/*
 * XREFs of DifCcCopyWriteWrapper @ 0x1405D3C40
 * Callers:
 *     <none>
 * Callees:
...
char __fastcall DifCcCopyWriteWrapper(__int64 a1, __int64 *a2, unsigned int a3, char a4, __int64 a5)
{
  ...
  v22 = 0LL;
  v23 = 0LL;
  APIThunkContextById = DifGetAPIThunkContextById(0);
  v14 = APIThunkContextById;
  if ( !APIThunkContextById )
    goto LABEL_17;
  if ( (ViVerifierEnabled == (_DWORD)v11 || (VfRuleClasses & 0xFF217644) == 0)
...
LABEL_8:
  ...
  else if ( (*((_DWORD *)APIThunkContextById + 3) & 0x20) == 0 )
  {
    goto LABEL_8;
  }
  *(_QWORD *)&v21 = 0LL;
...
LABEL_17:
  result = CcCopyWriteEx(a1, a2, a3, a4, a5, 0LL);
  BYTE8(v23) = result;
  if ( v14 )
  {
    v19 = (_QWORD **)(v14 + 6);
