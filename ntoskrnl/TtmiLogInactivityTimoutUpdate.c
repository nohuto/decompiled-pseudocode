/*
 * XREFs of TtmiLogInactivityTimoutUpdate @ 0x1409A56A8
 * Callers:
...
void __fastcall TtmiLogInactivityTimoutUpdate(int a1)
{
  ...
  if ( (unsigned int)dword_140D53948 > 5 )
  {
    if ( tlgKeywordOn((__int64)&dword_140D53948, 1LL) )
    {
      ...
      v9 = &v4;
      v4 = a1;
      tlgWriteTransfer_EtwWriteTransfer((__int64)&dword_140D53948, (unsigned __int8 *)byte_140032739, 0LL, 0LL, 4u, &v5);
    }
  }
}
