/*
 * XREFs of DifIoGetDriverDirectoryWrapper @ 0x1405DD6A0
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall DifIoGetDriverDirectoryWrapper(__int64 a1, unsigned int a2, unsigned int a3, __int64 a4)
{
  ...
  v20 = 0LL;
  v21 = 0LL;
  APIThunkContextById = DifGetAPIThunkContextById(183);
...
LABEL_17:
  result = IoGetDriverDirectory(a1, a2, a3, a4, v20, *((_QWORD *)&v20 + 1), v21, *((_QWORD *)&v21 + 1), v22);
  LODWORD(v22) = result;
  if ( v13 )
  {
    v18 = (_QWORD **)(v13 + 6);
