/*
 * XREFs of DifExEnterPriorityRegionAndAcquireResourceExclusiveWrapper @ 0x1405D6580
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall DifExEnterPriorityRegionAndAcquireResourceExclusiveWrapper(PERESOURCE Resource)
{
  ...
  v15 = 0LL;
  v14 = 0LL;
  APIThunkContextById = DifGetAPIThunkContextById(37);
...
LABEL_17:
  result = ExEnterPriorityRegionAndAcquireResourceExclusive(Resource);
  v15 = result;
  if ( v7 )
  {
    v12 = (_QWORD **)(v7 + 6);
