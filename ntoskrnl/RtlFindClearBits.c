/*
 * XREFs of RtlFindClearBits @ 0x14030D600
 * Callers:
 *     <none>
 * Callees:
 *     <none>
      ...
      while ( 1 )
      {
        while ( 1 )
        {
          ...
          if ( v27 )
            ...
            v37 = 63 - v36;
          v20 = (((unsigned int)(((char *)v17 - v13) >> 3) + 1) << 6) - v37;
          if ( v20 > v14 )
            goto LABEL_16;
...
LABEL_23:
        ...
        if ( v25 + (int)v28 >= NumberToFind )
        {
          LODWORD(v30) = -v25;
LABEL_30:
          v20 = ((unsigned int)(((char *)v17 - v13) >> 3) << 6) + v30;
          v21 = v20 <= v14;
          goto LABEL_11;
        }
        v29 = NumberToFind;
...
LABEL_43:
    ...
    while ( *v17 );
    v27 = !_BitScanReverse64((unsigned __int64 *)&v34, *v33);
    if ( v27 )
LABEL_77:
      v35 = 64;
    else
      v35 = 63 - v34;
LABEL_61:
    v20 = ((unsigned int)(((char *)v17 - v13) >> 3) << 6) - v35;
    if ( v20 > v14 )
      goto LABEL_16;
    v41 = NumberToFind - v35;
    v42 = &v17[(unsigned __int64)(NumberToFind - v35) >> 6];
    while ( ++v17 != v42 )
    {
      if ( *v17 )
        goto LABEL_43;
    ...
    if ( !v43 )
      break;
    v27 = !_BitScanForward64((unsigned __int64 *)&v44, *v17);
    if ( v27 )
      LODWORD(v44) = 64;
  }
