/*
 * XREFs of DifZwQueryInformationTransactionManagerWrapper @ 0x1405F2930
 * Callers:
 *     <none>
 * Callees:
...
LABEL_10:
  ...
  *((_QWORD *)&v23 + 1) = TransactionManagerHandle;
  LODWORD(v23) = TransactionManagerInformationClass;
  *((_QWORD *)&v22 + 1) = TransactionManagerInformation;
  LODWORD(v22) = TransactionManagerInformationLength;
