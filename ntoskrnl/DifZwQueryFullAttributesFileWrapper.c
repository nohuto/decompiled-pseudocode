/*
 * XREFs of DifZwQueryFullAttributesFileWrapper @ 0x1405F1E80
 * Callers:
 *     <none>
 * Callees:
...
NTSTATUS __fastcall DifZwQueryFullAttributesFileWrapper(
        ...
        PFILE_NETWORK_OPEN_INFORMATION FileInformation)
{
  ...
  v16 = 0LL;
  v17 = 0LL;
  APIThunkContextById = DifGetAPIThunkContextById(593);
...
LABEL_8:
  ...
  *(_QWORD *)&v16 = 0LL;
LABEL_10:
  *(_QWORD *)&v17 = ObjectAttributes;
  *((_QWORD *)&v16 + 1) = FileInformation;
...
LABEL_17:
  result = ZwQueryFullAttributesFile(ObjectAttributes, FileInformation);
  DWORD2(v17) = result;
  if ( v9 )
  {
    v14 = (_QWORD **)(v9 + 6);
