/*
 * XREFs of DifZwOpenProcessTokenExWrapper @ 0x1405EFC30
 * Callers:
 *     <none>
 * Callees:
...
NTSTATUS __fastcall DifZwOpenProcessTokenExWrapper(
        ...
        PHANDLE TokenHandle)
{
  ...
  v20 = 0LL;
  v21 = 0LL;
  APIThunkContextById = DifGetAPIThunkContextById(567);
...
LABEL_8:
  ...
  *(_QWORD *)&v20 = 0LL;
LABEL_10:
  *((_QWORD *)&v21 + 1) = ProcessHandle;
  *(_QWORD *)&v21 = __PAIR64__(DesiredAccess, HandleAttributes);
...
LABEL_17:
  result = ZwOpenProcessTokenEx(ProcessHandle, DesiredAccess, HandleAttributes, TokenHandle);
  LODWORD(v22) = result;
  if ( v13 )
  {
    v18 = (_QWORD **)(v13 + 6);
