/*
 * XREFs of DifIoAllocateWorkItemWrapper @ 0x1405DAF80
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall DifIoAllocateWorkItemWrapper(__int64 a1, __int64 a2, __int64 (__fastcall *a3)(__int64, __int64))
{
