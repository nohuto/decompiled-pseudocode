/*
 * XREFs of __asan_store8_noabort @ 0x140564990
 * Callers:
 *     <none>
 * Callees:
...
ULONG_PTR __fastcall _asan_store8_noabort(ULONG_PTR BugCheckParameter1)
{
  ULONG_PTR v1; // rbx
  ...
  else
  {
    ...
    {
LABEL_46:
      KeBugCheckEx(0x1F2u, BugCheckParameter1, 8uLL, v1, (unsigned __int8)v8 | 0x100LL);
    }
