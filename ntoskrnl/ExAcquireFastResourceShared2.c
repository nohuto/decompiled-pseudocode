/*
 * XREFs of ExAcquireFastResourceShared2 @ 0x14040D7F0
 * Callers:
...
char __fastcall ExAcquireFastResourceShared2(_WORD *BugCheckParameter2, ULONG_PTR a2, char a3)
{
  __int16 v3; // r9
  __int64 v4; // rbp
  int v5; // r10d
  ...
  if ( !v17 || (v14 & 4) != 0 )
  {
    ...
    do
    {
      ...
      if ( (*(_QWORD *)BugCheckParameter2 & 1) != 0 || (v20 & 2) != 0 )
