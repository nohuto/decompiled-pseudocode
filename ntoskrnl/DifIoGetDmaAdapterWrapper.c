/*
 * XREFs of DifIoGetDmaAdapterWrapper @ 0x1405DD570
 * Callers:
 *     <none>
 * Callees:
...
struct _DMA_ADAPTER *__fastcall DifIoGetDmaAdapterWrapper(
        ...
        PULONG NumberOfMapRegisters)
{
  ...
  struct _DMA_ADAPTER *v20; // [rsp+40h] [rbp-10h]
...
LABEL_8:
  ...
  *(_QWORD *)&v18 = 0LL;
LABEL_10:
  *((_QWORD *)&v19 + 1) = PhysicalDeviceObject;
  *(_QWORD *)&v19 = DeviceDescription;
  *((_QWORD *)&v18 + 1) = NumberOfMapRegisters;
...
LABEL_17:
  result = IoGetDmaAdapter(PhysicalDeviceObject, DeviceDescription, NumberOfMapRegisters);
  v20 = result;
  if ( v11 )
  {
    v16 = (_QWORD **)(v11 + 6);
