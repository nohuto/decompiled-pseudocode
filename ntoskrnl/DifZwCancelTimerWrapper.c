/*
 * XREFs of DifZwCancelTimerWrapper @ 0x1405EB7E0
 * Callers:
 *     <none>
 * Callees:
...
NTSTATUS __fastcall DifZwCancelTimerWrapper(HANDLE TimerHandle, PBOOLEAN CurrentState)
{
  ...
  v16 = 0LL;
  v17 = 0LL;
  APIThunkContextById = DifGetAPIThunkContextById(507);
...
LABEL_8:
  ...
  *(_QWORD *)&v16 = 0LL;
LABEL_10:
  *(_QWORD *)&v17 = TimerHandle;
  *((_QWORD *)&v16 + 1) = CurrentState;
...
LABEL_17:
  result = ZwCancelTimer(TimerHandle, CurrentState);
  DWORD2(v17) = result;
  if ( v9 )
  {
    v14 = (_QWORD **)(v9 + 6);
