/*
 * XREFs of DifMmPageEntireDriverWrapper @ 0x1405E5380
 * Callers:
 *     <none>
 * Callees:
...
PVOID __fastcall DifMmPageEntireDriverWrapper(PVOID AddressWithinSection)
{
  ...
  v15 = 0LL;
  v14 = 0LL;
  APIThunkContextById = DifGetAPIThunkContextById(347);
...
LABEL_8:
  ...
  *(_QWORD *)&v14 = 0LL;
LABEL_10:
  *((_QWORD *)&v14 + 1) = AddressWithinSection;
...
LABEL_17:
  result = MmPageEntireDriver(AddressWithinSection);
  v15 = result;
  if ( v7 )
  {
    v12 = (_QWORD **)(v7 + 6);
