/*
 * XREFs of TtmiLogCleanupCurrentSessionStart @ 0x1409A40F8
 * Callers:
...
void TtmiLogCleanupCurrentSessionStart()
{
  ...
  if ( (unsigned int)dword_140D53948 > 5 )
  {
    if ( tlgKeywordOn((__int64)&dword_140D53948, 1LL) )
    {
      ...
      v4 = 4;
      v3 = &v1;
      tlgWriteTransfer_EtwWriteTransfer((__int64)&dword_140D53948, (unsigned __int8 *)word_14003318A, 0LL, 0LL, 3u, &v2);
    }
  }
}
