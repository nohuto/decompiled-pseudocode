/*
 * XREFs of PpmIdleExecuteTransition @ 0x14022D7D0
 * Callers:
 ...
 *     PpmUpdatePlatformIdleAccounting @ 0x14058415C (PpmUpdatePlatformIdleAccounting.c)
 *     PpmPerfFeedbackCounterUpdate @ 0x14058AC24 (PpmPerfFeedbackCounterUpdate.c)
