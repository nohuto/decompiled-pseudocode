/*
 * XREFs of CmpSendUnsupportedOperationTelemetryEvent @ 0x140A1D518
 * Callers:
...
void CmpSendUnsupportedOperationTelemetryEvent()
{
  ...
  if ( (unsigned int)dword_140C04328 > 5 )
  {
    if ( tlgKeywordOn((__int64)&dword_140C04328, 0x400000000000LL) )
    {
      ...
      v4 = 0x1000000LL;
      v11 = 8LL;
      tlgWriteTransfer_EtwWriteTransfer((__int64)&dword_140C04328, (unsigned __int8 *)byte_1400378B9, 0LL, 0LL, 5u, &v5);
    }
  }
}
