/*
 * XREFs of DifRtlCreateRegistryKeyWrapper @ 0x1405E8B30
 * Callers:
 *     <none>
 * Callees:
...
NTSTATUS __fastcall DifRtlCreateRegistryKeyWrapper(ULONG RelativeTo, PWSTR Path)
{
  ...
  v17 = 0LL;
  v16 = 0LL;
  APIThunkContextById = DifGetAPIThunkContextById(416);
...
LABEL_17:
  result = RtlCreateRegistryKey(RelativeTo, Path);
  HIDWORD(v17) = result;
  if ( v9 )
  {
    v14 = (_QWORD **)(v9 + 6);
