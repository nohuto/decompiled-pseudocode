/*
 * XREFs of DifMmBuildMdlForNonPagedPoolWrapper @ 0x1405E4AC0
 * Callers:
 *     <none>
 * Callees:
...
void __fastcall DifMmBuildMdlForNonPagedPoolWrapper(PMDL MemoryDescriptorList)
{
...
LABEL_8:
  ...
  *(_QWORD *)&v13 = 0LL;
LABEL_10:
  *((_QWORD *)&v13 + 1) = MemoryDescriptorList;
