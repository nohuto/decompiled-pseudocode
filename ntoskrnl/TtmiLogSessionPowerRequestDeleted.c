/*
 * XREFs of TtmiLogSessionPowerRequestDeleted @ 0x1409A6B44
 * Callers:
...
void TtmiLogSessionPowerRequestDeleted()
{
  ...
  if ( (unsigned int)dword_140D53948 > 5 )
  {
    if ( tlgKeywordOn((__int64)&dword_140D53948, 1LL) )
    {
      ...
      v6 = v2;
      v11 = 4LL;
      tlgWriteTransfer_EtwWriteTransfer((__int64)&dword_140D53948, (unsigned __int8 *)byte_140032ED0, 0LL, 0LL, 5u, &v7);
    }
  }
}
