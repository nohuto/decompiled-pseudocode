/*
 * XREFs of ExReleaseDisownedFastResource2 @ 0x14040E8BC
 * Callers:
...
__int64 __fastcall ExReleaseDisownedFastResource2(ULONG_PTR BugCheckParameter2, ULONG_PTR a2)
{
  ...
  if ( (*(_BYTE *)(a2 + 37) & 2) == 0 && *(_QWORD *)(a2 + 24) != BugCheckParameter2 )
