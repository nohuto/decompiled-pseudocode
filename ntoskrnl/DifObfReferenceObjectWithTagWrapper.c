/*
 * XREFs of DifObfReferenceObjectWithTagWrapper @ 0x1405E6990
 * Callers:
 *     <none>
 * Callees:
...
LONG_PTR __fastcall DifObfReferenceObjectWithTagWrapper(PVOID Object, ULONG Tag)
{
...
LABEL_17:
  result = ObfReferenceObjectWithTag(Object, Tag);
  *((_QWORD *)&v17 + 1) = result;
  if ( v9 )
  {
    v14 = (_QWORD **)(v9 + 6);
