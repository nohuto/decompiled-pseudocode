/*
 * XREFs of IopInitializePlugPlayServices @ 0x140B599CC
 * Callers:
 ...
 *     PnpInitializeNotification @ 0x140B6A8AC (PnpInitializeNotification.c)
 ...
 *     PpProfileInit @ 0x140B7174C (PpProfileInit.c)
