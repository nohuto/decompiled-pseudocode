/*
 * XREFs of DifZwOpenDirectoryObjectWrapper @ 0x1405EF0D0
 * Callers:
 *     <none>
 * Callees:
...
NTSTATUS __fastcall DifZwOpenDirectoryObjectWrapper(
        ...
        POBJECT_ATTRIBUTES ObjectAttributes)
{
  ...
  v18 = 0LL;
  v19 = 0LL;
  APIThunkContextById = DifGetAPIThunkContextById(556);
...
LABEL_17:
  result = ZwOpenDirectoryObject(DirectoryHandle, DesiredAccess, ObjectAttributes);
  LODWORD(v20) = result;
  if ( v11 )
  {
    v16 = (_QWORD **)(v11 + 6);
