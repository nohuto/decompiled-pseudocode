/*
 * XREFs of DifZwOpenKeyExWrapper @ 0x1405EF720
 * Callers:
 *     <none>
 * Callees:
...
NTSTATUS __fastcall DifZwOpenKeyExWrapper(
        PHANDLE KeyHandle,
...
LABEL_17:
  result = ZwOpenKeyEx(KeyHandle, DesiredAccess, ObjectAttributes, OpenOptions);
  DWORD2(v22) = result;
  if ( v13 )
  {
    v18 = (_QWORD **)(v13 + 6);
