/*
 * XREFs of TtmiLogSessionDeviceAssignmentPolicySet @ 0x1409A6388
 * Callers:
...
void __fastcall TtmiLogSessionDeviceAssignmentPolicySet(char a1)
{
  ...
  if ( (unsigned int)dword_140D53948 > 5 )
  {
    if ( tlgKeywordOn((__int64)&dword_140D53948, 1LL) )
    {
      ...
      v9 = &v3;
      v10 = 1;
      tlgWriteTransfer_EtwWriteTransfer((__int64)&dword_140D53948, (unsigned __int8 *)byte_1400334D7, 0LL, 0LL, 4u, &v5);
    }
  }
}
