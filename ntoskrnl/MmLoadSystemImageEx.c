/*
 * XREFs of MmLoadSystemImageEx @ 0x14072E4EC
 * Callers:
 ...
 *     IopLoadCrashdmpImage @ 0x1408606A0 (IopLoadCrashdmpImage.c)
 ...
 *     MiValidateStrongCodeDriverImage @ 0x14062A5C0 (MiValidateStrongCodeDriverImage.c)
