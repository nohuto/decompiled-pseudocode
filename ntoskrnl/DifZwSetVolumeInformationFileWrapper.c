/*
 * XREFs of DifZwSetVolumeInformationFileWrapper @ 0x1405F5910
 * Callers:
 *     <none>
 * Callees:
...
NTSTATUS __fastcall DifZwSetVolumeInformationFileWrapper(
        HANDLE FileHandle,
        ...
        FS_INFORMATION_CLASS FsInformationClass)
{
  ...
  v22 = 0LL;
  v23 = 0LL;
  APIThunkContextById = DifGetAPIThunkContextById(649);
...
LABEL_8:
  ...
  *(_QWORD *)&v21 = 0LL;
LABEL_10:
  *((_QWORD *)&v21 + 1) = __PAIR64__(Length, FsInformationClass);
  *(_QWORD *)&v23 = FileHandle;
  *((_QWORD *)&v22 + 1) = IoStatusBlock;
  *(_QWORD *)&v22 = FsInformation;
...
LABEL_17:
  result = ZwSetVolumeInformationFile(FileHandle, IoStatusBlock, FsInformation, Length, FsInformationClass);
  DWORD2(v23) = result;
  if ( v14 )
  {
    v19 = (_QWORD **)(v14 + 6);
