/*
 * XREFs of DifZwCommitEnlistmentWrapper @ 0x1405EBB40
 * Callers:
 *     <none>
 * Callees:
...
NTSTATUS __fastcall DifZwCommitEnlistmentWrapper(HANDLE EnlistmentHandle, PLARGE_INTEGER TmVirtualClock)
{
