/*
 * XREFs of DifExAcquireSharedWaitForExclusiveWrapper @ 0x1405D4FF0
 * Callers:
 *     <none>
 * Callees:
...
BOOLEAN __fastcall DifExAcquireSharedWaitForExclusiveWrapper(PERESOURCE Resource, BOOLEAN a2)
{
  ...
  v16 = 0LL;
  v17 = 0LL;
  APIThunkContextById = DifGetAPIThunkContextById(20);
...
LABEL_17:
  result = ExAcquireSharedWaitForExclusive(Resource, a2);
  BYTE8(v17) = result;
  if ( v9 )
  {
    v14 = (_QWORD **)(v9 + 6);
