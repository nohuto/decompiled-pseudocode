/*
 * XREFs of MmQueryVirtualMemory @ 0x1407C6390
 * Callers:
 *     ?SmStCheckResident@?$SMKM_STORE@USM_TRAITS@@@@SA?AW4_SMST_RESIDENT_CHECK_RESULT@1@PEAXK@Z @ 0x14045CF12 (-SmStCheckResident@-$SMKM_STORE@USM_TRAITS@@@@SA-AW4_SMST_RESIDENT_CHECK_RESULT@1@PEAXK@Z.c)
 *     NtQueryVirtualMemory @ 0x1407C6350 (NtQueryVirtualMemory.c)
 ...
 *     MiIsSoftwareEnclave @ 0x1402D5610 (MiIsSoftwareEnclave.c)
 *     MiGetWorkingSetInfo @ 0x1402F7C60 (MiGetWorkingSetInfo.c)
 *     MiSetBasicInfoPartitionId @ 0x1402FE994 (MiSetBasicInfoPartitionId.c)
