/*
 * XREFs of DifKeAcquireQueuedSpinLockWrapper @ 0x1405E04A0
 * Callers:
 *     <none>
 * Callees:
...
KIRQL __fastcall DifKeAcquireQueuedSpinLockWrapper(KSPIN_LOCK_QUEUE_NUMBER Number)
{
...
LABEL_17:
  result = KeAcquireQueuedSpinLock(Number);
  LOBYTE(v15) = result;
  if ( v7 )
  {
    v12 = (_QWORD **)(v7 + 6);
