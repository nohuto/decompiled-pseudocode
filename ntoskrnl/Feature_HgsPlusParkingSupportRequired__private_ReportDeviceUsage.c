/*
 * XREFs of Feature_HgsPlusParkingSupportRequired__private_ReportDeviceUsage @ 0x14040B9A0
 * Callers:
...
void Feature_HgsPlusParkingSupportRequired__private_ReportDeviceUsage()
{
  ...
  v0 = (unsigned int)Feature_HgsPlusParkingSupportRequired__private_featureState;
  if ( (Feature_HgsPlusParkingSupportRequired__private_featureState & 0x10) == 0 )
  {
    LODWORD(v0) = Feature_HgsPlusParkingSupportRequired__private_featureState | 1;
    wil_details_FeatureReporting_ReportUsageToService(
      (__int64)&Feature_HgsPlusParkingSupportRequired__private_descriptor,
      v0,
      3,
      1LL);
