/*
 * XREFs of PopTraceSleepCheckpointInitFailure @ 0x14098FAE8
 * Callers:
...
void PopTraceSleepCheckpointInitFailure()
{
  ...
  if ( (unsigned int)dword_140C03928 > 5 )
  {
    if ( tlgKeywordOn((__int64)&dword_140C03928, 0x400000000000LL) )
    {
      ...
      v1 = v0;
      v4 = 4;
      tlgWriteTransfer_EtwWriteTransfer((__int64)&dword_140C03928, (unsigned __int8 *)byte_14002E789, 0LL, 0LL, 3u, &v2);
    }
  }
}
