/*
 * XREFs of DifZwDeleteValueKeyWrapper @ 0x1405ED350
 * Callers:
 *     <none>
 * Callees:
...
NTSTATUS __fastcall DifZwDeleteValueKeyWrapper(HANDLE KeyHandle, PUNICODE_STRING ValueName)
{
