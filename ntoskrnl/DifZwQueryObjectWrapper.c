/*
 * XREFs of DifZwQueryObjectWrapper @ 0x1405F2FC0
 * Callers:
 *     <none>
 * Callees:
...
NTSTATUS __fastcall DifZwQueryObjectWrapper(
        HANDLE Handle,
        ...
        PULONG ReturnLength)
{
  ...
  v22 = 0LL;
  v23 = 0LL;
  APIThunkContextById = DifGetAPIThunkContextById(606);
...
LABEL_10:
  ...
  *((_QWORD *)&v23 + 1) = Handle;
  LODWORD(v23) = ObjectInformationClass;
  *((_QWORD *)&v22 + 1) = ObjectInformation;
  LODWORD(v22) = ObjectInformationLength;
...
LABEL_17:
  result = ZwQueryObject(Handle, ObjectInformationClass, ObjectInformation, ObjectInformationLength, ReturnLength);
  LODWORD(v24) = result;
  if ( v14 )
  {
    v19 = (_QWORD **)(v14 + 6);
