/*
 * XREFs of DifKeReleaseSpinLockFromDpcLevelWrapper @ 0x1405E2B60
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall DifKeReleaseSpinLockFromDpcLevelWrapper(volatile signed __int64 *a1)
{
  ...
  v14 = 0LL;
  APIThunkContextById = DifGetAPIThunkContextById(298);
