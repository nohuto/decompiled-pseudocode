/*
 * XREFs of DifRtlCreateUnicodeStringWrapper @ 0x1405E8D60
 * Callers:
 *     <none>
 * Callees:
...
BOOLEAN __fastcall DifRtlCreateUnicodeStringWrapper(PUNICODE_STRING DestinationString, PCWSTR SourceString)
{
...
LABEL_8:
  ...
  *(_QWORD *)&v16 = 0LL;
LABEL_10:
  *(_QWORD *)&v17 = DestinationString;
  *((_QWORD *)&v16 + 1) = SourceString;
...
LABEL_17:
  result = RtlCreateUnicodeString(DestinationString, SourceString);
  BYTE8(v17) = result;
  if ( v9 )
  {
    v14 = (_QWORD **)(v9 + 6);
