/*
 * XREFs of DifIoRaiseHardErrorWrapper @ 0x1405DE250
 * Callers:
 *     <none>
 * Callees:
...
void __fastcall DifIoRaiseHardErrorWrapper(PIRP Irp, PVPB Vpb, PDEVICE_OBJECT RealDeviceObject)
{
  ...
  v17 = 0LL;
  v18 = 0LL;
  APIThunkContextById = DifGetAPIThunkContextById(197);
...
LABEL_17:
  IoRaiseHardError(Irp, Vpb, RealDeviceObject);
  if ( v11 )
  {
    v15 = (_QWORD **)(v11 + 6);
