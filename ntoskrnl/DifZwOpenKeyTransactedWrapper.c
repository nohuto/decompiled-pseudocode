/*
 * XREFs of DifZwOpenKeyTransactedWrapper @ 0x1405EF9C0
 * Callers:
 *     <none>
 * Callees:
...
NTSTATUS __fastcall DifZwOpenKeyTransactedWrapper(
        PHANDLE KeyHandle,
        ...
        HANDLE TransactionHandle)
{
  ...
  v21 = 0LL;
  v22 = 0LL;
  APIThunkContextById = DifGetAPIThunkContextById(563);
...
LABEL_17:
  result = ZwOpenKeyTransacted(KeyHandle, DesiredAccess, ObjectAttributes, TransactionHandle);
  DWORD2(v22) = result;
  if ( v13 )
  {
    v18 = (_QWORD **)(v13 + 6);
