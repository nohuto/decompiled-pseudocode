/*
 * XREFs of DifZwCreateDirectoryObjectWrapper @ 0x1405EBDF0
 * Callers:
 *     <none>
 * Callees:
...
NTSTATUS __fastcall DifZwCreateDirectoryObjectWrapper(
        ...
        POBJECT_ATTRIBUTES ObjectAttributes)
{
  ...
  v18 = 0LL;
  v19 = 0LL;
  APIThunkContextById = DifGetAPIThunkContextById(514);
...
LABEL_17:
  result = ZwCreateDirectoryObject(DirectoryHandle, DesiredAccess, ObjectAttributes);
  LODWORD(v20) = result;
  if ( v11 )
  {
    v16 = (_QWORD **)(v11 + 6);
