/*
 * XREFs of IopLiveDumpTraceMarkRequiredDumpDataDuration @ 0x140558C74
 * Callers:
  ...
  if ( (_BYTE)v3 )
  {
    if ( !v4[106] )
    {
      ...
      if ( (v3 & 1) != 0 )
      {
        ...
        v5 = (const EVENT_DESCRIPTOR *)LIVEDUMP_EVENT_SIZING_WORKFLOW_SYSTEM_QUIESCED_MARK_REQUIRED_DUMP_DATA;
        if ( (v4[20] & 1) == 0 )
          v5 = &LIVEDUMP_EVENT_CAPTURE_PAGES_WORKFLOW_SYSTEM_QUIESCED_MARK_REQUIRED_DUMP_DATA;
        UserData.Size = 8;
        ...
        if ( (unsigned int)dword_140C06280 > 5 )
        {
          ...
          if ( (_BYTE)v3 )
          {
            ...
            LOBYTE(v3) = tlgWriteTransfer_EtwWriteTransfer(
                           ...
                           (unsigned __int8 *)&byte_14002BE97,
                           (const GUID *)(a1 + 968),
                           (const GUID *)(a1 + 952),
                           4u,
                           &v10);
