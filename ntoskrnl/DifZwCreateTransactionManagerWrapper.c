/*
 * XREFs of DifZwCreateTransactionManagerWrapper @ 0x1405ECD20
 * Callers:
 *     <none>
 * Callees:
...
NTSTATUS __fastcall DifZwCreateTransactionManagerWrapper(
        PHANDLE TmHandle,
        ...
        ULONG CommitStrength)
{
  ...
  v22 = 0LL;
  v23 = 0LL;
  APIThunkContextById = DifGetAPIThunkContextById(526);
