/*
 * XREFs of DifPoFxSetComponentLatencyWrapper @ 0x1405E7760
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall DifPoFxSetComponentLatencyWrapper(__int64 a1, unsigned int a2, __int64 a3)
{
...
LABEL_17:
  result = PoFxSetComponentLatency(a1, a2, a3);
  if ( v11 )
  {
    v16 = (_QWORD **)(v11 + 6);
