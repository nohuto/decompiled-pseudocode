/*
 * XREFs of PnpProcessQueryRemoveAndEject @ 0x1408625F0
 * Callers:
 ...
 *     PiEventAreDeviceRelationsExcluded @ 0x140861DF8 (PiEventAreDeviceRelationsExcluded.c)
 ...
 *     PiDetermineDeleteType @ 0x1408639D4 (PiDetermineDeleteType.c)
