/*
 * XREFs of ?SetDPIinSetup@@YAJPEAU_DXGK_DISPLAY_SCENARIO_CONTEXT@@@Z @ 0x1C0139F44
 * Callers:
...
LABEL_4:
  ...
  if ( CurrentDpiInfoFromHDev >= 0 )
  {
    ...
    if ( qword_1C0250798 )
      ...
      v7 = -1073741637;
    if ( v7 >= 0 && qword_1C02507A0 )
      qword_1C02507A0(1LL, &v26);
    if ( v26 != v5 )
    {
      v8 = qword_1C02507B8 ? qword_1C02507B8() : -1073741637;
      if ( v8 >= 0 )
      {
        v9 = qword_1C02507C0 ? qword_1C02507C0(1LL, v5) : -1073741637;
        if ( v9 >= 0 )
        {
          v10 = qword_1C02507A8 ? qword_1C02507A8() : -1073741637;
          if ( v10 >= 0 )
          {
            if ( qword_1C02507B0 )
              v6 = qword_1C02507B0(1LL, v4 / 0x64 > 0x78);
            if ( v6 >= 0 )
            {
              v25 = 0;
              gDrvDpiWin8Style = 0;
