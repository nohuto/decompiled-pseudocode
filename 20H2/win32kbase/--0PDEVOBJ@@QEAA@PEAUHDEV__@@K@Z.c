/*
 * XREFs of ??0PDEVOBJ@@QEAA@PEAUHDEV__@@K@Z @ 0x1C013F1F4
 * Callers:
...
PDEVOBJ *__fastcall PDEVOBJ::PDEVOBJ(PDEVOBJ *this, char *a2)
{
  ...
  _QWORD *v34; // rax
  __int64 v35; // rcx
  _BYTE v37[32]; // [rsp+20h] [rbp-50h] BYREF
  _QWORD v38[2]; // [rsp+40h] [rbp-30h] BYREF
  __int16 v39; // [rsp+50h] [rbp-20h]
  ...
  *(_QWORD *)this = 0LL;
  ...
  v38[1] = 0LL;
  v39 = 256;
  DEVLOCKOBJ::vLock((DEVLOCKOBJ *)v37, (struct PDEVOBJ *)&v40);
  v4 = PDEV::Allocate(0);
  *(_QWORD *)this = v4;
  if ( v4 )
  {
        ...
        *(_QWORD *)(*(_QWORD *)this + 64LL) = GreCreateSemaphoreInternal(0);
        if ( *(_QWORD *)(*(_QWORD *)this + 64LL) )
        {
          ...
          **(_QWORD **)this = gppdevList;
          ...
          EtwTraceGreLockReleaseSemaphore((__int64)L"ghsemDriverMgmt", (int)ghsemDriverMgmt, v32);
          if ( ghsemDriverMgmt )
          {
