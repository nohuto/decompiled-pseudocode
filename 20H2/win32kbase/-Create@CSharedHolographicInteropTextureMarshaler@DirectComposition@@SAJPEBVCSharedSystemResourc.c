/*
 * XREFs of ?Create@CSharedHolographicInteropTextureMarshaler@DirectComposition@@SAJPEBVCSharedSystemResource@2@PEAPEAV12@@Z @ 0x1C01F3630
 * Callers:
 *     CreateSharedHolographicInteropTextureMarshaler @ 0x1C01F37C0 (CreateSharedHolographicInteropTextureMarshaler.c)
 * Callees:
