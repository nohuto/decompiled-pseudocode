/*
 * XREFs of ?CitpStatIncrement@@YAXPEAGG@Z @ 0x1C0062B2C
 * Callers:
 ...
 *     ?CitpInputTimesAddTo@@YAXPEAU_CIT_INPUT_TIMES@@PEBU1@@Z @ 0x1C0063974 (-CitpInputTimesAddTo@@YAXPEAU_CIT_INPUT_TIMES@@PEBU1@@Z.c)
