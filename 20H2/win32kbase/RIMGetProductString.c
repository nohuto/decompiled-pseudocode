/*
 * XREFs of RIMGetProductString @ 0x1C015E8FC
 * Callers:
 ...
 *     ?RtlStringCbLengthW@@YAJPEBG_KPEA_K@Z @ 0x1C00AA790 (-RtlStringCbLengthW@@YAJPEBG_KPEA_K@Z.c)
 *     wcscmp_0 @ 0x1C00D2893 (wcscmp_0.c)
