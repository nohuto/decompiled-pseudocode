/*
 * XREFs of ?xxxStickyKeys@@YAHPEAUtagKE@@KH@Z @ 0x1C0183070
 * Callers:
 *     <none>
 * Callees:
...
_BOOL8 __fastcall xxxStickyKeys(struct tagKE *a1, __int64 a2, unsigned int a3)
{
  ...
  {
    if ( (dword_1C0249BC4 & 4) != 0 )
    {
      if ( (dword_1C0249BC4 & 1) != 0 )
      {
        xxxTurnOffStickyKeys();
        if ( (dword_1C0249BC4 & 0x10) != 0 )
