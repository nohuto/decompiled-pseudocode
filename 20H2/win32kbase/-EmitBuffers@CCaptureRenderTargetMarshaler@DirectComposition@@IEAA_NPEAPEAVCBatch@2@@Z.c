/*
 * XREFs of ?EmitBuffers@CCaptureRenderTargetMarshaler@DirectComposition@@IEAA_NPEAPEAVCBatch@2@@Z @ 0x1C01EF058
 * Callers:
  ...
  for ( i = *((_DWORD *)this + 4); ; i = *((_DWORD *)this + 4) )
  {
    ...
    *((_DWORD *)v10 + 2) = *((_DWORD *)this + 6);
    ...
    if ( v9 )
    {
      ...
      {
        v16 = (void *)-1LL;
        v13 = (struct _OBJECT_TYPE *)((__int64 (*)(void))qword_1C024AA08)();
        OpenDwmHandle(
