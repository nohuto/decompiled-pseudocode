/*
 * XREFs of ?IsPointerMessageTouchpad@CTouchProcessor@@QEAAHPEAUtagTHREADINFO@@_KG@Z @ 0x1C0192C40
 * Callers:
 *     <none>
 * Callees:
        ...
        unsigned __int16 a4)
{
  ...
  if ( !a3 )
  {
    CInpLockGuardExclusive::CInpLockGuardExclusive(
      ...
      0LL);
    ThreadPointerData = ApiSetEditionFindThreadPointerData((char *)a2 + 1088, a4);
