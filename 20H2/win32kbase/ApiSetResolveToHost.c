/*
 * XREFs of ApiSetResolveToHost @ 0x1C00A650C
 * Callers:
 *     ?ResolveApiSetHost@@YAJPEAU_Win32kApiSet@@PEAX@Z @ 0x1C00A61F0 (-ResolveApiSetHost@@YAJPEAU_Win32kApiSet@@PEAX@Z.c)
 * Callees:
 *     ApiSetpSearchForApiSet @ 0x1C00A65E8 (ApiSetpSearchForApiSet.c)
 */
