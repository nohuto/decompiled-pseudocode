/*
 * XREFs of NtHWCursorUpdatePointer @ 0x1C014BE10
 * Callers:
 *     <none>
 * Callees:
      ...
      if ( (v12 & 1) != 0 )
      {
        ...
        if ( (v12 & 0x400) == 0 && (v12 & 0x20000) == 0 && (unsigned int)PDEVOBJ::bLddmDriver((PDEVOBJ *)&v23) )
        {
          ...
          if ( !a2 )
          {
            ...
            v14 = ((__int64 (__fastcall *)(struct _LUID *, int *, _QWORD))qword_1C024AAA8)(v13, &v30, 0LL);
            v15 = v14 < 0;
LABEL_16:
            if ( v15 )
              v14 = -1073741823;
            ...
            && HIDWORD(v24) <= (unsigned int)v4 )
          {
            ...
            v20 = PALLOCMEM2(v19, 1886221383LL, 1);
            v26 = v20;
            if ( v20 )
            {
              ...
              v14 = ((__int64 (__fastcall *)(struct _LUID *, int *, _DWORD *, _QWORD))qword_1C024AAB0)(
                      v22,
                      &v30,
                      v27,
                      0LL);
