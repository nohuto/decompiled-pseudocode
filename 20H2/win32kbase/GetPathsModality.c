/*
 * XREFs of GetPathsModality @ 0x1C00A8064
 * Callers:
        ...
        unsigned __int16 a4)
{
  ...
  __int64 v17; // rax
  __int64 v18; // rdx
  unsigned __int16 v19; // [rsp+48h] [rbp+20h] BYREF
  ...
  do
  {
    ...
    v12 = ((__int64 (__fastcall *)(_QWORD, struct D3DKMT_GETPATHSMODALITY *, unsigned __int16 *))qword_1C024A8B0)(
            a3,
            v8,
            &v19);
    v13 = v12;
