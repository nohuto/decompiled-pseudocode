/*
 * XREFs of LookUpTableFlushComplete @ 0x1C0278C60
 * Callers:
 ...
 *     ?TlgAggregateInternalProviderCallback@@YAXPEBU_GUID@@KE_K1PEAU_EVENT_FILTER_DESCRIPTOR@@PEAX@Z @ 0x1C0279780 (-TlgAggregateInternalProviderCallback@@YAXPEBU_GUID@@KE_K1PEAU_EVENT_FILTER_DESCRIPTOR@@PEAX@Z.c)
...
void __fastcall LookUpTableFlushComplete(__int64 a1)
{
  ...
  if ( *(_DWORD *)(a1 + 256) )
  {
    ...
    if ( *(_QWORD *)(v3 + 288) )
    {
      if ( (unsigned int)dword_1C02436D8 > 5 && tlgKeywordOn((__int64)&dword_1C02436D8, 0x400000000000LL) )
      {
