/*
 * XREFs of NtUserSetDisplayConfig @ 0x1C0135BB0
 * Callers:
 *     <none>
 * Callees:
...
LABEL_62:
  ...
  {
    v10 = *(_QWORD *)(*((_QWORD *)gptiCurrent + 53) + 768LL);
  ...
  else
  {
    ...
    if ( (_DWORD)v7 )
    {
      ...
      if ( v20 )
      {
        ...
        if ( qword_1C024FEC0 )
          qword_1C024FEC0(v22, &v38, Win32FreePool);
      }
      v11 = (__int64)v29;
      v35 = (__int64)v29;
      v16 = 0LL;
      ...
      while ( (unsigned int)v16 < (unsigned int)v7 )
      {
        if ( *(__int64 *)a2 < 0 )
        {
          ...
          *(_OWORD *)(v11 + 96) = *(_OWORD *)(a2 + 96);
          v10 = v11 + 128;
          *(_OWORD *)(v11 + 112) = *(_OWORD *)(a2 + 112);
          *(_OWORD *)(v11 + 128) = *(_OWORD *)(a2 + 128);
          *(_OWORD *)(v11 + 144) = *(_OWORD *)(a2 + 144);
          *(_OWORD *)(v11 + 160) = *(_OWORD *)(a2 + 160);
...
LABEL_63:
  if ( v9 >= 0 )
  {
    v24 = qword_1C0250B60 ? qword_1C0250B60(v10, v16, v11, v12) : -1073741637;
    if ( v24 >= 0 && qword_1C0250B68 )
      qword_1C0250B68();
  }
  if ( v29 && qword_1C024FFE8 )
    qword_1C024FFE8(&v38);
  UserSessionSwitchLeaveCrit(v10, v16, v11, v12);
