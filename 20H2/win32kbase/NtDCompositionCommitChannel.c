/*
 * XREFs of NtDCompositionCommitChannel @ 0x1C005EF30
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall NtDCompositionCommitChannel(int a1, _DWORD *a2, bool *a3, __int64 a4, void *a5)
{
  _DWORD *v5; // r12
  _BYTE *v6; // rdx
  ...
  *v6 = *v6;
  ...
  v9 = 0LL;
  v10 = 0LL;
  CurrentProcessWin32Process = PsGetCurrentProcessWin32Process(MmUserProbeAddress, v6, a3, a4);
...
LABEL_37:
  ...
  else
  {
    ...
    do
    {
      v22 = 0LL;
      v23 = 0LL;
      v17 = DirectComposition::CApplicationChannel::BuildBatch(v7, &v22, &v23, v30 != 0);
      if ( v22 )
