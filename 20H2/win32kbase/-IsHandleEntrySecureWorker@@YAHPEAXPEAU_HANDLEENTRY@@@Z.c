/*
 * XREFs of ?IsHandleEntrySecureWorker@@YAHPEAXPEAU_HANDLEENTRY@@@Z @ 0x1C011916C
 * Callers:
...
__int64 __fastcall IsHandleEntrySecureWorker(void *a1, struct _HANDLEENTRY *a2)
{
  ...
  v5 = 3LL * (unsigned int)((a2 - qword_1C0248D48) >> 5);
  CurrentProcessWin32Process = PsGetCurrentProcessWin32Process(a1);
  v7 = 1;
  if ( !CurrentProcessWin32Process )
    return v7;
  v8 = *((_WORD *)&unk_1C020365C + 12 * *((unsigned __int8 *)a2 + 24));
  if ( (v8 & 2) != 0 )
  {
    v9 = v2[v5 + 1];
  }
