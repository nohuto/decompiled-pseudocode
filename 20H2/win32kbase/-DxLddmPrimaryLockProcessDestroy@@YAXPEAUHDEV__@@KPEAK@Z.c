/*
 * XREFs of ?DxLddmPrimaryLockProcessDestroy@@YAXPEAUHDEV__@@KPEAK@Z @ 0x1C0011B4C
 * Callers:
 *     ?DxLddmCleanupAtProcessDestroy@@YAXK@Z @ 0x1C0011738 (-DxLddmCleanupAtProcessDestroy@@YAXK@Z.c)
 * Callees:
 *     DxLddmFindProcessEntry @ 0x1C0011BA0 (DxLddmFindProcessEntry.c)
    ...
    *(_QWORD *)(v7 + 8) = v8;
    ...
    if ( v9 )
    {
      ...
      if ( qword_1C024EF40 )
        ...
        v11 = -1073741637;
      if ( v11 >= 0 && qword_1C024EF48 )
        qword_1C024EF48(a1, (char *)v6 + 28, 1LL);
    }
