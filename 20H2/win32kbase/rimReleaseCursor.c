/*
 * XREFs of rimReleaseCursor @ 0x1C017EC60
 * Callers:
...
__int64 __fastcall rimReleaseCursor(__int64 a1, __int64 a2)
{
  ...
  {
    MicrosoftTelemetryAssertTriggeredNoArgsKM(v4, a2, (unsigned int)v4, v6);
    v6 = *(unsigned int *)(a1 + 980);
    result = v6;
    v4 = *(unsigned int *)(a1 + 976);
    v5 = v4;
...
LABEL_10:
  if ( (unsigned int)v5 >= *(_DWORD *)(a1 + 980) )
    return MicrosoftTelemetryAssertTriggeredNoArgsKM(v4, v8, v5, v6);
  return result;
}
