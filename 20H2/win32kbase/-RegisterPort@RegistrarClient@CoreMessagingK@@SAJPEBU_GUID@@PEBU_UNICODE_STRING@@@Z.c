/*
 * XREFs of ?RegisterPort@RegistrarClient@CoreMessagingK@@SAJPEBU_GUID@@PEBU_UNICODE_STRING@@@Z @ 0x1C00A97D8
 * Callers:
        ...
        const struct _UNICODE_STRING *a2)
{
  ...
  v13 = 0LL;
  v12 = v3;
  v6 = CoreUICallSend((int)&v14, (int)&v13, 1, 1, 13, (__int64)&unk_1C0208B21, &v12, Buffer, &v11);
  if ( v6 < 0 )
  {
