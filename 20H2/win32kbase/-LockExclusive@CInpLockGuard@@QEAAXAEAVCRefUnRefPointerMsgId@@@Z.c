/*
 * XREFs of ?LockExclusive@CInpLockGuard@@QEAAXAEAVCRefUnRefPointerMsgId@@@Z @ 0x1C00D1640
 * Callers:
...
void __fastcall CInpLockGuard::LockExclusive(PERESOURCE *this, struct CRefUnRefPointerMsgId *a2)
{
  ...
  _BYTE v48[32]; // [rsp+38h] [rbp-70h] BYREF
  _BYTE v49[32]; // [rsp+58h] [rbp-50h] BYREF
  ...
  while ( 1 )
  {
    ...
    if ( (unsigned int)CInpLockGuard::isManipulationThreadInTermination(v39)
      || !*((_DWORD *)this + 10)
