/*
 * XREFs of UserGlobalAtomTableCallout @ 0x1C006B5BC
 * Callers:
...
__int64 UserGlobalAtomTableCallout()
{
  ...
  if ( v13 >= 0 )
  {
    ...
    v16 = qword_1C0250970 ? qword_1C0250970(CurrentThread, ProcessWin32WindowStation, 32LL, &v20, 1) : -1073741637;
    if ( v16 >= 0 )
    ...
    || !(unsigned int)ApiSetIsCurrentProcessWinstaLocked() )
  {
    if ( qword_1C0250978 )
      v12 = qword_1C0250978();
    if ( v12 >= 0 && qword_1C0250980 )
      return qword_1C0250980();
  }
  return v0;
}
