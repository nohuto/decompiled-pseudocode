/*
 * XREFs of ?GetGlobalTickCount@CInputGlobals@@QEBA_KW4INPUT_GLOBALS_TICK_COUNT@@@Z @ 0x1C0097550
 * Callers:
 ...
 *     PowerIsDisplayIdleExpired @ 0x1C00974E0 (PowerIsDisplayIdleExpired.c)
