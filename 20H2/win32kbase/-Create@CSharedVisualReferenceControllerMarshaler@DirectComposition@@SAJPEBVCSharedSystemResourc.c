/*
 * XREFs of ?Create@CSharedVisualReferenceControllerMarshaler@DirectComposition@@SAJPEBVCSharedSystemResource@2@PEAPEAV12@@Z @ 0x1C01F2694
 * Callers:
 *     CreateSharedVisualReferenceControllerMarshaler @ 0x1C01F2870 (CreateSharedVisualReferenceControllerMarshaler.c)
 * Callees:
