/*
 * XREFs of ?SetReferenceArrayProperty@CPrimitiveGroupMarshaler@DirectComposition@@UEAAJPEAVCApplicationChannel@2@IPEAPEAVCResourceMarshaler@2@_KPEA_N@Z @ 0x1C005DA60
 * Callers:
 *     <none>
 * Callees:
      ...
      if ( v6 >= 0 )
      {
        do
        {
          ...
          if ( (unsigned int)v15 >= a5 )
            break;
          if ( !(*(unsigned __int8 (__fastcall **)(struct DirectComposition::CResourceMarshaler *, __int64))(*(_QWORD *)a4[v15] + 96LL))(
                  a4[v15],
                  126LL) )
            v6 = -1073741811;
