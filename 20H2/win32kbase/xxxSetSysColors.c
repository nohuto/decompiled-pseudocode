/*
 * XREFs of xxxSetSysColors @ 0x1C001BB80
 * Callers:
...
__int64 __fastcall xxxSetSysColors(__int64 a1, unsigned int a2, char *a3, char *a4, unsigned int a5)
{
  ...
  if ( (a5 & 1) != 0 )
  {
    v19 = qword_1C02509A8 ? qword_1C02509A8() : -1073741637;
    if ( v19 >= 0 )
    {
      v20 = (int)qword_1C02509B0;
      if ( qword_1C02509B0 )
        v20 = qword_1C02509B0(16LL);
      if ( !v20 )
        return 0LL;
    }
  }
...
LABEL_12:
  ...
  if ( (v5 & 1) != 0 )
  {
    ...
    if ( qword_1C02509C8 )
      ...
      v22 = -1073741637;
    if ( v22 >= 0 && qword_1C02509D0 )
      qword_1C02509D0(-1LL, 21LL, 0LL);
    if ( qword_1C02509D8 )
      v9 = qword_1C02509D8();
    if ( v9 >= 0 )
    {
      ...
      if ( v23 )
        ...
        v24 = 0LL;
      if ( qword_1C02509E0 )
        qword_1C02509E0(v24, 1LL, 66693LL);
      if ( *((struct tagDESKTOP **)gptiCurrent + 57) != grpdeskRitInput )
      {
        ...
        if ( (*(_DWORD *)(*v25 + 64LL) & 1) == 0 )
        {
          ...
          {
            if ( qword_1C02509E0 )
              qword_1C02509E0(v26, 1LL, 66693LL);
          }
        }
      }
    }
