/*
 * XREFs of ?vCopyTo@DC@@QEAAXAEAVXDCOBJ@@@Z @ 0x1C0087248
 * Callers:
...
void __fastcall DC::vCopyTo(DC *this, struct XDCOBJ *a2)
{
  ...
  *v7 = *v9;
  ...
  if ( v13 != v14 )
  {
    if ( v14 )
    {
      ...
      if ( v21 && (v21[21] & 1) == 0 )
        HmgDecrementShareReferenceCountEx((__int64)v21, 0LL);
    ...
    *(_QWORD *)(v12 + 200) = v13;
    if ( v13 )
    {
      ...
      if ( v21 && (v21[21] & 1) == 0 )
        HmgIncrementShareReferenceCount(v21);
      XEPATHOBJ::~XEPATHOBJ((XEPATHOBJ *)v20);
    }
  }
  ...
  *v16 = *v15;
  ...
  {
    *(_QWORD *)(*(_QWORD *)a2 + 296LL) = PALLOCMEM2((unsigned int)(8 * *((_DWORD *)this + 76)), 1684300103LL, 1);
