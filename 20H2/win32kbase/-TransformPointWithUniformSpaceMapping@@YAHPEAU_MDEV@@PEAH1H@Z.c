/*
 * XREFs of ?TransformPointWithUniformSpaceMapping@@YAHPEAU_MDEV@@PEAH1H@Z @ 0x1C0020150
 * Callers:
 *     DrvUniformSpaceToPixelSpacePoint @ 0x1C0020120 (DrvUniformSpaceToPixelSpacePoint.c)
 *     DrvPixelSpaceToUniformSpacePoint @ 0x1C0020B50 (DrvPixelSpaceToUniformSpacePoint.c)
 * Callees:
 *     DrvIsUniformSpaceMapping @ 0x1C00201B0 (DrvIsUniformSpaceMapping.c)
