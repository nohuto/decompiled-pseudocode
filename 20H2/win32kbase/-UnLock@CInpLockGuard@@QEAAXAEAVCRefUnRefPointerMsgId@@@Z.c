/*
 * XREFs of ?UnLock@CInpLockGuard@@QEAAXAEAVCRefUnRefPointerMsgId@@@Z @ 0x1C00D1E30
 * Callers:
 ...
 *     ?IsPointerPrimary@CTouchProcessor@@QEAAH_K@Z @ 0x1C0192E50 (-IsPointerPrimary@CTouchProcessor@@QEAAH_K@Z.c)
