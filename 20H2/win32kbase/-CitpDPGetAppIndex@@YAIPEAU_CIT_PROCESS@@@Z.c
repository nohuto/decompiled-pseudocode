/*
 * XREFs of ?CitpDPGetAppIndex@@YAIPEAU_CIT_PROCESS@@@Z @ 0x1C00A3050
 * Callers:
...
__int64 __fastcall CitpDPGetAppIndex(struct _CIT_PROCESS *a1)
{
  ...
  v7 = 0;
  v8 = (PCUNICODE_STRING *)&unk_1C01FDD60;
  ...
  if ( *(_DWORD *)v8 > 6u )
  {
    ...
    {
      case 7u:
        if ( (unsigned int)dword_1C0244C8C < MEMORY[0xFFFFF7800000037C] )
        {
          v10 = &off_1C0244C80;
          goto LABEL_25;
        }
        break;
      case 8u:
        if ( (unsigned int)dword_1C02433C4 < MEMORY[0xFFFFF7800000037C] )
        {
          v10 = &off_1C02433B8;
          goto LABEL_25;
        }
        break;
      case 9u:
        if ( (unsigned int)dword_1C0244C5C < MEMORY[0xFFFFF7800000037C] )
        {
          v10 = &off_1C0244C50;
          goto LABEL_25;
        }
        break;
      default:
        if ( v1 == 10 && (unsigned int)dword_1C0244C44 < MEMORY[0xFFFFF7800000037C] )
        {
          v10 = &off_1C0244C38;
          goto LABEL_25;
        }
  ...
  else
  {
    ...
    {
      case 6u:
        if ( (unsigned int)dword_1C0244C74 < MEMORY[0xFFFFF7800000037C] )
        {
          v10 = &off_1C0244C68;
          goto LABEL_25;
        }
        break;
      case 1u:
        if ( (unsigned int)dword_1C02433F4 < MEMORY[0xFFFFF7800000037C] )
        {
          v10 = &off_1C02433E8;
LABEL_25:
        ...
        break;
      case 2u:
        if ( (unsigned int)dword_1C02433DC >= MEMORY[0xFFFFF7800000037C] )
          break;
        v10 = &off_1C02433D0;
        goto LABEL_25;
      case 3u:
        if ( (unsigned int)dword_1C0244CA4 < MEMORY[0xFFFFF7800000037C] )
        {
          v10 = &off_1C0244C98;
          goto LABEL_25;
        }
        break;
      case 4u:
        if ( (unsigned int)dword_1C024340C < MEMORY[0xFFFFF7800000037C] )
        {
          v10 = &off_1C0243400;
          goto LABEL_25;
        }
        break;
      default:
        if ( v1 == 5 && (unsigned int)dword_1C02433AC < MEMORY[0xFFFFF7800000037C] )
        {
          v10 = &off_1C02433A0;
          goto LABEL_25;
        }
