/*
 * XREFs of xxxUpdatePerUserAccessPackSettings @ 0x1C008C770
 * Callers:
 *     <none>
 * Callees:
 ...
 *     GetProcessLuid @ 0x1C008DB90 (GetProcessLuid.c)
 ...
 *     ?CalculateMouseTable@@YAXXZ @ 0x1C008DCE0 (-CalculateMouseTable@@YAXXZ.c)
 *     __security_check_cookie @ 0x1C00CBC40 (__security_check_cookie.c)
 *     ?MKShowMouseCursor@@YAXXZ @ 0x1C01817F0 (-MKShowMouseCursor@@YAXXZ.c)
...
void __fastcall xxxUpdatePerUserAccessPackSettings(const UNICODE_STRING *a1)
{
  ...
  if ( v2 )
  {
    if ( v3 )
    {
      LODWORD(xmmword_1C0249BCC) = xmmword_1C0249BCC | 1;
      v9 = gdwPUDFlags | 1;
    }
    else
    {
    ...
    if ( v7 )
    {
      LODWORD(qword_1C0249B94) = qword_1C0249B94 | 1;
      v13 = v12 | 0x10;
    }
    else
    {
      LODWORD(qword_1C0249B94) = qword_1C0249B94 & 0xFFFFFFFE;
      v13 = v12 & 0xFFFFFFEF;
    }
    if ( Length )
    {
  ...
  if ( (((unsigned __int8)gdwPUDFlags ^ (unsigned __int8)xmmword_1C0249BCC) & 1) == 0 )
  {
    if ( v3 )
      v27 = xmmword_1C0249BCC | 1;
    else
      v27 = xmmword_1C0249BCC & 0xFFFFFFFE;
    LODWORD(xmmword_1C0249BCC) = v27;
  }
  if ( (dword_1C0249BC4 & 1) == (((unsigned int)gdwPUDFlags >> 1) & 1) )
  {
...
LABEL_65:
  v28 = gdwPUDFlags;
  if ( (((unsigned __int8)dword_1C0249BA4 ^ (unsigned __int8)((unsigned int)gdwPUDFlags >> 2)) & 1) == 0 )
  {
    if ( v5 )
      v29 = dword_1C0249BA4 | 1;
    else
      v29 = dword_1C0249BA4 & 0xFFFFFFFE;
    dword_1C0249BA4 = v29;
  }
  if ( (((unsigned __int8)dword_1C0249B8C ^ (unsigned __int8)((unsigned int)gdwPUDFlags >> 3)) & 1) == 0 )
  {
    if ( v6 )
      v30 = dword_1C0249B8C | 1;
    else
      v30 = dword_1C0249B8C & 0xFFFFFFFE;
    dword_1C0249B8C = v30;
  }
  if ( (((unsigned __int8)qword_1C0249B94 ^ (unsigned __int8)((unsigned int)gdwPUDFlags >> 4)) & 1) == 0 )
  {
    if ( v7 )
      v31 = qword_1C0249B94 | 1;
    else
      v31 = qword_1C0249B94 & 0xFFFFFFFE;
    LODWORD(qword_1C0249B94) = v31;
  }
  ...
  if ( (((unsigned __int8)dword_1C0249B7C ^ (unsigned __int8)(v28 >> 7)) & 1) == 0 )
  {
    if ( v8 )
      v32 = dword_1C0249B7C | 1;
    else
      v32 = dword_1C0249B7C & 0xFFFFFFFE;
    dword_1C0249B7C = v32;
  }
LABEL_22:
  ...
  Value = v16;
  LODWORD(xmmword_1C0249BCC) = v16;
  FastGetProfileIntW((int)a1, 15, (int)L"DelayBeforeAcceptance", 1000, (PULONG)&xmmword_1C0249BCC + 1, 0);
  FastGetProfileIntW((int)a1, 15, (int)L"AutoRepeatRate", 500, (PULONG)&xmmword_1C0249BCC + 3, 0);
  FastGetProfileIntW((int)a1, 15, (int)L"AutoRepeatDelay", 1000, (PULONG)&xmmword_1C0249BCC + 2, 0);
  FastGetProfileIntW((int)a1, 15, (int)L"BounceTime", 0, &::Value, 0);
  FastGetProfileIntW((int)a1, 19, (int)L"Flags", 2, &dword_1C024CE24, 0);
  FastGetProfileIntW((int)a1, 19, (int)L"FSTextEffect", 0, &dword_1C024CE28, 0);
  FastGetProfileIntW((int)a1, 19, (int)L"WindowsEffect", 0, &dword_1C024CE40, 0);
  ...
  *((_DWORD *)gpsi + 544) = (v17 >> 15) & 1;
  ...
  if ( (dword_1C0249BA4 & 1) != 0 )
    v19 = Value | 1;
  else
    v19 = Value & 0xFFFFFFFE;
  Value = v19;
  dword_1C0249BA4 = v19;
  FastGetProfileIntW((int)a1, 16, (int)L"MaximumSpeed", 40, &dword_1C0249BA8, 0);
  FastGetProfileIntW((int)a1, 16, (int)L"TimeToMaximumSpeed", 3000, &dword_1C0249BAC, 0);
  if ( dword_1C0249BA8 - 10 > 0x15E )
    dword_1C0249BA8 = 40;
  if ( dword_1C0249BAC - 1000 > 0xFA0 )
    dword_1C0249BAC = 3000;
  CalculateMouseTable();
  gbMKMouseMode = ((dword_1C0249BA4 & 0x80) != 0) ^ (((unsigned __int8)(1 << (2 * (gNumLockVk & 3) + 1)) & *((_BYTE *)&gafAsyncKeyState + ((unsigned __int64)(unsigned __int8)gNumLockVk >> 2))) != 0);
  if ( (dword_1C0249BA4 & 1) != 0 )
    MKShowMouseCursor();
  else
    MKHideMouseCursor();
  ...
  FastGetProfileIntW((int)a1, 18, (int)L"TimeToWait", 300000, (PULONG)&qword_1C0249B94 + 1, 0);
  FastGetProfileIntW((int)a1, 29, (int)L"Flags", 82, &Value, 0);
  if ( (dword_1C0249B7C & 1) != 0 )
    v22 = Value | 1;
  else
  ...
  v23 = OpenCacheKeyEx(a1, 29LL, 0x20019u, &v34);
  if ( v23 )
  {
    while ( 1 )
    {
...
LABEL_52:
  ...
  FastGetProfileIntW((int)a1, 48, (int)L"On", 0, &dword_1C0249B6C, 0);
  FastGetProfileIntW((int)a1, 48, (int)L"Locale", 0, &dword_1C0249B70, 0);
  AccessTimeOutReset();
