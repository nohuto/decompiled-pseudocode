/*
 * XREFs of ?SetMonitorData@@YAPEAUtagMONITOR@@PEAU1@K@Z @ 0x1C001FD54
 * Callers:
...
struct tagMONITOR *__fastcall SetMonitorData(struct tagMONITOR *Monitor, unsigned int a2)
{
  ...
  DisplayDC = (HDC)GreCreateDisplayDC(v8, 0);
  v10 = v28;
  if ( DisplayDC )
  {
...
LABEL_9:
  ...
  *((_WORD *)Monitor + 112) = MonitorPhysicalDPI;
  ...
  v13 = Win32AllocPoolZInit(0x64uLL);
  v14 = (_DWORD *)v13;
  if ( !v13 )
  {
