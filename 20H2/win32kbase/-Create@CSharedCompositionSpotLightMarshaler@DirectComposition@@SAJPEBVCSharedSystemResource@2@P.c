/*
 * XREFs of ?Create@CSharedCompositionSpotLightMarshaler@DirectComposition@@SAJPEBVCSharedSystemResource@2@PEAPEAV12@@Z @ 0x1C00AFB20
 * Callers:
 *     CreateSharedCompositionSpotLightMarshaler @ 0x1C00AFAE0 (CreateSharedCompositionSpotLightMarshaler.c)
 * Callees:
 *     Win32AllocPoolWithQuotaZInit @ 0x1C0059680 (Win32AllocPoolWithQuotaZInit.c)
 *     ?InitializeFromSharedResource@CSharedCompositionSpotLightMarshaler@DirectComposition@@IEAAJPEBVCSharedSystemResource@2@@Z @ 0x1C00AFBB8 (-InitializeFromSharedResource@CSharedCompositionSpotLightMarshaler@DirectComposition@@IEAAJPEBVC.c)
        ...
        struct DirectComposition::CSharedCompositionSpotLightMarshaler **a2)
{
  ...
  v4 = (DirectComposition::CSharedCompositionSpotLightMarshaler *)Win32AllocPoolWithQuotaZInit(0xD0uLL, 0x64794344u);
  v5 = v4;
  if ( v4 )
  {
    memset(v4, 0, 0xD0uLL);
