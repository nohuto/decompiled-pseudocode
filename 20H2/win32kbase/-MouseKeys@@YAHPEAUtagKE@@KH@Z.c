/*
 * XREFs of ?MouseKeys@@YAHPEAUtagKE@@KH@Z @ 0x1C0181850
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall MouseKeys(struct tagKE *a1)
{
  ...
  {
    if ( (dword_1C0249BA4 & 4) != 0 && v2 == gNumLockVk && (*((_WORD *)a1 + 1) & 0x8000) == 0 && v4 == 17 )
    {
  ...
  gMKPreviousVk = v2;
  return off_1C0204570[v5](word_1C021FEE0[v5]);
}
