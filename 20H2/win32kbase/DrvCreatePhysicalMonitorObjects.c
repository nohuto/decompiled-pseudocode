/*
 * XREFs of DrvCreatePhysicalMonitorObjects @ 0x1C00C6610
 * Callers:
...
LABEL_41:
              ...
              if ( qword_1C024F310 )
              {
                DeviceFromNameAndValidateDevice = qword_1C024F310();
                i = v33;
              }
              else
              {
              ...
              if ( DeviceFromNameAndValidateDevice < 0 )
                goto LABEL_42;
              DeviceFromNameAndValidateDevice = qword_1C024F318
                                              ? qword_1C024F318(
                                                  v22 + 4 * (v21 + 2),
