/*
 * XREFs of ??0MouseInputDataEx@CMouseProcessor@@QEAA@PEBU_MOUSE_INPUT_DATA@@W4MouseInputDataProcessingPrivate@@W4MouseInputDataProcessingOptions@@@Z @ 0x1C00312B8
 * Callers:
 ...
 * Callees:
 *     ?Now@EventTime@CMouseProcessor@@SA?AU12@XZ @ 0x1C0031360 (-Now@EventTime@CMouseProcessor@@SA-AU12@XZ.c)
...
__int64 __fastcall CMouseProcessor::MouseInputDataEx::MouseInputDataEx(__int64 a1, __int64 a2, int a3, unsigned int a4)
{
  ...
  v14 = *(_OWORD *)v8;
  v15 = v9;
  ((void (__fastcall *)(__int64, __int64, __int128 *, _QWORD, int *, _QWORD))CMouseProcessor::MouseInputDataEx::MouseInputDataEx)(
    a1,
    a2,
    &v14,
    a4,
