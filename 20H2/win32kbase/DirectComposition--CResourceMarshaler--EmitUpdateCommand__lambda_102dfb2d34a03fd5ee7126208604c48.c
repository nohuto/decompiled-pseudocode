/*
 * XREFs of DirectComposition::CResourceMarshaler::EmitUpdateCommand__lambda_102dfb2d34a03fd5ee7126208604c48c___lambda_0bc58e56ac4a9aab059b2d62d77c79a6___ @ 0x1C01E07AC
 * Callers:
    ...
    *((_DWORD *)v13 + 4) = 4 * v12;
    ...
    if ( (_DWORD)v12 )
    {
      ...
      do
      {
        v16 = *a3;
        *a3 = v16 + 1;
        *v14++ = *(_DWORD *)(*(_QWORD *)(*(_QWORD *)(*(_QWORD *)v6 + 96LL) + 8 * v16) + 24LL);
        --v15;
      }
      while ( v15 );
    }
