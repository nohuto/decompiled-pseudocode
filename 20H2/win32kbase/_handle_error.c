/*
 * XREFs of _handle_error @ 0x1C00D30A4
 * Callers:
 *     exp @ 0x1C00D28A8 (exp.c)
 *     log @ 0x1C00D2C90 (log.c)
 * Callees:
 *     __security_check_cookie @ 0x1C00CBC40 (__security_check_cookie.c)
 *     _call_matherr @ 0x1C00D2F70 (_call_matherr.c)
 *     _exception_enabled @ 0x1C00D2FE0 (_exception_enabled.c)
 *     _raise_exc @ 0x1C00D32A0 (_raise_exc.c)
