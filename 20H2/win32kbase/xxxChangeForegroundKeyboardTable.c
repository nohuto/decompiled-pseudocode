/*
 * XREFs of xxxChangeForegroundKeyboardTable @ 0x1C00882B0
 * Callers:
...
void __fastcall xxxChangeForegroundKeyboardTable(struct tagKL *a1, struct tagKL *a2)
{
  ...
  if ( a2 == (struct tagKL *)qword_1C024AD38 )
    return;
  v10[1] = a2;
  v10[0] = &gspklGlobalActive;
  HMAssignmentLock((__int64)v10, (__int64)a2);
  ApiSetEditionResetIMEConversionStatus(a1, a2);
  v5 = qword_1C024AD38 == 0;
  qword_1C024AD38 = (__int64)a2;
  if ( v5 )
  {
LABEL_4:
