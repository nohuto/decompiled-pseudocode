/*
 * XREFs of ?ProcessInjectedInput@CTouchProcessor@@QEAAXPEAX0_NK1@Z @ 0x1C0195458
 * Callers:
        ...
        bool a6)
{
  ...
  if ( v11 )
  {
    ...
    if ( v17 )
    {
      ...
      v24 = (_QWORD *)((char *)gptiCurrent + 1144);
      v25 = *((_QWORD *)gptiCurrent + 143);
      if ( *(struct tagTHREADINFO **)(v25 + 8) != (struct tagTHREADINFO *)((char *)gptiCurrent + 1144) )
        __fastfail(3u);
      *((_QWORD *)v22 + 4) = v24;
      *v23 = v25;
      *(_QWORD *)(v25 + 8) = v23;
