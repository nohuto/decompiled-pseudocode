/*
 * XREFs of ?PostMouseMoveToInputDest@CMouseProcessor@@AEAAXAEBVCInputDest@@PEBU_InputDeviceHandle@@AEBUtagLOGICALPOINT@@W4PostMouseMoveOptions@@PEAU_mouseCursorEvent@@@Z @ 0x1C0032A74
 * Callers:
        ...
        __int64 a6)
{
  ...
  v15 = QHelper::_anonymous_namespace_::GetQ(a2, v11);
  if ( v15 )
