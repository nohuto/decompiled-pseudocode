/*
 * XREFs of ?Create@CSharedReadScalarMarshaler@DirectComposition@@SAJPEBVCSharedSystemResource@2@PEAPEAV12@@Z @ 0x1C01F3008
 * Callers:
 *     CreateSharedReadScalarMarshaler @ 0x1C01F31E0 (CreateSharedReadScalarMarshaler.c)
 * Callees:
