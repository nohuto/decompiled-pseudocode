/*
 * XREFs of ?ShouldDeliverWheelEventToInputDest@CMouseProcessor@@AEBA_NAEBVCWheelEvent@1@AEBVCInputDest@@@Z @ 0x1C01BC464
 * Callers:
        ...
        __int64 a4)
{
  ...
  if ( !ThreadInfo || (*(_DWORD *)(*((_QWORD *)ThreadInfo + 53) + 820LL) & 0x30) != 0 )
  {
    ...
    if ( !v9 || !(unsigned int)IsShellProcess(*((_QWORD *)v9 + 53)) )
      return 1;
  }
  return v4;
}
