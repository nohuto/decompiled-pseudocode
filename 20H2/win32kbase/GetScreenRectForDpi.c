/*
 * XREFs of GetScreenRectForDpi @ 0x1C002F254
 * Callers:
...
LABEL_3:
  ...
  if ( *(_DWORD *)v4 == 1 )
  {
    v5 = *(__m128i *)GetMonitorRectForDpi(&v18, *(_QWORD *)(gpDispInfo + 96), a2);
    goto LABEL_3;
  }
  ...
  if ( v7 )
  {
    ...
    do
    {
      ...
      {
        MonitorRectForDpi = (__m128i *)GetMonitorRectForDpi(v19, v7, a2);
