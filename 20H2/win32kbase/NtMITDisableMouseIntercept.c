/*
 * XREFs of NtMITDisableMouseIntercept @ 0x1C012C670
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall NtMITDisableMouseIntercept(__int64 a1)
{
  ...
  if ( InputTraceLogging::Perf::s_userCritLoggingEnabled )
  {
    ...
    v61 = v4;
    if ( v4 && (*(int *)(v4 + 24) > 0 || *(_DWORD *)(v61 + 48)) )
    {
...
LABEL_61:
  ...
  if ( MouseProcessor )
    v56 = CMouseProcessor::MouseInterceptState::Disable(MouseProcessor + 3696);
  else
    v56 = 0;
  if ( !v56 )
  {
  ...
  v1 = 1LL;
LABEL_62:
  UserSessionSwitchLeaveCrit(v53, v50, v54, v55);
  return v1;
}
