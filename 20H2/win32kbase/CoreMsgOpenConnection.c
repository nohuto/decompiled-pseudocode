/*
 * XREFs of CoreMsgOpenConnection @ 0x1C00A9D3C
 * Callers:
 ...
 *     UserCoreMsgOpenConnectionHandle @ 0x1C01AC8C0 (UserCoreMsgOpenConnectionHandle.c)
 * Callees:
