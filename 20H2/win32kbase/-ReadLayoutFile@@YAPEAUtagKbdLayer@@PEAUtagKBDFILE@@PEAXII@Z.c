/*
 * XREFs of ?ReadLayoutFile@@YAPEAUtagKbdLayer@@PEAUtagKBDFILE@@PEAXII@Z @ 0x1C008A66C
 * Callers:
 ...
 *     strcmp_0 @ 0x1C00D2881 (strcmp_0.c)
...
LABEL_126:
                                if ( a4 )
                                {
                                  ...
                                  v78 = qword_1C0251378 ? qword_1C0251378() : -1073741637;
                                  if ( v78 >= 0 && !(qword_1C0251380 ? qword_1C0251380(v6) : 0) )
                                    break;
                                  *((_QWORD *)a1 + 6) = v6;
                                }
                                if ( v30 )
