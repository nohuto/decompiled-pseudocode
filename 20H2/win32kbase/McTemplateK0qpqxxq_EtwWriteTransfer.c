/*
 * XREFs of McTemplateK0qpqxxq_EtwWriteTransfer @ 0x1C0129150
 * Callers:
 ...
 *     EtwTraceDCompDeferBatchEvent @ 0x1C00684E0 (EtwTraceDCompDeferBatchEvent.c)
 *     ?KeepOrDeferBatches@CConnection@DirectComposition@@AEAAX_KPEAPEAVCBatch@2@@Z @ 0x1C01CDBEC (-KeepOrDeferBatches@CConnection@DirectComposition@@AEAAX_KPEAPEAVCBatch@2@@Z.c)
 * Callees:
        ...
        char a9)
{
  ...
  v20 = 8LL;
  v22 = 4LL;
  return McGenEventWrite_EtwWriteTransfer(a1, &DCompDeferBatchEvent, &W32kControlGuid, 7u, &v10);
}
