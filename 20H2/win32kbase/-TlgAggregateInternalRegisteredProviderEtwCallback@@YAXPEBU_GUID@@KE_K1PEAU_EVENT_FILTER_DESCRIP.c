/*
 * XREFs of ?TlgAggregateInternalRegisteredProviderEtwCallback@@YAXPEBU_GUID@@KE_K1PEAU_EVENT_FILTER_DESCRIPTOR@@PEAX@Z @ 0x1C02797F0
 * Callers:
 *     <none>
 * Callees:
 *     _guard_dispatch_icall_nop @ 0x1C00D36F0 (_guard_dispatch_icall_nop.c)
 *     LookUpTableFlushComplete @ 0x1C0278C60 (LookUpTableFlushComplete.c)
 *     LookUpTableFlushPartial @ 0x1C0279670 (LookUpTableFlushPartial.c)
 */
