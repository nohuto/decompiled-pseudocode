/*
 * XREFs of ?CoalesceQFrames@CTouchProcessor@@AEAAHPEBUCPointerInputFrame@@PEAUCPointerQFrame@@PEAU2@@Z @ 0x1C0187A6C
 * Callers:
        ...
        struct CPointerInputFrame *a4)
{
  ...
  struct tagQ *v61; // [rsp+38h] [rbp-8h] BYREF
  unsigned int v63; // [rsp+90h] [rbp+50h] BYREF
  struct CPointerInputFrame *v64; // [rsp+98h] [rbp+58h]
  ...
  while ( 1 )
  {
    ...
    if ( *((_DWORD *)v25 + 2) == *(_DWORD *)a3 )
    {
      ...
      {
        v61 = 0LL;
        NodeQueuedMessage = CTouchProcessor::FindNodeQueuedMessage((CTouchProcessor *)this, v25, v28, &v61);
        ...
        if ( NodeQueuedMessage )
        {
          if ( *((_QWORD *)NodeQueuedMessage + 1) )
          {
            ...
            *(_QWORD *)(*(_QWORD *)(v21 + 8) + 16LL * v35) = v61;
      ...
      if ( !(unsigned int)CTouchProcessor::CanCoalesceIgnoreNode(this, v64, v25, (enum CPointerCoalesce *)&v63) )
        break;
    }
LABEL_35:
    v22 = *((unsigned int *)a2 + 12);
        ...
        if ( (_DWORD)v42 )
        {
          ...
          do
          {
              ...
              && !(unsigned int)CPointerInfoNode::IsFullyReleased((CPointerInfoNode *)v43) )
            {
              ...
              CTouchProcessor::CoalesceNodeWithPrevious(this, a2, v64, (struct CPointerInfoNode *)v43, v41, 1);
              if ( *(_QWORD *)(v43 + 16) == *(_QWORD *)(v49 + 40) )
              ...
              if ( (unsigned int)Feature_Servicing_TelemetryForCollectingDataOnIdSysPeek__private_IsEnabled() )
              {
                if ( *((_QWORD *)v61 + 10) == v49 )
                  MicrosoftTelemetryAssertTriggeredNoArgsKM(v55, v54, v56, v57);
              }
              ApiSetEditionDelQEntry((__int64)v61 + 24, v49);
              ++v44;
            }
            v42 = *((unsigned int *)a2 + 12);
            ++v41;
...
LABEL_77:
  v58 = v63;
  v59 = *((_DWORD *)a3 + 35) & 0xFFFFFFF9 | (2 * ((2 * (v23 & 1)) | v23 & 1));
  *((_DWORD *)a3 + 35) = v59;
  CTouchProcessor::TrackCoalesceOnReassign(v59, a3, v58);
