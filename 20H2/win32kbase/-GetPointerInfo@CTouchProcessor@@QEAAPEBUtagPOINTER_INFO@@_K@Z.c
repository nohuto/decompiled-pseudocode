/*
 * XREFs of ?GetPointerInfo@CTouchProcessor@@QEAAPEBUtagPOINTER_INFO@@_K@Z @ 0x1C018FFF0
 * Callers:
 *     <none>
 * Callees:
...
LABEL_18:
    LOBYTE(v4) = 5;
    WPP_RECORDER_SF_(v5->DeviceExtension, v4, 7, v6, (__int64)&WPP_50814762fbc63e38c7e5eacf83347307_Traceguids);
LABEL_19:
    v13 = 0LL;
    goto LABEL_24;
  }
