/*
 * XREFs of RIMCreateHidDesc @ 0x1C006E4C4
 * Callers:
...
__int64 __fastcall RIMCreateHidDesc(__int64 a1, __int64 a2, __int64 a3)
{
  ...
  PVOID v59; // [rsp+58h] [rbp-71h] BYREF
  ...
  int v64; // [rsp+98h] [rbp-31h]
  unsigned __int16 v65[32]; // [rsp+A0h] [rbp-29h] BYREF
  ...
  *(_QWORD *)OutputBuffer = 0LL;
  ...
  {
    v11 = RIMGetDeviceObjectPointer((int)a2 + 208, v7, v9, (unsigned int)&Handle, (__int64)&v59, (__int64)&Object);
    if ( v11 < 0 )
    {
      if ( WPP_RECORDER_INITIALIZED != (_UNKNOWN *)&WPP_RECORDER_INITIALIZED )
      {
...
LABEL_73:
        ...
        Caps = RIMHidGetCaps(a1, v17, v23, v65);
        if ( Caps != 1114112 )
        {
          if ( WPP_RECORDER_INITIALIZED != (_UNKNOWN *)&WPP_RECORDER_INITIALIZED )
          {
        ...
        v31 = v65[0];
        if ( (unsigned int)rimIsExplicitRimUsagesMatchingUsages(a1, v65[1], v65[0]) )
        {
...
LABEL_86:
            ...
            v6 = RIMAllocateHidConfigDesc(a1, a2, v17, v23, v65, OutputBuffer);
            if ( !v6 )
            {
              if ( WPP_RECORDER_INITIALIZED != (_UNKNOWN *)&WPP_RECORDER_INITIALIZED )
              {
...
LABEL_47:
        if ( (unsigned int)ApiSetInkProcessorIsInkDevice(v33, v31, (char *)&OutputBuffer[1] + 2)
          && (*(_DWORD *)(a1 + 84) & 4) == 0 )
        {
          if ( WPP_RECORDER_INITIALIZED == (_UNKNOWN *)&WPP_RECORDER_INITIALIZED )
            goto LABEL_37;
        ...
        v6 = RIMAllocateHidDesc(a1, a2, v23, v65, (__int64)OutputBuffer, (__int64)v17, (__int64)v16);
        if ( !v6 )
        {
          if ( WPP_RECORDER_INITIALIZED == (_UNKNOWN *)&WPP_RECORDER_INITIALIZED )
            goto LABEL_37;
...
LABEL_51:
        ...
        v46 = RIMSearchHidTLCInfo(v65[1], v65[0]);
        v47 = v46;
        if ( v46 )
        {
          if ( WPP_RECORDER_INITIALIZED != (_UNKNOWN *)&WPP_RECORDER_INITIALIZED )
        ...
        {
          v47 = RIMAllocateAndLinkHidTLCInfo(v65[1], v65[0]);
          if ( !v47 )
          {
