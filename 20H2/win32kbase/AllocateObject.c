/*
 * XREFs of AllocateObject @ 0x1C003D5C0
 * Callers:
...
_QWORD *__fastcall AllocateObject(size_t Size, __int64 a2, int a3)
{
  ...
  {
    v10 = (unsigned int)(((_DWORD)a2 << 24) + 808478791);
    if ( a3 )
    {
  ...
  else
  {
    ...
    if ( qword_1C0250C50 )
      v7 = qword_1C0250C50(Size, a2, 1LL);
    else
      v7 = -1073741637;
    if ( v7 >= 0 && qword_1C0250C58 )
      v8 = (_QWORD *)qword_1C0250C58(v6);
    else
      v8 = 0LL;
    if ( v8 )
    {
