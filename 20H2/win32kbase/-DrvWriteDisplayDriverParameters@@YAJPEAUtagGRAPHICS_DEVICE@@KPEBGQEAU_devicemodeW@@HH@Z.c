/*
 * XREFs of ?DrvWriteDisplayDriverParameters@@YAJPEAUtagGRAPHICS_DEVICE@@KPEBGQEAU_devicemodeW@@HH@Z @ 0x1C00101C8
 * Callers:
 *     DrvUpdateDisplayDriverParameters @ 0x1C00100D4 (DrvUpdateDisplayDriverParameters.c)
 * Callees:
 *     ?DrvWriteAttachedSettings@@YAJKPEBGQEAU_devicemodeW@@HPEAK@Z @ 0x1C0010658 (-DrvWriteAttachedSettings@@YAJKPEBGQEAU_devicemodeW@@HPEAK@Z.c)
    ...
    if ( a4 )
    {
      ...
      if ( v9 >= 0 )
      {
        do
        {
          if ( v15 >= v17 )
            break;
          v16 = RtlWriteRegistryValue(0x40000000u, a3, off_1C0204120[v15], 4u, &v21[v15], 4u);
          ++v15;
          v9 = v16;
        }
        while ( v16 >= 0 );
