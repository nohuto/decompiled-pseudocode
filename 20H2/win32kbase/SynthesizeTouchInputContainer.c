/*
 * XREFs of SynthesizeTouchInputContainer @ 0x1C01AE500
 * Callers:
 *     ?OnTouchSynthesizeNotification@CHidInput@@EEAAJXZ @ 0x1C01A4FC0 (-OnTouchSynthesizeNotification@CHidInput@@EEAAJXZ.c)
 * Callees:
