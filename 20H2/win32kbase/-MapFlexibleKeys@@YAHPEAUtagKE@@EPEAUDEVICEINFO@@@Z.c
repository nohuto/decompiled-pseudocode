/*
 * XREFs of ?MapFlexibleKeys@@YAHPEAUtagKE@@EPEAUDEVICEINFO@@@Z @ 0x1C01AAA90
 * Callers:
 *     ?MapScancode@@YAHPEAUtagKE@@PEAEPEAUDEVICEINFO@@@Z @ 0x1C01AAD74 (-MapScancode@@YAHPEAUtagKE@@PEAEPEAUDEVICEINFO@@@Z.c)
 * Callees:
 *     __security_check_cookie @ 0x1C00CBC40 (__security_check_cookie.c)
 *     ?IsKeyDownSpecified@@YAHEPEBE@Z @ 0x1C01AA92C (-IsKeyDownSpecified@@YAHEPEBE@Z.c)
...
__int64 __fastcall MapFlexibleKeys(struct tagKE *a1, char a2, struct DEVICEINFO *a3)
{
  ...
  while ( 1 )
  {
    ...
    if ( *((__int16 *)v5 + 1) < 0 && v6 == iLastMatchedTarget )
      break;
    v10 = 0;
    v11 = (char *)&unk_1C0220668;
    do
    {
      v12 = (unsigned __int8)*v11;
      if ( (_BYTE)v12 == bLastVKDown )
      {
        bLastVKDown = 0;
      }
      else
      {
        ...
        LOWORD(v7) = 1;
        if ( (((unsigned __int8)(1 << (2 * (v12 & 3))) & gafRawKeyState[v12 >> 2]) == 0) == v13 )
          break;
      }
      ++v10;
      ++v11;
