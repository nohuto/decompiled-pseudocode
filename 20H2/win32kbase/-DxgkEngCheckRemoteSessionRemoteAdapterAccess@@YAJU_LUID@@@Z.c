/*
 * XREFs of ?DxgkEngCheckRemoteSessionRemoteAdapterAccess@@YAJU_LUID@@@Z @ 0x1C00B67F0
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall DxgkEngCheckRemoteSessionRemoteAdapterAccess(struct _LUID a1, __int64 a2)
{
  ...
  if ( (unsigned __int16)(gProtocolType - 1) <= 0xFFFDu )
  {
    if ( Object )
    {
      if ( (PVOID)PsGetCurrentProcess(65533LL, a2) != gpepCSRSS && !UserIsCurrentProcessDwm(v6, v5) )
      {
        ProductType = 0;
        ...
        if ( ProductType == NtProductServer
          ...
          && __PAIR64__(HighPart, LowPart) != qword_1C024B244 )
        {
