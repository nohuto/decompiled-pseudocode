/*
 * XREFs of ?OpenSharedHandle@CHostVisualMarshaler@DirectComposition@@UEAAJPEAPEAX@Z @ 0x1C0065330
 * Callers:
 *     <none>
 * Callees:
...
NTSTATUS __fastcall DirectComposition::CHostVisualMarshaler::OpenSharedHandle(
