/*
 * XREFs of ?PowerMonitorDimStateTelemetry@@YAXPEAU_DIM_UNDIM_TELEMETRY_DATA@@@Z @ 0x1C0071448
 * Callers:
 ...
 *     TlgAggregateFlush @ 0x1C01FA1F4 (TlgAggregateFlush.c)
 */
...
void __fastcall PowerMonitorDimStateTelemetry(struct _DIM_UNDIM_TELEMETRY_DATA *a1)
{
  ...
  if ( *((_BYTE *)a1 + 5) )
  {
    if ( (unsigned int)dword_1C023F378 > 5 && tlgKeywordOn((__int64)&dword_1C023F378, 0x400000000100LL) )
    {
      v5 = *((_BYTE *)v3 + 6);
  ...
  else
  {
    ...
    if ( (dword_1C024AE80 & 1) == 0 )
    {
      dword_1C024AE80 |= 1u;
      qword_1C024AE88 = MEMORY[0xFFFFF78000000008] + 36000000000LL;
    }
    if ( MEMORY[0xFFFFF78000000008] > (unsigned __int64)qword_1C024AE88 )
    {
      qword_1C024AE88 = MEMORY[0xFFFFF78000000008] + 36000000000LL;
      TlgAggregateFlush();
    }
