/*
 * XREFs of ?EmitCreationCommand@CCrossChannelChildVisualMarshaler@DirectComposition@@MEAA_NPEAPEAVCBatch@2@@Z @ 0x1C0004A30
 * Callers:
 *     <none>
 * Callees:
...
{
  return DirectComposition::CResourceMarshaler::EmitDuplicateHelper(this, a2, *((unsigned int *)this + 92));
}
