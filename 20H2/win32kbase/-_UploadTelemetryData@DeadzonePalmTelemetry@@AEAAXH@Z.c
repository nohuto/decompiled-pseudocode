/*
 * XREFs of ?_UploadTelemetryData@DeadzonePalmTelemetry@@AEAAXH@Z @ 0x1C017F5EC
 * Callers:
 *     ?ClearSession@DeadzonePalmTelemetry@@QEAAXXZ @ 0x1C017ED10 (-ClearSession@DeadzonePalmTelemetry@@QEAAXXZ.c)
 *     ?UpdateTelemetryBuffer@DeadzonePalmTelemetry@@QEAAXKKH@Z @ 0x1C017EF6C (-UpdateTelemetryBuffer@DeadzonePalmTelemetry@@QEAAXKKH@Z.c)
 * Callees:
 ...
 *     ?RtlStringCchLengthA@@YAJPEBD_KPEA_K@Z @ 0x1C017EDA4 (-RtlStringCchLengthA@@YAJPEBD_KPEA_K@Z.c)
 *     ?RtlStringCchPrintfA@@YAJPEAD_KPEBDZZ @ 0x1C017EE04 (-RtlStringCchPrintfA@@YAJPEAD_KPEBDZZ.c)
    ...
    *((_DWORD *)this + 1) = v6;
    if ( v6 )
    {
      ...
      do
      {
        ...
        if ( v16 + 32 >= 0x800 )
        {
          if ( (unsigned int)dword_1C02431A8 > 5 && tlgKeywordOn((__int64)&dword_1C02431A8, 0x400000000000LL) )
          {
            v17 = (__int64)v2;
            _tlgWriteTemplate<long (_tlgProvider_t const *,void const *,_GUID const *,_GUID const *,unsigned int,_EVENT_DATA_DESCRIPTOR *),&long _tlgWriteTransfer_EtwWriteTransfer(_tlgProvider_t const *,void const *,_GUID const *,_GUID const *,unsigned int,_EVENT_DATA_DESCRIPTOR *),_GUID const *,_GUID const *>::Write<_tlgWrapSz<char>>(
              (__int64)&dword_1C02431A8,
              byte_1C02169A6,
              0LL,
              0LL,
              (void **)&v17);
