/*
 * XREFs of rimAbIsPointerSuppressedByPointer @ 0x1C0159A28
 * Callers:
...
__int64 __fastcall rimAbIsPointerSuppressedByPointer(__int128 *a1, unsigned int *a2, unsigned int *a3, __int64 a4)
{
  int v4; // ebp
  unsigned int v8; // esi
  __int64 v9; // rcx
