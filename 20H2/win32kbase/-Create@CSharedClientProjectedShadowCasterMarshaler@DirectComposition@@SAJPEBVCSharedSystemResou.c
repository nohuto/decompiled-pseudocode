/*
 * XREFs of ?Create@CSharedClientProjectedShadowCasterMarshaler@DirectComposition@@SAJPEBVCSharedSystemResource@2@PEAPEAV12@@Z @ 0x1C01F3E60
 * Callers:
 *     CreateSharedClientProjectedShadowCasterMarshaler @ 0x1C01F4050 (CreateSharedClientProjectedShadowCasterMarshaler.c)
 * Callees:
