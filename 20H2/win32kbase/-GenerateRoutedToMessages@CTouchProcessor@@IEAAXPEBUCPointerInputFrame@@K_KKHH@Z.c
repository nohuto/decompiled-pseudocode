/*
 * XREFs of ?GenerateRoutedToMessages@CTouchProcessor@@IEAAXPEBUCPointerInputFrame@@K_KKHH@Z @ 0x1C018DDC0
 * Callers:
        ...
        int a7)
{
  ...
  if ( (*(_DWORD *)v11 & 0x40) != 0 )
  {
    ...
    {
      LOBYTE(v12) = 2;
      WPP_RECORDER_SF_LL(v13, v12, v14, 222, v16, *(_DWORD *)(v11 + 172), *(_WORD *)(v11 + 160));
    }
