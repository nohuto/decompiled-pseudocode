/*
 * XREFs of ?Create@CVisualTargetMarshaler@DirectComposition@@SAJPEBVCSharedSystemResource@2@PEAPEAV12@@Z @ 0x1C00A0C88
 * Callers:
 *     CreateVisualTargetMarshaler @ 0x1C00A0C30 (CreateVisualTargetMarshaler.c)
 * Callees:
