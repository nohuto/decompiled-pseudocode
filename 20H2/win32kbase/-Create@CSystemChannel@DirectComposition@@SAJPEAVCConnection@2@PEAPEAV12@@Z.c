/*
 * XREFs of ?Create@CSystemChannel@DirectComposition@@SAJPEAVCConnection@2@PEAPEAV12@@Z @ 0x1C00B65F4
 * Callers:
        ...
        struct DirectComposition::CSystemChannel **a2)
{
  ...
  v4 = (DirectComposition::CApplicationChannel *)Win32AllocPoolZInit(0x320uLL, 0x63734344u);
  v5 = v4;
  if ( v4 )
  {
