        ...
        const WCHAR **a7)
{
  ...
  v17 = 16LL;
  v15 = 8LL;
  return tlgWriteTransfer_EtwWriteTransfer((__int64)&dword_1C0243450, a2, 0LL, 0LL, 5u, &v13);
}
