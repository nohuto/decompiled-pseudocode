/*
 * XREFs of ?xxxMKMoveConstCursorTimer@@YAXPEAUtagWND@@I_K_J@Z @ 0x1C0182A30
 * Callers:
 *     <none>
 * Callees:
...
void __fastcall xxxMKMoveConstCursorTimer(struct tagWND *a1, __int64 a2, __int64 a3, __int64 a4)
{
  ...
  {
LABEL_6:
    a2 = giMouseMoveTable % (unsigned int)(unsigned __int8)byte_1C0249AE1;
    v5 = (unsigned __int8)byte_1C0249AE2[a2];
    giMouseMoveTable = a2 + 1;
    if ( !v5 )
      return;
    goto LABEL_7;
  }
  v5 = 4 * (unsigned __int8)byte_1C0249AE2[0];
LABEL_7:
