/*
 * XREFs of ?BoundPoint@CCursorClip@@QEAA?AW4ClipResult@@UtagPOINT@@W4BoundPointOptions@@W4InputTracing_MouseUpdatePositionReason@@PEAU3@@Z @ 0x1C002EE40
 * Callers:
 *     <none>
 * Callees:
 ...
 *     ?ApplyAppClip@CCursorClip@@AEAA_NUtagPOINT@@PEAU2@@Z @ 0x1C002F0A4 (-ApplyAppClip@CCursorClip@@AEAA_NUtagPOINT@@PEAU2@@Z.c)
        ...
        struct tagPOINT *a5)
{
  ...
  *a5 = a2;
  ...
  if ( (unsigned int)dword_1C0244A70 > 4 && (unsigned __int8)tlgKeywordOn(&dword_1C0244A70, 64LL, v9, v10) )
  {
    y = v11->y;
    x = v11->x;
    LODWORD(v23) = a1[18];
