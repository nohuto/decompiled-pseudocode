/*
 * XREFs of ?InitializeFromSharedResource@CHostVisualMarshaler@DirectComposition@@QEAAJPEBVCSharedSystemResource@2@@Z @ 0x1C0099DF0
 * Callers:
 ...
 * Callees:
 *     ?Initialize@CVisualMarshaler@DirectComposition@@UEAAJXZ @ 0x1C0099E50 (-Initialize@CVisualMarshaler@DirectComposition@@UEAAJXZ.c)
 */
