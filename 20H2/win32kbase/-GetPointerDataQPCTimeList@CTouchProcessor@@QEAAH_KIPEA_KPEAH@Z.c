/*
 * XREFs of ?GetPointerDataQPCTimeList@CTouchProcessor@@QEAAH_KIPEA_KPEAH@Z @ 0x1C018ECC0
 * Callers:
...
LABEL_28:
    LOBYTE(v9) = 5;
    WPP_RECORDER_SF_(v13->DeviceExtension, v9, 7, v14, (__int64)&WPP_50814762fbc63e38c7e5eacf83347307_Traceguids);
LABEL_29:
    v25 = 0;
    goto LABEL_44;
  }
