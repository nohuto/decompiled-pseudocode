/*
 * XREFs of ?DestroyHandleFirstPass@@YAXPEAU_HANDLEENTRY@@@Z @ 0x1C0120040
 * Callers:
 *     <none>
 * Callees:
...
void __fastcall DestroyHandleFirstPass(struct _HANDLEENTRY *a1, __int64 a2, __int64 a3, __int64 a4)
{
  _QWORD *v5; // rdi
  __int64 v6; // rax
  __int64 v7; // rbx
  ...
  v6 = (unsigned int)((a1 - qword_1C0248D48) >> 5);
  v7 = 3 * v6;
  if ( *((_BYTE *)a1 + 24) == 22 )
