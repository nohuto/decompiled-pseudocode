/*
 * XREFs of ?Configure@COPMProtectedOutput@@QEAAJQEAU_DXGKMDT_OPM_CONFIGURE_PARAMETERS@@KPEBE@Z @ 0x1C014133C
 * Callers:
 ...
 *     ??1CAutoMutex@OPM@@QEAA@XZ @ 0x1C00A36C0 (--1CAutoMutex@OPM@@QEAA@XZ.c)
 *     ?OPMAllocateMemory@OPM@@YAPEAX_KW4_POOL_TYPE@@@Z @ 0x1C00B8370 (-OPMAllocateMemory@OPM@@YAPEAX_KW4_POOL_TYPE@@@Z.c)
