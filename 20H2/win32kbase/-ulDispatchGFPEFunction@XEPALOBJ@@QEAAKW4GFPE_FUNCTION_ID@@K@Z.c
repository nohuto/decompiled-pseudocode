/*
 * XREFs of ?ulDispatchGFPEFunction@XEPALOBJ@@QEAAKW4GFPE_FUNCTION_ID@@K@Z @ 0x1C00183F0
 * Callers:
 ...
 * Callees:
 *     ?ulIndexedGetMatchFromPalentry@@YAKPEAVPALETTE@@K@Z @ 0x1C00184F0 (-ulIndexedGetMatchFromPalentry@@YAKPEAVPALETTE@@K@Z.c)
