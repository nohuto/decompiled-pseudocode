/*
 * XREFs of ?bInverse@EXFORMOBJ@@QEAAHAEAVMATRIX@@@Z @ 0x1C00A0280
 * Callers:
 *     ?vInit@EXFORMOBJ@@QEAAXAEAVXDCOBJ@@KH@Z @ 0x1C005B8F0 (-vInit@EXFORMOBJ@@QEAAXAEAVXDCOBJ@@KH@Z.c)
 * Callees:
 *     ?bIsZero@EFLOAT@@QEBAHXZ @ 0x1C005B8CC (-bIsZero@EFLOAT@@QEBAHXZ.c)
  ...
  *(_DWORD *)(*(_QWORD *)this + 32LL) = *((_DWORD *)a2 + 8) & 0xFFFFFFE7 | 0x10;
  if ( (*((_DWORD *)a2 + 8) & 2) != 0 )
  {
    ...
    *(_DWORD *)(v2 + 20) = *((_DWORD *)a2 + 5);
    v3 = COERCE_FLOAT(*(_DWORD *)(v2 + 16) ^ _xmm) * 0.0625;
    *(_DWORD *)(v2 + 20) ^= _xmm;
    *(float *)(v2 + 16) = v3;
  ...
  if ( !EFLOAT::bIsZero((EFLOAT *)&v13) )
  {
    ...
    *(float *)(v2 + 12) = *(float *)v6 / v5;
    ...
    if ( (v9 & 1) != 0 )
    {
      *(float *)(v2 + 16) = *(float *)v2 * *(float *)(v6 + 16);
      v10 = *(float *)(v2 + 12) * *(float *)(v6 + 20);
    }
    else
    {
      *(float *)(v2 + 16) = (float)(*(float *)(v2 + 8) * *(float *)(v6 + 20))
                          + (float)(*(float *)v2 * *(float *)(v6 + 16));
      v10 = (float)(*(float *)(v2 + 12) * *(float *)(v6 + 20)) + (float)(*(float *)(v2 + 4) * *(float *)(v6 + 16));
    }
    *(float *)(v2 + 20) = v10;
    LODWORD(v11) = *(_DWORD *)(v2 + 16) ^ _xmm;
    *(float *)(v2 + 16) = v11;
    *(_DWORD *)(v2 + 20) = LODWORD(v10) ^ _xmm;
    if ( (unsigned int)bFToL(v11, (int *)(v2 + 24), 6u)
      && (unsigned int)bFToL(*(float *)(v2 + 20), (int *)(v2 + 28), v12) )
    {
      return 1LL;
    }
  }
