/*
 * XREFs of ?OpenSharedResource@CApplicationChannel@DirectComposition@@QEAAJIPEAXI_N@Z @ 0x1C0064C10
 * Callers:
        ...
        bool a5)
{
  ...
  v7 = a4;
  LOBYTE(a4) = a5;
  inserted = DirectComposition::CApplicationChannel::OpenInternalSharedResource(this, a3, v7, a4, &v11);
  if ( inserted >= 0 )
  {
    v9 = v11;
