/*
 * XREFs of ?_UpdateLastInputTime@CInputGlobals@@AEAAX_KW4_LINP_SOURCE@@@Z @ 0x1C006580C
 * Callers:
...
char __fastcall CInputGlobals::_UpdateLastInputTime(__int64 a1, __int64 a2, int a3)
{
  ...
  *(_QWORD *)(a1 + 16) = a2;
  ...
  {
    LOBYTE(v5) = byte_1C0243738 - 1;
    if ( (unsigned __int8)(byte_1C0243738 - 1) > 2u && (qword_1C0243720 & 0x2000000000008000LL) != 0 )
    {
      LOBYTE(v5) = 0;
      if ( (qword_1C0243728 & 0x2000000000008000LL) == qword_1C0243728 && giPowerOffTimeOutMs > 0 )
      {
