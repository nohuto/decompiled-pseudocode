/*
 * XREFs of ?InitDomainLocks@@YAJXZ @ 0x1C00B5E58
 * Callers:
 *     InitCreateUserCrit @ 0x1C0293B84 (InitCreateUserCrit.c)
 * Callees:
 *     ?LockInitialize@tagDomLock@@QEBAJXZ @ 0x1C00B6050 (-LockInitialize@tagDomLock@@QEBAJXZ.c)
 */
...
__int64 InitDomainLocks(void)
{
  ...
  LODWORD(qword_1C024B358) = 0;
  dword_1C024B340 = 0;
  LODWORD(qword_1C024B328) = 0;
