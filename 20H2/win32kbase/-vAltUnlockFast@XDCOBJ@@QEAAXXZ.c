/*
 * XREFs of ?vAltUnlockFast@XDCOBJ@@QEAAXXZ @ 0x1C004BA04
 * Callers:
 ...
 *     ?ReleaseEntryLock@GdiHandleEntryTable@@QEAAXI@Z @ 0x1C00448C0 (-ReleaseEntryLock@GdiHandleEntryTable@@QEAAXI@Z.c)
