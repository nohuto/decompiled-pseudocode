/*
 * XREFs of HMAllocObject @ 0x1C0056580
 * Callers:
...
LABEL_6:
  ...
  if ( (v10 & 0x10) != 0 && a2 )
  {
    ...
    v28 = qword_1C02506F0;
    if ( qword_1C02506F0 )
      v28 = (__int64 (__fastcall *)(_QWORD, _QWORD, _QWORD))qword_1C02506F0(
                                                              a2,
...
LABEL_23:
  ...
  if ( (v10 & 0x40) == 0 )
  {
    ...
    else
    {
      ...
      {
        if ( qword_1C0250C18 )
          v14 = (void **)qword_1C0250C18(33LL, v12, v13);
        else
          v14 = 0LL;
        if ( !v14 )
          goto LABEL_76;
...
LABEL_76:
  ...
  {
    v14 = (void **)Win32AllocPoolZInit(v5);
    if ( !v14 )
      goto LABEL_76;
...
LABEL_24:
  if ( !v14 )
    goto LABEL_76;
  v15 = *v11;
  v16 = (char *)qword_1C0248D48 + 32 * *v11;
  ...
  *v18 = (__int64)v14;
  ...
  v21 = (int)v15 | (unsigned __int64)(*(unsigned __int16 *)((char *)qword_1C0248D48
                                                          + v15 * (unsigned int)dword_1C0248D50
                                                          + 26) << 16);
  *v14 = (void *)v21;
  if ( *(_DWORD *)((char *)&gahti + v40 + 16) )
  {
  ...
  if ( (v10 & 3) != 0 )
  {
    v23 = (unsigned int)PsGetProcessId(**(PEPROCESS **)(v6 + 424));
