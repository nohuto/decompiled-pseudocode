/*
 * XREFs of MicrosoftTelemetryAssertTriggeredWorker @ 0x1C01FA2DC
 * Callers:
 *     MicrosoftTelemetryAssertTriggeredNoArgsKM @ 0x1C01FA2AC (MicrosoftTelemetryAssertTriggeredNoArgsKM.c)
 * Callees:
 *     _tlgKeywordOn @ 0x1C0066CD0 (_tlgKeywordOn.c)
 *     _tlgWriteTransfer_EtwWriteTransfer @ 0x1C00689F0 (_tlgWriteTransfer_EtwWriteTransfer.c)
 *     TakeTelemetryAssertsLock @ 0x1C00BAC00 (TakeTelemetryAssertsLock.c)
 *     __security_check_cookie @ 0x1C00CBC40 (__security_check_cookie.c)
 *     GetImageTuple @ 0x1C01FA25C (GetImageTuple.c)
 *     _tlgCreate1Sz_char @ 0x1C01FA810 (_tlgCreate1Sz_char.c)
 */
...
LABEL_37:
  ...
  v19 = "<unknown>";
  if ( (unsigned int)dword_1C0277040 > 5 && tlgKeywordOn((__int64)&dword_1C0277040, 0x400000000000LL) )
  {
    v34 = 10;
    v65 = &v34;
    v21 = "<unknown>";
    ...
    tlgWriteTransfer_EtwWriteTransfer(
      (__int64)&dword_1C0277040,
      (unsigned __int8 *)dword_1C021C466,
      0LL,
      v25,
      0xBu,
      &v64);
  }
  if ( dword_1C0277078 && !v18 && !KeGetCurrentIrql() )
  {
    ...
    if ( (unsigned int)dword_1C0277040 > 5 && tlgKeywordOn((__int64)&dword_1C0277040, 0x400000000000LL) )
    {
      ...
      tlgWriteTransfer_EtwWriteTransfer(
        (__int64)&dword_1C0277040,
        (unsigned __int8 *)dword_1C021C57D,
        v28,
        0LL,
        v29,
        &v48);
