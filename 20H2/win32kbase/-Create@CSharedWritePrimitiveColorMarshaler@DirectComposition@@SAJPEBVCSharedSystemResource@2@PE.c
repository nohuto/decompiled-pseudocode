/*
 * XREFs of ?Create@CSharedWritePrimitiveColorMarshaler@DirectComposition@@SAJPEBVCSharedSystemResource@2@PEAPEAV12@@Z @ 0x1C01F2DA4
 * Callers:
 *     CreateSharedWritePrimitiveColorMarshaler @ 0x1C01F2F60 (CreateSharedWritePrimitiveColorMarshaler.c)
 * Callees:
