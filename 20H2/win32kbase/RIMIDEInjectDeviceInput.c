/*
 * XREFs of RIMIDEInjectDeviceInput @ 0x1C01687BC
 * Callers:
 ...
 *     ?RIMIDEInjectionIndexToLinkIndex@@YAHPEAURIMDEV@@KPEAGH@Z @ 0x1C0166A44 (-RIMIDEInjectionIndexToLinkIndex@@YAHPEAURIMDEV@@KPEAGH@Z.c)
