/*
 * XREFs of ?UpdateActivePointer@CTouchProcessor@@QEAAGPEBUCPointerInputFrame@@PEAUtagPOINTEREVENTINT@@PEAUtagCHitTestState@@PEAVCInputDest@@PEAKPEAGPEAIKG@Z @ 0x1C019ADC4
 * Callers:
        ...
        unsigned __int16 a10)
{
  ...
  int v35; // edx
  int v36; // [rsp+20h] [rbp-138h]
  __int16 v37; // [rsp+54h] [rbp-104h]
  _BYTE v39[128]; // [rsp+80h] [rbp-D8h] BYREF
  ...
  if ( NodeById )
  {
    if ( (a3[2].y & 1) == 0 )
    {
      ...
      if ( v24 != v15 )
      {
        ...
        {
          LOBYTE(v17) = 2;
          WPP_RECORDER_SF_LL(v18, v17, v20, 59, v36, v24, v15);
          if ( WPP_RECORDER_INITIALIZED != (_UNKNOWN *)&WPP_RECORDER_INITIALIZED )
          {
...
LABEL_19:
  ...
  Target = (_QWORD *)CTouchProcessor::UpdateInputCaptureAndGetTarget(this, v39, a3, NodeById, y, a4, a7, a8, a9);
  CInputDest::operator=((__int64)a5, Target);
  CInputDest::SetEmpty((CInputDest *)v39, v31, v32, v33);
  *a7 |= v37;
  v34 = *a7 | (2 * (*((_DWORD *)NodeById + 70) & 4));
  *a7 = v34;
  v35 = 2 * (*((_DWORD *)NodeById + 70) & 1);
  LOWORD(v35) = v34 | (2 * (*((_WORD *)NodeById + 140) & 1));
  *a7 = v35;
  *a7 = v35 | (2 * (*((_DWORD *)NodeById + 70) & 2));
