/*
 * XREFs of ?PostMouseMoveToQ@CMouseProcessor@@AEAAXPEAUtagQ@@AEBUtagLOGICALPOINT@@@Z @ 0x1C0031054
 * Callers:
 ...
 *     ?EnsureMoveTime@MouseMoveTimes@CMouseProcessor@@QEAAXXZ @ 0x1C0031274 (-EnsureMoveTime@MouseMoveTimes@CMouseProcessor@@QEAAXXZ.c)
        ...
        __int64 a4)
{
  ...
  v9 = (int)qword_1C024FF00;
  if ( qword_1C024FF00 )
    v9 = qword_1C024FF00(*((_QWORD *)a2 + 11));
  if ( !v9 || (*(_DWORD *)(*(_QWORD *)(*(_QWORD *)(*((_QWORD *)a2 + 11) + 424LL) + 832LL) + 100LL) & 2) == 0 )
  {
