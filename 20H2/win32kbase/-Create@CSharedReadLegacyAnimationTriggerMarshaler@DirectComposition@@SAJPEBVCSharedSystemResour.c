/*
 * XREFs of ?Create@CSharedReadLegacyAnimationTriggerMarshaler@DirectComposition@@SAJPEBVCSharedSystemResource@2@PEAPEAV12@@Z @ 0x1C01F3280
 * Callers:
 *     CreateSharedReadLegacyAnimationTriggerMarshaler @ 0x1C01F3360 (CreateSharedReadLegacyAnimationTriggerMarshaler.c)
 * Callees:
