/*
 * XREFs of NtUserIsMouseInPointerEnabled @ 0x1C01348B0
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall NtUserIsMouseInPointerEnabled(__int64 a1)
{
  ...
  if ( InputTraceLogging::Perf::s_userCritLoggingEnabled )
  {
    ...
    v28 = v3;
    if ( v3 && (*(int *)(v3 + 24) > 0 || *(_DWORD *)(v28 + 48)) )
    {
  ...
  InputTraceLogging::Perf::CritAcquire::~CritAcquire((InputTraceLogging::Perf::CritAcquire *)&v28, v9, v11, v12);
  ...
  if ( v14 )
  {
    ...
    *(LARGE_INTEGER *)(v14 + 8) = PerformanceCounter;
      ...
      && PerformanceCounter.QuadPart - W32KEtwUserCritAcquireDelayShLastTelemetryQPC >= W32KEtwUserCritTelemetryThrottleQPC )
    {
      ...
      {
        v26[0] = 1000000 * v16 / gliQpcFreq.QuadPart;
        McTemplateK0xqx_EtwWriteTransfer(
  ...
  v20 = *(_QWORD *)(W32GetThreadWin32Thread((__int64)KeGetCurrentThread()) + 424);
  v21 = (*(_DWORD *)(v20 + 820) >> 2) & 1;
  UserSessionSwitchLeaveCrit(v20, v22, v23, v24);
  return v21;
}
