/*
 * XREFs of ?InitializeMonitorBrightnessDiagnosticsPacket@@YAXPEAU_DXGK_DIAG_MONITOR_BRIGHTNESS_PACKET_EX@@H@Z @ 0x1C0072158
 * Callers:
        ...
        char a2)
{
  ...
  *((_DWORD *)a1 + 14) = dword_1C024B170;
  *((_DWORD *)a1 + 15) = dword_1C024B15C;
  *((_DWORD *)a1 + 16) = dword_1C024B158;
  *((_DWORD *)a1 + 17) = dword_1C024B164;
  v4 = dword_1C024B160;
  *((_DWORD *)a1 + 19) = -1;
  *((_DWORD *)a1 + 18) = v4;
  v5 = dword_1C024B16C;
  *((_DWORD *)a1 + 21) &= ~2u;
  v6 = *((_DWORD *)a1 + 21);
  *((_DWORD *)a1 + 20) = v5;
  v7 = v6 ^ ((unsigned __int8)v6 ^ (unsigned __int8)(4 * dword_1C024B1C8)) & 4;
  *((_DWORD *)a1 + 21) = v7;
  *((_DWORD *)a1 + 21) = a2 & 1 | v7 & 0xFFFFFFF6 | (8 * (dword_1C024B1C4 & 1));
}
