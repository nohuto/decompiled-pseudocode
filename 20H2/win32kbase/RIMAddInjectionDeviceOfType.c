/*
 * XREFs of RIMAddInjectionDeviceOfType @ 0x1C0155430
 * Callers:
        ...
        __int64 a6)
{
  ...
  __int64 v28; // [rsp+50h] [rbp-138h] BYREF
  int v29; // [rsp+58h] [rbp-130h]
  int v30; // [rsp+60h] [rbp-128h]
  __int64 v31; // [rsp+68h] [rbp-120h]
  ...
  __int64 v35; // [rsp+A0h] [rbp-E8h]
  __int64 v36[18]; // [rsp+B0h] [rbp-D8h] BYREF
...
LABEL_27:
        ...
        *(_DWORD *)&SourceString.Length = v19;
        ...
        if ( v21 < MmUserProbeAddress && (unsigned __int16)v19 <= HIWORD(v29) )
        {
          if ( (v19 & 1) != 0 )
            goto LABEL_21;
...
LABEL_21:
        MicrosoftTelemetryAssertTriggeredNoArgsKM(v19, Buffer, v21, v15);
        v22 = (_BYTE **)MmUserProbeAddress;
        goto LABEL_22;
      }
      v12 = -1073741637;
...
LABEL_46:
        LOBYTE(v14) = 3;
        WPP_RECORDER_SF_((_DWORD)gRimLog, v14, 1, v25, (__int64)&WPP_458f9cb2c9d13fde67ad7c5a84ebc3a7_Traceguids);
      }
    }
    else
    {
