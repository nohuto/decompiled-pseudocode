/*
 * XREFs of GdiProcessCallout @ 0x1C0017450
 * Callers:
 *     <none>
 * Callees:
    ...
    if ( v4 )
    {
      if ( (int)IsUmfdIsCurrentProcessUmfdHostNoLockSupported() >= 0 )
      {
        ...
        if ( v24 )
        {
          ...
          else if ( (int)IsUmfdUninitializeProcessSupported() >= 0 && qword_1C024F588 )
          {
            qword_1C024F588();
          }
        }
    ...
    *(_QWORD *)(a1 + 208) = a1 + 208;
    ...
    if ( ProcessPeb
      && (*(_DWORD *)(ProcessPeb + 264) = 20,
          ...
          ViewSize[1] = a1 + 248,
          LOBYTE(v19) = a2,
          (int)((__int64 (__fastcall *)(__int64, void *, __int64))qword_1C024A848)(
                 a1 + 248,
                 ...
                 v19) >= 0) )
    {
      ...
      if ( v20 < 0 )
        ((void (__fastcall *)(__int64, void *, _QWORD))qword_1C024A848)(a1 + 248, &gDxgkWin32kEngInterface, 0LL);
