/*
 * XREFs of ?CitpInteractionSummaryStopTracking@@YAXPEAU_CIT_INTERACTION_SUMMARY@@I@Z @ 0x1C0068CE4
 * Callers:
 ...
 *     ?OnlyCompositionMetrics@@YAHPEBU_CIT_INTERACTION_SUMMARY@@U_CIT_INPUT_TIMES@@@Z @ 0x1C00692D0 (-OnlyCompositionMetrics@@YAHPEBU_CIT_INTERACTION_SUMMARY@@U_CIT_INPUT_TIMES@@@Z.c)
...
void __fastcall CitpInteractionSummaryStopTracking(struct _CIT_INTERACTION_SUMMARY *a1, int a2)
{
  ...
  *(_QWORD *)v2 = v2;
  ...
  while ( v9 );
  if ( ((xmmword_1C024E484 & 0x10) == 0
     || *((_WORD *)v2 + 57) != 4
     || *((_WORD *)v2 + 54)
     && *((_WORD *)v2 + 55)
     && ((*((_BYTE *)v2 + 100) & 1) != 0 || (v10 = **(PVOID **)(*((_QWORD *)v2 + 3) + 8LL)) == 0LL || v10 != g_pepDwm))
    && ((xmmword_1C024E484 & 0x20) == 0
     || (*((_WORD *)v2 + 57) & 0xFFF3) != 0
     || (*((_WORD *)v2 + 57) & 8) == 0
     || *((_WORD *)v2 + 53) >= 3u
     || *((_WORD *)v2 + 54) && *((_WORD *)v2 + 55)) )
  {
    v11 = xmmword_1C024E4A0;
    v12 = a2 - *((_DWORD *)v2 + 23);
    v13 = a2 - *((_DWORD *)xmmword_1C024E4A0 + 218);
    v14 = *((_QWORD *)xmmword_1C024E4A0 + 105) + 1LL;
    v15 = *((_QWORD *)xmmword_1C024E4A0 + 108);
    *((_QWORD *)xmmword_1C024E4A0 + 105) = v14;
    if ( (*((_BYTE *)v2 + 100) & 1) != 0 )
    {
      v29 = *((_QWORD *)v2 + 3);
      v30 = &word_1C0209C50;
      ...
      if ( !(unsigned int)OnlyCompositionMetrics(v2, &v86, 0LL, v15)
        ...
        && tlgKeywordOn((__int64)&dword_1C0243250, 0x800000000800LL) )
      {
        v97 = *(_QWORD *)(v38 + 16);
        ...
        v50 = *(_WORD *)(v38 + 104);
        v74 = *((_DWORD *)v11 + 219);
        v75 = xmmword_1C024E484;
        v76 = DWORD2(xmmword_1C024E484);
        v71 = DWORD1(xmmword_1C024E484);
        v77 = *(&xmmword_1C024E474 + 1);
        v51 = *(_WORD *)(v38 + 70);
        v99 = *(_BYTE *)(v38 + 72);
        v52 = *(_WORD *)(v38 + 68);
        v53 = *(_WORD *)(v38 + 66);
    ...
    else
    {
        ...
        && tlgKeywordOn((__int64)&dword_1C0243250, 0x800000000800LL) )
      {
        ...
        v64 = *(_WORD *)(v22 + 104);
        v80 = *((_DWORD *)v11 + 219);
        v79 = xmmword_1C024E484;
        v78 = *(_QWORD *)((char *)&xmmword_1C024E484 + 4);
        v77 = *(&xmmword_1C024E474 + 1);
        v63 = *(_WORD *)(v22 + 70);
        v99 = *(_BYTE *)(v22 + 72);
        v62 = *(_WORD *)(v22 + 68);
