/*
 * XREFs of UserEnterUserCritSecShared @ 0x1C004E080
 * Callers:
 *     <none>
 * Callees:
...
__int64 UserEnterUserCritSecShared()
{
  ...
  if ( InputTraceLogging::Perf::s_userCritLoggingEnabled )
  {
    ...
    if ( v17 && (*(int *)(v17 + 24) > 0 || *(_DWORD *)(v21 + 48)) )
    {
      ...
      {
        if ( (unsigned __int8)tlgKeywordOn(&dword_1C0244A70, 0x2000LL, v18, v19) )
        {
          v27 = 0;
          v20 = v22;
          v26 = 4;
          v25 = &v20;
          tlgWriteTransfer_EtwWriteTransfer((int)&dword_1C0244A70, (int)&dword_1C0211E87, (int)&ActivityId, 0, 3u, &v24);
        }
      }
    }
  }
