/*
 * XREFs of ?CitpSetSpeechRecognitionInfo@@YAJPEAT_CIT_SI_INFOFLAGS@@PEAT_CIT_SI_INFO@@@Z @ 0x1C01F8C90
 * Callers:
...
__int64 __fastcall CitpSetSpeechRecognitionInfo(union _CIT_SI_INFOFLAGS *a1, union _CIT_SI_INFO *a2)
{
  ...
  if ( (unsigned int)dword_1C0244B0C < MEMORY[0xFFFFF7800000037C] )
    EtwTelemetryCoverageReport(&off_1C0244B00);
