/*
 * XREFs of InitScancodeMap @ 0x1C008C300
 * Callers:
 *     <none>
 * Callees:
...
int InitScancodeMap()
{
  ...
  while ( 1 )
  {
    v1 = OpenCacheKeyEx(0LL, 8LL, 0x20019u, &v13);
    if ( !v1 )
      goto LABEL_10;
    Length = 16;
...
LABEL_11:
  if ( v3 - 13 <= 0xFFF1 )
  {
    v8 = Win32AllocPoolZInit(v3 + 8LL, 0x6D637355u);
    v9 = (__int64)v8;
    if ( v8 )
    {
  ...
  while ( 1 )
  {
    v5 = OpenCacheKeyEx(0LL, 8LL, 0x20019u, &v13);
    v6 = v5;
    if ( !v5 )
      goto LABEL_22;
    Length = 16;
...
LABEL_23:
  if ( v7 >= 0x10 && (v7 & 0xF) == 0 )
  {
    v5 = Win32AllocPoolZInit(v7, 0x6D637355u);
