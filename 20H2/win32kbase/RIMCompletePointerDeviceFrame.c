/*
 * XREFs of RIMCompletePointerDeviceFrame @ 0x1C0170D50
 * Callers:
        ...
        __int64 a4)
{
  ...
  rimCountContactsToDeliverWithFrame(v8, &v29, &v28);
  v12 = v29;
  if ( !v29 )
  {
    if ( WPP_RECORDER_INITIALIZED != (_UNKNOWN *)&WPP_RECORDER_INITIALIZED )
  ...
  v13 = v28;
  if ( !(unsigned int)rimStorePointersInHoldingFrame(v6, a2, v12, (unsigned int)v28) )
  {
  ...
  v28 = 0LL;
  if ( !(unsigned int)rimGetCompleteFrameAndReleaseHoldingFrame(v6, a2, &v28) )
  {
