/*
 * XREFs of _anonymous_namespace_::UpdateKeyState @ 0x1C00A0660
 * Callers:
 *     UpdateKeyStateForMessage @ 0x1C00A0580 (UpdateKeyStateForMessage.c)
 * Callees:
 *     _anonymous_namespace_::ApplyKeyStateToQueue @ 0x1C00A06F8 (_anonymous_namespace_--ApplyKeyStateToQueue.c)
 */
