/*
 * XREFs of ApplyPathsModality @ 0x1C00109B4
 * Callers:
        ...
        __int64 a8)
{
  ...
  *a6 = 0;
  if ( (unsigned int)ApplyPathModalityToCdsRegistryStore(a1) )
  {
    ...
    if ( (int)((__int64 (__fastcall *)(__int64, __int64, __int64))qword_1C024A8C0)(v13, a1, a8) < 0 )
    {
      *a6 = 1;
      v18 = -1;
    }
    else
    {
      ...
      if ( v18 < 0 )
        *a6 = 1;
      ((void (__fastcall *)(__int64))qword_1C024A8C8)(a1);
      if ( v18 != 2 )
      {
LABEL_24:
        if ( v18 >= 0 )
        {
          v24 = qword_1C024F600 ? qword_1C024F600() : -1073741637;
          if ( v24 >= 0 && a7 && *a7 )
          {
            ...
            if ( *(_DWORD *)(*a7 + 20) )
            {
              do
              {
                ...
                if ( v28 && (*(_DWORD *)(v28 + 40) & 1) != 0 && qword_1C024F608 )
                {
                  qword_1C024F608(v28, 0LL, v25);
                  v27 = *a7;
                }
                ++v26;
                v25 = v27;
