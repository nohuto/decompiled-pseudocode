/*
 * XREFs of ?xxxUserChangeDisplaySettingsInternal@@YAJPEAU_UNICODE_STRING@@PEAU_devicemodeW@@PEAUtagDESKTOP@@KPEAXW4_MODE@@PEAU_DXGK_DISPLAY_SCENARIO_CONTEXT@@@Z @ 0x1C006BCA4
 * Callers:
...
LABEL_25:
      ...
      if ( (gdwPUDFlags & 0x20000000) != 0 )
      {
        if ( (PVOID)PsGetCurrentProcess(String1, 2147483652LL) != gpepCSRSS )
          goto LABEL_139;
        v29 = (int)qword_1C0250F50;
        if ( qword_1C0250F50 )
          v29 = qword_1C0250F50(String1, v13);
        if ( !v29 )
          goto LABEL_139;
      }
...
LABEL_46:
              ...
              if ( CreateCachedMonitor() )
              {
                ...
                if ( qword_1C0250AD8 )
                  ...
                  v21 = -1073741637;
                if ( v21 >= 0 && qword_1C0250AE0 )
                  qword_1C0250AE0();
LABEL_55:
                if ( qword_1C024B370 )
                {
                  v33 = qword_1C0250AE8 ? qword_1C0250AE8() : -1073741637;
                  if ( v33 >= 0 && qword_1C0250AF0 )
                    qword_1C0250AF0();
                }
                if ( qword_1C024F990 )
                  v20 = qword_1C024F990();
                if ( v20 >= 0 && qword_1C024F998 )
                ...
                v11 = DrvChangeDisplaySettings(
                        ...
                        *(_QWORD *)(gpDispInfo + 16),
                        ...
                        (__int64)a7);
                if ( qword_1C024FEC0 )
                  qword_1C024FEC0(a3, &v45, CompositionObject::Release);
                if ( a3 )
...
LABEL_69:
                if ( a3 )
                {
                  ...
                  {
                    if ( qword_1C02509E0 )
                      qword_1C02509E0(v25[3], 1LL, 66693LL);
                  }
                }
                if ( qword_1C02504D8 )
                  qword_1C02504D8(1LL);
                if ( (int)IszzzUpdateCursorImageSupported() >= 0 && qword_1C0250B00 )
                  qword_1C0250B00();
LABEL_76:
                if ( qword_1C024FFD8 )
                  qword_1C024FFD8(&v45);
