/*
 * XREFs of CoreMsgObjectCallout @ 0x1C002C73C
 * Callers:
...
__int64 __fastcall CoreMsgObjectCallout(unsigned int a1, _QWORD *a2)
{
  ...
  if ( (unsigned int)dword_1C0243450 > 5 )
  {
    ...
    v13 = a1;
    v16 = 4;
    tlgWriteTransfer_EtwWriteTransfer((int)&dword_1C0243450, (int)&dword_1C021BE07, 0, 0, 3u, &v14);
  }
...
LABEL_9:
  if ( (unsigned int)dword_1C0243450 > 5 )
  {
    ...
    v13 = v7;
    v16 = 4;
    tlgWriteTransfer_EtwWriteTransfer((int)&dword_1C0243450, (int)&dword_1C021BE64, 0, 0, 3u, &v14);
  }
  if ( v12[0] )
    KeReleaseMutex(P, 0);
  return v7;
