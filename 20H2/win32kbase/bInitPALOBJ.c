/*
 * XREFs of bInitPALOBJ @ 0x1C02938C4
 * Callers:
...
__int64 bInitPALOBJ()
{
  ...
  _QWORD *v20; // [rsp+90h] [rbp+20h] BYREF

  v0 = 0;
  v1 = (int *)&unk_1C024DE1C;
  *(_QWORD *)&pArrayOfSquares.peRed = &unk_1C024DE1C;
  v2 = 0;
  v3 = (int *)&unk_1C024DE1C;
  LODWORD(v4) = 256;
  do
  {
    v5 = v2 * v2;
  ...
  if ( !ghsemPalette )
    return 0LL;
  if ( logDefaultPal != 768 || !word_1C0245362 )
    goto LABEL_8;
  v17 = 0;
  v16 = 0LL;
  if ( !(unsigned int)PALMEMOBJ::bCreatePalette(
                        ...
                        1,
                        (unsigned __int16)word_1C0245362,
                        dword_1C0245364,
                        0,
                        0,
                        0,
