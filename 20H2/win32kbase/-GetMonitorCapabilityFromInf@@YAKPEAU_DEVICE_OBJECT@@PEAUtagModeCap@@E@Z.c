/*
 * XREFs of ?GetMonitorCapabilityFromInf@@YAKPEAU_DEVICE_OBJECT@@PEAUtagModeCap@@E@Z @ 0x1C009AAE8
 * Callers:
 ...
 *     __report_rangecheckfailure @ 0x1C00CBC80 (__report_rangecheckfailure.c)
