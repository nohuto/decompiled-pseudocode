/*
 * XREFs of ?EmitSetManipulations@CInteractionTrackerMarshaler@DirectComposition@@AEAA_NPEAPEAVCBatch@2@@Z @ 0x1C01E9DCC
 * Callers:
        ...
        struct DirectComposition::CBatch ***a2)
{
  ...
  {
    v16 = 0LL;
    if ( DirectComposition::CBatch::EnsureBatchBuffer((struct DirectComposition::CBatch **)a2, 0x10uLL, &v16) )
    {
      v7 = (char *)v16;
      *(_DWORD *)v16 = 16;
      *(_QWORD *)(v7 + 4) = 0LL;
