/*
 * XREFs of ?CoalesceMessage@Delivery@InputTraceLogging@@SAXPEBUtagQMSG@@@Z @ 0x1C0187694
 * Callers:
...
void __fastcall InputTraceLogging::Delivery::CoalesceMessage(const struct tagQMSG *a1, __int64 a2)
{
  ...
  {
    if ( (unsigned int)dword_1C0244A70 > 4 && tlgKeywordOn((__int64)&dword_1C0244A70, 16LL) )
    {
      ...
      tlgWriteTransfer_EtwWriteTransfer(
        ...
        (unsigned __int8 *)dword_1C0216B3E,
        0LL,
        0LL,
        7u,
        &v12);
         ...
         && tlgKeywordOn((__int64)&dword_1C0244A70, 16LL) )
  {
    v10 = *(_QWORD *)(v6 + 136);
    v8 = v5;
