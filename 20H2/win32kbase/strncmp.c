/*
 * XREFs of strncmp @ 0x1C00CC1A0
 * Callers:
 *     rimFindImageProcAddress @ 0x1C00097AC (rimFindImageProcAddress.c)
 *     ivrFindImageProcAddress @ 0x1C01B5068 (ivrFindImageProcAddress.c)
 * Callees:
 *     <none>
 */
