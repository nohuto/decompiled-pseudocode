/*
 * XREFs of ?ApplyAccelerationToDelta@CMouseProcessor@@AEAAXJJUtagPOINT@@_NPEAU_SUBPIXELS@@PEAJ3@Z @ 0x1C000BF40
 * Callers:
        ...
        int *a8)
{
  ...
  v9 = a3;
  v10 = a2;
  if ( a5 && (*((_BYTE *)qword_1C023F098 + 112) || (*(_BYTE *)(&qword_1C0248FC0 + 1) & 0x40) == 0) )
  {
    v12 = qword_1C023F0B0;
