/*
 * XREFs of ?_CreateLegacyInputSpace@CInputConfig@@AEAAJXZ @ 0x1C000E034
 * Callers:
...
__int64 __fastcall CInputConfig::_CreateLegacyInputSpace(CInputConfig *this)
{
  ...
  v37 = 0LL;
  v7 = RIMGetQDCActivePathsData((unsigned int *)&v37);
  ...
  if ( v7 )
  {
    for ( j = 0; j < *v7; ++j )
    {
      v18 = (const struct DISPLAYCONFIG_PATH_INFO_INTERNAL *)(*((_QWORD *)v7 + 1) + 200LL * j);
