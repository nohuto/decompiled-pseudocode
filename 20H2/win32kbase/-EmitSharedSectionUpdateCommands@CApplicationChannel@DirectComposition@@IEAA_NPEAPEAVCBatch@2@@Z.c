/*
 * XREFs of ?EmitSharedSectionUpdateCommands@CApplicationChannel@DirectComposition@@IEAA_NPEAPEAVCBatch@2@@Z @ 0x1C00602E0
 * Callers:
        ...
        struct DirectComposition::CBatch **a2)
{
  ...
  for ( i = *((_QWORD *)this + 52);
        i
     && (*(unsigned __int8 (__fastcall **)(__int64, struct DirectComposition::CBatch **))(*(_QWORD *)i + 56LL))(i, a2);
        *((_QWORD *)this + 52) = i )
  {
