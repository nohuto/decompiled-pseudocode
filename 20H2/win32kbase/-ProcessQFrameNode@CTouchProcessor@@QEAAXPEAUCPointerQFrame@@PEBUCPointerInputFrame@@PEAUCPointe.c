/*
 * XREFs of ?ProcessQFrameNode@CTouchProcessor@@QEAAXPEAUCPointerQFrame@@PEBUCPointerInputFrame@@PEAUCPointerInfoNode@@@Z @ 0x1C0195F50
 * Callers:
        ...
        struct CPointerInfoNode *a4)
{
  ...
  v8 = &WPP_50814762fbc63e38c7e5eacf83347307_Traceguids;
