/*
 * XREFs of ?Feature_Servicing_TelemetryForCollectingDataOnIdSysPeek__private_IsEnabled@@YAHXZ @ 0x1C00D13B0
 * Callers:
...
__int64 Feature_Servicing_TelemetryForCollectingDataOnIdSysPeek__private_IsEnabled(void)
{
  unsigned int CachedFeatureEnabledState; // eax
  unsigned int v1; // ebx

  CachedFeatureEnabledState = wil_details_FeatureStateCache_GetCachedFeatureEnabledState(
                                (unsigned int *)&Feature_Servicing_TelemetryForCollectingDataOnIdSysPeek__private_featureState,
                                (__int64)&wil_details_featureDescriptors_a);
  v1 = (CachedFeatureEnabledState >> 3) & 1;
  wil_details_FeatureReporting_ReportUsageToService(
    (__int64)&Feature_Servicing_TelemetryForCollectingDataOnIdSysPeek__private_reporting,
    0x29D5042u,
