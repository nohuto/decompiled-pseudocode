/*
 * XREFs of McTemplateK0qm_EtwWriteTransfer @ 0x1C00CE678
 * Callers:
 *     EtwTraceUiAuditWriteClipboard @ 0x1C00BA6B0 (EtwTraceUiAuditWriteClipboard.c)
 *     EtwTraceUiLimitWriteClipboard @ 0x1C0127260 (EtwTraceUiLimitWriteClipboard.c)
 * Callees:
