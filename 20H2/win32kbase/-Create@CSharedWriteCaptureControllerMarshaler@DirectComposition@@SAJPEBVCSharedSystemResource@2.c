/*
 * XREFs of ?Create@CSharedWriteCaptureControllerMarshaler@DirectComposition@@SAJPEBVCSharedSystemResource@2@PEAPEAV12@@Z @ 0x1C01F3AC0
 * Callers:
 *     CreateSharedWriteCaptureControllerMarshaler @ 0x1C01F3C20 (CreateSharedWriteCaptureControllerMarshaler.c)
 * Callees:
