/*
 * XREFs of ?EmitSetChildrenCommand@CSceneNodeMarshaler@DirectComposition@@AEAA_NPEAPEAVCBatch@2@@Z @ 0x1C01D12B0
 * Callers:
 *     ?EmitUpdateCommands@CSceneNodeMarshaler@DirectComposition@@MEAA_NPEAPEAVCBatch@2@@Z @ 0x1C01D59B0 (-EmitUpdateCommands@CSceneNodeMarshaler@DirectComposition@@MEAA_NPEAPEAVCBatch@2@@Z.c)
 * Callees:
  ...
  if ( (v2 & 0x20) != 0 )
  {
    ...
    *((_DWORD *)this + 4) = v2 & 0xFFFFFFDF;
    ...
    while ( v6 < *((_QWORD *)this + 8) || v7 )
    {
      ...
      v10 = (v8 - 20) >> 2;
      if ( *((_QWORD *)this + 8) - v9 < v10 )
        LODWORD(v10) = *((_DWORD *)this + 16) - v9;
      v19 = 0LL;
      ...
      *((_DWORD *)v11 + 3) = 4 * v10;
      ...
      if ( (_DWORD)v10 )
      {
        ...
        do
        {
          if ( (unsigned __int64)v13 >= *((_QWORD *)this + 8) )
          {
            v16 = 0LL;
          }
          else
          {
            _mm_lfence();
            v16 = *(_QWORD *)(*((_QWORD *)this + 7) + 8LL * v13);
          }
          ++v13;
