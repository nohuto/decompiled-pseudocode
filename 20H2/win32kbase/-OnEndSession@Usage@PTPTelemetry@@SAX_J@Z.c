/*
 * XREFs of ?OnEndSession@Usage@PTPTelemetry@@SAX_J@Z @ 0x1C01A0F94
 * Callers:
...
void __fastcall PTPTelemetry::Usage::OnEndSession(__int64 a1)
{
  ...
  if ( qword_1C024ACE8 > 0 )
  {
    ...
    {
      PerformanceCounter = KeQueryPerformanceCounter(0LL);
      qword_1C024ACF0 = PerformanceCounter.QuadPart;
    }
    qword_1C024AD00 = PerformanceCounter.QuadPart;
  }
