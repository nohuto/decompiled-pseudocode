/*
 * XREFs of NtConfigureInputSpace @ 0x1C012B730
 * Callers:
 *     <none>
 * Callees:
 *     ?FreeRegions@CInputSpace@@QEAAXXZ @ 0x1C000AD04 (-FreeRegions@CInputSpace@@QEAAXXZ.c)
 *     ??0CInputSpace@@QEAA@AEBUINPUT_SPACE@@_N@Z @ 0x1C000E240 (--0CInputSpace@@QEAA@AEBUINPUT_SPACE@@_N@Z.c)
 ...
 *     ?Validate@CInputConfig@@SA_NAEBUINPUT_SPACE@@PEBUINPUT_SPACE_REGION@@K@Z @ 0x1C01ADEC8 (-Validate@CInputConfig@@SA_NAEBUINPUT_SPACE@@PEBUINPUT_SPACE_REGION@@K@Z.c)
 */
