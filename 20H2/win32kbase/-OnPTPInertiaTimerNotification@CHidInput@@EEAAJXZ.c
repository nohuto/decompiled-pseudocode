/*
 * XREFs of ?OnPTPInertiaTimerNotification@CHidInput@@EEAAJXZ @ 0x1C01A4590
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall CHidInput::OnPTPInertiaTimerNotification(CHidInput *this)
{
  ...
  {
    v49 = *(CPTPProcessor **)(v48 + 480);
    if ( v49 )
      v49 = (CPTPProcessor *)*((_QWORD *)v49 + 125);
    if ( v49 )
      CPTPProcessor::HandleInertiaTimer(v49);
  }
  UserSessionSwitchLeaveCrit((__int64)v49, v48, v50, v51);
  return 0LL;
}
