/*
 * XREFs of ?DeliverMouseButtonToInputDest@CMouseProcessor@@AEAAXAEBVCButtonEvent@1@AEBVCInputDest@@AEBUInputDeliveryContext@1@@Z @ 0x1C002EBFC
 * Callers:
        ...
        const struct CMouseProcessor::InputDeliveryContext *a4)
{
  ...
  if ( *(_DWORD *)a3 )
  {
    if ( !CMouseProcessor::BufferInputDestinedForContainer(this, a2, a3) )
    {
      ...
      if ( *((_DWORD *)a2 + 8) == 2
        && (v27 = *((_QWORD *)a2 + 1),
            v28 = *((unsigned int *)a2 + 6),
            v29 = *(_DWORD *)(v27 + 112),
            v30 = *(_DWORD *)(v27 + 140),
            v33 = *(_QWORD *)(v27 + 132),
            v34 = v30,
            !(unsigned int)ApiSetEditionReportMouseBreakToAccessibility(a3, v28, &v33, (v29 >> 7) & 1)) )
      {
