/*
 * XREFs of ?Create@CSharedReadRemoteAppRenderTargetMarshaler@DirectComposition@@SAJPEBVCSharedSystemResource@2@PEAPEAV12@@Z @ 0x1C01F33D0
 * Callers:
 *     CreateSharedReadRemoteAppRenderTargetMarshaler @ 0x1C01F35B0 (CreateSharedReadRemoteAppRenderTargetMarshaler.c)
 * Callees:
