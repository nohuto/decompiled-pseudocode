/*
 * XREFs of ?PostMouseInputMessage@CMouseProcessor@@QEAA_N_KW4_POST_MOUSE_INPUT_MESSAGE_OPTIONS@@PEAU_mouseCursorEvent@@@Z @ 0x1C01BB1D0
 * Callers:
        ...
        struct _mouseCursorEvent *a4)
{
  ...
  __int64 v16; // rdx
  struct ContainerMouseInput *v17; // r8
...
LABEL_13:
        if ( IsMouseIVEnabled() && isRootPartition() && v14 )
        {
...
LABEL_17:
        CMouseProcessor::MouseInputMessage::`scalar deleting destructor'(v12, v8, v10, v11);
        LOBYTE(v7) = 1;
        return (char)v7;
      }
      v14 = (struct CMouseProcessor::MouseInputMessage *)((char *)v12 + 352);
