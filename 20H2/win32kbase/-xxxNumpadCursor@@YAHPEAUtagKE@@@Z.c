/*
 * XREFs of ?xxxNumpadCursor@@YAHPEAUtagKE@@@Z @ 0x1C00AB180
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall xxxNumpadCursor(struct tagKE *a1)
{
  ...
  if ( byte_1C024EDF4 )
  {
      ...
      if ( v6 < 0 )
      {
        xxxKeyEventEx(
          ...
          *((void **)a1 + 1),
          ...
          0LL,
          0LL);
        *((_WORD *)a1 + 1) = word_1C0252618;
        *(_BYTE *)a1 = byte_1C025261A;
        byte_1C024EDF4 = 0;
      }
      return 1LL;
    }
    ...
    xxxKeyEventEx(
      word_1C0252618,
      (unsigned __int8)byte_1C025261A | 0x200,
      *((_DWORD *)a1 + 1),
      0LL,
      *((void **)a1 + 1),
      (unsigned __int16 *)a1 + 8,
  ...
  if ( (v3 & 0x800) != 0 )
  {
    ...
    if ( !(unsigned int)ApiSetEditionIsSAS(v4, &v12)
      && ((byte_1C0249864 & 2) != 0 || gptiForeground && (*((_DWORD *)gptiForeground + 308) & 0x800000) != 0) )
    {
      if ( (byte_1C0249844 & 1) != 0 )
      {
        v7 = (void *)*((_QWORD *)a1 + 1);
        byte_1C024EDF4 = *((_BYTE *)a1 + 2);
        v11 = v7;
        LODWORD(v7) = *((_DWORD *)a1 + 1);
        byte_1C025261A = (byte_1C0249868 & 4) != 0 ? 54 : 42;
        word_1C0252618 = (byte_1C0249868 & 4) != 0 ? 417 : 160;
        xxxKeyEventEx(
          word_1C0252618 | 0x8000,
          (unsigned __int8)byte_1C025261A | 0x200,
          (unsigned int)v7,
          0LL,
          v11,
