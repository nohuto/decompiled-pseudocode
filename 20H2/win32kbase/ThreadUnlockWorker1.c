/*
 * XREFs of ThreadUnlockWorker1 @ 0x1C00873E0
 * Callers:
 *     <none>
 * Callees:
...
__int64 ThreadUnlockWorker1()
{
  ...
  *(_QWORD *)(v1 + 416) = *v5;
  ...
  if ( v6 )
  {
    ...
    {
      v7 = (struct _HANDLEENTRY *)((char *)qword_1C0248D48
      ...
      if ( (v8 & 1) != 0 && (v8 & 2) == 0 )
      {
        ...
        {
          GetDomainLockRef(12LL, v13, v14, v15);
          v16 = (char *)gpKernelHandleTable + 24 * (unsigned __int16)*(_DWORD *)v6;
          if ( !*((_QWORD *)v16 + 2) )
          {
            _InterlockedIncrement((volatile signed __int32 *)(v6 + 8));
            AddToDeferredUserCritThreadUnlockList(v16);
          }
        }
        else
        {
