/*
 * XREFs of _anonymous_namespace_::InMouseRawInputMode @ 0x1C003297C
 * Callers:
...
char __fastcall anonymous_namespace_::InMouseRawInputMode(__int64 a1, __int64 a2, int a3)
{
  ...
  if ( PtiFromInputDest && !(unsigned __int8)IsSpatialDelegationEnabledForThread(PtiFromInputDest) )
  {
    ...
    {
      if ( qword_1C024FF00 )
        v13 = qword_1C024FF00(v6);
      else
        v13 = 0;
      if ( !v13 )
        return v5;
      v14 = (*(_DWORD *)(*(_QWORD *)(*(_QWORD *)(v6 + 424) + 832LL) + 100LL) & 0x100) == 0;
      goto LABEL_14;
    }
    if ( a3 == 1 )
    {
      if ( qword_1C024FF00 )
        v11 = qword_1C024FF00(v6);
      else
        v11 = 0;
      if ( !v11 )
        return v5;
      v14 = (*(_DWORD *)(*(_QWORD *)(*(_QWORD *)(v6 + 424) + 832LL) + 100LL) & 2) == 0;
LABEL_14:
      if ( !v14 )
        return 1;
      return v5;
