/*
 * XREFs of RIMGetPnpActionBitsFromGuid @ 0x1C016C014
 * Callers:
...
_DWORD *__fastcall RIMGetPnpActionBitsFromGuid(char a1, int a2, __int64 a3, _DWORD *a4, _DWORD *a5, _DWORD *a6)
{
  ...
  if ( !v9 )
  {
    if ( WPP_RECORDER_INITIALIZED != (_UNKNOWN *)&WPP_RECORDER_INITIALIZED )
    {
      v12 = a2;
      LOBYTE(a2) = 4;
      WPP_RECORDER_SF_qq((_DWORD)gRimLog, a2, 1, 11, (__int64)&WPP_a75f261dfb463415346bb11edf387329_Traceguids, a1, v12);
    }
    result = a5;
LABEL_19:
    *result = 1;
  ...
  if ( !v10 )
  {
    if ( WPP_RECORDER_INITIALIZED != (_UNKNOWN *)&WPP_RECORDER_INITIALIZED )
    {
      v13 = a2;
      LOBYTE(a2) = 4;
      WPP_RECORDER_SF_qq((_DWORD)gRimLog, a2, 1, 12, (__int64)&WPP_a75f261dfb463415346bb11edf387329_Traceguids, a1, v13);
    }
    result = a6;
    goto LABEL_19;
  }
