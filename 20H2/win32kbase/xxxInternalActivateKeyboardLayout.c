/*
 * XREFs of xxxInternalActivateKeyboardLayout @ 0x1C0089370
 * Callers:
  ...
  if ( (a3 & 0x100) != 0 || a2 != *v9 )
  {
    ...
    *((_QWORD *)v8 + 52) = v22;
    ...
    if ( (*((_DWORD *)v8 + 122) & 8) != 0 )
    {
      v20 = v9;
      v21 = a2;
      HMAssignmentLock((__int64)&v20, a2);
      ...
      else
      {
        ...
        while ( v15 )
        {
          if ( *(_QWORD *)(v15 + 440) != a2 && (*(_DWORD *)(v15 + 488) & 1) == 0 )
          {
            v20 = (_QWORD *)(v15 + 440);
            v21 = a2;
            HMAssignmentLock((__int64)&v20, v18);
    ...
    if ( gptiForeground && *((_QWORD *)gptiForeground + 53) == *((_QWORD *)v8 + 53) )
    {
      ...
      if ( qword_1C0250028 )
        qword_1C0250028(2147483649LL, 0LL, *(unsigned int *)(a2 + 40), 0LL, 0);
