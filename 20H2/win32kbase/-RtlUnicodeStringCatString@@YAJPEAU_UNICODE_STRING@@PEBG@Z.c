/*
 * XREFs of ?RtlUnicodeStringCatString@@YAJPEAU_UNICODE_STRING@@PEBG@Z @ 0x1C01801D8
 * Callers:
 ...
 *     RtlWideCharArrayCopyStringWorker @ 0x1C01802D4 (RtlWideCharArrayCopyStringWorker.c)
 */
