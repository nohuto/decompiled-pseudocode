/*
 * XREFs of NtGdiDeleteObjectApp @ 0x1C003A900
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall NtGdiDeleteObjectApp(struct HOBJ__ *a1)
{
  ...
  __int64 v68; // [rsp+B8h] [rbp+67h] BYREF
    ...
    if ( v3 != 4 )
    {
      ...
      if ( v11 )
      {
        ...
        else
        {
          ...
          LOBYTE(v7) = 5;
          v69 = HmgShareLockCheckIgnoreStockBit(a1, v7);
          if ( v69 )
          {
            v14 = SURFREF::bDeleteSurface(&v69, 0LL);
            v16 = v69;
            v17 = v14;
            if ( v69 )
      ...
      {
        LODWORD(v68) = 0;
        return bDeleteDCInternalEx((HDC)a1, (unsigned int *)&v68);
      }
    }
