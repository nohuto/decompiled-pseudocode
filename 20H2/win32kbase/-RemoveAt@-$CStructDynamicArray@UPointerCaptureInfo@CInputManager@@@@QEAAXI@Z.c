/*
 * XREFs of ?RemoveAt@?$CStructDynamicArray@UPointerCaptureInfo@CInputManager@@@@QEAAXI@Z @ 0x1C01F4A44
 * Callers:
 ...
 *     ?UpdatePointerCapture@CInputManager@@SAJII@Z @ 0x1C01F4A94 (-UpdatePointerCapture@CInputManager@@SAJII@Z.c)
 * Callees:
