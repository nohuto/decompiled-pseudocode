/*
 * XREFs of ?RemoveCrossChannelVisualChild@CApplicationChannel@DirectComposition@@SAJIIII@Z @ 0x1C01CF34C
 * Callers:
 *     NtDCompositionRemoveCrossDeviceVisualChild @ 0x1C01CCD00 (NtDCompositionRemoveCrossDeviceVisualChild.c)
 * Callees:
