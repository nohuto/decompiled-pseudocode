/*
 * XREFs of ?InitializeFromSharedResource@CSharedCompositionPointLightMarshaler@DirectComposition@@IEAAJPEBVCSharedSystemResource@2@@Z @ 0x1C01F3D40
 * Callers:
 ...
 * Callees:
 *     ?Initialize@CCompositionPointLightMarshaler@DirectComposition@@UEAAJXZ @ 0x1C01EC920 (-Initialize@CCompositionPointLightMarshaler@DirectComposition@@UEAAJXZ.c)
 */
