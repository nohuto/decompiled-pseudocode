/*
 * XREFs of ??$EmitExpressionsArray@UtagMILCMD_KEYFRAMEANIMATION_ADDEXPRESSIONRESOURCES@@@CBaseExpressionMarshaler@DirectComposition@@IEAA_NPEAPEAVCBatch@1@W4MILCMD@@PEAPEAVCResourceMarshaler@1@IPEAI@Z @ 0x1C00A7A70
 * Callers:
