/*
 * XREFs of GreRectInRegion @ 0x1C0092E60
 * Callers:
 *     NtGdiRectInRegion @ 0x1C00C54A0 (NtGdiRectInRegion.c)
 ...
 *     ?bInside@RGNOBJ@@QEAAHPEAU_RECTL@@@Z @ 0x1C0092EC0 (-bInside@RGNOBJ@@QEAAHPEAU_RECTL@@@Z.c)
 */
