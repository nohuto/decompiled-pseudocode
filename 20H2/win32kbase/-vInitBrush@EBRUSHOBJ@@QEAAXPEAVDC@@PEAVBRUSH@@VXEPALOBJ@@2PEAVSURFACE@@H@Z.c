/*
 * XREFs of ?vInitBrush@EBRUSHOBJ@@QEAAXPEAVDC@@PEAVBRUSH@@VXEPALOBJ@@2PEAVSURFACE@@H@Z @ 0x1C0017F10
 * Callers:
 ...
 * Callees:
 *     rgbFromColorref @ 0x1C0018320 (rgbFromColorref.c)
 *     ?ulGetMatchingIndexFromColorref@@YAKVXEPALOBJ@@0K@Z @ 0x1C0018364 (-ulGetMatchingIndexFromColorref@@YAKVXEPALOBJ@@0K@Z.c)
 ...
 *     ?hFindIcmDIB@BRUSH@@QEAAPEAUHBITMAP__@@PEAX@Z @ 0x1C013E070 (-hFindIcmDIB@BRUSH@@QEAAPEAUHBITMAP__@@PEAX@Z.c)
 */
  ...
  *((_QWORD *)a1 + 13) = *(_QWORD *)(v27 + 1808);
  ...
  if ( v28 )
  {
    if ( _InterlockedExchangeAdd(v28, 0xFFFFFFFF) == 1 )
      RBRUSH::vFreeOrCacheRBrush(v28, 1LL, v23, v10);
    *((_QWORD *)a1 + 4) = 0LL;
    v7 = a5;
  }
  v29 = *((_QWORD *)a1 + 1);
  if ( v29 )
  {
    ...
    if ( _InterlockedExchangeAdd(v44, 0xFFFFFFFF) == 1 )
      RBRUSH::vFreeOrCacheRBrush(v44, 0LL, v23, v10);
    *((_QWORD *)a1 + 1) = 0LL;
    v7 = a5;
  }
  v30 = a1[30];
