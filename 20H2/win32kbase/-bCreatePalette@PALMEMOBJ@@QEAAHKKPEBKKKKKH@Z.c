/*
 * XREFs of ?bCreatePalette@PALMEMOBJ@@QEAAHKKPEBKKKKKH@Z @ 0x1C00CECE0
 * Callers:
 ...
 *     ?ParseBits@@YAXKPEAK00K@Z @ 0x1C0086D78 (-ParseBits@@YAXKPEAK00K@Z.c)
 *     ?vComputeCallTables@XEPALOBJ@@QEAAXXZ @ 0x1C00930C0 (-vComputeCallTables@XEPALOBJ@@QEAAXXZ.c)
...
LABEL_43:
  ...
  v25 = 0LL;
  if ( !HmgInsertObjectHelper::Insert((HmgInsertObjectHelper *)&v25, (struct OBJECT *)v14, 1u, v22 != 0, 8) )
  {
    if ( v25 )
