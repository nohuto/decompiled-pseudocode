/*
 * XREFs of ?CommitFrame@Pointer@InputTraceLogging@@SAXPEBURIMDEV@@PEBUCPointerInputFrame@@@Z @ 0x1C0187E94
 * Callers:
    ...
    if ( (unsigned int)(v2 - 5) > 1 )
    {
      if ( v2 == 7 )
      {
        if ( (unsigned int)dword_1C0244A70 <= 4 || !tlgKeywordOn((__int64)&dword_1C0244A70, 32LL) )
          return;
        v7 = (unsigned __int8 *)&unk_1C02179B5;
      }
      else
      {
        if ( (unsigned int)dword_1C0244A70 <= 4 || !tlgKeywordOn((__int64)&dword_1C0244A70, 32LL) )
          return;
        v7 = (unsigned __int8 *)&unk_1C0217954;
      }
    }
    else
    {
      if ( (unsigned int)dword_1C0244A70 <= 4 || !tlgKeywordOn((__int64)&dword_1C0244A70, 32LL) )
        return;
      v7 = (unsigned __int8 *)&unk_1C0217898;
    }
    v10 = *(_DWORD *)(v5 + 48);
    v11 = *(_DWORD *)(v5 + 40);
    v12 = *(_QWORD *)(v5 + 72);
