/*
 * XREFs of ?CreateActivationObject@CActivationObjectManager@@QEAAJDPEAU_OBJECT_ATTRIBUTES@@KDPEAX_KAEAU_LUID@@@Z @ 0x1C0091A34
 * Callers:
 *     NtUserCreateActivationObject @ 0x1C00AD380 (NtUserCreateActivationObject.c)
 * Callees:
 *     RIMLockExclusive @ 0x1C0036330 (RIMLockExclusive.c)
 *     ?Destroy@CActivationObject@@SAJPEAV1@@Z @ 0x1C0091988 (-Destroy@CActivationObject@@SAJPEAV1@@Z.c)
 ...
 *     ?GetGroupFromGroupId@CActivationObjectManager@@AEBAPEAVCActivationGroup@@AEBUACTIVATION_GROUP_ID@@@Z @ 0x1C0091CC8 (-GetGroupFromGroupId@CActivationObjectManager@@AEBAPEAVCActivationGroup@@AEBUACTIVATION_GROUP_ID.c)
        ...
        struct _LUID *a8)
{
  ...
  else if ( qword_1C0251A78 )
  {
    v10 = qword_1C0251A78(a6, &v19);
  }
  else
  {
    v10 = 0;
