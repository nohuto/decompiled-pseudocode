/*
 * XREFs of ApiSetEditionFinalizeKoreanImeCompStrOnMouseClick @ 0x1C002C8F0
 * Callers:
...
__int64 __fastcall ApiSetEditionFinalizeKoreanImeCompStrOnMouseClick(__int64 a1, unsigned int a2)
{
  ...
  if ( qword_1C0251798 )
    result = qword_1C0251798();
  else
    result = 3221225659LL;
  if ( (int)result >= 0 )
  {
    result = (__int64)qword_1C02517A0;
    if ( qword_1C02517A0 )
      result = qword_1C02517A0(a1, v2);
  }
