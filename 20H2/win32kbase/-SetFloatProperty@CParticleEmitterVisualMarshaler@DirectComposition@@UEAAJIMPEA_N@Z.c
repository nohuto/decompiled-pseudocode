/*
 * XREFs of ?SetFloatProperty@CParticleEmitterVisualMarshaler@DirectComposition@@UEAAJIMPEA_N@Z @ 0x1C01D71B0
 * Callers:
 *     <none>
 * Callees:
 *     ?SetFloatProperty@CVisualMarshaler@DirectComposition@@UEAAJIMPEA_N@Z @ 0x1C005B270 (-SetFloatProperty@CVisualMarshaler@DirectComposition@@UEAAJIMPEA_N@Z.c)
 */
