/*
 * XREFs of ?DestroyHandle@CConnection@DirectComposition@@SAJPEAUHDCOMPOSITIONCONNECTION__@@@Z @ 0x1C00814CC
 * Callers:
 ...
 *     NtDCompositionDestroyConnection @ 0x1C01CC5B0 (NtDCompositionDestroyConnection.c)
 * Callees:
