/*
 * XREFs of ?CollectMousePacketPerfTelemetry@MousePerfSummary@@QEAAXAEBU_MousePacketPerf@@@Z @ 0x1C0036AB8
 * Callers:
 ...
 * Callees:
 *     ?CalculateLatencyInMicroseconds@MousePerfSummary@@AEAA_K_K0@Z @ 0x1C0036BC0 (-CalculateLatencyInMicroseconds@MousePerfSummary@@AEAA_K_K0@Z.c)
 ...
 *     ?UpdatePerfData@MousePerfStage@@QEAAX_K@Z @ 0x1C01BD714 (-UpdatePerfData@MousePerfStage@@QEAAX_K@Z.c)
 */
        ...
        const struct _MousePacketPerf *a2)
{
  ...
  *(_QWORD *)(v11 + 448) = v10;
  ...
  if ( (unsigned int)dword_1C0243170 > 5 && (unsigned __int8)tlgKeywordOn(&dword_1C0243170, 16LL, v12, v13) )
  {
    v27 = *((_QWORD *)a2 + 5);
    v28 = *((_QWORD *)a2 + 4);
    v29 = *((_QWORD *)a2 + 3);
