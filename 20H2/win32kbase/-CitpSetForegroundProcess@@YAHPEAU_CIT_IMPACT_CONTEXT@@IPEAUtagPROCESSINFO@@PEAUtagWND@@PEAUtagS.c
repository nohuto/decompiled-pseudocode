/*
 * XREFs of ?CitpSetForegroundProcess@@YAHPEAU_CIT_IMPACT_CONTEXT@@IPEAUtagPROCESSINFO@@PEAUtagWND@@PEAUtagSHELL_INPUT_USAGE_DATA_INFO@@@Z @ 0x1C0066264
 * Callers:
 ...
 *     CitSessionConnectChange @ 0x1C00BCA80 (CitSessionConnectChange.c)
 ...
 *     ?CalculateDeltaFrom@CIT_USER_ACTIVITY_STAT@@QEAA?AU1@AEBU1@@Z @ 0x1C0066CF8 (-CalculateDeltaFrom@CIT_USER_ACTIVITY_STAT@@QEAA-AU1@AEBU1@@Z.c)
 ...
 *     ?CitpProgDataNotifyUseUpdate@@YAXPEAU_CIT_IMPACT_CONTEXT@@PEAU_CIT_PROG_DATA@@@Z @ 0x1C01F87D4 (-CitpProgDataNotifyUseUpdate@@YAXPEAU_CIT_IMPACT_CONTEXT@@PEAU_CIT_PROG_DATA@@@Z.c)
 */
...
LABEL_60:
  ...
  if ( a2 - *((_DWORD *)a1 + 144) > 2 * *(&xmmword_1C024E474 + 2) )
  {
    v76 = 4;
    goto LABEL_60;
  }
LABEL_4:
  if ( a2 - *((_DWORD *)a1 + 206) >= HIDWORD(xmmword_1C024E484) )
    CitpDPDataLog(a1);
  if ( *((_QWORD *)a1 + 15) )
  {
    v14 = *((_DWORD *)a1 + 81);
    ...
    *((_DWORD *)a1 + 158) += v127;
    ...
    if ( dword_1C0243250 && (unsigned __int8)tlgKeywordOn(&dword_1C0243250, 0x800000000800LL, v21, v22) )
    {
      ...
      if ( HIBYTE(qword_1C024E494) )
      {
        ...
        *((_QWORD *)a1 + 104) = v32;
        ...
        {
          if ( (unsigned __int8)tlgKeywordOn(&dword_1C0243250, 0x800000000800LL, v32, v31) )
          {
            v119 = v117;
            v36 = *((_WORD *)a1 + 80);
            v115 = *((_WORD *)a1 + 81);
        ...
        if ( v77 )
        {
          ...
          *((_DWORD *)v77 + 20) = v79;
          if ( v81 + v92 >= v81 )
            v82 = v81 + v92;
          *((_DWORD *)v77 + 21) = v82;
          CitpProgDataNotifyUseUpdate(xmmword_1C024E4A0, v77);
        }
      }
          ...
          *(_DWORD *)(v60 + 70) = v145;
          CitpBitmapUpdateForTimeRange(
            ...
            *((_DWORD *)a1 + 34),
            a2,
            *((_DWORD *)a1 + 218),
            DWORD2(xmmword_1C024E484));
        }
        if ( (xmmword_1C024E484 & 1) != 0 && a2 - *((_DWORD *)a1 + 218) > DWORD1(xmmword_1C024E484) )
  ...
  *(_DWORD *)((char *)a1 + 178) = 0;
  ...
  {
    v65 = *(_QWORD *)(v7 + 928);
    if ( dword_1C0243250 && (unsigned __int8)tlgKeywordOn(&dword_1C0243250, 0x800000000800LL, v62, v63) )
    {
      if ( (xmmword_1C024E484 & 1) != 0
      ...
      *(_DWORD *)((char *)a1 + 178) = v66;
      if ( HIBYTE(qword_1C024E494) )
      {
        ...
        *((_QWORD *)a1 + 104) = v69;
        ...
        if ( (unsigned int)dword_1C0243250 > 5 )
        {
          if ( (unsigned __int8)tlgKeywordOn(&dword_1C0243250, 0x800000000800LL, v69, v68) )
          {
            LODWORD(v124) = v118;
            v111 = v147;
            v88 = BYTE2(v147);
