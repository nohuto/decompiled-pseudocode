/*
 * XREFs of ?Create@CSharedReadCaptureControllerMarshaler@DirectComposition@@SAJPEBVCSharedSystemResource@2@PEAPEAV12@@Z @ 0x1C01F3870
 * Callers:
 *     CreateSharedReadCaptureControllerMarshaler @ 0x1C01F3A30 (CreateSharedReadCaptureControllerMarshaler.c)
 * Callees:
