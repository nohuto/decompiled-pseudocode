/*
 * XREFs of ?vReleaseCurrentpMapProcForSurfaces@@YAXW4_CLEANUPTYPE@@@Z @ 0x1C00186D0
 * Callers:
...
void __fastcall vReleaseCurrentpMapProcForSurfaces(__int64 a1)
{
  ...
  if ( (_DWORD)a1 == 2 )
  {
    ...
    while ( 1 )
    {
      ...
      {
        v2 = gpHandleManager;
        v3 = GdiHandleManager::DecodeIndex(gpHandleManager, NextEntryIndex);
        v4 = *((_QWORD *)v2 + 2);
        v5 = v3;
        ...
        if ( v3 < (unsigned int)a1 )
        {
          ...
          {
            v10 = v9[33];
            CurrentProcessWin32Process = PsGetCurrentProcessWin32Process(a1, v5, v6, v7);
