/*
 * XREFs of ?Create@CSharedWriteRemoteAppRenderTargetMarshaler@DirectComposition@@SAJPEBVCSharedSystemResource@2@PEAPEAV12@@Z @ 0x1C01F3484
 * Callers:
 *     CreateSharedWriteRemoteAppRenderTargetMarshaler @ 0x1C01F35F0 (CreateSharedWriteRemoteAppRenderTargetMarshaler.c)
 * Callees:
