/*
 * XREFs of ?createrec@EPATHOBJ@@IEAAHPEAVEXFORMOBJ@@PEAU_PATHDATAL@@PEAU_POINTFIX@@@Z @ 0x1C0087814
 * Callers:
 ...
 *     ?vOffsetPoints@@YAXPEAU_POINTFIX@@0IJJ@Z @ 0x1C013F144 (-vOffsetPoints@@YAXPEAU_POINTFIX@@0IJJ@Z.c)
 */
