/*
 * XREFs of NtGdiGetCOPPCompatibleOPMInformation @ 0x1C0141BE0
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall NtGdiGetCOPPCompatibleOPMInformation(unsigned __int64 a1, char *a2, void *a3)
{
  ...
  v4 = (char *)qword_1C024ABD8 + 16;
  v7 = *((_QWORD *)qword_1C024ABD8 + 2);
  ++*(_DWORD *)(v7 + 20);
  ...
  COPMSimpleBufferPool<_DXGKMDT_OPM_REQUESTED_INFORMATION>::AcquireBufferSafe(
    (struct _SLIST_ENTRY *)((char *)qword_1C024ABD8 + 8),
    (PSLIST_ENTRY *)Src);
