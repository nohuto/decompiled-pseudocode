/*
 * XREFs of ?AddThreadPointerData@CTouchProcessor@@QEAAHPEAUtagTHREADINPUTPOINTERLIST@@GK_KIUtagINPUTDEST@@H@Z @ 0x1C01858A0
 * Callers:
 *     <none>
 * Callees:
        ...
        int a8)
{
  ...
  int v34; // r9d
  __int64 v35; // rcx
  _BYTE v37[40]; // [rsp+30h] [rbp-F8h] BYREF
  CInpLockGuard *v38; // [rsp+58h] [rbp-D0h]
  _BYTE v39[128]; // [rsp+60h] [rbp-C8h] BYREF
  ...
  CInpLockGuardExclusive::CInpLockGuardExclusive((CInpLockGuardExclusive *)v37, (struct CInpLockGuard *)(a1 + 40), a5);
  ...
  if ( ThreadPointerData )
  {
    ...
    if ( v26 == a5 )
    {
      ...
      *(_DWORD *)(v25 + 32) = a6;
      ...
      v33 = v32 & 0xFFFFFFF5;
      *(_QWORD *)(v25 + 40) = WindowHandle;
      *(_DWORD *)(v25 + 48) = v33;
      if ( WPP_RECORDER_INITIALIZED != (_UNKNOWN *)&WPP_RECORDER_INITIALIZED
        && LOWORD(WPP_GLOBAL_Control->DeviceType) != v31 )
      {
        LOBYTE(v29) = 5;
        WPP_RECORDER_SF_(
          WPP_GLOBAL_Control->DeviceExtension,
  ...
  if ( v25 )
  {
    ...
    *(_QWORD *)(v25 + 24) = a5;
    *(_DWORD *)(v25 + 32) = a6;
    *(_QWORD *)(v25 + 40) = CInputDest::GetWindowHandle((CInputDest *)v39);
    *(_DWORD *)(v25 + 48) = a8 & 1 | v34 & 0xFFFFFFFC;
    CTouchProcessor::ReferenceMsgData(v35, a5, 4LL);
  }
  if ( WPP_RECORDER_INITIALIZED != (_UNKNOWN *)&WPP_RECORDER_INITIALIZED && LOWORD(WPP_GLOBAL_Control->DeviceType) )
  {
    LOBYTE(v29) = 5;
  ...
  v18 = v25 != 0;
LABEL_42:
  CInputDest::SetEmpty((CInputDest *)v39, v29, v30, v33);
  CInpLockGuard::UnLock((PERESOURCE *)v38, (struct CRefUnRefPointerMsgId *)v37);
  return v18;
}
