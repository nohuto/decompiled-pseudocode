/*
 * XREFs of ?_CreateCompositionInputSink@@YAJPEBUCOMPOSITION_INPUT_SINK@@HPEAPEAX@Z @ 0x1C0030018
 * Callers:
 *     NtCreateImplicitCompositionInputSink @ 0x1C002C840 (NtCreateImplicitCompositionInputSink.c)
 *     NtCreateCompositionInputSink @ 0x1C002EE20 (NtCreateCompositionInputSink.c)
 * Callees:
