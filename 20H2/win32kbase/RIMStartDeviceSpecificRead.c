/*
 * XREFs of RIMStartDeviceSpecificRead @ 0x1C0020CCC
 * Callers:
 ...
 *     RIMStartDeviceRead @ 0x1C0020E60 (RIMStartDeviceRead.c)
...
LABEL_8:
      ...
      *(_DWORD *)(a2 + 184) |= 0x80u;
      ...
      if ( v8 >= 0 )
      {
        ...
        if ( (unsigned int)dword_1C0244A70 > 5 && (unsigned __int8)tlgKeywordOn(&dword_1C0244A70, 256LL, v11, v12) )
        {
        ...
        else
        {
          ...
          if ( (v13 & 0x100) != 0 )
          {
            if ( (unsigned int)dword_1C0243170 > 5
              && (unsigned __int8)tlgKeywordOn(&dword_1C0243170, 0x400000000000LL, v13, v12) )
            {
        ...
        if ( v8 == -1073741670 )
        {
          ...
          *(_BYTE *)(a2 + 204) = v21 + 1;
          if ( v21 >= 5u )
          {
            ...
            if ( (unsigned int)dword_1C0243170 > 5
              && (unsigned __int8)tlgKeywordOn(&dword_1C0243170, 0x400000000000LL, v28, v29) )
            {
          ...
          else
          {
            ...
            if ( (unsigned int)dword_1C0243170 > 5 )
            {
              if ( (unsigned __int8)tlgKeywordOn(&dword_1C0243170, 0x400000000000LL, v23, v24) )
              {
