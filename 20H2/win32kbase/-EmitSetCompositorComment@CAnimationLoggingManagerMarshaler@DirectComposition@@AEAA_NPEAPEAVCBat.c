/*
 * XREFs of ?EmitSetCompositorComment@CAnimationLoggingManagerMarshaler@DirectComposition@@AEAA_NPEAPEAVCBatch@2@@Z @ 0x1C007E5F4
 * Callers:
        ...
        struct DirectComposition::CBatch **a2)
{
  ...
  if ( (*((_BYTE *)this + 256) & 1) != 0 )
  {
    ...
    if ( (unsigned __int64)v12 >= v9
      || DirectComposition::CBatch::AllocateNewFragment(
           (struct DirectComposition::CBatch ***)a2,
           (unsigned __int64 *)&v12)
      && (unsigned __int64)v12 >= v9 )
    {
      v12 = 0LL;
