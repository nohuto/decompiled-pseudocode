/*
 * XREFs of NtDCompositionSynchronize @ 0x1C005ED00
 * Callers:
 *     <none>
 * Callees:
 *     ?Synchronize@CSynchronizationManager@DirectComposition@@SAJPEAVCBatch@2@@Z @ 0x1C005EDD0 (-Synchronize@CSynchronizationManager@DirectComposition@@SAJPEAVCBatch@2@@Z.c)
