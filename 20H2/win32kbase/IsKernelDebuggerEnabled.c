/*
 * XREFs of IsKernelDebuggerEnabled @ 0x1C011C274
 * Callers:
 *     ?WatchDogBugCheckMachine@@YAXPEAURawInputManagerObject@@_K111@Z @ 0x1C0152E14 (-WatchDogBugCheckMachine@@YAXPEAURawInputManagerObject@@_K111@Z.c)
 * Callees:
 *     <none>
 */
