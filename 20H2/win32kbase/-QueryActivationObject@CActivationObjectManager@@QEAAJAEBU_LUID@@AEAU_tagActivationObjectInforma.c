/*
 * XREFs of ?QueryActivationObject@CActivationObjectManager@@QEAAJAEBU_LUID@@AEAU_tagActivationObjectInformation@@@Z @ 0x1C009222C
 * Callers:
 *     NtUserQueryActivationObject @ 0x1C00AE040 (NtUserQueryActivationObject.c)
 * Callees:
 *     ?GetContainingGroupIdFromActivationObject@CActivationObjectManager@@AEBA?AUACTIVATION_GROUP_ID@@AEBVCActivationObject@@@Z @ 0x1C00922EC (-GetContainingGroupIdFromActivationObject@CActivationObjectManager@@AEBA-AUACTIVATION_GROUP_ID@@.c)
        ...
        struct _tagActivationObjectInformation *a3)
{
  ...
  ExAcquirePushLockSharedEx(&qword_1C024E4D0, 0LL);
  ...
  ExReleasePushLockSharedEx(&qword_1C024E4D0, 0LL);
