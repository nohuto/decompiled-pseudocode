/*
 * XREFs of RIMWatchDog @ 0x1C0063100
 * Callers:
 *     <none>
 * Callees:
        ...
        && (struct _LIST_ENTRY *)(*(_QWORD *)&KeQueryPerformanceCounter(0LL) - (unsigned __int64)v2[45].Blink) > v2[46].Flink )
      {
        if ( !PsGetProcessDebugPort(v2[2].Flink) )
        {
          ...
          if ( (unsigned int)dword_1C0243170 > 5
            && (unsigned __int8)tlgKeywordOn(&dword_1C0243170, 0x400000000000LL, v7, v6) )
          {
      ...
      else
      {
        ...
        if ( (struct _LIST_ENTRY *)(*(_QWORD *)&KeQueryPerformanceCounter(0LL) - (unsigned __int64)v2[44].Blink) > v2[44].Flink )
        {
          ...
          DbgPrintGDI(
            ...
            HIDWORD(v2[5].Flink));
          if ( (unsigned int)dword_1C0243170 > 5
            && (unsigned __int8)tlgKeywordOn(&dword_1C0243170, 0x400000000000LL, v13, v14) )
          {
