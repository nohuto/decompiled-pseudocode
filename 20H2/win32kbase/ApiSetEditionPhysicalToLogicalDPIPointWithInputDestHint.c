/*
 * XREFs of ApiSetEditionPhysicalToLogicalDPIPointWithInputDestHint @ 0x1C00B46D4
 * Callers:
        ...
        __int64 a4)
{
  ...
  *a1 = v6;
  if ( qword_1C0251888 )
    result = qword_1C0251888();
  else
    result = 3221225659LL;
  if ( (int)result >= 0 )
  {
    result = (__int64)qword_1C0251890;
    if ( qword_1C0251890 )
      result = qword_1C0251890(a1, v6, a3, a4);
  }
