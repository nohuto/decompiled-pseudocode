/*
 * XREFs of McTemplateK0pqqqqqq_EtwWriteTransfer @ 0x1C014DD04
 * Callers:
 *     EtwDevLockEndUpdate @ 0x1C0096A10 (EtwDevLockEndUpdate.c)
 *     EtwDevLockEndTightUpdate @ 0x1C00A71C0 (EtwDevLockEndTightUpdate.c)
 * Callees:
