/*
 * XREFs of LogicalToPhysicalDPIPoint @ 0x1C0030850
 * Callers:
...
__int64 __fastcall LogicalToPhysicalDPIPoint(__int64 a1, __int64 a2, unsigned int a3, _QWORD *a4)
{
  ...
  if ( v8 == 2 && (CurrentThreadDpiAwarenessContext & 0x20000000) == 0 || !qword_1C0250B18 || (int)qword_1C0250B18() < 0 )
  {
    *(_QWORD *)a1 = *(_QWORD *)a2;
    return 0LL;
  }
  if ( !a4 || (v9 = (_QWORD *)*a4) == 0LL )
  {
    v9 = qword_1C0250B20;
    if ( qword_1C0250B20 )
      v9 = (_QWORD *)qword_1C0250B20(*(_QWORD *)a2, 2LL, CurrentThreadDpiAwarenessContext);
  }
  if ( a4 )
    *a4 = v9;
  v10 = v9[5];
