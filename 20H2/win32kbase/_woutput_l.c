/*
 * XREFs of _woutput_l @ 0x1C00CCC90
 * Callers:
 ...
 *     write_multi_char_0 @ 0x1C00CD5D0 (write_multi_char_0.c)
 *     write_string_0 @ 0x1C00CD628 (write_string_0.c)
 *     _get_printf_count_output @ 0x1C00CD6B4 (_get_printf_count_output.c)
