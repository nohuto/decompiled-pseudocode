/*
 * XREFs of ?DropInput@RIM@InputTraceLogging@@SAXPEBURIMDEV@@W4DropReason@12@@Z @ 0x1C01665DC
 * Callers:
 ...
 *     ?DropReasonToString@InputTraceLogging@@CAPEBDW4DropReason@RIM@1@@Z @ 0x1C0166704 (-DropReasonToString@InputTraceLogging@@CAPEBDW4DropReason@RIM@1@@Z.c)
 */
...
char __fastcall InputTraceLogging::RIM::DropInput(__int64 a1)
{
  ...
  if ( (_BYTE)v1 )
  {
    if ( (_BYTE)v1 == 2 )
    {
      ...
      if ( (v1 & 0x80u) == 0 )
      {
        ...
        {
          LOBYTE(v1) = tlgKeywordOn((__int64)&dword_1C0244A70, 256LL);
          if ( (_BYTE)v1 )
          {
            v3 = InputTraceLogging::DropReasonToString(v8);
            v6 = (unsigned __int8 *)&unk_1C0214A42;
            goto LABEL_17;
          }
        }
      }
      else if ( (unsigned int)dword_1C0244A70 > 4 )
      {
        ...
        if ( (_BYTE)v1 )
        {
          ...
          v6 = (unsigned __int8 *)&unk_1C02149A1;
          goto LABEL_17;
        }
      }
    }
    else if ( (_BYTE)v1 == 1 && (unsigned int)dword_1C0244A70 > 4 )
    {
      LOBYTE(v1) = tlgKeywordOn((__int64)&dword_1C0244A70, 256LL);
      if ( (_BYTE)v1 )
      {
        v3 = InputTraceLogging::DropReasonToString(v9);
        v6 = (unsigned __int8 *)&unk_1C0214A0B;
        goto LABEL_17;
      }
    }
  }
  else if ( (unsigned int)dword_1C0244A70 > 4 )
  {
    ...
    if ( (_BYTE)v1 )
    {
      ...
      v6 = (unsigned __int8 *)&unk_1C02149D7;
LABEL_17:
      v11 = v3;
      v12 = v4;
