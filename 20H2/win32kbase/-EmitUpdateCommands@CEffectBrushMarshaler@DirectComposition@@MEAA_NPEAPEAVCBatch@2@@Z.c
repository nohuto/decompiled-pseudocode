/*
 * XREFs of ?EmitUpdateCommands@CEffectBrushMarshaler@DirectComposition@@MEAA_NPEAPEAVCBatch@2@@Z @ 0x1C007F5E0
 * Callers:
 *     <none>
 * Callees:
 *     ?EmitSetInputs@CEffectBrushMarshaler@DirectComposition@@AEAA_NPEAPEAVCBatch@2@@Z @ 0x1C007F0D8 (-EmitSetInputs@CEffectBrushMarshaler@DirectComposition@@AEAA_NPEAPEAVCBatch@2@@Z.c)
 *     DirectComposition::CResourceMarshaler::EmitUpdateCommand__lambda_394ec4563cb9f209d8bec2a755d1dbfa___ @ 0x1C007F4B8 (DirectComposition--CResourceMarshaler--EmitUpdateCommand__lambda_394ec4563cb9f209d8bec2a755d1dbf.c)
