/*
 * XREFs of ?Create@CSharedReadHolographicInteropTextureMarshaler@DirectComposition@@SAJPEBVCSharedSystemResource@2@PEAPEAV12@@Z @ 0x1C01F3704
 * Callers:
 *     CreateSharedReadHolographicInteropTextureMarshaler @ 0x1C01F3800 (CreateSharedReadHolographicInteropTextureMarshaler.c)
 * Callees:
