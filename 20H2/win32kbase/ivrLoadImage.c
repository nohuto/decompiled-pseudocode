/*
 * XREFs of ivrLoadImage @ 0x1C01B511C
 * Callers:
 ...
 *     _strnicmp @ 0x1C00CC00C (_strnicmp.c)
...
struct _SYSTEM_GDI_DRIVER_INFORMATION *ivrLoadImage()
{
  ...
  xmmword_1C0252590 = 0LL;
  xmmword_1C02525A0 = 0LL;
      ...
      if ( v7 != -1073741820 )
      {
        if ( v7 >= 0 )
        {
          ...
          if ( *v6 )
          {
            ...
            AnsiString_4 = 0;
            v10 = *(char **)&v6[74 * v8 + 6];
            *((_QWORD *)&xmmword_1C02525A0 + 1) = RtlImageDirectoryEntryToData(
                                                    *(PVOID *)&v6[74 * v9 + 6],
                                                    1u,
                                                    0,
                                                    &AnsiString_4);
            AddressOfEntryPoint = RtlImageNtHeader(v10)->OptionalHeader.AddressOfEntryPoint;
            *((_QWORD *)&xmmword_1C0252590 + 1) = 0LL;
            *(_QWORD *)&xmmword_1C02525A0 = &v10[AddressOfEntryPoint];
            v1 = 1;
            *(_QWORD *)&xmmword_1C0252590 = v10;
          }
        }
LABEL_18:
