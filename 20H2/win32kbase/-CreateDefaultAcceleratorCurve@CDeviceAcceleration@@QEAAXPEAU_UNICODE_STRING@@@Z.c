/*
 * XREFs of ?CreateDefaultAcceleratorCurve@CDeviceAcceleration@@QEAAXPEAU_UNICODE_STRING@@@Z @ 0x1C008C5AC
 * Callers:
 *     ReadDefaultAccelerationCurves @ 0x1C008C2D0 (ReadDefaultAccelerationCurves.c)
 * Callees:
        ...
        struct _UNICODE_STRING *a2)
{
  ...
  else
  {
    if ( *((_BYTE *)this + 8) )
      goto LABEL_6;
    *((_OWORD *)this + 1) = xmmword_1C02489C8;
    *((_OWORD *)this + 2) = xmmword_1C02489D8;
    *((_QWORD *)this + 6) = qword_1C02489E8;
    *(_OWORD *)((char *)this + 56) = xmmword_1C02489F0;
    *(_OWORD *)((char *)this + 72) = xmmword_1C0248A00;
    v10 = qword_1C0248A10;
  }
  *((_QWORD *)this + 11) = v10;
LABEL_6:
