/*
 * XREFs of McTemplateK0ppqxxxqqq_EtwWriteTransfer @ 0x1C0128A6C
 * Callers:
 *     EtwTraceTokenCompositionSurfaceObjectEvent @ 0x1C00AB5D0 (EtwTraceTokenCompositionSurfaceObjectEvent.c)
 * Callees:
