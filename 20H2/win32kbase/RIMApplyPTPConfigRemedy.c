/*
 * XREFs of RIMApplyPTPConfigRemedy @ 0x1C017FD08
 * Callers:
    ...
    if ( (unsigned int)IsPTPInputEnabled() && (*(_DWORD *)(a2 + 184) & 0x4000000) != 0 )
    {
      ...
      if ( v7 % 0x19 == 1 && (v9 = *(_BYTE *)(a2 + 206), *(_BYTE *)(a2 + 206) = v9 + 1, v9 < 0x14u) )
      {
        ...
        if ( *(_BYTE *)(a2 + 206) == 1
          ...
          && tlgKeywordOn((__int64)&dword_1C0243250, 0x800000000000LL) )
        {
          v25 = v10 + 148;
      ...
      else
      {
        ...
        if ( v20 > 5 && tlgKeywordOn((__int64)&dword_1C0243250, 0x800000000000LL) )
        {
          v26[0] = v23;
