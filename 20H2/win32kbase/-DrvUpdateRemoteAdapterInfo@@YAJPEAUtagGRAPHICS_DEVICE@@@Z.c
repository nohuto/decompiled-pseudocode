/*
 * XREFs of ?DrvUpdateRemoteAdapterInfo@@YAJPEAUtagGRAPHICS_DEVICE@@@Z @ 0x1C00CB5AC
 * Callers:
    ...
    if ( v2 >= 0 )
    {
      ...
      while ( 1 )
      {
        ...
        if ( IoGetDeviceObjectPointer(&DestinationString, 0, &FileObject, &DeviceObject) >= 0 )
        {
          ...
          if ( v2 >= 0 && (_QWORD)v10 == qword_1C024B244 )
          {
            if ( dword_1C024B240 )
            {
...
LABEL_19:
  ...
  else if ( !Object && (unsigned __int8)((__int64 (*)(void))qword_1C024AAB8)() )
  {
    qword_1C024B244 = *((_QWORD *)a1 + 37);
