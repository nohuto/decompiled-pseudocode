/*
 * XREFs of efSin @ 0x1C00A0170
 * Callers:
 *     efCos @ 0x1C00A0140 (efCos.c)
 ...
 *     eFraction @ 0x1C00B3258 (eFraction.c)
 */
...
__int64 __fastcall efSin(int a1)
{
  ...
  {
    v8 = 4LL * (v14 & 0x1F);
    v9 = (__m128)*(unsigned int *)((char *)&unk_1C02484B0 - v8);
    v9.m128_f32[0] = (float)(v9.m128_f32[0] - gaefSin[32 - (int)v7 - 1]) * *(float *)&v4;
    v10 = _mm_xor_ps(v9, v5);
    v10.m128_f32[0] = v10.m128_f32[0] + *(float *)((char *)&unk_1C02484B0 - v8);
    v11 = v10;
  }
  else
  {
