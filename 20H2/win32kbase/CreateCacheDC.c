/*
 * XREFs of CreateCacheDC @ 0x1C001FB00
 * Callers:
...
__int64 __fastcall CreateCacheDC(__int64 a1, unsigned int a2, __int64 a3)
{
  ...
  DisplayDC = GreCreateDisplayDC(v7, 0);
  if ( !DisplayDC )
  {
    Win32FreePool(v6);
    return 0LL;
  ...
  if ( (a2 & 0x4000) != 0 )
  {
    if ( (int)IsGetStyleWindowSupported() >= 0 && qword_1C02505B0 )
      v9 = qword_1C02505B0(a1, 2848LL);
    else
      v9 = 0LL;
    v10 = a2 & 0xFFFFBFFF;
    if ( v9 )
  ...
  *(_QWORD *)(v6 + 32) = v9;
  if ( (a2 & 0x8000) != 0 )
  {
    ...
    *(_QWORD *)(a1 + 248) = v6;
    if ( (a2 & 0x4000) != 0 )
    {
      v13 = qword_1C02505F8 ? qword_1C02505F8() : -1073741637;
      if ( v13 >= 0 && qword_1C0250600 )
        qword_1C0250600(v6, 0LL);
    }
  }
  else
  {
