/*
 * XREFs of ?DisplayPath@InputConfig@InputTraceLogging@@SAXAEBUDISPLAYCONFIG_PATH_INFO_INTERNAL@@@Z @ 0x1C000A89C
 * Callers:
 ...
 *     ?ScalingToString@InputTraceLogging@@CAPEBDW4DISPLAYCONFIG_SCALING@@@Z @ 0x1C01ADE64 (-ScalingToString@InputTraceLogging@@CAPEBDW4DISPLAYCONFIG_SCALING@@@Z.c)
 */
        ...
        __int64 a4)
{
  ...
  {
    if ( (unsigned __int8)tlgKeywordOn(&dword_1C0244A70, 2LL, a1, a4) )
    {
