/*
 * XREFs of ?TPAAPSetCurtainState@CPTPEngine@@AEAAXH@Z @ 0x1C01C2E54
 * Callers:
 ...
 *     ?ProcessInitialization@CPTPEngine@@MEAAJXZ @ 0x1C01C0E90 (-ProcessInitialization@CPTPEngine@@MEAAJXZ.c)
