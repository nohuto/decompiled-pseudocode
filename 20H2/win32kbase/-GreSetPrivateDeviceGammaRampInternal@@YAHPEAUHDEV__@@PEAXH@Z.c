/*
 * XREFs of ?GreSetPrivateDeviceGammaRampInternal@@YAHPEAUHDEV__@@PEAXH@Z @ 0x1C0149D94
 * Callers:
 ...
 *     ?ComposeDeviceGammaRampsUnsafe@PDEVOBJ@@QEAAXXZ @ 0x1C0149BF0 (-ComposeDeviceGammaRampsUnsafe@PDEVOBJ@@QEAAXXZ.c)
 *     ?GetAppliedGammaRampTable@PDEVOBJ@@QEAAPEAXXZ @ 0x1C0149C9C (-GetAppliedGammaRampTable@PDEVOBJ@@QEAAPEAXXZ.c)
      ...
      if ( v7 )
      {
        ...
        else
        {
          ...
          if ( *((_QWORD *)a1 + 211) )
          {
            ...
            if ( !*((_QWORD *)a1 + 213) )
            {
              v16 = PALLOCMEM2(0x600uLL, 1735354695LL, 0);
              if ( v16 )
                *((_QWORD *)a1 + 213) = v16;
              else
                v7 = 0;
