/*
 * XREFs of ?AssignPointerCaptureData@CTouchProcessor@@AEAAXPEAUCInputPointerNode@@PEAUCPointerMsgData@@@Z @ 0x1C0186080
 * Callers:
        ...
        __int64 a4)
{
  ...
  if ( ((unsigned __int8)v6 & 1) == 0 )
  {
    ...
    {
LABEL_14:
      v8 = Win32AllocPoolZInit(0x138uLL, 0x43707355u);
      if ( !v8 )
        return;
      v8[10] = *((_WORD *)a3 + 8);
