/*
 * XREFs of ?UpdatePointerDeviceSystemMetrics@CInputSystemMetrics@@QEAAXPEBUDEVICEINFO@@_N@Z @ 0x1C01B838C
 * Callers:
 ...
 *     UpdatePointerDeviceSystemMetrics @ 0x1C01AA090 (UpdatePointerDeviceSystemMetrics.c)
 * Callees:
