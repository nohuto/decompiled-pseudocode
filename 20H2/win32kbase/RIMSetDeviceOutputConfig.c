/*
 * XREFs of RIMSetDeviceOutputConfig @ 0x1C0164BD4
 * Callers:
 ...
 *     ?GetPointerDeviceConfig@InputConfig@@SA_NPEBURIMDEV@@PEBUtagHID_POINTER_DEVICE_INFO@@PEAVCLockedInputSpace@@PEAVCLockedInputSpaceRegion@@@Z @ 0x1C01ADBF8 (-GetPointerDeviceConfig@InputConfig@@SA_NPEBURIMDEV@@PEBUtagHID_POINTER_DEVICE_INFO@@PEAVCLocked.c)
        ...
        __int64 a4)
{
  ...
  if ( *((_DWORD *)a1 + 336) && a4 && *((_DWORD *)a1 + 340) != 4 && *(_DWORD *)a4 )
  {
    while ( 1 )
    {
      ...
      if ( v15[4] == *((_DWORD *)a1 + 469) && v15[5] == *((_DWORD *)a1 + 470) && v15[7] == *((_DWORD *)a1 + 472) )
        break;
      if ( ++v4 >= *(_DWORD *)a4 )
        return;
    }
