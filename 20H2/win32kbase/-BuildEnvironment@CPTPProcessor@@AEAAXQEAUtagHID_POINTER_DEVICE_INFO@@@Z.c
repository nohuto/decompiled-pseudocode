/*
 * XREFs of ?BuildEnvironment@CPTPProcessor@@AEAAXQEAUtagHID_POINTER_DEVICE_INFO@@@Z @ 0x1C01A00B8
 * Callers:
...
void __fastcall CPTPProcessor::BuildEnvironment(CPTPProcessor *this, struct tagHID_POINTER_DEVICE_INFO *const a2)
{
  ...
  *(_QWORD *)((char *)this + 924) = *(_QWORD *)&qword_1C0248FC0;
  *(_OWORD *)((char *)this + 932) = gAapState;
  *(_OWORD *)((char *)this + 948) = xmmword_1C0251BC0;
  *(_OWORD *)((char *)this + 964) = xmmword_1C0251BD0;
  *(_OWORD *)((char *)this + 980) = xmmword_1C0251BE0;
  *(_OWORD *)((char *)this + 996) = xmmword_1C0251BF0;
  *(_OWORD *)((char *)this + 1012) = xmmword_1C0251C00;
