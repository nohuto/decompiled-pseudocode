/*
 * XREFs of ?EmitCreate@CDDisplayRenderTargetMarshaler@DirectComposition@@AEAA_NPEAPEAVCBatch@2@@Z @ 0x1C01E8ED8
 * Callers:
        ...
        struct DirectComposition::CBatch **a2)
{
  ...
  if ( *((_QWORD *)this + 10) )
  {
    v4 = (struct _OBJECT_TYPE *)((__int64 (*)(void))qword_1C024AA18)();
