/*
 * XREFs of ?CollectMousePerfTelemetry@MousePerfSummary@@QEAAXAEBU_MousePerf@@@Z @ 0x1C0035694
 * Callers:
...
LABEL_7:
  ...
  if ( (unsigned int)dword_1C0243170 > 5 && (unsigned __int8)tlgKeywordOn(&dword_1C0243170, 16LL, v27, v28) )
  {
    v47 = v33[8];
    v48 = v33[7];
    v49 = v33[4];
