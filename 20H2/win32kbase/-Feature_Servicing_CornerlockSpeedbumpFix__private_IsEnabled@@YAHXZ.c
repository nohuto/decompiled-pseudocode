/*
 * XREFs of ?Feature_Servicing_CornerlockSpeedbumpFix__private_IsEnabled@@YAHXZ @ 0x1C00D15D0
 * Callers:
 *     ?ApplySpeedBumpAndCornerLock@CCursorClip@@AEAAXUtagPOINT@@_N1PEAU2@@Z @ 0x1C019D660 (-ApplySpeedBumpAndCornerLock@CCursorClip@@AEAAXUtagPOINT@@_N1PEAU2@@Z.c)
 * Callees:
...
__int64 Feature_Servicing_CornerlockSpeedbumpFix__private_IsEnabled(void)
{
  unsigned int CachedFeatureEnabledState; // eax
  unsigned int v1; // ebx

  CachedFeatureEnabledState = wil_details_FeatureStateCache_GetCachedFeatureEnabledState(
                                (unsigned int *)&Feature_Servicing_CornerlockSpeedbumpFix__private_featureState,
                                (__int64)&Feature_Servicing_CornerlockSpeedbumpFix__private_descriptor);
  v1 = (CachedFeatureEnabledState >> 3) & 1;
  wil_details_FeatureReporting_ReportUsageToService(
    (__int64)&Feature_Servicing_CornerlockSpeedbumpFix__private_reporting,
    0x26FDB3Fu,
