/*
 * XREFs of ?bPEBCacheHandle@@YAHW4_HANDLECACHETYPE@@PEAT_OBJECTATTR@@PEAU_ENTRY@@PEAVHANDLELOCK@@PEAPEAU_BASEOBJECT@@@Z @ 0x1C003B020
 * Callers:
...
__int64 __fastcall bPEBCacheHandle(__int64 a1, _DWORD *a2, _DWORD *a3, _DWORD **a4, __int64 a5)
{
  ...
  signed __int32 v57[16]; // [rsp+0h] [rbp-F8h] BYREF
...
LABEL_113:
  ...
  else
  {
    ...
    *(_QWORD *)v22 = v28;
    ...
    {
      v57[14] = v32;
      McTemplateK0ppqqq_EtwWriteTransfer(v31, v30, v32, v14, v33, v29);
    }
  }
