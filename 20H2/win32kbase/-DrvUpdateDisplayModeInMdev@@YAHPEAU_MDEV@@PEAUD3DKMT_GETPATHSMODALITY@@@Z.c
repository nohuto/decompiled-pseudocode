/*
 * XREFs of ?DrvUpdateDisplayModeInMdev@@YAHPEAU_MDEV@@PEAUD3DKMT_GETPATHSMODALITY@@@Z @ 0x1C0145FB8
 * Callers:
...
__int64 __fastcall DrvUpdateDisplayModeInMdev(struct _MDEV *a1, struct D3DKMT_GETPATHSMODALITY *a2, __int64 a3)
{
  ...
  v3 = (int)qword_1C024EF58;
  if ( qword_1C024EF58 )
    v3 = qword_1C024EF58(a1);
  if ( !v3 || *((_DWORD *)a1 + 5) != 1 )
  {
...
LABEL_5:
  ...
  {
    v6 = WdLogNewEntry5_WdEvent(a1, a2, a3);
    *(_QWORD *)(v6 + 24) = 27932LL;
    goto LABEL_5;
  }
  if ( *((_WORD *)a2 + 10) != 1 )
  {
    v6 = WdLogNewEntry5_WdEvent(a1, a2, a3);
    *(_QWORD *)(v6 + 24) = 27937LL;
    goto LABEL_5;
  }
  v8 = *(_QWORD *)a1;
  if ( (unsigned __int8)((__int64 (__fastcall *)(_QWORD, _QWORD))qword_1C024A9D8)(
