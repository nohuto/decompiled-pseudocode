/*
 * XREFs of ?vCreate@RGNMEMOBJ@@QEAAXAEAVEPATHOBJ@@KPEAU_RECTL@@@Z @ 0x1C005A410
 * Callers:
 ...
 *     ?vTighten@RGNOBJ@@QEAAXXZ @ 0x1C005A9E0 (-vTighten@RGNOBJ@@QEAAXXZ.c)
 *     ?vCloseAllFigures@EPATHOBJ@@QEAAXXZ @ 0x1C005AAC0 (-vCloseAllFigures@EPATHOBJ@@QEAAXXZ.c)
 *     ?bFlatten@EPATHOBJ@@QEAAHXZ @ 0x1C0094090 (-bFlatten@EPATHOBJ@@QEAAHXZ.c)
 *     ?bAddNullScan@RGNMEMOBJ@@AEAAHJJ@Z @ 0x1C00C20FC (-bAddNullScan@RGNMEMOBJ@@AEAAHJJ@Z.c)
 *     bConstructGET @ 0x1C00C3A60 (bConstructGET.c)
 *     vAdvanceAETEdges @ 0x1C00C3F30 (vAdvanceAETEdges.c)
 *     vXSortAETEdges @ 0x1C00C45F0 (vXSortAETEdges.c)
 *     vMoveNewEdges @ 0x1C00C4DE0 (vMoveNewEdges.c)
  ...
  *(_QWORD *)this = 0LL;
  ...
  if ( v8 >= 0x14 )
  {
    ...
    if ( (unsigned __int64)(48 * v29) > 0xFFFFFFFF )
      return;
    v11 = (char *)PALLOCMEM2(48 * v29, 1734632775LL, 0);
    if ( !v11 )
      return;
    v12 = 1;
  }
