/*
 * XREFs of ?Initialize@?$CSharedStorage@VCBackTraceBucket@NSInstrumentation@@$$CCJVCBackTraceStorageUnit@2@VCBackTrace@2@@NSInstrumentation@@QEAA_NI@Z @ 0x1C014F128
 * Callers:
 *     ?Create@CBackTraceStoreEx@NSInstrumentation@@SAPEAV12@XZ @ 0x1C014F0CC (-Create@CBackTraceStoreEx@NSInstrumentation@@SAPEAV12@XZ.c)
 * Callees:
 *     <none>
 */
