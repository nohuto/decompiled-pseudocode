/*
 * XREFs of ?HMGrowHandleTable@@YAHXZ @ 0x1C008F7B0
 * Callers:
 ...
 * Callees:
 *     CommitReadOnlyMemory @ 0x1C008F980 (CommitReadOnlyMemory.c)
...
__int64 HMGrowHandleTable(void)
{
  ...
  if ( *((_QWORD *)gpsi + 1) == 65534LL )
    return 0LL;
  v0 = (char *)qword_1C0248D48 + *((unsigned int *)gpsi + 216);
  ...
  *((_QWORD *)gpsi + 1) = (unsigned __int64)*((unsigned int *)gpsi + 216) >> 5;
  ...
  v1 = gHandlePages;
  memset((char *)qword_1C0248D48 + 32 * gHandlePages, 0, 32LL * (*((_QWORD *)gpsi + 1) - gHandlePages));
  memset((char *)gpKernelHandleTable + 24 * v1, 0, 24 * (*((_QWORD *)gpsi + 1) - v1));
  v2 = *((_QWORD *)gpsi + 1) - 1LL;
  v3 = (char *)gpKernelHandleTable + 24 * v2;
  if ( v2 >= v1 )
  {
    v4 = (_WORD *)((char *)qword_1C0248D48 + 32 * *((_QWORD *)gpsi + 1) - 6);
    do
    {
      *v4 = 1;
      if ( (v2 & 1) != 0 )
