/*
 * XREFs of ValidateHwndEx @ 0x1C004C330
 * Callers:
...
__int64 __fastcall ValidateHwndEx(__int64 a1, int a2, int a3)
{
  ...
  v7 = (__int64 *)((char *)gpKernelHandleTable
                 + 24 * ((__int64)((unsigned int)(unsigned __int16)a1 * dword_1C0248D50) >> 5));
  ...
  if ( *v7
    ...
    && (!a2
     ...
     && qword_1C024FC68
     && ((__int64 (__fastcall *)(_QWORD, _QWORD))qword_1C024FC68)(*(_QWORD *)(v9 + 424), *(_QWORD *)(v13 + 24))) )
  {
