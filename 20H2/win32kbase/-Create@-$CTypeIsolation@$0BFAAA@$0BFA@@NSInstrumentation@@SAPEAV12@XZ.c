/*
 * XREFs of ?Create@?$CTypeIsolation@$0BFAAA@$0BFA@@NSInstrumentation@@SAPEAV12@XZ @ 0x1C007316C
 * Callers:
...
void *NSInstrumentation::CTypeIsolation<86016,336>::Create()
{
  ...
  *PoolWithTag = PoolWithTag;
  if ( !(unsigned __int8)NSInstrumentation::CTypeIsolation<86016,336>::Initialize(PoolWithTag) )
  {
