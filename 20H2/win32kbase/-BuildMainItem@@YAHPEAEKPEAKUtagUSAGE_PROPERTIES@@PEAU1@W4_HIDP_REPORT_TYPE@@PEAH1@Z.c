/*
 * XREFs of ?BuildMainItem@@YAHPEAEKPEAKUtagUSAGE_PROPERTIES@@PEAU1@W4_HIDP_REPORT_TYPE@@PEAH1@Z @ 0x1C016A588
 * Callers:
 ...
 *     ?OpenCollection@@YAHPEAEKW4tagHID_IDE_COL_TYPE@@PEAK@Z @ 0x1C016ADF0 (-OpenCollection@@YAHPEAEKW4tagHID_IDE_COL_TYPE@@PEAK@Z.c)
 *     ?SetCollectionLabel@@YAHPEAEKPEAK@Z @ 0x1C016AE5C (-SetCollectionLabel@@YAHPEAEKPEAK@Z.c)
 *     ?SetMultiByteValue@@YAHPEAEKPEAKPEAHK1@Z @ 0x1C016AECC (-SetMultiByteValue@@YAHPEAEKPEAKPEAHK1@Z.c)
 */
