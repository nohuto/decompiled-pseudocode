/*
 * XREFs of ?FlushHoldingBuffer@Mouse@InputTraceLogging@@SAXPEAUDEVICEINFO@@@Z @ 0x1C01ACBA4
 * Callers:
...
void __fastcall InputTraceLogging::Mouse::FlushHoldingBuffer(struct DEVICEINFO *a1)
{
  ...
  if ( (unsigned int)dword_1C0244A70 > 4 && tlgKeywordOn((__int64)&dword_1C0244A70, 64LL) )
  {
    ...
    v2 = v1;
    v5 = 8;
    tlgWriteTransfer_EtwWriteTransfer((__int64)&dword_1C0244A70, (unsigned __int8 *)dword_1C0218E58, 0LL, 0LL, 3u, &v3);
  }
}
