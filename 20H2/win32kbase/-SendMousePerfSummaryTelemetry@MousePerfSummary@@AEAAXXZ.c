/*
 * XREFs of ?SendMousePerfSummaryTelemetry@MousePerfSummary@@AEAAXXZ @ 0x1C01BD2AC
 * Callers:
 ...
 *     ?Reset@MousePerfSummary@@AEAAXXZ @ 0x1C01BCFCC (-Reset@MousePerfSummary@@AEAAXXZ.c)
 */
