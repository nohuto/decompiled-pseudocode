/*
 * XREFs of CoreMsgUninitialize @ 0x1C00BC0A0
 * Callers:
 *     ?Win32KDriverUnload@@YAXPEAU_DRIVER_OBJECT@@@Z @ 0x1C0120150 (-Win32KDriverUnload@@YAXPEAU_DRIVER_OBJECT@@@Z.c)
 * Callees:
 *     _tlgWriteTransfer_EtwWriteTransfer @ 0x1C00689F0 (_tlgWriteTransfer_EtwWriteTransfer.c)
 *     ?Uninitialize@ServerPorts@CoreMessagingK@@SAXXZ @ 0x1C00BC19C (-Uninitialize@ServerPorts@CoreMessagingK@@SAXXZ.c)
  ...
  if ( CoreMessagingK::EntryLock::s_Initialized )
  {
    if ( (unsigned int)dword_1C0243450 > 5 )
      tlgWriteTransfer_EtwWriteTransfer(
        (__int64)&dword_1C0243450,
        (unsigned __int8 *)dword_1C021BFAF,
        0LL,
        0LL,
        2u,
        &v4);
    ...
    if ( (unsigned int)dword_1C0243450 > 5 )
      tlgWriteTransfer_EtwWriteTransfer(
        (__int64)&dword_1C0243450,
        (unsigned __int8 *)dword_1C021BF8E,
        0LL,
        0LL,
        2u,
        &v4);
