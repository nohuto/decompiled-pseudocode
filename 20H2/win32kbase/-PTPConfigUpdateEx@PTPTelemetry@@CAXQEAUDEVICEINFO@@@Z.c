/*
 * XREFs of ?PTPConfigUpdateEx@PTPTelemetry@@CAXQEAUDEVICEINFO@@@Z @ 0x1C01A18C8
 * Callers:
...
void __fastcall PTPTelemetry::PTPConfigUpdateEx(struct DEVICEINFO *const a1, __int64 a2, __int64 a3, __int64 a4)
{
  ...
  *(_QWORD *)&v15.Length = 0x100000LL;
  ...
  v18 = 0LL;
  v19[5] = -__CFSHR__(*(&qword_1C0248FC0 + 1), 3);
  v19[6] = -__CFSHR__(*(&qword_1C0248FC0 + 1), 5);
  v19[7] = qword_1C0248FC0;
  if ( a1 )
  {
    v11 = *((_QWORD *)a1 + 60);
    v8 = 0;
