/*
 * XREFs of RIMGetDeviceButtons @ 0x1C015DD0C
 * Callers:
 ...
 *     RIMPbuttonToCursor @ 0x1C015F5CC (RIMPbuttonToCursor.c)
...
LABEL_41:
    ...
    {
      v25 = Win32AllocPoolZInit(12LL * *(unsigned int *)(a2 + 720), 0x78647352u);
      *(_QWORD *)(a2 + 968) = v25;
      if ( v25 )
      {
        v26 = *(_DWORD *)(a2 + 24) == 7;
