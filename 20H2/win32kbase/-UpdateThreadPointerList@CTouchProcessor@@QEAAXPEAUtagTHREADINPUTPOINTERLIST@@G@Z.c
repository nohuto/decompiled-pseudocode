/*
 * XREFs of ?UpdateThreadPointerList@CTouchProcessor@@QEAAXPEAUtagTHREADINPUTPOINTERLIST@@G@Z @ 0x1C0083050
 * Callers:
 *     <none>
 * Callees:
...
LABEL_37:
      LOBYTE(v6) = 5;
      WPP_RECORDER_SF_(v11->DeviceExtension, v6, 7, v12, (__int64)&WPP_50814762fbc63e38c7e5eacf83347307_Traceguids);
      goto LABEL_8;
    }
    v13 = 0LL;
    if ( a3 )
