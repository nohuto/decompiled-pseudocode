/*
 * XREFs of rimObsObserveNextInput @ 0x1C017D200
 * Callers:
 *     NtRIMObserveNextInput @ 0x1C01545C0 (NtRIMObserveNextInput.c)
 *     RIMObserveNextInput @ 0x1C0158350 (RIMObserveNextInput.c)
 * Callees:
