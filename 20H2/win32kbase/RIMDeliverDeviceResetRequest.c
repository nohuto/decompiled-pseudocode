/*
 * XREFs of RIMDeliverDeviceResetRequest @ 0x1C0022964
 * Callers:
...
__int64 __fastcall RIMDeliverDeviceResetRequest(char *ApcContext, __int64 a2, __int64 a3, __int64 a4)
{
  ...
  if ( (unsigned int)dword_1C0244A70 > 4 && (unsigned __int8)tlgKeywordOn(&dword_1C0244A70, 256LL, a3, a4) )
  {
    v12 = 0;
    v10 = &v8;
    v8 = ApcContext;
    v11 = 8;
    tlgWriteTransfer_EtwWriteTransfer((int)&dword_1C0244A70, (int)&dword_1C0216AC6, 0, 0, 3u, &v9);
  }
