/*
 * XREFs of ?wil_details_EvaluateFeatureDependencies@@YAXXZ @ 0x1C0278204
 * Callers:
 *     ?wil_details_OnFeatureConfigurationChange@@YAXPEAX@Z @ 0x1C02783A0 (-wil_details_OnFeatureConfigurationChange@@YAXPEAX@Z.c)
 ...
 *     ?wil_details_EvaluateFeatureDependencies_GetCachedFeatureEnabledState@@YA?ATwil_details_FeatureStateCache@@PEAT1@PEBUwil_details_FeatureDescriptor@@@Z @ 0x1C02782A8 (-wil_details_EvaluateFeatureDependencies_GetCachedFeatureEnabledState@@YA-ATwil_details_FeatureS.c)
 */
...
void wil_details_EvaluateFeatureDependencies(void)
{
  ...
  for ( j = (unsigned __int64 *)&wil_details_featureDescriptors_a; ; j = (unsigned __int64 *)((char *)v7 + 32) )
  {
