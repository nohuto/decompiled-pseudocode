/*
 * XREFs of EngLockSurface @ 0x1C00473A0
 * Callers:
 ...
 *     ?_RetrieveTableAndTableEntryIndex@GdiHandleEntryDirectory@@AEAA_NIPEAPEAVGdiHandleEntryTable@@PEAI@Z @ 0x1C00457A0 (-_RetrieveTableAndTableEntryIndex@GdiHandleEntryDirectory@@AEAA_NIPEAPEAVGdiHandleEntryTable@@PE.c)
...
SURFOBJ *__stdcall EngLockSurface(HSURF hsurf)
{
  ...
  v1 = (int *)HmgShareLockCheckIgnoreStockBit(hsurf, 5);
  v2 = v1;
  if ( !v1 )
    return 0LL;
  ...
  if ( v7 == 5 )
  {
    ...
    if ( v8 && qword_1C02453D8 )
      NSInstrumentation::CReferenceTracker::CReferenceCountedType::ReferenceDereferenceCommon(qword_1C02453D8, v8, 0);
  }
  else if ( v7 == 16 )
  {
