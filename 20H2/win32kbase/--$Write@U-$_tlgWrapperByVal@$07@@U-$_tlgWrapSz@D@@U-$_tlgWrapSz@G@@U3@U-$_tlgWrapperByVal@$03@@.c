/*
 * XREFs of ??$Write@U?$_tlgWrapperByVal@$07@@U?$_tlgWrapSz@D@@U?$_tlgWrapSz@G@@U3@U?$_tlgWrapperByVal@$03@@@?$_tlgWriteTemplate@$$A6AJPEBU_tlgProvider_t@@PEBX1IPEAU_EVENT_DATA_DESCRIPTOR@@@Z$1?_tlgWriteAgg@@YAJ011I2@ZPEBX@@SAJPEBU_tlgProvider_t@@PEBX1AEBU?$_tlgWrapperByVal@$07@@AEBU?$_tlgWrapSz@D@@AEBU?$_tlgWrapSz@G@@4AEBU?$_tlgWrapperByVal@$03@@@Z @ 0x1C012AE74
 * Callers:
        ...
        __int64 a8)
{
  ...
  *(_DWORD *)&EventDescriptor.Level = *(unsigned __int16 *)(a2 + 1);
  ...
  UserData.Ptr = (ULONGLONG)off_1C02431E8;
  v27 = a4;
  v28 = 8LL;
  UserData.Size = *(unsigned __int16 *)off_1C02431E8;
  ...
  result = -1073741811;
  if ( (void (__fastcall *)(const struct _GUID *, unsigned int, unsigned __int8, unsigned __int64, unsigned __int64, struct _EVENT_FILTER_DESCRIPTOR *, void *))qword_1C0243208 == TlgAggregateInternalRegisteredProviderEtwCallback )
  {
    ...
    {
      return EtwWriteTransfer(qword_1C0243200, &EventDescriptor, 0LL, 0LL, 7u, &UserData);
    }
  }
  return result;
}
