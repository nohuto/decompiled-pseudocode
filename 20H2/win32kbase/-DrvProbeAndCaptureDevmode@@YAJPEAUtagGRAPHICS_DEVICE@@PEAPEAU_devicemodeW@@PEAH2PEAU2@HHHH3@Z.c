/*
 * XREFs of ?DrvProbeAndCaptureDevmode@@YAJPEAUtagGRAPHICS_DEVICE@@PEAPEAU_devicemodeW@@PEAH2PEAU2@HHHH3@Z @ 0x1C000EABC
 * Callers:
 ...
 *     ?AreEquivalentDevModes@@YA_NQEBU_devicemodeW@@0@Z @ 0x1C0010724 (-AreEquivalentDevModes@@YA_NQEBU_devicemodeW@@0@Z.c)
 *     PALLOCMEM2 @ 0x1C003C5B0 (PALLOCMEM2.c)
 *     Win32FreePool @ 0x1C0057A50 (Win32FreePool.c)
 *     ?GetClosestMode@@YAPEAU_devicemodeW@@PEAUtagGRAPHICS_DEVICE@@PEAU1@HH@Z @ 0x1C00B7B20 (-GetClosestMode@@YAPEAU_devicemodeW@@PEAUtagGRAPHICS_DEVICE@@PEAU1@HH@Z.c)
        ...
        struct _devicemodeW *a10)
{
  ...
  *a3 = 0;
  ...
  if ( !Src )
    return 0;
  v16 = (struct _devicemodeW *)PALLOCMEM2(0x100DBuLL);
  if ( v16 )
  {
    v17 = *((_DWORD *)a1 + 40);
    v18 = a10;
    ...
    v22 = (struct _devicemodeW *)PALLOCMEM2(dmSize + dmDriverExtra);
    v13 = v22;
    if ( !v22 )
      goto LABEL_128;
    memmove(v22, Src, v21);
...
LABEL_128:
    ...
    v85 = (struct _devicemodeW *)PALLOCMEM2(0xDCuLL);
    if ( !v85 )
      goto LABEL_128;
    ...
    *(_DWORD *)&v16->dmSize = -8739;
    ...
    v39 = (struct _devicemodeW *)PALLOCMEM2(v38 + 220);
    if ( !v39 )
      goto LABEL_127;
    if ( v38 )
    {
...
LABEL_62:
    ...
    else
    {
      ...
      else
      {
        ...
        v67 = !v66;
        v68 = 8LL * !v66;
        v69 = (DWORD *)((char *)&unk_1C021E958 + v68 + 4);
        if ( v84 )
        {
          do
          {
        ...
        v16->dmPelsWidth = *(_DWORD *)((char *)&unk_1C021E958 + v68);
        v71 = *v69;
        v25 = a1;
...
LABEL_117:
          ...
          if ( (*((_DWORD *)v25 + 40) & 0x800000) != 0 && v56 + v39->dmSize == 244 )
            ((void (__fastcall *)(struct _devicemodeW *, struct _devicemodeW *))qword_1C024A908)(v39, v39);
          if ( v87 )
          {
