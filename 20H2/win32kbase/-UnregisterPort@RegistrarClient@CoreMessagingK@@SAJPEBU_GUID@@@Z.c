/*
 * XREFs of ?UnregisterPort@RegistrarClient@CoreMessagingK@@SAJPEBU_GUID@@@Z @ 0x1C00A9A58
 * Callers:
 *     ?UninitializeServerPort@ServerPorts@CoreMessagingK@@SAXPEAUServerPortInfo@2@@Z @ 0x1C00A9720 (-UninitializeServerPort@ServerPorts@CoreMessagingK@@SAXPEAUServerPortInfo@2@@Z.c)
 * Callees:
...
__int64 __fastcall CoreMessagingK::RegistrarClient::UnregisterPort(const struct _GUID *a1)
{
  ...
  v9 = v1;
  v3 = CoreUICallSend((int)&v8, (int)&v7, 1, 1, 14, (__int64)&unk_1C0208AB5, &v9);
  if ( v3 < 0 )
  {
  ...
  if ( (unsigned int)dword_1C0243450 > 5 )
  {
    ...
    v11 = a1;
    v12 = 16;
    tlgWriteTransfer_EtwWriteTransfer((__int64)&dword_1C0243450, (unsigned __int8 *)dword_1C021C1D4, 0LL, 0LL, 4u, &v10);
  }
  return v5;
}
