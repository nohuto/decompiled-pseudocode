/*
 * XREFs of ?ValidateProperty@@YAJPEAUtagHID_POINTER_DEVICE_INFO@@PEAUtagPOINTER_DEVICE_EXTENDED_PROPERTY@@@Z @ 0x1C016B7D8
 * Callers:
 *     RIMGetExtendedPointerDeviceProperty @ 0x1C016B7FC (RIMGetExtendedPointerDeviceProperty.c)
