/*
 * XREFs of ?ProcessInput@CPTPProcessor@@QEAAXPEAX0HHH@Z @ 0x1C01A1B84
 * Callers:
  ...
  *((LARGE_INTEGER *)this + 294) = KeQueryPerformanceCounter(0LL);
  ...
  if ( v10 )
  {
    ...
    *(_QWORD *)((char *)this + 1028) = *(_QWORD *)(*((_QWORD *)v12 + 17) + 248LL);
    ...
    v18 = qword_1C024EDD0;
    if ( qword_1C024EDD0 != *((_QWORD *)this + 287) )
    {
      *((_QWORD *)this + 287) = qword_1C024EDD0;
      if ( v18 )
      {
        v19 = *(_QWORD *)v16;
    ...
    v24 = qword_1C024EDD8;
    if ( qword_1C024EDD8 != *((_QWORD *)this + 288) )
    {
      *((_QWORD *)this + 288) = qword_1C024EDD8;
      if ( v24 )
      {
        v25 = *(_QWORD *)v16;
