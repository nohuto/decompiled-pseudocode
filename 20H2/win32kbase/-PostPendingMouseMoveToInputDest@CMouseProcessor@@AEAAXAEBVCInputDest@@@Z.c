/*
 * XREFs of ?PostPendingMouseMoveToInputDest@CMouseProcessor@@AEAAXAEBVCInputDest@@@Z @ 0x1C002EB14
 * Callers:
...
void __fastcall CMouseProcessor::PostPendingMouseMoveToInputDest(CMouseProcessor *this, const struct CInputDest *a2)
{
  ...
  if ( QHelper::HasPendingMouseMove(a2, a2) )
  {
    ...
    PendingMouseMovePoint = QHelper::GetPendingMouseMovePoint(v17, a2);
