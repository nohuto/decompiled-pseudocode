        ...
        __int64 a39)
{
  ...
  const WCHAR *v45; // [rsp+50h] [rbp-B0h]
  ...
  v46 = v42;
  v47 = 0;
  return tlgWriteTransfer_EtwWriteTransfer((__int64)&dword_1C0243250, a2, 0LL, 0LL, 0x25u, &v44);
}
