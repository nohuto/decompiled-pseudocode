/*
 * XREFs of NtDCompositionConfirmFrame @ 0x1C0080AA0
 * Callers:
 *     <none>
 * Callees:
 ...
 *     ?NotifyBatchProcessed@CApplicationChannel@DirectComposition@@QEAAXPEAVCBatch@2@@Z @ 0x1C0080F70 (-NotifyBatchProcessed@CApplicationChannel@DirectComposition@@QEAAXPEAVCBatch@2@@Z.c)
...
__int64 __fastcall NtDCompositionConfirmFrame(__int64 a1, __int64 *a2)
{
  ...
  DirectComposition::CConnection *v30; // [rsp+70h] [rbp+18h]
  ...
  if ( a2 )
  {
    ...
    if ( v4 >= 0 )
    {
      ...
      if ( v4 >= 0 )
      {
        ...
        if ( v12 )
        {
          v11 = (*(__int64 (__fastcall **)(__int64, __int64, __int64 *))(*(_QWORD *)v12 + 32LL))(v12, v29, &v31);
          v10 = v31;
        }
        v28 = v11;
        if ( v11 >= 0 )
        {
          ...
          *((_QWORD *)v3 + 16) = 0LL;
          ...
          KeLeaveCriticalRegion();
          v3 = v30;
          for ( i = (_QWORD *)*((_QWORD *)v30 + 24); i != (_QWORD *)((char *)v30 + 192); i = (_QWORD *)*i )
          {
            v23 = i[6];
            if ( v23 )
            {
        ...
        {
          DirectComposition::CConnection::~CConnection(v30);
