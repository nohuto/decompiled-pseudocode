/*
 * XREFs of ?EmitSetComments@CAnimationLoggingManagerMarshaler@DirectComposition@@AEAA_NPEAPEAVCBatch@2@@Z @ 0x1C007D3FC
 * Callers:
        ...
        struct DirectComposition::CBatch ***a2)
{
  ...
  if ( v2 < v4 )
  {
    ...
    while ( 1 )
    {
      ...
      v16 = 0LL;
      DirectComposition::CBatch::EnsureBatchBuffer((struct DirectComposition::CBatch **)a2, v12, &v16);
      v13 = (char *)v16;
      *(_DWORD *)v16 = Src;
      *(_OWORD *)(v13 + 4) = 0LL;
      *((_DWORD *)v13 + 1) = 15;
