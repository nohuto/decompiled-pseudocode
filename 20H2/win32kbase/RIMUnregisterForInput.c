/*
 * XREFs of RIMUnregisterForInput @ 0x1C0026970
 * Callers:
    ...
    *((_QWORD *)v4 + 53) = 0LL;
      ...
      if ( (v24 & 0x10) != 0 )
      {
        ...
        *v23 = v24 & 0xFFFFFFEF;
        ...
        if ( !v27 || (v4 = (char *)Object, v27 == KeGetCurrentThread()) )
          MicrosoftTelemetryAssertTriggeredNoArgsKM(v27, v19, v21, v22);
    ...
    do
    {
      ...
      else
      {
        v12 = 1;
        v28 = *v11;
        if ( (__int64 **)v11[1] != v10 || *(__int64 **)(v28 + 8) != v11 )
          __fastfail(3u);
        *v10 = (__int64 *)v28;
        *(_QWORD *)(v28 + 8) = v10;
        Win32FreePool(v11 - 1);
