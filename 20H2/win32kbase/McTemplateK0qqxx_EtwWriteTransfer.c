/*
 * XREFs of McTemplateK0qqxx_EtwWriteTransfer @ 0x1C0129CC4
 * Callers:
 *     EtwGdiSysMemToken @ 0x1C00B13C0 (EtwGdiSysMemToken.c)
 *     EtwTraceTokenIndependentFlipSkipCompleteEvent @ 0x1C0126850 (EtwTraceTokenIndependentFlipSkipCompleteEvent.c)
 * Callees:
