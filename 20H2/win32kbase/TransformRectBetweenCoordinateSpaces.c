/*
 * XREFs of TransformRectBetweenCoordinateSpaces @ 0x1C002F7A0
 * Callers:
 ...
 *     IsDpiAwarenessBoundaryInParentChain @ 0x1C01397E4 (IsDpiAwarenessBoundaryInParentChain.c)
 */
...
__int64 __fastcall TransformRectBetweenCoordinateSpaces(_OWORD *a1, __int64 a2, __int64 a3, __int64 a4)
{
  ...
  v14 = (unsigned int)*v7;
  if ( ((int)v14 >= v7[2] || v7[1] >= v7[3]) && !(_DWORD)v14 && !v7[1] )
  {
LABEL_31:
    *a1 = v11;
    return 0LL;
  ...
  if ( a3 )
  {
    v22 = (int)Is_GetTopLevelWindowSupported(v14, a2, 1LL) >= 0 && qword_1C02509A0 ? qword_1C02509A0(a3) : 0LL;
    if ( v22 )
    {
      if ( v22 != a3 )
      {
  ...
  do
  {
    ...
    if ( (unsigned int)IntersectRect(&v45, (int *)&v43, v7) )
    {
      if ( v39 )
      {
        v30 = v40;
