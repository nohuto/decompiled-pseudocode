/*
 * XREFs of xxxODI_ColorInit @ 0x1C008D430
 * Callers:
 *     InitUserScreen @ 0x1C001F2FC (InitUserScreen.c)
 * Callees:
 *     xxxSetSysColors @ 0x1C001BB80 (xxxSetSysColors.c)
 *     ?CI_GetClrVal@@YAKPEAGK@Z @ 0x1C008D6A4 (-CI_GetClrVal@@YAKPEAGK@Z.c)
...
__int64 __fastcall xxxODI_ColorInit(__int64 a1)
{
  ...
  *(_OWORD *)(v1 + 4584) = xmmword_1C020B390;
  *(_OWORD *)(v1 + 4600) = xmmword_1C020B3A0;
  *(_OWORD *)(v1 + 4616) = xmmword_1C020B3B0;
  *(_OWORD *)(v1 + 4632) = xmmword_1C020B3C0;
  *(_OWORD *)(v1 + 4648) = xmmword_1C020B3D0;
  *(_OWORD *)(v1 + 4664) = xmmword_1C020B3E0;
