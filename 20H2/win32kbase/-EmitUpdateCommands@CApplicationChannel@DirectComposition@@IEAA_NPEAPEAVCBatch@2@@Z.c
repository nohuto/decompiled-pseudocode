/*
 * XREFs of ?EmitUpdateCommands@CApplicationChannel@DirectComposition@@IEAA_NPEAPEAVCBatch@2@@Z @ 0x1C006026C
 * Callers:
        ...
        struct DirectComposition::CBatch **a2)
{
  ...
  for ( i = (__int64 *)*((_QWORD *)this + 51); ; i = (__int64 *)*((_QWORD *)this + 51) )
  {
    ...
    *((_QWORD *)this + 51) = i[1];
    v5 = *i;
    i[1] = 0LL;
    if ( !(*(unsigned __int8 (__fastcall **)(__int64 *, struct DirectComposition::CBatch **))(v5 + 56))(i, a2) )
      break;
    *((_DWORD *)i + 4) &= ~2u;
  }
  i[1] = *((_QWORD *)this + 51);
