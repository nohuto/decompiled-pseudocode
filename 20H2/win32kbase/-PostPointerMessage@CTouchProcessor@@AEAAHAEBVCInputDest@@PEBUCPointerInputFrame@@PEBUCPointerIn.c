/*
 * XREFs of ?PostPointerMessage@CTouchProcessor@@AEAAHAEBVCInputDest@@PEBUCPointerInputFrame@@PEBUCPointerInfoNode@@_KIKHH@Z @ 0x1C0194658
 * Callers:
 ...
 *     messageString @ 0x1C019BF80 (messageString.c)
 *     WPP_RECORDER_SF_LsHHsLLLL @ 0x1C019C5FC (WPP_RECORDER_SF_LsHHsLLLL.c)
 *     GetPointerInputSource @ 0x1C01ABF80 (GetPointerInputSource.c)
        ...
        unsigned int a9)
{
  ...
  if ( CheckAccessEx((int *)(*(_QWORD *)(v24 + 480) + 896LL), (int *)(Queue + 428), 0)
    ...
    && (v29 = *((_QWORD *)ThreadInfo + 53), v28 == v29)
