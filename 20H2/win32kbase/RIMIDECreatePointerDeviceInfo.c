/*
 * XREFs of RIMIDECreatePointerDeviceInfo @ 0x1C0167698
 * Callers:
...
__int64 __fastcall RIMIDECreatePointerDeviceInfo(__int64 a1, __int64 a2, __int64 a3, __int64 a4, __int64 a5)
{
  ...
  *(_QWORD *)&v63 = a5;
  ...
  Handle = 0LL;
  v61 = v11;
  v13 = (char *)Win32AllocPoolZInit(0x4C8uLL, 0x63707352u);
  v16 = v13 == 0LL;
...
LABEL_9:
  ...
  *((_QWORD *)v13 + 94) = 500 * gliQpcFreq.QuadPart / 1000;
  if ( v10 )
  {
    ...
    if ( v12 )
      RIMGetDeviceLocationInfo(v12, a2 + 2112, v29, v30);
  }
  v33 = v56;
  ...
  *((_QWORD *)v13 + 112) = *(_QWORD *)(v33 + 116);
  ...
  else
  {
    *((_DWORD *)v13 + 190) = *(_DWORD *)(v33 + 128);
    v36 = Win32AllocPoolZInit(0x28uLL, 0x6A6E6952u);
    *((_QWORD *)v13 + 89) = v36;
    if ( !v36 )
      v16 = 1;
    if ( v16 )
    ...
    *(_DWORD *)(a2 + 1360) = 6;
    DrvGetWDDMAdapterInfo(
      *(_QWORD *)(*(_QWORD *)(v26 + 80) + 240LL),
      ...
      (_DWORD *)(a2 + 1884));
LABEL_61:
    rimFindMonitorForDigitizerWithQDCData(a2, v25, 0LL, v28);
    goto LABEL_62;
  }
  if ( v10 )
  {
    *(_DWORD *)(a2 + 1344) = 1;
    RIMReadDigitizerToMonitorMappings((const UNICODE_STRING *)(v10 + 88), a2 + 1344, v23, v24);
    goto LABEL_61;
  }
LABEL_62:
  if ( (*((_DWORD *)v13 + 78) & 0x2000) == 0
    ...
    || *((_DWORD *)v13 + 38) - *((_DWORD *)v13 + 36) <= 1 )
  {
    if ( *(_DWORD *)(a2 + 1344) )
    {
      v45 = HMValidateSharedHandleNoRip(*(_QWORD *)(a2 + 1352), v26, v23, v24);
