/*
 * XREFs of ?ShouldDeferToken@CSynchronizationManager@DirectComposition@@SA_N_K0@Z @ 0x1C0095BC8
 * Callers:
 *     DCompositionShouldDeferToken @ 0x1C0095BB0 (DCompositionShouldDeferToken.c)
 * Callees:
