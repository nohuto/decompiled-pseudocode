/*
 * XREFs of ??$EmitSetProperty@UPropertySetColorValue@@U_D3DCOLORVALUE@@@CPropertySetMarshaler@DirectComposition@@AEAA_NPEAPEAVCBatch@1@I@Z @ 0x1C007E99C
 * Callers:
        ...
        unsigned int a3)
{
  ...
  *(_OWORD *)(v7 + 28) = *(_OWORD *)((*(_DWORD *)(*(_QWORD *)(a1 + 72) + 8 * v4 + 4) & 0x1FFFFFFF) + *(_QWORD *)(a1 + 88));
