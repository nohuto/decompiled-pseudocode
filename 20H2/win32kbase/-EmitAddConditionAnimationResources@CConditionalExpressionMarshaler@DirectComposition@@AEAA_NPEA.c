/*
 * XREFs of ?EmitAddConditionAnimationResources@CConditionalExpressionMarshaler@DirectComposition@@AEAA_NPEAPEAVCBatch@2@@Z @ 0x1C01E5540
 * Callers:
        ...
        struct DirectComposition::CBatch ***a2)
{
  ...
  for ( ; *((_DWORD *)this + 35) < *((_DWORD *)this + 34); *((_DWORD *)this + 35) += 2 * v5 )
  {
    ...
    v11 = 0LL;
    DirectComposition::CBatch::EnsureBatchBuffer((struct DirectComposition::CBatch **)a2, 8 * v5 + 16, &v11);
    v6 = (char *)v11;
    v7 = 0;
    *(_DWORD *)v11 = 8 * v5 + 16;
    v8 = v6 + 16;
    ...
    *((_DWORD *)v6 + 2) = *((_DWORD *)this + 6);
    ...
    {
      v9 = 2 * v7++;
      *v8 = *(_DWORD *)(*(_QWORD *)(*((_QWORD *)this + 16) + 8LL * (unsigned int)(v9 + *((_DWORD *)this + 35))) + 24LL);
      v8 += 2;
    }
  }
  return *((_DWORD *)this + 35) == *((_DWORD *)this + 34);
