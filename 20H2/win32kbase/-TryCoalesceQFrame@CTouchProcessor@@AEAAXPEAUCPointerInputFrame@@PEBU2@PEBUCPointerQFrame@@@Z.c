/*
 * XREFs of ?TryCoalesceQFrame@CTouchProcessor@@AEAAXPEAUCPointerInputFrame@@PEBU2@PEBUCPointerQFrame@@@Z @ 0x1C019A3D0
 * Callers:
 ...
 *     EtwTracePointerNoCoalesce @ 0x1C0126530 (EtwTracePointerNoCoalesce.c)
        ...
        const struct CPointerQFrame *a4)
{
  ...
  v10 = 0;
  v11 = 1;
  for ( i = 0; i < (unsigned int)v7; v4 += 160LL )
  {
    if ( *(_DWORD *)v4 == -1 )
      break;
    if ( !a4 || a4 == (const struct CPointerQFrame *)v4 )
    {
      ...
      if ( (v13 & 1) == 0 || (v13 & 8) != 0 || (v14 = v13, *(_QWORD *)(v4 + 8) == -1LL) )
      {
        ...
        if ( (v13 & 2) != 0 )
        {
          MicrosoftTelemetryAssertTriggeredNoArgsKM(this, v13, 0LL, a4);
          v14 = *(unsigned int *)(v4 + 140);
        }
      }
      if ( (v14 & 2) == 0 )
        goto LABEL_17;
      ...
      if ( (v14 & 2) != 0 )
      {
        if ( *(_DWORD *)(v4 + 144) != 1 )
        {
          MicrosoftTelemetryAssertTriggeredNoArgsKM(this, v14, v5, a4);
          LODWORD(v14) = *(_DWORD *)(v4 + 140);
        }
        v8 = 1;
        *(_DWORD *)(v4 + 140) = v14 | 4;
        v30 = 1;
...
LABEL_17:
  ...
  v16 = 1;
  for ( j = 0; j < (unsigned int)v7; v15 += 120 )
  {
    v18 = *((_QWORD *)a2 + 17) + 480LL * (unsigned int)v7;
    if ( (unsigned __int64)v15 >= v18 )
      MicrosoftTelemetryAssertTriggeredNoArgsKM(v18, v7, v5, a4);
    if ( (unsigned int)CPointerInfoNode::IsValid((CPointerInfoNode *)v15) )
    {
      ...
      else
      {
        ...
        if ( !*((_QWORD *)v15 + 2) )
        {
          CTouchProcessor::FreePointerInfoNodeInt((struct _KTHREAD **)v29, a2, j, (__int64)a4);
          v5 = 0LL;
        }
      }
      if ( *(_QWORD *)(v19 + 8) != -1LL )
  ...
  if ( v16 && (unsigned int)dword_1C0244A70 > 4 && tlgKeywordOn((__int64)&dword_1C0244A70, 32LL) )
  {
    v30 = *((_DWORD *)a2 + 10);
    v27 = *((_QWORD *)a2 + 9);
    v28[0] = *((_QWORD *)a2 + 14);
