/*
 * XREFs of McTemplateK0pqqqq_EtwWriteTransfer @ 0x1C0128D98
 * Callers:
 *     EtwTraceInternalSetTimer @ 0x1C00937E0 (EtwTraceInternalSetTimer.c)
 *     EtwTraceTimerProc @ 0x1C0093A70 (EtwTraceTimerProc.c)
 *     EtwDirtyRectUpdate @ 0x1C0096940 (EtwDirtyRectUpdate.c)
 *     EtwLogicalSurfRemovedTranslationFromDirtyEvent @ 0x1C014D7C0 (EtwLogicalSurfRemovedTranslationFromDirtyEvent.c)
 *     EtwLogicalSurfRemovedTranslationFromMoveEvent @ 0x1C014D800 (EtwLogicalSurfRemovedTranslationFromMoveEvent.c)
 *     EtwTranslationUpdate @ 0x1C014DB90 (EtwTranslationUpdate.c)
 * Callees:
