/*
 * XREFs of ?PushEffectLayer@CDrawingContext@@AEAAJPEBVCVisual@@AEBV?$TMilRect_@MUMilRectF@@UMil3DRectF@@UMilPointAndSizeF@@UNotNeeded@RectUniqueness@@@@11PEAVCResource@@PEA_N@Z @ 0x1800102BC
 * Callers:
 ...
 *     ?IsSurfaceSizeValid@CDrawingContext@@AEBA_NII@Z @ 0x1800105A0 (-IsSurfaceSizeValid@CDrawingContext@@AEBA_NII@Z.c)
 *     ?RoundOffLayerSize@CTreeEffectLayer@@SA?AUMilPointAndSizeL@@AEBV?$TMilRect_@MUMilRectF@@UMil3DRectF@@UMilPointAndSizeF@@UNotNeeded@RectUniqueness@@@@@Z @ 0x1800105EC (-RoundOffLayerSize@CTreeEffectLayer@@SA-AUMilPointAndSizeL@@AEBV-$TMilRect_@MUMilRectF@@UMil3DRe.c)
 ...
 *     ?GetLayerPointAndSize@CTreeEffectLayer@@SA?AUMilPointAndSizeL@@PEBVCEffectBrush@@AEBU2@AEBUMilPointAndSizeF@@@Z @ 0x180010A00 (-GetLayerPointAndSize@CTreeEffectLayer@@SA-AUMilPointAndSizeL@@PEBVCEffectBrush@@AEBU2@AEBUMilPo.c)
        ...
        char *a7)
{
  ...
  *((float *)&v53 + 1) = (float)(int)((int)v19.m128_f32[0] - _mm_cmplt_ss(v22, v19).m128_u32[0]);
  if ( (int)v48[2] <= 0 || (int)v48[3] <= 0 )
  {
    ...
    if ( v42 >= 0 )
      goto LABEL_14;
    MilInstrumentationCheckHR_MaybeFailFast(v43, 0LL, 0, v42, 0xDE9u, 0LL);
    goto LABEL_38;
  }
  if ( !a6 )
    goto LABEL_10;
  if ( (*(unsigned __int8 (__fastcall **)(struct CFilterEffect *, __int64))(*(_QWORD *)a6 + 56LL))(a6, 59LL) )
  {
    ...
    if ( v30 < 0 )
    {
      MilInstrumentationCheckHR_MaybeFailFast(v31, 0LL, 0, v30, 0xDFEu, 0LL);
      v9 = v49[0];
    }
    else
    {
      ...
      if ( v32 >= 0 )
        goto LABEL_14;
      MilInstrumentationCheckHR_MaybeFailFast(v33, 0LL, 0, v32, 0xE04u, 0LL);
    }
LABEL_38:
    if ( !v9 )
      return v28;
...
LABEL_28:
  ...
  if ( (int)CTreeEffectLayer::Create(this[4], v48, a6, a2, v52, v50, &v47) < 0 )
  {
    ...
    MilInstrumentationCheckHR_MaybeFailFast(v41, 0LL, 0, v40, 0xE23u, 0LL);
    v10 = v47;
  }
  else
  {
...
LABEL_14:
    ...
    MilInstrumentationCheckHR_MaybeFailFast(v27, 0LL, 0, v26, 0xE2Cu, 0LL);
  }
LABEL_15:
  if ( v10 )
