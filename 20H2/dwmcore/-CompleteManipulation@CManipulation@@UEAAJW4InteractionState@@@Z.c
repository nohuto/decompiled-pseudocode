/*
 * XREFs of ?CompleteManipulation@CManipulation@@UEAAJW4InteractionState@@@Z @ 0x1801D3620
 * Callers:
 *     <none>
 * Callees:
 ...
 *     ?_UpdateCaptureState@CManipulation@@AEAAX_N@Z @ 0x1801D5314 (-_UpdateCaptureState@CManipulation@@AEAAX_N@Z.c)
 */
