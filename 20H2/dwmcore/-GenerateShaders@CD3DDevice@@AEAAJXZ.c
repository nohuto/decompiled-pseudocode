/*
 * XREFs of ?GenerateShaders@CD3DDevice@@AEAAJXZ @ 0x18005270C
 * Callers:
...
LABEL_65:
  ...
  while ( 2 )
  {
    ...
    do
    {
      *(_QWORD *)v55 = 0LL;
      ...
      {
        v21 = *((_OWORD *)&unk_180281FE0 + v20);
        v56 = (struct ID3D11PixelShader *)*((_QWORD *)&unk_180281FE0 + 2 * v20);
        v58 = v21;
        if ( v56 )
        {
          *(_OWORD *)v55 = *((_OWORD *)&unk_1803421D0 + v18);
          *(_OWORD *)v65 = *((_OWORD *)&unk_180342210 + (int)v17);
          v22 = v65[0];
          if ( v65[0] )
          {
            v23 = *(_QWORD *)v55;
  ...
  do
  {
    ...
    *((_QWORD *)v32 + 202) = 0LL;
    ...
    CommonOrCubeMapRenderingShadersNoRefInternal = v35(v31, &byte_1802EAA80[264 * (int)v30], v32 + 1616);
    v9 = CommonOrCubeMapRenderingShadersNoRefInternal;
    if ( CommonOrCubeMapRenderingShadersNoRefInternal < 0 )
    {
      v53 = 595;
  ...
  do
  {
    ...
    *((_QWORD *)v38 + 274) = 0LL;
    ...
    CommonOrCubeMapRenderingShadersNoRefInternal = v41(v37, &_ImageBase + 10 * (int)v36 + 791962, v38 + 2192);
    v9 = CommonOrCubeMapRenderingShadersNoRefInternal;
    if ( CommonOrCubeMapRenderingShadersNoRefInternal < 0 )
    {
      v53 = 601;
