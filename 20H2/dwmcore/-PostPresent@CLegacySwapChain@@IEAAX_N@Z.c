/*
 * XREFs of ?PostPresent@CLegacySwapChain@@IEAAX_N@Z @ 0x1800C1E94
 * Callers:
 ...
 *     ?HasPendingScribble@CLegacySwapChain@@QEBA_NXZ @ 0x180247224 (-HasPendingScribble@CLegacySwapChain@@QEBA_NXZ.c)
