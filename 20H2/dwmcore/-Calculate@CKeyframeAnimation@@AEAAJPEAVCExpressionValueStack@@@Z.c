/*
 * XREFs of ?Calculate@CKeyframeAnimation@@AEAAJPEAVCExpressionValueStack@@@Z @ 0x180026B6C
 * Callers:
 ...
 *     ?GetIsComplete@Timer@@QEBA_NXZ @ 0x180026D3C (-GetIsComplete@Timer@@QEBA_NXZ.c)
...
__int64 __fastcall CKeyframeAnimation::Calculate(CKeyframeAnimation *this, struct CExpressionValueStack *a2)
{
  ...
  if ( (*((_BYTE *)this + 541) & 4) != 0 )
  {
    ...
    if ( v9 < 0 )
    {
      MilInstrumentationCheckHR_MaybeFailFast(v10, 0LL, 0, v9, 0xB01u, 0LL);
      return v5;
    }
    *((_BYTE *)this + 541) &= ~4u;
  }
...
LABEL_9:
  ...
  *((_BYTE *)this + 541) |= 2u;
  ...
  if ( v7 >= 0 )
    return 0;
  MilInstrumentationCheckHR_MaybeFailFast(v8, 0LL, 0, v7, 0xBA1u, 0LL);
  return v5;
}
