/*
 * XREFs of ??$AddOrUpdateProperty@UD2DVector4@@@CPropertySet@@AEAAJPEBUtagMILCMD_PROPERTYSET_SETPROPERTYVALUE@@PEBUD2DVector4@@@Z @ 0x1801E43C0
 * Callers:
...
LABEL_11:
  ...
  else
  {
    ...
    updated = CPropertySet::UpdateProperty<D2DQuaternion>(v9, v7, *(unsigned int *)(v8 + 16));
    v5 = updated;
    if ( updated < 0 )
    {
      v11 = 324;
