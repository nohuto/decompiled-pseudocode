/*
 * XREFs of ?GetCachedFeatureEnabledState@?$FeatureImpl@U__WilFeatureTraits_Feature_ProjectedShadow@@@details@wil@@AEAA?ATwil_details_FeatureStateCache@@XZ @ 0x18002D308
 * Callers:
        ...
        signed __int32 *a2)
{
  ...
  *a2 = *a1;
  if ( (v2 & 3) != 3 )
  {
    ...
    wil::details::FeatureImpl<__WilFeatureTraits_Feature_ProjectedShadow>::GetCurrentFeatureEnabledState(
      (__int64)a1,
      &v16);
    v7 = *a2;
    v8 = v6 != 0 ? v14 : 0;
