/*
 * XREFs of ?TelemetryUpdateTouchLatencyAnalysis@CPartitionVerticalBlankScheduler@@UEAAJAEBUTOUCH_TELEMETRY_UPDATE_INFO@@@Z @ 0x1800037B0
 * Callers:
 *     <none>
 * Callees:
 ...
 *     ?DeleteTouchInfo@InteractionTraceProvider@@SAXAEBUTouchUpdateInfo@CTelemetryTouchLatencyAnalysis@@_K@Z @ 0x18015391C (-DeleteTouchInfo@InteractionTraceProvider@@SAXAEBUTouchUpdateInfo@CTelemetryTouchLatencyAnalysis.c)
