/*
 * XREFs of ?UnTransformOutput@CInteractionContextTransformHelper@@QEAAXAEBUInteractionOutput@@K_NPEAU2@@Z @ 0x180268F50
 * Callers:
 ...
 *     TransformTranslateDelta @ 0x180268EC8 (TransformTranslateDelta.c)
 */
