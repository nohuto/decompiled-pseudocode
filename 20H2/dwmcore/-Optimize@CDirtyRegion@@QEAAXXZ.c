/*
 * XREFs of ?Optimize@CDirtyRegion@@QEAAXXZ @ 0x180099330
 * Callers:
 ...
 *     ?CalcOvehead@@YAMAEBUMilRectF@@0@Z @ 0x1800C467C (-CalcOvehead@@YAMAEBUMilRectF@@0@Z.c)
 *     ?SetFullDirty@CDirtyRegion@@QEAAXXZ @ 0x1800D1330 (-SetFullDirty@CDirtyRegion@@QEAAXXZ.c)
 *     ?CalcAcceleration@CDirtyRegion@@AEAAMAEBUDirtyRegionCachedData@1@0@Z @ 0x1800D3778 (-CalcAcceleration@CDirtyRegion@@AEAAMAEBUDirtyRegionCachedData@1@0@Z.c)
 ...
 *     ?SetRedrawRects@CDirtyRegion@@AEAAXXZ @ 0x180188954 (-SetRedrawRects@CDirtyRegion@@AEAAXXZ.c)
 */
