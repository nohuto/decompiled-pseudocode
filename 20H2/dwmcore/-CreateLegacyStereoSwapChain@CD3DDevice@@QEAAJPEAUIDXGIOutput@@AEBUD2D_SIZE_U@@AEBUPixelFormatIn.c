/*
 * XREFs of ?CreateLegacyStereoSwapChain@CD3DDevice@@QEAAJPEAUIDXGIOutput@@AEBUD2D_SIZE_U@@AEBUPixelFormatInfo@@AEBVRenderTargetInfo@@IPEAPEAVILegacyStereoSwapChain@@@Z @ 0x18023BBD0
 * Callers:
...
LABEL_20:
    ...
    v22 = v18;
LABEL_32:
    MilInstrumentationCheckHR_MaybeFailFast(v8, &dword_180303888, v22, v21, v25, 0LL);
  }
