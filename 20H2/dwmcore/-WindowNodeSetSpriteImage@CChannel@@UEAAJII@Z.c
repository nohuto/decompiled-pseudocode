/*
 * XREFs of ?WindowNodeSetSpriteImage@CChannel@@UEAAJII@Z @ 0x1800D19C0
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall CChannel::WindowNodeSetSpriteImage(CChannel *this, unsigned int a2, int a3)
{
  unsigned int v6; // ebx
