/*
 * XREFs of ?UnlockUnaligned@CBitmapLockUnaligned@@IEAAXXZ @ 0x180215FA0
 * Callers:
 *     ??1CBitmapLockUnaligned@@UEAA@XZ @ 0x180215BFC (--1CBitmapLockUnaligned@@UEAA@XZ.c)
 * Callees:
 *     ??3@YAXPEAX@Z @ 0x18009F4CC (--3@YAXPEAX@Z.c)
 *     ?WriteUnalignedScanline@@YAXPEAEPEBEII@Z @ 0x180216034 (-WriteUnalignedScanline@@YAXPEAEPEBEII@Z.c)
 */
