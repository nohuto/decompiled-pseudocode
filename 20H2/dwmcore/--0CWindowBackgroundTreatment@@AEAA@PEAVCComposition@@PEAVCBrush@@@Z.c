/*
 * XREFs of ??0CWindowBackgroundTreatment@@AEAA@PEAVCComposition@@PEAVCBrush@@@Z @ 0x1800BCD9C
 * Callers:
        ...
        struct CBrush *a3)
{
  ...
  *((_QWORD *)this + 20) = qword_1803437D0;
  ...
  *((_QWORD *)this + 23) = qword_1803437D0;
  ...
  *((_QWORD *)this + 26) = qword_1803437D0;
