/*
 * XREFs of ?GetFrameRate@CDebugFrameCounter@@QEAAIXZ @ 0x18016288C
 * Callers:
 ...
 * Callees:
 *     ?GetFrameCountInternal@CDebugFrameCounter@@IEAAIXZ @ 0x180162858 (-GetFrameCountInternal@CDebugFrameCounter@@IEAAIXZ.c)
 */
