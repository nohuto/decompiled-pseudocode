/*
 * XREFs of ?UpdateConfigurationIfDirty@CChainingHelper@@QEAAXXZ @ 0x1802127F0
 * Callers:
 ...
 *     ?ReconfigureAllManipulations@InteractionSourceManager@@QEAAXXZ @ 0x180211320 (-ReconfigureAllManipulations@InteractionSourceManager@@QEAAXXZ.c)
 *     ?ClearAllConfigurations@CChainingHelper@@QEAAXXZ @ 0x180212760 (-ClearAllConfigurations@CChainingHelper@@QEAAXXZ.c)
 * Callees:
