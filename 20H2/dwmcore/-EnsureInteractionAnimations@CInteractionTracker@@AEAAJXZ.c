/*
 * XREFs of ?EnsureInteractionAnimations@CInteractionTracker@@AEAAJXZ @ 0x1801C88F0
 * Callers:
 ...
 *     ??0CScrollAnimation@@QEAA@PEAVCComposition@@@Z @ 0x180200998 (--0CScrollAnimation@@QEAA@PEAVCComposition@@@Z.c)
...
LABEL_13:
  ...
  if ( !this[41] )
  {
    ...
    {
      v6 = -2147024882;
      MilInstrumentationCheckHR_MaybeFailFast(0LL, 0LL, 0, -2147024882, 0xC7Bu, 0LL);
      return v6;
    }
