/*
 * XREFs of ?LookupPerFrameData@CSynchronousSuperWetInk@@AEAAJIPEAV?$shared_ptr@$$BY0A@E@std@@@Z @ 0x1801EEE60
 * Callers:
 ...
 *     McTemplateU0pxtt_EventWriteTransfer @ 0x1801EFAB0 (McTemplateU0pxtt_EventWriteTransfer.c)
