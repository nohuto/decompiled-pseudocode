/*
 * XREFs of ??0CDirtyRegion@@IEAA@PEAVCVisualTree@@@Z @ 0x180051040
 * Callers:
 ...
 *     ??0CDirtyRegionAnnotationAllocationSet@@QEAA@XZ @ 0x180051160 (--0CDirtyRegionAnnotationAllocationSet@@QEAA@XZ.c)
