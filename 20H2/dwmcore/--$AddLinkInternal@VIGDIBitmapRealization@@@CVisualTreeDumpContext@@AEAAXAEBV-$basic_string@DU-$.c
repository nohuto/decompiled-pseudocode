/*
 * XREFs of ??$AddLinkInternal@VIGDIBitmapRealization@@@CVisualTreeDumpContext@@AEAAXAEBV?$basic_string@DU?$char_traits@D@std@@V?$allocator@D@2@@std@@PEAVIGDIBitmapRealization@@_N@Z @ 0x1801C0D84
 * Callers:
 *     ?DebugDump@CGdiSpriteBitmap@@UEAAXPEAVCVisualTreeDumpContext@@@Z @ 0x1801C14E0 (-DebugDump@CGdiSpriteBitmap@@UEAAXPEAVCVisualTreeDumpContext@@@Z.c)
 * Callees:
