/*
 * XREFs of ?RestoreCursors@CComposition@@QEAAXXZ @ 0x18004FFD4
 * Callers:
 ...
 *     ?RestoreVisuals@COffScreenRenderTarget@@MEAAXXZ @ 0x180185350 (-RestoreVisuals@COffScreenRenderTarget@@MEAAXXZ.c)
 *     ?RestoreVisuals@CMagnifierRenderTarget@@MEAAXXZ @ 0x18018B520 (-RestoreVisuals@CMagnifierRenderTarget@@MEAAXXZ.c)
 * Callees:
