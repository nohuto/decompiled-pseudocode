/*
 * XREFs of ?FillShapeWithBitmap@CDrawingContext@@QEAAJPEAVIBitmapResource@@AEBVCMILMatrix@@AEBVCShape@@_NH@Z @ 0x1800600DC
 * Callers:
 ...
 *     ?SetInverse@MILMatrix3x2@@QEAAXAEBV1@@Z @ 0x18006041C (-SetInverse@MILMatrix3x2@@QEAAXAEBV1@@Z.c)
