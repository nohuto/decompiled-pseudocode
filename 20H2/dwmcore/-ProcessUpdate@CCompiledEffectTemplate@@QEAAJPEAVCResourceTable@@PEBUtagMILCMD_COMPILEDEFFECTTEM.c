/*
 * XREFs of ?ProcessUpdate@CCompiledEffectTemplate@@QEAAJPEAVCResourceTable@@PEBUtagMILCMD_COMPILEDEFFECTTEMPLATE@@@Z @ 0x1800C65F8
 * Callers:
...
LABEL_17:
  ...
  if ( CNotificationResource::ShouldNotify(v4) )
  {
    ...
    v15 = CoreUICallSend(v12, v18, 2LL, 5LL, 1, &unk_1802885ED);
    v8 = v15;
    if ( v15 < 0 )
