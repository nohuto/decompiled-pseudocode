/*
 * XREFs of ?AddToInteractionSummary@CTelemetryTouchLatencyAnalysis@@AEAAXPEBUTouchScenarioInfo@1@_NGGAEBVCLatencyInfo@1@I@Z @ 0x18015C790
 * Callers:
 ...
 *     ?compare@?$basic_string@GU?$char_traits@G@std@@V?$allocator@G@2@@std@@QEBAHAEBV12@@Z @ 0x180041B34 (-compare@-$basic_string@GU-$char_traits@G@std@@V-$allocator@G@2@@std@@QEBAHAEBV12@@Z.c)
 ...
 *     ?UpdateInteractionSummary@InteractionTraceProvider@@SAXAEBUTouchScenarioInfo@CTelemetryTouchLatencyAnalysis@@_NI@Z @ 0x180161198 (-UpdateInteractionSummary@InteractionTraceProvider@@SAXAEBUTouchScenarioInfo@CTelemetryTouchLate.c)
 */
...
LABEL_17:
  ...
  if ( (unsigned int)((PerformanceCount.QuadPart - *((_QWORD *)v10 + 526)) / (qword_1803443F0 / 0x3E8uLL)) >= 0xEA60
    || *((_BYTE *)v10 + 4216) == 5 )
  {
    CTelemetryTouchLatencyAnalysis::SendInteractionSummary(v10);
