/*
 * XREFs of ??_ECParticleVector2Behavior@@UEAAPEAXI@Z @ 0x18016D360
 * Callers:
 *     ??_ECParticleVector2Behavior@@WGI@EAAPEAXI@Z @ 0x1800EEB90 (--_ECParticleVector2Behavior@@WGI@EAAPEAXI@Z.c)
 * Callees:
