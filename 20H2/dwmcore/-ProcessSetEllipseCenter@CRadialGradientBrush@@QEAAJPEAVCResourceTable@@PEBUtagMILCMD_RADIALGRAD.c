/*
 * XREFs of ?ProcessSetEllipseCenter@CRadialGradientBrush@@QEAAJPEAVCResourceTable@@PEBUtagMILCMD_RADIALGRADIENTBRUSH_SETELLIPSECENTER@@@Z @ 0x1801E766C
 * Callers:
        ...
        const struct tagMILCMD_RADIALGRADIENTBRUSH_SETELLIPSECENTER *a3)
{
  ...
  v3 = ((__int64 (__fastcall *)(char *, void *, char *))xmmword_180343280)(
         (char *)this + SDWORD2(xmmword_180343280),
