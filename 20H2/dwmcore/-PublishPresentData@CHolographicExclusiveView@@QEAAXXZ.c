/*
 * XREFs of ?PublishPresentData@CHolographicExclusiveView@@QEAAXXZ @ 0x180254950
 * Callers:
 *     ?InitializeClient@CHolographicManager@@AEAAXXZ @ 0x180251068 (-InitializeClient@CHolographicManager@@AEAAXXZ.c)
 ...
 * Callees:
 *     ?AttachExclusiveSwapChain@CHolographicManager@@QEAA_NPEAVCHolographicExclusiveView@@@Z @ 0x1802503B4 (-AttachExclusiveSwapChain@CHolographicManager@@QEAA_NPEAVCHolographicExclusiveView@@@Z.c)
