/*
 * XREFs of ?GetProcessAttribution@CProcessAttributionManager@@QEAAJK_KPEAPEAVCProcessAttribution@@@Z @ 0x18004270C
 * Callers:
 ...
 * Callees:
 *     ??0Record@CProcessAttributionManager@@QEAA@K_KH@Z @ 0x180040B70 (--0Record@CProcessAttributionManager@@QEAA@K_KH@Z.c)
