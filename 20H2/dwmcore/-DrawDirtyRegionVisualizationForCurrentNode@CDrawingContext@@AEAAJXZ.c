/*
 * XREFs of ?DrawDirtyRegionVisualizationForCurrentNode@CDrawingContext@@AEAAJXZ @ 0x180174E2C
 * Callers:
...
__int64 __fastcall CDrawingContext::DrawDirtyRegionVisualizationForCurrentNode(CDrawingContext *this)
{
  ...
  if ( (*(unsigned __int8 (__fastcall **)(_QWORD))(**((_QWORD **)this + 741) + 200LL))(*((_QWORD *)this + 741)) )
  {
    ...
    *((float *)&X + 3) = v8;
    ...
    if ( v9 < 0 )
    {
      MilInstrumentationCheckHR_MaybeFailFast(v10, 0LL, 0, v9, 0x17E1u, 0LL);
          ...
          if ( *(_QWORD *)(DirtyRegionVisualizationData + 32) )
          {
            ...
            while ( 1 )
            {
              ...
              if ( _mm_shuffle_ps(v32, v32, 255).m128_f32[0] > 0.0 )
              {
                ...
                if ( v24 < 0 )
                {
                  MilInstrumentationCheckHR_MaybeFailFast(v25, 0LL, 0, v24, 0x1815u, 0LL);
...
LABEL_36:
        ...
        v2 = v14;
        if ( v14 < 0 )
          MilInstrumentationCheckHR_MaybeFailFast(v15, 0LL, 0, v14, 0x17ECu, 0LL);
      }
      DynArrayImpl<0>::~DynArrayImpl<0>((__int64)&v27[1]);
