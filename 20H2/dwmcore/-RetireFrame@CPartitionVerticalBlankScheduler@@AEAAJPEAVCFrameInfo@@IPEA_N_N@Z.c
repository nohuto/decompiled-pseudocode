/*
 * XREFs of ?RetireFrame@CPartitionVerticalBlankScheduler@@AEAAJPEAVCFrameInfo@@IPEA_N_N@Z @ 0x180077C20
 * Callers:
 ...
 *     ?RecordRenderGlitch@CTelemetryTouchLatencyAnalysis@@QEAAX_KI@Z @ 0x1800C9CBC (-RecordRenderGlitch@CTelemetryTouchLatencyAnalysis@@QEAAX_KI@Z.c)
 *     ?TraceGlitch@CScheduleStatistics@@CAXIPEBVCFrameInfo@@AEB_K1@Z @ 0x1800CCBF8 (-TraceGlitch@CScheduleStatistics@@CAXIPEBVCFrameInfo@@AEB_K1@Z.c)
 *     __security_check_cookie @ 0x1800E29B0 (__security_check_cookie.c)
 *     _guard_dispatch_icall_nop @ 0x1800EE9F0 (_guard_dispatch_icall_nop.c)
 *     McTemplateU0xqxxqq_EventWriteTransfer @ 0x180153D00 (McTemplateU0xqxxqq_EventWriteTransfer.c)
 */
...
LABEL_6:
  ...
  if ( *((_BYTE *)a2 + 142) || a5 )
  {
    ...
    *((_QWORD *)a2 + 11) = v15;
    ...
    v24 = 0;
    v25 = _InterlockedExchange64(&qword_1803443E8, 0LL);
    dword_18034425C += v25;
    dword_180344260 += HIDWORD(v25);
    if ( *((_DWORD *)a2 + 50) )
    {
      do
      {
