/*
 * XREFs of ?EnsureSwapChain@CLocalAppRenderTarget@@IEAAJXZ @ 0x180189F2C
 * Callers:
 ...
 *     ?SendCompSurfHandle@CLocalAppRenderTarget@@IEBAXPEAX@Z @ 0x18018A5CC (-SendCompSurfHandle@CLocalAppRenderTarget@@IEBAXPEAX@Z.c)
