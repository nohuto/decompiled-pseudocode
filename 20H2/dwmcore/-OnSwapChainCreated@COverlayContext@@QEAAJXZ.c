/*
 * XREFs of ?OnSwapChainCreated@COverlayContext@@QEAAJXZ @ 0x180031EB8
 * Callers:
 ...
 *     ?IsIntelFullDesktopClipRequired@@YA_NI@Z @ 0x1800E6B90 (-IsIntelFullDesktopClipRequired@@YA_NI@Z.c)
