/*
 * XREFs of ?TransformInput@CInteractionContextTransformHelper@@QEAAJAEBUtagPOINTER_INFO@@_NPEAU2@@Z @ 0x180268968
 * Callers:
 ...
 *     s_TransformPointByMatrix @ 0x180269330 (s_TransformPointByMatrix.c)
 */
