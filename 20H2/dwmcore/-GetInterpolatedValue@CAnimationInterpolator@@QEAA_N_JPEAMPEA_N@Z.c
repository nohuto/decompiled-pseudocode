/*
 * XREFs of ?GetInterpolatedValue@CAnimationInterpolator@@QEAA_N_JPEAMPEA_N@Z @ 0x18021D3E0
 * Callers:
 ...
 *     ?EnsureHandoffCachedData@CAnimationInterpolator@@IEAA_NM_K@Z @ 0x18021D09C (-EnsureHandoffCachedData@CAnimationInterpolator@@IEAA_NM_K@Z.c)
