/*
 * XREFs of ?SetProperty@CKeyframeAnimation@@UEAAJIW4DCOMPOSITION_EXPRESSION_TYPE@@PEBX@Z @ 0x1800BFC70
 * Callers:
 *     <none>
 * Callees:
 ...
 *     ?SetProgress@CKeyframeAnimation@@AEAAXM@Z @ 0x1800D13B4 (-SetProgress@CKeyframeAnimation@@AEAAXM@Z.c)
 *     ?SetPlaybackRate@CKeyframeAnimation@@AEAAXM@Z @ 0x1800D35E8 (-SetPlaybackRate@CKeyframeAnimation@@AEAAXM@Z.c)
...
LABEL_32:
  ...
  if ( a2 != 16 )
  {
    ...
    if ( *(int *)(*(_QWORD *)(a1 + 304) + 4LL) >= 0
      ...
      || (qword_180341E90 & 4) == 0
      || (qword_180341E98 & 4) != qword_180341E98 )
    {
      return 0;
    }
