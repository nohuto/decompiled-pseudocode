/*
 * XREFs of ?QueryInterface@BamoDataProviderRegistrarStub@@UEAAJAEBU_GUID@@PEAPEAX@Z @ 0x18017EA70
 * Callers:
 *     ?QueryInterface@BamoDataProviderRegistrarStub@@W7EAAJAEBU_GUID@@PEAPEAX@Z @ 0x1800EFA50 (-QueryInterface@BamoDataProviderRegistrarStub@@W7EAAJAEBU_GUID@@PEAPEAX@Z.c)
 * Callees:
