/*
 * XREFs of ?CopyPixels@CBitmap@@UEAAJPEBUWICRect@@IIPEAE@Z @ 0x18004A180
 * Callers:
 *     ?CopyPixels@CBitmap@@WCI@EAAJPEBUWICRect@@IIPEAE@Z @ 0x1800EFE80 (-CopyPixels@CBitmap@@WCI@EAAJPEBUWICRect@@IIPEAE@Z.c)
 * Callees:
