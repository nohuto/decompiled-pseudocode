/*
 * XREFs of ??$RegisterNodeForVisit@VCResource@@@CDebugTreeDumper@@QEAAXPEAVCResource@@_N@Z @ 0x1801ED650
 * Callers:
 ...
 *     ??$_Insert_nohint@AEB_JU_Not_a_node_tag@std@@@?$_Tree@V?$_Tset_traits@_JU?$less@_J@std@@V?$allocator@_J@2@$0A@@std@@@std@@IEAA?AU?$pair@V?$_Tree_const_iterator@V?$_Tree_val@U?$_Tree_simple_types@_J@std@@@std@@@std@@_N@1@_NAEB_JU_Not_a_node_tag@1@@Z @ 0x1801966A4 (--$_Insert_nohint@AEB_JU_Not_a_node_tag@std@@@-$_Tree@V-$_Tset_traits@_JU-$less@_J@std@@V-$alloc.c)
 ...
 *     ??$?4V_lambda_603f181036d0da53b7b505f826c78df9_@@X@?$function@$$A6AXPEAXPEAVCDebugTreeDumper@@@Z@std@@QEAAAEAV01@$$QEAV_lambda_603f181036d0da53b7b505f826c78df9_@@@Z @ 0x1801ED47C (--$-4V_lambda_603f181036d0da53b7b505f826c78df9_@@X@-$function@$$A6AXPEAXPEAVCDebugTreeDumper@@@Z.c)
 */

__int64 __fastcall CDebugTreeDumper::RegisterNodeForVisit<CResource>(__int64 a1, __int64 a2)
{
  __int64 result; // rax
  __int64 v3; // rdi
  __int64 v5; // r10
  ...
  {
    v23 = 0LL;
    std::function<void (void *,CDebugTreeDumper *)>::operator=<_lambda_603f181036d0da53b7b505f826c78df9_,void>((__int64)v22);
