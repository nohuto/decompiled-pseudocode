/*
 * XREFs of ?GetProperty@CKeyframeAnimation@@UEAAJIPEAVCExpressionValue@@@Z @ 0x1801D0A10
 * Callers:
 *     <none>
 * Callees:
...
LABEL_11:
  ...
  v6 = -2147024809;
  MilInstrumentationCheckHR_MaybeFailFast((__int64)this, 0LL, 0, -2147024809, 0x880u, 0LL);
  return v6;
}
