/*
 * XREFs of ?CalcFrustumOutline@@YAXVCMILMatrix@@PEAULine3D@@111@Z @ 0x1801F347C
 * Callers:
 ...
 *     log10f_0 @ 0x1800EE977 (log10f_0.c)
 *     sqrtf_0 @ 0x1800EE99B (sqrtf_0.c)
 *     ??0Line3D@@QEAA@UMilPoint4F@@0@Z @ 0x1801F33A8 (--0Line3D@@QEAA@UMilPoint4F@@0@Z.c)
 */
