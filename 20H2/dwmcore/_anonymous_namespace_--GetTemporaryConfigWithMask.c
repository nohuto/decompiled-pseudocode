/*
 * XREFs of _anonymous_namespace_::GetTemporaryConfigWithMask @ 0x1800C5834
 * Callers:
 ...
 *     ?SupportsInteractionType@CInteractionProcessor@@QEBAHW4InputType@@I_N@Z @ 0x1800C85BC (-SupportsInteractionType@CInteractionProcessor@@QEBAHW4InputType@@I_N@Z.c)
 ...
 *     ?CanSkipChildren@CInteractionProcessor@@QEBAHXZ @ 0x180229808 (-CanSkipChildren@CInteractionProcessor@@QEBAHXZ.c)
