/*
 * XREFs of ?ProcessReferenceNode@CExpressionValueStack@@QEAAJPEAVCExpression@@PEAUExpressionReferenceNode@@_K@Z @ 0x1800679D0
 * Callers:
        ...
        LARGE_INTEGER a4)
{
  ...
  if ( (unsigned int)~*((_DWORD *)this + 4) < 5 )
  {
    ...
    v11 = -2147418113;
LABEL_48:
    MilInstrumentationCheckHR_MaybeFailFast(v9, &dword_180288F50, 2u, v10, 0x138u, 0LL);
    return v11;
  }
...
LABEL_5:
  ...
  *((_DWORD *)this + 4) = v12 + 1;
  ...
  if ( v8[2] == 2 )
  {
    ...
    if ( v18 < 0 )
    {
      MilInstrumentationCheckHR_MaybeFailFast(v19, &dword_180288F50, 2u, v18, 0xF4u, 0LL);
    }
    else
    {
      if ( v16.QuadPart )
      ...
      if ( v21 < 0 )
      {
        MilInstrumentationCheckHR_MaybeFailFast(v22, &dword_180288F50, 2u, v21, 0xFBu, 0LL);
      }
      else if ( v61 && *((_BYTE *)v61 + 4) && (v40 = CExpressionValue::ApplyMaskToValue(v14, v61), v20 = v40, v40 < 0) )
      {
        MilInstrumentationCheckHR_MaybeFailFast(v41, &dword_180288F50, 2u, v40, 0x10Bu, 0LL);
      }
      else
      {
        v23 = *((_QWORD *)a2 + 22);
    ...
    if ( ValueFromCache >= 0 )
    {
      if ( !LOBYTE(v62.LowPart) )
      {
        ...
        v33 = v20;
LABEL_38:
        MilInstrumentationCheckHR_MaybeFailFast((unsigned int)v30, &dword_180288F50, 2u, v33, v51, 0LL);
        goto LABEL_39;
      }
      return 0LL;
    }
...
LABEL_87:
  ...
  v31 = -2147418113;
  MilInstrumentationCheckHR_MaybeFailFast(v8[2] - 1, &dword_180288F50, 2u, -2147418113, 0x195u, 0LL);
LABEL_39:
  result = v31;
  if ( v14 )
    --*((_DWORD *)this + 4);
