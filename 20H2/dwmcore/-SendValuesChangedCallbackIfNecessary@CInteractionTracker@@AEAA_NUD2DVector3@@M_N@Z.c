/*
 * XREFs of ?SendValuesChangedCallbackIfNecessary@CInteractionTracker@@AEAA_NUD2DVector3@@M_N@Z @ 0x1801CB2A8
 * Callers:
...
LABEL_7:
  ...
  CoreUICallSend(*(_QWORD *)(*(_QWORD *)(*(_QWORD *)(a1 + 16) + 1080LL) + 48LL), v13, 2LL, 8LL, 0, &unk_1802885F4);
  v11 = *(_DWORD *)(a2 + 8);
