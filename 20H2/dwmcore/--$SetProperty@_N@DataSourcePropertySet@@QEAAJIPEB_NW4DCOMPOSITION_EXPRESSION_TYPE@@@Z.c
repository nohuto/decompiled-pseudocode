/*
 * XREFs of ??$SetProperty@_N@DataSourcePropertySet@@QEAAJIPEB_NW4DCOMPOSITION_EXPRESSION_TYPE@@@Z @ 0x18017F708
 * Callers:
...
LABEL_6:
  ...
  if ( v8 == v9 )
  {
    v11 = PropertySetStorage<DynArrayNoZero,PropertySetUserModeAllocator>::AddProperty<bool>((__int64)v10, 17, a3, &v19);
    v12 = v11;
    if ( v11 < 0 )
    {
  ...
  else
  {
    ...
    *(_BYTE *)((*(_DWORD *)(*v10 + 8 * v14 + 4) & 0x1FFFFFFF) + a1[12]) = *a3;
  }
  return 0LL;
}
