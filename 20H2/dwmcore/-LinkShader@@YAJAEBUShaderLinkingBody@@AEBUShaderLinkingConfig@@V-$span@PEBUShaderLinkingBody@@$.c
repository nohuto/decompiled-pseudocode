/*
 * XREFs of ?LinkShader@@YAJAEBUShaderLinkingBody@@AEBUShaderLinkingConfig@@V?$span@PEBUShaderLinkingBody@@$0?0@gsl@@PEAUVertexShaderDesc@@PEAPEAUID3D10Blob@@@Z @ 0x180054470
 * Callers:
 ...
 *     ??0CShaderLinkingGraphBuilder@@QEAA@XZ @ 0x180052EC0 (--0CShaderLinkingGraphBuilder@@QEAA@XZ.c)
 *     GetExpectedVertexShaderDesc @ 0x180052F00 (GetExpectedVertexShaderDesc.c)
 ...
 *     ??1CShaderLinkingGraphBuilder@@QEAA@XZ @ 0x180053754 (--1CShaderLinkingGraphBuilder@@QEAA@XZ.c)
 *     HasWhiteNoise @ 0x1800537EC (HasWhiteNoise.c)
 ...
 *     ?DoesSamplerRequireConstantBufferData@@YA_NAEBUShaderLinkingSamplerDesc@@@Z @ 0x180054A24 (-DoesSamplerRequireConstantBufferData@@YA_NAEBUShaderLinkingSamplerDesc@@@Z.c)
        ...
        struct ID3D10Blob **a5)
{
  ...
  struct _EVENT_DATA_DESCRIPTOR *v103; // [rsp+130h] [rbp+30h] BYREF
  ...
  *(_QWORD *)&v100.Size = v99;
  ...
  if ( v16 )
  {
    ...
    {
      v10 += *((_DWORD *)*v14 + 12);
      v63 = DiscoverSamplers(*v14++, &v100.Ptr);
      if ( v11 <= v63 )
        v11 = v63;
      ++v13;
    }
  ...
  v17 = v101[0];
  v18 = DiscoverSamplers(v101[0], &v100.Ptr);
  if ( v11 <= v18 )
    v11 = v18;
        ...
        else
        {
          ...
          if ( LODWORD(v27->Ptr) )
          {
            ...
            while ( 1 )
            {
              ...
              v65 = (__int64)v64[v46];
              LOWORD(v100.Reserved) = (unsigned __int8)(v46 + 48);
...
LABEL_29:
            ...
            v47 = v45;
            v48 = (__int128 *)v101[0];
            v50 = LoadShaderBody((__int64)v95, (__int64)v101[0], v49, v47, (__int64)&word_1802CBA06, &v90);
            v33 = v50;
            if ( v50 < 0 )
            {
            ...
            {
              v52 = AppendShaderBody(v95, 10, v48, a2, (__int64)&word_1802CBA06, (__int64)v90, v37, v89);
              v33 = v52;
              if ( v52 < 0 )
              {
              ...
              else
              {
                ...
                {
                  v100.Ptr = 5LL;
                  *(_QWORD *)&v100.Size = &unk_1802DBEA0;
                ...
                {
                  v100.Ptr = 2LL;
                  *(_QWORD *)&v100.Size = &unk_1802AA540;
