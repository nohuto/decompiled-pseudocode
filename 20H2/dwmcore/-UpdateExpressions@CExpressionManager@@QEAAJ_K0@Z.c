/*
 * XREFs of ?UpdateExpressions@CExpressionManager@@QEAAJ_K0@Z @ 0x18007E5D0
 * Callers:
 ...
 *     ?GetDurationAverage@CExpressionPerformanceCounter@@QEAANW4ExpressionPerformanceLabel@@@Z @ 0x1802001FC (-GetDurationAverage@CExpressionPerformanceCounter@@QEAANW4ExpressionPerformanceLabel@@@Z.c)
 *     ?Reset@CExpressionPerformanceCounter@@QEAAXXZ @ 0x180200230 (-Reset@CExpressionPerformanceCounter@@QEAAXXZ.c)
 */
  ...
  *((_BYTE *)this + 416) = v3 & 0xF3 | (2 * (v3 & 4));
  ...
  if ( *((_DWORD *)this + 64) || v3 & 2 | (2 * (v3 & 4)) & 2 || *((_DWORD *)this + 40) )
  {
    ...
    *((_BYTE *)this + 416) &= ~1u;
    ...
    {
      v27 = *((_QWORD *)this + 29) + 16LL * j;
      CBaseExpression::NotifyAnimationStateChanged(*(_QWORD *)(v27 + 8), *(_DWORD *)v27);
      (*(void (__fastcall **)(_QWORD))(**(_QWORD **)(v27 + 8) + 16LL))(*(_QWORD *)(v27 + 8));
    }
    *((_DWORD *)this + 64) = 0;
