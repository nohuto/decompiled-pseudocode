/*
 * XREFs of ?AddKeyframeData@CKeyframeAnimation@@AEAAJHMPEAUKeyframeData@@W4KeyframeAnimationCoordinateSpace@@@Z @ 0x1800255B8
 * Callers:
        ...
        unsigned int a5)
{
  ...
  v8 = *(_OWORD *)(a4 + 16);
  v73 = 0LL;
  xmmword_1803441D0 = v8;
  xmmword_1803441E0 = *(_OWORD *)(a4 + 32);
  v9 = *(_DWORD *)(a4 + 4);
  if ( v9 > 65539 )
  {
    v35 = v9 - 65540;
...
LABEL_32:
    if ( *(_DWORD *)(a4 + 24) != 1 )
    {
      ...
      else
      {
        ...
        {
          v17 = -2003303421;
          MilInstrumentationCheckHR_MaybeFailFast(*(_DWORD *)(a4 + 24) - 2, 0LL, 0, -2003303421, 0x512u, 0LL);
          goto LABEL_63;
        }
        Microsoft::WRL::ComPtr<CBrushRenderingGraph>::InternalRelease(v68);
