/*
 * XREFs of ?CheckOcclusionState@CVisualCapture@@UEAAJXZ @ 0x1801F0EE4
 * Callers:
 *     ?CheckOcclusionState@CVisualCapture@@$4PPPPPPPM@A@EAAJXZ @ 0x1800F0D40 (-CheckOcclusionState@CVisualCapture@@$4PPPPPPPM@A@EAAJXZ.c)
 * Callees:
