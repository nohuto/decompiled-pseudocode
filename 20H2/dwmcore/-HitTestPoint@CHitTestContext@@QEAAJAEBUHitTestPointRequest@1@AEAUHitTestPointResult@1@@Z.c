/*
 * XREFs of ?HitTestPoint@CHitTestContext@@QEAAJAEBUHitTestPointRequest@1@AEAUHitTestPointResult@1@@Z @ 0x18005B154
 * Callers:
 ...
 *     ?GetInputType@CInputSinkStruct@@SA?AW4CompositionInputType@@W4InputType@@@Z @ 0x18001EAC8 (-GetInputType@CInputSinkStruct@@SA-AW4CompositionInputType@@W4InputType@@@Z.c)
 *     ?HasInputSink@CInteraction@@QEBA_NXZ @ 0x18005B590 (-HasInputSink@CInteraction@@QEBA_NXZ.c)
 ...
 *     ?AdjustInputTypeForInteraction@CHitTestContext@@AEBA?AW4InputType@@W42@PEBVCInteraction@@@Z @ 0x18005B5F8 (-AdjustInputTypeForInteraction@CHitTestContext@@AEBA-AW4InputType@@W42@PEBVCInteraction@@@Z.c)
 ...
 *     ?EvaluateHitTestAttributesAndInputType@CHitTestContext@@AEAAXW4DIT_HITTESTATTRIBUTES@@K@Z @ 0x18005B894 (-EvaluateHitTestAttributesAndInputType@CHitTestContext@@AEAAXW4DIT_HITTESTATTRIBUTES@@K@Z.c)
 ...
 *     McTemplateU0qqp_EventWriteTransfer @ 0x18022627C (McTemplateU0qqp_EventWriteTransfer.c)
 */
...
LABEL_11:
  ...
  *((_QWORD *)v5 + 3) = v15;
  ...
  {
    v17 = v33 | 0x10000000;
    MilInstrumentationCheckHR_MaybeFailFast(v34, &dword_1802D9E90, 2u, v33 | 0x10000000, 0x29Eu, 0LL);
  }
  else
  {
    v35 = *((_DWORD *)v4 + 424);
