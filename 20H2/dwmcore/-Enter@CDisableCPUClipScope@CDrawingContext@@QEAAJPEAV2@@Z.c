/*
 * XREFs of ?Enter@CDisableCPUClipScope@CDrawingContext@@QEAAJPEAV2@@Z @ 0x180073AAC
 * Callers:
        ...
        struct CDrawingContext *a2)
{
  ...
  if ( v4 < 0 )
  {
    MilInstrumentationCheckHR_MaybeFailFast(v5, 0LL, 0, v4, 0x1874u, 0LL);
  }
  else
  {
    ...
    {
      --*((_DWORD *)a2 + 240);
      MilInstrumentationCheckHR_MaybeFailFast(v8, 0LL, 0, v7, 0x1881u, 0LL);
    }
    else
    {
      *(_QWORD *)this = a2;
