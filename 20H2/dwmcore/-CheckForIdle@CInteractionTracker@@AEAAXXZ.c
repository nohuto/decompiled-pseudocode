/*
 * XREFs of ?CheckForIdle@CInteractionTracker@@AEAAXXZ @ 0x1801C813C
 * Callers:
 ...
 *     ?IsOutOfBounds@CInteractionTracker@@QEAA_NXZ @ 0x1801C96C8 (-IsOutOfBounds@CInteractionTracker@@QEAA_NXZ.c)
