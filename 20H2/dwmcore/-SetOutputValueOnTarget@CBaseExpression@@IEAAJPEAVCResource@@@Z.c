/*
 * XREFs of ?SetOutputValueOnTarget@CBaseExpression@@IEAAJPEAVCResource@@@Z @ 0x18007EE20
 * Callers:
...
__int64 __fastcall CBaseExpression::SetOutputValueOnTarget(unsigned __int64 this, struct CResource *a2)
{
  ...
  if ( v8 < 0 )
  {
    MilInstrumentationCheckHR_MaybeFailFast(v9, 0LL, 0, v8, 0x231u, 0LL);
  }
  else
  {
    v11 = *(_QWORD *)(this + 192);
    if ( v11 && *(_BYTE *)(v11 + 4) )
    {
      ...
      if ( v50 < 0 )
      {
        MilInstrumentationCheckHR_MaybeFailFast(v51, 0LL, 0, v50, 0x254u, 0LL);
      }
      else
      {
...
LABEL_6:
        ...
        MilInstrumentationCheckHR_MaybeFailFast(v54, 0LL, 0, v53, 0x258u, 0LL);
      }
      v60 = v73;
      if ( v73 )
      {
    ...
    else
    {
      ...
      MilInstrumentationCheckHR_MaybeFailFast(v16, 0LL, 0, v15, 0x238u, 0LL);
    }
  }
LABEL_7:
  v12 = v77;
