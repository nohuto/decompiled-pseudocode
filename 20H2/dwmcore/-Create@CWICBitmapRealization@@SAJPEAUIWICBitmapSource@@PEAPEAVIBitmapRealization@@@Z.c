/*
 * XREFs of ?Create@CWICBitmapRealization@@SAJPEAUIWICBitmapSource@@PEAPEAVIBitmapRealization@@@Z @ 0x180049EC8
 * Callers:
 ...
 *     ??0CWICBitmapRealization@@QEAA@XZ @ 0x180049FAC (--0CWICBitmapRealization@@QEAA@XZ.c)
