/*
 * XREFs of ?ForceRetireScenario@InteractionTraceProvider@@SAXAEBUTouchScenarioInfo@CTelemetryTouchLatencyAnalysis@@@Z @ 0x18015DB3C
 * Callers:
        ...
        const struct CTelemetryTouchLatencyAnalysis::TouchScenarioInfo *a1)
{
  ...
  if ( (unsigned int)dword_180341EB8 > 5 && (qword_180341EC8 & 8) != 0 && (qword_180341ED0 & 8) == qword_180341ED0 )
  {
    ...
    tlgWriteTransfer_EventWriteTransfer(
      ...
      (unsigned __int8 *)dword_1802E2562,
      0LL,
      0LL,
      6u,
      &v5);
