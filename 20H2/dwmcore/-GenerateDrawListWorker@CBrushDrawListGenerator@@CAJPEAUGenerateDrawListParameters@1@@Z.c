/*
 * XREFs of ?GenerateDrawListWorker@CBrushDrawListGenerator@@CAJPEAUGenerateDrawListParameters@1@@Z @ 0x18009F7E0
 * Callers:
        ...
        struct CBrushDrawListGenerator::GenerateDrawListParameters *a1)
{
  ...
  if ( i == *((_DWORD *)a1 + 24) )
  {
    ...
    {
      MilInstrumentationCheckHR_MaybeFailFast(v6, 0LL, 0, DrawListPrimitive, 0x180u, 0LL);
      return v7;
    }
  }
  else
  {
    ...
    *((_DWORD *)a1 + 12) = v9;
    if ( v11 < 0 )
    {
      MilInstrumentationCheckHR_MaybeFailFast(v12, 0LL, 0, v11, 0x1C0u, 0LL);
      return v7;
    }
  }
  return 0;
