/*
 * XREFs of ?PubSebiUpdateLevelEventRpc@@YAJPEAXE@Z @ 0x180213FD0
 * Callers:
 *     ?SignalSEB@CLegacyRenderTarget@@AEAAX_NI@Z @ 0x18003140C (-SignalSEB@CLegacyRenderTarget@@AEAAX_NI@Z.c)
 *     ??1CLegacyRenderTarget@@MEAA@XZ @ 0x1800329C8 (--1CLegacyRenderTarget@@MEAA@XZ.c)
 * Callees:
 *     ?PubSebiGetRpcBindingHandle@@YAJPEAPEAX@Z @ 0x180031764 (-PubSebiGetRpcBindingHandle@@YAJPEAPEAX@Z.c)
 *     ?Find@ContextTable@@QEAAPEAXPEAU_SEB_RPC_PUBLISH_DATA@@@Z @ 0x180031940 (-Find@ContextTable@@QEAAPEAXPEAU_SEB_RPC_PUBLISH_DATA@@@Z.c)
 */
