/*
 * XREFs of ?InferVisualToTextureTransform@CGradientBrush@@IEBAJAEAY02$$CBUD2D_POINT_2F@@AEBV?$TMilRect_@MUMilRectF@@UMil3DRectF@@UMilPointAndSizeF@@UNotNeeded@RectUniqueness@@@@PEAUD2D_MATRIX_3X2_F@@@Z @ 0x1801E64C8
 * Callers:
 ...
 *     ?InferAffineMatrix@CMILMatrix@@QEAAXAEBV?$TMilRect_@MUMilRectF@@UMil3DRectF@@UMilPointAndSizeF@@UNotNeeded@RectUniqueness@@@@PEBUMilPoint2F@@@Z @ 0x18020E418 (-InferAffineMatrix@CMILMatrix@@QEAAXAEBV-$TMilRect_@MUMilRectF@@UMil3DRectF@@UMilPo_ea_18020E418.c)
 */
...
LABEL_6:
  ...
  *(_QWORD *)&v7->m[2][0] = v6;
  ...
  {
    v9 = -2003304441;
    MilInstrumentationCheckHR_MaybeFailFast(v8, &dword_180301E20, 2u, -2003304441, 0x1B2u, 0LL);
  }
  return v9;
}
