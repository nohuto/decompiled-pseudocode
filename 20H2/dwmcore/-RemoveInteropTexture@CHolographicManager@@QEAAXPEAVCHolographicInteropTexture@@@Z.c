/*
 * XREFs of ?RemoveInteropTexture@CHolographicManager@@QEAAXPEAVCHolographicInteropTexture@@@Z @ 0x18025181C
 * Callers:
 ...
 *     ?DwmHolographicInteropTextureRemove_@CompositorTracing@@QEAAXI@Z @ 0x1802507F0 (-DwmHolographicInteropTextureRemove_@CompositorTracing@@QEAAXI@Z.c)
