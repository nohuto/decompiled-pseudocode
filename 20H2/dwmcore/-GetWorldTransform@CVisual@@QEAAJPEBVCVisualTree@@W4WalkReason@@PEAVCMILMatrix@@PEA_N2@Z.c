/*
 * XREFs of ?GetWorldTransform@CVisual@@QEAAJPEBVCVisualTree@@W4WalkReason@@PEAVCMILMatrix@@PEA_N2@Z @ 0x1800B3B90
 * Callers:
...
LABEL_40:
    ...
    if ( v15 < 0 )
    {
      MilInstrumentationCheckHR_MaybeFailFast((__int64)Flink, 0LL, 0, v15, 0x6DDu, 0LL);
      return (unsigned int)v15;
    }
    if ( !v11[7].Blink )
    {
      MilInstrumentationCheckHR_MaybeFailFast((__int64)Flink, 0LL, 0, -2003292412, 0x69u, 0LL);
      MilInstrumentationCheckHR_MaybeFailFast(v32, 0LL, 0, -2003292412, 0x6E2u, 0LL);
      return 2291674884LL;
    }
