/*
 * XREFs of ?ProcessSurfaceUpdates@CGlobalSurfaceManager@@UEAAJXZ @ 0x1800A6E30
 * Callers:
 *     <none>
 * Callees:
        ...
        unsigned int *a3)
{
  ...
  struct _EVENT_DATA_DESCRIPTOR Buffer; // [rsp+60h] [rbp-78h] BYREF
  struct _EVENT_DATA_DESCRIPTOR v54; // [rsp+70h] [rbp-68h] BYREF
  struct _EVENT_DATA_DESCRIPTOR v55; // [rsp+80h] [rbp-58h] BYREF
  struct _EVENT_DATA_DESCRIPTOR v56; // [rsp+90h] [rbp-48h] BYREF
    ...
    if ( v8 >= 0 )
    {
      do
      {
        ...
        if ( v48 )
        {
          ...
          do
          {
            *(_QWORD *)&Buffer.Size = 0LL;
            v47 = 0LL;
            v24 = *((_QWORD *)v4 + 57) + 200LL * v19;
            Buffer.Ptr = *(_QWORD *)(v24 + 4);
