/*
 * XREFs of ?PresentMPO@COverlayContext@@QEAAJPEAVIOverlaySwapChain@@IAEBV?$vector@UtagRECT@@V?$allocator@UtagRECT@@@std@@@std@@@Z @ 0x1800E6D94
 * Callers:
 ...
 *     McTemplateU0xqqqddddddddddddqqq_EventWriteTransfer @ 0x18017D9EC (McTemplateU0xqqqddddddddddddqqq_EventWriteTransfer.c)
 */
