/*
 * XREFs of ?Create@CHolographicManager@@SAJPEAVCComposition@@PEAPEAV1@@Z @ 0x1800302BC
 * Callers:
 *     ?Initialize@CComposition@@MEAAJXZ @ 0x18002E2F0 (-Initialize@CComposition@@MEAAJXZ.c)
 * Callees:
 *     ??0CHolographicManager@@AEAA@PEAVCComposition@@@Z @ 0x18003035C (--0CHolographicManager@@AEAA@PEAVCComposition@@@Z.c)
