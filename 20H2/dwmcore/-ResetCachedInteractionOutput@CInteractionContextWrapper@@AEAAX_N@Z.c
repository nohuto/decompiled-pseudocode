/*
 * XREFs of ?ResetCachedInteractionOutput@CInteractionContextWrapper@@AEAAX_N@Z @ 0x18002FC98
 * Callers:
 ...
 *     ?ResetOutput@CInteractionContextWrapper@@UEAAXXZ @ 0x18022E7C0 (-ResetOutput@CInteractionContextWrapper@@UEAAXXZ.c)
 * Callees:
