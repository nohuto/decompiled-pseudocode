/*
 * XREFs of ?Create@CHolographicInteropTaskQueue@@SAJPEAPEAV1@@Z @ 0x180257B58
 * Callers:
 ...
 *     ??0CHolographicInteropTaskQueue@@AEAA@XZ @ 0x1802579FC (--0CHolographicInteropTaskQueue@@AEAA@XZ.c)
