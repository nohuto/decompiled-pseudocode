/*
 * XREFs of ?PreRender@CRemoteAppRenderTarget@@UEAAJXZ @ 0x180185C64
 * Callers:
 *     ?PreRender@CRemoteAppRenderTarget@@$4PPPPPPPM@A@EAAJXZ @ 0x1800EFBF0 (-PreRender@CRemoteAppRenderTarget@@$4PPPPPPPM@A@EAAJXZ.c)
 * Callees:
