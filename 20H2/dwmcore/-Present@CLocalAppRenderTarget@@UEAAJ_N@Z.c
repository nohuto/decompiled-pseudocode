/*
 * XREFs of ?Present@CLocalAppRenderTarget@@UEAAJ_N@Z @ 0x18018A338
 * Callers:
 *     ?Present@CLocalAppRenderTarget@@$4PPPPPPPM@A@EAAJ_N@Z @ 0x1800EFCB0 (-Present@CLocalAppRenderTarget@@$4PPPPPPPM@A@EAAJ_N@Z.c)
 * Callees:
