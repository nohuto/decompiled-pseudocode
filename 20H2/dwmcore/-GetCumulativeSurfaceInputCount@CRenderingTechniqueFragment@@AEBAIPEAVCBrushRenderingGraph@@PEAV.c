/*
 * XREFs of ?GetCumulativeSurfaceInputCount@CRenderingTechniqueFragment@@AEBAIPEAVCBrushRenderingGraph@@PEAV?$vector_facade@USurfaceDescription@CRenderingTechniqueFragment@@V?$buffer_impl@USurfaceDescription@CRenderingTechniqueFragment@@$0BA@$00Vliberal_expansion_policy@detail@@@detail@@@detail@@@Z @ 0x180057D94
 * Callers:
 ...
 * Callees:
 *     ??8SurfaceDescription@CRenderingTechniqueFragment@@QEBA_NAEBU01@@Z @ 0x180057458 (--8SurfaceDescription@CRenderingTechniqueFragment@@QEBA_NAEBU01@@Z.c)
    ...
    do
    {
      ...
      else
      {
        ...
        for ( i = *(void **)a3; ; i = (void *)(v16 + 12) )
        {
          if ( v12 == i )
            goto LABEL_9;
          if ( CRenderingTechniqueFragment::SurfaceDescription::operator==((__int64)i, (__int64)&v17) )
            break;
        }
        if ( v12 == (void *)v16 )
        {
