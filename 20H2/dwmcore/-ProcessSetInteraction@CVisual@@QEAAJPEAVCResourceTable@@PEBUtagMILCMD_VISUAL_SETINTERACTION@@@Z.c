/*
 * XREFs of ?ProcessSetInteraction@CVisual@@QEAAJPEAVCResourceTable@@PEBUtagMILCMD_VISUAL_SETINTERACTION@@@Z @ 0x1800DCA08
 * Callers:
 ...
 *     McTemplateU0qqqxxpp_EventWriteTransfer @ 0x1801AEA04 (McTemplateU0qqqxxpp_EventWriteTransfer.c)
 */
