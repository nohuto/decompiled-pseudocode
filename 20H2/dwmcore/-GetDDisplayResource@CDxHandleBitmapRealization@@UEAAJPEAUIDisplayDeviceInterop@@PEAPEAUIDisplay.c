/*
 * XREFs of ?GetDDisplayResource@CDxHandleBitmapRealization@@UEAAJPEAUIDisplayDeviceInterop@@PEAPEAUIDisplaySurface@Core@Display@Devices@Windows@@PEAI@Z @ 0x1802619B0
 * Callers:
 *     <none>
 * Callees:
        ...
        unsigned int *a4)
{
  ...
  v9 = 0;
  if ( *((_QWORD *)this + 3) && *((_DWORD *)this + 8) == dword_1803485D0 )
  {
LABEL_9:
    if ( a4 )
