/*
 * XREFs of ?ComputeExternalLayerOffsetAndBounds@CDrawingContext@@AEBAJPEAUMilPointAndSizeL@@@Z @ 0x180174650
 * Callers:
        ...
        struct MilPointAndSizeL *a2)
{
  ...
  v5 = v3;
  if ( v3 < 0 )
    MilInstrumentationCheckHR_MaybeFailFast(v4, 0LL, 0, v3, 0xD50u, 0LL);
  return v5;
}
