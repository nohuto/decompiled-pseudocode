/*
 * XREFs of ?ReleaseSwapChain@CLocalAppRenderTarget@@IEAAXXZ @ 0x18018A39C
 * Callers:
 *     ?EnsureSwapChain@CLocalAppRenderTarget@@IEAAJXZ @ 0x180189F2C (-EnsureSwapChain@CLocalAppRenderTarget@@IEAAJXZ.c)
 *     ?NotifyInvalidResource@CLocalAppRenderTarget@@UEAAXPEBVIDeviceResource@@@Z @ 0x18018A140 (-NotifyInvalidResource@CLocalAppRenderTarget@@UEAAXPEBVIDeviceResource@@@Z.c)
 * Callees:
