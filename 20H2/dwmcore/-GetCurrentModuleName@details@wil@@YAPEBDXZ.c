/*
 * XREFs of ?GetCurrentModuleName@details@wil@@YAPEBDXZ @ 0x18014CB20
 * Callers:
 *     <none>
 * Callees:
 *     ?GetModuleInformation@details@wil@@YA_NPEAXPEAIPEAD_K@Z @ 0x18014CF40 (-GetModuleInformation@details@wil@@YA_NPEAXPEAIPEAD_K@Z.c)
 */
