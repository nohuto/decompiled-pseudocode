/*
 * XREFs of ??_GCCheckMPOCache@@QEAAPEAXI@Z @ 0x1800EB7BC
 * Callers:
 *     ??4?$unique_ptr@VCCheckMPOCache@@U?$default_delete@VCCheckMPOCache@@@std@@@std@@QEAAAEAV01@$$QEAV01@@Z @ 0x1800EC100 (--4-$unique_ptr@VCCheckMPOCache@@U-$default_delete@VCCheckMPOCache@@@std@@@std@@QEAAAEAV01@$$QEA.c)
