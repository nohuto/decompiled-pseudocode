/*
 * XREFs of ?AddAdditionalDirtyRect@CVisual@@QEAAXAEBV?$TMilRect_@MUMilRectF@@UMil3DRectF@@UMilPointAndSizeF@@UNotNeeded@RectUniqueness@@@@@Z @ 0x1800A69B0
 * Callers:
 ...
 *     ??0CMergedDirtyRect@@QEAA@XZ @ 0x1800CE644 (--0CMergedDirtyRect@@QEAA@XZ.c)
