/*
 * XREFs of ?PreRender@CLocalAppRenderTarget@@UEAAJXZ @ 0x18018A2B8
 * Callers:
 *     ?PreRender@CLocalAppRenderTarget@@$4PPPPPPPM@A@EAAJXZ @ 0x1800EFCA0 (-PreRender@CLocalAppRenderTarget@@$4PPPPPPPM@A@EAAJXZ.c)
 * Callees:
