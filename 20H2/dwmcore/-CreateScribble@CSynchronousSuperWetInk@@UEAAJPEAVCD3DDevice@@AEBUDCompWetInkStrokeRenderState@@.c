/*
 * XREFs of ?CreateScribble@CSynchronousSuperWetInk@@UEAAJPEAVCD3DDevice@@AEBUDCompWetInkStrokeRenderState@@PEAPEAVCComputeScribble@@@Z @ 0x1801EEA00
 * Callers:
 *     <none>
 * Callees:
        ...
        *a4 = v17;
        if ( *((_BYTE *)v11 + 12) )
        {
          if ( !*((_BYTE *)this + 136) )
          {
              ...
              && (qword_180341ED0 & 8) == qword_180341ED0 )
            {
              ...
              tlgWriteTransfer_EventWriteTransfer(
                ...
                (unsigned __int8 *)dword_1802E6A7B,
                0LL,
                0LL,
                3u,
                &v33);
            ...
            && (qword_180341ED0 & 8) == qword_180341ED0 )
          {
            ...
            tlgWriteTransfer_EventWriteTransfer(
              (__int64)&dword_180341EB8,
              (unsigned __int8 *)dword_1802E6A31,
              0LL,
              0LL,
              3u,
              &v33);
