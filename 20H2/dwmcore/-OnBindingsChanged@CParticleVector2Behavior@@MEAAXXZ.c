/*
 * XREFs of ?OnBindingsChanged@CParticleVector2Behavior@@MEAAXXZ @ 0x1801E1E70
 * Callers:
 *     <none>
 * Callees:
...
void __fastcall CParticleVector2Behavior::OnBindingsChanged(CParticleVector2Behavior *this)
{
  ...
  *((_QWORD *)this + 15) = *((_QWORD *)this + 14);
  ...
  Particles::LinearKeyframeAnimation<Windows::Foundation::Numerics::float2>::AppendFrames((__int64)this + 104, v2);
}
