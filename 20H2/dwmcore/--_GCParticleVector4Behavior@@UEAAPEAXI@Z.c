/*
 * XREFs of ??_GCParticleVector4Behavior@@UEAAPEAXI@Z @ 0x18016D450
 * Callers:
 *     ??_ECParticleVector4Behavior@@WGI@EAAPEAXI@Z @ 0x1800EEBA0 (--_ECParticleVector4Behavior@@WGI@EAAPEAXI@Z.c)
 * Callees:
