/*
 * XREFs of ?ShapeDataFromGeometry@CDrawingContext@@CAJPEBUD2D_SIZE_F@@PEAVCGeometry@@PEAVCShapePtr@@@Z @ 0x180178268
 * Callers:
        ...
        struct CShapePtr *a3)
{
  ...
  if ( ShapeData < 0 )
  {
    MilInstrumentationCheckHR_MaybeFailFast(v8, 0LL, 0, ShapeData, 0x895u, 0LL);
  }
  else
  {
    ...
    if ( TightBounds < 0 )
    {
      MilInstrumentationCheckHR_MaybeFailFast(v11, 0LL, 0, TightBounds, 0x896u, 0LL);
    }
    else
    {
      v12 = v16;
