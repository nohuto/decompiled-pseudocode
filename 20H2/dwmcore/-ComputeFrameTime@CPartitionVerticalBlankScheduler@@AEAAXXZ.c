/*
 * XREFs of ?ComputeFrameTime@CPartitionVerticalBlankScheduler@@AEAAXXZ @ 0x18007E1A4
 * Callers:
 ...
 * Callees:
 *     ?UpdateDwmTimingInfo@CPartitionVerticalBlankScheduler@@AEAAXXZ @ 0x18007E32C (-UpdateDwmTimingInfo@CPartitionVerticalBlankScheduler@@AEAAXXZ.c)
 *     __security_check_cookie @ 0x1800E29B0 (__security_check_cookie.c)
 *     McTemplateU0x_EventWriteTransfer @ 0x180153BF8 (McTemplateU0x_EventWriteTransfer.c)
 *     McTemplateU0qNR0_EventWriteTransfer @ 0x180162B3C (McTemplateU0qNR0_EventWriteTransfer.c)
 */
