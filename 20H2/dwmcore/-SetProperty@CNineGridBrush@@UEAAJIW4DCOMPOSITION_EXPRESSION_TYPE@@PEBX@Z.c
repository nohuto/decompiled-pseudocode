/*
 * XREFs of ?SetProperty@CNineGridBrush@@UEAAJIW4DCOMPOSITION_EXPRESSION_TYPE@@PEBX@Z @ 0x1801D9F90
 * Callers:
 *     <none>
 * Callees:
 ...
 *     ?TryGetInsetFieldPointer@CNineGridBrush@@AEAAPEAMK@Z @ 0x1800C734C (-TryGetInsetFieldPointer@CNineGridBrush@@AEAAPEAMK@Z.c)
