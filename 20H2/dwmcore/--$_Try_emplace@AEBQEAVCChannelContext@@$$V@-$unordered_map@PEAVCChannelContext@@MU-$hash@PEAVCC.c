/*
 * XREFs of ??$_Try_emplace@AEBQEAVCChannelContext@@$$V@?$unordered_map@PEAVCChannelContext@@MU?$hash@PEAVCChannelContext@@@std@@U?$equal_to@PEAVCChannelContext@@@3@V?$allocator@U?$pair@QEAVCChannelContext@@M@std@@@3@@std@@QEAA?AU?$pair@V?$_List_iterator@V?$_List_val@U?$_List_simple_types@U?$pair@QEAVCChannelContext@@M@std@@@std@@@std@@@std@@_N@1@AEBQEAVCChannelContext@@@Z @ 0x180030AA0
 * Callers:
