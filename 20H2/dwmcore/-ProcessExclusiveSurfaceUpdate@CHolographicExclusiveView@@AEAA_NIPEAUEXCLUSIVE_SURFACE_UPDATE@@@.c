/*
 * XREFs of ?ProcessExclusiveSurfaceUpdate@CHolographicExclusiveView@@AEAA_NIPEAUEXCLUSIVE_SURFACE_UPDATE@@@Z @ 0x180254678
 * Callers:
 ...
 *     ?CloseSurfaceHandles@CHolographicExclusiveView@@AEAAXXZ @ 0x1802542B8 (-CloseSurfaceHandles@CHolographicExclusiveView@@AEAAXXZ.c)
