/*
 * XREFs of ?PushClippingScope@CDrawingContext@@AEAAJPEBVCVisual@@_NPEBVCMILMatrix@@PEAV?$TMilRect_@MUMilRectF@@UMil3DRectF@@UMilPointAndSizeF@@UNotNeeded@RectUniqueness@@@@@Z @ 0x1800752FC
 * Callers:
...
__int64 __fastcall CDrawingContext::PushClippingScope(int *a1, __int64 a2, char a3, __int64 a4, __int64 a5)
{
  ...
  if ( v10 < 0 )
  {
    MilInstrumentationCheckHR_MaybeFailFast(v12, 0LL, 0, v10, 0xB5Bu, 0LL);
LABEL_10:
    if ( v9 )
  ...
  if ( a2 )
  {
    ...
    if ( v17 < 0 )
    {
      MilInstrumentationCheckHR_MaybeFailFast(v18, 0LL, 0, v17, 0xB60u, 0LL);
      return v13;
    }
    v9 = 1;
  }
  ...
  if ( v14 < 0 )
  {
    MilInstrumentationCheckHR_MaybeFailFast(v15, 0LL, 0, v14, 0xB66u, 0LL);
    goto LABEL_10;
  }
  return v13;
}
