/*
 * XREFs of _anonymous_namespace_::SendFramesReport @ 0x1800585C4
 * Callers:
 *     _anonymous_namespace_::SendFramesReports @ 0x1800CF180 (_anonymous_namespace_--SendFramesReports.c)
 * Callees:
 *     _anonymous_namespace_::QpcToFileTimeAndGetCurrentFileTime @ 0x180027B10 (_anonymous_namespace_--QpcToFileTimeAndGetCurrentFileTime.c)
 ...
 *     _anonymous_namespace_::PackedStringArrayBuilder::Append @ 0x180058F5C (_anonymous_namespace_--PackedStringArrayBuilder--Append.c)
 ...
 *     ??$_Erase_tree@V?$allocator@U?$_Tree_node@U?$pair@$$CB_KPEAUBufferStream@BamoImpl@Microsoft@@@std@@PEAX@std@@@std@@@?$_Tree_val@U?$_Tree_simple_types@U?$pair@$$CB_KPEAUBufferStream@BamoImpl@Microsoft@@@std@@@std@@@std@@QEAAXAEAV?$allocator@U?$_Tree_node@U?$pair@$$CB_KPEAUBufferStream@BamoImpl@Microsoft@@@std@@PEAX@std@@@1@PEAU?$_Tree_node@U?$pair@$$CB_KPEAUBufferStream@BamoImpl@Microsoft@@@std@@PEAX@1@@Z @ 0x1800D0004 (--$_Erase_tree@V-$allocator@U-$_Tree_node@U-$pair@$$CB_KPEAUBufferStream@BamoImpl@Microsoft@@@st.c)
 *     ??E?$_Tree_unchecked_const_iterator@V?$_Tree_val@U?$_Tree_simple_types@V?$basic_string@GU?$char_traits@G@std@@V?$allocator@G@2@@std@@@std@@@std@@U_Iterator_base0@2@@std@@QEAAAEAV01@XZ @ 0x1800D115C (--E-$_Tree_unchecked_const_iterator@V-$_Tree_val@U-$_Tree_simple_types@V-$basic_string@GU-$char_.c)
...
__int64 __fastcall anonymous_namespace_::SendFramesReport(_QWORD *a1)
{
  ...
  __int64 v99[3]; // [rsp+178h] [rbp+70h] BYREF
...
LABEL_81:
  ...
  *v57 = 0;
  ...
  if ( (unsigned int)dword_180341EF0 > 5 && tlgKeywordOn((__int64)&dword_180341EF0, 0x400000000000LL) )
  {
    v66 = v103;
