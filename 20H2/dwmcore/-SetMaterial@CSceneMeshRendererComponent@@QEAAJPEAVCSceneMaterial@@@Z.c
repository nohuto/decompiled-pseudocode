/*
 * XREFs of ?SetMaterial@CSceneMeshRendererComponent@@QEAAJPEAVCSceneMaterial@@@Z @ 0x1801E9078
 * Callers:
        ...
        struct CSceneMaterial *a2)
{
  ...
  if ( a2 != v4 )
  {
    ...
    if ( a2 )
    {
      ...
      wil::com_ptr_t<IDXGISwapChain1,wil::err_returncode_policy>::reset(v8 + 5);
      *((_QWORD *)this + 9) = a2;
    }
