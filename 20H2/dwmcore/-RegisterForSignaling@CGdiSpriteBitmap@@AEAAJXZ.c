/*
 * XREFs of ?RegisterForSignaling@CGdiSpriteBitmap@@AEAAJXZ @ 0x180040578
 * Callers:
...
__int64 __fastcall CGdiSpriteBitmap::RegisterForSignaling(CGdiSpriteBitmap *this)
{
  ...
  else
  {
    ...
    if ( *((_QWORD *)this + 49) )
    {
      ...
      if ( v9 < 0 )
      {
        MilInstrumentationCheckHR_MaybeFailFast(v10, &dword_1802D8F10, 2u, v9, 0x3BCu, 0LL);
        goto LABEL_7;
      }
      v1 = 1;
    }
    else
    {
      ...
      if ( v6 < 0 )
      {
        MilInstrumentationCheckHR_MaybeFailFast(v7, &dword_1802D8F10, 2u, v6, 0x3B4u, 0LL);
        goto LABEL_7;
      }
    }
    *((_BYTE *)this + 127) = 1;
