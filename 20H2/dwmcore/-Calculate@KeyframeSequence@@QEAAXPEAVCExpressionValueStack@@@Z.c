/*
 * XREFs of ?Calculate@KeyframeSequence@@QEAAXPEAVCExpressionValueStack@@@Z @ 0x180026630
 * Callers:
...
LABEL_28:
  ...
  if ( v38 )
  {
    ...
    if ( !*(_DWORD *)v40 )
    {
      ...
      if ( v46 < 0 )
      {
        MilInstrumentationCheckHR_MaybeFailFast((unsigned int)v39, 0LL, 0, v46, 0x6B1u, 0LL);
LABEL_52:
        v41 = v11;
        if ( v11 >= 0 )
        {
...
LABEL_84:
        MilInstrumentationCheckHR_MaybeFailFast((unsigned int)v39, 0LL, 0, v11, 0x50u, 0LL);
LABEL_87:
    ...
    if ( *(_DWORD *)v40 != 18 )
    {
      switch ( *(_DWORD *)v40 )
      {
        ...
        default:
          v11 = -2147467259;
          MilInstrumentationCheckHR_MaybeFailFast((unsigned int)v39, 0LL, 0, -2147467259, 0x6E1u, 0LL);
          v41 = -2147467259;
          goto LABEL_84;
      }
    }
...
LABEL_113:
  ...
  if ( !*(_DWORD *)v53 )
  {
    ...
    if ( v54 < 0 )
    {
      MilInstrumentationCheckHR_MaybeFailFast((unsigned int)v52, 0LL, 0, v54, 0x6B1u, 0LL);
      goto LABEL_109;
    }
    v11 = 0;
  }
  if ( *(_DWORD *)v53 != 18 )
  {
    switch ( *(_DWORD *)v53 )
    {
      ...
      default:
        v11 = -2147467259;
        MilInstrumentationCheckHR_MaybeFailFast((unsigned int)v52, 0LL, 0, -2147467259, 0x6E1u, 0LL);
        v56 = -2147467259;
        goto LABEL_106;
    }
  }
...
LABEL_109:
  ...
  {
LABEL_106:
    MilInstrumentationCheckHR_MaybeFailFast((unsigned int)v52, 0LL, 0, v11, 0x50u, 0LL);
    goto LABEL_113;
  }
LABEL_34:
