/*
 * XREFs of ?GetSwapChainSize@CSurfaceBrush@@AEBAJPEAVISwapChainRealization@@PEAUD2D_SIZE_F@@PEAUD2D_RECT_F@@PEAUD2D_MATRIX_3X2_F@@@Z @ 0x1801EDA0C
 * Callers:
        ...
        struct D2D_MATRIX_3X2_F *a5)
{
  ...
  {
    v7 = -2003304441;
    MilInstrumentationCheckHR_MaybeFailFast(v10, &dword_180301E20, 2u, -2003304441, 0x375u, 0LL);
  }
  else
  {
    a3->width = v20;
