/*
 * XREFs of ?CheckMultiplaneOverlaySupport@CLegacyStereoSwapChain@@$4PPPPPPPM@A@EBA_NPEBUDXGI_CHECK_MULTIPLANEOVERLAYSUPPORT_PLANE_INFO@@IPEA_N@Z @ 0x1800F1B40
 * Callers:
 *     <none>
 * Callees:
 *     <none>
