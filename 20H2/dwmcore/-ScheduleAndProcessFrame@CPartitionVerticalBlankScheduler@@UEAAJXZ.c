/*
 * XREFs of ?ScheduleAndProcessFrame@CPartitionVerticalBlankScheduler@@UEAAJXZ @ 0x180078EE0
 * Callers:
 *     <none>
 * Callees:
 ...
 *     ?FindFirstOutstandingFrameIndex@CPartitionVerticalBlankScheduler@@AEAAIXZ @ 0x180078998 (-FindFirstOutstandingFrameIndex@CPartitionVerticalBlankScheduler@@AEAAIXZ.c)
 ...
 *     ?FrameEnded@CTelemetryFrames@@SAX_N0_K@Z @ 0x18007CB98 (-FrameEnded@CTelemetryFrames@@SAX_N0_K@Z.c)
 ...
 *     ?GetStackCaptureRootFailureAddress@@YAPEAXJ@Z @ 0x180213AF4 (-GetStackCaptureRootFailureAddress@@YAPEAXJ@Z.c)
...
__int64 __fastcall CPartitionVerticalBlankScheduler::ScheduleAndProcessFrame(unsigned __int64 **this)
{
  ...
  struct _EVENT_DATA_DESCRIPTOR v33; // [rsp+130h] [rbp+28h] BYREF
  struct _EVENT_DATA_DESCRIPTOR v34; // [rsp+140h] [rbp+38h] BYREF
...
LABEL_23:
  *((_DWORD *)this + 2799) = 0;
LABEL_24:
  _m_prefetchw(&dword_180344730);
  v19 = dword_180344730;
  do
  {
    v20 = v19 | 1u;
    v21 = v19;
    v19 = _InterlockedCompareExchange(&dword_180344730, v20, v19);
  }
  while ( v21 != v19 );
