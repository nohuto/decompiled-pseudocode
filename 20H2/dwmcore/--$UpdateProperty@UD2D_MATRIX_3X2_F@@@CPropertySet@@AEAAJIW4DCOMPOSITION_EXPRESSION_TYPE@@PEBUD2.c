/*
 * XREFs of ??$UpdateProperty@UD2D_MATRIX_3X2_F@@@CPropertySet@@AEAAJIW4DCOMPOSITION_EXPRESSION_TYPE@@PEBUD2D_MATRIX_3X2_F@@@Z @ 0x1800B8778
 * Callers:
...
__int64 __fastcall CPropertySet::UpdateProperty<D2D_MATRIX_3X2_F>(__int64 a1)
{
  unsigned int v1; // edx
  __int64 v2; // rcx
  int v3; // r8d
