/*
 * XREFs of ?Contains@CRegion@FastRegion@@QEBA_NAEBV12@@Z @ 0x1800C3414
 * Callers:
 ...
 *     ?Contains@CRgnData@Internal@FastRegion@@QEBA_NAEBUtagRECT@@@Z @ 0x1800C34F0 (-Contains@CRgnData@Internal@FastRegion@@QEBA_NAEBUtagRECT@@@Z.c)
 */
