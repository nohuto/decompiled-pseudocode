/*
 * XREFs of ??$RegisterNodeForVisit@VCBrush@@@CDebugTreeDumper@@QEAAXPEAVCBrush@@_N@Z @ 0x1801B6AA4
 * Callers:
 ...
 *     ??$?4V_lambda_cdafab528f206ffe3f245df898126ff3_@@X@?$function@$$A6AXPEAXPEAVCDebugTreeDumper@@@Z@std@@QEAAAEAV01@$$QEAV_lambda_cdafab528f206ffe3f245df898126ff3_@@@Z @ 0x1801B68FC (--$-4V_lambda_cdafab528f206ffe3f245df898126ff3_@@X@-$function@$$A6AXPEAXPEAVCDebugTreeDumper@@@Z.c)
 */

__int64 __fastcall CDebugTreeDumper::RegisterNodeForVisit<CBrush>(__int64 a1, __int64 a2)
{
  __int64 result; // rax
  __int64 v3; // rdi
  __int64 v5; // r10
  ...
  {
    v23 = 0LL;
    std::function<void (void *,CDebugTreeDumper *)>::operator=<_lambda_cdafab528f206ffe3f245df898126ff3_,void>((__int64)v22);
