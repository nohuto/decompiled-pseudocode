/*
 * XREFs of ?Release@ReferencedGitCookie@?$GitStorageType@UIInspectable@@@detail@XWinRT@@QEAAKXZ @ 0x180244ABC
 * Callers:
        ...
        volatile signed __int32 *a1)
{
  ...
  {
    if ( *((_DWORD *)a1 + 1) )
      (*(void (__fastcall **)(__int64))(*(_QWORD *)qword_180344678 + 32LL))(qword_180344678);
