/*
 * XREFs of _anonymous_namespace_::AddToResourceCount @ 0x1800C2E6C
 * Callers:
 *     ?CountResource@CResourceTable@@AEAAXW4MIL_RESOURCE_TYPE@@@Z @ 0x180066278 (-CountResource@CResourceTable@@AEAAXW4MIL_RESOURCE_TYPE@@@Z.c)
...
void __fastcall anonymous_namespace_::AddToResourceCount(int a1, int a2)
{
  ...
  if ( a1 > 44 )
  {
    ...
    {
LABEL_9:
      LODWORD(xmmword_1803440F0) = a2 + xmmword_1803440F0;
      return;
    }
    v4 = v3 - 86;
    if ( v4 )
...
LABEL_20:
  ...
  if ( v7 && (v8 = v7 - 2) != 0 && (v9 = v8 - 2) != 0 && (v10 = v9 - 2) != 0 && (v11 = v10 - 3) != 0 )
  {
    ...
    {
LABEL_8:
      HIDWORD(xmmword_1803440E0) += a2;
      return;
    }
    HIDWORD(xmmword_1803440F0) += a2;
  }
  else
  {
    DWORD2(xmmword_1803440F0) += a2;
  }
}
