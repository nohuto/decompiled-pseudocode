/*
 * XREFs of CHolographicInteropTaskQueue::ProcessPendingMessages__lambda_db6293ec4389496e05a5db7898b72386___ @ 0x18024F91C
 * Callers:
 *     ?PreRender@CHolographicManager@@UEAAXXZ @ 0x1800C8140 (-PreRender@CHolographicManager@@UEAAXXZ.c)
 * Callees:
 ...
 *     ?ReleaseInteropTextures@CHolographicManager@@QEAAXXZ @ 0x180251440 (-ReleaseInteropTextures@CHolographicManager@@QEAAXXZ.c)
 ...
 *     ?ReverseList@CHolographicInteropTaskQueue@@AEAAPEAU_SLIST_ENTRY@@PEAU2@@Z @ 0x180257DA0 (-ReverseList@CHolographicInteropTaskQueue@@AEAAPEAU_SLIST_ENTRY@@PEAU2@@Z.c)
 */
