/*
 * XREFs of ?_SendUpdateToRenderThread@CManipulation@@AEAAJ_NPEBUD2DVector3@@1@Z @ 0x1801D4D78
 * Callers:
 ...
 *     ?D2DMatrixMultiply@@YAPEAUD2DMatrix@@PEAU1@PEBU1@1@Z @ 0x1800692A4 (-D2DMatrixMultiply@@YAPEAUD2DMatrix@@PEAU1@PEBU1@1@Z.c)
        ...
        const struct D2DVector3 *a4)
{
  ...
  if ( v16 )
  {
    ...
    v78 = v25;
    v79 = v26;
    ManipulationManager = CoreUICallSend(v30, &v64, 1LL, 10LL, 0, &unk_180288616);
    v14 = ManipulationManager;
    if ( ManipulationManager >= 0 )
    {
