/*
 * XREFs of ?EnsureHolographicClient@CHolographicManager@@AEAAJXZ @ 0x180250B00
 * Callers:
 ...
 *     ?HolographicClientCreated_@CompositorTracing@@QEAAXXZ @ 0x180250F68 (-HolographicClientCreated_@CompositorTracing@@QEAAXXZ.c)
