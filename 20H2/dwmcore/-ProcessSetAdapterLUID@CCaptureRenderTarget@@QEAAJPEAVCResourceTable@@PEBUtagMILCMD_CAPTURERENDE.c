/*
 * XREFs of ?ProcessSetAdapterLUID@CCaptureRenderTarget@@QEAAJPEAVCResourceTable@@PEBUtagMILCMD_CAPTURERENDERTARGET_SETADAPTERLUID@@@Z @ 0x1801873A8
 * Callers:
 ...
 *     ??9@YA_NAEBU_LUID@@0@Z @ 0x18015C608 (--9@YA_NAEBU_LUID@@0@Z.c)
