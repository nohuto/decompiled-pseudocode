/*
 * XREFs of ?CreateLegacySwapChain@CD3DDevice@@QEAAJPEAUIDXGIOutput@@AEBUD2D_SIZE_U@@AEBUPixelFormatInfo@@AEBVRenderTargetInfo@@I_NPEAPEAVILegacySwapChain@@@Z @ 0x1800320D4
 * Callers:
 ...
 *     ?UseSwapchainAsShaderInput@CD3DDevice@@QEBA_NXZ @ 0x18003293C (-UseSwapchainAsShaderInput@CD3DDevice@@QEBA_NXZ.c)
...
LABEL_30:
    v26 = v15;
LABEL_39:
    MilInstrumentationCheckHR_MaybeFailFast(v12, &dword_1802D9F50, 3u, v26, v27, 0LL);
  }
