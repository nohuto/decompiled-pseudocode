/*
 * XREFs of ?ConfigureInteractionContextIfNecessary@?$CInputTypeContext@UDwmPenInteractionConfigurationPrimitive@@U?$TMILFlagsEnum@W4FlagsEnum@DwmInteractionTypePenPrimitiveType@@@@W4FlagsEnum@DwmInteractionTypePenPrimitiveType@@@@QEAAJAEBUInteractionStateInfo@@PEAUTemporaryConfiguration@@@Z @ 0x180229CB4
 * Callers:
  ...
  if ( *a1 )
  {
    ...
    if ( v15 == 2 && ((*((_BYTE *)a1 + 136) ^ ((unsigned __int8)v8 >> 1)) & 1) != 0 )
    {
      ...
      if ( (v8 & 2) != 0
        ...
        && (qword_180341E90 & 2) != 0
        && (qword_180341E98 & 2) == qword_180341E98 )
      {
        v34 = 0;
        v32 = &v29;
        *(_QWORD *)&v29 = a1;
        ...
        tlgWriteTransfer_EventWriteTransfer(
          ...
          (unsigned __int8 *)dword_1802E866F,
          0LL,
          0LL,
          3u,
          &v31);
