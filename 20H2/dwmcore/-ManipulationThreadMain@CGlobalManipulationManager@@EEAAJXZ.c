/*
 * XREFs of ?ManipulationThreadMain@CGlobalManipulationManager@@EEAAJXZ @ 0x18002E860
 * Callers:
 *     <none>
 * Callees:
 ...
 *     IsRegisterManipulationThreadPresent @ 0x1800E418C (IsRegisterManipulationThreadPresent.c)
