/*
 * XREFs of ?D2DGeometryFromShape@CDrawingContext@@AEAAJPEBVCShape@@AEBVCMILMatrix@@PEAPEAUID2D1Geometry@@PEA_N@Z @ 0x180017B18
 * Callers:
        ...
        bool *a5)
{
  ...
  *a4 = 0LL;
  ...
  if ( v9 < 0 )
  {
    MilInstrumentationCheckHR_MaybeFailFast(v10, 0LL, 0, v9, 0x8BAu, 0LL);
  }
  else if ( a5 )
  {
    *a5 = v6;
