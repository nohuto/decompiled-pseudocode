/*
 * XREFs of ?EnsureWNFHandles@CLegacyRenderTarget@@IEAAJXZ @ 0x1800314A4
 * Callers:
...
__int64 __fastcall CLegacyRenderTarget::EnsureWNFHandles(CLegacyRenderTarget *this)
{
  ...
  if ( *((_QWORD *)this + 2325) || (v4 = PubSebRegisterRpc(WNF_SEB_FULL_SCREEN_VIDEO_PLAYBACK), v1 = v4, v4 >= 0) )
  {
    if ( !*((_QWORD *)this + 2326) )
    {
      ...
      v1 = v6;
      if ( v6 < 0 )
        MilInstrumentationCheckHR_MaybeFailFast(v7, &dword_1802D8708, 2u, v6, 0x1DDu, 0LL);
    }
  }
  else
  {
    MilInstrumentationCheckHR_MaybeFailFast(v5, &dword_1802D8708, 2u, v4, 0x1D7u, 0LL);
  }
  return v1;
}
