/*
 * XREFs of ?CheckAndRecordOverlayCandidateForContext@COcclusionContext@@QEAAJPEAVCOverlayContext@@PEAVCVisual@@PEAVCCompositionSurfaceInfo@@PEAVISwapChainRealization@@PEBVCMILMatrix@@PEBVCShape@@U?$TMILFlagsEnum@W4FlagsEnum@MilSourceModification@@@@@Z @ 0x1801828F4
 * Callers:
 ...
 *     ?Intersects@CRgnData@Internal@FastRegion@@SA_NAEBV123@0@Z @ 0x1800C1014 (-Intersects@CRgnData@Internal@FastRegion@@SA_NAEBV123@0@Z.c)
 ...
 *     McTemplateU0xdddddddd_EventWriteTransfer @ 0x1801832E4 (McTemplateU0xdddddddd_EventWriteTransfer.c)
 */
