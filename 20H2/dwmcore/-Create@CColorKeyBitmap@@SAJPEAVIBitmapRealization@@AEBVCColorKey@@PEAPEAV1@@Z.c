/*
 * XREFs of ?Create@CColorKeyBitmap@@SAJPEAVIBitmapRealization@@AEBVCColorKey@@PEAPEAV1@@Z @ 0x180264EF8
 * Callers:
 ...
 *     ??0CColorKeyBitmap@@IEAA@AEBVCColorKey@@@Z @ 0x180264A78 (--0CColorKeyBitmap@@IEAA@AEBVCColorKey@@@Z.c)
