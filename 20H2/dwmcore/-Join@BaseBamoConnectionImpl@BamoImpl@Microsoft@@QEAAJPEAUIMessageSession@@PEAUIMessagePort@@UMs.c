/*
 * XREFs of ?Join@BaseBamoConnectionImpl@BamoImpl@Microsoft@@QEAAJPEAUIMessageSession@@PEAUIMessagePort@@UMsgScopeID@@PEBG_N@Z @ 0x18002CA04
 * Callers:
 ...
 * Callees:
 *     ?StringCchCatW@@YAJPEAG_KPEBG@Z @ 0x180029C70 (-StringCchCatW@@YAJPEAG_KPEBG@Z.c)
