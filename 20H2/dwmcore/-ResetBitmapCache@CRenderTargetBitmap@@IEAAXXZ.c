/*
 * XREFs of ?ResetBitmapCache@CRenderTargetBitmap@@IEAAXXZ @ 0x180070510
 * Callers:
 ...
 *     ?SetProtected@CRenderTargetBitmap@@UEAAX_N@Z @ 0x1800D96C0 (-SetProtected@CRenderTargetBitmap@@UEAAX_N@Z.c)
 * Callees:
