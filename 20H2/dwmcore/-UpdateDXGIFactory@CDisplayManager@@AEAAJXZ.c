/*
 * XREFs of ?UpdateDXGIFactory@CDisplayManager@@AEAAJXZ @ 0x18003BA60
 * Callers:
...
__int64 __fastcall CDisplayManager::UpdateDXGIFactory(CDisplayManager *this)
{
  ...
  else
  {
    ...
    if ( qword_180348548 && !byte_18034855D && (char *)hObject - 1 <= (char *)0xFFFFFFFFFFFFFFFDLL )
    {
      (*(void (__fastcall **)(CDisplayManager *, _QWORD))(*(_QWORD *)qword_180348548 + 184LL))(
        qword_180348548,
        (unsigned int)dword_180348558);
      dword_180348558 = 0;
    }
    ...
    byte_18034855D = GetSystemMetrics(4096) != 0;
