/*
 * XREFs of ??1CComposition@@MEAA@XZ @ 0x1801548C0
 * Callers:
 ...
 *     ?UnmapDeferredSharedSectionViews@CComposition@@IEAAXXZ @ 0x180155940 (-UnmapDeferredSharedSectionViews@CComposition@@IEAAXXZ.c)
