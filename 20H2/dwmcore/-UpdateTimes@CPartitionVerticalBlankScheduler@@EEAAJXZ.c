/*
 * XREFs of ?UpdateTimes@CPartitionVerticalBlankScheduler@@EEAAJXZ @ 0x180078A30
 * Callers:
 ...
 *     ?ComputeLastVSyncFromPreviousFrame@CPartitionVerticalBlankScheduler@@AEAAXXZ @ 0x1800D7DD8 (-ComputeLastVSyncFromPreviousFrame@CPartitionVerticalBlankScheduler@@AEAAXXZ.c)
 *     __security_check_cookie @ 0x1800E29B0 (__security_check_cookie.c)
 *     memset_0 @ 0x1800E3DCC (memset_0.c)
 *     _guard_dispatch_icall_nop @ 0x1800EE9F0 (_guard_dispatch_icall_nop.c)
 *     McTemplateU0qxqxxxqxxxxqxxxxxxxxxxqqqxqxxxx_EventWriteTransfer @ 0x180156064 (McTemplateU0qxqxxxqxxxxqxxxxxxxxxxqqqxqxxxx_EventWriteTransfer.c)
 */
        ...
        __int64 a3)
{
  ...
  struct _EVENT_DATA_DESCRIPTOR v50; // [rsp+148h] [rbp-50h] BYREF
  struct _EVENT_DATA_DESCRIPTOR v51; // [rsp+158h] [rbp-40h] BYREF

  v51.Ptr = (ULONGLONG)this;
  ...
  if ( *((_BYTE *)this + 5372)
    && *((_BYTE *)this + 5373)
    && (v31 = CPartitionVerticalBlankScheduler::Reset(this, a2, a3), v42 = v31, v31 < 0) )
  {
