/*
 * XREFs of ?OnNewContact@CManipulationManager@@IEAAJPEAVCInteraction@@IW4InputType@@_N22@Z @ 0x180222C60
 * Callers:
 ...
 *     McTemplateU0pq_EventWriteTransfer @ 0x1801E2F94 (McTemplateU0pq_EventWriteTransfer.c)
 ...
 *     ?Add@?$CMap@IW4InputType@@V?$CMapEqualHelper@IW4InputType@@@@@@QEAAHAEBIAEBW4InputType@@@Z @ 0x180221AE0 (-Add@-$CMap@IW4InputType@@V-$CMapEqualHelper@IW4InputType@@@@@@QEAAHAEBIAEBW4InputType@@@Z.c)
 ...
 *     ?LockTree@CManipulationManager@@SAXPEAVCVisualTree@@_N@Z @ 0x180222380 (-LockTree@CManipulationManager@@SAXPEAVCVisualTree@@_N@Z.c)
