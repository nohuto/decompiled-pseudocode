/*
 * XREFs of ?SetProperty@CLinearTransferEffect@@UEAAJIW4DCOMPOSITION_EXPRESSION_TYPE@@PEBX@Z @ 0x1801D2900
 * Callers:
 *     <none>
 * Callees:
...
LABEL_22:
  ...
  if ( *a1 != v5 )
  {
    v13 = *(_QWORD *)v4;
    *a1 = v5;
    (*(void (__fastcall **)(float *, _QWORD, _QWORD))(v13 + 72))(v4, 0LL, 0LL);
  }
  return 0;
}
