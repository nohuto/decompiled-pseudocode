/*
 * XREFs of ?DebugDump@CResource@@UEAAXPEAVCVisualTreeDumpContext@@@Z @ 0x1801631E0
 * Callers:
 *     <none>
 * Callees:
...
void __fastcall CResource::DebugDump(CResource *this, void **a2)
{
  _QWORD *v3; // rdx
  _QWORD v4[4]; // [rsp+20h] [rbp-38h] BYREF

  std::string::string(v4, (__int64)"CResource");
  if ( a2 != v4 )
  {
    v3 = v4;
    if ( v4[3] >= 0x10uLL )
