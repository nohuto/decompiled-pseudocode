/*
 * XREFs of ?PostSubgraph@CPreComputeContext@@QEAAJPEBVCVisualTree@@PEA_N@Z @ 0x1800936C0
 * Callers:
 ...
 *     ?AddRectangleToBounds@CWindowBackgroundTreatment@@QEAAJAEBV?$TMil3DRect@MV?$TMilRect_@MUMilRectF@@UMil3DRectF@@UMilPointAndSizeF@@UNotNeeded@RectUniqueness@@@@UMil3DRectF@@UNotNeeded@RectUniqueness@@@@@Z @ 0x180014328 (-AddRectangleToBounds@CWindowBackgroundTreatment@@QEAAJAEBV-$TMil3DRect@MV-$TMilRect_@MUMilRectF.c)
 *     ??8?$TMil3DRect@MV?$TMilRect_@MUMilRectF@@UMil3DRectF@@UMilPointAndSizeF@@UNotNeeded@RectUniqueness@@@@UMil3DRectF@@UNotNeeded@RectUniqueness@@@@QEBA_NAEBV0@@Z @ 0x180015FC8 (--8-$TMil3DRect@MV-$TMilRect_@MUMilRectF@@UMil3DRectF@@UMilPointAndSizeF@@UNotNeeded@RectUniquen.c)
 ...
 *     ?GetTopLevelWindow@CVisual@@QEBA_KXZ @ 0x18001CAD4 (-GetTopLevelWindow@CVisual@@QEBA_KXZ.c)
 ...
 *     ?UnionUnsafe@?$TMil3DRect@MV?$TMilRect_@MUMilRectF@@UMil3DRectF@@UMilPointAndSizeF@@UNotNeeded@RectUniqueness@@@@UMil3DRectF@@UNotNeeded@RectUniqueness@@@@QEAA_NAEBV1@@Z @ 0x1800B4B70 (-UnionUnsafe@-$TMil3DRect@MV-$TMilRect_@MUMilRectF@@UMil3DRectF@@UMilPointAndSizeF@@UNotNeeded@R.c)
 ...
 *     ?CopyInputTransform@@YAXAEBVCMILMatrix@@PEAUtagINPUT_TRANSFORM@@@Z @ 0x1800CB19C (-CopyInputTransform@@YAXAEBVCMILMatrix@@PEAUtagINPUT_TRANSFORM@@@Z.c)
 *     ?SetFullDirty@CDirtyRegion@@QEAAXXZ @ 0x1800D1330 (-SetFullDirty@CDirtyRegion@@QEAAXXZ.c)
 *     ?Invert@CMILMatrix@@QEAA_NXZ @ 0x1800D1824 (-Invert@CMILMatrix@@QEAA_NXZ.c)
 *     ?GetTopByReference@?$CWatermarkStack@PEAVCBspNode@@$0EA@$01$09@@QEBAPEBQEAVCBspNode@@XZ @ 0x1800D4B14 (-GetTopByReference@-$CWatermarkStack@PEAVCBspNode@@$0EA@$01$09@@QEBAPEBQEAVCBspNode@@XZ.c)
 *     __security_check_cookie @ 0x1800E29B0 (__security_check_cookie.c)
 *     IsNotifyInputSinkParentedPresent @ 0x1800E4138 (IsNotifyInputSinkParentedPresent.c)
...
__int64 __fastcall CPreComputeContext::PostSubgraph(CPreComputeContext *this, const struct CVisualTree *a2, bool *a3)
{
  ...
  ULONG v59; // xmm7_4
  float v60; // xmm1_4
  struct _EVENT_DATA_DESCRIPTOR *v61; // r12
  int Ptr; // edx
  unsigned int i; // edi
  __int64 v64; // rax
  __int64 v65; // rax
  ...
  __int64 v91; // rcx
  __int64 v92; // rax
  struct _EVENT_DATA_DESCRIPTOR v93; // xmm0
  int v94; // eax
  void *v95; // rcx
  ...
  __int64 v125; // r8
  bool v126; // al
  struct _EVENT_DATA_DESCRIPTOR *v127; // rcx
  struct _EVENT_DATA_DESCRIPTOR v128; // xmm1
  bool v129; // cc
  unsigned int Ptr_high; // xmm0_4
  float v131; // xmm7_4
  ULONG Size; // xmm2_4
  float v133; // xmm6_4
  ULONG Reserved; // xmm3_4
  float v135; // xmm4_4
  ...
  struct _EVENT_DATA_DESCRIPTOR v199; // [rsp+190h] [rbp-E8h] BYREF
  struct _EVENT_DATA_DESCRIPTOR v200; // [rsp+1A0h] [rbp-D8h] BYREF
  __int64 v201; // [rsp+1B0h] [rbp-C8h]
  struct _EVENT_DATA_DESCRIPTOR v202; // [rsp+1B8h] [rbp-C0h] BYREF
  __int64 v203; // [rsp+1C8h] [rbp-B0h]
  __int128 v204; // [rsp+1D0h] [rbp-A8h] BYREF
  __int64 v205; // [rsp+1E0h] [rbp-98h]
  struct _EVENT_DATA_DESCRIPTOR v206; // [rsp+1E8h] [rbp-90h] BYREF
...
LABEL_4:
  *a3 = 1;
  ...
  {
    v199.Ptr = 0x100000000LL;
    v61 = &v199;
    do
    {
      Ptr = v61->Ptr;
      for ( i = 0; i < (unsigned int)CVisual::GetLightsCount((_QWORD *)v7, Ptr); ++i )
      {
        if ( Ptr )
      ...
      v61 = (struct _EVENT_DATA_DESCRIPTOR *)((char *)v61 + 4);
    }
    while ( v61 != (struct _EVENT_DATA_DESCRIPTOR *)&v199.Size );
    v3 = v182;
  }
  v12 = *(_BYTE *)(v7 + 88);
  if ( (v12 & 1) != 0 )
...
LABEL_8:
  ...
  v190 = _xmm;
  v191 = _xmm;
  v199 = (struct _EVENT_DATA_DESCRIPTOR)TMilRect<float,MilRectF,Mil3DRectF,RectUniqueness::NotNeeded>::sc_rcInfinite;
  LOWORD(v192) = 32085;
  v176 = 0;
...
LABEL_211:
         ...
         || v104 < *(&TMilRect<float,MilRectF,Mil3DRectF,RectUniqueness::NotNeeded>::sc_rcInfinite + 3)) )
      {
        ...
        v104 = *(float *)&v199.Reserved;
        v103 = *(float *)&v199.Size;
        v102 = *((float *)&v199.Ptr + 1);
        v101 = *(float *)&v199.Ptr;
      }
      v11 = *(_QWORD *)(v100 + 240);
      if ( !v11 )
...
LABEL_234:
      ...
      else
      {
        ...
        if ( v180 )
        {
          v110 = (*(__int64 (__fastcall **)(__int64, struct _EVENT_DATA_DESCRIPTOR *, __int128 *))(*(_QWORD *)v180 + 32LL))(
                   v180,
                   &v206,
                   &v194);
          if ( v110 < 0 )
          ...
          {
            if ( *(float *)&v206.Ptr > v101 )
            {
              LODWORD(v199.Ptr) = v206.Ptr;
              v101 = *(float *)&v206.Ptr;
            }
            v112 = v102;
            if ( *((float *)&v206.Ptr + 1) > v102 )
            {
              HIDWORD(v199.Ptr) = HIDWORD(v206.Ptr);
              v102 = *((float *)&v206.Ptr + 1);
              v112 = *((float *)&v206.Ptr + 1);
            }
            v113 = v103;
            if ( v103 > *(float *)&v206.Size )
            {
              v199.Size = v206.Size;
              v103 = *(float *)&v206.Size;
              v113 = *(float *)&v206.Size;
            }
            v114 = v104;
            if ( v104 > *(float *)&v206.Reserved )
            {
              v199.Reserved = v206.Reserved;
              v104 = *(float *)&v206.Reserved;
              v114 = *(float *)&v206.Reserved;
            }
            if ( v113 <= v101 || v114 <= v112 )
            {
              ...
              v102 = 0.0;
              v101 = 0.0;
              v199 = (struct _EVENT_DATA_DESCRIPTOR)0LL;
            }
          }
          goto LABEL_234;
        }
...
LABEL_242:
    ...
    {
      v203 = v201;
      v202.Ptr = __PAIR64__(LODWORD(v102), LODWORD(v101));
      *(float *)&v202.Size = v103;
      *(float *)&v202.Reserved = v104;
    ...
    if ( *(float *)&v200.Size <= *(float *)&v200.Ptr )
      ++v117;
    if ( *(float *)&v200.Reserved <= *((float *)&v200.Ptr + 1) )
      ++v117;
    if ( v117 <= 1 )
    {
...
LABEL_15:
  ...
  if ( (*(_BYTE *)(v7 + 264) & 1) != 0 )
  {
    ...
    if ( v90 )
    {
      ...
      *((_DWORD *)this + 26) = v91;
      v92 = *((_QWORD *)this + 15);
      v200 = 0LL;
      v93 = *(struct _EVENT_DATA_DESCRIPTOR *)(v92 + 16 * v91);
      v94 = *((_DWORD *)this + 58);
      v202 = v93;
      ...
      if ( v97 )
      {
        v127 = (struct _EVENT_DATA_DESCRIPTOR *)(*((_QWORD *)this + 35) + 16LL * (unsigned int)(v97 - 1));
        v128 = *v127;
        v129 = *(float *)&v200.Ptr <= COERCE_FLOAT(*v127);
        v199 = *v127;
        if ( !v129 )
          LODWORD(v128.Ptr) = v200.Ptr;
        Ptr_high = HIDWORD(v199.Ptr);
        v131 = *((float *)&v199.Ptr + 1);
        if ( *((float *)&v200.Ptr + 1) > *((float *)&v199.Ptr + 1) )
        {
          Ptr_high = HIDWORD(v200.Ptr);
          v131 = *((float *)&v200.Ptr + 1);
        }
        Size = v199.Size;
        v133 = *(float *)&v199.Size;
        if ( *(float *)&v199.Size > *(float *)&v200.Size )
        {
          Size = v200.Size;
          v133 = *(float *)&v200.Size;
        }
        Reserved = v199.Reserved;
        v135 = *(float *)&v199.Reserved;
        if ( *(float *)&v199.Reserved > *(float *)&v200.Reserved )
        {
          Reserved = v200.Reserved;
          v135 = *(float *)&v200.Reserved;
        }
        if ( v133 <= *(float *)&v128.Ptr || v135 <= v131 )
        {
          Reserved = 0;
          Size = 0;
          Ptr_high = 0;
        ...
        v199.Ptr = __PAIR64__(Ptr_high, v128.Ptr);
        *(_QWORD *)&v199.Size = __PAIR64__(Reserved, Size);
      }
      else
      {
        v199 = v200;
  ...
  v122 = (ULONGLONG)v121;
  v199.Ptr = (ULONGLONG)v121;
  if ( !(_DWORD)v11
    || (v123 = v11 - 1,
        *((_DWORD *)this + 26) = v123,
        v124 = v123,
        v11 = *((_QWORD *)this + 15),
        v200 = *(struct _EVENT_DATA_DESCRIPTOR *)(v11 + 16 * v124),
        !*((_BYTE *)v121 + 356)) )
  {
LABEL_26:
    v18 = g_pComposition;
  ...
  v178 = *(_BYTE *)(v122 + 360);
  v179 = *(_BYTE *)(v122 + 359);
  if ( !CWindowBackgroundTreatment::HasValidSource((CWindowBackgroundTreatment *)v122, 0LL)
    || !TMil3DRect<float,TMilRect_<float,MilRectF,Mil3DRectF,MilPointAndSizeF,RectUniqueness::NotNeeded>,Mil3DRectF,RectUniqueness::NotNeeded>::operator==(
          (float *)(v122 + 144),
          (float *)(v122 + 192))
    || !(unsigned __int8)CWindowBackgroundTreatment::AreWorldBoundsUnchangedForPreCompute((CWindowBackgroundTreatment *)v122) )
  {
    CWindowBackgroundTreatment::ClearRenderTargetMaps((CWindowBackgroundTreatment *)v122);
    goto LABEL_26;
  }
  v18 = g_pComposition;
  v126 = v178
      && *((_QWORD *)g_pComposition + 57) - *(_QWORD *)(v122 + 376) < CCommonRegistryData::m_backdropBlurCachingThrottleQPCTimeDelta;
  if ( !v179 || v126 || !v177 )
    *(_BYTE *)(v122 + 357) = 0;
LABEL_27:
  if ( (*(_BYTE *)(v7 + 88) & 4) != 0 )
  {
    ...
    v47 = *(float *)&v200.Size;
    v48 = *(float *)&v200.Ptr;
    v49 = *(float *)&v200.Reserved;
    v50 = *((float *)&v200.Ptr + 1);
    if ( *(float *)&v200.Size > *(float *)&v200.Ptr && *(float *)&v200.Reserved > *((float *)&v200.Ptr + 1) )
    {
      v51 = *(_DWORD *)(v7 + 88);
      ...
      if ( v52 != 0.0 )
      {
        v48 = *(float *)&v200.Ptr - v52;
        v50 = *((float *)&v200.Ptr + 1) - v52;
        v47 = *(float *)&v200.Size + v52;
        v49 = *(float *)&v200.Reserved + v52;
      }
    }
    v53 = *((_DWORD *)this + 66);
    if ( v53 )
    {
      v202 = *(struct _EVENT_DATA_DESCRIPTOR *)(*((_QWORD *)this + 35) + 16LL * (unsigned int)(v53 - 1));
      v54 = *(float *)&v202.Ptr;
      if ( v48 > *(float *)&v202.Ptr )
        v54 = v48;
      v55 = *((float *)&v202.Ptr + 1);
      v56 = *((float *)&v202.Ptr + 1);
      if ( v50 > *((float *)&v202.Ptr + 1) )
      {
        v55 = v50;
        v56 = v50;
      }
      v57 = v202.Size;
      v58 = *(float *)&v202.Size;
      if ( *(float *)&v202.Size > v47 )
      {
        v57 = LODWORD(v47);
        v58 = v47;
      }
      v59 = v202.Reserved;
      v60 = *(float *)&v202.Reserved;
      if ( *(float *)&v202.Reserved > v49 )
      {
        v59 = LODWORD(v49);
        v60 = v49;
      }
      ...
      v199.Ptr = __PAIR64__(LODWORD(v55), LODWORD(v54));
      v48 = v54;
      v50 = v55;
      *(_QWORD *)&v199.Size = __PAIR64__(v59, v57);
      LODWORD(v47) = v57;
      LODWORD(v49) = v59;
    }
    else
    {
      v199.Ptr = __PAIR64__(LODWORD(v50), LODWORD(v48));
      *(_QWORD *)&v199.Size = __PAIR64__(LODWORD(v49), LODWORD(v47));
    }
    v11 = *((_QWORD *)this + 86);
    v23 = 0;
...
LABEL_28:
  ...
  *(_BYTE *)(v7 + 93) = v19 ^ (v19 ^ (*(_DWORD *)(v7 + 88) >> 12)) & 2;
  v202.Ptr = CVisual::GetTopLevelWindow((CVisual *)v7);
  ...
  {
    v11 = 2 * v35;
    *(struct _EVENT_DATA_DESCRIPTOR *)(*((_QWORD *)this + 78) + 16 * v35) = v202;
    *((_DWORD *)this + 162) = v36;
    goto LABEL_30;
  }
