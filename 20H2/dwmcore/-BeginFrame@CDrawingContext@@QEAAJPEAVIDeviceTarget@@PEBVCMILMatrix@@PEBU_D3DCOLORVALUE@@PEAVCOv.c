/*
 * XREFs of ?BeginFrame@CDrawingContext@@QEAAJPEAVIDeviceTarget@@PEBVCMILMatrix@@PEBU_D3DCOLORVALUE@@PEAVCOverlayContext@@@Z @ 0x180085038
 * Callers:
 ...
 *     McTemplateU0ppffffubr6_EventWriteTransfer @ 0x1801786F0 (McTemplateU0ppffffubr6_EventWriteTransfer.c)
        ...
        struct COverlayContext *a5)
{
  ...
  *((_QWORD *)this + 435) = 0LL;
  if ( dword_180348220 > *(_DWORD *)(v23 + 4) )
  {
    Init_thread_header(&dword_180348220);
    if ( dword_180348220 == -1 )
    {
      v33 = CProcessAttributionManager::CreateProcessAttribution(
              v22,
              -1,
              (const struct CProcessAttributionManager::ProcessAttributionRecord *)&unk_1803446C0,
              0,
              &v45);
      if ( v33 < 0 )
        ModuleFailFastForHRESULT((unsigned int)v33, retaddr);
      qword_180344660 = (__int64)v45;
      Init_thread_footer(&dword_180348220);
    }
  }
  v24 = (struct CProcessAttribution *)qword_180344660;
  LODWORD(v42) = 11;
  v43 = 0LL;
