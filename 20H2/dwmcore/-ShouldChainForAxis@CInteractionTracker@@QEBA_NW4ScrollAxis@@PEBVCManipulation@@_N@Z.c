/*
 * XREFs of ?ShouldChainForAxis@CInteractionTracker@@QEBA_NW4ScrollAxis@@PEBVCManipulation@@_N@Z @ 0x1801CC300
 * Callers:
 ...
 *     _lambda_f7bd61b0100483a4d5791bc237b79594_::operator() @ 0x1801C70BC (_lambda_f7bd61b0100483a4d5791bc237b79594_--operator().c)
 */
