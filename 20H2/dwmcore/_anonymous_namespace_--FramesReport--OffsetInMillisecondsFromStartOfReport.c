/*
 * XREFs of _anonymous_namespace_::FramesReport::OffsetInMillisecondsFromStartOfReport @ 0x180035774
 * Callers:
 *     _anonymous_namespace_::SealCurrentFrameSequence @ 0x180035330 (_anonymous_namespace_--SealCurrentFrameSequence.c)
 *     ?FrameRenderingStarted@CTelemetryFrames@@SAX_K@Z @ 0x18007C924 (-FrameRenderingStarted@CTelemetryFrames@@SAX_K@Z.c)
 * Callees:
 *     <none>
 */
