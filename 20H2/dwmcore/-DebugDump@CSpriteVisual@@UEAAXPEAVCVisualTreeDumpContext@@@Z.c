/*
 * XREFs of ?DebugDump@CSpriteVisual@@UEAAXPEAVCVisualTreeDumpContext@@@Z @ 0x1801ED230
 * Callers:
 *     <none>
 * Callees:
...
void __fastcall CSpriteVisual::DebugDump(CSpriteVisual *this, void **a2)
{
  _QWORD *v3; // rdx
  _QWORD v4[4]; // [rsp+20h] [rbp-38h] BYREF

  CVisual::DebugDump(this, a2);
  std::string::string(v4, (__int64)"CSpriteVisual");
  if ( a2 != v4 )
  {
    v3 = v4;
    if ( v4[3] >= 0x10uLL )
