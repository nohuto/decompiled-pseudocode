/*
 * XREFs of ?DwmCoreDllMain@@YAHPEAUHINSTANCE__@@K@Z @ 0x1800DCFB0
 * Callers:
 *     DllMain @ 0x1800E5188 (DllMain.c)
 * Callees:
 ...
 *     McGenEventUnregister_EventUnregister @ 0x1800E2690 (McGenEventUnregister_EventUnregister.c)
