/*
 * XREFs of ?WaitForWork@CPartitionVerticalBlankScheduler@@AEAAXXZ @ 0x18007ACAC
 * Callers:
 ...
 *     McTemplateU0qqqqq_EventWriteTransfer @ 0x180153AD8 (McTemplateU0qqqqq_EventWriteTransfer.c)
 *     ?CurrentTime@CDebugFrameCounter@@IEAA_KXZ @ 0x1801627A8 (-CurrentTime@CDebugFrameCounter@@IEAA_KXZ.c)
 *     ?UpdateGlitchList@CDebugFrameCounter@@IEAAXAEA_K@Z @ 0x1801629CC (-UpdateGlitchList@CDebugFrameCounter@@IEAAXAEA_K@Z.c)
        ...
        __int64 a3)
{
  ...
  struct _EVENT_DATA_DESCRIPTOR v43; // [rsp+70h] [rbp+Fh] BYREF
  ...
  if ( *((_BYTE *)this + 11224) && *((_BYTE *)this + 11225) )
  {
    ...
    CDebugFrameCounter::UpdateGlitchList((CPartitionVerticalBlankScheduler *)((char *)this + 11200), &v43.Ptr);
  }
  v6 = hObject;
  if ( (char *)hObject - 1 > (char *)0xFFFFFFFFFFFFFFFDLL )
  {
    if ( qword_180348548 )
    {
      ...
      else
      {
        ...
        {
          if ( EventW != (char *)-1LL
            && (*(int (__fastcall **)(CDisplayManager *, char *, int *))(*(_QWORD *)qword_180348548 + 176LL))(
                 qword_180348548,
                 EventW,
                 &dword_180348558) >= 0 )
          {
