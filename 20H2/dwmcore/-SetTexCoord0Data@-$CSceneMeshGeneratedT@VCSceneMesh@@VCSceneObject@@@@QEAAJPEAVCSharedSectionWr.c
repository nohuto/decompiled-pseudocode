/*
 * XREFs of ?SetTexCoord0Data@?$CSceneMeshGeneratedT@VCSceneMesh@@VCSceneObject@@@@QEAAJPEAVCSharedSectionWrapper@@@Z @ 0x180173128
 * Callers:
        ...
        struct CResource *a2)
{
  ...
  if ( a2 != this[14] )
  {
    ...
    if ( v5 < 0 )
    {
      MilInstrumentationCheckHR_MaybeFailFast(v6, 0LL, 0, v5, 0xA44u, 0LL);
    }
    else
    {
