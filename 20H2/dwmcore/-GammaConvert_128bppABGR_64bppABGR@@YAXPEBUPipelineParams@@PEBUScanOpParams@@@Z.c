/*
 * XREFs of ?GammaConvert_128bppABGR_64bppABGR@@YAXPEBUPipelineParams@@PEBUScanOpParams@@@Z @ 0x180218120
 * Callers:
 *     <none>
 * Callees:
 *     ?Convert_scRGB_float_To_sRGB_UINT16@@YAGM@Z @ 0x18021C33C (-Convert_scRGB_float_To_sRGB_UINT16@@YAGM@Z.c)
 */
