/*
 * XREFs of ?RenderDebugFrameCounter@CLegacyRenderTarget@@IEAAJPEAVCDrawingContext@@@Z @ 0x180184568
 * Callers:
 ...
 *     ?GetCPUTimePerFrame@CDebugFrameCounter@@QEAAIXZ @ 0x180162808 (-GetCPUTimePerFrame@CDebugFrameCounter@@QEAAIXZ.c)
 *     ?GetFrameRate@CDebugFrameCounter@@QEAAIXZ @ 0x18016288C (-GetFrameRate@CDebugFrameCounter@@QEAAIXZ.c)
 ...
 *     McTemplateU0qx_EventWriteTransfer @ 0x1801849AC (McTemplateU0qx_EventWriteTransfer.c)
 */
