/*
 * XREFs of _anonymous_namespace_::ProcessAttributionResourceCountersEncoder::Serialize @ 0x1800590C8
 * Callers:
        ...
        __int64 a2)
{
  ...
  Base853Encoder::AppendVarInt((Base853Encoder *)&v3, a1[18]);
  Base853Encoder::AppendVarInt((Base853Encoder *)&v3, a1[19]);
  Base853Encoder::AppendVarInt((Base853Encoder *)&v3, a1[20]);
