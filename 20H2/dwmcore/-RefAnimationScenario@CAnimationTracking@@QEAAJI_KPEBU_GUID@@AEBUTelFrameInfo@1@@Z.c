/*
 * XREFs of ?RefAnimationScenario@CAnimationTracking@@QEAAJI_KPEBU_GUID@@AEBUTelFrameInfo@1@@Z @ 0x180028BF8
 * Callers:
 ...
 *     McTemplateU0xzqqqz_EventWriteTransfer @ 0x1801571F0 (McTemplateU0xzqqqz_EventWriteTransfer.c)
  ...
  if ( v29 )
  {
    ...
    else
    {
      ...
      if ( v16 > *((_DWORD *)v29 + 45) )
      {
        ...
        v13 = v26;
        if ( v26 < 0 )
          MilInstrumentationCheckHR_MaybeFailFast((unsigned int)v17, 0LL, 0, v26, 0xC0u, 0LL);
      }
      else
      {
        v17 = *v14;
