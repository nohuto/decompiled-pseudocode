/*
 * XREFs of ?CopyFrom@CAtlasTexture@@QEAAXPEBV1@PEAI@Z @ 0x18024962C
 * Callers:
 ...
 *     ?IsFreeEntryInRow@CAtlasTexture@@QEBA_NI@Z @ 0x180249BF8 (-IsFreeEntryInRow@CAtlasTexture@@QEBA_NI@Z.c)
 *     ?IsInUseEntryInRow@CAtlasTexture@@QEBA_NI@Z @ 0x180249C28 (-IsInUseEntryInRow@CAtlasTexture@@QEBA_NI@Z.c)
 */
