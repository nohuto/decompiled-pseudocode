/*
 * XREFs of ??$_Uninitialized_move@PEAVDeviceInfo@CDeviceManager@@PEAV12@V?$allocator@VDeviceInfo@CDeviceManager@@@std@@@std@@YAPEAVDeviceInfo@CDeviceManager@@QEAV12@0PEAV12@AEAV?$allocator@VDeviceInfo@CDeviceManager@@@0@@Z @ 0x18003B238
 * Callers:
        ...
        char *a3)
{
  ...
  std::_Destroy_range<std::allocator<CDeviceManager::DeviceInfo>>(a3, a3, a2);
  return a3;
}
