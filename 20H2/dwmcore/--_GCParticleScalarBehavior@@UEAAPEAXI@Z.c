/*
 * XREFs of ??_GCParticleScalarBehavior@@UEAAPEAXI@Z @ 0x18016D290
 * Callers:
 *     ??_ECParticleScalarBehavior@@WGI@EAAPEAXI@Z @ 0x1800EEB80 (--_ECParticleScalarBehavior@@WGI@EAAPEAXI@Z.c)
 * Callees:
