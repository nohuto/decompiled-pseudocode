/*
 * XREFs of ?PropertyChanged@BamoCompObjectDiagnosticsRootProxyImpl@BamoImpl@@QEAAJI_KIIW4DCOMPOSITION_EXPRESSION_TYPE@@PEBEI@Z @ 0x1801820C4
 * Callers:
...
LABEL_3:
  ...
  return CoreUICallSend(v5, v8, 2LL, 0LL, 3, &unk_1802D7292);
}
