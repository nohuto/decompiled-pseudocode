/*
 * XREFs of ??0BamoDataProviderRegistrarPrincipal@@QEAA@PEAVBamoConnection@dataprovider_AutoBamos@@@Z @ 0x18002E034
 * Callers:
        ...
        struct dataprovider_AutoBamos::BamoConnection *a2)
{
  ...
  *((_QWORD *)v2 + 4) = 0LL;
  *((_DWORD *)v2 + 6) = 0;
  v5 = (*(__int64 (__fastcall **)(_QWORD, _QWORD, char *))(**(_QWORD **)(*(_QWORD *)(*((_QWORD *)v2 + 2) + 32LL) + 56LL)
                                                         + 24LL))(
         *(_QWORD *)(*(_QWORD *)(*((_QWORD *)v2 + 2) + 32LL) + 56LL),
         *(unsigned int *)(*(_QWORD *)(*((_QWORD *)v2 + 2) + 32LL) + 28LL),
         v2);
  if ( v5 < 0 )
  {
