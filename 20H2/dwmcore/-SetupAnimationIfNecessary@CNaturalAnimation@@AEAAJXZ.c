/*
 * XREFs of ?SetupAnimationIfNecessary@CNaturalAnimation@@AEAAJXZ @ 0x1801D8920
 * Callers:
 ...
 *     ?SetStartTimeIfNecessary@CNaturalAnimation@@AEAAX_K@Z @ 0x1801D8698 (-SetStartTimeIfNecessary@CNaturalAnimation@@AEAAX_K@Z.c)
 */
