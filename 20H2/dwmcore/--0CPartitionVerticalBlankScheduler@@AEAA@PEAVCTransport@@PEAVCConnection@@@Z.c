/*
 * XREFs of ??0CPartitionVerticalBlankScheduler@@AEAA@PEAVCTransport@@PEAVCConnection@@@Z @ 0x180033E64
 * Callers:
 *     ?RunCompositionThread@CConnection@@AEAAJXZ @ 0x18003351C (-RunCompositionThread@CConnection@@AEAAJXZ.c)
 * Callees:
 *     ??0CTelemetryTouchLatencyAnalysis@@QEAA@XZ @ 0x180034018 (--0CTelemetryTouchLatencyAnalysis@@QEAA@XZ.c)
