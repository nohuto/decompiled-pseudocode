/*
 * XREFs of ?VisualSetPassiveUpdateMode@CChannel@@UEAAJI_N@Z @ 0x1800E1A70
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall CChannel::VisualSetPassiveUpdateMode(CChannel *this, unsigned int a2, unsigned __int8 a3)
{
  unsigned int v6; // ebx
