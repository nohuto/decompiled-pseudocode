/*
 * XREFs of ?CheckOcclusionState@CCaptureRenderTarget@@UEAAJXZ @ 0x1800E85E8
 * Callers:
 *     ?CheckOcclusionState@CCaptureRenderTarget@@$4PPPPPPPM@A@EAAJXZ @ 0x1800EEEE0 (-CheckOcclusionState@CCaptureRenderTarget@@$4PPPPPPPM@A@EAAJXZ.c)
 *     ?CheckOcclusionState@CCaptureRenderTarget@@$4PPPPPPPM@EI@EAAJXZ @ 0x1800EEEF0 (-CheckOcclusionState@CCaptureRenderTarget@@$4PPPPPPPM@EI@EAAJXZ.c)
 * Callees:
