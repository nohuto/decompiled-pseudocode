/*
 * XREFs of ?Draw@CCompositionSurfaceBitmap@@UEAAJPEAVCDrawingContext@@AEBUD2D_SIZE_F@@PEAVCDrawListCache@@@Z @ 0x180014D64
 * Callers:
 *     ?Draw@CCompositionSurfaceBitmap@@$4PPPPPPPM@A@EAAJPEAVCDrawingContext@@AEBUD2D_SIZE_F@@PEAVCDrawListCache@@@Z @ 0x1800EEFC0 (-Draw@CCompositionSurfaceBitmap@@$4PPPPPPPM@A@EAAJPEAVCDrawingContext@@AEBUD2D_SIZE_F@@PEAVCDraw.c)
 * Callees:
 ...
 *     McTemplateU0pppffff_EventWriteTransfer @ 0x1801BC294 (McTemplateU0pppffff_EventWriteTransfer.c)
        ...
        struct CDrawListCache *a4)
{
  ...
  if ( !(unsigned __int8)TMilRect<float,MilRectF,Mil3DRectF,RectUniqueness::NotNeeded>::IsEmpty(&v44) )
  {
    ...
    {
      v18 = CDrawingContext::DrawSolidRectangle((char *)a2 + 16, &v39, &stru_1802ED980);
      v9 = v18;
      if ( v18 < 0 )
      {
