/*
 * XREFs of ?GenerateDrawList@CBrushDrawListGenerator@@QEAAJAEBUGenerateDrawListProperties@1@PEAVCDrawListEntryBuilder@@@Z @ 0x1800619C4
 * Callers:
...
LABEL_77:
    MilInstrumentationCheckHR_MaybeFailFast(v48, 0LL, 0, v17, 0x151u, 0LL);
    goto LABEL_44;
  }
  ...
  {
    MilInstrumentationCheckHR_MaybeFailFast(v37, 0LL, 0, DrawListPrimitive, 0x180u, 0LL);
    goto LABEL_77;
  }
LABEL_37:
  v17 = 0;
  if ( *((_QWORD *)a3 + 4) )
  {
    ...
    if ( v17 < 0 )
      MilInstrumentationCheckHR_MaybeFailFast(v34, 0LL, 0, v17, 0x156u, 0LL);
  }
LABEL_44:
  if ( v53 && v52 )
    (**v52)(v52, 1LL);
