/*
 * XREFs of ?PrepareData@CMegaRect@@QEAAJAEAV?$vector@EV?$allocator@E@std@@@std@@@Z @ 0x1800724A4
 * Callers:
 ...
 *     VerticesHaveIntegralXY @ 0x1800723D8 (VerticesHaveIntegralXY.c)
 *     IsValidAxisAlignedRect @ 0x180072438 (IsValidAxisAlignedRect.c)
