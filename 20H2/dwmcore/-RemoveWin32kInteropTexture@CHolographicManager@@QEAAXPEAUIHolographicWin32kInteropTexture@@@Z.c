/*
 * XREFs of ?RemoveWin32kInteropTexture@CHolographicManager@@QEAAXPEAUIHolographicWin32kInteropTexture@@@Z @ 0x180251988
 * Callers:
 *     ?Remove@CHolographicFrameProcessor@@UEAAXXZ @ 0x18025A3B0 (-Remove@CHolographicFrameProcessor@@UEAAXXZ.c)
 * Callees:
