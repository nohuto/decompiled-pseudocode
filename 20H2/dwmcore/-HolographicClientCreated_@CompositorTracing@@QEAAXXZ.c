/*
 * XREFs of ?HolographicClientCreated_@CompositorTracing@@QEAAXXZ @ 0x180250F68
 * Callers:
...
void __fastcall CompositorTracing::HolographicClientCreated_(CompositorTracing *this)
{
  ...
  {
    tlgWriteTransfer_EventWriteTransfer(v1, (unsigned __int8 *)dword_1802EA549, 0LL, 0LL, 2u, &v2);
  }
}
