/*
 * XREFs of McTemplateU0pqqNR2_EventWriteTransfer @ 0x1801C68B0
 * Callers:
 *     ?TraceUpdatedConfiguration@CInteraction@@QEAAXW4Enum@InteractionConfigurationUpdateType@@W42InteractionInputType@@IPEBX@Z @ 0x18006DA3C (-TraceUpdatedConfiguration@CInteraction@@QEAAXW4Enum@InteractionConfigurationUpdateType@@W42Inte.c)
 * Callees:
