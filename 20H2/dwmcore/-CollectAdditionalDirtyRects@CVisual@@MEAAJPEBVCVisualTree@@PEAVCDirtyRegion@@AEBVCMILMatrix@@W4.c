/*
 * XREFs of ?CollectAdditionalDirtyRects@CVisual@@MEAAJPEBVCVisualTree@@PEAVCDirtyRegion@@AEBVCMILMatrix@@W4Enum@MilBitmapInterpolationMode@@PEBV?$TMilRect_@MUMilRectF@@UMil3DRectF@@UMilPointAndSizeF@@UNotNeeded@RectUniqueness@@@@@Z @ 0x1800AAD40
 * Callers:
  ...
  if ( AdditionalDirtyRects )
  {
    if ( !(*(unsigned __int8 (__fastcall **)(struct CMergedDirtyRect *))(*(_QWORD *)AdditionalDirtyRects + 32LL))(AdditionalDirtyRects) )
    {
      ...
      if ( v27 )
      {
        ...
        MilInstrumentationCheckHR_MaybeFailFast(v20, 0LL, 0, v9, 0xE7Bu, 0LL);
      }
    }
  }
  return (unsigned int)v9;
