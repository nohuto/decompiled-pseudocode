/*
 * XREFs of ?SendPendingStateChangeCallbacks@CInteractionTracker@@AEAAX_N@Z @ 0x1801CAEF8
 * Callers:
 *     ?SendPendingCallbacks@CInteractionTracker@@AEAAXXZ @ 0x1801CAC74 (-SendPendingCallbacks@CInteractionTracker@@AEAAXXZ.c)
 * Callees:
 ...
 *     ?SendValuesChangedCallbackIfNecessary@CInteractionTracker@@AEAA_NUD2DVector3@@M_N@Z @ 0x1801CB2A8 (-SendValuesChangedCallbackIfNecessary@CInteractionTracker@@AEAA_NUD2DVector3@@M_N@Z.c)
      ...
      if ( v11 )
      {
        ...
        if ( v12 )
        {
          ...
          if ( !v13 )
          {
            ...
            CoreUICallSend(v5, v43, 2LL, 8LL, 1, &unk_1802885FB);
            if ( *((_BYTE *)this + 626) )
              *((_BYTE *)this + 626) = 0;
            goto LABEL_21;
          }
