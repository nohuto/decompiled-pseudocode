/*
 * XREFs of ?SetProjectedShadowCasters@CVisual@@QEAAXPEAV?$vector@PEAVCProjectedShadowCaster@@V?$allocator@PEAVCProjectedShadowCaster@@@std@@@std@@@Z @ 0x18001359C
 * Callers:
...
__int64 __fastcall CVisual::SetProjectedShadowCasters(__int64 a1, __int64 a2)
{
  ...
  if ( a2 )
  {
    ...
    {
      result = CSparseAlignedStorage<8,8>::AllocatedStorage::ReserveSlot(a1 + 224, 14LL);
      *(_QWORD *)result = a2;
    }
  }
  ...
  {
    *v3 &= ~0x40000u;
    result = CSparseAlignedStorage<8,8>::AllocatedStorage::FindSlot(v3, 14LL);
