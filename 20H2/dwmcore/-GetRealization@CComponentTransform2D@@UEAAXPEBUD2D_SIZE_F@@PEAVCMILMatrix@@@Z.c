/*
 * XREFs of ?GetRealization@CComponentTransform2D@@UEAAXPEBUD2D_SIZE_F@@PEAVCMILMatrix@@@Z @ 0x1801B8020
 * Callers:
 *     <none>
 * Callees:
 *     ?Set2DAffineMatrix@CMILMatrix@@QEAAXMMMMMM@Z @ 0x1800C8CFC (-Set2DAffineMatrix@CMILMatrix@@QEAAXMMMMMM@Z.c)
