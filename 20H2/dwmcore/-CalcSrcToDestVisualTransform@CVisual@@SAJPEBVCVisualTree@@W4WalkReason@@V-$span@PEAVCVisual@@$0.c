/*
 * XREFs of ?CalcSrcToDestVisualTransform@CVisual@@SAJPEBVCVisualTree@@W4WalkReason@@V?$span@PEAVCVisual@@$0?0@gsl@@PEAV1@V?$span@PEAVCMILMatrix@@$0?0@5@@Z @ 0x18000D554
 * Callers:
...
LABEL_12:
  ...
  if ( !v9 )
  {
    ...
    {
      v8 = -2003304441;
      MilInstrumentationCheckHR_MaybeFailFast(v16, 0LL, (unsigned int)v7, -2003304441, 0x450u, v7);
      return v8;
    }
    a1 = v34;
    v9 = 1;
