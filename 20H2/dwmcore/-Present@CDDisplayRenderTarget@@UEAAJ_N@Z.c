/*
 * XREFs of ?Present@CDDisplayRenderTarget@@UEAAJ_N@Z @ 0x18018BD20
 * Callers:
 *     ?Present@CDDisplayRenderTarget@@$4PPPPPPPM@A@EAAJ_N@Z @ 0x1800EF440 (-Present@CDDisplayRenderTarget@@$4PPPPPPPM@A@EAAJ_N@Z.c)
 * Callees:
 ...
 *     ?CheckForOcclusionChange@CDDisplayRenderTarget@@IEAAXJ@Z @ 0x1800E8F84 (-CheckForOcclusionChange@CDDisplayRenderTarget@@IEAAXJ@Z.c)
 *     ?GetDirtyRects@CDDisplaySwapChain@@UEBAIPEAV?$vector@UtagRECT@@V?$allocator@UtagRECT@@@std@@@std@@@Z @ 0x1800E8FC0 (-GetDirtyRects@CDDisplaySwapChain@@UEBAIPEAV-$vector@UtagRECT@@V-$allocator@UtagRECT@@@std@@@std.c)
 ...
 *     ?IsPrimaryMonitor@CDDisplayRenderTarget@@UEBA_NXZ @ 0x18016F730 (-IsPrimaryMonitor@CDDisplayRenderTarget@@UEBA_NXZ.c)
 ...
 *     ?GetOutstandingFrameCount@CDDisplayRenderTarget@@UEBAIPEAI@Z @ 0x18018BBB0 (-GetOutstandingFrameCount@CDDisplayRenderTarget@@UEBAIPEAI@Z.c)
 */
