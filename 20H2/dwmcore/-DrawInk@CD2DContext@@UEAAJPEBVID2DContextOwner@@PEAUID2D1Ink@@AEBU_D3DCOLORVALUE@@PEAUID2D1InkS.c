/*
 * XREFs of ?DrawInk@CD2DContext@@UEAAJPEBVID2DContextOwner@@PEAUID2D1Ink@@AEBU_D3DCOLORVALUE@@PEAUID2D1InkStyle@@W4D2D1_ANTIALIAS_MODE@@W4D2D1_PRIMITIVE_BLEND@@@Z @ 0x180238D70
 * Callers:
        ...
        enum D2D1_PRIMITIVE_BLEND a7)
{
  ...
  (*(void (__fastcall **)(_QWORD, const struct _D3DCOLORVALUE *))(**((_QWORD **)this + 45) + 64LL))(
    *((_QWORD *)this + 45),
    a4);
  (*(void (__fastcall **)(_QWORD, struct ID2D1Ink *, _QWORD, struct ID2D1InkStyle *))(**((_QWORD **)this + 30) + 816LL))(
    *((_QWORD *)this + 30),
    a3,
    *((_QWORD *)this + 45),
    a5);
