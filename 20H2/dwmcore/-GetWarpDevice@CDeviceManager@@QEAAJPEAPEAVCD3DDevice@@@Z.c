/*
 * XREFs of ?GetWarpDevice@CDeviceManager@@QEAAJPEAPEAVCD3DDevice@@@Z @ 0x180235FBC
 * Callers:
...
__int64 __fastcall CDeviceManager::GetWarpDevice(CDeviceManager *this, struct CD3DDevice **a2)
{
  ...
  *a2 = 0LL;
  ...
  v10 = Device;
  if ( Device < 0 )
    MilInstrumentationCheckHR_MaybeFailFast(v9, &dword_1802EDC28, 2u, Device, 0xF5u, 0LL);
  v2 = v10;
LABEL_9:
