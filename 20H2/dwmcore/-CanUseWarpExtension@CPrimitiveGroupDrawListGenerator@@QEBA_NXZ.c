/*
 * XREFs of ?CanUseWarpExtension@CPrimitiveGroupDrawListGenerator@@QEBA_NXZ @ 0x1802668A4
 * Callers:
 ...
 *     ??$IsTranslateAndScale@$0A@@CMILMatrix@@AEBA_NXZ @ 0x18020E260 (--$IsTranslateAndScale@$0A@@CMILMatrix@@AEBA_NXZ.c)
 */
