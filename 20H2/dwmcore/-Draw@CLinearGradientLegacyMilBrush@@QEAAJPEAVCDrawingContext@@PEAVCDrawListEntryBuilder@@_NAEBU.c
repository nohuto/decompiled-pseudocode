/*
 * XREFs of ?Draw@CLinearGradientLegacyMilBrush@@QEAAJPEAVCDrawingContext@@PEAVCDrawListEntryBuilder@@_NAEBUMilRectF@@@Z @ 0x1801B4A84
 * Callers:
 ...
 *     ??$GetGradientColorData@VCLinearGradientLegacyMilBrush@@@CGradientLegacyMilBrush@@KAJPEAVCLinearGradientLegacyMilBrush@@PEAVCGradientColorData@@@Z @ 0x1801B4814 (--$GetGradientColorData@VCLinearGradientLegacyMilBrush@@@CGradientLegacyMilBrush@@KAJPEAVCLinear.c)
  ...
  *(_OWORD *)v48 = *(_OWORD *)a5;
  if ( operator!=((float *)this + 14, (float *)v48) || memcmp_0((char *)this + 160, (char *)this + 72, 0x58uLL) )
  {
    ...
    *((float *)v48 + 1) = v14;
    ...
    ((void (__fastcall *)(_QWORD, void *, _DWORD *))xmmword_1803431A0)(
      *((_QWORD *)this + 31) + SDWORD2(xmmword_1803431A0),
      &CLinearGradientBrush::sc_StartPoint,
      v41);
    ((void (__fastcall *)(_QWORD, void *, struct CGeometryOnlyDrawListBrush **))xmmword_1803431D8)(
      *((_QWORD *)this + 31) + SDWORD2(xmmword_1803431D8),
      &CLinearGradientBrush::sc_EndPoint,
      v48);
    v17 = *((_QWORD *)&v42[1] + 1);
    v18 = *((_QWORD *)this + 32) + SDWORD2(xmmword_180342C98);
    v47[0].width = *(FLOAT *)*((_DWORD **)&v42[1] + 1);
    ((void (__fastcall *)(__int64, void *, struct D2D_SIZE_F *))xmmword_180342C98)(
      v18,
      &CColorGradientStop::sc_Offset,
      v47);
    v19 = *(const __m128i **)&v42[0];
    v20 = *((_QWORD *)this + 32) + SDWORD2(xmmword_180342CD0);
    ...
    ((void (__fastcall *)(__int64, void *, struct D2D_SIZE_F *))xmmword_180342CD0)(
      v20,
      &CColorGradientStop::sc_Color,
      v47);
    v22 = *((_QWORD *)this + 33) + SDWORD2(xmmword_180342C98);
    ...
    v24 = *((_QWORD *)this + 33) + SDWORD2(xmmword_180342CD0);
  ...
  else
  {
    ...
    *(_OWORD *)(*(_QWORD *)&v34 + 32LL) = *(_OWORD *)v48;
    v35 = *((_QWORD *)this + 31);
    v43[0] = v47[0];
    DrawList = (*(__int64 (__fastcall **)(__int64, _BYTE *))(*(_QWORD *)v35 + 328LL))(v35, v50);
    v10 = DrawList;
    if ( DrawList < 0 )
    {
      v40 = 91;
