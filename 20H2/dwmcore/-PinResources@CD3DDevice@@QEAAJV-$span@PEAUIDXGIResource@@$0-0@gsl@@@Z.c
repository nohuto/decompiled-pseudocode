/*
 * XREFs of ?PinResources@CD3DDevice@@QEAAJV?$span@PEAUIDXGIResource@@$0?0@gsl@@@Z @ 0x18023D518
 * Callers:
...
__int64 __fastcall CD3DDevice::PinResources(__int64 a1, unsigned __int64 *a2)
{
  ...
  if ( v2 < 0 )
  {
    MilInstrumentationCheckHR_MaybeFailFast(a1, &dword_180303858, 2u, v2, 0xF2Du, 0LL);
  }
  else
  {
    if ( *(_DWORD *)a2 )
...
LABEL_10:
    ...
    if ( (v3 - v6) >> 3 )
    {
      ...
      v2 = v12;
      if ( v12 < 0 )
        MilInstrumentationCheckHR_MaybeFailFast(v13, &dword_180303858, 2u, v12, 0xF4Fu, 0LL);
    }
  }
