/*
 * XREFs of ?ApplyConfiguration@COverlayContext@@QEAAJPEAV?$vector@PEBVCVisual@@V?$allocator@PEBVCVisual@@@std@@@std@@PEA_N1@Z @ 0x18009CE4C
 * Callers:
...
LABEL_70:
      ...
      *((_QWORD *)this + 1412) = v33;
      ...
      v10 = v36;
      if ( v36 < 0 )
        MilInstrumentationCheckHR_MaybeFailFast(v34, 0LL, 0, v36, 0x278u, 0LL);
      if ( v10 == -2005532292 )
      {
        COverlayContext::ClearDirectFlip(this);
        v10 = 0;
...
LABEL_9:
  ...
  v14 = *((_BYTE *)this + 11431);
  if ( !*((_BYTE *)this + 11432) && !v14 )
  {
    v14 = 0;
    v8 = 0;
  }
