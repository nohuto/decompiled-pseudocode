/*
 * XREFs of ?SetOriginOffsetProperty@CRadialGradientBrush@@AEAAJPEBUAnimatedProperty@AnimationHelper@@PEBX@Z @ 0x1801E7780
 * Callers:
 *     <none>
 * Callees:
 ...
 *     ?IsCenteredGradient@CRadialGradientBrush@@AEBA_NXZ @ 0x1801E762C (-IsCenteredGradient@CRadialGradientBrush@@AEBA_NXZ.c)
