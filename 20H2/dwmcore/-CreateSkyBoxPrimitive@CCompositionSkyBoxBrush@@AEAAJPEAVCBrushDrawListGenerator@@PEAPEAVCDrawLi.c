/*
 * XREFs of ?CreateSkyBoxPrimitive@CCompositionSkyBoxBrush@@AEAAJPEAVCBrushDrawListGenerator@@PEAPEAVCDrawListPrimitive@@@Z @ 0x1801BB2D4
 * Callers:
        ...
        struct CDrawListPrimitive **a3)
{
  ...
  else
  {
    for ( i = 0; i < 6; ++i )
    {
      v10 = *((_DWORD *)this + 28);
      if ( _bittest(&v10, i) )
        DynArray<unsigned short,0>::AddMultipleAndSet((__int64)&v25, (__int64 *)((char *)&unk_180301A80 + 12 * i));
    }
    ...
    v13 = (const struct MilPoint4F *)&unk_1803019F0;
    v14 = 8LL;
    do
    {
