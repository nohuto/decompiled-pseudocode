/*
 * XREFs of ?HrCreateBitmapFromMemoryEx@@YAJIIAEBUPixelFormatInfo@@IIPEAEPEAUIUnknown@@PEAPEAVIBitmapSource@@@Z @ 0x18003EE28
 * Callers:
 ...
 * Callees:
 *     ??0CClientMemoryBitmap@@QEAA@XZ @ 0x18003EBF8 (--0CClientMemoryBitmap@@QEAA@XZ.c)
