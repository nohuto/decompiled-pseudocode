/*
 * XREFs of ?EtwLogCurrentState@CDrawingContext@@QEBAXXZ @ 0x1800B6CC4
 * Callers:
 ...
 *     McTemplateU0ppffffubr6q_EventWriteTransfer @ 0x1801787D8 (McTemplateU0ppffffubr6q_EventWriteTransfer.c)
 */
