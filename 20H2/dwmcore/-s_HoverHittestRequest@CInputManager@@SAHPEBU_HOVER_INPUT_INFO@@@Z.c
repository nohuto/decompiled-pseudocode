/*
 * XREFs of ?s_HoverHittestRequest@CInputManager@@SAHPEBU_HOVER_INPUT_INFO@@@Z @ 0x18001D4A8
 * Callers:
...
_BOOL8 __fastcall CInputManager::s_HoverHittestRequest(const struct _HOVER_INPUT_INFO *a1)
{
  ...
  if ( CInputManager::s_pInputManager )
  {
    ...
    if ( v1 < 0 )
    {
      MilInstrumentationCheckHR_MaybeFailFast(v7, &dword_1802D9E90, 2u, v1, 0x17Eu, 0LL);
    }
    else
    {
      ...
      if ( v8 < 0 )
      {
        MilInstrumentationCheckHR_MaybeFailFast(v9, &dword_1802D9E90, 2u, v8, 0x181u, 0LL);
      }
      else
      {
        ...
        v1 = v10;
        if ( v10 < 0 )
          MilInstrumentationCheckHR_MaybeFailFast(v11, &dword_1802D9E90, 2u, v10, 0x18Bu, 0LL);
