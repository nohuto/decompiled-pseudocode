/*
 * XREFs of ?Initialize@CScrollAnimation@@IEAAJPEAVCInteractionTracker@@W4ScrollAxis@@@Z @ 0x180201108
 * Callers:
 ...
 *     ?InsertMaskElement@VectorSubchannelMaskInfo@@QEAAJE@Z @ 0x18021CA2C (-InsertMaskElement@VectorSubchannelMaskInfo@@QEAAJE@Z.c)
 */
