/*
 * XREFs of ?UpdateBackBufferTextureTarget@CDDisplaySwapChain@@IEAAJXZ @ 0x1802381B0
 * Callers:
...
__int64 __fastcall CDDisplaySwapChain::UpdateBackBufferTextureTarget(CDDisplaySwapChain *this)
{
  ...
  if ( v7 )
  {
    ...
    *v1 = 0LL;
    ...
    {
      MilInstrumentationCheckHR_MaybeFailFast(v11, &dword_1802EDC28, 2u, DeviceTextureTarget, 0x96u, 0LL);
    }
    else
    {
  ...
  {
    v12 = -2003304307;
    MilInstrumentationCheckHR_MaybeFailFast(v3, &dword_1802EDC28, 2u, -2003304307, 0x9Cu, 0LL);
  }
  return v12;
}
