/*
 * XREFs of ?BuildPolygon@Mesh@@AEAAJPEBUD2D_POINT_2F@@PEBW4D2D1_EDGE_FLAGS@@HAEBU_D3DCOLORVALUE@@@Z @ 0x18019F94C
 * Callers:
 ...
 *     ?AllocateVertex@Mesh@@AEAAJHPEAH@Z @ 0x18019F8D4 (-AllocateVertex@Mesh@@AEAAJHPEAH@Z.c)
