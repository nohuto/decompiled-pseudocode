/*
 * XREFs of ?XMMatrixInverse@DirectX@@YQ?AUXMMATRIX@1@PEAT__m128@@U21@@Z @ 0x1801F7370
 * Callers:
...
__m128 __fastcall DirectX::XMMatrixInverse(__m128 *a1, double a2, double a3, double a4)
{
  ...
  v13 = _mm_sub_ps(
          _mm_mul_ps(_mm_shuffle_ps(v11, v11, 80), _mm_shuffle_ps(v12, v12, 238)),
          _mm_mul_ps(_mm_shuffle_ps(v11, v11, 238), _mm_shuffle_ps(v12, v12, 80)));
  v14 = _mm_sub_ps(
          _mm_mul_ps(_mm_shuffle_ps(v11, v9, 136), _mm_shuffle_ps(v12, v8, 221)),
          _mm_mul_ps(_mm_shuffle_ps(v11, v9, 221), _mm_shuffle_ps(v12, v8, 136)));
  v15 = _mm_sub_ps(
          _mm_mul_ps(_mm_shuffle_ps(v8, v8, 73), _mm_shuffle_ps(_mm_shuffle_ps(v13, v14, 93), v13, 50)),
