/*
 * XREFs of ?DuplicateHandle@CResourceTable@@QEAAJPEAVCChannelContext@@I0I@Z @ 0x180066198
 * Callers:
 ...
 *     McTemplateU0qqqqxxqx_EventWriteTransfer @ 0x180173C74 (McTemplateU0qqqqxxqx_EventWriteTransfer.c)
 */
