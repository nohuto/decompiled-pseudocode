/*
 * XREFs of ?ToggleSuspension@CHolographicManager@@UEAAX_N@Z @ 0x1800D6850
 * Callers:
 *     <none>
 * Callees:
 ...
 *     ?DwmHolographicSuspendRequest_@CompositorTracing@@QEAAX_N@Z @ 0x180250894 (-DwmHolographicSuspendRequest_@CompositorTracing@@QEAAX_N@Z.c)
