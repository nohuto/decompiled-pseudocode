/*
 * XREFs of ?NotifyAnimationStateChanged@CBaseExpression@@AEAAJW4AnimationEventType@@@Z @ 0x180024E90
 * Callers:
 ...
 *     ?GetAnimationLoggingManagerNoRef@CBaseExpression@@IEAAPEAVCAnimationLoggingManager@@XZ @ 0x1801D927C (-GetAnimationLoggingManagerNoRef@CBaseExpression@@IEAAPEAVCAnimationLoggingManager@@XZ.c)
  ...
  if ( CNotificationResource::ShouldNotify((CNotificationResource *)a1) )
  {
    ...
    if ( CBaseExpression::TryGetTargetValue((CBaseExpression *)a1, (struct CExpressionValue *)v67) )
    {
      ...
      if ( v7 )
      {
        ...
        if ( v41 < 0 )
        {
          MilInstrumentationCheckHR_MaybeFailFast(v42, 0LL, 0, v41, 0x57Eu, 0LL);
          if ( !v64 )
            goto LABEL_28;
      ...
      if ( v19 )
      {
        ...
        if ( !v20 )
        {
          ...
          *((_QWORD *)&v54 + 1) = *(unsigned int *)(a1 + 56);
          v16 = CoreUICallSend(v10, &v54, 2LL, 0LL, 6, &unk_1802885C0);
          goto LABEL_25;
        }
        v21 = v20 - 33;
        if ( !v21 )
        ...
        if ( v21 == 161 )
        {
          ...
          *(_QWORD *)&v53 = v29;
          *((_QWORD *)&v53 + 1) = *(unsigned int *)(a1 + 56);
          v16 = CoreUICallSend(v10, &v53, 2LL, 0LL, 8, &unk_1802885CC);
          goto LABEL_25;
        }
LABEL_79:
        v4 = -2147024809;
        MilInstrumentationCheckHR_MaybeFailFast(v9, 0LL, 0, -2147024809, 0x60Au, 0LL);
LABEL_27:
        if ( !v6 )
          goto LABEL_28;
    ...
    else
    {
      if ( v5 != 69 )
      {
        ...
        if ( !v11 )
        {
          ...
          *(_QWORD *)&v54 = v47;
          *((_QWORD *)&v54 + 1) = *(unsigned int *)(a1 + 56);
          v16 = CoreUICallSend(v10, &v54, 2LL, 0LL, 9, &unk_1802885D2);
          goto LABEL_25;
        }
        v12 = v11 - 6;
        if ( !v12 )
        ...
        if ( !v13 )
        {
          ...
          *(_QWORD *)&v53 = v15;
          *((_QWORD *)&v53 + 1) = *(unsigned int *)(a1 + 56);
          v16 = CoreUICallSend(v10, &v53, 2LL, 0LL, 1, &unk_1802885A4);
          goto LABEL_25;
        }
        v33 = v13 - 17;
        if ( !v33 )
        {
          ...
          *(_QWORD *)&v53 = v35;
          *((_QWORD *)&v53 + 1) = *(unsigned int *)(a1 + 56);
          v16 = CoreUICallSend(v10, &v53, 2LL, 0LL, 2, &unk_1802885A8);
          goto LABEL_25;
        }
        if ( v33 == 17 )
        {
...
LABEL_25:
          ...
          if ( (int)(v16 + 0x80000000) < 0 || v16 == -2018375675 )
            ...
            MilInstrumentationCheckHR_MaybeFailFast(0x80000000, 0LL, 0, v16, 0x611u, 0LL);
          goto LABEL_27;
        }
        goto LABEL_79;
      }
