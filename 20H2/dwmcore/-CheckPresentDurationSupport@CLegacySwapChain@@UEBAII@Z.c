/*
 * XREFs of ?CheckPresentDurationSupport@CLegacySwapChain@@UEBAII@Z @ 0x180246B84
 * Callers:
 *     ?CheckPresentDurationSupport@CLegacySwapChain@@$4PPPPPPPM@A@EBAII@Z @ 0x1800F16A0 (-CheckPresentDurationSupport@CLegacySwapChain@@$4PPPPPPPM@A@EBAII@Z.c)
 * Callees:
