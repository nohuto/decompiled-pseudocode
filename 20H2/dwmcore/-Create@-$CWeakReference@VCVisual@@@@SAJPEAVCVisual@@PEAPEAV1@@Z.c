/*
 * XREFs of ?Create@?$CWeakReference@VCVisual@@@@SAJPEAVCVisual@@PEAPEAV1@@Z @ 0x180070208
 * Callers:
 ...
 *     ?Initialize@CExcludeVisualReference@@IEAAJPEAVCVisual@@@Z @ 0x1800DBCA8 (-Initialize@CExcludeVisualReference@@IEAAJPEAVCVisual@@@Z.c)
