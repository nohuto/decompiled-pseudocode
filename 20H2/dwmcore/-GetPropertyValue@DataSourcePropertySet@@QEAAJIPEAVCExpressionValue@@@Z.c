/*
 * XREFs of ?GetPropertyValue@DataSourcePropertySet@@QEAAJIPEAVCExpressionValue@@@Z @ 0x18017FC5C
 * Callers:
        ...
        struct CExpressionValue *a3)
{
  ...
  char v33; // [rsp+30h] [rbp+8h] BYREF
  int v34; // [rsp+38h] [rbp+10h] BYREF

  v34 = a2;
  v5 = *((_QWORD *)this + 6) & std::_Fnv1a_append_bytes((__int64)this, (const unsigned __int8 *const)&v34, 4uLL);
  while ( 1 )
  {
