/*
 * XREFs of ?SetBootstrapProxy@DiagnosticCallbacksManager@@MEAAJPEAVBamoProxy@Bamo@Microsoft@@@Z @ 0x180166C60
 * Callers:
 *     <none>
 * Callees:
