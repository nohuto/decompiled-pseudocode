/*
 * XREFs of ?SolidColorLegacyMilBrushUpdate@CChannel@@UEAAJINAEBU_D3DCOLORVALUE@@III@Z @ 0x1800D0CB0
 * Callers:
 *     <none>
 * Callees:
        ...
        unsigned int a7)
{
  ...
  v10 = a5;
  CChannel::CheckOptionalHandle((__int64)this, a5);
  v11 = a6;
  CChannel::CheckOptionalHandle((__int64)this, a6);
  v12 = a7;
  CChannel::CheckOptionalHandle((__int64)this, a7);
  v13 = *(_OWORD *)&a4->r;
  v17[0] = 504;
  v17[1] = a2;
  v17[3] = v10;
