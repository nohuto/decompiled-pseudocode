/*
 * XREFs of ?PreSubgraph@CHitTestContext@@QEAAJPEBVCVisualTree@@PEA_N@Z @ 0x1800A8E00
 * Callers:
 ...
 *     ?GetBspPolygonListCount@CVisual@@IEBAIXZ @ 0x1801AD054 (-GetBspPolygonListCount@CVisual@@IEBAIXZ.c)
...
LABEL_95:
  ...
  else
  {
    ...
    v37 = updated;
    if ( updated < 0 )
      MilInstrumentationCheckHR_MaybeFailFast((__int64)v39, 0LL, 0, updated, 0x793u, 0LL);
  }
  if ( v37 < 0 )
  {
    MilInstrumentationCheckHR_MaybeFailFast((__int64)v39, 0LL, 0, v37, 0x6DDu, 0LL);
  }
  else
  {
    if ( !v40[7].Blink )
    {
      ...
      v37 = -2003292412;
      MilInstrumentationCheckHR_MaybeFailFast(v63, 0LL, 0, -2003292412, 0x6E2u, 0LL);
...
LABEL_144:
      ...
      if ( v70[7].Blink < (struct _LIST_ENTRY *)v80 )
      {
        ...
        v68 = v81;
        if ( v81 < 0 )
          MilInstrumentationCheckHR_MaybeFailFast((__int64)v69, 0LL, 0, v81, 0x793u, 0LL);
      }
      if ( v68 < 0 )
      {
        MilInstrumentationCheckHR_MaybeFailFast((__int64)v69, 0LL, 0, v68, 0x6DDu, 0LL);
      }
      else
      {
        if ( !v70[7].Blink )
        {
          ...
          v68 = -2003292412;
          MilInstrumentationCheckHR_MaybeFailFast(v82, 0LL, 0, -2003292412, 0x6E2u, 0LL);
          ShapeData = -2003292412;
          goto LABEL_152;
        }
        v68 = 0;
