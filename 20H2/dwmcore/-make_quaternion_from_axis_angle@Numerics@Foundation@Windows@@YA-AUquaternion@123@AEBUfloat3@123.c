/*
 * XREFs of ?make_quaternion_from_axis_angle@Numerics@Foundation@Windows@@YA?AUquaternion@123@AEBUfloat3@123@M@Z @ 0x1801E1474
 * Callers:
 *     ?CopyInstanceFromIndex@CParticleEmitterVisual@@IEAAXII@Z @ 0x1801DEC6C (-CopyInstanceFromIndex@CParticleEmitterVisual@@IEAAXII@Z.c)
