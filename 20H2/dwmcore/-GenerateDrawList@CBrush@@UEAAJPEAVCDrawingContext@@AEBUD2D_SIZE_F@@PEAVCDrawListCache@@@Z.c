/*
 * XREFs of ?GenerateDrawList@CBrush@@UEAAJPEAVCDrawingContext@@AEBUD2D_SIZE_F@@PEAVCDrawListCache@@@Z @ 0x1800640C0
 * Callers:
 *     <none>
 * Callees:
        ...
        struct CDrawListCache *a4)
{
  ...
  __int64 (__fastcall *v9)(CBrush *, struct CDrawingContext *, struct D2D_SIZE_F *, unsigned int *); // rax
  __int64 v10; // rcx
  int v11; // ebx
  ...
  if ( dword_18034827C > *(_DWORD *)(*((_QWORD *)NtCurrentTeb()->ThreadLocalStoragePointer + (unsigned int)tls_index)
                                   + 4LL) )
  {
    Init_thread_header(&dword_18034827C);
    if ( dword_18034827C == -1 )
    {
      dword_180342AA8 = -2147022876;
      Init_thread_footer(&dword_18034827C);
    }
  }
  v8 = *this;
  v25 = &v24;
  v24 = 0LL;
  *(_QWORD *)v26 = 0LL;
  v9 = (__int64 (__fastcall *)(CBrush *, struct CDrawingContext *, struct D2D_SIZE_F *, unsigned int *))*((_QWORD *)v8 + 43);
  v27 = 1;
  ...
  if ( v11 < 0 )
  {
    MilInstrumentationCheckHR_MaybeFailFast(v10, &dword_180342AA0, 3u, v11, 0xB2u, 0LL);
    goto LABEL_11;
  }
  v13 = this[8];
  if ( !v13 )
  {
    ...
    v14 = (*((__int64 (__fastcall **)(CBrushRenderingGraph **, _BYTE *))*this + 41))(this, v32);
    v11 = v14;
    if ( v14 < 0 )
    {
      MilInstrumentationCheckHR_MaybeFailFast(v15, &dword_180342AA0, 3u, v14, 0xB7u, 0LL);
    }
    else
    {
      v28[0] = v24;
      ...
      if ( DrawList >= 0 )
      {
        ...
        {
          v19 -= 8;
          std::unique_ptr<CDrawListBrush>::~unique_ptr<CDrawListBrush>((__int64 (__fastcall ****)(_QWORD, __int64))v19);
          --v18;
        }
        while ( v18 );
        goto LABEL_11;
      }
      MilInstrumentationCheckHR_MaybeFailFast(v17, &dword_180342AA0, 3u, DrawList, 0xBEu, 0LL);
      CDrawListEntryBuilder::~CDrawListEntryBuilder((CDrawListEntryBuilder *)v34);
    }
  ...
  if ( *(int *)(v21 + 624) >= 37632 && !*(_BYTE *)(v21 + 1433) )
  {
    ...
    v11 = v22;
    if ( v22 < 0 )
      MilInstrumentationCheckHR_MaybeFailFast(v23, &dword_180342AA0, 3u, v22, 0xC9u, 0LL);
  }
LABEL_11:
  if ( v24 )
