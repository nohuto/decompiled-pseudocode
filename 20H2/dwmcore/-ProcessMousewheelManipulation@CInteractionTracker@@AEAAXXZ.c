/*
 * XREFs of ?ProcessMousewheelManipulation@CInteractionTracker@@AEAAXXZ @ 0x1801C9BD0
 * Callers:
 ...
 *     ?CalculateScaleAnimationDuration@CInteractionTracker@@AEAAMM@Z @ 0x1801C8034 (-CalculateScaleAnimationDuration@CInteractionTracker@@AEAAMM@Z.c)
 ...
 *     ?HasRunningDefaultPositionAnimation@CInteractionTracker@@QEBA_NXZ @ 0x1801C9478 (-HasRunningDefaultPositionAnimation@CInteractionTracker@@QEBA_NXZ.c)
 *     ?HasRunningDefaultScaleAnimation@CInteractionTracker@@QEBA_NXZ @ 0x1801C9498 (-HasRunningDefaultScaleAnimation@CInteractionTracker@@QEBA_NXZ.c)
