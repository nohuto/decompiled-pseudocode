/*
 * XREFs of ?Create@CColorKeyBitmapRealization@@SAJPEAVIBitmapRealization@@AEBVCColorKey@@PEAPEAV2@@Z @ 0x18025F984
 * Callers:
 ...
 *     ??0CColorKeyBitmapRealization@@QEAA@XZ @ 0x18025F810 (--0CColorKeyBitmapRealization@@QEAA@XZ.c)
