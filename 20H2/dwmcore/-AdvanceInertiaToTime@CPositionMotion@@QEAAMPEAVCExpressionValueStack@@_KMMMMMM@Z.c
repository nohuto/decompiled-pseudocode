/*
 * XREFs of ?AdvanceInertiaToTime@CPositionMotion@@QEAAMPEAVCExpressionValueStack@@_KMMMMMM@Z @ 0x18020C63C
 * Callers:
 ...
 *     ?AdvanceDeltaDueToScale@CPositionMotion@@AEAAXXZ @ 0x18020C5E4 (-AdvanceDeltaDueToScale@CPositionMotion@@AEAAXXZ.c)
 */
