/*
 * XREFs of ?PushTarget@CD2DContext@@UEAAJPEAVID2DContextOwner@@PEAVIDeviceTarget@@@Z @ 0x180081CF0
 * Callers:
 ...
 *     ?Flush@CBatchOptimizer@@QEAAXXZ @ 0x18009A8B8 (-Flush@CBatchOptimizer@@QEAAXXZ.c)
