/*
 * XREFs of ?Optimize@?$ShrinkableReferenceArray@PEAVCBaseDrawListEntry@@@@QEAAXXZ @ 0x1800D6C28
 * Callers:
 *     ?OnEndDraw@CDrawListBatchManager@@IEAAXXZ @ 0x18009D294 (-OnEndDraw@CDrawListBatchManager@@IEAAXXZ.c)
 * Callees:
    ...
    if ( (int)DynArrayImpl<0>::Grow((__int64)v11, 8u, v4, 1, 0LL) >= 0 )
    {
      ...
      if ( v3 > v4 )
      {
        ...
        if ( (_DWORD)v5 )
        {
          ...
          do
          {
            (*(void (__fastcall **)(_QWORD))(**(_QWORD **)(v7 + *(_QWORD *)a1) + 8LL))(*(_QWORD *)(v7 + *(_QWORD *)a1));
            v7 += 8LL;
            --v8;
          }
          while ( v8 );
