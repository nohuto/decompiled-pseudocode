/*
 * XREFs of ?DoTextureUpdates@CHolographicClient@@AEAAXXZ @ 0x18025829C
 * Callers:
 ...
 *     McTemplateU0f_EventWriteTransfer @ 0x180259A3C (McTemplateU0f_EventWriteTransfer.c)
 */
...
LABEL_16:
  if ( (Microsoft_Windows_Dwm_CoreEnableBits & 0x20000) != 0 )
    McTemplateU0xxxx_EventWriteTransfer(v3 - qword_180348D10, &EVTDESC_HOLOGRAPHICCLIENT_TEXTUREUPDATECOUNT);
}
