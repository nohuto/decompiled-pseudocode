/*
 * XREFs of ?PushGpuClipRectInternal@CDrawingContext@@AEAAJPEBVCVisual@@AEBV?$TMilRect_@MUMilRectF@@UMil3DRectF@@UMilPointAndSizeF@@UNotNeeded@RectUniqueness@@@@W4D2D1_ANTIALIAS_MODE@@_N@Z @ 0x1800854AC
 * Callers:
 ...
 *     ?CeilingSat@CFloatFPU@@SAHM@Z @ 0x1800856B4 (-CeilingSat@CFloatFPU@@SAHM@Z.c)
