/*
 * XREFs of ?MarkFullInvalid@CD2DBitmapCache@@QEAAXXZ @ 0x1800C71D4
 * Callers:
 ...
 *     ?MarkFullDirty@CWICBitmapRealization@@UEAAXXZ @ 0x1802609A0 (-MarkFullDirty@CWICBitmapRealization@@UEAAXXZ.c)
