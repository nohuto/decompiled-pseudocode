/*
 * XREFs of _anonymous_namespace_::Compressor::Compress @ 0x1800D1AA0
 * Callers:
 ...
 *     ?_Buy_raw@?$vector@EV?$allocator@E@std@@@std@@AEAAX_K@Z @ 0x1800D1CBC (-_Buy_raw@-$vector@EV-$allocator@E@std@@@std@@AEAAX_K@Z.c)
