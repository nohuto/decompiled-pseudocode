/*
 * XREFs of ?Create@MeshGraph@Mesh@@SAJHHHHPEAPEAU12@@Z @ 0x18006E570
 * Callers:
 ...
 *     ??0MeshLine@Mesh@@QEAA@XZ @ 0x1800DE3F4 (--0MeshLine@Mesh@@QEAA@XZ.c)
 *     ??0MeshVertex@Mesh@@QEAA@XZ @ 0x1800DE40C (--0MeshVertex@Mesh@@QEAA@XZ.c)
