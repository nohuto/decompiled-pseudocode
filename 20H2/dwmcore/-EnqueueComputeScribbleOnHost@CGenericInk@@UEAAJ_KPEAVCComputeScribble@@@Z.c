/*
 * XREFs of ?EnqueueComputeScribbleOnHost@CGenericInk@@UEAAJ_KPEAVCComputeScribble@@@Z @ 0x1801C2110
 * Callers:
 *     <none>
 * Callees:
 ...
 *     McTemplateU0pxqtq_EventWriteTransfer @ 0x1801C2DE0 (McTemplateU0pxqtq_EventWriteTransfer.c)
