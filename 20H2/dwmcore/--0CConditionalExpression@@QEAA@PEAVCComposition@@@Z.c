/*
 * XREFs of ??0CConditionalExpression@@QEAA@PEAVCComposition@@@Z @ 0x1801BC9A4
 * Callers:
 ...
 * Callees:
 *     ??0CBaseExpression@@QEAA@PEAVCComposition@@@Z @ 0x18006DBB8 (--0CBaseExpression@@QEAA@PEAVCComposition@@@Z.c)
