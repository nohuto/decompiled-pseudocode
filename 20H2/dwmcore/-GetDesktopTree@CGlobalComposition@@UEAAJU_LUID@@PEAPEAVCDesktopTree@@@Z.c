/*
 * XREFs of ?GetDesktopTree@CGlobalComposition@@UEAAJU_LUID@@PEAPEAVCDesktopTree@@@Z @ 0x180069990
 * Callers:
        ...
        struct CDesktopTree **a3)
{
  ...
  LowPart = a2.LowPart;
  v6 = -2147023728;
  if ( dword_180348224 > *(_DWORD *)(*((_QWORD *)NtCurrentTeb()->ThreadLocalStoragePointer + (unsigned int)tls_index)
                                   + 4LL) )
  {
    Init_thread_header(&dword_180348224);
    if ( dword_180348224 == -1 )
    {
      dword_180342A9C = -2147023728;
      Init_thread_footer(&dword_180348224);
    }
  }
  *a3 = 0LL;
  ...
  if ( __PAIR64__(HighPart, LowPart) == 0xFFFFFFFE00000000uLL )
  {
    ...
    if ( PrimaryMonitorTarget )
    {
      ...
      v6 = v11;
      if ( v11 < 0 )
        MilInstrumentationCheckHR_MaybeFailFast(v12, &dword_180342A98, 2u, v11, 0xB1u, 0LL);
    }
  }
LABEL_6:
