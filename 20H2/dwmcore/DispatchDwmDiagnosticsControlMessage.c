/*
 * XREFs of DispatchDwmDiagnosticsControlMessage @ 0x18020F904
 * Callers:
 *     McGenControlCallbackV2 @ 0x1800D1850 (McGenControlCallbackV2.c)
 * Callees:
 ...
 *     ?HandleMessage@DwmDiagnosticsControlMessage_0@@SAXPEBU1@@Z @ 0x18020F9E4 (-HandleMessage@DwmDiagnosticsControlMessage_0@@SAXPEBU1@@Z.c)
 */
