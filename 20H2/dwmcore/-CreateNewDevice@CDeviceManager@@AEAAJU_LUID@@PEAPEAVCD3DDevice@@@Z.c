/*
 * XREFs of ?CreateNewDevice@CDeviceManager@@AEAAJU_LUID@@PEAPEAVCD3DDevice@@@Z @ 0x18003B31C
 * Callers:
...
__int64 __fastcall CDeviceManager::CreateNewDevice(CDeviceManager *this, struct _LUID a2, struct CD3DDevice **a3)
{
  ...
  *a3 = 0LL;
  ...
  if ( Adapter < 0 )
  {
    MilInstrumentationCheckHR_MaybeFailFast(v5, &dword_1802D9EC0, 2u, Adapter, 0x42u, 0LL);
    TranslateDXGIorD3DErrorInContext((unsigned int)v6, 4LL, &v12);
    v6 = (int)v12;
  }
  if ( v6 < 0 )
  {
    MilInstrumentationCheckHR_MaybeFailFast(v5, &dword_1802AA538, 2u, v6, 0x134u, 0LL);
  }
  else
  {
    ...
    if ( v7 < 0 )
    {
      MilInstrumentationCheckHR_MaybeFailFast(v8, &dword_1802AA538, 2u, v7, 0x136u, 0LL);
    }
    else
    {
      v9 = (CMILCOMBase **)xmmword_1803485A0;
      if ( *((_QWORD *)&xmmword_1803485A0 + 1) == (_QWORD)xmmword_1803485A0 )
      {
      ...
      {
        v10 = *a3;
        *(_BYTE *)(xmmword_1803485A0 + 8) = 0;
        *v9 = v10;
        if ( v10 )
          CMILCOMBase::InternalAddRef(v10);
        *(_QWORD *)&xmmword_1803485A0 = xmmword_1803485A0 + 16;
      }
