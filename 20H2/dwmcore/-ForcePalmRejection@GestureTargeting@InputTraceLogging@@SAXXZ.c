/*
 * XREFs of ?ForcePalmRejection@GestureTargeting@InputTraceLogging@@SAXXZ @ 0x1802261FC
 * Callers:
...
void __fastcall InputTraceLogging::GestureTargeting::ForcePalmRejection(__int64 a1)
{
  ...
  {
    tlgWriteTransfer_EventWriteTransfer(v1, (unsigned __int8 *)dword_1802E8241, 0LL, 0LL, 2u, &v2);
  }
}
