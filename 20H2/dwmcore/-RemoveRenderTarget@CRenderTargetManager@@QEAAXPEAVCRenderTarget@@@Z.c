/*
 * XREFs of ?RemoveRenderTarget@CRenderTargetManager@@QEAAXPEAVCRenderTarget@@@Z @ 0x1800D9990
 * Callers:
 ...
 *     ?FinalRelease@CRenderTarget@@MEAAXXZ @ 0x1800DB9F0 (-FinalRelease@CRenderTarget@@MEAAXXZ.c)
