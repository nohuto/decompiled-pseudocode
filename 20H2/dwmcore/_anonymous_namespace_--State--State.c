/*
 * XREFs of _anonymous_namespace_::State::State @ 0x18003500C
 * Callers:
 *     ?RunCompositionThread@CConnection@@AEAAJXZ @ 0x18003351C (-RunCompositionThread@CConnection@@AEAAJXZ.c)
 * Callees:
 *     _anonymous_namespace_::FramesReport::FramesReport @ 0x180035E40 (_anonymous_namespace_--FramesReport--FramesReport.c)
