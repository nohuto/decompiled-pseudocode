/*
 * XREFs of dllmain_crt_process_attach @ 0x1800E3008
 * Callers:
 ...
 *     __scrt_initialize_crt @ 0x1800E2D30 (__scrt_initialize_crt.c)
 *     __scrt_is_nonwritable_in_current_image @ 0x1800E2E38 (__scrt_is_nonwritable_in_current_image.c)
 *     __scrt_release_startup_lock @ 0x1800E2ED8 (__scrt_release_startup_lock.c)
 *     __scrt_fastfail @ 0x1800E3710 (__scrt_fastfail.c)
 *     ?__scrt_initialize_type_info@@YAXXZ @ 0x1800E3AD0 (-__scrt_initialize_type_info@@YAXXZ.c)
 *     __scrt_initialize_default_local_stdio_options @ 0x1800E3AF8 (__scrt_initialize_default_local_stdio_options.c)
 *     __scrt_get_dyn_tls_init_callback @ 0x1800E3B1C (__scrt_get_dyn_tls_init_callback.c)
 *     _RTC_Initialize @ 0x1800E3B2C (_RTC_Initialize.c)
 *     _initterm_0 @ 0x1800E3C46 (_initterm_0.c)
 *     _initterm_e_0 @ 0x1800E3C52 (_initterm_e_0.c)
