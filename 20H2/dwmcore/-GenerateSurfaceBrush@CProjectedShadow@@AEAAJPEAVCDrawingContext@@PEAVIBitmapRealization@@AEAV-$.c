/*
 * XREFs of ?GenerateSurfaceBrush@CProjectedShadow@@AEAAJPEAVCDrawingContext@@PEAVIBitmapRealization@@AEAV?$TMilRect_@MUMilRectF@@UMil3DRectF@@UMilPointAndSizeF@@UNotNeeded@RectUniqueness@@@@PEAPEAVCSurfaceBrush@@@Z @ 0x18001E734
 * Callers:
...
LABEL_11:
  ...
  *((_DWORD *)v13 + 22) = 0;
  ...
  LODWORD(v17) = 0;
  ((void (__fastcall *)(char *, void *, CSurfaceBrush **))xmmword_1803433D0)(
    (char *)v13 + SDWORD2(xmmword_1803433D0),
    &CSurfaceBrush::sc_HorizontalAlignment,
    &v17);
  LODWORD(v17) = 0;
  ((void (__fastcall *)(char *, void *, CSurfaceBrush **))xmmword_180343408)(
    (char *)v13 + SDWORD2(xmmword_180343408),
