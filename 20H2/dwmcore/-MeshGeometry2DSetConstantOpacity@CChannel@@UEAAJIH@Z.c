/*
 * XREFs of ?MeshGeometry2DSetConstantOpacity@CChannel@@UEAAJIH@Z @ 0x180150240
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall CChannel::MeshGeometry2DSetConstantOpacity(CChannel *this, unsigned int a2, int a3)
{
  unsigned int v6; // ebx
