/*
 * XREFs of ?RemoveSourceEntry@DataProviderProxy@@QEAAJPEAVBamoDataSourceProxy@@@Z @ 0x1801814A8
 * Callers:
 *     ?OnDisconnected@DataSourceProxy@@MEAAJXZ @ 0x180180020 (-OnDisconnected@DataSourceProxy@@MEAAJXZ.c)
