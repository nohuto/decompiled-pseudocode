/*
 * XREFs of ?Present@CRemoteRenderTarget@@UEAAJ_N@Z @ 0x1800E1364
 * Callers:
 *     ?Present@CRemoteRenderTarget@@$4PPPPPPPM@A@EAAJ_N@Z @ 0x1800EF480 (-Present@CRemoteRenderTarget@@$4PPPPPPPM@A@EAAJ_N@Z.c)
 * Callees:
