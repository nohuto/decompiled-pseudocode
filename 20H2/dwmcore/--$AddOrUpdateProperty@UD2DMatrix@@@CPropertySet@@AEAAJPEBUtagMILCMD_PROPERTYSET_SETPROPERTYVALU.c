/*
 * XREFs of ??$AddOrUpdateProperty@UD2DMatrix@@@CPropertySet@@AEAAJPEBUtagMILCMD_PROPERTYSET_SETPROPERTYVALUE@@PEBUD2DMatrix@@@Z @ 0x1800B8818
 * Callers:
...
LABEL_11:
  ...
  else
  {
    ...
    updated = CPropertySet::UpdateProperty<D2DMatrix>(v9, v7, *(unsigned int *)(v8 + 16));
    v5 = updated;
    if ( updated < 0 )
    {
      v11 = 324;
