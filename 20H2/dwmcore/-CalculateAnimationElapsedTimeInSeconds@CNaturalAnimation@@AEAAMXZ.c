/*
 * XREFs of ?CalculateAnimationElapsedTimeInSeconds@CNaturalAnimation@@AEAAMXZ @ 0x1801D694C
 * Callers:
 ...
 * Callees:
 *     ?ToSeconds@TimeDelta@@QEBAMXZ @ 0x1801D89C8 (-ToSeconds@TimeDelta@@QEBAMXZ.c)
 */
