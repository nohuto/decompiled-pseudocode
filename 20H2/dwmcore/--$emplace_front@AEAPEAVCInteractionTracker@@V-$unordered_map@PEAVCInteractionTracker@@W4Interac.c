...
__int64 __fastcall std::list<std::pair<CInteractionTracker * const,std::unordered_map<CInteractionTracker *,enum InteractionTrackerBindingModeFlags>>>::emplace_front<CInteractionTracker * &,std::unordered_map<CInteractionTracker *,enum InteractionTrackerBindingModeFlags>>(
        __int64 **a1,
        _QWORD *a2,
        __int64 a3)
{
  ...
  v6 = **a1;
  if ( a1[1] == (__int64 *)0x2E8BA2E8BA2E8BALL )
    std::_Xlength_error("list<T> too long");
  v7 = *(_QWORD **)(v6 + 8);
  v8 = (_QWORD *)std::_Allocate<16,std::_Default_allocate_traits,0>(0x58uLL);
  v8[2] = *a2;
