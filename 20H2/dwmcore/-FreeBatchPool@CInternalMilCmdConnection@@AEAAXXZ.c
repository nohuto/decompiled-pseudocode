/*
 * XREFs of ?FreeBatchPool@CInternalMilCmdConnection@@AEAAXXZ @ 0x18004437C
 * Callers:
 *     ?ClearCaches@CInternalMilCmdConnection@@UEAA_NK@Z @ 0x1800C4510 (-ClearCaches@CInternalMilCmdConnection@@UEAA_NK@Z.c)
