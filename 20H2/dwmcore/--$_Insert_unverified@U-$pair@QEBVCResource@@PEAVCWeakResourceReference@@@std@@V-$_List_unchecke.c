        ...
        __int64 a4)
{
  ...
  v15 = *(_QWORD *)(v9 + 8 * v11);
  if ( v15 == qword_180348408 )
  {
    *(_QWORD *)(v9 + 8 * v11) = a4;
    *(_QWORD *)(qword_180348418 + 8 * v11 + 8) = a4;
  }
  else if ( v15 == v12 )
  {
    *(_QWORD *)(v9 + 8 * v11) = a4;
  ...
  else
  {
    ...
    *(_QWORD *)(v9 + 8 * v11 + 8) = *v17;
    if ( v18 != a4 )
      *(_QWORD *)(qword_180348418 + 8 * v11 + 8) = *(_QWORD *)(*(_QWORD *)(qword_180348418 + 8 * v11 + 8) + 8LL);
  }
