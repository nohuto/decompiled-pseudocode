/*
 * XREFs of ??_GCInteractionContextWrapper@@UEAAPEAXI@Z @ 0x18002F970
 * Callers:
 *     ??_ECInteractionContextWrapper@@W7EAAPEAXI@Z @ 0x1800F10B0 (--_ECInteractionContextWrapper@@W7EAAPEAXI@Z.c)
 * Callees:
