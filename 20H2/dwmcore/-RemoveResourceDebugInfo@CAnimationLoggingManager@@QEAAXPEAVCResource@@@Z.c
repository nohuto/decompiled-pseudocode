/*
 * XREFs of ?RemoveResourceDebugInfo@CAnimationLoggingManager@@QEAAXPEAVCResource@@@Z @ 0x1800C0298
 * Callers:
 ...
 *     ?DetachFromChannel@CResource@@UEAAXPEAVCChannelContext@@_N@Z @ 0x1800C8570 (-DetachFromChannel@CResource@@UEAAXPEAVCChannelContext@@_N@Z.c)
