/*
 * XREFs of Windows::Internal::Details::_dynamic_initializer_for___git__ @ 0x180003680
 * Callers:
 *     <none>
 * Callees:
 *     ??0Git@Details@Internal@Windows@@QEAA@XZ @ 0x1800E2724 (--0Git@Details@Internal@Windows@@QEAA@XZ.c)
 */
