/*
 * XREFs of ?PreRender@CComposition@@IEAAJXZ @ 0x18007CE20
 * Callers:
...
__int64 __fastcall CComposition::PreRender(RTL_SRWLOCK *this)
{
  ...
  signed __int32 v157; // [rsp+B8h] [rbp-150h] BYREF
  ...
  struct _EVENT_DATA_DESCRIPTOR v170; // [rsp+170h] [rbp-98h] BYREF
  struct _EVENT_DATA_DESCRIPTOR v171; // [rsp+180h] [rbp-88h] BYREF
  struct _EVENT_DATA_DESCRIPTOR v172; // [rsp+190h] [rbp-78h] BYREF
  struct _EVENT_DATA_DESCRIPTOR v173; // [rsp+1A0h] [rbp-68h] BYREF
  struct _EVENT_DATA_DESCRIPTOR v174; // [rsp+1B0h] [rbp-58h] BYREF
  struct _EVENT_DATA_DESCRIPTOR v175; // [rsp+1C0h] [rbp-48h] BYREF
  ...
  *(_OWORD *)((char *)v169 + 12) = *(_OWORD *)&v2[144].Ptr;
  ...
  v2[44].Ptr = v150;
  if ( DWORD1(v169[1]) )
    dword_180344280 |= 0x40u;
  if ( v10 < 0 )
  {
    MilInstrumentationCheckHR_MaybeFailFast((__int64)v11, &dword_1802D8408, 3u, v10, 0xCB6u, 0LL);
    goto LABEL_161;
  }
  ...
  {
LABEL_216:
    MilInstrumentationCheckHR_MaybeFailFast(v18, &dword_1802D8408, 3u, v10, 0xCB9u, 0LL);
    goto LABEL_161;
  }
  if ( v19 < 0 )
LABEL_31:
  ...
  if ( ::CycleTime )
  {
    ...
    v23 = CycleTime;
    if ( v25 )
      qword_1803442C0 += CycleTime - ::CycleTime;
  }
  ...
  v143 = 0;
  v144 = 0;
  wil::details::ReportUsageToService(&unk_1803487C0, 13330426LL, (v26 >> 8) & 1, (v26 >> 9) & 1, &v143, 0, 3);
  if ( LOBYTE(v2[36].Ptr) )
  {
  ...
  if ( v10 < 0 )
  {
    MilInstrumentationCheckHR_MaybeFailFast(v29, &dword_1802D8408, 3u, v10, 0xCC9u, 0LL);
  }
  else
  {
    v31 = 0LL;
    ...
    if ( ::CycleTime )
    {
      ...
      v31 = v151;
      if ( v33 )
        qword_1803442C8 += v151 - ::CycleTime;
    }
    ::CycleTime = v31;
    v34 = 0LL;
    v35 = (char *)v2[11].Ptr;
    ...
    *((_QWORD *)v35 + 8) = v51;
    ...
    if ( v143 < 0 )
    {
      MilInstrumentationCheckHR_MaybeFailFast((__int64)v40, &dword_1802D8408, 3u, v143, 0xCCEu, 0LL);
    }
    else
    {
      if ( (v55 & 2) != 0 )
      ...
      v61 = (_BYTE *)qword_180348598;
      if ( qword_180348598 != (_QWORD)xmmword_1803485A0 )
      {
        v62 = (_BYTE *)xmmword_1803485A0;
        do
        {
          v63 = 0;
          ...
          if ( qword_180348598 != (_QWORD)xmmword_1803485A0 )
          {
            while ( 1 )
            {
              ...
              if ( __PAIR64__(HIDWORD(v148), (unsigned int)v64) == *(_QWORD *)(*(_QWORD *)v65 + 936LL) )
                break;
              v65 += 16LL;
              if ( v65 == (_QWORD)xmmword_1803485A0 )
                goto LABEL_113;
            }
            if ( !*(_BYTE *)(v66 + 500) && !byte_1803485B0 && *(_DWORD *)(v66 + 496) )
              v63 = 1;
          }
LABEL_113:
      ...
      if ( !v84[132] || v84[133] )
      {
        ...
        if ( ::CycleTime )
        {
          ...
          v103 = v152;
          if ( v105 )
            qword_1803442D0 += v152 - ::CycleTime;
        }
        ::CycleTime = v103;
        v106 = v2[19].Ptr;
        v107 = v106[3];
        ...
        *(_QWORD *)v154 = 0LL;
        if ( ::CycleTime )
        {
          ...
          v125 = *(_QWORD *)v154;
          if ( ThreadCycleTime )
            qword_1803442D8 += *(_QWORD *)v154 - ::CycleTime;
        }
        ::CycleTime = v125;
        if ( v10 < 0 )
          MilInstrumentationCheckHR_MaybeFailFast(v125, &dword_1802D8408, 3u, v10, 0xCF4u, 0LL);
      }
      else
      {
