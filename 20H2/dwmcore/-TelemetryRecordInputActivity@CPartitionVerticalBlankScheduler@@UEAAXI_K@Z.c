        ...
        int a4)
{
  ...
  if ( (unsigned int)dword_180341EB8 > 5 && (qword_180341EC8 & 8) != 0 && (qword_180341ED0 & 8) == qword_180341ED0 )
  {
    ...
    v16 = 8LL;
    v14 = 4LL;
    tlgWriteTransfer_EventWriteTransfer((int)&dword_180341EB8, (int)&dword_1802E165C, 0, 0, 5u, &v12);
  }
