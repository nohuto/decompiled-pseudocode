/*
 * XREFs of ??$WalkSubtree@VCInputSinkContext@@@CVisualTreeIterator@@QEAAJPEBVCVisual@@PEAVCInputSinkContext@@W4WalkReason@@@Z @ 0x18006563C
 * Callers:
 ...
 *     ?GotoParent@?$CGraphWalker@VCVisual@@@@QEAAXPEAPEAVCVisual@@@Z @ 0x1800658CC (-GotoParent@-$CGraphWalker@VCVisual@@@@QEAAXPEAPEAVCVisual@@@Z.c)
...
LABEL_3:
    while ( (*((_BYTE *)v10 + 95) & 2) != 0 || v10 == (struct CVisual *)a2 )
    {
    ...
    {
LABEL_9:
      if ( (*((_BYTE *)v10 + 95) & 2) != 0 || v10 == (struct CVisual *)a2 )
