/*
 * XREFs of ?UpdateVisualProperty@CProjectedShadowCaster@@QEAAXPEBVCVisualTree@@_N@Z @ 0x180011D4C
 * Callers:
        ...
        char a3)
{
  ...
  if ( v8[6] != CurrentFrameId )
  {
    v8[6] = CurrentFrameId;
    v10 = CProjectedShadowCaster::ComputeEffectiveAlpha(this, v18, v17);
    v11 = CVisualTree::_IsInTree(v18, *((const struct CVisual **)this + 7), 1);
    v14 = 0;
    v15 = v17[0];
    if ( *((float *)v8 + 10) != v10 || *((_BYTE *)v8 + 56) != v17[0] || *((_BYTE *)v8 + 57) != v11 )
    {
      *((float *)v8 + 10) = v10;
      v14 = v12;
      *((_BYTE *)v8 + 56) = v15;
    ...
    if ( *((_BYTE *)v8 + 76) != v17[0]
      || COERCE_FLOAT(COERCE_UNSIGNED_INT(*((float *)v8 + 15) - *(float *)&v20) & _xmm) > 0.0000011920929
      || COERCE_FLOAT(COERCE_UNSIGNED_INT(*((float *)v8 + 16) - *((float *)&v20 + 1)) & _xmm) > 0.0000011920929
      || COERCE_FLOAT(COERCE_UNSIGNED_INT(*((float *)v8 + 17) - *((float *)&v20 + 2)) & _xmm) > 0.0000011920929
      || COERCE_FLOAT(COERCE_UNSIGNED_INT(*((float *)v8 + 18) - *((float *)&v20 + 3)) & _xmm) > 0.0000011920929 )
    {
      v16 = v20;
      *((_BYTE *)v8 + 76) = v17[0];
      *(_OWORD *)((char *)v8 + 60) = v16;
