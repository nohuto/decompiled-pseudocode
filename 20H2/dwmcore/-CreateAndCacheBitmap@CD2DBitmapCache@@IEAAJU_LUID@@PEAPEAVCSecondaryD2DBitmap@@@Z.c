/*
 * XREFs of ?CreateAndCacheBitmap@CD2DBitmapCache@@IEAAJU_LUID@@PEAPEAVCSecondaryD2DBitmap@@@Z @ 0x180047BAC
 * Callers:
 ...
 *     ?RemoveResourceNotifier@CD2DResource@@UEAAXPEBVIDeviceResourceNotify@@@Z @ 0x180054CA8 (-RemoveResourceNotifier@CD2DResource@@UEAAXPEBVIDeviceResourceNotify@@@Z.c)
        ...
        struct CSecondaryD2DBitmap **a3)
{
  ...
  *a3 = 0LL;
  ...
  else
  {
    ...
    if ( dword_180348248 > *(_DWORD *)(v13 + 4) )
    {
      Init_thread_header(&dword_180348248);
      if ( dword_180348248 == -1 )
      {
        dword_180348258 = 24;
        qword_180348250 = (__int64)"DWM Sysmem Source Bitmap";
        Init_thread_footer(&dword_180348248);
      }
    }
    if ( dword_180348260 > *(_DWORD *)(v13 + 4) )
    {
      Init_thread_header(&dword_180348260);
      if ( dword_180348260 == -1 )
      {
        dword_180348270 = 23;
        qword_180348268 = (__int64)"DWM Cross-Device Bitmap";
        Init_thread_footer(&dword_180348260);
      }
    }
    ...
    v16 = (const struct D2D_SIZE_U *)(***((__int64 (__fastcall ****)(_QWORD, CD3DDevice **))this + 3))(
                                       *((_QWORD *)this + 3),
                                       &v28);
    v17 = (const struct CResourceTag *)off_1803419D0[0];
    if ( *((_QWORD *)this + 4) )
      v17 = off_1803419D8;
