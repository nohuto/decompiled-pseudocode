/*
 * XREFs of ?ProcessFreeze@CVisualSurface@@QEAAJPEAVCResourceTable@@PEBUtagMILCMD_VISUALSURFACE_FREEZE@@@Z @ 0x1801F1B4C
 * Callers:
        ...
        const struct tagMILCMD_VISUALSURFACE_FREEZE *a3)
{
  ...
  *(_BYTE *)(v9 + 1800) = 1;
  ...
  if ( v10 >= 0 )
    return 0LL;
  MilInstrumentationCheckHR_MaybeFailFast(v11, 0LL, 0, v10, 0x137u, 0LL);
  wil::details::in1diag3::Return_Hr(
    retaddr,
    (void *)0x108,
    (__int64)"onecoreuap\\windows\\dwm\\dwmcore\\resources\\visualsurface.cpp",
