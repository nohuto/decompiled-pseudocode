 ...
 * Callers:
 *     ?FirstFrameRenderGlitch@InteractionTraceProvider@@SAXAEBUTouchScenarioInfo@CTelemetryTouchLatencyAnalysis@@_KI@Z @ 0x18015D964 (-FirstFrameRenderGlitch@InteractionTraceProvider@@SAXAEBUTouchScenarioInfo@CTelemetryTouchLatenc.c)
 *     ?SteadyStateFrameRenderGlitch@InteractionTraceProvider@@SAXAEBUTouchScenarioInfo@CTelemetryTouchLatencyAnalysis@@_KI@Z @ 0x180160A08 (-SteadyStateFrameRenderGlitch@InteractionTraceProvider@@SAXAEBUTouchScenarioInfo@CTelemetryTouch.c)
 * Callees:
        ...
        __int64 a24)
{
  ...
  v37 = 4LL;
  v35 = 4LL;
  return tlgWriteTransfer_EventWriteTransfer((__int64)&dword_180341EB8, a2, 0LL, 0LL, 0x16u, &v33);
}
