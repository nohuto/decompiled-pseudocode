/*
 * XREFs of ?MarkFullDirty@CSectionBitmapRealization@@UEAAXXZ @ 0x180264674
 * Callers:
 *     ?MarkFullDirty@CSectionBitmapRealization@@$4PPPPPPPM@A@EAAXXZ @ 0x1800F29C0 (-MarkFullDirty@CSectionBitmapRealization@@$4PPPPPPPM@A@EAAXXZ.c)
 *     ?MarkFullDirty@CSectionBitmapRealization@@$4PPPPPPPM@CA@EAAXXZ @ 0x1800F29D0 (-MarkFullDirty@CSectionBitmapRealization@@$4PPPPPPPM@CA@EAAXXZ.c)
 *     ?MarkFullDirty@CSectionBitmapRealization@@$4PPPPPPPM@EA@EAAXXZ @ 0x1800F2BB0 (-MarkFullDirty@CSectionBitmapRealization@@$4PPPPPPPM@EA@EAAXXZ.c)
 * Callees:
