/*
 * XREFs of ?RunShader@CSurfaceShaderComposer@@QEAAJPEBXIPEAPEAUID3D11ShaderResourceView@@IAEBUD3D11_VIEWPORT@@W4Enum@BlendMode@@AEBV?$span@USamplerMode@@$0?0@gsl@@_NPEAUID3D11RenderTargetView@@PEAUID3D11PixelShader@@PEBUtagRECT@@5@Z @ 0x180245974
 * Callers:
        ...
        char a13)
{
  ...
  v50 = a1;
  v48 = 0LL;
  v18 = *(int (__fastcall ****)(_QWORD, GUID *, __int64 *))(v17 + 600);
  v58 = 0LL;
  v47 = 0LL;
  if ( v16 )
  {
    ...
    std::vector<CDataSourceReader *>::_Reallocate_exactly((__int64)&v47, v16);
    v16 = *a8;
    v13 = v48;
  }
  v19 = a8[1];
  ...
  if ( v19 != v21 )
  {
    while ( 1 )
    {
      ...
      v43 = *(_WORD *)v19;
      v44 = *(_BYTE *)(v19 + 2);
      D3DSamplerStateNoRef = CD3DDevice::GetD3DSamplerStateNoRef(v22, (unsigned __int8 *)&v43, &v52);
      v25 = D3DSamplerStateNoRef;
      if ( D3DSamplerStateNoRef < 0 )
        break;
      if ( v13 == v20 )
      {
        std::vector<CVisual const *>::_Emplace_reallocate<CVisual const *>((__int64 *)&v47, v20, &v52);
        v13 = v48;
        v20 = (char *)*((_QWORD *)&v47 + 1);
      }
      else
    ...
    MilInstrumentationCheckHR_MaybeFailFast(v24, 0LL, 0, D3DSamplerStateNoRef, 0x10Au, 0LL);
    goto LABEL_27;
  }
LABEL_11:
  v26 = v53;
  ...
  v31(v18, (GUID *)v15[12], (__int64 *)&v46);
  if ( a9 )
  {
    v32 = **v18;
  ...
  if ( v33 < 0 )
  {
    MilInstrumentationCheckHR_MaybeFailFast(v34, 0LL, 0, v33, 0x12Eu, 0LL);
LABEL_27:
    v41 = (void *)v47;
    goto LABEL_28;
  }
