/*
 * XREFs of ?AddVisualTreeDataToList@CVisual@@IEAAXPEAVCVisualTreeData@@@Z @ 0x1800C4DFC
 * Callers:
 *     ?Link@CVisualTreeData@@MEAAXXZ @ 0x1800C4DA0 (-Link@CVisualTreeData@@MEAAXXZ.c)
 * Callees:
