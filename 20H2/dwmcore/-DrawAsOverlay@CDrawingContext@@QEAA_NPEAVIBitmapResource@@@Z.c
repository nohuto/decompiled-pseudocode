/*
 * XREFs of ?DrawAsOverlay@CDrawingContext@@QEAA_NPEAVIBitmapResource@@@Z @ 0x18007389C
 * Callers:
 ...
 * Callees:
 *     ?IsNormalDesktopRender@CDrawingContext@@QEBA_NXZ @ 0x18001B844 (-IsNormalDesktopRender@CDrawingContext@@QEBA_NXZ.c)
 ...
 *     ?IsInLayer@CDrawingContext@@QEBA_NXZ @ 0x1801774B4 (-IsInLayer@CDrawingContext@@QEBA_NXZ.c)
 ...
 *     ?IsOverlayAssigned@COverlayContext@@QEAA_NPEBVCVisual@@U_LUID@@PEA_NPEAUtagRECT@@3@Z @ 0x18017C630 (-IsOverlayAssigned@COverlayContext@@QEAA_NPEBVCVisual@@U_LUID@@PEA_NPEAUtagRECT@@3@Z.c)
