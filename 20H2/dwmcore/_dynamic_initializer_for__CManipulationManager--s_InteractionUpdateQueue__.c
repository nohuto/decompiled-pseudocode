/*
 * XREFs of _dynamic_initializer_for__CManipulationManager::s_InteractionUpdateQueue__ @ 0x180003560
 * Callers:
 *     <none>
 * Callees:
 *     ??0?$CQueue@PEAUInteractionUpdate@CManipulationManager@@@@QEAA@XZ @ 0x1800DB0A8 (--0-$CQueue@PEAUInteractionUpdate@CManipulationManager@@@@QEAA@XZ.c)
 */
