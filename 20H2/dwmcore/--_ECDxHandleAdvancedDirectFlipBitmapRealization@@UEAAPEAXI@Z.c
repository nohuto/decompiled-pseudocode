/*
 * XREFs of ??_ECDxHandleAdvancedDirectFlipBitmapRealization@@UEAAPEAXI@Z @ 0x180260C70
 * Callers:
 *     ??_ECDxHandleAdvancedDirectFlipBitmapRealization@@WBCA@EAAPEAXI@Z @ 0x1800F2F40 (--_ECDxHandleAdvancedDirectFlipBitmapRealization@@WBCA@EAAPEAXI@Z.c)
 * Callees:
