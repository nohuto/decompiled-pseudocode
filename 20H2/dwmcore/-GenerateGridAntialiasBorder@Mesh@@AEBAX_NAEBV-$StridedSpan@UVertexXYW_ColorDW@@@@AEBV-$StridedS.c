/*
 * XREFs of ?GenerateGridAntialiasBorder@Mesh@@AEBAX_NAEBV?$StridedSpan@UVertexXYW_ColorDW@@@@AEBV?$StridedSpan@UVertexAAFixupBase@@@@PEAHPEAGH3@Z @ 0x1800BB7C4
 * Callers:
 ...
 * Callees:
 *     OffsetBaseVertices @ 0x1800BBD6C (OffsetBaseVertices.c)
 *     CopyBaseVertices @ 0x1800BBE24 (CopyBaseVertices.c)
