/*
 * XREFs of ?SetProperty@CSpriteVectorShape@@UEAAJIW4DCOMPOSITION_EXPRESSION_TYPE@@PEBX@Z @ 0x1801ED140
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall CSpriteVectorShape::SetProperty(__int64 a1, int a2, int a3)
{
  ...
  {
    v9 = -2147024809;
    MilInstrumentationCheckHR_MaybeFailFast(v5, 0LL, 0, -2147024809, 0x2Du, 0LL);
  }
  return v9;
}
