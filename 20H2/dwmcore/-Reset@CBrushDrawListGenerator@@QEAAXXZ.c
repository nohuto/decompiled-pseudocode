/*
 * XREFs of ?Reset@CBrushDrawListGenerator@@QEAAXXZ @ 0x18009F5E8
 * Callers:
 ...
 *     ?GetBrushParameters@CColorBrush@@UEBAJPEAVCBrushDrawListGenerator@@@Z @ 0x1800CE5D0 (-GetBrushParameters@CColorBrush@@UEBAJPEAVCBrushDrawListGenerator@@@Z.c)
