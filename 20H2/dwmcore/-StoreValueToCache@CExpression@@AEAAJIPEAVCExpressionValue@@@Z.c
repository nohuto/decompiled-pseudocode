/*
 * XREFs of ?StoreValueToCache@CExpression@@AEAAJIPEAVCExpressionValue@@@Z @ 0x180067D00
 * Callers:
...
LABEL_32:
    v8 = -2147024809;
    MilInstrumentationCheckHR_MaybeFailFast(v14, 0LL, 0, -2147024809, 0x5ABu, 0LL);
    return v8;
  }
