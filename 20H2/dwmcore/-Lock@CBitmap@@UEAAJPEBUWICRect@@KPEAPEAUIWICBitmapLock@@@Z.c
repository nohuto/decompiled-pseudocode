/*
 * XREFs of ?Lock@CBitmap@@UEAAJPEBUWICRect@@KPEAPEAUIWICBitmapLock@@@Z @ 0x1802155D0
 * Callers:
 *     <none>
 * Callees:
        ...
        struct IWICBitmapLock **a4)
{
  ...
  if ( a2 )
  {
    if ( a4 )
    {
      v10 = (*((__int64 (__fastcall **)(HANDLE *, const struct WICRect *, _QWORD, __int64 *))this[-1].OwningThread + 3))(
              &this[-1].OwningThread,
              a2,
              a3,
              &v15);
