/*
 * XREFs of ?ReportUsage@?$FeatureImpl@U__WilFeatureTraits_Feature_ExpressionKeyframePerFrameSampling@@@details@wil@@QEAAX_NW4ReportingKind@3@_K@Z @ 0x1800EA850
 * Callers:
 *     ?PrepareForCalculation@CExpression@@MEAAXPEA_N@Z @ 0x18002D830 (-PrepareForCalculation@CExpression@@MEAAXPEA_N@Z.c)
 * Callees:
