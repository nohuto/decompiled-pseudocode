/*
 * XREFs of ?ClearRenderTargetMaps@CWindowBackgroundTreatment@@QEAAXXZ @ 0x1800BD584
 * Callers:
 ...
 *     ?InvalidateExistingBounds@CWindowBackgroundTreatment@@QEAAXXZ @ 0x1800C5B30 (-InvalidateExistingBounds@CWindowBackgroundTreatment@@QEAAXXZ.c)
