/*
 * XREFs of ??_ECManipulationTelemetryData@@UEAAPEAXI@Z @ 0x1801C53A8
 * Callers:
 *     ??_ECManipulationTelemetryData@@W7EAAPEAXI@Z @ 0x1800F0950 (--_ECManipulationTelemetryData@@W7EAAPEAXI@Z.c)
 * Callees:
