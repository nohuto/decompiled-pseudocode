/*
 * XREFs of ?TraceUpdatedConfiguration@CInteraction@@QEAAXW4Enum@InteractionConfigurationUpdateType@@W42InteractionInputType@@IPEBX@Z @ 0x18006DA3C
 * Callers:
 ...
 * Callees:
 *     McTemplateU0pqqNR2_EventWriteTransfer @ 0x1801C68B0 (McTemplateU0pqqNR2_EventWriteTransfer.c)
 */
