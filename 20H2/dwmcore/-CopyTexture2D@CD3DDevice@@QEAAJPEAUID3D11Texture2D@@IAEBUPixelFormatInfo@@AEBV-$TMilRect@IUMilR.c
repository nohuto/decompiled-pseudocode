/*
 * XREFs of ?CopyTexture2D@CD3DDevice@@QEAAJPEAUID3D11Texture2D@@IAEBUPixelFormatInfo@@AEBV?$TMilRect@IUMilRectU@@UMil3DRectU@@UNotNeeded@RectUniqueness@@@@PEAVIBitmapDest@@HH@Z @ 0x180051700
 * Callers:
 ...
 *     ?IsEqualPixelFormatInfo@@YA_NAEBUPixelFormatInfo@@0@Z @ 0x180051CBC (-IsEqualPixelFormatInfo@@YA_NAEBUPixelFormatInfo@@0@Z.c)
        ...
        int a8)
{
  ...
  {
    v14 = -2147024809;
    MilInstrumentationCheckHR_MaybeFailFast(v64, &dword_1802D9F28, 0xAu, -2147024809, 0xCAEu, 0LL);
    goto LABEL_17;
  }
  ...
  if ( !*((_QWORD *)a1 + 76) )
  {
    ...
    else
    {
      ...
      *(_OWORD *)v54 = 0LL;
      ...
      if ( v18 >= 0 )
      {
        ...
        if ( v24 < 0 )
        {
          MilInstrumentationCheckHR_MaybeFailFast(v25, &dword_1802D9F28, 0xAu, v24, 0xCF9u, 0LL);
          goto LABEL_16;
        }
        goto LABEL_7;
      }
    ...
    MilInstrumentationCheckHR_MaybeFailFast(v19, &dword_1802D9F28, 0xAu, v18, v45, 0LL);
    goto LABEL_17;
  }
  v47 = 0LL;
  ...
  if ( v32 < 0 )
  {
    MilInstrumentationCheckHR_MaybeFailFast(v33, &dword_1802D9F28, 0xAu, v32, 0xD01u, 0LL);
    v44 = v47;
    if ( !v47 )
      goto LABEL_17;
    goto LABEL_37;
  ...
  if ( v36 < 0 )
  {
    MilInstrumentationCheckHR_MaybeFailFast(v37, &dword_1802D9F28, 0xAu, v36, 0xD13u, 0LL);
    v44 = v34;
LABEL_37:
...
LABEL_7:
  ...
  else
  {
    ...
    else
    {
      ...
      if ( v40 < 0 )
      {
        MilInstrumentationCheckHR_MaybeFailFast(v41, &dword_1802D9F28, 0xAu, v40, 0xD24u, 0LL);
  ...
  v43 = v28;
LABEL_41:
  MilInstrumentationCheckHR_MaybeFailFast(v13, &dword_1802D9F28, 0xAu, v43, v46, 0LL);
LABEL_15:
  if ( (_BYTE)v51 )
LABEL_16:
