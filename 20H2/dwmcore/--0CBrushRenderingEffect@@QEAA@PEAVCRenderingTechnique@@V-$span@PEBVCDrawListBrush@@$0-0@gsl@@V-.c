/*
 * XREFs of ??0CBrushRenderingEffect@@QEAA@PEAVCRenderingTechnique@@V?$span@PEBVCDrawListBrush@@$0?0@gsl@@V?$span@_N$0?0@3@@Z @ 0x18005C27C
 * Callers:
 ...
 *     ??0CDrawListBitmap@@QEAA@XZ @ 0x180064AC0 (--0CDrawListBitmap@@QEAA@XZ.c)
 *     ??0SamplerMode@@QEAA@XZ @ 0x1800DE510 (--0SamplerMode@@QEAA@XZ.c)
