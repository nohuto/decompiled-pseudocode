/*
 * XREFs of ??0?$map@PEAXUDEVICE_INFO@@U?$less@PEAX@std@@V?$allocator@U?$pair@QEAXUDEVICE_INFO@@@std@@@3@@std@@QEAA@XZ @ 0x1800D95F0
 * Callers:
 *     _dynamic_initializer_for__CPointerDeviceCache::s_deviceCache__ @ 0x1800035B0 (_dynamic_initializer_for__CPointerDeviceCache--s_deviceCache__.c)
 * Callees:
