/*
 * XREFs of ?TraceGlitch@CScheduleStatistics@@CAXIPEBVCFrameInfo@@AEB_K1@Z @ 0x1800CCBF8
 * Callers:
 ...
 * Callees:
 *     McTemplateU0xxxtxxxxxxxxqN16_EventWriteTransfer @ 0x180162C4C (McTemplateU0xxxtxxxxxxxxqN16_EventWriteTransfer.c)
 */
