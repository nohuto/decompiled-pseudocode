/*
 * XREFs of ?Unregister@BamoDataProviderRegistrarPrincipalImpl@BamoImpl@@QEAAJI@Z @ 0x18017EBD0
 * Callers:
 *     ?Thunk_Unregister_5@?$IDataProviderRegistrarPrincipal_Receive@VBamoDataProviderRegistrarPrincipalImpl@BamoImpl@@@@SAJPEAXPEAPEAX@Z @ 0x18017EBC0 (-Thunk_Unregister_5@-$IDataProviderRegistrarPrincipal_Receive@VBamoDataProviderRegistrarPrincipa.c)
 * Callees:
