/*
 * XREFs of ?ScheduleCompositionPass@CPartitionVerticalBlankScheduler@@UEAAXKW4CompositionReason@@@Z @ 0x1800BEDE0
 * Callers:
...
LABEL_2:
  ...
  v7 = a3 | dword_180344730;
  result = (unsigned int)~_InterlockedOr(&dword_180344730, a3);
