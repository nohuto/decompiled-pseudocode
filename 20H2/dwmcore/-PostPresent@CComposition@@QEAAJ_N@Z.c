/*
 * XREFs of ?PostPresent@CComposition@@QEAAJ_N@Z @ 0x1800820C0
 * Callers:
...
__int64 __fastcall CComposition::PostPresent(CComposition *this, char a2)
{
  ...
  struct _EVENT_DATA_DESCRIPTOR v137; // [rsp+110h] [rbp+10h] BYREF
  ...
  *((_BYTE *)v2 + 130) = 0;
  ...
  v21 = (__int64 *)xmmword_1803485A0;
  v22 = (__int64 *)qword_180348598;
      ...
      else
      {
        ...
        *(_OWORD *)v128 = 0LL;
        ...
        if ( v128[0] != v128[1] )
        {
          ...
          v57 = v55;
          if ( v55 < 0 )
            MilInstrumentationCheckHR_MaybeFailFast(v56, 0LL, 0, v55, 0xF98u, 0LL);
...
LABEL_134:
        ...
        {
          *(_BYTE *)(v24 + 1434) = 1;
          CD3DDevice::DestroyAllResources((union _SLIST_HEADER *)v24);
        }
        goto LABEL_136;
      }
      if ( *(_BYTE *)(v24 + 1436) )
...
LABEL_147:
            ...
            v76 = (_QWORD *)(xmmword_1803485A0 - 16);
