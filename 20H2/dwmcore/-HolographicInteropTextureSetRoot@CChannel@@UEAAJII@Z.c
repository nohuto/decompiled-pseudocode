/*
 * XREFs of ?HolographicInteropTextureSetRoot@CChannel@@UEAAJII@Z @ 0x18014F940
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall CChannel::HolographicInteropTextureSetRoot(CChannel *this, unsigned int a2, int a3)
{
  unsigned int v6; // ebx
