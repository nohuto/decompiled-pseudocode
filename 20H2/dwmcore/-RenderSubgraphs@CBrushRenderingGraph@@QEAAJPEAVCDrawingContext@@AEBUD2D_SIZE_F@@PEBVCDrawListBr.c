/*
 * XREFs of ?RenderSubgraphs@CBrushRenderingGraph@@QEAAJPEAVCDrawingContext@@AEBUD2D_SIZE_F@@PEBVCDrawListBrush@@PEAVCDrawListCache@@@Z @ 0x180063718
 * Callers:
 ...
 *     ??4EffectInput@@QEAAAEAU0@AEBU0@@Z @ 0x18005CBF4 (--4EffectInput@@QEAAAEAU0@AEBU0@@Z.c)
 ...
 *     ??$emplace_back@$$T@?$vector@UEffectInput@@V?$allocator@UEffectInput@@@std@@@std@@QEAAAEAUEffectInput@@$$QEA$$T@Z @ 0x180065494 (--$emplace_back@$$T@-$vector@UEffectInput@@V-$allocator@UEffectInput@@@std@@@std@@QEAAAEAUEffect.c)
 ...
 *     ?reserve@?$vector@UEffectInput@@V?$allocator@UEffectInput@@@std@@@std@@QEAAX_K@Z @ 0x180065604 (-reserve@-$vector@UEffectInput@@V-$allocator@UEffectInput@@@std@@@std@@QEAAX_K@Z.c)
 ...
 *     ??0EffectStage@@QEAA@XZ @ 0x1800C5AE0 (--0EffectStage@@QEAA@XZ.c)
...
LABEL_9:
  ...
  if ( *((_BYTE *)this + 196) )
  {
    ...
    else
    {
      ...
      {
        v10 = -2003304441;
        MilInstrumentationCheckHR_MaybeFailFast(v72, &dword_1802D9038, 2u, -2003304441, 0x33Eu, 0LL);
        goto LABEL_63;
      }
      width = v5->width;
      v51 = v5->height;
      ...
      if ( BackdropImageFromRenderTarget < 0 )
      {
        v73 = 843;
LABEL_82:
        MilInstrumentationCheckHR_MaybeFailFast(v53, &dword_1802D9038, 2u, BackdropImageFromRenderTarget, v73, 0LL);
        goto LABEL_63;
      }
    }
  }
      ...
      else
      {
        if ( !CBrushRenderingGraph::IsWindowBackdropInput(this, v20) )
        {
          ...
          else
          {
            ...
            if ( v66 < 0 )
            {
              MilInstrumentationCheckHR_MaybeFailFast(v67, &dword_1802D9038, 2u, v66, 0x376u, 0LL);
              goto LABEL_29;
            }
            *(_QWORD *)&v86 = 0LL;
            v68 = v79;
...
LABEL_22:
    ...
    while ( v28 < *(_DWORD *)(*(_QWORD *)(*((_QWORD *)this + 18) + 8 * v29) + 60LL) )
    {
      ...
      {
        MilInstrumentationCheckHR_MaybeFailFast(v31, &dword_1802D9038, 2u, EffectStageInput, 0x406u, 0LL);
        goto LABEL_29;
      }
      ++v116;
      v26 = v76;
    ...
    if ( updated < 0 )
    {
      MilInstrumentationCheckHR_MaybeFailFast((unsigned int)v18, &dword_1802D9038, 2u, updated, 0x40Fu, 0LL);
    }
  ...
  while ( 1 )
  {
    ...
    *((_BYTE *)v40 + 68) = 1;
    ...
    if ( v42 < 0 )
    {
      MilInstrumentationCheckHR_MaybeFailFast(v43, &dword_1802D9038, 2u, v42, 0x3B3u, 0LL);
      goto LABEL_29;
    }
    v116 = 1;
    if ( v117[69] )
...
LABEL_60:
    ...
    if ( v44 < 0 )
    {
      MilInstrumentationCheckHR_MaybeFailFast((unsigned int)v45, &dword_1802D9038, 2u, v44, 0x3BCu, 0LL);
      goto LABEL_29;
    }
LABEL_43:
    v46 = v78;
...
LABEL_56:
    ...
    if ( v71 < 0 )
    {
      MilInstrumentationCheckHR_MaybeFailFast((unsigned int)v45, &dword_1802D9038, 2u, v71, 0x3E3u, 0LL);
      goto LABEL_29;
    }
    goto LABEL_43;
  }
  ...
  MilInstrumentationCheckHR_MaybeFailFast(v57, &dword_1802D9038, 2u, v56, 0x3D0u, 0LL);
LABEL_29:
