/*
 * XREFs of ?Pop@CDrawingContext@@UEAAJXZ @ 0x1800C9730
 * Callers:
 ...
 *     ?PopClippingScope@CDrawingContext@@AEAAX_N@Z @ 0x180177518 (-PopClippingScope@CDrawingContext@@AEAAX_N@Z.c)
...
__int64 __fastcall CDrawingContext::Pop(CDrawingContext *this)
{
  ...
  v6 = v3;
  if ( v3 < 0 )
    MilInstrumentationCheckHR_MaybeFailFast(v4, 0LL, 0, v3, 0x118Du, 0LL);
  if ( (int)v12 > 7 )
  {
    switch ( (_DWORD)v12 )
    {
      ...
      case 0xA:
        ...
        v6 = v10;
        if ( v10 < 0 )
          MilInstrumentationCheckHR_MaybeFailFast(v11, 0LL, 0, v10, 0x179Fu, 0LL);
        if ( v6 < 0 )
          MilInstrumentationCheckHR_MaybeFailFast(v11, 0LL, 0, v6, 0x11B2u, 0LL);
        break;
      case 0xB:
        CWatermarkStack<CDrawingContext::StackStateEntry,64,2,10>::Pop(v1, &v12);
        --*((_DWORD *)this + 212);
  ...
  else if ( (int)v12 >= 6 )
  {
    ...
    v6 = v8;
    if ( v8 < 0 )
      MilInstrumentationCheckHR_MaybeFailFast(v9, 0LL, 0, v8, 0x11A2u, 0LL);
  }
  else
  {
    switch ( (_DWORD)v12 )
