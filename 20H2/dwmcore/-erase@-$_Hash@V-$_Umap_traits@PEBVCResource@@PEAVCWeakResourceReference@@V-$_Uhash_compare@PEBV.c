        ...
        __int64 a3)
{
  ...
  appended = std::_Fnv1a_append_bytes((unsigned __int64)a1, (const unsigned __int8 *const)(a3 + 16), 8uLL);
  v7 = a1[3];
  v8 = 2 * (a1[6] & appended);
  ...
  std::list<std::pair<CResource const * const,CWeakResourceReference *>>::erase(a1 + 1, a2, v6);
  return a2;
}
