/*
 * XREFs of ?Initialize@CTextVisual@@MEAAJXZ @ 0x1801F04B0
 * Callers:
 *     <none>
 * Callees:
 ...
 *     ??0CTextVisualContent@@QEAA@PEAVCTextVisual@@@Z @ 0x1801F02CC (--0CTextVisualContent@@QEAA@PEAVCTextVisual@@@Z.c)
