/*
 * XREFs of ?Create@CSurfaceShaderComposer@@SAJPEAVCD3DDevice@@PEAPEAV1@@Z @ 0x18003A74C
 * Callers:
...
__int64 __fastcall CSurfaceShaderComposer::Create(struct CD3DDevice *a1, struct CSurfaceShaderComposer **a2)
{
  ...
  v7 = v6(v2, &unk_1802CAFD0, 832LL, 0LL, &v22);
  v9 = v7;
  if ( v7 < 0 )
  {
    v18 = 152;
  ...
  v7 = v10(v2, &v28, 3LL, &unk_1802CAFD0, 832LL, &v21);
  v9 = v7;
  if ( v7 < 0 )
  {
    v18 = 161;
