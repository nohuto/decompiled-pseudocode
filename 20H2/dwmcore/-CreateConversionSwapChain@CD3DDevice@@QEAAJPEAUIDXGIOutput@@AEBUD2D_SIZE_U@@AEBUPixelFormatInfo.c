/*
 * XREFs of ?CreateConversionSwapChain@CD3DDevice@@QEAAJPEAUIDXGIOutput@@AEBUD2D_SIZE_U@@AEBUPixelFormatInfo@@AEBVRenderTargetInfo@@PEAPEAVILegacySwapChain@@@Z @ 0x18023B328
 * Callers:
...
LABEL_18:
    v16 = v12;
LABEL_28:
    MilInstrumentationCheckHR_MaybeFailFast(v11, &dword_180303888, 3u, v16, v19, 0LL);
  }
