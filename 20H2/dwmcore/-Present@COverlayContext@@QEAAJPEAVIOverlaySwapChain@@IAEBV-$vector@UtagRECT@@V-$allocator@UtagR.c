/*
 * XREFs of ?Present@COverlayContext@@QEAAJPEAVIOverlaySwapChain@@IAEBV?$vector@UtagRECT@@V?$allocator@UtagRECT@@@std@@@std@@I_N@Z @ 0x1800E6C1C
 * Callers:
 ...
 * Callees:
 *     ?LegacyPresentRequired@COverlayContext@@AEBA_NXZ @ 0x18003C974 (-LegacyPresentRequired@COverlayContext@@AEBA_NXZ.c)
