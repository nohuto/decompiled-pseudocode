/*
 * XREFs of ??_ECHolographicFrameProcessor@@MEAAPEAXI@Z @ 0x180259B78
 * Callers:
 *     ??_ECHolographicFrameProcessor@@O7EAAPEAXI@Z @ 0x1800F2780 (--_ECHolographicFrameProcessor@@O7EAAPEAXI@Z.c)
 * Callees:
