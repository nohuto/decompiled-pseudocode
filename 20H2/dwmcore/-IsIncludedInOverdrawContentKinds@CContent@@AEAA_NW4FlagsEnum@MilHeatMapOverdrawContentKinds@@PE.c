/*
 * XREFs of ?IsIncludedInOverdrawContentKinds@CContent@@AEAA_NW4FlagsEnum@MilHeatMapOverdrawContentKinds@@PEAVCDrawingContext@@@Z @ 0x1801AAF38
 * Callers:
...
bool __fastcall CContent::IsIncludedInOverdrawContentKinds(__int64 a1, int a2, _DWORD *a3)
{
  ...
  if ( a2 != 0xFFFF
    ...
    && ((v4 & 0x20) == 0 || !(*(unsigned __int8 (__fastcall **)(__int64))(*(_QWORD *)a1 + 256LL))(a1))
    && ((v4 & 0x40) == 0 || !(*(unsigned __int8 (__fastcall **)(__int64))(*(_QWORD *)a1 + 264LL))(a1)) )
  {
    if ( (v4 & 1) == 0 )
      return 0;
