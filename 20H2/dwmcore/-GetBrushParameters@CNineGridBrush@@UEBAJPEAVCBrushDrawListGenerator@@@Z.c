/*
 * XREFs of ?GetBrushParameters@CNineGridBrush@@UEBAJPEAVCBrushDrawListGenerator@@@Z @ 0x180008640
 * Callers:
 *     <none>
 * Callees:
 *     ?IsIdentity@CComponentTransform2D@@QEBA_NXZ @ 0x180006458 (-IsIdentity@CComponentTransform2D@@QEBA_NXZ.c)
 *     ?IsIdentity@Matrix3x2F@D2D1@@QEBA_NXZ @ 0x1800089D8 (-IsIdentity@Matrix3x2F@D2D1@@QEBA_NXZ.c)
...
__int64 __fastcall CNineGridBrush::GetBrushParameters(CNineGridBrush *this, struct CBrushDrawListGenerator *a2)
{
  ...
  CNineGridDrawListBrush *v29; // rax
  __int128 v30; // xmm1
  unsigned int v31; // xmm1_4
  unsigned int v32; // xmm0_4
  __int128 v33; // xmm1
  CNineGridDrawListBrush *v34[2]; // [rsp+30h] [rbp-99h] BYREF
  ...
  CNineGridDrawListBrush *v44; // [rsp+B8h] [rbp-11h]
  char v45; // [rsp+DCh] [rbp+13h]

  v4 = -2147022876;
  if ( dword_1803482E8 > *(_DWORD *)(*((_QWORD *)NtCurrentTeb()->ThreadLocalStoragePointer + (unsigned int)tls_index)
                                   + 4LL) )
  {
    Init_thread_header(&dword_1803482E8);
    if ( dword_1803482E8 == -1 )
    {
      dword_180342AE4 = -2147022876;
      Init_thread_footer(&dword_1803482E8);
    }
  }
           ...
           180LL) )
    {
      ...
      if ( v23 )
      {
        if ( !CComponentTransform2D::IsIdentity(v23) )
        {
          ...
          MilInstrumentationCheckHR_MaybeFailFast(v24, &dword_180342AE0, 2u, -2147022876, 0x284u, 0LL);
          goto LABEL_45;
        }
      }
    }
  }
  v10 = (*(__int64 (__fastcall **)(_QWORD, _BYTE *))(**((_QWORD **)this + 10) + 328LL))(*((_QWORD *)this + 10), v41);
  v4 = v10;
  if ( v10 < 0 )
  {
    MilInstrumentationCheckHR_MaybeFailFast(v11, &dword_180342AE0, 2u, v10, 0x289u, 0LL);
LABEL_45:
  ...
  if ( v35[0] )
  {
    if ( *((_BYTE *)v35[0] + 52) )
    {
      ...
      v15 = *((_DWORD *)this + 26);
      HIDWORD(v34[0]) = v14;
      v34[1] = (CNineGridDrawListBrush *)__PAIR64__(*((_DWORD *)this + 28), v15);
      v40 = *(_OWORD *)v34;
    }
    else
    {
      ...
      v32 = *((_DWORD *)a2 + 3);
      *((_BYTE *)v35[0] + 52) = 1;
      v34[1] = (CNineGridDrawListBrush *)__PAIR64__(v32, v31);
      v33 = *(_OWORD *)v34;
  ...
  else
  {
    ...
    *(_OWORD *)((char *)a2 + 20) = v25;
    ...
    if ( v4 < 0 )
    {
      MilInstrumentationCheckHR_MaybeFailFast((unsigned int)v26, &dword_180342AE0, 2u, v4, 0x29Cu, 0LL);
      if ( v34[0] )
  ...
  *((_QWORD *)&v38 + 1) = 0LL;
  ...
  if ( v4 < 0 )
  {
    MilInstrumentationCheckHR_MaybeFailFast((unsigned int)v16, &dword_180342AE0, 2u, v4, 0x2CAu, 0LL);
    if ( v34[0] )
...
LABEL_14:
  ...
  {
    D2D1::Matrix3x2F::SetProduct((D2D1::Matrix3x2F *)&v38, (CNineGridDrawListBrush *)((char *)v8 + 8), v18);
    v19 = v39;
    *(_OWORD *)v20 = v38;
    *(_QWORD *)(v20 + 16) = v19;
  }
