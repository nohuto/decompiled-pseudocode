/*
 * XREFs of ?WaitForVBlank@CHolographicManager@@QEAAJXZ @ 0x180251B88
 * Callers:
 *     ?WaitForVBlank@CHolographicInteropTarget@@UEBAJPEAX@Z @ 0x180255710 (-WaitForVBlank@CHolographicInteropTarget@@UEBAJPEAX@Z.c)
 * Callees:
