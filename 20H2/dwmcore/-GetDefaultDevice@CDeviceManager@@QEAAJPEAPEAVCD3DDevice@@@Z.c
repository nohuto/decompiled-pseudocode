/*
 * XREFs of ?GetDefaultDevice@CDeviceManager@@QEAAJPEAPEAVCD3DDevice@@@Z @ 0x180235F38
 * Callers:
 ...
 *     ?GetDevice@CRemoteAppRenderTarget@@UEAAJPEAPEAVCD3DDevice@@@Z @ 0x180185970 (-GetDevice@CRemoteAppRenderTarget@@UEAAJPEAPEAVCD3DDevice@@@Z.c)
...
__int64 __fastcall CDeviceManager::GetDefaultDevice(CDeviceManager *this, struct CD3DDevice **a2)
{
  ...
  *a2 = 0LL;
  ...
  {
    v4 = -2003304442;
    MilInstrumentationCheckHR_MaybeFailFast((__int64)v3, &dword_1802EDC40, 3u, -2003304442, 0x8Eu, 0LL);
  }
  else
  {
    ...
    v4 = Device;
    if ( Device < 0 )
      MilInstrumentationCheckHR_MaybeFailFast(v6, &dword_1802EDC40, 3u, Device, 0x8Au, 0LL);
  }
  return v4;
}
