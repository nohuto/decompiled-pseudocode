/*
 * XREFs of ?SendCheckProtocol@BamoPeerImpl@DiagnosticCallbacks_AutoBamos@BamoImpl@@UEAAXAEBU_GUID@@@Z @ 0x180166840
 * Callers:
 *     <none>
 * Callees:
        ...
        const struct _GUID *a2)
{
  ...
  v7 = v2;
  v5 = CoreUICallSend(v4, v6, 2LL, 1LL, 0, &unk_1802D72A5);
  if ( v5 < 0 )
  {
