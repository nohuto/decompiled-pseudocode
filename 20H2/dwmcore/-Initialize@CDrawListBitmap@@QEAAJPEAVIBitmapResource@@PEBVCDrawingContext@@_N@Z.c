/*
 * XREFs of ?Initialize@CDrawListBitmap@@QEAAJPEAVIBitmapResource@@PEBVCDrawingContext@@_N@Z @ 0x18005E7F0
 * Callers:
        ...
        const struct CDrawingContext *a3)
{
  ...
  v9 = v7;
  if ( v7 < 0 )
    MilInstrumentationCheckHR_MaybeFailFast(v8, &dword_1802D87B8, 2u, v7, 0x27u, 0LL);
  else
    *((_BYTE *)this + 40) = v6;
  if ( v9 < 0 )
  {
