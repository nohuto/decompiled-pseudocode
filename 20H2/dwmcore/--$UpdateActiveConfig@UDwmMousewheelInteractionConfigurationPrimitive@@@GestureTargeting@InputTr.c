  ...
  if ( *(_DWORD *)v3 > 4u )
  {
    ...
    if ( (result & 0x800) != 0 )
    {
      ...
      if ( result == *(_QWORD *)(v3 + 24) )
      {
        ...
        v5 = "StopInertia";
        if ( (v4 & 0x20000000) == 0 )
          v5 = (const char *)&word_1802CBA06;
        v34 = (__int64)v5;
        v6 = "DisableGestures";
        if ( (v4 & 0x10000000) == 0 )
          v6 = (const char *)&word_1802CBA06;
        v19 = (__int64)v6;
        v7 = "Wheel";
        if ( (v4 & 0x8000) == 0 )
          v7 = (const char *)&word_1802CBA06;
        v20 = (__int64)v7;
        v8 = "Hover";
        if ( (v4 & 0x400) == 0 )
          v8 = (const char *)&word_1802CBA06;
        v21 = (__int64)v8;
        v9 = "Eraser";
        if ( (v4 & 0x200) == 0 )
          v9 = (const char *)&word_1802CBA06;
        v22 = (__int64)v9;
        v10 = "Button";
        if ( (v4 & 0x100) == 0 )
          v10 = (const char *)&word_1802CBA06;
        v23 = (__int64)v10;
        v11 = "Hold";
        if ( (v4 & 0x80u) == 0 )
          v11 = (const char *)&word_1802CBA06;
        v24 = (__int64)v11;
        v12 = "Tap";
        if ( (v4 & 0x40) == 0 )
          v12 = (const char *)&word_1802CBA06;
        v25 = (__int64)v12;
        v13 = "Zoom-";
        if ( (v4 & 0x20) == 0 )
          v13 = (const char *)&word_1802CBA06;
        v26 = (__int64)v13;
        v14 = "Zoom+";
        if ( (v4 & 0x10) == 0 )
          v14 = (const char *)&word_1802CBA06;
        v27 = (__int64)v14;
        v15 = "PanY-";
        if ( (v4 & 8) == 0 )
          v15 = (const char *)&word_1802CBA06;
        v28 = (__int64)v15;
        v16 = "PanY+";
        if ( (v4 & 4) == 0 )
          v16 = (const char *)&word_1802CBA06;
        v29 = (__int64)v16;
        v17 = "PanX-";
        if ( (v4 & 2) == 0 )
          v17 = (const char *)&word_1802CBA06;
        v30 = (__int64)v17;
        v18 = "PanX+";
        if ( (v4 & 1) == 0 )
          v18 = (const char *)&word_1802CBA06;
        v31 = (__int64)v18;
