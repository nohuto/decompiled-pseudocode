/*
 * XREFs of ?RenderForCapture@CaptureBitsResponse@@IEAAJXZ @ 0x18004FCDC
 * Callers:
...
__int64 __fastcall CaptureBitsResponse::RenderForCapture(CaptureBitsResponse *this)
{
  ...
  if ( v9 >= 0 )
  {
    *((_BYTE *)g_pComposition + 1129) = 1;
    ...
    v1 = v32;
    v15 = CDrawingContext::BeginFrame(v32, v14, (const struct CMILMatrix *)v33, &stru_1802AA510, 0LL);
    v11 = v15;
    if ( v15 < 0 )
    {
