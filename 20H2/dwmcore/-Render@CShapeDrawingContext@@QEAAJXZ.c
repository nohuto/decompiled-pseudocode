/*
 * XREFs of ?Render@CShapeDrawingContext@@QEAAJXZ @ 0x18025ED4C
 * Callers:
...
LABEL_88:
      ...
      case 3:
        ...
        else
        {
          ...
          {
            v62 = (__int64)*(v7 - 1);
            v63 = *(__int64 (__fastcall **)(__int64, _QWORD, struct ID2D1StrokeStyle1 **, CGeometryOnlyDrawListBrush **))(*(_QWORD *)v62 + 352LL);
...
LABEL_56:
    ...
    if ( *v5 == 6 )
    {
      ...
      else
      {
        ...
        {
          v13 = (__int64)*(v7 - 1);
          v14 = *(__int64 (__fastcall **)(__int64, _QWORD, struct ID2D1StrokeStyle1 **, CGeometryOnlyDrawListBrush **))(*(_QWORD *)v13 + 352LL);
          Microsoft::WRL::ComPtr<IUnknown>::InternalRelease((__int64 *)&v87);
...
LABEL_58:
  ...
  v35 = (*(__int64 (__fastcall **)(_QWORD, _BYTE *))(*(_QWORD *)*(v7 - 2) + 328LL))(*(v7 - 2), v114);
  if ( v35 < 0 )
  {
