/*
 * XREFs of ?AddToBspPolygonList@CVisual@@IEAAJPEAVCPolygon@@@Z @ 0x1801AC754
 * Callers:
 ...
 *     ?GetBspPolygonList@CVisual@@QEBAPEAV?$DynArray@PEAVCPolygon@@$0A@@@XZ @ 0x1800AA1FC (-GetBspPolygonList@CVisual@@QEBAPEAV-$DynArray@PEAVCPolygon@@$0A@@@XZ.c)
...
LABEL_15:
    ...
    if ( (v8 & 0x80000000) != 0 )
    {
      MilInstrumentationCheckHR_MaybeFailFast(v11, 0LL, 0, v8, 0x16A1u, 0LL);
      return v8;
    }
    goto LABEL_15;
  }
  ...
  v8 = -2147024882;
  MilInstrumentationCheckHR_MaybeFailFast(v7, 0LL, 0, -2147024882, 0x169Du, 0LL);
  return v8;
}
