/*
 * XREFs of ??$TakeItemFromCache@VCStateSettingDrawListEntry@@@CDrawListBatchManager@@CAJPEAV?$ShrinkableReferenceArray@PEAVCStateSettingDrawListEntry@@@@PEAPEAVCStateSettingDrawListEntry@@@Z @ 0x1800148CC
 * Callers:
...
__int64 __fastcall CDrawListBatchManager::TakeItemFromCache<CStateSettingDrawListEntry>(__int64 a1, _QWORD *a2)
{
  ...
  if ( v9 )
  {
    ...
    *((_QWORD *)v9 + 4) = 0LL;
    *((_DWORD *)v9 + 2) = 0;
    *(_QWORD *)v9 = &CStateSettingDrawListEntry::`vftable'{for `CMILRefCountBase'};
    *((_QWORD *)v9 + 2) = &CStateSettingDrawListEntry::`vftable'{for `CBaseDrawListEntry'};
  }
  else
  {
    v11 = 0LL;
