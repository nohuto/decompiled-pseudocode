/*
 * XREFs of ??$insert@V?$_Vector_const_iterator@V?$_Vector_val@U?$_Simple_types@UComputeScribbleLatencyData@@@std@@@std@@@std@@X@?$list@UComputeScribbleLatencyData@@V?$allocator@UComputeScribbleLatencyData@@@std@@@std@@QEAA?AV?$_List_iterator@V?$_List_val@U?$_List_simple_types@UComputeScribbleLatencyData@@@std@@@std@@@1@V?$_List_const_iterator@V?$_List_val@U?$_List_simple_types@UComputeScribbleLatencyData@@@std@@@std@@@1@V?$_Vector_const_iterator@V?$_Vector_val@U?$_Simple_types@UComputeScribbleLatencyData@@@std@@@std@@@1@1@Z @ 0x180162DB0
 * Callers:
        ...
        __int64 a5)
{
  ...
  if ( a4 != a5 )
  {
    ...
    if ( v10 )
    {
      *((_QWORD *)&xmmword_1803483F0 + 1) += v10;
      *(_QWORD *)v8 = a3;
      v11 = *(_QWORD **)(a3 + 8);
      *(_QWORD *)(a3 + 8) = v8;
      a3 = v15;
