/*
 * XREFs of ?ExtractHostInputLatencyArray@CLatencyInfo@CTelemetryTouchLatencyAnalysis@@SAJQEBV12@_KQEAI1@Z @ 0x18015D35C
 * Callers:
...
__int64 __fastcall CTelemetryTouchLatencyAnalysis::CLatencyInfo::ExtractHostInputLatencyArray(
