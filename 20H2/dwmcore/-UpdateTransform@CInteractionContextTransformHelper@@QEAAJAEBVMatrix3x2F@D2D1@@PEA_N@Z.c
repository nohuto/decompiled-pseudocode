/*
 * XREFs of ?UpdateTransform@CInteractionContextTransformHelper@@QEAAJAEBVMatrix3x2F@D2D1@@PEA_N@Z @ 0x180269034
 * Callers:
 ...
 *     GetInverse @ 0x180268414 (GetInverse.c)
 *     IsEqualMatrix @ 0x1802685B0 (IsEqualMatrix.c)
 */
