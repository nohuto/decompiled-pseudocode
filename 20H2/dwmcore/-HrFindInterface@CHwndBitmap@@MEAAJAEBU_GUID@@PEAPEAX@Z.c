/*
 * XREFs of ?HrFindInterface@CHwndBitmap@@MEAAJAEBU_GUID@@PEAPEAX@Z @ 0x1801C3E80
 * Callers:
 *     <none>
 * Callees:
 *     ?HrFindInterface@CContent@@MEAAJAEBU_GUID@@PEAPEAX@Z @ 0x180077BC0 (-HrFindInterface@CContent@@MEAAJAEBU_GUID@@PEAPEAX@Z.c)
 */
