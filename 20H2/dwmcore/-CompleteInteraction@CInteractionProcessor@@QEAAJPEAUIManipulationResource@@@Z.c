/*
 * XREFs of ?CompleteInteraction@CInteractionProcessor@@QEAAJPEAUIManipulationResource@@@Z @ 0x1802298D4
 * Callers:
 *     ?CompleteInteraction@CInteraction@@UEAAJXZ @ 0x1801C5670 (-CompleteInteraction@CInteraction@@UEAAJXZ.c)
 *     ?CompleteInteraction@CInteractionRoot@@UEAAJXZ @ 0x180231650 (-CompleteInteraction@CInteractionRoot@@UEAAJXZ.c)
 * Callees:
