/*
 * XREFs of ?ForceFullRender@CRenderTargetManager@@QEAAXXZ @ 0x1800D6E64
 * Callers:
 ...
 *     ?UpdateDebugCounter@CComposition@@QEAAX_N@Z @ 0x1801559A8 (-UpdateDebugCounter@CComposition@@QEAAX_N@Z.c)
 * Callees:
 *     <none>
 */
