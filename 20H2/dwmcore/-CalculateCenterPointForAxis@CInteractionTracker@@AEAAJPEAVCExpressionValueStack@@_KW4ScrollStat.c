/*
 * XREFs of ?CalculateCenterPointForAxis@CInteractionTracker@@AEAAJPEAVCExpressionValueStack@@_KW4ScrollState@@W4ScrollAxis@@PEAM@Z @ 0x1801C78D4
 * Callers:
...
LABEL_24:
  ...
  MilInstrumentationCheckHR_MaybeFailFast(v14, 0LL, 0, v13, 0x1728u, 0LL);
  return v15;
}
