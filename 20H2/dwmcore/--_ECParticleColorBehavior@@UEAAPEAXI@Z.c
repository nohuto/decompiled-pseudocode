/*
 * XREFs of ??_ECParticleColorBehavior@@UEAAPEAXI@Z @ 0x18016D140
 * Callers:
 *     ??_ECParticleColorBehavior@@WGI@EAAPEAXI@Z @ 0x1800EEB70 (--_ECParticleColorBehavior@@WGI@EAAPEAXI@Z.c)
 * Callees:
