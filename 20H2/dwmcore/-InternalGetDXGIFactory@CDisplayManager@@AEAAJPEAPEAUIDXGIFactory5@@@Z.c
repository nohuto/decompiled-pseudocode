/*
 * XREFs of ?InternalGetDXGIFactory@CDisplayManager@@AEAAJPEAPEAUIDXGIFactory5@@@Z @ 0x18003DD6C
 * Callers:
        ...
        struct IDXGIFactory5 **a2)
{
                                                                                                ...
                                                                                                + 63)) )
  {
    v4 = qword_180348548;
    if ( qword_180348548
      && (*(unsigned int (__fastcall **)(CDisplayManager *))(*(_QWORD *)qword_180348548 + 104LL))(qword_180348548)
      || (updated = CDisplayManager::UpdateDXGIFactory(v4), v9 = updated, updated >= 0) )
    {
      v5 = qword_180348548;
      *a2 = (struct IDXGIFactory5 *)qword_180348548;
