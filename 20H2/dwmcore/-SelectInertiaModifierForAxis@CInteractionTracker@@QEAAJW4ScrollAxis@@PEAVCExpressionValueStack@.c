/*
 * XREFs of ?SelectInertiaModifierForAxis@CInteractionTracker@@QEAAJW4ScrollAxis@@PEAVCExpressionValueStack@@_KPEAPEAUIScalarForce@@@Z @ 0x1801CA6D0
 * Callers:
 ...
 *     ?GetSampledConditionAnimation@CConditionalExpression@@QEBAXPEAPEAVCBaseExpression@@@Z @ 0x1801BD1D4 (-GetSampledConditionAnimation@CConditionalExpression@@QEBAXPEAPEAVCBaseExpression@@@Z.c)
 ...
 *     ??$?4VCExpressionForce@@@?$ComPtr@UIScalarForce@@@WRL@Microsoft@@QEAAAEAV012@PEAVCExpressionForce@@@Z @ 0x1801C6954 (--$-4VCExpressionForce@@@-$ComPtr@UIScalarForce@@@WRL@Microsoft@@QEAAAEAV012@PEAVCExpressionForc.c)
 *     ??$?4VCScalarForce@@@?$ComPtr@UIScalarForce@@@WRL@Microsoft@@QEAAAEAV012@AEBV?$ComPtr@VCScalarForce@@@12@@Z @ 0x1801C69F4 (--$-4VCScalarForce@@@-$ComPtr@UIScalarForce@@@WRL@Microsoft@@QEAAAEAV012@AEBV-$ComPtr@VCScalarFo.c)
 ...
 *     ??0CScalarForce@@QEAA@PEAUIAccelerator@@@Z @ 0x180211F34 (--0CScalarForce@@QEAA@PEAUIAccelerator@@@Z.c)
        ...
        _QWORD *a5)
{
  ...
  if ( v9 )
  {
    ...
    {
      MilInstrumentationCheckHR_MaybeFailFast(v13, 0LL, 0, IsAnyConditionSatisfied, 0xE60u, 0LL);
      goto LABEL_36;
    }
    v11 = v6;
    v10 = v56;
...
LABEL_15:
  ...
  if ( v15 < 0 )
  {
    MilInstrumentationCheckHR_MaybeFailFast(v16, 0LL, 0, v15, 0xE77u, 0LL);
    goto LABEL_36;
  }
  if ( !v49 )
    goto LABEL_35;
...
LABEL_16:
  ...
  if ( !v20 )
  {
    ...
    if ( Value < 0 )
    {
      MilInstrumentationCheckHR_MaybeFailFast(v39, 0LL, 0, Value, 0xEA0u, 0LL);
      goto LABEL_36;
    }
    ...
    {
      v14 = -2147024882;
      MilInstrumentationCheckHR_MaybeFailFast(v41, 0LL, 0, -2147024882, 0xEA6u, 0LL);
      goto LABEL_37;
    }
...
LABEL_35:
  ...
  if ( !v21 )
  {
    ...
    *(_DWORD *)(v35 + 144) = 1101004800;
    ...
    {
      v14 = -2147024882;
      MilInstrumentationCheckHR_MaybeFailFast(v36, 0LL, 0, -2147024882, 0xEC9u, 0LL);
      goto LABEL_37;
    }
    goto LABEL_35;
  }
  ...
  {
    v14 = -2147467259;
    MilInstrumentationCheckHR_MaybeFailFast(v18, 0LL, 0, -2147467259, 0xEEFu, 0LL);
    goto LABEL_37;
  }
  v52 = 0LL;
  ...
  if ( v10 != 1 )
  {
    ...
    if ( ForceForAxis < 0 )
    {
      MilInstrumentationCheckHR_MaybeFailFast(v27, 0LL, 0, ForceForAxis, 0xEE4u, 0LL);
      goto LABEL_28;
    }
    goto LABEL_32;
  }
...
LABEL_32:
  ...
  MilInstrumentationCheckHR_MaybeFailFast(v25, 0LL, 0, v24, 0xEDBu, 0LL);
LABEL_28:
  if ( v22 )
    (*(void (__fastcall **)(struct CBaseExpression *))(*(_QWORD *)v22 + 16LL))(v22);
  Microsoft::WRL::ComPtr<IUnknown>::InternalRelease((__int64 *)&v52);
