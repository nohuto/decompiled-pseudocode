/*
 * XREFs of _anonymous_namespace_::CanAddThisColumnVectorToMatrix @ 0x180229610
 * Callers:
 ...
 * Callees:
 *     ?D3DXVectorAreCloseToZero@@YAHAEBUD2DVector3@@@Z @ 0x18021C098 (-D3DXVectorAreCloseToZero@@YAHAEBUD2DVector3@@@Z.c)
