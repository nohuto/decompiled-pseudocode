        ...
        const unsigned __int16 **a15)
{
  ...
  v31 = 8LL;
  v29 = 4LL;
  return tlgWriteTransfer_EventWriteTransfer((int)&dword_180341EF0, a2, 0, 0, 0xDu, &v27);
}
