/*
 * XREFs of ?ComputeShadowPath@CProjectedShadow@@AEBA?AW4Enum@ShadowPath@@PEAVCDrawingContext@@@Z @ 0x18000DDF8
 * Callers:
 ...
 *     ?CanUseFastShadow@CProjectedShadow@@AEBA_NXZ @ 0x18000DF1C (-CanUseFastShadow@CProjectedShadow@@AEBA_NXZ.c)
