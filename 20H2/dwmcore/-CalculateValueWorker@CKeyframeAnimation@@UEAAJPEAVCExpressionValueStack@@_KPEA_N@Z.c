/*
 * XREFs of ?CalculateValueWorker@CKeyframeAnimation@@UEAAJPEAVCExpressionValueStack@@_KPEA_N@Z @ 0x180025CC0
 * Callers:
 ...
 *     ??4CExpressionValue@@QEAAAEAV0@AEBV0@@Z @ 0x1800D7134 (--4CExpressionValue@@QEAAAEAV0@AEBV0@@Z.c)
...
LABEL_48:
        ...
        *((_QWORD *)this + 58) = v46;
        ...
        {
          LODWORD(v46) = *((unsigned __int8 *)this + 540);
          v47 = v46;
        ...
        if ( (v47 & 8) == 0 )
        {
          ...
          if ( *((_QWORD *)this + 44) )
          {
            ...
            if ( v62 < 0 )
            {
              MilInstrumentationCheckHR_MaybeFailFast(v46, 0LL, 0, v62, 0x8A7u, 0LL);
LABEL_53:
              if ( v9 < 0 )
              {
