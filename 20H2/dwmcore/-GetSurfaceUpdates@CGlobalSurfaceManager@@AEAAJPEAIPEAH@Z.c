/*
 * XREFs of ?GetSurfaceUpdates@CGlobalSurfaceManager@@AEAAJPEAIPEAH@Z @ 0x180164128
 * Callers:
...
__int64 __fastcall CGlobalSurfaceManager::GetSurfaceUpdates(CGlobalSurfaceManager *this, unsigned int *a2, int *a3)
{
  ...
  if ( FrameSurfaceUpdates < 0 )
  {
    ...
    MilInstrumentationCheckHR_MaybeFailFast(v7, &dword_1802D8418, 3u, FrameSurfaceUpdates | 0x10000000, 0xA9u, 0LL);
  }
  return v3;
}
