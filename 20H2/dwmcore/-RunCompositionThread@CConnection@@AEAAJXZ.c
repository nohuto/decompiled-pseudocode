/*
 * XREFs of ?RunCompositionThread@CConnection@@AEAAJXZ @ 0x18003351C
 * Callers:
 *     ?CompositionThreadEntryPoint@CConnection@@CAKPEAX@Z @ 0x180033510 (-CompositionThreadEntryPoint@CConnection@@CAKPEAX@Z.c)
 * Callees:
 ...
 *     ??0CPartitionVerticalBlankScheduler@@AEAA@PEAVCTransport@@PEAVCConnection@@@Z @ 0x180033E64 (--0CPartitionVerticalBlankScheduler@@AEAA@PEAVCTransport@@PEAVCConnection@@@Z.c)
 ...
 *     ??0CProcessAttributionReporter@@AEAA@XZ @ 0x180035FF8 (--0CProcessAttributionReporter@@AEAA@XZ.c)
...
__int64 __fastcall CConnection::RunCompositionThread(CConnection *this)
{
  ...
  struct _EVENT_DATA_DESCRIPTOR v33; // [rsp+30h] [rbp-58h] BYREF
  struct _EVENT_DATA_DESCRIPTOR v34; // [rsp+40h] [rbp-48h] BYREF
  ...
  *((_QWORD *)v2 + 5) = 0LL;
  ...
  if ( v9 )
    ...
    v10 = 0LL;
  qword_180344460 = (CProcessResourceAttributionReporter *)v10;
  if ( !v10 )
    ModuleFailFastForHRESULT(2147942414LL, retaddr);
...
LABEL_34:
  ...
  if ( qword_180344458 )
  {
    CProcessAttributionReporter::~CProcessAttributionReporter(qword_180344458);
  ...
  if ( qword_180344460 )
  {
    CProcessResourceAttributionReporter::~CProcessResourceAttributionReporter(qword_180344460);
  ...
  if ( qword_180344450 )
  {
    WaitForThreadpoolWorkCallbacks(*((PTP_WORK *)qword_180344450 + 9), 1);
  ...
  if ( qword_180344440 )
  {
    anonymous_namespace_::State::_State(qword_180344440);
