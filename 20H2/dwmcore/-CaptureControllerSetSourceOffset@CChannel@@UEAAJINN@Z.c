/*
 * XREFs of ?CaptureControllerSetSourceOffset@CChannel@@UEAAJINN@Z @ 0x18014F300
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall CChannel::CaptureControllerSetSourceOffset(CChannel *this, unsigned int a2, double a3, double a4)
{
  float v6; // xmm0_4
  float v7; // xmm1_4
  unsigned int v8; // ebx
