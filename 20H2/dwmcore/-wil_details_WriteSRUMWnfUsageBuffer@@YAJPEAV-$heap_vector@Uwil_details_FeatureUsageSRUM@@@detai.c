/*
 * XREFs of ?wil_details_WriteSRUMWnfUsageBuffer@@YAJPEAV?$heap_vector@Uwil_details_FeatureUsageSRUM@@@details_abi@wil@@@Z @ 0x18014E688
 * Callers:
 *     _lambda_5035b992506f4af81a770c5842624510_::_lambda_invoker_cdecl_ @ 0x18014C3A0 (_lambda_5035b992506f4af81a770c5842624510_--_lambda_invoker_cdecl_.c)
 * Callees:
        ...
        const void *a3)
{
  ...
  if ( (unsigned __int64)(a1[1] - *a1) >= 0xC )
  {
    ...
    {
      v16 = 4096;
      v4 = wil_details_NtQueryWnfStateData((const struct __WIL__WNF_STATE_NAME *)&unk_1802EC7D8, a2, a3, v17, v18, &v16);
      if ( !v4 )
      {
        v7 = v16;
        v8 = *a1;
...
LABEL_12:
        ...
        updated = wil_details_NtUpdateWnfStateData(
                    (const struct __WIL__WNF_STATE_NAME *)&unk_1802EC7D8,
                    v18,
                    v7,
