/*
 * XREFs of ?ApplyRenderStateInternal@CDrawingContext@@AEAAJ_N@Z @ 0x18008AC90
 * Callers:
 ...
 *     ?ApplyRenderState@CDrawingContext@@UEAAJXZ @ 0x1800211C0 (-ApplyRenderState@CDrawingContext@@UEAAJXZ.c)
