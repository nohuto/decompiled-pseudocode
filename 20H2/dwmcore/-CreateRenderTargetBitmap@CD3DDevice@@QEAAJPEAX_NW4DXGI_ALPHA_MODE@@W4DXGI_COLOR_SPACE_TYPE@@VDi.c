/*
 * XREFs of ?CreateRenderTargetBitmap@CD3DDevice@@QEAAJPEAX_NW4DXGI_ALPHA_MODE@@W4DXGI_COLOR_SPACE_TYPE@@VDisplayId@@MPEAPEAVIRenderTargetBitmap@@@Z @ 0x18023C140
 * Callers:
...
LABEL_8:
    MilInstrumentationCheckHR_MaybeFailFast((__int64)a1, &dword_1802EDC28, 2u, v14, v16, 0LL);
  }
