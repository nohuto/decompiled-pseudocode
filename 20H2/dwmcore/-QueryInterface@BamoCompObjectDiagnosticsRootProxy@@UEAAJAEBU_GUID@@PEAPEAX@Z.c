/*
 * XREFs of ?QueryInterface@BamoCompObjectDiagnosticsRootProxy@@UEAAJAEBU_GUID@@PEAPEAX@Z @ 0x180182340
 * Callers:
 *     ?QueryInterface@BamoCompObjectDiagnosticsRootProxy@@W7EAAJAEBU_GUID@@PEAPEAX@Z @ 0x1800EFA90 (-QueryInterface@BamoCompObjectDiagnosticsRootProxy@@W7EAAJAEBU_GUID@@PEAPEAX@Z.c)
 * Callees:
