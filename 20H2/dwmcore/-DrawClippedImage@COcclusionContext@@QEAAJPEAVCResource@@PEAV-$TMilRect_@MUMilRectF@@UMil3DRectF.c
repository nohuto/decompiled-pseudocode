/*
 * XREFs of ?DrawClippedImage@COcclusionContext@@QEAAJPEAVCResource@@PEAV?$TMilRect_@MUMilRectF@@UMil3DRectF@@UMilPointAndSizeF@@UNotNeeded@RectUniqueness@@@@AEBVCShape@@U?$TMILFlagsEnum@W4FlagsEnum@MilSourceModification@@@@@Z @ 0x18001A1EC
 * Callers:
    ...
    && (_DWORD)v24 )
  {
    ...
    if ( v12 )
    {
      ...
      if ( (_DWORD)v24 )
      {
        ...
        MilInstrumentationCheckHR_MaybeFailFast(v22, 0LL, 0, v21, 0x4C6u, 0LL);
      }
LABEL_21:
      operator delete(v12);
    }
    ...
    {
      v5 = -2147024882;
      MilInstrumentationCheckHR_MaybeFailFast(v11, 0LL, 0, -2147024882, 0x4BEu, 0LL);
    }
  }
  return v5;
}
