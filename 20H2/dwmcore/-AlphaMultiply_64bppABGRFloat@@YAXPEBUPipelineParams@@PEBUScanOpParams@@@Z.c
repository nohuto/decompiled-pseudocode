/*
 * XREFs of ?AlphaMultiply_64bppABGRFloat@@YAXPEBUPipelineParams@@PEBUScanOpParams@@@Z @ 0x180218A70
 * Callers:
 *     <none>
 * Callees:
...
void __fastcall AlphaMultiply_64bppABGRFloat(const struct PipelineParams *a1, const struct ScanOpParams *a2)
{
  ...
  if ( v2 )
  {
    ...
    do
    {
      ...
      if ( v4 != CFloat16::operator float((unsigned __int16 *)&word_1803437A0) )
      {
        v5 = CFloat16::operator float(v3);
        if ( v5 != CFloat16::operator float(word_1803448B8) )
        {
          v60 = (float)*v6;
