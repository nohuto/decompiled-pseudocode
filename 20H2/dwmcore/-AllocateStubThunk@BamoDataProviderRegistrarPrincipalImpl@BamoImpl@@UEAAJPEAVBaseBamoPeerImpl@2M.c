/*
 * XREFs of ?AllocateStubThunk@BamoDataProviderRegistrarPrincipalImpl@BamoImpl@@UEAAJPEAVBaseBamoPeerImpl@2Microsoft@@PEAPEAVBamoStub@Bamo@4@@Z @ 0x1800DB4A0
 * Callers:
 *     <none>
 * Callees:
        ...
        struct Microsoft::Bamo::BamoStub **a3)
{
  ...
  v5 = (*(__int64 (__fastcall **)(BamoImpl::BamoDataProviderRegistrarPrincipalImpl *))(*(_QWORD *)this + 48LL))(this);
