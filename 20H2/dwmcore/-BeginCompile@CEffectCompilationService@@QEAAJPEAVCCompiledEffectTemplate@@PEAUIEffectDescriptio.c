/*
 * XREFs of ?BeginCompile@CEffectCompilationService@@QEAAJPEAVCCompiledEffectTemplate@@PEAUIEffectDescription@Composition@UI@Windows@@PEAPEAVCEffectCompilationTask@@@Z @ 0x1800C6714
 * Callers:
 ...
 *     McTemplateU0pdsddt_EventWriteTransfer @ 0x180167E50 (McTemplateU0pdsddt_EventWriteTransfer.c)
