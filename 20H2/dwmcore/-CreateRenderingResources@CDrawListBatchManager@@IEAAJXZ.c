/*
 * XREFs of ?CreateRenderingResources@CDrawListBatchManager@@IEAAJXZ @ 0x180037C60
 * Callers:
 ...
 * Callees:
 *     ??0CBatchOptimizer@@QEAA@PEAVCDrawListBatchManager@@@Z @ 0x180036D3C (--0CBatchOptimizer@@QEAA@PEAVCDrawListBatchManager@@@Z.c)
