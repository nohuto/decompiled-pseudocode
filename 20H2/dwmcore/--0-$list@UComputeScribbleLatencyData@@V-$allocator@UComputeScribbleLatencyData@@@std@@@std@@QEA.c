/*
 * XREFs of ??0?$list@UComputeScribbleLatencyData@@V?$allocator@UComputeScribbleLatencyData@@@std@@@std@@QEAA@XZ @ 0x1800DA4A8
 * Callers:
...
__int128 *std::list<ComputeScribbleLatencyData>::list<ComputeScribbleLatencyData>()
{
  ...
  xmmword_1803483F0 = 0LL;
  v0 = (_QWORD *)std::_Allocate<16,std::_Default_allocate_traits,0>(0x48uLL);
  *v0 = v0;
  v0[1] = v0;
  *(_QWORD *)&xmmword_1803483F0 = v0;
  return &xmmword_1803483F0;
}
