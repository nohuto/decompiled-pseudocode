/*
 * XREFs of RtlpHeapTrkDereferenceStack @ 0x1800FE16C
 * Callers:
        ...
        unsigned __int64 a4)
{
  ...
  v5 = *(_WORD *)(a1 + 18) & 0xF;
  v6 = 0;
  RtlAcquireSRWLockExclusive(*(_QWORD *)(qword_18016DBF8 + 8 * v5), a2, a3, a4);
  if ( (*(_DWORD *)(a1 + 20))-- == 1 )
  {
    v8 = *(_QWORD *)a1;
  ...
  result = RtlReleaseSRWLockExclusive(*(volatile signed __int64 **)(qword_18016DBF8 + 8 * v5));
  if ( v6 )
    return RtlFreeHeap(qword_18016DC00, 0, a1);
  return result;
}
