/*
 * XREFs of LdrpSearchPath @ 0x18005EE6C
 * Callers:
...
LABEL_33:
        ...
        if ( v26 != Buffer )
        {
          ...
          v29 = LdrpResolveDllName(&Destination, a5, v50, a7, 0);
          v15 = v29;
          if ( v27 )
          {
            if ( v29 < 0 )
...
LABEL_40:
  if ( v14 )
  {
    if ( v15 < 0 || RtlCompareUnicodeString(a7, v14, 1u) )
    {
      ...
      EtwEventWriteNoRegistration(&UserLoaderGuid, v41, (v15 >> 31) + 3, &UserData);
    }
