/*
 * XREFs of LdrpLogVsmEnclaveLdrDeleteEnclaveTelemetry @ 0x1800CFFF4
 * Callers:
  ...
  if ( v1->ProcessHeap )
  {
    ...
    if ( (unsigned int)dword_180166590 > 4 )
    {
      ...
      if ( (_BYTE)v1 )
      {
        ...
        v7 = a1;
        v13 = v5;
        LOBYTE(v1) = tlgWriteTransfer_EtwEventWriteTransfer(v3, (unsigned __int8 *)dword_180131946, v4, v5, v5, &v8);
      }
    }
  }
  return (char)v1;
