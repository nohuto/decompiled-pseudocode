/*
 * XREFs of RtlpMuiRegGetOrAddLangInfo @ 0x18010523C
 * Callers:
 ...
 * Callees:
 *     RtlpMuiRegGetLangInfoIndex @ 0x180105104 (RtlpMuiRegGetLangInfoIndex.c)
 *     RtlpMuiRegResizeLanguages @ 0x180105C94 (RtlpMuiRegResizeLanguages.c)
 */
...
__int64 __fastcall RtlpMuiRegGetOrAddLangInfo(__int64 *a1, __int64 a2, __int16 *a3)
{
  ...
  if ( LangInfoIndex < 0 )
  {
    ...
    if ( *(_WORD *)(v6 + 6) >= (unsigned __int16)v9 )
    {
      v10 = (unsigned int)*(unsigned __int16 *)(v6 + 6) + 4;
      if ( (unsigned int)v10 >= v9 )
        v6 = RtlpMuiRegResizeLanguages(v6, v10, (unsigned __int16)LangInfoIndex);
      if ( !v6 )
        return 3221225495LL;
      *a1 = v6;
    }
