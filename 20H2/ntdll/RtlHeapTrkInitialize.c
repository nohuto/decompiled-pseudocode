/*
 * XREFs of RtlHeapTrkInitialize @ 0x1800FDCA0
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall RtlHeapTrkInitialize(void *a1)
{
  ...
  if ( (int)result >= 0 )
  {
    if ( qword_18016D760 )
    {
      dword_18016DA88 = *(_DWORD *)(v19 + 56);
      RtlpHeapTrkGenerateHashRandoms((unsigned int)dword_18016DA88, v3, v4, v5, 0LL, &v21);
      Heap = (_DWORD *)RtlCreateHeap(
                         *(_DWORD *)(v19 + 52) == 0 ? 2 : 0,
                         ...
                         0LL,
                         0LL);
      qword_18016DC00 = (__int64)Heap;
      if ( Heap )
      {
        v18 = 2;
        RtlSetHeapInformation(Heap, 0, (__int64)&v18, 4uLL);
        dword_18016DBF0 = NtCurrentPeb()->NumberOfProcessors;
        if ( (unsigned __int8)RtlpHeapTrkAllocCacheAligned(&qword_18016D768, &qword_18016DC10, 32LL) )
        {
          if ( (unsigned __int8)RtlpHeapTrkAllocCacheAligned(&qword_18016DBE0, &qword_18016DBD8, 8LL) )
          {
            if ( (unsigned __int8)RtlpHeapTrkAllocCacheAligned(&qword_18016DBF8, &qword_18016DBD0, 8LL) )
            {
              qword_18016DA70 = RtlAllocateHeap(qword_18016DC00, 0, 126704LL);
              if ( qword_18016DA70 )
              {
                v7 = RtlAllocateHeap(qword_18016DC00, 0, 126704LL);
                qword_18016DA80 = v7;
                if ( v7 )
                {
                  v8 = (_QWORD *)qword_18016DA70;
                  v9 = 7919LL;
                  Handle = a1;
                  v10 = qword_18016DA70 - v7;
                  dword_18016DA78 = 0;
                  v11 = v7 - qword_18016DA70;
                  do
                  {
                    v12 = (char *)v8 + v11;
                    *v8 = v8;
        ...
        RtlDestroyHeap(qword_18016DC00);
        qword_18016DC00 = 0LL;
        qword_18016DC10 = 0LL;
        qword_18016DA70 = 0LL;
        qword_18016DBE0 = 0LL;
