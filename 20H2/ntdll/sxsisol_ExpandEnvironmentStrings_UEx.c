/*
 * XREFs of sxsisol_ExpandEnvironmentStrings_UEx @ 0x1800DF7DC
 * Callers:
 ...
 *     RtlExpandEnvironmentStrings_U @ 0x180076E00 (RtlExpandEnvironmentStrings_U.c)
...
__int64 __fastcall sxsisol_ExpandEnvironmentStrings_UEx(__int64 a1, unsigned __int16 *a2, unsigned __int16 *a3)
{
  ...
  if ( a2 && a3 && a2 != a3 )
  {
    if ( *a2 )
    {
      ...
      v5 = RtlExpandEnvironmentStrings_U(0LL, a2, (__int64)&v14, &v15);
      if ( (int)(v5 + 0x80000000) < 0 || v5 == -1073741789 )
      {
        if ( (unsigned int)v15 > 0xFFFE || (v12 = (unsigned int)v15 + 4LL, v12 > 0xFFFE) )
        {
          v5 = -1073741562;
        }
        else if ( (a3 == (unsigned __int16 *)-16LL || v12 > *((_QWORD *)a3 + 4))
               && (int)RtlpEnsureBufferSize(0, (__int64)(a3 + 8), v12) < 0 )
        {
          v5 = -1073741801;
        }
        else
      ...
      RtlLeaveCriticalSection((__int64)&FastPebLock, v11, v12);
    }
    else
    {
      *a3 = 0;
