/*
 * XREFs of RtlpCompareKnownAces @ 0x180038240
 * Callers:
...
char __fastcall RtlpCompareKnownAces(unsigned __int8 *a1, unsigned __int8 *a2, __int64 a3, __int64 a4)
{
  __int64 v6; // rcx
  __int64 v9; // r8
  int v11; // edx
  ...
  if ( !(unsigned __int8)RtlEqualSid(a2 + 8, a1 + 8) )
  {
    ...
    if ( !(unsigned __int8)RtlEqualSid(a2 + 8, v12) )
      return 0;
  }
  return 1;
}
