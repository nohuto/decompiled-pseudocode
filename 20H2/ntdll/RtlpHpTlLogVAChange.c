/*
 * XREFs of RtlpHpTlLogVAChange @ 0x18010B8EC
 * Callers:
...
void __fastcall RtlpHpTlLogVAChange(int a1, __int64 a2, __int64 a3, __int64 a4)
{
  ...
  switch ( a1 )
  {
    case 0x1000:
      ...
      v8[0] = a2;
      v12 = &v7;
      v5 = (unsigned __int8 *)&dword_180131F89;
      goto LABEL_13;
    case 0x2000:
      if ( (unsigned int)dword_180166698 <= 5 )
        return;
      v8[0] = a2;
      v12 = &v7;
      v5 = (unsigned __int8 *)&unk_180131F0F;
      goto LABEL_13;
    case 0x4000:
      if ( (unsigned int)dword_180166698 <= 5 )
        return;
      v8[0] = a2;
      v12 = &v7;
      v5 = (unsigned __int8 *)&unk_180131E68;
LABEL_13:
      v4 = v8;
      v7 = a3;
      goto LABEL_14;
  ...
  if ( a1 == 0x8000 && (unsigned int)dword_180166698 > 5 )
  {
    ...
    v8[0] = a3;
    v12 = v8;
    v5 = (unsigned __int8 *)&unk_180131FBE;
LABEL_14:
    v10 = v4;
    v14 = &v6;
    v11 = 8LL;
