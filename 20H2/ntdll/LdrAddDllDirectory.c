/*
 * XREFs of LdrAddDllDirectory @ 0x18008B710
 * Callers:
 ...
 *     RtlDetermineDosPathNameType_U @ 0x180076290 (RtlDetermineDosPathNameType_U.c)
...
NTSTATUS __cdecl LdrAddDllDirectory(PUNICODE_STRING NewDirectory, PDLL_DIRECTORY_COOKIE Cookie)
{
  ...
  *((_WORD *)v7 + 8) = NewDirectory->Length;
  ...
  v8 = NewDirectory->Length + (unsigned __int16)word_1801664B8 + 2;
  v13[16] = v8;
  if ( v8 > 0xFFFE )
  {
    local_unwind(v15, sub_1800CB3E4);
LABEL_11:
    __fastfail(3u);
  }
  word_1801664B8 = v8;
