/*
 * XREFs of RtlpHeapTrkInterceptor @ 0x1800FE670
 * Callers:
...
__int64 __fastcall RtlpHeapTrkInterceptor(__int64 a1, unsigned __int64 a2, int a3)
{
  ...
  if ( a1 == qword_18016DC00 || dword_18016DC2C == 1 )
    return 0LL;
  v4 = a3 - 2;
  if ( !v4 )
  {
LABEL_11:
    if ( a2 )
    {
      ...
      if ( dword_18016DA88 == 1 )
      {
        RtlpHeapTrkTrackAdd(a1, v8);
      }
      else if ( dword_18016DA88 == 2 )
      {
        CurrentProcessorNumber = RtlGetCurrentProcessorNumber(a1);
        v10 = CurrentProcessorNumber < dword_18016DBF0 ? CurrentProcessorNumber : 0;
        v11 = (unsigned int)v10;
        v12 = **(_DWORD **)(qword_18016D768 + 8 * v10);
        v13 = (MEMORY[0x7FFE0320] * (unsigned __int64)MEMORY[0x7FFE0004]) >> 24;
        if ( (unsigned int)(v13 - v12) >= 0x3E8
          && v12 == _InterlockedCompareExchange(
                      *(volatile signed __int32 **)(qword_18016D768 + 8LL * (unsigned int)v10),
                      v13,
                      v12) )
        {
          _InterlockedExchange64(
            (volatile __int64 *)(*(_QWORD *)(qword_18016D768 + 8LL * (unsigned int)v10) + 8LL),
            qword_18016D760 / 100);
        }
        v14 = *(_QWORD *)(qword_18016D768 + 8LL * (unsigned int)v10);
        if ( *(__int64 *)(v14 + 8) <= 0 )
        {
        ...
        else
        {
          ...
          _InterlockedExchangeAdd64(
            (volatile signed __int64 *)(*(_QWORD *)(qword_18016D768 + 8 * v11) + 8LL),
            ~(v17 - v16));
          _InterlockedIncrement64((volatile signed __int64 *)(*(_QWORD *)(qword_18016D768 + 8 * v11) + 16LL));
        }
      }
    }
    return 0LL;
