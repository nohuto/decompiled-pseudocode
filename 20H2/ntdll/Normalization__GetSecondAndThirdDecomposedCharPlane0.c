/*
 * XREFs of Normalization__GetSecondAndThirdDecomposedCharPlane0 @ 0x1801003A0
 * Callers:
 *     NormBuffer__ReplaceLastStartBase @ 0x1800FFCD4 (NormBuffer__ReplaceLastStartBase.c)
 * Callees:
 *     <none>
 */
