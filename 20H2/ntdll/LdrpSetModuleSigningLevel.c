/*
 * XREFs of LdrpSetModuleSigningLevel @ 0x180089558
 * Callers:
 ...
 * Callees:
 *     NtCompareSigningLevels @ 0x18009E420 (NtCompareSigningLevels.c)
 *     NtGetCachedSigningLevel @ 0x18009EEA0 (NtGetCachedSigningLevel.c)
 *     ZwSetCachedSigningLevel @ 0x1800A01C0 (ZwSetCachedSigningLevel.c)
 */
