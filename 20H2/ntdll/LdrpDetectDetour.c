/*
 * XREFs of LdrpDetectDetour @ 0x180061FBC
 * Callers:
...
char LdrpDetectDetour()
{
  ...
  do
  {
    ...
    {
      v8 = qword_180169728 - *((_QWORD *)&v16 + 1);
      if ( qword_180169728 == *((_QWORD *)&v16 + 1) )
        v8 = qword_180169730 - v17;
    }
    if ( v8 )
    {
      LODWORD(v8) = 1 << v2;
  ...
  if ( !LdrpDetourExist )
  {
    ...
    LdrpDetourExist = 1;
LABEL_19:
    if ( (int)ZwQueryInformationThread(-2LL, 42LL, &v15) < 0 )
    {
