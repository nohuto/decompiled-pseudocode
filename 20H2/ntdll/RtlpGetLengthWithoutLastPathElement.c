/*
 * XREFs of RtlpGetLengthWithoutLastPathElement @ 0x1800778C4
 * Callers:
 *     RtlGetLengthWithoutLastFullDosOrNtPathElement @ 0x1800778B0 (RtlGetLengthWithoutLastFullDosOrNtPathElement.c)
 * Callees:
 *     RtlpDetermineDosPathNameType4 @ 0x1800779C4 (RtlpDetermineDosPathNameType4.c)
 */
