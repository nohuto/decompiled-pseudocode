        ...
        _WORD *a6)
{
  ...
  {
    v82 = RtlCSparseBitmapBitmaskRead((__int64)&unk_18016DC50, 2 * ((a3 - qword_18016DC48) >> 20));
...
LABEL_28:
  ...
  {
    if ( v92
      || (v50 = RtlCSparseBitmapBitmaskRead((__int64)&unk_18016DC50, 2 * ((a3 - qword_18016DC48) >> 20))) != 0
...
LABEL_82:
  ...
  if ( v92
    || (v83 = RtlCSparseBitmapBitmaskRead((__int64)&unk_18016DC50, 2 * ((a3 - qword_18016DC48) >> 20))) != 0
