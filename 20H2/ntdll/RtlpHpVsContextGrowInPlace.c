/*
 * XREFs of RtlpHpVsContextGrowInPlace @ 0x180070EE8
 * Callers:
 ...
 *     RtlpHpVsCalculateChunkRequiredSize @ 0x18007118C (RtlpHpVsCalculateChunkRequiredSize.c)
 *     RtlpHpVsChunkSetUnusedBytes @ 0x1800711AC (RtlpHpVsChunkSetUnusedBytes.c)
  ...
  if ( v16 <= v14 && (v17 = v14 - v16) != 0 )
  {
    ...
    else
    {
      *(_WORD *)(v5 + 2) = WORD1(RtlpHpHeapGlobals) ^ WORD1(v5) ^ (((v22 << 16) + (v15 & 0xFFFF0000)) >> 16);
      ...
      if ( (unsigned __int64)v24 < a2 + 16 * (*(unsigned __int16 *)(a2 + 32) + 3LL) )
      {
