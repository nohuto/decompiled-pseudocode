/*
 * XREFs of _RtlpMuiRegLoadInstalledFromKey @ 0x180106E38
 * Callers:
 ...
 *     ValidateRegistrLangType @ 0x180106378 (ValidateRegistrLangType.c)
 */
      ...
      if ( v7 + 24 <= 0x200 )
      {
        ...
        *(_OWORD *)(((unsigned __int64)&v15 & 0xFFFFFFFFFFFFFFE0uLL) + 0x58) = 0LL;
        if ( (int)NtOpenKey() >= 0 )
        {
          ...
          v8 = *(_QWORD *)(((unsigned __int64)&v15 & 0xFFFFFFFFFFFFFFE0uLL) + 8);
