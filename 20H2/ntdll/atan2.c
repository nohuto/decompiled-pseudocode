/*
 * XREFs of atan2 @ 0x18008E680
 * Callers:
 *     <none>
 * Callees:
 *     _controlfp @ 0x1800940F4 (_controlfp.c)
...
LABEL_32:
    ...
    else
    {
      ...
      v27 = qword_1801240F0[v26];
      v28 = qword_180123960[v26];
    ...
    if ( v23 )
    {
      v28 = *(double *)&qword_180166B08 - v28;
      v25 = *(double *)&qword_180166B10 - v25;
    }
    if ( X < 0.0 )
    {
      v28 = *(double *)&qword_180166AF8 - v28;
      v25 = *(double *)&qword_180166B00 - v25;
    }
    v33 = v28 + v25;
    if ( v3 < 0.0 )
      *(_QWORD *)&v33 ^= _xmm;
