  ...
  *a6 = 1;
  ...
  if ( ((unsigned __int64)a3 & 0xFFFFFFFFFFFF0000uLL) != 0 )
  {
    ...
    if ( v8 && a4 + (unsigned __int64)(v9 & 0x7FFFFFFF) > v11 + a2
      ...
      && ((v13 = v9 & 0x7FFFFFFF, v14 = v13 + 2 * *v12, (unsigned int)v14 < v13) || a4 + v14 > v11 + a2) )
    {
      *a6 = 0;
      return -1LL;
    }
