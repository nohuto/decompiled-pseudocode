...
LABEL_23:
        ...
        if ( *(_DWORD *)(a4 + 16) )
        {
          ...
          {
            v52 = RtlCSparseBitmapBitmaskRead((__int64)&unk_18016DC50, 2 * ((v25 - qword_18016DC48) >> 20));
...
LABEL_36:
        ...
        else
        {
          ...
          {
            v51 = RtlCSparseBitmapBitmaskRead((__int64)&unk_18016DC50, 2 * ((a3 - qword_18016DC48) >> 20));
