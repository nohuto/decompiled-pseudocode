/*
 * XREFs of RtlSleepConditionVariableSRW @ 0x180064000
 * Callers:
 ...
 *     RtlpWakeSingle @ 0x1800641D0 (RtlpWakeSingle.c)
 *     RtlpOptimizeConditionVariableWaitList @ 0x180064408 (RtlpOptimizeConditionVariableWaitList.c)
...
LABEL_26:
  if ( v8 )
    ...
    RtlAcquireSRWLockExclusive((unsigned __int64)a2, i, v15, v14);
  return v16;
}
