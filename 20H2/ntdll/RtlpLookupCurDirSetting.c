/*
 * XREFs of RtlpLookupCurDirSetting @ 0x18006CF10
 * Callers:
...
LABEL_7:
      ...
      v6 = (HANDLE)_InterlockedCompareExchange64(&qword_18016D508, (signed __int64)Handle, 0LL);
      if ( v6 )
      {
        NtClose(Handle);
        Handle = v6;
