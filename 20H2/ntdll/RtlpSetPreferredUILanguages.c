/*
 * XREFs of RtlpSetPreferredUILanguages @ 0x1800F13E0
 * Callers:
 ...
 *     RtlStringCchCatW @ 0x1800EF7B0 (RtlStringCchCatW.c)
 ...
 *     RtlpGetMultiStringLength @ 0x1800F0B60 (RtlpGetMultiStringLength.c)
 *     RtlpSetInstallLanguage @ 0x1800F0D30 (RtlpSetInstallLanguage.c)
 *     RtlpSetMachineUILanguagesImmediate @ 0x1800F1218 (RtlpSetMachineUILanguagesImmediate.c)
 *     RtlpMuiRegGetFallbackInstalledLanguageInfoByLangId @ 0x1801048EC (RtlpMuiRegGetFallbackInstalledLanguageInfoByLangId.c)
 */
...
LABEL_103:
  ...
  if ( v13 >= 0 )
  {
    if ( !v4 )
    {
      v33 = 2;
      LODWORD(v51) = 262146;
      v34 = (WCHAR *)&unk_18013838C;
      v3 = v12;
      *((_QWORD *)&v51 + 1) = &unk_18013838C;
      v39 = 4;
      goto LABEL_133;
    }
    v15 = 4LL;
