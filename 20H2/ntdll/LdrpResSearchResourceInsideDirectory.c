/*
 * XREFs of LdrpResSearchResourceInsideDirectory @ 0x180049A78
 * Callers:
 ...
 *     RtlULongLongSub @ 0x18004AE28 (RtlULongLongSub.c)
 *     LdrpSectionTableFromVirtualAddress @ 0x18004B884 (LdrpSectionTableFromVirtualAddress.c)
        ...
        _WORD *a13)
{
  ...
  unsigned int *v102; // [rsp+C8h] [rbp-100h]
...
LABEL_176:
  ...
  if ( v23 != 34816 )
    goto LABEL_34;
  if ( v82 )
    RtlFreeHeap((__int64)NtCurrentPeb()->ProcessHeap, 0, v82);
