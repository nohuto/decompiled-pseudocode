/*
 * XREFs of TppAllocAlpcCompletion @ 0x1800797D4
 * Callers:
 *     TpAllocAlpcCompletion @ 0x1800796B0 (TpAllocAlpcCompletion.c)
 *     TpAllocAlpcCompletionEx @ 0x1800797B0 (TpAllocAlpcCompletionEx.c)
 * Callees:
