/*
 * XREFs of LdrpResReportResourceAccessInternal @ 0x180042CE4
 * Callers:
...
int __fastcall LdrpResReportResourceAccessInternal(PVOID BaseOfImage, __int64 a2, __int64 *a3, int a4)
{
  ...
  LODWORD(RcConfig) = RtlRunOnceExecuteOnce(&stru_18016D270, LdrpResReportResourceAccessInternalInitOnce, 0LL, 0LL);
  if ( (int)RcConfig >= 0 )
  {
    v10 = (unsigned __int16)dword_18016D190;
    LODWORD(RcConfig) = ++dword_18016D190;
    if ( !v10 )
    {
      v26 = 0LL;
      if ( a2 )
        ...
        if ( a4 >= 2 )
        {
          if ( a4 == 2 )
          {
            if ( (unsigned int)dword_180166520 <= 5 )
              return (int)RcConfig;
            LODWORD(RcConfig) = tlgKeywordOn(&dword_180166520, 0x400000000000LL);
            if ( !(_BYTE)RcConfig )
              return (int)RcConfig;
            v27 = *a3;
            v39 = &v29;
            v33 = &v27;
            v16 = (const int *)&unk_1801319FB;
            v28 = a3[1];
            v35 = &v28;
            v37 = &v26;
            v38 = 4LL;
