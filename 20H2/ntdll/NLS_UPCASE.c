 ...
 *     UpcaseUnicodeToSingleByteNHelper @ 0x18006121C (UpcaseUnicodeToSingleByteNHelper.c)
 *     RtlFindUnicodeSubstring @ 0x180087220 (RtlFindUnicodeSubstring.c)
 *     WerEscalationLazyInit @ 0x1800DE408 (WerEscalationLazyInit.c)
 *     RtlUpcaseUnicodeToCustomCPN @ 0x1800E5A30 (RtlUpcaseUnicodeToCustomCPN.c)
 *     UpcaseUnicodeToMultiByteNHelper @ 0x1800E5B84 (UpcaseUnicodeToMultiByteNHelper.c)
