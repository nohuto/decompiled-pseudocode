/*
 * XREFs of RtlEnterUmsSchedulingMode @ 0x1800F73F0
 * Callers:
 *     <none>
 * Callees:
 *     RtlGetCurrentUmsThread @ 0x1800589E0 (RtlGetCurrentUmsThread.c)
 *     ZwRaiseException @ 0x18009FD60 (ZwRaiseException.c)
 *     RtlpUmsPrimaryContextWrap @ 0x1800A21C0 (RtlpUmsPrimaryContextWrap.c)
