/*
 * XREFs of RtlpHpStackTraceRemoveStack @ 0x180109758
 * Callers:
        ...
        unsigned __int64 a4)
{
  ...
  if ( (dword_18016D588 & 1) != 0 && (dword_18016D588 & 2) != 0 && (int)RtlpHpStackTraceHeapGetContext(a1, 0, &v10) >= 0 )
  {
    v8 = RtlpHpStackTraceAllocRemove(v10, a2, v6, v7);
    if ( v8 )
      RtlStackDbStackRemove(&qword_18016D590, v8);
  }
