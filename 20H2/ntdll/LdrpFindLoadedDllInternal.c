...
__int64 __fastcall LdrpFindLoadedDllInternal(int a1, int a2, _QWORD *a3, __int64 a4, int a5)
{
  ...
  *a3 = 0LL;
         ...
         || (LoadedDllByName = LdrpFindLoadedDllByName(0, a1, a5, (_DWORD)a3, a4), LoadedDllByName < 0) )
  {
    ...
    v12 = 0LL;
    if ( (a5 & 0x200) != 0 )
      v11 = LdrpResolveDllName(a1, (unsigned int)&v14, (unsigned int)v13, (unsigned int)&v12, a5);
    else
      v11 = LdrpSearchPath(a1, a2, 0, 0, (__int64)&v14, (__int64)v13, (__int64)&v12, 0LL, 0LL);
    LoadedDllByName = v11;
    if ( v11 >= 0 )
    {
