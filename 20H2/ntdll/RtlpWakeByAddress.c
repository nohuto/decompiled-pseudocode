/*
 * XREFs of RtlpWakeByAddress @ 0x18006322C
 * Callers:
 ...
 *     RtlWakeAddressSingle @ 0x180062660 (RtlWakeAddressSingle.c)
 *     RtlpDecRefWnfUserSubscription @ 0x18006305C (RtlpDecRefWnfUserSubscription.c)
 *     RtlWakeAddressAll @ 0x180063210 (RtlWakeAddressAll.c)
 *     RtlpUnWaitCriticalSection @ 0x1800E95B0 (RtlpUnWaitCriticalSection.c)
 *     RtlPosixBarrier @ 0x1800EDB48 (RtlPosixBarrier.c)
 *     RtlWakeAddressAllNoFence @ 0x180103440 (RtlWakeAddressAllNoFence.c)
 *     RtlWakeAddressSingleNoFence @ 0x180103450 (RtlWakeAddressSingleNoFence.c)
 * Callees:
...
LABEL_7:
        ...
        *(_QWORD *)(v11 + 32) = v13;
        ...
        if ( v6 )
        {
          ...
          {
            v17 = *(_QWORD *)(v6 + 16);
            result = ZwAlertThreadByThreadId(*(_QWORD *)(v6 + 8), v9);
            v6 = v17;
          }
          while ( v17 );
        }
