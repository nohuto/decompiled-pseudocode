/*
 * XREFs of LdrProcessRelocationBlockLongLong @ 0x180084688
 * Callers:
 *     LdrRelocateImageWithBias @ 0x18008458C (LdrRelocateImageWithBias.c)
 *     LdrProcessRelocationBlock @ 0x1800E3DB0 (LdrProcessRelocationBlock.c)
 *     LdrProcessRelocationBlockEx @ 0x1800E3DE0 (LdrProcessRelocationBlockEx.c)
 * Callees:
 *     LdrpArmProcessRelocation @ 0x1800E3DEC (LdrpArmProcessRelocation.c)
 *     LdrpThumbProcessRelocation @ 0x1800E3EBC (LdrpThumbProcessRelocation.c)
 */
