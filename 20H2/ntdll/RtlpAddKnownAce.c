 ...
 *     RtlAddAccessAllowedAce @ 0x180077880 (RtlAddAccessAllowedAce.c)
 *     RtlAddAccessAllowedAceEx @ 0x180078FD0 (RtlAddAccessAllowedAceEx.c)
 *     RtlAddAccessDeniedAceEx @ 0x1800858B0 (RtlAddAccessDeniedAceEx.c)
 *     RtlpSysVolCreateSecurityDescriptor @ 0x1800882D0 (RtlpSysVolCreateSecurityDescriptor.c)
 *     RtlAddAuditAccessAceEx @ 0x18008A9A0 (RtlAddAuditAccessAceEx.c)
 *     RtlAddAuditAccessAce @ 0x18008B300 (RtlAddAuditAccessAce.c)
 *     RtlAddAccessDeniedAce @ 0x18008BCA0 (RtlAddAccessDeniedAce.c)
 *     RtlDefaultNpAcl @ 0x1800D6CF0 (RtlDefaultNpAcl.c)
 *     RtlAddAccessAllowedObjectAce @ 0x1800E9610 (RtlAddAccessAllowedObjectAce.c)
 *     RtlAddAccessDeniedObjectAce @ 0x1800E9670 (RtlAddAccessDeniedObjectAce.c)
 *     RtlAddAuditAccessObjectAce @ 0x1800E98E0 (RtlAddAuditAccessObjectAce.c)
 * Callees:
