 ...
 *     RtlSparseArrayElementFindCapped @ 0x18010F9AC (RtlSparseArrayElementFindCapped.c)
 * Callees:
 *     RtlLengthCurrentClearRunForwardEx @ 0x1800ED128 (RtlLengthCurrentClearRunForwardEx.c)
 */
    ...
    if ( _bittest64((const signed __int64 *)(a1 + 56), a2 >> 30) )
    {
      if ( _bittest64(*(const signed __int64 **)a1, a2 >> 15) )
      {
        ...
        else if ( v7 <= 0 )
        {
          ...
          v14 = a2 & 0x1F;
          v15 = *(_DWORD *)v13 & dword_1801271E0[v14];
