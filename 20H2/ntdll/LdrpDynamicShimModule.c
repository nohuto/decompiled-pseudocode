/*
 * XREFs of LdrpDynamicShimModule @ 0x18003D9E4
 * Callers:
...
__int64 __fastcall LdrpDynamicShimModule(_QWORD *a1)
{
  ...
  __int64 v10; // rdx
  __int64 v11; // r8
  unsigned int (__fastcall *v12)(_WORD *, _QWORD, __int64); // [rsp+68h] [rbp+10h] BYREF

  v1 = dword_180169710;
  v3 = 0;
  if ( dword_180169710 && g_pShimmedModuleList )
  {
    dword_180169710 = 0;
    v3 = LdrpGetProcApphelpCheckModule(&v12);
    if ( v3 >= 0 )
    {
      ...
      RtlLeaveCriticalSection((__int64)&LdrpDllNotificationLock, v10, v11);
    }
    else
    {
      v5 = LdrpDebugFlags;
