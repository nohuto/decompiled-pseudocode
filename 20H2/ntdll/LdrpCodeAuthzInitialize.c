/*
 * XREFs of LdrpCodeAuthzInitialize @ 0x18007B340
 * Callers:
 ...
 *     ZwQueryKey @ 0x18009D370 (ZwQueryKey.c)
...
__int64 LdrpCodeAuthzInitialize()
{
  ...
  if ( (unsigned __int16)(OutHeaders->OptionalHeader.Subsystem - 2) > 1u )
    return 0LL;
  if ( NtOpenKey(&KeyHandle, 3u, (POBJECT_ATTRIBUTES)&stru_18011D750) < 0
    || (v3 = NtQueryValueKey(KeyHandle, (PUNICODE_STRING)&stru_18011E448, KeyValuePartialInformation, v24, 0x50u, v14),
        NtClose(KeyHandle),
        v3 < 0)
    || v25 != 4
    || v26 != 4
    || !v27 )
  {
    v9 = 0LL;
    v1 = 0;
    if ( NtOpenKey(&v9, 0x20019u, &stru_180166600) >= 0 )
    {
    ...
    if ( NtOpenKey(&Handle, 1u, (POBJECT_ATTRIBUTES)&stru_18011D720) >= 0 )
    {
      if ( NtQueryValueKey(
             Handle,
        ...
        && v23 > 1 )
      {
        ...
        NtQueryValueKey(
          Handle,
          (PUNICODE_STRING)&stru_18011E438,
          KeyValuePartialInformation,
          KeyValueInformation,
          0x50u,
          ResultLength);
    ...
    if ( RtlFormatCurrentUserKeyPath(&CurrentUserKeyPath) >= 0 )
    {
      ...
      {
LABEL_27:
        if ( LdrLoadDll(0LL, 0LL, (PUNICODE_STRING)&stru_18011E428, &DllHandle) >= 0 )
        {
          v6 = DllHandle;
          if ( LdrGetProcedureAddressForCaller(
                 DllHandle,
                 (PANSI_STRING)&stru_18011E458,
                 0,
                 &ProcedureAddress,
                 0,
                 retaddr) >= 0
