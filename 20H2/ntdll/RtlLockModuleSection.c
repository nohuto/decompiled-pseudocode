/*
 * XREFs of RtlLockModuleSection @ 0x18005D780
 * Callers:
 ...
 *     RtlpLocateModuleSectionInLockedSectionList @ 0x18005D880 (RtlpLocateModuleSectionInLockedSectionList.c)
      ...
      *(_QWORD *)(Heap + 32) = 0LL;
      ...
      if ( v8 >= 0 )
      {
        ...
        if ( v12 >= 0 )
        {
          ...
          *(_QWORD *)(v6 + 24) = v14;
          *(_DWORD *)(v6 + 32) = 1;
          v9 = (__int64 *)off_180166658;
          if ( *off_180166658 != (_UNKNOWN *)&RtlpLockedSectionList )
            __fastfail(3u);
          *(_QWORD *)v6 = &RtlpLockedSectionList;
          *(_QWORD *)(v6 + 8) = v9;
          *v9 = v6;
          off_180166658 = (_UNKNOWN **)v6;
        }
      }
    }
    else
