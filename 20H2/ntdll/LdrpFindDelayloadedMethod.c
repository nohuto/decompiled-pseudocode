/*
 * XREFs of LdrpFindDelayloadedMethod @ 0x1800CEB18
 * Callers:
 *     LdrQueryOptionalDelayLoadedAPI @ 0x1800CEA10 (LdrQueryOptionalDelayLoadedAPI.c)
 * Callees:
 *     RtlpImageDirectoryEntryToDataEx @ 0x180032920 (RtlpImageDirectoryEntryToDataEx.c)
 *     LdrpFindDelayloadedMethodInDescriptor @ 0x1800CEBC4 (LdrpFindDelayloadedMethodInDescriptor.c)
 */
