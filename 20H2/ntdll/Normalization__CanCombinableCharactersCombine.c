/*
 * XREFs of Normalization__CanCombinableCharactersCombine @ 0x180100030
 * Callers:
 *     Normalization__NormalizeCharacter @ 0x18008046C (Normalization__NormalizeCharacter.c)
 *     NormBuffer__LastStartBasePair @ 0x1800FFB08 (NormBuffer__LastStartBasePair.c)
 *     NormBuffer__RecheckStartCombinations @ 0x1800FFB58 (NormBuffer__RecheckStartCombinations.c)
 *     Normalization__CanCombineWithStartBase @ 0x180100194 (Normalization__CanCombineWithStartBase.c)
 *     Normalization__CanCombineWithStartFirstPair @ 0x1801001E0 (Normalization__CanCombineWithStartFirstPair.c)
