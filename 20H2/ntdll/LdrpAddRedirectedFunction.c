/*
 * XREFs of LdrpAddRedirectedFunction @ 0x1800D4EE4
 * Callers:
 ...
 *     LdrpHashUnicodeString @ 0x18005FBB0 (LdrpHashUnicodeString.c)
 *     __security_check_cookie @ 0x18008C340 (__security_check_cookie.c)
 *     memmove @ 0x1800A3EC0 (memmove.c)
 *     LdrpCompareRedirectedFunction @ 0x1800D54AC (LdrpCompareRedirectedFunction.c)
 *     LdrpHashAsciizString @ 0x1800D591C (LdrpHashAsciizString.c)
 */
...
LABEL_31:
        ...
        if ( Heap )
        {
          ...
          *(_WORD *)(Heap + 42) = v17;
          ...
          if ( (qword_18016D3A0 & 1) != 0 && LdrpRedirectionTree )
            v18 = (unsigned __int64)&LdrpRedirectionTree ^ LdrpRedirectionTree;
          v19 = 0;
          v20 = qword_18016D3A0 & 1;
          if ( v18 )
          {
            while ( 1 )
            {
