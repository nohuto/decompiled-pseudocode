/*
 * XREFs of RtlpCopyContext @ 0x180030BD0
 * Callers:
 *     RtlUnwindEx @ 0x180030600 (RtlUnwindEx.c)
 *     RtlDispatchException @ 0x180051260 (RtlDispatchException.c)
 * Callees:
 *     RtlLocateExtendedFeature2 @ 0x1800715A0 (RtlLocateExtendedFeature2.c)
 */
    ...
    *(_DWORD *)(a1 + 48) = 0;
    if ( (*(_DWORD *)(a2 + 48) & 0x100040) == 0x100040 && (v4 & 0x100040) == 0x100040 )
    {
      *(_DWORD *)(a1 + 48) = 1048640;
      ExtendedFeature2 = (_OWORD *)RtlLocateExtendedFeature2(a2 + 1232, 11LL, 2147353560LL);
      v7 = (_OWORD *)RtlLocateExtendedFeature2(a1 + 1232, 11LL, 2147353560LL);
      if ( ExtendedFeature2 )
      {
        if ( v7 )
        {
