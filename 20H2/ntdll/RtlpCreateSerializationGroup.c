/*
 * XREFs of RtlpCreateSerializationGroup @ 0x180044D9C
 * Callers:
...
__int64 __fastcall RtlpCreateSerializationGroup(int a1, unsigned __int64 a2, unsigned __int64 a3, unsigned __int64 a4)
{
  ...
  RtlAcquireSRWLockShared((volatile signed __int64 *)(qword_18016D250 + 48), a2, a3, a4);
  for ( i = *(_QWORD **)(qword_18016D250 + 32); i != (_QWORD *)(qword_18016D250 + 32); i = (_QWORD *)*i )
  {
    ...
    if ( *((_DWORD *)i - 1) == a1 )
    {
      ...
      RtlReleaseSRWLockShared((volatile signed __int64 *)(qword_18016D250 + 48));
      return v6;
    }
  }
  RtlReleaseSRWLockShared((volatile signed __int64 *)(qword_18016D250 + 48));
  ...
  if ( result )
  {
    ...
    *(_QWORD *)(result + 24) = 0LL;
    v11 = qword_18016D250 + 48;
    *(_DWORD *)(result + 4) = a1;
    *(_DWORD *)(result + 32) = 1;
    RtlAcquireSRWLockExclusive(v11, v8, v9, v10);
    v12 = qword_18016D250;
    v13 = qword_18016D250 + 32;
    for ( j = *(_QWORD **)(qword_18016D250 + 32); j != (_QWORD *)v13; j = (_QWORD *)*j )
    {
    ...
    v16 = *(__int64 ***)(qword_18016D250 + 40);
    v17 = (__int64 *)(v6 + 8);
    if ( *v16 != (__int64 *)v13 )
      __fastfail(3u);
    *v17 = v13;
