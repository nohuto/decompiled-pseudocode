/*
 * XREFs of EtwpAddLogHeaderToLogFile @ 0x180056508
 * Callers:
 ...
 *     EtwpAddProviderTrackingInfo @ 0x180056BC8 (EtwpAddProviderTrackingInfo.c)
 ...
 *     ZwQueryVolumeInformationFile @ 0x18009D9D0 (ZwQueryVolumeInformationFile.c)
