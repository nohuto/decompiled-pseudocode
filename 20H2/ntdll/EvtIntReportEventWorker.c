/*
 * XREFs of EvtIntReportEventWorker @ 0x18004ED80
 * Callers:
 *     EvtIntReportEventAndSourceAsync @ 0x18004ED10 (EvtIntReportEventAndSourceAsync.c)
 *     EvtIntReportAuthzEventAndSourceAsync @ 0x180111B80 (EvtIntReportAuthzEventAndSourceAsync.c)
 * Callees:
 ...
 *     _local_unwind @ 0x18008D110 (_local_unwind.c)
 */
        ...
        __int64 a11)
{
  ...
  if ( v13 )
  {
    ...
    {
      v34 = 87;
      local_unwind(v42, &loc_18004F0D6);
      goto LABEL_29;
    }
