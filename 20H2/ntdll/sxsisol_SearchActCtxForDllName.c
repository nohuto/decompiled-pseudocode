        ...
        unsigned __int16 *a5)
{
  ...
  _QWORD v64[14]; // [rsp+80h] [rbp-80h] BYREF
  ...
  *(_OWORD *)Src = v8;
  ...
  v58 = (volatile signed __int32 *)v64[7];
...
LABEL_56:
  ...
  if ( (v64[8] & 0x200000000LL) == 0 )
    v20 = v19;
  AssemblyStorageRoot = RtlGetAssemblyStorageRoot(v20, v64[7], v64[8], (unsigned int)&v60, v56, (__int64)&v59);
...
LABEL_38:
          ...
          if ( v25 )
          {
            while ( 1 )
            {
              v45 = *(unsigned __int16 *)(v22 + 8LL * v35);
              v46 = v45 + *a5 + 2LL;
              v62 = (void *)(v64[5] + *(unsigned int *)(v22 + 8LL * v35 + 4));
              if ( v46 > 0xFFFE )
                break;
...
LABEL_39:
            ...
            if ( (v36 & 8) != 0 )
            {
              CharInUnicodeString = RtlFindCharInUnicodeString(1LL, Src, &RtlDosPathSeperatorsString, &v57);
              ...
              v38 = -2 - v57 + LOWORD(Src[0]);
              v37 = (char *)Src[1] + 2 * ((unsigned __int64)v57 >> 1) + 2;
            }
            else
            {
              v37 = (char *)Src[1];
