/*
 * XREFs of RtlpScanHeapAllocBlocks @ 0x1800F861C
 * Callers:
 ...
 *     RtlpGetBlockInfo @ 0x1800F807C (RtlpGetBlockInfo.c)
 *     RtlpGetHeapBlock @ 0x1800F80C8 (RtlpGetHeapBlock.c)
 */
...
char RtlpScanHeapAllocBlocks()
{
        ...
        if ( HeapBlock )
        {
          ...
          if ( !v8 )
          {
            ...
            if ( *(_QWORD *)(*(_QWORD *)v7 + 8LL) != v7
              ...
              || (*v10 = v9,
                  *(_QWORD *)(v9 + 8) = v10,
                  v11 = (__int64 *)qword_18016ACA8,
                  *(__int64 **)qword_18016ACA8 != &RtlpBusyList) )
            {
              __fastfail(3u);
            }
  ...
  if ( *((_QWORD *)&xmmword_18016ADE0 + 1) )
    (*((void (__fastcall **)(_QWORD, _QWORD, _QWORD, _QWORD, _DWORD, _QWORD))&xmmword_18016ADE0 + 1))(
      0LL,
      0LL,
      0LL,
      0LL,
