/*
 * XREFs of _LdrpInitialize @ 0x180074C8C
 * Callers:
 *     LdrpInitialize @ 0x180074C38 (LdrpInitialize.c)
 * Callees:
 ...
 *     RtlInitializeHeapGC @ 0x18007F088 (RtlInitializeHeapGC.c)
...
LABEL_2:
  ...
  while ( 1 )
  {
    ...
    if ( !result )
    {
      ...
      qword_1801812C0 = (__int64)&RtlpDynamicFunctionTable;
