/*
 * XREFs of ?RtlpFlsDataCleanup@@YAXPEAU_RTLP_FLS_CONTEXT@@PEAU_RTLP_FLS_DATA@@K@Z @ 0x18005DDC4
 * Callers:
 *     LdrShutdownThread @ 0x180017450 (LdrShutdownThread.c)
 *     LdrShutdownProcess @ 0x18005DAA0 (LdrShutdownProcess.c)
 *     RtlProcessFlsData @ 0x18005DDB0 (RtlProcessFlsData.c)
 * Callees:
...
void __fastcall RtlpFlsDataCleanup(struct _RTLP_FLS_CONTEXT *a1, struct _RTLP_FLS_DATA *a2, char a3)
{
  ...
  if ( (a3 & 1) != 0 )
  {
    ...
    {
      v5 = 17;
      v6 = (unsigned int)qword_18016D358;
      do
      {
