 ...
 *     ZwConnectPort @ 0x18009E4A0 (ZwConnectPort.c)
...
__int64 __fastcall CsrpConnectToServer(_WORD *Src, int a2, __int64 *a3, int a4, _DWORD *a5)
{
  ...
  *((_WORD *)v14 + 12) = aSharedsection[12];
  v36 = 48;
  CsrPortName = (_WORD)v14 - qword_18016CC28 + 26;
  v38 = &CsrPortName;
  v37 = 0LL;
  v39 = 64;
  v40 = 0LL;
  ...
  if ( v15 < 0 )
  {
    RtlFreeHeap(CsrHeap, 0LL, qword_18016CC28);
    return (unsigned int)v15;
  }
  *(_QWORD *)v14 = *(_QWORD *)L"ApiPort";
  *((_DWORD *)v14 + 2) = *(_DWORD *)L"ort";
  *((_WORD *)v14 + 6) = aApiport[6];
  CsrPortName = (_WORD)v14 - qword_18016CC28 + 14;
  v46 = 2;
  v47 = 257;
  v23 = 0x10000LL;
