/*
 * XREFs of LdrpLogCFGModuleInfoTelemetry @ 0x180084EA8
 * Callers:
...
int __fastcall LdrpLogCFGModuleInfoTelemetry(__int64 a1, __int64 a2)
{
  ...
  if ( v2->ProcessHeap )
  {
    ...
    {
      LODWORD(v2) = tlgKeywordOn(&dword_1801664E8, 0x200000000000LL);
      if ( (_BYTE)v2 )
      {
        v15 = 0;
        v17[1] = 0;
        ...
        v19 = 8;
        v28 = 8;
        LODWORD(v2) = tlgWriteTransfer_EtwEventWriteTransfer(v5, (int)&dword_180131D4A, 8, v6, 8u, &v12);
      }
    }
  }
  return (int)v2;
