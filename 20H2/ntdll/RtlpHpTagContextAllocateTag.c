  ...
  if ( v7 )
  {
    ...
    *(_OWORD *)(v7 + 16) = v9;
    ...
    else
    {
      ...
      {
        *(_WORD *)(v8 + 40) = FreeTag;
        *(_QWORD *)(qword_18016AB18 + 8LL * FreeTag - 8) = v8;
        v21 = *(_QWORD *)(v8 + 8) & (-1LL << (dword_18016AB0C & 0x1F));
        v13 = qword_18016AB10;
        v14 = (37
             * (BYTE6(v21)
              + 37
             ...
             + HIBYTE(v21)) & (((unsigned int)dword_18016AB0C >> 5) - 1);
        v15 = (signed __int64 *)(qword_18016AB10 + 8 * v14);
        _m_prefetchw(v15);
        v16 = *v15;
        do
        {
