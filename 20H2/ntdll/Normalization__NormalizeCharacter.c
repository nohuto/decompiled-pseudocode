/*
 * XREFs of Normalization__NormalizeCharacter @ 0x18008046C
 * Callers:
 *     Normalization__Normalize @ 0x180080338 (Normalization__Normalize.c)
 *     Normalization__AppendDecomposedChar @ 0x1800FFF1C (Normalization__AppendDecomposedChar.c)
 * Callees:
 *     NormBuffer__AppendEx @ 0x1800805A0 (NormBuffer__AppendEx.c)
 *     NormBuffer__Append @ 0x1800805EC (NormBuffer__Append.c)
 *     ComposeHangulLV @ 0x1800FF748 (ComposeHangulLV.c)
 *     ComposeHangulLVT @ 0x1800FF778 (ComposeHangulLVT.c)
 *     IsHangulLV @ 0x1800FF7AC (IsHangulLV.c)
 *     NormBuffer__GetLastChar @ 0x1800FF8D4 (NormBuffer__GetLastChar.c)
 *     NormBuffer__Insert @ 0x1800FF96C (NormBuffer__Insert.c)
 ...
 *     NormBuffer__ReplaceLastStartBasePair @ 0x1800FFD4C (NormBuffer__ReplaceLastStartBasePair.c)
 *     NormBuffer__RewindOutputCharacter @ 0x1800FFE0C (NormBuffer__RewindOutputCharacter.c)
 *     Normalization__AppendDecomposedChar @ 0x1800FFF1C (Normalization__AppendDecomposedChar.c)
