/*
 * XREFs of RtlpFcQueryFeatureConfigurationFromBufferSet @ 0x18011C050
 * Callers:
 *     RtlQueryFeatureConfiguration @ 0x18005CBC0 (RtlQueryFeatureConfiguration.c)
 * Callees:
 *     RtlpFcValidateFeatureConfigurationType @ 0x18005CC68 (RtlpFcValidateFeatureConfigurationType.c)
 *     RtlpFcQueryFeatureConfigurationFromBuffers @ 0x18011C2F0 (RtlpFcQueryFeatureConfigurationFromBuffers.c)
 */
