/*
 * XREFs of LdrpLogVsmEnclaveLdrLoadEnclaveModuleTelemetry @ 0x1800D01B4
 * Callers:
  ...
  if ( v1->ProcessHeap )
  {
    ...
    if ( (unsigned int)dword_180166590 > 4 )
    {
      ...
      if ( (_BYTE)v1 )
      {
        ...
        v7 = a1;
        v13 = v5;
        LOBYTE(v1) = tlgWriteTransfer_EtwEventWriteTransfer(v3, (unsigned __int8 *)dword_1801317E0, v4, v5, v5, &v8);
      }
    }
  }
  return (char)v1;
