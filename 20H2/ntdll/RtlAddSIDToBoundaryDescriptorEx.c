/*
 * XREFs of RtlAddSIDToBoundaryDescriptorEx @ 0x18007F740
 * Callers:
 *     RtlAddSIDToBoundaryDescriptor @ 0x18007F730 (RtlAddSIDToBoundaryDescriptor.c)
 *     RtlAddIntegrityLabelToBoundaryDescriptor @ 0x1800EB3B0 (RtlAddIntegrityLabelToBoundaryDescriptor.c)
 * Callees:
