...
void __fastcall RtlpHeapTrkTrackRemove(__int64 a1, __int64 a2)
{
  ...
  v7 = v6 & 0xF;
  v8 = v6;
  RtlAcquireSRWLockExclusive(*(PRTL_SRWLOCK *)(qword_18016DBE0 + 8 * v7));
  v9 = 2 * v8;
  for ( i = *(_QWORD **)(qword_18016DA70 + 8 * v9); i != (_QWORD *)(qword_18016DA70 + 8 * v9); i = (_QWORD *)*i )
  {
    v4 = i;
    if ( i[3] == a2 && i[2] == a1 )
    {
  ...
  RtlReleaseSRWLockExclusive(*(PRTL_SRWLOCK *)(qword_18016DBE0 + 8 * v7));
  if ( v5 )
  {
    v11 = (PVOID **)v4[4];
    if ( v11 )
