/*
 * XREFs of RtlpMuiRegGetInstalledLangInfoIndex @ 0x180079AA8
 * Callers:
 *     LdrpConvertLangFallbackListToMultiSz @ 0x18003681C (LdrpConvertLangFallbackListToMultiSz.c)
 *     _RtlpMuiRegValidateLIPLanguage @ 0x18010798C (_RtlpMuiRegValidateLIPLanguage.c)
 *     _RtlpMuiRegValidatePartialLanguage @ 0x180107BCC (_RtlpMuiRegValidatePartialLanguage.c)
 * Callees:
 *     <none>
 */
