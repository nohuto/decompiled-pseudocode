/*
 * XREFs of wcstoxq @ 0x18008E074
 * Callers:
 *     _wcstoi64 @ 0x18008E010 (_wcstoi64.c)
 *     _wcstoui64 @ 0x18008E040 (_wcstoui64.c)
 * Callees:
 *     _errno @ 0x180085410 (_errno.c)
 *     _invalid_parameter @ 0x18008C268 (_invalid_parameter.c)
 *     _iswctype_l @ 0x18008FC80 (_iswctype_l.c)
 *     _wchartodigit @ 0x180093C88 (_wchartodigit.c)
 */
