/*
 * XREFs of RtlStringCchCopyExW @ 0x1800D03A8
 * Callers:
 ...
 *     RtlpGetCompleteLanguageFallback @ 0x1800F077C (RtlpGetCompleteLanguageFallback.c)
 * Callees:
 *     RtlStringCopyWorkerW_1 @ 0x1800D047C (RtlStringCopyWorkerW_1.c)
 */
