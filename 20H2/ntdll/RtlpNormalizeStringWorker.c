/*
 * XREFs of RtlpNormalizeStringWorker @ 0x1800802B0
 * Callers:
 *     RtlNormalizeString @ 0x180080230 (RtlNormalizeString.c)
 * Callees:
 *     Normalization__Normalize @ 0x180080338 (Normalization__Normalize.c)
 *     Normalization__GuessCharCountBySize @ 0x1801004E0 (Normalization__GuessCharCountBySize.c)
 */
