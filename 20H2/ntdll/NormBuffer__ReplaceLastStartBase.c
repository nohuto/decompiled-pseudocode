/*
 * XREFs of NormBuffer__ReplaceLastStartBase @ 0x1800FFCD4
 * Callers:
 *     Normalization__NormalizeCharacter @ 0x18008046C (Normalization__NormalizeCharacter.c)
 * Callees:
 *     NormBuffer__AppendAndSortDecomposed @ 0x1800FF7E4 (NormBuffer__AppendAndSortDecomposed.c)
 *     Normalization__GetSecondAndThirdDecomposedCharPlane0 @ 0x1801003A0 (Normalization__GetSecondAndThirdDecomposedCharPlane0.c)
 */
