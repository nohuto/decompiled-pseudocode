/*
 * XREFs of RtlAddAtomToAtomTableEx @ 0x18004C47C
 * Callers:
 *     RtlAddAtomToAtomTable @ 0x18004C470 (RtlAddAtomToAtomTable.c)
 * Callees:
 *     RtlReleaseSRWLockExclusive @ 0x180012C70 (RtlReleaseSRWLockExclusive.c)
 *     RtlFreeHeap @ 0x180024760 (RtlFreeHeap.c)
 *     RtlpHashStringToAtom @ 0x18004C7D0 (RtlpHashStringToAtom.c)
 *     RtlGetIntegerAtom @ 0x18004C910 (RtlGetIntegerAtom.c)
      ...
      *(_QWORD *)&Size[1] = v11;
      if ( v11 )
      {
        ...
        *(_WORD *)(v12 + 2LL * (unsigned __int8)v13 + 18) = 0;
        ...
        {
          RtlFreeHeap((__int64)NtCurrentPeb()->ProcessHeap, 0, *(__int64 *)&Size[1]);
          v8 = -1073741801;
          goto LABEL_26;
        }
