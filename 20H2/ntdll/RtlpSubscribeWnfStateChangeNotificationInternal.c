/*
 * XREFs of RtlpSubscribeWnfStateChangeNotificationInternal @ 0x1800424EC
 * Callers:
 *     RtlSubscribeWnfStateChangeNotification @ 0x1800424A0 (RtlSubscribeWnfStateChangeNotification.c)
 *     RtlpFcStartSubscriptionManager @ 0x180044EBC (RtlpFcStartSubscriptionManager.c)
 *     RtlRegisterForWnfMetaNotification @ 0x180063C80 (RtlRegisterForWnfMetaNotification.c)
        ...
        int a9)
{
  ...
  {
    WnfUserSubscription = RtlRunOnceExecuteOnce(&stru_18016D4F0, RtlpInitializeWnf, 0LL, 0LL);
