/*
 * XREFs of InsertDeviceFirmwareLockHandlerEntry @ 0x1C003075C
 * Callers:
 *     AcpiRegisterDeviceFirmwareLockHandler @ 0x1C00A2E7C (AcpiRegisterDeviceFirmwareLockHandler.c)
 * Callees:
 *     FindDeviceFirmwareLockHandlerEntryLocked @ 0x1C00307F4 (FindDeviceFirmwareLockHandlerEntryLocked.c)
 */
