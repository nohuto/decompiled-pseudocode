/*
 * XREFs of ACPIRegisterForDeviceNotificationsByPowerInfo @ 0x1C000DC64
 * Callers:
 *     ACPIRegisterForDeviceNotifications @ 0x1C000DC20 (ACPIRegisterForDeviceNotifications.c)
 *     ACPIRegisterForDeviceNotificationsByDeviceExtension @ 0x1C005C4F8 (ACPIRegisterForDeviceNotificationsByDeviceExtension.c)
 * Callees:
 *     <none>
 */
