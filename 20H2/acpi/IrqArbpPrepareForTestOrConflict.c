/*
 * XREFs of IrqArbpPrepareForTestOrConflict @ 0x1C0092040
 * Callers:
 *     IrqArbTestAllocation @ 0x1C0095810 (IrqArbTestAllocation.c)
 *     IrqArbRetestAllocation @ 0x1C00B6E30 (IrqArbRetestAllocation.c)
 *     IrqArbpQueryConflictIsa @ 0x1C00B720C (IrqArbpQueryConflictIsa.c)
 * Callees:
 *     _guard_dispatch_icall_nop @ 0x1C0031E80 (_guard_dispatch_icall_nop.c)
 *     memset @ 0x1C0032180 (memset.c)
 *     LinkNodeCopyData @ 0x1C0091FE4 (LinkNodeCopyData.c)
 *     IrqArbpUnreferenceArbitrationList @ 0x1C0093CAC (IrqArbpUnreferenceArbitrationList.c)
 *     LinkNodeClearPossibleData @ 0x1C0093F8C (LinkNodeClearPossibleData.c)
 *     ProcessorCopyData @ 0x1C00941D0 (ProcessorCopyData.c)
 *     ProcessorpClearData @ 0x1C0094540 (ProcessorpClearData.c)
