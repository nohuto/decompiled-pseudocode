/*
 * XREFs of ACPIEmQueryEnableD3ColdOnSurpriseRemovalRule @ 0x1C00B5E80
 * Callers:
 ...
 * Callees:
 *     ACPIComputeDeviceIdMutiStringLength @ 0x1C0060784 (ACPIComputeDeviceIdMutiStringLength.c)
 */
