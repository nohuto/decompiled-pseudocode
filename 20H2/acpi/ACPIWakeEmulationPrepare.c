/*
 * XREFs of ACPIWakeEmulationPrepare @ 0x1C00B603C
 * Callers:
 *     ACPIDeviceInitializePowerRequest @ 0x1C001C784 (ACPIDeviceInitializePowerRequest.c)
 * Callees:
 *     ACPICreateWakeInterruptRegistrationEntries @ 0x1C00B5F90 (ACPICreateWakeInterruptRegistrationEntries.c)
 */
