/*
 * XREFs of PnpCmResourcesToBiosResources @ 0x1C0090640
 * Callers:
 ...
 *     PnpiCmResourceToBiosIrq @ 0x1C0090864 (PnpiCmResourceToBiosIrq.c)
 *     PnpiCmResourceToBiosIoPort @ 0x1C00908C4 (PnpiCmResourceToBiosIoPort.c)
 *     PnpiCmResourceToBiosAddress @ 0x1C00B4728 (PnpiCmResourceToBiosAddress.c)
 *     PnpiCmResourceToBiosAddressDouble @ 0x1C00B4814 (PnpiCmResourceToBiosAddressDouble.c)
 *     PnpiCmResourceToBiosAddressQuad @ 0x1C00B48F8 (PnpiCmResourceToBiosAddressQuad.c)
 *     PnpiCmResourceToBiosExtendedIrq @ 0x1C00B49C0 (PnpiCmResourceToBiosExtendedIrq.c)
 *     PnpiCmResourceToBiosGpioInterruptIoDescriptor @ 0x1C00B4AB0 (PnpiCmResourceToBiosGpioInterruptIoDescriptor.c)
 *     PnpiCmResourceToBiosIoFixedPort @ 0x1C00B4B0C (PnpiCmResourceToBiosIoFixedPort.c)
 *     PnpiCmResourceToBiosMemory @ 0x1C00B4B5C (PnpiCmResourceToBiosMemory.c)
 *     PnpiCmResourceToBiosMemory32Fixed @ 0x1C00B4BC8 (PnpiCmResourceToBiosMemory32Fixed.c)
 */
