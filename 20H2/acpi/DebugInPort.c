/*
 * XREFs of DebugInPort @ 0x1C0065EB0
 * Callers:
 *     DebugI @ 0x1C0065E50 (DebugI.c)
 *     DebugID @ 0x1C0065E70 (DebugID.c)
 *     DebugIW @ 0x1C0065E90 (DebugIW.c)
 * Callees:
...
LABEL_13:
  ...
  if ( byte_1C0083498 || !(unsigned __int8)IsNumber(a1, 16LL) )
    goto LABEL_13;
