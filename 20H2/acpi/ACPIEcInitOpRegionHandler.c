/*
 * XREFs of ACPIEcInitOpRegionHandler @ 0x1C00267F8
 * Callers:
 ...
 *     ACPIEcDisconnectGpeVector @ 0x1C00AE620 (ACPIEcDisconnectGpeVector.c)
 *     ACPIEcDisconnectGpioInterrupt @ 0x1C00AE650 (ACPIEcDisconnectGpioInterrupt.c)
 */
