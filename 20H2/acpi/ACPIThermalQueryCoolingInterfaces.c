/*
 * XREFs of ACPIThermalQueryCoolingInterfaces @ 0x1C000E3DC
 * Callers:
...
__int64 __fastcall ACPIThermalQueryCoolingInterfaces(__int64 a1)
{
  ...
  if ( v3 == 259 )
  {
    AttachedDeviceReference = IoGetAttachedDeviceReference(*(PDEVICE_OBJECT *)(a1 + 744));
    ...
    if ( RootDeviceExtension )
      v5 = *(_QWORD *)(RootDeviceExtension + 728);
    else
      v5 = 0LL;
    v3 = PoCreateThermalRequest(&v15, AttachedDeviceReference, v5, v12, 0x80000000);
    if ( v3 < 0 )
      goto LABEL_16;
    ...
    if ( PoolWithTag )
    {
      ...
      *((_QWORD *)v7 + 2) = v7 + 16;
      *((_QWORD *)v7 + 4) = a1;
      WorkItem = IoAllocateWorkItem(*(PDEVICE_OBJECT *)(a1 + 728));
      *((_QWORD *)v7 + 6) = WorkItem;
      if ( WorkItem )
      {
        *((_QWORD *)v7 + 8) = v15;
        v7[40] = PoGetThermalRequestSupport(v15, 0LL);
        v7[41] = PoGetThermalRequestSupport(v15, 1LL);
        v9 = KeAcquireSpinLockRaiseToDpc(&AcpiThermalConstraintLock);
        if ( *(_BYTE *)(a1 + 624) && !*(_QWORD *)(a1 + 616) )
        {
          *(_QWORD *)(a1 + 616) = v7;
          v10 = (_QWORD *)qword_1C00819F8;
          if ( *(__int64 **)qword_1C00819F8 != &AcpiThermalClientList )
            __fastfail(3u);
          *(_QWORD *)v7 = &AcpiThermalClientList;
          *((_QWORD *)v7 + 1) = v10;
          *v10 = v7;
          qword_1C00819F8 = (__int64)v7;
          v7 = 0LL;
        }
        v3 = *(_QWORD *)(a1 + 616) == 0LL ? 0xC00000BB : 0;
