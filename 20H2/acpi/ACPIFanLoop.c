/*
 * XREFs of ACPIFanLoop @ 0x1C000D1CC
 * Callers:
...
LABEL_30:
    ...
    if ( (v12 & 4) != 0 )
    {
      ...
      else
      {
        ...
        *(_QWORD *)(a1 + 272) = 0LL;
        v10 = 0;
        v18 = AMLIAsyncEvalObject(*(_QWORD *)(a1 + 232), (int)a1 + 240, 0, 0, (__int64)ACPIFanFSTCallback, a1);
        if ( v18 != 259 )
    ...
    else
    {
      *(_DWORD *)(a1 + 192) = v12 | 4;
      ...
      v15 = (_QWORD *)qword_1C0081FB8;
      v7 = v14;
      v16 = (_QWORD *)(a1 + 200);
      if ( *(__int64 **)qword_1C0081FB8 != &AcpiFanList )
        goto LABEL_30;
      *(_QWORD *)(a1 + 208) = qword_1C0081FB8;
      *v16 = &AcpiFanList;
      *v15 = v16;
      qword_1C0081FB8 = a1 + 200;
      KeReleaseSpinLock(&AcpiFanLock, v7);
    }
  }
