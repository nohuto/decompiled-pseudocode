/*
 * XREFs of RestartContext @ 0x1C0023B90
 * Callers:
 ...
 *     RestartCtxtCallback @ 0x1C0023A90 (RestartCtxtCallback.c)
 *     AMLIRestartContext @ 0x1C00634E0 (AMLIRestartContext.c)
 *     SleepQueueDpc @ 0x1C00672E0 (SleepQueueDpc.c)
 *     AsyncCallBack @ 0x1C0068148 (AsyncCallBack.c)
 *     TimeoutCallback @ 0x1C0068670 (TimeoutCallback.c)
 *     SyncLoadDDB @ 0x1C00BE308 (SyncLoadDDB.c)
 * Callees:
 *     InsertReadyQueue @ 0x1C00043E0 (InsertReadyQueue.c)
 *     OSQueueWorkItem @ 0x1C002B6F4 (OSQueueWorkItem.c)
 */
