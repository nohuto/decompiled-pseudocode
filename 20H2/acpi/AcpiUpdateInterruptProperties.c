/*
 * XREFs of AcpiUpdateInterruptProperties @ 0x1C00AF240
 * Callers:
 *     <none>
 * Callees:
 ...
 *     ProcessorUpdateInterruptProperties @ 0x1C00B6A68 (ProcessorUpdateInterruptProperties.c)
 *     IrqArbUpdateInterruptProperties @ 0x1C00B6E94 (IrqArbUpdateInterruptProperties.c)
 *     IcUpdateInterruptProperties @ 0x1C00B7384 (IcUpdateInterruptProperties.c)
 */
