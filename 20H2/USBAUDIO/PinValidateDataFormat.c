/*
 * XREFs of PinValidateDataFormat @ 0x1C0024170
 * Callers:
 ...
 *     PinMIDIDataFormatIntersection @ 0x1C0024D90 (PinMIDIDataFormatIntersection.c)
 * Callees:
 *     IsSampleRateInRange @ 0x1C0024048 (IsSampleRateInRange.c)
