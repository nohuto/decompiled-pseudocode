...
__int64 wil_InitializeFeatureStaging()
{
  ...
  v0 = Feature_Servicing_AudioRegressionFix__private_descriptor;
  v10 = RtlQueryFeatureConfigurationChangeStamp();
  v1 = 0;
  v2 = Feature_Servicing_AudioRegressionFix__private_descriptor;
...
LABEL_28:
  *(_QWORD *)v6 = v7;
  for ( v2 += 4; v2 < (int **)&wil_details_featureDescriptors_z; ++v2 )
  {
    v6 = *v2;
    if ( *v2 )
    {
...
LABEL_40:
    ...
    {
      for ( v0 += 4; v0 < (int **)&wil_details_featureDescriptors_z; ++v0 )
      {
        if ( *v0 )
          goto LABEL_40;
      }
