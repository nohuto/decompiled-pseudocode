/*
 * XREFs of DeviceStart @ 0x1C00228A0
 * Callers:
 *     <none>
 * Callees:
 ...
 *     RegistryGetIdleInfo @ 0x1C002B23C (RegistryGetIdleInfo.c)
 *     InitializeIrpThreadAndQueue @ 0x1C002B9D0 (InitializeIrpThreadAndQueue.c)
 */
