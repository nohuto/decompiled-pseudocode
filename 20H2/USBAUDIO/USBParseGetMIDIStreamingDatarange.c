/*
 * XREFs of USBParseGetMIDIStreamingDatarange @ 0x1C0031240
 * Callers:
        ...
        _QWORD *PoolWithTag)
{
  ...
  if ( v8 >= 0 )
  {
    ...
    if ( v20 )
    {
      ...
      *((_OWORD *)v11 + 1) = xmmword_1C00162B0;
      *((_DWORD *)v11 + 24) = ((v26 >> 31) & 8) + 8;
      *((_OWORD *)v11 + 2) = xmmword_1C00162C0;
      *((_OWORD *)v11 + 3) = xmmword_1C00162D0;
      *((_OWORD *)v11 + 4) = xmmword_1C00162E0;
      *((_OWORD *)v11 + 5) = xmmword_1C00162F0;
      *a5 = v11;
      v27 = 88;
