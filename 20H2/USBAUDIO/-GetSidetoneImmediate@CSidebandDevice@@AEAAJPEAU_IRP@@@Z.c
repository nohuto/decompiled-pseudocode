/*
 * XREFs of ?GetSidetoneImmediate@CSidebandDevice@@AEAAJPEAU_IRP@@@Z @ 0x1C000C2C4
 * Callers:
 ...
 *     PropertyGetBooleanSideband @ 0x1C0028D98 (PropertyGetBooleanSideband.c)
 *     PropertyGetDbLevelSideband @ 0x1C002948C (PropertyGetDbLevelSideband.c)
 */
