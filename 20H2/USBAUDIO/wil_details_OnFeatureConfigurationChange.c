...
__int64 wil_details_OnFeatureConfigurationChange()
{
  ...
  for ( i = Feature_Servicing_AudioRegressionFix__private_descriptor; i < (int **)&wil_details_featureDescriptors_z; ++i )
  {
    if ( *i )
    {
LABEL_22:
...
LABEL_15:
      ...
      for ( i += 4; i < (int **)&wil_details_featureDescriptors_z; ++i )
      {
        if ( *i )
          goto LABEL_22;
      }
