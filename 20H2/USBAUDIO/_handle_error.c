/*
 * XREFs of _handle_error @ 0x1C00121BC
 * Callers:
 *     log10 @ 0x1C0011D48 (log10.c)
 *     _pow_special @ 0x1C0012300 (_pow_special.c)
 * Callees:
 *     __security_check_cookie @ 0x1C0011C50 (__security_check_cookie.c)
 *     _call_matherr @ 0x1C0012088 (_call_matherr.c)
 *     _exception_enabled @ 0x1C00120F8 (_exception_enabled.c)
 *     _raise_exc @ 0x1C00124D0 (_raise_exc.c)
 *     _set_errno_from_matherr @ 0x1C0012790 (_set_errno_from_matherr.c)
