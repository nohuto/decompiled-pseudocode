/*
 * XREFs of PinSetDeviceState @ 0x1C0024CB0
 * Callers:
 ...
 *     WmiLogStreamStateChange @ 0x1C0003624 (WmiLogStreamStateChange.c)
 ...
 *     DecrementActivePinCount @ 0x1C0024C28 (DecrementActivePinCount.c)
 */
