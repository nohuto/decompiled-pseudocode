/*
 * XREFs of ?ndisTranslateResources@@YAHPEAU_NDIS_MINIPORT_BLOCK@@HT_LARGE_INTEGER@@PEAT2@PEAPEAU_CM_PARTIAL_RESOURCE_DESCRIPTOR@@@Z @ 0x1C003BD24
 * Callers:
 ...
 *     ?ndisImmediateReadWriteSharedMemory@@YAXPEAXKPEAEKE@Z @ 0x1C00BDE30 (-ndisImmediateReadWriteSharedMemory@@YAXPEAXKPEAEKE@Z.c)
