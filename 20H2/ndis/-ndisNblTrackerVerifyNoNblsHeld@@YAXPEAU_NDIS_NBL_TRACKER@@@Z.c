/*
 * XREFs of ?ndisNblTrackerVerifyNoNblsHeld@@YAXPEAU_NDIS_NBL_TRACKER@@@Z @ 0x1C0074480
 * Callers:
 ...
 *     ndisNblTrackerAreNblsOutstandingOnComponent @ 0x1C0073C58 (ndisNblTrackerAreNblsOutstandingOnComponent.c)
 */
