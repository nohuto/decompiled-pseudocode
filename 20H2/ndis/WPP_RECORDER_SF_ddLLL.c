/*
 * XREFs of WPP_RECORDER_SF_ddLLL @ 0x1C0034F04
 * Callers:
...
__int64 WPP_RECORDER_SF_ddLLL(__int64 a1, __int64 a2, __int64 a3, __int64 a4, int a5, ...)
{
  ...
  if ( (*((_DWORD *)WPP_GLOBAL_Control + 11) & 0x200000) != 0 && *((_BYTE *)WPP_GLOBAL_Control + 41) >= 4u )
    ndisWppFastTraceMessage(
      &WPP_a8d5194ea1de362605f2f80c2705a132_Traceguids,
      0xBu,
      va,
      4LL,
      va1,
      ...
      0LL);
  LOWORD(v7) = 11;
  return WppAutoLogTrace(a1, 4LL, 22LL, &WPP_a8d5194ea1de362605f2f80c2705a132_Traceguids, v7, (__int64 *)va);
}
