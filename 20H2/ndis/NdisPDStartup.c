/*
 * XREFs of NdisPDStartup @ 0x1C007E2A0
 * Callers:
 *     <none>
 * Callees:
    ...
    if ( v12 )
    {
      if ( ndisPDReferenceClientDriver(a1) )
      {
        ...
        *a5 = &unk_1C00C89F0;
        ...
        for ( i = *(__int64 **)(qword_1C00E4538 + 8); i != (__int64 *)(qword_1C00E4538 + 8); i = (__int64 *)*i )
        {
          if ( (_BYTE *)i[10] == a1 )
          {
            v10 = -1073740008;
        ...
        ClearBitsAndSet = RtlFindClearBitsAndSet((PRTL_BITMAP)(qword_1C00E4538 + 24), 1u, 0);
...
LABEL_19:
        ...
        *((_WORD *)v12 + 52) = ClearBitsAndSet;
        v16 = qword_1C00E4538 + 8;
        v17 = *(__int64 ***)(qword_1C00E4538 + 16);
        if ( *v17 != (__int64 *)(qword_1C00E4538 + 8) )
          __fastfail(3u);
        *v12 = v16;
        v12[1] = (__int64)v17;
        *v17 = v12;
