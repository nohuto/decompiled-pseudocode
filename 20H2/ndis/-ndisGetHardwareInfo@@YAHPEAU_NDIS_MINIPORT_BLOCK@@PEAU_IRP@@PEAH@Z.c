/*
 * XREFs of ?ndisGetHardwareInfo@@YAHPEAU_NDIS_MINIPORT_BLOCK@@PEAU_IRP@@PEAH@Z @ 0x1C006B42C
 * Callers:
 ...
 * Callees:
 *     NdisGetRssProcessorInformation @ 0x1C0026B60 (NdisGetRssProcessorInformation.c)
