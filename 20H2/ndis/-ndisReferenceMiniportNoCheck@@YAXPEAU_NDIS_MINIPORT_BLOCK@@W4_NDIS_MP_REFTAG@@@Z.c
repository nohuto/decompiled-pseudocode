/*
 * XREFs of ?ndisReferenceMiniportNoCheck@@YAXPEAU_NDIS_MINIPORT_BLOCK@@W4_NDIS_MP_REFTAG@@@Z @ 0x1C001982C
 * Callers:
 ...
 *     NdisMFreeSharedMemory @ 0x1C00612F0 (NdisMFreeSharedMemory.c)
 ...
 *     ?ndisSriovInterfaceReference@@YAXPEAX@Z @ 0x1C007C170 (-ndisSriovInterfaceReference@@YAXPEAX@Z.c)
 ...
 *     ?ndisQueuePowerIrp@@YAXPEAU_NDIS_MINIPORT_BLOCK@@PEAU_IRP@@@Z @ 0x1C00833C4 (-ndisQueuePowerIrp@@YAXPEAU_NDIS_MINIPORT_BLOCK@@PEAU_IRP@@@Z.c)
