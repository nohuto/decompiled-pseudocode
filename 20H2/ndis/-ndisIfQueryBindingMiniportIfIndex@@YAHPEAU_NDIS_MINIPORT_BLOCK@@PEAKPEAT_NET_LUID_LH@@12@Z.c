/*
 * XREFs of ?ndisIfQueryBindingMiniportIfIndex@@YAHPEAU_NDIS_MINIPORT_BLOCK@@PEAKPEAT_NET_LUID_LH@@12@Z @ 0x1C0104ECC
 * Callers:
        ...
        union _NET_LUID_LH *a5)
{
  ...
  *a4 = 0;
  ...
  {
    *a4 = a1->BaseMiniport->$CD0578741AE12013AECDCF3F95B08171::IfIndex;
