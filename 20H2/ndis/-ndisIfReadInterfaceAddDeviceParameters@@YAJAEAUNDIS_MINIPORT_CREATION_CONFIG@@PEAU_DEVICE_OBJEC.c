        ...
        struct _DEVICE_OBJECT *a2)
{
  ...
  if ( v4 >= 0 )
  {
    ...
    if ( (unsigned int)NetSetupPropertyBag::ReadUint64(
                         ...
                         (const struct _NETSETUPPROPKEY *)&unk_1C00CCA20,
                         (unsigned __int64 *)a1 + 2) )
      goto LABEL_17;
    if ( !(unsigned int)NetSetupPropertyBag::ReadUint32(
                          (NetSetupPropertyBag *)&v8,
                          (const struct _NETSETUPPROPKEY *)&unk_1C00CC9F0,
                          (unsigned int *)a1 + 11) )
      *((_BYTE *)a1 + 40) = 1;
    v9 = 0;
    if ( (unsigned int)NetSetupPropertyBag::ReadUint32(
                         (NetSetupPropertyBag *)&v8,
                         (const struct _NETSETUPPROPKEY *)&unk_1C00CCA38,
                         &v9) )
      goto LABEL_17;
    *((_BYTE *)a1 + 72) = (v9 & 2) != 0;
    if ( (unsigned int)NetSetupPropertyBag::ReadBoolean(
                         (NetSetupPropertyBag *)&v8,
                         (const struct _NETSETUPPROPKEY *)&unk_1C00CCA08,
                         (bool *)a1 + 73)
      || (unsigned int)NetSetupPropertyBag::ReadBoolean(
                         (NetSetupPropertyBag *)&v8,
                         (const struct _NETSETUPPROPKEY *)&unk_1C00CCA68,
                         (bool *)a1 + 74)
    ...
    if ( v4 >= 0 )
    {
      ...
      *((_QWORD *)a1 + 7) = v5;
      ...
      if ( !(unsigned int)NetSetupPropertyBag::ReadBoolean(
                            (NetSetupPropertyBag *)&v8,
                            (const struct _NETSETUPPROPKEY *)&unk_1C00CC9D8,
                            (bool *)a1 + 89)
        && (!*((_BYTE *)a1 + 89)
