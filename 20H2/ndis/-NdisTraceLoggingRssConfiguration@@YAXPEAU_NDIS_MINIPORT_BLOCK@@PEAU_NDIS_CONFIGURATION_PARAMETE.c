/*
 * XREFs of ?NdisTraceLoggingRssConfiguration@@YAXPEAU_NDIS_MINIPORT_BLOCK@@PEAU_NDIS_CONFIGURATION_PARAMETER@@H@Z @ 0x1C00220F4
 * Callers:
        ...
        __int64 a4)
{
  ...
  {
    v5 = tlgKeywordOn(&dword_1C00E3108, 0x200000000000LL, a3, a4);
    v10 = 0;
    if ( v5 )
    {
      if ( v8 )
