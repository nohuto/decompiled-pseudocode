/*
 * XREFs of NdisReferenceWithTag @ 0x1C000DE10
 * Callers:
 ...
 *     ?ndisReferenceRefNoCheck@@YAXPEAU_REFERENCE_EX@@E@Z @ 0x1C003F7D4 (-ndisReferenceRefNoCheck@@YAXPEAU_REFERENCE_EX@@E@Z.c)
