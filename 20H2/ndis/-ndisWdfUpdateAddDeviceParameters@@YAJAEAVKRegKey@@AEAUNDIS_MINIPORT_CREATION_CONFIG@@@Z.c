/*
 * XREFs of ?ndisWdfUpdateAddDeviceParameters@@YAJAEAVKRegKey@@AEAUNDIS_MINIPORT_CREATION_CONFIG@@@Z @ 0x1C0115E1C
 * Callers:
 ...
 *     ?IsIfBlockAvailable@@YA_NAEBU_GUID@@@Z @ 0x1C005F530 (-IsIfBlockAvailable@@YA_NAEBU_GUID@@@Z.c)
