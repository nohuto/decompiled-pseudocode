/*
 * XREFs of ?ndisMProcessDeferred@@YAXPEAU_NDIS_MINIPORT_BLOCK@@@Z @ 0x1C006F9D0
 * Callers:
 ...
 *     NdisIMRevertBack @ 0x1C0071620 (NdisIMRevertBack.c)
 *     ?ndisMDeferredDpc@@YAXPEAU_KDPC@@PEAX11@Z @ 0x1C00AA940 (-ndisMDeferredDpc@@YAXPEAU_KDPC@@PEAX11@Z.c)
