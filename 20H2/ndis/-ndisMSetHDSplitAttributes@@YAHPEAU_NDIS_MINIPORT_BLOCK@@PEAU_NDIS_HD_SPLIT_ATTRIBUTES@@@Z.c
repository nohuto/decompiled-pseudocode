/*
 * XREFs of ?ndisMSetHDSplitAttributes@@YAHPEAU_NDIS_MINIPORT_BLOCK@@PEAU_NDIS_HD_SPLIT_ATTRIBUTES@@@Z @ 0x1C0021ACC
 * Callers:
 ...
 *     NdisGetHypervisorInfo @ 0x1C0020F60 (NdisGetHypervisorInfo.c)
 */
