/*
 * XREFs of ?ndisPeriodicReceivesAddCpu@@YAXK@Z @ 0x1C00A3734
 * Callers:
...
void __fastcall ndisPeriodicReceivesAddCpu(ULONG a1)
{
  ...
  NdisInitializeTimer((PNDIS_TIMER)((char *)qword_1C00E4130 + v2), ndisPeriodicReceivesTimer, 0LL);
  KeSetTargetProcessorDpcEx((PKDPC)((char *)qword_1C00E4130 + v2 + 64), &ProcNumber);
  ndisWaitForKernelObject(&ndisPeriodicReceivesMutex);
  if ( byte_1C00E4101
    && (int)ndisCreateThread(v3, (void *)(unsigned int)v1, dword_1C00E4108, (PVOID *)qword_1C00E4148 + v1) < 0
