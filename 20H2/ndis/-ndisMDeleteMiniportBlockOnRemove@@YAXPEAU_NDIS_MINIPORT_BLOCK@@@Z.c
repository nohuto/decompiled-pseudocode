/*
 * XREFs of ?ndisMDeleteMiniportBlockOnRemove@@YAXPEAU_NDIS_MINIPORT_BLOCK@@@Z @ 0x1C006E6B0
 * Callers:
 ...
 *     ??1_NDIS_MINIPORT_BLOCK@@QEAA@XZ @ 0x1C006CA90 (--1_NDIS_MINIPORT_BLOCK@@QEAA@XZ.c)
 *     NdisFreeRefCount @ 0x1C00BE7B0 (NdisFreeRefCount.c)
 *     ?ndisAoAcFree@@YAXPEAU_NDIS_MINIPORT_BLOCK@@@Z @ 0x1C0113C60 (-ndisAoAcFree@@YAXPEAU_NDIS_MINIPORT_BLOCK@@@Z.c)
...
void __fastcall ndisMDeleteMiniportBlockOnRemove(struct _NDIS_MINIPORT_BLOCK *a1)
{
  ...
  NdisFreeRefCount((ULONG_PTR)a1->RefCountTracker);
  NsiRefCountTracker = a1->NsiRefCountTracker;
  a1->RefCountTracker = 0LL;
  NdisFreeRefCount((ULONG_PTR)NsiRefCountTracker);
