/*
 * XREFs of ndisQueueDpcWorkItem @ 0x1C0066FF0
 * Callers:
    ...
    *(_DWORD *)(v11 + 68) = 1;
    if ( a5 )
    {
      ...
      if ( HIBYTE(word_1C00E6184) )
      {
        ...
        WnodeEventItem = 48;
        *(_QWORD *)v18 = 0LL;
        *(_QWORD *)((char *)&v17 + 6) = qword_1C00E6178;
      ...
      *(_DWORD *)(v11 + 68) = v12 | 2;
      ndisInsertInWorkQueue(
        (struct _NDIS_WORK_QUEUE *)((char *)qword_1C00E4140 + 64 * (unsigned __int64)KeGetPcr()->Prcb.Number),
