/*
 * XREFs of ?ndisMInitializeScatterGatherDmaInternal@@YAHPEAXEKK@Z @ 0x1C0033984
 * Callers:
 *     NdisMRegisterScatterGatherDma @ 0x1C0033840 (NdisMRegisterScatterGatherDma.c)
 *     NdisMInitializeScatterGatherDma @ 0x1C00C11E0 (NdisMInitializeScatterGatherDma.c)
 * Callees:
