/*
 * XREFs of ?NdisPDPIClearReceiveFilter@@YAXPEAUNDIS_PD_FILTER_HANDLE__@@@Z @ 0x1C011AFF0
 * Callers:
 *     <none>
 * Callees:
 ...
 *     ??_GNDIS_PD_FILTER@@QEAAPEAXI@Z @ 0x1C0119260 (--_GNDIS_PD_FILTER@@QEAAPEAXI@Z.c)
 */
...
void __fastcall NdisPDPIClearReceiveFilter(struct NDIS_PD_FILTER_HANDLE__ *a1)
{
  ...
  v13.m_Lock = (KPushLockBase *)qword_1C00E4538;
