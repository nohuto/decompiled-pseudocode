/*
 * XREFs of ?ndisQueryStatisticsOids@@YAHPEAU_NDIS_MINIPORT_BLOCK@@PEAU_NDIS_USER_OPEN_CONTEXT@@PEAKIPEAEK2E3@Z @ 0x1C0012F28
 * Callers:
 ...
 *     ?ndisCheckForHangSupported@@YAEPEAU_NDIS_MINIPORT_BLOCK@@@Z @ 0x1C0019DF0 (-ndisCheckForHangSupported@@YAEPEAU_NDIS_MINIPORT_BLOCK@@@Z.c)
 *     ?ndisIsSatisfiedByOidGenStatistics@@YAKK@Z @ 0x1C0039C70 (-ndisIsSatisfiedByOidGenStatistics@@YAKK@Z.c)
