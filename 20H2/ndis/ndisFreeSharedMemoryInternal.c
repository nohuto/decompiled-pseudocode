/*
 * XREFs of ndisFreeSharedMemoryInternal @ 0x1C005F7EC
 * Callers:
        ...
        __int64 a5)
{
  ...
  if ( (unsigned __int64)v12 + 8 < 0x1000 )
  {
    ...
    if ( (*(_DWORD *)((a4 & 0xFFFFFFFFFFFFF000uLL) + 0xFFC))-- == 1 )
    {
      ...
      v14 = a3 != 0 ? 8 : 0;
      if ( (a4 & 0xFFFFFFFFFFFFF000uLL) == *(_QWORD *)((char *)v5 + v14 + 88) )
      {
        *(_DWORD *)((char *)v5 + (a3 != 0 ? 4 : 0) + 104) = 0;
        *(_QWORD *)((char *)v5 + v14 + 88) = 0LL;
      }
    }
  }
  else
