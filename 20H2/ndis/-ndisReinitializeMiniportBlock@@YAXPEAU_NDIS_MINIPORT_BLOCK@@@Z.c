/*
 * XREFs of ?ndisReinitializeMiniportBlock@@YAXPEAU_NDIS_MINIPORT_BLOCK@@@Z @ 0x1C0135F2C
 * Callers:
 ...
 *     ?ndisOpenULongRef@@YAXPEAU_ULONG_REFERENCE@@@Z @ 0x1C00AB850 (-ndisOpenULongRef@@YAXPEAU_ULONG_REFERENCE@@@Z.c)
