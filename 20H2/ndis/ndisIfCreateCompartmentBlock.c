/*
 * XREFs of ndisIfCreateCompartmentBlock @ 0x1C00347F0
 * Callers:
 ...
 *     ndisIfFindAvailableCompartmentId @ 0x1C00B2CAC (ndisIfFindAvailableCompartmentId.c)
 */
...
LABEL_8:
    ...
    if ( !v5 )
    {
      for ( i = qword_1C00E4B30;
            i != (struct _NDIS_IF_COMPARTMENT_BLOCK *)&qword_1C00E4B30;
      ...
      *(_QWORD *)(v17 + 8) = v12;
      *v16 = (__int64)v12;
      _InterlockedIncrement(&dword_1C00E6118);
    }
LABEL_14:
    KeReleaseSpinLock(&ndisIfListLock, v14);
    if ( v5 >= 0 )
