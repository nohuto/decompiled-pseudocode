/*
 * XREFs of ?ndisMCoIndicateReceiveNetBufferListsToNetBufferLists@@YAXPEAXPEAU_NET_BUFFER_LIST@@KK@Z @ 0x1C00BBF10
 * Callers:
        ...
        unsigned int a4)
{
  ...
  *(_BYTE *)((KeGetPcr()->Prcb.Number << 12) + *(_QWORD *)(*(_QWORD *)(v4 + 16) + 720LL)) = 1;
  ...
  {
    if ( (a4 & 2) == 0 )
      ndisReturnNetBufferListsInternal(*(struct _NDIS_MINIPORT_BLOCK **)(v4 + 120), a2, a4 & 1, 0LL);
  }
  else
  {
