/*
 * XREFs of ?ndisVerifyNdisTryAcquireRWLockRead@@YAEPEAU_NDIS_RW_LOCK_EX@@PEAU_LOCK_STATE_EX@@E@Z @ 0x1C00A4C60
 * Callers:
 *     <none>
 * Callees:
 ...
 *     NdisTryAcquireRWLockRead @ 0x1C00A4ED0 (NdisTryAcquireRWLockRead.c)
 */
