/*
 * XREFs of ?ndisCmGetThreadSessionId@@YAKPEAU_ETHREAD@@@Z @ 0x1C0013CE8
 * Callers:
 *     NdisGetThreadObjectCompartmentScope @ 0x1C0005DD0 (NdisGetThreadObjectCompartmentScope.c)
 ...
 *     ?ndisNsiGetAllThreadInformation@@YAJPEAU_NM_REQUEST_GET_ALL_PARAMETERS@@@Z @ 0x1C0006F00 (-ndisNsiGetAllThreadInformation@@YAJPEAU_NM_REQUEST_GET_ALL_PARAMETERS@@@Z.c)
 *     NdisGetThreadObjectCompartmentId @ 0x1C0007B30 (NdisGetThreadObjectCompartmentId.c)
