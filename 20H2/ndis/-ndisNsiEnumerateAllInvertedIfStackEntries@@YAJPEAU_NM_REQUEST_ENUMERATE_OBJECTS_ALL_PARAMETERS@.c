/*
 * XREFs of ?ndisNsiEnumerateAllInvertedIfStackEntries@@YAJPEAU_NM_REQUEST_ENUMERATE_OBJECTS_ALL_PARAMETERS@@@Z @ 0x1C00B1330
 * Callers:
 *     <none>
 * Callees:
  ...
  else if ( v4 )
  {
    ...
    if ( Interface )
    {
      *((_DWORD *)a1 + 22) = HIDWORD(Interface[81].Flink);
      if ( v5 )
      {
        v10 = (PVOID *)qword_1C00E4B58;
        while ( v10 != &qword_1C00E4B58 && v2 < v5 )
        {
          v11 = v10;
          v10 = (PVOID *)*v10;
          v12 = *((_DWORD *)v11 + 5);
