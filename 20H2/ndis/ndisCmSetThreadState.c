/*
 * XREFs of ndisCmSetThreadState @ 0x1C0009060
 * Callers:
 *     ?ndisNsiSetAllThreadInformation@@YAJPEAU_NM_REQUEST_SET_ALL_PARAMETERS@@@Z @ 0x1C00B0BD0 (-ndisNsiSetAllThreadInformation@@YAJPEAU_NM_REQUEST_SET_ALL_PARAMETERS@@@Z.c)
 *     NdisSetThreadObjectCompartmentScope @ 0x1C00F8810 (NdisSetThreadObjectCompartmentScope.c)
 *     NdisSetThreadObjectCompartmentId @ 0x1C00FF400 (NdisSetThreadObjectCompartmentId.c)
 * Callees:
