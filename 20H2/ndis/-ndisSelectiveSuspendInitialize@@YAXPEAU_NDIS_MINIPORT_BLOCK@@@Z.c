/*
 * XREFs of ?ndisSelectiveSuspendInitialize@@YAXPEAU_NDIS_MINIPORT_BLOCK@@@Z @ 0x1C01210DC
 * Callers:
    ...
    && DriverHandle->CancelIdleNotificationHandler )
  {
    ...
    if ( PoolWithTag )
    {
      ...
      *((_QWORD *)SelectiveSuspend + 75) = v5;
      if ( v5 )
      {
        *v5 = xmmword_1C00D2BE0;
        v5[1] = xmmword_1C00D2BF0;
        v5[2] = xmmword_1C00D2C00;
        v5[3] = xmmword_1C00D2C10;
        v5[4] = xmmword_1C00D2C20;
        v5[5] = xmmword_1C00D2C30;
        v5[6] = xmmword_1C00D2C40;
        *((_QWORD *)v5 + 14) = 0LL;
