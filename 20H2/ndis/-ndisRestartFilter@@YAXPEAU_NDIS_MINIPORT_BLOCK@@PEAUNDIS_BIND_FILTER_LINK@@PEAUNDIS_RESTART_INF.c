/*
 * XREFs of ?ndisRestartFilter@@YAXPEAU_NDIS_MINIPORT_BLOCK@@PEAUNDIS_BIND_FILTER_LINK@@PEAUNDIS_RESTART_INFORMATION@@@Z @ 0x1C00FFDB0
 * Callers:
 ...
 *     ?GetBindContext@BindState@Ndis@@QEAAPEAXXZ @ 0x1C01026BC (-GetBindContext@BindState@Ndis@@QEAAPEAXXZ.c)
