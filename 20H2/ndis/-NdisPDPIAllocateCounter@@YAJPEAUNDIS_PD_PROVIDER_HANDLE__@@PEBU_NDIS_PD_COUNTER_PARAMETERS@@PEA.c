/*
 * XREFs of ?NdisPDPIAllocateCounter@@YAJPEAUNDIS_PD_PROVIDER_HANDLE__@@PEBU_NDIS_PD_COUNTER_PARAMETERS@@PEAPEAUNDIS_PD_COUNTER_HANDLE__@@@Z @ 0x1C011AB50
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall NdisPDPIAllocateCounter(
        ...
        __int64 a4)
{
  struct NDIS_PD_COUNTER_HANDLE__ *v5; // rbx
  const wchar_t *v8; // r8
  int v9; // esi
  ...
  else
  {
    *a3 = 0LL;
      ...
      && (unsigned int)(a2->Type - 1) <= 2 )
    {
      ...
      *((_DWORD *)v5 + 17) = ndisGetNextPDCounterId();
      CounterName = a2->CounterName;
      if ( !CounterName
        || RtlCreateUnicodeString((PUNICODE_STRING)v5 + 6, (PCWSTR)CounterName)
        && RtlCreateUnicodeString((PUNICODE_STRING)v5 + 7, (PCWSTR)a2->CounterName) )
      {
        v9 = (*(__int64 (__fastcall **)(_QWORD, const struct _NDIS_PD_COUNTER_PARAMETERS *, struct NDIS_PD_COUNTER_HANDLE__ **))(*((_QWORD *)a1 + 10) + 40LL))(
               *((_QWORD *)a1 + 9),
               a2,
        ...
        if ( v9 >= 0 )
        {
          ndisSetupPDCounter((struct NDIS_PD_COUNTER *)v5, v16, a2->Type, (struct NDIS_PD_ASSOCIATION *)a1, 0);
          *a3 = v5;
          goto LABEL_27;
        }
      }
    ...
    if ( v5 )
      NDIS_PD_COUNTER::`scalar deleting destructor'((_UNICODE_STRING *)v5);
  }
LABEL_27:
  if ( *(int **)&WPP_RECORDER_INITIALIZED != &WPP_RECORDER_INITIALIZED )
  {
