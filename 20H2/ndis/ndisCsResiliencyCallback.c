/*
 * XREFs of ndisCsResiliencyCallback @ 0x1C005B280
 * Callers:
 *     <none>
 * Callees:
 ...
 *     ?ndisCsResiliencyChange@@YAXPEAU_NDIS_MINIPORT_BLOCK@@E@Z @ 0x1C005B390 (-ndisCsResiliencyChange@@YAXPEAU_NDIS_MINIPORT_BLOCK@@E@Z.c)
 */
