/*
 * XREFs of ?ndisMpHookNmrInitializeClient@@YAJXZ @ 0x1C0145904
 * Callers:
 ...
 *     ??0MINIPORT_HOOK_DRIVER@@QEAA@XZ @ 0x1C010B5B4 (--0MINIPORT_HOOK_DRIVER@@QEAA@XZ.c)
 *     ??_EMINIPORT_HOOK_DRIVER@@QEAAPEAXI@Z @ 0x1C012600C (--_EMINIPORT_HOOK_DRIVER@@QEAAPEAXI@Z.c)
 */
