/*
 * XREFs of ?ForEachLink@NDIS_BIND_DRIVER_BASE@@QEAAXP6AXPEAUNDIS_BIND_LINK_BASE@@@Z@Z @ 0x1C0105498
 * Callers:
 ...
 *     ?ReleaseShared@KLockHolder@@QEAAXXZ @ 0x1C010A1A0 (-ReleaseShared@KLockHolder@@QEAAXXZ.c)
 */
...
void __fastcall NDIS_BIND_DRIVER_BASE::ForEachLink(NDIS_BIND_DRIVER_BASE *this, void (__fastcall *a2)(_LIST_ENTRY *))
{
  ...
  v7.m_State = Unlocked;
  v7.m_Lock = (KPushLockBase *)(qword_1C00E4558 + 8);
