/*
 * XREFs of ?NdisMRemoveMiniportInternal@@YAXPEAU_NDIS_MINIPORT_BLOCK@@W4_NDIS_MINIPORT_EVENT@@@Z @ 0x1C005F5B0
 * Callers:
 *     NdisMRemoveMiniport @ 0x1C0061990 (NdisMRemoveMiniport.c)
