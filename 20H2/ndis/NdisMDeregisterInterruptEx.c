/*
 * XREFs of NdisMDeregisterInterruptEx @ 0x1C0137830
 * Callers:
 ...
 *     ?ndisWaitForDpcCompletion@@YAXPECJPECEPEAU_KEVENT@@@Z @ 0x1C00AA9F4 (-ndisWaitForDpcCompletion@@YAXPECJPECEPEAU_KEVENT@@@Z.c)
 */
