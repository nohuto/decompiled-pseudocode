/*
 * XREFs of NdisFreeRefCount @ 0x1C00BE7B0
 * Callers:
 ...
 *     ?ndisDeinitializeZeroBasedRef@@YAXPEAU_REFERENCE_EX@@@Z @ 0x1C0127DD4 (-ndisDeinitializeZeroBasedRef@@YAXPEAU_REFERENCE_EX@@@Z.c)
 * Callees:
