/*
 * XREFs of ?ndisMIndicateQosParametersChange@@YAEPEAU_NDIS_MINIPORT_BLOCK@@HPEAXK@Z @ 0x1C006F2E4
 * Callers:
 ...
 *     ?NdisTraceLoggingQosOperationalStatus@@YAXPEAU_NDIS_MINIPORT_BLOCK@@@Z @ 0x1C008BF74 (-NdisTraceLoggingQosOperationalStatus@@YAXPEAU_NDIS_MINIPORT_BLOCK@@@Z.c)
...
LABEL_43:
    if ( *(int **)&WPP_RECORDER_INITIALIZED != &WPP_RECORDER_INITIALIZED )
    {
      ...
      v10 = 2;
LABEL_45:
      WPP_RECORDER_SF_(v8[8], v10, 0x18u, v9, (struct _GUID *)&WPP_60844eb21a8f3cfcca037c14d27ddc90_Traceguids);
    }
    return 0;
  }
