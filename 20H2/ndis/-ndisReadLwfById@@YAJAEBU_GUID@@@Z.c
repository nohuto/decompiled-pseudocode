/*
 * XREFs of ?ndisReadLwfById@@YAJAEBU_GUID@@@Z @ 0x1C01250B0
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall ndisReadLwfById(const struct _GUID *a1)
{
  ...
  {
    m_ptr = (void **)&v7;
    FilterAltitude = ndisBlowStringListIntoAtoms(&m_ptr, (const struct _NETSETUPPROPKEY *)&unk_1C00D3558, (__int64)&v10);
    if ( !FilterAltitude )
    {
      ...
      if ( !FilterAltitude )
      {
        ...
        if ( !FilterAltitude )
        {
          FilterAltitude = NetSetupPropertyBag::ReadBoolean(
                             &m_ptr,
                             (const struct _NETSETUPPROPKEY *)&unk_1C00D35A0,
                             &v15);
          if ( !FilterAltitude )
          {
            v5 = 0;
            NetSetupPropertyBag::ReadBoolean(&m_ptr, (const struct _NETSETUPPROPKEY *)&unk_1C00D3588, &v5);
            v3 = v5 ? (char *)qword_1C00E45D8 + 56 : (char *)qword_1C00E45D8 + 40;
