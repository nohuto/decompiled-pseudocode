/*
 * XREFs of ?ndisNetBufferToPacket@@YAHPEAU_NET_BUFFER@@EPEAPEAU_NDIS_PACKET@@@Z @ 0x1C007524C
 * Callers:
...
__int64 __fastcall ndisNetBufferToPacket(struct _NET_BUFFER *a1, char a2, struct _NDIS_PACKET **a3)
{
  ...
  __int64 result; // rax
  PNDIS_PACKET v8; // rcx
  $50EFF04D87272ADD482F77D067E80136 *ProtocolReserved; // r9
  _MDL *CurrentMdl; // rdx
  ...
  *a3 = 0LL;
  ...
  if ( !Status )
  {
    ...
    ProtocolReserved = ($50EFF04D87272ADD482F77D067E80136 *)v8->ProtocolReserved;
    if ( !a2 )
