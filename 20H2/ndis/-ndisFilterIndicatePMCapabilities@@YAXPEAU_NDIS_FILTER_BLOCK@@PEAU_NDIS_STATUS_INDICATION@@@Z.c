/*
 * XREFs of ?ndisFilterIndicatePMCapabilities@@YAXPEAU_NDIS_FILTER_BLOCK@@PEAU_NDIS_STATUS_INDICATION@@@Z @ 0x1C008FBF4
 * Callers:
 ...
 * Callees:
 *     ?ndisUpdatePMCurrentParameters@@YAXPEAU_NDIS_PM_CAPABILITIES@@PEAU_NDIS_PM_PARAMETERS@@@Z @ 0x1C0095204 (-ndisUpdatePMCurrentParameters@@YAXPEAU_NDIS_PM_CAPABILITIES@@PEAU_NDIS_PM_PARAMETERS@@@Z.c)
 */
