/*
 * XREFs of ?ndisMFreeSGList@@YAXPEAU_NDIS_MINIPORT_BLOCK@@PEAU_NDIS_PACKET@@@Z @ 0x1C00638F4
 * Callers:
 ...
 * Callees:
 *     PplpLazyInitializeLookasideList @ 0x1C0039010 (PplpLazyInitializeLookasideList.c)
