/*
 * XREFs of ndisDriverSystemDispatch @ 0x1C00320D0
 * Callers:
...
LABEL_29:
      ...
      {
        qword_1C00E6178 = v6[1];
        byte_1C00E6174 = BYTE2(qword_1C00E6178);
        ndisLogger = HIDWORD(qword_1C00E6178);
        if ( (qword_1C00E6178 & 0x800000000LL) != 0 )
          LOBYTE(dword_1C00E6180) = 1;
        if ( (qword_1C00E6178 & 0x100000000LL) != 0 )
          BYTE1(dword_1C00E6180) = 1;
        if ( (qword_1C00E6178 & 0x200000000LL) != 0 )
          BYTE2(dword_1C00E6180) = 1;
        if ( (qword_1C00E6178 & 0x400000000LL) != 0 )
          HIBYTE(dword_1C00E6180) = 1;
        if ( (qword_1C00E6178 & 0x1000000000LL) != 0 )
          LOBYTE(word_1C00E6184) = 1;
        if ( (qword_1C00E6178 & 0x2000000000LL) != 0 )
          HIBYTE(word_1C00E6184) = 1;
      }
      break;
    case 5:
      byte_1C00E6174 = 0;
