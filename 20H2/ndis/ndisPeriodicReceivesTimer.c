/*
 * XREFs of ndisPeriodicReceivesTimer @ 0x1C00A3890
 * Callers:
 *     <none>
 * Callees:
        ...
        PVOID SystemSpecific3)
{
  ...
  v4 = 0LL;
  v5 = (char *)qword_1C00E4140 + 64 * (unsigned __int64)KeGetPcr()->Prcb.Number;
  ...
  *v4 = 0LL;
  ...
  {
LABEL_5:
    *((_DWORD *)qword_1C00E4138 + KeGetPcr()->Prcb.Number) = 0;
  }
  else
  {
    v8.QuadPart = qword_1C00E4128;
    if ( !qword_1C00E4128 )
      v8.QuadPart = -1LL;
    KeSetTimer(
...
LABEL_12:
  ...
  if ( v4 )
  {
    ...
    if ( (_BYTE)word_1C00E6184 )
    {
      ...
      v10 = 48;
      *(_QWORD *)v12 = 0LL;
      *(_QWORD *)((char *)&v11 + 6) = qword_1C00E6178;
