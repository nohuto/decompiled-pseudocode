/*
 * XREFs of ?NdisPDPIAllocateQueue@@YAJPEAUNDIS_PD_PROVIDER_HANDLE__@@PEBU_NDIS_PD_QUEUE_PARAMETERS@@PEAPEAU_NDIS_PD_QUEUE@@@Z @ 0x1C011ADC0
 * Callers:
 *     <none>
 * Callees:
 ...
 *     ??_GNDIS_PD_QUEUE_TRACKER@@QEAAPEAXI@Z @ 0x1C011931C (--_GNDIS_PD_QUEUE_TRACKER@@QEAAPEAXI@Z.c)
