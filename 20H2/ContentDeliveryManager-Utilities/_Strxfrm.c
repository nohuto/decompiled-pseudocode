/*
 * XREFs of _Strxfrm @ 0x1800CCC38
 * Callers:
 *     ?do_transform@?$collate@D@std@@MEBA?AV?$basic_string@DU?$char_traits@D@std@@V?$allocator@D@2@@2@PEBD0@Z @ 0x1800CC0D0 (-do_transform@-$collate@D@std@@MEBA-AV-$basic_string@DU-$char_traits@D@std@@V-$allocator@D@2@@2@.c)
 * Callees:
