/*
 * XREFs of _Mbrtowc @ 0x1800B03A0
 * Callers:
 *     ??$_Maklocstr@G@std@@YAPEAGPEBDPEAGAEBU_Cvtvec@@@Z @ 0x180029D20 (--$_Maklocstr@G@std@@YAPEAGPEBDPEAGAEBU_Cvtvec@@@Z.c)
 *     ?do_widen@?$ctype@_W@std@@MEBA_WD@Z @ 0x18002A180 (-do_widen@-$ctype@_W@std@@MEBA_WD@Z.c)
 *     ?do_widen@?$ctype@_W@std@@MEBAPEBDPEBD0PEA_W@Z @ 0x18002A1D0 (-do_widen@-$ctype@_W@std@@MEBAPEBDPEBD0PEA_W@Z.c)
 *     ?_Init@?$numpunct@G@std@@IEAAXAEBV_Locinfo@2@_N@Z @ 0x18003C2A0 (-_Init@-$numpunct@G@std@@IEAAXAEBV_Locinfo@2@_N@Z.c)
 *     ?do_in@?$codecvt@GDH@std@@MEBAHAEAHPEBD1AEAPEBDPEAG3AEAPEAG@Z @ 0x18004A180 (-do_in@-$codecvt@GDH@std@@MEBAHAEAHPEBD1AEAPEBDPEAG3AEAPEAG@Z.c)
 *     ?do_length@?$codecvt@GDH@std@@MEBAHAEAHPEBD1_K@Z @ 0x18004A460 (-do_length@-$codecvt@GDH@std@@MEBAHAEAHPEBD1_K@Z.c)
 ...
 *     ?do_in@?$codecvt@_WDH@std@@MEBAHAEAHPEBD1AEAPEBDPEA_W3AEAPEA_W@Z @ 0x1800C4390 (-do_in@-$codecvt@_WDH@std@@MEBAHAEAHPEBD1AEAPEBDPEA_W3AEAPEA_W@Z.c)
 *     ?do_length@?$codecvt@_WDH@std@@MEBAHAEAHPEBD1_K@Z @ 0x1800C4480 (-do_length@-$codecvt@_WDH@std@@MEBAHAEAHPEBD1_K@Z.c)
 * Callees:
