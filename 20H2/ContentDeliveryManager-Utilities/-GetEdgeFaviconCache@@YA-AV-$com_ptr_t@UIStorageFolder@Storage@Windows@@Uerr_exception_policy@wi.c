/*
 * XREFs of ?GetEdgeFaviconCache@@YA?AV?$com_ptr_t@UIStorageFolder@Storage@Windows@@Uerr_exception_policy@wil@@@wil@@XZ @ 0x18009A7B0
 * Callers:
 ...
 *     ?GetStateHandle@CallerIdentity@@YAJPEBGPEAPEAX@Z @ 0x1800AAD74 (-GetStateHandle@CallerIdentity@@YAJPEBGPEAPEAX@Z.c)
