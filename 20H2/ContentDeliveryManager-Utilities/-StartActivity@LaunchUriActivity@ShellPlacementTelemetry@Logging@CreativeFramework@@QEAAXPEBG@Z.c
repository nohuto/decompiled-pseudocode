/*
 * XREFs of ?StartActivity@LaunchUriActivity@ShellPlacementTelemetry@Logging@CreativeFramework@@QEAAXPEBG@Z @ 0x18002B184
 * Callers:
        ...
        const unsigned __int16 *a2)
{
  ...
  const unsigned __int16 *v21; // [rsp+88h] [rbp+27h]
  ...
  *(_DWORD *)v4 = 1;
    ...
    && (*((_QWORD *)v7 + 3) & 0x200000000000LL) == *((_QWORD *)v7 + 3) )
  {
    ...
    v20 = 4LL;
    v18 = 8LL;
    tlgWriteTransfer_EventWriteTransfer(v8, (unsigned __int8 *)dword_180175122, v11, v10, 5u, &v16);
  }
  if ( !*((_DWORD *)this + 8) )
