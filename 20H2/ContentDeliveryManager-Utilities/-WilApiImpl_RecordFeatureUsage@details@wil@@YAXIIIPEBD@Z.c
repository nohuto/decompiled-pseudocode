/*
 * XREFs of ?WilApiImpl_RecordFeatureUsage@details@wil@@YAXIIIPEBD@Z @ 0x18000BD30
 * Callers:
 *     <none>
 * Callees:
...
LABEL_21:
  ...
  else if ( !wil::details::g_processShutdownInProgress )
  {
    ...
    if ( !v6 && wil::details::FeatureStateManager::EnsureStateData((RTL_SRWLOCK *)&wil::details::g_featureStateManager) )
      wil::details_abi::SubscriptionList::OnSignaled((LPCRITICAL_SECTION)&qword_180197480[25], qword_180197480);
  }
}
