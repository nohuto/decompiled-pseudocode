 ...
 *     ??$make_shared@VAppUninstallService@Actions@CreativeFramework@@PEB_W@std@@YA?AV?$shared_ptr@VAppUninstallService@Actions@CreativeFramework@@@0@$$QEAPEB_W@Z @ 0x180086944 (--$make_shared@VAppUninstallService@Actions@CreativeFramework@@PEB_W@std@@YA-AV-$shared_ptr@VApp.c)
...
_QWORD *__fastcall CreativeFramework::Actions::MakeAppUninstallService(_QWORD *a1)
{
  ...
  v6[1] = -2LL;
  v6[0] = a1;
  v2 = (_QWORD *)CreativeFramework::Actions::GetRequiredParameter<std::wstring>((int)v9);
  if ( v2[3] >= 8uLL )
    v2 = (_QWORD *)*v2;
  v6[0] = v2;
