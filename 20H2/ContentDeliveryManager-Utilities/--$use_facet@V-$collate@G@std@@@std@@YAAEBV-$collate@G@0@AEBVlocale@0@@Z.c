/*
 * XREFs of ??$use_facet@V?$collate@G@std@@@std@@YAAEBV?$collate@G@0@AEBVlocale@0@@Z @ 0x1800BAB5C
 * Callers:
...
struct std::_Facet_base *__fastcall std::use_facet<std::collate<unsigned short>>(__int64 *a1)
{
  __int64 v2; // rsi
  ...
  v11 = (struct std::_Facet_base *)std::_Facetptr<std::collate<unsigned short>>::_Psave;
  v3 = std::collate<unsigned short>::id;
  ...
  if ( !v5 )
  {
    ...
    if ( !v5 )
    {
      ...
      {
        if ( std::collate<unsigned short>::_Getcat(&v11, a1) == -1 )
        {
          bad_cast::bad_cast((bad_cast *)pExceptionObject, "bad cast");
          throw (bad_cast *)pExceptionObject;
        }
        v5 = v11;
        std::_Facetptr<std::collate<unsigned short>>::_Psave = (__int64)v11;
