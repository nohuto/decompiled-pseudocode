/*
 * XREFs of _CRT_INIT @ 0x1800CCD8C
 * Callers:
 *     __DllMainCRTStartup @ 0x1800CD014 (__DllMainCRTStartup.c)
 * Callees:
 *     _amsg_exit_0 @ 0x1800CDA45 (_amsg_exit_0.c)
 *     _IsNonwritableInCurrentImage @ 0x1800CDAB0 (_IsNonwritableInCurrentImage.c)
 *     _initterm_0 @ 0x1800CDC1E (_initterm_0.c)
