/*
 * XREFs of __GSHandlerCheck_EH @ 0x1800CD96C
 * Callers:
 *     <none>
 * Callees:
 *     __CxxFrameHandler3_0 @ 0x1800CD266 (__CxxFrameHandler3_0.c)
 *     __GSHandlerCheckCommon @ 0x1800CD8E4 (__GSHandlerCheckCommon.c)
 */
