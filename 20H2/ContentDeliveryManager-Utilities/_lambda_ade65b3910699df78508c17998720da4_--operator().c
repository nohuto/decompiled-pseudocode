/*
 * XREFs of _lambda_ade65b3910699df78508c17998720da4_::operator() @ 0x180053920
 * Callers:
 *     Windows::Internal::COperationLambdaVar_0__lambda_ade65b3910699df78508c17998720da4__Windows::Internal::CNoResult_::Run @ 0x180056170 (Windows--Internal--COperationLambdaVar_0__lambda_ade65b3910699df78508c17998720da4__Windows--Inte.c)
 * Callees:
...
__int64 __fastcall lambda_ade65b3910699df78508c17998720da4_::operator()(__int64 *a1)
{
  __int64 v2; // rbx
  __int64 v3; // rax
  ...
  v36 = 0LL;
  v37 = 0LL;
  v23[0] = &ContentDeliveryManager::Background::ContentDeliveryManagerTelemetry::ActionRevertedActivity::`vftable';
  ContentDeliveryManager::Background::ContentDeliveryManagerTelemetry::ActionRevertedActivity::StartActivity(
    (ContentDeliveryManager::Background::ContentDeliveryManagerTelemetry::ActionRevertedActivity *)v23,
    v10,
    v7,
    v4);
  if ( v16 >= 8 )
