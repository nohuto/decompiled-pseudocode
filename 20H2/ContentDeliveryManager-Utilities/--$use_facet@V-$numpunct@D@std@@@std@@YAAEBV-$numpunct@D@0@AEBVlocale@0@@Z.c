/*
 * XREFs of ??$use_facet@V?$numpunct@D@std@@@std@@YAAEBV?$numpunct@D@0@AEBVlocale@0@@Z @ 0x1800B23BC
 * Callers:
 ...
 *     ?_Getcat@?$numpunct@D@std@@SA_KPEAPEBVfacet@locale@2@PEBV42@@Z @ 0x1800B2F18 (-_Getcat@-$numpunct@D@std@@SA_KPEAPEBVfacet@locale@2@PEBV42@@Z.c)
...
struct std::_Facet_base *__fastcall std::use_facet<std::numpunct<char>>(__int64 *a1)
{
  ...
  v11 = (struct std::_Facet_base *)std::_Facetptr<std::numpunct<char>>::_Psave;
  ...
  if ( !v5 )
  {
    ...
    if ( !v5 )
    {
      ...
      {
        if ( std::numpunct<char>::_Getcat(&v11, a1) == -1 )
        {
          bad_cast::bad_cast((bad_cast *)pExceptionObject, "bad cast");
          throw (bad_cast *)pExceptionObject;
        }
        v5 = v11;
        std::_Facetptr<std::numpunct<char>>::_Psave = (__int64)v11;
