/*
 * XREFs of _Toupper @ 0x1800BA204
 * Callers:
 *     ?do_toupper@?$ctype@D@std@@MEBADD@Z @ 0x1800B7450 (-do_toupper@-$ctype@D@std@@MEBADD@Z.c)
 *     ?do_toupper@?$ctype@D@std@@MEBAPEBDPEADPEBD@Z @ 0x1800B7470 (-do_toupper@-$ctype@D@std@@MEBAPEBDPEADPEBD@Z.c)
 * Callees:
 *     _GetLocaleHandleByColl @ 0x1800B976C (_GetLocaleHandleByColl.c)
 *     _GetLocaleHandleById @ 0x1800B9778 (_GetLocaleHandleById.c)
 *     __crtLCMapStringA_Stub @ 0x1800B9844 (__crtLCMapStringA_Stub.c)
 */
