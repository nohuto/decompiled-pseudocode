...
void **__fastcall CreativeFramework::Actions::GetOptionalParameter<std::wstring>(void **a1, void ***a2, char *a3)
{
  ...
  void *v12[2]; // [rsp+28h] [rbp-48h] BYREF
  ...
  else
  {
    ...
    v13 = 0LL;
    LOWORD(v12[0]) = 0;
    std::wstring::assign(v12, v11 + 8, 0LL, 0xFFFFFFFFFFFFFFFFuLL);
    v7 = v12;
    v8 = 0;
    v9 = 1;
  }
