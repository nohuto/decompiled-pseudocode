/*
 * XREFs of _anonymous_namespace_::PlacementHealth::HandleEvent_1_std::shared_ptr_ContentDeliveryManager::Background::CorrelationVectorWrapper___ @ 0x18003C9B8
 * Callers:
 ...
 * Callees:
 *     _anonymous_namespace_::StartsWith @ 0x18002DEE8 (_anonymous_namespace_--StartsWith.c)
