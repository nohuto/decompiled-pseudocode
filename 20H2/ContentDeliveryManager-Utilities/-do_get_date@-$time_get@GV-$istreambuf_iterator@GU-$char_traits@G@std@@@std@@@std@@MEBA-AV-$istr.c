/*
 * XREFs of ?do_get_date@?$time_get@GV?$istreambuf_iterator@GU?$char_traits@G@std@@@std@@@std@@MEBA?AV?$istreambuf_iterator@GU?$char_traits@G@std@@@2@V32@0AEAVios_base@2@AEAHPEAUtm@@@Z @ 0x1800C39D0
 * Callers:
 *     <none>
 * Callees:
        ...
        __int64 a7)
{
  ...
  if ( !v15 )
    v15 = 2;
  v16 = std::istreambuf_iterator<wchar_t>::equal((__int64)a3, (__int64)a4);
  v17 = a6;
  if ( v16 )
    goto LABEL_11;
...
LABEL_24:
    if ( std::istreambuf_iterator<wchar_t>::equal((__int64)a3, (__int64)a4) )
      break;
    v25 = (unsigned __int16 *)std::istreambuf_iterator<unsigned short>::operator*((__int64)a3);
  }
...
LABEL_37:
  while ( !std::istreambuf_iterator<wchar_t>::equal((__int64)a3, (__int64)a4) )
  {
    v29 = (unsigned __int16 *)std::istreambuf_iterator<unsigned short>::operator*((__int64)a3);
    if ( !(*(unsigned __int8 (__fastcall **)(struct std::_Facet_base *, __int64, _QWORD))(*(_QWORD *)v13 + 32LL))(
            v13,
            72LL,
            *v29) )
...
LABEL_44:
    if ( std::istreambuf_iterator<wchar_t>::equal((__int64)a3, (__int64)a4) )
      break;
    v33 = (unsigned __int16 *)std::istreambuf_iterator<unsigned short>::operator*((__int64)a3);
  }
  while ( (*(unsigned __int8 (__fastcall **)(struct std::_Facet_base *, __int64, _QWORD))(*(_QWORD *)v13 + 32LL))(
            v13,
            72LL,
  ...
  if ( std::istreambuf_iterator<wchar_t>::equal((__int64)a3, (__int64)a4) )
    goto LABEL_46;
  v34 = (unsigned __int16 *)std::istreambuf_iterator<unsigned short>::operator*((__int64)a3);
  if ( (*(unsigned __int8 (__fastcall **)(struct std::_Facet_base *, __int64, _QWORD))(*(_QWORD *)v13 + 32LL))(
         v13,
         4LL,
         *v34) )
