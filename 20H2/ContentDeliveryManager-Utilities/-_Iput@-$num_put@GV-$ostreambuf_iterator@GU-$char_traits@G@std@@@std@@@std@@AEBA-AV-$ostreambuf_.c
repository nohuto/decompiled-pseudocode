/*
 * XREFs of ?_Iput@?$num_put@GV?$ostreambuf_iterator@GU?$char_traits@G@std@@@std@@@std@@AEBA?AV?$ostreambuf_iterator@GU?$char_traits@G@std@@@2@V32@AEAVios_base@2@GPEAD_K@Z @ 0x1800BFBF0
 * Callers:
 ...
 *     ?do_put@?$num_put@GV?$ostreambuf_iterator@GU?$char_traits@G@std@@@std@@@std@@MEBA?AV?$ostreambuf_iterator@GU?$char_traits@G@std@@@2@V32@AEAVios_base@2@GPEBX@Z @ 0x1800C55D0 (-do_put@-$num_put@GV-$ostreambuf_iterator@GU-$char_traits@G@std@@@std@@@std@@MEBA-A_ea_1800C55D0.c)
        ...
        unsigned __int64 a7)
{
  ...
  *(_QWORD *)&v37 = v11;
  ...
  v12 = std::use_facet<std::ctype<unsigned short>>((__int64 *)&v37);
  if ( v11 )
  {
  ...
  *(_QWORD *)&v37 = v15;
  ...
  v16 = std::use_facet<std::numpunct<unsigned short>>((__int64 *)&v37);
  if ( v15 )
  {
