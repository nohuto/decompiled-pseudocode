/*
 * XREFs of ?ShouldUseInternal@Policy@CreativeFramework@@YA_NXZ @ 0x1800A32EC
 * Callers:
 *     ?SetLayoutType@Settings@TargetedContentLayoutHelpers@CreativeFramework@@YAXPEAUHSTRING__@@PEB_W0@Z @ 0x1800A34F8 (-SetLayoutType@Settings@TargetedContentLayoutHelpers@CreativeFramework@@YAXPEAUHSTRING__@@PEB_W0.c)
...
char __fastcall CreativeFramework::Policy::ShouldUseInternal(CreativeFramework::Policy *this)
{
  ...
  AcquireSRWLockShared(&stru_1801992F8);
  v1 = 0;
  if ( !byte_1801992A4 )
  {
    ReleaseSRWLockShared(&stru_1801992F8);
    AcquireSRWLockExclusive(&stru_1801992F8);
    if ( byte_1801992A4 )
    {
      v1 = byte_1801992A5;
LABEL_16:
      ReleaseSRWLockExclusive(&stru_1801992F8);
      return v1;
    }
