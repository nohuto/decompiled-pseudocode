/*
 * XREFs of _std::make_shared_CreativeFramework::Actions::SetDefaultApplicationService_wchar_t_const___wchar_t_const___wchar_t_const____::_1_::dtor$1 @ 0x1800D5712
 * Callers:
 *     <none>
 * Callees:
