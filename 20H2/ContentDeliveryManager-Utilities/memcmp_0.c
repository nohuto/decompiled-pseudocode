/*
 * XREFs of memcmp_0 @ 0x1800CDA2D
 * Callers:
 *     _contentmanagement_IID_Lookup @ 0x180001010 (_contentmanagement_IID_Lookup.c)
 *     ?FindInsertionPointOrIncrement@RawUsageIndex@details_abi@wil@@AEAAPEAEAEAUUsageIndexProperty@23@PEAEPEAX_KI@Z @ 0x180009DF0 (-FindInsertionPointOrIncrement@RawUsageIndex@details_abi@wil@@AEAAPEAEAEAUUsageIndexProperty@23@.c)
