/*
 * XREFs of ??R_lambda_c9aa0fd23ae4b9ff361376eb433e5573_@@QEBAJAEAVCNoResult@Internal@Windows@@@Z @ 0x18000EB68
 * Callers:
 *     ?Run@?$COperationLambdaVar@$0A@V_lambda_c9aa0fd23ae4b9ff361376eb433e5573_@@VCNoResult@Internal@Windows@@$$V@Internal@Windows@@UEAAJW4AsyncStage@23@JAEAVCNoResult@23@@Z @ 0x18001C060 (-Run@-$COperationLambdaVar@$0A@V_lambda_c9aa0fd23ae4b9ff361376eb433e5573_@@VCNoResult@Internal@W.c)
 * Callees:
...
__int64 __fastcall _lambda_c9aa0fd23ae4b9ff361376eb433e5573_::operator()(__int64 a1, void *a2)
{
...
LABEL_29:
  ...
  {
    ppbc = 0LL;
    ((void (__fastcall *)(LPBC, struct IBindCtxVtbl *))v14->lpVtbl->Release)(v14, v14->lpVtbl);
  }
