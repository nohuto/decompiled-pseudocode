/*
 * XREFs of ?GetIids@IdentityManager@ContentManagement@@UEAAJPEAKPEAPEAU_GUID@@@Z @ 0x1800105B0
 * Callers:
 *     ?GetIids@IdentityManager@ContentManagement@@WDA@EAAJPEAKPEAPEAU_GUID@@@Z @ 0x1800238D0 (-GetIids@IdentityManager@ContentManagement@@WDA@EAAJPEAKPEAPEAU_GUID@@@Z.c)
 * Callees:
 *     <none>
 */
