/*
 * XREFs of ?GetIids@TargetedContentTriggerManagerStatics@Internal@TargetedContent@Services@Windows@@UEAAJPEAKPEAPEAU_GUID@@@Z @ 0x180024ED0
 * Callers:
 *     ?GetIids@TargetedContentTriggerManagerStatics@Internal@TargetedContent@Services@Windows@@WCI@EAAJPEAKPEAPEAU_GUID@@@Z @ 0x180029400 (-GetIids@TargetedContentTriggerManagerStatics@Internal@TargetedContent@Services@Windows@@WCI@EAA.c)
 * Callees:
 *     <none>
 */
