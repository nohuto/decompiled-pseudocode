/*
 * XREFs of ?do_put@?$money_put@_WV?$ostreambuf_iterator@_WU?$char_traits@_W@std@@@std@@@std@@MEBA?AV?$ostreambuf_iterator@_WU?$char_traits@_W@std@@@2@V32@_NAEAVios_base@2@_WAEBV?$basic_string@_WU?$char_traits@_W@std@@V?$allocator@_W@2@@2@@Z @ 0x1800C4C70
 * Callers:
 *     <none>
 * Callees:
        ...
        char *a7)
{
  ...
  *(_QWORD *)&v25 = v11;
  ...
  if ( !v28 )
    std::wstring::append(v27, 1uLL, v30[0]);
  v26[3] = (void *)7;
  v26[2] = 0LL;
  LOWORD(v26[0]) = 0;
