/*
 * XREFs of ??_E?$COperationLambdaVar@$0A@V_lambda_eb8e642fd6379236047631f6462c9202_@@VCHSTRINGResult@Internal@Windows@@$$V@Internal@Windows@@UEAAPEAXI@Z @ 0x18001CDA0
 * Callers:
 *     <none>
 * Callees:
