/*
 * XREFs of ?_Init@?$_Mpunct@G@std@@IEAAXAEBV_Locinfo@2@_N@Z @ 0x1800BF854
 * Callers:
 ...
 *     ?_Getcat@?$moneypunct@G$0A@@std@@SA_KPEAPEBVfacet@locale@2@PEBV42@@Z @ 0x1800BD604 (-_Getcat@-$moneypunct@G$0A@@std@@SA_KPEAPEBVfacet@locale@2@PEBV42@@Z.c)
 ...
 *     ??_U@YAPEAX_K@Z @ 0x1800B1C0C (--_U@YAPEAX_K@Z.c)
 *     ??$_Getvals@G@?$_Mpunct@G@std@@IEAAXGPEBUlconv@@@Z @ 0x1800BA5A4 (--$_Getvals@G@-$_Mpunct@G@std@@IEAAXGPEBUlconv@@@Z.c)
 *     memcpy_s_0 @ 0x1800CD565 (memcpy_s_0.c)
 */
