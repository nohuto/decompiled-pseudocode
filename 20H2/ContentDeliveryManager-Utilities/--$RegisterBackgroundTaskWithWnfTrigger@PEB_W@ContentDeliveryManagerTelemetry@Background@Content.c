/*
 * XREFs of ??$RegisterBackgroundTaskWithWnfTrigger@PEB_W@ContentDeliveryManagerTelemetry@Background@ContentDeliveryManager@@SAX$$QEAPEB_WPEBD@Z @ 0x1800AF0E4
 * Callers:
        ...
        const unsigned __int16 *a2)
{
  ...
  if ( *(_DWORD *)v4 > 5u )
  {
      ...
      && (*(_QWORD *)(v5 + 24) & 0x200000000000LL) == *(_QWORD *)(v5 + 24) )
    {
      ...
      v13 = v6;
      v15 = 0;
      LODWORD(v4) = tlgWriteTransfer_EventWriteTransfer(v5, (unsigned __int8 *)dword_180178A28, 0LL, 0LL, 4u, &v12);
    }
  }
  return (int)v4;
}
