/*
 * XREFs of _Wcscoll @ 0x1800CCA08
 * Callers:
 *     ?do_compare@?$collate@_W@std@@MEBAHPEB_W000@Z @ 0x1800C2E40 (-do_compare@-$collate@_W@std@@MEBAHPEB_W000@Z.c)
 * Callees:
 *     _GetLocaleHandleByColl @ 0x1800B976C (_GetLocaleHandleByColl.c)
 *     _GetLocaleHandleById @ 0x1800B9778 (_GetLocaleHandleById.c)
 *     __crtCompareStringW_Stub @ 0x1800B97E4 (__crtCompareStringW_Stub.c)
 */
