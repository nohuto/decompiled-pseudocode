/*
 * XREFs of ?_Syserror_map@std@@YAPEBDH@Z @ 0x1800B0240
 * Callers:
 ...
 *     ?default_error_condition@_System_error_category@std@@UEBA?AVerror_condition@2@H@Z @ 0x180007E80 (-default_error_condition@_System_error_category@std@@UEBA-AVerror_condition@2@H@Z.c)
 * Callees:
 *     <none>
 */
