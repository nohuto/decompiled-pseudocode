/*
 * XREFs of ?InitializeMRTObjects@MRTHelperBase@ShellMRTHelper@@AEAAJXZ @ 0x1800A0F8C
 * Callers:
 ...
 *     ?FailFast_Hr@in1diag3@details@wil@@YAXPEAXIPEBDJ@Z @ 0x1800A1E0C (-FailFast_Hr@in1diag3@details@wil@@YAXPEAXIPEBDJ@Z.c)
...
LABEL_23:
        ...
        if ( *((_WORD *)this + 21) )
        {
          ...
          if ( *((_BYTE *)this + 43) )
          {
            Instance = (*(__int64 (__fastcall **)(__int64 *, _QWORD))(v20 + 112))(
                         *v15,
          ...
          {
            Instance = (*(__int64 (__fastcall **)(__int64 *))(v20 + 120))(*v15);
            if ( Instance < 0 )
            {
              v9 = 167LL;
              goto LABEL_11;
        ...
        if ( *((_BYTE *)this + 44) )
        {
          Instance = (*(__int64 (__fastcall **)(__int64 *, _QWORD))(**v15 + 128))(*v15, *((unsigned int *)this + 7));
          if ( Instance < 0 )
          {
            v9 = 173LL;
            goto LABEL_11;
        ...
        if ( v21 )
        {
          ...
          if ( v22 )
          {
            if ( v22 != 1 )
            {
              v31 = wil::verify_hresult<long>(0x8000FFFF);
              wil::details::in1diag3::FailFast_Hr(retaddr, (void *)0xBD, v32, (const char *)v31, ppv);
              JUMPOUT(0x1800A13E7LL);
            }
            v23 = L"light";
          }
          else
          ...
          Instance = (*(__int64 (__fastcall **)(__int64 *, const wchar_t *, const wchar_t *))(**v15 + 144))(
                       *v15,
                       L"Theme",
                       v23);
          if ( Instance < 0 )
        ...
        if ( v24 )
        {
          ...
          if ( v25 )
          {
            if ( v25 != 1 )
            {
              ...
              wil::details::in1diag3::FailFast_Hr(retaddr, (void *)0xD3, v30, (const char *)v29, ppv);
              __debugbreak();
            }
            v26 = L"lightunplated";
          }
          ...
          v27 = (*(__int64 (__fastcall **)(__int64 *, const wchar_t *))(**v15 + 136))(*v15, v26);
          v28 = v27;
          if ( v27 < 0 )
          {
            wil::details::in1diag3::Return_Hr(
