/*
 * XREFs of _lambda_fb6889284f8c6875beea5ab05f2a2ddf_::operator() @ 0x180053D44
 * Callers:
 *     Windows::Internal::COperationLambdaVar_0__lambda_fb6889284f8c6875beea5ab05f2a2ddf__Windows::Internal::CNoResult_::Run @ 0x180056130 (Windows--Internal--COperationLambdaVar_0__lambda_fb6889284f8c6875beea5ab05f2a2ddf__Windows--Inte.c)
 * Callees:
 ...
 *     ??1?$ActivityBase@VContentDeliveryManagerLogging@Background@ContentDeliveryManager@@$00$0CAAAAAAAAAAA@$04$0A@U_TlgReflectorTag_Param0IsProviderType@@@wil@@QEAA@XZ @ 0x180042E2C (--1-$ActivityBase@VContentDeliveryManagerLogging@Background@ContentDeliveryManager@@$00$0CAAAAAA.c)
 ...
 *     ?Stop@?$ActivityBase@VContentDeliveryManagerLogging@Background@ContentDeliveryManager@@$00$0CAAAAAAAAAAA@$04$0A@U_TlgReflectorTag_Param0IsProviderType@@@wil@@QEAAXJ@Z @ 0x180054958 (-Stop@-$ActivityBase@VContentDeliveryManagerLogging@Background@ContentDeliveryManager@@$00$0CAAA.c)
 *     ??A?$map@V?$basic_string@GU?$char_traits@G@std@@V?$allocator@G@2@@std@@V12@U?$less@V?$basic_string@GU?$char_traits@G@std@@V?$allocator@G@2@@std@@@2@V?$allocator@U?$pair@$$CBV?$basic_string@GU?$char_traits@G@std@@V?$allocator@G@2@@std@@V12@@std@@@2@@std@@QEAAAEAV?$basic_string@GU?$char_traits@G@std@@V?$allocator@G@2@@1@$$QEAV21@@Z @ 0x1800553F0 (--A-$map@V-$basic_string@GU-$char_traits@G@std@@V-$allocator@G@2@@std@@V12@U-$less@V-$basic_stri.c)
...
__int64 __fastcall lambda_fb6889284f8c6875beea5ab05f2a2ddf_::operator()(__int64 *a1)
{
  __int64 v2; // rbx
  __int64 v3; // rax
  ...
  v36 = 0LL;
  v37 = 0LL;
  v23[0] = &ContentDeliveryManager::Background::ContentDeliveryManagerTelemetry::ActionStagedActivity::`vftable';
  ContentDeliveryManager::Background::ContentDeliveryManagerTelemetry::ActionStagedActivity::StartActivity(
    (ContentDeliveryManager::Background::ContentDeliveryManagerTelemetry::ActionStagedActivity *)v23,
    v10,
    v7,
    v4);
  if ( v16 >= 8 )
  ...
  try
  {
    ...
    v21 = 0LL;
    LOWORD(v20[0]) = 0;
    (*(void (__fastcall **)(_QWORD))(**(_QWORD **)(*a1 + 72) + 24LL))(*(_QWORD *)(*a1 + 72));
