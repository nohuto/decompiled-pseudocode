/*
 * XREFs of ?IsEnabled@?$Feature@U__WilFeatureTraits_Feature_AppDefaultsEdgeCoinCampaign@@@wil@@SA_NXZ @ 0x180033330
 * Callers:
 *     <none>
 * Callees:
 ...
 *     ?GetCachedFeatureEnabledState@?$FeatureImpl@U__WilFeatureTraits_Feature_AppDefaultsEdgeCoinCampaign@@@details@wil@@AEAA?ATwil_details_FeatureStateCache@@XZ @ 0x1800388D8 (-GetCachedFeatureEnabledState@-$FeatureImpl@U__WilFeatureTraits_Feature_AppDefaultsEdgeCoinCampa.c)
 */
