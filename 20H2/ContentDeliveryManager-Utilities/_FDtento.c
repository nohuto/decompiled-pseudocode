/*
 * XREFs of _FDtento @ 0x1800B88F0
 * Callers:
 *     _Stofx @ 0x1800B0850 (_Stofx.c)
 * Callees:
 *     _FXp_getw @ 0x1800B840C (_FXp_getw.c)
 *     _FXp_movx @ 0x1800B8498 (_FXp_movx.c)
 *     _FXp_mulx @ 0x1800B86AC (_FXp_mulx.c)
 *     _FXp_setw @ 0x1800B883C (_FXp_setw.c)
