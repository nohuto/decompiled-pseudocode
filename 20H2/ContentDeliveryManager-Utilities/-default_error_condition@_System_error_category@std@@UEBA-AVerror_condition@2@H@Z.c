/*
 * XREFs of ?default_error_condition@_System_error_category@std@@UEBA?AVerror_condition@2@H@Z @ 0x180007E80
 * Callers:
 *     <none>
 * Callees:
 *     ?_Syserror_map@std@@YAPEBDH@Z @ 0x1800B0240 (-_Syserror_map@std@@YAPEBDH@Z.c)
 */
