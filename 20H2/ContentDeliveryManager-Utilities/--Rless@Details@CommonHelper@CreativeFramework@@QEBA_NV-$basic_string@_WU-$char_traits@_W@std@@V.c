...
bool __fastcall CreativeFramework::CommonHelper::Details::less::operator()(__int64 a1, __int64 a2, const WCHAR *a3)
{
  const WCHAR *v3; // rbx
  const WCHAR *v5; // rcx
  bool v6; // si
  ...
  if ( *(_QWORD *)(a2 + 24) < 8uLL )
    ...
    v5 = *(const WCHAR **)a2;
  v6 = CompareStringOrdinal(v5, -1, a3, -1, 1) == 1;
  if ( *(_QWORD *)(a2 + 24) >= 8uLL )
