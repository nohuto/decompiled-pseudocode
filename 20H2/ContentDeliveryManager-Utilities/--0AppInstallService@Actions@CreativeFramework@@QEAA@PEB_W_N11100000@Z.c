/*
 * XREFs of ??0AppInstallService@Actions@CreativeFramework@@QEAA@PEB_W_N11100000@Z @ 0x1800853A4
 * Callers:
 *     ?MakeAppInstallService@Actions@CreativeFramework@@YA?AV?$shared_ptr@VIActionService@Actions@CreativeFramework@@@std@@AEBUActionContext@12@AEBV?$map@V?$basic_string@_WU?$char_traits@_W@std@@V?$allocator@_W@2@@std@@V12@U?$less@V?$basic_string@_WU?$char_traits@_W@std@@V?$allocator@_W@2@@std@@@2@V?$allocator@U?$pair@$$CBV?$basic_string@_WU?$char_traits@_W@std@@V?$allocator@_W@2@@std@@V12@@std@@@2@@4@@Z @ 0x180085A50 (-MakeAppInstallService@Actions@CreativeFramework@@YA-AV-$shared_ptr@VIActionService@Actions@Crea.c)
 * Callees:
        ...
        wchar_t *a11)
{
  ...
  *(_WORD *)v13 = 0;
  ...
  std::wstring::assign((void **)v13, (char *)a2, v15);
  *((_QWORD *)this + 17) = 7LL;
  *((_QWORD *)this + 16) = 0LL;
  *((_WORD *)this + 56) = 0;
  if ( *Src )
  ...
  std::wstring::assign((void **)this + 14, (char *)Src, v16);
  *((_QWORD *)this + 21) = 7LL;
  *((_QWORD *)this + 20) = 0LL;
  *((_WORD *)this + 72) = 0;
  *((_QWORD *)this + 25) = 7LL;
  ...
  *((_WORD *)this + 104) = 0;
  ...
  std::wstring::assign((void **)this + 26, (char *)a10, v17);
  *((_QWORD *)this + 33) = 7LL;
  *((_QWORD *)this + 32) = 0LL;
  *((_WORD *)this + 120) = 0;
  if ( *a11 )
  ...
  std::wstring::assign((void **)this + 30, (char *)a11, v18);
  if ( a8 )
  {
    if ( *a8 )
    {
    ...
    std::wstring::assign((void **)this + 18, (char *)a8, v19);
  }
  if ( a9 )
  {
    if ( *a9 )
    ...
    std::wstring::assign((void **)this + 22, (char *)a9, v12);
  }
  return this;
}
