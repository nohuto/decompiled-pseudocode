/*
 * XREFs of _FXp_addh @ 0x1800B8050
 * Callers:
 *     _FXp_addx @ 0x1800B8398 (_FXp_addx.c)
 *     _FXp_mulh @ 0x1800B84C4 (_FXp_mulh.c)
 *     _FXp_setn @ 0x1800B87B4 (_FXp_setn.c)
 * Callees:
 *     _FDscale @ 0x1800B7E80 (_FDscale.c)
 *     _Feraise @ 0x1800CC2B8 (_Feraise.c)
 *     _FDtest @ 0x1800CC2EC (_FDtest.c)
 *     _FDint @ 0x1800CC33C (_FDint.c)
 *     _FDunscale @ 0x1800CC418 (_FDunscale.c)
 */
