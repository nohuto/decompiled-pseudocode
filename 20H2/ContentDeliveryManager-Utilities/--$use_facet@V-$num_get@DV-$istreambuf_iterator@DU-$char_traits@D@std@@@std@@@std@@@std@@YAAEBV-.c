/*
 * XREFs of ??$use_facet@V?$num_get@DV?$istreambuf_iterator@DU?$char_traits@D@std@@@std@@@std@@@std@@YAAEBV?$num_get@DV?$istreambuf_iterator@DU?$char_traits@D@std@@@std@@@0@AEBVlocale@0@@Z @ 0x1800B213C
 * Callers:
 ...
 *     ?_Getcat@?$num_get@DV?$istreambuf_iterator@DU?$char_traits@D@std@@@std@@@std@@SA_KPEAPEBVfacet@locale@2@PEBV42@@Z @ 0x1800B2D88 (-_Getcat@-$num_get@DV-$istreambuf_iterator@DU-$char_traits@D@std@@@std@@@std@@SA_KPEAPEBVfacet@l.c)
...
struct std::_Facet_base *__fastcall std::use_facet<std::num_get<char,std::istreambuf_iterator<char>>>(__int64 *a1)
{
  ...
  v11 = (struct std::_Facet_base *)std::_Facetptr<std::num_get<char,std::istreambuf_iterator<char>>>::_Psave;
  ...
  if ( !v5 )
  {
    ...
    if ( !v5 )
    {
      ...
      {
        if ( std::num_get<char,std::istreambuf_iterator<char>>::_Getcat(&v11, a1) == -1 )
        {
          bad_cast::bad_cast((bad_cast *)pExceptionObject, "bad cast");
          throw (bad_cast *)pExceptionObject;
        }
        v5 = v11;
        std::_Facetptr<std::num_get<char,std::istreambuf_iterator<char>>>::_Psave = (__int64)v11;
