/*
 * XREFs of ?Release@?$ProcessLocalStorageData@UProcessLocalData@details_abi@wil@@@details_abi@wil@@QEAAXXZ @ 0x180016FC4
 * Callers:
 *     wil::details::_dynamic_atexit_destructor_for__g_processLocalData__ @ 0x1800D86A0 (wil--details--_dynamic_atexit_destructor_for__g_processLocalData__.c)
 * Callees:
 ...
 *     ??1ThreadLocalData@details_abi@wil@@QEAA@XZ @ 0x180006690 (--1ThreadLocalData@details_abi@wil@@QEAA@XZ.c)
