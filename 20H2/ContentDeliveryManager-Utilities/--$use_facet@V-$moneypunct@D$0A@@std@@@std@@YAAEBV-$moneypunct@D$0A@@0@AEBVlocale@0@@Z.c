/*
 * XREFs of ??$use_facet@V?$moneypunct@D$0A@@std@@@std@@YAAEBV?$moneypunct@D$0A@@0@AEBVlocale@0@@Z @ 0x1800C741C
 * Callers:
 ...
 *     ?_Getcat@?$moneypunct@D$0A@@std@@SA_KPEAPEBVfacet@locale@2@PEBV42@@Z @ 0x1800C7DAC (-_Getcat@-$moneypunct@D$0A@@std@@SA_KPEAPEBVfacet@locale@2@PEBV42@@Z.c)
...
struct std::_Facet_base *__fastcall std::use_facet<std::moneypunct<char,0>>(__int64 *a1)
{
  ...
  v11 = (struct std::_Facet_base *)std::_Facetptr<std::moneypunct<char,0>>::_Psave;
  ...
  if ( !v5 )
  {
    ...
    if ( !v5 )
    {
      ...
      {
        if ( std::moneypunct<char,0>::_Getcat(&v11, a1) == -1 )
        {
          bad_cast::bad_cast((bad_cast *)pExceptionObject, "bad cast");
          throw (bad_cast *)pExceptionObject;
        }
        v5 = v11;
        std::_Facetptr<std::moneypunct<char,0>>::_Psave = (__int64)v11;
