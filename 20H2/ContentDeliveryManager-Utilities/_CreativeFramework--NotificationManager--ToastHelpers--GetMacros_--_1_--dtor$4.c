/*
 * XREFs of _CreativeFramework::NotificationManager::ToastHelpers::GetMacros_::_1_::dtor$4 @ 0x1800D668D
 * Callers:
 *     <none>
 * Callees:
 *     <none>
