/*
 * XREFs of ?GetIids@ContentDeliveryManagerConfigurationStatics@ContentManagement@@UEAAJPEAKPEAPEAU_GUID@@@Z @ 0x180024EA0
 * Callers:
 *     ?GetIids@ContentDeliveryManagerConfigurationStatics@ContentManagement@@WCI@EAAJPEAKPEAPEAU_GUID@@@Z @ 0x180029460 (-GetIids@ContentDeliveryManagerConfigurationStatics@ContentManagement@@WCI@EAAJPEAKPEAPEAU_GUID@.c)
 * Callees:
 *     <none>
 */
