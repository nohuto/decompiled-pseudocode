/*
 * XREFs of ?RegisterWnfTrigger@Internal@TargetedContent@Services@Windows@@YAJPEAUITargetedContentTriggerInternal@1234@V?$shared_ptr@VCorrelationVectorWrapper@Background@ContentDeliveryManager@@@std@@@Z @ 0x180072570
 * Callers:
 *     <none>
 * Callees:
...
LABEL_10:
          ...
          v13 = v25;
          v14 = (int)pv;
          Reserved1 = Microsoft::WRL::Wrappers::HStringReference::HStringReference(&v41, (const WCHAR **)off_1800F2890)[1].Reserved.Reserved1;
          v16 = (const WCHAR *)v35;
          if ( v36 >= 8 )
