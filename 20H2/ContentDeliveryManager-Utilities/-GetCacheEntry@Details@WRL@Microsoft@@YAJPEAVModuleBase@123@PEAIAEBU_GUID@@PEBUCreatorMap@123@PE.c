/*
 * XREFs of ?GetCacheEntry@Details@WRL@Microsoft@@YAJPEAVModuleBase@123@PEAIAEBU_GUID@@PEBUCreatorMap@123@PEAPEAUIUnknown@@@Z @ 0x18002443C
 * Callers:
 *     DllGetClassObject @ 0x1800254C0 (DllGetClassObject.c)
 *     DllGetActivationFactory @ 0x1800255F0 (DllGetActivationFactory.c)
 * Callees:
