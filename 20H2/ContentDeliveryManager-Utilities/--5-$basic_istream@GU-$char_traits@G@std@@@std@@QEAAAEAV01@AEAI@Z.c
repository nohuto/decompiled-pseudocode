/*
 * XREFs of ??5?$basic_istream@GU?$char_traits@G@std@@@std@@QEAAAEAV01@AEAI@Z @ 0x180034F30
 * Callers:
...
_QWORD *__fastcall std::basic_istream<unsigned short>::operator>>(_QWORD *a1, __int64 a2)
{
  ...
  if ( (unsigned __int8)std::basic_istream<unsigned short>::_Ipfx(v3) )
  {
    ...
    try
    {
      ...
      v21 = *(_QWORD *)(v9 + 72);
      v22 = v21 == 0;
      (*(void (__fastcall **)(__int64, char *, __int64 *, __int64 *, __int64, int *, __int64))(*(_QWORD *)v7 + 88LL))(
        v7,
        v25,
        &v21,
        &v19,
