/*
 * XREFs of IsOpenStateExplicitPresent @ 0x1800CE46C
 * Callers:
 *     ?GetSoftLandingFolderForUser@@YAJPEAXPEA_W_K@Z @ 0x1800AAB6C (-GetSoftLandingFolderForUser@@YAJPEAXPEA_W_K@Z.c)
 * Callees:
 *     ApiSetQueryApiSetPresence_0 @ 0x1800CE6A0 (ApiSetQueryApiSetPresence_0.c)
 */
...
char IsOpenStateExplicitPresent()
{
  ...
  if ( dword_180198CE0 == 1 )
    return 1;
  if ( dword_180198CE0 == 2 )
    return 0;
  v1 = 0;
  if ( (int)ApiSetQueryApiSetPresence_0(L"HJ", &v1) < 0 )
    return 0;
  result = v1;
  dword_180198CE0 = 2 - (v1 != 0);
  return result;
}
