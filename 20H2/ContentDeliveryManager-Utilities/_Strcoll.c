/*
 * XREFs of _Strcoll @ 0x1800CC8B0
 * Callers:
 *     ?do_compare@?$collate@D@std@@MEBAHPEBD000@Z @ 0x1800CA680 (-do_compare@-$collate@D@std@@MEBAHPEBD000@Z.c)
 * Callees:
 *     _GetLocaleHandleByColl @ 0x1800B976C (_GetLocaleHandleByColl.c)
 *     _GetLocaleHandleById @ 0x1800B9778 (_GetLocaleHandleById.c)
 *     __crtCompareStringA_Stub @ 0x1800B97D8 (__crtCompareStringA_Stub.c)
