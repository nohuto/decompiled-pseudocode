/*
 * XREFs of ??$ExtendedExecutionClosed@AEA_N@CDMUtilsUnlockTelemetry@@SAXAEA_N@Z @ 0x180081718
 * Callers:
...
int __fastcall CDMUtilsUnlockTelemetry::ExtendedExecutionClosed<bool &>(char *a1)
{
  ...
  if ( *(_DWORD *)v2 > 5u )
  {
      ...
      && (*(_QWORD *)(v3 + 24) & 0x200000000000LL) == *(_QWORD *)(v3 + 24) )
    {
      ...
      v9 = 1;
      v8 = &v6;
      LODWORD(v2) = tlgWriteTransfer_EventWriteTransfer(v3, (unsigned __int8 *)dword_180178450, 0LL, 0LL, 3u, &v7);
    }
  }
  return (int)v2;
}
