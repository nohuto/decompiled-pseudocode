/*
 * XREFs of ?RecognizeCaughtExceptionFromCallback@details@wil@@YAJPEAG_K@Z @ 0x180005064
 * Callers:
 *     _wil::details::ResultFromCaughtExceptionInternal_::_1_::catch$2 @ 0x1800CE84E (_wil--details--ResultFromCaughtExceptionInternal_--_1_--catch$2.c)
 * Callees:
