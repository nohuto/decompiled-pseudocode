/*
 * XREFs of ??1UtcWrapperBase@Diagnostics@Microsoft@@UEAA@XZ @ 0x1800AAB3C
 * Callers:
 *     ??_EUtcWrapperBase@Diagnostics@Microsoft@@UEAAPEAXI@Z @ 0x18001ADE0 (--_EUtcWrapperBase@Diagnostics@Microsoft@@UEAAPEAXI@Z.c)
 * Callees:
 *     <none>
 */
