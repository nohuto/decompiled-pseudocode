/*
 * XREFs of ?ProcessBackChannelMessage@CWindowList@@UEAAJPEBUMIL_MESSAGE@@@Z @ 0x180035290
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall CWindowList::ProcessBackChannelMessage(CWindowList *this, const struct MIL_MESSAGE *a2)
{
  ...
  if ( *(_DWORD *)a2 == 8 )
  {
            ...
            *((_DWORD *)a2 + 2)) )
    {
      ...
      v2 = started;
      if ( started < 0 )
        MilInstrumentationCheckHR_MaybeFailFast(0x14u, 0LL, 0LL, started, 0x656u);
    }
  }
  else if ( *(_DWORD *)a2 == 5 )
  {
  ...
  {
    v2 = -2147418113;
    MilInstrumentationCheckHR_MaybeFailFast(0x14u, 0LL, 0LL, -2147418113, 0x65Fu);
  }
  return v2;
}
