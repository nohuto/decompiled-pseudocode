/*
 * XREFs of ?SetBeginRect@CAnimatedTransitionVisual@@QEAAXPEBUtagRECT@@@Z @ 0x18000AD58
 * Callers:
    ...
    *(_OWORD *)&this[106].x = v3;
    ...
    if ( HIBYTE(this[120].y) )
    {
      if ( !LOBYTE(this[121].x) )
      {
        ...
        (*(void (__fastcall **)(CVisual *))(*(_QWORD *)v4 + 64LL))(v4);
      }
    }
  }
}
