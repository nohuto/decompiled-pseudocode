/*
 * XREFs of ?DPIChange@CWindowList@@UEAAJPEAUIDwmWindow@@@Z @ 0x18001AC70
 * Callers:
 *     <none>
 * Callees:
...
LABEL_2:
  ...
  {
LABEL_51:
    MilInstrumentationCheckHR_MaybeFailFast(0x14u, 0LL, 0LL, v6, 0x14C8u);
    goto LABEL_35;
  }
  if ( v5 )
  {
    ...
    *((_DWORD *)v5 + 15) = (_DWORD)v20;
    ...
    {
      MilInstrumentationCheckHR_MaybeFailFast(0x14u, 0LL, 0LL, v22, 0xD53u);
    }
    else if ( v15 || v12 )
    {
    ...
    if ( v8 < 0 )
    {
      MilInstrumentationCheckHR_MaybeFailFast(0x14u, 0LL, 0LL, v8, 0x14E5u);
    }
