/*
 * XREFs of ?InterpolateValue@CCubicBezierInterpolator@@UEAAJNPEANI@Z @ 0x1800AB8B0
 * Callers:
 *     <none>
 * Callees:
 *     ?GetFinalValue@CCubicBezierInterpolator@@UEAAJPEANI@Z @ 0x1800AB5F0 (-GetFinalValue@CCubicBezierInterpolator@@UEAAJPEANI@Z.c)
 */
