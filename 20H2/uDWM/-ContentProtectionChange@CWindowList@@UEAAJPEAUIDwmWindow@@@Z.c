/*
 * XREFs of ?ContentProtectionChange@CWindowList@@UEAAJPEAUIDwmWindow@@@Z @ 0x180096100
 * Callers:
 *     <none>
 * Callees:
    ...
    if ( v13 )
    {
      ...
      if ( ((v9 & 0x40) != 0) != v7 || v9 >> 7 != v8 )
      {
        *((_BYTE *)v6 + 611) = v9 & 0x3F | ((v7 & 1 | (unsigned __int8)(2 * v8)) << 6);
        ...
        v5 = v11;
        if ( v11 < 0 )
          MilInstrumentationCheckHR_MaybeFailFast(0x14u, 0LL, 0LL, v11, 0x13F6u);
      }
    }
  }
  else
  {
    MilInstrumentationCheckHR_MaybeFailFast(0x14u, 0LL, 0LL, SyncedWindowData, 0x13E2u);
  }
