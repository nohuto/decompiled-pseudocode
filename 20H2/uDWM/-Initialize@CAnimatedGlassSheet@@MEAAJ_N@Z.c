/*
 * XREFs of ?Initialize@CAnimatedGlassSheet@@MEAAJ_N@Z @ 0x18009A8F0
 * Callers:
 ...
 *     ?GetWindowFramePart@CTopLevelWindow@@CAPEAVCBitmapSource@@PEAUWindowFrame@1@I@Z @ 0x180094380 (-GetWindowFramePart@CTopLevelWindow@@CAPEAVCBitmapSource@@PEAUWindowFrame@1@I@Z.c)
 */
