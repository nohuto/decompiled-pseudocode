/*
 * XREFs of ?ScreenDuplicationFailedToGetDisplayConfig@WindowFrameLoggingTelemetry@@SAXXZ @ 0x18008E680
 * Callers:
...
void __fastcall WindowFrameLoggingTelemetry::ScreenDuplicationFailedToGetDisplayConfig(__int64 a1)
{
  ...
  {
    tlgWriteTransfer_EtwEventWriteTransfer(v1, byte_1800CFC87, 0LL, 0LL, 2, (__int64)v2);
  }
}
