/*
 * XREFs of ?CreateHostBackdropBrush@UI@WindowsInternal@@YAJPEAUIDCompositionDesktopDevicePartner@@PEAPEAUICompositionBrush@Composition@1Windows@@@Z @ 0x18003968C
 * Callers:
 ...
 *     ?put_BlurAmount@GaussianBlurEffect@Effects@Composition@UI@Microsoft@@UEAAJM@Z @ 0x180039C10 (-put_BlurAmount@GaussianBlurEffect@Effects@Composition@UI@Microsoft@@UEAAJM@Z.c)
        ...
        struct Windows::UI::Composition::ICompositionBrush **a3)
{
  ...
  _QWORD *v30; // rbx
  struct IDCompositionDesktopDevicePartner *v31; // rdi
  __int64 (__fastcall **v32)(_QWORD *, GUID *, struct IDCompositionDesktopDevicePartner *); // rax
  __int64 (__fastcall *v33)(_QWORD *, GUID *, struct IDCompositionDesktopDevicePartner *); // rsi
  __int64 v35; // rdx
  __int64 v36; // rdx
  ...
  struct IDCompositionDesktopDevicePartner *v46; // [rsp+68h] [rbp-1h] BYREF
  __int64 v47; // [rsp+70h] [rbp+7h] BYREF
  HSTRING_HEADER hstringHeader; // [rsp+78h] [rbp+Fh] BYREF
  GUID *v49; // [rsp+90h] [rbp+27h]
  ...
  *(_QWORD *)a2 = 0LL;
  ...
  v8 = v44;
  v43 = 0LL;
  v9 = *(__int64 (__fastcall **)(__int64, GUID *, __int64 *))(*(_QWORD *)v44 + 48LL);
...
LABEL_40:
  ...
  Microsoft::WRL::ComPtr<IWICBitmapDecoder>::InternalRelease(&v38);
  v27 = v29(v28, &v38);
  v7 = v27;
  if ( v27 < 0 )
  {
  ...
  v30 = v38;
  v31 = v46;
  v32 = (__int64 (__fastcall **)(_QWORD *, GUID *, struct IDCompositionDesktopDevicePartner *))*v38;
  v49 = 0LL;
  v33 = v32[7];
  Microsoft::WRL::Wrappers::HStringReference::CreateReference(&hstringHeader, L"source", 7u, 6u);
  v27 = v33(v30, v49, v31);
