/*
 * XREFs of ?Initialize@CDesktopManager@@AEAAJPEBUStartupInfo@@PEAUCompositionInfo@@@Z @ 0x180049978
 * Callers:
 ...
 *     ?reset@?$unique_storage@U?$resource_policy@PEAUHKEY__@@P6AJPEAU1@@Z$1?RegCloseKey@@YAJ0@ZU?$integral_constant@_K$0A@@wistd@@PEAU1@PEAU1@$0A@$$T@details@wil@@@details@wil@@QEAAXPEAUHKEY__@@@Z @ 0x18004AA84 (-reset@-$unique_storage@U-$resource_policy@PEAUHKEY__@@P6AJPEAU1@@Z$1-RegCloseKey@@YAJ0@ZU-$inte.c)
 ...
 *     ??0CWindowList@@QEAA@XZ @ 0x180051C68 (--0CWindowList@@QEAA@XZ.c)
 ...
 *     ??0CTransitionVisualController@@QEAA@XZ @ 0x180052614 (--0CTransitionVisualController@@QEAA@XZ.c)
 *     ?SetupDPIValues@CDesktopManager@@QEAAXXZ @ 0x1800527C0 (-SetupDPIValues@CDesktopManager@@QEAAXXZ.c)
 *     ?_InitializeWnf@CDesktopManager@@AEAAJXZ @ 0x180052940 (-_InitializeWnf@CDesktopManager@@AEAAJXZ.c)
 *     ?SetWindowAnimation@CDesktopManager@@SAX_N@Z @ 0x180052AF4 (-SetWindowAnimation@CDesktopManager@@SAX_N@Z.c)
 *     ??0CProjectionBorderManager@@QEAA@XZ @ 0x180052C0C (--0CProjectionBorderManager@@QEAA@XZ.c)
 ...
 *     ??0CAnimationClockCoordinator@@QEAA@XZ @ 0x180052EF4 (--0CAnimationClockCoordinator@@QEAA@XZ.c)
 *     ?SetEventCallback@CAnimationClockCoordinator@@QEAAJPEAUIAnimationClockEventListener@@@Z @ 0x180053010 (-SetEventCallback@CAnimationClockCoordinator@@QEAAJPEAUIAnimationClockEventListener@@@Z.c)
 *     ?Init@CTextCache@@QEAAJXZ @ 0x18005311C (-Init@CTextCache@@QEAAJXZ.c)
...
LABEL_70:
    v22 = -2147024882;
    MilInstrumentationCheckHR_MaybeFailFast(0x14u, &dword_1800CAE78, 1LL, -2147024882, phkResult);
    goto LABEL_62;
  }
...
LABEL_82:
    v35 = updated;
LABEL_116:
    MilInstrumentationCheckHR_MaybeFailFast(0x14u, &dword_1800CAE78, 1LL, v35, phkResulta);
    goto LABEL_59;
  }
  pvParam[0] = 8;
...
LABEL_88:
    v22 = -2147024882;
    MilInstrumentationCheckHR_MaybeFailFast(0x14u, &dword_1800CAE78, 1LL, -2147024882, phkResultb);
LABEL_118:
