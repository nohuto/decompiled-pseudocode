/*
 * XREFs of ?StyleChange@CWindowList@@UEAAJPEAUIDwmWindow@@@Z @ 0x18000ECD0
 * Callers:
 *     <none>
 * Callees:
 ...
 *     ?UpdateOwnerLists@CWindowData@@QEAAX_N@Z @ 0x1800134F8 (-UpdateOwnerLists@CWindowData@@QEAAX_N@Z.c)
...
LABEL_2:
    ...
    MilInstrumentationCheckHR_MaybeFailFast(0x14u, 0LL, 0LL, v36, 0x886u);
  v7 = v5;
  if ( v5 < 0 )
  {
LABEL_57:
    MilInstrumentationCheckHR_MaybeFailFast(0x14u, 0LL, 0LL, v5, 0xDDEu);
    goto LABEL_29;
  }
  if ( !v4 )
    goto LABEL_29;
...
LABEL_13:
  if ( v7 < 0 )
  {
    MilInstrumentationCheckHR_MaybeFailFast(0x14u, 0LL, 0LL, v7, 0x1D08u);
  }
  else
  {
    ...
    if ( v18 )
    {
      ...
      v7 = v31;
      if ( v31 < 0 )
        MilInstrumentationCheckHR_MaybeFailFast(0x14u, 0LL, 0LL, v31, 0x1D0Du);
    }
  }
  if ( v7 < 0 )
  {
    MilInstrumentationCheckHR_MaybeFailFast(0x14u, 0LL, 0LL, v7, 0xDFEu);
    goto LABEL_29;
  }
  ...
  if ( v19 < 0 )
  {
    MilInstrumentationCheckHR_MaybeFailFast(0x14u, 0LL, 0LL, v19, 0xDFFu);
    goto LABEL_29;
  }
LABEL_17:
  v20 = *(_QWORD *)(v4 + 536);
