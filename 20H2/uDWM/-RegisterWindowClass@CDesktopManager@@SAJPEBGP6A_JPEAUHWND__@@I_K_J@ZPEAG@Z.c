/*
 * XREFs of ?RegisterWindowClass@CDesktopManager@@SAJPEBGP6A_JPEAUHWND__@@I_K_J@ZPEAG@Z @ 0x18004A030
 * Callers:
        ...
        unsigned __int16 *a3)
{
  ...
  if ( dword_1800E5D94 > *(_DWORD *)(*((_QWORD *)NtCurrentTeb()->ThreadLocalStoragePointer + (unsigned int)tls_index)
                                   + 4LL) )
  {
    Init_thread_header(&dword_1800E5D94);
    if ( dword_1800E5D94 == -1 )
    {
      dword_1800E30D8 = -2147023486;
      Init_thread_footer(&dword_1800E5D94);
    }
  }
  v4 = 0;
  v5 = 0;
  ...
  *a3 = v6;
  if ( !v6 )
  {
    ...
    if ( v5 >= 0 )
      v5 = -2003304445;
    MilInstrumentationCheckHR_MaybeFailFast(0x14u, &dword_1800E30D8, 1LL, v5, 0x81Bu);
  }
  if ( v5 != -2147023486 )
