/*
 * XREFs of ?OnMagnifierSyncApiMessage@CMagnifierControl@@QEAAJW4DWMCMD@@PEAX_NKPEBU_REMOTE_PORT_VIEW@@PEAJPEAI@Z @ 0x18008C604
 * Callers:
        ...
        _DWORD *a8)
{
  ...
  v9 = 0;
  v13 = -2147023728;
  if ( dword_1800E5FC8 > *(_DWORD *)(*((_QWORD *)NtCurrentTeb()->ThreadLocalStoragePointer + (unsigned int)tls_index)
                                   + 4LL) )
  {
    Init_thread_header(&dword_1800E5FC8);
    if ( dword_1800E5FC8 == -1 )
    {
      dword_1800E5F0C = -2147023728;
      Init_thread_footer(&dword_1800E5FC8);
    }
  }
  ...
  if ( a2 == 1073741924 && a4 )
  {
    ...
    *a8 = 44;
    ...
    if ( v14 < 0 )
    {
      if ( v14 != -2147023728 )
      {
        MilInstrumentationCheckHR_MaybeFailFast(0x14u, &dword_1800E5F0C, 1LL, v14, 0x1E8u);
        goto LABEL_14;
      }
      v9 = 0;
    }
