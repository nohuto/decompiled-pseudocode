/*
 * XREFs of ?GetCachedFeatureEnabledState@?$FeatureImpl@U__WilFeatureTraits_Feature_SimulationDriver@@@details@wil@@AEAA?ATwil_details_FeatureStateCache@@XZ @ 0x18004C7D0
 * Callers:
 *     ?ReportUsage@?$FeatureImpl@U__WilFeatureTraits_Feature_SimulationDriver@@@details@wil@@QEAAX_NW4ReportingKind@3@_K@Z @ 0x18004C204 (-ReportUsage@-$FeatureImpl@U__WilFeatureTraits_Feature_SimulationDriver@@@details@wil@@QEAAX_NW4.c)
 * Callees:
  ...
  *a2 = *a1;
  if ( (v2 & 3) != 3 )
  {
    ...
    if ( !v11 && wil::details::g_enabledStateManager )
    {
      ...
      if ( !v6
        || v6 != dword_1800E305C
        || (v12 = 1, v13 = a1, !wil::details_abi::heap_buffer::push_back((void **)&xmmword_1800E3090, &v12, 0x10uLL)) )
      {
