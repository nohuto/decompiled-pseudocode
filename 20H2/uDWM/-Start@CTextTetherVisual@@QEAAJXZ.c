/*
 * XREFs of ?Start@CTextTetherVisual@@QEAAJXZ @ 0x1800A2024
 * Callers:
 ...
 *     ?UpdateInstructions@CTextTetherVisual@@IEAAJXZ @ 0x1800A21A4 (-UpdateInstructions@CTextTetherVisual@@IEAAJXZ.c)
 */
