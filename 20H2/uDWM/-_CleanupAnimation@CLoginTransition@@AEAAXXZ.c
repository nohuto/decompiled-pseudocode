/*
 * XREFs of ?_CleanupAnimation@CLoginTransition@@AEAAXXZ @ 0x180038C58
 * Callers:
...
void __fastcall CLoginTransition::_CleanupAnimation(CLoginTransition *this)
{
  ...
  if ( *((_QWORD *)this + 1) )
    CVisual::SetOffset(*((struct tagPOINT **)this + 4), &stru_1800C99D0);
  if ( *((_QWORD *)this + 2) )
    CVisual::SetOffset(*((struct tagPOINT **)this + 5), &stru_1800C99D0);
  v4 = *((_QWORD *)this + 6);
  if ( v4 )
  {
