/*
 * XREFs of ?DwmEventThreadProc@CDesktopManager@@CAKPEAX@Z @ 0x18004A1D0
 * Callers:
 *     <none>
 * Callees:
 ...
 *     ?AbandonActiveAnimations@CDesktopManager@@AEAAXXZ @ 0x1800853B8 (-AbandonActiveAnimations@CDesktopManager@@AEAAXXZ.c)
 *     ?CheckDXGIAdapter@CDesktopManager@@AEAAJPEA_N@Z @ 0x1800853F8 (-CheckDXGIAdapter@CDesktopManager@@AEAAJPEA_N@Z.c)
 *     ?Cleanup@CWaitForService@@QEAAXXZ @ 0x180085624 (-Cleanup@CWaitForService@@QEAAXXZ.c)
