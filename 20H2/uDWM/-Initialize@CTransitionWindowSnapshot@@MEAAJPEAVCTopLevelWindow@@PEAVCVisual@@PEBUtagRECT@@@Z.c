        ...
        const struct tagRECT *a4)
{
  ...
  if ( dword_1800E5B74 > *(_DWORD *)(*((_QWORD *)NtCurrentTeb()->ThreadLocalStoragePointer + (unsigned int)tls_index)
                                   + 4LL) )
  {
    Init_thread_header(&dword_1800E5B74);
    if ( dword_1800E5B74 == -1 )
    {
      dword_1800E2F04 = -2147023434;
      Init_thread_footer(&dword_1800E5B74);
    }
  }
  v19 = 0LL;
  ...
  if ( v8 < 0 )
  {
    MilInstrumentationCheckHR_MaybeFailFast(0x14u, &dword_1800E2F04, 1u, v8, 0x57u, v18);
    return v9;
  }
...
LABEL_21:
  v16 = v10;
LABEL_23:
  MilInstrumentationCheckHR_MaybeFailFast(0x14u, &dword_1800E2F04, 1u, v16, v17, v18);
LABEL_15:
  if ( v19 )
