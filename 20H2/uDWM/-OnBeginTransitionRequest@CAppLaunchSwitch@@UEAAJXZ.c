/*
 * XREFs of ?OnBeginTransitionRequest@CAppLaunchSwitch@@UEAAJXZ @ 0x1800AF490
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall CAppLaunchSwitch::OnBeginTransitionRequest(CAppLaunchSwitch *this)
{
    ...
    if ( v3 >= 0 )
    {
      ...
      *((_BYTE *)this + 120) = v5 == 0;
      ...
      if ( v6 )
      {
        ...
        v2 = v8;
        if ( v8 < 0 )
          MilInstrumentationCheckHR_MaybeFailFast(0x14u, &dword_1800D1D48, 1LL, v8, 0xA60u);
      }
      else
      {
        ...
        v2 = v9;
        if ( v9 < 0 )
          MilInstrumentationCheckHR_MaybeFailFast(0x14u, &dword_1800D1D48, 1LL, v9, 0xA64u);
      }
    }
    else
    {
      MilInstrumentationCheckHR_MaybeFailFast(0x14u, &dword_1800D1D48, 1LL, v3, 0xA5Cu);
    }
    if ( v4 )
  ...
  {
    v2 = -2147467259;
    MilInstrumentationCheckHR_MaybeFailFast(0x14u, &dword_1800D1D48, 1LL, -2147467259, 0xA5Au);
  }
  return v2;
}
