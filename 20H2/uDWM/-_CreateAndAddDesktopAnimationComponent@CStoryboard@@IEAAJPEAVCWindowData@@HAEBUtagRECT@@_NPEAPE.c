/*
 * XREFs of ?_CreateAndAddDesktopAnimationComponent@CStoryboard@@IEAAJPEAVCWindowData@@HAEBUtagRECT@@_NPEAPEAVCAnimationComponent@@@Z @ 0x1800B0984
 * Callers:
        ...
        struct CAnimationComponent **a6)
{
  ...
  if ( v13 >= 0 )
  {
    ...
    if ( v16 < 0 )
    {
      MilInstrumentationCheckHR_MaybeFailFast(0x14u, &CStoryboard::MILINSTRUMENTATIONHRESULTLIST, 1LL, v16, 0x153Du);
      goto LABEL_8;
    }
  ...
  {
    MilInstrumentationCheckHR_MaybeFailFast(0x14u, &CStoryboard::MILINSTRUMENTATIONHRESULTLIST, 1LL, v13, 0x153Cu);
  }
  v15 = (volatile signed __int32 *)v18;
LABEL_8:
  if ( v15 )
