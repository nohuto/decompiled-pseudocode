/*
 * XREFs of ?_SetTimer@CAnimationClock@@AEAAJK@Z @ 0x18002DB60
 * Callers:
 ...
 *     ?IsSet@CTimer@@QEAA_NXZ @ 0x18002DC1C (-IsSet@CTimer@@QEAA_NXZ.c)
 *     ?Start@CTimer@@QEAAJK@Z @ 0x18002E6D4 (-Start@CTimer@@QEAAJK@Z.c)
 *     ?Cancel@CTimer@@QEAAJXZ @ 0x18002E930 (-Cancel@CTimer@@QEAAJXZ.c)
 *     ??0CTimer@@QEAA@XZ @ 0x18002EDA0 (--0CTimer@@QEAA@XZ.c)
