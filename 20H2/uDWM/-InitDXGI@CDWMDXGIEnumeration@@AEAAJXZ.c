/*
 * XREFs of ?InitDXGI@CDWMDXGIEnumeration@@AEAAJXZ @ 0x1800372B8
 * Callers:
...
LABEL_48:
    v15 = v3;
LABEL_52:
    MilInstrumentationCheckHR_MaybeFailFast(0x14u, &dword_1800CADF8, 1LL, v15, v16);
LABEL_32:
    if ( ppFactory )
...
LABEL_51:
    ...
    {
      v8 = DynArrayImpl<0>::AddMultipleAndSet((__int64)this + 56, 8u, 1, v21);
      v4 = v8;
      if ( v8 < 0 )
