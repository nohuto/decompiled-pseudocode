/*
 * XREFs of ??0CAnalogCompositorManager@@AEAA@XZ @ 0x18004A854
 * Callers:
...
CAnalogCompositorManager *__fastcall CAnalogCompositorManager::CAnalogCompositorManager(CAnalogCompositorManager *this)
{
  ...
  if ( (*(int (__fastcall **)(_QWORD, const wchar_t *, CAnalogCompositorManager **))(**((_QWORD **)CDesktopManager::s_pDesktopManagerInstance
    ...
    || !(_DWORD)v9 )
  {
    v1 = Windows::Mirage::HolographicDriverDetectedWatcher::RegisterForCMNotifications((Windows::Mirage::HolographicDriverDetectedWatcher *)&qword_1800E5C98);
    if ( v1 < 0 )
    {
  ...
  return (CAnalogCompositorManager *)&qword_1800E5C90;
}
