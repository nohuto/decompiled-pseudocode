/*
 * XREFs of ??1CAnimatedTransitionVisual@@MEAA@XZ @ 0x180033AA4
 * Callers:
...
void __fastcall CAnimatedTransitionVisual::~CAnimatedTransitionVisual(CAnimatedTransitionVisual *this, unsigned int a2)
{
  ...
  *((_QWORD *)this + 1) = &CAnimatedTransitionVisual::`vftable'{for `CRenderDataVisual'};
  ...
  v12 = (CBaseObject *)*((_QWORD *)this + 83);
  if ( v12 )
    CBaseObject::Release(v12);
  v13 = (CBaseObject *)*((_QWORD *)this + 88);
  if ( v13 )
  ...
  v16 = (CBaseObject *)*((_QWORD *)this + 74);
  if ( v16 )
  ...
  v21 = (CAnimationResource **)((char *)this + 608);
  v22 = 7LL;
  do
  {
    if ( *v21 )
      CAnimationResource::Release(*v21, a2);
    ++v21;
    --v22;
  }
  while ( v22 );
