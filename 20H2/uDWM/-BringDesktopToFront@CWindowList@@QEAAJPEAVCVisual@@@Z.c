/*
 * XREFs of ?BringDesktopToFront@CWindowList@@QEAAJPEAVCVisual@@@Z @ 0x18000CB4C
 * Callers:
 ...
 *     ?MoveNext@VisualCollectionIterator@@QEAA_NXZ @ 0x18000CE90 (-MoveNext@VisualCollectionIterator@@QEAA_NXZ.c)
