/*
 * XREFs of ?UpdateNCAreaBackground@CTopLevelWindow@@AEAAJXZ @ 0x18001FA20
 * Callers:
...
LABEL_19:
  ...
  if ( !*((_QWORD *)this + 36) )
  {
    ...
    inserted = VisualCollection::InsertRelative((VisualCollection *)(*((_QWORD *)this + 33) + 32LL), *v7, 0LL, 1, 1);
    v6 = inserted;
    if ( inserted < 0 )
    {
      wil::details::in1diag3::Return_Hr(
    ...
    v29 = *v7;
    v34 = 0LL;
    CVisual::SetInsetFromParent(v29, &v34);
  }
  if ( *((_QWORD *)this + 94)
