/*
 * XREFs of ?GetNCAreaHorizontalStripHelper@CTopLevelWindow@@CAJPEAXHHW4NCAreaPart@1@11PEAUWindowFrame@1@2@Z @ 0x180049704
 * Callers:
        ...
        __int64 a8)
{
  ...
  v12 = a4;
  v27 = a2;
  if ( dword_1800E5DAC > *(_DWORD *)(*((_QWORD *)NtCurrentTeb()->ThreadLocalStoragePointer + (unsigned int)tls_index)
                                   + 4LL) )
  {
    Init_thread_header(&dword_1800E5DAC);
    if ( dword_1800E5DAC == -1 )
    {
      dword_1800E30F0 = -2147023728;
      Init_thread_footer(&dword_1800E5DAC);
    }
    a2 = v27;
    v8 = a1;
  }
    ...
    else
    {
      ...
      while ( 2 )
      {
        ...
        do
        {
          ...
          if ( v24 < 0 )
          {
            MilInstrumentationCheckHR_MaybeFailFast(0x14u, &dword_1800E30F0, 1LL, v24, 0x507u);
            return v25;
          }
          ++v22;
          ++v21;
