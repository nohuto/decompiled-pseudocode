/*
 * XREFs of ?Create@CDWMDXGIEnumeration@@SAJPEAPEAV1@@Z @ 0x1800370D8
 * Callers:
...
__int64 __fastcall CDWMDXGIEnumeration::Create(struct CDWMDXGIEnumeration **a1)
{
  ...
  if ( v3 )
  {
    ...
    if ( inited < 0 )
    {
      MilInstrumentationCheckHR_MaybeFailFast(0x14u, &dword_1800CADF8, 1LL, inited, 0x3Cu);
    }
    else
    {
      *a1 = v3;
  ...
  {
    v5 = -2147024882;
    MilInstrumentationCheckHR_MaybeFailFast(0x14u, &dword_1800CADF8, 1LL, -2147024882, 0x38u);
  }
  return v5;
}
