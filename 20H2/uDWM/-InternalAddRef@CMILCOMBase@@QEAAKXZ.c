/*
 * XREFs of ?InternalAddRef@CMILCOMBase@@QEAAKXZ @ 0x1800502AC
 * Callers:
 ...
 *     ?AddRef@CCompoundBitmapLock@@UEAAKXZ @ 0x1800502A0 (-AddRef@CCompoundBitmapLock@@UEAAKXZ.c)
 * Callees:
 *     ?IsKernelDebuggerPresent@@YAHXZ @ 0x1800BEBAC (-IsKernelDebuggerPresent@@YAHXZ.c)
 */
