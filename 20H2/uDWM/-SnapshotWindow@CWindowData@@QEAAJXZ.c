/*
 * XREFs of ?SnapshotWindow@CWindowData@@QEAAJXZ @ 0x180012524
 * Callers:
      ...
      if ( v5 )
      {
        ...
        if ( v5 )
        {
          ...
          if ( v7 )
          {
            ...
            if ( v8 < 0 )
            {
              MilInstrumentationCheckHR_MaybeFailFast(0x14u, 0LL, 0LL, v8, 0x1FA6u);
              return v4;
            }
...
LABEL_12:
  ...
  if ( (v9 & 0x10) != 0 )
  {
    ...
    else
    {
      ...
      v4 = v17;
      if ( v17 < 0 )
        MilInstrumentationCheckHR_MaybeFailFast(0x14u, 0LL, 0LL, v17, 0x1FB0u);
    }
  }
  else
  {
    ...
    if ( *((_DWORD *)this + 142) )
    {
      ...
      MilInstrumentationCheckHR_MaybeFailFast(0x14u, 0LL, 0LL, v18, 0x1FC0u);
    }
  }
  return v4;
}
