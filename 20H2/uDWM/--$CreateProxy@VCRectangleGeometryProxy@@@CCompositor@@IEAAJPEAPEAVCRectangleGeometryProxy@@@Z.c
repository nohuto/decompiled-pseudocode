/*
 * XREFs of ??$CreateProxy@VCRectangleGeometryProxy@@@CCompositor@@IEAAJPEAPEAVCRectangleGeometryProxy@@@Z @ 0x18003CA1C
 * Callers:
...
__int64 __fastcall CCompositor::CreateProxy<CRectangleGeometryProxy>(__int64 a1, __int64 *a2)
{
  __int64 v4; // rax
  __int64 v5; // rbx
  int v6; // eax
