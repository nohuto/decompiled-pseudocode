/*
 * XREFs of ?GetScenarioGuid@CTopLevelWindow3D@@AEAAXW4WindowAnimationType@1@PEAU_GUID@@@Z @ 0x18003FEA4
 * Callers:
    ...
    if ( v4 )
    {
      ...
      if ( v5 )
      {
        ...
        if ( v6 )
        {
          ...
          {
            if ( v7 == 1 )
              v8 = (GUID)xmmword_1800CBD68;
            else
              v8 = GUID_NULL;
          }
          else
          {
            v8 = (GUID)xmmword_1800CBD58;
          }
        }
        else
        {
          v8 = (GUID)xmmword_1800CC1B8;
        }
      }
      else
      {
        v8 = (GUID)xmmword_1800CBD48;
      }
    }
    else
    {
      v8 = (GUID)xmmword_1800CC1C8;
    }
  }
  else
  {
    v8 = (GUID)xmmword_1800CBD38;
  }
  *a3 = v8;
}
