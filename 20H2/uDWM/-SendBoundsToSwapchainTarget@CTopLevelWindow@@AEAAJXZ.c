/*
 * XREFs of ?SendBoundsToSwapchainTarget@CTopLevelWindow@@AEAAJXZ @ 0x180094BC4
 * Callers:
...
__int64 __fastcall CTopLevelWindow::SendBoundsToSwapchainTarget(CTopLevelWindow *this)
{
  ...
  cxLeftWidth = 0;
  v3 = (CIndirectSwapchainRenderTargetProxy *)*((_QWORD *)this + 98);
  if ( v3 )
  {
    cyTopHeight = 0;
    if ( *((_BYTE *)this + 776) )
    {
      ...
      v3 = (CIndirectSwapchainRenderTargetProxy *)*((_QWORD *)this + 98);
      v5 = *(_QWORD *)(*((_QWORD *)this + 91) + 48LL);
      v6 = _mm_srli_si128(*(__m128i *)(*((_QWORD *)this + 91) + 48LL), 8).m128i_u64[0];
