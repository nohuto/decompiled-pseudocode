/*
 * XREFs of ?OnAnimationStart@CAppArrangementDelayed@@EEAAJXZ @ 0x1800AF330
 * Callers:
 *     <none>
 * Callees:
 *     ?Abandon@CStoryboard@@QEAAXXZ @ 0x180008028 (-Abandon@CStoryboard@@QEAAXXZ.c)
 *     ?AbandonTransition@CAnimationScheduler@@QEAAJH@Z @ 0x180008EA4 (-AbandonTransition@CAnimationScheduler@@QEAAJH@Z.c)
