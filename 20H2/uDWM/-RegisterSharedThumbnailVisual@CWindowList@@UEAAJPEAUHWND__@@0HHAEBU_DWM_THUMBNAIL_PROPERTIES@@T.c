/*
 * XREFs of ?RegisterSharedThumbnailVisual@CWindowList@@UEAAJPEAUHWND__@@0HHAEBU_DWM_THUMBNAIL_PROPERTIES@@T_LARGE_INTEGER@@PEAX@Z @ 0x18002B580
 * Callers:
 *     <none>
 * Callees:
...
LABEL_6:
  ...
  *(_BYTE *)(v20 + 34) = 1;
  ...
  if ( v21 < 0 )
  {
    MilInstrumentationCheckHR_MaybeFailFast(0x14u, 0LL, 0LL, v21, 0xF3Eu);
    v12 = v41;
    goto LABEL_57;
  }
...
LABEL_64:
    MilInstrumentationCheckHR_MaybeFailFast(0x14u, 0LL, 0LL, v14, 0xF45u);
LABEL_57:
    if ( v12 )
