/*
 * XREFs of ?UpdateTransition@CIndirectTouchVisual@@MEAAJXZ @ 0x1800ADA70
 * Callers:
 *     <none>
 * Callees:
 ...
 *     ?StopOpacityTimeline@CIndirectTouchVisual@@IEAAXXZ @ 0x1800AD92C (-StopOpacityTimeline@CIndirectTouchVisual@@IEAAXXZ.c)
