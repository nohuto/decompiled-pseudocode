/*
 * XREFs of ?_AddProjectionBorderForAllDisplays@CProjectionBorderManager@@AEAAJAEBUDWM_CAPTURE_TOKEN@@@Z @ 0x180090FD8
 * Callers:
        ...
        const struct DWM_CAPTURE_TOKEN *a2)
{
  ...
  v4 = *((_QWORD *)CDesktopManager::s_pDesktopManagerInstance + 21);
  if ( v4 )
  {
    v12 = 0;
    v13 = 0;
