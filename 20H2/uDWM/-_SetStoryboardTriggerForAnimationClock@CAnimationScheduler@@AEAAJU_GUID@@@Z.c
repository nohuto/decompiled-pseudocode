/*
 * XREFs of ?_SetStoryboardTriggerForAnimationClock@CAnimationScheduler@@AEAAJU_GUID@@@Z @ 0x180032578
 * Callers:
 ...
 * Callees:
 *     ?SetStartTrigger@CStoryboard@@QEAAXPEAVCAnimationTriggerProxy@@@Z @ 0x1800083EC (-SetStartTrigger@CStoryboard@@QEAAXPEAVCAnimationTriggerProxy@@@Z.c)
 ...
 *     ?UseDComposition@CStoryboard@@QEAA_NXZ @ 0x18003273C (-UseDComposition@CStoryboard@@QEAA_NXZ.c)
