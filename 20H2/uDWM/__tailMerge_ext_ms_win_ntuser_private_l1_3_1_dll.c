/*
 * XREFs of __tailMerge_ext_ms_win_ntuser_private_l1_3_1_dll @ 0x180053E07
 * Callers:
 *     __imp_load_GetSystemMetricsForDpi @ 0x180053DFB (__imp_load_GetSystemMetricsForDpi.c)
 * Callees:
