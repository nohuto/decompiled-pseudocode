/*
 * XREFs of ?OnMagnifierDestroy@CMagnifierControl@@AEAAJPEAUHWND__@@@Z @ 0x18008C4E4
 * Callers:
 ...
 *     ?RemoveElement@?$CGenericTableMap@PEAUHWND__@@VMagnifierTableElement@CMagnifierControl@@@@QEAAHPEAVMagnifierTableElement@CMagnifierControl@@@Z @ 0x18008C918 (-RemoveElement@-$CGenericTableMap@PEAUHWND__@@VMagnifierTableElement@CMagnifierControl@@@@QEAAHP.c)
...
__int64 __fastcall CMagnifierControl::OnMagnifierDestroy(CMagnifierControl *this, __int64 a2)
{
  ...
  if ( dword_1800E5FD4 > *(_DWORD *)(*((_QWORD *)NtCurrentTeb()->ThreadLocalStoragePointer + (unsigned int)tls_index)
                                   + 4LL) )
  {
    Init_thread_header(&dword_1800E5FD4);
    if ( dword_1800E5FD4 == -1 )
    {
      dword_1800E5F00 = -2147023728;
      Init_thread_footer(&dword_1800E5FD4);
    }
  }
  ...
  {
    v2 = -2147023728;
    MilInstrumentationCheckHR_MaybeFailFast(0x14u, &dword_1800E5F00, 1LL, -2147023728, 0x2A3u);
  }
  return v2;
}
