/*
 * XREFs of ?_UpdateBorderShadowParts@CAccent@@IEAAJXZ @ 0x180001760
 * Callers:
...
__int64 __fastcall CAccent::_UpdateBorderShadowParts(CAtlasedRectsVisual **this)
{
  ...
  while ( 1 )
  {
    if ( !*v6 )
    {
      ...
      if ( v9 < 0 )
      {
        MilInstrumentationCheckHR_MaybeFailFast(0x14u, 0LL, 0, v9, 0x198u, v28);
        return v3;
      }
      *((_DWORD *)*v6 + 30) = v5;
      ...
      if ( v10 < 0 )
      {
        MilInstrumentationCheckHR_MaybeFailFast(0x14u, 0LL, 0, v10, 0x19Fu, v28);
        return v3;
      }
    }
    if ( v7 )
