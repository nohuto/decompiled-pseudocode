/*
 * XREFs of ?OnStoryboardStatusChanged@CAnimationEngine@@UEAAJPEAUIUIAnimationStoryboard2@@W4__MIDL___MIDL_itf_UIAnimation_0000_0002_0001@@1@Z @ 0x180038E50
 * Callers:
 *     <none>
 * Callees:
        ...
        enum __MIDL___MIDL_itf_UIAnimation_0000_0002_0001 a4)
{
  ...
  if ( a3 == UI_ANIMATION_STORYBOARD_FINISHED && ((a4 - 1) & 0xFFFFFFFD) == 0 )
  {
    ...
    else
    {
      ...
      {
        v4 = -2147467259;
        MilInstrumentationCheckHR_MaybeFailFast(0x14u, 0LL, 0LL, -2147467259, 0x56Au);
      }
      else
      {
        ...
        v4 = v10;
        if ( v10 < 0 )
          MilInstrumentationCheckHR_MaybeFailFast(0x14u, 0LL, 0LL, v10, 0x566u);
      }
      CGuard<CDwmCS>::~CGuard<CDwmCS>(&v11);
      if ( v4 < 0 )
        MilInstrumentationCheckHR_MaybeFailFast(0x14u, 0LL, 0LL, v4, 0x5D0u);
    }
  }
