/*
 * XREFs of ?Create@CStoryboardFactory@@SAJHPEAVCStoryboard@@PEAPEAV2@@Z @ 0x18003106C
 * Callers:
 ...
 *     ??0CAppArrangementBase@@IEAA@_N@Z @ 0x1800ADCD4 (--0CAppArrangementBase@@IEAA@_N@Z.c)
 *     ??0CCrossFade@@QEAA@XZ @ 0x1800ADD20 (--0CCrossFade@@QEAA@XZ.c)
 *     ??0CFadeOut@@QEAA@XZ @ 0x1800ADD50 (--0CFadeOut@@QEAA@XZ.c)
 *     ??0CLaunchSwitchBase@@QEAA@XZ @ 0x1800ADDC8 (--0CLaunchSwitchBase@@QEAA@XZ.c)
...
LABEL_9:
  *a3 = v8;
  ...
  {
    v12 = -2147024882;
    MilInstrumentationCheckHR_MaybeFailFast(0x14u, 0LL, 0LL, -2147024882, 0x1882u);
LABEL_120:
    if ( *a3 )
    {
  ...
  if ( v11 < 0 )
  {
    MilInstrumentationCheckHR_MaybeFailFast(0x14u, 0LL, 0LL, v11, 0x1884u);
  }
  else if ( a2 )
  {
