 ...
 *     ??$?0$$V@CloneWindow@WindowFrameLoggingTelemetry@@AEAA@U?$integral_constant@D$0A@@wistd@@@Z @ 0x18002C91C (--$-0$$V@CloneWindow@WindowFrameLoggingTelemetry@@AEAA@U-$integral_constant@D$0A@@wistd@@@Z.c)
 ...
 *     ?AllocClear@ProcessHeapImpl@WPF@@UEAAPEAX_K@Z @ 0x18003A6F0 (-AllocClear@ProcessHeapImpl@WPF@@UEAAPEAX_K@Z.c)
 *     ?Create@CImage@@SAJPEAPEAV1@@Z @ 0x18003EB34 (-Create@CImage@@SAJPEAPEAV1@@Z.c)
 *     McGenControlCallbackV2 @ 0x180042410 (McGenControlCallbackV2.c)
 ...
 *     ?InterpolateVelocity@CCubicBezierInterpolator@@UEAAJNPEANI@Z @ 0x1800AB9A0 (-InterpolateVelocity@CCubicBezierInterpolator@@UEAAJNPEANI@Z.c)
