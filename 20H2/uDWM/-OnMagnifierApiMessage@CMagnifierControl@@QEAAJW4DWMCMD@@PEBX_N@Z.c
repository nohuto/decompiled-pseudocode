/*
 * XREFs of ?OnMagnifierApiMessage@CMagnifierControl@@QEAAJW4DWMCMD@@PEBX_N@Z @ 0x18008BCEC
 * Callers:
 ...
 *     ?OnSetDesktopColorEffect@CFullScreenMagnifier@@QEAAJAEBUMilColorTransform@@@Z @ 0x180087C38 (-OnSetDesktopColorEffect@CFullScreenMagnifier@@QEAAJAEBUMilColorTransform@@@Z.c)
 ...
 *     ?OnSetPersistentDesktopColorEffect@CFullScreenMagnifier@@QEAAJAEBUMilColorTransform@@@Z @ 0x180087D74 (-OnSetPersistentDesktopColorEffect@CFullScreenMagnifier@@QEAAJAEBUMilColorTransform@@@Z.c)
 ...
 *     ?OnSetColorEffect@CMagnifier@@QEAAJAEBUMilColorTransform@@@Z @ 0x18008B274 (-OnSetColorEffect@CMagnifier@@QEAAJAEBUMilColorTransform@@@Z.c)
 ...
 *     CWindowList::ForEachSoftwareCursorListener__lambda_e7ecf37d3f646281150205d781ba1fb4___ @ 0x1800955DC (CWindowList--ForEachSoftwareCursorListener__lambda_e7ecf37d3f646281150205d781ba1fb4___.c)
 ...
 *     ?SetMagnificationFactor@MagnifierExperienceHelper@@QEAAXAEBN@Z @ 0x1800BC98C (-SetMagnificationFactor@MagnifierExperienceHelper@@QEAAXAEBN@Z.c)
 */
...
__int64 __fastcall CMagnifierControl::OnMagnifierApiMessage(unsigned __int64 a1, int a2, __int64 a3, char a4)
{
  ...
  float v62; // [rsp+88h] [rbp+38h] BYREF
  float v63; // [rsp+98h] [rbp+48h] BYREF

  LOBYTE(v63) = a4;
  v4 = 0;
  v8 = 0;
  if ( dword_1800E5FC4 > *(_DWORD *)(*((_QWORD *)NtCurrentTeb()->ThreadLocalStoragePointer + (unsigned int)tls_index)
                                   + 4LL) )
  {
    Init_thread_header(&dword_1800E5FC4);
    if ( dword_1800E5FC4 == -1 )
    {
      dword_1800E5F10 = -2147023728;
      Init_thread_footer(&dword_1800E5FC4);
    }
  }
  ...
  if ( a2 > 1073741927 )
  {
    ...
    if ( !v35 )
    {
      ...
      if ( v57 >= 0 )
        ...
        MilInstrumentationCheckHR_MaybeFailFast(0x14u, &dword_1800E5F10, 1LL, v57, 0xF1u);
      goto LABEL_74;
    }
    v36 = v35 - 1;
    if ( !v36 )
    {
      ...
      if ( v54 >= 0 )
      {
        ...
        v8 = v55;
        if ( v55 < 0 )
          MilInstrumentationCheckHR_MaybeFailFast(0x14u, &dword_1800E5F10, 1LL, v55, 0x13Fu);
      }
      else
      {
        MilInstrumentationCheckHR_MaybeFailFast(0x14u, &dword_1800E5F10, 1LL, v54, 0x13Du);
      }
      goto LABEL_74;
    }
    v37 = v36 - 1;
    if ( !v37 )
    {
      ...
      if ( v51 < 0 )
      {
        MilInstrumentationCheckHR_MaybeFailFast(0x14u, &dword_1800E5F10, 1LL, v51, 0x147u);
        goto LABEL_74;
      }
      goto LABEL_65;
    }
    ...
    if ( !v38 )
    {
      ...
      if ( v50 < 0 )
      {
        MilInstrumentationCheckHR_MaybeFailFast(0x14u, &dword_1800E5F10, 1LL, v50, 0x151u);
        goto LABEL_74;
      }
      goto LABEL_65;
    }
    ...
    if ( v39 )
    {
      ...
      if ( v40 )
      {
        ...
        if ( v43 < 0 )
        {
          MilInstrumentationCheckHR_MaybeFailFast(0x14u, &dword_1800E5F10, 1LL, v43, 0x189u);
          goto LABEL_74;
        }
        goto LABEL_54;
      }
    ...
    else
    {
      ...
      if ( v47 )
      {
        v63 = 0.0;
        v62 = 0.0;
        v48 = MagnifierExperienceHelper::MagnifierExperienceHelper(v47, (const double *)(a1 + 152), &v62, &v63);
      }
      else
      {
        v48 = 0LL;
      ...
      if ( v46 )
      {
        ...
        if ( v49 < 0 )
        {
          MilInstrumentationCheckHR_MaybeFailFast(0x14u, &dword_1800E5F10, 1LL, v49, 0x16Au);
          goto LABEL_74;
        }
LABEL_54:
  ...
  if ( a2 == 1073741927 )
  {
    ...
    if ( *(_BYTE *)(a1 + 128) )
    {
      ...
      *(_QWORD *)(a1 + 184) = v59;
      if ( !(_BYTE)v10 )
      {
        v62 = 0.0;
        LOBYTE(v63) = 0;
        if ( (int)wil::wnf_query_nothrow<unsigned int>(v10, (char *)&v63, (__int64)&v62, v12) >= 0
          && LOBYTE(v63)
          && !LODWORD(v62) )
        {
          goto LABEL_74;
      ...
      *(double *)(a1 + 152) = *v31;
      ...
      if ( v33 < 0 )
      {
        MilInstrumentationCheckHR_MaybeFailFast(0x14u, &dword_1800E5F10, 1LL, v33, 0x127u);
        goto LABEL_74;
      }
    }
    else
    {
      ...
      if ( v34 < 0 )
      {
        MilInstrumentationCheckHR_MaybeFailFast(0x14u, &dword_1800E5F10, 1LL, v34, 0x130u);
        goto LABEL_74;
      }
    }
    goto LABEL_65;
      ...
      if ( v15 )
      {
        ...
        if ( v16 )
        {
          ...
          if ( v17 )
          {
            ...
            if ( v18 < 0 )
            {
              MilInstrumentationCheckHR_MaybeFailFast(0x14u, &dword_1800E5F10, 1LL, v18, 0xFDu);
              goto LABEL_74;
            }
LABEL_65:
            ...
            v8 = v52;
            if ( v52 < 0 )
              MilInstrumentationCheckHR_MaybeFailFast(0x14u, &dword_1800E5F10, 1LL, v52, 0x198u);
            goto LABEL_74;
          }
          v20 = *(_QWORD *)(a3 + 8);
          v59 = 0LL;
          ...
          if ( v21 >= 0 )
          {
            ...
            v8 = v22;
            if ( v22 < 0 )
              MilInstrumentationCheckHR_MaybeFailFast(0x14u, &dword_1800E5F10, 1LL, v22, 0xE7u);
          }
          else
          {
            MilInstrumentationCheckHR_MaybeFailFast(0x14u, &dword_1800E5F10, 1LL, v21, 0xE3u);
          }
        }
        else
        {
          ...
          if ( v24 >= 0 )
          {
            ...
            v8 = v25;
            if ( v25 < 0 )
              MilInstrumentationCheckHR_MaybeFailFast(0x14u, &dword_1800E5F10, 1LL, v25, 0xD9u);
          }
          else
          {
            MilInstrumentationCheckHR_MaybeFailFast(0x14u, &dword_1800E5F10, 1LL, v24, 0xD5u);
          }
        }
      }
      else
      {
        ...
        if ( v27 >= 0 )
        {
          ...
          v8 = v28;
          if ( v28 < 0 )
            MilInstrumentationCheckHR_MaybeFailFast(0x14u, &dword_1800E5F10, 1LL, v28, 0xCBu);
        }
        else
        {
          MilInstrumentationCheckHR_MaybeFailFast(0x14u, &dword_1800E5F10, 1LL, v27, 0xC9u);
        }
      }
    }
    else
    {
      *(_BYTE *)(a1 + 128) = 0;
      ...
      v8 = v29;
      if ( v29 < 0 )
        MilInstrumentationCheckHR_MaybeFailFast(0x14u, &dword_1800E5F10, 1LL, v29, 0xBFu);
    }
  }
  else
  {
    ...
    v8 = v30;
    if ( v30 < 0 )
      MilInstrumentationCheckHR_MaybeFailFast(0x14u, &dword_1800E5F10, 1LL, v30, 0xB4u);
  }
LABEL_74:
  if ( v8 != -2147023728 )
    v4 = v8;
