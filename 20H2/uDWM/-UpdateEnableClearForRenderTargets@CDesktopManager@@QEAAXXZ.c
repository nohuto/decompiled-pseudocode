/*
 * XREFs of ?UpdateEnableClearForRenderTargets@CDesktopManager@@QEAAXXZ @ 0x180086D14
 * Callers:
 ...
 *     ?ShouldClearRenderTargets@CWindowList@@QEBA_NXZ @ 0x1800995DC (-ShouldClearRenderTargets@CWindowList@@QEBA_NXZ.c)
 */
