/*
 * XREFs of ?QueryInterface@GaussianBlurEffect@Effects@Composition@UI@Microsoft@@UEAAJAEBU_GUID@@PEAPEAX@Z @ 0x180039D00
 * Callers:
 *     ?QueryInterface@GaussianBlurEffect@Effects@Composition@UI@Microsoft@@W7EAAJAEBU_GUID@@PEAPEAX@Z @ 0x180056890 (-QueryInterface@GaussianBlurEffect@Effects@Composition@UI@Microsoft@@W7EAAJAEBU_GUID@@PEAPEAX@Z.c)
 *     ?QueryInterface@GaussianBlurEffect@Effects@Composition@UI@Microsoft@@WBA@EAAJAEBU_GUID@@PEAPEAX@Z @ 0x1800568A0 (-QueryInterface@GaussianBlurEffect@Effects@Composition@UI@Microsoft@@WBA@EAAJAEBU_GUID@@PEAPEAX@.c)
 *     ?QueryInterface@GaussianBlurEffect@Effects@Composition@UI@Microsoft@@WBI@EAAJAEBU_GUID@@PEAPEAX@Z @ 0x1800568B0 (-QueryInterface@GaussianBlurEffect@Effects@Composition@UI@Microsoft@@WBI@EAAJAEBU_GUID@@PEAPEAX@.c)
 *     ?QueryInterface@GaussianBlurEffect@Effects@Composition@UI@Microsoft@@WCA@EAAJAEBU_GUID@@PEAPEAX@Z @ 0x1800568C0 (-QueryInterface@GaussianBlurEffect@Effects@Composition@UI@Microsoft@@WCA@EAAJAEBU_GUID@@PEAPEAX@.c)
 * Callees:
