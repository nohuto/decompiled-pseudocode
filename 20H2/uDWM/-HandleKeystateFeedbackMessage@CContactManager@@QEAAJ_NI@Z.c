/*
 * XREFs of ?HandleKeystateFeedbackMessage@CContactManager@@QEAAJ_NI@Z @ 0x18009D7F8
 * Callers:
 ...
 *     ?BuildFeedbackString@CContactManager@@IEAAJKPEAGI@Z @ 0x18009CF5C (-BuildFeedbackString@CContactManager@@IEAAJKPEAGI@Z.c)
