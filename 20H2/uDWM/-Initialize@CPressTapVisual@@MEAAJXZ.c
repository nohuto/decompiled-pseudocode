/*
 * XREFs of ?Initialize@CPressTapVisual@@MEAAJXZ @ 0x1800A6520
 * Callers:
 ...
 *     ?MonitorDpiFromPoint@CDesktopManager@@SAIUtagPOINT@@@Z @ 0x180047928 (-MonitorDpiFromPoint@CDesktopManager@@SAIUtagPOINT@@@Z.c)
