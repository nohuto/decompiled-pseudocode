/*
 * XREFs of ?PostFlickFeedbackUpdate@CContactManager@@QEAAJIW4FLICK_TYPE@@PEBUtagPOINT@@_N@Z @ 0x18009F678
 * Callers:
 ...
 *     ?PostEventMessage@CDesktopManager@@QEAAJI_K_J@Z @ 0x180086760 (-PostEventMessage@CDesktopManager@@QEAAJI_K_J@Z.c)
 */
