/*
 * XREFs of ??$CreateProxy@VCIndirectSwapchainRenderTargetProxy@@@CCompositor@@IEAAJPEAPEAVCIndirectSwapchainRenderTargetProxy@@@Z @ 0x1800BCF04
 * Callers:
...
__int64 __fastcall CCompositor::CreateProxy<CIndirectSwapchainRenderTargetProxy>(__int64 a1, __int64 *a2)
{
  __int64 v4; // rax
  __int64 v5; // rbx
  int v6; // eax
