/*
 * XREFs of ?UpdateAccentPolicy@CAccent@@QEAAJPEBUtagRECT@@PEBUACCENT_POLICY@@PEAVCBaseGeometryProxy@@@Z @ 0x1800285D0
 * Callers:
 ...
 *     ?_GetSolidFillOpacity@CAccent@@IEAAMXZ @ 0x180093530 (-_GetSolidFillOpacity@CAccent@@IEAAMXZ.c)
