/*
 * XREFs of ?ReportTraceLoggingFailure@TraceLoggingProvider@wil@@IEAAXAEBUFailureInfo@2@@Z @ 0x18007E6C8
 * Callers:
 *     ?OnErrorReported@TraceLoggingProvider@wil@@MEAAX_NAEBUFailureInfo@2@@Z @ 0x180006EC0 (-OnErrorReported@TraceLoggingProvider@wil@@MEAAX_NAEBUFailureInfo@2@@Z.c)
 * Callees:
        ...
        __int64 a4)
{
  ...
  if ( *v4 > 2u )
  {
    ...
    v7 = *(_DWORD *)a2;
    v17 = (const unsigned __int16 *)*((_QWORD *)a2 + 15);
    v8 = *((_DWORD *)a2 + 14);
    v18 = (const unsigned __int16 *)*((_QWORD *)a2 + 6);
    v9 = *((_DWORD *)a2 + 1);
    v19 = 0x1000000LL;
