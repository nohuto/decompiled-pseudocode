/*
 * XREFs of ?FindWindowDataByHwnd@CWindowList@@QEAAPEAVCWindowData@@PEAUHWND__@@@Z @ 0x1800153EC
 * Callers:
 ...
 *     ?GetWindowZOrder@CAnimationComponent@@QEAAHXZ @ 0x180032B5C (-GetWindowZOrder@CAnimationComponent@@QEAAHXZ.c)
