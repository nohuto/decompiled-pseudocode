/*
 * XREFs of ?TransitionsForceDisabledChange@CWindowList@@UEAAJPEAUIDwmWindow@@@Z @ 0x180099740
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall CWindowList::TransitionsForceDisabledChange(CWindowList *this, struct IDwmWindow *a2)
{
  ...
  {
    MilInstrumentationCheckHR_MaybeFailFast(0x14u, 0LL, 0LL, SyncedWindowData, 0x15D9u);
  }
