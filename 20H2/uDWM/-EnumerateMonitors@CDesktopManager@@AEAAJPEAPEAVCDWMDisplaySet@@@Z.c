/*
 * XREFs of ?EnumerateMonitors@CDesktopManager@@AEAAJPEAPEAVCDWMDisplaySet@@@Z @ 0x180036D88
 * Callers:
 ...
 *     ?AddMultipleAndSet@?$DynArray@PEAUHMONITOR__@@$0A@@@QEAAJPEFBQEAUHMONITOR__@@I@Z @ 0x180041B58 (-AddMultipleAndSet@-$DynArray@PEAUHMONITOR__@@$0A@@@QEAAJPEFBQEAUHMONITOR__@@I@Z.c)
    ...
    *((_QWORD *)v9 + 1) = *v4;
    ...
    if ( v12 >= 0 )
    {
      ...
      if ( v13 >= 0 )
        ...
        MilInstrumentationCheckHR_MaybeFailFast(0x14u, &dword_1800CADF8, 1LL, v13, 0x78u);
    }
    else
    {
      MilInstrumentationCheckHR_MaybeFailFast(0x14u, &dword_1800CADF8, 1LL, v12, 0x76u);
    }
  }
