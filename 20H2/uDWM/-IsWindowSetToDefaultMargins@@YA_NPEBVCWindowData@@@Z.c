/*
 * XREFs of ?IsWindowSetToDefaultMargins@@YA_NPEBVCWindowData@@@Z @ 0x18000F900
 * Callers:
 ...
 *     ?GetDefaultWindowMarginsForWindowStyle@@YA?AU_MARGINS@@KKKN@Z @ 0x18000FA40 (-GetDefaultWindowMarginsForWindowStyle@@YA-AU_MARGINS@@KKKN@Z.c)
