/*
 * XREFs of ?Initialize@CIndirectTouchVisual@@MEAAJXZ @ 0x1800AD180
 * Callers:
 ...
 *     ?UpdateOpacityAndSource@CIndirectTouchVisual@@IEAAXXZ @ 0x1800ADA2C (-UpdateOpacityAndSource@CIndirectTouchVisual@@IEAAXXZ.c)
 */
