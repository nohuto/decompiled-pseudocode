/*
 * XREFs of ?UpdateThumbnailsForNewWindow@CWindowList@@AEAAJPEAVCWindowData@@@Z @ 0x18003EA6C
 * Callers:
  ...
  if ( *((_DWORD *)a2 + 124) )
  {
    while ( 1 )
    {
      ...
      else
      {
        ...
        if ( v11 < 0 )
        {
          MilInstrumentationCheckHR_MaybeFailFast(0x14u, 0LL, 0LL, v11, 0x16C0u);
          return v2;
        }
      }
    ...
    MilInstrumentationCheckHR_MaybeFailFast(0x14u, 0LL, 0LL, v8, 0x16B5u);
  }
  else
  {
LABEL_2:
