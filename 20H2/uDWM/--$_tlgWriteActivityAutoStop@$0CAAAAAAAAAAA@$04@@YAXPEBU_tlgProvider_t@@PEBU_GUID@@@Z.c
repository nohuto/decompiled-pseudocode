/*
 * XREFs of ??$_tlgWriteActivityAutoStop@$0CAAAAAAAAAAA@$04@@YAXPEBU_tlgProvider_t@@PEBU_GUID@@@Z @ 0x18008D8A4
 * Callers:
...
__int64 __fastcall _tlgWriteActivityAutoStop<35184372088832,5>(__int64 a1, __int64 a2)
{
  ...
  if ( *(_DWORD *)a1 > 5u && (*(_QWORD *)(a1 + 16) & 0x200000000000LL) != 0 )
  {
    ...
    if ( result == *(_QWORD *)(a1 + 24) )
      return tlgWriteTransfer_EtwEventWriteTransfer(a1, byte_1800CFBDB, a2, 0LL, 2, (__int64)v3);
  }
  return result;
}
