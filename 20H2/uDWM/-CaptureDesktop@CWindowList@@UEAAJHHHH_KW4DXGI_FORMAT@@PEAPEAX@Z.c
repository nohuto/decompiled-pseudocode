/*
 * XREFs of ?CaptureDesktop@CWindowList@@UEAAJHHHH_KW4DXGI_FORMAT@@PEAPEAX@Z @ 0x18003F580
 * Callers:
 *     <none>
 * Callees:
        ...
        void **a8)
{
  ...
  *a8 = 0LL;
  ...
  {
    v15 = -2147024809;
    MilInstrumentationCheckHR_MaybeFailFast(0x14u, 0LL, 0LL, -2147024809, 0x1528u);
    goto LABEL_8;
  }
  ...
  {
    v15 = -2147024362;
    MilInstrumentationCheckHR_MaybeFailFast(0x14u, 0LL, 0LL, -2147024362, 0x1509u);
    goto LABEL_8;
  }
  ...
  {
    v15 = -2147024362;
    MilInstrumentationCheckHR_MaybeFailFast(0x14u, 0LL, 0LL, -2147024362, 0x150Du);
    goto LABEL_8;
  }
  ...
  {
    v15 = -2147024882;
    MilInstrumentationCheckHR_MaybeFailFast(0x14u, 0LL, 0LL, -2147024882, 0x1517u);
...
LABEL_12:
  ...
  if ( v14 < 0 )
  {
    MilInstrumentationCheckHR_MaybeFailFast(0x14u, 0LL, 0LL, v14, 0x1523u);
    goto LABEL_12;
  }
  *a8 = FileMappingW;
LABEL_8:
