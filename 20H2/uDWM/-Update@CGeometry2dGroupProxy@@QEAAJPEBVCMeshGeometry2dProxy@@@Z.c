/*
 * XREFs of ?Update@CGeometry2dGroupProxy@@QEAAJPEBVCMeshGeometry2dProxy@@@Z @ 0x1800BDB50
 * Callers:
...
__int64 __fastcall CGeometry2dGroupProxy::Update(CGeometry2dGroupProxy *this, const struct CMeshGeometry2dProxy *a2)
{
  ...
  return (*(__int64 (__fastcall **)(_QWORD, _QWORD, int *, __int64))(**(_QWORD **)(v2 + 16) + 912LL))(
           *(_QWORD *)(v2 + 16),
           *(unsigned int *)(v2 + 24),
           &v4,
           1LL);
