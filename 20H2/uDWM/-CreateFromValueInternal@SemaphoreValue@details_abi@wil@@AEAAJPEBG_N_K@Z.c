/*
 * XREFs of ?CreateFromValueInternal@SemaphoreValue@details_abi@wil@@AEAAJPEBG_N_K@Z @ 0x18007D398
 * Callers:
 ...
 *     ?StringCchCopyW@@YAJPEAG_KPEBG@Z @ 0x18002BE24 (-StringCchCopyW@@YAJPEAG_KPEBG@Z.c)
