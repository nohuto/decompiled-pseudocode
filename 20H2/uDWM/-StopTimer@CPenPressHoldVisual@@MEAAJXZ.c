/*
 * XREFs of ?StopTimer@CPenPressHoldVisual@@MEAAJXZ @ 0x1800A63B0
 * Callers:
 ...
 *     ?UpdateTransition@CPenPressHoldVisual@@MEAAJXZ @ 0x1800A6400 (-UpdateTransition@CPenPressHoldVisual@@MEAAJXZ.c)
 * Callees:
