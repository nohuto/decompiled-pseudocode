/*
 * XREFs of ?Stop@CTextTetherVisual@@UEAAXXZ @ 0x1800A20D0
 * Callers:
 ...
 *     ?UpdateTransition@CTextTetherVisual@@MEAAJXZ @ 0x1800A2200 (-UpdateTransition@CTextTetherVisual@@MEAAJXZ.c)
 * Callees:
