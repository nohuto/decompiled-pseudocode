/*
 * XREFs of ?GetLocalToParentVisualTransform@CVisual@@QEAAXPEAV1@PEAUD2DMatrix@@@Z @ 0x180009C4C
 * Callers:
...
void __fastcall CVisual::GetLocalToParentVisualTransform(CVisual *this, struct CVisual *a2, struct D2DMatrix *a3)
{
  ...
  *(_DWORD *)a3 = 1065353216;
  do
  {
    ...
    v6 = _mm_cvtsi32_si128(*((_DWORD *)this + 28));
    v7 = _mm_cvtsi32_si128(*((_DWORD *)this + 29));
    v9[11] = 0;
    v9[9] = 0;
    v9[8] = 0;
    v9[7] = 0;
    ...
    v8 = (CVisual *)(*(__int64 (__fastcall **)(CVisual *))(*(_QWORD *)this + 80LL))(this);
    this = v8;
  }
  while ( v8 && (*(__int64 (__fastcall **)(CVisual *))(*(_QWORD *)v8 + 80LL))(v8) && this != a2 );
}
