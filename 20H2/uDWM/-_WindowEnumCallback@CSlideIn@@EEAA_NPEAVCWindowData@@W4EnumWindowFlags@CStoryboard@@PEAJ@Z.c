 ...
 *     ?SetChopPosition@CAnimatedTransitionVisual@@QEAAXPEBN0I@Z @ 0x1800A7498 (-SetChopPosition@CAnimatedTransitionVisual@@QEAAXPEBN0I@Z.c)
...
LABEL_27:
    ...
    if ( v22 < 0 )
    {
      MilInstrumentationCheckHR_MaybeFailFast(0x14u, &CStoryboard::MILINSTRUMENTATIONHRESULTLIST, 1u, v22, 0x2B6u, v43);
    }
    else
    {
      *(_DWORD *)(a2 + 616) = v8;
...
LABEL_17:
  ...
  if ( v9 == 43 )
  {
    ...
    v4 = v36;
    if ( v36 < 0 )
      MilInstrumentationCheckHR_MaybeFailFast(0x14u, &CStoryboard::MILINSTRUMENTATIONHRESULTLIST, 1u, v36, 0x2FFu, v43);
    goto LABEL_17;
  }
  if ( (v8 & 0xFFF) != 0 )
  {
...
LABEL_6:
  ...
  if ( v8 < 0 )
  {
    ...
    v4 = v34;
    if ( v34 < 0 )
      MilInstrumentationCheckHR_MaybeFailFast(0x14u, &CStoryboard::MILINSTRUMENTATIONHRESULTLIST, 1u, v34, 0x2F9u, v43);
  }
LABEL_21:
  result = 1;
  *v49 = v4;
