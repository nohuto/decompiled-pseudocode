/*
 * XREFs of ?_RemoveInactiveVisuals@CProjectionBorderManager@@AEAAXXZ @ 0x180091BC0
 * Callers:
...
void __fastcall CProjectionBorderManager::_RemoveInactiveVisuals(CProjectionBorderManager *this)
{
  ...
  if ( v2 >= 0 )
  {
    ...
    if ( (_BYTE)this )
    {
      ...
      {
        tlgWriteTransfer_EtwEventWriteTransfer(v4, byte_1800CFC07, 0LL, 0LL, 2, (__int64)v5);
      }
    }
  }
}
