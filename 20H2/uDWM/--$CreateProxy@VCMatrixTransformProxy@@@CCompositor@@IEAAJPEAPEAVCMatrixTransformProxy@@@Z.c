/*
 * XREFs of ??$CreateProxy@VCMatrixTransformProxy@@@CCompositor@@IEAAJPEAPEAVCMatrixTransformProxy@@@Z @ 0x180013758
 * Callers:
...
__int64 __fastcall CCompositor::CreateProxy<CMatrixTransformProxy>(__int64 a1, volatile signed __int32 **a2)
{
  __int64 v4; // rax
  ...
  *a2 = 0LL;
  ...
  if ( v5 )
  {
    ...
    v6 = CResource::Create(21LL, *(_QWORD *)(a1 + 16), v5 + 4);
    v7 = v6;
    if ( v6 < 0 )
