        ...
        struct CTransitionWindowSnapshot **a4)
{
  ...
  if ( dword_1800E5B70 > *(_DWORD *)(*((_QWORD *)NtCurrentTeb()->ThreadLocalStoragePointer + (unsigned int)tls_index)
                                   + 4LL) )
  {
    Init_thread_header(&dword_1800E5B70);
    if ( dword_1800E5B70 == -1 )
    {
      dword_1800E2F08 = -2147023434;
      Init_thread_footer(&dword_1800E5B70);
    }
  }
  *a4 = 0LL;
  ...
  if ( v9 )
  {
    ...
    if ( v11 < 0 )
    {
      MilInstrumentationCheckHR_MaybeFailFast(0x14u, &dword_1800E2F08, 1u, v11, 0x30u, v14);
    }
    else
    {
  ...
  {
    v12 = -2147024882;
    MilInstrumentationCheckHR_MaybeFailFast(0x14u, &dword_1800E2F08, 1u, -2147024882, 0x22u, v14);
  }
  return v12;
}
