/*
 * XREFs of ?ReportUsage@?$FeatureImpl@U__WilFeatureTraits_Feature_TabShell@@@details@wil@@QEAAX_NW4ReportingKind@3@_K@Z @ 0x18000FE54
 * Callers:
        ...
        ...)
{
  ...
  v9 = WORD2(v10);
  v8 = 1;
  return wil::details::ReportUsageToService(a1 + 2, 10727725LL, (v5 >> 8) & 1, (v5 >> 9) & 1, &v8, v6, v3);
}
