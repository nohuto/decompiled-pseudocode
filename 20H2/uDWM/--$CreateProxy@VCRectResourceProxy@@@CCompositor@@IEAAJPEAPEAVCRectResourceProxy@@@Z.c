/*
 * XREFs of ??$CreateProxy@VCRectResourceProxy@@@CCompositor@@IEAAJPEAPEAVCRectResourceProxy@@@Z @ 0x18003D9F0
 * Callers:
...
__int64 __fastcall CCompositor::CreateProxy<CRectResourceProxy>(__int64 a1, __int64 *a2)
{
  __int64 v4; // rax
  __int64 v5; // rbx
  int v6; // eax
