/*
 * XREFs of ?Create@CCompressedSourceBitmap@@SAJPEAUIWICImagingFactory@@PEBXKNNW4DXGI_FORMAT@@W4DXGI_ALPHA_MODE@@PEAPEAVIBitmapSource@@@Z @ 0x18004F6D0
 * Callers:
 ...
 *     ?InternalAddRef@CMILCOMBase@@QEAAKXZ @ 0x1800502AC (-InternalAddRef@CMILCOMBase@@QEAAKXZ.c)
        ...
        struct IBitmapSource **a8)
{
  ...
  *a8 = 0LL;
  ...
  if ( v14 )
  {
    ...
    if ( v15 < 0 )
    {
      MilInstrumentationCheckHR_MaybeFailFast(0x14u, 0LL, 0LL, v15, 0x25u);
    }
    else
    {
      ...
      if ( v17 < 0 )
      {
        MilInstrumentationCheckHR_MaybeFailFast(0x14u, 0LL, 0LL, v17, 0x27u);
      }
      else
      {
