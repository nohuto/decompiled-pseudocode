/*
 * XREFs of ?GenerateMesh@CTetherVisual@@IEAAJPEAUMesh2D@@@Z @ 0x1800A4778
 * Callers:
 ...
 *     ?AddAndSet@?$DynArray@K$0A@@@QEAAJIAEBK@Z @ 0x1800A23E8 (-AddAndSet@-$DynArray@K$0A@@@QEAAJIAEBK@Z.c)
