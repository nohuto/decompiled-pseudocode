/*
 * XREFs of ?UnregisterIndirectSwapchainRenderTargetFromWindow@CWindowList@@UEAAJPEAUIDwmWindow@@PEA_N@Z @ 0x180099820
 * Callers:
 *     <none>
 * Callees:
...
LABEL_9:
  ...
  if ( !v12 || (v9 = (CTopLevelWindow *)*((_QWORD *)v12 + 48)) == 0LL )
  {
    v7 = -2147467261;
    v11 = 5497;
    v8 = -2147467261;
