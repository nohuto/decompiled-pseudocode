/*
 * XREFs of ?TextChange@CWindowList@@AEAAJPEBUMILCMD_DWM_REDIRECTION_NOTIFYTEXTCHANGE@@@Z @ 0x1800159FC
 * Callers:
 ...
 *     ?UpdateTitle@CTopLevelWindow@@QEAAJPEAG@Z @ 0x180094FC8 (-UpdateTitle@CTopLevelWindow@@QEAAJPEAG@Z.c)
 */
...
LABEL_21:
        MilInstrumentationCheckHR_MaybeFailFast(0x14u, 0LL, 0LL, v10, 0x865u);
        goto LABEL_6;
      }
      *((_QWORD *)v11 + 3) = v9;
...
LABEL_4:
        ...
        MilInstrumentationCheckHR_MaybeFailFast(0x14u, 0LL, 0LL, v20, 0x886u);
      v6 = v10;
      if ( v10 >= 0 )
        goto LABEL_6;
      goto LABEL_21;
...
LABEL_6:
  if ( v6 < 0 )
  {
    MilInstrumentationCheckHR_MaybeFailFast(0x14u, 0LL, 0LL, v6, 0xCB1u);
  }
  else if ( v7 )
  {
