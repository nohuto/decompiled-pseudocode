/*
 * XREFs of ?OnMagnifierCreate@CMagnifierControl@@AEAAJPEAUHWND__@@H@Z @ 0x18008C2C0
 * Callers:
...
__int64 __fastcall CMagnifierControl::OnMagnifierCreate(struct CVisual **this, HWND a2, int a3)
{
  ...
  if ( dword_1800E5FD0 > *(_DWORD *)(*((_QWORD *)NtCurrentTeb()->ThreadLocalStoragePointer + (unsigned int)tls_index)
                                   + 4LL) )
  {
    Init_thread_header(&dword_1800E5FD0);
    if ( dword_1800E5FD0 == -1 )
    {
      dword_1800E5F04 = -2147023728;
      Init_thread_footer(&dword_1800E5FD0);
    }
  }
  v19 = 0LL;
  ...
  {
    v8 = -2147024809;
    MilInstrumentationCheckHR_MaybeFailFast(0x14u, &dword_1800E5F04, 1LL, -2147024809, 0x278u);
    return v8;
  }
...
LABEL_7:
    v9 = IsMagnifier;
LABEL_20:
    MilInstrumentationCheckHR_MaybeFailFast(0x14u, &dword_1800E5F04, 1LL, v9, v17);
    goto LABEL_21;
  }
  ...
  {
    v8 = -2147024882;
    MilInstrumentationCheckHR_MaybeFailFast(0x14u, &dword_1800E5F04, 1LL, -2147024882, 0x272u);
