/*
 * XREFs of DwmpCalculateColorizationColor @ 0x18003E528
 * Callers:
 *     ?ApplyColorizationParameters@CDesktopManager@@QEAAXPEBVCGlassColorizationParameters@@@Z @ 0x18003E4AC (-ApplyColorizationParameters@CDesktopManager@@QEAAXPEBVCGlassColorizationParameters@@@Z.c)
 * Callees:
...
__int64 __fastcall DwmpCalculateColorizationColor(int *a1, int *a2)
{
  ...
  v11 = (((unsigned __int8)(int)fminf(
                                  floorf_0((float)(fmaxf((float)(1.0 - v4) - (float)((float)a1[4] / 100.0), 0.0) * 255.0) + 0.5),
                                  255.0) << 8) | v10) << 8;
