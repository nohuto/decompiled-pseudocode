/*
 * XREFs of ?BitmapReceived@CIconicBitmapRegistry@@QEAAJPEAVCWindowData@@KIIPEAX_KK@Z @ 0x180088D38
 * Callers:
        ...
        char a8)
{
    ...
    && v14 )
  {
    ...
    if ( !IsWindowTab((struct CWindowData *)a2) )
    {
      if ( !(unsigned int)DwmGetIdealIconicThumbnailSize(1, (struct tagSIZE *)nNumerator) )
      {
        ...
        v11 = -2147467259;
        MilInstrumentationCheckHR_MaybeFailFast(0x14u, &dword_1800CAE90, 1LL, -2147467259, 0x2B2u);
        return v11;
      }
      v22 = nNumerator[0];
      v23 = nNumerator[1];
    ...
    {
      MilInstrumentationCheckHR_MaybeFailFast(0x14u, &dword_1800CAE90, 1LL, v24, 0x2C1u);
    }
    if ( v25 )
  ...
  else
  {
    ...
    v11 = -2147024809;
    MilInstrumentationCheckHR_MaybeFailFast(0x14u, &dword_1800CAE90, 1LL, -2147024809, 0x2A0u);
  }
  return v11;
}
