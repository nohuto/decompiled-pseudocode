/*
 * XREFs of ?StartStationaryAnimationWithDelay@CContactManager@@AEAAJIW4STATIONARY_ANIMATION_TYPE@CContactStationaryVisual@@PEBUtagPOINT@@PEBUtagRECT@@_K_N@Z @ 0x1800A08FC
 * Callers:
        ...
        char a7)
{
  ...
  *(_QWORD *)((char *)&v21 + 4) = v7;
  v11 = CreateTouchVisual<CContactStationaryVisual>(a6, &v22);
  v13 = v11;
  if ( v11 < 0 )
  {
    v19 = 2081;
