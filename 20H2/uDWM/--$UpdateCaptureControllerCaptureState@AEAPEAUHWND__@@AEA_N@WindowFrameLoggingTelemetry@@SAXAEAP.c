/*
 * XREFs of ??$UpdateCaptureControllerCaptureState@AEAPEAUHWND__@@AEA_N@WindowFrameLoggingTelemetry@@SAXAEAPEAUHWND__@@AEA_N@Z @ 0x18008CDC8
 * Callers:
 *     ?UpdateCaptureControllerCaptureState@CProjectionBorderManager@@UEAAJPEAUHWND__@@_N@Z @ 0x180090600 (-UpdateCaptureControllerCaptureState@CProjectionBorderManager@@UEAAJPEAUHWND__@@_N@Z.c)
 * Callees:
        ...
        char *a2)
{
  ...
  if ( *(_DWORD *)v5 > 5u && (*(_QWORD *)(v5 + 16) & 0x200000000000LL) != 0 )
  {
    ...
    if ( result == *(_QWORD *)(v5 + 24) )
    {
      ...
      v14 = 1;
      v11 = 8;
      return tlgWriteTransfer_EtwEventWriteTransfer(v5, byte_1800CF150, 0LL, 0LL, 4, (__int64)v9);
    }
  }
  return result;
}
