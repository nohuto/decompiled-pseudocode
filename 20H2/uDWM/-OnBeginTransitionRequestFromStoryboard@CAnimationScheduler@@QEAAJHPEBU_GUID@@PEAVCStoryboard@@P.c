/*
 * XREFs of ?OnBeginTransitionRequestFromStoryboard@CAnimationScheduler@@QEAAJHPEBU_GUID@@PEAVCStoryboard@@PEAU2@@Z @ 0x180030BE4
 * Callers:
...
LABEL_41:
      v22 = v12;
LABEL_44:
      MilInstrumentationCheckHR_MaybeFailFast(0x14u, &dword_1800D23EC, 1LL, v22, v23);
      goto LABEL_20;
    }
    if ( a3 )
