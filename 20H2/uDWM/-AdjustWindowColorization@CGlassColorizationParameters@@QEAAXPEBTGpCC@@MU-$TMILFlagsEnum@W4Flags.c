/*
 * XREFs of ?AdjustWindowColorization@CGlassColorizationParameters@@QEAAXPEBTGpCC@@MU?$TMILFlagsEnum@W4FlagsEnum@ColorizationFlags@@@@@Z @ 0x18001DA80
 * Callers:
 ...
 *     ?GetEffectiveGlassColorizationParameters@CDesktopManager@@QEAAXMU?$TMILFlagsEnum@W4FlagsEnum@ColorizationFlags@@@@_NPEAVCGlassColorizationParameters@@@Z @ 0x180086378 (-GetEffectiveGlassColorizationParameters@CDesktopManager@@QEAAXMU-$TMILFlagsEnum@W4FlagsEnum@Col.c)
 * Callees:
 ...
 *     ?IsPPIEdition@@YA_NXZ @ 0x1800363D0 (-IsPPIEdition@@YA_NXZ.c)
 *     ?GetColor@CImmersiveColor@@SAKW4IMMERSIVE_COLOR_TYPE@@@Z @ 0x18004255C (-GetColor@CImmersiveColor@@SAKW4IMMERSIVE_COLOR_TYPE@@@Z.c)
 *     floorf_0 @ 0x180056396 (floorf_0.c)
 *     _guard_dispatch_icall_nop @ 0x180056410 (_guard_dispatch_icall_nop.c)
 *     ?GetColor@ColorCache@@SAKW4IMMERSIVE_COLOR_TYPE@@@Z @ 0x180084D50 (-GetColor@ColorCache@@SAKW4IMMERSIVE_COLOR_TYPE@@@Z.c)
 ...
 *     GetStaticImmersiveColorPrivForHighContrastState @ 0x1800C1010 (GetStaticImmersiveColorPrivForHighContrastState.c)
 */
    ...
    if ( (a4 & 4) != 0 )
    {
      ...
      else
      {
        if ( v57 == 0.0 )
        {
          ...
          {
            v45 = dword_1800CD8D8[v15];
            if ( v45 != 31 )
              StaticImmersiveColorPrivForHighContrastState = GetSysColor(v45) | 0xFF000000;
          }
          else
          {
            StaticImmersiveColorPrivForHighContrastState = dword_1800CC5A0[v15];
          }
