/*
 * XREFs of ?OnCaptureRTBitsWorker@CMagnifier@@AEAAJ_KKHPEBUMAGN_UPDATE_TEXTURES_PARAM@@PEAUMILCMD_DWM_CAPTURE_METARENDERTARGET_BITSREPLY@@@Z @ 0x18008AED8
 * Callers:
        ...
        struct MILCMD_DWM_CAPTURE_METARENDERTARGET_BITSREPLY *a6)
{
  ...
  if ( *((_DWORD *)this + 42) )
  {
    ...
    {
      MilInstrumentationCheckHR_MaybeFailFast(0x14u, &dword_1800D1E28, 8LL, v12, 0x1E2u);
    }
  }
  else
  {
