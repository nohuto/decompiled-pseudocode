/*
 * XREFs of ?GDISurfaceChange@CWindowList@@UEAAJPEAUIDwmWindow@@@Z @ 0x180019FE0
 * Callers:
 *     <none>
 * Callees:
    ...
    if ( *((_DWORD *)v4 + 114) )
    {
      ...
      if ( (int)DynArrayImpl<0>::AddMultipleAndSet(&v25, 8LL, v17, v16) >= 0 )
      {
        ...
        if ( v27 )
        {
          ...
          MilInstrumentationCheckHR_MaybeFailFast(0x14u, 0LL, 0LL, v21, 0x1EEBu);
        }
      }
LABEL_22:
    ...
    if ( v7 < 0 )
    {
      MilInstrumentationCheckHR_MaybeFailFast(0x14u, 0LL, 0LL, v7, 0x140Fu);
    }
    else
    {
      v13 = *((_QWORD *)v4 + 15);
      ...
      if ( *((_QWORD **)v4 + 5) == v14 )
      {
        ...
        v7 = updated;
        if ( updated < 0 )
          MilInstrumentationCheckHR_MaybeFailFast(0x14u, 0LL, 0LL, updated, 0x1414u);
      }
    }
  }
LABEL_16:
