/*
 * XREFs of ??$UpdateCaptureControllerSize@AEAPEAUHWND__@@@WindowFrameLoggingTelemetry@@SAXAEAPEAUHWND__@@@Z @ 0x18008CEA8
 * Callers:
...
__int64 __fastcall WindowFrameLoggingTelemetry::UpdateCaptureControllerSize<HWND__ * &>(__int64 *a1)
{
  ...
  if ( *(_DWORD *)v3 > 5u && (*(_QWORD *)(v3 + 16) & 0x200000000000LL) != 0 )
  {
    ...
    if ( result == *(_QWORD *)(v3 + 24) )
    {
      ...
      v8 = 8;
      v7 = &v5;
      return tlgWriteTransfer_EtwEventWriteTransfer(v3, byte_1800CF191, 0LL, 0LL, 3, (__int64)v6);
    }
  }
  return result;
}
