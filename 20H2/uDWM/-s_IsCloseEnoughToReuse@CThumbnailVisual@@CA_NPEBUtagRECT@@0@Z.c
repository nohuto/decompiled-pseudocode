/*
 * XREFs of ?s_IsCloseEnoughToReuse@CThumbnailVisual@@CA_NPEBUtagRECT@@0@Z @ 0x180093BA4
 * Callers:
 ...
 * Callees:
 *     ?s_IsCloseEnoughToReuse@CThumbnailVisual@@CA_NNN@Z @ 0x180093B6C (-s_IsCloseEnoughToReuse@CThumbnailVisual@@CA_NNN@Z.c)
 */
