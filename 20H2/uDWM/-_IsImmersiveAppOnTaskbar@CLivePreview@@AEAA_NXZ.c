/*
 * XREFs of ?_IsImmersiveAppOnTaskbar@CLivePreview@@AEAA_NXZ @ 0x180082F04
 * Callers:
 ...
 *     ?_ShouldAddImmersiveChrome@CLivePreview@@AEAA_NXZ @ 0x1800834E0 (-_ShouldAddImmersiveChrome@CLivePreview@@AEAA_NXZ.c)
 * Callees:
 *     <none>
 */
...
bool __fastcall CLivePreview::_IsImmersiveAppOnTaskbar(CLivePreview *this)
{
  ...
  if ( v1 )
  {
    if ( ((*((_DWORD *)this + 136) - 3) & 0xFFFFFFFD) == 0 )
    {
      v3 = *(_DWORD *)(v1 + 112);
