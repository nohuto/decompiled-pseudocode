/*
 * XREFs of ?LivePreviewExcludeChange@CWindowList@@UEAAJPEAUIDwmWindow@@@Z @ 0x180045800
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall CWindowList::LivePreviewExcludeChange(CWindowList *this, struct IDwmWindow *a2)
{
  ...
  {
    MilInstrumentationCheckHR_MaybeFailFast(0x14u, 0LL, 0LL, SyncedWindowData, 0x148Eu);
  }
  else
  {
    v6 = v9;
