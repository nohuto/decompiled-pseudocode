/*
 * XREFs of ?SetHolographic@CWindowList@@UEAAJPEAUIDwmWindow@@_N@Z @ 0x180016F90
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall CWindowList::SetHolographic(CWindowList *this, struct IDwmWindow *a2, bool a3)
{
  ...
  {
    MilInstrumentationCheckHR_MaybeFailFast(0x14u, 0LL, 0LL, SyncedWindowData, 0xA57u);
  }
  else
  {
    v8 = v12;
    if ( v12 )
    {
      ...
      *((_BYTE *)v8 + 613) |= 4 * a3;
      ...
      if ( v9 )
      {
        ...
        v7 = v11;
        if ( v11 < 0 )
          MilInstrumentationCheckHR_MaybeFailFast(0x14u, 0LL, 0LL, v11, 0xA5Fu);
      }
    }
  }
