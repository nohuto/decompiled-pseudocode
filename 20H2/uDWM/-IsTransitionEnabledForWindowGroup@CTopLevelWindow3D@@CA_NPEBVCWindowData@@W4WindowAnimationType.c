/*
 * XREFs of ?IsTransitionEnabledForWindowGroup@CTopLevelWindow3D@@CA_NPEBVCWindowData@@W4WindowAnimationType@1@@Z @ 0x18000F5A4
 * Callers:
 ...
 * Callees:
 *     ?IsWindowTabEligible@@YA_NPEBVCWindowData@@@Z @ 0x18000FBB4 (-IsWindowTabEligible@@YA_NPEBVCWindowData@@@Z.c)
