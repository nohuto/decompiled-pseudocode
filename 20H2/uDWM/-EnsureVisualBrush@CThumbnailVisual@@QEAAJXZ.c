/*
 * XREFs of ?EnsureVisualBrush@CThumbnailVisual@@QEAAJXZ @ 0x180011574
 * Callers:
...
__int64 __fastcall CThumbnailVisual::EnsureVisualBrush(CThumbnailVisual *this)
{
  ...
  int v71; // eax
  CBaseObject *v72; // rcx
  __int64 v73; // [rsp+28h] [rbp-59h]
  unsigned int v74; // [rsp+28h] [rbp-59h]
  ...
  *(_QWORD *)&rc.left = 0LL;
  ...
  if ( !*((_BYTE *)this + 472) )
  {
    v71 = CRenderDataVisual::ClearInstructions(this);
    v8 = v71;
    if ( v71 < 0 )
    {
    ...
    v72 = (CBaseObject *)*((_QWORD *)this + 47);
    if ( !v72 )
      goto LABEL_30;
...
LABEL_16:
  ...
  v9 = (struct CBaseLegacyMilBrushProxy **)((char *)this + 384);
  if ( *((_QWORD *)this + 48) )
  {
...
LABEL_31:
  ...
  if ( !*((_QWORD *)this + 54) || (v11 = *((_QWORD *)this + 46)) == 0 || (*(_DWORD *)(v11 + 36) & 0x4000000) == 0 )
  {
    if ( !*v9 )
      goto LABEL_30;
    v12 = (struct CRectangleGeometryProxy **)((char *)this + 416);
    if ( !*((_QWORD *)this + 52) )
    {
    ...
    {
      v1 = *(CBaseObject **)&rc.left;
      v15 = CRenderDataVisual::AddInstruction(this, *(struct CRenderDataInstruction **)&rc.left);
      v8 = v15;
      if ( v15 < 0 )
  ...
  v28 = *(_DWORD *)(*(_QWORD *)(*((_QWORD *)this + 46) + 24LL) + 168LL);
...
LABEL_64:
    v31 = v8;
LABEL_67:
    MilInstrumentationCheckHR_MaybeFailFast(0x14u, 0LL, 0LL, v31, v74);
    goto LABEL_31;
  }
...
LABEL_66:
  ...
  if ( v35 >= 0 )
  {
    v36 = (CScaleTransformProxy *)*((_QWORD *)this + 57);
    if ( !v36 )
    {
    ...
    *(_QWORD *)&v46 = *(_OWORD *)&_mm_cvtepi32_pd(v44);
    ...
    v47 = CPushTransformInstruction::Create(*((struct CBaseTransformProxy **)this + 57), &v79);
    v8 = v47;
    if ( v47 < 0 )
    {
...
LABEL_26:
    ...
    v16 = v79;
    v48 = CRenderDataVisual::AddInstruction(this, v79);
    v8 = v48;
    if ( v48 < 0 )
    {
    ...
    v49 = CRenderDataVisual::AddInstruction(this, v83);
    v8 = v49;
    if ( v49 < 0 )
    {
    ...
    v18 = v77;
    v51 = CRenderDataVisual::AddInstruction(this, v77);
    v8 = v51;
    if ( v51 < 0 )
    {
    ...
    v52 = (CTranslateTransformProxy *)*((_QWORD *)this + 56);
    if ( !v52 )
    {
    ...
    v54 = (_DWORD *)*((_QWORD *)this + 46);
    v55 = 0;
    if ( v54[13] - v54[11] >= 0 )
      v55 = v54[13] - v54[11];
    v56 = 0;
    v57 = *(_QWORD *)(*((_QWORD *)this + 47) + 376LL);
    if ( v57 )
      v56 = *(_DWORD *)(v57 + 124);
    v58 = v54[12] - v54[10];
    v59 = 0;
    ...
    v62 = CPushTransformInstruction::Create(*((struct CBaseTransformProxy **)this + 56), &v80);
    v8 = v62;
    if ( v62 < 0 )
    {
...
LABEL_21:
    ...
    v3 = v80;
    v63 = CRenderDataVisual::AddInstruction(this, v80);
    v8 = v63;
    if ( v63 < 0 )
    {
...
LABEL_118:
    v64 = CDrawBitmapInstruction::Create(*((struct CBaseImageProxy **)this + 54), &v81);
    v8 = v64;
    if ( v64 >= 0 )
    {
      v2 = v81;
      ...
      if ( v65 >= 0 )
      {
        if ( v3 )
        {
          ...
          {
            v17 = v78;
            v67 = CRenderDataVisual::AddInstruction(this, v78);
            v8 = v67;
            if ( v67 < 0 )
