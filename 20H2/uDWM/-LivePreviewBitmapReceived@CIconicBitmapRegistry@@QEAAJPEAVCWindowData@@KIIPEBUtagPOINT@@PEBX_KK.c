/*
 * XREFs of ?LivePreviewBitmapReceived@CIconicBitmapRegistry@@QEAAJPEAVCWindowData@@KIIPEBUtagPOINT@@PEBX_KK@Z @ 0x180089050
 * Callers:
        ...
        char a9)
{
  ...
  {
    MilInstrumentationCheckHR_MaybeFailFast(0x14u, &dword_1800D1DC0, 1LL, WindowRestoreRect, 0x2FBu);
    return v19;
  }
...
LABEL_47:
    v19 = -2147024809;
    MilInstrumentationCheckHR_MaybeFailFast(0x14u, &dword_1800D1DC0, 1LL, -2147024809, v34);
    return v19;
  }
  v26 = *((_QWORD *)v13 + 12);
  if ( v26 && *(struct CWindowData **)(v26 + 72) == a2 )
  {
    ...
    if ( v27 >= 0 )
    {
      if ( *((_BYTE *)v13 + 89) )
      {
        ...
        v19 = v28;
        if ( v28 < 0 )
          MilInstrumentationCheckHR_MaybeFailFast(0x14u, &dword_1800D1DC0, 1LL, v28, 0x317u);
      }
      v29 = a6;
      v30 = *((_BYTE *)v13 + 88);
      v14 = v35;
    ...
    {
      MilInstrumentationCheckHR_MaybeFailFast(0x14u, &dword_1800D1DC0, 1LL, v27, 0x312u);
      v14 = v35;
    }
  }
  else
