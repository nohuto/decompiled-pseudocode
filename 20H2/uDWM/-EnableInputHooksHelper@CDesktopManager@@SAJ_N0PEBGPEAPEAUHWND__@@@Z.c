/*
 * XREFs of ?EnableInputHooksHelper@CDesktopManager@@SAJ_N0PEBGPEAPEAUHWND__@@@Z @ 0x180085CB8
 * Callers:
 ...
 *     ?EnableLivePreviewInputHooks@CDesktopManager@@SAJ_N0@Z @ 0x180085FAC (-EnableLivePreviewInputHooks@CDesktopManager@@SAJ_N0@Z.c)
 * Callees:
 *     ?MilInstrumentationCheckHR_MaybeFailFast@@YAXKQEBJIJIPEAX@Z @ 0x18000432C (-MilInstrumentationCheckHR_MaybeFailFast@@YAXKQEBJIJIPEAX@Z.c)
 *     ?EnableInputHooksHelper@CDesktopManager@@SAJ_N0PEBGPEAPEAUHWND__@@@Z @ 0x180085CB8 (-EnableInputHooksHelper@CDesktopManager@@SAJ_N0PEBGPEAPEAUHWND__@@@Z.c)
 *     ?SetForegroundWindowAsync@CDesktopManager@@SAJPEAUHWND__@@0_N@Z @ 0x180086C60 (-SetForegroundWindowAsync@CDesktopManager@@SAJPEAUHWND__@@0_N@Z.c)
 */
...
LABEL_18:
  ...
  if ( WindowInBand )
  {
    ...
    *((_QWORD *)CDesktopManager::s_pDesktopManagerInstance + 85) = ForegroundWindow;
    ...
    {
      MilInstrumentationCheckHR_MaybeFailFast(0x14u, &dword_1800D1D40, 2LL, v12, 0xB5Cu);
    }
    goto LABEL_18;
  }
  v7 = -2147024890;
  MilInstrumentationCheckHR_MaybeFailFast(0x14u, &dword_1800D1D40, 2LL, -2147024890, 0xB4Bu);
LABEL_19:
  if ( a1 )
