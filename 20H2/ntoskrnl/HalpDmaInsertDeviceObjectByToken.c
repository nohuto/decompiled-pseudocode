/*
 * XREFs of HalpDmaInsertDeviceObjectByToken @ 0x1403794D4
 * Callers:
 *     HalpDmaCheckAdapterToken @ 0x1404B7550 (HalpDmaCheckAdapterToken.c)
 *     HalpDmaLinkDeviceObjectByToken @ 0x140761510 (HalpDmaLinkDeviceObjectByToken.c)
 * Callees:
...
__int64 __fastcall HalpDmaInsertDeviceObjectByToken(__int64 a1, __int64 a2, char a3)
{
  ...
  if ( PoolWithTag )
  {
    ...
    *((_BYTE *)PoolWithTag + 32) = a3;
    v11 = (_QWORD *)qword_140C4BD48;
    if ( *(__int64 **)qword_140C4BD48 != &HalpDmaPdoList )
      __fastfail(3u);
    *(_QWORD *)PoolWithTag = &HalpDmaPdoList;
    *((_QWORD *)PoolWithTag + 1) = v11;
    *v11 = PoolWithTag;
    qword_140C4BD48 = (__int64)PoolWithTag;
  }
  else
  {
    v4 = -1073741670;
