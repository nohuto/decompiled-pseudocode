/*
 * XREFs of CcForEachPartition @ 0x14033B8A0
 * Callers:
 *     CcGetDirtyPages @ 0x14033B860 (CcGetDirtyPages.c)
 ...
 *     CcCoalescingCallBack @ 0x1404E7B00 (CcCoalescingCallBack.c)
 *     CcIsThereDirtyData @ 0x1404E8E40 (CcIsThereDirtyData.c)
