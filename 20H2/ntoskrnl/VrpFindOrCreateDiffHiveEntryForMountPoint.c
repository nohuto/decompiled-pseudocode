/*
 * XREFs of VrpFindOrCreateDiffHiveEntryForMountPoint @ 0x1405D3704
 * Callers:
...
LABEL_8:
  ...
  {
    DiffHiveEntry = 0LL;
    v15 = v10[1] & (-1LL << (dword_140C47824 & 0x1F));
    v12 = qword_140C47828;
    v13 = (37
         * (BYTE6(v15)
          + 37
         ...
         + HIBYTE(v15)) & (((unsigned int)dword_140C47824 >> 5) - 1);
    *v10 = *(_QWORD *)(qword_140C47828 + 8 * v13);
