/*
 * XREFs of KdInitSystem @ 0x1409B8160
 * Callers:
 ...
 *     MmGetPagedPoolCommitPointer @ 0x140331D98 (MmGetPagedPoolCommitPointer.c)
  ...
  else
  {
    ...
    if ( !KdpDebuggerDataListHead )
    {
      *((_QWORD *)&KdpContext + 1) = KdDebugDevice;
      ...
      qword_140C406C8 = (__int64)&KdpPowerListHead;
      KdpPowerListHead = (__int64)&KdpPowerListHead;
      qword_140C406B8 = (__int64)&KdpDebuggerDataListHead;
      ...
      *((_QWORD *)&xmmword_140C0F3B0 + 1) = &PsLoadedModuleList;
      *(_WORD *)((char *)&KdVersionBlock + 11) = 13059;
      qword_140C0F3C0 = (__int64)&KdpDebuggerDataListHead;
    }
    ...
    {
      v13 = 1;
      *(_QWORD *)&xmmword_140C0F3B0 = PsNtosImageBase;
    }
    qword_140C00B38 = xmmword_140C0F3B0;
    if ( !v8 )
    {
