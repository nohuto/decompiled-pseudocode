/*
 * XREFs of EtwpSendDataBlock @ 0x14071A53C
 * Callers:
...
LABEL_10:
      ...
      if ( (v17 - v10) * KeQueryTimeIncrement() >= 600010000
        && (unsigned int)dword_140C02B78 > 5
        && tlgKeywordOn((__int64)&dword_140C02B78, 0x200000000800LL) )
      {
        v43 = 8LL;
        v31 = 2164260864LL;
        v45 = 8LL;
        ...
        tlgWriteTransfer_EtwWriteTransfer(
          ...
          (unsigned __int8 *)byte_14002C97D,
          0LL,
          0LL,
          5u,
          &v41);
