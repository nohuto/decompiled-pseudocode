/*
 * XREFs of MiObtainDynamicVa @ 0x14025191C
 * Callers:
 ...
 *     MiFindNextAlignedForwardRunClearEx @ 0x1403C52C4 (MiFindNextAlignedForwardRunClearEx.c)
...
LABEL_87:
  ...
  if ( v5 == &qword_140C4E038 )
  {
    qword_140C4DEC8 -= v9 << 21;
    MiReclaimSystemVa(0LL);
  }
  _InterlockedExchangeAdd64(&qword_140C4F7C8[v32], v9);
  KeReleaseInStackQueuedSpinLockFromDpcLevel(&LockHandle);
