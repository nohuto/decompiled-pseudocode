/*
 * XREFs of HalpInterruptSetRemappedDestination @ 0x1404B9E08
 * Callers:
 ...
 *     HalpInterruptRemapUpdateDeliveryMode @ 0x1403CD6D4 (HalpInterruptRemapUpdateDeliveryMode.c)
 *     HalpInterruptGetRemappedLineState @ 0x1404B9D50 (HalpInterruptGetRemappedLineState.c)
