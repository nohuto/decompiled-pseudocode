/*
 * XREFs of RtlpMuiRegGetOrAddLangInfo @ 0x1407CB0C0
 * Callers:
 ...
 * Callees:
 *     RtlpMuiRegGetLangInfoIndex @ 0x1407CB18C (RtlpMuiRegGetLangInfoIndex.c)
 *     RtlpMuiRegResizeLanguages @ 0x1409842F4 (RtlpMuiRegResizeLanguages.c)
 */
