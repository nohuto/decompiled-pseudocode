/*
 * XREFs of MiReserveUserMemory @ 0x140625E30
 * Callers:
        ...
        _WORD *a6)
{
  ...
  if ( a2 == (__int64 *)1 )
    return 3221225485LL;
  v10 = 16;
  v11 = *(_QWORD *)(*(_QWORD *)(a1 + 88) + 1680LL);
  ...
  if ( (*(_DWORD *)(a1 + 60) & 0x20000000) != 0 && (MiFlags & 0x100000) == 0
    || (a3 & 2) == 0
    || (result = MiArbitraryCodeBlocked(*(_QWORD *)(a1 + 96)), UserPhysicalView = result, (int)result >= 0) )
  {
    v12 = ((*(_QWORD *)(a1 + 24) & 0xFFFLL) != 0) + (*(_QWORD *)(a1 + 24) >> 12);
    ...
    *((_DWORD *)PoolMm + 12) ^= (*((_DWORD *)PoolMm + 12) ^ (v16 << 12)) & 0x3F000;
    ...
    if ( v16 )
    {
      *(_BYTE *)(*(_QWORD *)(*(_QWORD *)(a1 + 88) + 1680LL) + 352LL) = 1;
      v17 = *((_DWORD *)PoolMm + 12);
    }
...
LABEL_21:
        ...
        *(_DWORD *)(v15 + 48) = v24;
        if ( !v25 )
        {
          UserPhysicalView = MiCreateWriteWatchView(*(_QWORD *)(a1 + 88), v15, v12);
        ...
        if ( (*(_BYTE *)(a1 + 120) & 1) != 0 )
        {
          if ( (*(_DWORD *)(a1 + 40) & 0x20400000) == 0x400000 || (v24 & 0x500000) == 0x500000 )
          {
            if ( *(_DWORD *)(a1 + 48) )
            {
LABEL_24:
...
LABEL_29:
                ...
                *(_BYTE *)(v15 + 33) = BYTE4(v34);
                if ( v25 )
                {
                  UserPhysicalView = MiInsertVadCharges(v15, *(struct _KPROCESS **)(a1 + 88));
                  v32 = UserPhysicalView;
                  if ( UserPhysicalView >= 0 )
                  {
                    if ( P )
                    {
                      ...
                      MiPreparePlaceholderVadReplacement(P, *(_QWORD *)(a1 + 88), v11 + 48);
                    ...
                    MiInsertPrivateVad(v15, *(_QWORD *)(a1 + 88));
                    if ( v28 )
                    ...
                    if ( !v36 )
                    {
                        ...
                        && !*(_QWORD *)(a1 + 80) )
                      {
                        ...
                        {
                          MiUnlockVad(v35, v15);
                          UNLOCK_ADDRESS_SPACE(v35, *(_QWORD *)(a1 + 88));
LABEL_43:
                          *a5 = v26;
                          return 0LL;
                        }
                        ...
                        UNLOCK_ADDRESS_SPACE_UNORDERED(v35, *(_QWORD *)(a1 + 88));
                        v26 = v55;
                        goto LABEL_145;
                      }
                    }
...
LABEL_145:
                    ...
                    if ( v25 )
                    {
                      ...
                      v32 = MiSecureVad(v15, v26, *(_QWORD *)(a1 + 24), v43, 0, (__int64)&v57);
                      if ( v32 >= 0 )
                      {
                        v44 = (unsigned __int64)v57;
LABEL_67:
                        **(_QWORD **)(a1 + 80) = qword_140C4DCD0 ^ *(_QWORD *)(a1 + 88) ^ v44;
                        goto LABEL_56;
                      }
                    }
                    else
...
LABEL_143:
                ...
                {
                  MiStoreGraphicsProtectionInVad(v15, *(unsigned int *)(a1 + 48));
                  v32 = -1073741637;
                }
                goto LABEL_73;
              }
              v33 = *(_QWORD *)(a1 + 8);
              if ( (unsigned int)MiIsVaRangeAvailable(v30, *(_QWORD *)a1, *(_QWORD *)(a1 + 24), *(_QWORD *)a1, v33) )
                goto LABEL_62;
              v32 = -1073741800;
LABEL_73:
              v27 = (__int64)v53;
...
LABEL_77:
        ...
        MiReleaseVadEventBlocks(v15, 0, v18);
    ...
    if ( (v46 & 4) != 0 )
    {
      if ( (v46 & 0x1A) == 0
        || (!v8
          ? (ProcessPartition = MiGetProcessPartition(*(_QWORD *)(a1 + 88)), CurrentThread = v53)
    ...
    UserPhysicalView = MiCreateLargePageVad(*(_QWORD *)(a1 + 88), v15, v8, 0LL);
    v32 = UserPhysicalView;
    LOBYTE(v8) = v10;
    if ( UserPhysicalView < 0 )
      goto LABEL_76;
