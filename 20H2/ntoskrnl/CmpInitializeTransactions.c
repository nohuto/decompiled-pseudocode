/*
 * XREFs of CmpInitializeTransactions @ 0x140A56678
 * Callers:
...
__int64 *CmpInitializeTransactions()
{
  ...
  qword_140C479E8 = (__int64)&CmpRmListHead;
  ...
  qword_140C47C68 = (__int64)&CmpLazyCommitListHead;
  ...
  _mm_lfence();
  if ( (void *)qword_140C4C640 == CmpRmListLock.Owner )
  {
    v0 = __rdtsc();
    ...
    qword_140C4C658 = v1;
    qword_140C4C650 = KiQueryUnbiasedInterruptTime() + 41929663 * (__rdtsc() >> 4) % 0x12A05F2000LL + 288000000000LL;
  }
  CmpLazyCommitTimer = 8LL;
  qword_140C47C98 = (__int64)CmpLazyCommitDpcRoutine;
  CmpLazyCommitDpc = 275;
  qword_140C47CD0 = (__int64)&qword_140C47CC8;
  qword_140C47CC8 = (__int64)&qword_140C47CC8;
  qword_140C47A48 = (__int64)&CmpDelayFreeRMListHead;
  ...
  qword_140C47A98 = (__int64)CmpDelayFreeRMDpcRoutine;
  qword_140C47CA0 = 0LL;
  qword_140C47CB8 = 0LL;
  qword_140C47C90 = 0LL;
  qword_140C47CD8 = 0LL;
  ...
  qword_140C47C28 = (__int64)&CmpLightTransactionList;
