/*
 * XREFs of ?wil_details_FeatureReporting_IncrementOpportunityInCache@@YAXPEAUwil_details_FeatureReportingCache@@W4wil_details_ServiceReportingKind@@IPEAUwil_details_RecordUsageResult@@@Z @ 0x1405BEDD4
 * Callers:
        ...
        struct wil_details_RecordUsageResult *a4)
{
  ...
  while ( 1 )
  {
    ...
    v12 = _InterlockedCompareExchange(&dword_140CDB3E0, v7 ^ (v7 ^ ((_DWORD)v11 << 15)) & 0x3F8000, v4);
    if ( v4 == v12 )
      break;
    v4 = v12;
  }
