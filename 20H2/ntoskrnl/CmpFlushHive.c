/*
 * XREFs of CmpFlushHive @ 0x1406504C8
 * Callers:
...
__int64 __fastcall CmpFlushHive(ULONG_PTR BugCheckParameter2, unsigned int a2)
{
  ...
  if ( (unsigned int)dword_140C02130 > 4 )
  {
    ...
    tlgWriteTransfer_EtwWriteTransfer(
      ...
      (unsigned __int8 *)byte_1400223D5,
      0LL,
      0LL,
      7u,
      UserData);
...
LABEL_88:
    ...
    valid = CmpWaitOnHiveWriteQueue(BugCheckParameter2, v11);
    if ( valid >= 0 )
      v7 += v46;
LABEL_119:
    if ( v7 >= 2 )
  ...
  CmpGenerateFlushControlData(BugCheckParameter2, v8, (int *)&v55);
  Ptr = v55.Ptr;
  if ( (unsigned int)dword_140C02130 > 4 )
  {
    v65 = 0;
    ...
    tlgWriteTransfer_EtwWriteTransfer(
      (__int64)&dword_140C02130,
      (unsigned __int8 *)&dword_14002240C,
      0LL,
      0LL,
      4u,
      UserData);
...
LABEL_25:
    if ( (Ptr & 0x158) != 0 )
      v13 = HvStoreModifiedData(BugCheckParameter2, (Ptr & 0x110) != 0, (Ptr & 0x40) != 0);
    else
      v13 = 0;
    if ( v13 )
    {
...
LABEL_30:
        ...
        if ( (Ptr & 0x80u) != 0 )
        {
          CmpLogFlushPhaseStart(v16, 1);
          v17 = v50;
          valid = HvExtendHivePrimaryFileValidDataLength(BugCheckParameter2, Ptr_high, v50);
          CmpLogFlushPhaseEnd(v49, 1, valid);
        ...
        if ( (Ptr & 8) != 0 )
        {
          CmpLogFlushPhaseStart(v16, 2);
          valid = HvWriteLogFile(BugCheckParameter2, v18, v19, &v52);
          CmpLogFlushPhaseEnd(v20, 2, valid);
          if ( valid < 0 )
            goto LABEL_46;
        ...
        if ( (Ptr & 0x10) != 0 )
        {
          CmpLogFlushPhaseStart(v16, 3);
          LOBYTE(v31) = 1;
          valid = HvValidateOrInvalidatePrimaryFileHeader(BugCheckParameter2, 0LL, v31, v17);
          CmpLogFlushPhaseEnd(v32, 3, valid);
          if ( valid < 0 )
          {
            Ptr |= 0x400u;
            goto LABEL_46;
        ...
        CmpLogFlushPhaseEnd(v21, 4, valid);
        if ( (Ptr & 0x20) != 0 )
        {
          v30 = v55.Size >> 2;
        ...
        if ( (Ptr & 0x40) != 0 )
        {
          CmpLogFlushPhaseStart(v22, 5);
          valid = HvWriteHivePrimaryFile(BugCheckParameter2);
          CmpLogFlushPhaseEnd(v28, 5, valid);
          if ( valid < 0 )
            goto LABEL_46;
        ...
        if ( (Ptr & 0x100) != 0 )
        {
          CmpLogFlushPhaseStart(v22, 6);
          LOBYTE(v33) = 1;
          LOBYTE(v34) = 1;
          valid = HvValidateOrInvalidatePrimaryFileHeader(BugCheckParameter2, v34, v33, v17);
          CmpLogFlushPhaseEnd(v35, 6, valid);
          if ( valid < 0 )
            goto LABEL_46;
          LOBYTE(Ptr_high) = Ptr_high | 0x20;
        ...
        {
          CmpLogFlushPhaseStart(v22, 7);
          if ( (int)CmpFileFlushAndPurge(BugCheckParameter2, 0) >= 0 )
            LOBYTE(Ptr_high) = Ptr_high | 0x20;
          CmpLogFlushPhaseEnd(v36, 7, (Ptr_high & 0x20) == 0 ? 0xC0000001 : 0);
        }
        valid = 0;
LABEL_46:
        CmpLockRegistry();
...
LABEL_71:
  ...
  if ( (unsigned int)dword_140C02130 > 4 )
  {
    *(_DWORD *)&EventDescriptor_8.Id = valid;
    ...
    v59 = 4LL;
    tlgWriteTransfer_EtwWriteTransfer((__int64)&dword_140C02130, (unsigned __int8 *)word_1400223B2, 0LL, 0LL, 3u, &v55);
  }
