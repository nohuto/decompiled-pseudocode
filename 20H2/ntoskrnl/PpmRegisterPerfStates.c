/*
 * XREFs of PpmRegisterPerfStates @ 0x1407B5080
 * Callers:
 *     PpmPerfRegisterNativePerfStates @ 0x1407B4E70 (PpmPerfRegisterNativePerfStates.c)
...
LABEL_50:
    ...
    v62 = (LARGE_INTEGER **)qword_140CFC4F0;
    ++PpmPerfDomainCount;
    if ( *(__int64 **)qword_140CFC4F0 != &PpmPerfDomainHead )
      __fastfail(3u);
