/*
 * XREFs of MiMakeVaRangeNoAccess @ 0x140327684
 * Callers:
...
LABEL_21:
        *(_QWORD *)a2 = v21;
        ...
        if ( ++v18 >= v35 )
        {
          MiUpdatePfnProtection((__int64)v33, (__int64)v34, 0x18u);
          return 1LL;
        }
      }
    }
  ...
  {
    TransitionPte = MI_READ_PTE_LOCK_FREE(a2);
    if ( (TransitionPte & 1) == 0 || ((_DWORD)v33[6] & 0x70) == 0x40 && MiRotatedToFrameBuffer(a2) )
      break;
