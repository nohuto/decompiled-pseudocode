/*
 * XREFs of MiDispatchFault @ 0x140270220
 * Callers:
 ...
 *     MiAdjustFaultList @ 0x14031A6C8 (MiAdjustFaultList.c)
...
LABEL_14:
      ...
      if ( (v21 & 4) != 0 )
      {
        ...
        {
          v40 = MiResolvePageFileFault((unsigned __int64 *)&v48, v12, 0LL, &v45);
          v20 = v49;
          v22 = v40;
        }
        goto LABEL_27;
