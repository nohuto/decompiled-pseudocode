/*
 * XREFs of IvtInitializeIommu @ 0x1409ACA80
 * Callers:
 *     <none>
 * Callees:
 ...
 *     IvtBuildContextEntry @ 0x1404DDE10 (IvtBuildContextEntry.c)
 ...
 *     IvtGetIdentityMappedDomain @ 0x1404DE614 (IvtGetIdentityMappedDomain.c)
 *     IvtInitializeIdentityMappings @ 0x1404DE7E0 (IvtInitializeIdentityMappings.c)
 *     IvtInitializeMTRR @ 0x1404DEA64 (IvtInitializeMTRR.c)
 *     IvtInvalidateAllContextEntries @ 0x1404DEC50 (IvtInvalidateAllContextEntries.c)
