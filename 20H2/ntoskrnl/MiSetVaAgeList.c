/*
 * XREFs of MiSetVaAgeList @ 0x1402B0AC0
 * Callers:
...
__int64 __fastcall MiSetVaAgeList(__int64 a1, unsigned __int64 a2, unsigned int a3, unsigned __int8 a4)
{
  ...
  _DWORD v79[8]; // [rsp+68h] [rbp-1h] BYREF
  ...
  *(_QWORD *)&LockHandle.OldIrql = 0LL;
  ...
  if ( (v9 & 7) == 2 )
    v11 = (unsigned __int64 *)&unk_140C4F640;
  else
...
LABEL_47:
  ...
  if ( v10 )
  {
    ...
    v78 = v37;
    if ( MiPteInShadowRange((unsigned __int64)&v78) && (MiFlags & 0xC00000) != 0 )
    {
      Process = KeGetCurrentThread()->ApcState.Process;
      if ( Process->AddressPolicy != 1 && (v37 & 1) != 0 && ((v37 & 0x20) == 0 || (v37 & 0x42) == 0) )
      {
        Process = KeGetCurrentThread()->ApcState.Process;
        v67 = Process[1].ProcessListEntry.Flink;
        if ( v67 )
        {
          v68 = *((_QWORD *)&v67->Flink + (((unsigned __int64)&v78 >> 3) & 0x1FF));
          v69 = v37 | 0x20;
          Process = (_KPROCESS *)(unsigned __int8)v68;
