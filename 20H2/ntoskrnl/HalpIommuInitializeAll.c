/*
 * XREFs of HalpIommuInitializeAll @ 0x14099DE54
 * Callers:
 ...
 *     HalpIommuUpdatePageTableLevel @ 0x1403A6A04 (HalpIommuUpdatePageTableLevel.c)
 *     HalpIommuUpdatePageWalkCapability @ 0x1403A6A34 (HalpIommuUpdatePageWalkCapability.c)
