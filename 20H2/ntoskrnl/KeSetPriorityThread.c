/*
 * XREFs of KeSetPriorityThread @ 0x1402DAB40
 * Callers:
...
LABEL_36:
  ...
  if ( Priority != v10 )
  {
    ...
    if ( BasePriority && !Priority )
      Priority = 1;
    if ( (BasePriority < 16 || Priority >= 16) && KiSetPriorityThread(Thread, (__int64)&v23, Priority) )
      v4 = Thread->Priority;
  }
  KiReleaseThreadLockSafe(Thread);
  KiProcessDeferredReadyList((__int64)CurrentPrcb, (__int64)&v23, CurrentIrql);
