/*
 * XREFs of MiRemoveWsle @ 0x1402BC4C0
 * Callers:
...
signed __int64 __fastcall MiRemoveWsle(__int64 a1, unsigned __int64 a2, __int64 a3, char a4, int a5, int a6)
{
  ...
  __int64 v36; // rax
  __int64 v37; // rdx
  signed __int64 v38; // [rsp+20h] [rbp-68h] BYREF
  ...
  v40 = 0LL;
  if ( v6 == 2 )
    v11 = (volatile signed __int64 *)&unk_140C4F640;
  else
  ...
  if ( (*(_BYTE *)(a1 + 184) & 7) == 4 )
  {
    ...
    {
      LODWORD(xmmword_140C4CBC8) = xmmword_140C4CBC8 - a3;
    }
