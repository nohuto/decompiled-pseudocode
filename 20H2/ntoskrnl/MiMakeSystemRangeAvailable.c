/*
 * XREFs of MiMakeSystemRangeAvailable @ 0x14024F8D4
 * Callers:
...
LABEL_11:
  ...
  _InterlockedExchangeAdd64(&qword_140C4F7C8[(int)BugCheckParameter4], -(__int64)v4);
  if ( (_DWORD)BugCheckParameter4 == 8 )
    qword_140C4DEC8 += BugCheckParameter3;
