/*
 * XREFs of WheapWmiExecutePolicyManagementMethod @ 0x1405BC490
 * Callers:
 *     WheapWmiExecuteMethod @ 0x1405BC360 (WheapWmiExecuteMethod.c)
 * Callees:
 *     WheapCommitPolicy @ 0x1409604D0 (WheapCommitPolicy.c)
 *     WheapGetAllPolicyBufferSize @ 0x1409605C0 (WheapGetAllPolicyBufferSize.c)
 *     WheapGetAllPolicyValues @ 0x1409605D0 (WheapGetAllPolicyValues.c)
 *     WheapGetPolicyValue @ 0x140960614 (WheapGetPolicyValue.c)
 *     WheapSetPolicyValue @ 0x1409607B8 (WheapSetPolicyValue.c)
 */
