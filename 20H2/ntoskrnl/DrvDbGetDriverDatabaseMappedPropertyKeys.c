/*
 * XREFs of DrvDbGetDriverDatabaseMappedPropertyKeys @ 0x14097FC84
 * Callers:
        ...
        unsigned int *a6)
{
  ...
  v11 = 0;
  *a6 = 0;
  CompositeMappedPropertyKeys = DrvDbGetCompositeMappedPropertyKeys(a1, (_OWORD **)off_140C02C70, 7u, a4, a5, v34);
