/*
 * XREFs of PnpTraceDockDeviceEnumeration @ 0x1408B4544
 * Callers:
...
void PnpTraceDockDeviceEnumeration()
{
  ...
  if ( (unsigned int)dword_140C02DC0 > 5 )
  {
    if ( tlgKeywordOn((__int64)&dword_140C02DC0, 0x400000000000LL) )
    {
      ...
      v3 = v1;
      v12 = 4LL;
      tlgWriteTransfer_EtwWriteTransfer((__int64)&dword_140C02DC0, (unsigned __int8 *)byte_140024483, 0LL, 0LL, 6u, &v4);
    }
  }
}
