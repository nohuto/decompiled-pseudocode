/*
 * XREFs of EmonInitializeProfiling @ 0x1409A2EA0
 * Callers:
 *     <none>
 * Callees:
 ...
 *     EmonFreeCounter @ 0x1403BA7B8 (EmonFreeCounter.c)
...
__int64 EmonInitializeProfiling()
{
  ...
  if ( !Number )
  {
    ...
    qword_140C48E88 = (__int64)&EmonProfileSourceDescriptorListHead;
    EmonProfileSourceDescriptorListHead = (__int64)&EmonProfileSourceDescriptorListHead;
    qword_140C48EA8 = (__int64)&EmonReservedResourcesList;
    ...
    if ( Memory )
    {
      ...
      do
      {
        ...
        if ( !EmonProfileSourceDescriptorTable[v24 + 29] )
        {
          ...
          v26 = (_QWORD *)qword_140C48E88;
          if ( *(__int64 **)qword_140C48E88 != &EmonProfileSourceDescriptorListHead )
            __fastfail(3u);
          ++EmonProfileSourceDescriptorCount;
          *v25 = &EmonProfileSourceDescriptorListHead;
          v25[1] = v26;
          *v26 = v25;
          qword_140C48E88 = (__int64)v25;
        }
