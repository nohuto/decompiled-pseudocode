/*
 * XREFs of SeQuerySigningPolicyWorker @ 0x14069004C
 * Callers:
 *     SeQuerySigningPolicy @ 0x140690484 (SeQuerySigningPolicy.c)
 * Callees:
 *     AppModelPolicy_GetPolicy_Internal @ 0x1402E3E94 (AppModelPolicy_GetPolicy_Internal.c)
        ...
        unsigned __int8 *a8)
{
  ...
  v27[0] = 0LL;
  v27[1] = 0LL;
  LODWORD(v12) = AppModelPolicy_GetPolicy_Internal(Token, (__int64)a2, (int *)&TokenInformation + 1, &v26, v27);
  if ( (int)v12 >= 0 )
  {
    ...
    if ( (unsigned int)(HIDWORD(TokenInformation) - 3014657) <= 1 )
    {
      ...
      {
        v16 = &Feature_LogErrorRecords_logged_traits;
        v17 = 17895887;
