/*
 * XREFs of HalpIommuAllocateRemappingTableEntry @ 0x1404C3948
 * Callers:
 *     HalpIrtAllocateIndex @ 0x140867D74 (HalpIrtAllocateIndex.c)
 * Callees:
 *     HalpIommuConvertPciBusMasterDescriptorToDeviceId @ 0x1403EF65C (HalpIommuConvertPciBusMasterDescriptorToDeviceId.c)
