/*
 * XREFs of KiParkUmsThread @ 0x140524440
 * Callers:
 ...
 *     KeRestoreLegacyFloatingPointControlWord @ 0x1403FC3B0 (KeRestoreLegacyFloatingPointControlWord.c)
 *     _alloca_probe @ 0x140405E30 (_alloca_probe.c)
 *     KiUmsRestoreUch @ 0x1404109C0 (KiUmsRestoreUch.c)
