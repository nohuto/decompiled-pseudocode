/*
 * XREFs of MiTrimSharedPage @ 0x14031F424
 * Callers:
 ...
 *     MiClusterVadFull @ 0x140553D98 (MiClusterVadFull.c)
 */
...
__int64 __fastcall MiTrimSharedPage(__int64 a1, unsigned __int8 a2, unsigned int a3)
{
  ...
  _QWORD *v32; // [rsp+90h] [rbp+40h] BYREF
  ...
  if ( (*(_DWORD *)(a1 + 16) & 0x400LL) == 0 )
  {
    ...
    if ( v18 )
    {
      ...
      if ( !v11 || *(int *)(v13 + 56) >= 0 || (unsigned int)MiClusterVadFull(a1, v18) != 1 )
        goto LABEL_18;
      v28 = (_QWORD *)MiDecrementModifiedWriteCount(v13, 0);
      if ( v28 )
  ...
  v13 = MiPreventControlAreaDeletion(a1, 0LL, &BugCheckParameter2, &v32);
  if ( !v13 )
    return 0LL;
  v14 = *(_QWORD *)(a1 + 16);
