/*
 * XREFs of HalpFirmwareInitDiscard @ 0x140A71BE0
 * Callers:
 *     HalpFirmwareInitSystem @ 0x1409A3E60 (HalpFirmwareInitSystem.c)
 * Callees:
...
__int64 __fastcall HalpFirmwareInitDiscard(__int64 a1)
{
  ...
  if ( (*(_DWORD *)(a1 + 264) & 1) != 0 )
  {
    ...
    xmmword_140C49DF0 = *(_OWORD *)(a1 + 280);
    xmmword_140C49E00 = *(_OWORD *)(a1 + 296);
    xmmword_140C49E10 = *(_OWORD *)(a1 + 312);
    HalpEfiTimeCalls = 0;
    HalpEfiTimeWrites = 0;
