/*
 * XREFs of PipProcessQueryRemovalInKernelMode @ 0x14072E35C
 * Callers:
 ...
 *     PiSendTargetDeviceRemoveCanceledNotification @ 0x1408BBB60 (PiSendTargetDeviceRemoveCanceledNotification.c)
 */
