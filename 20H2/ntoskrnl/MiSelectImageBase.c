/*
 * XREFs of MiSelectImageBase @ 0x14062B97C
 * Callers:
 ...
 *     MiGetImageWowSubsystemIndex @ 0x14062BF00 (MiGetImageWowSubsystemIndex.c)
 ...
 *     MiImageCanUseHighOverflowArea @ 0x1408DA510 (MiImageCanUseHighOverflowArea.c)
