/*
 * XREFs of TtmiLogTerminalDestroyed @ 0x140907040
 * Callers:
 *     TtmpDeleteTerminal @ 0x1409006F0 (TtmpDeleteTerminal.c)
 * Callees:
...
void TtmiLogTerminalDestroyed()
{
  ...
  if ( (unsigned int)dword_140D2D8E8 > 5 )
  {
    if ( tlgKeywordOn((__int64)&dword_140D2D8E8, 1LL) )
    {
      ...
      v1 = v0;
      v4 = 8;
      tlgWriteTransfer_EtwWriteTransfer((__int64)&dword_140D2D8E8, (unsigned __int8 *)byte_14002A8E1, 0LL, 0LL, 3u, &v2);
    }
  }
}
