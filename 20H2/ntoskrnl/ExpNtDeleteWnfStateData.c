/*
 * XREFs of ExpNtDeleteWnfStateData @ 0x1407C954C
 * Callers:
 *     NtDeleteWnfStateData @ 0x1407C9530 (NtDeleteWnfStateData.c)
 *     ExWnfCrossVmCallback @ 0x1409584D0 (ExWnfCrossVmCallback.c)
 * Callees:
