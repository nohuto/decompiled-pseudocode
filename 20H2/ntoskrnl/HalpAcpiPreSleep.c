/*
 * XREFs of HalpAcpiPreSleep @ 0x14099870C
 * Callers:
 *     HaliAcpiSleep @ 0x140385150 (HaliAcpiSleep.c)
 * Callees:
 *     HalpAcpiPmRegisterWrite @ 0x14037C4D0 (HalpAcpiPmRegisterWrite.c)
 *     HalpAcpiPmRegisterAvailable @ 0x14037C790 (HalpAcpiPmRegisterAvailable.c)
 ...
 *     HalpSetClockBeforeSleep @ 0x140385D84 (HalpSetClockBeforeSleep.c)
 ...
 *     HalpSaveDmaControllerState @ 0x1409988A0 (HalpSaveDmaControllerState.c)
 */
...
void *__fastcall HalpAcpiPreSleep(int a1)
{
  ...
  {
    HalpAcpiPmRegisterRead(0, (unsigned __int8)byte_140C49EF8 >> 1, (__int64)&v10, 2u, 0LL);
    v6 = v10;
    v9 = v10;
    if ( (int)HalpAcpiPmRegisterAvailable(3) >= 0 )
    {
      HalpAcpiPmRegisterRead(3, (unsigned __int8)byte_140C49EF8 >> 1, (__int64)&v10, 2u, 0LL);
      v6 = v10 | v9;
      v9 |= v10;
    }
    if ( (dword_140C49F10 & 0x40) == 0 )
    {
    ...
    HalpAcpiPmRegisterWrite(0, (unsigned __int8)byte_140C49EF8 >> 1, (__int64)&v9, 2u, 0LL);
    if ( (int)HalpAcpiPmRegisterAvailable(3) >= 0 )
      HalpAcpiPmRegisterWrite(3, (unsigned __int8)byte_140C49EF8 >> 1, (__int64)&v9, 2u, 0LL);
