/*
 * XREFs of MiInitializeWowPeb @ 0x1406B006C
 * Callers:
...
__int64 __fastcall MiInitializeWowPeb(__int64 a1, __int64 a2, __int64 a3, __int64 a4)
{
  ...
  if ( v8 && ((v9 = *(_WORD *)(v8 + 8), v9 == 332) || v9 == 452) )
  {
    ...
    if ( v12 )
    {
      ...
      if ( ((unsigned int)v14 & (unsigned __int64)qword_140CFC848[*(unsigned __int16 *)(a4 + 8)]) != v14 )
        v14 = 0LL;
      *(_QWORD *)a4 = v14;
      v13 = v27;
    }
  ...
  if ( (int)result >= 0 )
  {
    ...
    **(_QWORD **)(a3 + 1408) = v28[0];
    ...
    if ( v17 )
    {
      ...
      *(_QWORD *)(v19 + 112) = qword_140C4DCA0;
    ...
    else
    {
      ...
      *(_QWORD *)(v19 + 192) = qword_140C4DCA0;
