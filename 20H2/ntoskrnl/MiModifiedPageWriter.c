/*
 * XREFs of MiModifiedPageWriter @ 0x1403BE5C0
 * Callers:
 *     <none>
 * Callees:
...
LONG __fastcall MiModifiedPageWriter(__int64 a1, __int64 a2, __int64 a3, _DWORD *a4)
{
  ...
  *((_DWORD *)&CurrentThread[1].SwapListEntry + 3) |= 2u;
  v56 = KeSetActualBasePriorityThread((__int64)CurrentThread, 18, a3, a4);
  v6 = a1 + 104;
  v61[2] = (PVOID)(a1 + 920);
...
LABEL_45:
      ...
      if ( MiUseLowIoPriorityForModifiedPages(a1) )
      {
        ...
        *(_DWORD *)(a1 + 720) = 4;
        v18 = KeSetActualBasePriorityThread((__int64)CurrentThread, 4, v16, v17);
        v19 = 0;
      }
      else
      {
