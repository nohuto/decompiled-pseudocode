/*
 * XREFs of ExCreateCallback @ 0x1406DD3F0
 * Callers:
        ...
        BOOLEAN AllowMultipleCallbacks)
{
  ...
  if ( Create )
  {
    ...
    *(_QWORD *)&v14[1].Version = v14 + 1;
    ...
    v15 = (_DMA_OPERATIONS ***)qword_140C192B8;
    p_DmaOperations = &v14[2].DmaOperations;
    if ( *(__int64 **)qword_140C192B8 != &ExpCallbackListHead )
      __fastfail(3u);
    *(_QWORD *)&v14[3].Version = qword_140C192B8;
    *p_DmaOperations = (_DMA_OPERATIONS *)&ExpCallbackListHead;
    *v15 = p_DmaOperations;
    qword_140C192B8 = (__int64)&v14[2].DmaOperations;
