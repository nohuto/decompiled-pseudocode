/*
 * XREFs of RtlEnumerateBoundaryDescriptorEntries @ 0x1406FCBFC
 * Callers:
 *     ObpCompareEntryLevel1 @ 0x1406FC370 (ObpCompareEntryLevel1.c)
 ...
 *     ObpCheckDuplicateEntries @ 0x14071BA34 (ObpCheckDuplicateEntries.c)
