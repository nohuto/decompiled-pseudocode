/*
 * XREFs of IopLiveDumpAllocAndInitResources @ 0x1408995EC
 * Callers:
 ...
 *     RtlSetAllBitsEx @ 0x1403CAC20 (RtlSetAllBitsEx.c)
 ...
 *     IopLiveDumpResetCorralContext @ 0x1409B0638 (IopLiveDumpResetCorralContext.c)
...
LABEL_44:
  if ( (unsigned int)dword_140C04498 > 5 && tlgKeywordOn((__int64)&dword_140C04498, 0x200000000000LL) )
  {
    ...
    tlgWriteTransfer_EtwWriteTransfer(
      ...
      (unsigned __int8 *)byte_140023C08,
      (const GUID *)(a1 + 864),
      (const GUID *)(a1 + 848),
      7u,
      &v40);
