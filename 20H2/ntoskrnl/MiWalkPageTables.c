/*
 * XREFs of MiWalkPageTables @ 0x14026A5E0
 * Callers:
 ...
 *     MiInitializeWalkBounds @ 0x14026A430 (MiInitializeWalkBounds.c)
...
__int64 __fastcall MiWalkPageTables(__int64 a1)
{
  ...
  if ( !*(_BYTE *)(a1 + 5) )
    *(_BYTE *)(a1 + 5) = 15;
  v2 = *(_QWORD *)(a1 + 56);
  *(_QWORD *)(a1 + 72) = *(_QWORD *)(qword_140C4E4C8 + 8LL * *(unsigned __int16 *)(*(_QWORD *)(a1 + 24) + 174LL));
  if ( v2 )
  {
