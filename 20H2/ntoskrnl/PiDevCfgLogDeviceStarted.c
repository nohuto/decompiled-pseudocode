/*
 * XREFs of PiDevCfgLogDeviceStarted @ 0x14073D3CC
 * Callers:
 *     PpDevCfgTraceDeviceStart @ 0x140738548 (PpDevCfgTraceDeviceStart.c)
 * Callees:
 *     RtlInitUnicodeString @ 0x140210D50 (RtlInitUnicodeString.c)
 *     PipIsDevNodeDNStarted @ 0x140363608 (PipIsDevNodeDNStarted.c)
 *     PnpGetLogString @ 0x14036E1B0 (PnpGetLogString.c)
...
void __fastcall PiDevCfgLogDeviceStarted(__int64 a1)
{
  ...
  *(_QWORD *)&v31.Length = 0LL;
  ...
  if ( (byte_140C130BA & 0x18) == 0x18 )
  {
    ...
    LODWORD(v35[16]) = 8210;
    LODWORD(v35[21]) = 8210;
    if ( (int)PiDevCfgQueryObjectProperties(8210LL, v2, 1u, 0LL, (__int64)v35, 5u) >= 0 )
    {
      if ( SLODWORD(v35[4]) < 0 )
        v34 = 0LL;
      if ( SLODWORD(v35[9]) < 0 )
      ...
      if ( v7 || !PipIsDevNodeDNStarted(a1) )
      {
        ...
        {
          if ( ((unsigned __int8)v4 & (unsigned __int8)byte_140C130BA) != 0 )
          {
