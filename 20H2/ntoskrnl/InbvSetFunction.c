/*
 * XREFs of InbvSetFunction @ 0x1403C7D2C
 * Callers:
...
__int64 __fastcall InbvSetFunction(int a1)
{
  ...
  result = (unsigned int)dword_140C509E0;
  if ( (unsigned int)(dword_140C509E0 - 3) <= 1 )
  {
    if ( qword_140C509E8 )
    {
      v3 = *(void (__fastcall **)(_QWORD))(qword_140C509E8 + 136);
      if ( v3 )
        v3(0LL);
    }
    v4 = off_140C02F20;
    result = 4 - (unsigned int)(a1 != 4);
    dword_140C509E0 = 4 - (a1 != 4);
    if ( a1 != 4 )
      v4 = off_140C02FE0;
    qword_140C509E8 = (__int64)v4;
  }
  return result;
}
