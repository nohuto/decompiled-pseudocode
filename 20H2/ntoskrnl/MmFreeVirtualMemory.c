/*
 * XREFs of MmFreeVirtualMemory @ 0x140624BF0
 * Callers:
 *     PsDispatchIumService @ 0x1405812E4 (PsDispatchIumService.c)
 *     NtFreeVirtualMemory @ 0x140624B20 (NtFreeVirtualMemory.c)
...
LABEL_85:
    ...
    v31 = MiFreeVadRange((ULONG_PTR)v17, (int)&v38, v22, v21, v15, v44 != 0);
    v16 = v31;
    if ( v31 >= 0 )
    {
      if ( v13 )
