/*
 * XREFs of IopGetBootDiskInformationLite @ 0x140A469F0
 * Callers:
 *     IoGetBootDiskInformationLite @ 0x140793AC0 (IoGetBootDiskInformationLite.c)
 * Callees:
 ...
 *     IopAddBootDiskInformation @ 0x1403B3134 (IopAddBootDiskInformation.c)
