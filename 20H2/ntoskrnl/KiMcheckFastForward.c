/*
 * XREFs of KiMcheckFastForward @ 0x140524BE0
 * Callers:
...
unsigned __int64 __fastcall KiMcheckFastForward(ULONG_PTR BugCheckParameter4, char a2)
{
  ...
  if ( (*(_BYTE *)(BugCheckParameter4 + 368) & 1) == 0 )
  {
    ...
    if ( KiKvaShadow )
    {
      ...
      {
        v4 |= 4u;
        _InterlockedAdd(&dword_140C2AE0C, 1u);
      }
      if ( KiKvaShadow
  ...
  if ( a2 || (v4 & 1) != 0 )
  {
    _InterlockedAdd(&dword_140C2AE18, 1u);
    if ( (v4 & 1) != 0 )
      _InterlockedAdd(&dword_140C2AE20, 1u);
    v9 = 1;
  }
  else
  {
    _InterlockedAdd(&dword_140C2AE1C, 1u);
    v9 = 0;
  }
  v10 = 0LL;
  if ( KiKvaShadow )
...
LABEL_31:
  if ( (v4 & 4) != 0 )
  {
    _InterlockedAdd(&dword_140C2AE24, 1u);
    ...
    if ( KiKvaShadow )
    {
      ...
      *(_QWORD *)(v10 + 24) = CurrentPrcb->HalReserved[(unsigned __int64)v12 / 8];
      ...
      {
        _InterlockedAdd(&dword_140C2AE28, 1u);
    ...
    *(_QWORD *)(v3 + 64) = result;
    _InterlockedAdd(&dword_140C2AE14, 1u);
    *(_WORD *)((char *)&CurrentPrcb->CurrentThread + v12) = 0;
  }
  if ( !a2 )
  {
    _InterlockedAdd(&dword_140C2AE10, 1u);
