/*
 * XREFs of PopExecutePowerAction @ 0x140771228
 * Callers:
 ...
 *     PopCriticalShutdown @ 0x1408E9EF4 (PopCriticalShutdown.c)
 *     PopStartStopTtmSxTranstion @ 0x1408EA0C0 (PopStartStopTtmSxTranstion.c)
 ...
 *     PopPromoteActionFlag @ 0x14077160C (PopPromoteActionFlag.c)
 *     PopCompareActions @ 0x14077165C (PopCompareActions.c)
...
int __fastcall PopExecutePowerAction(__int64 a1, unsigned int a2, __int64 *a3, int a4, unsigned int a5)
{
  ...
  if ( (xmmword_140CFC490 & 0x8000) != 0 )
  {
    ...
    v57 = a1;
    v61 = 16;
    EtwTraceKernelEvent((__int64)&v60, 1u, 0x80008000, 0x1222u, 0x401802u);
  }
  v54 = v7;
  v10 = 0;
  v55 = a4;
...
LABEL_13:
      ...
      if ( v14 )
      {
        ...
        if ( v14 == 4 )
          v18 = v17;
        v46 = v18;
        if ( (int)PopCompareActions(v14, (unsigned int)qword_140C23304) < 0 )
        {
          v22 = 2;
        }
        else
        {
          ...
          if ( v26 > SHIDWORD(qword_140C23304) )
          {
            v45 |= v25;
            HIDWORD(qword_140C23304) = v26;
          }
        }
        LOBYTE(v20) = 1;
        ...
        else
        {
          ...
          if ( !(unsigned int)PopCompareActions(v36, v35) )
            v37 |= v22;
          LODWORD(qword_140C23304) = v14;
          v38 = v37 | 5;
          v33 = v14;
          dword_140C23314 = *(_DWORD *)a1;
          dword_140C23318 = 0;
          v45 = v38;
          if ( !*(_DWORD *)a1 )
            dword_140C23318 = *(_DWORD *)(a1 + 16);
        }
        if ( v33 == 3 )
          LODWORD(qword_140C23304) = v22;
        if ( v38 )
        {
          if ( TtmpEnabled == 1 )
            PopTtmIsSxTransitionInProgress = 1;
          v10 = 1;
          if ( (unsigned __int8)byte_140C23301 < (unsigned __int8)v22 )
          {
...
LABEL_42:
  ...
  if ( (v40 & 0x20) != 0 )
  {
    if ( v10 )
    {
      v41 = (__int64 *)qword_140C23C38;
      v40 = *(_QWORD *)(a1 + 8) + 32LL;
      if ( *(__int64 **)qword_140C23C38 != &PopActionWaiters )
        __fastfail(3u);
