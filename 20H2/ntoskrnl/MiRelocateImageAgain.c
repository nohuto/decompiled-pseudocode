/*
 * XREFs of MiRelocateImageAgain @ 0x14062B714
 * Callers:
...
__int64 __fastcall MiRelocateImageAgain(__int64 a1, int a2)
{
  ...
  {
    v10 = *(_QWORD *)(v6 + 32);
    v7 = (_QWORD *)MiReservePtes((__int64)&qword_140C4EDC0, 1u);
    if ( !v7 )
    {
...
LABEL_13:
        ...
        if ( qword_140C1D9C0 )
        {
          updated = qword_140C1D9C0(*(_QWORD *)(v2 + 40) & 0xFFFFFFFFFFFFFFF8uLL, v12);
          if ( updated >= 0 )
            goto LABEL_13;
        }
        else
...
LABEL_3:
  ...
  if ( v7 )
    MiReleasePtes((__int64)&qword_140C4EDC0, v7, 1u);
