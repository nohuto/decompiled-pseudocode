/*
 * XREFs of FsRtlpGetMaxVirtualDiskNestingLevel @ 0x1403CCACC
 * Callers:
 *     FsRtlQueryMaximumVirtualDiskNestingLevel @ 0x14039A780 (FsRtlQueryMaximumVirtualDiskNestingLevel.c)
 * Callees:
