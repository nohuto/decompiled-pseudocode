/*
 * XREFs of MiGatherMappedPages @ 0x140344824
 * Callers:
...
__int64 __fastcall MiGatherMappedPages(__int64 a1, unsigned int a2, __int64 a3)
{
  ...
  while ( 1 )
  {
    ...
    if ( (v15 & 0x20) != 0 )
    {
      ...
      v51 = (unsigned __int64)MI_READ_PTE_LOCK_FREE((unsigned __int64)&v81) >> 5;
...
LABEL_78:
      *(_QWORD *)(v10 + 16) = v54;
      if ( v79 )
        MiWritePteShadow(v10 + 16, v54, v55);
...
LABEL_39:
  ...
  v77 = v20;
  if ( v56 )
    v21 = CcNotifyOfMappedWrite(v20, v74.QuadPart, 0);
  else
    v21 = 0;
  ...
  *(_QWORD *)(a3 + 160) = v14;
  ...
  v26 = v24;
  v74.QuadPart = v24;
  LODWORD(v24) = v23->ByteCount;
  *(_DWORD *)(a3 + 136) = v24;
  v78 = (unsigned int)v24 >> 12;
...
LABEL_31:
  ...
  *(_QWORD *)(a3 + 152) = v19;
  if ( (int)FsRtlAcquireFileForModWriteEx(v19, &v76, v28) < 0 )
  {
    v33 = -1073741740;
    MiDereferenceControlAreaFile(v14, (unsigned __int64)v19);
    *v28 = 0LL;
...
LABEL_32:
  ...
  v32 = CcNotifyOfMappedWrite(v77, v26, v75->ByteCount);
  if ( !v32 )
  {
