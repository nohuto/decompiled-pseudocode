/*
 * XREFs of MxCreatePfns @ 0x140A5563C
 * Callers:
 ...
 *     MiIsRegularMemory @ 0x140A55A4C (MiIsRegularMemory.c)
 */
        ...
        *(_QWORD *)(48 * v13 - 0x58000000000LL + 24) ^= (*(_QWORD *)(48 * v13 - 0x58000000000LL + 24) ^ (*(_QWORD *)(48 * v13 - 0x58000000000LL + 24) + 1LL)) & 0x3FFFFFFFFFFFFFFFLL;
        if ( v5 )
        {
          ...
          if ( (v19 & 0x42) == 0 )
            v20 = v19;
          v21 = v19 | 0x800;
          v22 = ((unsigned __int16)((unsigned __int8)word_140C4DE88 << 8) ^ v20) & 0x100;
          if ( (v19 & 0x42) == 0 )
            v21 = v19;
          v23 = v21 ^ v22;
        ...
        else
        {
          ...
          if ( (v14 & 0x42) == 0 )
            v15 = v14;
          v16 = v14 | 0x800;
          v17 = ((unsigned __int16)((unsigned __int8)word_140C4DE88 << 8) ^ v15) & 0x100;
          if ( (v14 & 0x42) == 0 )
            v16 = v14;
          v18 = v16 ^ v17;
