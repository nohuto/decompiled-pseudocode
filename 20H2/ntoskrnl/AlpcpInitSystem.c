/*
 * XREFs of AlpcpInitSystem @ 0x1407C9D8C
 * Callers:
    ...
    *(__int128 *)((char *)v5 + 12) = AlpcpPortMapping;
    ...
    if ( SystemInformation >= 0 )
    {
      ...
      ExInitializePagedLookasideList(
        ...
        0x49436C41u,
        0x20u);
      ExInitializePagedLookasideList((PPAGED_LOOKASIDE_LIST)&stru_140CEBD00, 0LL, 0LL, 0, 0x80uLL, 0x61486C41u, 0x20u);
      ExInitializeNPagedLookasideList(&AlpcpNPLookasides, 0LL, 0LL, 0x200u, 0x20uLL, 0x65536C41u, 0x20u);
      SystemInformation = NtQuerySystemInformation(0LL, (__int64)v6, 64, 0LL);
      if ( SystemInformation >= 0 )
      {
      ...
      else
      {
        ...
        qword_140C2A848 = (__int64)&AlpcpMessageLogListHead;
        AlpcpMessageLogListHead = (__int64)&AlpcpMessageLogListHead;
        qword_140C2A838 = (__int64)&AlpcpFreeMessageLogListHead;
        AlpcpFreeMessageLogListHead = (__int64)&AlpcpFreeMessageLogListHead;
        qword_140C2A868 = (__int64)&AlpcpFreeMessageSnapshotListHead;
        AlpcpFreeMessageSnapshotListHead = (__int64)&AlpcpFreeMessageSnapshotListHead;
      }
      AlpcpCompletionListDatabase = 0LL;
      qword_140C2A7F8 = (__int64)&qword_140C2A7F0;
      qword_140C2A7F0 = (__int64)&qword_140C2A7F0;
    }
  }
  else
  {
