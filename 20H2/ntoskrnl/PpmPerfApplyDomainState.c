/*
 * XREFs of PpmPerfApplyDomainState @ 0x140304380
 * Callers:
 ...
 *     PpmPerfApplyCapsAndFloors @ 0x14030493C (PpmPerfApplyCapsAndFloors.c)
...
__int64 __fastcall PpmPerfApplyDomainState(__int64 a1)
{
  ...
  v53 = 0;
  v4 = *(_QWORD *)(a1 + 16);
  v65 = &PpmCurrentProfile[342 * dword_140C23D4C + 5];
