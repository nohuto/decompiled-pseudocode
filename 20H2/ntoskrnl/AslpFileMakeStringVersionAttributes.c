/*
 * XREFs of AslpFileMakeStringVersionAttributes @ 0x1407ADDA0
 * Callers:
 *     AslpFileGetVersionAttributes @ 0x1407ADD3C (AslpFileGetVersionAttributes.c)
 * Callees:
 *     AslpFileStringTokenize @ 0x1403BCC50 (AslpFileStringTokenize.c)
...
LABEL_47:
  ...
  do
  {
    v24 = *(int *)&byte_140008AC0[v22];
    v40 = *(_DWORD *)&byte_140008AC0[v22];
    VersionString = AslpFileQueryVersionString(
                      ...
                      (int)v20,
                      v23,
                      *(NTSTRSAFE_PCWSTR *)&byte_140008AC0[v22 + 8]);
    v6 = VersionString;
    if ( VersionString < 0 )
    {
