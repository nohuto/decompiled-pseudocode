/*
 * XREFs of AnFwDisplayFade @ 0x1409F4C00
 * Callers:
...
__int64 AnFwDisplayFade()
{
  ...
  if ( (dword_140C13330 & 0x2000) != 0 )
    return (unsigned int)SubRectangle;
  if ( (dword_140C13330 & 0x200000) != 0 )
    goto LABEL_69;
  RegionContext = BgpTxtGetRegionContext(qword_140C133F0);
  v7 = BgpTxtGetRegionContext(qword_140C133F8);
  v8 = v7;
  if ( !RegionContext || !v7 )
  {
  ...
  xmmword_140C10E20 = *(_OWORD *)RegionContext;
  qword_140C10E30 = *(_QWORD *)(RegionContext + 16);
  dword_140C10E38 = *(_DWORD *)(RegionContext + 24);
  xmmword_140C10E58 = *(_OWORD *)v7;
  qword_140C10E68 = *(_QWORD *)(v7 + 16);
  dword_140C10E70 = *(_DWORD *)(v7 + 24);
  ...
  v36 = 0;
  v9 = BgpGxParseBitmap((__int64)qword_140C13378, &v44);
  v1 = v44;
  SubRectangle = v9;
  if ( v9 < 0 )
    goto LABEL_41;
...
LABEL_10:
  ...
  v13 = qword_140C1338C + dword_140C13394;
  v14 = HIDWORD(qword_140C1338C) + dword_140C13398;
  v15 = xmmword_140C10E20 + DWORD2(xmmword_140C10E20);
  v5 += ((v12 + 15) & 0xFFFFFFF0) + 32 + 2 * (((v12 + 15) & 0xFFFFFFF0) + 32);
  v16 = DWORD1(xmmword_140C10E20) + HIDWORD(xmmword_140C10E20);
  if ( (unsigned int)xmmword_140C10E20 <= (int)qword_140C1338C + dword_140C13394
    && (unsigned int)xmmword_140C10E20 >= (unsigned int)qword_140C1338C
    && DWORD1(xmmword_140C10E20) >= HIDWORD(qword_140C1338C)
    && DWORD1(xmmword_140C10E20) <= v14 )
  {
    if ( v15 < (unsigned int)qword_140C1338C || v15 > v13 || v16 < HIDWORD(qword_140C1338C) || v16 > v14 )
      goto LABEL_51;
    v34 = 1;
  }
  v17 = xmmword_140C10E58 + DWORD2(xmmword_140C10E58);
  v18 = DWORD1(xmmword_140C10E58) + HIDWORD(xmmword_140C10E58);
  if ( (unsigned int)xmmword_140C10E58 >= (unsigned int)qword_140C1338C
    && (unsigned int)xmmword_140C10E58 <= v13
    && DWORD1(xmmword_140C10E58) >= HIDWORD(qword_140C1338C)
    && DWORD1(xmmword_140C10E58) <= v14 )
  {
    if ( v17 >= (unsigned int)qword_140C1338C && v17 <= v13 && v18 >= HIDWORD(qword_140C1338C) && v18 <= v14 )
    {
      v35 = 1;
      goto LABEL_12;
    }
...
LABEL_12:
  ...
  {
LABEL_13:
    v19 = BgpGxReadRectangle(&v40, (__int64)&xmmword_140C10E20);
    v0 = (__int64)v40;
    SubRectangle = v19;
    if ( v19 < 0 )
      goto LABEL_36;
  ...
  if ( !v35 )
  {
    v23 = BgpGxReadRectangle(&v50, (__int64)&xmmword_140C10E58);
    v2 = v50;
    SubRectangle = v23;
    if ( v23 < 0 )
      goto LABEL_36;
  ...
  v25 = qword_140C1338C;
  v26 = HIDWORD(qword_140C134B0);
  v40 = (int *)qword_140C1338C;
  if ( !v36 )
  {
    SubRectangle = BgpGxFindSubRectangle(
                     (_DWORD)v1,
                     HIDWORD(qword_140C134B0),
                     (unsigned int)&v42,
                     (unsigned int)&v39,
                     (__int64)&v33);
    if ( SubRectangle >= 0 )
  ...
  if ( !v34 )
  {
    ...
    if ( SubRectangle >= 0 )
    {
      ...
      *((_QWORD *)v51 + v37) = v41;
      ...
      {
        v41 = v42;
        LODWORD(xmmword_140C10E20) = v39 + xmmword_140C10E20;
        DWORD1(xmmword_140C10E20) += HIDWORD(v39);
      }
    }
  }
  if ( !v35 )
  {
    ...
    if ( SubRectangle >= 0 )
    {
      ...
      *((_QWORD *)v51 + v37) = v2;
      ...
      {
        LODWORD(xmmword_140C10E58) = v39 + xmmword_140C10E58;
        DWORD1(xmmword_140C10E58) += HIDWORD(v39);
        v2 = v42;
      }
    }
  }
...
LABEL_35:
    ...
    qword_140C10E08 = v25;
    qword_140C10E18 = v0;
    qword_140C10E48 = (__int64)v1;
    qword_140C10E78 = (__int64)v2;
    KeResetEvent(&stru_140CF3000);
    KeInitializeTimerEx(&stru_140CF2FC0, NotificationTimer);
    KeInitializeDpc(&stru_140CF2F40, AnFwpFadeAnimationTimer, 0LL);
    byte_140CDAFF0 = 1;
    LogFwStat(1LL, 7LL, 0LL);
    KeSetCoalescableTimer(&stru_140CF2FC0, 0LL, 0x1Eu, 0, &stru_140CF2F40);
    dword_140C13330 |= 0x2000u;
    dword_140C1334C = v5;
  }
LABEL_36:
  if ( v37 )
