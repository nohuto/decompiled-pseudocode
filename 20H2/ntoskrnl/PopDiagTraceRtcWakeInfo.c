/*
 * XREFs of PopDiagTraceRtcWakeInfo @ 0x14038B618
 * Callers:
 ...
 *     PopDiagInterruptTimeToSystemTime @ 0x14099B514 (PopDiagInterruptTimeToSystemTime.c)
 */
...
char __fastcall PopDiagTraceRtcWakeInfo(__int64 a1, int a2, int a3, int a4, int a5, int a6, __int64 a7)
{
  ...
  PopDiagInterruptTimeToSystemTime(qword_140C23370, &v26);
  PopDiagInterruptTimeToSystemTime(qword_140C23388, &v27);
  PopDiagInterruptTimeToSystemTime(qword_140C23348, &v28);
  ...
  {
    result = tlgKeywordOn((__int64)&dword_140C021E8, 0x400000000000LL);
    if ( result )
    {
      v16 = v86;
      v24 = v8;
      ...
      result = tlgWriteTransfer_EtwWriteTransfer(
                 ...
                 (unsigned __int8 *)byte_140026B73,
                 0LL,
                 0LL,
                 0x10u,
                 &v57);
