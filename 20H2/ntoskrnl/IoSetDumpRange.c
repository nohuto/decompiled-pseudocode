/*
 * XREFs of IoSetDumpRange @ 0x140500E50
 * Callers:
 *     IopAddPageDumpRange @ 0x140501BD8 (IopAddPageDumpRange.c)
 *     IoSetDumpRangeForPartialKernelDump @ 0x140509C50 (IoSetDumpRangeForPartialKernelDump.c)
 * Callees:
 *     MmIsAddressValidEx @ 0x1402CC2D0 (MmIsAddressValidEx.c)
 *     MmGetPhysicalAddress @ 0x1402FE520 (MmGetPhysicalAddress.c)
 *     IopAddPageToPageMap @ 0x140501DC0 (IopAddPageToPageMap.c)
 */
