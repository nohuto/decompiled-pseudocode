/*
 * XREFs of MiCreateKernelStackNode @ 0x140534248
 * Callers:
...
_QWORD *__fastcall MiCreateKernelStackNode(_WORD *a1, _QWORD *a2)
{
  ...
  if ( result )
  {
    ...
    result[4] = a2[1];
    *((_WORD *)result + 20) = *a1;
    v6 = ExAcquireSpinLockExclusive(&dword_140C4EA60);
    v7 = (_QWORD *)qword_140C4EA58;
    v8 = 0;
    v9 = v6;
    if ( qword_140C4EA58 )
    {
    ...
    RtlAvlInsertNodeEx((unsigned __int64 *)&qword_140C4EA58, (unsigned __int64)v7, v8, v5);
