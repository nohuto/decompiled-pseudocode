/*
 * XREFs of MiLogHotPatchPagesLocked @ 0x1408CE628
 * Callers:
...
char __fastcall MiLogHotPatchPagesLocked(__int64 a1, __int64 a2, int a3, int a4, int a5)
{
  ...
  v5 = &retaddr;
  v6 = *(_QWORD *)&qword_140C4ED60;
  if ( *(_QWORD *)&qword_140C4ED60 )
  {
    if ( **(_DWORD **)&qword_140C4ED60 > 5u )
    {
      LOBYTE(v5) = tlgKeywordOn(*(__int64 *)&qword_140C4ED60, 0x400000000020LL);
      if ( (_BYTE)v5 )
      {
        ...
        v18 = a4;
        v22 = 0x1000000LL;
        LOBYTE(v5) = tlgWriteEx_EtwWriteEx(v6, (unsigned __int8 *)&byte_1400251DF, v12, 1u, v14, v15, 9u, &v23);
      }
    }
  }
  return (char)v5;
