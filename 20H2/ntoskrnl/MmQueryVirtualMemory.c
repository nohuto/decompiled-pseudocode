/*
 * XREFs of MmQueryVirtualMemory @ 0x140621F60
 * Callers:
 *     ?SmStCheckResident@?$SMKM_STORE@USM_TRAITS@@@@SA?AW4_SMST_RESIDENT_CHECK_RESULT@1@PEAXK@Z @ 0x1403264E4 (-SmStCheckResident@-$SMKM_STORE@USM_TRAITS@@@@SA-AW4_SMST_RESIDENT_CHECK_RESULT@1@PEAXK@Z.c)
 *     NtQueryVirtualMemory @ 0x140621F20 (NtQueryVirtualMemory.c)
 ...
 *     MiIsSoftwareEnclave @ 0x14022BD0C (MiIsSoftwareEnclave.c)
...
LABEL_6:
  ...
  if ( v77 < 0x40
    || !PreviousMode
    || (IsUserQueryVmCallerTrusted = MiIsUserQueryVmCallerTrusted((int)CurrentThread),
        PreviousMode = v78,
