/*
 * XREFs of KeLoadMTRR @ 0x14099C1E0
 * Callers:
 *     HalpPostSleepMP @ 0x140998074 (HalpPostSleepMP.c)
 *     KiLoadMTRRTarget @ 0x1409A4230 (KiLoadMTRRTarget.c)
 * Callees:
 *     KeFlushCurrentTbImmediately @ 0x1403A01C0 (KeFlushCurrentTbImmediately.c)
 *     __security_check_cookie @ 0x1403CFAF0 (__security_check_cookie.c)
 *     KiLockStepExecution @ 0x14099C3C4 (KiLockStepExecution.c)
 *     KiWriteFixedMtrr @ 0x14099C40C (KiWriteFixedMtrr.c)
 *     KiReadFixedMtrr @ 0x14099C518 (KiReadFixedMtrr.c)
 *     KiCompareVarMtrr @ 0x14099C624 (KiCompareVarMtrr.c)
 */
...
__int64 __fastcall KeLoadMTRR(__int64 a1)
{
  ...
  if ( byte_140C2B1D0 )
  {
    ...
    if ( qword_140C2B1E0 )
    {
      ...
      {
        v2 = 0LL;
        v3 = (PVOID)((_BYTE *)qword_140C2B1E0 - v18);
        v17 = v18;
...
LABEL_6:
    ...
    if ( (_BYTE)qword_140C2B1C8 )
    {
      ...
      do
      {
        v12 = qword_140C2B1D8;
        v13 = 2 * v10;
        __writemsr(v11 - 1, *((_QWORD *)qword_140C2B1D8 + v13));
        v8 = HIDWORD(v12[v13 + 1]);
        __writemsr(v11, v12[v13 + 1]);
        v10 = ++v9;
        v11 += 2;
      }
      while ( v9 < (unsigned __int64)(unsigned __int8)qword_140C2B1C8 );
    }
    if ( qword_140C2B1E0 )
      KiWriteFixedMtrr(qword_140C2B1E0, v8);
