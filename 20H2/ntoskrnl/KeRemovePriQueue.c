/*
 * XREFs of KeRemovePriQueue @ 0x14028E810
 * Callers:
 ...
 *     KiGetDueTimeWithThreadTimerDelay @ 0x140520F90 (KiGetDueTimeWithThreadTimerDelay.c)
 */
        ...
        __int64 a4)
{
  ...
  unsigned int v5; // esi
  __int64 v10; // r15
  $FA66ECE7F681727997618FC8DC30F69A *v11; // r14
  int v12; // ebp
  ...
  unsigned int v70; // [rsp+98h] [rbp+20h] BYREF
      ...
      if ( v29 )
      {
        ...
        if ( (_DWORD)QueuePriority != v70 )
        {
          ...
          if ( !v37 )
          {
            ...
            _InterlockedIncrement((volatile signed __int32 *)&v38[22].WaitListHead + (int)v70);
            v30 = v70;
          }
