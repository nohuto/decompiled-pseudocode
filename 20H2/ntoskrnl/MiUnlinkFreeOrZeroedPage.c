/*
 * XREFs of MiUnlinkFreeOrZeroedPage @ 0x1402C4BE0
 * Callers:
...
__int64 __fastcall MiUnlinkFreeOrZeroedPage(ULONG_PTR BugCheckParameter2, _QWORD *a2, __int16 a3)
{
  ...
  {
    v7 = (char *)qword_140C4DD48 + 16 * dword_140C4DD04;
    if ( v6 >= *(_QWORD *)v7 && (dword_140C4DD04 == dword_140C4DD08 || v6 < *((_QWORD *)v7 + 2)) )
      goto LABEL_15;
  }
  v8 = 0;
  v9 = dword_140C4DD08;
...
LABEL_126:
  ...
  {
    v10 = (v8 + v9) >> 1;
    v7 = (char *)qword_140C4DD48 + 16 * v10;
    if ( v6 < *(_QWORD *)v7 )
    {
      if ( !v10 )
    ...
    if ( v10 == dword_140C4DD08 || v6 < *((_QWORD *)v7 + 2) )
      break;
    v8 = v10 + 1;
LABEL_12:
    if ( v9 < v8 )
...
LABEL_15:
  ...
  if ( qword_140C4DD50 )
    ...
    v12 = 0;
  v13 = a2;
  v14 = dword_140C4DD78 & (unsigned int)BugCheckParameter2 | (v11 << byte_140C4DD0C) | (v12 << byte_140C4DD0D);
  v15 = *(_QWORD *)(qword_140C4E4C8 + 8 * ((*(_QWORD *)(v4 + 40) >> 39) & 0x3FFLL));
  if ( a2 )
  {
    v21 = -1;
  }
  else
  {
    ...
    if ( dword_140C4DD04 > (unsigned int)dword_140C4DD08
      || (v18 = (char *)qword_140C4DD48 + 16 * dword_140C4DD04, BugCheckParameter2 < *(_QWORD *)v18)
      || dword_140C4DD04 != dword_140C4DD08 && BugCheckParameter2 >= *((_QWORD *)v18 + 2) )
    {
      v19 = 0;
      if ( dword_140C4DD08 < 0 )
LABEL_128:
      ...
      {
        v20 = (v19 + v16) >> 1;
        v18 = (char *)qword_140C4DD48 + 16 * v20;
        if ( BugCheckParameter2 >= *(_QWORD *)v18 )
        {
          if ( v20 == dword_140C4DD08 || BugCheckParameter2 < *((_QWORD *)v18 + 2) )
          {
            dword_140C4DD04 = (v19 + v16) >> 1;
            break;
          }
          v19 = v20 + 1;
        }
  ...
  if ( dword_140C4E54C == 1 )
  {
    ...
    v30 = (volatile signed __int32 *)(qword_140C4E5A8 + 4 * (BugCheckParameter2 >> 5));
    if ( v29 + 1 <= 0x20 )
    {
      v31 = 1 << v29;
      goto LABEL_51;
    ...
    if ( v33 == 0xFFFFFFFFFLL )
    {
      _InterlockedAnd(
        (volatile signed __int32 *)(*(_QWORD *)(*(_QWORD *)(v15 + 16)
                                              + 4544 * ((unsigned __int64)(unsigned int)v14 >> byte_140C4DD0C)
                                              + 16 * (v27 + 252)
                                              + 8)
                                  + 4 * ((unsigned __int64)((unsigned int)v14 & dword_140C4DD78) >> 5)),
        ~(1 << (v14 & dword_140C4DD78 & 0x1F)));
      v13[3] = 0xFFFFFFFFFLL;
    }
    else
    {
...
LABEL_71:
  ...
  v49 = *(_QWORD *)(v15 + 16) + 4544 * ((unsigned __int64)(unsigned int)v14 >> byte_140C4DD0C);
  ...
  if ( (unsigned int)MmNumberOfChannels > 1 )
    _InterlockedDecrement64((volatile signed __int64 *)(v49
                                                      ...
                                                      * (v66
                                                       + 2LL
                                                       * (unsigned __int8)(MiChannelMaximumPowerOf2Mask & ((unsigned int)v14 >> byte_140C4DD0D)))
                                                      + 4216));
