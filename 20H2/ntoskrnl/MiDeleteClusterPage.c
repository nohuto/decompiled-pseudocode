/*
 * XREFs of MiDeleteClusterPage @ 0x1402AEC40
 * Callers:
 ...
 *     MiTryLockNestedPageAtDpcInline @ 0x140349B40 (MiTryLockNestedPageAtDpcInline.c)
...
__int64 __fastcall MiDeleteClusterPage(ULONG_PTR BugCheckParameter2, __int64 a2)
{
  ...
  v63 = *(_QWORD *)(qword_140C4E4C8 + 8LL * Process[1].IdealProcessorPadding[5]);
  ...
  for ( i = 0LL; i < 0x10; ++i )
  {
    ...
    if ( byte_140C51EDE && _bittest64((const signed __int64 *)qword_140C52408, (unsigned __int64)(48 * v30 / 48) >> 9)
      || (unsigned int)MI_PFN_IS_PROTO(48 * v30 - 0x58000000000LL)
      || *(_QWORD *)(qword_140C4E4C8 + 8 * ((*(_QWORD *)(v32 + 40) >> 39) & 0x3FFLL)) != v63 )
    {
      return 0LL;
    }
    v5 = v31 + 1;
  ...
  do
  {
    ...
    *(_QWORD *)(v47 + 16) = ZeroPte;
    if ( *(unsigned __int8 *)(v47 + 34) >> 6 != v48 )
      MiChangePageAttribute(v47, v48, 1);
    v52 = *(_BYTE *)(v47 + 35);
    if ( (v52 & 0x10) != 0 )
...
LABEL_95:
    ...
    if ( !HIBYTE(word_140C4DE88) && (v56 & 1) != 0 )
      v56 |= 0x8000000000000000uLL;
    *v46 = v56;
...
LABEL_96:
  ...
  *((_QWORD *)&v67 + 1) = 1LL;
  LOBYTE(v68) = 2;
  MiInsertLargePageInNodeList(&v67);
