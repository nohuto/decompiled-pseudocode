/*
 * XREFs of KseShimDatabaseBootInitialize @ 0x140A751B4
 * Callers:
...
__int64 __fastcall KseShimDatabaseBootInitialize(void *Src, size_t Size, void *a3, unsigned int a4)
{
  ...
  if ( Src && v6 )
  {
    ...
    if ( v8 >= 0 )
    {
      if ( a3 && a4 )
      {
        if ( (int)KsepSdbBootInitialize(a3, a4, (__int64)qword_140C2AD98) < 0 )
        {
        ...
        else if ( dword_140C2AD90 >= (unsigned int)dword_140C2ADC8 )
        {
