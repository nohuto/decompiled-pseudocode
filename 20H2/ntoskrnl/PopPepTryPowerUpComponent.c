/*
 * XREFs of PopPepTryPowerUpComponent @ 0x140317FA8
 * Callers:
 *     PopPepTriggerComponentActivatingActivity @ 0x140317D30 (PopPepTriggerComponentActivatingActivity.c)
 *     PopPepTriggerComponentIdleStateChangeActivity @ 0x1403A5E40 (PopPepTriggerComponentIdleStateChangeActivity.c)
 * Callees:
