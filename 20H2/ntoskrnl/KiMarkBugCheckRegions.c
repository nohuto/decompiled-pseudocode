/*
 * XREFs of KiMarkBugCheckRegions @ 0x1403DBE68
 * Callers:
...
char __fastcall KiMarkBugCheckRegions(__int64 a1, __int64 a2, unsigned __int64 a3, __int64 a4)
{
  ...
  if ( qword_140C12EA0 )
  {
    *(_QWORD *)&KiMismatchSummary = qword_140C12EA0;
    IoAddTriageDumpDataBlock((ULONG)&KiMismatchSummary, (PVOID)8);
  }
  v7 = 3;
  if ( (_DWORD)a4 == 257 && dword_140C12E98 )
  {
    v8 = qword_140C12E88;
    v9 = 0;
    do
    ...
    while ( v9 < dword_140C12E98 );
    dword_140C12E98 = 4096;
  }
  v18 = &qword_140C12E88;
  v19 = 2LL;
  v20 = &dword_140C12E98;
...
LABEL_47:
  ...
  result = sub_1403EB0B4(a1, a2, a3, a4);
