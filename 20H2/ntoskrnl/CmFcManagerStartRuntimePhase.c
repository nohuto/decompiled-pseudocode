/*
 * XREFs of CmFcManagerStartRuntimePhase @ 0x140A3B7B8
 * Callers:
 ...
 *     RtlGetSwapReferenceIndex @ 0x1407D0CD4 (RtlGetSwapReferenceIndex.c)
 ...
 *     CmFcpSwapSectionState @ 0x140880FC4 (CmFcpSwapSectionState.c)
...
__int64 CmFcManagerStartRuntimePhase()
{
  ...
  *(_OWORD *)&DestinationString[1] = 0LL;
  ...
  if ( SectionFromBuffer >= 0 )
  {
    ...
    CmpVolumeManagerLockContextListExclusive((ULONG_PTR)&stru_140C47FB0);
    RtlpFcBufferManagerReferenceBuffers((__int64)qword_140C48010, (__int64)&Buffer, DestinationString);
    v6 = Buffer;
    v7 = v33;
    v8 = 3LL;
    do
    ...
    if ( !QuadPart
      || (SectionFromBuffer = CmFcpManagerCreateSectionFromBuffer(
          ...
          SectionFromBuffer >= 0) )
    {
      RtlpFcBufferManagerDereferenceBuffers((__int64)qword_140C48010, (__int64)v9);
      v9 = 0LL;
      v12 = 0;
      while ( 1 )
      {
        ...
        if ( ++v12 >= 3 )
        {
          ...
          while ( v16 != 1 );
          RtlpFcBufferManagerUpdateBuffers(qword_140C48010, Buffer, (__int64)v32);
          memset(v32, 0, 0x48uLL);
          ...
          if ( SectionFromBuffer >= 0 )
          {
            for ( i = 0; i < 2; ++i )
            {
              v18 = ((unsigned __int8)RtlGetSwapReferenceIndex(qword_140C480D0) - 1) & 1;
              ...
              RtlUpdateSwapReference(qword_140C480D0, v18);
            }
            qword_140C48188 = ExAllocateTimer(
...
LABEL_30:
    if ( v9 )
      RtlpFcBufferManagerDereferenceBuffers((__int64)qword_140C48010, (__int64)v9);
LABEL_33:
    CmSiRWLockReleaseExclusive((volatile signed __int64 *)&stru_140C47FB0);
