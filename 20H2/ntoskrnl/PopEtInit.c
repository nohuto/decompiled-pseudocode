/*
 * XREFs of PopEtInit @ 0x140A70A24
 * Callers:
 ...
 *     PopEtInitializeBuiltinAppId @ 0x1407C75FC (PopEtInitializeBuiltinAppId.c)
 *     RtlInternTableInitialize @ 0x1407C7664 (RtlInternTableInitialize.c)
