/*
 * XREFs of MiExtendSection @ 0x140708F38
 * Callers:
...
__int64 MiExtendSection(__int64 a1, _QWORD *a2, unsigned int a3, __int64 a4, ...)
{
  ...
  unsigned __int64 v52; // [rsp+28h] [rbp-F0h]
  unsigned __int64 v53; // [rsp+30h] [rbp-E8h]
  __int64 v54; // [rsp+38h] [rbp-E0h]
  __int128 v55; // [rsp+40h] [rbp-D8h] BYREF
  __int128 Privileges; // [rsp+50h] [rbp-C8h]
  __int128 v57; // [rsp+60h] [rbp-B8h]
  __int128 v58; // [rsp+70h] [rbp-A8h]
  __int128 v59; // [rsp+80h] [rbp-98h]
  __int128 v60; // [rsp+90h] [rbp-88h]
  __int128 v61; // [rsp+A0h] [rbp-78h]
  __int128 v62; // [rsp+B0h] [rbp-68h]
  __int128 v63; // [rsp+C0h] [rbp-58h]
  int v64; // [rsp+120h] [rbp+8h]
  __int64 v68; // [rsp+138h] [rbp+20h]
  __int64 *v69; // [rsp+140h] [rbp+28h] BYREF
  va_list va; // [rsp+140h] [rbp+28h]
  va_list va1; // [rsp+148h] [rbp+30h] BYREF

  va_start(va1, a4);
  va_start(va, a4);
  v69 = va_arg(va1, __int64 *);
  v5 = &v55;
  v51 = *(_QWORD *)a1;
  v4 = *(_QWORD *)a1;
  ...
  *v69 = 0LL;
  ...
  v63 = v20;
  if ( a3 )
    DWORD1(v58) ^= (DWORD1(v58) ^ (DWORD1(v58) - a3)) & 0x3FFFFFFF;
  v21 = 0LL;
  do
  {
    if ( v7 - v13 > v14 )
...
LABEL_49:
    ...
    *((_DWORD *)Pool + 11) = v22 >> 3;
    ...
    v26 = v54;
    v27 = Pool[4] & 0xFFC1 | (2 * ((*(_BYTE *)(v54 + 14) >> 1) & 0x1F));
    *((_WORD *)Pool + 16) = v27;
    if ( v5 == &v55 )
    {
      *((_WORD *)v5 + 17) &= 0xFu;
  ...
  while ( v13 < v52 );
  if ( v8 && MiControlAreaUsingExtents(v51) && *(_QWORD *)(a1 + 8) )
  {
    MiSubsectionNeedsExtents((_DWORD *)a1);
    *v69 = a1;
  }
  appended = MiAppendSubsectionChain(a1, (__int64)&v55, 0);
  if ( !appended )
  {
LABEL_16:
    v33 = *(_WORD *)(v26 + 12);
...
LABEL_18:
  ...
  if ( (appended & 1) != 0 )
  {
    ...
    while ( 1 )
    {
      ...
      {
        MiDecrementSubsectionViewCount((_QWORD *)v37, 0);
      }
  ...
  while ( 1 )
  {
    ...
    if ( SubsectionCharges < 0 )
      break;
    if ( (int)MiIncrementSubsectionViewCount((_QWORD *)v37, 56) <= 1 )
    {
      v15 += v46;
      break;
    }
...
LABEL_28:
      appended = MiAppendSubsectionChain(a1, (__int64)&v55, v17);
      if ( appended )
        goto LABEL_18;
      v26 = v54;
      goto LABEL_16;
...
LABEL_50:
  ControlAreaPartition = MiGetControlAreaPartition(v51);
  v68 = ControlAreaPartition;
    ...
    do
    {
      ...
      else
      {
        if ( (v17 & 2) != 0 && (*(_DWORD *)(v36 + 48) & 0x3FFFFFFF) != 0 )
          v15 += MiDecrementSubsectionViewCount((_QWORD *)v36, 24);
        if ( *(_QWORD *)(v36 + 8) )
        {
  ...
  if ( v15 )
    MiReturnCrossPartitionSectionCharges(v49, 1u, v15);
