/*
 * XREFs of EtwSetPerformanceTraceInformation @ 0x14093AD90
 * Callers:
 ...
 *     EtwpUpdateTagFilter @ 0x14078C854 (EtwpUpdateTagFilter.c)
 ...
 *     EtwpUpdateProcessorTraceEvents @ 0x14094AC14 (EtwpUpdateProcessorTraceEvents.c)
...
__int64 __fastcall EtwSetPerformanceTraceInformation(char *Address, SIZE_T Length, KPROCESSOR_MODE AccessMode)
{
  ...
  unsigned int v77; // [rsp+74h] [rbp-1A4h]
    ...
    if ( v6 != 18 )
    {
      switch ( v6 )
      {
        case 19:
          ...
          if ( !v59 )
            goto LABEL_153;
          v10 = EtwpCheckLoggerControlAccess(0x80u, (__int64)v59);
          if ( v10 < 0 )
            goto LABEL_79;
...
LABEL_78:
        ...
        case 23:
          if ( v4 >= 0x18 )
          {
            ...
            if ( v39 )
            {
              v10 = EtwpCheckLoggerControlAccess(0x80u, (__int64)v39);
              if ( v10 < 0 )
                goto LABEL_79;
  ...
  if ( v6 == 16 )
  {
    ...
    if ( !v35 )
      goto LABEL_153;
    v10 = EtwpCheckLoggerControlAccess(0x80u, (__int64)v35);
    if ( v10 >= 0 )
    {
      ...
      if ( v6 == 11 )
      {
        ...
        if ( SeSinglePrivilegeCheck(SeSystemProfilePrivilege, AccessMode) )
        {
          if ( !PsIsCurrentThreadInServerSilo() )
          {
            ...
            if ( v31 )
            {
              v10 = EtwpCheckLoggerControlAccess(0x80u, (__int64)v31);
              if ( v10 >= 0 )
              {
                if ( v66 )
                  _InterlockedOr((volatile signed __int32 *)v19 + 208, 0x400u);
                else
                  _InterlockedAnd((volatile signed __int32 *)v19 + 208, 0xFFFFFBFF);
              }
              goto LABEL_79;
            }
            goto LABEL_153;
      ...
      if ( (v60 & 3) == 0 )
      {
        ...
        if ( (unsigned __int16)v61 <= 4u )
        {
          if ( !PsIsCurrentThreadInServerSilo() )
          {
            ...
            v64 = EtwpAcquireLoggerContextByLoggerId(v8, v62, 1);
            v19 = v64;
            if ( v64 )
            {
...
LABEL_119:
  ...
  if ( (v51 & 3) == 0 )
  {
    if ( !PsIsCurrentThreadInServerSilo() || (unsigned int)(v6 - 14) > 1 )
    {
      ...
      if ( v56 )
      {
        v10 = EtwpCheckLoggerControlAccess(0x80u, (__int64)v56);
        if ( v10 < 0 )
          goto LABEL_79;
        switch ( v67 )
        {
          case 6:
            updated = EtwpUpdateStackTracing((RTL_BITMAP *)v19, (__int64)v53, v52);
            break;
          case 15:
