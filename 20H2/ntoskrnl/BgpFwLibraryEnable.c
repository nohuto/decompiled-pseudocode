/*
 * XREFs of BgpFwLibraryEnable @ 0x14039BFB8
 * Callers:
...
__int64 __fastcall BgpFwLibraryEnable(__int64 a1)
{
  ...
  v2 = dword_140C13330 & 0xC00;
  if ( (dword_140C13330 & 2) != 0 && v2 != 3072 )
    return 0LL;
  v3 = 0LL;
...
LABEL_9:
      ...
      xmmword_140C132D0 = *(_OWORD *)(a1 + 16);
      qword_140C132E0 = *(PVOID *)(a1 + 32);
      if ( v5 == 1 )
      {
        dword_140C13330 |= 8u;
...
LABEL_8:
  ...
  if ( v2 == 3072 )
  {
    if ( !(_BYTE)xmmword_140C132E8
      || !BYTE1(xmmword_140C132E8)
      || *(_DWORD *)(a1 + 16) != (_DWORD)xmmword_140C132F8
      || *(_QWORD *)(a1 + 4) != *(_QWORD *)((char *)&xmmword_140C132E8 + 4)
      || *(_DWORD *)(a1 + 12) != HIDWORD(xmmword_140C132E8)
  ...
  *(_QWORD *)(a1 + 32) = v11;
  ...
  {
    *(_BYTE *)(a1 + 1) = 1;
    if ( (_BYTE)xmmword_140C132E8 && BYTE1(xmmword_140C132E8) )
    {
      v13 = DWORD1(xmmword_140C132E8);
      if ( ((BYTE2(xmmword_140C132E8) - 1) & 0xFD) == 0 )
        v13 = DWORD2(xmmword_140C132E8);
      LOBYTE(v3) = (_DWORD)xmmword_140C132F8 != 4;
      MmUnmapIoSpace(BaseAddress, (unsigned int)(HIDWORD(xmmword_140C132E8) * v13) * (v3 + 3));
    }
    xmmword_140C132E8 = *(_OWORD *)a1;
    xmmword_140C132F8 = *(_OWORD *)(a1 + 16);
