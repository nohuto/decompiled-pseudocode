/*
 * XREFs of PopDirectedDripsBuildBroadcastTreeFull @ 0x1408FB310
 * Callers:
 *     PopDirectedDripsBuildBroadcastTreePartial @ 0x1408FB540 (PopDirectedDripsBuildBroadcastTreePartial.c)
 * Callees:
 *     PopFxIsDirectedPowerTransitionSupported @ 0x140569718 (PopFxIsDirectedPowerTransitionSupported.c)
 *     PopDirectedDripsDiagTraceProblemDevice @ 0x1408FABAC (PopDirectedDripsDiagTraceProblemDevice.c)
 *     PopDirectedDripsBuildPs4BroadcastTree @ 0x1408FB640 (PopDirectedDripsBuildPs4BroadcastTree.c)
 *     PopDirectedDripsFlushDeviceQueue @ 0x1408FB7D0 (PopDirectedDripsFlushDeviceQueue.c)
 *     PopDirectedDripsInsertQueueDevice @ 0x1408FB808 (PopDirectedDripsInsertQueueDevice.c)
 *     PopDirectedDripsIsLikelySpecialDevice @ 0x1408FB848 (PopDirectedDripsIsLikelySpecialDevice.c)
 *     PopDirectedDripsMarkDfxDevice @ 0x1408FB890 (PopDirectedDripsMarkDfxDevice.c)
 *     PopDirectedDripsVisitDevice @ 0x1408FB9C0 (PopDirectedDripsVisitDevice.c)
 */
