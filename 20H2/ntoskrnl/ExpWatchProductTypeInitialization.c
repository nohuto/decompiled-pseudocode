/*
 * XREFs of ExpWatchProductTypeInitialization @ 0x140A49CA8
 * Callers:
...
char __fastcall ExpWatchProductTypeInitialization(__int64 a1)
{
  ...
  qword_140C19370 = (__int64)ExpWatchProductTypeWork;
  qword_140C19378 = 0LL;
  ...
  else
  {
    ...
    if ( PoolWithTag )
    {
      ...
      else
      {
        ...
        qword_140C54120 = ExAllocatePoolWithTag(PagedPool, (unsigned int)BugCheckParameter2, 0x2079654Bu);
        if ( !qword_140C54120 )
        ...
        if ( (int)NtQueryValueKey(
                    ...
                    (unsigned __int64)&v42,
                    2u,
                    (char *)qword_140C54120,
                    (size_t)Objectd,
                    (unsigned __int64)&BugCheckParameter2) >= 0
          || (ExFreePoolWithTag(qword_140C54120, 0), qword_140C54120 = 0LL, !ExpSetupModeDetected) )
        {
LABEL_18:
          v11 = -1LL;
          do
          ...
          if ( v12 >= 0 )
          {
            ...
            if ( (int)NtOpenKey(&Handle, 131097, (__int64)&v45) >= 0 )
            {
              ...
              v16 = Handle;
              v17 = NtQueryKey(Handle, 2u, (unsigned __int64)&v53, 0x30u, &v43);
              if ( v17 < 0 )
