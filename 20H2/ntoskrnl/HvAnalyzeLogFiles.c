/*
 * XREFs of HvAnalyzeLogFiles @ 0x14088369C
 * Callers:
 ...
 *     HvpDetermineLatestLogFile @ 0x1408842A0 (HvpDetermineLatestLogFile.c)
...
LABEL_61:
    if ( (unsigned int)dword_140C02130 > 5 && tlgKeywordOn((__int64)&dword_140C02130, 0x400000000008LL) )
    {
      ...
      v85 = &v77;
      v86 = 8LL;
      tlgWriteTransfer_EtwWriteTransfer((__int64)&dword_140C02130, (unsigned __int8 *)byte_140022FEF, 0LL, 0LL, 3u, v84);
    }
  ...
  if ( (unsigned int)dword_140C02130 > 5 && tlgKeywordOn((__int64)&dword_140C02130, 8LL) )
  {
    ...
    v73 = v47;
    v97 = 4LL;
    tlgWriteTransfer_EtwWriteTransfer((__int64)&dword_140C02130, (unsigned __int8 *)byte_140022F0B, 0LL, 0LL, 7u, &v87);
    v46 = dword_140C02130;
  }
  if ( v37 == 1 )
  {
    ...
    else
    {
      if ( v46 > 5 && tlgKeywordOn((__int64)&dword_140C02130, 0x400000000000LL) )
      {
        ...
        tlgWriteTransfer_EtwWriteTransfer(
          ...
          (unsigned __int8 *)byte_140022F68,
          0LL,
          0LL,
          3u,
          v84);
