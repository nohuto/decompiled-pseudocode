/*
 * XREFs of RtlCreateAtomTableEx @ 0x14033BB70
 * Callers:
 *     RtlCreateAtomTable @ 0x1406F32B0 (RtlCreateAtomTable.c)
 * Callees:
 ...
 *     RtlpInitializeLockAtomTable @ 0x1406F33B8 (RtlpInitializeLockAtomTable.c)
