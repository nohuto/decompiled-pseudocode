/*
 * XREFs of AlpcpCompleteDispatchMessage @ 0x1405ECB50
 * Callers:
 ...
 *     AlpcpAllocateCompletionBuffer @ 0x1406B4F50 (AlpcpAllocateCompletionBuffer.c)
 ...
 *     AlpcpFreeBitmap @ 0x1408C5E7C (AlpcpFreeBitmap.c)
...
LABEL_25:
              ...
              *(_DWORD *)(v3 + 40) &= ~0x8000u;
              ...
              if ( v55 )
              {
                ...
                KeReleaseSemaphoreEx(*(_QWORD *)(v1 + 248), 1u, 1, v20, 0);
              }
              else
              {
                if ( v59 )
    ...
    *(_QWORD *)(a1 + 32) = 0LL;
    if ( v8 || v5 )
      *(_QWORD *)(a1 + 24) = v32 - 167;
      ...
      KeReleaseSemaphoreEx((__int64)(v32 - 22), 1u, 1, v38, 2);
  }
}
