/*
 * XREFs of PopAccountCbEnergyChange @ 0x14077C244
 * Callers:
...
int PopAccountCbEnergyChange()
{
  ...
  if ( (__int64 *)qword_140C235F0 != &qword_140C235F0 )
  {
    ...
    while ( (__int64 *)v2 != &qword_140C235F0 );
    LODWORD(v49) = v3;
  }
  if ( v3 != (_DWORD)xmmword_140C237C0 || v1 != *((_QWORD *)&xmmword_140C237C0 + 1) )
  {
    xmmword_140C237C0 = v49;
    if ( (unsigned int)dword_140C021E8 > 5 )
    {
      ...
      *(_QWORD *)&v49 = v17;
      ...
      if ( HIDWORD(qword_140C23620) )
        v39 = (100 * dword_140C23604 + (HIDWORD(qword_140C23620) >> 1)) / HIDWORD(qword_140C23620);
      else
        v39 = 0;
      v74 = 0;
      v43 = v39;
      ...
      v73 = v10;
      if ( HIDWORD(qword_140C23620) )
        v40 = 100000 * (unsigned __int64)dword_140C23604 / HIDWORD(qword_140C23620);
      else
        LODWORD(v40) = 0;
      v77 = 0;
      v80 = 0;
      ...
      LODWORD(v1) = tlgWriteTransfer_EtwWriteTransfer(
                      ...
                      (unsigned __int8 *)&byte_1400284B7,
                      0LL,
                      0LL,
                      0x16u,
                      &v51);
