/*
 * XREFs of RtlpPopulateLanguageConfigList @ 0x1407A2FFC
 * Callers:
 ...
 *     RtlpMuiRegValidateConfigNode @ 0x1405C906C (RtlpMuiRegValidateConfigNode.c)
 *     RtlpMuiRegCreateLanguageConfigList @ 0x1407A31A0 (RtlpMuiRegCreateLanguageConfigList.c)
 *     RtlpMuiRegConfigListAddLanguage @ 0x1409837B4 (RtlpMuiRegConfigListAddLanguage.c)
