/*
 * XREFs of PopDiagTracePowerButtonBugcheck @ 0x1408ED5F8
 * Callers:
...
void __fastcall PopDiagTracePowerButtonBugcheck(int a1)
{
  ...
  if ( a1 == 7000 )
  {
    ...
    if ( (unsigned int)dword_140C021E8 > 5 && tlgKeywordOn((__int64)&dword_140C021E8, 0x400000000000LL) )
    {
      v6 = 7000;
      v17 = &v6;
      v1 = (unsigned __int8 *)&dword_140027D54;
      v7 = dword_140C207A8;
      v19 = &v7;
      v8 = dword_140C207A4;
      v21 = &v8;
...
LABEL_9:
         ...
         && tlgKeywordOn((__int64)&dword_140C021E8, 0x800000000000LL) )
  {
    v13 = v3;
    v17 = &v13;
    v1 = (unsigned __int8 *)&byte_140027C2F;
    v12 = dword_140C207A8;
    v19 = &v12;
    v11 = dword_140C207A4;
    v21 = &v11;
