/*
 * XREFs of PopPepComponentGetWork @ 0x1402D4E98
 * Callers:
...
char __fastcall PopPepComponentGetWork(__int64 a1, __int64 a2, __int64 a3)
{
  ...
  if ( *(_BYTE *)(a1 + 125) == 1 )
  {
    ...
    if ( v10 )
    {
      ...
      started = PopPepStartActivity(a1, (int)v14 + 184, (int)v14 + 240, v13, v14 + 288, a3);
      goto LABEL_10;
    }
  }
LABEL_16:
...
LABEL_12:
    started = PopPepStartActivity(a1, 0, (int)a1 + 72, ReadyActivityType, v8, a3);
LABEL_10:
    LOBYTE(v3) = started;
    return v3;
  }
