/*
 * XREFs of CcPurgeCacheSection @ 0x1403557F0
 * Callers:
        ...
        ULONG Flags)
{
  ...
  if ( !SharedCacheMap )
    goto LABEL_4;
  v16 = v44;
  if ( v44 != *(_QWORD *)(MmGetControlAreaPartition((__int64)SectionObjectPointer) + 8) )
...
LABEL_4:
    ...
    if ( !v11 )
    {
      do
      {
        ...
        if ( !--v10 )
          break;
        v11 = MmPurgeSection(SectionObjectPointer, (__int64 *)FileOffset, 0LL, v9, v43);
      }
      while ( !v11 );
      SharedCacheMap = v45;
    }
