/*
 * XREFs of BgpFwLibraryInitialize @ 0x1409F59E8
 * Callers:
 ...
 *     BgpFwInitializeLock @ 0x140A9A168 (BgpFwInitializeLock.c)
 */
...
__int64 __fastcall BgpFwLibraryInitialize(__int64 a1, unsigned int a2)
{
  ...
  if ( (dword_140C13330 & 1) != 0 && (dword_140C13330 & 4) == 0 && (*(_DWORD *)(a1 + 120) & 0x100000) == 0 )
    return 3221225485LL;
  if ( (*(_DWORD *)(a1 + 120) & 0x100000) != 0 )
  {
    ...
    {
      qword_140C132E0 = 0LL;
      dword_140C13330 = dword_140C13330 & 0xFFEFE7FD | 0x101800;
      BgInternal = 0LL;
      ...
      if ( v39 )
      {
        ...
        qword_140C133F8 = ResFwConfigureDisplayStringResources(*(_QWORD *)(a1 + 256));
        qword_140C133F0 = AnFwConfigureProgressResources(*(int **)(a1 + 264));
      }
      else
      {
        qword_140C133F8 = 0LL;
  ...
  if ( a2 == -1 )
  {
    dword_140C13330 = BgpFwInitializeLock(0x100000LL) | 0xC04;
    qword_140C13408 = (__int64)&qword_140C13400;
    qword_140C13400 = (__int64)&qword_140C13400;
    v40 = *(_QWORD *)(a1 + 240);
    if ( !v40 || !*(_DWORD *)(a1 + 248) )
      return 3221225626LL;
    BgpFwInitializeReservePool(v40, 0x4000LL, &unk_140CF2700);
    v5 = BgpFwLibraryEnable(a1 + 32);
    if ( v5 < 0 )
      goto LABEL_59;
    xmmword_140C13368 = *(_OWORD *)(a1 + 100);
    if ( *(_QWORD *)(a1 + 88) )
    {
    ...
    if ( *(_DWORD *)(a1 + 116) >= 3u )
    {
      qword_140C134B0 = *(_QWORD *)(a1 + 404);
      dword_140C134B8 = *(_DWORD *)(a1 + 412);
    }
    dword_140C13498 = *(_DWORD *)(a1 + 400);
  ...
  if ( v5 >= 0 )
  {
    *(PHYSICAL_ADDRESS *)&xmmword_140C13310 = MmGetPhysicalAddress(qword_140C132E0);
    DWORD2(xmmword_140C13310) = DWORD2(BgInternal);
    HIDWORD(xmmword_140C13310) = DWORD1(BgInternal);
    LODWORD(xmmword_140C13320) = HIDWORD(BgInternal);
    if ( (_DWORD)xmmword_140C132D0 == 4 )
    {
      DWORD2(xmmword_140C13320) = 3;
    }
    else if ( (_DWORD)xmmword_140C132D0 == 5 )
    {
      DWORD2(xmmword_140C13320) = 4;
    }
    else
    {
      DWORD2(xmmword_140C13320) = 0;
    }
    v6 = 0;
    v7 = 416;
    v8 = 0;
    xmmword_140C13410 = *(_OWORD *)(a1 + 272);
    v9 = 0;
    xmmword_140C13420 = *(_OWORD *)(a1 + 288);
    xmmword_140C13430 = *(_OWORD *)(a1 + 304);
    xmmword_140C13440 = *(_OWORD *)(a1 + 320);
    xmmword_140C13450 = *(_OWORD *)(a1 + 336);
    xmmword_140C13460 = *(_OWORD *)(a1 + 352);
    xmmword_140C13470 = *(_OWORD *)(a1 + 368);
    xmmword_140C13480 = *(_OWORD *)(a1 + 384);
    if ( *(_QWORD *)(a1 + 72) )
    {
      v8 = 32;
      v9 = *(_DWORD *)(a1 + 84);
    ...
    if ( v15 )
    {
      ...
      *((_QWORD *)v16 + 54) = v21;
      dword_140C13330 |= 0x800u;
      v22 = BgpFoInitialize(v16 + 26, 1LL);
      dword_140C13330 &= ~0x800u;
      if ( v22 >= 0 )
        qword_140C133E0 = (__int64)(v16 + 26);
      if ( !qword_140C133E0 )
LABEL_76:
      ...
      memset(&qword_140C13378, 0, 0x58uLL);
      if ( *(_QWORD *)(a1 + 144) )
      {
        ...
        if ( v25 )
        {
          ...
          qword_140C1338C = *(_QWORD *)(a1 + 164);
        }
      }
      v26 = *(_QWORD *)(a1 + 184);
      if ( v26 && (int)BgpGxProcessQrCodeBitmap(v26, &qword_140C133B8) < 0 )
        qword_140C133B8 = 0LL;
      v27 = *(_QWORD *)(a1 + 216);
      if ( v27 )
      {
...
LABEL_35:
          ...
          v32 = *(_DWORD *)(a1 + 400);
          dword_140C13330 |= 0x8000u;
          dword_140C13498 = v32;
          BgpBcInitializeCriticalMode(a1, a2);
          dword_140C13330 = dword_140C13330 & 0xFFFF77FF | 0x800;
          ...
          qword_140C133F0 = AnFwConfigureProgressResources(*(int **)(a1 + 264));
          v37 = *(_DWORD *)(a1 + 124);
          dword_140C13330 |= v4 | 0x80;
          dword_140C13334 = v37;
          BgpFwReleaseLock();
          qword_140C133D0 = *(_QWORD *)(a1 + 232);
LABEL_49:
          dword_140C13330 |= 1u;
          v5 = 0;
          goto LABEL_50;
