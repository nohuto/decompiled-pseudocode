/*
 * XREFs of KiSwapToUmsThread @ 0x1408C0160
 * Callers:
 ...
 *     KeResetLegacyFloatingPointState @ 0x1403FC390 (KeResetLegacyFloatingPointState.c)
 *     KeSaveLegacyFloatingPointControlWord @ 0x1403FC3A0 (KeSaveLegacyFloatingPointControlWord.c)
...
__int64 __fastcall KiSwapToUmsThread(_QWORD *a1)
{
