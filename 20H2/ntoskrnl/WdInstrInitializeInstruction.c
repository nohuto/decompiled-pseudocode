/*
 * XREFs of WdInstrInitializeInstruction @ 0x1404DCD74
 * Callers:
 *     HalpWdatExecuteActionBeforeInitialize @ 0x1404D3264 (HalpWdatExecuteActionBeforeInitialize.c)
 *     HalpWdatInitializeWdat @ 0x1404D3448 (HalpWdatInitializeWdat.c)
 *     HalpWdatInitializeWdrt @ 0x1404D34E0 (HalpWdatInitializeWdrt.c)
 * Callees:
