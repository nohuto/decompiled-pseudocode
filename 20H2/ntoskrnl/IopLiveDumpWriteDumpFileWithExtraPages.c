/*
 * XREFs of IopLiveDumpWriteDumpFileWithExtraPages @ 0x14089B8D0
 * Callers:
 ...
 *     RtlNumberOfSetBitsEx @ 0x1405864A0 (RtlNumberOfSetBitsEx.c)
 *     MmFreeIndependentPages @ 0x1407601B0 (MmFreeIndependentPages.c)
 *     IopLiveDumpCheckTermination @ 0x14089A98C (IopLiveDumpCheckTermination.c)
 *     IopLiveDumpFreeDumpBuffers @ 0x14089AA50 (IopLiveDumpFreeDumpBuffers.c)
 *     IopLiveDumpGetExtraMergePages @ 0x14089ABC0 (IopLiveDumpGetExtraMergePages.c)
 *     IopLiveDumpGetNtMergePages @ 0x14089AE74 (IopLiveDumpGetNtMergePages.c)
