/*
 * XREFs of SecureDump_EncryptSymmetricKeyWithPublicKey @ 0x1405089A4
 * Callers:
    ...
    if ( Property >= 0 )
    {
      ...
      if ( Property >= 0 )
      {
        ...
        else if ( pbOutput == 2048 )
        {
          ...
          if ( Property >= 0 )
          {
            qword_140C4C6F8 = ExAllocatePoolWithTag(NonPagedPoolNx, ::pcbResult, 0x706D6453u);
            if ( !qword_140C4C6F8 )
              goto LABEL_3;
