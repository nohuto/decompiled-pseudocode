/*
 * XREFs of MiRelocateImage @ 0x14070B8DC
 * Callers:
 ...
 *     MiSetLeafPfnBuddy @ 0x1403291EC (MiSetLeafPfnBuddy.c)
 *     MiLegacyImageArchitecture @ 0x140356A14 (MiLegacyImageArchitecture.c)
 ...
 *     MiGetSubsectionFromPte @ 0x14054DC88 (MiGetSubsectionFromPte.c)
 ...
 *     MiScanRelocationPage @ 0x14070C0E0 (MiScanRelocationPage.c)
...
LABEL_56:
      ...
      *(_DWORD *)(v16 + 92) |= 0x400000u;
      ...
      if ( (MiFlags & 0x4000) == 0
        ...
        || (qword_140C1D9C0
          ? (updated = qword_140C1D9C0(*(_QWORD *)(v47 + 40) & 0xFFFFFFFFFFFFFFF8uLL, v46))
          : (updated = -1073741637),
            updated >= 0) )
      {
        updated = 0;
...
LABEL_100:
  ...
  if ( (int)MiMapImageInSystemSpace(v16, 3LL, v99) < 0 )
  {
    ExFreePoolWithTag(v26, 0);
    MiSetDeleteOnClose(v16, 0);
    return 0LL;
