/*
 * XREFs of DrvDbGetObjectSubKeyCallback @ 0x1409809E0
 * Callers:
 *     <none>
 * Callees:
 ...
 *     _PnpCtxRegEnumKeyWithCallback @ 0x1407A86D8 (_PnpCtxRegEnumKeyWithCallback.c)
...
__int64 __fastcall DrvDbGetObjectSubKeyCallback(__int64 a1, __int64 a2, const wchar_t *a3, __int64 a4)
{
  ...
  v4 = (const wchar_t **)&off_140007248;
  ppszDestEnd = 0LL;
  pcchRemaining = 0LL;
  v5 = 0LL;
  Handle = 0LL;
...
LABEL_9:
      ...
      if ( (int)SysCtxRegOpenKey(v17, a2, (__int64)a3, 8u, 0x20019u, (__int64)&Handle) < 0
        || (int)PnpCtxRegQueryInfoKey(v18, Handle, &v33, 0LL, &v28, 0LL, 0LL) < 0 )
      {
        goto LABEL_28;
      }
