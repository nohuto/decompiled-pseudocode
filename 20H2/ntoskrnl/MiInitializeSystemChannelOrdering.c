/*
 * XREFs of MiInitializeSystemChannelOrdering @ 0x140A957B8
 * Callers:
 *     MiInitializeChannelOrdering @ 0x14078EAA0 (MiInitializeChannelOrdering.c)
 * Callees:
...
void __fastcall MiInitializeSystemChannelOrdering(__int64 a1, unsigned int a2)
{
  ...
  for ( i = (char *)qword_140C4DD50; *(_QWORD *)i != -1LL; i += 16 )
  {
