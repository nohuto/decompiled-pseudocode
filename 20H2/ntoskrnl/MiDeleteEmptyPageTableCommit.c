/*
 * XREFs of MiDeleteEmptyPageTableCommit @ 0x1403F32D4
 * Callers:
...
unsigned __int64 __fastcall MiDeleteEmptyPageTableCommit(__int64 *a1)
{
  ...
  __int64 v39; // rcx
  _OWORD v40[21]; // [rsp+40h] [rbp-C0h] BYREF
  int v42; // [rsp+1A8h] [rbp+A8h] BYREF
  unsigned __int64 *v43; // [rsp+1B0h] [rbp+B0h]

  memset(v40, 0, 0x88uLL);
  memset(&v40[9], 0, 0x88uLL);
  ...
  else
  {
    ...
    HIDWORD(v40[1]) = (LeafVa >> 12) - 1;
    BYTE1(v40[2]) = ((LeafVa >> 12) - 1) >> 32;
    v7 = (char *)v40 + 1;
  }
  ...
  else
  {
    ...
    DWORD2(v40[10]) = (v6 >> 12) + 1;
    LOBYTE(v40[11]) = ((v6 >> 12) + 1) >> 32;
    v21 = (_QWORD *)((char *)&v40[9] + 1);
  }
  Process = KeGetCurrentThread()->ApcState.Process;
  v36 = MiLockWorkingSetExclusive(a1[3]);
  MiCaptureDeleteHierarchy(LeafVa, v6, v36, &v42);
  MiUnlockWorkingSetExclusive(a1[3], v36);
  MiReturnPageTablePageCommitment(LeafVa, v6, (_DWORD)Process, (_DWORD)v7, (__int64)v21, v3, (__int64)&v42);
  v37 = v43;
  result = v43[2];
  v39 = *(_QWORD *)(result + 24);
  if ( v39 )
  {
    _InterlockedExchangeAdd64((volatile signed __int64 *)&Process[1].Affinity.Bitmap[13], -v39);
    result = v37[2];
