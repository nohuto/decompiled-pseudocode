/*
 * XREFs of DownLevelGetParentLanguageName @ 0x1405BC7D8
 * Callers:
...
__int64 __fastcall DownLevelGetParentLanguageName(const void *a1, char *a2)
{
  ...
  if ( !a2 )
    return 0LL;
  v3 = bsearch(a1, &off_140002F30, 0x1B4uLL, 8uLL, (int (__cdecl *)(const void *, const void *))CompareLangName);
  if ( !v3 )
    return 0LL;
  v4 = -1LL;
  v5 = (char *)(&off_140003CD0)[2 * dword_140003CDC[4 * word_14001F2F0[(v3 - (_BYTE *)&off_140002F30) >> 3]]];
  do
    ++v4;
  while ( *(_WORD *)&v5[2 * v4] );
