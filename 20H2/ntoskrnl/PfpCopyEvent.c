/*
 * XREFs of PfpCopyEvent @ 0x14064B5D0
 * Callers:
 *     PfpFlushEventBuffers @ 0x14064B4D0 (PfpFlushEventBuffers.c)
 *     PfpFlushBuffers @ 0x14064B810 (PfpFlushBuffers.c)
 * Callees:
 *     ObfDereferenceObjectWithTag @ 0x140221210 (ObfDereferenceObjectWithTag.c)
 *     PfpIsProcessInfoPresent @ 0x1402440E8 (PfpIsProcessInfoPresent.c)
 *     memmove @ 0x140411040 (memmove.c)
 *     PsLookupProcessByProcessId @ 0x14063B130 (PsLookupProcessByProcessId.c)
 *     PfpLogPageAccess @ 0x14064BBB0 (PfpLogPageAccess.c)
 *     PfTAcquireLogEntry @ 0x14064C200 (PfTAcquireLogEntry.c)
 */
...
__int64 __fastcall PfpCopyEvent(__int64 *Src)
{
  ...
  {
    v13 = (v1 >> 2) & 0x3FF;
    v14 = PfTAcquireLogEntry(&unk_140C4FA58, &v18, v13);
    if ( !v14 )
      return 3221225626LL;
  ...
  *(_QWORD *)&v17 = v6 & 0xFFFFFFFF00FFFFFFuLL | v7;
  ...
  if ( !v10 )
    return 3221225864LL;
  v11 = ((qword_140C4FA98 + 47) & 0xFFFFFFFFFFFFFFF8uLL)
      + 40LL * (*(unsigned __int16 *)(v10 + 10) - (unsigned int)*(unsigned __int16 *)(qword_140C4FA98 + 36));
