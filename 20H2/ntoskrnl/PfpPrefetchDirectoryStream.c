/*
 * XREFs of PfpPrefetchDirectoryStream @ 0x1406F2380
 * Callers:
...
__int64 PfpPrefetchDirectoryStream(__int64 *a1, __int64 a2, __int64 a3, ...)
{
  ...
  unsigned int v32; // [rsp+E0h] [rbp+57h]
  __int64 v33; // [rsp+F8h] [rbp+6Fh] BYREF
  va_list va; // [rsp+F8h] [rbp+6Fh]
  __int64 v35; // [rsp+100h] [rbp+77h]
  ...
  *(_DWORD *)Src = 4;
  ...
  LODWORD(v10) = v36;
  *(_QWORD *)(Src + 8) = v13;
  v14 = PfpOpenHandleCreate((__int64)v29, v3, *(_QWORD *)(v12 + 16), *(_QWORD *)(v12 + 8), 1048577, v10, 0, a2);
  if ( v14 >= 0 )
  {
    if ( (*(_DWORD *)(*a1 + 80) & 4) != 0 )
