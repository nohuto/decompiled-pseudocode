/*
 * XREFs of ?SmFirstTimeInit@@YAJKK@Z @ 0x140337B6C
 * Callers:
 ...
 *     ?SmStorePrepare@?$SMKM_STORE_MGR@USM_TRAITS@@@@SAJPEAU1@@Z @ 0x1403C8360 (-SmStorePrepare@-$SMKM_STORE_MGR@USM_TRAITS@@@@SAJPEAU1@@Z.c)
 ...
 *     ExAllocatePrivateWorkerPool @ 0x1407BDE64 (ExAllocatePrivateWorkerPool.c)
