/*
 * XREFs of HalpPciGetHpetInterruptSource @ 0x140A912C0
 * Callers:
 *     HalpTimerRegister @ 0x1403B1C50 (HalpTimerRegister.c)
 * Callees:
 *     HalSocGetAcpiTable @ 0x1403B2194 (HalSocGetAcpiTable.c)
 *     HalpPciGetHpetInterruptSourceAmd @ 0x140A9138C (HalpPciGetHpetInterruptSourceAmd.c)
 *     HalpPciGetHpetInterruptSourceIntel @ 0x140A91478 (HalpPciGetHpetInterruptSourceIntel.c)
 */
