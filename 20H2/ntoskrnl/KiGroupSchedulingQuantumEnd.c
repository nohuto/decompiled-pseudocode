/*
 * XREFs of KiGroupSchedulingQuantumEnd @ 0x1402DB840
 * Callers:
...
LABEL_70:
  ...
  {
    KiGroupSchedulingGenerationEnd(a1, v7, 0);
    return;
  }
  v14 = *(_QWORD *)(a2 + 104);
  v15 = v14;
  ...
  if ( v14 )
  {
    ...
    if ( v16 )
    {
      while ( 1 )
      {
        ...
        if ( (v17 & 4) != 0 )
          break;
        KiComputeGroupSchedulingRank(v15, a1, (__int64 *)v16);
...
LABEL_41:
          ...
          else
          {
            ...
            if ( ThreadEffectiveRankNonZero )
              ready = KiChooseLowestRankedThread(a1, a2, v22);
            else
          ...
          if ( v19 )
          {
            if ( KiShouldPreemptionBeDeferred(a2) )
            {
              if ( (*(_DWORD *)(a2 + 120) & 0xC00) == 0 )
              {
                ...
                KiInsertDeferredPreemptionApc(a1, a2, 0LL);
...
LABEL_106:
            ...
            else if ( KiCheckForMaxOverQuotaScb(v19) && !*(_QWORD *)(a1 + 16) )
            {
