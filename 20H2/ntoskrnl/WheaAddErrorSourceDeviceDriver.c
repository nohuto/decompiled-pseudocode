/*
 * XREFs of WheaAddErrorSourceDeviceDriver @ 0x1407A6340
 * Callers:
 *     WheaAddErrorSourceDeviceDriverV1 @ 0x1403BA2D0 (WheaAddErrorSourceDeviceDriverV1.c)
 * Callees:
 *     WheapDeviceDriverGetPacketLength @ 0x1403BA6C0 (WheapDeviceDriverGetPacketLength.c)
