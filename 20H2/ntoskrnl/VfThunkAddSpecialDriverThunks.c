/*
 * XREFs of VfThunkAddSpecialDriverThunks @ 0x1409DB8C4
 * Callers:
 ...
 *     ViThunkFindNextSpecialTable @ 0x1409DC14C (ViThunkFindNextSpecialTable.c)
 *     ViThunkRecoverPristines @ 0x1409DC1A4 (ViThunkRecoverPristines.c)
 */
