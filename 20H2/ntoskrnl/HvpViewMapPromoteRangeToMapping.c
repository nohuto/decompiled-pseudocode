/*
 * XREFs of HvpViewMapPromoteRangeToMapping @ 0x1405DA2C4
 * Callers:
 *     HvpAddBin @ 0x1405DB258 (HvpAddBin.c)
 *     HvpRemapAndEnlistHiveBins @ 0x140706998 (HvpRemapAndEnlistHiveBins.c)
 * Callees:
 *     CmSiGetMemoryAllocationGranularity @ 0x1402043D0 (CmSiGetMemoryAllocationGranularity.c)
...
__int64 __fastcall HvpViewMapPromoteRangeToMapping(__int64 a1, int a2, unsigned int a3, __int64 *a4)
{
  ...
  if ( v15 >= 0 )
  {
    ...
    if ( ViewRangeValid >= 0 )
    {
      ...
      for ( i = *(_QWORD *)(v5 + 48); i < *(_QWORD *)(v22 + 40); i = *(_QWORD *)(v35 + 48) )
      {
        v35 = *(_QWORD *)v4;
        ...
        RtlRbRemoveNode((unsigned __int64 *)v4, v35);
        v37 = p_Privileges;
