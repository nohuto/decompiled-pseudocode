/*
 * XREFs of ?ReadPartitionTable@SC_DISK@@QEAAJPEAPEAVSC_DISK_LAYOUT@@@Z @ 0x1405C5778
 * Callers:
 ...
 * Callees:
 *     ?ResetPartitionCache@SC_DISK@@QEAAJXZ @ 0x1405C584C (-ResetPartitionCache@SC_DISK@@QEAAJXZ.c)
