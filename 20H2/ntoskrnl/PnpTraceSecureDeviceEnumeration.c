/*
 * XREFs of PnpTraceSecureDeviceEnumeration @ 0x1408B4B80
 * Callers:
...
void PnpTraceSecureDeviceEnumeration()
{
  ...
  if ( (unsigned int)dword_140C02DC0 > 5 )
  {
    if ( tlgKeywordOn((__int64)&dword_140C02DC0, 0x400000000000LL) )
    {
      ...
      v4 = v1;
      v13 = 4LL;
      tlgWriteTransfer_EtwWriteTransfer((__int64)&dword_140C02DC0, (unsigned __int8 *)word_1400244DA, 0LL, 0LL, 6u, &v5);
    }
  }
}
