...
void __fastcall MiQueuePinDriverAddressLog(__int64 a1, unsigned __int64 a2, unsigned int a3)
{
  ...
  {
    v8 = v7 + 1;
    v9 = v8 < dword_140C29F60 ? v8 : 0;
    v10 = dword_140C29F60 - 1;
    v11 = (qword_140C29F68 & 4) != 0 ? 0x20 : 0;
    v12 = qword_140C29F68 - ((qword_140C29F68 & 4) != 0 ? 4 : 0);
    while ( 1 )
    {
      v33 = 0;
      v13 = v11 + v10;
...
LABEL_17:
  ...
  while ( v7 != -1 && !(unsigned int)RtlInterlockedSetClearRun((__int64)&dword_140C29F60, v7, 1u) );
  if ( v7 >= 0x800 )
  {
LABEL_63:
