/*
 * XREFs of MiQueuePinDriverAddressLog @ 0x1403A3994
 * Callers:
...
void __fastcall MiQueuePinDriverAddressLog(__int64 a1, unsigned __int64 a2, unsigned int a3)
{
  ...
  v7 = -1;
  if ( (word_140C2A0D2 & 1) == 0 )
    goto LABEL_63;
  do
  {
    v8 = v7 + 1;
    v9 = v8 < stru_140C29F60.SizeOfBitMap ? v8 : 0;
    v10 = stru_140C29F60.SizeOfBitMap - 1;
    v11 = ((__int64)stru_140C29F60.Buffer & 4) != 0LL ? 0x20 : 0;
    v12 = (char *)stru_140C29F60.Buffer - (((__int64)stru_140C29F60.Buffer & 4) != 0LL ? 4 : 0);
    while ( 1 )
    {
      v33 = 0;
      v13 = v11 + v10;
...
LABEL_47:
      if ( !v9 )
        goto LABEL_17;
      SizeOfBitMap = v8 + 1;
      if ( v8 + 1 > stru_140C29F60.SizeOfBitMap )
        SizeOfBitMap = stru_140C29F60.SizeOfBitMap;
      v10 = SizeOfBitMap - 1;
      v9 = 0;
    }
...
LABEL_17:
  ...
  while ( v7 != -1 && !(unsigned int)RtlInterlockedSetClearRun((__int64)&stru_140C29F60, v7, 1u) );
  if ( v7 >= 0x800 )
  {
LABEL_63:
    v26 = (char *)&unk_140C2A078;
    if ( !(_BYTE)KdDebuggerEnabled )
      v26 = (char *)&unk_140C2A070;
