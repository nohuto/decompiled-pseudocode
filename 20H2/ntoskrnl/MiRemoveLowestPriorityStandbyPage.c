/*
 * XREFs of MiRemoveLowestPriorityStandbyPage @ 0x140384340
 * Callers:
...
LABEL_63:
  ...
  if ( (*(_BYTE *)(v15 + 34) & 7) != 2
    || *(_QWORD *)(qword_140C4E4C8 + 8 * ((*(_QWORD *)(v15 + 40) >> 39) & 0x3FFLL)) != a1 )
  {
    goto LABEL_47;
  }
  LockHandle.LockQueue.Lock = v5;
...
LABEL_54:
  ...
  if ( dword_140C4E54C == 1 )
  {
    v35 = v9 & 0x1F;
    LOBYTE(v36) = 1;
    v37 = (volatile signed __int32 *)(qword_140C4E5A8 + 4 * (v9 >> 5));
    if ( v35 + 1 <= 0x20 )
    {
      v38 = 1 << v35;
      goto LABEL_75;
