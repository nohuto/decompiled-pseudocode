/*
 * XREFs of MiDeleteCachedSubsection @ 0x1405272CC
 * Callers:
...
LABEL_25:
  ...
  *(_DWORD *)(v3 + 56) |= 0x100u;
  ...
  else
  {
    ...
    v79 = v46;
    *(_QWORD *)(*(_QWORD *)(qword_140C4E4C8 + 8LL * (*(_WORD *)(v3 + 60) & 0x3FF)) + 1688LL) = 0LL;
    ...
    else
    {
      ...
      v33 = MiFlushSectionInternal(v84, v82, (_QWORD *)v4, (_QWORD *)v4, 0LL, 2u, (unsigned int *)v80);
