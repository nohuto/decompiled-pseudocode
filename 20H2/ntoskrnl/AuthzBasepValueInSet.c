/*
 * XREFs of AuthzBasepValueInSet @ 0x1402E4660
 * Callers:
 ...
 *     AuthzBasepOperandValueTypesCompatible @ 0x1402E45C0 (AuthzBasepOperandValueTypesCompatible.c)
 ...
 *     AuthzBasepCompareIntegerOperands @ 0x1405C0278 (AuthzBasepCompareIntegerOperands.c)
...
LABEL_30:
      ...
      switch ( v12 )
      {
        case 3u:
          LOBYTE(v14) = 0x80;
          v15 = AuthzBasepCompareUnicodeStringOperands(v14, v22, a3);
          goto LABEL_13;
        case 4u:
          LOBYTE(v14) = 0x80;
