/*
 * XREFs of EtwpDisableKernelTrace @ 0x14078DD44
 * Callers:
...
__int64 __fastcall EtwpDisableKernelTrace(__int64 a1, int *a2, __int64 a3, _DWORD *a4)
{
  int v4; // ebp
  int v5; // r14d
  int v8; // eax
  ...
  if ( a2 )
  {
    ...
    if ( (v12 & 0x400) != 0 )
    {
      for ( i = 0; i < EtwpPmcProfile; ++i )
        KeStopProfile((ULONG_PTR)qword_140C19B68 + 248 * i);
    }
    if ( (a2[4] & 0x80u) != 0 )
    {
  ...
  return EtwpUpdateFileInfoDriverState(a1, (_DWORD)a2, 0, v5, v4);
}
