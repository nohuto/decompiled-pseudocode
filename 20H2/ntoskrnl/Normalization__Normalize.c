/*
 * XREFs of Normalization__Normalize @ 0x14091AC14
 * Callers:
 *     RtlpNormalizeStringWorker @ 0x14091B744 (RtlpNormalizeStringWorker.c)
 * Callees:
 *     memset @ 0x140411300 (memset.c)
 *     NormBuffer__Append @ 0x14058C00C (NormBuffer__Append.c)
 *     Normalization__GuessCharCountBySize @ 0x14091A52C (Normalization__GuessCharCountBySize.c)
