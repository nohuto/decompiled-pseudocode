/*
 * XREFs of WdipSemEnableScenario @ 0x1407857FC
 * Callers:
 ...
 *     WdipSemQueryScenarioTable @ 0x140785944 (WdipSemQueryScenarioTable.c)
 *     WdipSemGetLoggerIds @ 0x1407859AC (WdipSemGetLoggerIds.c)
 *     WdipSemActivateInstance @ 0x140785ACC (WdipSemActivateInstance.c)
 *     WdipSemEnableContextProviders @ 0x140785C8C (WdipSemEnableContextProviders.c)
