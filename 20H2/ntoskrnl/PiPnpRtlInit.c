/*
 * XREFs of PiPnpRtlInit @ 0x140798E30
 * Callers:
 ...
 *     _PnpCtxSetNtPlugPlayRoutine @ 0x140798FBC (_PnpCtxSetNtPlugPlayRoutine.c)
...
__int64 __fastcall PiPnpRtlInit(unsigned int a1)
{
  ...
  qword_140C440D8 = (__int64)&PiPnpRtlActiveOperations;
