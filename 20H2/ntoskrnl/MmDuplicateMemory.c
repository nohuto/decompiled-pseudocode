/*
 * XREFs of MmDuplicateMemory @ 0x140998B1C
 * Callers:
 ...
 *     MiResumeFromHibernate @ 0x140386074 (MiResumeFromHibernate.c)
...
LABEL_53:
      dword_140C4E54C = 0;
      if ( BYTE4(v19) == 1 )
        _InterlockedAdd(&dword_140C4EBCC, 0xFFFFFFFF);
      if ( qword_140C4E588 )
        qword_140C4E588 = 0LL;
      if ( v2 != 17 )
      {
      ...
      if ( v6 == 1 )
      {
        stru_140C4E568.Parameter = (void *)HIDWORD(v18);
        ExQueueWorkItem(&stru_140C4E568, HyperCriticalWorkQueue);
      }
      else
      {
        _InterlockedAdd(&dword_140C4ED58, 0xFFFFFFFF);
        KeSetEvent(&stru_140C4E550, 0, 0);
      }
    ...
    MiActOnMirrorBitmap((__int64)&qword_140C4E5A0, 1);
    v9 = 1;
    LODWORD(v19) = 0;
    if ( (BYTE8(v18) & 1) != 0 )
    {
...
LABEL_31:
      ...
      v4 = KeGetCurrentIrql();
      if ( *(_QWORD *)(a1 + 24) )
        MiActOnMirrorBitmap((__int64)qword_140C4E590, 1);
      if ( v4 < 2u )
      {
      ...
      qword_140C4E588 = (__int64)CurrentThread;
      if ( BYTE4(v19) == 1 )
      {
        _InterlockedAdd(&dword_140C4EBCC, 0xFFFFFFFF);
        BYTE4(v19) = 0;
      ...
      if ( v8 < 0
        ...
        || (v12 = (*(__int64 (__fastcall **)(__int64))(a1 + 8))(1LL), qword_140C4E588 = 0LL, v8 = v12, v12 != 1073742484)
        || v9 )
      {
LABEL_52:
        v6 = 0;
