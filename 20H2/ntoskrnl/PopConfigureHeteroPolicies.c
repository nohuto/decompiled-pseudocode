/*
 * XREFs of PopConfigureHeteroPolicies @ 0x1407B649C
 * Callers:
 ...
 *     KeConfigureHeteroPolicy @ 0x1407B6AB0 (KeConfigureHeteroPolicy.c)
 *     PpmHeteroComputeBias @ 0x1408F3D38 (PpmHeteroComputeBias.c)
 */
  ...
  for ( i = 0; i < 5; ++i )
  {
    switch ( i )
    {
      ...
      case 3u:
        ...
        {
          v12 = &PpmCurrentProfile[342 * dword_140C23D4C + 5];
          HIDWORD(v62) |= 0x1800u;
          goto LABEL_30;
        }
LABEL_28:
        v12 = (__int64 *)(v16 + 2736LL * dword_140C23D4C + 40);
        v62 = *v12;
        goto LABEL_30;
      default:
        v12 = &PpmCurrentProfile[342 * dword_140C23D4C + 5];
...
LABEL_30:
  ...
  {
    dword_140C20A74 = -1;
    xmmword_140C20A44 = (__int128)_mm_load_si128((const __m128i *)&_xmm);
    PopHeteroLegacyOverride = 5;
    xmmword_140C20A54 = xmmword_140C20A44;
    qword_140C20A6C = 0LL;
    qword_140C20A64 = xmmword_140C20A44;
  ...
  do
  {
    ...
    do
    {
      v21 = *(_DWORD *)((char *)&xmmword_140C20A44 + v18);
      if ( v21 != 5 )
  ...
  v23 = HIDWORD(v69[2]);
  v24 = *(_DWORD *)&v70[4];
  if ( (_DWORD)qword_140C20A6C )
    v23 = qword_140C20A6C;
  v25 = ResultLength[1];
  HIDWORD(v69[2]) = v23;
  v26 = *(_DWORD *)v70;
  if ( HIDWORD(qword_140C20A6C) )
    v26 = HIDWORD(qword_140C20A6C);
  LODWORD(v69[0]) = v22;
  *(_DWORD *)v70 = v26;
  if ( dword_140C20A74 != -1 )
    v24 = dword_140C20A74;
  *(_DWORD *)&v70[4] = v24;
