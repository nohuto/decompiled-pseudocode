/*
 * XREFs of RtlpHpSegMgrCommitComplete @ 0x140326D54
 * Callers:
        ...
        unsigned __int8 a6)
{
  ...
  int v25[14]; // [rsp+30h] [rbp-38h] BYREF
...
LABEL_38:
          ...
          KiAbThreadRemoveBoosts((ULONG_PTR)CurrentThread, SpinLock, v25);
          ...
          LOWORD(v6) = KiLeaveGuardedRegionUnsafe((__int64)KeGetCurrentThread());
        }
      }
      return v6;
    }
