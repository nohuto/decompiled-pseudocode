/*
 * XREFs of MiLogOutswappedProcessCommitReacquire @ 0x140529C04
 * Callers:
...
void __fastcall MiLogOutswappedProcessCommitReacquire(__int64 a1, __int64 a2, int a3, int a4)
{
  ...
  if ( *(_QWORD *)&qword_140C4ED60 )
  {
    if ( a3 )
    {
      if ( a4 )
      {
        if ( **(_DWORD **)&qword_140C4ED60 > 5u && tlgKeywordOn(*(__int64 *)&qword_140C4ED60, 4LL) )
        {
      ...
      else if ( **(_DWORD **)&qword_140C4ED60 > 5u && tlgKeywordOn(*(__int64 *)&qword_140C4ED60, 4LL) )
      {
        tlgCreate1Sz_char((__int64)v19, (const CHAR *)(v12 + 1448));
        v10 = (char *)&byte_140024B17;
        goto LABEL_13;
      }
    }
    else if ( **(_DWORD **)&qword_140C4ED60 > 5u && tlgKeywordOn(*(__int64 *)&qword_140C4ED60, 4LL) )
