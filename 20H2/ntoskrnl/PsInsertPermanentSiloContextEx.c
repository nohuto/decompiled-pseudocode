/*
 * XREFs of PsInsertPermanentSiloContextEx @ 0x1406A0B74
 * Callers:
 *     CmpGetOrCreateContextForSiloNoRef @ 0x1406A0A64 (CmpGetOrCreateContextForSiloNoRef.c)
 *     PsInsertPermanentSiloContext @ 0x1407D0190 (PsInsertPermanentSiloContext.c)
 *     ObCreateSiloRootDirectory @ 0x140982DB0 (ObCreateSiloRootDirectory.c)
 * Callees:
 *     PspJobHasChildren @ 0x1405D6234 (PspJobHasChildren.c)
