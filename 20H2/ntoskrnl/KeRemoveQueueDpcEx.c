/*
 * XREFs of KeRemoveQueueDpcEx @ 0x1403605E0
 * Callers:
...
char __fastcall KeRemoveQueueDpcEx(__int64 a1, char a2)
{
  ...
  unsigned __int16 v35[88]; // [rsp+130h] [rbp-F8h] BYREF
  ...
  if ( a2 && *(_QWORD *)(a1 + 16) )
  {
    KiGetDeepIdleProcessors(v35, (unsigned __int16 *)v34);
    v17 = 0;
    if ( LOWORD(v34[0]) )
    {
      v18 = *(_QWORD *)(a1 + 16);
    ...
    v4 = v27;
    if ( !IsEmptyAffinity )
      KeGenericProcessorCallback(v34, (void (__fastcall *)(struct _KPRCB *, __int64))xHalTimerWatchdogStop, 0LL, 2);
  }
  return v4;
}
