/*
 * XREFs of KeSetActualBasePriorityThread @ 0x1402BE010
 * Callers:
 ...
 *     PopFxEmergencyWorker @ 0x1407D0CA0 (PopFxEmergencyWorker.c)
 * Callees:
...
__int64 __fastcall KeSetActualBasePriorityThread(__int64 a1, int a2, __int64 a3, _DWORD *SchedulerAssist)
{
        ...
        if ( (int)v16 < v20 )
        {
          ...
          if ( v44 )
          {
            ...
            *v21->PriorityState = v47;
            ...
            KiInsertDeferredReadyList((__int64)&v64, a1);
            v21 = v69;
          }
          goto LABEL_20;
        }
