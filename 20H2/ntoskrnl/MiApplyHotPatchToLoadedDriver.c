/*
 * XREFs of MiApplyHotPatchToLoadedDriver @ 0x1408CBA38
 * Callers:
...
NTSTATUS __fastcall MiApplyHotPatchToLoadedDriver(__int64 a1, __int128 *a2, __int64 a3)
{
  ...
  if ( (unsigned int)MI_IS_PHYSICAL_ADDRESS(v3) )
  {
    ...
    if ( !(unsigned int)MiMakeZeroedPageTables(
                          v10,
                          v10 + 8 * (((unsigned int)dword_140C4CB30 >> 12) + ((dword_140C4CB30 & 0xFFF) != 0) - 1LL),
                          0,
                          12) )
      return -1073741670;
  }
...
LABEL_18:
    ...
    if ( active < 0 )
      goto LABEL_18;
    _InterlockedExchangeAdd(&dword_140C4EE50, v29);
    v12 = (unsigned int *)P;
    v21 = v27;
    v7 = 1;
