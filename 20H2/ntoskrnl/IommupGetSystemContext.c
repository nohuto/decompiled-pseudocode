/*
 * XREFs of IommupGetSystemContext @ 0x1403CB644
 * Callers:
 *     IommuGetLibraryContext @ 0x1404D7400 (IommuGetLibraryContext.c)
 *     IommuGetConfiguration @ 0x140A72EA0 (IommuGetConfiguration.c)
 *     IommuHvGetConfiguration @ 0x140A908B0 (IommuHvGetConfiguration.c)
 * Callees:
...
LABEL_9:
      if ( HalpHvIommu
        && (!IommupHvSvmEnabled
         || (int)((__int64 (__fastcall *)(_QWORD, _QWORD))qword_140C4A348)(a1, (unsigned int)IommupHvMaximumAsids) < 0) )
      {
        KxReleaseSpinLock(&IommupSystemContextListLock);
        if ( KiIrqlFlags )
        {
