/*
 * XREFs of MiDeleteExtentPfns @ 0x14053EC80
 * Callers:
...
char __fastcall MiDeleteExtentPfns(__int64 a1, __int64 a2)
{
  ...
  if ( a1 )
  {
    v3 = KeAbPreAcquire((ULONG_PTR)&qword_140C4C990, 0LL, 0LL);
    if ( v3 )
      *(_BYTE *)(v3 + 26) |= 1u;
  }
  while ( 1 )
...
LABEL_22:
  if ( v2 )
    LOBYTE(v5) = KeAbPostRelease((ULONG_PTR)&qword_140C4C990);
  return v5;
}
