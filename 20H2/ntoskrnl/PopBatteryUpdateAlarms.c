/*
 * XREFs of PopBatteryUpdateAlarms @ 0x140792F60
 * Callers:
  ...
  if ( (unsigned int)a2 < v18 )
  {
    ...
    do
    {
      if ( (int)PopGetPowerSettingValue(
                  (__int64)GUIDS_BATTERY_DISCHARGE_ACTION[v19],
                  a2,
                  v2,
                  (char *)&v31 + 4,
                  v27,
      ...
      if ( (int)PopGetPowerSettingValue(
                  (__int64)GUIDS_BATTERY_DISCHARGE_LEVEL[v19],
                  v22,
                  v2,
                  (char *)&v31 + 4,
                  v28,
      ...
      if ( (int)PopGetPowerSettingValue(
                  (__int64)GUIDS_BATTERY_DISCHARGE_FLAGS[v19],
                  v24,
                  v2,
                  (char *)&v31 + 4,
                  v29,
