/*
 * XREFs of ApiSetpSearchForApiSet @ 0x1403A2A70
 * Callers:
 *     ApiSetResolveToHost @ 0x1403713E4 (ApiSetResolveToHost.c)
 *     ApiSetValidateSchemaFormat @ 0x1405BC894 (ApiSetValidateSchemaFormat.c)
