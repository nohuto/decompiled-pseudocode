/*
 * XREFs of WarbirdCrypto::CCipherFeistel64::CallRoundFunction @ 0x140262120
 * Callers:
        ...
        unsigned int a4)
{
  ...
  switch ( v7[2] )
  {
    ...
    case 1:
      ...
      v66 = a3;
      v65 = a3;
      v35 = a4 - *((unsigned __int16 *)&v66 + ((v42 % 3 + (_BYTE)a2 + 1) & 3));
    ...
    case 7:
      ...
      v66 = a3;
      v65 = a3;
      v35 = __ROL4__(a4 ^ *((_DWORD *)&v66 + (((unsigned __int8)(a2 >> 1) - 1) & 1)), v33 % 7 + 1);
      v36 = *((unsigned __int16 *)&v65 + (v6 & 3));
LABEL_21:
      v17 = v36 * v35;
      v18 = a4 >> (v34 % 0xF + 1);
    ...
    case 9:
      ...
      v66 = a3;
      v65 = a3;
      v29 = __ROL4__(a4 ^ *((unsigned __int16 *)&v66 + ((v32 % 3 + (_BYTE)a2 + 1) & 3)), v31 % 7 + 1);
      v30 = *((unsigned __int16 *)&v65 + (v6 & 3));
      return (unsigned int)(__ROR4__(a4, v28 % 0x1F + 1) + v30 * v29);
    case 0xA:
      v25 = v7[4];
      v26 = v7[3];
      v14 = v7[5];
    ...
    case 0xC:
      ...
      v66 = a3;
      v65 = a3;
      v29 = __ROR4__(a4 + *((_DWORD *)&v66 + (((unsigned __int8)(a2 >> 1) - 1) & 1)), v47 % 0x1F + 1);
      v30 = *((unsigned __int16 *)&v65 + (v6 & 3));
      return (unsigned int)(__ROR4__(a4, v28 % 0x1F + 1) + v30 * v29);
    case 0xD:
      v62 = v7[4];
      ...
      v66 = a3;
      v65 = a3;
      v29 = __ROR4__(*((_DWORD *)&v66 + (((unsigned __int8)(a2 >> 1) - 1) & 1)) - a4, v62 % 0x1F + 1);
      v30 = *((unsigned __int16 *)&v65 + (v6 & 3));
      return (unsigned int)(__ROR4__(a4, v28 % 0x1F + 1) + v30 * v29);
    case 0xE:
      v46 = v7[4];
      ...
      v66 = a3;
      v65 = a3;
      v29 = __ROR4__(a4 ^ *((_DWORD *)&v66 + (((unsigned __int8)(a2 >> 1) - 1) & 1)), v46 % 0x1F + 1);
      v30 = *((unsigned __int16 *)&v65 + (v6 & 3));
      return (unsigned int)(__ROR4__(a4, v28 % 0x1F + 1) + v30 * v29);
    case 0xF:
      v59 = v7[4];
...
LABEL_3:
    ...
    case 0x15:
      ...
      v66 = a3;
      v65 = a3;
      v29 = __ROR4__(a4 - *((_DWORD *)&v66 + (((unsigned __int8)(a2 >> 1) - 1) & 1)), v27 % 0x1F + 1);
      v30 = *((unsigned __int16 *)&v65 + (v6 & 3));
      return (unsigned int)(__ROR4__(a4, v28 % 0x1F + 1) + v30 * v29);
    case 0x16:
      v24 = v7[4];
