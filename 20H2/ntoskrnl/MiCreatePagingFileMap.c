/*
 * XREFs of MiCreatePagingFileMap @ 0x1406826EC
 * Callers:
...
LABEL_18:
  ...
  if ( (v1 & 0x80000) != 0 && (v7 & 0xF) != 0 || v1 < 0 && (v7 & 0x1FF) != 0 )
    return 3221225714LL;
  if ( !(unsigned int)MiChargeCommit((unsigned __int64)v12, v7, 0) )
    return 3221225773LL;
  if ( v1 >= 0 )
  {
    v6 = 1LL;
...
LABEL_115:
    ...
    v15 = (unsigned int *)(qword_140C4DD18 + 4LL * v14 * (unsigned __int16)KeNumberNodes);
...
LABEL_121:
              ...
              MiUpdateLargePageSectionPfns(v48, (unsigned __int64)v45, *(unsigned int *)(v2 + 32));
              v45 += 8 * v53;
              v69 += v53;
            }
