/*
 * XREFs of TtmiWriteEnumerationEventsToQueue @ 0x140901D2C
 * Callers:
 ...
 *     TtmpPublishDisplayRequiredPowerRequestEvents @ 0x140902708 (TtmpPublishDisplayRequiredPowerRequestEvents.c)
