/*
 * XREFs of PnpFindBestConfigurationWorker @ 0x14074BB7C
 * Callers:
 *     PnpFindBestConfiguration @ 0x14074BB24 (PnpFindBestConfiguration.c)
 * Callees:
 *     IopTestConfiguration @ 0x14074BC94 (IopTestConfiguration.c)
 *     PnpSelectFirstConfiguration @ 0x14074BDEC (PnpSelectFirstConfiguration.c)
 *     IopAddRemoveReqDescs @ 0x14074BE80 (IopAddRemoveReqDescs.c)
 *     IopSelectNextConfiguration @ 0x1407CC0C0 (IopSelectNextConfiguration.c)
 *     IopRetestConfiguration @ 0x1408A34DC (IopRetestConfiguration.c)
 *     IopSaveRestoreConfiguration @ 0x1408A35A0 (IopSaveRestoreConfiguration.c)
 */
