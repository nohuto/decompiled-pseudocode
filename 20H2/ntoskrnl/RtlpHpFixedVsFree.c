/*
 * XREFs of RtlpHpFixedVsFree @ 0x1403800C0
 * Callers:
 *     <none>
 * Callees:
...
void __fastcall RtlpHpFixedVsFree(unsigned __int64 a1, __int64 a2, unsigned int a3, unsigned int a4)
{
  ...
  const signed __int64 *v33; // [rsp+38h] [rbp-10h]
  int v35; // [rsp+98h] [rbp+50h]
  int v36; // [rsp+A8h] [rbp+60h] BYREF
  ...
  v11 = *(__m128i *)(a1 + 48);
  v32 = *(_QWORD *)(a1 + 48);
  v33 = (const signed __int64 *)(a1 ^ _mm_srli_si128(v11, 8).m128i_u64[0]);
  if ( v6 >= v32 )
    goto LABEL_20;
  if ( v4 <= 1 )
  {
...
LABEL_8:
  RtlClearBitsEx((__int64)&v32, v6, v4);
  if ( !v9 )
  {
    v18 = *(_DWORD *)(a1 + 32);
    v19 = a1 + 24;
...
LABEL_41:
      ...
      KiAbThreadRemoveBoosts((ULONG_PTR)CurrentThread, v19, &v36);
