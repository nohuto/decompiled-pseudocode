/*
 * XREFs of WdipSemSqmLogInflightLimitExceededDataPoints @ 0x1406F3B70
 * Callers:
 ...
 *     WdipSemGetGuidKey @ 0x1409330F8 (WdipSemGetGuidKey.c)
...
__int64 WdipSemSqmLogInflightLimitExceededDataPoints()
{
  ...
  v3 = (unsigned int)dword_140C1C620;
  if ( dword_140C1C620 )
  {
    v1 = WdipSemSqmIncrementDword(v2, (unsigned int)dword_140C1C620);
    if ( v1 < 0 )
      v1 = 0;
    if ( (_DWORD)v3 )
    {
  ...
  for ( i = 0; i < dword_140C1C620; WdipSemFrequentScenarioTable[v8] = 0LL )
  {
    v8 = i;
