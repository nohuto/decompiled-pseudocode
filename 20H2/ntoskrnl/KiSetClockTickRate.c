/*
 * XREFs of KiSetClockTickRate @ 0x1402666EC
 * Callers:
...
__int64 __fastcall KiSetClockTickRate(unsigned int a1, char a2)
{
  ...
  if ( (unsigned int)v11 < dword_140C31454 )
    dword_140C31454 = v11;
  if ( (unsigned int)v11 > dword_140C31450 )
    dword_140C31450 = v11;
  if ( a1 < dword_140C3145C )
    dword_140C3145C = a1;
  if ( a1 > dword_140C31458 )
    dword_140C31458 = a1;
