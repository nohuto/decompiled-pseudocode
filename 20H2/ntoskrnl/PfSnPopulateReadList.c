/*
 * XREFs of PfSnPopulateReadList @ 0x140633B00
 * Callers:
 *     <none>
 * Callees:
...
void __fastcall PfSnPopulateReadList(__int64 a1)
{
  ...
  _DWORD v52[2]; // [rsp+D8h] [rbp-30h] BYREF
  ...
  _OWORD v58[3]; // [rsp+108h] [rbp+0h] BYREF
  ...
  v54 = 0LL;
  v57 = 0LL;
  Event = NtCreateEvent((unsigned __int64)&Handle, 2031619LL, (int)v52, NotificationEvent, 0);
  if ( Event >= 0 )
  {
    v10 = *(unsigned int **)v5;
    v11 = *(_DWORD *)(v2 + 40);
