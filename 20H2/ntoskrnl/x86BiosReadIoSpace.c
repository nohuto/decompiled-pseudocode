/*
 * XREFs of x86BiosReadIoSpace @ 0x140399240
 * Callers:
 *     XmInOp @ 0x140396160 (XmInOp.c)
 *     XmInsOp @ 0x1404E47E0 (XmInsOp.c)
 * Callees:
 *     x86BiosReadPciDataPort @ 0x1403C99BC (x86BiosReadPciDataPort.c)
 *     x86BiosReadCmosPort @ 0x1404BD880 (x86BiosReadCmosPort.c)
 *     x86BiosReadPciAddressPort @ 0x1404BD94C (x86BiosReadPciAddressPort.c)
 */
