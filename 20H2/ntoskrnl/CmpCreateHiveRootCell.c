/*
 * XREFs of CmpCreateHiveRootCell @ 0x140789E10
 * Callers:
        ...
        unsigned int *a5)
{
  ...
  Cell = HvAllocateCell(BugCheckParameter2, v9, 0LL, (__int64)&v23, (__int64)&v24);
  if ( Cell == -1 )
  {
    v16 = -1073741670;
...
LABEL_6:
      ...
      v16 = CmpAssignSecurityDescriptor(BugCheckParameter2, Cell, (_DWORD)v13, (_DWORD)NewDescriptor, 0);
