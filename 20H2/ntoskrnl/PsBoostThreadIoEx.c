/*
 * XREFs of PsBoostThreadIoEx @ 0x140223950
 * Callers:
 ...
 *     PsLeavePriorityRegion @ 0x1402F8090 (PsLeavePriorityRegion.c)
 *     PsEnterPriorityRegion @ 0x1402FF370 (PsEnterPriorityRegion.c)
