/*
 * XREFs of HalpRtcArmTimer @ 0x1404D4080
 * Callers:
 *     <none>
 * Callees:
 *     _guard_dispatch_icall @ 0x140405F40 (_guard_dispatch_icall.c)
 *     HalSetTimerProblem @ 0x1404D3C30 (HalSetTimerProblem.c)
 */
...
__int64 __fastcall HalpRtcArmTimer(__int64 *a1, int a2, __int64 a3)
{
  ...
  else
  {
    ...
    *a1 = v5;
    ...
    v7 = v7 & 1 | 0x42;
    ((void (__fastcall *)(_QWORD, __int64, char *, __int64))qword_140CF4268)(0LL, 11LL, &v7, 1LL);
