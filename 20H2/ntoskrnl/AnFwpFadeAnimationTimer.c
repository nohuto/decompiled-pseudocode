/*
 * XREFs of AnFwpFadeAnimationTimer @ 0x1409F54C0
 * Callers:
 *     <none>
 * Callees:
        ...
        PVOID SystemArgument2)
{
  ...
  if ( byte_140CDAFF0 )
  {
    ...
    v56 = qword_140C10E08;
    v55 = qword_140C10E80;
    v54 = (_BYTE *)qword_140C10E40;
    v57 = (_BYTE *)qword_140C10E50;
    v10 = 10 * (dword_140C10E00 - dword_140C10E00 / (unsigned int)(dword_140C13334 - dword_140C10E04));
    v13 = 0;
    if ( (unsigned int)BgpGetBitsPerPixel() == 24 )
    {
      if ( !v9 )
      {
        ...
        v32 = 0LL;
        v33 = *(_QWORD *)(v6 + 24);
        for ( i = *(_QWORD *)(qword_140C10E48 + 24);
    ...
    else
    {
      if ( !v9 )
      {
        ...
        v15 = 0LL;
        v16 = *(_QWORD *)(v6 + 24);
        for ( m = *(_QWORD *)(qword_140C10E48 + 24);
    ...
    if ( !v7 )
    {
      if ( !v4 && !v22 || (BgpGxDrawRectangle(v54, (__int64)&xmmword_140C10E20), !v22) )
        v7 = 1;
    }
    if ( !v8 )
    {
      if ( !v4 && !v30 || (BgpGxDrawRectangle((_BYTE *)v55, (__int64)&xmmword_140C10E58), !v30) )
        v8 = 1;
    }
    ...
    if ( v13 || v30 || v22 )
    {
      byte_140C10E10 = v7;
      byte_140C10E11 = v8;
      dword_140C10E00 = v10 / 0xA;
      dword_140C10E04 = v4 + 1;
      byte_140C10E12 = v9;
    }
    else
    {
      byte_140CDAFF0 = 0;
      KeCancelTimer(&stru_140CF2FC0);
      KeSetEvent(&stru_140CF3000, 0, 0);
    }
  }
  BgpFwReleaseLock();
}
