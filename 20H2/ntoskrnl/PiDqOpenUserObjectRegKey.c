/*
 * XREFs of PiDqOpenUserObjectRegKey @ 0x1406D39C0
 * Callers:
...
LABEL_12:
      ...
      if ( RelativeObjectRegPath >= 0 )
      {
        RelativeObjectRegPath = PnpConcatPWSTR(0x7FFFFFFFuLL, 0x58706E50u, (PVOID *)&v29, 2uLL);
        if ( RelativeObjectRegPath < 0 )
        {
          v9 = (PVOID)v29;
        }
        else
        {
          if ( *(_QWORD *)&PiPnpRtlCtx )
            ...
            v19 = 0LL;
          v9 = (PVOID)v29;
          RelativeObjectRegPath = SysCtxRegOpenKey(v19, 0LL, v29, 0, 4u, (__int64)&Handle);
          if ( RelativeObjectRegPath >= 0 )
          {
