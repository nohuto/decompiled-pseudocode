/*
 * XREFs of MiConvertStandbyToProto @ 0x140366CC8
 * Callers:
        ...
        __int64 a8)
{
  ...
  v12 = 1;
  v64 = 1;
  v14 = *(_QWORD *)(qword_140C4E4C8 + 8LL * *(unsigned __int16 *)(v13 + 174));
  v69 = v14;
  v16 = *v15;
  v70 = v16;
  v76 = v16;
...
LABEL_85:
    ...
    if ( a7 == (*(_QWORD *)(BugCheckParameter2 + 8) | 0x8000000000000000uLL)
      && v69 == *(_QWORD *)(qword_140C4E4C8 + 8 * ((*(_QWORD *)(BugCheckParameter2 + 40) >> 39) & 0x3FFLL))
      ...
      && (MiTryLockLeafPage((__int64 *)(a5 + 48), v44, &v67), (v48 = v67) != 0) )
    {
      if ( (*(_BYTE *)(v67 + 35) & 0x40) == 0
        ...
        && v70 == *(ULONG_PTR **)(qword_140C4E4C8 + 8 * ((*(_QWORD *)(v48 + 40) >> 39) & 0x3FFLL))
