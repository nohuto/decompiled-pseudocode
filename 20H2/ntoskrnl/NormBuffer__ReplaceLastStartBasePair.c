/*
 * XREFs of NormBuffer__ReplaceLastStartBasePair @ 0x14058C5A4
 * Callers:
 ...
 *     Normalization__GetThirdAndLastDecomposedCharPlane0 @ 0x14091A4B8 (Normalization__GetThirdAndLastDecomposedCharPlane0.c)
 */
