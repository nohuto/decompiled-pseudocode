/*
 * XREFs of MiFreePrivateFixupEntryForSystemImage @ 0x14039F308
 * Callers:
...
__int64 *__fastcall MiFreePrivateFixupEntryForSystemImage(ULONG_PTR BugCheckParameter2, int a2)
{
  ...
  v3 = 0LL;
  v5 = ExAcquireSpinLockExclusive(&dword_140C4CB64);
  v6 = (__int64 *)qword_140C4CB40;
  v7 = v5;
  while ( 1 )
  {
    if ( v6 == &qword_140C4CB40 )
      goto LABEL_9;
    v3 = (PVOID *)v6;
