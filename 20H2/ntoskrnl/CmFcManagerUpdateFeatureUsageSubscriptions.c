/*
 * XREFs of CmFcManagerUpdateFeatureUsageSubscriptions @ 0x1408806C0
 * Callers:
 ...
 *     RtlpFcUpdateUsageTriggers @ 0x14091CF08 (RtlpFcUpdateUsageTriggers.c)
 */
...
__int64 __fastcall CmFcManagerUpdateFeatureUsageSubscriptions(__int64 a1, __int64 a2, unsigned int a3)
{
  ...
  ExAcquirePushLockExclusiveEx((ULONG_PTR)&stru_140C47FB0, 0LL);
  RtlpFcBufferManagerReferenceBuffers((__int64)qword_140C48010, (__int64)&v24, &v20);
  v7 = v20;
  v8 = v24 + 1;
  v25 = 0LL;
  if ( v24 == -1 )
  ...
  if ( updated < 0 )
  {
    ...
    {
LABEL_13:
      if ( (_InterlockedExchangeAdd64((volatile signed __int64 *)&stru_140C47FB0, 0xFFFFFFFFFFFFFFFFuLL) & 6) == 2 )
        ExfTryToWakePushLock((volatile signed __int64 *)&stru_140C47FB0);
      KeAbPostRelease((ULONG_PTR)&stru_140C47FB0);
      if ( v20 )
        RtlpFcBufferManagerDereferenceBuffers((__int64)qword_140C48010, v20);
      goto LABEL_23;
    }
  ...
  RtlpFcBufferManagerDereferenceBuffers((__int64)qword_140C48010, v7);
  ExAcquirePushLockExclusiveEx((ULONG_PTR)&RunOnce, 0LL);
  v15 = (struct _DMA_ADAPTER *)qword_140C48000;
  qword_140C48000 = (__int64)DmaAdapter;
  DmaAdapter = v15;
  qword_140C48008 = v23;
  qword_140C47FF8 = v10;
  RtlpFcBufferManagerUpdateBuffers(qword_140C48010, v8, (__int64)v28);
  RtlpFcWriteHighLowHigh((__int64)&qword_140C47FB8, v8);
