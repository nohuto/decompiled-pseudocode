/*
 * XREFs of WdipSemLoadScenarioTable @ 0x1407AA224
 * Callers:
 ...
 *     VerSetConditionMask @ 0x14037F020 (VerSetConditionMask.c)
 ...
 *     WdipSemUpdateProviderEntriesForScenario @ 0x1407AAD44 (WdipSemUpdateProviderEntriesForScenario.c)
 *     WdipSemUpdateProviderTableWithScenario @ 0x1407AAE20 (WdipSemUpdateProviderTableWithScenario.c)
...
LABEL_16:
        if ( (int)WdipSemOpenRegistryKey(L"Instrumentation") >= 0 )
        {
          ...
          while ( 1 )
          {
            ...
            if ( (unsigned int)dword_140C1C840 >= 0x40 )
              break;
            v10 = dword_140C1C200;
