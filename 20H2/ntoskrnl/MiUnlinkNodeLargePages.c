/*
 * XREFs of MiUnlinkNodeLargePages @ 0x1403F594C
 * Callers:
...
LABEL_85:
    ...
    {
      if ( !(unsigned int)MiUnlinkNodeLargePageHelper(v97, (__int64 *)v57, v46, v48, v10) )
        goto LABEL_85;
      if ( (v10 & 0x20) != 0 )
  ...
  if ( v94 && (v10 & 0x40) == 0 && a6 != *(unsigned __int8 *)(v94 + 34) >> 6 )
  {
    ...
    do
    {
      if ( a9 )
        ...
        v79 = (_QWORD *)*v78;
      MiChangePageAttributeContiguous((__int64)(v78 + 0xB000000000LL) / 48, v77, a6, (__int64)v70);
      v98 = v78[2];
