/*
 * XREFs of SdbpFindNextIndexedWildCardTag @ 0x14074CA2C
 * Callers:
 ...
 *     AslStringPatternMatchA @ 0x140752B3C (AslStringPatternMatchA.c)
 *     SdbpKeyToAnsiString @ 0x140752C08 (SdbpKeyToAnsiString.c)
