/*
 * XREFs of sub_140964A5C @ 0x140964A5C
 * Callers:
...
__int64 __fastcall sub_140964A5C(__int64 a1, __int64 a2, __int64 a3, __int64 a4)
{
      ...
      if ( v49 > 8 )
      {
        ...
        if ( v49 > 9 )
        {
          ...
          if ( v65 )
            v66 = v42 + 1;
          if ( qword_140D2D458 )
            v67 = qword_140D2D458(v7, P, v48, v55, v54, v61, v60, v66, v65);
          else
            v67 = -1073741637;
          v8 = v67;
          if ( v67 < 0 )
