/*
 * XREFs of MiUpdateForkMaps @ 0x140559CD0
 * Callers:
...
ULONG_PTR __fastcall MiUpdateForkMaps(__int64 *a1, __int64 a2, __int64 a3, _QWORD *a4, __int64 a5, char a6)
{
  ...
  v29 = 0LL;
  v30 = 0LL;
  NextPageTable = MiGetNextPageTable(a2, a3, 0LL, a6, 4u, &v31);
  v28 = NextPageTable;
  v9 = NextPageTable;
  if ( !NextPageTable )
    return a3 + 8;
  ...
  else
  {
    if ( ((v9 ^ a1[6]) & 0xFFFFFFFFFFFFF000uLL) != 0 )
    {
      ...
      do
      {
        v20 = (__int64 *)(MiMapSinglePage(a1[7], v17, 1073741856, 0) + 8LL * ((*(_DWORD *)v15 >> 3) & 0x1FF));
      ...
      while ( v27 );
      v13 = MiMapSinglePage(a1[7], v17, 1073741856, 0);
      v9 = v28;
      a1[4] = v13;
      a1[8] = v19;
    }
