/*
 * XREFs of IopTrackLink @ 0x14069FC10
 * Callers:
 ...
 *     RtlULongSub @ 0x1402F0F2C (RtlULongSub.c)
 *     IoGetTransactionParameterBlock @ 0x1402F0F50 (IoGetTransactionParameterBlock.c)
        ...
        if ( *(_QWORD *)PoolWithQuota_0 )
        {
          ...
          if ( *(_QWORD *)PoolWithQuota_0 )
          {
            if ( (v9->DeviceObject->Characteristics & 0x10) != 0 )
            {
              ...
              if ( v13 < 0 )
                goto LABEL_14;
              IopMarshalIds(Src, v35, v37, PoolWithQuota_0);
              v16 = a5;
...
LABEL_78:
        ...
        v34 = v35[5];
        LOBYTE(v32) = _mm_cvtsi128_si32((__m128i)v35[3]) & 0xFE;
        v23 = IopSendMessageToTrackService(v36, &v31, PoolWithQuota_0);
      }
      v13 = v23;
      goto LABEL_14;
    }
