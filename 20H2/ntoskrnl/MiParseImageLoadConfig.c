/*
 * XREFs of MiParseImageLoadConfig @ 0x14070DC30
 * Callers:
...
__int64 __fastcall MiParseImageLoadConfig(__int64 a1, char *a2, unsigned int a3, __int64 *a4, __int64 a5, __int64 a6)
{
  ...
  _DWORD v27[3]; // [rsp+84h] [rbp-2F4h] BYREF
...
LABEL_7:
          ...
          if ( v18 + v14 > v18 && v18 + v14 <= *((_DWORD *)a4 + 4) )
          {
            ...
            MiLogRelocationRva(*((_DWORD *)a4 + 24), v14, v10, *(__int64 *)&v27[1]);
            *(_QWORD *)Src = v39;
            *(_QWORD *)&Src[2] = v10;
            *(_QWORD *)&Src[4] = v40;
            *(_QWORD *)&Src[6] = v28;
...
LABEL_21:
                  ...
                  if ( v22 >= 0 )
                  {
                    v25 = MiCaptureRetpolineRelocationTables((_DWORD)a2, a3, v23, v27[0], (__int64)&Src[24]);
