...
__int64 __fastcall PopBatteryApplyCompositeState(_DWORD *a1, int a2)
{
  ...
  if ( byte_140C235D8 )
  {
    ...
    v25 = 0LL;
    v6 = 0LL;
    while ( (__int64 *)v24 != &qword_140C235E0 )
    {
      v26 = *(_DWORD *)(v24 + 104);
      if ( v26 == 2 )
      {
    ...
    if ( PopCachedValidBatteryCount == -1 || PopCachedValidBatteryCount != dword_140C235D4 )
    {
      ...
      PopDiagTraceBatteryCountChange((unsigned int)dword_140C235D4, v6, v25, &qword_140C235E0);
    }
    v37 = 1;
  }
  ...
  do
  {
    ...
    if ( (unsigned __int8)PopBatteryCheckTrigger(v18) )
    {
      if ( PopBatteryCachedFlags[v15] != v17 )
      {
        ...
        v12 = v38;
        if ( dword_140C236EC[6 * v38] == 128 )
        {
          PopDiagTraceBatteryTriggerMet(0x140000000LL + 24LL * v38 + 12728040, (char *)PopPolicy + 24 * v38 + 96, &v38);
          v12 = v38;
        }
      }
      if ( !byte_140C236E0 )
  ...
  if ( dword_140C235D4 )
  {
    ...
    *((_QWORD *)&xmmword_140C237B0 + 1) = unk_140C23628;
    BYTE3(xmmword_140C237A0) = byte_140C23748 != 0 || (unk_140C23600 & 2) != 0;
  }
  PopAccountCbEnergyChange();
  PopReleaseRwLock((ULONG_PTR)&xmmword_140C23790);
  if ( v40 )
  {
    v39 = (dword_140C2374C + 500) / 0x3E8u;
    PopSetPowerSettingValueAcDc(&GUID_BATTERY_PERCENTAGE_REMAINING, 4u, &v39);
    PopAcquireRwLockExclusive((ULONG_PTR)&PopBsdUpdateLock);
    ...
    if ( dword_140C2374C == -1 )
      v32 = (MEMORY[0xFFFFF78000000008] - qword_140C23750 + 5000) / 0x2710uLL;
    if ( PopPlatformAoAc )
    {
