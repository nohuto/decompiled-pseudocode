/*
 * XREFs of PopBatteryApplyCompositeState @ 0x14077BE3C
 * Callers:
 ...
 *     PopSqmCreateDwordStreamEntry @ 0x14057D890 (PopSqmCreateDwordStreamEntry.c)
...
__int64 __fastcall PopBatteryApplyCompositeState(_DWORD *a1, int a2)
{
  ...
  if ( byte_140C235D8 )
  {
    PopSetPowerSettingValueAcDc(&GUID_BATTERY_COUNT, 4u, &dword_140C235D4);
    v27 = qword_140C235E0;
    v28 = 0LL;
    v6 = 0LL;
    while ( (__int64 *)v27 != &qword_140C235E0 )
    {
      v29 = *(_DWORD *)(v27 + 104);
      if ( v29 == 2 )
      {
    ...
    v7 = (unsigned int)dword_140C235D4;
    if ( PopCachedValidBatteryCount == -1 || PopCachedValidBatteryCount != dword_140C235D4 )
    {
      PopCachedValidBatteryCount = dword_140C235D4;
      PopDiagTraceBatteryCountChange((unsigned int)dword_140C235D4, v6, v28, &qword_140C235E0);
    }
    v43 = 1;
  }
  PopReleasePolicyLock(v7, v6);
  PopBatteryCheckCompositeCapacity(a1, v5, &v46);
  if ( ((unk_140C23600 ^ *(_BYTE *)a1) & 0xF) != 0 || byte_140C235D8 )
  {
  ...
  if ( qword_140C23620
    && (unsigned __int8)PopBatteryCheckTriggerAllBatteries(&unk_140C236E8, 1LL)
    && (dword_140C236EC[0] & 2) == 0 )
  {
  ...
  v12 = 0;
  v13 = 0;
  v14 = dword_140C235D4 != 0 ? 3 : 0;
  do
  {
    v15 = v13;
    v16 = 3LL * v13;
    v17 = dword_140C236EC[6 * v13];
    v18 = 0x140000000LL + 24LL * v13 + 12728040;
    if ( (unsigned __int8)PopBatteryCheckTrigger(v18) )
    {
      if ( PopBatteryCachedFlags[v15] != v17 )
      {
        ...
        v12 = v44;
        if ( dword_140C236EC[6 * v44] == 128 )
        {
          PopDiagTraceBatteryTriggerMet(0x140000000LL + 24LL * v44 + 12728040, (char *)PopPolicy + 24 * v44 + 96, &v44);
          v12 = v44;
        }
      }
      if ( !byte_140C236E0 )
        PopExecutePowerAction(
          0x140000000LL + 24LL * v12 + 12728040,
          8u,
    ...
    else
    {
      ...
      dword_140C236EC[2 * v16] = v17 & 0xFFFFFFFC;
  ...
  if ( dword_140C2363C != v14 )
  {
    ...
    if ( (unsigned int)dword_140C021E8 > 5 )
    {
      ...
      tlgWriteTransfer_EtwWriteTransfer(
        ...
        (unsigned __int8 *)byte_140028A38,
        0LL,
        0LL,
        4u,
        &v56);
    ...
    if ( (unsigned int)(v14 - 1) <= 1 != (unsigned int)(dword_140C2363C - 1) <= 1
      && v31 > 5
      && tlgKeywordOn((__int64)&dword_140C021E8, 0x400000000000LL) )
    {
      ...
      tlgWriteTransfer_EtwWriteTransfer(
        (__int64)&dword_140C021E8,
        (unsigned __int8 *)&dword_140028A7C,
        0LL,
        0LL,
        4u,
        &v51);
  ...
  PopAcquireRwLockExclusive((ULONG_PTR)&xmmword_140C23790);
  LOBYTE(v24) = unk_140C23600;
  xmmword_140C237A0 = 0LL;
  BYTE7(xmmword_140C237A0) = dword_140C23638;
  xmmword_140C237B0 = 0LL;
  LOBYTE(xmmword_140C237A0) = unk_140C23600 & 1;
  if ( dword_140C235D4 )
  {
    BYTE1(xmmword_140C237A0) = 1;
    BYTE2(xmmword_140C237A0) = (unk_140C23600 & 4) != 0;
    LOBYTE(v24) = byte_140C23748 != 0 || (unk_140C23600 & 2) != 0;
    DWORD2(xmmword_140C237A0) = HIDWORD(qword_140C23620);
    HIDWORD(xmmword_140C237A0) = unk_140C23604;
    *(_QWORD *)&xmmword_140C237B0 = qword_140C2360C;
    *((_QWORD *)&xmmword_140C237B0 + 1) = unk_140C23628;
    BYTE3(xmmword_140C237A0) = v24;
  }
  PopAccountCbEnergyChange(v24, v22, v23);
  PopReleaseRwLock((ULONG_PTR)&xmmword_140C23790);
  if ( v46 )
  {
    v45 = (dword_140C2374C + 500) / 0x3E8u;
    PopSetPowerSettingValueAcDc(&GUID_BATTERY_PERCENTAGE_REMAINING, 4u, &v45);
    PopAcquireRwLockExclusive((ULONG_PTR)&PopBsdUpdateLock);
    ...
    if ( dword_140C2374C == -1 )
      v35 = (MEMORY[0xFFFFF78000000008] - qword_140C23750 + 5000) / 0x2710uLL;
    if ( PopPlatformAoAc )
    {
