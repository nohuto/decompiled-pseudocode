/*
 * XREFs of MiAllocateMdlPagesByLists @ 0x140374584
 * Callers:
...
LABEL_21:
    ...
    *v33++ = v21;
    ...
    v28 = ((unsigned int)MiGetPfnChannel(v22) << byte_140C4DD0D) | dword_140C4DD78 & v21 | (v27 << byte_140C4DD0C);
    v14 = v28 & ~dword_140C4DD00 | dword_140C4DD00 & (v28 + 1);
    v31 = v14;
    if ( v8 >= a6 )
      goto LABEL_21;
    v19 = v39;
