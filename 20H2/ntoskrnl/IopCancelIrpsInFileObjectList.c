/*
 * XREFs of IopCancelIrpsInFileObjectList @ 0x14031892C
 * Callers:
 ...
 *     IopCheckListForCancelableIrp @ 0x140318AC8 (IopCheckListForCancelableIrp.c)
...
__int64 __fastcall IopCancelIrpsInFileObjectList(__int64 a1, int a2, int a3, int a4, char a5, char a6)
{
  ...
  while ( 1 )
  {
    ...
    if ( !(unsigned int)IopInterlockedAdd((volatile signed __int64 *)&v15->Overlay, -1) )
      IoFreeIrp(v15);
    v8 = a4;
    if ( (_QWORD *)Flink == v11 )
    {
