/*
 * XREFs of ?RtlStringCbCopyUnicodeString@@YAJPEAG_KPEBU_UNICODE_STRING@@@Z @ 0x14059BD0C
 * Callers:
 *     SmKmKeyGenStart @ 0x14092E4A0 (SmKmKeyGenStart.c)
 * Callees:
 *     RtlUnicodeStringValidateSrcWorker @ 0x14059BDC8 (RtlUnicodeStringValidateSrcWorker.c)
 */
