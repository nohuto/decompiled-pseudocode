/*
 * XREFs of MiCombineCandidate @ 0x1403694F0
 * Callers:
...
__int64 __fastcall MiCombineCandidate(_QWORD *a1, char a2, __int128 *a3)
{
  ...
  if ( (BYTE2(v4) & 7u) <= 1 )
    return 0LL;
  v5 = *((_QWORD *)&v19 + 1);
  if ( *(_QWORD *)(qword_140C4E4C8 + 8 * ((*((_QWORD *)&v21 + 1) >> 39) & 0x3FFLL)) != *a1 && (a2 & 1) == 0 )
    return 0LL;
  if ( (unsigned int)MI_PFN_IS_PROTO(&v19)
    ...
    && (BYTE3(v21) & 0x20) != 0
    || byte_140C51EDE
    && _bittest64((const signed __int64 *)qword_140C52408, (unsigned __int64)((v7 + 0x58000000000LL) / 48) >> 9) )
  {
    return 0LL;
  }
  v8 = v20;
  ...
  v22 = v8;
  if ( (v8 & 1) != 0 || v8 && qword_140C4DDC0 && (qword_140C4DDC0 & v8) == 0 )
    return 0LL;
  v13 = (v8 >> 5) & 0x1F;
  if ( (_DWORD)v13 == 24
    || (_DWORD)v13 == 31
    ...
    || (unsigned int)MiGetPagePrivilege((ULONG_PTR)&v19, 0, 0LL) )
  {
    return 0LL;
  }
  v14 = (__int64)(v5 << 25) >> 16;
  if ( v14 >= 0xFFFF800000000000uLL )
    v15 = (unsigned __int8)byte_140C4F848[((v14 >> 39) & 0x1FF) - 256];
  else
    v15 = 0;
