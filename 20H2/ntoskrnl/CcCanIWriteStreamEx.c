/*
 * XREFs of CcCanIWriteStreamEx @ 0x14029AAB0
 * Callers:
...
LABEL_27:
      ...
      if ( (_BYTE)dword_140CFB19C )
        v26 = 0x4000LL;
      if ( qword_140C527C0 < v26 )
      {
        v30 = (unsigned __int16 **)&unk_140C51C68;
        while ( 1 )
        {
          v45 = *v30;
          if ( dword_140C4DD7C )
...
LABEL_96:
          ++v30;
          v7 = 0;
          if ( (__int64)v30 > (__int64)&qword_140C51C70 )
          {
            if ( qword_140C52940 < (unsigned __int64)(qword_140C529B0 + 800) )
