/*
 * XREFs of KiEmulateAtlThunk @ 0x140524EF0
 * Callers:
 *     KiCheckForAtlThunk @ 0x140522A64 (KiCheckForAtlThunk.c)
 * Callees:
...
__int64 __fastcall KiEmulateAtlThunk(unsigned int *a1, _DWORD *a2, unsigned int *a3, unsigned int *a4, _DWORD *a5)
{
  ...
  v23 = (unsigned int)*a2;
  v22 = 0;
  v11 = (_WORD *)&KeGetPcr()->NtTib.$291CBC43A21EE7E4F58DE30F5474C31B::$F973CBAF4608634B0F908ADAEF96F715::Self[218].SubSystemTib
      + 1;
  if ( (*v11 & 1) != 0 )
  {
    v12 = 1;
