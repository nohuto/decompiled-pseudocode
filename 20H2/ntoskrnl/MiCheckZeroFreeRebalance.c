/*
 * XREFs of MiCheckZeroFreeRebalance @ 0x1402310F0
 * Callers:
...
unsigned __int64 __fastcall MiCheckZeroFreeRebalance(__int64 a1, unsigned int a2)
{
  ...
  v19 = a2 >> byte_140C4DD0C;
  v3 = *(_QWORD *)(a1 + 16) + 4544LL * (a2 >> byte_140C4DD0C);
  v18 = 0;
  if ( (unsigned int)MmNumberOfChannels > 1 )
    v18 = (unsigned __int16)(unsigned __int8)MiChannelMaximumPowerOf2Mask & (unsigned __int16)(a2 >> byte_140C4DD0D);
  v4 = (__int64 *)(v3 + 4128);
  result = 0LL;
  v6 = 0;
  for ( i = 0LL; i <= 1; ++i )
  ...
  if ( result < 0x200 )
  {
    ...
    if ( result >= 0x1000 && !*(_QWORD *)(a1 + 6320) )
    {
      ...
      if ( (result & 1) == 0 )
      {
        KeAcquireInStackQueuedSpinLock(&qword_140C4E480, &LockHandle);
        ...
        {
          v11 = 0;
          if ( (unsigned __int8)PsReferencePartitionSafe(*(_QWORD *)(a1 + 176)) )
          {
            *(_QWORD *)(a1 + 6304) = 0LL;
        ...
        __writecr8(OldIrql);
        if ( v11 == 1 )
          return ExQueueWorkItemToPartition(a1 + 6304);
      }
    }
  }
  return result;
