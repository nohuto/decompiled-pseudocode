/*
 * XREFs of PsGetThreadProperty @ 0x1402F6900
 * Callers:
 *     <none>
 * Callees:
 *     ObpIncrPointerCount @ 0x14027E460 (ObpIncrPointerCount.c)
 *     PsGetJobProperty @ 0x1402F6B00 (PsGetJobProperty.c)
...
PVOID __stdcall PsGetThreadProperty(PETHREAD Thread, ULONG_PTR Key, ULONG Flags)
{
  ...
  if ( (Flags & 0xFFFFFFFE) != 0
    ...
    || KeGetCurrentIrql() < 2u
    && (POBJECT_TYPE *)ObTypeIndexTable[(unsigned __int8)ObHeaderCookie ^ LOBYTE(Thread[-1].EndPadding[2]) ^ (unsigned __int64)(unsigned __int8)((unsigned __int16)((_WORD)Thread - 48) >> 8)] != PsThreadType
