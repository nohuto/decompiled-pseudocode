/*
 * XREFs of NormBuffer__IsBlocked @ 0x14058C2D8
 * Callers:
 *     Normalization__NormalizeCharacter @ 0x14091ADD0 (Normalization__NormalizeCharacter.c)
 * Callees:
 *     NormBuffer__GetCurrentOutputChar @ 0x14058C130 (NormBuffer__GetCurrentOutputChar.c)
 *     Normalization__PageLookup @ 0x14091B5E8 (Normalization__PageLookup.c)
 *     Normalization__TableLookup @ 0x14091B600 (Normalization__TableLookup.c)
 */
