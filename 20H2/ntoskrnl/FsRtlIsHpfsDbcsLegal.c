/*
 * XREFs of FsRtlIsHpfsDbcsLegal @ 0x14088F690
 * Callers:
 *     FsRtlIsHpfsDbcsLegal @ 0x14088F690 (FsRtlIsHpfsDbcsLegal.c)
 * Callees:
 *     FsRtlDissectDbcs @ 0x14088EF10 (FsRtlDissectDbcs.c)
 *     FsRtlIsHpfsDbcsLegal @ 0x14088F690 (FsRtlIsHpfsDbcsLegal.c)
 */
          ...
          do
          {
            ...
            if ( (unsigned __int8)v13 >= 0x80u && (_BYTE)NlsMbOemCodePageTag && NlsOemLeadByteInfoTable[v13] )
            {
              ...
              ++v12;
                   ...
                   && ((WildCardsPermissible != 0 ? 10 : 2) & *((unsigned __int8 *)qword_140011610 + v13)) == 0 )
            {
              return 0;
            }
            ++v12;
