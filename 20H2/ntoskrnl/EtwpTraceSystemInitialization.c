/*
 * XREFs of EtwpTraceSystemInitialization @ 0x140A691C4
 * Callers:
...
char EtwpTraceSystemInitialization()
{
  ...
  {
    v28 = KeBootTime;
    if ( (unsigned int)dword_140C02B78 > 5 && tlgKeywordOn((__int64)&dword_140C02B78, 0x800000000000LL) )
    {
      ...
      *(_QWORD *)&v30 = v7;
      ...
      tlgWriteTransfer_EtwWriteTransfer(
        ...
        (unsigned __int8 *)&dword_14002B9AC,
        0LL,
        0LL,
        0xCu,
        &v47);
    ...
    if ( (_BYTE)Version )
    {
      ...
      {
        LOBYTE(Version) = tlgKeywordOn((__int64)&dword_140C02B78, 0x400000000000LL);
        if ( (_BYTE)Version )
        {
          LOBYTE(v17) = v12;
          ...
          LOBYTE(Version) = tlgWriteTransfer_EtwWriteTransfer(
                              (__int64)&dword_140C02B78,
                              (unsigned __int8 *)&dword_14002B977,
                              0LL,
                              0LL,
                              4u,
                              &v68);
