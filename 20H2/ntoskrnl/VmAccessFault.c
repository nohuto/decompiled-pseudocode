        ...
        __int64 a7)
{
  ...
  if ( a3 > 0x10 || v11[1] > 0x10 )
  {
    ...
    {
      ++dword_140CEE918;
      v7 = (PSLIST_ENTRY)((__int64 (__fastcall *)(_QWORD, _QWORD, _QWORD, _SLIST_HEADER *))qword_140CEE930)(
...
LABEL_30:
  if ( v7 )
  {
    ...
    {
      ++dword_140CEE920;
      ((void (__fastcall *)(PSLIST_ENTRY, _SLIST_HEADER *))qword_140CEE938)(v7, &VmpLargeFaultBatchLookasideList);
    }
  }
