/*
 * XREFs of VmAccessFault @ 0x140931190
 * Callers:
 *     <none>
 * Callees:
        ...
        __int64 a7)
{
  ...
  if ( a3 > 0x10 || v11[1] > 0x10 )
  {
    ...
    {
      ++dword_140CEE918;
      v7 = (PSLIST_ENTRY)((__int64 (__fastcall *)(_QWORD, _QWORD, _QWORD, union _SLIST_HEADER *))qword_140CEE930)(
                           (unsigned int)dword_140CEE924,
                           (unsigned int)dword_140CEE92C,
                           (unsigned int)dword_140CEE928,
...
LABEL_30:
  ...
  {
    ++dword_140CEE91C;
    if ( LOWORD(VmpLargeFaultBatchLookasideList.Alignment) < (unsigned __int16)word_140CEE910 )
    {
    ...
    {
      ++dword_140CEE920;
      ((void (__fastcall *)(PSLIST_ENTRY, union _SLIST_HEADER *))qword_140CEE938)(v7, &VmpLargeFaultBatchLookasideList);
    }
  }
