/*
 * XREFs of ViThunkRecoverPristines @ 0x1409DC1A4
 * Callers:
 *     VfThunkAddSpecialDriverThunks @ 0x1409DB8C4 (VfThunkAddSpecialDriverThunks.c)
 * Callees:
 *     ViThunkReplacePristine @ 0x1409DC698 (ViThunkReplacePristine.c)
 *     ViThunkReplaceSpecialPristine @ 0x1409DC780 (ViThunkReplaceSpecialPristine.c)
 */
