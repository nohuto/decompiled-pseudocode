/*
 * XREFs of MiAddPrivateFixupEntryForSystemImage @ 0x1403A5018
 * Callers:
...
LABEL_7:
  ...
  v7 = ExAcquireSpinLockExclusive(&dword_140C4CB64);
  v8 = (_QWORD *)qword_140C4CB48;
  if ( *(__int64 **)qword_140C4CB48 != &qword_140C4CB40 )
    __fastfail(3u);
  *v5 = &qword_140C4CB40;
  v5[1] = v8;
  *v8 = v5;
  qword_140C4CB48 = (__int64)v5;
  ExReleaseSpinLockExclusiveFromDpcLevel(&dword_140C4CB64);
  if ( KiIrqlFlags )
  {
    if ( (KiIrqlFlags & 1) != 0 )
    {
