/*
 * XREFs of MiUnmapRetpolineStubs @ 0x140542748
 * Callers:
...
__int64 __fastcall MiUnmapRetpolineStubs(__int64 a1, int a2)
{
  ...
  v7 = AnyMultiplexedVm;
  v8 = v5 + ((((unsigned int)dword_140C4CB30 >> 12) + v6 + ((dword_140C4CB30 & 0xFFF) != 0)) << 12);
  v27 = v8;
  v9 = qword_140C4CAD0;
  ...
  if ( dword_140C4CB08 )
  {
    while ( 1 )
    {
      ...
      if ( v3 )
      {
        if ( (v14 & 0xFFF) != 0 )
          goto LABEL_9;
        MiFlushTbList((unsigned int *)v29, v12);
...
LABEL_16:
      ...
      if ( (unsigned int)v11 >= dword_140C4CB08 )
      {
        v13 = v25;
        break;
      }
