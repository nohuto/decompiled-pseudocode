/*
 * XREFs of EtwpNotifyGuid @ 0x1407181E8
 * Callers:
 ...
 *     EtwpValidateTraceControlFilterDescriptors @ 0x14094351C (EtwpValidateTraceControlFilterDescriptors.c)
...
__int64 __fastcall EtwpNotifyGuid(__int64 a1, __int64 a2, char a3)
{
  ...
  *(_DWORD *)(a2 + 20) = 0;
  ...
  if ( *(_BYTE *)(a2 + 12) )
  {
    v9 = EtwpCreateUmReplyObject((ULONG_PTR)v16, &v32, &DmaAdapter);
    if ( v9 < 0 )
      goto LABEL_53;
