/*
 * XREFs of ViDeadlockAnalyze @ 0x1409E1BA4
 * Callers:
 ...
 *     ViDeadlockAddParticipant @ 0x1409E1814 (ViDeadlockAddParticipant.c)
 *     ViDeadlockAnalyze @ 0x1409E1BA4 (ViDeadlockAnalyze.c)
 *     ViDeadlockCertify @ 0x1409E1E8C (ViDeadlockCertify.c)
...
__int64 __fastcall ViDeadlockAnalyze(ULONG_PTR a1, ULONG_PTR a2, int a3, unsigned int a4, __int64 a5)
{
  ...
  if ( a3 )
  {
    ...
    *((_QWORD *)v9 + 4107) = 0LL;
    if ( v10 )
      ViDeadlockState |= 8u;
    KeQueryCurrentStackInformation((char *)v9 + 33132, (struct _KPRCB **)v9 + 4142, (unsigned __int64 *)v9 + 4143);
    a4 = v21;
  }
    ...
    if ( (unsigned int)ViDeadlockCertify(a5, a2) )
    {
      *((_QWORD *)ViDeadlockGlobals + 4107) = a1;
      ViDeadlockPreprocessOptions(
        ...
        a2,
        0LL);
      VfReportIssueWithOptions(0xC4u, 0x1001uLL, a1, a2, 0LL, byte_140C12D94);
      return 0LL;
    }
    v8 = 0;
    goto LABEL_30;
