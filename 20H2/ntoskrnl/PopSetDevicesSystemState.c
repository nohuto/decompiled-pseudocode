/*
 * XREFs of PopSetDevicesSystemState @ 0x140993BF4
 * Callers:
...
__int64 PopSetDevicesSystemState()
{
  ...
  v3 = byte_140C23302;
  v5 = byte_140C2331C;
  v2[0] = dword_140C2332C;
  v2[1] = dword_140C23328;
  v0 = dword_140C23320;
  if ( (dword_140C2330C & 8) != 0 )
    v0 = 6;
  v2[5] = dword_140C2330C;
  v2[2] = v0;
  v2[3] = dword_140C23324;
  v2[4] = qword_140C23304;
  v6 = 0;
