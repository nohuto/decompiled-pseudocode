/*
 * XREFs of KeSetSelectedCpuSetsThread @ 0x14051B100
 * Callers:
 ...
 *     KiGetThreadCpuSetMaskPointer @ 0x14033D5B0 (KiGetThreadCpuSetMaskPointer.c)
...
__int64 __fastcall KeSetSelectedCpuSetsThread(__int64 a1, unsigned int a2, char *a3)
{
  ...
  _SINGLE_LIST_ENTRY v45[6]; // [rsp+28h] [rbp-30h] BYREF
    ...
    else
    {
      ...
      if ( v24->NextThread )
      {
        ...
        *(_BYTE *)(CurrentThread + 390) = CurrentIrql;
        KiQueueReadyThread((__int64)v24, CurrentThread, v35);
