/*
 * XREFs of KiIntSteerChooseInitialTargetProcessors @ 0x140377B84
 * Callers:
 ...
 *     KeIntSteerGetSteeringMode @ 0x140377C90 (KeIntSteerGetSteeringMode.c)
