/*
 * XREFs of VfDeadlockAcquireResource @ 0x1409E05D8
 * Callers:
 *     VerifierKeAcquireInStackQueuedSpinLock @ 0x1409DD510 (VerifierKeAcquireInStackQueuedSpinLock.c)
 *     VerifierKeAcquireInStackQueuedSpinLockAtDpcLevel @ 0x1409DD560 (VerifierKeAcquireInStackQueuedSpinLockAtDpcLevel.c)
 ...
 *     VerifierKeAcquireSpinLockRaiseToDpc @ 0x1409DDA10 (VerifierKeAcquireSpinLockRaiseToDpc.c)
 *     VerifierKeInitializeMutant @ 0x1409DDBE0 (VerifierKeInitializeMutant.c)
 *     VerifierKeTryToAcquireSpinLockAtDpcLevel @ 0x1409DE870 (VerifierKeTryToAcquireSpinLockAtDpcLevel.c)
 *     ViKeObjectAcquired @ 0x1409DF214 (ViKeObjectAcquired.c)
 ...
 *     VerifierExAcquireFastMutexUnsafe @ 0x1409E7850 (VerifierExAcquireFastMutexUnsafe.c)
 *     VerifierExTryToAcquireFastMutex @ 0x1409E7A40 (VerifierExTryToAcquireFastMutex.c)
 * Callees:
 ...
 *     ViDeadlockAddThread @ 0x1409E1A88 (ViDeadlockAddThread.c)
 ...
 *     ViDeadlockCheckDuplicatesAmongChildren @ 0x1409E20B0 (ViDeadlockCheckDuplicatesAmongChildren.c)
 *     ViDeadlockCheckDuplicatesAmongRoots @ 0x1409E2130 (ViDeadlockCheckDuplicatesAmongRoots.c)
 ...
 *     ViDeadlockSearchResource @ 0x1409E2D40 (ViDeadlockSearchResource.c)
 *     ViDeadlockSearchThread @ 0x1409E2DE8 (ViDeadlockSearchThread.c)
 *     ViDeadlockSimilarNode @ 0x1409E2E78 (ViDeadlockSimilarNode.c)
 *     ViDeadlockUpdateChildrenCount @ 0x1409E2F24 (ViDeadlockUpdateChildrenCount.c)
    ...
    if ( *v19 != (_DWORD)v6 )
    {
      if ( ((unsigned int)(v6 - 3) > 1 || (unsigned int)(v21 - 3) > 1) && (v21 != 7 || (unsigned int)(v6 - 5) > 1) )
      {
        ViDeadlockPreprocessOptions(
          ...
          (const void *)0x1008);
        VfReportIssueWithOptions(0xC4u, 0x1008uLL, a1, *v19, v6, byte_140C12D90);
        goto LABEL_35;
      }
      *v19 = v6;
    }
    ...
    if ( v22 )
    {
      if ( v24 > 1u )
      {
        ...
        ViDeadlockPreprocessOptions(
          ...
          (const void *)0x1000);
        VfReportIssueWithOptions(0xC4u, 0x1000uLL, a1, (ULONG_PTR)v19, v10, &dword_140C12D78);
LABEL_35:
        v15 = v46;
        v16 = 0;
        goto LABEL_52;
