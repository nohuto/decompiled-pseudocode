/*
 * XREFs of HalDmaAllocateCrashDumpRegistersEx @ 0x1403A5AC0
 * Callers:
 *     <none>
 * Callees:
...
LABEL_9:
  ...
  if ( v5 != (__int64 *)a1 )
  {
    v13 = (_QWORD *)qword_140C4BD68;
    v14 = (_QWORD *)(a1 + 280);
    if ( *(__int64 **)qword_140C4BD68 != &HalpDmaHibernateAdapters )
      __fastfail(3u);
    *v14 = &HalpDmaHibernateAdapters;
    v14[1] = v13;
    *v13 = v14;
    qword_140C4BD68 = (__int64)v14;
  }
  return 0LL;
}
