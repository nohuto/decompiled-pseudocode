/*
 * XREFs of MiResetAccessBitPte @ 0x14039AF20
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall MiResetAccessBitPte(__int64 a1, unsigned __int64 a2, int a3)
{
  ...
  if ( !v17 || (unsigned __int64)((__int64)(a2 << 25) >> 16) > 0x7FFFFFFEFFFFLL )
  {
    ...
    if ( VaAge == 7 && (unsigned int)MiGetPfnPriority((__int64)v15) < dword_140C4E6AC )
    {
      v20 = 0;
    }
    else
    ...
    if ( (*(_DWORD *)(v21 + 12) >= *(_DWORD *)(v21 + 8) || *(_BYTE *)(v21 + 5) || *(_QWORD *)(v21 + 16) > v22)
      ...
      && !*(_BYTE *)(v21 + 5) )
    {
      MiFlushTbList((unsigned int *)v21, (_KPROCESS *)v22);
    }
    return 0LL;
  }
