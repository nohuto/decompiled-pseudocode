/*
 * XREFs of KiAbForceProcessLockEntry @ 0x14038F584
 * Callers:
...
unsigned __int8 __fastcall KiAbForceProcessLockEntry(unsigned __int8 *a1)
{
  ...
  unsigned __int64 LockedHeadEntry; // rax
  __int64 v6; // rdi
  ...
  _DWORD *v33; // r8
  int v34; // eax
  _SINGLE_LIST_ENTRY v35; // [rsp+30h] [rbp-20h] BYREF
  ...
  LockedHeadEntry = KiAbEntryGetLockedHeadEntry((unsigned __int64)a1, 1, &LockHandle);
  v6 = LockedHeadEntry;
  if ( LockedHeadEntry )
  {
    if ( (a1[25] & 1) == 0 )
...
LABEL_4:
    ...
    CpuPriorityKey = KiAbEntryGetCpuPriorityKey(a1, v12, v13, v14);
...
LABEL_25:
    ...
    KiAbIoBoostOwners(v6, v16, (int)&v35, 0, (__int64)&CurrentPrcb->AbSelfIoBoostsList);
    goto LABEL_25;
  }
LABEL_5:
  ...
  if ( CurrentPrcb->NextThread )
  {
    ...
    *(_BYTE *)(CurrentThread + 390) = CurrentIrql;
    KiQueueReadyThread((__int64)CurrentPrcb, CurrentThread, v27);
