/*
 * XREFs of CmpDoFileWrite @ 0x14064F21C
 * Callers:
 *     CmpFileWrite @ 0x1406DAA70 (CmpFileWrite.c)
 ...
 *     CmpSetRespectIoPriorityThread @ 0x140244AC8 (CmpSetRespectIoPriorityThread.c)
 *     CmSiFreeMemory @ 0x140267C30 (CmSiFreeMemory.c)
 *     KeWaitForMultipleObjects @ 0x1402DCE40 (KeWaitForMultipleObjects.c)
 *     CmpSetIoPriorityThread @ 0x1403304D4 (CmpSetIoPriorityThread.c)
 *     CmpSetPriorityThread @ 0x1403304EC (CmpSetPriorityThread.c)
