...
LABEL_33:
    ...
    if ( (*((_DWORD *)Object + 20) & 2) != 0 )
    {
      ...
      if ( _InterlockedExchange(v26 + 29, 1) )
      {
        ...
        v22 = (struct _DMA_ADAPTER *)Object;
        v21 = IopWaitAndAcquireFileObjectLock((volatile signed __int32 *)Object, v27, v28, v29, v48);
      }
      else
      {
        if ( v29 )
...
LABEL_76:
    ...
    result = IopSynchronousServiceTail(RelatedDeviceObject, Irp, (__int64)v22, 0, v44, v30, 2u);
    if ( !v30 )
