/*
 * XREFs of KiGetNextTimerExpirationDueTime @ 0x140284DB0
 * Callers:
 ...
 * Callees:
 *     KiFindNextTimerDueTime @ 0x140285090 (KiFindNextTimerDueTime.c)
 *     KeIsEmptyAffinityEx @ 0x140286FE0 (KeIsEmptyAffinityEx.c)
 *     _guard_dispatch_icall @ 0x140405F40 (_guard_dispatch_icall.c)
 *     ExGetNextWakeTimeForDeepSleep @ 0x1405B46A4 (ExGetNextWakeTimeForDeepSleep.c)
 */
...
LABEL_7:
  if ( *(_BYTE *)(a1 + 33) )
  {
    ...
    do
    {
      v21 = qword_140C31B50[3 * v12];
      if ( v12 == 2 )
      {
        if ( v21 < v8 )
          v8 = qword_140C31B50[6];
      }
      else if ( v21 < v15 )
      {
        v15 = qword_140C31B50[3 * v12];
        if ( v12 == 4 )
          LOBYTE(v16) = 1;
      }
      ++v12;
