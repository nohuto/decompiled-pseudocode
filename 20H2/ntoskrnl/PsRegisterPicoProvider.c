/*
 * XREFs of PsRegisterPicoProvider @ 0x14090E430
 * Callers:
 *     <none>
 * Callees:
 *     <none>
...
__int64 __fastcall PsRegisterPicoProvider(__int64 a1, _QWORD *a2)
{
  ...
  xmmword_140C1DEB0 = *(_OWORD *)(a1 + 16);
  xmmword_140C1DEC0 = *(_OWORD *)(a1 + 32);
  xmmword_140C1DED0 = *(_OWORD *)(a1 + 48);
  xmmword_140C1DEE0 = *(_OWORD *)(a1 + 64);
  qword_140C1DEF0 = *(_QWORD *)(a1 + 80);
  PspPicoProviderRanges = _mm_srli_si128((__m128i)xmmword_140C1DED0, 8).m128i_u64[0];
