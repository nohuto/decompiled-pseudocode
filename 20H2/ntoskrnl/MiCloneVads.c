/*
 * XREFs of MiCloneVads @ 0x140557858
 * Callers:
...
__int64 __fastcall MiCloneVads(_QWORD *a1, ULONG_PTR a2, __int64 a3, __int64 a4, int a5, _DWORD *a6)
{
  _QWORD *v7; // r14
  __int64 v8; // r12
  __int64 v9; // rdi
...
LABEL_90:
    ...
    if ( v7[159] <= v10[5] )
    {
      ...
      *v14 = v78;
      ...
      if ( (unsigned int)MiInitializeForkMaps(a2, v89) )
      {
        ...
        if ( v26 )
        {
          do
          {
            ...
            v78 = (__int64)Address;
            v24 = v34 | v35;
            if ( v24 < 0x7FFFFFFFDLL && !MiIsVadLargePrivate(v28) )
            {
              ...
              do
              {
                MiFlushTbList((unsigned int *)v91, (_KPROCESS *)v24);
      ...
      if ( v74 > v80 )
        PsReturnProcessNonPagedPoolQuota(a2, v74 - v80);
      if ( (_QWORD)v90 )
        MiReturnFullProcessCommitment(a2, v90);
      if ( *((_QWORD *)&v90 + 1) )
