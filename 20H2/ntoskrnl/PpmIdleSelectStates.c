/*
 * XREFs of PpmIdleSelectStates @ 0x140395110
 * Callers:
 ...
 *     PpmCheckPreConditionsForDeepSleep @ 0x140390C1C (PpmCheckPreConditionsForDeepSleep.c)
 ...
 *     PpmIdleUpdateSelectionStatistics @ 0x1405655F8 (PpmIdleUpdateSelectionStatistics.c)
...
LABEL_9:
  ...
  *(_DWORD *)(v11 + 528) = v22;
  ...
  {
    v23 = BYTE6(PpmCurrentProfile[342 * dword_140C23D4C + 24]);
    *(_BYTE *)(v11 + 542) = v23;
    if ( v23 )
