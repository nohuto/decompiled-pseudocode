/*
 * XREFs of ExInitializeTimeRefresh @ 0x140A59BC0
 * Callers:
...
__int64 *ExInitializeTimeRefresh()
{
  ...
  qword_140C19538 = (__int64)ExpTimeRefreshDpcRoutine;
  qword_140C19558 = 0LL;
  qword_140C19540 = (__int64)&ExpOkToTimeRefresh;
  qword_140C19530 = 0LL;
  ...
  qword_140C19598 = (__int64)&ExpTimerResolutionListHead;
