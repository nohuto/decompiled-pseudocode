/*
 * XREFs of EtwpReserveTraceBuffer @ 0x140226840
 * Callers:
 ...
 *     EtwpGetTimeStampAndQpcDelta @ 0x1405A9D98 (EtwpGetTimeStampAndQpcDelta.c)
 */

unsigned __int64 __fastcall EtwpReserveTraceBuffer(unsigned int *a1, __int64 a2, __int64 a3, LARGE_INTEGER *a4, int a5)
{
  unsigned int v8; // r9d
  __int64 v9; // r8
  int v10; // r12d
...
LABEL_40:
  ...
  while ( 1 )
  {
    ...
    v11 = (_QWORD *)(*(_QWORD *)(*((_QWORD *)a1 + 135) + 4136LL) + ((unsigned __int64)Number << 6));
...
LABEL_29:
    v25 = EtwpSwitchBuffer((_DWORD)a1, v13, (_DWORD)v12, Number, a5);
    if ( (a1[3] & 0x4000000) != 0 )
    {
      ...
      while ( v33 != _InterlockedCompareExchange64((volatile signed __int64 *)a1 + 156, v34, v33) );
    }
    if ( v25 < 0 )
      goto LABEL_40;
    v9 = v36;
