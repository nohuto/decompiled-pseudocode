/*
 * XREFs of IopSetupArbiterAndTranslators @ 0x14074B25C
 * Callers:
 *     IopResourceRequirementsListToReqList @ 0x14074AC94 (IopResourceRequirementsListToReqList.c)
 * Callees:
 *     IopFindResourceHandlerInfo @ 0x14074B63C (IopFindResourceHandlerInfo.c)
 *     IopFindLegacyBusDeviceNode @ 0x14074B6CC (IopFindLegacyBusDeviceNode.c)
