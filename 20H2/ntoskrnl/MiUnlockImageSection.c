/*
 * XREFs of MiUnlockImageSection @ 0x1402F3190
 * Callers:
...
LABEL_52:
        ...
        v33 = (v31 >> 39) & 0x3FF;
        v34 = *(_QWORD *)(qword_140C4E4C8 + 8 * v33);
        if ( v32 == 1 )
          MiReturnCommit(*(_QWORD *)(qword_140C4E4C8 + 8 * v33), 1LL);
        v35 = 1LL;
...
LABEL_88:
    ...
    if ( qword_140C4CBD8 )
      result = ExpUnblockPushLock(&qword_140C4CBD8, 0LL, 0LL);
  }
  if ( !(_BYTE)CurrentIrql )
