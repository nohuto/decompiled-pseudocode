/*
 * XREFs of ExpGetSystemBasicInformation @ 0x14030BB10
 * Callers:
...
__int64 __fastcall ExpGetSystemBasicInformation(__int64 a1)
{
  ...
  *(_DWORD *)(a1 + 12) = v7;
  v8 = -1;
  if ( *(_QWORD *)(*(_QWORD *)(qword_140C4E4C8 + 8 * v2) + 6912LL) <= 0xFFFFFFFFuLL )
    v8 = *(_QWORD *)(*(_QWORD *)(qword_140C4E4C8 + 8 * v2) + 6912LL);
  *(_DWORD *)(a1 + 16) = v8;
  if ( *(_QWORD *)(*(_QWORD *)(qword_140C4E4C8 + 8 * v2) + 6920LL) <= 0xFFFFFFFFuLL )
    v6 = *(_QWORD *)(*(_QWORD *)(qword_140C4E4C8 + 8 * v2) + 6920LL);
  *(_DWORD *)(a1 + 20) = v6;
  return 0LL;
}
