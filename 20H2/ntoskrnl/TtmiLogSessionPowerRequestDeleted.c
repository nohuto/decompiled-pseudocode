/*
 * XREFs of TtmiLogSessionPowerRequestDeleted @ 0x140906950
 * Callers:
...
void TtmiLogSessionPowerRequestDeleted()
{
  ...
  if ( (unsigned int)dword_140D2D8E8 > 5 )
  {
    if ( tlgKeywordOn((__int64)&dword_140D2D8E8, 1LL) )
    {
      ...
      v6 = v2;
      v11 = 4LL;
      tlgWriteTransfer_EtwWriteTransfer((__int64)&dword_140D2D8E8, (unsigned __int8 *)word_14002A5EA, 0LL, 0LL, 5u, &v7);
    }
  }
}
