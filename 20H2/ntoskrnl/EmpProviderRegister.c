/*
 * XREFs of EmpProviderRegister @ 0x140793AF0
 * Callers:
 *     EmProviderRegister @ 0x140793A80 (EmProviderRegister.c)
 *     PoInitSystem @ 0x140A41DE0 (PoInitSystem.c)
 *     EmInitSystem @ 0x140A4633C (EmInitSystem.c)
 *     HalRegisterErrataCallbacks @ 0x140A46660 (HalRegisterErrataCallbacks.c)
 * Callees:
 ...
 *     EmpSearchCallbackDatabase @ 0x1403B30C4 (EmpSearchCallbackDatabase.c)
