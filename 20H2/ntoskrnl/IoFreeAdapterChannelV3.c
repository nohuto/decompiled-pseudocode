/*
 * XREFs of IoFreeAdapterChannelV3 @ 0x1404C49CC
 * Callers:
 *     IoFreeAdapterChannel @ 0x1404B7350 (IoFreeAdapterChannel.c)
 *     IoFreeAdapterChannelV3Passive @ 0x1404C4BC0 (IoFreeAdapterChannelV3Passive.c)
 * Callees:
 *     ExQueueWorkItem @ 0x1402D49A0 (ExQueueWorkItem.c)
 *     KiRemoveSystemWorkPriorityKick @ 0x1403F1DD4 (KiRemoveSystemWorkPriorityKick.c)
 *     HalpDmaGetNextWcb @ 0x1404B6024 (HalpDmaGetNextWcb.c)
 *     IoFreeAdapterChannelV3Internal @ 0x1404C4B70 (IoFreeAdapterChannelV3Internal.c)
