/*
 * XREFs of CcForceWriteThrough @ 0x14032B52C
 * Callers:
...
{
  char v4; // bl
  unsigned __int64 *Partition; // rbp
  ...
  if ( a3 )
    Partition = (unsigned __int64 *)CcGetPartition((_QWORD *)a3);
  else
    Partition = (unsigned __int64 *)*((_QWORD *)PspSystemPartition + 1);
  if ( (*(_DWORD *)(a1 + 80) & 0x1000000) != 0 && !CcCanIWriteStreamEx(Partition, a1, a2, 0, 0, 0LL)
