/*
 * XREFs of HalpDmaAllocateMappingResources @ 0x140A64788
 * Callers:
...
__int64 HalpDmaAllocateMappingResources()
{
  ...
  qword_140C53DA0 = HalpMmAllocCtxAlloc(v4, v1);
  if ( !qword_140C53DA0 )
    return 3221225626LL;
...
LABEL_14:
  ...
  if ( v2 <= 4 )
  {
    qword_140C53DA8 = HalpMmAllocCtxAlloc(v7, v1);
    if ( qword_140C53DA8 )
    {
      v13 = 0;
      if ( !v2 )
...
LABEL_12:
      ...
      while ( 1 )
      {
        ...
        v17 = qword_140C53DA8;
        *(_QWORD *)(v14 + qword_140C53DA8) = ReservedMapping;
        if ( !ReservedMapping )
          break;
        ++v13;
        v14 += 8LL;
    ...
    HalpMmAllocCtxFree(v12, qword_140C53DA0);
    v19 = v9;
    goto LABEL_14;
  }
LABEL_21:
  ...
  {
    HalpMmAllocCtxFree(v24, qword_140C53DA0);
