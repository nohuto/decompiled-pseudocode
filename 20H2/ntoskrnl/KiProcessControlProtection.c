/*
 * XREFs of KiProcessControlProtection @ 0x140510C20
 * Callers:
 *     KiControlProtectionFault @ 0x14040D940 (KiControlProtectionFault.c)
 * Callees:
 *     KiFixupControlProtectionUserModeReturnMismatch @ 0x1403F168C (KiFixupControlProtectionUserModeReturnMismatch.c)
