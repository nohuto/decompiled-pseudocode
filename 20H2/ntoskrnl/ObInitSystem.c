/*
 * XREFs of ObInitSystem @ 0x140A409B8
 * Callers:
 ...
 *     ObpLookupDirectoryEntry @ 0x14078BBDC (ObpLookupDirectoryEntry.c)
 ...
 *     ObpInitInfoBlockOffsets @ 0x140A6B444 (ObpInitInfoBlockOffsets.c)
...
char ObInitSystem()
{
  ...
  if ( !(_DWORD)InitializationPhase )
  {
    ...
    while ( v3 );
    ObpDefaultObject = 0;
    qword_140C25970 = (__int64)&qword_140C25968;
    qword_140C25968 = (__int64)&qword_140C25968;
    byte_140C25962 = 6;
    dword_140C25964 = 1;
    ...
    qword_140C25998 = (__int64)ObpProcessRemoveObjectDpcWorker;
