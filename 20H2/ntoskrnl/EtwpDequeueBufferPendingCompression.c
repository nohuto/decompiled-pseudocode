/*
 * XREFs of EtwpDequeueBufferPendingCompression @ 0x1405AB5F4
 * Callers:
 ...
 *     EtwpDequeueBufferPendingCompressionFromQueue @ 0x1405AB6E8 (EtwpDequeueBufferPendingCompressionFromQueue.c)
