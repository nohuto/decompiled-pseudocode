...
__int64 __fastcall MiUpdateCfgSystemWideBitmapWorker(__int64 a1, __int64 a2, unsigned __int64 a3, unsigned __int64 a4)
{
  ...
  if ( (int)result >= 0 )
  {
    ...
    v34[0] = v8 >> 12;
    PagefileSubsection = MiLocatePagefileSubsection((unsigned int *)(v12 + 128), v34);
    v14 = v35;
    if ( (unsigned int)MiChargeSegmentCommit(PagefileSubsection, *((_QWORD *)PagefileSubsection + 1) + 8 * v34[0], v35) )
    {
      v15 = v37;
      if ( v37 && (*v37 & 1) != 0 && v7 )
      {
