/*
 * XREFs of MmPurgeSection @ 0x1402C73C0
 * Callers:
...
char __fastcall MmPurgeSection(SECTION_OBJECT_POINTERS *a1, __int64 *a2, __int64 a3, int a4, _BYTE *a5)
{
  ...
  __int64 v50; // [rsp+58h] [rbp-A0h] BYREF
  ...
  *(_OWORD *)v52 = 0LL;
  ...
  v48 = 0LL;
  v8 = 0LL;
  CanFileBeTruncatedInternal = MiCanFileBeTruncatedInternal(a1, (__int64)&v56);
  v10 = v56;
  ...
  *(_DWORD *)(CanFileBeTruncatedInternal + 56) |= 0x8000u;
  ...
  while ( 1 )
  {
    ...
    if ( *(_DWORD *)(v47 + 108) )
      break;
    MiIncrementSubsectionViewCount((_QWORD *)v47, 0);
    if ( (*(_BYTE *)(v47 + 34) & 8) != 0 )
        ...
        while ( 1 )
        {
          while ( 1 )
          {
            ...
            if ( (*(_QWORD *)v13 & 0xC00LL) != 0x800 )
              goto LABEL_53;
            if ( !v21 || !qword_140C4DDC0 || (v21 & qword_140C4DDC0) != 0 )
            {
              v22 = *(_QWORD *)v13;
              if ( qword_140C4DDC0 && (v21 & 0x10) == 0 )
                v22 = v21 & ~qword_140C4DDC0;
LABEL_32:
...
LABEL_41:
        ...
        if ( (v26 & 8) != 0 )
        {
          MiWaitForPageWriteCompletion(v23, v11, v46, 17LL);
          goto LABEL_58;
        }
        if ( v18 && *(_WORD *)(v23 + 32) )
          *a5 = 1;
...
LABEL_58:
    ...
    v14 = v56;
    MiDecrementSubsectionViewCount((_QWORD *)v47, 0);
    ...
    {
      v8 = MiInsertUnusedSubsection(v47) + v48;
      v48 = v8;
    }
LABEL_46:
...
LABEL_47:
  ...
  v29 = 0;
LABEL_48:
  v30 = MiDecrementSubsections(v52[1], v52[1], 0) + v8;
  v31 = MiDecrementSubsections(v53, v53, 0);
  --*(_QWORD *)(v11 + 40);
  *(_DWORD *)(v11 + 56) &= ~4u;
  v32 = v31 + v30;
  if ( v32 )
    v33 = *(_QWORD *)(qword_140C4E4C8 + 8LL * (*(_WORD *)(v11 + 60) & 0x3FF));
  else
    v33 = 0LL;
