/*
 * XREFs of WheapLogInitEvent @ 0x1407A6758
 * Callers:
...
void WheapLogInitEvent()
{
  ...
  Size = 1072 * dword_140CDAF9C;
  PoolWithTag = (char *)ExAllocatePoolWithTag(NonPagedPoolNx, (unsigned int)(1072 * dword_140CDAF9C), 0x61656857u);
  if ( PoolWithTag )
  {
    v1 = (__int64 *)qword_140CDAFA8;
    for ( i = 0; v1 != &qword_140CDAFA8; v1 = (__int64 *)*v1 )
    {
      v3 = v1;
      v4 = 8LL;
    ...
    v20 = 0;
    v23 = 0;
    UserData.Ptr = (ULONGLONG)&dword_140CDAF9C;
    p_Size_4 = &Size_4;
    p_Size = &Size;
    UserData.Size = 4;
    Size_4 = 10;
