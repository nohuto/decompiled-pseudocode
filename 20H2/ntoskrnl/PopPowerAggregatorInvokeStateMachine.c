/*
 * XREFs of PopPowerAggregatorInvokeStateMachine @ 0x1407721F8
 * Callers:
 *     PopPowerAggregatorWorker @ 0x140772170 (PopPowerAggregatorWorker.c)
 * Callees:
 *     __security_check_cookie @ 0x1403CFAF0 (__security_check_cookie.c)
 *     _guard_dispatch_icall @ 0x140405F40 (_guard_dispatch_icall.c)
 *     xHalGetInterruptTranslator @ 0x1406DCE70 (xHalGetInterruptTranslator.c)
 *     PopPowerAggregatorInvalidStateHandler @ 0x140721D30 (PopPowerAggregatorInvalidStateHandler.c)
...
__int64 PopPowerAggregatorInvokeStateMachine()
{
  ...
  UserData.Reserved = 0;
  v6 = 0;
  *(_OWORD *)(LogEntry + 24) = xmmword_140C21658;
  UserData.Size = 4;
  v5 = 4;
  *(__m256 *)(LogEntry + 40) = ymmword_140C21668;
  *(_OWORD *)(LogEntry + 72) = xmmword_140C21688;
  *(_OWORD *)(LogEntry + 88) = xmmword_140C21698;
  UserData.Ptr = (ULONGLONG)&xmmword_140C21658;
  v4 = &xmmword_140C21688;
  PopPowerAggregatorDiagTraceEvent(&POP_ETW_EVENT_POWER_AGGREGATOR_HANDLER_INVOKE, 2u, &UserData);
  v1 = ((__int64 (__fastcall *)(__int64 *))*(&PopPowerAggregatorInternalStateContexts[4 * (int)xmmword_140C21688]
                                           + (int)xmmword_140C21658))(&PopPowerAggregatorContext);
