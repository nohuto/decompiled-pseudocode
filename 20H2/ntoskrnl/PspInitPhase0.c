/*
 * XREFs of PspInitPhase0 @ 0x140A400E8
 * Callers:
...
char __fastcall PspInitPhase0(PVOID StartContext)
{
  ...
  qword_140C1E0A8 = (__int64)&PsActiveProcessHead;
              ...
              if ( PspInitializeSiloStructures() )
              {
                ...
                if ( PspCidTable )
                {
                  ...
                  *(_BYTE *)(PspCidTable + 44) |= 1u;
                  qword_140C1E0D0 = (__int64)PspReaper;
                  qword_140C1E070 = (__int64)PspProcessRundownWorker;
