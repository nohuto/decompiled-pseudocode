/*
 * XREFs of MiUnmapMdlCommon @ 0x14052FC24
 * Callers:
...
void __fastcall MiUnmapMdlCommon(ULONG_PTR a1, __int64 a2, int a3, __int64 a4, ULONG_PTR a5)
{
  ...
  {
    v12 = ExAcquireSpinLockExclusive(&dword_140C4EA40);
    v13 = 0;
    v41 = (_QWORD *)qword_140C4EA50;
    v14 = (_QWORD *)qword_140C4EA50;
    if ( a5 >> 9 != 1 )
    {
      do
      {
...
LABEL_57:
  ...
  MiFlushTbList((unsigned int *)v46, (_KPROCESS *)v11);
  if ( v21 != 17 )
  {
    if ( v20 )
      MiUnlockPageTableInternal(a2, v20);
