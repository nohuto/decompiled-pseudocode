/*
 * XREFs of KiInitializeXSave @ 0x14099E320
 * Callers:
 ...
 *     KiUpdateXSaveSizeAndVolatileFeatures @ 0x1409A4030 (KiUpdateXSaveSizeAndVolatileFeatures.c)
 *     KiParseLoadOptions @ 0x1409A4170 (KiParseLoadOptions.c)
 */
