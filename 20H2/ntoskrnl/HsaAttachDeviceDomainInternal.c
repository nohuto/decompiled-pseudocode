/*
 * XREFs of HsaAttachDeviceDomainInternal @ 0x1404E0A38
 * Callers:
 *     HsaAttachDeviceDomain @ 0x1404E0A20 (HsaAttachDeviceDomain.c)
 *     HsaDetachDeviceDomain @ 0x1404E0F30 (HsaDetachDeviceDomain.c)
 * Callees:
