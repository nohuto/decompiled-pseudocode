/*
 * XREFs of AuthzBasepConvertRelativeToAbsoluteTokenAttribute @ 0x1405BF438
 * Callers:
        ...
        if ( (_DWORD)v13 )
        {
          while ( 1 )
          {
            ...
            if ( (int)pcbLength + 2 < (unsigned int)pcbLength
              ...
              || (((_DWORD)pcbLength + 5) & 0xFFFFFFFC) + v23 < v23 )
            {
              return (unsigned int)-1073741675;
            }
            ++v21;
            v12 = ((pcbLength + 5) & 0xFFFFFFFC) + v23;
            if ( v21 >= a1[3] )
              goto LABEL_51;
          }
        }
  ...
  if ( v30 > 2u )
  {
    if ( v30 == 3 )
    {
      ...
      *((_QWORD *)a3 + 4) = v29;
      ...
      for ( i = v5; ; v45 = i )
      {
        v9 = RtlStringCbLengthW((STRSAFE_PCNZWCH)((char *)a1 + a1[v43 + 4]), v45, &pcbLength);
        if ( v9 < 0 )
          break;
        v46 = pcbLength + 2;
        if ( (int)pcbLength + 2 < (unsigned int)pcbLength )
