/*
 * XREFs of HalpSetupAcpiPhase0 @ 0x140A62700
 * Callers:
...
__int64 __fastcall HalpSetupAcpiPhase0(__int64 a1)
{
  ...
  if ( !HalpProcessedACPIPhase0 )
  {
    ...
    if ( (dword_140C49F10 & 0x40000) != 0 )
      HalpInterruptClusterModeForced = 1;
    if ( (dword_140C49F10 & 0x80000) != 0 )
    ...
    if ( v8 )
    {
      ...
      {
        qword_140C50928 = HalpMmAllocateMemoryInternal(136 * (int)v15, 1u);
        if ( qword_140C50928 )
          PdttTable = v9;
      }
    }
