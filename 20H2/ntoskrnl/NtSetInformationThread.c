/*
 * XREFs of NtSetInformationThread @ 0x14060E970
 * Callers:
 *     <none>
 * Callees:
 ...
 *     KeSetIdealProcessorThread @ 0x14037A620 (KeSetIdealProcessorThread.c)
 ...
 *     KeSetUserHeteroCpuPolicyThread @ 0x1405117FC (KeSetUserHeteroCpuPolicyThread.c)
 ...
 *     PspSetThreadPpmPolicy @ 0x14076FC80 (PspSetThreadPpmPolicy.c)
...
LABEL_4:
  ...
  if ( ThreadInformationClass == ThreadWorkOnBehalfTicket )
  {
    if ( ThreadHandle == (HANDLE)-2LL )
    {
      ...
      if ( v16 )
      {
        v18 = PspThreadFromTicket(&v126, &DmaAdapter);
        if ( v18 >= 0 )
        {
...
LABEL_64:
      ...
      case ThreadActualBasePriority:
        ...
        {
          KeSetActualBasePriorityThread((__int64)v32, v37, v38, v39);
          v24 = v32;
        }
        else
        {
...
LABEL_42:
      ...
      case ThreadWow64Context:
        ...
        if ( result >= 0 )
        {
          ...
          {
            v72 = PspWow64SetContextThread((PETHREAD)v71, v5);
