/*
 * XREFs of TtmiLogCleanupCurrentSessionStart @ 0x1409040A0
 * Callers:
...
void TtmiLogCleanupCurrentSessionStart()
{
  ...
  if ( (unsigned int)dword_140D2D8E8 > 5 )
  {
    if ( tlgKeywordOn((__int64)&dword_140D2D8E8, 1LL) )
    {
      ...
      v4 = 4;
      v3 = &v1;
      tlgWriteTransfer_EtwWriteTransfer((__int64)&dword_140D2D8E8, (unsigned __int8 *)byte_14002A181, 0LL, 0LL, 3u, &v2);
    }
  }
}
