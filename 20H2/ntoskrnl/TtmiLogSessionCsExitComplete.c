/*
 * XREFs of TtmiLogSessionCsExitComplete @ 0x140906054
 * Callers:
...
void TtmiLogSessionCsExitComplete()
{
  ...
  if ( (unsigned int)dword_140D2D8E8 > 5 )
  {
    if ( tlgKeywordOn((__int64)&dword_140D2D8E8, 1LL) )
    {
      ...
      v1 = v0;
      v4 = 4;
      tlgWriteTransfer_EtwWriteTransfer((__int64)&dword_140D2D8E8, (unsigned __int8 *)word_140029E82, 0LL, 0LL, 3u, &v2);
    }
  }
}
