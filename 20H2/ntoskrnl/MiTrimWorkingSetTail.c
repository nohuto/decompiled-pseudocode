/*
 * XREFs of MiTrimWorkingSetTail @ 0x140343CE0
 * Callers:
 ...
 *     MiTrimmedEnough @ 0x14053A934 (MiTrimmedEnough.c)
 */
  ...
  for ( i = *(_QWORD *)(a1 + 168); ; MiProcessVmAccessedInfo(a1, *(_QWORD *)(i + 240), MiTrimWorkingSetEPTCallback, i) )
  {
    ...
    if ( (*(_DWORD *)i & 0x80u) != 0 )
    {
      ...
      *(_QWORD *)(i + 24) = *(_QWORD *)(i + 16);
      v7 = *(_QWORD *)(*(_QWORD *)(qword_140C4E4C8 + 8LL * *(unsigned __int16 *)(v1 + 174)) + 6848LL);
