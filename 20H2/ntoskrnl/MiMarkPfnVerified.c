/*
 * XREFs of MiMarkPfnVerified @ 0x1403156F4
 * Callers:
...
unsigned __int8 __fastcall MiMarkPfnVerified(ULONG_PTR a1, char a2)
{
  char v2; // di
  ULONG_PTR v4; // rbp
  ...
  v2 = a2;
  v15 = 0LL;
  v4 = (__int64)(a1 + 0x58000000000LL) / 48;
  if ( (a2 & 4) != 0 )
    v5 = 17;
  else
  ...
  if ( (v2 & 2) != 0 && (MiFlags & 0x10000) != 0 )
  {
    if ( !(unsigned int)MI_PFN_IS_PROTO(a1) && (MiFlags & 0x8000) != 0 )
      *(_QWORD *)&v15 = (__int64)(*(_QWORD *)(a1 + 8) << 25) >> 16;
    v7 = v2 & 1;
    v2 = v6 & 0xFE;
    if ( !v7 )
      v2 = v6;
  ...
  {
    MiGetPagePrivilege(a1, 1, (unsigned __int64 *)&v15);
