/*
 * XREFs of MmLoadSystemImageEx @ 0x140754C1C
 * Callers:
 ...
 *     IopLoadCrashdmpImage @ 0x14078AC60 (IopLoadCrashdmpImage.c)
 ...
 *     IoIsDeviceEjectable @ 0x1403569F4 (IoIsDeviceEjectable.c)
 ...
 *     MiValidateStrongCodeDriverImage @ 0x140533D24 (MiValidateStrongCodeDriverImage.c)
 ...
 *     MiRelocateAmount @ 0x1407D1014 (MiRelocateAmount.c)
...
LABEL_59:
  ...
  if ( !(_BYTE)v11 )
  {
    v25 = MiControlAreaRequiresCharge((__int64)v17);
    v46 = v25;
    if ( !v25 )
    {
      active = -1073740277;
...
LABEL_51:
  ...
  if ( (a4 & 1) == 0 )
  {
    _InterlockedExchangeAdd(&dword_140C4EE50, v18);
    v15 = P;
    v48 = v50;
  }
  ...
  {
    _InterlockedExchangeAdd((_DWORD *)&xmmword_140C4CBC8 + 3, -v18);
    v30 = v50;
    v27 = (void *)v29;
    v15 = P;
...
LABEL_93:
    ...
    else
    {
      ...
      if ( (*(_BYTE *)(*(_QWORD *)(*v17 + 56) + 46LL) & 0x40) == 0 )
      {
        ...
        MiSetImageProtection((__int64)v15, (unsigned __int64)v42, 8u, 4u);
        *v42 = v41 - MiRelocateAmount(v17);
        if ( v17[18] )
          MiSetImageProtection((__int64)v15, (unsigned __int64)v42, 8u, 0x100u);
      }
      active = MiFinalizeDriverImage(v15);
      v13 = 23;
      if ( active >= 0 )
      {
