/*
 * XREFs of PoDiagTraceDirectedDripsCandidateDevice @ 0x1408EA7E4
 * Callers:
 *     IoDiagTraceDirectedDripsCandidateDevices @ 0x1408B70B8 (IoDiagTraceDirectedDripsCandidateDevices.c)
 * Callees:
...
void PoDiagTraceDirectedDripsCandidateDevice()
{
  ...
  if ( PopTriggerDiagHandleRegistered && (unsigned int)dword_140C021E8 > 5 )
  {
    if ( tlgKeywordOn((__int64)&dword_140C021E8, 0x400000000000LL) )
    {
      ...
      tlgWriteTransfer_EtwWriteTransfer(
        ...
        (unsigned __int8 *)&dword_14002686C,
        0LL,
        0LL,
        7u,
        &v5);
