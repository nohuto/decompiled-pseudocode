/*
 * XREFs of VerifierKeReleaseInStackQueuedSpinLockForDpcCommon @ 0x1409DE0C0
 * Callers:
 *     VerifierKeReleaseInStackQueuedSpinLockForDpc @ 0x1409DE080 (VerifierKeReleaseInStackQueuedSpinLockForDpc.c)
 *     VerifierKeReleaseInStackQueuedSpinLockForDpcNoReboot @ 0x1409DE130 (VerifierKeReleaseInStackQueuedSpinLockForDpcNoReboot.c)
 * Callees:
