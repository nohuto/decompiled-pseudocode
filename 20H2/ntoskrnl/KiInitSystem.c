/*
 * XREFs of KiInitSystem @ 0x140A6A460
 * Callers:
...
__int64 (*KiInitSystem())()
{
  ...
  *((_QWORD *)&xmmword_140E018D0 + 1) = &KiArgumentTable;
  qword_140C31F78 = (__int64)KiBalanceSetManagerDeferredRoutine;
  qword_140C31F80 = (__int64)&KiBalanceSetManagerPeriodicEvent;
  qword_140C31EB0 = (__int64)&qword_140C31EA8;
  qword_140C31EA8 = (__int64)&qword_140C31EA8;
  ...
  qword_140C31ED8 = (__int64)KiSetVirtualHeteroClockIntervalRequestDpcRoutine;
