/*
 * XREFs of KiUpdateVpBackingThreadPriorityFromTopLevel @ 0x14051F1E0
 * Callers:
...
char __fastcall KiUpdateVpBackingThreadPriorityFromTopLevel(ULONG_PTR BugCheckParameter1, __int64 a2)
{
  ...
  if ( v5 != v7 )
  {
    ...
    *(_DWORD *)(BugCheckParameter1 + 856) = (_DWORD)v4;
    if ( *(char *)(BugCheckParameter1 + 195) < (char)v5 )
      LOBYTE(v4) = KiSetPriorityThread((_BYTE *)BugCheckParameter1, a2, v5);
    if ( v7 != 32 )
    {
      LOBYTE(v4) = v7;
        ...
        *(_DWORD *)(BugCheckParameter1 + 856) = (_DWORD)v4;
        if ( (unsigned int)v4 < 1 << v7 )
        {
          ...
          if ( v11 < 16 )
          {
            ...
            if ( v13 < v11 )
              LOBYTE(v4) = KiSetPriorityThread((_BYTE *)BugCheckParameter1, a2, v13);
          }
        }
      }
    }
  ...
  if ( v6 != 32 )
  {
    ...
    if ( v6 != (_DWORD)v4 )
    {
      ...
      LOBYTE(v4) = KiSetPriorityThread((_BYTE *)BugCheckParameter1, a2, v6);
    }
  }
  if ( (*(_DWORD *)(BugCheckParameter1 + 120) & 0x400000) != 0 )
  {
