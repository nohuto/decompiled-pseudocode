/*
 * XREFs of MmAllocateVirtualMemory @ 0x14067C130
 * Callers:
 *     PsDispatchIumService @ 0x1405812E4 (PsDispatchIumService.c)
 *     NtAllocateVirtualMemoryEx @ 0x14067C0D0 (NtAllocateVirtualMemoryEx.c)
        ...
        __int64 a11)
{
  ...
  if ( MapExtendedParameters >= 0 )
  {
    ...
    {
      MapExtendedParameters = MiAllocateVirtualMemory((__int64)v26, (__int64 *)v13, &v21);
    }
    if ( MapExtendedParameters < 0 )
      goto LABEL_29;
    v16 = v21;
