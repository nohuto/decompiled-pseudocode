/*
 * XREFs of IoUpdateLinkShareAccessEx @ 0x1405F91B0
 * Callers:
 *     IoUpdateShareAccess @ 0x14076F6E0 (IoUpdateShareAccess.c)
 *     IoUpdateLinkShareAccess @ 0x1408968F0 (IoUpdateLinkShareAccess.c)
 * Callees:
 *     <none>
 */
