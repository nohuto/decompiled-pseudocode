/*
 * XREFs of _CmGetDeviceRegPropWorker @ 0x14066B8FC
 * Callers:
 *     _CmGetDeviceRegProp @ 0x14066B77C (_CmGetDeviceRegProp.c)
 * Callees:
 *     _CmDevicePropertyRead @ 0x140267A0C (_CmDevicePropertyRead.c)
 *     _MapCmDevicePropertyToNtProperty @ 0x140267A48 (_MapCmDevicePropertyToNtProperty.c)
 *     _MapCmDevicePropertyToRegValue @ 0x140267AB4 (_MapCmDevicePropertyToRegValue.c)
 *     RtlInitUnicodeStringEx @ 0x140267E90 (RtlInitUnicodeStringEx.c)
 *     RtlStringCbCopyNExW @ 0x140329320 (RtlStringCbCopyNExW.c)
 *     _MapCmDevicePropertyToRegType @ 0x14032E70C (_MapCmDevicePropertyToRegType.c)
