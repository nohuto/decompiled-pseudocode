/*
 * XREFs of PopAddPagesToCompressedPageSet @ 0x1409973F4
 * Callers:
        ...
        __int64 a7)
{
  ...
  if ( v9 )
  {
    ...
    else
    {
      v13 = a4;
      v18 = *(_DWORD *)(a2 + 120);
      v19 = *((_QWORD *)qword_140C23578 + 5) - *((_QWORD *)qword_140C23578 + 7);
      if ( v18 && (v20 = *(_DWORD *)(a2 + 124), (int)(100 * v20 / v18) <= dword_140C23524) )
      {
        v21 = *((_DWORD *)qword_140C23578 + 2);
      ...
      {
        LOBYTE(v7) = v19 >= (__int64)((unsigned __int64)*((unsigned int *)qword_140C23578 + 2) >> 1);
      }
      *(_DWORD *)(a2 + 120) = v18 + 1;
    }
    v14 = __rdtsc();
