/*
 * XREFs of SeMarkLogonSessionForTerminationNotificationEx @ 0x1406E2EC0
 * Callers:
 *     SeMarkLogonSessionForTerminationNotification @ 0x1406E2EA0 (SeMarkLogonSessionForTerminationNotification.c)
 * Callees:
