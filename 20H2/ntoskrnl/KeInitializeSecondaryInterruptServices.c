/*
 * XREFs of KeInitializeSecondaryInterruptServices @ 0x1408BE390
 * Callers:
 *     HalpAllocateGsivForSecondaryInterrupt @ 0x1404CEF40 (HalpAllocateGsivForSecondaryInterrupt.c)
 * Callees:
...
__int64 KeInitializeSecondaryInterruptServices()
{
  ...
  if ( PoolWithTag )
  {
    ...
    while ( v4 );
    qword_140C2B328 = (__int64)&KiSecondarySignalList;
