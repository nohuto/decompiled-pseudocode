/*
 * XREFs of HalpGenericErrorSourceRecovery @ 0x1404CE348
 * Callers:
 *     HalpRequestGenericErrorRecovery @ 0x1404CE870 (HalpRequestGenericErrorRecovery.c)
 * Callees:
 *     RtlCompareMemory @ 0x140405B40 (RtlCompareMemory.c)
 *     HalpGhesMemoryErrorHandler @ 0x1404CE468 (HalpGhesMemoryErrorHandler.c)
