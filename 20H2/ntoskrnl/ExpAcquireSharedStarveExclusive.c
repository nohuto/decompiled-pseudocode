/*
 * XREFs of ExpAcquireSharedStarveExclusive @ 0x1402A1EA0
 * Callers:
 ...
 *     ExpFindEmptyEntry @ 0x140315240 (ExpFindEmptyEntry.c)
 *     ExpTryAcquireResourceSharedStarveExclusive @ 0x1403207C0 (ExpTryAcquireResourceSharedStarveExclusive.c)
 *     ExpPrepareToWaitForResourceShared @ 0x14032ED5C (ExpPrepareToWaitForResourceShared.c)
