/*
 * XREFs of HalpDmaAllocateContiguousPagesFromContiguousPoolAtHighLevelV3 @ 0x1404B5470
 * Callers:
 ...
 *     HalpDmaLinkContiguousTranslations @ 0x1404C6304 (HalpDmaLinkContiguousTranslations.c)
 */
