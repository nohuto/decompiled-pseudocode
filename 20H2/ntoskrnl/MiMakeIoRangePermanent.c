/*
 * XREFs of MiMakeIoRangePermanent @ 0x1405350B8
 * Callers:
...
__int64 __fastcall MiMakeIoRangePermanent(__int64 a1)
{
  ...
  v5 = *(_QWORD *)(a1 + 32) - v1;
  P = 0LL;
  v34 = ExAcquireSpinLockExclusive(&dword_140C4EAC0);
  v6 = v34;
  v7 = v5 + 1;
  if ( !v7 )
  {
LABEL_32:
    v25 = (_QWORD *)qword_140C4EB20;
    v26 = 0;
    if ( qword_140C4EB20 )
    {
      while ( 1 )
    ...
    RtlAvlInsertNodeEx((unsigned __int64 *)&qword_140C4EB20, (unsigned __int64)v25, v26, (_QWORD *)a1);
    goto LABEL_38;
  }
  do
  {
    v8 = (_QWORD *)*((_QWORD *)&xmmword_140C4EAC8 + 1);
    for ( i = *((_QWORD *)&xmmword_140C4EAC8 + 1) == 0LL; !i; i = v11 == 0LL )
    {
      v10 = v8[5];
      if ( v1 < v10 )
      {
    ...
    v16 = MiRemoveUnmappedIoNode(&qword_140C4EAD8, v1);
    v17 = (_QWORD *)v16;
    if ( !v16 )
    {
      v18 = v1 & 0x1FF;
