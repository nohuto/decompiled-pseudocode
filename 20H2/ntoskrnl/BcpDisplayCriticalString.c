/*
 * XREFs of BcpDisplayCriticalString @ 0x1405C311C
 * Callers:
 ...
 * Callees:
 *     BgpDisplayCharacterEx @ 0x1405C2BA4 (BgpDisplayCharacterEx.c)
 *     BgpFoGetStringAdvanceWidth @ 0x1405C2DA0 (BgpFoGetStringAdvanceWidth.c)
 *     BcpPrintSpaces @ 0x1405C3AE4 (BcpPrintSpaces.c)
 *     BgpRasGetGlyphAdvanceWidth @ 0x1405C425C (BgpRasGetGlyphAdvanceWidth.c)
 */
...
__int64 __fastcall BcpDisplayCriticalString(unsigned __int16 *a1, int a2, __int64 a3, __int64 a4)
{
  ...
  if ( BcpTextBoxLeftEdgeOverride )
    ...
    v6 = dword_140C10E90[18 * (int)a4 + 8] + dword_140C10E90[18 * (int)a4 + 4];
  if ( BcpTextBoxRightEdgeOverride )
    v7 = *(_DWORD *)BcpTextBoxRightEdgeOverride;
  else
    v7 = dword_140C10E90[18 * (int)a4 + 8] + dword_140C10E90[18 * (int)a4 + 6] + dword_140C10E90[18 * (int)a4 + 4];
  v8 = BcpCursor;
  ...
  *(_DWORD *)(qword_140C53D70 + 8) = a2;
  ...
  if ( (*a1 & 0xFFFE) != 0 )
  {
    while ( 1 )
    {
        ...
        if ( *(_WORD *)(v18 + 2LL * v17) != 32 )
        {
          while ( 1 )
          {
            ...
            if ( v7 < v29 + v8 && v14 )
            {
              if ( v8 < v7 )
              {
                StringAdvanceWidth = BcpPrintSpaces(qword_140C53D70, v8, v7, v9, v27, (__int64)&v33);
                if ( StringAdvanceWidth < 0 )
                  goto LABEL_40;
                if ( v14 < v33 )
                  v14 = v33;
              ...
              v8 = v6;
              v22 = v14 + dword_140C10E90[2 * v5 + 10];
              v14 = 0;
              v9 += v22;
              break;
            }
      ...
      v23 = v17;
      v8 = v6;
      v24 = v14 + dword_140C10E90[2 * v5 + 10];
      v14 = 0;
      v9 += v24;
