/*
 * XREFs of KiExpandKernelStackAndCalloutOnStackSegment @ 0x1402AD640
 * Callers:
 ...
 *     KiSwitchKernelStackAndCallout @ 0x140400250 (KiSwitchKernelStackAndCallout.c)
 */
        ...
        __int64 a5)
{
  ...
  struct _KPRCB *v32; // [rsp+48h] [rbp-50h] BYREF
...
LABEL_13:
  ...
  *(_QWORD *)(v17 + 40) = CurrentThread->InitialStack;
  ...
  KeQueryCurrentStackInformationEx(CurrentStackPointer, (char *)&v35, &v32, &v31);
  if ( v35 == 10 )
  {
    v20 = 1;
