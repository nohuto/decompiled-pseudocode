/*
 * XREFs of IoIs32bitProcess @ 0x14023F3D0
 * Callers:
 *     IoIsInitiator32bitProcess @ 0x14036C710 (IoIsInitiator32bitProcess.c)
 *     FsRtlGetMarkHandleInfo @ 0x1404EE638 (FsRtlGetMarkHandleInfo.c)
 *     EtwpGetScsiPassThroughCdb @ 0x1405A70C4 (EtwpGetScsiPassThroughCdb.c)
 ...
 *     WmipProbeWmiOpenGuidBlock @ 0x1406486B0 (WmipProbeWmiOpenGuidBlock.c)
