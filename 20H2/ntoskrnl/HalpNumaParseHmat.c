/*
 * XREFs of HalpNumaParseHmat @ 0x140A90284
 * Callers:
 *     HalpSetupAcpiPhase0 @ 0x140A62700 (HalpSetupAcpiPhase0.c)
 * Callees:
 *     HalpNumaQueryProximityNode @ 0x1403CEE80 (HalpNumaQueryProximityNode.c)
 *     qsort @ 0x1403D2150 (qsort.c)
 *     memset @ 0x140411300 (memset.c)
 *     HalpVerifyHmatEntryValidity @ 0x140A90718 (HalpVerifyHmatEntryValidity.c)
 */
