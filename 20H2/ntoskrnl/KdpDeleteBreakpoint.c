/*
 * XREFs of KdpDeleteBreakpoint @ 0x1409BD248
 * Callers:
 ...
 *     KdpDeleteBreakpointRange @ 0x1409BD2B0 (KdpDeleteBreakpointRange.c)
 * Callees:
...
char __fastcall KdpDeleteBreakpoint(int a1)
{
  ...
  if ( (unsigned int)(a1 - 1) > 0x1F )
    return 0;
  v2 = 5 * v1;
  v3 = *((_DWORD *)&unk_140C330A0 + 10 * v1);
  if ( !v3 )
    return 0;
  if ( (v3 & 0xC) == 4 )
  {
    *((_DWORD *)&unk_140C330A0 + 10 * v1) = 0;
    ++KdpBreakpointChangeCount;
  }
  else if ( (unsigned __int8)KdpLowWriteContent((unsigned int)v1) )
  {
    *((_DWORD *)&unk_140C330A0 + 2 * v2) = 0;
  }
  return 1;
}
