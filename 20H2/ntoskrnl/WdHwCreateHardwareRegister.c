/*
 * XREFs of WdHwCreateHardwareRegister @ 0x1404DC9B8
 * Callers:
 ...
 *     WdHwpGetReadMethod @ 0x1404DCAEC (WdHwpGetReadMethod.c)
 *     WdHwpGetWriteMethod @ 0x1404DCB5C (WdHwpGetWriteMethod.c)
 */
