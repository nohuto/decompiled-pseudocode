/*
 * XREFs of MiInitializeLoadedModuleList @ 0x140A54894
 * Callers:
...
__int64 __fastcall MiInitializeLoadedModuleList(__int64 a1)
{
  ...
  v9 = 0LL;
  qword_140C4CB48 = (__int64)&qword_140C4CB40;
  qword_140C4CB40 = (__int64)&qword_140C4CB40;
  ...
  *(&PsLoadedModuleList + 1) = &PsLoadedModuleList;
  ...
  qword_140C160C8 = (__int64)&ExpCovUnloadedModuleList;
