/*
 * XREFs of MiDemoteLocalLargePage @ 0x1402C0930
 * Callers:
...
__int64 __fastcall MiDemoteLocalLargePage(__int64 a1, unsigned int a2, __int16 a3, unsigned __int64 a4)
{
  unsigned int v6; // ebp
  unsigned int v7; // edi
  int v8; // r12d
  ...
  {
    v6 = (unsigned __int16)(unsigned __int8)MiChannelMaximumPowerOf2Mask & (unsigned __int16)(a2 >> byte_140C4DD0D);
    v30 = v6;
  }
  v7 = a2 >> byte_140C4DD0C;
  v32 = *(_QWORD *)(a1 + 16) + 4544LL * (a2 >> byte_140C4DD0C);
