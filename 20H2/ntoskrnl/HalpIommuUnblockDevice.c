/*
 * XREFs of HalpIommuUnblockDevice @ 0x1404C84B0
 * Callers:
 *     <none>
 * Callees:
 ...
 *     HalpIommuCheckDpptException @ 0x1404C7720 (HalpIommuCheckDpptException.c)
  ...
  if ( Device >= 0 )
  {
    ...
    if ( HalpHvIommu )
    {
      ...
      *((_QWORD *)&v29 + 1) = MEMORY[0x18];
      v15 = ((__int64 (__fastcall *)(__int128 *, __int64 *))qword_140C4A3D8)(&v29, &v28);
    }
    else
    {
...
LABEL_23:
      ...
      while ( 1 )
      {
        ...
        if ( v20 )
          break;
        v22 = (unsigned __int64)&CurrentThread->LockEntries[v21];
        v19 &= ~(1 << v21);
        if ( (*(_BYTE *)(v22 + 26) & 1) != 0
          && (*(_DWORD *)(v22 + 32) & 1) == 0
          ...
          *(_BYTE *)(v22 + 26) &= ~1u;
          if ( *(_QWORD *)(v22 + 32) )
          {
            if ( v22 )
            {
              ...
              *(_DWORD *)(v22 + 88) = v24;
              *(_QWORD *)(v22 + 32) = 0LL;
              v25 = (__int64)(v22 - (unsigned __int64)CurrentThread->LockEntries) / 96;
              if ( v18 == 1 )
...
LABEL_40:
      ...
      KiAbThreadRemoveBoosts((ULONG_PTR)CurrentThread, (__int64)&HalpDeviceBlockUnblockPushLock, &v33);
