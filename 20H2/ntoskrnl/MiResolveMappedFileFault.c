/*
 * XREFs of MiResolveMappedFileFault @ 0x140231830
 * Callers:
...
LABEL_110:
  ...
  v16 = 0;
  v63 = 0;
  v17 = *(_QWORD *)(qword_140C4E4C8 + 8 * v15);
  v67 = v17;
  v20 = v73;
  ...
  if ( MI_READ_PTE_LOCK_FREE(a2) == v20 )
  {
      ...
      || (*(_BYTE *)(v75 + 34) & 0x20) != 0 && (*(_DWORD *)(*(_QWORD *)v75 + 160LL) & 0x20) == 0 )
    {
      ...
      if ( (unsigned int)(v63 - 1) <= 1 )
        goto LABEL_33;
      if ( (*(_DWORD *)(v9 + 56) & 0x40020) == 0x20 && v24 && !dword_140C4EB40 )
      {
        if ( !v26 )
        {
LABEL_33:
...
LABEL_34:
          if ( (unsigned int)MiObtainFaultCharges(v29, 1LL, 1LL) )
          {
            ...
            if ( v24 && (unsigned int)MiUseSlabAllocator(v29, (_BYTE *)v8, v73, 0LL) )
              SlabPage = MiGetSlabPage(v29, v64, 0, v33, v33);
            else
...
LABEL_46:
      ...
      *(_QWORD *)(v22 + 160) = v37;
      *(_QWORD *)(v22 + 168) = v20;
      v42 = MiPickClusterForMappedFileFault(v29, v22, v40, v39, v60, v28, (__int64)&v78, (__int64)&v77);
      v43 = MiBuildMdlForMappedFileFault(v22, v78, v77, v29, v42, v28, v72, v40, a1, (__int64)&v79);
      v44 = v43;
      if ( v43 != v42 )
