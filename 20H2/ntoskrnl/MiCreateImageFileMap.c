/*
 * XREFs of MiCreateImageFileMap @ 0x1407084A8
 * Callers:
 ...
 *     PsIsCurrentThreadPrefetching @ 0x14030A690 (PsIsCurrentThreadPrefetching.c)
          ...
          *(_DWORD *)(v14 + 56) |= 0x800u;
          ...
          if ( (PerfGlobalGroupMask & 4) != 0 )
          {
            ...
            *(_QWORD *)&v100 = FileObject->FsContext;
            ...
            v103 = &v100;
            EtwTraceKernelEvent((__int64)&v103, v74, 4u, 0x269u, 0x401802u);
          }
          v52 = v79;
        }
        if ( (a4 & 0x10000) == 0 )
