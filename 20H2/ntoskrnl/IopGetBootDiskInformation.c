/*
 * XREFs of IopGetBootDiskInformation @ 0x140A92B7C
 * Callers:
 *     IoGetBootDiskInformation @ 0x1408965F0 (IoGetBootDiskInformation.c)
 * Callees:
 ...
 *     IopVerifyDiskSignature @ 0x1407D0308 (IopVerifyDiskSignature.c)
