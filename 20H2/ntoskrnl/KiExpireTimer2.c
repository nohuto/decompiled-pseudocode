/*
 * XREFs of KiExpireTimer2 @ 0x1402E01F0
 * Callers:
...
__int64 __fastcall KiExpireTimer2(__int64 a1, __int64 a2, unsigned __int64 a3, _DWORD *a4)
{
  __int64 v4; // r15
...
LABEL_66:
      ...
      while ( 1 )
      {
        ...
        v52 = v49;
        v49 = (__int64 *)*v49;
        if ( v51 && PsTimerResolutionActive(*(_QWORD *)(v52[3] + 544)) )
          break;
        if ( v49 == (__int64 *)v50 )
          goto LABEL_66;
      }
...
LABEL_15:
  ...
  *(_QWORD *)(a1 + 72) = v17;
  while ( !KiInsertTimer2(a1, 0, (__int64)&v80) )
  {
    if ( v18 )
      goto LABEL_4;
    v56 = *(_QWORD *)(a1 + 72);
  ...
  if ( v11 == 25 )
  {
    ...
    while ( 1 )
    {
      ...
      *v15 = v13;
      ...
      if ( v20 == 1 )
      {
        if ( (unsigned __int8)KiTryUnwaitThread(v7, v14, *(unsigned __int16 *)(v14 + 18), 0LL) )
        {
          v26 = (*(_DWORD *)(a1 + 4))-- == 1;
          if ( v26 )
          {
...
LABEL_32:
  ...
  if ( v28 )
  {
    ...
    if ( *(_QWORD *)(v7 + 11528) )
      KiProcessThreadWaitList(v7, 1LL, 0LL, 2LL);
    v33 = v78;
    if ( v78 )
    ...
    *(_BYTE *)(v41 + 12586) = 1;
    ((void (__fastcall *)(__int64, unsigned __int64))v28)(a1, v27);
    *(_BYTE *)(v41 + 12586) = 0;
