/*
 * XREFs of SecureDump_PrepareForInit @ 0x1403CBAA0
 * Callers:
...
LABEL_4:
      ...
      if ( v5 >= 0 )
      {
        DWORD1(xmmword_140C4C6D8) = *(_DWORD *)P;
        ExFreePoolWithTag(P, 0);
        if ( !DWORD1(xmmword_140C4C6D8)
          || (*a2 = 1,
              (int)SecureDump_ReadRegistry(
                     (unsigned int)v6,
                     (unsigned int)L"PublicKey",
                     3,
                     (unsigned int)&xmmword_140C4C6D8 + 8,
                     (__int64)&dwFlags) >= 0)
          && (int)SecureDump_ReadRegistry(
                    (unsigned int)v6,
...
LABEL_8:
  ...
  if ( *((_QWORD *)&xmmword_140C4C6D8 + 1) )
  {
    ExFreePoolWithTag(*((PVOID *)&xmmword_140C4C6D8 + 1), 0);
    *((_QWORD *)&xmmword_140C4C6D8 + 1) = 0LL;
  }
  if ( v3 )
  {
