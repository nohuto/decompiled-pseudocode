/*
 * XREFs of RtlEnumerateGenericTableLikeADirectory @ 0x14023F480
 * Callers:
 *     PiDmEnumObjectsWithCallback @ 0x14063D318 (PiDmEnumObjectsWithCallback.c)
 * Callees:
 *     RealSuccessor @ 0x14023F5A0 (RealSuccessor.c)
        ...
        PVOID Buffer)
{
  ...
  v13 = DeleteCount;
  v14 = (PRTL_AVL_MATCH_FUNCTION)HalSystemVectorDispatchEntry;
...
LABEL_9:
  if ( v12 )
  {
    while ( 1 )
    {
      v18 = ((__int64 (__fastcall *)(PRTL_AVL_TABLE, char *, PVOID))v14)(Table, v12 + 32, MatchData);
      if ( v18 != -1073741198 )
        break;
