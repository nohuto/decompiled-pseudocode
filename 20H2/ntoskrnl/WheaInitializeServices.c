/*
 * XREFs of WheaInitializeServices @ 0x140A6F5D4
 * Callers:
 *     InitBootProcessor @ 0x140A3CF64 (InitBootProcessor.c)
 * Callees:
 *     WheapInitializeInUsePageOfflineNotifications @ 0x1407C3B68 (WheapInitializeInUsePageOfflineNotifications.c)
 */
...
PVOID *WheaInitializeServices()
{
  ...
  qword_140CF4908 = (__int64)&WheapPfaList;
  ...
  *(_QWORD *)&WheapDispatchPtr.DeviceType = &WheapDispatchPtr.DeviceType;
  qword_140C15EB8 = (__int64)WheapDeferredRecoveryServiceDpcRoutine;
