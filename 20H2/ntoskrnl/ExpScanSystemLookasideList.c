/*
 * XREFs of ExpScanSystemLookasideList @ 0x1402F4E00
 * Callers:
 *     KeBalanceSetManager @ 0x1403B86E0 (KeBalanceSetManager.c)
 * Callees:
 *     ExpComputeLookasideDepth @ 0x1402F4FC4 (ExpComputeLookasideDepth.c)
...
__int64 ExpScanSystemLookasideList()
{
  ...
  for ( i = 0; i < dword_140C57F10; ++i )
  {
    v12 = 2LL;
    v13 = (char *)&unk_140C57F80 + 8384 * i;
    do
    {
