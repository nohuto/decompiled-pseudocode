/*
 * XREFs of ExAcquireSharedWaitForExclusive @ 0x1405B3370
 * Callers:
 *     FsRtlAcquireFileForModWriteEx @ 0x140344550 (FsRtlAcquireFileForModWriteEx.c)
 *     ExEnterCriticalRegionAndAcquireSharedWaitForExclusive @ 0x1405B3950 (ExEnterCriticalRegionAndAcquireSharedWaitForExclusive.c)
 * Callees:
 ...
 *     ExpTryAcquireResourceShared @ 0x14038F184 (ExpTryAcquireResourceShared.c)
