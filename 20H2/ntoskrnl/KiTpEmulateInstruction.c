/*
 * XREFs of KiTpEmulateInstruction @ 0x140A158C0
 * Callers:
 *     KiTpHandleTrap @ 0x14051B6F0 (KiTpHandleTrap.c)
 *     KiTpCompletion @ 0x140A15130 (KiTpCompletion.c)
 *     KiTpParseInstruction @ 0x140A162AC (KiTpParseInstruction.c)
 * Callees:
 *     KiTpAccessMemory @ 0x140A15008 (KiTpAccessMemory.c)
 *     KiTpDecodeModRm @ 0x140A15168 (KiTpDecodeModRm.c)
 *     KiTpDecodeModRmOperand @ 0x140A15254 (KiTpDecodeModRmOperand.c)
 *     KiTpEmulateGroup0Instruction @ 0x140A153B4 (KiTpEmulateGroup0Instruction.c)
 *     KiTpEmulateGroup11Instruction @ 0x140A15610 (KiTpEmulateGroup11Instruction.c)
 *     KiTpEmulateGroup1Instruction @ 0x140A156D0 (KiTpEmulateGroup1Instruction.c)
 *     KiTpEmulateMovRegImm @ 0x140A15F3C (KiTpEmulateMovRegImm.c)
 *     KiTpEmulateMovzx @ 0x140A15FCC (KiTpEmulateMovzx.c)
 *     KiTpEmulateRegisterPushPop @ 0x140A160DC (KiTpEmulateRegisterPushPop.c)
 *     KiTpFetchInstructionBytes @ 0x140A16210 (KiTpFetchInstructionBytes.c)
 *     KiTpGetRegisterAddressByIndex @ 0x140A16254 (KiTpGetRegisterAddressByIndex.c)
 *     KiTpReadOperandValue @ 0x140A163EC (KiTpReadOperandValue.c)
 *     KiTpSetFlagsZeroSignParity @ 0x140A16640 (KiTpSetFlagsZeroSignParity.c)
 *     KiTpSetImmediateOperandSize @ 0x140A166B0 (KiTpSetImmediateOperandSize.c)
 *     KiTpSignExtendOperandValue @ 0x140A166E0 (KiTpSignExtendOperandValue.c)
 *     KiTpWriteRegisterValue @ 0x140A1670C (KiTpWriteRegisterValue.c)
 */
