/*
 * XREFs of PspEstablishJobHierarchy @ 0x14062D6C4
 * Callers:
 ...
 *     PspSetEffectiveRateControlJob @ 0x14090BC48 (PspSetEffectiveRateControlJob.c)
...
LABEL_60:
        v24[1] = v20;
        LOBYTE(v25) = 1;
        PspEnumJobsAndProcessesInJobHierarchy(Object, (__int64)v24, 5);
LABEL_34:
        v21 = *(void **)(a3 + 1560);
        if ( v21 )
        {
