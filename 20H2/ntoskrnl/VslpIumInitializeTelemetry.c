/*
 * XREFs of VslpIumInitializeTelemetry @ 0x140A75E10
 * Callers:
...
char VslpIumInitializeTelemetry()
{
  ...
  result = TraceLoggingRegisterEx_EtwRegister_EtwSetInformation((ULONGLONG *)&dword_140C04460, 0LL, 0LL);
  if ( (*(_DWORD *)(KeLoaderBlock_0 + 264) & 1) != 0 )
  {
    if ( (unsigned int)dword_140C04460 <= 5 )
      goto LABEL_5;
    result = tlgKeywordOn((__int64)&dword_140C04460, 0x400000000000LL);
    if ( result )
    {
      v4 = *(_QWORD *)(v3 + 240);
      ...
      result = tlgWriteTransfer_EtwWriteTransfer(
                 ...
                 (unsigned __int8 *)byte_1400236D9,
                 0LL,
                 0LL,
                 5u,
                 v13);
  ...
  if ( (unsigned int)dword_140C04460 > 5 )
  {
    ...
    if ( result )
    {
      ...
      result = tlgWriteTransfer_EtwWriteTransfer(
                 (__int64)&dword_140C04460,
                 (unsigned __int8 *)word_14002368A,
                 0LL,
                 0LL,
                 6u,
                 v13);
