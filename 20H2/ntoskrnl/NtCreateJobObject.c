/*
 * XREFs of NtCreateJobObject @ 0x140710B60
 * Callers:
 *     <none>
 * Callees:
...
NTSTATUS __cdecl NtCreateJobObject(PHANDLE JobHandle, ACCESS_MASK DesiredAccess, POBJECT_ATTRIBUTES ObjectAttributes)
{
  ...
  v6 = CurrentThread->$6A88714AB977AAA8032D9F5E2A96BA31::gap0[10];
  if ( v6 )
  {
    v7 = 0x7FFFFFFF0000LL;
  ...
  *JobHandle = 0LL;
  ...
  else
  {
    ...
    *(_QWORD *)&v12[54].Header.Lock = 0LL;
    ...
    v13 = v12 + 1;
    v14 = (struct _LIST_ENTRY *)qword_140D2D358;
