/*
 * XREFs of RtlFindNextClearRunUlong @ 0x140314F84
 * Callers:
 *     MiFindFreePageFileSpaceForward @ 0x140314C38 (MiFindFreePageFileSpaceForward.c)
 *     MiRescanPageFileBitmapPortion @ 0x140314D74 (MiRescanPageFileBitmapPortion.c)
 *     MiRescanPagefileBitmaps @ 0x1403BF164 (MiRescanPagefileBitmaps.c)
 * Callees:
 *     <none>
 */
...
__int64 __fastcall RtlFindNextClearRunUlong(unsigned int *a1, unsigned int a2, __int64 a3, unsigned int a4, _DWORD *a5)
{
  ...
  if ( (v6 & 0x1F) == 0 )
    v10 = v7 + 4 * v8;
  v11 = *v9 | *((_DWORD *)qword_140011D10 + (a2 & 0x1F));
  v12 = 0;
  do
  {
    while ( 1 )
...
LABEL_8:
    ...
    v17 = v12 & 0x1F;
    v18 = 0;
    v19 = v11 & ~*((_DWORD *)qword_140011D10 + v17);
    v11 = v19;
    if ( (unsigned __int64)v9 > v10 )
    {
LABEL_21:
      ...
      if ( v18 )
        ...
        v21 = v9;
      v9 = v21;
      v11 |= ~*((_DWORD *)qword_140011D10 + (v6 & 0x1F));
LABEL_26:
      v22 = -1;
