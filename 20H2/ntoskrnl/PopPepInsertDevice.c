/*
 * XREFs of PopPepInsertDevice @ 0x1403BDD38
 * Callers:
...
_QWORD *__fastcall PopPepInsertDevice(__int64 a1, __int64 *a2)
{
  ...
  v4 = (__int64 **)qword_140C214E8;
  if ( *(__int64 **)qword_140C214E8 != &PopPepDeviceList )
    __fastfail(3u);
  a2[1] = qword_140C214E8;
  *a2 = (__int64)&PopPepDeviceList;
  *v4 = a2;
  qword_140C214E8 = (__int64)a2;
