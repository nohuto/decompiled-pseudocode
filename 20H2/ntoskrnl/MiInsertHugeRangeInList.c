/*
 * XREFs of MiInsertHugeRangeInList @ 0x140531B08
 * Callers:
...
unsigned __int64 __fastcall MiInsertHugeRangeInList(int a1, char a2, _QWORD *a3)
{
  ...
  v6 = (unsigned __int64 *)(qword_140C4E4F0 + 8 * v3);
  if ( a3 )
    v7 = a3;
  else
    v7 = (_QWORD *)MiHugePfnPartition((_QWORD *)(qword_140C4E4F0 + 8 * v3));
  v8 = v7[770];
  v9 = MiSearchNumaNodeTable(v3 << 18);
  v10 = (unsigned int)dword_140C4DE00[0];
...
LABEL_14:
  ...
  {
    *v6 = v22 | v20;
    result = v21 | *(_QWORD *)(qword_140C4E4F0 + 8 * v20) & 0xFFFFFF80001FFFFFuLL;
    *(_QWORD *)(qword_140C4E4F0 + 8 * v20) = result;
  }
  else
  {
    *v6 = v22;
