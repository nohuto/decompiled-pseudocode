/*
 * XREFs of ExpAllocateAsid @ 0x1405B6CDC
 * Callers:
...
__int64 ExpAllocateAsid()
{
  ...
  {
    v15 = dword_140C16784;
    if ( (_DWORD)dword_140C16784 != dword_140C16788 )
      break;
    if ( (_DWORD)dword_140C16784 == ExpSvmAgents )
    {
    ...
    KeAcquireInStackQueuedSpinLock(&qword_140C16798, &LockHandle);
    v9 = PoolWithTag;
    if ( v15 == (_DWORD)dword_140C16784 )
    {
      v9 = qword_140C16790;
      if ( qword_140C16790 )
        memmove(PoolWithTag, qword_140C16790, 16LL * v15);
      memset(&PoolWithTag[16 * v15], 0, 16LL * (v7 - v15));
      qword_140C16790 = PoolWithTag;
      LODWORD(dword_140C16784) = v7;
    }
    if ( v9 )
    {
      KeReleaseInStackQueuedSpinLockFromDpcLevel(&LockHandle);
  ...
  v16 = (_KPROCESS **)qword_140C16790;
  v17 = 0;
  if ( (_DWORD)dword_140C16784 )
  {
    while ( *v16 )
    {
      v16 += 2;
      if ( ++v17 >= (unsigned int)dword_140C16784 )
        goto LABEL_43;
    }
    v16[1] = (_KPROCESS *)1;
    *v16 = Process;
