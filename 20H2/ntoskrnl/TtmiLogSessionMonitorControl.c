/*
 * XREFs of TtmiLogSessionMonitorControl @ 0x1409064B8
 * Callers:
...
void __fastcall TtmiLogSessionMonitorControl(int a1)
{
  ...
  if ( (unsigned int)dword_140D2D8E8 > 5 )
  {
    if ( tlgKeywordOn((__int64)&dword_140D2D8E8, 1LL) )
    {
      ...
      v15 = 4LL;
      v17 = 4LL;
      tlgWriteTransfer_EtwWriteTransfer((__int64)&dword_140D2D8E8, (unsigned __int8 *)byte_14002A0AD, 0LL, 0LL, 6u, &v9);
    }
  }
}
