/*
 * XREFs of MiSystemFault @ 0x1402989E0
 * Callers:
...
__int64 __fastcall MiSystemFault(_QWORD *a1)
{
  ...
  if ( v4 >= 0xFFFFF68000000000uLL && v4 <= 0xFFFFF6FFFFFFFFFFuLL && v5 >= qword_140C4F9B8 && v5 <= qword_140C4E1E8 )
    a1[1] |= 2uLL;
  v8 = 0;
  ...
  if ( (a1[1] & 0x100000000000000LL) != 0 )
  {
    if ( v4 < 0xFFFFF68000000000uLL
      ...
      || v5 > 0x7FFFFFFEFFFFLL && (v5 < qword_140C4F9B8 || v5 > qword_140C4E1E8) )
    {
      return 3489660934LL;
    }
    return 192LL;
  ...
  if ( v5 < 0xFFFF800000000000uLL
    || v5 >= qword_140C4E1E0
    && v5 < qword_140C4E1E0 + MiHyperSpaceSize(v4, 0x100000000000000LL, 0xFFFFF68000000000uLL, 0xFFFFF6FFFFFFFFFFuLL) )
  {
    return 192LL;
  }
  ...
  if ( dword_140C4E3C4 )
  {
    v39 = ExAcquireSpinLockShared(&dword_140C4E3C0);
    v40 = (_QWORD *)qword_140C4E3C8;
    v41 = v39;
    if ( qword_140C4E3C8 )
    {
      do
...
LABEL_21:
  HIDWORD(v59[0]) = 1;
  v20 = (unsigned __int8)byte_140C4F848[((v5 >> 39) & 0x1FF) - 256];
  if ( (a1[10] & 8) != 0 )
  {
    if ( v20 == 6 )
      goto LABEL_28;
  ...
  if ( v20 == 8 )
  {
    SessionVm = (char *)&unk_140C52840;
  }
  else if ( v20 == 1 )
  {
    SessionVm = (char *)MiGetSessionVm(byte_140C4F848, v9);
    if ( !SessionVm )
      goto LABEL_152;
    v8 = 1;
  }
...
LABEL_29:
  ...
  *(_OWORD *)(a1 + 7) = *(_OWORD *)&v59[3];
  ...
  if ( (v26 & 1) != 0 )
  {
    ...
    {
      MiCheckSystemNxFault(a1, v26, 2LL, v30);
      v30 = a1[2];
    }
