/*
 * XREFs of DrvDbSetDeviceIdMappedProperty @ 0x140722960
 * Callers:
...
LABEL_38:
      if ( a3 )
        v8 = a3;
      v24 = DrvDbSetRegValueMappedProperty(v17, v8, (__int64)v18, v19, (__int64)a6, a7);
      goto LABEL_21;
    }
    if ( v19 == 8210 )
    {
...
LABEL_18:
        if ( a3 )
          v8 = a3;
        v24 = DrvDbSetDeviceIdDriverInfMatches(v17, v8, v23);
LABEL_21:
        v8 = Handle;
        v21 = v24;
        goto LABEL_22;
