/*
 * XREFs of MiGetPoolPages @ 0x140333D10
 * Callers:
  ...
  if ( v4[8].Region )
  {
    ...
    if ( (a1 & 0x40000000) != 0 )
    {
      ...
      if ( v5 )
      {
        ...
        {
          MiFillPhysicalPages(
            (__int64)(v17 + 0xB000000000LL) / 48,
            (unsigned __int64)((unsigned __int128)((__int64)(v17 + 0xB000000000LL) * (__int128)0x2AAAAAAAAAAAAAABLL) >> 64) >> 63,
            0LL);
          v17 = (_QWORD *)*v17;
        }
        while ( v17 );
