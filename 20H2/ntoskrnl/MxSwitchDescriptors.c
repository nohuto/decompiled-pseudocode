/*
 * XREFs of MxSwitchDescriptors @ 0x140A961DC
 * Callers:
 *     MxGetNextPage @ 0x140A453C4 (MxGetNextPage.c)
 * Callees:
 *     MiSearchNumaNodeTable @ 0x1402AEBA0 (MiSearchNumaNodeTable.c)
 *     MiInitializeBootMemoryDescriptor @ 0x140A454C0 (MiInitializeBootMemoryDescriptor.c)
 */
