/*
 * XREFs of HalpTimerGetClockRates @ 0x1403CDB64
 * Callers:
 *     HalpTimerFindIdealWatchdog @ 0x1403B055C (HalpTimerFindIdealWatchdog.c)
 *     HalpTimerGetClockConfiguration @ 0x1403CDAB0 (HalpTimerGetClockConfiguration.c)
 *     HalpTimerInitializeSystemWatchdog @ 0x1404C0B10 (HalpTimerInitializeSystemWatchdog.c)
