/*
 * XREFs of HalpInterruptRegisterLine @ 0x1403B1230
 * Callers:
 *     HalpApicDescribeLines @ 0x1403B0E68 (HalpApicDescribeLines.c)
 *     HalpApicDescribeLocalLines @ 0x1403B0EF4 (HalpApicDescribeLocalLines.c)
