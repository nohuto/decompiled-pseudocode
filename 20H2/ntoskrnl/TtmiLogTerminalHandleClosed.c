/*
 * XREFs of TtmiLogTerminalHandleClosed @ 0x1409072F8
 * Callers:
...
void __fastcall TtmiLogTerminalHandleClosed(int a1)
{
  ...
  if ( (unsigned int)dword_140D2D8E8 > 5 )
  {
    if ( tlgKeywordOn((__int64)&dword_140D2D8E8, 1LL) )
    {
      ...
      v15 = 8LL;
      v17 = 8LL;
      tlgWriteTransfer_EtwWriteTransfer((__int64)&dword_140D2D8E8, (unsigned __int8 *)byte_14002ACC3, 0LL, 0LL, 6u, &v9);
    }
  }
}
