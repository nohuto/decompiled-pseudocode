/*
 * XREFs of PpmCheckReInit @ 0x1407B5B84
 * Callers:
 ...
 *     PpmCheckArmPeriod @ 0x1403C12E4 (PpmCheckArmPeriod.c)
 *     PpmPerfClearResponsivenessHints @ 0x1403C136C (PpmPerfClearResponsivenessHints.c)
 *     PopInterruptSteeringEnabled @ 0x1403C13C8 (PopInterruptSteeringEnabled.c)
 *     PpmPerfCheckRequired @ 0x1403C13E4 (PpmPerfCheckRequired.c)
...
__int64 (__fastcall ***PpmCheckReInit())()
{
  ...
  v0 = 0;
  v1 = 0;
  v2 = &PpmCurrentProfile[342 * dword_140C23D4C];
  v3 = 0;
