/*
 * XREFs of MiLogHotPatchManagement @ 0x1408CDB00
 * Callers:
...
void __fastcall MiLogHotPatchManagement(int a1, __int64 a2, unsigned __int16 *a3, int a4)
{
  ...
  if ( *(_QWORD *)&qword_140C4ED60 )
  {
    if ( a1 )
    {
      if ( a1 == 3 )
      {
        if ( **(_DWORD **)&qword_140C4ED60 > 5u && tlgKeywordOn(*(__int64 *)&qword_140C4ED60, 32LL) )
        {
          ...
          v44[1] = 0;
          v47 = 0;
          tlgWriteEx_EtwWriteEx(v4, (unsigned __int8 *)byte_140025431, v10, 1u, v14, v15, 9u, &v32);
        }
      }
      else if ( a1 == 1 )
      {
        if ( **(_DWORD **)&qword_140C4ED60 > 5u && tlgKeywordOn(*(__int64 *)&qword_140C4ED60, 32LL) )
        {
          ...
          v79 = 4LL;
          v81 = 4LL;
          tlgWriteEx_EtwWriteEx(v4, (unsigned __int8 *)&dword_14002549C, v11, 1u, v14, v15, 6u, &v73);
        }
      }
      else if ( a1 == 4 && **(_DWORD **)&qword_140C4ED60 > 5u && tlgKeywordOn(*(__int64 *)&qword_140C4ED60, 32LL) )
      {
        ...
        v71 = 4 * v12 + 8;
        v72 = 0;
        tlgWriteEx_EtwWriteEx(v4, (unsigned __int8 *)&word_1400254EE, v13, 1u, v14, v15, 7u, &v61);
      }
    }
    else if ( **(_DWORD **)&qword_140C4ED60 > 5u )
    {
      if ( tlgKeywordOn(*(__int64 *)&qword_140C4ED60, 32LL) )
      {
        ...
        v58 = 2LL;
        v60[1] = 0;
        tlgWriteEx_EtwWriteEx(v4, (unsigned __int8 *)&word_1400253D6, v8, 1u, v14, v15, 8u, &v48);
      }
    }
  }
}
