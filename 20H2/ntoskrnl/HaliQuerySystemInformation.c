/*
 * XREFs of HaliQuerySystemInformation @ 0x140992C80
 * Callers:
 *     <none>
 * Callees:
 *     HalpGetPlatformTimerInformation @ 0x14032E464 (HalpGetPlatformTimerInformation.c)
 *     HalpQueryNumaRangeTableInformation @ 0x1403CE4AC (HalpQueryNumaRangeTableInformation.c)
 *     HalpGetDisplayBiosInformation @ 0x1403CEF70 (HalpGetDisplayBiosInformation.c)
 *     xKdEnumerateDebuggingDevices @ 0x1403CFAD0 (xKdEnumerateDebuggingDevices.c)
 *     __security_check_cookie @ 0x1403CFAF0 (__security_check_cookie.c)
 *     memmove @ 0x140411040 (memmove.c)
 *     memset @ 0x140411300 (memset.c)
 *     HalpTimerQueryWatchdogType @ 0x1404B50F0 (HalpTimerQueryWatchdogType.c)
 *     HalpDpQueryMaxHotPlugMemoryAddress @ 0x1404BC358 (HalpDpQueryMaxHotPlugMemoryAddress.c)
 *     HalpHvQueryHyperlaunchEntrypoint @ 0x1404D06AC (HalpHvQueryHyperlaunchEntrypoint.c)
 *     HalpQueryHeterogeneousMemoryAttributesInterface @ 0x1406DDE3C (HalpQueryHeterogeneousMemoryAttributesInterface.c)
 *     HalpQueryPerDeviceMsiLimitInformation @ 0x1406DDE50 (HalpQueryPerDeviceMsiLimitInformation.c)
 *     xHalAllocatePmcCounterSet @ 0x140721A00 (xHalAllocatePmcCounterSet.c)
 ...
 *     HalpGetProcessorBrandString @ 0x1407C3A90 (HalpGetProcessorBrandString.c)
 ...
 *     HalpQuerySecondaryInterruptInformation @ 0x1407D0010 (HalpQuerySecondaryInterruptInformation.c)
 *     HalpDmaGetRemappingInformation @ 0x1407D06D8 (HalpDmaGetRemappingInformation.c)
 *     HalpGetMcaLog @ 0x140866A74 (HalpGetMcaLog.c)
 *     HalpQueryAcpiWakeAlarmSystemPowerState @ 0x140868730 (HalpQueryAcpiWakeAlarmSystemPowerState.c)
 *     HalpAuditQueryResults @ 0x140868AE4 (HalpAuditQueryResults.c)
 ...
 *     HalpQueryChannelTopologyInformation @ 0x140A90BE8 (HalpQueryChannelTopologyInformation.c)
 */
