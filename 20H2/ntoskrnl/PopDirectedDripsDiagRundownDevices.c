/*
 * XREFs of PopDirectedDripsDiagRundownDevices @ 0x1408F9FE4
 * Callers:
...
void PopDirectedDripsDiagRundownDevices()
{
  ...
  while ( 1 )
  {
    v0 = (char *)qword_140C1E890;
    if ( qword_140C1E890 == &qword_140C1E890 )
      break;
    if ( *((PVOID **)qword_140C1E890 + 1) != &qword_140C1E890
      || (v1 = *(_QWORD *)qword_140C1E890, *(PVOID *)(*(_QWORD *)qword_140C1E890 + 8LL) != qword_140C1E890) )
    {
      __fastfail(3u);
    }
    qword_140C1E890 = *(PVOID *)qword_140C1E890;
    v2 = 0;
    *(_QWORD *)(v1 + 8) = &qword_140C1E890;
    v3 = 0;
    v36 = 0;
    v4 = *((_DWORD *)v0 + 39);
    if ( v4 )
    ...
    if ( (v8 & 0x40000) != 0 )
    {
      ...
      v43 = (__int64)v9;
      if ( (unsigned int)dword_140D2D920 > 5 && tlgKeywordOn((__int64)&dword_140D2D920, 0x400000000000LL) )
      {
        LOBYTE(v37) = v35[0];
        v53 = 1LL;
        v52 = &v37;
        ...
        tlgWriteTransfer_EtwWriteTransfer(
          (__int64)&dword_140D2D920,
          (unsigned __int8 *)byte_140028E81,
          0LL,
          0LL,
          0x16u,
          &v51);
      ...
      if ( PopDiagHandleRegistered != v11 )
      {
        ...
        if ( EtwEventEnabled(PopDiagHandle, &POP_ETW_EVENT_DIRECTED_DRIPS_DEVICE_STATS) )
        {
          ...
          *(_QWORD *)&PopDirectedDripsDiagEventData.Size = 1LL;
          qword_140C1EAB0 = (__int64)(v0 + 16);
          qword_140C1EAB8 = 8LL;
          v38 = v10->Length >> 1;
          qword_140C1EAC0 = (__int64)&v38;
          qword_140C1EAC8 = 4LL;
          Length = v10->Length;
          qword_140C1EAD0 = (__int64)v10->Buffer;
          dword_140C1EAD8 = Length;
          dword_140C1EADC = 0;
          v39 = v48->Length >> 1;
          qword_140C1EAE0 = (__int64)&v39;
          qword_140C1EAE8 = 4LL;
          v19 = v48->Length;
          qword_140C1EAF0 = (__int64)v48->Buffer;
          dword_140C1EAF8 = v19;
          dword_140C1EAFC = 0;
          v40 = v12->Length >> 1;
          qword_140C1EB00 = (__int64)&v40;
          qword_140C1EB08 = 4LL;
          v20 = v12->Length;
          qword_140C1EB10 = (__int64)v12->Buffer;
          dword_140C1EB18 = v20;
          dword_140C1EB1C = 0;
          LODWORD(v41) = v13->Length >> 1;
          qword_140C1EB20 = (__int64)&v41;
          qword_140C1EB28 = 4LL;
          v21 = v13->Length;
          qword_140C1EB30 = (__int64)v13->Buffer;
          qword_140C1EB40 = (__int64)(v0 + 148);
          qword_140C1EB50 = (__int64)(v0 + 156);
          qword_140C1EB70 = (__int64)(v0 + 152);
          dword_140C1EB38 = v21;
          qword_140C1EB60 = (__int64)(v0 + 160);
          dword_140C1EB3C = 0;
          qword_140C1EB48 = 4LL;
          qword_140C1EB58 = 4LL;
          qword_140C1EB68 = 4LL;
