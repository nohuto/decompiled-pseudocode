/*
 * XREFs of AuthzBasepGetInternalSecurityAttributesCopyoutBufferSize @ 0x1405D6A90
 * Callers:
 *     AuthzBasepQueryInternalSecurityAttributesToken @ 0x1405D6A04 (AuthzBasepQueryInternalSecurityAttributesToken.c)
 * Callees:
 *     AuthzBasepGetInternalSecurityAttributeValueCopyoutBufferSize @ 0x140202984 (AuthzBasepGetInternalSecurityAttributeValueCopyoutBufferSize.c)
 */
