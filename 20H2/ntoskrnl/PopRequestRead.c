/*
 * XREFs of PopRequestRead @ 0x1409B4954
 * Callers:
 *     PopRestoreHiberContext @ 0x1409964E8 (PopRestoreHiberContext.c)
 *     PopDecompressCallback @ 0x1409B4370 (PopDecompressCallback.c)
 * Callees:
    ...
    do
    {
      if ( v8 )
      {
        if ( v8 != 1 )
        {
          ...
          v9 = __rdtsc();
          qword_140C23988 += v9 - *(_QWORD *)(BugCheckParameter3 + 336);
          ...
          v10 = __rdtsc();
          qword_140C239B8 += (((unsigned __int64)HIDWORD(v10) << 32) | (unsigned int)v10) - v9;
        ...
        v17 = __rdtsc();
        qword_140C239B0 += (((unsigned __int64)HIDWORD(v17) << 32) | (unsigned int)v17) - v14;
...
LABEL_34:
        ...
        v28 = __rdtsc();
        qword_140C239B0 += (((unsigned __int64)HIDWORD(v28) << 32) | (unsigned int)v28)
