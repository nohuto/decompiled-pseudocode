/*
 * XREFs of MiDeleteSubsectionPages @ 0x1402C7990
 * Callers:
...
__int64 __fastcall MiDeleteSubsectionPages(__int64 *BugCheckParameter2, __int64 a2)
{
  ...
  *(_QWORD *)&v41[4] = 0LL;
  ...
  v50 = 17;
  v45 = *(_QWORD *)(qword_140C4E4C8 + 8 * v5);
  v6 = *(_QWORD *)(v2 + 64);
  v7 = 0LL;
  *(_QWORD *)v41 = v6 != 0;
...
LABEL_33:
    ...
    *(_QWORD *)&v41[4] = v22;
    if ( (v22 & 1) != 0 )
    {
      ...
      if ( *(_WORD *)(v21 + 32) <= 2u )
        v10 = v17;
      if ( (MI_READ_PTE_LOCK_FREE((unsigned __int64)&v41[4]) & 0x1FF000) == 0 )
      {
    ...
    if ( (v22 & 0x800) != 0 )
    {
      if ( qword_140C4DDC0 && (v22 & 0x10) == 0 )
        LOWORD(v22) = ~(_WORD)qword_140C4DDC0 & v22;
      v7 = v39;
    ...
    {
      v43 = v22;
      v25 = MiCapturePageFileInfoInline(&v43, 0LL);
      v43 = v25;
      if ( v25 )
...
LABEL_77:
  if ( (v40 & 0x80u) == 0 || (v40 & 0x20) != 0 )
    return v7;
  v26 = MiDecrementSubsectionViewCount((_QWORD *)v3, 0);
