/*
 * XREFs of AlpcpDispatchConnectionRequest @ 0x1405E6138
 * Callers:
 ...
 *     PsGetProcessJob @ 0x14031B630 (PsGetProcessJob.c)
 *     PsGetJobEffectiveFreezeCount @ 0x14057F968 (PsGetJobEffectiveFreezeCount.c)
