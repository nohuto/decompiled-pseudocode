/*
 * XREFs of PsOpenProcess @ 0x1406023B0
 * Callers:
 *     NtAlpcOpenSenderProcess @ 0x1405E6F70 (NtAlpcOpenSenderProcess.c)
 *     NtOpenProcess @ 0x1406B9850 (NtOpenProcess.c)
 * Callees:
...
LABEL_38:
  ...
  if ( v17 && (unsigned int)dword_140C01AB0 > 5 && tlgKeywordOn((__int64)&dword_140C01AB0, 0x400000000000LL) )
  {
    ...
    v68 = &v45;
    v69 = 8LL;
    tlgWriteTransfer_EtwWriteTransfer((__int64)&dword_140C01AB0, (unsigned __int8 *)&word_14002B2FE, 0LL, 0LL, 8u, &v57);
  }
  *v46 = Handle;
  v26 = v30;
LABEL_46:
