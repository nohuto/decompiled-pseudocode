/*
 * XREFs of WmiQueryTraceInformation @ 0x140784CA0
 * Callers:
  ...
  if ( TraceInformationClass > TraceHandleByNameClass )
  {
    ...
    if ( v16 )
    {
      ...
      if ( !v18 )
      {
        ...
        *((_OWORD *)TraceInformation + 1) = *(_OWORD *)off_140989330;
        *((_OWORD *)TraceInformation + 2) = *(_OWORD *)&off_140989340;
        *((_OWORD *)TraceInformation + 3) = *(_OWORD *)&off_140989350;
        *((_OWORD *)TraceInformation + 4) = *(_OWORD *)off_140989360;
        *((_OWORD *)TraceInformation + 5) = *(_OWORD *)&off_140989370;
        *((_OWORD *)TraceInformation + 6) = *(_OWORD *)off_140989380;
