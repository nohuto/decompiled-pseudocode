/*
 * XREFs of EtwpTiFillVadEventWrite @ 0x14032B6A4
 * Callers:
 *     EtwpTiVadQueryEventWrite @ 0x1403251F8 (EtwpTiVadQueryEventWrite.c)
 *     EtwpTiVadQueryEventWriteCallback @ 0x1406DB530 (EtwpTiVadQueryEventWriteCallback.c)
 * Callees:
 *     EtwWriteEx @ 0x14020E0B0 (EtwWriteEx.c)
 *     EtwpTiFillVad @ 0x14032B7D8 (EtwpTiFillVad.c)
 */
  ...
  if ( a6 )
  {
    ...
    do
    {
      ...
      else
      {
        ...
        v14->Reserved = 0;
        v14->Ptr = (ULONGLONG)&qword_14000A868;
        v14->Size = 4;
        v14[1].Reserved = 0;
        v14[1].Ptr = (ULONGLONG)&qword_14000A868;
        v14[1].Size = 8;
        v14[2].Reserved = 0;
        v14[2].Ptr = (ULONGLONG)&qword_14000A868;
        v14[2].Size = 4;
        v14[3].Reserved = 0;
        v14[3].Ptr = (ULONGLONG)&qword_14000A868;
        v14[3].Size = 4;
        v14[4].Reserved = 0;
        v14[4].Ptr = (ULONGLONG)&qword_14000A868;
        v14[4].Size = 8;
        v14[5].Reserved = 0;
        v14[5].Ptr = (ULONGLONG)&qword_14000A868;
        v14[5].Size = 8;
        v14[6].Reserved = 0;
        UserDataCount += 7;
        v14[6].Ptr = (ULONGLONG)&qword_14000A868;
        v14[6].Size = 2;
      }
      ++v7;
    }
