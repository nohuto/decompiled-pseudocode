/*
 * XREFs of MmGrowKernelStackEx @ 0x1403299E0
 * Callers:
 ...
 *     MmGrowKernelStack @ 0x140534BB0 (MmGrowKernelStack.c)
 * Callees:
...
__int64 __fastcall MmGrowKernelStackEx(__int64 a1, __int64 a2)
{
  ...
  if ( (char *)CurrentThread->StackBase - (*((_QWORD *)CurrentThread->InitialStack + 1) & 0xFFFFFFFFFFFFFFFEuLL) < (void *)0x12000 )
    return 3221225659LL;
  v3 = 0;
  v4 = *(_QWORD *)(qword_140C4E4C8 + 8LL * CurrentThread->Process[1].IdealProcessorPadding[5]);
