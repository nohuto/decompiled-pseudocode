/*
 * XREFs of HalpTscTraceProcessorSynchronization @ 0x14039D774
 * Callers:
 *     HalpTscAdjustToLeader @ 0x14039D3D8 (HalpTscAdjustToLeader.c)
 *     HalpTscAdjustToTarget @ 0x1404BF5B8 (HalpTscAdjustToTarget.c)
 *     HalpTscAdvSynchToLeader @ 0x1404BF77C (HalpTscAdvSynchToLeader.c)
 *     HalpTscAdvSynchToTarget @ 0x1404BF998 (HalpTscAdvSynchToTarget.c)
 * Callees:
