/*
 * XREFs of MiInitializeSystemDefaults @ 0x140A74F48
 * Callers:
...
ULONG_PTR __fastcall MiInitializeSystemDefaults(__int64 a1)
{
  ...
  dword_140C4DD64 = LogicalProcessorsPerCore;
...
LABEL_23:
  ...
  {
    byte_140C00DE3 = 4;
    qword_140C4DDC0 = 1LL << ((unsigned __int8)KiImplementedPhysicalBits - 1);
