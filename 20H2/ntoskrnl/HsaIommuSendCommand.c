/*
 * XREFs of HsaIommuSendCommand @ 0x1404E2288
 * Callers:
 *     HsaDismissPageFault @ 0x1404E0F50 (HsaDismissPageFault.c)
 *     HsaFlushDeviceTbOnly @ 0x1404E11D0 (HsaFlushDeviceTbOnly.c)
...
unsigned __int64 __fastcall HsaIommuSendCommand(unsigned __int64 *a1, unsigned __int64 *a2, int a3)
{
  ...
  if ( v12 == ((*(_QWORD *)(v8 + 0x2000) >> 4) & 0x7FFFLL) )
  {
    do
    {
      if ( (++v11 & dword_140C4A25C) != 0 || !qword_140C4A260 )
      {
        _mm_pause();
      }
      else
  ...
  *(_QWORD *)(v8 + 8200) = ((unsigned int)v9 ^ (16 * (_DWORD)v13)) & 0x7FFF0 ^ v9;
  ...
  if ( (_BYTE)result == 1 )
  {
    ...
    while ( 1 )
    {
      ...
      if ( !result )
        break;
      if ( (++v16 & dword_140C4A25C) != 0 || !qword_140C4A260 )
        _mm_pause();
      else
        qword_140C4A260(v16);
    }
