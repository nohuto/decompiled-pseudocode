/*
 * XREFs of MiDeleteNonPagedPoolPte @ 0x1403015D0
 * Callers:
  ...
  if ( v31[0] >= 0 )
  {
    ...
    if ( a3 == 1 )
    {
      if ( (*(_QWORD *)(v12 + 24) & 0x3FFFFFFFFFFFFFFFLL) != 1
        || !(unsigned int)MiEvictPageTableLock((__int64)&unk_140C4F4C0, a2, ZeroPte, 2) )
      {
        return 0LL;
      }
LABEL_12:
...
LABEL_24:
      v25 = *(_QWORD *)v31;
      if ( qword_140C4DDC0 && (v31[0] & 0x10) == 0 )
        v25 = *(_QWORD *)v31 & ~qword_140C4DDC0;
