/*
 * XREFs of ExpResizeBigPageTable @ 0x1403750AC
 * Callers:
...
__int64 __fastcall ExpResizeBigPageTable(char a1, __int64 a2, _QWORD *a3)
{
  ...
  *a3 = 0LL;
  ...
  if ( v5 )
  {
    v6 = *(_QWORD **)(qword_140C4DC60 + 992);
    v7 = (int *)(qword_140C4DC60 + 864);
    v8 = *(_QWORD *)(qword_140C4DC60 + 1000);
...
LABEL_16:
  ...
  *(_DWORD *)(v18 + 8 * v20 + 12) = v21;
  ...
  if ( v5 )
  {
    *(_QWORD *)(qword_140C4DC60 + 992) = v13;
    *(_QWORD *)(qword_140C4DC60 + 1000) = v9;
  }
  else
  {
