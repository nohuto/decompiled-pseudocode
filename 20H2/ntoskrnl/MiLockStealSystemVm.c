/*
 * XREFs of MiLockStealSystemVm @ 0x140321C88
 * Callers:
...
__int64 __fastcall MiLockStealSystemVm(__int64 a1, unsigned __int8 a2, unsigned __int64 a3, __int64 a4)
{
  ...
  v52 = a3;
  v6 = a2;
  v7 = *(_QWORD *)(qword_140C4E4C8 + 8 * ((*(_QWORD *)(a1 + 40) >> 39) & 0x3FFLL));
  v53 = v7;
  v8 = (__int64)(a3 << 25) >> 16;
...
LABEL_54:
    if ( !(unsigned int)MiSynchronizeSystemVa((__int64)v20, v8, SystemRegionType, v11, a4) )
      goto LABEL_58;
...
LABEL_58:
    ...
    if ( ((unsigned int)(*(_DWORD *)(a4 + 48) - 2) <= 1
      ...
      && *(_QWORD *)(qword_140C4E4C8 + 8 * ((*(_QWORD *)(a1 + 40) >> 39) & 0x3FFLL)) == v53
      && !(unsigned int)MI_PFN_IS_PROTO(a1) )
    {
      IsPfnFileOnly = MiIsPfnFileOnly(v43);
      if ( IsPfnFileOnly != v45 && !(unsigned int)MiIsPfnFromSlabAllocation(a1) )
        return v46;
    }
    goto LABEL_58;
  }
