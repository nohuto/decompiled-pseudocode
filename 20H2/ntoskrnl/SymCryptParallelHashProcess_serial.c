/*
 * XREFs of SymCryptParallelHashProcess_serial @ 0x1403EEF8C
 * Callers:
 *     SymCryptParallelSha256Process @ 0x1403EE764 (SymCryptParallelSha256Process.c)
 * Callees:
 *     SymCryptWipe @ 0x1403EECC4 (SymCryptWipe.c)
 *     _guard_dispatch_icall_nop @ 0x1403F7950 (_guard_dispatch_icall_nop.c)
