/*
 * XREFs of ExInitializeSessionHeapManager @ 0x14039D984
 * Callers:
 ...
 *     MiSessionPoolTrackTable @ 0x1406E42B0 (MiSessionPoolTrackTable.c)
 *     MiSessionPoolTrackTableSize @ 0x1407D0AB8 (MiSessionPoolTrackTableSize.c)
