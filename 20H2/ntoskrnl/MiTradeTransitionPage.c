/*
 * XREFs of MiTradeTransitionPage @ 0x140350BC0
 * Callers:
  ...
  else
  {
    if ( (unsigned int)MiCanPageMove(BugCheckParameter2, a2) && !MiIsPfnFromSlabAllocation(BugCheckParameter2) )
    {
      ...
      if ( a4 == -1 )
      {
        ...
        v13 = 128LL;
        v14 = (PfnChannel << byte_140C4DD0D) | dword_140C4DD78 & v10 | (v11 << byte_140C4DD0C);
        if ( (a5 & 0x3000000) != 0 )
          v13 = 65664LL;
      }
      else
      {
        v13 = 48LL;
        v14 = dword_140C4DD78 & v10 | a4 & ~dword_140C4DD78;
      }
...
LABEL_19:
      ...
      else
      {
        ...
        if ( !IsPfnFromSlabAllocation
          ...
          && v44 == *(_QWORD *)(qword_140C4E4C8 + 8 * ((*(_QWORD *)(BugCheckParameter2 + 40) >> 39) & 0x3FFLL))
