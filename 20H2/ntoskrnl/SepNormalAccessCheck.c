/*
 * XREFs of SepNormalAccessCheck @ 0x140226B20
 * Callers:
        ...
        char a14)
{
  ...
  unsigned int v59; // [rsp+6Ch] [rbp-6Ch]
...
LABEL_63:
          v43 = (_DWORD *)(a13 + 4);
          SepMatchPackage(a2, v59, v24 + 8, *(unsigned int *)(v24 + 4), a13 + 21, a13 + 4, a13 + 20, a13 + 16, a13 + 24);
        }
        else
        {
...
LABEL_88:
          v43 = (_DWORD *)(a13 + 8);
          SepMatchCapability(a2, v59, v24 + 8, *(_DWORD *)(v24 + 4), (_BYTE *)(a13 + 22), (_DWORD *)(a13 + 8));
        }
        v44 = ~*v43;
        v57 = v44 & v20;
        *(_DWORD *)a13 &= v44;
