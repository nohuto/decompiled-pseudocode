/*
 * XREFs of HalpBlkAddVirtualMapping @ 0x140A90CEC
 * Callers:
 ...
 *     HalpBlkShadowApic @ 0x140A911A8 (HalpBlkShadowApic.c)
 *     HalpBlkShadowStartupBlock @ 0x140A911FC (HalpBlkShadowStartupBlock.c)
 * Callees:
 *     HalpRemapVirtualAddress64 @ 0x140311558 (HalpRemapVirtualAddress64.c)
