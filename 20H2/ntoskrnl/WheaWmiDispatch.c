/*
 * XREFs of WheaWmiDispatch @ 0x1403CC0B0
 * Callers:
 *     <none>
 * Callees:
 *     WheapWmiRegisterInfo @ 0x1403CC10C (WheapWmiRegisterInfo.c)
 *     WheapWmiExecuteMethod @ 0x1405BC360 (WheapWmiExecuteMethod.c)
 *     WheapWmiGetAllData @ 0x1405BC588 (WheapWmiGetAllData.c)
 *     WheapWmiGetSingleInstance @ 0x1405BC5EC (WheapWmiGetSingleInstance.c)
 */
