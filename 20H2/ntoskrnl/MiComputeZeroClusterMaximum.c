/*
 * XREFs of MiComputeZeroClusterMaximum @ 0x14023C1EC
 * Callers:
...
unsigned __int64 __fastcall MiComputeZeroClusterMaximum(__int64 a1, __int64 a2, __int64 a3)
{
  ...
  v11 = 20000LL;
  v12 = *(_QWORD *)(qword_140C4E4C8 + 8 * v10);
  v13 = *(_QWORD *)(*(_QWORD *)(v12 + 6848) + 2384LL);
  v14 = 20000LL;
  if ( v13 > 0x4E20 )
    v14 = *(_QWORD *)(*(_QWORD *)(v12 + 6848) + 2384LL);
  ...
  {
    if ( v13 > 0x4E20 )
      v11 = *(_QWORD *)(*(_QWORD *)(v12 + 6848) + 2384LL);
    v15 = v11 >> 1;
  }
