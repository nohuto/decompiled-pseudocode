/*
 * XREFs of KdpReadPhysicalMemory @ 0x1409BA870
 * Callers:
 *     KdpReadPhysicalMemoryLong @ 0x1409BA9C0 (KdpReadPhysicalMemoryLong.c)
 *     KdpSendWaitContinue @ 0x1409BB4F4 (KdpSendWaitContinue.c)
 * Callees:
 *     RunLengthEncode @ 0x14050FB68 (RunLengthEncode.c)
