/*
 * XREFs of EtwpExpandFileName @ 0x1406E08A0
 * Callers:
...
__int64 __fastcall EtwpExpandFileName(char a1, UNICODE_STRING *a2, unsigned int a3, unsigned __int16 *a4)
{
  ...
  else
  {
    ...
    {
      v15 = *a4 + 56LL + CurrentServerSiloGlobals[536];
    }
    else
    {
      v14 = a2->Length;
      v15 = (unsigned int)CurrentServerSiloGlobals[536] - Length + (_DWORD)v14 + 2;
  ...
  if ( PoolWithTag )
  {
    if ( v6 )
    {
      ...
      else
      {
        ...
        v22 = RtlStringCbPrintfW(v19, v17, L"%ws%ws%ws", v21[135], &a2->Buffer[v31], v20);
      }
    }
    else if ( a1 )
    {
