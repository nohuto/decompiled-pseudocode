/*
 * XREFs of RtlpHpLfhSubsegmentSizeBlock @ 0x140593720
 * Callers:
 *     RtlpHpSegSizeInternal @ 0x140593690 (RtlpHpSegSizeInternal.c)
 * Callees:
 *     RtlpHpLfhSubsegmentSizeBlockInternal @ 0x1405937DC (RtlpHpLfhSubsegmentSizeBlockInternal.c)
 */
