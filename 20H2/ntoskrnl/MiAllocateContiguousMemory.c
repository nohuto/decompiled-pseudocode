/*
 * XREFs of MiAllocateContiguousMemory @ 0x14025FFCC
 * Callers:
 *     MmAllocateContiguousNodeMemory @ 0x14025FF30 (MmAllocateContiguousNodeMemory.c)
 *     MmAllocateContiguousMemory @ 0x14052FBE0 (MmAllocateContiguousMemory.c)
 * Callees:
        ...
        unsigned int a6)
{
  ...
  if ( !a4 || (v15 = 0, v14 <= a4) )
  {
    ...
    {
      v20 = MiProtectionToCacheAttribute(v10, 0LL, MmProtectFreedNonPagedPool != 0);
      v21 = a6;
      v48 = v20;
      ...
      v23 = (_DWORD *)(qword_140C4DD18 + 4LL * v22 * (unsigned __int16)KeNumberNodes);
      if ( v21 == 0x80000000 )
...
LABEL_20:
      v47 = 135266304;
      v25 = (_DWORD *)(qword_140C4DD18 + 4LL * v22 * (unsigned __int16)KeNumberNodes);
