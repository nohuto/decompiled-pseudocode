/*
 * XREFs of IovpCompleteRequest2 @ 0x1409D3600
 * Callers:
 ...
 *     IovpSessionDataReference @ 0x1409E49A8 (IovpSessionDataReference.c)
 */
...
void __fastcall IovpCompleteRequest2(ULONG_PTR a1, __int64 a2)
{
  ...
  *(_BYTE *)(v5 + 16) = KeAcquireSpinLockRaiseToDpc((PKSPIN_LOCK)(v5 + 8));
  ...
  if ( (v14 & 2) == 0 && (v2[v7 - 9] & 0x4000000) != 0 && !*(_BYTE *)(a1 + 65) )
  {
    ...
    {
      ViErrorReport6(574LL, *(const void **)&v2[v7], (const void *)a1, v33);
      v14 = v2[8];
    }
    v2[8] = v14 | 2;
  }
...
LABEL_38:
    ...
    {
      if ( (unsigned int)VfMajorAdvanceIrpStatus(v13, v32, &v33) )
      {
  ...
  *(_BYTE *)(v5 + 186) = *(_BYTE *)(a1 + 67) + 1;
  if ( v24 == *(char *)(a1 + 67) )
  {
    ...
    *(_QWORD *)(v25 + 240) = 0LL;
    ...
    if ( v26 )
    {
      ViIrpDatabaseAcquireLockExclusive((KIRQL *)&v32);
      v27 = *(_QWORD *)v5;
      ...
      *(_QWORD *)v5 = 0LL;
      VfUtilAddressRangeRemoveCheckEmpty(
        ...
        v27);
      ViIrpDatabaseReleaseLockExclusive(v32);
    }
