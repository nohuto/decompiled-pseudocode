/*
 * XREFs of MiRebaseDynamicRelocationRegions @ 0x140A4ECEC
 * Callers:
...
__int64 __fastcall MiRebaseDynamicRelocationRegions(__int64 a1)
{
  ...
  v5 = qword_140C4F9D8;
  v22 = qword_140C4F998;
  if ( (MiFlags & 0x8000) == 0 && qword_140C4F9D8 == 0xFFFFF68000000000uLL )
    goto LABEL_18;
  v6 = ((unsigned __int64)qword_140C4F9D8 >> 39) & 0x1FF;
  v7 = 0;
