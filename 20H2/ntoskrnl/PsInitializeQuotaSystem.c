/*
 * XREFs of PsInitializeQuotaSystem @ 0x140A6F1BC
 * Callers:
 *     InitBootProcessor @ 0x140A3CF64 (InitBootProcessor.c)
 *     MiInitSystem @ 0x140A52854 (MiInitSystem.c)
 * Callees:
 *     PspRegisterResource @ 0x1403C8840 (PspRegisterResource.c)
 *     PspSanitizeResourceLimits @ 0x1407C27A0 (PspSanitizeResourceLimits.c)
...
char __fastcall PsInitializeQuotaSystem(int a1)
{
  ...
  if ( a1 )
  {
    ...
    dword_140C1DFF8 = 0;
    qword_140C1E008 = 0LL;
    qword_140C1DFF0 = (__int64)&qword_140C1DFE8;
    qword_140C1DFE8 = (__int64)&qword_140C1DFE8;
    qword_140C1E028 = (__int64)&qword_140C1E020;
    qword_140C1E020 = (__int64)&qword_140C1E020;
    qword_140C1DFC8[0] = 0x10000LL;
    qword_140C1DFD8 = (__int64)MmRaisePoolQuota;
    qword_140C1DFE0 = (__int64)MmReturnPoolQuota;
    PspQuotaExpansionDescriptors[0] = 1;
    qword_140C1E000 = 0x80000LL;
    qword_140C1E010 = (__int64)MmRaisePoolQuota;
    qword_140C1E018 = (__int64)MmReturnPoolQuota;
LABEL_9:
