/*
 * XREFs of PoFxInitPowerManagement @ 0x140A70760
 * Callers:
...
__int64 PoFxInitPowerManagement()
{
  ...
  stru_140C24780.Header.Size = 6;
  *(_QWORD *)&PopFxResidentTimer.Header.Lock = 9LL;
  qword_140C24608 = (__int64)&PopFxDeviceList;
  PopFxDeviceList = (ULONG_PTR)&PopFxDeviceList;
  qword_140C24618 = (__int64)&PopFxAcpiDeviceList;
  PopFxAcpiDeviceList = (__int64)&PopFxAcpiDeviceList;
  qword_140C24748 = (__int64)&PopWorkOrderList;
  PopWorkOrderList = (__int64)&PopWorkOrderList;
  qword_140C24730 = (__int64)PopFxResidentTimeoutRoutine;
  qword_140C24770 = (__int64)&qword_140C24768;
  qword_140C24768 = (__int64)&qword_140C24768;
  stru_140C24780.Header.WaitListHead.Blink = &stru_140C24780.Header.WaitListHead;
  stru_140C24780.Header.WaitListHead.Flink = &stru_140C24780.Header.WaitListHead;
  ...
  qword_140C24658 = (__int64)&PopFxPluginList;
  ...
  LOWORD(stru_140C24780.Header.Lock) = 0;
  stru_140C24780.Header.SignalState = 1;
  ...
  memset(&byte_140C247A1, 0, 0x6FuLL);
  ...
  qword_140C24678 = (__int64)&SocSubsystemsList;
  ...
  *(_QWORD *)&PopPepIdleTimer.Header.Lock = 9LL;
  qword_140C214E8 = (__int64)&PopPepDeviceList;
  PopPepDeviceList = (__int64)&PopPepDeviceList;
  qword_140C21550 = (__int64)PopPepIdleTimeoutRoutine;
