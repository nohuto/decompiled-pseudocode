/*
 * XREFs of MiProbeLeafPteAccess @ 0x14026CA10
 * Callers:
...
LABEL_29:
  v22 = 0;
  if ( v6 >= v14 )
    v23 = (unsigned __int8)byte_140C4F848[((v6 >> 39) & 0x1FF) - 256];
  else
    v23 = 0;
  if ( v7 == 6 && v23 == 12 )
    v22 = 1;
...
LABEL_110:
  v46 = MiCopyOnWrite(v6, *(_QWORD *)(a1 + 16), -1LL, 0LL);
  if ( v46 >= 0 )
  {
LABEL_116:
    *v48 = 1;
