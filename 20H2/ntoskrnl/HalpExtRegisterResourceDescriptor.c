/*
 * XREFs of HalpExtRegisterResourceDescriptor @ 0x1404C2980
 * Callers:
 *     <none>
 * Callees:
 ...
 *     HalpExtGetRegisteredResourceIdString @ 0x1404C292C (HalpExtGetRegisteredResourceIdString.c)
 *     HalpRegisterDmaChannel @ 0x1404CDA2C (HalpRegisterDmaChannel.c)
  ...
  else
  {
    ...
    while ( 1 )
    {
      ...
      if ( *(_DWORD *)(v11 + 4) == v10
        ...
        && *(_DWORD *)(MemoryInternal + 36) == *(_DWORD *)(a3 + 8) )
      {
        break;
      }
    ...
    if ( *(int *)(MemoryInternal + 16) >= 0 )
      KeBugCheckEx(0x5Cu, 0x300uLL, MemoryInternal, a2, *(unsigned int *)(a3 + 8));
    v13 = *(_QWORD *)MemoryInternal;
    if ( *(_QWORD *)(*(_QWORD *)MemoryInternal + 8LL) != MemoryInternal
      || (v14 = *(__int64 **)(MemoryInternal + 8), *v14 != MemoryInternal) )
    {
LABEL_24:
      __fastfail(3u);
    }
  ...
  *(_QWORD *)(MemoryInternal + 8) = v15;
  *v15 = MemoryInternal;
  *(_QWORD *)(v8 + 8) = MemoryInternal;
  RtlInitUnicodeString(&DestinationString, L"Unknown Resource");
  if ( (int)HalpExtGetRegisteredResourceIdString(MemoryInternal, v16, SourceString) >= 0 )
