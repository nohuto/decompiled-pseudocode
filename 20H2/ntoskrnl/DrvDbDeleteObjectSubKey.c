/*
 * XREFs of DrvDbDeleteObjectSubKey @ 0x14097F68C
 * Callers:
 *     DrvDbDeleteObjectRegKey @ 0x14097F524 (DrvDbDeleteObjectRegKey.c)
 * Callees:
 ...
 *     _PnpCtxRegEnumValue @ 0x1406E4590 (_PnpCtxRegEnumValue.c)
 *     _PnpCtxRegQueryInfoKey @ 0x1406E6C64 (_PnpCtxRegQueryInfoKey.c)
...
LABEL_7:
  ...
  if ( v13 < 0 )
    goto LABEL_7;
  for ( i = PnpGetGenericStorePropertyKeys(*a1, (int)Handle, 0LL, 0, 0LL, 0, &v43);
        ;
        i = PnpGetGenericStorePropertyKeys(*a1, (int)Handle, 0LL, 0, (__int64)PoolWithTag, v17, &v43) )
  {
    inited = i;
    if ( i != -1073741789 )
      break;
