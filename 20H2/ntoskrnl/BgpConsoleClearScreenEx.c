/*
 * XREFs of BgpConsoleClearScreenEx @ 0x1409F9718
 * Callers:
...
__int64 BgpConsoleClearScreenEx()
{
  ...
  v0 = qword_140CDAFD8;
  v1 = *(_DWORD *)(qword_140CDAFD8 + 16);
  *(_DWORD *)(qword_140CDAFD8 + 68) = 0;
  *(_DWORD *)(v0 + 72) = 0;
  v2 = BgpClearScreen(v1);
  if ( v2 >= 0 )
  {
    v3 = (_DWORD *)qword_140CDAFD8;
    v4 = 0LL;
    v5 = *(_DWORD *)(qword_140CDAFD8 + 4);
    v6 = 80LL;
    do
    {
