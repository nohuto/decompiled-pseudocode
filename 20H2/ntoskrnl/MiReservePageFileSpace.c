/*
 * XREFs of MiReservePageFileSpace @ 0x1403481F0
 * Callers:
...
LABEL_15:
  ...
  {
    v38 = v20;
    if ( qword_140C4DDC0 && (v20 & 0x10) == 0 )
      v38 = v20 & ~qword_140C4DDC0;
  ...
  else
  {
    ...
    if ( qword_140C4DDC0 && (v23 & 0x10) == 0 )
      v39 = v23 & ~qword_140C4DDC0;
    if ( v27 < HIDWORD(v39) )
    {
      if ( qword_140C4DDC0 && (v23 & 0x10) == 0 )
        v40 = ~qword_140C4DDC0 & v23;
...
LABEL_36:
    ...
    for ( i = a2 - Address; i <= v32; updated = Address )
    {
      ...
      v37 = v36;
      if ( qword_140C4DDC0 && (v36 & 0x10) == 0 )
        v36 &= ~qword_140C4DDC0;
      if ( v37 && qword_140C4DDC0 )
      {
        if ( (v37 & 0x10) != 0 )
          LODWORD(v37) = v37 & 0xFFFFFFEF;
        else
          LODWORD(v37) = ~(_DWORD)qword_140C4DDC0 & v37;
      }
