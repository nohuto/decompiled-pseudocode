/*
 * XREFs of HalpMmAllocCtxAlloc @ 0x14037C7B8
 * Callers:
 ...
 *     HalpRegisterUsbController @ 0x1404D58C8 (HalpRegisterUsbController.c)
...
LABEL_30:
    v29 = 0LL;
    LOBYTE(v8) = KeAcquireSpinLockRaiseToDpc(&qword_140C4B8B0);
    goto LABEL_22;
  }
  v6 = KeAcquireSpinLockRaiseToDpc(&qword_140C4B8B0);
