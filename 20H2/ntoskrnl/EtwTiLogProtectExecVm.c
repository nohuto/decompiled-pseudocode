/*
 * XREFs of EtwTiLogProtectExecVm @ 0x14069A054
 * Callers:
 ...
 *     EtwpTiFillThreadIdentity @ 0x1402EC054 (EtwpTiFillThreadIdentity.c)
...
BOOLEAN EtwTiLogProtectExecVm(__int64 a1, char a2, ...)
{
  ...
  if ( result )
  {
    ...
    v9 = *(const EVENT_DESCRIPTOR **)((char *)off_140006318 + (a2 != 0 ? 0 : 0x10) + v5);
