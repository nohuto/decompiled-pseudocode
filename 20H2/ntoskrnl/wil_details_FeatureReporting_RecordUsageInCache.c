/*
 * XREFs of wil_details_FeatureReporting_RecordUsageInCache @ 0x1402FD858
 * Callers:
 ...
 * Callees:
 *     wil_details_FeatureReporting_IncrementOpportunityInCache @ 0x1404EAE30 (wil_details_FeatureReporting_IncrementOpportunityInCache.c)
 *     wil_details_FeatureReporting_IncrementUsageInCache @ 0x1404EAF24 (wil_details_FeatureReporting_IncrementUsageInCache.c)
 */
