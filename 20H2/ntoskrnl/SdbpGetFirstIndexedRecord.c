/*
 * XREFs of SdbpGetFirstIndexedRecord @ 0x140752EDC
 * Callers:
 ...
 *     SdbpBinarySearchFirst @ 0x140753900 (SdbpBinarySearchFirst.c)
 *     SdbpBinarySearchUnique @ 0x14077ADA8 (SdbpBinarySearchUnique.c)
 */
