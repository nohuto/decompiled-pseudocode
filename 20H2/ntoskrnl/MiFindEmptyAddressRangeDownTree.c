/*
 * XREFs of MiFindEmptyAddressRangeDownTree @ 0x1406B5614
 * Callers:
 *     MiFinishCreateSection @ 0x14067F9E0 (MiFinishCreateSection.c)
 *     MiFindEmptyAddressRangeDown @ 0x1406B5500 (MiFindEmptyAddressRangeDown.c)
 * Callees:
 *     MiHonorRangeStraddleRequirement @ 0x14030CDBC (MiHonorRangeStraddleRequirement.c)
