...
LABEL_45:
  ...
  if ( (*((_DWORD *)Object + 20) & 2) != 0 )
  {
    ...
    if ( _InterlockedExchange(v33 + 29, 1) )
    {
      ...
      LOBYTE(v34) = v53[0];
      v29 = (struct _DMA_ADAPTER *)Object;
      v37 = IopWaitAndAcquireFileObjectLock((volatile signed __int32 *)Object, v34, v35, v36, &v53[2]);
    }
    else
    {
      if ( v36 )
...
LABEL_68:
  ...
  v40 = (IRP *)IopAllocateIrpExReturn((__int64)DeviceObject, v39, 0LL, retaddr);
  Irp = v40;
  v59 = v40;
  if ( !v40 )
  {
...
LABEL_90:
  ...
  result = IopSynchronousServiceTail(v45, Irp, (__int64)v29, 0, v53[0], v52, 2u);
  if ( !v52 )
