/*
 * XREFs of EtwpRegisterPartitionPages @ 0x1405AED64
 * Callers:
...
char __fastcall EtwpRegisterPartitionPages(__int64 a1, __int64 a2, __int64 a3)
{
  ...
  PoolWithTag[2] = a2;
  PoolWithTag[3] = a1;
  v9 = ExAcquireSpinLockExclusive(&dword_140C19710);
  if ( EtwpMdlTable >= 2 * ((unsigned int)dword_140C19704 >> 5) )
  {
    v10 = 2 * ((unsigned int)dword_140C19704 >> 5);
    ...
    if ( v11 )
    {
      ...
      v14 = dword_140C19704;
      v15 = 0;
      v16 = -1LL << (dword_140C19704 & 0x1F);
      if ( (dword_140C19704 & 0xFFFFFFE0) != 0 )
      {
        do
        {
          v17 = qword_140C19708;
        ...
        while ( v15 < (unsigned int)dword_140C19704 >> 5 );
      }
      v20 = (void *)qword_140C19708;
      qword_140C19708 = (__int64)v11;
      dword_140C19704 = (32 * v10) | v14 & 0x1F;
      if ( v20 )
        EtwpMdlHashTableDeallocator(v20);
    }
    else if ( (dword_140C19704 & 0xFFFFFFE0) == 0 )
    {
      goto LABEL_25;
    }
  }
  v6 = 1;
  v29 = v8[1] & (-1LL << (dword_140C19704 & 0x1F));
  v21 = qword_140C19708;
  v22 = (37
       * (BYTE6(v29)
        + 37
       ...
       + HIBYTE(v29)) & (((unsigned int)dword_140C19704 >> 5) - 1);
  *v8 = *(_QWORD *)(qword_140C19708 + 8 * v22);
  *(_QWORD *)(v21 + 8 * v22) = v8;
  ++EtwpMdlTable;
LABEL_25:
  ExReleaseSpinLockExclusiveFromDpcLevel(&dword_140C19710);
  if ( KiIrqlFlags )
  {
    if ( (KiIrqlFlags & 1) != 0 )
    {
