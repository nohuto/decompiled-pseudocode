/*
 * XREFs of ExAllocateContiguousHeapPool @ 0x1402603B0
 * Callers:
        ...
        unsigned int a5)
{
  ...
  if ( v12 > *(_QWORD *)(*(_QWORD *)qword_140C4E4C8 + 6912LL)
    || a2 < *(_QWORD *)(*(_QWORD *)qword_140C4E4C8 + 6920LL)
  ...
  v16 = RtlpHpSegAlloc(v14, v15, v15, v15, 0x800000);
  v8 = v16;
  if ( !v16 )
    return v6;
