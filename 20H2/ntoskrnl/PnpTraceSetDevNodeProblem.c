/*
 * XREFs of PnpTraceSetDevNodeProblem @ 0x1407425E0
 * Callers:
...
void __fastcall PnpTraceSetDevNodeProblem(__int64 a1, __int64 a2, int a3, int a4, int a5, int a6, int a7)
{
  ...
  if ( a4 != 1 && (a4 != 24 || a3 != 788) && (unsigned int)dword_140C02D88 > 5 )
  {
    if ( tlgKeywordOn((__int64)&dword_140C02D88, 0x800000000000LL) )
    {
      v10 = v7;
      v16 = &v14;
      v14 = 1LL;
      ...
      v31 = 4LL;
      v33 = 4LL;
      tlgWriteAgg((__int64)&dword_140C02D88, (unsigned __int8 *)&byte_140024708, 0LL, 0xBu, &v15);
    }
  }
}
