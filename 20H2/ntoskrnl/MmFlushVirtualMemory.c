/*
 * XREFs of MmFlushVirtualMemory @ 0x1406D2554
 * Callers:
...
LABEL_16:
      if ( (unsigned int)MiFlushAcquire(v16, (ULONG_PTR)v20, LastSubsection) )
      {
        ...
        while ( 1 )
        {
          ...
          if ( v23 < 0 )
            break;
          v23 = MiFlushSectionInternal((ULONG_PTR)CurrentThread, v28, v20, (_QWORD *)LastSubsection, 0LL, v27, v22);
