/*
 * XREFs of KiSetHeteroPolicyThread @ 0x14051E884
 * Callers:
 *     KeSetHeteroCpuPolicyThread @ 0x1405117E0 (KeSetHeteroCpuPolicyThread.c)
 *     KeSetUserHeteroCpuPolicyThread @ 0x1405117FC (KeSetUserHeteroCpuPolicyThread.c)
 *     PopUpdateSingleThreadHeteroPolicies @ 0x1408F3D00 (PopUpdateSingleThreadHeteroPolicies.c)
 * Callees:
...
__int64 __fastcall KiSetHeteroPolicyThread(__int64 a1, __int64 a2, __int64 a3, _DWORD *SchedulerAssist)
{
  ...
  _SINGLE_LIST_ENTRY v56; // [rsp+38h] [rbp-38h] BYREF
  ...
  if ( CurrentIrql < 2u )
  {
    ...
    if ( v35->NextThread )
    {
      ...
      *(_BYTE *)(CurrentThread + 390) = CurrentIrql;
      KiQueueReadyThread((__int64)v35, CurrentThread, v46);
