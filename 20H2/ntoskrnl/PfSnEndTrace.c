/*
 * XREFs of PfSnEndTrace @ 0x14065AA98
 * Callers:
 *     PfSnEndTraceWorkerThreadRoutine @ 0x14065AA80 (PfSnEndTraceWorkerThreadRoutine.c)
 * Callees:
...
__int64 __fastcall PfSnEndTrace(struct _EX_RUNDOWN_REF *P)
{
  ...
  if ( (int)Count_low >= dword_140C50134 )
  {
    if ( (int)Count_low > 10 )
    {
...
LABEL_29:
        __fastfail(3u);
      v8[1] = qword_140C502E0;
      *v8 = &qword_140C502D8;
      *v9 = v8;
      v10 = dword_140C50320 + 1;
      qword_140C502E0 = v8;
      while ( 1 )
      {
        dword_140C50320 = v10;
        if ( v10 <= dword_140C4FFCC )
          break;
        v12 = qword_140C502D8;
        if ( qword_140C502D8 == &qword_140C502D8 )
          break;
        if ( *((PVOID **)qword_140C502D8 + 1) != &qword_140C502D8 )
          goto LABEL_29;
        v13 = *(_QWORD *)qword_140C502D8;
        if ( *(PVOID *)(*(_QWORD *)qword_140C502D8 + 8LL) != qword_140C502D8 )
          goto LABEL_29;
        qword_140C502D8 = *(PVOID *)qword_140C502D8;
        *(_QWORD *)(v13 + 8) = &qword_140C502D8;
