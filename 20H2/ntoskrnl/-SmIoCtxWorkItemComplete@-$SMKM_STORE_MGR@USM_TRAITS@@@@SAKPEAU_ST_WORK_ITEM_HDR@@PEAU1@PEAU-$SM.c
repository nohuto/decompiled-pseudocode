/*
 * XREFs of ?SmIoCtxWorkItemComplete@?$SMKM_STORE_MGR@USM_TRAITS@@@@SAKPEAU_ST_WORK_ITEM_HDR@@PEAU1@PEAU?$SMKM_STORE@USM_TRAITS@@@@J@Z @ 0x140256910
 * Callers:
...
__int64 __fastcall SMKM_STORE_MGR<SM_TRAITS>::SmIoCtxWorkItemComplete(__int64 a1, __int64 a2, _DWORD *a3, int a4)
{
  ...
  int v19; // eax
  int v20; // eax
  __int64 BugCheckOnFailure; // [rsp+20h] [rbp-28h]
...
LABEL_8:
  if ( v12 )
  {
    ...
    if ( (dword_140D240F0 & 2) != 0 )
      SmFpFree(&dword_140D23FC0, 5LL, v4, v12, BugCheckOnFailure, Priority);
  }
  if ( v8 )
