/*
 * XREFs of MiPickClusterForMappedFileFault @ 0x1402323EC
 * Callers:
...
LABEL_5:
  ...
  if ( !a3 && (v21 & 0x20000000) != 0 )
  {
    ...
    v27 = v22 & (dword_140C4EBD0 - 1);
    if ( v17 > v12 + 8 * (((unsigned int)(dword_140C4EBD0 - v27) >> 12) - 1LL) )
      v17 = v12 + 8 * (((unsigned int)(dword_140C4EBD0 - v27) >> 12) - 1LL);
  }
  else
  {
    v22 = 0;
  ...
  else
  {
    ...
    {
      v28 = (v22 >> 12) & ((unsigned int)(dword_140C4EBD0 - 1) >> 12);
      if ( v25 < v12 - 8 * v28 )
