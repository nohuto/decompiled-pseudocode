/*
 * XREFs of ExpSetTimer2 @ 0x1402E0924
 * Callers:
 *     NtSetTimer2 @ 0x1402E0900 (NtSetTimer2.c)
 *     NtCancelTimer2 @ 0x140330480 (NtCancelTimer2.c)
 *     NtSetIRTimer @ 0x140330AC0 (NtSetIRTimer.c)
 * Callees:
