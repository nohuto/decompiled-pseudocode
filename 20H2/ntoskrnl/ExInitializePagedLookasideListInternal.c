/*
 * XREFs of ExInitializePagedLookasideListInternal @ 0x140338750
 * Callers:
        ...
        int a8)
{
  ...
  *(_QWORD *)(a1 + 80) = 0LL;
  ...
  v13 = (_QWORD *)qword_140C16928;
  v14 = (_QWORD *)(a1 + 64);
  if ( *(__int64 **)qword_140C16928 != &ExPagedLookasideListHead )
    __fastfail(3u);
  *v14 = &ExPagedLookasideListHead;
  v14[1] = v13;
  *v13 = v14;
  qword_140C16928 = (__int64)v14;
