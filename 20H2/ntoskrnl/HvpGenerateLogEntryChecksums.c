/*
 * XREFs of HvpGenerateLogEntryChecksums @ 0x1405DF440
 * Callers:
 *     HvpGenerateLogEntry @ 0x1405DF298 (HvpGenerateLogEntry.c)
 * Callees:
 *     __security_check_cookie @ 0x1403CFAF0 (__security_check_cookie.c)
 *     SymCryptMarvin32 @ 0x1403EB2B8 (SymCryptMarvin32.c)
 *     SymCryptMarvin32Append @ 0x1403EB430 (SymCryptMarvin32Append.c)
 *     SymCryptMarvin32Init @ 0x1403EB5DC (SymCryptMarvin32Init.c)
 *     SymCryptMarvin32Result @ 0x1403EB5F8 (SymCryptMarvin32Result.c)
