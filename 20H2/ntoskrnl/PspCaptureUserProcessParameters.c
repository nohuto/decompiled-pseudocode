/*
 * XREFs of PspCaptureUserProcessParameters @ 0x1406A63D0
 * Callers:
 ...
 *     PspCaptureAndValidateUnicodeString @ 0x1406A6A8C (PspCaptureAndValidateUnicodeString.c)
 *     PspValidateEnvironmentBlock @ 0x1406A6B00 (PspValidateEnvironmentBlock.c)
