/*
 * XREFs of ExpOsProductCacheProviderHelper @ 0x1407CD2F4
 * Callers:
 ...
 *     ExpOsProductContentIdCacheProvider @ 0x140950440 (ExpOsProductContentIdCacheProvider.c)
 *     ExpOsProductPfnCacheProvider @ 0x140950480 (ExpOsProductPfnCacheProvider.c)
 * Callees:
        ...
        _BYTE *a7)
{
  ...
  ResultLength = 0;
  *a7 = 1;
  v10 = ZwOpenKey(&KeyHandle, 0x20019u, (POBJECT_ATTRIBUTES)&stru_140987130);
  if ( v10 >= 0 )
  {
