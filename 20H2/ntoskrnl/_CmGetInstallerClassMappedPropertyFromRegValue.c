/*
 * XREFs of _CmGetInstallerClassMappedPropertyFromRegValue @ 0x14075B19C
 * Callers:
...
LABEL_3:
  ...
  v14 = *(_QWORD *)a4 - *(_QWORD *)&v17->fmtid.Data1;
  if ( *(_QWORD *)a4 == *(_QWORD *)&v17->fmtid.Data1 )
    v14 = *(_QWORD *)(a4 + 8) - *(_QWORD *)v17->fmtid.Data4;
  if ( v14 )
  {
    v14 = 0LL;
    goto LABEL_3;
...
LABEL_8:
  if ( v18 )
  {
    ...
    *a8 = v14;
    ...
    if ( !a3 )
    {
      v15 = CmOpenInstallerClassRegKey(v45, a2, (__int64)v17, v16, 1, v14, (__int64)&Handle, v14);
      if ( v15 < 0 )
        goto LABEL_22;
    }
    v20 = *(_DWORD *)(a4 + 16);
      ...
      if ( v33 )
      {
        ...
        if ( !v37 )
        {
          ...
          if ( a3 )
            v38 = (int)a3;
          LODWORD(v42) = 4;
          v40 = PnpOpenPropertiesKey(v45, v38, 0LL, 1, 0, v41, &KeyHandle);
          v15 = v40;
          if ( v40 != -1073741772 )
          {
            if ( v40 < 0 )
