/*
 * XREFs of EtwpCoverageRecord @ 0x1406D72E4
 * Callers:
...
LABEL_9:
  ...
  if ( !v4 && v5 && (unsigned int)dword_140C02BE8 > 5 && tlgKeywordOn((__int64)&dword_140C02BE8, 2LL) )
  {
    v17 = *a1;
    v18 = *(const CHAR **)a2;
    v25 = **a1;
    ...
    tlgWriteTransfer_EtwWriteTransfer((__int64)&dword_140C02BE8, (unsigned __int8 *)byte_14002B771, 0LL, 0LL, 7u, &v50);
  }
  if ( EtwpCoverageCoreTracingEnabled && (unsigned int)dword_140C02BE8 > 5 )
  {
    if ( tlgKeywordOn((__int64)&dword_140C02BE8, 1LL) )
    {
      v19 = *a1;
      v20 = *(const CHAR **)a2;
      v29 = **a1;
      ...
      tlgWriteTransfer_EtwWriteTransfer(
        ...
        (unsigned __int8 *)byte_14002B6FD,
        0LL,
        0LL,
        9u,
        &v36);
