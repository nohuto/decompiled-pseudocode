/*
 * XREFs of PnpCompareInterruptInformation @ 0x14076EA4C
 * Callers:
...
char __fastcall PnpCompareInterruptInformation(__int64 a1, const void *a2, unsigned int a3)
{
  ...
  if ( v5 )
  {
    if ( *v5 == a3 )
    {
      ...
      if ( v3 != v4 && (unsigned int)dword_140C02DC0 > 5 )
      {
        LOBYTE(v3) = tlgKeywordOn((__int64)&dword_140C02DC0, 0x400000000000LL);
        if ( (_BYTE)v3 )
        {
          v14 = -1LL;
          do
...
LABEL_21:
    ...
    else if ( (unsigned int)dword_140C02DC0 > 5 )
    {
      LOBYTE(v3) = tlgKeywordOn((__int64)&dword_140C02DC0, 0x400000000000LL);
      if ( (_BYTE)v3 )
      {
