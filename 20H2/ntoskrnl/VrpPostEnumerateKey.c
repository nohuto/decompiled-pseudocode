/*
 * XREFs of VrpPostEnumerateKey @ 0x1405D0DA4
 * Callers:
 *     VrpRegistryCallback @ 0x1405D15D0 (VrpRegistryCallback.c)
 * Callees:
 *     ExGetPreviousMode @ 0x140209E30 (ExGetPreviousMode.c)
...
__int64 __fastcall VrpPostEnumerateKey(__int64 a1, __int64 a2)
{
  ...
  if ( (unsigned int)dword_140C02168 > 5 )
  {
    ...
    tlgWriteTransfer_EtwWriteTransfer(
      ...
      (unsigned __int8 *)byte_140023268,
      &ActivityId,
      0LL,
      5u,
      &v74);
...
LABEL_20:
  ...
  if ( v27 )
  {
    v28 = ExAllocatePoolWithTag(PagedPool, v27, 0x67655256u);
    P = v28;
    if ( !v28 )
    {
      v7 = -1073741670;
...
LABEL_50:
  ...
  if ( (_DWORD)v37 != 2 )
  {
    updated = VrpUpdateKeyInformation(v37, (_DWORD)v29, *(_DWORD *)(v4 + 24), v30, (__int64)&v55, 0);
    v7 = updated;
...
LABEL_54:
  ...
  if ( v7 < 0 && (unsigned int)dword_140C02168 > 2 )
  {
    ...
    tlgWriteTransfer_EtwWriteTransfer(
      (__int64)&dword_140C02168,
      (unsigned __int8 *)word_140023392,
      &ActivityId,
      0LL,
      8u,
      &v61);
