/*
 * XREFs of Amd64InitializeProfiling @ 0x1409AC850
 * Callers:
 *     <none>
 * Callees:
 ...
 *     Amd64FreeCounter @ 0x1404DC04C (Amd64FreeCounter.c)
 */
...
__int64 Amd64InitializeProfiling()
{
  ...
  if ( !Number )
  {
    ...
    qword_140C48A38 = (__int64)&Amd64ProfileSourceDescriptorListHead;
    ...
    for ( i = 0; i < 0xB0; ++i )
    {
      ...
      if ( !Amd64ProfileSourceDescriptorTable[v6 + 29] )
      {
        ...
        v8 = (_QWORD *)qword_140C48A38;
        if ( *(__int64 **)qword_140C48A38 != &Amd64ProfileSourceDescriptorListHead )
          __fastfail(3u);
        ++Amd64ProfileSourceDescriptorCount;
        *v7 = &Amd64ProfileSourceDescriptorListHead;
        v7[1] = v8;
        *v8 = v7;
        qword_140C48A38 = (__int64)v7;
      }
    }
  }
  v9 = &unk_140C05790;
