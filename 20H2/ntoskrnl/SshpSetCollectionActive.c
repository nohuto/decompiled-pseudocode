/*
 * XREFs of SshpSetCollectionActive @ 0x14057E42C
 * Callers:
 *     PdcPoSleepStudyHelperSetPhaseActive @ 0x1407D0E20 (PdcPoSleepStudyHelperSetPhaseActive.c)
 *     SshpPowerSettingCallback @ 0x1408FE340 (SshpPowerSettingCallback.c)
 * Callees:
 ...
 *     SshpStopBlockerAccounting @ 0x14057E70C (SshpStopBlockerAccounting.c)
...
char __fastcall SshpSetCollectionActive(ULONG_PTR BugCheckParameter2, char a2)
{
  ...
  __int64 v24; // rdx
  $C774EFD68449142D8271B1EC1EB7FB26 *v25; // rax
  __int64 v26; // rcx
...
LABEL_37:
  ...
  LOBYTE(v25) = KiAbThreadRemoveBoosts((ULONG_PTR)CurrentThread, BugCheckParameter2, &v28);
  v15 = CurrentThread->SpecialApcDisable++ == -1;
  if ( v15 )
  {
    v25 = &CurrentThread->152;
    if ( ($C774EFD68449142D8271B1EC1EB7FB26 *)v25->ApcState.ApcListHead[0].Flink != v25 )
      LOBYTE(v25) = KiCheckForKernelApcDelivery(v26);
  }
  return (char)v25;
}
