/*
 * XREFs of ViXdvSearchAllThunkArrays @ 0x1409CC120
 * Callers:
 *     ViXdvBindXdvDDIWrappers @ 0x1409CBC60 (ViXdvBindXdvDDIWrappers.c)
 * Callees:
 *     ViXdvSearchAndReplaceThunkArray @ 0x1409CC18C (ViXdvSearchAndReplaceThunkArray.c)
 *     ViXdvSearchAndReplaceThunkArrayOrderDependent @ 0x1409CC1DC (ViXdvSearchAndReplaceThunkArrayOrderDependent.c)
 */
