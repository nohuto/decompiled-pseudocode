/*
 * XREFs of HalpInterruptParseMadt @ 0x1403AEC54
 * Callers:
 ...
 *     HalpInterruptSortProcessorTable @ 0x1403AF1C4 (HalpInterruptSortProcessorTable.c)
          ...
          if ( v29 == 2 && (_BYTE)v27 == 10 )
          {
            if ( (int)HalpInterruptGsiToLine(*((unsigned int *)v28 + 1), &v87) >= 0 )
            {
              ...
              *(_DWORD *)(v57 + 32) = (v28[8] & 8) == 0;
              v61 = (__int64 *)qword_140C49728;
              if ( *(__int64 **)qword_140C49728 != &HalpInterruptOverrides )
                __fastfail(3u);
