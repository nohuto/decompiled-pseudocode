/*
 * XREFs of EtwTracePageFault @ 0x1405A60FC
 * Callers:
...
void __fastcall EtwTracePageFault(int a1, __int64 a2, char a3, __int64 a4)
{
  ...
  if ( ((__int64)CurrentThread[1].Queue & 0x10) != 0 )
  {
    ...
    EtwTraceSiloKernelEvent(ThreadServerSilo, (__int64)&v13, 1u, 0x1000u, v5, 0x2000102u);
  }
  else
  {
    ...
    EtwTraceSiloKernelEvent(v9, (__int64)&v13, 1u, 0x1000u, v5, v8);
    LOBYTE(CurrentThread[1].Queue) &= ~0x10u;
