/*
 * XREFs of MiMapPagesToZero @ 0x1402C2890
 * Callers:
...
__int64 __fastcall MiMapPagesToZero(__int64 a1, __int64 a2, unsigned int a3)
{
  ...
  v22 = 0x140000000uLL;
  if ( dword_140C4DE1C[4 * v21] == 1 )
  {
    MiChangePageAttribute(a2, 1u, 1);
LABEL_35:
    v22 = 0x140000000uLL;
  }
  v23 = 4;
  ...
  {
    if ( *(_BYTE *)(((LeafVa >> 39) & 0x1FF) - 256 + v22 + 12908616) == 1
      || LeafVa >= 0xFFFFF68000000000uLL && LeafVa <= (unsigned __int64)SchedulerAssist )
    {
      goto LABEL_66;
    }
    if ( LeafVa < qword_140C4F9B8 || (v31 = HIBYTE(word_140C4DE88), LeafVa > qword_140C4E1E8) )
      v31 = (unsigned __int8)word_140C4DE88;
  }
  else
  {
    v31 = HIBYTE(word_140C4DE88);
  }
  if ( v31 )
LABEL_65:
    v27 |= 0x100uLL;
LABEL_66:
  v32 = a3;
  v33 = v27 ^ ((unsigned __int16)v27 ^ (unsigned __int16)((unsigned __int8)word_140C4DE88 << 8)) & 0x100 | 0x42;
  v34 = v27 ^ ((unsigned __int16)v27 ^ (unsigned __int16)((unsigned __int8)word_140C4DE88 << 8)) & 0x100 | 0xC2;
  if ( (v25 & 0x4000000) == 0 )
    v34 = v33;
...
LABEL_88:
    ...
    if ( !HIBYTE(word_140C4DE88) && (v35 & 1) != 0 )
      v41 |= 0x8000000000000000uLL;
    *(_QWORD *)v8 = v41;
