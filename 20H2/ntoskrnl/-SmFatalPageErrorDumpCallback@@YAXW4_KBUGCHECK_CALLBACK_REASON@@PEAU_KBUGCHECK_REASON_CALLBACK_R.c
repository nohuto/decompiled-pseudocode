/*
 * XREFs of ?SmFatalPageErrorDumpCallback@@YAXW4_KBUGCHECK_CALLBACK_REASON@@PEAU_KBUGCHECK_REASON_CALLBACK_RECORD@@PEAXK@Z @ 0x14059D4C0
 * Callers:
 *     <none>
 * Callees:
 *     <none>
        ...
        ULONG ReasonSpecificDataLength)
{
  ...
  if ( v5 <= *((_DWORD *)ReasonSpecificData + 3) )
  {
    ...
    *((_OWORD *)ReasonSpecificData + 1) = xmmword_14003AA88;
  }
  else
  {
    v5 = 0;
