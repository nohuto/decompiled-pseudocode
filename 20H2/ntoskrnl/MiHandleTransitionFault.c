/*
 * XREFs of MiHandleTransitionFault @ 0x140278C30
 * Callers:
...
LABEL_54:
              v35 = a1;
              v36 = MiIdealClusterPage((int)a1, (int)Address, a2, a6, (void *)BugCheckParameter4, a3, (__int64)v40);
              v29 = v36;
              if ( v36 )
              {
