/*
 * XREFs of PfFbBufferListAllocateTemporary @ 0x1403287B4
 * Callers:
 *     PfpEventHandleOutOfBuffers @ 0x140328790 (PfpEventHandleOutOfBuffers.c)
 *     PfpSectInfoHandleOutOfBuffers @ 0x14078AE30 (PfpSectInfoHandleOutOfBuffers.c)
 * Callees:
