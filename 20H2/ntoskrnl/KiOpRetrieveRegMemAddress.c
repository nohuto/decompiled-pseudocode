/*
 * XREFs of KiOpRetrieveRegMemAddress @ 0x1403CCA20
 * Callers:
 *     KiOp_Div @ 0x1403CC920 (KiOp_Div.c)
 *     KiOp_SGDTSIDT @ 0x140522F60 (KiOp_SGDTSIDT.c)
 *     KiOp_SLDTSTRSMSW @ 0x140523120 (KiOp_SLDTSTRSMSW.c)
 * Callees:
 *     KiOpComputeLinearAddress @ 0x140522ACC (KiOpComputeLinearAddress.c)
 */
