/*
 * XREFs of ExpQueueWorkItem @ 0x14028DAE0
 * Callers:
 ...
 *     ExpIsPoolReadyForWork @ 0x14028EF20 (ExpIsPoolReadyForWork.c)
    ...
    if ( *v19 != v19 && (CurrentThread->Queue != (_DISPATCHER_HEADER *volatile)v18 || CurrentThread->WaitReason != 15) )
    {
      ...
      if ( v7 < v26 )
      {
        ...
        while ( 1 )
        {
          ...
          *v30 = v28;
          v28[1] = v30;
          if ( (unsigned __int8)KiTryUnwaitThreadWithPriority((__int64)CurrentPrcb, v29, (__int64)a2, v6) )
            goto LABEL_23;
          if ( v27 == v19 )
            goto LABEL_29;
        }
...
LABEL_23:
    ...
    KiExitDispatcher((__int64)CurrentPrcb, 0LL, 1u, 0, v42);
