/*
 * XREFs of VmpConvertPortionVpnRangeToGpnRange @ 0x1405A1450
 * Callers:
 *     VmpFillGpnRanges @ 0x1405A1970 (VmpFillGpnRanges.c)
 *     VmpFlushTbVaRange @ 0x1405A1D80 (VmpFlushTbVaRange.c)
 *     VmpQueryAccessedState @ 0x1405A31BC (VmpQueryAccessedState.c)
 * Callees:
 *     VmpVaMemoryRangeGetNext @ 0x1405A3B30 (VmpVaMemoryRangeGetNext.c)
 */
