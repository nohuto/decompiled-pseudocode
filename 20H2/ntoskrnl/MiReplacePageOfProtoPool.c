/*
 * XREFs of MiReplacePageOfProtoPool @ 0x1403191F4
 * Callers:
...
__int64 __fastcall MiReplacePageOfProtoPool(__int64 a1, __int64 a2, __int64 a3, __int64 a4)
{
  ...
  __int64 v55; // [rsp+40h] [rbp-99h]
  __int64 v56; // [rsp+48h] [rbp-91h] BYREF
  __int64 v57; // [rsp+50h] [rbp-89h]
  _DWORD v58[2]; // [rsp+58h] [rbp-81h] BYREF
  signed __int32 *v59; // [rsp+60h] [rbp-79h]
  __int64 v60; // [rsp+68h] [rbp-71h]
  __int128 v61; // [rsp+70h] [rbp-69h]
  __int128 v62; // [rsp+80h] [rbp-59h]
  __int128 v63; // [rsp+90h] [rbp-49h]
  signed __int32 v64[16]; // [rsp+A0h] [rbp-39h] BYREF
  ...
  KeCopyPage(a4, a1);
  m = 0;
  v9 = (((unsigned __int8)((unsigned __int8)&v64[14] + 1) - 57) & 4) != 0LL ? 0x20 : 0;
  v51 = v9;
  v10 = (char *)v64 - ((((unsigned __int8)((unsigned __int8)&v64[14] + 1) - 57) & 4) != 0LL ? 4 : 0);
  for ( i = v10; ; v10 = i )
  {
    v11 = m < v58[0] ? m : 0;
    v12 = v58[0] - 1;
...
LABEL_44:
    ...
    {
      v19 = v18;
      v17 = (unsigned __int64)&v64[(unsigned __int64)(unsigned int)v18 >> 5];
      if ( (signed __int32 *)v17 != &v64[15] && (*(_DWORD *)v17 | *((_DWORD *)qword_140011D10 + (v18 & 0x1F))) == -1 )
      {
        v19 = v18 - (v18 & 0x1F) + 32;
        for ( v17 += 4LL; v17 < (unsigned __int64)&v64[15] && *(_DWORD *)v17 == -1; v17 += 4LL )
          v19 += 32;
      }
      while ( v19 < 0x200 && _bittest(v64, v19) )
        ++v19;
      j = 0LL;
      if ( (signed __int32 *)v17 == &v64[15] )
        goto LABEL_27;
      v11 = v19 & 0x1F;
      if ( (*(_DWORD *)v17 & ~*((_DWORD *)qword_140011D10 + v11)) != 0 )
        goto LABEL_27;
      j = (unsigned int)(32 - v11);
      if ( (_DWORD)j != -1 )
      {
        v17 += 4LL;
        while ( v17 < (unsigned __int64)&v64[15] && !*(_DWORD *)v17 )
        {
          v17 += 4LL;
          j = (unsigned int)(j + 32);
          if ( (_DWORD)j == -1 )
...
LABEL_27:
        for ( k = j + v19; k < 0x200 && !_bittest(v64, k) && (_DWORD)j != -1; ++k )
          j = (unsigned int)(j + 1);
      }
LABEL_32:
      if ( (_DWORD)j )
...
LABEL_33:
  ...
  v27 = 48 * v60 - 0x58000000000LL;
  v28 = 48 * v57 - 0x58000000000LL;
  if ( v6 )
  {
    MiLockNestedPageAtDpcInline(48 * v60 - 0x58000000000LL, v17, j, v11);
  }
  else
  {
    v52 = 0;
...
LABEL_72:
    ...
    else if ( qword_140C4DDC0 )
    {
      if ( (v56 & 0x10) != 0 )
        ...
        v44 = ~qword_140C4DDC0 & v56;
    }
    v45 = (v44 >> 12) & 0xFFFFFFFFFLL;
    if ( v31 == 1 )
    {
      *((_QWORD *)&v63 + 1) = *(_QWORD *)(48 * v45 - 0x58000000000LL + 40) ^ (v57 ^ *(_QWORD *)(48 * v45
                                                                                              - 0x58000000000LL
                                                                                              + 40)) & 0xFFFFFFFFFLL;
      *(_QWORD *)(48 * v45 - 0x58000000000LL + 40) = *((_QWORD *)&v63 + 1);
    }
    --v6;
