/*
 * XREFs of NtOpenKeyTransactedEx_Stub @ 0x14097F4CC
 * Callers:
...
__int64 __fastcall NtOpenKeyTransactedEx_Stub(__int64 a1)
{
  ...
  if ( byte_140CFA020 )
  {
    v1 = (NTSTATUS (__stdcall *)(PHANDLE, ACCESS_MASK, POBJECT_ATTRIBUTES, ULONG, HANDLE))qword_140CF9FF8;
  }
  else
  {
    v1 = ZwOpenKeyTransactedEx;
    byte_140CFA020 = 1;
    qword_140CF9FF8 = (__int64)ZwOpenKeyTransactedEx;
  }
  if ( v1 )
