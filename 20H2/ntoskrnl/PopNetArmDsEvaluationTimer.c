/*
 * XREFs of PopNetArmDsEvaluationTimer @ 0x1408F43A4
 * Callers:
...
_BOOL8 PopNetArmDsEvaluationTimer()
{
  ...
  if ( MEMORY[0xFFFFF78000000008] < (unsigned __int64)(qword_140C4FD88 + v1) )
    v0 = v1 + qword_140C4FD88 - MEMORY[0xFFFFF78000000008];
