/*
 * XREFs of CmpInitializePreloadedHive @ 0x140A5957C
 * Callers:
 ...
 *     CmpSetupLoggingState @ 0x14079CFC8 (CmpSetupLoggingState.c)
...
LABEL_33:
  ...
  *(_QWORD *)&v24.Length = 0x800000LL;
  ...
  v16 = (_QWORD *)qword_140C48378;
  v17 = (_QWORD *)(v22 + 1616);
  if ( *(__int64 **)qword_140C48378 != &CmpPreloadedHivesList )
    __fastfail(3u);
  *v17 = &CmpPreloadedHivesList;
  v17[1] = v16;
  *v16 = v17;
  qword_140C48378 = (__int64)v17;
  return 0LL;
}
