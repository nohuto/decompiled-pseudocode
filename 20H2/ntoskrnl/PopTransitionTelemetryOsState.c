/*
 * XREFs of PopTransitionTelemetryOsState @ 0x140794320
 * Callers:
...
__int64 __fastcall PopTransitionTelemetryOsState(int a1, int a2)
{
  ...
  v48 = 0LL;
  v47 = 0LL;
  if ( !dword_140C021E8 || !tlgKeywordOn((__int64)&dword_140C021E8, 0x800000000000LL) || !byte_140C22C6C )
    return v4;
  switch ( a1 )
  {
    case 2:
...
LABEL_67:
  ...
  v4 = dword_140C22C68;
  if ( a1 != 5 || dword_140C22C30 == 1 || (unsigned int)(dword_140C22C30 - 4) <= 1 )
  {
    v8 = (KiQueryUnbiasedInterruptTime() - qword_140C22C48) / 0x2710uLL;
    v9 = v8 - qword_140C22C58;
    v10 = (MEMORY[0xFFFFF78000000008] - qword_140C22C40) / 0x2710uLL;
    qword_140C22C58 = v8;
    v11 = v10 - qword_140C22C50;
    v33 = v10 - qword_140C22C50;
    v12 = v10 - qword_140C22C50;
    qword_140C22C50 = v10;
    if ( v9 <= v11 )
      v12 = v9;
    v32 = v12;
    v21 = v7 + dword_140C22C60;
    dword_140C22C60 += v7;
    v19 = dword_140C22C30;
    v20 = dword_140C22C34;
    if ( a1 != 5 )
    ...
    if ( (unsigned int)dword_140C021E8 > 5 && tlgKeywordOn((__int64)&dword_140C021E8, 0x800000000000LL) )
    {
      ...
      tlgWriteTransfer_EtwWriteTransfer(
        ...
        (unsigned __int8 *)byte_140026E6D,
        0LL,
        0LL,
        0x16u,
        &v49);
