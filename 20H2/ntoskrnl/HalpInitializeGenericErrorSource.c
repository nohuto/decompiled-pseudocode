/*
 * XREFs of HalpInitializeGenericErrorSource @ 0x1409AAE64
 * Callers:
  ...
  switch ( *(_BYTE *)(a2 + 64) )
  {
    case 0:
      ...
      *((_QWORD *)P + 2) = MEMORY[0xFFFFF78000000320];
      ...
      v21 = (_QWORD *)qword_140C49BE8;
      if ( *(__int64 **)qword_140C49BE8 == &HalpGenericPolledErrorSourceListHead )
      {
        v22 = HalpGenericPollingInitDone == 0;
        *v20 = &HalpGenericPolledErrorSourceListHead;
        v20[1] = v21;
        *v21 = v20;
        qword_140C49BE8 = (__int64)v20;
        if ( v22 )
        {
    ...
    case 4:
      ...
      if ( v14 >= 0 )
      {
        ...
        v18 = (_QWORD *)qword_140C49C08;
        if ( *(__int64 **)qword_140C49C08 != &HalpGenericNmiErrorSourceListHead )
          goto LABEL_52;
        *v15 = &HalpGenericNmiErrorSourceListHead;
        v15[1] = v18;
        *v18 = v15;
        qword_140C49C08 = (__int64)v15;
      }
    ...
    case 8:
      ...
      if ( v11 >= 0 )
      {
        v12 = (_QWORD *)qword_140C49AC8;
        if ( *(__int64 **)qword_140C49AC8 != &HalpGenericSeaErrorSourceListHead )
          goto LABEL_52;
        v13 = P;
        *(_QWORD *)P = &HalpGenericSeaErrorSourceListHead;
        v13[1] = v12;
        *v12 = v13;
        qword_140C49AC8 = (__int64)v13;
      }
    ...
    case 9:
      ...
      if ( v8 >= 0 )
      {
        v9 = (_QWORD *)qword_140C49AB8;
        if ( *(__int64 **)qword_140C49AB8 != &HalpGenericSeiErrorSourceListHead )
          goto LABEL_52;
        v10 = P;
        *(_QWORD *)P = &HalpGenericSeiErrorSourceListHead;
        v10[1] = v9;
        *v9 = v10;
        qword_140C49AB8 = (__int64)v10;
      }
    ...
    case 0xA:
      ...
      if ( v4 < 0 )
        return (unsigned int)v4;
      v7 = (_QWORD *)qword_140C49AA8;
      if ( *(__int64 **)qword_140C49AA8 == &HalpGenericPeiErrorSourceListHead )
      {
        *v6 = &HalpGenericPeiErrorSourceListHead;
        v6[1] = v7;
        *v7 = v6;
        qword_140C49AA8 = (__int64)v6;
LABEL_55:
        if ( v4 >= 0 )
