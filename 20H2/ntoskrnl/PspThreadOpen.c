/*
 * XREFs of PspThreadOpen @ 0x1406B3250
 * Callers:
 *     <none>
 * Callees:
 *     PspIsParentProcess @ 0x140305274 (PspIsParentProcess.c)
...
__int64 __fastcall PspThreadOpen(__int64 a1, char a2, __int64 a3, __int64 a4, int *a5)
{
  ...
  if ( *(_QWORD *)(a4 + 1504) && !*(_QWORD *)(a3 + 2240) && a2 && (~HIDWORD(xmmword_140C1DEE0) & *a5) != 0 )
    return 3221225506LL;
  v12 = *a5;
  if ( (*a5 & 0x40) != 0 )
  {
