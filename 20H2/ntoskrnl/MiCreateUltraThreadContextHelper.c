/*
 * XREFs of MiCreateUltraThreadContextHelper @ 0x14033404C
 * Callers:
...
__int64 __fastcall MiCreateUltraThreadContextHelper(__int64 a1, unsigned int a2, unsigned int a3)
{
  ...
  v3 = dword_140C4EAAC;
  if ( dword_140C4EAAC != dword_140C4EAA8 )
  {
    while ( 1 )
    {
      v7 = _InterlockedCompareExchange(&dword_140C4EAAC, v3 + 1, v3);
      v6 = v3 == v7;
      v3 = v7;
      if ( v6 )
        break;
      if ( v7 == dword_140C4EAA8 )
        return 0LL;
    }
    *(_QWORD *)a1 = 0LL;
    v8 = a2;
    *(__m128i *)(a1 + 8) = _mm_load_si128((const __m128i *)&_xmm_ffffffffffffffffffffffffffffffff);
    ...
    if ( (int)MiAcquireNonPagedResources(&MiSystemPartition, (unsigned int)v8, 0LL, 0LL) >= 0 )
    {
      ...
      if ( v8 )
      {
        ...
        if ( v8 )
          _InterlockedExchangeAdd64(&qword_140C52800, v8);
        return 0LL;
      }
LABEL_10:
      *(_BYTE *)(a1 + 24) = 1;
