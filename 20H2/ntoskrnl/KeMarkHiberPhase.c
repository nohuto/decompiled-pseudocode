/*
 * XREFs of KeMarkHiberPhase @ 0x1409B2088
 * Callers:
...
void __fastcall KeMarkHiberPhase(_QWORD *Address)
{
  ...
  if ( qword_140C2B1D8 )
    PoSetHiberRange(0LL, 0x10000u, qword_140C2B1D8, 16 * (unsigned int)(unsigned __int8)qword_140C2B1C8, 0x7272744Du);
  if ( qword_140C2B1E0 )
    PoSetHiberRange(0LL, 0x10000u, qword_140C2B1E0, 0x58uLL, 0x7272744Du);
  v13 = *(_QWORD **)(v1 + 8);
