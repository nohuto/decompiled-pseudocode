/*
 * XREFs of MiInitializeMdlBatchPages @ 0x1403347C4
 * Callers:
...
__int64 __fastcall MiInitializeMdlBatchPages(__int64 a1)
{
  ...
  do
  {
    v10 = *((_DWORD *)MiSearchNumaNodeTable(48LL * *v7 / 48) + 2);
    if ( v3 )
    {
      if ( v10 == v2 )
      {
...
LABEL_12:
  ...
  for ( i = 0LL; i < v6; ++v5 )
  {
    ...
    *(_QWORD *)(v15 + 8) = 0xFFFFF68000000000uLL;
    MiSetLeafPfnBuddy((_QWORD *)v15, (unsigned __int64)CurrentProcess);
    *(_QWORD *)(v15 + 8) = v16;
