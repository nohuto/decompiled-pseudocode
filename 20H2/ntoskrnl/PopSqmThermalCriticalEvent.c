/*
 * XREFs of PopSqmThermalCriticalEvent @ 0x1408FC3C8
 * Callers:
...
char __fastcall PopSqmThermalCriticalEvent(__int64 a1, unsigned int a2, int a3)
{
  ...
  if ( v8 )
  {
    ...
    {
      LOBYTE(DeviceAttachmentBaseRefWithTag) = tlgKeywordOn((__int64)&dword_140C021E8, 0x800000000000LL);
      if ( (_BYTE)DeviceAttachmentBaseRefWithTag )
      {
        ...
        LOBYTE(DeviceAttachmentBaseRefWithTag) = tlgWriteTransfer_EtwWriteTransfer(
                                                   ...
                                                   (unsigned __int8 *)byte_140029850,
                                                   0LL,
                                                   0LL,
                                                   0xBu,
                                                   &v23);
