/*
 * XREFs of ExShareAddressSpaceWithDevice @ 0x1405B5850
 * Callers:
 *     <none>
 * Callees:
...
LABEL_22:
      ...
      if ( v17 && ($C774EFD68449142D8271B1EC1EB7FB26 *)v11->ApcState.ApcListHead[0].Flink != &v11->152 )
...
LABEL_84:
      ...
      if ( v17 && ($C774EFD68449142D8271B1EC1EB7FB26 *)v34->ApcState.ApcListHead[0].Flink != &v34->152 )
...
LABEL_98:
      ...
      while ( 1 )
      {
        ...
        if ( v17 )
          break;
        v50 = (unsigned __int64)&v45->LockEntries[v49];
        v48 &= ~(1 << v49);
        if ( (*(_BYTE *)(v50 + 26) & 1) != 0
          && (*(_DWORD *)(v50 + 32) & 1) == 0
...
LABEL_117:
      ...
      if ( v17 && ($C774EFD68449142D8271B1EC1EB7FB26 *)v45->ApcState.ApcListHead[0].Flink != &v45->152 )
...
LABEL_150:
  ...
  while ( 1 )
  {
    ...
    if ( v17 )
      goto LABEL_161;
    v69 = (unsigned __int64)&v66->LockEntries[v70];
    v68 &= ~(1 << v70);
    if ( (*(_BYTE *)(v69 + 26) & 1) != 0
      && (*(_DWORD *)(v69 + 32) & 1) == 0
...
LABEL_161:
  ...
  *(_DWORD *)(v69 + 88) = v72;
  *(_QWORD *)(v69 + 32) = 0LL;
  v73 = (__int64)(v69 - (unsigned __int64)v66->LockEntries) / 96;
  if ( v67 == 1 )
...
LABEL_168:
  ...
  if ( v17 && ($C774EFD68449142D8271B1EC1EB7FB26 *)v66->ApcState.ApcListHead[0].Flink != &v66->152 )
    KiCheckForKernelApcDelivery(1LL);
