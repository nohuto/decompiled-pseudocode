/*
 * XREFs of CcSetDirtyPinnedData @ 0x140241270
 * Callers:
  ...
  if ( *(_QWORD *)(v7 + 168) )
  {
    ...
    else
    {
      ...
      if ( _interlockedbittestandset(&dword_140C4C800, 0x1Fu) )
      {
        ...
        v63 = ExpWaitForSpinLockExclusiveAndAcquire(&dword_140C4C800, CurrentIrql);
      }
      v13 = dword_140C4C800;
      while ( (v13 & 0xBFFFFFFF) != 0x80000000 )
      {
        if ( (v13 & 0x40000000) == 0 )
        {
          v45 = _InterlockedCompareExchange(&dword_140C4C800, v13 | 0x40000000, v13);
          v26 = v13 == v45;
          v13 = v45;
          if ( !v26 )
            continue;
...
LABEL_30:
        ...
        KiAbThreadRemoveBoosts((ULONG_PTR)CurrentThread, v19 + 280, &v65);
