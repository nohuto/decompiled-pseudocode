/*
 * XREFs of MiProcessVaContiguityInformation @ 0x1405507F0
 * Callers:
 ...
 *     MiGetVadCacheAttribute @ 0x14055A2B0 (MiGetVadCacheAttribute.c)
 *     MiVadSupportsPhysicalContiguityQuery @ 0x1408D400C (MiVadSupportsPhysicalContiguityQuery.c)
 */
...
__int64 __fastcall MiProcessVaContiguityInformation(unsigned __int64 a1, __int64 a2)
{
  ...
  v31 = 0LL;
  v7 = 0;
  v8 = *(_QWORD *)(qword_140C4E4C8 + 8LL * *((unsigned __int16 *)v6 + 87));
