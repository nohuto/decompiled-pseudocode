/*
 * XREFs of CcGetDirtyPagesHelper @ 0x14029CC30
 * Callers:
 *     <none>
 * Callees:
...
char __fastcall CcGetDirtyPagesHelper(__int64 a1, __int64 *a2)
{
  ...
  ULONG_PTR v32; // [rsp+90h] [rbp-58h]
  void (__fastcall *v33)(ULONG_PTR, __int64 *, __int64, __int64 *, __int64 *, __int64, __int64); // [rsp+98h] [rbp-50h]
  ...
  v4 = *a2;
  v34 = *a2;
  v33 = (void (__fastcall *)(ULONG_PTR, __int64 *, __int64, __int64 *, __int64 *, __int64, __int64))a2[1];
