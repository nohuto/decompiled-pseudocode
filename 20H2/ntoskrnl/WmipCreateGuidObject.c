/*
 * XREFs of WmipCreateGuidObject @ 0x140668338
 * Callers:
...
__int64 __fastcall WmipCreateGuidObject(__int128 *a1, ACCESS_MASK a2, _OWORD *a3, _QWORD *a4)
{
  __int64 v8; // rax
  ...
  if ( GuidSecurityDescriptor >= 0 )
  {
    ...
    v25 = P;
    v23 = 640;
    GuidSecurityDescriptor = SeCreateAccessState((int)&v27, (int)v28, a2, (__int64)&WmipGenericMapping);
    if ( GuidSecurityDescriptor >= 0 )
    {
      ...
      if ( GuidSecurityDescriptor >= 0 )
      {
        ...
        *((_DWORD *)v15 + 36) = 4096;
        *(_OWORD *)(v15 + 24) = *a3;
        GuidSecurityDescriptor = ObInsertObjectEx((PADAPTER_OBJECT)v15, &v27, a2, 0, 0, 0LL, 0LL);
        if ( GuidSecurityDescriptor >= 0 )
        {
          *a4 = v15;
