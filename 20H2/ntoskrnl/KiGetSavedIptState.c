/*
 * XREFs of KiGetSavedIptState @ 0x140518690
 * Callers:
 *     <none>
 * Callees:
 *     KiGetSavedSupervisorState @ 0x140518740 (KiGetSavedSupervisorState.c)
 *     KiXSavesManagesIpt @ 0x140518AC4 (KiXSavesManagesIpt.c)
 *     RtlLocateSupervisorFeature @ 0x14058B5B0 (RtlLocateSupervisorFeature.c)
 */
