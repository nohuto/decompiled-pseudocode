/*
 * XREFs of AuthzBasepQueryInternalSecurityAttributesToken @ 0x1405D6A04
 * Callers:
 ...
 * Callees:
 *     AuthzBasepGetInternalSecurityAttributesCopyoutBufferSize @ 0x1405D6A90 (AuthzBasepGetInternalSecurityAttributesCopyoutBufferSize.c)
