/*
 * XREFs of HalpFindDevice @ 0x1409B9158
 * Callers:
 *     HalpKdReleaseDebuggingDevice @ 0x1409B9430 (HalpKdReleaseDebuggingDevice.c)
...
__int64 *__fastcall HalpFindDevice(__int64 a1)
{
  ...
  v1 = (__int64 *)qword_140C48BE8;
  v2 = 0LL;
  v4 = 0LL;
  v5 = 0;
  while ( v1 != &qword_140C48BE8 )
  {
    v6 = v1[2];
    v4 = v1;
    v7 = *(_DWORD *)(a1 + 220);
