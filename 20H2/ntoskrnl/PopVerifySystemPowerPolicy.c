/*
 * XREFs of PopVerifySystemPowerPolicy @ 0x140793524
 * Callers:
...
__int64 __fastcall PopVerifySystemPowerPolicy(_OWORD *a1, __int64 a2)
{
  ...
  *(_QWORD *)(a2 + 224) = *((_QWORD *)v4 + 12);
  ...
  v11 = *(_DWORD *)(a2 + 212);
  if ( v11 < (unsigned int)qword_140C23E10 )
  {
    *(_DWORD *)(a2 + 212) = qword_140C23E10;
    v11 = qword_140C23E10;
  }
  if ( v11 > HIDWORD(qword_140C23E10) )
    *(_DWORD *)(a2 + 212) = HIDWORD(qword_140C23E10);
