/*
 * XREFs of KiGetSystemServiceTraceTable @ 0x1408BF7C0
 * Callers:
 ...
 *     KiSystemServiceTraceTableCompareFunction @ 0x1408BF910 (KiSystemServiceTraceTableCompareFunction.c)
...
__int64 KiGetSystemServiceTraceTable()
{
  ...
  {
    PoolWithTag = ExAllocatePoolWithTag(PagedPool, 0x7610uLL, 0x7454694Bu);
    v1 = (signed __int64)PoolWithTag;
    if ( PoolWithTag )
    {
      memset(PoolWithTag, 0, 0x7610uLL);
      v3 = &off_14098B608;
      v4 = 472LL;
      v5 = v1 + 40;
      do
