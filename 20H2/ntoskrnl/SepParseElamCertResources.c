/*
 * XREFs of SepParseElamCertResources @ 0x1407A19A8
 * Callers:
 *     SeRegisterElamCertResources @ 0x1407A1914 (SeRegisterElamCertResources.c)
 * Callees:
...
LABEL_34:
    ...
    v33 = v29;
    LOBYTE(v29) = 7;
    v2 = qword_140C1D990(v29, v41, v9, *v16, (unsigned __int64)v40 & -(__int64)(v30 != 0), v33, 0LL);
    if ( v2 >= 0 && ++v34 < v36 )
      continue;
    return v2;
  }
