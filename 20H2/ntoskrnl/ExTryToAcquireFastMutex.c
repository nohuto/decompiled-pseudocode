/*
 * XREFs of ExTryToAcquireFastMutex @ 0x1402027D0
 * Callers:
 *     FsRtlTryToAcquireHeaderMutex @ 0x140201A70 (FsRtlTryToAcquireHeaderMutex.c)
 *     KeTryToAcquireGuardedMutex @ 0x1402027B0 (KeTryToAcquireGuardedMutex.c)
