/*
 * XREFs of RtlFindClearRuns @ 0x14035F6E0
 * Callers:
 *     RtlFindLongestRunClear @ 0x140585700 (RtlFindLongestRunClear.c)
 * Callees:
 *     <none>
 */
  ...
  if ( !v11 )
  {
    ...
    while ( 1 )
    {
      ...
      if ( v18 )
      {
        ...
        v16 = v17 - v15 + 8;
        v26 = *((_BYTE *)&qword_14001A7F8 - v15) | byte_14001DA60[v24] | v18;
        if ( v26 != 0xFF )
        {
          while ( v14 < v5 || v4[v14 - 1].NumberOfBits < *((unsigned __int8 *)RtlpBitsClearAnywhere + v26) )
          {
            ...
            v34 = 0;
            for ( j = byte_14001DA60[v33]; ((unsigned __int8)j & v26) != 0; ++v34 )
              j *= 2;
            v36 = v14 + 1;
