/*
 * XREFs of CmpIsLoadType @ 0x140A5FCFC
 * Callers:
        ...
        ...)
{
  ...
  if ( v12 )
  {
    ...
    if ( a6 && a7 )
    {
      ...
      if ( NodeName )
      {
        if ( RtlInitUnicodeStringEx(&DestinationString, NodeName) >= 0 )
        {
          ...
          if ( SubKeyByName != -1 )
          {
            ...
            {
              v10 = v13;
              ValueByName = CmpFindValueByName(v13, v20, (int)&CmpStartString);
      ...
      v21 = CmpFindValueByName(BugCheckParameter3, v40, (int)L"\b\n");
      if ( v21 == -1 )
        goto LABEL_8;
      ...
      v26 = CmpFindSubKeyByName(v13, a7, (unsigned __int16 *)v25);
      if ( v26 != -1 )
      {
        ...
        {
          v10 = v13;
          ValueByName = CmpFindValueByName(v13, v27, (int)&CmpStartString);
          (*(void (__fastcall **)(__int64, int *))(v13 + 16))(v13, &v32);
          if ( ValueByName != -1 )
            goto LABEL_4;
        }
    ...
    ValueByName = CmpFindValueByName(BugCheckParameter3, v40, (int)&CmpStartString);
    if ( ValueByName != -1 )
    {
LABEL_4:
