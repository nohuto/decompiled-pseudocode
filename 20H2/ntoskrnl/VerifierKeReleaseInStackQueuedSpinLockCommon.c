/*
 * XREFs of VerifierKeReleaseInStackQueuedSpinLockCommon @ 0x1409DE000
 * Callers:
 *     VerifierKeReleaseInStackQueuedSpinLock @ 0x1409DDFC0 (VerifierKeReleaseInStackQueuedSpinLock.c)
 *     VerifierKeReleaseInStackQueuedSpinLockNoReboot @ 0x1409DE220 (VerifierKeReleaseInStackQueuedSpinLockNoReboot.c)
 * Callees:
