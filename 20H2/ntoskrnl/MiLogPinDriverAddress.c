/*
 * XREFs of MiLogPinDriverAddress @ 0x1407B1614
 * Callers:
...
_QWORD *__fastcall MiLogPinDriverAddress(_QWORD *a1)
{
  ...
  if ( **(_DWORD **)&qword_140C4ED60 > 5u && tlgKeywordOn(*(__int64 *)&qword_140C4ED60, 0x400000000000LL) )
  {
    v11 = *(_DWORD *)a1;
    v26 = &v22;
    v22 = 1LL;
    ...
    v51 = 4LL;
    v53 = 8LL;
    tlgWriteAgg(v10, (unsigned __int8 *)&byte_140025A50, v9, 0x10u, &v25);
  }
