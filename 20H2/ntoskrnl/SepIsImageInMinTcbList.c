/*
 * XREFs of SepIsImageInMinTcbList @ 0x1406CB408
 * Callers:
...
LABEL_9:
    ...
    *a8 = v23;
    if ( !qword_140C1D980 || (LOBYTE(v20) = *v22, LOBYTE(v17) = a6, !(unsigned int)qword_140C1D980(v20, v17, v18)) )
      *v22 = a6;
    if ( !qword_140C1D980 || (LOBYTE(v20) = *a8, LOBYTE(v17) = a6, !(unsigned int)qword_140C1D980(v20, v17, v18)) )
      *a8 = a6;
