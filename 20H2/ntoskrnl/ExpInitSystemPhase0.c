/*
 * XREFs of ExpInitSystemPhase0 @ 0x140A6BBDC
 * Callers:
...
char ExpInitSystemPhase0()
{
  ...
  qword_140C169B8 = (__int64)&ExpSystemResourcesList;
  ...
  qword_140C16938 = (__int64)&ExNPagedLookasideListHead;
  ExNPagedLookasideListHead = (__int64)&ExNPagedLookasideListHead;
  qword_140C16928 = (__int64)&ExPagedLookasideListHead;
  ExPagedLookasideListHead = (__int64)&ExPagedLookasideListHead;
  qword_140C19658 = (__int64)&ExpFirmwareTableProviderListHead;
