/*
 * XREFs of BgpConsoleInitialize @ 0x1409F7820
 * Callers:
 *     <none>
 * Callees:
 ...
 *     BgpConsoleGetFontName @ 0x140A9A028 (BgpConsoleGetFontName.c)
 */
...
__int64 __fastcall BgpConsoleInitialize(unsigned int a1, unsigned int a2, unsigned int a3)
{
  ...
  qword_140CDAFD8 = (__int64)Memory;
  if ( !Memory )
  {
    v11 = -1073741801;
    goto LABEL_12;
  ...
  *(_DWORD *)(v8 + 52) = 22;
  ...
  BgpConsoleGetFontName((unsigned int)dword_140C13498, &Str2);
  FontHandle = BgpFoGetFontHandle(Str2, &v26);
  v10 = (unsigned int *)qword_140CDAFD8;
  v11 = FontHandle;
  if ( FontHandle >= 0 )
  {
    v11 = BgpConsoleSetPointSize(
            *(_DWORD *)(qword_140CDAFD8 + 4),
            *(_DWORD *)qword_140CDAFD8,
            *(_DWORD *)(qword_140CDAFD8 + 24),
            *(_DWORD *)(qword_140CDAFD8 + 20),
            (__int64)v25,
            (__int64)&v22);
    if ( v11 >= 0 )
    {
      ...
      *((_QWORD *)v10 + 6) = v22;
      ...
      v10 = (unsigned int *)qword_140CDAFD8;
      *(_QWORD *)(qword_140CDAFD8 + 40) = Context;
      if ( Context )
      {
        v14 = 0LL;
        v15 = *v10;
