/*
 * XREFs of sub_1409617F4 @ 0x1409617F4
 * Callers:
...
__int64 __fastcall sub_1409617F4(__int64 a1, __int64 a2, __int64 a3, __int64 a4)
{
  __int64 v4; // r15
  unsigned int v7; // r8d
  unsigned int *v8; // rdx
        ...
        if ( v16 > 5 )
        {
          ...
          if ( v16 > 6 )
          {
            ...
            if ( v8 + 1 < v8 )
              return (unsigned int)-1073741675;
            if ( qword_140D2D430 )
              v31 = ((__int64 (__fastcall *)(unsigned int *, _QWORD, _DWORD *))qword_140D2D4A8)(v22, v21, v27);
            else
              v31 = -1073741637;
            v7 = v31;
            if ( v31 < 0 )
