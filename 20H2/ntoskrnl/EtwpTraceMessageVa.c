/*
 * XREFs of EtwpTraceMessageVa @ 0x140245640
 * Callers:
 *     NtTraceEvent @ 0x140244D40 (NtTraceEvent.c)
 *     WmiTraceMessage @ 0x14032E070 (WmiTraceMessage.c)
 *     WmiTraceMessageVa @ 0x1405A4DA0 (WmiTraceMessageVa.c)
 * Callees:
        ...
        unsigned __int8 a6)
{
  ...
  LARGE_INTEGER v63; // [rsp+98h] [rbp-A0h] BYREF
...
LABEL_99:
  ...
  v28 = EtwpReserveTraceBuffer((unsigned int *)v13, v27, (__int64)&v71, &v63, 0);
  v29 = 0;
  v30 = v65;
...
LABEL_81:
  ...
  if ( (int)v41 >= 0 )
  {
    ...
    {
      EtwpSendTraceEvent(v65, &v71);
      v43 = v65;
    }
    if ( *(_QWORD *)(v43 + 1272) )
      EtwpInvokeEventCallback(v43, &v71, &v74, v42);
  }
  EtwpReleaseTraceBuffer(&v71, v39, v32, v41);
  result = v50;
  v7 = v53;
LABEL_86:
  if ( v47 )
