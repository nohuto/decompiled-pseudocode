/*
 * XREFs of KiSetupTimeIncrement @ 0x1403B31DC
 * Callers:
 *     KeInitializeClock @ 0x140A48B4C (KeInitializeClock.c)
 * Callees:
 *     KeQueryPerformanceCounter @ 0x140266AF0 (KeQueryPerformanceCounter.c)
 *     RtlGenerateQpcToIncrementConstants @ 0x140397B5C (RtlGenerateQpcToIncrementConstants.c)
 *     RtlpComputeFraction @ 0x140397B98 (RtlpComputeFraction.c)
 */
