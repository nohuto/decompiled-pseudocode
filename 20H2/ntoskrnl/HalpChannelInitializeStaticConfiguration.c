/*
 * XREFs of HalpChannelInitializeStaticConfiguration @ 0x140A62C20
 * Callers:
 ...
 *     HalpValidateMpns @ 0x1408690B0 (HalpValidateMpns.c)
 *     HalpSelectFeasibleLowPowerState @ 0x140A90C18 (HalpSelectFeasibleLowPowerState.c)
 */
