/*
 * XREFs of PfSetSuperfetchInformation @ 0x1406F4480
 * Callers:
...
__int64 __fastcall PfSetSuperfetchInformation(__int64 a1, __int128 *a2, int a3, KPROCESSOR_MODE a4)
{
  ...
  if ( DWORD2(v20) == 14 )
  {
    v8 = PfpRpControlRequest((__int64)&v20, a4);
    goto LABEL_11;
  }
  if ( SDWORD2(v20) > 14 )
  {
    ...
    if ( DWORD2(v20) != 18 )
    {
      switch ( DWORD2(v20) )
      {
        ...
        case 0x1D:
LABEL_10:
          v8 = PfpPfnPrioRequest((__int64)&v20, a4, (unsigned int *)&v35);
LABEL_11:
          v9 = v8;
          goto LABEL_12;
      }
  ...
  if ( DWORD2(v20) != 11 )
  {
    if ( DWORD2(v20) == 13 )
    {
      if ( DWORD2(v21) == 8 )
      {
        ...
        {
          v8 = PfpScenCtxPrefetchStateSet((ULONG_PTR)&qword_140C50160);
          goto LABEL_11;
        }
        goto LABEL_84;
      }
