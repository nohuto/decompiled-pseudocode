/*
 * XREFs of CmpFindSubKeyByHashWithStatus @ 0x1406C4550
 * Callers:
...
__int64 __fastcall CmpFindSubKeyByHashWithStatus(__int64 a1, __int64 a2, const UNICODE_STRING *a3, _DWORD *a4)
{
  int v8; // eax
  int v9; // ebx
  ...
  *a4 = -1;
  ...
  while ( 1 )
  {
    if ( v9 != *(_DWORD *)(a2 + 8LL * v10 + 8) )
      goto LABEL_3;
    v12 = CmpDoCompareKeyName(a1, a3, 0LL, *(_DWORD *)(a2 + 8LL * v10 + 4));
    if ( v12 == 2 )
      return 3221225626LL;
    if ( !v12 )
    {
