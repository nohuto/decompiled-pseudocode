/*
 * XREFs of MiActOnPartitionNodePages @ 0x14055EDD0
 * Callers:
 *     MiClearPartitionPageBitMap @ 0x14055F984 (MiClearPartitionPageBitMap.c)
 *     MiFreePartitionNodePages @ 0x140560814 (MiFreePartitionNodePages.c)
...
LABEL_44:
    ...
    if ( (char *)v10 != v18 && (*(_DWORD *)v10 | *((_DWORD *)qword_140011D10 + (v11 & 0x1F))) == -1 )
    {
    ...
    while ( v17 < v15 && _bittest64(v8, v17) )
      ++v17;
    SchedulerAssist = 0LL;
    if ( (char *)v10 != v18 && (*(_DWORD *)v10 & ~*((_DWORD *)qword_140011D10 + (v17 & 0x1F))) == 0 )
    {
        ...
        else
        {
          ...
          do
          {
            ...
            if ( (*(_BYTE *)(v34 + 11) & 0x40) != 0 )
              MiMoveBadPageCrossPartition(v31, (__int64)a3[1], (unsigned __int64)*a3);
