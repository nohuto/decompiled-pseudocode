/*
 * XREFs of MiMapViewOfSectionExCommon @ 0x1406EFB88
 * Callers:
 *     MmMapViewOfSectionEx @ 0x140338E80 (MmMapViewOfSectionEx.c)
 *     NtMapViewOfSectionEx @ 0x1406EE920 (NtMapViewOfSectionEx.c)
  ...
  if ( (v26[7] & 0xFFFFFFFFFFFFFFDFuLL) == 0 )
  {
    ...
    if ( MapExtendedParameters >= 0 )
    {
      ...
      if ( MapExtendedParameters >= 0 )
      {
        ...
        v25[10] = a12;
        HIDWORD(v25[7]) |= a14;
        MapExtendedParameters = MiMapViewOfSection((__int64)DmaAdapter[0], (__int64)v25, (void **)v21, 0LL, &v22, 1, 0);
