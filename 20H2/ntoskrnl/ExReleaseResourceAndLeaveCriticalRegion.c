/*
 * XREFs of ExReleaseResourceAndLeaveCriticalRegion @ 0x140223140
 * Callers:
 *     <none>
 * Callees:
...
void __stdcall ExReleaseResourceAndLeaveCriticalRegion(PERESOURCE Resource)
{
  ...
  else
  {
    ...
    if ( (Resource->ReservedLowFlags & 0x80u) == 0 )
      ExpReleaseResourceSharedForThreadLite(v5, v3, &LockHandle);
    else
  ...
  if ( v8
    && ($C774EFD68449142D8271B1EC1EB7FB26 *)v7->ApcState.ApcListHead[0].Flink != &v7->152
