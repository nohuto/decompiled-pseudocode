/*
 * XREFs of ?SmStTrimWsStore@?$SMKM_STORE@USM_TRAITS@@@@SAJPEAU1@_K@Z @ 0x140597F90
 * Callers:
...
LABEL_41:
      ...
      if ( v16 != v15 && (*v16 | *((_DWORD *)qword_140011D10 + (v12 & 0x1F))) == -1 )
      {
        v11 = v12 - (v12 & 0x1F) + 32;
      ...
      {
        v18 = v11 & 0x1F;
        if ( (*v16 & ~*((_DWORD *)qword_140011D10 + (v11 & 0x1F))) == 0 )
        {
          v17 = 32 - v18;
          if ( v18 == 33 )
            goto LABEL_32;
