/*
 * XREFs of KiSetProcessorSignature @ 0x1409A0D74
 * Callers:
 ...
 *     KiPublishProcessorFeatures @ 0x140A42EA0 (KiPublishProcessorFeatures.c)
 */
...
__int64 __fastcall KiSetProcessorSignature(__int64 a1, unsigned int a2)
{
  ...
  *((_QWORD *)&v56 + 1) = __PAIR64__(_RDX, _RCX);
  ...
  {
    v54 = i;
    if ( (unsigned int)i >= 0x29 )
      break;
    v19 = 3 * i;
    v20 = dword_1400101FC[6 * i];
    if ( (v20 & 2) == 0 )
    {
      if ( !HIBYTE(v20) || (v21 = HIBYTE(v20), _bittest((const int *)&v21, *(unsigned __int8 *)(a1 + 141))) )
      {
        ...
        v23 = 0;
        BugCheckParameter4 = dword_1400101F8[2 * v19];
        v25 = (unsigned int)dword_1400101F4[2 * v19];
        if ( ((unsigned int)v25 & *((_DWORD *)&v56 + BugCheckParameter4)) == 0
          && ((v20 & 8) == 0 || (v15 & qword_140010200[v19]) != qword_140010200[v19]) )
        {
          v27 = v20 & 0x10;
          if ( (v20 & 0x10) != 0 )
          {
            if ( (v16 & qword_140010200[v19]) == qword_140010200[v19] )
              v23 = 1;
            v27 = v20 & 0x10;
          }
          if ( !v23 )
          {
            if ( (v20 & 1) != 0 )
            {
              if ( !*(_DWORD *)(a1 + 36) )
              {
                ...
                LODWORD(BugCheckParameter4) = dword_1400101F8[2 * v19];
                LODWORD(v25) = dword_1400101F4[2 * v19];
              }
              KeBugCheckEx(
                0x5Du,
                0xFFFFFFFFuLL,
            ...
            if ( (v20 & 4) != 0 && *(_DWORD *)(a1 + 36) )
            {
              ...
              if ( (v20 & 8) != 0 )
              {
                LOBYTE(v28) = (KeFeatureBits & qword_140010200[v19]) == qword_140010200[v19];
              }
              else if ( v27 && (KeFeatureBits2 & qword_140010200[v19]) == qword_140010200[v19] )
              {
LABEL_70:
        ...
        if ( (v20 & 8) != 0 )
        {
          v15 |= qword_140010200[v19];
        }
        else if ( (v20 & 0x10) != 0 )
        {
          v16 |= qword_140010200[v19];
        }
        if ( (v20 & 4) != 0 && *(_DWORD *)(a1 + 36) )
        {
          v26 = 0;
          if ( (v20 & 8) != 0 )
          {
            LOBYTE(v26) = (KeFeatureBits & qword_140010200[v19]) == qword_140010200[v19];
            goto LABEL_13;
          }
          if ( (v20 & 0x10) == 0 || (KeFeatureBits2 & qword_140010200[v19]) != qword_140010200[v19] )
          {
LABEL_13:
            if ( !v26 )
...
LABEL_14:
  ...
  {
    v36 = (unsigned int *)(0x140000000LL + 24 * j + 24912);
    v37 = *(_DWORD *)(0x140000004LL + 24 * j + 24912);
    if ( (v37 & 2) == 0 )
    {
      if ( !HIBYTE(v37) || (v38 = HIBYTE(v37), _bittest((const int *)&v38, *(unsigned __int8 *)(a1 + 141))) )
      {
        ...
        if ( (v39 & *(_QWORD *)(0x140000010LL + 24 * j + 24912)) == *(_QWORD *)(0x140000010LL + 24 * j + 24912) )
        {
          v43 = __readmsr(*v36);
          for ( k = *(_QWORD *)(0x140000008LL + 24 * j + 24912); ; k += 24LL )
          {
            v14 = *(_QWORD *)k;
            if ( !*(_QWORD *)k )
              break;
...
LABEL_92:
  ...
  v34 = 0LL;
  v35 = a2;
  while ( dword_140020E38[5 * v34] != 19 )
  {
    if ( KiCpuTable[5 * v34] == *(unsigned __int8 *)(a1 + 141) && dword_140020E34[5 * v34] == a2 )
    {
      *(_DWORD *)(a1 + 1740) = dword_140020E40[5 * v34];
      break;
    }
