/*
 * XREFs of ?SmStHelperSendCommand@?$SMKM_STORE@USM_TRAITS@@@@SAJPEAU1@W4_SMKM_STORE_HELPER_COMMAND@@PEAU_SMKM_STORE_HELPER_PARAMS@@K@Z @ 0x140357EAC
 * Callers:
  ...
  if ( v9 != -1073741650 )
  {
    ...
    if ( (*(_BYTE *)(a1 + 6021) & 4) != 0 )
    {
      ...
      while ( 1 )
      {
        ...
        if ( v15 )
          break;
        v17 = (unsigned __int64)&CurrentThread->LockEntries[v16];
        v14 &= ~(1 << v16);
        if ( (*(_BYTE *)(v17 + 26) & 1) != 0
          && (*(_DWORD *)(v17 + 32) & 1) == 0
          ...
          *(_BYTE *)(v17 + 26) &= ~1u;
          if ( *(_QWORD *)(v17 + 32) )
          {
            if ( v17 )
            {
              ...
              *(_BYTE *)(v17 + 25) &= ~1u;
              *(_QWORD *)(v17 + 32) = 0LL;
              v18 = (__int64)(v17 - (unsigned __int64)CurrentThread->LockEntries) / 96;
              if ( v23 == 1 )
