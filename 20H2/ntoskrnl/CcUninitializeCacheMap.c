/*
 * XREFs of CcUninitializeCacheMap @ 0x14029E760
 * Callers:
        ...
        PCACHE_UNINITIALIZE_EVENT UninitializeEvent)
{
  ...
  PVOID *v12; // rcx
  PCACHE_UNINITIALIZE_EVENT v13; // r11
  int v14; // eax
  char v15; // dl
  ...
  *(_QWORD *)&v46.OldIrql = 0LL;
  ...
  if ( PrivateCacheMap )
  {
    ...
    --*((_DWORD *)SharedCacheMap + 1);
    v11 = PrivateCacheMap[12];
    v12 = (PVOID *)PrivateCacheMap[13];
    if ( (PFILE_OBJECT *)v11->DeviceObject == PrivateCacheMap + 12 && *v12 == PrivateCacheMap + 12 )
    {
      *v12 = v11;
      v11->DeviceObject = (PDEVICE_OBJECT)v12;
...
LABEL_28:
    ...
    if ( (v14 & 4) != 0 || UninitializeEvent )
    {
      ...
      if ( !*((_DWORD *)SharedCacheMap + 28)
        && ((v14 & 0x400) == 0 || *((_QWORD *)SharedCacheMap + 5) == 0x7FFFFFFFFFFFFFFFLL) )
      {
        CcDeleteSharedCacheMap(SharedCacheMap, &v46, &LockHandle, 0, 0LL);
        v5 = 0;
        v4 = 1;
        goto LABEL_30;
      }
...
LABEL_24:
    *(_BYTE *)(Partition + 633) = 1;
    ...
    {
      v15 = v13 && (*((_DWORD *)SharedCacheMap + 38) & 0x20) == 0;
    }
    CcScheduleLazyWriteScan(Partition, v15, v15);
    KeReleaseInStackQueuedSpinLockFromDpcLevel(&LockHandle);
    OldIrql = LockHandle.OldIrql;
    if ( !KiIrqlFlags )
      goto LABEL_28;
