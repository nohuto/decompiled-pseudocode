/*
 * XREFs of PopMarkHiberPhase @ 0x1409B46C8
 * Callers:
...
void __fastcall PopMarkHiberPhase(unsigned int *Address)
{
  ...
  PoSetHiberRange(0LL, 0x10000u, qword_140C23530, Length, 0);
  ...
  PoSetHiberRange(0LL, 0x10000u, qword_140C234F8, (unsigned int)dword_140C23500, 0);
