/*
 * XREFs of PnpRequestDeviceAction @ 0x14036E774
 * Callers:
 ...
 *     PnpInitializeProcessor @ 0x14050A828 (PnpInitializeProcessor.c)
 ...
 *     PiResetProblemDevicesWorker @ 0x14076A9A0 (PiResetProblemDevicesWorker.c)
 ...
 *     IopResourceRequirementsChanged @ 0x1408A2460 (IopResourceRequirementsChanged.c)
 ...
 *     PnpLogActionQueueEvent @ 0x14036F048 (PnpLogActionQueueEvent.c)
...
LABEL_9:
      if ( v12 && (KeGetPcr()->Prcb.DpcRequestSummary & 0x10001) == 0 )
      {
        ...
        {
          v43 = *(GUID *)&KeGetPcr()->NtTib.$291CBC43A21EE7E4F58DE30F5474C31B::$F973CBAF4608634B0F908ADAEF96F715::Self[105].SubSystemTib;
        }
      }
      goto LABEL_13;
    }
...
LABEL_13:
  *(GUID *)(PoolWithTag + 56) = v43;
  ...
  v15 = KeAcquireSpinLockRaiseToDpc(&qword_140C24D08);
  if ( ++dword_140C24D10 == 1 )
  ...
  __writecr8(v15);
  v16 = KeAcquireSpinLockRaiseToDpc(&qword_140C1E8B0);
  ...
  v19 = (_QWORD *)qword_140C43408;
  if ( *(__int64 **)qword_140C43408 != &PnpEnumerationRequestList )
    __fastfail(3u);
  *(_QWORD *)PoolWithTag = &PnpEnumerationRequestList;
  *((_QWORD *)PoolWithTag + 1) = v19;
  *v19 = PoolWithTag;
  qword_140C43408 = (__int64)PoolWithTag;
  if ( a7 )
  {
