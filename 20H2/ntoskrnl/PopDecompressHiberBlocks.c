/*
 * XREFs of PopDecompressHiberBlocks @ 0x140997874
 * Callers:
 ...
 *     RtlDecompressBufferProgress @ 0x1405904A0 (RtlDecompressBufferProgress.c)
 ...
 *     PopReadProducerConsumerBuffer @ 0x1409B47F0 (PopReadProducerConsumerBuffer.c)
        ...
        void (__fastcall *a5)(_DWORD *))
{
  ...
  LODWORD(v8) = (_DWORD)qword_140C23578;
  v9 = 0;
  v43 = 0;
  v47 = 0LL;
  v41 = 0;
  ...
  while ( 1 )
  {
    ...
    if ( !qword_140C239D8 && BugCheckParameter3[48] == KeGetCurrentPrcb()->Number && byte_140C23520 )
      qword_140C239D8 = KeQueryPerformanceCounter(0LL).QuadPart;
    Number = KeGetCurrentPrcb()->Number;
    if ( BugCheckParameter3[48] == (_DWORD)Number
      && !byte_140C23521
      && (!byte_140C23520 || (unsigned int)dword_140C23504 > 0x640) )
    {
      v15 = __rdtsc();
      if ( byte_140C504D0 )
      {
      ...
      v16 = __rdtsc();
      qword_140C239C0 += (((unsigned __int64)HIDWORD(v16) << 32) | (unsigned int)v16) - v15;
    }
    v40 = 4;
