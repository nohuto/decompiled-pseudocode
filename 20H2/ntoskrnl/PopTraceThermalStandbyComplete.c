/*
 * XREFs of PopTraceThermalStandbyComplete @ 0x140571F54
 * Callers:
...
void PopTraceThermalStandbyComplete()
{
  ...
  if ( (unsigned int)dword_140C021E8 > 5 )
  {
    if ( tlgKeywordOn((__int64)&dword_140C021E8, 0x400000000000LL) )
    {
      ...
      v10 = 4LL;
      v12 = 4LL;
      tlgWriteTransfer_EtwWriteTransfer((__int64)&dword_140C021E8, (unsigned __int8 *)byte_140026FDD, 0LL, 0LL, 5u, &v6);
    }
  }
}
