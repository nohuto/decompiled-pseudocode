/*
 * XREFs of PiDqIrpPropertySet @ 0x14072A3CC
 * Callers:
 ...
 *     _PnpSetGenericStoreProperty @ 0x1407356F8 (_PnpSetGenericStoreProperty.c)
...
__int64 __fastcall PiDqIrpPropertySet(PIRP Irp)
{
  ...
  if ( v6 < 0 )
    goto LABEL_27;
  NdrMesTypeDecode3(v20, "TP 3\a", &off_1400016A8, &off_140C01A50, 2, &P);
  if ( !P
    || !*((_QWORD *)P + 1)
    || !*((_QWORD *)P + 3)
    || !*((_DWORD *)P + 4)
