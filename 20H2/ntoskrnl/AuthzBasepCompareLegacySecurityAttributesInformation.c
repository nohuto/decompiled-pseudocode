/*
 * XREFs of AuthzBasepCompareLegacySecurityAttributesInformation @ 0x14068E908
 * Callers:
 ...
 *     AuthzBasepCompareSecurityAttribute @ 0x14068EA08 (AuthzBasepCompareSecurityAttribute.c)
 */
