/*
 * XREFs of SepLogUnmatchedSessionFlagImpersonationAttempt @ 0x140595888
 * Callers:
...
void __fastcall SepLogUnmatchedSessionFlagImpersonationAttempt(__int64 a1, __int64 a2)
{
  ...
  *(_OWORD *)P = 0LL;
  ...
  v6 = P[1];
  if ( (unsigned int)dword_140C02B30 > 5 && tlgKeywordOn((__int64)&dword_140C02B30, 0x400000000000LL) )
  {
    ...
    v25 = v6;
    v26[1] = 0;
    tlgWriteTransfer_EtwWriteTransfer((__int64)&dword_140C02B30, (unsigned __int8 *)&word_14002B42E, 0LL, 0LL, 8u, &v14);
  }
  if ( v6 )
