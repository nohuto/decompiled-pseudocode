/*
 * XREFs of HvlpFlushRangeListTbEx @ 0x1404F93DC
 * Callers:
 *     HvlFlushRangeListTb @ 0x14038FA8C (HvlFlushRangeListTb.c)
 * Callees:
 *     HvlpAllowFastFlushList @ 0x1403900DC (HvlpAllowFastFlushList.c)
 *     HvlpCountFlushVaList @ 0x140390108 (HvlpCountFlushVaList.c)
