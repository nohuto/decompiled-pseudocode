/*
 * XREFs of MiInitializeDriverImages @ 0x140A4D154
 * Callers:
...
__int64 __fastcall MiInitializeDriverImages(__int64 a1)
{
  ...
  while ( v6 );
  MxMarkActiveDriverBits((unsigned int)&qword_140C4DF60, v1, v4, (unsigned int)&v22, 3);
  v7 = qword_140C4DF68;
  v8 = (_DWORD *)((((unsigned __int64)qword_140C4DF68 >> 9) & 0x7FFFFFFFF8LL) - 0x98000000000LL);
  for ( i = 0LL; i < qword_140C4DF60; i += 0x8000LL )
  {
    if ( (*v8 & 0x800LL) == 0 )
    {
      if ( !(unsigned int)MiSplitBitmapPages(5, v7, 8LL) )
        return 0LL;
      RtlClearBitsEx((__int64)&qword_140C4DF60, i, 0x8000uLL);
    }
    v7 += 4096LL;
    v8 += 2;
  }
  ...
  qword_140C4CB70 = -1LL;
  qword_140C4CBA8 = 0LL;
  qword_140C4CB80 = (__int64)&qword_140C4CB78;
  qword_140C4CB78 = (__int64)&qword_140C4CB78;
    ...
    if ( &MmLargePageDriverBuffer < (_UNKNOWN *)v14 )
    {
      ...
      do
      {
        ...
        else
        {
          ...
          *((_WORD *)Pool + 8) = v20;
          *((_WORD *)Pool + 9) = v20;
          v21 = (_QWORD *)qword_140C4CB80;
          if ( *(__int64 **)qword_140C4CB80 != &qword_140C4CB78 )
            __fastfail(3u);
          *Pool = &qword_140C4CB78;
          Pool[1] = v21;
          v15 = 0x100002601LL;
          *v21 = Pool;
          qword_140C4CB80 = (__int64)Pool;
        }
        v13 = j + 1;
      }
      while ( j + 1 < v14 );
  ...
  MiFreeKernelPadSections(
    *(_QWORD *)(qword_140C4CB98 + 48),
    *(_QWORD *)(qword_140C4CB98 + 48) + *(unsigned int *)(qword_140C4CB98 + 64));
  if ( !(unsigned int)MiReloadBootLoadedDrivers(a1) || !(unsigned int)MiCreateInitialSystemWsles() )
    return 0LL;
  VfInitBootDriversLoaded(a1);
  result = 1LL;
  qword_140C4CB90 = (__int64)&qword_140C4CB88;
  qword_140C4CB88 = &qword_140C4CB88;
  return result;
}
