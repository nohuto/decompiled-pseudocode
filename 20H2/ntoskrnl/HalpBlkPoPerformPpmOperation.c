/*
 * XREFs of HalpBlkPoPerformPpmOperation @ 0x140A1CDC4
 * Callers:
 *     HalpBlkHandleIpi @ 0x140A1D190 (HalpBlkHandleIpi.c)
 * Callees:
 *     HalpBlkPoPerformPpmOperationForIoPort @ 0x140A1CE50 (HalpBlkPoPerformPpmOperationForIoPort.c)
 *     HalpBlkPoPerformPpmOperationForMsr @ 0x140A1CEE0 (HalpBlkPoPerformPpmOperationForMsr.c)
 */
