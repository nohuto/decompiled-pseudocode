/*
 * XREFs of MiZeroLargePageThread @ 0x1403B28F0
 * Callers:
 *     <none>
 * Callees:
    ...
    if ( *((_BYTE *)P + 80) )
    {
      ...
      if ( v11 )
      {
        KeAcquireInStackQueuedSpinLock(
          (PKSPIN_LOCK)(qword_140C50C10 + 4544LL * *(unsigned int *)(v11 + 184) + 4304),
          &LockHandle);
...
LABEL_19:
    ...
    if ( v17 )
    {
      ...
      if ( (ULONG_PTR *)v21 != &MiSystemPartition )
      {
        ...
        __writecr8(v24);
        v42 = ExAcquireSpinLockExclusive(&dword_140C50CC8);
        v9 = v53;
        v24 = v42;
      }
      if ( !--qword_140C50C28 )
      {
        v23 = (_QWORD *)qword_140C50C58;
        qword_140C50C58 = 0LL;
      }
      if ( (BYTE6(PerfGlobalGroupMask) & 1) != 0 )
      {
