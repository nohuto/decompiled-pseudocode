/*
 * XREFs of AnFwpProgressIndicatorTimer @ 0x1409F74C0
 * Callers:
 *     <none>
 * Callees:
        ...
        PVOID SystemArgument2)
{
  ...
  if ( byte_140CDAFE0 )
  {
    ...
    if ( word_140C10DF8 != -7989
      && (qword_140CDAFE8 + 10 * (v8[0].QuadPart / 33) / 100 - PerformanceCounter.QuadPart) / (v8[0].QuadPart / 33) >= 2 )
    {
      v5 = ++word_140C10DF8;
    }
