  ...
  *(_DWORD *)v38 = 0;
  ...
  if ( DriverNameFromKeyNode >= 0 )
  {
    ...
    if ( Pool )
    {
      ...
      WORD1(v36) = Destination.Length + 2;
...
LABEL_53:
          ...
          else
          {
            ...
            *(_WORD *)&v38[2] = v14->OptionalHeader.MajorImageVersion;
            DriverNameFromKeyNode = PnpPrepareDriverLoading(&v36, KeyHandle, BaseOfImage, v5, &v41);
            if ( DriverNameFromKeyNode < 0
                ...
                *((_QWORD *)v21 + 8) = v22;
                ...
                if ( v23 )
                {
                  ...
                  else
                  {
                    ...
                    {
                      v24 = WORD1(v36);
                      *(_QWORD *)(*((_QWORD *)v21 + 6) + 32LL) = IopVerifierExAllocatePool(NonPagedPoolNx, WORD1(v36));
                      v25 = *((_QWORD *)v21 + 6);
                      if ( *(_QWORD *)(v25 + 32) )
                      {
                        *(_WORD *)(v25 + 26) = v24;
                        *(_WORD *)(*((_QWORD *)v21 + 6) + 24LL) = v36;
...
LABEL_35:
  ...
  if ( (int)(DriverNameFromKeyNode + 0x80000000) >= 0 && DriverNameFromKeyNode != -1073741218 )
  {
    ...
    if ( DriverNameFromKeyNode != -1073741554 )
    {
      ...
      if ( DriverNameFromKeyNode != -1073740955 && IopGetRegistryValue(KeyHandle, L"ErrorControl", 0, &v50) >= 0 )
      {
        if ( *((_DWORD *)v50 + 3)
          && (_BYTE)CmFirstTime == 1
