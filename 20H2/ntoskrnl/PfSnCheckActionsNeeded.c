/*
 * XREFs of PfSnCheckActionsNeeded @ 0x14064C34C
 * Callers:
  ...
  *(_QWORD *)&v35[1] = a1;
  ...
  else
  {
    ...
    else
    {
      ...
      v27 = PfSnPrefetchCacheEntryGet((__int64)&unk_140C50338, *(_OWORD **)&v35[1], v16, &v34);
      v28 = (_DWORD *)v27;
      if ( v27 )
      {
        if ( v34 )
