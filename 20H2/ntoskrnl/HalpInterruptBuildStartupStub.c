/*
 * XREFs of HalpInterruptBuildStartupStub @ 0x1403A0CC0
 * Callers:
 ...
 *     HalpInterruptCreateGdtEntry32 @ 0x1403A0F08 (HalpInterruptCreateGdtEntry32.c)
 *     memmove @ 0x140411040 (memmove.c)
 *     KeForceEnableNx @ 0x14099CBC0 (KeForceEnableNx.c)
 */
...
_QWORD *__fastcall HalpInterruptBuildStartupStub(PVOID *a1, PHYSICAL_ADDRESS *a2, const void *a3, __int64 a4)
{
  ...
  *((_OWORD *)v11 + 1) = xmmword_14001E980;
  *((_OWORD *)v11 + 2) = xmmword_14001E990;
  *((_OWORD *)v11 + 3) = xmmword_14001E9A0;
  *((_OWORD *)v11 + 4) = xmmword_14001E9B0;
