/*
 * XREFs of CmInitSystem1 @ 0x140A58954
 * Callers:
 ...
 *     CmpInitializeFreezeThaw @ 0x14079B490 (CmpInitializeFreezeThaw.c)
 *     HvInitializeHashLibrary @ 0x14079B4C8 (HvInitializeHashLibrary.c)
 *     CmpValidateGlobalFlushControlFlags @ 0x14079B50C (CmpValidateGlobalFlushControlFlags.c)
 *     CmpInitializeGlobalKeyLockTracker @ 0x14079B52C (CmpInitializeGlobalKeyLockTracker.c)
 *     CmpVolumeManagerInitialize @ 0x14079B554 (CmpVolumeManagerInitialize.c)
 ...
 *     CmpUpdateStateSeparationHiveOptions @ 0x140A91CBC (CmpUpdateStateSeparationHiveOptions.c)
 *     CmpInitCmPrivateAlloc @ 0x140A91D1C (CmpInitCmPrivateAlloc.c)
 */
...
char __fastcall CmInitSystem1(ULONG_PTR BugCheckParameter3)
{
  ...
  *(&ObjectAttributes.Attributes + 1) = 0;
  ...
  qword_140C47EE8 = (__int64)&CmpAppHiveLoadList;
  ...
  qword_140D2D6B8 = (__int64)&CmpAsyncKernelPostList;
  ...
  qword_140C47F28 = (__int64)&CmpWorkerEngineListHead;
