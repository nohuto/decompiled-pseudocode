/*
 * XREFs of MiFlushStrongCodeDriverLoadFailures @ 0x140A52E5C
 * Callers:
...
_QWORD *MiFlushStrongCodeDriverLoadFailures()
{
  ...
  while ( 1 )
  {
    v1 = (const CHAR **)qword_140C4CB88;
    if ( qword_140C4CB88 == &qword_140C4CB88 )
      break;
    if ( *((PVOID **)qword_140C4CB88 + 1) != &qword_140C4CB88
      || (v3 = *(_QWORD *)qword_140C4CB88, *(PVOID *)(*(_QWORD *)qword_140C4CB88 + 8LL) != qword_140C4CB88) )
    {
      __fastfail(3u);
    }
    qword_140C4CB88 = *(PVOID *)qword_140C4CB88;
    *(_QWORD *)(v3 + 8) = &qword_140C4CB88;
    if ( **(_DWORD **)&qword_140C4ED60 > 5u && tlgKeywordOn(*(__int64 *)&qword_140C4ED60, 0x400000000000LL) )
    {
      ...
      v10 = 0x1000000LL;
      v25 = 8;
      tlgWriteEx_EtwWriteEx(v5, (unsigned __int8 *)&byte_140024DB7, v4, 1u, v6, v7, 8u, &v11);
    }
