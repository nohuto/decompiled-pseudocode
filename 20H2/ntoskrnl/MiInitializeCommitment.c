/*
 * XREFs of MiInitializeCommitment @ 0x1403BEDD4
 * Callers:
...
__int64 __fastcall MiInitializeCommitment(unsigned __int64 a1)
{
  ...
  *(_DWORD *)(a1 + 492) = 0;
  ...
  if ( dword_140C4DD7C )
  {
    ...
    v5 = (unsigned int)dword_140C4DD7C;
  ...
  *(_QWORD *)(a1 + 7168) = v3;
  ...
  if ( (ULONG_PTR *)a1 == &MiSystemPartition )
  {
    qword_140C4EE30 = *(_QWORD *)(a1 + 7464);
    qword_140C4EE30 -= qword_140C4EE38;
    result = qword_140C4EE58;
    qword_140C4EE30 -= qword_140C4EE58;
  }
  return result;
}
