/*
 * XREFs of HalpCheckWakeupTimeAndAdjust @ 0x1404D0EB8
 * Callers:
...
LABEL_21:
        ...
        if ( !ExLeapSecondData || !*(_BYTE *)ExLeapSecondData )
        {
          RtlpTimeFieldsToTimeNoLeapSeconds((__int16 *)&xmmword_140C491E2, &v17);
          goto LABEL_38;
        }
        v9 = *((_DWORD *)ExLeapSecondData + 1);
        _InterlockedOr(v16, 0);
        if ( !RtlpTimeFieldsToTimeNoLeapSeconds((__int16 *)&xmmword_140C491E2, &v22) )
          goto LABEL_38;
        v0 = v22;
        v10 = 0LL;
        if ( v9 )
