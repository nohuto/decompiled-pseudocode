/*
 * XREFs of PpmInstallNewIdleStates @ 0x1403C3AB0
 * Callers:
 *     PpmIdleInstallDefaultStates @ 0x1403C3A90 (PpmIdleInstallDefaultStates.c)
 * Callees:
 ...
 *     PpmDeepestHardwareIdleState @ 0x1403C3FFC (PpmDeepestHardwareIdleState.c)
