/*
 * XREFs of TtmiLogCalloutWatchdogCrashSkipped @ 0x140903F34
 * Callers:
...
char __fastcall TtmiLogCalloutWatchdogCrashSkipped(int a1, int a2, __int64 a3, __int64 a4, __int64 a5, __int64 a6)
{
  ...
  v6 = &retaddr;
  if ( (unsigned int)dword_140D2D8B0 > 5 )
  {
    LOBYTE(v6) = tlgKeywordOn((__int64)&dword_140D2D8B0, 0x400000000001LL);
    if ( (_BYTE)v6 )
    {
      ...
      LOBYTE(v6) = tlgWriteTransfer_EtwWriteTransfer(
                     (__int64)&dword_140D2D8B0,
                     (unsigned __int8 *)byte_140029FDB,
                     0LL,
                     0LL,
                     9u,
                     &v20);
