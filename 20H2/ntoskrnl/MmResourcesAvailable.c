/*
 * XREFs of MmResourcesAvailable @ 0x1402144D0
 * Callers:
...
LABEL_8:
  ...
  if ( (a1 & 0x20) == 0 )
  {
    v11 = qword_140C4EDB8 - qword_140C4EDA8;
    goto LABEL_8;
  }
  ...
  v3 = *(ULONG_PTR **)(qword_140C4E4C8 + 8LL * *(unsigned __int16 *)(v9 + 430));
LABEL_9:
  v17 = a2 + 0x80000;
  if ( a3 != 16 )
    v17 = a2 + 0x200000;
  if ( v17 <= v16 )
  {
    ...
    if ( v8 > v18 )
    {
      MiIssuePageExtendRequest(v3, v8, 2LL);
    }
    else
    {
LABEL_30:
  ...
  if ( (a1 & 0x20) == 0 )
  {
    if ( v10 )
    {
      ...
      if ( (_InterlockedExchangeAdd64((volatile signed __int64 *)&qword_140C4ED98, 0xFFFFFFFFFFFFFFFFuLL) & 6) == 2 )
        ExfTryToWakePushLock(&qword_140C4ED98);
      KeAbPostRelease((ULONG_PTR)&qword_140C4ED98);
