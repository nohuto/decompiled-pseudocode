/*
 * XREFs of MiApplyRetpolineFixupsToKernelAndHal @ 0x140A4EF80
 * Callers:
...
__int64 __fastcall MiApplyRetpolineFixupsToKernelAndHal(__int64 a1)
{
  ...
  v26 = 0LL;
  v3 = *(_QWORD *)(a1 + 16);
  dword_140C4CACC = *(_DWORD *)(v1 + 3468) >> 12;
  if ( (KiSpeculationFeatures & 0x2000000) != 0
    && (v26 = v3,
        ...
        dword_140C4CB08 = (v12 >> 12) + ((v12 & 0xFFF) != 0),
        dword_140C4CB08 > (unsigned int)dword_140C4CACC) )
  {
    updated = -1073741811;
  }
