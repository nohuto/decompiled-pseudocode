/*
 * XREFs of sub_1409647BC @ 0x1409647BC
 * Callers:
...
__int64 __fastcall sub_1409647BC(__int64 a1, __int64 a2, __int64 a3, __int64 a4)
{
  __int64 v4; // rbx
  unsigned int v7; // r8d
  unsigned int *v8; // rax
...
LABEL_19:
  if ( (v7 & 0x80000000) == 0 )
  {
    ...
    v15 = KeWaitForSingleObject(&stru_140C13D00, UserRequest, 1, 0, &Timeout);
    if ( v15 >= 0 && v15 != 192 && v15 != 258 )
    {
      if ( stru_140C13CE0.Header.SignalState || !dword_140D2D1C4 )
      {
