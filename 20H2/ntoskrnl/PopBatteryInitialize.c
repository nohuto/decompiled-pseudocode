/*
 * XREFs of PopBatteryInitialize @ 0x1408EF9E0
 * Callers:
...
NTSTATUS __fastcall PopBatteryInitialize(__int64 a1)
{
  ...
  if ( result >= 0 )
  {
    ...
    *(_DWORD *)(a1 + 104) = 3;
    v9 = (_QWORD *)(a1 + 64);
    v10 = (_QWORD *)qword_140C235F8;
    if ( *(__int64 **)qword_140C235F8 != &qword_140C235F0 )
      __fastfail(3u);
    v9[1] = qword_140C235F8;
    *v9 = &qword_140C235F0;
    *v10 = v9;
    ++dword_140C235D4;
    ++dword_140C23638;
    result = 0;
    qword_140C235F8 = (__int64)v9;
    byte_140C235D8 = 1;
  }
  return result;
}
