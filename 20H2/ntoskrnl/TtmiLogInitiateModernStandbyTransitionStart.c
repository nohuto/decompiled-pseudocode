/*
 * XREFs of TtmiLogInitiateModernStandbyTransitionStart @ 0x1409056F8
 * Callers:
...
void __fastcall TtmiLogInitiateModernStandbyTransitionStart(char a1, int a2)
{
  ...
  if ( (unsigned int)dword_140D2D8E8 > 5 )
  {
    if ( tlgKeywordOn((__int64)&dword_140D2D8E8, 1LL) )
    {
      ...
      v13 = 1;
      v7 = a2;
      tlgWriteTransfer_EtwWriteTransfer((__int64)&dword_140D2D8E8, (unsigned __int8 *)word_14002A392, 0LL, 0LL, 5u, &v8);
    }
  }
}
