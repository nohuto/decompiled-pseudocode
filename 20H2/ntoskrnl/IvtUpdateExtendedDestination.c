/*
 * XREFs of IvtUpdateExtendedDestination @ 0x1404DF56C
 * Callers:
 *     IvtUpdateRemappingDestination @ 0x1404DF750 (IvtUpdateRemappingDestination.c)
 *     HsaUpdateRemappingDestination @ 0x1404E2BE0 (HsaUpdateRemappingDestination.c)
 * Callees:
 *     IvtUpdateSingleTargetExtendedDestination @ 0x1404DF9F0 (IvtUpdateSingleTargetExtendedDestination.c)
 */
