/*
 * XREFs of MiAdvanceVadView @ 0x140250914
 * Callers:
...
__int64 __fastcall MiAdvanceVadView(__int64 a1, __int64 a2)
{
  ...
  if ( (*(_DWORD *)(a1 + 48) & 0x100000) == 0 )
  {
    ...
    if ( v9 )
    {
      SubsectionNode = (_QWORD *)MiLocatePagefileSubsection(v6 + 128, &v16);
      v8 = v16;
    }
    else
    {
    ...
    v13 = v8 - (*((unsigned int *)SubsectionNode + 9) | ((unsigned __int64)((_WORD)SubsectionNode[4] & 0xFFC0) << 26));
    *(_QWORD *)(a1 + 72) = SubsectionNode;
    v14 = SubsectionNode[1] + 8 * v13;
