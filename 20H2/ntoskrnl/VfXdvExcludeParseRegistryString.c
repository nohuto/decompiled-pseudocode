/*
 * XREFs of VfXdvExcludeParseRegistryString @ 0x140A97124
 * Callers:
        ...
        else
        {
          ...
          if ( v7 )
          {
            ...
            if ( (unsigned __int16)(v7 + 2) < (unsigned __int16)v7 )
              return Entry;
            *((_QWORD *)&v11 + 1) = v1;
            Entry = (unsigned __int64)VfSuspectExcludedDriversAllocateEntry((unsigned __int16 *)&v11, 0x45586656u);
            v8 = (_QWORD *)Entry;
            if ( Entry )
            {
              VfDriverLock();
              v9 = (_QWORD *)qword_140C1CAC8;
              if ( *(__int64 **)qword_140C1CAC8 != &VfXdvExcludedDriversList )
                __fastfail(3u);
              *v8 = &VfXdvExcludedDriversList;
              v8[1] = v9;
              *v9 = v8;
              qword_140C1CAC8 = (__int64)v8;
