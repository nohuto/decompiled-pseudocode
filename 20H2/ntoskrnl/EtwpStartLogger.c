/*
 * XREFs of EtwpStartLogger @ 0x140713B28
 * Callers:
 ...
 *     EtwpSetQpcDeltaTracking @ 0x1405A8D78 (EtwpSetQpcDeltaTracking.c)
...
LABEL_52:
  ...
  if ( v65 >= *(_DWORD *)(v20 + 16) )
  {
    if ( !byte_140CF74A0 )
    {
      ...
      {
        if ( tlgKeywordOn((__int64)&dword_140C02B78, 0x800000000000LL) )
        {
          v72 = v59;
          v80 = &v72;
          v81 = 4LL;
          tlgWriteTransfer_EtwWriteTransfer(
            ...
            (unsigned __int8 *)&dword_14002C37C,
            0LL,
            0LL,
            3u,
            &v79);
