/*
 * XREFs of EtwpFreeLoggerContext @ 0x140712770
 * Callers:
 ...
 *     ExReInitializeRundownProtectionCacheAware @ 0x140203A20 (ExReInitializeRundownProtectionCacheAware.c)
...
void __fastcall EtwpFreeLoggerContext(char *P)
{
  ...
  *((_DWORD *)P + 208) |= 0x200u;
  ...
  if ( (v18 & 0x2000) != 0 )
  {
    _InterlockedDecrement(&dword_140C53BE0);
    v18 = *((_DWORD *)P + 208);
  }
  if ( (v18 & 0x1000000) != 0 )
  ...
  if ( v22 )
  {
    ...
    {
      _InterlockedDecrement(&dword_140C53C00);
      v22 = (_DWORD *)*((_QWORD *)P + 126);
    }
    if ( v22 )
    {
