/*
 * XREFs of LdrProcessRelocationBlockLongLong @ 0x14091BAE8
 * Callers:
 *     LdrRelocateImageWithBias @ 0x14091BBA4 (LdrRelocateImageWithBias.c)
 * Callees:
 *     LdrpArmProcessRelocation @ 0x14058C7E8 (LdrpArmProcessRelocation.c)
 *     LdrpGenericProcessRelocation @ 0x14058C8BC (LdrpGenericProcessRelocation.c)
 *     LdrpThumbProcessRelocation @ 0x14058C964 (LdrpThumbProcessRelocation.c)
 */
