/*
 * XREFs of AlpcpSendMessage @ 0x1405EBDA0
 * Callers:
 ...
 *     AlpcpValidateMessage @ 0x1405EB4C8 (AlpcpValidateMessage.c)
...
LABEL_64:
  ...
  if ( !v13 )
  {
    ...
    {
      ++dword_140CEBC18;
      v21 = (PSLIST_ENTRY)((__int64 (__fastcall *)(_QWORD, _QWORD, _QWORD))qword_140CEBC30)(
                            (unsigned int)dword_140CEBC24,
                            (unsigned int)dword_140CEBC2C,
                            (unsigned int)dword_140CEBC28);
      if ( !v21 )
        return 3221225626LL;
    }
