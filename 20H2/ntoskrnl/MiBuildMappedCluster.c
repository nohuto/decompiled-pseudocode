/*
 * XREFs of MiBuildMappedCluster @ 0x140345BF8
 * Callers:
...
unsigned __int64 *__fastcall MiBuildMappedCluster(_QWORD *a1, unsigned __int64 *a2, int a3)
{
  ...
  v79 = v9;
  v82 = *(_QWORD *)(qword_140C4E4C8 + 8 * ((v7 >> 39) & 0x3FF));
  ...
  if ( v9 > v15 )
  {
    do
    {
      ...
      if ( (*(_QWORD *)v13 & 0xC01LL) != 0x800
        || (*(_QWORD *)(48 * (((v38 & (unsigned __int64)~qword_140C4DDC0) >> 12) & 0xFFFFFFFFFLL) - 0x57FFFFFFFD8LL) & 0x4000000000000LL) == 0
        || (*(_BYTE *)(48 * (((v38 & (unsigned __int64)~qword_140C4DDC0) >> 12) & 0xFFFFFFFFFLL) - 0x58000000000LL + 34) & 0x10) == 0
        || *(_WORD *)(48 * (((v38 & (unsigned __int64)~qword_140C4DDC0) >> 12) & 0xFFFFFFFFFLL) - 0x58000000000LL + 32)
        || v82 != *(_QWORD *)(qword_140C4E4C8
                            + 8
                            * ((*(_QWORD *)(48 * (((v38 & (unsigned __int64)~qword_140C4DDC0) >> 12) & 0xFFFFFFFFFLL)
                                          - 0x58000000000LL
                                          + 40) >> 39) & 0x3FFLL)) )
      {
        break;
...
LABEL_23:
    ...
    if ( v24 != 3 || (__int64)(((char *)v75 - (char *)v4 - 48) & 0xFFFFFFFFFFFFFFF8uLL) < 128 )
    {
      ...
      {
        v33 = 6 * (((v32 & (unsigned __int64)~qword_140C4DDC0) >> 12) & 0xFFFFFFFFFLL);
        if ( (*(_QWORD *)(48 * (((v32 & (unsigned __int64)~qword_140C4DDC0) >> 12) & 0xFFFFFFFFFLL) - 0x57FFFFFFFD8LL) & 0x4000000000000LL) == 0 )
        {
          v25 = v79;
          v19 -= 8LL;
          v23 -= 8LL;
        ...
        v34 = 48 * (((v32 & (unsigned __int64)~qword_140C4DDC0) >> 12) & 0xFFFFFFFFFLL) - 0x58000000000LL;
        v84 = 0;
...
LABEL_121:
        ...
        if ( (*(_BYTE *)(v34 + 34) & 0x10) != 0
          ...
          && v82 == *(_QWORD *)(qword_140C4E4C8 + 8 * ((*(_QWORD *)(v34 + 40) >> 39) & 0x3FFLL)) )
        {
          if ( v23 >= v74 )
          {
LABEL_42:
...
LABEL_43:
          ...
          if ( v76 )
          {
            ...
            v94 = MiReferencePageForModifiedWrite(v34, 0);
          ...
          {
            v56 = MiReferencePageForModifiedWrite(v34, 0);
            v16 = 0LL;
            v36 = v56;
            v94 = v56;
          }
          ...
          if ( v36 )
          {
            *v75++ = ((v32 & (unsigned __int64)~qword_140C4DDC0) >> 12) & 0xFFFFFFFFFLL;
            goto LABEL_42;
          }
        }
        else
    ...
    if ( v57 )
    {
      ...
      MiReleaseWriteInProgressCharges(v82, v57, 1);
      v39 = v79;
    }
    v22 = v74;
    if ( v74 == v77 + 8 )
...
LABEL_25:
  ...
  while ( v29 < v40 )
  {
    ...
    if ( (*(_QWORD *)v47 & 0xC01LL) != 0x800 )
      goto LABEL_89;
    v49 = 6 * (((v48 & ~qword_140C4DDC0) >> 12) & 0xFFFFFFFFFLL);
    if ( (*(_QWORD *)(48 * (((v48 & ~qword_140C4DDC0) >> 12) & 0xFFFFFFFFFLL) - 0x57FFFFFFFD8LL) & 0x4000000000000LL) != 0 )
    {
      v50 = 48 * (((v48 & ~qword_140C4DDC0) >> 12) & 0xFFFFFFFFFLL) - 0x58000000000LL;
      v85 = 0;
      ...
      if ( v48 == MI_READ_PTE_LOCK_FREE(v47) )
      {
        if ( (*(_BYTE *)(v50 + 34) & 0x10) != 0
          && !*(_WORD *)(v50 + 32)
          && v82 == *(_QWORD *)(qword_140C4E4C8 + 8 * ((*(_QWORD *)(v50 + 40) >> 39) & 0x3FFLL)) )
        {
          if ( v46 )
          {
            MiUnmapPageInHyperSpaceWorker(v46, 2u, 0x80000000);
            v95 = MiReferencePageForModifiedWrite(v50, 0);
          ...
          {
            v51 = MiReferencePageForModifiedWrite(v50, 0);
            v95 = v51;
          }
          if ( v51 )
          {
            *v43 = (v48 >> 12) & ((unsigned __int64)~qword_140C4DDC0 >> 12) & 0xFFFFFFFFFLL;
...
LABEL_89:
        ...
        if ( v55 )
        {
          ...
          MiReleaseWriteInProgressCharges(v82, v55, 1);
        }
        v81 = v89;
        v29 = v54;
        v46 = MiMapPageInHyperSpaceWorker(a1[5] & 0xFFFFFFFFFLL, &v96, 0x80000000LL);
