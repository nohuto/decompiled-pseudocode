/*
 * XREFs of KeBugCheck2 @ 0x140514F90
 * Callers:
 ...
 *     KiFilterBugCheckInfo @ 0x1403DB4CC (KiFilterBugCheckInfo.c)
 ...
 *     KiBugCheckUnicodeToAnsi @ 0x140516500 (KiBugCheckUnicodeToAnsi.c)
 ...
 *     KiSetDebuggerOwner @ 0x14051C934 (KiSetDebuggerOwner.c)
 *     KiAttemptBugcheckRecovery @ 0x1405232A4 (KiAttemptBugcheckRecovery.c)
 *     MmLocateUnloadedDriver @ 0x140533DCC (MmLocateUnloadedDriver.c)
        ...
        __int64 a6)
{
  ...
  unsigned __int64 v76; // [rsp+B0h] [rbp-50h] BYREF
  ...
  {
    LOBYTE(v11) = KeQueryCurrentStackInformation((char *)&v73, (struct _KPRCB **)&Src, &v76);
    ...
    while ( (v18 & 3) != 3 )
    {
      ...
      if ( v18 == v20 )
      {
        if ( (_BYTE)v11 )
        {
          ...
          {
            v22 = v76 - (_QWORD)Src;
            if ( v76 - (unsigned __int64)Src > 0x6000 )
              v22 = 24576LL;
...
LABEL_14:
  ...
  *(_QWORD *)&xmmword_140C2B350 = a3;
  if ( v67 == -1073741103 )
    v29 = 195;
  *((_QWORD *)&xmmword_140C2B350 + 1) = a4;
  ...
  switch ( v29 )
  {
    ...
    case 0x4Cu:
      ...
      *(_QWORD *)&KiBugCheckData = (unsigned int)a2;
      ...
      while ( (__int64)v36 < (__int64)qword_140C2B368 );
      v33 = CurrentThread;
      goto LABEL_115;
  }
  if ( v29 != 80 )
...
LABEL_66:
    v70 = *(_QWORD *)(v8 + 360);
    *((_QWORD *)&xmmword_140C2B350 + 1) = v70;
  ...
  if ( !CurrentPrcb->NmiActive )
  {
    DbgPrintEx(
      ...
      *((const void **)&KiBugCheckData + 1),
      (const void *)xmmword_140C2B350,
      *((const void **)&xmmword_140C2B350 + 1),
      (const void *)qword_140C2B360);
    if ( KiBugCheckDriver )
    ...
    if ( v46 )
    {
      if ( v67 == 265 )
      {
        KiMarkBugCheckRegions(
          *((__int64 *)&KiBugCheckData + 1),
          xmmword_140C2B350,
          *((unsigned __int64 *)&xmmword_140C2B350 + 1),
          qword_140C2B360);
        if ( qword_140C2B360 == 47 )
        {
          v56 = *((_QWORD *)&xmmword_140C2B350 + 1);
          if ( MmIsAddressValid((PVOID)(*((_QWORD *)&xmmword_140C2B350 + 1) + 1928LL)) )
...
LABEL_185:
      ...
      if ( v67 == 239 )
      {
        ...
        if ( CriticalProcessExceptionData )
        {
          ...
          if ( (_WORD)xmmword_140C196D0 )
            IoAddTriageDumpDataBlock(DWORD2(xmmword_140C196D0), (PVOID)(unsigned __int16)xmmword_140C196D0);
        }
      }
      goto LABEL_185;
    }
