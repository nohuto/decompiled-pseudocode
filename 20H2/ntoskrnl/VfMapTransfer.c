/*
 * XREFs of VfMapTransfer @ 0x1409CF880
 * Callers:
 *     <none>
 * Callees:
 ...
 *     ViCheckMdlLength @ 0x1409D0C64 (ViCheckMdlLength.c)
 *     ViGetAdapterInformationInternal @ 0x1409D1758 (ViGetAdapterInformationInternal.c)
 *     ViGetMapRegisterFile @ 0x1409D1924 (ViGetMapRegisterFile.c)
    ...
    if ( *(_DWORD *)(v8 + 192) == 3 )
    {
      ...
      if ( v10 )
      {
        ...
        ViHalPreprocessOptions(
          ...
          0LL,
          0LL);
        VfReportIssueWithOptions(0xE6u, 0x24uLL, v11, 0LL, 0LL, byte_140C12D14);
      }
    }
    if ( v4 == -559026163 )
    {
