/*
 * XREFs of WbReleaseLeastRecentlyUsedHeapExecutedBlocks @ 0x14065D048
 * Callers:
  ...
  if ( a2 > 0 )
  {
    ...
    do
    {
      ...
      if ( v14 )
      {
        v16 = v14[6];
        v18 = 0LL;
        if ( (int)sub_14065D1C4((int)a1 + 8, v16, 8, -1, (__int64)&v18) >= 0 )
          sub_14065F904(a1, v18);
      }
