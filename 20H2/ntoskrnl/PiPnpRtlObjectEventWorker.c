/*
 * XREFs of PiPnpRtlObjectEventWorker @ 0x140745470
 * Callers:
 *     PiDqIrpPropertySet @ 0x14072A3CC (PiDqIrpPropertySet.c)
 *     PiPnpRtlObjectEventCallback @ 0x140745440 (PiPnpRtlObjectEventCallback.c)
 * Callees:
