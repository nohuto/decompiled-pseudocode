/*
 * XREFs of IopInitializePlugPlayServices @ 0x140A50C78
 * Callers:
 ...
 *     IopPortInitialize @ 0x14079767C (IopPortInitialize.c)
 *     IopMemInitialize @ 0x140797714 (IopMemInitialize.c)
 *     IopDmaInitialize @ 0x1407977F8 (IopDmaInitialize.c)
 *     IopIrqInitialize @ 0x140797870 (IopIrqInitialize.c)
 *     IopBusNumberInitialize @ 0x1407978D8 (IopBusNumberInitialize.c)
 ...
 *     PiDcHandleSystemFirmwareUpdate @ 0x1408A6080 (PiDcHandleSystemFirmwareUpdate.c)
 *     ExFreePoolWithTag @ 0x1409B70B0 (ExFreePoolWithTag.c)
 *     IopInitializeResourceMap @ 0x140A3C7C0 (IopInitializeResourceMap.c)
 *     PnpDeviceCompletionQueueInitialize @ 0x140A4F7C8 (PnpDeviceCompletionQueueInitialize.c)
 *     PiInitFirmwareResources @ 0x140A4F840 (PiInitFirmwareResources.c)
 *     PnpInitializeLegacyBusInformationTable @ 0x140A4F894 (PnpInitializeLegacyBusInformationTable.c)
 ...
 *     PiKsrInitialize @ 0x140A51BE0 (PiKsrInitialize.c)
 ...
 *     PipProcessPendingOperations @ 0x140A51D60 (PipProcessPendingOperations.c)
 ...
 *     PnpInitializeNotification @ 0x140A52010 (PnpInitializeNotification.c)
 ...
 *     PiDmaGuardProcessRegistry @ 0x140A522BC (PiDmaGuardProcessRegistry.c)
 *     PpProfileInit @ 0x140A523DC (PpProfileInit.c)
 *     PnpInitializeDeviceActions @ 0x140A52474 (PnpInitializeDeviceActions.c)
          ...
          if ( (unsigned int)dword_140C02E30 > 4 && tlgKeywordOn((__int64)&dword_140C02E30, 0x400000000000LL) )
          {
            ...
            *(_QWORD *)&v36.Length = *(_QWORD *)(v21 + 2496);
            ...
            tlgWriteTransfer_EtwWriteTransfer(
              ...
              (unsigned __int8 *)byte_1400240EB,
              0LL,
              0LL,
              0xBu,
              &v42);
    ...
    if ( (int)result >= 0 )
    {
      ...
      if ( (int)result >= 0 )
      {
        ...
        if ( (int)result >= 0 )
        {
          ...
          ArbInitializeOsInaccessibleRange(dword_140C4DD60);
          ...
          *(_DWORD *)&v25.Length = 4063292;
          ...
          if ( IopOpenRegistryKeyEx(&Handle, 0LL, &v25, 0x20019u) >= 0 )
          {
            ...
            {
              qword_140C455F0 = (__int64)PipUpdateSetupInProgressCallback;
              qword_140C455F8 = (__int64)Handle;
          ...
          CmSetDeviceRegProp(
            *(__int64 *)&PiPnpRtlCtx,
            ...
            0);
          ZwClose(v17);
          qword_140C44A08 = (__int64)&IopPendingEjects;
          IopPendingEjects = (__int64)&IopPendingEjects;
          qword_140C44A98 = (__int64)&IopPendingSurpriseRemovals;
