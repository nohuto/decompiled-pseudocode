/*
 * XREFs of PoRegisterSystemState @ 0x14056D500
 * Callers:
 *     <none>
 * Callees:
 *     PoDestroyReasonContext @ 0x1403622D4 (PoDestroyReasonContext.c)
 *     PoCaptureReasonContext @ 0x1403638F8 (PoCaptureReasonContext.c)
 *     PopGetLegacyPowerRequestFlags @ 0x140364698 (PopGetLegacyPowerRequestFlags.c)
 *     PopApplyLegacyPowerRequestFlags @ 0x1403646EC (PopApplyLegacyPowerRequestFlags.c)
