/*
 * XREFs of SLQueryLicenseValueInternal @ 0x1407A0F5C
 * Callers:
...
LABEL_11:
  ...
  v47 = 0;
  v49 = 0;
  v9 = sub_1403B6A2C(v7, (__int64)&qword_1409864F0, 0LL, (__int64)&v49, 4, (__int64)&v58);
  v47 = v9;
  if ( !qword_140D2D408 || !v49 || RtlEqualUnicodeString(a2, &stru_1409864D0, 0) )
  {
LABEL_15:
    v16 = v52;
    v17 = (__int64)v51;
...
LABEL_16:
  ...
  if ( v18 )
  {
    v9 = sub_1403B6A2C(v7, (__int64)&v60, v16, v55, a5, v17);
    v47 = v9;
    if ( v9 == -1073741762 )
    {
