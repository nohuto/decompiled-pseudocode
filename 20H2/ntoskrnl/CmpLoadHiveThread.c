/*
 * XREFs of CmpLoadHiveThread @ 0x140794830
 * Callers:
 *     <none>
 * Callees:
 ...
 *     RtlUnicodeStringInit @ 0x1404EAC40 (RtlUnicodeStringInit.c)
  ...
  *(_QWORD *)Length = 0LL;
  ...
  if ( v5 )
  {
    ...
    else
    {
      ...
      Source = v11;
      LODWORD(inited) = CmpOpenHiveFile((UNICODE_STRING *)v11, 0, &v39, &v34, 7u, 0LL, (int *)Length, 0LL, 0LL);
...
LABEL_83:
        *((_QWORD *)v5 + 7) = BugCheckParameter2;
        ...
        ExRaiseHardError(-1073741288, 1, 1, (unsigned int)&v48, 1, (__int64)&v37);
