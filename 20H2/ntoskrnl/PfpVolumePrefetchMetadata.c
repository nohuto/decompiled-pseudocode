/*
 * XREFs of PfpVolumePrefetchMetadata @ 0x1406F1FD4
 * Callers:
...
__int64 __fastcall PfpVolumePrefetchMetadata(__int64 a1, unsigned int a2)
{
  ...
  *(_OWORD *)v39 = 0LL;
  ...
  v7 = *(_QWORD *)(v6 + 32);
  v36 = 0LL;
  v38 = ((MEMORY[0xFFFFF78000000004] * MEMORY[0xFFFFF78000000324]) << 8)
  ...
  *(_QWORD *)(Src + 8) = (8 * (v8 & 7)) | (unsigned __int64)(*(_DWORD *)(v9 + 28) & 7);
  if ( (*(_DWORD *)(*(_QWORD *)a1 + 80LL) & 4) != 0 )
    MmQueryMemoryListInformation((ULONG_PTR **)0xFFFFFFFFFFFFFFFFLL, (_OWORD *)(a1 + 48), 0xB0u, a2, &v45);
  v10 = 0LL;
...
LABEL_52:
      ...
      if ( *(_DWORD *)(v3 + 16) )
      {
        do
        {
          *(_DWORD *)(Src + 4) = 0;
          ...
          if ( PfpCheckPrefetchAbort((_QWORD *)a1)
            || (*(_DWORD *)(*(_QWORD *)a1 + 80LL) & 4) != 0
            && (unsigned __int64)(*(_QWORD *)(a1 + 48) + *(_QWORD *)(a1 + 56) + PfpGetPageListCount(a1 + 88, 0, v42)) < 0x80 )
          {
            goto LABEL_52;
          }
          LODWORD(v35) = 0;
  ...
  if ( (*(_DWORD *)(v7 + 8 * v4 + 12) & 0xFFFFFFFE) != 0 )
  {
    do
    {
      ...
      if ( (*v16 & 2) != 0 )
      {
        PfpFileSetupObjectAttributes(a1, (__int64)v16, a2, (__int64)&v40, (__int64)v41, &v44);
        v20 = PfpPrefetchDirectoryStream(
                a1,
                *(_DWORD *)(a1 + 16) + ((_DWORD)v37 << 6),
                (_DWORD)v16,
                v19,
                (__int64)v41,
                v44);
