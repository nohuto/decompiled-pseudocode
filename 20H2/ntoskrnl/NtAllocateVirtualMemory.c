/*
 * XREFs of NtAllocateVirtualMemory @ 0x14067D390
 * Callers:
 *     <none>
 * Callees:
        ...
        ULONG Protect)
{
  ...
  if ( v14 >= 0 )
  {
    if ( v22[3] )
    {
      ...
      {
        v14 = PsReferencePartitionByHandle(v22[3], 2, v16, 0x61566D4Du, &v17);
        v8 = v17;
        if ( v14 < 0 )
          goto LABEL_13;
      }
...
LABEL_21:
    ...
    v14 = MiAllocateVirtualMemory((__int64)v23, (__int64 *)v8, &v18);
    if ( v14 >= 0 )
    {
      v12 = v18;
      v19 = v18;
