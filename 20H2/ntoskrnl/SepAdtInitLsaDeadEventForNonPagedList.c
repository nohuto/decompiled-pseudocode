/*
 * XREFs of SepAdtInitLsaDeadEventForNonPagedList @ 0x140593E90
 * Callers:
...
bool __fastcall SepAdtInitLsaDeadEventForNonPagedList(__int64 a1)
{
  ...
  KeAcquireInStackQueuedSpinLock(&qword_140C54558, &LockHandle);
  qword_140C54598 = a1;
  v2 = qword_140C544E0 != (_QWORD)&qword_140C544E0;
