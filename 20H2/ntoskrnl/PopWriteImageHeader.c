/*
 * XREFs of PopWriteImageHeader @ 0x1409B4E20
 * Callers:
...
__int64 (*__fastcall PopWriteImageHeader(__int64 a1, __int64 a2, unsigned int a3, __int64 a4))(void)
{
  ...
  v8 = __rdtsc();
  qword_140C23870 = (((unsigned __int64)HIDWORD(v8) << 32) | (unsigned int)v8) - a4;
  dword_140C23A34 = ((unsigned int)dword_140C23500 >> 4) - 1;
  PerformanceCounter = KeQueryPerformanceCounter(0LL);
  v10 = 0;
  for ( qword_140C238A0 = PerformanceCounter.QuadPart;
        v10 < *(_DWORD *)(a1 + 256);
        qword_140C23880 += *(_QWORD *)(v11 + *(_QWORD *)(a1 + 264) + 80) )
  {
    v11 = v10++;
    v11 <<= 7;
    qword_140C23A00 += *(_QWORD *)(v11 + *(_QWORD *)(a1 + 264) + 56);
    qword_140C23878 += *(_QWORD *)(v11 + *(_QWORD *)(a1 + 264) + 40);
  }
  qword_140C23A10 = qword_140C23A28;
  qword_140C23A20 = (unsigned int)dword_140C23A30;
  qword_140C23A28 += qword_140C23A08;
  v12 = qword_140C239F8;
  dword_140C23A30 += qword_140C23A18;
  *(_QWORD *)(a2 + 88) = qword_140C239F8;
  if ( byte_140C23521 )
    *(_QWORD *)(a2 + 88) = qword_140C23A00 + v12;
  v13 = 3LL;
  v14 = a2 + 136;
  v15 = &qword_140C23858;
  do
