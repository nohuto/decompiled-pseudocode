/*
 * XREFs of KiDisplayBlueScreen @ 0x140516580
 * Callers:
 ...
 *     KeGetBugMessageText @ 0x140515F84 (KeGetBugMessageText.c)
 *     KiBugCheckConvertParameterValueToUnicodeString @ 0x14051614C (KiBugCheckConvertParameterValueToUnicodeString.c)
