/*
 * XREFs of WheaInitialize @ 0x140A61A3C
 * Callers:
 ...
 *     WheapCheckForClzeroSupport @ 0x1403BA15C (WheapCheckForClzeroSupport.c)
 ...
 *     WheapQueryPshedForErrorSources @ 0x140A622D8 (WheapQueryPshedForErrorSources.c)
 */
...
__int64 __fastcall WheaInitialize(__int64 a1, unsigned int a2)
{
  ...
  if ( !a2 )
  {
    ...
    qword_140CDAFB0 = (__int64)&qword_140CDAFA8;
    qword_140CDAFA8 = (__int64)&qword_140CDAFA8;
    KeInitializeEvent(&stru_140CDAFB8, SynchronizationEvent, 1u);
    ...
    if ( v49 )
    {
      do
      {
        v10 = qword_140CF44D8[8 * (__int64)v8[2]](0LL, v8, 0LL);
        if ( v10 < 0 )
  ...
  qword_140C15EF8 = (__int64)&WheapPrevErrList;
...
LABEL_19:
  ...
  if ( (unsigned __int64)&WheapConfigTableLock >= 0xFFFF800000000000uLL
    && byte_140C4F848[(((unsigned __int64)&WheapConfigTableLock >> 39) & 0x1FF) - 256] == 1
...
LABEL_29:
  ...
  if ( v22 && ($C774EFD68449142D8271B1EC1EB7FB26 *)CurrentThread->ApcState.ApcListHead[0].Flink != &CurrentThread->152 )
  ...
  for ( j = qword_140CDAFA8; (__int64 *)j != &qword_140CDAFA8; j = *(_QWORD *)j )
  {
    if ( *(_DWORD *)(j + 104) == 7 )
    {
      *(_DWORD *)(j + 108) = 2;
  ...
  v29 = qword_140CDAFA8;
  v30 = 0;
  while ( (__int64 *)v29 != &qword_140CDAFA8 )
  {
...
LABEL_71:
  ...
  if ( v22 && ($C774EFD68449142D8271B1EC1EB7FB26 *)v32->ApcState.ApcListHead[0].Flink != &v32->152 )
