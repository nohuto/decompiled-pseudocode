/*
 * XREFs of MiFillPageWithImageExtentContents @ 0x14053F054
 * Callers:
 *     MiCopyImageExtentContents @ 0x14053E634 (MiCopyImageExtentContents.c)
 *     MiCopyFromDirectMapExtent @ 0x1408D27BC (MiCopyFromDirectMapExtent.c)
 * Callees:
...
LABEL_52:
  ...
  if ( a4 != 4096 )
  {
    v39 = v26 ^ (v26 ^ (qword_140C4EC00 << 12)) & 0xFFFFFFFFF000LL;
    v40 = 0;
    if ( MiPteInShadowRange(v32) )
    {
      if ( (unsigned int)MiPteHasShadow() )
