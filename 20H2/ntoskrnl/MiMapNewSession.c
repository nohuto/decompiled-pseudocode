/*
 * XREFs of MiMapNewSession @ 0x1407832AC
 * Callers:
...
__int64 __fastcall MiMapNewSession(unsigned __int64 a1, unsigned __int16 a2)
{
  ...
  while ( v5 );
  MiFillPteHierarchy(qword_140C4DC60, v39);
  v9 = 4LL;
  ...
  do
  {
    ...
    *v15 = 0LL;
    ...
    if ( v9 == 3 )
    {
      *(_QWORD *)(v12 + 8) = MiGetPteAddress(qword_140C4DC60);
...
LABEL_19:
  ...
  v24 = 0;
  v25 = (_QWORD *)MiGetPteAddress(qword_140C4DC60);
  ...
  while ( 2 )
  {
    ...
    v28 = MiGetPteAddress(qword_140C4DC60);
    *(_QWORD *)(v29 + 8) = v28;
