/*
 * XREFs of PopDiagTraceControlCallback @ 0x14071C0D0
 * Callers:
 *     <none>
 * Callees:
  ...
  if ( (_DWORD)ControlCode == 2 )
  {
    ...
    if ( CallbackContext == &dword_140C021E8 )
    {
      if ( (MatchAnyKeyword & 0x800000000000LL) != 0 )
      {
        ...
        if ( dword_140C021E8 )
        {
          if ( tlgKeywordOn((__int64)&dword_140C021E8, 0x800000000000LL) && byte_140C22C6C )
          {
            PopAcquireRwLockExclusive((ULONG_PTR)&PopTelemetryOsState);
            if ( dword_140C22C30 == 1 || (unsigned int)(dword_140C22C30 - 4) <= 1 )
            {
              v27 = (KiQueryUnbiasedInterruptTime() - qword_140C22C48) / 0x2710uLL;
              v28 = v27 - qword_140C22C58;
              v29 = (MEMORY[0xFFFFF78000000008] - qword_140C22C40) / 0x2710uLL;
              qword_140C22C58 = v27;
              v30 = v29 - qword_140C22C50;
              qword_140C22C50 = v29;
              v31 = v30;
              if ( v28 <= v30 )
                v31 = v28;
