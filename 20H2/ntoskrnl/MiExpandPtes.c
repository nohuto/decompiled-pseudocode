...
__int64 __fastcall MiExpandPtes(__int64 *a1, unsigned __int64 a2)
{
  ...
  else
  {
        ...
        *(_BYTE *)(v37 + 26) &= ~1u;
        if ( *(_QWORD *)(v37 + 32) )
        {
          if ( v37 )
          {
            *(_BYTE *)(v37 + 32) |= 2u;
            if ( *(__int64 *)(v37 + 32) < 0 )
              KiAbEntryRemoveFromTree(v37, SessionId, v34);
    ...
    if ( (*((_DWORD *)&v32->0 + 1) & 0x10000) == 0 )
      KeBugCheckEx(0x162u, (ULONG_PTR)v32, v31, (unsigned int)SessionId, 0LL);
LABEL_55:
