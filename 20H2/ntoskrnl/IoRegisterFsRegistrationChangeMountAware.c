/*
 * XREFs of IoRegisterFsRegistrationChangeMountAware @ 0x1407C5980
 * Callers:
 *     IoRegisterFsRegistrationChange @ 0x140896640 (IoRegisterFsRegistrationChange.c)
 * Callees:
...
LABEL_5:
  if ( (__int64 *)IopFsNotifyChangeQueueHead != &IopFsNotifyChangeQueueHead
    && *(PDRIVER_OBJECT *)(qword_140C45A88 + 16) == DriverObject
    && *(PDRIVER_FS_NOTIFICATION *)(qword_140C45A88 + 24) == DriverNotificationRoutine )
  {
...
LABEL_9:
  ...
  v10 = (_QWORD *)qword_140C45A88;
  if ( *(__int64 **)qword_140C45A88 != &IopFsNotifyChangeQueueHead )
    __fastfail(3u);
  *PoolWithTag = &IopFsNotifyChangeQueueHead;
  PoolWithTag[1] = v10;
  *v10 = PoolWithTag;
  qword_140C45A88 = (__int64)PoolWithTag;
