/*
 * XREFs of EtwTimLogProhibitChildProcessCreation @ 0x14072B81C
 * Callers:
...
void __fastcall EtwTimLogProhibitChildProcessCreation(int a1, __int64 a2, UNICODE_STRING *a3, UNICODE_STRING *a4)
{
  ...
  if ( DestinationString == 2
    && (unsigned int)dword_140C02BB0 > 5
    && tlgKeywordOn((__int64)&dword_140C02BB0, 0x200000000001LL) )
  {
    v72[1] = v34;
    v69 = v72;
    v71 = v5[1];
    ...
    tlgWriteTransfer_EtwWriteTransfer(
      ...
      (unsigned __int8 *)&dword_14002C64C,
      0LL,
      0LL,
      0xAu,
      &v68);
  ...
  *(&UserData.Reserved + 2 * v29) = 0;
  ...
  if ( (unsigned int)dword_140C02B78 > 5 && tlgKeywordOn((__int64)&dword_140C02B78, 0x400000000000LL) )
  {
    ...
    tlgWriteTransfer_EtwWriteTransfer(
      ...
      (unsigned __int8 *)&dword_14002C6BC,
      0LL,
      0LL,
      0xCu,
      &v47);
