/*
 * XREFs of IopQueryConflictFillConflicts @ 0x1408BBE2C
 * Callers:
...
__int64 IopQueryConflictFillConflicts(__int64 a1, unsigned int a2, _QWORD *a3, __int64 a4, ...)
{
  ...
  if ( a2 )
  {
    ...
    do
    {
      if ( IopEliminateBogusConflict(a1, v6[3 * v9]) )
      {
        if ( v10 < v7 )
        {
  ...
  while ( v11 < v7 )
  {
    ...
    if ( v6[3 * v11] )
    {
      ...
      if ( v12 < v7 )
      {
        ...
        do
        {
          if ( IopEliminateBogusConflict(v6[v13], v6[3 * v14]) )
          {
            if ( v15 < v7 )
            {
          ...
          else if ( IopEliminateBogusConflict(v6[3 * v14], v6[3 * v11]) )
          {
            v16 = 3LL * v11;
...
LABEL_39:
  ...
  if ( v7 )
  {
    ...
    do
    {
      v31 = *v29;
      LODWORD(v43) = 0;
      IopQueryConflictFillString(v31, 0LL, (__int64 *)va, 0LL);
      v28 += 2 * v43 + 40;
    ...
    *(_DWORD *)v33 = -1;
    ...
    if ( v34 < v24 )
    {
      ...
      do
      {
        ...
        *(_DWORD *)(v37 + 28) = 0;
        LODWORD(v43) = v27;
        IopQueryConflictFillString(v6[3 * v35], v33 + 2 * (v36 + 2LL), (__int64 *)va, v5 + 40LL * v34 + 28);
        v37 += 40LL;
        v35 = v45 + 1;
        v27 -= v43;
        v34 = v40 + 1;
