/*
 * XREFs of HaliLocateHiberRanges @ 0x140999550
 * Callers:
 *     <none>
 * Callees:
  ...
  if ( MemoryMap )
  {
    if ( dword_140C4BA38 )
      PoSetHiberRange(
        MemoryMap,
        0xC000u,
        (PVOID)((unsigned __int64)(unsigned int)qword_140C4BA40 >> 12),
        (unsigned __int64)(unsigned int)dword_140C4BA38 >> 12,
        0x6D6C6168u);
    if ( dword_140C4BBF8 )
      PoSetHiberRange(
        MemoryMap,
