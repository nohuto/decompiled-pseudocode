/*
 * XREFs of PpmCheckComputeHeteroResponse @ 0x140576200
 * Callers:
 *     <none>
 * Callees:
 *     KeGetPrcb @ 0x140219160 (KeGetPrcb.c)
 *     KeEnumerateNextProcessor @ 0x140287E80 (KeEnumerateNextProcessor.c)
 *     PpmParkCalculateUnparkCount @ 0x140312EE0 (PpmParkCalculateUnparkCount.c)
 *     __security_check_cookie @ 0x1403CFAF0 (__security_check_cookie.c)
 *     qsort @ 0x1403D2150 (qsort.c)
 *     PpmHeteroUtilityGreaterThanOrEqualThreshold @ 0x1405769AC (PpmHeteroUtilityGreaterThanOrEqualThreshold.c)
...
char PpmCheckComputeHeteroResponse()
{
  ...
  v32 = 0LL;
  v31 = 0LL;
  v0 = &PpmCurrentProfile[342 * dword_140C23D4C];
