/*
 * XREFs of ExpWorkerInitialization @ 0x140A6DA34
 * Callers:
 ...
 *     ExpLegacyWorkerInitialization @ 0x1403C6290 (ExpLegacyWorkerInitialization.c)
...
LABEL_24:
      ...
      qword_140C4C4C0 = v19;
      v20 = __rdtsc();
      qword_140C4C4C8 = (41929663 * (unsigned int)((((unsigned __int64)HIDWORD(v20) << 32) | (unsigned int)v20) >> 4)) ^ 0x5EBLL;
      ...
      if ( v27 )
      {
        if ( p_DmaOperations >= 0xFFFF800000000000uLL && byte_140C4F848[((p_DmaOperations >> 39) & 0x1FF) - 256] == 1 )
...
LABEL_57:
      ...
      qword_140C4C4D8 = DmaOperations_high;
      ...
      if ( (_DWORD)DmaOperations_high )
      {
        ...
        while ( *v13 )
        {
          if ( (*(_BYTE *)(*v13 + 66) & 0x40) != 0 )
            _bittestandset64(&qword_140C4C4E0, v10);
          ++v10;
          ++v13;
...
LABEL_36:
      ...
      v32 = 0;
      v43 = 0;
      if ( v14 >= 0xFFFF800000000000uLL && byte_140C4F848[((v14 >> 39) & 0x1FF) - 256] == 1 )
...
LABEL_80:
      ...
      if ( (v32 & 0x1FFFF) != 0 )
      {
        ...
        if ( (v43 & 1) != 0 )
        {
          ...
          PsBoostThreadIoQoS((__int64)v31, 1LL);
        }
        if ( (v32 & 0x7FFF) != 0 )
      ...
      if ( (_DWORD)DmaOperations_high )
      {
        qword_140C4C500 = ObpObjectTypes[41929663 * (__rdtsc() >> 4) % v12];
        v5 = (_QWORD *)(qword_140C4C500 + 112);
        v6 = (const char *)(qword_140C4C500 + 112);
        if ( qword_140C4C500 + 112 < (unsigned __int64)(qword_140C4C500 + 176) )
        {
          ...
          while ( (unsigned __int64)v6 < qword_140C4C500 + 176 );
        }
        v7 = qword_140C4C4C0;
        v8 = 8LL;
        do
        {
          v7 = __ROR8__(v7 - *v5++, qword_140C4C4C8);
          v9 -= 8;
          --v8;
        }
        while ( v8 );
        for ( ; v9; --v9 )
        {
          ...
          v5 = (_QWORD *)((char *)v5 + 1);
          v7 = __ROR8__(v7 - v41, qword_140C4C4C8);
        }
        qword_140C4C508 = v7;
        qword_140C4C4D0 = KiQueryUnbiasedInterruptTime() + 41929663 * (__rdtsc() >> 4) % 0x12A05F2000LL + 288000000000LL;
      }
      else
      {
        qword_140C4C4C0 = 0LL;
