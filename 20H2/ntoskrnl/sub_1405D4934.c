/*
 * XREFs of sub_1405D4934 @ 0x1405D4934
 * Callers:
...
__int64 __fastcall sub_1405D4934(__int64 a1, _DWORD *a2)
{
  int v2; // esi
  void *v5; // rsi
  int v6; // edi
  ...
  if ( v6 >= 0 )
  {
    v6 = sub_1405D4A4C((_DWORD)v5, a2[2] & 0xFFFFFFF, (*a2 & 2) == 0, (unsigned int)&Mdl, (__int64)&v8);
    if ( v6 >= 0 )
    {
      v6 = sub_14065DAC8(
             1,
