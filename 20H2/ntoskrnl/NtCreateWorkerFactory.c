/*
 * XREFs of NtCreateWorkerFactory @ 0x140709330
 * Callers:
 *     <none>
 * Callees:
 ...
 *     ExpInitializeThreadHistory @ 0x1403567AC (ExpInitializeThreadHistory.c)
 *     KeInitializeTimer2 @ 0x140356810 (KeInitializeTimer2.c)
 *     KeDisableQueueingPriorityIncrement @ 0x140356960 (KeDisableQueueingPriorityIncrement.c)
