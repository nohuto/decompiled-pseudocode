/*
 * XREFs of Normalization__NormalizeCharacter @ 0x14091ADD0
 * Callers:
 *     Normalization__AppendDecomposedChar @ 0x140919EAC (Normalization__AppendDecomposedChar.c)
 *     Normalization__Normalize @ 0x14091AC14 (Normalization__Normalize.c)
 * Callees:
 *     ComposeHangulLV @ 0x14058BF70 (ComposeHangulLV.c)
 *     ComposeHangulLVT @ 0x14058BFA0 (ComposeHangulLVT.c)
 *     IsHangulLV @ 0x14058BFD4 (IsHangulLV.c)
 *     NormBuffer__Append @ 0x14058C00C (NormBuffer__Append.c)
 *     NormBuffer__AppendEx @ 0x14058C0E8 (NormBuffer__AppendEx.c)
 *     NormBuffer__GetLastChar @ 0x14058C188 (NormBuffer__GetLastChar.c)
 *     NormBuffer__Insert @ 0x14058C20C (NormBuffer__Insert.c)
 ...
 *     NormBuffer__RecheckStartCombinations @ 0x14058C3E0 (NormBuffer__RecheckStartCombinations.c)
 *     NormBuffer__ReplaceLastStartBase @ 0x14058C524 (NormBuffer__ReplaceLastStartBase.c)
 *     NormBuffer__ReplaceLastStartBasePair @ 0x14058C5A4 (NormBuffer__ReplaceLastStartBasePair.c)
 *     NormBuffer__RewindOutputCharacter @ 0x14058C61C (NormBuffer__RewindOutputCharacter.c)
 *     Normalization__AppendDecomposedChar @ 0x140919EAC (Normalization__AppendDecomposedChar.c)
