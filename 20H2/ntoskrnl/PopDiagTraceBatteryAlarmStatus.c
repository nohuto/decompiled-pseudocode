/*
 * XREFs of PopDiagTraceBatteryAlarmStatus @ 0x1408EAAA4
 * Callers:
  ...
  if ( (unsigned int)v3 <= 1 )
  {
    ...
    if ( (unsigned int)dword_140C021E8 > 5 )
    {
      ...
      if ( (_BYTE)v3 )
      {
        ...
        v18 = *(_DWORD *)(v9 + 16);
        v47 = &v18;
        v19 = (unsigned __int8)byte_140C236E0;
        v49 = &v19;
        v30 = 4LL;
        v32 = 4LL;
        v34 = 1LL;
        ...
        LOBYTE(v3) = tlgWriteTransfer_EtwWriteTransfer(
                       ...
                       (unsigned __int8 *)&word_1400265C6,
                       0LL,
                       0LL,
                       0xFu,
                       v25);
    ...
    if ( (unsigned int)dword_140C235D4 > 1 )
    {
      v10 = qword_140C235F0;
      v3 = (unsigned __int64)&qword_140C235F0;
      while ( (__int64 *)v10 != &qword_140C235F0 )
      {
        ++v6;
        if ( *(_DWORD *)(v10 + 64) )
          v3 = (unsigned __int64)&qword_140C235F0;
        if ( (unsigned int)dword_140C021E8 > 5 )
        {
          if ( tlgKeywordOn((__int64)&dword_140C021E8, 0x400000000000LL) )
          {
            ...
            tlgWriteTransfer_EtwWriteTransfer(
              (__int64)&dword_140C021E8,
              (unsigned __int8 *)word_140026532,
              0LL,
              0LL,
              8u,
              v25);
