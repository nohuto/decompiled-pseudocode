/*
 * XREFs of RtlpGetNormalization @ 0x14091E040
 * Callers:
 *     RtlIsNormalizedString @ 0x14091B630 (RtlIsNormalizedString.c)
 *     RtlNormalizeString @ 0x14091B6C0 (RtlNormalizeString.c)
 * Callees:
 ...
 *     NormalizationList__InsertTail @ 0x1405928FC (NormalizationList__InsertTail.c)
 *     NormalizationList__Lock @ 0x140592930 (NormalizationList__Lock.c)
 *     NormalizationList__Lookup @ 0x140592960 (NormalizationList__Lookup.c)
