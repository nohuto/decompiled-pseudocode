/*
 * XREFs of EtwpWriteUserEvent @ 0x1406557F0
 * Callers:
 ...
 *     DecodeProviderTraits @ 0x140245604 (DecodeProviderTraits.c)
 *     EtwpReleaseTraceBuffer @ 0x140245D20 (EtwpReleaseTraceBuffer.c)
 *     EtwpIsEventNameFilterEnabled @ 0x140245D68 (EtwpIsEventNameFilterEnabled.c)
 *     EtwpCreateEventKey @ 0x140245D84 (EtwpCreateEventKey.c)
...
LABEL_19:
    ...
    if ( (v45 & 0xFFFFFF9F) != 0 )
    {
      ...
      if ( (v109 & 0x80001000) != 0x80001000 && (v109 & 0x80002000) != 0x80002000 && (v109 & 0x80004000) != 0x80004000 )
        goto LABEL_197;
      if ( EtwpApplyLevelKwFilter(v150, v37, a8, v30, 1)
        && (unsigned __int8)EtwpApplyStackWalkFilterOnUserEvent(v129, v107, v37) )
      {
