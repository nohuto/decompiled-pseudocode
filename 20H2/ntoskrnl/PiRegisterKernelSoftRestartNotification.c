/*
 * XREFs of PiRegisterKernelSoftRestartNotification @ 0x1408B5804
 * Callers:
    ...
    else
    {
      ...
      if ( PoolWithTag )
      {
        ...
        else
        {
          ...
          v11 = (_QWORD *)qword_140C43008;
          if ( *(PVOID **)qword_140C43008 != &PnpKsrNotifyList )
            __fastfail(3u);
          *v10 = &PnpKsrNotifyList;
          v10[1] = v11;
          *v11 = v10;
          qword_140C43008 = (__int64)v10;
