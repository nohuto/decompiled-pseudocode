/*
 * XREFs of KsepMatchInitBiosInfo @ 0x140A6CDEC
 * Callers:
 ...
 *     KsepRegistryQueryMULTISZ @ 0x1407BA780 (KsepRegistryQueryMULTISZ.c)
...
__int64 KsepMatchInitBiosInfo()
{
  ...
  v12 = 0LL;
  KeyHandle = 0LL;
  xmmword_140C540B0 = 0LL;
  qword_140C540E0 = 0LL;
  v0 = -1;
  xmmword_140C540C0 = 0LL;
  xmmword_140C540D0 = 0LL;
  ...
  if ( v1 >= 0 )
  {
    ...
    if ( MULTISZ >= 0 )
    {
      ...
      MULTISZ = KsepRegistryQueryMULTISZ(KeyHandle, L"SystemBiosVersion", (__int64)&unk_140C53E70, 520LL, (__int64)&v12);
      word_140C54076 = 0;
      v4 = 0LL;
      v5 = &unk_140C53E70;
      while ( *v5 != 32 )
...
LABEL_11:
  ...
  if ( MULTISZ < 0 )
  {
    DWORD2(xmmword_140C540D0) = -1;
    *(_QWORD *)&xmmword_140C540B0 = 0LL;
  }
  else
  {
    *(_QWORD *)&xmmword_140C540B0 = &unk_140C53E70;
    DWORD2(xmmword_140C540D0) = v0;
  }
