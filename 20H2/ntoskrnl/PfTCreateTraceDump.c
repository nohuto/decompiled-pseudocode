/*
 * XREFs of PfTCreateTraceDump @ 0x14064D800
 * Callers:
...
__int64 __fastcall PfTCreateTraceDump(_QWORD *a1)
{
  ...
  v3 = 0;
  v4 = 0;
  for ( i = 0; (__int64 *)v1 != &qword_140C4FA98; v1 = *(_QWORD *)v1 )
    i += *(_DWORD *)(v1 + 32);
  v6 = 2LL * i;
...
LABEL_8:
        ...
        else
        {
          ...
          if ( v15 < (unsigned __int16)v16 || v15 >= (unsigned int)(*(_DWORD *)(v2 + 32) + v16) )
          {
            ...
            {
              v66 = *(_QWORD *)(v66 + 8);
              if ( (__int64 *)v66 == &qword_140C4FA98 )
                v66 = qword_140C4FAA0;
              if ( v66 == v2 )
                break;
...
LABEL_14:
        ...
        else
        {
          ...
          if ( v14 < (unsigned __int16)v20 || v14 >= (unsigned int)(*(_DWORD *)(v2 + 32) + v20) )
          {
            ...
            {
              v68 = *(_QWORD *)(v68 + 8);
              if ( (__int64 *)v68 == &qword_140C4FA98 )
                v68 = qword_140C4FAA0;
              if ( v68 == v2 )
                break;
...
LABEL_27:
    ...
    while ( v9 != (__int64 *)qword_140C4FA70 );
    if ( v3 )
    {
      v26 = 16 * v3;
      v27 = 32 * v4;
              ...
              if ( ((unsigned __int8)*(_QWORD *)v37 & 3u) < 2 )
              {
                ...
                else
                {
                  ...
                  if ( v43 < (unsigned __int16)v44 || v43 >= (unsigned int)(*(_DWORD *)(v2 + 32) + v44) )
                  {
                    ...
                    {
                      v62 = *(_QWORD *)(v62 + 8);
                      if ( (__int64 *)v62 == &qword_140C4FA98 )
                        v62 = qword_140C4FAA0;
                      if ( v62 == v2 )
                        break;
...
LABEL_45:
                ...
                else
                {
                  ...
                  if ( v42 < (unsigned __int16)v47 || v42 >= (unsigned int)(*(_DWORD *)(v2 + 32) + v47) )
                  {
                    ...
                    {
                      v64 = *(_QWORD *)(v64 + 8);
                      if ( (__int64 *)v64 == &qword_140C4FA98 )
                        v64 = qword_140C4FAA0;
                      if ( v64 == v2 )
                        break;
...
LABEL_59:
        ...
        while ( v31 != (__int64 *)qword_140C4FA70 );
        v8 = P;
  ...
  PfTFreeBufferList(&unk_140C4FA58);
  PfTFreeBufferList(&unk_140C4FA80);
  return v32;
}
