...
__int64 __fastcall RtlpHpLfhSubsegmentFreeBlock(__int64 a1, __int64 a2, __int64 a3, unsigned int a4)
{
  ...
  int v99; // [rsp+34h] [rbp-74h] BYREF
  int v100; // [rsp+38h] [rbp-70h]
  int v101; // [rsp+3Ch] [rbp-6Ch]
  int v102; // [rsp+40h] [rbp-68h] BYREF
  int v103; // [rsp+44h] [rbp-64h]
  int v104; // [rsp+48h] [rbp-60h] BYREF
  unsigned int v105; // [rsp+4Ch] [rbp-5Ch]
  int v106; // [rsp+50h] [rbp-58h]
  __int64 v107; // [rsp+58h] [rbp-50h]
  unsigned __int8 v109; // [rsp+B8h] [rbp+10h]
  unsigned __int8 AbAllocationRegionCount; // [rsp+C0h] [rbp+18h]

  v109 = -1;
  v4 = 0LL;
  v6 = a4;
  v105 = DWORD2(RtlpHpHeapGlobals) ^ *(_DWORD *)(a2 + 40) ^ ((unsigned int)a2 >> 12);
  v7 = 1;
  v8 = (signed __int64 *)a2;
  if ( !a3 )
    goto LABEL_17;
  v9 = (unsigned __int16)v105;
  v106 = 0;
  v10 = a3 - HIWORD(v105) - a2;
  v11 = *(_QWORD *)(a1
                  + 8LL
                  * *((unsigned __int8 *)RtlpLfhBucketIndexMap + (((unsigned int)(unsigned __int16)v105 + 15) >> 4))
                  + 128);
  v12 = *(_DWORD *)(v11 + 72);
  v13 = *(_BYTE *)(v11 + 76);
  if ( v12 )
  {
    ...
    v15 = v10 - v14 * (unsigned __int16)v105;
  }
  else
  {
    LODWORD(v14) = v10 >> v13;
      ...
      for ( i = v35; ; v35 = i )
      {
        while ( 1 )
        {
          ...
          if ( i )
          {
            ...
            {
              v30 = v109;
              if ( v109 <= 0xFu && CurrentIrql >= 2u )
              {
                CurrentPrcb = KeGetCurrentPrcb();
                SchedulerAssist = CurrentPrcb->SchedulerAssist;
                v96 = ~(unsigned __int16)(-1LL << (v109 + 1));
...
LABEL_160:
            ...
            --CurrentThread->AbAllocationRegionCount;
            KiAbThreadRemoveBoosts((ULONG_PTR)CurrentThread, v36, &v99);
        ...
        v97 = _InterlockedCompareExchange64(v8 + 2, v34 & 1 | (v34 + 2) & 0xFFFFFFFFFFFFFFFEuLL, v34);
        v55 = v34 == v97;
        v34 = v97;
        if ( v55 )
          break;
...
LABEL_46:
      *((_BYTE *)v8 + 38) = v38;
      ...
      if ( (*(_BYTE *)v4 & 1) == 0 && *(_QWORD *)(v4 + 8) > 8uLL )
      {
        ...
        v66 = **(_QWORD **)v42;
        if ( *(_QWORD *)(*(_QWORD *)v42 + 8LL) != v42 || *(signed __int64 **)(v66 + 8) != v8 )
          goto LABEL_177;
        *(_QWORD *)v42 = v66;
        *(_QWORD *)(v66 + 8) = v42;
        --*v43;
...
LABEL_77:
    ...
    KiAbThreadRemoveBoosts((ULONG_PTR)v49, v48, &v102);
  ...
  if ( v8 )
    RtlpHpLfhBucketAddSubsegment(
      v47,
      *(_QWORD *)(v47
                + 8LL * *((unsigned __int8 *)RtlpLfhBucketIndexMap + (((unsigned int)(unsigned __int16)v105 + 15) >> 4))
                + 128),
      v8,
      a4);
LABEL_25:
  if ( v4 )
  {
    ...
    if ( *(_BYTE *)(a1 + 57) )
    {
      ...
      if ( KiIrqlFlags )
      {
        if ( (KiIrqlFlags & 1) != 0 )
        {
          ...
          if ( v73 <= 0xFu && v109 <= 0xFu && v73 >= 2u )
          {
            v74 = KeGetCurrentPrcb();
            v75 = ~(unsigned __int16)(-1LL << (v109 + 1));
    ...
    else
    {
      ...
      if ( (unsigned int)MiGetSystemRegionType(v67) == 1 )
        v32 = MmGetSessionIdEx((__int64)v68->ApcState.Process);
...
LABEL_112:
        if ( (*((_DWORD *)&v68->0 + 1) & 0x10000) == 0 )
          KeBugCheckEx(0x162u, (ULONG_PTR)v68, v67, v32, 0LL);
      }
      else
      {
        *(_BYTE *)(v72 + 32) |= 2u;
      ...
      KiAbThreadRemoveBoosts((ULONG_PTR)v68, v67, &v104);
