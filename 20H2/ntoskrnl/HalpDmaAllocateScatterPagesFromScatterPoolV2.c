/*
 * XREFs of HalpDmaAllocateScatterPagesFromScatterPoolV2 @ 0x1404CBCAC
 * Callers:
 *     HalpDmaAllocateScatterPagesFromScatterPool @ 0x1404B720C (HalpDmaAllocateScatterPagesFromScatterPool.c)
 * Callees:
