/*
 * XREFs of HalpAllocateDomainCommonBufferInternal @ 0x1403A0934
 * Callers:
 *     HalAllocateCommonBufferExV3 @ 0x1403A08B0 (HalAllocateCommonBufferExV3.c)
 *     HalAllocateDomainCommonBuffer @ 0x1404C2B70 (HalAllocateDomainCommonBuffer.c)
 *     HalAllocateCommonBufferWithBounds @ 0x1404C4140 (HalAllocateCommonBufferWithBounds.c)
 * Callees:
