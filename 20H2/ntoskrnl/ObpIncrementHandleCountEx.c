/*
 * XREFs of ObpIncrementHandleCountEx @ 0x1406169E0
 * Callers:
 ...
 *     OBJECT_HEADER_TO_PROCESS_INFO @ 0x14032FEF0 (OBJECT_HEADER_TO_PROCESS_INFO.c)
...
LABEL_13:
        ...
        {
          if ( v49 )
            PspReturnQuota((char *)v22, 0LL, 1u, v49);
          v22 = 0LL;
        }
        else
        {
...
LABEL_79:
  ...
  if ( !v26 )
  {
    v23 = ObpLockHandleDataBaseEntry(v8, a3, &v52);
    if ( v23 >= 0 )
    {
      v25 = a3;
      goto LABEL_25;
