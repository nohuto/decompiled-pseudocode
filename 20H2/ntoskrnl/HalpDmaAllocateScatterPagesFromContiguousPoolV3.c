/*
 * XREFs of HalpDmaAllocateScatterPagesFromContiguousPoolV3 @ 0x1404B57BC
 * Callers:
 *     HalpDmaAllocateScatterPagesFromContiguousPool @ 0x1404B71B4 (HalpDmaAllocateScatterPagesFromContiguousPool.c)
 * Callees:
