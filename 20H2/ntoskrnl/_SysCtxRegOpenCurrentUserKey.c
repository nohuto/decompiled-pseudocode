/*
 * XREFs of _SysCtxRegOpenCurrentUserKey @ 0x140729B68
 * Callers:
 ...
 *     _SysCtxGetCachedContextBaseKey @ 0x1406D5330 (_SysCtxGetCachedContextBaseKey.c)
            ...
            if ( appended >= 0 )
            {
              ...
              if ( appended >= 0 )
              {
                ...
                if ( PoolWithTag )
                {
                  ...
                  appended = RtlAppendUnicodeStringToString(&Destination, &stru_1400099A0);
                  if ( appended >= 0 )
                  {
