/*
 * XREFs of HsaUpdateDeviceTableEntry @ 0x1404E2918
 * Callers:
 ...
 *     HsaSetDevicePasidTable @ 0x1404E2830 (HsaSetDevicePasidTable.c)
 * Callees:
 *     MmGetPhysicalAddress @ 0x1402FE520 (MmGetPhysicalAddress.c)
 *     __security_check_cookie @ 0x1403CFAF0 (__security_check_cookie.c)
 *     HsaBuildDeviceTableEntry @ 0x1404E0C44 (HsaBuildDeviceTableEntry.c)
 *     HsaGetBlockedDomain @ 0x1404E1C44 (HsaGetBlockedDomain.c)
 *     HsaInvalidateDTE @ 0x1404E218C (HsaInvalidateDTE.c)
 */
