/*
 * XREFs of PfpFlushBuffers @ 0x14064B810
 * Callers:
...
LABEL_16:
  ...
  while ( 1 )
  {
    ...
    v27 = HIDWORD(v28);
    v29 = dword_140C5015C + (((v8 << 8) + v9) >> 10);
    Src = 163851LL;
    PfpCopyEvent(&Src);
    if ( *((int *)&v6->Next + 2) > 1
          ...
          *((int *)&v6->Next + 2) > 1) )
    {
      ...
      if ( (unsigned __int64)Next <= *((_QWORD *)&v6[2].Next + 1) )
      {
        while ( 1 )
        {
          ...
          v22 = 0;
          v18 = PfTAcquireLogEntry(&unk_140C4FA58, &v22, 1LL);
          if ( !v18 )
            break;
