/*
 * XREFs of KiIntersectFeaturesWithPolicy @ 0x1409A3310
 * Callers:
 ...
 *     KiIsXSaveFeatureAllowed @ 0x1409A3470 (KiIsXSaveFeatureAllowed.c)
 *     KiLoadPolicyFromImage @ 0x1409A3500 (KiLoadPolicyFromImage.c)
 */
