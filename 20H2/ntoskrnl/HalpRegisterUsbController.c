/*
 * XREFs of HalpRegisterUsbController @ 0x1404D58C8
 * Callers:
 *     HalpUsbLegacyDeviceHandoff @ 0x1403C9BF0 (HalpUsbLegacyDeviceHandoff.c)
 * Callees:
...
__int64 __fastcall HalpRegisterUsbController(__int64 a1, int a2, char a3, char a4)
{
  ...
  if ( result )
  {
    ...
    *(_BYTE *)(result + 26) = a3;
    *(_BYTE *)(result + 25) = a4;
    v9 = (__int64 *)qword_140C48C08;
    if ( *(__int64 **)qword_140C48C08 != &HalpUsbControllerList )
      __fastfail(3u);
    *(_QWORD *)result = &HalpUsbControllerList;
    *(_QWORD *)(result + 8) = v9;
    *v9 = result;
    qword_140C48C08 = result;
  }
  return result;
}
