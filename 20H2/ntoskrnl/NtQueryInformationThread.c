...
int __fastcall NtQueryInformationThread(__m128i *Handle, int a2, __m128i *a3, unsigned int a4, unsigned int *a5)
{
  ...
  int v64; // [rsp+4Ch] [rbp-23Ch]
  struct _PROCESSOR_NUMBER v65; // [rsp+54h] [rbp-234h] BYREF
  __int16 v66; // [rsp+58h] [rbp-230h]
  __m128i *v67; // [rsp+60h] [rbp-228h]
  ...
  unsigned int *v73; // [rsp+98h] [rbp-1F0h]
  ...
  __int32 v78; // [rsp+E8h] [rbp-1A0h]
  unsigned int v79; // [rsp+ECh] [rbp-19Ch]
  unsigned int v80; // [rsp+F0h] [rbp-198h]
      ...
      if ( a2 )
      {
        switch ( a2 )
        {
          ...
          case 31:
            ...
            v78 = a3->m128i_i32[0];
            v70[0] = 0LL;
            result = ObReferenceObjectByHandle(Handle, 0x40u, (POBJECT_TYPE)PsThreadType, PreviousMode, v70, 0LL);
            v8 = result;
            if ( result < 0 )
              return result;
            if ( v39 == 3 )
          ...
          case 33:
            ...
            if ( result < 0 )
              return result;
            v65 = (struct _PROCESSOR_NUMBER)0x400000;
            KeSetIdealProcessorThreadByNumber((struct _KTHREAD *)Object, &v65, &v65);
            ObfDereferenceObjectWithTag(Object, 0x79517350u);
            *(struct _PROCESSOR_NUMBER *)v6->m128i_i8 = v65;
            if ( a5 )
              *a5 = 4;
            return 0;
          case 34:
          ...
          case 40:
            ...
            if ( result >= 0 )
            {
              ...
              v6->m128i_i64[0] = (unsigned int)KeMaximumIncrement * (unsigned __int64)v47[163];
