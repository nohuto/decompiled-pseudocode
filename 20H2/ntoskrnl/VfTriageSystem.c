/*
 * XREFs of VfTriageSystem @ 0x140A72D64
 * Callers:
 *     ViInitSystemPhase0 @ 0x140A72B38 (ViInitSystemPhase0.c)
 * Callees:
 *     DbgPrintEx @ 0x14037EFE0 (DbgPrintEx.c)
 *     MmTriageActiveInLastCrash @ 0x140A9542C (MmTriageActiveInLastCrash.c)
 ...
 *     TriageGetBugcheckData @ 0x140A98DE8 (TriageGetBugcheckData.c)
 */
...
__int64 __fastcall VfTriageSystem(__int64 a1)
{
  ...
  qword_140C1CF00 = *(_QWORD *)&v12[32];
  xmmword_140C1CEF0 = *(_OWORD *)&v12[16];
  if ( v8 )
  {
