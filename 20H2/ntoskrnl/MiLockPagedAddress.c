/*
 * XREFs of MiLockPagedAddress @ 0x14036B674
 * Callers:
...
LABEL_31:
  ...
  if ( (unsigned int)MiAddLockedPageCharge(v13, 0) )
  {
    v14 = 1;
  ...
  {
    if ( v3 )
      MiReleasePageFileInfo(*(_QWORD *)(qword_140C4E4C8 + 8 * ((*(_QWORD *)(v13 + 40) >> 39) & 0x3FFLL)), v3, 1);
