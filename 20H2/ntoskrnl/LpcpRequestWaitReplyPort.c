/*
 * XREFs of LpcpRequestWaitReplyPort @ 0x1408C478C
 * Callers:
 *     LpcRequestWaitReplyPort @ 0x1408C4440 (LpcRequestWaitReplyPort.c)
 *     LpcRequestWaitReplyPortEx @ 0x1408C4460 (LpcRequestWaitReplyPortEx.c)
 * Callees:
