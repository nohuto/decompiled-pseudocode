/*
 * XREFs of KdpSetOwedBreakpoints @ 0x1409BD5E0
 * Callers:
...
void __fastcall KdpSetOwedBreakpoints(__int64 a1)
{
  ...
  if ( KdpOweBreakpoint )
  {
    ...
    while ( 1 )
    {
      ...
      v1 += 5;
      if ( (__int64)v1 >= (__int64)&KdTimerDifference )
        return;
    }
    v8 = KdEnterDebugger(0LL);
    KdpOweBreakpoint = 0;
    v9 = (unsigned __int8 *)&unk_140C330A5;
    do
    {
    ...
    while ( (__int64)v9 < (__int64)byte_140C335A5 );
    KdExitDebugger(v8);
  }
}
