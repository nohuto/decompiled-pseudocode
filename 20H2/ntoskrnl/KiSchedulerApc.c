/*
 * XREFs of KiSchedulerApc @ 0x1402D7C50
 * Callers:
 *     <none>
 * Callees:
 ...
 *     KiResumeUmsThread @ 0x1408C00B0 (KiResumeUmsThread.c)
 *     KiSuspendUmsThread @ 0x1408C0108 (KiSuspendUmsThread.c)
 */

char __fastcall KiSchedulerApc(__int64 a1)
{
  char result; // al
  int v3; // r14d
  int v4; // r14d
  ...
  int v65; // eax
  int v66; // eax
  int v67; // [rsp+38h] [rbp-99h]
  int v68; // [rsp+3Ch] [rbp-95h] BYREF
  int v69; // [rsp+40h] [rbp-91h] BYREF
  int v70; // [rsp+44h] [rbp-8Dh] BYREF
  int v71; // [rsp+48h] [rbp-89h] BYREF
  int v72; // [rsp+4Ch] [rbp-85h] BYREF
  int v73; // [rsp+50h] [rbp-81h] BYREF
  _DWORD v74[40]; // [rsp+58h] [rbp-79h] BYREF

  result = (unsigned __int8)memset(v74, 0, 0x98uLL);
  v3 = *(_DWORD *)(a1 + 120);
  v69 = 0;
  v4 = v3 & 0x8000;
  v68 = 0;
  ...
  if ( !*(_DWORD *)(a1 + 740) && !v4 )
  {
    ...
    *(_DWORD *)(a1 + 116) &= ~0x80000u;
    ...
    if ( v5 )
      result = KiResumeUmsThread(a1, &v68);
  }
  *(_DWORD *)(a1 + 116) &= ~0x40000u;
  if ( v4 )
  {
    if ( (unsigned __int8)KiIsProcessTerminationRequested(a1, &v69) )
    {
      memset(&v74[2], 0, 0x90uLL);
      LOBYTE(v61) = 1;
      v74[0] = v69;
      LOBYTE(v62) = 1;
      v74[1] = 1;
      DbgkForwardException(v74, v62, v61);
      LOBYTE(v63) = 1;
      DbgkForwardException(v74, 0LL, v63);
    }
    ...
    KiReleaseThreadLockSafe(a1);
    return KiExitDispatcher((__int64)v14, 0LL, 1u, 0, v13);
  }
  return result;
}
