/*
 * XREFs of PopFxUpdateGlobalDeviceAccountingInfo @ 0x14056BC40
 * Callers:
...
__int64 __fastcall PopFxUpdateGlobalDeviceAccountingInfo(unsigned __int64 a1, unsigned __int64 a2)
{
  ...
  result = qword_140C247A8;
  if ( qword_140C247A8 < a1 )
  {
    v3 = a1 - qword_140C247A8;
    qword_140C247B0 += a1 - qword_140C247A8;
    if ( a1 - qword_140C247A8 < a2 )
    {
      qword_140C247B8 += v3;
    }
    else
