/*
 * XREFs of CmpWalkOneLevel @ 0x140679110
 * Callers:
        ...
        __int64 a11)
{
  ...
  volatile signed __int64 *v57; // rsi
  int v58; // eax
  __int16 v59; // ax
  __int16 v60; // ax
  int v61; // eax
  ...
  __int64 v75; // [rsp+38h] [rbp-81h]
  __int16 v76; // [rsp+50h] [rbp-69h]
  int SubKeyInLeafWithStatus; // [rsp+54h] [rbp-65h]
  __int16 v78; // [rsp+58h] [rbp-61h]
  __int16 v79; // [rsp+5Ah] [rbp-5Fh]
  unsigned int v80; // [rsp+5Ch] [rbp-5Dh] BYREF
  ULONG_PTR v81; // [rsp+60h] [rbp-59h]
  _DWORD v82[2]; // [rsp+68h] [rbp-51h] BYREF
  __int64 v83; // [rsp+70h] [rbp-49h] BYREF
  __int64 v84; // [rsp+78h] [rbp-41h]
  int v85; // [rsp+80h] [rbp-39h]
  int v86; // [rsp+84h] [rbp-35h]
  __int64 v87; // [rsp+88h] [rbp-31h]
  int v88; // [rsp+90h] [rbp-29h] BYREF
  __int64 v89; // [rsp+98h] [rbp-21h]
  ULONG_PTR v90; // [rsp+A0h] [rbp-19h] BYREF
  __int64 v91; // [rsp+A8h] [rbp-11h] BYREF
  __m128i v92; // [rsp+B0h] [rbp-9h]
  ...
  if ( v15 >= 0 )
  {
    do
    {
      ...
      v66 = *(void **)(KcbAtLayerHeight + 32);
      KcbInHashEntryByName = CmpFindKcbInHashEntryByName((__int64)v66, a8, KcbAtLayerHeight, (__int64)a6);
      v81 = KcbInHashEntryByName;
...
LABEL_136:
  ...
  if ( a9 )
  {
    NextElement = CmListGetNextElement(*(_QWORD *)(a2 + 8) + 208LL, &v91, 32LL);
    if ( NextElement )
    {
      do
      {
        v64 = *(_DWORD *)(NextElement + 68);
        if ( v64 == 2 || v64 == 11 )
          break;
        NextElement = CmListGetNextElement(v63 + 208, &v91, 32LL);
      }
      while ( NextElement );
...
LABEL_98:
  ...
  while ( 2 )
  {
    ...
    {
      (*(void (__fastcall **)(__int64, __int64 *))(v32 + 16))(v32, &v83);
      ExAcquirePushLockSharedEx(*(_QWORD *)(v29 + 32) + 72LL, 0LL);
      v70 = (*(__int64 (__fastcall **)(_QWORD, _QWORD, __int64 *))(*(_QWORD *)(v29 + 32) + 8LL))(
              *(_QWORD *)(v29 + 32),
              *(unsigned int *)(v29 + 40),
              &v83);
      v71 = *(_DWORD *)(v29 + 40);
      ...
      v73 = *(_QWORD *)(v29 + 32);
      if ( _InterlockedCompareExchange64((volatile signed __int64 *)(v73 + 72), 0LL, 17LL) != 17 )
        ExfReleasePushLockShared((signed __int64 *)(v73 + 72));
      KeAbPostRelease(v73 + 72);
    }
    v34 = *(_QWORD *)(v29 + 32);
    v82[1] = 0;
    v87 = v34;
...
LABEL_36:
    ...
    if ( *v49 == 26994 )
    {
      if ( (int)CmpFindSubKeyInRoot(v34, (__int64)v49, (__int64)a6, 0, &v80) < 0 )
      {
        v35 = -1073741670;
        goto LABEL_85;
      }
      (*(void (__fastcall **)(__int64, _DWORD *))(v34 + 16))(v34, v82);
      if ( v80 == -1 )
        goto LABEL_80;
      v49 = (_WORD *)(*(__int64 (__fastcall **)(__int64, _QWORD, _DWORD *))(v34 + 8))(v34, v80, v82);
      if ( !v49 )
      {
LABEL_145:
        v35 = -1073741670;
    ...
    if ( *v49 != 26732 )
    {
      SubKeyInLeafWithStatus = CmpFindSubKeyInLeafWithStatus(v34, (__int64)v49, (unsigned __int16 *)a6, 0LL, &v80, &v88);
...
LABEL_83:
    ...
    if ( v51 )
    {
      v52 = (unsigned __int16 *)v92.m128i_i64[1];
...
LABEL_80:
    ...
    while ( 1 )
    {
      if ( v50 != *(_DWORD *)&v49[4 * v55 + 4] )
        goto LABEL_77;
      v61 = CmpDoCompareKeyName(v87, (const UNICODE_STRING *)a6, 0LL, *(_DWORD *)&v49[4 * v55 + 2]);
      if ( v61 == 2 )
        break;
      if ( !v61 )
      {
...
LABEL_37:
    v11 = a1;
LABEL_38:
    (*(void (__fastcall **)(_QWORD, __int64 *))(*(_QWORD *)(v84 + 32) + 16LL))(*(_QWORD *)(v84 + 32), &v83);
    if ( v35 == -1073741772 )
    {
      v37 = -1;
      goto LABEL_40;
...
LABEL_41:
    ...
    {
LABEL_90:
      v57 = (volatile signed __int64 *)v81;
      LODWORD(v75) = a8;
      LODWORD(v74) = a7;
      v58 = CmpCreateKeyControlBlock(*(_QWORD *)(v29 + 32), v37, v29, v81, 0, (unsigned __int16 *)a6, v74, v75, &v90);
      ...
      if ( v58 >= 0 )
      {
        ...
        ++*(_WORD *)(a4 + 2);
        if ( v78 >= 2 )
          *(_QWORD *)(*(_QWORD *)(a4 + 24) + 8LL * v78 - 16) = v14;
        else
          *(_QWORD *)(a4 + 8LL * v78 + 8) = v14;
        v59 = *(_WORD *)(v11 + 66);
        if ( v78 != v59 )
        {
          CmpUnlockHashEntry(*(PVOID *)(v84 + 32), a8);
          ++v79;
          v59 = *(_WORD *)(v11 + 66);
        }
        v28 = v78 + 1;
...
LABEL_46:
  ...
  if ( v81 )
    CmpDereferenceKeyControlBlock(v81);
