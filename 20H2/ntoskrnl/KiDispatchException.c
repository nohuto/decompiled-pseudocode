...
int __fastcall KiDispatchException(NTSTATUS *a1, unsigned __int64 a2, __int64 a3, unsigned __int8 a4, char a5)
{
  char v5; // r12
  ...
  unsigned int v35; // [rsp+34h] [rbp+4h]
  ...
  if ( a5 && *(_QWORD *)&Process[2].Affinity.Count )
  {
    ...
    {
      LODWORD(v18) = ((__int64 (__fastcall *)(NTSTATUS *, unsigned __int64, __int64, _QWORD, char))xmmword_140C1DEC0)(
                       a1,
                       v37,
                       a3,
                       0LL,
  ...
  RtlGetExtendedContextLength2(v35, &v38, v9);
  v10 = v38 + 15LL;
  if ( v10 <= v38 )
  ...
  v12 = v9;
  v13 = v35;
  RtlInitializeExtendedContext2((__int64)&v34, v35, &v40, v12);
  ...
  if ( *a1 == -2147483645 )
  {
    ...
    if ( (KiDynamicTraceMask & 2) != 0 )
    {
      LOBYTE(v15) = a5;
      LOBYTE(v14) = v5;
      if ( (unsigned __int8)KiTpHandleTrap(a1, &v34, v14, v15) )
        goto LABEL_14;
    }
  }
  LOBYTE(v14) = v5;
  if ( (unsigned __int8)KiPreprocessFault((int)a1, (int)&v34, v14) )
    goto LABEL_14;
  if ( !v5 )
  {
    if ( (!a5
       || !(unsigned __int8)KdTrap(a3, v37, (_DWORD)a1, (unsigned int)&v34, 0, 0)
       && !(unsigned __int8)RtlDispatchException((__int64)a1, (__int64)&v34))
      && !(unsigned __int8)KdTrap(a3, v37, (_DWORD)a1, (unsigned int)&v34, 0, 1) )
    {
  ...
  if ( (HIDWORD(v39[2].Header.WaitListHead.Flink) & 1) == 0 )
  {
    ...
    if ( v18->ApcState.Process[1].AffinityPadding[10] && *a1 == -2147483646 && (*(_DWORD *)(a3 + 376) & 0x40000) != 0 )
    {
      _disable();
...
LABEL_75:
  ...
  if ( a5 )
  {
    ...
    {
      if ( (unsigned __int8)KdTrap(a3, v37, (_DWORD)a1, (unsigned int)&v34, v34, 0) )
      {
        v5 = v34;
LABEL_14:
    ...
    if ( v21 == -2147483597 || (LOBYTE(v22) = 1, LODWORD(v18) = DbgkForwardException(a1, v22, 0LL), !(_BYTE)v18) )
    {
      _disable();
      *(_DWORD *)(a3 + 376) &= ~0x100u;
      ...
      {
        v23 = (v19 - *(unsigned int *)(v40 + 20)) & 0xFFFFFFFFFFFFFFC0uLL;
        v41 = v23;
      }
      ...
      *((_QWORD *)&v53 + 1) = 0x4D0FFFFFB30LL;
      ...
      v26[3] = v19;
      *v26 = *(_QWORD *)&v52[25];
      KeCopyExceptionRecord(v47, a1);
      v27 = v48;
      RtlpCopyExtendedContext(1u, v48, (__int64)&v53, v35, v40, 0LL);
      *(_OWORD *)v27 = v53;
      *(_QWORD *)(v27 + 16) = v54;
  ...
  else
  {
    LOBYTE(v17) = 1;
    LOBYTE(v16) = 1;
    LODWORD(v18) = DbgkForwardException(a1, v16, v17);
    if ( !(_BYTE)v18 )
    {
      LOBYTE(v31) = 1;
      LODWORD(v18) = DbgkForwardException(a1, 0LL, v31);
      if ( !(_BYTE)v18 )
        LODWORD(v18) = ZwTerminateProcess((HANDLE)0xFFFFFFFFFFFFFFFFLL, *a1);
    }
  }
  return (int)v18;
}
