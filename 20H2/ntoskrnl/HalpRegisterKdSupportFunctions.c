/*
 * XREFs of HalpRegisterKdSupportFunctions @ 0x140A3BFD4
 * Callers:
...
__int64 *HalpRegisterKdSupportFunctions()
{
  ...
  result = &qword_140C48BE8;
  qword_140C48BF0 = (__int64)&qword_140C48BE8;
  qword_140C48BE8 = (__int64)&qword_140C48BE8;
