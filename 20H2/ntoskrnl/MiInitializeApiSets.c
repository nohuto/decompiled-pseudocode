/*
 * XREFs of MiInitializeApiSets @ 0x140A53048
 * Callers:
 ...
 *     MmCreateSection @ 0x140709CF0 (MmCreateSection.c)
 */
...
__int64 __fastcall MiInitializeApiSets(__int64 a1)
{
  ...
  if ( (int)result >= 0 )
  {
    ...
    else
    {
      ...
      qword_140C4CA78 = (__int64)v4;
      qword_140C4CA80 = (__int64)v6;
      result = 0LL;
      qword_140C4CA88 = *(unsigned int *)(*(_QWORD *)(a1 + 240) + 2696LL);
    }
  }
  return result;
}
