/*
 * XREFs of sub_140965AD8 @ 0x140965AD8
 * Callers:
...
__int64 __fastcall sub_140965AD8(__int64 a1, __int64 a2, __int64 a3, __int64 a4)
{
  signed int v6; // ebx
  unsigned int *v7; // rcx
  unsigned int *v8; // rax
...
LABEL_64:
      ...
      memmove(v39, v22, v38);
      v41 = v40;
      v35 = ((__int64 (__fastcall *)(_QWORD, void *, _QWORD, PVOID))qword_140D2D4C0)(
      ...
      if ( v35 >= 0 )
      {
        v35 = qword_140D2D460 ? qword_140D2D460(v29) : -1073741637;
        if ( v35 == -1073741198 )
          v35 = 0;
      }
      *(_DWORD *)(a4 + 4) = 20;
