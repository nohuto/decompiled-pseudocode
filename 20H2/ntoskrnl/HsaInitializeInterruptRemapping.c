/*
 * XREFs of HsaInitializeInterruptRemapping @ 0x1409AD558
 * Callers:
 *     HsaInitializeIommu @ 0x1409AD700 (HsaInitializeIommu.c)
 * Callees:
 *     RtlInitializeBitMap @ 0x140311A90 (RtlInitializeBitMap.c)
 *     ExtEnvZeroMemory @ 0x14036D0C0 (ExtEnvZeroMemory.c)
 *     HalMapIoSpace @ 0x1403B2320 (HalMapIoSpace.c)
 *     _guard_dispatch_icall @ 0x140405F40 (_guard_dispatch_icall.c)
 *     memset @ 0x140411300 (memset.c)
 *     HalpGetIrtEntryCount @ 0x1404CFB98 (HalpGetIrtEntryCount.c)
