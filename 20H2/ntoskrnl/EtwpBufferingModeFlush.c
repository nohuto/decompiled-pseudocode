/*
 * XREFs of EtwpBufferingModeFlush @ 0x14093F9B8
 * Callers:
 ...
 *     EtwpFindAndLockBufferForFlushing @ 0x14093FE20 (EtwpFindAndLockBufferForFlushing.c)
 */
  ...
  if ( _InterlockedCompareExchange64((volatile signed __int64 *)a1 + 162, *((_QWORD *)a1 + 103), -1LL) == -1 )
  {
    if ( *((_QWORD *)a1 + 160) )
    {
      ...
      if ( v27 )
      {
        ...
        do
        {
          v31 = *(_QWORD *)(v30 + *((_QWORD *)a1 + 160));
          v32 = *(_QWORD *)(v30 + *((_QWORD *)a1 + 161));
          if ( v31 > v32 )
          {
            do
            {
              ...
              v32 = _InterlockedCompareExchange64(
                      (volatile signed __int64 *)(*((_QWORD *)a1 + 161) + 8LL * v29),
                      v31,
                      v32);
            }
    ...
    do
    {
      v34 = EtwpFindAndLockBufferForFlushing(a1, *((_QWORD *)a1 + 162));
      v35 = v34;
      if ( !v34 )
        break;
    ...
    if ( *((_QWORD *)a1 + 161) )
    {
      for ( k = (unsigned int *)*((_QWORD *)a1 + 12); ; k = (unsigned int *)*((_QWORD *)v41 + 7) )
      {
        ...
        if ( v37 < v28 && *((_QWORD *)v41 + 3) <= *((_QWORD *)a1 + 162) )
        {
          v39 = *(_QWORD *)(*((_QWORD *)a1 + 161) + 8 * v38);
          do
          {
            if ( v37 <= v39 )
              break;
            v40 = v39;
            v39 = _InterlockedCompareExchange64((volatile signed __int64 *)(*((_QWORD *)a1 + 161) + 8 * v38), v37, v39);
          }
          while ( v40 != v39 );
        }
      }
