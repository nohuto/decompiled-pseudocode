        ...
        char a7)
{
  ...
  _DWORD v56[2]; // [rsp+34h] [rbp-CCh] BYREF
  ...
  {
    if ( !StLockTryAcquireExclusive(a1 + 440, &v55) )
      return 3221225557LL;
  }
  else
  {
    ...
    *(_DWORD *)(a1 + 1648) = v10;
    ...
    else
    {
      ...
      v41 = (unsigned int)MiGetSystemRegionType(a1 + 440) == 1
          ? (unsigned int)MmGetSessionIdEx((__int64)v40->ApcState.Process)
          : 0xFFFFFFFFLL;
...
LABEL_78:
      ...
      KiAbThreadRemoveBoosts((ULONG_PTR)v40, a1 + 440, v56);
...
LABEL_33:
    ...
    KiAbThreadRemoveBoosts((ULONG_PTR)v25, v12, &v59);
