/*
 * XREFs of EtwpSetPmcProfileSource @ 0x140939D8C
 * Callers:
...
__int64 __fastcall EtwpSetPmcProfileSource(_DWORD *a1, unsigned int a2)
{
  ...
  else
  {
    if ( qword_140C19B68 )
    {
      ExFreePoolWithTag(qword_140C19B68, 0);
      qword_140C19B68 = 0LL;
      EtwpPmcProfile = 0;
    }
    v5 = v3;
    qword_140C19B68 = ExAllocatePoolWithTag(NonPagedPoolNx, 248 * v3, 0x58777445u);
    v6 = qword_140C19B68;
    if ( qword_140C19B68 )
    {
      EtwpPmcProfile = v3;
