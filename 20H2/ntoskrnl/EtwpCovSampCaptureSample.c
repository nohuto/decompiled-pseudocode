/*
 * XREFs of EtwpCovSampCaptureSample @ 0x1405AD7D8
 * Callers:
 *     EtwpCovSampProfileInterrupt @ 0x1405ADBC0 (EtwpCovSampProfileInterrupt.c)
 ...
 *     EtwpCoverageSamplerReadyThread @ 0x1405AE694 (EtwpCoverageSamplerReadyThread.c)
 * Callees:
...
__int64 __fastcall EtwpCovSampCaptureSample(unsigned __int64 a1, unsigned int a2)
{
  ...
  v5 = qword_140C19748;
  v12 = 0;
  result = (*(_QWORD *)(qword_140C19748 + 8) >> 4) & 0x1FFLL;
  v8 = ((unsigned int)*(_QWORD *)(qword_140C19748 + 8) >> 13) & 0x3FFFF;
  ...
  else
  {
    ...
    {
      result = EtwpCovSampCaptureBufferGet(qword_140C19748);
      v4 = result;
      if ( result )
      {
