/*
 * XREFs of MiMirrorOmitPagesFromCopy @ 0x14038507C
 * Callers:
 ...
 *     MiMirrorRemoveBlackChildPartitionPages @ 0x140533210 (MiMirrorRemoveBlackChildPartitionPages.c)
 *     MiMirrorRemoveInactivePages @ 0x140533274 (MiMirrorRemoveInactivePages.c)
 *     MiRemoveEnclavePagesFromMirror @ 0x1409B3DD8 (MiRemoveEnclavePagesFromMirror.c)
 * Callees:
...
__int64 __fastcall MiMirrorOmitPagesFromCopy(__int64 a1, unsigned __int64 a2, unsigned __int64 a3, __int64 a4)
{
  ...
  v7 = a2;
  v8 = a2 & 0x1F;
  v9 = (volatile signed __int32 *)(qword_140C4E5A8 + 4 * (a2 >> 5));
  if ( v8 + v6 > 0x20 )
  {
    if ( (a2 & 0x1F) != 0 )
    {
...
LABEL_5:
  if ( *(_QWORD *)(a1 + 24) )
    RtlClearBitsEx((__int64)&qword_140C4E590, v7, v4);
