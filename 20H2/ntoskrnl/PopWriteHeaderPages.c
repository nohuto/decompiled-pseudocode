/*
 * XREFs of PopWriteHeaderPages @ 0x140993C94
 * Callers:
...
__int64 __fastcall PopWriteHeaderPages(__int64 a1, __int64 a2)
{
  ...
  if ( *(_QWORD *)(a1 + 240) )
  {
    ...
    *(_DWORD *)(a2 + 864) = v16;
    ...
    if ( v18 != v17 )
    {
      ...
      KeBugCheckEx(0xA0u, 3uLL, *(unsigned int *)(a2 + 860), v19, 0x1CDBuLL);
    }
  }
  ...
  *(_DWORD *)(a2 + 80) = tcpxsum(0, (const char *)v4, 0x5C0u);
  ...
  if ( v22 != v21 )
  {
    ...
    KeBugCheckEx(0xA0u, 3uLL, *(unsigned int *)(a2 + 80), v23, 0x1CF1uLL);
  }
  ...
  if ( v25 != v24 )
  {
    ...
    KeBugCheckEx(0xA0u, 4uLL, *(unsigned int *)(a2 + 80), v26, 0x1CF8uLL);
  }
  return 0LL;
}
