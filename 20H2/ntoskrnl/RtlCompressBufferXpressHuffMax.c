/*
 * XREFs of RtlCompressBufferXpressHuffMax @ 0x14058F734
 * Callers:
 *     RtlCompressBufferXpressHuff @ 0x140365AE0 (RtlCompressBufferXpressHuff.c)
 *     RtlCompressBufferProgress @ 0x140382FC0 (RtlCompressBufferProgress.c)
 * Callees:
 *     XpressBuildHuffmanEncodings @ 0x140366370 (XpressBuildHuffmanEncodings.c)
 *     XpressDoHuffmanPass @ 0x140366720 (XpressDoHuffmanPass.c)
  ...
  if ( a4 >= 0x12C )
  {
    ...
    *((_QWORD *)a6 + 0x8000) = 0LL;
    ...
    while ( 1 )
    {
      ...
      do
      {
        v26 = (unsigned __int16)XpressHashFunction[*v24] ^ (unsigned __int16)word_14003A370[v24[2]] ^ (unsigned __int64)(unsigned __int16)word_14003A170[v24[1]];
        v27 = *(_QWORD *)&a6[8 * v26];
        *(_QWORD *)&a6[8 * v26] = v24++;
