/*
 * XREFs of KsepResolveApplicableShimsForDriver @ 0x1408C2E74
 * Callers:
 ...
 *     KsepIsShimRegistered @ 0x1407B9460 (KsepIsShimRegistered.c)
 *     KsepGetLoadedModulesList @ 0x1407B9604 (KsepGetLoadedModulesList.c)
 *     KsepResolveShimHooks @ 0x1408C28E4 (KsepResolveShimHooks.c)
 */
...
LABEL_25:
    if ( v5 )
    {
      ...
      if ( a2 )
      {
        ...
        dword_140C2A924[2 * v27] = LoadedModulesList;
...
LABEL_31:
  ...
  if ( a2 )
  {
    ...
    dword_140C2A924[2 * v25] = LoadedModulesList;
...
LABEL_22:
  ...
  dword_140C2A924[2 * v26] = -1073740782;
