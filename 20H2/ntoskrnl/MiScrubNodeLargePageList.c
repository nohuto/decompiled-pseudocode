/*
 * XREFs of MiScrubNodeLargePageList @ 0x140555368
 * Callers:
        ...
        __int64 a10)
{
  ...
  if ( a5 )
  {
    ...
    if ( a3 > 1 )
    {
      v17 = MiReservePtes((__int64)&qword_140C4EDC0, v15);
      v13 = v17;
      if ( !v17 )
        return 1LL;
...
LABEL_64:
        ...
        *(_QWORD *)v13 = ValidPte;
        if ( v58 )
          MiWritePteShadow(v13, ValidPte, v56);
        goto LABEL_82;
      }
      if ( v13 >= v13 + 8 * v97 )
        goto LABEL_81;
...
LABEL_116:
      ...
      *v111 = v88;
      ...
      if ( a3 <= 1 )
        goto LABEL_135;
      v31 = v97;
      MiReleasePtes((__int64)&qword_140C4EDC0, (_QWORD *)v13, v97);
      v89 = MiReservePtes((__int64)&qword_140C4EDC0, v97);
      v13 = v89;
      if ( !v89 )
        goto LABEL_137;
...
LABEL_138:
  *((_DWORD *)&v121[1].SwapListEntry + 3) &= ~0x100u;
  ...
  {
    if ( v13 )
      MiReleasePtes((__int64)&qword_140C4EDC0, (_QWORD *)v13, v31);
  }
  return v30;
}
