/*
 * XREFs of MiInitializeDriverPtes @ 0x140A69998
 * Callers:
...
__int64 __fastcall MiInitializeDriverPtes(__int64 a1)
{
  ...
  for ( i = qword_140C4CBB0; i; i = *(PVOID *)i )
  {
    v16 = 0;
    do
    {
...
LABEL_60:
  ...
  if ( (KiSpeculationFeatures & 0x4000000) != 0 )
    qword_140C4DF78 = (unsigned __int64)(((__int64)((*((_QWORD *)qword_140C4CBB0 + 1) << 25)
                                                  + ((unsigned __int64)*((unsigned int *)qword_140C4CBB0 + 4) << 28)) >> 16)
                                       - qword_140C4DF80) >> 21;
  v44 = v52;
  m = 0LL;
  while ( v44 )
