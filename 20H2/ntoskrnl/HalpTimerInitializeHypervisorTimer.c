/*
 * XREFs of HalpTimerInitializeHypervisorTimer @ 0x1403AE154
 * Callers:
 ...
 *     HalpHvBuildDeviceId @ 0x1409AA1F8 (HalpHvBuildDeviceId.c)
 */
          ...
          if ( (int)HalpTimerInitialize(Timer) >= 0 )
          {
            *(_DWORD *)(v8 + 184) |= 4u;
            ...
            if ( v9 >= 0 )
            {
              ...
              LOBYTE(v15) = v11;
              if ( (int)((__int64 (__fastcall *)(_QWORD, _QWORD, unsigned __int64, __int64, __int128 *))qword_140C4A2A0)(
                          *((_QWORD *)v12 + 3),
                          *v12,
                          v24,
                          v15,
