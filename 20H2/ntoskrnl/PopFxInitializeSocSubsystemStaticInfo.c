/*
 * XREFs of PopFxInitializeSocSubsystemStaticInfo @ 0x1408E6F20
 * Callers:
...
LABEL_18:
      ...
      if ( v3 )
        goto LABEL_29;
      v22 = (unsigned int **)qword_140C24678;
      if ( *(__int64 **)qword_140C24678 != &SocSubsystemsList )
        __fastfail(3u);
      *(_QWORD *)v5 = &SocSubsystemsList;
      *((_QWORD *)v5 + 1) = v22;
      *v22 = v5;
      qword_140C24678 = (__int64)v5;
    }
    else
    {
