/*
 * XREFs of MmMarkHiberPhase @ 0x1409B371C
 * Callers:
...
__int64 MmMarkHiberPhase()
{
  ...
  PoSetHiberRange(0LL, 0x14000u, qword_140C4EC48, 1uLL, 0x61676D4Du);
  ...
  if ( MiIsRetpolineEnabled() )
  {
    PoSetHiberRange(
      ...
      0x10000u,
      qword_140C4CAE0,
      8 * (((unsigned __int64)qword_140C4CAD8 >> 6) + ((qword_140C4CAD8 & 0x3F) != 0)),
      0x62706D4Du);
    PoSetHiberRange(0LL, 0x10000u, Base, (unsigned int)(dword_140C4CB08 << 12), 0x62706D4Du);
  }
  MiMarkNonPagedHiberPhasePages(qword_140C4E0C8, qword_140C4E0C8 + qword_140C4E0D0 - 1, 0);
