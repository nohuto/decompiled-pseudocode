/*
 * XREFs of WdipSemDisableContextProvider @ 0x140785B90
 * Callers:
 ...
 *     WdipSemEnableDisableTrace @ 0x140785DE8 (WdipSemEnableDisableTrace.c)
 */
...
__int64 __fastcall WdipSemDisableContextProvider(__int64 a1, char a2)
{
  ...
  ExAcquirePushLockExclusiveEx((ULONG_PTR)&qword_140C1C208, 0LL);
  if ( a1 )
  {
  ...
  ExReleasePushLockEx((ULONG_PTR)&qword_140C1C208, 0LL);
