/*
 * XREFs of PpmIdleExecuteTransition @ 0x140281CF0
 * Callers:
 ...
 *     PpmIdleSetSynchronizationState @ 0x140565300 (PpmIdleSetSynchronizationState.c)
...
LABEL_21:
        ...
        v209 = v23;
        v205 = v21;
        v24 = KeGetPrcb(KiProcessorNumberToIndexMappingTable[64 * v206 + (unsigned __int8)v23]);
...
LABEL_53:
  ...
  *(_DWORD *)(BugCheckParameter4 + 32820) = v41;
  ...
  if ( v31 || *(_BYTE *)(v191 + 6) || *(_BYTE *)(v191 + 7) )
  {
    ...
    if ( *(_BYTE *)(v191 + 7) )
    {
      v46 = PpmCurrentProfile[342 * dword_140C23D4C + 24];
...
LABEL_112:
  ...
  if ( *(_BYTE *)(v43 + 540) )
  {
    ...
    KePrepareClockTimerForIdle(a5, (unsigned __int8)v199, *(_QWORD *)(v43 + 520), (unsigned __int8)v73);
  }
  v41 = BugCheckParameter2;
LABEL_135:
  ...
  *(_QWORD *)(BugCheckParameter4 + 32848) = v77;
  ...
  if ( v12 >= 0 )
  {
    ...
    if ( v193 != -1 )
    {
      ...
      if ( !qword_140C4FEC0 && v193 == dword_140C4FF00 )
        _InterlockedCompareExchange64(&qword_140C4FEC0, MEMORY[0xFFFFF78000000008], 0LL);
      if ( a5 )
      {
    ...
    *(_BYTE *)(BugCheckParameter4 + 248) &= ~1u;
    if ( DeepSleep )
    {
      ...
      if ( v120 )
      {
        ...
        v121->DeepSleep = 0;
        _InterlockedAnd64(
          &qword_140C2B208[(unsigned __int64)(unsigned int)KiProcessorIndexToNumberMappingTable[v122] >> 6],
