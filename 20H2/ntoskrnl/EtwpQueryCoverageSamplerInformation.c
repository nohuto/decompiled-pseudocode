/*
 * XREFs of EtwpQueryCoverageSamplerInformation @ 0x14094A014
 * Callers:
 ...
 *     EtwpCoverageSamplerQueryStatusInformation @ 0x1409497FC (EtwpCoverageSamplerQueryStatusInformation.c)
 */
...
LABEL_4:
  ...
  {
    Object = 0LL;
    StatusInformation = ObReferenceObjectByHandle(Handle[1], 1u, qword_140C19730, a3, &Object, 0LL);
