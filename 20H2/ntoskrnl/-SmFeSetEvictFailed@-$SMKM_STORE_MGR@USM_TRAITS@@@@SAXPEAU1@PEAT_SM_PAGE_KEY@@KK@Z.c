/*
 * XREFs of ?SmFeSetEvictFailed@?$SMKM_STORE_MGR@USM_TRAITS@@@@SAXPEAU1@PEAT_SM_PAGE_KEY@@KK@Z @ 0x140597560
 * Callers:
...
__int64 __fastcall SMKM_STORE_MGR<SM_TRAITS>::SmFeSetEvictFailed(__int64 a1, unsigned int *a2, int a3)
{
  ...
  while ( 1 )
  {
    ...
    if ( v19 )
      goto LABEL_24;
    v18 = (unsigned __int64)&v15->LockEntries[v20];
    v17 &= ~(1 << v20);
    if ( (*(_BYTE *)(v18 + 26) & 1) != 0
      && (*(_DWORD *)(v18 + 32) & 1) == 0
...
LABEL_24:
  ...
  *(_BYTE *)(v18 + 25) &= ~1u;
  *(_QWORD *)(v18 + 32) = 0LL;
  v21 = (__int64)(v18 - (unsigned __int64)v15->LockEntries) / 96;
  if ( v16 == 1 )
