/*
 * XREFs of KiOpDecode @ 0x1402E82D0
 * Callers:
 *     KiPreprocessFault @ 0x1402E7D20 (KiPreprocessFault.c)
 * Callees:
 *     KiOpFetchNextByte @ 0x1402E8458 (KiOpFetchNextByte.c)
 *     KiOpIsPrefix @ 0x1402E8480 (KiOpIsPrefix.c)
 *     KiOpLocateDecodeEntry @ 0x1402E8524 (KiOpLocateDecodeEntry.c)
 *     KiOpDecodeModRM @ 0x1403CEB6C (KiOpDecodeModRM.c)
 *     memset @ 0x140411300 (memset.c)
 *     KiOpFetchBytes @ 0x140522C0C (KiOpFetchBytes.c)
 */
