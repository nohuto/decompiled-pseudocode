/*
 * XREFs of PopInvokeSystemStateHandler @ 0x140995A68
 * Callers:
...
__int64 __fastcall PopInvokeSystemStateHandler(int a1, __int64 a2)
{
  ...
  if ( a2 )
  {
    ...
    qword_140C50500 = DeferredContext[4];
    dword_140C50508 = DeferredContext[5];
    byte_140C5050C = BYTE4(DeferredContext[5]);
    dword_140C50510 = DeferredContext[6];
    qword_140C504E8 = (__int64)v7;
    v9 = &PopHibernateSystemContext;
    qword_140C504F0 = v8;
    qword_140C504F8 = v6;
    qword_140C50518 = DeferredContext[7];
    RtlpInterlockedPushEntrySList(&stru_140C50520, &v38[8]);
  }
  else
  {
  ...
  if ( SLODWORD(v38[7].Next) >= 0 )
  {
    *((_BYTE *)v9 + 44) = 1;
    ...
    if ( a2 )
    {
      ...
      MmInvalidateDumpAddresses(qword_140C23508, 19LL);
      v13 = *(_QWORD *)(a2 + 304);
      if ( v13 )
  ...
  if ( a2 )
  {
    ...
    v23 = qword_140C23EA0 == 0;
    *v9 = (__int64)&unk_140C23E98;
    v9[3] = 0LL;
    if ( !v23 )
      PopIssueNextState(v9, v38, 6LL);
...
LABEL_49:
  ...
  if ( Next >= 0 )
  {
    if ( dword_140C23320 != 4 || PoResumeFromHibernate )
    {
      v15 = 0;
      v28 = KeQueryPerformanceCounter(0LL);
      ((void (__fastcall *)(void *, __int64 *))off_140C006A0[0])(&unk_140C23948, &qword_140C23950);
    }
    else
    {
      v15 = 1;
    ...
    if ( v15 )
    {
      ...
      qword_140C23828 = v28.QuadPart - PerformanceCounter.QuadPart;
    }
  }
  ...
  if ( a2 )
  {
    if ( !byte_140C23521 && Next == 1073742484 )
    {
      if ( byte_140C504D0 )
        BgLibraryInitialize(qword_140C504C8, 0LL);
    }
  }
  else
  {
