/*
 * XREFs of PopSleepDeviceList @ 0x140382BCC
 * Callers:
 ...
 *     PopIsNotifyForDirectedPowerTransition @ 0x140382E44 (PopIsNotifyForDirectedPowerTransition.c)
  ...
  if ( v2 > 0 )
  {
    do
    {
      ...
      *(_QWORD *)(a1 + 440) = v9;
      ...
      --v2;
      ++v6;
      LODWORD(v8) = (unsigned __int8)PopIsNotifyForDirectedPowerTransition(v9)
