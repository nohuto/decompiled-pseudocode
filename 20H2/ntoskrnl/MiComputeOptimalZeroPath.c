/*
 * XREFs of MiComputeOptimalZeroPath @ 0x140A532A0
 * Callers:
...
ULONG_PTR MiComputeOptimalZeroPath()
{
  ...
  for ( i = 0LL; ; ++i )
  {
    ...
    if ( v1 >= 2 )
    {
      v42 = 2LL;
      v9 = &v47;
      v41 = (unsigned __int64 *)&unk_140C4DE68;
      v10 = 0LL;
      v51 = &v47;
      v50 = 0LL;
      do
      {
        ...
        if ( v27 / 3 < 9 * (v44 / 0xA) )
        {
          v29 = (unsigned __int64)dword_140C4DE1C;
          dword_140C4DE1C[4 * v13] = 1;
        }
        v10 = v25 + 8;
        *(v18 - 1) = v28;
        v9 = v26 + 1;
      ...
      do
      {
        ...
        v34 = (unsigned __int8)MiLockPageInline(v33, v29, v22, SchedulerAssist);
  ...
  if ( v1 )
  {
    ...
    do
    {
      ...
      v38 = (unsigned __int8)MiLockPageInline(v37, v4, v5, v6);
      ...
      if ( KiIrqlFlags )
      {
        if ( (KiIrqlFlags & 1) != 0 )
        {
          ...
          if ( (unsigned __int8)result <= 0xFu && (unsigned __int8)v38 <= 0xFu && (unsigned __int8)result >= 2u )
          {
            ...
            v6 = v39->SchedulerAssist;
            result = ~(unsigned __int16)v4;
            v30 = ((unsigned int)result & v6[5]) == 0;
