/*
 * XREFs of RtlFindNextForwardRunClear @ 0x140344E30
 * Callers:
 ...
 *     ViThunkSnapSharedExports @ 0x1409C52AC (ViThunkSnapSharedExports.c)
 * Callees:
 *     <none>
 */
...
ULONG __stdcall RtlFindNextForwardRunClear(PRTL_BITMAP BitMapHeader, ULONG FromIndex, PULONG StartingRunIndex)
{
  ...
  if ( v9 != v8 && (*v9 | *((_DWORD *)qword_140011D10 + (v5 & 0x1F))) == 0xFFFFFFFF )
  {
    v5 = v5 - (v5 & 0x1F) + 32;
  ...
  if ( v9 == v8 )
    goto LABEL_13;
  v11 = v5 & 0x1F;
  if ( (*v9 & ~*((_DWORD *)qword_140011D10 + (v5 & 0x1F))) != 0 )
    goto LABEL_13;
  v10 = 32 - v11;
  if ( v11 != 33 )
  {
