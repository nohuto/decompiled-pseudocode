        ...
        PULONG ReturnLength)
{
  ...
  AlpcpCaptureIdMessage((__int64)PortMessage, &v22, &v23);
  if ( PreviousMode )
  {
...
LABEL_18:
    ...
    TokenModifiedIdMessage = AlpcpQuerySidMessage((int)v16, BugCheckParameter2[0], MessageInformation, Length, v11);
    goto LABEL_17;
  }
LABEL_20:
