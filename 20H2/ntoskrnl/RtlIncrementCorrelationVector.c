/*
 * XREFs of RtlIncrementCorrelationVector @ 0x140918950
 * Callers:
 *     <none>
 * Callees:
 *     __security_check_cookie @ 0x1403CFAF0 (__security_check_cookie.c)
 *     _snprintf_s @ 0x1403D6780 (_snprintf_s.c)
 *     sscanf_s @ 0x1403D7300 (sscanf_s.c)
 *     strcpy_s @ 0x1403D7400 (strcpy_s.c)
 *     RtlpGetCorrelationVectorLastDotPosition @ 0x14058B24C (RtlpGetCorrelationVectorLastDotPosition.c)
 *     RtlpGetCorrelationVectorBufferLength @ 0x140918C70 (RtlpGetCorrelationVectorBufferLength.c)
 */
