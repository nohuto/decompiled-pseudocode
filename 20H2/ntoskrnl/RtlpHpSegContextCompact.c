/*
 * XREFs of RtlpHpSegContextCompact @ 0x14023AFB0
 * Callers:
      ...
      do
      {
        ...
        if ( v8 < v9 )
        {
          ...
          if ( *(_QWORD **)(*v13 + 8LL) != v13
            || (_QWORD *)*v22 != v13
            || (*v22 = v21, *(_QWORD *)(v21 + 8) = v22, v23 = (_QWORD **)v30, --*(_QWORD *)(a1 + 88), *v23 != &v29) )
          {
            __fastfail(3u);
          }
          v13[1] = v23;
        ...
        if ( KiIrqlFlags )
        {
          if ( (KiIrqlFlags & 1) != 0 )
          {
            ...
            if ( CurrentIrql <= 0xFu && v7 <= 0xFu && CurrentIrql >= 2u )
            {
              ...
              v7 = v31;
              v27 = ~(unsigned __int16)(-1LL << (v31 + 1));
...
LABEL_38:
        ...
        KiAbThreadRemoveBoosts((ULONG_PTR)CurrentThread, a1 + 64, &v33);
  ...
  for ( result = &v29; v10 != &v29; result = &v29 )
  {
    v28 = v10;
    v10 = (_QWORD *)*v10;
    RtlpHpSegSegmentFree(a1, v28, 0x7FFFFFFFLL, 1LL);
  }
  return result;
}
