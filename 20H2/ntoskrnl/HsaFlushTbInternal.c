/*
 * XREFs of HsaFlushTbInternal @ 0x1404E130C
 * Callers:
 *     HsaAttachDeviceDomainInternal @ 0x1404E0A38 (HsaAttachDeviceDomainInternal.c)
 *     HsaFlushDomainTb @ 0x1404E1260 (HsaFlushDomainTb.c)
 *     HsaFlushTb @ 0x1404E12C0 (HsaFlushTb.c)
 * Callees:
 ...
 *     HalpIommuGetNextFlushDevice @ 0x1404CA5AC (HalpIommuGetNextFlushDevice.c)
