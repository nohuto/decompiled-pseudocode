/*
 * XREFs of HvpRemapAndEnlistHiveBins @ 0x140706998
 * Callers:
 ...
 *     HvpValidateLoadedBin @ 0x140706BD4 (HvpValidateLoadedBin.c)
...
__int64 __fastcall HvpRemapAndEnlistHiveBins(_DWORD *BugCheckParameter2)
{
  ...
  for ( i = 0; i < v6; v2 = v21 )
  {
    ...
    if ( v9 != 4096 )
    {
      ...
      if ( i + v9 > v6 )
        break;
      v11 = HvpViewMapPromoteRangeToMapping((__int64)(BugCheckParameter2 + 54), i, v9, &v23);
      if ( v11 < 0 )
  ...
  while ( i < v2 )
  {
    ...
    if ( v15 != 4096 )
    {
      ...
      for ( j = 0; j < v3; *(_DWORD *)(v13 + 16) = 0 )
      {
        ...
        if ( (*(_BYTE *)(v13 + 8) & 8) != 0 )
          HvpFreeBin((__int64)BugCheckParameter2, 0x1000u, (unsigned __int64)v18);
        else
