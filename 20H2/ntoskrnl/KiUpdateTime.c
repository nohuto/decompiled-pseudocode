/*
 * XREFs of KiUpdateTime @ 0x14027DA20
 * Callers:
...
__int64 __fastcall KiUpdateTime(unsigned __int8 a1, unsigned __int8 a2)
{
  ...
  unsigned __int8 v73; // [rsp+31h] [rbp-107h]
...
LABEL_95:
  ...
  {
    KiForwardTick((__int64)CurrentPrcb, KeNumberProcessors_0, v26, v5, (char *)v78);
    ...
    for ( ; v30 < (unsigned __int16)*v28; *(_QWORD *)&KiClockCheckPending[4 * v32 + 4] = *(_QWORD *)&v28[4 * v32 + 4] )
      v32 = v30++;
    for ( dword_140C110E4 = v29; v30 < (unsigned __int16)word_140C110E2; *(_QWORD *)&KiClockCheckPending[4 * v70 + 4] = v29 )
      v70 = v30++;
  }
