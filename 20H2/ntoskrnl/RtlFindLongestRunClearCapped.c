/*
 * XREFs of RtlFindLongestRunClearCapped @ 0x140585740
 * Callers:
...
LABEL_45:
    ...
    v16 = 8 * v14 - v15 + 8;
    for ( i = *((_BYTE *)&qword_14001A7F8 - v15) | byte_14001DA60[v21] | v18; ; i |= v25 )
    {
