/*
 * XREFs of PopIdleAoAcDozeToS4 @ 0x1408F7D60
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall PopIdleAoAcDozeToS4(int a1)
{
  ...
  dword_140C23270 = 0;
  v7 = 0LL;
  if ( dword_140C23288 == 1 )
    goto LABEL_10;
  if ( dword_140C23288 != 2 )
  {
    if ( dword_140C23288 == 3 )
    {
      v6[0] = 13;
      goto LABEL_11;
    }
    if ( dword_140C23288 == 4 )
    {
      v6[0] = 14;
      goto LABEL_11;
    }
LABEL_10:
  ...
  v6[0] = 11;
  if ( qword_140C23358
    && MEMORY[0xFFFFF78000000008] - qword_140C23358 > 10000000
...
LABEL_11:
  ...
  _InterlockedAnd(&dword_140C2328C, 0);
