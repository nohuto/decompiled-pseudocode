/*
 * XREFs of ObpInsertHandleCount @ 0x1406B24FC
 * Callers:
 *     ObpLockHandleDataBaseEntry @ 0x1406B2380 (ObpLockHandleDataBaseEntry.c)
 * Callees:
 *     OBJECT_HEADER_TO_HANDLE_INFO @ 0x140303330 (OBJECT_HEADER_TO_HANDLE_INFO.c)
