/*
 * XREFs of RtlpSetTimeZoneInformationWorker @ 0x14091795C
 * Callers:
 *     ExpRefreshTimeZoneInformation @ 0x14079F494 (ExpRefreshTimeZoneInformation.c)
 *     RtlSetDynamicTimeZoneInformation @ 0x140917920 (RtlSetDynamicTimeZoneInformation.c)
 *     RtlSetTimeZoneInformation @ 0x140917940 (RtlSetTimeZoneInformation.c)
