/*
 * XREFs of MiDemotePfnListChain @ 0x14055C748
 * Callers:
 ...
 *     MiSetResidentPageMemberInPfn @ 0x1403F3150 (MiSetResidentPageMemberInPfn.c)
    ...
    *(_QWORD *)(a1 + 8 * v8) = *v7;
    ...
    if ( (_DWORD)v8 == 1 )
    {
      MiUpdateLargePageBitMap(
        *(_QWORD *)(qword_140C4E4C8 + 8 * ((v7[5] >> 39) & 0x3FFLL)),
