/*
 * XREFs of PopSleepstudyStartNextSession @ 0x140770D38
 * Callers:
...
void __fastcall PopSleepstudyStartNextSession(ULONG a1, int a2)
{
  ...
  v4 = (LARGE_INTEGER *)((char *)&unk_140C1E398 + 96 * (unsigned int)dword_140C1E390);
  v5 = ((_BYTE)dword_140C1E390 + 1) & 7;
  dword_140C1E390 = ((_BYTE)dword_140C1E390 + 1) & 7;
  v6 = (LARGE_INTEGER *)((char *)&unk_140C1E398 + 96 * v5);
  ...
  if ( a1 != 2 )
  {
    if ( v4->LowPart == 1 )
      ++v6[1].QuadPart;
    if ( ((a1 - 1) & 0xFFFFFFFD) != 0 || (byte_140C4FE4C = 1, a1 != 3) )
    {
      v18 = 17;
      if ( (_DWORD)v39 == 45 )
        v18 = 2;
    ...
    if ( !PopSleepstudySessionContext )
    {
      ...
      *v20 = v29;
      ...
      v20[3] = v32;
      *((_QWORD *)v20 + 8) = v33;
      KeSetTimer2((__int64)&unk_140C1E2E8, -50000000LL, 0LL, (__int64)v38);
