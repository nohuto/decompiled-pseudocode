/*
 * XREFs of WbHeapExecuteCall @ 0x14065FA50
 * Callers:
  ...
  if ( HeapExecutedBlock >= 0 )
  {
    ...
    if ( HeapExecutedBlock >= 0 )
    {
      ...
      if ( HeapExecutedBlock >= 0 )
      {
        ...
        if ( HeapExecutedBlock >= 0 )
        {
          HeapExecutedBlock = sub_14065FDD8(v18, v19, DWORD2(v20), v20, v21);
          if ( HeapExecutedBlock >= 0 )
          {
            HeapExecutedBlock = WbUpdateHeapExecutedCallArgumentList(v22, v19, &v20, a2, a3, a4);
            if ( HeapExecutedBlock >= 0 )
            {
...
LABEL_11:
  sub_14065F0A0(a1, v18);
  sub_14065F904(a1, v19);
