/*
 * XREFs of SmHpBufferUpdateFullness @ 0x1402547B8
 * Callers:
...
__int64 __fastcall SmHpBufferUpdateFullness(__int64 a1, __int64 a2, __int16 a3)
{
  ...
  *(_DWORD *)(v6 + 560) += a3;
  ...
  if ( v7 != v4 )
  {
    result = SmHpBufferProtectEx(a1, a2, 1LL);
    v9 = *(_QWORD **)a2;
    if ( v7 >= 0 )
    {
    ...
    if ( v4 >= 0 )
    {
      ...
      else
      {
        ...
        SmHpBufferProtectEx(v13, *(_QWORD *)(v6 + 8 * v13) + 16 * (v12 ^ (unsigned int)(1 << v13)), 1LL);
      }
      result = v11[1];
