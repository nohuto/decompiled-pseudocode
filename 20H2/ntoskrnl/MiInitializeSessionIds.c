/*
 * XREFs of MiInitializeSessionIds @ 0x140A5376C
 * Callers:
...
__int64 MiInitializeSessionIds()
{
  ...
  *(_QWORD *)&v2.Length = 1048590LL;
  ...
  qword_140C4ED90 = Pool;
  if ( !Pool || (Pool->SizeOfBitMap = 128, Pool->Buffer = &Pool[1].SizeOfBitMap, !qword_140C4ED90) )
    KeBugCheckEx(0x7Du, qword_140C52710, qword_140C52700, ::BugCheckParameter3, 0x200uLL);
  memset(
    qword_140C4ED90->Buffer,
    0,
    4 * ((qword_140C4ED90->SizeOfBitMap >> 5) + ((qword_140C4ED90->SizeOfBitMap & 0x1F) != 0)));
  qword_140C4DC68 = 0LL;
  LOWORD(stru_140C4DC70.Header.Lock) = 0;
  stru_140C4DC70.Header.SignalState = 0;
  stru_140C4DC70.Header.WaitListHead.Blink = &stru_140C4DC70.Header.WaitListHead;
  stru_140C4DC70.Header.WaitListHead.Flink = &stru_140C4DC70.Header.WaitListHead;
  stru_140C4DC70.Header.Size = 6;
