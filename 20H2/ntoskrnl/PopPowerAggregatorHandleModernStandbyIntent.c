/*
 * XREFs of PopPowerAggregatorHandleModernStandbyIntent @ 0x1408F0B60
 * Callers:
 *     PopPowerAggregatorHandleIntentUnsafe @ 0x140771E64 (PopPowerAggregatorHandleIntentUnsafe.c)
 * Callees:
 *     PopPowerAggregatorAllowModernStandbyPromotion @ 0x1408F077C (PopPowerAggregatorAllowModernStandbyPromotion.c)
 *     PopPowerAggregatorGetModernStandbySessionType @ 0x1408F0A58 (PopPowerAggregatorGetModernStandbySessionType.c)
 */
