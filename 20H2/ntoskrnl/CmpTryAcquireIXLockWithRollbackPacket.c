/*
 * XREFs of CmpTryAcquireIXLockWithRollbackPacket @ 0x14076A14C
 * Callers:
 *     CmpTryAcquireKcbIXLocks @ 0x14076A0E0 (CmpTryAcquireKcbIXLocks.c)
 * Callees:
 *     CmpSnapshotTxOwnerArrayToRollbackPacket @ 0x140877864 (CmpSnapshotTxOwnerArrayToRollbackPacket.c)
 */
