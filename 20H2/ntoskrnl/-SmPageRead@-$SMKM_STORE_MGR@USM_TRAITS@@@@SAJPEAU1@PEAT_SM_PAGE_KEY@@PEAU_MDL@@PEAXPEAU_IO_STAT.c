/*
 * XREFs of ?SmPageRead@?$SMKM_STORE_MGR@USM_TRAITS@@@@SAJPEAU1@PEAT_SM_PAGE_KEY@@PEAU_MDL@@PEAXPEAU_IO_STATUS_BLOCK@@@Z @ 0x1403585C0
 * Callers:
...
LABEL_9:
      ...
      *((_QWORD *)PoolWithTag + 4) = v5;
      ...
      if ( PoolWithTag )
        SMKM_STORE_MGR<SM_TRAITS>::SmWorkItemFreeResource((__int64)&SmGlobals, (struct _MDL *)PoolWithTag, v10);
      goto LABEL_17;
    }
