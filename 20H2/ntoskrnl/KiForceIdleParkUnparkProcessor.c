/*
 * XREFs of KiForceIdleParkUnparkProcessor @ 0x140521618
 * Callers:
 *     KiForceIdleParkUnparkDpcRoutine @ 0x1405215F0 (KiForceIdleParkUnparkDpcRoutine.c)
...
__int64 __fastcall KiForceIdleParkUnparkProcessor(__int64 a1, __int64 a2, __int64 a3, __int64 a4)
{
  ...
  if ( *(_BYTE *)(a1 + 33212) )
  {
    ...
    _InterlockedOr64(&qword_140C125A8[v6 >> 6], 1LL << (v6 & 0x3F));
  }
  else
  {
    v5 = KiProcessorIndexToNumberMappingTable[*(unsigned int *)(a1 + 36)];
    _InterlockedOr64(&qword_140C124F8[v5 >> 6], 1LL << (v5 & 0x3F));
  }
