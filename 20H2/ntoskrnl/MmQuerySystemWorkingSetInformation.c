/*
 * XREFs of MmQuerySystemWorkingSetInformation @ 0x140332144
 * Callers:
...
void *__fastcall MmQuerySystemWorkingSetInformation(int a1, _QWORD *a2)
{
  ...
  *((_DWORD *)a2 + 15) = 0;
  ...
  v10 = *(_QWORD *)(qword_140C4E4C8 + 8LL * *(unsigned __int16 *)(AnyMultiplexedVm + 174));
  ...
  *((_DWORD *)a2 + 4) = *(_DWORD *)(AnyMultiplexedVm + 4);
  ...
  StandbyRepurposed = MiGetStandbyRepurposed(v10);
  v14 = *a2;
