/*
 * XREFs of WheapCreateRecordFromGenericErrorData @ 0x1405BB2A0
 * Callers:
 *     WheapDeviceDriverCreateRecord @ 0x1405BA880 (WheapDeviceDriverCreateRecord.c)
 *     WheapDefaultErrSrcCreateRecord @ 0x1405BB5B0 (WheapDefaultErrSrcCreateRecord.c)
 * Callees:
