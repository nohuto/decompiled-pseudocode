/*
 * XREFs of MiZeroLargePages @ 0x1402C0D40
 * Callers:
...
__int64 __fastcall MiZeroLargePages(unsigned __int64 a1, __int64 a2, __int64 a3, _DWORD *a4)
{
  ...
  __int64 v90; // rcx
  __int64 v91; // rax
  volatile signed __int32 *v92; // roff
  signed __int32 v93[8]; // [rsp+0h] [rbp-E8h] BYREF
  __int64 v94; // [rsp+50h] [rbp-98h]
  struct _KLOCK_QUEUE_HANDLE LockHandle; // [rsp+58h] [rbp-90h] BYREF
  volatile signed __int32 *v96; // [rsp+70h] [rbp-78h]
  __int64 v97; // [rsp+78h] [rbp-70h]
  unsigned __int64 v98; // [rsp+80h] [rbp-68h]
  __int64 v99; // [rsp+88h] [rbp-60h]
  __int64 v100; // [rsp+90h] [rbp-58h]
  struct _KTHREAD *CurrentThread; // [rsp+98h] [rbp-50h]
  struct _GROUP_AFFINITY Affinity; // [rsp+A0h] [rbp-48h] BYREF
  void *retaddr; // [rsp+E8h] [rbp+0h]
  unsigned int v105; // [rsp+F8h] [rbp+10h]
  int v106; // [rsp+100h] [rbp+18h] BYREF
  ...
  *((_DWORD *)&CurrentThread[1].SwapListEntry + 3) |= 0x400u;
  v6 = KeSetActualBasePriorityThread((__int64)v5, 0, a3, a4);
  v8 = 0;
  v9 = *(_QWORD *)(v4 + 232);
  v107 = v6;
  v105 = 0;
    ...
    if ( *(_DWORD *)(v16 + 136) )
    {
      ...
      if ( (*(_BYTE *)(v24 + 4) & 1) != 0 )
      {
        while ( 1 )
        {
          ...
          KxAcquireQueuedSpinLock((__int64)&LockHandle, (volatile __int64 *)(v16 + 24));
...
LABEL_40:
      ...
      while ( *(_DWORD *)(v18 + 6340) || dword_140C4ED58 )
      {
        if ( !KeWaitForSingleObject((PVOID)(v18 + 104), WrFreePage, 0, 0, (PLARGE_INTEGER)&MiFiveSeconds) )
        {
          KeSetActualBasePriorityThread((__int64)KeGetCurrentThread(), 12, v15, v37);
          goto LABEL_46;
        }
LABEL_41:
        v14 = (unsigned __int64)&MiFiveSeconds;
    ...
    if ( !*(_QWORD *)(v4 + 240) )
    {
      v40 = MiReferencePageRuns(*(_QWORD *)(v16 + 72), 0LL, v15, v14);
      if ( !v40 )
      {
LABEL_46:
        ++dword_140C2A108;
    ...
    {
      v42 = v97;
      HugePageToZero = MiGetHugePageToZero(v97, v4, v15, v14);
      goto LABEL_191;
    }
    v14 = (unsigned int)(*(_DWORD *)(v4 + 260) >> byte_140C4DD0C);
    *(_QWORD *)(v4 + 32) = 0LL;
    *(_BYTE *)(v4 + 69) = 0;
    if ( v8 < 3 )
    {
      v42 = v97;
      v44 = MiUnlinkNodeLargePages(v97, v8, 1, v14, 4, 1, v4 + 248, 64, v4);
      goto LABEL_186;
    }
    v45 = 0;
    LOBYTE(v7) = 17;
...
LABEL_64:
          v44 = 0LL;
LABEL_65:
          v48 = dword_140C4DD00 & (*(_DWORD *)(a1 + 260) + 1) | *(_DWORD *)(a1 + 260) & (unsigned int)~dword_140C4DD00;
          *(_DWORD *)(a1 + 260) = v48;
          goto LABEL_66;
        }
      }
...
LABEL_66:
    ...
    if ( v44 )
    {
      ...
      *(_WORD *)(a1 + 69) = 0;
      ...
      {
        ExpAcquireSpinLockExclusiveAtDpcLevelInstrumented(v60, -1);
      }
      else
      {
        ...
        if ( _interlockedbittestandset(v60, 0x1Fu) )
        {
          ...
          LOBYTE(v48) = -1;
          v106 = ExpWaitForSpinLockExclusiveAndAcquire((unsigned __int64)v60, v48, v15, (_DWORD *)v14);
        }
        v68 = *v60;
...
LABEL_168:
        RtlAvlInsertNodeEx((unsigned __int64 *)&qword_140C4E3E8, (unsigned __int64)v81, v82, (_QWORD *)a1);
        goto LABEL_169;
      }
      v70 = qword_140C4E3F8;
      v71 = 0;
      ...
      *(_QWORD *)(a1 + 16) = v70;
      if ( v70 )
      {
        ...
        *(_QWORD *)(v70 + 8LL * v71) = a1;
        ...
        if ( (*(_BYTE *)(v72 + 16) & 3) != i )
        {
          v79 = RtlpTreeDoubleRotateNodes(&qword_140C4E3F8, v70, v72, v71);
          *(_BYTE *)(v80 + 16) &= 0xFCu;
...
LABEL_177:
      ...
      if ( KiIrqlFlags )
      {
        if ( (KiIrqlFlags & 1) != 0 )
        {
          ...
          if ( v86 <= 0xFu && (unsigned __int8)v7 <= 0xFu && v86 >= 2u )
          {
            v87 = KeGetCurrentPrcb();
            v14 = (unsigned __int64)v87->SchedulerAssist;
            v88 = ~(unsigned __int16)(-1LL << ((unsigned __int8)v7 + 1));
            v19 = (v88 & *(_DWORD *)(v14 + 20)) == 0;
            v15 = (unsigned int)v88 & *(_DWORD *)(v14 + 20);
            *(_DWORD *)(v14 + 20) = v15;
            if ( v19 )
      ...
      __writecr8((unsigned __int8)v94);
      v8 = v105;
      if ( !v51 )
        goto LABEL_200;
      v42 = v97;
...
LABEL_186:
      ...
      if ( !*(_BYTE *)(v4 + 80) )
      {
        v89 = *((unsigned int *)MiSearchNumaNodeTable((v44 + 0x58000000000LL) / 48) + 2);
        if ( *(_DWORD *)(v4 + 268) != (_DWORD)v89 )
        {
          *(_DWORD *)(v4 + 268) = v89;
          Affinity = *(struct _GROUP_AFFINITY *)(4544 * v89 + *(_QWORD *)(v42 + 16) + 4472);
...
LABEL_191:
      ...
      else
      {
        ...
        if ( !v8 )
          v91 = 1LL;
        v90 = MiLargePageSizes[v91];
      }
      _InterlockedExchangeAdd64((volatile signed __int64 *)(v41 + 40), v90);
      v12 = v96;
      v92 = v96;
      _InterlockedExchangeAdd(v96, v90);
      v14 = (unsigned __int64)&MiFiveSeconds;
      v15 = 2LL;
      if ( *v92 >= 0x1000u )
      {
        _InterlockedOr(v93, 0);
        MiReassessZeroThreads(v4, __rdtsc() - v98, 2LL, &MiFiveSeconds);
        _InterlockedExchange(v12, 0);
        v13 = __rdtsc();
        _InterlockedOr(v93, 0);
        continue;
...
LABEL_47:
  v38 = CurrentThread;
  result = KeSetActualBasePriorityThread((__int64)CurrentThread, v107, v15, (_DWORD *)v14);
