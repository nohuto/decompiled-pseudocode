/*
 * XREFs of MmEnoughMemoryForWrite @ 0x1403541BC
 * Callers:
...
char __fastcall MmEnoughMemoryForWrite(__int64 a1)
{
  ...
  if ( a1 )
  {
    ...
    if ( !v4 )
      return 1;
    v3 = v12;
    v5 = *(ULONG_PTR **)(qword_140C4E4C8 + 8LL * (*(_WORD *)(v4 + 60) & 0x3FF));
  }
  else
  {
    v5 = &MiSystemPartition;
  }
  if ( (unsigned int)MiSufficientAvailablePages((__int64)v5, (_BYTE)dword_140CFB19C != 0 ? 0x4000LL : 450LL) )
  {
    v2 = 1;
  }
  else if ( v5[936] < v5[950] + 800 )
  {
    v2 = (unsigned int)MiSufficientAvailablePages((__int64)v5, 0x50uLL) != 0;
  }
  if ( v3 != 17 )
  {
