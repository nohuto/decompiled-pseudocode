/*
 * XREFs of PopEndMirroring @ 0x140999250
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall PopEndMirroring(ULONG_PTR BugCheckParameter3)
{
  ...
  if ( !(_DWORD)v1 )
  {
    ...
    v2 = PopBuildMemoryImageHeader((PVOID)qword_140C23340);
    if ( v2 >= 0 )
    {
      ...
      *(_DWORD *)&Affinity.Group = (unsigned __int16)((unsigned int)KiProcessorIndexToNumberMappingTable[0] >> 6);
      ...
      dword_140C50510 = KeNumberProcessors_0;
  ...
  v2 = *(_DWORD *)(qword_140C23340 + 188);
  if ( v2 < 0 || (v2 = PopInvokeSystemStateHandler(PopHibernatePowerStateHandlerType, qword_140C23340), v2 < 0) )
  {
LABEL_24:
    ...
    if ( qword_140C23340 )
    {
      ...
      v9 = *(_QWORD *)(qword_140C23340 + 168);
      if ( v9 )
        IoAddTriageDumpDataBlock(v9, (PVOID)0x178);
      v10 = *(_QWORD *)(qword_140C23340 + 200);
      if ( v10 )
