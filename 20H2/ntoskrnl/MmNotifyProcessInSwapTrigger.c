/*
 * XREFs of MmNotifyProcessInSwapTrigger @ 0x1402FF324
 * Callers:
...
char __fastcall MmNotifyProcessInSwapTrigger(__int64 a1)
{
  ...
  if ( result == 64 && *(_QWORD *)&qword_140C4ED60 && **(_DWORD **)&qword_140C4ED60 > 5u )
  {
    result = tlgKeywordOn(*(__int64 *)&qword_140C4ED60, 0x400000000008LL);
    if ( result )
    {
      ...
      v10 = 0x1000000LL;
      v17 = 8;
      return tlgWriteEx_EtwWriteEx(v6, (int)&byte_140024A1F, v5, 1, v7, v8, 5u, (__int64)v11);
    }
  }
  return result;
}
