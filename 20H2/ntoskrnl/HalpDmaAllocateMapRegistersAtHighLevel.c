/*
 * XREFs of HalpDmaAllocateMapRegistersAtHighLevel @ 0x1404C531C
 * Callers:
 *     HalDmaAllocateCrashDumpRegistersEx @ 0x1403A5AC0 (HalDmaAllocateCrashDumpRegistersEx.c)
 *     HalAllocateCrashDumpRegisters @ 0x1404B7380 (HalAllocateCrashDumpRegisters.c)
 * Callees:
 ...
 *     HalpDmaForceAllocation @ 0x1404C5FA4 (HalpDmaForceAllocation.c)
 *     HalpDmaPrependTranslations @ 0x1404C63A0 (HalpDmaPrependTranslations.c)
