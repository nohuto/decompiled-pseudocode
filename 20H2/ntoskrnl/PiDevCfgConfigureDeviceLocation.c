/*
 * XREFs of PiDevCfgConfigureDeviceLocation @ 0x14076C9EC
 * Callers:
 ...
 *     IopReplaceSeperatorWithPound @ 0x14075FF84 (IopReplaceSeperatorWithPound.c)
...
__int64 __fastcall PiDevCfgConfigureDeviceLocation(__int64 a1, __int64 a2, _DWORD *a3, _DWORD *a4)
{
  ...
  *(_OWORD *)&ObjectAttributes.SecurityDescriptor = 0LL;
  ...
  if ( v11 < 0 )
    goto LABEL_7;
  CachedContextBaseKey = NtQueryKey(KeyHandle, 4u, (unsigned __int64)v28, 0x28u, &v23);
  if ( CachedContextBaseKey < 0 )
    goto LABEL_7;
  if ( !HIDWORD(v28[0]) )
    goto LABEL_6;
