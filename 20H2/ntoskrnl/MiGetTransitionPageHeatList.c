/*
 * XREFs of MiGetTransitionPageHeatList @ 0x14055DB58
 * Callers:
...
PSLIST_ENTRY MiGetTransitionPageHeatList()
{
  ...
  result = RtlpInterlockedPopEntrySList(&stru_140C4E890);
  v1 = result;
  if ( result )
  {
  ...
  else
  {
    ...
    {
      v3 = v2;
      v2 = _InterlockedCompareExchange(&dword_140C4E8A0, v2 - 1, v2);
      if ( v3 == v2 )
        return v1;
    }
