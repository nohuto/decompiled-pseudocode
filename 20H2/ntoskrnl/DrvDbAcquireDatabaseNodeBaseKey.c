/*
 * XREFs of DrvDbAcquireDatabaseNodeBaseKey @ 0x1406E5790
 * Callers:
  ...
  *a4 = 0LL;
  ...
  else if ( (v11 & 2) != 0 )
  {
    ...
    if ( DatabaseNode >= 0 )
    {
      ...
      if ( (_DWORD)v5 )
      {
        Key = PnpCtxRegCreateKey(v18, v17, qword_140006420[v5], 0, 0x2000000u, 0LL, a2 + 96 + 8 * v5, 0LL);
      }
      else
      {
        v20 = 0LL;
...
LABEL_4:
  ...
  else
  {
    ...
    if ( DatabaseNode >= 0 )
    {
      ...
      if ( (_DWORD)v5 )
      {
        Tree = PnpCtxRegCreateTree(v15, v14, qword_140006420[v5], 0, 0x2000000, 0LL, (__int64)a4, 0LL);
      }
      else
      {
        if ( v15 )
