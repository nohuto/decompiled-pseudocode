/*
 * XREFs of NtQueryInformationToken @ 0x14061D520
 * Callers:
        ...
        PULONG ReturnLength)
{
  ...
  char v125[8]; // [rsp+80h] [rbp-128h] BYREF
  ...
  unsigned int v136; // [rsp+BCh] [rbp-ECh] BYREF
  unsigned int v137; // [rsp+C0h] [rbp-E8h] BYREF
  int v138; // [rsp+C4h] [rbp-E4h] BYREF
  unsigned int v139; // [rsp+C8h] [rbp-E0h] BYREF
  unsigned int v140; // [rsp+CCh] [rbp-DCh] BYREF
  unsigned int v141; // [rsp+D0h] [rbp-D8h] BYREF
  unsigned int v142; // [rsp+D4h] [rbp-D4h] BYREF
