/*
 * XREFs of PfpPrefetchPrivatePages @ 0x1406F1214
 * Callers:
 ...
 *     PfpGetPageListCount @ 0x14065806C (PfpGetPageListCount.c)
...
LABEL_31:
    ...
    v11 = (int *)(*(_QWORD *)(v1 + 56) + 40 * v10);
    if ( (int)PfpSourceBuildVaArray((__int64)v11, (__int64)P) < 0
      || (int)PfpSourceGetPrefetchSupport(v11, (__int64)Handle) < 0 )
    {
      goto LABEL_31;
    }
    v13 = Handle[1];
