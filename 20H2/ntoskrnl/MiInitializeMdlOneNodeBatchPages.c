/*
 * XREFs of MiInitializeMdlOneNodeBatchPages @ 0x140334C04
 * Callers:
...
__int64 __fastcall MiInitializeMdlOneNodeBatchPages(__int64 a1, _QWORD *a2, __int64 a3)
{
  ...
  do
  {
    ...
    if ( (unsigned int)MiCreateColorAnchors(&v25, *((unsigned int *)v18 + 2)) )
    {
      v19 = 3;
      if ( (v20 & 8) != 0 )
        v19 = 7;
...
LABEL_15:
      ...
      {
        if ( !v12 || dword_140C4DE18[4 * ((unsigned __int64)*(unsigned __int8 *)(v13 + 34) >> 6) + v3] == (_DWORD)v3 )
        {
          *(_QWORD *)(v13 + 16) = v8;
          v8 = v13;
        }
