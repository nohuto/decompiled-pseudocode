/*
 * XREFs of PiCMCaptureCreateDeviceInputData @ 0x1408B17EC
 * Callers:
...
LABEL_27:
        ...
        *(_QWORD *)(a4 + 24) = 0LL;
        if ( v13 )
        {
          ...
          if ( v14 >= 2 )
          {
            UserModeCallersCopy = PiControlMakeUserModeCallersCopy((void **)(a4 + 24), v13, v14, 2u, PreviousMode, 1);
            if ( UserModeCallersCopy < 0 )
            {
              *v12 = 0LL;
              *(_DWORD *)(a4 + 32) = 0;
            ...
            {
              v17 = 1;
              *(_WORD *)(*v12 + 2 * ((unsigned __int64)*(unsigned int *)(a4 + 32) >> 1) - 2) = 0;
            }
LABEL_44:
            if ( UserModeCallersCopy >= 0 )
