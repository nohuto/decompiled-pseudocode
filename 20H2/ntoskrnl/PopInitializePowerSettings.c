/*
 * XREFs of PopInitializePowerSettings @ 0x140A7538C
 * Callers:
...
const WNF_STATE_NAME *PopInitializePowerSettings()
{
  ...
  qword_140C22F78 = (__int64)&PopRegisteredPowerSettingCallbacks;
  PopRegisteredPowerSettingCallbacks = (__int64)&PopRegisteredPowerSettingCallbacks;
  qword_140C22F38 = (__int64)&PopPowerSettings;
