/*
 * XREFs of ExpRemoveTagForBigPages @ 0x1405B21E8
 * Callers:
        ...
        _BYTE *a8)
{
  ...
  if ( (v11 & 0x20) != 0 )
  {
    v13 = *(_QWORD *)(qword_140C4DC60 + 992);
    v14 = (volatile signed __int32 *)(qword_140C4DC60 + 864);
    v15 = *(_QWORD *)(qword_140C4DC60 + 1000);
  }
  else
  {
