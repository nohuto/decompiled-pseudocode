/*
 * XREFs of PopDirectedDripsEngage @ 0x140566DE4
 * Callers:
...
__int64 __fastcall PopDirectedDripsEngage(__int64 a1, char a2, __int64 a3)
{
  ...
  if ( a2 )
  {
    ...
    LOBYTE(a3) = 1;
    return PopDirectedDripsNotifyAppsAndServices(&PopDirectedDripsState, &dword_140C24B18, a3);
  }
  else
  {
    ...
    result = (unsigned int)dword_140C24B10;
    if ( (dword_140C24B10 & 4) != 0 )
