/*
 * XREFs of IoCaptureLiveDump @ 0x140898CC8
 * Callers:
 ...
 *     SecureDump_GetSecureDumpSettings @ 0x1403BF6D0 (SecureDump_GetSecureDumpSettings.c)
 ...
 *     IopLiveDumpIsUnderMemoryPressure @ 0x140506F14 (IopLiveDumpIsUnderMemoryPressure.c)
 ...
 *     KeGetSupervisorStateExtensionHost @ 0x140518310 (KeGetSupervisorStateExtensionHost.c)
  ...
  *(_QWORD *)v12[51].Data4 = v10;
  ...
  if ( (unsigned int)dword_140C04498 > 5 && tlgKeywordOn((__int64)&dword_140C04498, 0x200000000000LL) )
  {
    ...
    tlgWriteTransfer_EtwWriteTransfer(
      ...
      (unsigned __int8 *)&byte_140023867,
      v12 + 54,
      v12 + 53,
      3u,
      &v68);
...
LABEL_37:
      ...
      if ( inited >= 0 )
      {
        ...
        else
        {
          ...
          if ( (unsigned int)dword_140C04498 > 5 && tlgKeywordOn((__int64)&dword_140C04498, 0x200000000000LL) )
          {
            ...
            tlgWriteTransfer_EtwWriteTransfer(
              (__int64)&dword_140C04498,
              (unsigned __int8 *)&word_14002381E,
              v12 + 54,
              v12 + 53,
              4u,
              &v63);
  ...
  if ( (unsigned int)dword_140C04498 > 5 && tlgKeywordOn((__int64)&dword_140C04498, 0x200000000000LL) )
  {
    ...
    tlgWriteTransfer_EtwWriteTransfer((__int64)&dword_140C04498, (unsigned __int8 *)word_1400238A2, v36, v35, 6u, &v54);
  }
  if ( v12 )
  {
    if ( (*(_DWORD *)v12[2].Data4 & 8) == 0 )
