/*
 * XREFs of SepDuplicateToken @ 0x140601150
 * Callers:
 ...
 *     SepMakeTokenEffectiveOnly @ 0x1406BBDF8 (SepMakeTokenEffectiveOnly.c)
...
LABEL_42:
  ...
  v37 = *(unsigned int *)(a1 + 800);
  if ( (_DWORD)v37 )
    v23 = SepSetTokenCapabilities(0LL, *(_QWORD *)(a1 + 784), *(_QWORD *)(a1 + 792), v37);
  if ( v23 < 0 )
    goto LABEL_41;
  v38 = *(_QWORD *)(a1 + 784);
  if ( v38 )
