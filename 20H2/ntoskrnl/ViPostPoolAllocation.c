/*
 * XREFs of ViPostPoolAllocation @ 0x1409D853C
 * Callers:
  ...
  *a1 = v2;
  ...
  if ( (a2 & 1) != 0 )
  {
    ...
    if ( v12 > *(_DWORD *)(v6 + 112) )
      *(_DWORD *)(v6 + 112) = v12;
    v13 = v7 + _InterlockedExchangeAdd64(&qword_140C2A730, v7);
    if ( v13 > qword_140C2A740 )
      qword_140C2A740 = v13;
    v14 = _InterlockedIncrement(&dword_140C2A720);
    if ( v14 > dword_140C2A728 )
      dword_140C2A728 = v14;
  }
  else
  {
    ...
    if ( v16 > *(_DWORD *)(v6 + 116) )
      *(_DWORD *)(v6 + 116) = v16;
    v17 = v7 + _InterlockedExchangeAdd64(&qword_140C2A738, v7);
    if ( v17 > qword_140C2A748 )
      qword_140C2A748 = v17;
    v18 = _InterlockedIncrement(&dword_140C2A724);
    if ( v18 > dword_140C2A72C )
      dword_140C2A72C = v18;
  }
  result = v2;
  *v9 = a1;
