/*
 * XREFs of HalpLaAddReservation @ 0x1403BB708
 * Callers:
...
__int64 __fastcall HalpLaAddReservation(__int64 a1, __int64 a2)
{
  ...
  *(_QWORD *)(v4 + 24) = v5;
  ...
  v6 = (__int64 *)off_140C043E8;
  if ( *(_UNKNOWN ***)off_140C043E8 != &HalpLaReservedRanges )
    __fastfail(3u);
  *(_QWORD *)(v4 + 8) = off_140C043E8;
  *(_QWORD *)v4 = &HalpLaReservedRanges;
  *v6 = v4;
  result = 0LL;
  off_140C043E8 = (_UNKNOWN *)v4;
  return result;
}
