/*
 * XREFs of WheapWmiExecuteMethod @ 0x1405BC360
 * Callers:
 *     WheaWmiDispatch @ 0x1403CC0B0 (WheaWmiDispatch.c)
 * Callees:
 *     WheapWmiExecuteErrorInjectionMethod @ 0x1405BBE5C (WheapWmiExecuteErrorInjectionMethod.c)
