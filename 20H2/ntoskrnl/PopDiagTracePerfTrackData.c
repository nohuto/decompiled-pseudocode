/*
 * XREFs of PopDiagTracePerfTrackData @ 0x140770444
 * Callers:
...
char __fastcall PopDiagTracePerfTrackData(__int16 a1)
{
  ...
  if ( PopDiagHandleRegistered )
  {
    ...
    if ( result )
    {
      ...
      v35 = PopQpcTimeInMs(&qword_140C23840, &qword_140C23848);
      v34 = PopQpcTimeInMs(&qword_140C23830, &qword_140C23838);
      if ( qword_140C23828 )
      {
        v33 = 0LL;
        v30 = PopQpcTimeInMs(&v33, &qword_140C23828);
        v28 = v30 + PopQpcTimeInMs(&qword_140C23808, &qword_140C23810);
        *(_QWORD *)&UserData.Size = 4LL;
        UserData.Ptr = (ULONGLONG)&qword_140C239E8;
        v42 = &v28;
        v44 = &v30;
        v46 = &v34;
        v48 = &v35;
      ...
      result = dword_140C23A30;
      if ( dword_140C23A30 )
      {
        v4 = qword_140C23898;
        v31 = (4 * dword_140C23A30) & 0x3FFFFF;
        v37 = qword_140C23898;
        v32 = qword_140C23870 / v3;
        result = qword_140C23A40;
        v28 = qword_140C23A40;
        if ( (a1 & 8) != 0 )
        {
          if ( !PopShutdownButtonPressTime )
            return result;
          v29 = PopQpcTimeInMs(&PopShutdownButtonPressTime, &qword_140C237E8) + v4;
          if ( (int)PopReadRegKeyValue(
            ...
            v5 = PopQpcTimeInMs(&v33, &qword_140C238A0);
          v36 = v5;
          *(_QWORD *)&UserData.Size = 4LL;
          ...
          PopComputeDerivedHiberStats(&qword_140C23858, v3, &v38);
          LODWORD(v39) = v28;
          v6 = (unsigned __int64)qword_140C23A18 >> 8;
          WORD3(v39) = -1;
          if ( (unsigned __int64)qword_140C23A18 >> 8 > 0x7FFF )
            LOWORD(v6) = 0x7FFF;
          WORD2(v39) = v6 & 0x7FFF;
          if ( (unsigned __int64)qword_140C23A20 >> 8 <= 0xFFFF )
            WORD3(v39) = (unsigned int)qword_140C23A20 >> 8;
          WORD4(v39) = -1;
          if ( qword_140C238B8 / v3 <= 0xFFFF )
            WORD4(v39) = qword_140C238B8 / v3;
          WORD5(v39) = -1;
          if ( qword_140C239A8 / v3 <= 0xFFFF )
            WORD5(v39) = qword_140C239A8 / v3;
          WORD6(v39) = -1;
          if ( (unsigned int)qword_140C238A8 <= 0xFFFF )
            WORD6(v39) = qword_140C238A8;
          HIWORD(v39) = -1;
          if ( (unsigned int)qword_140C239E8 <= 0xFFFF )
            HIWORD(v39) = qword_140C239E8;
          v7 = DWORD1(v38);
          HIWORD(v40) = -1;
          if ( DWORD1(v38) > 0x3FF )
            v7 = 1023;
          ...
          v10 = (qword_140C23938 - qword_140C23970) / v3;
          if ( v10 > 0x1FFF )
            LODWORD(v10) = 0x1FFF;
          v11 = ((_DWORD)v10 << 19) | v9 & 0x7FFFF;
          v12 = (unsigned __int64)qword_140C239F8 >> 8;
          LODWORD(v40) = v11;
          if ( (unsigned __int64)qword_140C239F8 >> 8 > 0x7FFF )
            LOWORD(v12) = 0x7FFF;
          WORD2(v40) = v12 & 0x7FFF;
          if ( (unsigned __int64)qword_140C23A00 >> 8 <= 0xFFFF )
            HIWORD(v40) = (unsigned int)qword_140C23A00 >> 8;
        ...
        *(_QWORD *)&UserData.Size = 4LL;
        ...
        v17 = qword_140C238A8;
        if ( (_DWORD)qword_140C238A8 )
        {
          PopComputeDerivedHiberStats(&qword_140C23858, v3, &v38);
          LODWORD(v39) = v28;
          v18 = (unsigned __int64)qword_140C23A18 >> 8;
          if ( (unsigned __int64)qword_140C23A18 >> 8 > 0x7FFF )
            LOWORD(v18) = 0x7FFF;
          ...
          v22 = (qword_140C23938 - qword_140C23970) / v3;
          if ( v22 > 0x1FFF )
            LODWORD(v22) = 0x1FFF;
          LODWORD(v40) = v21 & 0x7FFFF | ((_DWORD)v22 << 19);
          v23 = (unsigned __int64)qword_140C239F8 >> 8;
          if ( (unsigned __int64)qword_140C239F8 >> 8 > 0x7FFF )
            LOWORD(v23) = 0x7FFF;
