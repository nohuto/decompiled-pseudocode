/*
 * XREFs of RtlNtStatusToDosErrorNoTeb @ 0x1403051B0
 * Callers:
...
ULONG __stdcall RtlNtStatusToDosErrorNoTeb(NTSTATUS Status)
{
  ...
  if ( (Status & 0x20000000) == 0 )
  {
    ...
    while ( 1 )
    {
      ...
      {
        if ( v7 < (unsigned __int8)byte_1400198B4[8 * v5] )
        {
          v8 = (unsigned __int16)word_1400198B6[4 * v5];
          if ( byte_1400198B5[8 * v5] == 1 )
