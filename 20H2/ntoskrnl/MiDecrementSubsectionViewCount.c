/*
 * XREFs of MiDecrementSubsectionViewCount @ 0x14022BF20
 * Callers:
...
__int64 __fastcall MiDecrementSubsectionViewCount(_QWORD *BugCheckParameter2, char a2)
{
    ...
    && !(unsigned int)MiControlAreaExemptFromCrossPartitionCharges(*BugCheckParameter2) )
  {
    ...
    else
    {
      ...
      v9 = (v7 & 0x100) != 0
         ? *(ULONG_PTR **)(qword_140C4E4C8 + 8LL * *(unsigned __int16 *)(Process[1].AffinityPadding[5] + 430))
         : *(ULONG_PTR **)(qword_140C4E4C8 + 8LL * Process[1].IdealProcessorPadding[5]);
    }
    if ( v9 != *(ULONG_PTR **)(qword_140C4E4C8 + 8LL * (*(_WORD *)(v2 + 60) & 0x3FF)) )
    {
