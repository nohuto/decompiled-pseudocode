/*
 * XREFs of CmpSetSecurityDescriptorInfo @ 0x1405E0E88
 * Callers:
...
__int64 CmpSetSecurityDescriptorInfo(ULONG_PTR a1, _DWORD *a2, ...)
{
  ...
  P = Privileges;
  v18 = RtlpSetSecurityObject(0, *a2, v54, (unsigned int)&P, 0, v58, v59, v17);
  if ( v18 >= 0 )
  {
    v18 = CmpTraceSecurityChanging(a1, (_DWORD)Privileges, *a2, v54, (__int64)P);
    if ( v18 < 0 )
    {
LABEL_19:
      v23 = 0LL;
...
LABEL_18:
    ...
    if ( (unsigned __int8)CmpFindMatchingDescriptorCell(v4, P, v19, &v40, &v48) )
    {
      v22 = v40;
      if ( (_DWORD)v40 == v38 )
      {
