/*
 * XREFs of MiFillSystemPtes @ 0x140286700
 * Callers:
 ...
 *     MiIoPagesInRun @ 0x140323C94 (MiIoPagesInRun.c)
...
LABEL_9:
  ...
  else
  {
    ...
    if ( LeafVa >= 0xFFFF800000000000uLL )
    {
      ...
      {
        if ( LeafVa < qword_140C4F9B8 || (v16 = HIBYTE(word_140C4DE88), LeafVa > qword_140C4E1E8) )
          v16 = (unsigned __int8)word_140C4DE88;
      }
      else
      {
        v16 = BugCheckParameter4;
  ...
  v23 = ((unsigned __int16)((unsigned __int8)word_140C4DE88 << 8) ^ v21) & 0x100;
  if ( (ProtectionPfnCompatible & 0x40000000) == 0 )
    v22 = v18;
  v24 = v22 ^ v23;
