/*
 * XREFs of BgkSetVirtualFrameBuffer @ 0x1403CC330
 * Callers:
 *     <none>
 * Callees:
 ...
 *     BgGetIsColorOverridden @ 0x1409F7B58 (BgGetIsColorOverridden.c)
 *     BgConvertResources @ 0x1409F9550 (BgConvertResources.c)
 */
