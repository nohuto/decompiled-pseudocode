/*
 * XREFs of KiSetVirtualHeteroClockIntervalRequest @ 0x14051EEB4
 * Callers:
 *     KeUpdatePendingQosRequest @ 0x14051D380 (KeUpdatePendingQosRequest.c)
 *     KiSetVirtualHeteroClockIntervalRequestDpcRoutine @ 0x14051EFF0 (KiSetVirtualHeteroClockIntervalRequestDpcRoutine.c)
 * Callees:
...
__int64 __fastcall KiSetVirtualHeteroClockIntervalRequest(char a1)
{
  ...
  if ( a1 )
  {
    if ( byte_140C124E0 )
    {
      ...
      v4 = (unsigned int)dword_140C124E8;
      byte_140C124E0 = 0;
      if ( dword_140C124E8 )
        PoTraceSystemTimerResolutionKernel(0, dword_140C124E8, 1);
      KiSetClockIntervalToMinimumRequested(v3, v4);
    }
  }
  else if ( !byte_140C124E0 && KiQosHysteresisTimerPeriod )
  {
