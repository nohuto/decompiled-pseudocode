/*
 * XREFs of EtwpEnableKernelTrace @ 0x14078DF64
 * Callers:
 ...
 *     DbgSetDebugPrintCallback @ 0x140583BD0 (DbgSetDebugPrintCallback.c)
...
__int64 __fastcall EtwpEnableKernelTrace(__m128i *a1, char *a2, _QWORD *a3, unsigned int a4)
{
  ...
  char *v21; // rax
  unsigned int v22; // [rsp+38h] [rbp-39h]
...
LABEL_57:
  ...
  {
    v12 |= 0x400u;
    qword_140C545D8 = (__int64)EtwpTraceIoInit;
    LODWORD(v25) = v12;
  }
  v13 = *((_DWORD *)a2 + 4);
  v14 = v26;
  ...
  {
    v14 = v26 | 1;
    qword_140C545E0 = (__int64)EtwpTraceOpticalIo;
    v13 = *((_DWORD *)a2 + 4);
    LODWORD(v26) = v26 | 1;
  }
  if ( (v13 & 2) != 0 )
  {
    v14 |= 2u;
    qword_140C545E8 = (__int64)EtwpTraceOpticalIoInit;
    LODWORD(v26) = v14;
  }
  ...
  {
    v14 |= 0x1000000u;
    qword_140C11EE0 = (__int64)EtwpTraceWdf;
    v15 = *((_DWORD *)a2 + 4);
    LODWORD(v26) = v14;
  }
  if ( (v15 & 0x2000000) != 0 )
  {
    v14 |= 0x2000000u;
    qword_140C11EE8 = (__int64)EtwpTraceWdf;
    LODWORD(v26) = v14;
  }
  if ( (*((_DWORD *)a2 + 2) & 0x8000000) != 0 )
  {
    DWORD2(v25) |= 0x8000000u;
    qword_140C11EF0 = (__int64)EtwpSystemTraceWdf;
  }
  v16 = *(_DWORD *)a2;
...
LABEL_50:
    ...
    if ( (v17 & 0x400) != 0 )
    {
      for ( i = 0; i < EtwpPmcProfile; ++i )
        KeStartProfile((ULONG_PTR)qword_140C19B68 + 248 * i);
      DWORD1(v25) = v8 | 0x400;
    }
...
LABEL_70:
  ...
  while ( v10 );
  EtwpDisableKernelTrace((__int64)v27, (int *)&v25, v23, (_DWORD *)v22);
  return (unsigned int)updated;
}
