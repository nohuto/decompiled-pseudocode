/*
 * XREFs of TtmiLogSessionPowerRequestAcknowledged @ 0x14090673C
 * Callers:
 *     TtmNotifySessionPowerRequestPresent @ 0x1409015A0 (TtmNotifySessionPowerRequestPresent.c)
 * Callees:
  ...
  if ( (unsigned int)dword_140D2D8E8 > 5 )
  {
    if ( tlgKeywordOn((__int64)&dword_140D2D8E8, 1LL) )
    {
      ...
      tlgWriteTransfer_EtwWriteTransfer(
        ...
        (unsigned __int8 *)byte_14002A911,
        0LL,
        0LL,
        0xAu,
        &v21);
