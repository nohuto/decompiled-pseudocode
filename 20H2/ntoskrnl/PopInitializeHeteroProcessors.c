/*
 * XREFs of PopInitializeHeteroProcessors @ 0x1407B5FAC
 * Callers:
 ...
 *     PpmIdleEnableIdleDurationExpirationTimeout @ 0x140564F28 (PpmIdleEnableIdleDurationExpirationTimeout.c)
  ...
  if ( v2 )
  {
    ...
    if ( !v9 )
    {
      ...
      else
      {
        ...
        {
          v30[1] = (unsigned __int16 *)qword_140C11558;
          v31 = 0;
...
LABEL_56:
  ...
  {
    v34[1] = (unsigned __int16 *)qword_140C11278[0];
