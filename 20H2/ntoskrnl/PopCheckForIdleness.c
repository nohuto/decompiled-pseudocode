/*
 * XREFs of PopCheckForIdleness @ 0x140340000
 * Callers:
 *     <none>
 * Callees:
...
__int64 PopCheckForIdleness()
{
  ...
  if ( byte_140C23275 )
  {
    ...
    if ( !PopPlatformAoAc )
    {
      if ( dword_140C2324C )
      {
        dword_140C23248 += PopIdleScanInterval;
        PopDiagTraceIdleCheck(v14, v13, v11);
        if ( !PopPlatformAoAc
          && PopPreSleepNotificationSeconds + 120 <= (unsigned int)dword_140C2324C
          && dword_140C23248 + PopPreSleepNotificationSeconds >= (unsigned int)dword_140C2324C
          && !PopIsAboutToSleep )
        {
          PopIsAboutToSleep = 1;
