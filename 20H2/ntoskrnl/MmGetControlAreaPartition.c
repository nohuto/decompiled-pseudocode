/*
 * XREFs of MmGetControlAreaPartition @ 0x1402B5D60
 * Callers:
...
ULONG_PTR __fastcall MmGetControlAreaPartition(__int64 a1)
{
  ...
  else
  {
    ...
    if ( _interlockedbittestandset(&dword_140C4C800, 0x1Fu) )
    {
      ...
      v22 = ExpWaitForSpinLockExclusiveAndAcquire(&dword_140C4C800, CurrentIrql);
    }
    v5 = dword_140C4C800;
    while ( (v5 & 0xBFFFFFFF) != 0x80000000 )
    {
      if ( (v5 & 0x40000000) == 0 )
      {
        v15 = _InterlockedCompareExchange(&dword_140C4C800, v5 | 0x40000000, v5);
        v14 = v5 == v15;
        v5 = v15;
        if ( !v14 )
          continue;
  ...
  if ( *(_QWORD *)a1 )
    v6 = *(ULONG_PTR **)(qword_140C4E4C8 + 8LL * (*(_WORD *)(*(_QWORD *)a1 + 60LL) & 0x3FF));
  else
