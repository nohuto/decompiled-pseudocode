/*
 * XREFs of PspInitializeSiloStructures @ 0x140A3F044
 * Callers:
 ...
 *     PspSiloInitializeSharedUserSessionId @ 0x1406E42F0 (PspSiloInitializeSharedUserSessionId.c)
...
LABEL_13:
  ...
  qword_140C1DF18 = (__int64)&PspSiloMonitorList;
