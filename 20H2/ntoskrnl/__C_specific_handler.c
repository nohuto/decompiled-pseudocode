/*
 * XREFs of __C_specific_handler @ 0x1403CFB20
 * Callers:
 *     __GSHandlerCheck_SEH @ 0x1403F7890 (__GSHandlerCheck_SEH.c)
 * Callees:
 *     RtlUnwindEx @ 0x1402E5AF0 (RtlUnwindEx.c)
 *     KeCheckStackAndTargetAddress @ 0x140311670 (KeCheckStackAndTargetAddress.c)
 *     _NLG_Notify @ 0x1403D0FF0 (_NLG_Notify.c)
 *     __NLG_Return2 @ 0x1403D1020 (__NLG_Return2.c)
 */
