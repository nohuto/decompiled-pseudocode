/*
 * XREFs of HalpBuildScatterGatherList @ 0x14039F7F4
 * Callers:
 *     HalGetScatterGatherList @ 0x140312E30 (HalGetScatterGatherList.c)
 *     HalBuildScatterGatherListV3 @ 0x14039F770 (HalBuildScatterGatherListV3.c)
 *     HalBuildScatterGatherListEx @ 0x1404C4430 (HalBuildScatterGatherListEx.c)
 *     HalGetScatterGatherListEx @ 0x1404C48E0 (HalGetScatterGatherListEx.c)
 * Callees:
