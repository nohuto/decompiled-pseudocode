/*
 * XREFs of PopInitializeIrpWorkers @ 0x140A73CC0
 * Callers:
...
NTSTATUS PopInitializeIrpWorkers()
{
  ...
  qword_140C20AF8 = (__int64)&PopIrpThreadList;
  PopIrpThreadList = (__int64)&PopIrpThreadList;
  qword_140C232D8 = (__int64)&PopIrpWorkerList;
  PopIrpWorkerList = (__int64)&PopIrpWorkerList;
  qword_140C232F0 = (__int64)&qword_140C232E8;
  qword_140C232E8 = (__int64)&qword_140C232E8;
