/*
 * XREFs of PopIrpWorker @ 0x14039C4D0
 * Callers:
 *     <none>
 * Callees:
 ...
 *     PopFxGetDeviceDStateReason @ 0x14039CB74 (PopFxGetDeviceDStateReason.c)
 *     KiRemoveSystemWorkPriorityKick @ 0x1403F1DD4 (KiRemoveSystemWorkPriorityKick.c)
 *     KeBugCheckEx @ 0x1403FBCA0 (KeBugCheckEx.c)
 *     _guard_dispatch_icall @ 0x140405F40 (_guard_dispatch_icall.c)
 *     PopAcquireIrpWorkerLock @ 0x1405761C0 (PopAcquireIrpWorkerLock.c)
 *     PopReleaseIrpWorkerLock @ 0x1405761DC (PopReleaseIrpWorkerLock.c)
...
NTSTATUS __fastcall PopIrpWorker(struct _KSEMAPHORE **Entry)
{
  ...
  *(_OWORD *)v34.m256i_i8 = (unsigned __int64)KeGetCurrentThread();
  ...
  ++PopIrpWorkerCount;
  if ( *(__int64 **)qword_140C20AF8 != &PopIrpThreadList )
LABEL_61:
    __fastfail(3u);
  *(_QWORD *)&v33 = &PopIrpThreadList;
  *((_QWORD *)&v33 + 1) = qword_140C20AF8;
  *(_QWORD *)qword_140C20AF8 = &v33;
  qword_140C20AF8 = (__int64)&v33;
LABEL_7:
