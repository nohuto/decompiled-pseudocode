/*
 * XREFs of MiProcessWorkingSets @ 0x140268EC0
 * Callers:
...
void __fastcall MiProcessWorkingSets(__int64 a1, __int64 a2)
{
  ...
  v71 = MiComputeSystemTrimCriteria(v3, a2);
  v5 = v71;
  ...
  while ( 2 )
  {
    ...
    *(_QWORD *)(v7 + 88) = *(_QWORD *)(v7 + 80) - *(_QWORD *)(v7 + 96);
    ...
    while ( 1 )
    {
      ...
      *((_WORD *)v14 + 86) = v11;
      v16 = v5 & 0x40;
      if ( (v5 & 0x40) != 0 && (struct _LIST_ENTRY *)v14[12] < Event[2].Header.WaitListHead.Flink )
        break;
...
LABEL_35:
        if ( !v16 || (v24 = 0, (struct _LIST_ENTRY *)v14[12] < Event[2].Header.WaitListHead.Flink) || v14[13] )
          v24 = 1;
        v25 = *((_DWORD *)v14 + 46);
        LOBYTE(v82) = v25;
        if ( v24 )
        {
          ...
          *((_WORD *)v14 + 92) = v82;
          ...
          v27 = *(_QWORD *)(qword_140C4E4C8 + 8 * v26) + 6856LL;
          v28 = *(__int64 ***)(*(_QWORD *)(qword_140C4E4C8 + 8 * v26) + 6864LL);
          if ( *v28 != (__int64 *)v27 )
            goto LABEL_83;
          *v15 = v27;
          v15[1] = (__int64)v28;
...
LABEL_49:
    if ( (v5 & 0x40) != 0 )
    {
      while ( v6 )
      {
        ...
        v46 = v6 - 4;
        v6 = (_QWORD *)*v6;
        *((_WORD *)v46 + 92) = v45 & 0xF9FF;
        MiReturnWsToExpansionList(v46, 1LL);
      }
      v7 = a2;
      v9 = 0LL;
    }
