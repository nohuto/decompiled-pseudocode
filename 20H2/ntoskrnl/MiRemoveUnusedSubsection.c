/*
 * XREFs of MiRemoveUnusedSubsection @ 0x140300DB4
 * Callers:
 ...
 *     MiReduceUnusedSubsectionCount @ 0x140300E40 (MiReduceUnusedSubsectionCount.c)
 */
...
void __fastcall MiRemoveUnusedSubsection(__int64 a1)
{
  ...
  v2 = *(_QWORD *)(qword_140C4E4C8 + 8LL * (*(_WORD *)(*(_QWORD *)a1 + 60LL) & 0x3FF));
