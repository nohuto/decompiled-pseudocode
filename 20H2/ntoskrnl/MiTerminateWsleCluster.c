/*
 * XREFs of MiTerminateWsleCluster @ 0x1402BF020
 * Callers:
...
LABEL_24:
  ...
  if ( (*(_DWORD *)(a1 + 24) & 4) == 0 )
    MiInsertTbFlushEntry((__int64)&v68, v6, *(_QWORD *)(a1 + 16), 0);
LABEL_26:
...
LABEL_29:
  ...
  {
    v39 = 0LL;
    v40 = (2 * (*(_DWORD *)(a1 + 24) & 8)) | 4;
    if ( (*(_DWORD *)(a1 + 24) & 0x10) == 0 )
      v40 = 2 * (*(_DWORD *)(a1 + 24) & 8);
    if ( *(_QWORD *)(a1 + 16) )
    {
      while ( 1 )
      {
        MiDeleteValidSystemPage(v62, v2, v40, (__int64)v67);
        if ( (*(_DWORD *)(a1 + 24) & 4) != 0 )
          break;
LABEL_61:
        ++v39;
...
LABEL_56:
      ...
      if ( qword_140C4DDC0 && (v63 & 0x10) == 0 )
        v46 = v63 & ~qword_140C4DDC0;
      if ( (v46 & 0xFFFFFFFF00000000uLL) == 0 )
        MiInsertTbFlushEntry((__int64)&v68, v6, 1LL, 0);
      goto LABEL_61;
    }
  }
LABEL_30:
