/*
 * XREFs of CmpCreateEmptyHiveClone @ 0x140875598
 * Callers:
...
__int64 __fastcall CmpCreateEmptyHiveClone(_QWORD *a1, __int64 a2)
{
  ...
  v4 = (char *)CmpAllocate(0x12E8uLL, 0, 0x30314D43u);
  v5 = v4;
  if ( v4 )
  {
    ...
    v7 = (void **)(a2 + 1536);
    v8 = 0;
    *((_DWORD *)v5 + 1038) = *(_DWORD *)(a2 + 4152);
    v9 = 2LL;
    while ( 1 )
    {
      if ( *v7 )
      {
        started = ObDuplicateObject(PsInitialSystemProcess, *v7, 0LL, (__int64 *)&v5[8 * v8 + 1536], 0, 512, 2, 0);
        if ( started < 0 )
          break;
      }
      ++v8;
