/*
 * XREFs of VfSuspectDriversGetVerifierInformation @ 0x1409DC8F0
 * Callers:
 ...
 *     VfTargetDriversGetZeroCounters @ 0x1409D9EA4 (VfTargetDriversGetZeroCounters.c)
  ...
  *a3 = 0;
  ...
  if ( (__int64 *)VfSuspectDriversList != &VfSuspectDriversList )
  {
    while ( 1 )
    {
      ...
      *(_DWORD *)(v6 + 40) = dword_140C2A6E4;
      *(_DWORD *)(v6 + 44) = dword_140C2A6E8;
      *(_DWORD *)(v6 + 92) = dword_140C2A718;
      *(_DWORD *)(v6 + 48) = dword_140C2A6EC;
      *(_DWORD *)(v6 + 52) = dword_140C2A6F0;
      *(_DWORD *)(v6 + 56) = dword_140C2A6F4;
      *(_DWORD *)(v6 + 60) = dword_140C2A6F8;
      *(_DWORD *)(v6 + 64) = dword_140C2A6FC;
      *(_DWORD *)(v6 + 68) = dword_140C2A700;
      *(_DWORD *)(v6 + 72) = dword_140C2A704;
      *(_DWORD *)(v6 + 76) = dword_140C2A708;
      *(_DWORD *)(v6 + 80) = dword_140C2A70C;
