/*
 * XREFs of HalpIrtInitializeDeviceApertures @ 0x1408682CC
 * Callers:
...
__int64 HalpIrtInitializeDeviceApertures()
{
  ...
  v1 = 0;
  qword_140C49768 = (__int64)&HalpIrtAllocatedDeviceAperturesHead;
  HalpIrtAllocatedDeviceAperturesHead = (__int64)&HalpIrtAllocatedDeviceAperturesHead;
  qword_140C49998 = (__int64)&HalpIrtFreeDeviceAperturesHead;
