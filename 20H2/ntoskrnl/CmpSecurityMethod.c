/*
 * XREFs of CmpSecurityMethod @ 0x14066EFA0
 * Callers:
 *     <none>
 * Callees:
...
LABEL_8:
        ...
        *((_QWORD *)&v26 + 1) = a3;
        *(_QWORD *)&v26 = a1;
        v18 = CmpCallCallBacksEx(v16, (__int64)&v26, 0LL, 1, v17, (__int64)a1, (__int64)v24);
        v19 = v18;
        if ( v18 < 0 )
        {
          if ( v18 == -1073740541 )
...
LABEL_14:
  ...
  if ( (_DWORD)BugCheckParameter4 == 1 )
  {
    v21 = 37;
LABEL_18:
    v19 = CmPostCallbackNotificationEx(v21, (__int64)a1, v19, (__int64)&v26, 0LL, v24);
    goto LABEL_19;
  }
  if ( !(_DWORD)BugCheckParameter4 )
  {
