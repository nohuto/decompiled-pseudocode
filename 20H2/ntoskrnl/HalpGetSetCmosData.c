/*
 * XREFs of HalpGetSetCmosData @ 0x1404CA8BC
 * Callers:
 ...
 *     HalpSetCmosData @ 0x1404CA980 (HalpSetCmosData.c)
 * Callees:
 *     HalpAcquireCmosSpinLock @ 0x140312D1C (HalpAcquireCmosSpinLock.c)
 *     HalpCmosReadByte @ 0x140365000 (HalpCmosReadByte.c)
 *     HalpCmosWriteByte @ 0x140365020 (HalpCmosWriteByte.c)
...
__int64 __fastcall HalpGetSetCmosData(__int64 a1, __int64 a2, __int64 a3, int a4, char a5)
{
  ...
  if ( v6 <= v10 )
  {
    if ( a5 )
    {
      ...
      {
        LOBYTE(v11) = *v5;
        ((void (__fastcall *)(_QWORD, __int64))funcs_1404CA932[v9])(v8, v11);
        ++v5;
        ++v8;
      }
      while ( v8 <= v10 );
    ...
    {
      do
        *v5++ = ((__int64 (__fastcall *)(_QWORD))funcs_1404CA917[v9])(v8++);
      while ( v8 <= v10 );
    }
  }
