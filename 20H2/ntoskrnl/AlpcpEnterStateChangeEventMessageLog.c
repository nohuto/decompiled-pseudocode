/*
 * XREFs of AlpcpEnterStateChangeEventMessageLog @ 0x1408C5414
 * Callers:
 ...
 *     AlpcpAllocateSnapshotMessageLog @ 0x1408C51D0 (AlpcpAllocateSnapshotMessageLog.c)
 *     AlpcpLocateMessageLog @ 0x1408C55C4 (AlpcpLocateMessageLog.c)
 */
...
char __fastcall AlpcpEnterStateChangeEventMessageLog(__int64 a1)
{
  ...
  if ( MessageLog )
  {
      ...
      || memcmp((const void *)(v5 + 80), (const void *)(a1 + 240), 0x28uLL) )
    {
      ...
      if ( !*(_DWORD *)(v3 + 44) )
      {
        v8 = (__int64 *)qword_140C2A868;
        if ( *(__int64 **)qword_140C2A868 == &AlpcpFreeMessageSnapshotListHead )
        {
