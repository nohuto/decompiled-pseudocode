/*
 * XREFs of IopInitializeDeviceInstanceKey @ 0x140748194
 * Callers:
 ...
 *     PnpClearDeviceTemporaryProperties @ 0x140747EA4 (PnpClearDeviceTemporaryProperties.c)
 *     IopIsRootEnumeratedDeviceObjectActive @ 0x1407484C4 (IopIsRootEnumeratedDeviceObjectActive.c)
...
LABEL_19:
              ...
              {
                if ( v17 )
                  PpDevCfgProcessDevice((__int64)v13, KeyHandle, v14);
                else
