/*
 * XREFs of KiFindNextTimerDueTime @ 0x140285090
 * Callers:
  ...
  while ( 1 )
  {
    ...
    while ( 2 )
    {
      ...
      while ( 1 )
      {
        ...
        {
          v39 = (_QWORD *)(qword_140CFD7A8[0] + 8 * (v37 >> 6));
          v40 = ((1LL << (v37 & 0x3F)) - 1) | ~*v39;
          if ( v40 == -1 )
          {
            while ( (unsigned __int64)++v39 <= qword_140CFD7A8[0] + 8 * (v38 >> 6) )
            {
              v40 = ~*v39;
              if ( *v39 )
                goto LABEL_48;
...
LABEL_48:
          ...
          v41 = v40 + (((__int64)v39 - qword_140CFD7A8[0]) >> 3 << 6);
          if ( v41 > v38 )
            goto LABEL_64;
          if ( v41 != -1LL )
            break;
