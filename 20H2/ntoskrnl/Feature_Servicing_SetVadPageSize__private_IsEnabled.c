/*
 * XREFs of Feature_Servicing_SetVadPageSize__private_IsEnabled @ 0x1403F2038
 * Callers:
...
__int64 Feature_Servicing_SetVadPageSize__private_IsEnabled()
{
  ...
  CachedFeatureEnabledState = wil_details_FeatureStateCache_GetCachedFeatureEnabledState(
                                (unsigned int *)&Feature_Servicing_SetVadPageSize__private_featureState,
                                (__int64)&Feature_Servicing_SetVadPageSize__private_descriptor);
  v1 = (CachedFeatureEnabledState >> 3) & 1;
  wil_details_FeatureReporting_ReportUsageToService(
    (int)&Feature_Servicing_SetVadPageSize__private_reporting,
    0x24F155Eu,
