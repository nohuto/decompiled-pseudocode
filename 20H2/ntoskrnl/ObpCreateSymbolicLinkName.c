/*
 * XREFs of ObpCreateSymbolicLinkName @ 0x1406DA1E4
 * Callers:
 ...
 *     OBP_GET_SILO_ROOT_DIRECTORY_FROM_SILO @ 0x14023DEF8 (OBP_GET_SILO_ROOT_DIRECTORY_FROM_SILO.c)
...
void __fastcall ObpCreateSymbolicLinkName(__int64 a1)
{
  ...
  int v27; // eax
  bool v28; // zf
  __m128i v29; // [rsp+38h] [rbp-49h]
  __m128i v30; // [rsp+48h] [rbp-39h] BYREF
  __int64 v31[2]; // [rsp+58h] [rbp-29h] BYREF
  __int64 v32; // [rsp+68h] [rbp-19h]
  int v33; // [rsp+70h] [rbp-11h]
  __int16 v34; // [rsp+74h] [rbp-Dh]
  __int16 v35; // [rsp+76h] [rbp-Bh]
  int v36; // [rsp+78h] [rbp-9h]
  int v37; // [rsp+7Ch] [rbp-5h]
  int v39; // [rsp+F0h] [rbp+6Fh]
  struct _DMA_ADAPTER *v40; // [rsp+F8h] [rbp+77h]
...
LABEL_15:
      ...
      v19 = ObpLookupDirectoryEntryEx(v15, (unsigned __int16 *)&v30, 0, 0LL, 0, (__int64)v31);
      v20 = v19;
      if ( v15 == v40 )
      {
        LOBYTE(v35) = v9;
...
LABEL_42:
  ObpReleaseLookupContext((__int64)v31);
