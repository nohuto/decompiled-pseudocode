/*
 * XREFs of RtlQueryAllFeatureConfigurations @ 0x14091B7F0
 * Callers:
 *     <none>
 * Callees:
 *     RtlpFcValidateFeatureConfigurationType @ 0x14038C1B0 (RtlpFcValidateFeatureConfigurationType.c)
        ...
        PSIZE_T ConfigurationCount)
{
  ...
  RtlpFcBufferManagerReferenceBuffers((__int64)qword_140C48010, (__int64)v13, &v12);
  ...
  RtlpFcBufferManagerDereferenceBuffers((__int64)qword_140C48010, v9);
