...
LABEL_58:
    ...
    if ( (_DWORD)Size )
    {
      if ( *((_QWORD *)&CmpRegistryProcess + 1) && (v13 || !(unsigned __int8)CmpIsBufferGloballyVisible(a4)) )
      {
        ...
        if ( (unsigned int)Size > 0x40uLL )
        {
          ...
          {
            ++dword_140CDB618;
            v33 = (PSLIST_ENTRY)((__int64 (__fastcall *)(_QWORD, _QWORD, _QWORD, union _SLIST_HEADER *))qword_140CDB630)(
...
LABEL_67:
    ...
    if ( v14 >= 0 )
    {
      ...
      ValueKey = CmQueryValueKey((_DWORD)v55, (unsigned int)&v77, v46, Src[1], Size, (__int64)&v49);
      v14 = ValueKey;
      v41 = ValueKey;
...
LABEL_69:
        ...
        v28 = CmQueryValueKey((_DWORD)DmaAdapter, (unsigned int)&v78, v46, Src[1], Size, (__int64)&v49);
        v14 = v28;
        v41 = v28;
