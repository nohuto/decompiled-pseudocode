/*
 * XREFs of IommuDomainAttachDevice @ 0x1404D89D0
 * Callers:
 *     <none>
 * Callees:
      ...
      if ( v11 >= 0 )
      {
        ...
        if ( v14 )
        {
          ...
          *(_QWORD *)(v14 + 48) = v10;
          ...
          v19 = (_QWORD *)qword_140C48B68;
          if ( *(__int64 **)qword_140C48B68 != &HalpIommuParaVirtDeviceCache )
            __fastfail(3u);
          *v15 = &HalpIommuParaVirtDeviceCache;
          v15[1] = v19;
          *v19 = v15;
          qword_140C48B68 = (__int64)v15;
