/*
 * XREFs of SPCallServerHandleWaitForDisplayWindow @ 0x140788F9C
 * Callers:
...
LABEL_9:
  if ( (v8 & 0x80000000) == 0 )
  {
    ...
    v10 = ((__int64 (__fastcall *)(UNICODE_STRING *, int *, int *, __int64, LARGE_INTEGER *))qword_140D2D4B8)(
            &DestinationString,
            &v44,
            &v43,
            4LL,
    ...
    do
    {
      v11 = KeWaitForSingleObject(&stru_140C13CE0, UserRequest, 1, 1u, 0LL);
      v12 = v11;
    }
    while ( v11 == 257 );
    if ( v11 >= 0 && v11 != 192 )
    {
      do
      {
        v19 = KeWaitForSingleObject(&stru_140C13D00, UserRequest, 1, 1u, 0LL);
        v12 = v19;
      }
      while ( v19 == 257 );
