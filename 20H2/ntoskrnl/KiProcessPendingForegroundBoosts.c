/*
 * XREFs of KiProcessPendingForegroundBoosts @ 0x1402E9570
 * Callers:
 *     <none>
 * Callees:
        ...
        PVOID SystemArgument2)
{
  ...
  _SINGLE_LIST_ENTRY v24; // [rsp+28h] [rbp-30h] BYREF
  ...
  v7 = (__int64 *)qword_140C31D88;
  while ( v7 != &qword_140C31D88 )
  {
    v8 = v7;
    v7 = (__int64 *)*v7;
    v9 = v6 - *((_DWORD *)v8 - 2);
  ...
  v12 = qword_140C31D88 != (_QWORD)&qword_140C31D88;
  ...
  while ( v4 )
  {
    ...
    _InterlockedAdd16((volatile signed __int16 *)v17 + 434, 0xFFFFu);
  }
