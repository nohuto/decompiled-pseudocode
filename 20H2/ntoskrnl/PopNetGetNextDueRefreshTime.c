/*
 * XREFs of PopNetGetNextDueRefreshTime @ 0x1408F45B4
 * Callers:
...
LARGE_INTEGER PopNetGetNextDueRefreshTime()
{
  ...
  if ( qword_140C23268
    && MEMORY[0xFFFFF78000000014] < qword_140C23268
    && qword_140C23268 - MEMORY[0xFFFFF78000000014] >= 1200000000 )
  {
    return (LARGE_INTEGER)(qword_140C23268 - 1200000000);
  }
  else
  {
