/*
 * XREFs of sub_140965874 @ 0x140965874
 * Callers:
...
__int64 __fastcall sub_140965874(__int64 a1, __int64 a2, __int64 a3, __int64 a4)
{
  __int64 v4; // rbp
  unsigned int v7; // r8d
  unsigned int *v8; // rdx
...
LABEL_17:
  ...
  if ( v19 )
    v20 = v8 + 1;
  v21 = qword_140D2D3B8 ? qword_140D2D3B8(v20, v19) : -1073741637;
  v22 = *(_DWORD *)(a2 + 32);
