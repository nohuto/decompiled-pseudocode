/*
 * XREFs of HalpPowerWriteResetCommand @ 0x1404BC94C
 * Callers:
 ...
 *     HalpMiscIsLegacyPcType @ 0x140385C34 (HalpMiscIsLegacyPcType.c)
...
void __fastcall __noreturn HalpPowerWriteResetCommand(int a1, volatile signed __int32 *a2)
{
  ...
  if ( !a1 )
  {
    ...
    if ( byte_140C49060 )
    {
      HalpAcpiPmRegisterWrite(8, 0, (__int64)&unk_140C49F20, 1u, 0LL);
