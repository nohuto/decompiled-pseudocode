        ...
        PULONG ResultLength)
{
  ...
  *(_OWORD *)Src = 0LL;
  ...
  if ( v20 < 0 || (v20 = CmpBounceContextStart(Src, KeyInformation, v13, v11, 0), v20 < 0) )
  {
    v8 = Index;
LABEL_48:
    v21 = DmaOperations;
  ...
  v8 = Index;
  v20 = CmEnumerateKey((_DWORD)DmaAdapter, (_DWORD)v31, Index, KeyInformationClass, (__int64)Src[1], v13, (__int64)v29);
