/*
 * XREFs of NtEnumerateKey @ 0x140676B10
 * Callers:
        ...
        _DWORD *a6)
{
  ...
  _DWORD v29[4]; // [rsp+58h] [rbp-1A0h] BYREF
  ...
  *(_OWORD *)Src = 0LL;
  ...
  if ( a3 > 2 )
  {
    if ( *(BOOLEAN **)((char *)&NlsMbCodePageTag + 7)
      ...
      && (PreviousMode = KeGetCurrentThread()->PreviousMode,
          v33 = 0LL,
          ObReferenceObjectByHandle(Handle, 0, (POBJECT_TYPE)CmKeyObjectType, PreviousMode, &v33, 0LL) >= 0) )
    {
  ...
  v44[8] = 0LL;
  Object = 0LL;
  v20 = ObReferenceObjectByHandle(Handle, 8u, (POBJECT_TYPE)CmKeyObjectType, v11, &Object, 0LL);
  ...
  v20 = CmKeyBodyRemapToVirtualForEnum((__int64 *)&DmaAdapter, v11, 8, &v31);
  if ( v20 < 0 || (v20 = CmpBounceContextStart(Src, a4, v13, v11, 0), v20 < 0) )
  {
    v8 = a2;
LABEL_48:
    v21 = DmaOperations;
  ...
  v8 = a2;
  v20 = CmEnumerateKey((_DWORD)DmaAdapter, (_DWORD)v31, a2, a3, (__int64)Src[1], v13, (__int64)v29);
