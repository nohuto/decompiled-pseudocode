/*
 * XREFs of IopSendMessageToTrackService @ 0x140894B00
 * Callers:
  ...
  while ( 1 )
  {
    if ( !IopLinkTrackingServiceObject )
    {
      ...
      else
      {
        ...
        KeResetEvent(&stru_140C45E20);
        ExQueueWorkItem(&IopLinkTrackingPacket, DelayedWorkQueue);
        v9 = KeWaitForSingleObject(&stru_140C45E20, Executive, PreviousMode, 0, 0LL);
        v10 = v9;
        if ( v9 != 192 && v9 != 257 && dword_140C45E38 < 0 )
          v10 = dword_140C45E38;
        KeSetEvent(&IopLinkTrackingPortObject, 0, 0);
        if ( v10 )
          return v10;
