/*
 * XREFs of HalpInterruptUnmap @ 0x14075D048
 * Callers:
 *     HalpTimerUnmapInterrupt @ 0x1404BEBB8 (HalpTimerUnmapInterrupt.c)
 *     HaliRemoveInterruptRemapping @ 0x14075D020 (HaliRemoveInterruptRemapping.c)
 * Callees:
 *     HalpInterruptIsHvLineBasedIntRemappingSupported @ 0x14036D140 (HalpInterruptIsHvLineBasedIntRemappingSupported.c)
 ...
 *     HalpSetIrtEntry @ 0x1404CFBA8 (HalpSetIrtEntry.c)
