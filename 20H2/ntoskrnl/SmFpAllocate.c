/*
 * XREFs of SmFpAllocate @ 0x140358D98
 * Callers:
 ...
 *     ?SmStMapPhysicalRegion@?$SMKM_STORE@USM_TRAITS@@@@SAPEAXPEAU1@KKKK@Z @ 0x140597B38 (-SmStMapPhysicalRegion@-$SMKM_STORE@USM_TRAITS@@@@SAPEAXPEAU1@KKKK@Z.c)
 * Callees:
...
LABEL_7:
  ...
  if ( a2 == 2 )
  {
    MdlForLock = SmKmAllocateMdlForLock((unsigned __int64)*((unsigned __int16 *)SpinLock + 46) << 12);
    goto LABEL_6;
  }
  if ( a2 == 3 )
  {
