/*
 * XREFs of IoCreateDevice @ 0x1405D91C0
 * Callers:
 ...
 *     KeInitializeDeviceQueue @ 0x140379740 (KeInitializeDeviceQueue.c)
...
LABEL_18:
    ...
    *(_DWORD *)&v13[3].Version = 128;
    ...
    inserted = ObInsertObjectEx(v13, 0, (__int64)&DmaAdapter, (__int64)&Handle);
    Vpb = inserted;
    if ( inserted >= 0 )
    {
