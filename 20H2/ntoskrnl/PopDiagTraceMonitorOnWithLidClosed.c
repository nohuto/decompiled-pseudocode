/*
 * XREFs of PopDiagTraceMonitorOnWithLidClosed @ 0x1408ED264
 * Callers:
...
void PopDiagTraceMonitorOnWithLidClosed()
{
  ...
  if ( !PopLidOpened && !PopConsoleExternalDisplayConnected && (unsigned int)dword_140C021E8 > 5 )
  {
    if ( tlgKeywordOn((__int64)&dword_140C021E8, 0x400000000000LL) )
    {
      ...
      v16 = 1LL;
      v18 = 8LL;
      tlgWriteTransfer_EtwWriteTransfer((__int64)&dword_140C021E8, (unsigned __int8 *)word_1400269A2, 0LL, 0LL, 7u, &v8);
    }
  }
}
