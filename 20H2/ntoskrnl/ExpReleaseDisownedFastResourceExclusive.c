/*
 * XREFs of ExpReleaseDisownedFastResourceExclusive @ 0x1405B3090
 * Callers:
 ...
 *     KeAbCrossThreadRelease @ 0x14038E2B0 (KeAbCrossThreadRelease.c)
...
LABEL_8:
  ...
  KxAcquireQueuedSpinLock((__int64)&LockHandle, v10);
  ExpPrepareToWakeResourceExclusive(a1, &v31, &v30, &v29);
  v17 = (_QWORD *)(a2 + 56);
  v18 = *(_QWORD *)(a2 + 56);
  v19 = *(_QWORD **)(a2 + 64);
  ...
  *(_QWORD *)(a2 + 48) = 0LL;
  KeReleaseInStackQueuedSpinLockFromDpcLevel(&v28);
  KeWakeWaitChain(&v31, 0LL, 2 * (unsigned int)(v30 != 0) + 1, v22);
  if ( KiIrqlFlags )
  {
    if ( (KiIrqlFlags & 1) != 0 )
    {
