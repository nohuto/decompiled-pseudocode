/*
 * XREFs of MiChangePageAttributeContiguous @ 0x14032DB94
 * Callers:
...
__int64 __fastcall MiChangePageAttributeContiguous(__int64 a1, __int64 a2, __int64 a3, __int64 SchedulerAssist)
{
  ...
  while ( v6 < v7 )
  {
    ...
    if ( v6 < v7 )
    {
      ...
      if ( !v10 )
      {
        MiFlushEntireTbDueToAttributeChange(a1, a2, a3, SchedulerAssist);
        if ( v8 >= dword_140C4DD8C && v5 != 1 )
        {
          ++dword_140C4DD84;
