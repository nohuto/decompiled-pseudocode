/*
 * XREFs of ExpSaPageGroupFreeMemory @ 0x1403940EC
 * Callers:
...
bool __fastcall ExpSaPageGroupFreeMemory(__int64 a1, unsigned __int64 a2, unsigned int a3)
{
  ...
  if ( v11 )
  {
    if ( v3 >= 0xFFFF800000000000uLL && byte_140C4F848[((v3 >> 39) & 0x1FF) - 256] == 1 )
...
LABEL_31:
  ...
  {
    v22 = &v16->152;
    if ( ($C774EFD68449142D8271B1EC1EB7FB26 *)v22->ApcState.ApcListHead[0].Flink != v22 )
