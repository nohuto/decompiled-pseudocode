/*
 * XREFs of PopPowerAggregatorRecordIntent @ 0x140771FB0
 * Callers:
 ...
 *     PopPowerAggregatorAreTargetStatesEqual @ 0x1408F07D4 (PopPowerAggregatorAreTargetStatesEqual.c)
 */
        ...
        int a7)
{
  ...
  v13 = (char *)&unk_140C21780 + 144 * (((unsigned __int8)dword_140C21778 - 1) & 0x1F);
  if ( *(_DWORD *)v13 != 1
    || *((_DWORD *)v13 + 6) != a2
    || *((_DWORD *)v13 + 8) != a4
    || *((_DWORD *)v13 + 34) != v9
