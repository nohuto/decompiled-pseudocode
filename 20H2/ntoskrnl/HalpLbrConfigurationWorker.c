/*
 * XREFs of HalpLbrConfigurationWorker @ 0x1408691AC
 * Callers:
 *     HalpLbrConfigureRecording @ 0x140869220 (HalpLbrConfigureRecording.c)
 *     HalpLbrStartRecording @ 0x140869260 (HalpLbrStartRecording.c)
 *     HalpLbrStopRecording @ 0x140869310 (HalpLbrStopRecording.c)
 * Callees:
