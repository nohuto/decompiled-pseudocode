/*
 * XREFs of EtwpTraceStackWalk @ 0x1405A5704
 * Callers:
 *     EtwpStackTraceDispatcher @ 0x1405A54D0 (EtwpStackTraceDispatcher.c)
 *     EtwpStackWalkApc @ 0x1405A5630 (EtwpStackWalkApc.c)
 * Callees:
...
void __fastcall EtwpTraceStackWalk(__int64 a1, unsigned int a2, __int64 a3, _QWORD *a4)
{
  ...
  struct _KPRCB *v27; // [rsp+618h] [rbp+8h] BYREF
  unsigned __int64 v28; // [rsp+620h] [rbp+10h] BYREF
  ...
  v32 = 0LL;
  v31 = 0LL;
  if ( !KeQueryCurrentStackInformation((char *)&v26, &v27, &v28) )
    return;
  if ( v26 <= 9 )
  {
    v6 = 929;
  ...
  {
    if ( (unsigned __int64)(KeGetCurrentStackPointer() - (char *)v27) <= 0x1438 )
      return;
    v10 = alloca(1536LL);
