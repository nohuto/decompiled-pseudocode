/*
 * XREFs of MiInitializeWorkingSetManagerParameters @ 0x1403CB334
 * Callers:
  ...
  if ( v4 == 1 )
  {
    ...
    *(_QWORD *)(v2 + 104) = v2 + 104;
    if ( (ULONG_PTR *)a1 != &MiSystemPartition )
      goto LABEL_32;
    LOWORD(stru_140C4ECD0.Header.Lock) = 0;
    stru_140C4ECD0.Header.SignalState = 0;
    stru_140C4ECD0.Header.WaitListHead.Blink = &stru_140C4ECD0.Header.WaitListHead;
    stru_140C4ECD0.Header.WaitListHead.Flink = &stru_140C4ECD0.Header.WaitListHead;
    stru_140C4ECD0.Header.Size = 6;
  }
