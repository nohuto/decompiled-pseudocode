/*
 * XREFs of Feature_Servicing_2206c_38536160__private_IsEnabled @ 0x1403F6778
 * Callers:
...
__int64 Feature_Servicing_2206c_38536160__private_IsEnabled()
{
  ...
  CachedFeatureEnabledState = wil_details_FeatureStateCache_GetCachedFeatureEnabledState(
                                (unsigned int *)&Feature_Servicing_2206c_38536160__private_featureState,
                                (__int64)&wil_details_featureDescriptors_a);
  v1 = (CachedFeatureEnabledState >> 3) & 1;
  wil_details_FeatureReporting_ReportUsageToService(
    (int)&Feature_Servicing_2206c_38536160__private_reporting,
    0x24C03E0u,
