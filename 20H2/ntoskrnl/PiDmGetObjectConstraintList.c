/*
 * XREFs of PiDmGetObjectConstraintList @ 0x1406ED5D0
 * Callers:
 *     PiDmGetCmObjectConstraintListFromCache @ 0x1406ED53C (PiDmGetCmObjectConstraintListFromCache.c)
 * Callees:
        ...
        unsigned int *a7)
{
  ...
  *a7 = 0;
  ...
  else
  {
    ...
    *(_QWORD *)&v17 = v9;
    *((_QWORD *)&v17 + 1) = v8;
    v13 = PiDmListEnumObjectsWithCallback(a1, (ULONG_PTR)P, PiDmGetObjectListCallback, (__int64)&v16);
    if ( v13 < 0 )
      goto LABEL_10;
    *v7 = HIDWORD(v17);
  }
