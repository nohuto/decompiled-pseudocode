/*
 * XREFs of SeAccessCheckWithHintWithAdminlessChecks @ 0x140223E30
 * Callers:
...
LABEL_20:
  ...
  *v12 = 0;
  PrimaryToken = (char *)a3->ClientToken;
  if ( !a3->ClientToken )
    PrimaryToken = (char *)a3->PrimaryToken;
  if ( (a2 & 4) == 0 )
  {
    v25 = SepFilterCheck(v13, (unsigned int)&P, (_DWORD)PrimaryToken, 0, (__int64)&v153);
    v26 = v136;
    *v136 = v25;
    if ( v25 < 0 )
      goto LABEL_183;
    ...
    *v26 = -1073741790;
    if ( v84 )
      SeLogAccessFailure((_DWORD)PrimaryToken, 0, 0, 0, v13, v132 | a5, 0, 0);
    if ( v127 )
      return 0;
LABEL_155:
...
LABEL_27:
  ...
  LOBYTE(v19) = 1;
  if ( (*((_DWORD *)PrimaryToken + 50) & 0x2000) != 0 )
    v27 = 1;
  else
LABEL_29:
    v27 = 0;
  v134 = v27;
  v131 = 0;
  if ( !SepAllowAccessUponLogoff && (*((_DWORD *)PrimaryToken + 50) & 0x20) == 0 )
  {
    v88 = *((_QWORD *)PrimaryToken + 27);
    if ( v88 )
    {
  ...
  if ( !v27 )
  {
    v29 = SepMandatoryIntegrityCheck(v152, v13, v19, (_DWORD)PrimaryToken, 0, a12, (__int64)&v151);
    v30 = v136;
    *v136 = v29;
    if ( v29 < 0 )
      goto LABEL_183;
    ...
    {
      *v30 = -1073741790;
      if ( (*((_DWORD *)PrimaryToken + 50) & 0x4000) == 0 || HIDWORD(v151) > 0x2000 )
      {
        if ( v127 )
          return 0;
        goto LABEL_155;
    ...
    {
      *v30 = 0;
      if ( (a5 & 0x2000000) == 0 || (*((_DWORD *)PrimaryToken + 50) & 0x4000) == 0 || HIDWORD(v151) > 0x2000 )
      {
LABEL_36:
        v28 = a12;
        goto LABEL_37;
...
LABEL_39:
  ...
  if ( PrimaryToken == (char *)-232LL || !v32 )
    goto LABEL_68;
  v34 = v32[1];
  ...
  while ( 2 )
  {
    ...
    if ( !(_BYTE)v40 )
      goto LABEL_135;
    v42 = (_WORD *)*((_QWORD *)PrimaryToken + 30);
    ...
    while ( 2 )
    {
      ...
      if ( **(_WORD **)v43 == (_WORD)v35 )
      {
        ...
        {
LABEL_51:
          if ( v43 == *((_WORD **)PrimaryToken + 30) && (*((_DWORD *)v43 + 2) & 0x10) == 0
            || (*((_DWORD *)v43 + 2) & 4) != 0 )
          {
            if ( *((_DWORD *)PrimaryToken + 32) )
...
LABEL_66:
  ...
  if ( *v33 > 0x40 )
  {
    v95 = (_WORD *)*((_QWORD *)PrimaryToken + 30);
    v96 = 64;
    v135 = 64;
    v150 = v95;
    do
...
LABEL_70:
  ...
  v50 = v132;
LABEL_71:
  if ( !v14 && !v31 && ((*((_DWORD *)PrimaryToken + 50) & 0x2000) != 0 || !v48) )
  {
    if ( !v127 )
  ...
  while ( 2 )
  {
    ...
    if ( *(_QWORD *)(v100 + 24) )
    {
      ...
      v104 = (_QWORD *)*((_QWORD *)PrimaryToken + 137);
      if ( v104 )
      {
        v105 = v104[75];
        v106 = v104[73];
      ...
      if ( v141 != 1 )
      {
        ...
        if ( (*((_DWORD *)PrimaryToken + 50) & 0x10) != 0 )
        {
          v112 = (_QWORD *)*((_QWORD *)PrimaryToken + 137);
          if ( v112 )
          {
            v113 = v112[75];
            v114 = v112[73];
...
LABEL_166:
  ...
  if ( PrimaryToken )
  {
    if ( ((_BYTE)v56
       || v61
       || !HIDWORD(v158[0]) && (*((_DWORD *)PrimaryToken + 50) & 0x4000) != 0 && (*v59 < 0 || BYTE7(v158[1])))
      && !v145 )
    {
      v77 = *v59 >= 0;
      v78 = v132 | v14;
      v79 = SepLocateTokenTrustLevel(v52);
      SeLogAccessFailure((_DWORD)PrimaryToken, 0, 0, v79, v13, v78, v77, 0);
      v57 = v137;
      v59 = v136;
    }
    if ( *v59 < 0 && !HIDWORD(v158[0]) && (*((_DWORD *)PrimaryToken + 50) & 0x4000) != 0 )
    {
      if ( BYTE8(v158[1]) )
      {
