/*
 * XREFs of SecureDump_Get_SecureDumpHeader @ 0x140508D60
 * Callers:
...
__int64 __fastcall SecureDump_Get_SecureDumpHeader(__int64 a1, _DWORD *a2, unsigned int a3)
{
  ...
  *((_QWORD *)a2 + 11) = 0LL;
  ...
  a2[5] = 4184;
  a2[4] = pcbResult;
  memmove(a2 + 1046, qword_140C4C6F8, pcbResult);
  v7 = a2[4] + a2[5];
  a2[10] = pbInput;
  v8 = dword_140C4C718;
  a2[7] = v7;
