/*
 * XREFs of NtSetSystemInformation @ 0x1406F5A80
 * Callers:
 ...
 *     MmLoadSystemImage @ 0x140754BE0 (MmLoadSystemImage.c)
 ...
 *     CmSetRegistryQuotaInformation @ 0x14086DA10 (CmSetRegistryQuotaInformation.c)
 ...
 *     HvlSetEnlightenmentInfo @ 0x140891010 (HvlSetEnlightenmentInfo.c)
 ...
 *     ExpSetProcessorMicrocodeUpdateInformation @ 0x14094DB44 (ExpSetProcessorMicrocodeUpdateInformation.c)
 ...
 *     VfRemoveVerifierEntry @ 0x1409EFBC4 (VfRemoveVerifierEntry.c)
    ...
    if ( v5 <= 159 )
    {
      ...
      if ( v5 > 129 )
      {
        ...
        *(_OWORD *)&CriticalProcessExceptionData = v118;
        xmmword_140C196D0 = v119;
        xmmword_140C196E0 = v120;
        return 0;
      }
      if ( v5 == 129 )
  ...
  if ( v5 > 56 )
  {
    if ( v5 <= 82 )
    {
      ...
      if ( (unsigned int)(*(_DWORD *)(v4 + 16) - 1) > 0x1E )
        return 3221225485LL;
      v116 = *(_OWORD *)v4;
      updated = PsLookupProcessThreadByCid((__int64)&v116, 0LL, &DmaAdapter);
      if ( (updated & 0x80000000) == 0 )
      {
        v42 = DmaAdapter;
        ...
        {
          KeSetActualBasePriorityThread((__int64)DmaAdapter, *(_DWORD *)(v4 + 16), v40, v41);
          updated = 259;
        }
        v43 = v42;
LABEL_199:
