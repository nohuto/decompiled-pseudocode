    ...
    if ( v5 <= SystemHypervisorDetailInformation )
    {
      ...
      if ( v5 > SystemProcessorProfileControlArea )
      {
        ...
        *(_OWORD *)&CriticalProcessExceptionData = v117;
        xmmword_140C196D0 = v118;
        xmmword_140C196E0 = v119;
        return 0;
      }
      if ( v5 == SystemProcessorProfileControlArea )
  ...
  if ( v5 > SystemPrefetcherInformation )
  {
    if ( v5 <= SystemThreadPriorityClientIdInformation )
    {
      ...
      if ( (unsigned int)(*(_DWORD *)(v4 + 16) - 1) > 0x1E )
        return -1073741811;
      v115 = *(_OWORD *)v4;
      updated = PsLookupProcessThreadByCid((__int64)&v115, 0LL, &DmaAdapter);
      if ( updated >= 0 )
      {
        v41 = DmaAdapter;
        ...
        {
          KeSetActualBasePriorityThread((__int64)DmaAdapter, *(_DWORD *)(v4 + 16), v39, v40);
          updated = 259;
        }
        v42 = v41;
LABEL_199:
