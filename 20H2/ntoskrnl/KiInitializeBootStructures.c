/*
 * XREFs of KiInitializeBootStructures @ 0x14099E840
 * Callers:
 ...
 *     HalInitializeProcessor @ 0x1403A7FA0 (HalInitializeProcessor.c)
 ...
 *     KiSaveInitialProcessorControlState @ 0x1403FBED0 (KiSaveInitialProcessorControlState.c)
 *     KiGetProcessorSignature @ 0x14099E588 (KiGetProcessorSignature.c)
 *     KiInitializeNXSupport @ 0x14099E70C (KiInitializeNXSupport.c)
 *     ExInitPoolLookasidePointers @ 0x14099EC88 (ExInitPoolLookasidePointers.c)
 ...
 *     InitializeBuildStrings @ 0x140A3BEBC (InitializeBuildStrings.c)
