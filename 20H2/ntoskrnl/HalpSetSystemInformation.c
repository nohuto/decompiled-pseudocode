/*
 * XREFs of HalpSetSystemInformation @ 0x14072F190
 * Callers:
 *     <none>
 * Callees:
 ...
 *     HalpTimerGetProfilingHandler @ 0x1404BFE68 (HalpTimerGetProfilingHandler.c)
 *     HalpTimerSetProfilingHandler @ 0x1404BFFD4 (HalpTimerSetProfilingHandler.c)
...
__int64 __fastcall HalpSetSystemInformation(int a1, int a2, __int64 (**a3)(void))
{
  ...
  switch ( a1 )
  {
    ...
    case 1:
      ...
      if ( qword_140CF5100 )
      {
        if ( qword_140CF5100 == PsGetCurrentThreadProcessId() )
        {
      ...
      else
      {
        HalpPerfInterruptHandler = (__int64 (__fastcall *)(_QWORD))*a3;
        if ( HalpPerfInterruptHandler )
          qword_140CF5100 = PsGetCurrentThreadProcessId();
      }
    ...
    case 10:
      ...
      if ( !qword_140CF50F0 )
      {
        ...
        if ( HalpTimerGetProfilingHandler() )
          qword_140CF50F0 = PsGetCurrentThreadProcessId();
        goto LABEL_34;
      }
      if ( qword_140CF50F0 == PsGetCurrentThreadProcessId() )
      {
        HalpTimerSetProfilingHandler(*a3);
        if ( !HalpTimerGetProfilingHandler() )
          qword_140CF50F0 = 0LL;
    ...
    case 19:
      ...
      if ( !qword_140CF50F8 )
      {
        ...
        if ( HalpProcessorTraceInterruptHandler )
          qword_140CF50F8 = PsGetCurrentThreadProcessId();
        goto LABEL_34;
      }
      if ( qword_140CF50F8 == PsGetCurrentThreadProcessId() )
      {
        HalpProcessorTraceInterruptHandler = (__int64 (__fastcall *)(_QWORD))*a3;
        if ( !HalpProcessorTraceInterruptHandler )
          qword_140CF50F8 = 0LL;
