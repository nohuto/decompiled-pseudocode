/*
 * XREFs of PnpTraceDeviceConfig @ 0x14073DDB8
 * Callers:
        ...
        __int64 *a17)
{
  ...
  if ( a17 )
    v27 = *a17;
  if ( (unsigned int)dword_140C02D50 > 5 )
  {
    if ( tlgKeywordOn((__int64)&dword_140C02D50, 0x800000000000LL) )
    {
      v31 = &v28;
      v33 = &v25;
      v35 = v38;
      ...
      tlgWriteTransfer_EtwWriteTransfer(
        (__int64)&dword_140C02D50,
        (unsigned __int8 *)byte_1400245CB,
        0LL,
        0LL,
        0x17u,
        &v30);
