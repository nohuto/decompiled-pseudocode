/*
 * XREFs of PiDevCfgProcessDevice @ 0x14073EAE0
 * Callers:
...
__int64 __fastcall PiDevCfgProcessDevice(__int64 a1, void *a2, char a3)
{
  ...
  *(_QWORD *)&DestinationString.Length = 0LL;
  ...
  inited = PiDevCfgInitDeviceContext(*(_QWORD *)(a1 + 48), (__int64)a2, v48);
  if ( inited >= 0 )
  {
    v10 = v48[0];
    if ( (a3 & 1) != 0 )
...
LABEL_45:
            if ( (_BYTE)v41 )
            {
              ...
              PiDevCfgLogDeviceConfigured(a1, (__int64)v48, v43, v42, inited, v22, (__int64)&v46);
            }
            goto LABEL_49;
          }
          v7 = 1;
