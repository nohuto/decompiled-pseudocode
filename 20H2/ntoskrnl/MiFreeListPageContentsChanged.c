/*
 * XREFs of MiFreeListPageContentsChanged @ 0x14054D34C
 * Callers:
...
void __fastcall MiFreeListPageContentsChanged(unsigned __int64 a1)
{
  ...
  *(_QWORD *)&LockHandle.OldIrql = 0LL;
  ...
  v4 = ((unsigned int)MiGetPfnChannel(v2) << byte_140C4DD0D) | dword_140C4DD78 & (unsigned int)a1 | (v3 << byte_140C4DD0C);
  v5 = *(_QWORD *)(*(_QWORD *)(qword_140C4E4C8 + 8 * ((*(_QWORD *)(v2 + 40) >> 39) & 0x3FFLL)) + 2184LL);
  ...
  if ( dword_140C4E54C == 1 )
  {
    v6 = a1 & 0x1F;
    LOBYTE(v7) = 1;
    v8 = (volatile signed __int32 *)(qword_140C4E5A8 + 4 * (a1 >> 5));
