/*
 * XREFs of MiSnapDriverRange @ 0x140758088
 * Callers:
 *     MiCheckForDiscardableLongJumpTable @ 0x140551E70 (MiCheckForDiscardableLongJumpTable.c)
 ...
 *     MiIsKernelHalPadSection @ 0x1403C783C (MiIsKernelHalPadSection.c)
