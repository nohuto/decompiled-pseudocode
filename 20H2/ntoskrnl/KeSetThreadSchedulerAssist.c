/*
 * XREFs of KeSetThreadSchedulerAssist @ 0x14051CAE8
 * Callers:
 *     VmSetThreadSchedulerAssist @ 0x1405A0D60 (VmSetThreadSchedulerAssist.c)
 * Callees:
...
char __fastcall KeSetThreadSchedulerAssist(PKTHREAD Thread, void *a2, __int64 a3, _DWORD *SchedulerAssist)
{
  ...
  _SINGLE_LIST_ENTRY v80; // [rsp+38h] [rbp-50h] BYREF
  ...
  if ( !(_DWORD)a3 )
  {
    ...
    if ( v57->NextThread )
    {
      ...
      *(_BYTE *)(CurrentThread + 390) = CurrentIrql;
      KiQueueReadyThread((__int64)v57, CurrentThread, v68);
    ...
    if ( (unsigned int)v7 <= 1 )
    {
      ...
      if ( v8 < 2u )
      {
        ...
        if ( v14->NextThread )
        {
          ...
          *(_BYTE *)(v15 + 643) = 32;
          *(_BYTE *)(v15 + 390) = v8;
          KiQueueReadyThread((__int64)v14, v15, v25);
          LOBYTE(v26) = v8;
