/*
 * XREFs of MiStoreWriteModifiedPages @ 0x140342AB0
 * Callers:
 ...
 *     MiUpdatePagefilePeakUsage @ 0x140341EA4 (MiUpdatePagefilePeakUsage.c)
...
__int64 __fastcall MiStoreWriteModifiedPages(__int64 a1)
{
  ...
  unsigned int v87; // [rsp+4Ch] [rbp-7Dh]
  ...
  _DWORD *v98; // [rsp+B0h] [rbp-19h] BYREF
...
LABEL_4:
  ...
  while ( v12 < v10 )
  {
    v13 = *v11;
    v14 = 1;
    if ( *v11 == qword_140C4EBE8 || !*(_QWORD *)(v7 + 24) )
      goto LABEL_32;
    if ( v98 != *(_DWORD **)(v7 + 112) )
    {
      if ( v98 )
      {
        v60 = MiDerefPageFileSpaceBitmaps(v7, &v98, 1);
        if ( v60 )
          ExFreePoolWithTag(v60, 0);
      }
      MiRefPageFileSpaceBitmaps((int *)v7, (__int64)&v98);
    }
    v15 = v103;
    v16 = v99 - 1;
...
LABEL_38:
    ...
    if ( (*(_QWORD *)(v9 + 24) & 0x4000000000000000LL) != 0 )
      goto LABEL_82;
    v90 = 0LL;
    v25 = MiStoreCheckCandidatePage(v9, v24, (unsigned __int64 *)&v92, &v94, &v90);
    if ( v25 < 0 )
    {
...
LABEL_36:
    ...
    if ( v27 >= 0 )
    {
      ...
      *(_DWORD *)(v88 + 120) = v24 + 1;
      MiUpdatePagefilePeakUsage((_QWORD *)v88);
      ...
      v30 = MiCapturePageFileInfoInline((unsigned __int64 *)(v9 + 16), 1, 1);
      *(_QWORD *)(v9 + 16) &= ~2uLL;
      v31 = v30;
      MiUpdatePfnBackingStore(v9, v88, v24, 1);
      _InterlockedAnd64((volatile signed __int64 *)(v9 + 24), 0x7FFFFFFFFFFFFFFFuLL);
      if ( KiIrqlFlags )
      {
        if ( (KiIrqlFlags & 1) != 0 )
...
LABEL_69:
  ...
  if ( v98 )
  {
    v57 = MiDerefPageFileSpaceBitmaps(v7, &v98, 0);
    if ( v57 )
