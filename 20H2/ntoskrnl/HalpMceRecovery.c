/*
 * XREFs of HalpMceRecovery @ 0x1404CE8D0
 * Callers:
 *     <none>
 * Callees:
 *     HalpMceRecoveryNotRequiredAmd @ 0x1404CEBCC (HalpMceRecoveryNotRequiredAmd.c)
 *     HalpMceRecoveryNotRequiredIntel @ 0x1404CEC94 (HalpMceRecoveryNotRequiredIntel.c)
 *     HalpMceRecoveryRequired @ 0x1404CED88 (HalpMceRecoveryRequired.c)
 */
