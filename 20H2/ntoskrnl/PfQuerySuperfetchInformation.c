/*
 * XREFs of PfQuerySuperfetchInformation @ 0x14060B800
 * Callers:
  ...
  else
  {
    switch ( v8 )
    {
      ...
      case 2:
        ...
        ExAcquirePushLockSharedEx((ULONG_PTR)qword_140C50138, 0LL);
        v41 = xmmword_140C4FF84;
        v42 = qword_140C4FF94;
        v43 = dword_140C4FF9C;
        if ( _InterlockedCompareExchange64((volatile signed __int64 *)qword_140C50138, 0LL, 17LL) != 17 )
          ExfReleasePushLockShared((signed __int64 *)qword_140C50138);
        KeAbPostRelease((ULONG_PTR)qword_140C50138);
      ...
      case 9:
        ...
        *(_DWORD *)Address[0] = dword_140CEC050;
        *v6 = 4;
        break;
      case 12:
