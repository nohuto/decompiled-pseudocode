/*
 * XREFs of RtlFindDynamicEnforcedAddressInRanges @ 0x1405CDB88
 * Callers:
 *     KiCheckUserAddressCetCompat @ 0x1405CCF1C (KiCheckUserAddressCetCompat.c)
 * Callees:
 *     KeAbPostRelease @ 0x14021ED30 (KeAbPostRelease.c)
 *     ExAcquirePushLockSharedEx @ 0x140220C00 (ExAcquirePushLockSharedEx.c)
 *     KeLeaveCriticalRegion @ 0x140221480 (KeLeaveCriticalRegion.c)
 *     ExfReleasePushLockShared @ 0x140242A40 (ExfReleasePushLockShared.c)
 *     RtlpDynamicEnforcedAddressRangesTreeCompare @ 0x1405CDCE4 (RtlpDynamicEnforcedAddressRangesTreeCompare.c)
 */
