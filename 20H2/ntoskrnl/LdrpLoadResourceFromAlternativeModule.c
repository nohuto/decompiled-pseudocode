/*
 * XREFs of LdrpLoadResourceFromAlternativeModule @ 0x1402FD528
 * Callers:
...
__int64 __fastcall LdrpLoadResourceFromAlternativeModule(__int64 a1, __int64 a2, int a3, int a4, unsigned int **a5)
{
  char v5; // si
