...
void PerfDiagpSaveActiveDCLLogFileName()
{
  ...
  if ( ValueData )
  {
    memset(dword_140C1A0D0, 0, 0xB0uLL);
    wcscpy(&xmmword_140C1A0AC, L"WdiContextLog");
    dword_140C1A0FC = 0x20000;
    RtlInitUnicodeString(&stru_140C1A160, &xmmword_140C1A0AC);
    qword_140C1A158 = (__int64)ValueData;
    word_140C1A152 = 520;
    dword_140C1A0D0[0] = 176;
    if ( (int)NtTraceControl(3u, dword_140C1A0D0, 0xB0u, dword_140C1A0D0, 0xB0u, &v2) < 0
