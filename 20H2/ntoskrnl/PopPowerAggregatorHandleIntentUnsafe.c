/*
 * XREFs of PopPowerAggregatorHandleIntentUnsafe @ 0x140771E64
 * Callers:
 ...
 *     PopPowerAggregatorHandleSystemTransitionStartIntent @ 0x140721D20 (PopPowerAggregatorHandleSystemTransitionStartIntent.c)
 ...
 *     PopPowerAggregatorIsAtTargetState @ 0x140772414 (PopPowerAggregatorIsAtTargetState.c)
 *     PopPowerAggregatorHandleSystemTransitionEndIntent @ 0x140776670 (PopPowerAggregatorHandleSystemTransitionEndIntent.c)
 *     PopPowerAggregatorCachePoPolicy @ 0x14078A5AC (PopPowerAggregatorCachePoPolicy.c)
 *     PopPowerAggregatorHandleActiveIntent @ 0x1408F0A90 (PopPowerAggregatorHandleActiveIntent.c)
 *     PopPowerAggregatorHandleDirectedDripsIntent @ 0x1408F0AD0 (PopPowerAggregatorHandleDirectedDripsIntent.c)
 *     PopPowerAggregatorHandleModernStandbyIntent @ 0x1408F0B60 (PopPowerAggregatorHandleModernStandbyIntent.c)
 *     PopPowerAggregatorHandleModernStandbyResumeIntent @ 0x1408F0C20 (PopPowerAggregatorHandleModernStandbyResumeIntent.c)
 *     PopPowerAggregatorHandleModernStandbySuspendIntent @ 0x1408F0C80 (PopPowerAggregatorHandleModernStandbySuspendIntent.c)
 */
...
__int64 __fastcall PopPowerAggregatorHandleIntentUnsafe(_QWORD *a1, unsigned int a2, unsigned int a3)
{
  ...
  *((_QWORD *)&v9 + 1) = a3;
        ...
        (v6 = (__int64 (__fastcall *)(__int64 *, __int128 *, _QWORD))PopPowerAggregatorIntentHandlers[v5]) != 0LL) )
  {
    ...
    if ( v7 >= 0 )
    {
      xmmword_140C21658 = v9;
      ymmword_140C21668 = v10;
