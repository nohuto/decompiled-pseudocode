/*
 * XREFs of MmAdjustWorkingSetSizeEx @ 0x14031CBE4
 * Callers:
        ...
        _BYTE *a6)
{
  ...
  *a6 = 0;
  ...
  if ( !a3 )
  {
    ...
    CurrentMultiplexedVm = Process + 1664;
LABEL_3:
    if ( a1 == -1LL && a2 == -1LL )
      return MiEmptyWorkingSetInitiate(CurrentMultiplexedVm, 0, 0LL, -1LL);
    v35 = *(ULONG_PTR **)(qword_140C4E4C8 + 8LL * *(unsigned __int16 *)(CurrentMultiplexedVm + 174));
