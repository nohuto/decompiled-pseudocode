/*
 * XREFs of wil_details_PopulateInitialConfiguredFeatureStatesFromBuffers @ 0x140A3B608
 * Callers:
 ...
 *     RtlpFcQueryFeatureConfigurationFromBuffers @ 0x14091CB00 (RtlpFcQueryFeatureConfigurationFromBuffers.c)
 */
...
__int64 __fastcall wil_details_PopulateInitialConfiguredFeatureStatesFromBuffers(__int64 *a1)
{
  ...
  v2 = 0;
  for ( i = (__int64 (__fastcall **)())&wil_details_featureDescriptors_a; ; i = v8 + 4 )
  {
