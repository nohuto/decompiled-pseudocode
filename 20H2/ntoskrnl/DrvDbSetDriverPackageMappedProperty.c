/*
 * XREFs of DrvDbSetDriverPackageMappedProperty @ 0x1407222DC
 * Callers:
 ...
 *     DrvDbOpenDriverPackageRegKey @ 0x1406E54C0 (DrvDbOpenDriverPackageRegKey.c)
 *     DrvDbGetDriverPackageSignerScore @ 0x140721E50 (DrvDbGetDriverPackageSignerScore.c)
 *     DrvDbSetRegValueMappedProperty @ 0x140722198 (DrvDbSetRegValueMappedProperty.c)
 *     DrvDbSetDriverPackageMappedProperty @ 0x1407222DC (DrvDbSetDriverPackageMappedProperty.c)
 *     _RegRtlSetValue @ 0x140765854 (_RegRtlSetValue.c)
 *     DrvDbGetDriverPackageSignerName @ 0x140980688 (DrvDbGetDriverPackageSignerName.c)
        ...
        unsigned int a7)
{
  ...
  if ( !a3 )
  {
    v16 = DrvDbOpenDriverPackageRegKey(v11, (int)v10, 3, 0, (__int64)&Handle, 0LL);
    if ( v16 < 0 )
      goto LABEL_31;
    v10 = a2;
  }
...
LABEL_70:
      ...
      if ( a3 )
        v39 = a3;
      if ( (int)DrvDbGetDriverPackageSignerScore(a1, a2, (__int64)v39, (wchar_t *)&v56) >= 0 && v56 == 218103811 )
      {
        v54 = (int)Handle;
        if ( a3 )
          v54 = (int)a3;
        if ( (unsigned int)DrvDbGetDriverPackageSignerName(v24, 0, v54, 0, 0, (__int64)&v63) == -1073741275 )
        {
          ...
          if ( a3 )
            v55 = a3;
          v16 = DrvDbSetRegValueMappedProperty(v24, v55, (__int64)v18, v19, (__int64)v23, v22);
          if ( v16 < 0 )
            goto LABEL_31;
          v47 = (int)Handle;
          if ( a3 )
...
LABEL_23:
    ...
    if ( a3 )
      v25 = a3;
    v26 = DrvDbSetRegValueMappedProperty(v24, v25, (__int64)v18, v19, (__int64)v23, v22);
    PoolWithTag = P;
    v12 = v59;
    goto LABEL_26;
  }
  ...
  if ( a3 )
    v45 = a3;
  if ( (int)DrvDbGetDriverPackageSignerScore(a1, v10, (__int64)v45, (wchar_t *)&v56) < 0 || v56 != 218103811 )
    goto LABEL_23;
  v46 = Handle;
  if ( a3 )
    v46 = a3;
  v16 = DrvDbSetRegValueMappedProperty(v24, v46, (__int64)v18, 0, 0LL, 0);
  if ( v16 != -1073741275 )
    goto LABEL_31;
LABEL_114:
  v16 = 0;
