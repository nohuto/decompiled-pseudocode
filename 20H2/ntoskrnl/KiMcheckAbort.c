/*
 * XREFs of KiMcheckAbort @ 0x14040C300
 * Callers:
 *     KiMcheckAbortShadow @ 0x140A179C0 (KiMcheckAbortShadow.c)
 * Callees:
        ...
        __int64 a8)
{
  ...
  unsigned __int8 v43; // [rsp+3Ah] [rbp-56h]
  char v44; // [rsp+3Bh] [rbp-55h]
  unsigned int v45; // [rsp+3Ch] [rbp-54h]
  ...
  __int64 v51; // [rsp+68h] [rbp-28h]
  __int64 v52; // [rsp+70h] [rbp-20h]
  unsigned __int64 v53; // [rsp+78h] [rbp-18h]
  _OWORD v54[6]; // [rsp+80h] [rbp-10h] BYREF
  unsigned __int64 v55; // [rsp+E0h] [rbp+50h]
