/*
 * XREFs of TtmInitCurrentSession @ 0x140900EAC
 * Callers:
 ...
 *     TtmiUpdateActiveTerminalCount @ 0x140901CE0 (TtmiUpdateActiveTerminalCount.c)
...
LABEL_3:
  ...
  *(_DWORD *)(v6 + 4) |= 8u;
  *(_DWORD *)(v6 + 76) = 1;
  v8 = TtmiCreateTerminal(v6, 0x1F0003u, 0, (_QWORD *)(v6 + 24), &v10, (struct _DMA_ADAPTER **)(v6 + 32));
  v3 = v8;
  if ( v8 >= 0 )
  {
