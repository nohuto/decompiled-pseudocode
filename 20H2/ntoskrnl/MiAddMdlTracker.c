/*
 * XREFs of MiAddMdlTracker @ 0x14052ED54
 * Callers:
 ...
 *     MiGetInstructionPointer @ 0x14052C4C4 (MiGetInstructionPointer.c)
 */
...
__int64 __fastcall MiAddMdlTracker(ULONG_PTR BugCheckParameter3, __int64 a2, int a3)
{
  ...
  if ( v3 || (v3 = PsInitialSystemProcess) != 0LL )
  {
    ...
    if ( v8 )
    {
      if ( *(_DWORD *)(v8 + 32) )
      {
        result = (__int64)ExAllocateFromNPagedLookasideList(&stru_140C4E8C0);
        v9 = result;
        if ( result )
        {
