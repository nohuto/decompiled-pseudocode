/*
 * XREFs of RtlpFcCalculateRequiredSizeForNewFeatureTable @ 0x14091C568
 * Callers:
 ...
 *     RtlpFcCompareFeatureToUpdate @ 0x14091C7FC (RtlpFcCompareFeatureToUpdate.c)
 *     RtlpFcDoesFeatureHaveUniqueState @ 0x14091C908 (RtlpFcDoesFeatureHaveUniqueState.c)
 *     RtlpFcIsUpdateModifyingOrAddingFeature @ 0x14091C960 (RtlpFcIsUpdateModifyingOrAddingFeature.c)
 *     RtlpFcUpdateFeature @ 0x14091CC90 (RtlpFcUpdateFeature.c)
 */
