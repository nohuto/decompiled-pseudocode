/*
 * XREFs of MiWriteAwePtes @ 0x14054C798
 * Callers:
        ...
        char a6)
{
  ...
  signed int v81; // [rsp+34h] [rbp-CCh]
    ...
    if ( v15 )
    {
      ...
      if ( v14 != v38 - 0x98000000000LL )
      {
        if ( v14 )
        {
          ...
          MiFlushTbList((unsigned int *)v106, v41);
          if ( v87 )
            v88 = 0LL;
...
LABEL_58:
    ...
    if ( v46 )
    {
      ...
      {
        v53 = v46;
        if ( qword_140C4DDC0 && (v46 & 0x10) == 0 )
          v53 = v46 & ~qword_140C4DDC0;
        v52 = v53 >> 12;
      }
      v49 = 0xFFFFFFFFFLL;
...
LABEL_97:
  ...
  if ( v62 != v97 )
  {
    ...
    MiFlushTbList((unsigned int *)v106, v69);
    v88 = v65;
    if ( v87 )
    {
      v70 = v65;
...
LABEL_112:
  if ( v14 )
  {
    ...
    if ( v66 )
    {
      MiFlushTbList((unsigned int *)v106, v74);
