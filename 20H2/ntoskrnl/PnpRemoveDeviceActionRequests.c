/*
 * XREFs of PnpRemoveDeviceActionRequests @ 0x140380AA4
 * Callers:
    ...
    do
    {
      ...
      if ( *(_QWORD *)(v3 + 16) == a1 )
      {
        ...
        *v7 = v5;
        ...
        v11 = KeAcquireSpinLockRaiseToDpc(&qword_140C24D08);
        v12 = dword_140C24D10-- == 1;
        v13 = v11;
        if ( v12 )
        ...
        __writecr8(v13);
        v14 = KeAcquireSpinLockRaiseToDpc(&qword_140C1E8B0);
