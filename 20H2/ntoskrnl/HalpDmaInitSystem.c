/*
 * XREFs of HalpDmaInitSystem @ 0x1409A2B20
 * Callers:
 *     <none>
 * Callees:
 ...
 *     HalpDmaInitDiscard @ 0x140A624A0 (HalpDmaInitDiscard.c)
...
__int64 __fastcall HalpDmaInitSystem(int a1, __int64 a2, __int64 a3)
{
  ...
  if ( !v5 )
  {
    ...
    qword_140C49C28 = (__int64)&HalpDmaControllers;
    HalpDmaControllers = (__int64)&HalpDmaControllers;
    qword_140C4BD68 = (__int64)&HalpDmaHibernateAdapters;
    HalpDmaHibernateAdapters = (__int64)&HalpDmaHibernateAdapters;
    qword_140C4BD48 = (__int64)&HalpDmaPdoList;
