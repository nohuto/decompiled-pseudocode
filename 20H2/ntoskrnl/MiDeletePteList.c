/*
 * XREFs of MiDeletePteList @ 0x1402C0040
 * Callers:
...
__int64 __fastcall MiDeletePteList(unsigned int *a1, _KPROCESS *a2, unsigned __int64 a3, _QWORD *a4, int a5)
{
  unsigned int v5; // eax
  __int64 v8; // r13
  ...
  do
  {
    ...
    do
    {
      ...
      v25 = *(_QWORD *)(qword_140C4E4C8 + 8 * ((*(_QWORD *)(v23 - 0x58000000000LL + 40) >> 39) & 0x3FFLL));
      v73 = v25;
      if ( (unsigned int)MI_PFN_IS_PROTO(v23 - 0x58000000000LL) )
      {
        ...
        if ( v31 )
        {
          v36 = MiDecrementCombinedPte(&a2[1].ActiveProcessorsPadding[6], v30);
        }
        else
        {
      ...
      else
      {
        ...
        *(_QWORD *)(v24 + 24) ^= (*(_QWORD *)(v24 + 24) ^ v37) & 0x3FFFFFFFFFFFFFFFLL;
        if ( !v37 )
        {
          ...
          if ( *(_WORD *)(v24 + 32) )
          {
            ...
            *(_BYTE *)(v24 + 34) = v45;
            ...
            {
              v37 = *(_QWORD *)(qword_140C4E4C8 + 8 * ((*(_QWORD *)(v24 + 40) >> 39) & 0x3FFLL));
              *(_BYTE *)(v37 + 675) = 1;
            }
            ++a4[1];
          }
          else if ( (_DWORD)v43 )
          {
            ...
            v47 = *(_QWORD *)(qword_140C4E4C8 + 8 * ((*(_QWORD *)(v24 + 40) >> 39) & 0x3FFLL));
            v72 = *(_QWORD *)(v24 + 16);
            if ( (v72 & 0x400) == 0 )
            {
              v48 = (v72 & 4) != 0 || (v72 & 2) != 0 ? MI_READ_PTE_LOCK_FREE((unsigned __int64)&v72) : 0LL;
              v72 = v48;
              if ( v48 )
        ...
        if ( v10 )
        {
          ...
          {
            if ( v53 )
              updated = MiUpdatePageFileHighInPte(v53, v51);
            else
