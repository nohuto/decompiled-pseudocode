/*
 * XREFs of MiValidateExistingImage @ 0x14062B2B4
 * Callers:
...
__int64 __fastcall MiValidateExistingImage(unsigned int *a1)
{
  ...
  if ( (v14 & 0x400) != 0 )
  {
    ...
    if ( qword_140C1D9E0 )
    {
      ...
      v18 = ((__int64 (__fastcall *)(_QWORD, __int64, __int64, _QWORD))qword_140C1D9E0)(
              v17,
              v9,
              v10,
    ...
    if ( !qword_140C1D980
      || (LOBYTE(v14) = (unsigned __int8)v14 >> 4,
          v19 = qword_140C1D980(v14, v9, v10),
...
LABEL_47:
    ...
    v20 = (int)qword_140C1D980;
    if ( qword_140C1D980 )
    {
      LOBYTE(v10) = (unsigned __int8)v10 >> 4;
      LOBYTE(v9) = v2;
      LOBYTE(v14) = v10;
      v20 = qword_140C1D980(v14, v9, v10);
    }
    v4 = v20 == 0;
  }
