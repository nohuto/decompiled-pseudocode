/*
 * XREFs of PpmParkReportUnparkedCore @ 0x14057BF50
 * Callers:
...
_BYTE *__fastcall PpmParkReportUnparkedCore(__int64 a1)
{
  ...
  *(_BYTE *)(a1 + 33212) = 0;
  _InterlockedAnd64(
    &qword_140C11328[(unsigned __int64)(unsigned int)KiProcessorIndexToNumberMappingTable[v2] >> 6],
    ~(1LL << (KiProcessorIndexToNumberMappingTable[v2] & 0x3F)));
  if ( *(_BYTE *)(a1 + 32819) )
  {
    _InterlockedAnd64(
      &qword_140C127C8[(unsigned __int64)(unsigned int)KiProcessorIndexToNumberMappingTable[*(unsigned int *)(a1 + 36)] >> 6],
