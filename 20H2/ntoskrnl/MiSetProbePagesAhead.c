/*
 * XREFs of MiSetProbePagesAhead @ 0x14034E904
 * Callers:
...
char __fastcall MiSetProbePagesAhead(__int64 a1)
{
  ...
  if ( (_BYTE)v2 == 1 )
  {
    ...
    if ( v3 != 3 )
    {
      v4 = *(_QWORD *)(a1 + 40);
      v18 = v4;
      v5 = 6 * (((unsigned __int64)MI_READ_PTE_LOCK_FREE((unsigned __int64)&v18) >> 12) & 0xFFFFFFFFFLL);
      LOBYTE(v2) = 40;
      if ( ((*(_QWORD *)(8 * v5 - 0x57FFFFFFFD8LL) >> 50) & 1) != 0 )
      {
        ...
        while ( 1 )
        {
          ...
          if ( ((*(_QWORD *)(v9 - 0x57FFFFFFFD8LL) >> 50) & 1) == 0 )
            break;
          v10 = (_QWORD *)qword_140C4ED00;
          v11 = v9 - 0x58000000000LL;
          if ( qword_140C4ED00 && ((*(_QWORD *)(v11 + 40) >> 60) & 7) == 1 )
          {
