/*
 * XREFs of SepAdtOpenObjectAuditAlarm @ 0x140921CD8
 * Callers:
        ...
        __int64 a19)
{
  ...
  *(_QWORD *)&v91.ImpersonationLevel = 0LL;
  ...
  v75 = 0;
  v91.ClientToken = a7;
  if ( !(unsigned __int8)SepAdtAuditThisEventWithContext(123LL, a12, a12 == 0, &v91) )
    return 1;
  v24 = &v93;
  if ( a18 )
    v24 = a18;
...
LABEL_19:
    ...
    if ( a5 )
    {
      if ( v77 == 116 || (LODWORD(v92[23]) = 1, v77 == 128) )
        LODWORD(v92[23]) = 2;
      v36 = *a5;
      v92[26] = a5;
