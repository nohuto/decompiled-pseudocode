/*
 * XREFs of RtlpGenericRandomPatternWorker @ 0x14058F1FC
 * Callers:
 *     RtlScrubMemory @ 0x14058EB58 (RtlScrubMemory.c)
 * Callees:
 *     RtlpFillMemoryRandomUp @ 0x14058EC8C (RtlpFillMemoryRandomUp.c)
 *     RtlpTestMemoryRandomUp @ 0x14058F6E8 (RtlpTestMemoryRandomUp.c)
 */
