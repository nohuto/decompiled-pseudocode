/*
 * XREFs of RaspGetXExtent @ 0x1403AC204
 * Callers:
 *     BcpGetCharacterMaxResourceProfile @ 0x1403BBC6C (BcpGetCharacterMaxResourceProfile.c)
 *     BgpRasGetGlyphAdvanceWidth @ 0x1405C425C (BgpRasGetGlyphAdvanceWidth.c)
 * Callees:
 *     RaspGetCacheEntry @ 0x1403AC3A8 (RaspGetCacheEntry.c)
