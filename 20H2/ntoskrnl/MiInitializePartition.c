/*
 * XREFs of MiInitializePartition @ 0x14078E400
 * Callers:
 ...
 *     MiInitializePfnListHead @ 0x1403A9D20 (MiInitializePfnListHead.c)
 *     MiInitializeCombining @ 0x1403A9D48 (MiInitializeCombining.c)
...
__int64 __fastcall MiInitializePartition(unsigned __int64 a1, __int16 a2)
{
  ...
  *(_DWORD *)(a1 + 4) = v3;
  ...
  {
    v6 = 0;
    for ( i = *v5; v6 < dword_140C4DD7C; i += 40LL )
    {
      *(_DWORD *)(i + 8) = v4;
      ++v6;
  ...
  *(_QWORD *)(a1 + 4232) = v10;
  ...
  v20 = dword_140C4DD7C;
  v21 = 0;
  for ( m = *(_QWORD *)(a1 + 4200); v21 < 2 * dword_140C4DD7C; ++v21 )
  {
  ...
  *(_DWORD *)(a1 + 6300) = v24;
  if ( (ULONG_PTR *)a1 == &MiSystemPartition )
    MiInitializePfnListHead((__int64)&qword_140C4C940, 5);
  v25 = 3LL;
