/*
 * XREFs of MiLogHotPatchOperationStatus @ 0x1408CE280
 * Callers:
  ...
  if ( *(_QWORD *)&qword_140C4ED60 )
  {
    ...
    if ( a5 )
    {
      if ( a5 == 1 )
      {
        ...
        v25 = a4;
        v37[4] = (__int64)&v25;
        v16 = (unsigned __int8 *)byte_140025713;
        v37[5] = 4LL;
        v37[6] = (__int64)&v26;
        v37[8] = (__int64)&v27;
        v37[10] = (__int64)v38;
      ...
      else
      {
        ...
        v28 = a4;
        v42 = &v28;
        v16 = (unsigned __int8 *)&word_140025786;
        v43 = 4LL;
        v44 = &v29;
        v46 = &v30;
        v48 = v51;
    ...
    if ( **(_DWORD **)&qword_140C4ED60 > 5u )
    {
      ...
      if ( (_BYTE)v5 )
      {
        ...
        v67[1] = 0;
        v69 = 8LL;
        LOBYTE(v5) = tlgWriteEx_EtwWriteEx(v10, (unsigned __int8 *)&unk_140025688, v12, 1u, v19, v20, 0xAu, &v54);
      }
    }
  }
  return (char)v5;
