/*
 * XREFs of MiSharePages @ 0x1403680B0
 * Callers:
 ...
 *     MiGetCombineDomain @ 0x140369BBC (MiGetCombineDomain.c)
 ...
 *     MiPopCombineBlock @ 0x14036ABA4 (MiPopCombineBlock.c)
...
void __fastcall MiSharePages(__int64 a1, _QWORD *a2, unsigned __int64 *a3, _QWORD *a4, int a5)
{
  ...
  unsigned int v139; // [rsp+A0h] [rbp-60h]
  int v140; // [rsp+A4h] [rbp-5Ch]
  unsigned __int64 *v141; // [rsp+A8h] [rbp-58h]
  unsigned int *Pool; // [rsp+B0h] [rbp-50h]
  ...
  *(_QWORD *)v136 = *a4;
  ...
  v140 = 0;
  v154 = a1 + 64;
  v15 = (unsigned int *)v164;
  Pool = (unsigned int *)v164;
  if ( v13 <= 0x14 )
  {
    LODWORD(v16) = v13;
  }
  else
  {
    ...
    if ( v13 < 0x1FD )
      v16 = v13;
    Pool = (unsigned int *)MiAllocatePool(64, 8 * v16 + 24, 0x73576D4Du);
    v15 = Pool;
    if ( !Pool )
    {
      v15 = (unsigned int *)v164;
...
LABEL_104:
              ...
              MiFlushTbList((unsigned int *)v163, v59);
              v54 = v149;
              v60 = v137;
              goto LABEL_92;
            }
            v60 = v137;
            if ( v137 == qword_140C4EC18 )
            {
...
LABEL_92:
              v26 = v126;
              if ( v60 != qword_140C4EC18 || !(unsigned int)MiPageMightBeZero(v126, BugCheckParameter2, v54) )
                goto LABEL_107;
              v152 = 0;
              while ( _interlockedbittestandset64((volatile signed __int32 *)(BugCheckParameter2 + 24), 0x3FuLL) )
              {
...
LABEL_74:
                ...
                if ( !v33 )
                {
                  if ( !(unsigned int)MiPerformCombineScan(v145, *(_QWORD *)v150, v132 == qword_140C4E3D0, v160)
                    || *(_QWORD *)&v160[0] != v137 )
                  {
                    goto LABEL_167;
                  }
...
LABEL_202:
    ...
    v15 = Pool;
    v25 = a5;
    MiFlushTbList(Pool, (_KPROCESS *)v32);
    v26 = v126;
    if ( v127 )
