/*
 * XREFs of x86BiosWriteIoSpace @ 0x140399130
 * Callers:
 *     XmOutOp @ 0x1403961B0 (XmOutOp.c)
 *     XmOutsOp @ 0x1404E4870 (XmOutsOp.c)
 * Callees:
 *     x86BiosWritePciAddressPort @ 0x1403CB2E4 (x86BiosWritePciAddressPort.c)
 *     x86BiosWriteCmosPort @ 0x1404BDA08 (x86BiosWriteCmosPort.c)
