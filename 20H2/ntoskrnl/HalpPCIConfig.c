/*
 * XREFs of HalpPCIConfig @ 0x140311160
 * Callers:
 *     HaliPciInterfaceReadConfig @ 0x1403110F0 (HaliPciInterfaceReadConfig.c)
 *     HaliPciInterfaceWriteConfig @ 0x14037CF80 (HaliPciInterfaceWriteConfig.c)
 *     HalpWritePCIConfig @ 0x14039EB9C (HalpWritePCIConfig.c)
 *     HalpReadPCIConfig @ 0x14039EEB4 (HalpReadPCIConfig.c)
 *     HalpPciHandleSecureAccess @ 0x1404D0D4C (HalpPciHandleSecureAccess.c)
 *     HaliHandlePCIConfigSpaceAccess @ 0x1404D4FB0 (HaliHandlePCIConfigSpaceAccess.c)
 *     HalpKdWritePCIConfig @ 0x1404DD900 (HalpKdWritePCIConfig.c)
 * Callees:
 ...
 *     HalpPciAccessIoConfigSpace @ 0x1403BB998 (HalpPciAccessIoConfigSpace.c)
