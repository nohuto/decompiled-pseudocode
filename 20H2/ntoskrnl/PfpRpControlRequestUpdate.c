/*
 * XREFs of PfpRpControlRequestUpdate @ 0x1406F33F4
 * Callers:
...
__int64 __fastcall PfpRpControlRequestUpdate(__int64 a1, _DWORD *a2)
{
  ...
  if ( (int)result >= 0 )
  {
    ...
    if ( !v14
      || !*(_DWORD *)(a1 + 112)
      || (result = PfpRpCHashDeleteEntries(a1, a1 + 96, (signed __int64 *)(a1 + 120), v14, (__int64)&a2[2 * a2[1] + 6]),
          (int)result >= 0) )
    {
      ...
      if ( v15 && *(_DWORD *)(a1 + 72) )
      {
        result = PfpRpCHashDeleteEntries(
                   a1,
                   a1 + 56,
                   (signed __int64 *)(a1 + 88),
                   v15,
                   ((unsigned __int64)&a2[2 * v9 + 7] + 3) & 0xFFFFFFFFFFFFFFF8uLL);
        if ( (int)result < 0 )
          return result;
        *(_QWORD *)(a1 + 80) = 0LL;
      }
