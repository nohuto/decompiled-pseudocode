/*
 * XREFs of IopLiveDumpAllocateFromVMMemoryPartition @ 0x14089A340
 * Callers:
...
LABEL_5:
    ...
    else
    {
      *(_DWORD *)(a1 + 80) |= 8u;
      ...
      {
        if ( tlgKeywordOn((__int64)&dword_140C04498, 0x200000000000LL) )
        {
          v11 = *(_DWORD *)(a1 + 80);
          v23 = 0;
          v26 = 0;
          ...
          tlgWriteTransfer_EtwWriteTransfer(
            ...
            (unsigned __int8 *)byte_140023715,
            (const GUID *)(a1 + 864),
            (const GUID *)(a1 + 848),
            4u,
            v20);
...
LABEL_14:
    *(_DWORD *)(a1 + 80) |= 4u;
    ...
    if ( (unsigned int)dword_140C04498 > 5 && tlgKeywordOn((__int64)&dword_140C04498, 0x200000000000LL) )
    {
      ...
      tlgWriteTransfer_EtwWriteTransfer(
        (__int64)&dword_140C04498,
        (unsigned __int8 *)&byte_140023777,
        (const GUID *)(a1 + 864),
        (const GUID *)(a1 + 848),
        4u,
        v20);
