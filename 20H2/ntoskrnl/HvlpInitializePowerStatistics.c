/*
 * XREFs of HvlpInitializePowerStatistics @ 0x1404F67F0
 * Callers:
...
__int64 HvlpInitializePowerStatistics()
{
  ...
  *(_DWORD *)v2 = 4;
  ...
  {
    xmmword_140CED260 = *(_OWORD *)v3;
    xmmword_140CED270 = *((_OWORD *)v3 + 1);
    unk_140CED280 = *((_OWORD *)v3 + 2);
    qword_140CED290 = v3[6];
  }
