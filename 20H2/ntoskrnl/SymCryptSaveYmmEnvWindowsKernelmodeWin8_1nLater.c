/*
 * XREFs of SymCryptSaveYmmEnvWindowsKernelmodeWin8_1nLater @ 0x1403EB794
 * Callers:
 *     SymCryptSaveYmm @ 0x1403C86C4 (SymCryptSaveYmm.c)
 * Callees:
 *     KeSaveExtendedProcessorState @ 0x14031F970 (KeSaveExtendedProcessorState.c)
 *     SymCryptCpuFeaturesNeverPresent @ 0x14032EB80 (SymCryptCpuFeaturesNeverPresent.c)
