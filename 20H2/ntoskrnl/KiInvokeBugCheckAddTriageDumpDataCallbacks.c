/*
 * XREFs of KiInvokeBugCheckAddTriageDumpDataCallbacks @ 0x140516AAC
 * Callers:
      ...
      if ( (_BYTE)v0 )
      {
        ...
        *((_QWORD *)&v6 + 1) = *((_QWORD *)&KiBugCheckData + 1);
          ...
          && (LOBYTE(v0) = KiValidateComponentName((STRSAFE_PCNZCH)v1[3]), (_BYTE)v0) )
        {
          ...
          *(_DWORD *)(v5 + 32) = 1;
          v0 = v5;
          v3 = (__int64 *)qword_140C31AA8;
          if ( *(__int64 **)qword_140C31AA8 != &KeBugCheckTriageDumpDataArrayListHead )
            __fastfail(3u);
