/*
 * XREFs of Uart16550InitializePortCommon @ 0x1405C9564
 * Callers:
 *     Uart16550InitializePort @ 0x1405C9540 (Uart16550InitializePort.c)
 *     Uart16550LegacyInitializePort @ 0x1405C9620 (Uart16550LegacyInitializePort.c)
 *     Uart16550MmInitializePort @ 0x1405C9690 (Uart16550MmInitializePort.c)
 * Callees:
 *     _guard_dispatch_icall @ 0x140405F40 (_guard_dispatch_icall.c)
 *     Uart16550SetBaud @ 0x1405C9830 (Uart16550SetBaud.c)
 *     UartpSetAccess @ 0x1405CA10C (UartpSetAccess.c)
 */
