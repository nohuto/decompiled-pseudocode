/*
 * XREFs of MiProcessLoaderEntry @ 0x140371B54
 * Callers:
...
__int64 __fastcall MiProcessLoaderEntry(unsigned __int64 *a1, int a2)
{
  ...
  if ( a2 != 1 )
  {
    ...
    if ( *(unsigned __int64 **)(*a1 + 8) == a1 && *v14 == a1 )
    {
      ...
      *(_QWORD *)(v13 + 8) = v14;
      RtlAvlRemoveNode(&qword_140C4CBE0, a1 + 29);
...
LABEL_24:
  ...
  *(&PsLoadedModuleList + 1) = a1;
  ...
  RtlAvlInsertNodeEx(&qword_140C4CBE0, (unsigned __int64)v7, v6, a1 + 29);
  ExReleaseSpinLockExclusiveFromDpcLevel(&PsLoadedModuleSpinLock);
