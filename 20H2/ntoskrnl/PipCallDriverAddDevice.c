/*
 * XREFs of PipCallDriverAddDevice @ 0x1407361D4
 * Callers:
 ...
 *     IovUtilMarkStack @ 0x14037E624 (IovUtilMarkStack.c)
 ...
 *     PiDmaGuardProcessPreAddDevice @ 0x140768B5C (PiDmaGuardProcessPreAddDevice.c)
