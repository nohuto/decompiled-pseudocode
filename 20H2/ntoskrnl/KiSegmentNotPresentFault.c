/*
 * XREFs of KiSegmentNotPresentFault @ 0x14040AA40
 * Callers:
 *     KiSegmentNotPresentFaultShadow @ 0x140A176C0 (KiSegmentNotPresentFaultShadow.c)
 * Callees:
...
void __fastcall __noreturn KiSegmentNotPresentFault(__int64 a1)
{
  ...
  if ( (v11 & 1) != 0 )
  {
    ...
    __writegsqword(0x270u, a1);
    __writegsbyte(0x851u, KeGetPcr()->Prcb.BpbRetpolineExitSpecCtrl);
    LOBYTE(a1) = KeGetPcr()->Prcb.BpbState;
    __writegsbyte(0x852u, a1);
