/*
 * XREFs of MiUnlinkPageFromBadList @ 0x14054DA40
 * Callers:
...
unsigned __int64 __fastcall MiUnlinkPageFromBadList(_QWORD *a1, char a2)
{
  ...
  {
    v6 = *(ULONG_PTR **)(qword_140C4E4C8 + 8 * ((a1[5] >> 39) & 0x3FFLL));
    v7 = (__int64 *)(v6 + 512);
  }
  v8 = a2 & 0x80;
  if ( !v8 )
  ...
  if ( v7 != &qword_140C4C940 && dword_140C4E54C == 1 )
  {
    v11 = v4 & 0x1F;
    LOBYTE(v12) = 1;
    v13 = (volatile signed __int32 *)(qword_140C4E5A8 + 4 * (v4 >> 5));
    if ( v11 + 1 <= 0x20 )
    {
      v14 = 1 << v11;
LABEL_22:
