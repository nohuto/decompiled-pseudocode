/*
 * XREFs of MmGetSectionInformation @ 0x140636810
 * Callers:
 ...
 *     MiGetControlAreaLoadConfig @ 0x140236A20 (MiGetControlAreaLoadConfig.c)
  ...
  if ( a2 )
  {
    if ( a2 == 1 || a2 == 4 )
    {
      if ( (v10 & 0x20) != 0 )
      {
        ...
        {
          *(_QWORD *)&v30[0] = qword_140C4DC90 | LOWORD(v30[0]);
          v21 = v30[0];
        }
        if ( a2 == 4 )
        {
    ...
    else if ( (v10 & 0x20) != 0 )
    {
      ...
      {
        if ( (*(_DWORD *)(v9 + 56) & 0x10000000) != 0 )
          v19 += qword_140C4DC90 - *(_QWORD *)(*(_QWORD *)v9 + 32LL);
        *(_QWORD *)a3 = v19;
      }
      else
      {
