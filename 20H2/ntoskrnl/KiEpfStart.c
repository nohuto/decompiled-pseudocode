/*
 * XREFs of KiEpfStart @ 0x140522774
 * Callers:
...
LABEL_6:
  ...
  if ( v5 )
  {
    _InterlockedIncrement(&dword_140C2AEF0);
    v6 = _InterlockedIncrement(&dword_140C2AEF4);
    do
      v9 = dword_140C2AEF8;
    while ( dword_140C2AEF8 < v6 && v9 != _InterlockedCompareExchange(&dword_140C2AEF8, v6, dword_140C2AEF8) );
    v10 = KeSetKernelStackSwapEnable(0);
    KeWaitForGate((__int64)&v14, 39);
    KeSetKernelStackSwapEnable(v10);
    _InterlockedDecrement(&dword_140C2AEF4);
  }
}
