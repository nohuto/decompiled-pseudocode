/*
 * XREFs of ExpSnapShotHandleTables @ 0x14094F460
 * Callers:
 *     ObGetHandleInformation @ 0x1408DF62C (ObGetHandleInformation.c)
 *     ObGetHandleInformationEx @ 0x1408DF680 (ObGetHandleInformationEx.c)
 * Callees:
