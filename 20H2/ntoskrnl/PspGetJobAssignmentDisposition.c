/*
 * XREFs of PspGetJobAssignmentDisposition @ 0x14062C698
 * Callers:
 ...
 *     PsIsJobParentImmutable @ 0x14062C400 (PsIsJobParentImmutable.c)
...
LABEL_11:
  ...
  else if ( PsIsJobParentImmutable(a1) || *(_DWORD *)(v11 + 212) || *(_QWORD *)(v11 + 1560) == -1LL )
  {
    return 3221225659LL;
  }
  else
