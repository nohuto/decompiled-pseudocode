/*
 * XREFs of KeResumeClockTimerFromIdle @ 0x1402843F0
 * Callers:
 ...
 *     KiGetPendingTick @ 0x14031A420 (KiGetPendingTick.c)
 ...
 *     ExRecordOneTimerExpiry @ 0x1405B4D00 (ExRecordOneTimerExpiry.c)
 */
...
void __fastcall KeResumeClockTimerFromIdle(_DWORD *a1)
{
  ...
  KiClockLatencyMeasurementEnabled = 0;
  if ( v9 - KiClockTimerOneShotStartTime < qword_140C31448 )
    qword_140C31448 = v9 - KiClockTimerOneShotStartTime;
  if ( v9 - KiClockTimerOneShotStartTime > qword_140C31440 )
    qword_140C31440 = v9 - KiClockTimerOneShotStartTime;
