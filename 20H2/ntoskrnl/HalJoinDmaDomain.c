/*
 * XREFs of HalJoinDmaDomain @ 0x1403C6720
 * Callers:
 ...
 *     HalpDmaIsDomainCompatible @ 0x1404C32CC (HalpDmaIsDomainCompatible.c)
 *     HalpDomainLaAllocate @ 0x1404C3344 (HalpDomainLaAllocate.c)
 *     HalpDomainLaDelete @ 0x1404C3424 (HalpDomainLaDelete.c)
 *     HalpIommuDomainMapLogicalRange @ 0x1404C7904 (HalpIommuDomainMapLogicalRange.c)
