/*
 * XREFs of HalpTimerTraceTimingHardware @ 0x1407D11C8
 * Callers:
...
void HalpTimerTraceTimingHardware()
{
  ...
  if ( (unsigned int)dword_140C02DF8 > 5 && tlgKeywordOn((__int64)&dword_140C02DF8, 0x400000000000LL) )
  {
    ...
    v28 = 4LL;
    v27 = &v13;
    tlgWriteTransfer_EtwWriteTransfer((__int64)&dword_140C02DF8, (unsigned __int8 *)byte_1400218B1, 0LL, 0LL, 9u, &v14);
  }
}
