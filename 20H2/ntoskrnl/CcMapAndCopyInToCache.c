        ...
        struct _KTHREAD *a9)
{
  ...
  unsigned int v127; // [rsp+C0h] [rbp-110h] BYREF
  int v128; // [rsp+C4h] [rbp-10Ch]
...
LABEL_9:
  ...
  if ( v12 )
  {
    ...
    if ( (*(_DWORD *)(v9 + 152) & 0x20) != 0 )
    {
      ...
      Next = v14->Next;
      v77 = (struct _SLIST_ENTRY **)*((_QWORD *)&v14->Next + 1);
    ...
    while ( 1 )
    {
      ...
      else
      {
        ...
        if ( v106 )
        {
          ...
          if ( v36 )
            v61 = 4096LL;
          v48 = CcLockSystemCacheBuffer(v121, &v140, v61, 1LL, &v127);
          v145 = v48;
          if ( !v48 )
            RtlRaiseStatus(v127);
          v47 = v140;
