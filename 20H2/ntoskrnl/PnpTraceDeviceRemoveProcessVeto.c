/*
 * XREFs of PnpTraceDeviceRemoveProcessVeto @ 0x1408B4444
 * Callers:
...
void PnpTraceDeviceRemoveProcessVeto()
{
  ...
  if ( (unsigned int)dword_140C02DC0 > 5 )
  {
    if ( tlgKeywordOn((__int64)&dword_140C02DC0, 0x400000000000LL) )
    {
      ...
      v13 = 2LL;
      v15[1] = 0;
      tlgWriteTransfer_EtwWriteTransfer((__int64)&dword_140C02DC0, (unsigned __int8 *)byte_14002485D, 0LL, 0LL, 8u, &v3);
    }
  }
}
