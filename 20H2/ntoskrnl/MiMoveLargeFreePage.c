/*
 * XREFs of MiMoveLargeFreePage @ 0x1405550F0
 * Callers:
...
__int64 __fastcall MiMoveLargeFreePage(__int64 a1, unsigned int a2, __int64 a3, _WORD *a4)
{
  ...
  if ( (_DWORD)result )
  {
    ...
    v25[0] = v8;
    if ( *(_QWORD *)(qword_140C4E4C8 + 8 * v19) == a3 )
    {
      ...
      {
        v21 = v20 + 24;
        v22 = (unsigned __int64)(*a4 & 0x3FF) << 39;
        do
        {
          v24 = 0;
          ...
          if ( (*(_BYTE *)(v21 + 11) & 0x40) != 0 )
            MiMoveBadPageCrossPartition(v20, a3, (unsigned __int64)a4);
    ...
    MiInsertLargePageInNodeList((__int64)v25, v18, v16, v17);
    return v5;
  }
  return result;
}
