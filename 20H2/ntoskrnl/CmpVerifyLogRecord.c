/*
 * XREFs of CmpVerifyLogRecord @ 0x1405CB8FC
 * Callers:
 *     CmpRmReDoPhase @ 0x140877F30 (CmpRmReDoPhase.c)
 * Callees:
 *     CmpVerifyCreateOrDeleteKeyLogRecord @ 0x1405CB8A0 (CmpVerifyCreateOrDeleteKeyLogRecord.c)
 *     CmpVerifyRenameKeyLogRecord @ 0x1405CB9B8 (CmpVerifyRenameKeyLogRecord.c)
 *     CmpVerifySetOrDeleteValueLogRecord @ 0x1405CBA00 (CmpVerifySetOrDeleteValueLogRecord.c)
 *     CmpVerifySetSecurityDescriptorLogRecord @ 0x1405CBA68 (CmpVerifySetSecurityDescriptorLogRecord.c)
