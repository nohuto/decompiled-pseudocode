/*
 * XREFs of MiAddWorkingSetEntries @ 0x1402736E0
 * Callers:
...
unsigned __int64 __fastcall MiAddWorkingSetEntries(__int64 a1, unsigned __int64 a2, __int64 a3, char a4)
{
  ...
  __int64 v79; // rax
  __int64 v80; // rdx
  unsigned __int64 v81; // [rsp+20h] [rbp-69h] BYREF
  ...
  _DWORD v91[8]; // [rsp+88h] [rbp-1h] BYREF
  ...
  v7 = a2;
  if ( v4 == 2 )
    v9 = (volatile signed __int64 *)&unk_140C4F640;
  else
  ...
  if ( (a4 & 1) != 0 )
  {
    ...
    if ( v13 > *(_QWORD *)(a1 + 112) && (*(_BYTE *)(a1 + 187) & 8) == 0 )
    {
      ...
      if ( v14 > v15 )
      {
        v16 = *(_QWORD **)(qword_140C4E4C8 + 8LL * *(unsigned __int16 *)(a1 + 174));
        v17 = v16[866];
        if ( (v14 & 0x3F) != 0 )
        {
          v18 = -1LL;
...
LABEL_87:
        ...
        if ( v14 - v15 >= 3 * (v17 >> 2) )
        {
          v61 = *(_QWORD *)(qword_140C4E4C8 + 8LL * *(unsigned __int16 *)(a1 + 174));
          v87 = v16[856];
          StandbyRepurposed = MiGetStandbyRepurposed(v61);
...
LABEL_15:
  ...
  *(_QWORD *)(a1 + 136) += a3;
  ...
  if ( (*(_BYTE *)(a1 + 184) & 7) == 2 )
  {
    ...
    if ( v12 == 1 )
      qword_140C4F690 += a3;
    if ( qword_140C4F690 > (unsigned __int64)qword_140C4F698 )
      qword_140C4F698 = qword_140C4F690;
  }
  if ( (a4 & 2) != 0 )
  {
    *(_QWORD *)(a1 + 144) += a3;
  ...
  if ( (v21 & 7u) >= 2 )
  {
    v45 = *(_QWORD *)(qword_140C4E4C8 + 8LL * *(unsigned __int16 *)(a1 + 174));
    v46 = (v21 & 7u) - 2;
  ...
  if ( v22 && a3 )
  {
    do
    {
      ...
      if ( v25 == 7 )
      {
        ...
        v41 = *(_QWORD *)(qword_140C4E4C8 + 8 * v39);
        v42 = *(_QWORD *)(v41 + 6848);
        if ( v40 >= *(_QWORD *)(v42 + 56) )
        {
          ...
          if ( *(_QWORD *)(a1 + 24) )
          {
            ...
            if ( *(__int64 **)(v41 + 6856) != v43 )
            {
              ...
              if ( (BYTE6(PerfGlobalGroupMask) & 0x21) != 0 )
              {
                KiAcquireQueuedSpinLockInstrumented(&LockHandle, &qword_140C4ECC0);
              }
              else if ( _InterlockedExchange64((volatile __int64 *)&qword_140C4ECC0, (__int64)&LockHandle) )
              {
  ...
  if ( (unsigned __int64 *)result != &v81 )
  {
...
LABEL_42:
  ...
  if ( v22 )
  {
    ...
    if ( v88 < 0xFFFFF68000000000uLL || (result = 0xFFFFF6FFFFFFFFFFuLL, v88 > 0xFFFFF6FFFFFFFFFFuLL) )
    {
      ...
      v85 = v36;
      if ( MiPteInShadowRange((unsigned __int64)&v85) && (MiFlags & 0xC00000) != 0 )
      {
        Process = KeGetCurrentThread()->ApcState.Process;
        if ( Process->AddressPolicy != 1 && (v36 & 1) != 0 && ((v36 & 0x20) == 0 || (v36 & 0x42) == 0) )
        {
          Process = KeGetCurrentThread()->ApcState.Process;
          v78 = Process[1].ProcessListEntry.Flink;
          if ( v78 )
          {
            v79 = *((_QWORD *)&v78->Flink + (((unsigned __int64)&v85 >> 3) & 0x1FF));
            v80 = v36 | 0x20;
            Process = (_KPROCESS *)(unsigned __int8)v79;
