/*
 * XREFs of MiSwitchToPfns @ 0x140A43FB8
 * Callers:
...
char __fastcall MiSwitchToPfns(__int64 a1, __int64 a2, __int64 a3, _DWORD *a4)
{
  ULONG_PTR v5; // rdi
  __int64 *v6; // rsi
  __int64 *v7; // r14
  ...
  v31 = 0LL;
  v32 = 0LL;
  v5 = MmPfnDatabase + 48 * qword_140C52700;
  if ( !qword_140C52700 && !*(_WORD *)(v5 + 32) )
  {
    v20 = (unsigned __int8)MiLockPageInline(MmPfnDatabase + 48 * qword_140C52700, a2, a3, a4);
