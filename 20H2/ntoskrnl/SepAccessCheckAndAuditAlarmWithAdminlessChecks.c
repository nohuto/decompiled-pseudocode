/*
 * XREFs of SepAccessCheckAndAuditAlarmWithAdminlessChecks @ 0x1405E3AB0
 * Callers:
 *     SepAccessCheckAndAuditAlarm @ 0x1405E39EC (SepAccessCheckAndAuditAlarm.c)
 * Callees:
 ...
 *     RtlOwnerAcesPresent @ 0x140204EA0 (RtlOwnerAcesPresent.c)
 ...
 *     SepFilterToDiscretionary @ 0x14022AA44 (SepFilterToDiscretionary.c)
                            ...
                            if ( SepRmEnforceCap && *v45 >= 0 && v167 )
                            {
                              ...
                              while ( 1 )
                              {
                                ...
                                if ( !v193 )
                                {
                                  ...
                                  if ( (int)AuthzBasepInitializeResourceClaimsFromSacl((__int64)v200, &v193) < 0 )
                                    LODWORD(v28) = 1;
                                  v185 = (int)v28;
                                  v104 = v193;
                                }
...
LABEL_54:
                ...
                v27 = SepFilterCheck((__int64)v28, &v193, (__int64)ClientToken, 1, v207);
                if ( v27 >= 0 )
                {
