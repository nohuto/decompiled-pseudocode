/*
 * XREFs of CcInitializeBcbProfiler @ 0x140A1E354
 * Callers:
 *     CcInitializeCacheManager @ 0x140A3F638 (CcInitializeCacheManager.c)
 * Callees:
 *     KeInitializeTimer @ 0x140202F10 (KeInitializeTimer.c)
 ...
 *     RtlLookupFunctionTable @ 0x1403C536C (RtlLookupFunctionTable.c)
 ...
 *     KiGetLoadOptions @ 0x140A7744C (KiGetLoadOptions.c)
 */
...
char CcInitializeBcbProfiler()
{
  ...
  {
    v96 = 10878976;
    SubStr[0] = __ROL4__(10878976, 175);
    v97 = 4259840;
    SubStr[1] = __ROR4__(4259840, 176);
    v98 = -1946139983;
    SubStr[2] = __ROR4__(-1946157056, 25);
    v74 = 1130496;
    SubStr[3] = __ROL4__(1130496, 178);
    v75 = 34603008;
    SubStr[4] = __ROR4__(34603008, 179);
    v76 = 17288;
    SubStr[5] = __ROR4__(316, 34);
    v77 = 161792;
    SubStr[6] = __ROL4__(161792, 181);
    v78 = 352321536;
    SubStr[7] = __ROR4__(352321536, 182);
    v79 = 103095;
    SubStr[9] = 0;
    SubStr[8] = __ROR4__(118784, 43);
    ...
    if ( !PoolWithTag )
    {
      ...
      *((_QWORD *)&v5 + 1) = (((unsigned __int64)v5 ^ *((_QWORD *)&v5 + 1)) * (unsigned __int128)0x47AE147AE147AE15uLL) >> 64;
      ...
      v92 = v7;
      if ( v7 >= 0x32 )
        LODWORD(v4) = (unsigned int)sub_1405CB010;
      LOBYTE(v8) = v7 >= 0x32;
      v90 = v8;
...
LABEL_64:
        v91 = -805294751;
        KeBugCheckEx(__ROR4__(-805306349, 92), 6uLL, (ULONG_PTR)v9, v19, 0LL);
      }
      v11 = 0LL;
      v12 = 0;
          ...
          *(_QWORD *)&Dpc[2].Header.Lock = v43;
          ...
          if ( v7 >= 0x32 )
          {
            *(_QWORD *)&Dpc[2].Processor = 0LL;
            Dpc[3].Header.WaitListHead.Flink = (struct _LIST_ENTRY *)sub_1405CB010;
