/*
 * XREFs of MiAllocatePartitionPhysicalPages @ 0x1408DD1B8
 * Callers:
 ...
 *     MiHugeRangeIsZeroed @ 0x140531878 (MiHugeRangeIsZeroed.c)
        ...
        unsigned int a6)
{
  ...
  *(_OWORD *)&v53.m256i_u64[2] = 0LL;
  ...
  if ( (a5 & 0x200) == 0 )
  {
    if ( (int)MiAcquireNonPagedResources((unsigned __int64)v7, a3, 0LL, 0) < 0 )
      return 3221225626LL;
    v7 = v45;
    v9 = v56;
  }
  ...
  while ( 1 )
  {
    ...
    {
      LargeNodePage = MiFindLargeNodePage((__int64)v7, v8, (unsigned int *)&v54, 1, v14, 1, 1u);
      if ( !LargeNodePage )
      {
        v9 = v56;
        goto LABEL_39;
...
LABEL_30:
    ...
    if ( v45 == &MiSystemPartition && !v57 )
      _InterlockedExchangeAdd64(&qword_140C4EE38, v27);
    v9 = v56;
    v11 += v27;
    if ( v11 == v56 )
      goto LABEL_48;
...
LABEL_71:
  ...
  while ( 2 )
  {
    ...
    if ( v9 - v11 <= v38 )
      v39 = v9 - v11;
    PagesForMdl = MiAllocatePagesForMdl((int)v7, -(__int64)(v47 != 0) & 0x100000000LL, -1LL, v35, v39 << 12, 1, v8, v37);
