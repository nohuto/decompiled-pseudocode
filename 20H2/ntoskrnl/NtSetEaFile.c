...
NTSTATUS __cdecl NtSetEaFile(HANDLE FileHandle, PIO_STATUS_BLOCK IoStatusBlock, PVOID Buffer, ULONG Length)
{
  ...
  PMDL Mdl; // rcx
  char v31; // bl
  char v32; // [rsp+40h] [rbp-78h] BYREF
        ...
        if ( v21 )
        {
          ...
          if ( (Flags & 4) != 0 )
          {
            ...
            if ( Length )
            {
              ...
              v29 = IoCheckEaBufferValidity(PoolWithQuota, Length, &ErrorOffset);
              v35 = v29;
              if ( v29 < 0 )
              {
                v34 = 1;
          ...
          else
          {
            ...
            if ( (Flags & 0x10) != 0 )
            {
              if ( Length )
              {
                ...
                IopProbeAndLockPages_3((__int64)Mdl, v23, 0, (__int64)DeviceObject, v25->Header.Type);
              }
            }
            else
            {
          ...
          v31 = v32;
          result = IopSynchronousServiceTail(DeviceObject, Irp, (__int64)v12, 0, v23, v32, 2u);
          if ( !v31 )
