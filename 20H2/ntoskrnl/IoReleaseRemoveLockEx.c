/*
 * XREFs of IoReleaseRemoveLockEx @ 0x14030C8D0
 * Callers:
 *     ViFilterDeviceUsageNotificationCompletion @ 0x1409E80D0 (ViFilterDeviceUsageNotificationCompletion.c)
 *     ViFilterGenericCompletionRoutine @ 0x1409E86C0 (ViFilterGenericCompletionRoutine.c)
 *     ViFilterStartCompletionRoutine @ 0x1409E8730 (ViFilterStartCompletionRoutine.c)
 * Callees:
