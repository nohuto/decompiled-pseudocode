/*
 * XREFs of HvlCalculateLivedumpSize @ 0x1404F6FC0
 * Callers:
...
__int64 __fastcall HvlCalculateLivedumpSize(_QWORD *a1, _QWORD *a2, _QWORD *a3)
{
  ...
  if ( (HvlpRootFlags & 2) != 0 && (v3 = 0, qword_140C473E8) && HvlpHypervisorStatsPage )
  {
    v4 = VslVsmEnabled == 0;
    *a1 = (*(_QWORD *)(HvlpHypervisorStatsPage + 24)
    ...
    if ( v4 )
    {
      *a3 = (unsigned __int64)(unsigned int)dword_140C473F8 << 12;
      *a2 = 0LL;
    }
    else
    {
