/*
 * XREFs of MiCreateEnclaveRegions @ 0x140A538D0
 * Callers:
...
_BOOL8 __fastcall MiCreateEnclaveRegions(__int64 a1)
{
  ...
  qword_140C4ED30 = (__int64)&qword_140C4ED28;
  qword_140C4ED28 = (__int64)&qword_140C4ED28;
  v2 = 0LL;
  qword_140C4ED38 = 0LL;
  ExInitializePushLock(&stru_140C4ED40);
  v3 = (__int64 *)(a1 + 32);
...
LABEL_20:
    ...
    v11 = 1;
LABEL_15:
    RtlAvlInsertNodeEx((unsigned __int64 *)&qword_140C4ED00, (unsigned __int64)v12, v11, v2);
LABEL_16:
  ...
  return !qword_140C4ED00 || (unsigned int)MiInitializeEnclaveMetadataPage();
}
