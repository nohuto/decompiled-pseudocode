/*
 * XREFs of MmGetSessionIdEx @ 0x140220F10
 * Callers:
 ...
 *     IoGetRequestorSessionId @ 0x140330A30 (IoGetRequestorSessionId.c)
 ...
 *     KeRemoveSystemServiceTable @ 0x1408BD8D0 (KeRemoveSystemServiceTable.c)
