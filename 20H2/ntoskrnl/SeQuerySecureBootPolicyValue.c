/*
 * XREFs of SeQuerySecureBootPolicyValue @ 0x1407D0F20
 * Callers:
 *     <none>
 * Callees:
 *     memmove @ 0x140411040 (memmove.c)
 *     SepSecureBootFindMatchingRegistryRule @ 0x140926C20 (SepSecureBootFindMatchingRegistryRule.c)
 *     SepSecureBootGetPolicyValueByRef @ 0x140926D50 (SepSecureBootGetPolicyValueByRef.c)
 */
  ...
  if ( qword_140CF4C78 )
  {
    ...
    if ( MatchingRegistryRule )
    {
      PolicyValueByRef = SepSecureBootGetPolicyValueByRef(
                           qword_140CF9F28 + *(unsigned int *)(MatchingRegistryRule + 12),
                           a3,
                           &Src,
                           &Size);
