/*
 * XREFs of MiReplaceLockedPage @ 0x14053BC6C
 * Callers:
...
__int64 __fastcall MiReplaceLockedPage(__int64 a1, ULONG_PTR a2, unsigned __int64 a3, unsigned int a4, int a5)
{
  ...
  Page = MiGetPage(
           *(_QWORD *)(qword_140C4E4C8 + 8 * ((*(_QWORD *)(a2 + 40) >> 39) & 0x3FFLL)),
           (PfnChannel << byte_140C4DD0D) | (v9 << byte_140C4DD0C) | (unsigned int)((__int64)(a2 + 0x58000000000LL) / 48) & dword_140C4DD78,
           a4);
  if ( Page == -1 )
    return 0LL;
