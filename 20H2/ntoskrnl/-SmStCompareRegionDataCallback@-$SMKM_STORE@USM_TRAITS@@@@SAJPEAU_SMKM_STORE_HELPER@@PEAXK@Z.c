/*
 * XREFs of ?SmStCompareRegionDataCallback@?$SMKM_STORE@USM_TRAITS@@@@SAJPEAU_SMKM_STORE_HELPER@@PEAXK@Z @ 0x1403261A0
 * Callers:
        ...
        struct _MDL *a4)
{
  ...
  v12 = SMKM_STORE<SM_TRAITS>::SmStMapRegion(v7, v11, 0, (_DWORD)a4, 64);
  if ( v12 > 3 )
  {
LABEL_7:
      ...
      while ( 1 )
      {
        ...
        if ( v6 )
        {
          ...
          if ( v6 != v12 )
          {
            if ( (*(_BYTE *)(v7 + 6021) & 4) != 0 )
            {
              SMKM_STORE<SM_TRAITS>::SmStUnmapVirtualRegion(v7, v8, (_DWORD)a3, (_DWORD)a4, v21, 8);
            }
            else
            {
              v16 = *(_QWORD *)(v7 + 6216);
...
LABEL_24:
  if ( (*(_BYTE *)(v7 + 6021) & 4) != 0 && v12 > 3 )
    SMKM_STORE<SM_TRAITS>::SmStUnmapVirtualRegion(v7, *(_DWORD *)a2, (_DWORD)a3, (_DWORD)a4, v21, 8);
  if ( v6 > 3 && v6 != v12 )
  {
    if ( (*(_BYTE *)(v7 + 6021) & 4) != 0 )
    {
