/*
 * XREFs of PfSnGetSectionObject @ 0x140634038
 * Callers:
 ...
 *     PfSnIsSectionPrefetchedAfterPhase @ 0x1406343E4 (PfSnIsSectionPrefetchedAfterPhase.c)
  ...
  if ( (*(_QWORD *)(v19 + 24) & 0x400000000LL) == 0 )
  {
    ...
    if ( v20 < 0
      || (v20 = PfpFileCheckAttributesForPrefetch(
                  ...
                  (((dword_140C50130 & 0x10) == 0) << 14) + 4864),
          v20 < 0) )
    {
