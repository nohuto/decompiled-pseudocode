/*
 * XREFs of RtlIoDecodeMemIoResource @ 0x14037CFC0
 * Callers:
 *     PnpFilterResourceRequirementsList @ 0x1407A4A2C (PnpFilterResourceRequirementsList.c)
 *     IopGenericUnpackRequirement @ 0x1407C0FF0 (IopGenericUnpackRequirement.c)
 *     IopGenericScoreRequirement @ 0x1407C3F80 (IopGenericScoreRequirement.c)
 * Callees:
 *     <none>
 */
