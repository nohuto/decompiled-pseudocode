/*
 * XREFs of PopHandleNextState @ 0x1409960D0
 * Callers:
 ...
 *     KeRestoreIptStateAfterProcessorComesOnline @ 0x140382F6C (KeRestoreIptStateAfterProcessorComesOnline.c)
 *     KeSaveIptStateBeforeProcessorGoesOffline @ 0x140383658 (KeSaveIptStateBeforeProcessorGoesOffline.c)
...
void __fastcall PopHandleNextState(__int64 a1, __int64 a2)
{
  ...
  *(_DWORD *)a2 = v6;
  ...
  {
    case 2:
      PopFxNotifySystemStateTransition((__int64)CurrentPrcb, 1, dword_140C23320);
      break;
    case 3:
    ...
    case 13:
      ...
      break;
    case 14:
      PopFxNotifySystemStateTransition((__int64)CurrentPrcb, 0, dword_140C23320);
      break;
    case 15:
      if ( *(_BYTE *)(a2 + 5) )
