/*
 * XREFs of MiFindPagesForMdl @ 0x140334FBC
 * Callers:
...
LABEL_3:
  ...
  v6 = (_DWORD *)(qword_140C4DD18 + 4LL * (unsigned int)(unsigned __int16)KeNumberNodes * v11);
...
LABEL_4:
  ...
  if ( (v8 & 0x10052) == 0x10000 )
  {
    result = MiAllocateMdlPagesByLists(
               ...
               *((_DWORD *)a1 + 15),
               a1[3],
               a1[5] - ((unsigned __int64)*(unsigned int *)(v5 + 40) >> 12),
               *((_DWORD *)a1 + 14));
    if ( (_DWORD)result == 1 )
      return result;
    v8 &= ~0x10000u;
