/*
 * XREFs of MiTrimSection @ 0x1403545B0
 * Callers:
...
__int64 __fastcall MiTrimSection(__int64 a1, int a2, int a3)
{
  ...
  if ( (a3 & 1) != 0 && (!*(_QWORD *)(v7 + 64) || (*(_DWORD *)(v7 + 56) & 0x20) != 0) )
    return 3221225608LL;
  v38 = MiStartingOffset((__int64 *)v6, v4, 0xFFFFFFFF);
...
LABEL_9:
          if ( v43 || (a3 & 0x20) != 0 )
            v15 = (unsigned int)MiAnyProtosAreMapped(v6, (_QWORD *)v3) != 0 ? v15 : 0;
          if ( v15 )
          {
            v16 = *(_QWORD **)(v6 + 80);
            if ( v16 != (_QWORD *)(v6 + 80) )
