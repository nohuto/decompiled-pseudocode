/*
 * XREFs of RtlpHpLfhSubsegmentCreate @ 0x140309B20
 * Callers:
 ...
 *     RtlpHpLfhBucketComputeNewSubsegmentBlockCount @ 0x140309DE8 (RtlpHpLfhBucketComputeNewSubsegmentBlockCount.c)
...
__int64 __fastcall RtlpHpLfhSubsegmentCreate(__int64 a1, __int64 a2, unsigned int a3)
{
  ...
  if ( (a3 & 1) != 0 )
    ...
    v21 = RtlpHpAcquireLockShared((volatile LONG *)(a1 + 72), *(unsigned __int8 *)(a1 + 57));
