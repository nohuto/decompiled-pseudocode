/*
 * XREFs of PnpTraceDeviceRemovalForResetComplete @ 0x1408B4270
 * Callers:
...
void PnpTraceDeviceRemovalForResetComplete()
{
  ...
  if ( dword_140C02DC0 && tlgKeywordOn((__int64)&dword_140C02DC0, 0x400000000000LL) && v1 > 5 )
  {
    if ( tlgKeywordOn((__int64)&dword_140C02DC0, v0) )
    {
      v12 = 0;
      v14[1] = 0;
      v17 = 0;
      ...
      tlgWriteTransfer_EtwWriteTransfer(
        (__int64)&dword_140C02DC0,
        (unsigned __int8 *)byte_140024538,
        0LL,
        0LL,
        0xDu,
        &v9);
