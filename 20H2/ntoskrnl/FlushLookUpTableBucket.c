/*
 * XREFs of FlushLookUpTableBucket @ 0x140375838
 * Callers:
 ...
 *     FlattenEventEntryTree @ 0x140375C3C (FlattenEventEntryTree.c)
...
LABEL_9:
  ...
  *(_DWORD *)(a1 + 256) -= v14;
  ...
  while ( 1 )
  {
    ...
    if ( v12 )
      break;
    v21 = (unsigned __int64)&v17->LockEntries[v20];
    v19 &= ~(1 << v20);
    if ( (*(_BYTE *)(v21 + 26) & 1) != 0
      && (*(_DWORD *)(v21 + 32) & 1) == 0
      ...
      *(_BYTE *)(v21 + 26) &= ~1u;
      if ( *(_QWORD *)(v21 + 32) )
      {
        if ( v21 )
        {
          ...
          *(_DWORD *)(v21 + 88) = v23;
          *(_QWORD *)(v21 + 32) = 0LL;
          v24 = (__int64)(v21 - (unsigned __int64)v17->LockEntries) / 96;
          if ( v18 == 1 )
