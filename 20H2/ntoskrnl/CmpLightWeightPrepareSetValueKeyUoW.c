/*
 * XREFs of CmpLightWeightPrepareSetValueKeyUoW @ 0x1406A4758
 * Callers:
...
LABEL_28:
    ...
    v32 = v4 + 1;
    if ( !(unsigned __int8)CmpFindNameInList(v8, (int)v4 + 4, (unsigned int)&v31, 0, (__int64)&v35, (__int64)&v23)
      || (LODWORD(v22) = v15, v16 = CmpAddValueKeyNew(v8, v22, *(_DWORD *)(a1 + 72)), v16 == -1) )
    {
      v9 = -1073741670;
LABEL_27:
