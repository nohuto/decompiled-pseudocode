/*
 * XREFs of MmStoreLogCorruptionFixed @ 0x140553030
 * Callers:
...
void __fastcall MmStoreLogCorruptionFixed(char *a1, unsigned int a2, int a3)
{
  ...
  if ( *(_QWORD *)&qword_140C4ED60 )
  {
    ...
    {
      if ( tlgKeywordOn(*(__int64 *)&qword_140C4ED60, 0x400000000002LL) )
      {
        v21 = 0;
        v24 = 0;
        v27 = 0;
        ...
        v15 = v6;
        v17 = 0x1000000LL;
        tlgWriteEx_EtwWriteEx(v9, (unsigned __int8 *)&word_140025B2A, v7, 1u, v10, v11, 8u, &v18);
      }
    }
  }
}
