/*
 * XREFs of PopTraceThermalRequestActiveActivity @ 0x14038A324
 * Callers:
 ...
 *     PopDiagSnapActiveActivity @ 0x14038A5F4 (PopDiagSnapActiveActivity.c)
        ...
        if ( v11 )
        {
            ...
            && tlgKeywordOn((__int64)&dword_140C021E8, 0x400000000000LL) )
          {
            ...
            tlgWriteTransfer_EtwWriteTransfer(
              ...
              (unsigned __int8 *)&word_140027156,
              0LL,
              0LL,
              8u,
              &v15);
