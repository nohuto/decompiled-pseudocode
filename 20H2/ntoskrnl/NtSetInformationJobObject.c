/*
 * XREFs of NtSetInformationJobObject @ 0x140661780
 * Callers:
 *     <none>
 * Callees:
 ...
 *     KeAddGroupAffinityEx @ 0x1405119C0 (KeAddGroupAffinityEx.c)
 ...
 *     PspGetJobMemoryUsageNotificationViolations @ 0x140665F18 (PspGetJobMemoryUsageNotificationViolations.c)
 ...
 *     PspSetJobSiloThreadImpersonationPolicy @ 0x14090C084 (PspSetJobSiloThreadImpersonationPolicy.c)
...
LABEL_6:
  ...
  if ( PreviousMode )
  {
    ...
    if ( (_DWORD)v4 )
    {
      if ( ((dword_1409889BC[v5] - 1) & (unsigned int)Src) != 0 )
...
LABEL_159:
                ...
                v110 = (char *)BugCheckParameter2;
LABEL_422:
                PsReturnSharedPoolQuota(v110, 0x28uLL, 0LL);
                goto LABEL_35;
              }
            }
        ...
        if ( (_DWORD)v5 != 44 )
        {
          if ( (_DWORD)v5 != 45 )
          {
            if ( (_DWORD)v5 == 46 )
            {
              v168 = *v9;
              v14 = (char *)DeferredContext;
              v18 = PspSetEnergyTrackingStateJobTree((char *)DeferredContext, &v168);
              goto LABEL_64;
            }
            if ( (_DWORD)v5 != 47 )
              goto LABEL_459;
...
LABEL_446:
    ...
    {
      if ( !v190[10] && !v190[7] && !v190[2] || PspIsContextAdmin() )
      {
        v14 = (char *)DeferredContext;
