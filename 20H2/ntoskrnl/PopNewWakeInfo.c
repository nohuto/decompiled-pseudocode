/*
 * XREFs of PopNewWakeInfo @ 0x14099B33C
 * Callers:
...
LONG PopNewWakeInfo()
{
  ...
  if ( v1 )
  {
    ...
    {
      v7 = (_QWORD *)qword_140C24208;
      v8 = *(_QWORD **)(qword_140C24208 + 8);
      if ( *(__int64 **)qword_140C24208 == &PopWakeInfoList && *v8 == qword_140C24208 )
      {
        qword_140C24208 = *(_QWORD *)(qword_140C24208 + 8);
        *v8 = &PopWakeInfoList;
        v7[1] = v7;
        *v7 = v7;
