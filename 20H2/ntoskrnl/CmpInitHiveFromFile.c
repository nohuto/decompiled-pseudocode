/*
 * XREFs of CmpInitHiveFromFile @ 0x14064EC08
 * Callers:
        ...
        void *a10)
{
  ...
  if ( (unsigned int)dword_140C02130 > 4 )
  {
    if ( tlgKeywordOn((__int64)&dword_140C02130, 8LL) )
    {
      ...
      tlgWriteTransfer_EtwWriteTransfer(
        ...
        (unsigned __int8 *)byte_140021ACD,
        0LL,
        0LL,
        4u,
        &v59);
  ...
  while ( 1 )
  {
    *v10 = 0LL;
    ...
    {
      v35 = 1;
      v23 = CmpOpenHiveFile(Source, v34, v40, 0LL, (__int64)v17, 0LL);
...
LABEL_35:
  ...
  v26 = v32;
  if ( !v32 && (*(_DWORD *)(BugCheckParameter2 + 4152) & 0x800) != 0 )
  {
    CmpAttachToRegistryProcess(v58);
    v28 = CmpFlushHive(BugCheckParameter2);
  ...
  *(_QWORD *)(BugCheckParameter2 + 1840) = ExAllocatePoolWithTag(PagedPool, Source->Length, 0x624E4D43u);
  ...
  if ( ZwQueryInformationFile(v21, &IoStatusBlock, &FileInformation, 0x28u, FileBasicInformation) >= 0 )
    *(_QWORD *)(BugCheckParameter2 + 4224) = v56;
  *(_DWORD *)(BugCheckParameter2 + 184) = HIDWORD(v49);
...
LABEL_9:
  ...
  if ( (unsigned int)dword_140C02130 > 4 && tlgKeywordOn((__int64)&dword_140C02130, 8LL) )
  {
    ...
    v66 = 4;
    tlgWriteTransfer_EtwWriteTransfer((__int64)&dword_140C02130, (unsigned __int8 *)byte_140021AA3, 0LL, 0LL, 3u, &v64);
  }
