/*
 * XREFs of DmrFindDrhdForDeviceScope @ 0x1404E67EC
 * Callers:
 ...
 *     DmrCheckPathMatch @ 0x1404E68C8 (DmrCheckPathMatch.c)
 *     DmrGetNextRemappingStructure @ 0x1404E6A8C (DmrGetNextRemappingStructure.c)
 */
