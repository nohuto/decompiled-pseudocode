/*
 * XREFs of PiDevCfgConfigureDevice @ 0x140731D80
 * Callers:
 ...
 *     PiDevCfgConfigureDeviceDriver @ 0x140763EA0 (PiDevCfgConfigureDeviceDriver.c)
...
__int64 __fastcall PiDevCfgConfigureDevice(__int64 a1, __int64 a2, __int64 a3, int *a4, _DWORD *a5)
{
  ...
  __int64 v109; // [rsp+1D0h] [rbp+D0h] BYREF
  ...
  _QWORD v113[22]; // [rsp+220h] [rbp+120h] BYREF
...
LABEL_8:
  ...
  HIDWORD(v113[18]) = 2;
  DriverConfiguration = PiDevCfgQueryObjectProperties(2, v16, 2, (_DWORD)Handle, (__int64)v113, 4);
  if ( DriverConfiguration < 0 )
    goto LABEL_139;
  v17 = v68;
  DriverConfiguration = 0;
...
LABEL_33:
  if ( (*(_DWORD *)a2 & 1) == 0 )
  {
    ...
    LODWORD(v113[11]) = 18;
    HIDWORD(v113[13]) = 6;
    DriverConfiguration = PiDevCfgQueryObjectProperties(v39, v38, 1, v8, (__int64)v113, 3);
    if ( DriverConfiguration < 0 )
      goto LABEL_139;
    if ( SLODWORD(v113[4]) >= 0 )
      v71 = 1;
  ...
  if ( !v69 )
  {
    ...
    LODWORD(v113[1]) = 18;
    HIDWORD(v113[3]) = 6;
    DriverConfiguration = PiDevCfgQueryObjectProperties(v42, v41, 1, v8, (__int64)v113, 1);
    if ( DriverConfiguration < 0 )
      goto LABEL_139;
    if ( SLODWORD(v113[4]) < 0 )
...
LABEL_54:
  ...
  if ( a3 && v83.Buffer )
  {
    DriverConfiguration = PiDevCfgBuildIndirectString(a3, &v83, &UnicodeString, &v109);
    if ( DriverConfiguration < 0 )
      goto LABEL_139;
    ...
    if ( v110 )
    {
      DriverConfiguration = PiDevCfgSetObjectProperty(
                              ...
                              *(_QWORD *)(v7 + 8),
                              ...
                              18,
                              v110,
                              (unsigned int)(unsigned __int16)v109 + 2,
                              0);
      if ( DriverConfiguration < 0 )
        goto LABEL_139;
    }
  ...
  else if ( (*(_DWORD *)a2 & 1) == 0 )
  {
    ...
    LODWORD(v113[1]) = 18;
    HIDWORD(v113[3]) = 6;
    if ( (int)PiDevCfgQueryObjectProperties(v51, v50, 1, v8, (__int64)v113, 1) < 0
      || SLODWORD(v113[4]) < 0
      || !v83.Buffer )
    {
LABEL_293:
...
LABEL_69:
  if ( !v85.Buffer )
    goto LABEL_293;
  DriverConfiguration = PiDevCfgBuildIndirectString(a3, &v85, &UnicodeString, 0LL);
  if ( DriverConfiguration < 0 )
    goto LABEL_139;
  DriverConfiguration = PiDevCfgSetObjectProperty(
                          PiPnpRtlCtx,
