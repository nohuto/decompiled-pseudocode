/*
 * XREFs of MiUnlinkHugeRange @ 0x14053205C
 * Callers:
...
__int64 __fastcall MiUnlinkHugeRange(__int64 a1, int a2)
{
  ...
  if ( ((v9 >> 21) & 0x3FFFF) != 0 )
    v15 = (unsigned __int64 *)(qword_140C4E4F0 + 8 * ((v9 >> 21) & 0x3FFFF));
  *v15 = v9 & 0x3FFFF | *v15 & 0xFFFFFFFFFFFC0000uLL;
  if ( (v9 & 0x3FFFF) != 0 )
    v14 = (__int64 *)(qword_140C4E4F0 + 8 * (v9 & 0x3FFFF));
