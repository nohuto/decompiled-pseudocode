/*
 * XREFs of HalpBlkIdleLoop @ 0x140A1D530
 * Callers:
 *     HalpBlkProcessorStartup @ 0x140A1B010 (HalpBlkProcessorStartup.c)
 * Callees:
 *     HalpBlkIdleHalt @ 0x140A1B060 (HalpBlkIdleHalt.c)
 *     HalpBlkIdlePortReadHalt @ 0x140A1B070 (HalpBlkIdlePortReadHalt.c)
 *     HalpBlkIdlePortRead @ 0x140A1B080 (HalpBlkIdlePortRead.c)
 *     HalpBlkIdleMonitorMWait @ 0x140A1B090 (HalpBlkIdleMonitorMWait.c)
 */
