/*
 * XREFs of FsRtlNotifyFilterReportChange @ 0x1406B7570
 * Callers:
 *     FsRtlNotifyFullReportChange @ 0x140890140 (FsRtlNotifyFullReportChange.c)
 *     FsRtlNotifyReportChange @ 0x1408901A0 (FsRtlNotifyReportChange.c)
 * Callees:
 ...
 *     RtlxOemStringToUnicodeSize @ 0x14075C860 (RtlxOemStringToUnicodeSize.c)
...
LABEL_26:
                      ...
                      if ( (v34 & 2) != 0 && v16[5].Blink )
                      {
                        if ( v16[5].Flink )
                        {
                          PsReturnProcessPagedPoolQuota((ULONG_PTR)v16[7].Blink, HIDWORD(v16[6].Flink));
