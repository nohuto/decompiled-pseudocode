/*
 * XREFs of NtWaitForWorkViaWorkerFactory @ 0x140206490
 * Callers:
 *     <none>
 * Callees:
 ...
 *     KiReleaseKobjectLock @ 0x1402FB220 (KiReleaseKobjectLock.c)
 ...
 *     ExpWorkerFactoryWantsToCreate @ 0x14031EFC0 (ExpWorkerFactoryWantsToCreate.c)
...
LABEL_184:
        ...
        if ( v24
          && ($C774EFD68449142D8271B1EC1EB7FB26 *)v95->ApcState.ApcListHead[0].Flink != &v95->152
