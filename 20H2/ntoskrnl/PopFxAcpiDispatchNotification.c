/*
 * XREFs of PopFxAcpiDispatchNotification @ 0x14057C258
 * Callers:
 *     PoFxPlatformRequestHandler @ 0x1403C66C0 (PoFxPlatformRequestHandler.c)
 * Callees:
 ...
 *     PopFxAcpiValidateParameters @ 0x14057C834 (PopFxAcpiValidateParameters.c)
