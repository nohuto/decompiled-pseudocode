/*
 * XREFs of XmEmulateInterrupt @ 0x140395FCC
 * Callers:
...
__int64 __fastcall XmEmulateInterrupt(unsigned __int8 a1, __int64 a2)
{
  ...
  if ( !XmEmulatorInitialized )
    return 4LL;
  XmStatus = 0;
  word_140CED2DC = dword_140CED440;
  dword_140CED2C8 = HIWORD(dword_140CED440);
  v4 = x86BiosTranslateAddress((unsigned __int16)dword_140CED440, HIWORD(dword_140CED440));
  *(_WORD *)(v4 - 6) = -1;
  *(_DWORD *)(v4 - 4) = 0xFFFF;
  LOWORD(dword_140CED2C8) = dword_140CED2C8 - 6;
