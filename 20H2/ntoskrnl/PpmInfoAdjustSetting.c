/*
 * XREFs of PpmInfoAdjustSetting @ 0x1406FADA4
 * Callers:
 *     PpmSetProfilePolicySetting @ 0x1406F9E44 (PpmSetProfilePolicySetting.c)
 * Callees:
 *     PpmPerfComputePerfReductionTolerance @ 0x14056CD64 (PpmPerfComputePerfReductionTolerance.c)
 *     PpmInfoWriteData @ 0x1406FAE60 (PpmInfoWriteData.c)
 */
