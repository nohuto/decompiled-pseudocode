/*
 * XREFs of MiAddPhysicalMemoryChunks @ 0x1408C7C6C
 * Callers:
 *     MiActOnPartitionNodePages @ 0x14055EDD0 (MiActOnPartitionNodePages.c)
 *     MmAddPhysicalMemory @ 0x1408C8B60 (MmAddPhysicalMemory.c)
 ...
 *     MiGetLargestPageIndex @ 0x140328A50 (MiGetLargestPageIndex.c)
 *     MiPageToNode @ 0x14032E6F4 (MiPageToNode.c)
 *     MiRestrictRangeToNode @ 0x1403AB5C0 (MiRestrictRangeToNode.c)
 *     MiNodeLargeFreeZeroPages2 @ 0x140555290 (MiNodeLargeFreeZeroPages2.c)
...
__int64 __fastcall MiAddPhysicalMemoryChunks(ULONG_PTR *a1, unsigned __int64 *a2, _QWORD *a3, int a4)
{
  ...
  while ( 1 )
  {
    while ( 1 )
    {
      ...
      v31 = qword_140C50C10 + 4544LL * ((unsigned int)MiGetClosestImplicitNode(v15 + 1) - 1);
      if ( v11 < 0 )
      {
        v14 = v32;
        if ( v32 > 0x200 )
