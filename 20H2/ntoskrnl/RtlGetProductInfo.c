/*
 * XREFs of RtlGetProductInfo @ 0x14032EBE0
 * Callers:
 *     ExGetSuiteMask @ 0x1407B9930 (ExGetSuiteMask.c)
 *     ExpInitSystemPhase1 @ 0x140A3F33C (ExpInitSystemPhase1.c)
 * Callees:
 *     CompareVersions @ 0x14032ED20 (CompareVersions.c)
        ...
        PULONG ReturnedProductType)
{
  ...
  *ReturnedProductType = 0;
  ...
  v17 = xmmword_140011CC0;
  v16[2] = SpMajorVersion;
  v16[3] = SpMinorVersion;
  if ( (int)CompareVersions(v16, &v17) < 0 )
    return 0;
  if ( ZwQueryLicenseValue((PUNICODE_STRING)&stru_140001F10, &Type, &Data, 4u, &ResultDataSize) < 0
    || Type != 4
    || ResultDataSize != 4 )
  {
  ...
  if ( ZwQueryLicenseValue((PUNICODE_STRING)&stru_140001F00, &Type, v18, 0xC8u, &ResultDataSize) < 0 )
    goto LABEL_7;
