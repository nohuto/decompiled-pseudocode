/*
 * XREFs of KseInitialize @ 0x140A3ED1C
 * Callers:
 ...
 *     KsepMatchInitialize @ 0x140A953EC (KsepMatchInitialize.c)
 */
...
LABEL_29:
  ...
  v5 = _InterlockedCompareExchange(&dword_140C50464, 1, 0);
  if ( v5 == 2 )
    return 0LL;
  if ( v5 == 1 )
    return 259LL;
  ...
  else
  {
    if ( ViVerifierEnabled )
      dword_140C50468 |= 0x40u;
    if ( InitSafeBootMode )
      dword_140C50468 |= 0x100u;
    v8 = *(_QWORD *)(a1 + 240);
...
LABEL_34:
  ...
  {
    dword_140C2A924[2 * v11] = -1073741637;
