/*
 * XREFs of IoGetDeviceProperty @ 0x140668830
 * Callers:
...
LABEL_31:
  ...
  if ( !PoolWithTag )
    return -1073741670;
  DeviceRegProp = ObQueryNameStringMode(v51, (__int64)PoolWithTag, v48, ResultLength, 0);
