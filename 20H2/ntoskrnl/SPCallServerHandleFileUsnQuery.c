/*
 * XREFs of SPCallServerHandleFileUsnQuery @ 0x140724ABC
 * Callers:
...
LABEL_39:
  ...
  if ( v28 >= 0 )
  {
    ...
    v14 = FsRtlKernelFsControlFile(v29, 0x900F4u, 0LL, 0, PoolWithTag, 0x248u, (ULONG *)&v47);
    if ( v14 < 0 )
      goto LABEL_56;
...
LABEL_56:
    ...
    v37 = *(_QWORD *)&PoolWithTag->Type;
    if ( v29->WriteAccess )
    {
      v14 = FsRtlKernelFsControlFile(v29, 0x900EFu, 0LL, 0, PoolWithTag, 0x248u, (ULONG *)&v47);
      if ( v14 < 0 )
        goto LABEL_56;
...
LABEL_63:
    ...
    {
      v14 = FsRtlKernelFsControlFile(v29, 0x900EBu, 0LL, 0, PoolWithTag, 0x248u, (ULONG *)&v47);
      if ( v14 < 0 )
        goto LABEL_56;
      if ( (unsigned int)v47 < 0x40 )
        goto LABEL_63;
