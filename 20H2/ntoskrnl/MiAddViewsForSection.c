...
__int64 __fastcall MiAddViewsForSection(__int64 **BugCheckParameter2, unsigned __int64 a2, _DWORD *SchedulerAssist)
{
  ...
  int v96; // [rsp+70h] [rbp-29h] BYREF
  int v97; // [rsp+74h] [rbp-25h]
  __int64 v98; // [rsp+78h] [rbp-21h]
  __int64 v99; // [rsp+80h] [rbp-19h]
  ULONG_PTR BugCheckParameter1; // [rsp+88h] [rbp-11h]
  int v101; // [rsp+90h] [rbp-9h]
  __int64 v102; // [rsp+98h] [rbp-1h]
  _DWORD *v103; // [rsp+A0h] [rbp+7h]
  __int64 v104; // [rsp+A8h] [rbp+Fh]
  void *retaddr; // [rsp+F8h] [rbp+5Fh]
  int v106; // [rsp+100h] [rbp+67h]
  struct _KTHREAD *v107; // [rsp+100h] [rbp+67h]
  char v109; // [rsp+110h] [rbp+77h]
  unsigned __int8 AbAllocationRegionCount; // [rsp+110h] [rbp+77h]
  KIRQL v111; // [rsp+110h] [rbp+77h]
  unsigned __int8 v112; // [rsp+110h] [rbp+77h]
  ...
  v82 = CurrentIrql + 1;
  v104 = 0x7FFFFFFFFFFFFFFCLL;
  while ( 1 )
  {
    v99 = v7;
    if ( *(_QWORD *)(v7 + 8) )
      break;
    v101 = *(_DWORD *)(v7 + 52) & 0x3FFFFFFF;
    ...
    if ( !v106 )
    {
      ...
      while ( 1 )
      {
        ...
        if ( (*(_BYTE *)(v32 + 26) & 1) != 0
          && (*(_DWORD *)(v32 + 32) & 1) == 0
          && (v104 & *(_QWORD *)(v32 + 32)) == (BugCheckParameter2a & 0x7FFFFFFFFFFFFFFCLL)
      ...
      if ( active != -1073741302 )
      {
        ...
        if ( !v106 )
        {
          ...
          if ( (unsigned int)MiGetSystemRegionType(v49) == 1 )
            v50 = (unsigned int)MmGetSessionIdEx((__int64)v107->ApcState.Process);
          else
            v50 = 0xFFFFFFFFLL;
          v51 = (ULONG_PTR)v107;
          ...
          AbAllocationRegionCount = v107->AbAllocationRegionCount;
          v99 = BugCheckParameter2b & 0x7FFFFFFFFFFFFFFCLL;
          v53 = ((char)v107->AbEntrySummary | (char)v107->AbOrphanedEntrySummary) ^ 0x3F;
          ...
          while ( 1 )
          {
            v55 = (__int64)&v107->LockEntries[v54];
            v102 = v55;
            v53 &= ~(1 << v54);
            if ( (*(_BYTE *)(v55 + 26) & 1) != 0
              && (*(_DWORD *)(v55 + 32) & 1) == 0
              && (*(_QWORD *)(v55 + 32) & 0x7FFFFFFFFFFFFFFCLL) == v99
          ...
          {
LABEL_135:
            if ( (*((_DWORD *)&v107->0 + 1) & 0x10000) == 0 )
              KeBugCheckEx(0x162u, (ULONG_PTR)v107, BugCheckParameter2b, v50, 0LL);
          }
          else
          {
            *(_BYTE *)(v55 + 32) |= 2u;
    ...
    v98 = v7;
    if ( v106 != 1 || (*(_DWORD *)(v7 + 52) & 0x40000000) == 0 )
      goto LABEL_14;
    ExReleaseSpinLockExclusiveFromDpcLevel((PEX_SPIN_LOCK)v3 + 18);
    if ( KiIrqlFlags )
    {
...
LABEL_193:
  ...
  if ( !v106 )
  {
    ...
    if ( (unsigned int)MiGetSystemRegionType(v74) == 1 )
      v75 = MmGetSessionIdEx((__int64)v107->ApcState.Process);
    else
      v75 = -1;
    v51 = (ULONG_PTR)v107;
    --v107->SpecialApcDisable;
    ...
    v112 = v107->AbAllocationRegionCount;
    v76 = ((char)v107->AbEntrySummary | (char)v107->AbOrphanedEntrySummary) ^ 0x3F;
    ...
    {
      v78 = ~(1 << v77);
      v79 = (__int64)&v107->LockEntries[v77];
      v76 &= v78;
      v99 = v79;
      if ( (*(_BYTE *)(v79 + 26) & 1) != 0
        && (*(_DWORD *)(v79 + 32) & 1) == 0
        && (v104 & *(_QWORD *)(v79 + 32)) == (BugCheckParameter2c & 0x7FFFFFFFFFFFFFFCLL)
        && *(_DWORD *)(v79 + 40) == v75 )
      {
        *(_BYTE *)(v79 + 26) &= ~1u;
        if ( *(_QWORD *)(v79 + 32) )
...
LABEL_191:
      if ( (*((_DWORD *)&v107->0 + 1) & 0x10000) == 0 )
        KeBugCheckEx(0x162u, (ULONG_PTR)v107, BugCheckParameter2c, v75, 0LL);
    }
    else
    {
      *(_BYTE *)(v79 + 32) |= 2u;
...
LABEL_140:
    ...
    v19 = v107->SpecialApcDisable++ == -1;
    if ( v19 && ($C774EFD68449142D8271B1EC1EB7FB26 *)v107->ApcState.ApcListHead[0].Flink != &v107->152 )
      KiCheckForKernelApcDelivery();
    KiLeaveGuardedRegionUnsafe((__int64)CurrentThread);
  }
LABEL_144:
...
LABEL_145:
  if ( v98 )
  {
    v111 = ExAcquireSpinLockExclusive(v43);
    if ( (v5 & 5) == 0 )
      v4 = v97 | 8;
    v59 = MiDecrementSubsections((ULONG_PTR)BugCheckParameter2, v98, v4);
    ...
    if ( KiIrqlFlags && (KiIrqlFlags & 1) != 0 && (v60 = KeGetCurrentIrql(), v60 <= 0xFu) )
    {
      ...
      if ( v111 <= 0xFu && v60 >= 2u )
      {
        ...
        v63 = ~(unsigned __int16)(-1LL << (v111 + 1));
    ...
    __writecr8(v61);
    if ( v59 )
      MiReturnCrossPartitionSectionCharges(*(_QWORD *)(qword_140C4E4C8 + 8LL * (*((_WORD *)v3 + 30) & 0x3FF)), v48, v59);
    result = v113;
  }
  if ( (v5 & 1) != 0 )
  {
