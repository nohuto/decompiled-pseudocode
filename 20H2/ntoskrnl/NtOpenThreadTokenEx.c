/*
 * XREFs of NtOpenThreadTokenEx @ 0x14067E0B0
 * Callers:
 *     NtOpenThreadToken @ 0x14067E090 (NtOpenThreadToken.c)
 * Callees:
...
LABEL_9:
    ...
    if ( v27 )
    {
      ...
      *((_QWORD *)&v41 + 1) = 0LL;
      ...
      inserted = ObInsertObjectEx((PADAPTER_OBJECT)v33, 0LL, DesiredAccess, 0, 0, 0LL, &Handle);
    }
    else
    {
