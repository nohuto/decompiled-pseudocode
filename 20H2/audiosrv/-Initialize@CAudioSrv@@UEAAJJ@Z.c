/*
 * XREFs of ?Initialize@CAudioSrv@@UEAAJJ@Z @ 0x180062A80
 * Callers:
 *     <none>
 * Callees:
 ...
 *     ??0CAudioDGProcess@@QEAA@PEAUIMonitorDGTermination@@@Z @ 0x1800629FC (--0CAudioDGProcess@@QEAA@PEAUIMonitorDGTermination@@@Z.c)
