/*
 * XREFs of AudioVolumeAddMasterVolumeNotification @ 0x180053C30
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall AudioVolumeAddMasterVolumeNotification(__int64 *a1)
{
  ...
  CWatchdogTimer<1>::CWatchdogTimer<1>(pv, v2[1], v3, (struct _TP_TIMER *)L"AudioVolumeAddMasterVolumeNotification");
  v4 = *a1;
