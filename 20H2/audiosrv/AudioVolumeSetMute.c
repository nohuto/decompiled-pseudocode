/*
 * XREFs of AudioVolumeSetMute @ 0x1800C4B00
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall AudioVolumeSetMute(__int64 a1, unsigned int a2, __int64 a3, __int64 a4)
{
  _QWORD *v7; // rbx
  ...
  CWatchdogTimer<1>::CWatchdogTimer<1>(pv, v8[1], v9, (struct _TP_TIMER *)L"AudioVolumeSetMute");
  LODWORD(v7) = (*(__int64 (__fastcall **)(_QWORD, _QWORD, __int64, __int64))(*(_QWORD *)*v7 + 144LL))(*v7, a2, a3, a4);
