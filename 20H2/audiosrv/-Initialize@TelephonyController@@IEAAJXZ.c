/*
 * XREFs of ?Initialize@TelephonyController@@IEAAJXZ @ 0x1801418F8
 * Callers:
 ...
 *     ?AddTail@?$CAtlList@IV?$CElementTraits@I@ATL@@@ATL@@QEAAPEAU__POSITION@@I@Z @ 0x180140D80 (-AddTail@-$CAtlList@IV-$CElementTraits@I@ATL@@@ATL@@QEAAPEAU__POSITION@@I@Z.c)
 ...
 *     ?SetAt@?$CAtlMap@IV?$CComPtr@UIKsControl@@@ATL@@V?$CElementTraits@I@2@V?$CElementTraits@V?$CComPtr@UIKsControl@@@ATL@@@2@@ATL@@QEAAPEAU__POSITION@@IAEBV?$CComPtr@UIKsControl@@@2@@Z @ 0x180142990 (-SetAt@-$CAtlMap@IV-$CComPtr@UIKsControl@@@ATL@@V-$CElementTraits@I@2@V-$CElementTraits@V-$CComP.c)
 */
...
__int64 __fastcall TelephonyController::Initialize(TelephonyController *this)
{
  ...
  struct IKsControl *v13; // [rsp+48h] [rbp-71h] BYREF
  ...
  GUID v31; // [rsp+D0h] [rbp+17h] BYREF
