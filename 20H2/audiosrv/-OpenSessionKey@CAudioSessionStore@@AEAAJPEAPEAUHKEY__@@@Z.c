/*
 * XREFs of ?OpenSessionKey@CAudioSessionStore@@AEAAJPEAPEAUHKEY__@@@Z @ 0x180051CEC
 * Callers:
 ...
 *     ?IsEqual@CAudioSessionStore@@UEAA_NPEBG@Z @ 0x180051F20 (-IsEqual@CAudioSessionStore@@UEAA_NPEBG@Z.c)
