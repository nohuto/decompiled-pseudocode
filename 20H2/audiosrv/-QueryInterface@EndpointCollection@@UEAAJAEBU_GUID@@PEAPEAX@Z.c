/*
 * XREFs of ?QueryInterface@EndpointCollection@@UEAAJAEBU_GUID@@PEAPEAX@Z @ 0x180056800
 * Callers:
 *     ?QueryInterface@EndpointCollection@@W7EAAJAEBU_GUID@@PEAPEAX@Z @ 0x1800750A0 (-QueryInterface@EndpointCollection@@W7EAAJAEBU_GUID@@PEAPEAX@Z.c)
 * Callees:
