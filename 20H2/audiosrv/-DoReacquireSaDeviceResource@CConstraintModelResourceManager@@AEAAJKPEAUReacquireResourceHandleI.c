/*
 * XREFs of ?DoReacquireSaDeviceResource@CConstraintModelResourceManager@@AEAAJKPEAUReacquireResourceHandleInfo@@@Z @ 0x1800F2C68
 * Callers:
 ...
 *     WPP_SF_ddI @ 0x1800F57C0 (WPP_SF_ddI.c)
 *     WPP_SF_ddID @ 0x1800F582C (WPP_SF_ddID.c)
