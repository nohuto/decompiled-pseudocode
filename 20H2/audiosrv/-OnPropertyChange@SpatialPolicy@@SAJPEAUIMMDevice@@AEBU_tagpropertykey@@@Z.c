/*
 * XREFs of ?OnPropertyChange@SpatialPolicy@@SAJPEAUIMMDevice@@AEBU_tagpropertykey@@@Z @ 0x18001D7D0
 * Callers:
...
__int64 __fastcall SpatialPolicy::OnPropertyChange(struct IMMDevice *a1, const struct _tagpropertykey *a2)
{
  ...
  if ( dword_18019EDBC > *(_DWORD *)(*((_QWORD *)NtCurrentTeb()->ThreadLocalStoragePointer + (unsigned int)tls_index)
                                   + 4LL) )
  {
    Init_thread_header(&dword_18019EDBC);
    if ( dword_18019EDBC == -1 )
    {
      xmmword_18019E460 = (__int128)GUID_00000000_0000_0000_0000_000000000000;
      dword_18019E470 = 0;
      Init_thread_footer(&dword_18019EDBC);
    }
  }
  v4 = xmmword_18019E460 - *(_QWORD *)&GUID_00000000_0000_0000_0000_000000000000.Data1;
  if ( (_QWORD)xmmword_18019E460 == *(_QWORD *)&GUID_00000000_0000_0000_0000_000000000000.Data1 )
    v4 = *((_QWORD *)&xmmword_18019E460 + 1) - *(_QWORD *)GUID_00000000_0000_0000_0000_000000000000.Data4;
  if ( !v4 )
  {
    xmmword_18019E460 = PKEY_SpatialAudio_Signaling_Key;
    dword_18019E470 = 2;
  }
  ...
  if ( dword_18019D844 )
    return 0LL;
  v5 = *(_QWORD *)&a2->fmtid.Data1 - xmmword_18019E460;
  if ( *(_QWORD *)&a2->fmtid.Data1 == (_QWORD)xmmword_18019E460 )
    v5 = *(_QWORD *)a2->fmtid.Data4 - *((_QWORD *)&xmmword_18019E460 + 1);
  if ( v5 || a2->pid != dword_18019E470 )
    return 0LL;
  v16 = 0LL;
