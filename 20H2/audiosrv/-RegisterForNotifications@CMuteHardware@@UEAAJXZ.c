/*
 * XREFs of ?RegisterForNotifications@CMuteHardware@@UEAAJXZ @ 0x180068D30
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall CMuteHardware::RegisterForNotifications(CMuteHardware *this)
{
  ...
  {
    WPP_SF_q(*((_QWORD *)WPP_GLOBAL_Control + 2), 18LL, &WPP_a111594f2af03e3a71e6f1c2b278efda_Traceguids, this);
  }
