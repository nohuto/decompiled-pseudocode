/*
 * XREFs of ?Create@CSystemEffectWrapper@@SAJAEBU_GUID@@PEAUIMMDevice@@PEBGW4APO_TYPE@@PEAUIUnknown@@PEAPEAU5@@Z @ 0x18012FB54
 * Callers:
 ...
 * Callees:
 *     ??0CSystemEffectWrapper@@QEAA@XZ @ 0x18012F360 (--0CSystemEffectWrapper@@QEAA@XZ.c)
