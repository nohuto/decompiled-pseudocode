/*
 * XREFs of PolicyConfigSetDeviceFormat @ 0x1800D9A10
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall PolicyConfigSetDeviceFormat(__int64 a1, void *a2, unsigned __int16 *a3)
{
  ...
  CWatchdogTimer<1>::CWatchdogTimer<1>(pv, v6[1], v7, (struct _TP_TIMER *)L"PolicyConfigSetDeviceFormat");
  v22 = 0LL;
