/*
 * XREFs of ??0CExclusiveModeListener@@QEAA@XZ @ 0x180105654
 * Callers:
 ...
 *     ??0CSpatialAudioResourceManagerTraceLogger@@QEAA@XZ @ 0x180066EC8 (--0CSpatialAudioResourceManagerTraceLogger@@QEAA@XZ.c)
