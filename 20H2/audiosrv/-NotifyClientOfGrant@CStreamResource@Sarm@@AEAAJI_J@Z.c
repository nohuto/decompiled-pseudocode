/*
 * XREFs of ?NotifyClientOfGrant@CStreamResource@Sarm@@AEAAJI_J@Z @ 0x18010B5B0
 * Callers:
...
__int64 __fastcall Sarm::CStreamResource::NotifyClientOfGrant(Sarm::CStreamResource *this, unsigned int a2, __int64 a3)
{
  ...
  if ( v6 >= 0 )
  {
    ...
    {
      if ( tlgKeywordOn((__int64)&dword_18019C350, 0x400000000000LL) )
      {
        v16 = *((_DWORD *)this + 13);
        v13 = (__int64)this + 16;
        v14[0] = *((_QWORD *)this + 5);
