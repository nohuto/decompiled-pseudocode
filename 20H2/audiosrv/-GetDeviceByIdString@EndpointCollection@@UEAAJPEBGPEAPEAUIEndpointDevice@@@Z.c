/*
 * XREFs of ?GetDeviceByIdString@EndpointCollection@@UEAAJPEBGPEAPEAUIEndpointDevice@@@Z @ 0x18013E070
 * Callers:
 *     <none>
 * Callees:
        ...
        struct IEndpointDevice **a3)
{
  ...
  _QWORD *v17; // [rsp+28h] [rbp-8h] BYREF
      ...
      *a3 = 0LL;
      ...
      if ( v9 >= 0 )
      {
        while ( 1 )
        {
          ...
          v9 = (*(__int64 (__fastcall **)(_QWORD *, __int64 *))(*v17 + 24LL))(v17, &v18);
          if ( v9 < 0 )
            break;
          v7 = v18;
          if ( !v18 )
...
LABEL_26:
  ...
  if ( v17 )
    (*(void (__fastcall **)(_QWORD *, _QWORD, EndpointCollection *))(*v17 + 16LL))(v17, *v17, v5);
  return v6;
}
