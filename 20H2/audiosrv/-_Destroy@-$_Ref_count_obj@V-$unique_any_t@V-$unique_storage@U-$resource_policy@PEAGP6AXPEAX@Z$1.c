/*
 * XREFs of ?_Destroy@?$_Ref_count_obj@V?$unique_any_t@V?$unique_storage@U?$resource_policy@PEAGP6AXPEAX@Z$1?CoTaskMemFree@@YAX0@ZU?$integral_constant@_K$0A@@wistd@@PEAGPEAG$0A@$$T@details@wil@@@details@wil@@@wil@@@std@@EEAAXXZ @ 0x1800D8C50
 * Callers:
 *     <none>
 * Callees:
 *     <none>
