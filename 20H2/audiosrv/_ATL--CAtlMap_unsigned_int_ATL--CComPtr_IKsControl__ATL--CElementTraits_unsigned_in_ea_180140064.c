/*
 * XREFs of _ATL::CAtlMap_unsigned_int_ATL::CComPtr_IKsControl__ATL::CElementTraits_unsigned_int__ATL::CElementTraits_ATL::CComPtr_IKsControl_____::NewNode_::_1_::catch$0 @ 0x180140064
 * Callers:
 *     <none>
 * Callees:
