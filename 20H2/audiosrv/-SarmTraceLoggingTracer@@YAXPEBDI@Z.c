/*
 * XREFs of ?SarmTraceLoggingTracer@@YAXPEBDI@Z @ 0x18010A020
 * Callers:
 ...
 *     ?HandleAppVolumePolicyChange@CSpatialAudioResourceManager@Sarm@@AEAAXK@Z @ 0x180106CFC (-HandleAppVolumePolicyChange@CSpatialAudioResourceManager@Sarm@@AEAAXK@Z.c)
