/*
 * XREFs of ??1?$CAutoPtrList@VPhoneTopologyWorkItem@@@ATL@@QEAA@XZ @ 0x18013EA5C
 * Callers:
 *     _PhoneTopology::PhoneTopology_::_1_::dtor$3 @ 0x18007A201 (_PhoneTopology--PhoneTopology_--_1_--dtor$3.c)
 * Callees:
 *     <none>
 */
