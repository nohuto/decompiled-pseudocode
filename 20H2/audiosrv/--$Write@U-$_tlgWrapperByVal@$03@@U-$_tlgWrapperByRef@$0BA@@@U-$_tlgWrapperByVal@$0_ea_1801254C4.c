        ...
        void **a19)
{
  ...
  v33 = 16LL;
  v31 = 4LL;
  return tlgWriteTransfer_EtwEventWriteTransfer((__int64)&dword_18019C448, a2, 0LL, 0LL, 17, (__int64)v29);
}
