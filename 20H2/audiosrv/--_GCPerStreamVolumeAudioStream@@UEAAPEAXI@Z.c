/*
 * XREFs of ??_GCPerStreamVolumeAudioStream@@UEAAPEAXI@Z @ 0x18004ECA0
 * Callers:
 *     ??_ECPerStreamVolumeAudioStream@@WCA@EAAPEAXI@Z @ 0x180074470 (--_ECPerStreamVolumeAudioStream@@WCA@EAAPEAXI@Z.c)
 * Callees:
