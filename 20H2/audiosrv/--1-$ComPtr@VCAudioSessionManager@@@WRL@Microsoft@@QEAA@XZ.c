/*
 * XREFs of ??1?$ComPtr@VCAudioSessionManager@@@WRL@Microsoft@@QEAA@XZ @ 0x1800D0A4C
 * Callers:
 *     _Microsoft::WRL::Details::MakeAndInitialize_CAudioSessionManager_CAudioSessionManager_unsigned_short_const___&__::_1_::dtor$2 @ 0x18007A327 (_Microsoft--WRL--Details--MakeAndInitialize_CAudioSessionManager_CAudioSessionManag_ea_18007A327.c)
 * Callees:
