/*
 * XREFs of ?MyServiceInitialization@@YAKPEAUSERVICE_STATUS_HANDLE__@@KPEAPEBG@Z @ 0x180061F30
 * Callers:
 *     ServiceStart @ 0x180061DF0 (ServiceStart.c)
 * Callees:
 *     ?InitializeAudioThreadpool@@YAJXZ @ 0x1800620F8 (-InitializeAudioThreadpool@@YAJXZ.c)
 *     McGenEventRegister_EtwEventRegister @ 0x180062200 (McGenEventRegister_EtwEventRegister.c)
