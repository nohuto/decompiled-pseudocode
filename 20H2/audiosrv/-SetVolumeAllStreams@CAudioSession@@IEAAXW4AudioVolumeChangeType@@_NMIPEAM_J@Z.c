/*
 * XREFs of ?SetVolumeAllStreams@CAudioSession@@IEAAXW4AudioVolumeChangeType@@_NMIPEAM_J@Z @ 0x180037C18
 * Callers:
 *     ?UpdateAudioVolume@CPerStreamVolumeAudioSession@@EEAAJW4AudioVolumeChangeType@@_NMIPEAM_J@Z @ 0x180037BE0 (-UpdateAudioVolume@CPerStreamVolumeAudioSession@@EEAAJW4AudioVolumeChangeType@@_NMIPEAM_J@Z.c)
        ...
        __int64 a6)
{
  ...
  {
    WPP_SF_q(*((_QWORD *)WPP_GLOBAL_Control + 2), 77LL, &WPP_7cf3fc3344fb31d0ce2bf36427d5d6eb_Traceguids, a1);
  }
  ...
  if ( *(_QWORD *)(a1 + 104) )
  {
    ...
    while ( 1 )
    {
      ...
      if ( WPP_GLOBAL_Control != (CAudioSessionManager *)&WPP_GLOBAL_Control
        ...
        && *((_BYTE *)WPP_GLOBAL_Control + 25) >= 5u )
      {
        WPP_SF_qq(*((_QWORD *)WPP_GLOBAL_Control + 2), 78LL, &WPP_7cf3fc3344fb31d0ce2bf36427d5d6eb_Traceguids, a1, v11);
      }
      if ( a2 == 3 )
