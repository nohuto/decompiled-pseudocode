/*
 * XREFs of ?OnNotify@CPerEndpointVolumeAudioSession@@EEAAJPEAUAUDIO_VOLUME_NOTIFICATION_DATA@@@Z @ 0x1800C9310
 * Callers:
 *     <none>
 * Callees:
 ...
 *     WPP_SF_qdgg @ 0x1800C24D4 (WPP_SF_qdgg.c)
 *     WPP_SF_q_guid__guid_ @ 0x1800CB2E4 (WPP_SF_q_guid__guid_.c)
 *     WPP_SF_qdd @ 0x1800CB358 (WPP_SF_qdd.c)
 *     WPP_SF_qgg_HEX__HEX_ @ 0x1800CB3B8 (WPP_SF_qgg_HEX__HEX_.c)
 */
