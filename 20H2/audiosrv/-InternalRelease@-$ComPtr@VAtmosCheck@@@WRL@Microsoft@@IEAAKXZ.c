/*
 * XREFs of ?InternalRelease@?$ComPtr@VAtmosCheck@@@WRL@Microsoft@@IEAAKXZ @ 0x1800473A8
 * Callers:
 ...
 *     _dynamic_atexit_destructor_for__CSpatialAudioTech::s_spAtmosCheck__ @ 0x18007CED0 (_dynamic_atexit_destructor_for__CSpatialAudioTech--s_spAtmosCheck__.c)
