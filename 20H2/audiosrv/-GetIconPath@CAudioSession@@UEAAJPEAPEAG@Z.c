/*
 * XREFs of ?GetIconPath@CAudioSession@@UEAAJPEAPEAG@Z @ 0x1800C7BA0
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall CAudioSession::GetIconPath(CAudioSession *this, unsigned __int16 **a2)
{
  ...
  {
    WPP_SF_S(*((_QWORD *)WPP_GLOBAL_Control + 2), 0xBu, (__int64)&WPP_7cf3fc3344fb31d0ce2bf36427d5d6eb_Traceguids, v5);
  }
