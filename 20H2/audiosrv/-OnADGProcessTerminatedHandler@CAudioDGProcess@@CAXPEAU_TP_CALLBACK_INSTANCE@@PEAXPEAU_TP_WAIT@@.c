/*
 * XREFs of ?OnADGProcessTerminatedHandler@CAudioDGProcess@@CAXPEAU_TP_CALLBACK_INSTANCE@@PEAXPEAU_TP_WAIT@@J@Z @ 0x18012D9B0
 * Callers:
 *     <none>
 * Callees:
        ...
        __int64 a4)
{
  ...
  v4 = dword_18019C4B8;
  v5 = a4;
  if ( (unsigned int)dword_18019C4B8 > 2 && tlgKeywordOn((__int64)&dword_18019C4B8, 0x400000000000LL) )
  {
    v13 = 0;
    v11 = &v8;
    v8 = 0x1000000LL;
    ...
    tlgWriteTransfer_EventWriteTransfer(
      ...
      (unsigned __int8 *)dword_18016C1E0,
      0LL,
      0LL,
      3u,
      &v10);
