/*
 * XREFs of ?CreateInstance@EndpointCollection@@SAJPEAPEAUIEndpointCollection@@@Z @ 0x180056764
 * Callers:
 ...
 *     ??0EndpointCollection@@IEAA@XZ @ 0x180056864 (--0EndpointCollection@@IEAA@XZ.c)
