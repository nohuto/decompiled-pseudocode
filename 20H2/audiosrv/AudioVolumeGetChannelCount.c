/*
 * XREFs of AudioVolumeGetChannelCount @ 0x1800C4530
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall AudioVolumeGetChannelCount(__int64 a1, __int64 a2)
{
  _QWORD *v3; // rbx
  ...
  CWatchdogTimer<1>::CWatchdogTimer<1>(pv, v4[1], v5, (struct _TP_TIMER *)L"AudioVolumeGetChannelCount");
  LODWORD(v3) = (*(__int64 (__fastcall **)(_QWORD, __int64))(*(_QWORD *)*v3 + 48LL))(*v3, a2);
