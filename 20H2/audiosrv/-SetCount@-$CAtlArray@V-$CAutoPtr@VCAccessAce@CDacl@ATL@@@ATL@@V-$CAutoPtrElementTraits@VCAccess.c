/*
 * XREFs of ?SetCount@?$CAtlArray@V?$CAutoPtr@VCAccessAce@CDacl@ATL@@@ATL@@V?$CAutoPtrElementTraits@VCAccessAce@CDacl@ATL@@@2@@ATL@@QEAA_N_KH@Z @ 0x180036300
 * Callers:
 ...
 *     ?RemoveAllAces@CDacl@ATL@@UEAAXXZ @ 0x180047330 (-RemoveAllAces@CDacl@ATL@@UEAAXXZ.c)
 * Callees:
