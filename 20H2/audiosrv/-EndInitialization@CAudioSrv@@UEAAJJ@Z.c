/*
 * XREFs of ?EndInitialization@CAudioSrv@@UEAAJJ@Z @ 0x1800639E0
 * Callers:
 *     <none>
 * Callees:
...
LABEL_23:
  ...
  *((_DWORD *)this + 27) = 1;
  ...
  if ( LastError )
    goto LABEL_24;
  LastError = StartRpcServer((unsigned __int16 *)this, L"Audiosrv", &unk_1801495A0, SecurityDescriptor);
  *((_DWORD *)this + 14) = LastError == 0;
  if ( LastError
    || (LastError = StartRpcServer((unsigned __int16 *)this, L"PlaybackManagerRpc", &unk_180149540, 0LL),
        *((_DWORD *)this + 15) = LastError == 0,
        LastError)
    || (LastError = StartRpcServer((unsigned __int16 *)this, L"AudioSrvDiagnosticsRpc", &unk_1801494E0, 0LL),
...
LABEL_24:
    ...
    if ( *v8 > 2u && (unsigned __int8)tlgKeywordOn(v8, 0x400000000000LL) )
    {
      ...
      v17 = 4;
      v18 = 0;
      tlgWriteTransfer_EtwEventWriteTransfer(v9, byte_18016613B, 0LL, 0LL, 3, (__int64)v15);
    }
    goto LABEL_18;
  }
  pcbData = 4;
