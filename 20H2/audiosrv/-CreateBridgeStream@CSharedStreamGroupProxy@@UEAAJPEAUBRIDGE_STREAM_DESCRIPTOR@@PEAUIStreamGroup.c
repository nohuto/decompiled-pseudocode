/*
 * XREFs of ?CreateBridgeStream@CSharedStreamGroupProxy@@UEAAJPEAUBRIDGE_STREAM_DESCRIPTOR@@PEAUIStreamGroupProxy@@PEAUSYSTEM_AUDIO_STREAM@@@Z @ 0x1800E4330
 * Callers:
 *     <none>
 * Callees:
...
LABEL_11:
  ...
  if ( *v14 > 4u )
  {
    ...
    v28 = 8;
    v25 = 8;
    tlgWriteTransfer_EtwEventWriteTransfer((__int64)v14, byte_180167A59, 0LL, 0LL, 5, (__int64)v20);
  }
  if ( v17 )
