/*
 * XREFs of ?IsSpatialAudioEnabled@SpatialAudioDevicePropertyReader@@UEAAJPEAH@Z @ 0x1801287A0
 * Callers:
 *     <none>
 * Callees:
  ...
  if ( *((_DWORD *)this + 128) )
  {
    ...
    else
    {
      if ( (unsigned int)dword_18019C480 > 2 )
      {
        ...
        v11 = (__int64)"SpatialAudioDevicePropertyReader::IsSpatialAudioEnabled";
        LODWORD(v10) = 709;
