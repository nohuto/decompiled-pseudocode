/*
 * XREFs of ?RuntimeClassInitialize@SpatialAudioConfigureDevice@@QEAAJPEBGPEAUIPropertyStore@@@Z @ 0x18005C0B8
 * Callers:
...
LABEL_12:
  ...
  else
  {
    ...
    v9 = SpatialAudioDevicePropertyWriter;
    if ( SpatialAudioDevicePropertyWriter < 0 && (unsigned int)dword_18019C480 > 2 )
    {
      LODWORD(v14) = 99;
      goto LABEL_12;
    }
