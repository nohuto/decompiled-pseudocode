/*
 * XREFs of ?GetPolicyVolumeForAudioStream@@YAXPEAUIAudioPolicyManager@@PEAUIAudioStreamPolicyVolumeClient@@PEBU_tlgProvider_t@@PEAMPEA_JW4GPV_REASON@@@Z @ 0x18002D320
 * Callers:
  ...
  *a4 = v13;
  ...
  if ( *a4 > 0.0 && (*(unsigned int (__fastcall **)(__int64))(*(_QWORD *)a2 + 56LL))(a2) != 21 )
  {
    v15 = (*(unsigned int (__fastcall **)(struct IAudioPolicyManager *))(*(_QWORD *)v9 + 280LL))(v9)
       && dword_180172F20[(*(unsigned int (__fastcall **)(__int64))(*(_QWORD *)a2 + 56LL))(a2)]
        ? 0.0
        : FLOAT_1_0;
    v59 = LODWORD(v15);
    v16 = v15 * *a4;
