/*
 * XREFs of ?RefreshSpatialAudioLicenseModelState@AtmosCheck@@AEAAJPEA_N@Z @ 0x18005F304
 * Callers:
 ...
 *     ??$Write@U?$_tlgWrapperByVal@$00@@U1@@?$_tlgWriteTemplate@$$A6AJPEBU_tlgProvider_t@@PEBXPEBU_GUID@@2IPEAU_EVENT_DATA_DESCRIPTOR@@@Z$1?_tlgWriteTransfer_EventWriteTransfer@@YAJ0122I3@ZPEBU2@PEBU2@@@SAJPEBU_tlgProvider_t@@PEBXPEBU_GUID@@2AEBU?$_tlgWrapperByVal@$00@@3@Z @ 0x180133948 (--$Write@U-$_tlgWrapperByVal@$00@@U1@@-$_tlgWriteTemplate@$$A6AJPEBU_tlgProvider_t@@PEBXPEBU_GUI.c)
...
LABEL_37:
      ...
      else
      {
        ...
        do
        {
          ...
          v16 = (const WCHAR *)&unk_18015C724;
          v17 = (const WCHAR *)&unk_18015C724;
          if ( *v12 )
            v17 = *v12;
          v18 = (const WCHAR *)&unk_18015C724;
          if ( v12[1] )
            v18 = v12[1];
          lpString1 = v18;
          v19 = (const WCHAR *)&unk_18015C724;
