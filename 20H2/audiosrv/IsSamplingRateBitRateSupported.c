/*
 * XREFs of IsSamplingRateBitRateSupported @ 0x18004B838
 * Callers:
...
LABEL_11:
  ...
  do
  {
    if ( v5 )
      break;
    if ( word_180160260[2 * v11] == *(_WORD *)(a3 + 14)
      && (v6 != -2 || word_180160260[2 * v11 + 1] == *(_WORD *)(a3 + 18)) )
    {
      *(_WORD *)(a3 + 18) = word_180160260[2 * v11 + 1];
      v14 = a3;
      v12 = *(_QWORD *)(a2 + 56);
      if ( !v12 )
        goto LABEL_25;
