/*
 * XREFs of ?TraceResult@AtmosCheck@@AEAAXJ_N@Z @ 0x180036994
 * Callers:
...
void __fastcall AtmosCheck::TraceResult(AtmosCheck *this, int a2, char a3)
{
  ...
  if ( !*((_BYTE *)this + 98) || a3 )
  {
    if ( (unsigned int)dword_18019C4F0 > 4 && (unsigned __int8)tlgKeywordOn(&dword_18019C4F0, 0x400000000000LL) )
    {
      v16[1] = a2;
      v19 = (char *)this + 168;
      v17 = v14;
