/*
 * XREFs of ?OnFormatCapsChange@CKsSoftwareNotificationsMonitor@@AEAAJXZ @ 0x1800E14EC
 * Callers:
 *     ?OnNotify@CKsSoftwareNotificationsMonitor@@UEAAJKPEBU_GUID@@@Z @ 0x1800E1A30 (-OnNotify@CKsSoftwareNotificationsMonitor@@UEAAJKPEBU_GUID@@@Z.c)
 * Callees:
              ...
              if ( !v13 )
              {
                  ...
                  && LODWORD(pvar_8[1]) == v35[0] )
                {
                  ...
                  *(_OWORD *)v45 = 0LL;
                  ...
                  {
                    v19 = dword_18019FA4C++;
                    v20 = (_DWORD *)*((_QWORD *)wil::details::static_lazy<AudioSrvTelemetryProvider>::get(
                                                  v18,
