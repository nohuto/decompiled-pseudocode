/*
 * XREFs of ?Initialize@CConstraintModelResourceManager@@AEAAJPEAUIAudioResourceControl@@@Z @ 0x180066158
 * Callers:
 ...
 *     ??0CConstraintModel@@QEAA@XZ @ 0x180056584 (--0CConstraintModel@@QEAA@XZ.c)
 *     ?AtlComPtrAssign@ATL@@YAPEAUIUnknown@@PEAPEAU2@PEAU2@@Z @ 0x180057AD4 (-AtlComPtrAssign@ATL@@YAPEAUIUnknown@@PEAPEAU2@PEAU2@@Z.c)
 *     ?SetupKeywordDetectorPriority@CConstraintModelResourceManager@@AEAAJXZ @ 0x1800662A4 (-SetupKeywordDetectorPriority@CConstraintModelResourceManager@@AEAAJXZ.c)
