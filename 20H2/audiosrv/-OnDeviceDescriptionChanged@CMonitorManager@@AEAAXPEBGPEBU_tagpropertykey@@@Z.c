/*
 * XREFs of ?OnDeviceDescriptionChanged@CMonitorManager@@AEAAXPEBGPEBU_tagpropertykey@@@Z @ 0x1800FD860
 * Callers:
 *     <none>
 * Callees:
        ...
        const struct _tagpropertykey *a3)
{
  ...
  else
  {
    ...
    if ( v8 )
    {
      CMonitor::OnDeviceDescriptionChanged((CMonitor *)v8[25].lpVtbl, v10);
      v6 = v8;
    }
    if ( v6 )
