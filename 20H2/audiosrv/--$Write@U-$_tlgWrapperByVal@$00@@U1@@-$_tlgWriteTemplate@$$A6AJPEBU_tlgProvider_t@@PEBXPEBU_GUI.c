/*
 * XREFs of ??$Write@U?$_tlgWrapperByVal@$00@@U1@@?$_tlgWriteTemplate@$$A6AJPEBU_tlgProvider_t@@PEBXPEBU_GUID@@2IPEAU_EVENT_DATA_DESCRIPTOR@@@Z$1?_tlgWriteTransfer_EventWriteTransfer@@YAJ0122I3@ZPEBU2@PEBU2@@@SAJPEBU_tlgProvider_t@@PEBXPEBU_GUID@@2AEBU?$_tlgWrapperByVal@$00@@3@Z @ 0x180133948
 * Callers:
        ...
        __int64 a6)
{
  ...
  v10 = 0;
  v9 = 1;
  return tlgWriteTransfer_EventWriteTransfer((__int64)&dword_18019C4F0, a2, 0LL, 0LL, 4u, &v7);
}
