/*
 * XREFs of ?SetFailureInfo@StoredFailureInfo@wil@@QEAAXAEBUFailureInfo@2@@Z @ 0x1800B56FC
 * Callers:
 *     ?ThrowResultExceptionInternal@details@wil@@YAXAEBUFailureInfo@2@@Z @ 0x1800B5B70 (-ThrowResultExceptionInternal@details@wil@@YAXAEBUFailureInfo@2@@Z.c)
 * Callees:
 ...
 *     ?create@shared_buffer@details@wil@@QEAA_NPEBX_K@Z @ 0x1800B5D80 (-create@shared_buffer@details@wil@@QEAA_NPEBX_K@Z.c)
