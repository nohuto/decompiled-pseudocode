/*
 * XREFs of ?StopStream@CAudioSession@@UEAAJPEAVCAudioStream@@@Z @ 0x18002CA10
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall CAudioSession::StopStream(CAudioSession *this, struct CAudioStream *a2)
{
  ...
  {
    WPP_SF_qq(*((_QWORD *)WPP_GLOBAL_Control + 2), 50LL, &WPP_7cf3fc3344fb31d0ce2bf36427d5d6eb_Traceguids, this, a2);
  }
  ...
  if ( v9 )
  {
    ...
    if ( updated )
      v7 = (unsigned int)dword_180160540[v14];
    else
      v7 = (unsigned int)dword_1801604E0[v14];
    v15 = *(_DWORD *)(v4 + 228);
    v10 = 16LL;
    v16 = 0;
    if ( (_DWORD)v8 )
...
LABEL_24:
  ...
  if ( WPP_GLOBAL_Control != (CAudioSessionManager *)&WPP_GLOBAL_Control
    ...
    && *((_BYTE *)WPP_GLOBAL_Control + 25) >= 4u )
  {
    WPP_SF_(*((_QWORD *)WPP_GLOBAL_Control + 2), 53LL, &WPP_7cf3fc3344fb31d0ce2bf36427d5d6eb_Traceguids);
    v23 = WPP_GLOBAL_Control;
  }
  if ( *((_QWORD *)this + 22) )
  {
...
LABEL_32:
  if ( updated < 0 )
    AudSrvTraceLoggingErrorHelper("CAudioSession::StopStream", 0xC29u, updated);
