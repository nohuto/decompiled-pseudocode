/*
 * XREFs of ?GetDictionaryLocalMetadataFormatId@SpatialAudioMetadataDictionaryData@@UEAAJPEAG@Z @ 0x18012BFC0
 * Callers:
 *     <none>
 * Callees:
        ...
        unsigned __int16 *a2)
{
  ...
  else
  {
    if ( (unsigned int)dword_18019C480 > 2 )
    {
      ...
      v11 = (__int64)"SpatialAudioMetadataDictionaryData::GetDictionaryLocalMetadataFormatId";
      LODWORD(v10) = 167;
