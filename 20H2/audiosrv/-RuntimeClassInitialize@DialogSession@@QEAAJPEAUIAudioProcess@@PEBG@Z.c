/*
 * XREFs of ?RuntimeClassInitialize@DialogSession@@QEAAJPEAUIAudioProcess@@PEBG@Z @ 0x1800F7120
 * Callers:
 ...
 *     ?Start@CVirtualAudioStream@@QEAAXXZ @ 0x180071D44 (-Start@CVirtualAudioStream@@QEAAXXZ.c)
