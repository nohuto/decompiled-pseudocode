/*
 * XREFs of ?_Destroy@?$_Ref_count_obj@VCSebReference@@@std@@EEAAXXZ @ 0x180037E10
 * Callers:
 *     <none>
 * Callees:
 *     <none>
...
int __fastcall std::_Ref_count_obj<CSebReference>::_Destroy(__int64 a1)
{
  __int64 v1; // rdi
  int v2; // eax
  ...
  result = _Mtx_unlock((_Mtx_t)(v1 + 8));
  if ( result )
  {
LABEL_8:
    std::_Throw_C_error(result);
    JUMPOUT(0x18009933CLL);
  }
  return result;
}
