/*
 * XREFs of _lambda_57bbabf49cb20fc485a93abeb9f206f0_::operator() @ 0x1800719B4
 * Callers:
 *     ?Stop@CVirtualAudioStream@@QEAAXXZ @ 0x180071D64 (-Stop@CVirtualAudioStream@@QEAAXXZ.c)
 * Callees:
