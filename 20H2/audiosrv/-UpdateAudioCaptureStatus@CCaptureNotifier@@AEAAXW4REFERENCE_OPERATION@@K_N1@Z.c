/*
 * XREFs of ?UpdateAudioCaptureStatus@CCaptureNotifier@@AEAAXW4REFERENCE_OPERATION@@K_N1@Z @ 0x1800EF768
 * Callers:
 ...
 *     ?ReleaseReference@CCaptureNotifier@@QEAAXK_N0@Z @ 0x1800EF6C0 (-ReleaseReference@CCaptureNotifier@@QEAAXK_N0@Z.c)
 * Callees:
