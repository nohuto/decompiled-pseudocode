/*
 * XREFs of dllmain_crt_process_attach @ 0x1800698E8
 * Callers:
 ...
 *     __scrt_is_nonwritable_in_current_image @ 0x18006A184 (__scrt_is_nonwritable_in_current_image.c)
 *     __scrt_release_startup_lock @ 0x18006A224 (__scrt_release_startup_lock.c)
 *     ?__scrt_initialize_type_info@@YAXXZ @ 0x18006A7E4 (-__scrt_initialize_type_info@@YAXXZ.c)
 *     __scrt_initialize_default_local_stdio_options @ 0x18006A80C (__scrt_initialize_default_local_stdio_options.c)
 *     __scrt_get_dyn_tls_init_callback @ 0x18006A830 (__scrt_get_dyn_tls_init_callback.c)
 *     __scrt_fastfail @ 0x18006A850 (__scrt_fastfail.c)
 *     _RTC_Initialize @ 0x18006A9A4 (_RTC_Initialize.c)
 *     _initterm_0 @ 0x18006ABE6 (_initterm_0.c)
 *     _initterm_e_0 @ 0x18006ABF2 (_initterm_e_0.c)
