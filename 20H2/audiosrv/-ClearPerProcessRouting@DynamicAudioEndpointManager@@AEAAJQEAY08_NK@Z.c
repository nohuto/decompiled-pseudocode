/*
 * XREFs of ?ClearPerProcessRouting@DynamicAudioEndpointManager@@AEAAJQEAY08_NK@Z @ 0x1801119E8
 * Callers:
  ...
  if ( v5 >= 0 )
  {
    ...
    while ( 2 )
    {
      ...
      do
      {
        if ( *v10 )
        {
          v5 = PublishChangeNotification((unsigned int)v8, (unsigned int)v9, &unk_18015C724, a3);
          v6 = v5;
          if ( v5 < 0 )
          {
            v7 = 69LL;
