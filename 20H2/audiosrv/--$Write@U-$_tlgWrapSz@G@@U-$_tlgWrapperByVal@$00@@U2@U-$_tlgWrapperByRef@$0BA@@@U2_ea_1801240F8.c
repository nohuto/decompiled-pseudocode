        ...
        __int64 *a24)
{
  ...
  v35 = v26;
  v36 = 0;
  return tlgWriteTransfer_EtwEventWriteTransfer((__int64)&dword_18019C448, a2, 0LL, 0LL, 22, (__int64)v33);
}
