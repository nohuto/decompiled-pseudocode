/*
 * XREFs of ?APOTrackAndLogException@@YAXPEBU_tlgProvider_t@@PEBGW4APO_TYPE@@U_GUID@@PEBDJ_N5@Z @ 0x18012F670
 * Callers:
...
void __fastcall APOTrackAndLogException(__int64 a1, __int64 a2, __int64 a3, __int64 a4, __int64 a5, int a6)
{
  ...
  if ( **(_DWORD **)&g_SysFxUtilTlp > 2u && tlgKeywordOn(*(__int64 *)&g_SysFxUtilTlp, 0x400000000000LL) )
  {
    ...
    _tlgWriteTemplate<long (_tlgProvider_t const *,void const *,_GUID const *,_GUID const *,unsigned int,_EVENT_DATA_DESCRIPTOR *),&long _tlgWriteTransfer_EventWriteTransfer(_tlgProvider_t const *,void const *,_GUID const *,_GUID const *,unsigned int,_EVENT_DATA_DESCRIPTOR *),_GUID const *,_GUID const *>::Write<_tlgWrapSz<char>,_tlgWrapperByRef<16>,_tlgWrapSz<unsigned short>,_tlgWrapSz<char>,_tlgWrapperByVal<4>>(
      v9,
      (unsigned __int8 *)dword_18016C366,
      a3,
      a4,
      (const CHAR **)&v15,
      &v14,
