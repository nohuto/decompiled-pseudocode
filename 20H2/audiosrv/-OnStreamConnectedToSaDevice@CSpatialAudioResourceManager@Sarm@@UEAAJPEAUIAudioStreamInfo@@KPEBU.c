/*
 * XREFs of ?OnStreamConnectedToSaDevice@CSpatialAudioResourceManager@Sarm@@UEAAJPEAUIAudioStreamInfo@@KPEBU_GUID@@PEBUSPATIAL_STREAM_PROPERTIES@@@Z @ 0x180047850
 * Callers:
 *     <none>
 * Callees:
 ...
 *     ?LogExclusiveListenerRequired@CSpatialAudioResourceManagerTraceLogger@@QEAAXH@Z @ 0x18010732C (-LogExclusiveListenerRequired@CSpatialAudioResourceManagerTraceLogger@@QEAAXH@Z.c)
 ...
 *     ?RemoveAtPos@?$CAtlMap@PEAUISaDeviceProxy@@VCEndpointResourcePool@Sarm@@V?$CElementTraits@PEAUISaDeviceProxy@@@ATL@@V?$CElementTraits@VCEndpointResourcePool@Sarm@@@5@@ATL@@QEAAXPEAU__POSITION@@@Z @ 0x1801082F8 (-RemoveAtPos@-$CAtlMap@PEAUISaDeviceProxy@@VCEndpointResourcePool@Sarm@@V-$CElementTraits@PEAUIS.c)
...
LABEL_32:
          if ( (unsigned int)dword_18019C350 > 4 )
          {
            ...
            *(_DWORD *)&v65.Id = 184549376;
            ...
            v84 = &v52;
            *(_DWORD *)&v65.Level = 4;
            v80.Ptr = (ULONGLONG)off_18019C358;
            v80.Size = *(unsigned __int16 *)off_18019C358;
            v81 = &unk_180168EE5;
            v83 = 1;
            v80.Reserved = 2;
            v82 = 38;
            EventWriteTransfer(qword_18019C370, &v65, 0LL, 0LL, 3u, &v80);
          }
          if ( v23 )
          ...
          if ( (unsigned int)dword_18019C350 > 4 )
          {
            ...
            *(_DWORD *)&v66.Id = 184549376;
            ...
            v90 = &v53;
            *(_DWORD *)&v66.Level = 4;
            v86.Ptr = (ULONGLONG)off_18019C358;
            v86.Size = *(unsigned __int16 *)off_18019C358;
            v87 = &unk_180168F17;
            v89 = 1;
            v86.Reserved = 2;
            v88 = 29;
            EventWriteTransfer(qword_18019C370, &v66, 0LL, 0LL, 3u, &v86);
          }
          if ( !v22 )
          {
            v19 = 0;
...
LABEL_17:
  if ( (unsigned int)dword_18019C350 > 4 )
  {
    ...
    *(_DWORD *)&v64.Id = 184549376;
    ...
    v78 = &v51;
    *(_DWORD *)&v64.Level = 4;
    v74.Ptr = (ULONGLONG)off_18019C358;
    v74.Size = *(unsigned __int16 *)off_18019C358;
    v77 = 1;
    v75 = &unk_180168EE5;
    v74.Reserved = 2;
    v76 = 38;
    EventWriteTransfer(qword_18019C370, &v64, 0LL, 0LL, 3u, &v74);
  }
  if ( !v12 )
    goto LABEL_20;
