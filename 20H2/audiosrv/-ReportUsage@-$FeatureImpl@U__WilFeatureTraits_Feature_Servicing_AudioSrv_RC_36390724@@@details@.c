/*
 * XREFs of ?ReportUsage@?$FeatureImpl@U__WilFeatureTraits_Feature_Servicing_AudioSrv_RC_36390724@@@details@wil@@QEAAX_NW4ReportingKind@3@_K@Z @ 0x18006CFCC
 * Callers:
...
__int64 wil::details::FeatureImpl<__WilFeatureTraits_Feature_Servicing_AudioSrv_RC_36390724>::ReportUsage(
        wil::details *a1,
        unsigned __int8 a2,
        __int64 a3,
        ...)
