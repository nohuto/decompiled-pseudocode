/*
 * XREFs of PolicyConfigReportSpatialLicenseChanged @ 0x1800D97C0
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall PolicyConfigReportSpatialLicenseChanged(__int64 a1, __int64 a2)
{
  ...
  CWatchdogTimer<1>::CWatchdogTimer<1>(pv, v3[1], v4, (struct _TP_TIMER *)L"PolicyConfigReportSpatialLicenseChanged");
  LODWORD(a2) = (*(__int64 (__fastcall **)(CPolicyConfig *, __int64))(*(_QWORD *)g_PolicyConfig + 256LL))(
                  g_PolicyConfig,
                  a2);
