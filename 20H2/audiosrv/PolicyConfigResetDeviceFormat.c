/*
 * XREFs of PolicyConfigResetDeviceFormat @ 0x1800D9820
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall PolicyConfigResetDeviceFormat(__int64 a1, __int64 a2)
{
  ...
  CWatchdogTimer<1>::CWatchdogTimer<1>(pv, v3[1], v4, (struct _TP_TIMER *)L"PolicyConfigResetDeviceFormat");
  LODWORD(a2) = (*(__int64 (__fastcall **)(CPolicyConfig *, __int64))(*(_QWORD *)g_PolicyConfig + 40LL))(
                  g_PolicyConfig,
                  a2);
