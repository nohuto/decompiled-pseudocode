/*
 * XREFs of ?GetDeviceDefaults@@YAJPEAVCEndpointCharacteristics@@W4__MIDL___MIDL_itf_audioengineendpoint_0000_0000_0001@@U_GUID@@PEAPEAUtWAVEFORMATEX@@3PEA_J4@Z @ 0x180021F80
 * Callers:
...
LABEL_149:
  ...
  if ( ProposedConnectorFormatForProcessingMode < 0
    ...
    && (unsigned __int8)tlgKeywordOn(&dword_18019C448, 20LL) )
  {
