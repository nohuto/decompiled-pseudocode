/*
 * XREFs of ?LogExclusiveListenerRequired@CSpatialAudioResourceManagerTraceLogger@@QEAAXH@Z @ 0x18010732C
 * Callers:
        ...
        int a2)
{
  ...
  if ( (unsigned int)dword_18019C350 > 4 )
  {
    ...
    v6 = 0;
    v5 = 4;
    tlgWriteTransfer_EventWriteTransfer((int)&dword_18019C350, (int)&dword_180168F35, 0, 0, 3u, &v3);
  }
}
