/*
 * XREFs of ?VAD_AudiosrvServiceStop@CAudioSrv@@AEAAJXZ @ 0x1800BAE14
 * Callers:
 ...
 *     ?DestroyAudioSessionManagerProvider@@YAXXZ @ 0x1800D0D9C (-DestroyAudioSessionManagerProvider@@YAXXZ.c)
