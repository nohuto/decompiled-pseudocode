/*
 * XREFs of s_mmeNotifyDeviceRemoved @ 0x1800F7AC0
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall s_mmeNotifyDeviceRemoved(__int64 a1, const unsigned __int16 *a2)
{
  ...
  CWatchdogTimer<1>::CWatchdogTimer<1>(pv, v3[1], v4, (struct _TP_TIMER *)L"s_mmeNotifyDeviceRemoved");
  LastError = 0;
  if ( (unsigned int)CheckRpcClientTokenMembershipsDisjunctive(v6, v5, &v10) )
  {
    if ( !v10 || (MmeOnDeviceRemoved(a2), !v10) )
      LastError = 5;
  }
  else
  {
