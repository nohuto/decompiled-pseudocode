/*
 * XREFs of ?NotifyNewAudioProtocol@CVolumeProvider@@UEAAXKI@Z @ 0x1800383A0
 * Callers:
 *     <none>
 * Callees:
...
void __fastcall CVolumeProvider::NotifyNewAudioProtocol(CVolumeProvider *this, unsigned int a2, int a3)
{
  ...
  {
    WPP_SF_d(*((_QWORD *)WPP_GLOBAL_Control + 2), 12LL, &WPP_51079a55607f31c93829f02be353d159_Traceguids, v15);
    v5 = WPP_GLOBAL_Control;
  }
      ...
      && *((_BYTE *)v5 + 25) >= 4u )
    {
      ...
      WPP_SF_qS(
        *((_QWORD *)WPP_GLOBAL_Control + 2),
        13,
        (unsigned int)&WPP_51079a55607f31c93829f02be353d159_Traceguids,
        v12,
        v13);
    }
