/*
 * XREFs of ?BeginTermination@CAudioSrv@@UEAAJXZ @ 0x1800B8430
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall CAudioSrv::BeginTermination(CAudioSrv *this)
{
  ...
  if ( *((_DWORD *)this + 16) )
  {
    ...
    if ( v7 )
    {
      ...
      {
        WPP_SF_d(*((_QWORD *)WPP_GLOBAL_Control + 2), 27LL, &WPP_bd0a34596ab73049bcbc5190e65788c6_Traceguids, v7);
      }
      v8 = 1;
    }
    else
  ...
  if ( *((_DWORD *)this + 14) )
  {
    ...
    if ( v9 )
    {
      if ( WPP_GLOBAL_Control != (CAudioSessionManager *)&WPP_GLOBAL_Control
        ...
        && *((_BYTE *)WPP_GLOBAL_Control + 25) >= 4u )
      {
        WPP_SF_d(*((_QWORD *)WPP_GLOBAL_Control + 2), 28LL, &WPP_bd0a34596ab73049bcbc5190e65788c6_Traceguids, v9);
      }
      v10 = 1;
    }
    else
  ...
  if ( *((_DWORD *)this + 15) )
  {
    ...
    if ( v11 )
    {
      if ( WPP_GLOBAL_Control != (CAudioSessionManager *)&WPP_GLOBAL_Control
        ...
        && *((_BYTE *)WPP_GLOBAL_Control + 25) >= 4u )
      {
        WPP_SF_d(*((_QWORD *)WPP_GLOBAL_Control + 2), 29LL, &WPP_bd0a34596ab73049bcbc5190e65788c6_Traceguids, v11);
      }
      v12 = 1;
    }
    else
  ...
  if ( *((_DWORD *)this + 17) )
  {
    ...
    if ( v13 )
    {
      if ( WPP_GLOBAL_Control != (CAudioSessionManager *)&WPP_GLOBAL_Control
        ...
        && *((_BYTE *)WPP_GLOBAL_Control + 25) >= 4u )
      {
        WPP_SF_d(*((_QWORD *)WPP_GLOBAL_Control + 2), 30LL, &WPP_bd0a34596ab73049bcbc5190e65788c6_Traceguids, v13);
      }
    }
    else
    {
