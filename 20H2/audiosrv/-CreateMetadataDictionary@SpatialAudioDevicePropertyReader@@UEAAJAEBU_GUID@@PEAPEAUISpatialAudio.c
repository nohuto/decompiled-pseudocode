/*
 * XREFs of ?CreateMetadataDictionary@SpatialAudioDevicePropertyReader@@UEAAJAEBU_GUID@@PEAPEAUISpatialAudioMetadataDictionaryData@@@Z @ 0x180127480
 * Callers:
 *     <none>
 * Callees:
  ...
  *(_OWORD *)pvar = 0LL;
  ...
  if ( LOWORD(pvar[0]) == 65 )
  {
    ...
    if ( PropertyIndexForMetadataFormatID >= 0 )
    {
      ...
      v9 = PropertyIndexForMetadataFormatID;
      if ( PropertyIndexForMetadataFormatID >= 0 || (unsigned int)dword_18019C480 <= 2 )
        goto LABEL_24;
      *(_DWORD *)v16 = 565;
    }
    else
