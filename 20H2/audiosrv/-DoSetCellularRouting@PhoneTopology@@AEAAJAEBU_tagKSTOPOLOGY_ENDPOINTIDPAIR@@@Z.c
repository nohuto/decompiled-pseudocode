/*
 * XREFs of ?DoSetCellularRouting@PhoneTopology@@AEAAJAEBU_tagKSTOPOLOGY_ENDPOINTIDPAIR@@@Z @ 0x18013EEEC
 * Callers:
 *     ?Process@SetCellularRoutingWorkItem@@UEAAXPEAVPhoneTopology@@@Z @ 0x180140120 (-Process@SetCellularRoutingWorkItem@@UEAAXPEAVPhoneTopology@@@Z.c)
 * Callees:
