/*
 * XREFs of ?TryGetOverridingMixFormat@CEndpointCharacteristics@@QEAAJW4__MIDL___MIDL_itf_audioengineendpoint_0000_0000_0001@@U_GUID@@PEAPEAUtWAVEFORMATEX@@@Z @ 0x180012520
 * Callers:
        ...
        struct tWAVEFORMATEX **a4)
{
  ...
  *a4 = 0LL;
  ...
  for ( i = 0; i < 9; ++i )
  {
    v11 = qword_18019D7B0[2 * i] - v24;
    if ( !v11 )
      v11 = qword_18019D7B0[2 * i + 1] - *((_QWORD *)&v24 + 1);
    if ( !v11 )
    {
