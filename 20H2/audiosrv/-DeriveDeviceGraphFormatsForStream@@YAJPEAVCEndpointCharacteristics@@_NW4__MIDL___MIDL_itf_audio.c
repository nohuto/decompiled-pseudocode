/*
 * XREFs of ?DeriveDeviceGraphFormatsForStream@@YAJPEAVCEndpointCharacteristics@@_NW4__MIDL___MIDL_itf_audioengineendpoint_0000_0000_0001@@W4_AUDCLNT_SHAREMODE@@KU_GUID@@44PEAUtWAVEFORMATEX@@PEAPEAU5@666@Z @ 0x180012180
 * Callers:
 ...
 *     ?ConvertPCMWfxToIEEEFloat@@YAXPEAUtWAVEFORMATEX@@@Z @ 0x18004BD00 (-ConvertPCMWfxToIEEEFloat@@YAXPEAUtWAVEFORMATEX@@@Z.c)
 ...
 *     wil::details::lambda_call__lambda_bb75d7955c525a160db854778f06b41a___::_lambda_call__lambda_bb75d7955c525a160db854778f06b41a___ @ 0x1800E13B4 (wil--details--lambda_call__lambda_bb75d7955c525a160db854778f06b41a___--_lambda_call__lambda_bb75.c)
 */
...
LABEL_76:
  ...
  *(_QWORD *)&v52.Data1 = (char *)a1 + 8688;
  ...
  for ( i = 0; i < 9; ++i )
  {
    v20 = qword_18019D7B0[2 * i] - *(_QWORD *)&v49.Data1;
    if ( !v20 )
      v20 = qword_18019D7B0[2 * i + 1] - *(_QWORD *)v49.Data4;
    if ( !v20 )
    {
