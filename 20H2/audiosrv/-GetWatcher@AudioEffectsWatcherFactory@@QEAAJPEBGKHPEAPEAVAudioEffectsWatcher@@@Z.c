/*
 * XREFs of ?GetWatcher@AudioEffectsWatcherFactory@@QEAAJPEBGKHPEAPEAVAudioEffectsWatcher@@@Z @ 0x1800C4F9C
 * Callers:
        ...
        struct AudioEffectsWatcher **a5)
{
  ...
  *a5 = 0LL;
  ...
  for ( i = (_QWORD *)qword_18019EEE8; i; i = (_QWORD *)*i )
  {
    v10 = i[2];
...
LABEL_14:
  ...
  if ( v13 >= 0 )
  {
    v14 = ATL::CAtlList<COnDeviceWorkItem *,ATL::CElementTraits<COnDeviceWorkItem *>>::NewNode(
            (__int64)&qword_18019EEE8,
            (__int64 *)&v16,
            xmmword_18019EEF0);
    if ( (_QWORD)xmmword_18019EEF0 )
      *(_QWORD *)xmmword_18019EEF0 = v14;
    else
      qword_18019EEE8 = (__int64)v14;
    *(_QWORD *)&xmmword_18019EEF0 = v14;
    *((_QWORD *)v12 + 10) = v14;
    ++*((_DWORD *)v12 + 18);
    *v8 = v12;
