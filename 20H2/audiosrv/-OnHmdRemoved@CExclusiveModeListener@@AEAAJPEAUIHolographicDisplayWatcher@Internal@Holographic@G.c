/*
 * XREFs of ?OnHmdRemoved@CExclusiveModeListener@@AEAAJPEAUIHolographicDisplayWatcher@Internal@Holographic@Graphics@Windows@@PEAUIHolographicDisplay@456@@Z @ 0x18010D230
 * Callers:
 *     <none>
 * Callees:
 ...
 *     ??$_Try_emplace@AEBU_GUID@@$$V@?$map@U_GUID@@UHmdInfo@@U?$less@U_GUID@@@std@@V?$allocator@U?$pair@$$CBU_GUID@@UHmdInfo@@@std@@@4@@std@@QEAA?AU?$pair@V?$_Tree_iterator@V?$_Tree_val@U?$_Tree_simple_types@U?$pair@$$CBU_GUID@@UHmdInfo@@@std@@@std@@@std@@@std@@_N@1@AEBU_GUID@@@Z @ 0x18010C468 (--$_Try_emplace@AEBU_GUID@@$$V@-$map@U_GUID@@UHmdInfo@@U-$less@U_GUID@@@std@@V-$allocator@U-$pai.c)
 *     ?LogOnHmdRemoved@CSpatialAudioResourceManagerTraceLogger@@QEAAXAEBU_GUID@@0@Z @ 0x18010CBA0 (-LogOnHmdRemoved@CSpatialAudioResourceManagerTraceLogger@@QEAAXAEBU_GUID@@0@Z.c)
        ...
        struct Windows::Graphics::Holographic::IHolographicDisplay *a3)
{
  ...
  struct _GUID v23; // [rsp+50h] [rbp-38h] BYREF
...
LABEL_3:
  ...
  v6 = (*(__int64 (__fastcall **)(__int64, struct _GUID *))(*(_QWORD *)v17 + 48LL))(v17, &v23);
  if ( v6 < 0 )
  {
    v7 = 234LL;
    goto LABEL_3;
  ...
  CSpatialAudioResourceManagerTraceLogger::LogOnHmdRemoved(v9, &v23, (const struct _GUID *)((char *)this + 136));
  std::map<_GUID,HmdInfo>::_Try_emplace<_GUID const &,>((__int64 **)this + 20, (__int64)&v20, &v23, v11);
  v12 = v20;
  ...
  else
  {
    std::_Tree<std::_Tmap_traits<_GUID,HmdInfo,std::less<_GUID>,std::allocator<std::pair<_GUID const,HmdInfo>>,0>>::erase(
      ...
      &v23);
    wil::com_ptr_t<Windows::Graphics::Holographic::IHolographicDisplay,wil::err_returncode_policy>::~com_ptr_t<Windows::Graphics::Holographic::IHolographicDisplay,wil::err_returncode_policy>(&v20);
    v15 = *(_QWORD *)&v23.Data1 - *(_QWORD *)&v10->Data1;
    if ( *(_QWORD *)&v23.Data1 == *(_QWORD *)&v10->Data1 )
      v15 = *(_QWORD *)v23.Data4 - *((_QWORD *)this + 18);
    if ( !v15 )
    {
