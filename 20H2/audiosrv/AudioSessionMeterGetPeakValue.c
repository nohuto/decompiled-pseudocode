/*
 * XREFs of AudioSessionMeterGetPeakValue @ 0x1800CCB00
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall AudioSessionMeterGetPeakValue(__int64 *a1, __int64 a2)
{
  ...
  CWatchdogTimer<1>::CWatchdogTimer<1>(pv, v4[1], v5, (struct _TP_TIMER *)L"AudioSessionMeterGetPeakValue");
  v6 = (*(__int64 (__fastcall **)(__int64, __int64))(*(_QWORD *)v2 + 232LL))(v2, a2);
  v7 = v6;
  if ( v6 < 0 )
    AudSrvTraceLoggingErrorHelper("AudioSessionMeterGetPeakValue", 2335, v6);
