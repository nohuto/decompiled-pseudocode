/*
 * XREFs of ?OnProcessTerminated@CAudioSession@@UEAAXPEAUIAudioProcess@@@Z @ 0x180046050
 * Callers:
 *     <none>
 * Callees:
...
void __fastcall CAudioSession::OnProcessTerminated(CAudioSession *this, struct IAudioProcess *a2)
{
  ...
  {
    WPP_SF_q(*((_QWORD *)WPP_GLOBAL_Control + 2), 71LL, &WPP_7cf3fc3344fb31d0ce2bf36427d5d6eb_Traceguids, this);
  }
