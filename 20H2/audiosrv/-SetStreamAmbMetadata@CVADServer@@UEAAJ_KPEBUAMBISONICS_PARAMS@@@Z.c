/*
 * XREFs of ?SetStreamAmbMetadata@CVADServer@@UEAAJ_KPEBUAMBISONICS_PARAMS@@@Z @ 0x1800DD160
 * Callers:
 *     <none>
 * Callees:
...
LABEL_17:
  ...
  if ( v9 >= 0 )
  {
    ...
    if ( v11 )
    {
      v12 = (*(__int64 (__fastcall **)(__int64, const struct AMBISONICS_PARAMS *))(*(_QWORD *)v11 + 24LL))(v11, a3);
      if ( v12 == -2005139384 )
        v12 = -2147024809;
      v7 = v12;
      if ( v12 >= 0 )
