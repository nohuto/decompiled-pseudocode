/*
 * XREFs of ?AddSessionNotification@CAudioSession@@UEAAJPEAUISessionInternalEvents@@@Z @ 0x180033B30
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall CAudioSession::AddSessionNotification(CAudioSession *this, struct ISessionInternalEvents *a2)
{
  ...
  {
    WPP_SF_q(*((_QWORD *)WPP_GLOBAL_Control + 2), 79LL, &WPP_7cf3fc3344fb31d0ce2bf36427d5d6eb_Traceguids, a2);
  }
  if ( a2 )
