/*
 * XREFs of _lambda_27865861a6df232656caf317e6e02d06_::operator() @ 0x1800E7568
 * Callers:
 *     std::_Func_impl_no_alloc__lambda_27865861a6df232656caf317e6e02d06__bool_ISaDeviceProxy___::_Do_call @ 0x1800E8F80 (std--_Func_impl_no_alloc__lambda_27865861a6df232656caf317e6e02d06__bool_ISaDeviceProxy___--_Do_c.c)
 * Callees:
 *     __security_check_cookie @ 0x180069C20 (__security_check_cookie.c)
 *     memcmp_0 @ 0x180074183 (memcmp_0.c)
 *     _guard_dispatch_icall_nop @ 0x1800741C0 (_guard_dispatch_icall_nop.c)
 *     WPP_SF_qdd @ 0x1800CB358 (WPP_SF_qdd.c)
 *     WPP_SF_qDD @ 0x1800E910C (WPP_SF_qDD.c)
 *     WPP_SF_qdddd @ 0x1800E9178 (WPP_SF_qdddd.c)
 *     WPP_SF_qii @ 0x1800E9200 (WPP_SF_qii.c)
 */

char __fastcall lambda_27865861a6df232656caf317e6e02d06_::operator()(__int64 *a1, __int64 a2)
{
  __int64 v4; // rbx
  __int64 v5; // rax
  __int64 v6; // rdx
    ...
    else
    {
             ...
             && *((_BYTE *)WPP_GLOBAL_Control + 25) >= 4u )
      {
        ...
        WPP_SF_qdd(
          *((_QWORD *)WPP_GLOBAL_Control + 2),
          0xCu,
          (__int64)&WPP_95ddedc4add13e06ef360afb0b04205c_Traceguids,
          a2,
          v28,
          v29);
      }
