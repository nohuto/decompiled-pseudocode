/*
 * XREFs of ?Initialize@AudioDeviceMgr@@AEAAJPEAUIEndpointNotificationCallback@@@Z @ 0x18005612C
 * Callers:
 ...
 *     ?CreateWorkItemThread@AudioDeviceMgr@@AEAAJXZ @ 0x1800684F4 (-CreateWorkItemThread@AudioDeviceMgr@@AEAAJXZ.c)
