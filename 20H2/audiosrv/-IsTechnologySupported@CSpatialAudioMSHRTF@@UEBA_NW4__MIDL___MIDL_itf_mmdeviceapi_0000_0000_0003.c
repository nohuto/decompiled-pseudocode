/*
 * XREFs of ?IsTechnologySupported@CSpatialAudioMSHRTF@@UEBA_NW4__MIDL___MIDL_itf_mmdeviceapi_0000_0000_0003@@PEBUtWAVEFORMATEX@@1V?$function@$$A6A_NPEBUWAVEFORMATEXTENSIBLE@@@Z@std@@KPEAIPEA_NPEAUWAVEFORMATEXTENSIBLE@@@Z @ 0x18004B1C0
 * Callers:
 *     <none>
 * Callees:
        ...
        __int64 a9)
{
  ...
  if ( !byte_18019E475 )
  {
    ...
    byte_18019E474 = v14 != 0;
    byte_18019E475 = 1;
    if ( !v14 && (unsigned int)dword_18019C448 > 4 && (unsigned __int8)tlgKeywordOn(&dword_18019C448, 16LL) )
      tlgWriteTransfer_EtwEventWriteTransfer(v15, (unsigned int)&unk_18016BFF1, 0, 0, 2, (__int64)v24);
  }
  v25 = 0LL;
