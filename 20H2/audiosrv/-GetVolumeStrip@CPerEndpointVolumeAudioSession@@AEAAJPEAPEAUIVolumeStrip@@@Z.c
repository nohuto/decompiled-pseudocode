/*
 * XREFs of ?GetVolumeStrip@CPerEndpointVolumeAudioSession@@AEAAJPEAPEAUIVolumeStrip@@@Z @ 0x1800C84B8
 * Callers:
 ...
 *     ?Reused@CPerEndpointVolumeAudioSession@@EEAAJXZ @ 0x1800CA580 (-Reused@CPerEndpointVolumeAudioSession@@EEAAJXZ.c)
...
LABEL_35:
  AudSrvTraceLoggingErrorHelper("CPerEndpointVolumeAudioSession::GetVolumeStrip", 1738, EndpointVolumeInformation);
LABEL_36:
  if ( v5 )
