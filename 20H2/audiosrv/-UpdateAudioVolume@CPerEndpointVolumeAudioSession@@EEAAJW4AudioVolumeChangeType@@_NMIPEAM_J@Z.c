/*
 * XREFs of ?UpdateAudioVolume@CPerEndpointVolumeAudioSession@@EEAAJW4AudioVolumeChangeType@@_NMIPEAM_J@Z @ 0x1800CAD80
 * Callers:
 *     <none>
 * Callees:
    ...
    if ( a5 )
    {
      ...
      do
      {
        if ( v19 != (CAudioSessionManager *)&WPP_GLOBAL_Control
          ...
          && *((_BYTE *)v19 + 25) >= 4u )
        {
          WPP_SF_dg(*((_QWORD *)v19 + 2), 0x52u, (__int64)&WPP_7cf3fc3344fb31d0ce2bf36427d5d6eb_Traceguids, v17);
          v19 = WPP_GLOBAL_Control;
        }
        if ( v17 < v23 )
        {
