/*
 * XREFs of AudioServerTelephonyControlEndSession @ 0x1800E0A70
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall AudioServerTelephonyControlEndSession(__int64 a1)
{
  ...
  CWatchdogTimer<1>::CWatchdogTimer<1>(pv, v1[1], v2, (struct _TP_TIMER *)L"AudioServerTelephonyControlEndSession");
  v3 = ((__int64 (__fastcall *)(struct IUnknown *))g_TelephonyControl->lpVtbl[1].Release)(g_TelephonyControl);
