/*
 * XREFs of ?LogAecEffectPolicyInsertion@@YAXAEBU_AEC_POLICY_RESULTS@@PEBGU_GUID@@W4__MIDL___MIDL_itf_audioengineendpoint_0000_0000_0001@@@Z @ 0x18005ABAC
 * Callers:
        ...
        __int64 a4)
{
  ...
  else
  {
    ...
    {
      if ( (unsigned __int8)tlgKeywordOn(&dword_18019C448, 0x400000000008LL) )
      {
        v27 = v8[16];
        v23 = v8 + 11;
        v11 = v8[10];
