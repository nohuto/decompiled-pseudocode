/*
 * XREFs of ?OnRequestDynamicObjects@CSpatialAudioResourceManager@Sarm@@UEAAJ_JII@Z @ 0x1801076A0
 * Callers:
 ...
 *     ?WaitForWorkToComplete@CWorkFifo@@QEAA_NXZ @ 0x18010906C (-WaitForWorkToComplete@CWorkFifo@@QEAA_NXZ.c)
 *     ?LogRequestDynamicObjects@CSpatialAudioResourceManagerTraceLogger@@QEAAX_JII@Z @ 0x180109D60 (-LogRequestDynamicObjects@CSpatialAudioResourceManagerTraceLogger@@QEAAX_JII@Z.c)
