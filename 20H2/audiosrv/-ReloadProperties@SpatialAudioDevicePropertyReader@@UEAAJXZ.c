/*
 * XREFs of ?ReloadProperties@SpatialAudioDevicePropertyReader@@UEAAJXZ @ 0x18001CFC0
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall SpatialAudioDevicePropertyReader::ReloadProperties(SpatialAudioDevicePropertyReader *this)
{
  ...
  *((_QWORD *)this + 63) = 0LL;
  ...
  if ( DeviceProperties < 0 && (unsigned int)dword_18019C480 > 2 )
  {
    LODWORD(v26) = 284;
LABEL_23:
...
LABEL_8:
  if ( (_DWORD)v24 )
  {
    ...
    *(_OWORD *)((char *)this + 134) = xmmword_180160150;
    *((_WORD *)this + 66) = 0;
    *(_OWORD *)((char *)this + 150) = xmmword_180160160;
    *(_OWORD *)((char *)this + 166) = xmmword_180160170;
    *(_OWORD *)((char *)this + 182) = xmmword_180160180;
    *(_OWORD *)((char *)this + 198) = xmmword_180160190;
    *(_OWORD *)((char *)this + 214) = xmmword_1801601A0;
    *(_OWORD *)((char *)this + 230) = xmmword_1801601B0;
  ...
  *((_QWORD *)this + 7) = v18;
  ...
  if ( v16 < 0 && (unsigned int)dword_18019C480 > 2 )
  {
    LODWORD(v24) = v16;
    LODWORD(v25) = 302;
