/*
 * XREFs of ?StopStream@CVADServer@@UEAAJ_KW4__MIDL___MIDL_itf_virtualaudiorpc_0000_0000_0002@@@Z @ 0x180017C70
 * Callers:
 *     <none>
 * Callees:
      ...
      if ( g_AudioJournal )
      {
        ...
        if ( StreamInfo >= 0 )
        {
          *(double *)&lpData[200 * v59[0] + 168] = v31 + *(double *)&lpData[200 * v59[0] + 168];
          ...
          if ( v36 == (BYTE *)&unk_18019F038 )
          {
            v38 = L"Render";
            v39 = 600;
          }
          else if ( v36 == (BYTE *)&unk_18019F290 )
          {
            v38 = L"Capture";
            v39 = 400;
          }
...
LABEL_97:
          ...
          p_hKey = &hKey;
          hKey = 0LL;
          v40 = RegCreateKeyExW(HKEY_LOCAL_MACHINE, &word_18019F4E8, 0, 0LL, 0, 2u, 0LL, &hKey, 0LL);
          v12 = v40;
          if ( v40 > 0 )
