/*
 * XREFs of ?PublishSebEvent@CSebNotifier@@AEAAXE@Z @ 0x1800459E4
 * Callers:
 *     _lambda_66d2f619b070ae3e79e6511eef39e0b9_::_lambda_invoker_cdecl_ @ 0x1800477F0 (_lambda_66d2f619b070ae3e79e6511eef39e0b9_--_lambda_invoker_cdecl_.c)
...
void __fastcall CSebNotifier::PublishSebEvent(CSebNotifier *this, unsigned __int8 a2)
{
  ...
  if ( *((_BYTE *)this + 88) != a2 )
  {
    ...
    if ( *v6 > 4u )
    {
      ...
      v7 = a2;
      v11 = 1LL;
      tlgWriteTransfer_EtwEventWriteTransfer((_DWORD)v6, (unsigned int)&unk_180168C39, 0, 0, 4, (__int64)v9);
    }
  }
}
