/*
 * XREFs of ??$MakeAndInitialize@VSpatialAudioEncoderProperties@@V1@AEBU_GUID@@AEAH@Details@WRL@Microsoft@@YAJPEAPEAVSpatialAudioEncoderProperties@@AEBU_GUID@@AEAH@Z @ 0x18012A4C4
 * Callers:
 ...
 *     ??0SpatialAudioEncoderProperties@@QEAA@XZ @ 0x18012A64C (--0SpatialAudioEncoderProperties@@QEAA@XZ.c)
