/*
 * XREFs of CEndpointCharacteristics::CloneDriverFormatIfMatching__lambda_c3615feb6884e65459670eec2aeca07c___ @ 0x180115D64
 * Callers:
...
__int64 __fastcall CEndpointCharacteristics::CloneDriverFormatIfMatching__lambda_c3615feb6884e65459670eec2aeca07c___(
        __int64 a1,
        __int64 a2,
        unsigned int *a3,
      ...
      if ( !v9 && *a3 > 0x40 )
      {
        ...
        if ( v10 <= 0x28 )
        {
          ...
          if ( _bittest64(&v11, v10) )
          {
            ...
            {
              v16[0] = 0;
              lambda_f36e01949351335f5e9acafaa1161a48_::operator()(a2, v12, v16);
              if ( v16[0] )
