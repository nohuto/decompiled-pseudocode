/*
 * XREFs of ?SetDesiredFormat@CSpatialProperties@@AEAA_NPEAVCEndpointCharacteristics@@AEBUWAVEFORMATEXTENSIBLE@@_N@Z @ 0x180126530
 * Callers:
        ...
        char a4)
{
  ...
  if ( (unsigned int)dword_18019C448 > 4 && tlgKeywordOn((__int64)&dword_18019C448, 0x400000000000LL) )
  {
    v26 = (void *)*((_QWORD *)a2 + 3);
    dwChannelMask = v8;
    nSamplesPerSec = v13;
