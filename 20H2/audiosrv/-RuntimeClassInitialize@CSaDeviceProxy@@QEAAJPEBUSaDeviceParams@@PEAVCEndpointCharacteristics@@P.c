/*
 * XREFs of ?RuntimeClassInitialize@CSaDeviceProxy@@QEAAJPEBUSaDeviceParams@@PEAVCEndpointCharacteristics@@PEAUIDeviceGraphObjectsStore@@W4_AUDCLNT_SHAREMODE@@KAEAUSaDeviceResourceParams@@PEBU_GUID@@5@Z @ 0x18002F750
 * Callers:
 ...
 *     WPP_SF_Sddd @ 0x1800E6FA0 (WPP_SF_Sddd.c)
    ...
    if ( (_QWORD)v15 )
    {
      if ( v20 <= 0x7FFFFFFF )
      {
        if ( v19 < 0x7FFFFFFF )
        {
          if ( !v18 )
          {
            v18 = (struct IMallocVtbl *)&unk_18015C724;
            v19 = 0LL;
          }
          if ( v20 )
          {
