/*
 * XREFs of __GSHandlerCheck_EH @ 0x180073FD8
 * Callers:
 *     <none>
 * Callees:
 *     __CxxFrameHandler3_0 @ 0x18006AD30 (__CxxFrameHandler3_0.c)
 *     __GSHandlerCheckCommon @ 0x180073F74 (__GSHandlerCheckCommon.c)
 */
