/*
 * XREFs of ?Initialize@AtmosCheck@@QEAAJW4AtmosRegistration@@PEAVIAtmosCodecsStatusChangedCallback@@@Z @ 0x18005F038
 * Callers:
 ...
 *     ?InitializeLicenseMapLegacy@AtmosCheck@@AEAAXXZ @ 0x18005FFCC (-InitializeLicenseMapLegacy@AtmosCheck@@AEAAXXZ.c)
