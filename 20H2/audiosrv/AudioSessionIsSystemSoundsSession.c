/*
 * XREFs of AudioSessionIsSystemSoundsSession @ 0x1800CC970
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall AudioSessionIsSystemSoundsSession(__int64 *a1)
{
  ...
  CWatchdogTimer<1>::CWatchdogTimer<1>(pv, v2[1], v3, (struct _TP_TIMER *)L"AudioSessionIsSystemSoundsSession");
