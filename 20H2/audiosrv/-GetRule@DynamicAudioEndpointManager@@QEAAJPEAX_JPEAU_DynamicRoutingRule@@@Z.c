/*
 * XREFs of ?GetRule@DynamicAudioEndpointManager@@QEAAJPEAX_JPEAU_DynamicRoutingRule@@@Z @ 0x180111E24
 * Callers:
 *     PolicyConfigGetDynamicRoutingRule @ 0x1800D93A0 (PolicyConfigGetDynamicRoutingRule.c)
 * Callees:
