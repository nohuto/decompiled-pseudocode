/*
 * XREFs of ?Create@CAudioMediaType@@SAJPEBUtWAVEFORMATEX@@IPEAPEAUIAudioMediaType@@MH@Z @ 0x18001F460
 * Callers:
 ...
 * Callees:
 *     ??0CAudioMediaType@@IEAA@XZ @ 0x180020468 (--0CAudioMediaType@@IEAA@XZ.c)
 *     ?IsValidPcmWfx@@YAHPEBUtWAVEFORMATEX@@@Z @ 0x18004714C (-IsValidPcmWfx@@YAHPEBUtWAVEFORMATEX@@@Z.c)
