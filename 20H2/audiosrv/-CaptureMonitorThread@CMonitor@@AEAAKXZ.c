/*
 * XREFs of ?CaptureMonitorThread@CMonitor@@AEAAKXZ @ 0x18010052C
 * Callers:
 *     ?CaptureMonitorThreadWrapper@CMonitor@@CAKPEAX@Z @ 0x180100640 (-CaptureMonitorThreadWrapper@CMonitor@@CAKPEAX@Z.c)
 * Callees:
 ...
 *     ?ResetEngineThreadPriority@@YAJPEAPEAX@Z @ 0x180104A70 (-ResetEngineThreadPriority@@YAJPEAPEAX@Z.c)
 *     ?SetEngineThreadPriority@@YAJW4AudioThreadPriorityLevel@@PEAPEAX@Z @ 0x180104AD0 (-SetEngineThreadPriority@@YAJW4AudioThreadPriorityLevel@@PEAPEAX@Z.c)
 */
