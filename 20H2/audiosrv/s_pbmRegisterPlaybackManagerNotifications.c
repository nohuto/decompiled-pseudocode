/*
 * XREFs of s_pbmRegisterPlaybackManagerNotifications @ 0x1800F8B00
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall s_pbmRegisterPlaybackManagerNotifications(__int64 a1, unsigned int a2, unsigned int a3)
{
  ...
  CWatchdogTimer<1>::CWatchdogTimer<1>(pv, v7[1], v8, (struct _TP_TIMER *)L"s_pbmRegisterPlaybackManagerNotifications");
  ...
  else if ( !a2 && g_PolicyManager )
  {
    ...
    if ( v9 >= 0 )
    {
      v11 = (*(__int64 (__fastcall **)(__int64))(*(_QWORD *)v14 + 328LL))(v14);
      v10 = v14;
      v6 = v11;
    }
    if ( v10 )
