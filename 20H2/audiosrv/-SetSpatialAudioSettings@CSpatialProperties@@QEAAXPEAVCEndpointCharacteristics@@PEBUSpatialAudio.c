/*
 * XREFs of ?SetSpatialAudioSettings@CSpatialProperties@@QEAAXPEAVCEndpointCharacteristics@@PEBUSpatialAudioSettings@@PEBUtWAVEFORMATEX@@PEAUIPropertyStore@@PEAUSpatialAudioRelatedGlobalSettings@@V?$function@$$A6A_NPEBUWAVEFORMATEXTENSIBLE@@@Z@std@@@Z @ 0x180049AAC
 * Callers:
        ...
        *(_OWORD *)pvar = PKEY_Endpoint_PreferedPcmChannelCountForHrtf;
          ...
          && (*(int (__fastcall **)(_QWORD, GUID *))(**(_QWORD **)(a1 + 56) + 48LL))(*(_QWORD *)(a1 + 56), &v88) >= 0 )
        {
          *(_OWORD *)pvar = *(_OWORD *)GetPreferredSpatialAudioEncoderId(pvar, v65, a3);
          ...
          if ( v15 )
          {
            if ( (unsigned int)dword_18019C448 > 2 && (unsigned __int8)tlgKeywordOn(&dword_18019C448, 16LL) )
            {
...
LABEL_63:
          ...
          *(_OWORD *)&Buf2[12] = *(_OWORD *)v14;
          ...
          {
            if ( v18 > 4 && (unsigned __int8)tlgKeywordOn(&dword_18019C448, 16LL) )
            {
              LODWORD(v66) = v12;
              pvar[0] = *(PROPVARIANT *)(v73 + 24);
              _tlgWriteTemplate<long (_tlgProvider_t const *,void const *,_GUID const *,_GUID const *,unsigned int,_EVENT_DATA_DESCRIPTOR *),&long _tlgWriteTransfer_EtwEventWriteTransfer(_tlgProvider_t const *,void const *,_GUID const *,_GUID const *,unsigned int,_EVENT_DATA_DESCRIPTOR *),_GUID const *,_GUID const *>::Write<_tlgWrapSz<unsigned short>,_tlgWrapperByVal<4>>(
                v40,
                (unsigned int)&unk_18016B18C,
                v41,
                v19,
                (__int64)pvar,
                (__int64)&v66);
          ...
          {
            if ( (unsigned int)dword_18019C448 > 4 && (unsigned __int8)tlgKeywordOn(&dword_18019C448, 16LL) )
            {
              v75[0] = v14;
              pvar[0] = *(PROPVARIANT *)(v21 + 24);
              _tlgWriteTemplate<long (_tlgProvider_t const *,void const *,_GUID const *,_GUID const *,unsigned int,_EVENT_DATA_DESCRIPTOR *),&long _tlgWriteTransfer_EtwEventWriteTransfer(_tlgProvider_t const *,void const *,_GUID const *,_GUID const *,unsigned int,_EVENT_DATA_DESCRIPTOR *),_GUID const *,_GUID const *>::Write<_tlgWrapSz<unsigned short>,_tlgWrapperByRef<16>>(
                v42,
                (unsigned int)&unk_18016AF04,
                v43,
                v44,
                (__int64)pvar,
                (__int64)v75);
...
LABEL_60:
          if ( v65 != v23
            ...
            && (unsigned __int8)tlgKeywordOn(&dword_18019C448, 16LL) )
          {
            LODWORD(v66) = v52;
            v75[0] = *(unsigned __int16 **)(v73 + 24);
            _tlgWriteTemplate<long (_tlgProvider_t const *,void const *,_GUID const *,_GUID const *,unsigned int,_EVENT_DATA_DESCRIPTOR *),&long _tlgWriteTransfer_EtwEventWriteTransfer(_tlgProvider_t const *,void const *,_GUID const *,_GUID const *,unsigned int,_EVENT_DATA_DESCRIPTOR *),_GUID const *,_GUID const *>::Write<_tlgWrapSz<unsigned short>,_tlgWrapperByVal<4>>(
              v50,
              (unsigned int)&unk_18016AB80,
              v51,
              v52,
              (__int64)v75,
              (__int64)&v66);
