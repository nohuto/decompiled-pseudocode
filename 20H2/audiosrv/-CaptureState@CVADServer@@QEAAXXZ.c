/*
 * XREFs of ?CaptureState@CVADServer@@QEAAXXZ @ 0x1800DAE04
 * Callers:
 *     ?Callback@AudioSrvTelemetryProvider@@CAXPEBU_GUID@@KE_K1PEAU_EVENT_FILTER_DESCRIPTOR@@PEAX@Z @ 0x1800DAD80 (-Callback@AudioSrvTelemetryProvider@@CAXPEBU_GUID@@KE_K1PEAU_EVENT_FILTER_DESCRIPTOR@@PEAX@Z.c)
 * Callees:
...
void __fastcall CVADServer::CaptureState(CVADServer *this)
{
  ...
  if ( **((_DWORD **)v7 + 1) > 4u && tlgKeywordOn(*((_QWORD *)v7 + 1), 3LL) )
  {
    v9 = *((_QWORD *)this + 22);
    v10 = (_WORD *)(v2 + 18);
    if ( v2 )
