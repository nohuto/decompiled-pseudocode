/*
 * XREFs of PolicyConfigGetShareMode @ 0x1800D96B0
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall PolicyConfigGetShareMode(__int64 a1, __int64 a2, __int64 a3)
{
  ...
  CWatchdogTimer<1>::CWatchdogTimer<1>(pv, v5[1], v6, (struct _TP_TIMER *)L"PolicyConfigGetShareMode");
  LODWORD(a3) = (*(__int64 (__fastcall **)(CPolicyConfig *, __int64, __int64))(*(_QWORD *)g_PolicyConfig + 72LL))(
                  g_PolicyConfig,
                  a2,
                  a3);
