/*
 * XREFs of ?Allocate@?$CHeapPtr@U_GUID@@VCComAllocator@ATL@@@ATL@@QEAA_N_K@Z @ 0x180021060
 * Callers:
 ...
 *     ??$AtlMultiply@_K@ATL@@YAJPEA_K_K1@Z @ 0x1800210CC (--$AtlMultiply@_K@ATL@@YAJPEA_K_K1@Z.c)
 */
