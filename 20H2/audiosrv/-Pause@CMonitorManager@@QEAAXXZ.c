/*
 * XREFs of ?Pause@CMonitorManager@@QEAAXXZ @ 0x1800FE320
 * Callers:
 *     ?PauseAllMonitors@CStreamConnectionManagerImpl@@UEAAXXZ @ 0x1800FE420 (-PauseAllMonitors@CStreamConnectionManagerImpl@@UEAAXXZ.c)
 * Callees:
