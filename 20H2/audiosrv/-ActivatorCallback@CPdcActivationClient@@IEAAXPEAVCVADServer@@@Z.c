/*
 * XREFs of ?ActivatorCallback@CPdcActivationClient@@IEAAXPEAVCVADServer@@@Z @ 0x1800EE7AC
 * Callers:
 *     ?PdcTimerActivatorCallback@CPdcActivationClient@@KAXPEAXW4_PDC_ACTIVATOR_ERROR_DETAIL@@00@Z @ 0x1800EE900 (-PdcTimerActivatorCallback@CPdcActivationClient@@KAXPEAXW4_PDC_ACTIVATOR_ERROR_DETAIL@@00@Z.c)
 * Callees:
 ...
 *     ?QueryState@CVADServer@@QEAAJPEAH00@Z @ 0x1800DCB78 (-QueryState@CVADServer@@QEAAJPEAH00@Z.c)
...
void __fastcall CPdcActivationClient::ActivatorCallback(CPdcActivationClient *this, struct CVADServer *a2)
{
  ...
  if ( *v6 > 4u )
  {
    *(_QWORD *)v12 = a2;
    ...
    v15 = 8;
    v16 = 0;
    tlgWriteTransfer_EtwEventWriteTransfer((__int64)v6, byte_180168B8D, 0LL, 0LL, 3, (__int64)v13);
  }
