/*
 * XREFs of s_pbmRegisterAppManagerNotification @ 0x180046B00
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall s_pbmRegisterAppManagerNotification(__int64 a1)
{
  ...
  CWatchdogTimer<1>::CWatchdogTimer<1>(pv, v3[1], v4, (struct _TP_TIMER *)L"s_pbmRegisterAppManagerNotification");
