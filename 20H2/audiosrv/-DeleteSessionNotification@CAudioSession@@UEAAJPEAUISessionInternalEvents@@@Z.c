/*
 * XREFs of ?DeleteSessionNotification@CAudioSession@@UEAAJPEAUISessionInternalEvents@@@Z @ 0x1800358A0
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall CAudioSession::DeleteSessionNotification(CAudioSession *this, struct ISessionInternalEvents *a2)
{
  ...
  {
    WPP_SF_q(*((_QWORD *)WPP_GLOBAL_Control + 2), 80LL, &WPP_7cf3fc3344fb31d0ce2bf36427d5d6eb_Traceguids, a2);
  }
  if ( a2 )
