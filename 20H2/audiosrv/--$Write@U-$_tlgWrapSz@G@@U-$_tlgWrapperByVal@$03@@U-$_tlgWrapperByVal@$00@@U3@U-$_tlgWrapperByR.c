        ...
        __int64 a25)
{
  ...
  v35 = v26;
  v36 = 0;
  return tlgWriteTransfer_EtwEventWriteTransfer((__int64)&dword_18019C448, a2, 0LL, 0LL, 23, (__int64)v33);
}
