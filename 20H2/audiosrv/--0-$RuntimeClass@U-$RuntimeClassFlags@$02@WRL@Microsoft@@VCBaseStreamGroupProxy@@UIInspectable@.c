/*
 * XREFs of ??0?$RuntimeClass@U?$RuntimeClassFlags@$02@WRL@Microsoft@@VCBaseStreamGroupProxy@@UIInspectable@@@WRL@Microsoft@@QEAA@XZ @ 0x1800E30D8
 * Callers:
 *     ??0CExclusiveStreamGroupProxy@@QEAA@XZ @ 0x1800E31F8 (--0CExclusiveStreamGroupProxy@@QEAA@XZ.c)
 * Callees:
 *     _guard_dispatch_icall_nop @ 0x1800741C0 (_guard_dispatch_icall_nop.c)
 *     ??0CBaseStreamGroupProxy@@QEAA@XZ @ 0x1800E3158 (--0CBaseStreamGroupProxy@@QEAA@XZ.c)
 */
