/*
 * XREFs of ?Mid@?$CStringT@GV?$StrTraitATL@GV?$ChTraitsCRT@G@ATL@@@ATL@@@ATL@@QEBA?AV12@HH@Z @ 0x1800C8FB4
 * Callers:
 ...
 *     ??$AtlAddThrow@H@ATL@@YAHHH@Z @ 0x1800C5DF4 (--$AtlAddThrow@H@ATL@@YAHHH@Z.c)
