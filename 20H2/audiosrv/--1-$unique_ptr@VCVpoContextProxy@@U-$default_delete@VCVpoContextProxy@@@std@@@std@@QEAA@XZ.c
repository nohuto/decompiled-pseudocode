/*
 * XREFs of ??1?$unique_ptr@VCVpoContextProxy@@U?$default_delete@VCVpoContextProxy@@@std@@@std@@QEAA@XZ @ 0x1800DA920
 * Callers:
 *     AudioServerGetEndpointVpoContext$dtor$4 @ 0x1800DEE20 (AudioServerGetEndpointVpoContext$dtor$4.c)
 *     AudioServerGetStreamVpoContext$dtor$6 @ 0x1800DFC48 (AudioServerGetStreamVpoContext$dtor$6.c)
 * Callees:
