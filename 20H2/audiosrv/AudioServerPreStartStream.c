/*
 * XREFs of AudioServerPreStartStream @ 0x1800E0010
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall AudioServerPreStartStream(char *a1)
{
  ...
  CWatchdogTimer<1>::CWatchdogTimer<1>(pv, v3[1], v4, (struct _TP_TIMER *)L"AudioServerPreStartStream");
  v5 = (*(__int64 (__fastcall **)(char *))(*(_QWORD *)a1 + 88LL))(a1);
  v6 = v5;
  if ( v5 >= 0 )
    v6 = 0;
  else
