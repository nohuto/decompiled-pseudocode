/*
 * XREFs of ??1?$CLockedList@VCAudioSessionNotificationProcess@@$00$0A@@@QEAA@XZ @ 0x1800CD910
 * Callers:
 *     _CAudioSessionManager::_CAudioSessionManager_::_1_::dtor$5 @ 0x1800CDDE8 (_CAudioSessionManager--_CAudioSessionManager_--_1_--dtor$5.c)
 * Callees:
