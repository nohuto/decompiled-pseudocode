/*
 * XREFs of ?MyServiceTerminate@@YAXXZ @ 0x1801156E4
 * Callers:
 *     ?OnServiceShutdown@@YAXPEAXE@Z @ 0x180115130 (-OnServiceShutdown@@YAXPEAXE@Z.c)
 * Callees:
 *     _guard_dispatch_icall_nop @ 0x1800741C0 (_guard_dispatch_icall_nop.c)
 *     ?Terminate@CAudioThreadPool@@QEAAJXZ @ 0x180105060 (-Terminate@CAudioThreadPool@@QEAAJXZ.c)
 *     McGenEventUnregister_EtwEventUnregister @ 0x180115A74 (McGenEventUnregister_EtwEventUnregister.c)
 */
