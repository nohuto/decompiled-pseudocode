/*
 * XREFs of ?VAD_AudiosrvServiceStart@CAudioSrv@@AEAAJXZ @ 0x180063590
 * Callers:
 ...
 *     ??0CAudioHealthMonitor@@QEAA@K@Z @ 0x180065314 (--0CAudioHealthMonitor@@QEAA@K@Z.c)
...
LABEL_32:
  v22 = RpcServerRegisterIf3(&unk_180148EB0, 0LL, 0LL, 33LL, 1234, 0, AudioSrvRpcIfCallback, SecurityDescriptor);
  if ( v22 )
  {
