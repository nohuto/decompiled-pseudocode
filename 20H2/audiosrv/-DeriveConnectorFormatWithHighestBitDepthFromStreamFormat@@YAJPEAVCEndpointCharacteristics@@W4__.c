/*
 * XREFs of ?DeriveConnectorFormatWithHighestBitDepthFromStreamFormat@@YAJPEAVCEndpointCharacteristics@@W4__MIDL___MIDL_itf_audioengineendpoint_0000_0000_0001@@PEAUtWAVEFORMATEX@@U_GUID@@PEAPEAU3@@Z @ 0x1800D641C
 * Callers:
 ...
 *     ?InitWaveFormatEx@@YAXPEAUWAVEFORMATEXTENSIBLE@@_NHHHHK@Z @ 0x1800D752C (-InitWaveFormatEx@@YAXPEAUWAVEFORMATEXTENSIBLE@@_NHHHHK@Z.c)
 */
...
LABEL_6:
  ...
  else
  {
    ...
    if ( v11 < 0 )
    {
      v15 = (unsigned __int16 *)&unk_1801704D0;
      v16 = 0;
      do
      {
        if ( v16 >= 5 )
