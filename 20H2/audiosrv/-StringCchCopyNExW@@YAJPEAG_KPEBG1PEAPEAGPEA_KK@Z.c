/*
 * XREFs of ?StringCchCopyNExW@@YAJPEAG_KPEBG1PEAPEAGPEA_KK@Z @ 0x18002A0C0
 * Callers:
 ...
 *     ?DevQueryResultCallback@@YAXPEAUHDEVQUERY__@@PEAXPEBU_DEV_QUERY_RESULT_ACTION_DATA@@@Z @ 0x1800BB980 (-DevQueryResultCallback@@YAXPEAUHDEVQUERY__@@PEAXPEBU_DEV_QUERY_RESULT_ACTION_DATA@@@Z.c)
...
LABEL_28:
  ...
  if ( !a3 )
  {
    v4 = (const unsigned __int16 *)&unk_18015C724;
    a4 = 0LL;
  }
  v7 = 0;
  if ( a2 )
