/*
 * XREFs of ?DoSetCellularEnable@PhoneTopology@@AEAAJPEAU_TelephonyInstanceData@@H@Z @ 0x18013ED38
 * Callers:
 *     ?Process@CallEnableWorkItem@@UEAAXPEAVPhoneTopology@@@Z @ 0x1801400A0 (-Process@CallEnableWorkItem@@UEAAXPEAVPhoneTopology@@@Z.c)
 * Callees:
