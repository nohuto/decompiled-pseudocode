/*
 * XREFs of ??0?$RuntimeClass@U?$RuntimeClassFlags@$01@WRL@Microsoft@@UIMMNotificationClient@@UIMixedRealitySpatialAudioFormatPolicyChange@@VFtmBase@23@@WRL@Microsoft@@QEAA@XZ @ 0x180105584
 * Callers:
 *     ??0CExclusiveModeListener@@QEAA@XZ @ 0x180105654 (--0CExclusiveModeListener@@QEAA@XZ.c)
 * Callees:
