/*
 * XREFs of ??_GDefaultChangedContext@@QEAAPEAXI@Z @ 0x1800F9F6C
 * Callers:
 *     ??1?$CAutoPtr@UDefaultChangedContext@@@ATL@@QEAA@XZ @ 0x1800F9A54 (--1-$CAutoPtr@UDefaultChangedContext@@@ATL@@QEAA@XZ.c)
