/*
 * XREFs of ?LoadPropertyStore@CAudioSessionStore@@AEAAJPEBG@Z @ 0x18000316C
 * Callers:
 ...
 *     ?StringCchCopyA@@YAJPEAD_KPEBD@Z @ 0x180044E6C (-StringCchCopyA@@YAJPEAD_KPEBD@Z.c)
 ...
 *     ?ULongLongSub@@YAJ_K0PEA_K@Z @ 0x180052654 (-ULongLongSub@@YAJ_K0PEA_K@Z.c)
 ...
 *     ?StringCbLengthA@@YAJPEBD_KPEA_K@Z @ 0x1800D898C (-StringCbLengthA@@YAJPEBD_KPEA_K@Z.c)
