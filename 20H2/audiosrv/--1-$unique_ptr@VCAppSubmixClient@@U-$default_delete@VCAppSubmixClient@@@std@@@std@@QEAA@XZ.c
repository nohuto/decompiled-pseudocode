/*
 * XREFs of ??1?$unique_ptr@VCAppSubmixClient@@U?$default_delete@VCAppSubmixClient@@@std@@@std@@QEAA@XZ @ 0x1800F0560
 * Callers:
 *     _CProcessSubmixManager::GetAppSubmixClientContextHelper_::_1_::dtor$2 @ 0x1800F0F2F (_CProcessSubmixManager--GetAppSubmixClientContextHelper_--_1_--dtor$2.c)
 *     _CProcessSubmixManager::GetAppSubmixClientContextHelper_::_1_::dtor$4 @ 0x1800F0F47 (_CProcessSubmixManager--GetAppSubmixClientContextHelper_--_1_--dtor$4.c)
 * Callees:
