/*
 * XREFs of ?Return_GetLastError@in1diag3@details@wil@@YAJPEAXIPEBD@Z @ 0x1800B5588
 * Callers:
 ...
 *     ?InitializeTheadpool@CWorkFifo@@AEAAJXZ @ 0x180107238 (-InitializeTheadpool@CWorkFifo@@AEAAJXZ.c)
 * Callees:
