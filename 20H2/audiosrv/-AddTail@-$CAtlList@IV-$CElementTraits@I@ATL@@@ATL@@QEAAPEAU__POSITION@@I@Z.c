/*
 * XREFs of ?AddTail@?$CAtlList@IV?$CElementTraits@I@ATL@@@ATL@@QEAAPEAU__POSITION@@I@Z @ 0x180140D80
 * Callers:
 *     ?Initialize@TelephonyController@@IEAAJXZ @ 0x1801418F8 (-Initialize@TelephonyController@@IEAAJXZ.c)
 * Callees:
 *     ?NewNode@?$CAtlList@IV?$CElementTraits@I@ATL@@@ATL@@AEAAPEAVCNode@12@IPEAV312@0@Z @ 0x180142408 (-NewNode@-$CAtlList@IV-$CElementTraits@I@ATL@@@ATL@@AEAAPEAVCNode@12@IPEAV312@0@Z.c)
 */
