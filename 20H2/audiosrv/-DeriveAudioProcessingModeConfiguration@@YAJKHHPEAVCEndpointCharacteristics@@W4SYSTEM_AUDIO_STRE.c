/*
 * XREFs of ?DeriveAudioProcessingModeConfiguration@@YAJKHHPEAVCEndpointCharacteristics@@W4SYSTEM_AUDIO_STREAM_TYPE@@W4_AUDCLNT_SHAREMODE@@W4__MIDL___MIDL_itf_audioengineendpoint_0000_0000_0001@@PEAUIProcessSubmixProxy@@HHPEAU_GUID@@5555@Z @ 0x18006E330
 * Callers:
...
LABEL_54:
  ...
  if ( a5 != 2 )
  {
    ...
    if ( a5 != 1 || (unsigned int)v17 < 0x15 )
    {
      v29 = v17;
      if ( a5 )
        v30 = (struct _GUID *)*(&off_180156660 + v17);
      else
        v30 = (struct _GUID *)*(&off_18014BC90 + v17);
      v28 = 0;
      if ( v30->Data1 )
...
LABEL_37:
      ...
      if ( (_DWORD)v17 == 18 )
      {
        if ( !a3 )
          goto LABEL_37;
        v30 = (struct _GUID *)&unk_180156718;
      }
      else
      {
        if ( (_DWORD)v17 != 3 || !a3 )
          goto LABEL_37;
        v30 = (struct _GUID *)&unk_180156708;
      }
LABEL_39:
