...
__int64 *__fastcall std::_Tree<std::_Tmap_traits<_GUID,HmdInfo,std::less<_GUID>,std::allocator<std::pair<_GUID const,HmdInfo>>,0>>::emplace_hint<std::piecewise_construct_t const &,std::tuple<_GUID const &>,std::tuple<>>(
        __int64 *a1,
        __int64 *a2,
        __int64 a3,
        __int64 a4,
