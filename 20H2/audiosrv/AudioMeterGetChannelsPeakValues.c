/*
 * XREFs of AudioMeterGetChannelsPeakValues @ 0x1800C43D0
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall AudioMeterGetChannelsPeakValues(__int64 a1, unsigned int a2, __int64 a3)
{
  _QWORD *v5; // rbx
  ...
  CWatchdogTimer<1>::CWatchdogTimer<1>(pv, v6[1], v7, (struct _TP_TIMER *)L"AudioMeterGetChannelsPeakValues");
  LODWORD(v5) = (*(__int64 (__fastcall **)(_QWORD, _QWORD, __int64))(*(_QWORD *)*v5 + 176LL))(*v5, a2, a3);
