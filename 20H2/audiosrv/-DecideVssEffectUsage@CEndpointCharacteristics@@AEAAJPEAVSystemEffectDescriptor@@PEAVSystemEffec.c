/*
 * XREFs of ?DecideVssEffectUsage@CEndpointCharacteristics@@AEAAJPEAVSystemEffectDescriptor@@PEAVSystemEffectChainDescriptor@@W4__MIDL___MIDL_itf_audioengineendpoint_0000_0000_0001@@@Z @ 0x180029318
 * Callers:
 *     std::_Func_impl_no_alloc__lambda_e06803c0aedafb4181c6469105296c31__long_SystemEffectDescriptor___SystemEffectChainDescriptor___::_Do_call @ 0x1800468B0 (std--_Func_impl_no_alloc__lambda_e06803c0aedafb4181c6469105296c31__long_SystemEffec_ea_1800468B0.c)
 *     std::_Func_impl_no_alloc__lambda_3391533480cddb0792323d763746dc17__long_SystemEffectDescriptor___SystemEffectChainDescriptor___::_Do_call @ 0x18011FE00 (std--_Func_impl_no_alloc__lambda_3391533480cddb0792323d763746dc17__long_SystemEffec_ea_18011FE00.c)
 * Callees:
...
LABEL_22:
      ...
      SystemEffectDescriptor::UpdateEffectsInOverridingChain(
        ...
        a3,
        v15,
        (unsigned __int64)&unk_18019D6E8 & -(__int64)v15,
        1,
        v17 != -1);
      ++v12;
      v14 += 16LL;
