/*
 * XREFs of Create_SpatialAudioConfigureDevice @ 0x18005BEA8
 * Callers:
...
__int64 __fastcall Create_SpatialAudioConfigureDevice(__int64 a1, __int64 a2, _QWORD *a3)
{
  int v4; // eax
  unsigned int v5; // ebx
  ...
  if ( a3 )
  {
    *a3 = 0LL;
    ...
    v4 = Microsoft::WRL::Details::MakeAndInitialize<SpatialAudioConfigureDevice,SpatialAudioConfigureDevice,unsigned short const * &,IPropertyStore * &>(
           &v7,
           &v9,
           &v10);
    v5 = v4;
    ...
    {
      v5 = (**v7)(v7, &GUID_19b6473a_cd1a_4394_961f_cf4a15c7b0f7, a3);
    }
  }
  else
  {
