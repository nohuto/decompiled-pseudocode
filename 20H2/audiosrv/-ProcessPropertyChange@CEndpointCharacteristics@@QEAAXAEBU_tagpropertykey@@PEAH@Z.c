/*
 * XREFs of ?ProcessPropertyChange@CEndpointCharacteristics@@QEAAXAEBU_tagpropertykey@@PEAH@Z @ 0x18001BF40
 * Callers:
        ...
        int *a3)
{
  ...
  v43 = this;
  *a3 = 0;
  v48 = xmmword_18019D724;
  v49 = dword_18019D734;
  v50 = xmmword_18019D738;
  v51 = dword_18019D748;
  v52 = xmmword_18019D74C;
  v53 = dword_18019D75C;
  v54 = xmmword_18019D774;
  v55 = dword_18019D784;
  v56 = xmmword_18019D788;
  v57 = dword_18019D798;
  v58 = xmmword_18019D79C;
  v59 = dword_18019D7AC;
...
LABEL_9:
      ...
      *(struct _GUID *)&v41[8] = v42;
      ...
      if ( v12 < 0 )
        wil::details::in1diag3::_Log_Hr(
          ...
          v38);
      v46.m256i_i64[0] = (__int64)off_180155BF8;
  ...
  if ( dword_18019EDB8 > *(_DWORD *)(*((_QWORD *)NtCurrentTeb()->ThreadLocalStoragePointer + (unsigned int)tls_index)
                                   + 4LL) )
  {
    Init_thread_header(&dword_18019EDB8);
    if ( dword_18019EDB8 == -1 )
    {
      xmmword_18019E400 = (__int128)GUID_00000000_0000_0000_0000_000000000000;
      dword_18019E410 = 0;
      dword_18019E414 = 8;
      xmmword_18019E418 = (__int128)GUID_00000000_0000_0000_0000_000000000000;
      dword_18019E428 = 0;
      dword_18019E42C = 4;
      *(PROPERTYKEY *)byte_18019E430 = PKEY_AudioEngine_DeviceFormat;
      dword_18019E444 = 2;
      *(struct _tagpropertykey *)byte_18019E448 = PKEY_Endpoint_AllowOffloading;
      dword_18019E45C = 16;
      Init_thread_footer(&dword_18019EDB8);
    }
  }
  v14 = &xmmword_18019E400;
  v44.m256i_i64[0] = (__int64)&xmmword_18019E400;
  if ( xmmword_18019E400 == *(_OWORD *)&GUID_00000000_0000_0000_0000_000000000000 )
  {
    ((void (*)(void))GetSpatialSettingsMonitoringPKey)();
    GetSpatialSettingsMonitoringPKey(&xmmword_18019E418);
    v14 = &xmmword_18019E400;
  }
  v15 = 0;
  LODWORD(pv) = 0;
