/*
 * XREFs of ?DetectComboEndpoint@SpatialPolicy@@SAJPEAUIMMDevice@@@Z @ 0x18005E1BC
 * Callers:
 ...
 *     ??4?$function@$$A6AXXZ@std@@QEAAAEAV01@AEBV01@@Z @ 0x1801214C0 (--4-$function@$$A6AXXZ@std@@QEAAAEAV01@AEBV01@@Z.c)
