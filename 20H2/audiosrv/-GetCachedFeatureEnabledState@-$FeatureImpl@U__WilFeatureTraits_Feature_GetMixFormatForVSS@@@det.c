/*
 * XREFs of ?GetCachedFeatureEnabledState@?$FeatureImpl@U__WilFeatureTraits_Feature_GetMixFormatForVSS@@@details@wil@@AEAA?ATwil_details_FeatureStateCache@@XZ @ 0x180034144
 * Callers:
