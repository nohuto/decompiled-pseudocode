/*
 * XREFs of HUBDESC_ValidateMSOSExtendedConfigDescriptor @ 0x1C0039A98
 * Callers:
...
char __fastcall HUBDESC_ValidateMSOSExtendedConfigDescriptor(_DWORD *a1, int a2, __int64 a3, __int64 a4)
{
  ...
  if ( a2 != *a1 )
  {
    if ( WPP_RECORDER_INITIALIZED != (_UNKNOWN *)&WPP_RECORDER_INITIALIZED )
      WPP_RECORDER_SF_dD(a4, 2u, 5u, 0x10Cu, (__int64)&WPP_aa79356b1e693837079f99291824f69e_Traceguids, a2, *a1);
  ...
  do
  {
    if ( *v8 )
    {
      ...
      {
        if ( WPP_RECORDER_INITIALIZED != (_UNKNOWN *)&WPP_RECORDER_INITIALIZED )
          WPP_RECORDER_SF_(a4, 2u, 5u, 0x10Eu, (__int64)&WPP_aa79356b1e693837079f99291824f69e_Traceguids);
...
LABEL_20:
  ...
  if ( WPP_RECORDER_INITIALIZED != (_UNKNOWN *)&WPP_RECORDER_INITIALIZED )
    WPP_RECORDER_SF_(a4, 2u, 5u, 0x10Fu, (__int64)&WPP_aa79356b1e693837079f99291824f69e_Traceguids);
...
LABEL_30:
    if ( WPP_RECORDER_INITIALIZED != (_UNKNOWN *)&WPP_RECORDER_INITIALIZED )
      WPP_RECORDER_SF_(a4, 2u, 5u, 0x110u, (__int64)&WPP_aa79356b1e693837079f99291824f69e_Traceguids);
  }
  return v7;
}
