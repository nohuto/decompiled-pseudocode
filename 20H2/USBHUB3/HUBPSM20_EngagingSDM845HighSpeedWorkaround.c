/*
 * XREFs of HUBPSM20_EngagingSDM845HighSpeedWorkaround @ 0x1C0010870
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall HUBPSM20_EngagingSDM845HighSpeedWorkaround(__int64 a1, __int64 a2, __int64 a3)
{
  ...
  {
    v6 = v4;
    WPP_RECORDER_SF_d(v3[179], 4u, 5u, 0x7Du, (__int64)&WPP_fa1f6120722133e233e88879adbd68f0_Traceguids, v6);
  }
  return 3013LL;
}
