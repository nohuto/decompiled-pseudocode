/*
 * XREFs of USBD_CreateHandle @ 0x1C008ED2C
 * Callers:
 ...
 *     USBDInternal_BuildAndSendQueryInterfaceSynchronously @ 0x1C008E648 (USBDInternal_BuildAndSendQueryInterfaceSynchronously.c)
