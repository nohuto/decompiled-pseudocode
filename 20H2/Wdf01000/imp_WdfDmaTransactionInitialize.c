/*
 * XREFs of imp_WdfDmaTransactionInitialize @ 0x1C002FC40
 * Callers:
 *     imp_WdfDmaTransactionInitializeUsingOffset @ 0x1C002FE60 (imp_WdfDmaTransactionInitializeUsingOffset.c)
 * Callees:
