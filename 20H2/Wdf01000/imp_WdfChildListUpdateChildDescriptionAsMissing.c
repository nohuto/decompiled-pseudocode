/*
 * XREFs of imp_WdfChildListUpdateChildDescriptionAsMissing @ 0x1C0038200
 * Callers:
 *     <none>
 * Callees:
        ...
        _WDF_CHILD_IDENTIFICATION_DESCRIPTION_HEADER *IdentificationDescription)
{
  ...
  if ( _a3 == IdentificationDescription->IdentificationDescriptionSize )
  {
    ...
    v9 = updated;
    if ( m_Globals->FxVerboseOn )
      WPP_IFR_SF_qL(m_Globals, 5u, 0xCu, 0x29u, WPP_FxChildListAPI_cpp_Traceguids, DeviceList, updated);
  }
  else
  {
    v9 = -1073741808;
