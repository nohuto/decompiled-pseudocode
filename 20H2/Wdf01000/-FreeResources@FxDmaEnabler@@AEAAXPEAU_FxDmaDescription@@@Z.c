/*
 * XREFs of ?FreeResources@FxDmaEnabler@@AEAAXPEAU_FxDmaDescription@@@Z @ 0x1C003148C
 * Callers:
 *     ?ReleaseResources@FxDmaEnabler@@AEAAXXZ @ 0x1C0031C3C (-ReleaseResources@FxDmaEnabler@@AEAAXXZ.c)
 * Callees:
