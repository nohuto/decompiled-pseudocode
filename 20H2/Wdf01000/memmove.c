 ...
 *     ?_CopyPtrToPtr@IFxMemory@@KAJPEAX_KPEAU_WDFMEMORY_OFFSET@@012@Z @ 0x1C005281C (-_CopyPtrToPtr@IFxMemory@@KAJPEAX_KPEAU_WDFMEMORY_OFFSET@@012@Z.c)
 ...
 *     ?GetConfigDescriptor@FxUsbDevice@@QEAAJPEAXPEAG@Z @ 0x1C006FDAC (-GetConfigDescriptor@FxUsbDevice@@QEAAJPEAXPEAG@Z.c)
 ...
 *     FxPurgeBugCheckDriverInfo @ 0x1C008FE2C (FxPurgeBugCheckDriverInfo.c)
 ...
 *     CmRegUtilUcValueSetUcString @ 0x1C00C5A2C (CmRegUtilUcValueSetUcString.c)
 * Callees:
 *     <none>
 */
