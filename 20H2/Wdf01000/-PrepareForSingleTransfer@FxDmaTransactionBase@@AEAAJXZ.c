/*
 * XREFs of ?PrepareForSingleTransfer@FxDmaTransactionBase@@AEAAJXZ @ 0x1C0036354
 * Callers:
...
__int64 __fastcall FxDmaTransactionBase::PrepareForSingleTransfer(FxDmaTransactionBase *this)
{
  ...
  if ( this->m_TransactionLength <= this->m_MaxFragmentLength )
  {
    ...
    else
    {
      ...
      WPP_IFR_SF_qL(m_Globals, 2u, 0xFu, 0xFu, WPP_FxDmaTransactionBase_cpp_Traceguids, ObjectHandleUnchecked, v7);
    }
