/*
 * XREFs of imp_WdfRequestForwardToParentDeviceIoQueue @ 0x1C0049940
 * Callers:
 *     <none>
 * Callees:
 ...
 *     ?ForwardRequestToParent@FxIoQueue@@QEAAJPEAV1@PEAVFxRequest@@PEAU_WDF_REQUEST_FORWARD_OPTIONS@@@Z @ 0x1C0075840 (-ForwardRequestToParent@FxIoQueue@@QEAAJPEAV1@PEAVFxRequest@@PEAU_WDF_REQUEST_FORWARD_OPTIONS@@@.c)
