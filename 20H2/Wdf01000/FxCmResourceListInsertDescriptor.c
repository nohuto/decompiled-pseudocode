/*
 * XREFs of FxCmResourceListInsertDescriptor @ 0x1C005B8B0
 * Callers:
 *     imp_WdfCmResourceListAppendDescriptor @ 0x1C005BBA0 (imp_WdfCmResourceListAppendDescriptor.c)
 *     imp_WdfCmResourceListInsertDescriptor @ 0x1C005BCD0 (imp_WdfCmResourceListInsertDescriptor.c)
 * Callees:
