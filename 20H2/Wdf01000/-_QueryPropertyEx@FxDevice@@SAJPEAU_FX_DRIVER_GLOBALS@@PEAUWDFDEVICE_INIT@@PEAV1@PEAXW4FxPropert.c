/*
 * XREFs of ?_QueryPropertyEx@FxDevice@@SAJPEAU_FX_DRIVER_GLOBALS@@PEAUWDFDEVICE_INIT@@PEAV1@PEAXW4FxPropertyType@@K3PEAK5@Z @ 0x1C005073C
 * Callers:
  ...
  if ( result >= 0 )
  {
    ...
    else
    {
      ...
      if ( !PhysicalDevice )
      {
        ...
        WPP_IFR_SF_qL(DriverGlobals, 2u, 0x12u, 0x18u, WPP_FxDeviceKm_cpp_Traceguids, ObjectHandleUnchecked, 0xC0000184);
