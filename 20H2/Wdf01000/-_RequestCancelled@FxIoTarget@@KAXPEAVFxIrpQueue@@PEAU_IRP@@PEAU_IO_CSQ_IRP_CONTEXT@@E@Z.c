/*
 * XREFs of ?_RequestCancelled@FxIoTarget@@KAXPEAVFxIrpQueue@@PEAU_IRP@@PEAU_IO_CSQ_IRP_CONTEXT@@E@Z @ 0x1C00659F0
 * Callers:
 *     <none>
 * Callees:
        ...
        unsigned __int8 CallerIrql)
{
  ...
  _a1 = (_IO_CSQ_IRP_CONTEXT *)FxObject::GetObjectHandleUnchecked((FxObject *)&CsqContext[-1].Overlay);
  if ( !_a1 )
    _a1 = (_IO_CSQ_IRP_CONTEXT *)&CsqContext[-1].Overlay;
  WPP_IFR_SF_q(
    (_FX_DRIVER_GLOBALS *)CsqContext[-1].CancelRoutine,
    4u,
    0xEu,
    0x37u,
