/*
 * XREFs of ?Vf_VerifyRequestIsTagRequest@FxRequest@@QEAAJPEAU_FX_DRIVER_GLOBALS@@@Z @ 0x1C00C2A78
 * Callers:
...
__int64 __fastcall FxRequest::Vf_VerifyRequestIsTagRequest(FxRequest *this, _FX_DRIVER_GLOBALS *FxDriverGlobals)
{
  ...
  if ( !this->m_Completed && (this->m_VerifierFlags & 3) == 0 )
  {
    ...
    WPP_IFR_SF_qL(FxDriverGlobals, 2u, 0xDu, 0x3Au, WPP_FxRequest_cpp_Traceguids, _a1, 0xC000000D);
