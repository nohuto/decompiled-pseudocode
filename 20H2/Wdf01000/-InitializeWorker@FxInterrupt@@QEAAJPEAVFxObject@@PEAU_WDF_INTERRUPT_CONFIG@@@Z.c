/*
 * XREFs of ?InitializeWorker@FxInterrupt@@QEAAJPEAVFxObject@@PEAU_WDF_INTERRUPT_CONFIG@@@Z @ 0x1C0088F08
 * Callers:
...
LABEL_10:
  ...
  if ( (int)result >= 0 )
  {
    ...
    if ( !this->m_EvtInterruptWorkItem && (!unk_1C00A9F89 || !this->m_EvtInterruptDpc) )
      return 0LL;
