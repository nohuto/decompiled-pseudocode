/*
 * XREFs of imp_WdfDmaEnablerWdmGetDmaAdapter @ 0x1C002EA60
 * Callers:
 *     <none>
 * Callees:
        ...
        int DmaDirection)
{
  ...
  $AA61F120FE94696E7B3472FF8202EE19 *v7; // rbx
  ...
  if ( DmaDirection == 1 )
  {
    v7 = ($AA61F120FE94696E7B3472FF8202EE19 *)&pDmaEnabler->m_DuplexAdapterInfo[1];
