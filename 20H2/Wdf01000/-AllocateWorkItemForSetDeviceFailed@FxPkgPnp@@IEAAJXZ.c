/*
 * XREFs of ?AllocateWorkItemForSetDeviceFailed@FxPkgPnp@@IEAAJXZ @ 0x1C007EE9C
 * Callers:
 *     ?QueryForReenumerationInterface@FxPkgPdo@@EEAAJXZ @ 0x1C0078E40 (-QueryForReenumerationInterface@FxPkgPdo@@EEAAJXZ.c)
