/*
 * XREFs of ?LoadCompanion@FxCompanionLibrary@@QEAAJPEAU_FX_DRIVER_GLOBALS@@PEAU_DEVICE_OBJECT@@PEAUIDeviceCompanionCallbacks@@PEAPEAUIDeviceCompanion@@@Z @ 0x1C0042358
 * Callers:
 ...
 *     ?OpenCompanionLibraryInterface@FxCompanionLibrary@@AEAAJPEAU_FX_DRIVER_GLOBALS@@@Z @ 0x1C0042894 (-OpenCompanionLibraryInterface@FxCompanionLibrary@@AEAAJPEAU_FX_DRIVER_GLOBALS@@@Z.c)
 *     ?RtlUShortAdd@@YAJGGPEAG@Z @ 0x1C0042934 (-RtlUShortAdd@@YAJGGPEAG@Z.c)
 *     RtlStringCbCopyUnicodeString @ 0x1C00429E0 (RtlStringCbCopyUnicodeString.c)
