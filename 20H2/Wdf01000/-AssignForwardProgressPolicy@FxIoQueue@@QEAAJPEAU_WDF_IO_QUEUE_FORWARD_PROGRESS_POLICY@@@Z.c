/*
 * XREFs of ?AssignForwardProgressPolicy@FxIoQueue@@QEAAJPEAU_WDF_IO_QUEUE_FORWARD_PROGRESS_POLICY@@@Z @ 0x1C0076E64
 * Callers:
 ...
 *     ?FreeAllReservedRequests@FxIoQueue@@AEAAXE@Z @ 0x1C0077074 (-FreeAllReservedRequests@FxIoQueue@@AEAAXE@Z.c)
 */
