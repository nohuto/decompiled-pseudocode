/*
 * XREFs of imp_WdfIoQueueRetrieveFoundRequest @ 0x1C0019730
 * Callers:
 *     <none>
 * Callees:
        ...
        WDFREQUEST__ **OutRequest)
{
  ...
  Request = FxIoQueue::GetRequest(pQueue, 0LL, pTagRequest, ($1B06A8CAC2803A14CDDB839694AE83F6 **)&pOutputRequest);
  if ( Request >= 0 )
