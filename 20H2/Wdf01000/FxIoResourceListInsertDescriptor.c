/*
 * XREFs of FxIoResourceListInsertDescriptor @ 0x1C005B99C
 * Callers:
 *     imp_WdfIoResourceListAppendDescriptor @ 0x1C005BED0 (imp_WdfIoResourceListAppendDescriptor.c)
 *     imp_WdfIoResourceListInsertDescriptor @ 0x1C005C100 (imp_WdfIoResourceListInsertDescriptor.c)
 * Callees:
