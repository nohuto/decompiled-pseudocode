/*
 * XREFs of ?PerfEvtDeviceD0ExitStart@@YAEPEAUWDFDEVICE__@@PEAU_GUID@@@Z @ 0x1C00433AC
 * Callers:
...
char __fastcall PerfEvtDeviceD0ExitStart(WDFDEVICE__ *Handle, _GUID *pActivityId)
{
  ...
  if ( (m_Globals->FxEnhancedVerifierOptions & 0xF00000) != 0 )
  {
    ...
    if ( (Microsoft_Windows_DriverFrameworks_KernelMode_PerformanceEnableBits[0] & 1) != 0 )
      McTemplateK0pp_EtwWriteTransfer(v7, &FX_POWER_D0_EXIT_START, pActivityId, Method, Handle);
  }
  return v3;
}
