/*
 * XREFs of ??0FxDeviceBase@@IEAA@PEAU_FX_DRIVER_GLOBALS@@PEAVFxDriver@@GG@Z @ 0x1C004C9E0
 * Callers:
 ...
 *     ??0FxDevice@@QEAA@PEAVFxDriver@@@Z @ 0x1C0050A20 (--0FxDevice@@QEAA@PEAVFxDriver@@@Z.c)
 * Callees:
