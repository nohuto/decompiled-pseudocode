/*
 * XREFs of ?SetDelayedDeletion@FxEventQueue@@QEAAXXZ @ 0x1C008A56C
 * Callers:
 *     ?PnpEventFinal@FxPkgPnp@@KA?AW4_WDF_DEVICE_PNP_STATE@@PEAV1@@Z @ 0x1C0079CF0 (-PnpEventFinal@FxPkgPnp@@KA-AW4_WDF_DEVICE_PNP_STATE@@PEAV1@@Z.c)
 * Callees:
