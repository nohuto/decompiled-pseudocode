/*
 * XREFs of AddEventHooksWdfIoQueueCreate @ 0x1C00C0070
 * Callers:
        ...
        WDFQUEUE__ **Queue)
{
  ...
  WDFQUEUE__ *queue; // [rsp+30h] [rbp-89h] BYREF
  _WDF_IO_QUEUE_CONFIG configNew; // [rsp+40h] [rbp-79h] BYREF
  _WDF_OBJECT_ATTRIBUTES attributes; // [rsp+A0h] [rbp-19h] BYREF
  ULONG_PTR retaddr; // [rsp+108h] [rbp+4Fh]
  void *contextHeader; // [rsp+118h] [rbp+5Fh] BYREF
  _VF_WDFIOQUEUECREATE_CONTEXT *context; // [rsp+128h] [rbp+6Fh] BYREF
