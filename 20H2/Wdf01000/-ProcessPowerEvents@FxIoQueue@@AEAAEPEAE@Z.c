...
LABEL_83:
    ...
    {
      while ( ($1B06A8CAC2803A14CDDB839694AE83F6 *)v53[-1].m_IoPkgListNode.m_ListEntry.Blink != &v30->120 )
      {
...
LABEL_71:
          ...
          {
            while ( ($1B06A8CAC2803A14CDDB839694AE83F6 *)v31[-1].m_IoPkgListNode.m_ListEntry.Blink != &v30->120 )
            {
