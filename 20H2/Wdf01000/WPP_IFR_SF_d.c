/*
 * XREFs of WPP_IFR_SF_D @ 0x1C00388D0
 * Callers:
 ...
 *     ?InitializeLockOrder@FxVerifierLock@@AEAAXXZ @ 0x1C0059F9C (-InitializeLockOrder@FxVerifierLock@@AEAAXXZ.c)
 *     GetImageName @ 0x1C005F478 (GetImageName.c)
 *     ?SetSpecialFileSupport@FxPkgPnp@@QEAAXW4_WDF_SPECIAL_FILE_TYPE@@E@Z @ 0x1C0082498 (-SetSpecialFileSupport@FxPkgPnp@@QEAAXW4_WDF_SPECIAL_FILE_TYPE@@E@Z.c)
 * Callees:
