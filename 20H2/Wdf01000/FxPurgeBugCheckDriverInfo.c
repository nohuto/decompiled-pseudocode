/*
 * XREFs of FxPurgeBugCheckDriverInfo @ 0x1C008FE2C
 * Callers:
...
void __fastcall FxPurgeBugCheckDriverInfo(_FX_DRIVER_GLOBALS *FxDriverGlobals)
{
  ...
  if ( (_DWORD)BugCheckDriverInfoIndex )
  {
    if ( P )
    {
      if ( (unsigned int)BugCheckDriverInfoIndex < dword_1C00A9F20 )
      {
        v5 = (_FX_DRIVER_GLOBALS **)((char *)P + 56 * BugCheckDriverInfoIndex);
        if ( *v5 == FxDriverGlobals )
        {
          if ( dword_1C00A9F20 - (_DWORD)BugCheckDriverInfoIndex != 1 )
            memmove(v5, v5 + 7, 56LL * (dword_1C00A9F20 - (unsigned int)BugCheckDriverInfoIndex - 1));
          if ( (unsigned int)BugCheckDriverInfoIndex < --dword_1C00A9F20 )
          {
            do
            {
            ...
            while ( (unsigned int)BugCheckDriverInfoIndex < dword_1C00A9F20 );
          }
        }
      }
    }
