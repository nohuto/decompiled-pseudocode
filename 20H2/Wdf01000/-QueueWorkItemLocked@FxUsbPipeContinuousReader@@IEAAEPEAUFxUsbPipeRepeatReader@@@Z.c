/*
 * XREFs of ?QueueWorkItemLocked@FxUsbPipeContinuousReader@@IEAAEPEAUFxUsbPipeRepeatReader@@@Z @ 0x1C006D0CC
 * Callers:
        ...
        FxUsbPipeRepeatReader *Repeater)
{
          ...
          1u) )
  {
    ...
    v6 = this->m_Pipe;
LABEL_6:
    ObjectHandleUnchecked = (const void *)FxObject::GetObjectHandleUnchecked(v6);
    WPP_IFR_SF_qdL(
      m_Globals,
      *(_DWORD *)(v10 + 328),
