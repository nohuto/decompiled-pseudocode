/*
 * XREFs of ?_AllocAndQueryPropertyEx@FxDevice@@SAJPEAU_FX_DRIVER_GLOBALS@@PEAUWDFDEVICE_INIT@@PEAV1@PEAXW4FxPropertyType@@W4_POOL_TYPE@@PEAU_WDF_OBJECT_ATTRIBUTES@@PEAPEAUWDFMEMORY__@@PEAK@Z @ 0x1C0052134
 * Callers:
...
LABEL_3:
  ...
  v19 = (_WDF_OBJECT_ATTRIBUTES *)PropertyMemory;
  *PropertyType = 0LL;
  *v16 = 0;
