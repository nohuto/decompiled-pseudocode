/*
 * XREFs of FxIoResourceRequirementsListInsertIoResList @ 0x1C005BAF0
 * Callers:
 *     imp_WdfIoResourceRequirementsListAppendIoResList @ 0x1C005C440 (imp_WdfIoResourceRequirementsListAppendIoResList.c)
 *     imp_WdfIoResourceRequirementsListInsertIoResList @ 0x1C005C540 (imp_WdfIoResourceRequirementsListInsertIoResList.c)
 * Callees:
