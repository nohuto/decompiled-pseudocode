/*
 * XREFs of Vf_VerifyWdfDeviceWdmDispatchIrpToIoQueue @ 0x1C00C1C74
 * Callers:
...
LABEL_7:
  ...
  if ( m_ParentDevice == m_Device )
  {
    if ( !m_ParentDevice )
    {
      ...
      v23 = 67;
LABEL_18:
      WPP_IFR_SF_qL(FxDriverGlobals, 2u, 0xDu, v23, WPP_FxDeviceApi_cpp_Traceguids, v22, 0xC000000D);
      goto LABEL_19;
    }
    ...
    if ( m_PkgPnp && !BYTE3(m_PkgPnp[1].m_DisposeSingleEntry.Next) )
    {
      ...
      WPP_IFR_SF_qL(FxDriverGlobals, 2u, 0xDu, 0x44u, WPP_FxDeviceApi_cpp_Traceguids, v25, v26);
      goto LABEL_19;
    }
  }
