/*
 * XREFs of PiRegStateReadStackCreationSettingsFromKey @ 0x1C00C5120
 * Callers:
 ...
 *     SeUtilSecurityInfoFromSecurityDescriptor @ 0x1C00C55AC (SeUtilSecurityInfoFromSecurityDescriptor.c)
 *     CmRegUtilUcValueGetFullBuffer @ 0x1C00C58E0 (CmRegUtilUcValueGetFullBuffer.c)
