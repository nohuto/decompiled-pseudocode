/*
 * XREFs of ?Initialize@FxPkgPdo@@UEAAJPEAUWDFDEVICE_INIT@@@Z @ 0x1C00787C0
 * Callers:
 *     <none>
 * Callees:
 ...
 *     ?FxCalculateTotalStringSize@@YA_KPEAUFxCollectionInternal@@EPEAE@Z @ 0x1C00611B0 (-FxCalculateTotalStringSize@@YA_KPEAUFxCollectionInternal@@EPEAE@Z.c)
 *     ?FxCopyMultiSz@@YAPEAGPEAGPEAUFxCollectionInternal@@@Z @ 0x1C0061224 (-FxCopyMultiSz@@YAPEAGPEAGPEAUFxCollectionInternal@@@Z.c)
...
int __fastcall FxPkgPdo::Initialize(FxPkgPdo *this, WDFDEVICE_INIT *DeviceInit)
{
  ...
  if ( result >= 0 )
  {
    ...
    v12 = FxPoolAllocator(this->m_Globals, &this->m_Globals->FxPoolFrameworks, 1u, _a2, this->m_Globals->Tag, Caller);
    this->m_IDsAllocation = (wchar_t *)v12;
    if ( v12 )
    {
      this->m_HardwareIDs = (wchar_t *)v12;
      v13 = FxCopyMultiSz((wchar_t *)v12, &DeviceInit->Pdo.HardwareIDs);
