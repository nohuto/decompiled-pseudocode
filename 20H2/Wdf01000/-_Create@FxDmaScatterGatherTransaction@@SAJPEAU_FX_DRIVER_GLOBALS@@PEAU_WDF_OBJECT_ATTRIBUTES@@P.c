/*
 * XREFs of ?_Create@FxDmaScatterGatherTransaction@@SAJPEAU_FX_DRIVER_GLOBALS@@PEAU_WDF_OBJECT_ATTRIBUTES@@PEAVFxDmaEnabler@@PEAPEAUWDFDMATRANSACTION__@@@Z @ 0x1C0034E44
 * Callers:
        ...
        WDFDMATRANSACTION__ **Transaction)
{
  ...
  $AA61F120FE94696E7B3472FF8202EE19 *v10; // rax
