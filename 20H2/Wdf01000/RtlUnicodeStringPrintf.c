/*
 * XREFs of RtlUnicodeStringPrintf @ 0x1C002DA34
 * Callers:
 *     ?FxLibraryCreateDevice@@YAJPEAU_UNICODE_STRING@@@Z @ 0x1C002CE08 (-FxLibraryCreateDevice@@YAJPEAU_UNICODE_STRING@@@Z.c)
 ...
 * Callees:
 *     RtlUnicodeStringValidateDestWorker @ 0x1C002DB60 (RtlUnicodeStringValidateDestWorker.c)
 *     RtlWideCharArrayVPrintfWorker @ 0x1C002DC88 (RtlWideCharArrayVPrintfWorker.c)
 */
