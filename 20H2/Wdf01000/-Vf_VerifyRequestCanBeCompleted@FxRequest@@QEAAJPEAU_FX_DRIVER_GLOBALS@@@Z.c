/*
 * XREFs of ?Vf_VerifyRequestCanBeCompleted@FxRequest@@QEAAJPEAU_FX_DRIVER_GLOBALS@@@Z @ 0x1C00C25C4
 * Callers:
...
__int64 __fastcall FxRequest::Vf_VerifyRequestCanBeCompleted(FxRequest *this, _FX_DRIVER_GLOBALS *FxDriverGlobals)
{
  ...
  if ( v4 )
    IsCurrentStackValid = FxRequest::Vf_VerifyRequestIsCurrentStackValid(this, v3);
  else
