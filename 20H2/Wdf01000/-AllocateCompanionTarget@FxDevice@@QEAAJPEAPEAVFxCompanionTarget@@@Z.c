/*
 * XREFs of ?AllocateCompanionTarget@FxDevice@@QEAAJPEAPEAVFxCompanionTarget@@@Z @ 0x1C004F7B4
 * Callers:
 ...
 *     ??0FxCompanionTarget@@QEAA@PEAU_FX_DRIVER_GLOBALS@@G@Z @ 0x1C004F6F0 (--0FxCompanionTarget@@QEAA@PEAU_FX_DRIVER_GLOBALS@@G@Z.c)
...
__int64 __fastcall FxDevice::AllocateCompanionTarget(FxDevice *this, FxCompanionTarget **DeviceCompanion)
{
  ...
  if ( v8 )
  {
    ...
    _a2 = FxCompanionLibrary::LoadCompanion(qword_1C00A9FC8, v12, SafePhysicalDevice, v13, v14);
