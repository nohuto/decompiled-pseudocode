/*
 * XREFs of FxLibraryCommonRegisterClient @ 0x1C0041194
 * Callers:
 *     LibraryRegisterClient @ 0x1C002D810 (LibraryRegisterClient.c)
 * Callees:
 *     memmove @ 0x1C001CB80 (memmove.c)
 *     ?IsClientInfoValid@@YAEPEAU_CLIENT_INFO@@@Z @ 0x1C0040CE4 (-IsClientInfoValid@@YAEPEAU_CLIENT_INFO@@@Z.c)
 ...
 *     McGenEventRegister_EtwRegister @ 0x1C0041A68 (McGenEventRegister_EtwRegister.c)
