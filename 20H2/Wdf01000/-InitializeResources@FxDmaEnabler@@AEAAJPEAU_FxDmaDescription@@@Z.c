/*
 * XREFs of ?InitializeResources@FxDmaEnabler@@AEAAJPEAU_FxDmaDescription@@@Z @ 0x1C0031998
 * Callers:
...
__int64 __fastcall FxDmaEnabler::InitializeResources(FxDmaEnabler *this, _FxDmaDescription *AdapterInfo)
{
  ...
  if ( (v10 & 8) != 0 )
  {
    ...
    if ( _a2 < 0 )
    {
      ...
      WPP_IFR_SF_qL(this->m_Globals, 2u, 0xFu, 0x15u, WPP_FxDmaEnabler_cpp_Traceguids, ObjectHandleUnchecked, _a2);
  ...
  if ( m_Globals->FxVerboseOn )
  {
    ...
    m_MaximumLength = AdapterInfo->MaximumFragmentLength;
  }
  if ( m_MaximumLength < this->m_MaximumLength )
  {
    if ( m_Globals->FxVerboseOn )
    {
      v19 = (const void *)FxObject::GetObjectHandleUnchecked(this);
      WPP_IFR_SF_qii(m_Globals, 5u, v21, 0x17u, WPP_FxDmaEnabler_cpp_Traceguids, v19, v21, v20);
    }
  }
  return 0LL;
}
