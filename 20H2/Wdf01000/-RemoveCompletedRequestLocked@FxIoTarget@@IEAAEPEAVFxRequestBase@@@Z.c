        ...
        unsigned __int8 a3)
{
  ...
  $1B06A8CAC2803A14CDDB839694AE83F6 *v7; // rax
  _IRP *Irp; // rdx
  ...
  v7 = &Request->120;
  if ( ($1B06A8CAC2803A14CDDB839694AE83F6 *)Flink->Blink != &Request->120
    || (Irp = Request->m_CsqContext.Irp, *($1B06A8CAC2803A14CDDB839694AE83F6 **)&Irp->Type != v7) )
  {
    __fastfail(3u);
  }
