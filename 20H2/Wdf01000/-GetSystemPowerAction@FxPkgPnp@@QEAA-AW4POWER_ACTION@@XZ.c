/*
 * XREFs of ?GetSystemPowerAction@FxPkgPnp@@QEAA?AW4POWER_ACTION@@XZ @ 0x1C007FBD4
 * Callers:
 ...
 *     ?GetSystemPowerAction@FxDevicePowerIrpTracker@@QEAA?AW4POWER_ACTION@@XZ @ 0x1C001C91C (-GetSystemPowerAction@FxDevicePowerIrpTracker@@QEAA-AW4POWER_ACTION@@XZ.c)
 */
