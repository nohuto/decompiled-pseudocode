/*
 * XREFs of imp_WdfDeviceSetDeviceState @ 0x1C0047C30
 * Callers:
 *     <none>
 * Callees:
 ...
 *     ?SetPnpState@FxPkgPnp@@QEAAXPEAU_WDF_DEVICE_STATE@@@Z @ 0x1C0082210 (-SetPnpState@FxPkgPnp@@QEAAXPEAU_WDF_DEVICE_STATE@@@Z.c)
 */
