/*
 * XREFs of imp_WdfDeviceSetPnpCapabilities @ 0x1C0047E50
 * Callers:
 *     <none>
 * Callees:
 ...
 *     ?SetPnpCaps@FxPkgPnp@@QEAAXPEAU_WDF_DEVICE_PNP_CAPABILITIES@@@Z @ 0x1C00820B0 (-SetPnpCaps@FxPkgPnp@@QEAAXPEAU_WDF_DEVICE_PNP_CAPABILITIES@@@Z.c)
 */
