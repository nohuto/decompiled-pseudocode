/*
 * XREFs of imp_WdfDeviceGetDevicePnpState @ 0x1C0002F10
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall imp_WdfDeviceGetDevicePnpState(_WDF_DRIVER_GLOBALS *DriverGlobals, unsigned __int64 Device)
{
  __int64 Offset; // r8
  FxDevice *v3; // rcx
  ...
  return (unsigned int)v3->m_CurrentPnpState;
}
