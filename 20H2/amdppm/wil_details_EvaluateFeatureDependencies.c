/*
 * XREFs of wil_details_EvaluateFeatureDependencies @ 0x1C0021444
 * Callers:
 *     wil_details_OnFeatureConfigurationChange @ 0x1C00215E0 (wil_details_OnFeatureConfigurationChange.c)
 ...
 *     wil_details_EvaluateFeatureDependencies_GetCachedFeatureEnabledState @ 0x1C00214F0 (wil_details_EvaluateFeatureDependencies_GetCachedFeatureEnabledState.c)
 */
...
_QWORD *wil_details_EvaluateFeatureDependencies()
{
  ...
  if ( v0 )
  {
    ...
    do
    {
      ...
      v0 = (int **)wil_details_FeatureDescriptors_SkipPadding(v0 + 4);
    }
    while ( v0 );
  }
  for ( i = wil_details_featureDescriptors_a; ; i = v6 + 4 )
  {
