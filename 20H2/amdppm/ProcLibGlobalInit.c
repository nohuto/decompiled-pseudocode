/*
 * XREFs of ProcLibGlobalInit @ 0x1C003778C
 * Callers:
 ...
 *     GetHiddenProcessorPresence @ 0x1C0022374 (GetHiddenProcessorPresence.c)
...
__int64 __fastcall ProcLibGlobalInit(PDEVICE_OBJECT DeviceObject)
{
  ...
  v37 = 0LL;
  v38 = 0LL;
  inited = ZwPowerInformation(ProcessorStateHandler, 0LL, 0, &dword_1C0013608, 0x110u);
  v3 = inited;
  if ( inited >= 0 )
  {
    v6 = dword_1C0013608;
    if ( dword_1C0013608 != 62 )
    {
...
LABEL_14:
    ...
    qword_1C0013950 = (__int64)&qword_1C0013948;
    qword_1C0013948 = (__int64)&qword_1C0013948;
    ...
    GetRegistryDwordValue(
      ...
      &v35);
    qword_1C00137C0 = (__int64)RegisterKernelIdleStates;
    v11 = 1280;
    byte_1C0013C04 = 0;
    qword_1C00137C8 = (__int64)RegisterKernelPerfStates;
    byte_1C0013830 = v35 == 0;
    dword_1C0013834 = 0;
    qword_1C00137D8 = (__int64)RegisterKernelPerfFeedback;
    v12 = 0;
    qword_1C00137E0 = (__int64)RegisterKernelLegacyPcc;
    qword_1C00137D0 = (__int64)RegisterKernelCap;
    qword_1C00137E8 = (__int64)RegisterKernelCpc;
    qword_1C00137F0 = (__int64)RegisterKernelPepPerf;
    qword_1C00137F8 = (__int64)GetNtProcessorNumber;
    qword_1C0013800 = (__int64)RegisterKernelPackage;
    qword_1C0013808 = (__int64)&PPM_ETW_SUMMARY2;
    qword_1C0013810 = (__int64)&PPM_ETW_IDLE_STATES_ERROR;
    qword_1C0013818 = (__int64)&PPM_ETW_PERF_STATES_ERROR;
    qword_1C0013820 = (__int64)&PPM_ETW_THROTTLE_STATES_ERROR;
    qword_1C0013828 = (__int64)&PPM_ETW_LONG_CAP_INFO;
    if ( !HviIsAnyHypervisorPresent() )
    {
      if ( (int)HalPrivateDispatchTable[143]((__int64)&v37) >= 0 )
      {
        ...
        qword_1C00136E8 = *((_QWORD *)&v37 + 1);
        xmmword_1C00136F0 = v38;
        qword_1C0013700 = v39;
      }
      dword_1C0013C00 = 2;
LABEL_48:
      ...
      if ( v25 < 0 )
      {
        if ( WPP_RECORDER_INITIALIZED != (_UNKNOWN *)&WPP_RECORDER_INITIALIZED )
          WPP_RECORDER_SF_D(
            ...
            (__int64)&WPP_4aa995de970d3daca8f220cb4e8727bd_Traceguids,
            v25);
        memset(&dword_1C0013508, 0, 0x100uLL);
        return v3;
      }
...
LABEL_82:
    ...
    if ( (InputBuffer & 0x100000000000LL) != 0 )
    {
      ...
      {
        dword_1C0013834 = 2;
        qword_1C00137C8 = (__int64)RegisterHvPerfStatesCounters;
        qword_1C00137D8 = (__int64)RegisterHvPerfFeedbackCounters;
        qword_1C00137E0 = (__int64)RegisterHvLegacyPccCounters;
        qword_1C00137E8 = (__int64)RegisterHvCpcCounters;
      }
      else
      {
        if ( !v32 )
        {
LABEL_41:
          dword_1C0013C00 = GetHiddenProcessorPresence();
          goto LABEL_48;
        }
        dword_1C0013834 = 1;
        qword_1C00137C8 = (__int64)RegisterHvPerfStates;
        qword_1C00137E0 = (__int64)RegisterHvLegacyPcc;
        qword_1C00137D8 = (__int64)RegisterNoop;
        qword_1C00137F0 = (__int64)RegisterNoop;
        qword_1C0013808 = (__int64)&PPM_ETW_SUMMARY2_MINROOT_HV;
        qword_1C0013818 = (__int64)&PPM_ETW_PERF_STATES_ERROR_MINROOT_HV;
        qword_1C0013820 = (__int64)&PPM_ETW_THROTTLE_STATES_ERROR_MINROOT_HV;
        qword_1C00137D0 = (__int64)RegisterHvCap;
        qword_1C0013828 = (__int64)&PPM_ETW_LONG_CAP_INFO_MINROOT_HV;
        qword_1C00137E8 = (__int64)RegisterHvCpc;
      }
      v11 = 1024;
      qword_1C00137C0 = (__int64)RegisterHvIdleStates;
      qword_1C0013810 = (__int64)&PPM_ETW_IDLE_STATES_ERROR_MINROOT_HV;
      qword_1C00137F8 = (__int64)GetLpIndex;
      v13 = RegisterHvPackage;
    }
    else
    {
      v12 = 1;
      qword_1C00137C0 = (__int64)RegisterGuestIdleStates;
      v13 = RegisterNoop;
