/*
 * XREFs of RegisterKernelPepPerf @ 0x1C00308F0
 * Callers:
 *     <none>
 * Callees:
 ...
 *     PepTranslateLimitReason @ 0x1C0035354 (PepTranslateLimitReason.c)
 */
...
__int64 __fastcall RegisterKernelPepPerf(__int64 a1)
{
  ...
  v52 = 0;
  memset(v50, 0, 32);
  v2(WdfDriverGlobals, qword_1C00133F8, 0LL);
  v3 = *(_QWORD *)(a1 + 1176);
  v4 = 0LL;
  v5 = 0LL;
  v47 = *(_DWORD *)(v3 + 16);
  if ( v47 )
  {
    v53 = *(_DWORD *)(v3 + 52);
    v54 = (v53 != -1) + 1;
    PerfDomain = GetPerfDomain(a1, (__int64)v50, &v52);
    v8 = *(_BYTE **)(a1 + 544);
    v51 = PerfDomain;
    if ( !v8 || !v8[48] )
      v8 = 0LL;
    ...
    if ( v19 )
    {
      ...
      *((_DWORD *)v4 + 9) = 1;
      ...
      v6 = ((__int64 (__fastcall *)(_QWORD *))qword_1C0013610)(v4);
      if ( v6 >= 0 )
      {
        ResetEnumerationContext((__int64 *)v50);
