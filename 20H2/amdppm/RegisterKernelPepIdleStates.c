/*
 * XREFs of RegisterKernelPepIdleStates @ 0x1C00301D0
 * Callers:
...
__int64 __fastcall RegisterKernelPepIdleStates(__int64 a1, __int64 a2, __int64 a3)
{
  ...
  (*(void (__fastcall **)(PWDF_DRIVER_GLOBALS, __int64, _QWORD))(WdfFunctions_01015 + 2504))(
    ...
    qword_1C00133F8,
    0LL);
  if ( !dword_1C0013994 || PlatformStatesRegistered )
  {
    v7 = 0;
  }
  else
  {
    HIDWORD(v34[0]) = dword_1C0013994;
    LODWORD(v34[0]) = 62;
    v34[5] = PepQueryPlatformStateResidency;
    v7 = ((__int64 (__fastcall *)(_QWORD *))qword_1C0013640)(v34);
    if ( v7 >= 0 )
    {
