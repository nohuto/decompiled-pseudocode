/*
 * XREFs of RegisterXsdDomain @ 0x1C002A624
 * Callers:
...
char __fastcall RegisterXsdDomain(_QWORD *a1)
{
  ...
  (*(void (__fastcall **)(PWDF_DRIVER_GLOBALS, __int64, _QWORD))(WdfFunctions_01015 + 2504))(
    ...
    qword_1C00133F8,
    0LL);
  for ( i = qword_1C0013420; (__int64 *)i != &qword_1C0013420; i = *(_QWORD *)i )
  {
    if ( *(_DWORD *)(i + 36) == v1[3] )
    {
      if ( v4 != *(_BYTE *)(i + 48) )
...
LABEL_19:
  ...
  if ( PoolWithTag )
  {
    ...
    *(_QWORD *)(i + 24) = i + 16;
    *(_QWORD *)(i + 16) = i + 16;
    v10 = (__int64 *)qword_1C0013428;
    if ( *(__int64 **)qword_1C0013428 == &qword_1C0013420 )
    {
      *(_QWORD *)i = &qword_1C0013420;
      *(_QWORD *)(i + 8) = v10;
      *v10 = i;
      qword_1C0013428 = i;
      *(_DWORD *)(i + 36) = v1[3];
