/*
 * XREFs of PepParkPreference @ 0x1C000DE50
 * Callers:
 *     <none>
 * Callees:
        ...
        __int64 a8)
{
  ...
  while ( v15 < v12 )
  {
    ...
    v14 = *((_QWORD *)&WPP_MAIN_CB.Queue.ListEntry.Blink->Flink + v20);
...
LABEL_23:
  ...
  if ( v15 && v14 )
  {
    ...
    v23[1] = v15;
    v24 = PepParkLists;
    result = ((__int64 (__fastcall *)(_QWORD, _DWORD *))qword_1C0013698)(*(_QWORD *)(v14 + 1104), v23);
    if ( (int)result < 0 )
    {
