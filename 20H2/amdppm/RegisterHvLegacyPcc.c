/*
 * XREFs of RegisterHvLegacyPcc @ 0x1C0022FA0
 * Callers:
 *     <none>
 * Callees:
 ...
 *     DecodeDoorbellAddressIo @ 0x1C0023F38 (DecodeDoorbellAddressIo.c)
...
__int64 __fastcall RegisterHvLegacyPcc(__int64 a1)
{
  ...
  v19 = dword_1C0013890;
  v14 = 0LL;
  if ( (unsigned __int8)qword_1C0013888 <= 1u )
  {
    v3 = qword_1C0013880;
    v5 = qword_1C0013878;
    if ( (_BYTE)qword_1C0013888 == 1 )
    {
  ...
  if ( v9 >= 0 )
  {
    HIDWORD(v23[0]) = dword_1C0013838;
    v23[2] = qword_1C0013868;
    LODWORD(v23[3]) = dword_1C0013870;
    v23[6] = v5 << v4;
    v23[5] = v3 << v4;
