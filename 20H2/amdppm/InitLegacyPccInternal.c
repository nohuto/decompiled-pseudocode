/*
 * XREFs of InitLegacyPccInternal @ 0x1C000A628
 * Callers:
 *     RegisterKernelLegacyPcc @ 0x1C000B200 (RegisterKernelLegacyPcc.c)
 *     RegisterHvLegacyPccCounters @ 0x1C0023280 (RegisterHvLegacyPccCounters.c)
 * Callees:
  ...
  if ( qword_1C0013968 )
  {
          ...
          (v3 = v12) != 0LL) )
    {
      ...
      *((_DWORD *)v3 + 8) = v16;
      ...
      if ( dword_1C00138E4 )
      {
        v17 = 0x989680 % ((unsigned int)dword_1C00138E4 >> 1);
        *((_DWORD *)v3 + 10) = 0x989680 / ((unsigned int)dword_1C00138E4 >> 1);
      }
      *((_DWORD *)v13 + 3) = 0;
      *((_WORD *)v13 + 8) = 0;
