/*
 * XREFs of RegisterKernelPackage @ 0x1C0030020
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall RegisterKernelPackage(__int64 a1)
{
  ...
  if ( *(_DWORD *)(a1 + 80) )
    ...
    v2 = ((__int64 (__fastcall *)(_QWORD))qword_1C0013708)(*(unsigned int *)(a1 + 56));
  v3 = v2;
  v4 = qword_1C0013430;
  ...
  if ( PoolWithTag )
  {
    ...
    *((_DWORD *)PoolWithTag + 9) = ((__int64 (__fastcall *)(_QWORD))qword_1C0013710)(v3);
