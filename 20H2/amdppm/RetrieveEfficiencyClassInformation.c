/*
 * XREFs of RetrieveEfficiencyClassInformation @ 0x1C0034728
 * Callers:
 ...
 *     GetProcessorEfficiencyClass @ 0x1C0034254 (GetProcessorEfficiencyClass.c)
 */
  ...
  while ( !(unsigned int)EnumerateNextDevice((__int64 *)v6, &v8) )
  {
    ...
    if ( (*(_QWORD *)(v8 + 272) & 0x2000000000LL) != 0 )
    {
      if ( (int)GetProcessorEfficiencyClass(v8, &v7) < 0 )
      {
        ...
        dword_1C00139DC = 1;
        qword_1C00139E0 = 0LL;
        LODWORD(qword_1C00139E0) = dword_1C00133F4;
        return v3;
      }
      v2 = v7;
      *(_BYTE *)(v1 + 368) = v7;
      ++*((_DWORD *)&qword_1C00139E0 + v2);
    }
  }
  for ( i = 0; i < 2; ++i )
  {
