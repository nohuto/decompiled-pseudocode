/*
 * XREFs of AcquirePccInterface @ 0x1C0023CF0
 * Callers:
...
__int64 __fastcall AcquirePccInterface(__int64 a1)
{
  ...
  else
  {
    ...
    if ( v3 >= 0 )
    {
      v3 = ValidatePccHeader(qword_1C00138E8);
      if ( v3 < 0 )
        goto LABEL_7;
      ...
      {
LABEL_7:
        ((void (__fastcall *)(__int64))qword_1C00138B8)(qword_1C00138A8);
        memset(&unk_1C00138A0, 0, 0x80uLL);
      }
    }
  }
