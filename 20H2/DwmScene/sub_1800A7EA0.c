/*
 * XREFs of sub_1800A7EA0 @ 0x1800A7EA0
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall sub_1800A7EA0(__int64 a1, _QWORD *a2)
{
  __int64 result; // rax
  int v5; // r8d
  int v6; // r8d
  ...
  if ( v7 )
  {
    ...
    *(_QWORD *)&v27 = *v9;
    *((_QWORD *)&v27 + 1) = v10;
    v11 = sub_1800D8398(v27, v28, 2LL);
    sub_1800AC570(a1, v11);
    v12 = sub_1800D8238(v27, v29, 2LL);
    result = sub_1800AC348(a1, v12);
    if ( v10 )
    {
