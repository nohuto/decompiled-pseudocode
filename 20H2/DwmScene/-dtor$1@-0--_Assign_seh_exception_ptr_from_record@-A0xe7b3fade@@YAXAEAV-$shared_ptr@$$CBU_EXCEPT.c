/*
 * XREFs of ?dtor$1@?0??_Assign_seh_exception_ptr_from_record@?A0xe7b3fade@@YAXAEAV?$shared_ptr@$$CBU_EXCEPTION_RECORD@@@std@@AEBU_EXCEPTION_RECORD@@QEAX@Z@4HA @ 0x18012035F
 * Callers:
 *     <none>
 * Callees:
