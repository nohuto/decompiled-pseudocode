/*
 * XREFs of sub_1800FF27C @ 0x1800FF27C
 * Callers:
...
__int64 __fastcall sub_1800FF27C(__int64 a1, __int64 a2, __int64 a3)
{
  __int64 v5; // rdi
  __int64 v6; // r12
  char v7; // r14
  ...
  *(_DWORD *)(a3 + 32) = 1;
  ...
  while ( 1 )
  {
    ...
    v34 = 0LL;
    v35 = 0LL;
    sub_18001CDF8(v33, (__int64)v52);
    v37 = 0LL;
    v38 = 0LL;
    sub_18001CDF8(v36, (__int64)Src);
    if ( (unsigned __int8)sub_1801001C4(v36, v33) )
      break;
    v40 = v36;
    v37 = 0LL;
    v38 = 0LL;
    sub_18001CDF8(v36, (__int64)v50);
    v34 = 0LL;
    v35 = 0LL;
    sub_18001CDF8(v33, (__int64)Src);
    sub_1801001C4(v33, v36);
    v40 = v36;
    v37 = 0LL;
    v38 = 0LL;
    sub_18001CDF8(v36, (__int64)v48);
    v34 = 0LL;
    v35 = 0LL;
    sub_18001CDF8(v33, (__int64)Src);
    if ( !(unsigned __int8)sub_1801001C4(v33, v36) )
    {
      if ( !v7 || !v47 )
        goto LABEL_32;
      memset(v56, 0, sizeof(v56));
      sub_1800B2CC4((__int64)v56, (__int64)Src, 1, 1);
...
LABEL_32:
    ...
    v27 = sub_1800B2A9C(a2, Src, v26);
    if ( !(unsigned __int8)std::ios_base::operator bool(v27 + *(int *)(*(_QWORD *)v27 + 4LL)) )
      goto LABEL_36;
  }
  memset(v57, 0, sizeof(v57));
  sub_1800B2CC4((__int64)v57, (__int64)Src, 1, 1);
  v54[2] = 0LL;
  v55 = 15LL;
  LOBYTE(v54[0]) = 0;
  v18 = sub_1800FD120((__int64)v57, v54);
  std::istream::operator>>(v18, &v47);
  v5 = v47 * v47 * v47;
  sub_1801003C4(a3 + 8, v5);
  if ( v55 < 0x10 )
  {
LABEL_25:
    sub_1800B2F70((__int64)&v57[144]);
    v20 = &v57[144];
LABEL_31:
...
LABEL_36:
  ...
  *(_QWORD *)a3 = v47;
  ...
  v51 = _mm_load_si128((const __m128i *)&xmmword_18013A450);
  LOBYTE(v50[0]) = 0;
  if ( v53 >= 0x10 )
  {
    v32 = v52[0];
