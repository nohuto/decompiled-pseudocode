/*
 * XREFs of sub_180094344 @ 0x180094344
 * Callers:
...
_QWORD *__fastcall sub_180094344(_QWORD *a1, __int64 *a2, int a3, __int64 a4, char a5)
{
  ...
  sub_1800CB9E8((_DWORD)a1, (unsigned int)v16, a3, -2147467263, a4, a5);
