/*
 * XREFs of sub_1800D3004 @ 0x1800D3004
 * Callers:
...
unsigned __int64 __fastcall sub_1800D3004(unsigned __int64 a1, unsigned __int64 a2, __int64 a3, char a4)
{
  ...
  do
  {
    if ( a3 <= 0 )
      break;
    sub_1800D29AC(&v12, v7, v4);
    LOBYTE(v11) = a4;
    a3 = (a3 >> 2) + (a3 >> 1);
    if ( (__int64)(v12 - v7) / 48 >= (__int64)(v4 - v13) / 48 )
    {
      sub_1800D3004(v13, v4, a3, v11);
      v4 = v12;
    }
    else
    {
      sub_1800D3004(v7, v12, a3, v11);
      v7 = v13;
    }
...
LABEL_9:
    if ( v10 >= 2 )
      return sub_1800D24E8(v7, v4);
  }
  else
  {
    sub_1800D27D8(v7, v4, a4);
    return sub_1800D2E8C(v7, v4);
  }
  return result;
}
