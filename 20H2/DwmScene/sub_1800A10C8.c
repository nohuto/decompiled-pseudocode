/*
 * XREFs of sub_1800A10C8 @ 0x1800A10C8
 * Callers:
...
__int64 __fastcall sub_1800A10C8(_QWORD *a1)
{
  _QWORD *v1; // r15
  _QWORD *v3; // rdi
  _QWORD *j; // rbx
  ...
  sub_1800A1B84(a1 + 2322);
  sub_1800A1C00(v1);
  sub_1800A1C00(a1 + 2324);
  sub_180067D38(a1 + 2);
  sub_180067D38(a1 + 261);
  v21 = 0LL;
