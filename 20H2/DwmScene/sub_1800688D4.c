/*
 * XREFs of sub_1800688D4 @ 0x1800688D4
 * Callers:
...
__int64 __fastcall sub_1800688D4(__int64 a1, __int64 a2, int a3, int a4, int a5)
{
  int v5; // r10d
  __int64 v7; // r9
  int v8; // eax
  ...
  return sub_1800D99B8((unsigned int)*(_QWORD *)(a1 + 96) + 64, a2, a3, a4, v5);
}
