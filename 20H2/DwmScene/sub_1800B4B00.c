/*
 * XREFs of sub_1800B4B00 @ 0x1800B4B00
 * Callers:
 ...
 *     sub_1800B77CC @ 0x1800B77CC (sub_1800B77CC.c)
...
_QWORD *__fastcall sub_1800B4B00(__int64 a1, _QWORD *a2, _QWORD *a3, _QWORD *a4)
{
  __int64 v8; // r8
  __int64 v9; // rdx
