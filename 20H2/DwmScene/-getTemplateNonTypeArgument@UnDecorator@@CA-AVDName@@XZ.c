/*
 * XREFs of ?getTemplateNonTypeArgument@UnDecorator@@CA?AVDName@@XZ @ 0x1800EF8FC
 * Callers:
 *     sub_1800EEDE8 @ 0x1800EEDE8 (sub_1800EEDE8.c)
 *     sub_1800EFB24 @ 0x1800EFB24 (sub_1800EFB24.c)
 *     sub_1800EFEDC @ 0x1800EFEDC (sub_1800EFEDC.c)
 * Callees:
 *     sub_18000FD48 @ 0x18000FD48 (sub_18000FD48.c)
 *     ??4?$shared_ptr@V__ExceptionPtr@@@std@@QEAAAEAV01@AEBV01@@Z @ 0x1800113F8 (--4-$shared_ptr@V__ExceptionPtr@@@std@@QEAAAEAV01@AEBV01@@Z.c)
 *     sub_180027FF4 @ 0x180027FF4 (sub_180027FF4.c)
 *     sub_1800ED2E4 @ 0x1800ED2E4 (sub_1800ED2E4.c)
...
__int64 __fastcall UnDecorator::getTemplateNonTypeArgument(__int64 a1)
{
  ...
  {
    v28 = 0LL;
    sub_1800ED2E4(*(_QWORD *)(a1 + 16), &v28);
    v4 = (_QWORD *)sub_1800EFB3C(v2, v23);
    v5 = (_QWORD)v28 != *v4;
    v6 = v24;
    if ( v24 )
    {
    ...
    if ( v5 )
    {
      ...
      sub_180027FF4(pExceptionObject, v22, 741, (__int64)v26, 0);
