...
__int64 __fastcall sub_1800915D4(_QWORD *a1)
{
  ...
  *a1 = &Spectre::Engine::Mesh::`vftable';
  ...
  v4 = (volatile signed __int32 *)a1[31];
  if ( v4 )
  {
  ...
  v5 = (volatile signed __int32 *)a1[29];
  if ( v5 )
  {
  ...
  v7 = (volatile signed __int32 *)a1[25];
  if ( v7 )
  {
  ...
  v8 = (volatile signed __int32 *)a1[23];
  if ( v8 )
  {
  ...
  v9 = (volatile signed __int32 *)a1[21];
  if ( v9 )
  {
  ...
  v10 = (volatile signed __int32 *)a1[19];
  if ( v10 )
  {
  ...
  result = sub_180022184((__int64)a1);
  v12 = (volatile signed __int32 *)a1[13];
  if ( v12 )
  {
