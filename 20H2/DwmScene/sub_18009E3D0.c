/*
 * XREFs of sub_18009E3D0 @ 0x18009E3D0
 * Callers:
...
__int64 __fastcall sub_18009E3D0(__int64 *a1, __int64 a2, size_t *a3)
{
  __int64 *v6; // rax
  __int64 *v7; // rbx
  const void *v8; // rdx
...
LABEL_14:
    v14 = *a1;
    v17[0] = (__int64)a3;
    v15 = sub_18009C41C((__int64)a1, v14, (__int64)&unk_1801D04A5, v17);
