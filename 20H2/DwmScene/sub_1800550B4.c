...
int *sub_1800550B4()
{
  if ( dword_1802191B0 > *(_DWORD *)(*((_QWORD *)NtCurrentTeb()->ThreadLocalStoragePointer + (unsigned int)TlsIndex)
                                   + 44LL) )
  {
    Init_thread_header(&dword_1802191B0);
    if ( dword_1802191B0 == -1 )
    {
      ...
      Init_thread_footer(&dword_1802191B0);
    }
  }
