/*
 * XREFs of sub_1800A5DA0 @ 0x1800A5DA0
 * Callers:
...
void __fastcall sub_1800A5DA0(__int64 a1, unsigned __int64 *a2, unsigned __int64 *a3)
{
  ...
  if ( v6 <= v9 )
  {
    ...
    for ( i = v15; i != v7; i += 4 )
      unknown_libname_101(i);
  }
  else
  {
    if ( v6 > (__int64)(*(_QWORD *)(a1 + 16) - (_QWORD)v8) >> 5 )
    {
      sub_1800ADF84(a1, ((char *)a3 - (char *)a2) >> 5);
      v9 = 0LL;
      v8 = *(char **)a1;
    }
    v10 = (__int64)&v4[4 * v9];
