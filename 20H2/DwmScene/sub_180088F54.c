/*
 * XREFs of sub_180088F54 @ 0x180088F54
 * Callers:
...
unsigned __int64 __fastcall sub_180088F54(unsigned __int64 *a1, _DWORD *a2, double a3, double a4)
{
  __m128 v4; // xmm0
  __m128 v5; // xmm1
  __m128 v6; // xmm9
  ...
  v12 = _mm_add_ps(_mm_mul_ps((__m128)xmmword_180139930[0], v11), v9);
  v13 = _mm_add_ps(
          _mm_add_ps(
  ...
  do
  {
    v15 = (__m128)xmmword_180139930[result++];
  ...
  while ( result < 8 );
  v18 = _mm_mul_ps(_mm_add_ps(v13, v14), (__m128)xmmword_18013A500);
  if ( !a2 )
  ...
  *a2 = v18.m128_i32[0];
  ...
  v19 = _mm_mul_ps(_mm_sub_ps(v13, v14), (__m128)xmmword_18013A500);
  if ( a2 == (_DWORD *)-12LL )
    wassert(L"pDestination", L"OneCoreUap\\External\\Sdk\\Inc\\DirectXMathConvert.inl", 0x5F3u);
  a2[3] = v19.m128_i32[0];
