/*
 * XREFs of sub_180016C80 @ 0x180016C80
 * Callers:
...
_QWORD *__fastcall sub_180016C80(__int64 a1, _QWORD *a2, __int64 a3, __int64 a4)
{
  void *v8; // rax
  __int64 v9; // r8
  void *v10; // rbx
  ...
  if ( v8 )
  {
    ...
    *((_QWORD *)&v19 + 1) = v11;
    v8 = (void *)sub_1800219FC(v10, a1, &v19);
  }
  v17 = 0LL;
  LOBYTE(v9) = v16;
  sub_1800182D0(&v17, v8, v9);
  v24 = 0LL;
  v12 = v17;
