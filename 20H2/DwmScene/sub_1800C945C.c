/*
 * XREFs of sub_1800C945C @ 0x1800C945C
 * Callers:
...
char __fastcall sub_1800C945C(__int64 a1, _QWORD *a2)
{
  __int64 v4; // rdx
  ...
  if ( *(_BYTE *)(a1 + 152) )
  {
    ...
    sub_180027FF4(pExceptionObject, v16, 78, (__int64)v19, 0);
...
LABEL_20:
        ...
        if ( v12 == *v11 )
        {
          ...
          v22 = v10;
          sub_1800C85E4((__int64 *)(a1 + 136), (__int64)&v17, &v22);
