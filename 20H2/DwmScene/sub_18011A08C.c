/*
 * XREFs of sub_18011A08C @ 0x18011A08C
 * Callers:
...
__int64 __fastcall sub_18011A08C(_QWORD *a1, __int64 a2, char *a3, __int64 a4)
{
  char *v5; // r10
  __int64 v8; // r15
  __int64 v9; // rdx
...
LABEL_17:
        ...
        if ( !v20 )
        {
          ...
          *(_QWORD *)(*(_QWORD *)a4 + 8LL) = *(_QWORD *)(a4 + 8);
          --a1[2];
          sub_18011CB50(a4 + 48);
          unknown_libname_101((__int64 *)(a4 + 16));
          j_j__o_free(a4);
          *(_QWORD *)a2 = v12;
          *(_BYTE *)(a2 + 8) = 0;
          result = a2;
  ...
  {
    v33 = sub_180089BB4((__int64)a1, &v35, a4);
    sub_18011A62C(a1, &v36, *v33);
    throw;
  }
LABEL_36:
  try
