/*
 * XREFs of sub_180062F8C @ 0x180062F8C
 * Callers:
...
_QWORD *__fastcall sub_180062F8C(__int64 a1, _QWORD *a2)
{
  __int64 v4; // rax
  ...
  sub_18006313C(a1, v10, v9, v8, v6, 0LL);
  v11 = *a2;
  v19 = 0LL;
  v12 = *(_QWORD *)(v11 + 104);
  if ( v12 )
  ...
  *((_QWORD *)&v19 + 1) = v13;
  ...
  if ( v15 )
  {
    ...
    v20 = *(_OWORD *)(v16 + 112);
    sub_180099BB8(v15, &v20);
  }
  v22 = *(_DWORD *)(*a2 + 88LL);
  sub_18003264C((__int64 **)(a1 + 120), (__int64)&v21, &v22);
