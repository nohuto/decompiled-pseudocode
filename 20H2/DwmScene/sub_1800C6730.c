...
__m128 *__fastcall sub_1800C6730(__m128 *a1, __m128 *a2)
{
  ...
  v4 = _mm_mul_ps((__m128)xmmword_1801D2A00, a2[3]);
  ...
  if ( a2 == (__m128 *)-16LL )
    wassert(L"pSource", L"OneCoreUap\\External\\Sdk\\Inc\\DirectXMathConvert.inl", 0x2A5u);
  v5 = _mm_mul_ps((__m128)xmmword_1801D2A00, a2[1]);
  ...
  if ( a2 == (__m128 *)-32LL )
    wassert(L"pSource", L"OneCoreUap\\External\\Sdk\\Inc\\DirectXMathConvert.inl", 0x2A5u);
  v6 = a2 + 8;
  v7 = _mm_mul_ps((__m128)xmmword_1801D2A00, a2[2]);
  ...
  if ( a2 == (__m128 *)-128LL )
    wassert(L"pSource", L"OneCoreUap\\External\\Sdk\\Inc\\DirectXMathConvert.inl", 0x2A5u);
  v8 = a2 + 6;
  v9 = _mm_mul_ps((__m128)xmmword_1801D29C0, *v6);
  if ( a2 == (__m128 *)-96LL )
    wassert(L"pSource", L"OneCoreUap\\External\\Sdk\\Inc\\DirectXMathConvert.inl", 0x2A5u);
  v10 = _mm_mul_ps((__m128)xmmword_1801D29B0, *v8);
  if ( !a2 )
    wassert(L"pSource", L"OneCoreUap\\External\\Sdk\\Inc\\DirectXMathConvert.inl", 0x2A5u);
  v11 = _mm_add_ps(v9, _mm_sub_ps(_mm_mul_ps((__m128)xmmword_1801D29F0, *a2), v10));
  ...
  v12 = _mm_sub_ps(
          _mm_sub_ps(_mm_mul_ps((__m128)xmmword_1801D29F0, *a2), _mm_mul_ps(*v8, (__m128)xmmword_1801D29B0)),
          _mm_mul_ps((__m128)xmmword_1801D29C0, *v6));
  ...
  v13 = _mm_add_ps(_mm_mul_ps((__m128)xmmword_1801D29D0, *v8), _mm_mul_ps((__m128)xmmword_1801D29F0, *a2));
  ...
  if ( a2 == (__m128 *)-80LL )
    wassert(L"pSource", L"OneCoreUap\\External\\Sdk\\Inc\\DirectXMathConvert.inl", 0x2A5u);
  v14 = _mm_mul_ps((__m128)xmmword_1801D29E0, a2[5]);
  ...
  if ( a2 == (__m128 *)-112LL )
    wassert(L"pSource", L"OneCoreUap\\External\\Sdk\\Inc\\DirectXMathConvert.inl", 0x2A5u);
  v15 = _mm_mul_ps((__m128)xmmword_1801D29E0, a2[7]);
  ...
  if ( !v16 )
    wassert(L"pSource", L"OneCoreUap\\External\\Sdk\\Inc\\DirectXMathConvert.inl", 0x2A5u);
  v17 = _mm_mul_ps((__m128)xmmword_1801D29E0, *v16);
