/*
 * XREFs of sub_18010B52C @ 0x18010B52C
 * Callers:
...
_QWORD *__fastcall sub_18010B52C(_QWORD *a1, unsigned __int64 a2)
{
  ...
  if ( (_QWORD *)*result != result )
  {
    ...
    {
      v8 = *(_QWORD *)a1[1];
      result = (_QWORD *)sub_1801075B4(a1, (__int64)v9, (size_t *)(v8 + 16), v8);
    }
    while ( v8 != v7 );
  }
  return result;
