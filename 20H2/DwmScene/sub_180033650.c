/*
 * XREFs of sub_180033650 @ 0x180033650
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall sub_180033650(__int64 a1, _QWORD *a2)
{
  __int64 result; // rax
  int v5; // r14d
  __int64 v6; // rdx
  ...
  {
    v18 = 0LL;
    sub_180027DD0((__int64 *)&v18, a2);
    v15 = 0LL;
    sub_1800338FC(v18, &v15);
    v21 = 0LL;
