...
char *__fastcall sub_18007D7C8(char *a1, char *a2, char *a3, __int64 a4, __int64 a5, __int64 a6)
{
  char *result; // rax
  __int64 v9; // rbp
  __int64 v10; // rsi
  ...
  if ( a4 < a5 )
  {
    ...
    do
    {
      ...
      v9 = v11 - v13;
      v14 = &v12[16 * v13];
      result = (char *)sub_18007D884((_DWORD)a1, (_DWORD)v12, (_DWORD)v14, (_DWORD)a3, a6);
      a3 = result;
      a1 = v14;
    }
    while ( a4 < v9 );
