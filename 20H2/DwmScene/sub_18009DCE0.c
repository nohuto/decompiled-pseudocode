/*
 * XREFs of sub_18009DCE0 @ 0x18009DCE0
 * Callers:
...
__int64 __fastcall sub_18009DCE0(__int64 **a1, __int64 a2, char a3, unsigned __int64 *a4, _QWORD *a5)
{
  __int64 *v8; // rdx
  __int64 *v9; // rsi
  __int64 v10; // rax
  ...
  {
    sub_180038644((__int64)v17, (__int64)v16);
    throw;
  }
  return result;
}
