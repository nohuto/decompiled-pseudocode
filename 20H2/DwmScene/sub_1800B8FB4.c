/*
 * XREFs of sub_1800B8FB4 @ 0x1800B8FB4
 * Callers:
 *     sub_1800C6090 @ 0x1800C6090 (sub_1800C6090.c)
 * Callees:
...
__int64 __fastcall sub_1800B8FB4(__int64 a1, const void **a2)
{
...
LABEL_14:
  ...
  v23 = _mm_load_si128((const __m128i *)&xmmword_18013C0F0);
  LOWORD(v22[0]) = 0;
  v13 = v27;
...
LABEL_31:
  ...
  return unknown_libname_101(v29);
}
