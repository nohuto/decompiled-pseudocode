/*
 * XREFs of sub_1801029A0 @ 0x1801029A0
 * Callers:
 *     sub_180103164 @ 0x180103164 (sub_180103164.c)
 *     sub_1801041B0 @ 0x1801041B0 (sub_1801041B0.c)
 * Callees:
 *     sub_1801025BC @ 0x1801025BC (sub_1801025BC.c)
 *     memcmp @ 0x18011E0BE (memcmp.c)
 */

__int64 __fastcall sub_1801029A0(_QWORD *a1, __int64 a2, char a3, size_t *a4, _QWORD *a5)
{
  _QWORD *v8; // r13
  __int64 *v9; // rbx
  ...
  try
  {
    *(_QWORD *)a2 = *sub_1801025BC(a1, &v26, v10, v8, (int)a4, v26);
    *(_BYTE *)(a2 + 8) = 1;
    result = a2;
  }
  catch ( ... )
  {
    sub_180104394(v28, v27);
    throw;
  }
  return result;
}
