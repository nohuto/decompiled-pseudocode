/*
 * XREFs of sub_1801057E4 @ 0x1801057E4
 * Callers:
...
__int64 __fastcall sub_1801057E4(__int64 a1, __int64 a2, _QWORD *a3)
{
...
LABEL_17:
  ...
  if ( *(_QWORD **)a1 != v8 )
  {
    do
    {
      unknown_libname_100((__int64)v9, 0);
      v9 += 2;
    }
    while ( v9 != v8 );
    v9 = *(_QWORD **)a1;
