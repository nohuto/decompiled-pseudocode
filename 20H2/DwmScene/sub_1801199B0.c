/*
 * XREFs of sub_1801199B0 @ 0x1801199B0
 * Callers:
...
__int64 __fastcall sub_1801199B0(__int64 **a1, __int64 a2, char a3, int *a4, _QWORD *a5)
{
  __int64 *v8; // rdx
  __int64 *v9; // rsi
  __int64 v10; // rax
  ...
  {
    sub_1800268AC((__int64)v18, (__int64)v17);
    throw;
  }
  return result;
}
