  ...
  if ( *(_QWORD *)(a3 + 16) )
  {
    ...
    *((_QWORD *)&v91 + 1) = v7;
    ...
    if ( (*(_DWORD *)(v144 + 440) & 0x2000000) != 0 )
    {
      ...
      v8 = qword_18021AB50;
      v9 = HIDWORD(qword_18021AB50);
      v10 = dword_18021AB58;
      v143 = xmmword_18020DC60;
      v11 = 0.0;
      v86 = 0LL;
      v12 = v144;
      if ( (_QWORD)v144 )
      ...
      sub_1800C62A4(a3, &v94, &unk_18020ABD0);
      v18 = v94;
      v19 = 0LL;
      if ( v94 != v95 )
      {
        ...
        if ( v19 )
        {
          v20 = (*(double (__fastcall **)(__int64, void *))(*(_QWORD *)v6 + 88LL))(v6, &unk_18020ABD0);
          v8 = LODWORD(v20);
        }
      }
      sub_1800C62A4(a3, &v96, &unk_18020ABF0);
      v21 = v96;
      v22 = 0LL;
      if ( v96 != v97 )
      {
        ...
        if ( v22 )
        {
          v23 = (*(double (__fastcall **)(__int64, void *))(*(_QWORD *)v6 + 88LL))(v6, &unk_18020ABF0);
          v9 = LODWORD(v23);
        }
      }
      sub_1800C62A4(a3, &v98, &unk_18020AC10);
      v24 = v98;
      v25 = 0LL;
      if ( v98 != v99 )
      {
        ...
        if ( v25 )
        {
          v26 = (*(double (__fastcall **)(__int64, void *))(*(_QWORD *)v6 + 88LL))(v6, &unk_18020AC10);
          v10 = LODWORD(v26);
        }
      }
      sub_1800C62A4(a3, &v100, &unk_18020AC30);
      v27 = v100;
      v28 = 0LL;
      if ( v100 != v101 )
      {
        ...
        while ( v27 != v101 );
        if ( v28 )
          LODWORD(v143) = (*(float (__fastcall **)(__int64, void *))(*(_QWORD *)v6 + 88LL))(v6, &unk_18020AC30);
      }
      sub_1800C62A4(a3, &v102, &unk_18020AC50);
      v29 = v102;
      v30 = 0LL;
      if ( v102 != v103 )
      {
        ...
        while ( v29 != v103 );
        if ( v30 )
          DWORD1(v143) = (*(float (__fastcall **)(__int64, void *))(*(_QWORD *)v6 + 88LL))(v6, &unk_18020AC50);
      }
      sub_1800C62A4(a3, &v104, &unk_18020AC70);
      v31 = v104;
      v32 = 0LL;
      if ( v104 != v105 )
      {
        ...
        while ( v31 != v105 );
        if ( v32 )
          DWORD2(v143) = (*(float (__fastcall **)(__int64, void *))(*(_QWORD *)v6 + 88LL))(v6, &unk_18020AC70);
      }
      sub_1800C62A4(a3, &v106, &unk_18020AC90);
      v33 = v106;
      v34 = 0LL;
      if ( v106 != v107 )
      {
        ...
        while ( v33 != v107 );
        if ( v34 )
          HIDWORD(v143) = (*(float (__fastcall **)(__int64, void *))(*(_QWORD *)v6 + 88LL))(v6, &unk_18020AC90);
      }
      sub_1800C62A4(a3, &v108, &unk_18020ACB0);
      v35 = v108;
      v36 = 0LL;
      if ( v108 != v109 )
      {
        ...
        if ( v36 )
        {
          v37 = (*(double (__fastcall **)(__int64, void *))(*(_QWORD *)v6 + 88LL))(v6, &unk_18020ACB0);
          v11 = *(float *)&v37;
        }
      }
      ...
      if ( v16 )
      {
        ...
        *(_DWORD *)(v16 + 148) = v9;
        *(_DWORD *)(v16 + 152) = v10;
        v39 = _InterlockedIncrement64(&qword_180208648);
        v40 = v86;
        *(_QWORD *)(v86 + 208) = v39;
        v41 = *(_QWORD *)(v40 + 216);
        if ( v39 >= v41 )
      ...
      if ( (_QWORD)v89 )
      {
        sub_1800C62A4(a3, &v110, &unk_18020AEF0);
        v43 = v110;
        v44 = 0LL;
        if ( v110 != v111 )
        {
          ...
          if ( v44 )
          {
            (*(void (__fastcall **)(__int64, void *))(*(_QWORD *)v6 + 88LL))(v6, &unk_18020AEF0);
            sub_1800F84F4(v42);
          }
        }
        sub_1800C62A4(a3, &v112, &unk_18020AED0);
        v45 = v112;
        v46 = 0LL;
        if ( v112 != v113 )
        {
          ...
          if ( v46 )
          {
            (*(void (__fastcall **)(__int64, void *))(*(_QWORD *)v6 + 88LL))(v6, &unk_18020AED0);
            sub_1800F84C8(v42);
          }
        }
        sub_1800C62A4(a3, &v114, &unk_18020AF50);
        v47 = v114;
        v48 = 0LL;
        if ( v114 != v115 )
        {
          ...
          if ( v48 )
          {
            (*(void (__fastcall **)(__int64, void *))(*(_QWORD *)v6 + 88LL))(v6, &unk_18020AF50);
            sub_1800F84E8(v42);
          }
        }
        sub_1800C62A4(a3, &v116, &unk_18020ADF0);
        v49 = v116;
        v50 = 0LL;
        if ( v116 != v117 )
        {
          ...
          if ( v50 )
          {
            (*(void (__fastcall **)(__int64, void *))(*(_QWORD *)v6 + 88LL))(v6, &unk_18020ADF0);
            sub_1800F8538(v42);
          }
        }
        sub_1800C62A4(a3, &v118, &unk_18020ADD0);
        v51 = v118;
        v52 = 0LL;
        if ( v118 != v119 )
        {
          ...
          if ( v52 )
          {
            (*(void (__fastcall **)(__int64, void *))(*(_QWORD *)v6 + 88LL))(v6, &unk_18020ADD0);
            sub_1800F8544(v42);
          }
        }
        sub_1800C62A4(a3, &v120, &unk_18020AE30);
        v53 = v120;
        v54 = 0LL;
        if ( v120 != v121 )
        {
          ...
          if ( v54 )
          {
            (*(void (__fastcall **)(__int64, void *))(*(_QWORD *)v6 + 88LL))(v6, &unk_18020AE30);
            sub_1800F8550(v42);
          }
        }
        sub_1800C62A4(a3, &v122, &unk_18020AE50);
        v55 = v122;
        v56 = 0LL;
        if ( v122 != v123 )
        {
          ...
          if ( v56 )
          {
            (*(void (__fastcall **)(__int64, void *))(*(_QWORD *)v6 + 88LL))(v6, &unk_18020AE50);
            sub_1800F8500(v42);
          }
        }
        sub_1800C62A4(a3, &v124, &unk_18020AE10);
        v57 = v124;
        v58 = 0LL;
        if ( v124 != v125 )
        {
          ...
          if ( v58 )
          {
            (*(void (__fastcall **)(__int64, void *))(*(_QWORD *)v6 + 88LL))(v6, &unk_18020AE10);
            sub_1800F84DC(v42);
          }
        }
        sub_1800C62A4(a3, &v126, &unk_18020AE70);
        v59 = v126;
        v60 = 0LL;
        if ( v126 != v127 )
        {
          ...
          if ( v60 )
          {
            (*(void (__fastcall **)(__int64, void *))(*(_QWORD *)v6 + 88LL))(v6, &unk_18020AE70);
            sub_1800F85B8(v42);
          }
        }
        sub_1800C62A4(a3, &v128, &unk_18020AE90);
        v61 = v128;
        v62 = 0LL;
        if ( v128 != v129 )
        {
          ...
          if ( v62 )
          {
            (*(void (__fastcall **)(__int64, void *))(*(_QWORD *)v6 + 88LL))(v6, &unk_18020AE90);
            sub_1800F85D0(v42);
          }
        }
        sub_1800C62A4(a3, &v130, &unk_18020AEB0);
        v63 = v130;
        v64 = 0LL;
        if ( v130 != v131 )
        {
          ...
          if ( v64 )
          {
            (*(void (__fastcall **)(__int64, void *))(*(_QWORD *)v6 + 88LL))(v6, &unk_18020AEB0);
            sub_1800F85C4(v42);
          }
        }
        sub_1800C62A4(a3, &v132, &unk_18020AF70);
        v65 = v132;
        v66 = 0LL;
        if ( v132 != v133 )
        {
          ...
          if ( v66 )
          {
            (*(void (__fastcall **)(__int64, void *))(*(_QWORD *)v6 + 88LL))(v6, &unk_18020AF70);
            sub_1800F85E8(v42);
          }
        }
        sub_1800C62A4(a3, &v134, &unk_18020AF90);
        v67 = v134;
        v68 = 0LL;
        if ( v134 != v135 )
        {
          ...
          if ( v68 )
          {
            (*(void (__fastcall **)(__int64, void *))(*(_QWORD *)v6 + 88LL))(v6, &unk_18020AF90);
            sub_1800F85DC(v42);
          }
        }
        sub_1800C62A4(a3, &v136, &unk_18020ADB0);
        v69 = v136;
        v70 = 0LL;
        if ( v136 != v137 )
        {
          ...
          if ( v70 )
          {
            v71 = (*(__int64 (__fastcall **)(__int64, void *, _QWORD))(*(_QWORD *)v6 + 72LL))(v6, &unk_18020ADB0, 0LL);
            sub_1800F84D4(v42, v71);
          }
        }
        sub_1800C62A4(a3, &v138, &unk_18020AFB0);
        v72 = v138;
        v73 = 0LL;
        if ( v138 != v139 )
        {
          ...
          if ( v73 )
          {
            v74 = (*(__int64 (__fastcall **)(__int64, void *, _QWORD))(*(_QWORD *)v6 + 72LL))(v6, &unk_18020AFB0, 0LL);
            sub_1800F8588(v42, v74);
          }
        }
        sub_1800C62A4(a3, &v140, &unk_18020AF30);
        v75 = v140;
        v76 = 0LL;
        if ( v140 != v141 )
        {
        ...
        sub_1800C62A4(a3, v92, &unk_18020AD10);
        v78 = (_QWORD *)v92[0];
        v79 = 0LL;
        ...
        sub_1800C62A4(a3, v93, &unk_18020AF10);
        v81 = (_QWORD *)v93[0];
        v82 = 0LL;
