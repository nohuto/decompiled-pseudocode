/*
 * XREFs of sub_18010A1F0 @ 0x18010A1F0
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall sub_18010A1F0(__int64 a1, __int128 *a2, int **a3)
{
  __int64 v6; // rdx
  __int64 v7; // rsi
...
LABEL_20:
  ...
  v18[2] = 0LL;
  v18[3] = 0LL;
  sub_18001CDF8(v18, (__int64)v23);
  v9 = sub_18009FE8C(a2, &v19, v18, &v17);
  v10 = (__int64 *)(a1 + 56);
  ...
  sub_1800E657C(*v10, v12);
  sub_1800E6608(*v10, (__int64)a3);
