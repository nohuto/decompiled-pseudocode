/*
 * XREFs of sub_1800862F4 @ 0x1800862F4
 * Callers:
...
__int64 __fastcall sub_1800862F4(__int64 a1, __int64 a2, unsigned __int64 a3, _QWORD *a4, _QWORD *a5)
{
  __int64 *v9; // rax
  ...
  if ( !*a4 )
  {
    v9 = (__int64 *)sub_180087B70(*a5, v25);
  ...
  {
    sub_18000FD48(v28);
    v18 = sub_18000FD48(v27);
    sub_180027FF4(v31, v18, 318, (__int64)v28, 0);
    throw (Spectre::Engine::EngineInvalidArgException *)v31;
  }
  v23 = *(_QWORD *)(a1 + 128);
  v12 = v23;
  sub_18008A270(a1 + 120, &v19, &v33);
  if ( v19 != v12 )
  {
    sub_18000FD48(v30);
    v17 = sub_18000FD48(v29);
    sub_180027FF4(pExceptionObject, v17, 323, (__int64)v30, 0);
