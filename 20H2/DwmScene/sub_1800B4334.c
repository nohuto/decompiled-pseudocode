/*
 * XREFs of sub_1800B4334 @ 0x1800B4334
 * Callers:
...
_QWORD *__fastcall sub_1800B4334(__int64 a1, _QWORD *a2)
{
  __int64 v4; // r14
  __int64 v5; // rcx
  __int64 v6; // rbx
...
LABEL_27:
    ...
    v15 = *(_OWORD *)(a1 + 8);
    sub_1800B2C3C((__int64)&v20, (__int64)&v15);
