/*
 * XREFs of sub_180095BE0 @ 0x180095BE0
 * Callers:
...
_QWORD *__fastcall sub_180095BE0(__int64 a1, _QWORD *a2, unsigned __int64 a3, int a4)
{
  __int64 v5; // r11
  _QWORD *v6; // rdx
  __int64 v7; // rcx
  ...
  if ( a3 >= (*(_QWORD *)(a1 + 112) - v5) / 88 )
  {
    ...
    sub_1800CB940((unsigned int)pExceptionObject, v14, 178, (unsigned int)v16, 0);
