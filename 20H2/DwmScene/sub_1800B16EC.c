/*
 * XREFs of sub_1800B16EC @ 0x1800B16EC
 * Callers:
 *     sub_1800B21C0 @ 0x1800B21C0 (sub_1800B21C0.c)
 * Callees:
...
_QWORD *__fastcall sub_1800B16EC(__int64 a1, _QWORD *a2)
{
  __int64 v3; // rbx
  __int128 v5; // [rsp+20h] [rbp-28h] BYREF

  v5 = 0LL;
  sub_1800B0F30((__int64)&v5);
  *(_OWORD *)a2 = 0LL;
