/*
 * XREFs of sub_18008866C @ 0x18008866C
 * Callers:
...
__int64 __fastcall sub_18008866C(__int64 a1, __int64 *a2)
{
  __int64 v4; // rcx
  __int64 v5; // rsi
  __int64 *v6; // rax
  ...
  {
    sub_18000FD48(v25);
    v16 = sub_18000FD48(v24);
    sub_180027FF4(v30, v16, 391, (__int64)v25, 0);
  ...
  *(_QWORD *)&v19 = *a2;
  *((_QWORD *)&v19 + 1) = v4;
  sub_1800876A0(a1, &v18, (__int64 *)&v19);
  v5 = v18;
  if ( !(_QWORD)v18 )
  {
    sub_18000FD48(v27);
    v17 = sub_18000FD48(v26);
    sub_180027FF4(v31, v17, 397, (__int64)v27, 0);
    throw (Spectre::Engine::EngineInvalidArgException *)v31;
  }
  v6 = sub_180087B70(v18, &v22);
  v8 = *a2;
  v9 = *v6;
  v10 = v23;
  if ( v23 )
  ...
  {
    sub_18000FD48(v29);
    v15 = sub_18000FD48(v28);
    sub_180027FF4(pExceptionObject, v15, 402, (__int64)v29, 0);
    throw (Spectre::Engine::EngineInvalidArgException *)pExceptionObject;
  }
  sub_18006187C(a1 + 16, v7);
  for ( i = (volatile signed __int32 *)(v5 + 76); _interlockedbittestandset(i, 0); i = (volatile signed __int32 *)(v5 + 76) )
    ;
  v20 = 0LL;
  sub_1800821F4(*a2, (__int64 *)&v20);
  result = v5 + 76;
  *(_DWORD *)(v5 + 76) = 0;
  if ( *((_QWORD *)&v18 + 1) )
  {
