        ...
        ID3D11DeviceContext **a10)
{
  ...
  if ( dword_18021886C > *(_DWORD *)(*((_QWORD *)NtCurrentTeb()->ThreadLocalStoragePointer + (unsigned int)TlsIndex)
                                   + 44LL) )
  {
    Init_thread_header(&dword_18021886C);
    if ( dword_18021886C == -1 )
    {
      byte_180218868 = 1;
      Init_thread_footer(&dword_18021886C);
    }
    goto LABEL_4;
  }
  while ( 1 )
