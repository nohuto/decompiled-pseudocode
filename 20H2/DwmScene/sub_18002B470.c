/*
 * XREFs of sub_18002B470 @ 0x18002B470
 * Callers:
 *     <none>
 * Callees:
...
int __fastcall sub_18002B470(__int64 a1, __int64 a2, __int64 a3, __int64 a4, int a5)
{
  int v6; // edx
  int v7; // r8d
  int v8; // r9d
  ...
  *(_OWORD *)v25 = 0LL;
  ...
  if ( *(float *)&v17 != (*(float (__fastcall **)(__int64))(*(_QWORD *)a1 + 120LL))(a1) )
  {
    ...
    sub_1801163DC(&unk_180208040, 3LL, "  non-uniform scale factors: x=%.0f%% y=%.0f%%", (float)(v19 * 100.0), v18);
  }
  v24 = 0LL;
  ...
  if ( LOBYTE(v25[1]) )
  {
    ...
    if ( result )
    {
      ...
      JUMPOUT(0x18002B77DLL);
    }
  }
  if ( BYTE8(v26) )
    return sub_180061A34(v26);
  return result;
}
