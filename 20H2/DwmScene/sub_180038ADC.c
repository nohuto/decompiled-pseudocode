/*
 * XREFs of sub_180038ADC @ 0x180038ADC
 * Callers:
...
_QWORD *__fastcall sub_180038ADC(__int64 *a1, _QWORD *a2)
{
  ...
  if ( v5 )
    goto LABEL_23;
  v6 = _std_type_info_hash(&qword_18020FC20);
  v7 = (__int64 *)*a1;
  v8 = *(__int64 **)(*a1 + 8);
  if ( *((_BYTE *)v8 + 25) )
    goto LABEL_9;
