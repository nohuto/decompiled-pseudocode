...
_QWORD *__fastcall sub_18006DDDC(_QWORD *a1, _QWORD *a2, __int64 *a3, int *a4, __int64 *a5)
{
  __int64 **v9; // rdi
  __int64 *v11; // r9
  int v12; // r13d
  ...
  if ( *((_DWORD *)a3 + 8) > *a4 )
  {
    ...
    {
      if ( *(_BYTE *)(v19[0][2] + 25) )
        sub_1800320A4(a1, a2, 0, v19[0], (int)a4, a5);
      else
        sub_1800320A4(a1, a2, 1, a3, (int)a4, a5);
      return a2;
    }
  ...
  {
LABEL_31:
    *a2 = *(_QWORD *)sub_18006F18C((_DWORD)a1, (unsigned int)&v20, 0, (_DWORD)a4, (__int64)a5);
    return a2;
  }
  if ( v15 )
