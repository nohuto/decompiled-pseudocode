/*
 * XREFs of sub_180022474 @ 0x180022474
 * Callers:
 *     sub_180026900 @ 0x180026900 (sub_180026900.c)
 * Callees:
...
_QWORD *__fastcall sub_180022474(__int64 a1, _QWORD *a2)
{
  __int64 v3; // rbx
  __int128 v5; // [rsp+20h] [rbp-28h] BYREF

  v5 = 0LL;
  sub_180020ED8((__int64)&v5);
  *(_OWORD *)a2 = 0LL;
