/*
 * XREFs of sub_1801150B0 @ 0x1801150B0
 * Callers:
 *     <none>
 * Callees:
...
ULONG __fastcall sub_1801150B0(__int64 a1, void *a2, __int64 a3, __int64 a4, void *a5, void *a6, int a7)
{
  ULONG result; // eax
  ...
  if ( (unsigned int)dword_18020DB58 > 5 )
  {
    ...
    return sub_180002C58(
             ...
             (unsigned __int8 *)dword_1801E841A,
             0LL,
             0LL,
             &v13,
             (__int64)&v12,
