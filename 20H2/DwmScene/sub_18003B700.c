/*
 * XREFs of sub_18003B700 @ 0x18003B700
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall sub_18003B700(__int64 a1, _QWORD *a2, int *a3, int *a4)
{
  int v5; // edi
  int v6; // esi
  _QWORD *v7; // rax
  ...
  *a2 = 0LL;
  ...
  v5 = *a4;
  v6 = *a3;
  v7 = (_QWORD *)sub_180062688(*(_QWORD *)(a1 + 8), v20);
  v8 = std::string::append(v7, &dword_18013D8E8, 7uLL);
  v19 = 0uLL;
  v18 = *(_OWORD *)v8;
  v19 = *((_OWORD *)v8 + 1);
  v8[2] = 0LL;
