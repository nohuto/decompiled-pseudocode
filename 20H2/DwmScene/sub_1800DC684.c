/*
 * XREFs of sub_1800DC684 @ 0x1800DC684
 * Callers:
...
unsigned __int64 __fastcall sub_1800DC684(_QWORD *a1, __int64 a2)
{
  __int64 v2; // r12
  __int64 v4; // rbx
  __int64 v5; // rax
  ...
  try
  {
    ...
    else
    {
      ...
      while ( v2 != v17 )
      {
        sub_180105588(v13, v2);
        v13 += 128LL;
        v20 = v13;
        v2 += 128LL;
      }
    }
    sub_1800DD0C0(a1, v11, v25 + 1, v9, v19, v20, v21);
    result = v26 + *a1;
  }
  catch ( ... )
  {
    sub_1800DD178(a1, v22, v27);
    sub_1800DD2B8(a1, v23, v9);
    throw;
  }
  return result;
}
