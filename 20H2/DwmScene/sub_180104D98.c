/*
 * XREFs of sub_180104D98 @ 0x180104D98
 * Callers:
...
_QWORD *__fastcall sub_180104D98(_QWORD *a1, _QWORD *a2)
{
  __int64 v3; // rcx
  __int64 v4; // rax
  ...
  *(_QWORD *)&v8 = *a2;
  *((_QWORD *)&v8 + 1) = v3;
  sub_1800A72EC((__int64)a1, (__int64)&v8);
  *a1 = &Spectre::Engine::ImageProcessingCamera::`vftable';
  v4 = sub_18006985C((__int64)v13);
  v9 = 0LL;
  v9 = *(_OWORD *)v4;
  *(_QWORD *)v4 = 0LL;
  *(_QWORD *)(v4 + 8) = 0LL;
  sub_1800A7CD4(a1, 0LL, 0LL, &v9, 0LL);
  v5 = v14;
  if ( v14 )
  {
  ...
  LOBYTE(Src[0]) = 0;
  sub_18000FB34(Src, 0x15uLL, 0LL, "ImageProcessingCamera");
  sub_180012E34(a1 + 3, Src);
