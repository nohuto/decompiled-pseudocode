/*
 * XREFs of sub_1800F03B0 @ 0x1800F03B0
 * Callers:
...
__int64 __fastcall sub_1800F03B0(__int64 a1, unsigned __int16 a2, __int64 *a3)
{
  _DWORD *v6; // rax
  __int64 result; // rax
  ...
  if ( !sub_1800ED414(*(_QWORD *)(a1 + 16), a2) )
  {
    ...
    v14 = sub_1800A06CC(v13, v23, a2);
    v15 = sub_180043BDC((__int64)v24, (__int64)"Property does not exist: ", (__int64)v14);
    v16 = sub_18000FD48(v18);
    sub_180027FF4(v25, v16, 457, v15, 0);
  ...
  {
    sub_18000FD48(v20);
    v17 = sub_18000FD48(v19);
    sub_180027FF4(v26, v17, 461, (__int64)v20, 0);
    throw (Spectre::Engine::EngineInvalidArgException *)v26;
  }
  if ( v6[12] == 2 )
  {
    sub_18000FD48(v22);
    v11 = sub_18000FD48(v21);
    sub_180027FF4(pExceptionObject, v11, 466, (__int64)v22, 0);
    throw (Spectre::Engine::EngineInvalidArgException *)pExceptionObject;
  }
  result = (__int64)std::shared_ptr<__ExceptionPtr>::operator=(
                      (_QWORD *)(*(_QWORD *)(a1 + 56) + 8 * (5LL * (unsigned int)v6[10] + 2)),
                      a3);
