/*
 * XREFs of sub_1800C2944 @ 0x1800C2944
 * Callers:
 ...
 *     sub_1800F8590 @ 0x1800F8590 (sub_1800F8590.c)
 *     sub_1800F85AC @ 0x1800F85AC (sub_1800F85AC.c)
 *     __security_check_cookie @ 0x18011E6F0 (__security_check_cookie.c)
 *     _guard_dispatch_icall_nop @ 0x18011FBB0 (_guard_dispatch_icall_nop.c)
 */

// Hidden C++ exception states: #wind=2
__int64 __fastcall sub_1800C2944(__int64 a1, _QWORD *a2, char a3, char a4)
{
  __int64 result; // rax
  __int64 v9; // r10
  __int64 v10; // r9
  ...
  if ( *a2 )
  {
    ...
    v16 = sub_1800752B4(a1, *(_DWORD *)(v34 + 112));
    v32 = qword_18020DB98;
    v33 = dword_18020DBA0;
    v17 = 0.0;
    v28 = 0LL;
    result = (__int64)sub_1800BCF20(a1, &v28, (__int64 *)&v34);
    v18 = v28;
    if ( (_QWORD)v28 )
    {
      v27 = 0LL;
    ...
    if ( a3 )
    {
      v23 = (*(float (__fastcall **)(__int64, void *))(*(_QWORD *)v16 + 88LL))(v16, &unk_18020AF10);
      v29[0] = 0;
      *(float *)&v29[1] = v23 * v17;
      v29[2] = 0;
      result = sub_1800F8590(*a2, v29);
    }
    if ( a4 )
    {
      v24 = *a2;
      (*(void (__fastcall **)(__int64, void *))(*(_QWORD *)v16 + 88LL))(v16, &unk_18020AD10);
      result = sub_1800F85AC(v24);
    }
    if ( *((_QWORD *)&v34 + 1) )
    {
