/*
 * XREFs of sub_18002FB34 @ 0x18002FB34
 * Callers:
...
__int64 **__fastcall sub_18002FB34(__int64 a1, __int64 **a2, __int64 a3, __int16 a4, int a5)
{
  unsigned int v9; // eax
  int v10; // eax
  int v11; // eax
  ...
  if ( (a4 & 1) != 0 )
  {
    ...
    v18 = sub_180062688(a1, v23);
    if ( *(_QWORD *)(v18 + 24) >= 0x10uLL )
      v18 = *(_QWORD *)v18;
    sub_180010454(v26, (const char *)v18);
    if ( v24 >= 0x10 )
    {
      v19 = v23[0];
      if ( v24 + 1 >= 0x1000 )
