/*
 * XREFs of _Microsoft::WRL::Details::MakeAndInitialize_AudioStateMonitorManager_AudioStateMonitorManager_CWindowsPolicyManager___&_CProcess____::_1_::dtor$1 @ 0x18003BFD6
 * Callers:
 *     <none>
 * Callees:
...
void __fastcall Microsoft::WRL::Details::MakeAndInitialize_AudioStateMonitorManager_AudioStateMonitorManager_CWindowsPolicyManager_____CProcess____::_1_::dtor_1(
        ...
        __int64 a2)
{
  CProcess::SetCellularHostProcess(*(CProcess **)(a2 + 88));
}
