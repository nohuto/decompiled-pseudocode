/*
 * XREFs of ?ResetReusedSessionGroupingParams@CProcess@@UEAAXXZ @ 0x1800173F0
 * Callers:
 *     ?SetApplicationHandlesGroupingParams@CProcess@@UEAAXXZ @ 0x1800197F0 (-SetApplicationHandlesGroupingParams@CProcess@@UEAAXXZ.c)
 * Callees:
