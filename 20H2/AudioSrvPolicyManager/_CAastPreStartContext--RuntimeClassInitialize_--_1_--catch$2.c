/*
 * XREFs of _CAastPreStartContext::RuntimeClassInitialize_::_1_::catch$2 @ 0x18003C4A9
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall CAastPreStartContext::RuntimeClassInitialize_::_1_::catch_2(
        __int64 a1,
        __int64 a2,
        __int64 a3,
        const char *a4)
