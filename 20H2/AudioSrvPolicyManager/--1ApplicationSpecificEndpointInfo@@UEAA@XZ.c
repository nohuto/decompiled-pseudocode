/*
 * XREFs of ??1ApplicationSpecificEndpointInfo@@UEAA@XZ @ 0x180019ECC
 * Callers:
 *     ??_GApplicationSpecificEndpointInfo@@UEAAPEAXI@Z @ 0x180019E90 (--_GApplicationSpecificEndpointInfo@@UEAAPEAXI@Z.c)
 * Callees:
