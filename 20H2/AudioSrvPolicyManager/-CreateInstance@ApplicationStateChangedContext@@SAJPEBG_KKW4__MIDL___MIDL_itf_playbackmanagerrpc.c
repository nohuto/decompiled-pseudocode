/*
 * XREFs of ?CreateInstance@ApplicationStateChangedContext@@SAJPEBG_KKW4__MIDL___MIDL_itf_playbackmanagerrpc_0000_0000_0002@@PEAPEAU1@@Z @ 0x18002D00C
 * Callers:
        ...
        _QWORD *a5)
{
  ...
  if ( v14 < 0 )
  {
    ...
    {
      WPP_SF_d(*((_QWORD *)WPP_GLOBAL_Control + 2), 0x24u, &WPP_c6f978e82fd73817a9c6bd1960ca45a6_Traceguids, v14);
    }
    AudPolicyLogError("ApplicationStateChangedContext::CreateInstance", 1028, v14);
  }
