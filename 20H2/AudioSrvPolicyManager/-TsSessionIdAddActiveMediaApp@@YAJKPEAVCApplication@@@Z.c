/*
 * XREFs of ?TsSessionIdAddActiveMediaApp@@YAJKPEAVCApplication@@@Z @ 0x180028F50
 * Callers:
...
__int64 __fastcall TsSessionIdAddActiveMediaApp(DWORD a1, struct CApplication *a2)
{
  ...
  __int64 *v10; // rax
  __int64 **v11; // rcx
  struct CApplication *v13; // [rsp+58h] [rbp+10h] BYREF
  struct TSSession *v14; // [rsp+60h] [rbp+18h] BYREF
