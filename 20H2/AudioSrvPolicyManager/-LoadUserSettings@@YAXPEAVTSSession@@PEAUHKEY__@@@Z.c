/*
 * XREFs of ?LoadUserSettings@@YAXPEAVTSSession@@PEAUHKEY__@@@Z @ 0x180026D08
 * Callers:
...
void __fastcall LoadUserSettings(struct TSSession *a1, HKEY a2)
{
  ...
  if ( *v4 > 4u )
  {
    ...
    v11 = 4;
    p_pvData = &pvData;
    tlgWriteTransfer_EventWriteTransfer((__int64)v4, (unsigned __int8 *)dword_1800466E3, 0LL, 0LL, 3u, &v9);
  }
  v6 = 1;
  pcbData = 4;
  *((_DWORD *)a1 + 80) = 1;
