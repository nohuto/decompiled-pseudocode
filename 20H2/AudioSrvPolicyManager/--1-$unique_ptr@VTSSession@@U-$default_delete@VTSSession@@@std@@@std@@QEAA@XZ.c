/*
 * XREFs of ??1?$unique_ptr@VTSSession@@U?$default_delete@VTSSession@@@std@@@std@@QEAA@XZ @ 0x18002B0D4
 * Callers:
 *     _TSSession::Create_::_1_::dtor$1 @ 0x18003C4EB (_TSSession--Create_--_1_--dtor$1.c)
 * Callees:
