/*
 * XREFs of ?Clear@CSecurityDesc@ATL@@MEAAXXZ @ 0x180035110
 * Callers:
 *     ??_GCSecurityDesc@ATL@@UEAAPEAXI@Z @ 0x180034910 (--_GCSecurityDesc@ATL@@UEAAPEAXI@Z.c)
 *     ??1CSecurityDesc@ATL@@UEAA@XZ @ 0x180034958 (--1CSecurityDesc@ATL@@UEAA@XZ.c)
