/*
 * XREFs of UsbhHubSyncSuspendPortEvent @ 0x1C0033A0C
 * Callers:
 ...
 *     Usbh_PcLogEntry @ 0x1C0035FC4 (Usbh_PcLogEntry.c)
 *     UsbhGetPortStatusBits @ 0x1C0038130 (UsbhGetPortStatusBits.c)
 */
