...
LABEL_65:
  ...
  if ( *(_DWORD *)v17 != 541218120 )
    UsbhTrapFatal_Dbg(DeviceObject, DeviceObject->DeviceExtension);
  PoolWithTag = (char *)ExAllocatePoolWithTag(ExDefaultNonPagedPoolType, 0x90uLL, 0x42554855u);
  v19 = PoolWithTag;
  if ( PoolWithTag )
  {
    ...
    *((_QWORD *)v19 + 10) = KeGetCurrentThread();
    v12[132] = KeAcquireSpinLockRaiseToDpc((PKSPIN_LOCK)&WPP_MAIN_CB.Queue.Wcb.NumberOfChannels);
    *((_DWORD *)v12 + 34) = 1;
    ...
    *((_DWORD *)v12 + 34) = 0;
    ...
    KeReleaseSpinLock((PKSPIN_LOCK)&WPP_MAIN_CB.Queue.Wcb.NumberOfChannels, v12[132]);
    if ( LowPart == 1 )
    {
