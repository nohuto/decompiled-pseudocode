/*
 * XREFs of ReadUSBFnFeaturesFromCurrentConfiguration @ 0x1C005D550
 * Callers:
 ...
 *     MyRegOpenKeyForRead @ 0x1C005DB5C (MyRegOpenKeyForRead.c)
 *     MyRegQueryString @ 0x1C005DBD8 (MyRegQueryString.c)
 */
