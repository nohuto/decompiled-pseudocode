/*
 * XREFs of RtlStringCchPrintfExW @ 0x1C004B580
 * Callers:
 *     UsbhBusIfLocationGetLocationStrings @ 0x1C004BC60 (UsbhBusIfLocationGetLocationStrings.c)
 * Callees:
 *     memset @ 0x1C001D340 (memset.c)
 *     RtlStringExHandleOtherFlagsW @ 0x1C004B750 (RtlStringExHandleOtherFlagsW.c)
 *     RtlStringVPrintfWorkerW @ 0x1C004B810 (RtlStringVPrintfWorkerW.c)
 */
        ...
        ...)
{
  ...
  else
  {
    ...
    if ( (dwFlags & 0x100) != 0 )
    {
      v12 = (const wchar_t *)&unk_1C00649A8;
      if ( pszFormat )
        v12 = pszFormat;
    }
    else
