/*
 * XREFs of UsbhGetDeviceInformation @ 0x1C0037D08
 * Callers:
 ...
 *     UsbhParseConfigurationDescriptorEx @ 0x1C00319B4 (UsbhParseConfigurationDescriptorEx.c)
...
__int64 __fastcall UsbhGetDeviceInformation(__int64 a1, __int64 a2)
{
  ...
  if ( (unsigned __int8)UsbhValidateConfigurationDescriptor(v8, (unsigned int)Size, &v25, dword_1C006B630 != 0) )
  {
