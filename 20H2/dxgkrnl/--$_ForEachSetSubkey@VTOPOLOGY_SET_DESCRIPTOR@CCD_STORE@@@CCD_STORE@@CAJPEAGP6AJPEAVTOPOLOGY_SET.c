/*
 * XREFs of ??$_ForEachSetSubkey@VTOPOLOGY_SET_DESCRIPTOR@CCD_STORE@@@CCD_STORE@@CAJPEAGP6AJPEAVTOPOLOGY_SET_DESCRIPTOR@0@PEAX@Z2@Z @ 0x1C0131A28
 * Callers:
 *     ?_ProcessConnectedSetDescriptorCallback@CCD_RECENT_TOPOLOGY_RETRIEVER@@CAJPEAVCONNECTED_SET_DESCRIPTOR@CCD_STORE@@PEAX@Z @ 0x1C0166E80 (-_ProcessConnectedSetDescriptorCallback@CCD_RECENT_TOPOLOGY_RETRIEVER@@CAJPEAVCONNECTED_SET_DESC.c)
 * Callees:
        ...
        CCD_RECENT_TOPOLOGY_RETRIEVER *a3)
{
  ...
  int v30; // [rsp+3Ch] [rbp-25h]
  char *v31; // [rsp+40h] [rbp-21h]
  _BYTE v32[112]; // [rsp+48h] [rbp-19h] BYREF
  HANDLE KeyHandle; // [rsp+C8h] [rbp+67h] BYREF
  HANDLE Handle; // [rsp+D0h] [rbp+6Fh] BYREF
  void *v35; // [rsp+E0h] [rbp+7Fh]
  ...
  else
  {
    for ( i = 0; ; ++i )
    {
      ...
      if ( SubkeyInfoFromRegistry < 0 )
        break;
      v14 = v35;
      LOWORD(v29) = *((_WORD *)v35 + 6);
      HIWORD(v29) = *((_WORD *)v35 + 6);
      v30 = 0;
      v31 = (char *)v35 + 16;
      if ( (unsigned __int16)v29 != *((_DWORD *)v35 + 3) )
      {
        v25 = WdLogNewEntry5_WdAssertion((unsigned __int16)v29, v10);
      ...
      TopologySetIdDescriptorCallback = (int)CCD_RECENT_TOPOLOGY_RETRIEVER::_FindTopologySetIdDescriptorCallback(
                                               (struct CCD_STORE::TOPOLOGY_SET_DESCRIPTOR *)v32,
                                               a3);
      ZwClose(Handle);
      if ( (int)TopologySetIdDescriptorCallback < 0 )
      {
