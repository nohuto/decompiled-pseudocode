/*
 * XREFs of ?_AugmentVidPnTopology@BTL_CDS_JOURNAL_TOPOLOGY_CONSTRUCTOR@@SAJPEAVDMMVIDPNTOPOLOGY@@PEAUD3DKMT_AUGMENT_CDSJ@@@Z @ 0x1C02EFA74
 * Callers:
...
LABEL_24:
    ...
    else
    {
      ...
      v16 = (_QWORD *)WdLogNewEntry5_WdDmmEvent(v13, v12);
      v17 = *((_QWORD *)v6 + 1);
      if ( !v17 )
      {
  ...
  v41 = (_QWORD *)WdLogNewEntry5_WdDmmEvent(v9, v8);
  v42 = *((_QWORD *)v6 + 1);
  if ( !v42 )
  {
