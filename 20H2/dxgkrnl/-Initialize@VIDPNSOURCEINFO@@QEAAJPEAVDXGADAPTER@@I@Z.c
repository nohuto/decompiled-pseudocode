/*
 * XREFs of ?Initialize@VIDPNSOURCEINFO@@QEAAJPEAVDXGADAPTER@@I@Z @ 0x1C02BA058
 * Callers:
 ...
 *     ?IsPointerVisible@ADAPTER_DISPLAY@@QEBAEI@Z @ 0x1C001A854 (-IsPointerVisible@ADAPTER_DISPLAY@@QEBAEI@Z.c)
 ...
 *     ?RtlStringCchCopyA@@YAJPEAD_KPEBD@Z @ 0x1C004D0F0 (-RtlStringCchCopyA@@YAJPEAD_KPEBD@Z.c)
