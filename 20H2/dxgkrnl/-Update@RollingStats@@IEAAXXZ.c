/*
 * XREFs of ?Update@RollingStats@@IEAAXXZ @ 0x1C006E470
 * Callers:
 ...
 *     ?GetSafeStdDev@TrackedWorkloadMonitor@@AEAANPEAVRollingStats@@@Z @ 0x1C006DFD8 (-GetSafeStdDev@TrackedWorkloadMonitor@@AEAANPEAVRollingStats@@@Z.c)
