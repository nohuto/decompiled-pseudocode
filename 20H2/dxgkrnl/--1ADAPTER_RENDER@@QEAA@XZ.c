/*
 * XREFs of ??1ADAPTER_RENDER@@QEAA@XZ @ 0x1C02143A0
 * Callers:
 ...
 *     ??1?$DXGNODELIST@VADAPTER_RENDER@@VDXGDEVICE@@@@AEAA@XZ @ 0x1C003AC34 (--1-$DXGNODELIST@VADAPTER_RENDER@@VDXGDEVICE@@@@AEAA@XZ.c)
