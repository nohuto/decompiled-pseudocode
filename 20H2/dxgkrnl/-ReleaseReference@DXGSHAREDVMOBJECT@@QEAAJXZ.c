/*
 * XREFs of ?ReleaseReference@DXGSHAREDVMOBJECT@@QEAAJXZ @ 0x1C0239AFC
 * Callers:
 ...
 *     ??1DXGSHAREDVMOBJECT@@AEAA@XZ @ 0x1C003FBC0 (--1DXGSHAREDVMOBJECT@@AEAA@XZ.c)
