/*
 * XREFs of DpiPdoSetMonitorDriverInterfaceStateWorker @ 0x1C02D8850
 * Callers:
 *     <none>
 * Callees:
 *     <none>
...
void __fastcall DpiPdoSetMonitorDriverInterfaceStateWorker(PVOID IoObject, PVOID Context, PIO_WORKITEM IoWorkItem)
{
  ...
  while ( 1 )
  {
    ...
    v4 = (PDEVICE_OBJECT *)qword_1C00B0EF8;
    if ( (__int64 *)qword_1C00B0EF8 == &qword_1C00B0EF8 )
    {
      v4 = 0LL;
      byte_1C00B0EB8 = 0;
    }
    ...
    {
      if ( *(__int64 **)(qword_1C00B0EF8 + 8) != &qword_1C00B0EF8
        || (v5 = *(_QWORD *)qword_1C00B0EF8, *(_QWORD *)(*(_QWORD *)qword_1C00B0EF8 + 8LL) != qword_1C00B0EF8) )
      {
        __fastfail(3u);
      }
      qword_1C00B0EF8 = *(_QWORD *)qword_1C00B0EF8;
      *(_QWORD *)(v5 + 8) = &qword_1C00B0EF8;
    }
