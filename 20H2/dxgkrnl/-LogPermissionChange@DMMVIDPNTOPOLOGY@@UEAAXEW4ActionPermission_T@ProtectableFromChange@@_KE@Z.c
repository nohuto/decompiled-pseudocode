/*
 * XREFs of ?LogPermissionChange@DMMVIDPNTOPOLOGY@@UEAAXEW4ActionPermission_T@ProtectableFromChange@@_KE@Z @ 0x1C01563C0
 * Callers:
 *     <none>
 * Callees:
 *     <none>
...
LABEL_14:
  ...
  v14 = WdLogNewEntry5_WdTrace(v9, a2, a3, a4);
  *(_QWORD *)(v14 + 24) = a1 - 56;
  if ( v12 >= *(_QWORD *)(a1 + 80) )
  {
