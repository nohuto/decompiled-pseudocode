/*
 * XREFs of ?AugmentTopology@BTL_CDS_JOURNAL_TOPOLOGY_CONSTRUCTOR@@SAJPEAVCCD_TOPOLOGY@@PEAUD3DKMT_AUGMENT_CDSJ@@_N@Z @ 0x1C0145460
 * Callers:
...
LABEL_68:
        if ( v27 >= 0 )
        {
          ...
          if ( v27 >= 0 )
          {
            ...
            LOBYTE(v65) = IsPrimaryClonePathByModality;
            CDS_JOURNAL::FillPathDescriptor(v71, a2, v65);
          }
          goto LABEL_73;
        }
LABEL_47:
...
LABEL_66:
      ...
      {
        v59 = WdLogNewEntry5_WdDmmEvent(v51, v48);
...
LABEL_63:
  ...
  *((_DWORD *)a2 + 6) = v15;
  ...
  {
    LOBYTE(v17) = 1;
    CDS_JOURNAL::FillPathDescriptor(v18, a2, v17);
    return v4;
  }
  return 3223192371LL;
}
