/*
 * XREFs of ?DestroyDeferredAllocations@DXGDEVICE@@QEAAXPEAVDXGTERMINATIONTRACKER@@@Z @ 0x1C0102150
 * Callers:
...
void __fastcall DXGDEVICE::DestroyDeferredAllocations(DXGDEVICE *this, struct DXGTERMINATIONTRACKER *a2)
{
  ...
  *(_OWORD *)v87 = 0LL;
  ...
  if ( LODWORD(v87[0]) )
  {
    ...
    _InterlockedIncrement((volatile signed __int32 *)(*(_QWORD *)(v13 + 16) + 4364LL));
...
LABEL_33:
          ...
          _InterlockedDecrement((volatile signed __int32 *)(*(_QWORD *)(v13 + 16) + 4364LL));
