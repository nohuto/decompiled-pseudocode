/*
 * XREFs of ?ReleaseTargetModeSet@DXGK_VIDPN_INTERFACE_V1_IMPL@@YAJQEAUD3DKMDT_HVIDPN__@@QEAUD3DKMDT_HVIDPNTARGETMODESET__@@@Z @ 0x1C0154450
 * Callers:
 *     <none>
 * Callees:
 ...
 *     ?ContainsByReference@?$DoublyLinkedList@VDMMVIDPNTARGETMODESET@@U?$DoubleLinkedListElementDeleter@VDMMVIDPNTARGETMODESET@@@@@@QEAAEQEBVDMMVIDPNTARGETMODESET@@@Z @ 0x1C004C700 (-ContainsByReference@-$DoublyLinkedList@VDMMVIDPNTARGETMODESET@@U-$DoubleLinkedListElementDelete.c)
 */
        ...
        struct D3DKMDT_HVIDPNTARGETMODESET__ *const a3)
{
  ...
  if ( (qword_1C00AF9B0 & 2) != 0 )
  {
    ...
    if ( (Microsoft_Windows_DxgKrnlEnableBits & 0x2000) != 0 )
      McTemplateK0q_EtwWriteTransfer((__int64)this, &EventProfilerEnter, (__int64)a3, 7049);
  }
  else
  {
    v43 = 0;
  }
  DXGETWPROFILER_BASE::PushProfilerEntry((__int64)&v41, 7049LL);
  ...
  *(_QWORD *)(v9 + 32) = this;
  ...
  if ( v16 == v12 )
  {
    ...
    {
      if ( v13 == *(struct D3DKMDT_HVIDPN__ **)(v14 + 112) )
      {
        v35 = WdLogNewEntry5_WdDmmEvent(v11, v10);
        *(_QWORD *)(v35 + 24) = v13;
        *(_QWORD *)(v35 + 32) = *(unsigned int *)(v14 + 24);
        WdLogEvent5_WdDmmEvent(v35);
        auto_rc<DMMVIDPNTARGETMODESET>::reset((__int64 *)(v14 + 112), 0LL);
        if ( *((_DWORD *)v13 + 24) != 1 )
        {
