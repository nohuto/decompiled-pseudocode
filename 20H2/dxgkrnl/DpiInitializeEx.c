/*
 * XREFs of DpiInitializeEx @ 0x1C0191F9C
 * Callers:
 *     DpiKmdDodInitialize @ 0x1C0023630 (DpiKmdDodInitialize.c)
 ...
 *     DpiGetDriverDataSizeFromVersion @ 0x1C01927B0 (DpiGetDriverDataSizeFromVersion.c)
...
LABEL_8:
  ...
  *v21 = v21;
  ...
  v22 = (_QWORD *)qword_1C00B0B48;
  v23 = DriverObjectExtension;
  if ( *(__int64 **)qword_1C00B0B48 != &qword_1C00B0B40 )
    goto LABEL_39;
  *(_QWORD *)DriverObjectExtension = &qword_1C00B0B40;
  v23[1] = v22;
  *v22 = v23;
  qword_1C00B0B48 = (__int64)v23;
  ...
  *(_QWORD *)(v26 + 24) = DriverObjectExtension;
  ...
  v40 = 0LL;
  if ( (int)KsrGetFirmwareInformation(&v40) >= 0 && !qword_1C00B1008 )
  {
    ...
    *(_OWORD *)&ObjectAttributes.SecurityDescriptor = 0LL;
    ...
    {
      qword_1C00B1008 = (__int64)ExRegisterCallback(CallbackObject, DpiKsrCallback, &DpGlobals);
