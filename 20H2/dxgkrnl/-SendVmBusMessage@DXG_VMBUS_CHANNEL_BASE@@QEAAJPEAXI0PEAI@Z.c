/*
 * XREFs of ?SendVmBusMessage@DXG_VMBUS_CHANNEL_BASE@@QEAAJPEAXI0PEAI@Z @ 0x1C0239BD8
 * Callers:
        ...
        unsigned int *a5)
{
  ...
  if ( a3 > 0x20000 || (v9 = a5, *a5 > 0x20000) )
  {
    ...
    *(_QWORD *)(v16 + 24) = 13455LL;
    WdLogEvent5_WdWarning(v16);
LABEL_6:
    v12 = -1073741811;
    goto LABEL_7;
  }
  v12 = ((__int64 (__fastcall *)(struct _KTHREAD *, void *, _QWORD, _QWORD, int, void *, unsigned int *, _QWORD))qword_1C00B2100)(
          *this,
          a2,
          a3,
          0LL,
