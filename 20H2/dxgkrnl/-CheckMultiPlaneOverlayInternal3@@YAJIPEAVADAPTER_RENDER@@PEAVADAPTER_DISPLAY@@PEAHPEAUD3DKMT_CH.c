/*
 * XREFs of ?CheckMultiPlaneOverlayInternal3@@YAJIPEAVADAPTER_RENDER@@PEAVADAPTER_DISPLAY@@PEAHPEAUD3DKMT_CHECK_MULTIPLANE_OVERLAY_SUPPORT_RETURN_INFO@@@Z @ 0x1C0251734
 * Callers:
 ...
 *     ?LogCheckMutiplaneOverlaySupport@@YAXJHIPEAPEAU_D3DKMT_CHECK_MULTIPLANE_OVERLAY_PLANE3@@PEAPEAXIPEAPEAU_D3DKMT_MULTIPLANE_OVERLAY_POST_COMPOSITION_WITH_SOURCE@@PEAVADAPTER_RENDER@@@Z @ 0x1C0254670 (-LogCheckMutiplaneOverlaySupport@@YAXJHIPEAPEAU_D3DKMT_CHECK_MULTIPLANE_OVERLAY_PLANE3@@PEAPEAXI.c)
 */
      ...
      if ( v28 )
      {
        ...
        if ( v36 )
        {
          ...
          if ( v70 )
          {
            ...
            LODWORD(v71) = 0;
            v56 = *((_QWORD *)v74 + 2);
            if ( *(_QWORD *)(v56 + 928) && *(_BYTE *)(v56 + 2642) )
              v57 = -1;
            else
              v57 = v75;
            ...
            else
            {
              v67 = (struct _KTHREAD **)v72;
              v68 = v73;
              if ( (unsigned int)v60 <= *(_DWORD *)(v66 + 2536) )
              {
                if ( *(_QWORD *)(v66 + 896) )
                  CallCheckMultiPlaneOverlaySupport2DDI((unsigned int)v60, (unsigned __int64)v73, v28, v72, a4, a5);
                else
                  CallCheckMultiPlaneOverlaySupport1DDI((unsigned int)v60, (unsigned __int64)v73, v28, v72, a4, a5);
              }
            }
            if ( *a4 == 1
              && ADAPTER_DISPLAY::ConfigChangesOnMultipleOutputs(v67, (__int64)v58)
              && !*(_BYTE *)(*((_QWORD *)v74 + 2) + 2644LL) )
            {
              *a4 = 0;
