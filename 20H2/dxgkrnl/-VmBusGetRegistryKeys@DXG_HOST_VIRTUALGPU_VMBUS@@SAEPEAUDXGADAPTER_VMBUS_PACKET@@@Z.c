/*
 * XREFs of ?VmBusGetRegistryKeys@DXG_HOST_VIRTUALGPU_VMBUS@@SAEPEAUDXGADAPTER_VMBUS_PACKET@@@Z @ 0x1C0240F70
 * Callers:
 *     <none>
 * Callees:
 ...
 *     RtlUnicodeStringValidateDestWorker @ 0x1C000C60C (RtlUnicodeStringValidateDestWorker.c)
 *     __security_check_cookie @ 0x1C00243B0 (__security_check_cookie.c)
 *     memmove @ 0x1C0027140 (memmove.c)
 *     memset @ 0x1C0027400 (memset.c)
 *     ?RtlStringCbCopyUnicodeString@@YAJPEAG_KPEBU_UNICODE_STRING@@@Z @ 0x1C003E1EC (-RtlStringCbCopyUnicodeString@@YAJPEAG_KPEBU_UNICODE_STRING@@@Z.c)
    ...
    if ( (int)v15 >= 0 )
    {
      ...
      if ( v21 >= 0 )
      {
        ...
        if ( (int)v15 >= 0 )
        {
          ...
          {
            Values = (char *)ppszDest + 2 * pcchDestLength - (_QWORD)&unk_1C0083398;
            do
            {
              if ( !v26 )
                break;
