/*
 * XREFs of ?WriteDxgDiagnosticsEvent_QDC@@YAXPEAU_DXGK_DIAG_HEADER@@@Z @ 0x1C000AF28
 * Callers:
...
void __fastcall WriteDxgDiagnosticsEvent_QDC(struct _DXGK_DIAG_HEADER *a1, __int64 a2)
{
  __int64 v3; // rdx
  __int64 v4; // rdx
  int v5; // ecx
  ...
  if ( *((_BYTE *)DXGGLOBAL::GetGlobal((__int64)a1, a2) + 304320) )
  {
    if ( (unsigned int)dword_1C00AFA20 > 1
      && tlgKeywordOn((__int64)&dword_1C00AFA20, 0x200000000001LL)
      && tlgKeywordOn((__int64)&dword_1C00AFA20, v4) )
    {
      v8 = &unk_1C007E61B;
LABEL_11:
      v10 = *((_WORD *)a1 + 2);
  ...
  else if ( (unsigned int)dword_1C00AFA20 > 4
         && tlgKeywordOn((__int64)&dword_1C00AFA20, 0x200000000001LL)
         && tlgKeywordOn((__int64)&dword_1C00AFA20, v3) )
  {
    v8 = &unk_1C007E5F9;
    goto LABEL_11;
  }
