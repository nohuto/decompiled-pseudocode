/*
 * XREFs of ?Initialize@OUTPUTDUPL_CONTEXT@@QEAAJPEBU_D3DKMT_CREATE_OUTPUTDUPL@@@Z @ 0x1C029FC70
 * Callers:
 ...
 *     ?Initialize@DXGDXGIKEYEDMUTEX@@QEAAJPEAX@Z @ 0x1C02990B8 (-Initialize@DXGDXGIKEYEDMUTEX@@QEAAJPEAX@Z.c)
