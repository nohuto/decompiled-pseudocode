/*
 * XREFs of ?RebuildMonitorModeListCacheHelper@@YAJPEAVDXGADAPTER@@IPEAU_DXGK_DISPLAY_SCENARIO_CONTEXT@@@Z @ 0x1C02F06B4
 * Callers:
 *     MonitorRebuildMonitorModeListCache @ 0x1C02F2ECC (MonitorRebuildMonitorModeListCache.c)
 * Callees:
