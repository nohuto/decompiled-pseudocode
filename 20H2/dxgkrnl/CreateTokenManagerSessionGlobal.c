/*
 * XREFs of CreateTokenManagerSessionGlobal @ 0x1C001AE58
 * Callers:
 ...
 *     ?Initialize@CTokenManager@@AEAAJXZ @ 0x1C001AED8 (-Initialize@CTokenManager@@AEAAJXZ.c)
 *     ??0CTokenManager@@AEAA@XZ @ 0x1C001B034 (--0CTokenManager@@AEAA@XZ.c)
 */
