/*
 * XREFs of _pGetAdditionalTiming @ 0x1C0192EFC
 * Callers:
 *     ?_GetAdditionalTiming@DXGMONITOR@@QEAAJPEAIPEAPEAU_DXGK_TARGETMODE_DETAIL_TIMING@@@Z @ 0x1C0192E10 (-_GetAdditionalTiming@DXGMONITOR@@QEAAJPEAIPEAPEAU_DXGK_TARGETMODE_DETAIL_TIMING@@@Z.c)
 * Callees:
 *     _pGetAdditionalModeEntry @ 0x1C0193058 (_pGetAdditionalModeEntry.c)
...
__int64 __fastcall pGetAdditionalTiming(__int64 a1, __int64 a2, _DWORD *a3, _QWORD *a4)
{
  ...
  else
  {
    ...
    ExAcquirePushLockSharedEx(&qword_1C00B1E78, 0LL);
    LOBYTE(v9) = v8;
    AdditionalModeEntry = pGetAdditionalModeEntry((unsigned int)v4, v9);
    if ( !AdditionalModeEntry )
    {
      ExReleasePushLockEx(&qword_1C00B1E78, 0LL);
      ExAcquirePushLockExclusiveEx(&qword_1C00B1E78, 0LL);
      LOBYTE(v11) = v8;
