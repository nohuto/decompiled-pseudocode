/*
 * XREFs of ??1CFlipPresentUpdate@@UEAA@XZ @ 0x1C006DA5C
 * Callers:
 *     ??_GCFlipPresentUpdate@@UEAAPEAXI@Z @ 0x1C0069A90 (--_GCFlipPresentUpdate@@UEAAPEAXI@Z.c)
 * Callees:
 *     ?Release@CFlipPropertySetBase@@QEAAKXZ @ 0x1C0067B30 (-Release@CFlipPropertySetBase@@QEAAKXZ.c)
 *     ??1CFlipTokenOperation@@MEAA@XZ @ 0x1C006AF8C (--1CFlipTokenOperation@@MEAA@XZ.c)
 */
