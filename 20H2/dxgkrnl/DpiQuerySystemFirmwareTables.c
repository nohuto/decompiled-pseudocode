/*
 * XREFs of DpiQuerySystemFirmwareTables @ 0x1C0194EB8
 * Callers:
 *     DpiReadSystemFirmwareTable @ 0x1C0194E40 (DpiReadSystemFirmwareTable.c)
 *     DpiEnumSystemFirmwareTables @ 0x1C02C6D60 (DpiEnumSystemFirmwareTables.c)
 * Callees:
