/*
 * XREFs of _lambda_412e717f5b4824a72ec987e49bacdc3c_::operator() @ 0x1C00D4660
 * Callers:
...
char __fastcall lambda_412e717f5b4824a72ec987e49bacdc3c_::operator()(__int64 a1)
{
  ...
  if ( *v8 )
  {
    ...
    {
      LOBYTE(v8) = tlgKeywordOn((__int64)&dword_1C00AFA90, 0x800000000004LL);
      if ( (_BYTE)v8 )
      {
        v9 = *(__int64 **)(a1 + 16);
        v40 = 0;
        ...
        LOBYTE(v8) = tlgWriteTransfer_EtwWriteTransfer(
                       ...
                       (unsigned __int8 *)dword_1C007DEDA,
                       0LL,
                       0LL,
                       6u,
                       &v28);
