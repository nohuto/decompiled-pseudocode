/*
 * XREFs of McTemplateK0xqqqqqqqq_EtwWriteTransfer @ 0x1C0055DCC
 * Callers:
...
NTSTATUS McTemplateK0xqqqqqqqq_EtwWriteTransfer(__int64 a1, __int64 a2, __int64 a3, ...)
{
  ...
  v20 = 4LL;
  v22 = 4LL;
  return McGenEventWrite_EtwWriteTransfer((REGHANDLE *)&DxgkControlGuid_Context, &EventMiracastInterrupt, a3, 0xAu, &v4);
}
