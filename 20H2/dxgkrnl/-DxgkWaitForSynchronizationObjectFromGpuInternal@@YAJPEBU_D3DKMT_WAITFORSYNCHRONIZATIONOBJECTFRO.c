/*
 * XREFs of ?DxgkWaitForSynchronizationObjectFromGpuInternal@@YAJPEBU_D3DKMT_WAITFORSYNCHRONIZATIONOBJECTFROMGPU@@_N1PEB_K1@Z @ 0x1C00EA670
 * Callers:
 ...
 *     DxgkWaitForSynchronizationObjectFromGpu @ 0x1C00EA640 (DxgkWaitForSynchronizationObjectFromGpu.c)
