/*
 * XREFs of ?VmBusChannelProcessPacket@DXG_HOST_VIRTUALGPU_VMBUS@@SAXPEAUVMBCHANNEL__@@PEAUVMBPACKETCOMPLETION__@@PEAXII@Z @ 0x1C00406C0
 * Callers:
 *     <none>
 * Callees:
...
LABEL_8:
  ...
  if ( PoolWithTag )
  {
    ...
    v21 = ((__int64 (__fastcall *)(struct VMBCHANNEL__ *))qword_1C00B2098)(a1);
    v20[1].Parameter = 0LL;
