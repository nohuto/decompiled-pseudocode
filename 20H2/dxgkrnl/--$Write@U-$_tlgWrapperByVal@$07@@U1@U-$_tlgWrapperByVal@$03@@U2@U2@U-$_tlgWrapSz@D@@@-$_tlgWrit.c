/*
 * XREFs of ??$Write@U?$_tlgWrapperByVal@$07@@U1@U?$_tlgWrapperByVal@$03@@U2@U2@U?$_tlgWrapSz@D@@@?$_tlgWriteTemplate@$$A6AJPEBU_tlgProvider_t@@PEBX1IPEAU_EVENT_DATA_DESCRIPTOR@@@Z$1?_tlgWriteAgg@@YAJ011I2@ZPEBX@@SAJPEBU_tlgProvider_t@@PEBX1AEBU?$_tlgWrapperByVal@$07@@2AEBU?$_tlgWrapperByVal@$03@@33AEBU?$_tlgWrapSz@D@@@Z @ 0x1C0056F0C
 * Callers:
 *     ?DpiOpmLogSetLevel@@YAXJII@Z @ 0x1C00572B0 (-DpiOpmLogSetLevel@@YAXJII@Z.c)
 * Callees:
 *     __security_check_cookie @ 0x1C00243B0 (__security_check_cookie.c)
 *     ExtractAggregateFieldTypes @ 0x1C0061AA4 (ExtractAggregateFieldTypes.c)
 *     InsertEventEntryInLookUpTable @ 0x1C0061C58 (InsertEventEntryInLookUpTable.c)
 */
        ...
        const CHAR **a9)
{
  ...
  *(_DWORD *)&EventDescriptor.Level = *(unsigned __int16 *)(a2 + 1);
  ...
  UserData.Ptr = (ULONGLONG)off_1C00AF9F0;
  v25 = 8;
  v21 = a4;
  v22 = 8;
  UserData.Size = *(unsigned __int16 *)off_1C00AF9F0;
  ...
  result = -1073741811;
  if ( (void (__fastcall *)(const struct _GUID *, unsigned int, unsigned __int8, unsigned __int64, unsigned __int64, struct _EVENT_FILTER_DESCRIPTOR *, void *))qword_1C00AFA10 == TlgAggregateInternalRegisteredProviderEtwCallback )
  {
