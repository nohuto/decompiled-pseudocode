/*
 * XREFs of ?DpiPdoHandleOpmIoctlsInternal@@YAJPEAU_FDO_CONTEXT@@PEAU_PDO_CONTEXT@@KPEAXK2KPEA_K@Z @ 0x1C001C714
 * Callers:
 *     DpiPdoHandleOpmIoctls @ 0x1C016E098 (DpiPdoHandleOpmIoctls.c)
 * Callees:
 ...
 *     DpiPdoVerifyOpmParameters @ 0x1C016E258 (DpiPdoVerifyOpmParameters.c)
...
LABEL_159:
      ...
      else
      {
        ...
        if ( (int)v13 >= 0 )
        {
          ...
          if ( (unsigned int)dword_1C00AF9E8 > 5 && tlgKeywordOn((__int64)&dword_1C00AF9E8, 0x400000100000LL) )
          {
