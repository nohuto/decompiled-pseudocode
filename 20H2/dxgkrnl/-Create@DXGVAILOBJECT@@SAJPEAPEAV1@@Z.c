/*
 * XREFs of ?Create@DXGVAILOBJECT@@SAJPEAPEAV1@@Z @ 0x1C02B35F8
 * Callers:
 ...
 *     ?ResolveHandle@DXGVAILOBJECT@@SAJPEAXKDPEAPEAV1@@Z @ 0x1C02B472C (-ResolveHandle@DXGVAILOBJECT@@SAJPEAXKDPEAPEAV1@@Z.c)
 */
