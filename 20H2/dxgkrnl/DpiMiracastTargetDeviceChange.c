/*
 * XREFs of DpiMiracastTargetDeviceChange @ 0x1C0053960
 * Callers:
 *     <none>
 * Callees:
        ...
        if ( v16 )
        {
          ...
          *((_QWORD *)Context + 11) = KeGetCurrentThread();
          ...
          if ( *(char **)(*(_QWORD *)Context + 8LL) != Context
            ...
            || (*v26 = v25,
                v25[1] = v26,
                v27 = (char **)qword_1C00B0F30,
                *(__int64 **)qword_1C00B0F30 != &qword_1C00B0F28) )
          {
            __fastfail(3u);
          }
          *(_QWORD *)Context = &qword_1C00B0F28;
          *((_QWORD *)Context + 1) = v27;
          *v27 = Context;
          qword_1C00B0F30 = (__int64)Context;
