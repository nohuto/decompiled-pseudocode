/*
 * XREFs of ?_DsiTransmission@DXGMONITOR@@AEAAJKPEAXK0PEA_K@Z @ 0x1C02FA790
 * Callers:
 ...
 *     ?_ValidateMipiDsiPackets@DXGMONITOR@@AEAAJPEAU_DXGK_DSI_TRANSMISSION@@@Z @ 0x1C02FADA0 (-_ValidateMipiDsiPackets@DXGMONITOR@@AEAAJPEAU_DXGK_DSI_TRANSMISSION@@@Z.c)
 */
