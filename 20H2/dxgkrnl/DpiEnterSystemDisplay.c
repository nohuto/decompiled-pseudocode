/*
 * XREFs of DpiEnterSystemDisplay @ 0x1C001FDC0
 * Callers:
 *     <none>
 * Callees:
...
LABEL_61:
    ...
    {
      v18 = v24;
      if ( !v24 && qword_1C00B0DC0 && v5 == *(_QWORD *)(qword_1C00B0DC0 + 64) )
        *(_DWORD *)(a2 + 16) = 1;
      else
        *(_DWORD *)(a2 + 16) = 5;
LABEL_60:
