/*
 * XREFs of ?PostNewMessage@CDWMBackchannelManager@@UEAAXPEAVCFlipConsumerMessage@@@Z @ 0x1C006C8A0
 * Callers:
 *     <none>
 * Callees:
 *     ??$FindProperty@UPresentConfirmedStatistics@@@CFlipPropertySetBase@@QEAAXPEAPEAUPresentConfirmedStatistics@@@Z @ 0x1C006C67C (--$FindProperty@UPresentConfirmedStatistics@@@CFlipPropertySetBase@@QEAAXPEAPEAUPresentConfirmed.c)
 *     ?PostNewMessage@CBackchannelManager@@UEAAXPEAVCFlipConsumerMessage@@@Z @ 0x1C006CA60 (-PostNewMessage@CBackchannelManager@@UEAAXPEAVCFlipConsumerMessage@@@Z.c)
 */
