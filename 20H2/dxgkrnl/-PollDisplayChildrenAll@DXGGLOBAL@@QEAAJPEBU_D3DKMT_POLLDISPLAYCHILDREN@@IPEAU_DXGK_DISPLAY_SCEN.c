/*
 * XREFs of ?PollDisplayChildrenAll@DXGGLOBAL@@QEAAJPEBU_D3DKMT_POLLDISPLAYCHILDREN@@IPEAU_DXGK_DISPLAY_SCENARIO_CONTEXT@@@Z @ 0x1C026922C
 * Callers:
 ...
 *     MonitorReleaseMonitorPendingEvent @ 0x1C0157548 (MonitorReleaseMonitorPendingEvent.c)
