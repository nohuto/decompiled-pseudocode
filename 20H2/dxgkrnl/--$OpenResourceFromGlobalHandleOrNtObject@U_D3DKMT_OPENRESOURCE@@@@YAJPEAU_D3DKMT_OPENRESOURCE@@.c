/*
 * XREFs of ??$OpenResourceFromGlobalHandleOrNtObject@U_D3DKMT_OPENRESOURCE@@@@YAJPEAU_D3DKMT_OPENRESOURCE@@IPEAU_DXGSHAREDALLOCOBJECT@@H@Z @ 0x1C0114EC4
 * Callers:
...
LABEL_64:
        ...
        && ((v55 = *((_QWORD *)v119 + 231)) == 0 || *(_QWORD *)(v55 + 2704) || *(_QWORD *)(v33 + 96) == v55) )
      {
        ...
        StandardAllocation = DXGDEVICE::OpenResource<_D3DKMT_OPENRESOURCE>(
                               (struct _DXGK_ALLOCATIONINFO *)v119,
                               (__int64)v10,
                               v121,
                               0LL,
                               0,
