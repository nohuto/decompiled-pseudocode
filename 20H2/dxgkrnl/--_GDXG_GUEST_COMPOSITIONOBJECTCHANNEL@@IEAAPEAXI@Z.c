/*
 * XREFs of ??_GDXG_GUEST_COMPOSITIONOBJECTCHANNEL@@IEAAPEAXI@Z @ 0x1C02B2C94
 * Callers:
 *     ?Delete@DXG_GUEST_COMPOSITIONOBJECTCHANNEL@@UEAAXXZ @ 0x1C02B3CD0 (-Delete@DXG_GUEST_COMPOSITIONOBJECTCHANNEL@@UEAAXXZ.c)
 * Callees:
