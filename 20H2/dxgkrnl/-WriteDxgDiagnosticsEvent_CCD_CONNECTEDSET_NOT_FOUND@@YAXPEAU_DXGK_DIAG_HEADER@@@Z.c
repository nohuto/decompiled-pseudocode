/*
 * XREFs of ?WriteDxgDiagnosticsEvent_CCD_CONNECTEDSET_NOT_FOUND@@YAXPEAU_DXGK_DIAG_HEADER@@@Z @ 0x1C0044D5C
 * Callers:
...
void __fastcall WriteDxgDiagnosticsEvent_CCD_CONNECTEDSET_NOT_FOUND(struct _DXGK_DIAG_HEADER *a1)
{
  ...
  if ( (unsigned int)dword_1C00AFA20 > 4 && tlgKeywordOn((__int64)&dword_1C00AFA20, 0x200000000040LL) )
  {
    if ( tlgKeywordOn((__int64)&dword_1C00AFA20, v1) )
    {
      v6 = *(_WORD *)(v4 + 4);
      v5 = v4;
      v7 = 5;
