/*
 * XREFs of ?DmmUpdateCopyProtectionOnAllClientVidPnPathsFromSource@@YAJQEAXIW4_D3DKMDT_VIDPN_PRESENT_PATH_COPYPROTECTION_TYPE@@I@Z @ 0x1C013EDA4
 * Callers:
 ...
 *     ?IsCopyProtectionSchemeSupported@DMMVIDPNPRESENTPATH@@QEAAEW4_D3DKMDT_VIDPN_PRESENT_PATH_COPYPROTECTION_TYPE@@@Z @ 0x1C000CE2C (-IsCopyProtectionSchemeSupported@DMMVIDPNPRESENTPATH@@QEAAEW4_D3DKMDT_VIDPN_PRESENT_PATH_COPYPRO.c)
  ...
  if ( v11 )
  {
    ...
    if ( v47 )
    {
      ...
      while ( 1 )
      {
        ...
        if ( v39 == -1071774970 )
        {
          v44 = (_QWORD *)WdLogNewEntry5_WdDmmEvent(v41, v40);
          v44[3] = v5;
          v44[4] = v6;
          v44[5] = v50;
          v44[6] = a1;
