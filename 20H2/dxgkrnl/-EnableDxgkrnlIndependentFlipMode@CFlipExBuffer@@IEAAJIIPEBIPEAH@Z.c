/*
 * XREFs of ?EnableDxgkrnlIndependentFlipMode@CFlipExBuffer@@IEAAJIIPEBIPEAH@Z @ 0x1C001D318
 * Callers:
 *     ?SetIndependentFlip@CFlipExBuffer@@UEAAJ_N0IIPEBIPEAH@Z @ 0x1C001D280 (-SetIndependentFlip@CFlipExBuffer@@UEAAJ_N0IIPEBIPEAH@Z.c)
 * Callees:
        ...
        int *a5)
{
  ...
  if ( *((_DWORD *)this + 60) )
  {
    ...
    Handle = 0LL;
    v10 = CBufferRealization::OpenDxSurfaceHandle(v11, 0LL, 1u, &Handle);
    if ( v10 >= 0 )
    {
