/*
 * XREFs of DxgkUseAdapterViewInCurrentSession @ 0x1C014B154
 * Callers:
 ...
 *     ?AddDisplaySource@SESSION_ADAPTER@@QEAAJPEAVDISPLAY_SOURCE@@@Z @ 0x1C014B354 (-AddDisplaySource@SESSION_ADAPTER@@QEAAJPEAVDISPLAY_SOURCE@@@Z.c)
 ...
 *     ?RemoveAdapterFromSession@DXGSESSIONDATA@@QEAAJAEBU_LUID@@@Z @ 0x1C014B4F0 (-RemoveAdapterFromSession@DXGSESSIONDATA@@QEAAJAEBU_LUID@@@Z.c)
...
LABEL_8:
      ...
      else
      {
        ...
        if ( a3 )
        {
          ...
          if ( v25 >= 0 )
          {
            KeSetEvent(*(PRKEVENT *)(*((_QWORD *)v18 + 337) + 560LL), 0, 0);
LABEL_17:
