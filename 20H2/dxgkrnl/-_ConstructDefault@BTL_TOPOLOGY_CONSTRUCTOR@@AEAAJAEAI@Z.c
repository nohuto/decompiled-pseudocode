/*
 * XREFs of ?_ConstructDefault@BTL_TOPOLOGY_CONSTRUCTOR@@AEAAJAEAI@Z @ 0x1C02EDC94
 * Callers:
 ...
 *     _lambda_58ec37c2392282bb0e6e3e53197351b6_::operator() @ 0x1C02EC4C8 (_lambda_58ec37c2392282bb0e6e3e53197351b6_--operator().c)
