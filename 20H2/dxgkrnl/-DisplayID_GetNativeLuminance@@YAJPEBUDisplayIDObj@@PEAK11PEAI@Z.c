/*
 * XREFs of ?DisplayID_GetNativeLuminance@@YAJPEBUDisplayIDObj@@PEAK11PEAI@Z @ 0x1C006029C
 * Callers:
 ...
 *     ?IsValidBlock@DisplayID_DisplayParameters_Parser@@QEBA_NXZ @ 0x1C005FFB8 (-IsValidBlock@DisplayID_DisplayParameters_Parser@@QEBA_NXZ.c)
 *     ?ConvertHalfToFloat@@YAMG@Z @ 0x1C0060014 (-ConvertHalfToFloat@@YAMG@Z.c)
 */
