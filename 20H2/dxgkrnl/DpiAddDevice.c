/*
 * XREFs of DpiAddDevice @ 0x1C017DE10
 * Callers:
 *     <none>
 * Callees:
 ...
 *     DpiGetAgpStatus @ 0x1C0196AC4 (DpiGetAgpStatus.c)
 *     DpiGetVgaStatus @ 0x1C0196CA4 (DpiGetVgaStatus.c)
 ...
 *     DpiSetDeviceUsageType @ 0x1C02C7004 (DpiSetDeviceUsageType.c)
...
LABEL_63:
  ...
  *((_QWORD *)DeviceExtension + 49) = &DpiFdoHandleFilterResources;
  if ( !byte_1C00B0B11 && !DeviceExtension[480] )
...
LABEL_238:
  ...
  *((_QWORD *)DeviceExtension + 16) = DpiFdoDispatchPnp;
    ...
    *((_QWORD *)v6 + 17) = DpiFdoDispatchPower;
    if ( v6[1152] )
    {
      *(_BYTE *)(*((_QWORD *)v6 + 21) + 108LL) = 1;
      ...
      if ( qword_1C00B0DB8 && qword_1C00B0DB8 != qword_1C00B0DC0 )
      {
      ...
      qword_1C00B0DB8 = (__int64)DeviceObjecta;
      v167 = *((_QWORD *)v6 + 6);
      v205 = 0LL;
  ...
  if ( v182 && v188 )
  {
    qword_1C00B0DC0 = (__int64)DeviceObjecta;
    if ( !qword_1C00B0DB8 )
      qword_1C00B0DB8 = (__int64)DeviceObjecta;
