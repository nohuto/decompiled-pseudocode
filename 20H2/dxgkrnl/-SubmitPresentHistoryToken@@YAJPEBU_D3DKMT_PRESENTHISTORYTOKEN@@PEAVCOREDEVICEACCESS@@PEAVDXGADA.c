/*
 * XREFs of ?SubmitPresentHistoryToken@@YAJPEBU_D3DKMT_PRESENTHISTORYTOKEN@@PEAVCOREDEVICEACCESS@@PEAVDXGADAPTERSTOPRESETLOCKSHARED@@PEAVCWin32kLocks@@HPEAT_LARGE_INTEGER@@PEAUDXGK_PRESENT_PARAMS@@PEAUVIDSCH_SUBMIT_DATA_BASE@@PEAVDXGCONTEXT@@PEAU_PRESENT_REDIRECTED_PARAMS@@PEAD@Z @ 0x1C0102FF0
 * Callers:
 ...
 *     ??1KOBJECTREF@@QEAA@XZ @ 0x1C0047084 (--1KOBJECTREF@@QEAA@XZ.c)
    ...
    *((_QWORD *)a2 + 5) = 0LL;
    ...
    if ( v42 == 258 )
    {
      if ( (unsigned int)_InterlockedIncrement((volatile signed __int32 *)(v18 + 4496)) <= 2 )
      {
        ...
        {
          if ( tlgKeywordOn((__int64)&dword_1C00AFA90, 0x400000040000LL) )
          {
...
LABEL_90:
    ...
    else
    {
      ...
      if ( *(int *)(v76 + 2328) >= 0x2000 || *(_BYTE *)(v76 + 2628) )
        v78 = *(_DWORD *)(v76 + 2536) * ((v77 << 6) + ((8 * v77 + 199) & 0xFFFFFFF8)) + 8 * (v77 + 74);
      else
        v78 = 1288;
      memset(v75, 0, v78);
      v79 = *((_QWORD *)v222 + 2);
      ...
      *((_BYTE *)&v75[21].Next + 12) = v73;
      if ( (_BYTE)v73 )
      {
        ...
        *((_DWORD *)&v75[36].Next + 2) = v80;
        v82 = v80 << 6;
        HIDWORD(v75[36].Next) = v81;
        *((_DWORD *)&v75[36].Next + 3) = v81 * (v82 + ((v73 + 199) & 0xFFFFFFF8)) + 16;
        v83 = v81 * (v82 + ((v73 + 199) & 0xFFFFFFF8)) + 592;
              ...
              do
              {
                ...
                if ( *((_BYTE *)v13 + 348) )
                  v186 = (_QWORD *)((char *)v13
                                  + 64 * (unsigned __int64)(v183 * *((_DWORD *)v13 + 145))
