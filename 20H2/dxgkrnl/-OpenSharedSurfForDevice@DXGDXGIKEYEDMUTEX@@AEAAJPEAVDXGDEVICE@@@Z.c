/*
 * XREFs of ?OpenSharedSurfForDevice@DXGDXGIKEYEDMUTEX@@AEAAJPEAVDXGDEVICE@@@Z @ 0x1C0299ED0
 * Callers:
            ...
            *((_DWORD *)this + 23) = v48;
            ...
            if ( Resident >= 0 )
            {
              if ( (*(_DWORD *)(*(_QWORD *)(*((_QWORD *)a2 + 2) + 16LL) + 2060LL) & 0x40) != 0 )
              {
                ...
                v82.MinimumAddress = *(_QWORD *)(v60 + 2544);
                v82.MaximumAddress = *(_QWORD *)(v60 + 2552);
                if ( v54 )
                {
