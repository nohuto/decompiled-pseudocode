/*
 * XREFs of ?SaveTopology@TOPOLOGY_SET_DESCRIPTOR@CCD_STORE@@QEAAJPEBVCCD_TOPOLOGY@@_N@Z @ 0x1C015A074
 * Callers:
 *     _anonymous_namespace_::_SaveTopologySetCallback @ 0x1C015A040 (_anonymous_namespace_--_SaveTopologySetCallback.c)
 * Callees:
 ...
 *     ?MapModalitySetIdPath@CCD_TOPOLOGY@@QEBAJIPEAG@Z @ 0x1C015A594 (-MapModalitySetIdPath@CCD_TOPOLOGY@@QEBAJIPEAG@Z.c)
