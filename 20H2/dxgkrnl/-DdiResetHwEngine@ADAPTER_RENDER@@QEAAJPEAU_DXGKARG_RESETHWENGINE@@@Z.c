/*
 * XREFs of ?DdiResetHwEngine@ADAPTER_RENDER@@QEAAJPEAU_DXGKARG_RESETHWENGINE@@@Z @ 0x1C003C6A8
 * Callers:
 *     ?ADAPTER_RENDER_DdiResetHwEngine@@YAJPEAVADAPTER_RENDER@@PEAU_DXGKARG_RESETHWENGINE@@@Z @ 0x1C0041420 (-ADAPTER_RENDER_DdiResetHwEngine@@YAJPEAVADAPTER_RENDER@@PEAU_DXGKARG_RESETHWENGINE@@@Z.c)
 * Callees:
        ...
        __int64 a3)
{
  ...
  if ( (qword_1C00AF9B0 & 2) != 0 )
  {
    ...
    if ( (Microsoft_Windows_DxgKrnlEnableBits & 0x2000) != 0 )
      McTemplateK0q_EtwWriteTransfer((__int64)this, &EventProfilerEnter, a3, 5132);
  }
  else
  {
    v23 = 0;
  }
  DXGETWPROFILER_BASE::PushProfilerEntry((__int64)&v21, 5132LL);
  ...
  v10 = (*(int (__fastcall **)(_QWORD, struct _DXGKARG_RESETHWENGINE *))(*((_QWORD *)this + 2) + 1056LL))(
