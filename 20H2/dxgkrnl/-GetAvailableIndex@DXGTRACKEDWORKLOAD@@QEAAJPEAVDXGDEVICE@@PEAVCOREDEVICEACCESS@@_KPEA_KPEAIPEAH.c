/*
 * XREFs of ?GetAvailableIndex@DXGTRACKEDWORKLOAD@@QEAAJPEAVDXGDEVICE@@PEAVCOREDEVICEACCESS@@_KPEA_KPEAIPEAH@Z @ 0x1C02BB570
 * Callers:
 *     NtDxgkGetAvailableTrackedWorkloadIndex @ 0x1C02BC720 (NtDxgkGetAvailableTrackedWorkloadIndex.c)
 * Callees:
 *     ?GetIndexHelper@DXGTRACKEDWORKLOAD@@IEAAJPEAI@Z @ 0x1C02BB62C (-GetIndexHelper@DXGTRACKEDWORKLOAD@@IEAAJPEAI@Z.c)
