/*
 * XREFs of ?GetAdapterPerfDataCaps@DXGADAPTER@@QEAAJPEAU_D3DKMT_ADAPTER_PERFDATACAPS@@@Z @ 0x1C020C238
 * Callers:
        ...
        __int64 a3)
{
    ...
    && (PhysicalAdapterIndex = a2->PhysicalAdapterIndex, (unsigned int)PhysicalAdapterIndex < *((_DWORD *)this + 70)) )
  {
    ...
    a2->MaxMemoryBandwidth = *(_QWORD *)(v5 + 200);
    a2->MaxPCIEBandwidth = *(_QWORD *)(v5 + 208);
    a2->MaxFanRPM = *(_DWORD *)(v5 + 216);
    a2->TemperatureMax = *(_DWORD *)(v5 + 220);
    a2->TemperatureWarning = *(_DWORD *)(v5 + 224);
    return 0LL;
  }
  else
  {
