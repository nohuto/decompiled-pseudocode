/*
 * XREFs of ?AcquireFirstModeInfo@DXGDMM_VIDPNTARGETMODESET_INTERFACE_V1_IMPL@@YAJQEAUD3DKMDT_HVIDPNTARGETMODESET__@@PEAPEBU_D3DKMDT_VIDPN_TARGET_MODE@@@Z @ 0x1C0123260
 * Callers:
 *     <none>
 * Callees:
  ...
  if ( a2 )
  {
    *(_QWORD *)a2 = 0LL;
    ...
    if ( v9 )
    {
      ...
      {
        v24 = WdLogNewEntry5_WdDmmEvent(v12, v11);
        *(_QWORD *)(v24 + 24) = v9;
