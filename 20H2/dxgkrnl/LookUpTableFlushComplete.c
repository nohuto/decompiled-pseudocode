/*
 * XREFs of LookUpTableFlushComplete @ 0x1C019799C
 * Callers:
 ...
 *     ?TlgAggregateInternalFlushWorkItemRoutineKernelMode@@YAXPEAX@Z @ 0x1C02FFBE0 (-TlgAggregateInternalFlushWorkItemRoutineKernelMode@@YAXPEAX@Z.c)
 *     ?TlgAggregateInternalProviderCallback@@YAXPEBU_GUID@@KE_K1PEAU_EVENT_FILTER_DESCRIPTOR@@PEAX@Z @ 0x1C02FFC70 (-TlgAggregateInternalProviderCallback@@YAXPEBU_GUID@@KE_K1PEAU_EVENT_FILTER_DESCRIPTOR@@PEAX@Z.c)
 ...
 *     FlushLookUpTableBucket @ 0x1C0061B74 (FlushLookUpTableBucket.c)
 *     UpdateInternalStatsOnFlush @ 0x1C02FFCD8 (UpdateInternalStatsOnFlush.c)
 */
...
void __fastcall LookUpTableFlushComplete(__int64 a1)
{
  ...
  if ( *(_DWORD *)(a1 + 256) )
  {
    ...
    if ( *(_QWORD *)(v3 + 288) )
    {
      if ( (unsigned int)dword_1C00AFB38 > 5 && tlgKeywordOn((__int64)&dword_1C00AFB38, 0x400000000000LL) )
      {
