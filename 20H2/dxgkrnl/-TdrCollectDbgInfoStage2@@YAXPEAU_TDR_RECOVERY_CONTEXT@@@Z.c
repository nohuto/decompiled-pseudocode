/*
 * XREFs of ?TdrCollectDbgInfoStage2@@YAXPEAU_TDR_RECOVERY_CONTEXT@@@Z @ 0x1C02642C0
 * Callers:
 ...
 *     ??_GCTDR_DUMP_BUFFER@@QEAAPEAXI@Z @ 0x1C0262C3C (--_GCTDR_DUMP_BUFFER@@QEAAPEAXI@Z.c)
