/*
 * XREFs of ?GetDisplayModeFromPath@DMMVIDPNPRESENTPATH@@QEBAJAEAU_D3DKMT_DISPLAYMODE@@@Z @ 0x1C014515C
 * Callers:
 ...
 *     ConvertDMMScalingToGdiScaling @ 0x1C0144FD8 (ConvertDMMScalingToGdiScaling.c)
 */
