/*
 * XREFs of ?CreateClientVmBusChannel@@YAJPEAXPEAU_DEVICE_OBJECT@@U_GUID@@2PEBU_UNICODE_STRING@@PEAU_VMB_CHANNEL_STATE_CHANGE_CALLBACKS@@P6AXPEAUVMBCHANNEL__@@PEAUVMBPACKETCOMPLETION__@@0II@ZP6AX5I@ZPEAPEAU5@@Z @ 0x1C0236A64
 * Callers:
        ...
        struct VMBCHANNEL__ **a9)
{
  ...
  *a9 = 0LL;
  ...
  {
    v21 = 0LL;
    v14 = ((__int64 (__fastcall *)(struct _DEVICE_OBJECT *, _QWORD, struct VMBCHANNEL__ **))qword_1C00B2050)(
            a2,
            0LL,
            &v21);
    if ( v14 < 0 )
      goto LABEL_10;
    ((void (__fastcall *)(struct VMBCHANNEL__ *, __int64))qword_1C00B20C0)(v21, 0x20000LL);
    ((void (__fastcall *)(struct VMBCHANNEL__ *, __int64, __int64))qword_1C00B2138)(v21, 256LL, 256LL);
    ((void (__fastcall *)(struct VMBCHANNEL__ *, struct _VMB_CHANNEL_STATE_CHANGE_CALLBACKS *))qword_1C00B20D0)(
      v21,
      v25);
    ((void (__fastcall *)(struct VMBCHANNEL__ *, void (*)(struct VMBCHANNEL__ *, struct VMBPACKETCOMPLETION__ *, void *, unsigned int, unsigned int), _QWORD))qword_1C00B20C8)(
      v21,
      v26,
      0LL);
    ((void (__fastcall *)(struct VMBCHANNEL__ *, __int64))qword_1C00B2118)(v21, a1);
    v14 = ((__int64 (__fastcall *)(struct VMBCHANNEL__ *, struct _GUID *, struct _GUID *, _QWORD))qword_1C00B2140)(
            v21,
            a3,
            a4,
            0LL);
    if ( v14 < 0
      || (((void (__fastcall *)(struct VMBCHANNEL__ *, _QWORD))qword_1C00B2108)(v21, 0LL),
          ((void (__fastcall *)(struct VMBCHANNEL__ *, const struct _UNICODE_STRING *))qword_1C00B20B0)(v21, a5),
          v14 = ((__int64 (__fastcall *)(struct VMBCHANNEL__ *))qword_1C00B2080)(v21),
          v14 < 0) )
    {
LABEL_10:
      if ( v21 )
    ...
    {
      ((void (__fastcall *)(struct VMBCHANNEL__ *))qword_1C00B2130)(v21);
      *a9 = v21;
    }
  }
