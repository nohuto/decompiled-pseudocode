/*
 * XREFs of ?DestroyClientAllocations@DXGDEVICE@@QEAAXPEAVDXGALLOCATION@@@Z @ 0x1C02266A4
 * Callers:
...
void __fastcall DXGDEVICE::DestroyClientAllocations(DXGDEVICE *this, struct DXGALLOCATION *a2)
{
  ...
  if ( a2 )
  {
    ...
    do
    {
      ...
      ADAPTER_RENDER::FreeAllocationHandleAndWaitForZeroReferences(this, (struct _EX_RUNDOWN_REF *)v2, 0LL);
      if ( (*((_DWORD *)v4 + 18) & 1) != 0 )
      {
