/*
 * XREFs of DxgkUnlock2 @ 0x1C0100710
 * Callers:
...
__int64 __fastcall DxgkUnlock2(struct _D3DKMT_UNLOCK2 *a1)
{
  ...
  struct _D3DKMT_UNLOCK2 *v13; // r12
  __int64 v14; // rdx
  __int64 v15; // rcx
  ...
  struct _D3DKMT_UNLOCK2 v116; // [rsp+50h] [rbp-108h] BYREF
      ...
      if ( *((_QWORD *)v117 + 3) )
      {
        ...
        if ( v30 == v118 )
        {
          if ( !*((_DWORD *)v16 + 108) )
          {
            ...
            if ( (v61 & 4) != 0 )
            {
              ...
              if ( v101 )
              {
                ...
                v33 = v118;
                if ( v105 == 1
                  && ADAPTER_DISPLAY::IsVidPnSourceOwner(*(DXGADAPTER ***)(v101 + 2696), v118, v100)
          ...
          if ( (int)v38 >= 0 )
          {
            ...
            if ( !*((_DWORD *)DXGGLOBAL::GetGlobal((__int64)v40, v35) + 311) )
              goto LABEL_52;
            CurrentThread = KeGetCurrentThread();
            if ( !CurrentThread )
            {
              v107 = WdLogNewEntry5_WdAssertion(v42, v41);
              *(_QWORD *)(v107 + 24) = 507LL;
