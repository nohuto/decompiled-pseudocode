/*
 * XREFs of MonitorGetMonitorDeviceInterfaceName @ 0x1C0141BEC
 * Callers:
 ...
 * Callees:
 *     ?RtlStringCchCopyUnicodeString@@YAJPEAG_KPEBU_UNICODE_STRING@@@Z @ 0x1C00188C4 (-RtlStringCchCopyUnicodeString@@YAJPEAG_KPEBU_UNICODE_STRING@@@Z.c)
