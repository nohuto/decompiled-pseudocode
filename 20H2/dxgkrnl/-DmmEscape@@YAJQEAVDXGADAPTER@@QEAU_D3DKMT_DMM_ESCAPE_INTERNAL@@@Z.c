/*
 * XREFs of ?DmmEscape@@YAJQEAVDXGADAPTER@@QEAU_D3DKMT_DMM_ESCAPE_INTERNAL@@@Z @ 0x1C02DB320
 * Callers:
 ...
 *     ?MapEscapeCodeToDiagInfoType@VIDPN_MGR@@SA?AW4DIAGINFO_TYPE@1@W4_D3DKMT_DMMESCAPETYPE@@@Z @ 0x1C02DE1A8 (-MapEscapeCodeToDiagInfoType@VIDPN_MGR@@SA-AW4DIAGINFO_TYPE@1@W4_D3DKMT_DMMESCAPETYPE@@@Z.c)
 */
...
LABEL_19:
    if ( DXGADAPTER::IsDiagnosticAllowed(this, v4) )
    {
      ...
      {
        v36 = WdLogNewEntry5_WdTrace(v32, v31, v33, v34);
        v20 = 0;
