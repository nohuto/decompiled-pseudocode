/*
 * XREFs of ?DxgkCreateContextVirtualImpl@@YAJPEAU_D3DKMT_CREATECONTEXTVIRTUAL@@E@Z @ 0x1C00E4BD0
 * Callers:
 *     DxgkCreateContextVirtual @ 0x1C00E4BA0 (DxgkCreateContextVirtual.c)
 ...
 *     ?GetBitCount@@YAII@Z @ 0x1C00E4BB8 (-GetBitCount@@YAII@Z.c)
