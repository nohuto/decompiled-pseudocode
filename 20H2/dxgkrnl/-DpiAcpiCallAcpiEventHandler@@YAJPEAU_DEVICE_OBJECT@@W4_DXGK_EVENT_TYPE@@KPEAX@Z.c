/*
 * XREFs of ?DpiAcpiCallAcpiEventHandler@@YAJPEAU_DEVICE_OBJECT@@W4_DXGK_EVENT_TYPE@@KPEAX@Z @ 0x1C0058424
 * Callers:
 *     ?DpiAcpiPowerStateCallback@@YAXPEAX00@Z @ 0x1C0021150 (-DpiAcpiPowerStateCallback@@YAXPEAX00@Z.c)
 *     ?DpiAcpiEventCallback@@YAXPEAXK@Z @ 0x1C00586C0 (-DpiAcpiEventCallback@@YAXPEAXK@Z.c)
 *     DpiAcpiDockEventCallback @ 0x1C02D4BA0 (DpiAcpiDockEventCallback.c)
 * Callees:
  ...
  *(_QWORD *)&v23[4] = MEMORY[0xFFFFF78000000014];
  ...
  if ( PoolWithTag )
  {
    ...
    *((_QWORD *)PoolWithTag + 13) = *(_QWORD *)&v23[4];
    ExEnterCriticalRegionAndAcquireFastMutexUnsafe(&dword_1C00B0CA0);
    qword_1C00B0CD8 = (__int64)KeGetCurrentThread();
    if ( a2 == DxgkPowerStateEvent && (_DWORD)v5 == 4 )
    {
      ++dword_1C00B0CF0;
      KeClearEvent(&Event);
    }
    v15 = (_QWORD *)qword_1C00B0CE8;
    if ( *(__int64 **)qword_1C00B0CE8 != &qword_1C00B0CE0 )
      __fastfail(3u);
    *(_QWORD *)PoolWithTag = &qword_1C00B0CE0;
    *((_QWORD *)PoolWithTag + 1) = v15;
    *v15 = PoolWithTag;
    qword_1C00B0CE8 = (__int64)PoolWithTag;
    if ( !IoWorkItem )
    {
    ...
    qword_1C00B0CD8 = 0LL;
    ExReleaseFastMutexUnsafeAndLeaveCriticalRegion(&dword_1C00B0CA0);
    if ( v8 < 0 )
