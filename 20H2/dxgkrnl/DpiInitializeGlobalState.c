/*
 * XREFs of DpiInitializeGlobalState @ 0x1C03051B0
 * Callers:
 *     DriverEntry @ 0x1C0305D00 (DriverEntry.c)
 * Callees:
 *     __security_check_cookie @ 0x1C00243B0 (__security_check_cookie.c)
 *     _guard_dispatch_icall_nop @ 0x1C0027100 (_guard_dispatch_icall_nop.c)
 *     DpiIsXboxOne @ 0x1C019779C (DpiIsXboxOne.c)
...
__int64 DpiInitializeGlobalState()
{
  ...
  *((_QWORD *)&v66 + 1) = &v43;
  ...
  if ( v2 < 0 || !dword_1C00B0F3C )
    dword_1C00B0F3C = 7236;
  if ( v2 < 0 || (byte_1C00B0B17 = 1, !HIDWORD(v43)) )
    byte_1C00B0B17 = 0;
  v3 = -(int)v43;
  LODWORD(v43) = 0;
  DueTime.QuadPart = v3;
  ...
  v62 = 0LL;
  v61 = 0LL;
  byte_1C00B0B19 = (int)RtlQueryRegistryValuesEx(2LL, L"GraphicsDrivers", &v51, 0LL, 0LL) >= 0 && (_DWORD)v43 != 0;
  v43 = 0x100000000LL;
  v53 = L"HwSchMode";
  v51 = 0LL;
  v54 = (int *)&v43;
  ...
  *((_QWORD *)&v61 + 1) = (char *)&v43 + 4;
  ...
  if ( v4 < 0 || (dword_1C00B0B30 = v43, (unsigned int)v43 >= 3) )
    dword_1C00B0B30 = 0;
  if ( v4 < 0 || (byte_1C00B0B34 = 0, HIDWORD(v43)) )
    byte_1C00B0B34 = 1;
  v55 = 67108868;
  v43 = -1LL;
  LODWORD(v61) = 67108868;
...
LABEL_52:
  ...
  if ( PhysicalMemoryRanges )
  {
    ...
    if ( PoolWithTag )
    {
      ...
      qword_1C00B0B48 = (__int64)&qword_1C00B0B40;
      qword_1C00B0B40 = (__int64)&qword_1C00B0B40;
      RtlInitUnicodeString(
        (PUNICODE_STRING)&DestinationString[1],
      ...
      *(_OWORD *)&ObjectAttributes.SecurityDescriptor = 0LL;
      ...
      byte_1C00B0B59 = 0;
      byte_1C00B0B58 = v32 == 0LL;
      KeInitializeEvent(&stru_1C00B0B60, NotificationEvent, 0);
      byte_1C00B0B5A = 0;
      ...
      if ( v33 )
      {
        ...
        dword_1C00B0D98 = 0;
        qword_1C00B0DA8 = (__int64)&Entry;
        Entry = &Entry;
        KeInitializeTimerEx(&stru_1C00B0D10, SynchronizationTimer);
        KeInitializeDpc(&stru_1C00B0D50, (PKDEFERRED_ROUTINE)DpiPdoPollingDpc, 0LL);
        qword_1C00B0D90 = IoAllocateWorkItem((PDEVICE_OBJECT)g_pDriverObject);
        if ( qword_1C00B0D90 )
        {
          ExInitializeNPagedLookasideList(&stru_1C00B0C00, 0LL, 0LL, 0x200u, 0x30uLL, 0x74727044u, 0);
          byte_1C00B0EB8 = 0;
          KeInitializeMutex(&stru_1C00B0EC0, 0);
          HIDWORD(DestinationString[0]) = 2;
          qword_1C00B0F00 = (__int64)&qword_1C00B0EF8;
          qword_1C00B0EF8 = (__int64)&qword_1C00B0EF8;
          v48 = 4;
          if ( ((int (__fastcall *)(__int64, __int64, char *, int *))HalDispatchTable->HalQuerySystemInformation)(
                 ...
                 &v48) < 0
            || (byte_1C00B0B16 = 1, HIDWORD(DestinationString[0]) == 2) )
          {
            byte_1C00B0B16 = 0;
          }
          dword_1C00B0E6C = -1;
          ...
          qword_1C00B0F20 = (__int64)&qword_1C00B0F18;
          qword_1C00B0F18 = (__int64)&qword_1C00B0F18;
          dword_1C00B0F38 = 0;
          qword_1C00B0F30 = (__int64)&qword_1C00B0F28;
          qword_1C00B0F28 = (__int64)&qword_1C00B0F28;
          ...
          {
            IoWorkItem = 0LL;
            qword_1C00B0CE8 = (__int64)&qword_1C00B0CE0;
            qword_1C00B0CE0 = (__int64)&qword_1C00B0CE0;
            dword_1C00B0CF0 = 0;
            qword_1C00B0CD8 = 0LL;
            dword_1C00B0CA0 = 1;
            qword_1C00B0CA8 = 0LL;
            dword_1C00B0CB0 = 0;
            KeInitializeEvent(&stru_1C00B0CB8, SynchronizationEvent, 0);
            KeInitializeEvent(&Event, NotificationEvent, 1u);
            byte_1C00B1090 = 0;
            KeInitializeMutex(&stru_1C00B1098, 0);
            byte_1C00B0B1C = 0;
            qword_1C00B10D8 = (__int64)&qword_1C00B10D0;
            qword_1C00B10D0 = &qword_1C00B10D0;
            qword_1C00B1000 = 1LL;
            dword_1C00B0EB4 = 0;
            byte_1C00B0B1F = DpiIsXboxOne();
          }
LABEL_39:
          v1 = v0;
          if ( (int)v12 >= 0 )
