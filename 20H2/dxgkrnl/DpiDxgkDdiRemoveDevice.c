/*
 * XREFs of DpiDxgkDdiRemoveDevice @ 0x1C02D7760
 * Callers:
...
__int64 __fastcall DpiDxgkDdiRemoveDevice(__int64 a1, __int64 a2, __int64 a3)
{
  ...
  {
    v14 = 0;
    McTemplateK0pq_EtwWriteTransfer(a1, &EventEnterDdiRemoveDevice, a3, a2, v14);
  }
  ...
  {
    LODWORD(v13) = v5;
    McTemplateK0pq_EtwWriteTransfer(v7, &EventExitDdiRemoveDevice, v8, a2, v13);
  }
