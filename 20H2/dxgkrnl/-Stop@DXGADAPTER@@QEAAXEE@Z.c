/*
 * XREFs of ?Stop@DXGADAPTER@@QEAAXEE@Z @ 0x1C020E8D4
 * Callers:
 ...
 *     ?SetSchedulerCrossAdapterData@DXGGLOBAL@@QEAAXPEAU_KEVENT@@@Z @ 0x1C0045D64 (-SetSchedulerCrossAdapterData@DXGGLOBAL@@QEAAXPEAU_KEVENT@@@Z.c)
...
void __fastcall DXGADAPTER::Stop(DXGADAPTER *this, __int64 a2, unsigned __int8 a3)
{
  ...
  *(_QWORD *)(v7 + 24) = this;
  ...
  if ( (unsigned int)dword_1C00AFA90 > 5 && tlgKeywordOn((__int64)&dword_1C00AFA90, 0x400000000800LL) )
  {
    v34 = v53;
    v33 = v3;
    v36 = (v53 >> 1) & 1;
