/*
 * XREFs of DpiIndirectOpenDevice @ 0x1C02D45AC
 * Callers:
 *     DpiFdoOpenDeviceFileObjectIfNeeded @ 0x1C0182318 (DpiFdoOpenDeviceFileObjectIfNeeded.c)
 * Callees:
 *     ?DpiIndirectGetObjectName@@YAJPEAXPEAPEAU_OBJECT_NAME_INFORMATION@@@Z @ 0x1C02D3C2C (-DpiIndirectGetObjectName@@YAJPEAXPEAPEAU_OBJECT_NAME_INFORMATION@@@Z.c)
 */
