/*
 * XREFs of DpiFdoSetAdapterPowerState @ 0x1C0170A00
 * Callers:
  ...
  if ( State.SystemState > *((_DWORD *)DeviceExtension + 71) )
  {
    ...
    if ( *((_QWORD *)DeviceExtension + 2) == 0x274727044LL )
    {
      ...
      *((POWER_STATE *)DeviceExtension + 71) = State;
      ...
      if ( v33 == 5 && (PDEVICE_OBJECT)qword_1C00B0DB8 == DeviceObject && dword_1C00B0E68 == 3 )
      {
        byte_1C00B0E88 = 1;
        LOBYTE(v19) = 1;
  ...
  else if ( State.SystemState < *((_DWORD *)DeviceExtension + 71) )
  {
    ...
    if ( v14 && *((_DWORD *)DeviceExtension + 5) == 2 )
    {
      ...
      if ( (PDEVICE_OBJECT)qword_1C00B0DB8 == DeviceObject )
      {
        ...
        {
          LOBYTE(v11) = 1;
          DpiAcquirePostDisplayInfoFromBgfx(&xmmword_1C00B0DC8, v11, 0LL);
          byte_1C00B0E88 = 0;
          dword_1C00B0EB4 = 1;
          v34 = DeviceObject;
        }
        if ( a4 == 5 )
        {
          ...
          if ( (!v16 || *(int *)(v16 + 2596) <= 1105) && byte_1C00B0B16 )
          {
            v35 = -1;
            v36 = 0LL;
      ...
      if ( *((_DWORD *)DeviceExtension + 59) == 2 )
      {
        if ( *((_QWORD *)DeviceExtension + 3) == qword_1C00B0DB8 )
        {
          qword_1C00B0E70 = (__int64)KeGetCurrentThread();
          qword_1C00B0E78 = (__int64)v34;
        }
        ((void (__fastcall *)(_DWORD, _DWORD, _DWORD, _DWORD, _DWORD))DpiDxgkDdiSetPowerState)(
          ...
          *((_QWORD *)DeviceExtension + 6),
          ...
          (POWER_STATE)State.SystemState,
          v33);
        if ( (struct _KTHREAD *)qword_1C00B0E70 == KeGetCurrentThread() )
        {
          qword_1C00B0E78 = 0LL;
          qword_1C00B0E70 = 0LL;
        }
        if ( (PDEVICE_OBJECT)qword_1C00B0DB8 == DeviceObject && dword_1C00B0E68 == 3 )
        {
          xmmword_1C00B0DD8 = 0LL;
          DWORD2(xmmword_1C00B0DD8) = -1;
          xmmword_1C00B0DC8 = 0LL;
