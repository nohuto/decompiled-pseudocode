/*
 * XREFs of DpiFdoStopDeviceAndReleasePostDisplayOwnership @ 0x1C02CB318
 * Callers:
...
__int64 __fastcall DpiFdoStopDeviceAndReleasePostDisplayOwnership(__int64 a1)
{
  ...
  *(_BYTE *)(v1 + 3904) = v3 & 0xFB;
  if ( *(_DWORD *)(v4 + 136) < 0x3003u || !*(_QWORD *)(v4 + 736) )
    goto LABEL_11;
  HIDWORD(xmmword_1C00B0DD8) = 0;
  v5 = DpiDxgkDdiStopDeviceAndReleasePostDisplayOwnership(
         v4,
         *(_QWORD *)(v1 + 48),
         (unsigned int)dword_1C00B0E6C,
         &xmmword_1C00B0DC8);
  v2 = v5;
  if ( v5 >= 0 )
  {
    if ( (_DWORD)xmmword_1C00B0DC8 )
    {
      if ( !*(_BYTE *)(v1 + 1154) )
        dword_1C00B0EB4 = 2;
    }
