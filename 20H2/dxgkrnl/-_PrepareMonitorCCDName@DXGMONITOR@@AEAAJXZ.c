/*
 * XREFs of ?_PrepareMonitorCCDName@DXGMONITOR@@AEAAJXZ @ 0x1C0188FEC
 * Callers:
 ...
 *     __report_rangecheckfailure @ 0x1C00243F0 (__report_rangecheckfailure.c)
 *     memcmp @ 0x1C0026FF0 (memcmp.c)
 *     memset @ 0x1C0027400 (memset.c)
 *     ?DisplayID_GetManufactureDate@@YAJPEBUDisplayIDObj@@PEAEPEAG@Z @ 0x1C005ED7C (-DisplayID_GetManufactureDate@@YAJPEBUDisplayIDObj@@PEAEPEAG@Z.c)
 *     ?DisplayID_GetManufacturerName@@YAJPEBUDisplayIDObj@@PEAG@Z @ 0x1C005EDF0 (-DisplayID_GetManufacturerName@@YAJPEBUDisplayIDObj@@PEAG@Z.c)
 *     ?DisplayID_GetProductCode@@YAJPEBUDisplayIDObj@@PEAG@Z @ 0x1C005EEC0 (-DisplayID_GetProductCode@@YAJPEBUDisplayIDObj@@PEAG@Z.c)
 *     ?DisplayID_GetSerialNumber@@YAJPEBUDisplayIDObj@@PEAG@Z @ 0x1C005EF38 (-DisplayID_GetSerialNumber@@YAJPEBUDisplayIDObj@@PEAG@Z.c)
 *     MonitorUnifyCCDMonitorString @ 0x1C0180FF8 (MonitorUnifyCCDMonitorString.c)
 ...
 *     MonitorLogBadEDID @ 0x1C02F2D78 (MonitorLogBadEDID.c)
 */
...
LABEL_25:
          ...
          if ( Flink )
          {
            ...
            *(_WORD *)(v38 + 2 * v34 + 24) = 0;
            v46 = (__int64 *)qword_1C00B1E38;
            if ( *(struct _LIST_ENTRY **)qword_1C00B1E38 != &DXGMONITOR::_UniqueEntryList )
              __fastfail(3u);
