/*
 * XREFs of DpiFdoHandleRemoveDevice @ 0x1C02C8E80
 * Callers:
 *     <none>
 * Callees:
 ...
 *     DpiCheckSpbResourceLeakage @ 0x1C0058714 (DpiCheckSpbResourceLeakage.c)
 ...
 *     DpiPdoDestroyPendingPdoObjects @ 0x1C02D7C80 (DpiPdoDestroyPendingPdoObjects.c)
 */
...
__int64 __fastcall DpiFdoHandleRemoveDevice(PDEVICE_OBJECT DeviceObject, PIRP Irp)
{
  ...
  if ( (PDEVICE_OBJECT)qword_1C00B0DC0 == DeviceObject )
  {
