/*
 * XREFs of ?VmBusSubmitVailPresentHistoryToken@DXG_HOST_VIRTUALGPU_VMBUS@@SAEPEAUDXGADAPTER_VMBUS_PACKET@@@Z @ 0x1C024F120
 * Callers:
 *     <none>
 * Callees:
...
LABEL_29:
    ...
    *(_QWORD *)(v8 + 144) = 0LL;
    ...
    if ( (_DWORD)v18 )
    {
      ...
      v15 = (volatile signed __int32 *)RefCountedBuffer;
      if ( RefCountedBuffer )
      {
