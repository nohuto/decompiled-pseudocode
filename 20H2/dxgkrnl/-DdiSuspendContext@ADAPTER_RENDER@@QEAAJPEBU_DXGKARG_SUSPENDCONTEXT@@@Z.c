/*
 * XREFs of ?DdiSuspendContext@ADAPTER_RENDER@@QEAAJPEBU_DXGKARG_SUSPENDCONTEXT@@@Z @ 0x1C021ED9C
 * Callers:
 *     ?ADAPTER_RENDER_DdiSuspendContext@@YAJPEAVADAPTER_RENDER@@PEBU_DXGKARG_SUSPENDCONTEXT@@@Z @ 0x1C0041560 (-ADAPTER_RENDER_DdiSuspendContext@@YAJPEAVADAPTER_RENDER@@PEBU_DXGKARG_SUSPENDCONTEXT@@@Z.c)
 * Callees:
        ...
        __int64 a3)
{
  ...
  __int64 v11; // rdx
  __int64 v12; // rcx
  __int64 (__fastcall *v13)(_QWORD, const struct _DXGKARG_SUSPENDCONTEXT *); // rax
  int v14; // ebx
  __int64 v15; // rcx
  _QWORD *v16; // rax
  ...
  if ( (qword_1C00AF9B0 & 2) != 0 )
  {
    ...
    if ( (Microsoft_Windows_DxgKrnlEnableBits & 0x2000) != 0 )
      McTemplateK0q_EtwWriteTransfer((__int64)this, &EventProfilerEnter, a3, 5118);
  }
  else
  {
    v27 = 0;
  }
  DXGETWPROFILER_BASE::PushProfilerEntry((__int64)&v25, 5118LL);
  ...
  v12 = *((_QWORD *)this + 2);
  v13 = *(__int64 (__fastcall **)(_QWORD, const struct _DXGKARG_SUSPENDCONTEXT *))(v12 + 1224);
  if ( v13 )
