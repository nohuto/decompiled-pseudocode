/*
 * XREFs of ?_OnMonitorDeviceNodeReady@DXGMONITOR@@QEAAJPEAU_DXGK_DISPLAY_SCENARIO_CONTEXT@@@Z @ 0x1C0186D4C
 * Callers:
 ...
 *     ?_UpdatePnPDeviceProperties@DXGMONITOR@@AEAAJXZ @ 0x1C0186DEC (-_UpdatePnPDeviceProperties@DXGMONITOR@@AEAAJXZ.c)
