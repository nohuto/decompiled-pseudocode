/*
 * XREFs of ?_AddSecondaryPathToTopology@BTL_TOPOLOGY_CONSTRUCTOR@@AEAAJ_NAEBU_LUID@@I@Z @ 0x1C02ED360
 * Callers:
 ...
 *     ?_IsBetterSecondaryTarget@BTL_TOPOLOGY_CONSTRUCTOR@@CA_NAEBVDXGADAPTER@@AEBVDMMVIDEOPRESENTTARGET@@PEBV3@@Z @ 0x1C02EE978 (-_IsBetterSecondaryTarget@BTL_TOPOLOGY_CONSTRUCTOR@@CA_NAEBVDXGADAPTER@@AEBVDMMVIDEOPRESENTTARGE.c)
 */
        ...
        unsigned int a4)
{
  ...
  if ( (int)v14 < 0 )
    goto LABEL_93;
  v85 = (char *)v12 + 2696;
  v82 = *(VIDPN_MGR **)(*((_QWORD *)v12 + 337) + 88LL);
  v16 = v82;
...
LABEL_47:
    ...
    {
      v44 = WdLogNewEntry5_WdDmmEvent(v38, v37);
      *(_QWORD *)(v44 + 24) = v36;
      *(_QWORD *)(v44 + 32) = v12;
