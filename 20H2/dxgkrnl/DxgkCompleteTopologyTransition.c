/*
 * XREFs of DxgkCompleteTopologyTransition @ 0x1C0158D70
 * Callers:
 *     <none>
 * Callees:
 ...
 *     ?ToggleTopologyTransition@DXGGLOBAL@@QEAAEE@Z @ 0x1C00186F4 (-ToggleTopologyTransition@DXGGLOBAL@@QEAAEE@Z.c)
...
__int64 DxgkCompleteTopologyTransition()
{
  ...
  {
    *(_QWORD *)(WdLogNewEntry5_WdTrace(v7, v6, v8, v9) + 24) = 7611LL;
  }
  else
  {
    *(_QWORD *)(WdLogNewEntry5_WdTrace(v7, v6, v8, v9) + 24) = 7615LL;
    v20[0] = 0LL;
    v20[1] = v21;
