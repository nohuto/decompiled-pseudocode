/*
 * XREFs of ??1CFlipConsumerMessage@@MEAA@XZ @ 0x1C0067334
 * Callers:
 *     ??_ECFlipConsumerMessage@@MEAAPEAXI@Z @ 0x1C0067390 (--_ECFlipConsumerMessage@@MEAAPEAXI@Z.c)
 * Callees:
 *     ??1CFlipPropertySetBase@@MEAA@XZ @ 0x1C006AF3C (--1CFlipPropertySetBase@@MEAA@XZ.c)
 */
