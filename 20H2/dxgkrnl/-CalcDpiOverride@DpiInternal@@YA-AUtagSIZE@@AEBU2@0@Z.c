/*
 * XREFs of ?CalcDpiOverride@DpiInternal@@YA?AUtagSIZE@@AEBU2@0@Z @ 0x1C000C12C
 * Callers:
 ...
 * Callees:
 *     ?CalcDpi@DpiInternal@@YA?AUtagSIZE@@AEBU2@0@Z @ 0x1C004AA68 (-CalcDpi@DpiInternal@@YA-AUtagSIZE@@AEBU2@0@Z.c)
 */
        ...
        const struct tagSIZE *a3)
{
  ...
  struct tagSIZE v22; // [rsp+D8h] [rbp+7Fh] BYREF
  ...
  {
    cx = v20;
    cy = (unsigned int)(v20 * *((_DWORD *)this + 1)) / *(_DWORD *)this;
  }
  if ( cx && cy )
  {
    v22.cx = cx;
