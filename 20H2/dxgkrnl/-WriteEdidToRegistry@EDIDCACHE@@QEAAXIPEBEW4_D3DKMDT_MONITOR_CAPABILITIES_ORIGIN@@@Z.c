/*
 * XREFs of ?WriteEdidToRegistry@EDIDCACHE@@QEAAXIPEBEW4_D3DKMDT_MONITOR_CAPABILITIES_ORIGIN@@@Z @ 0x1C027585C
 * Callers:
        ...
        enum _D3DKMDT_MONITOR_CAPABILITIES_ORIGIN a4)
{
  ...
  enum _D3DKMDT_MONITOR_CAPABILITIES_ORIGIN v26; // [rsp+68h] [rbp+20h] BYREF
  ...
  v24 = 0;
  v5 = a2;
  v6 = EDIDCACHE::OpenEdidRegistryForTarget(this, a2, 0xF003Fu, (void **)&Path, &v24);
  v10 = v6;
  if ( v6 >= 0 )
  {
    v12 = Path;
    ...
    v19 = v15;
    if ( v15 < 0
      || (v14 = L"Origin", v20 = RtlWriteRegistryValue(0x40000000u, Path, L"Origin", 4u, &v26, 4u), v19 = v20, v20 < 0) )
    {
