/*
 * XREFs of ?DdiRecommendMonitorModes@ADAPTER_DISPLAY@@QEAAJPEAU_DXGKARG_RECOMMENDMONITORMODES@@@Z @ 0x1C0187F04
 * Callers:
        ...
        __int64 a3)
{
  ...
  DXGETWPROFILER_BASE::PushProfilerEntry((__int64)&v28, 5037LL);
  ...
  v12 = (*(int (__fastcall **)(_QWORD, struct _DXGKARG_RECOMMENDMONITORMODES *))(*((_QWORD *)this + 2) + 576LL))(
  ...
  v16[7] = pMonitorSourceModeSetInterface;
  if ( (_DWORD)v12 != -1073741801 && (_DWORD)v12 )
  {
    v27 = WdLogNewEntry5_WdError(pMonitorSourceModeSetInterface, v17);
    *(_QWORD *)(v27 + 24) = v12;
