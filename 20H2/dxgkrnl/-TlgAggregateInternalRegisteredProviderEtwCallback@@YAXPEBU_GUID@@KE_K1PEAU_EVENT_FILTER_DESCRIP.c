/*
 * XREFs of ?TlgAggregateInternalRegisteredProviderEtwCallback@@YAXPEBU_GUID@@KE_K1PEAU_EVENT_FILTER_DESCRIPTOR@@PEAX@Z @ 0x1C0197950
 * Callers:
 *     <none>
 * Callees:
 *     _guard_dispatch_icall_nop @ 0x1C0027100 (_guard_dispatch_icall_nop.c)
 *     LookUpTableFlushComplete @ 0x1C019799C (LookUpTableFlushComplete.c)
 *     LookUpTableFlushPartial @ 0x1C02FFB5C (LookUpTableFlushPartial.c)
 */
