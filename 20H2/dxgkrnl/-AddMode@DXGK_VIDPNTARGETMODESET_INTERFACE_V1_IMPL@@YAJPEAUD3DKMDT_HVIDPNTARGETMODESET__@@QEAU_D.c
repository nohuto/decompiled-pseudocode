/*
 * XREFs of ?AddMode@DXGK_VIDPNTARGETMODESET_INTERFACE_V1_IMPL@@YAJPEAUD3DKMDT_HVIDPNTARGETMODESET__@@QEAU_D3DKMDT_VIDPN_TARGET_MODE@@@Z @ 0x1C010F7A0
 * Callers:
 *     <none>
 * Callees:
...
LABEL_20:
  if ( !DXGADAPTER::DriverSupportSetTimingsFromVidPn(*(DXGADAPTER **)(v19 + 16))
    || (v23 = 1, (*(_DWORD *)(*(_QWORD *)(v22 + 2696) + 440LL) & 1) != 0) )
  {
    v23 = 0;
  }
  v24 = v21 & 3;
