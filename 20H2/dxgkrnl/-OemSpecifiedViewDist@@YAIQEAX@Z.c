/*
 * XREFs of ?OemSpecifiedViewDist@@YAIQEAX@Z @ 0x1C02A8144
 * Callers:
 *     ?DetermineViewDistance@@YA_NQEAXAEBUtagSIZE@@H1PEAI@Z @ 0x1C0166E20 (-DetermineViewDistance@@YA_NQEAXAEBUtagSIZE@@H1PEAI@Z.c)
 * Callees:
