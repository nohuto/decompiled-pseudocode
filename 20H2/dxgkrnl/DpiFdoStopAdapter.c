...
__int64 __fastcall DpiFdoStopAdapter(struct _DEVICE_OBJECT *a1, __int64 a2)
{
  ...
  *((_DWORD *)DeviceExtension + 59) = 4;
  if ( v7 && *((_DWORD *)DeviceExtension + 5) == 2 )
  {
    ...
    if ( (DeviceExtension[3904] & 1) != 0 || (struct _DEVICE_OBJECT *)qword_1C00B0B20 == a1 )
    {
    ...
    if ( DeviceExtension[1152] && dword_1C00B0E6C != -1 )
    {
      ...
      for ( i = 0; i < *((_DWORD *)DeviceExtension + 916); v34 = v36 )
      {
        ...
        if ( *v34 == *((_QWORD *)DeviceExtension + 456) )
          break;
        if ( *((_DWORD *)v34 + 126) == dword_1C00B0E6C )
        {
          v37 = (__int128 *)v34[116];
          if ( v37 )
          {
            xmmword_1C00B0DE8 = *v37;
            xmmword_1C00B0DF8 = v37[1];
            xmmword_1C00B0E08 = v37[2];
            xmmword_1C00B0E18 = v37[3];
            xmmword_1C00B0E28 = v37[4];
            xmmword_1C00B0E38 = v37[5];
            xmmword_1C00B0E48 = v37[6];
            xmmword_1C00B0E58 = v37[7];
            v36 = (__int64 *)*v34;
          }
        }
        ++i;
  ...
  if ( DeviceExtension[1152] )
  {
    if ( v42 )
    {
      ...
      if ( v44 < 0 || DWORD2(xmmword_1C00B0DD8) != dword_1C00B0E6C )
