/*
 * XREFs of NtTokenManagerCreateCompositionTokenHandle @ 0x1C00158E0
 * Callers:
 *     <none>
 * Callees:
...
LABEL_51:
  ...
  if ( LocallyUniqueId >= 0 )
  {
    if ( !DXGGLOBAL::m_pGlobal )
    {
      ...
      *(_QWORD *)(v19 + 24) = 2238LL;
      WdLogEvent5_WdAssertion(v19);
    }
    LocallyUniqueId = (*(__int64 (__fastcall **)(__int64, __int64 *))(*((_QWORD *)DXGGLOBAL::m_pGlobal + 38048) + 192LL))(
                        0x80000000LL,
                        &v21);
    if ( LocallyUniqueId >= 0 )
    {
  ...
  if ( v21 )
  {
    ...
    (*(void (**)(void))(*((_QWORD *)DXGGLOBAL::m_pGlobal + 38048) + 312LL))();
  }
