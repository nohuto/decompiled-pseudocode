/*
 * XREFs of DxgkHandleVideoParameters @ 0x1C02937B8
 * Callers:
 *     DpiGdoHandleVideoParameters @ 0x1C02D8DC0 (DpiGdoHandleVideoParameters.c)
 * Callees:
 ...
 *     ?GetCurrentTvStandard@@YAIPEAVDXGADAPTER@@I@Z @ 0x1C0293628 (-GetCurrentTvStandard@@YAIPEAVDXGADAPTER@@I@Z.c)
...
LABEL_11:
  ...
  if ( (unsigned int)v4 >= *((_DWORD *)a1[337] + 20) )
  {
    v16 = (_QWORD *)WdLogNewEntry5_WdError(v15, v14);
    v10 = -1071774975;
    v16[3] = v4;
...
LABEL_42:
  ...
  if ( *((_DWORD *)Source1 + 21) != 1 )
  {
    ...
    {
      updated = ADAPTER_DISPLAY::DestroyCopyProtection(a1[337], v4, *((_DWORD *)Source1 + 23));
    }
    else
    {
...
LABEL_32:
      ...
      updated = ADAPTER_DISPLAY::UpdateCopyProtection(a1[337], v4, v29, *((_DWORD *)Source1 + 23));
    }
    goto LABEL_39;
  }
  v29 = *((unsigned int *)Source1 + 24);
  if ( (unsigned int)(v29 - 1) <= 2 )
  {
    if ( *((_DWORD *)Source1 + 20) != 1 )
      goto LABEL_32;
    updated = ADAPTER_DISPLAY::CreateCopyProtection(a1[337], v4, v29, (unsigned int *)Source1 + 23);
LABEL_39:
    v10 = updated;
    goto LABEL_41;
  }
