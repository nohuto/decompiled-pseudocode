/*
 * XREFs of ?AddPath@DMMVIDPNTOPOLOGY@@QEAAJPEAVDMMVIDPNPRESENTPATH@@W4_D3DKMDT_MONITOR_CONNECTIVITY_CHECKS@@@Z @ 0x1C0120FD8
 * Callers:
 ...
 *     ?Add@?$Set@VDMMVIDPNPRESENTPATH@@@@QEAAEQEAVDMMVIDPNPRESENTPATH@@@Z @ 0x1C0007D8C (-Add@-$Set@VDMMVIDPNPRESENTPATH@@@@QEAAEQEAVDMMVIDPNPRESENTPATH@@@Z.c)
        ...
        __int64 a4)
{
  ...
  {
    v28 = (_QWORD *)WdLogNewEntry5_WdDmmEvent(v20, v19);
    v28[3] = a2;
    v28[4] = this;
  ...
  if ( !*(_QWORD *)(v22 + 112) )
  {
    ...
    if ( (_DWORD)v4 == 1 )
    {
      v30 = WdLogNewEntry5_WdDmmEvent(v29, v19);
    ...
    else
    {
      if ( (_DWORD)v4 == 2 )
      {
        v35 = (_QWORD *)WdLogNewEntry5_WdDmmEvent(v29, v19);
        v35[3] = a2;
        v35[4] = this;
