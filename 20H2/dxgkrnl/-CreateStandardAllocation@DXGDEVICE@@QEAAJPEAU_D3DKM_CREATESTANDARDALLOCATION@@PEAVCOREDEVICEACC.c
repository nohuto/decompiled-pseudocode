/*
 * XREFs of ?CreateStandardAllocation@DXGDEVICE@@QEAAJPEAU_D3DKM_CREATESTANDARDALLOCATION@@PEAVCOREDEVICEACCESS@@@Z @ 0x1C0111200
 * Callers:
 ...
 *     GetPixelSizeInBytes @ 0x1C02270E4 (GetPixelSizeInBytes.c)
 */
...
LABEL_2:
  ...
  if ( !*(_BYTE *)(v8 + 2615) && !DXGADAPTER::ReplicateGdiContent((DXGADAPTER *)v8) )
  {
    Size = this->Size;
    goto LABEL_2;
  }
LABEL_66:
  ...
  v90 = v9;
LABEL_3:
  if ( *((_DWORD *)a2 + 4) == 1 && !*(_QWORD *)(v8 + 2696) )
...
LABEL_27:
    ...
    *(_QWORD *)&v98.hResource = 0LL;
    ...
    if ( v9 )
    {
      ...
      {
        v37 = *(_DWORD *)v36;
        v92 = *(struct _EX_RUNDOWN_REF **)&this->SupportedReadSegmentSet;
...
LABEL_37:
        ...
        *v91 = *(_DWORD *)v95;
        if ( !v87 )
        {
                  ...
                  *(_QWORD *)(v7[6].Count + 8)) )
          {
            ...
            {
              v70 = *(_QWORD *)(this->Size + 16);
              if ( (*(_DWORD *)(v70 + 2060) & 0x200) == 0 || (_DWORD)v33 != 1 )
              {
                LODWORD(v29) = -1073741811;
    ...
    *((_DWORD *)a2 + 3) = v98.hGlobalShare;
    ...
    if ( (v48 & 0xFFFFFFFD) != 0 )
      ...
      v49 = (*(__int64 (__fastcall **)(_QWORD, ULONG_PTR))(*(_QWORD *)(*(_QWORD *)(this->Size + 640) + 8LL) + 688LL))(
              *(_QWORD *)(this->Size + 648),
              v7[3].Count);
    *((_QWORD *)a2 + 41) = v49;
    if ( (*(_DWORD *)a2 & 0x40) != 0 )
