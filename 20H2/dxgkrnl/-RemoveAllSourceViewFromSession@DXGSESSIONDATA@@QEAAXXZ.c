/*
 * XREFs of ?RemoveAllSourceViewFromSession@DXGSESSIONDATA@@QEAAXXZ @ 0x1C00DE330
 * Callers:
 ...
 *     ?RemoveAllDisplaySource@SESSION_VIEW@@QEAAXXZ @ 0x1C00DE3D0 (-RemoveAllDisplaySource@SESSION_VIEW@@QEAAXXZ.c)
 */
