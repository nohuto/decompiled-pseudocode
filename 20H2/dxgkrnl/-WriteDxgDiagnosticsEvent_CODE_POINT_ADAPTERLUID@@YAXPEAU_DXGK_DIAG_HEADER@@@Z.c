...
void __fastcall WriteDxgDiagnosticsEvent_CODE_POINT_ADAPTERLUID(struct _DXGK_DIAG_HEADER *a1)
{
  ...
  if ( (unsigned int)IsCodePointTypeNoisy(*((unsigned int *)a1 + 12)) )
  {
    if ( (unsigned int)dword_1C00AFA20 <= 4 )
      return;
    if ( (unsigned __int8)tlgKeywordOn(&dword_1C00AFA20, 16LL) && (unsigned __int8)tlgKeywordOn(&dword_1C00AFA20, v2) )
    {
      v5 = &unk_1C007E877;
LABEL_14:
      v25 = *((_WORD *)a1 + 2);
  ...
  else
  {
    ...
    {
      if ( (unsigned __int8)tlgKeywordOn(&dword_1C00AFA20, v4) )
      {
        v5 = &unk_1C007E84E;
        goto LABEL_14;
      }
  ...
  switch ( v10 )
  {
    case 'D':
      if ( *((int *)a1 + 13) < 0 != ((*((_DWORD *)a1 + 13) & 0x40000000) != 0)
        && (unsigned __int8)tlgKeywordOn(&dword_1C00AFA20, v3) )
      {
      ...
      break;
    case 'X':
      if ( !(unsigned __int8)tlgKeywordOn(&dword_1C00AFA20, v3) )
        return;
      v14 = &unk_1C007E7F5;
      goto LABEL_29;
    case '`':
      ...
      goto LABEL_29;
    case 'b':
      if ( *((int *)a1 + 14) < 0 && (unsigned __int8)tlgKeywordOn(&dword_1C00AFA20, v3) )
      {
        v27 = *((_DWORD *)a1 + 13);
        v29 = *((_QWORD *)a1 + 8);
        v26 = v17;
      ...
      break;
    default:
      if ( v10 != 104 || !(unsigned __int8)tlgKeywordOn(&dword_1C00AFA20, v3) )
        return;
      v14 = &unk_1C007E63D;
LABEL_29:
      v26 = *((_DWORD *)a1 + 15);
