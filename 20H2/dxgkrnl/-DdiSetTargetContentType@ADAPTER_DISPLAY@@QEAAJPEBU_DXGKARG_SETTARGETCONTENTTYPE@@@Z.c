/*
 * XREFs of ?DdiSetTargetContentType@ADAPTER_DISPLAY@@QEAAJPEBU_DXGKARG_SETTARGETCONTENTTYPE@@@Z @ 0x1C021D820
 * Callers:
...
__int64 __fastcall ADAPTER_DISPLAY::DdiSetTargetContentType(
        ADAPTER_DISPLAY *this,
        const struct _DXGKARG_SETTARGETCONTENTTYPE *a2,
        __int64 a3)
{
  __int64 v5; // rdx
  __int64 v6; // rcx
  ...
  if ( (qword_1C00AF9B0 & 2) != 0 )
  {
    ...
    if ( (Microsoft_Windows_DxgKrnlEnableBits & 0x2000) != 0 )
      McTemplateK0q_EtwWriteTransfer((__int64)this, &EventProfilerEnter, a3, 5078);
  }
  else
  {
    v28 = 0;
  }
  DXGETWPROFILER_BASE::PushProfilerEntry((__int64)&v26, 5078LL);
  ...
  v12 = (*(int (__fastcall **)(_QWORD, const struct _DXGKARG_SETTARGETCONTENTTYPE *))(*((_QWORD *)this + 2) + 1104LL))(
