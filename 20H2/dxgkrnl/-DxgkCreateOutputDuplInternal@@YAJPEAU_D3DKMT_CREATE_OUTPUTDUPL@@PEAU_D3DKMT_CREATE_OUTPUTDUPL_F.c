/*
 * XREFs of ?DxgkCreateOutputDuplInternal@@YAJPEAU_D3DKMT_CREATE_OUTPUTDUPL@@PEAU_D3DKMT_CREATE_OUTPUTDUPL_FLAGS@@@Z @ 0x1C02980C8
 * Callers:
 ...
 *     ?OutputDuplIsAllowedByMdmPolicy@@YA_NXZ @ 0x1C029A660 (-OutputDuplIsAllowedByMdmPolicy@@YA_NXZ.c)
 */
