/*
 * XREFs of MicrosoftTelemetryAssertTriggeredWorker @ 0x1C006E73C
 * Callers:
 *     MicrosoftTelemetryAssertTriggeredNoArgsKM @ 0x1C006E70C (MicrosoftTelemetryAssertTriggeredNoArgsKM.c)
 * Callees:
 ...
 *     GetImageTuple @ 0x1C006E6BC (GetImageTuple.c)
 *     _tlgCreate1Sz_char @ 0x1C006EC48 (_tlgCreate1Sz_char.c)
 *     TakeTelemetryAssertsLock @ 0x1C006EC7C (TakeTelemetryAssertsLock.c)
 */
...
LABEL_33:
  ...
  if ( (unsigned int)dword_1C00D3040 > 5 && tlgKeywordOn((__int64)&dword_1C00D3040, 0x400000000000LL) )
  {
    v36 = 10;
    v67 = &v36;
    v68 = 4LL;
    ...
    tlgWriteTransfer_EtwWriteTransfer(
      (__int64)&dword_1C00D3040,
      (unsigned __int8 *)dword_1C0080AF7,
      0LL,
      v24,
      0xBu,
      &v66);
  }
  if ( dword_1C00D3078 && !v19 && !KeGetCurrentIrql() )
  {
    v27 = DbgkWerCaptureLiveKernelDump(L"TELASSERT", 465LL, v15, 0LL, v35, v13, 0LL, 0LL, 0);
    if ( (unsigned int)dword_1C00D3040 > 5 )
    {
      v29 = tlgKeywordOn((__int64)&dword_1C00D3040, 0x400000000000LL);
      v28 = 0LL;
      if ( v29 )
      {
        v52 = 4LL;
        ...
        tlgWriteTransfer_EtwWriteTransfer(
          (__int64)&dword_1C00D3040,
          (unsigned __int8 *)dword_1C0080B64,
          v31,
          0LL,
          v32,
          &v50);
