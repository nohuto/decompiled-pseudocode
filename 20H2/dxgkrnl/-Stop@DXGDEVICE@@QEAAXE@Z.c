/*
 * XREFs of ?Stop@DXGDEVICE@@QEAAXE@Z @ 0x1C02557C0
 * Callers:
 ...
 *     ?SendWnfNotification@DXGPROCESS@@QEAAJPEBU_WNF_STATE_NAME@@PEAXK@Z @ 0x1C0284A90 (-SendWnfNotification@DXGPROCESS@@QEAAJPEBU_WNF_STATE_NAME@@PEAXK@Z.c)
 */
