/*
 * XREFs of ?VmBusChannelProcessPacketCblt@DXG_HOST_GLOBAL_VMBUS@@SAXPEAUVMBCHANNEL__@@PEAUVMBPACKETCOMPLETION__@@PEAXII@Z @ 0x1C0025E10
 * Callers:
        ...
        unsigned int a5)
{
  ...
  v9 = 1;
  v39 = 1;
  v11 = *(_QWORD *)(((__int64 (*)(void))qword_1C00B2098)() + 496);
  Next = 0;
  v37 = v11;
...
LABEL_25:
              ...
              (v21 = (PSLIST_ENTRY)v23(v25, v22, v24, (char *)Global + 112)) != 0LL) )
        {
          ...
          *((_QWORD *)&v21[1].Next + 1) = v21;
          if ( *(_BYTE *)(v37 + 299)
            && ((unsigned int)DXG_DEFERRED_WORK_QUEUE_DPC_CBLT::GetNumWorkItems((PKSPIN_LOCK)(v37 + 360))
