/*
 * XREFs of ?DisplayID_GetPreferredMode@@YAJPEBUDisplayIDObj@@PEAUDISPLAY_PREFERRED_MODE_INFO@@@Z @ 0x1C005F6F0
 * Callers:
 *     MonitorGetDpiInfoFromDescriptor @ 0x1C0140A9C (MonitorGetDpiInfoFromDescriptor.c)
 * Callees:
 *     ?DisplayID_GetFirstType7Desc@@YAJAEBUDisplayIDObj@@AEAPEAU_DISPLAYID_TYPE7_TIMING_BLOCK@@@Z @ 0x1C005F4A0 (-DisplayID_GetFirstType7Desc@@YAJAEBUDisplayIDObj@@AEAPEAU_DISPLAYID_TYPE7_TIMING_BLOCK@@@Z.c)
