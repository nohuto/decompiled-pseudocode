/*
 * XREFs of ?IsCurrentThreadAppContainer@DXGPROCESS@@SA_NXZ @ 0x1C028451C
 * Callers:
 ...
 * Callees:
 *     ?OpenCurrentThreadToken@DXGPROCESS@@SAJPEAPEAX@Z @ 0x1C0284610 (-OpenCurrentThreadToken@DXGPROCESS@@SAJPEAPEAX@Z.c)
 */
