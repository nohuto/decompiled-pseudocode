/*
 * XREFs of ?Acquire@DXGDEVICEACCESSLOCKSHARED@@QEAAXXZ @ 0x1C0024860
 * Callers:
 ...
 *     ?ReleasePowerTransitionLockShared@ADAPTER_RENDER@@QEAAXXZ @ 0x1C0024620 (-ReleasePowerTransitionLockShared@ADAPTER_RENDER@@QEAAXXZ.c)
