/*
 * XREFs of ?AddWaitToContext@CAdapter@@UEAAJII_K@Z @ 0x1C00638C0
 * Callers:
 *     <none>
 * Callees:
 *     memset @ 0x1C0027400 (memset.c)
 *     DxgkKernelModeWaitForSynchronizationObjectFromGpu @ 0x1C00E7F4C (DxgkKernelModeWaitForSynchronizationObjectFromGpu.c)
 */
