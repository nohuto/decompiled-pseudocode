/*
 * XREFs of McTemplateK0pqqqqqqq_EtwWriteTransfer @ 0x1C003EB44
 * Callers:
...
NTSTATUS McTemplateK0pqqqqqqq_EtwWriteTransfer(__int64 a1, const EVENT_DESCRIPTOR *a2, __int64 a3, ...)
{
  ...
  v18 = 4LL;
  v20 = 4LL;
  return McGenEventWrite_EtwWriteTransfer((REGHANDLE *)&DxgkControlGuid_Context, a2, a3, 9u, &v4);
}
