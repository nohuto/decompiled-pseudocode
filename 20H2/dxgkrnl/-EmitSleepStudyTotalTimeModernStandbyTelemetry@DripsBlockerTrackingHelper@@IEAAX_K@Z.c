/*
 * XREFs of ?EmitSleepStudyTotalTimeModernStandbyTelemetry@DripsBlockerTrackingHelper@@IEAAX_K@Z @ 0x1C02BF4CC
 * Callers:
        ...
        __int64 a2)
{
  ...
  {
    if ( tlgKeywordOn((__int64)&dword_1C00AFA90, 0x400000002000LL) )
    {
      ...
      tlgWriteTransfer_EtwWriteTransfer(
        (__int64)&dword_1C00AFA90,
        (unsigned __int8 *)dword_1C007F760,
        0LL,
        0LL,
        v10 + 8,
        &v18);
