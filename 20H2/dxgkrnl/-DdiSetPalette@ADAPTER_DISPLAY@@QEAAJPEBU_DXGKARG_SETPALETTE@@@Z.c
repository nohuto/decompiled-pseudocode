/*
 * XREFs of ?DdiSetPalette@ADAPTER_DISPLAY@@QEAAJPEBU_DXGKARG_SETPALETTE@@@Z @ 0x1C021CD60
 * Callers:
        ...
        __int64 a3)
{
  ...
  DXGETWPROFILER_BASE::PushProfilerEntry((__int64)&v28, 5017LL);
  ...
  v14 = (*(int (__fastcall **)(_QWORD, const struct _DXGKARG_SETPALETTE *))(*((_QWORD *)this + 2) + 456LL))(
  ...
  if ( (_DWORD)v14 )
  {
    v23 = WdLogNewEntry5_WdError(VidPnSourceId, v21);
    *(_QWORD *)(v23 + 24) = v14;
