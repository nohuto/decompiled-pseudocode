/*
 * XREFs of ?VmBusWaitForSyncObjectFromCpuCblt@DXG_HOST_VIRTUALGPU_VMBUS@@SAEPEAUDXGADAPTER_VMBUS_PACKET@@@Z @ 0x1C00D9940
 * Callers:
 *     <none>
 * Callees:
