/*
 * XREFs of ?AcquireBuffer@DXGSWAPCHAIN@@QEAAJPEAU_D3DKMT_ACQUIRESWAPCHAIN@@PEAI@Z @ 0x1C02A8B44
 * Callers:
 ...
 *     ?Remove@DXGFIXEDQUEUE@@QEAAJPEAI@Z @ 0x1C004AFFC (-Remove@DXGFIXEDQUEUE@@QEAAJPEAI@Z.c)
