/*
 * XREFs of ?SubmitPresent@DXGCONTEXT@@QEAAJPEBU_D3DKMT_PRESENT@@PEAPEAVDXGHWQUEUE@@IPEAPEAV1@PEAVDXGALLOCATION@@IIPEAU_DXGKARG_PRESENT@@PEAU_D3DKMT_PRESENT_RGNS@@PEAU_VIDMM_DMA_BUFFER@@PEAUVIDSCH_SUBMIT_DATA_BASE@@W4_D3DDDIFORMAT@@PEAVCOREDEVICEACCESS@@@Z @ 0x1C00FD790
 * Callers:
...
LABEL_23:
  ...
  if ( v231 )
  {
    ...
    *(_QWORD *)v125 = 0LL;
    ...
    if ( *((_DWORD *)DXGGLOBAL::GetGlobal(v127, v126) + 311) )
    {
      v130 = KeGetCurrentThread();
      if ( !v130 )
      {
        v151 = WdLogNewEntry5_WdAssertion(v129, v128);
        *(_QWORD *)(v151 + 24) = 507LL;
        WdLogEvent5_WdAssertion(v151);
      }
      v131 = PsGetCurrentProcessSessionId(v129, v128);
...
LABEL_25:
  ...
  v48 = 0;
  v49 = *(_DWORD *)(v17 + 2328);
  if ( (v49 >= 0x2000 || *(_BYTE *)(v17 + 2628)) && *(_DWORD *)(v17 + 1872) >= 0x5007u && v44 )
  {
    v48 = 1;
    if ( v43 )
    {
...
LABEL_94:
      ...
      if ( *((_DWORD *)DXGGLOBAL::GetGlobal((__int64)v87, v40) + 311) )
      {
        v90 = KeGetCurrentThread();
        if ( !v90 )
        {
          v211 = WdLogNewEntry5_WdAssertion(v89, v88);
          *(_QWORD *)(v211 + 24) = 507LL;
          WdLogEvent5_WdAssertion(v211);
        }
        v91 = PsGetCurrentProcessSessionId(v89, v88);
...
LABEL_93:
  ...
  if ( !(_DWORD)v51 || !v48 )
  {
    ...
    *(_DWORD *)((char *)a12 + v61) = *(_DWORD *)((_BYTE *)a12 + v61) & 0xFFFFFC00 | 1;
    if ( *((_BYTE *)a12 + 348) )
      v62 = (char *)a12 + *((_DWORD *)a12 + 145) * ((8 * *((_DWORD *)a12 + 146) + 199) & 0xFFFFFFF8) + 624;
    else
      v62 = (char *)a12 + 488;
    ...
    if ( v221 >= 0 )
    {
      ...
      v64 = v63[2];
      if ( *(int *)(v64 + 2328) >= 0x2000 || *(_BYTE *)(v64 + 2628) )
      {
        v65 = 0xFFFF;
        v224 = 0xFFFF;
        v232 = -1LL;
      ...
      if ( *((_BYTE *)a12 + 348) )
        *(_WORD *)((char *)a12 + *((_DWORD *)a12 + 145) * ((8 * *((_DWORD *)a12 + 146) + 199) & 0xFFFFFFF8) + 608) = v65;
      else
        *((_DWORD *)a12 + 135) ^= (*((_DWORD *)a12 + 135) ^ (v65 << 17)) & 0x3E0000;
      if ( *((_BYTE *)a12 + 348) )
        v66 = (char *)a12 + *((_DWORD *)a12 + 145) * ((8 * *((_DWORD *)a12 + 146) + 199) & 0xFFFFFFF8) + 616;
      else
        v66 = (char *)a12 + 504;
      *(_QWORD *)v66 = v232;
      v67 = *((_QWORD *)v58 + 5);
      if ( v67 && (*(_DWORD *)(v67 + 4) & 8) != 0 )
        ...
        v68 = 0LL;
      if ( *((_BYTE *)a12 + 348) )
        *(_QWORD *)((char *)a12 + *((_DWORD *)a12 + 145) * ((8 * *((_DWORD *)a12 + 146) + 199) & 0xFFFFFFF8) + 632) = v68;
      else
        *((_QWORD *)a12 + 70) = v68;
      v69 = *((_BYTE *)a12 + 348);
      v70 = 736LL;
      ...
      v71 = (char *)a12 + v70;
      if ( v69 )
        v72 = (char *)a12 + *((_DWORD *)a12 + 145) * ((8 * *((_DWORD *)a12 + 146) + 199) & 0xFFFFFFF8) + 600;
      else
        v72 = (char *)a12 + 496;
      *(_QWORD *)v72 = *(_QWORD *)(*((_QWORD *)v58 + 6) + 16LL);
      if ( !*(_BYTE *)(*(_QWORD *)(*(_QWORD *)(v14[2].Count + 16) + 16LL) + 2650LL) )
      {
        ...
        if ( *((_BYTE *)a12 + 348) )
          v73 = (char *)a12 + *((_DWORD *)a12 + 145) * ((8 * *((_DWORD *)a12 + 146) + 199) & 0xFFFFFFF8) + 592;
        else
          v73 = (char *)a12 + 552;
        *(_QWORD *)v73 = v72;
      }
      ...
      *((_DWORD *)v71 + 8) = 0;
      ...
      Ptr = 0LL;
      if ( (v81->Flags.Value & 1) != 0 || !*(_BYTE *)(*(_QWORD *)(*(_QWORD *)(v14[2].Count + 16) + 16LL) + 2650LL) )
        Ptr = v14[23].Ptr;
      ...
      {
        if ( *((_BYTE *)a12 + 348) )
          v208 = (char *)a12 + *((_DWORD *)a12 + 145) * ((8 * *((_DWORD *)a12 + 146) + 199) & 0xFFFFFFF8) + 624;
        else
          v208 = (char *)a12 + 488;
