/*
 * XREFs of DxgkSetStablePowerState @ 0x1C02861D0
 * Callers:
 *     <none>
 * Callees:
 ...
 *     ?AddStablePowerReference@ADAPTER_RENDER@@QEAAXXZ @ 0x1C021453C (-AddStablePowerReference@ADAPTER_RENDER@@QEAAXXZ.c)
...
LABEL_25:
  ...
  *((_QWORD *)v34 + 202) = KeGetCurrentThread();
  ...
  if ( HIDWORD(v59) )
  {
    if ( !v45 )
    {
      ADAPTER_RENDER::AddStablePowerReference(v25[338]);
      v45 = *(_DWORD *)(v33 + 28);
    }
    *(_DWORD *)(v33 + 28) = v45 + 1;
  }
  else if ( v45 )
  {
    ...
    *(_DWORD *)(v33 + 28) = v47;
    if ( !v47 )
      ADAPTER_RENDER::ReleaseStablePowerReference(v25[338]);
  }
  else
  {
