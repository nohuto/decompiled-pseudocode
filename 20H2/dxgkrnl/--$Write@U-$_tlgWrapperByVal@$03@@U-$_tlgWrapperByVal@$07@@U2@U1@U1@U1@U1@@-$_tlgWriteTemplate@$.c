/*
 * XREFs of ??$Write@U?$_tlgWrapperByVal@$03@@U?$_tlgWrapperByVal@$07@@U2@U1@U1@U1@U1@@?$_tlgWriteTemplate@$$A6AJPEBU_tlgProvider_t@@PEBXPEBU_GUID@@2IPEAU_EVENT_DATA_DESCRIPTOR@@@Z$1?_tlgWriteTransfer_EtwWriteTransfer@@YAJ0122I3@ZPEBU2@PEBU2@@@SAJPEBU_tlgProvider_t@@PEBXPEBU_GUID@@2AEBU?$_tlgWrapperByVal@$03@@AEBU?$_tlgWrapperByVal@$07@@43333@Z @ 0x1C00448A0
 * Callers:
        ...
        __int64 a11)
{
  ...
  v16 = 8LL;
  v14 = 4LL;
  return tlgWriteTransfer_EtwWriteTransfer((__int64)&dword_1C00AFA20, a2, 0LL, 0LL, 9u, &v12);
}
