/*
 * XREFs of ?InitializeAdapterObject@DXGADAPTERSYNCOBJECT@@QEAAJPEAVDXGSYNCOBJECT@@PEAVDXGDEVICE@@@Z @ 0x1C00DAE14
 * Callers:
 ...
 *     ??2@YAPEAX_KIW4DXGK_POOL_FLAGS@@@Z @ 0x1C00269AC (--2@YAPEAX_KIW4DXGK_POOL_FLAGS@@@Z.c)
        ...
        struct DXGDEVICE *a3)
{
  ...
  v18 = *((_DWORD *)a2 + 49);
  if ( !(unsigned int)Feature_WSL_Device_GPU__private_IsEnabled() || (v18 & 0x100) == 0 || !a3 )
    goto LABEL_31;
  v19 = *((_QWORD *)a3 + 5);
