/*
 * XREFs of ?ReleaseAnalogTokensAndGetUpdates@CTokenQueue@@QEAA_NIPEAUCSM_SURFACE_UPDATE@@IPEA_NPEAIPEAPEAVCToken@@@Z @ 0x1C0063260
 * Callers:
        ...
        struct CToken **a7)
{
  ...
  *v13 = this;
  ...
  while ( 1 )
  {
    ...
    LOBYTE(a5) = 0;
    if ( (*(int (__fastcall **)(_QWORD *, __int64, bool **))(*((_QWORD *)v12 - 1) + 184LL))((_QWORD *)v12 - 1, a2, &a5) < 0 )
    {
LABEL_10:
...
LABEL_19:
  if ( v7 )
  {
    ...
    v19 = 0;
    v20 = *(_QWORD *)v30[0];
    if ( *(_QWORD **)(v30[0] + 8LL) != v30 || *(_QWORD *)(v20 + 8) != v30[0] )
      goto LABEL_33;
    v30[0] = *(_QWORD *)v30[0];
    *(_QWORD *)(v20 + 8) = v30;
    if ( v18 != v30 )
      ...
      do
      {
        ...
        else
        {
          *((_DWORD *)a3 + 7) = (*(__int64 (__fastcall **)(const struct CToken *))(*(_QWORD *)v22 + 112LL))(v22);
          v19 = 1;
          v24 = *((_DWORD *)CFlipToken::FromToken(v22) + 26);
          Global = DXGGLOBAL::GetGlobal(v26, v25);
          (*(void (__fastcall **)(CompositionSurfaceObject *, _QWORD))(*((_QWORD *)Global + 38048) + 64LL))(v23, v24);
          *v21 = v22;
        }
        v18 = (_QWORD *)v30[0];
        if ( *(_QWORD **)(v30[0] + 8LL) != v30 )
