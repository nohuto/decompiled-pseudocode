/*
 * XREFs of DpiKsrGetSavedAdapterState @ 0x1C02D1974
 * Callers:
...
__int64 __fastcall DpiKsrGetSavedAdapterState(__int64 a1)
{
  ...
  *v2 = 0;
  ...
  if ( v9 )
  {
    ...
    if ( !*(_BYTE *)(v10 + 16) )
    {
      v12 = *(_DWORD *)(qword_1C00B1018 + 8);
      if ( v12 >= v9 )
      {
        v13 = WdLogNewEntry5_WdError(v10, qword_1C00B1018);
        *(_QWORD *)(v13 + 24) = -1073741823LL;
        WdLogEvent5_WdError(v13);
        return 3221225473LL;
      }
      *(_DWORD *)(qword_1C00B1018 + 8) = v12 + 1;
      *(_BYTE *)(v10 + 16) = 1;
    }
    *v4 = v10 + 24;
    *v5 = *(_DWORD *)(v10 + 20);
