/*
 * XREFs of MonitorGetMonitorOrientationsFromMonitor @ 0x1C01257DC
 * Callers:
 ...
 *     ?_GetMonitorOrientation@DXGMONITOR@@QEBAJPEAK0@Z @ 0x1C0009790 (-_GetMonitorOrientation@DXGMONITOR@@QEBAJPEAK0@Z.c)
 */
