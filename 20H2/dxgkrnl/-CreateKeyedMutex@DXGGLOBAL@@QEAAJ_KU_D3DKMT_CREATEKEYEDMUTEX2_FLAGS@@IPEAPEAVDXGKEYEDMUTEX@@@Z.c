/*
 * XREFs of ?CreateKeyedMutex@DXGGLOBAL@@QEAAJ_KU_D3DKMT_CREATEKEYEDMUTEX2_FLAGS@@IPEAPEAVDXGKEYEDMUTEX@@@Z @ 0x1C028EAA4
 * Callers:
 ...
 *     ??_GDXGKEYEDMUTEX@@QEAAPEAXI@Z @ 0x1C0048264 (--_GDXGKEYEDMUTEX@@QEAAPEAXI@Z.c)
