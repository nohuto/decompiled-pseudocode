/*
 * XREFs of ?DxgkCddOpenResource@@YAJPEAU_D3DKMT_OPENRESOURCE@@IPEAU_EPROCESS@@PEAIPEAPEAXPEA_K@Z @ 0x1C022B880
 * Callers:
 *     <none>
 * Callees:
 ...
 *     ?GdiNodeSupportsGpuVa@ADAPTER_RENDER@@QEBAEXZ @ 0x1C003EC1C (-GdiNodeSupportsGpuVa@ADAPTER_RENDER@@QEBAEXZ.c)
