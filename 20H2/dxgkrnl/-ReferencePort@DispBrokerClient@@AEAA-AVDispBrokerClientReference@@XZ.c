/*
 * XREFs of ?ReferencePort@DispBrokerClient@@AEAA?AVDispBrokerClientReference@@XZ @ 0x1C016075C
 * Callers:
 ...
 *     ?IsClientHandleValid@DispBrokerClient@@AEAA_NXZ @ 0x1C01607D4 (-IsClientHandleValid@DispBrokerClient@@AEAA_NXZ.c)
 */
