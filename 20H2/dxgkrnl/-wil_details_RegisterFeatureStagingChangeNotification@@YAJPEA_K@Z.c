/*
 * XREFs of ?wil_details_RegisterFeatureStagingChangeNotification@@YAJPEA_K@Z @ 0x1C00DA1FC
 * Callers:
        ...
        unsigned __int64 *a1)
{
  ...
  for ( i = (unsigned __int64 *)&wil_details_featureDescriptors_a; ; i = (unsigned __int64 *)((char *)result + 32) )
  {
