/*
 * XREFs of ?TdrCreateRecoveryContext@@YAPEAU_TDR_RECOVERY_CONTEXT@@XZ @ 0x1C0264620
 * Callers:
 ...
 *     ?TdrReferenceRecoveryContext@@YAPEAU_TDR_RECOVERY_CONTEXT@@PEAU1@@Z @ 0x1C0264C48 (-TdrReferenceRecoveryContext@@YAPEAU_TDR_RECOVERY_CONTEXT@@PEAU1@@Z.c)
 */
...
struct _TDR_RECOVERY_CONTEXT *TdrCreateRecoveryContext(void)
{
  ...
  if ( Pool )
  {
    ...
    *((_DWORD *)Pool + 695) = dword_1C00B1164;
    *((_DWORD *)Pool + 696) = dword_1C00B1170;
