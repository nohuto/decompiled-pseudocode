/*
 * XREFs of ??ROBTAIN_MODES_ON_SOURCE@@QEBAJPEAPEAU_D3DKMT_DISPLAYMODE@@PEAI01@Z @ 0x1C011C600
 * Callers:
 ...
 *     ?GetDisplayOnlyDriverUseRawModes@ADAPTER_DISPLAY@@QEBAHXZ @ 0x1C0042DB8 (-GetDisplayOnlyDriverUseRawModes@ADAPTER_DISPLAY@@QEBAHXZ.c)
 *     ?AddUniqueMode@MODE_UNION_LIST@@QEAAJAEBU_D3DKMT_DISPLAYMODE@@@Z @ 0x1C00DC0BC (-AddUniqueMode@MODE_UNION_LIST@@QEAAJAEBU_D3DKMT_DISPLAYMODE@@@Z.c)
 ...
 *     _CompareDisplayMode @ 0x1C011D6DC (_CompareDisplayMode.c)
 ...
 *     _UpgradeDispModeFlags @ 0x1C025D22C (_UpgradeDispModeFlags.c)
 */
...
LABEL_166:
                      ...
                      v94 = *((_QWORD *)v229 + 338) || !*(_BYTE *)(*((_QWORD *)v229 + 337) + 249LL) || v89 == 1;
