/*
 * XREFs of DpiMiracastInterfaceChange @ 0x1C00526F0
 * Callers:
 *     <none>
 * Callees:
...
LABEL_48:
          ...
          *(_WORD *)(v15 + 332) = 0;
          ...
          v45 = qword_1C00B0F18;
          v61 = 1;
          while ( (__int64 *)v45 != &qword_1C00B0F18 )
          {
          ...
          if ( v47 < 0 )
            goto LABEL_13;
          KeAcquireInStackQueuedSpinLock(&SpinLock, &LockHandle);
          v48 = (__int64 *)qword_1C00B0F20;
          if ( *(__int64 **)qword_1C00B0F20 != &qword_1C00B0F18 )
            goto LABEL_74;
          *(_QWORD *)v15 = &qword_1C00B0F18;
          *(_QWORD *)(v15 + 8) = v48;
          *v48 = v15;
          qword_1C00B0F20 = v15;
          v60 = 1;
