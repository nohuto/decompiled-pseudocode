/*
 * XREFs of ?CompleteFlipManagerToken@CTokenManager@@IEAAJPEAXPEA_N@Z @ 0x1C0062A70
 * Callers:
...
__int64 __fastcall CTokenManager::CompleteFlipManagerToken(CTokenManager *this, void *a2, bool *a3)
{
  ...
  *a3 = 1;
  ...
  if ( v6 >= 0 )
  {
    ...
    (*(void (__fastcall **)(PVOID))(*((_QWORD *)Global + 38048) + 72LL))(Object);
    ...
    (*(void (__fastcall **)(PVOID))(*((_QWORD *)v15 + 38048) + 80LL))(Object);
  }
  ObCloseHandle(a2, 1);
