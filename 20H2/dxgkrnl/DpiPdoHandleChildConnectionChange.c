/*
 * XREFs of DpiPdoHandleChildConnectionChange @ 0x1C0174078
 * Callers:
 ...
 *     DpiPdoSetMonitorDriverInterfaceState @ 0x1C02D86E0 (DpiPdoSetMonitorDriverInterfaceState.c)
...
LABEL_32:
    ...
    if ( v12 )
    {
      PhysicalMonitor = MonitorCreatePhysicalMonitor(v33, a2, v12, (__int64)a9);
      v22 = PhysicalMonitor;
