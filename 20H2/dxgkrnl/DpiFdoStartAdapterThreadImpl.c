/*
 * XREFs of DpiFdoStartAdapterThreadImpl @ 0x1C01826A0
 * Callers:
 ...
 *     wcsncmp_0 @ 0x1C0024445 (wcsncmp_0.c)
 *     _guard_dispatch_icall_nop @ 0x1C0027100 (_guard_dispatch_icall_nop.c)
 *     memset @ 0x1C0027400 (memset.c)
 *     ?Free@?$AUTO_FREE_POOL@PEAUIDD_COMPLETION_CONTEXT@@@@QEAAXXZ @ 0x1C0051BF8 (-Free@-$AUTO_FREE_POOL@PEAUIDD_COMPLETION_CONTEXT@@@@QEAAXXZ.c)
...
__int64 __fastcall DpiFdoStartAdapterThreadImpl(int *a1, char a2, _BYTE *a3)
{
  ...
  unsigned int Timeouta; // [rsp+20h] [rbp-188h]
...
LABEL_4:
  ...
  if ( v10 )
  {
    _InterlockedCompareExchange(&dword_1C00B0E68, 5, 4);
    LOBYTE(v11) = 1;
  ...
  {
    byte_1C00B0B5A = 1;
    DpiAcquirePostDisplayInfoFromBgfx((__int64)&xmmword_1C00B0DC8, 1, 1);
    dword_1C00B0EB4 = 1;
    if ( qword_1C00B0DC0 )
      (*(void (__fastcall **)(_QWORD, __int128 *))(*(_QWORD *)(qword_1C00B0DC0 + 64) + 976LL))(
        *(_QWORD *)(*(_QWORD *)(qword_1C00B0DC0 + 64) + 48LL),
        &xmmword_1C00B0DC8);
    dword_1C00B0E68 = 1;
    goto LABEL_14;
  }
  if ( v10 )
  {
    if ( (unsigned int)(dword_1C00B0E68 - 4) <= 1 )
                    ...
                    && (!v55 || v22) )
                  {
                    if ( !*(_BYTE *)(v21 + 481) || v60 )
                    {
                      ...
                      if ( v26 != 1075708986 )
                      {
                        ...
                        {
                          v27 = (v72 & 1) != 0 || (_BYTE)word_1C00B0B1D && (v72 & 0x40) != 0;
                          v57 |= v27;
...
LABEL_45:
      ...
      while ( *(_QWORD *)v19 != qword_1C00B0B40 );
    }
    v61 = ++v17;
  }
  while ( v17 < 2 );
  if ( v62 && (unsigned int)(dword_1C00B0E68 - 1) <= 1 )
  ...
  if ( v56 )
  {
    ...
    if ( *(_QWORD *)v29 != v29 )
    {
      ...
      while ( *(_QWORD *)v29 != qword_1C00B0B40 );
    }
  }
