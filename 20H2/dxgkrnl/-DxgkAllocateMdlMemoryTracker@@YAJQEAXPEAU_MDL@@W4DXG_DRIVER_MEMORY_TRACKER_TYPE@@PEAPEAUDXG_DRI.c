/*
 * XREFs of ?DxgkAllocateMdlMemoryTracker@@YAJQEAXPEAU_MDL@@W4DXG_DRIVER_MEMORY_TRACKER_TYPE@@PEAPEAUDXG_DRIVER_MEMORY_TRACKER@@@Z @ 0x1C0041648
 * Callers:
 *     DxgkAllocatePagesForMdlCB @ 0x1C0041C10 (DxgkAllocatePagesForMdlCB.c)
 *     DxgkMapMdlToIoMmuCB @ 0x1C00420F0 (DxgkMapMdlToIoMmuCB.c)
 * Callees:
