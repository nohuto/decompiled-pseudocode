/*
 * XREFs of _BmlGetPathModeListForPath @ 0x1C02EB530
 * Callers:
 ...
 *     ?GetBitsPerPixel@DMMVIDPNSOURCEMODE@@QEBAIXZ @ 0x1C005B194 (-GetBitsPerPixel@DMMVIDPNSOURCEMODE@@QEBAIXZ.c)
 ...
 *     BmlIsSecondaryClonePath @ 0x1C01348AC (BmlIsSecondaryClonePath.c)
 *     BmlGetModeCategoryForRegion @ 0x1C0134A74 (BmlGetModeCategoryForRegion.c)
 *     BmlDoesSourceModeObeyConstraint @ 0x1C0134E18 (BmlDoesSourceModeObeyConstraint.c)
 *     BmlAreRawModesEnabled @ 0x1C0136C58 (BmlAreRawModesEnabled.c)
