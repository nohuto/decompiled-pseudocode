/*
 * XREFs of DpiMiracastSendAsyncUserModeRequest @ 0x1C02CD678
 * Callers:
...
LABEL_34:
  if ( (Microsoft_Windows_DxgKrnlEnableBits & 0x20000000) != 0 )
  {
    ...
    LODWORD(v40) = Size;
    LODWORD(v39) = 0;
    McTemplateK0pqtqq_EtwWriteTransfer(v17, &EventLeaveMiracastSendUserModeRequest, v18, a1[12], v39, v40, v41, v42);
  }
  return v19;
}
