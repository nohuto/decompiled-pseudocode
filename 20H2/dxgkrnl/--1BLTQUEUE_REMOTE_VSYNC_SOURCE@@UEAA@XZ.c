/*
 * XREFs of ??1BLTQUEUE_REMOTE_VSYNC_SOURCE@@UEAA@XZ @ 0x1C02FF534
 * Callers:
 *     ??_EBLTQUEUE_REMOTE_VSYNC_SOURCE@@UEAAPEAXI@Z @ 0x1C005E960 (--_EBLTQUEUE_REMOTE_VSYNC_SOURCE@@UEAAPEAXI@Z.c)
 * Callees:
