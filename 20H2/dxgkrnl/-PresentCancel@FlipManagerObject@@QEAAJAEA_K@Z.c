/*
 * XREFs of ?PresentCancel@FlipManagerObject@@QEAAJAEA_K@Z @ 0x1C00679A8
 * Callers:
 ...
 *     ?PresentCancel@CFlipManager@@QEAAJAEA_K@Z @ 0x1C006AA70 (-PresentCancel@CFlipManager@@QEAAJAEA_K@Z.c)
 */
