/*
 * XREFs of DpWriteSpbResource @ 0x1C02D6220
 * Callers:
 *     <none>
 * Callees:
 *     DpiValidateSpbResource @ 0x1C02D6578 (DpiValidateSpbResource.c)
 */
        ...
        PIO_STATUS_BLOCK a7)
{
  ...
  if ( (int)result >= 0 )
  {
    ...
    if ( !Ptr )
      Ptr = v20[7].Ptr;
    LODWORD(Ptr) = ZwWriteFile(v20[5].Ptr, Ptr, 0LL, 0LL, IoStatusBlock, a4, Length, ByteOffset, 0LL);
    if ( (_DWORD)Ptr == 259 )
    {
      if ( v10 )
        goto LABEL_17;
