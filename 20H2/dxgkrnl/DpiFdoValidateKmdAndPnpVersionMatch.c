/*
 * XREFs of DpiFdoValidateKmdAndPnpVersionMatch @ 0x1C0181054
 * Callers:
 *     DpiFdoInitializeFdo @ 0x1C017FE94 (DpiFdoInitializeFdo.c)
 * Callees:
 *     _tlgKeywordOn @ 0x1C000AE58 (_tlgKeywordOn.c)
 *     ?RtlUnicodeStringCchCopyStringN@@YAJPEAU_UNICODE_STRING@@PEBG_K@Z @ 0x1C00216E0 (-RtlUnicodeStringCchCopyStringN@@YAJPEAU_UNICODE_STRING@@PEBG_K@Z.c)
 ...
 *     IsKnownMismatchedVersionedDriver @ 0x1C02C7150 (IsKnownMismatchedVersionedDriver.c)
 */
...
LABEL_59:
        ...
        while ( 1 )
        {
          ...
          if ( v23 > 3 )
          {
            ...
            {
              if ( (unsigned int)dword_1C00AFA90 > 5 && tlgKeywordOn((__int64)&dword_1C00AFA90, 0x400000000100LL) )
              {
                v45 = *(_DWORD *)(a1 + 1140);
                v46 = *(_DWORD *)(a1 + 1136);
                v47 = *(_DWORD *)(a1 + 1132);
