/*
 * XREFs of McTemplateK0pqqqqqqqqqqqqqqqq_EtwWriteTransfer @ 0x1C005BEE4
 * Callers:
...
NTSTATUS McTemplateK0pqqqqqqqqqqqqqqqq_EtwWriteTransfer(__int64 a1, __int64 a2, __int64 a3, ...)
{
  ...
  v36 = 4LL;
  v38 = 4LL;
  return McGenEventWrite_EtwWriteTransfer((REGHANDLE *)&DxgkControlGuid_Context, &SetTimingsFromVidPn, a3, 0x12u, &v4);
}
