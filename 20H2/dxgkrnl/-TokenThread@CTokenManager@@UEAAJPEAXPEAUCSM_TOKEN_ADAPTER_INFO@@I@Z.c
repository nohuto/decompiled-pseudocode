/*
 * XREFs of ?TokenThread@CTokenManager@@UEAAJPEAXPEAUCSM_TOKEN_ADAPTER_INFO@@I@Z @ 0x1C00196F0
 * Callers:
 *     <none>
 * Callees:
 ...
 *     ?ValidateUserEvent@CTokenManager@@CAJPEAXPEAPEAX@Z @ 0x1C00197BC (-ValidateUserEvent@CTokenManager@@CAJPEAXPEAPEAX@Z.c)
