/*
 * XREFs of ?CheckVisRgn@DXGPRESENT@@QEAAJPEBU_D3DKMT_PRESENT@@PEAUHDC__@@PEAUHDEV__@@PEBVDXGDEVICE@@IIW4_D3DDDIFORMAT@@H@Z @ 0x1C016A6D0
 * Callers:
 ...
 *     ?DmmIsTargetNonStandard@@YA_NPEAVDXGADAPTER@@I@Z @ 0x1C0143F94 (-DmmIsTargetNonStandard@@YA_NPEAVDXGADAPTER@@I@Z.c)
 ...
 *     ?AllowLegacyPresent@DXGDEVICE@@QEBAEI@Z @ 0x1C027D438 (-AllowLegacyPresent@DXGDEVICE@@QEBAEI@Z.c)
 *     ?ComputeSrcDstRects@DXGPRESENT@@QEAAHPEBU_D3DKMT_PRESENT@@II@Z @ 0x1C027E89C (-ComputeSrcDstRects@DXGPRESENT@@QEAAHPEBU_D3DKMT_PRESENT@@II@Z.c)
 */
...
LABEL_8:
        ...
        if ( (!v15 || !v22 && ADAPTER_DISPLAY::IsInVirtualMode(*(ADAPTER_DISPLAY **)(v15 + 2696), a2->VidPnSourceId))
...
LABEL_133:
              ...
              {
                v98 = (unsigned int *)(*(_QWORD *)(*(_QWORD *)(v15 + 2696) + 112LL) + 3968LL * a2->VidPnSourceId);
              ...
              if ( v55 )
              {
                ...
                *((_DWORD *)this + 1) = v61;
                if ( (v61 & 0x10) != 0
                  ...
                  && ADAPTER_DISPLAY::IsVidPnSourceOwner(*(DXGADAPTER ***)(v15 + 2696), a5, a2->VidPnSourceId)
...
LABEL_137:
            ...
            if ( (*(unsigned int (__fastcall **)(HDC))(v16 + 56))(a3)
              && (!v15 || !ADAPTER_DISPLAY::IsVidPnSourceOwner(*(ADAPTER_DISPLAY **)(v15 + 2696), a5)) )
            {
              *((_DWORD *)this + 1) |= 0x10u;
              *((_QWORD *)this + 6) = a2->hWindow;
              return 0LL;
...
LABEL_122:
              ...
              if ( (*((_DWORD *)a5 + 108) || ADAPTER_DISPLAY::HasAnyVidPnSourceOwner(*(DXGADAPTER ***)(v111 + 2696)))
...
LABEL_43:
    ...
    else
    {
      if ( !v15 || v15 != *((_QWORD *)a5 + 231) )
      {
        ...
        *(_QWORD *)(v77 + 24) = 10438LL;
        WdLogEvent5_WdAssertion(v77);
      }
      v27 = 3968LL * a2->VidPnSourceId;
      v28 = (_DWORD *)((char *)this + 24);
      *(_OWORD *)((char *)this + 24) = *(_OWORD *)(v27 + *(_QWORD *)(*(_QWORD *)(v15 + 2696) + 112LL) + 628);
    }
    *((_QWORD *)this + 5) = 0LL;
    goto LABEL_8;
  }
