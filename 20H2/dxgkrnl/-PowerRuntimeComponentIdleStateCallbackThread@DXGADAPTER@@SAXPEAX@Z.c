/*
 * XREFs of ?PowerRuntimeComponentIdleStateCallbackThread@DXGADAPTER@@SAXPEAX@Z @ 0x1C020D230
 * Callers:
 *     <none>
 * Callees:
...
{
  DXGADAPTER::PowerRuntimeComponentIdleStateCallback_Thread(StartContext);
}
