/*
 * XREFs of ?Release@CCompositionFrame@@UEAAJXZ @ 0x1C0012DA0
 * Callers:
 *     <none>
 * Callees:
 *     ?ReturnLegacyTokenBuffer@CCompositionFrame@@IEAAXXZ @ 0x1C0013004 (-ReturnLegacyTokenBuffer@CCompositionFrame@@IEAAXXZ.c)
