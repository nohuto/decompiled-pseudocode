/*
 * XREFs of ?DiscardPendingPresent@BLTQUEUE@@AEAAXXZ @ 0x1C02FC310
 * Callers:
 ...
 *     ?AssignNull@DXGALLOCATIONREFERENCE@@QEAAXXZ @ 0x1C0226670 (-AssignNull@DXGALLOCATIONREFERENCE@@QEAAXXZ.c)
 ...
 *     ?ReleasePresentDoneEvent@BLTENTRY@@QEAAXE@Z @ 0x1C02FDE90 (-ReleasePresentDoneEvent@BLTENTRY@@QEAAXE@Z.c)
 */
