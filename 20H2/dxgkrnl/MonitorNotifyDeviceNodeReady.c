/*
 * XREFs of MonitorNotifyDeviceNodeReady @ 0x1C0189D90
 * Callers:
 ...
 *     ?_GetAttachedPhysicalMonitor@DXGMONITOR@@QEAAPEAV1@XZ @ 0x1C005CFB8 (-_GetAttachedPhysicalMonitor@DXGMONITOR@@QEAAPEAV1@XZ.c)
