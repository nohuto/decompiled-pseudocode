/*
 * XREFs of DpiPdoPollingWorkItem @ 0x1C02D7FE0
 * Callers:
 ...
 *     DpiFdoPendingCreatePdoCompletion @ 0x1C02C6E5C (DpiFdoPendingCreatePdoCompletion.c)
...
void __fastcall DpiPdoPollingWorkItem(PDEVICE_OBJECT DeviceObject, PVOID Context)
{
  ...
  while ( 1 )
  {
    ...
    {
      v4 = 0LL;
      _InterlockedExchange(&dword_1C00B0D98, 0);
    }
    else
    {
...
LABEL_21:
    ...
    ExFreeToNPagedLookasideList(&stru_1C00B0C00, v4);
    if ( v3 == 259 )
    {
      _InterlockedExchange(&dword_1C00B0D98, 0);
