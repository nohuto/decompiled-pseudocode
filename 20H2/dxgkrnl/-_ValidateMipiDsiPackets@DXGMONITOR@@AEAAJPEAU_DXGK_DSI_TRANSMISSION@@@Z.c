/*
 * XREFs of ?_ValidateMipiDsiPackets@DXGMONITOR@@AEAAJPEAU_DXGK_DSI_TRANSMISSION@@@Z @ 0x1C02FADA0
 * Callers:
 *     ?_DsiTransmission@DXGMONITOR@@AEAAJKPEAXK0PEA_K@Z @ 0x1C02FA790 (-_DsiTransmission@DXGMONITOR@@AEAAJKPEAXK0PEA_K@Z.c)
 * Callees:
 *     ?_IsValidPacket@DXGMONITOR@@AEAAEPEAU_DXGK_DSI_PACKET@@EI@Z @ 0x1C02FAB20 (-_IsValidPacket@DXGMONITOR@@AEAAEPEAU_DXGK_DSI_PACKET@@EI@Z.c)
 */
