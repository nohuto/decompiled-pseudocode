/*
 * XREFs of ?FindBlockListStrings@@YAJPEAGIIPEBGW4_QAI_DRIVERVERSION@@PEAIPEAU_UNICODE_STRING@@@Z @ 0x1C017C1C4
 * Callers:
 ...
 *     wcscmp_0 @ 0x1C00270D8 (wcscmp_0.c)
...
LABEL_44:
                      if ( (v39 || v48)
                        ...
                        && tlgKeywordOn((__int64)&dword_1C00AFA90, 0x400000000200LL) )
                      {
                      ...
                      if ( v59[0] != (_BYTE)v20 && (unsigned int)dword_1C00AFA90 > 5 )
                      {
                        if ( tlgKeywordOn((__int64)&dword_1C00AFA90, 0x400000001000LL) )
                        {
                          v64 = a5;
                          v73 = v71;
