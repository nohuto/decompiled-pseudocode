/*
 * XREFs of DpiMiracastGetDeviceContextFromName @ 0x1C02CCE5C
 * Callers:
...
__int64 __fastcall DpiMiracastGetDeviceContextFromName(PCWSTR SourceString)
{
  ...
  v1 = qword_1C00B0F18;
  if ( (__int64 *)qword_1C00B0F18 == &qword_1C00B0F18 )
    goto LABEL_6;
  do
  {
    v2 = v1;
  ...
  while ( (__int64 *)v1 != &qword_1C00B0F18 );
  if ( (__int64 *)v1 == &qword_1C00B0F18 )
LABEL_6:
    v2 = 0LL;
  else
