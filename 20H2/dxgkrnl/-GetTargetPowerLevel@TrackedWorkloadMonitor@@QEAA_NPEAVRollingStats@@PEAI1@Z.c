/*
 * XREFs of ?GetTargetPowerLevel@TrackedWorkloadMonitor@@QEAA_NPEAVRollingStats@@PEAI1@Z @ 0x1C006E0A8
 * Callers:
 ...
 *     ?Update@RollingStats@@IEAAXXZ @ 0x1C006E470 (-Update@RollingStats@@IEAAXXZ.c)
 */
