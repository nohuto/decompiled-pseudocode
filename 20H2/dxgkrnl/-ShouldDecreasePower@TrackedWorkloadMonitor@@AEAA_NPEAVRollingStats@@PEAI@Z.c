/*
 * XREFs of ?ShouldDecreasePower@TrackedWorkloadMonitor@@AEAA_NPEAVRollingStats@@PEAI@Z @ 0x1C006E2F0
 * Callers:
 ...
 * Callees:
 *     ?GetPowerLevel@TrackedWorkloadMonitor@@AEAAINNI@Z @ 0x1C006DF90 (-GetPowerLevel@TrackedWorkloadMonitor@@AEAAINNI@Z.c)
