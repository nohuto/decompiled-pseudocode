/*
 * XREFs of IoMmuUnmapStagingMdlInternal @ 0x1C0056514
 * Callers:
 ...
 *     IoMmuReferenceMdl @ 0x1C0056314 (IoMmuReferenceMdl.c)
 */
  ...
  do
  {
    ...
    if ( v9 )
    {
      ...
      *(_WORD *)(v10 + 8) = 8 * ((v11 >> 12) + 6);
      if ( (int)((__int64 (__fastcall *)(_QWORD, _QWORD))qword_1C00B1078)(*(_QWORD *)(a1 + 8), *(_QWORD *)(a1 + 48)) < 0 )
      {
