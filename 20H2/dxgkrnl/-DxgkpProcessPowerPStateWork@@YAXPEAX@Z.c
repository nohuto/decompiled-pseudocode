/*
 * XREFs of ?DxgkpProcessPowerPStateWork@@YAXPEAX@Z @ 0x1C0220970
 * Callers:
 *     <none>
 * Callees:
 ...
 *     ?ProcessPStateTransitionRequest@DXGADAPTER@@QEAAXXZ @ 0x1C0037B28 (-ProcessPStateTransitionRequest@DXGADAPTER@@QEAAXXZ.c)
 */
