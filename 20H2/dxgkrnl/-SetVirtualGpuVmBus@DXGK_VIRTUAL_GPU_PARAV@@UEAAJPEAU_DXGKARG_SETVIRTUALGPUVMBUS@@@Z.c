/*
 * XREFs of ?SetVirtualGpuVmBus@DXGK_VIRTUAL_GPU_PARAV@@UEAAJPEAU_DXGKARG_SETVIRTUALGPUVMBUS@@@Z @ 0x1C0234E80
 * Callers:
 *     <none>
 * Callees:
        ...
        struct _DXGKARG_SETVIRTUALGPUVMBUS *a2)
{
  ...
  if ( (int)v7 >= 0 )
  {
    ...
    if ( g_VgpuDisableVaBackedVm
      || (v14 = ((__int64 (__fastcall *)(__int64, struct _EPROCESS **))qword_1C00B22E8)(v13, &v50), v15 = v50, v14 < 0) )
    {
      v15 = 0LL;
    }
    v16 = 0LL;
