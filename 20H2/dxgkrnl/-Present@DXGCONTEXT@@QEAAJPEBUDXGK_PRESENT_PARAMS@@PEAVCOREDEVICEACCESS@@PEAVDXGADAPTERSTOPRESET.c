/*
 * XREFs of ?Present@DXGCONTEXT@@QEAAJPEBUDXGK_PRESENT_PARAMS@@PEAVCOREDEVICEACCESS@@PEAVDXGADAPTERSTOPRESETLOCKSHARED@@PEAVCWin32kLocks@@PEAPEAV1@PEAUVIDSCH_SUBMIT_DATA_BASE@@@Z @ 0x1C00FC160
 * Callers:
 ...
 *     ?IsFullWDDMDevice@DXGDEVICE@@QEBA?BEI@Z @ 0x1C0007288 (-IsFullWDDMDevice@DXGDEVICE@@QEBA-BEI@Z.c)
 *     ?IsDisplayOnlyAdapter@DXGADAPTER@@QEBAEXZ @ 0x1C00079FC (-IsDisplayOnlyAdapter@DXGADAPTER@@QEBAEXZ.c)
 ...
 *     ??0DXGPRESENTMUTEX@@QEAA@QEAVADAPTER_RENDER@@@Z @ 0x1C0016BD8 (--0DXGPRESENTMUTEX@@QEAA@QEAVADAPTER_RENDER@@@Z.c)
 ...
 *     ?GetWin32kInterface@DXGPROCESS@@QEBAQEBU_DXGKWIN32KENG_INTERFACE@@XZ @ 0x1C001737C (-GetWin32kInterface@DXGPROCESS@@QEBAQEBU_DXGKWIN32KENG_INTERFACE@@XZ.c)
 *     ?ClearDisplayedAllMultiPlaneOverlaysUnsafe@DXGDEVICE@@QEAAXI@Z @ 0x1C001A824 (-ClearDisplayedAllMultiPlaneOverlaysUnsafe@DXGDEVICE@@QEAAXI@Z.c)
 ...
 *     ?hDestDc@CWin32kLocks@@QEBAPEAUHDC__@@XZ @ 0x1C0047314 (-hDestDc@CWin32kLocks@@QEBAPEAUHDC__@@XZ.c)
 ...
 *     ?ValidatePresentRegions@DXGCONTEXT@@AEBAJPEBU_D3DKMT_PRESENT@@II@Z @ 0x1C01546E4 (-ValidatePresentRegions@DXGCONTEXT@@AEBAJPEBU_D3DKMT_PRESENT@@II@Z.c)
 ...
 *     ?GetDdiSubRectCnt@DXGPRESENT@@QEBAII@Z @ 0x1C016BF18 (-GetDdiSubRectCnt@DXGPRESENT@@QEBAII@Z.c)
 *     ?GetDdiSubRectList@DXGPRESENT@@QEBAPEAUtagRECT@@I@Z @ 0x1C016BF38 (-GetDdiSubRectList@DXGPRESENT@@QEBAPEAUtagRECT@@I@Z.c)
 *     ?CheckOutput@DXGPRESENT@@QEAAXII@Z @ 0x1C016BF58 (-CheckOutput@DXGPRESENT@@QEAAXII@Z.c)
 ...
 *     ?RemoveAlphaChannel@@YA?AW4_D3DDDIFORMAT@@W41@@Z @ 0x1C02808A0 (-RemoveAlphaChannel@@YA-AW4_D3DDDIFORMAT@@W41@@Z.c)
                        ...
                        if ( (int)v142 >= 0 )
                        {
                          ...
                          else
                          {
                            ...
                            *(_QWORD *)&v509.Flags.0 = &v514[4];
                            v509.hAllocation = 1;
                            DXGDEVICE::Unlock(v427, (const struct _D3DKMT_UNLOCK *)&v509, 0LL);
                          }
...
LABEL_342:
    ...
    if ( (a2->Flags.Value & 0x60000) == 0x60000 )
    {
      ...
      *(_QWORD *)(v263 + 24) = 4266LL;
      goto LABEL_341;
    }
    if ( ((unsigned __int16)v35 & 0x1000) == 0 )
    {
      v263 = WdLogNewEntry5_WdError(v45, v35);
      *(_QWORD *)(v263 + 24) = 4272LL;
      goto LABEL_341;
    }
