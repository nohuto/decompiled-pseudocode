/*
 * XREFs of ?VmBusSendSubmitCommandToHwQueue@DXG_GUEST_VIRTUALGPU_VMBUS@@QEAAJPEAVDXGPROCESS@@PEBU_D3DKMT_SUBMITCOMMANDTOHWQUEUE@@@Z @ 0x1C024B9DC
 * Callers:
...
LABEL_33:
        ...
        if ( (unsigned int)v34 < *((_DWORD *)a2 + 64) )
        {
          ...
          if ( (_BYTE)Count_low == (*(_BYTE *)(v35 + 16 * v34 + 8) & 0x60) && (v25 & 0x2000) == 0 && (v25 & 0x1F) != 0 )
          {
            ...
            {
              v36 = WdLogNewEntry5_WdError(v25, Count_low);
              *(_QWORD *)(v36 + 24) = 267LL;
