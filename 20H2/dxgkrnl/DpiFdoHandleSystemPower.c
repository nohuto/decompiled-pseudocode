/*
 * XREFs of DpiFdoHandleSystemPower @ 0x1C0170EEC
 * Callers:
 ...
 *     DpiCorrectPowerAction @ 0x1C001FAE8 (DpiCorrectPowerAction.c)
...
LABEL_34:
    ...
    if ( !DeviceExtension[1158] )
    {
      if ( DeviceExtension[480] )
      {
        ...
        {
          v37 = *(_DWORD *)(v6 + 32);
          if ( !DeviceExtension[1154] || (v29 = 1, (unsigned int)(dword_1C00B0E68 - 4) > 1) )
            v29 = 0;
          if ( v28.SystemState == PowerSystemWorking )
            v37 = DpiCorrectPowerAction((__int64)DeviceObject, v27, *(_DWORD *)(v6 + 32));
          if ( v29 && v28.SystemState < *((_DWORD *)DeviceExtension + 71) && byte_1C00B0E88 )
          {
            LOBYTE(v27) = 1;
            DpiAcquirePostDisplayInfoFromBgfx(&xmmword_1C00B0DC8, v27, 0LL);
            byte_1C00B0E88 = 0;
            dword_1C00B0EB4 = 1;
            qword_1C00B0E70 = (__int64)KeGetCurrentThread();
            qword_1C00B0E78 = (__int64)DeviceObject;
          }
  ...
  if ( *(_DWORD *)(v6 + 24) != 6 || v17 || !HIBYTE(word_1C00B1010) )
    goto LABEL_4;
  ...
  if ( v18 == -1073741637 )
    goto LABEL_8;
  if ( (unsigned int)(dword_1C00B0E68 - 1) <= 1 )
