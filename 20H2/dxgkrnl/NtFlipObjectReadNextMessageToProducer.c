/*
 * XREFs of NtFlipObjectReadNextMessageToProducer @ 0x1C0068DB0
 * Callers:
 *     <none>
 * Callees:
 ...
 *     ?ResolveHandle@FlipManagerObject@@KAJPEAXKDPEAPEAU1@@Z @ 0x1C0069978 (-ResolveHandle@FlipManagerObject@@KAJPEAXKDPEAPEAU1@@Z.c)
 */
