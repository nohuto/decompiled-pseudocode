/*
 * XREFs of ?_SetColorSpaceTransform@DXGMONITOR@@AEAAJKPEAX@Z @ 0x1C013845C
 * Callers:
...
__int64 __fastcall DXGMONITOR::_SetColorSpaceTransform(DXGMONITOR *this, __int64 a2, int *a3)
{
  ...
  struct _D3DKMDT_GAMMA_RAMP v58; // [rsp+40h] [rbp-38h] BYREF
  enum _D3DDDI_GAMMARAMP_TYPE v59; // [rsp+80h] [rbp+8h] BYREF
  ReferenceCounted *v60; // [rsp+90h] [rbp+18h] BYREF
  ...
  v59 = D3DDDI_GAMMARAMP_UNINITIALIZED;
  v12 = 0LL;
  v60 = 0LL;
  wil_details_FeatureReporting_ReportUsageToService(
    ...
    1,
    v57);
  MostCapableColorSpaceTransform = DXGMONITOR::_GetMostCapableColorSpaceTransform(this, &v59);
...
LABEL_43:
  ...
  v28 = v59;
  v29 = a3[3];
  if ( v59 < D3DDDI_GAMMARAMP_MATRIX_3x4 && v29 != v59 && (v59 == D3DDDI_GAMMARAMP_DXGI_1 || v29 > v59) )
  {
    LODWORD(v17) = -1073741811;
    v20 = WdLogNewEntry5_WdWarning(v26, v24, v16);
    *(_QWORD *)(v20 + 24) = a3[3];
  ...
  if ( (int)v17 >= 0 )
  {
    ...
    *(_QWORD *)&v58.Type = (unsigned int)v39;
    v58.DataSize = GetSizeFromGammaRampType(v39);
    v58.Data.pRgb256x3x16 = (D3DDDI_GAMMA_RAMP_RGB256x3x16 *)(a3 + 4);
    LODWORD(v17) = ColorSpaceTransformConvert(&v58, (struct _D3DKMDT_GAMMA_RAMP *)(v12 + 16));
    if ( (int)v17 >= 0 )
    {
      ...
      v43 = DXGMONITOR::_CombineDXGIGammaRamp(this, (struct DXGK_GAMMA_RAMP *)v12, &v60);
      v47 = v60;
      LODWORD(v17) = v43;
      if ( v43 >= 0 )
      {
