/*
 * XREFs of DpiFdoDispatchPnp @ 0x1C0197DA0
 * Callers:
 *     <none>
 * Callees:
 ...
 *     DpiFdoCloseDeviceFileObject @ 0x1C02C7838 (DpiFdoCloseDeviceFileObject.c)
 */
  ...
  switch ( MinorFunction )
  {
    ...
    case 1u:
      ...
      if ( *(_BYTE *)(DeviceExtension + 484) )
        DpiCheckForOutstandingD3Requests(DeviceExtension);
      ExAcquireResourceExclusiveLite(*(PERESOURCE *)(DeviceExtension + 168), 1u);
      if ( byte_1C00B0B11 && !*(_BYTE *)(DeviceExtension + 481) || *(_BYTE *)(DeviceExtension + 480) )
      {
        v12 = 1;
        Status = -1073741823;
        v20 = (_QWORD *)WdLogNewEntry5_WdError(v6, v5);
        v20[3] = a1;
        v20[4] = (unsigned __int8)byte_1C00B0B11;
