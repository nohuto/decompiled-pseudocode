/*
 * XREFs of DxgkMiracastStartMiracastSession @ 0x1C0054860
 * Callers:
 ...
 *     ??_GMIRACAST_CHUNK_LIST@@QEAAPEAXI@Z @ 0x1C0051F48 (--_GMIRACAST_CHUNK_LIST@@QEAAPEAXI@Z.c)
 *     ?AllocateNewChunks@MIRACAST_CHUNK_LIST@@QEAAEK@Z @ 0x1C0052010 (-AllocateNewChunks@MIRACAST_CHUNK_LIST@@QEAAEK@Z.c)
...
LABEL_27:
  ...
  *(_QWORD *)(DeviceContextFromName + 88) = KeGetCurrentThread();
  ...
  if ( !*(_DWORD *)(DeviceContextFromName + 408) )
  {
    ...
    *(_DWORD *)(DeviceContextFromName + 672) = dword_1C00B0F50;
    v39 = v101;
