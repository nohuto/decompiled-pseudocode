/*
 * XREFs of ??1DXGK_VIRTUAL_GPU_PARAV@@UEAA@XZ @ 0x1C003F3BC
 * Callers:
 *     ??_EDXGK_VIRTUAL_GPU_PARAV@@UEAAPEAXI@Z @ 0x1C003F450 (--_EDXGK_VIRTUAL_GPU_PARAV@@UEAAPEAXI@Z.c)
 * Callees:
 *     ??_GCDriverStoreCopy@@QEAAPEAXI@Z @ 0x1C003F414 (--_GCDriverStoreCopy@@QEAAPEAXI@Z.c)
 */
