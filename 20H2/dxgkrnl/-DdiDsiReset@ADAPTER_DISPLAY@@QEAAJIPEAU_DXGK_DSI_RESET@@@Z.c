/*
 * XREFs of ?DdiDsiReset@ADAPTER_DISPLAY@@QEAAJIPEAU_DXGK_DSI_RESET@@@Z @ 0x1C02196AC
 * Callers:
...
__int64 __fastcall ADAPTER_DISPLAY::DdiDsiReset(ADAPTER_DISPLAY *this, unsigned int a2, struct _DXGK_DSI_RESET *a3)
{
  ...
  __int64 v12; // rdx
  __int64 v13; // rcx
  __int64 (__fastcall *v14)(_QWORD, _QWORD, struct _DXGK_DSI_RESET *); // rax
  int v15; // ebx
  _QWORD *v16; // rax
  ...
  DXGETWPROFILER_BASE::PushProfilerEntry((__int64)&v27, 5146LL);
  ...
  if ( v13 && (v14 = *(__int64 (__fastcall **)(_QWORD, _QWORD, struct _DXGK_DSI_RESET *))(v13 + 48)) != 0LL )
