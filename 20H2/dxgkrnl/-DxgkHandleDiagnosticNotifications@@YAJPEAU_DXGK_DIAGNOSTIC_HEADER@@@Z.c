/*
 * XREFs of ?DxgkHandleDiagnosticNotifications@@YAJPEAU_DXGK_DIAGNOSTIC_HEADER@@@Z @ 0x1C004BA90
 * Callers:
 *     <none>
 * Callees:
...
LABEL_8:
  ...
  if ( (Value & 1) != 0 )
  {
    if ( v5 )
    {
      if ( (unsigned int)dword_1C00AFB00 > 4
        && tlgKeywordOn((__int64)&dword_1C00AFB00, 1LL)
        && tlgKeywordOn((__int64)&dword_1C00AFB00, v13) )
      {
        v28 = v16;
        v29[0] = v16;
        v33 = v16 & (v17 >> 2);
    ...
    if ( (unsigned int)dword_1C00AFB00 > 4
      && tlgKeywordOn((__int64)&dword_1C00AFB00, 1LL)
      && tlgKeywordOn((__int64)&dword_1C00AFB00, v7) )
    {
      v11 = (unsigned __int8 *)&unk_1C007F143;
      v35 = a1->TargetId;
...
LABEL_24:
  ...
  else
  {
    ...
    {
      if ( (unsigned int)dword_1C00AFB00 > 4
        && tlgKeywordOn((__int64)&dword_1C00AFB00, 2LL)
        && tlgKeywordOn((__int64)&dword_1C00AFB00, v20) )
      {
        v26 = v23;
        v25 = 0;
        v33 = v23 & (v24 >> 2);
    ...
    if ( (unsigned int)dword_1C00AFB00 > 4
      && tlgKeywordOn((__int64)&dword_1C00AFB00, 2LL)
      && tlgKeywordOn((__int64)&dword_1C00AFB00, v18) )
    {
      v11 = (unsigned __int8 *)&unk_1C007F046;
      v35 = a1->TargetId;
      v36 = a1->SequenceNumber;
      p_TargetId = v32;
      v34 = v19;
