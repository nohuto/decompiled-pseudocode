/*
 * XREFs of ??1CFlipResourceState@@MEAA@XZ @ 0x1C006B04C
 * Callers:
 *     ??_ECFlipResourceState@@MEAAPEAXI@Z @ 0x1C006B140 (--_ECFlipResourceState@@MEAAPEAXI@Z.c)
 *     ??_GCPoolBufferResourceState@@UEAAPEAXI@Z @ 0x1C006B190 (--_GCPoolBufferResourceState@@UEAAPEAXI@Z.c)
