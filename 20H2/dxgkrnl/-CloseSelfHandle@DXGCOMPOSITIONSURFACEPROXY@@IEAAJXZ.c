/*
 * XREFs of ?CloseSelfHandle@DXGCOMPOSITIONSURFACEPROXY@@IEAAJXZ @ 0x1C028B110
 * Callers:
...
LABEL_16:
    ...
    v20 = DXGSESSIONDATA::VailUnregisterCompositionSurfaceProxy(SessionDataForSpecifiedSession, this);
    v2 = v20;
    if ( v20 < 0 )
      goto LABEL_16;
  }
