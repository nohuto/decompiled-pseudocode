/*
 * XREFs of PiRegStateReadStackCreationSettingsFromKey @ 0x1C02C39E0
 * Callers:
 ...
 *     SeUtilSecurityInfoFromSecurityDescriptor @ 0x1C02C3E6C (SeUtilSecurityInfoFromSecurityDescriptor.c)
 *     CmRegUtilUcValueGetFullBuffer @ 0x1C02C41A0 (CmRegUtilUcValueGetFullBuffer.c)
