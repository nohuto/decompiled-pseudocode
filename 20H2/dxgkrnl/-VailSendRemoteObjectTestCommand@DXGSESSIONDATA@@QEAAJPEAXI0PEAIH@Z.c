/*
 * XREFs of ?VailSendRemoteObjectTestCommand@DXGSESSIONDATA@@QEAAJPEAXI0PEAIH@Z @ 0x1C02B6AB4
 * Callers:
 ...
 *     ?AddReference@DXGVAILGUESTOBJECT@@QEAAXXZ @ 0x1C02B2DC8 (-AddReference@DXGVAILGUESTOBJECT@@QEAAXXZ.c)
