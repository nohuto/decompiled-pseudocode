/*
 * XREFs of MonitorIsAdvancedColorEnabled @ 0x1C0139AE0
 * Callers:
...
__int64 __fastcall MonitorIsAdvancedColorEnabled(struct HDXGMONITOR__ *a1, bool *a2)
{
  __int64 result; // rax
  __int64 v4; // rdx
  __int64 v5; // rcx
