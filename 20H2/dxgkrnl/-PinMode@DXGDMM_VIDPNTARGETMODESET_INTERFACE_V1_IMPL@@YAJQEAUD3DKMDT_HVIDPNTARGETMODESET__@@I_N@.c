/*
 * XREFs of ?PinMode@DXGDMM_VIDPNTARGETMODESET_INTERFACE_V1_IMPL@@YAJQEAUD3DKMDT_HVIDPNTARGETMODESET__@@I_N@Z @ 0x1C0121790
 * Callers:
 *     <none>
 * Callees:
        ...
        __int64 a3)
{
  ...
  if ( v6 )
  {
    ...
    else
    {
      ...
      if ( v12 < 0 )
      {
        v27 = WdLogNewEntry5_WdDmmEvent(v19, v18);
        *(_QWORD *)(v27 + 24) = v5;
        *(_QWORD *)(v27 + 32) = this;
