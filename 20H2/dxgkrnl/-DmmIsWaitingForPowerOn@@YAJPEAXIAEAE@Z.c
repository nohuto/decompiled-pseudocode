/*
 * XREFs of ?DmmIsWaitingForPowerOn@@YAJPEAXIAEAE@Z @ 0x1C0172BBC
 * Callers:
 ...
 *     ?IsPathFromSourcePoweredOff@DMMVIDPN@@QEBAEI@Z @ 0x1C0172CCC (-IsPathFromSourcePoweredOff@DMMVIDPN@@QEBAEI@Z.c)
 */
