/*
 * XREFs of ?AccessCheckTargetPolicy@DXGDISPLAYMANAGEROBJECT@@SAJW4_D3DKMT_DISPLAY_TARGET_USAGE@@_N@Z @ 0x1C02AFA54
 * Callers:
 ...
 *     ?IsCurrentThreadAppContainer@DXGPROCESS@@SA_NXZ @ 0x1C028451C (-IsCurrentThreadAppContainer@DXGPROCESS@@SA_NXZ.c)
 */
