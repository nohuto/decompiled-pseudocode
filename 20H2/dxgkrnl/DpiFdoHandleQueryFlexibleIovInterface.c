/*
 * XREFs of DpiFdoHandleQueryFlexibleIovInterface @ 0x1C02D20B0
 * Callers:
 *     <none>
 * Callees:
    ...
    if ( v8 == 1 )
    {
      if ( v9 >= 0x78u )
      {
        ...
        if ( *(_BYTE *)(v5 + 5264) )
        {
          ...
          if ( *(_QWORD *)(v5 + 5304) )
          {
            qword_1C00AFCB8 = (__int64)&DpiIovGetBackingResource;
            qword_1C00AFCC0 = (__int64)DpiIovGetMmioRangeCount;
            qword_1C00AFCC8 = (__int64)DpiIovGetMmioRanges;
          }
          else
          {
            v18 = 0LL;
            ...
            qword_1C00AFCB8 = (__int64)v18;
          }
          memmove(a4, &unk_1C00AFC80, 0x78uLL);
