/*
 * XREFs of ?InitializePowerManagement@DXGADAPTER@@AEAAJXZ @ 0x1C017B1A8
 * Callers:
 ...
 *     ?SetPowerComponentResidencyCB@DXGADAPTER@@QEAAXI_K@Z @ 0x1C0038B90 (-SetPowerComponentResidencyCB@DXGADAPTER@@QEAAXI_K@Z.c)
 ...
 *     DpiGetPnpRegistryKeyName @ 0x1C01703D0 (DpiGetPnpRegistryKeyName.c)
 *     ?DestroySerializeFStateTransitWorker@DXGADAPTER@@QEAAXXZ @ 0x1C020B558 (-DestroySerializeFStateTransitWorker@DXGADAPTER@@QEAAXXZ.c)
 ...
 *     DpiEnablePowerManagement @ 0x1C02C50EC (DpiEnablePowerManagement.c)
 */
