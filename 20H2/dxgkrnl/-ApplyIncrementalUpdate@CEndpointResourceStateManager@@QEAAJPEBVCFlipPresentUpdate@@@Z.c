/*
 * XREFs of ?ApplyIncrementalUpdate@CEndpointResourceStateManager@@QEAAJPEBVCFlipPresentUpdate@@@Z @ 0x1C006B1DC
 * Callers:
 ...
 *     ?Dequeue@?$CFlipObjectQueue@VCPoolBufferResourceState@@@@QEAAPEAVCPoolBufferResourceState@@XZ @ 0x1C006B6B4 (-Dequeue@-$CFlipObjectQueue@VCPoolBufferResourceState@@@@QEAAPEAVCPoolBufferResourceState@@XZ.c)
