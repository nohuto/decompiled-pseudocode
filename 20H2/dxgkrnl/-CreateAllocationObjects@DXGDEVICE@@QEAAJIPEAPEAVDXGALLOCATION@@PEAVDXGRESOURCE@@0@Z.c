/*
 * XREFs of ?CreateAllocationObjects@DXGDEVICE@@QEAAJIPEAPEAVDXGALLOCATION@@PEAVDXGRESOURCE@@0@Z @ 0x1C010A2D0
 * Callers:
 ...
 *     ??0DXGALLOCATION@@QEAA@PEAVDXGDEVICE@@@Z @ 0x1C02265B0 (--0DXGALLOCATION@@QEAA@PEAVDXGDEVICE@@@Z.c)
 */
