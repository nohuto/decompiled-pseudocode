/*
 * XREFs of ?NotifyChannelClosed@DXGCHANNELENDPOINTPROXY@@QEAAXXZ @ 0x1C02B1F3C
 * Callers:
 ...
 *     ?GetUsedEntryCount@HMGRTABLE@@QEAAIXZ @ 0x1C004C7E4 (-GetUsedEntryCount@HMGRTABLE@@QEAAIXZ.c)
