/*
 * XREFs of DxgkMiracastQueryMiracastSupportInternal @ 0x1C0170584
 * Callers:
 ...
 *     DxgkNetDispQueryMiracastDisplayDeviceSupport @ 0x1C0170150 (DxgkNetDispQueryMiracastDisplayDeviceSupport.c)
...
LABEL_8:
    ...
    xmmword_1C00B0FE0 = 0LL;
    dword_1C00B0FF0 = 0;
LABEL_22:
    MiracastSupportForFDO = -1073741637;
    goto LABEL_16;
  }
  DWORD1(xmmword_1C00B0FE0) = dword_1C00B0F3C;
  LOBYTE(xmmword_1C00B0FE0) = 0;
  BYTE8(xmmword_1C00B0FE0) = 0;
  *(_QWORD *)((char *)&xmmword_1C00B0FE0 + 12) = v8;
  if ( a1 )
  {
    *(_OWORD *)a1 = xmmword_1C00B0FE0;
    *(_DWORD *)(a1 + 16) = dword_1C00B0FF0;
  }
