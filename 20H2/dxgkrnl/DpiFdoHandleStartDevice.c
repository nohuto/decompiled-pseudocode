/*
 * XREFs of DpiFdoHandleStartDevice @ 0x1C0190DE0
 * Callers:
 *     <none>
 * Callees:
 *     DpiCheckForOutstandingD3Requests @ 0x1C001E4A0 (DpiCheckForOutstandingD3Requests.c)
 *     WindowsQueryLicenseDWORD @ 0x1C0022FD0 (WindowsQueryLicenseDWORD.c)
...
LABEL_40:
        if ( byte_1C00B0B59 )
          KeSetEvent(&stru_1C00B0B60, 0, 0);
LABEL_21:
        if ( byte_1C00B0B5A && !*(_BYTE *)(DeviceExtension + 1158) )
        {
          ThreadHandle = 0LL;
