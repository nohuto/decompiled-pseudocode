/*
 * XREFs of ?DpiClaimPersistedMemoryBlock@@YAJPEAU_FDO_CONTEXT@@_KPEBU_GUID@@@Z @ 0x1C02D0BA8
 * Callers:
...
LABEL_44:
  ...
  if ( v26 )
  {
    ...
    else
    {
      ...
      qword_1C00B1018 = (__int64)MappedSystemVa;
      if ( !MappedSystemVa )
      {
        v12 = -1073741823LL;
LABEL_43:
