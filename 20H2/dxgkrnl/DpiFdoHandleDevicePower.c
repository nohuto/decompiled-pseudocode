/*
 * XREFs of DpiFdoHandleDevicePower @ 0x1C01717A0
 * Callers:
 *     DpiFdoDispatchPower @ 0x1C0170EC0 (DpiFdoDispatchPower.c)
 * Callees:
 *     DxgkReportDeviceDirectedPowerDown @ 0x1C003B25C (DxgkReportDeviceDirectedPowerDown.c)
 *     DpiSetDevicePowerTransitionStateAtPassiveLevel @ 0x1C0050D8C (DpiSetDevicePowerTransitionStateAtPassiveLevel.c)
 ...
 *     DpiFdoDetermineAffectedSession @ 0x1C02C6DF8 (DpiFdoDetermineAffectedSession.c)
 *     DpiFdoIsDevicePresent @ 0x1C02CA074 (DpiFdoIsDevicePresent.c)
 *     DpiFdoRebootForSurpriseRemoval @ 0x1C02CA61C (DpiFdoRebootForSurpriseRemoval.c)
 *     DpiLdaPowerDownAllAdaptersInChain @ 0x1C02D6BAC (DpiLdaPowerDownAllAdaptersInChain.c)
 *     DpiLdaPowerUpAdapterInChain @ 0x1C02D6D58 (DpiLdaPowerUpAdapterInChain.c)
...
LABEL_95:
      v17 = v52;
LABEL_96:
      if ( (PDEVICE_OBJECT)qword_1C00B0DB8 == DeviceObject )
      {
        if ( (_BYTE)v27 )
        {
          if ( dword_1C00B0E68 == 3 && byte_1C00B0E88 )
          {
            LOBYTE(v28) = 1;
            DpiAcquirePostDisplayInfoFromBgfx(&xmmword_1C00B0DC8, v28, 0LL);
            byte_1C00B0E88 = 0;
            dword_1C00B0EB4 = 1;
          }
        }
