/*
 * XREFs of DxgkCheckDisplayState @ 0x1C02BAB90
 * Callers:
 *     <none>
 * Callees:
 ...
 *     ?CheckPrimaryContentState@DISPLAYSTATECHECKER@@QEAAJXZ @ 0x1C02B87D4 (-CheckPrimaryContentState@DISPLAYSTATECHECKER@@QEAAJXZ.c)
