...
LABEL_12:
    ...
    while ( 1 )
    {
      v7 = ((__int64 (__fastcall *)(KSPIN_LOCK, _QWORD, _QWORD, __int64))qword_1C00B1038)(
             v5[1],
    ...
    if ( (_DWORD)v6 )
    {
      ...
      do
      {
        ((void (__fastcall *)(KSPIN_LOCK, _QWORD, _QWORD))qword_1C00B1040)(
          v5[1],
  ...
  {
    LODWORD(v4) = ((__int64 (__fastcall *)(_QWORD, __int64, _QWORD, __int64))qword_1C00B1038)(
