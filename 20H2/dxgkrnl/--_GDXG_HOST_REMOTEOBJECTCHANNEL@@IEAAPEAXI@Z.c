/*
 * XREFs of ??_GDXG_HOST_REMOTEOBJECTCHANNEL@@IEAAPEAXI@Z @ 0x1C02B2D44
 * Callers:
 *     ?Delete@DXG_HOST_REMOTEOBJECTCHANNEL@@UEAAXXZ @ 0x1C02B3D40 (-Delete@DXG_HOST_REMOTEOBJECTCHANNEL@@UEAAXXZ.c)
 * Callees:
