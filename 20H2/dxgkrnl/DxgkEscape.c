/*
 * XREFs of DxgkEscape @ 0x1C00F72C0
 * Callers:
 ...
 *     ?TdrDbgCtrl@@YAJW4_TDR_DBG_CTRL@@@Z @ 0x1C02646C8 (-TdrDbgCtrl@@YAJW4_TDR_DBG_CTRL@@@Z.c)
 ...
 *     ?IsAMDDriverEscapeAllowed@@YAHPEAX_K@Z @ 0x1C0266D88 (-IsAMDDriverEscapeAllowed@@YAHPEAX_K@Z.c)
...
LABEL_553:
          ...
          case D3DKMT_ESCAPE_HISTORY_BUFFER_STATUS:
            ...
            {
              v179 = 0;
              if ( (qword_1C00AF9B0 & 0x61C8ED7) != 0
                && (qword_1C00AF9B8 & 0xFFFFFFFFF9E37128uLL) == 0
                && (qword_1C00AF9B0 & 0x4000) != 0 )
              {
