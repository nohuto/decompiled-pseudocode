/*
 * XREFs of ?DpiBrightness3Set@@YAJPEAXKPEAU_DXGK_BRIGHTNESS_SET_IN@@@Z @ 0x1C02CE9A0
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall DpiBrightness3Set(_QWORD *a1, unsigned int a2, struct _DXGK_BRIGHTNESS_SET_IN *a3)
{
  ...
  __int64 v11; // rax
  __int64 v12; // r9
  __int64 (__fastcall *v13)(_QWORD, _QWORD, struct _DXGK_BRIGHTNESS_SET_IN *); // rax
  ...
  if ( v7 >= 0 )
  {
    ...
    if ( v12 )
    {
      v13 = *(__int64 (__fastcall **)(_QWORD, _QWORD, struct _DXGK_BRIGHTNESS_SET_IN *))(v12 + 32);
      if ( v13 )
