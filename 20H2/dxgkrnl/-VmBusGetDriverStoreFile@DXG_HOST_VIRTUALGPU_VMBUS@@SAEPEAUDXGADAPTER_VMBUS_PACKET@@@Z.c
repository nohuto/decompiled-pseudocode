/*
 * XREFs of ?VmBusGetDriverStoreFile@DXG_HOST_VIRTUALGPU_VMBUS@@SAEPEAUDXGADAPTER_VMBUS_PACKET@@@Z @ 0x1C02409B0
 * Callers:
 *     <none>
 * Callees:
 ...
 *     ??0CDriverStoreCopy@@QEAA@XZ @ 0x1C02605E0 (--0CDriverStoreCopy@@QEAA@XZ.c)
