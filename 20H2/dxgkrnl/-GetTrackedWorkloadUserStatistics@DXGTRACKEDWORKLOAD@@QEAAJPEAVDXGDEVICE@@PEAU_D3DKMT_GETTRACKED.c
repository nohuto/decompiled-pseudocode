/*
 * XREFs of ?GetTrackedWorkloadUserStatistics@DXGTRACKEDWORKLOAD@@QEAAJPEAVDXGDEVICE@@PEAU_D3DKMT_GETTRACKEDWORKLOADSTATISTICS@@@Z @ 0x1C02BB6EC
 * Callers:
 *     NtDxgkGetTrackedWorkloadStatistics @ 0x1C02BCA60 (NtDxgkGetTrackedWorkloadStatistics.c)
 * Callees:
 *     memset @ 0x1C0027400 (memset.c)
 *     ?GetStats@CumulativeStats@@QEAAXPEAN000PEA_K@Z @ 0x1C006E034 (-GetStats@CumulativeStats@@QEAAXPEAN000PEA_K@Z.c)
 *     ?IsSaturated@TrackedWorkloadMonitor@@QEAA_NXZ @ 0x1C006E278 (-IsSaturated@TrackedWorkloadMonitor@@QEAA_NXZ.c)
 */
