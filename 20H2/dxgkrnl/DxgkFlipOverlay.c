/*
 * XREFs of DxgkFlipOverlay @ 0x1C027A650
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall DxgkFlipOverlay(__int64 a1, __int64 a2, __int64 a3)
{
  ...
  __int64 v35; // rcx
  __int64 v36; // r8
  struct DXGDEVICE *v37; // [rsp+20h] [rbp-E8h] BYREF
  int v38; // [rsp+28h] [rbp-E0h] BYREF
  __int64 v39; // [rsp+30h] [rbp-D8h]
  char v40; // [rsp+38h] [rbp-D0h]
  DXGDEVICE *v41; // [rsp+40h] [rbp-C8h] BYREF
  _QWORD v42[2]; // [rsp+48h] [rbp-C0h] BYREF
  _D3DKMT_FLIPOVERLAY v43; // [rsp+58h] [rbp-B0h] BYREF
  _BYTE v44[16]; // [rsp+78h] [rbp-90h] BYREF
  _BYTE v45[24]; // [rsp+88h] [rbp-80h] BYREF
  _BYTE v46[80]; // [rsp+A0h] [rbp-68h] BYREF
  ...
  DXGETWPROFILER_BASE::PushProfilerEntry((__int64)&v38, 2024LL);
...
LABEL_28:
  ...
  v43 = *v3;
  v41 = 0LL;
  DXGDEVICEBYHANDLE::DXGDEVICEBYHANDLE((DXGDEVICEBYHANDLE *)&v37, v43.hDevice, (struct _KTHREAD **)Current, &v41);
  v13 = (struct ADAPTER_RENDER **)v41;
  if ( !v41 )
  {
    v14 = WdLogNewEntry5_WdError(v12, v11);
    *(_QWORD *)(v14 + 24) = v43.hDevice;
...
LABEL_25:
  ...
  v18 = (v43.hOverlay >> 6) & 0xFFFFFF;
  if ( (unsigned int)v18 >= *((_DWORD *)Current + 64) )
    goto LABEL_17;
  v17 = *((_QWORD *)Current + 30);
  v15 = *(unsigned int *)(v17 + 16 * v18 + 8);
  v16 = (v43.hOverlay >> 25) & 0x60;
  if ( ((v43.hOverlay >> 25) & 0x60) != (*(_BYTE *)(v17 + 16 * v18 + 8) & 0x60)
    || (v15 & 0x2000) != 0
    || (v15 & 0x1F) == 0 )
  {
    goto LABEL_17;
...
LABEL_23:
  ...
  if ( v25 >= 0 )
  {
    ...
    v32 = DXGOVERLAY::FlipOverlay(v20, &v43);
