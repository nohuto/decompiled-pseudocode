/*
 * XREFs of NVMeSetIoQueueCountCompletion @ 0x1C001A930
 * Callers:
 *     <none>
 * Callees:
...
LABEL_29:
  ...
  if ( *(_QWORD *)(SrbExtension + 4232) )
  {
    if ( v14 >= *(_WORD *)(v3 + 280) )
      v14 = *(_WORD *)(v3 + 280);
    LOWORD(v7) = *(_WORD *)(v3 + 282);
    if ( (unsigned __int16)v16 >= (unsigned __int16)v7 )
      LOWORD(v16) = *(_WORD *)(v3 + 282);
  }
  *(_WORD *)(v3 + 280) = v14;
  *(_WORD *)(v3 + 282) = v16;
  if ( !*(_BYTE *)(v3 + 16) && *(_BYTE *)(v3 + 3800) )
  {
    v19 = *(_DWORD *)(v3 + 3812);
    v20 = (unsigned int)(unsigned __int16)v16 * *(_DWORD *)(v3 + 3804) / 0x64;
    *(_WORD *)(v3 + 284) = v20;
    if ( (v19 & 0x80u) == 0 )
    {
      LOWORD(v7) = v20;
