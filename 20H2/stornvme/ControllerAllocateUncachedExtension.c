/*
 * XREFs of ControllerAllocateUncachedExtension @ 0x1C0008DD0
 * Callers:
...
char __fastcall ControllerAllocateUncachedExtension(__int64 a1, __int64 a2)
{
  ...
  *(_QWORD *)(a1 + 1624) = UncachedExtension;
  if ( UncachedExtension )
  {
    ...
    *(_QWORD *)(a1 + 1608) = v6;
    *(_QWORD *)(a1 + 1616) = StorPortGetPhysicalAddress(a1, 0LL, v6, &v18);
    v7 = *(_QWORD *)(a1 + 1624) + 4096LL;
    v8 = *(_BYTE *)(a1 + 16) == 0;
    *(_QWORD *)(a1 + 920) = v7;
    v9 = v7 + 0x2000;
    *(_QWORD *)(a1 + 1624) = v7 + 0x2000;
    if ( v8 )
    {
      v10 = (_QWORD *)(a1 + 1032);
      v11 = 6LL;
    ...
    *(_QWORD *)(a1 + 1704) = v9;
    ...
    v13 = *(_QWORD *)(a1 + 1624);
    *(_QWORD *)(a1 + 1712) = PhysicalAddress;
    v13 += 4096LL;
    v14 = (unsigned __int64)*(unsigned __int16 *)(a1 + 276) << 6;
    *(_QWORD *)(a1 + 288) = v13;
    v15 = v14 + v13;
    v8 = *(_BYTE *)(a1 + 16) == 0;
    *(_QWORD *)(a1 + 424) = v15;
    v16 = v15 + 4096;
    *(_QWORD *)(a1 + 1624) = v15 + 4096;
    if ( !v8 )
    {
      v17 = v15 + 12288;
      *(_QWORD *)(a1 + 1624) = v17;
      *(_QWORD *)(a1 + 776) = v17 - 344;
      *(_QWORD *)(a1 + 768) = v17 - 480;
      *(_QWORD *)(v17 - 480) = v16;
      **(_QWORD **)(a1 + 776) = v16 + 4096;
    }
    return 1;
  }
  else
