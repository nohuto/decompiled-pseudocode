/*
 * XREFs of NVMeValidateProtocolCommandRequest @ 0x1C0014090
 * Callers:
...
LABEL_7:
  ...
  if ( (unsigned int)(v5[14] - 1) > 1 )
    goto LABEL_18;
  if ( (unsigned __int8)v5[20] == 20 && !(unsigned __int8)NVMeIsAllowedWithinThrottleLimit(a1, 5LL, 0LL) )
  {
    v5[4] = 8;
    v2 = -1056964595;
    *(_BYTE *)(a2 + 3) = 39;
...
LABEL_42:
  if ( v5[9] )
    goto LABEL_18;
LABEL_50:
  if ( v5[14] == 2 && (*(_QWORD *)(a1 + 168) & 0x2000000000LL) == 0 )
    goto LABEL_18;
  return v2;
}
