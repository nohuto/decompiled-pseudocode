/*
 * XREFs of ScsiReportLunsCommand @ 0x1C0015698
 * Callers:
 *     ScsiToNVMe @ 0x1C0003A60 (ScsiToNVMe.c)
 * Callees:
 *     NVMeIsLunActive @ 0x1C0013B24 (NVMeIsLunActive.c)
 */
  ...
  if ( v6 >= (unsigned __int64)v7 + 8 )
  {
    ...
    *v4 = HIBYTE(v7);
    ...
    if ( *(_DWORD *)(a1 + 200) )
    {
      do
      {
        if ( NVMeIsLunActive(*(_QWORD *)(v3 + 8 * v8 + 1720)) )
        {
      ...
      while ( (unsigned int)v8 < *(_DWORD *)(v3 + 200) );
    }
  }
  else
  {
