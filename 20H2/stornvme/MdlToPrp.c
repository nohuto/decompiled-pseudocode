 ...
 * 00000001C0003FFB: jnz     loc_1C00086F8
 ...
 * 00000001C00040C1: ja      loc_1C0008701
 ...
 * 00000001C0004101: jnb     loc_1C00087CA
 * 00000001C0004107: test    edi, edi
 * 00000001C0004109: jz      loc_1C00087E3
 * 00000001C000410F: lea     eax, [r14+rdi]
 * 00000001C0004113: cmp     eax, [rbp+arg_18]
 * 00000001C0004116: ja      loc_1C00087E3
 ...
 * 00000001C00086F8: mov     rbx, [rdx+38h]
 * 00000001C00086FC: jmp     loc_1C0004005
 * 00000001C0008701: xor     r9d, r9d
 * 00000001C0008704: mov     [rbp+arg_10], r13d
 * 00000001C0008708: xor     r8d, r8d
 * 00000001C000870B: mov     [rsp+58h+var_38], r13
 * 00000001C0008710: lea     rdx, [rbp+arg_10]
 * 00000001C0008714: mov     rcx, rsi
 * 00000001C0008717: call    GetSrbScsiData
 * 00000001C000871C: mov     r12d, [rbp+arg_10]
 * 00000001C0008720: mov     rcx, rax
 * 00000001C0008723: mov     edx, r12d
 * 00000001C0008726: mov     r8, rax
 * 00000001C0008729: call    GetLbaFromCdb
 * 00000001C000872E: test    rax, rax
 * 00000001C0008731: jz      loc_1C00040C7
 * 00000001C0008737: movzx   ecx, byte ptr [rcx]
 * 00000001C000873A: cmp     cl, 28h ; '('
 * 00000001C000873D: jz      short loc_1C0008752
 * 00000001C000873F: cmp     cl, 2Ah ; '*'
 * 00000001C0008742: jz      short loc_1C0008752
 * 00000001C0008744: cmp     cl, 88h
 * 00000001C0008747: jz      short loc_1C0008752
 * 00000001C0008749: cmp     cl, 8Ah
 * 00000001C000874C: jnz     loc_1C00040C7
 * 00000001C0008752: mov     r10d, [r15+78h]
 * 00000001C0008756: add     [rbp+arg_8], r10d
 * 00000001C000875A: cmp     byte ptr [rsi+2], 28h ; '('
 * 00000001C000875E: jnz     short loc_1C000876A
 * 00000001C0008760: mov     eax, [rsi+34h]
 * 00000001C0008763: movzx   ecx, byte ptr [rax+rsi+0Ah]
 * 00000001C0008768: jmp     short loc_1C000876E
 * 00000001C000876A: movzx   ecx, byte ptr [rsi+7]
 * 00000001C000876E: movzx   edx, cl
 * 00000001C0008771: lea     r11, [r15+rdx*8]
 * 00000001C0008775: mov     rax, [r11+6B8h]
 * 00000001C000877C: mov     ecx, [rax+34h]
 * 00000001C000877F: lea     eax, [r10-1]
 * 00000001C0008783: add     eax, ecx
 * 00000001C0008785: neg     ecx
 * 00000001C0008787: and     eax, ecx
 * 00000001C0008789: sub     [rdi+rsi], eax
 * 00000001C000878C: cmp     edx, [r15+0C8h]
 * 00000001C0008793: jnb     short loc_1C00087A5
 * 00000001C0008795: mov     rax, [r11+6B8h]
 * 00000001C000879C: test    rax, rax
 * 00000001C000879F: jz      short loc_1C00087A5
 * 00000001C00087A1: mov     r9d, [rax+10h]
 * 00000001C00087A5: mov     dword ptr [rsp+58h+var_30], r9d
 * 00000001C00087AA: lea     rax, [rbx+1000h]
 * 00000001C00087B1: mov     r9d, r12d
 * 00000001C00087B4: mov     [rsp+58h+var_38], rax
 * 00000001C00087B9: mov     rdx, rsi
 * 00000001C00087BC: mov     rcx, r15
 * 00000001C00087BF: call    BuildReadWriteCommand
 * 00000001C00087C4: nop
 * 00000001C00087C5: jmp     loc_1C00040C7
 * 00000001C00087CA: mov     r14d, r8d
 * 00000001C00087CD: shr     r14d, 0Ch
 * 00000001C00087D1: mov     eax, r14d
 * 00000001C00087D4: shl     eax, 0Ch
 * 00000001C00087D7: sub     r8d, eax
 * 00000001C00087DA: mov     [rbp+arg_8], r8d
 * 00000001C00087DE: jmp     loc_1C0004107
 * 00000001C00087E3: mov     eax, 0C1000001h
 * 00000001C00087E8: jmp     loc_1C000413F
 */
