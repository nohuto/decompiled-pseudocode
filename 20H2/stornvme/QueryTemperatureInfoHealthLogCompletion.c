/*
 * XREFs of QueryTemperatureInfoHealthLogCompletion @ 0x1C0015100
 * Callers:
 *     <none>
 * Callees:
 ...
 *     KelvinToCelsius @ 0x1C0012778 (KelvinToCelsius.c)
 */
...
__int64 __fastcall QueryTemperatureInfoHealthLogCompletion(__int64 a1, __int64 a2)
{
  ...
  if ( *(_QWORD *)(v6 + 4200) )
    result = NVMeFreeDmaBuffer(a1, *(unsigned int *)(v6 + 4240), v6 + 4200, *(_QWORD *)(v6 + 4208));
  *(_DWORD *)(v6 + 4240) = 0;
  *(_QWORD *)(v6 + 4200) = 0LL;
  return result;
}
