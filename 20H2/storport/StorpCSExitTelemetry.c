/*
 * XREFs of StorpCSExitTelemetry @ 0x1C0051C94
 * Callers:
  ...
  if ( a1 )
  {
    ...
    if ( *(_QWORD *)(a1 + 5088) )
    {
      ...
      if ( (unsigned int)dword_1C0069058 > 5 && tlgKeywordOn(v7, 0x400000000000LL) )
      {
        ...
        v130 = 8LL;
        v132 = 4LL;
        tlgWriteTransfer_EtwWriteTransfer(v13, (unsigned __int8 *)dword_1C005F9BD, v8, v9, 0x11u, &v102);
      }
    }
      ...
      if ( RaidUnitCheckAndAcquirePoFx((__int64)(i - 7)) )
      {
        ...
        if ( (unsigned int)dword_1C0069058 > 5 )
        {
          if ( tlgKeywordOn(v18, 0x400000000000LL) )
          {
            ...
            v99 = 8LL;
            v101 = 4LL;
            tlgWriteTransfer_EtwWriteTransfer(v24, (unsigned __int8 *)dword_1C005F75A, v19, v20, 0x17u, &v59);
          }
        }
