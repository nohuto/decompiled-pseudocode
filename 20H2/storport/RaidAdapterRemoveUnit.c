/*
 * XREFs of RaidAdapterRemoveUnit @ 0x1C0017068
 * Callers:
 *     RaidBusEnumeratorReleaseUnit @ 0x1C0017014 (RaidBusEnumeratorReleaseUnit.c)
 ...
 *     StorRemoveDictionary @ 0x1C001713C (StorRemoveDictionary.c)
 */
