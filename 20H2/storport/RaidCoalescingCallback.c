/*
 * XREFs of RaidCoalescingCallback @ 0x1C0030580
 * Callers:
 *     <none>
 * Callees:
  ...
  if ( (_DWORD)result && *(_QWORD *)(a3 + 5096) && *(_QWORD *)(a3 + 5112) )
  {
    ...
    else if ( a1 == 2 )
    {
      *(_BYTE *)(a3 + 109) &= ~1u;
      ...
      if ( StorEtwLoggingEnabled && (v19 & (unsigned __int8)byte_1C0069841) != 0 )
        McTemplateK0qqqqq_EtwWriteTransfer(v16, v15, v17, *(_DWORD *)(a3 + 56), v17, v18, v15, v14);
      result = RaCallMiniportAdapterControl(a3 + 320);
      if ( *(_QWORD *)(a3 + 5352) )
      {
