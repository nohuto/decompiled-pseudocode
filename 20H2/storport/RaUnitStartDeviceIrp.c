/*
 * XREFs of RaUnitStartDeviceIrp @ 0x1C00747FC
 * Callers:
 ...
 *     RaidIsUnitQueueLocked @ 0x1C0011228 (RaidIsUnitQueueLocked.c)
 *     RaidUnlockUnitQueue @ 0x1C0011238 (RaidUnlockUnitQueue.c)
 ...
 *     RaUnitInitializeWMI @ 0x1C0074474 (RaUnitInitializeWMI.c)
  ...
  *(_QWORD *)(a1 + 3264) = 0x10000000LL;
  ...
  if ( *(_QWORD *)(a1 + 104) && (unsigned int)dword_1C0069058 > 5 && tlgKeywordOn(v7, 0x400000000000LL) )
  {
    ...
    *(_QWORD *)&v33 = *(_QWORD *)(a1 + 3208);
    ...
    v73 = 4LL;
    v75 = 4LL;
    tlgWriteTransfer_EtwWriteTransfer((__int64)v10, (unsigned __int8 *)dword_1C005DAE7, v13, v14, 0x19u, &v34);
  }
