/*
 * XREFs of RaidUnitAllocateResources @ 0x1C0018C10
 * Callers:
 ...
 *     StorCreateEventQueue @ 0x1C0018FC8 (StorCreateEventQueue.c)
...
__int64 __fastcall RaidUnitAllocateResources(__int64 a1)
{
  ...
  *(_DWORD *)(a1 + 912) = 0x10000000;
  ...
  v4 = *(_QWORD *)(a1 + 24);
  if ( v4 )
    LOBYTE(v4) = *(_BYTE *)(v4 + 548) & 0x10;
  if ( (_BYTE)v4 )
    **(_DWORD **)(a1 + 504) |= 5u;
  v5 = (_QWORD *)(a1 + 512);
  EventQueue = RaInitializeTagList(a1 + 512, (unsigned int)(*(_DWORD *)(v1 + 536) + 1), *(_QWORD *)(a1 + 8));
  if ( EventQueue < 0 )
    goto LABEL_25;
...
LABEL_10:
  if ( v11 != -1 )
  {
    *(_DWORD *)(a1 + 1696) = v11;
    v12 = *(_QWORD *)(a1 + 24);
    v13 = ((*(_DWORD *)(v12 + 468) + 7) & 0xFFFFFFF8) + 1232;
    if ( *(_BYTE *)(v1 + 426) != 1 )
      v13 = ((*(_DWORD *)(v12 + 468) + 7) & 0xFFFFFFF8) + 1088;
    ContiguousIoResources = StorAllocateContiguousIoResources(
                              v13,
                              ((*(_DWORD *)(v12 + 468) + 7) & 0xFFFFFFF8) + 1088,
                              v1);
    ...
    if ( ContiguousIoResources )
    {
      ...
      *(_QWORD *)(a1 + 1704) = ContiguousIoResources + 1088;
      ...
      {
        *(_DWORD *)(v16 + 776) = 144;
        *(_QWORD *)(v16 + 792) = v16 + ((*(_DWORD *)(*(_QWORD *)(a1 + 24) + 468LL) + 7) & 0xFFFFFFF8) + 1088LL;
      }
