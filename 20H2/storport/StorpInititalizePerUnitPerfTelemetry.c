/*
 * XREFs of StorpInititalizePerUnitPerfTelemetry @ 0x1C0074158
 * Callers:
 *     StorpInitializeUnitTelemetry @ 0x1C0019EB8 (StorpInitializeUnitTelemetry.c)
 * Callees:
...
__int64 __fastcall StorpInititalizePerUnitPerfTelemetry(__int64 a1)
{
  ...
  *(_QWORD *)(a1 + 2248) = Pool;
  if ( Pool )
  {
    ...
    v5 = RaidAllocatePool(NonPagedPoolNx, HIDWORD(qword_1C0069440), 0x65546152u, *(_QWORD *)(a1 + 8));
    *(_QWORD *)(a1 + 2264) = v5;
    if ( v5 )
    {
      memset(v5, 0, HIDWORD(qword_1C0069440));
      if ( UseQPCTime )
      ...
      *(LARGE_INTEGER *)(a1 + 2256) = PerformanceCounter;
      v8 = RaidAllocatePool(NonPagedPoolNx, (unsigned int)dword_1C006945C, 0x65546152u, v7);
      *(_QWORD *)(a1 + 2272) = v8;
      if ( v8 )
        memset(v8, 0, (unsigned int)dword_1C006945C);
      result = 0LL;
      *(_OWORD *)(a1 + 2280) = 0LL;
      *(_QWORD *)(a1 + 2296) = 0LL;
      *(_QWORD *)(a1 + 2304) = 0LL;
