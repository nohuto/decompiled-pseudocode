/*
 * XREFs of RaDriverAddDevice @ 0x1C0033F60
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall RaDriverAddDevice(PDRIVER_OBJECT DriverObject, PDEVICE_OBJECT TargetDevice)
{
  NTSTATUS v4; // esi
  ...
  SourceDevice = 0LL;
  DeviceName = 0LL;
  RaidCreateDeviceName(TargetDevice, &DeviceName, &v16);
