/*
 * XREFs of RaidAdapterSetMaxOperationalPower @ 0x1C003EB14
 * Callers:
 ...
 *     RaidAdapterPassiveCoolingCallback @ 0x1C003E7F0 (RaidAdapterPassiveCoolingCallback.c)
 * Callees:
 ...
 *     RaidAdapterEffectiveMaxOperationalPower @ 0x1C003E7C4 (RaidAdapterEffectiveMaxOperationalPower.c)
 */
...
LABEL_11:
  ...
  if ( (unsigned int)dword_1C0069058 > 5 )
  {
    if ( tlgKeywordOn(v14, 0x400000000000LL) )
    {
      ...
      v31 = v19;
      v59 = 8LL;
      tlgWriteTransfer_EtwWriteTransfer(v17, (unsigned __int8 *)dword_1C005D877, v18, v19, 0xEu, &v35);
    }
  }
