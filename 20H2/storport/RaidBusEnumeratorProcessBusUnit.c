...
_OWORD *__fastcall RaidBusEnumeratorProcessBusUnit(_QWORD *a1, __int64 a2)
{
  ...
  {
    if ( !v5 )
      return (_OWORD *)StorDeleteScsiIdentity(a2 + 32);
    *(_DWORD *)(a2 + 88) = 1;
  }
  else if ( v5 )
  {
