/*
 * XREFs of RaidAdapterStartDevice @ 0x1C002F830
 * Callers:
 ...
 *     RaidAdapterGetSystemPowerHint @ 0x1C002CB28 (RaidAdapterGetSystemPowerHint.c)
 *     RaidAdapterGetSystemPowerResumeLatency @ 0x1C002CB4C (RaidAdapterGetSystemPowerResumeLatency.c)
 ...
 *     RaidAdapterRegisterNonPoFxMiniportInterface @ 0x1C002DC00 (RaidAdapterRegisterNonPoFxMiniportInterface.c)
 *     RaidAdapterRegisterRpmbInterface @ 0x1C002DC64 (RaidAdapterRegisterRpmbInterface.c)
...
__int64 __fastcall RaidAdapterStartDevice(char *Context, __int64 a2)
{
  ...
  KIRQL v20; // bl
  __int64 v21; // rax
  PVOID *Handle; // [rsp+20h] [rbp-78h]
  unsigned int v23; // [rsp+28h] [rbp-70h]
  _DWORD v24[4]; // [rsp+50h] [rbp-48h] BYREF
  int SystemPowerHint; // [rsp+60h] [rbp-38h]
  int SystemPowerResumeLatency; // [rsp+64h] [rbp-34h]

  if ( WPP_GLOBAL_Control != (PDEVICE_OBJECT)&WPP_GLOBAL_Control
    && (HIDWORD(WPP_GLOBAL_Control->Timer) & 2) != 0
    && BYTE1(WPP_GLOBAL_Control->Timer) >= 4u )
  {
    WPP_SF_qq(WPP_GLOBAL_Control->AttachedDevice, 16LL, &WPP_7de55442f8f2316906ef02cf8f2423cb_Traceguids, Context, a2);
  }
