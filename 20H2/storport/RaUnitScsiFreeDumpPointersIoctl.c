/*
 * XREFs of RaUnitScsiFreeDumpPointersIoctl @ 0x1C0014734
 * Callers:
 ...
 *     StorPortReleaseAdditionalCrashDumpArea @ 0x1C0014B18 (StorPortReleaseAdditionalCrashDumpArea.c)
...
__int64 __fastcall RaUnitScsiFreeDumpPointersIoctl(__int64 a1, IRP *a2, __int64 a3, __int64 a4)
{
  ...
  if ( *(_BYTE *)(a1 + 1733) == 1 && v4 )
  {
    ...
    *((_QWORD *)v8 + 8) = *(_QWORD *)(p_Process + 64);
    ...
    if ( !Srb
      || (ContiguousIoResources = StorAllocateContiguousIoResources(
                                    ((*(_DWORD *)(v4 + 468) + 7) & 0xFFFFFFF8) + 1088,
                                    v17,
                                    v4),
    ...
    *(_QWORD *)(v10 + 656) = RaidXrbSignalCompletion;
    ...
    {
      WPP_SF_qq(WPP_GLOBAL_Control->AttachedDevice, 34LL, &WPP_af1ac7e2487a3dc41c42fd4890c580b6_Traceguids, v10, Srb);
    }
    if ( *(_BYTE *)(v4 + 4514) )
  ...
  if ( *(_WORD *)(v24 + 5154) )
  {
    v26 = *(void (__fastcall **)(_QWORD, _QWORD, _QWORD, __int64))(v24 + 5176);
    if ( v26 )
    {
      v26(*(_QWORD *)(v24 + 5160), v26, 0LL, a4);
      v25 = *(_QWORD *)(a1 + 24);
    }
  }
  StorPortReleaseAdditionalCrashDumpArea(v25 + 728, v16, v5, a4);
