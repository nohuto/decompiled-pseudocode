/*
 * XREFs of RaUnitScsiIrp @ 0x1C0009B80
 * Callers:
 ...
 *     RaUnitSwallowStopUnitCommand @ 0x1C00499A8 (RaUnitSwallowStopUnitCommand.c)
...
LABEL_24:
    ...
    && (v39 = RaUnitSwallowStopUnitCommand(a1)) != 0 )
  {
    ...
    if ( WPP_GLOBAL_Control != (PDEVICE_OBJECT)&WPP_GLOBAL_Control
      ...
      && BYTE1(WPP_GLOBAL_Control->Timer) >= 4u )
    {
      WPP_SF_qq(WPP_GLOBAL_Control->AttachedDevice, 20LL, &WPP_af1ac7e2487a3dc41c42fd4890c580b6_Traceguids, a1, a2);
    }
    return v40;
  }
  else
