/*
 * XREFs of RaidAdapterPowerDownDeviceCompletion @ 0x1C0015720
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall RaidAdapterPowerDownDeviceCompletion(__int64 a1, __int64 a2)
{
  ...
  {
    WPP_SF_qq(WPP_GLOBAL_Control->AttachedDevice, 25LL, &WPP_b3ad513c322230fb96603cfbc644830e_Traceguids, v2, a2);
  }
  if ( *(_BYTE *)(a2 + 65) )
