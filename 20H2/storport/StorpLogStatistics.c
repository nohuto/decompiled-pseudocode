/*
 * XREFs of StorpLogStatistics @ 0x1C000C8B8
 * Callers:
 *     StorpTraceLoggingTelemetryTimerDpcRoutine @ 0x1C000E080 (StorpTraceLoggingTelemetryTimerDpcRoutine.c)
 * Callees:
 ...
 *     RaidGetPortData @ 0x1C000E04C (RaidGetPortData.c)
        ...
        if ( v11 != v8 + 4 )
        {
          do
          {
            if ( (int)RaidAcquireAdapterRemoveLock((__int64)(v11 - 8)) >= 0 )
            {
              ...
              if ( v16 )
              {
                KeAcquireInStackQueuedSpinLock(v11 + 8, &v13);
                for ( i = (__int64 *)v11[9]; i != (__int64 *)(v11 + 9); i = (__int64 *)*i )
              ...
              if ( (a1 & 0x40) != 0 )
                v11[677] = 0LL;
              ExReleaseRundownProtectionCacheAware((PEX_RUNDOWN_REF_CACHE_AWARE)v11[27]);
            }
            v11 = (KSPIN_LOCK *)*v11;
          }
          while ( v11 != v10 );
