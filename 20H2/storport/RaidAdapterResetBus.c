/*
 * XREFs of RaidAdapterResetBus @ 0x1C002E120
 * Callers:
...
__int64 __fastcall RaidAdapterResetBus(__int64 a1, unsigned __int8 a2)
{
  ...
  if ( a2 >= *(_BYTE *)(a1 + 400) )
    return 3221225485LL;
  if ( _InterlockedCompareExchange((volatile signed __int32 *)(a1 + 268), 1, 0) == 1 )
    return 3221226614LL;
  ...
  if ( (qword_1C0069310 & 0x400) != 0 )
    DbgLogRequest(
      *(_QWORD *)(a1 + 320),
      11,
      *(_QWORD *)(a1 + 320),
      *(unsigned int *)(*(_QWORD *)(a1 + 320) + 56LL),
      v2,
      0LL,
      0LL);
  v12 = *(_QWORD *)(a1 + 552);
  ...
  *(_BYTE *)(a1 + 568) &= ~2u;
    ...
    do
    {
      ...
      if ( v19 )
      {
        ExpInterlockedPushEntrySList(
          (PSLIST_HEADER)(*(_QWORD *)(a1 + 4816) + ((unsigned __int64)(HIDWORD(v19[1].Next) % v18) << 6)),
          v19);
        ++v17;
      }
    }
    while ( v17 < *(_DWORD *)(a1 + 4808) );
    v10 = v27;
  }
  ...
  if ( v20 )
  {
    ...
    if ( v20 == 1000000 * (v20 / 0xF4240) )
      v21 = v20 / 0xF4240;
    RaidAdapterSetPauseTimer(a1, a1 + 4280, a1 + 4344, v21);
  }
  else
  {
    v23 = KfRaiseIrql(2u);
  ...
  if ( (unsigned int)dword_1C0069058 > 5 )
  {
    if ( tlgKeywordOn(v22, 0x400000000000LL) )
    {
      ...
      v53 = 4;
      v56 = 4;
      tlgWriteTransfer_EtwWriteTransfer(4LL, (unsigned __int8 *)dword_1C005D672, v24, v25, 9u, &v36);
    }
  }
  *(_DWORD *)(a1 + 268) = 0;
  return v15;
