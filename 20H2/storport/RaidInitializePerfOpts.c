/*
 * XREFs of RaidInitializePerfOpts @ 0x1C0031540
 * Callers:
...
__int64 __fastcall RaidInitializePerfOpts(__int64 a1, char a2, __int64 i)
{
  ...
  if ( !v7 )
  {
    ...
    v15 = 23LL;
LABEL_6:
    WPP_SF_(v14->AttachedDevice, v15, &WPP_7de55442f8f2316906ef02cf8f2423cb_Traceguids);
LABEL_7:
    v13 = -1056964602;
    goto LABEL_116;
  }
    ...
    else
    {
      ...
      if ( v11 && (*(_DWORD *)(v7 + 8) & 4) != 0 )
      {
        ...
        if ( v28 > v31 || v31 > v30 )
        {
          ...
          v18 = 26LL;
LABEL_18:
          WPP_SF_(v17->AttachedDevice, v18, &WPP_7de55442f8f2316906ef02cf8f2423cb_Traceguids);
LABEL_19:
          v13 = -1056964607;
          goto LABEL_116;
        }
