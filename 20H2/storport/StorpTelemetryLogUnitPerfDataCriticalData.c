/*
 * XREFs of StorpTelemetryLogUnitPerfDataCriticalData @ 0x1C00547E4
 * Callers:
...
void __fastcall StorpTelemetryLogUnitPerfDataCriticalData(__int64 a1)
{
  ...
  if ( (unsigned int)dword_1C0069058 > 5 )
  {
    if ( tlgKeywordOn(a1, 0x800000000000LL) )
    {
      ...
      v73 = &v18;
      v11 = v9[40];
      v18 = 3 * qword_1C0069440;
      v75 = v11;
      v76 = 8 * (unsigned __int16)(3 * qword_1C0069440);
      tlgWriteTransfer_EtwWriteTransfer(
        (3 * qword_1C0069440) & 0x1FFFFFFFFFFFFFFFLL,
        (unsigned __int8 *)dword_1C005FEEB,
        v12,
        v13,
        0x1Du,
        &v30);
