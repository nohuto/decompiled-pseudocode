/*
 * XREFs of StorpInitializePerfTelemetry @ 0x1C0052490
 * Callers:
...
__int64 StorpInitializePerfTelemetry()
{
  ...
  unk_1C0069408 = 24LL;
  qword_1C0069440 = 0x34000000022LL;
  v1 = 2LL;
  *(_OWORD *)&xmmword_1C0069430 = 0LL;
  *(&xmmword_1C0069430 + 1) = (PVOID)0x180000000ALL;
  xmmword_1C0069410 = 0LL;
  *(_OWORD *)&P = 0LL;
  *(_QWORD *)&xmmword_1C0069410 = 327682LL;
  *(_OWORD *)&xmmword_1C00693F8 = 0LL;
  *(_OWORD *)&xmmword_1C0069420 = 0LL;
  g_RaidNumberProcessors = KeQueryActiveProcessorCountEx(0xFFFFu);
  LODWORD(Size) = HIDWORD(qword_1C0069440) * g_RaidNumberProcessors;
  if ( UseQPCTime )
    PerformanceCounter = KeQueryPerformanceCounter(0LL);
  else
    PerformanceCounter.QuadPart = KeQueryUnbiasedInterruptTime();
  qword_1C0069450 = PerformanceCounter.QuadPart;
  ...
  {
    xmmword_1C00693F8 = ExAllocatePoolWithTag(
  ...
  {
    xmmword_1C00693F8 = 0LL;
  }
  if ( HIWORD(TelemetryPerfContext) )
  {
    *(&xmmword_1C00693F8 + 1) = ExAllocatePoolWithTag(
                                  NonPagedPoolNxCacheAligned,
  ...
  {
    *(&xmmword_1C00693F8 + 1) = 0LL;
  }
  if ( (_WORD)xmmword_1C0069410 )
  {
    *((_QWORD *)&xmmword_1C0069410 + 1) = ExAllocatePoolWithTag(
                                            NonPagedPoolNxCacheAligned,
                                            8LL * (unsigned __int16)xmmword_1C0069410,
                                            0x65546152u);
  ...
  {
    *((_QWORD *)&xmmword_1C0069410 + 1) = 0LL;
  }
  if ( WORD1(xmmword_1C0069410) )
  {
    xmmword_1C0069420 = ExAllocatePoolWithTag(NonPagedPoolNxCacheAligned, 8LL * WORD1(xmmword_1C0069410), 0x65546152u);
    if ( !xmmword_1C0069420 )
      goto LABEL_34;
  }
  else
  {
    xmmword_1C0069420 = 0LL;
  }
  if ( WORD2(xmmword_1C0069410) )
  {
    *(&xmmword_1C0069420 + 1) = ExAllocatePoolWithTag(
                                  NonPagedPoolNxCacheAligned,
                                  8LL * WORD2(xmmword_1C0069410),
                                  0x65546152u);
  ...
  {
    *(&xmmword_1C0069420 + 1) = 0LL;
  }
  if ( WORD3(xmmword_1C0069410) )
  {
    xmmword_1C0069430 = ExAllocatePoolWithTag(NonPagedPoolNxCacheAligned, 8LL * WORD3(xmmword_1C0069410), 0x65546152u);
...
LABEL_34:
  ...
  do
  {
    *(_QWORD *)(v6 + *((_QWORD *)&xmmword_1C0069410 + 1)) = v7++;
    v6 += 8LL;
    --v1;
  }
  while ( v1 );
  if ( UseQPCTime && g_StorpTraceLoggingPerformanceHighResolutionTimer )
  {
    ...
    *(_QWORD *)xmmword_1C0069420 = (PerformanceFrequency.QuadPart << 6) / 1000;
    *((_QWORD *)xmmword_1C0069420 + 1) = (PerformanceFrequency.QuadPart << 8) / 1000;
    *((_QWORD *)xmmword_1C0069420 + 2) = (PerformanceFrequency.QuadPart << 10) / 1000;
    *((_QWORD *)xmmword_1C0069420 + 3) = 5120 * PerformanceFrequency.QuadPart / 1000;
  }
  else
  {
    *(_QWORD *)*(&P + 1) = 2560LL;
    ...
    *((_QWORD *)*(&P + 1) + 11) = 0x7FFFFFFFFFFFFFFFLL;
    *(_QWORD *)xmmword_1C0069420 = 640000LL;
    *((_QWORD *)xmmword_1C0069420 + 1) = 2560000LL;
    *((_QWORD *)xmmword_1C0069420 + 2) = 10240000LL;
    *((_QWORD *)xmmword_1C0069420 + 3) = 51200000LL;
  }
  *((_QWORD *)xmmword_1C0069420 + 4) = 0x7FFFFFFFFFFFFFFFLL;
  dword_1C0069458 = 64;
  g_RaidNumaHighestNodeNumber = KeQueryHighestNodeNumber();
  LODWORD(dword_1C006945C) = dword_1C0069458 * ((unsigned __int16)g_RaidNumaHighestNodeNumber + 1);
  return v0;
}
