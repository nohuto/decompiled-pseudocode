/*
 * XREFs of RaUnitDeviceUsageNotificationIrp @ 0x1C00142F4
 * Callers:
 ...
 *     RaidSecondaryDumpRegister @ 0x1C0057E28 (RaidSecondaryDumpRegister.c)
 *     RaidNotifyPoAboutSpecialDevice @ 0x1C0058CC0 (RaidNotifyPoAboutSpecialDevice.c)
 */
        ...
        if ( Lock )
        {
          ...
          *(_BYTE *)(v2 + 104) |= 0x80u;
          ...
          if ( (unsigned int)dword_1C0069058 > 5 && tlgKeywordOn(v10, 0x400000000000LL) )
          {
            ...
            tlgWriteTransfer_EtwWriteTransfer((int)&v37, (int)&dword_1C005DE8A, v14, v15, 0xBu, &v37);
          }
        }
        else
        {
