/*
 * XREFs of RaidAdapterGetMiniportDumpInfo @ 0x1C0078780
 * Callers:
 *     RaidAdapterPopulateMiniportDumpInfo @ 0x1C0078C64 (RaidAdapterPopulateMiniportDumpInfo.c)
 * Callees:
    ...
    *(_DWORD *)(a3 + 72) = v4 << 16;
    ...
    if ( Pool )
    {
      ...
      *v9 = 32;
      ...
      Srb = RaidAllocateSrb(*(_QWORD *)(a1 + 8), 0x2Au, *(_BYTE *)(a1 + 426), 0);
      if ( Srb
