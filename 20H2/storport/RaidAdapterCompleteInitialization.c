/*
 * XREFs of RaidAdapterCompleteInitialization @ 0x1C002BA58
 * Callers:
 ...
 *     RaInitializePower @ 0x1C002B0FC (RaInitializePower.c)
 *     StorCreateScsiSymbolicLink @ 0x1C0045CA0 (StorCreateScsiSymbolicLink.c)
 *     RaFreeRaidResources @ 0x1C004DCC0 (RaFreeRaidResources.c)
    ...
    if ( ScsiSymbolicLink >= 0 )
    {
      if ( (unsigned int)dword_1C0069058 > 5 )
      {
        if ( tlgKeywordOn(v10, 0x400000000000LL) )
        {
          ...
          tlgWriteTransfer_EtwWriteTransfer((__int64)&v18, (unsigned __int8 *)dword_1C005D702, v14, v15, 7u, &v18);
        }
      }
