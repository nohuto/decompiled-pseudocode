/*
 * XREFs of StorPortGetPhysicalAddress @ 0x1C001BBA0
 * Callers:
 *     StorPortGetPhysicalAddressVrfy @ 0x1C007F2B0 (StorPortGetPhysicalAddressVrfy.c)
 * Callees:
...
PHYSICAL_ADDRESS __fastcall StorPortGetPhysicalAddress(__int64 a1, __int64 a2, void *a3, unsigned int *a4)
{
  ...
  *a4 = 0;
  ...
  {
    v29 = *(unsigned int *)(v16 + 776);
    if ( (unsigned __int64)a3 < v19 + v29 )
    {
      v30 = (_DWORD)a3 - v19;
      PhysicalAddress.QuadPart = *(_QWORD *)(v16 + 768) + v30;
      v31 = v29 - v30;
LABEL_38:
      *v7 = v31;
  ...
  if ( !a2 )
  {
    if ( !*(_BYTE *)(v16 + 736) || *(_DWORD *)(v16 + 756) != 3 )
    {
      PhysicalAddress = MmGetPhysicalAddress(a3);
      v31 = (*(_DWORD *)(v16 + 468) + 7) & 0xFFFFFFF8;
      goto LABEL_38;
    }
    return PhysicalAddress;
  }
...
LABEL_40:
    ...
    else if ( (*(_BYTE *)(v16 + 4515) & 4) != 0 && (!*(_BYTE *)(v16 + 736) || *(_DWORD *)(v16 + 756) != 3) )
    {
      PhysicalAddress = MmGetPhysicalAddress(a3);
      *v7 = v8 - v34;
    }
