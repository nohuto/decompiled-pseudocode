/*
 * XREFs of StorpTelemetrySendAdaptiveIdleCounters @ 0x1C0002108
 * Callers:
 *     StorpLogPerUnitStatistics @ 0x1C000CA80 (StorpLogPerUnitStatistics.c)
 * Callees:
 *     RaidUnitGetMinimumPowerCyclePeriod @ 0x1C000608C (RaidUnitGetMinimumPowerCyclePeriod.c)
    ...
    if ( (*(_DWORD *)(*(_QWORD *)(a1 + 1744) + 32LL) & 0x100) != 0 )
    {
      ...
      if ( (unsigned int)dword_1C0069058 > 5 )
      {
        if ( (unsigned __int8)tlgKeywordOn(v2, 0x400000000000LL) )
        {
          ...
          v46 = &v20;
          v47 = 8LL;
          tlgWriteTransfer_EtwWriteTransfer(v9, (int)&dword_1C005F0B4, v3, v4, 0xFu, &v21);
        }
      }
