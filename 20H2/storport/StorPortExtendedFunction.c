/*
 * XREFs of StorPortExtendedFunction @ 0x1C000EDC0
 * Callers:
 *     <none>
 * Callees:
 ...
 *     RaidInitializeRpmb @ 0x1C0032580 (RaidInitializeRpmb.c)
 ...
 *     RaMiniportSaveFeatureList @ 0x1C0036F44 (RaMiniportSaveFeatureList.c)
 *     McTemplateK0pqqq_EtwWriteTransfer @ 0x1C003708C (McTemplateK0pqqq_EtwWriteTransfer.c)
 *     RaidAdapterCacheOperationalPowerRange @ 0x1C0037AE8 (RaidAdapterCacheOperationalPowerRange.c)
 ...
 *     StorBuildScatterGatherListProxy @ 0x1C00381DC (StorBuildScatterGatherListProxy.c)
 *     StorDelayExecution @ 0x1C0038240 (StorDelayExecution.c)
 ...
 *     StorpAllocateContiguousMemorySpecifyCacheNode @ 0x1C003A8EC (StorpAllocateContiguousMemorySpecifyCacheNode.c)
 ...
 *     StorpFlushDataBufferMdl @ 0x1C003B250 (StorpFlushDataBufferMdl.c)
 ...
 *     StorpGetActiveNodeCount @ 0x1C003B8E0 (StorpGetActiveNodeCount.c)
 *     StorpGetDataInSgList @ 0x1C003B974 (StorpGetDataInSgList.c)
 *     StorpGetGroupAffinity @ 0x1C003BBAC (StorpGetGroupAffinity.c)
 *     StorpGetMSIInfo @ 0x1C003BC08 (StorpGetMSIInfo.c)
 *     StorpGetOriginalMdl @ 0x1C003BCF0 (StorpGetOriginalMdl.c)
 *     StorpGetPfns @ 0x1C003BD70 (StorpGetPfns.c)
 *     StorpGetRequestInfo @ 0x1C003BE10 (StorpGetRequestInfo.c)
        ...
        __int64 a11)
{
  ...
  {
    WPP_SF_D(WPP_GLOBAL_Control->AttachedDevice, 79LL, &WPP_42621249f2c9312d441c8bf8760aa631_Traceguids, a1);
    v13 = a2;
  }
  v17 = 0x1C0000000uLL;
  switch ( a1 )
  {
    ...
    case 1u:
      ...
      else
      {
        ...
        WPP_SF_(WPP_GLOBAL_Control->AttachedDevice, 30LL, &WPP_42621249f2c9312d441c8bf8760aa631_Traceguids);
        return 3238002696LL;
      }
    case 2u:
    ...
    case 8u:
      ...
      else
      {
          ...
          && BYTE1(WPP_GLOBAL_Control->Timer) >= 2u )
        {
          v20 = 45LL;
LABEL_13:
          WPP_SF_(v19->AttachedDevice, v20, &WPP_42621249f2c9312d441c8bf8760aa631_Traceguids);
          return 3238002694LL;
        }
      }
      return 3238002694LL;
...
LABEL_243:
    ...
    default:
      if ( WPP_GLOBAL_Control != (PDEVICE_OBJECT)&WPP_GLOBAL_Control
        ...
        && BYTE1(WPP_GLOBAL_Control->Timer) >= 2u )
      {
        WPP_SF_D(WPP_GLOBAL_Control->AttachedDevice, 80LL, &WPP_42621249f2c9312d441c8bf8760aa631_Traceguids, a1);
      }
      return v14;
  }
}
