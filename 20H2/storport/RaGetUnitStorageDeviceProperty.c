/*
 * XREFs of RaGetUnitStorageDeviceProperty @ 0x1C0072664
 * Callers:
 *     RaUnitStorageQueryDevicePropertyIoctl @ 0x1C0072600 (RaUnitStorageQueryDevicePropertyIoctl.c)
 * Callees:
 *     RaidRemoveTrailingBlanks @ 0x1C000BF28 (RaidRemoveTrailingBlanks.c)
...
LABEL_25:
  ...
  v11 = *(__int128 **)(a1 + 144);
  if ( !v11 || (*(_DWORD *)(*(_QWORD *)(*(_QWORD *)(a1 + 24) + 552LL) + 184LL) & 0x40) == 0 )
  {
    v12 = *((_OWORD *)v3 + 1);
    Src[5] = *((_QWORD *)v3 + 1);
    v13 = *((_DWORD *)v3 + 8);
