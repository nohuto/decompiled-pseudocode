/*
 * XREFs of RaUnitTelemetryIdIoctl @ 0x1C001A410
 * Callers:
...
LABEL_13:
  ...
  *(_OWORD *)&MasterIrp->AssociatedIrp.MasterIrp = *(_OWORD *)(*(_QWORD *)(a1 + 24) + 5192LL);
  ...
  if ( (unsigned int)dword_1C0069058 > 5 && tlgKeywordOn(Length, 0x400000000000LL) )
  {
    v10 = *(_QWORD *)(v8 + 24);
    v19 = 16LL;
    v20 = v9;
    ...
    v27 = 1LL;
    v29 = 1LL;
    tlgWriteTransfer_EtwWriteTransfer(v10, (int)&dword_1C005DC62, v7, v8, 8u, &v17);
  }
  v11 = 0;
  return RaidCompleteRequestEx(a2, 0, v11);
}
