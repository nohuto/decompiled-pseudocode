/*
 * XREFs of StorPortGetUncachedExtension @ 0x1C00393E0
 * Callers:
 ...
 *     RaidDmaAllocateUncachedExtension @ 0x1C0033CD0 (RaidDmaAllocateUncachedExtension.c)
 *     StorpUpdateUncachedExtensionAllocationRegion @ 0x1C003D448 (StorpUpdateUncachedExtensionAllocationRegion.c)
 *     RaidInitializeDma @ 0x1C0079FB4 (RaidInitializeDma.c)
 *     RaidIsDmaInitialized @ 0x1C007A13C (RaidIsDmaInitialized.c)
 */
      ...
      else
      {
        if ( *(_BYTE *)(a2 + 144) != 3 )
        {
          if ( *(_BYTE *)(a2 + 144) == 4 )
          {
            ...
            *(_QWORD *)(v7 + 4448) = 0x100000000LL;
            *(_QWORD *)(v7 + 4464) = v11;
            StorpUpdateUncachedExtensionAllocationRegion(v7, &v20);
            v4 = v20;
          }
LABEL_27:
...
LABEL_31:
            if ( *(_BYTE *)(a2 + 144) == 4 )
            {
              ...
              *(_QWORD *)(v7 + 4440) = v15;
              *(_QWORD *)(v7 + 4432) = v16;
              if ( (unsigned int)Feature_Servicing_2206C_37999740__private_IsEnabled() )
              {
                if ( !*(_QWORD *)(v7 + 112) )
