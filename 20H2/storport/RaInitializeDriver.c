/*
 * XREFs of RaInitializeDriver @ 0x1C007A29C
 * Callers:
 *     StorPortInitialize @ 0x1C0035C40 (StorPortInitialize.c)
 * Callees:
 *     McGenEventRegister_EtwRegister @ 0x1C0033EE8 (McGenEventRegister_EtwRegister.c)
 *     RaidAddPortDriver @ 0x1C003530C (RaidAddPortDriver.c)
