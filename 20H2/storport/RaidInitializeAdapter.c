/*
 * XREFs of RaidInitializeAdapter @ 0x1C0079570
 * Callers:
 ...
 *     RaidAllocateDeviceProperty @ 0x1C00304A8 (RaidAllocateDeviceProperty.c)
 ...
 *     StorpInitializeAdapterTelemetry @ 0x1C0052404 (StorpInitializeAdapterTelemetry.c)
  ...
  *(_DWORD *)(a1 + 336) = v15;
  ...
  if ( (int)result >= 0 )
  {
    ...
    *(UUID *)(a1 + 5192) = Uuid;
    ...
    if ( (unsigned int)dword_1C0069058 > 5 && tlgKeywordOn(v41, 0x400000000000LL) )
    {
      v52 = *(_DWORD *)(a1 + 2216);
      ...
      *(_QWORD *)&v66[12].Size = 1LL;
      tlgWriteTransfer_EtwWriteTransfer(v42, (unsigned __int8 *)dword_1C005D581, v43, v44, 0xDu, v66);
    }
    KeInitializeDpc(
