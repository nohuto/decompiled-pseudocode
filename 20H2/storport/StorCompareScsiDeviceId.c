/*
 * XREFs of StorCompareScsiDeviceId @ 0x1C0013BF4
 * Callers:
 *     StorCompareScsiIdentity @ 0x1C00185E0 (StorCompareScsiIdentity.c)
 *     RaidCheckEnclosureIdMapping @ 0x1C003540C (RaidCheckEnclosureIdMapping.c)
 * Callees:
 *     StorGetNextVPDIdDescriptor @ 0x1C0013D58 (StorGetNextVPDIdDescriptor.c)
 *     StorInitVPDIdEnumeration @ 0x1C0013DA8 (StorInitVPDIdEnumeration.c)
 *     __security_check_cookie @ 0x1C001CB10 (__security_check_cookie.c)
 *     __report_rangecheckfailure @ 0x1C001CB50 (__report_rangecheckfailure.c)
