/*
 * XREFs of ATAShimGetMsftId @ 0x1C0058190
 * Callers:
 *     ATADeviceIdShimStorageDeviceIdCompletionHook @ 0x1C0058120 (ATADeviceIdShimStorageDeviceIdCompletionHook.c)
 * Callees:
 *     __security_check_cookie @ 0x1C001CB10 (__security_check_cookie.c)
 *     RaidAddATADeviceIdMapping @ 0x1C00350A4 (RaidAddATADeviceIdMapping.c)
 *     RaidCheckATADeviceIdMapping @ 0x1C0035390 (RaidCheckATADeviceIdMapping.c)
 *     RaidSaveATADeviceIdMapping @ 0x1C0035938 (RaidSaveATADeviceIdMapping.c)
 *     TrimString @ 0x1C0058940 (TrimString.c)
 */
