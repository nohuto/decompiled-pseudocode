/*
 * XREFs of RaidAdapterPostScatterGatherExecute @ 0x1C0004FF0
 * Callers:
 ...
 * Callees:
 *     RaidLogGetParm4 @ 0x1C00056B0 (RaidLogGetParm4.c)
 ...
 *     RaAllocateConcurrentChannelToken @ 0x1C002AD78 (RaAllocateConcurrentChannelToken.c)
 */
