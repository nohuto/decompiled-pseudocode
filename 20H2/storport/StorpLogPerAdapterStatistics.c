/*
 * XREFs of StorpLogPerAdapterStatistics @ 0x1C000E678
 * Callers:
 ...
 *     StorpInitializeHierarchicalResetBuckets @ 0x1C000E7AC (StorpInitializeHierarchicalResetBuckets.c)
...
void __fastcall StorpLogPerAdapterStatistics(__int64 a1)
{
    ...
    && tlgKeywordOn(v2, 0x400000000000LL) )
  {
    ...
    v59 = 4LL;
    v61 = 1LL;
    tlgWriteTransfer_EtwWriteTransfer(v5, (int)&dword_1C005F365, v6, v7, 0x13u, &v27);
  }
    ...
    && tlgKeywordOn(v3, 0x400000000000LL) )
  {
    ...
    v59 = 4LL;
    v61 = 1LL;
    tlgWriteTransfer_EtwWriteTransfer(v8, (int)&dword_1C00602E5, v9, v10, 0x13u, &v27);
  }
