/*
 * XREFs of StorpTelemetryLogUnitPerfDataMeasures @ 0x1C000DC7C
 * Callers:
...
void __fastcall StorpTelemetryLogUnitPerfDataMeasures(__int64 a1)
{
  ...
  if ( (unsigned int)dword_1C0069058 > 5 )
  {
    if ( (unsigned __int8)tlgKeywordOn(a1, 0x400000000000LL) )
    {
      ...
      v80 = &v20;
      v12 = v10[40];
      v20 = 3 * qword_1C0069440;
      v82 = v12;
      v83 = 8 * (unsigned __int16)(3 * qword_1C0069440);
      tlgWriteTransfer_EtwWriteTransfer(3 * qword_1C0069440, (int)&dword_1C005EC77, v13, v14, 0x1Fu, &v32);
    }
  }
}
