/*
 * XREFs of StorpLogPhysicalTopologyInfo @ 0x1C0052B98
 * Callers:
...
char __fastcall StorpLogPhysicalTopologyInfo(__int64 a1, __int64 a2, unsigned int a3)
{
  ...
  v11 = *(_DWORD *)(a2 + 8);
  if ( (unsigned int)dword_1C0069058 > 5 && tlgKeywordOn(v8, 0x400000000000LL) )
  {
    v55 = 16LL;
    v54 = a1 + 5192;
    ...
    v48 = v7;
    v62 = 4LL;
    tlgWriteTransfer_EtwWriteTransfer(v13, (unsigned __int8 *)dword_1C005F4C8, v14, v15, 7u, &v53);
    v11 = *(_DWORD *)(a2 + 8);
  }
  LOBYTE(v16) = v11;
                ...
                if ( (unsigned int)dword_1C0069058 > 5 )
                {
                  ...
                  if ( (_BYTE)v16 )
                  {
                    ...
                    LOBYTE(v16) = tlgWriteTransfer_EtwWriteTransfer(
                                    (__int64)v81,
                                    (unsigned __int8 *)dword_1C005F544,
                                    v26,
                                    v27,
                                    0xBu,
                                    &v53);
                    ...
                    *(_OWORD *)v81 = v38;
                    if ( (unsigned int)dword_1C0069058 > 5 )
                    {
                      ...
                      if ( (_BYTE)v16 )
                      {
                        ...
                        LOBYTE(v16) = tlgWriteTransfer_EtwWriteTransfer(
                                        (__int64)v81,
                                        (unsigned __int8 *)dword_1C005E349,
                                        -1LL,
                                        v39,
                                        0xEu,
                                        &v53);
