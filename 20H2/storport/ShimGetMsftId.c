/*
 * XREFs of ShimGetMsftId @ 0x1C0058600
 * Callers:
 *     DeviceIdShimStorageDeviceIdCompletionHook @ 0x1C0058400 (DeviceIdShimStorageDeviceIdCompletionHook.c)
 * Callees:
 *     __security_check_cookie @ 0x1C001CB10 (__security_check_cookie.c)
 *     RaidAddEnclosureIdMapping @ 0x1C00351E0 (RaidAddEnclosureIdMapping.c)
 *     RaidCheckEnclosureIdMapping @ 0x1C003540C (RaidCheckEnclosureIdMapping.c)
 *     RaidSaveEnclosureIdMapping @ 0x1C0035A7C (RaidSaveEnclosureIdMapping.c)
 *     PortRegistryReadDeviceKey @ 0x1C00732D4 (PortRegistryReadDeviceKey.c)
