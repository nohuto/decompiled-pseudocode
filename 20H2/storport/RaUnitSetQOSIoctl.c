/*
 * XREFs of RaUnitSetQOSIoctl @ 0x1C0047B54
 * Callers:
 *     RaUnitDeviceControlIrp @ 0x1C000B1A8 (RaUnitDeviceControlIrp.c)
 * Callees:
 *     RaidCompleteRequestEx @ 0x1C0008FD0 (RaidCompleteRequestEx.c)
 *     RaidAdapterEnableQosWaitTimeoutCheck @ 0x1C002C718 (RaidAdapterEnableQosWaitTimeoutCheck.c)
 ...
 *     RaidUnitDisableWaitCheckTimer @ 0x1C004A660 (RaidUnitDisableWaitCheckTimer.c)
  ...
  if ( v6 )
  {
    ...
    if ( v7 )
    {
      if ( v7 != 20 )
      {
        ...
        v9 = 40;
LABEL_83:
        WPP_SF_q((__int64)v8->AttachedDevice, v9, (__int64)&WPP_af1ac7e2487a3dc41c42fd4890c580b6_Traceguids, a1);
LABEL_84:
        v5 = -1073741637;
        goto LABEL_85;
      }
  ...
  if ( Flags != -1 && Flags != 500 * (Flags / 0x1F4) )
  {
    ...
    v17 = 46;
LABEL_77:
    WPP_SF_q((__int64)v16->AttachedDevice, v17, (__int64)&WPP_af1ac7e2487a3dc41c42fd4890c580b6_Traceguids, a1);
LABEL_78:
    v5 = -1073741811;
    goto LABEL_85;
  }
