/*
 * XREFs of RaidUnitSetSystemPowerIrp @ 0x1C00124A8
 * Callers:
...
__int64 __fastcall RaidUnitSetSystemPowerIrp(__int64 a1, IRP *a2, __int64 a3)
{
  ...
  *(_DWORD *)(a1 + 496) = EaLength;
  ...
  {
    WPP_SF_qqD(WPP_GLOBAL_Control->AttachedDevice, 57LL, &WPP_b3ad513c322230fb96603cfbc644830e_Traceguids, a1, a2, v13);
  }
  return v13;
}
