/*
 * XREFs of ??0?$CComAggObject@VCCrossProcessClientOutputEndpoint@@@ATL@@QEAA@PEAX@Z @ 0x14005AE54
 * Callers:
 ...
 *     ??0CCrossProcessClientOutputEndpoint@@QEAA@XZ @ 0x14005B418 (--0CCrossProcessClientOutputEndpoint@@QEAA@XZ.c)
 */
