/*
 * XREFs of ??0CpuManager@@QEAA@XZ @ 0x14001387C
 * Callers:
 ...
 *     ??0?$RuntimeClass@U?$RuntimeClassFlags@$01@WRL@Microsoft@@UIUnknown@@@WRL@Microsoft@@QEAA@XZ @ 0x140013750 (--0-$RuntimeClass@U-$RuntimeClassFlags@$01@WRL@Microsoft@@UIUnknown@@@WRL@Microsoft@@QEAA@XZ.c)
 *     ??0HandleRegistrations@CpuManager@@QEAA@XZ @ 0x140013924 (--0HandleRegistrations@CpuManager@@QEAA@XZ.c)
 */
