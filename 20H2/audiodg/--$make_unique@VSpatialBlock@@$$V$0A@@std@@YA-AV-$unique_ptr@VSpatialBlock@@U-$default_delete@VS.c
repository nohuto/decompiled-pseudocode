/*
 * XREFs of ??$make_unique@VSpatialBlock@@$$V$0A@@std@@YA?AV?$unique_ptr@VSpatialBlock@@U?$default_delete@VSpatialBlock@@@std@@@0@XZ @ 0x140068880
 * Callers:
 ...
 * Callees:
 *     ??0_unnamed_type__changeSet_@SpatialBlock@@QEAA@XZ @ 0x14001C704 (--0_unnamed_type__changeSet_@SpatialBlock@@QEAA@XZ.c)
