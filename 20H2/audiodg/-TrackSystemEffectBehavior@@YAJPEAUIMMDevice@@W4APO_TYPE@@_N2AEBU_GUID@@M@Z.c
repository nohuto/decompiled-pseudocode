/*
 * XREFs of ?TrackSystemEffectBehavior@@YAJPEAUIMMDevice@@W4APO_TYPE@@_N2AEBU_GUID@@M@Z @ 0x14000B080
 * Callers:
...
__int64 __fastcall TrackSystemEffectBehavior(__int64 a1, int a2, char a3, unsigned __int8 a4, __int64 a5, float a6)
{
  ...
  if ( dword_1400904E4 > *(_DWORD *)(*ThreadLocalStoragePointer + 4) )
  {
    Init_thread_header(&dword_1400904E4);
    if ( dword_1400904E4 == -1 )
    {
      xmmword_140090104 = PKEY_Endpoint_LFX_FailCount;
      dword_140090114 = 9;
      xmmword_140090118 = PKEY_Endpoint_GFX_FailCount;
      dword_140090128 = 8;
      xmmword_14009012C = PKEY_Endpoint_EFX_FailCount;
      dword_14009013C = 31;
      Init_thread_footer(&dword_1400904E4);
    }
  }
  if ( dword_1400904E0 > *(_DWORD *)(v11 + 4) )
  {
    Init_thread_header(&dword_1400904E0);
    if ( dword_1400904E0 == -1 )
    {
      xmmword_1400900B4 = PKEY_Endpoint_LFX_ExceptionCount;
      dword_1400900C4 = 33;
      xmmword_1400900C8 = PKEY_Endpoint_GFX_ExceptionCount;
      dword_1400900D8 = 34;
      xmmword_1400900DC = PKEY_Endpoint_EFX_ExceptionCount;
      dword_1400900EC = 35;
      Init_thread_footer(&dword_1400904E0);
    }
  }
  if ( !(_DWORD)v8 )
  {
  ...
  if ( !byte_140090098 )
  {
    ...
    if ( !RegGetValueW(
            ...
            &pvData,
            &pcbData) )
      byte_140090140 = (_DWORD)pvData != 0;
    byte_140090098 = 1;
  }
  if ( byte_140090140 )
  {
