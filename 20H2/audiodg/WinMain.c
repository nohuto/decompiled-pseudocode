 ...
 *     McGenEventRegister_EtwEventRegister @ 0x140014D4C (McGenEventRegister_EtwEventRegister.c)
 *     WppInitUm @ 0x140014D8C (WppInitUm.c)
 *     WPP_SF_D @ 0x14003E95C (WPP_SF_D.c)
 *     WPP_SF_S @ 0x14003E9A0 (WPP_SF_S.c)
