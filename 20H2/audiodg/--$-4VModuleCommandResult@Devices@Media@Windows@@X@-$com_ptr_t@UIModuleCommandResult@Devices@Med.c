/*
 * XREFs of ??$?4VModuleCommandResult@Devices@Media@Windows@@X@?$com_ptr_t@UIModuleCommandResult@Devices@Media@Windows@@Uerr_returncode_policy@wil@@@wil@@QEAAAEAV01@$$QEAV?$ComPtr@VModuleCommandResult@Devices@Media@Windows@@@WRL@Microsoft@@@Z @ 0x14001EDD8
 * Callers:
