/*
 * XREFs of ?StopStream@CSubmixImpl@@UEAAJ_K@Z @ 0x140004940
 * Callers:
 *     ?StopStream@CProcessSubmix@@UEAAJ_K@Z @ 0x1400043B0 (-StopStream@CProcessSubmix@@UEAAJ_K@Z.c)
 *     ?StopStream@CStreamGroup@@UEAAJ_K@Z @ 0x14003E740 (-StopStream@CStreamGroup@@UEAAJ_K@Z.c)
 * Callees:
