/*
 * XREFs of ?CreateInstance@?$CComCreator@V?$CComAggObject@VCProcessSubmix@@@ATL@@@ATL@@SAJPEAXAEBU_GUID@@PEAPEAX@Z @ 0x14004F5AC
 * Callers:
        ...
        _QWORD *a3)
{
  ...
  if ( v9 )
  {
    v10 = ATL::CComCriticalSection::Init((struct _RTL_CRITICAL_SECTION *)(v9 + 368));
    if ( v10 >= 0 )
    {
      *(_BYTE *)(v9 + 408) = 1;
      v10 = 0;
