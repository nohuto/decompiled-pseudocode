/*
 * XREFs of ?GetLatency@CPipeInstance@@QEBAJPEA_J@Z @ 0x140008230
 * Callers:
      ...
      if ( *(_DWORD *)(v5 + 40) == 2 )
      {
        ...
        if ( *(_DWORD *)(v8 + 4) )
        {
            ...
            && fPending )
          {
            ...
            qword_140090460 = qword_140090470;
            byte_140090468 = 1;
            TraceLoggingRegisterEx_EtwEventRegister_EtwEventSetInformation();
            dword_14009046C = 1;
            (*(void (__fastcall **)(__int64 *))(qword_140090458 + 8))(&qword_140090458);
            InitOnceComplete(&`AudioDgTelemetryProvider::Instance'::`2'::wrapper, 0, &qword_140090458);
          }
