/*
 * XREFs of ??0CCrossProcessBaseEndpoint@@IEAA@XZ @ 0x140016D2C
 * Callers:
 *     ??0CCrossProcessServerInputEndpoint@@QEAA@XZ @ 0x140016C3C (--0CCrossProcessServerInputEndpoint@@QEAA@XZ.c)
 *     ??0CCrossProcessBaseClientEndpoint@@QEAA@XZ @ 0x14005B294 (--0CCrossProcessBaseClientEndpoint@@QEAA@XZ.c)
 *     ??0CCrossProcessBaseServerEndpoint@@QEAA@W4__MIDL___MIDL_itf_mmdeviceapi_0000_0000_0001@@@Z @ 0x14005B308 (--0CCrossProcessBaseServerEndpoint@@QEAA@W4__MIDL___MIDL_itf_mmdeviceapi_0000_0000_0001@@@Z.c)
 * Callees:
 *     ?Clear@?$CAggregateTelemetry@V?$CAggregateValuesClusteredBase@W4CpGlitchEvent@@PEAI@@W4CpGlitchEvent@@PEAI$0A@$0A@@@UEAAXXZ @ 0x140016EC0 (-Clear@-$CAggregateTelemetry@V-$CAggregateValuesClusteredBase@W4CpGlitchEvent@@PEAI@@W4CpGlitchE.c)
 *     ??0CCriticalSection@ATL@@QEAA@XZ @ 0x140016EF8 (--0CCriticalSection@ATL@@QEAA@XZ.c)
