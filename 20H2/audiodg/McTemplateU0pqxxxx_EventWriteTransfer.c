/*
 * XREFs of McTemplateU0pqxxxx_EventWriteTransfer @ 0x14006177C
 * Callers:
 ...
 *     ?GetDevicePosition@CCrossProcessClientOutputEndpoint@@UEAAJPEA_K0@Z @ 0x140062B20 (-GetDevicePosition@CCrossProcessClientOutputEndpoint@@UEAAJPEA_K0@Z.c)
