/*
 * XREFs of ??0?$CComAggObject@VCSpatialCrossProcessServerInputEndpoint@@@ATL@@QEAA@PEAX@Z @ 0x140064FB0
 * Callers:
 ...
 *     ??0CSpatialCrossProcessServerInputEndpoint@@QEAA@XZ @ 0x1400655E4 (--0CSpatialCrossProcessServerInputEndpoint@@QEAA@XZ.c)
 */
