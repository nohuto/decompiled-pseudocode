/*
 * XREFs of ?GetObjectsAvailableForProcessing@CSpatialCrossProcessBaseEndpoint@@IEAAJPEAI0@Z @ 0x140069CAC
 * Callers:
        ...
        unsigned int *a3)
{
  ...
  *a2 = 0;
  ...
  else
  {
    ...
    v9 = _InterlockedCompareExchange((volatile signed __int32 *)(*((_QWORD *)this + 161) + 4LL * *a2 + 24), 0, 0);
    if ( v9 > v8 )
    {
      Index = -2147418113;
LABEL_7:
