/*
 * XREFs of ?CreateInstance@?$CComCreator@V?$CComAggObject@VCVpoContext@@@ATL@@@ATL@@SAJPEAXAEBU_GUID@@PEAPEAX@Z @ 0x14004DD54
 * Callers:
 ...
 *     ??0?$CComAggObject@VCVpoContext@@@ATL@@QEAA@PEAX@Z @ 0x14004D9D8 (--0-$CComAggObject@VCVpoContext@@@ATL@@QEAA@PEAX@Z.c)
 */
