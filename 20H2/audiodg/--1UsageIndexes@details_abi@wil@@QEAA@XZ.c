/*
 * XREFs of ??1UsageIndexes@details_abi@wil@@QEAA@XZ @ 0x14002105C
 * Callers:
 ...
 *     _wil::details_abi::FeatureStateData::ProcessShutdown_::_1_::dtor$0 @ 0x14002530F (_wil--details_abi--FeatureStateData--ProcessShutdown_--_1_--dtor$0.c)
 *     ?RecordUsage@FeatureStateData@details_abi@wil@@QEAAXXZ @ 0x140025D84 (-RecordUsage@FeatureStateData@details_abi@wil@@QEAAXXZ.c)
 *     _wil::details_abi::FeatureStateData::RecordUsage_::_1_::dtor$0 @ 0x140025DE4 (_wil--details_abi--FeatureStateData--RecordUsage_--_1_--dtor$0.c)
 * Callees:
