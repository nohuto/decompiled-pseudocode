/*
 * XREFs of ??$GetActivationFactory@UIDataReaderStatics@Streams@Storage@Windows@@@Foundation@Windows@@YAJPEAUHSTRING__@@PEAPEAUIDataReaderStatics@Streams@Storage@1@@Z @ 0x140053BE0
 * Callers:
