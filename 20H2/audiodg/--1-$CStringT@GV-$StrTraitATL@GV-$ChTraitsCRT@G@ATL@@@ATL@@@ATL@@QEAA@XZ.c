/*
 * XREFs of ??1?$CStringT@GV?$StrTraitATL@GV?$ChTraitsCRT@G@ATL@@@ATL@@@ATL@@QEAA@XZ @ 0x140041788
 * Callers:
 *     _CSystemAudioDeviceCollection::Add_::_1_::dtor$1 @ 0x14002BED7 (_CSystemAudioDeviceCollection--Add_--_1_--dtor$1.c)
 * Callees:
 *     <none>
 */
