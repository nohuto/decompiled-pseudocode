/*
 * XREFs of ?RegisterProcess@GraphStreamingResourceManager@@UEAAJPEAXPEAPEAUProcessRegistrationToken__@@@Z @ 0x140003B60
 * Callers:
 *     <none>
 * Callees:
        ...
        struct ProcessRegistrationToken__ **a3)
{
  ...
  __int64 Node; // rax
  struct ProcessRegistrationToken__ *v9; // rbx
  int v10; // edi
  ...
  Node = ATL::CAtlMap<unsigned long,GraphStreamingResourceManager::HandleRegistrations::ListValue,ATL::CElementTraits<unsigned long>,ATL::CElementTraits<GraphStreamingResourceManager::HandleRegistrations::ListValue>>::GetNode(
           ...
           (unsigned int)&v19,
           (__int64)v18);
  v9 = (struct ProcessRegistrationToken__ *)Node;
  if ( Node )
  {
  ...
  else
  {
    ...
    v16 = 0LL;
    LODWORD(v15) = 1;
    v9 = (struct ProcessRegistrationToken__ *)ATL::CAtlMap<unsigned long,GraphStreamingResourceManager::HandleRegistrations::ListValue,ATL::CElementTraits<unsigned long>,ATL::CElementTraits<GraphStreamingResourceManager::HandleRegistrations::ListValue>>::SetAt(
                                                (char *)this + 56,
                                                ProcessId,
                                                &v15);
    v10 = (*(__int64 (__fastcall **)(char *, void *, __int64))(*((_QWORD *)this - 1) + 32LL))(
            (char *)this - 8,
            a2,
            (__int64)v9 + 16);
    if ( v10 < 0 )
