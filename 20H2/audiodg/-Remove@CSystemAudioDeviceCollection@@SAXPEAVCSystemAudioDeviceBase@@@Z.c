/*
 * XREFs of ?Remove@CSystemAudioDeviceCollection@@SAXPEAVCSystemAudioDeviceBase@@@Z @ 0x140001D94
 * Callers:
...
LABEL_7:
  ...
  {
    v3 = (struct CSystemAudioDeviceBase **)qword_140090370;
    while ( *v3 != a1 )
    {
      ++v2;
      ++v3;
      if ( v2 >= (int)qword_140090378 )
        goto LABEL_7;
    }
  }
  if ( v2 != -1 )
