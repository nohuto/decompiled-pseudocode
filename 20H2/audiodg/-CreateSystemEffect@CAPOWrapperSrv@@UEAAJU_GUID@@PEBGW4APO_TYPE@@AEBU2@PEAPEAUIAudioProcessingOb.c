/*
 * XREFs of ?CreateSystemEffect@CAPOWrapperSrv@@UEAAJU_GUID@@PEBGW4APO_TYPE@@AEBU2@PEAPEAUIAudioProcessingObject@@@Z @ 0x140009F50
 * Callers:
 *     <none>
 * Callees:
 ...
 *     ??0CSystemEffectWrapper@@QEAA@XZ @ 0x14000AF8C (--0CSystemEffectWrapper@@QEAA@XZ.c)
