/*
 * XREFs of ?EnableMMCSS@CSystemAudioDeviceSharedBase@@IEAAJXZ @ 0x1400437D8
 * Callers:
 ...
 * Callees:
 *     ?SetEngineThreadPriority@@YAJW4AudioThreadPriorityLevel@@PEAPEAX@Z @ 0x1400517F8 (-SetEngineThreadPriority@@YAJW4AudioThreadPriorityLevel@@PEAPEAX@Z.c)
 */
