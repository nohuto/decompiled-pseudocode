/*
 * XREFs of ?GetDisplayNode@@YAJAEAV?$CAtlList@PEAVCDisplayNode@@V?$CElementTraits@PEAVCDisplayNode@@@ATL@@@ATL@@PEAVCProcessNode@@PEAPEAVCDisplayNode@@@Z @ 0x14004C36C
 * Callers:
...
__int64 __fastcall GetDisplayNode(__int64 *a1, __int64 a2, CDisplayNode **a3)
{
  ...
  ATL::CAtlException *v14; // [rsp+20h] [rbp-38h] BYREF
  ...
  if ( v15 )
  {
    while ( 1 )
    {
      Next = (CDisplayNode **)ATL::CAtlList<CDisplayNode *,ATL::CElementTraits<CDisplayNode *>>::GetNext(a1, &v15);
      v8 = *Next;
      if ( *(_QWORD *)*Next == a2 )
        break;
      if ( !v15 )
  ...
  *v3 = v8;
  if ( !v8 )
  {
    ...
    try
    {
      ...
      v15 = (__int64)v11;
      v6 = 0;
      ATL::CAtlList<CStreamInstance *,ATL::CElementTraits<CStreamInstance *>>::AddHead(a1, (__int64)&v15, v10);
    }
