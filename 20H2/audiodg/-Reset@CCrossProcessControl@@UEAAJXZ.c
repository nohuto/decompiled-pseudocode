/*
 * XREFs of ?Reset@CCrossProcessControl@@UEAAJXZ @ 0x1400610D0
 * Callers:
 *     <none>
 * Callees:
 *     ?DrainAndResetQueue@CCrossProcessBaseEndpoint@@IEAAXXZ @ 0x140060348 (-DrainAndResetQueue@CCrossProcessBaseEndpoint@@IEAAXXZ.c)
