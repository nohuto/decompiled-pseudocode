/*
 * XREFs of XWinRT::detail::AtomicUpdates::AtomicUpdate__lambda_e3c6fb090615ba5f6d24ed4c991f4fba___lambda_2b4e95c994fbfcf834a48c0377dad5b5___ @ 0x1400537E4
 * Callers:
        ...
        _BYTE ***a3)
{
  ...
  while ( 1 )
  {
    v7 = lambda_ff31f237a5f513eedfcdc5d7eb333a7b_::operator()(a2, v3, &v11);
    if ( v7 < 0 )
      break;
