/*
 * XREFs of ?SetEngineThreadPriority@@YAJW4AudioThreadPriorityLevel@@PEAPEAX@Z @ 0x1400517F8
 * Callers:
 *     ?EnableMMCSS@CSystemAudioDeviceSharedBase@@IEAAJXZ @ 0x1400437D8 (-EnableMMCSS@CSystemAudioDeviceSharedBase@@IEAAJXZ.c)
 * Callees:
 *     ?ResetEngineThreadPriority@@YAJPEAPEAX@Z @ 0x140051798 (-ResetEngineThreadPriority@@YAJPEAPEAX@Z.c)
 */
