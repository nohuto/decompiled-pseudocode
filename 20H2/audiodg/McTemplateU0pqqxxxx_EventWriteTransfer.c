/*
 * XREFs of McTemplateU0pqqxxxx_EventWriteTransfer @ 0x140061638
 * Callers:
 *     ?SetCurrentTimeStamp@CCrossProcessBaseEndpoint@@MEAAXPEAUAE_CURRENT_POSITION@@_J@Z @ 0x140015FF0 (-SetCurrentTimeStamp@CCrossProcessBaseEndpoint@@MEAAXPEAUAE_CURRENT_POSITION@@_J@Z.c)
 * Callees:
