/*
 * XREFs of ?GetDescription@CProtectedOutputController@@UEAAJPEAKPEAU_GUID@@0PEAPEAU2@@Z @ 0x140048590
 * Callers:
 *     <none>
 * Callees:
        ...
        struct _GUID **a5)
{
  ...
  {
    WPP_SF_D(*((_QWORD *)WPP_GLOBAL_Control + 2), 0xBu, (__int64)&WPP_8a78b0fe90e638a027f0a1224aa299fc_Traceguids, v5);
  }
