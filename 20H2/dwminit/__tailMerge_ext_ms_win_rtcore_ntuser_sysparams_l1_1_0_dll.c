/*
 * XREFs of __tailMerge_ext_ms_win_rtcore_ntuser_sysparams_l1_1_0_dll @ 0x180005AE8
 * Callers:
 *     __imp_load_EnumDisplayDevicesW @ 0x180005ADC (__imp_load_EnumDisplayDevicesW.c)
 * Callees:
