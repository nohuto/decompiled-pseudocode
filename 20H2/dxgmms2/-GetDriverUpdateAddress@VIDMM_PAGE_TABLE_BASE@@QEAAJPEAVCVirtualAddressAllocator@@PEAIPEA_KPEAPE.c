/*
 * XREFs of ?GetDriverUpdateAddress@VIDMM_PAGE_TABLE_BASE@@QEAAJPEAVCVirtualAddressAllocator@@PEAIPEA_KPEAPEAX@Z @ 0x1C007D3FC
 * Callers:
 ...
 *     ?GetSegmentOffsetInPages@VIDMM_PAGE_TABLE_BASE@@QEBA_KXZ @ 0x1C0025E30 (-GetSegmentOffsetInPages@VIDMM_PAGE_TABLE_BASE@@QEBA_KXZ.c)
      ...
      if ( v13 == 1 )
      {
        ...
        *a4 = 0LL;
        ...
        else
        {
          ...
          while ( 1 )
          {
            v27 = (unsigned __int64 *)*((_QWORD *)this + 1);
            LOBYTE(v40) = 0;
