/*
 * XREFs of ?CurateVPR@VIDMM_SEGMENT@@QEAAXXZ @ 0x1C00C7574
 * Callers:
 ...
 *     Percentagex100 @ 0x1C00C8B44 (Percentagex100.c)
 *     ?CalculateCapacity@VIDMM_LINEAR_POOL@@QEAA_KXZ @ 0x1C00CF21C (-CalculateCapacity@VIDMM_LINEAR_POOL@@QEAA_KXZ.c)
 */
    ...
    *((_BYTE *)this + 448) = 1;
    if ( !v2 )
    {
      ...
      if ( (Microsoft_Windows_DxgKrnlEnableBits & 0x400) != 0 )
      {
        ...
        Percentagex100((unsigned int)dword_1C00514C8, (unsigned int)dword_1C00514CC);
        v29 = v4;
        LOWORD(v28) = v3;
    ...
    v8 = *((_QWORD *)this + 54);
    v9 = *((_QWORD *)this + 55);
    if ( v9 < v8 * (unsigned __int64)(unsigned int)dword_1C00514C8 / (unsigned int)dword_1C00514CC )
    {
      v10 = VIDMM_LINEAR_POOL::CalculateCapacity(*((VIDMM_LINEAR_POOL **)this + 19));
      v12 = dword_1C00514D4;
      v13 = v8 - v9;
      v14 = (unsigned __int64)(unsigned int)dword_1C00514D0 * v13 % (unsigned int)dword_1C00514D4;
      if ( v10 < (unsigned __int64)(unsigned int)dword_1C00514D0 * v13 / (unsigned int)dword_1C00514D4 )
      {
        v31 = 0LL;
        v30 = 0;
        if ( bTracingEnabled )
