/*
 * XREFs of ?IsAllocationTerminated@VIDMM_GLOBAL@@QEAAEPEAU_VIDMM_MULTI_ALLOC@@@Z @ 0x1C00B1C50
 * Callers:
 *     VidMmIsAllocationTerminated @ 0x1C0022560 (VidMmIsAllocationTerminated.c)
 * Callees:
