/*
 * XREFs of VidSchDdiNotifyInterruptWorker @ 0x1C000CC80
 * Callers:
 ...
 *     ?VidSchiVerifyDriverReportedFenceId@@YAHPEAU_VIDSCH_NODE@@KHPEAK@Z @ 0x1C000EC64 (-VidSchiVerifyDriverReportedFenceId@@YAHPEAU_VIDSCH_NODE@@KHPEAK@Z.c)
 *     VidSchiProcessIsrPreemptedPacket @ 0x1C000ECE0 (VidSchiProcessIsrPreemptedPacket.c)
 *     ?MapVidPnTargetToVidPnSource@ADAPTER_DISPLAY@@QEAAII@Z @ 0x1C0029FBC (-MapVidPnTargetToVidPnSource@ADAPTER_DISPLAY@@QEAAII@Z.c)
 ...
 *     ?VidSchiValidatePageFaultFlags@@YAXW4_DXGK_PAGE_FAULT_FLAGS@@@Z @ 0x1C00396A8 (-VidSchiValidatePageFaultFlags@@YAXW4_DXGK_PAGE_FAULT_FLAGS@@@Z.c)
 *     VidSchiProcessIsrGpuEngineTimeout @ 0x1C003B160 (VidSchiProcessIsrGpuEngineTimeout.c)
 *     VidSchiProcessIsrHwQueuePageFaulted @ 0x1C003B1E4 (VidSchiProcessIsrHwQueuePageFaulted.c)
 *     VidSchiProcessIsrMonitoredFenceSignaled @ 0x1C003B368 (VidSchiProcessIsrMonitoredFenceSignaled.c)
 *     VidSchiProcessIsrSchedulingLogFull @ 0x1C003B3EC (VidSchiProcessIsrSchedulingLogFull.c)
 *     VidSchiProcessIsrSuspendContextCompleted @ 0x1C003B470 (VidSchiProcessIsrSuspendContextCompleted.c)
 */
