/*
 * XREFs of ?AllocateVirtualAddressRange@CVirtualAddressAllocator@@QEAAJPEAU_RTL_AVL_TREE@@_K111IPEAPEAUVIDMM_VAD@@E@Z @ 0x1C007A360
 * Callers:
...
LABEL_33:
      ...
      _InterlockedAdd(&dword_1C005176C, 1u);
    ...
    else
    {
      ...
      if ( v32 )
      {
        ...
        _InterlockedIncrement(&dword_1C005176C);
