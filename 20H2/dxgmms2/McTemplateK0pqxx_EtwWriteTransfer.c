/*
 * XREFs of McTemplateK0pqxx_EtwWriteTransfer @ 0x1C0025FFC
 * Callers:
 ...
 *     ?RemoveVadFromFreeList@CVirtualAddressAllocator@@IEAAXPEAUVIDMM_VAD@@@Z @ 0x1C007A618 (-RemoveVadFromFreeList@CVirtualAddressAllocator@@IEAAXPEAUVIDMM_VAD@@@Z.c)
