/*
 * XREFs of TlgUnregisterAggregateProvider @ 0x1C00D5870
 * Callers:
 ...
 *     DestroyAggregateSession @ 0x1C00D55C0 (DestroyAggregateSession.c)
 */
...
void TlgUnregisterAggregateProvider()
{
  ...
  {
    v1 = 0LL;
    ExAcquirePushLockExclusiveEx(&unk_1C0051630, 0LL);
    v2 = qword_1C0051820;
    v3 = &qword_1C0051820;
    while ( v2 )
    {
