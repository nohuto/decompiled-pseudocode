/*
 * XREFs of VidSchSubmitWaitFromCpu @ 0x1C0012140
 * Callers:
 ...
 *     ??_GVIDSCH_CPU_WAITER@@QEAAPEAXI@Z @ 0x1C0029C0C (--_GVIDSCH_CPU_WAITER@@QEAAPEAXI@Z.c)
...
LABEL_26:
      ...
      *v26 = v15;
      *(_QWORD *)(v19 + 840) = v15;
      VidSchiUnwaitMonitoredFences((struct HwQueueStagingList *)v30, v19, 0LL);
      if ( !v31 )
      {
        while ( 1 )
        {
