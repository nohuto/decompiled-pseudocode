/*
 * XREFs of McTemplateK0pppxqq_EtwWriteTransfer @ 0x1C0025D38
 * Callers:
...
NTSTATUS McTemplateK0pppxqq_EtwWriteTransfer(__int64 a1, __int64 a2, __int64 a3, ...)
{
  ...
  v14 = 4LL;
  v16 = 4LL;
  return McGenEventWrite_EtwWriteTransfer(&DxgkControlGuid_Context, &EventPagingQueueSubmitSystem, a3, 7u, &v4);
}
