/*
 * XREFs of ?VidSchiControlIndependentVidPnVSyncThread@@YAXPEAU_VIDSCH_GLOBAL@@@Z @ 0x1C002A718
 * Callers:
 *     VidSchiControlVSyncThread @ 0x1C0014E20 (VidSchiControlVSyncThread.c)
 * Callees:
 *     ?NumberOfVSyncWaiter@DXGADAPTER@@QEAAKI@Z @ 0x1C0014F78 (-NumberOfVSyncWaiter@DXGADAPTER@@QEAAKI@Z.c)
