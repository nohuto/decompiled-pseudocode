/*
 * XREFs of ?CommitPageDirectory@VIDMM_PAGE_DIRECTORY@@QEAAJPEAVCVirtualAddressAllocator@@PEAPEAUVIDMM_ALLOC@@@Z @ 0x1C008389C
 * Callers:
  ...
  *(_BYTE *)(v7 + 89) = 0;
  ...
  if ( (int)result >= 0 )
  {
    ...
    if ( (v12[16][10] & 0x1000) != 0 )
      this[1][17] = (__int64 *)(*(__int64 (__fastcall **)(_QWORD, __int64))(**(_QWORD **)(v12[12][1] + 24) + 104LL))(
                                 *(_QWORD *)(v12[12][1] + 24),
                                 v12[12][3]);
