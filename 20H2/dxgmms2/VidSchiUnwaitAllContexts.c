/*
 * XREFs of VidSchiUnwaitAllContexts @ 0x1C0031F30
 * Callers:
 *     VidSchiReportHwHang @ 0x1C003CE54 (VidSchiReportHwHang.c)
 *     VidSchFlushAdapter @ 0x1C00D2340 (VidSchFlushAdapter.c)
 * Callees:
 *     ?VidSchiUnwaitAllContextsInList@@YAXPEAU_LIST_ENTRY@@@Z @ 0x1C002CBC0 (-VidSchiUnwaitAllContextsInList@@YAXPEAU_LIST_ENTRY@@@Z.c)
 */
