/*
 * XREFs of ?NotifyAllocationEviction@VIDMM_GLOBAL@@QEAAXPEAUVIDMM_ALLOC@@_NPEA_K2@Z @ 0x1C006E190
 * Callers:
        ...
        unsigned __int64 *a5)
{
  ...
  if ( !*(_DWORD *)(v9 + 152) )
  {
    ...
    {
      VIDMM_SEGMENT::MarkResourcesForEviction(*(VIDMM_SEGMENT **)(v9 + 128), (struct _VIDMM_GLOBAL_ALLOC *)v9, a4, a5);
      if ( bTracingEnabled )
      {
