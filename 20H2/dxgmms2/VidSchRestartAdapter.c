/*
 * XREFs of VidSchRestartAdapter @ 0x1C00D3350
 * Callers:
 *     <none>
 * Callees:
 ...
 *     VidSchResetFlipQueueTimeout @ 0x1C00D0664 (VidSchResetFlipQueueTimeout.c)
 *     VidSchResetGPUTimeout @ 0x1C00D06BC (VidSchResetGPUTimeout.c)
 */
