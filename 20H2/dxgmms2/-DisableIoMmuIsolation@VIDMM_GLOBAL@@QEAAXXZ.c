/*
 * XREFs of ?DisableIoMmuIsolation@VIDMM_GLOBAL@@QEAAXXZ @ 0x1C00AFEF8
 * Callers:
 *     ?VidMmDisableIoMmuIsolation@@YAXPEAVVIDMM_GLOBAL@@@Z @ 0x1C0021E60 (-VidMmDisableIoMmuIsolation@@YAXPEAVVIDMM_GLOBAL@@@Z.c)
