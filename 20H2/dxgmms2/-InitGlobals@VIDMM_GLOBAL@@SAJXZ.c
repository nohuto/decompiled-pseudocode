/*
 * XREFs of ?InitGlobals@VIDMM_GLOBAL@@SAJXZ @ 0x1C009011C
 * Callers:
 *     VidMmInitGlobals @ 0x1C0017220 (VidMmInitGlobals.c)
 * Callees:
 ...
 *     McGenEventRegister_EtwRegister @ 0x1C0017238 (McGenEventRegister_EtwRegister.c)
...
LABEL_27:
  ...
  if ( v15 < 0 )
    goto LABEL_27;
  qword_1C00517D0 = (__int64)&VIDMM_RECYCLE_HEAP_MGR::_GlobalHeapManagerListHead;
  ...
  qword_1C0051818 = (__int64)&VIDMM_GLOBAL::_AdapterListHead;
