/*
 * XREFs of ?ReportState@VIDMM_DEVICE@@QEAAXXZ @ 0x1C00B9354
 * Callers:
 *     VidMmReportVidMmDeviceState @ 0x1C0022720 (VidMmReportVidMmDeviceState.c)
...
void __fastcall VIDMM_DEVICE::ReportState(VIDMM_DEVICE *this)
{
  ...
  if ( v1 )
  {
    DXGAUTOPUSHLOCK::DXGAUTOPUSHLOCK((DXGAUTOPUSHLOCK *)v11, (struct _KTHREAD **)(v1 + 360), 0LL);
