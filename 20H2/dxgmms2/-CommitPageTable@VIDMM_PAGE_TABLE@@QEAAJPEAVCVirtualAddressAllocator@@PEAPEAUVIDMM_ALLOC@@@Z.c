/*
 * XREFs of ?CommitPageTable@VIDMM_PAGE_TABLE@@QEAAJPEAVCVirtualAddressAllocator@@PEAPEAUVIDMM_ALLOC@@@Z @ 0x1C0080AD8
 * Callers:
  ...
  *a3 = 0LL;
  if ( !VIDMM_PAGE_TABLE_BASE::IsResident(this) )
  {
    ...
    *(_BYTE *)(*((_QWORD *)this + 1) + 89LL) = 0;
    ...
    v13 = 0;
    v10 = VIDMM_GLOBAL::PageInOneAllocation(v7, v8, v9 ? 0 : 7, 0, &v13, v6, 0, -1LL);
    v4 = v10;
    if ( v13 )
    {
