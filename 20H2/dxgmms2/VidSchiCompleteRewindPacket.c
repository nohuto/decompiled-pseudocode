/*
 * XREFs of VidSchiCompleteRewindPacket @ 0x1C0013E14
 * Callers:
 ...
 *     VidSchiSetNextRunPacket @ 0x1C0014054 (VidSchiSetNextRunPacket.c)
    ...
    *(_QWORD *)(a1 + 656) = 0LL;
    if ( (v15 & 0x200) != 0 )
    {
      if ( (((unsigned __int8)(*(_DWORD *)(a1 + 184) >> 9) | *(_BYTE *)(a1 + 184)) & 2) == 0 )
        VidSchiUpdateContextStatus(a1, 0xAuLL, 14713LL);
    }
    ...
    {
      return (unsigned int)VidSchiUpdateContextStatus(a1, 5uLL, 14726LL);
    }
  }
  return v3;
}
