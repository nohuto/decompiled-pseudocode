/*
 * XREFs of ?TerminateAllocation@VIDMM_GLOBAL@@QEAAXPEAU_VIDMM_MULTI_ALLOC@@IU_D3DDDICB_DESTROYALLOCATION2FLAGS@@PEAVDXGTERMINATIONTRACKER@@@Z @ 0x1C0066D80
 * Callers:
 *     VidMmTerminateAllocation @ 0x1C0004E20 (VidMmTerminateAllocation.c)
 * Callees:
