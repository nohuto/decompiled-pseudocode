/*
 * XREFs of VidSchSubmitWaitToHwQueue @ 0x1C003A710
 * Callers:
 *     VidSchWaitForPagingFence @ 0x1C00D3F20 (VidSchWaitForPagingFence.c)
 * Callees:
 *     ?VidSchiAcquireSyncObjectForHwQueue@@YAJPEAU_VIDSCH_SYNC_OBJECT@@PEAU_VIDSCH_QUEUE_PACKET@@@Z @ 0x1C0035F60 (-VidSchiAcquireSyncObjectForHwQueue@@YAJPEAU_VIDSCH_SYNC_OBJECT@@PEAU_VIDSCH_QUEUE_PACKET@@@Z.c)
