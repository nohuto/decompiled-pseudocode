/*
 * XREFs of ?UnblockUEFIFrameBufferRanges@VIDMM_GLOBAL@@QEAAJPEBU_DXGK_QUERYSEGMENTMEMORYSTATE@@@Z @ 0x1C00B52C0
 * Callers:
 *     VidMmUnblockUEFIFrameBufferRanges @ 0x1C00228B0 (VidMmUnblockUEFIFrameBufferRanges.c)
 * Callees:
