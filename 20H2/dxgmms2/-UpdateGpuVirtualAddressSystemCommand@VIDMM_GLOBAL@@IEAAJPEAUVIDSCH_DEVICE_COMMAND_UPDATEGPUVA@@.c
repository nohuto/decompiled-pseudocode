/*
 * XREFs of ?UpdateGpuVirtualAddressSystemCommand@VIDMM_GLOBAL@@IEAAJPEAUVIDSCH_DEVICE_COMMAND_UPDATEGPUVA@@PEAPEAUVIDMM_ALLOC@@@Z @ 0x1C00B5E48
 * Callers:
 ...
 *     VidSchGetPagingContext @ 0x1C0034BF0 (VidSchGetPagingContext.c)
        ...
        struct VIDMM_ALLOC **a3)
{
  ...
  DXGAUTOPUSHLOCK::DXGAUTOPUSHLOCK((DXGAUTOPUSHLOCK *)v132, v8 + 7, 0LL);
