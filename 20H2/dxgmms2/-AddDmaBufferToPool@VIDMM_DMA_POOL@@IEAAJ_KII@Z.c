/*
 * XREFs of ?AddDmaBufferToPool@VIDMM_DMA_POOL@@IEAAJ_KII@Z @ 0x1C008AEBC
 * Callers:
...
LABEL_67:
  ...
  if ( (*((_BYTE *)this + 32) & 1) != 0 || (_DWORD)v4 )
  {
    ...
    if ( !v8 )
    {
      _InterlockedAdd(&dword_1C0051670, 1u);
    ...
    if ( !v11 )
    {
      v65 = *(_QWORD *)(*(_QWORD *)(*(_QWORD *)this + 24LL) + 1992LL);
      v10[20] = 2;
      ...
      *((_QWORD *)v10 + 9) = v66;
      if ( !v66 )
      {
        _InterlockedAdd(&dword_1C0051684, 1u);
        v68 = WdLogNewEntry5_WdLowResource(v67);
        *(_QWORD *)(v68 + 24) = 1270LL;
        goto LABEL_83;
      }
...
LABEL_20:
      if ( (_DWORD)v4 )
      {
        ...
        *((_QWORD *)v10 + 14) = v34;
        if ( !v34 )
        {
          _InterlockedAdd(&dword_1C0051688, 1u);
          v68 = WdLogNewEntry5_WdLowResource(v35);
          *(_QWORD *)(v68 + 24) = 1310LL;
          goto LABEL_83;
        }
        memset(v34, 0, 24 * v4);
      }
      if ( v79 )
      {
        ...
        *((_QWORD *)v10 + 15) = v50;
        if ( !v50 )
        {
          _InterlockedAdd(&dword_1C005168C, 1u);
          v68 = WdLogNewEntry5_WdLowResource(v51);
          *(_QWORD *)(v68 + 24) = 1327LL;
          goto LABEL_83;
        }
        memset(v50, 0, 24 * v48);
      }
...
LABEL_38:
          ...
          {
            v56 = (struct VIDMM_MAPPED_VA_RANGE *)CVirtualAddressAllocator::MapVirtualAddressRange(
                                                    ...
                                                    *(_QWORD *)(v54 + 2552),
                                                    0x1000u,
                                                    (_D3DDDIGPUVIRTUALADDRESS_PROTECTION_TYPE)((*(_DWORD *)(v55 + 32) < 0x6000u) | 0x12LL),
                                                    0LL,
                                                    v53,
                                                    0LL);
            if ( v56 )
...
LABEL_85:
        ...
        *((_QWORD *)v10 + 22) = v57;
        ...
        _InterlockedAdd(&dword_1C0051694, 1u);
        v68 = WdLogNewEntry5_WdLowResource(v58);
        *(_QWORD *)(v68 + 24) = 1359LL;
        goto LABEL_83;
      }
      ...
      *((_QWORD *)v10 + 16) = v37;
      ...
      _InterlockedAdd(&dword_1C00516EC, 1u);
      v68 = WdLogNewEntry5_WdLowResource(v38);
      *(_QWORD *)(v68 + 24) = 1341LL;
LABEL_83:
    ...
    OneAllocation = VIDMM_GLOBAL::CreateOneAllocation(
                      ...
                      *((_DWORD *)this + 2),
                      ...
                      0,
                      0,
                      (struct _DXGK_ALLOCATIONINFOFLAGS_WDDM2_0::$5068715F5D8591D41DA1228877FDA04B::$63766B29C143116E9EC685C38896947D)v13,
                      0,
                      0LL,
                      0LL,
                      0LL,
                      ...
                      0,
                      0LL,
                      (_D3DDDI_SEGMENTPREFERENCE **)v10 + 7);
    if ( OneAllocation < 0 )
    {
      _InterlockedAdd(&dword_1C0051678, 1u);
      v63 = WdLogNewEntry5_WdLowResource(v15);
      *(_QWORD *)(v63 + 24) = 1187LL;
    }
    else
    {
...
LABEL_84:
      ...
      _InterlockedAdd(&dword_1C005167C, 1u);
      v63 = WdLogNewEntry5_WdLowResource(v20);
      *(_QWORD *)(v63 + 24) = 1207LL;
    }
