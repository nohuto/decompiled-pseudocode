/*
 * XREFs of VidSchiProfilePerformanceTick @ 0x1C000A480
 * Callers:
 ...
 *     VidSchiNeedToForcePreemptNode @ 0x1C00156D8 (VidSchiNeedToForcePreemptNode.c)
      ...
      if ( (_DWORD)a1 != 4 )
      {
        switch ( (int)a1 )
        {
          ...
          case 7:
            ...
            if ( *(_QWORD *)(v65 + 984)
              || (v95 = operator new[](0x400uLL, 0x61616956u, (enum _POOL_TYPE)512),
                  (*(_QWORD *)(v65 + 984) = v95) != 0LL) )
            {
