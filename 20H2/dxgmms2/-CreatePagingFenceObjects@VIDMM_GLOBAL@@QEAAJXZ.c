/*
 * XREFs of ?CreatePagingFenceObjects@VIDMM_GLOBAL@@QEAAJXZ @ 0x1C0095B90
 * Callers:
 ...
 *     ?DestroyPagingFenceObjects@VIDMM_GLOBAL@@QEAAXXZ @ 0x1C00AFE60 (-DestroyPagingFenceObjects@VIDMM_GLOBAL@@QEAAXXZ.c)
 */
