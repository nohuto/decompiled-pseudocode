/*
 * XREFs of VidSchiSetPriorityContext @ 0x1C0010184
 * Callers:
 *     VidSchSubmitCommand @ 0x1C0067440 (VidSchSubmitCommand.c)
 *     VidSchSetPriorityContext @ 0x1C0068A10 (VidSchSetPriorityContext.c)
 ...
 *     VidSchSetAbsolutePriorityContext @ 0x1C00D34F0 (VidSchSetAbsolutePriorityContext.c)
 * Callees:
 *     ?VidSchiStopExecutionTimeAtThisPriority@@YAXPEAU_VIDSCH_NODE@@K_K1@Z @ 0x1C00138E8 (-VidSchiStopExecutionTimeAtThisPriority@@YAXPEAU_VIDSCH_NODE@@K_K1@Z.c)
 *     ?VidSchiStartExecutionTimeAtThisPriority@@YAXPEAU_VIDSCH_NODE@@K_K@Z @ 0x1C00139F4 (-VidSchiStartExecutionTimeAtThisPriority@@YAXPEAU_VIDSCH_NODE@@K_K@Z.c)
 *     McTemplateK0pqq_EtwWriteTransfer @ 0x1C00247EC (McTemplateK0pqq_EtwWriteTransfer.c)
 *     ?VidSchiUpdateReadyBitsInNewPriority@@YAXPEAU_VIDSCH_NODE@@PEAU_VIDSCH_CONTEXT@@@Z @ 0x1C002CC34 (-VidSchiUpdateReadyBitsInNewPriority@@YAXPEAU_VIDSCH_NODE@@PEAU_VIDSCH_CONTEXT@@@Z.c)
 */
