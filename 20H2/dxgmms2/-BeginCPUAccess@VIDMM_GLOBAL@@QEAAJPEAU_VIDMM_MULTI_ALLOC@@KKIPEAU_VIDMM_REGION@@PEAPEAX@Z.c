/*
 * XREFs of ?BeginCPUAccess@VIDMM_GLOBAL@@QEAAJPEAU_VIDMM_MULTI_ALLOC@@KKIPEAU_VIDMM_REGION@@PEAPEAX@Z @ 0x1C0072DE0
 * Callers:
 *     VidMmBeginCPUAccess @ 0x1C0011E20 (VidMmBeginCPUAccess.c)
 * Callees:
 ...
 *     ?VidMmRecordLock@@YAXPEAU_VIDMM_GLOBAL_STATISTICS@@KKH@Z @ 0x1C0011FDC (-VidMmRecordLock@@YAXPEAU_VIDMM_GLOBAL_STATISTICS@@KKH@Z.c)
        ...
        void **a7)
{
  ...
  *a7 = 0LL;
  ...
  {
    v18 = *(_QWORD *)v7[1];
    if ( v18 != PsGetCurrentProcess(v17, v13, v15) && (*(_DWORD *)(v12 + 80) & 0x1000) == 0 )
    {
      v53 = WdLogNewEntry5_WdAssertion(v19, v13, v15);
      *(_QWORD *)(v53 + 24) = 7909LL;
LABEL_67:
  ...
  if ( (v16 & 0x82) != 0 )
  {
    ...
    {
      v53 = WdLogNewEntry5_WdAssertion(v20, v13, v15);
      *(_QWORD *)(v53 + 24) = 7950LL;
      goto LABEL_67;
    }
    if ( !*((_BYTE *)this + 7081) && (v20 & 4) != 0 )
    {
      v53 = WdLogNewEntry5_WdAssertion(v20, v13, v15);
      *(_QWORD *)(v53 + 24) = 7961LL;
      goto LABEL_67;
    }
  }
  if ( (v16 & 0x81) != 0 )
