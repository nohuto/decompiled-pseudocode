/*
 * XREFs of ?CheckPageTableInvalid@VIDMM_PAGE_DIRECTORY@@QEAAEPEAVCVirtualAddressAllocator@@I_K@Z @ 0x1C007E73C
 * Callers:
        ...
        unsigned __int64 a4)
{
  ...
  *(_QWORD *)(v4 + 8 * v7 + 8) = 0LL;
  ...
  if ( (*(_DWORD *)this & 0x20) != 0 )
    ...
    VIDMM_PAGE_DIRECTORY::DestroyPageDirectory((VIDMM_PAGE_DIRECTORY *)v9, a2, a4);
