/*
 * XREFs of McTemplateK0ppqpttq_EtwWriteTransfer @ 0x1C002D104
 * Callers:
 ...
 *     VidSchiMarkDevicesInError @ 0x1C00D0D20 (VidSchiMarkDevicesInError.c)
...
NTSTATUS McTemplateK0ppqpttq_EtwWriteTransfer(__int64 a1, const EVENT_DESCRIPTOR *a2, __int64 a3, ...)
{
  ...
  v17 = 4LL;
  v19 = 4LL;
  return McGenEventWrite_EtwWriteTransfer(&DxgkControlGuid_Context, a2, 0LL, 8u, &v5);
}
