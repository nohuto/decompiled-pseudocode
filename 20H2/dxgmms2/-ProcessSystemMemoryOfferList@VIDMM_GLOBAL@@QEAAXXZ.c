/*
 * XREFs of ?ProcessSystemMemoryOfferList@VIDMM_GLOBAL@@QEAAXXZ @ 0x1C00816C0
 * Callers:
  ...
  while ( 1 )
  {
    ...
    *v11 = 0LL;
    ...
    if ( v19 )
    {
      ...
      if ( (*((_DWORD *)this + 1762) & 0x8000) != 0 || *((_QWORD *)this + 577) - v14[54] > v12[*((int *)v14 + 106)] )
      {
        *((_DWORD *)v14 + 20) |= 0x40u;
        *((_QWORD *)v2 + 1) = 0LL;
        ExReleasePushLockExclusiveEx(v2, 0LL);
        KeLeaveCriticalRegion();
        VIDMM_GLOBAL::MarkGlobalAllocation(this, (struct _VIDMM_GLOBAL_ALLOC *)(v11 - 49), 0LL, 0LL);
        LOBYTE(v22) = 1;
        LOBYTE(v27) = 0;
