/*
 * XREFs of ?Init@VIDMM_DEVICE@@QEAAJ_NPEAVVIDMM_PROCESS@@@Z @ 0x1C007F71C
 * Callers:
 *     VidMmInitDevice @ 0x1C0012CC0 (VidMmInitDevice.c)
...
__int64 __fastcall VIDMM_DEVICE::Init(VIDMM_DEVICE *this, __int64 a2, struct _KTHREAD **a3)
{
  char v4; // r15
  __int64 v6; // rcx
  ...
  else if ( *((_QWORD *)this + 3) )
  {
    if ( DXGPROCESS::GetCurrent() && (v6 = *((_QWORD *)DXGPROCESS::GetCurrent() + 8)) != 0 )
      v7 = *(struct _KTHREAD ***)(v6 + 8);
    else
      v7 = 0LL;
  }
  else
  {
    v7 = *(struct _KTHREAD ***)(*(_QWORD *)this + 40384LL);
  }
  *((_QWORD *)this + 1) = v7;
  if ( !v7 )
  {
  ...
  if ( *((_QWORD *)this + 3) )
  {
    ...
    if ( v9 < 0 )
    {
      _InterlockedAdd(&dword_1C0051668, 1u);
  ...
  *((_QWORD *)this + 5) = v11;
  if ( !v11 )
  {
    _InterlockedAdd(&dword_1C005166C, 1u);
