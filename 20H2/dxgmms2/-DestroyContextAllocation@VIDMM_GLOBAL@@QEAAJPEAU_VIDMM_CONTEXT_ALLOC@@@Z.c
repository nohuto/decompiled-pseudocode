/*
 * XREFs of ?DestroyContextAllocation@VIDMM_GLOBAL@@QEAAJPEAU_VIDMM_CONTEXT_ALLOC@@@Z @ 0x1C008A914
 * Callers:
 *     VidMmDestroyContextAllocation @ 0x1C00169C0 (VidMmDestroyContextAllocation.c)
 * Callees:
