/*
 * XREFs of ?CreateVidMmObjects@VIDMM_PAGE_TABLE_BASE@@QEAAJPEAVCVirtualAddressAllocator@@II@Z @ 0x1C00805B8
 * Callers:
 ...
 * Callees:
 *     ?DriverSegmentIdToAdapterSegmentIndex@VIDMM_GLOBAL@@QEAAIII@Z @ 0x1C0012A84 (-DriverSegmentIdToAdapterSegmentIndex@VIDMM_GLOBAL@@QEAAIII@Z.c)
        ...
        int a4)
{
  ...
  v16 = (struct _VIDMM_GLOBAL_ALLOC **)((char *)this + 8);
  if ( !v15 )
    v15 = 4096;
