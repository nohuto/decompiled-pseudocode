/*
 * XREFs of ?EvictResource@VIDMM_MEMORY_SEGMENT@@UEAAXPEAU_VIDMM_GLOBAL_ALLOC@@EEEPEAU_VIDMM_LOCAL_ALLOC@@@Z @ 0x1C006F1F0
 * Callers:
 *     <none>
 * Callees:
        ...
        struct _VIDMM_LOCAL_ALLOC *a6)
{
  ...
  v12 = (_QWORD *)((char *)a2 + 376);
  v13 = *((_QWORD *)a2 + 47);
  if ( *(struct _VIDMM_GLOBAL_ALLOC **)(v13 + 8) != (struct _VIDMM_GLOBAL_ALLOC *)((char *)a2 + 376)
    || (v14 = (_QWORD *)*((_QWORD *)a2 + 48), (_QWORD *)*v14 != v12) )
  {
    __fastfail(3u);
  }
  *v14 = v13;
