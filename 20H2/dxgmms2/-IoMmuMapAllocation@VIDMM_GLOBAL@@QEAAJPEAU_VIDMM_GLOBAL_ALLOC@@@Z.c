/*
 * XREFs of ?IoMmuMapAllocation@VIDMM_GLOBAL@@QEAAJPEAU_VIDMM_GLOBAL_ALLOC@@@Z @ 0x1C00B18EC
 * Callers:
 ...
 *     ?MapAllocationsToIoMmu@VIDMM_SEGMENT@@QEAAJXZ @ 0x1C00C83B0 (-MapAllocationsToIoMmu@VIDMM_SEGMENT@@QEAAJXZ.c)
 * Callees:
