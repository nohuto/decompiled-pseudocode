/*
 * XREFs of ?VidSchiInsertCommandToHwQueue@@YAXPEAU_VIDSCH_QUEUE_PACKET@@@Z @ 0x1C0037988
 * Callers:
 ...
 *     ?VidSchiPacketBlockedOnWaitCondition@@YA_NPEAU_VIDSCH_QUEUE_PACKET@@@Z @ 0x1C0037D80 (-VidSchiPacketBlockedOnWaitCondition@@YA_NPEAU_VIDSCH_QUEUE_PACKET@@@Z.c)
...
void __fastcall VidSchiInsertCommandToHwQueue(struct _VIDSCH_QUEUE_PACKET *a1)
{
  ...
  v21 = &v20;
  v20 = (__int64)&v20;
  _InterlockedIncrement((volatile signed __int32 *)(v6 + 716));
  _InterlockedIncrement((volatile signed __int32 *)(v4 + 2876));
