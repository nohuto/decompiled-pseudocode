/*
 * XREFs of ?UpdateContextAllocation@VIDMM_GLOBAL@@QEAAX_K0PEAXI@Z @ 0x1C00B5D3C
 * Callers:
        ...
        UINT a5)
{
  ...
  v10 = 0;
  for ( i = -1071775743; v10 < *((_DWORD *)this + 1750); ++v10 )
  {
    ...
    while ( i == -1071775743 )
    {
      ...
      i = ADAPTER_RENDER::DdiBuildPagingBuffer(v12, &v13);
