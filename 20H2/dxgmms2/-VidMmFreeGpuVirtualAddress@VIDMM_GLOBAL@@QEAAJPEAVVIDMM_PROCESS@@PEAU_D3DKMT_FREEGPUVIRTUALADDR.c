/*
 * XREFs of ?VidMmFreeGpuVirtualAddress@VIDMM_GLOBAL@@QEAAJPEAVVIDMM_PROCESS@@PEAU_D3DKMT_FREEGPUVIRTUALADDRESS@@E@Z @ 0x1C0087054
 * Callers:
 *     VidMmFreeGpuVirtualAddress @ 0x1C0015630 (VidMmFreeGpuVirtualAddress.c)
