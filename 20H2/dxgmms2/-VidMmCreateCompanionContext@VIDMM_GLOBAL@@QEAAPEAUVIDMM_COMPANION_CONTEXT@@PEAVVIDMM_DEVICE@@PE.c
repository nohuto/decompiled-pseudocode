/*
 * XREFs of ?VidMmCreateCompanionContext@VIDMM_GLOBAL@@QEAAPEAUVIDMM_COMPANION_CONTEXT@@PEAVVIDMM_DEVICE@@PEAU_VIDSCH_CONTEXT@@@Z @ 0x1C00B6E9C
 * Callers:
 *     VidMmCreateCompanionContext @ 0x1C0022420 (VidMmCreateCompanionContext.c)
 * Callees:
