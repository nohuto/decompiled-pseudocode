/*
 * XREFs of McTemplateK0pptpqxqxqxqqq_EtwWriteTransfer @ 0x1C0027244
 * Callers:
 ...
 *     ?RecordPagingOperation@VIDMM_GLOBAL@@QEAAXKPEAU_VIDMM_GLOBAL_ALLOC@@PEAU_DXGKARG_BUILDPAGINGBUFFER@@J_KHPEAX@Z @ 0x1C007E784 (-RecordPagingOperation@VIDMM_GLOBAL@@QEAAXKPEAU_VIDMM_GLOBAL_ALLOC@@PEAU_DXGKARG_BUILDPAGINGBUFF.c)
 * Callees:
...
NTSTATUS McTemplateK0pptpqxqxqxqqq_EtwWriteTransfer(__int64 a1, __int64 a2, __int64 a3, ...)
{
  ...
  __int64 v31; // [rsp+148h] [rbp+48h] BYREF
  ...
  va_list va2; // [rsp+158h] [rbp+58h]
  __int64 v37; // [rsp+160h] [rbp+60h] BYREF
  va_list va3; // [rsp+160h] [rbp+60h]
  __int64 v39; // [rsp+168h] [rbp+68h] BYREF
  va_list va4; // [rsp+168h] [rbp+68h]
  ...
  v28 = 4LL;
  v30 = 4LL;
  return McGenEventWrite_EtwWriteTransfer(&DxgkControlGuid_Context, &EventPagingOpSpecialLockTransfer, a3, 0xEu, &v4);
}
