/*
 * XREFs of ?UnmapGpuVA@VIDMM_FENCE_STORAGE_PAGE@@QEAAXPEAVVIDMM_GLOBAL@@PEAVVIDMM_PROCESS@@I_N@Z @ 0x1C0086EDC
 * Callers:
            ...
            if ( !a5 || (v24 = v12[13], _bittest(&v24, a4)) )
            {
              if ( v12[12]-- == 1 )
              {
                ...
                *(_QWORD *)(v21 + 8) = v22;
                ...
                VIDMM_FENCE_STORAGE_PAGE::ReleaseStoragePageGpuData(
                  v23,
                  (struct VIDMM_FENCE_STORAGE_PAGE_GPU_DATA ***)v10);
              }
              goto LABEL_10;
            }
          }
