/*
 * XREFs of ?VidSchiWorkerThreadTimerCallback@@YAXPEAU_EX_TIMER@@PEAX@Z @ 0x1C0014BA0
 * Callers:
 *     <none>
 * Callees:
 *     VidSchiCheckYieldExitCondition @ 0x1C0014CC8 (VidSchiCheckYieldExitCondition.c)
