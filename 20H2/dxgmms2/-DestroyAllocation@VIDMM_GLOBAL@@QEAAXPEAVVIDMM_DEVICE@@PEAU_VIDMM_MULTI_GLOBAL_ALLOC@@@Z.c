/*
 * XREFs of ?DestroyAllocation@VIDMM_GLOBAL@@QEAAXPEAVVIDMM_DEVICE@@PEAU_VIDMM_MULTI_GLOBAL_ALLOC@@@Z @ 0x1C0073168
 * Callers:
 *     VidMmDestroyAllocation @ 0x1C0011E60 (VidMmDestroyAllocation.c)
 * Callees:
