/*
 * XREFs of ?SetWorkingSetInformation@VIDMM_PROCESS@@QEAAJPEAU_D3DKMT_WORKINGSETINFO@@@Z @ 0x1C00BB648
 * Callers:
 *     VidMmSetWorkingSetInformation @ 0x1C0022810 (VidMmSetWorkingSetInformation.c)
 * Callees:
