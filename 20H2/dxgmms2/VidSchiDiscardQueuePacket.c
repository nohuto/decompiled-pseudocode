/*
 * XREFs of VidSchiDiscardQueuePacket @ 0x1C00D08EC
 * Callers:
 ...
 *     VidSchFlushPendingCommand @ 0x1C00D2600 (VidSchFlushPendingCommand.c)
 * Callees:
 ...
 *     ?DdiCancelCommand@ADAPTER_RENDER@@QEAAJPEBU_DXGKARG_CANCELCOMMAND@@@Z @ 0x1C0021C30 (-DdiCancelCommand@ADAPTER_RENDER@@QEAAJPEBU_DXGKARG_CANCELCOMMAND@@@Z.c)
 ...
 *     ?VidSchiFreeHistoryBufferStorage@@YAXPEAU_VIDSCH_QUEUE_PACKET@@@Z @ 0x1C002ADE4 (-VidSchiFreeHistoryBufferStorage@@YAXPEAU_VIDSCH_QUEUE_PACKET@@@Z.c)
