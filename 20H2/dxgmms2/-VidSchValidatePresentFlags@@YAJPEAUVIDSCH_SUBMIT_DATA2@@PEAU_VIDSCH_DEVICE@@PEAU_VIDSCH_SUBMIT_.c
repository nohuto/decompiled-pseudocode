/*
 * XREFs of ?VidSchValidatePresentFlags@@YAJPEAUVIDSCH_SUBMIT_DATA2@@PEAU_VIDSCH_DEVICE@@PEAU_VIDSCH_SUBMIT_FLAGS@@@Z @ 0x1C0004590
 * Callers:
 *     VidSchSubmitCommandContextless @ 0x1C0035620 (VidSchSubmitCommandContextless.c)
