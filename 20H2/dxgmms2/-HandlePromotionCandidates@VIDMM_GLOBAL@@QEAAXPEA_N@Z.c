/*
 * XREFs of ?HandlePromotionCandidates@VIDMM_GLOBAL@@QEAAXPEA_N@Z @ 0x1C0084770
 * Callers:
...
LABEL_11:
  ...
  *a2 = 1;
  ...
  v65 = 0;
  v51 = 0LL;
  DXGAUTOPUSHLOCK::DXGAUTOPUSHLOCK((DXGAUTOPUSHLOCK *)v60, (struct _KTHREAD **)this + 5130, 0LL);
