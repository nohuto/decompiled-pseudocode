/*
 * XREFs of ?EvictPageDirectory@VIDMM_PAGE_DIRECTORY@@QEAAJPEAVCVirtualAddressAllocator@@_KEE@Z @ 0x1C00839BC
 * Callers:
 ...
 * Callees:
 *     ?IsResident@VIDMM_PAGE_TABLE_BASE@@QEBAEXZ @ 0x1C0012AC4 (-IsResident@VIDMM_PAGE_TABLE_BASE@@QEBAEXZ.c)
        ...
        unsigned __int8 a5)
{
  ...
  if ( v14 )
  {
    ...
    {
LABEL_13:
      *(_QWORD *)((char *)this[3] + (_QWORD)v16) = 0LL;
    ...
    if ( (*(_DWORD *)this & 0x20) != 0 )
    {
      ...
      {
        if ( (*(_DWORD *)((_BYTE *)this[3] + (_QWORD)v16) & 0x400) != 0 )
        {
        ...
        {
          VIDMM_PAGE_TABLE::EvictPageTable(*(struct VIDMM_ALLOC ***)((char *)v19 + v17), a2);
        }
        v16 = (char *)v37;
      }
      ...
      v23 = this[4];
      v24 = v22 & 0x400;
      v25 = *(struct VIDMM_ALLOC ***)((char *)v23 + v21);
      if ( v25 )
      {
        if ( v24 )
        {
        ...
        {
          VIDMM_PAGE_TABLE::EvictPageTable(v25, a2);
        }
      }
    }
    else
...
LABEL_18:
    ...
    *((_BYTE *)this[1] + 89) = 0;
    VIDMM_GLOBAL::EvictOneAllocation((struct VIDMM_ALLOC **)v10, this[2], 0LL);
    *((_DWORD *)this[1] + 19) &= ~0x100000u;
    return 0LL;
  }
  v36 = 0;
