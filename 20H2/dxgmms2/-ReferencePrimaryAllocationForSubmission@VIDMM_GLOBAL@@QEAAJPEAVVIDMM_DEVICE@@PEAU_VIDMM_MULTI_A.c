/*
 * XREFs of ?ReferencePrimaryAllocationForSubmission@VIDMM_GLOBAL@@QEAAJPEAVVIDMM_DEVICE@@PEAU_VIDMM_MULTI_ALLOC@@PEAPEAUVIDMM_ALLOC@@@Z @ 0x1C00856FC
 * Callers:
 *     VidMmReferencePrimaryAllocationForSubmission @ 0x1C0014680 (VidMmReferencePrimaryAllocationForSubmission.c)
 * Callees:
 *     <none>
 */
