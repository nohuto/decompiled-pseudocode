/*
 * XREFs of ?IsAllocationInPresentQueue@VIDMM_GLOBAL@@QEAAEPEAU_VIDMM_MULTI_ALLOC@@PEAI@Z @ 0x1C00B1ABC
 * Callers:
 *     VidMmIsAllocationInPresentQueue @ 0x1C0022540 (VidMmIsAllocationInPresentQueue.c)
