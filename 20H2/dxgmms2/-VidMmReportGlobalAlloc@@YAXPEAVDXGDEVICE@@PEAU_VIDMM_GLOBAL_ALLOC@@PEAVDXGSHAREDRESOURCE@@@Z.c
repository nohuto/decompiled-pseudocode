/*
 * XREFs of ?VidMmReportGlobalAlloc@@YAXPEAVDXGDEVICE@@PEAU_VIDMM_GLOBAL_ALLOC@@PEAVDXGSHAREDRESOURCE@@@Z @ 0x1C00BCDD8
 * Callers:
 *     VidMmReportContextAllocList @ 0x1C00BD360 (VidMmReportContextAllocList.c)
 *     VidMmReportMultiGlobalAlloc @ 0x1C00BD5A0 (VidMmReportMultiGlobalAlloc.c)
 * Callees:
