/*
 * XREFs of ??1VIDMM_SEGMENT@@UEAA@XZ @ 0x1C00C6E00
 * Callers:
 *     ??_EVIDMM_SEGMENT@@UEAAPEAXI@Z @ 0x1C0028370 (--_EVIDMM_SEGMENT@@UEAAPEAXI@Z.c)
 *     ??1VIDMM_SYSMEM_SEGMENT@@UEAA@XZ @ 0x1C00C387C (--1VIDMM_SYSMEM_SEGMENT@@UEAA@XZ.c)
 *     ??1VIDMM_APERTURE_SEGMENT@@UEAA@XZ @ 0x1C00C38C0 (--1VIDMM_APERTURE_SEGMENT@@UEAA@XZ.c)
