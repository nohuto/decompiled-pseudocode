/*
 * XREFs of ?Allocate@VIDMM_PROCESS_HEAP@@UEAAJ_KIW4_VIDMM_PROCESS_HEAP_MAPPING@@PEAPEAX22PEAEEE@Z @ 0x1C00CC810
 * Callers:
 *     <none>
 * Callees:
        ...
        char a9)
{
  ...
  *v21 = 0LL;
  ...
  if ( v22 < (unsigned int)dword_1C0051338 )
  {
...
LABEL_29:
      ...
      {
        Object = 0LL;
        _InterlockedIncrement(&dword_1C0051758);
