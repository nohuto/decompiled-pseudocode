/*
 * XREFs of ?CloseAllocation@VIDMM_GLOBAL@@QEAAJPEAU_VIDMM_MULTI_ALLOC@@EPEAPEAU_VIDMM_LOCAL_ALLOC@@U_D3DDDICB_DESTROYALLOCATION2FLAGS@@PEAPEAU_KEVENT@@@Z @ 0x1C0073B30
 * Callers:
 *     VidMmCloseAllocation @ 0x1C0011E90 (VidMmCloseAllocation.c)
 *     VidMmTryCloseAllocation @ 0x1C0015920 (VidMmTryCloseAllocation.c)
 * Callees:
      ...
      if ( !(unsigned __int8)ExTryAcquirePushLockExclusiveEx((char *)Current + 144, 0LL) )
      {
        if ( bTracingEnabled )
        {
          ...
          if ( v16 != -1 && (Microsoft_Windows_DxgKrnlEnableBits & 0x40) != 0 )
            McTemplateK0q_EtwWriteTransfer(v11, &EventBlockThread, v12, v16);
        }
