/*
 * XREFs of ?InitializeVaAllocator@CVirtualAddressAllocator@@QEAAJ_KIPEAVVIDMM_GLOBAL@@PEAVVIDMM_PROCESS@@@Z @ 0x1C00833CC
 * Callers:
 ...
 *     ?InsertVadToFreeList@CVirtualAddressAllocator@@IEAAXPEAUVIDMM_VAD@@@Z @ 0x1C007DC7C (-InsertVadToFreeList@CVirtualAddressAllocator@@IEAAXPEAUVIDMM_VAD@@@Z.c)
 *     ?AllocateVad@CVirtualAddressAllocator@@SAPEAUVIDMM_VAD@@_K0I@Z @ 0x1C007DD28 (-AllocateVad@CVirtualAddressAllocator@@SAPEAUVIDMM_VAD@@_K0I@Z.c)
        ...
        struct VIDMM_PROCESS *a5)
{
  ...
  *((_QWORD *)this + 6) = 0LL;
  ...
  if ( v12 )
    ...
    v15 = 0LL;
  *((_QWORD *)this + 13) = v15;
  if ( !v15 || (int)VIDMM_DEVICE::Init(v15, 0LL, (struct _KTHREAD **)a5) < 0 )
    goto LABEL_29;
  if ( dword_1C0051494 == 2 )
  {
