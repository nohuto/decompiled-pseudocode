/*
 * XREFs of ?Resume@VIDMM_DEVICE@@QEAAJ_NPEA_NPEAPEAUVIDMM_ALLOC@@@Z @ 0x1C0082EA0
 * Callers:
    ...
    || (v8 = VIDMM_GLOBAL::TryPageInDevice(*(VIDMM_GLOBAL **)this, this, a2, a3, a4), v8 >= 0) )
  {
    ...
    VIDMM_GLOBAL::RecordVaPagingHistorySuspendResumeDevice(
      ...
      *((struct VIDMM_PROCESS **)this + 1),
      this,
      1u);
    DXGAUTOPUSHLOCK::DXGAUTOPUSHLOCK((DXGAUTOPUSHLOCK *)v25, (struct _KTHREAD **)(*(_QWORD *)this + 44472LL), 0LL);
