/*
 * XREFs of VidSchiProcessHwQueuePageFaultedDpc @ 0x1C003ACC8
 * Callers:
 *     VidSchDdiNotifyDpc @ 0x1C00058D0 (VidSchDdiNotifyDpc.c)
 *     VidSchDdiNotifyDpcWorker @ 0x1C002EBA8 (VidSchDdiNotifyDpcWorker.c)
 * Callees:
...
LABEL_39:
  ...
  if ( (unsigned int)dword_1C0051048 > 5 && tlgKeywordOn((__int64)&dword_1C0051048, 0x400000000010LL) )
  {
    ...
    v36 = v4;
    v40 = v29;
    v52 = *(unsigned __int16 **)(Blink + 1520);
    *(_QWORD *)&v53 = v33;
    v56 = v31;
