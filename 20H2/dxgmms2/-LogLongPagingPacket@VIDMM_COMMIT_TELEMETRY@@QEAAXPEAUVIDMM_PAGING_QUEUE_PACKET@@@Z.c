/*
 * XREFs of ?LogLongPagingPacket@VIDMM_COMMIT_TELEMETRY@@QEAAXPEAUVIDMM_PAGING_QUEUE_PACKET@@@Z @ 0x1C00C0E2C
 * Callers:
        ...
        struct VIDMM_PAGING_QUEUE_PACKET *a2)
{
    ...
    && (unsigned int)_InterlockedIncrement((volatile signed __int32 *)(*((_QWORD *)this + 1) + 260LL)) <= 5 )
  {
    ...
    if ( (unsigned int)dword_1C0051048 > 5 && tlgKeywordOn((__int64)&dword_1C0051048, 0x400000000008LL) )
    {
      v5 = *((_QWORD *)a2 + 17);
      v6 = *((_QWORD *)a2 + 19);
