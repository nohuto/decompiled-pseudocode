/*
 * XREFs of ?GetNextBuffersContractedSize@VIDMM_DMA_POOL@@QEAAXPEA_KPEAI1@Z @ 0x1C00BB9B4
 * Callers:
 *     VidMmGetNextBuffersContractedSize @ 0x1C00224C0 (VidMmGetNextBuffersContractedSize.c)
 * Callees:
