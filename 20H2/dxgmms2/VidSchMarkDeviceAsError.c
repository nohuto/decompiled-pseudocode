/*
 * XREFs of VidSchMarkDeviceAsError @ 0x1C0015BD0
 * Callers:
 *     VidSchiSendToExecutionQueue @ 0x1C0007900 (VidSchiSendToExecutionQueue.c)
 *     VidSchInvalidateHwContext @ 0x1C0039C80 (VidSchInvalidateHwContext.c)
 ...
 *     ?ValidateHistoryBuffers@VIDMM_GLOBAL@@QEAAJPEAPEAU_VIDMM_MULTI_ALLOC@@_K@Z @ 0x1C00B6CF8 (-ValidateHistoryBuffers@VIDMM_GLOBAL@@QEAAJPEAPEAU_VIDMM_MULTI_ALLOC@@_K@Z.c)
