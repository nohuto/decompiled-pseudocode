/*
 * XREFs of VidSchTerminateAdapter @ 0x1C00D3950
 * Callers:
 *     VidSchInitializeAdapter @ 0x1C008D5F0 (VidSchInitializeAdapter.c)
 *     VidSchiHandleControlEvent @ 0x1C00D0CB8 (VidSchiHandleControlEvent.c)
 * Callees:
 *     VidSchiAcceptsIncomingWork @ 0x1C00083A8 (VidSchiAcceptsIncomingWork.c)
 *     VidSchiDecrementContextReference @ 0x1C00105B0 (VidSchiDecrementContextReference.c)
 *     VidSchIsWorkerThread @ 0x1C0010AB0 (VidSchIsWorkerThread.c)
 *     VidSchiClearPeriodicFrameNotifications @ 0x1C002EFF8 (VidSchiClearPeriodicFrameNotifications.c)
 *     ??1_VIDSCH_GLOBAL@@QEAA@XZ @ 0x1C0032764 (--1_VIDSCH_GLOBAL@@QEAA@XZ.c)
 *     VidSchTerminateHwContext @ 0x1C003A8A0 (VidSchTerminateHwContext.c)
 *     VidSchTerminateHwQueue @ 0x1C003A9C0 (VidSchTerminateHwQueue.c)
