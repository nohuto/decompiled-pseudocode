/*
 * XREFs of ?InitPagingProcessVaSpace@VIDMM_GLOBAL@@QEAAJIE@Z @ 0x1C0095B00
 * Callers:
 ...
 *     ?EvictRootPageTable@CVirtualAddressAllocator@@QEAAXIE@Z @ 0x1C00231C4 (-EvictRootPageTable@CVirtualAddressAllocator@@QEAAXIE@Z.c)
 ...
 *     ?MapPagingQueueGpuVAs@VIDMM_DEVICE@@QEAAJI@Z @ 0x1C00B8F78 (-MapPagingQueueGpuVAs@VIDMM_DEVICE@@QEAAJI@Z.c)
 ...
 *     VidSchSetHwQueueProgressFenceObject @ 0x1C00D4240 (VidSchSetHwQueueProgressFenceObject.c)
 */
