/*
 * XREFs of McTemplateK0pptpqxpx_EtwWriteTransfer @ 0x1C0026CEC
 * Callers:
...
NTSTATUS McTemplateK0pptpqxpx_EtwWriteTransfer(__int64 a1, __int64 a2, __int64 a3, ...)
{
  ...
  v18 = 8LL;
  v20 = 8LL;
  return McGenEventWrite_EtwWriteTransfer(&DxgkControlGuid_Context, &EventPagingOpInitContextResource, a3, 9u, &v4);
}
