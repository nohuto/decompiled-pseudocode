/*
 * XREFs of ?ReferenceAllocationForTokenSubmission@VIDMM_GLOBAL@@QEAAJPEAVVIDMM_DEVICE@@PEAU_VIDMM_MULTI_ALLOC@@PEAPEAUVIDMM_ALLOC@@@Z @ 0x1C00B3E3C
 * Callers:
 *     VidMmReferenceAllocationForTokenSubmission @ 0x1C00226B0 (VidMmReferenceAllocationForTokenSubmission.c)
 * Callees:
 *     <none>
 */
