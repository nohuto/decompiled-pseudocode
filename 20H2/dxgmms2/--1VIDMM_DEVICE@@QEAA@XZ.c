/*
 * XREFs of ??1VIDMM_DEVICE@@QEAA@XZ @ 0x1C0080CBC
 * Callers:
...
void __fastcall VIDMM_DEVICE::~VIDMM_DEVICE(VIDMM_DEVICE *this)
{
  ...
  DXGAUTOPUSHLOCK::DXGAUTOPUSHLOCK((DXGAUTOPUSHLOCK *)v36, (struct _KTHREAD **)(*(_QWORD *)this + 44472LL), 0LL);
  ...
  DXGAUTOPUSHLOCK::DXGAUTOPUSHLOCK((DXGAUTOPUSHLOCK *)v39, (struct _KTHREAD **)(*(_QWORD *)this + 44472LL), 0LL);
