/*
 * XREFs of ?TlgAggregateInternalRegisteredProviderEtwCallback@@YAXPEBU_GUID@@KE_K1PEAU_EVENT_FILTER_DESCRIPTOR@@PEAX@Z @ 0x1C00882A0
 * Callers:
 *     <none>
 * Callees:
 *     _guard_dispatch_icall_nop @ 0x1C00182E0 (_guard_dispatch_icall_nop.c)
 *     LookUpTableFlushComplete @ 0x1C00967C8 (LookUpTableFlushComplete.c)
 *     LookUpTableFlushPartial @ 0x1C00D56AC (LookUpTableFlushPartial.c)
 */
