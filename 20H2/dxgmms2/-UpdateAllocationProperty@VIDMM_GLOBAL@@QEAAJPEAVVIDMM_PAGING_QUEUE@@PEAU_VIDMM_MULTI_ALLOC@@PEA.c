/*
 * XREFs of ?UpdateAllocationProperty@VIDMM_GLOBAL@@QEAAJPEAVVIDMM_PAGING_QUEUE@@PEAU_VIDMM_MULTI_ALLOC@@PEAU_VIDMM_UPDATEALLOCPROPERTY@@PEA_K@Z @ 0x1C00B5A44
 * Callers:
 *     ?VidMmUpdateAllocationProperty@@YAJPEAVVIDMM_GLOBAL@@PEAVVIDMM_PAGING_QUEUE@@PEAU_VIDMM_MULTI_ALLOC@@PEAU_VIDMM_UPDATEALLOCPROPERTY@@PEA_K@Z @ 0x1C0022250 (-VidMmUpdateAllocationProperty@@YAJPEAVVIDMM_GLOBAL@@PEAVVIDMM_PAGING_QUEUE@@PEAU_VIDMM_MULTI_AL.c)
 * Callees:
  ...
  *(_OWORD *)((char *)&v31[4] + 4) = *(_OWORD *)a4;
  ...
  if ( (_mm_srli_si128(*(__m128i *)(v31 + 36), 8).m128i_i8[4] & 2) != 0 )
  {
    ...
    if ( _bittest((const int *)&v15, v10) || (*((_DWORD *)a3 + 7) & 8) != 0 && (~v13 & HIDWORD(v31[4])) != 0 )
      goto LABEL_3;
    v19 = *(_DWORD *)(v12 + 76);
    v20 = *(struct _DXGK_ALLOCATIONINFOFLAGS_WDDM2_0 **)(v12 + 496);
    v33 = 0;
