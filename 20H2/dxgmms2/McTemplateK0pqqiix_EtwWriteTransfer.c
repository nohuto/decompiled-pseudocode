/*
 * XREFs of McTemplateK0pqqiix_EtwWriteTransfer @ 0x1C002D99C
 * Callers:
 *     VidSchiProcessPeriodicNotificationCookie @ 0x1C0030224 (VidSchiProcessPeriodicNotificationCookie.c)
 *     ?VidSchPeriodicMonitoredFenceTimerCallback@@YAXPEAU_EX_TIMER@@PEAX@Z @ 0x1C0032A70 (-VidSchPeriodicMonitoredFenceTimerCallback@@YAXPEAU_EX_TIMER@@PEAX@Z.c)
 * Callees:
