/*
 * XREFs of ?VidMmMapViewOfAllocation@@YAPEAXPEAU_VIDMM_LOCAL_ALLOC@@_K1PEAPEAXH@Z @ 0x1C006C988
 * Callers:
  ...
  *a4 = 0LL;
  ...
  else
  {
    if ( (*(_DWORD *)(v5 + 84) & 4) != 0 || (_DWORD)v10 )
    {
      v26 = *(_QWORD *)(v5 + 352);
      v38 = a2;
      v27 = MmMapViewInSystemSpaceEx(v26, v5 + 360, &v37, &v38, 0LL);
      v29 = v27;
      if ( v27 < 0 )
      {
      ...
      {
        MappedBase = (PVOID)(a2 + *(_QWORD *)(v5 + 360) - v38);
...
LABEL_18:
        ...
        *(_QWORD *)(v20 + 32) = (int)v16;
        ...
        if ( !a5 )
        {
          v21 = MmMapViewInSystemSpace(*(PVOID *)(v5 + 352), &MappedBase, (PSIZE_T)(v5 + 8));
          v16 = v21;
          if ( v21 < 0 )
          {
            _InterlockedIncrement(&dword_1C0051754);
