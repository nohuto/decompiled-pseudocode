/*
 * XREFs of ?DeInitGlobals@VIDMM_GLOBAL@@SAXXZ @ 0x1C00AF6EC
 * Callers:
 *     VidMmDeInitGlobals @ 0x1C0022460 (VidMmDeInitGlobals.c)
 * Callees:
 *     ??3@YAXPEAX@Z @ 0x1C0011A64 (--3@YAXPEAX@Z.c)
 *     McGenEventUnregister_EtwUnregister @ 0x1C0023CDC (McGenEventUnregister_EtwUnregister.c)
 *     ??_GVIDMM_PROCESS_FENCE_STORAGE@@QEAAPEAXI@Z @ 0x1C0025990 (--_GVIDMM_PROCESS_FENCE_STORAGE@@QEAAPEAXI@Z.c)
 *     ?wil_UninitializeFeatureStaging@@YAXXZ @ 0x1C005F9E8 (-wil_UninitializeFeatureStaging@@YAXXZ.c)
