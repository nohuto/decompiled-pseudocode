/*
 * XREFs of ?VidMmiInit@@YAPEAVVIDMM_GLOBAL@@PEAVADAPTER_RENDER@@@Z @ 0x1C0093BD4
 * Callers:
 *     VidMmInitializeAdapter @ 0x1C00172B0 (VidMmInitializeAdapter.c)
 * Callees:
 ...
 *     ??_GVIDMM_GLOBAL@@QEAAPEAXI@Z @ 0x1C0021BA0 (--_GVIDMM_GLOBAL@@QEAAPEAXI@Z.c)
...
LABEL_24:
  ...
  if ( v18 < 0 )
  {
    _InterlockedIncrement(&dword_1C00516A0);
