/*
 * XREFs of ?ModifyPageTable@VIDMM_PAGE_TABLE@@QEAAXPEAVCVirtualAddressAllocator@@PEBUCOMMIT_VA_STATE@@II_KPEAE@Z @ 0x1C007D950
 * Callers:
      ...
      if ( (unsigned int)v10 < (unsigned int)v10 + a5 )
      {
        ...
        do
        {
          ...
          *(_QWORD *)(v17 + v16) = *(_QWORD *)a3;
          ...
          v13 += v12;
          *(_QWORD *)(v16 + *((_QWORD *)this + 3) + 8) = v19;
          v16 += 16LL;
          --v15;
        }
        while ( v15 );
      ...
      if ( (unsigned int)v10 < (unsigned int)v10 + a5 )
      {
        ...
        do
        {
          ...
          *(_QWORD *)(v23 + v22) = *(_QWORD *)a3;
          v24 = *((_QWORD *)a3 + 8);
          if ( v24 )
            *(_QWORD *)(v22 + *((_QWORD *)this + 3) + 8) = *((_QWORD *)a3 + 3) + (v20 - *((_QWORD *)a3 + 3)) % v24;
          else
            *(_QWORD *)(v22 + *((_QWORD *)this + 3) + 8) = v20;
          v22 += 16LL;
          v25 = 16LL;
          if ( (*(_DWORD *)this & 0x40) == 0 )
            v25 = 1LL;
