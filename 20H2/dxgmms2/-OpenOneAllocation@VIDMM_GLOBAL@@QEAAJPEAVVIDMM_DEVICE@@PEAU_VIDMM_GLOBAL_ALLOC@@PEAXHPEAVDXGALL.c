/*
 * XREFs of ?OpenOneAllocation@VIDMM_GLOBAL@@QEAAJPEAVVIDMM_DEVICE@@PEAU_VIDMM_GLOBAL_ALLOC@@PEAXHPEAVDXGALLOCATION@@PEAPEAUVIDMM_ALLOC@@PEAE@Z @ 0x1C0078DD0
 * Callers:
 *     ?OpenAllocation@VIDMM_GLOBAL@@QEAAJPEAVVIDMM_DEVICE@@PEAU_VIDMM_MULTI_GLOBAL_ALLOC@@IPEAXHPEAVDXGALLOCATION@@PEAPEAU_VIDMM_MULTI_ALLOC@@PEAIPEAE@Z @ 0x1C0078D44 (-OpenAllocation@VIDMM_GLOBAL@@QEAAJPEAVVIDMM_DEVICE@@PEAU_VIDMM_MULTI_GLOBAL_ALLOC@@IPEAXHPEAVDX.c)
 ...
 *     ?IsWarpAdapter@DXGADAPTER@@QEBAEXZ @ 0x1C0012AB0 (-IsWarpAdapter@DXGADAPTER@@QEBAEXZ.c)
...
LABEL_131:
    _InterlockedIncrement(&dword_1C0051648);
    v105 = WdLogNewEntry5_WdLowResource(v16);
    *(_QWORD *)(v105 + 24) = 4116LL;
  ...
  if ( ((_BYTE)this[5117] & 4) != 0 )
  {
    if ( (**((_DWORD **)a3 + 62) & 0x10000008) != 0 )
    {
      ...
      else
      {
        v111 = 0LL;
        v115 = 0LL;
        CurrentProcess = PsGetCurrentProcess(v48, v47, v44);
...
LABEL_118:
  ...
  {
    v59 = (_QWORD *)WdLogNewEntry5_WdCriticalError(v48, v47);
    v59[3] = 275LL;
    v59[4] = 4LL;
    v59[5] = v58;
    v59[6] = 0LL;
  ...
  if ( v60 <= 0 )
  {
    v61 = WdLogNewEntry5_WdAssertion(v48, v47, v44);
    *(_QWORD *)(v61 + 24) = 705LL;
  ...
  *(_DWORD *)(v58 + 24) = v62;
  ...
  if ( v117 != v116 )
  {
    ...
    {
      DXGAUTOPUSHLOCK::DXGAUTOPUSHLOCK((DXGAUTOPUSHLOCK *)v121, this + 4996, 0LL);
      DXGPUSHLOCK::AcquireExclusive(v122);
      v67 = (__int64 *)((char *)a3 + 408);
      v123 = 2;
      if ( *((_QWORD *)a3 + 51) )
      ...
      if ( (*((_BYTE *)a3 + 84) & 0xC0) == 0xC0 )
      {
        ...
        v69 = *(_QWORD *)(*(_QWORD *)(*((_QWORD *)v45 + 1) + 16LL) + 8 * v68) + 424LL;
        v70 = *(__int64 ***)(*(_QWORD *)(*(_QWORD *)(*((_QWORD *)v45 + 1) + 16LL) + 8 * v68) + 432LL);
        if ( *v70 != (__int64 *)v69 )
          goto LABEL_130;
        *v67 = v69;
        *((_QWORD *)a3 + 52) = v70;
