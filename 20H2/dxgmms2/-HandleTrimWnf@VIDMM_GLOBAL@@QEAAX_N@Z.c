/*
 * XREFs of ?HandleTrimWnf@VIDMM_GLOBAL@@QEAAX_N@Z @ 0x1C0081BB0
 * Callers:
 ...
 *     ?GetNumBytesToTrim@VIDMM_PROCESS_ADAPTER_INFO@@QEAAXPEA_K_N1@Z @ 0x1C006C368 (-GetNumBytesToTrim@VIDMM_PROCESS_ADAPTER_INFO@@QEAAXPEA_K_N1@Z.c)
 ...
 *     ?SendWnfNotificationToProcess@VIDMM_GLOBAL@@KAJPEAVVIDMM_PROCESS@@PEBU_WNF_STATE_NAME@@PEAXK@Z @ 0x1C0082344 (-SendWnfNotificationToProcess@VIDMM_GLOBAL@@KAJPEAVVIDMM_PROCESS@@PEBU_WNF_STATE_NAME@@PEAXK@Z.c)
 */
...
LABEL_17:
        ...
        if ( v16 == 0x1E3AC1ECDLL )
          ...
          v18 = v17 / v16;
        v19 = 100 - v18;
        if ( (__int64)(100 - v18) <= (unsigned int)dword_1C0051404 )
        {
          if ( v19 <= (unsigned int)dword_1C0051408 )
          {
            v20 = (unsigned int)dword_1C0051418;
            v21 = (unsigned int)dword_1C0051414;
            v9 = v78;
            goto LABEL_13;
          }
          v9 = v78;
          v20 = (unsigned int)dword_1C0051418
              + (v19 - (unsigned int)dword_1C0051408)
              * (unsigned int)(dword_1C0051414 - dword_1C0051418)
              / (unsigned int)(dword_1C0051404 - dword_1C0051408);
        }
        else
        {
          v20 = (unsigned int)dword_1C005140C;
        }
        v21 = (unsigned int)dword_1C0051410;
LABEL_13:
        if ( v3 >= v20 )
          v3 = v20;
        if ( v6 >= v21 )
...
LABEL_50:
          ...
          if ( v34 == 0x1E3AC1ECDLL )
            ...
            v36 = v35 / v34;
          v37 = 100 - v36;
          if ( (__int64)(100 - v36) > (unsigned int)dword_1C0051404 )
          {
            v38 = (unsigned int)dword_1C005140C;
            goto LABEL_45;
          }
          if ( v37 > (unsigned int)dword_1C0051408 )
          {
            v9 = v78;
            v38 = (unsigned int)dword_1C0051418
                + (v37 - (unsigned int)dword_1C0051408)
                * (unsigned int)(dword_1C0051414 - dword_1C0051418)
                / (unsigned int)(dword_1C0051404 - dword_1C0051408);
LABEL_45:
            v39 = (unsigned int)dword_1C0051410;
          }
          else
          {
            v38 = (unsigned int)dword_1C0051418;
            v39 = (unsigned int)dword_1C0051414;
            v9 = v78;
          }
          if ( v3 >= v38 )
            v3 = v38;
      ...
      if ( v42 == 917943092 )
        ...
        v44 = v43 / v42;
      v45 = 100 - v44;
      if ( (__int64)(100 - v44) <= (unsigned int)dword_1C0051404 )
      {
        v9 = v78;
        if ( v45 <= (unsigned int)dword_1C0051408 )
        {
          v46 = (unsigned int)dword_1C0051418;
          v47 = (unsigned int)dword_1C0051414;
          v12 = v79;
          goto LABEL_61;
        }
        v12 = v79;
        v46 = (unsigned int)dword_1C0051418
            + (v45 - (unsigned int)dword_1C0051408)
            * (unsigned int)(dword_1C0051414 - dword_1C0051418)
            / (unsigned int)(dword_1C0051404 - dword_1C0051408);
      }
      else
      {
        v46 = (unsigned int)dword_1C005140C;
      }
      v47 = (unsigned int)dword_1C0051410;
LABEL_61:
      if ( v3 >= v46 )
        v3 = v46;
      if ( v6 >= v47 )
...
LABEL_69:
    ...
    if ( v24 == 917943092 )
      ...
      v26 = v25 / v24;
    v27 = 100 - v26;
    if ( (__int64)(100 - v26) <= (unsigned int)dword_1C0051404 )
    {
      v9 = v78;
      if ( v27 <= (unsigned int)dword_1C0051408 )
      {
        v28 = (unsigned int)dword_1C0051418;
        v29 = (unsigned int)dword_1C0051414;
        v12 = v79;
        goto LABEL_28;
      }
      v12 = v79;
      v28 = (unsigned int)dword_1C0051418
          + (v27 - (unsigned int)dword_1C0051408)
          * (unsigned int)(dword_1C0051414 - dword_1C0051418)
          / (unsigned int)(dword_1C0051404 - dword_1C0051408);
    }
    else
    {
      v28 = (unsigned int)dword_1C005140C;
    }
    v29 = (unsigned int)dword_1C0051410;
LABEL_28:
    if ( v3 >= v28 )
      v3 = v28;
    if ( v6 >= v29 )
  ...
  if ( !(unsigned __int8)ExTryAcquirePushLockSharedEx((char *)this + 41040, 0LL) )
  {
    if ( bTracingEnabled )
    {
      ...
      if ( v75 != -1 && (Microsoft_Windows_DxgKrnlEnableBits & 0x40) != 0 )
        McTemplateK0q_EtwWriteTransfer(v58, &EventBlockThread, v59, v75);
    }
...
LABEL_113:
      ...
      if ( a2 )
      {
        DXGAUTOPUSHLOCK::DXGAUTOPUSHLOCK((DXGAUTOPUSHLOCK *)v84, v62 + 42, 0LL);
        DXGPUSHLOCK::AcquireShared(v85);
        v86 = 1;
        VIDMM_PROCESS_ADAPTER_INFO::GetNumBytesToTrim(v62 - 3, &v79, 0, 1);
