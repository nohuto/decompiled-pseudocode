/*
 * XREFs of VidSchCreateSyncObject @ 0x1C007FD70
 * Callers:
 ...
 *     DxgkAcquireGuestCpuEvent @ 0x1C0017810 (DxgkAcquireGuestCpuEvent.c)
 ...
 *     VidSchiAddSyncObjectToAdapterList @ 0x1C002ED40 (VidSchiAddSyncObjectToAdapterList.c)
 *     VidSchiAddSyncObjectToCrossAdapterInfo @ 0x1C002EDB8 (VidSchiAddSyncObjectToCrossAdapterInfo.c)
        ...
        *(_BYTE *)(v17 + 25) = 0;
        if ( *(_BYTE *)(v17 + 31) )
        {
          *(_QWORD *)(v17 + 64) = *((_QWORD *)a3 + 1);
          if ( (unsigned int)Feature_WSL_Device_GPU__private_IsEnabled() && *(_BYTE *)(*((_QWORD *)a3 + 1) + 19LL) )
