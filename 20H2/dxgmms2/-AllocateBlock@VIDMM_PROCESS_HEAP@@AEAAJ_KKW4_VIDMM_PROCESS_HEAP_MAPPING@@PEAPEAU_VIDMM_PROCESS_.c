/*
 * XREFs of ?AllocateBlock@VIDMM_PROCESS_HEAP@@AEAAJ_KKW4_VIDMM_PROCESS_HEAP_MAPPING@@PEAPEAU_VIDMM_PROCESS_HEAP_BLOCK@@E@Z @ 0x1C00CCE70
 * Callers:
...
LABEL_31:
  ...
  if ( !v10 )
  {
    _InterlockedIncrement(&dword_1C00516AC);
  ...
  if ( v32 < 0 )
  {
    _InterlockedIncrement(&dword_1C00516B0);
    goto LABEL_37;
  }
  ...
  if ( !v33 )
  {
    _InterlockedIncrement(&dword_1C00516B4);
