/*
 * XREFs of ?CommitVirtualAddressRange@VIDMM_PAGE_DIRECTORY@@QEAAJPEAVCVirtualAddressAllocator@@PEBUCOMMIT_VA_STATE@@_K222EPEAPEAUVIDMM_ALLOC@@@Z @ 0x1C007B170
 * Callers:
 ...
 *     ?CheckContiguousSysMem@@YAEPEAU_MDL@@I_K@Z @ 0x1C00BD77C (-CheckContiguousSysMem@@YAEPEAU_MDL@@I_K@Z.c)
...
LABEL_64:
    if ( !*((_DWORD *)this + 1) && (*((_DWORD *)v69 + 36) & 4) == 0 )
      VIDMM_PAGE_DIRECTORY::EvictPageDirectory(this, v69, v15 & ~*((_QWORD *)v32 + 4), 1u, 1u);
