/*
 * XREFs of VidSchiEnsureRootPageTableUpdated @ 0x1C00D456C
 * Callers:
 *     VidSchSubmitCommandToHwQueue @ 0x1C0039DF0 (VidSchSubmitCommandToHwQueue.c)
 *     VidSchiSuspendResumeHwContext @ 0x1C003BF78 (VidSchiSuspendResumeHwContext.c)
 * Callees:
 *     ?DdiSetRootPageTable@ADAPTER_RENDER@@QEAAXPEAU_DXGKARG_SETROOTPAGETABLE@@@Z @ 0x1C0015F78 (-DdiSetRootPageTable@ADAPTER_RENDER@@QEAAXPEAU_DXGKARG_SETROOTPAGETABLE@@@Z.c)
 ...
 *     ?GetPageDirectoryData@VIDMM_PROCESS@@QEAAXKIPEA_KPEAI10@Z @ 0x1C00BB0E8 (-GetPageDirectoryData@VIDMM_PROCESS@@QEAAXKIPEA_KPEAI10@Z.c)
 */
