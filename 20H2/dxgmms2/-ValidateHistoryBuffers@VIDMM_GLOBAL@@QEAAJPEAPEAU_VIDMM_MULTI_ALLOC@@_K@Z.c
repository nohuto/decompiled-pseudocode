/*
 * XREFs of ?ValidateHistoryBuffers@VIDMM_GLOBAL@@QEAAJPEAPEAU_VIDMM_MULTI_ALLOC@@_K@Z @ 0x1C00B6CF8
 * Callers:
 *     VidMmValidateHistoryBuffers @ 0x1C0022990 (VidMmValidateHistoryBuffers.c)
 * Callees:
