/*
 * XREFs of ?VidMmGetAllocationGpuVirtualAddress@VIDMM_GLOBAL@@QEAA_KPEAU_VIDMM_MULTI_ALLOC@@EI@Z @ 0x1C008563C
 * Callers:
 *     VidMmGetAllocationGpuVirtualAddress @ 0x1C0014660 (VidMmGetAllocationGpuVirtualAddress.c)
 * Callees:
