/*
 * XREFs of ?Lock@VIDMM_GLOBAL@@QEAAJPEAU_VIDMM_MULTI_ALLOC@@KPEAPEAX@Z @ 0x1C0074740
 * Callers:
 *     ?VidMmLock@@YAJPEAVVIDMM_GLOBAL@@PEAU_VIDMM_MULTI_ALLOC@@KPEAPEAX@Z @ 0x1C0011F40 (-VidMmLock@@YAJPEAVVIDMM_GLOBAL@@PEAU_VIDMM_MULTI_ALLOC@@KPEAPEAX@Z.c)
 * Callees:
...
LABEL_37:
      ...
      if ( !(unsigned __int8)ExTryAcquirePushLockExclusiveEx(v40, 0LL) )
      {
        if ( bTracingEnabled )
        {
          ...
          if ( v50 != -1 && (Microsoft_Windows_DxgKrnlEnableBits & 0x40) != 0 )
            McTemplateK0q_EtwWriteTransfer(v48, &EventBlockThread, v49, v50);
        }
  ...
  if ( !*((_DWORD *)v61 + 19) )
  {
    ...
    else if ( v64 )
    {
      ...
      if ( (v65 & 0x1001) == 0 )
      {
        if ( (**(_DWORD **)(v62 + 496) & 4) != 0 && !*(_BYTE *)(v64 + 474) || (v63 & 0x10000) != 0 )
          goto LABEL_80;
        if ( (v65 & 4) != 0 )
        {
          if ( (v61[4] & 1) == 0 )
