/*
 * XREFs of ?SignalMonitoredFence@VIDMM_GLOBAL@@QEAAXIPEAU_VIDSCH_SYNC_OBJECT@@_KPEA_N@Z @ 0x1C00B4C34
 * Callers:
 ...
 *     VidSchGetDriverPagingHwQueue @ 0x1C0034BD4 (VidSchGetDriverPagingHwQueue.c)
