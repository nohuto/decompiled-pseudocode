/*
 * XREFs of VidSchiProcessDpcCompletedPacket @ 0x1C00083C0
 * Callers:
 ...
 *     ?VidSchiAllowToDebugPageFault@@YAXPEAU_VIDSCH_DMA_PACKET@@@Z @ 0x1C002A2AC (-VidSchiAllowToDebugPageFault@@YAXPEAU_VIDSCH_DMA_PACKET@@@Z.c)
...
LABEL_113:
      if ( v63 >= *(_QWORD *)(v59 + 2688) )
      {
        ...
        if ( v63 >= *(_QWORD *)(v59 + 2672) && !*(_BYTE *)(*(_QWORD *)(v131 + 40) + 2624LL) )
        {
            ...
            && (*(_DWORD *)(v59 + 2448) & 0x200) != 0 )
          {
            ...
            VidSchiUpdateContextStatus(v1, 7uLL, 26665LL);
            if ( bTracingEnabled )
            {
              v79 = *(_QWORD *)(v1 + 56);
  ...
  *(_QWORD *)(v119 + 16) = *((_QWORD *)v3 + 13);
  ...
  if ( bTracingEnabled )
  {
    ...
    if ( *(_QWORD *)(v33 + 984)
      || (v87 = operator new[](0x400uLL, 0x61616956u, (enum _POOL_TYPE)512), (*(_QWORD *)(v33 + 984) = v87) != 0LL) )
    {
