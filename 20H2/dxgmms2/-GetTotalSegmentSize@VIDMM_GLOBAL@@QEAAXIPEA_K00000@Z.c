/*
 * XREFs of ?GetTotalSegmentSize@VIDMM_GLOBAL@@QEAAXIPEA_K00000@Z @ 0x1C006D1BC
 * Callers:
 *     VidMmGetTotalSegmentSize @ 0x1C0011600 (VidMmGetTotalSegmentSize.c)
 * Callees:
 *     ?GetCurrent@VIDMM_PARTITION@@SAPEAU1@XZ @ 0x1C0011644 (-GetCurrent@VIDMM_PARTITION@@SAPEAU1@XZ.c)
