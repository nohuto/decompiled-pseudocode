/*
 * XREFs of McTemplateK0pppqxqqqqqqqpppqqqqqqqqqqtpht_EtwWriteTransfer @ 0x1C0023F00
 * Callers:
 ...
 *     ?ReportState@VIDMM_DMA_POOL@@QEAAXXZ @ 0x1C00BBB38 (-ReportState@VIDMM_DMA_POOL@@QEAAXXZ.c)
 *     ?VidMmReportGlobalAlloc@@YAXPEAVDXGDEVICE@@PEAU_VIDMM_GLOBAL_ALLOC@@PEAVDXGSHAREDRESOURCE@@@Z @ 0x1C00BCDD8 (-VidMmReportGlobalAlloc@@YAXPEAVDXGDEVICE@@PEAU_VIDMM_GLOBAL_ALLOC@@PEAVDXGSHAREDRESOURCE@@@Z.c)
