/*
 * XREFs of McTemplateK0pqqxqqtppx_EtwWriteTransfer @ 0x1C002E1F8
 * Callers:
...
NTSTATUS McTemplateK0pqqxqqtppx_EtwWriteTransfer(__int64 a1, __int64 a2, __int64 a3, ...)
{
  ...
  v22 = 8LL;
  v24 = 8LL;
  return McGenEventWrite_EtwWriteTransfer(&DxgkControlGuid_Context, &EventQueueSubmit, a3, 0xBu, &v4);
}
