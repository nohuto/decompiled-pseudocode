/*
 * XREFs of ?Escape@VIDMM_GLOBAL@@QEAAJPEAVVIDMM_DEVICE@@PEAU_D3DKMT_VIDMM_ESCAPE@@H@Z @ 0x1C00B0494
 * Callers:
 *     VidMmEscape @ 0x1C0022480 (VidMmEscape.c)
 * Callees:
 ...
 *     ?Flush@VIDMM_WORKER_THREAD@@QEAAXXZ @ 0x1C00B9E50 (-Flush@VIDMM_WORKER_THREAD@@QEAAXXZ.c)
        ...
        if ( Type != D3DKMT_VIDMMESCAPETYPE_DEFRAG )
        {
          if ( Type == 17 )
            wil_details_FeatureReporting_ReportUsageToService(
              ...
              (int)v33);
LABEL_23:
          DXGAUTOPUSHLOCK::DXGAUTOPUSHLOCK((DXGAUTOPUSHLOCK *)v34, this + 5130, 0LL);
