/*
 * XREFs of ?EndPreparation@VIDMM_GLOBAL@@IEAAXIPEAU_KEVENT@@_N_KPEAU_VIDSCH_SYNC_OBJECT@@@Z @ 0x1C007F608
 * Callers:
 ...
 *     VidSchSignalPagingFences @ 0x1C007E5AC (VidSchSignalPagingFences.c)
