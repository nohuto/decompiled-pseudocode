/*
 * XREFs of McTemplateK0ppxxxxxqxx_EtwWriteTransfer @ 0x1C0025EFC
 * Callers:
 ...
 *     ?VidMmiLogEndVaRangeMapping@@YAXPEAVCVirtualAddressAllocator@@PEAUVIDMM_MAPPED_VA_RANGE@@_K22@Z @ 0x1C00C05C8 (-VidMmiLogEndVaRangeMapping@@YAXPEAVCVirtualAddressAllocator@@PEAUVIDMM_MAPPED_VA_RANGE@@_K22@Z.c)
 * Callees:
