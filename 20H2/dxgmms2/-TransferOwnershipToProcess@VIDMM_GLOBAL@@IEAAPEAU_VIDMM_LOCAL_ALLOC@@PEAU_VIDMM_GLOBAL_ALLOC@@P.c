/*
 * XREFs of ?TransferOwnershipToProcess@VIDMM_GLOBAL@@IEAAPEAU_VIDMM_LOCAL_ALLOC@@PEAU_VIDMM_GLOBAL_ALLOC@@PEAU2@1@Z @ 0x1C0085CA0
 * Callers:
        ...
        struct _VIDMM_LOCAL_ALLOC *a4)
{
  ...
  if ( v4
    ...
    && (v10 = (PRKPROCESS *)*((_QWORD *)a4 + 1),
        ...
        (int)v11 < 0) )
  {
    _InterlockedIncrement(&dword_1C0051644);
