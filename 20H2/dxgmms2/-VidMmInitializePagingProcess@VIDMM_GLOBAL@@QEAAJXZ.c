/*
 * XREFs of ?VidMmInitializePagingProcess@VIDMM_GLOBAL@@QEAAJXZ @ 0x1C009596C
 * Callers:
 *     VidMmInitializePagingProcess @ 0x1C0017600 (VidMmInitializePagingProcess.c)
 * Callees:
