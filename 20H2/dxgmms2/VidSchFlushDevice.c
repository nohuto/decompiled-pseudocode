/*
 * XREFs of VidSchFlushDevice @ 0x1C0069460
 * Callers:
 ...
 *     ?WaitOnAllocForceSync@VIDMM_GLOBAL@@QEAAXPEAUVIDMM_ALLOC@@@Z @ 0x1C0069400 (-WaitOnAllocForceSync@VIDMM_GLOBAL@@QEAAXPEAUVIDMM_ALLOC@@@Z.c)
 ...
 *     VidSchiInterlockedReadUlong @ 0x1C0010ACC (VidSchiInterlockedReadUlong.c)
...
__int64 __fastcall VidSchFlushDevice(__int64 a1, int *a2, __int64 a3, __int64 a4)
{
  ...
  if ( a1 && a2 )
  {
    ...
    if ( (v7 & 1) != 0 )
    {
      ...
      if ( v7 != 5 )
      {
        VidSchiClearFlipDevice((struct _KEVENT *)v9, a1, 9u);
