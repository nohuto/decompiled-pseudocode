/*
 * XREFs of VidMmResizeBuffersInPool @ 0x1C0022790
 * Callers:
 *     <none>
 * Callees:
 *     ?ResizeBuffersInPool@VIDMM_DMA_POOL@@QEAAJ_KII@Z @ 0x1C00BBF60 (-ResizeBuffersInPool@VIDMM_DMA_POOL@@QEAAJ_KII@Z.c)
 */
