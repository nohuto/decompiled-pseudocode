/*
 * XREFs of McTemplateK0pqxxxx_EtwWriteTransfer @ 0x1C002E634
 * Callers:
 *     VidSchiUpdateLastCompletedPresentTimestamp @ 0x1C000C200 (VidSchiUpdateLastCompletedPresentTimestamp.c)
 *     ?VidSchiUpdateNodeYieldStatus@@YAXPEAU_VIDSCH_NODE@@@Z @ 0x1C0014974 (-VidSchiUpdateNodeYieldStatus@@YAXPEAU_VIDSCH_NODE@@@Z.c)
 * Callees:
...
NTSTATUS McTemplateK0pqxxxx_EtwWriteTransfer(__int64 a1, __int64 a2, __int64 a3, ...)
{
  ...
  v14 = 8LL;
  v16 = 8LL;
  return McGenEventWrite_EtwWriteTransfer(&DxgkControlGuid_Context, &EventYieldConditionEvaluation, a3, 7u, &v4);
}
