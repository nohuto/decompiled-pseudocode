/*
 * XREFs of ?ResizeBuffersInPool@VIDMM_DMA_POOL@@QEAAJ_KII@Z @ 0x1C00BBF60
 * Callers:
 *     VidMmResizeBuffersInPool @ 0x1C0022790 (VidMmResizeBuffersInPool.c)
 * Callees:
