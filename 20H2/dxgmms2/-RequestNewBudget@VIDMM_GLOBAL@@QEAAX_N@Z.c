/*
 * XREFs of ?RequestNewBudget@VIDMM_GLOBAL@@QEAAX_N@Z @ 0x1C0082848
 * Callers:
 ...
 *     ?NotifyProcessStatusChange@VIDMM_GLOBAL@@QEAAXXZ @ 0x1C0082640 (-NotifyProcessStatusChange@VIDMM_GLOBAL@@QEAAXXZ.c)
