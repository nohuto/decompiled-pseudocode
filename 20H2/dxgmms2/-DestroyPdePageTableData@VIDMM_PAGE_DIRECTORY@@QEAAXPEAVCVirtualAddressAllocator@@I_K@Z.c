/*
 * XREFs of ?DestroyPdePageTableData@VIDMM_PAGE_DIRECTORY@@QEAAXPEAVCVirtualAddressAllocator@@I_K@Z @ 0x1C0087A90
 * Callers:
  ...
  if ( (v8 & 2) == 0 )
  {
    ...
    else
    {
      ...
      if ( (*(_DWORD *)this & 0x20) != 0 )
        ...
        VIDMM_PAGE_DIRECTORY::DestroyPageDirectory((VIDMM_PAGE_DIRECTORY *)v10, (PRKPROCESS **)a2, a4);
    }
