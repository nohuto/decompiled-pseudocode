/*
 * XREFs of ?InvalidateAllocation@VIDMM_GLOBAL@@QEAAXPEAU_VIDMM_MULTI_GLOBAL_ALLOC@@@Z @ 0x1C00B17D0
 * Callers:
 *     VidMmInvalidateAllocation @ 0x1C0022520 (VidMmInvalidateAllocation.c)
 * Callees:
