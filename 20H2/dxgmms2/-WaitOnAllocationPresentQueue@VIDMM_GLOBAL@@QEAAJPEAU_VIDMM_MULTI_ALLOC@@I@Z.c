/*
 * XREFs of ?WaitOnAllocationPresentQueue@VIDMM_GLOBAL@@QEAAJPEAU_VIDMM_MULTI_ALLOC@@I@Z @ 0x1C00B86F8
 * Callers:
 *     VidMmWaitOnAllocationPresentQueue @ 0x1C00229B0 (VidMmWaitOnAllocationPresentQueue.c)
