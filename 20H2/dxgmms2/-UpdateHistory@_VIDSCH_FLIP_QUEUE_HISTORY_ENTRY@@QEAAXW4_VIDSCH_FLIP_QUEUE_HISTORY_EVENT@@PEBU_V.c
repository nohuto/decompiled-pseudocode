/*
 * XREFs of ?UpdateHistory@_VIDSCH_FLIP_QUEUE_HISTORY_ENTRY@@QEAAXW4_VIDSCH_FLIP_QUEUE_HISTORY_EVENT@@PEBU_VIDSCH_PRESENT_INFO@@PEAUVIDSCH_FLIP_QUEUE@@KK@Z @ 0x1C000F558
 * Callers:
        ...
        unsigned int a6)
{
  ...
  *(LARGE_INTEGER *)(a1 + 8) = KeQueryPerformanceCounter(0LL);
  v9 = 1344LL * a6;
  *(_BYTE *)(a1 + 32) = (*(_DWORD *)(v9 + a4 + 1224) & 0x20) != 0;
  *(_DWORD *)(a1 + 36) = *(_DWORD *)(v9 + a4 + 1140);
  *(_DWORD *)(a1 + 28) = *(_DWORD *)(v9 + a4 + 1144);
  *(_DWORD *)(a1 + 44) = *(_DWORD *)(a3 + 2356);
  *(_DWORD *)(a1 + 40) = *(_DWORD *)(a3 + 2352);
