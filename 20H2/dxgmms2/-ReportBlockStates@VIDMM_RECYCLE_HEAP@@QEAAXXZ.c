/*
 * XREFs of ?ReportBlockStates@VIDMM_RECYCLE_HEAP@@QEAAXXZ @ 0x1C00C27E0
 * Callers:
 ...
 *     ?ReportStates@VIDMM_RECYCLE_BLOCK@@QEAAXXZ @ 0x1C00C29A8 (-ReportStates@VIDMM_RECYCLE_BLOCK@@QEAAXXZ.c)
 */
