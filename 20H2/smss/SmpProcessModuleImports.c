/*
 * XREFs of SmpProcessModuleImports @ 0x140008B10
 * Callers:
 *     <none>
 * Callees:
...
int __fastcall SmpProcessModuleImports(__int16 **a1, const char *a2)
{
  ...
  *(_QWORD *)&v37.Length = 34209792LL;
  ...
  if ( v9 != 0x2D004900500041LL && v9 != 0x2D005400580045LL )
    goto LABEL_40;
  v10 = (PWSTR)((char *)v37.Buffer + v37.Length);
  v11 = v37.Length;
  if ( v37.Length > 1u )
  {
    do
...
LABEL_20:
  ...
  v22 = (_DWORD *)((char *)&v7[6 * *(_DWORD *)((char *)v7 + v21 + 4)] + (unsigned int)v7[4]);
  if ( !v22 )
  {
LABEL_40:
    v34 = (PWSTR)((char *)Buffer + Length - 2);
    if ( v34 < Buffer )
      goto LABEL_43;
    while ( *v34 != 46 )
    {
...
LABEL_43:
    ...
    else
    {
      *(&v38.MaximumLength + 2) = 0;
      ...
      v35 = &v38;
      v38.Buffer = Buffer;
      *(_DWORD *)&v38.MaximumLength = (unsigned __int16)(2 * v36);
      v38.Length = 2 * v36;
    }
    return SmpSaveRegistryValue_U(v3[1], v35, &v37, 1LL, 0LL);
  }
  if ( RtlCompareUnicodeStrings(v37.Buffer, v12, (PCWCH)((char *)v7 + v22[1]), v22[3] >> 1, 1u) )
    goto LABEL_39;
  if ( v8 )
  {
    v23 = v22[5];
    if ( v23 > 1 )
    {
      ...
      {
        v31 = (v29 + v25) >> 1;
        v32 = (__int64)&v7[5 * v31] + v22[4];
        v33 = RtlCompareUnicodeStrings(
                v26,
                v30,
                (PCWCH)((char *)v7 + *(unsigned int *)(v32 + 4)),
                *(_DWORD *)(v32 + 8) >> 1,
                1u);
        if ( v33 >= 0 )
        {
...
LABEL_39:
  ...
  v27 = (char *)v7 + v22[4];
LABEL_37:
  v38.Buffer = (PWSTR)((char *)v7 + *((unsigned int *)v27 + 3));
  v38.MaximumLength = *((_WORD *)v27 + 8);
  result = *((unsigned __int16 *)v27 + 8);
  v38.Length = result;
  if ( (_WORD)result )
  {
    v37 = v38;
