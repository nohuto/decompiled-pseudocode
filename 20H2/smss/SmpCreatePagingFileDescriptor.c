/*
 * XREFs of SmpCreatePagingFileDescriptor @ 0x140007260
 * Callers:
...
__int64 __fastcall SmpCreatePagingFileDescriptor(__int128 *a1)
{
  ...
  if ( v2 < 0 )
  {
    ...
    *((_DWORD *)&SmpPagefileLog + 2 * v11) = 1002;
  ...
  if ( v3 < 0 )
  {
    ...
    *((_DWORD *)&SmpPagefileLog + 2 * v12) = 1040;
...
LABEL_9:
      ...
      {
        v9 = (__int64 *)qword_1400245D8;
        if ( *(PVOID **)qword_1400245D8 == &SmpPagingFileDescriptorList )
        {
          *(_QWORD *)v6 = &SmpPagingFileDescriptorList;
          *(_QWORD *)(v6 + 8) = v9;
          *v9 = v6;
