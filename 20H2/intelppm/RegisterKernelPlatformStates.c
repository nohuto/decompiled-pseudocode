/*
 * XREFs of RegisterKernelPlatformStates @ 0x1C00380AC
 * Callers:
 ...
 *     ValidatePlatformIdleState @ 0x1C0030664 (ValidatePlatformIdleState.c)
...
__int64 __fastcall RegisterKernelPlatformStates(__int64 a1)
{
  ...
  v1 = dword_1C001C3E4;
  if ( byte_1C001CC00 && dword_1C001CBFC > (unsigned int)dword_1C001C3E4 )
    v1 = dword_1C001CBFC;
  v2 = (unsigned int)dword_1C001C98C;
  if ( !dword_1C001C98C )
    return 0;
  v4 = (48 * dword_1C001C98C + 59) & 0xFFFFFFFC;
  PoolWithTag = (char *)ExAllocatePoolWithTag(PagedPool, v4 + 8 * dword_1C001C98C * v1, 0x72637250u);
  v6 = PoolWithTag;
  if ( !PoolWithTag )
  {
  ...
  if ( (_DWORD)v2 )
  {
    ...
    while ( 1 )
    {
      ...
      *v8 = v9;
      v8[8] = v1;
      ProcessorNumberFromIndex = ((__int64 (__fastcall *)(_QWORD, _DWORD *, _QWORD))qword_1C001C6A0)(
                                   *(_QWORD *)(a1 + 1104),
                                   v8,
                                   0LL);
...
LABEL_23:
  *(_DWORD *)v6 = 62;
  *((_DWORD *)v6 + 1) = dword_1C001C98C;
  *((_DWORD *)v6 + 2) = dword_1C001C98C;
  ...
  *((_QWORD *)v6 + 4) = PepIdleComplete;
  ProcessorNumberFromIndex = ((__int64 (__fastcall *)(char *))qword_1C001C630)(v6);
  if ( ProcessorNumberFromIndex >= 0 )
  {
    Src = v6;
    v6 = 0LL;
