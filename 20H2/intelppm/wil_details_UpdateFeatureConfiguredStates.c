/*
 * XREFs of wil_details_UpdateFeatureConfiguredStates @ 0x1C00212A0
 * Callers:
 *     wil_details_OnFeatureConfigurationChange @ 0x1C0021220 (wil_details_OnFeatureConfigurationChange.c)
 * Callees:
 *     __security_check_cookie @ 0x1C00044F0 (__security_check_cookie.c)
 *     wil_details_FeatureDescriptors_SkipPadding @ 0x1C000465C (wil_details_FeatureDescriptors_SkipPadding.c)
 *     wil_details_BuildFeatureStateCacheFromQueryResults @ 0x1C0021008 (wil_details_BuildFeatureStateCacheFromQueryResults.c)
 */
