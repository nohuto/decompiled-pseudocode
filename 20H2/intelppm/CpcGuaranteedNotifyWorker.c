/*
 * XREFs of CpcGuaranteedNotifyWorker @ 0x1C002EA88
 * Callers:
 *     CpcNativeInterruptWorker @ 0x1C002F060 (CpcNativeInterruptWorker.c)
 *     AcpiCppcGuaranteedNotifyWorker @ 0x1C0032C20 (AcpiCppcGuaranteedNotifyWorker.c)
 * Callees:
 ...
 *     ProcLibTracePccCapChange @ 0x1C00082F4 (ProcLibTracePccCapChange.c)
              ...
              v10 >= 0) )
        {
          ...
          *(_DWORD *)(v7 + 84) = v15;
          if ( v15 != *(_DWORD *)(v5 + 724) )
          {
            ...
            ((void (__fastcall *)(__int64))qword_1C001C7C0)(v5);
          }
