...
void __fastcall PccInitiateExecuteCallback(int a1, void (*a2)(void))
{
  ...
  if ( a1 >= 0 )
  {
    (*(void (__fastcall **)(PWDF_DRIVER_GLOBALS, __int64))(WdfFunctions_01015 + 2528))(
      ...
      qword_1C001C958);
    v3 = qword_1C001C440;
    for ( i = 0; (__int64 *)v3 != &qword_1C001C440; v3 = *(_QWORD *)v3 )
    {
    ...
    if ( i )
    {
      LOBYTE(word_1C001C96C) = 1;
      if ( !HIBYTE(word_1C001C96C) )
      {
        HIBYTE(word_1C001C96C) = 1;
        v11 = 1;
      }
    }
    (*(void (__fastcall **)(PWDF_DRIVER_GLOBALS, __int64))(WdfFunctions_01015 + 2536))(
      ...
      qword_1C001C958);
    if ( v11 )
      IoQueueWorkItem(qword_1C001C960, (PIO_WORKITEM_ROUTINE)PccCapWorker, CriticalWorkQueue, 0LL);
  }
  if ( a2 )
    a2();
}
