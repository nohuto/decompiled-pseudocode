...
LABEL_29:
    *((_BYTE *)v3 + 48) = 1;
    (*(void (__fastcall **)(PWDF_DRIVER_GLOBALS, __int64, _QWORD))(WdfFunctions_01015 + 2504))(
      ...
      qword_1C001C3E8,
      0LL);
    ProcessorNumberFromIndex = ((__int64 (__fastcall *)(unsigned int *))qword_1C001C630)(v3);
  ...
  if ( v4 )
  {
    ...
    if ( v6 )
    {
      ...
      do
      {
        ...
        *v4 = v21;
        v4[8] = v5;
        if ( (int)((__int64 (__fastcall *)(_QWORD, _DWORD *, __int64))qword_1C001C6A0)(*(_QWORD *)(a1 + 1104), v4, v23) >= 0 )
        {
