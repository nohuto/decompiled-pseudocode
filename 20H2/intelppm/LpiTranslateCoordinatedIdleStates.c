/*
 * XREFs of LpiTranslateCoordinatedIdleStates @ 0x1C003B588
 * Callers:
 ...
 *     ValidateCoordinatedLpiDependencies @ 0x1C002FBB8 (ValidateCoordinatedLpiDependencies.c)
 *     ValidateCoordinatedLpiStates @ 0x1C002FD30 (ValidateCoordinatedLpiStates.c)
...
__int64 __fastcall LpiTranslateCoordinatedIdleStates(__int64 a1, _DWORD *a2, unsigned int **a3, _QWORD *a4, _QWORD *a5)
{
  ...
  v6 = 0LL;
  v8 = ValidateCoordinatedLpiStates((_DWORD *)qword_1C001C9B8, v7);
  if ( v8 >= 0 )
  {
                ...
                for ( j = 0; (unsigned int)v27 < *(_DWORD *)(v26 + 16); j = v27 )
                {
                  ...
                  *(_QWORD *)(v30 + 184) = *(_QWORD *)(v26 + 8);
                  ...
                  if ( v8 < 0 )
                    goto LABEL_33;
                  v33 = Size;
                  if ( (unsigned int)KeIsEqualAffinityEx(Size, &unk_1C001C708) )
                  {
                    *(_BYTE *)(v33 + 208) = 1;
                    v34 = 1;
                  }
