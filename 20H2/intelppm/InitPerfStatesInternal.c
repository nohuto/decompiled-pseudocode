/*
 * XREFs of InitPerfStatesInternal @ 0x1C0025BB0
 * Callers:
 *     RegisterKernelPerfStates @ 0x1C0026670 (RegisterKernelPerfStates.c)
 *     RegisterHvPerfStatesCounters @ 0x1C0032340 (RegisterHvPerfStatesCounters.c)
 * Callees:
  ...
  if ( v14 )
  {
    ...
    if ( v16 )
    {
      ...
      *((_QWORD *)v6 + 42) = PerfControlPTStates;
      v53 = v18;
      if ( dword_1C001CBF8 == 1 || v18 == 252 || (v19 = v18 == 1, v20 = PerfControlPTStatesHidden, v19) )
