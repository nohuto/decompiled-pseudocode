/*
 * XREFs of WPP_RECORDER_SF_q @ 0x1C000DB5C
 * Callers:
...
__int64 WPP_RECORDER_SF_q(__int64 a1, _DWORD a2, _DWORD a3, unsigned __int16 a4, __int64 a5, ...)
{
  ...
  if ( (HIDWORD(WPP_GLOBAL_Control->Timer) & 2) != 0 && BYTE1(WPP_GLOBAL_Control->Timer) >= 5u )
    pfnWppTraceMessage(
      ...
      43LL,
      &WPP_3ecf09519eed3e44f5ad5541281ba006_Traceguids,
      a4,
      va,
      8LL,
      0LL);
  LOWORD(v8) = a4;
  return WppAutoLogTrace(a1, 5LL, 2LL, &WPP_3ecf09519eed3e44f5ad5541281ba006_Traceguids, v8, va);
}
