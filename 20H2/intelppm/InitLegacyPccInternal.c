 ...
 *     RegisterHvLegacyPccCounters @ 0x1C00319D0 (RegisterHvLegacyPccCounters.c)
 * Callees:
  ...
  if ( qword_1C001C960 )
  {
          ...
          (v3 = v12) != 0LL) )
    {
      ...
      *((_DWORD *)v3 + 8) = v16;
      ...
      if ( dword_1C001C8DC )
      {
        v17 = 0x989680 % ((unsigned int)dword_1C001C8DC >> 1);
        *((_DWORD *)v3 + 10) = 0x989680 / ((unsigned int)dword_1C001C8DC >> 1);
      }
      *((_QWORD *)v13 + 1) = 100LL;
      ...
      if ( v5 >= 0 )
      {
        ...
        while ( !(unsigned int)EnumerateNextDevice((__int64 *)v29, &v32) )
        {
          *(_QWORD *)(v32 + 232) = v26 - 1;
          v27 = (_QWORD *)qword_1C001C448;
          if ( *(__int64 **)qword_1C001C448 != &qword_1C001C440 )
            __fastfail(3u);
          *v26 = &qword_1C001C440;
          v26[1] = v27;
          *v27 = v26;
          qword_1C001C448 = (__int64)v26;
        }
