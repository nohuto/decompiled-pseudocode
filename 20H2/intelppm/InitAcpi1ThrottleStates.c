/*
 * XREFs of InitAcpi1ThrottleStates @ 0x1C002286C
 * Callers:
...
__int64 __fastcall InitAcpi1ThrottleStates(__int64 a1, __int64 a2, __int64 a3, __int64 a4)
{
  ...
  v4 = 0;
  if ( ((unsigned int)dword_1C001C3E4 <= 1 || (*(_DWORD *)(a1 + 272) & 0x200000) != 0)
    && (*(_DWORD *)(a1 + 272) & 0x100000) != 0
    && (v6 = a1 + 184, (unsigned __int8)IsValidAcpiGenericAddress(a1 + 184, a2, a3, a4))
    && (unsigned __int8)(byte_1C001CEB6 - 1) <= 3u
    && (unsigned __int8)byte_1C001CEB6 + (unsigned int)(unsigned __int8)byte_1C001CEB7 <= 0x20 )
  {
    _InterlockedOr((volatile signed __int32 *)(a1 + 1088), 4u);
    _InterlockedOr((volatile signed __int32 *)(a1 + 1092), 4u);
    v8 = 1 << byte_1C001CEB6;
    PoolWithTag = ExAllocatePoolWithTag(NonPagedPoolNx, (unsigned int)(20 * (1 << byte_1C001CEB6) + 4), 0x72637250u);
      ...
      **(_DWORD **)(a1 + 488) = v8;
      if ( v8 > 1 )
      {
        ...
        do
        {
          ...
          *(_DWORD *)(v12 + v11 - 4) = (v13 << byte_1C001CEB7) | 0x10;
        }
        while ( v10 < v8 );
      }
