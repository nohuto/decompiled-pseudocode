/*
 * XREFs of Crashdump_Cleanup @ 0x1C0049E70
 * Callers:
 *     <none>
 * Callees:
 *     Crashdump_Register_SaveStateForHybridSleep @ 0x1C004BED8 (Crashdump_Register_SaveStateForHybridSleep.c)
 *     Crashdump_Register_StopController @ 0x1C004C0B4 (Crashdump_Register_StopController.c)
 *     Crashdump_Command_Stop @ 0x1C004CDB0 (Crashdump_Command_Stop.c)
 ...
 *     Crashdump_UsbDevice_SuspendPort @ 0x1C004F188 (Crashdump_UsbDevice_SuspendPort.c)
 */
