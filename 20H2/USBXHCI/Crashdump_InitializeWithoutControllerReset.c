/*
 * XREFs of Crashdump_InitializeWithoutControllerReset @ 0x1C004AB14
 * Callers:
 *     Crashdump_Initialize @ 0x1C004A3A0 (Crashdump_Initialize.c)
 * Callees:
 *     Crashdump_Register_PrepareForHibernate @ 0x1C004BAC0 (Crashdump_Register_PrepareForHibernate.c)
 *     Crashdump_EventRing_PrepareForHibernate @ 0x1C004C998 (Crashdump_EventRing_PrepareForHibernate.c)
 *     Crashdump_Command_PrepareForDump @ 0x1C004CAF8 (Crashdump_Command_PrepareForDump.c)
 *     Crashdump_Command_TestCommandRingOperation @ 0x1C004CF88 (Crashdump_Command_TestCommandRingOperation.c)
