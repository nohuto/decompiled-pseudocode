/*
 * XREFs of Controller_WdfEvtDeviceArmWakeFromSx @ 0x1C0035880
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall Controller_WdfEvtDeviceArmWakeFromSx(__int64 a1)
{
  ...
  {
    LOBYTE(v2) = 4;
    WPP_RECORDER_SF_i(*(_QWORD *)(v3 + 72), v2, 4, 90, (__int64)&WPP_1fced1a270be39d344e698c349d4a9f8_Traceguids, v1);
  }
  *(_BYTE *)(v3 + 468) = 1;
  return 0LL;
}
