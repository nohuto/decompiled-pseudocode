 ...
 * 00000001C0004E82: jnz     loc_1C001D718
 ...
 * 00000001C001D718: cmp     byte ptr [rcx+29h], 4
 * 00000001C001D71C: jb      loc_1C0004E88
 * 00000001C001D722: mov     rax, qword ptr cs:WPP_MAIN_CB+148h
 * 00000001C001D729: lea     rdx, [rsp+0A8h+arg_58]
 * 00000001C001D731: mov     rcx, [rcx+18h]
 * 00000001C001D735: lea     r8, WPP_d233b597c96c378d294c2d5b80e0f0a8_Traceguids
 * 00000001C001D73C: mov     [rsp+0A8h+var_18], 0
 * 00000001C001D748: mov     r9d, ebx
 * 00000001C001D74B: mov     [rsp+0A8h+var_20], 8
 * 00000001C001D757: mov     [rsp+0A8h+var_28], rdx
 * 00000001C001D75F: lea     rdx, [rsp+0A8h+arg_50]
 * 00000001C001D767: mov     [rsp+0A8h+var_30], 4
 * 00000001C001D770: mov     [rsp+0A8h+var_38], rdx
 * 00000001C001D775: lea     rdx, [rsp+0A8h+arg_48]
 * 00000001C001D77D: mov     [rsp+0A8h+var_40], 4
 * 00000001C001D786: mov     [rsp+0A8h+var_48], rdx
 * 00000001C001D78B: lea     rdx, [rsp+0A8h+arg_40]
 * 00000001C001D793: mov     [rsp+0A8h+var_50], 4
 * 00000001C001D79C: mov     [rsp+0A8h+var_58], rdx
 * 00000001C001D7A1: lea     rdx, [rsp+0A8h+arg_38]
 * 00000001C001D7A9: mov     [rsp+0A8h+var_60], 8
 * 00000001C001D7B2: mov     [rsp+0A8h+var_68], rdx
 * 00000001C001D7B7: lea     rdx, [rsp+0A8h+arg_30]
 * 00000001C001D7BF: mov     [rsp+0A8h+var_70], 4
 * 00000001C001D7C8: mov     [rsp+0A8h+var_78], rdx
 * 00000001C001D7CD: lea     rdx, [rsp+0A8h+arg_28]
 * 00000001C001D7D5: mov     [rsp+0A8h+var_80], 4
 * 00000001C001D7DE: mov     [rsp+0A8h+var_88], rdx
 * 00000001C001D7E3: mov     edx, 2Bh ; '+'
 * 00000001C001D7E8: call    cs:__guard_dispatch_icall_fptr
 * 00000001C001D7EE: nop
 * 00000001C001D7EF: jmp     loc_1C0004E88
 */
