/*
 * XREFs of Controller_WdfEvtDeviceSelfManagedIoCleanup @ 0x1C0077120
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall Controller_WdfEvtDeviceSelfManagedIoCleanup(__int64 a1)
{
  ...
  {
    LOBYTE(v2) = 5;
    WPP_RECORDER_SF_i(v3[9], v2, 4, 60, (__int64)&WPP_1fced1a270be39d344e698c349d4a9f8_Traceguids, v1);
  }
  v4 = (void *)v3[68];
  if ( v4 )
  {
