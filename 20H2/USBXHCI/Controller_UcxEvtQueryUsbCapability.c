...
LABEL_26:
    LOBYTE(v10) = 4;
    WPP_RECORDER_SF_(*(_QWORD *)(v9 + 72), v10, 4, v17, (__int64)&WPP_1fced1a270be39d344e698c349d4a9f8_Traceguids);
    goto LABEL_13;
  }
  if ( RtlCompareMemory(a2, &GUID_USB_CAPABILITY_STATIC_STREAMS, 0x10uLL) == 16 )
  {
    ...
    {
      LOBYTE(v10) = 4;
      WPP_RECORDER_SF_(*(_QWORD *)(v9 + 72), v10, 4, 189, (__int64)&WPP_1fced1a270be39d344e698c349d4a9f8_Traceguids);
    }
    *a5 = 2;
    if ( a3 >= 2 )
    {
...
LABEL_57:
    ...
    LOBYTE(v10) = 4;
LABEL_56:
    WPP_RECORDER_SF_d(*(_QWORD *)(v9 + 72), v10, 4, v19, (__int64)&WPP_1fced1a270be39d344e698c349d4a9f8_Traceguids, a3);
    goto LABEL_57;
  }
...
LABEL_22:
      LOBYTE(v10) = 4;
      WPP_RECORDER_SF_(*(_QWORD *)(v9 + 72), v10, 4, v16, (__int64)&WPP_1fced1a270be39d344e698c349d4a9f8_Traceguids);
LABEL_23:
      v8 = -1073741637;
LABEL_13:
      LOBYTE(v14) = 0;
...
LABEL_51:
      LOBYTE(v10) = 2;
      WPP_RECORDER_SF_(*(_QWORD *)(v9 + 72), v10, 4, v18, (__int64)&WPP_1fced1a270be39d344e698c349d4a9f8_Traceguids);
LABEL_52:
      v8 = -1073741811;
      goto LABEL_13;
    }
    ...
    if ( (v11 & 0x10) != 0 )
    {
      ...
      {
        LOBYTE(v10) = 4;
        WPP_RECORDER_SF_(*(_QWORD *)(v9 + 72), v10, 4, 196, (__int64)&WPP_1fced1a270be39d344e698c349d4a9f8_Traceguids);
      }
  ...
  {
    LOBYTE(v10) = 4;
    WPP_RECORDER_SF_(*(_QWORD *)(v9 + 72), v10, 4, 200, (__int64)&WPP_1fced1a270be39d344e698c349d4a9f8_Traceguids);
  }
  *a5 = 4;
  if ( a3 < 4 )
  {
