/*
 * XREFs of Controller_InitiateRecovery @ 0x1C0032C80
 * Callers:
...
__int64 __fastcall Controller_InitiateRecovery(_QWORD *a1, __int64 a2, int a3, int a4)
{
  ...
  {
    LOBYTE(a2) = 4;
    result = WPP_RECORDER_SF_(a1[9], a2, 4, 231, (__int64)&WPP_1fced1a270be39d344e698c349d4a9f8_Traceguids);
  }
  if ( (v5 & 2) != 0 )
  {
  ...
  for ( ; v5; v5 &= result )
  {
    if ( (v5 & 0x18) != 0 )
    {
      ...
      if ( (v10 & 2) == 0 )
      {
        ...
        KeFlushQueuedDpcs();
        ((void (__fastcall *)(__int64, _QWORD))qword_1C00627A0)(UcxDriverGlobals, a1[1]);
        if ( (v5 & 8) != 0 )
      ...
      if ( (v10 & 4) == 0 && (v5 & 0x10) != 0 )
      {
        ...
        {
          LOBYTE(a2) = 4;
          WPP_RECORDER_SF_(a1[9], a2, 4, 233, (__int64)&WPP_1fced1a270be39d344e698c349d4a9f8_Traceguids);
        }
        v15 = *a1;
        *(_DWORD *)v16 = 28;
    ...
    else if ( (v5 & 4) != 0 )
    {
      ...
      {
        LOBYTE(v9) = 2;
        WPP_RECORDER_SF_d(a1[9], v9, 4, 234, (__int64)&WPP_1fced1a270be39d344e698c349d4a9f8_Traceguids, v8);
      }
    ...
    {
      ((void (__fastcall *)(__int64, _QWORD))qword_1C0062790)(UcxDriverGlobals, a1[1]);
      result = 4294967293LL;
    }
    else
    {
      if ( (v5 & 0x20) == 0 )
      {
        ...
        {
          LOBYTE(a2) = 2;
          return WPP_RECORDER_SF_d(a1[9], a2, 4, 235, (__int64)&WPP_1fced1a270be39d344e698c349d4a9f8_Traceguids, v5);
        }
        return result;
      }
      (*(void (__fastcall **)(PWDF_DRIVER_GLOBALS, _QWORD, __int64))(WdfFunctions_01023 + 696))(
