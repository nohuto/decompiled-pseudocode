 ...
 * 00000001C000FF77: jnz     loc_1C0022C7A
 ...
 * 00000001C0022C7A: cmp     [rcx+29h], dil
 * 00000001C0022C7E: jb      loc_1C000FF7D
 * 00000001C0022C84: and     [rsp+88h+var_18], 0
 * 00000001C0022C8A: lea     rdx, [rsp+88h+arg_48]
 * 00000001C0022C92: mov     rax, qword ptr cs:WPP_MAIN_CB+148h
 * 00000001C0022C99: lea     r8, WPP_e17193f9e7953bf0d59f9dd2738aa1c9_Traceguids
 * 00000001C0022CA0: mov     rcx, [rcx+18h]
 * 00000001C0022CA4: mov     [rsp+88h+var_20], 8
 * 00000001C0022CAD: mov     [rsp+88h+var_28], rdx
 * 00000001C0022CB2: lea     rdx, [rsp+88h+arg_40]
 * 00000001C0022CBA: mov     [rsp+88h+var_30], rdi
 * 00000001C0022CBF: mov     [rsp+88h+var_38], rdx
 * 00000001C0022CC4: lea     rdx, [rsp+88h+arg_38]
 * 00000001C0022CCC: mov     [rsp+88h+var_40], rdi
 * 00000001C0022CD1: mov     [rsp+88h+var_48], rdx
 * 00000001C0022CD6: lea     rdx, [rsp+88h+arg_30]
 * 00000001C0022CDE: mov     [rsp+88h+var_50], rdi
 * 00000001C0022CE3: mov     [rsp+88h+var_58], rdx
 * 00000001C0022CE8: lea     rdx, [rsp+88h+arg_28]
 * 00000001C0022CF0: mov     [rsp+88h+var_60], rdi
 * 00000001C0022CF5: mov     [rsp+88h+var_68], rdx
 * 00000001C0022CFA: mov     edx, 2Bh ; '+'
 * 00000001C0022CFF: movzx   r9d, bp
 * 00000001C0022D03: call    cs:__guard_dispatch_icall_fptr
 * 00000001C0022D09: nop
 * 00000001C0022D0A: jmp     loc_1C000FF7D
 */
