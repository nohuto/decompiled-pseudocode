...
__int64 __fastcall Controller_D0Exit(_QWORD *a1, char a2, __int64 a3)
{
  ...
  {
    LOBYTE(v5) = 5;
    WPP_RECORDER_SF_qL(a1[9], v5, 4, 122, (__int64)&WPP_1fced1a270be39d344e698c349d4a9f8_Traceguids, (char)a1, a2);
  }
  result = Register_ControllerStop(a1[11]);
  if ( (int)result < 0 && WPP_RECORDER_INITIALIZED != (_UNKNOWN *)&WPP_RECORDER_INITIALIZED )
  {
    LOBYTE(v7) = 2;
    return WPP_RECORDER_SF_d(a1[9], v7, 4, 123, (__int64)&WPP_1fced1a270be39d344e698c349d4a9f8_Traceguids, result);
  }
  return result;
}
