/*
 * XREFs of WPP_RECORDER_SF_Dddd @ 0x1C003D2AC
 * Callers:
...
__int64 WPP_RECORDER_SF_Dddd(__int64 a1, __int64 a2, __int64 a3, __int64 a4, int a5, ...)
{
  ...
  if ( (HIDWORD(WPP_GLOBAL_Control->Timer) & 0x10) != 0 && BYTE1(WPP_GLOBAL_Control->Timer) >= 2u )
    (*((void (__fastcall **)(_DEVICE_OBJECT *, __int64, void *, __int64, __int64 *, __int64, __int64 *, __int64, char *, __int64, _DWORD *, __int64, _QWORD))&WPP_MAIN_CB.Reserved
     + 1))(
