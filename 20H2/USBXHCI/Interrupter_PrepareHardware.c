/*
 * XREFs of Interrupter_PrepareHardware @ 0x1C006EE90
 * Callers:
 ...
 *     WPP_RECORDER_SF_Dd @ 0x1C003CD0C (WPP_RECORDER_SF_Dd.c)
 *     Interrupter_PopulateInterrupterLookupTable @ 0x1C006EFC0 (Interrupter_PopulateInterrupterLookupTable.c)
 *     Interrupter_CmResList_GetInterrupterCountAndType @ 0x1C006FCB4 (Interrupter_CmResList_GetInterrupterCountAndType.c)
