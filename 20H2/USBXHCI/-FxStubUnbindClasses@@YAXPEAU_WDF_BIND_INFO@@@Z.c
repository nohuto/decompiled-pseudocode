/*
 * XREFs of ?FxStubUnbindClasses@@YAXPEAU_WDF_BIND_INFO@@@Z @ 0x1C0050834
 * Callers:
...
void __fastcall FxStubUnbindClasses(struct _WDF_BIND_INFO *a1)
{
  ...
  v1 = &Ucx_BIND_INFO;
  if ( off_1C0062708 != &__KMDF_CLASS_BIND_START && &Ucx_BIND_INFO <= off_1C0062708 )
  {
    do
    {
