/*
 * XREFs of RootHub_PrepareHardware @ 0x1C0070600
 * Callers:
 ...
 *     WPP_RECORDER_SF_cccc @ 0x1C003F1FC (WPP_RECORDER_SF_cccc.c)
 */
...
__int64 __fastcall RootHub_PrepareHardware(unsigned __int64 *a1)
{
  ...
  *((_WORD *)a1 + 13) = *(_WORD *)(v4 + 98);
  ...
  PoolWithTag = ExAllocatePoolWithTag(
                  ...
                  112LL * *((unsigned int *)a1 + 4),
                  0x49434858u);
  a1[6] = (unsigned __int64)PoolWithTag;
  if ( PoolWithTag )
  {
    memset(PoolWithTag, 0, 112LL * *((unsigned int *)a1 + 4));
...
LABEL_70:
  ...
  {
    if ( WPP_RECORDER_INITIALIZED != (_UNKNOWN *)&WPP_RECORDER_INITIALIZED )
      WPP_RECORDER_SF_(*(_QWORD *)(a1[1] + 72), 2, 11, 20, (__int64)&WPP_f43a94b2b62e338aeb45278c2677cd1d_Traceguids);
    v24 = -1073741670;
  }
LABEL_71:
  v48 = (char *)a1[6];
