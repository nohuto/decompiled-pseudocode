/*
 * XREFs of Crashdump_Initialize @ 0x1C004A3A0
 * Callers:
 *     <none>
 * Callees:
 *     __security_check_cookie @ 0x1C0019F30 (__security_check_cookie.c)
 *     memset @ 0x1C001BFC0 (memset.c)
 *     Crashdump_InitializeWithControllerReset @ 0x1C004A8F0 (Crashdump_InitializeWithControllerReset.c)
 *     Crashdump_InitializeWithoutControllerReset @ 0x1C004AB14 (Crashdump_InitializeWithoutControllerReset.c)
 *     Crashdump_Register_BiosHandoff @ 0x1C004B7B4 (Crashdump_Register_BiosHandoff.c)
 *     Crashdump_Register_LogRHPortInfo @ 0x1C004B974 (Crashdump_Register_LogRHPortInfo.c)
 */
