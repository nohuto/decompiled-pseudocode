/*
 * XREFs of Controller_InternalReset @ 0x1C0032FD8
 * Callers:
...
__int64 __fastcall Controller_InternalReset(__int64 a1, __int64 a2, __int64 a3)
{
  ...
  if ( WPP_RECORDER_INITIALIZED != (_UNKNOWN *)&WPP_RECORDER_INITIALIZED )
    WPP_RECORDER_SF_(*(_QWORD *)(a1 + 72), 4, 4, 176, (__int64)&WPP_1fced1a270be39d344e698c349d4a9f8_Traceguids);
...
LABEL_34:
  ...
  if ( v13 < 0 )
  {
    ...
    result = ((__int64 (__fastcall *)(__int64, _QWORD))qword_1C00627A0)(UcxDriverGlobals, *(_QWORD *)(a1 + 8));
    if ( WPP_RECORDER_INITIALIZED != (_UNKNOWN *)&WPP_RECORDER_INITIALIZED )
    {
      LOBYTE(v33) = 2;
