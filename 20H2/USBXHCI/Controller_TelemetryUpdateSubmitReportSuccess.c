/*
 * XREFs of Controller_TelemetryUpdateSubmitReportSuccess @ 0x1C0076930
 * Callers:
...
__int64 __fastcall Controller_TelemetryUpdateSubmitReportSuccess(_QWORD *a1, int a2)
{
  ...
  if ( (a2 & 0xFFFFEFC0) != 0 && WPP_RECORDER_INITIALIZED != (_UNKNOWN *)&WPP_RECORDER_INITIALIZED )
  {
    v8 = a2;
    LOBYTE(a2) = 2;
    WPP_RECORDER_SF_d(a1[9], a2, 4, 236, (__int64)&WPP_1fced1a270be39d344e698c349d4a9f8_Traceguids, v8);
  }
  ...
  LOBYTE(v6) = 3;
  result = WPP_RECORDER_SF_d(a1[9], v6, 4, v7, (__int64)&WPP_1fced1a270be39d344e698c349d4a9f8_Traceguids, result);
LABEL_19:
  if ( v10 )
