/*
 * XREFs of Controller_WdfEvtDeviceReleaseHardware @ 0x1C0076F10
 * Callers:
 *     <none>
 * Callees:
 ...
 *     XilDeviceSlot_ReleaseHardware @ 0x1C0037634 (XilDeviceSlot_ReleaseHardware.c)
 ...
 *     Interrupter_ReleaseHardware @ 0x1C0077A30 (Interrupter_ReleaseHardware.c)
 *     RootHub_ReleaseHardware @ 0x1C0077DB8 (RootHub_ReleaseHardware.c)
 */
...
__int64 __fastcall Controller_WdfEvtDeviceReleaseHardware(__int64 a1)
{
  ...
  {
    LOBYTE(v2) = 4;
    WPP_RECORDER_SF_i(*(_QWORD *)(v3 + 72), v2, 4, 51, (__int64)&WPP_1fced1a270be39d344e698c349d4a9f8_Traceguids, v1);
  }
