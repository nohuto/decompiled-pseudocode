/*
 * XREFs of Controller_EvtIoInternalDeviceControl @ 0x1C00323E0
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall Controller_EvtIoInternalDeviceControl(__int64 a1, IRP *a2)
{
  ...
  if ( LowPart == 2232247 )
  {
    ...
    {
      LOBYTE(v5) = 4;
      WPP_RECORDER_SF_(*(_QWORD *)(v6 + 72), v5, 4, 206, (__int64)&WPP_1fced1a270be39d344e698c349d4a9f8_Traceguids);
    }
    v7 = 0;
