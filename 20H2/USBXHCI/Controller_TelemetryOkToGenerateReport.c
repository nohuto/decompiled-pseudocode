/*
 * XREFs of Controller_TelemetryOkToGenerateReport @ 0x1C0076648
 * Callers:
...
LABEL_21:
        LOBYTE(v10) = 3;
        WPP_RECORDER_SF_d(a1[9], v10, 4, v12, (__int64)&WPP_1fced1a270be39d344e698c349d4a9f8_Traceguids, v11);
        goto LABEL_4;
      }
    }
    v3 = 1;
  ...
  if ( WPP_RECORDER_INITIALIZED == (_UNKNOWN *)&WPP_RECORDER_INITIALIZED )
    return v3;
  LOBYTE(a2) = 4;
  WPP_RECORDER_SF_d(a1[9], a2, 4, 217, (__int64)&WPP_1fced1a270be39d344e698c349d4a9f8_Traceguids, a3);
LABEL_4:
  if ( v18 )
