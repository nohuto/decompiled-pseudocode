...
__int64 __fastcall Controller_PopulateDeviceFlagsFromKse(__int64 a1, __int64 a2, int a3)
{
  ...
  do
  {
    ...
    if ( ((int (__fastcall *)(wchar_t *, __int64, __int64 *))WPP_MAIN_CB.Queue.Wcb.BufferChainingDpc)(pszDest, v9, &v22) >= 0 )
    {
    ...
    if ( ((int (__fastcall *)(wchar_t *, __int64, __int64 *))WPP_MAIN_CB.Queue.Wcb.BufferChainingDpc)(pszDest, v9, &v23) >= 0 )
    {
      if ( WPP_RECORDER_INITIALIZED != (_UNKNOWN *)&WPP_RECORDER_INITIALIZED )
    ...
    if ( ((int (__fastcall *)(wchar_t *, __int64, __int64 *))WPP_MAIN_CB.Queue.Wcb.BufferChainingDpc)(pszDest, v9, &v24) >= 0 )
    {
      if ( WPP_RECORDER_INITIALIZED != (_UNKNOWN *)&WPP_RECORDER_INITIALIZED )
    ...
    if ( ((int (__fastcall *)(wchar_t *, __int64, __int64 *))WPP_MAIN_CB.Queue.Wcb.BufferChainingDpc)(pszDest, v9, &v25) >= 0 )
    {
      if ( WPP_RECORDER_INITIALIZED != (_UNKNOWN *)&WPP_RECORDER_INITIALIZED )
    ...
    if ( v17 != -1 )
    {
      ...
      if ( ((int (__fastcall *)(wchar_t *, __int64, __int64 *))WPP_MAIN_CB.Queue.Wcb.BufferChainingDpc)(
             pszDest,
             v9,
             &v26) >= 0 )
      {
...
LABEL_55:
  ...
  if ( (result & 0x1000000) != 0 )
  {
    ...
    {
      LOBYTE(v17) = 2;
      WPP_RECORDER_SF_(*(_QWORD *)(a1 + 72), v17, 4, 161, (__int64)&WPP_1fced1a270be39d344e698c349d4a9f8_Traceguids);
    }
