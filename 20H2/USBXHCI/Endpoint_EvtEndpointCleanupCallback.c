/*
 * XREFs of Endpoint_EvtEndpointCleanupCallback @ 0x1C0039190
 * Callers:
 *     <none>
 * Callees:
 *     _guard_dispatch_icall_nop @ 0x1C001BCF0 (_guard_dispatch_icall_nop.c)
 *     XilEndpoint_DestroySecureObject @ 0x1C0038140 (XilEndpoint_DestroySecureObject.c)
 *     XilEndpoint_FreeResources @ 0x1C003821C (XilEndpoint_FreeResources.c)
 *     WPP_RECORDER_SF_ddqqq @ 0x1C003C380 (WPP_RECORDER_SF_ddqqq.c)
 *     UsbDevice_RemoveEndpointFromDeviceEndpointList @ 0x1C0047B08 (UsbDevice_RemoveEndpointFromDeviceEndpointList.c)
 *     Etw_EndpointDelete @ 0x1C0048E60 (Etw_EndpointDelete.c)
 */
