/*
 * XREFs of McTemplateK0pquuqqqqqqsssxqqqttqqqtxxqqqqqqqqqqnnqqttt_EtwWriteTransfer @ 0x1C001B6E8
 * Callers:
...
__int64 __fastcall McTemplateK0pquuqqqqqqsssxqqqttqqqtxxqqqqqqqqqqnnqqttt_EtwWriteTransfer(
        __int64 a1,
        __int64 a2,
        __int64 a3,
        __int64 a4,
        ...
        char a47)
{
  ...
  const char *v54; // rcx
  int v55; // eax
  _BYTE v57[16]; // [rsp+30h] [rbp-D0h] BYREF
  ...
  const char *v78; // [rsp+E0h] [rbp-20h]
  int v79; // [rsp+E8h] [rbp-18h]
  int v80; // [rsp+ECh] [rbp-14h]
  const char *v81; // [rsp+F0h] [rbp-10h]
  int v82; // [rsp+F8h] [rbp-8h]
  int v83; // [rsp+FCh] [rbp-4h]
  const char *v84; // [rsp+100h] [rbp+0h]
  ...
  __int64 v145; // [rsp+318h] [rbp+218h] BYREF
  ...
  v142 = 4LL;
  v144 = 4LL;
  return McGenEventWrite_EtwWriteTransfer(v54, &USBXHCI_ETW_EVENT_CONTROLLER_HEALTH_V3, 0LL, 43LL, v57);
}
