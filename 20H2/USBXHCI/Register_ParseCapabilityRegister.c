/*
 * XREFs of Register_ParseCapabilityRegister @ 0x1C0070C80
 * Callers:
...
LABEL_5:
  ...
  *(_BYTE *)(v11 + 321) = v9;
  ...
  else
  {
    ...
    {
      LOBYTE(v6) = 4;
      WPP_RECORDER_SF_(*(_QWORD *)(v12 + 72), v6, 6, 24, (__int64)&WPP_6d0f545b908f3ff5e03e6416fb6b60c9_Traceguids);
      v12 = *(_QWORD *)(a1 + 8);
    }
    v53 = (_QWORD *)(v12 + 336);
    v54 = 2LL;
...
LABEL_70:
    ...
    if ( WPP_RECORDER_INITIALIZED != (_UNKNOWN *)&WPP_RECORDER_INITIALIZED )
    {
      ...
      WPP_RECORDER_SF_dddd(
        *(_QWORD *)(*(_QWORD *)(a1 + 8) + 72LL),
        ...
        35,
        (__int64)&WPP_6d0f545b908f3ff5e03e6416fb6b60c9_Traceguids,
        (*(_DWORD *)(a1 + 100) & 0x10) != 0,
        (*(_DWORD *)(a1 + 100) & 0x20) != 0,
        (*(_DWORD *)(a1 + 100) & 0x40) != 0,
        (*(_DWORD *)(a1 + 100) & 0x80) != 0);
      v15 = *(_DWORD *)(a1 + 100);
      if ( WPP_RECORDER_INITIALIZED != (_UNKNOWN *)&WPP_RECORDER_INITIALIZED )
      {
  ...
  *(_DWORD *)(a1 + 112) = v39;
  ...
  if ( !*(_WORD *)(a1 + 102) || (v40 = 4LL * *(unsigned __int16 *)(a1 + 102), v40 >= *(unsigned int *)(a1 + 20)) )
  {
    if ( WPP_RECORDER_INITIALIZED != (_UNKNOWN *)&WPP_RECORDER_INITIALIZED )
    {
      v60 = *(_WORD *)(a1 + 102);
  ...
  *(_QWORD *)(a1 + 72) = FirstExtendedCapability;
  if ( !Controller_IsSecureDevice(v43) || *(_BYTE *)(a1 + 128) )
  {
