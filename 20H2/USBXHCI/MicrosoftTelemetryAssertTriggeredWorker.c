/*
 * XREFs of MicrosoftTelemetryAssertTriggeredWorker @ 0x1C0051218
 * Callers:
 *     MicrosoftTelemetryAssertTriggeredMsgKM @ 0x1C00511E8 (MicrosoftTelemetryAssertTriggeredMsgKM.c)
 * Callees:
 *     __security_check_cookie @ 0x1C0019F30 (__security_check_cookie.c)
 *     GetImageTuple @ 0x1C0051198 (GetImageTuple.c)
 *     _tlgCreate1Sz_char @ 0x1C00518AC (_tlgCreate1Sz_char.c)
 *     _tlgKeywordOn @ 0x1C00518EC (_tlgKeywordOn.c)
 *     _tlgWriteTransfer_EtwWriteTransfer @ 0x1C0051918 (_tlgWriteTransfer_EtwWriteTransfer.c)
 */
...
LABEL_37:
  ...
  if ( (unsigned int)dword_1C006A040 > 5 && (unsigned __int8)tlgKeywordOn(&dword_1C006A040, 0x400000000000LL) )
  {
    ...
    tlgWriteTransfer_EtwWriteTransfer((int)&v76, (int)&dword_1C00556C3, v32, v33, 0xBu, &v76);
  }
  if ( dword_1C006A078 && !v24 && !KeGetCurrentIrql() )
  {
    ...
    if ( (unsigned int)dword_1C006A040 > 5 && (unsigned __int8)tlgKeywordOn(&dword_1C006A040, 0x400000000000LL) )
    {
      ...
      v58 = v34;
      v75 = 4LL;
      tlgWriteTransfer_EtwWriteTransfer(v37, (int)&dword_1C0055730, v38, v39, v40, &v60);
    }
    if ( !v34 )
    {
