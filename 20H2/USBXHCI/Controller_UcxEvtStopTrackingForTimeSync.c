/*
 * XREFs of Controller_UcxEvtStopTrackingForTimeSync @ 0x1C0035390
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall Controller_UcxEvtStopTrackingForTimeSync(__int64 a1, __int64 a2, __int64 a3, unsigned __int64 a4)
{
  ...
  if ( v13 >= 0 )
  {
    if ( !*v18 )
    {
      ...
      {
        LOBYTE(v10) = 2;
        WPP_RECORDER_SF_(*(_QWORD *)(v12 + 72), v10, 4, 288, (__int64)&WPP_1fced1a270be39d344e698c349d4a9f8_Traceguids);
      }
LABEL_13:
      v13 = -1073741811;
      goto LABEL_5;
