/*
 * XREFs of XilEndpoint_SendRequestToSetSecureStreamContextArray @ 0x1C0038730
 * Callers:
        ...
        void *Src)
{
  ...
  if ( v7 > 0xFFFFFFFF || (v10 = v7 + 48, (int)v7 + 48 < (unsigned int)v7) )
    v10 = 0;
  PoolWithTag = ExAllocatePoolWithTag(SHIDWORD(WPP_MAIN_CB.DeviceLock.Header.WaitListHead.Flink), v10, 0x49434858u);
  v12 = PoolWithTag;
  if ( PoolWithTag )
  {
