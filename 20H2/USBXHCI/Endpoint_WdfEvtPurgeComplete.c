...
__int64 __fastcall Endpoint_WdfEvtPurgeComplete(__int64 a1, __int64 a2)
{
  ...
  if ( !*(_BYTE *)(v3 + 37) || (result = *(_QWORD *)(v3 + 136)) == 0 )
  {
    if ( WPP_RECORDER_INITIALIZED == (_UNKNOWN *)&WPP_RECORDER_INITIALIZED )
      return ((__int64 (__fastcall *)(__int64, __int64))qword_1C0062800)(UcxDriverGlobals, a2);
    v6 = 34;
LABEL_4:
    LOBYTE(v4) = 4;
    WPP_RECORDER_SF_ddq(
  ...
  {
    if ( WPP_RECORDER_INITIALIZED == (_UNKNOWN *)&WPP_RECORDER_INITIALIZED )
      return ((__int64 (__fastcall *)(_QWORD, _QWORD))qword_1C0062800)(UcxDriverGlobals, a2);
    v6 = 33;
    goto LABEL_4;
  }
  return result;
