/*
 * XREFs of DriverEntry @ 0x1C007232C
 * Callers:
 ...
 *     Counter_Register @ 0x1C0072714 (Counter_Register.c)
 *     WppInitKm @ 0x1C007285C (WppInitKm.c)
 *     WppLoadTracingSupport @ 0x1C0072910 (WppLoadTracingSupport.c)
