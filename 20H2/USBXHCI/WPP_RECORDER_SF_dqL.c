 ...
 * 00000001C0009541: jnz     loc_1C0025C8C
 ...
 * 00000001C0025C8C: cmp     [rcx+29h], bl
 * 00000001C0025C8F: jb      loc_1C0009547
 * 00000001C0025C95: and     [rsp+68h+var_18], 0
 * 00000001C0025C9B: lea     rdx, [rsp+68h+arg_38]
 * 00000001C0025CA3: mov     rax, qword ptr cs:WPP_MAIN_CB+148h
 * 00000001C0025CAA: lea     r8, WPP_2e14ba44bfb4396fe7ac9baa15c70ba7_Traceguids
 * 00000001C0025CB1: mov     rcx, [rcx+18h]
 * 00000001C0025CB5: mov     r9d, edi
 * 00000001C0025CB8: mov     [rsp+68h+var_20], rbp
 * 00000001C0025CBD: mov     [rsp+68h+var_28], rdx
 * 00000001C0025CC2: lea     rdx, [rsp+68h+arg_30]
 * 00000001C0025CCA: mov     [rsp+68h+var_30], 8
 * 00000001C0025CD3: mov     [rsp+68h+var_38], rdx
 * 00000001C0025CD8: lea     rdx, [rsp+68h+arg_28]
 * 00000001C0025CE0: mov     [rsp+68h+var_40], rbp
 * 00000001C0025CE5: mov     [rsp+68h+var_48], rdx
 * 00000001C0025CEA: mov     edx, 2Bh ; '+'
 * 00000001C0025CEF: call    cs:__guard_dispatch_icall_fptr
 * 00000001C0025CF5: nop
 * 00000001C0025CF6: jmp     loc_1C0009547
 */
