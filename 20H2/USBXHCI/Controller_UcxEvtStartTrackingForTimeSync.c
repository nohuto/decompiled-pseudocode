/*
 * XREFs of Controller_UcxEvtStartTrackingForTimeSync @ 0x1C0034D50
 * Callers:
 *     <none>
 * Callees:
        ...
        unsigned __int64 a4)
{
  ...
  if ( *(_QWORD *)v43 )
  {
    ...
    {
      LOBYTE(v19) = 2;
      WPP_RECORDER_SF_(*(_QWORD *)(v10 + 72), v19, 4, 281, (__int64)&WPP_1fced1a270be39d344e698c349d4a9f8_Traceguids);
    }
LABEL_23:
    v13 = -1073741811;
    goto LABEL_6;
