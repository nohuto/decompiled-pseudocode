/*
 * XREFs of ESM_ReclaimingCanceledTransfersAfterControllerSurpriseRemoval @ 0x1C004F900
 * Callers:
 *     <none>
 * Callees:
 *     Endpoint_SM_OkToCompleteEndpointResetRequest @ 0x1C003A63C (Endpoint_SM_OkToCompleteEndpointResetRequest.c)
 *     TR_OkToReclaimTransfersOnCancel @ 0x1C00401AC (TR_OkToReclaimTransfersOnCancel.c)
 */
