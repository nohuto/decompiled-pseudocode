/*
 * XREFs of XilEndpoint_CreateSecureObject @ 0x1C0037F60
 * Callers:
...
__int64 __fastcall XilEndpoint_CreateSecureObject(_QWORD *a1, int a2, int a3, int a4)
{
  ...
  *((_QWORD *)&v19 + 1) = v9;
  ...
  {
    LOBYTE(v11) = 2;
    WPP_RECORDER_SF_d(*(_QWORD *)(v6 + 72), v11, 13, 10, (__int64)&WPP_ef657641772f3c5a4b119de1b27b7cfa_Traceguids, v10);
  }
  return v12;
}
