/*
 * XREFs of Controller_ConfigureSxWakeSettings @ 0x1C007198C
 * Callers:
...
__int64 __fastcall Controller_ConfigureSxWakeSettings(__int64 *a1)
{
  ...
  {
    LOBYTE(v4) = 2;
    return WPP_RECORDER_SF_d(a1[9], v4, 4, 32, (__int64)&WPP_1fced1a270be39d344e698c349d4a9f8_Traceguids, result);
  }
  return result;
}
