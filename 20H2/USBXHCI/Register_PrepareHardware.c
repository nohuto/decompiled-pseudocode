/*
 * XREFs of Register_PrepareHardware @ 0x1C006DF14
 * Callers:
...
LABEL_11:
    ...
    if ( v12 >= 0 )
    {
      ...
      if ( v12 >= 0 )
      {
        ...
        if ( v12 >= 0 )
        {
          if ( (unsigned int)Feature_Servicing_LimitNXPXHCIControllerTo32bitDMA__private_IsEnabled()
            && (_mm_srli_si128(*(__m128i *)(*(_QWORD *)(a1 + 8) + 336LL), 8).m128i_u64[0] & 0x80000) != 0
