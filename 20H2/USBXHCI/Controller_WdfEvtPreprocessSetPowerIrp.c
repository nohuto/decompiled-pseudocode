 ...
 *     Crashdump_ProcessSystemPowerAction @ 0x1C004AD54 (Crashdump_ProcessSystemPowerAction.c)
 */
...
LABEL_14:
  ...
  *(_QWORD *)(a2 + 184) += 72LL;
  ...
  {
    LOBYTE(v13) = 2;
    WPP_RECORDER_SF_d(*(_QWORD *)(v6 + 16), v13, 4, 208, (__int64)&WPP_1fced1a270be39d344e698c349d4a9f8_Traceguids, v12);
  }
  return v14;
}
