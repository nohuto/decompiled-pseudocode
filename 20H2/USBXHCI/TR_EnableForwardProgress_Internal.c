/*
 * XREFs of TR_EnableForwardProgress_Internal @ 0x1C003FC64
 * Callers:
 *     Endpoint_UcxEvtEndpointEnableForwardProgress @ 0x1C003B120 (Endpoint_UcxEvtEndpointEnableForwardProgress.c)
 * Callees:
