/*
 * XREFs of Endpoint_UcxEvtEndpointStaticStreamsAdd @ 0x1C003B410
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall Endpoint_UcxEvtEndpointStaticStreamsAdd(__int64 a1, unsigned int a2, __int64 a3)
{
  ...
  if ( *(_BYTE *)(v6 + 1336) )
    v8 = 2;
  v24 = v8;
  v9 = ((__int64 (__fastcall *)(__int64, __int64, __int64 *, _QWORD *, __int64 *))qword_1C0062820)(
         UcxDriverGlobals,
         a1,
         &v29,
         v22,
  ...
  if ( v9 >= 0 )
  {
    ...
    *(_DWORD *)(v12 + 8) = v3;
    ...
    for ( i = v12 + 48; ; i += 104LL )
    {
      ...
      *(_QWORD *)&v20 = 24LL;
      v21 = v30;
      ((void (__fastcall *)(__int64, __int64, __int128 *))qword_1C0062818)(UcxDriverGlobals, v19, &v20);
