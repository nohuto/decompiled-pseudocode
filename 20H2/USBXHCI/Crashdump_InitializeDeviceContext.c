/*
 * XREFs of Crashdump_InitializeDeviceContext @ 0x1C004A6D0
 * Callers:
...
__int64 __fastcall Crashdump_InitializeDeviceContext(__int64 a1, int a2, __int64 a3, __int64 a4, __int64 a5)
{
  ...
  if ( v8 < 0 )
    return (unsigned int)v8;
  PoolWithTag = ExAllocatePoolWithTag(SHIDWORD(WPP_MAIN_CB.DeviceLock.Header.WaitListHead.Flink), 0xC8uLL, 0x43434858u);
  v14 = PoolWithTag;
  if ( !PoolWithTag )
...
LABEL_13:
  ...
  while ( 1 )
  {
    ...
    if ( v17 )
      break;
    v19 = ExAllocatePoolWithTag(SHIDWORD(WPP_MAIN_CB.DeviceLock.Header.WaitListHead.Flink), 0xC8uLL, 0x43434858u);
    v14 = v19;
    if ( !v19 )
    {
      v8 = -1073741670;
