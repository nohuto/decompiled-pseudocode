/*
 * XREFs of WerKernelCreateReport @ 0x1C0051BE0
 * Callers:
 *     TelemetryData_SubmitReport @ 0x1C00789A8 (TelemetryData_SubmitReport.c)
 * Callees:
 *     CheckSpaceAvailable @ 0x1C00519C0 (CheckSpaceAvailable.c)
 *     WerpCreateRegistryKey @ 0x1C0052798 (WerpCreateRegistryKey.c)
 */
