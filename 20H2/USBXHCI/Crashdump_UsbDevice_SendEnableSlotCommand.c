/*
 * XREFs of Crashdump_UsbDevice_SendEnableSlotCommand @ 0x1C004EF4C
 * Callers:
 *     Crashdump_UsbDevice_ReConfigureOnControllerReset @ 0x1C004E87C (Crashdump_UsbDevice_ReConfigureOnControllerReset.c)
 * Callees:
