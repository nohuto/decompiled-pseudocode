/*
 * XREFs of Controller_WdfEvtDeviceFilterRemoveResourceRequirements @ 0x1C006F860
 * Callers:
 *     <none>
 * Callees:
 ...
 *     Interrupter_IoResList_GetMessageCountAndType @ 0x1C006F964 (Interrupter_IoResList_GetMessageCountAndType.c)
