/*
 * XREFs of Counter_CreateTransferRingInstance @ 0x1C006C390
 * Callers:
...
NTSTATUS __fastcall Counter_CreateTransferRingInstance(__int64 *a1, int a2, PPCW_INSTANCE *a3)
{
  ...
  if ( *(_BYTE *)(g_WdfDriverUsbXhciContext + 28) && !a3[4] )
  {
    ...
    Data = *(_DWORD *)(*a1 + 176);
    if ( *(_DWORD *)(*a1 + 244) == 1 )
      RtlStringCchPrintfW(pszDest, 0x15uLL, L"%04X.%u.%04X.%02X.%u", *(unsigned __int16 *)(v5 + 248), Data, v7, v8, a2);
    else
      RtlStringCchPrintfW(pszDest, 0x15uLL, L"%S.%u.%04X.%02X.%u", v5 + 304, Data, v7, v8, a2);
