 ...
 * 00000001C000DEBC: jnz     loc_1C0020C94
 ...
 * 00000001C0020C94: cmp     [rcx+29h], dil
 * 00000001C0020C98: jb      loc_1C000DEC2
 * 00000001C0020C9E: and     [rsp+90h+var_10], 0
 * 00000001C0020CA7: lea     rdx, [rbp+1Fh+arg_50]
 * 00000001C0020CAB: mov     rax, qword ptr cs:WPP_MAIN_CB+148h
 * 00000001C0020CB2: lea     r8, WPP_f900c8e8530d3ebbc4303e7a1e3d0cbe_Traceguids
 * 00000001C0020CB9: mov     rcx, [rcx+18h]
 * 00000001C0020CBD: mov     [rsp+90h+var_18], rsi
 * 00000001C0020CC2: mov     [rsp+90h+var_20], rdx
 * 00000001C0020CC7: lea     rdx, [rbp+1Fh+arg_48]
 * 00000001C0020CCB: mov     [rsp+90h+var_28], rsi
 * 00000001C0020CD0: mov     [rsp+90h+var_30], rdx
 * 00000001C0020CD5: lea     rdx, [rbp+1Fh+arg_40]
 * 00000001C0020CD9: mov     [rsp+90h+var_38], rsi
 * 00000001C0020CDE: mov     [rsp+90h+var_40], rdx
 * 00000001C0020CE3: lea     rdx, [rbp+1Fh+arg_38]
 * 00000001C0020CE7: mov     [rsp+90h+var_48], rdi
 * 00000001C0020CEC: mov     [rsp+90h+var_50], rdx
 * 00000001C0020CF1: lea     rdx, [rbp+1Fh+arg_30]
 * 00000001C0020CF5: mov     [rsp+90h+var_58], rdi
 * 00000001C0020CFA: mov     [rsp+90h+var_60], rdx
 * 00000001C0020CFF: lea     rdx, [rbp+1Fh+arg_28]
 * 00000001C0020D03: mov     [rsp+90h+var_68], rdi
 * 00000001C0020D08: mov     [rsp+90h+var_70], rdx
 * 00000001C0020D0D: mov     edx, 2Bh ; '+'
 * 00000001C0020D12: movzx   r9d, r14w
 * 00000001C0020D16: call    cs:__guard_dispatch_icall_fptr
 * 00000001C0020D1C: nop
 * 00000001C0020D1D: jmp     loc_1C000DEC2
 */
