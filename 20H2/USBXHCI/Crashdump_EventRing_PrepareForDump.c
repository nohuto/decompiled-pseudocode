/*
 * XREFs of Crashdump_EventRing_PrepareForDump @ 0x1C004C87C
 * Callers:
 *     Crashdump_InitializeWithControllerReset @ 0x1C004A8F0 (Crashdump_InitializeWithControllerReset.c)
 * Callees:
 *     memset @ 0x1C001BFC0 (memset.c)
 *     Crashdump_EventRing_UpdateDequeuePointer @ 0x1C004CA88 (Crashdump_EventRing_UpdateDequeuePointer.c)
 */
