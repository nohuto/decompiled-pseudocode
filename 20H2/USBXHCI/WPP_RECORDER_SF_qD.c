 ...
 *     Controller_AcquireWdfPowerReferenceForDebugger @ 0x1C00315D0 (Controller_AcquireWdfPowerReferenceForDebugger.c)
 ...
 * 00000001C0014577: jb      loc_1C002C032
 ...
 * 00000001C002C032: lea     rcx, [rdi+rdi*4]
 * 00000001C002C036: add     rcx, rcx
 * 00000001C002C039: cmp     [r10+rcx*8+29h], sil
 * 00000001C002C03E: jb      loc_1C001457D
 * 00000001C002C044: and     [rsp+68h+var_28], 0
 * 00000001C002C04A: lea     rdx, [rsp+68h+arg_30]
 * 00000001C002C052: mov     rax, qword ptr cs:WPP_MAIN_CB+148h
 * 00000001C002C059: mov     r9d, ebp
 * 00000001C002C05C: mov     r8, [rsp+68h+arg_20]
 * 00000001C002C064: mov     rcx, [r10+rcx*8+18h]
 * 00000001C002C069: mov     [rsp+68h+var_30], rbx
 * 00000001C002C06E: mov     [rsp+68h+var_38], rdx
 * 00000001C002C073: lea     rdx, [rsp+68h+arg_28]
 * 00000001C002C07B: mov     [rsp+68h+var_40], 8
 * 00000001C002C084: mov     [rsp+68h+var_48], rdx
 * 00000001C002C089: mov     edx, 2Bh ; '+'
 * 00000001C002C08E: call    cs:__guard_dispatch_icall_fptr
 * 00000001C002C094: nop
 * 00000001C002C095: jmp     loc_1C001457D
 */
