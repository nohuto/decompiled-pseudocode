 ...
 * 00000001C00072BB: jnz     loc_1C0024570
 ...
 * 00000001C0024570: cmp     byte ptr [rcx+29h], 4
 * 00000001C0024574: jb      loc_1C00072C1
 * 00000001C002457A: and     [rsp+68h+var_18], 0
 * 00000001C0024580: lea     rdx, [rsp+68h+arg_38]
 * 00000001C0024588: mov     rax, qword ptr cs:WPP_MAIN_CB+148h
 * 00000001C002458F: lea     r8, WPP_72168dd6ef593f221f3405957586a4e9_Traceguids
 * 00000001C0024596: mov     rcx, [rcx+18h]
 * 00000001C002459A: mov     r9d, ebx
 * 00000001C002459D: mov     [rsp+68h+var_20], rbp
 * 00000001C00245A2: mov     [rsp+68h+var_28], rdx
 * 00000001C00245A7: lea     rdx, [rsp+68h+arg_30]
 * 00000001C00245AF: mov     [rsp+68h+var_30], 4
 * 00000001C00245B8: mov     [rsp+68h+var_38], rdx
 * 00000001C00245BD: lea     rdx, [rsp+68h+arg_28]
 * 00000001C00245C5: mov     [rsp+68h+var_40], rbp
 * 00000001C00245CA: mov     [rsp+68h+var_48], rdx
 * 00000001C00245CF: mov     edx, 2Bh ; '+'
 * 00000001C00245D4: call    cs:__guard_dispatch_icall_fptr
 * 00000001C00245DA: nop
 * 00000001C00245DB: jmp     loc_1C00072C1
 */
