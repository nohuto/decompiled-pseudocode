/*
 * XREFs of Crashdump_ResetDevice @ 0x1C004ADD0
 * Callers:
 *     <none>
 * Callees:
 *     Crashdump_Register_ResetPort @ 0x1C004BC18 (Crashdump_Register_ResetPort.c)
 *     Crashdump_UsbDevice_GetPortType @ 0x1C004E60C (Crashdump_UsbDevice_GetPortType.c)
 *     Crashdump_UsbDevice_ReConfigureOnPortReset @ 0x1C004E9D0 (Crashdump_UsbDevice_ReConfigureOnPortReset.c)
 *     Crashdump_UsbDevice_ResetPort @ 0x1C004EAD0 (Crashdump_UsbDevice_ResetPort.c)
 */
