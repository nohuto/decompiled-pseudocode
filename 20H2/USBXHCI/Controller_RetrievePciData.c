/*
 * XREFs of Controller_RetrievePciData @ 0x1C006DAF0
 * Callers:
 ...
 *     Controller_PopulatePciDeviceInformation @ 0x1C006DCD0 (Controller_PopulatePciDeviceInformation.c)
 */
...
__int64 __fastcall Controller_RetrievePciData(__int64 a1, int a2, __int64 a3, __int64 a4)
{
  ...
  {
    LOBYTE(v9) = 2;
    WPP_RECORDER_SF_d(a2, v9, 4, 134, (__int64)&WPP_1fced1a270be39d344e698c349d4a9f8_Traceguids, v8);
  }
...
LABEL_11:
    LOBYTE(v11) = 2;
    WPP_RECORDER_SF_d(a2, v11, 4, v16, (__int64)&WPP_1fced1a270be39d344e698c349d4a9f8_Traceguids, v10);
    return v12;
  }
  v13 = v20;
  LOWORD(v18) = 1;
