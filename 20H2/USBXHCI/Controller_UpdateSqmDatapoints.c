/*
 * XREFs of Controller_UpdateSqmDatapoints @ 0x1C0076CFC
 * Callers:
...
__int64 __fastcall Controller_UpdateSqmDatapoints(__int64 *a1)
{
  ...
  {
    LOBYTE(v9) = 3;
    WPP_RECORDER_SF_d(a1[9], v9, 4, 58, (__int64)&WPP_1fced1a270be39d344e698c349d4a9f8_Traceguids, v8);
  }
...
LABEL_14:
    LOBYTE(v4) = 3;
    result = WPP_RECORDER_SF_d(a1[9], v4, 4, v5, (__int64)&WPP_1fced1a270be39d344e698c349d4a9f8_Traceguids, result);
  }
LABEL_15:
  if ( v14 )
