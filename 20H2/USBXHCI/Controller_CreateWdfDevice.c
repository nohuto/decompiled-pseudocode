/*
 * XREFs of Controller_CreateWdfDevice @ 0x1C006E550
 * Callers:
...
LABEL_47:
    LOBYTE(v10) = 2;
    WPP_RECORDER_SF_d(a2, v10, 4, v29, (__int64)&WPP_1fced1a270be39d344e698c349d4a9f8_Traceguids, v32);
    goto LABEL_48;
  }
...
LABEL_30:
    ...
    *((_QWORD *)&v51 + 1) = 0x100000001LL;
    ...
    {
      LOBYTE(v10) = 3;
      WPP_RECORDER_SF_d(a2, v10, 4, 39, (__int64)&WPP_1fced1a270be39d344e698c349d4a9f8_Traceguids, v7);
    }
    ++v7;
  }
  if ( v14 < 0 )
...
LABEL_33:
    LOBYTE(v21) = 2;
    WPP_RECORDER_SF_d(a2, v21, 4, v30, (__int64)&WPP_1fced1a270be39d344e698c349d4a9f8_Traceguids, v20);
    goto LABEL_22;
  }
  ...
  *(_QWORD *)((char *)&v58 + 4) = 0xFFFFFFFF00000002uLL;
  ...
  if ( v26 < 0 )
  {
    ...
    {
      LOBYTE(v27) = 2;
      WPP_RECORDER_SF_d(a2, v27, 4, 45, (__int64)&WPP_1fced1a270be39d344e698c349d4a9f8_Traceguids, v26);
    }
    v12 = 0;
  }
LABEL_22:
