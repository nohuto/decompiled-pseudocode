/*
 * XREFs of _lambda_116eb2b29a456c26711f063c826cbee8_::operator() @ 0x18019F110
 * Callers:
 ...
 *     ??$?0$$V@?$_Ref_count_obj@UHotKeyInfo@@@std@@QEAA@XZ @ 0x18019CD78 (--$-0$$V@-$_Ref_count_obj@UHotKeyInfo@@@std@@QEAA@XZ.c)
 */
