/*
 * XREFs of ?LogRawInputDeviceAttached@RawInputProvidersTelemetry@@SAXIGGG@Z @ 0x180034DF4
 * Callers:
...
void __fastcall RawInputProvidersTelemetry::LogRawInputDeviceAttached(__int64 a1, __int16 a2, __int16 a3, __int16 a4)
{
  ...
  if ( **(_DWORD **)(v8 + 8) > 5u && tlgKeywordOn(*(_QWORD *)(v8 + 8), 0x400000000000LL) )
  {
    v12 = a4;
    v13 = a3;
    v14 = a2;
