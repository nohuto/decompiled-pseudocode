/*
 * XREFs of ?OnMouseInputGenerated@BamoInputObserverClientProxyImpl@BamoImpl@@QEAAJAEBUAPP_MOUSE_INPUT_OBSERVER_PACKET@InputObservation@@@Z @ 0x1800F39BC
 * Callers:
        ...
        const struct InputObservation::APP_MOUSE_INPUT_OBSERVER_PACKET *a2)
{
  ...
  if ( *(_QWORD *)(*(_QWORD *)(*(_QWORD *)(*((_QWORD *)this + 2) + 24LL) + 32LL) + 56LL) )
  {
    ...
    if ( v5 >= 0 )
    {
      ...
      v14[2] = v11;
      v14[3] = v12;
      return CoreUICallSend(v7, v13, 2LL, 39LL, 0, &unk_1801BF23C, (unsigned int)v14);
    }
    else
    {
