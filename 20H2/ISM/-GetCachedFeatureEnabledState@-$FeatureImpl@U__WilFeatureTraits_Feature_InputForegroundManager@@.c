/*
 * XREFs of ?GetCachedFeatureEnabledState@?$FeatureImpl@U__WilFeatureTraits_Feature_InputForegroundManager@@@details@wil@@AEAA?ATwil_details_FeatureStateCache@@XZ @ 0x180045CD0
 * Callers:
