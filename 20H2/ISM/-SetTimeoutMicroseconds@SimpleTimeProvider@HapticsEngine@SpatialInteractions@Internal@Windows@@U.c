/*
 * XREFs of ?SetTimeoutMicroseconds@SimpleTimeProvider@HapticsEngine@SpatialInteractions@Internal@Windows@@UEAAJ_J@Z @ 0x18016EE00
 * Callers:
 *     <none>
 * Callees:
        ...
        __int64 a2)
{
  ...
  v4 = 1000000 * PerformanceCount.QuadPart / qword_180208308;
  if ( a2 > v4 )
    v5 = a2 - v4;
  else
    v5 = 1LL;
