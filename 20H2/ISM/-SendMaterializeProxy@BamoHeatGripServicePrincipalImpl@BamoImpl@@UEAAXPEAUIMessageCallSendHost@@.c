/*
 * XREFs of ?SendMaterializeProxy@BamoHeatGripServicePrincipalImpl@BamoImpl@@UEAAXPEAUIMessageCallSendHost@@PEAVBamoStubImpl@2Microsoft@@@Z @ 0x18000E190
 * Callers:
 *     <none>
 * Callees:
        ...
        struct Microsoft::BamoImpl::BamoStubImpl *a3)
{
  ...
  v8 = CoreUICallSend(a2, &v16, 2LL, 74LL, 23, &unk_1801BF1AA, v14);
  if ( v8 < 0 )
  {
