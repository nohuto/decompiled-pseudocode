/*
 * XREFs of ?get@?$static_lazy@VRawInputProvidersTelemetry@@@details@wil@@QEAAPEAVRawInputProvidersTelemetry@@P6AXXZ@Z @ 0x180034EA8
 * Callers:
...
LPVOID __fastcall wil::details::static_lazy<RawInputProvidersTelemetry>::get(__int64 a1, void (__cdecl *a2)())
{
  ...
  {
    v5 = &qword_1802090A8;
    qword_1802090A8 = &RawInputProvidersContinuousTracing::`vftable';
    qword_1802090C0 = (struct _tlgProvider_t *)&`RawInputProvidersTelemetry::StaticHandle::StaticHandle'::`2'::__hInner;
    atexit(a2);
    wil::TraceLoggingProvider::Register((wil::TraceLoggingProvider *)&qword_1802090A8, qword_1802090C0, 0LL);
    InitOnceComplete(&`RawInputProvidersTelemetry::Instance'::`2'::wrapper, 0, &qword_1802090A8);
  }
  return v5;
}
