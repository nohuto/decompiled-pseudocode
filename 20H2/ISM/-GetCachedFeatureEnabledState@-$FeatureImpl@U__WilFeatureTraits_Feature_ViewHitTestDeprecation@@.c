/*
 * XREFs of ?GetCachedFeatureEnabledState@?$FeatureImpl@U__WilFeatureTraits_Feature_ViewHitTestDeprecation@@@details@wil@@AEAA?ATwil_details_FeatureStateCache@@XZ @ 0x180048FD4
 * Callers:
