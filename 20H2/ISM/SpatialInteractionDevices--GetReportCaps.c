/*
 * XREFs of SpatialInteractionDevices::GetReportCaps @ 0x1800C9370
 * Callers:
 ...
 *     ??$make_shared@USpatialInputReportCaps@SpatialInteractionDevices@@$$V@std@@YA?AV?$shared_ptr@USpatialInputReportCaps@SpatialInteractionDevices@@@0@XZ @ 0x1800C8C68 (--$make_shared@USpatialInputReportCaps@SpatialInteractionDevices@@$$V@std@@YA-AV-$shared_ptr@USp.c)
