/*
 * XREFs of ?InitializeWaitHandles@EndpointListEntry@SipcServer@@QEAAJXZ @ 0x1800C0E08
 * Callers:
 ...
 *     ?GetWaitHandles@SipcEndpoint@@QEBAXAEAPEAX00@Z @ 0x1800C0D18 (-GetWaitHandles@SipcEndpoint@@QEBAXAEAPEAX00@Z.c)
 */
