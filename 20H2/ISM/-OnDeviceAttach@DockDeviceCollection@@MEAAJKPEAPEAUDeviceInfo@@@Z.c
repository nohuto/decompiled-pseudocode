/*
 * XREFs of ?OnDeviceAttach@DockDeviceCollection@@MEAAJKPEAPEAUDeviceInfo@@@Z @ 0x18009B900
 * Callers:
 *     <none>
 * Callees:
 ...
 *     ??$emplace_back@UGetInputReportResult@@@?$deque@UGetInputReportResult@@V?$allocator@UGetInputReportResult@@@std@@@std@@QEAAAEAUGetInputReportResult@@$$QEAU2@@Z @ 0x18009B628 (--$emplace_back@UGetInputReportResult@@@-$deque@UGetInputReportResult@@V-$allocator@UGetInputRep.c)
