/*
 * XREFs of ??$make_shared@VSystemCursorService@@PEAVSystemCursorController@@AEAK@std@@YA?AV?$shared_ptr@VSystemCursorService@@@0@$$QEAPEAVSystemCursorController@@AEAK@Z @ 0x18013AFA4
 * Callers:
 ...
 *     ??0SystemCursorService@@QEAA@PEAVSystemCursorController@@K@Z @ 0x18013E214 (--0SystemCursorService@@QEAA@PEAVSystemCursorController@@K@Z.c)
 */
