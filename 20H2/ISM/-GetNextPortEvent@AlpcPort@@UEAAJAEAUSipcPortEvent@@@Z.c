/*
 * XREFs of ?GetNextPortEvent@AlpcPort@@UEAAJAEAUSipcPortEvent@@@Z @ 0x1800C0740
 * Callers:
 *     <none>
 * Callees:
 *     memset_0 @ 0x18003C540 (memset_0.c)
 *     __security_check_cookie @ 0x18003C560 (__security_check_cookie.c)
 *     ?NtStatusToHr@details@wil@@YAJJ@Z @ 0x1800658DC (-NtStatusToHr@details@wil@@YAJJ@Z.c)
 ...
 *     ?DisconnectAllSections@SipcPort@@IEAAXXZ @ 0x1800C009C (-DisconnectAllSections@SipcPort@@IEAAXXZ.c)
 ...
 *     ?GetValue@?$SerializedIntegral@I@@QEBAIXZ @ 0x1800C0CDC (-GetValue@-$SerializedIntegral@I@@QEBAIXZ.c)
