/*
 * XREFs of ?MPCHolographicInputManager_ForcedPrimary_@ISMTracing@@QEAAXK@Z @ 0x180076868
 * Callers:
...
void __fastcall ISMTracing::MPCHolographicInputManager_ForcedPrimary_(ISMTracing *this, int a2)
{
  ...
  if ( ISMTracing::IsEnabled((__int64)this) )
  {
    ...
    if ( **((_DWORD **)v4 + 1) > 4u && tlgKeywordOn(*((_QWORD *)v4 + 1), 1LL) )
    {
      ...
      v6 = a2;
      v9 = 4;
      tlgWriteTransfer_EventWriteTransfer(v5, (unsigned __int8 *)dword_1801C7B5E, 0LL, 0LL, 3u, &v7);
    }
  }
}
