/*
 * XREFs of ?SetConvertGraspToSystemGesture@BamoMPCManagerPrincipalImpl@BamoImpl@@QEAAJ_NI@Z @ 0x180073DE4
 * Callers:
 *     ?Thunk_SetConvertGraspToSystemGesture_43@?$IMPCManagerPrincipal_Receive@VBamoMPCManagerPrincipalImpl@BamoImpl@@@@SAJPEAXPEAPEAX@Z @ 0x180074420 (-Thunk_SetConvertGraspToSystemGesture_43@-$IMPCManagerPrincipal_Receive@VBamoMPCManagerPrincipal.c)
 * Callees:
