/*
 * XREFs of ?OnInput@DragNDropProcessorLegacy@@UEAAJPEAUInputInfo@@PEAVInputContext@@PEAUContextualProcessorResponse@@@Z @ 0x180175470
 * Callers:
 *     <none>
 * Callees:
      ...
      if ( v51 )
      {
        ...
        if ( (*((_BYTE *)a2 + v12 + 228) & 4) != 0 )
        {
          ...
          if ( v31 )
          {
            ...
            v36 = v51;
            LOWORD(v44) = 3;
            CoreUICallSend(*((_QWORD *)v52 + 8), &v51, 1LL, 1LL, v44, &unk_1801C62BE, *(_DWORD *)v46);
          ...
          else
          {
            ...
            v34 = v51;
            LOWORD(v43) = 1;
            if ( (int)CoreUICallSend(*((_QWORD *)v52 + 8), &v51, 1LL, 1LL, v43, &unk_1801C62BE, *(_DWORD *)v46) >= 0 )
            {
              v11 = (_QWORD *)((char *)v4 + 144);
            }
            else
...
LABEL_45:
        ...
        v40 = *((_QWORD *)v52 + 8);
        v48 = v14;
        CoreUICallSend(v40, &v51, 1LL, 1LL, v45, &unk_1801C62BE, *(_DWORD *)v46);
