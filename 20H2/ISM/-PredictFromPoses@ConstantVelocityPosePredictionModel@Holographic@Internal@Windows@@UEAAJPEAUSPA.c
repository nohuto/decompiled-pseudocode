/*
 * XREFs of ?PredictFromPoses@ConstantVelocityPosePredictionModel@Holographic@Internal@Windows@@UEAAJPEAUSPATIAL_GRAPH_DYNAMIC_NODE_POSE@@_K_J0@Z @ 0x180162180
 * Callers:
 *     <none>
 * Callees:
 ...
 *     PoseClientStatics::SpatialGraphDifferentialsToSE3 @ 0x180163EB4 (PoseClientStatics--SpatialGraphDifferentialsToSE3.c)
...
LABEL_10:
  ...
  v12 = (double)((int)a4 - *(_DWORD *)a2) / (double)(int)qword_1802082E8;
  if ( v12 <= 0.0 )
  {
    *(_OWORD *)a5 = *(_OWORD *)a2;
