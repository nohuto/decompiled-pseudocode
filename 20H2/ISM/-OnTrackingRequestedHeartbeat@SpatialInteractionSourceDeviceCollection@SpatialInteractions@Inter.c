/*
 * XREFs of ?OnTrackingRequestedHeartbeat@SpatialInteractionSourceDeviceCollection@SpatialInteractions@Internal@Windows@@UEAAJKPEAUISpatialInteractionSourceCollectionCallbacks@234@@Z @ 0x1800D1510
 * Callers:
 *     <none>
 * Callees:
        ...
        struct Windows::Internal::SpatialInteractions::ISpatialInteractionSourceCollectionCallbacks *a3)
{
  ...
  bool v18; // [rsp+71h] [rbp-8Fh] BYREF
  unsigned int v19; // [rsp+74h] [rbp-8Ch] BYREF
  int v20; // [rsp+78h] [rbp-88h] BYREF
  int v21; // [rsp+80h] [rbp-80h] BYREF
  Windows::Internal::SpatialInteractions::SpatialInteractionSourceDevice *v22[2]; // [rsp+88h] [rbp-78h] BYREF
  __int64 StringRawBuffer; // [rsp+98h] [rbp-68h] BYREF
  int v24[2]; // [rsp+A0h] [rbp-60h] BYREF
  __m256i v25; // [rsp+A8h] [rbp-58h] BYREF
  __m256i *v26; // [rsp+E0h] [rbp-20h]
  __m256i v27; // [rsp+E8h] [rbp-18h] BYREF
  struct _GUID v28; // [rsp+108h] [rbp+8h] BYREF
  ...
  *(_OWORD *)v22 = 0LL;
  ...
  {
    v6 = v22[0];
    if ( (*(unsigned __int8 (__fastcall **)(Windows::Internal::SpatialInteractions::SpatialInteractionSourceDevice *))(*(_QWORD *)v22[0] + 104LL))(v22[0]) )
    {
      ...
      v17 = DynamicNodeInfo;
      *(_OWORD *)v25.m256i_i8 = v8;
      v11 = *(_OWORD *)((char *)v6 + 540);
      *(_OWORD *)&v25.m256i_u64[2] = v10;
      v12 = *(_OWORD *)((char *)v6 + 556);
      *(_OWORD *)v27.m256i_i8 = v11;
      *(_OWORD *)&v27.m256i_u64[2] = v12;
      StringRawBuffer = (__int64)WindowsGetStringRawBuffer(v9, 0LL);
      v18 = (*(__int64 (__fastcall **)(Windows::Internal::SpatialInteractions::SpatialInteractionSourceDevice *))(*(_QWORD *)v6 + 40LL))(v6);
      v19 = *((_DWORD *)v6 + 126);
      v20 = *((_DWORD *)v6 + 3);
      *(_QWORD *)v24 = (**(__int64 (__fastcall ***)(Windows::Internal::SpatialInteractions::SpatialInteractionSourceDevice *))v6)(v6);
      SpatialInteractionDevices::SpatialInteractionTraceContinuous::TrackingRequestedHeartbeat<wchar_t const *,unsigned long &,unsigned long,unsigned int,bool,bool &,wchar_t const *,_GUID &,enum SPATIAL_TRACKING_CAPABILITY_FLAGS &,float (&)[3],float (&)[4],float (&)[3],float (&)[4]>(
        ...
        (unsigned int *)&v29,
        (float (*)[3])&v25,
        (float (*)[4])((char *)&v25.m256i_u64[1] + 4),
        (float (*)[3])&v27,
        (float (*)[4])((char *)&v27.m256i_u64[1] + 4));
      if ( Windows::Internal::SpatialInteractions::SpatialInteractionSourceDevice::CanSwitchTo6DOF(v6) )
      {
        v25.m256i_i64[1] = (__int64)v3;
        v25.m256i_i64[0] = (__int64)off_1801B0928;
        LOBYTE(v13) = 1;
        v26 = &v25;
