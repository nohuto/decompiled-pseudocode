/*
 * XREFs of ?QueryInterface@BamoTestCommandsPrincipal@@UEAAJAEBU_GUID@@PEAPEAX@Z @ 0x1801709F0
 * Callers:
 *     ?QueryInterface@BamoTestCommandsPrincipal@@W7EAAJAEBU_GUID@@PEAPEAX@Z @ 0x18004CCA0 (-QueryInterface@BamoTestCommandsPrincipal@@W7EAAJAEBU_GUID@@PEAPEAX@Z.c)
 * Callees:
