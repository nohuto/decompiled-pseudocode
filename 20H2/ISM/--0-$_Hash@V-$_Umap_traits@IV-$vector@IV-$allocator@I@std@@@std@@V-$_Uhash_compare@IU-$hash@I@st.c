/*
 * XREFs of ??0?$_Hash@V?$_Umap_traits@IV?$vector@IV?$allocator@I@std@@@std@@V?$_Uhash_compare@IU?$hash@I@std@@U?$equal_to@I@2@@2@V?$allocator@U?$pair@$$CBIV?$vector@IV?$allocator@I@std@@@std@@@std@@@2@$0A@@std@@@std@@QEAA@AEBV?$_Uhash_compare@IU?$hash@I@std@@U?$equal_to@I@2@@1@AEBV?$allocator@U?$pair@$$CBIV?$vector@IV?$allocator@I@std@@@std@@@std@@@1@@Z @ 0x180024EE4
 * Callers:
 *     ??0?$unordered_map@IV?$vector@IV?$allocator@I@std@@@std@@U?$hash@I@2@U?$equal_to@I@2@V?$allocator@U?$pair@$$CBIV?$vector@IV?$allocator@I@std@@@std@@@std@@@2@@std@@QEAA@XZ @ 0x180024D34 (--0-$unordered_map@IV-$vector@IV-$allocator@I@std@@@std@@U-$hash@I@2@U-$equal_to@I@2@V-$allocato.c)
 * Callees:
        ...
        int *a2)
{
  ...
  *v2 = v2;
  v2[1] = v2;
  qword_180208B78 = (__int64)v2;
  qword_180208B88 = 0LL;
  xmmword_180208B90 = 0LL;
  std::vector<std::_List_unchecked_iterator<std::_List_val<std::_List_simple_types<std::pair<tagMsgRoutingInfo const,IInputTarget *>>>>>::_Buy_raw(
    ...
    0x10uLL);
  v3 = qword_180208B88;
  memset64((void *)qword_180208B88, (unsigned __int64)v2, 0x10uLL);
  *(_QWORD *)&xmmword_180208B90 = v3 + 128;
  qword_180208BA0 = 7LL;
  qword_180208BA8 = 8LL;
