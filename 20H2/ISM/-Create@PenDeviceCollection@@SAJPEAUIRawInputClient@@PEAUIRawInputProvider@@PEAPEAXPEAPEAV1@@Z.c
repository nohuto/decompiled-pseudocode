/*
 * XREFs of ?Create@PenDeviceCollection@@SAJPEAUIRawInputClient@@PEAUIRawInputProvider@@PEAPEAXPEAPEAV1@@Z @ 0x180022D40
 * Callers:
        ...
        struct PenDeviceCollection **a4)
{
  ...
  if ( a1 && a3 && a4 )
  {
    ...
    {
      LODWORD(v20) = 852000;
      v13 = HIDDeviceCollection::Initialize(v12, v10, (struct _RIM_USAGE_ANDPAGE *const)&v20, v11, 1u, a3);
      v15 = v13;
      if ( v13 < 0 )
