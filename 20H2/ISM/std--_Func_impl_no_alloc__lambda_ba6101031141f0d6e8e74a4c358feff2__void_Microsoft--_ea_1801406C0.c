/*
 * XREFs of std::_Func_impl_no_alloc__lambda_ba6101031141f0d6e8e74a4c358feff2__void_Microsoft::WRL::ComPtr_DataProviderPrincipal__&_::_Delete_this @ 0x1801406C0
 * Callers:
 *     <none>
 * Callees:
