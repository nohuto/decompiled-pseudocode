/*
 * XREFs of ?GetInterfaceProperty@DevicePropertyHelper@DevicePropertyHelpers@@QEBAJAEBU_DEVPROPKEY@@KPEAEPEAK@Z @ 0x18009348C
 * Callers:
 ...
 *     DevicePropertyHelpers::MapCrToHResult @ 0x180093CB0 (DevicePropertyHelpers--MapCrToHResult.c)
 */
