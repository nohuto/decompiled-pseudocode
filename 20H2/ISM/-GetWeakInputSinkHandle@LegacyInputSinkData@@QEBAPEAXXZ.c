/*
 * XREFs of ?GetWeakInputSinkHandle@LegacyInputSinkData@@QEBAPEAXXZ @ 0x1800F0E1C
 * Callers:
 ...
 *     ?GetInputSinkHandle@DWMInputTarget@@AEBAPEAXXZ @ 0x1800B6A30 (-GetInputSinkHandle@DWMInputTarget@@AEBAPEAXXZ.c)
 ...
 *     ?OwnsRefOfInputSink@LegacyInputSinkData@@QEBA_NXZ @ 0x180044034 (-OwnsRefOfInputSink@LegacyInputSinkData@@QEBA_NXZ.c)
 */
