 ...
 * Callers:
 *     ?Release@InputRedirectionProcessor@@W7EAAKXZ @ 0x18004CE50 (-Release@InputRedirectionProcessor@@W7EAAKXZ.c)
 *     ?Release@InputRedirectionProcessor@@WBA@EAAKXZ @ 0x18004CE60 (-Release@InputRedirectionProcessor@@WBA@EAAKXZ.c)
 *     ?Release@InputRedirectionProcessor@@WBI@EAAKXZ @ 0x18004CE70 (-Release@InputRedirectionProcessor@@WBI@EAAKXZ.c)
 * Callees:
