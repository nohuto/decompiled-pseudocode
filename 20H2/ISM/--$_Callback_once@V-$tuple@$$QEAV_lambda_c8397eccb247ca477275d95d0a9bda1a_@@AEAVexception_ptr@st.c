/*
 * XREFs of ??$_Callback_once@V?$tuple@$$QEAV_lambda_c8397eccb247ca477275d95d0a9bda1a_@@AEAVexception_ptr@std@@@std@@U?$integer_sequence@_K$0A@@2@$00@std@@YAHPEAX0PEAPEAX@Z @ 0x180033150
 * Callers:
 *     <none>
 * Callees:
 *     ??0MPCConstantManager@@QEAA@PEAVMPCManagerConnection@@@Z @ 0x180033048 (--0MPCConstantManager@@QEAA@PEAVMPCManagerConnection@@@Z.c)
