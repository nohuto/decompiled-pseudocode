/*
 * XREFs of ??$MPCGestureHandler_PointerDown@AEAJAEAJAEAIAEAKAEAK@ISMTracing@@SAXAEAJ0AEAIAEAK2@Z @ 0x180079D74
 * Callers:
        ...
        unsigned int *a5)
{
  ...
  if ( ISMTracing::IsEnabled((__int64)a1) )
  {
    ...
    ISMTracing::MPCGestureHandler_PointerDown_(v10, *a1, *a2, *a3, *a4, *a5);
  }
}
