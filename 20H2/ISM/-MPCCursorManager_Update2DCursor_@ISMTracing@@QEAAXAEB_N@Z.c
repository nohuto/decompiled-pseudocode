/*
 * XREFs of ?MPCCursorManager_Update2DCursor_@ISMTracing@@QEAAXAEB_N@Z @ 0x18007C258
 * Callers:
...
void __fastcall ISMTracing::MPCCursorManager_Update2DCursor_(ISMTracing *this, const bool *a2)
{
  ...
  if ( ISMTracing::IsEnabled((__int64)this) )
  {
    ...
    if ( **((_DWORD **)v4 + 1) > 4u && tlgKeywordOn(*((_QWORD *)v4 + 1), 1LL) )
    {
      ...
      v11 = v5;
      v10 = &v8;
      tlgWriteTransfer_EventWriteTransfer(v6, (unsigned __int8 *)dword_1801C8248, 0LL, 0LL, 3u, &v9);
    }
  }
}
