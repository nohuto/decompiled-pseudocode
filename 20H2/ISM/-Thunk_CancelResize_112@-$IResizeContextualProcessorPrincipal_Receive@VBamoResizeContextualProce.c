/*
 * XREFs of ?Thunk_CancelResize_112@?$IResizeContextualProcessorPrincipal_Receive@VBamoResizeContextualProcessorPrincipalImpl@BamoImpl@@@@SAJPEAXPEAPEAX@Z @ 0x1800FCD50
 * Callers:
 *     <none>
 * Callees:
 *     <none>
