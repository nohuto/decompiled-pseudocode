/*
 * XREFs of ??$_Try_emplace@AEBK$$V@?$unordered_map@K_KU?$hash@K@std@@U?$equal_to@K@2@V?$allocator@U?$pair@$$CBK_K@std@@@2@@std@@QEAA?AU?$pair@V?$_List_iterator@V?$_List_val@U?$_List_simple_types@U?$pair@$$CBK_K@std@@@std@@@std@@@std@@_N@1@AEBK@Z @ 0x1800F753C
 * Callers:
...
__int64 __fastcall std::unordered_map<unsigned long,unsigned __int64>::_Try_emplace<unsigned long const &,>(
        __int64 a1,
        __int64 a2,
