/*
 * XREFs of ?ControllerHapticsStatistics_@SpatialInteractionTrace@SpatialInteractionDevices@@QEAAXKJJN@Z @ 0x18016B44C
 * Callers:
        ...
        double a5)
{
  ...
  if ( **((_DWORD **)v8 + 1) > 4u && tlgKeywordOn(*((_QWORD *)v8 + 1), 0x400000000000LL) )
  {
    ...
    v13 = a2;
    v23 = 8LL;
    tlgWriteTransfer_EventWriteTransfer(v10, (unsigned __int8 *)dword_1801D0E9A, 0LL, 0LL, 6u, &v15);
  }
}
