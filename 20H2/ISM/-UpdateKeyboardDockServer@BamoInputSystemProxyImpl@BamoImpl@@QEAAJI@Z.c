/*
 * XREFs of ?UpdateKeyboardDockServer@BamoInputSystemProxyImpl@BamoImpl@@QEAAJI@Z @ 0x1800EEBB4
 * Callers:
 ...
 *     ?Thunk_UpdateKeyboardDockServer_10@?$IInputSystemProxy_Receive@VBamoInputSystemProxyImpl@BamoImpl@@@@SAJPEAXPEAPEAX@Z @ 0x1800ECF30 (-Thunk_UpdateKeyboardDockServer_10@-$IInputSystemProxy_Receive@VBamoInputSystemProxyImpl@BamoImp.c)
 * Callees:
