/*
 * XREFs of ??_GVirtualTouchpadContextProvider@@UEAAPEAXI@Z @ 0x180145630
 * Callers:
 *     ??_EVirtualTouchpadContextProvider@@W7EAAPEAXI@Z @ 0x18004C700 (--_EVirtualTouchpadContextProvider@@W7EAAPEAXI@Z.c)
 * Callees:
 ...
 *     ??1CriticalSection@Wrappers@WRL@Microsoft@@QEAA@XZ @ 0x180064508 (--1CriticalSection@Wrappers@WRL@Microsoft@@QEAA@XZ.c)
        ...
        char a2)
{
  ...
  std::_List_node<std::pair<unsigned __int64 const,tagRECT>,void *>::_Free_non_head<std::allocator<std::_List_node<std::pair<unsigned __int64 const,tagRECT>,void *>>>(
    v4,
    *((_QWORD ***)this + 17));
  std::_Deallocate<16,0>(*((void **)this + 17), (const struct std::nothrow_t *)0x28);
  Microsoft::WRL::Wrappers::CriticalSection::~CriticalSection((LPCRITICAL_SECTION)((char *)this + 88));
