/*
 * XREFs of ?ProcessDeviceNotifications@PnpDeviceWatcher@@QEAAJPEAK@Z @ 0x180026EF0
 * Callers:
 ...
 *     ?RemoveInterface@PnpDevice@@AEAAJPEAUHSTRING__@@@Z @ 0x1800A065C (-RemoveInterface@PnpDevice@@AEAAJPEAUHSTRING__@@@Z.c)
 */
