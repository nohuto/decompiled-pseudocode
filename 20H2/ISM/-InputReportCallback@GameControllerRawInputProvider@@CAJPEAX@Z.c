/*
 * XREFs of ?InputReportCallback@GameControllerRawInputProvider@@CAJPEAX@Z @ 0x180088530
 * Callers:
 *     <none>
 * Callees:
 *     ?Return_Hr@in1diag3@details@wil@@YAXPEAXIPEBDJ@Z @ 0x1800357E0 (-Return_Hr@in1diag3@details@wil@@YAXPEAXIPEBDJ@Z.c)
 *     _guard_dispatch_icall_nop @ 0x18004A660 (_guard_dispatch_icall_nop.c)
 *     ??1?$unique_ptr@UInputInfo@@P6AXPEAU1@@Z@std@@QEAA@XZ @ 0x18008815C (--1-$unique_ptr@UInputInfo@@P6AXPEAU1@@Z@std@@QEAA@XZ.c)
 */
