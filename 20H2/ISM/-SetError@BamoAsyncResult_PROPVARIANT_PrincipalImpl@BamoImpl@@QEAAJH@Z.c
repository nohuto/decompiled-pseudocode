/*
 * XREFs of ?SetError@BamoAsyncResult_PROPVARIANT_PrincipalImpl@BamoImpl@@QEAAJH@Z @ 0x18011A838
 * Callers:
 *     ?Thunk_SetError_5@?$IAsyncResult_PROPVARIANT_Principal_Receive@VBamoAsyncResult_PROPVARIANT_PrincipalImpl@BamoImpl@@@@SAJPEAXPEAPEAX@Z @ 0x18011AA70 (-Thunk_SetError_5@-$IAsyncResult_PROPVARIANT_Principal_Receive@VBamoAsyncResult_PROPVARIANT_Prin.c)
 * Callees:
