/*
 * XREFs of ?QueryInterface@BamoInputForwardTargetInputObjectProxy@@UEAAJAEBU_GUID@@PEAPEAX@Z @ 0x1800EA4C0
 * Callers:
 *     ?QueryInterface@BamoInputForwardTargetInputObjectProxy@@W7EAAJAEBU_GUID@@PEAPEAX@Z @ 0x18004B2C0 (-QueryInterface@BamoInputForwardTargetInputObjectProxy@@W7EAAJAEBU_GUID@@PEAPEAX@Z.c)
 * Callees:
