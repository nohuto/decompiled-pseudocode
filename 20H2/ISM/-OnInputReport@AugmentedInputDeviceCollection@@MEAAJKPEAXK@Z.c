/*
 * XREFs of ?OnInputReport@AugmentedInputDeviceCollection@@MEAAJKPEAXK@Z @ 0x18008F740
 * Callers:
 *     <none>
 * Callees:
 ...
 *     ?GetAugmentedInputCacheEntry@AugmentedInputDeviceCollection@@AEAAJKPEAUAugmentedInputCacheState@@@Z @ 0x18008F2D0 (-GetAugmentedInputCacheEntry@AugmentedInputDeviceCollection@@AEAAJKPEAUAugmentedInputCacheState@.c)
 *     ?UpdateCacheForDevice@AugmentedInputDeviceCollection@@AEAAJKUAugmentedInputCacheState@@@Z @ 0x18008FAFC (-UpdateCacheForDevice@AugmentedInputDeviceCollection@@AEAAJKUAugmentedInputCacheState@@@Z.c)
        ...
        unsigned int a4)
{
  ...
  char v31; // [rsp+350h] [rbp+250h]
  float v32; // [rsp+354h] [rbp+254h]
  float v33; // [rsp+358h] [rbp+258h]
  USHORT UsageList[20]; // [rsp+880h] [rbp+780h] BYREF
