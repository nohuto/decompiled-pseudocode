/*
 * XREFs of ?UpdateTailButtonClickedEventsRequired@BamoPenEventsClientProxyImpl@BamoImpl@@QEAAJ_N@Z @ 0x180134B58
 * Callers:
 ...
 *     ?Thunk_UpdateTailButtonClickedEventsRequired_13@?$IPenEventsClientProxy_Receive@VBamoPenEventsClientProxyImpl@BamoImpl@@@@SAJPEAXPEAPEAX@Z @ 0x180134870 (-Thunk_UpdateTailButtonClickedEventsRequired_13@-$IPenEventsClientProxy_Receive@VBamoPenEventsCl.c)
 * Callees:
