/*
 * XREFs of ??$to_hstring@PEBDX@winrt@@YA?AUhstring@0@AEBQEBD@Z @ 0x1800BD2A4
 * Callers:
 ...
 *     WindowsPreallocateStringBuffer_0 @ 0x18003CFD7 (WindowsPreallocateStringBuffer_0.c)
 *     MultiByteToWideChar_0 @ 0x18003DCE1 (MultiByteToWideChar_0.c)
