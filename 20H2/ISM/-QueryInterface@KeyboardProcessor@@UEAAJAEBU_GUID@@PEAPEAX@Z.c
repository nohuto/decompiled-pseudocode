/*
 * XREFs of ?QueryInterface@KeyboardProcessor@@UEAAJAEBU_GUID@@PEAPEAX@Z @ 0x180047CD0
 * Callers:
 *     ?QueryInterface@KeyboardProcessor@@W7EAAJAEBU_GUID@@PEAPEAX@Z @ 0x18004C260 (-QueryInterface@KeyboardProcessor@@W7EAAJAEBU_GUID@@PEAPEAX@Z.c)
 * Callees:
