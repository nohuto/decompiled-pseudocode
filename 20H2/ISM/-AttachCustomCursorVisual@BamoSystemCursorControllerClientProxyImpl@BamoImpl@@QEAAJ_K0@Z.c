/*
 * XREFs of ?AttachCustomCursorVisual@BamoSystemCursorControllerClientProxyImpl@BamoImpl@@QEAAJ_K0@Z @ 0x1800E339C
 * Callers:
        ...
        int a2)
{
  ...
  if ( *(_QWORD *)(*(_QWORD *)(*(_QWORD *)(*((_QWORD *)this + 2) + 24LL) + 32LL) + 56LL) )
  {
    ...
    if ( v6 >= 0 )
    {
      ...
      v9 = 2;
      return CoreUICallSend(v8, v10, 2LL, 64LL, v9, &unk_1801BF29D, a2);
    }
    else
    {
