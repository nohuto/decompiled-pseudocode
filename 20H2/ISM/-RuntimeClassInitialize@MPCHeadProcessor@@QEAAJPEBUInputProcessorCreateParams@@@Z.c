/*
 * XREFs of ?RuntimeClassInitialize@MPCHeadProcessor@@QEAAJPEBUInputProcessorCreateParams@@@Z @ 0x180197B6C
 * Callers:
...
LABEL_3:
  ...
  v11 = this;
  std::call_once__lambda_0768ca99b5f0498451ffc3dbd3bcf85b___(v3, (__int64)&v11);
