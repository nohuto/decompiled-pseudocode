/*
 * XREFs of ?DeliverInput@InputRedirectionTarget@@UEAAJPEAUInputInfo@@@Z @ 0x18017F630
 * Callers:
 *     <none>
 * Callees:
 ...
 *     ?IsValid@InputRedirectionTarget@@QEAA_NXZ @ 0x18017F954 (-IsValid@InputRedirectionTarget@@QEAA_NXZ.c)
 */
