/*
 * XREFs of ?DeliverInput@ShellGesturesTarget@@UEAAJPEAUInputInfo@@@Z @ 0x18017E990
 * Callers:
 *     <none>
 * Callees:
...
void __fastcall __noreturn ShellGesturesTarget::DeliverInput(
