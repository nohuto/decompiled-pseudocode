/*
 * XREFs of SpatialInteractionDevices::ParseFeatureScaled_DirectX::XMFLOAT3_3_ @ 0x1800C7490
 * Callers:
 ...
 *     SpatialInteractionDevices::UpdateFeatureReportIfNeeded @ 0x1800CA438 (SpatialInteractionDevices--UpdateFeatureReportIfNeeded.c)
 ...
 *     ?HidStatus@SpatialInteractionDevices@@YAJJ@Z @ 0x1800CBB80 (-HidStatus@SpatialInteractionDevices@@YAJJ@Z.c)
 */
