/*
 * XREFs of ?GripStatusForPanelReceived@BamoHeatGripServiceStubImpl@BamoImpl@@QEAAJAEBUHeatGripReport@@@Z @ 0x18012A1FC
 * Callers:
...
LABEL_3:
  ...
  v10 = v6;
  v11 = v7;
  return CoreUICallSend(v15, v9, 2LL, 33LL, v8, &unk_1801BF237, (unsigned int)&v10);
}
