/*
 * XREFs of ?MPCInputRouter_IsTargetHolographic_@ISMTracing@@QEAAXPEAUIInputTarget@@K_K_N@Z @ 0x1800B872C
 * Callers:
        ...
        bool a5)
{
  ...
  if ( ISMTracing::IsEnabled((__int64)this) )
  {
    ...
    if ( *v10 > 5u && tlgKeywordOn(v9[1], 1LL) )
    {
      ...
      v23 = 8;
      v17 = 1;
      tlgWriteTransfer_EventWriteTransfer((__int64)v10, (unsigned __int8 *)dword_1801CAA65, 0LL, 0LL, 6u, &v15);
    }
  }
}
