/*
 * XREFs of ?Thunk_ProcessResult_116@?$IDragNDropContextualProcessorPrincipal_Receive@VBamoDragNDropContextualProcessorPrincipalImpl@BamoImpl@@@@SAJPEAXPEAPEAX@Z @ 0x1800F6050
 * Callers:
 *     <none>
 * Callees:
 *     <none>
