/*
 * XREFs of ?GiveSpatialDataToPID@BamoMPCManagerPrincipalImpl@BamoImpl@@QEAAJI@Z @ 0x1800724A4
 * Callers:
 *     ?Thunk_GiveSpatialDataToPID_25@?$IMPCManagerPrincipal_Receive@VBamoMPCManagerPrincipalImpl@BamoImpl@@@@SAJPEAXPEAPEAX@Z @ 0x180074240 (-Thunk_GiveSpatialDataToPID_25@-$IMPCManagerPrincipal_Receive@VBamoMPCManagerPrincipalImpl@BamoI.c)
 * Callees:
