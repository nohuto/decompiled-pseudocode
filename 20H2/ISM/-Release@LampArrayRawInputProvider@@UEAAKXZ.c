 ...
 *     ?Release@LampArrayRawInputProvider@@W7EAAKXZ @ 0x18004AAA0 (-Release@LampArrayRawInputProvider@@W7EAAKXZ.c)
 *     ?Release@LampArrayRawInputProvider@@WBA@EAAKXZ @ 0x18004AAB0 (-Release@LampArrayRawInputProvider@@WBA@EAAKXZ.c)
 * Callees:
 *     _guard_dispatch_icall_nop @ 0x18004A660 (_guard_dispatch_icall_nop.c)
 *     ?Shutdown@LampArrayRawInputProvider@@AEAAXXZ @ 0x18009F020 (-Shutdown@LampArrayRawInputProvider@@AEAAXXZ.c)
 */
