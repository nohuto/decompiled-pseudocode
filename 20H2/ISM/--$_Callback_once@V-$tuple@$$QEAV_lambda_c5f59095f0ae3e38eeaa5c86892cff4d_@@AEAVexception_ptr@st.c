/*
 * XREFs of ??$_Callback_once@V?$tuple@$$QEAV_lambda_c5f59095f0ae3e38eeaa5c86892cff4d_@@AEAVexception_ptr@std@@@std@@U?$integer_sequence@_K$0A@@2@$00@std@@YAHPEAX0PEAPEAX@Z @ 0x18018ACC0
 * Callers:
 *     <none>
 * Callees:
