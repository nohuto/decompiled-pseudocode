/*
 * XREFs of ?CreateSpatialPayloadDescriptor@SpatialObjectDDIClientFactoryHelper@Holographic@Internal@Windows@@UEAAJPEBX_KPEAPEAUISpatialPayloadDescriptor@234@@Z @ 0x1800D70D0
 * Callers:
 *     <none>
 * Callees:
