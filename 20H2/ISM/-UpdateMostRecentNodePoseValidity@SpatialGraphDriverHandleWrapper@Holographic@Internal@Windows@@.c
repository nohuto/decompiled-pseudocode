/*
 * XREFs of ?UpdateMostRecentNodePoseValidity@SpatialGraphDriverHandleWrapper@Holographic@Internal@Windows@@QEAAJAEBUSPATIAL_NODE_ID@@W4SPATIAL_TRACKING_VALIDITY_FLAGS@@@Z @ 0x1801667D4
 * Callers:
 ...
 *     ?InvokeNodePoseValidityChangedCallbacksAsync@SpatialGraphDriverHandleWrapper@Holographic@Internal@Windows@@AEAAXAEBV?$unique_any_t@V?$unique_storage@U?$resource_policy@PEAU_RTL_SRWLOCK@@P6AXPEAU1@@Z$1?ReleaseSRWLockExclusive@@YAX0@ZU?$integral_constant@_K$00@wistd@@PEAU1@PEAU1@$0A@$$T@details@wil@@@details@wil@@@wil@@AEBUSPATIAL_NODE_ID@@W4SPATIAL_TRACKING_VALIDITY_FLAGS@@@Z @ 0x18015FC04 (-InvokeNodePoseValidityChangedCallbacksAsync@SpatialGraphDriverHandleWrapper@Holographic@Interna.c)
 *     ?Update@NodePoseValidityCollection@Details@Holographic@Internal@Windows@@QEAA?AW4SPATIAL_TRACKING_VALIDITY_FLAGS@@AEBUSPATIAL_NODE_ID@@W46@@Z @ 0x180166734 (-Update@NodePoseValidityCollection@Details@Holographic@Internal@Windows@@QEAA-AW4SPATIAL_TRACKIN.c)
 */
