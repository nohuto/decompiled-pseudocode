/*
 * XREFs of ?ReadPoseDataFromRegistry@SpatialInteractionDevices@@YAJPEAUHKEY__@@PEAUPoseData@1@@Z @ 0x1800C68E0
 * Callers:
 ...
 * Callees:
 *     _anonymous_namespace_::ReadRegistryFloat @ 0x1800C69C0 (_anonymous_namespace_--ReadRegistryFloat.c)
 */
