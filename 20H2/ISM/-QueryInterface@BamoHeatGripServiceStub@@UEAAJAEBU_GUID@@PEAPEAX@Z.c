/*
 * XREFs of ?QueryInterface@BamoHeatGripServiceStub@@UEAAJAEBU_GUID@@PEAPEAX@Z @ 0x18012A3F0
 * Callers:
 *     ?QueryInterface@BamoHeatGripServiceStub@@W7EAAJAEBU_GUID@@PEAPEAX@Z @ 0x18004C180 (-QueryInterface@BamoHeatGripServiceStub@@W7EAAJAEBU_GUID@@PEAPEAX@Z.c)
 * Callees:
