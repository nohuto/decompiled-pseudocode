/*
 * XREFs of ?RegisterObserverClientOfType@BamoInputObserverManagerPrincipalImpl@BamoImpl@@QEAAJW4InputObserverType@InputObservation@@I@Z @ 0x1800F3D78
 * Callers:
 *     ?Thunk_RegisterObserverClientOfType_161@?$IInputObserverManagerPrincipal_Receive@VBamoInputObserverManagerPrincipalImpl@BamoImpl@@@@SAJPEAXPEAPEAX@Z @ 0x1800F4060 (-Thunk_RegisterObserverClientOfType_161@-$IInputObserverManagerPrincipal_Receive@VBamoInputObser.c)
 * Callees:
