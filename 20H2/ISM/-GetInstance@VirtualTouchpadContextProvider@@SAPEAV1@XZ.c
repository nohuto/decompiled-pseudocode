/*
 * XREFs of ?GetInstance@VirtualTouchpadContextProvider@@SAPEAV1@XZ @ 0x18014594C
 * Callers:
...
struct VirtualTouchpadContextProvider *VirtualTouchpadContextProvider::GetInstance(void)
{
  ...
  if ( dword_1802094DC > *(_DWORD *)(v1 + 16) )
  {
    Init_thread_header(&dword_1802094DC);
    if ( dword_1802094DC == -1 )
    {
      atexit(VirtualTouchpadContextProvider::GetInstance_::_2_::_dynamic_atexit_destructor_for__s_instance__);
      Init_thread_footer(&dword_1802094DC);
    }
  }
