/*
 * XREFs of ??0V2NodePropertyRequest@Holographic@Internal@Windows@@QEAA@AEAVHolographicDriverHandleWrapper@123@AEBUSPATIAL_NODE_ID@@IAEBU_GUID@@P6AJPEBX_K@Z$$QEAV?$function@$$A6AXAEAVV2NodePropertyRequest@Holographic@Internal@Windows@@J@Z@std@@@Z @ 0x180156E48
 * Callers:
