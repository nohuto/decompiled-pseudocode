/*
 * XREFs of ?SuppressInputOfType@BamoInputObserverManagerPrincipalImpl@BamoImpl@@QEAAJW4InputObserverType@InputObservation@@I@Z @ 0x1800F3EE4
 * Callers:
 *     ?Thunk_SuppressInputOfType_161@?$IInputObserverManagerPrincipal_Receive@VBamoInputObserverManagerPrincipalImpl@BamoImpl@@@@SAJPEAXPEAPEAX@Z @ 0x1800F4080 (-Thunk_SuppressInputOfType_161@-$IInputObserverManagerPrincipal_Receive@VBamoInputObserverManage.c)
 * Callees:
