/*
 * XREFs of ?get@?$static_lazy@VSpatialInteractionTraceContinuous@SpatialInteractionDevices@@@details@wil@@QEAAPEAVSpatialInteractionTraceContinuous@SpatialInteractionDevices@@P6AXXZ@Z @ 0x1800D415C
 * Callers:
...
_QWORD *__fastcall wil::details::static_lazy<SpatialInteractionDevices::SpatialInteractionTraceContinuous>::get(
        __int64 a1,
        void (__cdecl *a2)())
{
  ...
  {
    v5 = qword_180208710;
    qword_180208710[0] = &RawInputProvidersContinuousTracing::`vftable';
    qword_180208728 = (struct _tlgProvider_t *)&`SpatialInteractionDevices::SpatialInteractionTraceContinuous::StaticHandle::StaticHandle'::`2'::__hInner;
    atexit(a2);
    wil::TraceLoggingProvider::Register((wil::TraceLoggingProvider *)qword_180208710, qword_180208728, 0LL);
    InitOnceComplete(
      &`SpatialInteractionDevices::SpatialInteractionTraceContinuous::Instance'::`2'::wrapper,
      0,
      qword_180208710);
