/*
 * XREFs of ??0QpcTimeConverter@@QEAA@XZ @ 0x180034504
 * Callers:
 *     _dynamic_initializer_for__GameControllerRawInputProvider::s_qpcTime__ @ 0x1800016B0 (_dynamic_initializer_for__GameControllerRawInputProvider--s_qpcTime__.c)
 ...
 *     ??0DeviceState@MagnifierProcessor@@QEAA@XZ @ 0x18017C7F4 (--0DeviceState@MagnifierProcessor@@QEAA@XZ.c)
 * Callees:
 *     <none>
 */
