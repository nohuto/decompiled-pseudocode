/*
 * XREFs of ?GetCurrentTimeMicroseconds@SimpleTimeProvider@HapticsEngine@SpatialInteractions@Internal@Windows@@UEAAJPEA_J@Z @ 0x18016C4F0
 * Callers:
 *     <none>
 * Callees:
 *     <none>
        ...
        __int64 *a2)
{
  ...
  *a2 = 1000000 * PerformanceCount.QuadPart / qword_180208308;
  return 0LL;
}
