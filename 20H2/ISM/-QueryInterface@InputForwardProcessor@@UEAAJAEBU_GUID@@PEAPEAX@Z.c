/*
 * XREFs of ?QueryInterface@InputForwardProcessor@@UEAAJAEBU_GUID@@PEAPEAX@Z @ 0x180176C40
 * Callers:
 *     ?QueryInterface@InputForwardProcessor@@W7EAAJAEBU_GUID@@PEAPEAX@Z @ 0x18004CD40 (-QueryInterface@InputForwardProcessor@@W7EAAJAEBU_GUID@@PEAPEAX@Z.c)
 * Callees:
