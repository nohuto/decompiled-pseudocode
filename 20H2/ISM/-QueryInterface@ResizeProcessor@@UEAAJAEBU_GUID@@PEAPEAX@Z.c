/*
 * XREFs of ?QueryInterface@ResizeProcessor@@UEAAJAEBU_GUID@@PEAPEAX@Z @ 0x1800FE520
 * Callers:
 *     ?QueryInterface@ResizeProcessor@@W7EAAJAEBU_GUID@@PEAPEAX@Z @ 0x18004B4B0 (-QueryInterface@ResizeProcessor@@W7EAAJAEBU_GUID@@PEAPEAX@Z.c)
 * Callees:
