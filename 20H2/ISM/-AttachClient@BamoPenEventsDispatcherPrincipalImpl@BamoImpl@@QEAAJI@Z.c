/*
 * XREFs of ?AttachClient@BamoPenEventsDispatcherPrincipalImpl@BamoImpl@@QEAAJI@Z @ 0x18013265C
 * Callers:
 *     ?Thunk_AttachClient_10@?$IPenEventsDispatcherPrincipal_Receive@VBamoPenEventsDispatcherPrincipalImpl@BamoImpl@@@@SAJPEAXPEAPEAX@Z @ 0x180134820 (-Thunk_AttachClient_10@-$IPenEventsDispatcherPrincipal_Receive@VBamoPenEventsDispatcherPrincipal.c)
 * Callees:
