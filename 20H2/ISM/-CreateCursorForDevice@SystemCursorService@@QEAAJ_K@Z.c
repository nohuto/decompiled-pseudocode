/*
 * XREFs of ?CreateCursorForDevice@SystemCursorService@@QEAAJ_K@Z @ 0x18013EB5C
 * Callers:
 ...
 *     ?shared_from_this@?$enable_shared_from_this@VSystemCursorService@@@std@@QEAA?AV?$shared_ptr@VSystemCursorService@@@2@XZ @ 0x1800484F8 (-shared_from_this@-$enable_shared_from_this@VSystemCursorService@@@std@@QEAA-AV-$shared_ptr@VSys.c)
 ...
 *     ?lock@?$weak_ptr@VSystemCursor@@@std@@QEBA?AV?$shared_ptr@VSystemCursor@@@2@XZ @ 0x18013D454 (-lock@-$weak_ptr@VSystemCursor@@@std@@QEBA-AV-$shared_ptr@VSystemCursor@@@2@XZ.c)
 *     ??$make_shared@VSystemCursor@@V?$shared_ptr@VSystemCursorService@@@std@@AEA_K@std@@YA?AV?$shared_ptr@VSystemCursor@@@0@$$QEAV?$shared_ptr@VSystemCursorService@@@0@AEA_K@Z @ 0x18013DE70 (--$make_shared@VSystemCursor@@V-$shared_ptr@VSystemCursorService@@@std@@AEA_K@std@@YA-AV-$shared.c)
