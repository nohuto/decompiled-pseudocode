/*
 * XREFs of ?Remove@Edges@@QEAAJPEBUEdgyCompositionConfigurationUpdateEx@@@Z @ 0x1801796CC
 * Callers:
 ...
 *     ?IsClientPresent@Edge@@QEBA_NW4EdgyClient@@@Z @ 0x1801791BC (-IsClientPresent@Edge@@QEBA_NW4EdgyClient@@@Z.c)
