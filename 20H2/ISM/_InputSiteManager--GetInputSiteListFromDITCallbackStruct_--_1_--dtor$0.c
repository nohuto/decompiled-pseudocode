/*
 * XREFs of _InputSiteManager::GetInputSiteListFromDITCallbackStruct_::_1_::dtor$0 @ 0x18004F6F0
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall InputSiteManager::GetInputSiteListFromDITCallbackStruct_::_1_::dtor_0(
        __int64 a1,
        __int64 a2,
        __int64 a3)
{
