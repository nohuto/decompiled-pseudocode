/*
 * XREFs of ?SendMaterializeProxy@BamoActivatableEntityPrincipalImpl@BamoImpl@@UEAAXPEAUIMessageCallSendHost@@PEAVBamoStubImpl@2Microsoft@@@Z @ 0x180006CA0
 * Callers:
 *     <none>
 * Callees:
        ...
        struct Microsoft::BamoImpl::BamoStubImpl *a3)
{
  ...
  v8 = CoreUICallSend(a2, &v58, 2LL, 74LL, 1, &unk_1801BF1AA, v57);
  if ( v8 < 0 )
  {
  ...
  if ( *(_QWORD *)(*(_QWORD *)(*((_QWORD *)this + 2) + 32LL) + 56LL) )
  {
    ...
    LOWORD(v55) = 0;
    v59 = v11;
    v14 = CoreUICallSend(SendHost, &v58, 2LL, 1LL, v55, &unk_1801BF1A2, v10);
  ...
  if ( *(_QWORD *)(*(_QWORD *)(*((_QWORD *)this + 2) + 32LL) + 56LL) )
  {
    ...
    LOWORD(v55) = 1;
    v59 = v17;
    v20 = CoreUICallSend(v19, &v58, 2LL, 1LL, v55, &unk_1801BF1A2, v16);
  ...
  if ( *(_QWORD *)(*(_QWORD *)(*((_QWORD *)this + 2) + 32LL) + 56LL) )
  {
    ...
    v59 = v23;
    LOWORD(v55) = 2;
    v26 = CoreUICallSend(v25, &v58, 2LL, 1LL, v55, &unk_1801BF1A5, (unsigned int)&v61);
  ...
  if ( *(_QWORD *)(*(_QWORD *)(*((_QWORD *)this + 2) + 32LL) + 56LL) )
  {
    ...
    v58 = v30;
    LOWORD(v55) = 3;
    v32 = CoreUICallSend(v31, &v58, 2LL, 1LL, v55, &unk_1801BF1AA, v28);
  ...
  if ( *(_QWORD *)(*(_QWORD *)(*((_QWORD *)this + 2) + 32LL) + 56LL) )
  {
    ...
    v58 = v36;
    LOWORD(v55) = 4;
    v38 = CoreUICallSend(v37, &v58, 2LL, 1LL, v55, &unk_1801BF1AA, v34);
  ...
  if ( *(_QWORD *)(*(_QWORD *)(*((_QWORD *)this + 2) + 32LL) + 56LL) )
  {
    ...
    LOWORD(v55) = 5;
    v59 = v41;
    v44 = CoreUICallSend(v43, &v58, 2LL, 1LL, v55, &unk_1801BF1AD, v40);
  ...
  v59 = *(unsigned int *)(v3 + 40);
  LOWORD(v55) = 55;
  v48 = CoreUICallSend(a2, &v58, 2LL, 74LL, v55, &unk_1801BF1AA, v47);
  if ( v48 < 0 )
  {
    wil::details::in1diag3::FailFast_Hr(
      retaddr,
