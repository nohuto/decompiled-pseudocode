/*
 * XREFs of ?Initialize3DComponents@MPCGamepadProcessor@@UEAAXXZ @ 0x1801922A0
 * Callers:
 *     <none>
 * Callees:
 ...
 *     ??$make_unique@VMPCSlateDeadzoneHelper@@MM$0A@@std@@YA?AV?$unique_ptr@VMPCSlateDeadzoneHelper@@U?$default_delete@VMPCSlateDeadzoneHelper@@@std@@@0@$$QEAM0@Z @ 0x18007CE20 (--$make_unique@VMPCSlateDeadzoneHelper@@MM$0A@@std@@YA-AV-$unique_ptr@VMPCSlateDeadzoneHelper@@U.c)
...
void __fastcall MPCGamepadProcessor::Initialize3DComponents(MPCGamepadProcessor *this)
{
  ...
  v3 = std::make_unique<MPCButtonHoldHelper,float,0>(&v15, flt_1801C5ED4);
  ...
  v5 = std::make_unique<MPCButtonHoldHelper,float,0>(&v15, flt_1801C5ED4);
