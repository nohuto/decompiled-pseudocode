/*
 * XREFs of ?TriggerHomeGesture@BamoMPCManagerPrincipalImpl@BamoImpl@@QEAAJW4InputType@@I@Z @ 0x18003F8B8
 * Callers:
 *     ?Thunk_TriggerHomeGesture_21@?$IMPCManagerPrincipal_Receive@VBamoMPCManagerPrincipalImpl@BamoImpl@@@@SAJPEAXPEAPEAX@Z @ 0x18003F8A0 (-Thunk_TriggerHomeGesture_21@-$IMPCManagerPrincipal_Receive@VBamoMPCManagerPrincipalImpl@BamoImp.c)
 * Callees:
 ...
 *     ?GetCurrentCaller@BamoPrincipalImpl@BamoImpl@Microsoft@@IEAAPEAVBamoStubImpl@23@XZ @ 0x18006EDAC (-GetCurrentCaller@BamoPrincipalImpl@BamoImpl@Microsoft@@IEAAPEAVBamoStubImpl@23@XZ.c)
 */
