/*
 * XREFs of ?AddInputType@MPCConstantManager@@QEAAXPEAUIMPCInputProviderBase@@@Z @ 0x18006DEEC
 * Callers:
 ...
 * Callees:
 *     ?CheckTypeExistence@MPCConstantManager@@QEAA_NW4InputType@@@Z @ 0x1800364F4 (-CheckTypeExistence@MPCConstantManager@@QEAA_NW4InputType@@@Z.c)
