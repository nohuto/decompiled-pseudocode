/*
 * XREFs of ??_GDWMFocusedInputTarget@@MEAAPEAXI@Z @ 0x18001B694
 * Callers:
 *     ??_EDWMFocusedInputTarget@@OCI@EAAPEAXI@Z @ 0x18004C470 (--_EDWMFocusedInputTarget@@OCI@EAAPEAXI@Z.c)
 * Callees:
 ...
 *     ??1DWMFocusedInputTarget@@MEAA@XZ @ 0x18001B6DC (--1DWMFocusedInputTarget@@MEAA@XZ.c)
 */
