/*
 * XREFs of ?RegisterControllerClient@EdgyConnection@@QEAAJPEBGPEAVEdgyControllerClientProxy@@@Z @ 0x18017777C
 * Callers:
 ...
 *     ?GetType@BamoDragSourceClientProxy@@UEAAAEBU_GUID@@XZ @ 0x1800E5E80 (-GetType@BamoDragSourceClientProxy@@UEAAAEBU_GUID@@XZ.c)
