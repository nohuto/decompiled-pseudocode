/*
 * XREFs of ?StartDrag@BamoDragNDropContextualProcessorPrincipalImpl@BamoImpl@@QEAAJI_KI@Z @ 0x1800F5EC4
 * Callers:
 *     ?Thunk_StartDrag_107@?$IDragNDropContextualProcessorPrincipal_Receive@VBamoDragNDropContextualProcessorPrincipalImpl@BamoImpl@@@@SAJPEAXPEAPEAX@Z @ 0x1800F6090 (-Thunk_StartDrag_107@-$IDragNDropContextualProcessorPrincipal_Receive@VBamoDragNDropContextualPr.c)
 * Callees:
