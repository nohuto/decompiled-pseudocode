/*
 * XREFs of ?GetInputForwardAreaInputObject@BamoInputSiteElementProxy@@UEAAPEAVBamoInputForwardAreaInputObjectProxy@@XZ @ 0x180010AF0
 * Callers:
 *     <none>
 * Callees:
        ...
        BamoInputSiteElementProxy *this)
{
  ...
  if ( *(_DWORD *)(v2 + 168) != CurrentThreadId && *(_DWORD *)(v2 + 24) != CurrentThreadId )
  {
    wil::details::in1diag3::_FailFast_Unexpected(
      ...
      v4);
    JUMPOUT(0x180055EE6LL);
  }
  return (struct BamoInputForwardAreaInputObjectProxy *)*((_QWORD *)this + 18);
}
