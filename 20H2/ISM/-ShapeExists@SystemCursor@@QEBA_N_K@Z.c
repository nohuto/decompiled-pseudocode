/*
 * XREFs of ?ShapeExists@SystemCursor@@QEBA_N_K@Z @ 0x18013CD20
 * Callers:
 ...
 *     ?GetAndValidateDefaultShapeId@SystemCursor@@QEAA_KXZ @ 0x18013F9F0 (-GetAndValidateDefaultShapeId@SystemCursor@@QEAA_KXZ.c)
