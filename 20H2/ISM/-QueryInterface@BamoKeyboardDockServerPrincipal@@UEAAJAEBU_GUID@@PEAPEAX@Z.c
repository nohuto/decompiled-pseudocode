/*
 * XREFs of ?QueryInterface@BamoKeyboardDockServerPrincipal@@UEAAJAEBU_GUID@@PEAPEAX@Z @ 0x180127040
 * Callers:
 *     ?QueryInterface@BamoKeyboardDockServerPrincipal@@W7EAAJAEBU_GUID@@PEAPEAX@Z @ 0x18004C140 (-QueryInterface@BamoKeyboardDockServerPrincipal@@W7EAAJAEBU_GUID@@PEAPEAX@Z.c)
 * Callees:
