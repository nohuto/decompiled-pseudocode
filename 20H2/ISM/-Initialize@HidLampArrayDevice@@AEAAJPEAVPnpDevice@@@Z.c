/*
 * XREFs of ?Initialize@HidLampArrayDevice@@AEAAJPEAVPnpDevice@@@Z @ 0x1800A6D0C
 * Callers:
 ...
 *     ?KeyboardHidUsageToVKey@HidUsageConverter@@SAIG@Z @ 0x1800A96D0 (-KeyboardHidUsageToVKey@HidUsageConverter@@SAIG@Z.c)
 */
