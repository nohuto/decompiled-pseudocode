/*
 * XREFs of ?GetPoseAtTime_NotEnoughPosesToInterpolate_@HolographicDriverClientContinuousTrace@@QEAAXXZ @ 0x18015DDC8
 * Callers:
        ...
        HolographicDriverClientContinuousTrace *this)
{
  ...
  if ( HolographicDriverClientContinuousTrace::IsVerboseTracingEnabled((unsigned __int64)this) )
  {
    ...
    if ( **(_DWORD **)(v2 + 8) > 5u && tlgKeywordOn(*(_QWORD *)(v2 + 8), 0x800000LL) )
    {
      ...
      v4 = 0x1000000LL;
      v7 = 8;
      tlgWriteTransfer_EventWriteTransfer(v3, (unsigned __int8 *)dword_1801CFC84, 0LL, 0LL, 3u, &v5);
    }
  }
}
