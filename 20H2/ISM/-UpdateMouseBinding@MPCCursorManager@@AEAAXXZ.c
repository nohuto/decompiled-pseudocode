/*
 * XREFs of ?UpdateMouseBinding@MPCCursorManager@@AEAAXXZ @ 0x18007C578
 * Callers:
 *     ?UpdateState@MPCCursorManager@@QEAAXXZ @ 0x18007C694 (-UpdateState@MPCCursorManager@@QEAAXXZ.c)
 * Callees:
