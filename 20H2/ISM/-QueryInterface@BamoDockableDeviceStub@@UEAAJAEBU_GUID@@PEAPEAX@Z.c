/*
 * XREFs of ?QueryInterface@BamoDockableDeviceStub@@UEAAJAEBU_GUID@@PEAPEAX@Z @ 0x180126FB0
 * Callers:
 *     ?QueryInterface@BamoDockableDeviceStub@@W7EAAJAEBU_GUID@@PEAPEAX@Z @ 0x18004C130 (-QueryInterface@BamoDockableDeviceStub@@W7EAAJAEBU_GUID@@PEAPEAX@Z.c)
 * Callees:
