/*
 * XREFs of ?StartResize@ResizeProcessor@@QEAAJKPEAVBamoResizeControllerClientProxy@@@Z @ 0x1800FEF6C
 * Callers:
 *     ?StartResize@ResizeControllerHost@@MEAAJPEAVBamoResizeContextualProcessorStub@@IPEAVBamoResizeControllerClientProxy@@@Z @ 0x1800FCD20 (-StartResize@ResizeControllerHost@@MEAAJPEAVBamoResizeContextualProcessorStub@@IPEAVBamoResizeCo.c)
 * Callees:
 ...
 *     ??B?$ComPtr@VInputSite@@@WRL@Microsoft@@QEBAPEQBoolStruct@Details@12@HXZ @ 0x18004414C (--B-$ComPtr@VInputSite@@@WRL@Microsoft@@QEBAPEQBoolStruct@Details@12@HXZ.c)
