/*
 * XREFs of ??1KeyboardInjectionDevice@@QEAA@XZ @ 0x18011F7D4
 * Callers:
 *     _ControllerProcessor::ControllerProcessor_::_1_::dtor$8 @ 0x18011F4D7 (_ControllerProcessor--ControllerProcessor_--_1_--dtor$8.c)
 * Callees:
