/*
 * XREFs of ?CancelDrag@BamoDragNDropContextualProcessorPrincipalImpl@BamoImpl@@QEAAJII@Z @ 0x1800F58F4
 * Callers:
 *     ?Thunk_CancelDrag_112@?$IDragNDropContextualProcessorPrincipal_Receive@VBamoDragNDropContextualProcessorPrincipalImpl@BamoImpl@@@@SAJPEAXPEAPEAX@Z @ 0x1800F6030 (-Thunk_CancelDrag_112@-$IDragNDropContextualProcessorPrincipal_Receive@VBamoDragNDropContextualP.c)
 * Callees:
