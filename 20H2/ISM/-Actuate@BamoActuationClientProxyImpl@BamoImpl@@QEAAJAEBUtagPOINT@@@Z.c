/*
 * XREFs of ?Actuate@BamoActuationClientProxyImpl@BamoImpl@@QEAAJAEBUtagPOINT@@@Z @ 0x1800E2BBC
 * Callers:
        ...
        const struct tagPOINT *a2)
{
  ...
  if ( *(_QWORD *)(*(_QWORD *)(*(_QWORD *)(*((_QWORD *)this + 2) + 24LL) + 32LL) + 56LL) )
  {
    ...
    if ( v5 >= 0 )
    {
      ...
      v9[0] = v11;
      v9[1] = v12;
      return CoreUICallSend(v7, v9, 2LL, 8LL, 0, &unk_1801BF1B3, (unsigned int)&v13);
    }
    else
    {
