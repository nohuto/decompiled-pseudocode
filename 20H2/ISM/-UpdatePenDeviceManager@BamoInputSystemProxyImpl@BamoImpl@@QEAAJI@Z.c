/*
 * XREFs of ?UpdatePenDeviceManager@BamoInputSystemProxyImpl@BamoImpl@@QEAAJI@Z @ 0x1800EEE78
 * Callers:
 ...
 *     ?Thunk_UpdatePenDeviceManager_10@?$IInputSystemProxy_Receive@VBamoInputSystemProxyImpl@BamoImpl@@@@SAJPEAXPEAPEAX@Z @ 0x1800ECF60 (-Thunk_UpdatePenDeviceManager_10@-$IInputSystemProxy_Receive@VBamoInputSystemProxyImpl@BamoImpl@.c)
 * Callees:
