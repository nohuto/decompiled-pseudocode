/*
 * XREFs of ??1?$unique_ptr@VMPCSpatialGestureRecognizerHandler@@U?$default_delete@VMPCSpatialGestureRecognizerHandler@@@std@@@std@@QEAA@XZ @ 0x18007A710
 * Callers:
 *     _MPCGestureHandler::MPCGestureHandler_::_1_::dtor$4 @ 0x18007A5C5 (_MPCGestureHandler--MPCGestureHandler_--_1_--dtor$4.c)
 *     _MPCHandProcessor::MPCHandProcessor_::_1_::dtor$3 @ 0x18007D0AF (_MPCHandProcessor--MPCHandProcessor_--_1_--dtor$3.c)
 * Callees:
