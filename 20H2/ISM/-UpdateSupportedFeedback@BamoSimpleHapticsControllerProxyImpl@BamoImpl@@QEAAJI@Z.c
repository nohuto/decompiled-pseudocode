/*
 * XREFs of ?UpdateSupportedFeedback@BamoSimpleHapticsControllerProxyImpl@BamoImpl@@QEAAJI@Z @ 0x1800EF4F8
 * Callers:
 *     ?UpdateStateOfProxyOnPlaceholderProxyHookUp@BamoSimpleHapticsControllerProxyImpl@BamoImpl@@UEAAXPEAVBamoProxyImpl@2Microsoft@@@Z @ 0x180043B80 (-UpdateStateOfProxyOnPlaceholderProxyHookUp@BamoSimpleHapticsControllerProxyImpl@BamoImpl@@UEAAX.c)
 *     ?Thunk_UpdateSupportedFeedback_10@?$ISimpleHapticsControllerProxy_Receive@VBamoSimpleHapticsControllerProxyImpl@BamoImpl@@@@SAJPEAXPEAPEAX@Z @ 0x1800ED020 (-Thunk_UpdateSupportedFeedback_10@-$ISimpleHapticsControllerProxy_Receive@VBamoSimpleHapticsCont.c)
 * Callees:
