/*
 * XREFs of ?UpdateState@MPCButtonHoldHelper@@QEAAX_N_K@Z @ 0x180084F20
 * Callers:
 ...
 * Callees:
 *     ?ResetState@MPCButtonHoldHelper@@QEAAXXZ @ 0x180084F04 (-ResetState@MPCButtonHoldHelper@@QEAAXXZ.c)
 */
