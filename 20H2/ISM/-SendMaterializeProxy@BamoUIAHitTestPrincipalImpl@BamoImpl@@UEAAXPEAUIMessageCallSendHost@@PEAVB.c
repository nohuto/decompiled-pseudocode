/*
 * XREFs of ?SendMaterializeProxy@BamoUIAHitTestPrincipalImpl@BamoImpl@@UEAAXPEAUIMessageCallSendHost@@PEAVBamoStubImpl@2Microsoft@@@Z @ 0x18000DCE0
 * Callers:
 *     <none>
 * Callees:
        ...
        struct Microsoft::BamoImpl::BamoStubImpl *a3)
{
  ...
  v8 = CoreUICallSend(a2, &v16, 2LL, 74LL, 49, &unk_1801BF1AA, v14);
  if ( v8 < 0 )
  {
