/*
 * XREFs of ?Create@ViewMenuChordedKeyHandler@@SAJP6AJPEAXAEAV?$vector@U?$pair@G_N@std@@V?$allocator@U?$pair@G_N@std@@@2@@std@@_N@Z0AEBV23@PEAPEAV1@@Z @ 0x180124624
 * Callers:
 ...
 *     ??0ViewMenuChordedKeyHandler@@IEAA@XZ @ 0x1801240F4 (--0ViewMenuChordedKeyHandler@@IEAA@XZ.c)
