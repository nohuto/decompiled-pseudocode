/*
 * XREFs of ??1?$vector@V?$com_ptr_t@UIHeadEventHandler@@Uerr_exception_policy@wil@@@wil@@V?$allocator@V?$com_ptr_t@UIHeadEventHandler@@Uerr_exception_policy@wil@@@wil@@@std@@@std@@QEAA@XZ @ 0x18007A730
 * Callers:
 *     _MPCGestureHandler::MPCGestureHandler_::_1_::dtor$5 @ 0x18007A5D8 (_MPCGestureHandler--MPCGestureHandler_--_1_--dtor$5.c)
 *     _MPCHeadUpdateListener::OnHeadEventOccurredWorkerThread_::_1_::dtor$1 @ 0x18008D7F2 (_MPCHeadUpdateListener--OnHeadEventOccurredWorkerThread_--_1_--dtor$1.c)
 * Callees:
