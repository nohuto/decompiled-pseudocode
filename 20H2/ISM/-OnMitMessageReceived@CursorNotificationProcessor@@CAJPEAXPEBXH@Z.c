/*
 * XREFs of ?OnMitMessageReceived@CursorNotificationProcessor@@CAJPEAXPEBXH@Z @ 0x18001AD90
 * Callers:
 *     <none>
 * Callees:
 ...
 *     ?IsTimestampNewest@CursorNotificationProcessor@@QEAA_N_J@Z @ 0x18003AFA0 (-IsTimestampNewest@CursorNotificationProcessor@@QEAA_N_J@Z.c)
