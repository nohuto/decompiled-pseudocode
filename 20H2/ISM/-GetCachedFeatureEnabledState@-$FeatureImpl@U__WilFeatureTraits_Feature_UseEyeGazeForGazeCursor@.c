/*
 * XREFs of ?GetCachedFeatureEnabledState@?$FeatureImpl@U__WilFeatureTraits_Feature_UseEyeGazeForGazeCursor@@@details@wil@@AEAA?ATwil_details_FeatureStateCache@@XZ @ 0x18003FE04
 * Callers:
