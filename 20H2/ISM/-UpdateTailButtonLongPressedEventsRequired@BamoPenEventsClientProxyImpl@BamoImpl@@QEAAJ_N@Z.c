/*
 * XREFs of ?UpdateTailButtonLongPressedEventsRequired@BamoPenEventsClientProxyImpl@BamoImpl@@QEAAJ_N@Z @ 0x180134CA0
 * Callers:
 ...
 *     ?Thunk_UpdateTailButtonLongPressedEventsRequired_13@?$IPenEventsClientProxy_Receive@VBamoPenEventsClientProxyImpl@BamoImpl@@@@SAJPEAXPEAPEAX@Z @ 0x180134890 (-Thunk_UpdateTailButtonLongPressedEventsRequired_13@-$IPenEventsClientProxy_Receive@VBamoPenEven.c)
 * Callees:
