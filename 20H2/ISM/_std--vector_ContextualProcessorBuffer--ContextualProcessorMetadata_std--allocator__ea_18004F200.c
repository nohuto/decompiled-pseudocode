/*
 * XREFs of _std::vector_ContextualProcessorBuffer::ContextualProcessorMetadata_std::allocator_ContextualProcessorBuffer::ContextualProcessorMetadata___::_Emplace_reallocate_ContextualProcessorBuffer::ContextualProcessorMetadata_const_&__::_1_::catch$213 @ 0x18004F200
 * Callers:
 *     <none>
 * Callees:
 ...
 *     ?deallocate@?$allocator@UContextualProcessorMetadata@ContextualProcessorBuffer@@@std@@QEAAXQEAUContextualProcessorMetadata@ContextualProcessorBuffer@@_K@Z @ 0x18014DB2C (-deallocate@-$allocator@UContextualProcessorMetadata@ContextualProcessorBuffer@@@std@@QEAAXQEAUC.c)
 */
