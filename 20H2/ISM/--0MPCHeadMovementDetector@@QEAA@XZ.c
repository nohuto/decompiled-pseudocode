/*
 * XREFs of ??0MPCHeadMovementDetector@@QEAA@XZ @ 0x18008BC70
 * Callers:
 ...
 *     ?ScheduleNextTimerCallback@MPCHeadMovementDetector@@AEAAXXZ @ 0x18008C874 (-ScheduleNextTimerCallback@MPCHeadMovementDetector@@AEAAXXZ.c)
