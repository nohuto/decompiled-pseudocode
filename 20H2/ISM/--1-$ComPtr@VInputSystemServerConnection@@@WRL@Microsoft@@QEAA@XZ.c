/*
 * XREFs of ??1?$ComPtr@VInputSystemServerConnection@@@WRL@Microsoft@@QEAA@XZ @ 0x1800BBAAC
 * Callers:
 *     _InputSystemServerConnection::Create_::_1_::dtor$2 @ 0x180050DEC (_InputSystemServerConnection--Create_--_1_--dtor$2.c)
 * Callees:
