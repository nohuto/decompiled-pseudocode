/*
 * XREFs of ?CreateCursorForDevice@BamoSystemCursorControllerProxy@@UEAAJ_K@Z @ 0x1800E3700
 * Callers:
 *     <none>
 * Callees:
        ...
        unsigned __int64 a2)
{
  ...
  LODWORD(v3) = BamoImpl::BamoSystemCursorControllerProxyImpl::CreateCursorForDevice(
