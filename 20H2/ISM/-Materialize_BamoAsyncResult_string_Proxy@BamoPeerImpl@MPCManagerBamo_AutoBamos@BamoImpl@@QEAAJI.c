/*
 * XREFs of ?Materialize_BamoAsyncResult_string_Proxy@BamoPeerImpl@MPCManagerBamo_AutoBamos@BamoImpl@@QEAAJI@Z @ 0x1800729F4
 * Callers:
 *     ?Thunk_Materialize_BamoAsyncResult_string_Proxy_11@?$IBamoPeer_MPCManagerBamo_AutoBamos_Receive@VBamoPeerImpl@MPCManagerBamo_AutoBamos@BamoImpl@@@@SAJPEAXPEAPEAX@Z @ 0x180074330 (-Thunk_Materialize_BamoAsyncResult_string_Proxy_11@-$IBamoPeer_MPCManagerBamo_AutoBamos_Receive@.c)
 * Callees:
