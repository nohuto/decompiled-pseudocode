...
void __fastcall __noreturn std::_Hash_std::_Umap_traits_DWMPointerMapping_CursorId_std::_Uhash_compare_DWMPointerMapping_DWMMappingHash_std::equal_to_DWMPointerMapping____std::allocator_std::pair_DWMPointerMapping_const__CursorId____0___::_Insert_unverified_std::pair_DWMPointerMapping_const__CursorId__std::_List_unchecked_iterator_std::_List_val_std::_List_simple_types_std::pair_DWMPointerMapping_const__CursorId__________::_1_::catch_70(
        __int64 a1,
        __int64 a2)
{
  std::list<std::pair<unsigned long const,tagPOINTF>>::erase(*(_QWORD *)(a2 + 80) + 8LL, a2 + 80, *(_QWORD *)(a2 + 104));
  throw;
}
