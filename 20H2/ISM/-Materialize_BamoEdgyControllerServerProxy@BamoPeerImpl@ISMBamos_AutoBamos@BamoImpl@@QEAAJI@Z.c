/*
 * XREFs of ?Materialize_BamoEdgyControllerServerProxy@BamoPeerImpl@ISMBamos_AutoBamos@BamoImpl@@QEAAJI@Z @ 0x1800E71E8
 * Callers:
 *     ?Thunk_Materialize_BamoEdgyControllerServerProxy_10@?$IBamoPeer_ISMBamos_AutoBamos_Receive@VBamoPeerImpl@ISMBamos_AutoBamos@BamoImpl@@@@SAJPEAXPEAPEAX@Z @ 0x1800ECA90 (-Thunk_Materialize_BamoEdgyControllerServerProxy_10@-$IBamoPeer_ISMBamos_AutoBamos_Receive@VBamo.c)
 * Callees:
