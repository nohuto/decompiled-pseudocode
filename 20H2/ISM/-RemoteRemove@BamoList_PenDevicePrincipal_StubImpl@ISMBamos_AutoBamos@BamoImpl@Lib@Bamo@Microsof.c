/*
 * XREFs of ?RemoteRemove@BamoList_PenDevicePrincipal_StubImpl@ISMBamos_AutoBamos@BamoImpl@Lib@Bamo@Microsoft@@QEAAJI@Z @ 0x18012FBFC
 * Callers:
...
LABEL_3:
  ...
  v7[1] = v10;
  v6 = 1;
  return CoreUICallSend(v11, v7, 2LL, 72LL, v6, &unk_1801BF1AA, a2);
}
