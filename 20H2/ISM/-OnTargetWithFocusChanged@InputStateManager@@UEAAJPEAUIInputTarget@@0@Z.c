/*
 * XREFs of ?OnTargetWithFocusChanged@InputStateManager@@UEAAJPEAUIInputTarget@@0@Z @ 0x1800193C0
 * Callers:
 *     <none>
 * Callees:
...
LABEL_31:
      if ( v33 == v35 )
      {
        ...
        if ( v37 && *v37 > 1u )
        {
          ...
          {
            tlgWriteTransfer_EventWriteTransfer(v38, (int)&dword_1801CE004, 0, 0, 2u, &v60);
          }
        }
        v39 = *(_QWORD **)(v13 + 72);
