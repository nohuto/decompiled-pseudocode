/*
 * XREFs of ?BeginInitialize@SpatialInteractionSourceController@SpatialInteractions@Internal@Windows@@UEAAJXZ @ 0x18016A720
 * Callers:
 *     <none>
 * Callees:
 ...
 *     ?GetTicks@PerfCounter@@YA_JXZ @ 0x18007D9BC (-GetTicks@PerfCounter@@YA_JXZ.c)
 ...
 *     ??B_Atomic_llong@std@@QEBA_JXZ @ 0x180169E08 (--B_Atomic_llong@std@@QEBA_JXZ.c)
 */
