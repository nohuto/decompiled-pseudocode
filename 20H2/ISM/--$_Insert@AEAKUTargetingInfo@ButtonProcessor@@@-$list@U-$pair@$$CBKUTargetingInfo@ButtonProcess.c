/*
 * XREFs of ??$_Insert@AEAKUTargetingInfo@ButtonProcessor@@@?$list@U?$pair@$$CBKUTargetingInfo@ButtonProcessor@@@std@@V?$allocator@U?$pair@$$CBKUTargetingInfo@ButtonProcessor@@@std@@@2@@std@@QEAAXV?$_List_unchecked_const_iterator@V?$_List_val@U?$_List_simple_types@U?$pair@$$CBKUTargetingInfo@ButtonProcessor@@@std@@@std@@@std@@U_Iterator_base0@2@@1@AEAK$$QEAUTargetingInfo@ButtonProcessor@@@Z @ 0x180049A58
 * Callers:
 *     ??$emplace@AEAKUTargetingInfo@ButtonProcessor@@@?$_Hash@V?$_Umap_traits@KUTargetingInfo@ButtonProcessor@@V?$_Uhash_compare@KU?$hash@K@std@@U?$equal_to@K@2@@std@@V?$allocator@U?$pair@$$CBKUTargetingInfo@ButtonProcessor@@@std@@@4@$0A@@std@@@std@@QEAA?AU?$pair@V?$_List_iterator@V?$_List_val@U?$_List_simple_types@U?$pair@$$CBKUTargetingInfo@ButtonProcessor@@@std@@@std@@@std@@@std@@_N@1@AEAK$$QEAUTargetingInfo@ButtonProcessor@@@Z @ 0x180049CD0 (--$emplace@AEAKUTargetingInfo@ButtonProcessor@@@-$_Hash@V-$_Umap_traits@KUTargetingInfo@ButtonPr.c)
 * Callees:
...
_QWORD *__fastcall std::list<std::pair<unsigned long const,ButtonProcessor::TargetingInfo>>::_Insert<unsigned long &,ButtonProcessor::TargetingInfo>(
        __int64 a1,
        __int64 a2,
        _DWORD *a3,
        _QWORD *a4)
