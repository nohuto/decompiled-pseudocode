/*
 * XREFs of ?SetTimestampsFromInput@GameControllerRawInputProvider@@AEAAX_KPEAUInputInfo@@@Z @ 0x180088FF4
 * Callers:
        ...
        struct InputInfo *a3)
{
  ...
  *((_DWORD *)a3 + 2) = v8;
  ...
  if ( GameControllerRawInputProvider::s_qpcTime )
    v10 = GameControllerRawInputProvider::s_qpcTime * (a2 / qword_1802087F0)
        + GameControllerRawInputProvider::s_qpcTime * (a2 % qword_1802087F0) / qword_1802087F0;
  *((_QWORD *)a3 + 2) = v10;
}
