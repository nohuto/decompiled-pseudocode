 ...
 *     ??0NodePropertyChangedHandler@SpatialInteractions@Internal@Windows@@QEAA@XZ @ 0x180169488 (--0NodePropertyChangedHandler@SpatialInteractions@Internal@Windows@@QEAA@XZ.c)
