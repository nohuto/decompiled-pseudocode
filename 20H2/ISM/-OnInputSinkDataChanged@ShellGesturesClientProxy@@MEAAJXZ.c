/*
 * XREFs of ?OnInputSinkDataChanged@ShellGesturesClientProxy@@MEAAJXZ @ 0x180101100
 * Callers:
 *     ?OnConnected@ShellGesturesClientProxy@@MEAAJXZ @ 0x1800458D0 (-OnConnected@ShellGesturesClientProxy@@MEAAJXZ.c)
 * Callees:
