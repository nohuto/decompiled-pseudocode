/*
 * XREFs of ?MPCHandProcessor_UseGazeForTargetingChange_@ISMTracing@@QEAAXPEBULegacyInputInfo@@_N@Z @ 0x18007DF94
 * Callers:
        ...
        char a3)
{
  ...
  if ( **((_DWORD **)v5 + 1) > 4u && tlgKeywordOn(*((_QWORD *)v5 + 1), 1LL) )
  {
    ...
    v17 = v7;
    v12 = a3;
    tlgWriteTransfer_EventWriteTransfer(v8, (unsigned __int8 *)dword_1801C82CA, 0LL, 0LL, 8u, &v15);
  }
}
