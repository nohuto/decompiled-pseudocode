/*
 * XREFs of _lambda_f2d9a31b738d46358cc103eee0272db8_::operator() @ 0x1801583B8
 * Callers:
 ...
 *     ??$IsValidFloat@M@Details@@YA_NM@Z @ 0x1800C42D8 (--$IsValidFloat@M@Details@@YA_NM@Z.c)
 ...
 *     ??$ValidateOrthonormalRightHandedMatrix@$00@Details@DirectX@@YQ?AW4OrthonormalMatrixValidationFailures@1@UXMMATRIX@1@@Z @ 0x18014F674 (--$ValidateOrthonormalRightHandedMatrix@$00@Details@DirectX@@YQ-AW4OrthonormalMatrixValidationFa.c)
 *     Windows::Internal::Holographic::HolographicDeviceSnapshot::Write_Windows::Internal::Holographic::TrackedDeviceSnapshot__lambda_3f94c1c330aebc4cd0e0e5305e75e493___ @ 0x180150F38 (Windows--Internal--Holographic--HolographicDeviceSnapshot--Write_Windows--Internal-_ea_180150F38.c)
...
LABEL_16:
  if ( (*(_BYTE *)(v19 + 16) & 2) == 0 )
  {
    *(_OWORD *)(v12 + 36) = xmmword_1801C6308;
    *(_OWORD *)(v12 + 52) = xmmword_1801C6318;
