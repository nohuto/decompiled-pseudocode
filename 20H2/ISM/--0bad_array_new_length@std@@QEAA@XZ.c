/*
 * XREFs of ??0bad_array_new_length@std@@QEAA@XZ @ 0x18003CB8C
 * Callers:
 *     ?__scrt_throw_std_bad_array_new_length@@YAXXZ @ 0x18003CC3C (-__scrt_throw_std_bad_array_new_length@@YAXXZ.c)
 * Callees:
 *     <none>
 */
