/*
 * XREFs of ?UIAHitTestResponse@BamoUIAHitTestStubImpl@BamoImpl@@QEAAJAEBU_GUID@@@Z @ 0x18018775C
 * Callers:
...
LABEL_3:
  ...
  v7 = 0;
  v9 = v6;
  return CoreUICallSend(v13, v8, 2LL, 68LL, v7, &unk_1801BF1BD, (unsigned int)&v9);
}
