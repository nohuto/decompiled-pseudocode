/*
 * XREFs of ?GetValueCaps@Internal@SpatialInteractionDevices@@YAJPEAUHID_HANDLE@2@W4_HIDP_REPORT_TYPE@@GGGGPEAPEAU_HIDP_VALUE_CAPS@@@Z @ 0x1800CB894
 * Callers:
 ...
 *     ?MatchValueCaps@Internal@SpatialInteractionDevices@@YA_NGGGGPEAU_HIDP_VALUE_CAPS@@@Z @ 0x1800C94B8 (-MatchValueCaps@Internal@SpatialInteractionDevices@@YA_NGGGGPEAU_HIDP_VALUE_CAPS@@@Z.c)
 */
