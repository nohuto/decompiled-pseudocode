/*
 * XREFs of ?_Growmap@?$deque@V?$ComPtr@UIUnknown@@@WRL@Microsoft@@V?$allocator@V?$ComPtr@UIUnknown@@@WRL@Microsoft@@@std@@@std@@AEAAX_K@Z @ 0x180166FA0
 * Callers:
 *     ?_Push_back_internal@?$deque@V?$ComPtr@UIUnknown@@@WRL@Microsoft@@V?$allocator@V?$ComPtr@UIUnknown@@@WRL@Microsoft@@@std@@@std@@AEAAX$$QEAV?$ComPtr@UIUnknown@@@WRL@Microsoft@@@Z @ 0x180167104 (-_Push_back_internal@-$deque@V-$ComPtr@UIUnknown@@@WRL@Microsoft@@V-$allocator@V-$ComPtr@UIUnkno.c)
 * Callees:
...
void __fastcall std::deque<Microsoft::WRL::ComPtr<IUnknown>>::_Growmap(_QWORD *a1)
{
