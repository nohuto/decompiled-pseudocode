/*
 * XREFs of ??0hresult_error@winrt@@QEAA@Uhresult@1@Utake_ownership_from_abi_t@1@@Z @ 0x1800BC944
 * Callers:
 ...
 *     WINRT_GetRestrictedErrorInfo @ 0x18003D7B2 (WINRT_GetRestrictedErrorInfo.c)
