/*
 * XREFs of ?CreateCursorShapeAnimation@BamoSystemCursorControllerPrincipalImpl@BamoImpl@@QEAAJ_K0@Z @ 0x18013B954
 * Callers:
 *     ?Thunk_CreateCursorShapeAnimation_253@?$ISystemCursorControllerPrincipal_Receive@VBamoSystemCursorControllerPrincipalImpl@BamoImpl@@@@SAJPEAXPEAPEAX@Z @ 0x18013CD90 (-Thunk_CreateCursorShapeAnimation_253@-$ISystemCursorControllerPrincipal_Receive@VBamoSystemCurs.c)
 * Callees:
        ...
        __int64 a3)
{
  ...
  v9 = (*(__int64 (__fastcall **)(char *, __int64, __int64, __int64))(*((_QWORD *)this - 2) + 96LL))(
         (char *)this - 16,
         v8,
         a2,
         a3);
