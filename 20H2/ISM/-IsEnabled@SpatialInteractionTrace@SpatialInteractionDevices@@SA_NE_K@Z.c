/*
 * XREFs of ?IsEnabled@SpatialInteractionTrace@SpatialInteractionDevices@@SA_NE_K@Z @ 0x1800C6188
 * Callers:
 *     ??$SpatialInputController_Added@KPEB_WGGG@SpatialInteractionTrace@SpatialInteractionDevices@@SAX$$QEAK$$QEAPEB_W$$QEAG22@Z @ 0x1800CC854 (--$SpatialInputController_Added@KPEB_WGGG@SpatialInteractionTrace@SpatialInteractionDevices@@SAX.c)
 ...
 *     ??$SpatialObjectDeviceStartListeningToSpatialObjects@PEB_WAEAJ@SpatialInteractionTrace@SpatialInteractionDevices@@SAX$$QEAPEB_WAEAJ@Z @ 0x1800D4A20 (--$SpatialObjectDeviceStartListeningToSpatialObjects@PEB_WAEAJ@SpatialInteractionTrace@SpatialIn.c)
 ...
 *     _lambda_2610a4571c07b034f8353f9aca44fe5c_::operator() @ 0x1800D5E30 (_lambda_2610a4571c07b034f8353f9aca44fe5c_--operator().c)
 *     _lambda_3d50a50961408acf3fdeaf78894b32d8_::operator() @ 0x1800D5EDC (_lambda_3d50a50961408acf3fdeaf78894b32d8_--operator().c)
 *     _lambda_86a3fa2e77f671cbbc20107799d6d433_::operator() @ 0x1800D6348 (_lambda_86a3fa2e77f671cbbc20107799d6d433_--operator().c)
 *     _lambda_88fb4871a400503c69c7f747a4c77519_::operator() @ 0x1800D63C4 (_lambda_88fb4871a400503c69c7f747a4c77519_--operator().c)
 *     _lambda_8af77e303c344d221a281039b3d8ff10_::operator() @ 0x1800D6558 (_lambda_8af77e303c344d221a281039b3d8ff10_--operator().c)
 ...
 *     ??$SpatialObjectReadNextStateError@U_GUID@@AEAJAEA_J@SpatialInteractionTrace@SpatialInteractionDevices@@SAX$$QEAU_GUID@@AEAJAEA_J@Z @ 0x1800DAFC0 (--$SpatialObjectReadNextStateError@U_GUID@@AEAJAEA_J@SpatialInteractionTrace@SpatialInteractionD.c)
 ...
 *     ??$ControllerHapticsStatistics@AEAKAEAJAEAJAEAN@SpatialInteractionTrace@SpatialInteractionDevices@@SAXAEAKAEAJ1AEAN@Z @ 0x18016806C (--$ControllerHapticsStatistics@AEAKAEAJAEAJAEAN@SpatialInteractionTrace@SpatialInteractionDevice.c)
 ...
 *     ??$InitializeHapticsEngine@AEA_N_JE_N_N@SpatialInteractionTrace@SpatialInteractionDevices@@SAXAEA_N$$QEA_J$$QEAE$$QEA_N3@Z @ 0x180168194 (--$InitializeHapticsEngine@AEA_N_JE_N_N@SpatialInteractionTrace@SpatialInteractionDevices@@SAXAE.c)
 *     ??$ParsingInitialized@AEAJAEAKAEAKAEAPEB_WAEAGAEAGAEA_NAEA_NAEAGAEAGAEAG_NAEAEAEAIAEAKAEAUPoseData@SpatialInteractionDevices@@AEAU12@@SpatialInteractionTrace@SpatialInteractionDevices@@SAXAEAJAEAK1AEAPEB_WAEAG3AEA_N4333$$QEA_NAEAEAEAI1AEAUPoseData@1@8@Z @ 0x1801684A0 (--$ParsingInitialized@AEAJAEAKAEAKAEAPEB_WAEAGAEAGAEA_NAEA_NAEAGAEAGAEAG_NAEAEAEAIAEAKAEAUPoseDa.c)
 ...
 *     wil::details::lambda_call__lambda_6bcc6914c6f7140c2e7947a0a05a7a7e___::_lambda_call__lambda_6bcc6914c6f7140c2e7947a0a05a7a7e___ @ 0x180169A38 (wil--details--lambda_call__lambda_6bcc6914c6f7140c2e7947a0a05a7a7e___--_lambda_call__lambda_6bcc.c)
 ...
 *     ?InitDeviceHandeness@SpatialInteractionSourceController@SpatialInteractions@Internal@Windows@@AEAAJPEAW4Handedness@SpatialInteractionDevices@@@Z @ 0x18016C9EC (-InitDeviceHandeness@SpatialInteractionSourceController@SpatialInteractions@Internal@Windows@@AE.c)
 ...
 *     ?SetButtonLatencyMicroseconds@SpatialInteractionSourceController@SpatialInteractions@Internal@Windows@@QEAAXH@Z @ 0x18016E948 (-SetButtonLatencyMicroseconds@SpatialInteractionSourceController@SpatialInteractions@Internal@Wi.c)
 ...
 *     ?UpdateNodeErrorStatus@SpatialInteractionSourceController@SpatialInteractions@Internal@Windows@@QEAAXPEAUISpatialGraphDriverClient@Holographic@34@AEBUSPATIAL_NODE_ID@@@Z @ 0x18016FBE0 (-UpdateNodeErrorStatus@SpatialInteractionSourceController@SpatialInteractions@Internal@Windows@@.c)
 * Callees:
...
char __fastcall SpatialInteractionDevices::SpatialInteractionTrace::IsEnabled(__int64 a1)
{
  wil::TraceLoggingProvider *v1; // rax

  v1 = (wil::TraceLoggingProvider *)wil::details::static_lazy<SpatialInteractionDevices::SpatialInteractionTrace>::get(
                                      a1,
