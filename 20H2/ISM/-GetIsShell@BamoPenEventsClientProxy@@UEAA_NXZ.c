/*
 * XREFs of ?GetIsShell@BamoPenEventsClientProxy@@UEAA_NXZ @ 0x180132FE0
 * Callers:
 *     <none>
 * Callees:
...
bool __fastcall BamoPenEventsClientProxy::GetIsShell(BamoPenEventsClientProxy *this)
{
