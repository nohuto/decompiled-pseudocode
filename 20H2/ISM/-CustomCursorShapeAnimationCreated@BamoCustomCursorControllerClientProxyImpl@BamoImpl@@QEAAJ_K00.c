/*
 * XREFs of ?CustomCursorShapeAnimationCreated@BamoCustomCursorControllerClientProxyImpl@BamoImpl@@QEAAJ_K00@Z @ 0x1800E496C
 * Callers:
        ...
        int a2)
{
  ...
  if ( *(_QWORD *)(*(_QWORD *)(*(_QWORD *)(*((_QWORD *)this + 2) + 24LL) + 32LL) + 56LL) )
  {
    ...
    if ( v6 >= 0 )
    {
      ...
      v9 = 2;
      return CoreUICallSend(v8, v11, 2LL, 19LL, v9, &unk_1801BF1D2, a2);
    }
    else
    {
