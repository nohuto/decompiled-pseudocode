/*
 * XREFs of ?to_hstring@hstring_builder@impl@winrt@@QEAA?AUhstring@3@XZ @ 0x1800BE668
 * Callers:
 *     ??$to_hstring@PEBDX@winrt@@YA?AUhstring@0@AEBQEBD@Z @ 0x1800BD2A4 (--$to_hstring@PEBDX@winrt@@YA-AUhstring@0@AEBQEBD@Z.c)
 * Callees:
 *     WINRT_WindowsPromoteStringBuffer @ 0x18003CFE3 (WINRT_WindowsPromoteStringBuffer.c)
