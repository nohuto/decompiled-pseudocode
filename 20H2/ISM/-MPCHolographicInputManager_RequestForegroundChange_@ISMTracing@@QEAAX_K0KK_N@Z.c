/*
 * XREFs of ?MPCHolographicInputManager_RequestForegroundChange_@ISMTracing@@QEAAX_K0KK_N@Z @ 0x180076E3C
 * Callers:
        ...
        bool a6)
{
  ...
  if ( ISMTracing::IsEnabled((__int64)this) )
  {
    ...
    if ( **((_DWORD **)v10 + 1) > 4u && tlgKeywordOn(*((_QWORD *)v10 + 1), 1LL) )
    {
      ...
      v17 = a3;
      v18 = a2;
      tlgWriteTransfer_EventWriteTransfer(v13, (unsigned __int8 *)dword_1801C7986, 0LL, 0LL, 7u, &v19);
    }
  }
}
