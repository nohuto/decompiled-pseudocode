/*
 * XREFs of ?QueryInterface@BamoControllerNavigationManagerPrincipal@@UEAAJAEBU_GUID@@PEAPEAX@Z @ 0x18011D230
 * Callers:
 *     ?QueryInterface@BamoControllerNavigationManagerPrincipal@@W7EAAJAEBU_GUID@@PEAPEAX@Z @ 0x18004C060 (-QueryInterface@BamoControllerNavigationManagerPrincipal@@W7EAAJAEBU_GUID@@PEAPEAX@Z.c)
 * Callees:
