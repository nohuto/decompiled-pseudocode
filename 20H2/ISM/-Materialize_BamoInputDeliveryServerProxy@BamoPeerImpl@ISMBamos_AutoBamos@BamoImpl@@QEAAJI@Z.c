/*
 * XREFs of ?Materialize_BamoInputDeliveryServerProxy@BamoPeerImpl@ISMBamos_AutoBamos@BamoImpl@@QEAAJI@Z @ 0x1800E72B8
 * Callers:
 *     ?Thunk_Materialize_BamoInputDeliveryServerProxy_10@?$IBamoPeer_ISMBamos_AutoBamos_Receive@VBamoPeerImpl@ISMBamos_AutoBamos@BamoImpl@@@@SAJPEAXPEAPEAX@Z @ 0x1800ECAE0 (-Thunk_Materialize_BamoInputDeliveryServerProxy_10@-$IBamoPeer_ISMBamos_AutoBamos_Receive@VBamoP.c)
 * Callees:
        ...
        unsigned int a2)
{
  ...
  *v9 = &BamoInputDeliveryServerProxy::`vftable'{for `Microsoft::Bamo::BamoProxy'};
  v9[1] = &BamoInputDeliveryServerProxy::`vftable'{for `IInputDeliveryServerProxy'};
  *((_DWORD *)v9 + 6) = 0;
  v9[4] = 0LL;
  *((_DWORD *)v9 + 10) = 0;
  *((_DWORD *)v9 + 11) = 0;
