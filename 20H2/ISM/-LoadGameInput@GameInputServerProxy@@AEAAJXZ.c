/*
 * XREFs of ?LoadGameInput@GameInputServerProxy@@AEAAJXZ @ 0x18004268C
 * Callers:
 ...
 *     ?OnModuleUpdated@GameInputServerProxy@@CAXPEAX@Z @ 0x180042B60 (-OnModuleUpdated@GameInputServerProxy@@CAXPEAX@Z.c)
 * Callees:
