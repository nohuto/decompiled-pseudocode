/*
 * XREFs of ?SetLoggingCallback@SpatialObjectDDIClientFactoryHelper@Holographic@Internal@Windows@@UEAAJPEAUISpatialObjectDDIClientLoggingCallback@234@@Z @ 0x1800D87B0
 * Callers:
 *     <none>
 * Callees:
