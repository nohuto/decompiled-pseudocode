/*
 * XREFs of ?OnSystemCommand@GameControllerRawInputProvider@@UEAAXI_K0E_N@Z @ 0x180088B10
 * Callers:
 *     <none>
 * Callees:
 ...
 *     ??4?$com_ptr_t@UIRawInputClient@@Uerr_exception_policy@wil@@@wil@@QEAAAEAV01@AEBV01@@Z @ 0x180040A64 (--4-$com_ptr_t@UIRawInputClient@@Uerr_exception_policy@wil@@@wil@@QEAAAEAV01@AEBV01@@Z.c)
 *     ??I?$com_ptr_t@UIMessageTimer@@Uerr_exception_policy@wil@@@wil@@QEAAPEAPEAUIMessageTimer@@XZ @ 0x180040AB8 (--I-$com_ptr_t@UIMessageTimer@@Uerr_exception_policy@wil@@@wil@@QEAAPEAPEAUIMessageTimer@@XZ.c)
 ...
 *     ?PushBack@?$NtList@UShellButtonListEntry@GameControllerRawInputProvider@@@@QEAAXPEAUShellButtonListEntry@GameControllerRawInputProvider@@@Z @ 0x180040B34 (-PushBack@-$NtList@UShellButtonListEntry@GameControllerRawInputProvider@@@@QEAAXPEAUShellButtonL.c)
 *     ?RemoveAt@?$NtList@UShellButtonListEntry@GameControllerRawInputProvider@@@@QEAAPEAUShellButtonListEntry@GameControllerRawInputProvider@@PEAU23@@Z @ 0x180040B60 (-RemoveAt@-$NtList@UShellButtonListEntry@GameControllerRawInputProvider@@@@QEAAPEAUShellButtonLi.c)
