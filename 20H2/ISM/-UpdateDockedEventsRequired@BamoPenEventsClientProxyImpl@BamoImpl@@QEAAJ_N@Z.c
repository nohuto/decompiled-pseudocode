/*
 * XREFs of ?UpdateDockedEventsRequired@BamoPenEventsClientProxyImpl@BamoImpl@@QEAAJ_N@Z @ 0x180134A10
 * Callers:
 ...
 *     ?Thunk_UpdateDockedEventsRequired_13@?$IPenEventsClientProxy_Receive@VBamoPenEventsClientProxyImpl@BamoImpl@@@@SAJPEAXPEAPEAX@Z @ 0x180134850 (-Thunk_UpdateDockedEventsRequired_13@-$IPenEventsClientProxy_Receive@VBamoPenEventsClientProxyIm.c)
 * Callees:
