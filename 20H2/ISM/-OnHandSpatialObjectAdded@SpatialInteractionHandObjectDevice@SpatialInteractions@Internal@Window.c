/*
 * XREFs of ?OnHandSpatialObjectAdded@SpatialInteractionHandObjectDevice@SpatialInteractions@Internal@Windows@@AEAAJAEBU_GUID@@@Z @ 0x1800E0294
 * Callers:
 ...
 *     ??$make_shared@VSpatialInteractionSourceHand@SpatialInteractions@Internal@Windows@@PEAUISpatialObjectDevice@Holographic@34@PEAUISpatialObject@634@@std@@YA?AV?$shared_ptr@VSpatialInteractionSourceHand@SpatialInteractions@Internal@Windows@@@0@$$QEAPEAUISpatialObjectDevice@Holographic@Internal@Windows@@$$QEAPEAUISpatialObject@345@@Z @ 0x1800DE290 (--$make_shared@VSpatialInteractionSourceHand@SpatialInteractions@Internal@Windows@@PEAUISpatialO.c)
