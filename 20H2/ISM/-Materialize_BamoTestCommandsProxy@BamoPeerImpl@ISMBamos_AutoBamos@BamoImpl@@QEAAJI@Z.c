/*
 * XREFs of ?Materialize_BamoTestCommandsProxy@BamoPeerImpl@ISMBamos_AutoBamos@BamoImpl@@QEAAJI@Z @ 0x1800E81FC
 * Callers:
 *     ?Thunk_Materialize_BamoTestCommandsProxy_10@?$IBamoPeer_ISMBamos_AutoBamos_Receive@VBamoPeerImpl@ISMBamos_AutoBamos@BamoImpl@@@@SAJPEAXPEAPEAX@Z @ 0x1800ECCA0 (-Thunk_Materialize_BamoTestCommandsProxy_10@-$IBamoPeer_ISMBamos_AutoBamos_Receive@VBamoPeerImpl.c)
 * Callees:
