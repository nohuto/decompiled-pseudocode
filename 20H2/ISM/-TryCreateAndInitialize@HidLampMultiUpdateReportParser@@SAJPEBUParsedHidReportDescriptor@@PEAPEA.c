/*
 * XREFs of ?TryCreateAndInitialize@HidLampMultiUpdateReportParser@@SAJPEBUParsedHidReportDescriptor@@PEAPEAV1@@Z @ 0x1800AB7C4
 * Callers:
 ...
 *     ??$_Emplace_reallocate@AEBVHidChannelValueInfo@@@?$vector@VHidChannelValueInfo@@V?$allocator@VHidChannelValueInfo@@@std@@@std@@QEAAPEAVHidChannelValueInfo@@QEAV2@AEBV2@@Z @ 0x1800A485C (--$_Emplace_reallocate@AEBVHidChannelValueInfo@@@-$vector@VHidChannelValueInfo@@V-$allocator@VHi.c)
 *     ??0HidLampMultiUpdateReportParser@@AEAA@XZ @ 0x1800AAE80 (--0HidLampMultiUpdateReportParser@@AEAA@XZ.c)
        ...
        struct HidLampMultiUpdateReportParser **a2)
{
  ...
  __int64 *v20; // rcx
  __int64 v21; // rdx
  struct HidLampMultiUpdateReportParser *v22; // rax
