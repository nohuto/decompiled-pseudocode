/*
 * XREFs of ?RuntimeClassInitialize@MPCGamepadProcessor@@QEAAJPEBUInputProcessorCreateParams@@@Z @ 0x180193ADC
 * Callers:
 ...
 *     ??B?$ComPtrRef@V?$ComPtr@UIInputFocusListener@@@WRL@Microsoft@@@Details@WRL@Microsoft@@QEBAPEAPEAXXZ @ 0x18006457C (--B-$ComPtrRef@V-$ComPtr@UIInputFocusListener@@@WRL@Microsoft@@@Details@WRL@Microsoft@@QEBAPEAPE.c)
