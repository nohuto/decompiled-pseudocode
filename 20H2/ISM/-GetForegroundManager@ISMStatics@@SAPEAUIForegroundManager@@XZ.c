/*
 * XREFs of ?GetForegroundManager@ISMStatics@@SAPEAUIForegroundManager@@XZ @ 0x18001213C
 * Callers:
 ...
 *     ?Activate@ActivatableEntityBamoPrincipal@@UEAAJPEAVBamoActivatableEntityStub@@@Z @ 0x180105340 (-Activate@ActivatableEntityBamoPrincipal@@UEAAJPEAVBamoActivatableEntityStub@@@Z.c)
 * Callees:
