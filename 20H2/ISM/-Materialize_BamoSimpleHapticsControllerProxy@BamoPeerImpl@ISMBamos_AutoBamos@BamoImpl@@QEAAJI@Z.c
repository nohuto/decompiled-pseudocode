/*
 * XREFs of ?Materialize_BamoSimpleHapticsControllerProxy@BamoPeerImpl@ISMBamos_AutoBamos@BamoImpl@@QEAAJI@Z @ 0x1800E7ED4
 * Callers:
 *     ?Thunk_Materialize_BamoSimpleHapticsControllerProxy_10@?$IBamoPeer_ISMBamos_AutoBamos_Receive@VBamoPeerImpl@ISMBamos_AutoBamos@BamoImpl@@@@SAJPEAXPEAPEAX@Z @ 0x1800ECC60 (-Thunk_Materialize_BamoSimpleHapticsControllerProxy_10@-$IBamoPeer_ISMBamos_AutoBamos_Receive@VB.c)
 * Callees:
