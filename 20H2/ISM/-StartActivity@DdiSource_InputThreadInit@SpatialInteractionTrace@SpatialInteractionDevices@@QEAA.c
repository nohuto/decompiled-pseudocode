/*
 * XREFs of ?StartActivity@DdiSource_InputThreadInit@SpatialInteractionTrace@SpatialInteractionDevices@@QEAAXAEBU_GUID@@@Z @ 0x1800D8DDC
 * Callers:
        ...
        const struct _GUID *a2)
{
  ...
  if ( *v5 > 4u )
  {
    ...
    tlgWriteTransfer_EventWriteTransfer(
      (__int64)v5,
      (unsigned __int8 *)dword_1801CC65D,
      (const GUID *)(v7 + 8),
      v6,
      5u,
      &v10);
