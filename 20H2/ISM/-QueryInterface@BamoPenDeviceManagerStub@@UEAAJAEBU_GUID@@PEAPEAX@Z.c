/*
 * XREFs of ?QueryInterface@BamoPenDeviceManagerStub@@UEAAJAEBU_GUID@@PEAPEAX@Z @ 0x18012F8B0
 * Callers:
 *     ?QueryInterface@BamoPenDeviceManagerStub@@W7EAAJAEBU_GUID@@PEAPEAX@Z @ 0x18004C1F0 (-QueryInterface@BamoPenDeviceManagerStub@@W7EAAJAEBU_GUID@@PEAPEAX@Z.c)
 * Callees:
