/*
 * XREFs of ?XMQuaternionMultiply@DirectX@@YQ?AT__m128@@T2@0@Z @ 0x1800865DC
 * Callers:
 ...
 *     SpatialInteractionDevices::ReadLocalOrientation @ 0x1800C9E3C (SpatialInteractionDevices--ReadLocalOrientation.c)
