/*
 * XREFs of ??0MPCInputProviderBase@@QEAA@XZ @ 0x18002AAEC
 * Callers:
 ...
 *     ??0?$RuntimeClass@U?$RuntimeClassFlags@$01@WRL@Microsoft@@UIRawInputProvider@@VMPCInputProviderBase@@@WRL@Microsoft@@QEAA@XZ @ 0x18019166C (--0-$RuntimeClass@U-$RuntimeClassFlags@$01@WRL@Microsoft@@UIRawInputProvider@@VMPCInputProviderB.c)
 * Callees:
 ...
 *     ?CalculateMaximumSize@RayStabilizer@@AEAAXXZ @ 0x18002AABC (-CalculateMaximumSize@RayStabilizer@@AEAAXXZ.c)
