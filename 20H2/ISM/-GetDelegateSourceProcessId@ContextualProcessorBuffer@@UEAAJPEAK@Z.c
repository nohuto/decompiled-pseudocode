/*
 * XREFs of ?GetDelegateSourceProcessId@ContextualProcessorBuffer@@UEAAJPEAK@Z @ 0x18014BD80
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall ContextualProcessorBuffer::GetDelegateSourceProcessId(
        ...
        unsigned int *a2)
{
  ...
  if ( *v3 && (int)Microsoft::WRL::ComPtr<IInputTarget>::As<IFocusInputTarget>(v3, &v6) >= 0 )
    v4 = (*(__int64 (__fastcall **)(__int64, unsigned int *))(*(_QWORD *)v6 + 72LL))(v6, a2);
  else
    v4 = -2147467259;
