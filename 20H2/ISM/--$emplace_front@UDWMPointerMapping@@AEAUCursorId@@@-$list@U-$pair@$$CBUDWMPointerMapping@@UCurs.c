/*
 * XREFs of ??$emplace_front@UDWMPointerMapping@@AEAUCursorId@@@?$list@U?$pair@$$CBUDWMPointerMapping@@UCursorId@@@std@@V?$allocator@U?$pair@$$CBUDWMPointerMapping@@UCursorId@@@std@@@2@@std@@QEAAAEAU?$pair@$$CBUDWMPointerMapping@@UCursorId@@@1@$$QEAUDWMPointerMapping@@AEAUCursorId@@@Z @ 0x180025C08
 * Callers:
