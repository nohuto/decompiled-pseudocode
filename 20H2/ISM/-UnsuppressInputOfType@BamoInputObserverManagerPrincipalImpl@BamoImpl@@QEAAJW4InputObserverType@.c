/*
 * XREFs of ?UnsuppressInputOfType@BamoInputObserverManagerPrincipalImpl@BamoImpl@@QEAAJW4InputObserverType@InputObservation@@I@Z @ 0x1800F4244
 * Callers:
 *     ?Thunk_UnsuppressInputOfType_161@?$IInputObserverManagerPrincipal_Receive@VBamoInputObserverManagerPrincipalImpl@BamoImpl@@@@SAJPEAXPEAPEAX@Z @ 0x1800F40C0 (-Thunk_UnsuppressInputOfType_161@-$IInputObserverManagerPrincipal_Receive@VBamoInputObserverMana.c)
 * Callees:
