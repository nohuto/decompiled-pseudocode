/*
 * XREFs of ?GetConstantNamesString@MPCConstantManager@@AEAA?AV?$basic_string@GU?$char_traits@G@std@@V?$allocator@G@2@@std@@W4InputType@@@Z @ 0x18006E9C4
 * Callers:
...
_QWORD *__fastcall MPCConstantManager::GetConstantNamesString(__int64 a1, _QWORD *a2, unsigned int a3)
{
  ...
  v22 = a3;
  v20 = a2;
  std::wstring::wstring(a2, (__int64)&word_1801C13CC);
  v19 = 1;
  v5 = (__int64 *)(a1 + 56);
