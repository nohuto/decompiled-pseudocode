/*
 * XREFs of ?Thunk_UpdateAutoForwardId_2@?$IActivationControllerProxy_Receive@VBamoActivationControllerProxyImpl@BamoImpl@@@@SAJPEAXPEAPEAX@Z @ 0x180011920
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall IActivationControllerProxy_Receive<BamoImpl::BamoActivationControllerProxyImpl>::Thunk_UpdateAutoForwardId_2(
        __int64 a1,
        _QWORD **a2)
{
  int v4; // eax
  ...
  *(_QWORD *)(a1 + 56) = **a2;
  if ( *(_BYTE *)(a1 + 28) )
  {
    ...
    v4 = (*(__int64 (__fastcall **)(__int64))(*(_QWORD *)(a1 - 16) + 72LL))(a1 - 16);
    if ( v4 < 0 )
