/*
 * XREFs of ?UpdateId@BamoDragSourceClientProxyImpl@BamoImpl@@QEAAJ_K@Z @ 0x1800EE38C
 * Callers:
 ...
 *     ?Thunk_UpdateId_2@?$IDragSourceClientProxy_Receive@VBamoDragSourceClientProxyImpl@BamoImpl@@@@SAJPEAXPEAPEAX@Z @ 0x1800ECE70 (-Thunk_UpdateId_2@-$IDragSourceClientProxy_Receive@VBamoDragSourceClientProxyImpl@BamoImpl@@@@SA.c)
 * Callees:
