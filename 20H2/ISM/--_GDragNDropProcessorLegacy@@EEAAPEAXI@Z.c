/*
 * XREFs of ??_GDragNDropProcessorLegacy@@EEAAPEAXI@Z @ 0x1801745A8
 * Callers:
 *     ??_EDragNDropProcessorLegacy@@G7EAAPEAXI@Z @ 0x18004CD10 (--_EDragNDropProcessorLegacy@@G7EAAPEAXI@Z.c)
 * Callees:
