/*
 * XREFs of ?UpdateResizeContextualProcessor@BamoInputSystemProxyImpl@BamoImpl@@QEAAJI@Z @ 0x1800EF1F0
 * Callers:
 ...
 *     ?Thunk_UpdateResizeContextualProcessor_10@?$IInputSystemProxy_Receive@VBamoInputSystemProxyImpl@BamoImpl@@@@SAJPEAXPEAPEAX@Z @ 0x1800ECFC0 (-Thunk_UpdateResizeContextualProcessor_10@-$IInputSystemProxy_Receive@VBamoInputSystemProxyImpl@.c)
 * Callees:
