/*
 * XREFs of ?InjectZoom@ManipulationInjector@@QEAAXMK@Z @ 0x1800C3478
 * Callers:
 ...
 *     ?TransitionZoomTypes@ManipulationInjector@@AEAAXXZ @ 0x1800C3BB8 (-TransitionZoomTypes@ManipulationInjector@@AEAAXXZ.c)
