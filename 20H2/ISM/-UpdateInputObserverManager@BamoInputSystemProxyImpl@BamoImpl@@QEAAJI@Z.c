/*
 * XREFs of ?UpdateInputObserverManager@BamoInputSystemProxyImpl@BamoImpl@@QEAAJI@Z @ 0x1800EE5EC
 * Callers:
 ...
 *     ?Thunk_UpdateInputObserverManager_10@?$IInputSystemProxy_Receive@VBamoInputSystemProxyImpl@BamoImpl@@@@SAJPEAXPEAPEAX@Z @ 0x1800ECEC0 (-Thunk_UpdateInputObserverManager_10@-$IInputSystemProxy_Receive@VBamoInputSystemProxyImpl@BamoI.c)
 * Callees:
...
__int64 __fastcall BamoImpl::BamoInputSystemProxyImpl::UpdateInputObserverManager(
        ...
        unsigned int a2)
{
  ...
  *((_QWORD *)this + 10) = v7;
  ...
  if ( *((_BYTE *)this + 28) )
  {
    ...
    v9 = (*(__int64 (__fastcall **)(char *))(*((_QWORD *)this - 2) + 104LL))((char *)this - 16);
    if ( v9 < 0 )
