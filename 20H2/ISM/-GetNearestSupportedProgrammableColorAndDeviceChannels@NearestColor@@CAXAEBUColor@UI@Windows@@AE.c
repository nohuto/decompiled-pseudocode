/*
 * XREFs of ?GetNearestSupportedProgrammableColorAndDeviceChannels@NearestColor@@CAXAEBUColor@UI@Windows@@AEBULampAttributes@@PEAU234@PEAULampColor@@@Z @ 0x1800A8CA4
 * Callers:
 ...
 * Callees:
 *     ?SnapChannelToNearest@NearestColor@@CANNN@Z @ 0x1800A8F68 (-SnapChannelToNearest@NearestColor@@CANNN@Z.c)
 */
