/*
 * XREFs of ??$_Uninitialized_move@PEAUContextualProcessorEntry@ContextualProcessorManager@@PEAU12@V?$allocator@UContextualProcessorEntry@ContextualProcessorManager@@@std@@@std@@YAPEAUContextualProcessorEntry@ContextualProcessorManager@@QEAU12@0PEAU12@AEAV?$allocator@UContextualProcessorEntry@ContextualProcessorManager@@@0@@Z @ 0x180048CCC
 * Callers:
...
__int64 *__fastcall std::_Uninitialized_move<ContextualProcessorManager::ContextualProcessorEntry *,ContextualProcessorManager::ContextualProcessorEntry *,std::allocator<ContextualProcessorManager::ContextualProcessorEntry>>(
        __int64 *a1,
        __int64 *a2,
        __int64 *a3)
{
