/*
 * XREFs of ?QueryInterface@BamoPenDevicePrincipal@@UEAAJAEBU_GUID@@PEAPEAX@Z @ 0x180131460
 * Callers:
 *     ?QueryInterface@BamoPenDevicePrincipal@@W7EAAJAEBU_GUID@@PEAPEAX@Z @ 0x18004C200 (-QueryInterface@BamoPenDevicePrincipal@@W7EAAJAEBU_GUID@@PEAPEAX@Z.c)
 * Callees:
