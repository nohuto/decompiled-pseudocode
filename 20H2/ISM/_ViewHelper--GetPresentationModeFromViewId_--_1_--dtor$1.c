/*
 * XREFs of _ViewHelper::GetPresentationModeFromViewId_::_1_::dtor$1 @ 0x180041F79
 * Callers:
 *     <none>
 * Callees:
 *     <none>
...
void __fastcall ViewHelper::GetPresentationModeFromViewId_::_1_::dtor_1(__int64 a1, __int64 a2)
{
