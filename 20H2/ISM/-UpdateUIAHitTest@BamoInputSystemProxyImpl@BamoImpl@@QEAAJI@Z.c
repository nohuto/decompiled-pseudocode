/*
 * XREFs of ?UpdateUIAHitTest@BamoInputSystemProxyImpl@BamoImpl@@QEAAJI@Z @ 0x1800EFB94
 * Callers:
 ...
 *     ?Thunk_UpdateUIAHitTest_10@?$IInputSystemProxy_Receive@VBamoInputSystemProxyImpl@BamoImpl@@@@SAJPEAXPEAPEAX@Z @ 0x1800ED0A0 (-Thunk_UpdateUIAHitTest_10@-$IInputSystemProxy_Receive@VBamoInputSystemProxyImpl@BamoImpl@@@@SAJ.c)
 * Callees:
        ...
        unsigned int a2)
{
  ...
  *((_QWORD *)this + 18) = v7;
  ...
  if ( *((_BYTE *)this + 28) )
  {
    ...
    v9 = (*(__int64 (__fastcall **)(char *))(*((_QWORD *)this - 2) + 168LL))((char *)this - 16);
    if ( v9 < 0 )
