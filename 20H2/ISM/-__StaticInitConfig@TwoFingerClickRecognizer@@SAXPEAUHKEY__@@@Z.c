/*
 * XREFs of ?__StaticInitConfig@TwoFingerClickRecognizer@@SAXPEAUHKEY__@@@Z @ 0x180186684
 * Callers:
 *     ?StaticInitConfig@GestureRecognizer@@KAXXZ @ 0x180185684 (-StaticInitConfig@GestureRecognizer@@KAXXZ.c)
 * Callees:
