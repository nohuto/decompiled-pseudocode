/*
 * XREFs of ?QueryInterface@HomeGestureReadyChangedEventArgs@@UEAAJAEBU_GUID@@PEAPEAX@Z @ 0x180109D50
 * Callers:
 *     ?QueryInterface@HomeGestureReadyChangedEventArgs@@W7EAAJAEBU_GUID@@PEAPEAX@Z @ 0x18004B7F0 (-QueryInterface@HomeGestureReadyChangedEventArgs@@W7EAAJAEBU_GUID@@PEAPEAX@Z.c)
 * Callees:
