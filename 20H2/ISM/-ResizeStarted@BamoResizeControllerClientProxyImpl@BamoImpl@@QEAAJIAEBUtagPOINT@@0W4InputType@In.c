/*
 * XREFs of ?ResizeStarted@BamoResizeControllerClientProxyImpl@BamoImpl@@QEAAJIAEBUtagPOINT@@0W4InputType@Input@Internal@UI@Windows@@@Z @ 0x1800EBE80
 * Callers:
...
LABEL_3:
  ...
  v15[0] = v17;
  v15[1] = v13;
  return CoreUICallSend(v11, v15, 2LL, 56LL, 0, &unk_1801BF27E, a2);
}
