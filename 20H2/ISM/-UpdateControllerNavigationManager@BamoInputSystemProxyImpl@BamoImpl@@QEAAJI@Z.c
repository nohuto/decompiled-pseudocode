/*
 * XREFs of ?UpdateControllerNavigationManager@BamoInputSystemProxyImpl@BamoImpl@@QEAAJI@Z @ 0x1800ED7A0
 * Callers:
 ...
 *     ?Thunk_UpdateControllerNavigationManager_10@?$IInputSystemProxy_Receive@VBamoInputSystemProxyImpl@BamoImpl@@@@SAJPEAXPEAPEAX@Z @ 0x1800ECD80 (-Thunk_UpdateControllerNavigationManager_10@-$IInputSystemProxy_Receive@VBamoInputSystemProxyImp.c)
 * Callees:
