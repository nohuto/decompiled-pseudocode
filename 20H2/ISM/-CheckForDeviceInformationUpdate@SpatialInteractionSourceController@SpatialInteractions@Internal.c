/*
 * XREFs of ?CheckForDeviceInformationUpdate@SpatialInteractionSourceController@SpatialInteractions@Internal@Windows@@AEAAXPEA_N@Z @ 0x18016AB24
 * Callers:
        ...
        bool *a2)
{
  ...
  v4 = *((_BYTE *)this + 952);
  v5 = *((_BYTE *)this + 1052);
  v6 = PerformanceCount.QuadPart / (qword_180208328 / 1000);
  v7 = *((_BYTE *)this + 1020)
    && PerformanceCount.QuadPart / (qword_180208328 / 1000) - *((_QWORD *)this + 118) > 500
