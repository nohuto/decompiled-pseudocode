/*
 * XREFs of ??$EnumerateStubs@W4InputType@@PEBGUtagPROPVARIANT@@U2@@BamoMPCConstantManagerClientPrincipal@@QEAAJP6AJPEAVBamoMPCConstantManagerClientStub@@W4InputType@@PEBGUtagPROPVARIANT@@3@Z_N1233@Z @ 0x18006CDE8
 * Callers:
        ...
        __int64 a7)
{
  ...
  v13 = Microsoft::BamoImpl::BamoPrincipalImpl::EnumerateStubs<long (*)(BamoMPCConstantManagerClientStub *,enum InputType,unsigned short const *,tagPROPVARIANT,tagPROPVARIANT),enum InputType,unsigned short const *,tagPROPVARIANT,tagPROPVARIANT>(
          a1 + 16,
          (__int64 (__fastcall *)(__int64, __int64 (__fastcall *)(int, int, int, int, __int64), _QWORD, __int64, int *, __int128 *))lambda_23c26f952cd19a1a8b0d89221ba81740_::_lambda_invoker_cdecl_,
          v11,
          v12,
          a4,
          a5,
