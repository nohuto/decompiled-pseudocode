/*
 * XREFs of ?Thunk_CheckProtocol_6@?$IBamoPeer_MPCManagerBamo_AutoBamos_Receive@VBamoPeerImpl@MPCManagerBamo_AutoBamos@BamoImpl@@@@SAJPEAXPEAPEAX@Z @ 0x180074180
 * Callers:
 *     <none>
 * Callees:
