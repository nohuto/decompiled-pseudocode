/*
 * XREFs of ?LogMPCGameControllerInputReport@ISMTracing@@SAXPEAUInputInfo@@AEB_N@Z @ 0x180083608
 * Callers:
...
void __fastcall ISMTracing::LogMPCGameControllerInputReport(struct InputInfo *a1, const bool *a2)
{
  ...
  if ( **((_DWORD **)v4 + 1) > 5u && tlgKeywordOn(*((_QWORD *)v4 + 1), 1LL) )
  {
    ...
    v16 = 4LL;
    v14 = 4LL;
    tlgWriteTransfer_EventWriteTransfer(v6, (unsigned __int8 *)dword_1801C8A98, 0LL, 0LL, 7u, &v12);
  }
}
