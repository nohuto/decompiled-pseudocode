/*
 * XREFs of ?OnGamepadIsSupportedForProcess@BamoMPCManagerClientPrincipalImpl@BamoImpl@@QEAAJI@Z @ 0x18010C990
 * Callers:
 *     ?Thunk_OnGamepadIsSupportedForProcess_25@?$IMPCManagerClientPrincipal_Receive@VBamoMPCManagerClientPrincipalImpl@BamoImpl@@@@SAJPEAXPEAPEAX@Z @ 0x18010D440 (-Thunk_OnGamepadIsSupportedForProcess_25@-$IMPCManagerClientPrincipal_Receive@VBamoMPCManagerCli.c)
 * Callees:
