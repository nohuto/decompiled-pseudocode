/*
 * XREFs of ??1?$vector@U?$pair@KPEAUIInputProcessor@@@std@@V?$allocator@U?$pair@KPEAUIInputProcessor@@@std@@@2@@std@@QEAA@XZ @ 0x180086FCC
 * Callers:
 *     _InputStateManager::InputStateManager_::_1_::dtor$4 @ 0x1800504AB (_InputStateManager--InputStateManager_--_1_--dtor$4.c)
 *     _SystemCursorService::SystemCursorService_::_1_::dtor$3 @ 0x18013E302 (_SystemCursorService--SystemCursorService_--_1_--dtor$3.c)
