/*
 * XREFs of ?QueryInterface@BamoAsyncResult_string_Stub@@UEAAJAEBU_GUID@@PEAPEAX@Z @ 0x18011AE00
 * Callers:
 *     ?QueryInterface@BamoAsyncResult_string_Stub@@W7EAAJAEBU_GUID@@PEAPEAX@Z @ 0x18004C010 (-QueryInterface@BamoAsyncResult_string_Stub@@W7EAAJAEBU_GUID@@PEAPEAX@Z.c)
 * Callees:
