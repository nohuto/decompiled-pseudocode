/*
 * XREFs of ?SpatialGraphNodeReferenceFactoryDestroyed_@HolographicDriverClientTrace@@QEAAXPEBX@Z @ 0x180163FCC
 * Callers:
        ...
        const void *a2)
{
  ...
  if ( **(_DWORD **)(v3 + 8) > 4u && tlgKeywordOn(*(_QWORD *)(v3 + 8), 2LL) )
  {
    ...
    v5 = a2;
    v8 = 8;
    tlgWriteTransfer_EventWriteTransfer(v4, (unsigned __int8 *)dword_1801CEA4D, 0LL, 0LL, 3u, &v6);
  }
}
