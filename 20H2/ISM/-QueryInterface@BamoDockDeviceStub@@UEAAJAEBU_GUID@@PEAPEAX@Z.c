/*
 * XREFs of ?QueryInterface@BamoDockDeviceStub@@UEAAJAEBU_GUID@@PEAPEAX@Z @ 0x180126E90
 * Callers:
 *     ?QueryInterface@BamoDockDeviceStub@@W7EAAJAEBU_GUID@@PEAPEAX@Z @ 0x18004C110 (-QueryInterface@BamoDockDeviceStub@@W7EAAJAEBU_GUID@@PEAPEAX@Z.c)
 * Callees:
