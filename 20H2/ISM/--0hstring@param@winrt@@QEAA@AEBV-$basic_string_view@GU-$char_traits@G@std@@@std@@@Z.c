/*
 * XREFs of ??0hstring@param@winrt@@QEAA@AEBV?$basic_string_view@GU?$char_traits@G@std@@@std@@@Z @ 0x180033B08
 * Callers:
 ...
 * Callees:
 *     WINRT_WindowsCreateStringReference @ 0x18003CFA7 (WINRT_WindowsCreateStringReference.c)
 */
