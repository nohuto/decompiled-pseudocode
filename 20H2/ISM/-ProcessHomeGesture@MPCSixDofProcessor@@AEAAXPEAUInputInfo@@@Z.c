/*
 * XREFs of ?ProcessHomeGesture@MPCSixDofProcessor@@AEAAXPEAUInputInfo@@@Z @ 0x18018E1E4
 * Callers:
 ...
 *     ?TicksToSeconds@PerfCounter@@YAM_J@Z @ 0x18007BD40 (-TicksToSeconds@PerfCounter@@YAM_J@Z.c)
