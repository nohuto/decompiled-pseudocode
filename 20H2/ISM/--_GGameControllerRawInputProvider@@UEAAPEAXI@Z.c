/*
 * XREFs of ??_GGameControllerRawInputProvider@@UEAAPEAXI@Z @ 0x1800882A4
 * Callers:
 *     ??_EGameControllerRawInputProvider@@WBI@EAAPEAXI@Z @ 0x18004A990 (--_EGameControllerRawInputProvider@@WBI@EAAPEAXI@Z.c)
 * Callees:
