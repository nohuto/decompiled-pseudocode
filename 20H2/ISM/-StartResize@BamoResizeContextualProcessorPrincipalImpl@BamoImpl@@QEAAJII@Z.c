/*
 * XREFs of ?StartResize@BamoResizeContextualProcessorPrincipalImpl@BamoImpl@@QEAAJII@Z @ 0x1800FCBE4
 * Callers:
 *     ?Thunk_StartResize_112@?$IResizeContextualProcessorPrincipal_Receive@VBamoResizeContextualProcessorPrincipalImpl@BamoImpl@@@@SAJPEAXPEAPEAX@Z @ 0x1800FCD90 (-Thunk_StartResize_112@-$IResizeContextualProcessorPrincipal_Receive@VBamoResizeContextualProces.c)
 * Callees:
