 ...
 *     ??1NodePropertyCache@Holographic@Internal@Windows@@QEAA@XZ @ 0x1801578FC (--1NodePropertyCache@Holographic@Internal@Windows@@QEAA@XZ.c)
        ...
        void **a3)
{
  ...
  while ( !*((_BYTE *)v3 + 25) )
  {
    ...
    std::_Tree_val<std::_Tree_simple_types<std::pair<_GUID const,std::vector<unsigned char>>>>::_Erase_tree<std::allocator<std::_Tree_node<std::pair<_GUID const,std::vector<unsigned char>>,void *>>>(
      ...
      v6 + 6,
      *((_QWORD *)v6[6] + 1));
    std::_Deallocate<16,0>(v6[6], (const struct std::nothrow_t *)0x48);
