...
__int64 __fastcall std::_Hash<std::_Umap_traits<IInputTarget *,std::unordered_set<unsigned long>,std::_Uhash_compare<IInputTarget *,std::hash<IInputTarget *>,std::equal_to<IInputTarget *>>,std::allocator<std::pair<IInputTarget * const,std::unordered_set<unsigned long>>>,0>>::_Insert_unverified<std::pair<IInputTarget * const,std::unordered_set<unsigned long>> &,std::_List_unchecked_iterator<std::_List_val<std::_List_simple_types<std::pair<IInputTarget * const,std::unordered_set<unsigned long>>>>>>(
        __int64 a1,
        __int64 a2,
        ...
        __int64 *a4)
{
  ...
  while ( 1 )
  {
    ...
    {
      std::list<std::pair<IInputTarget * const,std::unordered_set<unsigned long>>>::erase(v11 + 8, &v25, a4);
      *(_QWORD *)a2 = v9;
      *(_BYTE *)(a2 + 8) = 0;
      return a2;
    }
  ...
  try
  {
    std::_Hash<std::_Umap_traits<IInputTarget *,std::unordered_set<unsigned long>,std::_Uhash_compare<IInputTarget *,std::hash<IInputTarget *>,std::equal_to<IInputTarget *>>,std::allocator<std::pair<IInputTarget * const,std::unordered_set<unsigned long>>>,0>>::_Check_size();
    *(_QWORD *)a2 = a4;
    *(_BYTE *)(a2 + 8) = 1;
    result = a2;
  }
  ...
  {
    std::_Hash<std::_Umap_traits<IInputTarget *,std::unordered_set<unsigned long>,std::_Uhash_compare<IInputTarget *,std::hash<IInputTarget *>,std::equal_to<IInputTarget *>>,std::allocator<std::pair<IInputTarget * const,std::unordered_set<unsigned long>>>,0>>::erase<std::_List_iterator<std::_List_val<std::_List_simple_types<std::pair<IInputTarget * const,std::unordered_set<unsigned long>>>>>,void>(
      a1,
      &v25,
      v26);
    throw;
