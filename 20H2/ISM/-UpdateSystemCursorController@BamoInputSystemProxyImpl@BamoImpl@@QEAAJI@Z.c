/*
 * XREFs of ?UpdateSystemCursorController@BamoInputSystemProxyImpl@BamoImpl@@QEAAJI@Z @ 0x1800EF6B4
 * Callers:
 ...
 *     ?Thunk_UpdateSystemCursorController_10@?$IInputSystemProxy_Receive@VBamoInputSystemProxyImpl@BamoImpl@@@@SAJPEAXPEAPEAX@Z @ 0x1800ED040 (-Thunk_UpdateSystemCursorController_10@-$IInputSystemProxy_Receive@VBamoInputSystemProxyImpl@Bam.c)
 * Callees:
