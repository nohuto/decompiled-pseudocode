/*
 * XREFs of _HidLampArrayDevice::ExtractReportDescriptorsFromPreparsedData_::_1_::catch$216 @ 0x1800A6CC8
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall HidLampArrayDevice::ExtractReportDescriptorsFromPreparsedData_::_1_::catch_216(
        __int64 a1,
        __int64 a2,
        __int64 a3,
        const char *a4)
