/*
 * XREFs of ?UpdateActivationWatcher@BamoInputSystemProxyImpl@BamoImpl@@QEAAJI@Z @ 0x1800ED498
 * Callers:
 ...
 *     ?Thunk_UpdateActivationWatcher_10@?$IInputSystemProxy_Receive@VBamoInputSystemProxyImpl@BamoImpl@@@@SAJPEAXPEAPEAX@Z @ 0x1800ECD40 (-Thunk_UpdateActivationWatcher_10@-$IInputSystemProxy_Receive@VBamoInputSystemProxyImpl@BamoImpl.c)
 * Callees:
