/*
 * XREFs of ??_GHidLampMultiUpdateReportParser@@UEAAPEAXI@Z @ 0x1800AB160
 * Callers:
 *     <none>
 * Callees:
 ...
 *     ??1HidLampMultiUpdateReportParser@@UEAA@XZ @ 0x1800AAF8C (--1HidLampMultiUpdateReportParser@@UEAA@XZ.c)
 */
