/*
 * XREFs of ??$_Insert_unverified@$$CBKU_Not_a_node_tag@std@@@?$_Hash@V?$_Uset_traits@KV?$_Uhash_compare@KU?$hash@K@std@@U?$equal_to@K@2@@std@@V?$allocator@K@2@$0A@@std@@@std@@IEAA?AU?$pair@V?$_List_const_iterator@V?$_List_val@U?$_List_simple_types@K@std@@@std@@@std@@_N@1@$$QEBKU_Not_a_node_tag@1@@Z @ 0x1800F68D4
 * Callers:
 ...
 *     ?CancelDrag@DragNDropProcessorLegacy@@QEAAJPEAUtagMsgRoutingInfo@@K@Z @ 0x1801745F8 (-CancelDrag@DragNDropProcessorLegacy@@QEAAJPEAUtagMsgRoutingInfo@@K@Z.c)
 ...
 *     ?List@PointerMetadata@@YAXPEAUInputInfo@@AEAV?$unordered_set@KU?$hash@K@std@@U?$equal_to@K@2@V?$allocator@K@2@@std@@@Z @ 0x1801A4990 (-List@PointerMetadata@@YAXPEAUInputInfo@@AEAV-$unordered_set@KU-$hash@K@std@@U-$equal_to@K@2@V-$.c)
 * Callees:
...
__int64 __fastcall std::_Hash<std::_Uset_traits<unsigned long,std::_Uhash_compare<unsigned long,std::hash<unsigned long>,std::equal_to<unsigned long>>,std::allocator<unsigned long>,0>>::_Insert_unverified<unsigned long const,std::_Not_a_node_tag>(
        __int64 a1,
        __int64 a2,
        const unsigned __int8 *a3)
{
  ...
  v5 = std::_Fnv1a_append_bytes(a1, a3, 4uLL) & *(_QWORD *)(a1 + 48);
  v6 = *std::_Hash<std::_Umap_traits<unsigned long,tagPOINT,std::_Uhash_compare<unsigned long,std::hash<unsigned long>,std::equal_to<unsigned long>>,std::allocator<std::pair<unsigned long const,tagPOINT>>,0>>::_End(
          ...
          v21,
          v5);
  while ( v6 != *(_QWORD *)(*(_QWORD *)(a1 + 24) + 16 * v5) )
  {
    v6 = *(_QWORD *)(v6 + 8);
    if ( *v7 == *(_DWORD *)(v6 + 16) )
    {
  ...
  std::list<unsigned long>::_Insert<unsigned long const &>(a1 + 8, **(_QWORD **)(a1 + 8), v7);
  v9 = *(__int64 ***)(a1 + 8);
  v10 = *v9;
  v11 = **v9;
  if ( v6 != v11 )
  ...
  v13 = 2 * v5;
  v14 = *(_QWORD *)(a1 + 24);
  if ( *(__int64 ***)(v14 + 16 * v5) == v9 )
  {
    *(_QWORD *)(v14 + 16 * v5) = v10;
    v15 = *(_QWORD *)(a1 + 24);
    *(_QWORD *)(v15 + 16 * v5 + 8) = v10;
  }
  else
  {
    v16 = (__int64 **)(v14 + 16 * v5);
    if ( *(_QWORD *)(v14 + 8 * v13) == v6 )
    {
      *v16 = v10;
    }
    else
    {
      ...
      {
        v19 = *(_QWORD *)(a1 + 24);
        v20 = *(_QWORD *)(v19 + 8 * v13 + 8);
        *(_QWORD *)(v19 + 8 * v13 + 8) = *(_QWORD *)(v20 + 8);
      }
    }
  }
  try
