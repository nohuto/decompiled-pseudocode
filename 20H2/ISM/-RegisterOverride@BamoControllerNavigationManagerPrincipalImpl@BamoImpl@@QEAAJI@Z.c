/*
 * XREFs of ?RegisterOverride@BamoControllerNavigationManagerPrincipalImpl@BamoImpl@@QEAAJI@Z @ 0x18011D950
 * Callers:
 *     ?Thunk_RegisterOverride_10@?$IControllerNavigationManagerPrincipal_Receive@VBamoControllerNavigationManagerPrincipalImpl@BamoImpl@@@@SAJPEAXPEAPEAX@Z @ 0x18011DE40 (-Thunk_RegisterOverride_10@-$IControllerNavigationManagerPrincipal_Receive@VBamoControllerNaviga.c)
 * Callees:
