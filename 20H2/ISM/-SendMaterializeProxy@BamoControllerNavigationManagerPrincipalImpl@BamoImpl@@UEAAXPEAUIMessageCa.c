        ...
        struct Microsoft::BamoImpl::BamoStubImpl *a3)
{
  ...
  v8 = CoreUICallSend(a2, &v30, 2LL, 74LL, 10, &unk_1801BF1AA, v28);
  if ( v8 < 0 )
  {
  ...
  if ( *(_QWORD *)(*(_QWORD *)(*((_QWORD *)this + 2) + 32LL) + 56LL) )
  {
    ...
    LOWORD(v26) = 0;
    v31 = v11;
    v14 = CoreUICallSend(SendHost, &v30, 2LL, 15LL, v26, &unk_1801BF1AD, v10);
  ...
  if ( *(_QWORD *)(*(_QWORD *)(*((_QWORD *)this + 2) + 32LL) + 56LL) )
  {
    ...
    LOWORD(v26) = 1;
    v31 = v17;
    v20 = CoreUICallSend(v19, &v30, 2LL, 15LL, v26, &unk_1801BF1AD, v16);
  ...
  v31 = *(unsigned int *)(v3 + 40);
  LOWORD(v26) = 55;
  v23 = CoreUICallSend(a2, &v30, 2LL, 74LL, v26, &unk_1801BF1AA, v29);
  if ( v23 < 0 )
  {
    wil::details::in1diag3::FailFast_Hr(
      retaddr,
