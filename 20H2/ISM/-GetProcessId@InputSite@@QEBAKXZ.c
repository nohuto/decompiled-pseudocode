/*
 * XREFs of ?GetProcessId@InputSite@@QEBAKXZ @ 0x180043C50
 * Callers:
 ...
 *     _lambda_1dc6d0ada7bcfb8231392ed4059b0fbe_::operator()_InputSite___ @ 0x180044044 (_lambda_1dc6d0ada7bcfb8231392ed4059b0fbe_--operator()_InputSite___.c)
 * Callees:
