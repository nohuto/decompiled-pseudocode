/*
 * XREFs of ??0Win32kInterop@@QEAA@XZ @ 0x1800235DC
 * Callers:
 ...
 *     ??0?$_Hash@V?$_Umap_traits@_KUTargetingInfo@Win32kInterop@@V?$_Uhash_compare@_KU?$hash@_K@std@@U?$equal_to@_K@2@@std@@V?$allocator@U?$pair@$$CB_KUTargetingInfo@Win32kInterop@@@std@@@4@$0A@@std@@@std@@QEAA@AEBV?$_Uhash_compare@_KU?$hash@_K@std@@U?$equal_to@_K@2@@1@AEBV?$allocator@U?$pair@$$CB_KUTargetingInfo@Win32kInterop@@@std@@@1@@Z @ 0x180024D68 (--0-$_Hash@V-$_Umap_traits@_KUTargetingInfo@Win32kInterop@@V-$_Uhash_compare@_KU-$hash@_K@std@@U.c)
 *     ??0?$_Hash@V?$_Umap_traits@_K_KV?$_Uhash_compare@_KU?$hash@_K@std@@U?$equal_to@_K@2@@std@@V?$allocator@U?$pair@$$CB_K_K@std@@@2@$0A@@std@@@std@@QEAA@AEBV?$_Uhash_compare@_KU?$hash@_K@std@@U?$equal_to@_K@2@@1@AEBV?$allocator@U?$pair@$$CB_K_K@std@@@1@@Z @ 0x180025AB8 (--0-$_Hash@V-$_Umap_traits@_K_KV-$_Uhash_compare@_KU-$hash@_K@std@@U-$equal_to@_K@2@@std@@V-$all.c)
 *     ??0?$_Hash@V?$_Umap_traits@KPEAVInputInfoValidator@@V?$_Uhash_compare@KU?$hash@K@std@@U?$equal_to@K@2@@std@@V?$allocator@U?$pair@$$CBKPEAVInputInfoValidator@@@std@@@3@$0A@@std@@@std@@QEAA@AEBV?$_Uhash_compare@KU?$hash@K@std@@U?$equal_to@K@2@@1@AEBV?$allocator@U?$pair@$$CBKPEAVInputInfoValidator@@@std@@@1@@Z @ 0x18002ADB8 (--0-$_Hash@V-$_Umap_traits@KPEAVInputInfoValidator@@V-$_Uhash_compare@KU-$hash@K@std@@U-$equal_t.c)
 *     ??_L@YAXPEAX_K1P6AX0@Z2@Z @ 0x18003D39C (--_L@YAXPEAX_K1P6AX0@Z2@Z.c)
 *     ??0?$KernelInputConnection@U_MIT_ACCESSIBILITY_TIMER@@@@QEAA@PEBD@Z @ 0x180041104 (--0-$KernelInputConnection@U_MIT_ACCESSIBILITY_TIMER@@@@QEAA@PEBD@Z.c)
 *     ??0?$KernelInputConnection@U_MIT_DEVICE_IDENTIFICATION_MESSAGE@@@@QEAA@PEBD@Z @ 0x180041130 (--0-$KernelInputConnection@U_MIT_DEVICE_IDENTIFICATION_MESSAGE@@@@QEAA@PEBD@Z.c)
 *     ??0?$KernelInputConnection@U_MIT_HOTKEY_REGISTRATION_MESSAGE@@@@QEAA@PEBD@Z @ 0x18004115C (--0-$KernelInputConnection@U_MIT_HOTKEY_REGISTRATION_MESSAGE@@@@QEAA@PEBD@Z.c)
 *     ??0?$KernelInputConnection@U_MIT_INPUT_INTEROP_MESSAGE@@@@QEAA@PEBD@Z @ 0x180041188 (--0-$KernelInputConnection@U_MIT_INPUT_INTEROP_MESSAGE@@@@QEAA@PEBD@Z.c)
 *     ??0?$KernelInputConnection@U_MIT_KEYBOARD_INPUT_MESSAGE@@@@QEAA@PEBD@Z @ 0x1800411AC (--0-$KernelInputConnection@U_MIT_KEYBOARD_INPUT_MESSAGE@@@@QEAA@PEBD@Z.c)
 *     ??0?$KernelInputConnection@U_MIT_KEYBOARD_OVERRIDER_INPUT_MESSAGE@@@@QEAA@PEBD@Z @ 0x1800411D8 (--0-$KernelInputConnection@U_MIT_KEYBOARD_OVERRIDER_INPUT_MESSAGE@@@@QEAA@PEBD@Z.c)
 *     ??0?$KernelInputConnection@U_MIT_MOUSE_INPUT_MESSAGE@@@@QEAA@PEBD@Z @ 0x180041204 (--0-$KernelInputConnection@U_MIT_MOUSE_INPUT_MESSAGE@@@@QEAA@PEBD@Z.c)
 *     ??0?$KernelInputConnection@U_MIT_PNP_DEVICE_NOTIFICATION_MESSAGE@@@@QEAA@PEBD@Z @ 0x180041230 (--0-$KernelInputConnection@U_MIT_PNP_DEVICE_NOTIFICATION_MESSAGE@@@@QEAA@PEBD@Z.c)
 */
