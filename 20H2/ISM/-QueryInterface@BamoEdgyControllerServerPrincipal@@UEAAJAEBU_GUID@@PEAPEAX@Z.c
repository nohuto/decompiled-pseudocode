/*
 * XREFs of ?QueryInterface@BamoEdgyControllerServerPrincipal@@UEAAJAEBU_GUID@@PEAPEAX@Z @ 0x180100240
 * Callers:
 *     ?QueryInterface@BamoEdgyControllerServerPrincipal@@W7EAAJAEBU_GUID@@PEAPEAX@Z @ 0x18004B4D0 (-QueryInterface@BamoEdgyControllerServerPrincipal@@W7EAAJAEBU_GUID@@PEAPEAX@Z.c)
 * Callees:
