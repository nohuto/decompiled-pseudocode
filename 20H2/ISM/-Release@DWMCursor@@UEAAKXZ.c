/*
 * XREFs of ?Release@DWMCursor@@UEAAKXZ @ 0x180010750
 * Callers:
 *     ?Release@DWMCursor@@W7EAAKXZ @ 0x18004C370 (-Release@DWMCursor@@W7EAAKXZ.c)
 *     ?Release@DWMCursor@@WBA@EAAKXZ @ 0x18004C380 (-Release@DWMCursor@@WBA@EAAKXZ.c)
 * Callees:
