/*
 * XREFs of _ISMHeatFrameworkHost::RegisterForSystemContext_::_1_::dtor$1 @ 0x18012CE3F
 * Callers:
 *     <none>
 * Callees:
 *     <none>
...
void __fastcall ISMHeatFrameworkHost::RegisterForSystemContext_::_1_::dtor_1(__int64 a1, __int64 a2)
{
