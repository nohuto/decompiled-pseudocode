/*
 * XREFs of ?AttachClient@BamoPenEventsDispatcherProxyImpl@BamoImpl@@QEAAJPEAVBamoPenEventsClientPrincipal@@@Z @ 0x1800E321C
 * Callers:
        ...
        struct BamoPenEventsClientPrincipal *a2)
{
  ...
  if ( *(_QWORD *)(*(_QWORD *)(*((_QWORD *)this[2] + 3) + 32LL) + 56LL) )
  {
    ...
    if ( v5 >= 0 )
    {
      ...
      v9[0] = v11;
      v9[1] = v12;
      return CoreUICallSend(v7, v9, 2LL, 54LL, 0, &unk_1801BF1AA, v4);
    }
    else
    {
