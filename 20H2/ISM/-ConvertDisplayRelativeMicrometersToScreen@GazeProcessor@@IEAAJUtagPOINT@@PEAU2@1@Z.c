/*
 * XREFs of ?ConvertDisplayRelativeMicrometersToScreen@GazeProcessor@@IEAAJUtagPOINT@@PEAU2@1@Z @ 0x180188500
 * Callers:
 *     ?OnInputReport@GazeProcessor@@UEAAJPEAUInputInfo@@@Z @ 0x1801889A0 (-OnInputReport@GazeProcessor@@UEAAJPEAUInputInfo@@@Z.c)
 * Callees:
 *     ?GetClippedPointInRect@@YA?AUtagPOINT@@AEBU1@AEBUtagRECT@@PEA_N@Z @ 0x180188640 (-GetClippedPointInRect@@YA-AUtagPOINT@@AEBU1@AEBUtagRECT@@PEA_N@Z.c)
 */
