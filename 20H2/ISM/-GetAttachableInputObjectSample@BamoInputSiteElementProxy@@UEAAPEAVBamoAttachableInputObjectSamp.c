/*
 * XREFs of ?GetAttachableInputObjectSample@BamoInputSiteElementProxy@@UEAAPEAVBamoAttachableInputObjectSampleProxy@@XZ @ 0x180010D20
 * Callers:
 *     <none>
 * Callees:
...
struct BamoAttachableInputObjectSampleProxy *__fastcall BamoInputSiteElementProxy::GetAttachableInputObjectSample(
        BamoInputSiteElementProxy *this)
{
  ...
  if ( *(_DWORD *)(v2 + 168) != CurrentThreadId && *(_DWORD *)(v2 + 24) != CurrentThreadId )
  {
    wil::details::in1diag3::_FailFast_Unexpected(
      ...
      v4);
    JUMPOUT(0x180055F8ELL);
  }
  return (struct BamoAttachableInputObjectSampleProxy *)*((_QWORD *)this + 11);
}
