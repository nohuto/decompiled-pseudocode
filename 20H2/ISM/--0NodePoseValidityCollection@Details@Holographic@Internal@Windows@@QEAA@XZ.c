/*
 * XREFs of ??0NodePoseValidityCollection@Details@Holographic@Internal@Windows@@QEAA@XZ @ 0x180036B84
 * Callers:
 ...
 * Callees:
 *     ??0Entry@NodePoseValidityCollection@Details@Holographic@Internal@Windows@@QEAA@XZ @ 0x18001E1B0 (--0Entry@NodePoseValidityCollection@Details@Holographic@Internal@Windows@@QEAA@XZ.c)
