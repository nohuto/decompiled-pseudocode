/*
 * XREFs of ??$_Erase_tree@V?$allocator@U?$_Tree_node@U?$pair@$$CBU_GUID@@V?$vector@EV?$allocator@E@std@@@std@@@std@@PEAX@std@@@std@@@?$_Tree_val@U?$_Tree_simple_types@U?$pair@$$CBU_GUID@@V?$vector@EV?$allocator@E@std@@@std@@@std@@@std@@@std@@QEAAXAEAV?$allocator@U?$_Tree_node@U?$pair@$$CBU_GUID@@V?$vector@EV?$allocator@E@std@@@std@@@std@@PEAX@std@@@1@PEAU?$_Tree_node@U?$pair@$$CBU_GUID@@V?$vector@EV?$allocator@E@std@@@std@@@std@@PEAX@1@@Z @ 0x180151A98
 * Callers:
 ...
 *     ??1PropertyCache@Holographic@Internal@Windows@@QEAA@XZ @ 0x18015795C (--1PropertyCache@Holographic@Internal@Windows@@QEAA@XZ.c)
...
void __fastcall std::_Tree_val<std::_Tree_simple_types<std::pair<_GUID const,std::vector<unsigned char>>>>::_Erase_tree<std::allocator<std::_Tree_node<std::pair<_GUID const,std::vector<unsigned char>>,void *>>>(
        __int64 a1,
        __int64 a2,
        __int64 a3)
{
  ...
  if ( !*(_BYTE *)(a3 + 25) )
  {
    do
    {
      ...
      v6 = v3;
      v3 = (_QWORD *)*v3;
      std::vector<unsigned char>::_Tidy((__int64)v6 + 48);
