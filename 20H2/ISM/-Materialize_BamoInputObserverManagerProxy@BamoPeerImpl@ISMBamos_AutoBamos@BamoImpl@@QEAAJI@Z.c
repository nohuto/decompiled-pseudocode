/*
 * XREFs of ?Materialize_BamoInputObserverManagerProxy@BamoPeerImpl@ISMBamos_AutoBamos@BamoImpl@@QEAAJI@Z @ 0x1800E75E0
 * Callers:
 *     ?Thunk_Materialize_BamoInputObserverManagerProxy_10@?$IBamoPeer_ISMBamos_AutoBamos_Receive@VBamoPeerImpl@ISMBamos_AutoBamos@BamoImpl@@@@SAJPEAXPEAPEAX@Z @ 0x1800ECB20 (-Thunk_Materialize_BamoInputObserverManagerProxy_10@-$IBamoPeer_ISMBamos_AutoBamos_Receive@VBamo.c)
 * Callees:
