/*
 * XREFs of ?InternalAddRef@?$ComPtr@UIInputTarget@@@WRL@Microsoft@@IEBAXXZ @ 0x1800337B0
 * Callers:
 ...
 *     ?GetFallbackTarget@ContextualProcessorBuffer@@UEAA?AV?$ComPtr@UIInputTarget@@@WRL@Microsoft@@XZ @ 0x18014BE80 (-GetFallbackTarget@ContextualProcessorBuffer@@UEAA-AV-$ComPtr@UIInputTarget@@@WRL@Microsoft@@XZ.c)
