/*
 * XREFs of ??_GContextualProcessorBuffer@@MEAAPEAXI@Z @ 0x18000AE80
 * Callers:
 *     ??_EContextualProcessorBuffer@@OCA@EAAPEAXI@Z @ 0x18004C7E0 (--_EContextualProcessorBuffer@@OCA@EAAPEAXI@Z.c)
 * Callees:
