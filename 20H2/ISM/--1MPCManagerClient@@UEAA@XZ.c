/*
 * XREFs of ??1MPCManagerClient@@UEAA@XZ @ 0x1801067CC
 * Callers:
 ...
 *     ??1?$ComPtr@VEventTargetArray@Details@WRL@Microsoft@@@WRL@Microsoft@@QEAA@XZ @ 0x1801066B4 (--1-$ComPtr@VEventTargetArray@Details@WRL@Microsoft@@@WRL@Microsoft@@QEAA@XZ.c)
