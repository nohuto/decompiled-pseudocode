 ...
 * Callers:
 *     ?Release@GameControllerRawInputProvider@@W7EAAKXZ @ 0x18004A9D0 (-Release@GameControllerRawInputProvider@@W7EAAKXZ.c)
 *     ?Release@GameControllerRawInputProvider@@WBA@EAAKXZ @ 0x18004A9E0 (-Release@GameControllerRawInputProvider@@WBA@EAAKXZ.c)
 *     ?Release@GameControllerRawInputProvider@@WBI@EAAKXZ @ 0x18004A9F0 (-Release@GameControllerRawInputProvider@@WBI@EAAKXZ.c)
 * Callees:
