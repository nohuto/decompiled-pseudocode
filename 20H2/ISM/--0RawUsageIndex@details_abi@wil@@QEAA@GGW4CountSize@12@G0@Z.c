/*
 * XREFs of ??0RawUsageIndex@details_abi@wil@@QEAA@GGW4CountSize@12@G0@Z @ 0x18000562C
 * Callers:
 ...
 * Callees:
 *     ?GetSize@UsageIndexProperty@details_abi@wil@@QEBA_KXZ @ 0x1800056B0 (-GetSize@UsageIndexProperty@details_abi@wil@@QEBA_KXZ.c)
 */
