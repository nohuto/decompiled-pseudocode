/*
 * XREFs of ?UpdateShellGesturesClient@BamoInputSiteElementProxyImpl@BamoImpl@@QEAAJI@Z @ 0x1800F32E0
 * Callers:
        ...
        unsigned int a2)
{
  ...
  *((_QWORD *)this + 22) = v7;
  ...
  if ( *((_BYTE *)this + 28) )
  {
    ...
    v9 = (*(__int64 (__fastcall **)(char *))(*((_QWORD *)this - 2) + 200LL))((char *)this - 16);
    if ( v9 < 0 )
