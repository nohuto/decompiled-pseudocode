/*
 * XREFs of ??$MakeAndInitialize@VMPCMouseProcessor@@UIInputProcessor@@AEAPEAUInputProcessorCreateParams@@@Details@WRL@Microsoft@@YAJPEAPEAUIInputProcessor@@AEAPEAUInputProcessorCreateParams@@@Z @ 0x18001F550
 * Callers:
        ...
        const struct InputProcessorCreateParams **a2)
{
  ...
  *a1 = 0LL;
  v4 = (MPCMouseProcessor *)operator new(0x20F8uLL, (const struct std::nothrow_t *)&std::nothrow);
  if ( !v4 )
