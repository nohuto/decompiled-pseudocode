/*
 * XREFs of ?AttachApplication@BamoSystemCursorControllerPrincipalImpl@BamoImpl@@QEAAJI@Z @ 0x18013B3E0
 * Callers:
 *     ?Thunk_AttachApplication_10@?$ISystemCursorControllerPrincipal_Receive@VBamoSystemCursorControllerPrincipalImpl@BamoImpl@@@@SAJPEAXPEAPEAX@Z @ 0x18013CD60 (-Thunk_AttachApplication_10@-$ISystemCursorControllerPrincipal_Receive@VBamoSystemCursorControll.c)
 * Callees:
