/*
 * XREFs of ??1?$queue@V?$shared_ptr@V?$function@$$A6AXXZ@std@@@std@@V?$deque@V?$shared_ptr@V?$function@$$A6AXXZ@std@@@std@@V?$allocator@V?$shared_ptr@V?$function@$$A6AXXZ@std@@@std@@@2@@2@@std@@QEAA@XZ @ 0x180157570
 * Callers:
 *     _ThreadHelpers::ChainedThreadpoolWorker::ChainedThreadpoolWorker_::_1_::dtor$1 @ 0x1801565E5 (_ThreadHelpers--ChainedThreadpoolWorker--ChainedThreadpoolWorker_--_1_--dtor$1.c)
 * Callees:
