/*
 * XREFs of ?OnHitTest@EdgyProcessor@@UEAAJPEAUHitTestInfo@@PEAVInputContext@@PEAUContextualProcessorInitialState@@@Z @ 0x180177C60
 * Callers:
 *     <none>
 * Callees:
 ...
 *     ?QualifyEdgyHitTestInputReport@EdgyProcessor@@IEAA_NPEAUHitTestInfo@@PEAUEdgyPointerInfo@@@Z @ 0x180177F08 (-QualifyEdgyHitTestInputReport@EdgyProcessor@@IEAA_NPEAUHitTestInfo@@PEAUEdgyPointerInfo@@@Z.c)
