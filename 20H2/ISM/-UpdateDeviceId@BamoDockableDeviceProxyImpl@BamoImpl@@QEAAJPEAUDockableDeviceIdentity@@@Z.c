/*
 * XREFs of ?UpdateDeviceId@BamoDockableDeviceProxyImpl@BamoImpl@@QEAAJPEAUDockableDeviceIdentity@@@Z @ 0x1800ED8B8
 * Callers:
 ...
 *     ?Thunk_UpdateDeviceId_58@?$IDockableDeviceProxy_Receive@VBamoDockableDeviceProxyImpl@BamoImpl@@@@SAJPEAXPEAPEAX@Z @ 0x1800ECD90 (-Thunk_UpdateDeviceId_58@-$IDockableDeviceProxy_Receive@VBamoDockableDeviceProxyImpl@BamoImpl@@@.c)
 * Callees:
