/*
 * XREFs of ?MPCHolographicInputManager_UpdateDoubleClickValues_@ISMTracing@@QEAAXAEB_NAEBH1@Z @ 0x180076FF4
 * Callers:
        ...
        int *a4)
{
  ...
  if ( **((_DWORD **)v7 + 1) > 4u && tlgKeywordOn(*((_QWORD *)v7 + 1), 1LL) )
  {
    ...
    v18 = v9;
    v16 = v8;
    tlgWriteTransfer_EventWriteTransfer(v10, (unsigned __int8 *)dword_1801C788C, 0LL, 0LL, 5u, &v14);
  }
}
