/*
 * XREFs of std::_Func_impl_no_alloc__lambda_3dd39dd98c03cde2644bdcb497ffed4e__void_std::shared_ptr_Windows::Internal::SpatialInteractions::SpatialInteractionSourceDevice__const_&_::_Do_call @ 0x1800D38A0
 * Callers:
 *     <none>
 * Callees:
...
void __fastcall std::_Func_impl_no_alloc__lambda_3dd39dd98c03cde2644bdcb497ffed4e__void_std::shared_ptr_Windows::Internal::SpatialInteractions::SpatialInteractionSourceDevice__const___::_Do_call(
        __int64 a1,
        __int64 *a2)
{
  int updated; // eax
