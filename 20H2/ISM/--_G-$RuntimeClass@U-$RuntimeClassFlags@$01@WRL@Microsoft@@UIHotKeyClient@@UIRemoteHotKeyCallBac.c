/*
 * XREFs of ??_G?$RuntimeClass@U?$RuntimeClassFlags@$01@WRL@Microsoft@@UIHotKeyClient@@UIRemoteHotKeyCallBack@@UIMessageProxyReconnectAdapterOwner@@UIUnknown@@@WRL@Microsoft@@UEAAPEAXI@Z @ 0x180147E30
 * Callers:
 *     <none>
 * Callees:
