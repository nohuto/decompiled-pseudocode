/*
 * XREFs of __scrt_initialize_crt @ 0x18003BD80
 * Callers:
 *     dllmain_crt_process_attach @ 0x18003B788 (dllmain_crt_process_attach.c)
 * Callees:
 *     __isa_available_init @ 0x18003C20C (__isa_available_init.c)
