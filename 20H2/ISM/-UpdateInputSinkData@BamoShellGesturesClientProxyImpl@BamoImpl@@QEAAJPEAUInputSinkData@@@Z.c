/*
 * XREFs of ?UpdateInputSinkData@BamoShellGesturesClientProxyImpl@BamoImpl@@QEAAJPEAUInputSinkData@@@Z @ 0x180101360
 * Callers:
 *     ?UpdateStateOfProxyOnPlaceholderProxyHookUp@BamoShellGesturesClientProxyImpl@BamoImpl@@UEAAXPEAVBamoProxyImpl@2Microsoft@@@Z @ 0x180045900 (-UpdateStateOfProxyOnPlaceholderProxyHookUp@BamoShellGesturesClientProxyImpl@BamoImpl@@UEAAXPEAV.c)
 *     ?Thunk_UpdateInputSinkData_232@?$IShellGesturesClientProxy_Receive@VBamoShellGesturesClientProxyImpl@BamoImpl@@@@SAJPEAXPEAPEAX@Z @ 0x180101350 (-Thunk_UpdateInputSinkData_232@-$IShellGesturesClientProxy_Receive@VBamoShellGesturesClientProxy.c)
 * Callees:
