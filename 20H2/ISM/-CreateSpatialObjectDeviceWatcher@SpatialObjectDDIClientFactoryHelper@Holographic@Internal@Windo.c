/*
 * XREFs of ?CreateSpatialObjectDeviceWatcher@SpatialObjectDDIClientFactoryHelper@Holographic@Internal@Windows@@UEAAJAEBU_GUID@@PEAUISpatialObjectDeviceWatcherCallback@234@PEAPEAUISpatialObjectDeviceWatcher@234@@Z @ 0x1800D7070
 * Callers:
 *     <none>
 * Callees:
