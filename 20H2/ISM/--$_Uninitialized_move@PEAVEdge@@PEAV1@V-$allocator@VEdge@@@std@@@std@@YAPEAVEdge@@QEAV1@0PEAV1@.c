/*
 * XREFs of ??$_Uninitialized_move@PEAVEdge@@PEAV1@V?$allocator@VEdge@@@std@@@std@@YAPEAVEdge@@QEAV1@0PEAV1@AEAV?$allocator@VEdge@@@0@@Z @ 0x18017846C
 * Callers:
 ...
 *     ??0Edge@@QEAA@$$QEAV0@@Z @ 0x180178588 (--0Edge@@QEAA@$$QEAV0@@Z.c)
 */
