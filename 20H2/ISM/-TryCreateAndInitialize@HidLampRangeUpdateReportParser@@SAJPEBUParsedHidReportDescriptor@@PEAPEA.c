/*
 * XREFs of ?TryCreateAndInitialize@HidLampRangeUpdateReportParser@@SAJPEBUParsedHidReportDescriptor@@PEAPEAV1@@Z @ 0x1800ABF48
 * Callers:
 ...
 *     ??0HidLampRangeUpdateReportParser@@AEAA@XZ @ 0x1800ABAAC (--0HidLampRangeUpdateReportParser@@AEAA@XZ.c)
