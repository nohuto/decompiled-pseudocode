/*
 * XREFs of ?QueryInterface@BamoTestCommandsStub@@UEAAJAEBU_GUID@@PEAPEAX@Z @ 0x180170A80
 * Callers:
 *     ?QueryInterface@BamoTestCommandsStub@@W7EAAJAEBU_GUID@@PEAPEAX@Z @ 0x18004CCB0 (-QueryInterface@BamoTestCommandsStub@@W7EAAJAEBU_GUID@@PEAPEAX@Z.c)
 * Callees:
