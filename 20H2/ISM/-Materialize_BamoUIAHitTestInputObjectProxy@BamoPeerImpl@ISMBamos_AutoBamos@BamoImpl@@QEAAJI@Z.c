/*
 * XREFs of ?Materialize_BamoUIAHitTestInputObjectProxy@BamoPeerImpl@ISMBamos_AutoBamos@BamoImpl@@QEAAJI@Z @ 0x1800E82CC
 * Callers:
 *     ?Thunk_Materialize_BamoUIAHitTestInputObjectProxy_10@?$IBamoPeer_ISMBamos_AutoBamos_Receive@VBamoPeerImpl@ISMBamos_AutoBamos@BamoImpl@@@@SAJPEAXPEAPEAX@Z @ 0x1800ECCB0 (-Thunk_Materialize_BamoUIAHitTestInputObjectProxy_10@-$IBamoPeer_ISMBamos_AutoBamos_Receive@VBam.c)
 * Callees:
