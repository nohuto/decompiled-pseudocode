/*
 * XREFs of std::call_once__lambda_7a8cdf47427de701aad174af942599f3___ @ 0x180189988
 * Callers:
...
void __fastcall std::call_once__lambda_7a8cdf47427de701aad174af942599f3___(__int64 a1, __int64 a2)
{
  ...
  if ( std::_Execute_once(
         (struct std::once_flag *)&unk_180208A80,
  ...
  else
  {
    ...
    std::_XGetLastError();
    __debugbreak();
    std::call_once__lambda_7a8cdf47427de701aad174af942599f3____::_1_::dtor_0();
  }
}
