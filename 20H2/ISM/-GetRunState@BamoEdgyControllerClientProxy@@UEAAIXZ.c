/*
 * XREFs of ?GetRunState@BamoEdgyControllerClientProxy@@UEAAIXZ @ 0x1800FF9E0
 * Callers:
 *     ?OnRunStateChanged@EdgyControllerClientProxy@@MEAAJXZ @ 0x1800FFBD0 (-OnRunStateChanged@EdgyControllerClientProxy@@MEAAJXZ.c)
