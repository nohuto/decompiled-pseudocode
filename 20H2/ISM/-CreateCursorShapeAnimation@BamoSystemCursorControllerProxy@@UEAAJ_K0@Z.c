/*
 * XREFs of ?CreateCursorShapeAnimation@BamoSystemCursorControllerProxy@@UEAAJ_K0@Z @ 0x1800E3860
 * Callers:
 *     <none>
 * Callees:
        ...
        unsigned __int64 a3)
{
  ...
  LODWORD(v5) = BamoImpl::BamoSystemCursorControllerProxyImpl::CreateCursorShapeAnimation(
