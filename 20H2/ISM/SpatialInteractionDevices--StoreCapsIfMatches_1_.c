/*
 * XREFs of SpatialInteractionDevices::StoreCapsIfMatches_1_ @ 0x1800C7B90
 * Callers:
...
__int64 __fastcall SpatialInteractionDevices::StoreCapsIfMatches_1_(__int64 a1, __int64 a2, __int64 a3, _BYTE *a4)
{
