/*
 * XREFs of ?Thunk_RegisterEdgyControllerClient_142@?$IEdgyControllerServerPrincipal_Receive@VBamoEdgyControllerServerPrincipalImpl@BamoImpl@@@@SAJPEAXPEAPEAX@Z @ 0x1801004F0
 * Callers:
 *     <none>
 * Callees:
 *     <none>
