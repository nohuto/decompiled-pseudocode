/*
 * XREFs of ?UpdateContainerId@BamoContainerInfoInputObjectProxyImpl@BamoImpl@@QEAAJPEAUCONTAINER_ID@@@Z @ 0x1800ED6FC
 * Callers:
 *     ?UpdateStateOfProxyOnPlaceholderProxyHookUp@BamoContainerInfoInputObjectProxyImpl@BamoImpl@@UEAAXPEAVBamoProxyImpl@2Microsoft@@@Z @ 0x1800437D0 (-UpdateStateOfProxyOnPlaceholderProxyHookUp@BamoContainerInfoInputObjectProxyImpl@BamoImpl@@UEAA.c)
 *     ?Thunk_UpdateContainerId_34@?$IContainerInfoInputObjectProxy_Receive@VBamoContainerInfoInputObjectProxyImpl@BamoImpl@@@@SAJPEAXPEAPEAX@Z @ 0x1800ECD70 (-Thunk_UpdateContainerId_34@-$IContainerInfoInputObjectProxy_Receive@VBamoContainerInfoInputObje.c)
 * Callees:
