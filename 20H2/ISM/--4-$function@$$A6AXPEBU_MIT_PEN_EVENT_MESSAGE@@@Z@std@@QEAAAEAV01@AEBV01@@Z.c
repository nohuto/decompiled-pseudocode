/*
 * XREFs of ??4?$function@$$A6AXPEBU_MIT_PEN_EVENT_MESSAGE@@@Z@std@@QEAAAEAV01@AEBV01@@Z @ 0x18002D88C
 * Callers:
...
__int64 __fastcall std::function<void (_MIT_PEN_EVENT_MESSAGE const *)>::operator=(__int64 a1, __int64 a2)
{
  ...
  if ( v4 == v6 || *(_QWORD *)(a1 + 56) == a1 )
  {
    v9 = 0LL;
    std::_Func_class<void,_MIT_POINTER_INPUT_DOWN_MESSAGE const *>::_Reset_move(v8, v6);
    std::_Func_class<void,_MIT_POINTER_INPUT_DOWN_MESSAGE const *>::_Reset_move(v6, a1);
    std::_Func_class<void,_MIT_POINTER_INPUT_DOWN_MESSAGE const *>::_Reset_move(a1, v8);
