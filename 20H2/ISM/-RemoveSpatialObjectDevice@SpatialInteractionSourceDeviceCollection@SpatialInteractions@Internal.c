/*
 * XREFs of ?RemoveSpatialObjectDevice@SpatialInteractionSourceDeviceCollection@SpatialInteractions@Internal@Windows@@AEAAJPEB_W@Z @ 0x1800D8280
 * Callers:
        ...
        const wchar_t *a2)
{
  ...
  RTL_SRWLOCK *v18; // [rsp+28h] [rbp-A0h]
  __int128 v19; // [rsp+30h] [rbp-98h] BYREF
  __int64 *v20; // [rsp+40h] [rbp-88h]
  int v21[2]; // [rsp+48h] [rbp-80h] BYREF
  char *v22; // [rsp+50h] [rbp-78h]
  void *v23[3]; // [rsp+58h] [rbp-70h] BYREF
  unsigned __int64 v24; // [rsp+70h] [rbp-58h]
  void **v25; // [rsp+90h] [rbp-38h]
  ...
  v20 = 0LL;
  v5 = this + 77;
  AcquireSRWLockExclusive(this + 77);
  try
  {
    v18 = v5;
    std::wstring::wstring(v23, (__int64)a2);
    ...
    *(_QWORD *)v17 = *(_QWORD *)v21;
    ...
    v10 = (__int64 *)v19;
    for ( i = (__int64 *)v19; i != v7; ++i )
    {
      v12 = (*(__int64 (__fastcall **)(__int64))(*(_QWORD *)*i + 56LL))(*i);
      if ( v12 < 0 )
      ...
      *(_QWORD *)v17 = *i;
      ...
      v23[1] = v13;
      v25 = v23;
      v14 = Windows::Internal::SpatialInteractions::SpatialInteractionSourceDeviceCollection::QueueInputThreadCallback(
              this,
              (__int64)v23);
      v15 = v14;
      if ( v14 < 0 )
      {
        ...
        if ( v10 )
        {
          std::_Destroy_range<std::allocator<Microsoft::WRL::ComPtr<Windows::Internal::SpatialInteractions::SpatialInteractionObjectDevice>>>(
            v10,
            v7);
          std::_Deallocate<16,0>(v10, (const struct std::nothrow_t *)(8 * (v4 - v10)));
        }
        return v15;
      }
    }
