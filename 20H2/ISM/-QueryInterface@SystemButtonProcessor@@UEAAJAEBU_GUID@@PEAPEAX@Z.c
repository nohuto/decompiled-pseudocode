/*
 * XREFs of ?QueryInterface@SystemButtonProcessor@@UEAAJAEBU_GUID@@PEAPEAX@Z @ 0x180028C30
 * Callers:
 *     ?QueryInterface@SystemButtonProcessor@@W7EAAJAEBU_GUID@@PEAPEAX@Z @ 0x18004CF10 (-QueryInterface@SystemButtonProcessor@@W7EAAJAEBU_GUID@@PEAPEAX@Z.c)
 * Callees:
