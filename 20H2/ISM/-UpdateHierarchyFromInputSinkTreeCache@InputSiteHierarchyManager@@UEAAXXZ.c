/*
 * XREFs of ?UpdateHierarchyFromInputSinkTreeCache@InputSiteHierarchyManager@@UEAAXXZ @ 0x180015650
 * Callers:
 *     <none>
 * Callees:
 ...
 *     ??0LegacyInputSinkData@@QEAA@$$QEAV?$unique_any_t@V?$unique_storage@U?$handle_null_resource_policy@P6AJPEAX@Z$1?NtCloseCompositionInputSink@@YAJ0@Z@details@wil@@@details@wil@@@wil@@@Z @ 0x180004B58 (--0LegacyInputSinkData@@QEAA@$$QEAV-$unique_any_t@V-$unique_storage@U-$handle_null_resource_poli.c)
 ...
 *     ??0LegacyInputSinkData@@QEAA@$$QEAV0@@Z @ 0x180014E88 (--0LegacyInputSinkData@@QEAA@$$QEAV0@@Z.c)
 ...
 *     ??0InputSinkTreeCache@@QEAA@XZ @ 0x18002AF8C (--0InputSinkTreeCache@@QEAA@XZ.c)
 ...
 *     ??1?$variant@PEAXV?$unique_any_t@V?$unique_storage@U?$handle_null_resource_policy@P6AJPEAX@Z$1?NtCloseCompositionInputSink@@YAJ0@Z@details@wil@@@details@wil@@@wil@@@std@@QEAA@XZ @ 0x180043C44 (--1-$variant@PEAXV-$unique_any_t@V-$unique_storage@U-$handle_null_resource_policy@P6AJPEAX@Z$1-N.c)
 *     ?GetProcessId@InputSite@@QEBAKXZ @ 0x180043C50 (-GetProcessId@InputSite@@QEBAKXZ.c)
 ...
 *     ??0bad_optional_access@std@@QEAA@XZ @ 0x18006DB9C (--0bad_optional_access@std@@QEAA@XZ.c)
...
void __fastcall InputSiteHierarchyManager::UpdateHierarchyFromInputSinkTreeCache(InputSiteHierarchyManager *this)
{
  ...
  v3 = qword_1802085A8;
  v115 = qword_1802085A8;
  v179 = qword_1802085A8;
  v4 = (_QWORD *)xmmword_1802085B0;
  v114 = xmmword_1802085B0;
  v5 = *((_QWORD *)&xmmword_1802085B0 + 1);
  v180 = xmmword_1802085B0;
  qword_1802085A8 = 0LL;
  xmmword_1802085B0 = 0uLL;
  v167 = &SRWLock;
