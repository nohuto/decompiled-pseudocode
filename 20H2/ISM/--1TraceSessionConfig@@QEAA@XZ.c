/*
 * XREFs of ??1TraceSessionConfig@@QEAA@XZ @ 0x1800926EC
 * Callers:
 *     GetHolographicInputSession @ 0x1800931A8 (GetHolographicInputSession.c)
 *     _GetHolographicInputSession_::_1_::dtor$3 @ 0x180093477 (_GetHolographicInputSession_--_1_--dtor$3.c)
 ...
 *     _SpatialRimDeviceCollection::OnDeviceAttach_::_1_::dtor$0 @ 0x180094878 (_SpatialRimDeviceCollection--OnDeviceAttach_--_1_--dtor$0.c)
 *     ?OnFinalRelease@SpatialRimDeviceCollection@@MEAAXXZ @ 0x180094920 (-OnFinalRelease@SpatialRimDeviceCollection@@MEAAXXZ.c)
 *     _SpatialRimDeviceCollection::OnFinalRelease_::_1_::dtor$0 @ 0x180094A30 (_SpatialRimDeviceCollection--OnFinalRelease_--_1_--dtor$0.c)
