/*
 * XREFs of ?UnregisterKeyboardDockClient@KeyboardDockServer@@QEAAJPEAVBamoKeyboardDockClientProxy@@@Z @ 0x180127E30
 * Callers:
 *     ?OnDisconnected@KeyboardDockClientProxy@@MEAAJXZ @ 0x1801287F0 (-OnDisconnected@KeyboardDockClientProxy@@MEAAJXZ.c)
 * Callees:
