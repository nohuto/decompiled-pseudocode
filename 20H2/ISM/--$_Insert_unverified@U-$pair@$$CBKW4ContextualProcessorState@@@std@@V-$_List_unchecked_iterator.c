        ...
        __int64 *a4)
{
  ...
  v8 = (0x100000001B3LL
      * (a3[3] ^ (0x100000001B3LL
                * (a3[2] ^ (0x100000001B3LL * (a3[1] ^ (0x100000001B3LL * (*a3 ^ 0xCBF29CE484222325uLL)))))))) & *(_QWORD *)(a1 + 48);
  v9 = 2 * v8;
  v10 = *(_QWORD *)(a1 + 24);
  v11 = *(_QWORD *)(a1 + 8);
  ...
  if ( v11 != v12 )
  {
    ...
    {
      v11 = *(_QWORD *)(v11 + 8);
      if ( *(_DWORD *)a3 == *(_DWORD *)(v11 + 16) )
      {
        std::list<ISystemContextObserver *>::erase(a1 + 8, v28, a4);
        *(_QWORD *)a2 = v11;
        *(_BYTE *)(a2 + 8) = 0;
        return a2;
      }
  ...
  {
    *(_QWORD *)(v14 + 16 * v8) = a4;
    *(_QWORD *)(*(_QWORD *)(a1 + 24) + 16 * v8 + 8) = a4;
  }
  else
  {
    v24 = (__int64 **)(v14 + 16 * v8);
    if ( v15 == v11 )
    {
      *v24 = a4;
    }
    else
    {
      ...
      v24[1] = *v25;
      if ( v26 != a4 )
        *(_QWORD *)(*(_QWORD *)(a1 + 24) + 8 * v9 + 8) = *(_QWORD *)(*(_QWORD *)(*(_QWORD *)(a1 + 24) + 8 * v9 + 8) + 8LL);
    }
  }
  v16 = *(_QWORD *)(a1 + 16);
  v17 = *(_QWORD *)(a1 + 56);
  if ( v16 < 0 )
  {
    v21 = *(_QWORD *)(a1 + 16) & 1LL | ((unsigned __int64)v16 >> 1);
    v18 = (float)(int)v21 + (float)(int)v21;
  }
  else
  {
    v18 = (float)(int)v16;
  ...
  if ( v17 < 0 )
  {
    ...
    v19 = (float)(int)v22 + (float)(int)v22;
  }
  else
  {
    v19 = (float)(int)v17;
  ...
  {
    v27 = std::_Hash<std::_Umap_traits<IInputTarget *,std::unordered_set<unsigned long>,std::_Uhash_compare<IInputTarget *,std::hash<IInputTarget *>,std::equal_to<IInputTarget *>>,std::allocator<std::pair<IInputTarget * const,std::unordered_set<unsigned long>>>,0>>::_Desired_grow_bucket_count(a1);
    std::_Hash<std::_Umap_traits<unsigned long,unsigned int,std::_Uhash_compare<unsigned long,std::hash<unsigned long>,std::equal_to<unsigned long>>,std::allocator<std::pair<unsigned long const,unsigned int>>,0>>::_Forced_rehash(
      a1,
      v27);
  }
  *(_QWORD *)a2 = a4;
