/*
 * XREFs of ?GetCachedFeatureEnabledState@?$FeatureImpl@U__WilFeatureTraits_Feature_InputSiteTree@@@details@wil@@AEAA?ATwil_details_FeatureStateCache@@XZ @ 0x18003E3E4
 * Callers:
