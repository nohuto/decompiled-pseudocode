/*
 * XREFs of ?GetEnabled@BamoControllerNavigationManagerProxy@@UEAA_NXZ @ 0x1800E6010
 * Callers:
 ...
 *     ?GetEnabled@ControllerNavigationClientProxy@@UEAA_NXZ @ 0x18011E230 (-GetEnabled@ControllerNavigationClientProxy@@UEAA_NXZ.c)
