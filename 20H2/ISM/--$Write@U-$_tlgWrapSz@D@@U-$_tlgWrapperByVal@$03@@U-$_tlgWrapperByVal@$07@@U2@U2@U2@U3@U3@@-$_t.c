        ...
        __int64 a12)
{
  ...
  const unsigned __int16 *v17; // [rsp+50h] [rbp-79h]
  ...
  v17 = v12;
  v19 = 0;
  return tlgWriteTransfer_EventWriteTransfer((__int64)&dword_180205478, a2, 0LL, 0LL, 0xAu, &v16);
}
