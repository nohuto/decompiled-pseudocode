/*
 * XREFs of ?GetLastScrollVelocityAvg@MPCGestureHandlerManager@@QEAAMV?$com_ptr_t@UIMPCInputProviderBase@@Uerr_exception_policy@wil@@@wil@@@Z @ 0x18006B3CC
 * Callers:
...
__m128 __fastcall MPCGestureHandlerManager::GetLastScrollVelocityAvg(__int64 a1, _QWORD *a2)
{
  _QWORD *v3; // rax
  __int64 v4; // r9
  __int64 *v5; // r10
