/*
 * XREFs of ?EndInitialize@SpatialInteractionSourceController@SpatialInteractions@Internal@Windows@@UEAAJXZ @ 0x18016B9B0
 * Callers:
 *     <none>
 * Callees:
 ...
 *     ?SupportsAnalogTrigger@SpatialInteractionDevices@@YAJPEAUHID_HANDLE@1@PEA_N@Z @ 0x1800CA1CC (-SupportsAnalogTrigger@SpatialInteractionDevices@@YAJPEAUHID_HANDLE@1@PEA_N@Z.c)
 ...
 *     _lambda_b6eb6e6574f6e884ecb744657c22bdda_::operator() @ 0x18016A034 (_lambda_b6eb6e6574f6e884ecb744657c22bdda_--operator().c)
 ...
 *     ?GetPosesOffsets@SpatialInteractionSourceController@SpatialInteractions@Internal@Windows@@AEAAJXZ @ 0x18016C6C0 (-GetPosesOffsets@SpatialInteractionSourceController@SpatialInteractions@Internal@Windows@@AEAAJX.c)
 ...
 *     ?SetDeviceErrorStatus@SpatialInteractionSourceController@SpatialInteractions@Internal@Windows@@AEAAXII@Z @ 0x18016EA44 (-SetDeviceErrorStatus@SpatialInteractionSourceController@SpatialInteractions@Internal@Windows@@A.c)
 */
        ...
        struct SpatialInteractionDevices::HID_HANDLE *a2)
{
  ...
  __int64 v20[3]; // [rsp+20h] [rbp-20h] BYREF
  char v21; // [rsp+38h] [rbp-8h]
  wil::details::in1diag3 *retaddr; // [rsp+78h] [rbp+38h]
  unsigned __int8 v23; // [rsp+80h] [rbp+40h] BYREF
      ...
      if ( HapticsCutoffTimeInSeconds >= 0 )
      {
        *((_BYTE *)this + 1021) = *((_BYTE *)this + 748);
        ...
        HapticsCutoffTimeInSeconds = SpatialInteractionDevices::GetHapticsCutoffTimeInSeconds(
                                       v3,
                                       (struct SpatialInteractionDevices::HID_HANDLE *)&v23,
                                       v13);
        if ( HapticsCutoffTimeInSeconds >= 0 )
        {
          *((_WORD *)this + 373) = 1000 * v23;
          v10 = 0;
          goto LABEL_21;
        }
      }
...
LABEL_38:
  v21 = 0;
  lambda_b6eb6e6574f6e884ecb744657c22bdda_::operator()(v20);
