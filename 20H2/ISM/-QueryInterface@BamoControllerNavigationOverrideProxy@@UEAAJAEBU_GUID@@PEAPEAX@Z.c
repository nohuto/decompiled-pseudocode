/*
 * XREFs of ?QueryInterface@BamoControllerNavigationOverrideProxy@@UEAAJAEBU_GUID@@PEAPEAX@Z @ 0x18011E580
 * Callers:
 *     ?QueryInterface@BamoControllerNavigationOverrideProxy@@W7EAAJAEBU_GUID@@PEAPEAX@Z @ 0x18004C090 (-QueryInterface@BamoControllerNavigationOverrideProxy@@W7EAAJAEBU_GUID@@PEAPEAX@Z.c)
 * Callees:
