/*
 * XREFs of ?BroadcastContextMessage@ISMHeatFrameworkHost@@IEAAJPEAV?$variant@Umonostate@std@@UInputConfigContextMessage@@UDisplayOcclusionContextMessage@@UVirtualTouchpadContextMessage@@@std@@PEAUIHeatSystemContextClient@@@Z @ 0x18012C440
 * Callers:
 ...
 *     ??$?0V?$allocator@U?$_List_node@U?$pair@$$CB_KUtagRECT@@@std@@PEAX@std@@@std@@@?$_Hash@V?$_Umap_traits@_KUtagRECT@@V?$_Uhash_compare@_KU?$hash@_K@std@@U?$equal_to@_K@2@@std@@V?$allocator@U?$pair@$$CB_KUtagRECT@@@std@@@3@$0A@@std@@@std@@QEAA@AEBV01@AEBV?$allocator@U?$_List_node@U?$pair@$$CB_KUtagRECT@@@std@@PEAX@std@@@1@@Z @ 0x18012A640 (--$-0V-$allocator@U-$_List_node@U-$pair@$$CB_KUtagRECT@@@std@@PEAX@std@@@std@@@-$_Hash@V-$_Umap_.c)
 ...
 *     ??$emplace@AEA_KUHeatDisplayOcclusionRect@@@?$_Hash@V?$_Umap_traits@_KUHeatDisplayOcclusionRect@@V?$_Uhash_compare@_KU?$hash@_K@std@@U?$equal_to@_K@2@@std@@V?$allocator@U?$pair@$$CB_KUHeatDisplayOcclusionRect@@@std@@@3@$0A@@std@@@std@@QEAA?AU?$pair@V?$_List_iterator@V?$_List_val@U?$_List_simple_types@U?$pair@$$CB_KUHeatDisplayOcclusionRect@@@std@@@std@@@std@@@std@@_N@1@AEA_K$$QEAUHeatDisplayOcclusionRect@@@Z @ 0x18012B9A0 (--$emplace@AEA_KUHeatDisplayOcclusionRect@@@-$_Hash@V-$_Umap_traits@_KUHeatDisplayOcclusionRect@.c)
 *     ??$emplace@AEBUDockInputIdentity@@AEA_K@?$_Tree@V?$_Tmap_traits@UDockInputIdentity@@_KU?$less@UDockInputIdentity@@@std@@V?$allocator@U?$pair@$$CBUDockInputIdentity@@_K@std@@@3@$0A@@std@@@std@@QEAA?AU?$pair@V?$_Tree_iterator@V?$_Tree_val@U?$_Tree_simple_types@U?$pair@$$CBUDockInputIdentity@@_K@std@@@std@@@std@@@std@@_N@1@AEBUDockInputIdentity@@AEA_K@Z @ 0x18012B9F8 (--$emplace@AEBUDockInputIdentity@@AEA_K@-$_Tree@V-$_Tmap_traits@UDockInputIdentity@@_KU-$less@UD.c)
 ...
 *     ??0?$_Hash@V?$_Umap_traits@_KUHeatDisplayOcclusionRect@@V?$_Uhash_compare@_KU?$hash@_K@std@@U?$equal_to@_K@2@@std@@V?$allocator@U?$pair@$$CB_KUHeatDisplayOcclusionRect@@@std@@@3@$0A@@std@@@std@@QEAA@AEBV?$_Uhash_compare@_KU?$hash@_K@std@@U?$equal_to@_K@2@@1@AEBV?$allocator@U?$pair@$$CB_KUHeatDisplayOcclusionRect@@@std@@@1@@Z @ 0x18012BD44 (--0-$_Hash@V-$_Umap_traits@_KUHeatDisplayOcclusionRect@@V-$_Uhash_compare@_KU-$hash@_K@std@@U-$e.c)
 *     ??0HeatDisplayOcclusionRect@@QEAA@AEBUtagRECT@@0QEBG@Z @ 0x18012BE2C (--0HeatDisplayOcclusionRect@@QEAA@AEBUtagRECT@@0QEBG@Z.c)
 *     ?at@?$map@UDockInputIdentity@@_KU?$less@UDockInputIdentity@@@std@@V?$allocator@U?$pair@$$CBUDockInputIdentity@@_K@std@@@3@@std@@QEAAAEA_KAEBUDockInputIdentity@@@Z @ 0x18012D980 (-at@-$map@UDockInputIdentity@@_KU-$less@UDockInputIdentity@@@std@@V-$allocator@U-$pair@$$CBUDock.c)
 */

// Hidden C++ exception states: #wind=1
__int64 __fastcall ISMHeatFrameworkHost::BroadcastContextMessage(
        _QWORD *a1,
        __int64 a2,
        ...
        const char *a4)
{
  ...
  if ( a2 )
  {
    std::variant<std::monostate,HeatInputConfigContextMessage,HeatLowPowerStateContextMessage,HeatHingeAngleContextMessage,HeatDisplayOcclusionContextMessage,HeatVirtualTouchpadContextMessage>::emplace<HeatInputConfigContextMessage,unsigned long &,INPUT_SPACE_PAYLOAD * &,1,0>(
      (__int64)v21,
      (unsigned int *)a2,
      (__int64 *)(a2 + 8));
  }
  else
  {
    ...
    if ( v8 )
    {
      ...
      {
        v11 = v10 + 32;
        HeatDisplayOcclusionRect::HeatDisplayOcclusionRect(
          (HeatDisplayOcclusionRect *)v25,
          (const struct tagRECT *)(v10 + 56),
          (const struct tagRECT *)(v10 + 72),
          (size_t *)(v10 + 88));
        ...
        if ( v20 == a1[24] )
        {
          v18 = a1[26];
          a1[26] = v18 + 1;
          std::_Tree<std::_Tmap_traits<DockInputIdentity,unsigned __int64,std::less<DockInputIdentity>,std::allocator<std::pair<DockInputIdentity const,unsigned __int64>>,0>>::emplace<DockInputIdentity const &,unsigned __int64 &>(
            v13,
            (__int64)v23,
            v12,
            &v18);
        ...
        {
          v18 = *(_QWORD *)std::map<DockInputIdentity,unsigned __int64>::at(v13, v11);
        }
        std::_Hash<std::_Umap_traits<unsigned __int64,HeatDisplayOcclusionRect,std::_Uhash_compare<unsigned __int64,std::hash<unsigned __int64>,std::equal_to<unsigned __int64>>,std::allocator<std::pair<unsigned __int64 const,HeatDisplayOcclusionRect>>,0>>::emplace<unsigned __int64 &,HeatDisplayOcclusionRect>(
          (__int64)v21,
          (__int64)v24,
          &v18,
          (__int64)v25);
  ...
  else
  {
    ...
    for ( i = *v15; i != (__int64 **)v15; i = (__int64 **)*i )
      (*(void (__fastcall **)(__int64 *, _BYTE *))*i[2])(i[2], v21);
  }
  std::_Variant_raw_visit1<2>::_Visit<_lambda_7c9a1ed22efa7e719e5ba754edc265b7_,std::_Variant_storage_<0,std::monostate,HeatInputConfigContextMessage,HeatLowPowerStateContextMessage,HeatHingeAngleContextMessage,HeatDisplayOcclusionContextMessage,HeatVirtualTouchpadContextMessage> &>(
    v22 + 1,
    v7,
