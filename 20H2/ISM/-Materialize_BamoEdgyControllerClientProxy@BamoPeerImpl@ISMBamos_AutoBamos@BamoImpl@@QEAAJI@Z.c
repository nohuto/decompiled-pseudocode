/*
 * XREFs of ?Materialize_BamoEdgyControllerClientProxy@BamoPeerImpl@ISMBamos_AutoBamos@BamoImpl@@QEAAJI@Z @ 0x1800E7140
 * Callers:
 *     ?Thunk_Materialize_BamoEdgyControllerClientProxy_10@?$IBamoPeer_ISMBamos_AutoBamos_Receive@VBamoPeerImpl@ISMBamos_AutoBamos@BamoImpl@@@@SAJPEAXPEAPEAX@Z @ 0x1800ECA80 (-Thunk_Materialize_BamoEdgyControllerClientProxy_10@-$IBamoPeer_ISMBamos_AutoBamos_Receive@VBamo.c)
 * Callees:
