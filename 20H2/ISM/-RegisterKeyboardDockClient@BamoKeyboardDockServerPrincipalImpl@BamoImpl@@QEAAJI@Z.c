/*
 * XREFs of ?RegisterKeyboardDockClient@BamoKeyboardDockServerPrincipalImpl@BamoImpl@@QEAAJI@Z @ 0x180127158
 * Callers:
 *     ?Thunk_RegisterKeyboardDockClient_10@?$IKeyboardDockServerPrincipal_Receive@VBamoKeyboardDockServerPrincipalImpl@BamoImpl@@@@SAJPEAXPEAPEAX@Z @ 0x180127E20 (-Thunk_RegisterKeyboardDockClient_10@-$IKeyboardDockServerPrincipal_Receive@VBamoKeyboardDockSer.c)
 * Callees:
