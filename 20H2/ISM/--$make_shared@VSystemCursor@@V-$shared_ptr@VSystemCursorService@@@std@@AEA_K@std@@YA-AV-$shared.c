/*
 * XREFs of ??$make_shared@VSystemCursor@@V?$shared_ptr@VSystemCursorService@@@std@@AEA_K@std@@YA?AV?$shared_ptr@VSystemCursor@@@0@$$QEAV?$shared_ptr@VSystemCursorService@@@0@AEA_K@Z @ 0x18013DE70
 * Callers:
 ...
 *     ??0SystemCursor@@QEAA@V?$shared_ptr@VSystemCursorService@@@std@@_K@Z @ 0x18013E150 (--0SystemCursor@@QEAA@V-$shared_ptr@VSystemCursorService@@@std@@_K@Z.c)
 */
