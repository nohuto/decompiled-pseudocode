        ...
        void *a3)
{
  ...
  *(_QWORD *)(*(_QWORD *)a3 + 8LL) = *((_QWORD *)a3 + 1);
  --*(_QWORD *)(a1 + 8);
  Microsoft::WRL::ComPtr<IUnknown>::InternalRelease((__int64 *)a3 + 4);
  v6 = *((_QWORD *)a3 + 3);
  if ( v6 )
  {
    *((_QWORD *)a3 + 3) = 0LL;
