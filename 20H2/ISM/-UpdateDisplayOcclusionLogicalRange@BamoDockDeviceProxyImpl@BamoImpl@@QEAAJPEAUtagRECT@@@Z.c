/*
 * XREFs of ?UpdateDisplayOcclusionLogicalRange@BamoDockDeviceProxyImpl@BamoImpl@@QEAAJPEAUtagRECT@@@Z @ 0x1800ED960
 * Callers:
 ...
 *     ?Thunk_UpdateDisplayOcclusionLogicalRange_39@?$IDockDeviceProxy_Receive@VBamoDockDeviceProxyImpl@BamoImpl@@@@SAJPEAXPEAPEAX@Z @ 0x1800ECDA0 (-Thunk_UpdateDisplayOcclusionLogicalRange_39@-$IDockDeviceProxy_Receive@VBamoDockDeviceProxyImpl.c)
 * Callees:
        ...
        struct tagRECT *a2)
{
  ...
  *(struct tagRECT *)((char *)this + 44) = *a2;
  if ( *((_BYTE *)this + 28) )
  {
