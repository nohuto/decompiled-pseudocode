/*
 * XREFs of ??$_Callback_once@V?$tuple@$$QEAV_lambda_f0f9811b609bc44f6b5f596bb37acf9a_@@AEAVexception_ptr@std@@@std@@U?$integer_sequence@_K$0A@@2@$00@std@@YAHPEAX0PEAPEAX@Z @ 0x18003AC80
 * Callers:
 *     <none>
 * Callees:
