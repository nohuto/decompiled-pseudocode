/*
 * XREFs of ?Initialize@DockDevice@@QEAAJPEAUDockDeviceInfo@@@Z @ 0x18009E138
 * Callers:
 ...
 * Callees:
 *     ?Log_HrIfMsg@in1diag3@details@wil@@YA_NPEAXIPEBDJ_N1ZZ @ 0x18002E3C0 (-Log_HrIfMsg@in1diag3@details@wil@@YA_NPEAXIPEBDJ_N1ZZ.c)
 *     ?StringCchCopyW@@YAJPEAG_KPEBG@Z @ 0x180031B2C (-StringCchCopyW@@YAJPEAG_KPEBG@Z.c)
 ...
 *     ?_Log_NtStatus@in1diag3@details@wil@@YAXPEAXIPEBDJ@Z @ 0x180090800 (-_Log_NtStatus@in1diag3@details@wil@@YAXPEAXIPEBDJ@Z.c)
 ...
 *     ??$make_unique@$$BY0A@G$0A@@std@@YA?AV?$unique_ptr@$$BY0A@GU?$default_delete@$$BY0A@G@std@@@0@_K@Z @ 0x18009DBFC (--$make_unique@$$BY0A@G$0A@@std@@YA-AV-$unique_ptr@$$BY0A@GU-$default_delete@$$BY0A@G@std@@@0@_K.c)
 *     ??$make_unique@$$BY0A@U_HIDP_LINK_COLLECTION_NODE@@$0A@@std@@YA?AV?$unique_ptr@$$BY0A@U_HIDP_LINK_COLLECTION_NODE@@U?$default_delete@$$BY0A@U_HIDP_LINK_COLLECTION_NODE@@@std@@@0@_K@Z @ 0x18009DC64 (--$make_unique@$$BY0A@U_HIDP_LINK_COLLECTION_NODE@@$0A@@std@@YA-AV-$unique_ptr@$$BY0A@U_HIDP_LIN.c)
 *     ??$make_unique@$$BY0A@U_HIDP_VALUE_CAPS@@$0A@@std@@YA?AV?$unique_ptr@$$BY0A@U_HIDP_VALUE_CAPS@@U?$default_delete@$$BY0A@U_HIDP_VALUE_CAPS@@@std@@@0@_K@Z @ 0x18009DCCC (--$make_unique@$$BY0A@U_HIDP_VALUE_CAPS@@$0A@@std@@YA-AV-$unique_ptr@$$BY0A@U_HIDP_VALUE_CAPS@@U.c)
 */
...
__int64 __fastcall DockDevice::Initialize(DockDevice *this, struct DockDeviceInfo *a2)
{
  ...
  if ( v6 >= 0 )
  {
    ...
    *(_QWORD *)&v40 = LinkCollectionNodes;
    ...
    if ( v10 >= 0 )
    {
      if ( dword_1802094D4 > *(_DWORD *)(*((_QWORD *)NtCurrentTeb()->ThreadLocalStoragePointer + (unsigned int)tls_index)
                                       + 16LL) )
      {
        Init_thread_header(&dword_1802094D4);
        if ( dword_1802094D4 == -1 )
        {
          dword_180209370 = 2;
          *(_OWORD *)&xmmword_180209360 = DEVPKEY_Device_PanelId;
          dword_180209374 = 0;
          qword_180209378 = 0LL;
          Init_thread_footer(&dword_1802094D4);
        }
      }
