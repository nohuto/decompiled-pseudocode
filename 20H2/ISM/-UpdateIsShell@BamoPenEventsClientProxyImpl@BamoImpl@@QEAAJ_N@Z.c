/*
 * XREFs of ?UpdateIsShell@BamoPenEventsClientProxyImpl@BamoImpl@@QEAAJ_N@Z @ 0x180134AB4
 * Callers:
 ...
 *     ?Thunk_UpdateIsShell_13@?$IPenEventsClientProxy_Receive@VBamoPenEventsClientProxyImpl@BamoImpl@@@@SAJPEAXPEAPEAX@Z @ 0x180134860 (-Thunk_UpdateIsShell_13@-$IPenEventsClientProxy_Receive@VBamoPenEventsClientProxyImpl@BamoImpl@@.c)
 * Callees:
