/*
 * XREFs of ?GenerateMouseLeaveEventMessage@Win32kInterop@@AEBAXAEBV?$ComPtr@UIInputTarget@@@WRL@Microsoft@@@Z @ 0x1800B0344
 * Callers:
 ...
 *     ??$As@UIInputDestInputTarget@@@?$ComPtr@UIInputTarget@@@WRL@Microsoft@@QEBAJV?$ComPtrRef@V?$ComPtr@UIInputDestInputTarget@@@WRL@Microsoft@@@Details@12@@Z @ 0x1800AC760 (--$As@UIInputDestInputTarget@@@-$ComPtr@UIInputTarget@@@WRL@Microsoft@@QEBAJV-$ComPtrRef@V-$ComP.c)
 */
