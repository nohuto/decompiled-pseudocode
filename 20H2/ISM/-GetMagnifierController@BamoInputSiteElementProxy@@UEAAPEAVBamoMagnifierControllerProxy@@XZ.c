/*
 * XREFs of ?GetMagnifierController@BamoInputSiteElementProxy@@UEAAPEAVBamoMagnifierControllerProxy@@XZ @ 0x180010A50
 * Callers:
 *     <none>
 * Callees:
        ...
        BamoInputSiteElementProxy *this)
{
  ...
  if ( *(_DWORD *)(v2 + 168) != CurrentThreadId && *(_DWORD *)(v2 + 24) != CurrentThreadId )
  {
    wil::details::in1diag3::_FailFast_Unexpected(
      ...
      v4);
    JUMPOUT(0x180055EB6LL);
  }
  return (struct BamoMagnifierControllerProxy *)*((_QWORD *)this + 20);
}
