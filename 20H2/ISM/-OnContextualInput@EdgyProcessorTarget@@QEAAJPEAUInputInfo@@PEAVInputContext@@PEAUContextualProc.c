/*
 * XREFs of ?OnContextualInput@EdgyProcessorTarget@@QEAAJPEAUInputInfo@@PEAVInputContext@@PEAUContextualProcessorResponse@@@Z @ 0x18017A704
 * Callers:
 ...
 *     ?HasCandidates@EdgyImpl@@QEAA_NXZ @ 0x18017B94C (-HasCandidates@EdgyImpl@@QEAA_NXZ.c)
