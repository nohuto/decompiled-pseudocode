/*
 * XREFs of ?GetCachedFeatureEnabledState@?$FeatureImpl@U__WilFeatureTraits_Feature_Input_HeatMultiDevice@@@details@wil@@AEAA?ATwil_details_FeatureStateCache@@XZ @ 0x18004A0E4
 * Callers:
