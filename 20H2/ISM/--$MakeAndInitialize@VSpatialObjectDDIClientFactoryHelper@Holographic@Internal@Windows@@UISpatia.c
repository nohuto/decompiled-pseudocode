/*
 * XREFs of ??$MakeAndInitialize@VSpatialObjectDDIClientFactoryHelper@Holographic@Internal@Windows@@UISpatialObjectDDIClientFactory@234@$$V@Details@WRL@Microsoft@@YAJPEAPEAUISpatialObjectDDIClientFactory@Holographic@Internal@Windows@@@Z @ 0x1800D4988
 * Callers:
 ...
 *     ??0SpatialObjectDDIClientFactoryHelper@Holographic@Internal@Windows@@QEAA@XZ @ 0x1800D58CC (--0SpatialObjectDDIClientFactoryHelper@Holographic@Internal@Windows@@QEAA@XZ.c)
