/*
 * XREFs of ??0ForegroundManager@@AEAA@XZ @ 0x1800336BC
 * Callers:
 ...
 * Callees:
 *     ??0?$KernelInputConnection@U_tagActivationObjectNotification@@@@QEAA@PEBD@Z @ 0x180045E74 (--0-$KernelInputConnection@U_tagActivationObjectNotification@@@@QEAA@PEBD@Z.c)
