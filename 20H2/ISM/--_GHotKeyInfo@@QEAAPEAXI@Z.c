/*
 * XREFs of ??_GHotKeyInfo@@QEAAPEAXI@Z @ 0x18019F5B0
 * Callers:
 ...
 *     ?_Destroy@?$_Ref_count_obj@UHotKeyInfo@@@std@@EEAAXXZ @ 0x1801A1E30 (-_Destroy@-$_Ref_count_obj@UHotKeyInfo@@@std@@EEAAXXZ.c)
 * Callees:
