/*
 * XREFs of SpatialInteractionDevices::ReadPosePosition @ 0x1800C9F04
 * Callers:
 ...
 * Callees:
 *     SpatialInteractionDevices::ParseFloatData_DirectX::XMFLOAT3_ @ 0x1800C77A0 (SpatialInteractionDevices--ParseFloatData_DirectX--XMFLOAT3_.c)
 */
