/*
 * XREFs of ?Materialize_BamoResizeControllerClientProxy@BamoPeerImpl@ISMBamos_AutoBamos@BamoImpl@@QEAAJI@Z @ 0x1800E7D60
 * Callers:
 *     ?Thunk_Materialize_BamoResizeControllerClientProxy_10@?$IBamoPeer_ISMBamos_AutoBamos_Receive@VBamoPeerImpl@ISMBamos_AutoBamos@BamoImpl@@@@SAJPEAXPEAPEAX@Z @ 0x1800ECC40 (-Thunk_Materialize_BamoResizeControllerClientProxy_10@-$IBamoPeer_ISMBamos_AutoBamos_Receive@VBa.c)
 * Callees:
        ...
        unsigned int a2)
{
  ...
  *v9 = &BamoResizeControllerClientProxy::`vftable'{for `Microsoft::Bamo::BamoProxy'};
  v9[1] = &BamoResizeControllerClientProxy::`vftable'{for `IResizeControllerClientProxy'};
  *((_DWORD *)v9 + 6) = 0;
  v9[4] = 0LL;
  *((_DWORD *)v9 + 10) = 0;
  *((_DWORD *)v9 + 11) = 0;
