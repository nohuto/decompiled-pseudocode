/*
 * XREFs of wil::init_once_nothrow__lambda_2e51b86642a92e3b17e4afda222f3187___ @ 0x18014683C
 * Callers:
        ...
        _BYTE *a3)
{
  ...
  if ( a3 )
    *a3 = 0;
  if ( !InitOnceBeginInitialize(&stru_180209488, 0, &fPending, 0LL) )
  ...
  if ( fPending )
  {
    ...
    if ( a3 )
      *a3 = 1;
    InitOnceComplete(&stru_180209488, 0, 0LL);
  }
  return 0LL;
}
