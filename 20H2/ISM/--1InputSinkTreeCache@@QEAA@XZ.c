/*
 * XREFs of ??1InputSinkTreeCache@@QEAA@XZ @ 0x18003B49C
 * Callers:
 *     _InputSinkTreeCache::GetInstance_::_2_::_dynamic_atexit_destructor_for__instance__ @ 0x1800517F0 (_InputSinkTreeCache--GetInstance_--_2_--_dynamic_atexit_destructor_for__instance__.c)
 * Callees:
