/*
 * XREFs of ?HandReportIgnored_@SpatialInteractionTraceContinuous@SpatialInteractionDevices@@QEAAXU_GUID@@_JHH_N2@Z @ 0x1800DF960
 * Callers:
        ...
        bool a7)
{
  ...
  v20 = this;
  v10 = 1000000 * a3 / qword_180208308;
