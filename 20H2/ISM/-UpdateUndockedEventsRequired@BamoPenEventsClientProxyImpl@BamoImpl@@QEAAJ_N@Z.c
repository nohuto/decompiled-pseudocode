/*
 * XREFs of ?UpdateUndockedEventsRequired@BamoPenEventsClientProxyImpl@BamoImpl@@QEAAJ_N@Z @ 0x180134D44
 * Callers:
 ...
 *     ?Thunk_UpdateUndockedEventsRequired_13@?$IPenEventsClientProxy_Receive@VBamoPenEventsClientProxyImpl@BamoImpl@@@@SAJPEAXPEAPEAX@Z @ 0x1801348A0 (-Thunk_UpdateUndockedEventsRequired_13@-$IPenEventsClientProxy_Receive@VBamoPenEventsClientProxy.c)
 * Callees:
