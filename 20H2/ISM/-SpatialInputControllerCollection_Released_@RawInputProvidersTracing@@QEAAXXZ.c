/*
 * XREFs of ?SpatialInputControllerCollection_Released_@RawInputProvidersTracing@@QEAAXXZ @ 0x180095804
 * Callers:
...
void __fastcall RawInputProvidersTracing::SpatialInputControllerCollection_Released_(RawInputProvidersTracing *this)
{
  ...
  if ( *(_DWORD *)v1[1] > 4u && tlgKeywordOn(v1[1], 2LL) )
    tlgWriteTransfer_EventWriteTransfer(v3, (unsigned __int8 *)dword_1801C998B, 0LL, 0LL, v2, &v4);
}
