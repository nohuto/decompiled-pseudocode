/*
 * XREFs of ?QueryInterface@BamoDockDevicePrincipal@@UEAAJAEBU_GUID@@PEAPEAX@Z @ 0x180126E00
 * Callers:
 *     ?QueryInterface@BamoDockDevicePrincipal@@W7EAAJAEBU_GUID@@PEAPEAX@Z @ 0x18004C100 (-QueryInterface@BamoDockDevicePrincipal@@W7EAAJAEBU_GUID@@PEAPEAX@Z.c)
 * Callees:
