/*
 * XREFs of ?OnActivationObjectNotification@ForegroundManager@@AEAAXPEBU_tagActivationObjectNotification@@@Z @ 0x18001A5E0
 * Callers:
 ...
 *     ?ActivationNotificationSourceToString@InputTraceLogging@@CAPEBDAEBW4ACTIVATIONOBJECTSTATECHANGE_REASON@@@Z @ 0x180045EA0 (-ActivationNotificationSourceToString@InputTraceLogging@@CAPEBDAEBW4ACTIVATIONOBJECTSTATECHANGE_.c)
 *     ?attach@?$com_ptr_t@VBamoActivatableEntityPrincipal@@Uerr_exception_policy@wil@@@wil@@QEAAXPEAVBamoActivatableEntityPrincipal@@@Z @ 0x180046274 (-attach@-$com_ptr_t@VBamoActivatableEntityPrincipal@@Uerr_exception_policy@wil@@@wil@@QEAAXPEAVB.c)
 *     _guard_dispatch_icall_nop @ 0x18004A660 (_guard_dispatch_icall_nop.c)
 *     ??8@YA_NAEBU_LUID@@0@Z @ 0x1800B6D60 (--8@YA_NAEBU_LUID@@0@Z.c)
 *     ??$Write@U?$_tlgWrapSz@D@@U1@U?$_tlgWrapperByVal@$07@@U2@U2@U2@U?$_tlgWrapperByVal@$03@@@?$_tlgWriteTemplate@$$A6AJPEBU_tlgProvider_t@@PEBXPEBU_GUID@@2IPEAU_EVENT_DATA_DESCRIPTOR@@@Z$1?_tlgWriteTransfer_EventWriteTransfer@@YAJ0122I3@ZPEBU2@PEBU2@@@SAJPEBU_tlgProvider_t@@PEBXPEBU_GUID@@2AEBU?$_tlgWrapSz@D@@3AEBU?$_tlgWrapperByVal@$07@@444AEBU?$_tlgWrapperByVal@$03@@@Z @ 0x1801040C8 (--$Write@U-$_tlgWrapSz@D@@U1@U-$_tlgWrapperByVal@$07@@U2@U2@U2@U-$_tlgWrapperByVal@$03@@@-$_tlgW.c)
