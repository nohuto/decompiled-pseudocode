/*
 * XREFs of ??0SpatialInteractionSourceController@SpatialInteractions@Internal@Windows@@QEAA@PEAUIHidDevice@123@KKV?$function@$$A6AXXZ@std@@@Z @ 0x180169604
 * Callers:
 ...
 *     ??0HID_HANDLE@SpatialInteractionDevices@@QEAA@XZ @ 0x1800CB36C (--0HID_HANDLE@SpatialInteractionDevices@@QEAA@XZ.c)
 *     ??0?$function@$$A6AXXZ@std@@QEAA@$$QEAV01@@Z @ 0x1801564CC (--0-$function@$$A6AXXZ@std@@QEAA@$$QEAV01@@Z.c)
 ...
 *     ??0SpatialInteractionSourceDevice@SpatialInteractions@Internal@Windows@@QEAA@KKW4InputType@@@Z @ 0x18016997C (--0SpatialInteractionSourceDevice@SpatialInteractions@Internal@Windows@@QEAA@KKW4InputType@@@Z.c)
        ...
        __int64 a5)
{
  ...
  *(_OWORD *)((char *)&v19.m256i_u64[1] + 4) = xmmword_1801C6360;
