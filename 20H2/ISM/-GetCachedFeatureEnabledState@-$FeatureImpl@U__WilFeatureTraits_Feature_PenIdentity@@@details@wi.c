/*
 * XREFs of ?GetCachedFeatureEnabledState@?$FeatureImpl@U__WilFeatureTraits_Feature_PenIdentity@@@details@wil@@AEAA?ATwil_details_FeatureStateCache@@XZ @ 0x180040EB0
 * Callers:
