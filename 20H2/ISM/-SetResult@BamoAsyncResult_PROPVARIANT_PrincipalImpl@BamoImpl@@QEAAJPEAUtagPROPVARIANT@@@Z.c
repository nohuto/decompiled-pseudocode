/*
 * XREFs of ?SetResult@BamoAsyncResult_PROPVARIANT_PrincipalImpl@BamoImpl@@QEAAJPEAUtagPROPVARIANT@@@Z @ 0x18011A970
 * Callers:
 *     ?Thunk_SetResult_0@?$IAsyncResult_PROPVARIANT_Principal_Receive@VBamoAsyncResult_PROPVARIANT_PrincipalImpl@BamoImpl@@@@SAJPEAXPEAPEAX@Z @ 0x18011AA80 (-Thunk_SetResult_0@-$IAsyncResult_PROPVARIANT_Principal_Receive@VBamoAsyncResult_PROPVARIANT_Pri.c)
 * Callees:
