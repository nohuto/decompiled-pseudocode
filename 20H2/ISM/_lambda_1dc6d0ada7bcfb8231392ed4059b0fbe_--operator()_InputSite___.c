/*
 * XREFs of _lambda_1dc6d0ada7bcfb8231392ed4059b0fbe_::operator()_InputSite___ @ 0x180044044
 * Callers:
...
char __fastcall lambda_1dc6d0ada7bcfb8231392ed4059b0fbe_::operator()_InputSite___(__int64 a1, InputSite **a2)
{
  ...
  if ( *(_DWORD *)a1 == 1 && (v4 = *((_QWORD *)*a2 + 3)) != 0 )
  {
    ...
    v6 = *(_DWORD *)(a1 + 16);
    v7 = *((_DWORD *)*a2 + 4);
    v8 = (unsigned int)InputSite::GetProcessId(*a2) == v6 || !v6 || !(unsigned int)InputSite::GetProcessId(*a2);
    if ( v7 != 1 || v4 != v5 || !v8 )
      return 0;
  }
  else
