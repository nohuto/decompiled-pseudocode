/*
 * XREFs of ?UpdateInputSiteManager@BamoInputSystemProxyImpl@BamoImpl@@QEAAJI@Z @ 0x1800EE704
 * Callers:
 ...
 *     ?Thunk_UpdateInputSiteManager_10@?$IInputSystemProxy_Receive@VBamoInputSystemProxyImpl@BamoImpl@@@@SAJPEAXPEAPEAX@Z @ 0x1800ECED0 (-Thunk_UpdateInputSiteManager_10@-$IInputSystemProxy_Receive@VBamoInputSystemProxyImpl@BamoImpl@.c)
 * Callees:
