 ...
 *     ?GetControllerVirtualKeyMappingFor@ControllerProcessor@@SAGW4GameInputGamepadButtons@@@Z @ 0x180120784 (-GetControllerVirtualKeyMappingFor@ControllerProcessor@@SAGW4GameInputGamepadButtons@@@Z.c)
  ...
  v4 = 16
     * ((0x100000001B3LL
       * (a3[3] ^ (0x100000001B3LL
                 * (a3[2] ^ (0x100000001B3LL * (a3[1] ^ (0x100000001B3LL * (*a3 ^ 0xCBF29CE484222325uLL)))))))) & qword_180208C30);
  v5 = *(__int64 **)(v4 + qword_180208C18);
  v6 = qword_180208C18 + v4;
  for ( i = v5; ; i = (__int64 *)*i )
  {
    v8 = v5 == (__int64 *)qword_180208C08 ? qword_180208C08 : **(_QWORD **)(v6 + 8);
    if ( i == (__int64 *)v8 )
      break;
