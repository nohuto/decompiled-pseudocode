/*
 * XREFs of ?RegisterEdgyControllerClient@BamoEdgyControllerServerPrincipalImpl@BamoImpl@@QEAAJPEBGI@Z @ 0x180100358
 * Callers:
 *     ?Thunk_RegisterEdgyControllerClient_142@?$IEdgyControllerServerPrincipal_Receive@VBamoEdgyControllerServerPrincipalImpl@BamoImpl@@@@SAJPEAXPEAPEAX@Z @ 0x1801004F0 (-Thunk_RegisterEdgyControllerClient_142@-$IEdgyControllerServerPrincipal_Receive@VBamoEdgyContro.c)
 * Callees:
        ...
        unsigned int a3)
{
  ...
  Microsoft::BamoImpl::DropAndReacquireLock::DropAndReacquireLock(
    ...
    v10);
  v14 = (*(__int64 (__fastcall **)(char *, __int64, const unsigned __int16 *, char *))(*((_QWORD *)this - 2) + 72LL))(
          (char *)this - 16,
          v8,
          a2,
          v13);
