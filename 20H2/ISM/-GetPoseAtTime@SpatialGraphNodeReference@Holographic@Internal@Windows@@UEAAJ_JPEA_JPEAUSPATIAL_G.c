/*
 * XREFs of ?GetPoseAtTime@SpatialGraphNodeReference@Holographic@Internal@Windows@@UEAAJ_JPEA_JPEAUSPATIAL_GRAPH_DYNAMIC_NODE_POSE@@@Z @ 0x18015D520
 * Callers:
 *     <none>
 * Callees:
        ...
        struct SPATIAL_GRAPH_DYNAMIC_NODE_POSE *a4)
{
  ...
  *(_QWORD *)v29 = v32;
  ...
  if ( v6 - 1 <= 1 )
  {
    ...
    {
      if ( v32 - (__int64)v37 < qword_180208318 )
      {
        v17 = *((_QWORD *)this + 13);
        v28 = 0;
