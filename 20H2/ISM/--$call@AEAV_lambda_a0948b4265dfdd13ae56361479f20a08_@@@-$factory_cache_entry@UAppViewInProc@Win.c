/*
 * XREFs of ??$call@AEAV_lambda_a0948b4265dfdd13ae56361479f20a08_@@@?$factory_cache_entry@UAppViewInProc@WindowManagement@ApplicationModel@Internal@Windows@winrt@@UIAppViewStatics@23456@@impl@winrt@@QEAA?AUAppViewWatcher@WindowManagement@ApplicationModel@Internal@Windows@2@AEAV_lambda_a0948b4265dfdd13ae56361479f20a08_@@@Z @ 0x1800337D0
 * Callers:
 ...
 *     ??0hstring@param@winrt@@QEAA@AEBV?$basic_string_view@GU?$char_traits@G@std@@@std@@@Z @ 0x180033B08 (--0hstring@param@winrt@@QEAA@AEBV-$basic_string_view@GU-$char_traits@G@std@@@std@@@Z.c)
 ...
 *     WINRT_InterlockedPushEntrySList @ 0x18003DCBD (WINRT_InterlockedPushEntrySList.c)
        ...
        __int64 a2)
{
  ...
  v8 = a2;
  v9[3] = &qword_180208AF8;
  _InterlockedIncrement64(&qword_180208AF8);
  if ( `winrt::impl::call_factory<winrt::Windows::Internal::ApplicationModel::WindowManagement::AppViewInProc,winrt::Windows::Internal::ApplicationModel::WindowManagement::IAppViewStatics,_lambda_a0948b4265dfdd13ae56361479f20a08_>'::`2'::factory )
  {
    ...
    _InterlockedDecrement64(&qword_180208AF8);
    return a2;
  }
  _InterlockedDecrement64(&qword_180208AF8);
