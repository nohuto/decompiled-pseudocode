/*
 * XREFs of ??1LampArrayRawInputProvider@@EEAA@XZ @ 0x18009E850
 * Callers:
 ...
 *     ?Clear@?$NtList@UDeviceListEntry@PnpDeviceWatcher@@@@QEAAXXZ @ 0x18009EAA4 (-Clear@-$NtList@UDeviceListEntry@PnpDeviceWatcher@@@@QEAAXXZ.c)
