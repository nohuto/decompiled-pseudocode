/*
 * XREFs of ?Slerp@MPCMath@@YA?AUfloat3@Numerics@Foundation@Windows@@U2345@0M@Z @ 0x180086224
 * Callers:
 ...
 * Callees:
 *     acosf_0 @ 0x18004A5B7 (acosf_0.c)
 *     cosf_0 @ 0x18004A5E7 (cosf_0.c)
 *     sinf_0 @ 0x18004A5FF (sinf_0.c)
 */
