/*
 * XREFs of ?OnVoiceEvent@BamoMPCInputObjectProxyImpl@BamoImpl@@QEAAJAEBUMPCTraceInfo@@AEBW4PhrasePriv@Internal@Spatial@Input@UI@Windows@@AEBUPoseDataMsg@56789@AEBUHitObjectMsg@56789@@Z @ 0x1800E9894
 * Callers:
  ...
  if ( *(_QWORD *)(*(_QWORD *)(*(_QWORD *)(*((_QWORD *)this + 2) + 24LL) + 32LL) + 56LL) )
  {
    ...
    if ( v11 >= 0 )
    {
      ...
      *((_OWORD *)v17 + 6) = v30;
      ...
      v34[1] = v32[0];
      v31 = 1;
      return CoreUICallSend(v13, v34, 2LL, 46LL, v31, &unk_1801BF257, (unsigned int)&v33);
    }
    else
    {
