/*
 * XREFs of ?OnGamepadExclusivityExited@BamoMPCManagerClientPrincipalImpl@BamoImpl@@QEAAJXZ @ 0x18010C874
 * Callers:
 *     ?Thunk_OnGamepadExclusivityExited_41@?$IMPCManagerClientPrincipal_Receive@VBamoMPCManagerClientPrincipalImpl@BamoImpl@@@@SAJPEAXPEAPEAX@Z @ 0x18010D430 (-Thunk_OnGamepadExclusivityExited_41@-$IMPCManagerClientPrincipal_Receive@VBamoMPCManagerClientP.c)
 * Callees:
        ...
        BamoImpl::BamoMPCManagerClientPrincipalImpl *this)
{
  ...
  v5 = (*(__int64 (__fastcall **)(char *, __int64))(*((_QWORD *)this - 2) + 104LL))((char *)this - 16, v4);
  if ( v5 < 0 )
