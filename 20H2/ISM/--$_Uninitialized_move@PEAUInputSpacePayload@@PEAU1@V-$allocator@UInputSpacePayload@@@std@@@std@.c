/*
 * XREFs of ??$_Uninitialized_move@PEAUInputSpacePayload@@PEAU1@V?$allocator@UInputSpacePayload@@@std@@@std@@YAPEAUInputSpacePayload@@QEAU1@0PEAU1@AEAV?$allocator@UInputSpacePayload@@@0@@Z @ 0x18012B81C
 * Callers:
