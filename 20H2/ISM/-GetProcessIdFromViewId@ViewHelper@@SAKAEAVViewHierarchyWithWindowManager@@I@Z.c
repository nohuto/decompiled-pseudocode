/*
 * XREFs of ?GetProcessIdFromViewId@ViewHelper@@SAKAEAVViewHierarchyWithWindowManager@@I@Z @ 0x1800BCBFC
 * Callers:
...
__int64 __fastcall ViewHelper::GetProcessIdFromViewId(struct ViewHierarchyWithWindowManager *a1, unsigned int a2)
{
  char v2; // si
  ...
  if ( v4 )
  {
    v5 = winrt::impl::consume_Windows_Internal_ApplicationModel_WindowManagement_IAppView<winrt::Windows::Internal::ApplicationModel::WindowManagement::IAppView>::Window(
           &v10,
           v8);
    v6 = (*(__int64 (__fastcall **)(_QWORD, __int64 *))(*(_QWORD *)*v5 + 104LL))(*v5, &v9);
    if ( v6 < 0 )
