/*
 * XREFs of ?CreateChildInputProcessor@@YAJW4InputType@@PEAUInputProcessorCreateParams@@PEAPEAUIInputProcessor@@@Z @ 0x180028440
 * Callers:
 ...
 * Callees:
 *     ?CreateInputProcessorWorker@@YAJPEAUInputProcessorCreateParams@@PEAPEAUIInputProcessor@@W4InputType@@H@Z @ 0x180027FB0 (-CreateInputProcessorWorker@@YAJPEAUInputProcessorCreateParams@@PEAPEAUIInputProcessor@@W4InputT.c)
 *     ?ValidateParams@@YAJPEBUInputProcessorCreateParams@@_N@Z @ 0x180028D00 (-ValidateParams@@YAJPEBUInputProcessorCreateParams@@_N@Z.c)
 *     ?Return_Hr@in1diag3@details@wil@@YAXPEAXIPEBDJ@Z @ 0x1800357E0 (-Return_Hr@in1diag3@details@wil@@YAXPEAXIPEBDJ@Z.c)
 *     ?IsSingleBit@@YAHJ@Z @ 0x18003AF68 (-IsSingleBit@@YAHJ@Z.c)
...
LABEL_20:
    wil::details::in1diag3::FailFast_Hr(
      ...
      v15[0]);
    JUMPOUT(0x18005CC10LL);
  }
  v8 = 0;
  while ( 1 )
  {
    v9 = 48LL * v8;
    v10 = *(_QWORD *)v15 - *(_QWORD *)((char *)&unk_180205000 + v9);
    if ( *(_QWORD *)v15 == *(_QWORD *)((char *)&unk_180205000 + v9) )
      v10 = *(_QWORD *)&v15[2] - *(_QWORD *)((char *)&unk_180205000 + v9 + 8);
    if ( !v10 )
      break;
  ...
  v11 = v8 + 1;
  if ( *(_DWORD *)((char *)&unk_180205000 + v9 + 16) != a1 )
    v11 = 0;
