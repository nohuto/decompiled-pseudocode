/*
 * XREFs of ?UpdateEdgyControllerServer@BamoInputSystemProxyImpl@BamoImpl@@QEAAJI@Z @ 0x1800EDC68
 * Callers:
 ...
 *     ?Thunk_UpdateEdgyControllerServer_10@?$IInputSystemProxy_Receive@VBamoInputSystemProxyImpl@BamoImpl@@@@SAJPEAXPEAPEAX@Z @ 0x1800ECDD0 (-Thunk_UpdateEdgyControllerServer_10@-$IInputSystemProxy_Receive@VBamoInputSystemProxyImpl@BamoI.c)
 * Callees:
