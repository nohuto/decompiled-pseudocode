/*
 * XREFs of ?AllocateStubThunk@BamoEdgyControllerServerPrincipalImpl@BamoImpl@@UEAAJPEAVBaseBamoPeerImpl@2Microsoft@@PEAPEAVBamoStub@Bamo@4@@Z @ 0x180011220
 * Callers:
 *     <none>
 * Callees:
        ...
        struct Microsoft::Bamo::BamoStub **a3)
{
  ...
  v5 = (*(__int64 (__fastcall **)(BamoImpl::BamoEdgyControllerServerPrincipalImpl *))(*(_QWORD *)this + 48LL))(this);
