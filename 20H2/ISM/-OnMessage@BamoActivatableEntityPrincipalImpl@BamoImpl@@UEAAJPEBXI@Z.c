/*
 * XREFs of ?OnMessage@BamoActivatableEntityPrincipalImpl@BamoImpl@@UEAAJPEBXI@Z @ 0x180105510
 * Callers:
 *     <none>
 * Callees:
        ...
        const void *a2)
{
  ...
  result = CoreUICallReceive(
             *(_QWORD *)(*(_QWORD *)(*((_QWORD *)this + 2) + 32LL) + 72LL),
             &IActivatableEntityPrincipal_Receive<BamoImpl::BamoActivatableEntityPrincipalImpl>::Type,
