/*
 * XREFs of ?GetCachedFeatureEnabledState@?$FeatureImpl@U__WilFeatureTraits_Feature_MinQMouseAndMiP@@@details@wil@@AEAA?ATwil_details_FeatureStateCache@@XZ @ 0x180041520
 * Callers:
