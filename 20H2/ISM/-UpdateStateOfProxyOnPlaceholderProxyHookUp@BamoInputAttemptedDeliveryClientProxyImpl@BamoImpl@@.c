/*
 * XREFs of ?UpdateStateOfProxyOnPlaceholderProxyHookUp@BamoInputAttemptedDeliveryClientProxyImpl@BamoImpl@@UEAAXPEAVBamoProxyImpl@2Microsoft@@@Z @ 0x180045C50
 * Callers:
 *     <none>
 * Callees:
 ...
 *     ??1DropAndReacquireLock@BamoImpl@Microsoft@@QEAA@XZ @ 0x18006DCA8 (--1DropAndReacquireLock@BamoImpl@Microsoft@@QEAA@XZ.c)
 */
