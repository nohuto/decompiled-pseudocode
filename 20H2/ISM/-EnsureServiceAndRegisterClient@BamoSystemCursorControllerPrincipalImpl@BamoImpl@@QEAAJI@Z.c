/*
 * XREFs of ?EnsureServiceAndRegisterClient@BamoSystemCursorControllerPrincipalImpl@BamoImpl@@QEAAJI@Z @ 0x18013C6DC
 * Callers:
 *     ?Thunk_EnsureServiceAndRegisterClient_10@?$ISystemCursorControllerPrincipal_Receive@VBamoSystemCursorControllerPrincipalImpl@BamoImpl@@@@SAJPEAXPEAPEAX@Z @ 0x18013CE10 (-Thunk_EnsureServiceAndRegisterClient_10@-$ISystemCursorControllerPrincipal_Receive@VBamoSystemC.c)
 * Callees:
