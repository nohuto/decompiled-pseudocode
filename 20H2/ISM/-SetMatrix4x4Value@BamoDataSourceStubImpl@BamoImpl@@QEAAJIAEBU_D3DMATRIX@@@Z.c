/*
 * XREFs of ?SetMatrix4x4Value@BamoDataSourceStubImpl@BamoImpl@@QEAAJIAEBU_D3DMATRIX@@@Z @ 0x180143ADC
 * Callers:
...
LABEL_3:
  ...
  v17 = v10;
  v18 = v11;
  return CoreUICallSend(v13, v14, 2LL, 5LL, v12, &unk_1801C09A5, a2);
}
