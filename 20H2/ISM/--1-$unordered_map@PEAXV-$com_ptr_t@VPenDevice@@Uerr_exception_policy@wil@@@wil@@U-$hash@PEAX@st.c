/*
 * XREFs of ??1?$unordered_map@PEAXV?$com_ptr_t@VPenDevice@@Uerr_exception_policy@wil@@@wil@@U?$hash@PEAX@std@@U?$equal_to@PEAX@4@V?$allocator@U?$pair@QEAXV?$com_ptr_t@VPenDevice@@Uerr_exception_policy@wil@@@wil@@@std@@@4@@std@@QEAA@XZ @ 0x18012E93C
 * Callers:
 *     _PenDeviceManager::PenDeviceManager_::_1_::dtor$1 @ 0x18012E87D (_PenDeviceManager--PenDeviceManager_--_1_--dtor$1.c)
 * Callees:
