/*
 * XREFs of ?QueryInterface@TapProcessor@@UEAAJAEBU_GUID@@PEAPEAX@Z @ 0x180181A20
 * Callers:
 *     ?QueryInterface@TapProcessor@@W7EAAJAEBU_GUID@@PEAPEAX@Z @ 0x18004CEC0 (-QueryInterface@TapProcessor@@W7EAAJAEBU_GUID@@PEAPEAX@Z.c)
 *     ?QueryInterface@TapProcessor@@WBA@EAAJAEBU_GUID@@PEAPEAX@Z @ 0x18004CED0 (-QueryInterface@TapProcessor@@WBA@EAAJAEBU_GUID@@PEAPEAX@Z.c)
 * Callees:
