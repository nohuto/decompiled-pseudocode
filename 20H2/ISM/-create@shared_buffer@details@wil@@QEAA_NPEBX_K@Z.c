/*
 * XREFs of ?create@shared_buffer@details@wil@@QEAA_NPEBX_K@Z @ 0x180067D88
 * Callers:
 ...
 *     ?what@ResultException@wil@@UEBAPEBDXZ @ 0x180067F20 (-what@ResultException@wil@@UEBAPEBDXZ.c)
 * Callees:
 *     memcpy_s @ 0x180029CD8 (memcpy_s.c)
 *     ?assign@shared_buffer@details@wil@@AEAAXPEAJ_K@Z @ 0x180067D44 (-assign@shared_buffer@details@wil@@AEAAXPEAJ_K@Z.c)
