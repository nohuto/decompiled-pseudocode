/*
 * XREFs of ??1?$map@UDockInputIdentity@@_KU?$less@UDockInputIdentity@@@std@@V?$allocator@U?$pair@$$CBUDockInputIdentity@@_K@std@@@3@@std@@QEAA@XZ @ 0x18012C050
 * Callers:
 *     _ISMHeatFrameworkHost::ISMHeatFrameworkHost_::_1_::dtor$5 @ 0x18012BFAB (_ISMHeatFrameworkHost--ISMHeatFrameworkHost_--_1_--dtor$5.c)
 * Callees:
