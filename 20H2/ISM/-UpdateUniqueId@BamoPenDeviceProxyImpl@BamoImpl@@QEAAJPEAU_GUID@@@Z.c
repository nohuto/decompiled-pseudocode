/*
 * XREFs of ?UpdateUniqueId@BamoPenDeviceProxyImpl@BamoImpl@@QEAAJPEAU_GUID@@@Z @ 0x1800EFCB4
 * Callers:
 ...
 *     ?Thunk_UpdateUniqueId_29@?$IPenDeviceProxy_Receive@VBamoPenDeviceProxyImpl@BamoImpl@@@@SAJPEAXPEAPEAX@Z @ 0x1800ED0B0 (-Thunk_UpdateUniqueId_29@-$IPenDeviceProxy_Receive@VBamoPenDeviceProxyImpl@BamoImpl@@@@SAJPEAXPE.c)
 * Callees:
