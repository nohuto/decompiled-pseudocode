/*
 * XREFs of ?Remove@InjectionDevice@@QEAAJXZ @ 0x180121864
 * Callers:
 *     ??1ControllerProcessor@@MEAA@XZ @ 0x18011F578 (--1ControllerProcessor@@MEAA@XZ.c)
 *     ??1InjectionDevice@@QEAA@XZ @ 0x18011F7B4 (--1InjectionDevice@@QEAA@XZ.c)
 *     ??1KeyboardInjectionDevice@@QEAA@XZ @ 0x18011F7D4 (--1KeyboardInjectionDevice@@QEAA@XZ.c)
