/*
 * XREFs of ?QueryInterface@BamoResizeContextualProcessorPrincipal@@UEAAJAEBU_GUID@@PEAPEAX@Z @ 0x1800FC970
 * Callers:
 *     ?QueryInterface@BamoResizeContextualProcessorPrincipal@@W7EAAJAEBU_GUID@@PEAPEAX@Z @ 0x18004B480 (-QueryInterface@BamoResizeContextualProcessorPrincipal@@W7EAAJAEBU_GUID@@PEAPEAX@Z.c)
 * Callees:
