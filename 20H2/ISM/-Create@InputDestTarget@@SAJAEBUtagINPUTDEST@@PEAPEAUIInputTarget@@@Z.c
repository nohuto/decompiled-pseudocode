/*
 * XREFs of ?Create@InputDestTarget@@SAJAEBUtagINPUTDEST@@PEAPEAUIInputTarget@@@Z @ 0x18013A38C
 * Callers:
 ...
 *     ??0InputDestTarget@@QEAA@AEBUtagINPUTDEST@@@Z @ 0x18013A204 (--0InputDestTarget@@QEAA@AEBUtagINPUTDEST@@@Z.c)
 */
