/*
 * XREFs of ?SetHapticsFeedback_@SpatialInteractionTraceContinuous@SpatialInteractionDevices@@QEAAXJKKGEG@Z @ 0x18016ECC8
 * Callers:
        ...
        unsigned __int16 a7)
{
  ...
  if ( *(_DWORD *)v10[1] > 5u && tlgKeywordOn(v10[1], 2LL) )
  {
    ...
    v23 = 4LL;
    v21 = 4LL;
    tlgWriteTransfer_EventWriteTransfer(v12, (unsigned __int8 *)dword_1801D0B4D, 0LL, 0LL, 8u, &v19);
  }
}
