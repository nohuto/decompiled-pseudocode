/*
 * XREFs of ??$_tlgWriteActivityAutoStop@$0EAAAAAAAAAAA@$04@@YAXPEBU_tlgProvider_t@@PEBU_GUID@@@Z @ 0x180155AA0
 * Callers:
...
void __fastcall _tlgWriteActivityAutoStop<70368744177664,5>(_DWORD *a1)
{
  ...
  if ( *a1 > 5u && tlgKeywordOn((__int64)a1, 0x400000000000LL) )
    tlgWriteTransfer_EventWriteTransfer(v2, (unsigned __int8 *)dword_1801D0955, v1, 0LL, 2u, &v3);
}
