/*
 * XREFs of ??1DisplayOcclusionContextMessage@@QEAA@XZ @ 0x18012C178
 * Callers:
 *     _DisplayOcclusionContextProvider::Broadcast_::_1_::dtor$1 @ 0x180146B0B (_DisplayOcclusionContextProvider--Broadcast_--_1_--dtor$1.c)
 *     _DisplayOcclusionContextProvider::GetCurrentContext_::_1_::dtor$1 @ 0x180146BCB (_DisplayOcclusionContextProvider--GetCurrentContext_--_1_--dtor$1.c)
 * Callees:
