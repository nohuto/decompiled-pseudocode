/*
 * XREFs of ?SetForegroundActivatableEntity@ForegroundManager@InputTraceLogging@@SAX_K@Z @ 0x180104BB0
 * Callers:
...
void __fastcall InputTraceLogging::ForegroundManager::SetForegroundActivatableEntity(__int64 a1)
{
  ...
  if ( **((_DWORD **)v2 + 1) > 4u && tlgKeywordOn(*((_QWORD *)v2 + 1), 0x8000LL) )
  {
    ...
    v4 = a1;
    v7 = 8;
    tlgWriteTransfer_EventWriteTransfer(v3, (unsigned __int8 *)dword_1801CDCDE, 0LL, 0LL, 3u, &v5);
  }
}
