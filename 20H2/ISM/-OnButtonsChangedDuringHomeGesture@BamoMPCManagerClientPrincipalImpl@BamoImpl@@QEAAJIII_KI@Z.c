/*
 * XREFs of ?OnButtonsChangedDuringHomeGesture@BamoMPCManagerClientPrincipalImpl@BamoImpl@@QEAAJIII_KI@Z @ 0x18010C604
 * Callers:
 *     ?Thunk_OnButtonsChangedDuringHomeGesture_71@?$IMPCManagerClientPrincipal_Receive@VBamoMPCManagerClientPrincipalImpl@BamoImpl@@@@SAJPEAXPEAPEAX@Z @ 0x1800467D0 (-Thunk_OnButtonsChangedDuringHomeGesture_71@-$IMPCManagerClientPrincipal_Receive@VBamoMPCManager.c)
 * Callees:
