/*
 * XREFs of ?SpatialObjectEnsureDynamicNodeInfoFailed_@SpatialInteractionTrace@SpatialInteractionDevices@@QEAAXAEBU_GUID@@J@Z @ 0x1800D894C
 * Callers:
