/*
 * XREFs of ??1?$unordered_map@KV?$ComPtr@VDataSourcePrincipal@@@WRL@Microsoft@@U?$hash@K@std@@U?$equal_to@K@5@V?$allocator@U?$pair@$$CBKV?$ComPtr@VDataSourcePrincipal@@@WRL@Microsoft@@@std@@@5@@std@@QEAA@XZ @ 0x1800F8194
 * Callers:
 *     _DragNDropProcessor::DragNDropProcessor_::_1_::dtor$9 @ 0x1800F7FFA (_DragNDropProcessor--DragNDropProcessor_--_1_--dtor$9.c)
 *     _ResizeProcessor::ResizeProcessor_::_1_::dtor$7 @ 0x1800FD566 (_ResizeProcessor--ResizeProcessor_--_1_--dtor$7.c)
 * Callees:
