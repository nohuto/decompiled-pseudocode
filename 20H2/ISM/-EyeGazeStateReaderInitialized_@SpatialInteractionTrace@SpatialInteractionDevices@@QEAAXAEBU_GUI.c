/*
 * XREFs of ?EyeGazeStateReaderInitialized_@SpatialInteractionTrace@SpatialInteractionDevices@@QEAAXAEBU_GUID@@_N@Z @ 0x1800DB574
 * Callers:
        ...
        char a3)
{
  ...
  if ( **((_DWORD **)v5 + 1) > 4u && tlgKeywordOn(*((_QWORD *)v5 + 1), 2LL) )
  {
    ...
    v9 = a2;
    v10 = 16;
    tlgWriteTransfer_EventWriteTransfer(v6, (unsigned __int8 *)dword_1801CC914, 0LL, 0LL, 4u, &v8);
  }
}
