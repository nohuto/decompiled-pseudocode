/*
 * XREFs of EngCopyBits @ 0x1C009C350
 * Callers:
 ...
 *     ?pfnGetRLESrcCopy@@YAP6AHPEAUBLTINFO@@@ZKK@Z @ 0x1C009CBE0 (-pfnGetRLESrcCopy@@YAP6AHPEAUBLTINFO@@@ZKK@Z.c)
