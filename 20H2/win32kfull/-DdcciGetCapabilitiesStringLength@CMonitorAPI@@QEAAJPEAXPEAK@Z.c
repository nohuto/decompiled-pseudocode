/*
 * XREFs of ?DdcciGetCapabilitiesStringLength@CMonitorAPI@@QEAAJPEAXPEAK@Z @ 0x1C0270B1C
 * Callers:
 *     NtGdiDDCCIGetCapabilitiesStringLength @ 0x1C0271840 (NtGdiDDCCIGetCapabilitiesStringLength.c)
 * Callees:
