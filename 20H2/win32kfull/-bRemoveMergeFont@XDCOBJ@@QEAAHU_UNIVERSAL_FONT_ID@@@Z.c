/*
 * XREFs of ?bRemoveMergeFont@XDCOBJ@@QEAAHU_UNIVERSAL_FONT_ID@@@Z @ 0x1C02AC558
 * Callers:
...
LABEL_8:
    ...
    {
      v13 = v4[1];
      if ( v4 == *(_QWORD **)(*(_QWORD *)a1 + 2056LL) )
        *(_QWORD *)(*(_QWORD *)a1 + 2056LL) = v13;
      else
        v5[1] = v13;
      Win32FreePool(v4);
    }
