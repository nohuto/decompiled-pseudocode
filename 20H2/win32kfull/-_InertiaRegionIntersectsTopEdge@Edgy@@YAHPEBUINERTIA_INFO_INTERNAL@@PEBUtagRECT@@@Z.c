/*
 * XREFs of ?_InertiaRegionIntersectsTopEdge@Edgy@@YAHPEBUINERTIA_INFO_INTERNAL@@PEBUtagRECT@@@Z @ 0x1C020806C
 * Callers:
 ...
 *     GetInertiaRegionInVirtualizedScreen @ 0x1C0217FB8 (GetInertiaRegionInVirtualizedScreen.c)
 */
