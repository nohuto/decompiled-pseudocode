/*
 * XREFs of ?HidRequestValidityCheck@@YAHQEAUtagRAWINPUTDEVICE@@PEBUtagPROCESS_HID_TABLE@@W4_REGISTER_RAW_INPUT_INTERNAL@@@Z @ 0x1C00FF820
 * Callers:
...
__int64 __fastcall HidRequestValidityCheck(__int64 a1, __int64 a2, __int64 a3)
{
  ...
  if ( (v8 & 0x200) != 0 )
  {
    ...
    if ( *(_WORD *)(a1 + 2) == 2 )
    {
      ...
      if ( (_BYTE)v12 != 48
        || !v5
        || *(_QWORD *)(*(_QWORD *)(v5 + 16) + 424LL) != PsGetCurrentProcessWin32Process(v12, a2, a3) )
      {
        goto LABEL_40;
      }
    }
...
LABEL_14:
  ...
  if ( *(_QWORD *)(*(_QWORD *)(v5 + 16) + 424LL) == PsGetCurrentProcessWin32Process(v9, a2, a3) )
  {
LABEL_20:
