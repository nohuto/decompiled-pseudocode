/*
 * XREFs of ?UnlinkAndFreeThreadPointerData@@YAXPEAUtagTHREADINPUTPOINTERLIST@@PEAUtagTHREADPOINTERDATA@@@Z @ 0x1C01F105C
 * Callers:
 *     xxxCleanupThreadPointerInputInfo @ 0x1C00FCC40 (xxxCleanupThreadPointerInputInfo.c)
 *     EditionUnlinkAndFreeThreadPointerData @ 0x1C01F1D20 (EditionUnlinkAndFreeThreadPointerData.c)
 * Callees:
 *     <none>
 */
