/*
 * XREFs of TraceLoggingRegisterEx_EtwRegister_EtwSetInformation @ 0x1C037B6C8
 * Callers:
 *     ??0InteractiveControlManager@@AEAA@XZ @ 0x1C000ACF0 (--0InteractiveControlManager@@AEAA@XZ.c)
 *     EnableUserkTraceLogging @ 0x1C01240D0 (EnableUserkTraceLogging.c)
 *     InitializeTelemetryAssertsKMByName @ 0x1C01286F8 (InitializeTelemetryAssertsKMByName.c)
