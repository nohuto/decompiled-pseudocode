/*
 * XREFs of xxxDesktopThreadWaiter @ 0x1C007E9C8
 * Callers:
 ...
 *     SleepInputIdle @ 0x1C007EBB4 (SleepInputIdle.c)
 *     xxxRemoveQueueCompletion @ 0x1C007EC40 (xxxRemoveQueueCompletion.c)
 *     zzzWakeInputIdle @ 0x1C007ED48 (zzzWakeInputIdle.c)
...
__int64 __fastcall xxxDesktopThreadWaiter(char a1, char a2)
{
  ...
  v4 = (LegacyInputDispatcher *)qword_1C0339F20;
  if ( gptiCurrent == gTermIO[2] )
    v4 = (LegacyInputDispatcher *)qword_1C0339F28;
  v5 = *((_DWORD *)v4 + 15);
  v6 = 0;
  if ( a1 )
  {
