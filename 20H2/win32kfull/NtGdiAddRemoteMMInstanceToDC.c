/*
 * XREFs of NtGdiAddRemoteMMInstanceToDC @ 0x1C027C3D0
 * Callers:
 *     <none>
 * Callees:
 ...
 *     ??0PUBLIC_PFTOBJ@@QEAA@XZ @ 0x1C015D1F8 (--0PUBLIC_PFTOBJ@@QEAA@XZ.c)
 ...
 *     ?GreGetBaseUFIBits@@YAHPEAU_UNIVERSAL_FONT_ID@@PEAU_FONTFILEVIEW@@@Z @ 0x1C027B06C (-GreGetBaseUFIBits@@YAHPEAU_UNIVERSAL_FONT_ID@@PEAU_FONTFILEVIEW@@@Z.c)
 */
