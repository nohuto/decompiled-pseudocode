/*
 * XREFs of ?vGetBlendInfo@@YAXKPEAVSURFACE@@KPEAU_BLENDINFO@@@Z @ 0x1C00DE8CC
 * Callers:
 *     vSrcOpaqCopyS8D32 @ 0x1C00DE320 (vSrcOpaqCopyS8D32.c)
 *     ?pvFillOpaqTableCT@@YAPEAXKKKPEAVSURFACE@@PEAU_BLENDINFO@@H@Z @ 0x1C00DE818 (-pvFillOpaqTableCT@@YAPEAXKKKPEAVSURFACE@@PEAU_BLENDINFO@@H@Z.c)
 * Callees:
...
LABEL_25:
    ...
    DWORD1(v27[0]) = v16;
    LODWORD(v27[2]) = v12;
    *((_QWORD *)&v27[1] + 1) = __PAIR64__(v13, v11);
    DWORD1(v27[1]) = v14;
    goto LABEL_9;
  }
  v10 = 5;
...
LABEL_9:
  ...
  *(_QWORD *)&v27[3] = v21;
  ...
  DWORD2(v27[2]) = v21[(unsigned __int8)((unsigned __int64)((a3 & (unsigned int)v13) << v18) >> v15)];
  v24 = v21[(unsigned __int8)((unsigned __int64)((a3 & (unsigned int)v12) << v19) >> v14)];
  *(_OWORD *)a4 = v27[0];
  *((_OWORD *)a4 + 1) = v23;
  v25 = v27[3];
  HIDWORD(v27[2]) = v24;
