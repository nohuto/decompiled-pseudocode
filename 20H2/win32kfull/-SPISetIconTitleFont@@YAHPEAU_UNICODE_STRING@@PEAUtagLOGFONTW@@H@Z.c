/*
 * XREFs of ?SPISetIconTitleFont@@YAHPEAU_UNICODE_STRING@@PEAUtagLOGFONTW@@H@Z @ 0x1C01D642C
 * Callers:
...
__int64 __fastcall SPISetIconTitleFont(struct _UNICODE_STRING *a1, struct tagLOGFONTW *a2, __int64 a3)
{
  int v3; // r15d
  BOOL v6; // ebp
  unsigned int v7; // edi
  ...
  v6 = a3 == 0;
  v7 = 0;
  v8 = *(unsigned __int16 *)(PsGetCurrentProcessWin32Process(a1, a2, a3) + 284);
