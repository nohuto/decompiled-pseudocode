/*
 * XREFs of ?vLockShadow@PANSURFLOCK@@QEAAXPEAU_RECTL@@PEAU_CLIPOBJ@@H@Z @ 0x1C029624C
 * Callers:
 ...
 *     ?ShadowUnLockWait@@YAXPEAU_PANDEV@@@Z @ 0x1C0295AD4 (-ShadowUnLockWait@@YAXPEAU_PANDEV@@@Z.c)
 */
