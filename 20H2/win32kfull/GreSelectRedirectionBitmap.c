/*
 * XREFs of GreSelectRedirectionBitmap @ 0x1C00408E0
 * Callers:
 ...
 *     ?MulGetBitmapForDisplayDevice@@YAPEAUHBITMAP__@@PEAUHDEV__@@0PEAU1@@Z @ 0x1C02A2C00 (-MulGetBitmapForDisplayDevice@@YAPEAUHBITMAP__@@PEAUHDEV__@@0PEAU1@@Z.c)
 */
...
__int64 __fastcall GreSelectRedirectionBitmap(__int64 a1, HBITMAP a2)
{
  ...
  __int64 v29; // rdi
  int v30; // eax
  _QWORD v31[7]; // [rsp+20h] [rbp-38h] BYREF
