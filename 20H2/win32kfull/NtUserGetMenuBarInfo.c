/*
 * XREFs of NtUserGetMenuBarInfo @ 0x1C00F0C30
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall NtUserGetMenuBarInfo(__int64 a1, int a2, int a3, ULONG64 a4)
{
  ...
  if ( v10 )
  {
    *(_QWORD *)&v41 = *(_QWORD *)(gptiCurrent + 416LL);
    ...
    *v11 = *v11;
    ...
    MenuBarInfo = xxxGetMenuBarInfo((struct tagWND *)v10, a2, a3, (__int64)&v43);
    ...
    if ( (*(_BYTE *)(*(_QWORD *)(v14 + 480) + 224LL) & 1) == 0 )
    {
      ...
      if ( (*(_BYTE *)(*(_QWORD *)(v24 + 480) + 224LL) & 0x20) == 0 )
      {
