/*
 * XREFs of ?xxxSPISetMinMetrics@@YAHPEAU_UNICODE_STRING@@PEAUtagMINIMIZEDMETRICS@@H@Z @ 0x1C0022F6C
 * Callers:
...
__int64 __fastcall xxxSPISetMinMetrics(struct _UNICODE_STRING *a1, struct tagMINIMIZEDMETRICS *a2, __int64 a3)
{
  int v3; // r15d
  BOOL v6; // r14d
  unsigned int v7; // edi
