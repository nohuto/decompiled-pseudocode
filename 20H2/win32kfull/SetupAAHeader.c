/*
 * XREFs of SetupAAHeader @ 0x1C006F890
 * Callers:
 *     AAHalftoneBitmap @ 0x1C006D780 (AAHalftoneBitmap.c)
 * Callees:
 *     _ALIGN_MEM @ 0x1C0070134 (_ALIGN_MEM.c)
 *     ComputeByteOffset @ 0x1C0070164 (ComputeByteOffset.c)
 *     ComputeInputColorInfo @ 0x1C00701B8 (ComputeInputColorInfo.c)
 *     ComputeAABBP @ 0x1C00702F4 (ComputeAABBP.c)
...
LABEL_50:
  ...
  *(_DWORD *)(a3 + 152) = v34 * v33;
  ...
  if ( (v23 & 0x80u) != 0 )
  {
    v126 = ComputeBytesPerScanLine(1LL, 4LL, (unsigned int)v25);
    v127 = v126 + 4;
