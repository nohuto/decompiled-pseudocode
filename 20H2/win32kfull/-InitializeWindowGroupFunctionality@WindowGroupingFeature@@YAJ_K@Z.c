/*
 * XREFs of ?InitializeWindowGroupFunctionality@WindowGroupingFeature@@YAJ_K@Z @ 0x1C0240290
 * Callers:
 ...
 *     ?Initialize@CWindowGroupManager@@SAJ_K@Z @ 0x1C0240230 (-Initialize@CWindowGroupManager@@SAJ_K@Z.c)
 */
