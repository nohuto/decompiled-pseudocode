/*
 * XREFs of ?DropInput@Mouse@InputTraceLogging@@SAX_KW4DropReason@12@@Z @ 0x1C021304C
 * Callers:
 *     ?QueuePTPMouseEvent@@YAXPEAXUtagPOINT@@K_K2PEAU_PTPMouseLatencyTracker@@@Z @ 0x1C02130B8 (-QueuePTPMouseEvent@@YAXPEAXUtagPOINT@@K_K2PEAU_PTPMouseLatencyTracker@@@Z.c)
 * Callees:
...
int __fastcall InputTraceLogging::Mouse::DropInput(__int64 a1, __int64 a2, __int64 a3, __int64 a4)
{
  ...
  if ( (unsigned int)dword_1C032FB30 > 4 && (qword_1C032FB40 & 0x40) != 0 )
  {
    v4 = qword_1C032FB48 & 0x40;
    if ( v4 == qword_1C032FB48 )
    {
      v7 = a1;
      v6 = "PTPQueueFull";
