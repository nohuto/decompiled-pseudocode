/*
 * XREFs of xxxCsEvent @ 0x1C0246808
 * Callers:
 *     xxxChangeMonitorFlags @ 0x1C011F72C (xxxChangeMonitorFlags.c)
 *     NtUserEvent @ 0x1C01F8560 (NtUserEvent.c)
...
__int64 __fastcall xxxCsEvent(void *Src, unsigned __int16 a2)
{
  ...
  *(_WORD *)(v6 + 6) = a2;
  ...
  if ( WPP_MAIN_CB.Queue.Wcb.BufferChainingDpc )
  {
    ...
    do
    {
      if ( ((v10 & (__int64)BufferChainingDpc->SystemArgument1) == 0 || *(_WORD *)(v6 + 4))
        && ((v10 & (__int64)BufferChainingDpc->SystemArgument1) != 0 || !*(_WORD *)(v6 + 4)) )
      {
        ++v8;
      }
  ...
  *v11 = v8;
  v13 = 0;
  for ( i = WPP_MAIN_CB.Queue.Wcb.BufferChainingDpc; i && v13 < *v12; i = (PKDPC)i->DeferredRoutine )
  {
    if ( ((*(_DWORD *)v6 & (__int64)i->SystemArgument1) == 0 || *(_WORD *)(v6 + 4))
      && ((*(_DWORD *)v6 & (__int64)i->SystemArgument1) != 0 || !*(_WORD *)(v6 + 4)) )
    {
      *(_QWORD *)&v21 = &v12[2 * v13 + 2];
      *((_QWORD *)&v21 + 1) = i->SystemArgument2;
