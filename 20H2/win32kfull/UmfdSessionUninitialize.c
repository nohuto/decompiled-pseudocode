/*
 * XREFs of UmfdSessionUninitialize @ 0x1C0129020
 * Callers:
 *     <none>
 * Callees:
 *     ?Destroy@CMultipleConsumerWorkQueue@@SAXQEAV1@@Z @ 0x1C0124924 (-Destroy@CMultipleConsumerWorkQueue@@SAXQEAV1@@Z.c)
 *     ?SessionUninitialize@UmfdHostLifeTimeManager@@CAXXZ @ 0x1C01290CC (-SessionUninitialize@UmfdHostLifeTimeManager@@CAXXZ.c)
