/*
 * XREFs of ?pxrlStrRead04@@YAPEAU_XRUNLEN@@PEAU_STRDDA@@PEAU_STRRUN@@PEAE2PEAU_XLATEOBJ@@JJJ@Z @ 0x1C010C6A0
 * Callers:
 *     <none>
 * Callees:
 *     <none>
        ...
        int a8)
{
  ...
  if ( a4 )
  {
    ...
    if ( v8 < a7 )
    {
      ...
      while ( 1 )
      {
        v45 = (v41 & (unsigned int)dword_1C02EDA38[v43]) >> dword_1C02EDA58[v62];
        if ( a5 )
          LODWORD(v45) = a5->pulXlate[v45];
        if ( (v40 & dword_1C02EE5E0[v44]) != 0 )
        {
    ...
    if ( a6 < a7 )
    {
      ...
      if ( a5 )
      {
        while ( 1 )
        {
          ...
          if ( (_DWORD)v20 )
          {
            v21 = v15->pulXlate[(unsigned __int64)(v17 & (unsigned int)dword_1C02EDA38[v19]) >> LOBYTE(dword_1C02EDA58[v19])];
            v22 = &v9[v18 + 2];
      ...
      else
      {
        ...
        {
          v29 = *v16++;
          v30 = (v17 & (unsigned int)dword_1C02EDA38[v19]) >> dword_1C02EDA58[v19];
          if ( (_DWORD)v29 )
          {
            v31 = &v9[v18 + 2];
