/*
 * XREFs of STROBJ_bGetAdvanceWidths @ 0x1C02BDCA0
 * Callers:
 *     NtGdiSTROBJ_bGetAdvanceWidths @ 0x1C02B4180 (NtGdiSTROBJ_bGetAdvanceWidths.c)
 * Callees:
 *     ?STROBJ_bGetAdvanceWidthsLinked@@YAHPEAVESTROBJ@@KKPEAU_POINTQF@@@Z @ 0x1C02BC430 (-STROBJ_bGetAdvanceWidthsLinked@@YAHPEAVESTROBJ@@KKPEAU_POINTQF@@@Z.c)
 */
