/*
 * XREFs of ?PerformLegacyDpiUpgrade@@YAHPEAU_UNICODE_STRING@@K@Z @ 0x1C00864C0
 * Callers:
 *     xxxUpdatePerUserSystemParameters @ 0x1C0028410 (xxxUpdatePerUserSystemParameters.c)
 * Callees:
 *     __security_check_cookie @ 0x1C015A0C0 (__security_check_cookie.c)
 *     ?PerformWin8DpiUpgrade@@YAHPEAU_UNICODE_STRING@@K@Z @ 0x1C01D3D08 (-PerformWin8DpiUpgrade@@YAHPEAU_UNICODE_STRING@@K@Z.c)
 */
...
__int64 __fastcall PerformLegacyDpiUpgrade(struct _UNICODE_STRING *a1)
{
  ...
  if ( v7 )
    ...
    *(_DWORD *)(gpsi + 2236LL) &= ~0x20u;
  v4 = 4096;
  FastWriteProfileValue(a1, 4LL, L"DpiScalingVer", 4LL, &v4, 4);
  if ( v7 || v5 )
    return 1;
  return v1;
}
