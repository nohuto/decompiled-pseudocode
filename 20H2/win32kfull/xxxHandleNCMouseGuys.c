/*
 * XREFs of xxxHandleNCMouseGuys @ 0x1C0223854
 * Callers:
  ...
  if ( a3 == 2 )
  {
    ...
    else
    {
      ...
      if ( (*(_BYTE *)(v12 + 31) & 0xC0) != 0x40 || (*(_BYTE *)(v12 + 233) & 0x10) == 0 )
      {
        ...
        *((_QWORD *)&v21 + 1) = NonChildAncestor;
        if ( NonChildAncestor )
          HMLockObject(NonChildAncestor);
        xxxActivateWindowWithOptions(NonChildAncestor, 0LL, 0LL, 0LL);
...
LABEL_37:
  if ( v8 != 61456 && v8 != 61488 && v8 != 61536
    ...
    || v8 == 61456
    && (v19 = *(_QWORD *)(a1 + 40), (*(_BYTE *)(v19 + 30) & 4) != 0)
    && (*(_BYTE *)(v19 + 31) & 1) != 0
    && (DragOperationFromMaximizedAllowed((struct tagWND *)a1)
     || ShellWindowManagement::WindowSubjectToBehavior((ShellWindowManagement **)a1, (struct tagWND *)4, v20)) )
  {
    if ( v5 && gSqmIsOptedIn )
