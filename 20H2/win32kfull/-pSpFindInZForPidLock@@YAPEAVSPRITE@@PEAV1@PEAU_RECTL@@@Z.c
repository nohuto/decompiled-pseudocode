/*
 * XREFs of ?pSpFindInZForPidLock@@YAPEAVSPRITE@@PEAV1@PEAU_RECTL@@@Z @ 0x1C0159EA8
 * Callers:
 ...
 * Callees:
 *     ?bIsCursorSprite@@YAHPEAVSPRITE@@@Z @ 0x1C0105C18 (-bIsCursorSprite@@YAHPEAVSPRITE@@@Z.c)
 */
