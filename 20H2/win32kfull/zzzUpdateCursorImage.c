/*
 * XREFs of zzzUpdateCursorImage @ 0x1C00CD0D0
 * Callers:
 ...
 *     ?FCursorShadowed@@YAHPEAU_CURSINFO@@@Z @ 0x1C00CE2C8 (-FCursorShadowed@@YAHPEAU_CURSINFO@@@Z.c)
...
void zzzUpdateCursorImage()
{
  ...
  if ( (struct tagCURSOR *)v0 != gpcurLogCurrent )
  {
      ...
      if ( !WPP_MAIN_CB.Dpc.DeferredContext )
      {
        *(_DWORD *)(v0 + 120) = 0;
        ...
        WPP_MAIN_CB.Dpc.DeferredContext = (PVOID)SetRITTimer(
                                                   (int)WPP_MAIN_CB.Dpc.DeferredContext,
                                                   100 * *v27 / 6u,
    ...
    {
      FindTimer(0LL, (__int64)WPP_MAIN_CB.Dpc.DeferredContext, 4u, 1, 0LL);
