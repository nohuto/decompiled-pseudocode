/*
 * XREFs of ?bPrepareSrcDco@DEVLOCKBLTOBJ@@QEAAHPEAVXDCOBJ@@HH@Z @ 0x1C00F4C9C
 * Callers:
...
LABEL_3:
  ...
  if ( (v12 & 1) != 0 && (v12 & 0x4000) == 0 && *((_QWORD *)this + 21) && !*((_QWORD *)this + 25) )
  {
    *((_DWORD *)v11 + 9) |= 0x4000u;
    DC::pSurface(*v10, *((struct SURFACE **)this + 21));
  ...
  if ( !(unsigned int)DEVLOCKBLTOBJ::bMapSrcSurfaceView(this, (int)v11) )
  {
    ...
    if ( (*((_DWORD *)this + 28) & 0x1000) != 0 && *((_QWORD *)this + 15) && *((_BYTE *)this + 137) )
