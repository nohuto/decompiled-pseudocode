/*
 * XREFs of ?xxxSkipSysMsgEx@@YAPEAUtagQMSG@@PEAUtagTHREADINFO@@PEAU1@H@Z @ 0x1C00D799C
 * Callers:
 ...
 *     ?EqualMsg@@YAHPEAUtagQMSG@@0@Z @ 0x1C01094F4 (-EqualMsg@@YAHPEAUtagQMSG@@0@Z.c)
...
struct tagQMSG *__fastcall xxxSkipSysMsgEx(struct tagTHREADINFO *a1, struct tagQMSG *a2, unsigned int a3)
{
  ...
  if ( (IsPointerInputMessage(*((_DWORD *)a2 + 6))
     ...
     || v11 == 255)
    && (unsigned int)dword_1C032FB30 > 5
