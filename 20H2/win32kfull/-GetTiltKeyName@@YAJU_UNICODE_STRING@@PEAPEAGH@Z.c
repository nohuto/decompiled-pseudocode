/*
 * XREFs of ?GetTiltKeyName@@YAJU_UNICODE_STRING@@PEAPEAGH@Z @ 0x1C01CE0F8
 * Callers:
 ...
 *     ?GetDeviceId@@YAJU_UNICODE_STRING@@PEAPEAG1@Z @ 0x1C01CDFC8 (-GetDeviceId@@YAJU_UNICODE_STRING@@PEAPEAG1@Z.c)
 *     ?GetInstanceId@@YAJU_UNICODE_STRING@@PEAPEAG1@Z @ 0x1C01CE050 (-GetInstanceId@@YAJU_UNICODE_STRING@@PEAPEAG1@Z.c)
 */
