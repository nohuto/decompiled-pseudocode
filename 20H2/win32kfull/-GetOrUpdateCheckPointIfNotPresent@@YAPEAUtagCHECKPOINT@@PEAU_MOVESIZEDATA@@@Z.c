/*
 * XREFs of ?GetOrUpdateCheckPointIfNotPresent@@YAPEAUtagCHECKPOINT@@PEAU_MOVESIZEDATA@@@Z @ 0x1C020AA68
 * Callers:
...
struct tagCHECKPOINT *__fastcall GetOrUpdateCheckPointIfNotPresent(struct _MOVESIZEDATA *a1)
{
  ...
  v2 = *((_QWORD *)a1 + 2);
  v7 = 0LL;
  Prop = (struct tagCHECKPOINT *)GetProp(v2, LOWORD(WPP_MAIN_CB.DeviceQueue.Lock), 1LL);
  if ( Prop
