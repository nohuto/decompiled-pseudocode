/*
 * XREFs of GreSfmRegisterLogicalSurfaceForSignaling @ 0x1C00C1478
 * Callers:
 ...
 *     ?SignalOnDirty@SFMLOGICALSURFACE@@QEAAJH@Z @ 0x1C00C155C (-SignalOnDirty@SFMLOGICALSURFACE@@QEAAJH@Z.c)
