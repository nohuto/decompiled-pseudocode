/*
 * XREFs of ?vPlgWriteAND@@YAXPEAU_PLGRUN@@0PEAVSURFACE@@PEAU_CLIPOBJ@@@Z @ 0x1C02D8BE0
 * Callers:
 *     <none>
 * Callees:
              ...
              do
              {
                ...
                if ( !v29 )
                {
                  if ( v31 )
                    *v28 = v30;
                  ++v28;
                  v29 = *((_BYTE *)&dword_1C02FA2D8 + (v25 & 7));
                  v34 = v29;
                  if ( (int)v25 < 0
                    || (int)v25 >= *((_DWORD *)a3 + 14)
                    || (unsigned __int64)v28 < v4
    ...
    else if ( a1 < a2 )
    {
      do
      {
        ...
        for ( j = *((_QWORD *)a3 + 10) + v10; v11; --v11 )
        {
          ...
          v17 = *((_BYTE *)&dword_1C02FA2D8 + (*(_DWORD *)v5 & 7));
                ...
                if ( !v17 )
                {
                  *v16++ = v18;
                  if ( (unsigned __int64)v16 < v4 || (unsigned __int64)v16 > v9 )
                    ...
                    v18 = *v16;
                  v17 = *((_BYTE *)&dword_1C02FA2D8 + (v14 & 7));
                }
                if ( v15 >= 0 )
                  continue;
              }
