/*
 * XREFs of ?bWiden@WIDENER@@IEAAHXZ @ 0x1C0135060
 * Callers:
 ...
 *     ?vNextEvent@LINER@@QEAAXXZ @ 0x1C0135244 (-vNextEvent@LINER@@QEAAXXZ.c)
 *     ?bBeginFigure@WIDEPATHOBJ@@QEAAHXZ @ 0x1C01354C0 (-bBeginFigure@WIDEPATHOBJ@@QEAAHXZ.c)
 *     ?bValid@WIDENER@@QEBAHXZ @ 0x1C01355F8 (-bValid@WIDENER@@QEBAHXZ.c)
 *     ?vEndFigure@WIDEPATHOBJ@@QEAAXXZ @ 0x1C013563C (-vEndFigure@WIDEPATHOBJ@@QEAAXXZ.c)
 *     ?vAddJoin@WIDENER@@IEAAXH@Z @ 0x1C0135728 (-vAddJoin@WIDENER@@IEAAXH@Z.c)
 *     ?vReverseConcatenate@WIDEPATHOBJ@@QEAAXAEAV1@@Z @ 0x1C01362C4 (-vReverseConcatenate@WIDEPATHOBJ@@QEAAXAEAV1@@Z.c)
 *     ?vPrependBeforeFigure@WIDEPATHOBJ@@QEAAXXZ @ 0x1C01366A8 (-vPrependBeforeFigure@WIDEPATHOBJ@@QEAAXXZ.c)
 *     ?efNextStyleLength@STYLER@@IEAA?AVEFLOAT@@XZ @ 0x1C02CDBBC (-efNextStyleLength@STYLER@@IEAA-AVEFLOAT@@XZ.c)
 *     ?efWorldLength@STYLER@@IEAA?AVEFLOAT@@VEVECTORFX@@@Z @ 0x1C02CDBF8 (-efWorldLength@STYLER@@IEAA-AVEFLOAT@@VEVECTORFX@@@Z.c)
 ...
 *     ?vPrependBeforeSubpath@WIDEPATHOBJ@@QEAAXXZ @ 0x1C02CE278 (-vPrependBeforeSubpath@WIDEPATHOBJ@@QEAAXXZ.c)
 */
