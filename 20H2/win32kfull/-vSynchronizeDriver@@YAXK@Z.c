/*
 * XREFs of ?vSynchronizeDriver@@YAXK@Z @ 0x1C009B504
 * Callers:
 *     GreFlush @ 0x1C009B000 (GreFlush.c)
 *     ?GreSynchronizeTimer@@YAXPEAXI_K_J@Z @ 0x1C029DFB0 (-GreSynchronizeTimer@@YAXPEAXI_K_J@Z.c)
 * Callees:
 *     <none>
 */
