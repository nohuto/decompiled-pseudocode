/*
 * XREFs of ?_StoreGestureConfig@@YAHPEAUtagWND@@IPEAUtagGESTURECONFIG@@@Z @ 0x1C0128B8C
 * Callers:
 ...
 *     ?GCRemoveHashElement@@YAXPEAPEAUtagGESTURECONFIGLIST@@I@Z @ 0x1C0226FFC (-GCRemoveHashElement@@YAXPEAPEAUtagGESTURECONFIGLIST@@I@Z.c)
 */
...
LABEL_24:
  ...
  for ( i = (int *)((char *)a3 + 4); ; i += 3 )
  {
    ...
    if ( (unsigned int)(v15 - 1) > 6 )
      break;
    v7 = (unsigned int)~dword_1C02E9E50[v15];
