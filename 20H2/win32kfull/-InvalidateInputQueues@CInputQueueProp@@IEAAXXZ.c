/*
 * XREFs of ?InvalidateInputQueues@CInputQueueProp@@IEAAXXZ @ 0x1C011CB8C
 * Callers:
 *     ?Delete@CInputQueueProp@@UEAAXXZ @ 0x1C011CB60 (-Delete@CInputQueueProp@@UEAAXXZ.c)
 * Callees:
 *     ?Reset@?$CDynamicArray@PEAVIInputQueue@@$0HHHAHDFF@@@QEAAX_N@Z @ 0x1C011CC14 (-Reset@-$CDynamicArray@PEAVIInputQueue@@$0HHHAHDFF@@@QEAAX_N@Z.c)
