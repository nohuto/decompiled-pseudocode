/*
 * XREFs of ?InternalScrollDC@@YAHPEAUtagWND@@PEAUHDC__@@HHPEAUtagRECT@@2PEAUHRGN__@@32H@Z @ 0x1C0041CAC
 * Callers:
        ...
        int a10)
{
  ...
  struct tagRECT v65; // [rsp+F0h] [rbp-10h] BYREF
  ...
  if ( a10 )
  {
    GreTransformPoints((_DWORD)a2, (unsigned int)&v66, (unsigned int)&v66, 2, 1);
    GreTransformPoints((_DWORD)a2, (unsigned int)&v63, (unsigned int)&v63, 2, 1);
  ...
  v19 = (unsigned int)(v11 + _mm_cvtsi128_si32(v17));
  v65.left = v19;
  v65.right = v11 + _mm_cvtsi128_si32(_mm_srli_si128(v17, 8));
  v65.top = a4 + _mm_cvtsi128_si32(_mm_srli_si128(v17, 4));
...
LABEL_81:
                    if ( v41 != 1 )
                    {
                      ...
                      if ( a10 )
                        GreTransformPoints((_DWORD)a2, (unsigned int)&v65, (unsigned int)&v65, 2, 0);
                      NtGdiBitBltInternal(
                        a2,
                        (unsigned int)v65.left,
                        (unsigned int)v65.top,
                        (unsigned int)(v65.right - v65.left),
                        v65.bottom - v65.top,
                        a2,
                        v65.left - (_DWORD)v58,
                        v65.top - v57,
...
LABEL_29:
    if ( (unsigned __int64)v50 <= 1 )
    {
      ...
      if ( v50 != (HRGN)1 )
      {
        LODWORD(v64) = v11 + v63.m128i_i32[0];
        DWORD2(v64) = v11 + v63.m128i_i32[2];
        DWORD1(v64) = a4 + v63.m128i_i32[1];
        HIDWORD(v64) = a4 + v63.m128i_i32[3];
      ...
      if ( v23 )
      {
        if ( (unsigned int)IntersectRect(&v67, &v63, &v65) )
        {
          if ( v11 && a4 )
            goto LABEL_105;
          UnionRect(&v67, v63.m128i_i32, &v65.left);
          SubtractRect((__int64)&v67, (__int64)&v67, (__int64)&v64);
          v27 = v67;
LABEL_36:
          if ( a9 )
            *a9 = v27;
...
LABEL_41:
          v28 = v47;
LABEL_42:
          v29 = (unsigned int)v64;
          v30 = DWORD2(v64);
          if ( (int)v64 < SDWORD2(v64) )
          {
            v31 = DWORD1(v64);
            v32 = HIDWORD(v64);
            if ( SDWORD1(v64) < SHIDWORD(v64) )
            {
              if ( a10 )
              {
