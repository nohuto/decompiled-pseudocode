/*
 * XREFs of zzzAttachToQueue @ 0x1C00BFE38
 * Callers:
 ...
 *     ?CheckTransferState@@YAKPEAUtagTHREADINFO@@PEAUtagQ@@JH@Z @ 0x1C00C01F4 (-CheckTransferState@@YAKPEAUtagTHREADINFO@@PEAUtagQ@@JH@Z.c)
