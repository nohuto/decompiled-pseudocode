/*
 * XREFs of ?vXlatGlyphArray@RFONTOBJ@@QEAAXPEBGIPEAKKH@Z @ 0x1C0060F30
 * Callers:
...
LABEL_53:
        ...
        {
          v48 = *a2;
          if ( (unsigned __int16)v48 >= gqlTTSystem && (unsigned __int16)v48 <= (unsigned __int16)word_1C033B8DA )
          {
            v49 = v48 - gqlTTSystem;
            ...
            if ( ((0x80000000 >> v50) & *(_DWORD *)(qword_1C033B8E0 + 4LL * (v49 >> 5))) != 0 )
LABEL_55:
