/*
 * XREFs of ?Feature_MSRC74780_RejectRecursiveNtGdiStarDoc__private_IsEnabled@@YAHXZ @ 0x1C015D5CC
 * Callers:
...
__int64 Feature_MSRC74780_RejectRecursiveNtGdiStarDoc__private_IsEnabled(void)
{
  ...
  CachedFeatureEnabledState = wil_details_FeatureStateCache_GetCachedFeatureEnabledState(
                                (unsigned int *)&Feature_MSRC74780_RejectRecursiveNtGdiStarDoc__private_featureState,
                                (__int64)&Feature_MSRC74780_RejectRecursiveNtGdiStarDoc__private_descriptor);
  v1 = (CachedFeatureEnabledState >> 3) & 1;
  wil_details_FeatureReporting_ReportUsageToService(
    (__int64)&Feature_MSRC74780_RejectRecursiveNtGdiStarDoc__private_reporting,
    0x27B7A51u,
