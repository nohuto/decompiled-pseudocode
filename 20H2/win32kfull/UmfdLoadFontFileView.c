/*
 * XREFs of UmfdLoadFontFileView @ 0x1C00E2860
 * Callers:
 ...
 *     ?LookUpFNTCacheTable@@YAHKPEAGPEAK1PEAPEAVPDEV@@1HPEAH3PEAPEAU_FONTFILEVIEW@@KPEAUtagDESIGNVECTOR@@K@Z @ 0x1C00E2E44 (-LookUpFNTCacheTable@@YAHKPEAGPEAK1PEAPEAVPDEV@@1HPEAH3PEAPEAU_FONTFILEVIEW@@KPEAUtagDESIGNVECTO.c)
 *     ?bIsPathInSystemFontsDir@@YAHPEBG@Z @ 0x1C00E32B8 (-bIsPathInSystemFontsDir@@YAHPEBG@Z.c)
  ...
  *v15 = 0LL;
  if ( (_BYTE)result )
  {
    ...
    if ( !v42 )
    {
      ...
      v21 = v47;
      v22 = 1;
      for ( i = qword_1C0340A10; v20 < v47; v21 = v47 )
      {
        v23 = v20++;
        *((_DWORD *)v46[v23] + 16) = 0;
      }
      ...
      else
      {
        ...
        PutFntCacheDrvAndFileInfo(*v17, qword_1C0340A10, v39, v46, v47);
      }
      if ( v30 )
      {
        *v15 = qword_1C0340A10;
