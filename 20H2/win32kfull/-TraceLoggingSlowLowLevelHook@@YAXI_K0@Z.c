/*
 * XREFs of ?TraceLoggingSlowLowLevelHook@@YAXI_K0@Z @ 0x1C0225260
 * Callers:
...
void __fastcall TraceLoggingSlowLowLevelHook(int a1, __int64 a2, __int64 a3)
{
    ...
    && (qword_1C032A410 & 0x400000000000LL) == qword_1C032A410 )
  {
    ...
    v11 = 4LL;
    v9 = 8LL;
    tlgWriteTransfer_EtwWriteTransfer((__int64)&dword_1C032A3F8, (unsigned __int8 *)dword_1C02F0AB8, 0LL, 0LL, 6u, &v7);
  }
}
