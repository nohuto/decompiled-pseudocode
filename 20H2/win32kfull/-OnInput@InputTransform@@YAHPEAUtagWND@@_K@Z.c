/*
 * XREFs of ?OnInput@InputTransform@@YAHPEAUtagWND@@_K@Z @ 0x1C01084D0
 * Callers:
 ...
 *     InputTransformOnInput @ 0x1C01F55B0 (InputTransformOnInput.c)
 *     SetManipulationInputTargetTransform @ 0x1C01F55E0 (SetManipulationInputTargetTransform.c)
 * Callees:
...
LABEL_6:
    ...
    if ( InputTraceLogging::Enabled(0)
      ...
      && (qword_1C032FB40 & 4) != 0
      && (qword_1C032FB48 & 4) == qword_1C032FB48 )
    {
      v37 = *((_DWORD *)v6 + 21);
      v39 = *((_DWORD *)v6 + 20);
      v40 = *((_DWORD *)v6 + 19);
