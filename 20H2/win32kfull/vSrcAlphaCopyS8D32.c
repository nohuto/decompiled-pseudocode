/*
 * XREFs of vSrcAlphaCopyS8D32 @ 0x1C00E8B40
 * Callers:
 *     <none>
 * Callees:
 *     <none>
    ...
    if ( v12 )
    {
      do
      {
        ...
        if ( (_BYTE)v14 )
        {
          ...
          {
            _mm_lfence();
            *v13 = alAlpha_255[*((unsigned __int8 *)off_1C032A0D0 + 4 * v14 + 2)] | ((alAlpha_255[*((unsigned __int8 *)off_1C032A0D0
                                                                                                  + 4 * v14
                                                                                                  + 1)] | (alAlpha_255[*((unsigned __int8 *)off_1C032A0D0 + 4 * v14)] << 8)) << 8);
          }
        }
        ++result;
        ++v13;
