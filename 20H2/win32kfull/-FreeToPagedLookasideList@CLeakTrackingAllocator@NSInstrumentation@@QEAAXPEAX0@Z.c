/*
 * XREFs of ?FreeToPagedLookasideList@CLeakTrackingAllocator@NSInstrumentation@@QEAAXPEAX0@Z @ 0x1C02DC6DC
 * Callers:
        ...
        struct _SLIST_ENTRY *a3)
{
  ...
  NSInstrumentation::CPrioritizedWriterLock **DeviceContext; // rsi
  ...
  if ( *a2 )
  {
    v7 = (NSInstrumentation::CPointerHashTable *)*((_QWORD *)WPP_MAIN_CB.Queue.Wcb.DeviceContext + 6);
    v9 = 0LL;
    v3 = a3 - 1;
