/*
 * XREFs of SetWindowCompositionHolographic @ 0x1C0213F3C
 * Callers:
...
__int64 __fastcall SetWindowCompositionHolographic(__int64 *a1, __int128 *a2)
{
  ...
  {
    if ( -__CFSHR__(v10[0], 14) == v5 )
      return 0;
    LODWORD(v10[0]) = (v5 << 13) | v10[0] & 0xFFFFDFFF;
    ...
    else
    {
      ...
      return (unsigned int)DwmAsyncSetCompositionAttribute(v8, *a1, 23, a2);
    }
  }
  return v6;
}
