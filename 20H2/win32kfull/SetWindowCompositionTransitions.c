/*
 * XREFs of SetWindowCompositionTransitions @ 0x1C0214198
 * Callers:
...
__int64 __fastcall SetWindowCompositionTransitions(__int64 *a1, __int128 *a2)
{
  ...
  {
    if ( -__CFSHR__(v10[0], 7) == v5 )
      return 0;
    LODWORD(v10[0]) = v10[0] & 0xFFFFFFBF | (v5 << 6);
    ...
    else
    {
      ...
      return (unsigned int)DwmAsyncSetCompositionAttribute(v8, *a1, 3, a2);
    }
  }
  return v6;
}
