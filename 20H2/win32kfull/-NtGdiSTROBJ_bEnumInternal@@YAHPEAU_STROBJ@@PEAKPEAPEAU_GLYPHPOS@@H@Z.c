/*
 * XREFs of ?NtGdiSTROBJ_bEnumInternal@@YAHPEAU_STROBJ@@PEAKPEAPEAU_GLYPHPOS@@H@Z @ 0x1C02B09B8
 * Callers:
 *     NtGdiSTROBJ_bEnum @ 0x1C02B4140 (NtGdiSTROBJ_bEnum.c)
 *     NtGdiSTROBJ_bEnumPositionsOnly @ 0x1C02B4160 (NtGdiSTROBJ_bEnumPositionsOnly.c)
 * Callees:
 ...
 *     STROBJ_bEnumPositionsOnly @ 0x1C02BDC70 (STROBJ_bEnumPositionsOnly.c)
 */
