/*
 * XREFs of MonitorAPIProcessTerminating @ 0x1C01052C0
 * Callers:
 *     <none>
 * Callees:
 ...
 *     ?GetNextElementIndex@?$CList@VCPhysicalMonitorHandle@@@OPM@@QEAAEKPEAK@Z @ 0x1C0271624 (-GetNextElementIndex@-$CList@VCPhysicalMonitorHandle@@@OPM@@QEAAEKPEAK@Z.c)
 */
...
void __fastcall MonitorAPIProcessTerminating(void *a1)
{
  ...
  v1 = (char *)qword_1C033A078;
  OPM::CAutoMutex::CAutoMutex((OPM::CAutoMutex *)&v7, (struct OPM::CMutex *)((char *)qword_1C033A078 + 32));
  v3 = 0;
  v5 = 0;
  if ( *((_DWORD *)v1 + 4) )
  {
