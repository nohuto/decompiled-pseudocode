/*
 * XREFs of ?pxrlStrRead01@@YAPEAU_XRUNLEN@@PEAU_STRDDA@@PEAU_STRRUN@@PEAE2PEAU_XLATEOBJ@@JJJ@Z @ 0x1C00EC4E0
 * Callers:
 *     <none>
 * Callees:
 *     <none>
        ...
        int a8)
{
  ...
  if ( a4 )
  {
    ...
    while ( 1 )
    {
      if ( (dword_1C02EE5E0[v37] & v34) != 0 )
      {
        v38 = (unsigned int)*v36;
        if ( (dword_1C02EE5E0[v15] & v54) != 0 )
        {
          if ( !(_DWORD)v38 )
            goto LABEL_43;
          v39 = v59;
