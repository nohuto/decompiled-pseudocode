/*
 * XREFs of GreGetBoundsRect @ 0x1C009EF48
 * Callers:
...
__int64 __fastcall GreGetBoundsRect(HDC a1, struct _POINTL *a2, __int16 a3)
{
  ...
  if ( (a3 & 0x4000) == 0 )
  {
    ...
    if ( (v49[24] & 1) != 0 )
    {
      v11 = *((__m128i *)XDCOBJ::prgnEffRao((XDCOBJ *)&v45) + 6);
      ...
      {
        if ( (unsigned int)EXFORMOBJ::bXform((EXFORMOBJ *)v48, a2) )
          goto LABEL_36;
        goto LABEL_40;
      }
      v22 = *(_OWORD *)&a2->x;
      ...
      v56 = a2->y;
      *(_OWORD *)&v52[0].x = v22;
      if ( !(unsigned int)EXFORMOBJ::bXform((EXFORMOBJ *)v48, v52) )
      {
LABEL_40:
        v6 = 0;
        goto LABEL_36;
