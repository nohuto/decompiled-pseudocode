/*
 * XREFs of ?RedirNineGrid@@YAHPEAU_SURFOBJ@@0PEAU_CLIPOBJ@@PEAU_XLATEOBJ@@PEAU_RECTL@@3PEAUNINEGRID@@PEAU_BLENDOBJ@@PEAX@Z @ 0x1C029BB40
 * Callers:
 *     <none>
 * Callees:
        ...
        void *a9)
{
        ...
        if ( (v17 & 0x20000) != 0 )
        {
          for ( i = **(struct _DISPSURF ***)(v16 + 1800); i; i = *(struct _DISPSURF **)i )
          {
            ...
            if ( v19 )
            {
              ...
              {
                if ( *(_QWORD *)(*(_QWORD *)(v19 + 1792) + 792LL) )
                {
                  ...
                  (*(void (__fastcall **)(struct _SURFOBJ *, __int64, struct _CLIPOBJ *, struct _XLATEOBJ *, struct _RECTL *, struct _RECTL *, struct NINEGRID *, struct _BLENDOBJ *, void *))(v21 + 792))(
                    DevBitmap,
                    v22,
                    a3,
                    a4,
  ...
  v23 = EngNineGrid(a1, (__int64)a2, (__int64)a3, (__int64)a4, (__int64)a5, (__int64)a6, (__int64)a7, (__int64)v14);
  if ( v26 )
    bMakeOpaque(v26);
  if ( v27 )
    bMakeOpaque(v27);
