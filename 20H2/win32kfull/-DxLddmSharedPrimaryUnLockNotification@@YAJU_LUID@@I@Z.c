/*
 * XREFs of ?DxLddmSharedPrimaryUnLockNotification@@YAJU_LUID@@I@Z @ 0x1C02759BC
 * Callers:
 *     NtGdiDdDDISharedPrimaryUnLockNotification @ 0x1C0277760 (NtGdiDdDDISharedPrimaryUnLockNotification.c)
 * Callees:
