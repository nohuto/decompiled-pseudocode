/*
 * XREFs of ?NtGdiDrawStreamInternal@@YAHAEAVXDCOBJ@@AEAVEXFORMOBJ@@PEAVSURFACE@@PEAU_XLATEOBJ@@PEAU_RECTL@@4JPEADPEAU_DRAWSTREAMINFO@@@Z @ 0x1C009F2E0
 * Callers:
          ...
          && (unsigned __int64)(v62 + (__int64)v23 + 0x80000000LL) <= 0xFFFFFFFF )
        {
            ...
            && (unsigned __int64)(v36 + v22 + 0x80000000LL) <= 0xFFFFFFFF )
          {
            ...
            if ( v31 != v32 && v45.m128i_i32[1] != _mm_srli_si128(v45, 8).m128i_i32[1] )
            {
              ...
              {
                v75 = v45;
                XDCOBJ::vAccumulateTight(v44, v41, &v75);
              }
              ++*(_DWORD *)(v37 + 92);
              v47 = EngDrawStream;
              v48 = *(_QWORD *)(v37 + 48);
