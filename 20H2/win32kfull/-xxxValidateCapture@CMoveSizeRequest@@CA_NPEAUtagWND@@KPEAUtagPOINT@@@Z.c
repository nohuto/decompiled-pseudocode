/*
 * XREFs of ?xxxValidateCapture@CMoveSizeRequest@@CA_NPEAUtagWND@@KPEAUtagPOINT@@@Z @ 0x1C02418A0
 * Callers:
...
bool __fastcall CMoveSizeRequest::xxxValidateCapture(struct tagWND *a1, int a2, struct tagPOINT *a3)
{
  ...
  if ( *(_QWORD *)(v4 + 432) == *(_QWORD *)(gptiCurrent + 432LL)
  ...
  v10 = (struct tagPOINT)*((_QWORD *)v9 + 97);
