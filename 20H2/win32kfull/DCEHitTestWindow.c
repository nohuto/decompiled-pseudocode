/*
 * XREFs of DCEHitTestWindow @ 0x1C01E44C4
 * Callers:
 ...
 *     ?DCEPointInTriangle@@YAHPEAU_D3DVERTEX@@MM@Z @ 0x1C01E3778 (-DCEPointInTriangle@@YAHPEAU_D3DVERTEX@@MM@Z.c)
 *     BuildVertexList @ 0x1C01E42A4 (BuildVertexList.c)
