/*
 * XREFs of ?zzzUpdateFade@@YAXPEAUtagPOINT@@PEAUtagSIZE@@PEAUHDC__@@0PEAU_BLENDFUNCTION@@@Z @ 0x1C01E72E4
 * Callers:
  ...
  if ( (v9 & 8) != 0 )
  {
    ...
    if ( v10 )
    {
      ...
      *(_QWORD *)(ThreadWin32Thread + 416) = v16;
      v16[1] = v10;
      HMLockObject(v10);
      zzzUpdateLayeredWindow(v10, 0LL, a1, a2, (__int64)a3, (__int64)a4, 0, (__int64)a5, 2, 0LL);
