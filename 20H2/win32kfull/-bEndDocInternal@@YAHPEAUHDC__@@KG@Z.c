/*
 * XREFs of ?bEndDocInternal@@YAHPEAUHDC__@@KG@Z @ 0x1C015D634
 * Callers:
 *     NtGdiStartPage @ 0x1C0141E00 (NtGdiStartPage.c)
 *     NtGdiEndDoc @ 0x1C0156730 (NtGdiEndDoc.c)
 *     NtGdiAbortDoc @ 0x1C027C260 (NtGdiAbortDoc.c)
 * Callees:
    ...
    *((_DWORD *)v25[0] + 79) |= 0xFu;
    ...
    if ( *((_DWORD *)v25[0] + 26) - 1 > 0 )
    {
      while ( 1 )
      {
        ...
        v28 = 0;
        v26 = 0LL;
        v20 = (DC *)HmgLockIgnoreOwner(v19, v16);
        v26 = v20;
