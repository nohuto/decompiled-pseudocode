/*
 * XREFs of ?Dump@CLeakTrackingAllocator@NSInstrumentation@@QEAAXPEAU_DUMP_CONTEXT@2@@Z @ 0x1C02DC4FC
 * Callers:
        ...
        struct NSInstrumentation::_DUMP_CONTEXT *a2)
{
  ...
  if ( v2 )
  {
    ...
    if ( v4 )
    {
      ...
      if ( !v6 )
      {
        v7 = *((_QWORD *)WPP_MAIN_CB.Queue.Wcb.DeviceContext + 7);
        if ( v7 )
    ...
    {
      v5 = (NSInstrumentation::CPointerHashTable *)*((_QWORD *)WPP_MAIN_CB.Queue.Wcb.DeviceContext + 6);
      if ( v5 )
  ...
  {
    v3 = (NSInstrumentation::CPrioritizedWriterLock *)*((_QWORD *)WPP_MAIN_CB.Queue.Wcb.DeviceContext + 8);
    if ( v3 )
