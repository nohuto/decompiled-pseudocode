/*
 * XREFs of NtUserSetTargetForResourceBrokering @ 0x1C0007EC0
 * Callers:
 *     <none>
 * Callees:
 *     ?_SetTargetForCursorApiBrokering@@YAXPEAUtagTHREADINFO@@0@Z @ 0x1C0007FDC (-_SetTargetForCursorApiBrokering@@YAXPEAUtagTHREADINFO@@0@Z.c)
