/*
 * XREFs of GetScaledLogFontForDpi @ 0x1C0034A40
 * Callers:
...
_BOOL8 __fastcall GetScaledLogFontForDpi(unsigned int a1, unsigned int a2, __int64 a3)
{
  ...
  if ( !a1 )
  {
    ...
    {
      v14 = *(struct HLFONT__ **)(DPIMETRICSForDpiUnsafe + 64);
      goto LABEL_13;
    }
    v16 = *(HBRUSH *)(Get96DpiMetrics() + 64);
    goto LABEL_30;
  }
  v9 = a1 - 1;
  if ( !v9 )
  {
    if ( DPIMETRICSForDpiUnsafe )
    {
      v14 = *(struct HLFONT__ **)(DPIMETRICSForDpiUnsafe + 32);
      goto LABEL_13;
    }
    v16 = *(HBRUSH *)(Get96DpiMetrics() + 32);
    goto LABEL_30;
  }
  v10 = v9 - 1;
  if ( !v10 )
  {
    if ( DPIMETRICSForDpiUnsafe )
    {
      v14 = *(struct HLFONT__ **)DPIMETRICSForDpiUnsafe;
      goto LABEL_13;
    }
    v16 = *(HBRUSH *)Get96DpiMetrics();
    goto LABEL_30;
  }
  v11 = v10 - 1;
  if ( !v11 )
  {
    if ( DPIMETRICSForDpiUnsafe )
    {
      v14 = *(struct HLFONT__ **)(DPIMETRICSForDpiUnsafe + 56);
      goto LABEL_13;
    }
    v16 = *(HBRUSH *)(Get96DpiMetrics() + 56);
LABEL_30:
    v14 = 0LL;
  ...
  v14 = *(struct HLFONT__ **)(GetDPIServerInfoForDpi(a2) + 8);
LABEL_13:
  if ( v14 )
    v7 = GreExtGetObjectW((HBRUSH)v14) != 0;
  if ( ScaledFont )
