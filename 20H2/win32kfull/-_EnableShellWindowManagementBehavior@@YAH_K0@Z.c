/*
 * XREFs of ?_EnableShellWindowManagementBehavior@@YAH_K0@Z @ 0x1C012C0C0
 * Callers:
 *     <none>
 * Callees:
 ...
 *     ?InitializeWindowGroupFunctionality@WindowGroupingFeature@@YAJ_K@Z @ 0x1C0240290 (-InitializeWindowGroupFunctionality@WindowGroupingFeature@@YAJ_K@Z.c)
 */
