/*
 * XREFs of EditionHandleAndPostKeyEvent @ 0x1C00BDD10
 * Callers:
 *     <none>
 * Callees:
    ...
    || (a5 != 9 || (a6 & 1) != 0) && (a5 != 27 || (a6 & 2) != 0) )
  {
    if ( !gpqForeground )
    {
      if ( !a4 && ((*gpsi & 0x2000) != 0 || (*gpsi & 0x4000) != 0) && (unsigned __int8)(a5 + 83) <= 6u )
        PostShellHookMessagesEx(0xCuLL, (unsigned __int64)(unsigned __int16)(a5 - 165) << 16, 0LL);
      return 0LL;
    }
    CLockExclusiveAllowRecursion<DLT_QUEUE>::CLockExclusiveAllowRecursion<DLT_QUEUE>(v60, gpqForeground);
    v18 = a5;
    v54 = a5;
...
LABEL_48:
        ...
        if ( !(unsigned __int8)IsKeyboardDelegationEnabledForThread(*(_QWORD *)(gpqForeground + 96LL)) )
        {
                               ...
                               (__int64)&v54) )
          {
            ...
            v58 = v52;
            v59 = v53;
            PostInputMessage(gpqForeground, 0LL, a15, v24, a12, 0LL, a14, 0, a11, a13, 0LL, v54, v56);
          }
        }
        return 0LL;
      }
