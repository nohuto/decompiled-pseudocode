/*
 * XREFs of ?ParseFontLinkEntry@@YA_NPEAGPEAUFontLinkData@@@Z @ 0x1C001FF4C
 * Callers:
 *     bAddFlEntry @ 0x1C001F994 (bAddFlEntry.c)
 *     bDeleteFlEntry @ 0x1C0297A00 (bDeleteFlEntry.c)
 * Callees:
 *     ?ParseFontScaleFactor@@YA_NPEBGPEAJ@Z @ 0x1C0020A2C (-ParseFontScaleFactor@@YA_NPEBGPEAJ@Z.c)
 */
