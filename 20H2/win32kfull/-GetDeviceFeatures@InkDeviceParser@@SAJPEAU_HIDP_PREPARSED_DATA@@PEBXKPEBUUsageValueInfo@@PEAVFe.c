/*
 * XREFs of ?GetDeviceFeatures@InkDeviceParser@@SAJPEAU_HIDP_PREPARSED_DATA@@PEBXKPEBUUsageValueInfo@@PEAVFeatures@InkDevice@@@Z @ 0x1C024FA04
 * Callers:
        ...
        struct InkDevice::Features *a5)
{
  ...
  else if ( (unsigned int)dword_1C032A288 > 2 )
  {
    ...
    v17 = 4;
    v16 = &v10;
    tlgWriteTransfer_EtwWriteTransfer((__int64)&dword_1C032A288, (unsigned __int8 *)dword_1C02F0A0C, 0LL, 0LL, 3u, &v15);
  }
  return v7;
}
