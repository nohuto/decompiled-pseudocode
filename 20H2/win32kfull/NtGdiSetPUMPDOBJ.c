/*
 * XREFs of NtGdiSetPUMPDOBJ @ 0x1C0071780
 * Callers:
 *     <none>
 * Callees:
 ...
 *     ?bSandboxedCurrentProcess@@YAHXZ @ 0x1C00720E0 (-bSandboxedCurrentProcess@@YAHXZ.c)
 *     W32GetThreadWin32Thread @ 0x1C00B4FD0 (W32GetThreadWin32Thread.c)
 *     ?bIsProcessLocalSystem@@YAHPEAU_EPROCESS@@@Z @ 0x1C0287DA0 (-bIsProcessLocalSystem@@YAHPEAU_EPROCESS@@@Z.c)
 *     ??1UMPDREF@@QEAA@XZ @ 0x1C02B0890 (--1UMPDREF@@QEAA@XZ.c)
 */
...
LABEL_25:
          ...
          if ( *(_QWORD *)(v20 + 24) == W32GetThreadWin32Thread(KeGetCurrentThread()) )
          {
            *(_BYTE *)(v20 + 32) |= 2u;
