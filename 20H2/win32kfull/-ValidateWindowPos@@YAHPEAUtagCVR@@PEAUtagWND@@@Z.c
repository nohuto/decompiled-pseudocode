/*
 * XREFs of ?ValidateWindowPos@@YAHPEAUtagCVR@@PEAUtagWND@@@Z @ 0x1C0047C30
 * Callers:
      ...
      && *(_BYTE *)(v9 + 24) == 1 )
    {
      ...
      if ( *v12 )
      {
        *((_QWORD *)a1 + 13) = v13[2];
        if ( (*((_DWORD *)a1 + 8) & 4) != 0 )
          return 1LL;
        DesktopWindow = GetDesktopWindow((__int64)v13);
        ...
        if ( v20 >= 0 )
        {
          ...
          if ( v21 )
          {
            ...
            if ( !v22 || (v23 = v22[5], v24 = *(_BYTE *)(v23 + 19), v24 < 0) )
            {
            ...
            {
              if ( ((v24 & 4 ^ (*(unsigned __int8 *)(v23 + 24) >> 1) & 4) & 0xFFFFFFFC) == 0 )
                return 0LL;
              return !a2 || a2 == v16;
            }
            v25 = v22[11];
          ...
          if ( v25
            && ((*(_BYTE *)(*(_QWORD *)(v25 + 40) + 19LL) & 4 ^ (*(unsigned __int8 *)(*(_QWORD *)(v25 + 40) + 24LL) >> 1) & 4) & 0xFFFFFFFC) != 0 )
          {
            return 0LL;
          }
          return !a2 || a2 == v16;
