/*
 * XREFs of NtGdiCreateEllipticRgn @ 0x1C029E980
 * Callers:
 *     <none>
 * Callees:
...
struct HOBJ__ *__fastcall NtGdiCreateEllipticRgn(unsigned int a1, unsigned int a2, int a3, int a4)
{
  ...
  struct OBJECT *v12; // [rsp+28h] [rbp-E0h] BYREF
  int v13; // [rsp+30h] [rbp-D8h]
  int v14; // [rsp+34h] [rbp-D4h]
  _QWORD v15[16]; // [rsp+38h] [rbp-D0h] BYREF
  _DWORD v16[20]; // [rsp+B8h] [rbp-50h] BYREF
...
LABEL_21:
  ...
  v12 = (struct OBJECT *)__PAIR64__(a2, a1);
  v13 = a3;
  v14 = a4;
