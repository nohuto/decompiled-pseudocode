/*
 * XREFs of UserGetHipDeviceInfo @ 0x1C01EE830
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall UserGetHipDeviceInfo(_DWORD *a1, __int64 a2, __int64 a3)
{
  ...
  char *v27; // rax
  char *v28; // rax
  __int128 v30[4]; // [rsp+20h] [rbp-48h] BYREF
    ...
    if ( (*((_DWORD *)i + 50) & 0x80u) != 0 )
    {
      ...
      if ( v4 )
      {
        ...
        *(_QWORD *)&a1[v12 + 17] = *(_QWORD *)(v11 + 2096);
        ...
        RtlStringCchCopyW((char *)&a1[v12 + 149], 128LL, (char *)(v32 + 1364));
        v24 = *(_QWORD *)(v32 + 1352);
        if ( v24 )
        ...
        {
          a1[v12 + 3] = v26 | 1;
          *(_OWORD *)&a1[v12 + 12] = *GetMonitorRect(v30, v25, v22, v23);
        }
        else
        {
          a1[v12 + 3] = v26 & 0xFFFFFFFE;
          *(_OWORD *)&a1[v12 + 12] = 0LL;
        }
        v27 = (char *)&a1[v12];
        if ( *(_QWORD *)(v10 + 328) )
          RtlStringCbCopyUnicodeString(v27 + 84, 0x100uLL, (const struct _UNICODE_STRING *)(v10 + 320));
        else
          *((_WORD *)v27 + 42) = 0;
        v28 = (char *)&a1[v12];
        if ( *(_QWORD *)(v10 + 328) )
          RtlStringCbCopyUnicodeString(v28 + 852, 0x100uLL, (const struct _UNICODE_STRING *)(v10 + 848));
        else
          *((_WORD *)v28 + 426) = 0;
        v4 = v31;
        v6 -= 1104;
