/*
 * XREFs of ?JobCalloutTerminate@@YAHPEAUtagW32JOB@@@Z @ 0x1C010B000
 * Callers:
...
__int64 __fastcall JobCalloutTerminate(struct tagW32JOB *a1)
{
  ...
  if ( WPP_RECORDER_INITIALIZED != (_UNKNOWN *)&WPP_RECORDER_INITIALIZED )
    WPP_RECORDER_SF_q((_DWORD)a1, 4, 13, 24, (__int64)&WPP_8d1b82f3b1933447d2872340d476a1f2_Traceguids, (char)a1);
  v2 = *((_QWORD *)a1 + 7);
  if ( v2 )
  {
    Win32FreePool(v2);
