/*
 * XREFs of ?InternalCreateMenu@@YAPEAUtagMENU@@H@Z @ 0x1C00BD658
 * Callers:
 ...
 *     _CreateMenu @ 0x1C00BD640 (_CreateMenu.c)
 *     _CreatePopupMenu @ 0x1C012AF70 (_CreatePopupMenu.c)
 * Callees:
 *     ??$InitLookAsideRef@UtagMENU@@@@YAEPEAUtagMENU@@@Z @ 0x1C00BD714 (--$InitLookAsideRef@UtagMENU@@@@YAEPEAUtagMENU@@@Z.c)
