/*
 * XREFs of ?GetReportExtendedUsage@InteractiveControlManager@@QEAAJKKGGGPEAJ@Z @ 0x1C0251BDC
 * Callers:
 ...
 *     ?ExtractCustomUsage@InteractiveControlParser@@SAJPEAU_HIDP_PREPARSED_DATA@@PEAEKGGGPEAJ@Z @ 0x1C025BBD0 (-ExtractCustomUsage@InteractiveControlParser@@SAJPEAU_HIDP_PREPARSED_DATA@@PEAEKGGGPEAJ@Z.c)
 */
...
LABEL_10:
  ...
  Device = InteractiveControlParser::ExtractCustomUsage(
             ...
             *((_DWORD *)v22 + 22),
             ...
             a7);
  v14 = Device;
  if ( Device < 0 && (unsigned int)dword_1C032A2F8 > 2 )
    goto LABEL_10;
LABEL_11:
  if ( (unsigned int)dword_1C032A2F8 > 4 )
  {
