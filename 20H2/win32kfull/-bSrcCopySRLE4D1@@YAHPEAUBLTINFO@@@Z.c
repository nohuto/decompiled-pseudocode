/*
 * XREFs of ?bSrcCopySRLE4D1@@YAHPEAUBLTINFO@@@Z @ 0x1C02CC1E0
 * Callers:
 *     <none>
 * Callees:
...
LABEL_73:
    ...
    else
    {
      if ( v9 >= v60 )
      {
        v30 = byte_1C02FA048[(unsigned __int8)(7 - (v9 & 7))];
      }
      else
      {
        v29 = v60 - v9;
        ...
        LODWORD(v26) = v26 - v29;
        v30 = byte_1C02FA048[(unsigned __int8)(7 - (v60 & 7))];
        if ( (v29 & 1) != 0 )
        {
          v31 = v15 | v30;
          v30 >>= 1;
