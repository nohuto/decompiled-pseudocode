/*
 * XREFs of ProcessSuspendedEventMessage @ 0x1C011DBD4
 * Callers:
 ...
 * Callees:
 *     ?ProcessComplexCoalescence@@YAHII_K_JPEA_KPEA_J@Z @ 0x1C0008B44 (-ProcessComplexCoalescence@@YAHII_K_JPEA_KPEA_J@Z.c)
 ...
 *     ?FindQMsgForCoalesce@@YAPEAUtagQMSG@@PEAUtagMLIST@@IPEAUHWND__@@PEAU1@@Z @ 0x1C011DD5C (-FindQMsgForCoalesce@@YAPEAUtagQMSG@@PEAUtagMLIST@@IPEAUHWND__@@PEAU1@@Z.c)
 */
