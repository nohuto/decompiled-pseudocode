/*
 * XREFs of ?vComputeUncoveredSpriteRegion@RGNOBJ@@QEAAXAEAVPDEVOBJ@@@Z @ 0x1C0085AD4
 * Callers:
 ...
 *     ?bEnum@ENUMUNCOVERED@@QEAAHPEAU_RECTL@@@Z @ 0x1C0085C4C (-bEnum@ENUMUNCOVERED@@QEAAHPEAU_RECTL@@@Z.c)
 */
