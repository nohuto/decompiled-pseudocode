/*
 * XREFs of RemapHimetricPointsForMultiMonDigitizers @ 0x1C01E547C
 * Callers:
...
__int64 __fastcall RemapHimetricPointsForMultiMonDigitizers(__int64 a1, __int64 a2, _DWORD *a3, _DWORD *a4)
{
  ...
  __m128i v35; // [rsp+50h] [rbp-28h] BYREF
  ...
  *(_OWORD *)b = *(_OWORD *)a1;
  ...
  v18 = *(__m128i *)GetMonitorRect(&v34, a2, v16, v17);
  v34 = v18;
  ScreenRect = GetScreenRect(&v35);
  ...
  v24 = EngMulDiv(_mm_cvtsi128_si32(v18) - ScreenRect->m128i_i64[0], b[2], v23);
