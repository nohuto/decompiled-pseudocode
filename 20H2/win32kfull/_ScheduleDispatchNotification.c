/*
 * XREFs of _ScheduleDispatchNotification @ 0x1C004E6D0
 * Callers:
 *     <none>
 * Callees:
 ...
 *     ??1?$CLockExclusiveInUserCrit@VDLT_QUEUE@@@@QEAA@XZ @ 0x1C01DF800 (--1-$CLockExclusiveInUserCrit@VDLT_QUEUE@@@@QEAA@XZ.c)
 *     MicrosoftTelemetryAssertTriggeredNoArgsKM @ 0x1C02DE410 (MicrosoftTelemetryAssertTriggeredNoArgsKM.c)
 */

__int64 __fastcall ScheduleDispatchNotification(struct tagWND *a1, __int64 a2, __int64 a3)
{
  __int64 v3; // rdi
  ...
  if ( *(_QWORD *)(v3 + 424) == CurrentProcessWin32Process )
  {
    v6 = 0;
    if ( v3 != gptiCurrent
      && !(unsigned __int8)CheckAccess(CurrentProcessWin32Process + 880, *(_QWORD *)(v3 + 432) + 428LL) )
    {
      return 1LL;
    }
    v7 = *(_QWORD *)(v3 + 432);
    ...
    {
      vAdjustDelegatePriority((struct tagTHREADINFO *)v3, v14, v15);
      if ( (*(_DWORD *)(v3 + 1232) & 0x20) == 0 || (v26 = 0, (unsigned int)ProcessSuspendedEventMessage(v3, 9LL, a1)) )
      {
        ...
        else
        {
          ...
          if ( v16 )
          {
            ...
            *((_QWORD *)v17 + 13) = v3;
            if ( (*(_DWORD *)(v3 + 488) & 1) == 0 )
            {
              *(_WORD *)(*(_QWORD *)(v3 + 448) + 6LL) |= 0x2040u;
              *(_WORD *)(*(_QWORD *)(v3 + 448) + 4LL) |= 0x2040u;
              if ( (*(_WORD *)(*(_QWORD *)(v3 + 448) + 10LL) & 0x2040) != 0 )
                KeSetEvent(*(PRKEVENT *)(v3 + 736), 2, 0);
            }
