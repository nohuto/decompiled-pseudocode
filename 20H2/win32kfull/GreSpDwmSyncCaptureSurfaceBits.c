/*
 * XREFs of GreSpDwmSyncCaptureSurfaceBits @ 0x1C026F8FC
 * Callers:
...
_BOOL8 __fastcall GreSpDwmSyncCaptureSurfaceBits(HWND a1, HDC a2, float a3, int a4, int a5, int a6, int a7)
{
  ...
  __int64 v27; // [rsp+D8h] [rbp-1h] BYREF
  int v28; // [rsp+E0h] [rbp+7h]
  int v29; // [rsp+E4h] [rbp+Bh]
  ...
  if ( (v22[24] & 1) != 0 && (v14 = *(_QWORD *)(v18[0] + 496LL)) != 0 )
  {
    ...
    if ( !ERECTL::bWrapped((ERECTL *)&v27) && !KeAreApcsDisabled() )
    {
