/*
 * XREFs of ?vSpComputeUncoveredRegion@@YAXPEAU_SPRITESTATE@@H@Z @ 0x1C00859E4
 * Callers:
 ...
 *     ?vComputeUncoveredSpriteRegion@RGNOBJ@@QEAAXAEAVPDEVOBJ@@@Z @ 0x1C0085AD4 (-vComputeUncoveredSpriteRegion@RGNOBJ@@QEAAXAEAVPDEVOBJ@@@Z.c)
 */
...
LABEL_2:
    ...
    if ( *((_QWORD *)a1 + 129) && a2 == 1 )
    {
      ...
      if ( v12[0] )
      {
        ...
        if ( !RGNOBJ::bMerge((RGNOBJ *)v12, (struct RGNOBJ *)&v13, (struct RGNOBJ *)&v9, 4u) )
          RGNOBJ::vSet((RGNOBJ *)v12);
        if ( !RGNOBJ::bMerge((RGNOBJ *)&v13, (struct RGNOBJ *)&v14, (struct RGNOBJ *)v12, 0xEu) )
