/*
 * XREFs of ?TraceLoggingWinPHotKeyEvent@@YAXXZ @ 0x1C0225594
 * Callers:
 *     ?WinlogonHotkeyCallback@@YAX_K_J@Z @ 0x1C01D8E70 (-WinlogonHotkeyCallback@@YAX_K_J@Z.c)
 * Callees:
...
void TraceLoggingWinPHotKeyEvent(void)
{
    ...
    && (qword_1C032A410 & 0x400000000000LL) == qword_1C032A410 )
  {
    ...
    v4 = 0;
    v3 = 8;
    tlgWriteTransfer_EtwWriteTransfer((__int64)&dword_1C032A3F8, (unsigned __int8 *)dword_1C02F1588, 0LL, 0LL, 3u, &v1);
  }
}
