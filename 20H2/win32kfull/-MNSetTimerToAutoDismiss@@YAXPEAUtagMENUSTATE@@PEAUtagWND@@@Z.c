/*
 * XREFs of ?MNSetTimerToAutoDismiss@@YAXPEAUtagMENUSTATE@@PEAUtagWND@@@Z @ 0x1C023550C
 * Callers:
...
void __fastcall MNSetTimerToAutoDismiss(struct tagMENUSTATE *a1, struct tagWND *a2)
{
  ...
  {
    if ( InternalSetTimer((unsigned __int64)a2, 65529LL, 16 * *(&WPP_MAIN_CB.ActiveThreadCount + 1), 0LL, 0, 16) )
      *((_DWORD *)a1 + 2) |= 0x1000u;
  }
}
