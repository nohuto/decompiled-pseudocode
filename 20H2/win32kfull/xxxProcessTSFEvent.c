/*
 * XREFs of xxxProcessTSFEvent @ 0x1C0006784
 * Callers:
 ...
 * Callees:
 *     ?TSFRangeFromEvent@@YAKKW4TSFLocality@@@Z @ 0x1C000684C (-TSFRangeFromEvent@@YAKKW4TSFLocality@@@Z.c)
...
void *__fastcall xxxProcessTSFEvent(struct tagNOTIFY *a1)
{
  ...
  *(_QWORD *)a1 = a1;
  ...
  result = &unk_1C033B400;
  if ( a1 != (struct tagNOTIFY *)&unk_1C033B400 )
