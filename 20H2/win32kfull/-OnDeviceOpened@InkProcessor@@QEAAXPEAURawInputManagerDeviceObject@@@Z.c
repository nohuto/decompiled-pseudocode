/*
 * XREFs of ?OnDeviceOpened@InkProcessor@@QEAAXPEAURawInputManagerDeviceObject@@@Z @ 0x1C024F098
 * Callers:
 ...
 * Callees:
 *     ?OnDeviceOpened@RimBackedDeviceBase@Rim@@UEAAXXZ @ 0x1C0243460 (-OnDeviceOpened@RimBackedDeviceBase@Rim@@UEAAXXZ.c)
