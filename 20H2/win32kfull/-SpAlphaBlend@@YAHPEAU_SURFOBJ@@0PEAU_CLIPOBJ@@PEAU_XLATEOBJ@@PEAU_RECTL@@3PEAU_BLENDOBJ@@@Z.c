/*
 * XREFs of ?SpAlphaBlend@@YAHPEAU_SURFOBJ@@0PEAU_CLIPOBJ@@PEAU_XLATEOBJ@@PEAU_RECTL@@3PEAU_BLENDOBJ@@@Z @ 0x1C0084350
 * Callers:
 *     <none>
 * Callees:
        ...
        struct _BLENDOBJ *pBlendObj)
{
  ...
  if ( !hdev || *((struct _SURFOBJ **)hdev + 15) != a2 )
  {
    ...
    while ( 1 )
    {
      if ( !(unsigned int)ENUMUNDERLAYS::bEnum((ENUMUNDERLAYS *)v27, &v20, &v23, &v22) )
        return v8;
      v10 = v20;
      p_pvScan0 = 0LL;
      v21 = 0LL;
