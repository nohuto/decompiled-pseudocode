/*
 * XREFs of ?vSrcTranCopyS8D16New@@YAXPEAEJJ0JJJJKKPEAVSURFACE@@P6AXPEBE00JPEAPEAG@Z0@Z @ 0x1C0278418
 * Callers:
 ...
 *     ulBlendPixelCT @ 0x1C02780F0 (ulBlendPixelCT.c)
 *     ?vCopyAlphaBuffer16bpp@@YAXPEBEPEAE1JPEAPEAG@Z @ 0x1C0278260 (-vCopyAlphaBuffer16bpp@@YAXPEBEPEAE1JPEAPEAG@Z.c)
 */
      ...
      if ( (_BYTE)v23 )
      {
        ...
        else
        {
          if ( (_BYTE)v23 == 114 )
            ...
            v25 = ulBlendPixelCT((__int64)v28, v24, (unsigned __int8 *)off_1C032A0D0 + 4 * v23);
          *(_WORD *)v21 = v25;
        }
      }
      --v22;
