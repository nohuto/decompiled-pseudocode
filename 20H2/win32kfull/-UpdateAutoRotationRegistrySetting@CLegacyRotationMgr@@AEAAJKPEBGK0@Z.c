/*
 * XREFs of ?UpdateAutoRotationRegistrySetting@CLegacyRotationMgr@@AEAAJKPEBGK0@Z @ 0x1C011E0D8
 * Callers:
 *     ?AutoRotationUpdateRegistry@CLegacyRotationMgr@@UEAAXXZ @ 0x1C011DDA0 (-AutoRotationUpdateRegistry@CLegacyRotationMgr@@UEAAXXZ.c)
