/*
 * XREFs of xxxClientLoadImage @ 0x1C0077158
 * Callers:
        ...
        unsigned int a6)
{
  ...
  if ( (_WORD)v9 )
  {
    result = AllocCallbackMessage(96, (_WORD)v9 != 0, v9 & -(__int64)((_WORD)v9 != 0), v28, 1, 0x200uLL);
    v10 = result;
    v22 = result;
    if ( !result )
      return result;
  ...
  if ( v10 != (unsigned __int8 *)v27 && v10 != v28 )
    PushW32ThreadLock(v10, &v24, Win32FreePool);
  *((_DWORD *)v10 + 10) = v19;
  if ( (int)CaptureCallbackData(
              (struct _CAPTUREBUF *)v10,
              (unsigned __int64)v20,
              (unsigned int)(unsigned __int16)v19 + 2,
              (void **)v10 + 6) < 0 )
    goto LABEL_22;
  *((_WORD *)v10 + 28) = *a1;
  v11 = a1[1];
