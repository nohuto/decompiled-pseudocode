/*
 * XREFs of ?Feature_MSRC75758_vSetApiBitmapOnbCreateDIB__private_IsEnabled@@YAHXZ @ 0x1C015EA14
 * Callers:
...
__int64 Feature_MSRC75758_vSetApiBitmapOnbCreateDIB__private_IsEnabled(void)
{
  ...
  CachedFeatureEnabledState = wil_details_FeatureStateCache_GetCachedFeatureEnabledState(
                                (unsigned int *)&Feature_MSRC75758_vSetApiBitmapOnbCreateDIB__private_featureState,
                                (__int64)&Feature_MSRC75758_vSetApiBitmapOnbCreateDIB__private_descriptor);
  v1 = (CachedFeatureEnabledState >> 3) & 1;
  wil_details_FeatureReporting_ReportUsageToService(
    (__int64)&Feature_MSRC75758_vSetApiBitmapOnbCreateDIB__private_reporting,
    0x282F69Eu,
