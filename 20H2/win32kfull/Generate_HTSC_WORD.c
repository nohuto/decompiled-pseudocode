/*
 * XREFs of Generate_HTSC_WORD @ 0x1C0121008
 * Callers:
 ...
 *     RotateHTPatXY @ 0x1C0151248 (RotateHTPatXY.c)
 *     RotateHTPat45 @ 0x1C0152C94 (RotateHTPat45.c)
 */
...
LABEL_14:
    ...
    v20 = 16 * (v5 >> 1);
    v9 = (v8 << 24) + 808539208;
    v10 = *(__int64 *)((char *)&off_1C02DF2B8 + v20);
    v11 = v10;
