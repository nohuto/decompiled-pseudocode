/*
 * XREFs of ?SpBitBlt@@YAHPEAU_SURFOBJ@@00PEAU_CLIPOBJ@@PEAU_XLATEOBJ@@PEAU_RECTL@@PEAU_POINTL@@4PEAU_BRUSHOBJ@@4K@Z @ 0x1C00AF010
 * Callers:
 *     ?bSpUpdatePosition@@YAHPEAVSPRITE@@PEAU_POINTL@@HH@Z @ 0x1C0085DBC (-bSpUpdatePosition@@YAHPEAVSPRITE@@PEAU_POINTL@@HH@Z.c)
 *     ?SpCopyBits@@YAHPEAU_SURFOBJ@@0PEAU_CLIPOBJ@@PEAU_XLATEOBJ@@PEAU_RECTL@@PEAU_POINTL@@@Z @ 0x1C00F8DE0 (-SpCopyBits@@YAHPEAU_SURFOBJ@@0PEAU_CLIPOBJ@@PEAU_XLATEOBJ@@PEAU_RECTL@@PEAU_POINTL@@@Z.c)
 * Callees:
  ...
  if ( !hdev || a2 != *((struct _SURFOBJ **)hdev + 15) )
  {
    ...
    while ( 1 )
    {
      ...
      if ( updated )
      {
        ...
        {
          p_iType = &v16->iType;
          if ( v16->iType == 1 && bAllowShareAccess(v16) )
          {
        ...
        *(struct _RECTL *)v65 = v64;
        if ( !ppco || bIntersect(&ppco->rclBounds, &v64, (struct _RECTL *)v65) )
        {
          ...
          if ( v16->iType == 1 )
          {
            ...
            if ( *v41 != 1 || !bAllowShareAccess(v16) )
              goto LABEL_57;
            if ( !W32GetThreadWin32Thread(KeGetCurrentThread())
              || !*(_QWORD *)(W32GetThreadWin32Thread(KeGetCurrentThread()) + 280)
              || !*(_DWORD *)(W32GetThreadWin32Thread(KeGetCurrentThread()) + 104)
