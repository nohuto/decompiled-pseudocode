/*
 * XREFs of ?ulSetEntries@XEPALOBJ@@QEAAKKKPEBUtagPALETTEENTRY@@@Z @ 0x1C02BBF48
 * Callers:
...
__int64 __fastcall XEPALOBJ::ulSetEntries(XEPALOBJ *this, __int64 a2, __int64 a3, const struct tagPALETTEENTRY *a4)
{
  __int64 v4; // r10
  const struct tagPALETTEENTRY *v5; // rdi
  unsigned int v6; // ebx
  __int64 v7; // rsi
  unsigned int v9; // ecx
  _BYTE *v10; // rdx
  ...
  {
    --v6;
    *(const struct tagPALETTEENTRY *)((char *)v5 + v16) = *v5;
    if ( v10 )
      *v10++ = 0;
    if ( v11 )
      *v11++ = 0;
