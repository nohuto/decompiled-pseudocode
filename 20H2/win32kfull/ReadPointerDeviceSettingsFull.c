/*
 * XREFs of ReadPointerDeviceSettingsFull @ 0x1C00330A4
 * Callers:
...
__int64 __fastcall ReadPointerDeviceSettingsFull(int a1, __int64 a2, unsigned __int16 *a3, unsigned int a4)
{
  ...
  if ( !v7 )
  {
    v30 = off_1C032A698;
    if ( !gModeMonitor )
      GetDWORDSettingValues(7LL, off_1C032A698, 7LL);
    v31 = *((_DWORD *)v30 + 3);
    if ( v31 == -1 )
      v31 = *((_DWORD *)v30 + 2);
    *(_DWORD *)a2 = v31;
  ...
  if ( v23 == 2 )
  {
    if ( !gPredictionMonitor )
      gPredictionMonitor = (int)CreatePredictionSettings(off_1C032A018, a2, a3, a4) >= 0;
    if ( gPredictionMonitor == 1 )
    {
      v24 = off_1C032A018;
      GetPredictionSettings(off_1C032A018, a2, a3, a4);
      v25 = *((_DWORD *)v24 + 3);
      v26 = 60;
      if ( v25 == -1 )
      {
