/*
 * XREFs of ?zzzAnimateCursor@@YAXPEAUtagWND@@I_K_J@Z @ 0x1C00CC630
 * Callers:
...
void __fastcall zzzAnimateCursor(struct tagWND *a1, __int64 a2, __int64 a3)
{
  ...
  if ( v4 && (*((_DWORD *)v4 + 20) & 8) != 0 && *((_QWORD *)v4 + 14) )
  {
    ...
    *(_QWORD *)(v11 + 416) = v30;
    ...
    LODWORD(v17) = (2863311531u * (unsigned __int64)(unsigned int)v21) >> 32;
    v22 = (unsigned int)v21 / 6;
    if ( (int)((unsigned int)v21 / 6) <= v7 )
    {
      v24 = *((_DWORD *)v6 + 23);
      LODWORD(v19) = *((_DWORD *)v6 + 30);
      do
      {
        v25 = v19 + 1;
        v7 -= v22;
