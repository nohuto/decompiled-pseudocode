/*
 * XREFs of ?bSpDwmValidateSurface@@YAHAEAVXDCOBJ@@HHHH@Z @ 0x1C00B180C
 * Callers:
 ...
 *     ?bContain@RGNOBJ@@QEAAHAEAU_RECTL@@@Z @ 0x1C01070B0 (-bContain@RGNOBJ@@QEAAHAEAU_RECTL@@@Z.c)
...
LABEL_16:
  ...
  if ( (*(_DWORD *)(v51[0] + 32LL) & 2) == 0 )
    goto LABEL_15;
  v38 = v34;
  EXFORMOBJ::bXform((EXFORMOBJ *)v51, &v38);
  v15 = *(_QWORD *)a1;
