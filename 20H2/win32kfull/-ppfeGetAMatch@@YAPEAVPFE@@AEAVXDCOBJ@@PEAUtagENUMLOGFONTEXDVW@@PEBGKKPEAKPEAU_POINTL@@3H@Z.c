/*
 * XREFs of ?ppfeGetAMatch@@YAPEAVPFE@@AEAVXDCOBJ@@PEAUtagENUMLOGFONTEXDVW@@PEBGKKPEAKPEAU_POINTL@@3H@Z @ 0x1C0059B40
 * Callers:
 ...
 *     ?vEmergency@MAPPER@@QEAAXXZ @ 0x1C02938B4 (-vEmergency@MAPPER@@QEAAXXZ.c)
 */
