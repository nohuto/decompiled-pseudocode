/*
 * XREFs of bMoveDevDragRect @ 0x1C0285128
 * Callers:
...
__int64 __fastcall bMoveDevDragRect(HDEV a1, int *a2, int *a3, int a4)
{
  ...
  v37 = a1;
  v36 = a1;
  SEMOBJSHARED::SEMOBJSHARED((SEMOBJSHARED *)v40, ghsemDynamicModeChange);
  v39 = ghsemGreLock;
...
LABEL_21:
    ...
    do
    {
      if ( *v32 )
      {
        LODWORD(v34) = a4 != 0 ? 0x2000000 : 0;
        GreUpdateSprite(v5, 0LL, *v32, 0LL, 0LL, 0LL, 0LL, 0LL, 0, 0LL, v34, 0LL, 0LL, a4, 0);
      }
      ++v32;
      --v31;
    }
