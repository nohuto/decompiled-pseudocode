/*
 * XREFs of ?Feature_Servicing_Perf_FindWindowEx__private_IsEnabled@@YAHXZ @ 0x1C015C000
 * Callers:
...
__int64 Feature_Servicing_Perf_FindWindowEx__private_IsEnabled(void)
{
  ...
  CachedFeatureEnabledState = wil_details_FeatureStateCache_GetCachedFeatureEnabledState(
                                &Feature_Servicing_Perf_FindWindowEx__private_featureState,
                                &Feature_Servicing_Perf_FindWindowEx__private_descriptor);
  v1 = (CachedFeatureEnabledState >> 3) & 1;
  wil_details_FeatureReporting_ReportUsageToService(
    (__int64)&Feature_Servicing_Perf_FindWindowEx__private_reporting,
    0x27CDC11u,
