/*
 * XREFs of ?_TTUpdateRankWithSegment@@YAXJJJJPEAUtagPOINT@@PEAGUtagRECT@@PEBUtagTOUCHTARGETINGCONTACT@@@Z @ 0x1C025EEAC
 * Callers:
 ...
 *     TouchTargetingRank @ 0x1C025F724 (TouchTargetingRank.c)
 *     TouchTargetingSnapToSegment @ 0x1C025FF78 (TouchTargetingSnapToSegment.c)
 */
