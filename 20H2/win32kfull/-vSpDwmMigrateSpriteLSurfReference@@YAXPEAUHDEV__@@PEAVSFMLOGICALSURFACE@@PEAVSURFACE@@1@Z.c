/*
 * XREFs of ?vSpDwmMigrateSpriteLSurfReference@@YAXPEAUHDEV__@@PEAVSFMLOGICALSURFACE@@PEAVSURFACE@@1@Z @ 0x1C00FB7F8
 * Callers:
 *     vSpDwmMigrateSpriteLSurfReferenceWrap @ 0x1C00FB7E0 (vSpDwmMigrateSpriteLSurfReferenceWrap.c)
 * Callees:
