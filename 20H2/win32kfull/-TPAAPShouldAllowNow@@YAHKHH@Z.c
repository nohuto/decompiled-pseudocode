/*
 * XREFs of ?TPAAPShouldAllowNow@@YAHKHH@Z @ 0x1C02131D0
 * Callers:
 *     EditionLegacyTouchPadMouseAllowTap @ 0x1C0213720 (EditionLegacyTouchPadMouseAllowTap.c)
 * Callees:
 *     ?TPAAPSqmBlockedCount@@YAXH@Z @ 0x1C021330C (-TPAAPSqmBlockedCount@@YAXH@Z.c)
 */
