/*
 * XREFs of BRUSHOBJ_pvAllocRbrush @ 0x1C026CC00
 * Callers:
 *     VerifierBRUSHOBJ_pvAllocRbrush @ 0x1C029D420 (VerifierBRUSHOBJ_pvAllocRbrush.c)
 *     ?MulRealizeBrush@@YAHPEAU_BRUSHOBJ@@PEAU_SURFOBJ@@11PEAU_XLATEOBJ@@K@Z @ 0x1C02A31A0 (-MulRealizeBrush@@YAHPEAU_BRUSHOBJ@@PEAU_SURFOBJ@@11PEAU_XLATEOBJ@@K@Z.c)
 * Callees:
