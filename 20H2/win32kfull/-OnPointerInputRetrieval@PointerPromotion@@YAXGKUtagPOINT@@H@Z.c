/*
 * XREFs of ?OnPointerInputRetrieval@PointerPromotion@@YAXGKUtagPOINT@@H@Z @ 0x1C021865C
 * Callers:
 *     PointerPromotionOnPointerInputRetrieval @ 0x1C02197F0 (PointerPromotionOnPointerInputRetrieval.c)
 * Callees:
  ...
  if ( CacheById )
  {
    ...
    if ( MousePromotionEntry )
    {
      *((_QWORD *)MousePromotionEntry + 1) = v8;
      if ( !v9 && !word_1C0339BC0 )
      {
        v11 = v14[0] + 1;
        if ( (unsigned int)v11 < 5 )
        {
          v12 = (unsigned int)(5 - v11);
          v13 = (struct tagMOUSE_PROMOTION_QUEUE *)((char *)&unk_1C0339AF0 + 24 * v11);
          do
          {
