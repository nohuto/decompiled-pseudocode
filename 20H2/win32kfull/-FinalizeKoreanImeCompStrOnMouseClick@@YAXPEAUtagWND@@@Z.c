/*
 * XREFs of ?FinalizeKoreanImeCompStrOnMouseClick@@YAXPEAUtagWND@@@Z @ 0x1C01D7FE0
 * Callers:
 *     EditionFinalizeKoreanImeCompStrOnMouseClick @ 0x1C00FDBE0 (EditionFinalizeKoreanImeCompStrOnMouseClick.c)
 * Callees:
