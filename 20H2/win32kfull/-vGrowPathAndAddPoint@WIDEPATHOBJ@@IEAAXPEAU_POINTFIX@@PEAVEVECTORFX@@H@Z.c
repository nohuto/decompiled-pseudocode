/*
 * XREFs of ?vGrowPathAndAddPoint@WIDEPATHOBJ@@IEAAXPEAU_POINTFIX@@PEAVEVECTORFX@@H@Z @ 0x1C02CE184
 * Callers:
 ...
 * Callees:
 *     ?bGrowPath@WIDEPATHOBJ@@IEAAHXZ @ 0x1C0135508 (-bGrowPath@WIDEPATHOBJ@@IEAAHXZ.c)
 */
