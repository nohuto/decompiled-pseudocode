/*
 * XREFs of EngAlphaBlend @ 0x1C0069DA0
 * Callers:
 ...
 *     ?bDetermineAlphaBlendFunction@@YAHPEAVSURFACE@@0PEAVXEPALOBJ@@1PEAVXLATE@@JPEAU_ALPHA_DISPATCH_FORMAT@@H@Z @ 0x1C006A618 (-bDetermineAlphaBlendFunction@@YAHPEAVSURFACE@@0PEAVXEPALOBJ@@1PEAVXLATE@@JPEAU_ALPHA_DISPATCH_F.c)
        ...
        if ( (_DWORD)v56 )
        {
          ...
          while ( 1 )
          {
            ...
            if ( !v27 )
              break;
LABEL_44:
            v45 = XCLIPOBJ::bEnum(v26, 0x144u, &v85, 0LL);
            top = v81.top;
            v27 = v45;
            LODWORD(v55) = v45;
          }
