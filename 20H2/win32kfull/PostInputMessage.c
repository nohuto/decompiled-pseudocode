/*
 * XREFs of PostInputMessage @ 0x1C00D6C28
 * Callers:
...
LABEL_11:
      ...
      *(_QWORD *)(v25 + 136) = a7;
      ...
      if ( *((_DWORD *)a1 + 98) <= 1u )
        goto LABEL_24;
      v29 = *(_QWORD *)(W32GetThreadWin32Thread((__int64)KeGetCurrentThread()) + 464);
      if ( *(_QWORD *)(v29 + 48) )
        goto LABEL_24;
      v29 = *(_QWORD *)(W32GetThreadWin32Thread((__int64)KeGetCurrentThread()) + 464);
      if ( *(_QWORD *)(v29 + 56) )
