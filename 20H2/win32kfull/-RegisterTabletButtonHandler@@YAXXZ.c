/*
 * XREFs of ?RegisterTabletButtonHandler@@YAXXZ @ 0x1C01D8778
 * Callers:
 *     RawInputThread @ 0x1C0009A30 (RawInputThread.c)
 * Callees:
 *     _RegisterRawInputDevices @ 0x1C00FF680 (_RegisterRawInputDevices.c)
 *     ?ReadTabletButtonSettings@@YAXXZ @ 0x1C01D86D4 (-ReadTabletButtonSettings@@YAXXZ.c)
 */
...
void RegisterTabletButtonHandler(void)
{
  ...
  v3 = gObjDummyLock;
  v4 = v0;
  RegisterRawInputDevices((__int64)v1, 1LL, 1LL);
}
