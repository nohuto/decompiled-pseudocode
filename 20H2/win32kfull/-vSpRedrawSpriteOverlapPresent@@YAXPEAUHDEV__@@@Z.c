/*
 * XREFs of ?vSpRedrawSpriteOverlapPresent@@YAXPEAUHDEV__@@@Z @ 0x1C00C31E8
 * Callers:
...
void __fastcall vSpRedrawSpriteOverlapPresent(HDEV a1)
{
  ...
  __int64 *v21[24]; // [rsp+68h] [rbp-A0h] BYREF
  ...
  if ( v8 == v7 )
  {
    if ( v25 || v33 )
    {
      ...
      while ( 1 )
      {
        ...
        if ( v9 )
        {
          v11 = XCLIPOBJ::bEnum((XCLIPOBJ *)v23, 0x144u, (char *)v41, 0LL);
          v10 = v41[0];
          v9 = v11;
        }
        if ( v5 )
        {
          v12 = XCLIPOBJ::bEnum((XCLIPOBJ *)v31, 0x144u, (char *)&v39, 0LL);
          v3 = v39;
          v5 = v12;
        }
        if ( v10 != v3 )
...
LABEL_38:
    ...
    do
    {
      v15 = XCLIPOBJ::bEnum((XCLIPOBJ *)&v39, 0x144u, (char *)v41, 0LL);
LABEL_40:
      if ( v41[0] )
      {
        do
