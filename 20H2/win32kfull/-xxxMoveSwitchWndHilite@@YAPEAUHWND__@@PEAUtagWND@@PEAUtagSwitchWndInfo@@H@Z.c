/*
 * XREFs of ?xxxMoveSwitchWndHilite@@YAPEAUHWND__@@PEAUtagWND@@PEAUtagSwitchWndInfo@@H@Z @ 0x1C01F2F40
 * Callers:
...
LABEL_23:
  v21 = v5 == 0;
  *((_QWORD *)v6 + 4) = NextPrevPhwnd(v6, *((HWND **)v6 + 4), v21);
  ...
  *((_DWORD *)v6 + 17) = v10;
  ...
  if ( v8 )
  {
    xxxPaintIconsInSwitchWindow(a1, v6, DCEx, *((_DWORD *)v6 + 13), v20, 0, 1, v21, 0LL);
    v6 = Getpswi(a1, v16, v17, v18);
  }
  if ( v6 )
  {
