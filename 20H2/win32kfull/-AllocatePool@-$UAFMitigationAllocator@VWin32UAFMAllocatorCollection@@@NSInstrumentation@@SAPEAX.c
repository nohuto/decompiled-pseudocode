/*
 * XREFs of ?AllocatePool@?$UAFMitigationAllocator@VWin32UAFMAllocatorCollection@@@NSInstrumentation@@SAPEAXW4_POOL_TYPE@@_KIPEAI@Z @ 0x1C021F4EC
 * Callers:
 *     Win32UAFMAllocPagedLookasideListImpl @ 0x1C021FD50 (Win32UAFMAllocPagedLookasideListImpl.c)
 *     Win32UAFMAllocPoolImpl @ 0x1C021FDD0 (Win32UAFMAllocPoolImpl.c)
 * Callees:
