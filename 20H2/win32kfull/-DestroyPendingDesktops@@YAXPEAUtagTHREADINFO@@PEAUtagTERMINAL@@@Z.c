/*
 * XREFs of ?DestroyPendingDesktops@@YAXPEAUtagTHREADINFO@@PEAUtagTERMINAL@@@Z @ 0x1C007D268
 * Callers:
...
void __fastcall DestroyPendingDesktops(struct tagTHREADINFO *a1, struct tagTERMINAL *a2)
{
  ...
  while ( v7 )
  {
    ...
    if ( v7 == grpdeskRitInput )
    {
      ...
      {
        LOBYTE(v14) = 4;
        WPP_RECORDER_SF_(v15, v14, 8, 11, (__int64)&WPP_9563cc11843c38630c872e630d898c35_Traceguids);
      }
      if ( (*(_DWORD *)(v12 + 64) & 1) != 0 )
      {
        ...
        {
          LOBYTE(v14) = 4;
          WPP_RECORDER_SF_(v15, v14, 8, 12, (__int64)&WPP_9563cc11843c38630c872e630d898c35_Traceguids);
        }
          ...
          && ((PVOID)v7 == grpdeskLogon || !grpdeskLogon || (*((_DWORD *)grpdeskLogon + 12) & 2) != 0) )
        {
          ...
          {
            LOBYTE(v14) = 4;
            WPP_RECORDER_SF_(v15, v14, 8, 13, (__int64)&WPP_9563cc11843c38630c872e630d898c35_Traceguids);
          }
      ...
      else
      {
        ...
        if ( !v43 )
        {
          ...
          {
            LOBYTE(v14) = 4;
            WPP_RECORDER_SF_(v15, v14, 8, 14, (__int64)&WPP_9563cc11843c38630c872e630d898c35_Traceguids);
          }
      ...
      PushW32ThreadLock(v43, &v61, UserDereferenceObject);
      if ( v43 )
...
LABEL_8:
    ...
    v18 = *((_QWORD *)a1 + 74);
    PushW32ThreadLock(v17, &v63, UserDereferenceObject);
    if ( v17 )
...
LABEL_40:
    ...
    if ( v34 )
    {
      ...
      if ( v35 )
      {
        ...
        {
          LOBYTE(v19) = 4;
          WPP_RECORDER_SF_(v26, v19, 8, 18, (__int64)&WPP_9563cc11843c38630c872e630d898c35_Traceguids);
        }
        ...
        if ( v7 == grpdeskRitInput )
        {
          *(_DWORD *)(v7 + 48) |= 1u;
          ...
          {
            LOBYTE(v36) = 4;
            WPP_RECORDER_SF_q(v37, v36, 8, 19, (__int64)&WPP_9563cc11843c38630c872e630d898c35_Traceguids, v7);
          }
        }
        else
        {
  ...
  {
    LOBYTE(v4) = 4;
    WPP_RECORDER_SF_(v5, v4, 8, 20, (__int64)&WPP_9563cc11843c38630c872e630d898c35_Traceguids);
  }
