/*
 * XREFs of xxxInjectTouchInput @ 0x1C01DC64C
 * Callers:
 ...
 *     ?SortTouchContacts@@YAHPEAUtagPOINTER_TOUCH_INFO@@I@Z @ 0x1C01DB49C (-SortTouchContacts@@YAHPEAUtagPOINTER_TOUCH_INFO@@I@Z.c)
 ...
 *     ?_ValidateInjectionQpcCount@@YAH_K00HH@Z @ 0x1C01DBAD8 (-_ValidateInjectionQpcCount@@YAH_K00HH@Z.c)
 *     ?_ValidateInjectionTime@@YAHKKKHH@Z @ 0x1C01DBB48 (-_ValidateInjectionTime@@YAHKKKHH@Z.c)
