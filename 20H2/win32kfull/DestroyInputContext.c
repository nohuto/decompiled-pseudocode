/*
 * XREFs of DestroyInputContext @ 0x1C014D0DC
 * Callers:
 ...
 *     AssociateInputContext @ 0x1C01105F4 (AssociateInputContext.c)
 */
...
LABEL_16:
  ...
  v5 = BuildHwndList(
         *(struct tagWND **)(*(_QWORD *)(*(_QWORD *)(*(_QWORD *)(v4 + 456) + 8LL) + 24LL) + 112LL),
         3,
         a1[2]);
  v6 = v5;
  if ( v5 )
    ...
    for ( i = (unsigned __int64 *)((char *)v5 + 32); *i != 1; ++i )
    {
      ...
      if ( v8 )
      {
        if ( *(_QWORD *)(*(_QWORD *)(v8 + 40) + 208LL) == *a1 )
          AssociateInputContext(v8, *(__int64 **)(v4 + 792));
      }
    }
    FreeHwndList(v6);
  }
