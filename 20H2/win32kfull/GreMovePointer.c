/*
 * XREFs of GreMovePointer @ 0x1C00C4410
 * Callers:
 ...
 *     ApplyGatheredDeviceInfoSummaryInformation @ 0x1C0125DC0 (ApplyGatheredDeviceInfoSummaryInformation.c)
 *     HideMouseTrails @ 0x1C01D4020 (HideMouseTrails.c)
