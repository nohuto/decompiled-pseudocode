/*
 * XREFs of ?ValidatePointerPromotion@@YAHGKPEAKPEAPEAUtagMOUSE_PROMOTION_ENTRY@@1@Z @ 0x1C0218DEC
 * Callers:
 ...
 *     ?FindCacheById@@YAPEAUtagMOUSE_PROMOTION_CACHE@@GPEAK@Z @ 0x1C021849C (-FindCacheById@@YAPEAUtagMOUSE_PROMOTION_CACHE@@GPEAK@Z.c)
 *     ?FindMousePromotionEntry@@YAPEAUtagMOUSE_PROMOTION_ENTRY@@AEBUtagMOUSE_PROMOTION_QUEUE@@K@Z @ 0x1C02184D0 (-FindMousePromotionEntry@@YAPEAUtagMOUSE_PROMOTION_ENTRY@@AEBUtagMOUSE_PROMOTION_QUEUE@@K@Z.c)
        ...
        struct tagMOUSE_PROMOTION_ENTRY **a5)
{
  ...
  v10 = CacheById;
  if ( !CacheById || CacheById == word_1C0339AE8 && (dword_1C0339BE8 & 2) != 0 )
    return 0LL;
  ...
  if ( v5 != 0x10000000 || (v5 = DetectPromotionType(v12, v13), v5 != v15) )
  {
    ...
    else if ( v18 || v10 != word_1C0339AE8 )
    {
      return 0LL;
    }
    *a3 = v5;
