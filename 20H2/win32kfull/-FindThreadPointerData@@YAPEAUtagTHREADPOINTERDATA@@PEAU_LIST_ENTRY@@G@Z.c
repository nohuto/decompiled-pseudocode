/*
 * XREFs of ?FindThreadPointerData@@YAPEAUtagTHREADPOINTERDATA@@PEAU_LIST_ENTRY@@G@Z @ 0x1C01F09BC
 * Callers:
 ...
 *     EditionFindThreadPointerData @ 0x1C01F1B30 (EditionFindThreadPointerData.c)
 * Callees:
 *     <none>
 */
