/*
 * XREFs of ?PromotePointerInternal@@YAHGKPEAUtagMOUSE_PROMOTION_ENTRY@@0@Z @ 0x1C0218974
 * Callers:
 ...
 *     ?ValidateDoubleClick@@YAHAEBUtagTAP_INFO@@KKH@Z @ 0x1C0218D70 (-ValidateDoubleClick@@YAHAEBUtagTAP_INFO@@KKH@Z.c)
 */
        ...
        struct tagMOUSE_PROMOTION_ENTRY *a4)
{
  ...
  if ( (dword_1C0339BE8 & 8) != 0
    && CacheById == (struct tagMOUSE_PROMOTION_CACHE *)word_1C0339AE8
  ...
  v22 = (v4 & 0x20000) != 0;
  if ( (v4 & 0x40000) != 0 )
    v13 = ValidateDoubleClick((const struct tagTAP_INFO *)&xmmword_1C0339BA0, v26, *((_DWORD *)a3 + 4), (v4 & 2) != 0);
  else
    v13 = 0;
  if ( v13 )
    *((_QWORD *)a3 + 1) = *(_QWORD *)((char *)&xmmword_1C0339BA0 + 12);
  v14 = v9 + 1;
  v15 = *((_QWORD *)a3 + 1);
  v26 = *((_DWORD *)a3 + 4);
  if ( (unsigned int)v14 < 5 )
  {
    ...
    v17 = (struct tagMOUSE_PROMOTION_QUEUE *)((char *)&unk_1C0339AF0 + 24 * v14);
    do
    {
  ...
  else
  {
    ...
    {
      if ( v10 )
        v18 = dword_1C0339BE8 | 4;
      else
        v18 = dword_1C0339BE8 & 0xFFFFFFFB;
      dword_1C0339BE8 = v18 & 0xFFFFFFEF | (16 * v12) | 2;
    }
  }
  if ( v23 )
  {
    *(&xmmword_1C0339BA0 + 4) = a1;
    dword_1C0339BB4 = v26;
    xmmword_1C0339BA0 = gptiCurrent;
    *(_QWORD *)((char *)&xmmword_1C0339BA0 + 12) = v15;
    dword_1C0339BB8 = v11;
  }
  else if ( v4 )
  {
    xmmword_1C0339BA0 = 0LL;
    unk_1C0339BB0 = 0LL;
  }
  return 1LL;
}
