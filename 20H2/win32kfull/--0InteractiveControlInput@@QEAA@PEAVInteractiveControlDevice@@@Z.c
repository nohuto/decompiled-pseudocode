/*
 * XREFs of ??0InteractiveControlInput@@QEAA@PEAVInteractiveControlDevice@@@Z @ 0x1C0257FCC
 * Callers:
        ...
        struct InteractiveControlDevice *a2)
{
  ...
  *((_QWORD *)this + 5) = a2;
  *((_DWORD *)this + 7) = v2 >> 24;
  LOWORD(v2) = word_1C0333420;
  *((_DWORD *)this + 8) = (unsigned __int16)word_1C0333420;
  *((_DWORD *)this + 12) = 0;
  *((_QWORD *)this + 10) = 0LL;
  *((_DWORD *)this + 22) = 0;
  word_1C0333420 = v2 + 1;
