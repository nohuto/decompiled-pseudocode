/*
 * XREFs of _RegisterDManipHook @ 0x1C011D224
 * Callers:
...
__int64 __fastcall RegisterDManipHook(__int64 a1, unsigned __int64 a2, const unsigned __int16 *a3)
{
  ...
  if ( gihmodDManipHook >= 0
    ...
    || (v4 = *(unsigned int *)(PsGetCurrentProcessWin32Process(v3, a2, a3) + 780), (_DWORD)v4 != luidSystem[0])
    || (CurrentProcessWin32Process = PsGetCurrentProcessWin32Process(v4, a2, a3),
  ...
  if ( RtlStringCopyWorkerW(pszDest, 0x82uLL, v8, NtSystemRoot, v15) < 0 || (int)RtlStringCbCatW(pszDest, a2, a3) < 0 )
  {
    v10 = 3LL;
    goto LABEL_10;
  }
...
LABEL_10:
  ...
  gppiDManipHook = PsGetCurrentProcessWin32Process(v13, v12, v14);
