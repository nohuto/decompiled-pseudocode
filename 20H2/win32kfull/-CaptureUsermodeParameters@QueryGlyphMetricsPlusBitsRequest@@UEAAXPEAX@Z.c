/*
 * XREFs of ?CaptureUsermodeParameters@QueryGlyphMetricsPlusBitsRequest@@UEAAXPEAX@Z @ 0x1C005F330
 * Callers:
 *     <none>
 * Callees:
 *     ?ValidateGlyphBitsBuffer@@YA_NKJJKK@Z @ 0x1C005F6B0 (-ValidateGlyphBitsBuffer@@YA_NKJJKK@Z.c)
