 ...
 *     ?bSetHTSurfInfo@@YAHPEAU_SURFOBJ@@PEAU_HTSURFACEINFO@@J@Z @ 0x1C006C8F4 (-bSetHTSurfInfo@@YAHPEAU_SURFOBJ@@PEAU_HTSURFACEINFO@@J@Z.c)
 ...
 *     ?bEqualEntries@XEPALOBJ@@QEAAHV1@@Z @ 0x1C0101C6C (-bEqualEntries@XEPALOBJ@@QEAAHV1@@Z.c)
...
LABEL_96:
          ...
          {
            if ( !(unsigned int)PALMEMOBJ::bCreateHTPalette((PALMEMOBJ *)&v133, v31, (struct _GDIINFO *)(v108 + 2136)) )
              goto LABEL_113;
            v115 = (SURFOBJ *)&v133;
...
LABEL_153:
            ...
            if ( v36 )
            {
              *((_QWORD *)&v125 + 1) = *((_QWORD *)v36 + 14);
              WORD1(v125) = *((_WORD *)v36 + 14);
              v90 = *((_DWORD *)v36 + 6);
              if ( (v90 & 8) != 0
                || (v90 & 2) != 0
                && (v91 = (_DWORD *)*((_QWORD *)v36 + 14), *v91 == 16711680)
                && v91[1] == 65280
                && v91[2] == 255 )
              {
                LOBYTE(v125) = v89 | 2;
...
LABEL_89:
                    ...
                    if ( v68 )
                    {
                      if ( (unsigned int)bUMPDSecurityGateEx() && !v129 )
                      {
                        if ( gfUMPDDebug )
                          DbgPrint(
                        ...
                        if ( v99 )
                        {
                          ...
                          do
                          {
                            ...
                            if ( *v100 )
                            {
                              do
                              {
                                prclDest[3] = *(_OWORD *)&v100[4 * v103++ + 1];
