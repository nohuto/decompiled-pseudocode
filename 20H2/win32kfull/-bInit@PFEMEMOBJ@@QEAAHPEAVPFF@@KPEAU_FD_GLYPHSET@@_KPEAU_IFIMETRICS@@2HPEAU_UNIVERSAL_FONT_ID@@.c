/*
 * XREFs of ?bInit@PFEMEMOBJ@@QEAAHPEAVPFF@@KPEAU_FD_GLYPHSET@@_KPEAU_IFIMETRICS@@2HPEAU_UNIVERSAL_FONT_ID@@H@Z @ 0x1C001EC94
 * Callers:
 ...
 *     ?dpNtmi@PFEOBJ@@QEAAKXZ @ 0x1C001F2F4 (-dpNtmi@PFEOBJ@@QEAAKXZ.c)
 *     IsAnyCharsetDbcs @ 0x1C001F350 (IsAnyCharsetDbcs.c)
        ...
        int a10)
{
  ...
  *(_DWORD *)(*(_QWORD *)this + 80LL) = _InterlockedIncrement(&dword_1C033B7A8);
