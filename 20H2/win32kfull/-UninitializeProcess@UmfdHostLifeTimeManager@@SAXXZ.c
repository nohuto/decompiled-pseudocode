/*
 * XREFs of ?UninitializeProcess@UmfdHostLifeTimeManager@@SAXXZ @ 0x1C00EA030
 * Callers:
 *     UmfdUninitializeProcess @ 0x1C00E9F80 (UmfdUninitializeProcess.c)
 * Callees:
 ...
 *     ?UmfdGetServerPort@@YAPEAXW4FontDriverType@@@Z @ 0x1C00EA85C (-UmfdGetServerPort@@YAPEAXW4FontDriverType@@@Z.c)
