/*
 * XREFs of ?GrePatBltLockedDC@@YAHAEAVXDCOBJ@@AEAVEXFORMOBJ@@PEAVERECTL@@KPEAVSURFACE@@KKKK@Z @ 0x1C009DD54
 * Callers:
        ...
        unsigned int a9)
{
  ...
  __m128i v44[4]; // [rsp+60h] [rbp-48h] BYREF
...
LABEL_16:
                ...
                {
                  v44[0] = *(__m128i *)a3;
                  XDCOBJ::vAccumulateTight((XDCOBJ *)v11, (struct ECLIPOBJ *)v16, v44);
                }
                ++*((_DWORD *)a5 + 23);
