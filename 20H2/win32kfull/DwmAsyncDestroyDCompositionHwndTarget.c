/*
 * XREFs of DwmAsyncDestroyDCompositionHwndTarget @ 0x1C0120604
 * Callers:
 *     EditionNotifyDwmForSystemVisualDestruction @ 0x1C01205A0 (EditionNotifyDwmForSystemVisualDestruction.c)
 * Callees:
 *     <none>
 */
