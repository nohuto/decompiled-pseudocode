/*
 * XREFs of ReferenceClass @ 0x1C0104220
 * Callers:
 ...
 *     ?ClassAllocString@@YAPEAXQEAUtagDESKTOP@@KK@Z @ 0x1C01045B4 (-ClassAllocString@@YAPEAXQEAUtagDESKTOP@@KK@Z.c)
...
LABEL_22:
    ...
    *((_QWORD *)&v20 + 1) = *(_QWORD *)(a1 + 80);
    ...
    v20 = *(_OWORD *)LockPointer(v21, v7 + 112, *(_QWORD *)(a1 + 112));
    HMAssignmentLock(&v20);
