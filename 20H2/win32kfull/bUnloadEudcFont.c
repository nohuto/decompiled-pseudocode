/*
 * XREFs of bUnloadEudcFont @ 0x1C001F7B8
 * Callers:
 ...
 * Callees:
 *     ?vFreePql@PFEOBJ@@QEAAXXZ @ 0x1C001F890 (-vFreePql@PFEOBJ@@QEAAXXZ.c)
...
__int64 __fastcall bUnloadEudcFont(__int64 *a1)
{
  ...
  if ( v11 )
  {
    ...
    {
      v3 = 0;
      if ( (dword_1C033A0B8 & 0x10) != 0 || !bFinallyInitializeFontAssocDefault )
        goto LABEL_5;
      v4 = (char *)&unk_1C0333ACC;
      v8 = 7LL;
      do
      {
