/*
 * XREFs of ?GetETMFontManagement@@YAHAEAVRFONTOBJ@@VPDEVOBJ@@PEAU_SURFOBJ@@PEAU_FONTOBJ@@KKPEAXK4@Z @ 0x1C0134D54
 * Callers:
        ...
        void *a7)
{
  ...
  v17 = *(_QWORD *)a1;
  if ( a2 != qword_1C0340A10 || v17 && *(_DWORD *)(*(_QWORD *)(v17 + 24) + 8LL) == 3 )
  {
    v24 = *(void **)(v17 + 128);
