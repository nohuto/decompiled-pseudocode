/*
 * XREFs of ?bNearMatch@MAPPER@@QEAAHAEAVPFEOBJ@@PEAEH@Z @ 0x1C005A300
 * Callers:
 ...
 *     ?bNoMatch@MAPPER@@QEBAHPEAVPFE@@@Z @ 0x1C005D3A8 (-bNoMatch@MAPPER@@QEBAHPEAVPFE@@@Z.c)
...
LABEL_79:
  ...
  {
    if ( (v50 & 0x80000) == 0 && !(unsigned int)MAPPER::bCalcOrientation((__int64 **)this) )
      goto LABEL_148;
    v73 = *((_DWORD *)this + 44);
