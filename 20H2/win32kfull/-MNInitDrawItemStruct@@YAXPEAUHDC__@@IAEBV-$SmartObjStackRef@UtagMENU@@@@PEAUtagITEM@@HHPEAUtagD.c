/*
 * XREFs of ?MNInitDrawItemStruct@@YAXPEAUHDC__@@IAEBV?$SmartObjStackRef@UtagMENU@@@@PEAUtagITEM@@HHPEAUtagDRAWITEMSTRUCT@@@Z @ 0x1C0033CB8
 * Callers:
...
__int64 __fastcall MNInitDrawItemStruct(__int64 a1, int a2, __int64 **a3, __int64 a4, int a5, int a6, __int64 a7)
{
  ...
  *(_DWORD *)(a7 + 16) = v13 | v11 | (v14 != 0) | v12 | v15 | (8 * (*(_DWORD *)(*(_QWORD *)(**a3 + 40) + 40LL) & 0x10)) | (*(_DWORD *)(*(_QWORD *)a4 + 4LL) >> 2) & 0x40 | ~((unsigned __int16)*(_DWORD *)(*(_QWORD *)(**a3 + 40) + 40LL) << 6) & 0x100;
