/*
 * XREFs of InitClipboardILDef @ 0x1C012B2D0
 * Callers:
 *     <none>
 * Callees:
 *     WPP_RECORDER_SF_ @ 0x1C0040298 (WPP_RECORDER_SF_.c)
 *     ?GetClipILIndexFromName@@YAIPEAGI@Z @ 0x1C021E8EC (-GetClipILIndexFromName@@YAIPEAGI@Z.c)
 */
...
int InitClipboardILDef()
{
  ...
  *(_OWORD *)&ObjectAttributes.SecurityDescriptor = 0LL;
  ...
  {
    LOBYTE(v2) = 4;
    LODWORD(v4) = WPP_RECORDER_SF_(v3, v2, 17, 10, (__int64)&WPP_163528e29d493e69e95520b3b68f976c_Traceguids);
  }
  dword_1C032A09C = 0;
  dword_1C032A084 = 0;
  dword_1C032A054[0] = 0;
