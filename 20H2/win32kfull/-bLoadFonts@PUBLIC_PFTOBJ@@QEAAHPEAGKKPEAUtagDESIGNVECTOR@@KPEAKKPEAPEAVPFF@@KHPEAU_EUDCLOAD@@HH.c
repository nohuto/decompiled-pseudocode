/*
 * XREFs of ?bLoadFonts@PUBLIC_PFTOBJ@@QEAAHPEAGKKPEAUtagDESIGNVECTOR@@KPEAKKPEAPEAVPFF@@KHPEAU_EUDCLOAD@@HH@Z @ 0x1C00669FC
 * Callers:
 ...
 *     ?chpfeIncrPFF@PFTOBJ@@QEAAKPEAVPFF@@PEAHKPEAU_EUDCLOAD@@@Z @ 0x1C00203E8 (-chpfeIncrPFF@PFTOBJ@@QEAAKPEAVPFF@@PEAHKPEAU_EUDCLOAD@@@Z.c)
 ...
 *     ?vSetUniqueness@PFFOBJ@@QEAAXXZ @ 0x1C01192D8 (-vSetUniqueness@PFFOBJ@@QEAAXXZ.c)
...
LABEL_13:
    ...
    if ( !v90
      || (v94 = (unsigned int *)&v90[v15],
          v91 = (HDEV)PALLOCMEM2((unsigned int)((_DWORD)v15 << 7)),
          (v29 = (struct _FONTFILEVIEW **)v91) == 0LL) )
    {
      v17 = 0;
      goto LABEL_61;
    }
