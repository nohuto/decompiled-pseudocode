/*
 * XREFs of ?xxxProcessMousePromotionQueue@@YAXXZ @ 0x1C0218F9C
 * Callers:
 *     xxxRealInternalGetMessage @ 0x1C004FF70 (xxxRealInternalGetMessage.c)
 *     xxxCleanupThreadPointerInputInfo @ 0x1C00FCC40 (xxxCleanupThreadPointerInputInfo.c)
 ...
 *     ?DequeueMousePromotionEntry@@YAPEAUtagMOUSE_PROMOTION_ENTRY@@AEAUtagMOUSE_PROMOTION_QUEUE@@@Z @ 0x1C0218388 (-DequeueMousePromotionEntry@@YAPEAUtagMOUSE_PROMOTION_ENTRY@@AEAUtagMOUSE_PROMOTION_QUEUE@@@Z.c)
...
void xxxProcessMousePromotionQueue(void)
{
  ...
  v10 = 0LL;
  v11 = 0LL;
  if ( !qword_1C0339BE0 && qword_1C0339B60 )
  {
    dword_1C0339BE8 &= ~1u;
    qword_1C0339BE0 = gptiCurrent;
    for ( i = DequeueMousePromotionEntry((struct tagMOUSE_PROMOTION_QUEUE *)&qword_1C0339B60);
          ;
          i = DequeueMousePromotionEntry((struct tagMOUSE_PROMOTION_QUEUE *)&qword_1C0339B60) )
    {
      v9 = (__int64)i;
      if ( !i )
        break;
