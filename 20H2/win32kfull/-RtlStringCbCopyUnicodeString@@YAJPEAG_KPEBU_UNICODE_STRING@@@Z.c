/*
 * XREFs of ?RtlStringCbCopyUnicodeString@@YAJPEAG_KPEBU_UNICODE_STRING@@@Z @ 0x1C01ECC90
 * Callers:
 ...
 * Callees:
 *     RtlUnicodeStringValidateSrcWorker @ 0x1C01ECD4C (RtlUnicodeStringValidateSrcWorker.c)
 */
