/*
 * XREFs of ?ReadLinearityData@@YAHPEAUtagHID_POINTER_DEVICE_INFO@@U_UNICODE_STRING@@PEAX@Z @ 0x1C01CE368
 * Callers:
 *     RetrieveCalibrationData @ 0x1C01CF1B0 (RetrieveCalibrationData.c)
 * Callees:
