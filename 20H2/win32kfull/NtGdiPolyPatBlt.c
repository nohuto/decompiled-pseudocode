/*
 * XREFs of NtGdiPolyPatBlt @ 0x1C009D680
 * Callers:
 *     <none>
 * Callees:
 ...
 *     ??0DWMSCREENREADMODIFYWRITEASSIST@@QEAA@AEAVXDCOBJ@@@Z @ 0x1C015DFEC (--0DWMSCREENREADMODIFYWRITEASSIST@@QEAA@AEAVXDCOBJ@@@Z.c)
    ...
    if ( ((gajRop3[(unsigned __int8)v7] | gajRop3[BYTE1(v7)]) & 0xB2) != 0 )
    {
      ...
      if ( *v29 )
      {
        if ( *(_DWORD *)(v12 + 492) && (*(_DWORD *)(v12 + 36) & 0x4000) != 0 )
        {
          ...
          if ( !(unsigned int)ERECTL::bEmpty((ERECTL *)&v27) )
...
LABEL_31:
  if ( v9 )
  {
    v21 = UserReferenceDwmApiPort(a1, a2, a3, a4);
