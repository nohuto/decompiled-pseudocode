/*
 * XREFs of ?UMPDDrvQueryFontTree@@YAPEAXPEAUDHPDEV__@@_KKKPEAK@Z @ 0x1C02AADE0
 * Callers:
 *     <none>
 * Callees:
 ...
 *     ?bSandboxedClient@UMPDOBJ@@QEAAHXZ @ 0x1C015DFA4 (-bSandboxedClient@UMPDOBJ@@QEAAHXZ.c)
 ...
 *     ?bIsFreeHooked@@YAHPEAUDHPDEV__@@PEAVUMPDOBJ@@@Z @ 0x1C02ABF10 (-bIsFreeHooked@@YAHPEAUDHPDEV__@@PEAVUMPDOBJ@@@Z.c)
 */
        ...
        unsigned int *a5)
{
  ...
  _OWORD v30[2]; // [rsp+50h] [rbp-71h] BYREF
...
LABEL_28:
  ...
  if ( v31[6] )
  {
    LODWORD(Size) = 8;
    v14 = -1;
    if ( (unsigned int)UMPDOBJ::Thunk(v11, v31, 0x48u, &v27, Size) != -1 )
    {
      v15 = (WCRUN *)v27;
      if ( v27 )
      {
