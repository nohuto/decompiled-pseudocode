/*
 * XREFs of GreGetDeviceGammaRamp @ 0x1C0115164
 * Callers:
 *     PrepareGammaRampData @ 0x1C0114F60 (PrepareGammaRampData.c)
 *     NtGdiGetDeviceGammaRamp @ 0x1C02B5800 (NtGdiGetDeviceGammaRamp.c)
 * Callees:
