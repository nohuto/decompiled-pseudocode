/*
 * XREFs of ?ValidatePointer@InkDevice@@AEBAJI@Z @ 0x1C0255FD0
 * Callers:
      ...
      if ( v10 == 0x80000000 || v10 == 11 || v10 == 13 )
      {
          ...
          && *(unsigned __int16 *)(v11 + 110) == *((_DWORD *)this + 33) )
        {
          ...
          if ( v12 && *v12 )
          {
            if ( !byte_1C03408D4 )
            {
              if ( (unsigned int)dword_1C032A288 > 5
                && (qword_1C032A298 & 0x400000000000LL) != 0
                && (qword_1C032A2A0 & 0x400000000000LL) == qword_1C032A2A0 )
              {
                tlgWriteTransfer_EtwWriteTransfer(
                  (__int64)&dword_1C032A288,
                  (unsigned __int8 *)dword_1C02F2296,
                  0LL,
                  0LL,
                  2u,
                  &v17);
