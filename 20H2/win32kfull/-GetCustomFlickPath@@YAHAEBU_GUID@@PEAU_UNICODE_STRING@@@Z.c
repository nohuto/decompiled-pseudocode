/*
 * XREFs of ?GetCustomFlickPath@@YAHAEBU_GUID@@PEAU_UNICODE_STRING@@@Z @ 0x1C02091DC
 * Callers:
 *     ?GetCustomFlick@@YAHPEAUtagCUSTOM_FLICK@@@Z @ 0x1C02090A8 (-GetCustomFlick@@YAHPEAUtagCUSTOM_FLICK@@@Z.c)
