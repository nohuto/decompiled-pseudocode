/*
 * XREFs of _PostThreadMessageEx @ 0x1C00BE604
 * Callers:
...
LABEL_45:
  ...
  v9 = *(_QWORD *)(v8 + 424);
  CurrentProcessWin32Process = PsGetCurrentProcessWin32Process(a1, 0x8000LL, a3);
...
LABEL_8:
  ...
  AdjustForCoalescing((struct tagMLIST *)(v8 + 808), 0LL, a2);
  if ( (*(_DWORD *)(v8 + 1232) & 0x20) != 0
    && v8 != gptiCurrent
    && !(unsigned int)ProcessSuspendedPostMessage(v8, 0LL, a2, a3) )
  {
    return 0LL;
  }
  ...
  StoreQMessage(v12, 0LL, a2, a3, a4, 0, 0LL, 0, 0LL, 0, a5, *(_DWORD *)(*(_QWORD *)(v13 + 424) + 280LL), 0LL, 0LL);
  SetWakeBit(v8, 264LL);
  if ( a2 == 786 )
    SetWakeBit(v8, 128LL);
  v14 = *(_QWORD *)(v8 + 432);
