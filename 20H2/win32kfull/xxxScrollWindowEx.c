/*
 * XREFs of xxxScrollWindowEx @ 0x1C0040D0C
 * Callers:
...
LABEL_6:
  ...
  if ( v68 )
  {
    ...
    *(_QWORD *)&v88 = *(_QWORD *)(ThreadWin32Thread + 416);
  ...
  if ( !v64 )
  {
    ...
    if ( *(_QWORD *)v9 )
    {
      if ( (unsigned int)IsDescendant(*(_QWORD *)v9, v12) )
      {
        v72 = 1;
  ...
  if ( v80 )
  {
    ...
    if ( *((_QWORD *)v12 + 14) )
    {
      OffsetChildren(v12, v19, v20, (unsigned __int64)&v93 & -(__int64)(a4 != 0LL), v63);
