/*
 * XREFs of NtUserCalculatePopupWindowPosition @ 0x1C01F6A50
 * Callers:
 *     <none>
 * Callees:
        ...
        _DWORD *a5)
{
  ...
  int BestPos; // ebx
  _OWORD *v19; // rcx
  int v21[2]; // [rsp+50h] [rbp-98h]
  __int64 v22; // [rsp+60h] [rbp-88h]
  __int64 v23[5]; // [rsp+68h] [rbp-80h] BYREF
  __int128 v24; // [rsp+90h] [rbp-58h] BYREF
...
LABEL_3:
  ...
  *(_QWORD *)v21 = *a2;
  ...
  else
  {
    ...
    v22 = v15;
    v16 = HIDWORD(v15);
    v17 = MonitorFromPoint(v15, 2LL, 0LL, v12);
    if ( (a3 & 4) != 0 )
    {
      LODWORD(v15) = v15 - v21[0] / 2;
    }
    else if ( (a3 & 8) != 0 )
    {
      LODWORD(v15) = v15 - v21[0];
    }
    if ( (a3 & 0x10) != 0 )
    {
      LODWORD(v16) = v21[1] / -2 + v16;
    }
    else if ( (a3 & 0x20) != 0 )
    {
      LODWORD(v16) = v16 - v21[1];
    }
    v9 = 1;
    SmartObjStackRef<tagPOPUPMENU>::SmartObjStackRef<tagPOPUPMENU>(v23, 0LL);
    BestPos = FindBestPos(v15, v16, v21[0], v21[1], (__int64)a4, a3 | 0x20000u, (__int64)v23, v17, v22);
    ...
    *a5 = (__int16)BestPos;
    ...
    a5[2] = v21[0] + (__int16)BestPos;
    v14 = (unsigned int)(SHIWORD(BestPos) + v21[1]);
    a5[3] = v14;
  }
LABEL_28:
