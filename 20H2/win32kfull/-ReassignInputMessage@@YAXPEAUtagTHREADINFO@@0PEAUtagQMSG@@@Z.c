/*
 * XREFs of ?ReassignInputMessage@@YAXPEAUtagTHREADINFO@@0PEAUtagQMSG@@@Z @ 0x1C01E05C0
 * Callers:
...
void __fastcall ReassignInputMessage(struct tagTHREADINFO *a1, struct tagTHREADINFO *a2, struct tagQMSG *a3)
{
  ...
  v6 = *((_QWORD *)a2 + 54);
  DelQEntry((_QWORD *)(*((_QWORD *)a1 + 54) + 24LL), a3, 0);
  v7 = *((_QWORD *)a1 + 54);
        ...
        if ( *(_QWORD *)(*((_QWORD *)a2 + 54) + 136LL) )
        {
          ...
          if ( v17 )
          {
            if ( *(_DWORD *)(v17 + 24) == 512
              ...
              && (v16 & 0x100) == 0 )
            {
              DelQEntry((_QWORD *)(v6 + 24), (_QWORD *)v17, 1);
            }
          }
        }
      }
