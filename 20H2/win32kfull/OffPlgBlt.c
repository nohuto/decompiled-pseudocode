/*
 * XREFs of OffPlgBlt @ 0x1C02C7B94
 * Callers:
        ...
        int a14)
{
  ...
  __int64 (__fastcall *v30)(__int64, __int64, __int64, struct _CLIPOBJ *, __int64, __int64, __int64 *, _DWORD *, __int128 *, __int64, int); // [rsp+98h] [rbp-31h]
  __int128 v31; // [rsp+A0h] [rbp-29h] BYREF
  ...
  if ( a12 )
  {
    LODWORD(v31) = x + *(_DWORD *)a12;
    DWORD2(v31) = x + *((_DWORD *)a12 + 2);
    DWORD1(v31) = y + *((_DWORD *)a12 + 1);
    v18 = &v31;
    HIDWORD(v31) = y + *((_DWORD *)a12 + 3);
  }
  v32[0] = 16 * v15 + *a11;
  v32[2] = 16 * v15 + a11[2];
  v32[4] = 16 * v15 + a11[4];
