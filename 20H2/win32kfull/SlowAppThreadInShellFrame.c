/*
 * XREFs of SlowAppThreadInShellFrame @ 0x1C0029684
 * Callers:
 ...
 *     ?OtherThreadsKeyboardInput@@YAPEAUtagTHREADINFO@@PEAUtagQ@@PEAUtagQMSG@@@Z @ 0x1C01E0564 (-OtherThreadsKeyboardInput@@YAPEAUtagTHREADINFO@@PEAUtagQ@@PEAUtagQMSG@@@Z.c)
 */
        ...
        int a4)
{
  ...
  if ( v11 )
  {
    ...
    if ( v17 )
    {
      if ( (unsigned int)IsDebuggerAttached(*(_QWORD *)(v17 + 424)) )
  ...
  if ( v13 )
  {
    if ( v13 != a1 && v13 == a2 )
    {
      ...
      if ( v19 )
      {
        if ( a3 == v19 )
        {
          if ( (unsigned int)IsDebuggerAttached(*((_QWORD *)v13 + 53)) )
            return (struct tagTHREADINFO *)v9;
