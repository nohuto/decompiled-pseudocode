/*
 * XREFs of ?_OnInput@Edgy@@YA?AUtagSTATE_TRANSITION_DATA@1@AEAUtagEDGY_DATA@@PEAX@Z @ 0x1C020834C
 * Callers:
 *     ?ProcessInput@Edgy@@YAHPEAXPEAPEAX@Z @ 0x1C0207548 (-ProcessInput@Edgy@@YAHPEAXPEAPEAX@Z.c)
 * Callees:
 ...
 *     ?_OnEnterActive@Edgy@@YAXAEAUtagEDGY_DATA@@AEBUtagARC_DATA@1@@Z @ 0x1C020826C (-_OnEnterActive@Edgy@@YAXAEAUtagEDGY_DATA@@AEBUtagARC_DATA@1@@Z.c)
 *     ?_OnEnterDisambiguation@Edgy@@YAXAEAUtagEDGY_DATA@@AEBUtagARC_DATA@1@@Z @ 0x1C02082D4 (-_OnEnterDisambiguation@Edgy@@YAXAEAUtagEDGY_DATA@@AEBUtagARC_DATA@1@@Z.c)
...
__int64 __fastcall Edgy::_OnInput(__int64 a1, __int64 a2, __int64 a3)
{
  ...
  ArcData = Edgy::_GetArcData((__int64)&v19, a2, a3);
  v6 = (const struct Edgy::tagARC_DATA *)*(int *)(a2 + 16);
  v7 = 4;
  v8 = dword_1C02F4AE0[(_QWORD)v6];
  v9 = *(_OWORD *)(ArcData + 16);
  v10 = dword_1C02F4AE4[(_QWORD)v6];
  ...
  *(_QWORD *)&v9 = *(_QWORD *)(ArcData + 48);
  ...
  while ( v8 < v10 )
  {
    if ( ((__int64)v15[1] & dword_1C02F4968[4 * v8]) == dword_1C02F496C[4 * v8] )
    {
      v7 = dword_1C02F4964[4 * v8];
      break;
    }
    ++v8;
  }
