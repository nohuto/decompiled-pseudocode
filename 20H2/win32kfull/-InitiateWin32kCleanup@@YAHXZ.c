/*
 * XREFs of ?InitiateWin32kCleanup@@YAHXZ @ 0x1C000B814
 * Callers:
 *     RawInputThread @ 0x1C0009A30 (RawInputThread.c)
 * Callees:
 *     ?SetWaitForWinstaRundown@@YAXXZ @ 0x1C000B16C (-SetWaitForWinstaRundown@@YAXXZ.c)
 ...
 *     ?Deinitialize@InteractiveControlManager@@AEAAXXZ @ 0x1C012A9B0 (-Deinitialize@InteractiveControlManager@@AEAAXXZ.c)
...
__int64 InitiateWin32kCleanup(void)
{
  ...
  EmptyMousePromotionQueue((struct tagMOUSE_PROMOTION_QUEUE *)&qword_1C0339B60);
  v3 = (struct tagMOUSE_PROMOTION_QUEUE *)&unk_1C0339AF0;
  v4 = 5LL;
  do
  {
