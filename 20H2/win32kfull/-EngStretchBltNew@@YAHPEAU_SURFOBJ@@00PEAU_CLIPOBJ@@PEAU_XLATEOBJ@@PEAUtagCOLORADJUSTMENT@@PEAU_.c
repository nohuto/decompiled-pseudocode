/*
 * XREFs of ?EngStretchBltNew@@YAHPEAU_SURFOBJ@@00PEAU_CLIPOBJ@@PEAU_XLATEOBJ@@PEAUtagCOLORADJUSTMENT@@PEAU_POINTL@@PEAU_RECTL@@54K@Z @ 0x1C006AEAC
 * Callers:
 ...
 *     ??1?$AutoResource@$1?FreeTmpBuffer@@YAXPEAX@Z@@QEAA@XZ @ 0x1C0069CDC (--1-$AutoResource@$1-FreeTmpBuffer@@YAXPEAX@Z@@QEAA@XZ.c)
 ...
 *     ?vInitBuffer@@YAXPEAU_STRRUN@@PEAU_RECTL@@K@Z @ 0x1C006C62C (-vInitBuffer@@YAXPEAU_STRRUN@@PEAU_RECTL@@K@Z.c)
 ...
 *     ??0ECLIPOBJ@@QEAA@XZ @ 0x1C015D0D8 (--0ECLIPOBJ@@QEAA@XZ.c)
 *     ??0RGNMEMOBJTMP@@QEAA@XZ @ 0x1C015D104 (--0RGNMEMOBJTMP@@QEAA@XZ.c)
 *     ??0ECLIPOBJ@@QEAA@PEAVREGION@@AEAVERECTL@@H@Z @ 0x1C015D550 (--0ECLIPOBJ@@QEAA@PEAVREGION@@AEAVERECTL@@H@Z.c)
        ...
        unsigned int a11)
{
  ...
  struct _STRDDA *v67; // rax
  struct tagCOLORADJUSTMENT *v68; // r8
  ...
  LONG v76; // r9d
  int j; // r8d
  struct tagCOLORADJUSTMENT *v78; // r10
  int v79; // edx
  ...
  SURFOBJ *v99; // rax
  int v100; // eax
  unsigned int (__fastcall *v101)(HSURF, SURFOBJ *, _QWORD, XCLIPOBJ *, _QWORD, struct tagCOLORADJUSTMENT *, struct _POINTL *, struct _RECTL *, __int128 *, struct _POINTL *, unsigned int); // rax
  int v102; // ecx
  int v103; // eax
  int v104; // eax
  ...
  struct tagCOLORADJUSTMENT *v131; // [rsp+C8h] [rbp-4A0h]
  ...
  __int64 v141; // [rsp+110h] [rbp-458h] BYREF
  ...
  struct _POINTL *v149; // [rsp+150h] [rbp-418h]
  ...
  __int64 v180; // [rsp+250h] [rbp-318h]
  __int64 v181; // [rsp+258h] [rbp-310h] BYREF
  __int64 v182; // [rsp+260h] [rbp-308h] BYREF
...
LABEL_233:
    ...
    if ( a11 == 4 )
    {
      if ( v23 )
        goto LABEL_233;
      v53 = EngHTBlt(v12, v11, v24, v130, v128, v13, v146, a8, v15, v149, 0, 0LL);
      if ( v53 == -1 )
        goto LABEL_233;
      if ( v53 )
      {
                    ...
                    if ( v99 )
                    {
                      ...
                      *((_QWORD *)&v192 + 1) = v121;
                      if ( (*(_DWORD *)(v21 + 112) & 0x400) != 0 )
                        v100 = (*(__int64 (__fastcall **)(SURFOBJ *, struct _SURFOBJ *, _QWORD, unsigned __int64, __int128 *, struct _RECTL *))(v20 + 2840))(
                                 v99,
                                 v126,
                                 0LL,
                                 v128,
                        ...
                        v100 = ((__int64 (__fastcall *)(SURFOBJ *, struct _SURFOBJ *, _QWORD, unsigned __int64, __int128 *, struct _RECTL *))EngCopyBits)(
                                 ...
                                 v15);
                      if ( !v100
                        || (v101 = *(unsigned int (__fastcall **)(HSURF, SURFOBJ *, _QWORD, XCLIPOBJ *, _QWORD, struct tagCOLORADJUSTMENT *, struct _POINTL *, struct _RECTL *, __int128 *, struct _POINTL *, unsigned int))(v19 + 2848)) == 0LL
...
LABEL_33:
    ...
    *(_QWORD *)&v186.left = 0LL;
    ...
    v38 = v127;
    v116 = *(_WORD *)(v127 + 100);
    if ( v116 || *(_QWORD *)(v127 + 32) == *(_QWORD *)(v21 + 32) )
    {
      v190 = *(__m128i *)a8;
      ...
      v170 = v103;
      v171 = v102;
      ERECTL::operator*=(&v188, &v169);
      if ( (unsigned int)ERECTL::bEmpty((ERECTL *)&v188) )
        goto LABEL_63;
      if ( v116
...
LABEL_36:
        ...
        v143 = 0;
        v191 = 0LL;
        if ( v114 || *(_WORD *)(v21 + 100) || (unsigned int)(*(_DWORD *)(v21 + 96) - 7) <= 1 )
        {
          v176[3] = 0;
          v179 = 0;
          ...
          *(_QWORD *)&v186.left = 0LL;
          ...
          if ( (v114 & 2) != 0 )
          {
            ...
            if ( v92 > 0 )
            {
              *(_QWORD *)(v141 + 80) = *(_QWORD *)(v141 + 72) + v92 * (v90 - 1);
              v91 = v114;
            }
            else
            {
              *(_QWORD *)(v141 + 80) = *(_QWORD *)(v141 + 72);
            }
            *(_DWORD *)(v141 + 88) = -*(_DWORD *)(v141 + 88);
            v89 = v141;
          }
          if ( (v91 & 1) != 0 )
          {
                    ...
                    do
                    {
                      ...
                      if ( v194.left )
                      {
                        StretchDIBDirect(
                          ...
                          *(_DWORD *)(v41 + 96));
                        ERECTL::operator+=((unsigned int *)&v186, (unsigned int *)&v197);
                        v55 = v119;
                      }
                    }
                    while ( v55 );
...
LABEL_222:
                        ...
                        if ( !v109 || bIntersect(&v193, (const struct _RECTL *)((char *)v109 + 4), &v193) )
                        {
                          ...
                          if ( !(unsigned int)ERECTL::bEmpty((ERECTL *)v201) )
                          {
                            v188.left += v125;
                            ...
                            if ( (*(_DWORD *)(v51 + 112) & 0x400) != 0 )
                              (*(void (__fastcall **)(unsigned __int64, unsigned __int64, _BYTE *, __int64, struct _RECTL *, __int64 *))(v19 + 2840))(
                                v51 + 24,
                                (v136 + 24) & -(__int64)(v136 != 0),
                                v200,
                                v110,
                              ...
                              ((void (__fastcall *)(unsigned __int64, unsigned __int64, _BYTE *, __int64, struct _RECTL *, __int64 *))EngCopyBits)(
                                v51 + 24,
                                (v136 + 24) & -(__int64)(v136 != 0),
                                v200,
                                v110,
                    ...
                    *(_QWORD *)&v189.left = 0LL;
                    ...
                    while ( 1 )
                    {
                      for ( i = 0; ; i = v120 + 1 )
                      {
                        ...
                        v187 = 0LL;
                        vInitStrDDAClip(&v186, v15, v14, v152, &v187);
                        if ( !(unsigned int)ERECTL::bEmpty((ERECTL *)&v187) )
                        {
                          --v187.left;
                          --v187.top;
                          ++v187.right;
                          ++v187.bottom;
                          ERECTL::operator*=(&v187, &v186);
                          v62 = v15->right;
                          if ( v62 >= v15->left )
                          {
                            v63 = v15->bottom;
                            ...
                            if ( v63 >= v64 )
                            {
                              ...
                              {
                                v67 = (struct _STRDDA *)PALLOCMEM2(4 * v66 + 40, 1752462151LL, 0);
                                v131 = (struct tagCOLORADJUSTMENT *)v67;
                                if ( v67 )
                                {
                                  vInitStrDDA(v67, &v187, v15, (struct _RECTL *)v14);
                                  v68 = v131;
                                  v166 = *(struct _RECTL *)&v131->caSize;
                                  v69 = v133;
                                  if ( v133 )
                                  {
                                    if ( (*(_BYTE *)(v133 + 4) & 1) != 0 )
                                  ...
                                  if ( v118 )
                                    *(_DWORD *)&v131->caColorfulness = (v150 != 1) - 1;
                                  v135 = (HSURF)*(&apfnRead + 3 * *(unsigned int *)(v21 + 96) + v113 - 1);
                                  hsurf = v135;
...
LABEL_215:
                                  ...
                                  v112 = v187.top;
                                  v145 = *(_QWORD *)(v21 + 80) + *(_DWORD *)(v21 + 88) * v187.top;
                                  v154 = 0LL;
                                  if ( v140 )
                                  {
                                    LODWORD(v154) = v149->x + v187.left - v15->left;
                                    ...
                                    v126 = (struct _SURFOBJ *)(v106
                                                             + *(_DWORD *)p_lDelta * (v187.top + v149->y - v15->top));
                                  }
                                  else
                                  {
                                    v126 = 0LL;
                                  ...
                                  *(_DWORD *)v73 = *(_DWORD *)&v131->caIlluminantIndex;
                                  ...
                                  if ( !v75 || v167[0] )
                                  {
                                    ...
                                    for ( j = 0; ; ++j )
                                    {
                                      ...
                                      if ( v76 >= v187.bottom )
                                        break;
                                      v78 = v131;
                                      v79 = *(_DWORD *)(*(_QWORD *)&v131[1].caSize + 4LL * j);
                                      v80 = v132;
                                      *((_DWORD *)v132 + 1) = v79;
                                      if ( v79 )
                                      {
                                        v81 = (unsigned __int64)v199 & -(__int64)((_DWORD)v152 != 0);
                                        v82 = ((__int64 (__fastcall *)(struct tagCOLORADJUSTMENT *, struct _STRRUN *, __int64, struct _SURFOBJ *, unsigned __int64, LONG, LONG, _DWORD))v135)(
                                                v78,
                                                v80,
                                                v145,
                                                v126,
                                      ...
                                      {
                                        ((void (__fastcall *)(struct tagCOLORADJUSTMENT *, struct _STRRUN *, __int64, _QWORD, unsigned __int64, LONG, LONG, _DWORD))v135)(
                                          v78,
                                          v80,
                                          v145,
                                          0LL,
                                  ...
                                  FreeTmpBuffer(v132);
                                  Win32FreePool(v131);
                                  ERECTL::operator+=((unsigned int *)&v189, (unsigned int *)&v166);
                                  RGNMEMOBJTMP::~RGNMEMOBJTMP((RGNMEMOBJTMP *)v167);
                                }
                              }
                            }
