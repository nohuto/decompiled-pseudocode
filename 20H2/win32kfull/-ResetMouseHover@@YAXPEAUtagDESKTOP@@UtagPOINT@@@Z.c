/*
 * XREFs of ?ResetMouseHover@@YAXPEAUtagDESKTOP@@UtagPOINT@@@Z @ 0x1C0017A1C
 * Callers:
...
void __fastcall ResetMouseHover(struct tagDESKTOP *a1, struct tagPOINT a2)
{
  ...
  v4 = LODWORD(WPP_MAIN_CB.Dpc.SystemArgument2) >> 1;
  v5 = HIDWORD(WPP_MAIN_CB.Dpc.SystemArgument1) >> 1;
  *((_DWORD *)a1 + 49) = x - (LODWORD(WPP_MAIN_CB.Dpc.SystemArgument2) >> 1);
  *((_DWORD *)a1 + 50) = y - v5;
  *((_DWORD *)a1 + 51) = v4 + x;
  *((_DWORD *)a1 + 52) = v5 + y;
}
