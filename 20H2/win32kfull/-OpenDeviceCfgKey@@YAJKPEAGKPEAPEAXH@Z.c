/*
 * XREFs of ?OpenDeviceCfgKey@@YAJKPEAGKPEAPEAXH@Z @ 0x1C007AB20
 * Callers:
 *     ?GetFlickMap@@YAHPEAUtagFLICK_MAP@@@Z @ 0x1C002F6B8 (-GetFlickMap@@YAHPEAUtagFLICK_MAP@@@Z.c)
 *     EditionGetPointerDeviceConfigurationKey @ 0x1C007AA50 (EditionGetPointerDeviceConfigurationKey.c)
 ...
 *     ?IsTouchpadQuery@@YAHKPEAG@Z @ 0x1C007B0FC (-IsTouchpadQuery@@YAHKPEAG@Z.c)
