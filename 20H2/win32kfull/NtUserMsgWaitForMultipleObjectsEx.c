/*
 * XREFs of NtUserMsgWaitForMultipleObjectsEx @ 0x1C004D6E0
 * Callers:
 *     <none>
 * Callees:
 ...
 *     _CancelQueueEventCompletionPacket @ 0x1C01D2C50 (_CancelQueueEventCompletionPacket.c)
 *     _ReassociateQueueEventCompletionPacket @ 0x1C01D2D00 (_ReassociateQueueEventCompletionPacket.c)
 *     _SetWaitForQueueAttach @ 0x1C01D2DB0 (_SetWaitForQueueAttach.c)
 */
...
__int64 __fastcall NtUserMsgWaitForMultipleObjectsEx(unsigned int a1, volatile void *a2, int a3, int a4, int a5)
{
  ...
  void (__fastcall *v59)(void *); // [rsp+60h] [rbp-8C8h]
...
LABEL_12:
        ...
        *((_OWORD *)v18 + 3) = v19[3];
        ...
        if ( v24 )
        {
          ...
          *(_QWORD *)(v33 + 16) = &v57;
          v58 = v55;
          v59 = (void (__fastcall *)(void *))Win32FreePool;
