/*
 * XREFs of ?CalcVirtualScreenClipRegion@@YAXPEAUHRGN__@@PEAUtagWND@@@Z @ 0x1C00387D8
 * Callers:
...
void __fastcall CalcVirtualScreenClipRegion(HRGN a1, struct tagWND *a2)
{
    ...
    && (v5 = (*(_DWORD *)(*((_QWORD *)a2 + 5) + 288LL) >> 8) & 0x1FF) != 0 )
  {
    ...
    if ( *(_DWORD *)*gpDispInfo == 1 )
    {
      ...
      MonitorRectForDpi = (__int128 *)GetMonitorRectForDpi(v13, *(_QWORD *)(DispInfo + 96), v5);
LABEL_6:
    ...
    if ( !EmptyRgn )
    {
      MonitorRectForDpi = (__int128 *)GetScreenRectForWindow(v13, a2);
      goto LABEL_6;
    }
