/*
 * XREFs of PALOBJ_cGetColors @ 0x1C02BC220
 * Callers:
 *     <none>
 * Callees:
 *     ?ulGetEntries@XEPALOBJ@@QEAAKKKPEAUtagPALETTEENTRY@@H@Z @ 0x1C0116F5C (-ulGetEntries@XEPALOBJ@@QEAAKKKPEAUtagPALETTEENTRY@@H@Z.c)
 *     ?CorrectColors@XEPALOBJ@@QEAAXPEAUtagPALETTEENTRY@@K@Z @ 0x1C02931A8 (-CorrectColors@XEPALOBJ@@QEAAXPEAUtagPALETTEENTRY@@K@Z.c)
 */
