/*
 * XREFs of ?bWiden@EPATHOBJ@@QEAAHAEAV1@PEAU_XFORMOBJ@@PEAU_LINEATTRS@@@Z @ 0x1C0133F74
 * Callers:
 ...
 * Callees:
 *     ?vMakeItWide@WIDENER@@QEAAXAEAVEPATHOBJ@@@Z @ 0x1C013401C (-vMakeItWide@WIDENER@@QEAAXAEAVEPATHOBJ@@@Z.c)
