/*
 * XREFs of GreTransferDwmStateToSpriteState @ 0x1C001C1B4
 * Callers:
 ...
 *     ?vFixupMetaSpriteList@@YAXAEAVPDEVOBJ@@@Z @ 0x1C028190C (-vFixupMetaSpriteList@@YAXAEAVPDEVOBJ@@@Z.c)
 */
...
__int64 __fastcall GreTransferDwmStateToSpriteState(HDEV a1, __int64 a2)
{
  ...
  unsigned int v24; // [rsp+6Ch] [rbp-25h] BYREF
  ...
  do
  {
    ...
    if ( GdiCreateSprite(a1, *(HWND *)(v10 + 40), (struct tagRECT *)(v10 + 56)) )
    {
      ...
      if ( v16 )
      {
        v27 = SFMLOGICALSURFACE::OwnsSurfaceCleanup((SFMLOGICALSURFACE *)v11, v12, v14);
...
LABEL_19:
        ...
        if ( v16 )
          SFMLOGICALSURFACE::CleanupShape((SFMLOGICALSURFACE *)v11, v27);
        goto LABEL_40;
      }
