/*
 * XREFs of ?FindImeHotKeyByKey@@YAPEAU_tagIMEHOTKEYOBJ@@PEAU1@III@Z @ 0x1C00FE040
 * Callers:
 *     CheckImeHotKey @ 0x1C00FDDDC (CheckImeHotKey.c)
 * Callees:
 *     GetActiveHKL @ 0x1C00FE0F8 (GetActiveHKL.c)
 *     ?GetHotKeyLangID@@YAGK@Z @ 0x1C010EFEC (-GetHotKeyLangID@@YAGK@Z.c)
 *     ?GetLangIdMatchLevel@@YAHPEAUHKL__@@G@Z @ 0x1C021D4E0 (-GetLangIdMatchLevel@@YAHPEAUHKL__@@G@Z.c)
 */
