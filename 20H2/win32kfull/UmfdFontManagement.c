/*
 * XREFs of UmfdFontManagement @ 0x1C02DD630
 * Callers:
 ...
 *     ?GetDrvType@FontManagementRequest@@UEBA?AW4FontDriverType@@XZ @ 0x1C02DD500 (-GetDrvType@FontManagementRequest@@UEBA-AW4FontDriverType@@XZ.c)
 */
