/*
 * XREFs of NtGdiEngAlphaBlend @ 0x1C02B13D0
 * Callers:
 *     <none>
 * Callees:
 ...
 *     ??$GetDDIOBJ@U_BLENDOBJ@@@UMPDOBJ@@QEAAPEAU_BLENDOBJ@@PEAU1@@Z @ 0x1C02B071C (--$GetDDIOBJ@U_BLENDOBJ@@@UMPDOBJ@@QEAAPEAU_BLENDOBJ@@PEAU1@@Z.c)
 */
