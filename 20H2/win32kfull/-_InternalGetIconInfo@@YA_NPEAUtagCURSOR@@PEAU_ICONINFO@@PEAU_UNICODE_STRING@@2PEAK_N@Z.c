/*
 * XREFs of ?_InternalGetIconInfo@@YA_NPEAUtagCURSOR@@PEAU_ICONINFO@@PEAU_UNICODE_STRING@@2PEAK_N@Z @ 0x1C00951E8
 * Callers:
        ...
        bool a6)
{
  ...
  _DWORD v32[3]; // [rsp+B8h] [rbp-70h] BYREF
  ...
  *(_QWORD *)v25 = 0LL;
  ...
  if ( b )
  {
    ...
    if ( !v14 || a6 )
      ...
      v23 = v10 / 2;
    GreStretchBltInternal(ghdcMem, v23, ghdcMem2, 0, 0, *((_DWORD *)v7 + 35), v22, 13369376, 0xFFFFFF, 0);
  }
  else
  {
    if ( !v14 || a6 )
