/*
 * XREFs of ?InjectInput@RIM@InputTraceLogging@@SAXPEBURIMDEV@@W4InputTracing_RimInjectionSource@@K@Z @ 0x1C01DB100
 * Callers:
 ...
 *     ?PointerDeviceTypeToString@InputTraceLogging@@CAPEBDK@Z @ 0x1C01DB36C (-PointerDeviceTypeToString@InputTraceLogging@@CAPEBDK@Z.c)
 */
...
char __fastcall InputTraceLogging::RIM::InjectInput(__int64 a1, int a2, __int64 a3, __int64 a4)
{
  ...
  if ( (_BYTE)v4 != 2 )
  {
    if ( (_BYTE)v4 )
    {
      ...
      if ( (unsigned int)dword_1C032FB30 <= 4 )
        return v4;
      if ( (qword_1C032FB40 & 0x100) == 0 )
        return v4;
      LOBYTE(v4) = 0;
      if ( (qword_1C032FB48 & 0x100) != qword_1C032FB48 )
        return v4;
      v16 = (unsigned __int8 *)&unk_1C02EF2F3;
    }
    else
    {
      if ( (unsigned int)dword_1C032FB30 <= 4 )
      ...
      if ( (qword_1C032FB48 & 0x100) != qword_1C032FB48 )
        return v4;
      v16 = (unsigned __int8 *)&unk_1C02EF2B6;
    }
  ...
  if ( (v4 & 0x80u) == 0 )
  {
    if ( (unsigned int)dword_1C032FB30 > 4 && (qword_1C032FB40 & 0x100) != 0 )
    {
      LOBYTE(v4) = 0;
      if ( (qword_1C032FB48 & 0x100) == qword_1C032FB48 )
      {
  ...
  else if ( (unsigned int)dword_1C032FB30 > 4 && (qword_1C032FB40 & 0x100) != 0 )
  {
    LOBYTE(v4) = 0;
    if ( (qword_1C032FB48 & 0x100) == qword_1C032FB48 )
    {
      ...
      LOBYTE(v4) = _tlgWriteTemplate<long (_tlgProvider_t const *,void const *,_GUID const *,_GUID const *,unsigned int,_EVENT_DATA_DESCRIPTOR *),&long _tlgWriteTransfer_EtwWriteTransfer(_tlgProvider_t const *,void const *,_GUID const *,_GUID const *,unsigned int,_EVENT_DATA_DESCRIPTOR *),_GUID const *,_GUID const *>::Write<_tlgWrapperByVal<8>,_tlgWrapSz<char>,_tlgWrapSz<char>,_tlgWrapperByVal<4>,_tlgWrapperByVal<4>,_tlgWrapperByVal<4>>(
                     (__int64)&dword_1C032FB30,
                     (unsigned __int8 *)dword_1C02EF202,
                     v12,
                     v13,
                     (__int64)&v19,
                     (void **)&v18,
