/*
 * XREFs of ?DdcciGetCapabilitiesString@CMonitorAPI@@QEAAJPEAXPEADK@Z @ 0x1C0270408
 * Callers:
 *     NtGdiDDCCIGetCapabilitiesString @ 0x1C0271810 (NtGdiDDCCIGetCapabilitiesString.c)
 * Callees:
