/*
 * XREFs of WritePointerDeviceSettingsFull @ 0x1C020980C
 * Callers:
 *     xxxSystemParametersInfoWorker @ 0x1C002F978 (xxxSystemParametersInfoWorker.c)
 * Callees:
 *     ?SetCustomFlick@@YAHPEAUtagCUSTOM_FLICK@@@Z @ 0x1C02092A4 (-SetCustomFlick@@YAHPEAUtagCUSTOM_FLICK@@@Z.c)
...
__int64 __fastcall WritePointerDeviceSettingsFull(int a1, __int64 a2, const unsigned __int16 *a3)
{
  ...
  if ( v4 )
  {
      ...
      if ( v6 )
      {
        ...
        if ( (_DWORD)v7 )
        {
          if ( (_DWORD)v7 == 2 )
          {
            ...
            if ( v8 <= 0x3C )
            {
              dword_1C032A6AC[0] = *(_DWORD *)(a2 + 4);
              glTOUCH_DRIVER_HW_STACK_LATENCY = v8;
            }
            v9 = *(_DWORD *)(a2 + 8);
            if ( v9 <= 0x3C )
            {
              dword_1C032A6BC = *(_DWORD *)(a2 + 8);
              glTOUCH_DRIVER_HW_STACK_SAMPLETIME = v9;
            }
            dword_1C032A6CC = *(_DWORD *)(a2 + 12);
            gbTOUCH_DRIVER_HW_STACK_TIMESTAMP = dword_1C032A6CC;
            result = 1LL;
            if ( (_DWORD)a3 )
    ...
    {
      dword_1C032A79C = *(_DWORD *)a2;
      dword_1C032A7AC = *(_DWORD *)(a2 + 4);
      dword_1C032A7BC = *(_DWORD *)(a2 + 8);
      dword_1C032A7CC = *(_DWORD *)(a2 + 12);
      dword_1C032A7DC = *(_DWORD *)(a2 + 16);
      dword_1C032A7EC = *(_DWORD *)(a2 + 20);
      dword_1C032A7FC = *(_DWORD *)(a2 + 24);
      result = 1LL;
  ...
  {
    dword_1C032A80C = *(_DWORD *)a2;
    dword_1C032A81C = *(_DWORD *)(a2 + 4);
    dword_1C032A82C = *(_DWORD *)(a2 + 8);
    dword_1C032A83C = *(_DWORD *)(a2 + 12);
    dword_1C032A84C = *(_DWORD *)(a2 + 16);
    dword_1C032A85C = *(_DWORD *)(a2 + 20);
    dword_1C032A86C = *(_DWORD *)(a2 + 24);
    dword_1C032A87C = *(_DWORD *)(a2 + 28);
    result = 1LL;
