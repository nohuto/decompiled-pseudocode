/*
 * XREFs of xxxTranslateAccelerator @ 0x1C0103718
 * Callers:
 ...
 *     SystoChar @ 0x1C0103AD0 (SystoChar.c)
...
LABEL_28:
          ...
          else
          {
            ...
            SysDesktopMenu = *v30;
            if ( !*v30 )
              SysDesktopMenu = xxxLoadSysDesktopMenu(v30, 16);
            v31 = W32GetThreadWin32Thread((__int64)KeGetCurrentThread());
            *(_QWORD *)&v40 = *(_QWORD *)(v31 + 416);
            *(_QWORD *)(v31 + 416) = &v40;
            *((_QWORD *)&v40 + 1) = SysDesktopMenu;
            if ( SysDesktopMenu )
              HMLockObject(SysDesktopMenu);
