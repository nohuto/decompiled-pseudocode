/*
 * XREFs of ?zzzSetSystemImage@@YAXPEAUtagCURSOR@@0@Z @ 0x1C007A070
 * Callers:
  ...
  if ( v4 )
  {
    ...
    do
    {
      ...
      else
      {
        ...
        *((_QWORD *)v19 + 3) = PsGetCurrentProcessWin32Process(v21, v20, v22);
      }
      if ( (*((_DWORD *)v19 + 20) & 8) != 0 )
      {
        ...
        if ( *((int *)v19 + 22) > 0 )
        {
          ...
          do
          {
            v25 = *(_QWORD *)(v24 + *((_QWORD *)v19 + 12));
            HMChangeOwnerProcess(v25, gptiCurrent);
            v24 += 8LL;
            ++v23;
            *(_QWORD *)(v25 + 24) = *((_QWORD *)v19 + 3);
          }
          while ( v23 < *((_DWORD *)v19 + 22) );
        }
      }
