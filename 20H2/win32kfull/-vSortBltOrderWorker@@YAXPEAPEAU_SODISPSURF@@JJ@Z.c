/*
 * XREFs of ?vSortBltOrderWorker@@YAXPEAPEAU_SODISPSURF@@JJ@Z @ 0x1C02A64F8
 * Callers:
 *     ??0MULTISORTBLTORDER@@QEAA@PEAU_VDEV@@JJ@Z @ 0x1C02A0480 (--0MULTISORTBLTORDER@@QEAA@PEAU_VDEV@@JJ@Z.c)
 * Callees:
 *     ?isSorted@@YA_NPEAU_SODISPSURF@@0JJ@Z @ 0x1C02A60E0 (-isSorted@@YA_NPEAU_SODISPSURF@@0JJ@Z.c)
 */
