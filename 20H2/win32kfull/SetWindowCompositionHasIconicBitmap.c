/*
 * XREFs of SetWindowCompositionHasIconicBitmap @ 0x1C011BA4C
 * Callers:
...
__int64 __fastcall SetWindowCompositionHasIconicBitmap(__int64 *a1, __int128 *a2)
{
  bool v3; // zf
  int v5; // edi
  unsigned int v6; // ebx
  ...
  {
    if ( -__CFSHR__(v10[0], 6) == v5 )
      return 0;
    LODWORD(v10[0]) = v10[0] & 0xFFFFFFDF | (32 * v5);
    ...
    else
    {
      ...
      return (unsigned int)DwmAsyncSetCompositionAttribute(v8, *a1, 9, a2);
    }
  }
  return v6;
}
