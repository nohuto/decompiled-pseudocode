/*
 * XREFs of ?TraceLoggingSuppressQuickLaunch@@YAXXZ @ 0x1C022534C
 * Callers:
...
void TraceLoggingSuppressQuickLaunch(void)
{
    ...
    && (qword_1C032A410 & 0x400000000000LL) == qword_1C032A410 )
  {
    ...
    v4 = 0;
    v3 = 8;
    tlgWriteTransfer_EtwWriteTransfer((__int64)&dword_1C032A3F8, (unsigned __int8 *)dword_1C02F0C0A, 0LL, 0LL, 3u, &v1);
  }
}
