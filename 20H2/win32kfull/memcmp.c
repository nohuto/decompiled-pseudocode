 ...
 *     MagpRemoveTransformOutputMagFac @ 0x1C0108718 (MagpRemoveTransformOutputMagFac.c)
 ...
 *     CompareEventEntry @ 0x1C025C5CC (CompareEventEntry.c)
