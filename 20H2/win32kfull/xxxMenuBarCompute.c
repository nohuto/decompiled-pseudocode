/*
 * XREFs of xxxMenuBarCompute @ 0x1C003812C
 * Callers:
...
__int64 __fastcall xxxMenuBarCompute(__int64 ***a1, __int64 a2, __int64 a3, __int64 a4, int a5)
{
  ...
  {
    if ( (W32GetCurrentThreadDpiAwarenessContext(a1, 0LL, a3, a4) & 0xF) != 0 )
      WindowDpiLastNotify = *(_WORD *)(PsGetCurrentProcessWin32Process(v10, v17, a3) + 284);
    else
      WindowDpiLastNotify = 96;
    v9 = MEMORY[0x28];
  }
  if ( ((*(_DWORD *)(v9 + 232) & 0x10000000) != 0
     || (*(_DWORD *)(PsGetCurrentProcessWin32Process(v10, v9, a3) + 820) & 0x100000) != 0)
  ...
  if ( (*(_DWORD *)((**a1)[5] + 40) & 1) == 0 )
  {
    ...
    MBC_RightJustifyMenu((__int64 **)a1);
  }
