/*
 * XREFs of ?ForceCompletePendingPromotion@@YAXXZ @ 0x1C0218564
 * Callers:
...
void ForceCompletePendingPromotion(void)
{
  ...
  v3 = 0LL;
  v0 = word_1C0339BC0;
  v2 = ((dword_1C0339BD0 != 0) + 16842753) | (dword_1C0339BD4 != 0 ? 0x2000000 : 0);
  if ( !ValidatePointerPromotion(word_1C0339BC0, dword_1C0339BC4, &v2, &v4, &v3) )
    goto LABEL_5;
  v1 = v3;
  if ( v3 )
  {
