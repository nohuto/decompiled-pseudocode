/*
 * XREFs of NtUserCreateDCompositionHwndTarget @ 0x1C0080530
 * Callers:
 *     <none>
 * Callees:
 ...
 *     ?TestWindowForCompositionTarget@@YAJPEAUHWND__@@H@Z @ 0x1C008088C (-TestWindowForCompositionTarget@@YAJPEAUHWND__@@H@Z.c)
