/*
 * XREFs of ?InternalInvalidate2@@YAHPEAUtagWND@@PEAUHRGN__@@1PEAUtagRECT@@K@Z @ 0x1C00430B0
 * Callers:
 ...
 *     PhysicalToLogicalInPlaceRect @ 0x1C0044D24 (PhysicalToLogicalInPlaceRect.c)
...
__int64 __fastcall InternalInvalidate2(struct tagWND *a1, HRGN a2, HRGN a3, struct tagRECT *a4, unsigned int a5)
{
  ...
  *(_DWORD *)(v6 + 232) &= ~2u;
  ...
  {
    if ( !(unsigned int)IsRectEmptyInl(&v59) )
      goto LABEL_13;
  }
  else
  {
