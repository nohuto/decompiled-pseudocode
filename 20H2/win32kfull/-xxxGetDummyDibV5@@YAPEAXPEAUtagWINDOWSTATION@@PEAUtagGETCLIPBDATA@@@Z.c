/*
 * XREFs of ?xxxGetDummyDibV5@@YAPEAXPEAUtagWINDOWSTATION@@PEAUtagGETCLIPBDATA@@@Z @ 0x1C021ED94
 * Callers:
 ...
 *     ?SizeOfDibColorTable@@YAKPEAUtagBITMAPINFOHEADER@@@Z @ 0x1C015187C (-SizeOfDibColorTable@@YAKPEAUtagBITMAPINFOHEADER@@@Z.c)
...
LABEL_12:
  ...
  if ( *((_QWORD *)v9 + 1) == 2LL )
    return (void *)v2;
  v10 = (HBITMAP)xxxGetClipboardData(a1, 2u, (__int64)a2);
  if ( !v10 )
    return (void *)v2;
  v11 = 0LL;
