/*
 * XREFs of ?bSpDwmCreateLogicalSurface@@YAHPEAUHDEV__@@PEAVDWMSPRITE@@PEAVSFMLOGICALSURFACE@@PEAUtagSIZE@@PEAPEAV3@@Z @ 0x1C00C607C
 * Callers:
    ...
    if ( v11 || (*((_DWORD *)a3 + 61) & 1) != 0 )
    {
      ...
      *((_DWORD *)this + 17) = *((_DWORD *)this + 15);
      if ( *v28 == a3 )
      {
        ...
        if ( !v34 )
          goto LABEL_8;
        DWMSPRITE::SetLogicalSurface(this, v30, 0LL);
        DWMSPRITE::SetLogicalSurface(this, v31, v7);
        *v28 = v7;
      }
      else
      {
