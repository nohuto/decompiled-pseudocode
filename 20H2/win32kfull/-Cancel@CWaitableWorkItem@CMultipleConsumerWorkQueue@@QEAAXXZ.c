/*
 * XREFs of ?Cancel@CWaitableWorkItem@CMultipleConsumerWorkQueue@@QEAAXXZ @ 0x1C02DE334
 * Callers:
 ...
 *     ?UmfdCancelServerOutstandingRequests@@YAJPEAX@Z @ 0x1C00EA828 (-UmfdCancelServerOutstandingRequests@@YAJPEAX@Z.c)
 * Callees:
 *     <none>
 */
