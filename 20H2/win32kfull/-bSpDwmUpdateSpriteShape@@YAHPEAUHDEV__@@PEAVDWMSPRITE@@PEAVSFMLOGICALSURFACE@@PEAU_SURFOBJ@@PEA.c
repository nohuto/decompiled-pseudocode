/*
 * XREFs of ?bSpDwmUpdateSpriteShape@@YAHPEAUHDEV__@@PEAVDWMSPRITE@@PEAVSFMLOGICALSURFACE@@PEAU_SURFOBJ@@PEAU_RECTL@@PEAVPALETTE@@PEAK4PEAPEAV3@@Z @ 0x1C00C5D84
 * Callers:
        ...
        if ( right <= a4->sizlBitmap.cx )
        {
          ...
          if ( bottom <= a4->sizlBitmap.cy && top <= bottom && left <= right )
          {
            ...
            *(_QWORD *)&v39.left = 0LL;
            if ( a8 )
            {
              ERECTL::operator*=(&v39.left, &a8->left);
              v33 = v39.left + v20;
              v34 = v39.top + v21;
            }
...
LABEL_27:
            ...
            if ( v13 )
            {
              ...
              else
              {
                ...
                if ( !v27 )
                  goto LABEL_25;
                vSpUpdateDirtyRgn(a2, v18, 0LL, (struct _RECTL *)&v39, a7, 0);
              }
              if ( v13 )
                vSpUpdateDirtyRgn(a2, v18, 0LL, (struct _RECTL *)&v39, a7, 0);
            }
