/*
 * XREFs of ?FontManagement@PFFOBJ@@QEAAHPEAU_SURFOBJ@@PEAU_FONTOBJ@@KKPEAXK2@Z @ 0x1C02C10D0
 * Callers:
        ...
        void *a8)
{
  ...
  ATTACHOBJ::ATTACHOBJ((ATTACHOBJ *)v14, this, (__int64)a3, a4);
  if ( v12 )
    v11 = v12(a2, a3, v9, a5, a6, a7, a8);
