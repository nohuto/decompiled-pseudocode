/*
 * XREFs of SetWindowCompositionNonClientRTLLayout @ 0x1C02140C4
 * Callers:
...
__int64 __fastcall SetWindowCompositionNonClientRTLLayout(__int64 *a1, __int128 *a2)
{
  ...
  {
    if ( -__CFSHR__(v10[0], 3) == v5 )
      return 0;
    LODWORD(v10[0]) = v10[0] & 0xFFFFFFFB | (4 * v5);
    ...
    else
    {
      ...
      return (unsigned int)DwmAsyncSetCompositionAttribute(v8, *a1, 6, a2);
    }
  }
  return v6;
}
