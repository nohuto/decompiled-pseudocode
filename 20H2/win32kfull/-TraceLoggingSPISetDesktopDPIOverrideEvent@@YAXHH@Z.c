/*
 * XREFs of ?TraceLoggingSPISetDesktopDPIOverrideEvent@@YAXHH@Z @ 0x1C0224FBC
 * Callers:
...
void __fastcall TraceLoggingSPISetDesktopDPIOverrideEvent(__int64 a1, int a2, __int64 a3, __int64 a4)
{
