/*
 * XREFs of ?PopulatePayloadReport@InkDeviceParser@@SAJPEAU_HIDP_PREPARSED_DATA@@PEBUUsageValueInfo@@PEBXKPEAXK@Z @ 0x1C024FB14
 * Callers:
        ...
        ULONG ReportLength)
{
  ...
  *a5 = *((_BYTE *)a2 + 6);
  ...
  if ( v6 < 0 && (unsigned int)dword_1C032A288 > 2 )
  {
    ...
    v12 = 4;
    v11 = &v9;
    tlgWriteTransfer_EtwWriteTransfer((__int64)&dword_1C032A288, (unsigned __int8 *)dword_1C02F0A0C, 0LL, 0LL, 3u, &v10);
  }
  return v7;
}
