/*
 * XREFs of xxxGetInputEvent @ 0x1C004DC30
 * Callers:
...
__int64 __fastcall xxxGetInputEvent(unsigned int a1)
{
  ...
  if ( ((unsigned __int16)(v5 | *(_WORD *)(v3 + 4)) & v1) != 0
    || (v6 = *(unsigned int *)(gptiCurrent + 1232LL), (*(_DWORD *)(gptiCurrent + 1232LL) & 0x400) != 0 || (v2 & 8) != 0)
    && (v6 & 0x200) != 0
...
LABEL_40:
  ...
  CurrentProcessWin32Process = PsGetCurrentProcessWin32Process(v7, v2, v6);
