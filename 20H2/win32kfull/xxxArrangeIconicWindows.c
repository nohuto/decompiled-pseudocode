/*
 * XREFs of xxxArrangeIconicWindows @ 0x1C0152DE0
 * Callers:
 *     <none>
 * Callees:
...
struct tagBWL *__fastcall xxxArrangeIconicWindows(__int64 a1)
{
  ...
  InternalGetRealClientRect(a1, (__int64)&v71, 1LL, 0LL, 1);
...
LABEL_9:
  ...
  do
  {
    ...
    if ( v11 == v69 )
      goto LABEL_6;
    Prop = GetProp(v11, LOWORD(WPP_MAIN_CB.DeviceQueue.Lock), 1LL);
    if ( !Prop )
      goto LABEL_6;
    v15 = *(_DWORD *)(Prop + 48);
    v16 = (_DWORD *)(Prop + 32);
    ...
    while ( 2 )
    {
      if ( v28 )
      {
        ...
        if ( v29 )
        {
          v30 = v26;
          v31 = 0;
          v32 = *(_QWORD *)(GetProp(v29, LOWORD(WPP_MAIN_CB.DeviceQueue.Lock), 1LL) + 32);
          *(_QWORD *)&v71 = v32;
          if ( v26 < v27 )
          {
            v33 = DWORD1(v71);
...
LABEL_90:
            ...
            v35 = *(_QWORD *)(GetProp(v34, LOWORD(WPP_MAIN_CB.DeviceQueue.Lock), 1LL) + 32);
...
LABEL_103:
  ...
  if ( *v68 != 1 )
  {
    ...
    while ( 1 )
    {
      ...
      if ( !v51 )
        goto LABEL_114;
      v52 = GetProp(v51, LOWORD(WPP_MAIN_CB.DeviceQueue.Lock), 1LL);
      if ( v52 )
      {
        *(_DWORD *)(v52 + 48) |= 0x20u;
        *(_QWORD *)(v52 + 32) = v62;
  ...
  if ( v53 )
  {
    while ( 1 )
    {
      ...
      if ( v61 )
      {
        ...
        if ( v54 )
        {
          v56 = GetProp(v54, LOWORD(WPP_MAIN_CB.DeviceQueue.Lock), 1LL);
