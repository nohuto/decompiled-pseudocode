/*
 * XREFs of NtGdiStartDoc @ 0x1C01413D0
 * Callers:
 *     <none>
 * Callees:
 *     ULongLongMult @ 0x1C01419B0 (ULongLongMult.c)
...
__int64 __fastcall NtGdiStartDoc(HDC a1, __int64 a2, _DWORD *a3, int a4)
{
  ...
  if ( v32.lpszDocName )
    FreeThreadBufferWithTag(v32.lpszDocName);
  if ( v32.lpszOutput )
    FreeThreadBufferWithTag(v32.lpszOutput);
  if ( v32.lpszDatatype )
    FreeThreadBufferWithTag(v32.lpszDatatype);
  return started;
}
