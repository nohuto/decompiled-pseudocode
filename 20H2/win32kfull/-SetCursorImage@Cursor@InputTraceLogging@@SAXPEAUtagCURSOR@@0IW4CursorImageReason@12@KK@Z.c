/*
 * XREFs of ?SetCursorImage@Cursor@InputTraceLogging@@SAXPEAUtagCURSOR@@0IW4CursorImageReason@12@KK@Z @ 0x1C002B2A8
 * Callers:
        ...
        int a6)
{
  ...
  result = &retaddr;
  if ( (unsigned int)dword_1C032FB30 > 4 && (qword_1C032FB40 & 8) != 0 )
  {
    result = (_UNKNOWN **)(qword_1C032FB48 & 8);
    if ( result == (_UNKNOWN **)qword_1C032FB48 )
    {
