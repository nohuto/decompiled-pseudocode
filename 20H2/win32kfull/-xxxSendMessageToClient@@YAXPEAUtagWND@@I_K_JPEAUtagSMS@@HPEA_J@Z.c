/*
 * XREFs of ?xxxSendMessageToClient@@YAXPEAUtagWND@@I_K_JPEAUtagSMS@@HPEA_J@Z @ 0x1C0054120
 * Callers:
...
LABEL_6:
        ...
        if ( (v9 & 0x1FFFF) >= 0x400 )
        {
          v48 = a5;
          v47 = v14;
          v17 = SfnDWORD((__int64 *)a1, v9, v8, v7, v16, *(_QWORD *)(gpsi + 752LL));
        }
        else
        {
...
LABEL_8:
    ...
    || (*(_BYTE *)(v18 + 18) & 1) != 0 )
  {
    ...
    if ( (v9 & 0x1FFFF) >= 0x400 )
    {
      v48 = a5;
      v47 = v14;
      v17 = SfnDWORD((__int64 *)a1, v9, v8, v7, v13, *(_QWORD *)(v25 - 4608));
    }
    else
    {
      v17 = ((__int64 (__fastcall *)(struct tagWND *, _QWORD, __int64, __int64, __int64, _QWORD, BOOL, struct tagSMS *))gapfnScSendMessage[(unsigned __int8)MessageTable[(unsigned __int16)v9]])(
  ...
  if ( a6 )
  {
    ...
    *(_QWORD *)&v51 = *(_QWORD *)(v45 + 416);
    *(_QWORD *)(v45 + 416) = &v51;
    *((_QWORD *)&v51 + 1) = a1;
    HMLockObject(a1);
  }
  v37 = xxxDefWindowProc(a1);
  v40 = a7;
  *a7 = v37;
  if ( v36 )
