/*
 * XREFs of ?GetCurrentThreadCompositedDpiContext@@YAKXZ @ 0x1C003AF80
 * Callers:
...
__int64 __fastcall GetCurrentThreadCompositedDpiContext(__int64 a1, __int64 a2, __int64 a3, __int64 a4)
{
