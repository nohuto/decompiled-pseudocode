/*
 * XREFs of ?EnsureServerInfoForDpi@@YAXPEAUtagDPISERVERINFO@@H@Z @ 0x1C01E98AC
 * Callers:
...
void __fastcall EnsureServerInfoForDpi(struct tagDPISERVERINFO *a1, __int64 a2, __int64 a3)
{
  ...
  if ( !*(_DWORD *)a1 )
  {
    ...
    {
      memset(v8, 0, 0x68uLL);
      if ( (unsigned int)CreateScaledFont(*(HBRUSH *)(v5 + 8), (__int64)&v8[2], (__int64)&v8[2] + 4, 0LL) )
      {
      ...
      if ( (unsigned int)CreateScaledFont(*(HBRUSH *)(v5 + 24), (__int64)&v8[4], (__int64)&v8[4] + 4, (__int64)&v8[5]) )
      {
