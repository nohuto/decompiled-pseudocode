/*
 * XREFs of ?xxxSetSlateAutoRotationState@CLegacyRotationMgr@@AEAAJH@Z @ 0x1C01D1778
 * Callers:
...
__int64 __fastcall CLegacyRotationMgr::xxxSetSlateAutoRotationState(CLegacyRotationMgr *this, int a2)
{
  ...
  if ( updated >= 0 )
  {
      ...
      && (qword_1C032A410 & 0x200000000001LL) == qword_1C032A410 )
    {
      ...
      v5 = a2;
      v8 = 4;
      tlgWriteTransfer_EtwWriteTransfer((int)&dword_1C032A3F8, (int)&dword_1C02EEB79, 0, 0, 3u, &v6);
    }
  }
