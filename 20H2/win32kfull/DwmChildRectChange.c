/*
 * XREFs of DwmChildRectChange @ 0x1C00CB830
 * Callers:
...
LONG_PTR __fastcall DwmChildRectChange(unsigned __int64 a1, __int64 a2, int a3)
{
      ...
      if ( *ThreadWin32Thread )
      {
        ...
        if ( *(_QWORD *)(v30 + 456) )
        {
          ...
          if ( (*(_DWORD *)(**(_QWORD **)(*(_QWORD *)(v37 + 456) + 8LL) + 64LL) & 1) != 0 )
          {
            v45 = v5[5];
            v46 = *(_DWORD *)(v45 + 288);
            if ( (v46 & 0xF) == 0 && (v46 & 0x40000000) != 0 )
            {
              v51 = *(unsigned __int16 *)(v45 + 284);
              if ( (_WORD)v51 != 96 )
              {
                ScaledLogPixels = GreGetScaledLogPixels(v51, v42, v43, v44);
                v66 = ScaledLogPixels;
  ...
  v47 = *v5;
  result = ReferenceDwmApiPort(v48);
  v50 = (void *)result;
  ...
  if ( result )
  {
    ...
    *(__m128i *)&v72[17] = v70;
    v72[25] = v4;
    EtwUpdateEvent(v47, 1073741845LL);
    LpcRequestPort(v50, v72);
    return ObfDereferenceObject(v50);
  }
  return result;
}
