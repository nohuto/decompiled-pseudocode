/*
 * XREFs of GrePolyPolygonInternal @ 0x1C0139D14
 * Callers:
...
LABEL_15:
  ...
  v10 = *(_QWORD *)(v13[0] + 976LL);
  v11 = *(_DWORD *)(v10 + 152);
  if ( (v11 & 0x1000) != 0 )
  {
    GreDCSelectBrush(v13[0], *(_QWORD *)(v10 + 160));
    v9 = v13[0];
  }
  if ( (v11 & 0x2000) != 0 )
  {
  ...
  if ( a4 )
  {
    ...
    if ( v16 )
    {
      ...
      if ( (*(_DWORD *)(v13[0] + 248LL) & 1) != 0
        || (unsigned int)EPATHOBJ::bStrokeAndOrFill(&ppo, (struct XDCOBJ *)v13, (LINEATTRS *)(v13[0] + 208LL), &v14, 3u) )
      {
        v8 = 1;
        goto LABEL_13;
      }
