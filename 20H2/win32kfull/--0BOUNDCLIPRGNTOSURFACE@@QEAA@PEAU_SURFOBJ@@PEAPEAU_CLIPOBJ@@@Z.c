/*
 * XREFs of ??0BOUNDCLIPRGNTOSURFACE@@QEAA@PEAU_SURFOBJ@@PEAPEAU_CLIPOBJ@@@Z @ 0x1C013DFA0
 * Callers:
 ...
 *     ?bContain@ERECTL@@QEBAHAEBU_RECTL@@@Z @ 0x1C013E068 (-bContain@ERECTL@@QEBAHAEBU_RECTL@@@Z.c)
