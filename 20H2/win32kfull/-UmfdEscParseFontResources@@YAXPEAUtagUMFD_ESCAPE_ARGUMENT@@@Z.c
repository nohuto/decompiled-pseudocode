/*
 * XREFs of ?UmfdEscParseFontResources@@YAXPEAUtagUMFD_ESCAPE_ARGUMENT@@@Z @ 0x1C00E196C
 * Callers:
 *     UmfdDispatchEscape @ 0x1C008D6E0 (UmfdDispatchEscape.c)
 * Callees:
 *     cParseFontResources @ 0x1C00E1A48 (cParseFontResources.c)
...
void __fastcall UmfdEscParseFontResources(struct tagUMFD_ESCAPE_ARGUMENT *a1)
{
  ...
  if ( UmfdFileviewLookup
    && (v9 = *(_DWORD *)v1,
        (unsigned __int8)NSInstrumentation::CSortedVector<unsigned int,_FONTFILEVIEW *>::LookUp(v3, &v9, &v11))
    && *(_QWORD *)(v11 + 16) )
  {
