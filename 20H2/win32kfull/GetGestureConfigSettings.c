/*
 * XREFs of GetGestureConfigSettings @ 0x1C0227198
 * Callers:
 *     NtUserGetGestureConfig @ 0x1C01F92D0 (NtUserGetGestureConfig.c)
 * Callees:
 *     ?GetGCData@@YAPEAUtagVWPLGESTUREDATA@@PEAUtagWND@@@Z @ 0x1C001AB2C (-GetGCData@@YAPEAUtagVWPLGESTUREDATA@@PEAUtagWND@@@Z.c)
 *     _IsTopLevelWindow @ 0x1C0046FA0 (_IsTopLevelWindow.c)
 *     UserSetLastError @ 0x1C00D60E0 (UserSetLastError.c)
 *     ?IsBitSet@@YAHPEAEI@Z @ 0x1C0128D38 (-IsBitSet@@YAHPEAEI@Z.c)
 *     ?GetWindowGCList@@YAPEAPEAXPEAUtagWND@@@Z @ 0x1C0128D68 (-GetWindowGCList@@YAPEAPEAXPEAUtagWND@@@Z.c)
 *     ?FindGID@@YAHPEAPEAUtagGESTURECONFIGLIST@@I0@Z @ 0x1C0226FC4 (-FindGID@@YAHPEAPEAUtagGESTURECONFIGLIST@@I0@Z.c)
 */
...
LABEL_37:
      ...
      else
      {
        if ( !*((_DWORD *)v26 + 2) )
        {
          ...
          v37 = ~*(v30 - 1) & dword_1C02E9E50[v31];
          goto LABEL_37;
        }
        *(v30 - 1) = ~*v30 & dword_1C02E9E50[v31];
      }
LABEL_39:
      ++v29;
      v30 += 3;
