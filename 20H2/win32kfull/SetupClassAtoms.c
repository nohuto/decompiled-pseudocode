/*
 * XREFs of SetupClassAtoms @ 0x1C0121800
 * Callers:
 *     <none>
 * Callees:
 *     <none>
...
__int64 SetupClassAtoms()
{
  ...
  *(_WORD *)(gpsi + 1378LL) = UserAddAtomEx(L"SysFrostedWindow", 1LL, 2LL);
  ...
  LOWORD(WPP_MAIN_CB.DeviceQueue.Lock) = UserAddAtomEx(L"SysCP", 1LL, 2LL);
  if ( LOWORD(WPP_MAIN_CB.DeviceQueue.Lock) )
    v8 = v7 != 0 ? v6 : 0;
  else
    LOBYTE(v8) = 0;
  ...
  *((_WORD *)&WPP_MAIN_CB.AlignmentRequirement + 2) = UserAddAtomEx(L"SysSwapChain", 1LL, 2LL);
  v17 = (*((_WORD *)&WPP_MAIN_CB.AlignmentRequirement + 2) != 0) & v16;
  ...
  if ( LOWORD(WPP_MAIN_CB.AlignmentRequirement) )
    v19 = v18 != 0 ? v17 : 0;
  else
    v19 = 0;
  ...
  *((_WORD *)&WPP_MAIN_CB.DeviceQueue.1 + 2) = UserAddAtomEx(L"BrokeredForeground", 1LL, 2LL);
  if ( *((_WORD *)&WPP_MAIN_CB.DeviceQueue.1 + 2) )
    v33 = v31 && v32;
  else
    v33 = 0;
