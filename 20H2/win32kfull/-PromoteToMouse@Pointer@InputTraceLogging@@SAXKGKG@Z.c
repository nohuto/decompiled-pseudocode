/*
 * XREFs of ?PromoteToMouse@Pointer@InputTraceLogging@@SAXKGKG@Z @ 0x1C0218B78
 * Callers:
...
void __fastcall InputTraceLogging::Pointer::PromoteToMouse(int a1, __int16 a2, int a3, unsigned __int16 a4)
{
  ...
  if ( (unsigned int)dword_1C032FB30 > 4 && (qword_1C032FB40 & 0x20) != 0 && (qword_1C032FB48 & 0x20) == qword_1C032FB48 )
  {
    v6 = a3;
    v15 = &v5;
    v4 = a2;
    ...
    v12 = 2LL;
    v10 = 4LL;
    tlgWriteTransfer_EtwWriteTransfer((__int64)&dword_1C032FB30, (unsigned __int8 *)dword_1C02F0956, 0LL, 0LL, 6u, &v8);
  }
}
