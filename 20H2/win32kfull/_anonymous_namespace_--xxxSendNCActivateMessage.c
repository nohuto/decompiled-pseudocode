/*
 * XREFs of _anonymous_namespace_::xxxSendNCActivateMessage @ 0x1C00BB764
 * Callers:
...
bool __fastcall anonymous_namespace_::xxxSendNCActivateMessage(
        struct tagWND *a1,
        unsigned __int64 a2,
...
LABEL_3:
    TopLevelWindow = a1;
    v6 = xxxSendMessage((unsigned __int64)a1, 0x86u, a2, a3) != 0;
    goto LABEL_4;
  }
  v7 = 1;
  ...
  if ( TopLevelWindow && gpqForegroundPrev && *(struct tagWND **)(gpqForegroundPrev + 128LL) != TopLevelWindow )
  {
    ...
    *(_QWORD *)(ThreadWin32Thread + 416) = v16;
    ...
    v6 = (unsigned int)xxxSendNotifyMessage((__int64)TopLevelWindow, 0x86u, a2, 0LL, 1) != 0;
...
LABEL_4:
  ...
  if ( (*((_DWORD *)TopLevelWindow + 81) & 8) != 0 )
  {
    for ( i = *((_QWORD *)TopLevelWindow + 14); i; i = *(_QWORD *)(i + 88) )
    {
      ...
      {
        QueueNotifyTransformableMessage((struct tagWND *)i, 764, v7, 0, 1, 0);
        break;
      }
    }
  }
