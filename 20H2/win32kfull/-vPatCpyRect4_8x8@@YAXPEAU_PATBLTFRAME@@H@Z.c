/*
 * XREFs of ?vPatCpyRect4_8x8@@YAXPEAU_PATBLTFRAME@@H@Z @ 0x1C02C5870
 * Callers:
 *     ?vBrushPath4_8x8Enum@@YAXPEAU_RECTL@@KPEAX@Z @ 0x1C02CEE40 (-vBrushPath4_8x8Enum@@YAXPEAU_RECTL@@KPEAX@Z.c)
 * Callees:
 *     __security_check_cookie @ 0x1C015A0C0 (__security_check_cookie.c)
 *     ?vPatternCopyLoop@@YAXPEAU_RECTL@@PEAKPEAU_PATBLTFRAME@@HKKKKJJJPEBK3@Z @ 0x1C02C6CAC (-vPatternCopyLoop@@YAXPEAU_RECTL@@PEAKPEAU_PATBLTFRAME@@HKKKKJJJPEBK3@Z.c)
 */
...
void __fastcall vPatCpyRect4_8x8(struct _PATBLTFRAME *a1, int a2)
{
  ...
  if ( *((_DWORD *)a1 + 8) )
  {
    v6 = (const unsigned int *)&v19;
    v7 = (const unsigned int *)&v21;
    v8 = &v20;
    v9 = 4 * *((_BYTE *)a1 + 32);
  ...
  do
  {
    v13 = dword_1C02F9FB0[v3->left & 7];
    v14 = ~v13;
    v15 = dword_1C02F9FB0[v3->right & 7];
    if ( !v15 )
      v15 = -1;
