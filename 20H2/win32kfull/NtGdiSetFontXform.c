/*
 * XREFs of NtGdiSetFontXform @ 0x1C0141280
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall NtGdiSetFontXform(HDC a1, unsigned int a2, unsigned int a3)
{
  ...
  v13 = 0;
  v18 = 0;
  if ( bConvertDwordToFloat(a2, (float *)&v13)
    && bConvertDwordToFloat(a3, (float *)&v18)
    && (v5 = v18, v6 = v13, v15 = 0LL, v16 = 0, v17 = 0, XDCOBJ::vLock((XDCOBJ *)&v15, a1), (v7 = v15) != 0LL) )
  {
    *((_DWORD *)v15 + 113) = v6;
    v8 = 1;
    *((_DWORD *)v7 + 114) = v5;
    *((_DWORD *)v15 + 63) |= 1u;
    ...
    if ( v15 )
    {
      ...
      v14 = 0;
      v11 = *(_QWORD *)v9;
      HmgDecrementExclusiveReferenceCountEx(v9, v17, &v14);
      if ( v14 )
