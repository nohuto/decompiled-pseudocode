/*
 * XREFs of ?OnDeviceClosed@InkProcessor@@QEAAXPEAURawInputManagerDeviceObject@@@Z @ 0x1C024EF84
 * Callers:
 ...
 * Callees:
 *     ?OnDeviceClosed@RimBackedDeviceBase@Rim@@UEAAXXZ @ 0x1C0243420 (-OnDeviceClosed@RimBackedDeviceBase@Rim@@UEAAXXZ.c)
