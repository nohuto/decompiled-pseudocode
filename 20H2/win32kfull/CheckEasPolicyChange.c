/*
 * XREFs of CheckEasPolicyChange @ 0x1C01D3E68
 * Callers:
...
__int64 CheckEasPolicyChange()
{
  ...
  *(_OWORD *)&ObjectAttributes.SecurityDescriptor = 0LL;
  ...
  if ( qword_1C033B9F8 != KeyInformation )
  {
    qword_1C033B9F8 = KeyInformation;
    return 1;
  }
  ...
  *(_OWORD *)&ObjectAttributes.SecurityDescriptor = 0LL;
  ...
  if ( qword_1C033B9F0 != KeyInformation )
  {
    qword_1C033B9F0 = KeyInformation;
    return 1;
  }
  return v0;
}
