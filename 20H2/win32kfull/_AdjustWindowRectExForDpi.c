/*
 * XREFs of _AdjustWindowRectExForDpi @ 0x1C00CBE20
 * Callers:
...
LABEL_4:
  ...
  if ( *(_DWORD *)(ThreadWin32Thread + 632) > 0x9900u )
    ...
    v14 = *(_DWORD *)(ThreadWin32Thread + 648);
  if ( (v10 & 0x100) == 0 )
    v11 = (v10 & 0x20000) != 0;
  v15 = v11 + 1;
  ...
  if ( (a2 & 0x40000) != 0 || (result = v15, v16 > 0) && (a2 & 0xC00000) == 0xC00000 && (v14 & 0x30000000) == 0 )
    result = v16 + v15 + (unsigned int)GetResizeBorderWidthForDpiWithAppCompat2(a5, v14, v13);
  v18 = result + 2;
  if ( (v10 & 0x200) == 0 )
    v18 = result;
  if ( v18 )
