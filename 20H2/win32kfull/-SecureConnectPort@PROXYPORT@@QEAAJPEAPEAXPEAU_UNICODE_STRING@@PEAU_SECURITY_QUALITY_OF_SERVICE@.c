/*
 * XREFs of ?SecureConnectPort@PROXYPORT@@QEAAJPEAPEAXPEAU_UNICODE_STRING@@PEAU_SECURITY_QUALITY_OF_SERVICE@@PEAU_PORT_VIEW@@PEAXPEAU_REMOTE_PORT_VIEW@@PEAK46@Z @ 0x1C0116328
 * Callers:
 *     ??0PROXYPORT@@QEAA@_K@Z @ 0x1C0115F38 (--0PROXYPORT@@QEAA@_K@Z.c)
 * Callees:
 *     __security_check_cookie @ 0x1C015A0C0 (__security_check_cookie.c)
 *     Win32DestroySection @ 0x1C01D4080 (Win32DestroySection.c)
 *     Win32OpenSectionByHandle @ 0x1C01D409C (Win32OpenSectionByHandle.c)
 *     Win32MapViewInSessionSpace @ 0x1C01E90E4 (Win32MapViewInSessionSpace.c)
 */
