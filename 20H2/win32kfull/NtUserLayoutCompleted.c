/*
 * XREFs of NtUserLayoutCompleted @ 0x1C0113E00
 * Callers:
 *     <none>
 * Callees:
 ...
 *     DwmAsyncCancelRotationDelay @ 0x1C0273B20 (DwmAsyncCancelRotationDelay.c)
 */
...
__int64 __fastcall NtUserLayoutCompleted(__int64 a1)
{
  ...
  if ( v2 )
  {
    ...
    *((_QWORD *)&v13 + 1) = v2;
    ...
    {
      v12 = (void *)ReferenceDwmApiPort(v6);
      DwmAsyncCancelRotationDelay(v12);
    }
