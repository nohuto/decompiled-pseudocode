/*
 * XREFs of ?GreUpdateSpriteInternal@@YAHPEAUHDEV__@@PEAUHWND__@@PEAXPEAUHDC__@@PEAUtagPOINT@@PEAUtagSIZE@@34KPEAU_BLENDFUNCTION@@KPEAUtagRECT@@PEAUtagMINIWINDOWINFO@@HH@Z @ 0x1C00A76A0
 * Callers:
 ...
 *     ?GreUpdateSpriteCallout@@YAXPEAX@Z @ 0x1C026D260 (-GreUpdateSpriteCallout@@YAXPEAX@Z.c)
 * Callees:
        ...
        int a15)
{
  ...
  __int64 v63; // r9
  LONG y; // edx
  struct _RECTL *v65; // rax
  LONG v66; // ecx
  int v67; // eax
  LONG v68; // eax
  unsigned int v69; // eax
  int v70; // eax
  SFMLOGICALSURFACE *v71; // rcx
  int v72; // eax
  bool v73; // dl
  SURFACE *v74; // rax
  int updated; // eax
...
LABEL_80:
    ...
    if ( v113 == 0x2000000 )
    {
      ...
      v113 = 570425346;
      v73 = v95 || v97;
      vSpDwmUpdateSpriteVisibility((struct DWMSPRITE *)v18, v73);
      v38 = 570425346;
    }
    if ( (v38 & 0x20000000) != 0 )
    {
...
LABEL_32:
    ...
    *(_DWORD *)(v18 + 72) = v38;
    if ( (v38 & 2) != 0 )
    {
      ...
      {
        v69 = bSpDwmCreateLogicalSurface(v94, (struct DWMSPRITE *)v18, (struct SFMLOGICALSURFACE *)v33, 0LL, &v84);
        v38 = v113;
        v39 = (struct tagPOINT *)v86;
        FirstLSurf = v84;
        v79 = v69;
      ...
      if ( *((_QWORD *)v82 + 23) )
      {
        if ( (unsigned int)SFMLOGICALSURFACE::bDeviceBitmap(v82) )
        {
          if ( !(unsigned int)bRemoteDriverNeedsDeviceBitmaps((struct PDEVOBJ *)&v101) )
          {
            ...
            v70 = PDEVOBJ::bAllowShareAccess((PDEVOBJ *)&v101);
            v71 = v82;
            if ( v70 )
            {
              v72 = *((_DWORD *)v82 + 29);
              if ( (v72 & 0x20) == 0 )
              {
                *((_DWORD *)v82 + 29) = v72 | 0x20;
                pConvertDfbSurfaceToDibPostNKAPC(*((HSURF *)v71 + 4));
                v80 = 1;
              }
            }
            else
      ...
      if ( v104[0] )
      {
        if ( !(unsigned int)XDCOBJ::bFullScreen((XDCOBJ *)v104) )
        {
          ...
          if ( !v93 )
            v65 = 0LL;
          v109.bottom = v66;
          v67 = bSpDwmUpdateSpriteShape(
                  v94,
                  (struct DWMSPRITE *)v18,
                  FirstLSurf,
                  (struct _SURFOBJ *)(v63 + 24),
                  &v109,
                  *(struct PALETTE **)(v63 + 128),
                  &v83,
                  v65,
                  &v84);
          v62 = v104[0];
...
LABEL_49:
    ...
    if ( (_DWORD)v41 && !v80 && (v44 || (*((_DWORD *)FirstLSurf + 63) & 8) != 0) )
    {
      if ( (*((_DWORD *)FirstLSurf + 63) & 8) != 0 )
        SFMLOGICALSURFACE::StartSfmStateTracking(FirstLSurf, v94, gpSfmState, (int)v39);
      ...
      v105 = *(_QWORD *)(v18 + 104);
      v60 = *(_DWORD *)(v18 + 116) < 1;
      *(_QWORD *)(v18 + 104) = 0LL;
      LODWORD(v82) = !v60;
      v106 = *(_QWORD *)v84;
      v100 = *(void **)v18;
      v61 = (void *)UserReferenceDwmApiPort(v59, v58, v56, v57);
      DwmAsyncUpdateSprite(v61, v18 + 72, v85, v89, v88, v87, (int)v82, v105);
    }
    if ( v36 )
    {
    ...
    if ( v102 )
    {
      ...
      if ( v45 )
      {
        SFMLOGICALSURFACE::DeInitialize(v45, v47, 0LL);
        FreeObject(v45, 18LL);
