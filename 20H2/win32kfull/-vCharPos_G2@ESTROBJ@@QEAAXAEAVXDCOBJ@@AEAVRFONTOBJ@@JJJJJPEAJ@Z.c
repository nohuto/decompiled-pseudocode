/*
 * XREFs of ?vCharPos_G2@ESTROBJ@@QEAAXAEAVXDCOBJ@@AEAVRFONTOBJ@@JJJJJPEAJ@Z @ 0x1C0005254
 * Callers:
 ...
 *     ??4EPOINTQF@@QEAAXAEAVEPOINTFL@@@Z @ 0x1C02BC2CC (--4EPOINTQF@@QEAAXAEAVEPOINTFL@@@Z.c)
 */
