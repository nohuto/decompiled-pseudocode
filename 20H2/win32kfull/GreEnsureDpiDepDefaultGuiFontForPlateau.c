/*
 * XREFs of GreEnsureDpiDepDefaultGuiFontForPlateau @ 0x1C0292C00
 * Callers:
 *     NtGdiEnsureDpiDepDefaultGuiFontForPlateau @ 0x1C02AD7B0 (NtGdiEnsureDpiDepDefaultGuiFontForPlateau.c)
 * Callees:
