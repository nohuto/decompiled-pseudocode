/*
 * XREFs of InitializeClientPfnArrays @ 0x1C0127494
 * Callers:
 *     NtUserInitializeClientPfnArrays @ 0x1C01273A0 (NtUserInitializeClientPfnArrays.c)
 * Callees:
 *     <none>
 */

__int64 __fastcall InitializeClientPfnArrays(__int128 *a1, _OWORD *a2, __int64 a3, struct _LIST_ENTRY *a4)
{
  __int128 v8; // xmm0
  __int128 v9; // xmm0
  _OWORD *v10; // rbx
  ...
  if ( PsGetCurrentProcess(a1, a2, a3) == gpepCSRSS )
  {
    ...
    *(_QWORD *)&WPP_MAIN_CB.SectorSize = *(_QWORD *)(gpsi + 640LL);
    WPP_MAIN_CB.DeviceObjectExtension = *(struct _DEVOBJ_EXTENSION **)(gpsi + 616LL);
    WPP_MAIN_CB.Reserved = *(PVOID *)(gpsi + 696LL);
    *((_QWORD *)&WPP_MAIN_CB.Reserved + 1) = *(_QWORD *)(gpsi + 680LL);
    qword_1C0338EE8 = *(_QWORD *)(gpsi + 648LL);
    qword_1C0338F50 = *(_QWORD *)(gpsi + 664LL);
    qword_1C0338F68 = *(_QWORD *)(gpsi + 592LL);
    qword_1C0338EF0 = *(_QWORD *)(gpsi + 688LL);
    qword_1C0338EF8 = *(_QWORD *)(gpsi + 656LL);
    qword_1C0338F48 = 1LL;
    qword_1C0338F58 = 3LL;
    qword_1C0338F60 = 2LL;
    qword_1C0338F70 = 5LL;
    WPP_MAIN_CB.DeviceLock.Header.WaitListHead.Flink = a4;
    dword_1C0339EE8 = 1;
    return 0LL;
  }
  return 3221225506LL;
