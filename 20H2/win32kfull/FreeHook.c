 ...
 *     FreeThreadsWindowHooks @ 0x1C00F3C10 (FreeThreadsWindowHooks.c)
 * Callees:
 *     ?UnlinkHook@@YAXPEAUtagHOOK@@@Z @ 0x1C0074C44 (-UnlinkHook@@YAXPEAUtagHOOK@@@Z.c)
