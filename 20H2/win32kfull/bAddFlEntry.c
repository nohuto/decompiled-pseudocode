/*
 * XREFs of bAddFlEntry @ 0x1C001F994
 * Callers:
 ...
 *     ?ParseFontLinkEntry@@YA_NPEAGPEAUFontLinkData@@@Z @ 0x1C001FF4C (-ParseFontLinkEntry@@YA_NPEAGPEAUFontLinkData@@@Z.c)
 *     ?FindBaseFontEntry@@YAPEAU_FLENTRY@@PEBG@Z @ 0x1C002008C (-FindBaseFontEntry@@YAPEAU_FLENTRY@@PEBG@Z.c)
 *     ?FindLinkedFontEntry@@YAPEAU_PFEDATA@@PEAU_LIST_ENTRY@@PEBG1@Z @ 0x1C0020114 (-FindLinkedFontEntry@@YAPEAU_PFEDATA@@PEAU_LIST_ENTRY@@PEBG1@Z.c)
  ...
  *(_QWORD *)(v16 + 24) = v36;
  ...
  if ( (_QWORD)v32 )
  {
    ...
    if ( v15 )
    {
      ...
      *(_QWORD *)(v7 + 24) = v7 + 16;
      *(_QWORD *)(v7 + 16) = v7 + 16;
      v27 = (__int64 *)off_1C032A380;
      if ( *off_1C032A380 != (_UNKNOWN *)&off_1C032A378 )
        goto LABEL_48;
      ++dword_1C033A0B4;
      *(_QWORD *)(v7 + 8) = off_1C032A380;
      *(_QWORD *)v7 = &off_1C032A378;
      *v27 = v7;
      off_1C032A380 = (_UNKNOWN **)v7;
      if ( a5 )
        *a5 = v7;
      ++dword_1C033A0B0;
    }
