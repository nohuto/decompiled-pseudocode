/*
 * XREFs of TransformVectorWithInputTargetPrecedence @ 0x1C00FAD88
 * Callers:
 ...
 *     EditionGetLogicalPointForMouseCaptureButtonEvent @ 0x1C00FAD10 (EditionGetLogicalPointForMouseCaptureButtonEvent.c)
 * Callees:
