/*
 * XREFs of ?Insert@?$CSortedVector@PEAXPEAX@NSInstrumentation@@QEAA_NAEBQEAX0@Z @ 0x1C02DC8DC
 * Callers:
 ...
 *     ?LowerBound@?$CSortedVector@PEAXPEAX@NSInstrumentation@@QEBA_KAEBQEAX@Z @ 0x1C02DCB2C (-LowerBound@-$CSortedVector@PEAXPEAX@NSInstrumentation@@QEBA_KAEBQEAX@Z.c)
 */
...
char __fastcall NSInstrumentation::CSortedVector<void *,void *>::Insert(__int64 a1, _QWORD *a2, _QWORD *a3)
{
  ...
  v9 = 16 * v7;
  v10 = v7;
  if ( v7 < v8 && (v11 = *(_QWORD *)(a1 + 48), *(_QWORD *)(v11 + 16 * v7) == *a2) )
  {
    *(_QWORD *)(v11 + v9 + 8) = *a3;
  }
  else
  {
    v12 = *(_QWORD *)(a1 + 32);
    if ( v8 != v12 || NSInstrumentation::CSortedVector<void *,void *>::ReAllocate(a1, 2 * v12) )
    {
      memmove(
