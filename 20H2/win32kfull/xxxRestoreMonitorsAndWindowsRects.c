/*
 * XREFs of xxxRestoreMonitorsAndWindowsRects @ 0x1C01D796C
 * Callers:
...
__int64 __fastcall xxxRestoreMonitorsAndWindowsRects(__int64 a1, __int64 a2)
{
  ...
  __int128 v26; // [rsp+58h] [rbp-30h] BYREF
      ...
      for ( i = 0; i < *(_DWORD *)(a1 + 32); v13 += 48LL )
      {
          ...
          && (*(_DWORD *)(*(_QWORD *)(*(_QWORD *)(v16 + 16) + 424LL) + 820LL) & 0x30) != 0x10 )
        {
          ...
          *(_QWORD *)(ThreadWin32Thread + 416) = v25;
          ...
          {
            Prop = (_OWORD *)GetProp(v16, LOWORD(WPP_MAIN_CB.DeviceQueue.Lock), 1LL);
            if ( Prop )
              *Prop = *(_OWORD *)(v13 + 16);
          }
          LODWORD(v24) = 20;
