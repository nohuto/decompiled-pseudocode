/*
 * XREFs of ?ProcessInkFeedbackCommand@HideInkCursorProvider@@UEAAJW4INK_FEEDBACK_COMMAND@@PEBXI@Z @ 0x1C0253AE0
 * Callers:
 *     <none>
 * Callees:
        ...
        __int64 a4)
{
  ...
  if ( a2 == 3 )
  {
    ...
    if ( !InkFeedbackProviderBase::FindActiveCommandByTargetPointerId((__int64)a1, 3, *a3) )
    {
      ...
      v61 = 4;
LABEL_17:
      tlgWriteTransfer_EtwWriteTransfer((__int64)&dword_1C032A288, (unsigned __int8 *)dword_1C02F0A0C, 0LL, 0LL, 3u, v8);
      return v7;
    }
    v7 = -1073741823;
