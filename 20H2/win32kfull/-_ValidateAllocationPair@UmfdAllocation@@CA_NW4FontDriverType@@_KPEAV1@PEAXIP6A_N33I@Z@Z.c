/*
 * XREFs of ?_ValidateAllocationPair@UmfdAllocation@@CA_NW4FontDriverType@@_KPEAV1@PEAXIP6A_N33I@Z@Z @ 0x1C00E35B0
 * Callers:
 ...
 * Callees:
 *     ?TryProbeForRead@@YA_NPEAXII@Z @ 0x1C00E41C4 (-TryProbeForRead@@YA_NPEAXII@Z.c)
