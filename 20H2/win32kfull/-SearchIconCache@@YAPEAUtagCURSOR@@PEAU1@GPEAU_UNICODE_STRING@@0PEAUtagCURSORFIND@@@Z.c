/*
 * XREFs of ?SearchIconCache@@YAPEAUtagCURSOR@@PEAU1@GPEAU_UNICODE_STRING@@0PEAUtagCURSORFIND@@@Z @ 0x1C00947A8
 * Callers:
 ...
 * Callees:
 *     ?ResStrCmp@@YAHPEAU_UNICODE_STRING@@0@Z @ 0x1C0094884 (-ResStrCmp@@YAHPEAU_UNICODE_STRING@@0@Z.c)
 */
