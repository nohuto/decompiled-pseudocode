/*
 * XREFs of ?CalcVisRgnWorker@@YAHQEAUtagWND@@PEAPEAUHRGN__@@K@Z @ 0x1C00441B0
 * Callers:
 ...
 *     DpiRectContainsRectWithSubpixel @ 0x1C01E4CD4 (DpiRectContainsRectWithSubpixel.c)
    ...
    do
    {
      ...
      else
      {
        ...
        *(_OWORD *)v73 = *(_OWORD *)(v77 + 88);
        ...
        {
          v122 = *v72;
          if ( (unsigned int)IsDpiBoundaryBetweenWindows(v121, v122) )
          {
            v112 = v74 + 16 * v76;
...
LABEL_169:
        ...
        if ( (unsigned int)IsDpiBoundaryBetweenWindows(v5, v85) )
        {
          v115 = 0LL;
