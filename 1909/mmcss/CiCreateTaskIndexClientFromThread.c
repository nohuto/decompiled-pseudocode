/*
 * XREFs of CiCreateTaskIndexClientFromThread @ 0x1C000B1F0
 * Callers:
 ...
 *     CiThreadReferenceTaskIndex @ 0x1C00028E0 (CiThreadReferenceTaskIndex.c)
...
__int64 __fastcall CiCreateTaskIndexClientFromThread(__int64 a1, _DWORD *a2)
{
  ...
  struct _IO_STATUS_BLOCK IoStatusBlock; // [rsp+98h] [rbp-190h] BYREF
  _OBJECT_ATTRIBUTES ObjectAttributes; // [rsp+A8h] [rbp-180h] BYREF
