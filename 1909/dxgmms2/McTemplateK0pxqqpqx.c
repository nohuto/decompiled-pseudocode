/*
 * XREFs of McTemplateK0pxqqpqx @ 0x1C002D810
 * Callers:
...
ULONG McTemplateK0pxqqpqx(__int64 a1, __int64 a2, const GUID *a3, ...)
{
  ...
  v16 = 4LL;
  v18 = 8LL;
  return McGenEventWrite((PMCGEN_TRACE_CONTEXT)&DxgkControlGuid_Context, &EventCancelFlip, a3, 8u, &EventData);
}
