/*
 * XREFs of ?EndCPUAccess@VIDMM_GLOBAL@@QEAAJPEAU_VIDMM_MULTI_ALLOC@@KKPEAU_VIDMM_REGION@@@Z @ 0x1C0081A14
 * Callers:
 *     VidMmEndCPUAccess @ 0x1C0014700 (VidMmEndCPUAccess.c)
 * Callees:
