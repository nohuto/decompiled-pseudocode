/*
 * XREFs of ?HandlePromotionCandidates@VIDMM_GLOBAL@@QEAAXPEA_N@Z @ 0x1C007E330
 * Callers:
 ...
 *     ?GetLargestGap@VIDMM_SEGMENT@@QEAA_KPEAU_VIDMM_GLOBAL_ALLOC@@W4_VIDMM_PLACEMENT_RESTRICTION@@E@Z @ 0x1C00BF920 (-GetLargestGap@VIDMM_SEGMENT@@QEAA_KPEAU_VIDMM_GLOBAL_ALLOC@@W4_VIDMM_PLACEMENT_RESTRICTION@@E@Z.c)
 */
  ...
  if ( !(unsigned __int8)ExTryAcquirePushLockSharedEx((char *)this + 40968, 0LL) )
  {
    if ( bTracingEnabled )
    {
      ...
      if ( v8 != -1 && (Microsoft_Windows_DxgKrnlEnableBits & 0x40) != 0 )
        McTemplateK0q(v4, (const EVENT_DESCRIPTOR *)"g", v5, v8);
    }
  ...
  *a2 = 1;
  ...
  else
  {
    ...
    *((_QWORD *)this + 5171) = v15;
    if ( v15 > qword_1C004E3E0 )
      *((_QWORD *)this + 5171) = qword_1C004E3E0;
  }
  v61 = 0;
  v49 = 0LL;
...
LABEL_80:
                          ...
                          if ( *(_DWORD *)(v37 + 376) < 0xA0000000 )
                            goto LABEL_80;
LABEL_63:
                          if ( (*(_DWORD *)(v37 + 80) & 0x10000) != 0 && *(_DWORD *)(v37 + 344) )
                            goto LABEL_80;
                          v39 = v61;
                          v40 = v49;
                          if ( v61
                            && (v49 + *(_QWORD *)(v37 + 16) > (unsigned __int64)qword_1C004E3E8 || v61 > dword_1C004E3F0) )
                          {
                            goto LABEL_91;
                          }
