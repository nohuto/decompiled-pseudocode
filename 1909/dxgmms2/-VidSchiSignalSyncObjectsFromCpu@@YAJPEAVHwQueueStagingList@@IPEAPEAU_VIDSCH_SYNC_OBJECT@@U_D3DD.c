/*
 * XREFs of ?VidSchiSignalSyncObjectsFromCpu@@YAJPEAVHwQueueStagingList@@IPEAPEAU_VIDSCH_SYNC_OBJECT@@U_D3DDDICB_SIGNALFLAGS@@PEB_K@Z @ 0x1C0031E10
 * Callers:
...
LABEL_20:
  ...
  {
LABEL_38:
    VidSchiUnwaitMonitoredFences(v30, *((_QWORD *)*v7 + 1));
    return v5;
  }
  v9 = a5;
  v10 = (char *)a3 - a5;
