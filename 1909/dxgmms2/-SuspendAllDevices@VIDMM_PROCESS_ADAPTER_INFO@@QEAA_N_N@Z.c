/*
 * XREFs of ?SuspendAllDevices@VIDMM_PROCESS_ADAPTER_INFO@@QEAA_N_N@Z @ 0x1C00B4ADC
 * Callers:
 ...
 *     ?IsResumedRecently@VIDMM_DEVICE@@QEBA_NXZ @ 0x1C00B45F4 (-IsResumedRecently@VIDMM_DEVICE@@QEBA_NXZ.c)
 */
