/*
 * XREFs of ?PinAllocation@VIDMM_GLOBAL@@QEAAJPEAU_VIDMM_MULTI_ALLOC@@PEAKPEAT_LARGE_INTEGER@@@Z @ 0x1C0085844
 * Callers:
 *     VidMmPinAllocation @ 0x1C0016FF0 (VidMmPinAllocation.c)
 * Callees:
