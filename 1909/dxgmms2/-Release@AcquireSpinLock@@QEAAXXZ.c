/*
 * XREFs of ?Release@AcquireSpinLock@@QEAAXXZ @ 0x1C00113C4
 * Callers:
 ...
 *     ??$VidSchRundownUnorderedWaiter@U_VIDSCH_CONTEXT@@@@YAJPEAU_VIDSCH_CONTEXT@@PEAU_VIDSCH_GLOBAL@@W4_VIDSCH_FLUSH_STAGE@@_NP6AXPEAVHwQueueStagingList@@0@Z@Z @ 0x1C0011300 (--$VidSchRundownUnorderedWaiter@U_VIDSCH_CONTEXT@@@@YAJPEAU_VIDSCH_CONTEXT@@PEAU_VIDSCH_GLOBAL@@.c)
 *     VidSchConfirmToken @ 0x1C0015FD0 (VidSchConfirmToken.c)
 *     VidSchExitIndependentFlip @ 0x1C00160E0 (VidSchExitIndependentFlip.c)
 *     VidSchTimeoutSyncObject @ 0x1C0016F6C (VidSchTimeoutSyncObject.c)
