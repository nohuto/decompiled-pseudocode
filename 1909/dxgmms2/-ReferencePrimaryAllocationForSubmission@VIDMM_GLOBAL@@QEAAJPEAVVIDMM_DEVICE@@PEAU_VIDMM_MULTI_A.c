/*
 * XREFs of ?ReferencePrimaryAllocationForSubmission@VIDMM_GLOBAL@@QEAAJPEAVVIDMM_DEVICE@@PEAU_VIDMM_MULTI_ALLOC@@PEAPEAUVIDMM_ALLOC@@@Z @ 0x1C007FA74
 * Callers:
 *     VidMmReferencePrimaryAllocationForSubmission @ 0x1C0013740 (VidMmReferencePrimaryAllocationForSubmission.c)
 * Callees:
 *     <none>
 */
