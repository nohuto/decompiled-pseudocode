/*
 * XREFs of ?SetWorkingSetInformation@VIDMM_PROCESS@@QEAAJPEAU_D3DKMT_WORKINGSETINFO@@@Z @ 0x1C00B5840
 * Callers:
 *     VidMmSetWorkingSetInformation @ 0x1C0024C90 (VidMmSetWorkingSetInformation.c)
 * Callees:
