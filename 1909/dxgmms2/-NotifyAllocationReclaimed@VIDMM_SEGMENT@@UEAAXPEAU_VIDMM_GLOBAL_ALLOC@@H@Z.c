/*
 * XREFs of ?NotifyAllocationReclaimed@VIDMM_SEGMENT@@UEAAXPEAU_VIDMM_GLOBAL_ALLOC@@H@Z @ 0x1C00C04F0
 * Callers:
 *     <none>
 * Callees:
  ...
  if ( (_DWORD)a3 )
  {
    ...
    *((_QWORD *)this + 28) = v8;
    ...
    if ( *((_DWORD *)this + 92) != -1 && (*((_DWORD *)a2 + 19) & 0x200) == 0 )
    {
      ...
      v14 = v12 - v11;
      *((_QWORD *)this + 29) = v14;
      if ( v10 > qword_1C004E408 && v14 <= qword_1C004E408 )
      {
        (*(void (__fastcall **)(_QWORD, _QWORD))(*((_QWORD *)this + 1) + 40064LL))(
          *(_QWORD *)(*((_QWORD *)this + 1) + 40112LL),
