/*
 * XREFs of McTemplateK0pqqxqqtppx @ 0x1C002D2A4
 * Callers:
...
ULONG McTemplateK0pqqxqqtppx(__int64 a1, __int64 a2, const GUID *a3, ...)
{
  ...
  v22 = 8LL;
  v24 = 8LL;
  return McGenEventWrite((PMCGEN_TRACE_CONTEXT)&DxgkControlGuid_Context, &EventQueueSubmit, a3, 0xBu, &EventData);
}
