/*
 * XREFs of ?OpenOneAllocation@VIDMM_GLOBAL@@QEAAJPEAVVIDMM_DEVICE@@PEAU_VIDMM_GLOBAL_ALLOC@@PEAXHPEAVDXGALLOCATION@@PEAPEAUVIDMM_ALLOC@@PEAE@Z @ 0x1C00746E0
 * Callers:
...
LABEL_116:
    _InterlockedIncrement(&dword_1C004E5C8);
    v88 = WdLogNewEntry5_WdLowResource(v16);
    *(_QWORD *)(v88 + 24) = 4019LL;
...
LABEL_103:
  ...
  *(_DWORD *)(v43 + 24) = v47;
  ...
  if ( (**((_DWORD **)a3 + 63) & 0x40000000) != 0 )
  {
    ...
    if ( v56 < 0 )
    {
      _InterlockedIncrement(&dword_1C004E64C);
