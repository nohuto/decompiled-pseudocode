/*
 * XREFs of ?Defragment@VIDMM_GLOBAL@@QEAAXPEAVVIDMM_SEGMENT@@@Z @ 0x1C00AAE6C
 * Callers:
...
void __fastcall VIDMM_GLOBAL::Defragment(VIDMM_GLOBAL *this, struct VIDMM_SEGMENT *a2)
{
  ...
  *((_QWORD *)a2 + 60) = v4;
  ...
  else
  {
    ...
    v7 = *((_QWORD *)this + 3);
    v8 = 352 * v6;
    v9 = *(unsigned int *)(352 * v6 + *(_QWORD *)(v7 + 2440) + 16);
    if ( (v9 & 4) != 0
      && (LOBYTE(v8) = (*(_BYTE *)(v7 + 1908) & 8) != 0,
    ...
    else
    {
      ...
      *(_QWORD *)(v12 + 24) = a2;
      ...
      while ( v13 != (struct VIDMM_SEGMENT *)((char *)a2 + 136) )
      {
        ...
        if ( !(unsigned __int8)PsIsSystemProcess(**v14) && !*(_BYTE *)((*v14)[4] + 296LL) )
        {
          v15 = v14 + 5;
          v16 = (_QWORD *)*v15;
          while ( v16 != v15 )
