/*
 * XREFs of ?CleanupFreeBlock@VIDMM_RECYCLE_BLOCK@@QEAA_NPEAVVIDMM_RECYCLE_RANGE@@@Z @ 0x1C00698D8
 * Callers:
...
char __fastcall VIDMM_RECYCLE_BLOCK::CleanupFreeBlock(VIDMM_RECYCLE_BLOCK *this, struct VIDMM_RECYCLE_RANGE *a2)
{
  ...
  if ( v5 )
  {
    VIDMM_RECYCLE_HEAP::RemoveMultirangeFromTree(v6, 2LL, (__int64)v5);
