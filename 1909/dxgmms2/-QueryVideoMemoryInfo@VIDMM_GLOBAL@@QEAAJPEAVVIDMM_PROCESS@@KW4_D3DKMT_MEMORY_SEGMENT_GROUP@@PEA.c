/*
 * XREFs of ?QueryVideoMemoryInfo@VIDMM_GLOBAL@@QEAAJPEAVVIDMM_PROCESS@@KW4_D3DKMT_MEMORY_SEGMENT_GROUP@@PEA_K222@Z @ 0x1C00AE844
 * Callers:
 *     VidMmQueryVideoMemoryInfo @ 0x1C0024B30 (VidMmQueryVideoMemoryInfo.c)
 * Callees:
