/*
 * XREFs of ?ResizeBuffersInPool@VIDMM_DMA_POOL@@QEAAJ_KII@Z @ 0x1C00B6148
 * Callers:
 *     VidMmResizeBuffersInPool @ 0x1C0024C10 (VidMmResizeBuffersInPool.c)
 * Callees:
