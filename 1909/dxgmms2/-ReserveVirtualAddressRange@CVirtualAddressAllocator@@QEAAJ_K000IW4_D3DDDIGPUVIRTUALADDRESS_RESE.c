/*
 * XREFs of ?ReserveVirtualAddressRange@CVirtualAddressAllocator@@QEAAJ_K000IW4_D3DDDIGPUVIRTUALADDRESS_RESERVATION_TYPE@@_KEPEA_KPEAPEAUVIDMM_MAPPED_VA_RANGE@@E@Z @ 0x1C005ED74
 * Callers:
        ...
        unsigned __int8 a12)
{
  ...
  if ( a12 && (*(_DWORD *)(*((_QWORD *)this + 11) + 88LL) & 2) != 0 )
    v12 = *(_BYTE *)(*((_QWORD *)this + 10) + 40137LL) != 0 ? a12 : 0;
  v33 = 0LL;
  v17 = a11;
  if ( a11 )
    *a11 = 0LL;
