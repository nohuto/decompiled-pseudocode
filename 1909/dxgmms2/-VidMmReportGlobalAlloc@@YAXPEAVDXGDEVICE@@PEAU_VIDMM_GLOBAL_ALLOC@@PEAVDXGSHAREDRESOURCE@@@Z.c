/*
 * XREFs of ?VidMmReportGlobalAlloc@@YAXPEAVDXGDEVICE@@PEAU_VIDMM_GLOBAL_ALLOC@@PEAVDXGSHAREDRESOURCE@@@Z @ 0x1C00B6E44
 * Callers:
 *     VidMmReportContextAllocList @ 0x1C00B7370 (VidMmReportContextAllocList.c)
 *     VidMmReportMultiGlobalAlloc @ 0x1C00B75A0 (VidMmReportMultiGlobalAlloc.c)
 * Callees:
...
void __fastcall VidMmReportGlobalAlloc(struct DXGDEVICE *a1, struct _VIDMM_GLOBAL_ALLOC *a2, const GUID *a3)
{
  ...
  {
    LOBYTE(v18) = *((_BYTE *)a2 + 432);
    LOBYTE(v17) = *(_BYTE *)(v3 + 4);
    McTemplateK0puu((__int64)a1, &EventReportOfferAllocation, a3, a2, v17, v18);
  }
}
