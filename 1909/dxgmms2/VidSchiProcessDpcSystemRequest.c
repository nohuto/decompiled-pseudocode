/*
 * XREFs of VidSchiProcessDpcSystemRequest @ 0x1C0011D0C
 * Callers:
 ...
 *     ?VidSchiStopExecutionTimeAtThisPriority@@YAXPEAU_VIDSCH_NODE@@K_K1@Z @ 0x1C001229C (-VidSchiStopExecutionTimeAtThisPriority@@YAXPEAU_VIDSCH_NODE@@K_K1@Z.c)
