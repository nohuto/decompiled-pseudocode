/*
 * XREFs of McTemplateK0pqqttp @ 0x1C002CF5C
 * Callers:
...
ULONG McTemplateK0pqqttp(_DWORD a1, _DWORD a2, _DWORD a3, __int64 a4, char a5, char a6, ...)
{
  ...
  v18 = 4LL;
  v20 = 8LL;
  return McGenEventWrite((PMCGEN_TRACE_CONTEXT)&DxgkControlGuid_Context, &EventQueueComplete, 0LL, 7u, &EventData);
}
