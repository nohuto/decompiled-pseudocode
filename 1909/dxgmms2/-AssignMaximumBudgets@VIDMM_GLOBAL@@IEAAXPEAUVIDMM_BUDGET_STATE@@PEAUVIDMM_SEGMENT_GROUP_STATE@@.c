/*
 * XREFs of ?AssignMaximumBudgets@VIDMM_GLOBAL@@IEAAXPEAUVIDMM_BUDGET_STATE@@PEAUVIDMM_SEGMENT_GROUP_STATE@@@Z @ 0x1C00C363C
 * Callers:
...
{
  _DWORD *v4; // r15
  struct VIDMM_SEGMENT_GROUP_STATE **v6; // rdi
  VIDMM_GLOBAL *v7; // r10
  int i; // ebp
  __int64 v9; // rcx
  _QWORD *v10; // rdx
  ...
  v4 = (_DWORD *)((char *)a3 + 308);
  v6 = (struct VIDMM_SEGMENT_GROUP_STATE **)((char *)a3 + 184);
  v7 = this;
  for ( i = 0; i < 3; ++i )
  {
    v9 = 3LL;
    v10 = (_QWORD *)((char *)a3 + 16 * i + 8 * i + 40);
    do
    {
      *v10++ = *((_QWORD *)a3 + 3);
      --v9;
    ...
    {
      v11 = *(v6 - 7);
      while ( v11 != (struct VIDMM_SEGMENT_GROUP_STATE *)((char *)a3 + 16 * i + 128) )
      {
        v12 = (struct VIDMM_SEGMENT_GROUP_STATE *)((char *)v11 - 400);
        v13 = v11;
