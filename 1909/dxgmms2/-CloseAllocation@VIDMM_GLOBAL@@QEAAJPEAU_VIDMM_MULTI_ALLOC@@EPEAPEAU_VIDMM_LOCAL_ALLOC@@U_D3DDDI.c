/*
 * XREFs of ?CloseAllocation@VIDMM_GLOBAL@@QEAAJPEAU_VIDMM_MULTI_ALLOC@@EPEAPEAU_VIDMM_LOCAL_ALLOC@@U_D3DDDICB_DESTROYALLOCATION2FLAGS@@PEAPEAU_KEVENT@@@Z @ 0x1C0070F04
 * Callers:
 *     VidMmCloseAllocation @ 0x1C0002970 (VidMmCloseAllocation.c)
 *     VidMmTryCloseAllocation @ 0x1C0014930 (VidMmTryCloseAllocation.c)
 * Callees:
      ...
      if ( !(unsigned __int8)ExTryAcquirePushLockExclusiveEx((char *)Current + 136, 0LL) )
      {
        if ( bTracingEnabled )
        {
          ...
          if ( v16 != -1 && (Microsoft_Windows_DxgKrnlEnableBits & 0x40) != 0 )
            McTemplateK0q(v11, (const EVENT_DESCRIPTOR *)"g", v12, v16);
        }
