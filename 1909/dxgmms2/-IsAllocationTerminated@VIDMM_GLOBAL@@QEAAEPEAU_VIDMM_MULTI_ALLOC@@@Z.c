/*
 * XREFs of ?IsAllocationTerminated@VIDMM_GLOBAL@@QEAAEPEAU_VIDMM_MULTI_ALLOC@@@Z @ 0x1C00ACE80
 * Callers:
 *     VidMmIsAllocationTerminated @ 0x1C0024A80 (VidMmIsAllocationTerminated.c)
 * Callees:
