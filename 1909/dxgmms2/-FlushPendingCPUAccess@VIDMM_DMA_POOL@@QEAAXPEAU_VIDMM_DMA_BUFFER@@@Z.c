/*
 * XREFs of ?FlushPendingCPUAccess@VIDMM_DMA_POOL@@QEAAXPEAU_VIDMM_DMA_BUFFER@@@Z @ 0x1C00B5B78
 * Callers:
...
{
  if ( *((_DWORD *)this + 9) )
    (*(void (__fastcall **)(_QWORD))(**(_QWORD **)(*((_QWORD *)a2 + 7) + 136LL) + 56LL))(*(_QWORD *)(*((_QWORD *)a2 + 7) + 136LL));
}
