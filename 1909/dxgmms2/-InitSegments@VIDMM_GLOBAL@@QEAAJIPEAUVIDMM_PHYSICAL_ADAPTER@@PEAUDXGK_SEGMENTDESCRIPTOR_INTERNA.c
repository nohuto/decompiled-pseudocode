/*
 * XREFs of ?InitSegments@VIDMM_GLOBAL@@QEAAJIPEAUVIDMM_PHYSICAL_ADAPTER@@PEAUDXGK_SEGMENTDESCRIPTOR_INTERNAL@@PEA_K@Z @ 0x1C0090634
 * Callers:
 ...
 *     ?InitializeSegmentGroupState@VIDMM_GLOBAL@@QEAAXIPEAUVIDMM_SEGMENT_GROUP_STATE@@_K@Z @ 0x1C00902B0 (-InitializeSegmentGroupState@VIDMM_GLOBAL@@QEAAXIPEAUVIDMM_SEGMENT_GROUP_STATE@@_K@Z.c)
 ...
 *     ?SetVprRange@VIDMM_SEGMENT@@QEAAJ_K0II0@Z @ 0x1C00C1A80 (-SetVprRange@VIDMM_SEGMENT@@QEAAJ_K0II0@Z.c)
 */
      ...
      *(_QWORD *)&DestinationString.Length = (char *)a4 + 104;
      if ( (v11 & 3) != 0 && v10 == *((unsigned __int16 *)a3 + 14) )
      {
        ...
        *(_QWORD *)(*((_QWORD *)this + 464) + 8LL * v10) = v32;
        ...
        {
          _InterlockedAdd(&dword_1C004E67C, 1u);
          goto LABEL_91;
        }
      }
      else
      {
        ...
        else
        {
          ...
          *(_QWORD *)(v43 + *((_QWORD *)this + 464)) = v51;
          ...
          {
            _InterlockedAdd(&dword_1C004E658, 1u);
LABEL_91:
...
LABEL_93:
  ...
  for ( i = 0; i < *((_DWORD *)a3 + 6); ++i )
  {
    ...
    *(_QWORD *)(v19 + 48) = v21;
    ...
    if ( v22 < 0 )
    {
      _InterlockedAdd(&dword_1C004E680, 1u);
