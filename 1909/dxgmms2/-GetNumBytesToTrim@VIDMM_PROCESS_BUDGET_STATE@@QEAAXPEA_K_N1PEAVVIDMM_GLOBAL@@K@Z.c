/*
 * XREFs of ?GetNumBytesToTrim@VIDMM_PROCESS_BUDGET_STATE@@QEAAXPEA_K_N1PEAVVIDMM_GLOBAL@@K@Z @ 0x1C0063AD8
 * Callers:
  ...
  do
  {
    if ( a3 )
      v14 = *((_QWORD *)VIDMM_GLOBAL::GetSegmentGroupState(
                          ...
                          a6,
                          v7,
                          *(struct VIDMM_PARTITION **)(*(_QWORD *)(*((_QWORD *)this + 2) + 40LL) + 264LL))
            + 2);
    else
