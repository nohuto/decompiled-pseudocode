/*
 * XREFs of ??1VIDMM_DMA_POOL@@QEAA@XZ @ 0x1C0084260
 * Callers:
 *     ??_GVIDMM_DMA_POOL@@QEAAPEAXI@Z @ 0x1C0016BCC (--_GVIDMM_DMA_POOL@@QEAAPEAXI@Z.c)
 * Callees:
 *     ?LockAllPoolForAddRemove@VIDMM_DMA_POOL@@KAXE@Z @ 0x1C005CC0C (-LockAllPoolForAddRemove@VIDMM_DMA_POOL@@KAXE@Z.c)
 ...
 *     ?UpdateFairResourceUsage@VIDMM_DMA_POOL@@IEAAXXZ @ 0x1C00867FC (-UpdateFairResourceUsage@VIDMM_DMA_POOL@@IEAAXXZ.c)
 */
