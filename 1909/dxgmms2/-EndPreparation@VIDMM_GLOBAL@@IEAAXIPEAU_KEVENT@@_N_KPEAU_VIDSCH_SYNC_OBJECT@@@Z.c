/*
 * XREFs of ?EndPreparation@VIDMM_GLOBAL@@IEAAXIPEAU_KEVENT@@_N_KPEAU_VIDSCH_SYNC_OBJECT@@@Z @ 0x1C005E960
 * Callers:
 *     ?TryPageInDevice@VIDMM_GLOBAL@@QEAAJPEAVVIDMM_DEVICE@@_NPEA_NPEAPEAUVIDMM_ALLOC@@@Z @ 0x1C005CF64 (-TryPageInDevice@VIDMM_GLOBAL@@QEAAJPEAVVIDMM_DEVICE@@_NPEA_NPEAPEAUVIDMM_ALLOC@@@Z.c)
 ...
 *     ?PrepareMoveResources@VIDMM_GLOBAL@@QEAAJPEAUVIDMM_ALLOC@@W4VIDMM_MOVE_RESOURCES_OPERATION@@I_KW4VIDMM_MOVE_RESOURCES_DEFRAG_STAGE@@22W4VIDMM_DEFRAGMENT_DIRECTION@@PEA_NPEAPEAU_VIDMM_GLOBAL_ALLOC@@@Z @ 0x1C00AE19C (-PrepareMoveResources@VIDMM_GLOBAL@@QEAAJPEAUVIDMM_ALLOC@@W4VIDMM_MOVE_RESOURCES_OPERATION@@I_KW.c)
 * Callees:
        ...
        struct _VIDSCH_SYNC_OBJECT *a6)
{
  ...
  *((_QWORD *)this + 465) = (char *)this + 3720;
  ...
  if ( a2 == -1 )
  {
    if ( *((_DWORD *)this + 1748) )
    {
      do
      {
        v12 = 0;
        v13 = 1560LL * v8;
        if ( *(_DWORD *)(*((_QWORD *)this + 5023) + v13 + 24) )
        {
          do
          {
            v14 = *(_QWORD *)(*((_QWORD *)this + 464) + 8LL * (v12 + *(_DWORD *)(*((_QWORD *)this + 5023) + v13 + 20)));
            (*(void (__fastcall **)(__int64))(*(_QWORD *)v14 + 160LL))(v14);
            ++v12;
          }
          while ( v12 < *(_DWORD *)(*((_QWORD *)this + 5023) + v13 + 24) );
        }
        VIDMM_GLOBAL::EndPreparationOnPhysicalAdapter(this, v8++);
      }
      while ( v8 < *((_DWORD *)this + 1748) );
    }
  }
  else
  {
    v16 = 1560LL * a2;
    v17 = v16 + *((_QWORD *)this + 5023);
    if ( *(_DWORD *)(v17 + 24) )
    {
      do
      {
  ...
  {
    VidSchSignalPagingFences(*(_QWORD *)(*((_QWORD *)this + 2) + 528LL), &a6, &a5);
    if ( a2 == -1 )
    {
