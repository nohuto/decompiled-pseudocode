/*
 * XREFs of ?Lock@VIDMM_RECYCLE_MULTIRANGE@@QEAAJPEAU_VIDMM_GLOBAL_ALLOC@@_K1W4_LOCK_OPERATION@@PEAVVIDMM_SEGMENT@@E@Z @ 0x1C00666DC
 * Callers:
        ...
        unsigned __int8 a7)
{
  ...
  this[28] = (struct VIDMM_RECYCLE_RANGE *)*((_QWORD *)a2 + 13);
