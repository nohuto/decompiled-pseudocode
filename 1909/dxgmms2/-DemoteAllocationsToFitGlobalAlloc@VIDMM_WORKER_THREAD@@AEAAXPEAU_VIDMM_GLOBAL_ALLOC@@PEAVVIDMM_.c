/*
 * XREFs of ?DemoteAllocationsToFitGlobalAlloc@VIDMM_WORKER_THREAD@@AEAAXPEAU_VIDMM_GLOBAL_ALLOC@@PEAVVIDMM_DEVICE@@AEBUVIDMM_PAGE_IN_POLICY_PER_COMBINATION@@W4VIDMM_BUDGET_PRIORITY_BAND@@PEA_N@Z @ 0x1C00B38F8
 * Callers:
 ...
 *     ?FaultAllDemotableAllocations@VIDMM_DEVICE@@QEAAXPEAV1@IW4_VIDMM_PLACEMENT_RESTRICTION@@IPEAIPEA_KPEA_N@Z @ 0x1C00B2F5C (-FaultAllDemotableAllocations@VIDMM_DEVICE@@QEAAXPEAV1@IW4_VIDMM_PLACEMENT_RESTRICTION@@IPEAIPEA.c)
 *     ?CanSuspendThisDevice@VIDMM_DEVICE@@QEAA_NPEAV1@W4VIDMM_SUSPEND_CANDIDATE_PASS@@W4VIDMM_BUDGET_PRIORITY_BAND@@@Z @ 0x1C00B3880 (-CanSuspendThisDevice@VIDMM_DEVICE@@QEAA_NPEAV1@W4VIDMM_SUSPEND_CANDIDATE_PASS@@W4VIDMM_BUDGET_P.c)
...
char VIDMM_WORKER_THREAD::DemoteAllocationsToFitGlobalAlloc(__int64 *a1, __int64 a2, VIDMM_DEVICE *a3, ...)
{
  ...
  *v69 = 0;
  ...
  do
  {
    ...
    v49 &= ~(1 << v11);
    v57 = v11 + *(_DWORD *)(1560 * (v13 & 0x3F) + *(_QWORD *)(*v4 + 40184) + 20);
    v7 = *(_QWORD *)(v12 + 3712);
    v62 = v57;
...
LABEL_91:
      ...
      if ( (VIDMM_GLOBAL::_Config & 0x40) == 0
        || (_DWORD)v68 == 2
        || *(_DWORD *)(a2 + 376) < 0xA0000000 && (LODWORD(v7) = *(_DWORD *)(a2 + 76), (v7 & 0x40) != 0)
