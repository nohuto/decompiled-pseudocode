/*
 * XREFs of ?CombineFreedRanges@VIDMM_RECYCLE_BLOCK@@QEAAXPEAVVIDMM_RECYCLE_RANGE@@00@Z @ 0x1C00BA9D8
 * Callers:
        ...
        struct VIDMM_RECYCLE_RANGE *a4)
{
  ...
  v8 = (struct _SLIST_ENTRY *)*((_QWORD *)a4 + 17);
  NextRange = a2;
  v10 = 0;
  do
  {
    v11 = *(_QWORD *)(*((_QWORD *)NextRange + 9) + 32LL);
    if ( *((_DWORD *)NextRange + 21) == 2 )
    {
    ...
    else
    {
      ...
      if ( !v8 )
        v8 = (struct _SLIST_ENTRY *)*((_QWORD *)NextRange + 17);
    }
    if ( NextRange == a3 )
      v10 = 1;
    else
  ...
  while ( !v10 );
  v13 = (struct _SLIST_ENTRY *)*((_QWORD *)a2 + 4);
  v14 = *((_QWORD *)a3 + 5);
  ...
  *((_QWORD *)a4 + 5) = v14;
  ...
  do
  {
    ...
    v21 = (struct _SLIST_ENTRY *)*((_QWORD *)a2 + 17);
    v23 = v19;
    if ( v21 && v21 != v8 )
