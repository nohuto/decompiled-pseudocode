/*
 * XREFs of VidSchiCancelIndependentFlips @ 0x1C0016B40
 * Callers:
  ...
  if ( a4 )
  {
    ...
    if ( v8 )
    {
      v9 = *(_QWORD *)(*(_QWORD *)(*(_QWORD *)(*(_QWORD *)(*(_QWORD *)(v7 + 16) + 40LL) + 24LL)
                     ...
                     + 8 * v6
                     + 88);
      _InterlockedExchangeAdd((volatile signed __int32 *)(*(_QWORD *)(a2 + 8 * v6 + 5792) + 8LL), -v8);
      *(_DWORD *)(*(_QWORD *)(a2 + 8 * v6 + 5792) + 4LL) += v8;
      *(_DWORD *)(v9 + 4) += v8;
    }
  }
}
