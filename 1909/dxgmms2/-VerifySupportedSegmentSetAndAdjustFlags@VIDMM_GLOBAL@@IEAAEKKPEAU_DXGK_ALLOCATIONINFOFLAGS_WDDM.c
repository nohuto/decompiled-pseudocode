/*
 * XREFs of ?VerifySupportedSegmentSetAndAdjustFlags@VIDMM_GLOBAL@@IEAAEKKPEAU_DXGK_ALLOCATIONINFOFLAGS_WDDM2_0@@_K1_NPEAU_VIDMM_VERIFY_SUPPORTED_SEGMENT@@@Z @ 0x1C00704F8
 * Callers:
    ...
    do
    {
      ...
      if ( (v37 & 1) != 0 )
      {
        ...
        if ( a5 > *(_QWORD *)(v40 + 392) )
        {
          ...
          *(_QWORD *)(v42 + 24) = 11967LL;
          goto LABEL_42;
        }
        if ( (*(_DWORD *)(v40 + 80) & 0x20) != 0 )
        {
          v42 = WdLogNewEntry5_WdAssertion(v38, v37);
          *(_QWORD *)(v42 + 24) = 11972LL;
          goto LABEL_42;
        }
      }
...
LABEL_21:
  ...
  else
  {
    ...
    if ( !a6 )
    {
      ...
      *(_QWORD *)(v42 + 24) = 11994LL;
      goto LABEL_42;
    }
    if ( a6 < a5 )
    {
      v42 = WdLogNewEntry5_WdAssertion(v28, v25);
      *(_QWORD *)(v42 + 24) = 12000LL;
      goto LABEL_42;
    }
    v29 = a8;
    *(_DWORD *)a8 |= 4u;
  ...
  if ( (Value & 0x100000) == 0 || v20 )
  {
    if ( (Value & 0x4000) == 0 || v20 )
    {
      ...
      v42 = WdLogNewEntry5_WdAssertion(536870913LL, Value);
      *(_QWORD *)(v42 + 24) = 12074LL;
    }
    else
    {
      v42 = WdLogNewEntry5_WdAssertion(536870913LL, Value);
      *(_QWORD *)(v42 + 24) = 12062LL;
    }
  }
  else
  {
    v42 = WdLogNewEntry5_WdAssertion(536870913LL, Value);
    *(_QWORD *)(v42 + 24) = 12055LL;
  }
LABEL_42:
