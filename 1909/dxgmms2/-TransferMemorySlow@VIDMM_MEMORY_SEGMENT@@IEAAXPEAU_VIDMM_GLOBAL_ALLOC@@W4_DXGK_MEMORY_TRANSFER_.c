/*
 * XREFs of ?TransferMemorySlow@VIDMM_MEMORY_SEGMENT@@IEAAXPEAU_VIDMM_GLOBAL_ALLOC@@W4_DXGK_MEMORY_TRANSFER_DIRECTION@@PEAVVIDMM_SEGMENT@@T_LARGE_INTEGER@@@Z @ 0x1C00BE4B8
 * Callers:
        ...
        union _LARGE_INTEGER a5)
{
  ...
  v31 = a4;
  v5 = 1560LL * *((unsigned int *)this + 95);
  v6 = *((_QWORD *)this + 1);
  v8 = *((_QWORD *)a2 + 1);
  v29 = 0;
  v10 = v8 >> 1;
  v12 = 0LL;
  v30 = *(_BYTE *)(v5 + *(_QWORD *)(v6 + 40184) + 436);
  v28 = 0LL;
