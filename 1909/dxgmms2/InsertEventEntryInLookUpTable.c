/*
 * XREFs of InsertEventEntryInLookUpTable @ 0x1C003B44C
 * Callers:
 *     VidSchiMarkDeviceAsError @ 0x1C00010A0 (VidSchiMarkDeviceAsError.c)
 * Callees:
 *     RunningHash @ 0x1C0017B94 (RunningHash.c)
 *     memcmp @ 0x1C0018520 (memcmp.c)
...
__int64 __fastcall InsertEventEntryInLookUpTable(__int64 a1, __int128 *a2, char a3, __int64 a4, unsigned __int8 a5)
{
  ...
  v7 = a4;
  v8 = 0;
  RunningHash(&v40, a4 + 16, 8uLL);
  v9 = a5;
  v10 = a5 + 2;
  if ( (unsigned __int8)(a5 + 2) < 0xAu )
  {
    v11 = v7 + 16LL * v10;
    v12 = (unsigned __int8)(10 - v10);
    do
    {
