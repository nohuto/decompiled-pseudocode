/*
 * XREFs of VidSchiUpdateContextStatus @ 0x1C000A6F0
 * Callers:
 ...
 *     VidSchiFinishMeasuringPreemptionTime @ 0x1C001232C (VidSchiFinishMeasuringPreemptionTime.c)
 ...
 *     ?VidschiUnselectContext@@YAXPEAU_VIDSCH_CONTEXT@@@Z @ 0x1C0012E00 (-VidschiUnselectContext@@YAXPEAU_VIDSCH_CONTEXT@@@Z.c)
