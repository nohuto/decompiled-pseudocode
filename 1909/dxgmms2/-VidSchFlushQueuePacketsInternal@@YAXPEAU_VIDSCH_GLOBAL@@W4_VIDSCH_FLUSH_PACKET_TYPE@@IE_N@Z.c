/*
 * XREFs of ?VidSchFlushQueuePacketsInternal@@YAXPEAU_VIDSCH_GLOBAL@@W4_VIDSCH_FLUSH_PACKET_TYPE@@IE_N@Z @ 0x1C00178DC
 * Callers:
 *     VidSchFlushQueuePackets @ 0x1C00178C0 (VidSchFlushQueuePackets.c)
 *     VidSchFlushPresentReferencesAndDisableOverlays @ 0x1C00CB1F0 (VidSchFlushPresentReferencesAndDisableOverlays.c)
 * Callees:
 *     VidSchiSetFlipDevice @ 0x1C000381C (VidSchiSetFlipDevice.c)
 *     VidSchiAcceptsIncomingWork @ 0x1C00067B0 (VidSchiAcceptsIncomingWork.c)
