/*
 * XREFs of ?Unlock@VIDMM_GLOBAL@@QEAAJPEAU_VIDMM_MULTI_ALLOC@@@Z @ 0x1C0073EB0
 * Callers:
 *     ?VidMmUnlock@@YAJPEAVVIDMM_GLOBAL@@PEAU_VIDMM_MULTI_ALLOC@@@Z @ 0x1C0002AF0 (-VidMmUnlock@@YAJPEAVVIDMM_GLOBAL@@PEAU_VIDMM_MULTI_ALLOC@@@Z.c)
 * Callees:
...
__int64 __fastcall VIDMM_GLOBAL::Unlock(VIDMM_GLOBAL *this, __int64 **a2)
{
  ...
  if ( *((_DWORD *)v2 + 19) )
  {
    ...
    {
      _InterlockedDecrement((volatile signed __int32 *)(v5 + 344));
      if ( (*((_DWORD *)v2 + 19))-- == 1 )
      {
      ...
      if ( (Microsoft_Windows_DxgKrnlEnableBits & 0x40) != 0 )
        McTemplateK0p(v10, &EventUnlock2, v11, a2);
    }
    else
    {
      v16 = WdLogNewEntry5_WdAssertion(v10, v9);
      *(_QWORD *)(v16 + 24) = 22911LL;
