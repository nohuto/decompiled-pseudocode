/*
 * XREFs of VidSchiControlVSync @ 0x1C007B8A0
 * Callers:
 *     VidSchiControlVSyncThread @ 0x1C000FA40 (VidSchiControlVSyncThread.c)
 ...
 * Callees:
 *     ?DdiControlInterrupt@DXGADAPTER@@QEAAJW4_DXGK_INTERRUPT_TYPE@@E@Z @ 0x1C000FB54 (-DdiControlInterrupt@DXGADAPTER@@QEAAJW4_DXGK_INTERRUPT_TYPE@@E@Z.c)
    ...
    if ( (_BYTE)a2 )
    {
      ...
      if ( *(_DWORD *)(a1 + 40) )
      {
        do
        {
          ...
          {
            if ( *(_BYTE *)(a1 + 1756) )
              _InterlockedExchange((volatile __int32 *)(*(_QWORD *)(a1 + 8LL * (unsigned int)a2 + 2576) + 33224LL), 1);
            *(_QWORD *)(*(_QWORD *)(a1 + 8LL * (unsigned int)a2 + 2576) + 33232LL) = 0LL;
          }
          LODWORD(a2) = a2 + 1;
        }
