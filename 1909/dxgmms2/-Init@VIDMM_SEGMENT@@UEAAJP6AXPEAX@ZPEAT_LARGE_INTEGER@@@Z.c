/*
 * XREFs of ?Init@VIDMM_SEGMENT@@UEAAJP6AXPEAX@ZPEAT_LARGE_INTEGER@@@Z @ 0x1C008B9A0
 * Callers:
 *     ?Init@VIDMM_SYSMEM_SEGMENT@@UEAAJP6AXPEAX@ZPEAT_LARGE_INTEGER@@@Z @ 0x1C008B780 (-Init@VIDMM_SYSMEM_SEGMENT@@UEAAJP6AXPEAX@ZPEAT_LARGE_INTEGER@@@Z.c)
 *     ?Init@VIDMM_APERTURE_SEGMENT@@UEAAJP6AXPEAX@ZPEAT_LARGE_INTEGER@@@Z @ 0x1C008B830 (-Init@VIDMM_APERTURE_SEGMENT@@UEAAJP6AXPEAX@ZPEAT_LARGE_INTEGER@@@Z.c)
 ...
 *     ?ReportSegment@VIDMM_SEGMENT@@QEAAXXZ @ 0x1C008BB60 (-ReportSegment@VIDMM_SEGMENT@@QEAAXXZ.c)
 ...
 *     ??0VIDMM_LINEAR_POOL@@QEAA@XZ @ 0x1C008BD10 (--0VIDMM_LINEAR_POOL@@QEAA@XZ.c)
...
__int64 __fastcall VIDMM_SEGMENT::Init(PHYSICAL_ADDRESS *this, void (*a2)(void *), union _LARGE_INTEGER *a3)
{
  ...
  else
  {
    ...
    if ( !v6 )
    {
      _InterlockedIncrement(&dword_1C004E5E0);
    ...
    || (LOBYTE(a2) = 6, result = VIDMM_SEGMENT::BlockMemoryRanges(this, a2, 12LL), (int)result >= 0) )
  {
      ...
      || (LOBYTE(a2) = 7, result = VIDMM_SEGMENT::BlockMemoryRanges(this, a2, 18LL), (int)result >= 0) )
    {
      if ( a3 )
        ...
        QuadPart = *(_QWORD *)(*(_QWORD *)(this[1].QuadPart + 24) + 1848LL);
      ...
      if ( (int)v10 >= 0 )
      {
        ...
        if ( PagesForMdl )
        {
          v15 = (unsigned int)dword_1C004E184;
          this[30].QuadPart = (unsigned int)dword_1C004E184;
          if ( (_DWORD)v15 )
          {
            v24 = v15;
            v23 = 16 * v15;
        ...
        _InterlockedIncrement(&dword_1C004E678);
