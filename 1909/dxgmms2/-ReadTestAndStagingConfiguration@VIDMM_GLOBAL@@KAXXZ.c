/*
 * XREFs of ?ReadTestAndStagingConfiguration@VIDMM_GLOBAL@@KAXXZ @ 0x1C008DCDC
 * Callers:
...
void VIDMM_GLOBAL::ReadTestAndStagingConfiguration(void)
{
  ...
  _BYTE v84[56]; // [rsp+278h] [rbp+178h] BYREF
