/*
 * XREFs of VidSchEnterIndependentFlip @ 0x1C00161E0
 * Callers:
 *     <none>
 * Callees:
 *     ??0VIDSCH_INDEPENDENT_FLIP_VIDPNSOURCE_ITERATOR@@QEAA@PEAU_VIDSCH_INDEPENDENT_FLIP_STATE@@@Z @ 0x1C00168D0 (--0VIDSCH_INDEPENDENT_FLIP_VIDPNSOURCE_ITERATOR@@QEAA@PEAU_VIDSCH_INDEPENDENT_FLIP_STATE@@@Z.c)
  ...
  *a8 = 0LL;
  if ( *(_BYTE *)(a1 + 47) )
  {
    ...
    while ( 1 )
    {
      ...
      v21 = *(int *)(v11 + *(_QWORD *)(a1 + 8LL * v18 + 2576) + 172);
      if ( (int)v21 > -1 )
...
LABEL_58:
      ...
      while ( 1 )
      {
        ...
        *(_DWORD *)(*(_QWORD *)(a1 + 8LL * v14 + 2576) + v29 + 172) = v24;
    ...
    *(_QWORD *)(v16 + 88) = v32;
    ...
    while ( v34 )
    {
      v36 = 216LL * *(unsigned int *)(v54 + 4 * v35) + *(_QWORD *)(a1 + 8LL * v52 + 2576) + 136LL;
      v37 = *(_QWORD *)(v16 + 88);
