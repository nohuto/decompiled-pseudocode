/*
 * XREFs of ?InitializeSegmentGroupState@VIDMM_GLOBAL@@QEAAXIPEAUVIDMM_SEGMENT_GROUP_STATE@@_K@Z @ 0x1C00902B0
 * Callers:
        ...
        __int64 a4)
{
  ...
  *((_QWORD *)a3 + 1) = v13;
  *((_QWORD *)a3 + 2) = v13;
  v14 = (unsigned int)(100 - dword_1C004E3A4 - v11);
  v15 = 3LL;
  v16 = v10 * v14;
