/*
 * XREFs of ?VidMmiInit@@YAPEAVVIDMM_GLOBAL@@PEAVADAPTER_RENDER@@@Z @ 0x1C008F9E0
 * Callers:
 *     VidMmInitializeAdapter @ 0x1C0017BD0 (VidMmInitializeAdapter.c)
 * Callees:
...
LABEL_24:
  ...
  if ( v17 < 0 )
  {
    _InterlockedIncrement(&dword_1C004E620);
