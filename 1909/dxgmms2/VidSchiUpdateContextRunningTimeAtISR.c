/*
 * XREFs of VidSchiUpdateContextRunningTimeAtISR @ 0x1C000B900
 * Callers:
 *     VidSchiProcessIsrCompletedPacket @ 0x1C000B660 (VidSchiProcessIsrCompletedPacket.c)
 *     VidSchiUpdateNodeRunningTimeAtISR @ 0x1C000B880 (VidSchiUpdateNodeRunningTimeAtISR.c)
...
_BOOL8 __fastcall VidSchiUpdateContextRunningTimeAtISR(_QWORD *a1)
{
  ...
  *v15 += v12;
  LODWORD(v16) = _InterlockedExchangeAdd64(*(volatile signed __int64 **)(v5 + 5920), v12);
