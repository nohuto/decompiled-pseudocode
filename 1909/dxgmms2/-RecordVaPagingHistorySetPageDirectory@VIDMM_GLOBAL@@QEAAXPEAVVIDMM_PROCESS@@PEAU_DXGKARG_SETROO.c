/*
 * XREFs of ?RecordVaPagingHistorySetPageDirectory@VIDMM_GLOBAL@@QEAAXPEAVVIDMM_PROCESS@@PEAU_DXGKARG_SETROOTPAGETABLE@@PEAX@Z @ 0x1C00827D0
 * Callers:
  ...
  if ( *((_QWORD *)this + 5115) )
  {
    ...
    if ( v8 )
    {
      ...
      *((_QWORD *)this + 5118) = KeGetCurrentThread();
      v9 = *((unsigned int *)this + 10232);
      if ( (_DWORD)v9 == dword_1C004E32C )
      {
        *((_DWORD *)this + 10232) = 0;
        v9 = 0LL;
      }
      v10 = *(void **)(*((_QWORD *)this + 5115) + 24 * v9 + 16);
      if ( v10 )
        operator delete(v10);
