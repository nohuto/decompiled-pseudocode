/*
 * XREFs of ?MapRange@VIDMM_CPU_HOST_APERTURE@@QEAAJPEAU_VIDMM_GLOBAL_ALLOC@@@Z @ 0x1C0017004
 * Callers:
 ...
 *     ?CopyRangeToArray@VIDMM_CPU_HOST_APERTURE@@AEBAXPEAI_KPEBUVIDMM_CPU_HOST_APERTURE_RANGE@@@Z @ 0x1C001720C (-CopyRangeToArray@VIDMM_CPU_HOST_APERTURE@@AEBAXPEAI_KPEBUVIDMM_CPU_HOST_APERTURE_RANGE@@@Z.c)
...
__int64 __fastcall VIDMM_CPU_HOST_APERTURE::MapRange(VIDMM_CPU_HOST_APERTURE *this, struct _VIDMM_GLOBAL_ALLOC *a2)
{
  ...
  unsigned __int16 v32; // [rsp+38h] [rbp-28h]
  int v33; // [rsp+3Ah] [rbp-26h]
  __int16 v34; // [rsp+3Eh] [rbp-22h]
  unsigned __int64 v35; // [rsp+40h] [rbp-20h]
  PVOID v36; // [rsp+48h] [rbp-18h]
  _QWORD *v37; // [rsp+50h] [rbp-10h]
  PVOID v38; // [rsp+90h] [rbp+30h]
  ...
  if ( !is_mul_ok(v5, 4uLL) )
    v7 = -1LL;
  v38 = operator new[](v7, 0x36346956u, PagedPool);
  v10 = v38;
  if ( !v38 )
  {
