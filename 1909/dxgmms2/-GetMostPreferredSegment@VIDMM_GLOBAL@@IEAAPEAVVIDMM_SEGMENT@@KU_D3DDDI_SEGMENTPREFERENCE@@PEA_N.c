/*
 * XREFs of ?GetMostPreferredSegment@VIDMM_GLOBAL@@IEAAPEAVVIDMM_SEGMENT@@KU_D3DDDI_SEGMENTPREFERENCE@@PEA_N@Z @ 0x1C0070904
 * Callers:
    ...
    else
    {
      ...
      if ( v6 )
        return *(struct VIDMM_SEGMENT **)(*((_QWORD *)this + 464)
                                        + 8LL * (v6 + *(_DWORD *)(1560LL * a2 + *((_QWORD *)this + 5023) + 20) - 1));
    }
  }
