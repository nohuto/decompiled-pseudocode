/*
 * XREFs of VidSchiIsQuantumLeft @ 0x1C0012BB0
 * Callers:
 ...
 * Callees:
 *     ?VidSchiSelectContextFromThisProcess@@YAXPEAU_VIDSCH_CONTEXT@@PEAPEAU1@@Z @ 0x1C0012CB4 (-VidSchiSelectContextFromThisProcess@@YAXPEAU_VIDSCH_CONTEXT@@PEAPEAU1@@Z.c)
