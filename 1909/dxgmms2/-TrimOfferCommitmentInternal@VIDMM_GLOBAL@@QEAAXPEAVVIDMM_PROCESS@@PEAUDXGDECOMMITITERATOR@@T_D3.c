/*
 * XREFs of ?TrimOfferCommitmentInternal@VIDMM_GLOBAL@@QEAAXPEAVVIDMM_PROCESS@@PEAUDXGDECOMMITITERATOR@@T_D3DKMT_TRIMPROCESSCOMMITMENT_FLAGS@@_KPEA_K@Z @ 0x1C00AFBBC
 * Callers:
        ...
        unsigned __int64 *a6)
{
  ...
  *(_QWORD *)(v12 + 24) = v23;
  ...
  if ( (v6 & 1) != 0 )
  {
    v7 = (unsigned int)(dword_1C004E430 << 20);
    if ( a5 < v7 )
      v7 = a5;
  }
