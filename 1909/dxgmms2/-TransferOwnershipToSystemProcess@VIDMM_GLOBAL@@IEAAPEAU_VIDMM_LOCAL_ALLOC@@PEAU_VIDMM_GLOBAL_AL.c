/*
 * XREFs of ?TransferOwnershipToSystemProcess@VIDMM_GLOBAL@@IEAAPEAU_VIDMM_LOCAL_ALLOC@@PEAU_VIDMM_GLOBAL_ALLOC@@PEAU2@@Z @ 0x1C0080560
 * Callers:
...
LABEL_4:
  if ( bTracingEnabled )
  {
    ...
    if ( (Microsoft_Windows_DxgKrnlEnableBits & 0x200) != 0 )
    {
      ...
      McTemplateK0pqq(v10, &EventTransferAllocationOwnership, v9, a2, v17, v18);
    }
  }
  if ( *((_QWORD *)a3 + 1) )
  {
