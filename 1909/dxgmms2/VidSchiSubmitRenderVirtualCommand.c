/*
 * XREFs of VidSchiSubmitRenderVirtualCommand @ 0x1C007A0A0
 * Callers:
 ...
 *     ?DdiSetRootPageTable@ADAPTER_RENDER@@QEAAXPEAU_DXGKARG_SETROOTPAGETABLE@@@Z @ 0x1C0014DFC (-DdiSetRootPageTable@ADAPTER_RENDER@@QEAAXPEAU_DXGKARG_SETROOTPAGETABLE@@@Z.c)
...
__int64 __fastcall VidSchiSubmitRenderVirtualCommand(_VIDSCH_QUEUE_PACKET *this)
{
    ...
    && !_InterlockedCompareExchange((volatile signed __int32 *)(v3 + 200), 0, 0) )
  {
    ...
    *((_QWORD *)this + 15) = v45;
    ...
    for ( i = *(_QWORD *)(v4 + 24); ; VidSchWaitForCompletionEvent(i, v46, 20LL) )
    {
    ...
    *(_DWORD *)(v11 + 148) = *(_DWORD *)(v12 + 332);
    ...
    if ( (v22 & 1) != 0 )
    {
      ...
      {
        if ( *(_DWORD *)(*(_QWORD *)(v5 + 8 * v42 + 2576) + 33280LL) != -1 )
        {
