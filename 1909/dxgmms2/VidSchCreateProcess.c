/*
 * XREFs of VidSchCreateProcess @ 0x1C0080830
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall VidSchCreateProcess(__int64 a1, __int64 a2)
{
  ...
  *(_DWORD *)v6 = 845244758;
  *(_QWORD *)(v6 + 8) = a1;
  *(_DWORD *)(v6 + 16) = *(_BYTE *)(a1 + 297) != 0 ? 5 : 2;
  TdrHistoryInit((struct _TDR_HISTORY *)(v6 + 32));
  Global = DXGGLOBAL::GetGlobal();
  MaximumAdapterCount = DXGGLOBAL::GetMaximumAdapterCount(Global);
  v9 = ExAllocatePoolWithTag(PagedPool, 4 * ((unsigned __int64)(MaximumAdapterCount + 31) >> 5), 0x32616956u);
  *(_QWORD *)(v6 + 2616) = v9;
  if ( !v9 )
  {
...
LABEL_13:
  ...
  v12 = ExAllocatePoolWithTag((POOL_TYPE)512, 8LL * MaximumAdapterCount, 0x32616956u);
  *(_QWORD *)(v6 + 24) = v12;
  if ( !v12 )
  {
  ...
  *(_QWORD *)(v6 + 2632) = *(_QWORD *)(a1 + 64);
  *(_QWORD *)(v6 + 2648) = *(_QWORD *)(a1 + 56);
  v15 = *(_QWORD *)(a1 + 72);
  if ( v15 )
    v15 = *(_QWORD *)(v15 + 80);
  *(_QWORD *)(v6 + 2640) = v15;
