/*
 * XREFs of ?InitializeSubmitData@CVidSchSubmitData@@QEAAXXZ @ 0x1C002A07C
 * Callers:
 ...
 *     ?GetVidSchSibmitDataSize@ADAPTER_RENDER@@QEAAIXZ @ 0x1C0029F6C (-GetVidSchSibmitDataSize@ADAPTER_RENDER@@QEAAIXZ.c)
 */
...
void __fastcall CVidSchSubmitData::InitializeSubmitData(CVidSchSubmitData *this)
{
  ...
  *(_QWORD *)this = v4;
  if ( v4 )
  {
    ...
    if ( *(int *)(v7 + 2184) < 0x2000 )
      v8 = 1;
    else
      v8 = *(_DWORD *)(v7 + 256);
    if ( *(int *)(v7 + 2184) < 0x2000 && !*(_BYTE *)(v7 + 2484) )
      v3 = 0;
    v9 = *(_DWORD **)this;
    v10 = *(_DWORD *)(v7 + 2392);
    *(_BYTE *)(*(_QWORD *)this + 356LL) = v3;
    if ( v3 )
    {
      ...
      v12 = v8 << 6;
      v9[139] = v10;
      v9[141] = v10 * (v12 + ((v11 + 191) & 0xFFFFFFF8)) + 16;
