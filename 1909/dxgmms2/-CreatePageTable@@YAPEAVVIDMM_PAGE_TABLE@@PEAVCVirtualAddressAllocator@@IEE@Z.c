/*
 * XREFs of ?CreatePageTable@@YAPEAVVIDMM_PAGE_TABLE@@PEAVCVirtualAddressAllocator@@IEE@Z @ 0x1C0060C7C
 * Callers:
        ...
        char a4)
{
  ...
  if ( v11 )
  {
    v12 = *(_DWORD *)(*(_QWORD *)(*((_QWORD *)a1 + 10) + 40184LL) + 1560 * v5 + 76) >> 4;
    if ( !a3 )
      v12 = *(_DWORD *)(*(_QWORD *)(*((_QWORD *)a1 + 10) + 40184LL) + 1560 * v5 + 76);
    if ( (int)VIDMM_PAGE_TABLE::InitializePageTable(v11, a1, v12, a3, a4) >= 0 )
      return v11;
    v17 = WdLogNewEntry5_WdAssertion(v14, v13);
    *(_QWORD *)(v17 + 24) = 4049LL;
