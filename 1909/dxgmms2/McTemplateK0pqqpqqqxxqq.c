/*
 * XREFs of McTemplateK0pqqpqqqxxqq @ 0x1C002CB0C
 * Callers:
...
ULONG McTemplateK0pqqpqqqxxqq(__int64 a1, __int64 a2, const GUID *a3, ...)
{
  ...
  v24 = 4LL;
  v26 = 4LL;
  return McGenEventWrite((PMCGEN_TRACE_CONTEXT)&DxgkControlGuid_Context, &EventIndependentFlip, a3, 0xCu, &EventData);
}
