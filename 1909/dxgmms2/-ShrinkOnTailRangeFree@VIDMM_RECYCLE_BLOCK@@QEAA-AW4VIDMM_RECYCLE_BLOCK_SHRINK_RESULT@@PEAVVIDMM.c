/*
 * XREFs of ?ShrinkOnTailRangeFree@VIDMM_RECYCLE_BLOCK@@QEAA?AW4VIDMM_RECYCLE_BLOCK_SHRINK_RESULT@@PEAVVIDMM_RECYCLE_RANGE@@@Z @ 0x1C0069818
 * Callers:
...
LABEL_26:
  ...
  if ( v13 )
  {
    ...
    VIDMM_RECYCLE_HEAP::RemoveMultirangeFromTree(a1[4], v24, v3);
  ...
  else
  {
    ...
    {
      v33 = (_QWORD *)WdLogNewEntry5_WdCriticalError(v12, v9);
      v33[5] = 0LL;
      v33[6] = 0LL;
      v33[7] = 0LL;
      v33[3] = 270LL;
    ...
    VIDMM_RECYCLE_HEAP::RemoveRangeFromTree(a1[4], v32, a2);
    v34 = *(_QWORD **)(a2 + 128);
    *v34 = a1 + 9;
    a1[10] = (__int64)v34;
