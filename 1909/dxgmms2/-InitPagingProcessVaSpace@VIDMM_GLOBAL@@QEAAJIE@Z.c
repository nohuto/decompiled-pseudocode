/*
 * XREFs of ?InitPagingProcessVaSpace@VIDMM_GLOBAL@@QEAAJIE@Z @ 0x1C009179C
 * Callers:
 ...
 *     VidSchSetHwQueueProgressFenceObject @ 0x1C00CCE80 (VidSchSetHwQueueProgressFenceObject.c)
 */
