/*
 * XREFs of ?InitPagingProcess@VIDMM_PAGING_PROCESS@@QEAAJPEAVVIDMM_GLOBAL@@@Z @ 0x1C0091CD4
 * Callers:
  ...
  *((_QWORD *)this + 1) = v5;
  if ( v5 )
  {
    ...
    else
    {
      ...
      *(_QWORD *)(v14 + 24) = 7380LL;
    }
    WdLogEvent5_WdAssertion(v14);
  }
  else
  {
    _InterlockedIncrement(&dword_1C004E640);
    v13 = WdLogNewEntry5_WdLowResource(v7);
    *(_QWORD *)(v13 + 24) = 7352LL;
