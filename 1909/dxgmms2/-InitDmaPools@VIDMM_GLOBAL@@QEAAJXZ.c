/*
 * XREFs of ?InitDmaPools@VIDMM_GLOBAL@@QEAAJXZ @ 0x1C0091900
 * Callers:
 ...
 *     ?Init@VIDMM_DMA_POOL@@QEAAJXZ @ 0x1C0086708 (-Init@VIDMM_DMA_POOL@@QEAAJXZ.c)
 *     ??0VIDMM_DMA_POOL@@QEAA@PEAVVIDMM_GLOBAL@@KPEAVVIDMM_DEVICE@@PEAVDXGCONTEXT@@KKKKKH@Z @ 0x1C0086874 (--0VIDMM_DMA_POOL@@QEAA@PEAVVIDMM_GLOBAL@@KPEAVVIDMM_DEVICE@@PEAVDXGCONTEXT@@KKKKKH@Z.c)
 */
  ...
  if ( *((_DWORD *)this + 1748) )
  {
    while ( 1 )
    {
      ...
      *((_QWORD *)this + v2 + 79) = v6;
      ...
      if ( v8 < 0 )
      {
        _InterlockedAdd(&dword_1C004E664, 1u);
      ...
      *(_DWORD *)(v11 + 32) = 1;
      if ( (unsigned int)v2 >= *((_DWORD *)this + 1748) )
        goto LABEL_9;
    }
    _InterlockedAdd(&dword_1C004E660, 1u);
    v14 = WdLogNewEntry5_WdLowResource(v7);
    *(_QWORD *)(v14 + 24) = 1873LL;
