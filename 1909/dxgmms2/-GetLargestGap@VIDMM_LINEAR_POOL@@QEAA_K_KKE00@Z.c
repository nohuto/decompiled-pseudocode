/*
 * XREFs of ?GetLargestGap@VIDMM_LINEAR_POOL@@QEAA_K_KKE00@Z @ 0x1C00C8654
 * Callers:
 ...
 * Callees:
 *     ?ApplyBlockRunRestrictions@VIDMM_LINEAR_POOL@@IEAAXPEA_NPEA_K1_KKE22@Z @ 0x1C007F0A0 (-ApplyBlockRunRestrictions@VIDMM_LINEAR_POOL@@IEAAXPEA_NPEA_K1_KKE22@Z.c)
 */
        ...
        VIDMM_LINEAR_POOL *a6)
{
  ...
  if ( v7 != (VIDMM_LINEAR_POOL *)((char *)this + 40) )
  {
    ...
    do
    {
      v13 = (unsigned __int64 *)((char *)v7 - 24);
