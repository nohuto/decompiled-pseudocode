/*
 * XREFs of ?LogProcessInformation@VIDMM_COMMIT_TELEMETRY@@AEAAXPEAUVIDMM_PROCESS_ADAPTER_INFO@@PEAU_GUID@@@Z @ 0x1C00C4D18
 * Callers:
    ...
    if ( a2 )
    {
      ...
      if ( *(_DWORD *)(v6 + 6992) )
      {
        ...
        do
        {
          ...
          {
            if ( (qword_1C004E058 & 0x10000) == 0 || (v11 = 1, (v8 & 0x10000) != v8) )
              v11 = 0;
            v9 = v6;
            if ( v11 )
            {
              v12 = *(unsigned __int16 **)(*(_QWORD *)(v6 + 24) + 1408LL);
              v27 = v30;
              v28 = 2LL;
              v13 = *v12;
              v29 = *((_QWORD *)v12 + 1);
