/*
 * XREFs of ?DestroyContextAllocation@VIDMM_GLOBAL@@QEAAJPEAU_VIDMM_CONTEXT_ALLOC@@@Z @ 0x1C0081BFC
 * Callers:
 *     VidMmDestroyContextAllocation @ 0x1C00147B0 (VidMmDestroyContextAllocation.c)
 * Callees:
