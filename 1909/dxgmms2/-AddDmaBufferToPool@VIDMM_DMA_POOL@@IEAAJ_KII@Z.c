/*
 * XREFs of ?AddDmaBufferToPool@VIDMM_DMA_POOL@@IEAAJ_KII@Z @ 0x1C005C588
 * Callers:
...
__int64 __fastcall VIDMM_DMA_POOL::AddDmaBufferToPool(VIDMM_DMA_POOL *this, SIZE_T a2, int a3, unsigned int a4)
{
  ...
  if ( *((_DWORD *)this + 23) > VIDMM_DMA_POOL::_NbDmaBufferLimitCompareWatermark )
  {
      ...
      || (v56 = *(_QWORD *)(v55 + 24), *(_DWORD *)(v56 + 328) != 2) && !*(_BYTE *)(*(_QWORD *)(v56 + 40) + 298LL) )
    {
      ...
      {
        _InterlockedAdd(&dword_1C004E68C, 1u);
...
LABEL_65:
  ...
  if ( (*((_BYTE *)this + 32) & 1) != 0 || (_DWORD)v4 )
  {
    ...
    if ( !v8 )
    {
      _InterlockedAdd(&dword_1C004E5F0, 1u);
    ...
    if ( !v11 )
    {
      ...
      *((_DWORD *)v10 + 20) = 2;
      ...
      if ( !v62 )
      {
        _InterlockedAdd(&dword_1C004E604, 1u);
...
LABEL_19:
      if ( (_DWORD)v4 )
      {
        ...
        if ( !v27 )
        {
          _InterlockedAdd(&dword_1C004E610, 1u);
        ...
        if ( !v30 )
        {
          _InterlockedAdd(&dword_1C004E608, 1u);
      ...
      if ( v75 )
      {
        ...
        if ( !v34 )
        {
          _InterlockedAdd(&dword_1C004E60C, 1u);
...
LABEL_43:
        ...
        _InterlockedAdd(&dword_1C004E614, 1u);
      ...
      _InterlockedAdd(&dword_1C004E66C, 1u);
...
LABEL_82:
    ...
    if ( OneAllocation < 0 )
    {
      _InterlockedAdd(&dword_1C004E5F8, 1u);
