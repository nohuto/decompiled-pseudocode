/*
 * XREFs of VidMmResizeBuffersInPool @ 0x1C0024C10
 * Callers:
 *     <none>
 * Callees:
 *     ?ResizeBuffersInPool@VIDMM_DMA_POOL@@QEAAJ_KII@Z @ 0x1C00B6148 (-ResizeBuffersInPool@VIDMM_DMA_POOL@@QEAAJ_KII@Z.c)
 */
