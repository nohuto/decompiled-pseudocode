/*
 * XREFs of ?FlushPagingBufferInternal@VIDMM_GLOBAL@@QEAAXKEP6AXPEAX@Z0EE@Z @ 0x1C0079770
 * Callers:
 ...
 *     ?PurgeAllocation@VIDMM_GLOBAL@@QEAAXPEAU_VIDMM_GLOBAL_ALLOC@@U_VIDMM_PURGE_FLAGS@@@Z @ 0x1C00AE328 (-PurgeAllocation@VIDMM_GLOBAL@@QEAAXPEAU_VIDMM_GLOBAL_ALLOC@@U_VIDMM_PURGE_FLAGS@@@Z.c)
 ...
 *     VidSchIsMonitoredFenceSignaled @ 0x1C0003430 (VidSchIsMonitoredFenceSignaled.c)
 ...
 *     ?AcquireBuffer@VIDMM_DMA_POOL@@QEAAJPEAPEAU_VIDMM_DMA_BUFFER@@EE@Z @ 0x1C007DC10 (-AcquireBuffer@VIDMM_DMA_POOL@@QEAAJPEAPEAU_VIDMM_DMA_BUFFER@@EE@Z.c)
  ...
  *(_DWORD *)(v24 + 172) = v25;
  ...
  if ( !VidSchIsTDRPending(v49) )
  {
    ...
    else
    {
      ...
      VidSchRegisterCompletionEvent(v52, v104);
      do
      {
        ...
        if ( v94 )
          ...
          VidSchWaitForCompletionEvent(v52, v104, 19LL);
      }
      while ( !PoolWithTag );
...
LABEL_63:
  ...
  *((_DWORD *)v9 + v12 + 1171) = 0;
  if ( v107 )
  {
    ...
    VIDMM_DMA_POOL::AcquireBuffer(v84[79], v84 + 143, 0, 1u);
    *((_DWORD *)v84[143] + 8) = 1;
    *((_DWORD *)v9 + v12 + 414) = 0;
    *((_DWORD *)v9 + v12 + 478) = 0;
    *((_DWORD *)v9 + v12 + 542) = 0;
