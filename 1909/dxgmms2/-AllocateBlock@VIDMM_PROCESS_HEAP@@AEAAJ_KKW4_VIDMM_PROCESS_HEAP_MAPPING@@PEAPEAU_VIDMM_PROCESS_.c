/*
 * XREFs of ?AllocateBlock@VIDMM_PROCESS_HEAP@@AEAAJ_KKW4_VIDMM_PROCESS_HEAP_MAPPING@@PEAPEAU_VIDMM_PROCESS_HEAP_BLOCK@@E@Z @ 0x1C00C5A00
 * Callers:
 ...
 *     ?GetBlockListHead@VIDMM_PROCESS_HEAP@@AEAAPEAU_LIST_ENTRY@@W4_VIDMM_PROCESS_HEAP_MAPPING@@@Z @ 0x1C00C6B28 (-GetBlockListHead@VIDMM_PROCESS_HEAP@@AEAAPEAU_LIST_ENTRY@@W4_VIDMM_PROCESS_HEAP_MAPPING@@@Z.c)
 */
...
LABEL_31:
  ...
  if ( !v10 )
  {
    _InterlockedIncrement(&dword_1C004E62C);
  ...
  if ( v31 < 0 )
  {
    _InterlockedIncrement(&dword_1C004E630);
    goto LABEL_37;
  }
  ...
  if ( !v32 )
  {
    _InterlockedIncrement(&dword_1C004E634);
