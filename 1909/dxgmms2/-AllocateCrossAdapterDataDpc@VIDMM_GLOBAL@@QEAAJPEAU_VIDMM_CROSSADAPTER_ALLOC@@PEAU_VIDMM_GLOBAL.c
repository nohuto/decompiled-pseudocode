/*
 * XREFs of ?AllocateCrossAdapterDataDpc@VIDMM_GLOBAL@@QEAAJPEAU_VIDMM_CROSSADAPTER_ALLOC@@PEAU_VIDMM_GLOBAL_ALLOC@@@Z @ 0x1C002510C
 * Callers:
 ...
 *     VidSchGetRunEvent @ 0x1C0082C40 (VidSchGetRunEvent.c)
 */
        ...
        struct _VIDMM_GLOBAL_ALLOC *a3)
{
  ...
  {
    _InterlockedIncrement(&dword_1C004E724);
    v8 = WdLogNewEntry5_WdLowResource();
    *(_QWORD *)(v8 + 24) = 30828LL;
