/*
 * XREFs of ?Init@VIDMM_GLOBAL@@QEAAJPEAVADAPTER_RENDER@@PEAU_DXGK_QUERYSEGMENTOUT4@@K@Z @ 0x1C008FBDC
 * Callers:
 ...
 *     ??_H@YAXPEAX_K1P6APEAX0@Z@Z @ 0x1C0001B68 (--_H@YAXPEAX_K1P6APEAX0@Z@Z.c)
 ...
 *     ?InitializeGpuVaState@VIDMM_PHYSICAL_ADAPTER@@QEAAJPEAVVIDMM_GLOBAL@@IPEBQEAVVIDMM_SEGMENT@@PEBUDXGADAPTER_GPUMMUCAPS@@PEBUDXGK_PHYSICALADAPTERINFO@@I@Z @ 0x1C00AC478 (-InitializeGpuVaState@VIDMM_PHYSICAL_ADAPTER@@QEAAJPEAVVIDMM_GLOBAL@@IPEBQEAVVIDMM_SEGMENT@@PEBU.c)
...
LABEL_71:
  ...
  *((_QWORD *)this + 5023) = v18;
  if ( !v18 )
  {
    _InterlockedIncrement(&dword_1C004E61C);
    v75 = WdLogNewEntry5_WdLowResource(v17);
    *(_QWORD *)(v75 + 24) = 1439LL;
