/*
 * XREFs of VidSchiProcessIsrMonitoredFenceSignaled @ 0x1C0038FA8
 * Callers:
...
PSLIST_ENTRY __fastcall VidSchiProcessIsrMonitoredFenceSignaled(__int64 a1)
{
  ...
  v3 = ExpInterlockedPopEntrySList((PSLIST_HEADER)(a1 + 2880));
  if ( v3 )
  {
    v3[2].Next = (struct _SLIST_ENTRY *)a1;
    LODWORD(v3->Next) = 11;
    return ExpInterlockedPushEntrySList(v1 + 106, v3 + 1);
  }
  else
  {
