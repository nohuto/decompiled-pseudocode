/*
 * XREFs of ?PageInDeviceInternal@VIDMM_GLOBAL@@IEAAJPEAVVIDMM_DEVICE@@_NPEA_NPEAPEAUVIDMM_ALLOC@@@Z @ 0x1C005CC44
 * Callers:
 ...
 *     ?FaultCommitment@VIDMM_DEVICE@@QEAAXPEAUVIDMM_ALLOC@@@Z @ 0x1C006041C (-FaultCommitment@VIDMM_DEVICE@@QEAAXPEAUVIDMM_ALLOC@@@Z.c)
        ...
        struct VIDMM_ALLOC **a5)
{
  ...
  *a5 = 0LL;
  ...
  if ( v10 )
  {
    DXGPUSHLOCK::AcquireShared((DXGPUSHLOCK *)(v10 + 664));
    a4 = v22;
    a3 = v21;
  }
  v11 = (struct VIDMM_ALLOC *)*((_QWORD *)a2 + 30);
  if ( !v11 )
    goto LABEL_8;
  ...
  if ( (*((_DWORD *)v15 + 19) & 0x100) != 0 )
  {
    ...
    LOBYTE(a4) = a3;
    v18 = VIDMM_GLOBAL::PageInOneAllocation(v7, v11, 0LL, a4, v19);
LABEL_34:
    v8 = v18;
    goto LABEL_35;
  }
  if ( (*((_DWORD *)v11 + 7) & 3) != 0 )
  {
    v18 = VIDMM_GLOBAL::PageInFaultedAllocation(v7, *((struct VIDMM_ALLOC **)a2 + 30), a3, a4, a5);
    goto LABEL_34;
  }
LABEL_35:
  if ( v8 < 0 )
        ...
        if ( v13 == v5 )
        {
          ...
          while ( 1 )
          {
            while ( 1 )
            {
              ...
              if ( !v12 )
                break;
              if ( v12 != 1 || *(_DWORD *)(**(_QWORD **)v11 + 376LL) >= 0xA0000000 )
                goto LABEL_24;
            }
...
LABEL_24:
    ...
    while ( v12 == 1 && *(_DWORD *)(**(_QWORD **)v11 + 376LL) < 0xA0000000 );
LABEL_15:
    v14 = **(_QWORD **)v11;
    if ( *(_DWORD *)(v14 + 128) == 1 )
    {
...
LABEL_27:
  if ( v10 )
  {
    ExReleasePushLockSharedEx(v10 + 664, 0LL);
