/*
 * XREFs of ?DdiSetVidPnSourceAddress@ADAPTER_DISPLAY@@QEAAJPEBU_DXGKARG_SETVIDPNSOURCEADDRESS@@@Z @ 0x1C0024288
 * Callers:
 *     VidSchSetVidPnSourceAddress @ 0x1C00CC230 (VidSchSetVidPnSourceAddress.c)
 * Callees:
