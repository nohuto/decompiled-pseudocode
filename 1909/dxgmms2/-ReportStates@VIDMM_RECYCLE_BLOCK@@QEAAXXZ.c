/*
 * XREFs of ?ReportStates@VIDMM_RECYCLE_BLOCK@@QEAAXXZ @ 0x1C00BB570
 * Callers:
 *     ?ReportBlockStates@VIDMM_RECYCLE_HEAP@@QEAAXXZ @ 0x1C00BB3A8 (-ReportBlockStates@VIDMM_RECYCLE_HEAP@@QEAAXXZ.c)
 * Callees:
  ...
  for ( i = (char *)*((_QWORD *)this + 9); i != v3; i = *(char **)i )
  {
    ...
    if ( v7 == 1 || v7 > 1 && v7 <= 5 )
    {
      if ( bTracingEnabled )
      {
        ...
        a3 = (const GUID *)*((_QWORD *)v6 + 4);
        if ( (Microsoft_Windows_DxgKrnlEnableBits & 0x200) != 0 )
          McTemplateK0qpxp(
            *((_QWORD *)v6 + 5) - (_QWORD)a3,
