/*
 * XREFs of ?CreateOneAllocation@VIDMM_GLOBAL@@QEAAJPEAVVIDMM_DEVICE@@K_K1KKKU_D3DDDI_SEGMENTPREFERENCE@@U_DXGK_ALLOCATIONINFOFLAGS@@PEAVDXGADAPTERALLOCATION@@PEAX5KE5EPEAPEAU_VIDMM_CROSSADAPTER_ALLOC@@PEAPEAU_VIDMM_GLOBAL_ALLOC@@@Z @ 0x1C0071580
 * Callers:
 ...
 *     ?CreateAllocation@VIDMM_GLOBAL@@QEAAJPEAVVIDMM_DEVICE@@K_K1KKKKU_D3DDDI_SEGMENTPREFERENCE@@U_DXGK_SEGMENTBANKPREFERENCE@@U_DXGK_ALLOCATIONINFOFLAGS@@KPEAVDXGADAPTERALLOCATION@@PEAXPEAPEAU_VIDMM_CROSSADAPTER_ALLOC@@PEAPEAU_VIDMM_MULTI_GLOBAL_ALLOC@@@Z @ 0x1C007FAEC (-CreateAllocation@VIDMM_GLOBAL@@QEAAJPEAVVIDMM_DEVICE@@K_K1KKKKU_D3DDDI_SEGMENTPREFERENCE@@U_DXG.c)
 * Callees:
 *     ??3@YAXPEAX@Z @ 0x1C0001710 (--3@YAXPEAX@Z.c)
 *     ?IsWarpAdapter@DXGADAPTER@@QEBAEXZ @ 0x1C000178C (-IsWarpAdapter@DXGADAPTER@@QEBAEXZ.c)
 *     ?IsSoftGPU@DXGADAPTER@@QEBAEXZ @ 0x1C00017A0 (-IsSoftGPU@DXGADAPTER@@QEBAEXZ.c)
 *     ??0VIDMM_GLOBAL_ALLOC_VGPU_BASE@@QEAA@XZ @ 0x1C00028B4 (--0VIDMM_GLOBAL_ALLOC_VGPU_BASE@@QEAA@XZ.c)
 *     ??0DXGFASTMUTEX@@QEAA@W4_DXGK_BLOCK_THREAD_REASON@@W4DXGK_LOCK_ORDER@@@Z @ 0x1C00028DC (--0DXGFASTMUTEX@@QEAA@W4_DXGK_BLOCK_THREAD_REASON@@W4DXGK_LOCK_ORDER@@@Z.c)
 *     ??_U@YAPEAX_KIW4_POOL_TYPE@@@Z @ 0x1C0002900 (--_U@YAPEAX_KIW4_POOL_TYPE@@@Z.c)
 *     ?VidMmiReferencePartition@@YAXPEAUVIDMM_PARTITION@@@Z @ 0x1C0002964 (-VidMmiReferencePartition@@YAXPEAUVIDMM_PARTITION@@@Z.c)
 ...
 *     ?CheckForCpuVisibleMemorySegment@VIDMM_GLOBAL@@IEAAEKK@Z @ 0x1C006B3D4 (-CheckForCpuVisibleMemorySegment@VIDMM_GLOBAL@@IEAAEKK@Z.c)
 ...
 *     ?VerifySegmentSet@VIDMM_GLOBAL@@QEAAEKKKPEAK@Z @ 0x1C007FC9C (-VerifySegmentSet@VIDMM_GLOBAL@@QEAAEKKKPEAK@Z.c)
 *     ?VerifySegmentSetAny@VIDMM_GLOBAL@@IEAAEKKK@Z @ 0x1C00807D0 (-VerifySegmentSetAny@VIDMM_GLOBAL@@IEAAEKKK@Z.c)
 ...
 *     ?VerifySegmentSetAtLeastOneInMask@VIDMM_GLOBAL@@QEAAEKKKPEAK@Z @ 0x1C00B153C (-VerifySegmentSetAtLeastOneInMask@VIDMM_GLOBAL@@QEAAEKKKPEAK@Z.c)
 *     ?GetVmwpProcess@VIDMM_PROCESS@@QEAAPEAV1@XZ @ 0x1C00B5368 (-GetVmwpProcess@VIDMM_PROCESS@@QEAAPEAV1@XZ.c)
 */
...
LABEL_154:
  ...
  if ( (unsigned __int8)v60 | (v185 || v80) )
  {
    ...
    if ( v83 )
      goto LABEL_204;
LABEL_329:
    _InterlockedIncrement(&dword_1C004E5D4);
    v162 = WdLogNewEntry5_WdLowResource(v84);
    *(_QWORD *)(v162 + 24) = 3071LL;
...
LABEL_308:
  ...
  *((_QWORD *)v86 + 63) = v92;
  if ( !v92 )
  {
    _InterlockedIncrement(&dword_1C004E6E0);
    v95 = WdLogNewEntry5_WdLowResource(v94);
    *(_QWORD *)(v95 + 24) = 3098LL;
  ...
  if ( *(_BYTE *)(*(_QWORD *)(*((_QWORD *)this + 2) + 528LL) + 57LL) )
  {
    if ( (v163.Value & 0x40000000) != 0 || (v163.Value & 0x80000000) != 0 )
    {
      *(_QWORD *)(*((_QWORD *)v86 + 63) + 24LL) = operator new[](0x20uLL, 0x33306956u, (POOL_TYPE)512);
      ...
      {
        _InterlockedIncrement(&dword_1C004E5CC);
        v97 = WdLogNewEntry5_WdLowResource(0LL);
        *(_QWORD *)(v97 + 24) = 3115LL;
