/*
 * XREFs of ?UnmapVideoApertureSegment@VIDMM_GLOBAL@@QEAAXPEAU_VIDMM_GLOBAL_ALLOC@@I_K11T_LARGE_INTEGER@@H@Z @ 0x1C0084B80
 * Callers:
        ...
        int a8)
{
  ...
  VIDMM_GLOBAL::UnmapVideoApertureSegmentInternal(this, v10, v9, a3, a4, a5, a7, a8);
}
