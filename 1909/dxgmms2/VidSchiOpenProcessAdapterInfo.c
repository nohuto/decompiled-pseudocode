/*
 * XREFs of VidSchiOpenProcessAdapterInfo @ 0x1C007BD1C
 * Callers:
 ...
 *     ??_GVIDSCH_PROCESS_ADAPTER_INFO@@QEAAPEAXI@Z @ 0x1C00116B8 (--_GVIDSCH_PROCESS_ADAPTER_INFO@@QEAAPEAXI@Z.c)
...
__int64 __fastcall VidSchiOpenProcessAdapterInfo(__int64 a1, __int64 a2)
{
  ...
  struct _PCW_DATA v63; // [rsp+60h] [rbp-38h] BYREF
      ...
      while ( 1 )
      {
        ...
        *v17 = ExAllocatePoolWithTag((POOL_TYPE)512, 0xE0uLL, 0x32616956u);
        ...
        if ( (unsigned int)v15 >= *(_DWORD *)(a2 + 688) )
          v22 = *(_QWORD *)(a2 + 616);
        v23 = (int *)(*(_QWORD *)(352LL * *(unsigned __int16 *)(*(_QWORD *)v22 + 6LL) + *(_QWORD *)(v21 + 2440) + 24)
                    + 74LL * *(unsigned __int16 *)(*(_QWORD *)v22 + 8LL));
        *(_QWORD *)&DestinationString.Length = 0LL;
        DestinationString.Buffer = 0LL;
        v24 = *v23;
        if ( (_DWORD)v24 )
          v25 = off_1C003CDD0[v24];
        else
          v25 = (wchar_t *)(v23 + 1);
        ...
        if ( (unsigned int)v15 >= v32 )
          v33 = v31;
        v63.Data = *v33;
        v28 = PcwCreateInstance(v35, GpuPerformanceCounterSetEngine, &DestinationString, 1u, &v63);
        if ( v28 < 0 )
        {
LABEL_52:
