/*
 * XREFs of McTemplateK0pptpqqx @ 0x1C0027BD0
 * Callers:
...
ULONG McTemplateK0pptpqqx(__int64 a1, __int64 a2, const GUID *a3, ...)
{
  ...
  v16 = 4LL;
  v18 = 8LL;
  return McGenEventWrite((PMCGEN_TRACE_CONTEXT)&DxgkControlGuid_Context, &EventPagingOpDiscard, a3, 8u, &EventData);
}
