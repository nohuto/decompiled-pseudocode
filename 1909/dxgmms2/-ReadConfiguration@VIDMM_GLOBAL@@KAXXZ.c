/*
 * XREFs of ?ReadConfiguration@VIDMM_GLOBAL@@KAXXZ @ 0x1C008C690
 * Callers:
...
void VIDMM_GLOBAL::ReadConfiguration(void)
{
  ...
  struct _UNICODE_STRING String; // [rsp+138h] [rbp+30h] BYREF
  struct _UNICODE_STRING Destination; // [rsp+148h] [rbp+40h] BYREF
  struct _UNICODE_STRING DestinationString; // [rsp+158h] [rbp+50h] BYREF
  ...
  {
    _InterlockedAdd(&dword_1C004E6D0, 1u);
  ...
  *((_QWORD *)&v93[107] + 1) = &v84;
  ...
  v9 = (unsigned int *)&unk_1C004E188;
  memset(&unk_1C004E188, 0, 0x80uLL);
  ...
  *(_QWORD *)(v15 + 24) = v22;
  ...
  dword_1C004E298 = v33;
  dword_1C004E29C = v34;
  qword_1C004E2A0 = (unsigned int)(v38 << 20);
  dword_1C004E2A8 = v39;
  dword_1C004E2AC = v40;
  dword_1C004E2B8 = v42;
  dword_1C004E2BC = v43;
  dword_1C004E2E0 = v48;
  qword_1C004E2B0 = (unsigned int)(10000000 * v41);
  qword_1C004E2C0 = (unsigned int)(10000000 * v44);
  qword_1C004E2C8 = (unsigned int)(10000000 * v45);
  qword_1C004E2D0 = (unsigned int)(10000000 * v46);
  qword_1C004E2D8 = (unsigned int)(10000000 * v47);
  ...
  dword_1C004E144 = v50 != 0;
  qword_1C004E150 = (unsigned __int64)v51 << 20;
  LOBYTE(v0) = v52 != 0;
  qword_1C004E310 = (unsigned int)(v53 << 10);
  dword_1C004E148 = v0;
  qword_1C004E320 = (unsigned int)(10000 * v55);
  dword_1C004E318 = v54;
