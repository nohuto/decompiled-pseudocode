/*
 * XREFs of ?NotifyAllocationReclaimed@VIDMM_GLOBAL@@QEAAXPEAU_VIDMM_GLOBAL_ALLOC@@H@Z @ 0x1C00ADCD8
 * Callers:
 ...
 *     ?NotifyAllocationReclaimed@@YAXPEAX@Z @ 0x1C00ADCB0 (-NotifyAllocationReclaimed@@YAXPEAX@Z.c)
 *     ?ReclaimAllocationForVPRCallback@@YAEPEAX0@Z @ 0x1C00C132C (-ReclaimAllocationForVPRCallback@@YAEPEAX0@Z.c)
 * Callees:
