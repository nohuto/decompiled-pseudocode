/*
 * XREFs of McTemplateK0ppqqxqq @ 0x1C0027368
 * Callers:
...
ULONG McTemplateK0ppqqxqq(__int64 a1, __int64 a2, const GUID *a3, ...)
{
  ...
  v18 = 4LL;
  v20 = 4LL;
  return McGenEventWrite((PMCGEN_TRACE_CONTEXT)&DxgkControlGuid_Context, &EventProcessPolicyChange, a3, 8u, &EventData);
}
