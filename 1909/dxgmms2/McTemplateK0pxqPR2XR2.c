/*
 * XREFs of McTemplateK0pxqPR2XR2 @ 0x1C0032440
 * Callers:
...
ULONG McTemplateK0pxqPR2XR2(__int64 a1, __int64 a2, const GUID *a3, ...)
{
  ...
  v8 = 8LL;
  v10 = 4LL;
  return McGenEventWrite((PMCGEN_TRACE_CONTEXT)&DxgkControlGuid_Context, &EventCreateSyncPoint, a3, 6u, &EventData);
}
