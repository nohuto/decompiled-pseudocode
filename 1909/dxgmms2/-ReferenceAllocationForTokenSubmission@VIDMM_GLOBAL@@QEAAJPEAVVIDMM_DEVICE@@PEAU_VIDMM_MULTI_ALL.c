/*
 * XREFs of ?ReferenceAllocationForTokenSubmission@VIDMM_GLOBAL@@QEAAJPEAVVIDMM_DEVICE@@PEAU_VIDMM_MULTI_ALLOC@@PEAPEAUVIDMM_ALLOC@@@Z @ 0x1C0084534
 * Callers:
 *     VidMmReferenceAllocationForTokenSubmission @ 0x1C0016C00 (VidMmReferenceAllocationForTokenSubmission.c)
 * Callees:
 *     <none>
 */
