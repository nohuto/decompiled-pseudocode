/*
 * XREFs of ?VidSchiSelectContextFromThisPriority@@YAPEAU_VIDSCH_CONTEXT@@PEAU_VIDSCH_NODE@@K_N@Z @ 0x1C0009AC0
 * Callers:
 *     VidSchiSelectContext @ 0x1C00085C0 (VidSchiSelectContext.c)
 * Callees:
 *     VidSchiIsQuantumLeft @ 0x1C0012BB0 (VidSchiIsQuantumLeft.c)
