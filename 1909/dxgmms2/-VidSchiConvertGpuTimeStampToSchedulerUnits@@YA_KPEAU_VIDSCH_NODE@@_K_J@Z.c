/*
 * XREFs of ?VidSchiConvertGpuTimeStampToSchedulerUnits@@YA_KPEAU_VIDSCH_NODE@@_K_J@Z @ 0x1C0034C5C
 * Callers:
        ...
        unsigned __int64 a3)
{
  ...
  if ( v4 == v3 )
    return 0LL;
  v6 = *((_QWORD *)a1 + 1391) + (a2 - v3) * (*((_QWORD *)a1 + 1392) - *((_QWORD *)a1 + 1391)) / (v4 - v3);
