/*
 * XREFs of McTemplateK0iq @ 0x1C00266E0
 * Callers:
...
ULONG McTemplateK0iq(__int64 a1, __int64 a2, const GUID *a3, ...)
{
  ...
  v10 = 0;
  v9 = 4;
  return McGenEventWrite((PMCGEN_TRACE_CONTEXT)&DxgkControlGuid_Context, &VidMmWorkerThreadWake, a3, 3u, &v4);
}
