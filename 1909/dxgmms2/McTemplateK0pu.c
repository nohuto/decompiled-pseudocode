/*
 * XREFs of McTemplateK0pu @ 0x1C00264FC
 * Callers:
...
ULONG McTemplateK0pu(__int64 a1, __int64 a2, const GUID *a3, ...)
{
  ...
  v10 = 0;
  v9 = 1;
  return McGenEventWrite((PMCGEN_TRACE_CONTEXT)&DxgkControlGuid_Context, &EventOfferAllocation, a3, 3u, &v4);
}
