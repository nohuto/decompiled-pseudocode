/*
 * XREFs of McTemplateK0ppqqx @ 0x1C002C458
 * Callers:
 *     ?PropagatePresentHistoryToken@DXGPRESENTHISTORYTOKENQUEUE@@QEAAXPEAU_D3DKMT_PRESENTHISTORYTOKEN@@_N1111@Z @ 0x1C0010298 (-PropagatePresentHistoryToken@DXGPRESENTHISTORYTOKENQUEUE@@QEAAXPEAU_D3DKMT_PRESENTHISTORYTOKEN@.c)
...
ULONG McTemplateK0ppqqx(__int64 a1, __int64 a2, __int64 a3, ...)
{
  int v4; // [rsp+30h] [rbp-59h] BYREF
  int v5; // [rsp+38h] [rbp-51h] BYREF
  __int64 v6; // [rsp+40h] [rbp-49h] BYREF
  EVENT_DATA_DESCRIPTOR EventData; // [rsp+50h] [rbp-39h] BYREF
