/*
 * XREFs of McTemplateK0pppp @ 0x1C00321B8
 * Callers:
...
ULONG McTemplateK0pppp(__int64 a1, __int64 a2, const GUID *a3, ...)
{
  ...
  v12 = 8LL;
  va_copy(v11, va3);
  return McGenEventWrite((PMCGEN_TRACE_CONTEXT)&DxgkControlGuid_Context, &EventAssociateContext, a3, 5u, &EventData);
}
