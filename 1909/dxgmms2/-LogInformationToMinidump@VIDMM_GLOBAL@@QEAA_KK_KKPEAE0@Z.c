/*
 * XREFs of ?LogInformationToMinidump@VIDMM_GLOBAL@@QEAA_KK_KKPEAE0@Z @ 0x1C00AD2E4
 * Callers:
 ...
 *     ?WritePagingHistoryToMinidump@VIDMM_GLOBAL@@QEAA_KPEAU_VIDMM_MINIDUMP_HEADER@@PEAE_K@Z @ 0x1C00BA470 (-WritePagingHistoryToMinidump@VIDMM_GLOBAL@@QEAA_KPEAU_VIDMM_MINIDUMP_HEADER@@PEAE_K@Z.c)
 */
        ...
        unsigned __int64 a6)
{
  ...
  if ( a6 < 0x4F8 )
    return 0LL;
  v11 = (unsigned __int8 *)a5 + 1272;
  memset((char *)a5 + 4, 0, 0x4F4uLL);
  v12 = 6LL;
  *(_DWORD *)a5 = 1;
  ...
  *((_QWORD *)v17 + 14) = *((_QWORD *)v18 + 14);
  v20 = VIDMM_GLOBAL::WriteSegmentInformationToMinidump(this, a5, v11, a6 - 1272);
  v21 = &v11[v20];
  v22 = a6 - 1272 - v20;
  v23 = 10240LL;
  if ( v22 < 0x2800 )
