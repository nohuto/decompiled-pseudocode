/*
 * XREFs of VidSchiUpdateDdiHwContextPriority @ 0x1C00CD440
 * Callers:
 ...
 *     VidSchSetAbsolutePriorityHwContext @ 0x1C00CCD50 (VidSchSetAbsolutePriorityHwContext.c)
 *     VidSchSetInProcessPriorityHwContext @ 0x1C00CCEC0 (VidSchSetInProcessPriorityHwContext.c)
 *     VidSchSetPriorityHwContext @ 0x1C00CCF60 (VidSchSetPriorityHwContext.c)
 * Callees:
...
LABEL_15:
  ...
  return ADAPTER_RENDER::DdiSetContextSchedulingProperties(*(ADAPTER_RENDER **)(*(_QWORD *)(v3 + 16) + 2560LL), &v8);
}
