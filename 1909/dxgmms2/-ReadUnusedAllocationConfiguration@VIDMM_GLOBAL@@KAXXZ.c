/*
 * XREFs of ?ReadUnusedAllocationConfiguration@VIDMM_GLOBAL@@KAXXZ @ 0x1C008F0EC
 * Callers:
...
void VIDMM_GLOBAL::ReadUnusedAllocationConfiguration(void)
{
  ...
  xmmword_1C004E230 = (__int128)_mm_load_si128((const __m128i *)&_xmm);
  xmmword_1C004E250 = (__int128)_mm_load_si128((const __m128i *)&_xmm);
  xmmword_1C004E240 = (__int128)_mm_load_si128((const __m128i *)&_xmm);
  xmmword_1C004E270 = (__int128)_mm_load_si128((const __m128i *)&_xmm);
  v6 = 1000000;
  v11 = 1000000;
  xmmword_1C004E260 = (__int128)_mm_load_si128((const __m128i *)&_xmm);
  v1 = 1;
  v3 = 15;
  v8 = 1;
  v12 = 15;
  v13 = 15;
  qword_1C004E228 = 1LL;
  xmmword_1C004E300 = (__int128)_mm_load_si128((const __m128i *)&_xmm);
  v2 = 0;
  v4 = 45;
  v5 = 120;
  v7 = 0;
  ...
  v14 = 30;
  v15 = 30;
  xmmword_1C004E2F0 = (__int128)_mm_load_si128((const __m128i *)&_xmm);
  ...
  v16[3] = &qword_1C004E228;
  v16[5] = &v1;
  v16[9] = L"Unused.MinimumThreshold";
  v16[10] = &xmmword_1C004E230;
  v16[12] = &v2;
  v16[16] = L"Unused.LowThreshold";
  v16[17] = (char *)&xmmword_1C004E230 + 8;
  v16[19] = &v3;
  v16[23] = L"Unused.NormalThreshold";
  v16[24] = &xmmword_1C004E240;
  v16[26] = &v4;
  LODWORD(v16[8]) = 288;
  ...
  qword_1C004E228 *= 10000000LL;
  *(_QWORD *)&xmmword_1C004E230 = 10000000 * xmmword_1C004E230;
  *((_QWORD *)&xmmword_1C004E230 + 1) *= 10000000LL;
  *(_QWORD *)&xmmword_1C004E240 = 10000000 * xmmword_1C004E240;
  *((_QWORD *)&xmmword_1C004E240 + 1) *= 10000000LL;
  *(_QWORD *)&xmmword_1C004E250 = 10000000 * xmmword_1C004E250;
  *((_QWORD *)&xmmword_1C004E250 + 1) *= 10000000LL;
  *(_QWORD *)&xmmword_1C004E260 = 10000000 * xmmword_1C004E260;
  *((_QWORD *)&xmmword_1C004E260 + 1) *= 10000000LL;
  *(_QWORD *)&xmmword_1C004E270 = 10000000 * xmmword_1C004E270;
  *((_QWORD *)&xmmword_1C004E270 + 1) *= 10000000LL;
  do
  {
    *(_QWORD *)v0 *= 10000000LL;
    v0 = (__int128 *)((char *)v0 + 8);
  }
  while ( (__int64)v0 < (__int64)&qword_1C004E310 );
}
