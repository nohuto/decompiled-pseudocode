/*
 * XREFs of McTemplateK0qpxxxqqxpu @ 0x1C0029738
 * Callers:
...
ULONG __fastcall McTemplateK0qpxxxqqxpu(
        __int64 a1,
        __int64 a2,
        __int64 a3,
        int a4,
        ...
        char a13)
{
  ...
  EVENT_DATA_DESCRIPTOR EventData; // [rsp+40h] [rbp-B1h] BYREF
  ...
  v33 = 8LL;
  v35 = 1LL;
  return McGenEventWrite((PMCGEN_TRACE_CONTEXT)&DxgkControlGuid_Context, &EventReportSegment, 0LL, 0xBu, &EventData);
}
