/*
 * XREFs of ?MapPagesIntoAperture@VIDMM_APERTURE_SEGMENT@@UEAAJKPEAU_MDL@@HPEAPEAXPEA_K@Z @ 0x1C00BC240
 * Callers:
 *     <none>
 * Callees:
        ...
        union _LARGE_INTEGER *a6)
{
  ...
  {
    *a6 = v11[0];
    (*((void (__fastcall **)(VIDMM_LINEAR_POOL **, _QWORD, _QWORD))*this + 27))(this, 0LL, a2);
  }
