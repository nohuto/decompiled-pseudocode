/*
 * XREFs of ?VidSchiFreeCompletedHwQueuePacket@@YAXPEAU_VIDSCH_QUEUE_PACKET@@@Z @ 0x1C00355DC
 * Callers:
...
void __fastcall VidSchiFreeCompletedHwQueuePacket(struct _VIDSCH_QUEUE_PACKET *a1)
{
  ...
  *((_QWORD *)a1 + 5) = 0LL;
  ...
  if ( v11 != v2 + 136 )
  {
    LOBYTE(v10) = v11 == *(_QWORD *)(v2 + 184);
    v10 = (unsigned int)(v10 + 1);
  }
  VidSchiSetHwQueueState(v2, v10);
  _InterlockedDecrement((volatile signed __int32 *)(v6 + 708));
  _InterlockedDecrement((volatile signed __int32 *)(v4 + 2852));
  _InterlockedDecrement((volatile signed __int32 *)(v5 + 1280));
  _InterlockedDecrement((volatile signed __int32 *)(v2 + 128));
  ...
  VidSchiSignalRegisteredEvent(v6, (struct _KEVENT **)(v6 + 1576));
