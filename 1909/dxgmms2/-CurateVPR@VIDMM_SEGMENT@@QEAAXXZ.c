/*
 * XREFs of ?CurateVPR@VIDMM_SEGMENT@@QEAAXXZ @ 0x1C00BF0D0
 * Callers:
 ...
 *     Percentagex100 @ 0x1C00C0798 (Percentagex100.c)
 *     ?CalculateCapacity@VIDMM_LINEAR_POOL@@QEAA_KXZ @ 0x1C00C7D44 (-CalculateCapacity@VIDMM_LINEAR_POOL@@QEAA_KXZ.c)
 */
