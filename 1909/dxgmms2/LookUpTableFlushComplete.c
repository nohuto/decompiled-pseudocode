/*
 * XREFs of LookUpTableFlushComplete @ 0x1C0091E94
 * Callers:
 ...
 *     ?TlgAggregateInternalRegisteredProviderEtwCallback@@YAXPEBU_GUID@@KE_K1PEAU_EVENT_FILTER_DESCRIPTOR@@PEAX@Z @ 0x1C00829D0 (-TlgAggregateInternalRegisteredProviderEtwCallback@@YAXPEBU_GUID@@KE_K1PEAU_EVENT_FILTER_DESCRIP.c)
 ...
 *     UpdateInternalStatsOnFlush @ 0x1C00CE38C (UpdateInternalStatsOnFlush.c)
 */
  ...
  if ( a1[64] )
  {
    ...
    if ( *(_QWORD *)(v4 + 288) )
    {
        ...
        && (qword_1C004E098 & 0x400000000000LL) == qword_1C004E098 )
      {
        ...
        v33 = 4LL;
        v35 = 4LL;
        TlgWrite((TraceLoggingHProvider)&dword_1C004E080, &unk_1C00411A7, 0LL, v5, 0xBu, &pData);
      }
