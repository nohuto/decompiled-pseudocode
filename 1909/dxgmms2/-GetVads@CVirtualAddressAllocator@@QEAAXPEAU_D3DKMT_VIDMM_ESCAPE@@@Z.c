/*
 * XREFs of ?GetVads@CVirtualAddressAllocator@@QEAAXPEAU_D3DKMT_VIDMM_ESCAPE@@@Z @ 0x1C00B7FD0
 * Callers:
...
void __fastcall CVirtualAddressAllocator::GetVads(struct _KTHREAD **this, struct _D3DKMT_VIDMM_ESCAPE *a2)
{
  ...
  _QWORD **v45; // rsi
  _QWORD *i; // rax
  _BYTE v47[32]; // [rsp+20h] [rbp-48h] BYREF

  DXGAUTOPUSHLOCKEXCLUSIVE::DXGAUTOPUSHLOCKEXCLUSIVE((DXGAUTOPUSHLOCKEXCLUSIVE *)v47, this + 7);
  ...
  if ( (_DWORD)VaRangeIndex )
  {
    ...
    if ( v7 )
    {
      ...
      if ( (_DWORD)VaRangeIndex )
      {
        ...
        if ( (_DWORD)VaRangeIndex )
        {
          if ( (_DWORD)VaRangeIndex != 1 )
            goto LABEL_84;
          PhysicalAdapterIndex = this[10];
          Value = a2->SetFault.Value;
          if ( (unsigned int)Value < *((_DWORD *)PhysicalAdapterIndex + 1748) )
          {
            v10 = *((_QWORD *)PhysicalAdapterIndex + 5023) + 1560 * Value;
            ...
            while ( 1 )
            {
              ...
              v13 = *(_QWORD *)(*((_QWORD *)this[10] + 464)
                              + 8LL
                              * (v5 + *(_DWORD *)(1560LL * a2->SetFault.Value + *((_QWORD *)this[10] + 5023) + 20)));
        ...
        else
        {
          ...
          if ( (unsigned int)v14 < *((_DWORD *)PhysicalAdapterIndex + 1748) )
          {
            v15 = *((_QWORD *)PhysicalAdapterIndex + 5023) + 1560 * v14;
            v16 = *(_QWORD *)(v15 + 440);
      ...
      else
      {
        ...
        if ( (unsigned int)v19 < *((_DWORD *)PhysicalAdapterIndex + 1748) && a2->GetVads.GetPte.NumPtes <= 0x40 )
        {
          v20 = *((_QWORD *)PhysicalAdapterIndex + 5023) + 1560 * v19;
          v21 = *(_DWORD **)(v20 + 440);
