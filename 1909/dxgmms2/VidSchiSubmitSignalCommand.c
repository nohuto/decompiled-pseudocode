/*
 * XREFs of VidSchiSubmitSignalCommand @ 0x1C0012AA0
 * Callers:
...
void __fastcall VidSchiSubmitSignalCommand(struct _VIDSCH_QUEUE_PACKET *a1)
{
  ...
  else
  {
    ...
    if ( (*((_DWORD *)v2 + 68) & 1) != 0 )
    {
      if ( (v7 & 4) == 0 )
      {
        ...
        _InterlockedIncrement((volatile signed __int32 *)(v4 + 900));
        v7 = *((_DWORD *)v2 + 20);
        v6 = (_QWORD *)v12[0];
      }
      v8 = v7 | 9;
  ...
  while ( 1 )
  {
    ...
    *v6 = 0LL;
    v6[1] = 0LL;
    HwQueueStagingList::ProcessHwQueue((HwQueueStagingList *)v12, (struct VIDSCH_HW_QUEUE *)(v6 - 19));
    v6 = (_QWORD *)v12[0];
  }
  v13 = 1;
