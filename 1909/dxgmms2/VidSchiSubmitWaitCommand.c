/*
 * XREFs of VidSchiSubmitWaitCommand @ 0x1C0012410
 * Callers:
...
void __fastcall VidSchiSubmitWaitCommand(struct _VIDSCH_QUEUE_PACKET *a1)
{
    ...
    || _InterlockedCompareExchange((volatile signed __int32 *)(v4 + 200), 0, 0) )
  {
    ...
    if ( (v17 & 1) == 0 )
    {
      ...
      if ( (v17 & 4) != 0 )
        ...
        VidSchiUnwaitWaitQueuePacket((__int64)v18, (__int64)v2, v8);
    }
  }
  if ( (*((_DWORD *)v2 + 68) & 1) != 0 )
  {
  ...
  else
  {
    ...
    VidSchiUpdateContextStatus(v1, (_QWORD *)4, 23564LL);
  }
  while ( 1 )
  {
    v9 = (_QWORD *)v18[0];
    ...
    *v9 = 0LL;
    v9[1] = 0LL;
    HwQueueStagingList::ProcessHwQueue((HwQueueStagingList *)v18, (struct VIDSCH_HW_QUEUE *)(v9 - 19));
  }
  v19 = 1;
