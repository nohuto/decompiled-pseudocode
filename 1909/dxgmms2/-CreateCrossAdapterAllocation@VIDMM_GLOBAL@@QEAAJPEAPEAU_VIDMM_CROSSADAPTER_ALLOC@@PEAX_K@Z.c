/*
 * XREFs of ?CreateCrossAdapterAllocation@VIDMM_GLOBAL@@QEAAJPEAPEAU_VIDMM_CROSSADAPTER_ALLOC@@PEAX_K@Z @ 0x1C00AA950
 * Callers:
 *     VidMmCreateCrossAdapterAllocation @ 0x1C0024960 (VidMmCreateCrossAdapterAllocation.c)
 * Callees:
        ...
        SIZE_T a4)
{
  ...
  if ( !a3 || (v5 = MmSecureVirtualMemory(a3, a4, 4u)) != 0LL )
  {
    ...
    *a2 = (struct _VIDMM_CROSSADAPTER_ALLOC *)v14;
    ...
    {
      _InterlockedIncrement(&dword_1C004E71C);
      v16 = WdLogNewEntry5_WdLowResource(v13);
      *(_QWORD *)(v16 + 24) = 1952LL;
