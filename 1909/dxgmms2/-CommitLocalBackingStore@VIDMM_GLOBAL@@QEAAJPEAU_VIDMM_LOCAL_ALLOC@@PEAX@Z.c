/*
 * XREFs of ?CommitLocalBackingStore@VIDMM_GLOBAL@@QEAAJPEAU_VIDMM_LOCAL_ALLOC@@PEAX@Z @ 0x1C0075E08
 * Callers:
...
LABEL_53:
  ...
  if ( (v13 & 0x20) == 0 )
  {
    ...
    if ( v18 < 0 )
    {
      _InterlockedIncrement(&dword_1C004E668);
