/*
 * XREFs of VidSchiDiscardQueuePacket @ 0x1C00C9544
 * Callers:
 ...
 *     VidSchFlushPendingCommand @ 0x1C00CB0F0 (VidSchFlushPendingCommand.c)
 * Callees:
        ...
        __int64 a3)
{
  ...
  if ( *(_BYTE *)(v7 + 46) )
  {
    ...
    if ( v8 )
    {
      ...
      v23.AllocationListSize = *((_DWORD *)a1 + 85);
...
LABEL_16:
  if ( (*((_DWORD *)a1 + 18) & 0x100) != 0 )
  {
    ...
    VidSchiSignalRegisteredEvent(v7, (struct _KEVENT **)(v7 + 1560));
    ...
    *(_QWORD *)(v7 + 1368) = MEMORY[0xFFFFF78000000320];
    KeSetEvent((PRKEVENT)(v7 + 1336), 0, 0);
