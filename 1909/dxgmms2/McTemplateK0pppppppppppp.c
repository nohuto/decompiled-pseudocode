/*
 * XREFs of McTemplateK0pppppppppppp @ 0x1C0025B08
 * Callers:
 ...
 *     VidMmReportContextAllocList @ 0x1C00B7370 (VidMmReportContextAllocList.c)
 *     VidMmReportMultiAlloc @ 0x1C00B7480 (VidMmReportMultiAlloc.c)
 *     ?ReportState@VIDMM_PAGE_TABLE_BASE@@QEAAXPEAVCVirtualAddressAllocator@@@Z @ 0x1C00B9E18 (-ReportState@VIDMM_PAGE_TABLE_BASE@@QEAAXPEAVCVirtualAddressAllocator@@@Z.c)
 * Callees:
 *     __security_check_cookie @ 0x1C0018050 (__security_check_cookie.c)
 *     McGenEventWrite @ 0x1C0025A44 (McGenEventWrite.c)
 */

ULONG McTemplateK0pppppppppppp(__int64 a1, const EVENT_DESCRIPTOR *a2, const GUID *a3, ...)
{
  ...
  v26 = 8LL;
  v28 = 8LL;
  return McGenEventWrite((PMCGEN_TRACE_CONTEXT)&DxgkControlGuid_Context, a2, a3, 0xDu, &EventData);
}
