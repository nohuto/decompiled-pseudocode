/*
 * XREFs of ?WaitDmaBufferNotBusy@VIDMM_DMA_POOL@@IEAAXPEAU_VIDMM_DMA_BUFFER@@EPEAE@Z @ 0x1C007DAF4
 * Callers:
 ...
 *     VidSchIsWorkerThread @ 0x1C0011830 (VidSchIsWorkerThread.c)
        ...
        unsigned __int8 *a4)
{
  ...
  VidSchRegisterCompletionEvent(*(_QWORD *)(*(_QWORD *)(v8 + 16) + 528LL), (__int64)v19);
  while ( *((_BYTE *)a2 + 24) == 1 )
  {
    if ( (unsigned int)VidSchWaitForCompletionEvent(
                         *(_QWORD *)(*(_QWORD *)(*(_QWORD *)this + 16LL) + 528LL),
                         (__int64)v19,
                         (const GUID *)1) == -1073741130 )
    {
      if ( a4 )
        *a4 = 1;
      break;
