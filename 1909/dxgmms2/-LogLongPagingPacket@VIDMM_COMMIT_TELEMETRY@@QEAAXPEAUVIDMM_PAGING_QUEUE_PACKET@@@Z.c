/*
 * XREFs of ?LogLongPagingPacket@VIDMM_COMMIT_TELEMETRY@@QEAAXPEAUVIDMM_PAGING_QUEUE_PACKET@@@Z @ 0x1C00C456C
 * Callers:
    ...
    && (unsigned int)_InterlockedIncrement((volatile signed __int32 *)(*((_QWORD *)this + 1) + 252LL)) <= 5 )
  {
    ...
    *(_QWORD *)ActivityId.Data4 = 0LL;
      ...
      && (qword_1C004E060 & 0x400000000008LL) == qword_1C004E060 )
    {
      ...
      v14 = 2;
      v46 = 1;
      TlgWrite((TraceLoggingHProvider)&hProvider, &unk_1C0040839, &ActivityId, (LPCGUID)8, 0xBu, &pData);
    }
