/*
 * XREFs of ?InitGlobals@VIDMM_GLOBAL@@SAJXZ @ 0x1C008C144
 * Callers:
 *     VidMmInitGlobals @ 0x1C0017B40 (VidMmInitGlobals.c)
 * Callees:
 ...
 *     McGenEventRegister @ 0x1C0017B54 (McGenEventRegister.c)
...
__int64 VIDMM_GLOBAL::InitGlobals(void)
{
  ...
  if ( v9 )
  {
    ...
    qword_1C004E750 = (__int64)&VIDMM_RECYCLE_HEAP_MGR::_GlobalHeapManagerListHead;
    ...
    if ( v16 )
    {
      ...
      qword_1C004E780 = (__int64)&VIDMM_GLOBAL::_AdapterListHead;
...
LABEL_27:
  ...
  {
    _InterlockedAdd(&dword_1C004E61C, 1u);
