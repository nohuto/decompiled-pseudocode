/*
 * XREFs of ?VidMmReferenceWrittenPrimaries@VIDMM_GLOBAL@@QEAAJPEAVDXGDEVICE@@IQEBIIPEAU_VIDMM_PRIMARIES_REFERENCES@@PEAUVIDSCH_HW_QUEUE@@PEAPEAVDXGCONTEXT@@@Z @ 0x1C0073C40
 * Callers:
 *     VidMmReferenceWrittenPrimaries @ 0x1C0002AB0 (VidMmReferenceWrittenPrimaries.c)
 * Callees:
