...
char *__fastcall RtlpReAllocateHeap(unsigned __int16 *HeapHandle, int a2, char *a3, SIZE_T a4)
{
  ...
  unsigned int v92; // [rsp+E8h] [rbp-90h]
...
LABEL_3:
  ...
  if ( *((_BYTE *)HeapHandle + 418) == 2 )
  {
    if ( *((_QWORD *)HeapHandle + 51) )
    {
      ...
      if ( *((char *)v12 + 15) < 0 )
      {
        ...
        v16 = RtlpLFHKey ^ ((unsigned __int64)v12 >> 4) ^ *((_DWORD *)v12 + 2) ^ (unsigned int)HeapHandle;
        if ( (_WORD)v16 )
          v17 = 0LL;
        else
        ...
        else if ( (v19 & 0x3F) == 0x3F )
        {
          ...
          {
            if ( !((unsigned __int16)RtlpLFHKey ^ (unsigned __int16)(v15 ^ *(_WORD *)v14 ^ (unsigned __int16)HeapHandle)) )
              v7 = *(_QWORD *)&v72[-(((unsigned int)RtlpLFHKey ^ (unsigned int)v15 ^ *v14 ^ (unsigned int)HeapHandle) >> 12)];
            v21 = *(_WORD *)(v7 + 36);
          }
        ...
        if ( v79 )
        {
          RtlpLogHeapReallocateEvent((_DWORD)HeapHandle, (_DWORD)v79, (_DWORD)Src, v76, a4, 2);
          return (char *)v79;
        }
        return (char *)v27;
      }
  ...
  if ( (v37 & 0x3F) != 0 )
  {
    ...
    else if ( (v37 & 0x3F) == 0x3F )
    {
      ...
      {
        if ( (unsigned __int16)RtlpLFHKey ^ (unsigned __int16)((unsigned __int16)HeapHandle ^ *v33 ^ ((unsigned __int64)v11 >> 4)) )
          LOWORD(v41) = MEMORY[0x24];
        else
          LOWORD(v41) = *(_WORD *)(*(_QWORD *)&v11[-(((unsigned int)RtlpLFHKey ^ (unsigned int)HeapHandle ^ *(_DWORD *)v33 ^ (unsigned int)((unsigned __int64)v11 >> 4)) >> 12)]
                                 + 36LL);
        v28 = v102;
      }
...
LABEL_108:
    ...
    *(_QWORD *)v78 = v74 >> 4;
    if ( v74 >> 4 > v34 )
    {
      if ( *v36 == 4 || !(unsigned __int8)RtlpGrowBlockInPlace((int)HeapHandle, v74 >> 4) )
      {
        if ( (v28 & 0x10) != 0 )
        {
          Src = 0LL;
        ...
        else
        {
          ...
          if ( (v56 & 2) != 0 )
          {
            ...
            v102 = v55;
            v57 = *(_WORD *)(RtlpGetExtraStuffPointer(v11) + 2);
            if ( v57 > 0 )
            {
            ...
            if ( *v59 )
            {
              ...
              *((_DWORD *)v61 + 2) = v62;
              if ( HIBYTE(v62) != ((unsigned __int8)v62 ^ (unsigned __int8)(BYTE1(v62) ^ BYTE2(v62))) )
                RtlpAnalyzeHeapFailure(HeapHandle, v61);
            }
            if ( (v61[10] & 2) != 0 )
            {
              ExtraStuffPointer = (_QWORD *)RtlpGetExtraStuffPointer(v61);
              ...
              if ( (v11[10] & 2) != 0 )
              {
                v65 = RtlpGetExtraStuffPointer(v11);
    ...
    if ( (v11[10] & 2) != 0 )
    {
      ...
      *(_OWORD *)v82 = *(_OWORD *)v98;
      ...
      if ( (NtGlobalFlag & 0x800) != 0 )
      {
        v43 = *(_QWORD *)v78;
        v34 = v75;
        *(_WORD *)(v82 + 2) = RtlpUpdateTagEntry(
                                (_DWORD)HeapHandle,
                                *(unsigned __int16 *)(v82 + 2),
                                v75,
                                *(_DWORD *)v78,
                                4);
LABEL_119:
...
LABEL_135:
            ...
            if ( v43 != v34 )
            {
              if ( *v81 == 4 )
              {
                ...
                v43 = *(_QWORD *)v78;
                if ( (v92 & 0x800) != 0 )
                  *((_WORD *)v49 + 9) = RtlpUpdateTagEntry(
                                          (_DWORD)HeapHandle,
                ...
                v87[0] = &v49[v74];
                v85 = 16 * v75 - v74;
                v84 = RtlpSecMemFreeVirtualMemory(v74, v87, &v85, 0x4000LL);
                if ( v84 >= 0 )
                {
                  *((_QWORD *)v49 + 4) -= v85;
                  v11 = v73;
              ...
              else
              {
                ...
                *v89 = v43;
                ...
                if ( v52 )
                  ...
                  v53 = HeapHandle;
                v95 = v53;
                RtlpCreateSplitBlock((int)HeapHandle, v51 != 0, v43, v50);
              }
            }
            if ( *v81 != 4 )
            {
    ...
    else
    {
      ...
      {
        v43 = *(_QWORD *)v78;
        v11[11] = RtlpUpdateTagEntry((_DWORD)HeapHandle, (unsigned __int8)v11[11], *v33, *(_DWORD *)v78, 4);
        LOBYTE(v28) = v102;
        v34 = v75;
        v44 = a4;
        goto LABEL_120;
...
LABEL_193:
  ...
  {
    RtlpLogHeapReallocateEvent((_DWORD)HeapHandle, (_DWORD)Src, (_DWORD)v88, v77, a4, 3);
    return Src;
  }
  return v70;
}
