/*
 * XREFs of RtlCreateSystemVolumeInformationFolder @ 0x180086CB0
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall RtlCreateSystemVolumeInformationFolder(unsigned __int16 *a1)
{
  ...
  else
  {
    ...
    RtlFreeHeap((__int64)NtCurrentPeb()->ProcessHeap, 0, (__int64)v11.Buffer);
    ProcessHeap = NtCurrentPeb()->ProcessHeap;
    if ( v6 < 0 )
    {
      RtlFreeHeap((__int64)ProcessHeap, 0, (__int64)v22);
      v8 = NtCurrentPeb();
      Buffer = v21;
    }
    else
  ...
  RtlFreeHeap((__int64)v8->ProcessHeap, 0, (__int64)Buffer);
