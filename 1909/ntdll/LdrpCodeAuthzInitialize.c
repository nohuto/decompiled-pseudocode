...
__int64 LdrpCodeAuthzInitialize()
{
  ...
  if ( (unsigned __int16)(*(_WORD *)(v16 + 92) - 2) > 1u )
    return 0LL;
  if ( (int)NtOpenKey(&v13, 3LL, &unk_180118818) < 0
    || (v3 = NtQueryValueKey(v13, &unk_1801193E8, 2LL, v29, 80, &v15), NtClose(v13), v3 < 0)
    || v30 != 4
    || v31 != 4
    || !v32 )
  {
    v9 = 0LL;
    v1 = 0;
    if ( (int)NtOpenKey(&v9, 131097LL, &unk_18015F530) >= 0 )
    {
    ...
    if ( (int)NtOpenKey(&Handle, 1LL, &unk_1801187E8) >= 0 )
    {
