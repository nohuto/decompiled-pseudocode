/*
 * XREFs of LdrpCodeAuthzInitialize @ 0x18007AA5C
 * Callers:
...
__int64 LdrpCodeAuthzInitialize()
{
  ...
  if ( (unsigned __int16)(OutHeaders->OptionalHeader.Subsystem - 2) > 1u )
    return 0LL;
  if ( NtOpenKey(&KeyHandle, 3u, (POBJECT_ATTRIBUTES)&stru_180118818) < 0
    || (v3 = NtQueryValueKey(KeyHandle, (PUNICODE_STRING)&stru_1801193E8, KeyValuePartialInformation, v24, 0x50u, v14),
        NtClose(KeyHandle),
        v3 < 0)
    || v25 != 4
    || v26 != 4
    || !v27 )
  {
    v9 = 0LL;
    v1 = 0;
    if ( NtOpenKey(&v9, 0x20019u, &stru_18015F530) >= 0 )
    {
    ...
    if ( NtOpenKey(&Handle, 1u, (POBJECT_ATTRIBUTES)&stru_1801187E8) >= 0 )
    {
      if ( NtQueryValueKey(
             Handle,
