/*
 * XREFs of RtlNtPathNameToDosPathName @ 0x1800021A0
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall RtlNtPathNameToDosPathName(int a1, unsigned __int16 *a2, _DWORD *a3, _QWORD *a4)
{
  ...
  v9 = (const wchar_t *)&RtlpDosDevicesUncPrefix;
  LOBYTE(a3) = 1;
  if ( (unsigned __int8)RtlPrefixUnicodeString(&RtlpDosDevicesUncPrefix, a2, a3) )
  {
    v11 = (unsigned __int16 *)&unk_180119260;
    if ( v6 )
      *v6 = 2;
    goto LABEL_10;
  }
  ...
  if ( !(unsigned __int8)RtlPrefixUnicodeString(L"\b\n", a2, v10) )
  {
    if ( !v6 )
      return v4;
    v18 = RtlDetermineDosPathNameType_Ustr(a2);
    if ( v18 )
    {
      if ( v18 <= 0 )
        return v4;
