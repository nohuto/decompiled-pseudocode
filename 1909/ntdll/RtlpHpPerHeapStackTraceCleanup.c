/*
 * XREFs of RtlpHpPerHeapStackTraceCleanup @ 0x180101830
 * Callers:
 *     RtlpHpStackTraceHeapDestroy @ 0x18004ACC8 (RtlpHpStackTraceHeapDestroy.c)
 *     RtlpHpStackTraceHeapDisable @ 0x1801025A0 (RtlpHpStackTraceHeapDisable.c)
 * Callees:
...
LABEL_13:
      ...
      v11 = 0LL;
LABEL_21:
      RtlStackDbStackRemove(&qword_1801663B0, *(_QWORD *)(v11 + 16));
      v16 = RtlpHpEnvHandle;
