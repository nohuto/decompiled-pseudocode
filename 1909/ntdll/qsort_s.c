/*
 * XREFs of qsort_s @ 0x180091070
 * Callers:
 *     <none>
 * Callees:
 *     _invalid_parameter @ 0x18008CD78 (_invalid_parameter.c)
 *     __security_check_cookie @ 0x18008CE50 (__security_check_cookie.c)
 *     _guard_check_icall @ 0x1800933B0 (_guard_check_icall.c)
    ...
    if ( NumOfElements >= 2 )
    {
      ...
      while ( 1 )
      {
        while ( 1 )
        {
          ...
          v19 = &v7[v18];
          if ( ((int (__fastcall *)(void *, char *, char *))CompareFunction)(Context, v7, &v7[v18]) > 0 )
          {
            v20 = SizeOfElements;
            v21 = &v7[v18];
            if ( v7 != v19 )
          ...
          if ( ((int (__fastcall *)(void *, char *, char *, rsize_t))CompareFunction)(Context, v7, v8, v20) > 0 )
          {
            v23 = SizeOfElements;
            v24 = v8;
            if ( v7 != v8 )
          ...
          if ( ((int (__fastcall *)(void *, char *, char *))CompareFunction)(Context, &v7[v18], v8) > 0 )
          {
            v27 = SizeOfElements;
            v28 = v8;
            if ( v19 != v8 )
            ...
            if ( (unsigned __int64)v19 > v31 )
            {
              while ( 1 )
              {
                ...
                if ( v31 >= (unsigned __int64)v19 )
                  break;
                if ( ((int (__fastcall *)(void *, unsigned __int64, char *))CompareFunction)(Context, v31, v19) > 0 )
                {
                  if ( (unsigned __int64)v19 > v31 )
                    goto LABEL_38;
                  goto LABEL_36;
...
LABEL_36:
            ...
            while ( v31 <= (unsigned __int64)v8
                 && ((int (__fastcall *)(void *, unsigned __int64, char *))CompareFunction)(Context, v31, v19) <= 0 );
            do
            {
LABEL_38:
              v33 = v32;
            ...
            while ( v32 > v19 && ((int (__fastcall *)(void *, char *, char *))CompareFunction)(Context, v32, v19) > 0 );
          ...
          if ( v19 < v33 )
          {
            while ( 1 )
            {
              ...
              if ( v33 <= v19 )
                break;
              if ( ((unsigned int (__fastcall *)(void *, char *, char *))CompareFunction)(Context, v33, v19) )
              {
                if ( v19 >= v33 )
                  break;
                v7 = v40;
          ...
          do
            v33 -= SizeOfElements;
          while ( v33 > v40
               && !((unsigned int (__fastcall *)(void *, char *, char *))CompareFunction)(Context, v33, v19) );
LABEL_56:
          v9 = v39;
