...
__int64 __fastcall LdrpHandleTlsData(__int64 a1)
{
  ...
  else
  {
    ...
    if ( v8 >= 0 )
    {
      ...
      if ( v7 + 16 >= v7 )
      {
        Heap = (_BYTE *)RtlAllocateHeap((__int64)ProcessHeap, NtdllBaseTag + 786432, v9);
        v41 = Heap;
        if ( !Heap )
          v8 = -1073741801;
      }
  ...
  *((_DWORD *)Heap + 2) = LdrpActiveThreadCount;
  ...
  while ( 1 )
  {
    ...
    v43 = v16;
    v19 = RtlAllocateHeap((__int64)ProcessHeap, NtdllBaseTag + 786432, v16 + v13 + 1);
    v46 = v19;
    if ( !v19 )
    {
      v32 = -1073741801;
...
LABEL_30:
  ...
  while ( (_DWORD)v17 )
  {
    ...
    if ( (Heap[24 * v17 + 16] & 2) != 0 )
    {
      ...
      if ( v22 )
      {
        LdrpQueueDeferredTlsData(v24, *(_QWORD *)&Heap[24 * v17 + 32]);
        continue;
      }
      v28 = *(_QWORD *)(v24 - 8);
      goto LABEL_52;
