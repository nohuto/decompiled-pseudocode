/*
 * XREFs of RtlIpv6StringToAddressA @ 0x18007AFD0
 * Callers:
 *     RtlIpv6StringToAddressExA @ 0x18007AF00 (RtlIpv6StringToAddressExA.c)
 * Callees:
 *     __isascii @ 0x18008D4B0 (__isascii.c)
 *     isdigit @ 0x18008D5F0 (isdigit.c)
 *     isxdigit @ 0x18008D740 (isxdigit.c)
 *     strtol @ 0x1800922E0 (strtol.c)
