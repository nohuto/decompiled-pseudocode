 ...
 *     __C_specific_handler @ 0x18008D2E0 (__C_specific_handler.c)
 *     KiUserCallbackDispatcherHandler @ 0x1800A0B60 (KiUserCallbackDispatcherHandler.c)
 *     __longjmp_internal @ 0x1800A3950 (__longjmp_internal.c)
 * Callees:
 ...
 *     RtlCaptureContext2 @ 0x1800A1020 (RtlCaptureContext2.c)
 *     RtlpGuardSynchronizeRestorePc @ 0x1800A1610 (RtlpGuardSynchronizeRestorePc.c)
 *     _alloca_probe @ 0x1800A1EE0 (_alloca_probe.c)
 *     RtlpExecuteHandlerForUnwind @ 0x1800A2070 (RtlpExecuteHandlerForUnwind.c)
        ...
        PUNWIND_HISTORY_TABLE HistoryTable)
{
  ...
  if ( !(unsigned __int8)RtlpGetStackLimits(&v126, &v125) )
    goto LABEL_205;
  ...
  while ( 2 )
  {
    ...
    if ( !v118 )
    {
      ...
      RtlpPopUserShadowStack(v15, v20, v21);
      goto LABEL_77;
    }
    RtlpCopyContext(v14, v15);
    v23 = ImageBase;
    v24 = 0;
    ...
    else
    {
      ...
      if ( *(_BYTE *)(v25 + 2) )
      {
        do
        {
          ...
          if ( (BYTE1(v107) & 0xF) == 3 )
            break;
          v106 = (unsigned int)RtlpUnwindOpSlots(v107, v30) + (unsigned int)v106;
        }
...
LABEL_18:
    ...
    if ( v26 >= 2 )
    {
      ...
      RtlpUnwindEpilogue(v23, v93, v91 - v93, (_DWORD)v118, (__int64)v14, 0LL, 0LL, 0LL);
      v23 = ImageBase;
      goto LABEL_56;
    }
    v19 = (ULONG64)v119;
...
LABEL_52:
              ...
              else
              {
                if ( (v54 & 0xF0) != 0x40 || (v97 = v52[1], (v97 & 0xF8) != 0x58) )
                {
                  ...
                  RtlpPopUserShadowStack(v14, v54, v52);
                  v23 = ImageBase;
                  goto LABEL_55;
                }
...
LABEL_29:
    ...
    {
LABEL_156:
      v103 = RtlpSameFunction(v83, v23, v84 + v23);
      if ( !v103 || v84 == *v103 )
        goto LABEL_49;
LABEL_139:
      v23 = ImageBase;
    ...
    while ( 1 )
    {
      ...
      if ( v42 )
      {
        do
        {
          ...
          {
            v40 = (unsigned int)RtlpUnwindOpSlots(*((unsigned __int16 *)v43 + 2), v43) + (unsigned int)v40;
          }
          else
          {
...
LABEL_205:
    ...
    if ( v51 )
    {
      ...
      do
      {
        ...
        v60 = RtlpExecuteHandlerForUnwind(v59, v18, v15, &ControlPc);
        ...
        if ( v62 )
        {
          ...
          ImageBase = v131;
          v118 = FunctionEntry;
          RtlpCopyContext(v141, v135);
          v14 = v127;
          v15 = v101;
          RtlpCopyContext(v127, v101);
          v102 = RtlVirtualUnwind(2u, v99, v19, v100, v14, &HandlerData, &EstablisherFrame, 0LL);
          v120 = v102;
          if ( ((*((_QWORD *)&xmmword_18017A390 + 1) >> 12) & 3) == 1 )
          {
...
LABEL_204:
  ...
  RtlGuardRestoreContext(v15, v77);
}
