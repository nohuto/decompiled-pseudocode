        ...
        __int64 a8)
{
  ...
  if ( (*(_BYTE *)v13 & 1) != 0 )
  {
    ...
    if ( (unsigned int)RtlGetCurrentServiceSessionId() )
      ...
      v22 = 2147353476LL;
    LdrpTraceLoadMUIDll(&v40, *(unsigned __int8 *)v22);
  }
  else
  {
    v14 = 2147353476LL;
...
LABEL_37:
      if ( v34 )
      {
        ...
        if ( (int)result < 0 )
          return result;
        v25 = LdrpResSearchResourceHandle((HANDLE)Handle, v36, v35, v33, v32);
      }
      else
      {
        v20 = v35;
        v21 = v30;
        v18 = LdrpResSearchResourceMappedFile((_DWORD)v29, v28, v16, (unsigned int)v46, v30, v36, v35, v33, v32);
        v27 = v18;
        if ( v18 != -1073741686 )
          goto LABEL_25;
        ...
        if ( MappingSize < 0 )
          goto LABEL_25;
        v25 = LdrpResSearchResourceMappedFile(v37, v28, v16 | 0x1000000, (unsigned int)v46, v21, v36, v20, v33, v32);
      }
      v18 = v25;
      v27 = v25;
LABEL_25:
      ...
      if ( (*(_BYTE *)v12 & 1) != 0 )
      {
        ...
        LdrpTraceLoadMUIDll(&v42, *(unsigned __int8 *)v14);
      }
      return v18;
    }
...
LABEL_95:
  ...
  if ( (v16 & 0x200) == 0 )
    goto LABEL_84;
  if ( (Handle & 1) == 0 )
    v29 = (wchar_t *)(Handle | 1);
  if ( (v16 & 0x1000) == 0
    || (result = ZwQueryVirtualMemory(-1LL, Handle & 0xFFFFFFFFFFFFFFFCuLL, 0LL, v45, 48LL, 0LL), (int)result >= 0) )
  {
LABEL_84:
