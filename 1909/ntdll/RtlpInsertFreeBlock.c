/*
 * XREFs of RtlpInsertFreeBlock @ 0x18004580C
 * Callers:
...
void __fastcall RtlpInsertFreeBlock(unsigned __int64 a1, __int64 a2, unsigned __int64 a3)
{
  ...
  if ( a3 )
  {
    ...
    v7 = *(_BYTE *)(v5 + 14);
    if ( v7 )
      v8 = (v5 & 0xFFFFFFFFFFFF0000uLL) - ((unsigned __int64)v7 << 16) + 0x10000;
    else
      v8 = a1;
    v9 = *(_BYTE *)(v5 + 10);
    v10 = (_QWORD *)(a1 + 336);
    ...
    while ( 1 )
    {
      ...
      *(_QWORD *)(a1 + 192) += *(unsigned __int16 *)(v5 + 8);
      ...
      if ( v20 )
      {
        for ( i = *((unsigned int *)v20 + 2); ; i = *((unsigned int *)v22 + 2) )
        {
...
LABEL_29:
        LOBYTE(Entry) = 1;
        RtlpHeapAddListEntry(a1, (_DWORD)v20, (_DWORD)Entry, v5 + 16, v23, *(unsigned __int16 *)(v5 + 8));
      }
      if ( *(_DWORD *)(a1 + 124) )
      {
