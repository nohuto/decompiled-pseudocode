...
__int64 __fastcall RtlCheckTokenCapability(void *a1, __int64 a2, _BYTE *a3)
{
  ...
  char v28[56]; // [rsp+1D0h] [rbp+D0h] BYREF
  ...
  *a3 = 0;
  ...
  if ( v9 == -1073741700 )
  {
    ...
    v25[1] = 2;
    v26 = 1;
    v9 = NtDuplicateToken(Handle, 8LL, &v17);
    NtClose(Handle);
  }
  if ( v9 >= 0 )
  {
...
LABEL_4:
    ...
    RtlpAddKnownAce((unsigned int)v27, 2, 0, 65537, v24[0], 0);
    RtlpAddKnownAce((unsigned int)v27, 2, 0, 65537, a2, 0);
    LOBYTE(v8) = 1;
