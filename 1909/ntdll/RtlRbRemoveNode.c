 ...
 *     RtlpHpVaMgrRangeCoalesce @ 0x18004E220 (RtlpHpVaMgrRangeCoalesce.c)
 ...
 *     RtlpHpVsFreeChunkRemove @ 0x1800687C4 (RtlpHpVsFreeChunkRemove.c)
 * Callees:
 *     <none>
 */
...
BOOLEAN __cdecl RtlRbRemoveNode(PRTL_RB_TREE Tree, PRTL_BALANCED_NODE Node)
{
  ...
  $7D93978C745EB1C2D28075BAF55422B4 v44; // cl
  _RTL_BALANCED_NODE *v45; // r15
  __int64 v46; // r11
  unsigned __int64 v47; // rax
  _RTL_BALANCED_NODE *v48; // rdx
  $87560DA0B77CFC7566AA725C77477589 *v49; // r8
  _RTL_BALANCED_NODE *v50; // r8
  char v51; // cl
  _RTL_BALANCED_NODE *v52; // rax
  $424C8BBEF8F6C852886B4C6E806B5DB0 v53; // al
  char v54; // cl
  unsigned __int64 v55; // rcx
  $7D93978C745EB1C2D28075BAF55422B4 v56; // cl
  _RTL_BALANCED_NODE *v57; // r8
  $87560DA0B77CFC7566AA725C77477589 *v58; // r10
  ...
  unsigned __int64 ParentValue; // r15
...
LABEL_48:
    ...
    v35 = v34 | v13 & 3;
    *(_QWORD *)(v10 + 16) = v35;
    *(_BYTE *)(v10 + 16) = v35 ^ (*(_BYTE *)&Node->0 ^ v35) & 1;
  ...
  if ( !v9 )
  {
    ...
    if ( (v16 & 1) != 0 )
    {
      ...
      v56 = ($7D93978C745EB1C2D28075BAF55422B4)(v111 | 1);
      Tree->0 = v56;
    }
    else
    {
      Tree->Min = (_RTL_BALANCED_NODE *)v5;
      v56 = ($7D93978C745EB1C2D28075BAF55422B4)v5;
    }
    if ( (*(_BYTE *)&v56 & 1) != 0 )
    {
...
LABEL_14:
  ...
  if ( !v5 )
  {
    ...
    while ( 1 )
    {
      ...
      v91 = v49->ParentValue & 0xFFFFFFFFFFFFFFFCuLL;
...
LABEL_92:
          v58 = &v9->16;
          *(_BYTE *)&v48->0 ^= (*(_BYTE *)&v9->0 ^ *(_BYTE *)&v48->0) & 1;
          *(_BYTE *)&v9->0 &= ~1u;
          *(_BYTE *)&v57->0 &= ~1u;
...
LABEL_106:
              ...
              *v67 = v9;
              ...
              v58->ParentValue |= (unsigned __int64)v48;
              if ( (*(_BYTE *)&Tree->0 & 1) == 0 )
              {
...
LABEL_329:
      ...
      if ( (*(_BYTE *)&v53 & 1) != 0 )
      {
        LOBYTE(v16) = *(_BYTE *)&v53 & 0xFE;
        v9->0 = ($424C8BBEF8F6C852886B4C6E806B5DB0)v16;
        *(_BYTE *)&v48->0 |= 1u;
        return v16;
      }
      *(_BYTE *)&v48->0 |= 1u;
