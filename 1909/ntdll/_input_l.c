...
__int64 __fastcall input_l(FILE *Stream, unsigned __int8 *a2, __int64 a3, __int64 a4)
{
  ...
  int v58; // [rsp+50h] [rbp-31h] BYREF
  int v59; // [rsp+54h] [rbp-2Dh]
...
LABEL_171:
        ...
        if ( v24 == 123 )
        {
          v48 = ReadStringDelimited(v47, &v73, &v58, &v57, SrcCh, v26, Stream, &v66);
          v5 = v73;
        }
        else
        {
          v48 = ReadString(v47, 0LL, &v58, &v57, SrcCh, v26, Stream, &v66);
        }
        v4 = v58;
        if ( !v48 )
        {
