/*
 * XREFs of RtlpSetSecurityObject @ 0x18007BBE0
 * Callers:
 *     RtlSetSecurityObject @ 0x18007BBB0 (RtlSetSecurityObject.c)
 *     RtlSetSecurityObjectEx @ 0x180089AD0 (RtlSetSecurityObjectEx.c)
 * Callees:
 ...
 *     NtOpenProcessToken @ 0x18009F2E0 (NtOpenProcessToken.c)
...
LABEL_136:
  ...
  if ( (a5 & 8) == 0 )
  {
    if ( !a8 )
      return (unsigned int)-1073741734;
    LODWORD(v100) = NtQueryInformationToken(a8, 10LL, v127, 56LL, v121);
    valid = v100;
    ...
    v8 = Size;
    if ( !RtlpValidOwnerSubjectContext((void *)Size, (__int64)v104, v102, (int *)&v100) )
      return (unsigned int)-1073741734;
  }
  v20 = v104;
LABEL_12:
...
LABEL_18:
  ...
  {
LABEL_83:
    LODWORD(v100) = RtlpGetDefaultTrustSubjectContext(v8, &v125);
    valid = v100;
    if ( (v100 & 0x80000000) != 0LL )
      return (unsigned int)valid;
    v50 = (__int64)v125;
...
LABEL_175:
      ...
      do
      {
        ...
        if ( AceByType )
        {
          ...
          if ( !(unsigned __int8)RtlpValidTrustSubjectContext(v51, AceByType + 8, v69, &v100) )
            goto LABEL_175;
        }
        ++v98;
      }
    ...
    if ( (a2 & 0x100) == 0 )
      goto LABEL_86;
    valid = RtlpValidFilterAclSubjectContext((__int64)v106, v51);
    if ( valid >= 0 )
    {
      if ( (a5 & 2) != 0 )
      {
LABEL_86:
      ...
      v72 = v51;
      v52 = (int)v85;
      valid = RtlpValidFilterAclSubjectContext((__int64)v85, v72);
      if ( valid >= 0 )
      {
LABEL_87:
...
LABEL_100:
          ...
          v56 = v55;
          v44 = v99;
          valid = RtlpCombineAcls(v99, v56, v101, v118, v119, v120, (__int64 *)&v122, 0LL);
          if ( valid < 0 )
            goto LABEL_57;
          v15 = v122;
          Src = v122;
...
LABEL_228:
              ...
              valid = NtQueryInformationToken(Handle, 4LL, Heap, v117, &v117);
              NtClose(Handle);
              if ( valid < 0 )
              {
                v79 = (__int64)Heap;
              ...
              LOBYTE(v80) = v103;
              valid = RtlpCreateServerAcl((_DWORD)v25, v80, *Heap, (unsigned int)&v124, (__int64)v96);
              ...
              if ( v30 )
              {
                ...
                *(_WORD *)(v31 + 2) = v34;
                ...
                if ( v25 )
                {
                  ...
                  RtlpApplyAclToObject((__int64)v32, a7);
...
LABEL_50:
                ...
                else
                {
                  v108 = 0;
                  v109 = 768;
                  valid = RtlInitializeSid((__int64)v130, (__int64)&v108, 1u);
                  if ( valid >= 0 )
                  {
                    v131 = 4;
                    v98 = 0;
                    while ( 1 )
                    {
                      ...
                      v82 = *(_QWORD *)(v31 + 32);
LABEL_251:
                      AceBySid = RtlFindAceBySid(v82, v130, &v98);
                      if ( !AceBySid )
                        goto LABEL_50;
...
LABEL_177:
  ...
  while ( 1 )
  {
    ...
    if ( v8 )
    {
      LODWORD(v100) = NtQueryInformationToken(v8, 10LL, v127, 56LL, v121);
      valid = v100;
      if ( (v100 & 0x80000000) != 0LL )
        return (unsigned int)valid;
      if ( v128 == 2 && v129 < 1 )
    ...
    {
      LODWORD(v100) = NtOpenProcessToken(-1LL, 8LL, &Handle);
      valid = v100;
      if ( (v100 & 0x80000000) != 0LL )
        return (unsigned int)valid;
    }
    ...
    if ( Size )
      v67 = Size;
    if ( !(unsigned __int8)RtlpValidLabelSubjectContext(v67, v63, v66, &v100) )
    {
      NtClose(Handle);
      break;
    }
