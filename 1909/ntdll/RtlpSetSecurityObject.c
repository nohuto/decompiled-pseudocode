...
LABEL_136:
  ...
  if ( (a5 & 8) == 0 )
  {
    if ( !TokenHandle )
      return (unsigned int)-1073741734;
    LODWORD(v98) = NtQueryInformationToken(TokenHandle, 0xAu, TokenInformation, 0x38u, &ReturnLength);
    valid = v98;
    ...
    v8 = (HANDLE)Size;
    if ( !RtlpValidOwnerSubjectContext((void *)Size, v102, v100, (NTSTATUS *)&v98) )
      return (unsigned int)-1073741734;
  }
  v20 = (char *)v102;
LABEL_12:
...
LABEL_18:
  ...
  {
LABEL_83:
    LODWORD(v98) = RtlpGetDefaultTrustSubjectContext(v8, v122);
    valid = v98;
    if ( (v98 & 0x80000000) != 0LL )
      return (unsigned int)valid;
    v50 = v122[0];
...
LABEL_175:
      ...
      do
      {
        ...
        if ( AceByType )
        {
          ...
          if ( !(unsigned __int8)RtlpValidTrustSubjectContext(v51, AceByType + 2, v68, &v98) )
            goto LABEL_175;
        }
        ++v96;
      }
...
LABEL_86:
      ...
      v71 = v51;
      v52 = (int)v84;
      valid = RtlpValidFilterAclSubjectContext(v84, v71);
      if ( valid >= 0 )
      {
LABEL_87:
...
LABEL_228:
              ...
              LOBYTE(v79) = v101;
              valid = RtlpCreateServerAcl((_DWORD)v25, v79, *Heap, (unsigned int)&v121, (__int64)v94);
              ...
              if ( v30 )
              {
                ...
                *v30 = 1;
                ...
                if ( Src )
                {
                  ...
                  RtlpApplyAclToObject((__int64)(v31 + 10), a7);
...
LABEL_251:
                      AceBySid = RtlFindAceBySid(v81, Sid, &v96);
                      if ( !AceBySid )
                        goto LABEL_50;
                      v83 = *(_BYTE *)(AceBySid + 1) & 0xF4 | 8;
                      ++v96;
                      *(_BYTE *)(AceBySid + 1) = v83;
                    }
                    if ( *((_DWORD *)v31 + 4) )
                    {
...
LABEL_177:
  ...
  while ( 1 )
  {
    ...
    if ( v8 )
    {
      LODWORD(v98) = NtQueryInformationToken(v8, 0xAu, TokenInformation, 0x38u, &ReturnLength);
      valid = v98;
      if ( (v98 & 0x80000000) != 0LL )
        return (unsigned int)valid;
      if ( v125 == 2 && v126 < 1 )
    ...
    {
      LODWORD(v98) = NtOpenProcessToken((HANDLE)0xFFFFFFFFFFFFFFFFLL, 8u, &Handle);
      valid = v98;
      if ( (v98 & 0x80000000) != 0LL )
        return (unsigned int)valid;
    }
    ...
    if ( Size )
      v66 = (void *)Size;
    if ( !(unsigned __int8)RtlpValidLabelSubjectContext(v66, v63) )
    {
      NtClose(Handle);
      break;
    }
