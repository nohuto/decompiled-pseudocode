...
__int64 __fastcall RtlpComputePath(_DWORD *a1, unsigned int a2, wchar_t *a3, char a4)
{
  ...
  v38 = a3;
  v36 = a1;
  v4 = ((unsigned __int64)xmmword_18017A390 >> 60) & 3;
  v35 = 0LL;
  v32 = 0LL;
  v5 = 0LL;
  Src = 0LL;
      ...
      if ( *v11 )
      {
        switch ( *v11 )
        {
          ...
          case 3:
            ...
            {
              Heap = (_WORD *)RtlAllocateHeap((__int64)NtCurrentPeb()->ProcessHeap, NtdllBaseTag + 1572864, 2 * v29);
              v33 = Heap;
              if ( !Heap )
              {
...
LABEL_67:
          ...
          case 7:
            ...
            break;
          default:
            v25 = (unsigned __int16)LdrpAppPackagesPath;
LABEL_70:
            v6 += 2LL;
LABEL_71:
            v6 += v25;
      ...
      {
        v25 = (unsigned __int16)LdrpDllDirectory;
        goto LABEL_70;
      }
      ++v10;
      ++v11;
