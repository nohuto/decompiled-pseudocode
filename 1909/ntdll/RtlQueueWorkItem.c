  ...
  else
  {
    ...
    if ( Heap )
    {
      ...
      if ( v6 >= 0 )
      {
        ...
        v40 = NtCurrentTeb();
        v8 = BaseAddress;
        *(_GUID *)(BaseAddress + 13) = v40->ActivityId;
...
LABEL_6:
          ...
          *((_DWORD *)BaseAddress + 2) = 0;
          v6 = TpReserveTaskPost(*v11, BaseAddress, &v28);
          v24 = v6;
          if ( v6 >= 0 )
          {
            v21 = 1;
            ...
            {
              RtlpxLookupFunctionTable(*v10, (signed __int64)DllHandle, v13, v14);
            }
            else
            {
              *(_OWORD *)DllHandle = xmmword_18017A500;
              v38 = qword_18017A510;
            }
            v15 = DllHandle[1];
...
LABEL_28:
  if ( v8 )
  {
    ...
    if ( v21 )
      TpUnreserveTaskPost((volatile signed __int32 *)v8[4], (__int64)&v28);
    if ( v22 )
      LdrUnloadDll(v8[10]);
    if ( v23 )
    {
