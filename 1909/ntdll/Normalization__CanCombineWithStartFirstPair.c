/*
 * XREFs of Normalization__CanCombineWithStartFirstPair @ 0x1800F9B14
 * Callers:
 ...
 *     Normalization__GetSecondDecomposedCharPlane0 @ 0x1800F9DA0 (Normalization__GetSecondDecomposedCharPlane0.c)
 */
