/*
 * XREFs of TppWorkPost @ 0x180038510
 * Callers:
...
int __fastcall TppWorkPost(__int64 a1)
{
  ...
  if ( v7 )
  {
    ...
    *(_QWORD *)(a1 + 128) = *(_QWORD *)NtCurrentTeb()->WorkingOnBehalfTicket;
    ...
    v12 = *(_DWORD *)(a1 + 192);
    if ( !v11 )
      v11 = (char *)TppPoolpGlobalPool;
    if ( v11 == (char *)TppPoolpSerializedPool )
      v12 = 1;
...
LABEL_22:
          ...
          Value = (_RTL_SRWLOCK **)v16[1].Value;
          if ( *Value != v16 )
            __fastfail(3u);
          *(_QWORD *)(a1 + 224) = Value;
          *v15 = v16;
          *Value = (_RTL_SRWLOCK *)v15;
          v16[1].Value = (unsigned __int64)v15;
          ...
          if ( v18 != 1 )
          {
            ...
            while ( v30 != v18 );
            if ( v28 == 2 )
              RtlpWakeSRWLock((volatile signed __int64 *)&v16[2], v29, 0);
          }
          ...
          if ( *((_DWORD *)v11 + 106) != v19 )
          {
            ...
            TppAdjustRunningThreadGoalWithLock(v11);
          ...
          while ( v24 != v6 );
          if ( v23 )
            LODWORD(v6) = NtReleaseWorkerFactoryWorker(*((HANDLE *)v11 + 7));
