/*
 * XREFs of Normalization__CanCombineWithStartBase @ 0x1800F9AC8
 * Callers:
 *     Normalization__IsNormalized @ 0x1800F9E3C (Normalization__IsNormalized.c)
 * Callees:
 *     Normalization__GetFirstDecomposedCharPlane0 @ 0x1800F9B9C (Normalization__GetFirstDecomposedCharPlane0.c)
 */
