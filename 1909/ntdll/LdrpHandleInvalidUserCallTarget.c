/*
 * XREFs of LdrpHandleInvalidUserCallTarget @ 0x18008D0D0
 * Callers:
 ...
 *     LdrpDispatchUserCallTarget @ 0x18008D230 (LdrpDispatchUserCallTarget.c)
 *     LdrpDispatchUserCallTargetES @ 0x18008D280 (LdrpDispatchUserCallTargetES.c)
 * Callees:
