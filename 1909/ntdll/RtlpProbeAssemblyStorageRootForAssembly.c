/*
 * XREFs of RtlpProbeAssemblyStorageRootForAssembly @ 0x180071980
 * Callers:
        ...
        HANDLE *a7)
{
  ...
  WCHAR *StringRoutine; // [rsp+98h] [rbp-68h]
  ...
  *(_QWORD *)&NtFileName.Length = 0LL;
  ...
  else
  {
    if ( v15 > 0x208 )
    {
      StringRoutine = (WCHAR *)NtdllpAllocateStringRoutine((unsigned __int16)v15);
      v7 = StringRoutine;
      if ( !StringRoutine )
      {
        DbgPrintEx(
    ...
    {
      v7 = DosFileName;
      StringRoutine = DosFileName;
    }
    memmove(v7, a2[1], (unsigned __int16)v11);
    v16 = (WCHAR *)((char *)v7 + *(unsigned __int16 *)a2);
    if ( v26 )
      *v16++ = 92;
    ...
    *(_WORD *)((char *)v16 + *(unsigned __int16 *)v28) = 0;
    ...
    if ( RtlDosPathNameToRelativeNtPathName_U(v7, &NtFileName, 0LL, &RelativeName) )
    {
...
LABEL_50:
        ...
        v25 = NtdllpAllocateStringRoutine(v15);
        *(_QWORD *)(a5 + 8) = v25;
        if ( v25 )
        {
          memmove(v25, v7, v18);
