/*
 * XREFs of RtlpHpLfhSubsegmentInitialize @ 0x18004A67C
 * Callers:
        ...
        __int64 a5)
{
  ...
  *(_WORD *)v17 = 1;
  ...
  v25 = (unsigned __int64)(unsigned int)RtlpHeapGenerateRandomValue32(v23, v21, v22) << 32;
  result = (v25 | (unsigned int)RtlpHeapGenerateRandomValue32(v27, v26, v28)) & 0x7F7F7F7F7F7F7F7FLL;
