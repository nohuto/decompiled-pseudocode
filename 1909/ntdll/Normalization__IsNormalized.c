/*
 * XREFs of Normalization__IsNormalized @ 0x1800F9E3C
 * Callers:
 ...
 *     Normalization__GetLastChar @ 0x1800F9C08 (Normalization__GetLastChar.c)
 */
...
LABEL_88:
        ...
        if ( v8 >= 44032 )
          break;
        if ( v4 > 1 && CanComposeHangul(v8, v5[1]) )
          goto LABEL_30;
...
LABEL_23:
    ...
    if ( *(_BYTE *)(a1 + 112) == 1 || v4 > 1 && CanComposeHangul(v8, v5[1]) )
      goto LABEL_30;
LABEL_90:
    v35 = 0;
    v27 = 0;
