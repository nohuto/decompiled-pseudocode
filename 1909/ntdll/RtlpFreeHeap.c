/*
 * XREFs of RtlpFreeHeap @ 0x180041AB0
 * Callers:
 ...
 *     RtlpUpdateHeapWatermarks @ 0x180084FF4 (RtlpUpdateHeapWatermarks.c)
...
LABEL_275:
  ...
  if ( *(_BYTE *)(v12 + 15) == 4 )
  {
    ...
    *(_QWORD *)(a1 + 592) -= *(_QWORD *)v137;
    ...
    {
      RtlpLogHeapFailure(13, 0, v101, v105, v104, 0LL);
    }
    if ( !v5 )
    {
...
LABEL_61:
          ...
          LODWORD(v120) = v33;
          LOBYTE(v33) = 1;
          RtlpHeapRemoveListEntry(a1, (_DWORD)v32, v33, v26 + 16, v35, v120);
        }
        *v30 = v29;
        *(_QWORD *)(v29 + 8) = v30;
      ...
      {
        RtlpLogHeapFailure(13, a1, v28, a4, v31, 0LL);
        v24 = v125;
      }
    }
    v36 = v12 + 16 * v24;
    ...
    if ( HIBYTE(v153) != ((unsigned __int8)v153 ^ (unsigned __int8)(BYTE1(v153) ^ BYTE2(v153))) )
      RtlpLogHeapFailure(3, a1, v12 + 16 * v24, 0, 0LL, 0LL);
    while ( 1 )
    {
      v24 = v125;
LABEL_70:
...
LABEL_95:
          v143 = v48;
          LOBYTE(v41) = 1;
          RtlpHeapRemoveListEntry(a1, (_DWORD)v45, v41, v36 + 16, v48, v46);
        }
        *v43 = v42;
        *(_QWORD *)(v42 + 8) = v43;
      ...
      {
        RtlpLogHeapFailure(13, a1, v41, a4, v44, 0LL);
      }
    }
    v159 = v12;
    v5 = v122;
          ...
          else
          {
            ...
            if ( (int)(v53 - (unsigned __int16)v62) <= 0 )
            {
              ...
              if ( *(_DWORD *)(a1 + 124) )
              {
                ...
                {
                  RtlpLogHeapFailure(3, a1, v63, 0, 0LL, 0LL);
                  v53 = v127;
                }
              }
              if ( (int)(v53 - (unsigned __int16)v64) > 0 )
              {
                if ( *v55 || (_DWORD)v134 != *((_DWORD *)v55 + 2) - 1 )
                {
                  ...
                  {
                    if ( (_BYTE)v69 )
                      v70 = (unsigned __int8)RtlpBitsClearLow[(unsigned __int8)v69];
                    else
                      v70 = (unsigned __int8)RtlpBitsClearLow[BYTE1(v69)] + 8;
                  }
                  else if ( (v69 & 0xFF0000) != 0 )
                  {
                    v70 = (unsigned __int8)RtlpBitsClearLow[BYTE2(v69)] + 16;
                  }
                  else
                  {
                    v70 = (unsigned __int8)RtlpBitsClearLow[(unsigned __int64)v69 >> 24] + 24;
                  }
...
LABEL_163:
                ...
                else
                {
                  ...
                  {
                    LOBYTE(a4) = 1;
                    if ( (int)RtlpHeapListCompare(a1, v66, v53, a4) <= 0 )
                    {
                      v59 = v66;
                      goto LABEL_163;
                    }
...
LABEL_168:
      ...
      {
        RtlpLogHeapFailure(13, 0, (_DWORD)v59, 0, *v74, 0LL);
      }
...
LABEL_235:
      ...
      *(_WORD *)(v100 - 4) = updated;
      *(_WORD *)(v100 - 2) = 0;
      if ( (*(_DWORD *)(a1 + 112) & 0x8000000) != 0 )
      {
        *(_WORD *)(v100 - 2) = RtlLogStackBackTraceEx(1u);
        v52 = 256;
        goto LABEL_276;
      }
      goto LABEL_114;
...
LABEL_211:
      v88 = (_QWORD *)(a1 + 336);
      if ( *(_QWORD *)(a1 + 312) )
        Entry = (_QWORD *)RtlpFindEntry(a1, v85);
      else
        Entry = (_QWORD *)*v88;
      while ( v88 != Entry )
      {
      ...
      {
        RtlpLogHeapFailure(13, 0, (_DWORD)Entry, 0, *v93, 0LL);
      }
      *(_QWORD *)(a1 + 192) += *(unsigned __int16 *)(v12 + 8);
      v94 = *(__int64 ***)(a1 + 312);
      if ( v94 )
...
LABEL_232:
        LOBYTE(Entry) = 1;
        RtlpHeapAddListEntry(a1, (_DWORD)v94, (_DWORD)Entry, v12 + 16, v97, v95);
      }
      goto LABEL_200;
    }
    v86 = (_DWORD *)(v12 + 32);
    ...
    if ( v21 )
    {
      *(_QWORD *)(v114 + 16) = 0LL;
      ...
      if ( v115 != -2 )
      {
        ...
        DeferredCriticalSectionEvent = *(HANDLE *)(v114 + 24);
        if ( !DeferredCriticalSectionEvent )
          DeferredCriticalSectionEvent = RtlpCreateDeferredCriticalSectionEvent(v114);
        v133 = 0;
