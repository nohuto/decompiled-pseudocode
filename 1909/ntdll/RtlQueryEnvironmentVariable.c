        ...
        PSIZE_T ReturnLength)
{
  ...
  *ReturnLength = 0LL;
  if ( !NameLength )
    return -1073741568;
  result = RtlpCheckPseudoEnvironmentVariable((wchar_t *)Name, NameLength, (__int64)v12);
  if ( result == -1073741568 )
  {
    if ( !Environment )
    {
      ...
      v35 = RtlpQueryEnvironmentCache(&v36, (__int64)Name, NameLength, Value, ValueLength, v12);
      if ( v35 != -1073741568 )
      {
LABEL_56:
...
LABEL_45:
    ...
    if ( *(_WORD *)Environment )
    {
      ...
      result = RtlpQueryEnvironmentCache(&v36, (__int64)Name, NameLength, Value, ValueLength, v12);
      if ( result == -1073741568 )
      {
        v33 = 1;
        Environment = v36;
