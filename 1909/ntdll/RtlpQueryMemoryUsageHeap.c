/*
 * XREFs of RtlpQueryMemoryUsageHeap @ 0x1800F106C
 * Callers:
 *     RtlpQueryExtendedInformationHeap @ 0x180077050 (RtlpQueryExtendedInformationHeap.c)
 *     RtlpHeapQueryTotalReserveSize @ 0x1800F0B50 (RtlpHeapQueryTotalReserveSize.c)
 * Callees:
 *     RtlpGetLowFragHeapMetadataSize @ 0x180107800 (RtlpGetLowFragHeapMetadataSize.c)
 */
