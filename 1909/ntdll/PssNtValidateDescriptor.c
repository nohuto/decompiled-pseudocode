/*
 * XREFs of PssNtValidateDescriptor @ 0x180110E90
 * Callers:
 *     PssNtDuplicateSnapshot @ 0x1801107A0 (PssNtDuplicateSnapshot.c)
 *     PssNtFreeSnapshot @ 0x180110A30 (PssNtFreeSnapshot.c)
 *     PssNtQuerySnapshot @ 0x180110BF0 (PssNtQuerySnapshot.c)
 *     PssNtWalkSnapshot @ 0x180111020 (PssNtWalkSnapshot.c)
 * Callees:
