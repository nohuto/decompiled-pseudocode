/*
 * XREFs of RtlpHpSegSubAllocate @ 0x180077998
 * Callers:
 *     RtlpHpSegVsAllocate @ 0x180077980 (RtlpHpSegVsAllocate.c)
 * Callees:
...
void *__fastcall RtlpHpSegSubAllocate(__int64 a1, unsigned int a2, unsigned int a3, _DWORD *a4, _DWORD *a5)
{
  unsigned int v6; // eax
  void *v9; // rax
  void *v10; // rsi
