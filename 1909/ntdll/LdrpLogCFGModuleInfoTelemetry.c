/*
 * XREFs of LdrpLogCFGModuleInfoTelemetry @ 0x180084294
 * Callers:
...
char __fastcall LdrpLogCFGModuleInfoTelemetry(__int64 a1, __int64 a2)
{
  ...
  if ( v2->ProcessHeap )
  {
    ...
    {
      LOBYTE(v2) = TlgKeywordOn((TraceLoggingHProvider)&dword_18015F418, 0x200000000000uLL);
      if ( (_BYTE)v2 )
      {
        ...
        v26 = 4;
        v29 = 8;
        LOBYTE(v2) = TlgWrite(v5, &unk_18012B963, (LPCGUID)8, v6, 8u, &pData);
      }
    }
  }
  return (char)v2;
