/*
 * XREFs of RtlLoadString @ 0x180054F40
 * Callers:
 *     <none>
 * Callees:
        ...
        PULONG ReturnLanguageLen)
{
  ...
  ULONG *v19; // [rsp+50h] [rbp-68h] BYREF
...
LABEL_8:
    ...
    *(_QWORD *)lcid = 0LL;
    ...
    {
      v12 = LdrpSearchResourceSection_U(DllHandle, (__int64)v21, 4u, 1u, (__int64)&v19);
      if ( v12 < 0 )
        return v12;
      v12 = LdrpAccessResourceData((unsigned __int64)DllHandle, v19, (unsigned __int64 *)&v18, 0LL);
    }
    if ( v12 >= 0 && v18 )
    {
      v13 = 0;
