 ...
 * Callees:
 *     RtlpFindNextActivationContextSection @ 0x180026E54 (RtlpFindNextActivationContextSection.c)
...
__int64 __fastcall RtlFindActivationContextSectionString(int a1, __int64 a2, int a3, int a4, __int64 a5)
{
  ...
  if ( (int)result >= 0 )
  {
    ...
    {
      v27 = 0;
      result = RtlpFindNextActivationContextSection(&v23, &v18, &v17, &v21);
      v12 = v17;
      v13 = v21;
      if ( (int)result >= 0 )
      {
        while ( 1 )
        {
          ...
          result = RtlpFindUnicodeStringInSection((_DWORD)v18, v12, a4, a5, (__int64)&v20, (__int64)&v19);
          if ( (int)result >= 0 )
            break;
