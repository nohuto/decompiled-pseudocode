/*
 * XREFs of RtlUnicodeStringValidateDestWorker @ 0x1800298C4
 * Callers:
 ...
 *     RtlUnicodeStringCbCopyStringN @ 0x18006B060 (RtlUnicodeStringCbCopyStringN.c)
 *     RtlUnicodeStringCat @ 0x180078298 (RtlUnicodeStringCat.c)
 *     RtlUnicodeStringCopyString @ 0x1800CCE68 (RtlUnicodeStringCopyString.c)
 * Callees:
 *     RtlUnicodeStringValidateWorker @ 0x180029934 (RtlUnicodeStringValidateWorker.c)
 */
