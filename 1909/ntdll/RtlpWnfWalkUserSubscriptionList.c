/*
 * XREFs of RtlpWnfWalkUserSubscriptionList @ 0x180006950
 * Callers:
 ...
 *     RtlpWnfMarkFailure @ 0x18008C7EC (RtlpWnfMarkFailure.c)
      ...
      *((_QWORD *)v8 + 19) = NtCurrentTeb()->ClientId.UniqueThread;
      ...
      if ( !*((_DWORD *)v8 + 24) )
      {
        ...
        if ( (unsigned int)RtlGetCurrentServiceSessionId() )
          ...
          v16 = 2147353486LL;
        if ( *(_BYTE *)v16 )
          RtlpWnfETWEventCallback(v12, a1[4], (_DWORD)v8, a2, v22, v10, v18);
      ...
      if ( v20 )
      {
        ...
        {
          v19 = 1;
          RtlpWnfMarkFailure(v8, (unsigned int)v18, (unsigned int)a1[4]);
          goto LABEL_60;
        }
      }
      else
...
LABEL_46:
    ...
    RtlpDecRefWnfUserSubscription(v8, &v23, &v24);
    v7 = v21;
    v6 = v25;
    if ( v23 )
    {
