/*
 * XREFs of LdrpProcessDetachNode @ 0x18006D950
 * Callers:
...
void __fastcall LdrpProcessDetachNode(_QWORD **a1)
{
  ...
  __int64 v10; // [rsp+60h] [rbp-68h] BYREF
  int v11; // [rsp+68h] [rbp-60h]
  _BYTE v12[56]; // [rsp+70h] [rbp-58h] BYREF
  ...
  for ( i = *a1; i != a1; i = (_QWORD *)*i )
  {
    ...
    *((_WORD *)i - 26) = 0;
    ...
    if ( v7 && (v3[13] & 0x80000) != 0 )
    {
      ...
      RtlActivateActivationContextUnsafeFast((__int64)&v10, v3[17]);
      if ( *((_WORD *)v3 + 55) )
        LdrpCallTlsInitializers(0, (unsigned __int64)(i - 20), v8, v9);
