/*
 * XREFs of RtlGetProductInfo @ 0x180082420
 * Callers:
 *     <none>
 * Callees:
 *     CompareVersions @ 0x180082560 (CompareVersions.c)
        ...
        PDWORD ReturnedProductType)
{
  ...
  *ReturnedProductType = 0;
  v7 = Data_8;
  v17 = xmmword_180122368;
  if ( (int)CompareVersions(&Data_8, &v17) < 0 )
    return 0;
  if ( ZwQueryLicenseValue((PUNICODE_STRING)&stru_1801188B8, &Type, &Data, 4u, &ResultDataSize) < 0
    || Type != 4
    || ResultDataSize != 4 )
  {
  ...
  if ( ZwQueryLicenseValue((PUNICODE_STRING)&stru_1801188A8, &Type, v18, 0xC8u, &ResultDataSize) < 0 )
    goto LABEL_7;
