...
LABEL_95:
  ...
  while ( 1 )
  {
    v34 = RtlpInterlockedPopEntrySList((PSLIST_HEADER)(v5 + 16 * (v33 + 13LL)));
    if ( v34 )
      break;
    if ( ++v33 >= 0x20 )
      goto LABEL_64;
...
LABEL_99:
  ...
  *((_WORD *)&v22->Next + 4) &= 0xF800u;
  ...
  v22->Next = *(_SLIST_ENTRY **)(v52 + v5 + 728);
...
LABEL_169:
      if ( !(_DWORD)v6 )
        RtlStdReleaseStackTrace(v5, v22);
      goto LABEL_8;
    }
    v62 = 0LL;
    if ( !byte_180165408 )
...
LABEL_22:
        ...
        result = _InterlockedCompareExchange64(&RtlCriticalSectionLock, 0LL, v12);
        v16 = v12 == result;
        v12 = result;
        if ( v16 )
          goto LABEL_22;
