...
LABEL_40:
          ...
          v126 = RtlpHpHeapGlobals ^ *(_QWORD *)(a1 + 24);
          v158 = v60 - v35 + 1;
          v127 = v158 << v124;
          v128 = *(_QWORD *)a1;
          v148[0] = -1;
          ...
          {
            RtlpHpLfhSubsegmentIncBlockCounts(a1, v11, v142, v127, (__int64)&v158, 1, (__int64)v148);
            goto LABEL_45;
          }
          RtlpHpLfhSubsegmentDecBlockCounts(a1, v11, v49, v151);
          RtlReleaseSRWLockExclusive((volatile signed __int64 *)(v11 + 24));
          v35 = ~(3LL << ((2 * v48) & 0x3F));
    ...
    else
    {
      ...
      if ( (_QWORD *)*v119 == v119
        || ((RtlAcquireSRWLockExclusive(v163 + 2), (_QWORD *)*v119 == v119)
          ? (v63 = 0LL)
          : (v63 = RtlpHpLfhOwnerMoveSubsegment(v163, *v119, 2LL)),
...
LABEL_113:
  ...
  else
  {
    ...
    if ( (unsigned __int8)v76 == HIBYTE(v76) )
    {
      ...
      v132 = RtlpHeapGenerateRandomValue32(v77, 0x180000000uLL, a3);
...
LABEL_83:
    ...
    {
      RtlpHpLfhSubsegmentIncBlockCounts(a1, v67, v143, v130, (__int64)&v157, 1, (__int64)&v147);
      goto LABEL_88;
    }
    RtlpHpLfhSubsegmentDecBlockCounts(a1, v67, v94, v151);
    RtlReleaseSRWLockExclusive((volatile signed __int64 *)(v67 + 24));
    v35 = ~(3LL << ((2 * v159) & 0x3F));
    _InterlockedAnd64(
...
LABEL_52:
  if ( v154 )
    RtlpHpLfhBucketUpdateAffinityMapping(a1, v163, v35, v36);
  if ( v63 )
    RtlpHpLfhBucketAddSubsegment(a1, v163, v63, a5);
  return v5;
}
