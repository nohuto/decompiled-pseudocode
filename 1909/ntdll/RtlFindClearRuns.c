/*
 * XREFs of RtlFindClearRuns @ 0x1800E9740
 * Callers:
 *     RtlFindLongestRunClear @ 0x1800E9A30 (RtlFindLongestRunClear.c)
 * Callees:
 *     <none>
 */
  ...
  if ( !v11 )
  {
    ...
    while ( 1 )
    {
      ...
      if ( v19 )
      {
        ...
        v13 = v17 - v15 + 8;
        v43 = v13;
        v26 = *((_BYTE *)&unk_180124328 - v15) | byte_180124310[v20] | v19;
        if ( v26 != 0xFF )
        {
          do
          {
            ...
            v28 = 0;
            for ( j = byte_180124310[v27]; (j & v26) != 0; j *= 2 )
              ++v28;
            v30 = v6 + 1;
            if ( v6 >= SizeOfRunArray )
              v30 = v6;
