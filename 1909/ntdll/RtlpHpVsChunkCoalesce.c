/*
 * XREFs of RtlpHpVsChunkCoalesce @ 0x180039500
 * Callers:
...
unsigned __int64 __fastcall RtlpHpVsChunkCoalesce(__int64 a1, __int64 a2, unsigned __int64 a3, unsigned int *a4)
{
  ...
  v7 = a4;
  v9 = WORD1(v6);
  *(_BYTE *)(a3 + 6) = BYTE6(a3) ^ ((v24 & 0xFF00FFFF) >> 16) ^ BYTE6(RtlpHpHeapGlobals);
  if ( WORD2(v6) )
  {
  ...
  if ( v13 < a2 + 48 + 16 * (unsigned __int64)*(unsigned __int16 *)(a2 + 32) )
  {
    ...
    if ( (v14 & 0xFF000000000000LL) == 0 )
    {
      ...
      v17 = v4 + 16 * v9;
      v18 = RtlpHpHeapGlobals ^ *(_DWORD *)v13 ^ v13;
      v19 = 16 * HIWORD(v18);
  ...
  if ( (*(_BYTE *)(a1 + 176) & 1) != 0 )
  {
    ...
    {
      v23 = RtlpHpHeapGlobals ^ *(_QWORD *)v22 ^ v22;
      if ( (v23 & 0xFF000000000000LL) == 0 )
      {
        RtlpHpVsFreeChunkRemove(a1, a2, v22);
        v9 += WORD1(v23);
      }
    }
  }
  *v7 = v9;
  ...
  {
    v16 = v4 + 16LL * v9;
    *(_WORD *)(v4 + 2) = WORD1(RtlpHpHeapGlobals) ^ WORD1(v4) ^ v9;
    if ( v16 < v12 + 16 * (unsigned __int64)*(unsigned __int16 *)(a2 + 32) )
      *(_WORD *)(v16 + 4) = WORD2(v16) ^ WORD2(RtlpHpHeapGlobals) ^ v9;
  }
  return v4;
}
