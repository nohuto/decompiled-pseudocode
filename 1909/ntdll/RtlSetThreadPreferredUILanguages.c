...
__int64 __fastcall RtlSetThreadPreferredUILanguages(int a1, _WORD *a2, int *a3)
{
  ...
  if ( a2 )
  {
    ...
    if ( v23 < 2 || *a2 || a2[1] )
    {
      if ( (int)LdrpCreateLangFallbackList(&BaseAddress, v22, 5LL) < 0 || !BaseAddress )
        return (unsigned int)-1073741801;
      updated = RtlpMuiRegAddMultiSzToLangFallbackList(g_RegInfo, a2, v23, v5 | 2u, 26, 5, &BaseAddress);
      if ( updated < 0 )
      {
...
LABEL_20:
    ...
    v17 = ((__int64 (*)(void))RtlpMuiRegDupLanguageList)();
