/*
 * XREFs of _output_l @ 0x1800933D0
 * Callers:
...
LABEL_121:
                    ...
                    v40 = v57 - SizeConverted - v39;
                    if ( (v7 & 0xC) == 0 )
                    {
                      LOBYTE(v23) = 32;
                      write_multi_char(v23, v40, v59, &v54);
                    }
                    write_string(v55, v39, v59, &v54);
                    v42 = v59;
                    if ( (v7 & 0xC) == 8 )
                    {
                      LOBYTE(v41) = 48;
                      write_multi_char(v41, v40, v59, &v54);
                    }
                    v43 = SizeConverted;
                    if ( v58 && SizeConverted > 0 )
                    {
                      v44 = v13;
                      while ( 1 )
                      {
                        v45 = *v44++;
                        --v43;
                        if ( wctomb_s(&v63, v69, 6uLL, v45) || !v63 )
                          break;
                        write_string(v69, (unsigned int)v63, v59, &v54);
                        if ( !v43 )
                          goto LABEL_135;
                      }
                      v11 = -1;
                    ...
                    {
                      write_string(v13, (unsigned int)SizeConverted, v42, &v54);
LABEL_135:
                      v11 = v54;
                    }
                    if ( v11 >= 0 && (v7 & 4) != 0 )
                    {
                      LOBYTE(v46) = 32;
                      write_multi_char(v46, v40, v59, &v54);
                      v11 = v54;
                    }
                    v5 = v64;
                    v10 = v53;
