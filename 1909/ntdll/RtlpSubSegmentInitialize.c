/*
 * XREFs of RtlpSubSegmentInitialize @ 0x18004A2C0
 * Callers:
...
LABEL_11:
  ...
  *(_DWORD *)(v13 + 168) = ++*(_DWORD *)(v26 + 32);
  ...
  if ( (unsigned __int8)HeapData_high == HIBYTE(HeapData_high) )
  {
    ...
    RandomValue32 = RtlpHeapGenerateRandomValue32(v29, 0LL, 0LL);
  ...
  v32 = (RtlpLowFragHeapRandomData[v30] % v16) << 16;
  HIWORD(v52) = RtlpLowFragHeapRandomData[v30] % v16;
  LOWORD(v52) = v16;
  ...
  *(_DWORD *)(v21 + 44) = 1;
  ...
  if ( (RtlpLowFragHeapGlobalFlags & 2) == 0 )
  {
    ...
    v34 = (unsigned __int64)(unsigned int)RtlpHeapGenerateRandomValue32(v52, v32, v22) << 32;
    *(_QWORD *)&RtlpLowFragHeapRandomData[8 * ((unsigned __int8)v33 >> 3)] = (v34 | (unsigned int)RtlpHeapGenerateRandomValue32(
                                                                                                    v36,
                                                                                                    v35,
