...
LABEL_77:
  ...
  while ( 1 )
  {
    v15 = RtlpInterlockedPopEntrySList((PSLIST_HEADER)(v5 + 16 * (v14 + 13LL)));
    if ( v15 )
      break;
    if ( ++v14 >= 0x20 )
      goto LABEL_24;
...
LABEL_30:
  ...
  *((_WORD *)&v13->Next + 4) &= 0xF800u;
  ...
  v13->Next = *(_SLIST_ENTRY **)(v20 + v5 + 728);
...
LABEL_149:
  if ( !(_DWORD)v6 )
    RtlStdReleaseStackTrace(v5, v13);
LABEL_6:
  WORD1(Heap->Next) = v6;
  *((_WORD *)&Heap[2].Next + 6) = WORD1(v6);
  ...
  v8 = NtCreateSemaphore(&v84, 1048579LL, 0LL, 0LL, 0x7FFFFFFF);
  if ( v8 < 0 )
  {
    NtClose(Handle);
    RtlpFreeDebugInfo(Heap);
