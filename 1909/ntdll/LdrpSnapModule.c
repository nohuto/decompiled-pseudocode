...
LABEL_52:
  ...
  if ( v69 )
  {
    ...
    if ( v19 == 267 )
    {
      v18 = RtlpImageDirectoryEntryToData32(v17, v16, 0, (unsigned int)&v70, v69, (__int64)&v57);
      v21 = v57;
      v55 = v57;
      goto LABEL_78;
    }
...
LABEL_79:
  ...
  if ( qword_18017A3A0 && (byte_18017A38C & 1) == 0 )
  {
    if ( v15 < *((_QWORD *)&xmmword_18017A500 + 1)
      || v15 >= *((_QWORD *)&xmmword_18017A500 + 1) + (unsigned __int64)(unsigned int)qword_18017A510 )
    {
      RtlpxLookupFunctionTable(v15, &v66);
      v21 = v55;
    }
    else
    {
      v66 = xmmword_18017A500;
      v67 = qword_18017A510;
    }
    v69 = *((_QWORD *)&v66 + 1);
    if ( *((_QWORD *)&v66 + 1) != v15 )
...
LABEL_45:
      if ( (unsigned int)v44 < v21[5] )
      {
        ...
        if ( (_DWORD)v45 )
        {
          ...
          {
            v47 = LdrpResolveForwarder((char *)(v15 + v45), v56, v29, &v65);
            v31 = v47;
            LODWORD(v69) = v47;
            if ( v47 == 259 )
              return 0LL;
    ...
    else
    {
      ...
      if ( (*(_DWORD *)(v4 + 32) & 0x2000000) == 0 )
        goto LABEL_30;
      v51 = LdrpCheckRedirection(v54, v56, v35 + 1);
      v33 = v51;
      if ( v51 != -4530927 )
      {
        v29 = v54;
...
LABEL_65:
  ...
  if ( (unsigned int)CompatCachepLookupCdb(*(wchar_t **)(v54 + 80))
    || (unsigned int)CompatCachepLookupCdb(*(wchar_t **)(v56 + 80)) )
  {
    v52 = v54 + 72;
    LdrpLogLoadFailureEtwEvent(v54 + 72, v56 + 72, 1, (unsigned int)&LoadFailure, 0);
    LdrpLogLoadFailureEtwEvent(v54 + 72, v56 + 72, 1, (unsigned int)&LoadFailureOperational, 1);
  }
  else
  {
    v52 = v54 + 72;
  ...
  LODWORD(v69) = v31;
  LdrpReportError(v52, v53, (unsigned int)v31);
  v48 = a1;
LABEL_66:
  if ( *(_QWORD *)(v48 + 184) )
  {
