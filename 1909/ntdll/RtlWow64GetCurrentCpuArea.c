/*
 * XREFs of RtlWow64GetCurrentCpuArea @ 0x180066690
 * Callers:
 *     RtlWow64GetCurrentMachine @ 0x1800664F0 (RtlWow64GetCurrentMachine.c)
 * Callees:
 *     RtlWow64GetCpuAreaInfo @ 0x180066710 (RtlWow64GetCpuAreaInfo.c)
 */
