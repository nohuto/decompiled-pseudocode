...
__int64 RtlpHeapTrkTrackStack()
{
  ...
  v1 = BackTraceHash[0];
  Heap = RtlAllocateHeap(qword_180166A18, 0, 8LL * v0 + 24);
  v3 = v1 & 0xF;
  RtlAcquireSRWLockExclusive(*(volatile signed __int64 **)(qword_180166A10 + 8 * v3));
  v4 = qword_180166890;
...
LABEL_6:
    if ( Heap )
    {
      ...
      *(_QWORD *)v8 = Heap;
      ...
      RtlReleaseSRWLockExclusive(*(volatile signed __int64 **)(qword_180166A10 + 8 * v3));
      return Heap;
    }
    else
    {
...
LABEL_5:
  ...
  RtlReleaseSRWLockExclusive(*(volatile signed __int64 **)(qword_180166A10 + 8 * v3));
  if ( Heap )
    RtlFreeHeap(qword_180166A18, 0, Heap);
  return (__int64)v6;
}
