/*
 * XREFs of RtlpHpRegisterEnvironment @ 0x18004CD90
 * Callers:
...
__int64 __fastcall RtlpHpRegisterEnvironment(__int128 *a1, int a2)
{
  ...
  if ( a2 )
  {
    ...
    if ( BYTE1(v2) == 3 )
      v6 = 0x40000000LL;
    v7 = RtlpHpVaMgrCtxAllocatorReference(&unk_180166AB8, v10, v6);
    if ( v7 == -1 )
    {
  ...
  {
    RtlpHpVaMgrCtxAllocatorDereference(&unk_180166AB8, v10, v5);
  }
  return v3;
}
