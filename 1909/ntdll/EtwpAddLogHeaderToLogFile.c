          ...
          if ( (unsigned int)(LowPart - 1024) <= 0xFFFC00 )
          {
            ...
            if ( HighPart )
            {
              if ( Buffer[15].QuadPart && Buffer[14].HighPart == *(_DWORD *)(a1 + 204) )
              {
                ...
                v38 = NtWriteFile(v26, 0LL, 0LL, 0LL, &IoStatusBlock, Buffer, *(_DWORD *)(a1 + 208), &ByteOffset, 0LL);
...
LABEL_39:
    ...
    else
    {
      ...
      else
      {
        ...
        EtwpGetTimeZoneInformation((char *)&Buffer[22]);
        ...
        {
          v23 = (char *)Buffer + v22;
          *((_DWORD *)v23 + 1) = 5242960;
          *(_DWORD *)v23 = -1073610750;
          *((_DWORD *)v23 + 2) = v55;
          *((_DWORD *)v23 + 3) = v54;
          *((_DWORD *)v23 + 6) = v56[2] / (__int64)SystemInformation[1];
          *((_DWORD *)v23 + 7) = v56[3] / (__int64)SystemInformation[1];
          if ( *(_DWORD *)(a1 + 16) == 2 )
          {
