/*
 * XREFs of EtwpAddLogHeaderToLogFile @ 0x180004BA8
 * Callers:
...
__int64 __fastcall EtwpAddLogHeaderToLogFile(__int64 a1, void *a2, int a3, char a4)
{
  ...
  if ( !v7 )
    EtwpGenerateFileName(
      (const wchar_t **)(a1 + 184),
      (volatile signed __int32 *)(a1 + 200),
      (UNICODE_STRING *)(a1 + 168));
...
LABEL_10:
    ...
    else if ( a4 )
    {
      v26 = Handle;
      v47 = 0LL;
      File = NtReadFile(Handle, 0LL, 0LL, 0LL, v50, v15, v9, &v47, 0LL);
      if ( File >= 0 )
      {
          ...
          && *(_DWORD *)(v15 + 148) == 8 )
        {
          ...
          if ( (unsigned int)(v36 - 1024) <= 0xFFFC00 )
          {
            ...
            if ( v37 )
            {
              ...
              {
                *(_QWORD *)(v15 + 120) = 0LL;
                v38 = NtWriteFile(v26, 0LL, 0LL, 0LL, v50, v15, *(_DWORD *)(a1 + 208), &v47, 0LL);
                *(_DWORD *)(a1 + 392) = v37;
                File = v38;
                *(_DWORD *)(a1 + 336) = v37;
                *(_DWORD *)(a1 + 208) = v36;
...
LABEL_39:
    ...
    else
    {
      ...
      *(_DWORD *)(v15 + 48) = v13 & 0xFFFFFFF8;
      ...
      else
      {
        ...
        *((_QWORD *)v16 + 2) = v18;
        v16[3] = v54;
        v16[2] = v55;
        v16[6] = v56[2] / (__int64)SystemInformation[1];
        v16[7] = v56[3] / (__int64)SystemInformation[1];
        v19 = NtCurrentPeb();
        ...
        *(_QWORD *)(v15 + 168) = 0LL;
        ...
        EtwpGetTimeZoneInformation((char *)(v15 + 176));
        ...
        *((_QWORD *)v16 + 2) = *(_QWORD *)(a1 + 8);
        ...
        if ( (unsigned int)(v22 + 80) <= *(_DWORD *)v15 )
        {
          ...
          *(_DWORD *)(v23 + 8) = v55;
          *(_DWORD *)(v23 + 12) = v54;
          *(_DWORD *)(v23 + 24) = v56[2] / (__int64)SystemInformation[1];
          *(_DWORD *)(v23 + 28) = v56[3] / (__int64)SystemInformation[1];
          if ( *(_DWORD *)(a1 + 16) == 2 )
          {
      ...
      *(_DWORD *)(v15 + 4) = *(_DWORD *)(v15 + 48);
      ...
      File = NtWriteFile(v26, 0LL, 0LL, 0LL, v50, v15, v9, 0LL, 0LL);
      if ( File >= 0 )
      {
        ...
        if ( !(_DWORD)v28
          ...
          || (v52 = v28 * ((-(__int64)((*(_DWORD *)(a1 + 324) & 0x2000) != 0) & 0xFFFFFFFFFFF00400uLL) + 0x100000),
              File = ZwSetInformationFile(v26, v50, &v52, 8LL, 20),
              File >= 0) )
        {
          *(_QWORD *)(a1 + 144) = v26;
          *(_DWORD *)(a1 + 392) = 1;
  ...
  if ( File >= 0 )
  {
    File = ZwQueryInformationThread(-2LL, 0LL, v53, 48LL, 0LL);
    if ( File >= 0 )
    {
      File = ZwQueryInformationThread(-2LL, 1LL, v56, 32LL, 0LL);
      if ( File >= 0 )
      {
