/*
 * XREFs of LdrpPrepareImportAddressTableForSnap @ 0x180020F00
 * Callers:
...
__int64 __fastcall LdrpPrepareImportAddressTableForSnap(__int64 a1)
{
  ...
  v1 = *(_QWORD *)(a1 + 56);
  v2 = (__int64 *)(a1 + 112);
  v4 = RtlpImageDirectoryEntryToDataEx(*(_QWORD *)(v1 + 48), 1, 0xCu, (_DWORD *)(a1 + 112), &v22);
  v5 = v22;
  if ( v4 < 0 )
    v5 = 0LL;
  ...
  *(_QWORD *)(a1 + 104) = v5;
  ...
  if ( !Config || *Config < 0x94u )
    goto LABEL_10;
  v8 = v21;
  if ( (*(_WORD *)(v21 + 94) & 0x4000) != 0 && (Config[36] & 0x100) != 0 )
  {
