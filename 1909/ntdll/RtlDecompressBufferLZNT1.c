/*
 * XREFs of RtlDecompressBufferLZNT1 @ 0x180108920
 * Callers:
 *     <none>
 * Callees:
 *     LZNT1DecompressChunk @ 0x1800A20A0 (LZNT1DecompressChunk.c)
...
LABEL_23:
    ...
    if ( !a5 )
    {
      v9 = LZNT1DecompressChunk(v8, v7, v15, v14, &v24);
      if ( v9 < 0 )
      {
LABEL_7:
        *a6 = v24;
...
LABEL_13:
    ...
    v9 = LZNT1DecompressChunk(v8, v7, v15, v14, &v25);
    if ( v9 < 0 )
      goto LABEL_7;
    v16 = a5;
    v24 = a5;
