/*
 * XREFs of RtlGetSystemPreferredUILanguages @ 0x1800746F0
 * Callers:
...
LABEL_34:
    ...
    {
      *a5 = v17;
      v21 = LdrpConvertLangFallbackListToMultiSz(v19[7], (__int64)v19, (_DWORD *)a4, a5, v13, v14, &v38);
      if ( v21 >= 0 && v38 )
        goto LABEL_29;
      v21 = LdrpCreateLangFallbackList(&v40, (__int64)v19, 0x19u, 1);
      if ( v21 >= 0 )
      {
        v21 = LdrpMergeLangFallbackLists(v13 | 0x30u, (__int64)v19, &v40, 0LL, 0LL, 0LL, 0LL, 0LL, 0);
        if ( v21 >= 0 )
        {
          v22 = a5;
          *a5 = v39;
    ...
    {
      v20 = LdrpCreateLangFallbackList(&v40, (__int64)v19, 0x19u, 1);
      v21 = v20;
      if ( (v13 & 0x8080) != 0 )
      {
        if ( v20 >= 0 )
        {
          v21 = LdrpMergeLangFallbackLists(v13 | 0x30u, (__int64)v19, &v40, 0LL, 0LL, 0LL, v19[7], 0LL, 1);
          if ( v21 >= 0 )
          {
            v22 = a5;
LABEL_23:
            v23 = v40;
            v24 = LdrpConvertLangFallbackListToMultiSz(v40, (__int64)v19, (_DWORD *)a4, v22, v13, v14, &v38);
            goto LABEL_24;
          }
        }
      }
      ...
      {
        v21 = LdrpMergeLangFallbackLists(v13 | 0x30u, (__int64)v19, &v40, 0LL, 0LL, 0LL, v19[7], 0LL, 0);
        if ( v21 >= 0 )
        {
          v26 = LdrpCreateLangFallbackList(&v41, (__int64)v19, 0x19u, 1);
          v23 = v40;
          v21 = v26;
          if ( v26 < 0 )
            goto LABEL_82;
            ...
            if ( v37 != -1 )
            {
              ...
              if ( v28 )
              {
                ...
                if ( *(_BYTE *)(v40 + 8) )
                  ...
                  v29 = v19[6];
                v21 = LdrpMergeParentBaseLanguagesToList((unsigned int)&v41, (_DWORD)v28, (_DWORD)v19, v29, v34);
              }
            }
          }
          else
              ...
              do
              {
                ...
                if ( *(_WORD *)(v31 + 6LL * v30) == 2 )
                {
                  ...
                  if ( (*v32 & 6) != 0 )
                  {
                    ...
                    v21 = LdrpMergeParentBaseLanguagesToList((unsigned int)&v41, (_DWORD)v32, (_DWORD)v19, v33, v34);
                    if ( v21 >= 0 )
                      goto LABEL_81;
                  }
                  v30 = v45;
...
LABEL_81:
          v35 = v27;
          v10 = v41;
          v24 = LdrpConvertLangFallbackListToMultiSz(v41, (__int64)v19, (_DWORD *)a4, a5, v13, v35, &v38);
LABEL_24:
          v21 = v24;
LABEL_25:
          if ( v23 )
