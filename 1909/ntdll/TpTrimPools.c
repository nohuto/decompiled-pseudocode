/*
 * XREFs of TpTrimPools @ 0x180060860
 * Callers:
...
signed __int64 TpTrimPools()
{
  ...
  while ( v3 != &TppPoolpList )
  {
    ...
    v29 = 0;
    v7 = 1;
    if ( (int)NtSetInformationWorkerFactory(*(v4 - 41), 12LL, &v29) >= 0 && v29 )
    {
      v8 = 0;
      ...
      *((_DWORD *)v4 + 13) = v9;
      ...
      v11 = (__int64 *)(v4 + 9);
      Heap = RtlAllocateHeap((__int64)NtCurrentPeb()->ProcessHeap, (TppHeapTag + 786432) | 8u, 8 * ((v9 >> 12) & 0x7FF));
      if ( !Heap )
      {
        while ( 1 )
        {
          ...
          if ( (__int64 *)*v11 == v11 )
            break;
          v24 = *(_QWORD *)v23;
          if ( *(_QWORD *)(*(_QWORD *)v23 + 8LL) != v23 || (v25 = *(_QWORD **)(v23 + 8), *v25 != v23) )
LABEL_44:
            __fastfail(3u);
          *v25 = v24;
          *(_QWORD *)(v24 + 8) = v25;
          NtClose(*(HANDLE *)(v23 + 16));
      ...
      if ( v13 )
      {
        ...
        *((_DWORD *)v4 + 13) &= 0xFF800001;
        ...
        do
        {
          ...
          if ( (unsigned int)NtWaitForMultipleObjects(v20, Heap + 8 * v19, 0LL, 0LL, &v30) == 258 )
            break;
          ++v18;
        }
        ...
        if ( (_DWORD)v14 )
        {
          ...
          do
          {
            NtClose(*(HANDLE *)((char *)v21 + Heap - v13));
            RtlFreeHeap((__int64)NtCurrentPeb()->ProcessHeap, TppHeapTag + 786432, *v21++);
            --v14;
          }
          while ( v14 );
        }
        RtlFreeHeap((__int64)NtCurrentPeb()->ProcessHeap, TppHeapTag + 786432, v13);
      }
      else
      {
        while ( 1 )
