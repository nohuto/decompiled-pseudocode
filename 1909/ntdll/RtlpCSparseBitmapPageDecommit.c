...
char __fastcall RtlpCSparseBitmapPageDecommit(__int64 a1, unsigned __int64 a2, int a3, unsigned __int64 a4)
{
...
LABEL_22:
    a3 = 0;
    RtlpCSparseBitmapLock(a1, 1uLL, (unsigned __int64)v31, a4);
    v28 = *(_QWORD *)(a1 + 32);
    if ( v28 == -1 )
      break;
...
LABEL_20:
  if ( v34 )
  {
    *(_QWORD *)(a1 + 32) = -1LL;
    ...
    LOBYTE(v13) = RtlpWakeByAddress(a1 + 32, 1);
  }
  return (char)v13;
}
