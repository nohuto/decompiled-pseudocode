...
LABEL_83:
    ...
    EnvBlock = (char *)RtlpAllocateEnvBlock(2 * (ValueLength + ((v17 - (_BYTE *)BaseAddress) >> 1) - v62));
    if ( EnvBlock )
    {
      memmove(EnvBlock, BaseAddress, 2LL * (unsigned int)((v61 - (_BYTE *)BaseAddress) >> 1));
      v46 = &EnvBlock[2 * (unsigned int)((v61 - (_BYTE *)BaseAddress) >> 1)];
