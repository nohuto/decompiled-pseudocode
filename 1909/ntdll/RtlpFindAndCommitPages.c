...
LABEL_5:
  ...
  if ( v7 == (_QWORD *)(a1 + 240) )
    return 0LL;
  if ( RtlpHeapErrorHandlerThreshold >= 1 && v7[5] < *v2 )
  {
    if ( NtCurrentPeb()->Ldr )
      DbgPrint("HEAP[%wZ]: ", &NtCurrentPeb()->Ldr->InLoadOrderModuleList.Flink[5].Blink);
    else
  ...
  else
  {
    ...
    *v2 = (v58 + 4095) & 0xFFFFFFFFFFFFF000uLL;
    ...
    if ( (unsigned int)RtlpHpHeapCheckCommitLimit(*v2, *(_QWORD *)(a1 + 576) - *(_QWORD *)(a1 + 664), a1, a1 + 376) )
      v12 = ZwAllocateVirtualMemory(-1LL, &v68, 0LL, v2, 4096, HeapProtection);
    else
      v12 = -1073741523;
    ++*(_DWORD *)(a1 + 624);
  }
  ...
  if ( *(_BYTE *)v15 && (NtCurrentPeb()->TracingFlags & 1) != 0 )
    RtlpLogHeapCommit(a1, v68, *v2, 2LL);
  if ( *(_DWORD *)(a1 + 124) )
  {
  ...
  *(_BYTE *)(v10 + 15) = 0;
  ...
  {
    RtlpLogHeapFailure(13, 0, (_DWORD)v17, v20, v21, 0LL);
  }
  v22 = v7[5];
  if ( v22 )
  {
...
LABEL_81:
      RtlpHeapRemoveListEntry(a1, (_DWORD)v23, 0, (_DWORD)v7, v61, v7[5]);
    }
    v24 = *v7;
    v25 = (__int64 *)v7[1];
    v26 = *(_QWORD *)(*v7 + 8LL);
    ...
    {
      RtlpLogHeapFailure(13, 0, (_DWORD)v7, v26, v27, 0LL);
    }
  }
  --*(_DWORD *)(v11 + 84);
...
LABEL_53:
  ...
  *(_BYTE *)(v10 + 14) = v51;
  ...
  if ( *(_BYTE *)v53 && (NtCurrentPeb()->TracingFlags & 1) != 0 )
  {
    ...
    RtlpLogHeapExtendEvent(a1, v10, *v2, 16 * *(_QWORD *)(a1 + 192), *(unsigned __int8 *)v13);
  }
  v54 = 2147353482LL;
  ...
  if ( *(_BYTE *)v56 )
  {
    ...
    RtlpLogHeapExtendEvent(a1, v10, *v2, 16 * *(_QWORD *)(a1 + 192), *(unsigned __int8 *)v54);
  }
  return v10;
}
