/*
 * XREFs of RtlpHpLfhSubsegmentFreeBlock @ 0x1800413B0
 * Callers:
 ...
 *     RtlpHpLfhSubsegmentFindEmptyUnits @ 0x18004308C (RtlpHpLfhSubsegmentFindEmptyUnits.c)
...
__int64 __fastcall RtlpHpLfhSubsegmentFreeBlock(unsigned __int64 a1, __int64 a2, __int64 a3, int a4)
{
  ...
  int v66; // [rsp+30h] [rbp-58h]
  int v67[21]; // [rsp+34h] [rbp-54h] BYREF
  unsigned int v69; // [rsp+98h] [rbp+10h]
  unsigned int v70; // [rsp+A0h] [rbp+18h] BYREF
  ...
  v7 = a1;
  v8 = 0LL;
  v69 = qword_180163548 ^ *(_DWORD *)(a2 + 40) ^ ((unsigned int)a2 >> 12);
  if ( !a3 )
    goto LABEL_16;
  v9 = a3 - HIWORD(v69) - a2;
  v10 = *(_QWORD *)(a1
                  + 8LL * RtlpLfhBucketIndexMap[(unsigned __int64)((unsigned int)(unsigned __int16)v69 + 15) >> 4]
                  + 128);
  v11 = *(_DWORD *)(v10 + 72);
  v12 = *(_BYTE *)(v10 + 76);
  if ( v11 )
  {
    ...
    v14 = v9 - v13 * (unsigned __int16)v69;
  }
  else
  {
    LODWORD(v13) = v9 >> v12;
  ...
  if ( !v14 )
  {
    ...
    *(_WORD *)(v6 + 36) = v15;
    ...
    {
      RtlpLogHeapFailure(17, *(_QWORD *)v7, v5, v6, (unsigned int)v13, 0LL);
      return v4;
    }
    if ( *(_BYTE *)(v6 + 45) > 1u )
    {
      ...
      _m_prefetchw(v22);
      LODWORD(v23) = -1;
      v24 = &v22[2 * (((v19 + (unsigned __int16)v69 - 1) >> v18) - (unsigned int)v20) + 2];
      v25 = 0;
      if ( v22 < v24 )
      {
        do
        ...
        while ( v22 < v24 );
        if ( v25 && (RtlpHpLfhPerfFlags & 0x20) != 0 )
        ...
        if ( (_DWORD)v23 != -1 )
        {
          ...
          if ( (RtlpHpLfhPerfFlags & 0x20) != 0 && !v32 )
          {
            v33 = *(_QWORD *)a1;
            if ( (*(_BYTE *)(*(_QWORD *)a1 + 13LL) & 8) == 0 )
            {
              v34 = *(__int16 *)(v33 + 22);
              v35 = *(_QWORD *)(v34 + v33 + 8) >> *(_BYTE *)(v33 + 11);
              if ( v35 <= 8 )
                v35 = 8LL;
              v36 = *(_QWORD *)(v34 + v33 + 8) >> *(_BYTE *)(v33 + 12);
              if ( v36 <= 8 )
                v36 = 8LL;
              v37 = *(_QWORD *)(v34 + v33 + 16) + *(_QWORD *)(v34 + v33 + 24);
          ...
          do
          {
            EmptyUnits = RtlpHpLfhSubsegmentFindEmptyUnits(v6, (unsigned int)v23, &v70);
            v66 = EmptyUnits;
            if ( EmptyUnits == -1 )
              break;
            v59 = v70;
            ...
            else if ( v31 )
            {
              ...
              ((void (__fastcall *)(_QWORD, __int64, _QWORD))(a1 ^ RtlpHpHeapGlobals ^ *(_QWORD *)(a1 + 32)))(
                *(_QWORD *)a1,
                v6 + (unsigned int)(EmptyUnits << v60),
                v70 << v60);
              RtlpHpLfhSubsegmentDecBlockCounts(a1, v6, v61, v62);
              if ( !v32 )
                break;
              LODWORD(v23) = v59 + v66;
            }
            ...
            {
              LODWORD(v23) = EmptyUnits;
              if ( (v54 & 1) == 0 )
                RtlAcquireSRWLockShared((volatile signed __int64 *)(a1 + 72), v56, v57, v58);
              v31 = 2;
              RtlAcquireSRWLockExclusive((volatile signed __int64 *)(v6 + 24));
            }
          }
      ...
      if ( !v8 && (!(_WORD)v28 || (unsigned __int16)v28 == v27 - 1) )
      {
        ...
        do
        {
          while ( 1 )
          {
            ...
            if ( (v38 & 1) != 0 )
              break;
            v39 = (volatile signed __int64 *)(v38 + 16);
            v8 = v38;
            RtlAcquireSRWLockExclusive((volatile signed __int64 *)(v38 + 16));
            v38 = *(_QWORD *)(v6 + 16);
            if ( v8 == v38 )
              goto LABEL_48;
...
LABEL_69:
        ...
        if ( v6 )
        {
          v49 = *(volatile signed __int64 **)(v7
                                            + 8LL
                                            * RtlpLfhBucketIndexMap[(unsigned __int64)((unsigned int)(unsigned __int16)v69
                                                                                     + 15) >> 4]
                                            + 128);
          if ( *(_WORD *)(v6 + 32) != *(_WORD *)(v6 + 34) )
          {
            RtlAcquireSRWLockExclusive(v49 + 2);
            RtlpHpLfhSubsegmentSetOwner(v6, v49);
            if ( *(_WORD *)(v6 + 32) == *(_WORD *)(v6 + 34) )
              *(_QWORD *)(v6 + 16) = 0LL;
            else
              v6 = RtlpHpLfhOwnerMoveSubsegment(v49, v6, 0LL);
            RtlReleaseSRWLockExclusive(v49 + 2);
          }
          if ( v6 )
          {
            _InterlockedDecrement64(v49 + 8);
            v50 = v71 & 1;
            _InterlockedExchangeAdd64(v49 + 7, -*(__int16 *)(v6 + 34));
            ...
            if ( *(_BYTE *)(v6 + 45) )
            {
              do
              {
                v53 = RtlpHpLfhSubsegmentFindEmptyUnits(v6, v4, v67);
                if ( v53 == -1 )
                  break;
                v52 += v67[0];
                v4 = v67[0] + v53;
              ...
              while ( v67[0] + v53 < v51 );
              if ( v52 && (RtlpHpLfhPerfFlags & 0x20) != 0 )
                _InterlockedExchangeAdd64(
                  (volatile signed __int64 *)(*(__int16 *)(v7 + 58) + v7 + 24),
                  -(__int64)((unsigned __int64)(unsigned int)(v52 << *(_BYTE *)(v6 + 44)) >> 12));
            }
            ((void (__fastcall *)(_QWORD, __int64, _QWORD, _QWORD))(v7 ^ RtlpHpHeapGlobals ^ *(_QWORD *)(v7 + 16)))(
              *(_QWORD *)v7,
              v6,
