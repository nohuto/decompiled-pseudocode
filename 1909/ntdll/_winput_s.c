/*
 * XREFs of _winput_s @ 0x18009B4AC
 * Callers:
...
LABEL_130:
      ...
      if ( v29 == 123 )
      {
        v37 = ReadStringDelimited_1(v36, &v75, (wint_t *)&v58, &v60, (void **)v73, v13, Stream, Src, v71);
        v4 = v75;
      }
      else
      {
        v37 = ReadString_1(v36, 0LL, (wint_t *)&v58, &v60, (void **)v73, v13, Stream, Src, v71);
      }
      v9 = v71[0];
      LOWORD(v5) = v58;
      v63 = v71[0];
