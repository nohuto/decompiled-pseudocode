/*
 * XREFs of LdrpUnloadNode @ 0x18002ECFC
 * Callers:
  ...
  for ( i = *(_QWORD **)a1; i != (_QWORD *)a1; i = (_QWORD *)*i )
  {
    ...
    if ( (LdrpDebugFlags & 5) != 0 )
      LdrpLogDbgPrint(
        ...
        v5 + 9);
    LdrUnloadAlternateResourceModuleEx(v5[6], 0LL);
  }
...
LABEL_18:
  while ( 1 )
  {
    ...
    *v11 = (_QWORD *)*v10;
    ...
    LdrpDecrementNodeLoadCountLockHeld(v9, 0LL, &v24);
    RtlReleaseSRWLockExclusive(&LdrpModuleDatatableLock);
    if ( v24 )
      LdrpUnloadNode(v9);
    RtlFreeHeap(LdrpHeap, 0LL, v8);
  }
  v14 = *(_QWORD **)a1;
  *(_DWORD *)(a1 + 56) = -2;
  if ( v14 != (_QWORD *)a1 )
      ...
      if ( (v17 & 0x40) != 0 )
      {
        ...
        *(_QWORD *)(v18 + 8) = v19;
        ...
        if ( *(_QWORD *)(*(_QWORD *)v16 + 8LL) != v16
          || (v21 = *(_QWORD **)(v16 + 8), *v21 != v16)
          || (*v21 = v20, *(_QWORD *)(v20 + 8) = v21, v22 = *(_QWORD *)(v16 + 16), *(_QWORD *)(v22 + 8) != v16 + 16)
          || (v23 = *(_QWORD **)(v16 + 24), *v23 != v16 + 16) )
        {
LABEL_47:
          __fastfail(3u);
        }
