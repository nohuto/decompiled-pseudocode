        ...
        char a9)
{
  ...
  if ( !v13 && a4 && *(_WORD *)(a4 + 4) )
  {
    do
    {
      ...
      if ( *v19 )
      {
        ...
        if ( *(_QWORD *)(a4 + 16) )
          v34 = *(_QWORD *)(a4 + 16);
        if ( (int)GetNameFromLangListNode(v34, v19, &v49) >= 0 )
        {
    ...
    if ( !v13 )
    {
      for ( i = 0; i < *(unsigned __int16 *)(a5 + 4); v20 = Heap )
      {
        ...
        if ( *v19 )
        {
          ...
          if ( *(_QWORD *)(a5 + 16) )
            v36 = *(_QWORD *)(a5 + 16);
          if ( (int)GetNameFromLangListNode(v36, v19, &v49) >= 0 )
          {
    ...
    if ( *(_WORD *)(v23 + 4) )
    {
      do
      {
        ...
        if ( *v19 )
        {
          v50 = Heap;
          v49 = 11141120;
          if ( (int)GetNameFromLangListNode(a2, v19, &v49) >= 0 )
          {
            LOBYTE(v20) = 1;
            if ( (int)LdrpLangFallbackListAppendNode(v22, a2, v20, (unsigned int)v43, v50) >= 0 && (v57 & 0x10) != 0 )
            {
              v25 = *(_QWORD *)(v16 + 24);
  ...
  if ( appended >= 0 )
  {
    ...
    {
      v29 = v47;
      appended = LdrpLangFallbackListAppendNode((_DWORD)v47, a2, 0, (unsigned int)&v46, v56);
      if ( appended >= 0 )
      {
        if ( v54 )
        {
