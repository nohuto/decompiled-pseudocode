/*
 * XREFs of RtlZeroHeap @ 0x1800F2A30
 * Callers:
        ...
        if ( *v12 == v14 && v13 == v8 + 16 )
        {
          *(_QWORD *)(a1 + 192) -= *(unsigned __int16 *)(v8 + 8);
          ...
          if ( v15 )
          {
            ...
            v18 = v17 - 1;
LABEL_27:
            RtlpHeapRemoveListEntry(a1, v15, 1, (__int64 *)(v8 + 16), v18, v16);
          }
          *v12 = v11;
          *(_QWORD *)(v11 + 8) = v12;
          if ( (*(_BYTE *)(v8 + 10) & 8) == 0 || RtlpCommitBlock(a1, v8) )
          {
            ...
            *(_QWORD *)(a1 + 192) += *(unsigned __int16 *)(v10 + 8);
            ...
            if ( v26 )
            {
              ...
              v29 = v28 - 1;
LABEL_52:
              RtlpHeapAddListEntry(a1, v26, 1, v10 + 16, v29, v27);
            }
            if ( *(_DWORD *)(a1 + 124) )
            {
        ...
        {
          RtlpLogHeapFailure(13, a1, v8 + 16, v14, v13, 0LL);
        }
        v3 = 0LL;
      }
      else
