/*
 * XREFs of LdrpLogIntegrityContinuityTelemetry @ 0x1800CFF40
 * Callers:
...
NTSTATUS __fastcall LdrpLogIntegrityContinuityTelemetry(__int64 a1, int a2, int a3, int a4, char a5)
{
         ...
         0LL) >= 0 )
  {
    ...
    if ( dword_18015F418 > 5u && TlgKeywordOn((TraceLoggingHProvider)&dword_18015F418, 0x800000000000uLL) )
    {
      v14 = *(_QWORD *)(a1 + 56);
      ...
      v53 = 4LL;
      v55 = 1LL;
      TlgWrite((TraceLoggingHProvider)&dword_18015F418, &unk_18012BAC5, v12, v13, 0xFu, &pData);
    }
  }
