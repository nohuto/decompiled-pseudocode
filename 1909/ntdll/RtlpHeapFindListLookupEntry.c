/*
 * XREFs of RtlpHeapFindListLookupEntry @ 0x180045AF0
 * Callers:
  ...
  if ( a3 )
  {
    ...
    if ( *(_DWORD *)(a1 + 124) )
    {
      ...
      if ( HIBYTE(v25) != ((unsigned __int8)v25 ^ (unsigned __int8)(BYTE1(v25) ^ BYTE2(v25))) )
        RtlpLogHeapFailure(3, a1, v10 - 16, 0, 0LL, 0LL);
    }
    v11 = a5;
    a3 = v28;
  ...
  if ( a3 )
  {
    ...
    if ( *(_DWORD *)(a1 + 124) )
    {
      ...
      if ( HIBYTE(v26) != ((unsigned __int8)v26 ^ (unsigned __int8)(BYTE1(v26) ^ BYTE2(v26))) )
        RtlpLogHeapFailure(3, a1, v13 - 16, 0, 0LL, 0LL);
    }
    a3 = v28;
...
LABEL_32:
      ...
      {
        if ( (_BYTE)v21 )
          v22 = (unsigned __int8)RtlpBitsClearLow[(unsigned __int8)v21];
        else
          v22 = (unsigned __int8)RtlpBitsClearLow[BYTE1(v21)] + 8;
      }
      else if ( (v21 & 0xFF0000) != 0 )
      {
        v22 = (unsigned __int8)RtlpBitsClearLow[BYTE2(v21)] + 16;
      }
      else
      {
        v22 = (unsigned __int8)RtlpBitsClearLow[(unsigned __int64)v21 >> 24] + 24;
      }
      v23 = 32 * v19 + v22;
      v24 = 2 * v23;
      if ( !*(_DWORD *)(a2 + 12) )
