...
__int64 __fastcall SbSelectProcedure(__int64 a1, unsigned int a2, __int64 a3, unsigned int a4)
{
  ...
  _EVENT_DATA_DESCRIPTOR v43; // [rsp+E0h] [rbp-20h] BYREF
  _QWORD v44[14]; // [rsp+F0h] [rbp-10h] BYREF
...
LABEL_46:
                  v30 = *v18;
                  v43.Ptr = (unsigned __int64)(v18 + 14);
                  v31 = -1LL;
                  *(_QWORD *)&v43.Size = 16LL;
                  do
                    ++v31;
                  ...
                  v37 = 2 * (v15 + 1);
                  v44[7] = v37;
                  EtwEventWrite(v29, &AeSbImplEvent, 5u, &v43);
                }
              }
            }
          }
