/*
 * XREFs of RtlLengthCurrentClearRunForwardEx @ 0x1800E9FF8
 * Callers:
 *     RtlCSparseBitmapFindBitSetCapped @ 0x18004F900 (RtlCSparseBitmapFindBitSetCapped.c)
 * Callees:
 *     <none>
 */
...
LABEL_14:
    ...
    if ( v7 )
      LODWORD(v9) = v3[1];
    v15 = -1;
    v10 = !_BitScanForward64(&v9, (unsigned int)v9 | ~dword_1801222E0[v4]);
    if ( !v10 )
      v15 = v9;
