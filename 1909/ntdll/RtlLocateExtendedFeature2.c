/*
 * XREFs of RtlLocateExtendedFeature2 @ 0x180074490
 * Callers:
 ...
 *     RtlpMergeContextXState @ 0x180074420 (RtlpMergeContextXState.c)
 *     RtlLocateExtendedFeature @ 0x1800F22E0 (RtlLocateExtendedFeature.c)
 * Callees:
