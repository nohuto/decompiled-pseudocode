/*
 * XREFs of RtlpAllocateHeap @ 0x18003C350
 * Callers:
 ...
 *     RtlpGetLFHContext @ 0x1800702D4 (RtlpGetLFHContext.c)
        ...
        _DWORD *a6)
{
  ...
  if ( v12 > *(unsigned int *)(a1 + 148) )
  {
    ...
    {
      v213 += 56LL;
      v104 = (RtlpHeapGenerateRandomValue32(a1, a2, 0LL) & 0xF) << 12;
      v186 = 0LL;
      v187 = v104 + v213 + 4096;
      HeapProtection = RtlpGetHeapProtection(a1, 1LL);
      if ( (int)ZwAllocateVirtualMemory(-1LL, &v186, 0LL, &v187, 0x2000, HeapProtection) < 0 )
        goto LABEL_398;
      v169 = v104 + v186;
      if ( (unsigned int)RtlpHpHeapCheckCommitLimit(
                           ...
                           *(_QWORD *)(a1 + 576) - *(_QWORD *)(a1 + 664),
                           a1,
                           a1 + 376)
        && (int)ZwAllocateVirtualMemory(-1LL, &v169, 0LL, &v213, 4096, HeapProtection) >= 0 )
      {
        ...
        *(_QWORD *)(a1 + 592) += v213;
        ...
        if ( (unsigned int)RtlGetCurrentServiceSessionId(v106) )
          v108 = (__int64)NtCurrentPeb()->SharedData + 550;
        else
          v108 = 2147353472LL;
        if ( *(_BYTE *)v108 && (NtCurrentPeb()->TracingFlags & 1) != 0 )
          RtlpLogHeapCommit(a1, v169, v213, 9LL);
        ...
        if ( *(_BYTE *)v109 && (NtCurrentPeb()->TracingFlags & 1) != 0 )
        {
          ...
          RtlpLogHeapExtendEvent(a1, v169, v213, 16 * *(_QWORD *)(a1 + 192), *(unsigned __int8 *)v107);
        }
        v110 = 2147353482LL;
        if ( (unsigned int)RtlGetCurrentServiceSessionId(v109) )
        ...
        if ( *(_BYTE *)v111 )
        {
          ...
          RtlpLogHeapExtendEvent(a1, v169, v213, 16 * *(_QWORD *)(a1 + 192), *(unsigned __int8 *)v110);
        }
        if ( (*(_DWORD *)(a1 + 112) & 0x8000000) != 0 )
          *(_WORD *)(v169 + 16) = RtlLogStackBackTraceEx(1u);
        if ( (NtCurrentPeb()->NtGlobalFlag & 0x800) != 0 )
        {
          updated = RtlpUpdateTagEntry(a1, (unsigned __int8)(v8 >> 18), 0, *(_QWORD *)(v169 + 32) >> 4, 1);
          *(_WORD *)(v169 + 18) = updated;
        }
        v112 = v169;
        if ( *(_DWORD *)(a1 + 124) )
        {
        ...
        {
          RtlpLogHeapFailure(13, 0, v10, 0, a2, 0LL);
        }
        v172 = (void *)(v169 + 64);
        goto LABEL_398;
      }
  ...
  if ( (v8 & 0x800000) == 0 )
  {
    ...
    {
      if ( a3 > RtlpLargestLfhBlock || *(_BYTE *)(a1 + 418) == 2 && *(_QWORD *)(a1 + 408) || *(_BYTE *)(a1 + 419) != 2 )
        goto LABEL_19;
LABEL_210:
        ...
        *v79 = v80;
        if ( v171 || (v80 & 0x1Fu) > 0x10 || v80 > 0xFF00u )
        {
          ...
          if ( *(_BYTE *)(a1 + 418) == 2 )
            ...
            v82 = 0LL;
          LFHContext = RtlpGetLFHContext(v82, v81);
...
LABEL_19:
  if ( a5 )
  {
    ...
    if ( *a5 )
    {
      ...
      if ( *(_DWORD *)(a1 + 124) )
      {
        ...
        *((_DWORD *)v21 + 2) = v85;
        if ( HIBYTE(v85) != ((unsigned __int8)v85 ^ (unsigned __int8)(BYTE1(v85) ^ BYTE2(v85))) )
          RtlpAnalyzeHeapFailure(a1, v84 - 2);
      }
      v86 = *v84;
      ...
      {
        RtlpLogHeapFailure(13, a1, (_DWORD)v84, v89, v88, 0LL);
        goto LABEL_321;
      }
...
LABEL_157:
        LOBYTE(v92) = 1;
        RtlpHeapRemoveListEntry(a1, (_DWORD)v90, v92, (_DWORD)v84, v93, v91);
      }
      *v87 = v86;
      *(_QWORD *)(v86 + 8) = v87;
      v32 = v21 + 10;
      if ( (v21[10] & 8) != 0 && !(unsigned __int8)RtlpCommitBlock(a1, v21) )
      {
        LOBYTE(v94) = 1;
        RtlpDeCommitFreeBlock(a1, v21, *((unsigned __int16 *)v21 + 4), v94);
LABEL_321:
...
LABEL_49:
      ...
      if ( (*v32 & 1) != 0 )
      {
        RtlpLogHeapFailure(3, a1, (_DWORD)v21, 0, 0LL, 0LL);
        goto LABEL_398;
      }
      *v32 = v6;
        ...
        if ( v35 != 1 )
        {
          ...
          *((_WORD *)v42 + 6) = v12 ^ *(_WORD *)(a1 + 140);
          ...
          else
          {
            ...
            v204 = v44;
            if ( v44 >= 0xFE )
              RtlpLogHeapFailure(3, v43, (_DWORD)v21 + 16 * v12, v41, 0LL, 0LL);
          }
          v42[14] = v44;
          v42[11] = 0;
          *((_WORD *)v42 + 4) = v35;
            ...
            if ( *(_DWORD *)(a1 + 124) )
            {
              ...
              *((_DWORD *)v45 + 2) = v123;
              if ( HIBYTE(v123) != ((unsigned __int8)v123 ^ (unsigned __int8)(BYTE1(v123) ^ BYTE2(v123))) )
                RtlpAnalyzeHeapFailure(a1, &v42[16 * v35]);
            }
            v124 = v45 + 16;
            v125 = *((_QWORD *)v45 + 2);
...
LABEL_277:
                v195 = v132;
                LOBYTE(v124) = 1;
                RtlpHeapRemoveListEntry(a1, (_DWORD)v129, (_DWORD)v124, (_DWORD)v45 + 16, v132, v130);
                v126 = v178;
              }
              *v126 = v125;
              *(_QWORD *)(v125 + 8) = v126;
              if ( (v45[10] & 8) == 0 || (unsigned __int8)RtlpCommitBlock(a1, &v42[16 * v35]) )
              {
                if ( v39 )
                {
                  v147 = v45[10];
                ...
                *(_WORD *)&v42[16 * v133 + 12] = v133 ^ *(_WORD *)(a1 + 140);
                ...
                if ( !v39 )
                {
                  ...
                  v135 = (_QWORD *)(a1 + 336);
                  if ( *(_QWORD *)(a1 + 312) )
                    Entry = (_QWORD *)RtlpFindEntry(a1, (unsigned __int16)v133);
                  else
                    Entry = (_QWORD *)*v135;
                  while ( v135 != Entry )
                  {
                  ...
                  v137 = v42 + 16;
                  v138 = (__int64 *)Entry[1];
                  if ( (_QWORD *)*v138 == Entry )
                  {
                    *v137 = Entry;
                    *((_QWORD *)v42 + 3) = v138;
                    *v138 = (__int64)v137;
                  ...
                  {
                    RtlpLogHeapFailure(13, 0, (_DWORD)Entry, 0, *v138, 0LL);
                  }
...
LABEL_79:
                    LOBYTE(v48) = 1;
                    RtlpHeapAddListEntry(a1, (_DWORD)v51, v48, v55, v165, v166);
                  }
LABEL_80:
                  v34 = v168;
                  if ( *(_DWORD *)(a1 + 124) )
...
LABEL_356:
                ...
                v151 = (_QWORD *)(a1 + 336);
                if ( *(_QWORD *)(a1 + 312) )
                  v152 = (_QWORD *)RtlpFindEntry(a1, v134);
                else
                  v152 = (_QWORD *)*v151;
                while ( v151 != v152 )
                {
                ...
                {
                  RtlpLogHeapFailure(13, 0, (_DWORD)v152, 0, *v155, 0LL);
                }
                *(_QWORD *)(a1 + 192) += *((unsigned __int16 *)v42 + 4);
                v51 = *(__int64 ***)(a1 + 312);
                if ( !v51 )
...
LABEL_255:
              ...
              LOBYTE(v142) = 1;
              RtlpDeCommitFreeBlock(a1, &v42[16 * v35], *((unsigned __int16 *)v45 + 4), v142);
            }
            else
            {
              RtlpLogHeapFailure(13, a1, (_DWORD)v124, v128, v127, 0LL);
            }
            if ( v171 )
            {
          ...
          *((_WORD *)v45 + 6) = v35 ^ *(_WORD *)(a1 + 140);
          ...
          if ( !v39 )
          {
            ...
            if ( *(_QWORD *)(a1 + 312) )
              v48 = RtlpFindEntry(a1, (unsigned int)v46);
            else
              v48 = *v47;
            ...
            {
              RtlpLogHeapFailure(13, 0, v48, 0, *v50, 0LL);
            }
            *(_QWORD *)(a1 + 192) += *((unsigned __int16 *)v42 + 4);
            v51 = *(__int64 ***)(a1 + 312);
            if ( v51 )
...
LABEL_243:
            v114 = (_QWORD *)(a1 + 336);
            if ( *(_QWORD *)(a1 + 312) )
              v115 = (_QWORD *)RtlpFindEntry(a1, v46);
            else
              v115 = (_QWORD *)*v114;
            while ( v114 != v115 )
            {
            ...
            {
              RtlpLogHeapFailure(13, 0, (_DWORD)v115, 0, *v118, 0LL);
            }
            *(_QWORD *)(a1 + 192) += *((unsigned __int16 *)v42 + 4);
            v51 = *(__int64 ***)(a1 + 312);
            if ( !v51 )
            ...
            while ( 1 )
            {
              ...
              {
                v120 = *((unsigned __int16 *)v42 + 4);
                v178 = (__int64 *)*((unsigned __int16 *)v42 + 4);
                goto LABEL_255;
              }
              if ( !*v51 )
                break;
            ...
            v120 = v48 - 1;
            v178 = (__int64 *)(unsigned int)(v48 - 1);
            goto LABEL_255;
          }
          v145 = v42 + 32;
          v193 = v42 + 32;
...
LABEL_200:
        ...
        if ( (v102[10] & 2) != 0 )
        {
          ExtraStuffPointer = (_QWORD *)RtlpGetExtraStuffPointer(v102);
          v202 = ExtraStuffPointer;
          *ExtraStuffPointer = 0LL;
          ExtraStuffPointer[1] = 0LL;
          if ( (*(_DWORD *)(a1 + 112) & 0x8000000) != 0 )
            *(_WORD *)ExtraStuffPointer = RtlLogStackBackTraceEx(1u);
          if ( (NtCurrentPeb()->NtGlobalFlag & 0x800) != 0 )
            *((_WORD *)v202 + 1) = RtlpUpdateTagEntry(a1, (v211 >> 18) & 0xFFF, 0, *v56, 0);
        }
        else if ( (NtCurrentPeb()->NtGlobalFlag & 0x800) != 0 )
        {
          v102[11] = RtlpUpdateTagEntry(a1, (unsigned __int8)(v211 >> 18), 0, *v56, 0);
        }
        if ( *(_DWORD *)(a1 + 124) )
        {
      ...
      else
      {
        ...
        if ( (int)(v174 - (unsigned __int16)v20) > 0 )
        {
          ...
          else
          {
            ...
            {
              if ( (_BYTE)v60 )
                v61 = (unsigned __int8)RtlpBitsClearLow[(unsigned __int8)v60];
              else
                v61 = (unsigned __int8)RtlpBitsClearLow[BYTE1(v60)] + 8;
            }
            else if ( (v60 & 0xFF0000) != 0 )
            {
              v61 = (unsigned __int8)RtlpBitsClearLow[BYTE2(v60)] + 16;
            }
            else
            {
              v61 = (unsigned __int8)RtlpBitsClearLow[(unsigned __int64)v60 >> 24] + 24;
            }
...
LABEL_182:
  ...
  else
  {
    ...
    if ( *(_DWORD *)(a1 + 124) )
    {
      ...
      *((_DWORD *)v21 + 2) = v22;
      if ( HIBYTE(v22) != ((unsigned __int8)v22 ^ (unsigned __int8)(BYTE1(v22) ^ BYTE2(v22))) )
        RtlpAnalyzeHeapFailure(a1, v16 - 2);
    }
    ...
    if ( v23 >= v174 )
    {
      ...
      {
        RtlpLogHeapFailure(13, a1, (_DWORD)v16, v27, v26, 0LL);
        goto LABEL_398;
      }
      *(_QWORD *)(a1 + 192) -= v23;
      v28 = *(__int64 ***)(a1 + 312);
...
LABEL_45:
        v194 = v31;
        LOBYTE(v10) = 1;
        RtlpHeapRemoveListEntry(a1, (_DWORD)v28, v10, (_DWORD)v16, v31, v29);
      }
      *v25 = v24;
      *(_QWORD *)(v24 + 8) = v25;
LABEL_47:
      ...
      {
        LOBYTE(v99) = 1;
        RtlpDeCommitFreeBlock(a1, v21, *((unsigned __int16 *)v21 + 4), v99);
        goto LABEL_398;
      }
      LOBYTE(v6) = v173;
      goto LABEL_49;
  ...
  v64 = (_QWORD *)RtlpExtendHeap(a1, v213);
  v21 = (char *)v64;
  v180 = (char *)v64;
  if ( !v64 )
  {
...
LABEL_121:
      v74 = (int)v65;
      LOBYTE(v65) = 1;
      RtlpHeapRemoveListEntry(a1, (_DWORD)v70, (_DWORD)v65, v74, v73, v71);
    }
    *v67 = v66;
    *(_QWORD *)(v66 + 8) = v67;
    goto LABEL_47;
  }
  RtlpLogHeapFailure(13, a1, (_DWORD)v65, v69, v68, 0LL);
LABEL_398:
  if ( v167 )
  {
    if ( !v169 && v172 )
      RtlpUpdateHeapWatermarks(a1, a2, v10);
    RtlLeaveCriticalSection(*(_QWORD *)(a1 + 352));
  }
  SharedData = NtCurrentPeb()->SharedData;
  if ( SharedData && *SharedData )
    v160 = (__int64)NtCurrentPeb()->SharedData + 558;
  else
    v160 = 2147353480LL;
  v161 = v172;
  if ( *(_BYTE *)v160 && v172 )
  {
    if ( v169 )
      RtlpHeapLogRangeReserve(a1, v169 & 0xFFFFFFFFFFFF0000uLL, *(_QWORD *)(v169 + 40));
  }
  return (__int64)v161;
}
