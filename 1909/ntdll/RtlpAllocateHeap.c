        ...
        _DWORD *a6)
{
  ...
  if ( v12 > *(unsigned int *)(a1 + 148) )
  {
    ...
    {
      v209 += 56LL;
      v102 = (RtlpHeapGenerateRandomValue32(a1, a2, 0LL) & 0xF) << 12;
      BaseAddress = 0LL;
      ...
      if ( (unsigned int)RtlpHpHeapCheckCommitLimit(
                           ...
                           *(_QWORD *)(a1 + 576) - *(_QWORD *)(a1 + 664),
                           a1,
                           a1 + 376)
        && ZwAllocateVirtualMemory((HANDLE)0xFFFFFFFFFFFFFFFFLL, &v165, 0LL, &v209, 0x1000u, HeapProtection) >= 0 )
      {
        ...
        *(_QWORD *)(a1 + 592) += v209;
        ...
        if ( RtlGetCurrentServiceSessionId() )
          v105 = (__int64)NtCurrentPeb()->SharedData + 550;
        else
          v105 = 2147353472LL;
        if ( *(_BYTE *)v105 && (NtCurrentPeb()->TracingFlags & 1) != 0 )
          RtlpLogHeapCommit(a1, v165, v209, 9LL);
        if ( RtlGetCurrentServiceSessionId() )
          v106 = (__int64)NtCurrentPeb()->SharedData + 550;
        else
          v106 = 2147353472LL;
        if ( *(_BYTE *)v106 && (NtCurrentPeb()->TracingFlags & 1) != 0 )
        {
          if ( RtlGetCurrentServiceSessionId() )
            v104 = (__int64)NtCurrentPeb()->SharedData + 550;
          RtlpLogHeapExtendEvent(a1, (int)v165, v209, 16 * *(_QWORD *)(a1 + 192), (HANDLE)*(unsigned __int8 *)v104);
        }
        v107 = 2147353482LL;
        if ( RtlGetCurrentServiceSessionId() )
        ...
        if ( *(_BYTE *)v108 )
        {
          ...
          RtlpLogHeapExtendEvent(a1, (int)v165, v209, 16 * *(_QWORD *)(a1 + 192), (HANDLE)*(unsigned __int8 *)v107);
        }
        if ( (*(_DWORD *)(a1 + 112) & 0x8000000) != 0 )
          *((_WORD *)v165 + 8) = RtlLogStackBackTraceEx(1u);
        if ( (NtCurrentPeb()->NtGlobalFlag & 0x800) != 0 )
        {
          updated = RtlpUpdateTagEntry(a1, (unsigned __int8)(v8 >> 18), 0, *((_QWORD *)v165 + 4) >> 4, 1);
          *((_WORD *)v165 + 9) = updated;
        }
        v109 = v165;
        if ( *(_DWORD *)(a1 + 124) )
        {
...
LABEL_157:
      ...
      *(_QWORD *)(v86 + 8) = v87;
      v32 = v21 + 10;
      if ( (v21[10] & 8) != 0 && !(unsigned __int8)RtlpCommitBlock(a1) )
      {
...
LABEL_277:
                v191 = v129;
                LOBYTE(v121) = 1;
                RtlpHeapRemoveListEntry(a1, (_DWORD)v126, (_DWORD)v121, (_DWORD)v45 + 16, v129, v127);
                v123 = v174;
              }
              *v123 = v122;
              *(_QWORD *)(v122 + 8) = v123;
              if ( (v45[10] & 8) == 0 || (unsigned __int8)RtlpCommitBlock(a1) )
              {
                if ( v39 )
                {
                  v143 = v45[10];
                ...
                *(_WORD *)&v42[16 * v130 + 12] = v130 ^ *(_WORD *)(a1 + 140);
                ...
                if ( !v39 )
                {
                  ...
                  v132 = (_QWORD *)(a1 + 336);
                  if ( *(_QWORD *)(a1 + 312) )
                    Entry = (_QWORD *)RtlpFindEntry(a1, (unsigned __int16)v130);
                  else
                    Entry = (_QWORD *)*v132;
                  while ( v132 != Entry )
                  {
                  ...
                  v134 = v42 + 16;
                  v135 = (__int64 *)Entry[1];
                  if ( (_QWORD *)*v135 == Entry )
                  {
                    *v134 = Entry;
                    *((_QWORD *)v42 + 3) = v135;
                    *v135 = (__int64)v134;
                  ...
                  {
                    RtlpLogHeapFailure(13, 0, (_DWORD)Entry, 0, *v135, 0LL);
                  }
...
LABEL_79:
                    LOBYTE(v48) = 1;
                    RtlpHeapAddListEntry(a1, (_DWORD)v51, v48, v55, AllocationType, Protect);
                  }
LABEL_80:
                  v34 = v164;
                  if ( *(_DWORD *)(a1 + 124) )
...
LABEL_356:
                ...
                v147 = (_QWORD *)(a1 + 336);
                if ( *(_QWORD *)(a1 + 312) )
                  v148 = (_QWORD *)RtlpFindEntry(a1, v131);
                else
                  v148 = (_QWORD *)*v147;
                while ( v147 != v148 )
                {
                ...
                {
                  RtlpLogHeapFailure(13, 0, (_DWORD)v148, 0, *v151, 0LL);
                }
                *(_QWORD *)(a1 + 192) += *((unsigned __int16 *)v42 + 4);
                v51 = *(__int64 ***)(a1 + 312);
                if ( !v51 )
...
LABEL_255:
            ...
            {
              RtlpLogHeapFailure(13, a1, (_DWORD)v121, v125, v124, 0LL);
            }
            if ( v167 )
            {
...
LABEL_243:
            v111 = (_QWORD *)(a1 + 336);
            if ( *(_QWORD *)(a1 + 312) )
              v112 = (_QWORD *)RtlpFindEntry(a1, v46);
            else
              v112 = (_QWORD *)*v111;
            while ( v111 != v112 )
            {
            ...
            {
              RtlpLogHeapFailure(13, 0, (_DWORD)v112, 0, *v115, 0LL);
            }
            *(_QWORD *)(a1 + 192) += *((unsigned __int16 *)v42 + 4);
            v51 = *(__int64 ***)(a1 + 312);
            if ( !v51 )
            ...
            while ( 1 )
            {
              ...
              {
                v117 = *((unsigned __int16 *)v42 + 4);
                v174 = (__int64 *)*((unsigned __int16 *)v42 + 4);
                goto LABEL_255;
              }
              if ( !*v51 )
                break;
            ...
            v117 = v48 - 1;
            v174 = (__int64 *)(unsigned int)(v48 - 1);
            goto LABEL_255;
          }
          v141 = v42 + 32;
          v189 = v42 + 32;
...
LABEL_200:
        ...
        if ( (v100[10] & 2) != 0 )
        {
          ExtraStuffPointer = (_QWORD *)RtlpGetExtraStuffPointer(v100);
          v198 = ExtraStuffPointer;
          *ExtraStuffPointer = 0LL;
          ExtraStuffPointer[1] = 0LL;
          if ( (*(_DWORD *)(a1 + 112) & 0x8000000) != 0 )
            *(_WORD *)ExtraStuffPointer = RtlLogStackBackTraceEx(1u);
          if ( (NtCurrentPeb()->NtGlobalFlag & 0x800) != 0 )
            *((_WORD *)v198 + 1) = RtlpUpdateTagEntry(a1, (v207 >> 18) & 0xFFF, 0, *v56, 0);
        }
        else if ( (NtCurrentPeb()->NtGlobalFlag & 0x800) != 0 )
        {
          v100[11] = RtlpUpdateTagEntry(a1, (unsigned __int8)(v207 >> 18), 0, *v56, 0);
        }
        if ( *(_DWORD *)(a1 + 124) )
        {
...
LABEL_398:
  ...
  {
    if ( v165 )
      RtlpHeapLogRangeReserve(a1, (unsigned __int64)v165 & 0xFFFFFFFFFFFF0000uLL, *((_QWORD *)v165 + 5));
  }
  return v157;
}
