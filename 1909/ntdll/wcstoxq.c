/*
 * XREFs of wcstoxq @ 0x18008EB74
 * Callers:
 *     _wcstoi64 @ 0x18008EB10 (_wcstoi64.c)
 *     _wcstoui64 @ 0x18008EB40 (_wcstoui64.c)
 * Callees:
 *     _errno @ 0x1800849C0 (_errno.c)
 *     _invalid_parameter @ 0x18008CD78 (_invalid_parameter.c)
 *     _iswctype_l @ 0x180090780 (_iswctype_l.c)
 *     _wchartodigit @ 0x1800947B4 (_wchartodigit.c)
 */
