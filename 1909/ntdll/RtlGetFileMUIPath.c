        ...
        if ( v20 != 1 )
        {
          if ( v20 == 2 )
          {
            ...
            do
            {
              ...
              MUIRedirectedFilePath = RtlpGetMUIRedirectedFilePath(&v93, Heap, v48, v84, BytesRequired, v67, v80);
              v7 = 0LL;
          ...
          else
          {
            ...
            do
            {
              if ( !v52 || (v62 = wcsicmp(v59, DestinationString.Buffer), v7 = 0LL, !v62) )
              {
                ...
                v63 = RtlpGetMUIRedirectedFilePath(&v95, Heap, FilePart, v84, BytesRequired, v67, v80);
                v7 = 0LL;
...
LABEL_38:
          if ( v9 < v27 )
          {
            ...
            if ( SourceString || v85 )
            {
              ...
              if ( v65 )
                v65 = (int)RtlIntegerToUnicode((unsigned __int16)Lcid, 0x10u, -4, (char *)v96) >= 0;
...
LABEL_50:
        ...
        if ( ReturnLength )
        {
          v41 = LdrpCalcAllocSize(ReturnLength, 2uLL);
          if ( !v41 )
          {
            v14 = -1073741675;
LABEL_68:
...
LABEL_30:
  ...
  if ( !ReturnLength )
    goto LABEL_14;
  v24 = LdrpCalcAllocSize(ReturnLength, 2uLL);
  if ( v24 )
  {
