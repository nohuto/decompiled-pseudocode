/*
 * XREFs of LdrProcessRelocationBlockLongLong @ 0x1800838A0
 * Callers:
 *     LdrRelocateImageWithBias @ 0x1800837A8 (LdrRelocateImageWithBias.c)
 *     LdrProcessRelocationBlock @ 0x1800E2070 (LdrProcessRelocationBlock.c)
 *     LdrProcessRelocationBlockEx @ 0x1800E20A0 (LdrProcessRelocationBlockEx.c)
 * Callees:
 *     LdrpArmProcessRelocation @ 0x1800E20AC (LdrpArmProcessRelocation.c)
 *     LdrpThumbProcessRelocation @ 0x1800E2178 (LdrpThumbProcessRelocation.c)
 */
