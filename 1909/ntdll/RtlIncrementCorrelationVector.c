/*
 * XREFs of RtlIncrementCorrelationVector @ 0x180072BA0
 * Callers:
 *     <none>
 * Callees:
 *     RtlpGetCorrelationVectorBufferLength @ 0x18007356C (RtlpGetCorrelationVectorBufferLength.c)
 *     __security_check_cookie @ 0x18008CE50 (__security_check_cookie.c)
 *     _snprintf_s @ 0x180097620 (_snprintf_s.c)
...
DWORD __cdecl RtlIncrementCorrelationVector(PCORRELATION_VECTOR CorrelationVector)
{
  ...
  v4 = -1;
  v7 = RtlpGetCorrelationVectorBufferLength(v6, v5);
  v10 = v7;
  if ( v7 <= 0 )
    return -2147483643;
  v11 = 0LL;
  ...
  if ( v15 >= CorrelationVectorBufferLength - v4 - 2 )
    return -2147483643;
