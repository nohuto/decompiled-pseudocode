...
LABEL_44:
      ...
      if ( v24 )
      {
        ...
        result = RtlpHpSegMgrCommit(a1, v24, v44, v55);
        if ( (int)result < 0 )
          return result;
        if ( v24 > 0 )
          RtlpHpSegPageRangeHandleCommit(a1, a2, (unsigned int)&v56, (unsigned int)&v57, 1);
        ...
        *(_WORD *)(a2 + 28) = ~(v24 + ~*(_WORD *)(a2 + 28));
        ...
        if ( *(_BYTE *)v46 && (NtCurrentPeb()->TracingFlags & 1) != 0 )
        {
          ...
          if ( v24 <= 0 )
            RtlpLogHeapDecommit(v47, v48, v49, 13LL);
          else
            RtlpLogHeapCommit(v47, v48, v49, 10LL);
        }
      }
      v9 += v50;
      v14 = v24 + v54;
