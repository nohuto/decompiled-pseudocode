/*
 * XREFs of RtlpSetTimeZoneInformationWorker @ 0x1800EB658
 * Callers:
 *     RtlSetDynamicTimeZoneInformation @ 0x1800EB5B0 (RtlSetDynamicTimeZoneInformation.c)
 *     RtlSetTimeZoneInformation @ 0x1800EB5C0 (RtlSetTimeZoneInformation.c)
 * Callees:
