/*
 * XREFs of TpAllocPoolInternal @ 0x180062FD4
 * Callers:
 ...
 *     NtCreateIoCompletion @ 0x18009E380 (NtCreateIoCompletion.c)
 *     NtCreateWorkerFactory @ 0x18009E780 (NtCreateWorkerFactory.c)
...
__int64 __fastcall TpAllocPoolInternal(__int64 *a1, char a2)
{
  ...
  *a1 = 0LL;
  ...
  if ( !Heap )
    goto LABEL_37;
  v40 = TppHeapTag + 786432;
  v35 = RtlAllocateHeap((__int64)NtCurrentPeb()->ProcessHeap, TppHeapTag + 786432, 72LL * (unsigned int)TppNumberNodes);
  if ( !v35 )
  {
    updated = -1073741801;
    v33 = -1073741801;
  ...
  if ( updated >= 0 )
  {
    ...
    *(_DWORD *)Heap = 1;
    ...
    if ( updated >= 0 )
    {
      ...
      if ( v39 )
      {
        updated = NtSetInformationWorkerFactory(*v22, 13LL, &v39);
        v33 = updated;
        if ( updated < 0 )
        {
LABEL_35:
      ...
      *(_QWORD *)(Heap + 456) = Heap + 456;
      TppGetCurrentThreadNumaNode(Heap, v36, 0LL);
      *(_QWORD *)(Heap + 400) = retaddr;
      updated = TppInitializeTimerQueue(Heap + 112, Heap, v23);
      v33 = updated;
      if ( updated >= 0 )
      {
        updated = 0;
        ...
        v24 = (_QWORD *)(Heap + 384);
        v25 = off_18015F618;
        if ( *off_18015F618 != (_UNKNOWN *)&TppPoolpList )
          __fastfail(3u);
        *v24 = &TppPoolpList;
        *(_QWORD *)(Heap + 392) = v25;
        *v25 = v24;
...
LABEL_42:
  ...
  {
    if ( v35 )
      RtlFreeHeap((__int64)NtCurrentPeb()->ProcessHeap, TppHeapTag + 786432, v35);
    v31 = *(_QWORD *)(Heap + 40);
    if ( v31 )
