/*
 * XREFs of SbpRetrieveCompatibilityManifest @ 0x18007ACA4
 * Callers:
...
__int64 __fastcall SbpRetrieveCompatibilityManifest(volatile signed __int32 *a1, __int64 *a2, unsigned __int64 *a3)
{
  struct _PEB *v3; // rax
  unsigned int v4; // ebx
  __int64 v5; // rbp
