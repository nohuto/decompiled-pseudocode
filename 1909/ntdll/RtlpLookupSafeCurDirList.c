/*
 * XREFs of RtlpLookupSafeCurDirList @ 0x1800DDFF0
 * Callers:
  ...
  *(_DWORD *)&ValueName.Length = 0x2000000;
  if ( qword_1801627C0 == -1 )
  {
    ...
    if ( Heap )
    {
      Heap[1] = Heap;
      *Heap = Heap;
      KeyHandle = qword_1801665F8;
      v3 = qword_1801665F8;
      if ( !qword_1801665F8 )
      {
        v4 = NtOpenKey(&KeyHandle, 1u, (POBJECT_ATTRIBUTES)&stru_1801194B8);
        v5 = (signed __int64)KeyHandle;
        if ( v4 < 0 )
          v5 = -1LL;
        KeyHandle = (HANDLE)v5;
        v3 = (HANDLE)_InterlockedCompareExchange64((volatile signed __int64 *)&qword_1801665F8, v5, 0LL);
        if ( v3 )
        {
          if ( v4 >= 0 )
            NtClose(KeyHandle);
