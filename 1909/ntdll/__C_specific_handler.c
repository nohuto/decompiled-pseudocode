/*
 * XREFs of __C_specific_handler @ 0x18008D2E0
 * Callers:
 *     __GSHandlerCheck_SEH @ 0x18009CA24 (__GSHandlerCheck_SEH.c)
 * Callees:
 *     RtlUnwindEx @ 0x18001D490 (RtlUnwindEx.c)
 *     _NLG_Notify @ 0x180093090 (_NLG_Notify.c)
 *     __NLG_Return2 @ 0x1800930C0 (__NLG_Return2.c)
 *     __except_validate_context_record @ 0x1800930C8 (__except_validate_context_record.c)
 */
