/*
 * XREFs of RtlCompressBufferXpressHuffMax @ 0x180108D24
 * Callers:
  ...
  if ( a4 >= 0x12C )
  {
    ...
    *((_QWORD *)a6 + 0x8000) = 0LL;
    ...
    while ( 1 )
    {
      ...
      do
      {
        v23 = (unsigned __int16)XpressHashFunction[*v21] ^ (unsigned __int16)word_1801395D0[v21[2]] ^ (unsigned __int64)(unsigned __int16)word_1801393D0[v21[1]];
        v24 = *(_QWORD *)&a6[8 * v23];
        *(_QWORD *)&a6[8 * v23] = v21++;
...
LABEL_87:
      ...
      *(_DWORD *)v10 = 2 * v17 + 1;
      ...
      if ( &v12[4 * ((unsigned __int64)(XpressBuildHuffmanEncodings((_QWORD *)a6 + 163840) + v57 + 31) >> 5) + 258 + v58] >= v61 )
        return 3221225507LL;
      v10 = a6 + 1342240;
      v12 = XpressDoHuffmanPass((__int64)(a6 + 1310720), a6 + 1342240, (unsigned __int64)v16, (__int64)v12, v54);
      v59 = v12;
      v55 = v54 == 0;
      v7 = a2;
      if ( !v55 )
