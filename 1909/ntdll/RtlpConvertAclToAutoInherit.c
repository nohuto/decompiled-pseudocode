/*
 * XREFs of RtlpConvertAclToAutoInherit @ 0x1800E53E0
 * Callers:
        ...
        _DWORD *a9)
{
  ...
  __int64 v88; // [rsp+B8h] [rbp-58h] BYREF
  ...
  _WORD *v98; // [rsp+100h] [rbp-10h]
  _WORD *v99; // [rsp+108h] [rbp-8h]
          ...
          if ( v37 )
          {
            ...
            if ( v38 | ~v34[1] & 8 )
            {
              ...
              if ( a2[2] )
              {
                ...
                do
                {
                  if ( RtlpCompareAces(v34, (unsigned __int8 *)v40, v99, v98) )
                  {
                    v46 &= ~*(v48 - 3);
                    v47 &= ~*(v48 - 5);
                    v49 &= ~*(v48 - 4);
...
LABEL_45:
        ...
        if ( (_WORD)v22 )
        {
          ...
          do
          {
            ...
            {
              if ( !RtlBaseAceType[v58] )
                v52 = 1;
              v12 = v97;
              if ( RtlBaseAceType[v58] == 1 )
                v53 = 1;
...
LABEL_90:
    ...
    if ( (*v12 & 0x1000) != 0 )
    {
      ...
      v78 = (void *)RtlAllocateHeap((__int64)ProcessHeap, NtdllBaseTag + 1310720, a2[1]);
      *v10 = (__int64)v78;
      if ( v78 )
        memmove(v78, a2, a2[1]);
      else
...
LABEL_66:
  ...
  if ( v90 )
    RtlFreeHeap((__int64)ProcessHeap, 0, (__int64)v90);
  return (unsigned int)v15;
}
