  ...
  *(_QWORD *)(a4 + 136) = *(unsigned __int16 *)(a4 + 146) + a4 + 176;
  ...
  if ( !result )
  {
    ...
    *(_DWORD *)(v15 + 208) = ~(v34 - 1) & (*(_DWORD *)(v15 + 208) + v34 - 1);
    ...
    {
      v17 = EtwpAddLogHeaderToLogFile(v15, v7, v8, (*(_DWORD *)(v15 + 324) & 4) != 0);
      if ( v17 )
      {
    ...
    *(_DWORD *)(v15 + 212) = v19 & 0xFFFFFFF8;
    ...
    {
      TraceBufferPool = EtwpRegisterPrivateSession(*(unsigned __int16 *)(v15 + 20), &v31, &v28);
      if ( TraceBufferPool )
        goto LABEL_60;
      *(_QWORD *)(v15 + 560) = v31;
    }
    ...
    if ( (*(_DWORD *)(v15 + 324) & 0x400) == 0 )
    {
      EtwThread = EtwpCreateEtwThread((__int64)EtwpLogger, inited);
      if ( !EtwThread )
      {
    ...
    EtwpGetUmLoggerInfoFromContext(a4, v22, &v28);
    _InterlockedExchange64((volatile __int64 *)(EtwpLoggerArray + 8 * v21), v22);
