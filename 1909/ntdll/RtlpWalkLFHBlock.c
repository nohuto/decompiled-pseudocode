/*
 * XREFs of RtlpWalkLFHBlock @ 0x180107CFC
 * Callers:
...
LABEL_23:
  ...
  v29 = *(_QWORD *)(v5 + 24);
  if ( ((*(_BYTE *)(v6 + 10) ^ (unsigned __int8)(*(_BYTE *)(v29 + 138) & (*(_DWORD *)(v29 + 124) >> 20))) & 1) == 0 )
    goto LABEL_124;
  if ( *(_DWORD *)(v29 + 124) )
  {
    v30 = *(_DWORD *)(v6 + 8);
    LOWORD(v61) = v30;
    if ( (v30 & *(_DWORD *)(v29 + 124)) != 0 )
      v61 = *(_DWORD *)(v29 + 136) ^ v30;
    v31 = v61;
  }
  else
  {
...
LABEL_124:
  if ( !RtlpIsLFHZoneAllocation(v5, v6) && v5 != *(_QWORD *)a2 )
  {
    v53 = *(_QWORD *)(v5 + 24);
    v54 = *(_BYTE *)(v6 + 10);
    v55 = *(_BYTE *)(v53 + 138);
