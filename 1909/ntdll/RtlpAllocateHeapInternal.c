...
LABEL_179:
      ...
      if ( (v68 & 4) != 0 )
      {
        ...
        if ( v69 )
          v89 = v69;
        RtlpAllocateHeapRaiseException(v89);
      }
LABEL_183:
...
LABEL_200:
      ...
      if ( (dword_1801663A8 & 1) != 0 && (dword_1801663A8 & 2) != 0 )
      {
        ...
        {
          v117[0] = RtlpHpEnvHandle;
          if ( HeapHandle != *(unsigned __int16 **)RtlpHpMetadataHeapCtxGet(v117) && Heap && (v68 & 0x10000000) == 0 )
            goto LABEL_207;
        }
      }
      return Heap;
    ...
    if ( v74 )
    {
      ...
      {
        if ( (int)RtlpCallInterceptRoutine(v74, (_DWORD)HeapHandle, 0, 1, (__int64)&v105) < 0 )
          goto LABEL_178;
      ...
      && ((unsigned __int8)(1 << ((v69 >> 4) & 7)) & *((_BYTE *)HeapHandle + (v69 >> 7) + 434)) != 0 )
    {
      ...
      LODWORD(v97) = 2;
      Heap = RtlpLowFragHeapAllocFromContext(v79, *(unsigned __int16 *)(v78 + 2 * v77), a2, v68);
      if ( Heap )
      {
LABEL_175:
        if ( !v118 )
          goto LABEL_183;
        a2 -= v105;
        v87 = RtlpSetupExtendedBlock((_DWORD)HeapHandle, v68, Heap, v80, v105, v118);
        v96 = Heap;
        Heap = v87;
        if ( (int)RtlpCallInterceptRoutine(v118, (_DWORD)HeapHandle, v87, 2, v96) >= 0 )
          goto LABEL_183;
...
LABEL_173:
    ...
    Heap = RtlpAllocateHeap((int)HeapHandle, v86, (__int64)&v97);
    if ( !Heap )
      goto LABEL_179;
    goto LABEL_175;
  }
...
LABEL_129:
  ...
  if ( dword_18015F9B8 || (v20 = *((_QWORD *)HeapHandle + 6)) == 0 && (v20 = qword_180163568) == 0 || v17 <= v20 )
  {
    ...
    if ( (v19 & 0x1000000) == 0 )
    {
      ...
      {
        v19 |= 8u;
        if ( (int)RtlpCallInterceptRoutine(v24, (_DWORD)HeapHandle, 0, 1, (__int64)&v109) < 0 )
        {
          Heap = 0LL;
          v22 = 0LL;
LABEL_119:
    ...
    if ( (*(_QWORD *)&HeapHandle[4 * v110 + 480] & 1) != 0 )
    {
      ...
      if ( (*v34 & 1) != 0 )
      {
        ...
        {
          RtlpHpLfhBucketActivate(HeapHandle + 416, (unsigned int)v33);
          v31 = (char *)(HeapHandle + 416);
        }
      }
      if ( (*v34 & 1) != 0 )
    ...
    v111 = ((((unsigned int)RtlpHpLfhPerfFlags >> 10) & 1) + 2LL) << 6;
    v112 = v111 - (((_BYTE)v41 - 1) & 7) + v41 + 7;
    v42 = (void *)RtlpHpLfhSlotAllocate((__int64)v31, v28);
    Heap = (__int64)v42;
    if ( v42 )
    {
      v43 = (v28 & 2) == 0;
...
LABEL_74:
    if ( v22 > 0x20000 )
    {
      ...
      {
        v45 = (void *)RtlpHpLargeAlloc(HeapHandle);
      }
      else
      {
        v44 = 224LL;
        if ( v22 <= *((unsigned int *)HeapHandle + 68) )
          v44 = 128LL;
        v45 = RtlpHpSegAlloc((__int64)&HeapHandle[v44], v17, v22, v22, v28);
      }
      Heap = (__int64)v45;
    }
    else
    {
      ...
      SRWLock = 0LL;
      v115 = 0LL;
      Heap = (__int64)RtlpHpVsContextAllocateInternal(
                        (PRTL_SRWLOCK)HeapHandle + 80,
                        v17,
                        v22,
                        v28,
                        (__int64)&v113,
...
LABEL_116:
      ...
      if ( v103 )
      {
        *(_BYTE *)(v50 + 2) &= 0xF0u;
        *(_BYTE *)(v50 + 2) |= v63 & 0xF;
        if ( (int)RtlpCallInterceptRoutine(v63, (_DWORD)HeapHandle, Heap, 2, v50 + 16) < 0 )
        {
          RtlFreeHeap(HeapHandle, 0, (PVOID)Heap);
          Heap = 0LL;
        }
    ...
    *(_WORD *)v50 = a4;
    ...
    {
      v52 = RtlCSparseBitmapBitmaskRead(&BaseAddress, 2 * ((unsigned __int64)(Heap - qword_180166A68) >> 20));
      if ( !v52 || (v53 = v52 - 1, v53 == 2) )
      {
        RtlpHpLargeAllocSetExtraPresent(HeapHandle, Heap, v102);
        goto LABEL_116;
      }
    }
    v54 = 96LL * v53;
    ...
    {
      DescriptorValidateSafe = RtlpHpSegGetDescriptorValidateSafe(&HeapHandle[v54 + 128], Heap);
    }
    else
    {
      v56 = *(_QWORD *)v55 & Heap;
      if ( (RtlpHpHeapGlobals ^ v55 ^ v56 ^ *(_QWORD *)(v56 + 0x10)) == 0xA2E64EADA2E64EADuLL )
        DescriptorValidateSafe = v56 + 32 * ((unsigned __int64)(unsigned int)(Heap - v56) >> *(_BYTE *)(v55 + 8));
      else
    ...
    if ( DescriptorValidateSafe )
    {
      ...
      if ( (v58 & 1) != 0 )
      {
        if ( (v58 & 2) != 0 )
        {
          if ( (v58 & 0xCu) >= 8 || (((1 << *(_BYTE *)(v55 + 8)) - 1) & (unsigned __int64)Heap) == 0 )
            goto LABEL_111;
        }
        else
        {
    ...
    DescriptorValidateSafe = 0LL;
LABEL_111:
    v60 = *(unsigned __int8 *)(DescriptorValidateSafe + 24);
    LOBYTE(v60) = v60 & 0xC;
    ...
    {
      v61 = ((DescriptorValidateSafe - (*(_QWORD *)v55 & DescriptorValidateSafe)) >> 5 << *(_BYTE *)(v55 + 8))
          + (*(_QWORD *)v55 & DescriptorValidateSafe);
      if ( (_BYTE)v60 == 8 )
      {
      ...
      {
        RtlpHpVsChunkSetExtraPresent(*(_QWORD *)(v55 + 32), Heap, v60, v61);
      }
    }
    goto LABEL_116;
  }
  ...
  if ( v21 )
    RtlpLogHeapFailure(20, (_DWORD)HeapHandle, 0, v21, v16 + a2, *((_QWORD *)HeapHandle + 6));
  Heap = 0LL;
  v22 = 0LL;
LABEL_120:
  ...
  if ( (dword_1801663A8 & 1) != 0 && (dword_1801663A8 & 2) != 0 )
  {
    if ( NtCurrentPeb()->ProcessHeap )
    {
      v116 = RtlpHpEnvHandle;
      if ( HeapHandle != *(unsigned __int16 **)RtlpHpMetadataHeapCtxGet(&v116) )
LABEL_207:
