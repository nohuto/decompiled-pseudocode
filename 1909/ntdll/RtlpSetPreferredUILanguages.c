...
__int64 __fastcall RtlpSetPreferredUILanguages(int a1, WCHAR *a2, _DWORD *a3)
{
  ...
  HANDLE v62; // [rsp+B8h] [rbp-48h]
  HANDLE v63; // [rsp+C0h] [rbp-40h]
  WCHAR *v64; // [rsp+C8h] [rbp-38h] BYREF
  wchar_t *v65; // [rsp+D0h] [rbp-30h]
  HANDLE v66; // [rsp+D8h] [rbp-28h] BYREF
