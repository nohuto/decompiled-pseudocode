...
LABEL_25:
        ...
        while ( 1 )
        {
          v22 = _InterlockedCompareExchange64(&RtlCriticalSectionLock, v14 - 4, v14);
          v19 = v14 == v22;
          v14 = v22;
          if ( v19 )
            break;
...
LABEL_11:
    ...
    if ( RtlpStackTraceDatabase
      && (_DWORD)v11
      && (unsigned int)v11 <= *(_DWORD *)(RtlpStackTraceDatabase + 180)
      && *(_QWORD *)(*(_QWORD *)(RtlpStackTraceDatabase + 184) - 8 * v11)
