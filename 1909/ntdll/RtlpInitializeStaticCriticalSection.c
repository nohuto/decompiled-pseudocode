...
LABEL_15:
        ...
        if ( (*(_DWORD *)(v12 + 36) & 1) != 0 )
        {
          ...
          if ( result )
          {
            *(_QWORD *)((v9 & 0xFFFFFFFFFFFFFFF0uLL) + 8) = result;
            *(_QWORD *)(v12 + 16) = 0LL;
...
LABEL_19:
              ...
              if ( !_interlockedbittestandreset((volatile signed __int32 *)(v12 + 36), 1u) )
                result = ZwAlertThreadByThreadId(*(_QWORD *)(v12 + 24));
              v12 = v14;
            }
            while ( v14 );
            return result;
        ...
        result = _InterlockedCompareExchange64(&RtlCriticalSectionLock, 0LL, v9);
        v13 = v9 == result;
        v9 = result;
        if ( v13 )
          goto LABEL_19;
