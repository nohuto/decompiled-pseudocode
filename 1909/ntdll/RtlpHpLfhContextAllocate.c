/*
 * XREFs of RtlpHpLfhContextAllocate @ 0x180046108
 * Callers:
...
__int64 __fastcall RtlpHpLfhContextAllocate(__int64 a1, size_t Size, unsigned int a3, unsigned int a4)
{
  size_t v4; // rdi
  bool v5; // zf
  __int64 v6; // rdx
  ...
  v16 = ((((unsigned int)RtlpHpLfhPerfFlags >> 10) & 1) + 2LL) << 6;
  ...
  v13 = (void *)RtlpHpLfhSlotAllocate(a1, (_RTL_SRWLOCK *)v10, *(_QWORD *)(v11 + 8LL * v12 + v10), v4, a4);
  v14 = v13;
  if ( v13 && (a4 & 2) != 0 )
    memset(v13, 0, v4);
  return (__int64)v14;
