/*
 * XREFs of _output_s @ 0x180098BE0
 * Callers:
 ...
 *     write_multi_char_1 @ 0x18009968C (write_multi_char_1.c)
 *     write_string_1 @ 0x1800996E4 (write_string_1.c)
 *     memset @ 0x1800A3DC0 (memset.c)
 */

__int64 __fastcall output_s(__int64 a1, _BYTE *a2, int *a3)
{
  int v5; // edi
  int v6; // esi
...
LABEL_114:
                  ...
                  {
                    LOBYTE(v17) = 32;
                    write_multi_char_1(v17, v41, v60, &v53);
                  }
                  write_string_1(v52, v7, v60, &v53);
                  v43 = v60;
                  if ( (v5 & 0xC) == 8 )
                  {
                    LOBYTE(v42) = 48;
                    write_multi_char_1(v42, v41, v60, &v53);
                  }
                  if ( v57 && (int)v11 > 0 )
                  {
                    v44 = v8;
                    ...
                    while ( 1 )
                    {
                      v46 = *v44++;
                      --v45;
                      if ( (unsigned int)safecrt_wctomb_s(&v63, v66, 6LL, v46) || !v63 )
                        break;
                      write_string_1(v66, v63, v60, &v53);
                      if ( !v45 )
                        goto LABEL_127;
                    }
                    v53 = -1;
LABEL_127:
                  ...
                  {
                    write_string_1(v8, (unsigned int)v11, v43, &v53);
                  }
                  if ( v53 >= 0 && (v5 & 4) != 0 )
                  {
                    LOBYTE(v47) = 32;
                    write_multi_char_1(v47, v41, v43, &v53);
                    v6 = v55;
                    a2 = v64;
                  }
                  else
...
LABEL_50:
                ...
                if ( (v5 & 0x810) != 0 )
                {
                  v25 = safecrt_wctomb_s(&v56, v65, 512LL, *((unsigned __int16 *)a3 - 4));
                  LODWORD(v11) = v56;
                  if ( v25 )
                    v62 = 1;
                }
