/*
 * XREFs of NdisMFreeNetBufferSGList @ 0x1C00102F0
 * Callers:
 *     <none>
 * Callees:
 *     PplpLazyInitializeLookasideList @ 0x1C003DD48 (PplpLazyInitializeLookasideList.c)
 *     _guard_dispatch_icall_nop @ 0x1C0041350 (_guard_dispatch_icall_nop.c)
 *     ?RtlCopyBufferToMdl@@YAJPEAXPEAU_MDL@@_K2PEA_K@Z @ 0x1C0078894 (-RtlCopyBufferToMdl@@YAJPEAXPEAU_MDL@@_K2PEA_K@Z.c)
 */
        ...
        PNET_BUFFER NetBuffer)
{
  ...
  else if ( (Reserved & 2) != 0 )
  {
    ...
    if ( (Reserved & 4) == 0 )
    {
      RtlCopyBufferToMdl(&v14[48 * v4->CurrentMdlOffset], v4->CurrentMdl, v4->CurrentMdlOffset, v4->DataLength, &v15);
      Reserved = v4->Reserved;
    }
