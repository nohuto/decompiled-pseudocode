/*
 * XREFs of ?ndisNblTrackerVerifyNoNblsHeld@@YAXPEAU_NDIS_NBL_TRACKER@@@Z @ 0x1C00AADFC
 * Callers:
 ...
 *     ndisNblTrackerAreNblsOutstandingOnComponent @ 0x1C00AA5DC (ndisNblTrackerAreNblsOutstandingOnComponent.c)
 */
