/*
 * XREFs of ?ndisLWM5IndicateReceive@@YAXPEAU_X_FILTER@@PEAX1I1II@Z @ 0x1C00AD098
 * Callers:
 *     EthIndicateReceive @ 0x1C00AE1D0 (EthIndicateReceive.c)
 * Callees:
        ...
        size_t Size)
{
  ...
  Packet = 0LL;
  v9 = a4;
  if ( (Miniport->Flags & 0x20000000) == 0 )
    return;
...
LABEL_34:
  ...
  v21 = (MDL *)((Head->MdlFlags & 5) != 0 ? Head->MappedSystemVa : MmMapLockedPages(Head, 0));
  v22 = (unsigned int)v37;
  ByteCount = Head->ByteCount;
  Buffer = v21;
  memmove(v21, Src, (unsigned int)v37);
  NdisAllocateBuffer(&Status, &Buffer, 0LL, (char *)Buffer + v22, ByteCount - v37);
  v17 = Status;
  if ( Status )
    goto LABEL_32;
  v24 = Buffer;
  ...
  *(_QWORD *)Packet->ProtocolReserved = Head;
  ...
  v17 = ((__int64 (__fastcall *)(PNDIS_PACKET, int *, void *, void *, _DWORD, _DWORD))Miniport->DriverHandle->MiniportDriverCharacteristics.ResetHandlerEx)(
          v25,
          &v31,
...
LABEL_27:
  *(unsigned int *)((char *)&Packet->Private.Count + Packet->Private.NdisPacketOobOffset) = 0;
  ...
  Miniport->PacketIndicateHandler(Miniport, &Packet, 1u);
  if ( (Miniport->Flags & 0x40000) == 0 )
  {
    v30 = Packet;
