/*
 * XREFs of ?ndisRestartProtocol@@YAXPEAU_NDIS_MINIPORT_BLOCK@@PEAUNDIS_BIND_PROTOCOL_LINK@@PEAUNDIS_RESTART_INFORMATION@@@Z @ 0x1C0104620
 * Callers:
 ...
 *     WPP_RECORDER_SF_ZqD @ 0x1C002854C (WPP_RECORDER_SF_ZqD.c)
