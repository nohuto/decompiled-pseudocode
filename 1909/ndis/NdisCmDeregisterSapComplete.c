/*
 * XREFs of NdisCmDeregisterSapComplete @ 0x1C0083750
 * Callers:
 ...
 *     ?ndisDereferenceSap@@YAXPEAU_NDIS_CO_SAP_BLOCK@@@Z @ 0x1C008245C (-ndisDereferenceSap@@YAXPEAU_NDIS_CO_SAP_BLOCK@@@Z.c)
 */
