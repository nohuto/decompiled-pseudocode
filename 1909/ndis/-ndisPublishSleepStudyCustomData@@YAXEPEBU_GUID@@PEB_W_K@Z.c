/*
 * XREFs of ?ndisPublishSleepStudyCustomData@@YAXEPEBU_GUID@@PEB_W_K@Z @ 0x1C011C748
 * Callers:
...
void __fastcall ndisPublishSleepStudyCustomData(char a1, const struct _GUID *a2, const wchar_t *a3, ULONGLONG a4)
{
  __int64 v7; // rcx
  __int64 v8; // rax
  ...
  const wchar_t *v20; // [rsp+90h] [rbp-39h]
