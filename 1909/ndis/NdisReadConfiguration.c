/*
 * XREFs of NdisReadConfiguration @ 0x1C002BBB0
 * Callers:
 *     ndisReadRssKeywords @ 0x1C002A93C (ndisReadRssKeywords.c)
 *     ndisReadPMAdminConfigState @ 0x1C002AD10 (ndisReadPMAdminConfigState.c)
 ...
 *     ?ndisReadSoftwareTimestampSettings@@YAXPEAU_NDIS_CONFIGURATION_HANDLE@@PEAU_NDIS_MINIPORT_BLOCK@@@Z @ 0x1C002CD74 (-ndisReadSoftwareTimestampSettings@@YAXPEAU_NDIS_CONFIGURATION_HANDLE@@PEAU_NDIS_MINIPORT_BLOCK@.c)
 ...
 *     ndisSaveParameters @ 0x1C0038590 (ndisSaveParameters.c)
 *     __security_check_cookie @ 0x1C0040760 (__security_check_cookie.c)
 *     memmove @ 0x1C0041380 (memmove.c)
 *     memset @ 0x1C00416C0 (memset.c)
 *     ?ndisReadUpperBindings@@YAHPEAU_NDIS_M_DRIVER_BLOCK@@PEAPEA_WPEAK@Z @ 0x1C007EEA4 (-ndisReadUpperBindings@@YAHPEAU_NDIS_M_DRIVER_BLOCK@@PEAPEA_WPEAK@Z.c)
...
LABEL_9:
    ...
    if ( v11 >= 9 )
    {
      ...
      if ( RtlEqualUnicodeString(Keyword, &stru_1C00CA0D0, 1u) )
      {
        if ( ParameterType )
          goto LABEL_24;
        dword_1C00E81B0 = ndisReadNDKGlobalFlags();
        RegistryValues = 0;
        v26 = (struct _NDIS_CONFIGURATION_PARAMETER *)&unk_1C00E81A8;
LABEL_82:
        *ParameterValue = v26;
        goto LABEL_24;
      }
