/*
 * XREFs of ?NdisPDPIProviderControl@@YAJPEAUNDIS_PD_PROVIDER_HANDLE__@@W4NDIS_PD_CONTROL_TYPE@@W4NDIS_PD_PROVIDER_CONTROL_CODE@@PEAXK3KPEAK@Z @ 0x1C0120170
 * Callers:
 *     <none>
 * Callees:
 *     _guard_dispatch_icall_nop @ 0x1C0041350 (_guard_dispatch_icall_nop.c)
 *     WPP_RECORDER_SF_qLLS @ 0x1C00C0794 (WPP_RECORDER_SF_qLLS.c)
 *     WPP_RECORDER_SF_qLLd @ 0x1C00C0928 (WPP_RECORDER_SF_qLLd.c)
 */
