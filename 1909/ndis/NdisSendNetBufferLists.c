/*
 * XREFs of NdisSendNetBufferLists @ 0x1C000BFC0
 * Callers:
 *     <none>
 * Callees:
        ...
        ULONG SendFlags)
{
  ...
  struct NDIS_PCW_CONTEXT v47; // [rsp+48h] [rbp-51h] BYREF
  ...
  struct NDIS_NBL_TRACKER_HANDLE__ *v53; // [rsp+88h] [rbp-11h]
  __int64 v54; // [rsp+90h] [rbp-9h]
  NDIS_PCW_CONTEXT v55; // [rsp+98h] [rbp-1h] BYREF
  NDIS_PORT_NUMBER v58; // [rsp+110h] [rbp+77h]
  ...
  v7 = *(_DWORD *)(v4 + 48);
  v8 = NetBufferLists;
  *(_QWORD *)&v47.DatapathEventsMask = 0LL;
  v9 = (char *)NdisBindingHandle;
  v47.CurrentCpu = -1;
  if ( v7 || *(_DWORD *)(v4 + 80) )
  {
    v47.DatapathEventsMask = v7;
    v47.DatapathCyclesMask = *(_DWORD *)(v4 + 80);
    v47.PcwBlock = *(_NDIS_PCW_DATA_BLOCK **)(v4 + 40);
    if ( !v47.PcwBlock )
      v47.PcwBlock = *(_NDIS_PCW_DATA_BLOCK **)(v4 + 40);
  }
  ...
  if ( *(_DWORD *)ndisNblTrackerMode )
  {
    ...
    v26 = v6 & 1;
    v53 = v21;
    LODWORD(v49) = ndisNblTrackerEpoch;
    v48 = 0LL;
    v51 = 0LL;
    v50 = 0LL;
    v44 = v6 & 1;
    ...
    v29 = v27 & 1;
    if ( (v27 & 1) != 0 )
      v49 = *(_QWORD *)((v27 & 0xFFFFFFFFFFFFFFF8uLL) + 24);
    else
      v49 = v27;
    if ( (v27 & 1) != 0 )
      v27 |= 2LL * (v23 & 1);
...
LABEL_74:
        ...
        if ( (Region & 1) != 0 )
        {
          ndisNblTrackerUpdateOwnershipCount(Region, v51 - v24, &v44, &v45);
          *(_QWORD *)&PortNumber = &WPP_RECORDER_INITIALIZED;
        }
        v51 = v24;
        if ( !Alignment )
      ...
      if ( v35 )
      {
        ...
        if ( WPP_RECORDER_INITIALIZED != *(_UNKNOWN **)&PortNumber )
        {
          LOBYTE(v29) = 3;
          WPP_RECORDER_SF_qD(
      ...
      else if ( WPP_RECORDER_INITIALIZED != *(_UNKNOWN **)&PortNumber )
      {
        LOBYTE(v29) = 3;
        WPP_RECORDER_SF_q(
          *((_QWORD *)WPP_GLOBAL_Control + 8),
...
LABEL_6:
  ...
  DatapathEventsMask = v47.DatapathEventsMask;
  if ( (v47.DatapathEventsMask & 0x200140) != 0 || (v47.DatapathCyclesMask & 0x40) != 0 )
  {
    if ( (v6 & 1) == 0 )
    {
    ...
    if ( (DatapathEventsMask & 0x40) != 0 )
    {
      ...
      DatapathEventsMask = v47.DatapathEventsMask;
      v47.CurrentCpu = Number;
      ++*(_QWORD *)((char *)&v47.PcwBlock->DatapathEventReferences[12]
                  + ndisPcwOffsetToPerCpuData
                  + ndisPcwPerCpuDataStride * Number);
    }
    else
    {
      Number = v47.CurrentCpu;
    }
    if ( !(_BYTE)PortNumber && (DatapathEventsMask & 0x200000) != 0 )
    {
      if ( Number == -1 )
      {
        Number = KeGetPcr()->Prcb.Number;
      ...
      ++*(wchar_t **)((char *)&v47.PcwBlock->TotalInstanceName.Buffer
                    + ndisPcwOffsetToPerCpuData
                    + ndisPcwPerCpuDataStride * Number);
    }
    if ( (DatapathEventsMask & 0x400100) != 0 )
    {
      ...
      if ( (DatapathEventsMask & 0x100) != 0 )
      {
        ...
        *(_QWORD *)((char *)&v47.PcwBlock->DatapathEventReferences[16]
                  + ndisPcwOffsetToPerCpuData
                  + ndisPcwPerCpuDataStride * Number) += v18;
      }
      if ( !(_BYTE)PortNumber && (DatapathEventsMask & 0x400000) != 0 )
      {
        if ( Number == -1 )
        {
          Number = KeGetPcr()->Prcb.Number;
        ...
        v43 = (char *)v47.PcwBlock + ndisPcwOffsetToPerCpuData + ndisPcwPerCpuDataStride * Number;
        *((_QWORD *)v43 + 26) += v18;
      }
    }
    if ( (v47.DatapathCyclesMask & 0x40) != 0 )
    {
      ndisPcwStartCycleCounter(&v47, 6u);
    }
  ...
  if ( v11 )
  {
    ...
    {
      if ( v41 == 1 )
        ndisMSendNetBufferListsToPackets((struct _NDIS_MINIPORT_BLOCK *)v4);
      else
        ndisMFakeSendNetBufferLists(v4, (char)v8);
    }
    else
    {
      ndisMSendNBLToMiniportInternal((struct _NDIS_MINIPORT_BLOCK *)v4, v8, 0);
    }
  }
  else
  {
    ...
    {
      ndisFLoopbackNetBufferLists(v12, v8, (__int64)&v52);
      v8 = (struct _NET_BUFFER_LIST *)v52;
    }
    if ( v8 )
    {
      v13 = *(_QWORD *)(v4 + 2552);
      v14 = 2;
      v15 = 0;
      NDIS_PCW_CONTEXT::NDIS_PCW_CONTEXT(&v55, (struct _NDIS_MINIPORT_BLOCK *)v4);
      if ( v13 == v4 && SLOBYTE(v55.DatapathCyclesMask) < 0 )
      {
        if ( (v6 & 1) == 0 )
          v14 = KfRaiseIrql(2u);
        ndisPcwStartCycleCounter(&v55, 7u);
        v15 = !(v6 & 1);
      }
      ...
      if ( v13 == v4 )
      {
        if ( SLOBYTE(v55.DatapathCyclesMask) < 0 )
          ndisPcwEndCycleCounter(&v55, 7u, 0x14uLL);
        if ( v15 && v14 != 2 )
          KeLowerIrql(v14);
      }
    }
  ...
  if ( (v47.DatapathCyclesMask & 0x40) != 0 )
  {
    ndisPcwEndCycleCounter(&v47, 6u, 0x13uLL);
    if ( v46 != 2 )
      KeLowerIrql(v46);
  }
}
