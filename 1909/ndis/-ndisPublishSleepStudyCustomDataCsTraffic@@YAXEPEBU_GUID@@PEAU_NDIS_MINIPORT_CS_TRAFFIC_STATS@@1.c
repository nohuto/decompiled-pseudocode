/*
 * XREFs of ?ndisPublishSleepStudyCustomDataCsTraffic@@YAXEPEBU_GUID@@PEAU_NDIS_MINIPORT_CS_TRAFFIC_STATS@@1@Z @ 0x1C011C958
 * Callers:
        ...
        struct _NDIS_MINIPORT_CS_TRAFFIC_STATS *a4)
{
  ...
  do
  {
    ndisPublishSleepStudyCustomData(a1, a2, off_1C00CC050[v4], v15[v4]);
    ++v4;
    --v14;
  }
  while ( v14 );
