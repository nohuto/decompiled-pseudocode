 ...
 *     WPP_RECORDER_SF_qddS @ 0x1C00C1010 (WPP_RECORDER_SF_qddS.c)
 *     WPP_RECORDER_SF_qddd @ 0x1C00C11A4 (WPP_RECORDER_SF_qddd_ea_1C00C11A4.c)
        ...
        unsigned int *a7)
{
  ...
  v34.m_Lock = (KPushLockBase *)qword_1C00E67E8;
