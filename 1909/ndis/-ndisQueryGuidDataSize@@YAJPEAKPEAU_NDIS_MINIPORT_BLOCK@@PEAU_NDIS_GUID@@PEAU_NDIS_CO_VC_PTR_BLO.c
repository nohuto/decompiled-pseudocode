 ...
 *     WPP_RECORDER_SF_qLDDDDDDDDDD @ 0x1C00A7F3C (WPP_RECORDER_SF_qLDDDDDDDDDD.c)
 *     WPP_RECORDER_SF_qLDDDDDDDDDDD @ 0x1C00A8160 (WPP_RECORDER_SF_qLDDDDDDDDDDD.c)
 */
        ...
        struct _NDIS_MINIPORT_BLOCK *a6)
{
  ...
  *(_QWORD *)&GuidString.Length = 0LL;
  ...
  if ( (unsigned __int8)byte_1C00E6771 >= 4u )
