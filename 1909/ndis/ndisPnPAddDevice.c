/*
 * XREFs of ndisPnPAddDevice @ 0x1C002D984
 * Callers:
 *     ?ndisWdmPnPAddDevice@@YAJPEAU_DRIVER_OBJECT@@PEAU_DEVICE_OBJECT@@@Z @ 0x1C003F640 (-ndisWdmPnPAddDevice@@YAJPEAU_DRIVER_OBJECT@@PEAU_DEVICE_OBJECT@@@Z.c)
 *     NdisWdfPnPAddDevice @ 0x1C009F050 (NdisWdfPnPAddDevice.c)
 * Callees:
 ...
 *     ??1NDIS_MINIPORT_CREATION_CONFIG@@QEAA@XZ @ 0x1C003E38C (--1NDIS_MINIPORT_CREATION_CONFIG@@QEAA@XZ.c)
