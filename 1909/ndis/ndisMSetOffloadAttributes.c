/*
 * XREFs of ndisMSetOffloadAttributes @ 0x1C00312E0
 * Callers:
 ...
 *     ?ndisValidateOffloadCapability@@YAEPEAU_NDIS_OFFLOAD@@@Z @ 0x1C00316E0 (-ndisValidateOffloadCapability@@YAEPEAU_NDIS_OFFLOAD@@@Z.c)
 ...
 *     ?ndisValidateConnectionOffload@@YAEPEAU_NDIS_TCP_CONNECTION_OFFLOAD@@@Z @ 0x1C00AAF88 (-ndisValidateConnectionOffload@@YAEPEAU_NDIS_TCP_CONNECTION_OFFLOAD@@@Z.c)
 */
