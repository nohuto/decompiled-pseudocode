/*
 * XREFs of ?ndisImmediateReadWriteSharedMemory@@YAXPEAXKPEAEKE@Z @ 0x1C00809C8
 * Callers:
 *     NdisImmediateReadSharedMemory @ 0x1C0081550 (NdisImmediateReadSharedMemory.c)
 *     NdisImmediateWriteSharedMemory @ 0x1C0081600 (NdisImmediateWriteSharedMemory.c)
 * Callees:
