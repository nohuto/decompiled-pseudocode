/*
 * XREFs of McTemplateK0qzz @ 0x1C007D948
 * Callers:
...
ULONG __fastcall McTemplateK0qzz(
        __int64 a1,
        ...
        const wchar_t *a6)
{
  ...
  v21 = v12;
  v23 = 0;
  return McGenEventWrite((PMCGEN_TRACE_CONTEXT)&NDIS_PROVIDER_ID_Context, a2, &NDIS_PROVIDER_ID, 4u, &EventData);
}
