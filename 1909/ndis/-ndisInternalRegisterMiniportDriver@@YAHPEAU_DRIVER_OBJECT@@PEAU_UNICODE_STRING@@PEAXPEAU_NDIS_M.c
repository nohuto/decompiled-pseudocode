/*
 * XREFs of ?ndisInternalRegisterMiniportDriver@@YAHPEAU_DRIVER_OBJECT@@PEAU_UNICODE_STRING@@PEAXPEAU_NDIS_MINIPORT_DRIVER_CHARACTERISTICS@@PEAPEAX@Z @ 0x1C0036F60
 * Callers:
 *     NdisMRegisterMiniportDriver @ 0x1C0036F40 (NdisMRegisterMiniportDriver.c)
