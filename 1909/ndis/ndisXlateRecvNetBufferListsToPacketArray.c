/*
 * XREFs of ndisXlateRecvNetBufferListsToPacketArray @ 0x1C007AE98
 * Callers:
 ...
 *     ?ndisNetBufferToPacket@@YAHPEAU_NET_BUFFER@@EPEAPEAU_NDIS_PACKET@@@Z @ 0x1C007A110 (-ndisNetBufferToPacket@@YAHPEAU_NET_BUFFER@@EPEAPEAU_NDIS_PACKET@@@Z.c)
