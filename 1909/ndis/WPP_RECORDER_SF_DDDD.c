/*
 * XREFs of WPP_RECORDER_SF_DDDD @ 0x1C00696C4
 * Callers:
        ...
        ...)
{
  ...
  if ( _bittest(&v12, ((_BYTE)a3 - 1) & 0x1F) && *((_BYTE *)WPP_GLOBAL_Control + 80 * v11 + 41) >= 5u )
    ndisWppFastTraceMessage(a5, a4, &a6, 4LL, &a7, 4LL, &a8, 4LL, va, 4LL, 0LL);
  LOWORD(v14) = a4;
  return WppAutoLogTrace(a1, 5LL, a3, a5, v14, &a6, 4LL, &a7, 4LL, &a8, 4LL, va);
}
