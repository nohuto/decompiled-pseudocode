/*
 * XREFs of ?CheckMissingMandatoryFilter@BindRules@Ndis@@YAXPEAUBindStack@2@@Z @ 0x1C00FE61C
 * Callers:
      ...
      if ( (*(_DWORD *)(v10 + 40) & 1) == 0 && *(_DWORD *)(v9 + 28) && *(_DWORD *)(v9 + 32) && !*(_BYTE *)(v9 + 8) )
      {
        if ( WPP_RECORDER_INITIALIZED != (_UNKNOWN *)&WPP_RECORDER_INITIALIZED )
        {
          if ( *((_WORD *)WPP_GLOBAL_Control + 36) )
            WPP_RECORDER_SF__guid_D(*((_QWORD *)WPP_GLOBAL_Control + 8), v10 + 24, v9, 31);
        }
        v3 = 1;
      }
    }
  ...
  for ( j = 0LL; j != v11; ++j )
  {
    ...
    if ( v3 )
    {
      ...
      if ( !v16 || !*(_QWORD *)v14 )
      {
        ...
        v18 = (unsigned __int8)byte_1C00E677B < 4u;
