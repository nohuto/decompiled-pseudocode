/*
 * XREFs of ndisAllocateEventLog @ 0x1C010AC14
 * Callers:
 *     ndisAddDevice @ 0x1C012E628 (ndisAddDevice.c)
 *     DriverEntry @ 0x1C0144AD0 (DriverEntry.c)
 * Callees:
 *     memset @ 0x1C00416C0 (memset.c)
 *     ?ndisEventEntryCount@@YAKW4_NDIS_EVENT_LOG_SIZE@@@Z @ 0x1C010AD80 (-ndisEventEntryCount@@YAKW4_NDIS_EVENT_LOG_SIZE@@@Z.c)
 */
