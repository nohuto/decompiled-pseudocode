/*
 * XREFs of McTemplateK0jqxjqxdd @ 0x1C00BE918
 * Callers:
...
ULONG __fastcall McTemplateK0jqxjqxdd(
        __int64 a1,
        __int64 a2,
        const GUID *a3,
        __int64 a4,
        ...
        char a11)
{
  ...
  v26 = 4LL;
  v28 = 4LL;
  return McGenEventWrite((PMCGEN_TRACE_CONTEXT)&NDIS_PROVIDER_ID_Context, &FilterChangedMediaType, a3, 9u, &EventData);
}
