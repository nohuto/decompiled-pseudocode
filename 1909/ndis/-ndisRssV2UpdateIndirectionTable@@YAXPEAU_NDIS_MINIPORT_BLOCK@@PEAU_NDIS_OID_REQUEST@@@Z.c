/*
 * XREFs of ?ndisRssV2UpdateIndirectionTable@@YAXPEAU_NDIS_MINIPORT_BLOCK@@PEAU_NDIS_OID_REQUEST@@@Z @ 0x1C00C5B64
 * Callers:
 ...
 *     WPP_RECORDER_SF_dddD @ 0x1C00C6D1C (WPP_RECORDER_SF_dddD_ea_1C00C6D1C.c)
 *     WPP_RECORDER_SF_dddDL @ 0x1C00C6E18 (WPP_RECORDER_SF_dddDL.c)
 *     WPP_RECORDER_SF_dddd @ 0x1C00C6F38 (WPP_RECORDER_SF_dddd_ea_1C00C6F38.c)
 */
