/*
 * XREFs of ?netsetupBuildObjectPath@@YAXW4_NETSETUP_OBJECT_TYPE@@AEBU_GUID@@W4NetSetupStoreType@@W4NetSetupSubkeyType@@PEA_W@Z @ 0x1C0101BE4
 * Callers:
...
int __fastcall netsetupBuildObjectPath(__int64 a1, unsigned int *a2, int a3, int a4, wchar_t *Dst)
{
  ...
  {
    v8 = (const wchar_t *)&unk_1C00CDC00;
  }
  if ( a3 )
  {
    if ( a3 == 1 )
  ...
  else
  {
    ...
    PathForObjectType = netsetupGetPathForObjectType(a1, *((unsigned __int8 *)a2 + 15), *((unsigned __int8 *)a2 + 14));
    LODWORD(v5) = swprintf_s(
                    Dst,
                    0x100uLL,
