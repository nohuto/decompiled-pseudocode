/*
 * XREFs of McTemplateK0juqjzzz @ 0x1C00BE9F0
 * Callers:
...
ULONG __fastcall McTemplateK0juqjzzz(
        __int64 a1,
        __int64 a2,
        const GUID *a3,
        __int64 a4,
        ...
        const wchar_t *a10)
{
  ...
  v37 = v19;
  v39 = 0;
  return McGenEventWrite((PMCGEN_TRACE_CONTEXT)&NDIS_PROVIDER_ID_Context, &FilterStateChangeEx, a3, 8u, &EventData);
}
