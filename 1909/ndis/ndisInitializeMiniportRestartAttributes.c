/*
 * XREFs of ndisInitializeMiniportRestartAttributes @ 0x1C003FAE8
 * Callers:
...
__int64 __fastcall ndisInitializeMiniportRestartAttributes(__int64 a1, __int64 a2)
{
  ...
  *(_QWORD *)a2 = 0LL;
  *(_DWORD *)(a2 + 12) = 88;
  *(_DWORD *)(a2 + 20) = *(_DWORD *)(*(_QWORD *)(a1 + 4040) + 1120LL);
  v5 = a2 + 112;
  *(_QWORD *)(a2 + 24) = *(_QWORD *)(a1 + 2272);
  *(_QWORD *)(a2 + 32) = *(_QWORD *)(a1 + 2280);
  ...
  *(_QWORD *)(a2 + 56) = v5;
  *(_OWORD *)v5 = *(_OWORD *)(a1 + 2692);
  *(_DWORD *)(v5 + 16) = *(_DWORD *)(a1 + 2708);
  if ( (*(_BYTE *)(a1 + 4952) & 1) != 0 )
    *(_DWORD *)(a2 + 48) = v6 | 0x20;
  *(_DWORD *)(a2 + 64) = *(_DWORD *)(*(_QWORD *)(a1 + 4040) + 528LL);
  *(_DWORD *)(a2 + 72) = *(_DWORD *)(*(_QWORD *)(a1 + 4040) + 536LL);
  *(_DWORD *)(a2 + 76) = *(_DWORD *)(a1 + 2688);
  *(_DWORD *)(a2 + 80) = *(_DWORD *)(a1 + 3008);
  *(_DWORD *)(a2 + 84) = *(_DWORD *)(a1 + 3012);
  v7 = *(_DWORD *)(a1 + 200);
  if ( v7 )
  {
