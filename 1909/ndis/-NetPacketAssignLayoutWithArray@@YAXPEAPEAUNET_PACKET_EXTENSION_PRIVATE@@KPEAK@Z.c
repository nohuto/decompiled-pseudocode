/*
 * XREFs of ?NetPacketAssignLayoutWithArray@@YAXPEAPEAUNET_PACKET_EXTENSION_PRIVATE@@KPEAK@Z @ 0x1C0128450
 * Callers:
 *     NetPacketComputeSizeAndUpdateExtensions @ 0x1C00C7960 (NetPacketComputeSizeAndUpdateExtensions.c)
 * Callees:
 *     <none>
 */
