/*
 * XREFs of ?ndisClearTransientBindFailuresAboveThisFilter@@YAXPEAU_NDIS_MINIPORT_BLOCK@@PEAUNDIS_BIND_FILTER_LINK@@@Z @ 0x1C0106940
 * Callers:
...
LABEL_30:
  ...
  for ( j = 0LL; j != v10; ++j )
  {
    ...
    if ( (v14 != 0) != ((v14 & 0xFFFBFFE3) != 0) || !v13->BindState.Miniport )
    {
      ...
      v16 = (unsigned __int8)byte_1C00E677B < 4u;
