/*
 * XREFs of ?ndisIncrementSyncIdleCountersLocked@@YAXPEAU_NDIS_SELECTIVE_SUSPEND@@W4_NDIS_SS_BUSY_REASON@@K@Z @ 0x1C00B5A50
 * Callers:
 ...
 * Callees:
 *     ndisSSInvalidateOidCache @ 0x1C00B9230 (ndisSSInvalidateOidCache.c)
 */
