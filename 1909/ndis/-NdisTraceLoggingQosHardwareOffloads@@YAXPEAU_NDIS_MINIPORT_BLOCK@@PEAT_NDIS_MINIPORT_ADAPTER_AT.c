/*
 * XREFs of ?NdisTraceLoggingQosHardwareOffloads@@YAXPEAU_NDIS_MINIPORT_BLOCK@@PEAT_NDIS_MINIPORT_ADAPTER_ATTRIBUTES@@@Z @ 0x1C0020678
 * Callers:
        ...
        union _NDIS_MINIPORT_ADAPTER_ATTRIBUTES *a2)
{
  ...
  if ( hProvider.LevelPlus1 > 5 )
  {
    if ( TlgKeywordOn(&hProvider, 0x200000000000uLL) )
    {
      ...
      v19 = &v9;
      v20 = 4LL;
      TlgWrite(&hProvider, &unk_1C00D23D7, v2, (LPCGUID)v3, 7u, &pData);
    }
  }
}
