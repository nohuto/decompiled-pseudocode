/*
 * XREFs of ndisIfEnumerateNsiObjects @ 0x1C0114A98
 * Callers:
 *     ndisHandlePnPRequest @ 0x1C012B4E8 (ndisHandlePnPRequest.c)
 * Callees:
 *     memset @ 0x1C00416C0 (memset.c)
 *     NdisIfGetNetLuidFromInterfaceIndex @ 0x1C0066830 (NdisIfGetNetLuidFromInterfaceIndex.c)
 */
    ...
    if ( NetLuidFromInterfaceIndex >= 0 )
    {
      ...
      if ( LODWORD(v32[13]) )
      {
        ...
        while ( 1 )
        {
          ...
          *((_DWORD *)&a1[2].Info + 1) = v30 * 8;
          LODWORD(a1[3].Value) = v29 * 8 + v30 * 8;
          v3 = 1232 * v28;
          if ( *((_DWORD *)&a1[3].Info + 1) < 1232 * v28 )
            break;
          LODWORD(v32[10]) = 656;
          v32[9] = &v7[v30];
          LODWORD(v32[12]) = 568;
