/*
 * XREFs of ndisGetCombinedPMConfig @ 0x1C0035178
 * Callers:
 ...
 *     ndisMIndicatePMOffloadReject @ 0x1C0073510 (ndisMIndicatePMOffloadReject.c)
 *     ndisMIndicateWoLPatternReject @ 0x1C0073600 (ndisMIndicateWoLPatternReject.c)
...
void __fastcall ndisGetCombinedPMConfig(__int64 a1, __int64 a2)
{
  ...
  *(_QWORD *)(a1 + 520) = KeGetCurrentThread();
  ...
  for ( i = *(_QWORD *)(a1 + 2040); i; i = *(_QWORD *)(i + 120) )
  {
    v7 |= *(_DWORD *)(i + 740);
    v6 |= *(_DWORD *)(i + 744);
    v8 |= *(_DWORD *)(i + 752);
