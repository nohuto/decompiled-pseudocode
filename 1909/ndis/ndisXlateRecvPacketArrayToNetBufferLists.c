/*
 * XREFs of ndisXlateRecvPacketArrayToNetBufferLists @ 0x1C007B048
 * Callers:
 ...
 *     ?ndisPacketToNetBuffer@@YAXPEAU_NDIS_PACKET@@PEAU_NET_BUFFER@@@Z @ 0x1C007A224 (-ndisPacketToNetBuffer@@YAXPEAU_NDIS_PACKET@@PEAU_NET_BUFFER@@@Z.c)
 *     ndisGenerateNetBufferListCorrelationIds @ 0x1C007AD6C (ndisGenerateNetBufferListCorrelationIds.c)
 *     XlateReceivePacketStats @ 0x1C00A31E0 (XlateReceivePacketStats.c)
