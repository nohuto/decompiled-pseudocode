/*
 * XREFs of ?ndisSetMiniportHandlers@@_Y2PAGENPNP@@AXPEAU_NDIS_MINIPORT_BLOCK@@@Z @ 0x1C012F354
 * Callers:
 ...
 *     ndisMIsPowerSynchronizedDatapathRequired @ 0x1C002FB0C (ndisMIsPowerSynchronizedDatapathRequired.c)
 */
...
void __fastcall ndisSetMiniportHandlers(struct _NDIS_MINIPORT_BLOCK *a1)
{
  ...
  if ( v2 )
  {
    ...
    {
      CancelSendPacketsHandler = (void (__fastcall *)(void *, void *))ndisFakeMiniportCancelSendPackets;
    }
