/*
 * XREFs of ?ndisPeriodicReceivesLearning@@YAXPEAU_NDIS_MINIPORT_BLOCK@@KPEAT_LARGE_INTEGER@@@Z @ 0x1C0040D4C
 * Callers:
        ...
        union _LARGE_INTEGER *a3)
{
  ...
  {
    if ( v16.DpcTimeLimit )
      v5 = v9 * (1024 - (v16.DpcTimeCount << 10) / v16.DpcTimeLimit) / a2;
  ...
  v11 = v8 + 1;
  if ( (unsigned int)(v8 + 1) >= 0xB || v5 >= 0x200 )
  {
    if ( !(_DWORD)v8 || v5 <= 0x300 )
      return;
    v11 = v8 - 1;
  }
  if ( v11 != 11 )
