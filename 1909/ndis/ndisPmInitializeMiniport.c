 ...
 *     WPP_RECORDER_SF_qZD @ 0x1C00A6568 (WPP_RECORDER_SF_qZD.c)
 ...
 *     ?ndisAoAcPmInitTempRef@@YAXPEAU_NDIS_MINIPORT_BLOCK@@@Z @ 0x1C00BB0B8 (-ndisAoAcPmInitTempRef@@YAXPEAU_NDIS_MINIPORT_BLOCK@@@Z.c)
