/*
 * XREFs of ?ndisMIndicateHwTimestampCapabilitiesChange@@YAEPEAU_NDIS_MINIPORT_BLOCK@@HPEAXKEPEAE@Z @ 0x1C0097398
 * Callers:
 ...
 *     WPP_RECORDER_SF_qDqLLLL @ 0x1C009933C (WPP_RECORDER_SF_qDqLLLL.c)
 */
