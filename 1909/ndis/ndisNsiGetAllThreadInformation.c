/*
 * XREFs of ndisNsiGetAllThreadInformation @ 0x1C00105F0
 * Callers:
 *     <none>
 * Callees:
...
LABEL_10:
    ...
    {
      v16 = KeAcquireSpinLockRaiseToDpc(&ndisCmSessionLock);
      if ( ThreadSessionId < ndisCmSessionCount )
        v6 = *((_DWORD *)ndisCmSession + 6 * ThreadSessionId);
      KeReleaseSpinLock(&ndisCmSessionLock, v16);
      if ( !v6 )
        v6 = 1;
      v11 = v6;
    }
