/*
 * XREFs of NdisAllocateReassembledNetBufferList @ 0x1C007A6A0
 * Callers:
 *     <none>
 * Callees:
 ...
 *     NetioCopyOpaqueNetBufferListInformation @ 0x1C007AC4C (NetioCopyOpaqueNetBufferListInformation.c)
