/*
 * XREFs of ?ndisInvokeNextSendHandler@@YAXPEAU_NET_BUFFER_LIST@@KKPEAU_NDIS_OBJECT_HEADER@@PEAXP6AX20KK@Z@Z @ 0x1C00407EC
 * Callers:
        ...
        void (*a6)(void))
{
  ...
  void (__fastcall *v10)(void *, _NET_BUFFER_LIST *, unsigned int, unsigned int); // r15
  void *v11; // r12
  bool v12; // zf
    ...
    if ( v12 )
    {
      while ( *v9 )
      {
        ...
        *(_BYTE *)(v14 + 16) = 0;
        ...
        v10 = *(void (__fastcall **)(void *, _NET_BUFFER_LIST *, unsigned int, unsigned int))&v13[108].Type;
...
LABEL_15:
  ...
  else
  {
    ...
    if ( KeExpandKernelStackAndCalloutEx(
           ...
           0LL) < 0 )
    {
      if ( byte_1C00E5E20 && (*(_DWORD *)&v7[201] & 2) != 0 )
