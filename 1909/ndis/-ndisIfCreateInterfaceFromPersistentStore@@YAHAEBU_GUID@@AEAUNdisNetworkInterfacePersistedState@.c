/*
 * XREFs of ?ndisIfCreateInterfaceFromPersistentStore@@YAHAEBU_GUID@@AEAUNdisNetworkInterfacePersistedState@@W4NdisIfBlockSource@@@Z @ 0x1C0039BE0
 * Callers:
 ...
 *     WPP_RECORDER_SF_i_guid_ @ 0x1C00674E4 (WPP_RECORDER_SF_i_guid_.c)
