/*
 * XREFs of ?ndisAoAcEnableRemoteWake@@YAJPEAU_NDIS_MINIPORT_BLOCK@@PEAU_NDIS_PM_NIC_ACTIVE@@E@Z @ 0x1C00BAD68
 * Callers:
 ...
 *     WPP_RECORDER_SF_DDLc @ 0x1C00BE4D4 (WPP_RECORDER_SF_DDLc.c)
 *     WPP_RECORDER_SF_DDLcD @ 0x1C00BE5D8 (WPP_RECORDER_SF_DDLcD.c)
 */
