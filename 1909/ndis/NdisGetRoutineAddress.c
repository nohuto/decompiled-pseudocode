/*
 * XREFs of NdisGetRoutineAddress @ 0x1C0039A30
 * Callers:
 *     ?ndisVerifierGetRoutineAddress@@YAPEAXPEAU_UNICODE_STRING@@@Z @ 0x1C00A9A80 (-ndisVerifierGetRoutineAddress@@YAPEAXPEAU_UNICODE_STRING@@@Z.c)
 * Callees:
 *     FindExportedRoutineByName @ 0x1C0039A9C (FindExportedRoutineByName.c)
 */
