/*
 * XREFs of ?ndisGetMiniportInfo@@YAHPEAU_NDIS_MINIPORT_BLOCK@@PEAU_NDIS_MINIPORT_ADAPTER_GENERAL_ATTRIBUTES@@PEAJPEAE2@Z @ 0x1C00964B8
 * Callers:
 ...
 *     WPP_RECORDER_SF_qDDDDDD @ 0x1C0099028 (WPP_RECORDER_SF_qDDDDDD.c)
