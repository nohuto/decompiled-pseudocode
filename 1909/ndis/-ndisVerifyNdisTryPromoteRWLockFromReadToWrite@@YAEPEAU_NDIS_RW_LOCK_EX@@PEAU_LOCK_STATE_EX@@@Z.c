/*
 * XREFs of ?ndisVerifyNdisTryPromoteRWLockFromReadToWrite@@YAEPEAU_NDIS_RW_LOCK_EX@@PEAU_LOCK_STATE_EX@@@Z @ 0x1C00C42E0
 * Callers:
 *     <none>
 * Callees:
 ...
 *     NdisTryPromoteRWLockFromReadToWrite @ 0x1C00C45E0 (NdisTryPromoteRWLockFromReadToWrite.c)
 */
