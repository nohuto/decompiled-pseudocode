/*
 * XREFs of EthFilterDprIndicateReceive @ 0x1C00A1AA0
 * Callers:
 *     <none>
 * Callees:
 ...
 *     ethFilterReceivePacketStats @ 0x1C00A326C (ethFilterReceivePacketStats.c)
 */
...
LABEL_55:
    ...
    do
    {
      ...
      if ( (v38 & 0xA0) != 0
        ...
        && ((v38 & 4) != 0
         || (v38 & 2) != 0
         && (unsigned __int8)ethFindMulticast(*(unsigned int *)(v36 + 456), *(_QWORD *)(v36 + 448), 0LL, a3)) )
      {
