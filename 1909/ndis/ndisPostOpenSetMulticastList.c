/*
 * XREFs of ndisPostOpenSetMulticastList @ 0x1C003924C
 * Callers:
 *     ndisOidPostEthMulticastList @ 0x1C0039160 (ndisOidPostEthMulticastList.c)
 *     ndisOidPostEthMulticastOid @ 0x1C0040630 (ndisOidPostEthMulticastOid.c)
 * Callees:
