/*
 * XREFs of ?ndisPnPIrpFilterResourceRequirements@@YAJPEAU_DEVICE_OBJECT@@PEAU_NDIS_MINIPORT_BLOCK@@PEAU_IRP@@PEAE3@Z @ 0x1C003E020
 * Callers:
        ...
        unsigned __int8 *a5)
{
  ...
  *(_OWORD *)&CurrentStackLocation[-1].Parameters.ReadWriteConfig.Length = *(_OWORD *)&CurrentStackLocation->Parameters.ReadWriteConfig.Length;
  ...
  v8 = IoSynchronousCallDriver(a2->NextDeviceObject, a3, a3, a4);
  if ( v8 >= 0 )
  {
    v9 = ndisMInvokeFilterResourceRequirements(v6);
    if ( !v9
      || v9 == 259
      || v9 == -2147483643
