/*
 * XREFs of ?ndisValidate60Protocol@@YAHPEAU_NDIS_PROTOCOL_DRIVER_CHARACTERISTICS@@@Z @ 0x1C00380E4
 * Callers:
 *     NdisRegisterProtocolDriver @ 0x1C0037850 (NdisRegisterProtocolDriver.c)
 * Callees:
 *     WPP_RECORDER_SF_Z @ 0x1C001973C (WPP_RECORDER_SF_Z.c)
 *     WPP_RECORDER_SF_ZL @ 0x1C00381D0 (WPP_RECORDER_SF_ZL.c)
          ...
          if ( WPP_RECORDER_INITIALIZED != (_UNKNOWN *)&WPP_RECORDER_INITIALIZED )
            WPP_RECORDER_SF_Z(
              *((_QWORD *)WPP_GLOBAL_Control + 8),
              ...
              (struct _GUID *)&WPP_8eff094606dc365e3cd879b7a6c5bbc9_Traceguids,
              &a1->Name.Length);
          if ( (byte_1C00E8084 & 0x10) != 0 )
            McTemplateK0zq((_DWORD)a1, (unsigned int)&Validate60ProtocolFailed, a3, a1->Name.Buffer, 2);
        }
      }
      else
      {
        if ( WPP_RECORDER_INITIALIZED != (_UNKNOWN *)&WPP_RECORDER_INITIALIZED )
          WPP_RECORDER_SF_Z(
            *((_QWORD *)WPP_GLOBAL_Control + 8),
            ...
            &a1->Name.Length);
        if ( (byte_1C00E8084 & 0x10) != 0 )
          McTemplateK0zq((_DWORD)a1, (unsigned int)&Validate60ProtocolFailed, a3, a1->Name.Buffer, 1);
      }
    }
    else
    {
      if ( WPP_RECORDER_INITIALIZED != (_UNKNOWN *)&WPP_RECORDER_INITIALIZED )
        WPP_RECORDER_SF_Z(
          *((_QWORD *)WPP_GLOBAL_Control + 8),
          ...
          &a1->Name.Length);
      if ( (byte_1C00E8084 & 0x10) != 0 )
        McTemplateK0zq((_DWORD)a1, (unsigned int)&Validate60ProtocolFailed, a3, a1->Name.Buffer, 0);
    }
  }
  if ( WPP_RECORDER_INITIALIZED != (_UNKNOWN *)&WPP_RECORDER_INITIALIZED )
