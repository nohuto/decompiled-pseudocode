/*
 * XREFs of ?ndisVerifierAllocateMemory@@YAHPEAPEAXIIT_LARGE_INTEGER@@@Z @ 0x1C00A9640
 * Callers:
 *     <none>
 * Callees:
 *     _guard_dispatch_icall_nop @ 0x1C0041350 (_guard_dispatch_icall_nop.c)
 *     NdisAllocateMemory @ 0x1C0080C10 (NdisAllocateMemory.c)
 *     ?ndisVerifierInjectResourceFailure@@YAEE@Z @ 0x1C00A9AF8 (-ndisVerifierInjectResourceFailure@@YAEE@Z.c)
 */
