/*
 * XREFs of ?ndisNblVerifyRxIndication@@YAXPEBU_NET_BUFFER_LIST@@KKKPEBU_NDIS_OBJECT_HEADER@@W4_NDIS_MEDIUM@@@Z @ 0x1C00A9EF8
 * Callers:
 ...
 * Callees:
 *     ndisParseReceivedNBL @ 0x1C009C240 (ndisParseReceivedNBL.c)
