 ...
 *     ndisMFakeDirectOidRequest @ 0x1C009A690 (ndisMFakeDirectOidRequest.c)
 * Callees:
 ...
 * 00000001C0008597: jnz     loc_1C0046450
 ...
 * 00000001C0046450: cmp     [rax+29h], bl
 * 00000001C0046453: jb      loc_1C000859D
 * 00000001C0046459: mov     rcx, [rsp+68h+arg_20]; struct _GUID *
 * 00000001C0046461: lea     rax, [rsp+68h+arg_38]
 * 00000001C0046469: mov     [rsp+68h+var_28], 0
 * 00000001C0046472: lea     r8, [rsp+68h+arg_28]
 * 00000001C004647A: mov     [rsp+68h+var_30], 4
 * 00000001C0046483: mov     r9d, 8
 * 00000001C0046489: mov     [rsp+68h+var_38], rax
 * 00000001C004648E: lea     rax, [rsp+68h+arg_30]
 * 00000001C0046496: mov     [rsp+68h+var_40], 4
 * 00000001C004649F: movzx   edx, di; unsigned __int16
 * 00000001C00464A2: mov     [rsp+68h+var_48], rax
 * 00000001C00464A7: call    ?ndisWppFastTraceMessage@@YAXPEBU_GUID@@GZZ; ndisWppFastTraceMessage(_GUID const *,ushort,...)
 * 00000001C00464AC: nop
 * 00000001C00464AD: jmp     loc_1C000859D
 */
