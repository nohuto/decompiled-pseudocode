/*
 * XREFs of ?ndisInternalSetRSSv2IndirectionTable@@YAHPEAU_NDIS_MINIPORT_BLOCK@@PEAU_NDIS_OID_REQUEST@@GPEAU_PROCESSOR_NUMBER@@U3@G22@Z @ 0x1C00C4E20
 * Callers:
 ...
 *     ?ndisEntrySetScanForward@@YAEPEAGPEAU_NDIS_RSS_ENTRY_SET@@@Z @ 0x1C00C49DC (-ndisEntrySetScanForward@@YAEPEAGPEAU_NDIS_RSS_ENTRY_SET@@@Z.c)
 ...
 *     ?ndisMergeRSSv2DirectOidResults@@YAXPEAU_NDIS_RSS_SET_INDIRECTION_ENTRIES@@KPEAU_PROCESSOR_NUMBER@@U2@K11PEAH@Z @ 0x1C00C5374 (-ndisMergeRSSv2DirectOidResults@@YAXPEAU_NDIS_RSS_SET_INDIRECTION_ENTRIES@@KPEAU_PROCESSOR_NUMBE.c)
 */
        ...
        struct _PROCESSOR_NUMBER *a8)
{
  ...
  *(_QWORD *)&RssV2Context->Command.Param.RssEntryTableOffset = 20LL;
  Reserved = 0;
  RssV2Context->Command.Param.Header.Type = -55;
  ...
  if ( !ndisAreProcessorsEqual(a5, *a8) )
  {
    ...
    *(_DWORD *)v55 = v19;
    ...
    RssV2Context->Command.Entry[0].EntryStatus = 259;
      ...
      while ( ndisEntrySetScanForward(v55, (struct _NDIS_RSS_ENTRY_SET *)v63) )
      {
        ...
        if ( ndisAreProcessorsEqual(v26, v11[v28]) )
        {
          ...
          if ( !ndisAreProcessorsEqual(v31[v28 % v30], v26) )
          {
            ...
            RssV2Context->Command.Entry[v39].EntryStatus = 259;
            ...
            if ( v40 > 1 )
            {
              ...
              do
              {
                ...
                if ( !ndisAreProcessorsEqual(v33[v43], v26) )
                {
                  ...
                  RssV2Context->Command.Entry[v50].EntryStatus = 259;
