/*
 * XREFs of ?ndisDriverSystemDispatch@@YAJPEAU_DEVICE_OBJECT@@PEAU_IRP@@@Z @ 0x1C0031E28
 * Callers:
...
LABEL_29:
      ...
      {
        qword_1C00E8090 = *(_QWORD *)&Parameters->CompletionMode;
        byte_1C00E808C = BYTE2(qword_1C00E8090);
        ndisLogger = HIDWORD(qword_1C00E8090);
        if ( (qword_1C00E8090 & 0x800000000LL) != 0 )
          LOBYTE(dword_1C00E8098) = 1;
        if ( (qword_1C00E8090 & 0x100000000LL) != 0 )
          BYTE1(dword_1C00E8098) = 1;
        if ( (qword_1C00E8090 & 0x200000000LL) != 0 )
          BYTE2(dword_1C00E8098) = 1;
        if ( (qword_1C00E8090 & 0x400000000LL) != 0 )
          HIBYTE(dword_1C00E8098) = 1;
        if ( (qword_1C00E8090 & 0x1000000000LL) != 0 )
          LOBYTE(word_1C00E809C) = 1;
        if ( (qword_1C00E8090 & 0x2000000000LL) != 0 )
          HIBYTE(word_1C00E809C) = 1;
      }
      break;
    case 5u:
      byte_1C00E808C = 0;
