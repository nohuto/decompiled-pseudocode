/*
 * XREFs of ndisOidPostOffloadEncapsulation @ 0x1C003A060
 * Callers:
 ...
 *     ?ndisOidPostMiniportSetEncapsulation@@YAXPEAU_NDIS_REQ_TRACKER@@@Z @ 0x1C003A2C0 (-ndisOidPostMiniportSetEncapsulation@@YAXPEAU_NDIS_REQ_TRACKER@@@Z.c)
 */
