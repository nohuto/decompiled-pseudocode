/*
 * XREFs of ?reserve@?$KArray@ULwfBindProperties@@$00@Rtl@@QEAA_N_K@Z @ 0x1C0126D68
 * Callers:
 *     ?grow@?$KArray@ULwfBindProperties@@$00@Rtl@@AEAA_N_K@Z @ 0x1C012578C (-grow@-$KArray@ULwfBindProperties@@$00@Rtl@@AEAA_N_K@Z.c)
 * Callees:
 *     ??_GLwfBindProperties@@QEAAPEAXI@Z @ 0x1C00C755C (--_GLwfBindProperties@@QEAAPEAXI@Z.c)
 */
    ...
    if ( is_mul_ok(0x40uLL, a2) )
    {
      ...
      if ( PoolWithTag )
      {
        ...
        for ( i = 0; i < v7; v7 = a1[1] )
        {
          ...
          *(_DWORD *)&PoolWithTag[v10 + 32] = *(_DWORD *)(v10 + v9 + 32);
