/*
 * XREFs of McTemplateK0jqxzqq @ 0x1C0097EC8
 * Callers:
...
ULONG __fastcall McTemplateK0jqxzqq(
        __int64 a1,
        __int64 a2,
        const GUID *a3,
        __int64 a4,
        ...
        char a9)
{
  ...
  v26 = 4LL;
  v25 = &a9;
  return McGenEventWrite((PMCGEN_TRACE_CONTEXT)&NDIS_PROVIDER_ID_Context, &MiniportReset, a3, 7u, &EventData);
}
