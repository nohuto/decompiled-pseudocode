/*
 * XREFs of ?ndisGetMiniportIndicateList@@YAPEAU_NET_BUFFER_LIST@@PEAU_NDIS_MINIPORT_BLOCK@@@Z @ 0x1C00ACE5C
 * Callers:
 *     ndisPeriodicReceivesWorker @ 0x1C00AF090 (ndisPeriodicReceivesWorker.c)
 * Callees:
 *     ndisPeriodicReceivesGetMaxNblCount @ 0x1C00AF030 (ndisPeriodicReceivesGetMaxNblCount.c)
 */
