/*
 * XREFs of MicrosoftTelemetryAssertTriggeredWorker @ 0x1C00C9048
 * Callers:
 ...
 *     _TlgCreateSz @ 0x1C00C9590 (_TlgCreateSz.c)
 */
...
LABEL_38:
  ...
  KeReleaseSpinLock(&g_AssertSpinLock, v4);
  v23 = "<unknown>";
  if ( stru_1C00F8040.LevelPlus1 > 5 && TlgKeywordOn(&stru_1C00F8040, 0x400000000000uLL) )
  {
    v24 = "<unknown>";
    v36 = 10;
    v37 = v17;
    ...
    TlgWrite(&stru_1C00F8040, &unk_1C00D26F4, v26, v27, 0xBu, &pData);
  }
  if ( TraceLoggingProviderEnabled(&stru_1C00F8078, v21, v22) && !v20 && !KeGetCurrentIrql() )
  {
    v29 = DbgkWerCaptureLiveKernelDump(L"TELASSERT", 465LL, v17, g_ModuleName, v14, v15, v28, v28, v28);
    if ( stru_1C00F8040.LevelPlus1 > 5 && TlgKeywordOn(&stru_1C00F8040, 0x400000000000uLL) )
    {
      v44 = v17;
      v45 = v14;
      ...
      v62 = 4LL;
      v64 = 4LL;
      TlgWrite(&stru_1C00F8040, &unk_1C00D268B, v30, v31, cData, &v49);
    }
    if ( !v29 )
    {
