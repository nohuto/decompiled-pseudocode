/*
 * XREFs of ?NdisTraceLoggingQosOperationalStatus@@YAXPEAU_NDIS_MINIPORT_BLOCK@@@Z @ 0x1C00C36F8
 * Callers:
...
void __fastcall NdisTraceLoggingQosOperationalStatus(struct _NDIS_MINIPORT_BLOCK *a1)
{
  ...
  unsigned __int8 *Data4; // [rsp+60h] [rbp-39h]
  ...
  if ( hProvider.LevelPlus1 > 5 )
  {
    if ( TlgKeywordOn(&hProvider, 0x200000000000uLL) )
    {
      ...
      v22 = 8LL;
      v24 = 8LL;
      TlgWrite(&hProvider, &unk_1C00D221C, v1, v2, 0xAu, &pData);
    }
  }
}
