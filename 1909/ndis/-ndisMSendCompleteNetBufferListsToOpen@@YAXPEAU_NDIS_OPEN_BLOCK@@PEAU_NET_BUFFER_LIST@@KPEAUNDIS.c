/*
 * XREFs of ?ndisMSendCompleteNetBufferListsToOpen@@YAXPEAU_NDIS_OPEN_BLOCK@@PEAU_NET_BUFFER_LIST@@KPEAUNDIS_PCW_CONTEXT@@@Z @ 0x1C000AD70
 * Callers:
        ...
        struct NDIS_PCW_CONTEXT *a4)
{
  ...
  if ( byte_1C00E5E20 )
    ndisMarkNetBufferListCorrelationIdsAsUsed(a2, a2, a3);
  ...
  a1->ProtSendNetBufferListsComplete(a1->SendCompleteNetBufferListsContext, a2, v5);
  if ( (a4->DatapathCyclesMask & 0x200) != 0 )
