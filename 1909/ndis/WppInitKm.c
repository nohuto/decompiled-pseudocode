/*
 * XREFs of WppInitKm @ 0x1C010B194
 * Callers:
...
void __fastcall WppInitKm(__int64 a1, __int64 a2)
{
  ...
  void (__fastcall *v5)(_DRIVER_OBJECT *, _QWORD, void (__fastcall *)(__int64, __int64, __int64 *, __int64), _DEVICE_OBJECT *, _VPB **); // rax
  ...
  if ( WPP_GLOBAL_Control != (_UNKNOWN *)&WPP_MAIN_CB )
  {
    ...
    if ( WPPTraceSuite == 4 )
    {
      ...
      do
      {
        v5 = (void (__fastcall *)(_DRIVER_OBJECT *, _QWORD, void (__fastcall *)(__int64, __int64, __int64 *, __int64), _DEVICE_OBJECT *, _VPB **))pfnEtwRegisterClassicProvider;
        v4->Vpb = 0LL;
