/*
 * XREFs of __tailMerge_api_ms_win_security_sddl_l1_1_0_dll @ 0x1800E966A
 * Callers:
 *     __imp_load_ConvertStringSecurityDescriptorToSecurityDescriptorW @ 0x1800E965E (__imp_load_ConvertStringSecurityDescriptorToSecurityDescriptorW.c)
 * Callees:
