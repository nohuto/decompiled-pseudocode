/*
 * XREFs of ?CalculateInertiaValueWorker@CInteractionTrackerScaleAnimation@@MEAAJPEAVCExpressionValueStack@@_KMPEAM@Z @ 0x180207DF0
 * Callers:
 *     <none>
 * Callees:
        ...
        float *a5)
{
  ...
  _DWORD *v10; // rcx
  double (__fastcall *v11)(char *, struct CExpressionValueStack *, unsigned __int64); // r11
  double v12; // xmm0_8
