 ...
 *     ?_Extract@?$_Tree_val@U?$_Tree_simple_types@U?$pair@QEAVCSceneNode@@PEAX@std@@@std@@@std@@QEAAPEAU?$_Tree_node@U?$pair@QEAVCSceneNode@@PEAX@std@@PEAX@2@V?$_Tree_const_iterator@V?$_Tree_val@U?$_Tree_simple_types@U?$pair@QEAVCSceneNode@@PEAX@std@@@std@@@std@@@2@@Z @ 0x18017AE44 (-_Extract@-$_Tree_val@U-$_Tree_simple_types@U-$pair@QEAVCSceneNode@@PEAX@std@@@std@@@std@@QEAAPE.c)
 */
