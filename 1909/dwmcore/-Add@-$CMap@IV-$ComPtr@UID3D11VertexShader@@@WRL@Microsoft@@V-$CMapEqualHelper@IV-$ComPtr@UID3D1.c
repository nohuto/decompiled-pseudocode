/*
 * XREFs of ?Add@?$CMap@IV?$ComPtr@UID3D11VertexShader@@@WRL@Microsoft@@V?$CMapEqualHelper@IV?$ComPtr@UID3D11VertexShader@@@WRL@Microsoft@@@@@@QEAAHAEBIAEBV?$ComPtr@UID3D11VertexShader@@@WRL@Microsoft@@@Z @ 0x1800309A8
 * Callers:
