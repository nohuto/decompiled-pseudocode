/*
 * XREFs of ??$As@VISwapChainContent@@@?$ComPtr@VIImageSource@@@WRL@Microsoft@@QEBAJV?$ComPtrRef@V?$ComPtr@VISwapChainContent@@@WRL@Microsoft@@@Details@12@@Z @ 0x18001517C
 * Callers:
...
__int64 __fastcall Microsoft::WRL::ComPtr<IImageSource>::As<ISwapChainContent>(
        ...
        __int64 a2)
{
  ...
  return v4(v2, &GUID_5d3514b2_d61f_44e2_ac76_abb094163fc2, a2);
}
