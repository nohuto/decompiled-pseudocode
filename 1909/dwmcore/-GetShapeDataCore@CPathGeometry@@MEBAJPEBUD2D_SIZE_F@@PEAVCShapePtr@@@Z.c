/*
 * XREFs of ?GetShapeDataCore@CPathGeometry@@MEBAJPEBUD2D_SIZE_F@@PEAVCShapePtr@@@Z @ 0x1801EDAA0
 * Callers:
 *     <none>
 * Callees:
 ...
 *     ??0CPathSegmentsShape@@QEAA@PEBVCPathData@@@Z @ 0x18024C04C (--0CPathSegmentsShape@@QEAA@PEBVCPathData@@@Z.c)
 */
