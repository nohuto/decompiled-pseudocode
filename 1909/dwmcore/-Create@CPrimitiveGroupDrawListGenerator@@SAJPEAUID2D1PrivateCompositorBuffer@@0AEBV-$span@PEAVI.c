/*
 * XREFs of ?Create@CPrimitiveGroupDrawListGenerator@@SAJPEAUID2D1PrivateCompositorBuffer@@0AEBV?$span@PEAVIImageSource@@$0?0@gsl@@1AEBV?$span@PEAVCPrimitiveColor@@$0?0@4@PEAPEAV1@@Z @ 0x18007A5F0
 * Callers:
        ...
        _QWORD *a6)
{
  ...
  {
    v18 = -2147024882;
    MilInstrumentationCheckHR_MaybeFailFast(v11, 0LL, 0, 0x8007000E, 0x87u, 0LL);
    return v18;
  }
  ...
  {
    v18 = -2147024882;
    MilInstrumentationCheckHR_MaybeFailFast(v14, 0LL, 0, 0x8007000E, 0x88u, 0LL);
    goto LABEL_23;
  }
...
LABEL_22:
  ...
  v18 = -2147024882;
  MilInstrumentationCheckHR_MaybeFailFast(v20, 0LL, 0, 0x8007000E, 0x93u, 0LL);
LABEL_23:
