...
_QWORD *__fastcall std::list<std::pair<CResource const * const,CWeakResourceReference *>>::erase(
        __int64 a1,
        _QWORD *a2,
        __int64 *a3)
{
