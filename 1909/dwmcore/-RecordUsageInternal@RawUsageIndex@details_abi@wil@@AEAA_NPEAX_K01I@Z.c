/*
 * XREFs of ?RecordUsageInternal@RawUsageIndex@details_abi@wil@@AEAA_NPEAX_K01I@Z @ 0x1800B1C18
 * Callers:
 ...
 *     ?GetSize@UsageIndexProperty@details_abi@wil@@QEBA_KXZ @ 0x1800B211C (-GetSize@UsageIndexProperty@details_abi@wil@@QEBA_KXZ.c)
