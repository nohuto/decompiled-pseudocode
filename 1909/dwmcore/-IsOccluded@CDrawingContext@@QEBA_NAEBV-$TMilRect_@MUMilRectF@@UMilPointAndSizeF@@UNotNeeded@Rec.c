/*
 * XREFs of ?IsOccluded@CDrawingContext@@QEBA_NAEBV?$TMilRect_@MUMilRectF@@UMilPointAndSizeF@@UNotNeeded@RectUniqueness@@@@H@Z @ 0x18016E720
 * Callers:
...
char __fastcall CDrawingContext::IsOccluded(__int64 a1, __int128 *a2, unsigned int a3)
{
  ...
  if ( *(_BYTE *)(a1 + 6347) )
  {
    ...
    {
      CScopedClipStack::GetClipBoundsWorld(a1 + 1008, (__int64)&v14);
      left = v13.left;
