/*
 * XREFs of ?NotifyQuaternionPropertyChanged@CPropertyChangeResource@@IEBAJIAEBUD2DQuaternion@@@Z @ 0x1801CCCE8
 * Callers:
        ...
        const struct D2DQuaternion *a3)
{
  ...
  if ( CPropertyChangeResource::ShouldNotify(this, a2) )
  {
    ...
    LOWORD(v13) = 5;
    v3 = CoreUICallSend(v9, v14, 2LL, 13LL, v13, &unk_1802B11C3, v6, &v15);
    if ( v3 == -2018375675 )
      v3 = 0;
    if ( v3 < 0 )
