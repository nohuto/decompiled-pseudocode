/*
 * XREFs of ??4?$ComPtr@VCLinkedShader@@@WRL@Microsoft@@QEAAAEAV012@PEAVCLinkedShader@@@Z @ 0x18003010C
 * Callers:
...
CDirtyRegion **__fastcall Microsoft::WRL::ComPtr<CLinkedShader>::operator=(
        CDirtyRegion **a1,
