/*
 * XREFs of ?InsertWARP@CDrawListEntryBuilder@@AEAAJAEBUPrimitiveGeometryDesc@@PEBUPrimitiveVertexAttributesDesc@@PEBUD2D_MATRIX_3X2_F@@@Z @ 0x1801ADD18
 * Callers:
 ...
 *     ?ToD2D1ExtendMode@ExtendMode@@YA?AW4D2D1_EXTEND_MODE@@W4Enum@1@@Z @ 0x180019874 (-ToD2D1ExtendMode@ExtendMode@@YA-AW4D2D1_EXTEND_MODE@@W4Enum@1@@Z.c)
 ...
 *     ?ToD2D1InterpolationMode@InterpolationMode@@YA?AW4D2D1_INTERPOLATION_MODE@@W4Enum@1@@Z @ 0x1801AC8EC (-ToD2D1InterpolationMode@InterpolationMode@@YA-AW4D2D1_INTERPOLATION_MODE@@W4Enum@1@@Z.c)
 *     ??0WARPDrawListEntryParams@@QEAA@XZ @ 0x1801AD9C4 (--0WARPDrawListEntryParams@@QEAA@XZ.c)
            ...
            do
            {
              ...
              if ( _bittest(&v29, v10) )
              {
                *(_QWORD *)&v49.left = gsl::span<PrimitiveUVDesc,-1>::operator[]((unsigned __int64 *)v47, v27);
                if ( memcmp_0(*(const void **)&v49.left, &unk_180338F70, 0x24uLL) )
                {
                  v30 = 80 * v27;
