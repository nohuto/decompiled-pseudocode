/*
 * XREFs of ?ProcessTransformParentStack@CTransformParentPreComputeHelper@@EEAAJPEBVCVisualTree@@_K_N@Z @ 0x1800219C0
 * Callers:
 *     <none>
 * Callees:
...
LABEL_6:
      ...
      if ( v16 < v8 )
      {
        updated = CVisual::UpdateWorldTransform((CVisual *)v11, (CVisual **)v5, UnusedTreeData, v12, v63);
        if ( updated < 0 )
        {
