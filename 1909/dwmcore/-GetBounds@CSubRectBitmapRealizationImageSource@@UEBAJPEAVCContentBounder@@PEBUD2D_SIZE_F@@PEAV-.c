/*
 * XREFs of ?GetBounds@CSubRectBitmapRealizationImageSource@@UEBAJPEAVCContentBounder@@PEBUD2D_SIZE_F@@PEAV?$TMilRect_@MUMilRectF@@UMilPointAndSizeF@@UNotNeeded@RectUniqueness@@@@@Z @ 0x1802591C0
 * Callers:
 *     ?GetTransform@CSubRectBitmapRealizationImageSource@@UEAA_NPEAVCMILMatrix@@PEAV?$TMilRect_@MUMilRectF@@UMilPointAndSizeF@@UNotNeeded@RectUniqueness@@@@@Z @ 0x180259420 (-GetTransform@CSubRectBitmapRealizationImageSource@@UEAA_NPEAVCMILMatrix@@PEAV-$TMilRect_@MUMilR.c)
 * Callees:
