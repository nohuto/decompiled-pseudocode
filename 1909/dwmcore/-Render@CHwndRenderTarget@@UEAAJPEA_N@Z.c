/*
 * XREFs of ?Render@CHwndRenderTarget@@UEAAJPEA_N@Z @ 0x180059EF0
 * Callers:
 *     ?Render@CHwndRenderTargetDDA@@UEAAJPEA_N@Z @ 0x1801AA280 (-Render@CHwndRenderTargetDDA@@UEAAJPEA_N@Z.c)
 * Callees:
...
LABEL_43:
        ...
        && *((_DWORD *)g_DisplayManager + 18) == 1 )
      {
        ...
        if ( *((_QWORD *)v3 + 109) || (v44 = PubSebRegisterRpc(WNF_SEB_FULL_SCREEN_VIDEO_PLAYBACK), v42 = v44, v44 >= 0) )
        {
          v46 = (_DWORD)v3 + 880;
          if ( !*((_QWORD *)v3 + 110) )
          {
            v47 = PubSebRegisterRpc(WNF_SEB_FULL_SCREEN_HDR_VIDEO_PLAYBACK);
            v42 = v47;
            if ( v47 >= 0 )
              goto LABEL_76;
            MilInstrumentationCheckHR_MaybeFailFast(v48, &dword_1802BE894, 1u, v47, 0x227u, 0LL);
          }
        }
        else
        {
          MilInstrumentationCheckHR_MaybeFailFast(v45, &dword_1802BE894, 1u, v44, 0x221u, 0LL);
        }
        if ( v42 >= 0 )
        {
LABEL_76:
          ...
          if ( v3[863] || v3[864] )
          {
            *(_WORD *)(v3 + 863) = 0;
            if ( (Microsoft_Windows_Dwm_CoreEnableBits & 0x20) != 0 )
              McTemplateU0zqq((_DWORD)v58, v46, v41, 0, updated);
          }
        }
      }
LABEL_101:
