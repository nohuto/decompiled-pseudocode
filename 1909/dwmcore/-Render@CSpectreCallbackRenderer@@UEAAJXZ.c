/*
 * XREFs of ?Render@CSpectreCallbackRenderer@@UEAAJXZ @ 0x1801B06D0
 * Callers:
 *     <none>
 * Callees:
...
LABEL_15:
  ...
  *(_QWORD *)&v36 = v7;
  ...
  if ( v8 != v9 )
  {
    ...
    v32[2] = v12;
    v32[3] = v13;
    if ( CMILMatrix::SetToInverse((CMILMatrix *)v34, (const struct CMILMatrix *)v32) )
    {
      ...
      for ( i = v27; v16 < (__int64)(v28 - (_QWORD)v27) >> 3; i = v27 )
      {
        ...
        if ( (*(int (__fastcall **)(__int64, _BYTE *, _QWORD *))(*(_QWORD *)v18 + 280LL))(v18, v34, &i[v16]) >= 0 )
        {
          v19 = v27[v16];
