/*
 * XREFs of ?GetValue@KeyframeValue@@QEBAJPEAVCExpressionValueStack@@PEAVCExpressionValue@@@Z @ 0x1802081F4
 * Callers:
        ...
        struct CExpressionValue *a3)
{
  ...
  if ( !*(_DWORD *)v5 )
  {
    ...
    if ( v6 < 0 )
    {
      MilInstrumentationCheckHR_MaybeFailFast(v7, 0LL, 0, v6, 0x6B6u, 0LL);
      goto LABEL_30;
    }
  }
  if ( *(_DWORD *)v5 == 11 )
...
LABEL_30:
  ...
  v8 = -2147467259;
  MilInstrumentationCheckHR_MaybeFailFast(v9, 0LL, 0, 0x80004005, 0x6E6u, 0LL);
  v10 = -2147467259;
LABEL_31:
