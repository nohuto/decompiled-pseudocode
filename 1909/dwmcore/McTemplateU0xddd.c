/*
 * XREFs of McTemplateU0xddd @ 0x1801A973C
 * Callers:
...
ULONG __fastcall McTemplateU0xddd(__int64 a1, __int64 a2, __int64 a3, int a4, char a5, char a6)
{
  ...
  v15 = 4LL;
  v14 = &a6;
  return McGenEventWrite(Microsoft_Windows_Dwm_Core_Provider_Context, &EVTDESC_ETWGUID_SLICER_CAPTUREFRAME, a3, 5u, &v7);
}
