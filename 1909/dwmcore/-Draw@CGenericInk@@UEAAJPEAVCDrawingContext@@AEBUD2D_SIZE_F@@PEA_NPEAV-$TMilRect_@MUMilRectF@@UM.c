/*
 * XREFs of ?Draw@CGenericInk@@UEAAJPEAVCDrawingContext@@AEBUD2D_SIZE_F@@PEA_NPEAV?$TMilRect_@MUMilRectF@@UMilPointAndSizeF@@UNotNeeded@RectUniqueness@@@@@Z @ 0x180213960
 * Callers:
 *     <none>
 * Callees:
...
LABEL_32:
  ...
  if ( v8 )
  {
    ...
    v23 = 0;
    v28 = v29;
    CDrawingContext::GetWorldTransform(v19, (struct CMILMatrix *)v22);
