/*
 * XREFs of ?Lock@CBitmap@@UEAAJPEBUWICRect@@KPEAPEAUIWICBitmapLock@@@Z @ 0x180221D20
 * Callers:
 *     <none>
 * Callees:
        ...
        struct IWICBitmapLock **a4)
{
  ...
  {
    v9 = -2147024809;
    MilInstrumentationCheckHR_MaybeFailFast(v8, 0LL, 0, 0x80070057, 0x119u, 0LL);
    goto LABEL_10;
  }
  if ( !a4 )
  {
    v9 = -2147024809;
    MilInstrumentationCheckHR_MaybeFailFast(v8, 0LL, 0, 0x80070057, 0x11Au, 0LL);
    goto LABEL_10;
  }
  ...
  MilInstrumentationCheckHR_MaybeFailFast(v11, 0LL, 0, v10, v13, 0LL);
LABEL_10:
  if ( v14 )
