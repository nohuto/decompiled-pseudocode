/*
 * XREFs of ?SetInteractionInternal@CVisual@@QEAAXPEAVCInteraction@@@Z @ 0x1800AA0D4
 * Callers:
...
void __fastcall CVisual::SetInteractionInternal(CVisual *this, struct CInteraction *a2)
{
  ...
  if ( a2 )
  {
    ...
    {
      *(_QWORD *)CSparseAlignedStorage<8,8>::AllocatedStorage::ReserveSlot((__int64)this + 224, 10) = a2;
    }
  }
  else if ( v5 )
  {
