/*
 * XREFs of ?VisualGroupUpdate@CChannel@@UEAAJIPEBIII@Z @ 0x180158080
 * Callers:
 *     <none>
 * Callees:
        ...
        unsigned int a5)
{
  ...
  CChannel::CheckHandle((__int64)this, a2, 191);
  v10 = 4LL * a4;
...
LABEL_10:
    v14 = -2147024362;
    MilInstrumentationCheckHR_MaybeFailFast(v9, 0LL, 0, 0x80070216, v16, 0LL);
    goto LABEL_11;
  }
  v11 = v9 + v10;
  ...
  if ( v12 < 0 )
  {
    MilInstrumentationCheckHR_MaybeFailFast(v13, 0LL, 0, v12, 0x74Du, 0LL);
  }
  else
  {
