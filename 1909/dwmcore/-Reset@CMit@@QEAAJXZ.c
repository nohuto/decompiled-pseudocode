/*
 * XREFs of ?Reset@CMit@@QEAAJXZ @ 0x1800E0980
 * Callers:
...
__int64 __fastcall CMit::Reset(HANDLE *this)
{
  ...
  if ( !this[1] )
  {
    ...
    {
      v4 = -2147467260;
      MilInstrumentationCheckHR_MaybeFailFast((__int64)this, &dword_1802BFC98, 1u, 0x80004004, 0x92u, 0LL);
    }
    else
    {
      ...
      v4 = -2147024882;
      MilInstrumentationCheckHR_MaybeFailFast(v3, &dword_1802BFC98, 1u, 0x8007000E, 0xA4u, 0LL);
    }
