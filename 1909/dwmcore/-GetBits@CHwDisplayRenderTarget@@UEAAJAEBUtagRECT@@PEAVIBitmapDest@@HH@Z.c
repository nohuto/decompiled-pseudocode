/*
 * XREFs of ?GetBits@CHwDisplayRenderTarget@@UEAAJAEBUtagRECT@@PEAVIBitmapDest@@HH@Z @ 0x180022ED0
 * Callers:
 *     ?GetBits@CHwDisplayRenderTarget@@WJA@EAAJAEBUtagRECT@@PEAVIBitmapDest@@HH@Z @ 0x1800F04A0 (-GetBits@CHwDisplayRenderTarget@@WJA@EAAJAEBUtagRECT@@PEAVIBitmapDest@@HH@Z.c)
 * Callees:
        ...
        int a5)
{
  ...
  if ( (*((unsigned __int8 (__fastcall **)(CD3DDeviceLevel1 **))*this + 4))(this) )
  {
    ...
    {
      v6 = -2147024891;
      MilInstrumentationCheckHR_MaybeFailFast(v11, 0LL, 0, -2147024891, 0x101u, 0LL);
      goto LABEL_5;
    }
