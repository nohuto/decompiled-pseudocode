/*
 * XREFs of ?CalcRectFullyVisible@CDrawingContext@@QEAAJPEBUMilRectF@@HPEA_N@Z @ 0x18016B09C
 * Callers:
        ...
        bool *a4)
{
  ...
  if ( *((_BYTE *)this + 6347) && CMILMatrix::Is2DAxisAlignedPreserving<1>((__int64)this + 280) )
  {
    ...
    CMILMatrix::Transform2DBoundsHelper<0>(TopByReference, (__int64)&v20, (float *)v21);
    ...
    if ( v15 < 0 )
    {
      MilInstrumentationCheckHR_MaybeFailFast(v16, 0LL, 0, v15, 0xF3Fu, 0LL);
      return v9;
    }
    v4 = v18 == 0;
  }
