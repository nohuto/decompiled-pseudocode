/*
 * XREFs of ?Partition_Synchronize@CGlobalComposition@@UEAAJPEAVCChannelContext@@PEAVCResourceTable@@PEBUtagMILCMD_PARTITION_SYNCHRONIZE@@@Z @ 0x1801A2180
 * Callers:
 *     <none>
 * Callees:
        ...
        const struct tagMILCMD_PARTITION_SYNCHRONIZE *a4)
{
  ...
  {
    if ( *((_BYTE *)a4 + 16) )
      (*(void (__fastcall **)(_QWORD, LPVOID, _QWORD))(**((_QWORD **)this + 69) + 112LL))(
        *((_QWORD *)this + 69),
        v10,
        0LL);
  ...
  {
    MilInstrumentationCheckHR_MaybeFailFast((__int64)v8, 0LL, 0, 0x8007000E, 0x9Au, 0LL);
