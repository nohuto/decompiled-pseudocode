/*
 * XREFs of ?StopInteraction@CInteractionContextWrapper@@UEAAJXZ @ 0x180233AD0
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall CInteractionContextWrapper::StopInteraction(CInteractionContextWrapper *this)
{
  ...
  if ( v2 )
  {
    ...
    if ( v9 >= 0 )
    {
      (*(void (__fastcall **)(CInteractionContextWrapper *, __int64, __int64, _QWORD))(*(_QWORD *)this + 88LL))(
        this,
        v4,
        v5,
        (unsigned int)v9);
  ...
  if ( dword_180337240 > 4u && TlgKeywordOn((TraceLoggingHProvider)&dword_180337240, 2uLL) )
  {
    ...
    v13 = 8;
    v16 = cData;
    TlgWrite(v6, &unk_1802DD354, 0LL, 0LL, cData, &pData);
