/*
 * XREFs of ?CreateRenderingEffect@CBrushRenderingEffectFactory@@UEAAJV?$span@PEBVCDrawListBrush@@$0?0@gsl@@PEAPEAVCRenderingEffect@@@Z @ 0x180039A10
 * Callers:
 *     <none>
 * Callees:
        ...
        _QWORD *a3)
{
  ...
  if ( v8 || (v12 = DefaultHeap::Alloc(0x108uLL), (v8 = v12) != 0LL) )
  {
    v10 = *a2;
    v11 = *((_QWORD *)a1 + 2);
