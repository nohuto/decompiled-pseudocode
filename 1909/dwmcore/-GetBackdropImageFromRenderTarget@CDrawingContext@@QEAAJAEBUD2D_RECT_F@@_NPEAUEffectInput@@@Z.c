/*
 * XREFs of ?GetBackdropImageFromRenderTarget@CDrawingContext@@QEAAJAEBUD2D_RECT_F@@_NPEAUEffectInput@@@Z @ 0x1800367E0
 * Callers:
        ...
        struct EffectInput *a4)
{
  ...
  struct IImageSource *v50[2]; // [rsp+88h] [rbp-80h] BYREF
  ...
  *((_BYTE *)a4 + 44) = 1;
  ...
  CScopedClipStack::GetClipBoundsWorld(this + 126, &v70);
  v10 = *(float *)&v70;
  v11 = *((float *)&v70 + 1);
  v12 = *((float *)&v70 + 2);
  v13 = *((float *)&v70 + 3);
  ...
  if ( v15 > v10 && v16 > v14 )
  {
    ...
    v19 = CMatrixStack::GetTopByReference((CMatrixStack *)(this + 60));
    ...
    *(_WORD *)((char *)a4 + 101) = 257;
    ...
    v68 = (int)ceilf_0(v12);
    v69 = (int)ceilf_0(v13);
    RenderTargetBitmap = CDrawingContext::FlushD2D((CDrawingContext *)this);
    ...
    if ( a3 )
    {
      ...
      *(_QWORD *)&v73 = "Backdrop effect input";
      ...
      RenderTargetBitmap = (*(__int64 (__fastcall **)(struct IRenderTarget *, __int64 *))(*(_QWORD *)v23 + 72LL))(
                             v23,
                             &v54);
      v22 = RenderTargetBitmap;
      if ( RenderTargetBitmap < 0 )
      ...
      RenderTargetBitmap = (*(__int64 (__fastcall **)(__int64, _QWORD, __int64, int *))(*(_QWORD *)v52 + 64LL))(
                             v52,
                             0LL,
                             v54,
                             &v66);
      ...
      v73 = _xmm;
      v41 = Matrix3x3::operator*(&v55, &v61, &v73);
      ...
      *((float *)&v73 + 3) = 1.0 / v51.height;
      ...
      v42 = Matrix3x3::operator*(v41, &v55, &v73);
      v50[0] = 0LL;
    ...
    else
    {
      ...
      *((float *)&v70 + 3) = 1.0 / (float)SHIDWORD(v73);
      ...
      v28 = Matrix3x3::operator*(&v55, &v61, &v70);
    ...
    *(_OWORD *)((char *)a4 + 84) = v29;
    if ( !v30 )
      (*(void (__fastcall **)(struct IRenderTarget *, struct IRenderTarget *, unsigned __int64))(*(_QWORD *)v23 + 216LL))(
        v23,
        this[48],
        (unsigned __int64)(this + 1) & -(__int64)(this != 0LL));
    RenderTargetBitmap = CRenderTargetImageSource::Create(v23, 1, 0LL, v50);
    v22 = RenderTargetBitmap;
    if ( RenderTargetBitmap >= 0 )
    {
      v5 = v50[0];
LABEL_23:
      RenderTargetBitmap = CDrawListBitmap::FromImageSource(a4, v5, (const struct CDrawingContext *)this, 0);
      v22 = RenderTargetBitmap;
      if ( RenderTargetBitmap >= 0 )
        goto LABEL_24;
      v46 = 2645;
    ...
    v46 = 2630;
LABEL_47:
    MilInstrumentationCheckHR_MaybeFailFast(v21, 0LL, 0, RenderTargetBitmap, v46, 0LL);
    goto LABEL_24;
  }
  v43 = a2->bottom - a2->top;
  v51.width = a2->right - a2->left;
  v51.height = v43;
  v44 = CDrawingContext::SetEffectInputToTransparentBlack((CDrawingContext *)this, &v51, a4, &v49);
  v22 = v44;
  if ( v44 >= 0 )
  {
    v5 = v49;
