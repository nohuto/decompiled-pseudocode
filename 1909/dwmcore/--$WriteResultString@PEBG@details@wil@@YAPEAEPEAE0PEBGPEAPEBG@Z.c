/*
 * XREFs of ??$WriteResultString@PEBG@details@wil@@YAPEAEPEAE0PEBGPEAPEBG@Z @ 0x1801535C4
 * Callers:
 ...
 *     ?ResultStringSize@details@wil@@YA_KPEBG@Z @ 0x180154D34 (-ResultStringSize@details@wil@@YA_KPEBG@Z.c)
 */
