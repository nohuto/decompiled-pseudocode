/*
 * XREFs of ?GetRandomPoint@CPathEmitterArea@EmitterShapes@@QEAA?AUfloat2@Numerics@Foundation@Windows@@AEAV?$mersenne_twister_engine@I$0CA@$0CHA@$0BIN@$0BP@$0JJAILANP@$0L@$0PPPPPPPP@$06$0JNCMFGIA@$0P@$0OPMGAAAA@$0BC@$0GMAHIJGF@@std@@@Z @ 0x18020B198
 * Callers:
 *     ?GetRandomPoint@CPathAreaSpawner@EmitterShapes@@UEBA?AUfloat2@Numerics@Foundation@Windows@@AEAV?$mersenne_twister_engine@I$0CA@$0CHA@$0BIN@$0BP@$0JJAILANP@$0L@$0PPPPPPPP@$06$0JNCMFGIA@$0P@$0OPMGAAAA@$0BC@$0GMAHIJGF@@std@@M@Z @ 0x1801EBE10 (-GetRandomPoint@CPathAreaSpawner@EmitterShapes@@UEBA-AUfloat2@Numerics@Foundation@Windows@@AEAV-.c)
 * Callees:
...
float *__fastcall EmitterShapes::CPathEmitterArea::GetRandomPoint(__int64 a1, float *a2, __int64 a3)
{
  ...
  v14 = (float)((float)(v13 * i[2]) + (float)((float)(1.0 - v11) * *i)) + (float)((float)(v11 * v10) * i[4]);
  v15 = (float)((float)(v13 * i[3]) + (float)((float)(1.0 - v11) * i[1])) + (float)((float)(v11 * v10) * i[5]);
  *a2 = v14;
  a2[1] = v15;
  return result;
}
