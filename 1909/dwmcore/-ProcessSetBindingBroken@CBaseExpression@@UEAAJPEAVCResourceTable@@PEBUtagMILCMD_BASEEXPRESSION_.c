/*
 * XREFs of ?ProcessSetBindingBroken@CBaseExpression@@UEAAJPEAVCResourceTable@@PEBUtagMILCMD_BASEEXPRESSION_SETBINDINGBROKEN@@@Z @ 0x1800A8640
 * Callers:
 *     <none>
 * Callees:
        ...
        const struct tagMILCMD_BASEEXPRESSION_SETBINDINGBROKEN *a3)
{
  ...
  if ( (v3 & 2) != 0 )
  {
    ...
    if ( v5 < 0 )
    {
      MilInstrumentationCheckHR_MaybeFailFast(v6, 0LL, 0, v5, 0x14Bu, 0LL);
      return v7;
    }
