/*
 * XREFs of ?GetCasterShadowInputBrush@CProjectedShadow@@AEBAJPEAVCDrawingContext@@PEAPEAVCDrawListBrush@@@Z @ 0x1801F0274
 * Callers:
...
LABEL_36:
    Microsoft::WRL::ComPtr<ID3D11Device5>::InternalRelease((__int64 *)&v30.right);
