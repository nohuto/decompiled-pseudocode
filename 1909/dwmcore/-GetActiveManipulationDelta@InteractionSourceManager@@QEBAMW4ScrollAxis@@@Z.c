/*
 * XREFs of ?GetActiveManipulationDelta@InteractionSourceManager@@QEBAMW4ScrollAxis@@@Z @ 0x18021D368
 * Callers:
...
__m128 __fastcall InteractionSourceManager::GetActiveManipulationDelta(InteractionSourceManager *a1)
{
  ...
  if ( v3 )
  {
    ...
    (*(void (__fastcall **)(struct CManipulation *, __int64, _DWORD *))(*(_QWORD *)v6 + 136LL))(v6, 1LL, v11);
    v7 = (__m128)v11[1];
  }
  else
  {
    ...
    (*(void (__fastcall **)(struct CManipulation *, __int64, _DWORD *))(*(_QWORD *)v8 + 136LL))(v8, 1LL, v11);
    v7 = (__m128)v11[0];
  }
