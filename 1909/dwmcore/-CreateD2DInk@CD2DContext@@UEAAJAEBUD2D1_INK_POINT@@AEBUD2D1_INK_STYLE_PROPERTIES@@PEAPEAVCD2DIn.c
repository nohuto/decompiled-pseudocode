/*
 * XREFs of ?CreateD2DInk@CD2DContext@@UEAAJAEBUD2D1_INK_POINT@@AEBUD2D1_INK_STYLE_PROPERTIES@@PEAPEAVCD2DInk@@@Z @ 0x18015E870
 * Callers:
 *     <none>
 * Callees:
        ...
        struct CD2DInk **a4)
{
  ...
  MilInstrumentationCheckHR_MaybeFailFast((__int64)this, 0LL, 0, v9, v11, 0LL);
LABEL_11:
  if ( v13 )
