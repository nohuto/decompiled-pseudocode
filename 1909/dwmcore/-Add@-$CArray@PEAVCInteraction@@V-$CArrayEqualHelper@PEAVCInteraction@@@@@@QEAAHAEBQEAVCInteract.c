/*
 * XREFs of ?Add@?$CArray@PEAVCInteraction@@V?$CArrayEqualHelper@PEAVCInteraction@@@@@@QEAAHAEBQEAVCInteraction@@@Z @ 0x1801D55AC
 * Callers:
...
__int64 __fastcall CArray<CInteraction *,CArrayEqualHelper<CInteraction *>>::Add(__int64 a1, _QWORD *a2)
{
  ...
  v2 = dword_18033D0D8;
  v4 = 1;
  v5 = dword_18033D0D8 + 1;
  if ( dword_18033D0D8 + 1 <= 0 )
    return 0;
  if ( dword_18033D0D8 == dword_18033D0DC )
  {
    if ( dword_18033D0D8 <= 0x3FFFFFFF && (unsigned __int64)dword_18033D0D8 <= 0xFFFFFFFFFFFFFFFLL )
    {
      v6 = 2;
      if ( dword_18033D0DC >= 2 )
        v6 = dword_18033D0D8 + (dword_18033D0D8 >> 1);
      v7 = (char *)(dword_18033D0D8
