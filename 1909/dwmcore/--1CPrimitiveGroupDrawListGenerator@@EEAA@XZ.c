/*
 * XREFs of ??1CPrimitiveGroupDrawListGenerator@@EEAA@XZ @ 0x18007AD3C
 * Callers:
        ...
        CPrimitiveGroupDrawListGenerator *this)
{
  ...
  *v2 = &CPrimitiveGroupDrawListGenerator::`vftable'{for `IDeviceResourceNotify'};
  ...
  {
    v11 = v8 - 8;
    `vector destructor iterator'(v8, 0x18uLL, *((_QWORD *)v8 - 1), (void (*)(void *))CDrawListBitmap::~CDrawListBitmap);
  ...
  {
    v10 = v9 - 8;
    `vector destructor iterator'(v9, 0x18uLL, *((_QWORD *)v9 - 1), (void (*)(void *))CDrawListBitmap::~CDrawListBitmap);
