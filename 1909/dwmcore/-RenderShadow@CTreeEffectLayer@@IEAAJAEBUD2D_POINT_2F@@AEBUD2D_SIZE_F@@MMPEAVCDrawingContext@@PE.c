/*
 * XREFs of ?RenderShadow@CTreeEffectLayer@@IEAAJAEBUD2D_POINT_2F@@AEBUD2D_SIZE_F@@MMPEAVCDrawingContext@@PEAVCDropShadow@@PEAVIRenderTargetBitmap@@@Z @ 0x18017C3E4
 * Callers:
 ...
 *     ?IsOverdrawHeatMapEnabled@CComposition@@QEAA_NXZ @ 0x18007AD18 (-IsOverdrawHeatMapEnabled@CComposition@@QEAA_NXZ.c)
