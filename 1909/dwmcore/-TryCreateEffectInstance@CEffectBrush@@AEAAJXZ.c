/*
 * XREFs of ?TryCreateEffectInstance@CEffectBrush@@AEAAJXZ @ 0x180047170
 * Callers:
...
__int64 __fastcall CEffectBrush::TryCreateEffectInstance(CEffectBrush *this)
{
  ...
  if ( !*((_QWORD *)this + 13) && CEffectBrush::HasValidTemplate(this) )
  {
    ...
    if ( v7 < 0 )
    {
      MilInstrumentationCheckHR_MaybeFailFast(v8, 0LL, 0, v7, 0x1B3u, 0LL);
      return v1;
    }
    v9 = *((_QWORD *)this + 12);
    if ( v9 )
  ...
  if ( *v2 )
  {
    if ( !(*(__int64 (__fastcall **)(_QWORD))(*(_QWORD *)*v2 + 64LL))(*v2) )
    {
      if ( CCompiledEffectTemplate::GetCompiledEffectNoRef(*((CCompiledEffectTemplate **)this + 11)) )
      {
        ...
        v1 = v13;
        if ( v13 < 0 )
          MilInstrumentationCheckHR_MaybeFailFast(v14, 0LL, 0, v13, 0x1C4u, 0LL);
      }
    }
  }
  return v1;
