/*
 * XREFs of ?LogAnimationEnded@CAnimationLoggingManager@@QEAAX_KPEAVCResource@@IIW4AnimationEndedReasonType@@@Z @ 0x1801BE460
 * Callers:
 ...
 *     ?ProcessSetAnimationEnded@CAnimationLoggingManager@@QEAAJPEAVCResourceTable@@PEBUtagMILCMD_ANIMATIONLOGGINGMANAGER_SETANIMATIONENDED@@@Z @ 0x1801BF56C (-ProcessSetAnimationEnded@CAnimationLoggingManager@@QEAAJPEAVCResourceTable@@PEBUtagMILCMD_ANIMA.c)
 * Callees:
        ...
        int a6)
{
  ...
  {
    LOBYTE(DebugInfoForResource) = TlgKeywordOn((TraceLoggingHProvider)&dword_180337240, 1uLL);
    if ( (_BYTE)DebugInfoForResource )
    {
      ...
      LOBYTE(DebugInfoForResource) = TlgWrite(
                                       (TraceLoggingHProvider)&dword_180337240,
                                       &unk_1802D9483,
                                       0LL,
                                       0LL,
                                       8u,
