/*
 * XREFs of ??$WalkSubtree@VCOcclusionContext@@@CVisualTreeIterator@@QEAAJPEBVCVisualTree@@PEBVCVisual@@PEAVCOcclusionContext@@W4WalkReason@@@Z @ 0x180085370
 * Callers:
...
LABEL_42:
      ...
      if ( v31 == 1 )
      {
        ...
        if ( v59 == -1 )
          goto LABEL_40;
        v45 = *(_QWORD *)(v30 + 72);
        v30 = (v45 & 2) != 0 ? *(_QWORD *)(v45 & 0xFFFFFFFFFFFFFFFCuLL) : *(_QWORD *)(v30 + 72) & 1LL;
...
LABEL_41:
    ...
    if ( v15 < 0 )
    {
      v65 = 219;
LABEL_116:
      MilInstrumentationCheckHR_MaybeFailFast((__int64)v16, 0LL, 0, v15, v65, 0LL);
      goto LABEL_46;
    }
    if ( !(_BYTE)v69 )
      goto LABEL_32;
    ...
    *(_QWORD *)&v67 = *(_QWORD *)(a1 + 16);
    ...
    {
      v8 = -2147024362;
      MilInstrumentationCheckHR_MaybeFailFast(v19, 0LL, 0, 0x80070216, 0x4Cu, 0LL);
      v12 = -2147024362;
LABEL_102:
...
LABEL_13:
        *(_OWORD *)(*(_QWORD *)(a1 + 48) + 16LL * v20) = v67;
        v21 = *(_DWORD *)(a1 + 56);
        v22 = (unsigned int)(*(_DWORD *)(a1 + 32) + 1);
        *(_DWORD *)(a1 + 32) = v22;
      ...
      v8 = -2147024362;
      MilInstrumentationCheckHR_MaybeFailFast(v52, 0LL, 0, 0x80070216, 0x55u, 0LL);
    }
    v57 = lpMem;
    if ( lpMem )
    {
...
LABEL_28:
  ...
  MilInstrumentationCheckHR_MaybeFailFast((__int64)v16, 0LL, 0, v12, 0xEAu, 0LL);
LABEL_46:
  v13 = v70;
  v11 = 64LL;
LABEL_47:
  ...
  if ( v13 )
  {
    ...
    if ( !Value )
    {
      ...
      {
        MilInstrumentationCheckHR_MaybeFailFast(v61, 0LL, 0, 0x8007000E, 0x42u, 0LL);
        goto LABEL_58;
      }
...
LABEL_58:
  ...
  *(_DWORD *)(a1 + 32) = 0;
  ...
  if ( v42 == 10 )
  {
    ...
    {
      MilInstrumentationCheckHR_MaybeFailFast(v30, 0LL, 0, 0x80070216, 0xEEu, 0LL);
    }
