/*
 * XREFs of ??1CBrushDrawListGenerator@@QEAA@XZ @ 0x18003C358
 * Callers:
 ...
 *     ??1?$unique_ptr@VCDrawListBrush@@U?$default_delete@VCDrawListBrush@@@std@@@std@@QEAA@XZ @ 0x1800BFB7C (--1-$unique_ptr@VCDrawListBrush@@U-$default_delete@VCDrawListBrush@@@std@@@std@@QEAA@XZ.c)
 */
