/*
 * XREFs of ?GetHandles@CRenderData@@AEAAJPEAVCResourceTable@@@Z @ 0x1800A1A34
 * Callers:
...
__int64 __fastcall CRenderData::GetHandles(CRenderData *this, struct CResourceTable *a2)
{
  ...
  else
  {
    ...
    v15 = DynArrayImpl<1>::AddMultipleAndSet((char *)this + 120, 8LL, v7, &v19);
    v12 = v15;
    if ( v15 < 0 )
      ...
      if ( v20 <= 0x21B )
      {
        switch ( v20 )
        {
          case 0x21Bu:
            ...
            {
              v12 = -2003303421;
              MilInstrumentationCheckHR_MaybeFailFast(v11, 0LL, 0, 0x88980403, 0x6Fu, 0LL);
              return v12;
            }
          ...
          case 0x216u:
            ...
            {
              v12 = -2003303421;
              MilInstrumentationCheckHR_MaybeFailFast(v11, 0LL, 0, 0x88980403, 0x27u, 0LL);
              return v12;
            }
            FirstItemSafe = CResource::AddHandleToArrayAndReplace<CResource>(this, (__int64)a2);
            v12 = FirstItemSafe;
          ...
          case 0x217u:
            ...
            {
              v12 = -2003303421;
              MilInstrumentationCheckHR_MaybeFailFast(v11, 0LL, 0, 0x88980403, 0x34u, 0LL);
              return v12;
            }
            FirstItemSafe = CResource::AddHandleToArrayAndReplace<CResource>(this, (__int64)a2);
            v12 = FirstItemSafe;
          ...
          case 0x218u:
            ...
            {
              v12 = -2003303421;
              MilInstrumentationCheckHR_MaybeFailFast(v11, 0LL, 0, 0x88980403, 0x42u, 0LL);
              return v12;
            }
            FirstItemSafe = CResource::AddHandleToArrayAndReplace<CResource>(this, (__int64)a2);
            v12 = FirstItemSafe;
          ...
          case 0x219u:
            ...
            {
              v12 = -2003303421;
              MilInstrumentationCheckHR_MaybeFailFast(v11, 0LL, 0, 0x88980403, 0x54u, 0LL);
              return v12;
            }
            FirstItemSafe = CResource::AddHandleToArrayAndReplace<CResource>(this, (__int64)a2);
            v12 = FirstItemSafe;
          ...
          case 0x21Au:
            ...
            {
              v12 = -2003303421;
              MilInstrumentationCheckHR_MaybeFailFast(v11, 0LL, 0, 0x88980403, 0x61u, 0LL);
              return v12;
            }
            FirstItemSafe = CResource::AddHandleToArrayAndReplace<CResource>(this, (__int64)a2);
            v12 = FirstItemSafe;
...
LABEL_85:
            v12 = -2003303421;
            MilInstrumentationCheckHR_MaybeFailFast(v11, 0LL, 0, 0x88980403, 0x21u, 0LL);
            return v12;
        }
      }
      else
      {
        switch ( v20 )
        {
          case 0x21Cu:
            ...
            {
              v12 = -2003303421;
              MilInstrumentationCheckHR_MaybeFailFast(v11, 0LL, 0, 0x88980403, 0x7Cu, 0LL);
              return v12;
            }
            break;
          case 0x21Du:
            ...
            {
              v12 = -2003303421;
              MilInstrumentationCheckHR_MaybeFailFast(v11, 0LL, 0, 0x88980403, 0x83u, 0LL);
              return v12;
            }
            FirstItemSafe = CResource::AddHandleToArrayAndReplace<CResource>(this, (__int64)a2);
            v12 = FirstItemSafe;
          ...
          case 0x21Eu:
            ...
            {
              v12 = -2003303421;
              MilInstrumentationCheckHR_MaybeFailFast(v11, 0LL, 0, 0x88980403, 0x90u, 0LL);
              return v12;
            }
            FirstItemSafe = CResource::AddHandleToArrayAndReplace<CResource>(this, (__int64)a2);
            v12 = FirstItemSafe;
          ...
          case 0x21Fu:
            ...
            {
              v12 = -2003303421;
              MilInstrumentationCheckHR_MaybeFailFast(v11, 0LL, 0, 0x88980403, 0x9Du, 0LL);
              return v12;
            }
            --v3;
            break;
          case 0x220u:
            ...
            {
              v12 = -2003303421;
              MilInstrumentationCheckHR_MaybeFailFast(v11, 0LL, 0, 0x88980403, 0xA6u, 0LL);
              return v12;
            }
            FirstItemSafe = CResource::AddHandleToArrayAndReplace<CResource>(this, (__int64)a2);
            v12 = FirstItemSafe;
...
LABEL_15:
  ...
  {
    v12 = -2003303421;
    MilInstrumentationCheckHR_MaybeFailFast(v11, 0LL, 0, 0x88980403, 0xC2u, 0LL);
  }
  return v12;
}
