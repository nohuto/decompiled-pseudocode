/*
 * XREFs of ?CollectOcclusionHelper@CWindowNode@@AEAAJPEAVCResource@@V?$TMilRect_@HUtagRECT@@UMilPointAndSizeL@@U_CMilRectL_@RectUniqueness@@@@PEAVCOcclusionContext@@PEBVCShape@@_N@Z @ 0x180217B8C
 * Callers:
        ...
        char a6)
{
  ...
  *a3 = v11;
  ...
  if ( a6 )
  {
    ...
    v9 = v18;
    if ( v18 < 0 )
      MilInstrumentationCheckHR_MaybeFailFast(v19, 0LL, 0, v18, 0x738u, 0LL);
  }
  else if ( a5 )
  {
    ...
    v9 = v20;
    if ( v20 < 0 )
      MilInstrumentationCheckHR_MaybeFailFast(v21, 0LL, 0, v20, 0x73Fu, 0LL);
  }
  return v9;
}
