/*
 * XREFs of ?GetBounds@CProjectedShadow@@UEBAJPEAVCContentBounder@@PEBUD2D_SIZE_F@@PEAV?$TMilRect_@MUMilRectF@@UMilPointAndSizeF@@UNotNeeded@RectUniqueness@@@@@Z @ 0x1801F01F0
 * Callers:
 *     <none>
 * Callees:
