/*
 * XREFs of MicrosoftTelemetryAssertTriggeredWorker @ 0x180220B58
 * Callers:
 ...
 *     GetImageTuple @ 0x180220A5C (GetImageTuple.c)
 */
...
LABEL_5:
  ...
  if ( GetTickCount() - *((_DWORD *)v10 + 2) > 0xEA60 )
  {
    *((_DWORD *)v10 + 2) = GetTickCount();
    ...
    if ( *((_DWORD *)v10 + 4) == 1 && !TraceLoggingRegisterEx((TraceLoggingHProvider)&dword_180337910, v16, v17) )
    {
      if ( TraceLoggingProviderEnabled((TraceLoggingHProvider)&dword_180337910, 0, 0LL) )
      {
        v22 = v64[0];
        v9 = 1;
      ...
      EventUnregister(qword_180337930);
      qword_180337930 = 0LL;
      dword_180337910 = 0;
    }
    if ( !TraceLoggingRegisterEx((TraceLoggingHProvider)&dword_180337948, v16, v17) )
    {
      if ( v7 )
      {
        if ( dword_180337948 > 5u && TlgKeywordOn((TraceLoggingHProvider)&dword_180337948, 0x400000000000uLL) )
        {
          v32 = 10;
          v42 = (ULONGLONG *)&v32;
          v26 = v64;
          ...
          v63 = 4LL;
          TlgWrite((TraceLoggingHProvider)&dword_180337948, &unk_1802DB9ED, 0LL, 0LL, 0xEu, &pData);
        }
      }
      else if ( dword_180337948 > 5u && TlgKeywordOn((TraceLoggingHProvider)&dword_180337948, 0x400000000000uLL) )
      {
        ...
        *(_QWORD *)&v55.Size = 4LL;
        v30 = v9;
        v57 = 4LL;
        TlgWrite((TraceLoggingHProvider)&dword_180337948, &unk_1802DB96C, 0LL, 0LL, 0xBu, &pData);
      }
      EventUnregister(qword_180337968);
      qword_180337968 = 0LL;
      dword_180337948 = 0;
    }
    if ( v9 && v8 )
