/*
 * XREFs of ?Create@CEmptyRegionDrawListBrush@@SAJPEAVCDrawingContext@@AEBUD2D_RECT_F@@$$QEAV?$unique_ptr@VCDrawListBrush@@U?$default_delete@VCDrawListBrush@@@std@@@std@@PEAPEAV1@@Z @ 0x180258608
 * Callers:
        ...
        _QWORD *a4)
{
  ...
  if ( v10 )
  {
    v14 = CEmptyRegionDrawListBrush::Initialize((CEmptyRegionDrawListBrush *)v10, a1, a2);
    v13 = v14;
    if ( v14 < 0 )
    {
      MilInstrumentationCheckHR_MaybeFailFast(v15, 0LL, 0, v14, 0x1Du, 0LL);
      CEmptyRegionDrawListBrush::`scalar deleting destructor'((void **)v10, 1);
    }
    else
    {
      *a4 = v10;
  ...
  {
    v13 = -2147024882;
    MilInstrumentationCheckHR_MaybeFailFast(v9, 0LL, 0, 0x8007000E, 0x1Bu, 0LL);
  }
  return v13;
}
