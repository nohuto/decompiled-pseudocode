/*
 * XREFs of ?IsAncestorInSameSpace@CVisualTree@@QEBA_NPEBVCVisual@@0@Z @ 0x18000BA48
 * Callers:
 ...
 * Callees:
 *     ?IsPreserve3D@CVisual@@QEBA_NPEBV1@@Z @ 0x18000BAB0 (-IsPreserve3D@CVisual@@QEBA_NPEBV1@@Z.c)
 */
