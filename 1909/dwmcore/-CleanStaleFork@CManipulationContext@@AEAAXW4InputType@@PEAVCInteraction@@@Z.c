/*
 * XREFs of ?CleanStaleFork@CManipulationContext@@AEAAXW4InputType@@PEAVCInteraction@@@Z @ 0x18023AB18
 * Callers:
  ...
  if ( a3 )
  {
    ...
    do
    {
      ...
      if ( dword_180337240 > 4u && TlgKeywordOn((TraceLoggingHProvider)&dword_180337240, 2uLL) )
      {
        ...
        v24 = 0;
        v22 = &v3[4 * v7 + 240];
        TlgWrite((TraceLoggingHProvider)&dword_180337240, &unk_1802DE9AC, 0LL, 0LL, 6u, &pData);
      }
