/*
 * XREFs of ?Create@CHolographicExclusivePresentData@@SAJPEAX00IIPEAPEAUIHolographicExclusivePresentData@@@Z @ 0x1802495C4
 * Callers:
        ...
        struct IHolographicExclusivePresentData **a6)
{
  ...
  {
    v7 = -2147024882;
    MilInstrumentationCheckHR_MaybeFailFast(v12, 0LL, 0, 0x8007000E, 0x12u, 0LL);
  }
  return v7;
}
