/*
 * XREFs of ?ProcessInnerExpression@CKeyframeAnimation@@QEAAJIPEAVCExpressionValueStack@@PEAVCExpressionValue@@@Z @ 0x1801DFFA4
 * Callers:
        ...
        struct CExpressionValue *a4)
{
  ...
  if ( a2 < *((_DWORD *)this + 98) )
  {
    ...
    if ( v7 < 0 )
    {
      MilInstrumentationCheckHR_MaybeFailFast(v8, 0LL, 0, v7, 0x68Du, 0LL);
    }
    else
    {
  ...
  {
    v5 = -2147467259;
    MilInstrumentationCheckHR_MaybeFailFast((__int64)this, 0LL, 0, 0x80004005, 0x686u, 0LL);
  }
  return v5;
}
