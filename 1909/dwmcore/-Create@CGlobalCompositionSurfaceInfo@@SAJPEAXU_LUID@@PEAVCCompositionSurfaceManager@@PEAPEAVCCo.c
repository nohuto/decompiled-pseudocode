/*
 * XREFs of ?Create@CGlobalCompositionSurfaceInfo@@SAJPEAXU_LUID@@PEAVCCompositionSurfaceManager@@PEAPEAVCCompositionSurfaceInfo@@@Z @ 0x1800C28B4
 * Callers:
        ...
        struct _LUID **a4)
{
  ...
  *a4 = 0LL;
  ...
  if ( v10 )
  {
    ...
    {
      MilInstrumentationCheckHR_MaybeFailFast(v13, 0LL, 0, 0x8007000E, 0x66u, 0LL);
      MilInstrumentationCheckHR_MaybeFailFast(v16, 0LL, 0, 0x8007000E, 0x18u, 0LL);
      v14 = -2147024882;
      MilInstrumentationCheckHR_MaybeFailFast(v17, 0LL, 0, 0x8007000E, 0x2Bu, 0LL);
