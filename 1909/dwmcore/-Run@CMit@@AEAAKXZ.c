/*
 * XREFs of ?Run@CMit@@AEAAKXZ @ 0x1800E575C
 * Callers:
 *     ?RunInputThreadStatic@CMit@@SAKPEAX@Z @ 0x1800E5750 (-RunInputThreadStatic@CMit@@SAKPEAX@Z.c)
 * Callees:
...
__int64 __fastcall CMit::Run(CMit *this)
{
  ...
  *((_QWORD *)this + 16) = v2;
  ...
  {
    v6 = -2147024882;
    MilInstrumentationCheckHR_MaybeFailFast((__int64)v3, &dword_180312098, 1u, 0x8007000E, 0x116u, 0LL);
    goto LABEL_23;
  }
...
LABEL_21:
  ...
  *((_QWORD *)this + 15) = MITGetCursorUpdateHandle();
  if ( !(unsigned int)NtMITActivateInputProcessing(CMit::s_HitTestRequest, &v11) )
  {
    ...
    v10 = 299;
LABEL_22:
    MilInstrumentationCheckHR_MaybeFailFast(v5, &dword_180312098, 1u, v7, v10, 0LL);
    goto LABEL_23;
  }
  v6 = 0;
