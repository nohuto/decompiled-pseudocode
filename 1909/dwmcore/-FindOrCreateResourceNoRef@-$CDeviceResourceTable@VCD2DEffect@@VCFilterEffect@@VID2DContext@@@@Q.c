/*
 * XREFs of ?FindOrCreateResourceNoRef@?$CDeviceResourceTable@VCD2DEffect@@VCFilterEffect@@VID2DContext@@@@QEAAJPEAVID2DContext@@PEAPEAVCD2DEffect@@@Z @ 0x1801CAF50
 * Callers:
        ...
        struct CD2DEffect **a3)
{
  ...
  int v12; // eax
  __int64 v13; // rcx
  struct CD2DEffect *v14; // r10
  unsigned int v15; // eax
  unsigned int v16; // edx
  signed int v17; // eax
  unsigned int v18; // eax
  unsigned int v19; // edx
  struct CD2DEffect *v20; // rcx
  signed int v21; // eax
  unsigned int v22; // r9d
  unsigned int v24; // [rsp+20h] [rbp-10h]
  struct CD2DEffect *v25; // [rsp+60h] [rbp+30h] BYREF
...
LABEL_32:
  ...
  v12 = CFilterEffect::CreateResource(*((CFilterEffect **)a1 + 1), a2, &v25);
  v3 = v12;
  if ( v12 < 0 )
  {
    v22 = v12;
  ...
  if ( v3 < 0 )
  {
    *a3 = 0LL;
    if ( v5 )
    {
      if ( !v20 )
        goto LABEL_39;
      CD2DResource::RemoveResourceNotifier((struct CD2DEffect *)((char *)v20 + 16), a1);
      v20 = v25;
    }
  }
  if ( v20 )
    (*(void (__fastcall **)(struct CD2DEffect *))(*(_QWORD *)v20 + 16LL))(v20);
LABEL_39:
  if ( v4 )
