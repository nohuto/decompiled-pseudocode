/*
 * XREFs of ?GetInformation@CRedirectedGDISurface@@QEAAJW4_RedirectGDISurfaceInformationClass@@PEAKPEAX@Z @ 0x180048F38
 * Callers:
...
LABEL_19:
    v15 = v7;
LABEL_37:
    MilInstrumentationCheckHR_MaybeFailFast(a1, &dword_1802BFD10, 3u, v15, v19, 0LL);
    return v7;
  }
