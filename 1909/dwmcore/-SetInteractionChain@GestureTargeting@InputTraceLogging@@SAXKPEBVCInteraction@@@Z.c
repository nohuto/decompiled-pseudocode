/*
 * XREFs of ?SetInteractionChain@GestureTargeting@InputTraceLogging@@SAXKPEBVCInteraction@@@Z @ 0x18023D2C8
 * Callers:
  ...
  if ( a2 )
  {
    do
    {
      ...
      if ( *(_DWORD *)v6 > 4u && TlgKeywordOn((TraceLoggingHProvider)v5[1], 0x800uLL) )
      {
        ...
        v52 = &v21;
        v53 = 4;
        TlgWrite(v6, &unk_1802DECA0, 0LL, 0LL, 0xDu, &v25);
      }
  ...
  else
  {
    ...
    if ( *(_DWORD *)v3 > 4u )
    {
      if ( TlgKeywordOn(v3, 0x800uLL) )
      {
        ...
        v56 = &v59;
        v57 = 4;
        TlgWrite(v4, &unk_1802DEC5B, 0LL, 0LL, 3u, &pData);
      }
    }
  }
}
