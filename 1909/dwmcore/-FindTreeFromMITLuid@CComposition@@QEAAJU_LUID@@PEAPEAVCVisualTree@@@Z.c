/*
 * XREFs of ?FindTreeFromMITLuid@CComposition@@QEAAJU_LUID@@PEAPEAVCVisualTree@@@Z @ 0x180175DB0
 * Callers:
...
__int64 __fastcall CComposition::FindTreeFromMITLuid(CComposition *this, struct _LUID a2, struct CVisualTree **a3)
{
  ...
  {
    MilInstrumentationCheckHR_MaybeFailFast(v5, &dword_1802E27D4, 1u, DesktopRenderTarget, 0xDA8u, 0LL);
    v7 = v10;
  }
  else
  {
