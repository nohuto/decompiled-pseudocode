/*
 * XREFs of ?CreateDirectInkFactory@CD2DGenericInk@@SAJPEAUID2D1DeviceContext@@PEAPEAUIDCompositionDirectInkFactoryPartner@@@Z @ 0x180168F04
 * Callers:
        ...
        struct IDCompositionDirectInkFactoryPartner **a2)
{
  ...
  {
    MilInstrumentationCheckHR_MaybeFailFast(v5, 0LL, 0, LPCreateDCompositionDirectInkFactoryPartner, 0x2Eu, 0LL);
  }
  else
  {
    v7 = v10(a1, a2);
