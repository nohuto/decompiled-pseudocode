/*
 * XREFs of ?InferAffineMatrix@CMILMatrix@@QEAAXAEBV?$TMilRect_@MUMilRectF@@UMilPointAndSizeF@@UNotNeeded@RectUniqueness@@@@PEBUMilPoint2F@@@Z @ 0x180019214
 * Callers:
...
_UNKNOWN **__fastcall CMILMatrix::InferAffineMatrix(__int64 a1, float *a2, float *a3)
{
  ...
  *(_OWORD *)(a1 + 48) = _xmm;
  ...
  v12 = 1.0 / (float)((float)((float)((float)(v6 - v4) * v5) - (float)(v10 * v6)) + v11);
  *(float *)(a1 + 4) = (float)((float)((float)((float)(v4 - v6) * v16) + (float)((float)(v6 - v4) * v17))
                             + (float)((float)(v6 - v6) * v18))
                     * v12;
  *(float *)a1 = (float)((float)((float)((float)(v4 - v6) * v9) + (float)((float)(v6 - v4) * v8))
                       + (float)((float)(v6 - v6) * v19))
               * v12;
  *(_WORD *)(a1 + 64) = 0x4000;
  ...
  *(float *)(a1 + 20) = (float)((float)((float)((float)(v5 - v5) * v16) + (float)((float)(v5 - v7) * v17))
                              + (float)(v10 * v18))
                      * v12;
  *(float *)(a1 + 52) = (float)((float)((float)(v13 * v16) + (float)(v11 * v17)) + (float)(v14 * v18)) * v12;
  *(float *)(a1 + 48) = (float)((float)((float)(v13 * v9) + (float)(v11 * v8)) + (float)(v14 * v19)) * v12;
  return result;
}
