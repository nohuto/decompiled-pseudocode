/*
 * XREFs of ?_FailFast_GetLastError@in1diag3@details@wil@@YAXPEAXIPEBD@Z @ 0x1801552E8
 * Callers:
 ...
 *     ?SetEvent@details@wil@@YAXPEAX@Z @ 0x1801B6724 (-SetEvent@details@wil@@YAXPEAX@Z.c)
 * Callees:
