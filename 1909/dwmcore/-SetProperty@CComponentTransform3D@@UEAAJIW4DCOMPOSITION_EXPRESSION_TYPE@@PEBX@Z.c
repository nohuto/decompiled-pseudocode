/*
 * XREFs of ?SetProperty@CComponentTransform3D@@UEAAJIW4DCOMPOSITION_EXPRESSION_TYPE@@PEBX@Z @ 0x1800B8810
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall CComponentTransform3D::SetProperty(__int64 a1, int a2, int a3, float *a4)
{
  ...
  else
  {
    ...
    {
      if ( ++v6 == &CDrawListEntryBatch::`vftable'{for `CMILRefCountBase'} )
        goto LABEL_8;
    }
    v5 = (int *)*v6;
LABEL_8:
    ...
    {
      v9 = -2147024809;
      MilInstrumentationCheckHR_MaybeFailFast((__int64)v6, 0LL, 0, 0x80070057, 0x54u, 0LL);
      return v9;
    }
  }
