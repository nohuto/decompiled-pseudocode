/*
 * XREFs of ?CalcHDRConvertUVTransform@CD3DDeviceLevel1@@QEBAXIIIIAEBV?$TMilRect_@HUtagRECT@@UMilPointAndSizeL@@U_CMilRectL_@RectUniqueness@@@@W4DXGI_MODE_ROTATION@@0PEAVCMILMatrix@@@Z @ 0x18015A684
 * Callers:
        ...
        CMILMatrix *a9)
{
  ...
  CMILMatrix::InferAffineMatrix((__int64)a9, flt_180338F60, v31);
  if ( v15 != 0.0 || v18 != 0.0 )
  ...
  else
  {
    ...
    CMILMatrix::SetToInverse((CMILMatrix *)v29, (const struct CMILMatrix *)v27);
    v24 = (const struct CMILMatrix *)v29;
  }
  CMILMatrix::Multiply(a9, v24);
  CMILMatrix::InferAffineMatrix((__int64)v25, v34, flt_180338F60);
  CMILMatrix::Multiply(a9, (const struct CMILMatrix *)v25);
}
