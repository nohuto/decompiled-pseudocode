/*
 * XREFs of ?CalculateInertiaValueWorker@CInteractionTrackerPositionAnimation@@MEAAJPEAVCExpressionValueStack@@_KMPEAM@Z @ 0x1802076B0
 * Callers:
 *     <none>
 * Callees:
 ...
 *     ?AdvanceInertiaToTime@CPositionMotion@@QEAAMPEAVCExpressionValueStack@@_KMMMMMM@Z @ 0x18020F1B8 (-AdvanceInertiaToTime@CPositionMotion@@QEAAMPEAVCExpressionValueStack@@_KMMMMMM@Z.c)
 */
        ...
        float *a5)
{
  ...
  if ( v5 )
    ...
    v10 = 0LL;
  MostRecentCenterPoint = CInteractionTracker::GetMostRecentCenterPoint((__int64)v10, 2, *((_DWORD *)this + 79));
  v12 = *((_DWORD *)this + 79);
  ...
  *v7 = v18;
  ...
  if ( dword_180337240 > 4u && TlgKeywordOn((TraceLoggingHProvider)&dword_180337240, 2uLL) )
  {
    ...
    v35 = v21;
    v38 = v21;
    TlgWrite((TraceLoggingHProvider)&dword_180337240, &unk_1802DB685, 0LL, 0LL, 7u, &pData);
  }
  return 0LL;
}
