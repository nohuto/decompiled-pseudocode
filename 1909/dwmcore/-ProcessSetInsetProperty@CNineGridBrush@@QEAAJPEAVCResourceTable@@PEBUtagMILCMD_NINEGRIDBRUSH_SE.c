/*
 * XREFs of ?ProcessSetInsetProperty@CNineGridBrush@@QEAAJPEAVCResourceTable@@PEBUtagMILCMD_NINEGRIDBRUSH_SETINSETPROPERTY@@@Z @ 0x1800A25B0
 * Callers:
        ...
        const struct tagMILCMD_NINEGRIDBRUSH_SETINSETPROPERTY *a3)
{
  ...
  {
    v3 = -2003303421;
    MilInstrumentationCheckHR_MaybeFailFast((__int64)v5, 0LL, 0, 0x88980403, 0x149u, 0LL);
  }
  return v3;
}
