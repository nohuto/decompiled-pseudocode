/*
 * XREFs of ?DeferredSendDebugStart@CAnimationLoggingManager@@AEAAXI_KI@Z @ 0x1801BE2B8
 * Callers:
  ...
  if ( ResourceWithoutType )
  {
    ...
    if ( DebugInfoForResource )
    {
      if ( *((_DWORD *)DebugInfoForResource + 10) )
      {
        ...
        v18 = 18;
        v19 = 0;
        v12 = *(DiagnosticCallbacksManager **)(v11 + 1264);
        if ( (*(int (__fastcall **)(struct CResource *, _QWORD, _BYTE *))(*(_QWORD *)v8 + 136LL))(v8, a4, v16) < 0 )
        {
