/*
 * XREFs of _lambda_580f0a00adc947519c271a5e102e8e8a_::operator() @ 0x18016586C
 * Callers:
...
void __fastcall lambda_580f0a00adc947519c271a5e102e8e8a_::operator()(__int64 a1)
{
  __int64 v1; // r9
  __int64 v2; // rcx
  __int64 v3; // rdx
  ...
  v2 = *(_QWORD *)(*(_QWORD *)(*(_QWORD *)a1 + 488LL) + 32LL);
  v3 = *(_QWORD *)(v2 + 216);
  v4 = *(_QWORD *)(v2 + 200);
  v5 = *(_QWORD *)(v1 + 240);
  *(_BYTE *)(v1 + 1164) = 0;
