/*
 * XREFs of ?CreateFullScreenRenderTargets2@CDesktopRenderTarget@@AEAAJXZ @ 0x18002B18C
 * Callers:
...
__int64 __fastcall CDesktopRenderTarget::CreateFullScreenRenderTargets2(CDesktopRenderTarget *this)
{
  ...
  do
  {
    ...
    DisplayNoRef = CDesktopRenderTarget::FindDisplayNoRef(this, v28);
    v10 = *((_BYTE *)this + 360);
    v11 = (__int64)DisplayNoRef;
    v12 = *((_BYTE *)this + 377);
...
LABEL_24:
        ...
        v26 = DynArrayImpl<0>::AddMultipleAndSet((char *)this + 224, 8LL, 1LL, &v28);
        v2 = v26;
        if ( v26 < 0 )
    ...
    inited = CHwndRenderTarget::InitFullScreen(v28, (__int64)this, v11, &v29, *((_DWORD *)this + 85), v10, v12);
    v2 = inited;
    if ( inited < 0 )
    {
      v27 = 425;
