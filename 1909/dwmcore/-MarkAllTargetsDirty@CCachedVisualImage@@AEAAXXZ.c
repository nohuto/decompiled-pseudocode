/*
 * XREFs of ?MarkAllTargetsDirty@CCachedVisualImage@@AEAAXXZ @ 0x1800D1218
 * Callers:
 ...
 *     ?OnChanged@CCachedVisualImage@@UEAAHW4Flags@NotificationEventArgs@@PEAUIUnknown@@@Z @ 0x1800D11F0 (-OnChanged@CCachedVisualImage@@UEAAHW4Flags@NotificationEventArgs@@PEAUIUnknown@@@Z.c)
  ...
  if ( v1 > 0 )
  {
    ...
    do
    {
      ...
      else
      {
        ...
        DynArray<CCachedVisualImage::RenderTargetBitmapInfo,1>::RemoveAt((__int64)v2, v3);
      }
      --v1;
    }
    while ( v1 > 0 );
