/*
 * XREFs of ?SetPrimaryVsyncPresentWaitTarget@CRenderTargetManager@@QEBAJI@Z @ 0x180187B98
 * Callers:
...
__int64 __fastcall CRenderTargetManager::SetPrimaryVsyncPresentWaitTarget(CRenderTargetManager *this, unsigned int a2)
{
  ...
  if ( PrimaryRenderTargetNoRef )
  {
           ...
           80LL) )
    {
      ...
      v3 = v7;
      if ( v7 < 0 )
        MilInstrumentationCheckHR_MaybeFailFast(v8, &dword_1802E2B48, 2u, v7, 0x151u, 0LL);
    }
    else
    {
      v3 = -2003292412;
      MilInstrumentationCheckHR_MaybeFailFast(v6, &dword_1802E2B48, 2u, 0x88982F04, 0x155u, 0LL);
    }
  }
  return v3;
}
