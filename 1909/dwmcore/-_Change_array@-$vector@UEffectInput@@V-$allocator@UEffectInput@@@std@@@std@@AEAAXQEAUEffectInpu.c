/*
 * XREFs of ?_Change_array@?$vector@UEffectInput@@V?$allocator@UEffectInput@@@std@@@std@@AEAAXQEAUEffectInput@@_K1@Z @ 0x18003E420
 * Callers:
 ...
 *     ??$_Emplace_reallocate@$$T@?$vector@UEffectInput@@V?$allocator@UEffectInput@@@std@@@std@@QEAAPEAUEffectInput@@QEAU2@$$QEA$$T@Z @ 0x1802046A0 (--$_Emplace_reallocate@$$T@-$vector@UEffectInput@@V-$allocator@UEffectInput@@@std@@@std@@QEAAPEA.c)
 * Callees:
...
__int64 __fastcall std::vector<EffectInput>::_Change_array(__int64 a1, __int64 a2, __int64 a3, __int64 a4)
{
  ...
  if ( *(_QWORD *)a1 )
  {
    ...
    if ( v4 != v10 )
    {
      do
      {
        Microsoft::WRL::ComPtr<ID3D11Device5>::InternalRelease(v4 + 1);
