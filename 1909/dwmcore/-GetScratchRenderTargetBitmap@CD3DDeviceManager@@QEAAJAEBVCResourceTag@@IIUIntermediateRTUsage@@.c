/*
 * XREFs of ?GetScratchRenderTargetBitmap@CD3DDeviceManager@@QEAAJAEBVCResourceTag@@IIUIntermediateRTUsage@@U?$TMILFlagsEnum@W4FlagsEnum@MilRTInitialization@@@@PEAUPixelFormatInfo@@_NU_LUID@@VDisplayId@@44PEAPEAVIRenderTargetBitmap@@@Z @ 0x1800158FC
 * Callers:
        ...
        _QWORD *a13)
{
  ...
  *a13 = 0LL;
  ...
  if ( v21 < 0 )
  {
    MilInstrumentationCheckHR_MaybeFailFast(v22, &dword_180280CA0, 1u, v21, 0x524u, 0LL);
  }
  else
  {
    ...
    if ( D3DDevice < 0 )
    {
      MilInstrumentationCheckHR_MaybeFailFast(v25, &dword_180280CA0, 1u, D3DDevice, 0x526u, 0LL);
      v20 = v32;
    }
    else
    {
      ...
      if ( RenderTargetBitmap < 0 )
        MilInstrumentationCheckHR_MaybeFailFast(v27, &dword_180280CA0, 1u, RenderTargetBitmap, 0x52Fu, 0LL);
    }
  }
  if ( v20 )
