/*
 * XREFs of ?VisualSetColorTransform@CChannel@@UEAAJII@Z @ 0x180158250
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall CChannel::VisualSetColorTransform(CChannel *this, unsigned int a2, unsigned int a3)
{
  unsigned int v6; // ebx
  ...
  CChannel::CheckOptionalHandle((__int64)this, a3, 23LL);
  v8[0] = 486;
  v8[1] = a2;
  v8[2] = a3;
