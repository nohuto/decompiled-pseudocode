/*
 * XREFs of ?WaitForNextFrameStart@CPartitionVerticalBlankScheduler@@AEAAJ_N@Z @ 0x180071034
 * Callers:
 ...
 *     ?EstimateNextVSync@CPartitionVerticalBlankScheduler@@AEAA_KXZ @ 0x1800D7CF0 (-EstimateNextVSync@CPartitionVerticalBlankScheduler@@AEAA_KXZ.c)
 *     ?TraceTime@CPartitionVerticalBlankScheduler@@AEAAXXZ @ 0x1800D906C (-TraceTime@CPartitionVerticalBlankScheduler@@AEAAXXZ.c)
...
LABEL_15:
  ...
  v13 = v20;
  if ( v20 < 0 )
    MilInstrumentationCheckHR_MaybeFailFast(v17, &dword_180280CA0, 1u, v20, 0x4C1u, 0LL);
  if ( v13 >= 0 )
  {
    if ( v13 != 142213121 )
    {
...
LABEL_40:
  MilInstrumentationCheckHR_MaybeFailFast(v17, &dword_180280CA0, 1u, v13, 0x1C2u, 0LL);
LABEL_23:
  ...
  *((_BYTE *)this + 26237) = v21;
  ...
  {
    if ( v13 != -2003304307 )
      MilInstrumentationCheckHR_MaybeFailFast(v17, &dword_180280CA0, 1u, v13, 0x1CFu, 0LL);
  }
  else
  {
    v22 = 0LL;
