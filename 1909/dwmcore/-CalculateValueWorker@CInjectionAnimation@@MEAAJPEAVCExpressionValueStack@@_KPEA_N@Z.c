/*
 * XREFs of ?CalculateValueWorker@CInjectionAnimation@@MEAAJPEAVCExpressionValueStack@@_KPEA_N@Z @ 0x1801D51C0
 * Callers:
 *     <none>
 * Callees:
        ...
        bool *a4)
{
  ...
  if ( v4 && (*(unsigned __int8 (__fastcall **)(CManipulation *, __int64))(*(_QWORD *)v4 + 48LL))(v4, 100LL) )
  {
    *a4 = 1;
    v7 = *((_DWORD *)this + 80);
    if ( v7 < *((_DWORD *)this + 81) )
    {
      ...
      do
      {
        ...
        if ( v11 < 0 )
        {
          MilInstrumentationCheckHR_MaybeFailFast(v12, 0LL, 0, v11, 0xA1u, 0LL);
          return v13;
        }
        v7 = *((_DWORD *)this + 80) + 1;
        *((_DWORD *)this + 80) = v7;
