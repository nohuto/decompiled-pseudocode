/*
 * XREFs of ?TargetFrameInput@CGlobalManipulationManager@@AEAAXPEAVCManipulationFrame@@@Z @ 0x180239550
 * Callers:
 ...
 *     ?TargetBufferedFrames@CGlobalManipulationManager@@AEAAXIPEAXK@Z @ 0x18023947C (-TargetBufferedFrames@CGlobalManipulationManager@@AEAAXIPEAXK@Z.c)
