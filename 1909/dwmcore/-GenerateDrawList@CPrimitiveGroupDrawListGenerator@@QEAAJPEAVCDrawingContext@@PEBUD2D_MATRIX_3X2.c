/*
 * XREFs of ?GenerateDrawList@CPrimitiveGroupDrawListGenerator@@QEAAJPEAVCDrawingContext@@PEBUD2D_MATRIX_3X2_F@@PEAVCDrawListCache@@@Z @ 0x180038570
 * Callers:
 ...
 *     ?FromD2D1ExtendMode@ExtendMode@@YA?AW4Enum@1@W4D2D1_EXTEND_MODE@@@Z @ 0x180038B38 (-FromD2D1ExtendMode@ExtendMode@@YA-AW4Enum@1@W4D2D1_EXTEND_MODE@@@Z.c)
...
LABEL_6:
  CDrawingContext::GetWorldTransform(a2, (struct CMILMatrix *)v98);
  v12 = 0;
  if ( !v8 )
  {
...
LABEL_43:
  ...
  {
    if ( !CCpuClip::IsAxisAlignedRectangle((CCpuClip *)&v83) || !CMILMatrix::Is2DAxisAlignedPreserving<1>((__int64)v98) )
    {
      v82 = 1;
      goto LABEL_13;
    }
...
LABEL_13:
  ...
  if ( v39 )
  {
    ...
    if ( v50 >= 0 )
    {
      ...
      Microsoft::WRL::ComPtr<ID3D11Device5>::InternalRelease((__int64 *)&v74 + 1);
      Microsoft::WRL::ComPtr<ID3D11Device5>::InternalRelease((__int64 *)&v74);
      goto LABEL_43;
    }
    v63 = 601;
LABEL_91:
