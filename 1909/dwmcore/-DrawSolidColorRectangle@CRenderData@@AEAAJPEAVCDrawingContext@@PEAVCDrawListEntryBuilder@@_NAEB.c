/*
 * XREFs of ?DrawSolidColorRectangle@CRenderData@@AEAAJPEAVCDrawingContext@@PEAVCDrawListEntryBuilder@@_NAEBUMilRectF@@AEBU_D3DCOLORVALUE@@@Z @ 0x180034A84
 * Callers:
  ...
  *(_QWORD *)&v21.r = 0LL;
  ...
  if ( v27 )
  {
    ...
    **(_QWORD **)&v26.r = *(_QWORD *)&v26.b;
    if ( v13 )
      CGeometryOnlyDrawListBrush::`vector deleting destructor'(v13, 1u);
  }
  if ( v14 < 0 )
  {
    MilInstrumentationCheckHR_MaybeFailFast((unsigned int)v13, 0LL, 0, v14, 0x38Bu, 0LL);
  }
  else
  {
    v15 = *(_OWORD *)a5;
    ...
    *(_QWORD *)&v21.r = 0LL;
    CBrushDrawListGenerator::AttachInput(&v28, 0LL, &v26);
    if ( *(_QWORD *)&v26.r )
  ...
  if ( *(_QWORD *)&v21.r )
    CGeometryOnlyDrawListBrush::`vector deleting destructor'(*(CGeometryOnlyDrawListBrush **)&v21.r, 1u);
