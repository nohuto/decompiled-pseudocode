/*
 * XREFs of ?CalcEffectiveTransform@CVisual@@QEAAXW4Enum@CpuClippingMode@@PEBVCMILMatrix@@PEA_NPEAV4@PEBVCVisualTree@@3@Z @ 0x18008B720
 * Callers:
 ...
 *     ?InitializeDeviceTransform@CVisualCapture@@MEAAXPEAVCMILMatrix@@@Z @ 0x1801FC390 (-InitializeDeviceTransform@CVisualCapture@@MEAAXPEAVCMILMatrix@@@Z.c)
  ...
  if ( (*(_BYTE *)(a1 + 272) & 4) != 0 )
  {
    ...
    if ( dword_180337240 > 4u && TlgKeywordOn((TraceLoggingHProvider)&dword_180337240, 2uLL) )
    {
      ...
      *(float *)&v119 = v85;
      ...
      v180 = 4LL;
      v182 = 4LL;
      TlgWrite((TraceLoggingHProvider)&dword_180337240, &unk_1802D9E69, 0LL, 0LL, 0x14u, &pData);
      v83 = dword_180337240;
    }
    if ( v136 && v83 > 4 )
    {
      if ( TlgKeywordOn((TraceLoggingHProvider)&dword_180337240, 2uLL) )
      {
        ...
        *(float *)&v119 = v118;
        v180 = 4LL;
        v182 = 4LL;
        TlgWrite((TraceLoggingHProvider)&dword_180337240, &unk_1802D9C74, 0LL, 0LL, 0x14u, &pData);
      }
    }
  }
}
