/*
 * XREFs of ?GenerateApproxBlurIntermediate@CProjectedShadow@@AEAAJPEAVCDrawingContext@@MAEBUD2D_SIZE_F@@AEAV?$ComPtr@VCRenderTargetImageSource@@@WRL@Microsoft@@@Z @ 0x1801EF750
 * Callers:
