/*
 * XREFs of ??$AddOrUpdateProperty@M@CPropertySet@@AEAAJPEBUtagMILCMD_PROPERTYSET_SETPROPERTYVALUE@@PEBM@Z @ 0x1800A35D8
 * Callers:
...
LABEL_11:
  ...
  else
  {
    ...
    updated = CPropertySet::UpdateProperty<float>(v10, v7, *(unsigned int *)(v9 + 16), v8);
    v5 = updated;
    if ( updated < 0 )
    {
      v12 = 324;
