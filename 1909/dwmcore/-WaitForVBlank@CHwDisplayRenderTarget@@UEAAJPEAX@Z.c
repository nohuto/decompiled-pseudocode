/*
 * XREFs of ?WaitForVBlank@CHwDisplayRenderTarget@@UEAAJPEAX@Z @ 0x1800DDF00
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall CHwDisplayRenderTarget::WaitForVBlank(CHwDisplayRenderTarget *this, void *a2)
{
  ...
  if ( v4 < 0 )
  {
    MilInstrumentationCheckHR_MaybeFailFast(v5, &dword_180280CA0, 1u, v4, 0x235u, 0LL);
  }
  else if ( *((_DWORD *)g_pComposition + 274) == 6 )
  {
    ...
    v6 = v11;
    if ( v11 < 0 )
      MilInstrumentationCheckHR_MaybeFailFast(v12, &dword_180280CA0, 1u, v11, 0x23Eu, 0LL);
  }
  else
  {
    ...
    v6 = v7;
    if ( v7 < 0 )
      MilInstrumentationCheckHR_MaybeFailFast(v8, &dword_180280CA0, 1u, v7, 0x239u, 0LL);
  }
  return v6;
}
