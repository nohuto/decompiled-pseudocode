/*
 * XREFs of ?GetTextureMemoryLayoutData@CPrimitiveGroup@@UEBAJAEBUD2D_SIZE_F@@AEAV?$vector@ULayoutData@CContent@@V?$allocator@ULayoutData@CContent@@@std@@@std@@@Z @ 0x1801C4E70
 * Callers:
 *     <none>
 * Callees:
        ...
        __int64 a3)
{
  ...
  *(_QWORD *)(a3 + 8) = *(_QWORD *)a3;
  ...
  if ( v6 < 0 )
  {
    MilInstrumentationCheckHR_MaybeFailFast(v7, 0LL, 0, v6, 0x25Cu, 0LL);
  }
  else
  {
    ...
    if ( appended < 0 )
    {
      MilInstrumentationCheckHR_MaybeFailFast(v11, 0LL, 0, appended, 0x25Fu, 0LL);
    }
    else if ( HIDWORD(v24) )
    {
      do
      {
        v18.m128_f32[0] = (float)*(int *)(v22[0] + 16LL * v5);
        v18.m128_f32[1] = (float)*(int *)(v22[0] + 16LL * v5 + 4);
        v18.m128_f32[2] = (float)*(int *)(v22[0] + 16LL * v5 + 8);
        v18.m128_f32[3] = (float)*(int *)(v22[0] + 16LL * v5 + 12);
