/*
 * XREFs of ?GetD2DBitmap@CColorKeyBitmapRealization@@UEAAJAEBURenderTargetInfo@@PEBV?$TMilRect@IUMilRectU@@UNotNeeded@RectUniqueness@@@@_NPEAPEAUID2D1Bitmap1@@@Z @ 0x1802552D0
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall CColorKeyBitmapRealization::GetD2DBitmap(__int64 a1, __int64 a2, __int64 a3, __int64 a4, _QWORD *a5)
{
  ...
  Bitmap = CD2DBitmapCache::GetBitmap(a1 - 128, *(struct _LUID *)a2, *(unsigned int *)(a2 + 8), a4, a3, v9, a5);
  v7 = Bitmap;
  if ( Bitmap < 0 )
