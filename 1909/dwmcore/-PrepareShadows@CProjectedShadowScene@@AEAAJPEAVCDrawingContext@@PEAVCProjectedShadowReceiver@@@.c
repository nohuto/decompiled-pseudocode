/*
 * XREFs of ?PrepareShadows@CProjectedShadowScene@@AEAAJPEAVCDrawingContext@@PEAVCProjectedShadowReceiver@@@Z @ 0x180006990
 * Callers:
 ...
 *     ?CalculateBlurRadius@CProjectedShadowScene@@AEBAMM@Z @ 0x18000633C (-CalculateBlurRadius@CProjectedShadowScene@@AEBAMM@Z.c)
 ...
 *     ??0CProjectedShadow@@QEAA@PEAVCComposition@@@Z @ 0x1801EE2F4 (--0CProjectedShadow@@QEAA@PEAVCComposition@@@Z.c)
