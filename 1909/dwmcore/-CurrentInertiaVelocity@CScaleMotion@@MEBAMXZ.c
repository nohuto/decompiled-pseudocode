/*
 * XREFs of ?CurrentInertiaVelocity@CScaleMotion@@MEBAMXZ @ 0x18020F370
 * Callers:
 *     ?CurrentInertiaVelocity@CPositionMotion@@MEBAMXZ @ 0x18020F400 (-CurrentInertiaVelocity@CPositionMotion@@MEBAMXZ.c)
 * Callees:
