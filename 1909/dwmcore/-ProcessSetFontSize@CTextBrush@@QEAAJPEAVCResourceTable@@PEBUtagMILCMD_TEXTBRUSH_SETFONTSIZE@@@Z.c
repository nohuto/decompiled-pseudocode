/*
 * XREFs of ?ProcessSetFontSize@CTextBrush@@QEAAJPEAVCResourceTable@@PEBUtagMILCMD_TEXTBRUSH_SETFONTSIZE@@@Z @ 0x1801FB5B4
 * Callers:
        ...
        const struct tagMILCMD_TEXTBRUSH_SETFONTSIZE *a3)
{
  ...
  v4 = ((__int64 (__fastcall *)(char *, void *, char *))xmmword_180338B20)(
         (char *)this + SDWORD2(xmmword_180338B20),
