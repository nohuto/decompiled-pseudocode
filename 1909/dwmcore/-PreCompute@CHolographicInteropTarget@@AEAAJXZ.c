/*
 * XREFs of ?PreCompute@CHolographicInteropTarget@@AEAAJXZ @ 0x180244160
 * Callers:
 *     ?PreRender@CHolographicInteropTarget@@UEAAJXZ @ 0x180244250 (-PreRender@CHolographicInteropTarget@@UEAAJXZ.c)
 * Callees:
