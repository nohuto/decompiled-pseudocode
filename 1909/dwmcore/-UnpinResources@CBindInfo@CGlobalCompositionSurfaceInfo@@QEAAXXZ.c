/*
 * XREFs of ?UnpinResources@CBindInfo@CGlobalCompositionSurfaceInfo@@QEAAXXZ @ 0x1800EFEF8
 * Callers:
 ...
 *     ?UnpinResources@CGlobalCompositionSurfaceInfo@@UEAAXXZ @ 0x1800EFFD0 (-UnpinResources@CGlobalCompositionSurfaceInfo@@UEAAXXZ.c)
 * Callees:
