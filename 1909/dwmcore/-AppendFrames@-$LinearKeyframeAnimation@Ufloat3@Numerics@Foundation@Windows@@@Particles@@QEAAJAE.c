/*
 * XREFs of ?AppendFrames@?$LinearKeyframeAnimation@Ufloat3@Numerics@Foundation@Windows@@@Particles@@QEAAJAEBV?$span@$$CBUParticleBindingData@@$0?0@gsl@@@Z @ 0x1801E805C
 * Callers:
 *     ?OnBindingChanged@CParticleColorBehavior@@MEAAJAEAV?$span@$$CBUParticleBindingData@@$0?0@gsl@@_N@Z @ 0x1801E8CF0 (-OnBindingChanged@CParticleColorBehavior@@MEAAJAEAV-$span@$$CBUParticleBindingData@@$0-0@gsl@@_N.c)
 * Callees:
