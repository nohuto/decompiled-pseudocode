/*
 * XREFs of ?TelemetrySetApplicationId@CChannelContext@@QEAAJPEBG_K@Z @ 0x18004C934
 * Callers:
 ...
 *     ?StringCchCopyNW@@YAJPEAG_KPEBG1@Z @ 0x18004D2B0 (-StringCchCopyNW@@YAJPEAG_KPEBG1@Z.c)
