/*
 * XREFs of ?GetCachedFeatureEnabledState@?$Feature@U__WilFeatureTraits_Feature_TreeDumping@@@wil@@CA?AW4wil_details_CachedFeatureEnabledState@@_N@Z @ 0x180158D14
 * Callers:
...
__int64 __fastcall wil::Feature<__WilFeatureTraits_Feature_TreeDumping>::GetCachedFeatureEnabledState(
        __int64 a1,
        __int64 a2,
        __int64 a3)
{
  ...
  v3 = `wil::Feature<__WilFeatureTraits_Feature_TreeDumping>::GetFeaturePropertyCache'::`2'::data & 3;
  if ( (`wil::Feature<__WilFeatureTraits_Feature_TreeDumping>::GetFeaturePropertyCache'::`2'::data & 3) == 0
    || (`wil::Feature<__WilFeatureTraits_Feature_TreeDumping>::GetFeaturePropertyCache'::`2'::data & 0x30) == 0 )
  {
    FeatureEnabledState = (unsigned int)wil::details::WilApi_GetFeatureEnabledState((wil::details *)0x1234CCA, a2, a3);
    v5 = FeatureEnabledState & 0x80;
    v6 = (FeatureEnabledState >> 6) & 1;
    v7 = FeatureEnabledState & 0xFFFFFF3F;
    if ( !v7 || (v8 = 2, v7 != 2) )
      v8 = 1;
    v9 = (`wil::Feature<__WilFeatureTraits_Feature_TreeDumping>::GetFeaturePropertyCache'::`2'::data >> 2) & 1;
    if ( v3 )
      v8 = v3;
    else
      v9 = v6;
    wil::details::EnabledStateManager::SubscribeFeaturePropertyCacheToEnabledStateChanges(
      ...
      (__int64)&`wil::Feature<__WilFeatureTraits_Feature_TreeDumping>::GetFeaturePropertyCache'::`2'::data,
      0);
    if ( v3 )
    {
    ...
    wil_details_ModifyFeatureData(
      (union wil_details_FeaturePropertyCache *)&`wil::Feature<__WilFeatureTraits_Feature_TreeDumping>::GetFeaturePropertyCache'::`2'::data,
      v10,
      v11);
    return v8;
  }
