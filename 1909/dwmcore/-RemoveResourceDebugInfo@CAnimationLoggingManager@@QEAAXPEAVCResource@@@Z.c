/*
 * XREFs of ?RemoveResourceDebugInfo@CAnimationLoggingManager@@QEAAXPEAVCResource@@@Z @ 0x1800BDD54
 * Callers:
 ...
 *     ?DetachFromChannel@CResource@@UEAAXPEAVCChannelContext@@_N@Z @ 0x1800C7E00 (-DetachFromChannel@CResource@@UEAAXPEAVCChannelContext@@_N@Z.c)
