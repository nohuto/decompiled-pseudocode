/*
 * XREFs of ?SendTelemetry@CDwmRenderThreadWatchdog@@AEAAXXZ @ 0x18018BF84
 * Callers:
 *     ?OnWatchdogTimeout@CDwmRenderThreadWatchdog@@EEAAXXZ @ 0x18018BF50 (-OnWatchdogTimeout@CDwmRenderThreadWatchdog@@EEAAXXZ.c)
 * Callees:
...
void __fastcall CDwmRenderThreadWatchdog::SendTelemetry(CDwmRenderThreadWatchdog *this)
{
  ...
  if ( dword_1803371D0 > 5u )
  {
    if ( TlgKeywordOn((TraceLoggingHProvider)&dword_1803371D0, 0x400000000000uLL) )
    {
      ...
      v10 = &v4;
      v11 = 4;
      TlgWrite(v1, &unk_1802D7594, 0LL, 0LL, 4u, &pData);
    }
  }
}
