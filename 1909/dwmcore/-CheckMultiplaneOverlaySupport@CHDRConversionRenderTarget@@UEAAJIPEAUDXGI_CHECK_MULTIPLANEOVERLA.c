/*
 * XREFs of ?CheckMultiplaneOverlaySupport@CHDRConversionRenderTarget@@UEAAJIPEAUDXGI_CHECK_MULTIPLANEOVERLAYSUPPORT_PLANE_INFO@@PEA_N1@Z @ 0x180167140
 * Callers:
 *     <none>
 * Callees:
 ...
 *     ?IsDesktopRect@CHDRConversionRenderTarget@@IEBA_NAEBUtagRECT@@@Z @ 0x180167B1C (-IsDesktopRect@CHDRConversionRenderTarget@@IEBA_NAEBUtagRECT@@@Z.c)
 */
