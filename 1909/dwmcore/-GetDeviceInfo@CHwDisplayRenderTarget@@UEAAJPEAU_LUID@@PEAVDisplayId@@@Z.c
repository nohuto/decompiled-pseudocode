/*
 * XREFs of ?GetDeviceInfo@CHwDisplayRenderTarget@@UEAAJPEAU_LUID@@PEAVDisplayId@@@Z @ 0x1800BBE20
 * Callers:
 *     ?GetDeviceInfo@CHwDisplayRenderTarget@@WJA@EAAJPEAU_LUID@@PEAVDisplayId@@@Z @ 0x1800F0500 (-GetDeviceInfo@CHwDisplayRenderTarget@@WJA@EAAJPEAU_LUID@@PEAVDisplayId@@@Z.c)
 * Callees:
