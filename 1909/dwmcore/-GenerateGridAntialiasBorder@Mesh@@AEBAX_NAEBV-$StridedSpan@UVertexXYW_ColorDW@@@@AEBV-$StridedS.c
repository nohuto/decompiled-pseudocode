/*
 * XREFs of ?GenerateGridAntialiasBorder@Mesh@@AEBAX_NAEBV?$StridedSpan@UVertexXYW_ColorDW@@@@AEBV?$StridedSpan@UVertexAAFixupBase@@@@PEAHPEAGH3@Z @ 0x1800B9E2C
 * Callers:
 ...
 * Callees:
 *     OffsetBaseVertices @ 0x1800BA3F8 (OffsetBaseVertices.c)
