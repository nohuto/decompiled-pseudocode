/*
 * XREFs of ?BeginFigure@CPathEmitterEdge@EmitterShapes@@EEAAXUD2D_POINT_2F@@W4D2D1_FIGURE_BEGIN@@@Z @ 0x18020A960
 * Callers:
 *     <none>
 * Callees:
        ...
        enum D2D1_FIGURE_BEGIN a3)
{
  ...
  if ( v10 == *((_QWORD *)&v9 + 1) )
  {
    std::vector<float>::_Emplace_reallocate<float const &>((__int64)&v9, *((_BYTE **)&v9 + 1), &v12);
  }
  else
  {
    **((_DWORD **)&v9 + 1) = 0;
  ...
  else
  {
    std::vector<Windows::Foundation::Numerics::float2>::vector<Windows::Foundation::Numerics::float2>(
      *((_QWORD *)this + 3),
      (__int64)&v7);
    std::vector<float>::vector<float>(v5 + 24, (__int64)&v9);
    v6 = v11;
    *((_QWORD *)this + 3) += 56LL;
    *(_DWORD *)(v5 + 48) = v6;
  }
