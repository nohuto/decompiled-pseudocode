/*
 * XREFs of McTemplateU0qqqqxxqx @ 0x1801785EC
 * Callers:
...
ULONG __fastcall McTemplateU0qqqqxxqx(
        __int64 a1,
        __int64 a2,
        __int64 a3,
        int a4,
        ...
        char a10)
{
  ...
  v25 = 4LL;
  v27 = 8LL;
  return McGenEventWrite(Microsoft_Windows_Dwm_Core_Provider_Context, &EVTDESC_DCOMPEVENT_RESOURCE_OPEN, a3, 9u, &v11);
}
