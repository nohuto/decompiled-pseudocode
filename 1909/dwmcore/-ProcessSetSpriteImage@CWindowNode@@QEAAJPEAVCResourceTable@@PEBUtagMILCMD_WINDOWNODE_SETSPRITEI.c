/*
 * XREFs of ?ProcessSetSpriteImage@CWindowNode@@QEAAJPEAVCResourceTable@@PEBUtagMILCMD_WINDOWNODE_SETSPRITEIMAGE@@@Z @ 0x1800AD780
 * Callers:
        ...
        const struct tagMILCMD_WINDOWNODE_SETSPRITEIMAGE *a3)
{
  ...
  if ( (_DWORD)v5 == 60
    && ((Resource = CResourceTable::GetResource((__int64)a2, v3, 0x3Cu)) == 0
      ? (v5 = 0LL)
...
LABEL_8:
    ...
    v10 = v8;
    if ( v8 < 0 )
      MilInstrumentationCheckHR_MaybeFailFast(v9, 0LL, 0, v8, 0x3C6u, 0LL);
  }
  else
  {
    v10 = -2003303421;
    MilInstrumentationCheckHR_MaybeFailFast(this, 0LL, 0, 0x88980403, 0x3C2u, 0LL);
  }
  return v10;
}
