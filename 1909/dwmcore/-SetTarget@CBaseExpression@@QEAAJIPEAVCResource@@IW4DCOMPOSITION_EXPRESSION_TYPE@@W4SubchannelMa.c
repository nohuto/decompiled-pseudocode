/*
 * XREFs of ?SetTarget@CBaseExpression@@QEAAJIPEAVCResource@@IW4DCOMPOSITION_EXPRESSION_TYPE@@W4SubchannelMaskType@@E_K@Z @ 0x1800A4DB4
 * Callers:
  ...
  *(_BYTE *)(a1 + 208) |= v17 ? 2 : 0;
  ...
  if ( a7 )
  {
    ...
    else
    {
      ...
      {
        v15 = -2147467259;
        MilInstrumentationCheckHR_MaybeFailFast((__int64)v18, 0LL, 0, 0x80004005, 0xB8u, 0LL);
        goto LABEL_15;
      }
