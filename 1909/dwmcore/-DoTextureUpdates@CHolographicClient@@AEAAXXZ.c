/*
 * XREFs of ?DoTextureUpdates@CHolographicClient@@AEAAXXZ @ 0x180247498
 * Callers:
...
LABEL_10:
    ...
    if ( v5 == -1 )
    {
      ...
      {
        v9 |= v5;
        McTemplateU0xxxq(v6, &EVTDESC_HOLOGRAPHICCLIENT_TEXTUREUPDATEWAITFAILED, qword_18033DD68, qword_18033DD60, v2);
      }
      goto LABEL_10;
    }
LABEL_11:
...
LABEL_16:
  if ( (Microsoft_Windows_Dwm_CoreEnableBits & 0x40000) != 0 )
    McTemplateU0xxxx(v3 - qword_18033DD60, &EVTDESC_HOLOGRAPHICCLIENT_TEXTUREUPDATECOUNT);
}
