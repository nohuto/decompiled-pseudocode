/*
 * XREFs of ?GetCommonOrCubeMapRenderingShadersNoRefInternal@CD3DDeviceLevel1@@AEAAJAEBUCommonRenderingShaderDesc@@_NPEAIPEAPEAUID3D11PixelShader@@@Z @ 0x180044440
 * Callers:
 ...
 *     ?TryLookupPreCompiledBytecode@CommonRenderingShaderDesc@@SA?AV?$span@$$CBE$0?0@gsl@@AEBU1@@Z @ 0x1801ABAF4 (-TryLookupPreCompiledBytecode@CommonRenderingShaderDesc@@SA-AV-$span@$$CBE$0-0@gsl@@AEBU1@@Z.c)
 */
...
LABEL_17:
  ...
  else
  {
    ...
    v36 = v8;
    if ( v8 )
      (*(void (__fastcall **)(__int64, __int64, __int64, __int64))(*(_QWORD *)v8 + 8LL))(v8, v16, v14, v15);
    v19 = *(_DWORD *)(v18 + 8);
    if ( v8 )
    {
...
LABEL_12:
      *v38 = v19;
      *v39 = (struct ID3D11PixelShader *)v8;
      goto LABEL_13;
    }
  }
...
LABEL_13:
  if ( v8 )
    (*(void (__fastcall **)(__int64, __int64, __int64, __int64))(*(_QWORD *)v8 + 16LL))(v8, v16, v14, v15);
  return v20;
}
