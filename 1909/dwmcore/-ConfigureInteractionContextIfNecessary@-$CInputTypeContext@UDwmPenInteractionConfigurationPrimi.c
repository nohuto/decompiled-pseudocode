/*
 * XREFs of ?ConfigureInteractionContextIfNecessary@?$CInputTypeContext@UDwmPenInteractionConfigurationPrimitive@@U?$TMILFlagsEnum@W4FlagsEnum@DwmInteractionTypePenPrimitiveType@@@@W4FlagsEnum@DwmInteractionTypePenPrimitiveType@@@@QEAAJAEBUInteractionStateInfo@@PEAUTemporaryConfiguration@@@Z @ 0x18022EF2C
 * Callers:
        ...
        __int64 a3)
{
  ...
  if ( *a1 )
  {
    ...
    {
      v6 = 1;
      if ( (v8 & 2) != 0 && dword_180337240 > 4u && TlgKeywordOn((TraceLoggingHProvider)&dword_180337240, 2uLL) )
      {
        v38 = 0;
        v36 = &v33;
        *(_QWORD *)&v33 = a1;
        v37 = 8;
        TlgWrite(v19, &unk_1802DC1DF, 0LL, 0LL, 3u, &pData);
        v18 = *((_DWORD *)a1 + 39);
        v10 = 1;
      }
    }
