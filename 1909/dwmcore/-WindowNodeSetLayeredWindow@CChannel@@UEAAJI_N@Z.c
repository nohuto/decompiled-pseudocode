/*
 * XREFs of ?WindowNodeSetLayeredWindow@CChannel@@UEAAJI_N@Z @ 0x1800532F0
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall CChannel::WindowNodeSetLayeredWindow(CChannel *this, unsigned int a2, unsigned __int8 a3)
{
  unsigned int v6; // ebx
  ...
  CChannel::CheckHandle(this, a2, 197LL);
  v8[0] = 526;
  v8[1] = a2;
  v8[2] = a3;
