/*
 * XREFs of ?UnlockUnaligned@CBitmapLockUnaligned@@IEAAXXZ @ 0x180222508
 * Callers:
 *     ??1CBitmapLockUnaligned@@UEAA@XZ @ 0x180222194 (--1CBitmapLockUnaligned@@UEAA@XZ.c)
 * Callees:
 *     ??3@YAXPEAX@Z @ 0x18007004C (--3@YAXPEAX@Z.c)
 *     ?WriteUnalignedScanline@@YAXPEAEPEBEII@Z @ 0x18022259C (-WriteUnalignedScanline@@YAXPEAEPEBEII@Z.c)
 */
