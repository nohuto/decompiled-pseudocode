/*
 * XREFs of ?GetValueAt@?$LinearKeyframeAnimation@M@Particles@@QEBAMMAEBV?$span@M$0?0@gsl@@@Z @ 0x1801E82F4
 * Callers:
 ...
 * Callees:
 *     ?FindFirstFrameIndex@?$LinearKeyframeAnimation@M@Particles@@IEBAIM@Z @ 0x1801E8184 (-FindFirstFrameIndex@-$LinearKeyframeAnimation@M@Particles@@IEBAIM@Z.c)
 *     ?GetValueForFrame@?$ParticleKeyframe@M@Particles@@QEBAMAEBV?$span@M$0?0@gsl@@@Z @ 0x1801E86A4 (-GetValueForFrame@-$ParticleKeyframe@M@Particles@@QEBAMAEBV-$span@M$0-0@gsl@@@Z.c)
 */
