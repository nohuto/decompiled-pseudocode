/*
 * XREFs of ?GetReceiverMaskInputBrush@CProjectedShadowReceiver@@QEAAJPEAVCDrawingContext@@PEAPEAVCDrawListBrush@@@Z @ 0x1801F1514
 * Callers:
...
LABEL_12:
      ...
      else
      {
        ...
        Microsoft::WRL::ComPtr<ID3D11Device5>::InternalRelease((__int64 *)&v31 + 1);
