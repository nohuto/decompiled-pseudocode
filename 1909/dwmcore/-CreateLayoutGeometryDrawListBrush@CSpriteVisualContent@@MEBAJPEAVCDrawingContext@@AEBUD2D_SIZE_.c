/*
 * XREFs of ?CreateLayoutGeometryDrawListBrush@CSpriteVisualContent@@MEBAJPEAVCDrawingContext@@AEBUD2D_SIZE_F@@PEAPEAVCDrawListBrush@@@Z @ 0x180034C50
 * Callers:
        ...
        struct CDrawListBrush **a4)
{
  ...
  if ( v7 < 0 )
  {
    MilInstrumentationCheckHR_MaybeFailFast((unsigned int)v6, 0LL, 0, v7, 0xC4u, 0LL);
    if ( v12 )
