/*
 * XREFs of ??0SubscriptionList@details_abi@wil@@QEAA@XZ @ 0x1800B16B8
 * Callers:
 ...
 *     ?construct@?$manually_managed_shutdown_aware_object@VFeatureStateManager@details@wil@@@wil@@QEAAXXZ @ 0x1800E7CA8 (-construct@-$manually_managed_shutdown_aware_object@VFeatureStateManager@details@wil@@@wil@@QEAA.c)
 * Callees:
 *     <none>
 */
