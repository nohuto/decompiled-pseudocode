/*
 * XREFs of ?TransformOutput@CInteractionContextTransformHelper@@QEAAXAEBUINTERACTION_CHANGESET@@AEBUtagRECT@@1K_NPEAU2@@Z @ 0x18025D768
 * Callers:
  ...
  if ( !D2D1::Matrix3x2F::IsIdentity(this) )
  {
    ...
    if ( v18 )
    {
      if ( v15 )
      {
        ...
        *(float *)v15 = v24;
        v25 = (float)((float)(*(float *)(v16 + 4) * *((float *)this + 27))
        ...
        *(float *)(v16 + 4) = v25;
        if ( a5 != 5 )
        {
          v26 = (float)((float)(*(float *)(v15 + 16) * v21[1]) + (float)(*(float *)(v15 + 20) * v21[3])) + v21[5];
    ...
    if ( (*((_BYTE *)a7 + 84) & 4) != 0 )
    {
      if ( v17 )
      {
        v27 = (float)((float)(*(float *)v17 * *((float *)this + 25))
                    + (float)(*(float *)(v17 + 4) * *((float *)this + 27)))
            + *((float *)this + 29);
        ...
        *(float *)(v17 + 4) = v27;
        if ( a5 != 5 )
        {
          v28 = (float)((float)(*(float *)(v17 + 16) * v21[1]) + (float)(*(float *)(v17 + 20) * v21[3])) + v21[5];
