/*
 * XREFs of ?GetGeometryBounds@CGeometry2DGroup@@UEAAXPEAV?$CRectF@ULocalRenderingHPC@CoordinateSpace@@@@@Z @ 0x180211480
 * Callers:
 *     <none>
 * Callees:
    ...
    if ( (v5 & 2) != 0 )
    {
      ...
      if ( *(_DWORD *)(a1 + 96) )
      {
        do
        {
          ...
          if ( v7 )
          {
            (*(void (__fastcall **)(__int64, float *))(*(_QWORD *)v7 + 208LL))(v7, v11);
