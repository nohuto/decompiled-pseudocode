/*
 * XREFs of ?ForceFullRender@CRenderTargetManager@@QEAAXXZ @ 0x1800D5C24
 * Callers:
 *     ?ForceFullRender@CComposition@@QEAAX_N@Z @ 0x1800D5C0C (-ForceFullRender@CComposition@@QEAAX_N@Z.c)
