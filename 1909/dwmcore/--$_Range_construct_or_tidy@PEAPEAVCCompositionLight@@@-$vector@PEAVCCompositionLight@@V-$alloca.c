/*
 * XREFs of ??$_Range_construct_or_tidy@PEAPEAVCCompositionLight@@@?$vector@PEAVCCompositionLight@@V?$allocator@PEAVCCompositionLight@@@std@@@std@@AEAAXPEAPEAVCCompositionLight@@0Uforward_iterator_tag@1@@Z @ 0x1801B0384
 * Callers:
