/*
 * XREFs of ?IsGradientWhitePixelGPUBlacklistedGpu@CCommonRegistryData@@SA_NII@Z @ 0x18004A75C
 * Callers:
...
char __fastcall CCommonRegistryData::IsGradientWhitePixelGPUBlacklistedGpu(int a1, unsigned __int16 a2)
{
  ...
  else
  {
    ...
    CCommonRegistryData::m_whitePixelBlacklistedGpuIds = (const struct CCommonRegistryData::GpuId *const)&unk_1802E1DF0;
    v6 = 0;
  }
  if ( !v6 )
    return 0;
