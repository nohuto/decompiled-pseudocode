/*
 * XREFs of ?RenderTargetRectToDesktopRect@CHwndRenderTarget@@IEAAX_NAEBV?$TMilRect_@HUtagRECT@@UMilPointAndSizeL@@U_CMilRectL_@RectUniqueness@@@@PEAV?$TMilRect_@MUMilRectF@@UMilPointAndSizeF@@UNotNeeded@RectUniqueness@@@@@Z @ 0x1801A80AC
 * Callers:
...
char __fastcall CHwndRenderTarget::RenderTargetRectToDesktopRect(__int64 a1, __int64 a2, __int64 a3, _OWORD *a4)
{
  ...
  __int64 v10; // rax
  char result; // al
  _BYTE v12[64]; // [rsp+20h] [rbp-88h] BYREF
  ...
  *(float *)v6.m128i_i32 = (float)*(int *)(a3 + 12);
  ...
  if ( !v7 || (v9 = *(_BYTE *)(v7 + 13439) == 0, v10 = 288LL, v9) )
    v10 = 220LL;
  CMILMatrix::SetToInverse((CMILMatrix *)v12, (const struct CMILMatrix *)(v10 + a1));
