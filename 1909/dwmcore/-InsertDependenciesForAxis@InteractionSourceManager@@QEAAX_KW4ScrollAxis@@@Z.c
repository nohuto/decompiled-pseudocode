/*
 * XREFs of ?InsertDependenciesForAxis@InteractionSourceManager@@QEAAX_KW4ScrollAxis@@@Z @ 0x18021D6DC
 * Callers:
...
void __fastcall InteractionSourceManager::InsertDependenciesForAxis(_QWORD *a1, unsigned __int64 a2, int a3)
{
  ...
  while ( v3 != v6 )
  {
    ...
    {
      (*(void (__fastcall **)(__int64, unsigned __int64))(*(_QWORD *)SourceModifierConditionalAnimation + 208LL))(
    ...
    if ( v13 )
    {
      (*(void (__fastcall **)(__int64, unsigned __int64))(*(_QWORD *)v13 + 208LL))(v13, a2);
...
LABEL_11:
    ...
    if ( a3 >= 0 )
    {
      ...
      CExpressionManager::InsertExpressionsInOrderForTarget(*(_QWORD *)(*a1 + 240LL), a2, (__int64)v18, v16);
    }
LABEL_18:
    CExpressionManager::InsertExpressionsInOrderForTarget(*(_QWORD *)(*a1 + 240LL), a2, (__int64)v15, 9u);
