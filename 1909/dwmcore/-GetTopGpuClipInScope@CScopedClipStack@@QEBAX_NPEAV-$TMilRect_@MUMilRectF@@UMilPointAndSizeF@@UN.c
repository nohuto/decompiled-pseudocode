/*
 * XREFs of ?GetTopGpuClipInScope@CScopedClipStack@@QEBAX_NPEAV?$TMilRect_@MUMilRectF@@UMilPointAndSizeF@@UNotNeeded@RectUniqueness@@@@@Z @ 0x180035C98
 * Callers:
...
char __fastcall CScopedClipStack::GetTopGpuClipInScope(CScopedClipStack *a1, char a2)
{
  ...
  if ( (_BYTE)v3 )
    LOBYTE(v3) = CBaseClipStack::Top((_DWORD *)(v4 + 2224), v5);
  else
