/*
 * XREFs of ?Grow@?$DynArrayImpl@$00@@IEAAJIIHPEAPEBX@Z @ 0x1800AADF4
 * Callers:
...
LABEL_33:
    v11 = -2147024362;
    MilInstrumentationCheckHR_MaybeFailFast(a1, 0LL, 0, 0x80070216, v25, 0LL);
    return v11;
  }
  v10 = *(_DWORD *)(a1 + 20);
  v11 = 0;
  ...
  else
  {
    ...
    {
      v11 = -2147024882;
      MilInstrumentationCheckHR_MaybeFailFast(v23, 0LL, 0, 0x8007000E, 0x111u, 0LL);
      return v11;
    }
    if ( v22 != *(char **)v7 )
    {
