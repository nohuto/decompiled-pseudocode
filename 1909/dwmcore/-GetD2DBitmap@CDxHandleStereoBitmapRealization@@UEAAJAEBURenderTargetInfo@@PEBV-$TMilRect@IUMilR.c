/*
 * XREFs of ?GetD2DBitmap@CDxHandleStereoBitmapRealization@@UEAAJAEBURenderTargetInfo@@PEBV?$TMilRect@IUMilRectU@@UNotNeeded@RectUniqueness@@@@_NPEAPEAUID2D1Bitmap1@@@Z @ 0x180261B70
 * Callers:
 *     <none>
 * Callees:
        ...
        _QWORD *a5)
{
  ...
  *a5 = 0LL;
  ...
  else
  {
    ...
    {
      v21 = (*(__int64 (__fastcall **)(__int64, struct _LUID, __int64, __int64))(*(_QWORD *)(a1 + 312) + 48LL))(
              a1 + 312,
              v18,
              v17,
              v15);
