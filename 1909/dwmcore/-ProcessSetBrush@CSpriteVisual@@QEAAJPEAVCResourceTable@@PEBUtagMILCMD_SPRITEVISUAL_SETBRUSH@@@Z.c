/*
 * XREFs of ?ProcessSetBrush@CSpriteVisual@@QEAAJPEAVCResourceTable@@PEBUtagMILCMD_SPRITEVISUAL_SETBRUSH@@@Z @ 0x18007B6E0
 * Callers:
        ...
        const struct tagMILCMD_SPRITEVISUAL_SETBRUSH *a3)
{
  ...
  {
    v10 = -2003303421;
    MilInstrumentationCheckHR_MaybeFailFast(v7, 0LL, 0, 0x88980403, 0x3Du, 0LL);
  }
  else
  {
