/*
 * XREFs of ?EnsureAdapterInfo@CGlobalSurfaceManager@@AEAAJXZ @ 0x1800CEFF0
 * Callers:
 ...
 *     ?ReleaseAdapterInfo@CGlobalSurfaceManager@@AEAAXXZ @ 0x1800D3EB4 (-ReleaseAdapterInfo@CGlobalSurfaceManager@@AEAAXXZ.c)
