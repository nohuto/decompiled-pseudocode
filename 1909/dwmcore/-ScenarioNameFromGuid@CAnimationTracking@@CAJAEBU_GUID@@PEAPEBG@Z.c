/*
 * XREFs of ?ScenarioNameFromGuid@CAnimationTracking@@CAJAEBU_GUID@@PEAPEBG@Z @ 0x1800B4944
 * Callers:
...
__int64 __fastcall CAnimationTracking::ScenarioNameFromGuid(const struct _GUID *a1, const unsigned __int16 **a2)
{
  ...
  while ( 1 )
  {
    v5 = *(_QWORD *)&a1->Data1 - (_QWORD)*(&off_1803363A0 + 3 * v3 + 1);
    if ( *(wchar_t **)&a1->Data1 == *(&off_1803363A0 + 3 * v3 + 1) )
      v5 = *(_QWORD *)a1->Data4 - (_QWORD)(&off_1803363A0)[3 * v3 + 1];
    if ( !v5 )
      break;
