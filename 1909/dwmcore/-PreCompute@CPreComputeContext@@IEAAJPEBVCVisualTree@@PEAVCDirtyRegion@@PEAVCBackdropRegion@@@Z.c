/*
 * XREFs of ?PreCompute@CPreComputeContext@@IEAAJPEBVCVisualTree@@PEAVCDirtyRegion@@PEAVCBackdropRegion@@@Z @ 0x180081E30
 * Callers:
        ...
        struct CBackdropRegion *a4)
{
  ...
  *((_QWORD *)this + 89) = a4;
  ...
  if ( !*((_QWORD *)this + 79) )
  {
    ...
    v8 = v124;
    if ( v124 < 0 )
      MilInstrumentationCheckHR_MaybeFailFast(v6, 0LL, 0, v124, 0x488u, 0LL);
  }
  if ( v8 < 0 )
  {
    v172 = 59;
  ...
  LODWORD(v173) = 1;
  *((_DWORD *)this + 4) = 0;
  v10 = CWatermarkStack<enum MilBitmapInterpolationMode::Enum,64,2,10>::Push((unsigned int *)this + 4, &v173);
  v8 = v10;
  if ( v10 < 0 )
  {
  ...
  *((_DWORD *)this + 12) = 0;
  LODWORD(v173) = 1;
  v12 = CWatermarkStack<enum MilBitmapInterpolationMode::Enum,64,2,10>::Push((unsigned int *)this + 12, &v173);
  v8 = v12;
  if ( v12 < 0 )
  {
  ...
  *((_DWORD *)this + 20) = 0;
  LODWORD(v173) = 0;
  v14 = CWatermarkStack<enum MilBitmapInterpolationMode::Enum,64,2,10>::Push((unsigned int *)this + 20, &v173);
  v8 = v14;
  if ( v14 < 0 )
  {
  ...
  *((_DWORD *)this + 28) = 0;
  *((_DWORD *)this + 36) = 0;
  CWatermarkStack<float,2,2,10>::Push((unsigned int *)this + 36, &v173);
  *((_DWORD *)this + 44) = 0;
  v173 = (void *)_mm_unpacklo_ps((__m128)0LL, (__m128)LODWORD(FLOAT_N1_0)).m128_u64[0];
  CWatermarkStack<D2D_VECTOR_2F,2,2,10>::Push((unsigned int *)this + 44, &v173);
  *((_DWORD *)this + 52) = 0;
  v173 = 0LL;
  CWatermarkStack<void *,2,2,10>::Push((unsigned int *)this + 52, &v173);
  *((_DWORD *)this + 60) = 0;
  *((_DWORD *)this + 68) = 0;
  if ( *((_DWORD *)this + 82) )
  {
  ...
  *((_BYTE *)this + 1185) = 0;
  ...
  if ( v19 < 0 )
  {
    MilInstrumentationCheckHR_MaybeFailFast(v6, 0LL, 0, v19, 0x59u, 0LL);
    goto LABEL_82;
  }
  v8 = 0;
  v20 = 0;
...
LABEL_22:
    ...
    *((_DWORD *)this + 278) = 0;
    ...
    {
      TreeDataListHead = (__int64 *)CVisual::GetTreeDataListHead(v23);
      ...
      {
        v79 = (char *)(v6 - 224);
        if ( *(const struct CVisualTree **)(v6 + 32) == a2 )
          break;
        v6 = *(_QWORD *)v6;
        if ( (__int64 *)v6 == v126 )
          goto LABEL_93;
    ...
    if ( v79 && *((_QWORD *)v79 + 15) >= v78 )
    {
      v16 = 0;
LABEL_97:
      if ( v8 >= 0 )
        goto LABEL_22;
      MilInstrumentationCheckHR_MaybeFailFast(v6, 0LL, 0, v8, 0x4F0u, 0LL);
      goto LABEL_23;
    }
LABEL_93:
    ...
    else
    {
      ...
      v8 = v82;
      if ( v82 < 0 )
        MilInstrumentationCheckHR_MaybeFailFast(v6, 0LL, 0, v82, 0x1Eu, 0LL);
    }
    v21 = (unsigned int)v173;
    goto LABEL_97;
  }
LABEL_23:
  ...
  if ( v25 )
  {
    ...
    while ( 1 )
    {
      v6 = *(_QWORD *)(v128 + *(_QWORD *)(*(_QWORD *)this + 1040LL));
      if ( *(_BYTE *)(v6 + 162) )
      {
        v129 = (const struct CVisual *)(*(__int64 (__fastcall **)(__int64))(*(_QWORD *)v6 + 208LL))(v6);
    ...
    MilInstrumentationCheckHR_MaybeFailFast(v6, 0LL, 0, v131, 0x50Du, 0LL);
  }
LABEL_25:
  if ( v8 < 0 )
  {
    v172 = 99;
LABEL_318:
    MilInstrumentationCheckHR_MaybeFailFast(v6, 0LL, 0, v8, v172, 0LL);
    goto LABEL_82;
  }
  if ( !*((_BYTE *)this + 1186) )
    goto LABEL_28;
...
LABEL_206:
  ...
  MilInstrumentationCheckHR_MaybeFailFast(0LL, 0LL, 0, v119, 0x529u, 0LL);
LABEL_207:
  v9 = (_DWORD *)((char *)this + 16);
LABEL_28:
  ...
  else
  {
    ...
    if ( v30 == 10 )
    {
      ...
      {
        MilInstrumentationCheckHR_MaybeFailFast(v29, 0LL, 0, 0x80070216, 0xEEu, 0LL);
      }
