/*
 * XREFs of ?TileLegacyMilBrushSetSourceModifications@CChannel@@UEAAJIU?$TMILFlagsEnum@W4FlagsEnum@MilSourceModification@@@@KK@Z @ 0x180157ED0
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall CChannel::TileLegacyMilBrushSetSourceModifications(
        CChannel *this,
        unsigned int a2,
        int a3,
        int a4,
