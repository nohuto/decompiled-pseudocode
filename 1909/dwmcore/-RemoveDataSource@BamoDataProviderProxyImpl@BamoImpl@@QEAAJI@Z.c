/*
 * XREFs of ?RemoveDataSource@BamoDataProviderProxyImpl@BamoImpl@@QEAAJI@Z @ 0x18024F888
 * Callers:
 *     ?Thunk_RemoveDataSource_5@?$IDataProviderProxy_Receive@VBamoDataProviderProxyImpl@BamoImpl@@@@SAJPEAXPEAPEAX@Z @ 0x18024FD00 (-Thunk_RemoveDataSource_5@-$IDataProviderProxy_Receive@VBamoDataProviderProxyImpl@BamoImpl@@@@SA.c)
 * Callees:
        ...
        unsigned int a2)
{
  ...
  v9 = (*(__int64 (__fastcall **)(char *, char *))(*((_QWORD *)this - 2) + 72LL))((char *)this - 16, v8);
  v12 = v15;
  v13 = v9;
  if ( v15 )
  {
