/*
 * XREFs of ?SendRemotingMetaData@CDisplay@@QEBAJAEBU_DWMIndirectMetaData@@@Z @ 0x180159930
 * Callers:
...
__int64 __fastcall CDisplay::SendRemotingMetaData(CDisplay *this, const struct _DWMIndirectMetaData *a2)
{
  ...
  if ( v2 )
  {
    ...
    v3 = v8;
    if ( v8 < 0 )
      MilInstrumentationCheckHR_MaybeFailFast(v9, &dword_1802E1E90, 1u, v8, 0x381u, 0LL);
  }
  return v3;
}
