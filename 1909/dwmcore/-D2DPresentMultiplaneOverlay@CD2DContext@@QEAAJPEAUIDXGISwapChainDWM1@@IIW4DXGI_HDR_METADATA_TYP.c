/*
 * XREFs of ?D2DPresentMultiplaneOverlay@CD2DContext@@QEAAJPEAUIDXGISwapChainDWM1@@IIW4DXGI_HDR_METADATA_TYPE@@PEBXIPEBU_DXGI_PRESENT_MULTIPLANE_OVERLAY@@@Z @ 0x18015EF40
 * Callers:
        ...
        const struct _DXGI_PRESENT_MULTIPLANE_OVERLAY *a8)
{
  if ( (a4 & 1) != 0 )
    ...
    return (*(__int64 (__fastcall **)(_QWORD, struct IDXGISwapChainDWM1 *, _QWORD))(**((_QWORD **)this + 30) + 112LL))(
             *((_QWORD *)this + 30),
             a2,
             a3);
}
