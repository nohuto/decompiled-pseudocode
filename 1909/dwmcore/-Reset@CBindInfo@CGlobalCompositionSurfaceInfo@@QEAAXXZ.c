/*
 * XREFs of ?Reset@CBindInfo@CGlobalCompositionSurfaceInfo@@QEAAXXZ @ 0x1800C2A20
 * Callers:
 ...
 *     ?OnNotifyInvalidResource@CGlobalCompositionSurfaceInfo@@EEAAXXZ @ 0x18025BE70 (-OnNotifyInvalidResource@CGlobalCompositionSurfaceInfo@@EEAAXXZ.c)
 * Callees:
...
void __fastcall CGlobalCompositionSurfaceInfo::CBindInfo::Reset(CGlobalCompositionSurfaceInfo::CBindInfo *this)
{
  ...
  *((_BYTE *)this + 152) = 0;
  ...
  if ( v7 )
  {
    ...
    if ( v6 >= v15 )
    {
      MilInstrumentationCheckHR_MaybeFailFast(v14, 0LL, 0, 0x80070057, 0x222u, 0LL);
    }
    else
    {
      v16 = v15 - 1;
