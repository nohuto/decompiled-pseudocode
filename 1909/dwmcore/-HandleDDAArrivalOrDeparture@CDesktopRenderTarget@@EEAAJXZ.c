/*
 * XREFs of ?HandleDDAArrivalOrDeparture@CDesktopRenderTarget@@EEAAJXZ @ 0x1801A6DF0
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall CDesktopRenderTarget::HandleDDAArrivalOrDeparture(CDesktopRenderTarget *this)
{
  ...
  {
    MilInstrumentationCheckHR_MaybeFailFast(v4, &dword_1802E27D8, 2u, CurrentDisplaySet, 0x2E6u, 0LL);
    goto LABEL_14;
  }
  if ( *((_DWORD *)v13 + 18) )
  {
        ...
        if ( CDisplay::HasDDAChanged((CDisplay *)v7) )
        {
          ...
          *(_BYTE *)(v7 + 319) = v8;
          if ( v8 && *(_BYTE *)(v7 + 314) )
          {
            ...
            if ( v9 < 0 )
            {
              MilInstrumentationCheckHR_MaybeFailFast(v10, &dword_1802E27D8, 2u, v9, 0x308u, 0LL);
LABEL_14:
              if ( v1 )
