/*
 * XREFs of ?ProcessSetNodesInfo@CExpression@@QEAAJPEAVCResourceTable@@PEBUtagMILCMD_EXPRESSION_SETNODESINFO@@@Z @ 0x18007BECC
 * Callers:
...
LABEL_6:
  if ( *((_DWORD *)a3 + 3) < 4u || (this *= 8LL, *((unsigned int *)a3 + 6) < (unsigned __int64)this) )
  {
    cData = 239;
    goto LABEL_26;
  }
...
LABEL_15:
  if ( *(int *)(*(_QWORD *)(v6 + 304) + 4LL) < 0
    && dword_180337240 > 4u
    && TlgKeywordOn((TraceLoggingHProvider)&dword_180337240, 1uLL) )
  {
    ...
    v21 = 4LL;
    v23 = 4LL;
    TlgWrite((TraceLoggingHProvider)&dword_180337240, &unk_1802DA447, 0LL, 0LL, 4u, &pData);
  }
  return v17;
}
