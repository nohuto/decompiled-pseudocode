/*
 * XREFs of ?DrawAsDrawList@CLinearGradientLegacyMilBrush@@QEAAJPEAVCDrawingContext@@PEAVCDrawListEntryBuilder@@_NAEBUMilRectF@@@Z @ 0x180211BF8
 * Callers:
  ...
  *(_OWORD *)v45 = *(_OWORD *)a5;
  if ( operator!=((float *)this + 14, (float *)v45) || memcmp_0((char *)this + 160, (char *)this + 72, 0x58uLL) )
  {
    ...
    *((float *)v45 + 1) = v15;
    ...
    ((void (__fastcall *)(_QWORD, void *, _DWORD *))xmmword_1803385E0)(
      *((_QWORD *)this + 31) + SDWORD2(xmmword_1803385E0),
      &CLinearGradientBrush::sc_StartPoint,
      v38);
    ((void (__fastcall *)(_QWORD, void *, struct CGeometryOnlyDrawListBrush **))xmmword_180338618)(
      *((_QWORD *)this + 31) + SDWORD2(xmmword_180338618),
      &CLinearGradientBrush::sc_EndPoint,
      v45);
    v18 = *((_QWORD *)&v39[1] + 1);
    v19 = *((_QWORD *)this + 32) + SDWORD2(xmmword_180338180);
    LODWORD(v44[0]) = **((_DWORD **)&v39[1] + 1);
    ((void (__fastcall *)(__int64, void *, CGeometryOnlyDrawListBrush **))xmmword_180338180)(
      v19,
      &CColorGradientStop::sc_Offset,
      v44);
    v20 = *(const __m128i **)&v39[0];
    v21 = *((_QWORD *)this + 32) + SDWORD2(xmmword_1803381B8);
    ...
    ((void (__fastcall *)(__int64, void *, CGeometryOnlyDrawListBrush **))xmmword_1803381B8)(
      v21,
      &CColorGradientStop::sc_Color,
      v44);
    v23 = *((_QWORD *)this + 33) + SDWORD2(xmmword_180338180);
    ...
    v25 = *((_QWORD *)this + 33) + SDWORD2(xmmword_1803381B8);
