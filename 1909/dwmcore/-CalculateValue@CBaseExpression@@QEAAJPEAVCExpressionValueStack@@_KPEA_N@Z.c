/*
 * XREFs of ?CalculateValue@CBaseExpression@@QEAAJPEAVCExpressionValueStack@@_KPEA_N@Z @ 0x180075BC0
 * Callers:
 ...
 *     ?IsExpressionValueValid@CBaseExpression@@AEAA_NPEAVCExpressionValue@@@Z @ 0x1800769E0 (-IsExpressionValueValid@CBaseExpression@@AEAA_NPEAVCExpressionValue@@@Z.c)
        ...
        bool *a4)
{
  ...
  *(_DWORD *)v63 = *((_DWORD *)a2 + 4);
  if ( !*((_QWORD *)this + 34) )
    *((_QWORD *)this + 34) = a3;
  (*(void (__fastcall **)(CBaseExpression *, bool *))(*(_QWORD *)this + 272LL))(this, &v63[4]);
...
LABEL_16:
  ...
  MilInstrumentationCheckHR_MaybeFailFast(v36, 0LL, 0, v35, 0x2B9u, 0LL);
LABEL_17:
  if ( v13 < 0 )
  {
    MilInstrumentationCheckHR_MaybeFailFast(v12, &dword_1802A1DA8, 1u, v13, 0x3ECu, 0LL);
    goto LABEL_47;
  }
  if ( !v11 )
    CBaseExpression::NotifyAnimationStarted(this);
  v13 = (*(__int64 (__fastcall **)(CBaseExpression *, struct CExpressionValueStack *, __int64, bool *))(*(_QWORD *)this + 248LL))(
          this,
          a2,
          v67,
          a4);
  if ( v13 < 0 )
  {
    MilInstrumentationCheckHR_MaybeFailFast((__int64)v16, &dword_1802A1DA8, 1u, v13, 0x3F3u, 0LL);
    goto LABEL_47;
  }
  if ( v5 )
  {
  ...
  {
    v13 = -2147024890;
    MilInstrumentationCheckHR_MaybeFailFast((__int64)v38, &dword_1802A1DA8, 1u, 0x80070006, 0x40Du, 0LL);
    v43 = v71;
    if ( !v71 )
      goto LABEL_47;
    goto LABEL_76;
...
LABEL_72:
  ...
  if ( v72 != *((_DWORD *)this + 36) )
  {
    ...
    v62 = 1050;
LABEL_74:
    MilInstrumentationCheckHR_MaybeFailFast(v40, &dword_1802A1DA8, 1u, v42, v62, 0LL);
    v43 = v71;
    if ( v71 )
    {
      v71 = 0LL;
...
LABEL_25:
  ...
  {
    v13 = -2147467259;
    MilInstrumentationCheckHR_MaybeFailFast(v20, &dword_1802A1DA8, 1u, 0x80004005, 0x433u, 0LL);
    goto LABEL_48;
  }
  if ( v17 )
  {
...
LABEL_31:
  ...
  if ( v21 )
  {
    ...
    if ( v54 < 0 )
    {
      MilInstrumentationCheckHR_MaybeFailFast(v55, 0LL, 0, v54, 0x1ECu, 0LL);
      goto LABEL_38;
    }
...
LABEL_37:
  ...
  if ( v26 )
  {
    ...
    if ( v27 )
    {
      ...
      if ( v28 >= 0 )
        goto LABEL_37;
      MilInstrumentationCheckHR_MaybeFailFast(v23, 0LL, 0, v28, 0x1FEu, 0LL);
LABEL_38:
      v13 = v29;
      if ( v29 >= 0 )
      {
  ...
  v13 = -2147024890;
  v29 = -2147024890;
  MilInstrumentationCheckHR_MaybeFailFast(v23, 0LL, 0, 0x80070006, 0x1FDu, 0LL);
LABEL_139:
  MilInstrumentationCheckHR_MaybeFailFast(v23, &dword_1802A1DA8, 1u, v29, 0x440u, 0LL);
LABEL_48:
  v30 = *((_DWORD *)a2 + 4);
  if ( v30 > v19 )
  {
