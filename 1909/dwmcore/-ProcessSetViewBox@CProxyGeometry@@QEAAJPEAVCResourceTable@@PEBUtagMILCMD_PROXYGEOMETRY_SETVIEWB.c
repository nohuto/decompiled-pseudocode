/*
 * XREFs of ?ProcessSetViewBox@CProxyGeometry@@QEAAJPEAVCResourceTable@@PEBUtagMILCMD_PROXYGEOMETRY_SETVIEWBOX@@@Z @ 0x1801F34A4
 * Callers:
        ...
        const struct tagMILCMD_PROXYGEOMETRY_SETVIEWBOX *a3)
{
  ...
  if ( ResourceWithoutType != this[18] )
  {
    ...
    {
      v4 = -2003303421;
      MilInstrumentationCheckHR_MaybeFailFast(v7, 0LL, 0, 0x88980403, 0x5Bu, 0LL);
    }
  }
  return v4;
}
