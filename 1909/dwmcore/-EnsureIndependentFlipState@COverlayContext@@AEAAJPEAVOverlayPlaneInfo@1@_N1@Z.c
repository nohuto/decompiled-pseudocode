/*
 * XREFs of ?EnsureIndependentFlipState@COverlayContext@@AEAAJPEAVOverlayPlaneInfo@1@_N1@Z @ 0x1801847A0
 * Callers:
 ...
 *     ?IsFullscreenSingleMonitor@COverlayContext@@AEBA_NXZ @ 0x18018537C (-IsFullscreenSingleMonitor@COverlayContext@@AEBA_NXZ.c)
