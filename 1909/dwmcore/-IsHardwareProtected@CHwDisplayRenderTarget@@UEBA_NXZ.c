/*
 * XREFs of ?IsHardwareProtected@CHwDisplayRenderTarget@@UEBA_NXZ @ 0x1800BEAF0
 * Callers:
 *     ?IsHardwareProtected@CHwDisplayRenderTarget@@WJA@EBA_NXZ @ 0x1800F0560 (-IsHardwareProtected@CHwDisplayRenderTarget@@WJA@EBA_NXZ.c)
 * Callees:
