/*
 * XREFs of ?UpdateValueWithChaining@CScrollAnimation@@IEAAMMMW4Boundary@@@Z @ 0x18020629C
 * Callers:
 ...
 *     ?ShouldChainAllForAxis@CInteractionTracker@@QEBA_NW4ScrollAxis@@PEBVCManipulation@@@Z @ 0x1801DC338 (-ShouldChainAllForAxis@CInteractionTracker@@QEBA_NW4ScrollAxis@@PEBVCManipulation@@@Z.c)
 ...
 *     ?UpdateChainingDirection@CScrollAnimation@@AEAAXM@Z @ 0x1802061E8 (-UpdateChainingDirection@CScrollAnimation@@AEAAXM@Z.c)
 ...
 *     ?ChainToParent@CChainingHelper@@QEAAXW4ScrollAxis@@W4Boundary@@_N@Z @ 0x18021F3A0 (-ChainToParent@CChainingHelper@@QEAAXW4ScrollAxis@@W4Boundary@@_N@Z.c)
 *     ?RestoreSupportedInteractionsWithBoundaries@CChainingHelper@@QEAAXW4ScrollAxis@@W4Boundary@@_N2@Z @ 0x18021F4F4 (-RestoreSupportedInteractionsWithBoundaries@CChainingHelper@@QEAAXW4ScrollAxis@@W4Boundary@@_N2@.c)
 */
...
float __fastcall CScrollAnimation::UpdateValueWithChaining(__int64 a1, float a2, float a3, unsigned int a4)
{
  ...
  if ( ActiveChainingHelper )
  {
    ...
    if ( dword_180337240 > 4u && TlgKeywordOn((TraceLoggingHProvider)&dword_180337240, 2uLL) )
    {
      ...
      v90 = v19;
      TlgWrite((TraceLoggingHProvider)&dword_180337240, &unk_1802DB4E7, 0LL, 0LL, 0x10u, &pData);
    }
    v20 = *(_BYTE *)(a1 + 428);
    if ( (v20 & 2) == 0 && v12 == 2 )
    {
        ...
        && InteractionSourceManager::HasActiveManipulation(v11) )
      {
        ...
        ShouldChainAllForAxis = CInteractionTracker::ShouldChainAllForAxis(v23, *(_DWORD *)(a1 + 316), (__int64)v22);
      }
      else
      {
    ...
    if ( v26 )
    {
      ...
      if ( !v27 )
      {
        ...
        {
          if ( v32 == 1 || (v33 = *(_DWORD *)(a1 + 412), v32 == 3) )
          {
            v33 = *(_DWORD *)(a1 + 412);
            if ( a4 == v32 && (float)((float)(v92 - *(float *)(a1 + 416)) > 0.0) < 0.0 )
            {
              if ( InteractionSourceManager::TryGetActiveChainingHelper(v11)
                && InteractionSourceManager::HasActiveManipulation(v11) )
              {
                v35 = InteractionSourceManager::TryGetActiveManipulation(v11);
                v37 = CInteractionTracker::ShouldChainAllForAxis(v36, *(_DWORD *)(a1 + 316), (__int64)v35);
              }
              else
              {
                v37 = 0;
              ...
              LOBYTE(v34) = v37;
              CChainingHelper::ChainToParent(ActiveChainingHelper, *(unsigned int *)(a1 + 316), a4, v34);
              v33 = *(_DWORD *)(a1 + 412);
            }
          }
          if ( (unsigned int)(v33 - 2) <= 1 && a4 == v33 && (float)((float)(v92 - *(float *)(a1 + 416)) > 0.0) > 0.0 )
          {
            if ( InteractionSourceManager::TryGetActiveChainingHelper(v11)
              && InteractionSourceManager::HasActiveManipulation(v11) )
            {
              v39 = InteractionSourceManager::TryGetActiveManipulation(v11);
              v41 = CInteractionTracker::ShouldChainAllForAxis(v40, *(_DWORD *)(a1 + 316), (__int64)v39);
            }
            else
            {
              v41 = 0;
            ...
            LOBYTE(v38) = v41;
            CChainingHelper::ChainToParent(ActiveChainingHelper, *(unsigned int *)(a1 + 316), a4, v38);
          }
          if ( !a4 )
          {
            if ( InteractionSourceManager::TryGetActiveChainingHelper(v11)
              && InteractionSourceManager::HasActiveManipulation(v11) )
            {
              ...
              v5 = CInteractionTracker::ShouldChainAllForAxis(v44, *(_DWORD *)(a1 + 316), (__int64)v43);
            }
        ...
        if ( a4 && ShouldChainForAxis )
        {
            ...
            && InteractionSourceManager::HasActiveManipulation(v11) )
          {
            ...
            v48 = CInteractionTracker::ShouldChainAllForAxis(v47, *(_DWORD *)(a1 + 316), (__int64)v46);
          }
          else
          {
            v48 = 0;
          ...
          LOBYTE(v45) = v48;
          CChainingHelper::ChainToParent(ActiveChainingHelper, *(unsigned int *)(a1 + 316), a4, v45);
        }
...
LABEL_76:
      ...
      if ( *(_DWORD *)(a1 + 412) && ShouldChainForAxis )
      {
          ...
          && InteractionSourceManager::HasActiveManipulation(v11) )
        {
          ...
          v31 = CInteractionTracker::ShouldChainAllForAxis(v30, *(_DWORD *)(a1 + 316), (__int64)v29);
        }
        else
        {
          v31 = 0;
