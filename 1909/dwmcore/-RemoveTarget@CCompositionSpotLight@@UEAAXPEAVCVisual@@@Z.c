/*
 * XREFs of ?RemoveTarget@CCompositionSpotLight@@UEAAXPEAVCVisual@@@Z @ 0x1800C12E0
 * Callers:
 *     <none>
 * Callees:
 *     ?RemoveTarget@CCompositionLight@@UEAAXPEAVCVisual@@@Z @ 0x1800C1310 (-RemoveTarget@CCompositionLight@@UEAAXPEAVCVisual@@@Z.c)
