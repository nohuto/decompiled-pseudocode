/*
 * XREFs of ?SetLastLocalToWorldTransform@CMoveRenderPassInfo@@QEAAJPEBVCMILMatrix@@0PEAV2@PEA_N@Z @ 0x18017F394
 * Callers:
        ...
        bool *a5)
{
  ...
  _BYTE v39[48]; // [rsp+D0h] [rbp-30h] BYREF
...
LABEL_6:
  ...
  if ( v5 && a2 && CMILMatrix::Is2DAxisAlignedPreserving<1>((__int64)a2) )
  {
    ...
    if ( v14 )
    {
      ...
      CMILMatrix::SetToInverse((CMILMatrix *)v39, (const struct CMILMatrix *)v35);
