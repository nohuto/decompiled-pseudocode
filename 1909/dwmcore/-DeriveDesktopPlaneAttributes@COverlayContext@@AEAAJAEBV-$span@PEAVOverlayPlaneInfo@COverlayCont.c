/*
 * XREFs of ?DeriveDesktopPlaneAttributes@COverlayContext@@AEAAJAEBV?$span@PEAVOverlayPlaneInfo@COverlayContext@@$0?0@gsl@@_N11PEAIPEAUDXGI_MULTIPLANE_OVERLAY_ATTRIBUTES@@@Z @ 0x1801840C8
 * Callers:
 ...
 *     ?OverlaysEnabled@COverlayContext@@AEBA_NXZ @ 0x180185B6C (-OverlaysEnabled@COverlayContext@@AEBA_NXZ.c)
