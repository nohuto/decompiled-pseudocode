/*
 * XREFs of ??$SetProperty@M@DataSourcePropertySet@@QEAAJIPEBMW4DCOMPOSITION_EXPRESSION_TYPE@@@Z @ 0x1801957C4
 * Callers:
...
__int64 __fastcall DataSourcePropertySet::SetProperty<float>(_QWORD *a1, int a2, _DWORD *a3)
{
  ...
  if ( v12 == a1[1] )
  {
    v6 = PropertySetStorage<DynArrayNoZero,PropertySetUserModeAllocator>::AddProperty<float>((__int64)v5, 18, a3, &v14);
    v7 = v6;
    if ( v6 < 0 )
    {
  ...
  else
  {
    ...
    *(_DWORD *)((*(_DWORD *)(*v5 + 8 * v9 + 4) & 0x1FFFFFFF) + a1[12]) = *a3;
  }
  return 0LL;
}
