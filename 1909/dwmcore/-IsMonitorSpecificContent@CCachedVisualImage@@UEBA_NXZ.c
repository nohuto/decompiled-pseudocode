/*
 * XREFs of ?IsMonitorSpecificContent@CCachedVisualImage@@UEBA_NXZ @ 0x1801C7DD0
 * Callers:
 *     ?IsMonitorSpecificContent@CHwndBitmap@@UEBA_NXZ @ 0x180214E50 (-IsMonitorSpecificContent@CHwndBitmap@@UEBA_NXZ.c)
 * Callees:
