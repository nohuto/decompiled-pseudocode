/*
 * XREFs of ?SetProperty@CKeyframeAnimation@@UEAAJIW4DCOMPOSITION_EXPRESSION_TYPE@@PEBX@Z @ 0x1800BE220
 * Callers:
 *     <none>
 * Callees:
 ...
 *     ?SetPlaybackRate@CKeyframeAnimation@@AEAAXM@Z @ 0x1800D1FF8 (-SetPlaybackRate@CKeyframeAnimation@@AEAAXM@Z.c)
...
LABEL_29:
    ...
    if ( a2 == 29 )
    {
      ...
      if ( v15 >= 1.0 )
      {
          ...
          && TlgKeywordOn((TraceLoggingHProvider)&dword_180337240, 4uLL) )
        {
          ...
          v19 = v13;
          v22 = v13;
          TlgWrite((TraceLoggingHProvider)&dword_180337240, &unk_1802DA77B, 0LL, 0LL, v13, &pData);
        }
      }
      return 0;
    }
  ...
  if ( v16[0] > 0.0 )
  {
      ...
      && TlgKeywordOn((TraceLoggingHProvider)&dword_180337240, 4uLL) )
    {
      ...
      v19 = v11;
      v22 = v11;
      TlgWrite((TraceLoggingHProvider)&dword_180337240, &unk_1802DA739, 0LL, 0LL, v11, &pData);
    }
  }
  return 0;
}
