/*
 * XREFs of ?PushHoverPointer@CHoverPointerSource@@UEAAJAEBUD2D_POINT_2F@@@Z @ 0x1800A80D0
 * Callers:
 *     <none>
 * Callees:
    ...
    if ( v5 )
    {
      ...
      else
      {
        ...
        if ( v9 )
        {
          ...
          v15 = this;
          v11 = v9;
          v2 = CoreUICallSend(v5, &v11, 1LL, 10LL, v10, &unk_1802B1192, (unsigned int)&v15, &v14);
          if ( v2 < 0 )
        ...
        {
          v2 = -2147467259;
          MilInstrumentationCheckHR_MaybeFailFast(v8, 0LL, 0, 0x80004005, 0x4Au, 0LL);
        }
      }
      Microsoft::WRL::ComPtr<ID2DBitmap>::InternalRelease((__int64 *)&v12);
    }
