/*
 * XREFs of ?ComputeLayout@CSurfaceBrush@@QEBAJAEBUD2D_SIZE_F@@_NPEAULayoutData@CContent@@PEAPEAVCShape@@@Z @ 0x18008C790
 * Callers:
        ...
        struct CShape **a5)
{
  ...
  {
    v9 = -2003304441;
    MilInstrumentationCheckHR_MaybeFailFast((__int64)this, (const int *)"\a", 1u, 0x88980007, 0x3B5u, 0LL);
    return v9;
  }
  v57 = 0LL;
  v58 = 0LL;
         ...
         &v58) >= 0 )
  {
    ...
    if ( SwapChainSize < 0 )
    {
      MilInstrumentationCheckHR_MaybeFailFast(v53, (const int *)"\a", 1u, SwapChainSize, 0x3C8u, 0LL);
LABEL_60:
  ...
  *(_QWORD *)&v72.m[1][0] = 0LL;
  LOBYTE(v72.m[2][0]) = 1;
  v29 = CShape::TryOptimizedCombinePaths(
          (CShape *)&v81,
          v28,
          (CShape *)&v73,
          (__int64)v61,
          1,
          (struct CShape **)v72.m[1]);
  v9 = v29;
  if ( v29 < 0 )
  {
  ...
  if ( (v9 & 0x80000000) != 0 )
  {
    MilInstrumentationCheckHR_MaybeFailFast(v31, (const int *)"\a", 1u, v9, 0x40Eu, 0LL);
LABEL_59:
  ...
  {
    v9 = -2003304441;
    MilInstrumentationCheckHR_MaybeFailFast(v33, (const int *)"\a", 1u, 0x88980007, 0x413u, 0LL);
    goto LABEL_59;
  }
  v34 = lpMem;
  v35 = v76;
