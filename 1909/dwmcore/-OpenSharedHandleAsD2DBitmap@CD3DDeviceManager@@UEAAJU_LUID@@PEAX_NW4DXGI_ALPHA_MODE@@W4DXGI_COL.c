/*
 * XREFs of ?OpenSharedHandleAsD2DBitmap@CD3DDeviceManager@@UEAAJU_LUID@@PEAX_NW4DXGI_ALPHA_MODE@@W4DXGI_COLOR_SPACE_TYPE@@MMVDisplayId@@PEAPEAVCD2DBitmap@@@Z @ 0x180053870
 * Callers:
        ...
        _QWORD *a10)
{
  ...
  *a10 = 0LL;
  ...
  if ( D3DDevice < 0 )
  {
    MilInstrumentationCheckHR_MaybeFailFast(v20, &dword_180280CA0, 1u, D3DDevice, 0x666u, 0LL);
    v15 = v27;
    goto LABEL_15;
  }
  v15 = v27;
...
LABEL_25:
    v25 = v18;
LABEL_28:
    MilInstrumentationCheckHR_MaybeFailFast(v17, &dword_180280CA0, 1u, v25, v26, 0LL);
    goto LABEL_15;
  }
  ...
  if ( D2DBitmapInternal < 0 )
    MilInstrumentationCheckHR_MaybeFailFast(v23, &dword_180280CA0, 1u, D2DBitmapInternal, 0x697u, 0LL);
LABEL_15:
  if ( v28 )
