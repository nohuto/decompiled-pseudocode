/*
 * XREFs of ??1?$CQueue@V?$ComPtr@VCManipulationFrame@@@WRL@Microsoft@@@@QEAA@XZ @ 0x1800D815C
 * Callers:
 *     _dynamic_atexit_destructor_for__CGlobalManipulationManager::s_InputQueue__ @ 0x1800F1A40 (_dynamic_atexit_destructor_for__CGlobalManipulationManager--s_InputQueue__.c)
 * Callees:
        ...
        __int64 a3)
{
  ...
  while ( v3 );
  DeleteCriticalSection(&stru_18033D5A8);
}
