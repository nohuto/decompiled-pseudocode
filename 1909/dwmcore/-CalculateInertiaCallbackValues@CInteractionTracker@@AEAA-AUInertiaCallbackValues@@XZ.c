/*
 * XREFs of ?CalculateInertiaCallbackValues@CInteractionTracker@@AEAA?AUInertiaCallbackValues@@XZ @ 0x1801D7C54
 * Callers:
 ...
 *     ?GetScaleAdjustedPositionIfNeeded@CInteractionTracker@@AEBA?AUD2DVector3@@AEBU2@@Z @ 0x1801D92DC (-GetScaleAdjustedPositionIfNeeded@CInteractionTracker@@AEBA-AUD2DVector3@@AEBU2@@Z.c)
...
unsigned int *__fastcall CInteractionTracker::CalculateInertiaCallbackValues(__int64 a1, unsigned int *a2)
{
  ...
  if ( CInteractionTracker::AreInteractionAnimationsAlive((CInteractionTracker *)a1) )
  {
    ...
    *((_BYTE *)a2 + 53) = HasImpulse;
    v8 = (__m128)*(unsigned int *)((*(__int64 (__fastcall **)(__int64))(*(_QWORD *)v7 + 320LL))(v7) + 48);
    v9 = (*(__int64 (__fastcall **)(_QWORD))(**(_QWORD **)(a1 + 336) + 320LL))(*(_QWORD *)(a1 + 336));
    v10 = *(_QWORD *)(a1 + 320);
    v67 = 0;
    *(_QWORD *)a2 = _mm_unpacklo_ps(v8, (__m128)*(unsigned int *)(v9 + 48)).m128_u64[0];
    a2[2] = 0;
    a2[3] = *(_DWORD *)((*(__int64 (__fastcall **)(__int64))(*(_QWORD *)v10 + 320LL))(v10) + 48);
    ...
    *((_QWORD *)a2 + 2) = _mm_unpacklo_ps(v11, v2).m128_u64[0];
    ...
    v13 = *(_QWORD *)(a1 + 328);
    a2[7] = v2.m128_i32[0];
    v14 = (CMotion *)(*(__int64 (__fastcall **)(__int64))(*(_QWORD *)v13 + 320LL))(v13);
    v2.m128_f32[0] = CMotion::GetModifiedRestingValue(v14);
    v15 = v2;
    v16 = (CMotion *)(*(__int64 (__fastcall **)(_QWORD))(**(_QWORD **)(a1 + 336) + 320LL))(*(_QWORD *)(a1 + 336));
    v2.m128_f32[0] = CMotion::GetModifiedRestingValue(v16);
    v17 = *(_QWORD *)(a1 + 320);
    v67 = 0;
    *((_QWORD *)a2 + 4) = _mm_unpacklo_ps(v15, v2).m128_u64[0];
    a2[10] = 0;
    v18 = (CMotion *)(*(__int64 (__fastcall **)(__int64))(*(_QWORD *)v17 + 320LL))(v17);
    ModifiedRestingValue = CMotion::GetModifiedRestingValue(v18);
    v20 = *(_QWORD *)(a1 + 328);
    *((float *)a2 + 12) = ModifiedRestingValue;
    v21 = 1;
    v22 = *(_QWORD *)((*(__int64 (__fastcall **)(__int64))(*(_QWORD *)v20 + 320LL))(v20) + 136);
    if ( v22 )
    ...
    if ( v23 )
    {
      v24 = *(_QWORD *)((*(__int64 (__fastcall **)(_QWORD))(**(_QWORD **)(a1 + 336) + 320LL))(*(_QWORD *)(a1 + 336))
                      + 136);
    ...
    v27 = *(_QWORD *)(a1 + 320);
    *((_BYTE *)a2 + 44) = v26;
    v28 = *(_QWORD *)((*(__int64 (__fastcall **)(__int64))(*(_QWORD *)v27 + 320LL))(v27) + 136);
    if ( v28 )
