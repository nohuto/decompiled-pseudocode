/*
 * XREFs of ?OnRemovedFromDrawList@CGroupDrawListEntry@@UEAAXPEBVCDrawListEntryBatch@@@Z @ 0x1800C14D0
 * Callers:
 *     <none>
 * Callees:
        ...
        __int64 a3)
{
  ...
  CGroupDrawListEntry *v15; // [rsp+40h] [rbp+8h] BYREF
  ...
  *((_DWORD *)this + 4) = v6;
  if ( !v6 )
  {
    ...
    *((_QWORD *)this + 3) = 0LL;
    ...
    {
      if ( v10 <= *(_DWORD *)(v8 + 108) )
      {
        *(_QWORD *)(*(_QWORD *)(v8 + 88) + 8LL * v9) = v15;
        *(_DWORD *)(v8 + 112) = v10;
LABEL_8:
        _InterlockedIncrement((volatile signed __int32 *)v15 + 2);
        return;
      }
      v11 = DynArrayImpl<0>::AddMultipleAndSet(v8 + 88, 8, 1, &v15);
      v13 = v11;
      if ( v11 >= 0 )
        goto LABEL_8;
