/*
 * XREFs of ?EnsureSharedRenderTargets@CMagnifierRenderTarget@@AEAAJXZ @ 0x1801A8740
 * Callers:
...
__int64 __fastcall CMagnifierRenderTarget::EnsureSharedRenderTargets(CMagnifierRenderTarget *this)
{
  ...
  while ( 1 )
  {
    ...
    if ( v2 < 0 )
    {
      MilInstrumentationCheckHR_MaybeFailFast(v9, &dword_1802E1E90, 1u, v2, 0x19Eu, 0LL);
      goto LABEL_15;
    }
LABEL_11:
    v13 = 0LL;
  ...
  MilInstrumentationCheckHR_MaybeFailFast(v6, &dword_1802E1E90, 1u, v5, 0x19Bu, 0LL);
LABEL_15:
  if ( v13 )
