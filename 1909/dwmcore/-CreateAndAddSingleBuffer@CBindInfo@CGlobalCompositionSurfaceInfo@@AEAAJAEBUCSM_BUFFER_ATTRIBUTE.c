/*
 * XREFs of ?CreateAndAddSingleBuffer@CBindInfo@CGlobalCompositionSurfaceInfo@@AEAAJAEBUCSM_BUFFER_ATTRIBUTES@@AEBUCSM_SINGLE_BUFFER_INFO@@@Z @ 0x18025B424
 * Callers:
        ...
        const struct CSM_SINGLE_BUFFER_INFO *a3)
{
  ...
  if ( v4 < 0 )
  {
    MilInstrumentationCheckHR_MaybeFailFast(v5, &dword_180312638, 3u, v4, 0x561u, 0LL);
  }
  else
  {
    ...
    v7 = v8;
    if ( v8 < 0 )
      MilInstrumentationCheckHR_MaybeFailFast(v9, &dword_180312638, 3u, v8, 0x566u, 0LL);
  }
  if ( v6 )
