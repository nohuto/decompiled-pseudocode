/*
 * XREFs of ?AnimateSingle@DirectionAnimator@Particles@@UEBAXAEAV?$span@M$0?0@gsl@@000@Z @ 0x1801E7D90
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall Particles::DirectionAnimator::AnimateSingle(
        ...
        __int64 a5)
{
  void (__fastcall ***v5)(_QWORD, __int64, __int64, _QWORD *); // rcx
  __m128 v7; // xmm3
  __m128 v8; // xmm2
  __m128 v9; // xmm1
  __m128 v10; // xmm3
  ...
  __int32 v18; // [rsp+40h] [rbp-20h]
  unsigned __int32 v19; // [rsp+44h] [rbp-1Ch]
  unsigned __int32 v20; // [rsp+48h] [rbp-18h]
  _QWORD v21[2]; // [rsp+50h] [rbp-10h] BYREF

  v5 = *(void (__fastcall ****)(_QWORD, __int64, __int64, _QWORD *))(a1 + 8);
  v21[1] = &v16;
  v21[0] = 3LL;
  (**v5)(v5, a2, a3, v21);
  ...
  v18 = v10.m128_i32[0];
  v19 = _mm_shuffle_ps(v10, v10, 85).m128_u32[0];
  v16 = __PAIR64__(v19, v10.m128_u32[0]);
  v20 = _mm_shuffle_ps(v10, v10, 170).m128_u32[0];
  v17 = *(float *)&v20;
  v11 = (float *)gsl::span<COverlayContext *,-1>::operator[](a4);
