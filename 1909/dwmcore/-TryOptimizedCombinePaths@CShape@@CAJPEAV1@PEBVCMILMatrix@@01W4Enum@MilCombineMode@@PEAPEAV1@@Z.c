/*
 * XREFs of ?TryOptimizedCombinePaths@CShape@@CAJPEAV1@PEBVCMILMatrix@@01W4Enum@MilCombineMode@@PEAPEAV1@@Z @ 0x18004D4E0
 * Callers:
 ...
 *     ?Is2DAxisAlignedIntegerPreserving@CMILMatrix@@QEBA_N_N@Z @ 0x1800ED97C (-Is2DAxisAlignedIntegerPreserving@CMILMatrix@@QEBA_N_N@Z.c)
 ...
 *     ?CopyRegionShape@CRegionShape@@QEBAJPEBVCMILMatrix@@PEAPEAV1@@Z @ 0x1800EDC98 (-CopyRegionShape@CRegionShape@@QEBAJPEBVCMILMatrix@@PEAPEAV1@@Z.c)
        ...
        struct CShape **a6)
{
  ...
  bool v44; // dl
  struct CShape *v45; // rax
  struct CShape *v46; // rdi
  __int64 v47; // rax
  int v48; // eax
  ...
  CRegionShape *v97; // [rsp+30h] [rbp-D0h] BYREF
...
LABEL_150:
      if ( a5 )
      {
        ...
        if ( a5 == 1 )
        {
          ...
          if ( v83 )
          {
            v82 = (_QWORD *)*((_QWORD *)ObjectCache + 1);
            *((_QWORD *)ObjectCache + 1) = *v82;
            *((_DWORD *)ObjectCache + 1) = v83 - 1;
          }
          if ( v82 || (v82 = DefaultHeap::Alloc(0x48uLL)) != 0LL )
          {
            v82[1] = 0LL;
            *v82 = &CRectanglesShape::`vftable';
            v82[2] = v82 + 6;
            v82[3] = v82 + 6;
            *((_DWORD *)v82 + 8) = 1;
            *(_QWORD *)((char *)v82 + 36) = 1LL;
        ...
        else
        {
          ...
          if ( !a1 || (*(unsigned __int8 (__fastcall **)(CShape *))(*(_QWORD *)a1 + 16LL))(a1) )
          {
            ...
            if ( v80 )
            {
              v79 = (_QWORD *)*((_QWORD *)v78 + 1);
              *((_QWORD *)v78 + 1) = *v79;
              *((_DWORD *)v78 + 1) = v80 - 1;
            }
            if ( v79 || (v79 = DefaultHeap::Alloc(0x48uLL)) != 0LL )
            {
              v79[1] = 0LL;
              *v79 = &CRectanglesShape::`vftable';
              v79[2] = v79 + 6;
              v79[3] = v79 + 6;
              *((_DWORD *)v79 + 8) = 1;
              *(_QWORD *)((char *)v79 + 36) = 1LL;
              `vector constructor iterator'(
                v79 + 6,
                0x10uLL,
                1uLL,
      ...
      {
        if ( !a4 || CShape::IsAxisAlignedRectangle(a3) && CMILMatrix::Is2DAxisAlignedPreserving<1>(a4) )
        {
...
LABEL_148:
    if ( !a3 || (*(unsigned __int8 (__fastcall **)(CShape *))(*(_QWORD *)a3 + 16LL))(a3) )
    {
      ...
      if ( v90 )
      {
        v89 = (_QWORD *)*((_QWORD *)v88 + 1);
        *((_QWORD *)v88 + 1) = *v89;
        *((_DWORD *)v88 + 1) = v90 - 1;
      }
      if ( v89 || (v89 = DefaultHeap::Alloc(0x48uLL)) != 0LL )
      {
        v89[1] = 0LL;
        *v89 = &CRectanglesShape::`vftable';
        v89[2] = v89 + 6;
        v89[3] = v89 + 6;
        *((_DWORD *)v89 + 8) = 1;
        *(_QWORD *)((char *)v89 + 36) = 1LL;
        `vector constructor iterator'(
          v89 + 6,
          0x10uLL,
          1uLL,
...
LABEL_120:
        ...
        *(_QWORD *)&v99.left = 0LL;
        ...
        v70 = FastRegion::CRegion::Copy(
                ...
                (const struct CRegion *)(*(_QWORD *)&v98.left + 16LL));
        v9 = v70;
        if ( v70 < 0 )
        {
          v96 = 758;
        ...
        {
          v9 = -2147024882;
          MilInstrumentationCheckHR_MaybeFailFast(v73, 0LL, 0, -2147024882, 0x309u, 0LL);
LABEL_143:
...
LABEL_142:
  ...
  {
    case 0:
      if ( (unsigned __int8)TMilRect<float,MilRectF,RectUniqueness::NotNeeded>::DoesContain(&v98, &v99) || IsEmpty(&v99) )
      {
      ...
      if ( (unsigned __int8)TMilRect<float,MilRectF,RectUniqueness::NotNeeded>::DoesContain(&v99, &v98) || IsEmpty(&v98) )
      {
        ...
        *v104 = 0;
        ...
        else
        {
          ...
          else
          {
            ...
            {
              v9 = -2147024882;
              MilInstrumentationCheckHR_MaybeFailFast(v62, 0LL, 0, -2147024882, 0x2DFu, 0LL);
LABEL_113:
      ...
      goto LABEL_113;
    case 1:
      TMilRect<float,MilRectF,RectUniqueness::NotNeeded>::IntersectUnsafe(&v98, &v99);
      ...
      {
        v45 = (struct CShape *)DefaultHeap::Alloc(0x60uLL);
        v46 = v45;
        if ( v45 )
        {
          *((_QWORD *)v45 + 3) = 0LL;
          ...
          *((_QWORD *)v45 + 10) = 0LL;
          *((_QWORD *)v45 + 1) = 0LL;
          *(_QWORD *)v45 = &CRegionShape::`vftable';
          *((_QWORD *)v45 + 2) = (char *)v45 + 24;
          *((_DWORD *)v45 + 6) = 0;
          *((_QWORD *)v45 + 11) = 0LL;
        }
        else
        ...
        if ( v46 )
        {
          v47 = CMilRectLFromMilRectF(v100, &v98);
          v48 = CRegionShape::BuildFromRects(v46, v47, 1LL);
          v9 = v48;
          if ( v48 < 0 )
          {
...
LABEL_190:
        v9 = -2147024882;
        MilInstrumentationCheckHR_MaybeFailFast(v43, 0LL, 0, -2147024882, v94, 0LL);
        break;
      }
      ...
      if ( !Value )
      {
        ...
        {
          MilInstrumentationCheckHR_MaybeFailFast(v52, 0LL, 0, -2147024882, 0x42u, 0LL);
      ...
      *a6 = (struct CShape *)v55;
      ...
      break;
    case 2:
      if ( !(unsigned __int8)TMilRect<float,MilRectF,RectUniqueness::NotNeeded>::DoesContain(&v99, &v98)
        && !IsEmpty(&v98) )
      {
          ...
          *v102 = 0;
          ...
          else
          {
            ...
            else
            {
              ...
              {
                v9 = -2147024882;
                MilInstrumentationCheckHR_MaybeFailFast(v38, 0LL, 0, -2147024882, 0x2C2u, 0LL);
LABEL_56:
                FastRegion::CRegion::FreeMemory((FastRegion::CRegion *)&v102);
                FastRegion::CRegion::FreeMemory((FastRegion::CRegion *)&v104);
                break;
      ...
      if ( v42 )
      {
        v41 = (_QWORD *)*((_QWORD *)v40 + 1);
        *((_QWORD *)v40 + 1) = *v41;
        *((_DWORD *)v40 + 1) = v42 - 1;
      }
      if ( v41 || (v41 = DefaultHeap::Alloc(0x48uLL)) != 0LL )
      {
        v41[1] = 0LL;
