/*
 * XREFs of ?SetVisible@CVisual@@QEAAX_N@Z @ 0x180020794
 * Callers:
 ...
 *     ?ProcessSetVisible@CVisual@@QEAAJPEAVCResourceTable@@PEBUtagMILCMD_VISUAL_SETVISIBLE@@@Z @ 0x1801C2C2C (-ProcessSetVisible@CVisual@@QEAAJPEAVCResourceTable@@PEBUtagMILCMD_VISUAL_SETVISIBLE@@@Z.c)
 * Callees:
...
void __fastcall CVisual::SetVisible(CVisual *this, char a2)
{
  ...
  if ( a2 != ((*((_BYTE *)this + 95) & 4) != 0) )
  {
    v2 = (CVisual *)*((_QWORD *)this + 10);
    *((_BYTE *)this + 95) = (4 * a2) | *((_BYTE *)this + 95) & 0xFB;
    if ( v2 )
    {
      if ( a2 )
