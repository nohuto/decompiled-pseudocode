/*
 * XREFs of ?AddVisualTreeDataToList@CVisual@@IEAAXPEAVCVisualTreeData@@@Z @ 0x18007DB88
 * Callers:
 *     ?Link@CVisualTreeData@@MEAAXXZ @ 0x18007DB30 (-Link@CVisualTreeData@@MEAAXXZ.c)
 * Callees:
...
void __fastcall CVisual::AddVisualTreeDataToList(CVisual *this, struct CVisualTreeData *a2)
{
  ...
  if ( !TreeDataListHead )
  {
    ...
    {
      *(_QWORD *)CSparseAlignedStorage<8,8>::AllocatedStorage::ReserveSlot((__int64)this + 224, 1) = TreeDataListHead;
    }
  }
