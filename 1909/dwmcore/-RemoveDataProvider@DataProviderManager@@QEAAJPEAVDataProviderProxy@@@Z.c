/*
 * XREFs of ?RemoveDataProvider@DataProviderManager@@QEAAJPEAVDataProviderProxy@@@Z @ 0x180188220
 * Callers:
 ...
 *     ?OnDisconnected@DataProviderProxy@@MEAAJXZ @ 0x180197A20 (-OnDisconnected@DataProviderProxy@@MEAAJXZ.c)
 * Callees:
