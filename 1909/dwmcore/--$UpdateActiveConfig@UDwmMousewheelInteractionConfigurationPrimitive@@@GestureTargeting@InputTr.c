/*
 * XREFs of ??$UpdateActiveConfig@UDwmMousewheelInteractionConfigurationPrimitive@@@GestureTargeting@InputTraceLogging@@SAXAEBUDwmMousewheelInteractionConfigurationPrimitive@@@Z @ 0x18022D818
 * Callers:
        ...
        __int64 a1)
{
  ...
  if ( *(_DWORD *)v2[1] > 4u )
  {
    ...
    if ( (_BYTE)v2 )
    {
      ...
      v50 = v31;
      v53 = v31;
      LOBYTE(v2) = TlgWrite(v32, &unk_1802DC0DB, 0LL, 0LL, 0x12u, &pData);
    }
  }
  return (char)v2;
}
