/*
 * XREFs of ??1CProjectedShadowScene@@UEAA@XZ @ 0x1800039C0
 * Callers:
 *     ??_GCProjectedShadowScene@@UEAAPEAXI@Z @ 0x180003980 (--_GCProjectedShadowScene@@UEAAPEAXI@Z.c)
 * Callees:
 *     ?ClearReceivers@CProjectedShadowScene@@AEAAXXZ @ 0x180003C34 (-ClearReceivers@CProjectedShadowScene@@AEAAXXZ.c)
