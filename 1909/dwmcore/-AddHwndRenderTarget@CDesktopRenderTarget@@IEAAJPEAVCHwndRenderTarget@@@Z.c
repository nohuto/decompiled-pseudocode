/*
 * XREFs of ?AddHwndRenderTarget@CDesktopRenderTarget@@IEAAJPEAVCHwndRenderTarget@@@Z @ 0x18002819C
 * Callers:
...
LABEL_12:
  ...
  if ( (unsigned int)DynArray<CHwndRenderTarget *,0>::Remove((char *)this + 176, &v14) )
  ...
  else
  {
    ...
    if ( v9 + 1 >= v9 )
    {
      ...
      v12 = DynArrayImpl<0>::AddMultipleAndSet((char *)this + 176, 8LL, 1LL, &v14);
      v6 = v12;
      if ( v12 < 0 )
