/*
 * XREFs of ?CaptureCurrentManipulation@CInteractionProcessor@@QEAAXI_K@Z @ 0x18022EA84
 * Callers:
 *     ?CaptureCurrentManipulation@CInteraction@@UEAAXI_K@Z @ 0x1801D5750 (-CaptureCurrentManipulation@CInteraction@@UEAAXI_K@Z.c)
 * Callees:
  ...
  *((_QWORD *)this + 104) = a3;
  if ( dword_180337240 > 4u )
  {
    if ( TlgKeywordOn((TraceLoggingHProvider)&dword_180337240, 2uLL) )
    {
      ...
      v10 = 4LL;
      v12 = 8LL;
      TlgWrite(v3, &unk_1802DC55E, 0LL, 0LL, 5u, &pData);
    }
  }
}
