/*
 * XREFs of ?ReadTexture@CColorKeyBitmap@@QEAAXXZ @ 0x180256860
 * Callers:
 *     ?ReadTexture@CColorKeyBitmapRealization@@UEAAXXZ @ 0x1802555C0 (-ReadTexture@CColorKeyBitmapRealization@@UEAAXXZ.c)
 * Callees:
