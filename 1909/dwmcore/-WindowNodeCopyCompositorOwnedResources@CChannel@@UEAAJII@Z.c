/*
 * XREFs of ?WindowNodeCopyCompositorOwnedResources@CChannel@@UEAAJII@Z @ 0x1800D5AC0
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall CChannel::WindowNodeCopyCompositorOwnedResources(CChannel *this, unsigned int a2, unsigned int a3)
{
  unsigned int v6; // ebx
  ...
  CChannel::CheckHandle((__int64)this, a3, 197);
  v8[0] = 517;
  v8[1] = a2;
  v8[2] = a3;
