/*
 * XREFs of ?CreateRenderingEffect@CCommonRenderingEffectFactory@@UEAAJV?$span@PEBVCDrawListBrush@@$0?0@gsl@@PEAPEAVCRenderingEffect@@@Z @ 0x180038FF0
 * Callers:
 *     <none>
 * Callees:
 ...
 *     ??0CDrawListBitmap@@QEAA@AEBV0@@Z @ 0x18003A340 (--0CDrawListBitmap@@QEAA@AEBV0@@Z.c)
...
__int64 __fastcall CCommonRenderingEffectFactory::CreateRenderingEffect(__int64 a1, __int64 a2, _QWORD *a3)
{
  ...
  if ( v10 || (v10 = (char *)DefaultHeap::Alloc(0x48uLL)) != 0LL )
  {
    ...
    *((_WORD *)v10 + 34) = 257;
    ...
    if ( *((_QWORD *)v10 + 6) != v22 )
    {
      ...
      v41 = *((_QWORD *)v10 + 6);
      *((_QWORD *)v10 + 6) = v22;
      Microsoft::WRL::ComPtr<ID3D11Device5>::InternalRelease(&v41);
    }
    v23 = v42;
    v10[56] = *((_BYTE *)v11 + 16);
    *((_WORD *)v10 + 32) = *v23;
  ...
  if ( (v5 & 1) != 0 )
  {
    Microsoft::WRL::ComPtr<ID3D11Device5>::InternalRelease(&v56);
