/*
 * XREFs of ?ConvertInnerToOuterBounds@CVisual@@IEAAJPEBVCVisualTree@@@Z @ 0x180082C60
 * Callers:
...
LABEL_129:
  ...
  else
  {
    ...
    v38 = *((float *)this + 40);
    v39 = (unsigned int)(v38 <= *((float *)this + 39)) + 1;
    if ( *((float *)this + 37) > *(float *)v34 )
      v39 = v38 <= *((float *)this + 39);
    v40 = v39 + 1;
    ...
    if ( v40 <= 1 )
    {
      ...
      else
      {
        ...
        {
          v41 = (char *)(v39 - 224);
          if ( *(struct CVisualTree **)(v39 + 32) == v4 )
            break;
          v39 = *(_QWORD *)v39;
          if ( (__int64 *)v39 == TreeDataListHead )
            goto LABEL_91;
        }
      }
      if ( !v41 )
...
LABEL_91:
        if ( *((_QWORD *)this + 10)
          && ((*((_BYTE *)this + 94) & 4) != 0 && CMILMatrix::Is2DAxisAlignedPreserving<1>((__int64)&v78)
               ...
               *v65 && (*(__int64 (__fastcall **)(_QWORD))(*(_QWORD *)**v65 + 192LL))(**v65))) )
        {
          ...
          if ( (_BYTE)v87 )
          {
            if ( !v70 )
            {
              v71 = (struct _LIST_ENTRY *)*((_QWORD *)this + 10);
              v86 = 0;
              CVisual::GetWorldTransform(v71, (__int64)v4, 1, (__int64)v85, 0LL, 0LL);
              if ( CMILMatrix::Invert((CMILMatrix *)v85) )
              {
                ...
                v81 = v76;
                v82 = (int)Matrix;
                if ( (unsigned __int8)CMILMatrix::IsIdentity<1>(&v78) )
                  goto LABEL_119;
...
LABEL_121:
            ...
            *(_QWORD *)((char *)this + 156) = qword_180338DA0;
          }
        }
        else
        {
          ...
          v86 = 0;
          LOBYTE(v87) = 0;
          CVisual::CalcEffectiveTransform(this, 5LL, 0LL, &v87, v83, 0LL, v85);
          if ( (_BYTE)v87 )
          {
            v77 = v85;
            goto LABEL_124;
...
LABEL_125:
      ...
      v42 = 0;
      TreeData = 0LL;
      v44 = *(_QWORD *)(*((_QWORD *)this + 2) + 384LL);
      if ( (**((_DWORD **)this + 28) & 0x800000) != 0 )
      {
        v45 = CSparseAlignedStorage<8,8>::AllocatedStorage::FindSlot(*((_QWORD *)this + 28), 9LL);
        v47 = *(unsigned int *)(v46 + 4);
        v48 = v45 >= (unsigned int)v47 ? 0LL : (__int64 *)(v47 + 15 + v46 + 8LL * v45 - (((_BYTE)v47 + 15) & 7));
        v39 = *v48;
        if ( *v48 )
        {
          v50 = (CVisual *)(*(__int64 (__fastcall **)(_QWORD))(**(_QWORD **)v39 + 192LL))(*(_QWORD *)v39);
          if ( v50 && ((v41[16] & 4) == 0 || *((_QWORD *)v41 + 27) != v44) )
          {
            v4 = v88;
...
LABEL_73:
      if ( this != *((CVisual **)v4 + 3) )
      {
        ...
        if ( *((_BYTE *)v4 + 32) )
        {
          TreeData = (__int64 **)(v39 + 328);
        }
        else
        {
          v51 = (__int64 *)CVisual::GetTreeDataListHead((CVisual *)v39);
          if ( v51 )
          {
            v39 = *v51;
            if ( (__int64 *)*v51 != v51 )
            {
              while ( *(struct CVisualTree **)(v39 + 32) != v4 )
              {
                v39 = *(_QWORD *)v39;
                if ( (__int64 *)v39 == v51 )
                  goto LABEL_82;
              }
              TreeData = (__int64 **)(v39 - 224);
            }
          }
        }
      }
...
LABEL_83:
      v52 = (unsigned __int64)TreeData[15];
LABEL_85:
      if ( *((_QWORD *)v41 + 15) >= v52
        || (updated = CVisual::UpdateWorldTransform(
                        this,
                        (CVisual **)v4,
                        (struct CTreeData *)v41,
                        v42,
            ...
            updated >= 0) )
      {
        ...
        {
          MilInstrumentationCheckHR_MaybeFailFast(v39, 0LL, 0, 0x88982F04, 0x65u, 0LL);
          MilInstrumentationCheckHR_MaybeFailFast(v61, 0LL, 0, 0x88982F04, 0x76Fu, 0LL);
        }
      }
      else
      {
        MilInstrumentationCheckHR_MaybeFailFast(v39, 0LL, 0, updated, 0x80Bu, 0LL);
