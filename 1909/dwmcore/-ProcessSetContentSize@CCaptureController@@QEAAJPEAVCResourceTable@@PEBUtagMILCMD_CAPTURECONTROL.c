/*
 * XREFs of ?ProcessSetContentSize@CCaptureController@@QEAAJPEAVCResourceTable@@PEBUtagMILCMD_CAPTURECONTROLLER_SETCONTENTSIZE@@@Z @ 0x1801CD83C
 * Callers:
        ...
        const struct tagMILCMD_CAPTURECONTROLLER_SETCONTENTSIZE *a3)
{
  ...
  *((_DWORD *)this + 28) = v5;
  while ( v4 != v6 )
  {
    v7 = *v4++;
    v8 = *((float *)this + 28);
    *(_DWORD *)(v7 + 88) = (int)*((float *)this + 27);
    *(_DWORD *)(v7 + 92) = (int)v8;
  }
  return 0LL;
}
