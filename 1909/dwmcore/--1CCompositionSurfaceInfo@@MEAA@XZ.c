/*
 * XREFs of ??1CCompositionSurfaceInfo@@MEAA@XZ @ 0x1800C2820
 * Callers:
 ...
 *     ?RemoveFromSurfaceMap@CCompositionSurfaceManager@@IEAA_NU_LUID@@@Z @ 0x1800C29CC (-RemoveFromSurfaceMap@CCompositionSurfaceManager@@IEAA_NU_LUID@@@Z.c)
 */
