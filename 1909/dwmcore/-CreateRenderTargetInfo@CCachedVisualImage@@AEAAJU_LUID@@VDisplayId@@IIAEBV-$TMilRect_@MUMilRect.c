/*
 * XREFs of ?CreateRenderTargetInfo@CCachedVisualImage@@AEAAJU_LUID@@VDisplayId@@IIAEBV?$TMilRect_@MUMilRectF@@UMilPointAndSizeF@@UNotNeeded@RectUniqueness@@@@W4Enum@MilStretch@@PEAURenderTargetBitmapInfo@1@@Z @ 0x1800BEBE8
 * Callers:
        ...
        __int64 a8)
{
  ...
  if ( a4 && a5 )
  {
    ...
    {
      MilInstrumentationCheckHR_MaybeFailFast(v20, &dword_1802BE3B0, 1u, RenderTargetBitmap, 0x4AFu, 0LL);
    }
    else
    {
      ...
      if ( v21 < 0 )
      {
        MilInstrumentationCheckHR_MaybeFailFast(v22, &dword_1802BE3B0, 1u, v21, 0x4B2u, 0LL);
        v13 = v24;
      }
      else
      {
