/*
 * XREFs of PopulateSamplerArguments @ 0x1800329FC
 * Callers:
...
__int64 __fastcall PopulateSamplerArguments(__int64 a1, __int64 a2, unsigned int a3, _BYTE *a4, __int64 a5)
{
  ...
  if ( v9[22] || v9[18] )
  {
    ...
    *(_WORD *)&v23[14] = (unsigned __int8)(v15 + 48);
    v22 = 0LL;
    appended = CShaderLinkingGraphBuilder::AppendNode(a1, a3 | 0x300, (__int64)byte_18028123E, a5, (__int64)v23, &v22);
    v11 = appended;
    if ( appended < 0 )
    {
  ...
  if ( (v9[20] || v9[19])
    && (v18 = a4[4],
        ...
        v22 = 0LL,
        v19 = CShaderLinkingGraphBuilder::AppendNode(a1, v8, (__int64)byte_18028123E, a5, (__int64)v23, &v22),
        v11 = v19,
        v19 < 0) )
  {
