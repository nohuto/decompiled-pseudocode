/*
 * XREFs of ?Init@CDirectFlipInfo@@QEAAXPEAVCOverlayContext@@PEAVIRenderTarget@@PEBVCVisual@@PEAVCCompositionSurfaceInfo@@PEAVISwapChainContent@@W4Enum@DirectFlipMode@@PEBVCRegion@@@Z @ 0x1801932A4
 * Callers:
 ...
 *     ??0CDirectFlipInfo@@QEAA@AEBV0@@Z @ 0x180192524 (--0CDirectFlipInfo@@QEAA@AEBV0@@Z.c)
 * Callees:
