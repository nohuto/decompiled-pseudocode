/*
 * XREFs of ?RemoveAllChildren@CVisual@@IEAAXXZ @ 0x180078CC0
 * Callers:
 *     ??1CVisual@@MEAA@XZ @ 0x180077D38 (--1CVisual@@MEAA@XZ.c)
 *     ?ProcessRemoveAllChildren@CVisual@@QEAAJPEBVCResourceTable@@PEBUtagMILCMD_VISUAL_REMOVEALLCHILDREN@@@Z @ 0x1801C284C (-ProcessRemoveAllChildren@CVisual@@QEAAJPEBVCResourceTable@@PEBUtagMILCMD_VISUAL_REMOVEALLCHILDR.c)
 * Callees:
...
void __fastcall CVisual::RemoveAllChildren(CVisual *this)
{
  ...
  if ( (_DWORD)v3 )
  {
    ...
    do
    {
      ...
      if ( v9 )
      {
        CVisual::NotifyMidManipulationUpdate(this, 3LL, v9);
        v12 = *(_BYTE *)(v11 + 272);
        *(_QWORD *)(v11 + 80) = 0LL;
        ...
        if ( v6 >= v16 )
        {
          MilInstrumentationCheckHR_MaybeFailFast((__int64)v15, 0LL, 0, 0x80070057, 0x139u, 0LL);
        }
        else if ( v16 == 1 )
        {
          *v1 = 1LL;
