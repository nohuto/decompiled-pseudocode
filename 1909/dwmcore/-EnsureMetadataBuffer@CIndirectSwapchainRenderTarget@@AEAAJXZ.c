/*
 * XREFs of ?EnsureMetadataBuffer@CIndirectSwapchainRenderTarget@@AEAAJXZ @ 0x180193C34
 * Callers:
...
__int64 __fastcall CIndirectSwapchainRenderTarget::EnsureMetadataBuffer(CIndirectSwapchainRenderTarget *this)
{
  ...
  *((_DWORD *)this + 124) = 0;
  ...
  if ( v4 < 0 )
  {
    MilInstrumentationCheckHR_MaybeFailFast(v5, 0LL, 0, v4, 0x21Du, 0LL);
  }
  else
  {
    ...
    if ( v7 < 0 )
    {
      MilInstrumentationCheckHR_MaybeFailFast(v8, 0LL, 0, v7, 0x21Eu, 0LL);
    }
    else if ( *((_BYTE *)this + 267)
           && (v18 = 4, v9 = DynArray<unsigned char,0>::AddMultipleAndSet((__int64)v1, &v18, 4u), v6 = v9, v9 < 0) )
    {
      MilInstrumentationCheckHR_MaybeFailFast(v10, 0LL, 0, v9, 0x224u, 0LL);
    }
    else if ( *((_BYTE *)this + 506)
           || (v18 = 2, v11 = DynArray<unsigned char,0>::AddMultipleAndSet((__int64)v1, &v18, 4u), v6 = v11, v11 >= 0) )
    {
      ...
      {
        MilInstrumentationCheckHR_MaybeFailFast(v14, 0LL, 0, v13, 0x230u, 0LL);
      }
      else if ( *((_BYTE *)this + 504) )
      {
        v18 = 0;
    ...
    {
      MilInstrumentationCheckHR_MaybeFailFast(v12, 0LL, 0, v11, 0x22Au, 0LL);
    }
  }
  return v6;
}
