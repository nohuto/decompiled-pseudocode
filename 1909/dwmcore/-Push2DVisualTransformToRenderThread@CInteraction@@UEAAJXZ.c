/*
 * XREFs of ?Push2DVisualTransformToRenderThread@CInteraction@@UEAAJXZ @ 0x1801D6050
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall CInteraction::Push2DVisualTransformToRenderThread(CInteraction *this)
{
  ...
  if ( v7 )
  {
    ...
    LOWORD(v13) = 3;
    v15[3] = v11;
    ManipulationManager = CoreUICallSend(v18, &v20, 1LL, 10LL, v13, &unk_1802B118A, (unsigned int)&v19, v15);
    v5 = ManipulationManager;
    if ( ManipulationManager >= 0 )
    {
