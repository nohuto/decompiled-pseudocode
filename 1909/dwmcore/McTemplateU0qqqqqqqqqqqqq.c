/*
 * XREFs of McTemplateU0qqqqqqqqqqqqq @ 0x18017219C
 * Callers:
...
ULONG __fastcall McTemplateU0qqqqqqqqqqqqq(
        __int64 a1,
        __int64 a2,
        __int64 a3,
        int a4,
        ...
        char a15)
{
  ...
  v40 = 4LL;
  v42 = 4LL;
  return McGenEventWrite(Microsoft_Windows_Dwm_Core_Provider_Context, &ENDFRAME_DRAWLIST_BATCH_STATS, a3, 0xEu, &v16);
}
