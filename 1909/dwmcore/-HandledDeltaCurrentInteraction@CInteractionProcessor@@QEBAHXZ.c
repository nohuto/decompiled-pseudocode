/*
 * XREFs of ?HandledDeltaCurrentInteraction@CInteractionProcessor@@QEBAHXZ @ 0x18023040C
 * Callers:
 *     ?HandledDeltaCurrentInteraction@CInteraction@@UEBAHXZ @ 0x1801D5A40 (-HandledDeltaCurrentInteraction@CInteraction@@UEBAHXZ.c)
 *     ?HandledDeltaCurrentInteraction@CInteractionRoot@@UEBAHXZ @ 0x18023B220 (-HandledDeltaCurrentInteraction@CInteractionRoot@@UEBAHXZ.c)
 * Callees:
