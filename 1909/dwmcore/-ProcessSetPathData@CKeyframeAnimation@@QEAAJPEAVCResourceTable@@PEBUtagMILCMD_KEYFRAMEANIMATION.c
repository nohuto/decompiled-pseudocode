/*
 * XREFs of ?ProcessSetPathData@CKeyframeAnimation@@QEAAJPEAVCResourceTable@@PEBUtagMILCMD_KEYFRAMEANIMATION_SETPATHDATA@@PEBXI@Z @ 0x1801E0048
 * Callers:
...
LABEL_34:
  ...
  else
  {
    ...
    {
      MilInstrumentationCheckHR_MaybeFailFast(v13, 0LL, 0, D2DFactoryNoRef, 0x287u, 0LL);
    }
    else
    {
      v15 = 0;
