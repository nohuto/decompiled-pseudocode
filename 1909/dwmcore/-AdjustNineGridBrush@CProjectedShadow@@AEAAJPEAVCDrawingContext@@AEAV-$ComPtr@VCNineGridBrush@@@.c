/*
 * XREFs of ?AdjustNineGridBrush@CProjectedShadow@@AEAAJPEAVCDrawingContext@@AEAV?$ComPtr@VCNineGridBrush@@@WRL@Microsoft@@@Z @ 0x1801EE4B8
 * Callers:
...
__int64 __fastcall CProjectedShadow::AdjustNineGridBrush(__int64 a1, __int64 a2, CNineGridBrush **a3)
{
  ...
  *(_QWORD *)&v25.m11 = 0xC2800000C2800000uLL;
  ...
  v13 = ((__int64 (__fastcall *)(char *, void *, float *))xmmword_180336248)(
          (char *)v12 + SDWORD2(xmmword_180336248),
  ...
  v16 = ((__int64 (__fastcall *)(char *, void *, struct D2D_MATRIX_3X2_F *))xmmword_180336280)(
          (char *)v12 + SDWORD2(xmmword_180336280),
