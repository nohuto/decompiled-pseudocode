/*
 * XREFs of ?SendUnpresentedFramesAlarmTelemetry@CTelemetryFrameStatistics@@AEAAX_K@Z @ 0x18001F464
 * Callers:
        ...
        __int64 a2)
{
  ...
  if ( dword_1803371D0 > 5u && TlgKeywordOn((TraceLoggingHProvider)&dword_1803371D0, 0x400000000000uLL) )
  {
    ...
    v7 = 4;
    v10 = 4;
    TlgWrite((TraceLoggingHProvider)&dword_1803371D0, &unk_1802D93F5, 0LL, 0LL, 4u, &pData);
  }
  *((_DWORD *)this + 6) = 0;
  *((_QWORD *)this + 1) = a2;
}
