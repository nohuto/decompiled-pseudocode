/*
 * XREFs of ?CreateManipulationThread@CGlobalManipulationManager@@EEAAJXZ @ 0x1800DFEF0
 * Callers:
 *     <none>
 * Callees:
...
LABEL_8:
    v6 = v3;
LABEL_10:
    MilInstrumentationCheckHR_MaybeFailFast((__int64)this, &dword_1802BFC90, 2u, v6, dwCreationFlags, 0LL);
    return v3;
  }
