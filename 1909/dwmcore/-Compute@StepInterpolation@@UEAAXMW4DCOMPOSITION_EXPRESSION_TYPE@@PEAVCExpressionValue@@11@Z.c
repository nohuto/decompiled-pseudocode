/*
 * XREFs of ?Compute@StepInterpolation@@UEAAXMW4DCOMPOSITION_EXPRESSION_TYPE@@PEAVCExpressionValue@@11@Z @ 0x1800BD5B0
 * Callers:
 *     <none>
 * Callees:
        ...
        struct _D3DCOLORVALUE *a6)
{
  ...
  if ( !v14 )
    return KeyframeInterpolation::ExpressionValueLerp((unsigned int)a3, v9, a4, a5, a6);
  v17 = (unsigned int)(v14 - 1);
  if ( !(_DWORD)v17 )
    return KeyframeInterpolation::InterpolateSpherical(v17, (unsigned int)a3, a4, a5, a6);
  v18 = (unsigned int)(v17 - 1);
  if ( !(_DWORD)v18 )
    return KeyframeInterpolation::InterpolateHsl(v18, v9, a4, a5, a6);
  v19 = v18 - 1;
  if ( !v19 )
