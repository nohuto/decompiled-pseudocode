/*
 * XREFs of ?GetD2DGeometry@CRectanglesShape@@UEBAJPEBVCMILMatrix@@PEAPEAUID2D1Geometry@@@Z @ 0x1802499F0
 * Callers:
      ...
      else
      {
        ...
        else
        {
          for ( i = 0; i < *((_DWORD *)this + 10); ++i )
          {
            ...
            v30 = v18;
            v32 = v17;
            CMILMatrix::Transform(a2, (const struct MilPoint2F *)&v26, (struct MilPoint2F *)v34);
