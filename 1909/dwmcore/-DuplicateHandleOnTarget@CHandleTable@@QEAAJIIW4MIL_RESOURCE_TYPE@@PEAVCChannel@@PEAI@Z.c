/*
 * XREFs of ?DuplicateHandleOnTarget@CHandleTable@@QEAAJIIW4MIL_RESOURCE_TYPE@@PEAVCChannel@@PEAI@Z @ 0x1800C9D08
 * Callers:
...
__int64 __fastcall CHandleTable::DuplicateHandleOnTarget(__int64 a1, int a2, int a3, int a4, CChannel *a5, _DWORD *a6)
{
  ...
  else
  {
    ...
    {
      v12 = -2147024890;
      MilInstrumentationCheckHR_MaybeFailFast(v14, 0LL, 0, 0x80070006, 0x112u, 0LL);
    }
  }
