/*
 * XREFs of ?PinResources@CD3DDeviceLevel1@@QEAAJPEAPEAUIDXGIResource@@I@Z @ 0x18015C780
 * Callers:
 ...
 *     ?IsSameResource@CUnpinResource@CD3DDeviceLevel1@@QEBA_NPEBUIDXGIResource@@@Z @ 0x1800EAF90 (-IsSameResource@CUnpinResource@CD3DDeviceLevel1@@QEBA_NPEBUIDXGIResource@@@Z.c)
 *     ?erase@?$vector_facade@VCUnpinResource@CD3DDeviceLevel1@@V?$buffer_impl@VCUnpinResource@CD3DDeviceLevel1@@$06$00Vliberal_expansion_policy@detail@@@detail@@@detail@@QEAA?AV?$basic_iterator@VCUnpinResource@CD3DDeviceLevel1@@@2@V?$basic_iterator@$$CBVCUnpinResource@CD3DDeviceLevel1@@@2@@Z @ 0x1800EB450 (-erase@-$vector_facade@VCUnpinResource@CD3DDeviceLevel1@@V-$buffer_impl@VCUnpinResource@CD3DDevi.c)
 ...
 *     ??$min@I@@YAIII@Z @ 0x18015A208 (--$min@I@@YAIII@Z.c)
 */
...
__int64 __fastcall CD3DDeviceLevel1::PinResources(CD3DDeviceLevel1 *this, struct IDXGIResource **a2, unsigned int a3)
{
  ...
  if ( v4 < 0 )
  {
    MilInstrumentationCheckHR_MaybeFailFast((__int64)this, &dword_1802BE2AC, 1u, v4, 0xF89u, 0LL);
    v14 = v25;
  }
  else
  {
...
LABEL_9:
    ...
    if ( v15 )
    {
      ...
      MilInstrumentationCheckHR_MaybeFailFast(v19, &dword_1802BE2AC, 1u, v18, 0xFB4u, 0LL);
    }
  }
LABEL_17:
  if ( v4 < 0 && v3 )
