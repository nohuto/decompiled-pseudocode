        ...
        __int64 **a4)
{
  ...
  v6 = *(_QWORD *)qword_18033D078;
  v7 = *(_QWORD **)(*(_QWORD *)qword_18033D078 + 8LL);
  v8 = std::_List_alloc<std::_List_base_types<std::pair<CResource const * const,CWeakResourceReference *>>>::_Buynode0(
         a1,
         *(_QWORD **)qword_18033D078,
         v7);
  v9 = **a4;
  v8[3] = 0LL;
  v8[2] = v9;
  if ( qword_18033D080 == 0x7FFFFFFFFFFFFFELL )
