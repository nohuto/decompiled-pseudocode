/*
 * XREFs of ?DiscardRectangle@CHwDisplayRenderTarget@@UEAAXAEBUMilRectF@@@Z @ 0x1800BCD90
 * Callers:
 *     ?DiscardRectangle@CHwDisplayRenderTarget@@WJA@EAAXAEBUMilRectF@@@Z @ 0x1800F0490 (-DiscardRectangle@CHwDisplayRenderTarget@@WJA@EAAXAEBUMilRectF@@@Z.c)
 * Callees:
