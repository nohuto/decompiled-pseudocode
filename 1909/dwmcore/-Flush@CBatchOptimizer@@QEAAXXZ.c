/*
 * XREFs of ?Flush@CBatchOptimizer@@QEAAXXZ @ 0x180058AB0
 * Callers:
...
void __fastcall CBatchOptimizer::Flush(unsigned __int64 this)
{
  ...
  if ( v2 )
  {
    ...
    {
      v4 = i + 520LL * *(int *)(i + 48);
      v5 = *(void (__fastcall ****)(_QWORD))(v4 + 112);
      v6 = *(_DWORD *)(v4 + 96);
      ...
      if ( v5 )
      {
        ...
        if ( v8 )
        {
          wil::com_ptr_t<CRenderingEffect,wil::err_returncode_policy>::operator=((__int64 *)(v8 + 24), v5);
      ...
      if ( !v7 && v6 )
      {
        ((void (__fastcall *)(unsigned __int64, void (__fastcall ***)(_QWORD), _QWORD))`gsl::details::get_terminate_handler'::`2'::handler)(
          this,
          v5,
          v6);
        __debugbreak();
