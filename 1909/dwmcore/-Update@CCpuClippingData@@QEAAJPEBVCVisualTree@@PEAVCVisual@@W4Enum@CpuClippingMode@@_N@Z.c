/*
 * XREFs of ?Update@CCpuClippingData@@QEAAJPEBVCVisualTree@@PEAVCVisual@@W4Enum@CpuClippingMode@@_N@Z @ 0x180060C00
 * Callers:
...
LABEL_91:
  ...
  *((_BYTE *)a1 + 76) = a5;
  if ( !v16 || *(_DWORD *)v16 == 5 || (unsigned __int64)v16[4] <= *((_QWORD *)a1 + 4) || v17 - 1 > 1 )
  {
    if ( !v10 )
      goto LABEL_21;
  }
  ...
  if ( v17 != 5 )
  {
    ...
    CVisual::CalcEffectiveTransform(a3, *a1, v20, &a5, *((_QWORD *)a1 + 2), a2, v21);
