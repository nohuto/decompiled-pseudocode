/*
 * XREFs of ?GetIntersectingRedrawRects@CDirtyRegion@@QEBAXAEBUMilRectF@@PEBVCVisualTree@@PEBVCOcclusionContext@@PEAV?$DynArray@UMilRectF@@$0A@@@@Z @ 0x18017682C
 * Callers:
 *     ?GetIntersectingRedrawRects@CHwndRenderTarget@@UEBAXAEBUMilRectF@@PEBVCVisualTree@@PEBVCOcclusionContext@@PEAV?$DynArray@UMilRectF@@$0A@@@@Z @ 0x1801A7830 (-GetIntersectingRedrawRects@CHwndRenderTarget@@UEBAXAEBUMilRectF@@PEBVCVisualTree@@PEBVCOcclusio.c)
 * Callees:
