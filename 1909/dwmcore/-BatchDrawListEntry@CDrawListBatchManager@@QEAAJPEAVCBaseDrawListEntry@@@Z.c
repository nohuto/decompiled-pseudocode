/*
 * XREFs of ?BatchDrawListEntry@CDrawListBatchManager@@QEAAJPEAVCBaseDrawListEntry@@@Z @ 0x1801AB9B0
 * Callers:
        ...
        struct CBaseDrawListEntry *a2)
{
  ...
  if ( v2 < 0 )
  {
    MilInstrumentationCheckHR_MaybeFailFast(v3, 0LL, 0, v2, 0x8Au, 0LL);
  }
  else
  {
