/*
 * XREFs of ??0DataSourceProxy@@QEAA@XZ @ 0x18024F640
 * Callers:
 ...
 * Callees:
 *     ?_Buynode0@?$_List_alloc@U?$_List_base_types@U?$pair@$$CBII@std@@V?$allocator@U?$pair@$$CBII@std@@@2@@std@@@std@@QEAAPEAU?$_List_node@U?$pair@$$CBII@std@@PEAX@2@PEAU32@0@Z @ 0x180196F08 (-_Buynode0@-$_List_alloc@U-$_List_base_types@U-$pair@$$CBII@std@@V-$allocator@U-$pair@$$CBII@std.c)
