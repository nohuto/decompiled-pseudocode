/*
 * XREFs of ?BuildInteractionChainAndUpdateTree@CManipulationContext@@SAXPEAVCVisualTree@@PEAVCInteraction@@IW4InputType@@_NPEAVCInteractionChain@@PEA_N@Z @ 0x18023A674
 * Callers:
 ...
 *     ?GetInputHandle@CInteraction@@QEBAPEAXXZ @ 0x1801D5830 (-GetInputHandle@CInteraction@@QEBAPEAXXZ.c)
 ...
 *     ?IsStrictlyHoverPointerSource@CInteraction@@QEBA_NXZ @ 0x18023B5F0 (-IsStrictlyHoverPointerSource@CInteraction@@QEBA_NXZ.c)
