/*
 * XREFs of ?Add@?$CMergedRectBase@$01@@QEAAXAEBV?$TMilRect_@MUMilRectF@@UMilPointAndSizeF@@UNotNeeded@RectUniqueness@@@@@Z @ 0x180182378
 * Callers:
  ...
  if ( !result )
  {
    ...
    do
    {
      if ( *v9 )
      {
        ...
        {
          v17 = *v10;
          TMilRect<float,MilRectF,RectUniqueness::NotNeeded>::UnionUnsafe((float *)&v17, p_left);
          ...
          v14 = TMilRect<float,MilRectF,RectUniqueness::NotNeeded>::AreaUnsafe((__int64)a2);
          v16 = v15 - *(float *)&v14;
          if ( v5 > v16 )
          {
            v5 = v16;
