/*
 * XREFs of ?CalculateValueWorker@CConditionalExpression@@UEAAJPEAVCExpressionValueStack@@_KPEA_N@Z @ 0x1801D2C00
 * Callers:
 *     <none>
 * Callees:
    ...
    if ( v10 == 1 )
    {
      ...
      if ( v12 )
      {
        do
        {
          ...
          if ( v13 < 0 )
          {
            MilInstrumentationCheckHR_MaybeFailFast(v14, 0LL, 0, v13, 0x117u, 0LL);
            goto LABEL_23;
          }
          if ( v39 )
          {
            ...
            if ( v17 < 0 )
            {
              MilInstrumentationCheckHR_MaybeFailFast((__int64)v18, 0LL, 0, v17, 0x11Eu, 0LL);
              goto LABEL_23;
            }
            ...
            if ( v19 < 0 )
            {
              MilInstrumentationCheckHR_MaybeFailFast(v20, 0LL, 0, v19, 0x11Fu, 0LL);
              goto LABEL_23;
            }
          }
          else
        ...
        MilInstrumentationCheckHR_MaybeFailFast(v22, 0LL, 0, v21, 0x133u, 0LL);
LABEL_23:
        v27 = v41;
        if ( v41 )
        {
...
LABEL_17:
        ...
        if ( v23 )
        {
          v24 = (*(__int64 (__fastcall **)(__int64, struct CExpressionValueStack *, unsigned __int64, bool *))(*(_QWORD *)v23 + 248LL))(
                  v23,
                  a2,
                  a3,
                  a4);
          v9 = v24;
          if ( v24 < 0 )
            MilInstrumentationCheckHR_MaybeFailFast(v25, 0LL, 0, v24, 0x128u, 0LL);
        }
        else
        {
          v9 = 1;
...
LABEL_25:
  ...
  else
  {
    ...
    {
      MilInstrumentationCheckHR_MaybeFailFast(v29, 0LL, 0, IsAnyConditionSatisfied, 0xECu, 0LL);
    }
    else
    {
      v30 = *((int *)this + 89);
      if ( (int)v30 < 0 )
      {
        ...
        if ( v34 )
        {
          v35 = (*(__int64 (__fastcall **)(__int64, struct CExpressionValueStack *, unsigned __int64, bool *))(*(_QWORD *)v34 + 248LL))(
                  v34,
                  a2,
                  a3,
                  a4);
          v9 = v35;
          if ( v35 < 0 )
            MilInstrumentationCheckHR_MaybeFailFast(v36, 0LL, 0, v35, 0xF4u, 0LL);
        }
        else
        {
          return 1;
      ...
      else
      {
        ...
        v32 = (*(__int64 (__fastcall **)(__int64, struct CExpressionValueStack *, unsigned __int64, bool *))(*(_QWORD *)v31 + 248LL))(
                v31,
                a2,
                a3,
                a4);
        v9 = v32;
        if ( v32 < 0 )
          MilInstrumentationCheckHR_MaybeFailFast(v33, 0LL, 0, v32, 0xF0u, 0LL);
      }
    }
  }
  return v9;
