/*
 * XREFs of ?ProcessSetPropertyUpdate@CAnimationLoggingManager@@QEAAJPEAVCResourceTable@@PEBUtagMILCMD_ANIMATIONLOGGINGMANAGER_SETPROPERTYUPDATE@@@Z @ 0x1801BF6DC
 * Callers:
        ...
        const struct tagMILCMD_ANIMATIONLOGGINGMANAGER_SETPROPERTYUPDATE *a3)
{
  ...
  if ( (int)v4 + 1 >= (unsigned int)v4 )
  {
    ...
    v6 = v10;
    if ( v10 < 0 )
      MilInstrumentationCheckHR_MaybeFailFast(v7, 0LL, 0, v10, 0xC3u, 0LL);
  }
  else
  {
    v6 = -2147024362;
