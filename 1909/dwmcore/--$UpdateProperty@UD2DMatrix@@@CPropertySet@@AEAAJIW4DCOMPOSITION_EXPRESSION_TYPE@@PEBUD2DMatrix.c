/*
 * XREFs of ??$UpdateProperty@UD2DMatrix@@@CPropertySet@@AEAAJIW4DCOMPOSITION_EXPRESSION_TYPE@@PEBUD2DMatrix@@@Z @ 0x1800A3070
 * Callers:
...
__int64 __fastcall CPropertySet::UpdateProperty<D2DMatrix>(__int64 a1, __int64 a2, __int64 a3, __int64 a4)
{
  unsigned int v4; // edx
  __int64 v5; // rcx
  int v6; // r8d
    ...
    && (v9 = *((_QWORD *)v8 + 10), v5 = v4, *(_DWORD *)(v9 + 8LL * v4) == v6) )
  {
    ...
    v10 &= 0x1FFFFFFFu;
    *(_OWORD *)(v10 + v11) = *v7;
    *(_OWORD *)(v10 + v11 + 16) = v7[1];
    *(_OWORD *)(v10 + v11 + 32) = v7[2];
    *(_OWORD *)(v10 + v11 + 48) = v7[3];
    v12 = CPropertySet::PropertyUpdated<D2DMatrix>(v8, v4, 1, (__int64)v7);
    v14 = v12;
    if ( v12 < 0 )
