/*
 * XREFs of McTemplateU0qx @ 0x1801A8414
 * Callers:
...
ULONG McTemplateU0qx(__int64 a1, __int64 a2, __int64 a3, ...)
{
  ...
  v10 = 0;
  v9 = 8;
  return McGenEventWrite(Microsoft_Windows_Dwm_Core_Provider_Context, &EVTDESC_DEBUG_FRAME_COUNTER_EVENT, a3, 3u, &v4);
}
