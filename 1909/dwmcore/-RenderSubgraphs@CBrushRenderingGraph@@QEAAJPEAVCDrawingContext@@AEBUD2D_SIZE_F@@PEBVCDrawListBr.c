/*
 * XREFs of ?RenderSubgraphs@CBrushRenderingGraph@@QEAAJPEAVCDrawingContext@@AEBUD2D_SIZE_F@@PEBVCDrawListBrush@@PEAVCDrawListCache@@@Z @ 0x18003C54C
 * Callers:
 ...
 *     ?reserve@?$vector@UEffectInput@@V?$allocator@UEffectInput@@@std@@@std@@QEAAX_K@Z @ 0x18003CE40 (-reserve@-$vector@UEffectInput@@V-$allocator@UEffectInput@@@std@@@std@@QEAAX_K@Z.c)
        ...
        struct CDrawListCache *a5)
{
  ...
  struct IImageSource *v62; // [rsp+60h] [rbp-A0h] BYREF
  ...
  *(_QWORD *)v76.Data4 = 0LL;
  ...
  v73 = 0;
  CDrawingContext::GetWorldTransform(a2, (struct CMILMatrix *)v72);
  ...
  if ( v20 )
  {
    ...
    do
    {
      ...
      else
      {
        ...
        BackdropImageFromRenderTarget = CDrawListBitmap::FromImageSource((CDrawListBitmap *)v23, v35, a2, 0);
        v9 = BackdropImageFromRenderTarget;
        if ( BackdropImageFromRenderTarget < 0 )
        {
          v56 = 852;
...
LABEL_46:
  ...
  if ( *((_BYTE *)this + 196) )
  {
    ...
    *((float *)&v74[1] + 1) = v52;
    CDrawingContext::CalcWorldSpaceClippedBounds(a2, v74, v75);
    v53 = *(_OWORD *)v75;
...
LABEL_29:
  ...
  Microsoft::WRL::ComPtr<ID3D11Device5>::InternalRelease((__int64 *)&v77 + 1);
