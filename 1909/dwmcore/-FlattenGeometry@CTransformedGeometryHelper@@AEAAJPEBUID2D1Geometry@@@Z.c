/*
 * XREFs of ?FlattenGeometry@CTransformedGeometryHelper@@AEAAJPEBUID2D1Geometry@@@Z @ 0x18024C6F8
 * Callers:
...
__int64 __fastcall CTransformedGeometryHelper::FlattenGeometry(CMILMatrix **this, const struct ID2D1Geometry *a2)
{
  ...
  if ( this[3] )
  {
    ...
    sqrtf_0((float)(v14 * v14) + (float)(v13 * v13));
  ...
  v2 = v16;
  if ( v16 < 0 )
    MilInstrumentationCheckHR_MaybeFailFast(v17, 0LL, 0, v16, 0xA2u, 0LL);
  return v2;
}
