/*
 * XREFs of ?GetSDRBoost@CDesktopRenderTarget@@UEBAMXZ @ 0x1801A6DB0
 * Callers:
 *     ?GetSDRBoost@CDesktopRenderTarget@@WGI@EBAMXZ @ 0x1800F0E00 (-GetSDRBoost@CDesktopRenderTarget@@WGI@EBAMXZ.c)
 * Callees:
 *     <none>
 */
