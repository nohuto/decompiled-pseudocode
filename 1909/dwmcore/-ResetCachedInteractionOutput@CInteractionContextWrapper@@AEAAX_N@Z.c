/*
 * XREFs of ?ResetCachedInteractionOutput@CInteractionContextWrapper@@AEAAX_N@Z @ 0x1800C19B4
 * Callers:
 ...
 * Callees:
 *     _anonymous_namespace_::ResetInteractionOutput @ 0x1800C19E4 (_anonymous_namespace_--ResetInteractionOutput.c)
 */
