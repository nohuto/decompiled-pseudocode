/*
 * XREFs of ?NotifyVector4PropertyChanged@CPropertyChangeResource@@IEBAJIAEBUD2DVector4@@@Z @ 0x1801CCDBC
 * Callers:
        ...
        const struct D2DVector4 *a3)
{
  ...
  if ( CPropertyChangeResource::ShouldNotify(this, a2) )
  {
    ...
    LOWORD(v13) = 3;
    v3 = CoreUICallSend(v9, v14, 2LL, 13LL, v13, &unk_1802B11B7, v6, &v15);
    if ( v3 == -2018375675 )
      v3 = 0;
    if ( v3 < 0 )
      MilInstrumentationCheckHR_MaybeFailFast(v11, 0LL, 0, v3, 0x14Au, 0LL);
  }
