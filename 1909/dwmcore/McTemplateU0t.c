/*
 * XREFs of McTemplateU0t @ 0x1801781B0
 * Callers:
...
ULONG __fastcall McTemplateU0t(__int64 a1, __int64 a2, __int64 a3)
{
  ...
  v7 = 0;
  v6 = 4;
  return McGenEventWrite(Microsoft_Windows_Dwm_Core_Provider_Context, &EVTDESC_SCHEDULE_GLITCH_DETECTED, a3, 2u, &v4);
}
