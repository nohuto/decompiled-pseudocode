/*
 * XREFs of ?DrawRectangleOverlay@CDrawingContext@@AEAAJPEBV?$TMilRect_@MUMilRectF@@UMilPointAndSizeF@@UNotNeeded@RectUniqueness@@@@@Z @ 0x18016CAE4
 * Callers:
...
__int64 __fastcall CDrawingContext::DrawRectangleOverlay(CDrawingContext *a1)
{
  ...
  if ( !CDrawingContext::IsBounding(a1) )
  {
    ...
    v1 = v4;
    if ( v4 < 0 )
      MilInstrumentationCheckHR_MaybeFailFast(v5, 0LL, 0, v4, 0x22D3u, 0LL);
    else
