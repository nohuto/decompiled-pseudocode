/*
 * XREFs of ?SendFrameStatisticsTelemetry@CTelemetryFrameStatistics@@AEAAX_K@Z @ 0x1800B3084
 * Callers:
...
void __fastcall CTelemetryFrameStatistics::SendFrameStatisticsTelemetry(CTelemetryFrameStatistics *this, __int64 a2)
{
  ...
  if ( *((_DWORD *)this + 8) )
  {
    ...
    if ( dword_1803371D0 > 5u && TlgKeywordOn((TraceLoggingHProvider)&dword_1803371D0, 0x400000000000uLL) )
    {
      ...
      v49 = 4;
      v21 = v12 / v6;
      TlgWrite((TraceLoggingHProvider)&dword_1803371D0, &unk_1802D932E, 0LL, 0LL, 0xBu, &pData);
    }
