/*
 * XREFs of ?SetProperty@CInteraction@@UEAAJIW4DCOMPOSITION_EXPRESSION_TYPE@@PEBX@Z @ 0x1801D6720
 * Callers:
 *     <none>
 * Callees:
...
LABEL_6:
  ...
  v5 = -2147024809;
  MilInstrumentationCheckHR_MaybeFailFast(a1, 0LL, 0, 0x80070057, 0x26Fu, 0LL);
  return v5;
}
