/*
 * XREFs of ?FindExistingGradient@CGradientSource@@IEAA_NPEAVCD3DDeviceLevel1@@_NAEBVRetrievalParams@1@@Z @ 0x1800195A8
 * Callers:
        ...
        const struct CGradientSource::RetrievalParams *a4)
{
  ...
  if ( a3 )
  {
    ...
    while ( v8 != v7 )
    {
      ...
      std::_Tree_unchecked_const_iterator<std::_Tree_val<std::_Tree_simple_types<std::pair<CD3DDeviceLevel1 const * const,CGradientSource::Cache>>>,std::_Iterator_base0>::operator++(&v22);
      v8 = v22;
    }
  }
