/*
 * XREFs of ?GetPixelFormatInfo@CDesktopRenderTarget@@UEBA?AUPixelFormatInfo@@XZ @ 0x1800D28C0
 * Callers:
 *     ?GetPixelFormatInfo@CDesktopRenderTarget@@WGI@EBA?AUPixelFormatInfo@@XZ @ 0x1800F0DF0 (-GetPixelFormatInfo@CDesktopRenderTarget@@WGI@EBA-AUPixelFormatInfo@@XZ.c)
 * Callees:
