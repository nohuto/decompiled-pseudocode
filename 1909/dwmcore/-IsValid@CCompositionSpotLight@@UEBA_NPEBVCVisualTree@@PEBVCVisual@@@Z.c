/*
 * XREFs of ?IsValid@CCompositionSpotLight@@UEBA_NPEBVCVisualTree@@PEBVCVisual@@@Z @ 0x180022160
 * Callers:
 *     <none>
 * Callees:
        ...
        const struct CVisual *a3)
{
  ...
  v5 = (const struct CVisual *)(*(__int64 (__fastcall **)(CCompositionSpotLight *))(*(_QWORD *)this + 208LL))(this);
  v6 = v5;
  v7 = v5;
  if ( v5 )
  {
    while ( (*((_BYTE *)v6 + 95) & 4) != 0 )
    {
      if ( v6 == a2[3] )
      {
        if ( a3 == v5 )
