/*
 * XREFs of ?LogDebugPropertyUpdate@CAnimationLoggingManager@@QEAAXPEAVCResource@@W4PropertyChangeSource@@_KW4MIL_RESOURCE_TYPE@@IIPEAVSubchannelMaskInfo@@PEBVCExpressionValue@@@Z @ 0x1801BE7F8
 * Callers:
 ...
 * Callees:
 *     _anonymous_namespace_::GetExpressionTypeString @ 0x18001DBA4 (_anonymous_namespace_--GetExpressionTypeString.c)
 ...
 *     ?GetSubchannels@MatrixSubchannelMaskInfo@@QEBAGXZ @ 0x180229030 (-GetSubchannels@MatrixSubchannelMaskInfo@@QEBAGXZ.c)
 *     ?GetSubchannels@VectorSubchannelMaskInfo@@QEBAGXZ @ 0x180229080 (-GetSubchannels@VectorSubchannelMaskInfo@@QEBAGXZ.c)
    ...
    if ( v20 )
    {
      ...
      if ( v21 )
      {
        ...
        if ( v22 )
        {
          ...
          if ( !v23 )
          {
            if ( dword_180337240 <= 5u || !TlgKeywordOn((TraceLoggingHProvider)&dword_180337240, 1uLL) )
              goto LABEL_64;
            v65 = 8LL;
            v64 = &v60;
            TlgCreateWsz(&pDesc, off_18026FA10[a5]);
            v68 = 4LL;
            v67 = &v59;
            v69 = &a7;
            v70 = 4LL;
            ...
            if ( v25 )
            {
              ...
              if ( v26 )
              {
                ...
                if ( dword_180337240 > 5u && TlgKeywordOn((TraceLoggingHProvider)&dword_180337240, 1uLL) )
                {
                  ...
                  v104 = 4LL;
                  v106 = 4LL;
                  TlgWrite((TraceLoggingHProvider)&dword_180337240, &unk_1802D9744, 0LL, 0LL, 0x1Au, &pData);
                }
              }
              else if ( dword_180337240 > 5u && TlgKeywordOn((TraceLoggingHProvider)&dword_180337240, 1uLL) )
              {
                ...
                v84 = 4LL;
                v86 = 4LL;
                TlgWrite((TraceLoggingHProvider)&dword_180337240, &unk_1802D967C, 0LL, 0LL, 0x10u, &pData);
              }
              goto LABEL_64;
            }
            if ( dword_180337240 <= 5u || !TlgKeywordOn((TraceLoggingHProvider)&dword_180337240, 1uLL) )
...
LABEL_33:
            ...
            v80 = 4LL;
            v82 = 4LL;
            TlgWrite((TraceLoggingHProvider)&dword_180337240, &unk_1802D95C6, 0LL, 0LL, 0xEu, &pData);
            goto LABEL_64;
          }
          if ( dword_180337240 > 5u && TlgKeywordOn((TraceLoggingHProvider)&dword_180337240, 1uLL) )
          {
            ...
            v80 = 4LL;
            v82 = 4LL;
            TlgWrite((TraceLoggingHProvider)&dword_180337240, &unk_1802D9510, 0LL, 0LL, 0xEu, &pData);
          }
        }
        else if ( dword_180337240 > 5u && TlgKeywordOn((TraceLoggingHProvider)&dword_180337240, 1uLL) )
        {
          ...
          v78 = 4LL;
          v80 = 4LL;
          TlgWrite((TraceLoggingHProvider)&dword_180337240, &unk_1802D9997, 0LL, 0LL, 0xDu, &pData);
        }
      }
      else if ( dword_180337240 > 5u && TlgKeywordOn((TraceLoggingHProvider)&dword_180337240, 1uLL) )
      {
        ...
        v76 = 4LL;
        v78 = 4LL;
        TlgWrite((TraceLoggingHProvider)&dword_180337240, &unk_1802D98E7, 0LL, 0LL, 0xCu, &pData);
      }
    }
    else if ( dword_180337240 > 5u && TlgKeywordOn((TraceLoggingHProvider)&dword_180337240, 1uLL) )
    {
      ...
      v75 = v14;
      v76 = 4LL;
      TlgWrite((TraceLoggingHProvider)&dword_180337240, &unk_1802D983E, 0LL, 0LL, 0xBu, &pData);
    }
  }
  else if ( dword_180337240 > 5u && TlgKeywordOn((TraceLoggingHProvider)&dword_180337240, 1uLL) )
  {
    ...
    v61 = v53;
    v76 = 4LL;
    TlgWrite((TraceLoggingHProvider)&dword_180337240, &unk_1802D9A4A, 0LL, 0LL, 0xBu, &pData);
  }
LABEL_64:
  if ( a3 == 2 )
  {
