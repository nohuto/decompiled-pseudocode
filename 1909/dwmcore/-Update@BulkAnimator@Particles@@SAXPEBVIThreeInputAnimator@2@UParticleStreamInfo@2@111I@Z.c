/*
 * XREFs of ?Update@BulkAnimator@Particles@@SAXPEBVIThreeInputAnimator@2@UParticleStreamInfo@2@111I@Z @ 0x1801E89A8
 * Callers:
        ...
        unsigned int a6)
{
  ...
  v10 = (*(unsigned int (__fastcall **)(__int64))(*(_QWORD *)a1 + 16LL))(a1) >> 2;
...
LABEL_12:
      ...
      (**(void (__fastcall ***)(__int64, _QWORD *, _QWORD *, _QWORD *, _QWORD *))a1)(a1, v26, v25, v24, v23);
      ++v13;
