/*
 * XREFs of ?DeactivateSwapChain@CHolographicExclusiveView@@AEAAXXZ @ 0x1802436C0
 * Callers:
 ...
 * Callees:
 *     ?CloseSurfaceHandles@CHolographicExclusiveView@@AEAAXXZ @ 0x18024365C (-CloseSurfaceHandles@CHolographicExclusiveView@@AEAAXXZ.c)
 */
