/*
 * XREFs of ?RemoveAssociations@CBaseRenderTarget@@AEAAXXZ @ 0x18004A0E8
 * Callers:
 ...
 *     ?PrepareForReuse@CBaseRenderTarget@@UEAAXXZ @ 0x180160E70 (-PrepareForReuse@CBaseRenderTarget@@UEAAXXZ.c)
 * Callees:
