/*
 * XREFs of ?DisplayText@CDisplayDebugFrameCounter@@IEAAJIIPEAVCDrawingContext@@AEBV?$TMilRect_@MUMilRectF@@UMilPointAndSizeF@@UNotNeeded@RectUniqueness@@@@W4DebugFrameCounterPosition@1@PEAV3@@Z @ 0x180191848
 * Callers:
        ...
        float *a7)
{
  ...
  *(struct _D3DCOLORVALUE *)&v29.r = (struct _D3DCOLORVALUE)_xmm;
  ...
  if ( v15 )
  {
    ...
    v20 = (*(__int64 (__fastcall **)(_QWORD, const wchar_t *, _QWORD, __int64, _DWORD, int, _DWORD, const WCHAR *, char *))(**((_QWORD **)this + 3) + 120LL))(
            *((_QWORD *)this + 3),
            L"Lucida Console",
            0LL,
            400LL,
  ...
  *(struct _D3DCOLORVALUE *)&v29.r = (struct _D3DCOLORVALUE)_xmm;
  v30.left = v13;
  v30.right = v12 + 120.0;
  CDrawingContext::DrawSolidRectangleInternal(a4, (__int64)&v30, (__int128 *)&v29);
  if ( a2 <= 0x1E )
    *(struct _D3DCOLORVALUE *)&v11.r = (struct _D3DCOLORVALUE)_xmm;
  *(struct _D3DCOLORVALUE *)&v29.r = *(struct _D3DCOLORVALUE *)&v11.r;
  ...
  if ( v24 < 0 )
  {
    MilInstrumentationCheckHR_MaybeFailFast(v25, 0LL, 0, v24, 0xC1u, 0LL);
  }
  else
  {
    *(struct _D3DCOLORVALUE *)&v29.r = (struct _D3DCOLORVALUE)_xmm;
    ...
    if ( v26 < 0 )
    {
      MilInstrumentationCheckHR_MaybeFailFast(v27, 0LL, 0, v26, 0xC4u, 0LL);
    }
    else
    {
      *a7 = v13;
