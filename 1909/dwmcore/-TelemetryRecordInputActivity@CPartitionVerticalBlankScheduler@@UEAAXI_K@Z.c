/*
 * XREFs of ?TelemetryRecordInputActivity@CPartitionVerticalBlankScheduler@@UEAAXI_K@Z @ 0x18001A650
 * Callers:
 *     <none>
 * Callees:
 *     ?Update@CMouseKeyboardInfo@CTelemetryTouchLatencyAnalysis@@QEAAXI_K0@Z @ 0x18001A6FC (-Update@CMouseKeyboardInfo@CTelemetryTouchLatencyAnalysis@@QEAAXI_K0@Z.c)
        ...
        unsigned __int64 a3)
{
  ...
  if ( dword_180337240 > 4u && TlgKeywordOn((TraceLoggingHProvider)&dword_180337240, 2uLL) )
  {
    ...
    v18 = 4;
    v21 = 8;
    TlgWrite((TraceLoggingHProvider)&dword_180337240, &unk_1802D7557, 0LL, 0LL, 5u, &pData);
    v3 = v24;
    v4 = v23;
  }
  ...
  if ( hProvider > 5u && TlgKeywordOn((TraceLoggingHProvider)&hProvider, 2uLL) )
  {
    ...
    v18 = 8;
    v21 = 8;
    TlgWrite(v8, &unk_1802D8A83, 0LL, 0LL, 5u, &pData);
    v7 = v12;
    v3 = v11;
    v4 = v10;
  }
