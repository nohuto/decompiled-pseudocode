/*
 * XREFs of ?ProcessSetCallbackId@CNotificationResource@@QEAAJPEAVCResourceTable@@PEBUtagMILCMD_NOTIFICATIONRESOURCE_SETCALLBACKID@@@Z @ 0x1800BCFE8
 * Callers:
        ...
        const struct tagMILCMD_NOTIFICATIONRESOURCE_SETCALLBACKID *a3)
{
  ...
  v4 = 0LL;
  v6 = *((_QWORD *)this + 2);
  if ( v3 < 0x10000 && v3 < *(_DWORD *)(v6 + 352) && (v8 = v3, v9 = *(_QWORD *)(v6 + 328), *(_QWORD *)(v9 + 8 * v8)) )
  {
    ...
    {
      v11 = -2147024891;
      MilInstrumentationCheckHR_MaybeFailFast(v10, 0LL, 0, 0x80070005, 0x5Bu, 0LL);
    }
    else
    {
      if ( v10 )
      ...
      *((_DWORD *)this + 14) = *((_DWORD *)a3 + 2);
      v15 = *(_QWORD *)this;
      *((_QWORD *)this + 6) = v4;
      (*(void (__fastcall **)(CNotificationResource *))(v15 + 192))(this);
    }
  }
  else
  {
    v11 = -2147024809;
    MilInstrumentationCheckHR_MaybeFailFast(v6, 0LL, 0, 0x80070057, 0x8A7u, 0LL);
    MilInstrumentationCheckHR_MaybeFailFast(v18, 0LL, 0, 0x80070057, 0x53u, 0LL);
  }
