/*
 * XREFs of ?Create@CPrimitiveGroupDrawListBrush@@SAJPEAVCPrimitiveGroupDrawListGenerator@@USamplerMode@@PEAPEAV1@@Z @ 0x18000FBD4
 * Callers:
        ...
        _QWORD *a3)
{
  ...
  *a3 = v10;
  ...
  {
    v6 = -2147024882;
    MilInstrumentationCheckHR_MaybeFailFast(v12, 0LL, 0, -2147024882, 0x13u, 0LL);
  }
  return v6;
}
