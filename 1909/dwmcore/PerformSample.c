/*
 * XREFs of PerformSample @ 0x1800317BC
 * Callers:
...
__int64 __fastcall PerformSample(__int64 a1, __int64 a2, unsigned int a3, __int16 a4, unsigned __int16 a5, void *a6)
{
  void *v6; // r15
  __int16 v7; // r13
  __int128 *v8; // rdi
    ...
    else
    {
      if ( !*((_BYTE *)v8 + 21) )
      {
        ...
        if ( *((_BYTE *)v8 + 17) == 2 )
        {
          if ( *((_BYTE *)v8 + 16) == 2 )
          {
            v27 = *(_OWORD *)"SampleWrappedTexture";
            *(_DWORD *)&v44[16] = *(_DWORD *)"ture";
            *(_WORD *)&v44[20] = v19;
            goto LABEL_19;
          }
          v27 = *(_OWORD *)"SampleWrappedTextureVOnly";
          v32 = aSamplewrappedt[24];
          v33 = *(_QWORD *)"tureVOnly";
        }
        else
        {
          v27 = *(_OWORD *)"SampleWrappedTextureUOnly";
...
LABEL_19:
        ...
        *(_OWORD *)v44 = v27;
        ...
        if ( appended < 0 )
        {
          MilInstrumentationCheckHR_MaybeFailFast(v29, 0LL, 0, appended, 0x2ACu, 0LL);
          return v16;
        }
        goto LABEL_9;
      }
    ...
    if ( *((_BYTE *)v8 + 23)
      && (*((_QWORD *)&v39 + 1) = &a5,
          *(_QWORD *)&v39 = 1LL,
          ...
          v25 < 0) )
    {
      MilInstrumentationCheckHR_MaybeFailFast(v26, 0LL, 0, v25, 0x2B5u, 0LL);
    }
    else if ( *((_BYTE *)v8 + 24)
           && (*((_QWORD *)&v39 + 1) = &a5,
               *(_QWORD *)&v39 = 1LL,
