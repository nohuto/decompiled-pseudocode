/*
 * XREFs of ?SetSpriteImage@CWindowNode@@AEAAJPEAVISpriteImage@@@Z @ 0x1800AD7FC
 * Callers:
...
__int64 __fastcall CWindowNode::SetSpriteImage(CWindowNode *this, struct ISpriteImage *a2)
{
  ...
  struct ISpriteImage *v29; // [rsp+58h] [rbp+10h] BYREF
...
LABEL_7:
      ...
      do
      {
        ...
        if ( (_DWORD)v23 )
        {
          ...
          if ( (_DWORD)v23 != 1 )
          {
            ...
            {
              v23 = v24++;
              *(_QWORD *)(v25 + 8 * v23) = *(_QWORD *)(v25 + 8LL * v24);
              LODWORD(v23) = *((_DWORD *)this + 194);
            }
            while ( v24 < (int)v23 - 1 );
          }
        ...
        {
          MilInstrumentationCheckHR_MaybeFailFast(v23, 0LL, 0, 0x80070057, 0x19Fu, 0LL);
        }
      }
    ...
    else
    {
      if ( v11 <= *((_DWORD *)this + 193) )
      {
        ...
        *((_DWORD *)this + 194) = v11;
LABEL_12:
        v8 = (*(__int64 (__fastcall **)(struct ISpriteImage *, CWindowNode *))(*(_QWORD *)v29 + 160LL))(v29, this);
        v2 = v8;
        if ( v8 >= 0 )
        {
          LOBYTE(v12) = *((_BYTE *)this + 937);
          (*(void (__fastcall **)(struct ISpriteImage *, __int64))(*(_QWORD *)v29 + 208LL))(v29, v12);
          v13 = *((_DWORD *)this + 215) >> 1;
          LOBYTE(v13) = (*((_DWORD *)this + 215) & 2) != 0;
          (*(void (__fastcall **)(struct ISpriteImage *, __int64, char *))(*(_QWORD *)v29 + 216LL))(
            v29,
            v13,
            (char *)this + 808);
...
LABEL_14:
        ...
        v28 = 1013;
LABEL_43:
        MilInstrumentationCheckHR_MaybeFailFast(v9, 0LL, 0, v8, v28, 0LL);
        return v2;
      }
      v27 = DynArrayImpl<0>::AddMultipleAndSet((__int64)this + 752, 8, 1, &v29);
      v2 = v27;
      if ( v27 < 0 )
        MilInstrumentationCheckHR_MaybeFailFast(v26, 0LL, 0, v27, 0xC3u, 0LL);
    }
    if ( (v2 & 0x80000000) != 0 )
    {
      MilInstrumentationCheckHR_MaybeFailFast(v26, 0LL, 0, v2, 0x3F3u, 0LL);
      return v2;
    }
    goto LABEL_12;
  }
