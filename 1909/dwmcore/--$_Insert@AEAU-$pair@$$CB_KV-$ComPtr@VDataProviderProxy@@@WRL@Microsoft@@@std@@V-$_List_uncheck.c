/*
 * XREFs of ??$_Insert@AEAU?$pair@$$CB_KV?$ComPtr@VDataProviderProxy@@@WRL@Microsoft@@@std@@V?$_List_unchecked_iterator@V?$_List_val@U?$_List_simple_types@U?$pair@$$CB_KV?$ComPtr@VDataProviderProxy@@@WRL@Microsoft@@@std@@@std@@@std@@@2@@?$_Hash@V?$_Umap_traits@_KV?$ComPtr@VDataProviderProxy@@@WRL@Microsoft@@V?$_Uhash_compare@_KU?$hash@_K@std@@U?$equal_to@_K@2@@std@@V?$allocator@U?$pair@$$CB_KV?$ComPtr@VDataProviderProxy@@@WRL@Microsoft@@@std@@@5@$0A@@std@@@std@@IEAA?AU?$pair@V?$_List_iterator@V?$_List_val@U?$_List_simple_types@U?$pair@$$CB_KV?$ComPtr@VDataProviderProxy@@@WRL@Microsoft@@@std@@@std@@@std@@@std@@_N@1@AEAU?$pair@$$CB_KV?$ComPtr@VDataProviderProxy@@@WRL@Microsoft@@@1@V?$_List_unchecked_iterator@V?$_List_val@U?$_List_simple_types@U?$pair@$$CB_KV?$ComPtr@VDataProviderProxy@@@WRL@Microsoft@@@std@@@std@@@std@@@1@@Z @ 0x1800E4FF8
 * Callers:
        ...
        __int64 *a4)
{
  ...
  if ( v16 != v12 )
    v12 = **(_QWORD **)(v14 + 8 * v15 + 8);
  v17 = v12;
  while ( v17 != v16 )
  {
    v17 = *(_QWORD *)(v12 + 8);
    v12 = v17;
    if ( *(_QWORD *)v6 == *(_QWORD *)(v17 + 16) )
    {
      std::list<std::pair<unsigned __int64 const,Microsoft::WRL::ComPtr<DataProviderProxy>>>::erase(a1 + 8, &v33, a4);
      *(_QWORD *)a2 = v12;
      *(_BYTE *)(a2 + 8) = 0;
      return a2;
    }
  ...
  v19 = *(_QWORD *)(a1 + 24);
  v20 = *(__int64 **)(v19 + 8 * v15);
  if ( v20 == *v11 )
  {
    *(_QWORD *)(v19 + 8 * v15) = a4;
    *(_QWORD *)(*(_QWORD *)(a1 + 24) + 8 * v15 + 8) = a4;
  }
  else if ( v20 == (__int64 *)v17 )
  {
    *(_QWORD *)(v19 + 8 * v15) = a4;
  }
  else
  {
    v27 = *(__int64 ***)(v19 + 8 * v15 + 8);
    v28 = *v27;
    *(_QWORD *)(v19 + 8 * v15 + 8) = *v27;
    if ( v28 != a4 )
