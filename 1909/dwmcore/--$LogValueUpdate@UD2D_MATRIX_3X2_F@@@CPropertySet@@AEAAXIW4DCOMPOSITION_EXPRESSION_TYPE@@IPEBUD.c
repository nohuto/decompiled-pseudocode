/*
 * XREFs of ??$LogValueUpdate@UD2D_MATRIX_3X2_F@@@CPropertySet@@AEAAXIW4DCOMPOSITION_EXPRESSION_TYPE@@IPEBUD2D_MATRIX_3X2_F@@@Z @ 0x18001C31C
 * Callers:
      ...
      if ( v6 )
      {
        ...
        if ( v7 )
        {
                  ...
                  if ( (_DWORD)v12 )
                  {
                    ...
                    if ( dword_180337240 > 5u )
                    {
                      if ( TlgKeywordOn((TraceLoggingHProvider)&dword_180337240, 1uLL) )
                      {
                        ...
                        v84 = 4LL;
                        v86 = 4LL;
                        TlgWrite((TraceLoggingHProvider)&dword_180337240, &unk_1802DB16E, 0LL, 0LL, 0x16u, &pData);
                      }
                    }
                  }
                  else if ( dword_180337240 > 5u && TlgKeywordOn((TraceLoggingHProvider)&dword_180337240, 1uLL) )
                  {
                    v47 = &v44;
                    v49 = &v43;
                    v51 = &v42;
                    ...
                    v64 = 4LL;
                    v66 = 4LL;
                    TlgWrite((TraceLoggingHProvider)&dword_180337240, &unk_1802DB0E8, 0LL, 0LL, 0xCu, &pData);
                  }
                }
                else if ( dword_180337240 > 5u && TlgKeywordOn((TraceLoggingHProvider)&dword_180337240, 1uLL) )
                {
                  ...
                  v60 = 4LL;
                  v62 = 4LL;
                  TlgWrite((TraceLoggingHProvider)&dword_180337240, &unk_1802DB297, 0LL, 0LL, 0xAu, &pData);
                }
              }
              else if ( dword_180337240 > 5u && TlgKeywordOn((TraceLoggingHProvider)&dword_180337240, 1uLL) )
              {
                ...
                v60 = 4LL;
                v62 = 4LL;
                TlgWrite((TraceLoggingHProvider)&dword_180337240, &unk_1802DB30B, 0LL, 0LL, 0xAu, &pData);
              }
            }
            else if ( dword_180337240 > 5u && TlgKeywordOn((TraceLoggingHProvider)&dword_180337240, 1uLL) )
            {
          ...
          else if ( dword_180337240 > 5u && TlgKeywordOn((TraceLoggingHProvider)&dword_180337240, 1uLL) )
          {
            ...
            v58 = 4LL;
            v60 = 4LL;
            TlgWrite((TraceLoggingHProvider)&dword_180337240, &unk_1802DB226, 0LL, 0LL, 9u, &pData);
          }
        }
        else if ( dword_180337240 > 5u && TlgKeywordOn((TraceLoggingHProvider)&dword_180337240, 1uLL) )
        {
          ...
          v56 = 4LL;
          v58 = 4LL;
          TlgWrite((TraceLoggingHProvider)&dword_180337240, &unk_1802DB44D, 0LL, 0LL, 8u, &pData);
        }
      }
      else if ( dword_180337240 > 5u && TlgKeywordOn((TraceLoggingHProvider)&dword_180337240, 1uLL) )
      {
        ...
        v54 = 4LL;
        v56 = 4LL;
        TlgWrite((TraceLoggingHProvider)&dword_180337240, &unk_1802DB3E6, 0LL, 0LL, 7u, &pData);
      }
    }
    else if ( dword_180337240 > 5u && TlgKeywordOn((TraceLoggingHProvider)&dword_180337240, 1uLL) )
    {
      ...
      v45 = v40;
      v56 = 4LL;
      TlgWrite((TraceLoggingHProvider)&dword_180337240, &unk_1802DB37F, 0LL, 0LL, 7u, &pData);
    }
  }
}
