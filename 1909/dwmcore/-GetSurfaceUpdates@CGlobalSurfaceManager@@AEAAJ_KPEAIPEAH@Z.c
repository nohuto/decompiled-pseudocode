/*
 * XREFs of ?GetSurfaceUpdates@CGlobalSurfaceManager@@AEAAJ_KPEAIPEAH@Z @ 0x18019AB88
 * Callers:
        ...
        int *a4)
{
  ...
  if ( FrameSurfaceUpdates < 0 )
  {
    ...
    MilInstrumentationCheckHR_MaybeFailFast(v6, &dword_1802BE810, 3u, FrameSurfaceUpdates | 0x10000000, 0xDCu, 0LL);
  }
  return v4;
}
