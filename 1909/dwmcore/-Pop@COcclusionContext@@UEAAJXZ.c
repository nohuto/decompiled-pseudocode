/*
 * XREFs of ?Pop@COcclusionContext@@UEAAJXZ @ 0x1800CBA90
 * Callers:
 *     <none>
 * Callees:
 ...
 *     ?PopClip@COcclusionContext@@AEAAXXZ @ 0x180170B40 (-PopClip@COcclusionContext@@AEAAXXZ.c)
 */
...
__int64 __fastcall COcclusionContext::Pop(COcclusionContext *this)
{
  ...
  else
  {
    ...
    if ( v5 )
    {
      v6 = *(_DWORD *)(*((_QWORD *)this + 134) + 4LL * (unsigned int)(v5 - 1));
    }
    else
    {
      v2 = -2147467259;
      MilInstrumentationCheckHR_MaybeFailFast((__int64)this, 0LL, 0, 0x80004005, 0x479u, 0LL);
      v6 = v9;
    }
    if ( v6 )
    {
