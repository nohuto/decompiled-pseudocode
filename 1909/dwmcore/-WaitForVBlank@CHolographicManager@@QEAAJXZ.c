/*
 * XREFs of ?WaitForVBlank@CHolographicManager@@QEAAJXZ @ 0x180240F00
 * Callers:
 *     ?WaitForVBlank@CHolographicInteropTarget@@UEAAJPEAX@Z @ 0x180244C10 (-WaitForVBlank@CHolographicInteropTarget@@UEAAJPEAX@Z.c)
 * Callees:
