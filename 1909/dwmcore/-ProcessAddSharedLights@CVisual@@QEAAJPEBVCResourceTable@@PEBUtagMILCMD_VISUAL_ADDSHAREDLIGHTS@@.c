/*
 * XREFs of ?ProcessAddSharedLights@CVisual@@QEAAJPEBVCResourceTable@@PEBUtagMILCMD_VISUAL_ADDSHAREDLIGHTS@@PEBXI@Z @ 0x180036398
 * Callers:
        ...
        unsigned int a5)
{
  ...
  {
    v5 = CVisual::AddSharedLights(this, (char *)this + 280, 0LL, a2, a4, *((_DWORD *)a3 + 2));
    v7 = v5;
    if ( v5 < 0 )
  ...
  {
    v7 = -2003303421;
    MilInstrumentationCheckHR_MaybeFailFast((unsigned int)this, 0LL, 0, -2003303421, 0xC5Fu, 0LL);
  }
  return v7;
}
