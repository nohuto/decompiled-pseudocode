/*
 * XREFs of ?AdvanceInertiaToTime@CPositionMotion@@QEAAMPEAVCExpressionValueStack@@_KMMMMMM@Z @ 0x18020F1B8
 * Callers:
 ...
 *     ?AdvanceDeltaDueToScale@CPositionMotion@@AEAAXXZ @ 0x18020F160 (-AdvanceDeltaDueToScale@CPositionMotion@@AEAAXXZ.c)
 */
