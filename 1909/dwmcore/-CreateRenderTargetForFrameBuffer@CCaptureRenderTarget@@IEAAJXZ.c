/*
 * XREFs of ?CreateRenderTargetForFrameBuffer@CCaptureRenderTarget@@IEAAJXZ @ 0x18024DA3C
 * Callers:
...
__int64 __fastcall CCaptureRenderTarget::CreateRenderTargetForFrameBuffer(CCaptureRenderTarget *this)
{
  ...
  if ( v9 < 0 )
  {
    MilInstrumentationCheckHR_MaybeFailFast(v10, 0LL, 0, v9, 0x267u, 0LL);
    goto LABEL_27;
  }
  v12 = v27;
  v27 = 0LL;
  ...
  if ( v13 < 0 )
  {
    MilInstrumentationCheckHR_MaybeFailFast(v14, 0LL, 0, v13, 0x270u, 0LL);
    goto LABEL_27;
  }
  ...
  if ( ((unsigned __int64)&v17[-*v1] & 0xFFFFFFFFFFFFFFF0uLL) == 0 )
  {
    ...
    if ( v19 < 0 )
    {
      MilInstrumentationCheckHR_MaybeFailFast(v20, 0LL, 0, v19, 0x27Cu, 0LL);
...
LABEL_22:
  ...
  v11 = v22;
  if ( v22 < 0 )
    MilInstrumentationCheckHR_MaybeFailFast(v23, 0LL, 0, v22, 0x288u, 0LL);
  else
    v27 = 0LL;
LABEL_27:
  if ( v11 < 0 )
