/*
 * XREFs of ?TransformInput@CInteractionContextTransformHelper@@QEAAJAEBUtagPOINTER_INFO@@_NPEAU2@@Z @ 0x18025D6F4
 * Callers:
 ...
 *     s_TransformPointByMatrix @ 0x18025E01C (s_TransformPointByMatrix.c)
 */
