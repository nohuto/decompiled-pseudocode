/*
 * XREFs of ?FillXBRPass2Buffer@@YAJPEAVCSurfaceShaderComposer@@IIII@Z @ 0x18017E550
 * Callers:
...
__int64 __fastcall FillXBRPass2Buffer(struct CSurfaceShaderComposer *a1, int a2, int a3, int a4, signed int a5)
{
  ...
  v9[6] = (float)a2;
  v9[7] = (float)a3;
  v5 = CSurfaceShaderComposer::SetScratchConstantBuffer((__int64)a1, v8, D3D11_USAGE_DEFAULT);
  v6 = v5;
  if ( v5 >= 0 )
    return 0LL;
