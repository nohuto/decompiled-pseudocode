/*
 * XREFs of ?CalculateFrameTargets@CGlobalManipulationManager@@AEAAXPEAVCManipulationFrame@@@Z @ 0x180236900
 * Callers:
...
void __fastcall CGlobalManipulationManager::CalculateFrameTargets(
        ...
        struct CManipulationFrame *a2)
{
  ...
  if ( *(_DWORD *)(v6 + 16) )
  {
    do
    {
      ...
      CMap<unsigned int,Microsoft::WRL::ComPtr<CManipulationContext>,CMapEqualHelper<unsigned int,Microsoft::WRL::ComPtr<CManipulationContext>>>::Lookup(
        ...
        (char *)a2 + v7 + 148);
      v8 = v15;
      if ( v15 && ((*(_DWORD *)((_BYTE *)a2 + v7 + 156) & 0x40004) != 0 || IsMousewheelFrame) )
      {
        if ( (int)CGestureTargetingManager::ProcessInput(v15, (struct CManipulationFrame *)((char *)a2 + v7 + 144)) < 0 )
        {
          *((_DWORD *)v8 + 6) = 1;
        }
  ...
  if ( *((int *)this + 74) > 0 )
  {
    ...
    do
    {
      ...
      {
        v12 = ConvertToInputType(*((_DWORD *)a2 + 36), *((_DWORD *)a2 + 39));
