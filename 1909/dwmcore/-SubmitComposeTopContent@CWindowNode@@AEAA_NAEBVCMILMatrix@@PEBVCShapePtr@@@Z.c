/*
 * XREFs of ?SubmitComposeTopContent@CWindowNode@@AEAA_NAEBVCMILMatrix@@PEBVCShapePtr@@@Z @ 0x1802186A8
 * Callers:
  ...
  if ( !*((_BYTE *)this + 939) )
  {
    ...
    if ( v11 )
    {
      if ( *(_QWORD *)a3 && v7 )
      {
        ...
        if ( v12 < 0 )
        {
          MilInstrumentationCheckHR_MaybeFailFast(v13, 0LL, 0, v12, 0xD04u, 0LL);
        }
        else
        {
          v3 = 1;
