/*
 * XREFs of ?GetBounds@CGenericInk@@UEBAJPEAVCContentBounder@@PEBUD2D_SIZE_F@@PEAV?$TMilRect_@MUMilRectF@@UMilPointAndSizeF@@UNotNeeded@RectUniqueness@@@@@Z @ 0x180213EB0
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall CGenericInk::GetBounds(__int64 a1, __int64 a2, __int64 a3, __int128 *a4)
{
  ...
  if ( *(_DWORD *)(a1 + 200) )
  {
    ...
    v6 = CDeviceResourceTable<CD2DGenericInk,CGenericInk,ID2DContext>::FindOrCreateResourceNoRef(
           (struct IDeviceResourceNotify *)(a1 + 80),
           0LL,
           &v11);
    v4 = v6;
    if ( v6 < 0 )
    ...
    else
    {
      ...
      v4 = v8;
      if ( v8 < 0 )
        MilInstrumentationCheckHR_MaybeFailFast(v9, 0LL, 0, v8, 0x117u, 0LL);
      else
        *a4 = v12;
    }
  }
