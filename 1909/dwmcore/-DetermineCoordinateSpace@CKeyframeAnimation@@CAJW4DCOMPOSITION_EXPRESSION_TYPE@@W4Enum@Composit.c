/*
 * XREFs of ?DetermineCoordinateSpace@CKeyframeAnimation@@CAJW4DCOMPOSITION_EXPRESSION_TYPE@@W4Enum@CompositionColorSpace@@PEAW4KeyframeAnimationCoordinateSpace@@@Z @ 0x1800A7B60
 * Callers:
...
LABEL_21:
    v7 = -2003303421;
    MilInstrumentationCheckHR_MaybeFailFast(v12, 0LL, 0, 0x88980403, v13, 0LL);
    return v7;
  }
  if ( a2 < 0 )
    goto LABEL_20;
