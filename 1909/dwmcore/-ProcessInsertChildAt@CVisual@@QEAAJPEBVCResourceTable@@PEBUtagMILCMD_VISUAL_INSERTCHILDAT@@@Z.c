/*
 * XREFs of ?ProcessInsertChildAt@CVisual@@QEAAJPEBVCResourceTable@@PEBUtagMILCMD_VISUAL_INSERTCHILDAT@@@Z @ 0x1800B9684
 * Callers:
        ...
        const struct tagMILCMD_VISUAL_INSERTCHILDAT *a3)
{
  ...
  {
    v12 = -2003303421;
    MilInstrumentationCheckHR_MaybeFailFast((__int64)this, 0LL, 0, 0x88980403, 0xD40u, 0LL);
  }
  return v12;
}
