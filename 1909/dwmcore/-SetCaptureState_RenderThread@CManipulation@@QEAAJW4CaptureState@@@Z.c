/*
 * XREFs of ?SetCaptureState_RenderThread@CManipulation@@QEAAJW4CaptureState@@@Z @ 0x1801E1C1C
 * Callers:
...
__int64 __fastcall CManipulation::SetCaptureState_RenderThread(CManipulation *a1, int a2)
{
  ...
  else
  {
    ...
    LOWORD(v10) = 1;
    v12 = a1;
    v7 = CoreUICallSend(v13, &v14, 1LL, 10LL, v10, &unk_1802B117E, (unsigned int)&v12, v11);
    v6 = v7;
    if ( v7 < 0 )
