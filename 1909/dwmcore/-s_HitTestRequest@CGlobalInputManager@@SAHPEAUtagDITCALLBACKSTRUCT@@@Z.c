/*
 * XREFs of ?s_HitTestRequest@CGlobalInputManager@@SAHPEAUtagDITCALLBACKSTRUCT@@@Z @ 0x1800A91FC
 * Callers:
 *     ?HitTestRequest@CInputProxy@@UEAA_NPEAUtagDITCALLBACKSTRUCT@@@Z @ 0x1800A91E0 (-HitTestRequest@CInputProxy@@UEAA_NPEAUtagDITCALLBACKSTRUCT@@@Z.c)
 * Callees:
 ...
 *     ?ConfigureInput@CComposition@@QEAA_NXZ @ 0x1800A9E84 (-ConfigureInput@CComposition@@QEAA_NXZ.c)
...
LABEL_21:
  ...
  if ( v12 < 0 )
  {
    MilInstrumentationCheckHR_MaybeFailFast(v13, &dword_1802BE430, 1u, v12, 0x82u, 0LL);
    goto LABEL_21;
  }
  ...
  v5 = v14;
  if ( v14 < 0 )
    MilInstrumentationCheckHR_MaybeFailFast(v15, &dword_1802BE430, 1u, v14, 0x86u, 0LL);
