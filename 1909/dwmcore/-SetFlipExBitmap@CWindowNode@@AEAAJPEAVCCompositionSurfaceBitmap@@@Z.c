/*
 * XREFs of ?SetFlipExBitmap@CWindowNode@@AEAAJPEAVCCompositionSurfaceBitmap@@@Z @ 0x18021846C
 * Callers:
...
LABEL_6:
  ...
  if ( v8 < 0 )
  {
    MilInstrumentationCheckHR_MaybeFailFast(v9, 0LL, 0, v8, 0x592u, 0LL);
    return v2;
  }
  v10 = *((_DWORD *)v5 + 6);
  v11 = v10 + 1;
...
LABEL_16:
  if ( (v2 & 0x80000000) == 0 )
    goto LABEL_11;
  MilInstrumentationCheckHR_MaybeFailFast(v12, 0LL, 0, v2, 0x593u, 0LL);
  return v2;
}
