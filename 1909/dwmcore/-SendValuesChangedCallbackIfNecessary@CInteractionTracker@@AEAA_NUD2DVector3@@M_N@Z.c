/*
 * XREFs of ?SendValuesChangedCallbackIfNecessary@CInteractionTracker@@AEAA_NUD2DVector3@@M_N@Z @ 0x1801DB370
 * Callers:
...
LABEL_7:
  ...
  LOWORD(v16) = 0;
  CoreUICallSend(*(_QWORD *)(v11 + 48), v19, 2LL, 8LL, v16, &unk_1802B1154, (unsigned int)&v17, a3);
  v14 = *((_DWORD *)a2 + 2);
  *(_QWORD *)(a1 + 504) = *a2;
  *(_DWORD *)(a1 + 512) = v14;
  *(float *)(a1 + 516) = a3;
