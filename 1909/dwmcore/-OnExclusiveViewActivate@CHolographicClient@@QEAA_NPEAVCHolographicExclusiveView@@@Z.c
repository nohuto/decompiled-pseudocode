/*
 * XREFs of ?OnExclusiveViewActivate@CHolographicClient@@QEAA_NPEAVCHolographicExclusiveView@@@Z @ 0x1802479A8
 * Callers:
        ...
        struct CHolographicExclusiveView *a2)
{
  ...
  v2 = *((_QWORD *)this + 3);
  v3 = *(__int64 (__fastcall **)(__int64, _QWORD, char *, _QWORD, _DWORD))(*(_QWORD *)v2 + 112LL);
  if ( a2 )
