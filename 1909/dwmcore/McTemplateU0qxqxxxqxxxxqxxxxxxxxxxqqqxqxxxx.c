/*
 * XREFs of McTemplateU0qxqxxxqxxxxqxxxxxxxxxxqqqxqxxxx @ 0x18018BBB8
 * Callers:
...
ULONG __fastcall McTemplateU0qxqxxxqxxxxqxxxxxxxxxxqqqxqxxxx(
        __int64 a1,
        __int64 a2,
        int a3,
        __int64 a4,
        ...
        __int64 a33)
{
  ...
  struct _EVENT_DATA_DESCRIPTOR v36; // [rsp+40h] [rbp-C0h] BYREF
  ...
  v96 = 8LL;
  v98 = 8LL;
  return McGenEventWrite(Microsoft_Windows_Dwm_Core_Provider_Context, &EVTDESC_SCHEDULE_FRAMEINFO, 0LL, 0x20u, &v36);
}
