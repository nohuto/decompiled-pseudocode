/*
 * XREFs of ?HitTestContent@CWindowNode@@UEAAJ_NAEBUD2D_POINT_2F@@PEA_N@Z @ 0x1800C2450
 * Callers:
 *     <none>
 * Callees:
 ...
 *     ?ShouldHitTest@CWindowNode@@MEBA_NXZ @ 0x1800C2670 (-ShouldHitTest@CWindowNode@@MEBA_NXZ.c)
 ...
 *     ?IsColorKey@CColorKey@@QEBA_NAEBU_D3DCOLORVALUE@@@Z @ 0x18024D264 (-IsColorKey@CColorKey@@QEBA_NAEBU_D3DCOLORVALUE@@@Z.c)
 */
...
__int64 __fastcall CWindowNode::HitTestContent(CWindowNode *this, char a2, const struct D2D_POINT_2F *a3, bool *a4)
{
  ...
  if ( v8 < 0 )
  {
    MilInstrumentationCheckHR_MaybeFailFast(v9, 0LL, 0, v8, 0x754u, 0LL);
    return v10;
  }
  if ( CWindowNode::ShouldHitTest(this) && !*a4 )
  {
    ...
    if ( v18 )
    {
      ...
      if ( !*((_BYTE *)v18 + 160) )
      {
        ...
        if ( ShapeData < 0 )
        {
          MilInstrumentationCheckHR_MaybeFailFast(v25, 0LL, 0, ShapeData, 0x76Du, 0LL);
          goto LABEL_25;
        }
        v26 = a3->y - v15;
        v35.r = a3->x - v12;
        v35.g = v26;
        v27 = CShapePtr::FillContainsPoint((CShape **)&v34, (const struct D2D_POINT_2F *)&v35, a4);
        v10 = v27;
        if ( v27 < 0 )
        {
          MilInstrumentationCheckHR_MaybeFailFast(v28, 0LL, 0, v27, 0x776u, 0LL);
          goto LABEL_25;
        }
        if ( *a4 )
    ...
    if ( !v21 )
    {
      if ( a2 )
      {
        TouchTargetBounds = (const struct MilRectF *)CVisual::GetTouchTargetBounds((__int64)this, &v34);
...
LABEL_8:
           ...
           &v35) >= 0 )
    {
      if ( (*((_BYTE *)this + 860) & 2) != 0 )
      {
        ...
        v32 = !CColorKey::IsColorKey((CWindowNode *)((char *)this + 808), &v35);
        *a4 = v32;
      }
      else
      {
