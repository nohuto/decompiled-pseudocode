/*
 * XREFs of ?GenerateIntermediateSurfaceBrush@CBrushDrawListGenerator@@QEAAJAEBUGenerateDrawListProperties@1@PEAPEAVCSurfaceDrawListBrush@@@Z @ 0x1801AF5F4
 * Callers:
        ...
        double a4)
{
  ...
  struct IImageSource *v85[2]; // [rsp+88h] [rbp-80h] BYREF
  ...
  v85[0] = 0LL;
  v89 = 0;
  CDrawingContext::GetWorldTransform(v6, (struct CMILMatrix *)v88);
...
LABEL_11:
    ...
    if ( CMILMatrix::Invert((CMILMatrix *)Destination, (__int64)v10, v11) )
    {
      ...
      *(float *)&v23 = (float)SLODWORD(v94.bottom);
      ...
      Bounds = CVisual::GetBounds((__int64)CurrentVisual, *((_QWORD *)v19 + 757));
      v91[0] = (struct CShape *)__PAIR64__(v21, v20);
      v26 = *(_DWORD *)(Bounds + 16);
      v93 = *(_DWORD *)(Bounds + 20);
      v92 = v26;
      v91[1] = (struct CShape *)__PAIR64__(v23, v22);
      CMILMatrix::Transform3DBoundsHelper<1>((__int64)Destination, (float *)v91, (__m128 *)v91);
      left = v90.left;
    ...
    v30 = (const struct CVisualTree **)*this;
    v82 = 0LL;
    v81 = 0LL;
    v83 = 0;
    v84 = 0;
    ...
    if ( CpuClip < 0 )
    {
      MilInstrumentationCheckHR_MaybeFailFast(v32, 0LL, 0, CpuClip, 0x32Eu, 0LL);
    }
    else
    {
      ...
      if ( v33 < 0 )
      {
        MilInstrumentationCheckHR_MaybeFailFast(v34, 0LL, 0, v33, 0x333u, 0LL);
      }
      else
      {
...
LABEL_39:
          ...
          if ( *((_DWORD *)this + 18) == 1 )
          {
            ...
            if ( v44 )
            {
              D2DMatrixHelper::GetScaleDimensions((CDrawingContext *)((char *)v44 + 8), &v80, &v80.dx, v41);
              m11 = v80.m11;
              dx = v80.dx;
            }
          }
          ...
          *(float *)&a4 = (float)(int)v46.m128_f32[0];
          ...
          if ( v53 >= 0 )
          {
            ...
            v55 = CDrawingContext::PushTransformInternal(*this, 0LL, (const struct CMILMatrix *)v86, 0LL, 1);
            v14 = v55;
            if ( v55 < 0 )
            {
              MilInstrumentationCheckHR_MaybeFailFast(v56, 0LL, 0, v55, 0x383u, 0LL);
              Microsoft::WRL::ComPtr<ID3D11Device5>::InternalRelease((__int64 *)&v78);
            }
            else
            {
              ...
              if ( DrawList < 0 )
              {
                MilInstrumentationCheckHR_MaybeFailFast(v58, 0LL, 0, DrawList, 0x387u, 0LL);
              }
              else
              {
                v79 = 0LL;
                ...
                if ( v59 < 0 )
                {
                  MilInstrumentationCheckHR_MaybeFailFast(v60, 0LL, 0, v59, 0x38Au, 0LL);
                }
                else
                {
                  CDrawListCache::Update(v79, *this, v96);
                  v61 = CDrawListCache::Render((__int64)v79, *this, (__int64)v86, 1.0);
                  v14 = v61;
                  if ( v61 >= 0 )
                  {
                    CDrawingContext::PopTransformInternal(*this, 1);
                    v63 = CDrawingContext::PopLayer(*this);
                    v14 = v63;
                    if ( v63 < 0 )
                    {
                      MilInstrumentationCheckHR_MaybeFailFast(v64, 0LL, 0, v63, 0x398u, 0LL);
                    }
                    else
                    {
                      ...
                      if ( v65 >= 0 )
                      {
                        ...
                        *(_OWORD *)v91 = 0LL;
                        ...
                        if ( v69 < 0 )
                        {
                          MilInstrumentationCheckHR_MaybeFailFast(v70, 0LL, 0, v69, 0x3ADu, 0LL);
                        }
                        else
                        {
                          ...
                          *(_QWORD *)&v81.left = &v78;
                          ...
                          if ( v14 < 0 )
                          {
                            MilInstrumentationCheckHR_MaybeFailFast((__int64)v71, 0LL, 0, v14, 0x3B4u, 0LL);
                          }
                          else
                          {
                            v94 = v90;
                        ...
                        Microsoft::WRL::ComPtr<ID3D11Device5>::InternalRelease((__int64 *)&v91[1]);
                        Microsoft::WRL::ComPtr<ID3D11Device5>::InternalRelease((__int64 *)v91);
                        if ( v78 )
                          CSurfaceDrawListBrush::`vector deleting destructor'(v78, 1);
                        goto LABEL_91;
                      }
                      MilInstrumentationCheckHR_MaybeFailFast(v66, 0LL, 0, v65, 0x39Cu, 0LL);
                    }
                    v75 = v79;
                    if ( v79 )
                    {
...
LABEL_76:
                  ...
                  MilInstrumentationCheckHR_MaybeFailFast(v62, 0LL, 0, v61, 0x391u, 0LL);
                }
                v76 = v79;
                if ( v79 )
                {
          ...
          MilInstrumentationCheckHR_MaybeFailFast(v54, 0LL, 0, v53, 0x37Au, 0LL);
          goto LABEL_76;
        }
        MilInstrumentationCheckHR_MaybeFailFast(v36, 0LL, 0, v35, 0x336u, 0LL);
      }
    }
    CShapePtr::Release((CShapePtr *)&v82);
    goto LABEL_91;
  ...
  *(_QWORD *)&v81.right = 0LL;
  ...
  if ( v14 < 0 )
  {
    MilInstrumentationCheckHR_MaybeFailFast(v13, 0LL, 0, v14, 0x30Du, 0LL);
  }
  else
  {
    ...
    MilInstrumentationCheckHR_MaybeFailFast(v17, 0LL, 0, v16, 0x30Fu, 0LL);
  }
  if ( v91[0] )
