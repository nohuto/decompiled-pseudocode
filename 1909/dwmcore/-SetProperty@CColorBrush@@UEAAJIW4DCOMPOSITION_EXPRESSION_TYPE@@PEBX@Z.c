/*
 * XREFs of ?SetProperty@CColorBrush@@UEAAJIW4DCOMPOSITION_EXPRESSION_TYPE@@PEBX@Z @ 0x1800B8620
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall CColorBrush::SetProperty(__int64 a1)
{
  ...
  {
    v7 = -2147024809;
    MilInstrumentationCheckHR_MaybeFailFast(v3, 0LL, 0, 0x80070057, 0x3Bu, 0LL);
  }
  return v7;
}
