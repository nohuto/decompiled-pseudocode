/*
 * XREFs of ?PreSubgraph@CShapeDrawingContext@@QEAAJPEA_N@Z @ 0x1802521B8
 * Callers:
 ...
 *     ??$_Emplace_reallocate@AEBVCShapeRenderTask@@@?$vector@VCShapeRenderTask@@V?$allocator@VCShapeRenderTask@@@std@@@std@@QEAAPEAVCShapeRenderTask@@QEAV2@AEBV2@@Z @ 0x1802517CC (--$_Emplace_reallocate@AEBVCShapeRenderTask@@@-$vector@VCShapeRenderTask@@V-$allocator@VCShapeRe.c)
...
__int64 __fastcall CShapeDrawingContext::PreSubgraph(CShapeDrawingContext *this, bool *a2)
{
  ...
  *a2 = 1;
  ...
  v8 = (*(__int64 (__fastcall **)(CSpriteVectorShape *, __int64))(*(_QWORD *)v3 + 48LL))(v3, 174LL);
  if ( v8 )
  {
    *a2 = 0;
    v20 = *((_OWORD *)v3 + 4);
  ...
  if ( v7 )
  {
    ...
    v11 = *v7;
    *(_QWORD *)&v20 = v10;
    (*(void (__fastcall **)(__int64 *, __int128 *, struct D2D_MATRIX_3X2_F *))(v11 + 216))(v7, &v20, &v24);
  ...
  if ( DoesIntersectUnsafe )
  {
    ...
    v5 = RenderTasks;
    if ( RenderTasks < 0 )
      MilInstrumentationCheckHR_MaybeFailFast(v18, 0LL, 0, RenderTasks, 0x14Bu, 0LL);
  }
  return v5;
}
