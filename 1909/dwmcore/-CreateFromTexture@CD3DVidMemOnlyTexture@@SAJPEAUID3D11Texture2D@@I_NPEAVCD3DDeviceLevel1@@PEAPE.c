/*
 * XREFs of ?CreateFromTexture@CD3DVidMemOnlyTexture@@SAJPEAUID3D11Texture2D@@I_NPEAVCD3DDeviceLevel1@@PEAPEAV1@@Z @ 0x180049938
 * Callers:
 ...
 *     ??0CD3DVidMemOnlyTexture@@IEAA@_N@Z @ 0x18004989C (--0CD3DVidMemOnlyTexture@@IEAA@_N@Z.c)
