/*
 * XREFs of ?InitDXGI@CDXGIEnumeration@@AEAAJXZ @ 0x180026A78
 * Callers:
...
LABEL_71:
    v22 = v3;
LABEL_72:
    MilInstrumentationCheckHR_MaybeFailFast(v4, &dword_1802BE018, 1u, v22, v24, 0LL);
    goto LABEL_33;
  }
...
LABEL_9:
  while ( (*(unsigned int (__fastcall **)(void *, _QWORD, __int64 *))(*(_QWORD *)ppFactory + 96LL))(ppFactory, v2, &v34) != -2005270526 )
  {
    ...
    {
      v5 = -2147024362;
      MilInstrumentationCheckHR_MaybeFailFast(v4, 0LL, 0, -2147024362, 0xB8u, 0LL);
    }
    else
    {
      ...
      v13 = DynArrayImpl<0>::AddMultipleAndSet((char *)this + 64, 8LL, 1LL, &v25);
      v5 = v13;
      if ( v13 < 0 )
...
LABEL_15:
  ...
  if ( !v2 )
  {
    v5 = -2003304291;
    v32 = -2003304291;
    MilInstrumentationCheckHR_MaybeFailFast(v8, &dword_1802BE018, 1u, -2003304291, 0x162u, 0LL);
LABEL_62:
    TranslateDXGIorD3DErrorInContext((unsigned int)v5, 5LL, &v32);
    v5 = v32;
    goto LABEL_34;
  }
  v14 = v27;
