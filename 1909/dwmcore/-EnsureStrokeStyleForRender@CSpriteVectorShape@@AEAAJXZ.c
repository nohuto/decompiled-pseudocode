/*
 * XREFs of ?EnsureStrokeStyleForRender@CSpriteVectorShape@@AEAAJXZ @ 0x1801F99B4
 * Callers:
...
__int64 __fastcall CSpriteVectorShape::EnsureStrokeStyleForRender(CSpriteVectorShape *this)
{
  ...
  if ( !*((_QWORD *)this + 15) )
  {
    ...
    v23 = 0LL;
    v24 = 0LL;
    std::vector<float>::reserve((__int64)&v22, v5 >> 2);
    v8 = 0LL;
    ...
    if ( v11 )
    {
      do
      {
        ...
        *(float *)&v25 = v12;
        if ( v24 == v10 )
        {
          std::vector<float>::_Emplace_reallocate<float const &>((__int64)&v22, v10, &v25);
          v10 = v23;
        }
        else
        {
    ...
    {
      MilInstrumentationCheckHR_MaybeFailFast(v17, 0LL, 0, D2DFactoryNoRef, 0x1FBu, 0LL);
    }
    else
    {
      v18 = v10 - v14;
      ...
      v3 = v19;
      if ( v19 < 0 )
        MilInstrumentationCheckHR_MaybeFailFast(v20, 0LL, 0, v19, 0x200u, 0LL);
    }
