/*
 * XREFs of ?IsHDRContent@CCompositionSurfaceBitmap@@UEBA_NXZ @ 0x18001AAD0
 * Callers:
 *     ?IsHDRContent@CCompositionSurfaceBitmap@@W7EBA_NXZ @ 0x1800F0D00 (-IsHDRContent@CCompositionSurfaceBitmap@@W7EBA_NXZ.c)
 * Callees:
