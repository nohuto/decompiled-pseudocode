/*
 * XREFs of ?DuplicateHandle@CHandleTable@@QEAAJPEAVCChannel@@I0PEAI@Z @ 0x180055CC0
 * Callers:
        ...
        unsigned int *a5)
{
  ...
  if ( Entry )
  {
    ...
    if ( NewEntry < 0 )
    {
      MilInstrumentationCheckHR_MaybeFailFast(v12, 0LL, 0, NewEntry, 0xC1u, 0LL);
    }
    else
    {
      v14 = v20;
      ...
      if ( v16 )
      {
        ...
        if ( v17 < 0 )
        {
          MilInstrumentationCheckHR_MaybeFailFast(v18, 0LL, 0, v17, 0xDEu, 0LL);
      ...
      {
        v13 = -2147024890;
        MilInstrumentationCheckHR_MaybeFailFast(v15, 0LL, 0, -2147024890, 0xCAu, 0LL);
      }
    }
  }
  else
  {
    v13 = -2147024890;
    MilInstrumentationCheckHR_MaybeFailFast(v10, 0LL, 0, -2147024890, 0xB8u, 0LL);
  }
