/*
 * XREFs of McTemplateU0pqnz @ 0x18015D4BC
 * Callers:
...
ULONG __fastcall McTemplateU0pqnz(
        __int64 a1,
        __int64 a2,
        __int64 a3,
        int a4,
        ...
        const wchar_t *a7)
{
  ...
  if ( !a7 )
    v7 = L"NULL";
  v18 = v7;
  return McGenEventWrite(Microsoft_Windows_Dwm_Core_Provider_Context, &EVTDESC_HWDEVICE_CREATE, 0LL, 5u, &v11);
}
