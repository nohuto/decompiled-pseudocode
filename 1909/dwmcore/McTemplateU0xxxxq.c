/*
 * XREFs of McTemplateU0xxxxq @ 0x180178380
 * Callers:
...
ULONG McTemplateU0xxxxq(__int64 a1, __int64 a2, ...)
{
  ...
  struct _EVENT_DATA_DESCRIPTOR v4; // [rsp+40h] [rbp-31h] BYREF
  ...
  v13 = &v3;
  v14 = 4LL;
  return McGenEventWrite(Microsoft_Windows_Dwm_Core_Provider_Context, &EVTDESC_SCHEDULE_PRESENT_Start, v16, 6u, &v4);
}
