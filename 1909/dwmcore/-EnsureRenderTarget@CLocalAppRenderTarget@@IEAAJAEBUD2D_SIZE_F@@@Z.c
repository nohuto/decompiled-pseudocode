/*
 * XREFs of ?EnsureRenderTarget@CLocalAppRenderTarget@@IEAAJAEBUD2D_SIZE_F@@@Z @ 0x18024EB68
 * Callers:
 ...
 *     ?SendCompSurfHandle@CLocalAppRenderTarget@@IEBAXPEAX@Z @ 0x18024F4EC (-SendCompSurfHandle@CLocalAppRenderTarget@@IEBAXPEAX@Z.c)
 */
