/*
 * XREFs of ?EndOverlayCandidateCollection@COverlayContext@@QEAAJPEBVCVisualTree@@PEBVCDirtyRegion@@PEAVCOcclusionContext@@PEA_N@Z @ 0x1800816B4
 * Callers:
 ...
 *     ?CopyTransientProperties@OverlayPlaneInfo@COverlayContext@@QEAAXAEBV12@@Z @ 0x180183FDC (-CopyTransientProperties@OverlayPlaneInfo@COverlayContext@@QEAAXAEBV12@@Z.c)
 ...
 *     ?RectIntersectsDirty@COverlayContext@@AEBA_NAEBV?$TMilRect_@MUMilRectF@@UMilPointAndSizeF@@UNotNeeded@RectUniqueness@@@@@Z @ 0x180185CBC (-RectIntersectsDirty@COverlayContext@@AEBA_NAEBV-$TMilRect_@MUMilRectF@@UMilPointAndSizeF@@UNotN.c)
        ...
        bool *a5)
{
  ...
  const struct CVisualTree *v62; // [rsp+28h] [rbp-D8h] BYREF
  bool *v63; // [rsp+30h] [rbp-D0h]
  unsigned __int64 v64; // [rsp+38h] [rbp-C8h] BYREF
  _BYTE v65[256]; // [rsp+40h] [rbp-C0h] BYREF
  float v66; // [rsp+140h] [rbp+40h] BYREF
  float v67; // [rsp+144h] [rbp+44h]
  float v68; // [rsp+148h] [rbp+48h]
  float v69; // [rsp+14Ch] [rbp+4Ch]
  _BYTE v70[16]; // [rsp+150h] [rbp+50h] BYREF

  v5 = a5;
  LODWORD(v6) = 0;
  v8 = (const struct CVisualTree *)a2;
  v62 = (const struct CVisualTree *)a2;
  v10 = 0;
  v63 = a5;
  v61 = 0;
...
LABEL_21:
      ...
      if ( *((_DWORD *)this + 3304) > (int)v6 )
      {
               ...
               v12) )
        {
          ...
          if ( (*(unsigned __int8 (__fastcall **)(__int64))(*(_QWORD *)(v35 + 144) + 88LL))(v35 + 144) )
          {
            ...
            {
              detail::vector_facade<COverlayContext::OverlayPlaneInfo,detail::buffer_impl<COverlayContext::OverlayPlaneInfo,16,1,detail::liberal_expansion_policy>>::clear((_QWORD *)this + 24);
            }
          }
        }
      }
    ...
    if ( (unsigned int)((*((_QWORD *)this + 25) - v26) >> 8) )
    {
      do
      {
        ...
        IsOccluded = COcclusionContext::IsOccluded(a4, v70, 0LL, v38);
        v40 = IsOccluded;
    ...
    while ( v27 != v28 )
    {
      ...
      if ( OverlayCandidateIndex == -1 )
      {
        if ( !(unsigned __int8)COverlayContext::RectIntersectsDirty(this, v27 + 152) )
        {
          ...
          v62 = (const struct CVisualTree *)(*v25 + ((v45 + 1LL) << 8));
          v48 = COverlayContext::OverlayPlaneInfo::OverlayPlaneInfo(
                  (COverlayContext::OverlayPlaneInfo *)v65,
...
LABEL_27:
    ...
    while ( 1 )
    {
      ...
      v52 = *((_QWORD *)this + 24);
      v53 = v49 + v52;
      v54 = *(_BYTE *)(v49 + v52 + 200);
      if ( !IsEligibleForOverlays )
        break;
      if ( v54 || (unsigned __int8)COverlayContext::RectContainedInDirty(this, v53 + 152, v51) )
      {
        ++v30;
        goto LABEL_98;
      }
...
LABEL_95:
        McTemplateU0xq(
          ...
          *(unsigned int *)(v56 + 40) | (unsigned __int64)((__int64)(int)HIDWORD(*(_QWORD *)(v56 + 40)) << 32),
          v57);
      }
LABEL_96:
      v62 = (const struct CVisualTree *)(v49 + *v25);
      detail::vector_facade<COverlayContext::OverlayPlaneInfo,detail::buffer_impl<COverlayContext::OverlayPlaneInfo,16,1,detail::liberal_expansion_policy>>::erase(
        (char *)this + 192,
        &v66,
        &v62);
