/*
 * XREFs of ?TemporaryInteractionConfigurationUpdate@GestureTargeting@InputTraceLogging@@SAXPEBUInteractionUpdate@CManipulationManager@@@Z @ 0x180239B84
 * Callers:
        ...
        const struct CManipulationManager::InteractionUpdate *a1)
{
  ...
  if ( *(_DWORD *)v4 > 4u && TlgKeywordOn((TraceLoggingHProvider)v3[1], 0x800uLL) )
  {
    ...
    if ( (v2 & 0x20) == 0 )
      v37 = v36;
    TlgCreateSz(&v85, v37);
    TlgWrite(v4, &unk_1802DE29D, 0LL, 0LL, 0x16u, &pData);
  }
}
