/*
 * XREFs of ?FeatureLoggingHook@details@wil@@YAXIPEBUFEATURE_LOGGED_TRAITS@@PEBUFEATURE_ERROR@@HPEBW4wil_ReportingKind@@PEBW4wil_VariantReportingKind@@E_K@Z @ 0x1800D6340
 * Callers:
 *     <none>
 * Callees:
    ...
    if ( a5 )
    {
      ...
      if ( **(_DWORD **)(v16 + 8) > 5u && TlgKeywordOn(*(TraceLoggingHProvider *)(v16 + 8), 2uLL) )
      {
        ...
        *(_QWORD *)&pDesc.Size = 4LL;
        v59 = 8LL;
        TlgWrite(v19, &unk_1802DE8C3, 0LL, 0LL, 9u, &pData);
      }
      if ( *((_BYTE *)a2 + 4) == 1 )
      {
        if ( v9 )
        {
          ...
          if ( *(_DWORD *)v23 > 5u )
          {
            if ( TlgKeywordOn(v23, 0xAuLL) )
            {
              ...
              *(_QWORD *)&pDesc.Size = 4LL;
              v59 = 8LL;
              TlgWrite(v24, &unk_1802DE934, 0LL, 0LL, 9u, &pData);
            }
          }
        }
      }
      ...
      if ( a6 )
      {
        ...
        if ( *(_DWORD *)v26 > 5u && TlgKeywordOn(v26, 4uLL) )
        {
          ...
          *(_QWORD *)&pDesc.Size = 4LL;
          v59 = 1LL;
          *(_QWORD *)&v60.Size = 8LL;
          TlgWrite(v28, &unk_1802DE71B, 0LL, 0LL, 0xAu, &pData);
        }
      }
      else if ( a3 )
      {
        ...
        if ( **(_DWORD **)(v32 + 8) > 2u )
        {
          if ( TlgKeywordOn(*(TraceLoggingHProvider *)(v32 + 8), 1uLL) )
          {
            ...
            v73 = 4LL;
            v72 = (char *)a3 + 80;
            TlgWrite(v40, &unk_1802DE7A3, 0LL, 0LL, 0x14u, &pData);
          }
        }
      }
    }
