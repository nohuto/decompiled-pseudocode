/*
 * XREFs of ?HrFindInterface@CPathEmitterArea@EmitterShapes@@MEAAJAEBU_GUID@@PEAPEAX@Z @ 0x18020B460
 * Callers:
 *     <none>
 * Callees:
        ...
        void **a3)
{
  ...
  {
    v3 = -2147467262;
    MilInstrumentationCheckHR_MaybeFailFast((__int64)this, 0LL, 0, 0x80004002, 0x130u, 0LL);
  }
  else
  {
