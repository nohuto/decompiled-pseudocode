/*
 * XREFs of ?ProcessSetDiagnosticItemId@CAnimationLoggingManager@@QEAAJPEAVCResourceTable@@PEBUtagMILCMD_ANIMATIONLOGGINGMANAGER_SETDIAGNOSTICITEMID@@@Z @ 0x1801BF5BC
 * Callers:
    ...
    *((_DWORD *)DebugInfoForResource + 11) = *((_DWORD *)a3 + 5);
    if ( *((_DWORD *)a3 + 4) )
    {
      if ( *((_DWORD *)a3 + 3) != -1 )
      {
        ...
        {
          v10 = *((_DWORD *)a3 + 3);
          v11 = *(_QWORD *)(*((_QWORD *)this + 2) + 384LL);
          v12 = *((_DWORD *)a3 + 2);
          *(_QWORD *)v9 = this;
          v9[2] = v12;
          *((_QWORD *)v9 + 2) = v11;
        ...
        if ( v9 )
        {
          v13 = (*(__int64 (__fastcall **)(_QWORD))(**(_QWORD **)(*((_QWORD *)this + 2) + 552LL) + 88LL))(*(_QWORD *)(*((_QWORD *)this + 2) + 552LL));
          v14 = (*(__int64 (__fastcall **)(__int64, __int64 (__fastcall *)(void *), _DWORD *, __int64))(*(_QWORD *)v13 + 136LL))(
                  v13,
