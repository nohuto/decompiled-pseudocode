/*
 * XREFs of ?SetTemporaryConfiguration@CInteraction@@UEAAJW4TemporaryConfigurationAxis@@W4Enum@InteractionConfigurationUpdateType@@_NU?$TMILFlagsEnum@W4FlagsEnum@DwmInteractionTypeTouchPrimitiveType@@@@@Z @ 0x1801D6780
 * Callers:
 *     <none>
 * Callees:
  ...
  else
  {
    ...
    else
    {
      if ( dword_180337240 > 4u && TlgKeywordOn((TraceLoggingHProvider)&dword_180337240, 2uLL) )
      {
        ...
        v23 = a5;
        v39 = v16;
        TlgWrite(v15, &unk_1802DA55C, 0LL, 0LL, 7u, &pData);
      }
      if ( dword_18033D560 )
        SetEvent(hEvent);
    }
