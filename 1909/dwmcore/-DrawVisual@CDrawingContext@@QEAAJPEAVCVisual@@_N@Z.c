/*
 * XREFs of ?DrawVisual@CDrawingContext@@QEAAJPEAVCVisual@@_N@Z @ 0x18002407C
 * Callers:
 *     ?DrawVisual@CDrawingContext@@UEAAJPEAVCVisual@@@Z @ 0x180020BE0 (-DrawVisual@CDrawingContext@@UEAAJPEAVCVisual@@@Z.c)
 ...
 *     ?Draw@CRedirectedVisualContent@@UEAAJPEAVCDrawingContext@@AEBUD2D_SIZE_F@@PEA_NPEAV?$TMilRect_@MUMilRectF@@UMilPointAndSizeF@@UNotNeeded@RectUniqueness@@@@@Z @ 0x18020C610 (-Draw@CRedirectedVisualContent@@UEAAJPEAVCDrawingContext@@AEBUD2D_SIZE_F@@PEA_NPEAV-$TMilRect_@M.c)
 * Callees:
 ...
 *     ?Top@?$CWatermarkStack@M$0EA@$01$09@@QEBAJPEAMI@Z @ 0x180024550 (-Top@-$CWatermarkStack@M$0EA@$01$09@@QEBAJPEAMI@Z.c)
    ...
    if ( VisualTree >= 0 )
    {
      ...
      if ( !IsEmpty(&v25) )
      {
        ...
        else
        {
          ...
          v14 = CDrawingContext::BeginFrame(v12, (__int64)TopByReference, 0LL, 0, 0LL);
          v5 = v14;
          if ( v14 < 0 )
          {
          ...
          else
          {
            ...
            *((_DWORD *)v12 + 66) = *((_DWORD *)this + 66);
            ...
            v16 = CWatermarkStack<enum MilBitmapInterpolationMode::Enum,64,2,10>::Push((char *)v12 + 3264, &v23);
            v5 = v16;
            if ( v16 < 0 )
            {
            ...
            else
            {
              ...
              v19 = CDrawingContext::DrawVisualTree(v12, 0x7FFFFFFF, 0, 1, !IsBounding, 0LL, 0, 1);
              v5 = v19;
              if ( v19 < 0 )
              {
