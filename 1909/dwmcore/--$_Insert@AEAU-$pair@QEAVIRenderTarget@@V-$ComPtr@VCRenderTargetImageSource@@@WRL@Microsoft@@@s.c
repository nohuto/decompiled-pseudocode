...
__int64 __fastcall std::_Hash<std::_Umap_traits<IRenderTarget *,Microsoft::WRL::ComPtr<CRenderTargetImageSource>,std::_Uhash_compare<IRenderTarget *,std::hash<IRenderTarget *>,std::equal_to<IRenderTarget *>>,std::allocator<std::pair<IRenderTarget * const,Microsoft::WRL::ComPtr<CRenderTargetImageSource>>>,0>>::_Insert<std::pair<IRenderTarget * const,Microsoft::WRL::ComPtr<CRenderTargetImageSource>> &,std::_List_unchecked_iterator<std::_List_val<std::_List_simple_types<std::pair<IRenderTarget * const,Microsoft::WRL::ComPtr<CRenderTargetImageSource>>>>>>(
        __int64 a1,
        __int64 a2,
        unsigned __int8 *a3,
        __int64 *a4)
{
  ...
  __int64 v29; // rbp
  __int64 v30; // rbx
  char v31[40]; // [rsp+20h] [rbp-28h] BYREF
  ...
  if ( a3 < a3 + 8 )
  {
    ...
    while ( (unsigned __int8 *)(a3 - v6) != v9 );
  }
  v11 = (__int64 *)std::_Hash<std::_Umap_traits<CResource *,CAnimationLoggingManager::ResourceDebugInfo,std::_Uhash_compare<CResource *,std::hash<CResource *>,std::equal_to<CResource *>>,std::allocator<std::pair<CResource * const,CAnimationLoggingManager::ResourceDebugInfo>>,0>>::_End(
                     a1,
                     &v32,
                     v8 & *(_QWORD *)(a1 + 48));
  v14 = 2 * v13;
  v15 = *v11;
  v16 = *v11;
  while ( v16 != *(_QWORD *)(*(_QWORD *)(a1 + 24) + 8 * v14) )
  {
    v16 = *(_QWORD *)(v15 + 8);
    v15 = v16;
  ...
  {
    v26 = *(__int64 ***)(v18 + 8 * v14 + 8);
    v27 = *v26;
    *(_QWORD *)(v18 + 8 * v14 + 8) = *v26;
    if ( v27 != a4 )
