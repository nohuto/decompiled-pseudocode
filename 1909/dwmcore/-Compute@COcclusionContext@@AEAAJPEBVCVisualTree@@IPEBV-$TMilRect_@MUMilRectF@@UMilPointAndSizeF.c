/*
 * XREFs of ?Compute@COcclusionContext@@AEAAJPEBVCVisualTree@@IPEBV?$TMilRect_@MUMilRectF@@UMilPointAndSizeF@@UNotNeeded@RectUniqueness@@@@M_NPEBVCMILMatrix@@AEBV?$span@PEAVCOverlayContext@@$0?0@gsl@@@Z @ 0x180096F30
 * Callers:
        ...
        _OWORD *a8)
{
  ...
  *((_DWORD *)this + 296) = 0;
  ...
  {
    v17 = -2147024882;
    MilInstrumentationCheckHR_MaybeFailFast(v29, 0LL, 0, 0x8007000E, 0xD2u, 0LL);
    goto LABEL_13;
  }
  if ( (_DWORD)v12 )
  {
    ...
    do
    {
      if ( v8 )
      {
        CMILMatrix::Transform2DBoundsHelper<0>(
          (COcclusionContext *)((char *)this + 896),
          (__int64)v31 + v32,
          (float *)&v43);
        v33 = v43;
      }
...
LABEL_4:
  ...
  *((_BYTE *)this + 825) = v21;
  v15 = CVisualTreeIterator::WalkSubtree<COcclusionContext>(
          (__int64)this + 48,
