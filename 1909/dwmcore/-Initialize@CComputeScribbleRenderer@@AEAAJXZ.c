/*
 * XREFs of ?Initialize@CComputeScribbleRenderer@@AEAAJXZ @ 0x1801AC0A0
 * Callers:
...
__int64 __fastcall CComputeScribbleRenderer::Initialize(CComputeScribbleRenderer *this)
{
  ...
  v2 = *(__int64 **)(*(_QWORD *)((*(__int64 (__fastcall **)(_QWORD))(**(_QWORD **)this + 104LL))(*(_QWORD *)this) + 16)
                   + 80LL);
  v3 = *(CSwapChainBase **)(*(_QWORD *)this + 176LL);
  v4 = *((_DWORD *)v3 + 40);
  *((_DWORD *)this + 4) = v4;
  v5 = v4;
  v7 = v4;
...
LABEL_27:
  ...
  v25 = *(_QWORD *)this;
  v31 = 1;
  v26 = CComputeScribbleRenderer::CScheduler::Create(*(const struct CDisplay **)(v25 + 168), lpVtbl, &v30);
  if ( v31 )
  {
    v27 = *v29;
    *v29 = v30;
