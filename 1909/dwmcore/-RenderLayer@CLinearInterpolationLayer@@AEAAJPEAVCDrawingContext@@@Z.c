/*
 * XREFs of ?RenderLayer@CLinearInterpolationLayer@@AEAAJPEAVCDrawingContext@@@Z @ 0x18017D4C8
 * Callers:
...
__int64 __fastcall CLinearInterpolationLayer::RenderLayer(CLinearInterpolationLayer *this, struct CDrawingContext *a2)
{
  ...
  *((float *)&v18 + 3) = _mm_cvtepi32_ps(v5).m128_f32[0] + 0.0;
  ...
  else
  {
    ...
    v10 = CDrawingContext::PushTransformInternal(a2, 0LL, (const struct CMILMatrix *)v16, 0LL, 0);
    v9 = v10;
    if ( v10 < 0 )
    {
