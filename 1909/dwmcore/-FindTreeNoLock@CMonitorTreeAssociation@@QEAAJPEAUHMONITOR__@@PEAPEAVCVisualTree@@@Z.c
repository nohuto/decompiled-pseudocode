/*
 * XREFs of ?FindTreeNoLock@CMonitorTreeAssociation@@QEAAJPEAUHMONITOR__@@PEAPEAVCVisualTree@@@Z @ 0x1800A9E38
 * Callers:
        ...
        struct CVisualTree **a3)
{
  ...
  *a3 = 0LL;
  ...
  {
    v5 = -2003292412;
    MilInstrumentationCheckHR_MaybeFailFast((__int64)this, &dword_1802BE430, 1u, 0x88982F04, 0x90u, 0LL);
  }
  return v5;
}
