/*
 * XREFs of ?SendUpdateToRenderThread@CManipulationTelemetryData@@UEAAJXZ @ 0x180234730
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall CManipulationTelemetryData::SendUpdateToRenderThread(CManipulationTelemetryData *this)
{
  ...
  *((LARGE_INTEGER *)this + 10) = PerformanceCount;
  ...
  if ( dword_180337240 > 5u && TlgKeywordOn((TraceLoggingHProvider)&dword_180337240, 2uLL) )
  {
    ...
    v52 = 4LL;
    v54 = 4LL;
    TlgWrite((TraceLoggingHProvider)&dword_180337240, &unk_1802DD878, 0LL, 0LL, 0xDu, &pData);
  }
  ...
  if ( v8 )
  {
    ...
    v22 = v8;
    LOWORD(cData) = 0;
    ManipulationManager = CoreUICallSend(v16, &v22, 1LL, 11LL, cData, &unk_1802B119A, (unsigned int)&QuadPart, v30);
    v6 = ManipulationManager;
    if ( ManipulationManager >= 0 )
    {
