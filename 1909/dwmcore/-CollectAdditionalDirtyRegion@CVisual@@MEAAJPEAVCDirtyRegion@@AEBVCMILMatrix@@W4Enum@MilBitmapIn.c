/*
 * XREFs of ?CollectAdditionalDirtyRegion@CVisual@@MEAAJPEAVCDirtyRegion@@AEBVCMILMatrix@@W4Enum@MilBitmapInterpolationMode@@PEBV?$CRectF@UPageInPixels@CoordinateSpace@@@@@Z @ 0x1800799F0
 * Callers:
      ...
      if ( *(_DWORD *)(v14 + 72) )
      {
        ...
        if ( v27 )
        {
          ...
          while ( 1 )
          {
            ...
            if ( (unsigned __int8)CVisual::AdjustContentWorldBounds(this, &v29) )
            {
              if ( a5 )
              {
                v17 = *a5;
