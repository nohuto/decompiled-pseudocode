/*
 * XREFs of ?QueryObjectPropertyValue@CExpressionValueStack@@AEAAJPEAVCExpression@@PEAUExpressionReferenceNode@@_KPEAVCExpressionValue@@PEAVSubchannelMaskInfo@@@Z @ 0x180202560
 * Callers:
 ...
 *     ?ShouldLogPerfStats@CBaseExpression@@IEAA_NXZ @ 0x1801E6AE4 (-ShouldLogPerfStats@CBaseExpression@@IEAA_NXZ.c)
 */
        ...
        struct SubchannelMaskInfo *a6)
{
  ...
  v12 = (*(__int64 (__fastcall **)(struct CExpression *, _QWORD, struct CResource **))(*(_QWORD *)a2 + 280LL))(
          a2,
          *((unsigned int *)v10 + 5),
          &v24);
  v14 = v12;
  if ( v12 < 0 )
  {
    MilInstrumentationCheckHR_MaybeFailFast(v13, &dword_1802A1DA8, 1u, v12, 0xF4u, 0LL);
  }
  else
  {
    if ( v6 )
    ...
    if ( v16 < 0 )
    {
      MilInstrumentationCheckHR_MaybeFailFast(v17, &dword_1802A1DA8, 1u, v16, 0xFBu, 0LL);
    }
    else if ( a6 && *((_BYTE *)a6 + 4) && (v18 = CExpressionValue::ApplyMaskToValue(a5, a6), v14 = v18, v18 < 0) )
    {
      MilInstrumentationCheckHR_MaybeFailFast(v19, &dword_1802A1DA8, 1u, v18, 0x10Bu, 0LL);
    }
    else
    {
      v20 = *((_QWORD *)a2 + 22);
