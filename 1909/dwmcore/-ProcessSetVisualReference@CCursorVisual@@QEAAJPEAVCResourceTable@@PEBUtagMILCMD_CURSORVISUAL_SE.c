/*
 * XREFs of ?ProcessSetVisualReference@CCursorVisual@@QEAAJPEAVCResourceTable@@PEBUtagMILCMD_CURSORVISUAL_SETVISUALREFERENCE@@@Z @ 0x180212BB8
 * Callers:
        ...
        const struct tagMILCMD_CURSORVISUAL_SETVISUALREFERENCE *a3)
{
  ...
  if ( v7 )
  {
    ...
    {
      v6 = -2003303421;
      MilInstrumentationCheckHR_MaybeFailFast(v9, 0LL, 0, 0x88980403, 0x61u, 0LL);
    }
  }
  return v6;
}
