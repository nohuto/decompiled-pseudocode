/*
 * XREFs of ?GetAdapterNoRefFromLuid@CDXGIEnumeration@@QEBAJU_LUID@@PEAPEAVCDXGIAdapterLimited@@@Z @ 0x180027BF0
 * Callers:
        ...
        struct CDXGIAdapterLimited **a3)
{
  ...
  v5 = -2003304307;
  MilInstrumentationCheckHR_MaybeFailFast((unsigned int)this, &dword_180280CA0, 1u, -2003304307, v8, 0LL);
  return v5;
}
