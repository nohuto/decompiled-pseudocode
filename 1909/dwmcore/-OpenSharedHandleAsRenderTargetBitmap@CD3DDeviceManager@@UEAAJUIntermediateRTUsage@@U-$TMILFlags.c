/*
 * XREFs of ?OpenSharedHandleAsRenderTargetBitmap@CD3DDeviceManager@@UEAAJUIntermediateRTUsage@@U?$TMILFlagsEnum@W4FlagsEnum@MilRTInitialization@@@@PEAUPixelFormatInfo@@U_LUID@@VDisplayId@@PEAX_NPEAPEAVIRenderTargetBitmap@@@Z @ 0x18015DCA0
 * Callers:
        ...
        _QWORD *a9)
{
  ...
  *a9 = 0LL;
  ...
  if ( v18 < 0 )
  {
    MilInstrumentationCheckHR_MaybeFailFast(v17, &dword_1802E1E90, 1u, v18, 0x6BDu, 0LL);
  }
  else
  {
    ...
    if ( D3DDevice < 0 )
    {
      MilInstrumentationCheckHR_MaybeFailFast(v20, &dword_1802E1E90, 1u, D3DDevice, 0x6BFu, 0LL);
      v10 = v27;
      goto LABEL_13;
    }
    v10 = v27;
    ...
    if ( v21 < 0 )
    {
      MilInstrumentationCheckHR_MaybeFailFast(v22, &dword_1802E1E90, 1u, v21, 0x6C9u, 0LL);
      v12 = v28;
    }
    else
    {
      ...
      v18 = v23;
      if ( v23 < 0 )
        MilInstrumentationCheckHR_MaybeFailFast(v24, &dword_1802E1E90, 1u, v23, 0x6CCu, 0LL);
    }
  }
  if ( v12 )
