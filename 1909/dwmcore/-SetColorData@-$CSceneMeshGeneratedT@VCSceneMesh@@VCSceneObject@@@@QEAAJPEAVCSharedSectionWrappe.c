/*
 * XREFs of ?SetColorData@?$CSceneMeshGeneratedT@VCSceneMesh@@VCSceneObject@@@@QEAAJPEAVCSharedSectionWrapper@@@Z @ 0x1801A04E8
 * Callers:
        ...
        struct CResource *a2)
{
  ...
  if ( a2 != this[16] )
  {
    ...
    if ( v5 < 0 )
    {
      MilInstrumentationCheckHR_MaybeFailFast(v6, 0LL, 0, v5, 0x2DEu, 0LL);
    }
    else
    {
