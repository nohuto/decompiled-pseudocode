/*
 * XREFs of ?AdvanceInertiaToTimeInertiaModifier@CMotion@@AEAAMPEAVCExpressionValueStack@@_K@Z @ 0x18020E3D0
 * Callers:
        ...
        __int64 a3)
{
  ...
  if ( dword_180337240 > 4u )
  {
    if ( TlgKeywordOn((TraceLoggingHProvider)&dword_180337240, 2uLL) )
    {
      ...
      v34 = v15;
      v35 = 4;
      TlgWrite((TraceLoggingHProvider)&dword_180337240, &unk_1802DB72D, 0LL, 0LL, 8u, &pData);
      return v16;
    }
  }
  return result;
