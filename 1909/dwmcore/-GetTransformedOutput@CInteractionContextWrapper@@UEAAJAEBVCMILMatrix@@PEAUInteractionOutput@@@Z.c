/*
 * XREFs of ?GetTransformedOutput@CInteractionContextWrapper@@UEAAJAEBVCMILMatrix@@PEAUInteractionOutput@@@Z @ 0x180232D50
 * Callers:
 *     <none>
 * Callees:
    ...
    *((_DWORD *)a3 + 14) = *((_DWORD *)v3 + 14);
    if ( dword_180337240 > 4u )
    {
      if ( TlgKeywordOn((TraceLoggingHProvider)&dword_180337240, 2uLL) )
      {
        ...
        v35 = v11;
        v37 = v11;
        TlgWrite(v10, &unk_1802DD0C0, 0LL, 0LL, 0xDu, &pData);
        return v13;
      }
    }
  }
