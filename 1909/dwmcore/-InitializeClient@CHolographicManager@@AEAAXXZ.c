/*
 * XREFs of ?InitializeClient@CHolographicManager@@AEAAXXZ @ 0x1802404F4
 * Callers:
...
void __fastcall CHolographicManager::InitializeClient(CHolographicManager *this)
{
  ...
  for ( k = (_QWORD *)*((_QWORD *)this + 18); k != *((_QWORD **)this + 19); ++k )
  {
    v7 = (struct IUnknown *)((*k + 64LL) & -(__int64)(*k != 0LL));
    CHolographicInteropTaskQueue::PostMessageW(*((CHolographicInteropTaskQueue **)this + 6), 2u, v7, 0LL, 0LL, 0LL, 0LL);
    CHolographicInteropTaskQueue::PostMessageW(*((CHolographicInteropTaskQueue **)this + 6), 1u, v7, 0LL, 0LL, 0LL, 0LL);
  }
