/*
 * XREFs of ?Transform3DGroupUpdate@CChannel@@UEAAJIPEBII@Z @ 0x180157F70
 * Callers:
 *     <none>
 * Callees:
        ...
        unsigned int a4)
{
  ...
  CChannel::CheckHandle((__int64)this, a2, 181);
  v8 = 4LL * a4;
  ...
  {
    v11 = -2147024362;
    MilInstrumentationCheckHR_MaybeFailFast(0xFFFFFFFFLL, 0LL, 0, 0x80070216, 0xAEDu, 0LL);
  }
  else
  {
    si128.m128i_i32[3] = 0;
    ...
    if ( v9 < 0 )
    {
      MilInstrumentationCheckHR_MaybeFailFast(v10, 0LL, 0, v9, 0xAEFu, 0LL);
    }
    else
    {
