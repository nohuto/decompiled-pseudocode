/*
 * XREFs of ?AdvanceInertiaToTime@CMotion@@UEAAMPEAVCExpressionValueStack@@_KMMM@Z @ 0x18020E190
 * Callers:
        ...
        float a6)
{
  ...
  *((float *)this + 9) = a5;
  ...
  if ( dword_180337240 > 4u && TlgKeywordOn((TraceLoggingHProvider)&dword_180337240, 2uLL) )
  {
    ...
    v33 = v19;
    v36 = v19;
    TlgWrite((TraceLoggingHProvider)&dword_180337240, &unk_1802DB7DE, 0LL, 0LL, 7u, &pData);
  }
  return v21;
}
