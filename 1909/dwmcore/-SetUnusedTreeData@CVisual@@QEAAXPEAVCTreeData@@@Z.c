/*
 * XREFs of ?SetUnusedTreeData@CVisual@@QEAAXPEAVCTreeData@@@Z @ 0x18007B3C0
 * Callers:
...
void __fastcall CVisual::SetUnusedTreeData(CVisual *this, struct CTreeData *a2)
{
  ...
  if ( a2 )
  {
    ...
    {
      *(_QWORD *)CSparseAlignedStorage<8,8>::AllocatedStorage::ReserveSlot((__int64)this + 224, 6) = a2;
    }
  }
  else if ( v5 )
  {
