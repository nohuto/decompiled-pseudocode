/*
 * XREFs of ?LockForRead@CHwTextureRenderTarget@@UEBAJAEBV?$TMilRect@IUMilRectU@@UNotNeeded@RectUniqueness@@@@PEAPEAVIBitmapLock@@@Z @ 0x1801620B0
 * Callers:
 *     <none>
 * Callees:
...
LABEL_13:
  ...
  else
  {
    ...
    if ( v10 < 0 )
    {
      MilInstrumentationCheckHR_MaybeFailFast(v11, 0LL, 0, v10, 0x31Eu, 0LL);
      goto LABEL_15;
    }
  ...
  v12 = v9;
LABEL_14:
  MilInstrumentationCheckHR_MaybeFailFast(a1, 0LL, 0, v12, v14, 0LL);
LABEL_15:
  if ( v16 )
