/*
 * XREFs of ?CalculateFigureLength@Figure@CPathEmitterEdge@EmitterShapes@@QEAAX_N@Z @ 0x18020AA3C
 * Callers:
 *     ?EndFigure@CPathEmitterEdge@EmitterShapes@@EEAAXW4D2D1_FIGURE_END@@@Z @ 0x18020AE40 (-EndFigure@CPathEmitterEdge@EmitterShapes@@EEAAXW4D2D1_FIGURE_END@@@Z.c)
 * Callees:
        ...
        char a2)
{
  ...
  if ( a2 )
  {
    ...
    if ( *((float **)this + 5) == v6 )
    {
      std::vector<float>::_Emplace_reallocate<float const &>((__int64)this + 24, v6, &v10);
    }
    else
    {
      *((_QWORD *)this + 4) += 4LL;
