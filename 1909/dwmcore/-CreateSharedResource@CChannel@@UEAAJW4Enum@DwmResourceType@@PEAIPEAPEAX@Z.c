/*
 * XREFs of ?CreateSharedResource@CChannel@@UEAAJW4Enum@DwmResourceType@@PEAIPEAPEAX@Z @ 0x1801564B0
 * Callers:
 *     <none>
 * Callees:
...
LABEL_4:
    ...
    v13 = NtDCompositionReferenceSharedResourceOnDwmChannel(*(unsigned int *)(a1 + 56), hObject, v22, &v18, &v17);
    if ( v13 < 0 )
    {
      v10 = v13 | 0x10000000;
      v16 = 719;
  ...
  v12 = v8;
LABEL_12:
  MilInstrumentationCheckHR_MaybeFailFast(v9, 0LL, 0, v12, v16, 0LL);
  if ( hObject )
    CloseHandle(hObject);
LABEL_14:
