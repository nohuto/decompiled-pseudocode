/*
 * XREFs of ?GetBits@CHwndRenderTarget@@UEAAJPEBUtagRECT@@PEAVIBitmapDest@@@Z @ 0x180022C00
 * Callers:
        ...
        __int64 (__fastcall ***a3)(struct IBitmapDest *, GUID *, __int64 *))
{
  ...
  {
    v6 = -2003304442;
    MilInstrumentationCheckHR_MaybeFailFast(v4, 0LL, 0, -2003304442, 0x57Au, 0LL);
    return v6;
  }
