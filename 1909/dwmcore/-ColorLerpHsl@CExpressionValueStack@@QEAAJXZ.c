/*
 * XREFs of ?ColorLerpHsl@CExpressionValueStack@@QEAAJXZ @ 0x18001C744
 * Callers:
 ...
 *     ?ColorLerp@CExpressionValueStack@@QEAAJXZ @ 0x1801FEBF0 (-ColorLerp@CExpressionValueStack@@QEAAJXZ.c)
 * Callees:
