/*
 * XREFs of ?RenderBlackContent@CWindowNode@@AEAAJPEAVCDrawingContext@@@Z @ 0x1802182EC
 * Callers:
...
__int64 __fastcall CWindowNode::RenderBlackContent(CWindowNode *this, struct CDrawingContext *a2)
{
  ...
  else
  {
    ...
    {
      MilInstrumentationCheckHR_MaybeFailFast((__int64)v4, 0LL, 0, WindowClipShape, 0xC76u, 0LL);
      goto LABEL_8;
    }
    v5 = v11;
  }
  ...
  v7 = v8;
  if ( v8 < 0 )
    MilInstrumentationCheckHR_MaybeFailFast(v9, 0LL, 0, v8, 0xC79u, 0LL);
LABEL_8:
