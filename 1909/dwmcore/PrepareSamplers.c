/*
 * XREFs of PrepareSamplers @ 0x1800320B4
 * Callers:
...
__int64 __fastcall PrepareSamplers(__int64 a1, __int64 a2, _QWORD *a3)
{
  ...
  FragmentsModuleNoRef = CShaderLinkingGraphBuilder::GetFragmentsModuleNoRef(a1, &v18);
...
LABEL_6:
        if ( (unsigned __int64)(unsigned int)v9 >= *a3 )
          goto LABEL_18;
        v13 = PopulateSamplerArguments(v4, a2, v9, (_DWORD)v12, (__int64)v10);
        v8 = v13;
        if ( v13 < 0 )
        {
