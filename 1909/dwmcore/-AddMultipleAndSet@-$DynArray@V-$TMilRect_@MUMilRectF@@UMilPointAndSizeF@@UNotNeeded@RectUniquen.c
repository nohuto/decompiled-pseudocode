/*
 * XREFs of ?AddMultipleAndSet@?$DynArray@V?$TMilRect_@MUMilRectF@@UMilPointAndSizeF@@UNotNeeded@RectUniqueness@@@@$0A@@@QEAAJPEFBV?$TMilRect_@MUMilRectF@@UMilPointAndSizeF@@UNotNeeded@RectUniqueness@@@@I@Z @ 0x1800B7AC0
 * Callers:
        ...
        unsigned int a3)
{
  ...
  else if ( v5 > *(_DWORD *)(a1 + 20) )
  {
    ...
    if ( (int)result < 0 )
    {
      MilInstrumentationCheckHR_MaybeFailFast(v7, 0LL, 0, result, 0xC3u, 0LL);
      return v8;
    }
  }
  else
