/*
 * XREFs of ?RenderWorker@CComposeTop@@AEAAJPEAVCDrawingContext@@AEBVCMILMatrix@@AEBVCShape@@PEAV?$TMilRect_@MUMilRectF@@UMilPointAndSizeF@@UNotNeeded@RectUniqueness@@@@@Z @ 0x1801FE124
 * Callers:
        ...
        _OWORD *a5)
{
  ...
  if ( v11 < 0 )
  {
    MilInstrumentationCheckHR_MaybeFailFast(v12, 0LL, 0, v11, 0x16Au, 0LL);
LABEL_14:
    if ( !v8 )
      goto LABEL_16;
    goto LABEL_15;
...
LABEL_12:
  ...
  if ( v14 < 0 )
  {
    MilInstrumentationCheckHR_MaybeFailFast(v15, 0LL, 0, v14, 0x178u, 0LL);
    goto LABEL_18;
  }
  v9 = 1;
  v16 = CDrawingContext::PushTransformInternal(a2, 0LL, (const struct CMILMatrix *)v25, 0LL, 1);
  v13 = v16;
  if ( v16 >= 0 )
  {
    v8 = 1;
    ...
    if ( v18 < 0 )
    {
      MilInstrumentationCheckHR_MaybeFailFast(v19, 0LL, 0, v18, 0x17Fu, 0LL);
LABEL_15:
...
LABEL_16:
    ...
    if ( v20 < 0 )
    {
      MilInstrumentationCheckHR_MaybeFailFast(v21, 0LL, 0, v20, 0x184u, 0LL);
      goto LABEL_15;
    }
    goto LABEL_12;
  }
  MilInstrumentationCheckHR_MaybeFailFast(v17, 0LL, 0, v16, 0x17Bu, 0LL);
LABEL_17:
