/*
 * XREFs of ?GenerateImageSourceForEffectInput@CWindowBackgroundTreatment@@QEAAJPEAVCDrawingContext@@@Z @ 0x180011164
 * Callers:
        ...
        struct CDrawingContext *a2)
{
  ...
  *(_QWORD *)&this[23].left = 0LL;
  Microsoft::WRL::ComPtr<ID3D11Device5>::InternalRelease((char *)&v44 + 8);
