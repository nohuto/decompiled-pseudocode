...
__int64 *__fastcall std::_Tree_val<std::_Tree_simple_types<std::pair<std::wstring const * const,unsigned int>>>::_Extract(
        __int64 **a1,
        _QWORD *a2)
{
  _QWORD *v2; // r8
...
LABEL_12:
    ...
    if ( (__int64 *)**a1 == v6 )
    {
      if ( *(_BYTE *)(v3 + 25) )
        ...
        v11 = std::_Tree_val<std::_Tree_simple_types<std::pair<unsigned int const,StereoscopicViewData>>>::_Min(
                v3,
                a2,
                v9);
      *v9 = v11;
