/*
 * XREFs of ?LogTelemetry@CDisplaySet@@SAXPEAV1@0W4Enum@DisplayStateComparison@@@Z @ 0x1800B6770
 * Callers:
 ...
 *     ?ShouldTripleBuffer@CDisplay@@QEBA_NXZ @ 0x18001D7E4 (-ShouldTripleBuffer@CDisplay@@QEBA_NXZ.c)
...
void __fastcall CDisplaySet::LogTelemetry(__int64 a1, __int64 a2, int a3)
{
  ...
  v3 = a2;
  v44 = a2;
  if ( TraceLoggingProviderEnabled((TraceLoggingHProvider)&dword_1803371D0, 4u, 0x400000000000uLL) )
  {
    v45 = 0LL;
    ...
    if ( dword_1803371D0 > 4u )
    {
      if ( TlgKeywordOn((TraceLoggingHProvider)&dword_1803371D0, 0x400000000000uLL) )
      {
        ...
        v73 = &v38;
        v74 = 4LL;
        TlgWrite((TraceLoggingHProvider)&dword_1803371D0, &unk_1802D716B, 0LL, 0LL, 0xFu, &pData);
      }
    }
