/*
 * XREFs of ?UpdateOnManipulationThread@CManipulation@@UEAAJAEBUUpdateOnManipulationThreadArgs@@PEAUIManipulationTelemetryData@@@Z @ 0x1801E21F0
 * Callers:
 *     <none>
 * Callees:
 ...
 *     _anonymous_namespace_::StoreIfChanged_float_ @ 0x1801E0E18 (_anonymous_namespace_--StoreIfChanged_float_.c)
 *     _anonymous_namespace_::StoreIfChanged_D2DVector3_ @ 0x1801E0E34 (_anonymous_namespace_--StoreIfChanged_D2DVector3_.c)
 ...
 *     ?_UpdateCaptureState@CManipulation@@AEAAX_N@Z @ 0x1801E2F20 (-_UpdateCaptureState@CManipulation@@AEAAX_N@Z.c)
 */
  ...
  *(_DWORD *)(v9 + 28) = *((_DWORD *)a2 + 7);
    ...
    || ((v25 ^ *((_BYTE *)a2 + 16)) & 2) != 0 )
  {
    ...
    *(_DWORD *)(v24 + 172) = *((_DWORD *)a2 + 23);
    ...
    if ( v26 < 0 )
    {
      MilInstrumentationCheckHR_MaybeFailFast(v27, 0LL, 0, v26, 0x76u, 0LL);
    }
    else if ( a3 )
    {
      v28 = *((_QWORD *)a2 + 6);
