/*
 * XREFs of ??$AddLinkInternal@VCSpriteVisualContent@@@CVisualTreeDumpContext@@AEAAXAEBV?$basic_string@DU?$char_traits@D@std@@V?$allocator@D@2@@std@@PEAVCSpriteVisualContent@@_N@Z @ 0x1801C9548
 * Callers:
