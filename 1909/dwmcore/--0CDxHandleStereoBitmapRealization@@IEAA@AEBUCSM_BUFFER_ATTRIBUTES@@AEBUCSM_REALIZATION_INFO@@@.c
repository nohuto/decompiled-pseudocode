/*
 * XREFs of ??0CDxHandleStereoBitmapRealization@@IEAA@AEBUCSM_BUFFER_ATTRIBUTES@@AEBUCSM_REALIZATION_INFO@@@Z @ 0x1802617CC
 * Callers:
        ...
        const struct CSM_REALIZATION_INFO *a3)
{
  ...
  CDxHandleBitmapRealization::CDxHandleBitmapRealization((__int64)this, 0LL, (__int64)a2, (__int64)a3, 1);
  *((_QWORD *)this + 54) = 0LL;
  ...
  *((_QWORD *)this + 57) = &CD2DBitmapCacheSourceRealization::`vftable'{for `ID2DBitmapCache'};
