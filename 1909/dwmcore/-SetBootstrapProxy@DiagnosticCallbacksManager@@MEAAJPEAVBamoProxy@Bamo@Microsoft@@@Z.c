/*
 * XREFs of ?SetBootstrapProxy@DiagnosticCallbacksManager@@MEAAJPEAVBamoProxy@Bamo@Microsoft@@@Z @ 0x180189DA0
 * Callers:
 *     <none>
 * Callees:
