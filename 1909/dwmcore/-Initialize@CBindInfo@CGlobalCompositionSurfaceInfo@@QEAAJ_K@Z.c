/*
 * XREFs of ?Initialize@CBindInfo@CGlobalCompositionSurfaceInfo@@QEAAJ_K@Z @ 0x180051954
 * Callers:
        ...
        __int64 a2)
{
  ...
  {
    v3 = v4 | 0x10000000;
    MilInstrumentationCheckHR_MaybeFailFast(v5, &dword_1802D3268, 3u, v4 | 0x10000000, 0x381u, 0LL);
    goto LABEL_12;
  }
  v6 = v26[0];
  *((_QWORD *)this + 1) = v25;
  ...
  if ( v6 )
  {
    ...
    if ( v7 )
    {
      ...
      if ( v8 )
      {
        ...
        {
          v3 = -2147024809;
          MilInstrumentationCheckHR_MaybeFailFast(v8, &dword_1802D3268, 3u, -2147024809, 0x3BFu, 0LL);
          goto LABEL_17;
        }
        v16 = (char *)hObject;
        v24 = 0LL;
        ...
        if ( v17 < 0 )
        {
          MilInstrumentationCheckHR_MaybeFailFast(v18, &dword_1802D3268, 3u, v17, 0x3ACu, 0LL);
        }
        else
        {
          v19 = v24;
          ...
          *((_QWORD *)this + 18) = ((unsigned __int64)v19 + 16) & -(__int64)(v19 != 0LL);
          ...
          v3 = v21;
          if ( v21 < 0 )
            MilInstrumentationCheckHR_MaybeFailFast(v22, &dword_1802D3268, 3u, v21, 0x3B0u, 0LL);
          else
...
LABEL_17:
    ...
    MilInstrumentationCheckHR_MaybeFailFast(v14, &dword_1802D3268, 3u, v13, v23, 0LL);
    goto LABEL_12;
  }
  return v3;
}
