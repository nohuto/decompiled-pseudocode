/*
 * XREFs of ?SelectInertiaModifierForAxis@CInteractionTracker@@QEAAJW4ScrollAxis@@PEAVCExpressionValueStack@@_KPEAPEAUIScalarForce@@@Z @ 0x1801DA7A0
 * Callers:
        ...
        _QWORD *a5)
{
  ...
  if ( v9 )
  {
    ...
    {
      MilInstrumentationCheckHR_MaybeFailFast(v13, 0LL, 0, IsAnyConditionSatisfied, 0xDF1u, 0LL);
      goto LABEL_36;
    }
    v11 = v6;
    v10 = v58;
...
LABEL_15:
  ...
  if ( v15 < 0 )
  {
    MilInstrumentationCheckHR_MaybeFailFast(v16, 0LL, 0, v15, 0xE08u, 0LL);
    goto LABEL_36;
  }
  if ( !v49 )
    goto LABEL_35;
...
LABEL_16:
  ...
  if ( !v19 )
  {
    ...
    if ( Value < 0 )
    {
      MilInstrumentationCheckHR_MaybeFailFast(v38, 0LL, 0, Value, 0xE31u, 0LL);
      goto LABEL_36;
    }
    ...
    {
      v14 = -2147024882;
      MilInstrumentationCheckHR_MaybeFailFast(v40, 0LL, 0, 0x8007000E, 0xE37u, 0LL);
      goto LABEL_37;
    }
    ...
    *((_DWORD *)v41 + 7) = v43;
    ...
    v47 = v50;
    v48 = (CMotion *)(*(__int64 (__fastcall **)(_DWORD *))(*(_QWORD *)v50 + 320LL))(v50);
    CMotion::GetCurrentVelocity(v48);
    (*(__int64 (__fastcall **)(_DWORD *))(*(_QWORD *)v47 + 320LL))(v47);
    CScalarForce::Initialize(v46, (_DWORD)v6 == 2);
    *(_DWORD *)((*(__int64 (__fastcall **)(_DWORD *))(*(_QWORD *)v50 + 320LL))(v50) + 144) = 1114636288;
...
LABEL_35:
  ...
  if ( !v20 )
  {
    ...
    {
      v32 = v50;
      v33 = (CMotion *)(*(__int64 (__fastcall **)(_DWORD *))(*(_QWORD *)v50 + 320LL))(v50);
      CMotion::GetCurrentVelocity(v33);
      (*(__int64 (__fastcall **)(_DWORD *))(*(_QWORD *)v32 + 320LL))(v32);
    ...
    *(_DWORD *)((*(__int64 (__fastcall **)(_DWORD *))(*(_QWORD *)v50 + 320LL))(v50) + 144) = 1101004800;
    if ( !v51 )
    {
      v14 = -2147024882;
      MilInstrumentationCheckHR_MaybeFailFast(v36, 0LL, 0, 0x8007000E, 0xE5Au, 0LL);
      goto LABEL_37;
    }
    goto LABEL_35;
  }
  ...
  {
    v14 = -2147467259;
    MilInstrumentationCheckHR_MaybeFailFast(v18, 0LL, 0, 0x80004005, 0xE80u, 0LL);
    goto LABEL_37;
  }
  v52 = 0LL;
  ...
  v23 = (CMotion *)(*(__int64 (__fastcall **)(__int64))(*(_QWORD *)v22 + 320LL))(v22);
  CMotion::GetCurrentVelocity(v23);
  (*(void (__fastcall **)(__int64))(*(_QWORD *)v22 + 320LL))(v22);
  if ( v10 != 1 )
  {
    ...
    if ( ForceForAxis < 0 )
    {
      MilInstrumentationCheckHR_MaybeFailFast(v27, 0LL, 0, ForceForAxis, 0xE75u, 0LL);
      goto LABEL_28;
    }
    goto LABEL_32;
  }
...
LABEL_32:
  ...
  MilInstrumentationCheckHR_MaybeFailFast(v25, 0LL, 0, v24, 0xE6Cu, 0LL);
LABEL_28:
  if ( v21 )
    (*(void (__fastcall **)(struct CBaseExpression *))(*(_QWORD *)v21 + 16LL))(v21);
  Microsoft::WRL::ComPtr<ID2DBitmap>::InternalRelease((__int64 *)&v52);
