/*
 * XREFs of ?CreateNewDevice@CD3DDeviceManager@@AEAAJU_LUID@@PEAPEAVCD3DDeviceLevel1@@@Z @ 0x18002CEF8
 * Callers:
        ...
        struct CD3DDeviceLevel1 **a3)
{
  ...
  *a3 = 0LL;
  v26 = 0LL;
  v7 = CDisplayManager::EnsureDXGIEnumeration(this, &v27);
  v9 = v27;
  v10 = v7;
  if ( v7 < 0 )
  {
    MilInstrumentationCheckHR_MaybeFailFast(v8, &dword_180280CA0, 1u, v7, 0x222u, 0LL);
  }
  else
  {
    ...
    {
      MilInstrumentationCheckHR_MaybeFailFast(v12, &dword_180280CA0, 1u, AdapterNoRefFromLuid, 0x225u, 0LL);
      goto LABEL_9;
    }
    ...
    if ( v14 < 0 )
    {
      MilInstrumentationCheckHR_MaybeFailFast(v15, &dword_180280CA0, 1u, v14, 0x239u, 0LL);
      goto LABEL_9;
    }
    v16 = CD3DDeviceLevel1::Create(v25, this, &v26);
    v10 = v16;
    if ( v16 >= 0 )
    {
    ...
    MilInstrumentationCheckHR_MaybeFailFast(v17, &dword_180280CA0, 1u, v16, 0x23Du, 0LL);
    v4 = v26;
  }
  if ( v4 )
