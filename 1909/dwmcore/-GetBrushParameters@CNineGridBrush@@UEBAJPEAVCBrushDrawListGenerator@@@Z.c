/*
 * XREFs of ?GetBrushParameters@CNineGridBrush@@UEBAJPEAVCBrushDrawListGenerator@@@Z @ 0x18000E810
 * Callers:
 *     <none>
 * Callees:
 ...
 *     ??4?$unique_ptr@VCDrawListPrimitive@@U?$default_delete@VCDrawListPrimitive@@@std@@@std@@QEAAAEAV01@$$QEAV01@@Z @ 0x1800394D8 (--4-$unique_ptr@VCDrawListPrimitive@@U-$default_delete@VCDrawListPrimitive@@@std@@@std@@QEAAAEAV.c)
...
__int64 __fastcall CNineGridBrush::GetBrushParameters(CNineGridBrush *this, struct CBrushDrawListGenerator *a2)
{
  ...
  v4 = -2147022876;
  if ( dword_18033D3A4 > *(_DWORD *)(*((_QWORD *)NtCurrentTeb()->ThreadLocalStoragePointer + (unsigned int)tls_index)
                                   + 4LL) )
  {
    Init_thread_header(&dword_18033D3A4);
    if ( dword_18033D3A4 == -1 )
    {
      dword_180339B40 = -2147022876;
      Init_thread_footer(&dword_18033D3A4);
    }
  }
  v5 = 0LL;
  ...
  *((_QWORD *)&v39 + 1) = __PAIR64__(v11, v10);
        ...
        if ( !CComponentTransform2D::IsIdentity(v27) )
        {
          if ( (Microsoft_Windows_Dwm_CoreEnableBits & 0x80000) != 0 )
            McTemplateU0d(
              ...
              2147944420LL);
          MilInstrumentationCheckHR_MaybeFailFast(v28, &dword_180339B40, 1u, -2147022876, 0x284u, 0LL);
          goto LABEL_47;
        }
      }
    }
  ...
  if ( v13 < 0 )
  {
    MilInstrumentationCheckHR_MaybeFailFast(v14, &dword_180339B40, 1u, v13, 0x289u, 0LL);
LABEL_47:
  ...
  else
  {
    ...
    *(_OWORD *)((char *)a2 + 20) = v16;
    ...
    if ( v4 < 0 )
    {
      MilInstrumentationCheckHR_MaybeFailFast((unsigned int)v17, &dword_180339B40, 1u, v4, 0x29Cu, 0LL);
      if ( v36[0] )
  ...
  *((_QWORD *)&v40 + 1) = 0LL;
  ...
  if ( v4 < 0 )
  {
    MilInstrumentationCheckHR_MaybeFailFast((unsigned int)v22, &dword_180339B40, 1u, v4, 0x2CAu, 0LL);
    if ( v36[0] )
