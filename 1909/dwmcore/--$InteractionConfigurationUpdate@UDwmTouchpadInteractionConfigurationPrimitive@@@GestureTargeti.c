/*
 * XREFs of ??$InteractionConfigurationUpdate@UDwmTouchpadInteractionConfigurationPrimitive@@@GestureTargeting@InputTraceLogging@@SAXPEBUInteractionUpdate@CManipulationManager@@@Z @ 0x1800A8EF8
 * Callers:
        ...
        unsigned int *a1)
{
  ...
  if ( a1[12] )
  {
    ...
    do
    {
      ...
      if ( *(_DWORD *)v5 > 4u && TlgKeywordOn(*(TraceLoggingHProvider *)(v4 + 8), 0x800uLL) )
      {
        ...
        v134 = 4LL;
        v136 = 4LL;
        TlgWrite(v5, &unk_1802DDB06, 0LL, 0LL, 0x21u, &pData);
      }
      LODWORD(v6) = v84 + 1;
      v84 = v6;
    }
  ...
  else
  {
    ...
    if ( *(_DWORD *)v7 > 4u )
    {
      LOBYTE(v6) = TlgKeywordOn(*(TraceLoggingHProvider *)(v6 + 8), 0x800uLL);
      if ( (_BYTE)v6 )
      {
        ...
        v115 = v2;
        v116 = 4LL;
        LOBYTE(v6) = TlgWrite(v7, &unk_1802DDA1C, 0LL, 0LL, 0x10u, &pData);
      }
    }
  }
  return v6;
