/*
 * XREFs of ?UpdateDeviceTransform@CDrawingContext@@AEAAJAEBVCMILMatrix@@PEA_N@Z @ 0x18001461C
 * Callers:
...
__int64 __fastcall CDrawingContext::UpdateDeviceTransform(CDrawingContext *this, const struct CMILMatrix *a2, bool *a3)
{
  ...
  *((_BYTE *)this + 6132) = v7 != 0;
  if ( !v8 )
  {
    v9 = *((_QWORD *)this + 784);
    v14 = 0;
    CMILMatrix::Multiply((const struct CMILMatrix *)(v9 + 828), a2, (struct CMILMatrix *)v13);
