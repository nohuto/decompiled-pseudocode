/*
 * XREFs of ?SetCommonState@CD2DContext@@AEAAXPEBVID2DContextOwner@@W4D2D1_PRIMITIVE_BLEND@@PEBW4D2D1_ANTIALIAS_MODE@@PEAUD2D_MATRIX_3X2_F@@@Z @ 0x180160D04
 * Callers:
        ...
        struct D2D_MATRIX_3X2_F *a5)
{
  ...
  (*(void (__fastcall **)(const struct ID2DContextOwner *, __int128 *))(*(_QWORD *)a2 + 16LL))(a2, &v9);
  (*(void (__fastcall **)(_QWORD, __int128 *))(**((_QWORD **)this + 29) + 240LL))(*((_QWORD *)this + 29), &v9);
