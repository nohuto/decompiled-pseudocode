/*
 * XREFs of ?GetD2DBitmap@CD3DTexture@@QEAAJ_NPEAPEAUID2D1Bitmap1@@@Z @ 0x18001F590
 * Callers:
 *     ?GetBitmap@CHwTextureRenderTarget@@UEAAJ_NPEAPEAUID2D1Bitmap1@@@Z @ 0x18001F580 (-GetBitmap@CHwTextureRenderTarget@@UEAAJ_NPEAPEAUID2D1Bitmap1@@@Z.c)
 * Callees:
...
__int64 __fastcall CD3DTexture::GetD2DBitmap(CD3DTexture *this, char a2, struct ID2D1Bitmap1 **a3)
{
  ...
  *a3 = 0LL;
  ...
  {
    v3 = -2003292412;
    MilInstrumentationCheckHR_MaybeFailFast(v7, 0LL, 0, -2003292412, 0x1F7u, 0LL);
    return v3;
  }
  if ( a2 )
  {
    ...
    v12 = 510;
LABEL_9:
    MilInstrumentationCheckHR_MaybeFailFast(v10, 0LL, 0, D2DBitmap, v12, 0LL);
    return v3;
  }
  v8 = (char *)this + 224;
  if ( !*((_QWORD *)this + 28) )
