/*
 * XREFs of ?GetInputBrushParameters@CBrushRenderingGraph@@AEAAJPEAVCDrawingContext@@AEBUD2D_SIZE_F@@IIPEAUEffectInput@@@Z @ 0x180039510
 * Callers:
 ...
 *     ?CopyPrimitiveClamp@CDrawListBrush@@QEAAXPEBV1@@Z @ 0x18000FA58 (-CopyPrimitiveClamp@CDrawListBrush@@QEAAXPEBV1@@Z.c)
    ...
    else
    {
      ...
      *(_QWORD *)&v53.right = 0LL;
      ...
      if ( IntermediateSurfaceBrush >= 0 )
      {
        ...
        if ( v52 )
          CGeometryOnlyDrawListBrush::`vector deleting destructor'(v52, 1u);
LABEL_10:
        if ( v7 )
        {
          ...
          {
            CDrawListBitmap::operator=(a6, v23 + 56);
            v24 = 0;
          }
          else
          {
