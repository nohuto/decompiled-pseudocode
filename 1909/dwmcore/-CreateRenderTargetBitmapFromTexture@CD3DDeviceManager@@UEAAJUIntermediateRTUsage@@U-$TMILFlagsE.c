/*
 * XREFs of ?CreateRenderTargetBitmapFromTexture@CD3DDeviceManager@@UEAAJUIntermediateRTUsage@@U?$TMILFlagsEnum@W4FlagsEnum@MilRTInitialization@@@@PEAUPixelFormatInfo@@U_LUID@@VDisplayId@@PEAUID3D11Texture2D@@PEAPEAVIRenderTargetBitmap@@@Z @ 0x18015D9D0
 * Callers:
        ...
        _QWORD *a8)
{
  ...
  *a8 = 0LL;
  ...
  if ( v17 < 0 )
  {
    MilInstrumentationCheckHR_MaybeFailFast(v16, &dword_1802E1E90, 1u, v17, 0x4E5u, 0LL);
  }
  else
  {
    ...
    if ( D3DDevice < 0 )
    {
      MilInstrumentationCheckHR_MaybeFailFast(v19, &dword_1802E1E90, 1u, D3DDevice, 0x4E7u, 0LL);
      v9 = v25;
      goto LABEL_13;
    }
    v9 = v25;
    ...
    if ( v20 < 0 )
    {
      MilInstrumentationCheckHR_MaybeFailFast(v21, &dword_1802E1E90, 1u, v20, 0x4F0u, 0LL);
      v11 = v26;
    }
    else
    {
      ...
      v17 = v22;
      if ( v22 < 0 )
        MilInstrumentationCheckHR_MaybeFailFast(v23, &dword_1802E1E90, 1u, v22, 0x4F3u, 0LL);
    }
  }
  if ( v11 )
