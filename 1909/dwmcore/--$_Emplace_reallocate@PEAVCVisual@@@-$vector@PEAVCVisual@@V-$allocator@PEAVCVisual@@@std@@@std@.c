/*
 * XREFs of ??$_Emplace_reallocate@PEAVCVisual@@@?$vector@PEAVCVisual@@V?$allocator@PEAVCVisual@@@std@@@std@@QEAAPEAPEAVCVisual@@QEAPEAV2@$$QEAPEAV2@@Z @ 0x18025AD50
 * Callers:
 ...
 *     ?_Change_array@?$vector@PEAVCVisual@@V?$allocator@PEAVCVisual@@@std@@@std@@AEAAXQEAPEAVCVisual@@_K1@Z @ 0x18002009C (-_Change_array@-$vector@PEAVCVisual@@V-$allocator@PEAVCVisual@@@std@@@std@@AEAAXQEAPEAVCVisual@@.c)
...
__int64 __fastcall std::vector<CVisual *>::_Emplace_reallocate<CVisual *>(__int64 a1, _BYTE *a2, _QWORD *a3)
{
  ...
  *(_QWORD *)&v12[8 * v4] = *a3;
  ...
  std::vector<CVisual *>::_Change_array((__int64 *)a1, (__int64)v12, v8, v9);
