/*
 * XREFs of ?LogCacheAccess@CExpression@@AEAAX_NIPEAVCExpressionValue@@@Z @ 0x1801D3F88
 * Callers:
      ...
      if ( v24 )
      {
        ...
        if ( v25 )
        {
          ...
          if ( v26 )
          {
            if ( v26 != 161 )
              goto LABEL_33;
            if ( dword_180337240 > 4u && TlgKeywordOn((TraceLoggingHProvider)&dword_180337240, 1uLL) )
            {
              ...
              *(_QWORD *)&v51.Size = v28;
              ...
              v79 = v28;
              v81 = v28;
              TlgWrite((TraceLoggingHProvider)&dword_180337240, &unk_1802DA068, 0LL, 0LL, 0x17u, &pData);
            }
          }
          else if ( dword_180337240 > 4u && TlgKeywordOn((TraceLoggingHProvider)&dword_180337240, 1uLL) )
          {
            LODWORD(v38) = CBaseExpression::GetTracingCookie(this);
            v43 = v29;
            v42 = &v38;
            ...
            *(_QWORD *)&v51.Size = v30;
            ...
            v59 = v30;
            v61 = v30;
            TlgWrite((TraceLoggingHProvider)&dword_180337240, &unk_1802D9FE8, 0LL, 0LL, 0xDu, &pData);
          }
        }
        else if ( dword_180337240 > 4u && TlgKeywordOn((TraceLoggingHProvider)&dword_180337240, 1uLL) )
        {
          ...
          *(_QWORD *)&v51.Size = v32;
          ...
          v55 = v32;
          v57 = v32;
          TlgWrite((TraceLoggingHProvider)&dword_180337240, &unk_1802DA247, 0LL, 0LL, 0xBu, &pData);
        }
      }
      else if ( dword_180337240 > 4u && TlgKeywordOn((TraceLoggingHProvider)&dword_180337240, 1uLL) )
      {
        ...
        *(_QWORD *)&v51.Size = v34;
        ...
        v55 = v34;
        v57 = v34;
        TlgWrite((TraceLoggingHProvider)&dword_180337240, &unk_1802DA2B5, 0LL, 0LL, 0xBu, &pData);
      }
    }
    else if ( dword_180337240 > 4u && TlgKeywordOn((TraceLoggingHProvider)&dword_180337240, 1uLL) )
    {
  ...
  else if ( v4 == 52 )
  {
    if ( dword_180337240 > 4u && TlgKeywordOn((TraceLoggingHProvider)&dword_180337240, 1uLL) )
    {
      ...
      *(_QWORD *)&v51.Size = v22;
      v53 = v22;
      v55 = v22;
      TlgWrite((TraceLoggingHProvider)&dword_180337240, &unk_1802DA1DC, 0LL, 0LL, 0xAu, &pData);
    }
  }
  else
  {
            ...
            if ( v10 == 7 )
            {
              if ( dword_180337240 > 4u )
              {
                if ( TlgKeywordOn((TraceLoggingHProvider)&dword_180337240, 1uLL) )
                {
                  ...
                  v51.Ptr = (ULONGLONG)v5;
                  *(_QWORD *)&v51.Size = v12;
                  TlgWrite((TraceLoggingHProvider)&dword_180337240, &unk_1802DA11A, 0LL, 0LL, 8u, &pData);
                }
              }
              return;
            }
LABEL_33:
          ...
          if ( dword_180337240 > 4u && TlgKeywordOn((TraceLoggingHProvider)&dword_180337240, 1uLL) )
          {
            ...
            *(_QWORD *)&v51.Size = v14;
            v53 = v14;
            TlgWrite((TraceLoggingHProvider)&dword_180337240, &unk_1802DA323, 0LL, 0LL, 9u, &pData);
          }
        }
        else if ( dword_180337240 > 4u && TlgKeywordOn((TraceLoggingHProvider)&dword_180337240, 1uLL) )
        {
      ...
      else if ( dword_180337240 > 4u && TlgKeywordOn((TraceLoggingHProvider)&dword_180337240, 1uLL) )
      {
        ...
        v50 = 8LL;
        *(_QWORD *)&v51.Size = v18;
        TlgWrite((TraceLoggingHProvider)&dword_180337240, &unk_1802DA3E6, 0LL, 0LL, 8u, &pData);
      }
    }
    else if ( dword_180337240 > 4u && TlgKeywordOn((TraceLoggingHProvider)&dword_180337240, 1uLL) )
    {
      ...
      TlgWrite((TraceLoggingHProvider)&dword_180337240, &unk_1802DA17B, 0LL, 0LL, 8u, &pData);
    }
  }
}
