/*
 * XREFs of ?EnsureBrushGraph@CNineGridBrush@@MEAAJ_N@Z @ 0x1801E6BB0
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall CNineGridBrush::EnsureBrushGraph(CNineGridBrush *this, char a2)
{
  ...
  if ( (!a2
     || (*(unsigned __int8 (__fastcall **)(CNineGridBrush *, _QWORD, char *))(*(_QWORD *)this + 336LL))(this, 0LL, &v7))
    && (Microsoft::WRL::ComPtr<CBrushRenderingGraph>::InternalRelease((__int64 *)this + 8),
        v3 = CBrushRenderingGraphBuilder::Build(
               *((struct CSpriteVisualContent **)this + 10),
