/*
 * XREFs of ?DiscardView@CD3DDeviceLevel1@@QEAAXPEAUID3D11View@@PEBUtagRECT@@I@Z @ 0x18015B31C
 * Callers:
...
void __fastcall CD3DDeviceLevel1::DiscardView(CD3DDeviceLevel1 *this, struct ID3D11View *a2, const struct tagRECT *a3)
{
  ...
  {
    v4 = (int)a2;
    (*(void (__fastcall **)(_QWORD, struct ID3D11View *, const struct tagRECT *, __int64))(**((_QWORD **)this + 80)
                                                                                         + 1064LL))(
      *((_QWORD *)this + 80),
      a2,
      a3,
