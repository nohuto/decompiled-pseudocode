/*
 * XREFs of ?CalcLocalSpaceClippedBounds@CDrawingContext@@QEAAXAEBV?$TMilRect_@MUMilRectF@@UMilPointAndSizeF@@UNotNeeded@RectUniqueness@@@@PEAV2@@Z @ 0x18016AE4C
 * Callers:
...
char __fastcall CDrawingContext::CalcLocalSpaceClippedBounds(CDrawingContext *a1, __int128 *a2, __int64 a3)
{
  __int128 v3; // xmm0
  __int64 v5; // r11
  char result; // al
  ...
  *(_OWORD *)a3 = v3;
  ...
  CScopedClipStack::GetClipBoundsWorld(v5 + 1008, (__int64)v17);
