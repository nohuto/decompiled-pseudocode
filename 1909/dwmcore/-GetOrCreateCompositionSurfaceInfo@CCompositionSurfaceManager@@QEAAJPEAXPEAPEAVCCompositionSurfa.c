/*
 * XREFs of ?GetOrCreateCompositionSurfaceInfo@CCompositionSurfaceManager@@QEAAJPEAXPEAPEAVCCompositionSurfaceInfo@@@Z @ 0x1800ABB70
 * Callers:
 ...
 *     ?GetCompositionSurfaceInfoByLuid@CCompositionSurfaceManager@@QEAAPEAVCCompositionSurfaceInfo@@U_LUID@@@Z @ 0x1800ABC34 (-GetCompositionSurfaceInfoByLuid@CCompositionSurfaceManager@@QEAAPEAVCCompositionSurfaceInfo@@U_.c)
        ...
        struct CCompositionSurfaceInfo **a3)
{
  ...
  *a3 = 0LL;
  ...
  {
    v7 = v8 | 0x10000000;
    MilInstrumentationCheckHR_MaybeFailFast(v9, 0LL, 0, v8 | 0x10000000, 0x24u, 0LL);
  }
  if ( v7 < 0 )
  {
    MilInstrumentationCheckHR_MaybeFailFast(v9, 0LL, 0, v7, 0x38u, 0LL);
  }
  else
  {
    v6 = 1;
    ...
    {
      v12 = CGlobalCompositionSurfaceInfo::Create(a2, v15, this, &v16);
      v7 = v12;
      if ( v12 < 0 )
      {
        MilInstrumentationCheckHR_MaybeFailFast(v13, 0LL, 0, v12, 0x4Cu, 0LL);
        goto LABEL_11;
      }
      v11 = v16;
      v6 = 0;
