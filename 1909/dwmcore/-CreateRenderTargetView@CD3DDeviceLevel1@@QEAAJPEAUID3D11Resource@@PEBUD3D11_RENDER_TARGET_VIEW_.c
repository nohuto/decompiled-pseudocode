/*
 * XREFs of ?CreateRenderTargetView@CD3DDeviceLevel1@@QEAAJPEAUID3D11Resource@@PEBUD3D11_RENDER_TARGET_VIEW_DESC@@PEAPEAUID3D11RenderTargetView@@@Z @ 0x1800496A0
 * Callers:
        ...
        struct ID3D11RenderTargetView **a4)
{
  ...
  *a4 = 0LL;
  ...
  if ( v5 < 0 )
  {
    MilInstrumentationCheckHR_MaybeFailFast((unsigned int)this, 0LL, 0, v5, 0x5E7u, 0LL);
  }
  else
  {
