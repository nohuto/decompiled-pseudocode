/*
 * XREFs of ?GetBrushParameters@CWindowBackdropBrush@@UEBAJPEAVCBrushDrawListGenerator@@@Z @ 0x1801FD520
 * Callers:
 *     <none>
 * Callees:
...
LABEL_15:
  ...
  v13 = 1;
  v18 = 1;
  v6 = CSurfaceDrawListBrush::CreateWithTextureTransform((struct CSurfaceDrawListBrush *)&v19, &v12, (__int64)v23, &v17);
  if ( v18 )
  {
    v5 = (__int64)v17;
    v7 = *v16;
