/*
 * XREFs of McTemplateU0xddqqddddddddddddqqq @ 0x18018706C
 * Callers:
        ...
        char a22)
{
  ...
  v61 = 4LL;
  v63 = 4LL;
  return McGenEventWrite(Microsoft_Windows_Dwm_Core_Provider_Context, &EVTDESC_OVERLAY_RECORDCANDIDATE, a3, 0x15u, &v23);
}
