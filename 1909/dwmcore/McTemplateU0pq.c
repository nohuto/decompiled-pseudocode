/*
 * XREFs of McTemplateU0pq @ 0x1801C5500
 * Callers:
...
ULONG __fastcall McTemplateU0pq(REGHANDLE *a1, const EVENT_DESCRIPTOR *a2, __int64 a3, int a4)
{
  ...
  v11 = 0;
  v10 = 4;
  return McGenEventWrite(a1, a2, a3, 3u, &v5);
}
