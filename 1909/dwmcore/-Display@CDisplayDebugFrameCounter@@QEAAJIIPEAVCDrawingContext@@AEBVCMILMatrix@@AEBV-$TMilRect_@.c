/*
 * XREFs of ?Display@CDisplayDebugFrameCounter@@QEAAJIIPEAVCDrawingContext@@AEBVCMILMatrix@@AEBV?$TMilRect_@MUMilRectF@@UMilPointAndSizeF@@UNotNeeded@RectUniqueness@@@@W4DebugFrameCounterPosition@1@PEAV4@@Z @ 0x180191538
 * Callers:
        ...
        _OWORD *a8)
{
  ...
  *(_OWORD *)v36 = v16;
  ...
  {
    v21 = CDrawingContext::PushTransformInternal(a4, 0LL, (const struct CMILMatrix *)v31, 0LL, 1);
    v20 = v21;
    if ( v21 < 0 )
    {
