/*
 * XREFs of ??$UnmarshalResourceArray@VCSceneNode@@@CResource@@SAJPEBXIIW4MIL_RESOURCE_TYPE@@PEAIPEAPEAPEAVCSceneNode@@PEAVCResourceTable@@_N@Z @ 0x18019ACB4
 * Callers:
        ...
        __int64 a7)
{
  ...
  result = CResource::UnmarshalResourceArray(a1, a2, a3, 0x9Eu, a5, &v8, a7, 0);
  *a6 = v8;
  return result;
}
