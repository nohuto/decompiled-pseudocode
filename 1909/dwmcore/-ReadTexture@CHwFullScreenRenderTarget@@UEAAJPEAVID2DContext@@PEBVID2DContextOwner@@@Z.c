/*
 * XREFs of ?ReadTexture@CHwFullScreenRenderTarget@@UEAAJPEAVID2DContext@@PEBVID2DContextOwner@@@Z @ 0x1801664B0
 * Callers:
 *     ?ReadTexture@CHwFullScreenRenderTarget@@WJA@EAAJPEAVID2DContext@@PEBVID2DContextOwner@@@Z @ 0x1800F0600 (-ReadTexture@CHwFullScreenRenderTarget@@WJA@EAAJPEAVID2DContext@@PEBVID2DContextOwner@@@Z.c)
