/*
 * XREFs of ?Calculate@CKeyframeAnimation@@AEAAJPEAVCExpressionValueStack@@@Z @ 0x1800A7298
 * Callers:
 ...
 *     ?GetIsComplete@Timer@@QEBA_NXZ @ 0x1800A7460 (-GetIsComplete@Timer@@QEBA_NXZ.c)
        ...
        __int64 a3)
{
  ...
  if ( (*((_BYTE *)this + 541) & 4) != 0 )
  {
    ...
    if ( v12 < 0 )
    {
      MilInstrumentationCheckHR_MaybeFailFast(v13, 0LL, 0, v12, 0xB06u, 0LL);
      return v7;
    }
    *((_BYTE *)this + 541) &= ~4u;
  }
...
LABEL_9:
  ...
  *((_BYTE *)this + 541) = v9 | 2;
  ...
  if ( v10 >= 0 )
    return 0;
  MilInstrumentationCheckHR_MaybeFailFast(v11, 0LL, 0, v10, 0xBA6u, 0LL);
  return v7;
}
