/*
 * XREFs of McTemplateU0xxxx @ 0x180244C30
 * Callers:
...
ULONG McTemplateU0xxxx(__int64 a1, const EVENT_DESCRIPTOR *a2, ...)
{
  ...
  va_copy(v10, va3);
  v11 = 8LL;
  return McGenEventWrite(Microsoft_Windows_Dwm_Core_Provider_Context, a2, v13, 5u, &v3);
}
