/*
 * XREFs of ?ProcessOutput@CInteractionProcessor@@QEAAXPEAUIManipulationResource@@_N1PEAUIManipulationTelemetryData@@AEAUInteractionOutput@@@Z @ 0x180230D6C
 * Callers:
  ...
  if ( dword_180337240 > 4u )
  {
    if ( TlgKeywordOn((TraceLoggingHProvider)&dword_180337240, 2uLL) )
    {
      ...
      *(_QWORD *)&v43 = v25;
      ...
      v48 = v25;
      v50 = v25;
      TlgWrite((TraceLoggingHProvider)&dword_180337240, &unk_1802DC6B1, 0LL, 0LL, 9u, &pData);
    }
  }
}
