/*
 * XREFs of ?UnboundedInertiaPanningAtTime@CPositionMotion@@AEBAMM@Z @ 0x18020F5B8
 * Callers:
 *     ?AdvanceInertiaToTimeDefault@CPositionMotion@@MEAAMXZ @ 0x18020F240 (-AdvanceInertiaToTimeDefault@CPositionMotion@@MEAAMXZ.c)
