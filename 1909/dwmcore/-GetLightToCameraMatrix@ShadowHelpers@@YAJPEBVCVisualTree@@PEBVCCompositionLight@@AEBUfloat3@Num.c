/*
 * XREFs of ?GetLightToCameraMatrix@ShadowHelpers@@YAJPEBVCVisualTree@@PEBVCCompositionLight@@AEBUfloat3@Numerics@Foundation@Windows@@PEAVCMILMatrix@@@Z @ 0x180005AAC
 * Callers:
 ...
 * Callees:
 *     ?make_float4x4_look_at@Numerics@Foundation@Windows@@YA?AUfloat4x4@123@AEBUfloat3@123@00@Z @ 0x180005BD8 (-make_float4x4_look_at@Numerics@Foundation@Windows@@YA-AUfloat4x4@123@AEBUfloat3@123@00@Z.c)
        ...
        const struct Windows::Foundation::Numerics::float3 *a4)
{
  ...
  v8 = (*(unsigned int (__fastcall **)(const struct CVisualTree *))(*(_QWORD *)a2 + 224LL))(a2) == 1;
