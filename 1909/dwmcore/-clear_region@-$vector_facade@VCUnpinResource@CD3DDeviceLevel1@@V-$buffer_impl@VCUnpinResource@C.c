/*
 * XREFs of ?clear_region@?$vector_facade@VCUnpinResource@CD3DDeviceLevel1@@V?$buffer_impl@VCUnpinResource@CD3DDeviceLevel1@@$06$00Vliberal_expansion_policy@detail@@@detail@@@detail@@IEAAX_K0@Z @ 0x1800EB24C
 * Callers:
...
LABEL_10:
    ...
    std::move<std::move_iterator<CD3DDeviceLevel1::CUnpinResource *>,stdext::checked_array_iterator<CD3DDeviceLevel1::CUnpinResource *>>(
      (__int64)&v11,
      (char *)(v4 + 16LL * (_QWORD)v7),
      v8,
      &v13);
  }
  v10 = 16 * a3;
  detail::destruct_range<CD3DDeviceLevel1::CUnpinResource>((__int64 *)&v8[-v10], (__int64 *)v8);
  a1[1] -= v10;
}
