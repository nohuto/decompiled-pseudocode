/*
 * XREFs of ?ProcessSetTemplate@CEffectBrush@@QEAAJPEAVCResourceTable@@PEBUtagMILCMD_EFFECTBRUSH_SETTEMPLATE@@@Z @ 0x18004783C
 * Callers:
        ...
        const struct tagMILCMD_EFFECTBRUSH_SETTEMPLATE *a3)
{
  ...
  Resource = (struct CResource *)CResourceTable::GetResource(a2, *((unsigned int *)a3 + 2), 25LL);
  v7 = Resource;
  if ( !Resource )
  {
...
LABEL_23:
  ...
  while ( 1 )
  {
    ...
    if ( v13 > *((_DWORD *)this + 33) )
      break;
    v6 = v12;
    *(_QWORD *)(*((_QWORD *)this + 14) + 8LL * v12) = v18;
    *((_DWORD *)this + 34) = v13;
LABEL_8:
    if ( ++v11 >= v10 )
      goto LABEL_9;
  ...
  v9 = v16;
  if ( v16 < 0 )
    MilInstrumentationCheckHR_MaybeFailFast(v6, 0LL, 0, v16, 0xC3u, 0LL);
LABEL_19:
  if ( v9 >= 0 )
    goto LABEL_8;
  v17 = 170;
