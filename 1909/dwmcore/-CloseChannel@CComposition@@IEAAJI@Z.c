/*
 * XREFs of ?CloseChannel@CComposition@@IEAAJI@Z @ 0x1800CCBD8
 * Callers:
 ...
 *     ?UpdateDebugCounter@CComposition@@QEAAX_N@Z @ 0x1801766E8 (-UpdateDebugCounter@CComposition@@QEAAX_N@Z.c)
 */
