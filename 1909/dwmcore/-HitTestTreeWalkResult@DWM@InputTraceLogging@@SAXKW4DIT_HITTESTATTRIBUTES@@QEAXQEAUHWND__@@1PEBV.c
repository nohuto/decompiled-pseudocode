/*
 * XREFs of ?HitTestTreeWalkResult@DWM@InputTraceLogging@@SAXKW4DIT_HITTESTATTRIBUTES@@QEAXQEAUHWND__@@1PEBVCInteraction@@@Z @ 0x1800A98E0
 * Callers:
        ...
        struct CInteraction *a6)
{
  ...
  if ( *(_DWORD *)v11 > 4u && TlgKeywordOn(*(TraceLoggingHProvider *)(v10 + 8), 2uLL) )
  {
    ...
    v90 = &v50;
    v91 = 4LL;
    TlgWrite(v11, &unk_1802DBCF6, 0LL, 0LL, 0x1Au, &pData);
  }
  if ( v6 )
