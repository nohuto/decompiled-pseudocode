/*
 * XREFs of ?GdiSpriteBitmapUnmapSection@CChannel@@UEAAJI@Z @ 0x1800D99C0
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall CChannel::GdiSpriteBitmapUnmapSection(CChannel *this, unsigned int a2)
{
  unsigned int v4; // ebx
