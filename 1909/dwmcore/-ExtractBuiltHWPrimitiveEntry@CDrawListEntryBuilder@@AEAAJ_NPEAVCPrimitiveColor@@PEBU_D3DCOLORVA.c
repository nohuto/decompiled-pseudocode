/*
 * XREFs of ?ExtractBuiltHWPrimitiveEntry@CDrawListEntryBuilder@@AEAAJ_NPEAVCPrimitiveColor@@PEBU_D3DCOLORVALUE@@@Z @ 0x180097BC0
 * Callers:
        ...
        const struct _D3DCOLORVALUE *a4)
{
  ...
  *(_QWORD *)&v66 = v35;
  if ( !v35 )
    goto LABEL_97;
  v74 = 1LL;
  v36 = (((__int64)v29 - v30) >> 3) - v32;
  if ( v34 > 1 )
    v36 = 1LL;
  v67 = 1LL;
  v35 = 8 * v36;
  v37 = (__int64 *)((char *)v29 - v35);
  if ( v29 != (__int64 *)((char *)v29 - v35) )
  {
    v63 = v66;
    v64 = v67;
    do
...
LABEL_97:
    _o__invalid_parameter_noinfo_noreturn(v35, v34);
    JUMPOUT(0x180129B63LL);
  }
LABEL_41:
  *((_QWORD *)this + 6) += 8LL;
