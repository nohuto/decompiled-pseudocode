/*
 * XREFs of ?SetColorProperty@CColorBrush@@IEAAJPEBUAnimatedProperty@AnimationHelper@@PEBX@Z @ 0x1800A2800
 * Callers:
 *     <none>
 * Callees:
        ...
        const void *a3)
{
  if ( CResource::ModifyProperty(this, a2, a3) )
  {
    ...
    (*(void (__fastcall **)(CColorBrush *, __int64, CColorBrush *))(*(_QWORD *)this + 64LL))(this, 6LL, this);
  }
  return 0LL;
}
