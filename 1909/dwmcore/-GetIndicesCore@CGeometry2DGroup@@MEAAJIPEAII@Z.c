/*
 * XREFs of ?GetIndicesCore@CGeometry2DGroup@@MEAAJIPEAII@Z @ 0x180211650
 * Callers:
 *     <none>
 * Callees:
  ...
  *((_DWORD *)this + 8) = v4 ^ ((unsigned __int8)v4 ^ (unsigned __int8)(v4 + 2)) & 6;
  if ( (((unsigned __int8)v4 ^ ((unsigned __int8)v4 ^ (unsigned __int8)(v4 + 2)) & 6) & 6) == 2 )
  {
    for ( i = 0LL; (unsigned int)i < *((_DWORD *)this + 24); i = (unsigned int)(i + 1) )
    {
      ...
      if ( v12 )
      {
        v13 = (*(unsigned int (__fastcall **)(_QWORD))(*(_QWORD *)v12 + 200LL))(*(_QWORD *)(v11 + 8 * i));
        v14 = (*(__int64 (__fastcall **)(__int64, _QWORD, unsigned int *, _QWORD))(*(_QWORD *)v12 + 224LL))(
                v12,
                a2,
                a3,
                a4);
        ...
        a3 += v13;
        a4 -= v13;
        a2 += (*(__int64 (__fastcall **)(__int64))(*(_QWORD *)v12 + 192LL))(v12);
      }
    }
  }
