/*
 * XREFs of McTemplateU0xxxxx @ 0x180178438
 * Callers:
...
ULONG McTemplateU0xxxxx(__int64 a1, const EVENT_DESCRIPTOR *a2, ...)
{
  ...
  v11 = 8LL;
  v13 = 8LL;
  return McGenEventWrite(Microsoft_Windows_Dwm_Core_Provider_Context, a2, v15, 6u, &v3);
}
