/*
 * XREFs of ?Calculate@KeyframeSequence@@QEAAXPEAVCExpressionValueStack@@@Z @ 0x1800A6C40
 * Callers:
...
LABEL_28:
  ...
  if ( v41 )
  {
    ...
    if ( !*(_DWORD *)v43 )
    {
      ...
      if ( v47 < 0 )
      {
        MilInstrumentationCheckHR_MaybeFailFast((__int64)v42, 0LL, 0, v47, 0x6B6u, 0LL);
LABEL_55:
        v44 = v12;
        if ( v12 >= 0 )
        {
...
LABEL_84:
        MilInstrumentationCheckHR_MaybeFailFast((__int64)v42, 0LL, 0, v12, 0x50u, 0LL);
LABEL_87:
    ...
    if ( *(_DWORD *)v43 != 18 )
    {
      switch ( *(_DWORD *)v43 )
      {
        ...
        default:
          v12 = -2147467259;
          MilInstrumentationCheckHR_MaybeFailFast((__int64)v42, 0LL, 0, 0x80004005, 0x6E6u, 0LL);
          v44 = -2147467259;
          goto LABEL_84;
      }
    }
...
LABEL_113:
  ...
  if ( !*(_DWORD *)v54 )
  {
    ...
    if ( v55 < 0 )
    {
      MilInstrumentationCheckHR_MaybeFailFast((__int64)v53, 0LL, 0, v55, 0x6B6u, 0LL);
      goto LABEL_109;
    }
    v12 = 0;
  }
  if ( *(_DWORD *)v54 != 18 )
  {
    switch ( *(_DWORD *)v54 )
    {
      ...
      default:
        v12 = -2147467259;
        MilInstrumentationCheckHR_MaybeFailFast((__int64)v53, 0LL, 0, 0x80004005, 0x6E6u, 0LL);
        v57 = -2147467259;
        goto LABEL_106;
    }
  }
...
LABEL_109:
  ...
  {
LABEL_106:
    MilInstrumentationCheckHR_MaybeFailFast((__int64)v53, 0LL, 0, v12, 0x50u, 0LL);
    goto LABEL_113;
  }
LABEL_34:
