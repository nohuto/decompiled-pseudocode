/*
 * XREFs of ?CanUseWarpExtension@CPrimitiveGroupDrawListGenerator@@QEBA_NXZ @ 0x180256AE4
 * Callers:
 ...
 *     ??$IsTranslateAndScale@$0A@@CMILMatrix@@AEBA_NXZ @ 0x18021B0FC (--$IsTranslateAndScale@$0A@@CMILMatrix@@AEBA_NXZ.c)
 */
...
LABEL_2:
  ...
  if ( (v4[1] & 0xFFFFFFCC) == 0 && *v4 <= 1u && v4[11] <= 1u )
  {
    ...
    while ( 1 )
    {
      ...
      v18 = 1065353216;
      v23 = 1065353216;
      if ( !CMILMatrix::IsTranslateAndScale<0>((__int64)v15) )
        break;
