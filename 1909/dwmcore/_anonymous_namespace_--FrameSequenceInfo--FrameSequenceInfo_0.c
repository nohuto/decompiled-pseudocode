/*
 * XREFs of _anonymous_namespace_::FrameSequenceInfo::FrameSequenceInfo_0 @ 0x180171028
 * Callers:
...
__int64 __fastcall anonymous_namespace_::FrameSequenceInfo::FrameSequenceInfo_0(__int64 a1, __int64 a2)
{
  ...
  *(_QWORD *)(a1 + 408) = 0LL;
  *(_QWORD *)(a1 + 416) = 0LL;
  v4 = std::_Tree_comp_alloc<std::_Tset_traits<unsigned __int64,std::less<unsigned __int64>,std::allocator<unsigned __int64>,0>>::_Buyheadnode();
  *(_QWORD *)(a1 + 408) = v4;
  ...
  *(_QWORD *)(a1 + 424) = 0LL;
  *(_QWORD *)(a1 + 432) = 0LL;
  v6 = std::_Tree_comp_alloc<std::_Tset_traits<unsigned __int64,std::less<unsigned __int64>,std::allocator<unsigned __int64>,0>>::_Buyheadnode();
  *(_QWORD *)(a1 + 424) = v6;
  ...
  *(_QWORD *)(a1 + 448) = 0LL;
  *(_QWORD *)(a1 + 456) = 0LL;
  v8 = std::_Tree_comp_alloc_std::_Tmap_traits__anonymous_namespace_::AnimationId_unsigned_int_A0x155a666c::AnimationId::LessThan_std::allocator_std::pair__anonymous_namespace_::AnimationId_const__unsigned_int____0___::_Buyheadnode();
  *(_QWORD *)(a1 + 448) = v8;
