/*
 * XREFs of ?ContainEffectInChainInputs@CFilterEffect@@QEAAJW4MIL_RESOURCE_TYPE@@@Z @ 0x1801CAD28
 * Callers:
...
__int64 __fastcall CFilterEffect::ContainEffectInChainInputs(__int64 a1, unsigned int a2)
{
  ...
  *(_DWORD *)(a1 + 32) = v2 ^ ((unsigned __int8)v2 ^ (unsigned __int8)(v2 + 2)) & 6;
    ...
    else
    {
      ...
      if ( *(int *)(a1 + 152) > 0 )
      {
        ...
        do
        {
          ...
          if ( v9 )
          {
            if ( (*(unsigned __int8 (__fastcall **)(__int64, __int64))(*(_QWORD *)v9 + 48LL))(v9, 56LL) )
            {
              v10 = *(_QWORD *)(v8 + 24);
              if ( v10 )
              {
  ...
  {
    v5 = -2147467259;
    MilInstrumentationCheckHR_MaybeFailFast(a1, 0LL, 0, 0x80004005, 0x27Cu, 0LL);
  }
