/*
 * XREFs of ?SetProperty@CTextBrush@@UEAAJIW4DCOMPOSITION_EXPRESSION_TYPE@@PEBX@Z @ 0x1801FB8B0
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall CTextBrush::SetProperty(__int64 a1, int a2, int a3)
{
  ...
  {
    v9 = -2147024809;
    MilInstrumentationCheckHR_MaybeFailFast(v5, 0LL, 0, 0x80070057, 0x5Au, 0LL);
  }
  Microsoft::WRL::ComPtr<ID2DBitmap>::InternalRelease((__int64 *)(a1 + 160));
  return v9;
}
