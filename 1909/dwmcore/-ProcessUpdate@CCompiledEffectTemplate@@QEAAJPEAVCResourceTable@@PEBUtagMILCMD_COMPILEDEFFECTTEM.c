/*
 * XREFs of ?ProcessUpdate@CCompiledEffectTemplate@@QEAAJPEAVCResourceTable@@PEBUtagMILCMD_COMPILEDEFFECTTEMPLATE@@@Z @ 0x1800C5DDC
 * Callers:
 ...
 *     ?SignalCompileCompletedEvent@CCompiledEffectTemplate@@AEAAXXZ @ 0x1800AA330 (-SignalCompileCompletedEvent@CCompiledEffectTemplate@@AEAAXXZ.c)
...
LABEL_12:
  ...
  this = (CCompiledEffectTemplate *)CResourceTable::GetResource((__int64)a2, *((_DWORD *)a3 + 2), 0xA7u);
  if ( !this )
  {
    v8 = -2003303421;
    v19 = 42;
  ...
  *((_QWORD *)v4 + 8) = *((_QWORD *)a3 + 3);
  ...
  v11 = v7;
LABEL_17:
  MilInstrumentationCheckHR_MaybeFailFast((__int64)this, 0LL, 0, v11, v19, 0LL);
  ...
  if ( CNotificationResource::ShouldNotify(v4) )
  {
    ...
    LOWORD(v20) = 1;
    v17 = CoreUICallSend(v13, v21, 2LL, 5LL, v20, &unk_1802B114D, v12, v14);
    v8 = v17;
    if ( v17 < 0 )
