/*
 * XREFs of ?ProcessSetLookupId@CDataSourceReader@@QEAAJPEAVCResourceTable@@PEBUtagMILCMD_DATASOURCEREADER_SETLOOKUPID@@@Z @ 0x1801CC870
 * Callers:
        ...
        const struct tagMILCMD_DATASOURCEREADER_SETLOOKUPID *a3)
{
  ...
  *((_QWORD *)this + 8) = v5;
  ...
  if ( !v9 )
    DataProviderManager::AddReaderToReadyList(*(DataProviderManager **)(*((_QWORD *)this + 2) + 1232LL), this, v7, v8);
  return 0LL;
}
