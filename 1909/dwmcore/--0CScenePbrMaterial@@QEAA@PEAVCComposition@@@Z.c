/*
 * XREFs of ??0CScenePbrMaterial@@QEAA@PEAVCComposition@@@Z @ 0x18019C294
 * Callers:
 *     ??0CSceneMetallicRoughnessMaterial@@QEAA@PEAVCComposition@@@Z @ 0x18019C210 (--0CSceneMetallicRoughnessMaterial@@QEAA@PEAVCComposition@@@Z.c)
 * Callees:
