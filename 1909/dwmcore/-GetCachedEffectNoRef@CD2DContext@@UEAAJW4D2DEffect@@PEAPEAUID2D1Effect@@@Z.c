/*
 * XREFs of ?GetCachedEffectNoRef@CD2DContext@@UEAAJW4D2DEffect@@PEAPEAUID2D1Effect@@@Z @ 0x180020A30
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall CD2DContext::GetCachedEffectNoRef(__int64 a1, unsigned int a2, _QWORD *a3)
{
  ...
  *a3 = 0LL;
  ...
  if ( v5 < 0 )
  {
    MilInstrumentationCheckHR_MaybeFailFast(a1, 0LL, 0, v5, 0x743u, 0LL);
  }
  else
  {
    v6 = a2;
...
LABEL_5:
    ...
    MilInstrumentationCheckHR_MaybeFailFast(v9, 0LL, 0, v8, 0x748u, 0LL);
  }
  if ( v11 )
