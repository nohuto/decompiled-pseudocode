/*
 * XREFs of ??0CCommonRenderingEffect@@QEAA@AEBVCDrawListBitmap@@USamplerMode@@01@Z @ 0x18003BEB4
 * Callers:
 ...
 *     ??0CDrawListBitmap@@QEAA@XZ @ 0x1800C04C0 (--0CDrawListBitmap@@QEAA@XZ.c)
 */
