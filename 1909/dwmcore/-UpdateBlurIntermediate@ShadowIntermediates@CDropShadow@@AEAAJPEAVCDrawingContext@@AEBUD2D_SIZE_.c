/*
 * XREFs of ?UpdateBlurIntermediate@ShadowIntermediates@CDropShadow@@AEAAJPEAVCDrawingContext@@AEBUD2D_SIZE_F@@M@Z @ 0x1801C8EB0
 * Callers:
        ...
        double a4)
{
  ...
  CRenderTargetImageSource **v19; // rsi
  CRenderTargetImageSource *v20; // rcx
  CRenderTargetImageSource *v21; // rcx
  signed int BlurIntermediate; // eax
  __int64 v23; // rcx
  struct D2D_SIZE_F v25[3]; // [rsp+38h] [rbp-29h] BYREF
  float v26; // [rsp+50h] [rbp-11h]
  float v27; // [rsp+54h] [rbp-Dh]
  ...
  else
  {
    ...
    *(float *)&a4 = *(float *)&a4 + a3->width;
    ...
    LODWORD(v25[0].width) = _mm_cmplt_ss(v10, v12).m128_u32[0];
    v10.m128_f32[0] = *(float *)&a4;
    LODWORD(v25[1].width) = _mm_cmplt_ss(v4, v10).m128_u32[0];
    v13 = _mm_cvtsi32_si128(v11 - LODWORD(v25[0].width));
    v14 = (CRenderTargetImageSource *)*((_QWORD *)this + 3);
    LODWORD(v15) = _mm_cvtepi32_ps(v13).m128_u32[0];
    v25[0].height = v15;
    v25[0].width = (float)((int)*(float *)&a4 - LODWORD(v25[1].width));
    if ( v14 && CRenderTargetImageSource::IsValid(v14) )
    {
      ...
      if ( v16 < 0 )
      {
        MilInstrumentationCheckHR_MaybeFailFast(v17, 0LL, 0, v16, 0x350u, 0LL);
        return v18;
      }
      if ( (float)COERCE_DOUBLE(COERCE_UNSIGNED_INT64((float)((float)((int)*(float *)&a4 - LODWORD(v25[1].width))
                                                            - (float)(v26 - v25[2].width))) & _xmm) > 0.015625
        || (float)COERCE_DOUBLE(COERCE_UNSIGNED_INT64((float)(v15 - (float)(v27 - v25[2].height))) & _xmm) > 0.015625 )
      {
        CDropShadow::ShadowIntermediates::DestroyIntermediates(this, 0);
      }
    }
    v19 = (CRenderTargetImageSource **)((char *)this + 24);
    if ( !*((_QWORD *)this + 3) || !CRenderTargetImageSource::IsValid(*v19) )
    {
      v20 = *v19;
      *v19 = 0LL;
      if ( v20 )
        (*(void (__fastcall **)(CRenderTargetImageSource *))(*(_QWORD *)v20 + 16LL))(v20);
      v21 = *v19;
      *v19 = 0LL;
      if ( v21 )
      ...
      {
        MilInstrumentationCheckHR_MaybeFailFast(v23, 0LL, 0, BlurIntermediate, 0x35Du, 0LL);
        return v18;
      }
