/*
 * XREFs of ?ProcessUpdate@CMeshGeometry2D@@QEAAJPEAVCResourceTable@@PEBUtagMILCMD_MESHGEOMETRY2D@@PEBXI@Z @ 0x180210AA0
 * Callers:
...
LABEL_32:
      v8 = -2003303421;
      MilInstrumentationCheckHR_MaybeFailFast(v9, 0LL, 0, 0x88980403, v25, 0LL);
LABEL_42:
      CMeshGeometry2D::UnRegisterNotifiers((CMeshGeometry2D *)this);
      goto LABEL_43;
    }
