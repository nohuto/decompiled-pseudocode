/*
 * XREFs of ?CreateSecondaryD2DBitmap@CD3DDeviceManager@@QEAAJU_LUID@@PEAVDWM_TEXTURE2D_DESC@@PEAUD2D1_BITMAP_PROPERTIES1@@PEAW4DXGI_COLOR_SPACE_TYPE@@PEAPEAVCSecondaryD2DBitmap@@@Z @ 0x18004EAA0
 * Callers:
 ...
 *     ?GetCompatibleTextureFormat@CD3DDeviceLevel1@@QEBA?AW4DXGI_FORMAT@@W42@@Z @ 0x18004F434 (-GetCompatibleTextureFormat@CD3DDeviceLevel1@@QEBA-AW4DXGI_FORMAT@@W42@@Z.c)
        ...
        struct CSecondaryD2DBitmap **a6)
{
  ...
  *a6 = 0LL;
  ...
  if ( v13 < 0 )
  {
    MilInstrumentationCheckHR_MaybeFailFast(v14, &dword_180280CA0, 1u, v13, 0x610u, 0LL);
  }
  else
  {
    ...
    if ( D3DDevice < 0 )
    {
      MilInstrumentationCheckHR_MaybeFailFast(v17, &dword_180280CA0, 1u, D3DDevice, 0x612u, 0LL);
      v7 = v29;
      goto LABEL_14;
    }
    v7 = v29;
    ...
    if ( v24 < 0 )
    {
      MilInstrumentationCheckHR_MaybeFailFast(v25, &dword_180280CA0, 1u, v24, 0x634u, 0LL);
      v8 = v30;
    }
    else
    {
      ...
      if ( SecondaryD2DBitmap < 0 )
        MilInstrumentationCheckHR_MaybeFailFast(v27, &dword_180280CA0, 1u, SecondaryD2DBitmap, 0x63Fu, 0LL);
    }
  }
  if ( v8 )
