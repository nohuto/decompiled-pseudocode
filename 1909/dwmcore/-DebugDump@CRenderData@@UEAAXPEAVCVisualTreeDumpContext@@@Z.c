/*
 * XREFs of ?DebugDump@CRenderData@@UEAAXPEAVCVisualTreeDumpContext@@@Z @ 0x180216870
 * Callers:
 *     <none>
 * Callees:
...
void __fastcall CRenderData::DebugDump(CRenderData *this, struct CVisualTreeDumpContext *a2)
{
  _QWORD v3[4]; // [rsp+20h] [rbp-38h] BYREF

  CContent::DebugDump(this, a2);
  std::string::string(v3, (__int64)"CRenderData");
