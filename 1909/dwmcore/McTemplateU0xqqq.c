/*
 * XREFs of McTemplateU0xqqq @ 0x180178218
 * Callers:
...
ULONG __fastcall McTemplateU0xqqq(__int64 a1, __int64 a2, __int64 a3, int a4, char a5, char a6)
{
  ...
  v15 = 4LL;
  v14 = &a6;
  return McGenEventWrite(Microsoft_Windows_Dwm_Core_Provider_Context, &EVTDESC_SCHEDULE_RENDERTIME, a3, 5u, &v7);
}
