/*
 * XREFs of CreateMegaRectVertex @ 0x18003D748
 * Callers:
...
__int64 __fastcall CreateMegaRectVertex(__int64 a1, __int64 *a2, unsigned int a3, __int64 a4, __int64 a5)
{
  ...
  *(_DWORD *)(a5 + 12) = 1065353216;
  ...
  if ( a3 )
  {
    ...
    do
    {
      v23 = (float)(v20 * *(float *)((char *)v15 + v16)) + (float)(*v15 * v13);
      v24 = (float)(v22 * (float)((float)(v20 * *(float *)((char *)v15 + v16 - 4)) + (float)(*(v15 - 1) * v13)))
          + (float)((float)((float)(v20 * *(float *)((char *)v15 + v17 - 4))
                          + (float)(*(float *)((char *)v15 + (_QWORD)v18 - 4) * v13))
                  * v14);
      v25 = (float)((float)(v20 * *(float *)((char *)v15 + v17)) + (float)(*(float *)((char *)v15 + (_QWORD)v18) * v13))
          * v14;
      *(float *)((char *)v15 + v19 - 4) = v24;
      v26 = (float)(v22 * v23) + v25;
      *(float *)((char *)v15 + v19) = v26;
      *(float *)((char *)v15 + result - 4) = v24;
      *(float *)((char *)v15 + result) = v26;
      v15 += 2;
      --v21;
    }
    while ( v21 );
