/*
 * XREFs of ?GetProperty@CColorBrush@@UEAAJIPEAVCExpressionValue@@@Z @ 0x1800B8690
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall CColorBrush::GetProperty(CColorBrush *this, int a2, struct CExpressionValue *a3)
{
  ...
  while ( 1 )
  {
    ...
    if ( a2 == **(_DWORD **)v5 )
      break;
    if ( ++v5 == (const struct AnimationHelper::AnimatedProperty *const near *const *)&unk_180269258 )
      goto LABEL_11;
  }
  if ( !v6 )
  {
LABEL_11:
    v4 = -2147024809;
    MilInstrumentationCheckHR_MaybeFailFast((__int64)v5, 0LL, 0, 0x80070057, 0x21u, 0LL);
    return v4;
  }
  v7 = *((_DWORD *)v6 + 1);
  v8 = *((_QWORD *)v6 + 1);
