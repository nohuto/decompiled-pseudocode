/*
 * XREFs of ?CalcFrustumOutline@@YAXVCMILMatrix@@PEAULine3D@@111@Z @ 0x1801C59B8
 * Callers:
 ...
 *     log10f_0 @ 0x1800F01B7 (log10f_0.c)
 *     sqrtf_0 @ 0x1800F01DB (sqrtf_0.c)
 *     ??0Line3D@@QEAA@UMilPoint4F@@0@Z @ 0x1801C58E0 (--0Line3D@@QEAA@UMilPoint4F@@0@Z.c)
 */
