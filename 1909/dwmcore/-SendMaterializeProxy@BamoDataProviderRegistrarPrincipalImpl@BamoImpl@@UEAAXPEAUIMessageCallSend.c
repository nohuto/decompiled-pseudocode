/*
 * XREFs of ?SendMaterializeProxy@BamoDataProviderRegistrarPrincipalImpl@BamoImpl@@UEAAXPEAUIMessageCallSendHost@@PEAVBamoStubImpl@2Microsoft@@@Z @ 0x1800E5B40
 * Callers:
 *     <none>
 * Callees:
        ...
        struct Microsoft::BamoImpl::BamoStubImpl *a3)
{
  ...
  LOWORD(v10) = 2;
  v7 = CoreUICallSend(a2, &v17, 2LL, 6LL, v10, &unk_1802BA8B5, v13, v15);
  if ( v7 < 0 )
  {
  ...
  v18 = *(unsigned int *)(v3 + 40);
  LOWORD(v11) = 4;
  v9 = CoreUICallSend(a2, &v17, 2LL, 6LL, v11, &unk_1802BA8B5, v14, v16);
  if ( v9 < 0 )
  {
    wil::details::in1diag3::FailFast_Hr(
      retaddr,
