/*
 * XREFs of ?GenerateShaders@CD3DDeviceLevel1@@AEAAJXZ @ 0x180030490
 * Callers:
...
LABEL_54:
  ...
  while ( 2 )
  {
    for ( j = 0; j < 2; ++j )
    {
      ...
      {
        v18 = *((_OWORD *)&unk_180270140 + v16);
        v43 = (struct ID3D11PixelShader *)*((_QWORD *)&unk_180270140 + 2 * v16);
        v46 = v18;
        if ( v43 )
        {
          *(_OWORD *)v44 = *(_OWORD *)(v17 + 16LL * v14 + 3371712);
          *(_OWORD *)v53 = *(_OWORD *)(v17 + 16LL * (int)j + 3371776);
          v19 = v53[0];
          if ( v53[0] )
          {
            v20 = v44[0];
  ...
  do
  {
    ...
    CommonOrCubeMapRenderingShadersNoRefInternal = v27(v25, &byte_1802DF340[264 * (int)v24], v26 + 168);
    v10 = CommonOrCubeMapRenderingShadersNoRefInternal;
    if ( CommonOrCubeMapRenderingShadersNoRefInternal < 0 )
    {
      v41 = 682;
  ...
  do
  {
    ...
    CommonOrCubeMapRenderingShadersNoRefInternal = v31(v29, &_ImageBase + 10 * (int)v28 + 776998, v30 + 240);
    v10 = CommonOrCubeMapRenderingShadersNoRefInternal;
    if ( CommonOrCubeMapRenderingShadersNoRefInternal < 0 )
    {
      v41 = 689;
