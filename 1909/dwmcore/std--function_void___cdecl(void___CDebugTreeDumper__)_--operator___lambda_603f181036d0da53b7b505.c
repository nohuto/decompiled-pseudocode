/*
 * XREFs of std::function_void___cdecl(void___CDebugTreeDumper__)_::operator___lambda_603f181036d0da53b7b505f826c78df9__void_ @ 0x1801FA470
 * Callers:
...
__int64 __fastcall std::function_void___cdecl_void___CDebugTreeDumper____::operator___lambda_603f181036d0da53b7b505f826c78df9__void_(
        __int64 a1)
{
  __int64 v2; // rdx
  __int64 v3; // rdx
