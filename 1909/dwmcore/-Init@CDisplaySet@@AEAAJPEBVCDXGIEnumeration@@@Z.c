/*
 * XREFs of ?Init@CDisplaySet@@AEAAJPEBVCDXGIEnumeration@@@Z @ 0x180025D04
 * Callers:
 ...
 *     ?ShouldForceRemotingMode@CDisplaySet@@CA_NXZ @ 0x1800274F4 (-ShouldForceRemotingMode@CDisplaySet@@CA_NXZ.c)
...
__int64 __fastcall CDisplaySet::Init(CDisplaySet *this, const struct CDXGIEnumeration *a2)
{
  ...
  *((_QWORD *)this + 2) = v3;
  ...
  if ( v4 < 0 )
  {
    v29 = 181;
LABEL_47:
    MilInstrumentationCheckHR_MaybeFailFast(v5, &dword_1802BE018, 1u, v4, v29, 0LL);
    return (unsigned int)v6;
  }
  for ( i = 0; i < *((_DWORD *)this + 18); ++i )
  {
    v8 = *((_DWORD *)this + 6);
    v9 = *(_DWORD **)(*((_QWORD *)this + 6) + 8LL * i);
    if ( *((_DWORD *)this + 8) <= v8 || (v10 = 0, *((_DWORD *)this + 9) <= *((_DWORD *)this + 7)) )
      v10 = 1;
    v5 = v9[30];
    if ( v9[32] <= v5 || (v11 = 0, v9[33] <= v9[31]) )
      v11 = 1;
    if ( v10 )
    {
      if ( v11 )
  ...
  *((_BYTE *)this + 112) = 0;
  for ( j = 0; j < *((_DWORD *)this + 18); ++j )
  {
    ...
    if ( v6 < 0 )
    {
      MilInstrumentationCheckHR_MaybeFailFast((unsigned int)v17, 0LL, 0, v6, 0x4FAu, 0LL);
      break;
    }
    v18 = *((_QWORD *)this + 6);
...
LABEL_23:
  ...
  if ( v6 < 0 )
    MilInstrumentationCheckHR_MaybeFailFast(v5, &dword_1802BE018, 1u, v6, 0xB9u, 0LL);
  return (unsigned int)v6;
}
