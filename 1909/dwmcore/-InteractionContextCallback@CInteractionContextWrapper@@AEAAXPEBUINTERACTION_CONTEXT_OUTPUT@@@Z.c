/*
 * XREFs of ?InteractionContextCallback@CInteractionContextWrapper@@AEAAXPEBUINTERACTION_CONTEXT_OUTPUT@@@Z @ 0x18023302C
 * Callers:
 *     ?s_InteractionContextCallback@CInteractionContextWrapper@@CAXPEAXPEBUINTERACTION_CONTEXT_OUTPUT@@@Z @ 0x1802341F0 (-s_InteractionContextCallback@CInteractionContextWrapper@@CAXPEAXPEBUINTERACTION_CONTEXT_OUTPUT@.c)
 * Callees:
  ...
  if ( (_DWORD)v15 == 1 )
  {
    ...
    *((_BYTE *)this + 156) = v8;
    ...
    if ( TlgKeywordOn((TraceLoggingHProvider)&dword_180337240, 2uLL) )
    {
      ...
      v40 = 4LL;
      v42 = 4LL;
      TlgWrite((TraceLoggingHProvider)&dword_180337240, &unk_1802DCDC0, 0LL, 0LL, 0xDu, &pData);
    }
  }
  if ( dword_180337240 > 4u )
  {
    if ( TlgKeywordOn((TraceLoggingHProvider)&dword_180337240, 2uLL) )
    {
      ...
      v49 = 4LL;
      v51 = 4LL;
      TlgWrite((TraceLoggingHProvider)&dword_180337240, &unk_1802DCE9B, 0LL, 0LL, 6u, &v43);
    }
  }
}
