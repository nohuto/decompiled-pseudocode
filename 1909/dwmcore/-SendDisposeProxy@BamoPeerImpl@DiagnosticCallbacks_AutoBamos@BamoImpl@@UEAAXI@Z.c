/*
 * XREFs of ?SendDisposeProxy@BamoPeerImpl@DiagnosticCallbacks_AutoBamos@BamoImpl@@UEAAXI@Z @ 0x180189AD0
 * Callers:
 *     <none>
 * Callees:
...
void __fastcall BamoImpl::DiagnosticCallbacks_AutoBamos::BamoPeerImpl::SendDisposeProxy(
        ...
        int a2)
{
  ...
  LOWORD(v5) = 6;
  v4 = CoreUICallSend(v3, v7, 2LL, 1LL, v5, &unk_1802BC172, a2, v6);
  if ( v4 < 0 )
  {
