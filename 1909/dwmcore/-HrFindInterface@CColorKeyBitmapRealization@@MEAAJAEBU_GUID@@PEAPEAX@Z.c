/*
 * XREFs of ?HrFindInterface@CColorKeyBitmapRealization@@MEAAJAEBU_GUID@@PEAPEAX@Z @ 0x180255410
 * Callers:
 *     <none>
 * Callees:
 *     ?HrFindInterface@CD2DBitmapCache@@MEAAJAEBU_GUID@@PEAPEAX@Z @ 0x1801AACD0 (-HrFindInterface@CD2DBitmapCache@@MEAAJAEBU_GUID@@PEAPEAX@Z.c)
 */
