/*
 * XREFs of ??0?$vector@UMilRectF@@V?$allocator@UMilRectF@@@std@@@std@@QEAA@AEBV01@@Z @ 0x18016A880
 * Callers:
 ...
 *     ?_Buy@?$vector@UMilRectF@@V?$allocator@UMilRectF@@@std@@@std@@AEAA_N_K@Z @ 0x180170458 (-_Buy@-$vector@UMilRectF@@V-$allocator@UMilRectF@@@std@@@std@@AEAA_N_K@Z.c)
 */
