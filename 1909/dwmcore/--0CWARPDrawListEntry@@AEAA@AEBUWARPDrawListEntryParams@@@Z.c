/*
 * XREFs of ??0CWARPDrawListEntry@@AEAA@AEBUWARPDrawListEntryParams@@@Z @ 0x1801B8F40
 * Callers:
        ...
        const struct WARPDrawListEntryParams *a2)
{
  ...
  *((_QWORD *)this + 18) = &CWARPDrawListEntry::`vftable'{for `CRenderingEffect'};
  ...
  *((_QWORD *)this + 36) = 0LL;
  *((_BYTE *)this + 296) = 0;
  *((_BYTE *)this + 360) = *((_BYTE *)a2 + 240);
  *((_BYTE *)this + 361) = *((_BYTE *)a2 + 241);
  *((_OWORD *)this + 10) = *(_OWORD *)((char *)a2 + 40);
  *(_OWORD *)((char *)this + 184) = *((_OWORD *)a2 + 4);
  ...
  if ( v4 )
  {
    ...
    do
    {
      ...
      *(float *)((char *)++v6 + (_QWORD)v8 + 180) = v10;
      --v7;
    }
    while ( v7 );
  }
  WARPDrawListEntryBitmapDesc::operator=((char *)this + 200, (char *)a2 + 80);
  WARPDrawListEntryBitmapDesc::operator=((char *)this + 280, (char *)a2 + 160);
  return this;
}
