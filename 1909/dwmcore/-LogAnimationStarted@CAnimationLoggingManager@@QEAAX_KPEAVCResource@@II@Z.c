/*
 * XREFs of ?LogAnimationStarted@CAnimationLoggingManager@@QEAAX_KPEAVCResource@@II@Z @ 0x1801BE6A8
 * Callers:
        ...
        unsigned int a5)
{
  ...
  if ( a3 )
  {
    ...
    if ( DebugInfoForResource )
    {
      ...
      {
        v10 = *(DiagnosticCallbacksManager **)(*((_QWORD *)this + 2) + 1264LL);
        memset_0(v17, 0, sizeof(v17));
        v11 = *(_QWORD *)a3;
        v18 = 0LL;
        v19 = 18;
        v12 = *(__int64 (__fastcall **)(struct CResource *, _QWORD, _BYTE *))(v11 + 136);
        v20 = 0;
        v13 = v12(a3, a5, v17);
        if ( v13 < 0 )
        {
