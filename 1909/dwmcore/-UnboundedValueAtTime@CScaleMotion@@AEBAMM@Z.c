/*
 * XREFs of ?UnboundedValueAtTime@CScaleMotion@@AEBAMM@Z @ 0x18020F848
 * Callers:
 *     ?AdvanceInertiaToTimeDefault@CScaleMotion@@MEAAMXZ @ 0x18020F660 (-AdvanceInertiaToTimeDefault@CScaleMotion@@MEAAMXZ.c)
