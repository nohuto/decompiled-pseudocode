/*
 * XREFs of ?NotifyAnimationStateChanged@CBaseExpression@@AEAAJW4AnimationEventType@@@Z @ 0x1800A5654
 * Callers:
  ...
  if ( CNotificationResource::ShouldNotify((CNotificationResource *)a1) )
  {
    ...
    if ( CBaseExpression::TryGetTargetValue((CBaseExpression *)a1, (struct CExpressionValue *)v67) )
    {
      ...
      if ( v7 )
      {
        ...
        if ( v38 < 0 )
        {
          MilInstrumentationCheckHR_MaybeFailFast(v39, 0LL, 0, v38, 0x569u, 0LL);
          if ( !v64 )
            goto LABEL_28;
      ...
      if ( v19 )
      {
        ...
        if ( !v20 )
        {
          ...
          *((_QWORD *)&v57 + 1) = *(unsigned int *)(a1 + 56);
          LOWORD(v53) = 6;
          v16 = CoreUICallSend(v10, &v57, 2LL, 0LL, v53, &unk_1802B1120, a2, &v56);
          goto LABEL_25;
        }
        v21 = v20 - 33;
        if ( !v21 )
        ...
        if ( v21 == 161 )
        {
          ...
          *((_QWORD *)&v56 + 1) = *(unsigned int *)(a1 + 56);
          LOWORD(v53) = 8;
          v16 = CoreUICallSend(v10, &v56, 2LL, 0LL, v53, &unk_1802B112C, a2, v59);
          goto LABEL_25;
        }
LABEL_80:
        v4 = -2147024809;
        MilInstrumentationCheckHR_MaybeFailFast(v9, 0LL, 0, 0x80070057, 0x5F5u, 0LL);
LABEL_27:
        if ( !v6 )
          goto LABEL_28;
    ...
    else
    {
      if ( v5 != 69 )
      {
        ...
        if ( !v11 )
        {
          ...
          *((_QWORD *)&v57 + 1) = *(unsigned int *)(a1 + 56);
          LOWORD(v53) = 9;
          v16 = CoreUICallSend(v10, &v57, 2LL, 0LL, v53, &unk_1802B1132, a2, *((_QWORD *)&v56 + 1));
          goto LABEL_25;
        }
        v12 = v11 - 6;
        if ( !v12 )
        ...
        if ( !v13 )
        {
          ...
          *((_QWORD *)&v56 + 1) = *(unsigned int *)(a1 + 56);
          LOWORD(v53) = 1;
          v16 = CoreUICallSend(v10, &v56, 2LL, 0LL, v53, &unk_1802B1104, a2, v8);
          goto LABEL_25;
        }
        v33 = v13 - 17;
        if ( !v33 )
        {
          ...
          *((_QWORD *)&v56 + 1) = *(unsigned int *)(a1 + 56);
          LOWORD(v53) = 2;
          *(_QWORD *)&v57 = v60;
          v16 = CoreUICallSend(v10, &v56, 2LL, 0LL, v53, &unk_1802B1108, a2, &v57);
          goto LABEL_25;
        }
        if ( v33 == 17 )
        {
...
LABEL_25:
          ...
          if ( (int)(v16 + 0x80000000) < 0 || v16 == -2018375675 )
            ...
            MilInstrumentationCheckHR_MaybeFailFast(0x80000000LL, 0LL, 0, v16, 0x5FCu, 0LL);
          goto LABEL_27;
        }
        goto LABEL_80;
      }
