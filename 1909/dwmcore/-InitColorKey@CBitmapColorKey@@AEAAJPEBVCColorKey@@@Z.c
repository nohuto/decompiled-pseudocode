/*
 * XREFs of ?InitColorKey@CBitmapColorKey@@AEAAJPEBVCColorKey@@@Z @ 0x18026011C
 * Callers:
 ...
 * Callees:
 *     ?Convert_MilColorF_scRGB_To_MilColorF_sRGB@@YA?AU_D3DCOLORVALUE@@PEBU1@@Z @ 0x180034DD4 (-Convert_MilColorF_scRGB_To_MilColorF_sRGB@@YA-AU_D3DCOLORVALUE@@PEBU1@@Z.c)
...
LABEL_4:
      v3 = -2003292288;
      MilInstrumentationCheckHR_MaybeFailFast(v5, 0LL, 0, 0x88982F80, v93, 0LL);
      return v3;
    }
  ...
  switch ( v17 )
  {
    ...
    case 28:
      *(struct _D3DCOLORVALUE *)&v95.r = (struct _D3DCOLORVALUE)_mm_loadu_si128(a2);
      ...
      v29 = Convert_scRGB_Channel_To_sRGB_Byte(v95.r);
      v30 = Convert_scRGB_Channel_To_sRGB_Byte(v95.g);
      v31 = ((v30 | ((v29 | (v28 << 8)) << 8)) << 8) | Convert_scRGB_Channel_To_sRGB_Byte(v95.b);
      *((_BYTE *)this + 62) = v31;
      ...
      *(struct _D3DCOLORVALUE *)&v95.r = (struct _D3DCOLORVALUE)_mm_loadu_si128(v7);
      ...
      v33 = Convert_scRGB_Channel_To_sRGB_Byte(v95.r);
      v34 = Convert_scRGB_Channel_To_sRGB_Byte(v95.g);
      v35 = ((v34 | ((v33 | (v27 << 8)) << 8)) << 8) | Convert_scRGB_Channel_To_sRGB_Byte(v95.b);
      *((_BYTE *)this + 94) = v35;
    ...
    default:
      ...
      *(struct _D3DCOLORVALUE *)&v95.r = (struct _D3DCOLORVALUE)_mm_loadu_si128(a2);
      ...
      v21 = Convert_scRGB_Channel_To_sRGB_Byte(v95.r);
      v22 = Convert_scRGB_Channel_To_sRGB_Byte(v95.g);
      *((_DWORD *)this + 14) = ((v22 | ((v21 | (v20 << 8)) << 8)) << 8) | Convert_scRGB_Channel_To_sRGB_Byte(v95.b);
      *(struct _D3DCOLORVALUE *)&v95.r = (struct _D3DCOLORVALUE)_mm_loadu_si128(v7);
      ...
      v24 = Convert_scRGB_Channel_To_sRGB_Byte(v95.r);
      v25 = Convert_scRGB_Channel_To_sRGB_Byte(v95.g);
      *((_DWORD *)this + 22) = ((v25 | ((v24 | (v19 << 8)) << 8)) << 8) | Convert_scRGB_Channel_To_sRGB_Byte(v95.b);
      break;
  }
  return v3;
}
