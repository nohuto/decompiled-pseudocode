/*
 * XREFs of ?DebuggingStarted@BamoCompObjectDiagnosticsRootProxyImpl@BamoImpl@@QEAAJI_KIW4DCOMPOSITION_EXPRESSION_TYPE@@PEBEI@Z @ 0x1801985D8
 * Callers:
        ...
        __int64 a3)
{
  ...
  unsigned int v9; // [rsp+60h] [rbp-38h] BYREF
  struct IMessageCallSendHost *v10; // [rsp+68h] [rbp-30h] BYREF
...
LABEL_3:
  ...
  v11[1] = v9;
  LOWORD(v8) = 1;
  return CoreUICallSend(v10, v11, 2LL, 0LL, v8, &unk_1802BC152, a2, a3);
}
