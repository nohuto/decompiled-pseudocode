/*
 * XREFs of ??0CShaderLinkingGraphBuilder@@QEAA@XZ @ 0x180031244
 * Callers:
        ...
        CShaderLinkingGraphBuilder *this)
{
  ...
  *((_QWORD *)this + 3) = 0LL;
  *((_QWORD *)this + 4) = 0LL;
  *((_QWORD *)this + 3) = std::_List_alloc<std::_List_base_types<std::pair<enum ShaderLinkingArgument const,CShaderLinkingGraphBuilder::Node>>>::_Buynode0(
                            this,
                            0LL,
                            0LL);
  *((_QWORD *)v1 + 3) = 0LL;
