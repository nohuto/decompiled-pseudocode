/*
 * XREFs of ?Channel_SetConnectionId@CComposition@@AEAAJPEAVCChannelContext@@PEAVCResourceTable@@PEBUtagMILCMD_CHANNEL_SETCONNECTIONID@@@Z @ 0x1800D00CC
 * Callers:
        ...
        const struct tagMILCMD_CHANNEL_SETCONNECTIONID *a4)
{
  ...
  if ( v8 == -2018375658 )
  {
    v10 = (*(__int64 (__fastcall **)(_QWORD, _QWORD, _QWORD))(**(_QWORD **)(v6 + 24) + 200LL))(
            *(_QWORD *)(v6 + 24),
            v4,
            0LL);
    if ( v10 < 0 )
