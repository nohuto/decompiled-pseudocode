/*
 * XREFs of ?GetKMTAdapterType@CDXGIAdapterLimited@@AEAAJXZ @ 0x180027100
 * Callers:
...
__int64 __fastcall CDXGIAdapterLimited::GetKMTAdapterType(CDXGIAdapterLimited *this)
{
  ...
  if ( v3 < 0 )
  {
    v9 = 227;
LABEL_15:
    MilInstrumentationCheckHR_MaybeFailFast(v4, 0LL, 0, v3, v9, 0LL);
    goto LABEL_5;
  }
  ...
  {
    v5 = v6 | 0x10000000;
    MilInstrumentationCheckHR_MaybeFailFast(v7, 0LL, 0, v6 | 0x10000000, 0xEAu, 0LL);
  }
  else
  {
    *((_DWORD *)this + 90) = v13;
