/*
 * XREFs of ?CheckAndReportHighResourceUsage@CProcessResourceAttributionReporter@@AEAAXXZ @ 0x1800CBBA8
 * Callers:
        ...
        __int64 a3)
{
  ...
  if ( (unsigned __int8)wil::operator!=<CD3DDeviceLevel1,wil::err_returncode_policy>(&ListEntry) )
  {
