/*
 * XREFs of ?GetShapeDataCore@CRectangleGeometry@@MEBAJPEBUD2D_SIZE_F@@PEAVCShapePtr@@@Z @ 0x18008B290
 * Callers:
 *     <none>
 * Callees:
  ...
  if ( v12 > v10 && v13 > v11 )
  {
    ...
    if ( !v14 )
    {
      ...
      if ( !Value )
      {
        ...
        {
          MilInstrumentationCheckHR_MaybeFailFast(v26, 0LL, 0, 0x8007000E, 0x42u, 0LL);
...
LABEL_49:
    v5 = -2147024882;
    MilInstrumentationCheckHR_MaybeFailFast(v24, 0LL, 0, 0x8007000E, v30, 0LL);
    return v5;
  }
