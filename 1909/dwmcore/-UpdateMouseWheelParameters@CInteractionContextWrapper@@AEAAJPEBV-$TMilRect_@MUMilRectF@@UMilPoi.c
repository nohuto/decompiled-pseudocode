/*
 * XREFs of ?UpdateMouseWheelParameters@CInteractionContextWrapper@@AEAAJPEBV?$TMilRect_@MUMilRectF@@UMilPointAndSizeF@@UNotNeeded@RectUniqueness@@@@@Z @ 0x180233CAC
 * Callers:
...
__int64 __fastcall CInteractionContextWrapper::UpdateMouseWheelParameters(__int64 a1)
{
  ...
  if ( CCommonRegistryData::m_dwMousewheelScrollingMode == 2
    ...
    && !CCommonRegistryData::m_dwMousewheelScrollingMode
