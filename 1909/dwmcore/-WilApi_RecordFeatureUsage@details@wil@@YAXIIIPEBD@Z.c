/*
 * XREFs of ?WilApi_RecordFeatureUsage@details@wil@@YAXIIIPEBD@Z @ 0x1800AFF3C
 * Callers:
 ...
 *     ?RecordSRUMFeatureUsage@details@wil@@YAXIII@Z @ 0x1801549C0 (-RecordSRUMFeatureUsage@details@wil@@YAXIII@Z.c)
 * Callees:
