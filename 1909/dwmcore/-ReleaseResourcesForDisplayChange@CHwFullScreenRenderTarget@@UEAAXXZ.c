/*
 * XREFs of ?ReleaseResourcesForDisplayChange@CHwFullScreenRenderTarget@@UEAAXXZ @ 0x18002BEA0
 * Callers:
 *     ?ReleaseResourcesForDisplayChange@CHwFullScreenRenderTarget@@WJA@EAAXXZ @ 0x1800F0680 (-ReleaseResourcesForDisplayChange@CHwFullScreenRenderTarget@@WJA@EAAXXZ.c)
