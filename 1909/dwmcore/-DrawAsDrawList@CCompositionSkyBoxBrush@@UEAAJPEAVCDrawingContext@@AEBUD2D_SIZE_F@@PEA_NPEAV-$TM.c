/*
 * XREFs of ?DrawAsDrawList@CCompositionSkyBoxBrush@@UEAAJPEAVCDrawingContext@@AEBUD2D_SIZE_F@@PEA_NPEAV?$TMilRect_@MUMilRectF@@UMilPointAndSizeF@@UNotNeeded@RectUniqueness@@@@PEAVCDrawListCache@@@Z @ 0x1801D1980
 * Callers:
 *     <none>
 * Callees:
        ...
        struct ID2D1Geometry *a6)
{
  ...
  v28 = 0;
  CDrawingContext::GetWorldTransform((CDrawingContext *)a2, (struct CMILMatrix *)v27);
