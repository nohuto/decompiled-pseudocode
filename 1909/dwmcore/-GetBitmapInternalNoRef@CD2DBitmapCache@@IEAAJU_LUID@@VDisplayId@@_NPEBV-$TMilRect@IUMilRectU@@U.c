/*
 * XREFs of ?GetBitmapInternalNoRef@CD2DBitmapCache@@IEAAJU_LUID@@VDisplayId@@_NPEBV?$TMilRect@IUMilRectU@@UNotNeeded@RectUniqueness@@@@PEAPEAVID2DBitmap@@@Z @ 0x1800513B4
 * Callers:
...
LABEL_23:
    v22 = v16;
LABEL_54:
    MilInstrumentationCheckHR_MaybeFailFast(v8, 0LL, 0, v22, v27, 0LL);
    return v16;
  }
  if ( !a5 )
  {
  ...
  v23 = _mm_cvtsi128_si32(*a5);
  v29 = *a5;
  if ( v23 )
    --v23;
  v24 = v29.m128i_u32[1];
  if ( v29.m128i_i32[1] )
    v24 = v29.m128i_i32[1] - 1;
  v25 = v29.m128i_u32[2];
  if ( v29.m128i_i32[2] != -1 )
    v25 = v29.m128i_i32[2] + 1;
  v26 = v29.m128i_u32[3];
  if ( v29.m128i_i32[3] != -1 )
    v26 = v29.m128i_i32[3] + 1;
  CD2DBitmapCache::GetBitmapRect(this, (struct MilRectU *)&v30);
  if ( (unsigned int)v30 > v23 )
...
LABEL_4:
  ...
  if ( !v12
    ...
    || (v14 = (_DWORD *)(*(__int64 (__fastcall **)(_QWORD, struct CSecondaryD2DBitmap **))(**((_QWORD **)this + 4) + 40LL))(
                          *((_QWORD *)this + 4),
                          &v30),
        *v14 != (_DWORD)DisplayId::None)
    && *v14 != a3
    && a3 != (_DWORD)DisplayId::All
