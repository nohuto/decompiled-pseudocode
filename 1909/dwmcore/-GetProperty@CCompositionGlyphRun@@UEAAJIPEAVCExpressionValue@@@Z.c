/*
 * XREFs of ?GetProperty@CCompositionGlyphRun@@UEAAJIPEAVCExpressionValue@@@Z @ 0x1801CF630
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall CCompositionGlyphRun::GetProperty(CCompositionGlyphRun *this, int a2, struct CExpressionValue *a3)
{
  unsigned int v4; // ebx
