/*
 * XREFs of ?BeginCompile@CEffectCompilationService@@QEAAJPEAVCCompiledEffectTemplate@@PEAUIEffectDescription@Composition@UI@Windows@@PEAPEAVCEffectCompilationTask@@@Z @ 0x1800C5EE8
 * Callers:
 ...
 *     ?TryReviveDeadTask@CEffectCompilationService@@AEAAXPEBVCEffectCompilationTask@@@Z @ 0x1800C620C (-TryReviveDeadTask@CEffectCompilationService@@AEAAXPEBVCEffectCompilationTask@@@Z.c)
        ...
        struct CEffectCompilationTask **a4)
{
  ...
  int v45; // ecx
  __int64 v46; // rcx
  struct _RTL_CRITICAL_SECTION *v47[2]; // [rsp+40h] [rbp-28h] BYREF
  ...
  if ( v47[0] == this[15] )
  {
    ...
    v29 = CEffectCompilationTask::CEffectCompilationTask(v27, (struct CEffectCompilationService *)this, a3);
    Microsoft::WRL::ComPtr<CEffectCompilationTask>::operator=(&pv, v29);
    v10 = (PTP_WORK *)pv;
    if ( !pv )
    {
      v15 = -2147024882;
      MilInstrumentationCheckHR_MaybeFailFast(v30, 0LL, 0, 0x8007000E, 0x8Au, 0LL);
  ...
  {
    Microsoft::WRL::ComPtr<CEffectCompilationTask>::operator=(&pv, v47[0]->SpinCount);
    v10 = (PTP_WORK *)pv;
  ...
  {
    v15 = -2147024362;
    MilInstrumentationCheckHR_MaybeFailFast(2147942934LL, 0LL, 0, 0x80070216, 0xB8u, 0LL);
    goto LABEL_8;
  }
  if ( v12 > *((_DWORD *)v10 + 9) )
  {
...
LABEL_8:
  ...
  *((_DWORD *)v10 + 10) = v12;
LABEL_9:
  v47[0] = (struct _RTL_CRITICAL_SECTION *)(this + 4);
