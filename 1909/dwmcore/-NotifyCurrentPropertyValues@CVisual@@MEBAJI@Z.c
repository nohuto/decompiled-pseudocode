/*
 * XREFs of ?NotifyCurrentPropertyValues@CVisual@@MEBAJI@Z @ 0x1800C0DB0
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall CVisual::NotifyCurrentPropertyValues(CVisual *this, int a2)
{
  ...
  if ( *(_QWORD *)&v23.x == CVisual::sc_defaultOffset )
    v7 = LODWORD(v23.z) - (unsigned __int64)(unsigned int)dword_18033D360;
  if ( v7
    && (v10 = CPropertyChangeResource::NotifyVector3PropertyChanged(this, 0x1Cu, (const struct D2DVector3 *)&v23),
        v2 = v10,
        v10 < 0) )
  {
    MilInstrumentationCheckHR_MaybeFailFast(v11, 0LL, 0, v10, 0x1B79u, 0LL);
  }
  else
  {
LABEL_29:
      ...
      || (v13 = CPropertyChangeResource::NotifyScalarPropertyChanged(this, 0x1Au, OpacityInternal), v2 = v13, v13 >= 0) )
    {
            ...
            v15 >= 0) )
      {
        ...
        if ( *(_QWORD *)&v22.x == CVisual::sc_defaultRelativeOffset )
          v17 = LODWORD(v23.z) - (unsigned __int64)(unsigned int)dword_18033D370;
        if ( v17
          && (v18 = CPropertyChangeResource::NotifyVector3PropertyChanged(this, 0x1Eu, (const struct D2DVector3 *)&v23),
              v2 = v18,
              v18 < 0) )
        {
          MilInstrumentationCheckHR_MaybeFailFast(v19, 0LL, 0, v18, 0x1B98u, 0LL);
        }
        else
        {
LABEL_30:
          if ( a2 < 0 )
          {
            ...
            *(_QWORD *)&v22.x = *(_QWORD *)&v23.x;
            if ( *(_QWORD *)&v23.x != CVisual::sc_defaultRelativeSize )
            {
              ...
              v2 = v20;
              if ( v20 < 0 )
                MilInstrumentationCheckHR_MaybeFailFast(v21, 0LL, 0, v20, 0x1BA2u, 0LL);
            }
          }
        }
      }
      ...
      {
        MilInstrumentationCheckHR_MaybeFailFast(v16, 0LL, 0, v15, 0x1B8Bu, 0LL);
      }
    }
    else
    {
      MilInstrumentationCheckHR_MaybeFailFast(v14, 0LL, 0, v13, 0x1B82u, 0LL);
    }
  }
  return v2;
}
