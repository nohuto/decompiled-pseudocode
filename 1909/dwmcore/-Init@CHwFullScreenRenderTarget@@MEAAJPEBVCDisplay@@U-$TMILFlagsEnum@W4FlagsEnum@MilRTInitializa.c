/*
 * XREFs of ?Init@CHwFullScreenRenderTarget@@MEAAJPEBVCDisplay@@U?$TMILFlagsEnum@W4FlagsEnum@MilRTInitialization@@@@@Z @ 0x1800E3960
 * Callers:
...
__int64 __fastcall CHwFullScreenRenderTarget::Init(CBaseRenderTarget *this, CDisplay *a2)
{
  ...
  *((_BYTE *)this + 500) = CComputeScribbleRenderer::IsDriverWhitelisted(*((const struct CD3DDeviceLevel1 **)this + 19));
  ...
  if ( (*((_DWORD *)this + 55) & 0x400) != 0 )
  {
    ...
    else if ( (*(unsigned int (__fastcall **)(CSwapChainBase *))(*(_QWORD *)*v4 + 304LL))(*v4) != 2 )
    {
      *((_BYTE *)a2 + 318) = 1;
      ...
      v9 = -2003304306;
      MilInstrumentationCheckHR_MaybeFailFast(v11, &dword_1802BE358, 3u, 0x8898008E, 0x4Cu, 0LL);
      return v9;
    }
  }
  ...
  if ( SwapChain < 0 )
  {
    v12 = 95;
LABEL_15:
    MilInstrumentationCheckHR_MaybeFailFast(v8, &dword_1802BE358, 3u, SwapChain, v12, 0LL);
  }
  return v9;
}
