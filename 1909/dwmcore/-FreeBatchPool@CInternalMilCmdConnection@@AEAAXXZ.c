/*
 * XREFs of ?FreeBatchPool@CInternalMilCmdConnection@@AEAAXXZ @ 0x18006F46C
 * Callers:
 *     ?ClearCaches@CInternalMilCmdConnection@@UEAA_NK@Z @ 0x1800C2400 (-ClearCaches@CInternalMilCmdConnection@@UEAA_NK@Z.c)
