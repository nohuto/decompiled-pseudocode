/*
 * XREFs of McTemplateU0pqqpxffffffffffffffff @ 0x180236014
 * Callers:
...
ULONG __fastcall McTemplateU0pqqpxffffffffffffffff(
        __int64 a1,
        __int64 a2,
        __int64 a3,
        int a4,
        ...
        char a23)
{
  ...
  __int64 v67; // [rsp+1C0h] [rbp+C0h] BYREF
  ...
  v64 = 4LL;
  v66 = 4LL;
  return McGenEventWrite(Microsoft_Windows_Dwm_Core_Provider_Context, &EVTDESC_HIT_TEST_Stop, a3, 0x16u, &v24);
}
