/*
 * XREFs of ?DebugDump@CCursorVisual@@UEAAXPEAVCVisualTreeDumpContext@@@Z @ 0x180212A30
 * Callers:
 *     <none>
 * Callees:
...
void __fastcall CCursorVisual::DebugDump(CCursorVisual *this, struct CVisualTreeDumpContext *a2)
{
  _QWORD v3[4]; // [rsp+20h] [rbp-38h] BYREF

  CVisual::DebugDump(this, a2);
  std::string::string(v3, (__int64)"CCursorVisual");
