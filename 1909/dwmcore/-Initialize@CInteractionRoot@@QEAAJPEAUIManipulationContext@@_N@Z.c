/*
 * XREFs of ?Initialize@CInteractionRoot@@QEAAJPEAUIManipulationContext@@_N@Z @ 0x1801D5A74
 * Callers:
 ...
 * Callees:
 *     ??0CInteractionContextWrapper@@QEAA@XZ @ 0x1800C18A8 (--0CInteractionContextWrapper@@QEAA@XZ.c)
