/*
 * XREFs of ?Create@CDxHandleAdvancedDirectFlipBitmapRealization@@SAHW4CompositionBufferType@@AEBUCSM_BUFFER_ATTRIBUTES@@AEBUCSM_REALIZATION_INFO@@U_LUID@@PEAPEAVCBitmapRealization@@@Z @ 0x180052880
 * Callers:
        ...
        CDxHandleBitmapRealization **a5)
{
  ...
  *a5 = 0LL;
  if ( (*(_DWORD *)(a2 + 116) & 0x100) != 0 )
  {
    ...
    {
      v9 = -2003292288;
      MilInstrumentationCheckHR_MaybeFailFast(a1, &dword_1802B0F20, 2u, -2003292288, 0x28u, 0LL);
    }
    else
    {
      ...
      if ( v13 )
      {
        ...
        if ( v14 < 0 )
        {
          MilInstrumentationCheckHR_MaybeFailFast(v15, &dword_1802B0F20, 2u, v14, 0x32u, 0LL);
        }
        else
        {
          ...
          if ( v9 < 0 )
          {
            MilInstrumentationCheckHR_MaybeFailFast(v17, &dword_1802B0F20, 2u, v9, 0x34u, 0LL);
          }
          else
          {
            *a5 = v13;
      ...
      {
        v9 = -2147024882;
        MilInstrumentationCheckHR_MaybeFailFast(v12, &dword_1802B0F20, 2u, -2147024882, 0x2Fu, 0LL);
      }
    }
  }
  else
  {
    v9 = -2003292287;
    MilInstrumentationCheckHR_MaybeFailFast(a1, &dword_1802B0F20, 2u, -2003292287, 0x23u, 0LL);
  }
  return (unsigned int)v9;
}
