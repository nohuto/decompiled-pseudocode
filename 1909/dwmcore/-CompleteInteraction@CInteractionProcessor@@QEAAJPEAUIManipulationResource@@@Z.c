/*
 * XREFs of ?CompleteInteraction@CInteractionProcessor@@QEAAJPEAUIManipulationResource@@@Z @ 0x18022EB50
 * Callers:
 *     ?CompleteInteraction@CInteraction@@UEAAJXZ @ 0x1801D5770 (-CompleteInteraction@CInteraction@@UEAAJXZ.c)
 *     ?CompleteInteraction@CInteractionRoot@@UEAAJXZ @ 0x18023AE00 (-CompleteInteraction@CInteractionRoot@@UEAAJXZ.c)
 * Callees:
