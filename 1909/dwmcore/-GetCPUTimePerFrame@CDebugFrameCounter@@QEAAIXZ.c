/*
 * XREFs of ?GetCPUTimePerFrame@CDebugFrameCounter@@QEAAIXZ @ 0x180191F98
 * Callers:
 ...
 * Callees:
 *     ?GetFrameCountInternal@CDebugFrameCounter@@IEAAIXZ @ 0x180191FE8 (-GetFrameCountInternal@CDebugFrameCounter@@IEAAIXZ.c)
 */
