/*
 * XREFs of ?GetBits@CDesktopRenderTarget@@UEAAJPEBUtagRECT@@PEAVIBitmapDest@@@Z @ 0x180025A10
 * Callers:
 *     ?GetBits@CDesktopRenderTarget@@WGI@EAAJPEBUtagRECT@@PEAVIBitmapDest@@@Z @ 0x1800F0DE0 (-GetBits@CDesktopRenderTarget@@WGI@EAAJPEBUtagRECT@@PEAVIBitmapDest@@@Z.c)
 * Callees:
