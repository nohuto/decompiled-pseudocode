/*
 * XREFs of ?Transform@?$CSimdNonScale2DOperator@U?$Vertex_UVxN@UVertexXYW_ColorDW@@@@@VertexTransfer@@QEAQXAEBU?$Vertex_UVxN@UVertexXYW_ColorDW@@@@T__m128@@1IPEAU3@@Z @ 0x1800CA9B4
 * Callers:
        ...
        __m128 *a6)
{
  ...
  *a6 = _mm_or_ps(
  ...
  if ( a5 )
  {
    ...
    do
    {
      *m128_f32 = *(_OWORD *)((char *)m128_f32 + v8);
      ++m128_f32;
      --v9;
    }
    while ( v9 );
