/*
 * XREFs of ?ProcessSetSurface@CSceneSurfaceMaterialInput@@QEAAJPEAVCResourceTable@@PEBUtagMILCMD_SCENESURFACEMATERIALINPUT_SETSURFACE@@@Z @ 0x1801F8954
 * Callers:
        ...
        const struct tagMILCMD_SCENESURFACEMATERIALINPUT_SETSURFACE *a3)
{
  ...
  if ( v5 )
  {
    Resource = (struct CResource *)CResourceTable::GetResource((__int64)a2, v5, 0x22u);
    if ( !Resource )
    {
  ...
  if ( Resource != this[9] )
  {
    ...
    v12 = *this;
    this[9] = Resource;
    (*((void (__fastcall **)(struct CResource **, _QWORD, struct CResource **))v12 + 8))(this, 0LL, this);
  }
  v11 = 0;
LABEL_9:
  if ( v11 >= 0 )
