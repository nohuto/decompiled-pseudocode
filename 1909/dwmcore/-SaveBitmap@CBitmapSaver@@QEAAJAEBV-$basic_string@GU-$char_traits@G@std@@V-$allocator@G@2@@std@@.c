/*
 * XREFs of ?SaveBitmap@CBitmapSaver@@QEAAJAEBV?$basic_string@GU?$char_traits@G@std@@V?$allocator@G@2@@std@@@Z @ 0x180255C48
 * Callers:
 ...
 * Callees:
 *     ?c_str@?$basic_string@GU?$char_traits@G@std@@V?$allocator@G@2@@std@@QEBAPEBGXZ @ 0x18004C5B4 (-c_str@-$basic_string@GU-$char_traits@G@std@@V-$allocator@G@2@@std@@QEBAPEBGXZ.c)
...
__int64 __fastcall CBitmapSaver::SaveBitmap(CBitmapSaver *this, wchar_t *a2)
{
  ...
  {
    v10 = -2147024809;
    MilInstrumentationCheckHR_MaybeFailFast(v8, 0LL, 0, 0x80070057, 0x73u, 0LL);
    goto LABEL_16;
  }
