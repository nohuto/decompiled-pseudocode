/*
 * XREFs of ?HaveOverlayCandidatesChanged@COverlayContext@@AEAA_NXZ @ 0x18006FE74
 * Callers:
 ...
 *     ?IsEqualTo@CRgnData@Internal@FastRegion@@QEBA_NAEBV123@@Z @ 0x1801850E0 (-IsEqualTo@CRgnData@Internal@FastRegion@@QEBA_NAEBV123@@Z.c)
 */
...
char __fastcall COverlayContext::HaveOverlayCandidatesChanged(COverlayContext *this)
{
  ...
  if ( (*((_QWORD *)this + 25) - v4) >> 8 != (*((_QWORD *)this + 540) - v3) >> 8
    || *((_BYTE *)this + 13441) != *((_BYTE *)this + 13442)
  ...
  if ( v5 )
  {
    while ( 1 )
    {
      ...
      if ( *(_QWORD *)(v8 + v4 + 16) != *(_QWORD *)(v8 + v3 + 16)
        ...
        || operator!=((float *)(v8 + v4 + 152), (float *)(v8 + v3 + 152)) )
      {
        break;
      }
