/*
 * XREFs of ?InsertChildAt@CVisual@@IEAAJPEAV1@I_N@Z @ 0x1800B9728
 * Callers:
...
__int64 __fastcall CVisual::InsertChildAt(CVisual *this, struct CVisual *a2, unsigned int a3, char a4)
{
  ...
  {
    v25 = -2147024809;
    MilInstrumentationCheckHR_MaybeFailFast((__int64)this, 0LL, 0, 0x80070057, 0x2EDu, 0LL);
  }
  else
  {
      ...
      *((_QWORD *)a2 + 63) = 0LL;
      ...
      if ( (*((_BYTE *)a2 + 95) & 4) != 0 )
      {
        ...
        if ( (_DWORD)v12 )
        {
          ...
          do
          {
            v54 = CPtrArrayBase::operator[]((__int64 *)this + 3, v52);
            if ( v54 != *((_QWORD *)this + 10) )
              (*(void (__fastcall **)(unsigned __int64, _QWORD, CVisual *))(*(_QWORD *)v54 + 64LL))(v54, 0LL, this);
            ++v52;
            --v53;
          }
          while ( v53 );
        ...
        *((_DWORD *)this + 22) |= 0x11u;
        ...
        if ( (_DWORD)v17 )
        {
          ...
          do
          {
            v57 = CPtrArrayBase::operator[]((__int64 *)a2 + 3, v55);
            if ( v57 != *((_QWORD *)a2 + 10) )
              (*(void (__fastcall **)(unsigned __int64, __int64, struct CVisual *))(*(_QWORD *)v57 + 64LL))(
                v57,
                1LL,
                a2);
            ++v55;
            ...
            *((_DWORD *)v21 + 22) |= 0x40u;
            ...
            if ( (_DWORD)v30 )
            {
              ...
              do
              {
                ...
                if ( v49 != v21[10] )
                  (*(void (__fastcall **)(unsigned __int64, __int64, __int64 *))(*(_QWORD *)v49 + 64LL))(v49, 1LL, v21);
                ++v47;
                --v48;
              }
              while ( v48 );
