/*
 * XREFs of ?InferVisualToTextureTransform@CGradientBrush@@IEBAJAEAY02$$CBUD2D_POINT_2F@@AEBV?$TMilRect_@MUMilRectF@@UMilPointAndSizeF@@UNotNeeded@RectUniqueness@@@@PEAUD2D_MATRIX_3X2_F@@@Z @ 0x1800190F0
 * Callers:
 ...
 * Callees:
 *     ?InferAffineMatrix@CMILMatrix@@QEAAXAEBV?$TMilRect_@MUMilRectF@@UMilPointAndSizeF@@UNotNeeded@RectUniqueness@@@@PEBUMilPoint2F@@@Z @ 0x180019214 (-InferAffineMatrix@CMILMatrix@@QEAAXAEBV-$TMilRect_@MUMilRectF@@UMilPointAndSizeF@@UNotNeeded@Re.c)
...
LABEL_5:
  ...
  *(_QWORD *)&v7->m[2][0] = v6;
  ...
  {
    v9 = -2003304441;
    MilInstrumentationCheckHR_MaybeFailFast(v8, (const int *const)"\a", 1u, -2003304441, 0x1A3u, 0LL);
  }
  return v9;
}
