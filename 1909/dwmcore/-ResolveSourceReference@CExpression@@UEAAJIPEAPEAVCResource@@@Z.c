/*
 * XREFs of ?ResolveSourceReference@CExpression@@UEAAJIPEAPEAVCResource@@@Z @ 0x1800BB1F0
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall CExpression::ResolveSourceReference(CExpression *this, unsigned int a2, struct CResource **a3)
{
  ...
  *a3 = v3;
  ...
  {
    v4 = -2147467259;
    MilInstrumentationCheckHR_MaybeFailFast(0LL, &dword_1802A1DA8, 1u, 0x80004005, 0x14Cu, 0LL);
  }
  return v4;
}
