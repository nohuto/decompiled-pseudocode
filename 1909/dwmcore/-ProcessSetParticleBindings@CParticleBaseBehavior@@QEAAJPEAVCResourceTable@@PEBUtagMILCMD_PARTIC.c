/*
 * XREFs of ?ProcessSetParticleBindings@CParticleBaseBehavior@@QEAAJPEAVCResourceTable@@PEBUtagMILCMD_PARTICLEBASEBEHAVIOR_SETPARTICLEBINDINGS@@PEBXI@Z @ 0x1801FD6D8
 * Callers:
