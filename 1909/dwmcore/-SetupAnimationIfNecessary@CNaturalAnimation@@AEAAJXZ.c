/*
 * XREFs of ?SetupAnimationIfNecessary@CNaturalAnimation@@AEAAJXZ @ 0x1801E5968
 * Callers:
 ...
 *     ?SetStartTimeIfNecessary@CNaturalAnimation@@AEAAX_K@Z @ 0x1801E56E8 (-SetStartTimeIfNecessary@CNaturalAnimation@@AEAAX_K@Z.c)
 */
