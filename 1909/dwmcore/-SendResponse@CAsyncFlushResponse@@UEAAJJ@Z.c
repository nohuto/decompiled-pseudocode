/*
 * XREFs of ?SendResponse@CAsyncFlushResponse@@UEAAJJ@Z @ 0x1800D3E10
 * Callers:
 *     ?OnPresentComplete@CAsyncFlushResponse@@UEAAJXZ @ 0x1800D3E00 (-OnPresentComplete@CAsyncFlushResponse@@UEAAJXZ.c)
 * Callees:
