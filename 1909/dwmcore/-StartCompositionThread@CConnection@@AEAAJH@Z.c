/*
 * XREFs of ?StartCompositionThread@CConnection@@AEAAJH@Z @ 0x1800E63EC
 * Callers:
    ...
    if ( v6 )
    {
      ...
      if ( SetThreadPriority(*((HANDLE *)this + 3), nPriority) )
      {
        ...
        if ( ResumeThread(*((HANDLE *)this + 3)) == -1 )
        {
          ...
          if ( v3 >= 0 )
            v3 = -2003304445;
          MilInstrumentationCheckHR_MaybeFailFast(v14, 0LL, 0, v3, 0xA1u, 0LL);
        }
        else
        {
          ...
          if ( !WaitForMultipleObjects(2u, Handles, 0, 0xFFFFFFFF) )
          {
            ...
            if ( v3 >= 0 )
              v3 = -2003304445;
            MilInstrumentationCheckHR_MaybeFailFast(v16, 0LL, 0, v3, 0xA5u, 0LL);
          }
        }
      }
      else
      {
        ...
        if ( v3 >= 0 )
          v3 = -2003304445;
        MilInstrumentationCheckHR_MaybeFailFast(v12, 0LL, 0, v3, 0x9Eu, 0LL);
      }
    }
    else
    {
      v3 = -2147024882;
      MilInstrumentationCheckHR_MaybeFailFast(v7, 0LL, 0, 0x8007000E, 0x99u, 0LL);
    }
  }
  else
  {
    ...
    if ( v3 >= 0 )
      v3 = -2003304445;
    MilInstrumentationCheckHR_MaybeFailFast(v10, 0LL, 0, v3, 0x91u, 0LL);
  }
