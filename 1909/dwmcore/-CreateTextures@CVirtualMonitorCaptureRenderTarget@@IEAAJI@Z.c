/*
 * XREFs of ?CreateTextures@CVirtualMonitorCaptureRenderTarget@@IEAAJI@Z @ 0x1801A524C
 * Callers:
        ...
        unsigned int a2)
{
  ...
  v4 = 0;
  *((_QWORD *)this + 50) = *(_QWORD *)(*(__int64 (__fastcall **)(_QWORD, void **))(**(_QWORD **)(*((_QWORD *)this + 2)
                                                                                               + 112LL)
                                                                                 + 40LL))(
                                        *(_QWORD *)(*((_QWORD *)this + 2) + 112LL),
                                        &v22);
  D3DDeviceNoRef = CCaptureRenderTarget::GetD3DDeviceNoRef(this);
  if ( D3DDeviceNoRef )
  {
    v6 = (__int64 *)*((_QWORD *)D3DDeviceNoRef + 79);
    v7 = 0;
    if ( a2 )
    {
      while ( 1 )
      {
        ...
        v23[8] = 40;
        v23[10] = 2050;
        wil::com_ptr_t<ID3D12Fence,wil::err_returncode_policy>::reset((__int64 *)&v20);
        ...
        if ( (v4 & 0x80000000) != 0 )
        {
          MilInstrumentationCheckHR_MaybeFailFast(v15, 0LL, 0, v4, 0x11Bu, 0LL);
          goto LABEL_20;
        }
