/*
 * XREFs of ??$_Emplace_reallocate@PEBUShaderLinkingBody@@@?$vector@PEBUShaderLinkingBody@@V?$allocator@PEBUShaderLinkingBody@@@std@@@std@@QEAAPEAPEBUShaderLinkingBody@@QEAPEBU2@$$QEAPEBU2@@Z @ 0x18002FF30
 * Callers:
        ...
        _QWORD *a3)
{
  ...
  *(_QWORD *)&v13[8 * v4] = *a3;
  ...
  std::vector<CColorGradientStop *>::_Change_array(a1, v13, v8, v11);
