/*
 * XREFs of ?Create@CD3DDeviceLevel1@@SAJPEAVCDXGIAdapterLimited@@PEAVIMILPoolManager@@PEAPEAV1@@Z @ 0x18002D3CC
 * Callers:
 ...
 *     ??0CD3DDeviceLevel1@@AEAA@PEAVIMILPoolManager@@@Z @ 0x18002D074 (--0CD3DDeviceLevel1@@AEAA@PEAVIMILPoolManager@@@Z.c)
        ...
        struct CD3DDeviceLevel1 **a3)
{
  ...
  *a3 = 0LL;
  ...
  if ( v7 < 0 )
  {
    MilInstrumentationCheckHR_MaybeFailFast(v8, &dword_180280CA0, 1u, v7, 0x166u, 0LL);
  }
  else
  {
    ...
    {
      v9 = -2147024882;
      MilInstrumentationCheckHR_MaybeFailFast(v11, &dword_180280CA0, 1u, -2147024882, 0x169u, 0LL);
      goto LABEL_7;
    }
    ...
    MilInstrumentationCheckHR_MaybeFailFast(v13, &dword_180280CA0, 1u, v12, 0x16Du, 0LL);
  }
  if ( v4 )
