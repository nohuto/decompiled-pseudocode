/*
 * XREFs of ?ProcessSetSpriteClip@CWindowNode@@QEAAJPEAVCResourceTable@@PEBUtagMILCMD_WINDOWNODE_SETSPRITECLIP@@@Z @ 0x18009A5B8
 * Callers:
        ...
        const struct tagMILCMD_WINDOWNODE_SETSPRITECLIP *a3)
{
    ...
    && (*(unsigned __int8 (__fastcall **)(__int64, __int64))(*(_QWORD *)Resource + 48LL))(Resource, 140LL) )
  {
    if ( v4 != *((struct CResource **)this + 100) )
    {
      ...
      MilInstrumentationCheckHR_MaybeFailFast(v15, 0LL, 0, v14, 0x460u, 0LL);
    }
  }
  else
  {
    v3 = -2003303421;
    MilInstrumentationCheckHR_MaybeFailFast(v13, 0LL, 0, 0x88980403, 0x45Au, 0LL);
  }
  if ( v9 )
  {
LABEL_11:
