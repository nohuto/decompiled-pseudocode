/*
 * XREFs of ?Render@CDrawListCache@@QEAAJPEAVCDrawingContext@@AEBVCMILMatrix@@MW4Enum@MilCompositingMode@@@Z @ 0x180096510
 * Callers:
 ...
 *     ?CeilingSat@CFloatFPU@@SAHM@Z @ 0x1800BCED8 (-CeilingSat@CFloatFPU@@SAHM@Z.c)
...
__int64 __fastcall CDrawListCache::Render(__int64 a1, CDrawingContext *a2, __int64 a3, float a4)
{
  __m128 v4; // xmm2
  bool v5; // cc
  __int64 v6; // rax
...
LABEL_9:
  ...
  {
    v21 = *(__int64 **)v17;
    if ( (*(_DWORD *)(*(_QWORD *)v17 + 132LL) & 0x400) != 0 && CMILMatrix::Is2DAxisAlignedPreserving<1>(v8) )
    {
      v37 = (float)((float)(*((float *)v21 + 13) * *(float *)(v8 + 16)) + (float)(*((float *)v21 + 12) * *(float *)v8))
          + *(float *)(v8 + 48);
      v38 = (float)((float)(*((float *)v21 + 13) * *(float *)(v8 + 20))
                  + (float)(*((float *)v21 + 12) * *(float *)(v8 + 4)))
          + *(float *)(v8 + 52);
      ...
      if ( COERCE_UNSIGNED_INT(
             fabs(
               (float)((float)(*((float *)v21 + 13) * *(float *)(v8 + 20))
                     + (float)(*((float *)v21 + 12) * *(float *)(v8 + 4)))
             + *(float *)(v8 + 52))) > 0x497FFFF0 )
      {
