/*
 * XREFs of ?AddOrUpdateTrackerBindings@CInteractionTrackerBindingManager@@AEAAXPEAVCInteractionTracker@@0W4InteractionTrackerBindingModeFlags@@@Z @ 0x1801DD8CC
 * Callers:
 ...
 *     ??$verify_hresult@J@wil@@YAJJ@Z @ 0x180153670 (--$verify_hresult@J@wil@@YAJJ@Z.c)
 ...
 *     ??8?$_Tree_const_iterator@V?$_Tree_val@U?$_Tree_simple_types@PEAVCInteractionTracker@@@std@@@std@@@std@@QEBA_NAEBV01@@Z @ 0x1801DD764 (--8-$_Tree_const_iterator@V-$_Tree_val@U-$_Tree_simple_types@PEAVCInteractionTracker@@@std@@@std.c)
