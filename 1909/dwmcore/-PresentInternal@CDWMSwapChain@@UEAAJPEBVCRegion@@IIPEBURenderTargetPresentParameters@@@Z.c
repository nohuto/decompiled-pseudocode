/*
 * XREFs of ?PresentInternal@CDWMSwapChain@@UEAAJPEBVCRegion@@IIPEBURenderTargetPresentParameters@@@Z @ 0x18006C6B0
 * Callers:
 *     <none>
 * Callees:
 ...
 *     ?DbgSavePresentInfo@CDWMSwapChain@@IEAAXW4DbgPresentType@1@IJI@Z @ 0x180162B1C (-DbgSavePresentInfo@CDWMSwapChain@@IEAAXW4DbgPresentType@1@IJI@Z.c)
...
LABEL_164:
      ...
      DynArrayImpl<0>::~DynArrayImpl<0>(v116);
      goto LABEL_43;
    }
    while ( 1 )
    {
