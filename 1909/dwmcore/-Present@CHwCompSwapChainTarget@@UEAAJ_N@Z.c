/*
 * XREFs of ?Present@CHwCompSwapChainTarget@@UEAAJ_N@Z @ 0x18023EAE0
 * Callers:
 *     ?Present@CHwCompSwapChainTarget@@WNA@EAAJ_N@Z @ 0x1800F1490 (-Present@CHwCompSwapChainTarget@@WNA@EAAJ_N@Z.c)
 * Callees:
...
__int64 __fastcall CHwCompSwapChainTarget::Present(CHwCompSwapChainTarget *this, char a2)
{
  ...
  if ( a2 || **((_DWORD **)this + 30) )
  {
    ...
    if ( v4 < 0 )
    {
      MilInstrumentationCheckHR_MaybeFailFast(v5, &dword_1802E22B8, 1u, v4, 0x169u, 0LL);
    }
    else
    {
      ...
      if ( v6 < 0 )
      {
        MilInstrumentationCheckHR_MaybeFailFast(v7, &dword_1802E22B8, 1u, v6, 0x16Bu, 0LL);
      }
      else
      {
        ...
        if ( v9 < 0 )
        {
          MilInstrumentationCheckHR_MaybeFailFast(v10, &dword_1802E22B8, 1u, v9, 0x170u, 0LL);
        }
        else
        {
          ...
          v2 = v11;
          if ( v11 < 0 )
            MilInstrumentationCheckHR_MaybeFailFast(v12, &dword_1802E22B8, 1u, v11, 0x172u, 0LL);
        }
      }
    }
