/*
 * XREFs of ?_Add@CDirtyRegion@@AEAAJPEAVCVisual@@_NAEBV?$TMilRect_@MUMilRectF@@UMilPointAndSizeF@@UNotNeeded@RectUniqueness@@@@@Z @ 0x18008A330
 * Callers:
 ...
 *     ?UpdateAcceleration@CDirtyRegion@@AEAAXI@Z @ 0x180033EA4 (-UpdateAcceleration@CDirtyRegion@@AEAAXI@Z.c)
 ...
 *     ?CalcDirtyRegionCachedData@CDirtyRegion@@AEAAXAEBV?$TMilRect_@MUMilRectF@@UMilPointAndSizeF@@UNotNeeded@RectUniqueness@@@@PEAUDirtyRegionCachedData@1@@Z @ 0x18007DC8C (-CalcDirtyRegionCachedData@CDirtyRegion@@AEAAXAEBV-$TMilRect_@MUMilRectF@@UMilPointAndSizeF@@UNo.c)
      ...
      if ( !*((_BYTE *)this + 2884) )
      {
        ...
        if ( a2 )
        {
          ...
          if ( v22 == 32 )
          {
            ...
            {
              v4 = -2147024882;
              MilInstrumentationCheckHR_MaybeFailFast(v128, 0LL, 0, 0x8007000E, 0x1Bu, 0LL);
              MilInstrumentationCheckHR_MaybeFailFast(v132, 0LL, 0, 0x8007000E, 0x1FFu, 0LL);
              return v4;
            }
