/*
 * XREFs of ?UnmapSharedMemory@CSharedSection@@AEBAXXZ @ 0x1800D34FC
 * Callers:
 *     ??1CSharedSection@@UEAA@XZ @ 0x1800D34A0 (--1CSharedSection@@UEAA@XZ.c)
 *     ?OnChanged@CSharedSection@@MEAAHW4Flags@NotificationEventArgs@@PEAUIUnknown@@@Z @ 0x1800D3CE0 (-OnChanged@CSharedSection@@MEAAHW4Flags@NotificationEventArgs@@PEAUIUnknown@@@Z.c)
 * Callees:
