/*
 * XREFs of ?_UpdateInteractionOutput@CInteractionContextWrapper@@AEAAXPEBUINTERACTION_CONTEXT_OUTPUT@@PEAUInteractionOutput@@@Z @ 0x180233E10
 * Callers:
        ...
        struct InteractionOutput *a3)
{
  ...
  *((_DWORD *)a3 + 11) = *((_DWORD *)a2 + 4);
  ...
  if ( dword_180337240 > 4u && TlgKeywordOn((TraceLoggingHProvider)&dword_180337240, 2uLL) )
  {
    ...
    v62 = v19;
    v63 = 4LL;
    TlgWrite((TraceLoggingHProvider)&dword_180337240, &unk_1802DCF21, 0LL, 0LL, 0x13u, &pData);
  }
  v20 = v22;
  *v8 = v21;
  *v9 = v20;
