/*
 * XREFs of ?CreateTexture@CD3DVidMemOnlyTexture@@SAJAEBVDWM_TEXTURE2D_DESC@@PEAVCD3DDeviceLevel1@@PEAPEAV1@@Z @ 0x1800499E0
 * Callers:
        ...
        struct D3D11_SUBRESOURCE_DATA *a3)
{
  ...
  v12 = 0LL;
  v5 = CD3DDeviceLevel1::CreateTexture(this, a1, a3, &v12);
  v7 = v12;
  v8 = v5;
  if ( v5 < 0 )
  {
    MilInstrumentationCheckHR_MaybeFailFast(v6, 0LL, 0, v5, 0x49u, 0LL);
  }
  else
  {
    v9 = CD3DVidMemOnlyTexture::CreateFromTexture(v12, 0, 0, this, (struct CD3DVidMemOnlyTexture **)a3);
    v8 = v9;
    if ( v9 < 0 )
