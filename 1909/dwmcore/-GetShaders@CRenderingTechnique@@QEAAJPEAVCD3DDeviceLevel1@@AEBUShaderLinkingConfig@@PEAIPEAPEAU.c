/*
 * XREFs of ?GetShaders@CRenderingTechnique@@QEAAJPEAVCD3DDeviceLevel1@@AEBUShaderLinkingConfig@@PEAIPEAPEAUID3D11PixelShader@@@Z @ 0x1800437EC
 * Callers:
 ...
 *     ?GetConstantBufferRequirements@ShaderLinkingConfig@@QEBA?AUConstantBufferRequirements@1@XZ @ 0x1800451D8 (-GetConstantBufferRequirements@ShaderLinkingConfig@@QEBA-AUConstantBufferRequirements@1@XZ.c)
...
LABEL_23:
  ...
  else
  {
    ...
    v32 = *(_QWORD *)v27;
    v29 = v48;
    while ( *(_QWORD *)v32 != v47 || *(_DWORD *)(v32 + 8) != (_DWORD)v48 )
    {
      ++v30;
      ++v31;
      v32 += 16LL;
  ...
  {
    v8 = *(volatile signed __int32 **)(*((_QWORD *)v27 + 1) + 8LL * v30);
