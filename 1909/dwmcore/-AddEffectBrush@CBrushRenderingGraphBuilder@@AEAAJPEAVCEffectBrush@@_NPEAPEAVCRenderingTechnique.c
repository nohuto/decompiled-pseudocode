/*
 * XREFs of ?AddEffectBrush@CBrushRenderingGraphBuilder@@AEAAJPEAVCEffectBrush@@_NPEAPEAVCRenderingTechniqueFragment@@@Z @ 0x180046334
 * Callers:
 ...
 *     ?GetCompiledEffectNoRef@CCompiledEffectTemplate@@QEBAPEBUICompiledEffect@Composition@UI@Windows@@XZ @ 0x1800467EC (-GetCompiledEffectNoRef@CCompiledEffectTemplate@@QEBAPEBUICompiledEffect@Composition@UI@Windows@.c)
    ...
    if ( v18 != v56 )
    {
      ...
      if ( (v20 & 8) != 0 )
      {
        ...
        *(_DWORD *)(v67[0] + v19) = -1;
        ...
        if ( v80 )
          CRenderingTechniqueFragment::`scalar deleting destructor'(v80, v17);
      }
      else
      {
        ...
        *(_DWORD *)(v67[0] + v19) = v64;
        ...
        if ( v78 )
          CRenderingTechniqueFragment::`scalar deleting destructor'(v78, v17);
        v6 = v58;
      }
    }
    ++v18;
...
LABEL_17:
        if ( v33 )
          CRenderingTechniqueFragment::`scalar deleting destructor'(v33, v17);
        goto LABEL_19;
      }
      *(_QWORD *)v17 = v69;
      *(_QWORD *)(v17 + 8) = 0LL;
...
LABEL_19:
  ...
  if ( v36 >= 0 )
  {
    ...
    if ( *((_QWORD *)v24 + 6) == v17 )
    {
      std::vector<CRenderingTechniqueFragment::FragmentInput>::_Emplace_reallocate<CRenderingTechniqueFragment::FragmentInput>(
        ...
        &v73);
      if ( v74 )
        CRenderingTechniqueFragment::`scalar deleting destructor'(v74, v17);
    }
    else
    {
      *(_QWORD *)v17 = v73;
  ...
  if ( v57 )
    CRenderingTechniqueFragment::`scalar deleting destructor'(v57, v17);
LABEL_29:
  v39 = v67[0];
  if ( v67[0] )
  {
    ...
    if ( v67[0] != v67[1] )
    {
      do
      {
        ...
        if ( v44 )
          CRenderingTechniqueFragment::`scalar deleting destructor'(v44, v17);
        v39 += 16LL;
      }
      while ( v39 != v40 );
      v39 = v67[0];
  ...
  if ( v6 )
    CRenderingTechniqueFragment::`scalar deleting destructor'(v6, v17);
