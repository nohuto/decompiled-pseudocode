/*
 * XREFs of ??$InteractionConfigurationUpdate@UDwmMousewheelInteractionConfigurationPrimitive@@@GestureTargeting@InputTraceLogging@@SAXPEBUInteractionUpdate@CManipulationManager@@@Z @ 0x1800ACC70
 * Callers:
  ...
  else
  {
    ...
    if ( *(_DWORD *)v65 > 4u )
    {
      ...
      if ( (_BYTE)v6 )
      {
        ...
        v115 = v2;
        v116 = 4LL;
        LOBYTE(v6) = TlgWrite(v65, &unk_1802DDA1C, 0LL, 0LL, 0x10u, &pData);
      }
    }
  }
  return (char)v6;
