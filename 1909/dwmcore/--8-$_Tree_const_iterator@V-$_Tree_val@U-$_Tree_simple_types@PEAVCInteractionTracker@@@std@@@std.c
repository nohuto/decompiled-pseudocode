/*
 * XREFs of ??8?$_Tree_const_iterator@V?$_Tree_val@U?$_Tree_simple_types@PEAVCInteractionTracker@@@std@@@std@@@std@@QEBA_NAEBV01@@Z @ 0x1801DD764
 * Callers:
...
bool __fastcall std::_Tree_const_iterator<std::_Tree_val<std::_Tree_simple_types<CInteractionTracker *>>>::operator==(
        _QWORD *a1,
        _QWORD *a2)
{
  return *a1 == *a2;
