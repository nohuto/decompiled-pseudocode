/*
 * XREFs of ?DesktopRenderTargetRecreateDisplaySet@CChannel@@UEAAJI@Z @ 0x180156610
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall CChannel::DesktopRenderTargetRecreateDisplaySet(CChannel *this, unsigned int a2)
{
  unsigned int v4; // ebx
