/*
 * XREFs of ?ConvertGlobalMotionToLocalMotion@CInteractionProcessor@@AEAA?AUD2DVector3@@AEBUInteractionMotion@@AEBUD2DMatrix@@PEAU4@2@Z @ 0x18022F5B0
 * Callers:
        ...
        struct D2DMatrix *a6)
{
  ...
  *(_DWORD *)(a2 + 8) = v19;
  ...
  if ( dword_180337240 > 4u && TlgKeywordOn((TraceLoggingHProvider)&dword_180337240, 2uLL) )
  {
    ...
    v105 = v34;
    v107 = v34;
    TlgWrite((TraceLoggingHProvider)&dword_180337240, &unk_1802DCA93, 0LL, 0LL, 0x20u, &pData);
  }
  return a2;
}
