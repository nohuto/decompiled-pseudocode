/*
 * XREFs of ??$_Insert_range@PEAD@?$vector@DV?$allocator@D@std@@@std@@AEAAXV?$_Vector_const_iterator@V?$_Vector_val@U?$_Simple_types@D@std@@@std@@@1@PEAD1Uforward_iterator_tag@1@@Z @ 0x1800CBE24
 * Callers:
 *     _anonymous_namespace_::SendFramesReport @ 0x180040348 (_anonymous_namespace_--SendFramesReport.c)
 * Callees:
 *     ??$_Allocate@$0BA@U_Default_allocate_traits@std@@$0A@@std@@YAPEAX_K@Z @ 0x18003DFF8 (--$_Allocate@$0BA@U_Default_allocate_traits@std@@$0A@@std@@YAPEAX_K@Z.c)
 *     ?_Change_array@?$vector@DV?$allocator@D@std@@@std@@AEAAXQEAD_K1@Z @ 0x180042658 (-_Change_array@-$vector@DV-$allocator@D@std@@@std@@AEAAXQEAD_K1@Z.c)
 *     ?_Calculate_growth@?$vector@DV?$allocator@D@std@@@std@@AEBA_K_K@Z @ 0x1800426BC (-_Calculate_growth@-$vector@DV-$allocator@D@std@@@std@@AEBA_K_K@Z.c)
...
void __fastcall std::vector<char>::_Insert_range<char *>(__int64 a1, _BYTE *a2, const void *a3, __int64 a4)
{
  ...
  if ( a4 - (_QWORD)a3 == 1 && a2 == *(_BYTE **)(a1 + 8) || (v6 = 0, v5) )
  {
    ...
    if ( v5 > *(_QWORD *)(a1 + 16) - v10 )
    {
      ...
      v14 = v13 + v5;
      v21 = std::vector<char>::_Calculate_growth((_QWORD *)a1, v13 + v5);
      ...
      std::vector<char>::_Change_array((__int64 *)a1, (__int64)v17, v14, v21);
    }
    else
    {
      v11 = v10 - (_QWORD)a2;
