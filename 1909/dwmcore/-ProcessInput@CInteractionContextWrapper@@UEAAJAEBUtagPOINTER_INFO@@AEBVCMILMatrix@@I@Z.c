/*
 * XREFs of ?ProcessInput@CInteractionContextWrapper@@UEAAJAEBUtagPOINTER_INFO@@AEBVCMILMatrix@@I@Z @ 0x180233390
 * Callers:
 *     <none>
 * Callees:
        ...
        int a4)
{
  ...
  *((_QWORD *)this + 31) = *((_QWORD *)a2 + 2);
  ...
  if ( dword_180337240 > 4u && TlgKeywordOn((TraceLoggingHProvider)&dword_180337240, 2uLL) )
  {
    ...
    v122 = v24;
    v124 = v24;
    TlgWrite(v23, &unk_1802DD229, 0LL, 0LL, 0x1Du, &pData);
