/*
 * XREFs of ?GetProperty@CVisual@@UEAAJIPEAVCExpressionValue@@@Z @ 0x1800A29A0
 * Callers:
  ...
  if ( v4 )
  {
    ...
    if ( v8 )
    {
      ...
      if ( v10 )
      {
        ...
        {
          v3 = -2147024809;
          MilInstrumentationCheckHR_MaybeFailFast((__int64)this, 0LL, 0, 0x80070057, 0x19F5u, 0LL);
          return v3;
        }
