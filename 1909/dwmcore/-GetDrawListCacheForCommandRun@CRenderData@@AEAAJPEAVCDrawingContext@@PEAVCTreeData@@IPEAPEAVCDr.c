/*
 * XREFs of ?GetDrawListCacheForCommandRun@CRenderData@@AEAAJPEAVCDrawingContext@@PEAVCTreeData@@IPEAPEAVCDrawListCache@@@Z @ 0x18003523C
 * Callers:
 ...
 * Callees:
 *     ?IsDrawListCachingDisabled@CDrawingContext@@QEBA_NXZ @ 0x18003531C (-IsDrawListCachingDisabled@CDrawingContext@@QEBA_NXZ.c)
