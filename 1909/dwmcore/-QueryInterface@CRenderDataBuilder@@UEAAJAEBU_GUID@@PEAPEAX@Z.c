/*
 * XREFs of ?QueryInterface@CRenderDataBuilder@@UEAAJAEBU_GUID@@PEAPEAX@Z @ 0x18016A350
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall CRenderDataBuilder::QueryInterface(CRenderDataBuilder *this, const struct _GUID *a2, void **a3)
{
  ...
  if ( a3 )
  {
    ...
    if ( v5 )
    {
      v3 = -2147467262;
      *a3 = 0LL;
      MilInstrumentationCheckHR_MaybeFailFast((__int64)this, 0LL, 0, 0x80004002, 0x42u, 0LL);
    }
    else
    {
LABEL_11:
  ...
  {
    v3 = -2147024809;
    MilInstrumentationCheckHR_MaybeFailFast((__int64)this, 0LL, 0, 0x80070057, 0x34u, 0LL);
  }
  return v3;
}
