/*
 * XREFs of ?SetProperty@?$CScaleTransformGeneratedT@VCScaleTransform@@VCTransform@@@@MEAAJIW4DCOMPOSITION_EXPRESSION_TYPE@@PEBX@Z @ 0x1801A1070
 * Callers:
 *     <none>
 * Callees:
...
LABEL_15:
  ...
  v4 = -2147024809;
  MilInstrumentationCheckHR_MaybeFailFast(a1, 0LL, 0, 0x80070057, 0xC97u, 0LL);
  return v4;
}
