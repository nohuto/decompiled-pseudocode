/*
 * XREFs of ??$_Insert_range@PEAULayoutData@CContent@@@?$vector@ULayoutData@CContent@@V?$allocator@ULayoutData@CContent@@@std@@@std@@AEAAXV?$_Vector_const_iterator@V?$_Vector_val@U?$_Simple_types@ULayoutData@CContent@@@std@@@std@@@1@PEAULayoutData@CContent@@1Uforward_iterator_tag@1@@Z @ 0x1801C98A4
 * Callers:
 ...
 *     ?_Change_array@?$vector@ULayoutData@CContent@@V?$allocator@ULayoutData@CContent@@@std@@@std@@AEAAXQEAULayoutData@CContent@@_K1@Z @ 0x1801C53B4 (-_Change_array@-$vector@ULayoutData@CContent@@V-$allocator@ULayoutData@CContent@@@std@@@std@@AEA.c)
 */
  ...
  if ( v9 == 1 && a2 == *(char **)(a1 + 8) || (v23 = 0, v9) )
  {
    ...
    else
    {
      ...
      if ( v9 > 0x666666666666666LL - v13 )
        std::_Xlength_error((const char *)((unsigned __int64)((unsigned __int128)((*(_QWORD *)(a1 + 16) - v12)
                                                                                * (__int128)0x6666666666666667LL) >> 64) >> 63));
      v24 = v13 + v9;
      v14 = std::vector<CContent::LayoutData>::_Calculate_growth((_QWORD *)a1, v13 + v9);
      v15 = 40 * v14;
      if ( v14 > v16 )
        v15 = -1LL;
      ...
      return (void *)std::vector<CContent::LayoutData>::_Change_array(a1, (__int64)v17, v24, v14);
    }
  }
  return result;
}
