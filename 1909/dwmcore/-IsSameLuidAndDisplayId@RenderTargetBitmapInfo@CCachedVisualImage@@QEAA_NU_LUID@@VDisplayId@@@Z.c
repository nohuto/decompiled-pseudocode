/*
 * XREFs of ?IsSameLuidAndDisplayId@RenderTargetBitmapInfo@CCachedVisualImage@@QEAA_NU_LUID@@VDisplayId@@@Z @ 0x180052538
 * Callers:
        ...
        unsigned int a3)
{
    ...
    && HIDWORD(v12) == v10.HighPart )
  {
    ...
    else if ( v11 == (_DWORD)DisplayId::None )
    {
      ...
      {
        DisplayColorSpace = (unsigned int)CDisplaySet::GetDisplayColorSpace((__int64)v13, a3);
        v6 = IsDXGIColorSpaceHDR(DisplayColorSpace) ^ 1;
      }
      Microsoft::WRL::ComPtr<CDisplaySet const>::InternalRelease(&v13);
    }
  }
