/*
 * XREFs of ?GetD2DBitmap@CDxHandleAdvancedDirectFlipBitmapRealization@@UEAAJAEBURenderTargetInfo@@PEBV?$TMilRect@IUMilRectU@@UNotNeeded@RectUniqueness@@@@_NPEAPEAUID2D1Bitmap1@@@Z @ 0x180260E90
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall CDxHandleAdvancedDirectFlipBitmapRealization::GetD2DBitmap(
        ...
        _QWORD *a5)
{
  CDxHandleAdvancedDirectFlipBitmapRealization *v6; // rcx
  ...
  v6 = (CDxHandleAdvancedDirectFlipBitmapRealization *)(a1 - 144);
  *a5 = 0LL;
  if ( *(_OWORD *)(a1 + 296) == 0LL )
  {
    ...
    v12 = D2DBitmap;
    if ( D2DBitmap < 0 )
      MilInstrumentationCheckHR_MaybeFailFast(v11, 0LL, 0, D2DBitmap, 0x61u, 0LL);
  }
  else
  {
    ...
    else
    {
      ...
      v12 = v16;
      if ( v16 < 0 )
        MilInstrumentationCheckHR_MaybeFailFast(v17, 0LL, 0, v16, 0x5Du, 0LL);
    }
  }
  return v12;
}
