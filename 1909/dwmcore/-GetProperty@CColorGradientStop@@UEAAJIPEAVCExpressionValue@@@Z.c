/*
 * XREFs of ?GetProperty@CColorGradientStop@@UEAAJIPEAVCExpressionValue@@@Z @ 0x1801CDC40
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall CColorGradientStop::GetProperty(CColorGradientStop *this, int a2, struct CExpressionValue *a3)
{
  ...
  {
    v4 = -2147024809;
    MilInstrumentationCheckHR_MaybeFailFast(v6, 0LL, v7, 0x80070057, 0x2Fu, (void *)(v7 & v10));
  }
  return v4;
}
