/*
 * XREFs of ?Create@CComputeScribbleRenderer@@SAJPEAVCHwFullScreenRenderTarget@@PEAPEAV1@@Z @ 0x1801ABE34
 * Callers:
        ...
        struct CComputeScribbleRenderer **a2)
{
  ...
  if ( v5 )
  {
    CComputeScribbleRenderer::~CComputeScribbleRenderer((CComputeScribbleRenderer::CScheduler **)v5);
    operator delete(v5);
  }
  return v7;
}
