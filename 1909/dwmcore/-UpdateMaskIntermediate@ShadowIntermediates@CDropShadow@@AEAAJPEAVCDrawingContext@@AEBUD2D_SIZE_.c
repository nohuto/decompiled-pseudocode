/*
 * XREFs of ?UpdateMaskIntermediate@ShadowIntermediates@CDropShadow@@AEAAJPEAVCDrawingContext@@AEBUD2D_SIZE_F@@@Z @ 0x1801C90F4
 * Callers:
        ...
        const struct D2D_SIZE_F *a3)
{
  ...
  if ( v13 && CRenderTargetImageSource::IsValid(v13) )
  {
    ...
    if ( v14 < 0 )
    {
      MilInstrumentationCheckHR_MaybeFailFast(v15, 0LL, 0, v14, 0x31Cu, 0LL);
      return v16;
    }
  ...
  *v8 = 0LL;
  ...
  if ( v19 >= 0 )
    ...
    MilInstrumentationCheckHR_MaybeFailFast(v20, 0LL, 0, v19, 0x329u, 0LL);
  return v16;
}
