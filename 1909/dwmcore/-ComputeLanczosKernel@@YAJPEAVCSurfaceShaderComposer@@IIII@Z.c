/*
 * XREFs of ?ComputeLanczosKernel@@YAJPEAVCSurfaceShaderComposer@@IIII@Z @ 0x18017DFB4
 * Callers:
        ...
        unsigned int a5)
{
  ...
  const void *v21[2]; // [rsp+30h] [rbp-D0h] BYREF
  ...
  while ( v14 );
  v21[0] = (const void *)1568;
  v21[1] = v22;
  v17 = CSurfaceShaderComposer::SetScratchConstantBuffer((__int64)a1, v21, D3D11_USAGE_DEFAULT);
  v19 = v17;
  if ( v17 < 0 )
