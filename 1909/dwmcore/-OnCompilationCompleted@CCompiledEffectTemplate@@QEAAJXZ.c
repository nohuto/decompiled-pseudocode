/*
 * XREFs of ?OnCompilationCompleted@CCompiledEffectTemplate@@QEAAJXZ @ 0x1800AA260
 * Callers:
...
__int64 __fastcall CCompiledEffectTemplate::OnCompilationCompleted(CCompiledEffectTemplate *this)
{
  ...
  if ( *(_DWORD *)(*((_QWORD *)this + 9) + 64LL) == 2 )
  {
    if ( CNotificationResource::ShouldNotify(this) )
    {
      ...
      v22 = v12;
      LOWORD(v18) = 1;
      v16 = CoreUICallSend(v3, &v21, v13, 5LL, v18, &unk_1802B114D, v15, v14);
      v2 = v16;
      if ( v16 < 0 )
  ...
  else if ( *(_DWORD *)(*((_QWORD *)this + 9) + 64LL) == 3 )
  {
    if ( CNotificationResource::ShouldNotify(this)
      && (v5 = CNotificationResource::GetChannelCallbackId(v4),
          ...
          v21 = v5,
          LOWORD(v18) = 0,
          v7 = CoreUICallSend(v3, &v21, v6, 5LL, v18, &unk_1802B113E, v19, v20),
          v2 = v7,
          v7 < 0) )
    {
