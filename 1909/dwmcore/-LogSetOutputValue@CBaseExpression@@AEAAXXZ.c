/*
 * XREFs of ?LogSetOutputValue@CBaseExpression@@AEAAXXZ @ 0x1801E5C44
 * Callers:
...
void __fastcall CBaseExpression::LogSetOutputValue(CBaseExpression *this)
{
        ...
        if ( v21 )
        {
          ...
          if ( v22 )
          {
            ...
            if ( dword_180337240 > 4u && TlgKeywordOn((TraceLoggingHProvider)&dword_180337240, 1uLL) )
            {
              ...
              v76 = v24;
              v78 = v24;
              TlgWrite((TraceLoggingHProvider)&dword_180337240, &unk_1802DAE93, 0LL, 0LL, 0x16u, &pData);
            }
          }
          else if ( dword_180337240 > 4u && TlgKeywordOn((TraceLoggingHProvider)&dword_180337240, 1uLL) )
          {
            ...
            v56 = v26;
            v58 = v26;
            TlgWrite((TraceLoggingHProvider)&dword_180337240, &unk_1802DAE23, 0LL, 0LL, 0xCu, &pData);
          }
        }
        else if ( dword_180337240 > 4u && TlgKeywordOn((TraceLoggingHProvider)&dword_180337240, 1uLL) )
        {
          ...
          v52 = v28;
          v54 = v28;
          TlgWrite((TraceLoggingHProvider)&dword_180337240, &unk_1802DADC5, 0LL, 0LL, 0xAu, &pData);
        }
      }
      else if ( dword_180337240 > 4u && TlgKeywordOn((TraceLoggingHProvider)&dword_180337240, 1uLL) )
      {
        ...
        v52 = v30;
        v54 = v30;
        TlgWrite((TraceLoggingHProvider)&dword_180337240, &unk_1802DB039, 0LL, 0LL, 0xAu, &pData);
      }
    }
    else if ( dword_180337240 > 4u && TlgKeywordOn((TraceLoggingHProvider)&dword_180337240, 1uLL) )
    {
  ...
  else if ( v4 == 52 )
  {
    if ( dword_180337240 > 4u && TlgKeywordOn((TraceLoggingHProvider)&dword_180337240, 1uLL) )
    {
      ...
      v50 = v18;
      v52 = v18;
      TlgWrite((TraceLoggingHProvider)&dword_180337240, &unk_1802DAFDE, 0LL, 0LL, 9u, &pData);
    }
  }
  else
  {
            ...
            if ( v8 == 7 )
            {
              if ( dword_180337240 > 4u )
              {
                if ( TlgKeywordOn((TraceLoggingHProvider)&dword_180337240, 1uLL) )
                {
                  ...
                  v47 = (char *)this + 64;
                  v48 = v9;
                  TlgWrite((TraceLoggingHProvider)&dword_180337240, &unk_1802DAF35, 0LL, 0LL, 7u, &pData);
                }
              }
              return;
            }
LABEL_38:
          ...
          if ( dword_180337240 > 4u && TlgKeywordOn((TraceLoggingHProvider)&dword_180337240, 1uLL) )
          {
            ...
            v48 = v10;
            v50 = v10;
            TlgWrite((TraceLoggingHProvider)&dword_180337240, &unk_1802DAF86, 0LL, 0LL, v10 + 4, &pData);
          }
        }
        else if ( dword_180337240 > 4u && TlgKeywordOn((TraceLoggingHProvider)&dword_180337240, 1uLL) )
        {
      ...
      else if ( dword_180337240 > 4u && TlgKeywordOn((TraceLoggingHProvider)&dword_180337240, 1uLL) )
      {
        ...
        v46 = 8LL;
        v48 = v15;
        TlgWrite((TraceLoggingHProvider)&dword_180337240, &unk_1802DB097, 0LL, 0LL, 7u, &pData);
      }
    }
    else if ( dword_180337240 > 4u && TlgKeywordOn((TraceLoggingHProvider)&dword_180337240, 1uLL) )
    {
      ...
      v46 = 8LL;
      v48 = 10LL;
      TlgWrite((TraceLoggingHProvider)&dword_180337240, &unk_1802DAD74, 0LL, 0LL, 7u, &pData);
    }
  }
}
