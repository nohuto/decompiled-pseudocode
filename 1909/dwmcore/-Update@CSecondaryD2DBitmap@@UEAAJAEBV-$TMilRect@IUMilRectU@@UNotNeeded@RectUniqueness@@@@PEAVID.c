/*
 * XREFs of ?Update@CSecondaryD2DBitmap@@UEAAJAEBV?$TMilRect@IUMilRectU@@UNotNeeded@RectUniqueness@@@@PEAVID2DBitmapCacheSource@@@Z @ 0x180053420
 * Callers:
 *     <none>
 * Callees:
 ...
 *     ?HasPrefilterScale@CSecondaryD2DBitmap@@IEBA_NXZ @ 0x1800537B0 (-HasPrefilterScale@CSecondaryD2DBitmap@@IEBA_NXZ.c)
