/*
 * XREFs of ??$AddLinkInternal@VIBitmapRealization@@@CVisualTreeDumpContext@@AEAAXAEBV?$basic_string@DU?$char_traits@D@std@@V?$allocator@D@2@@std@@PEAVIBitmapRealization@@_N@Z @ 0x180172510
 * Callers:
