/*
 * XREFs of ?SetVolume@CSidebandDevice@@AEAAJPEAU_IRP@@@Z @ 0x1C000CF78
 * Callers:
...
__int64 __fastcall CSidebandDevice::SetVolume(CSidebandDevice *this, PIRP Irp, __int64 a3)
{
  ...
  int v31; // [rsp+30h] [rbp-28h]
  unsigned int v32; // [rsp+30h] [rbp-28h]
  unsigned int v33; // [rsp+38h] [rbp-20h]
  int v34; // [rsp+40h] [rbp-18h] BYREF
  struct _KSPIN_DESCRIPTOR_EX *v35; // [rsp+48h] [rbp-10h] BYREF
  unsigned int v36; // [rsp+A0h] [rbp+48h] BYREF
  unsigned int v37; // [rsp+A8h] [rbp+50h] BYREF
  ...
  if ( WPP_RECORDER_INITIALIZED != (_UNKNOWN *)&WPP_RECORDER_INITIALIZED )
  {
    v32 = p_NamedPipeType[3];
    v28 = p_NamedPipeType[2];
    WPP_RECORDER_SF_dd(
      (__int64)WPP_GLOBAL_Control->DeviceExtension,
      v12,
      v13,
  ...
  PinFromEpIndex = CSidebandDevice::GetPinFromEpIndex(this, *p_NamedPipeType, &v36, &v35);
  ...
  if ( BridgePinForDataPin >= 0 )
  {
    ...
    v23 = PropertySetDbLevelSideband(
            *((_QWORD *)this + 4),
            *(_DWORD *)(v6 + 200) + v22 * *(_DWORD *)(v6 + 196),
            (unsigned int)&v39,
            p_NamedPipeType[2],
  ...
  else if ( WPP_RECORDER_INITIALIZED != (_UNKNOWN *)&WPP_RECORDER_INITIALIZED )
  {
    v19 = 34;
LABEL_23:
    LODWORD(v25) = BridgePinForDataPin;
    WPP_RECORDER_SF_d(
      (__int64)WPP_GLOBAL_Control->DeviceExtension,
      v18,
      9u,
