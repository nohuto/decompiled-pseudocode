/*
 * XREFs of USBParseSelectorUnit @ 0x1C002CFA0
 * Callers:
 *     <none>
 * Callees:
 ...
 *     USBParseGetChannelConfigForUnit @ 0x1C002C950 (USBParseGetChannelConfigForUnit.c)
 *     USBParseGetUnitString @ 0x1C002C9F4 (USBParseGetUnitString.c)
 *     USBParseBuildSourceIdArray @ 0x1C002CB54 (USBParseBuildSourceIdArray.c)
 */
...
__int64 __fastcall USBParseSelectorUnit(__int64 a1, unsigned __int8 *a2)
{
  ...
  if ( v9 == v5 )
  {
    UnitString = USBParseGetUnitString(a1, a2, &v15);
    if ( UnitString < 0 )
      return (unsigned int)UnitString;
    SourceString = (const WCHAR *)v15;
  }
  else if ( v9 + 1 != v5 )
  {
    return (unsigned int)-1073741438;
  ...
  if ( v10 )
  {
    ...
    UnitString = BusApiBuildFunctionUnit(a1, a2[3], 3, v13, ChannelConfigForUnit, v11, v10, SourceString, 0, &v15);
    ExFreePool(v10);
  }
  else
  {
