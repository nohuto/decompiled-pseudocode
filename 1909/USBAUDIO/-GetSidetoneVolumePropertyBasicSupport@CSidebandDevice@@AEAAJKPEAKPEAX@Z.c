/*
 * XREFs of ?GetSidetoneVolumePropertyBasicSupport@CSidebandDevice@@AEAAJKPEAKPEAX@Z @ 0x1C000B3A0
 * Callers:
 ...
 *     PropertyGetDbBasicSupportSideband @ 0x1C0026C98 (PropertyGetDbBasicSupportSideband.c)
 */
