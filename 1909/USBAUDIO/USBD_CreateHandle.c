/*
 * XREFs of USBD_CreateHandle @ 0x1C0010034
 * Callers:
 ...
 * Callees:
 *     USBDInternal_BuildAndSendQueryInterfaceSynchronously @ 0x1C000F750 (USBDInternal_BuildAndSendQueryInterfaceSynchronously.c)
