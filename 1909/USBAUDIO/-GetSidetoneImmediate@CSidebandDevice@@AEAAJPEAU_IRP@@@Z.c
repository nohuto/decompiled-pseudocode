 ...
 * Callers:
 *     ?GetSidetoneStatusUpdate@CSidebandDevice@@AEAAJPEAU_IRP@@@Z @ 0x1C000DBB4 (-GetSidetoneStatusUpdate@CSidebandDevice@@AEAAJPEAU_IRP@@@Z.c)
 * Callees:
 ...
 *     PropertyGetDbLevelSideband @ 0x1C0026964 (PropertyGetDbLevelSideband.c)
 */
