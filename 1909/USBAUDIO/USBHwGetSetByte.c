/*
 * XREFs of USBHwGetSetByte @ 0x1C0029FD0
 * Callers:
 *     USBCntrlGetSetBoolean @ 0x1C002EB70 (USBCntrlGetSetBoolean.c)
 *     USBType1SetCopyProtect @ 0x1C002F7C0 (USBType1SetCopyProtect.c)
 * Callees:
