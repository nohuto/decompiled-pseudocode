/*
 * XREFs of USBHwGetSetProperty @ 0x1C0029E6C
 * Callers:
 *     USBHwGetSetByte @ 0x1C0029FD0 (USBHwGetSetByte.c)
 *     USBHwGetSetShort @ 0x1C002A080 (USBHwGetSetShort.c)
 *     USBHwGetSetMemory @ 0x1C002A140 (USBHwGetSetMemory.c)
 *     USBCntrlGetSetGEQ @ 0x1C002EBD0 (USBCntrlGetSetGEQ.c)
 *     USBCntrlGetSetProcessingUnitValue @ 0x1C002ED90 (USBCntrlGetSetProcessingUnitValue.c)
 *     USBCntrlMuxSource @ 0x1C002EE40 (USBCntrlMuxSource.c)
 *     USBCntrlGetSetMixerLevels @ 0x1C002EEF0 (USBCntrlGetSetMixerLevels.c)
