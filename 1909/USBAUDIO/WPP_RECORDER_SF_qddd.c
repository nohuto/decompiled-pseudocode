/*
 * XREFs of WPP_RECORDER_SF_qddd @ 0x1C000207C
 * Callers:
 *     PinSetDeviceState @ 0x1C00225C0 (PinSetDeviceState.c)
 * Callees:
...
__int64 WPP_RECORDER_SF_qddd(__int64 a1, __int64 a2, __int64 a3, __int64 a4, int a5, ...)
{
  ...
  if ( (HIDWORD(WPP_GLOBAL_Control->Timer) & 0x80u) != 0 )
    ((void (__fastcall *)(struct _DEVICE_OBJECT *, __int64, void *, __int64, __int64 *, __int64, __int64 *, __int64, __int64 *, __int64, char *, __int64, _QWORD))pfnWppTraceMessage)(
      ...
      43LL,
      &WPP_cc9c4cff163931cb0937dd2acbce6db6_Traceguids,
      20LL,
      (__int64 *)va,
      8LL,
      (__int64 *)va1,
      ...
      0LL);
  LOWORD(v7) = 20;
  return WppAutoLogTrace(a1, 0LL, 8LL, &WPP_cc9c4cff163931cb0937dd2acbce6db6_Traceguids, v7, (__int64 *)va);
}
