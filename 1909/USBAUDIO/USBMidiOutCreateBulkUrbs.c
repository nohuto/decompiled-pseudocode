/*
 * XREFs of USBMidiOutCreateBulkUrbs @ 0x1C0007254
 * Callers:
 *     USBMidiOutProcessPin @ 0x1C0031460 (USBMidiOutProcessPin.c)
 * Callees:
 *     USBMidiOutAllocateRequest @ 0x1C0030EAC (USBMidiOutAllocateRequest.c)
 *     USBMIDICreateEventPackets @ 0x1C0031234 (USBMIDICreateEventPackets.c)
 */
