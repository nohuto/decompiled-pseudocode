/*
 * XREFs of WPP_RECORDER_SF_qqddd @ 0x1C0001738
 * Callers:
...
__int64 WPP_RECORDER_SF_qqddd(__int64 a1, __int64 a2, __int64 a3, __int64 a4, int a5, ...)
{
  ...
  if ( (HIDWORD(WPP_GLOBAL_Control->Timer) & 1) != 0 )
    ((void (__fastcall *)(struct _DEVICE_OBJECT *, __int64, const union _LARGE_INTEGER *, __int64, __int64 *, __int64, __int64 *, __int64, __int64 *, __int64, __int64 *, __int64, char *, __int64, _QWORD))pfnWppTraceMessage)(
      WPP_GLOBAL_Control->AttachedDevice,
      43LL,
      &WPP_849477e99634315227f7ff611fe724be_Traceguids,
      15LL,
      (__int64 *)va,
      8LL,
      (__int64 *)va1,
      ...
      0LL);
  LOWORD(v7) = 15;
  return WppAutoLogTrace(a1, 0LL, 1LL, &WPP_849477e99634315227f7ff611fe724be_Traceguids, v7, (__int64 *)va);
}
