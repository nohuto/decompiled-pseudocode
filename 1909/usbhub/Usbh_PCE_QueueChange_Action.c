/*
 * XREFs of Usbh_PCE_QueueChange_Action @ 0x1C00137C0
 * Callers:
...
LABEL_31:
  if ( (_DWORD)v17 == 2 )
  {
    v28 = v83;
    v29 = v82;
    v30 = UsbhInsertQueuePortChangeObject(a1, v18, (unsigned int *)va, v82, v83);
  ...
  else
  {
    switch ( (int)v17 )
    {
      ...
      case 14:
        ...
        UsbhInsertQueuePortChangeObject(a1, v18, (unsigned int *)va, v82, v83);
...
LABEL_81:
      ...
      case 17:
      case 20:
        Log(a1, 512, 1597272117, (int)v82, *(unsigned __int16 *)(a2 + 4));
        if ( v66 == 1 )
        {
        ...
        v67 = &WPP_5739628a84103faf3c5119bfd97a7d41_Traceguids;
LABEL_74:
        if ( WPP_RECORDER_INITIALIZED != (_UNKNOWN *)&WPP_RECORDER_INITIALIZED && LOWORD(WPP_GLOBAL_Control->DeviceType) )
      ...
      case 7:
        ...
        *(_DWORD *)(v51 + a2 + 1384) = 7;
        UsbhInsertQueuePortChangeObject(a1, v18, (unsigned int *)va, v50, v83);
