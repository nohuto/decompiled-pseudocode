/*
 * XREFs of UsbhFdoSystemPowerState @ 0x1C0006010
 * Callers:
...
__int64 __fastcall UsbhFdoSystemPowerState(PDEVICE_OBJECT DeviceObject, PIRP Irp)
{
  ...
  _QWORD v38[2]; // [rsp+50h] [rbp-68h] BYREF
  ...
  *(_DWORD *)(v11 + v9 + 40) = 812874099;
  ...
  if ( *(_DWORD *)(FdoExt(*(_QWORD *)(v8 + 8)) + 1360) != 5 )
  {
    ...
    if ( LowPart != 1 )
      v22 = 205;
    UsbhSetFdoPowerState((__int64)DeviceObject, 0, v22, (LowPart != 1) + 127);
  ...
  *(_QWORD *)(v13 + 1344) = v8;
  ...
  if ( *(_DWORD *)(FdoExt(*(_QWORD *)(v8 + 8)) + 4172) == 213 )
  {
    v38[0] = 0LL;
    v38[1] = 0LL;
    UsbhSetFdoPowerState((__int64)DeviceObject, LowPart, 213, (LowPart == 1) + 103);
    UsbhReleaseFdoPwrLock((__int64)DeviceObject, v8);
  ...
  if ( v17 )
  {
    if ( LowPart == 1 )
    {
      ...
      *(_DWORD *)(FdoExt(DeviceObject) + 4212) = 1;
      UsbhSetFdoPowerState((__int64)DeviceObject, 0, v19, 129);
      UsbhReleaseFdoPwrLock((__int64)DeviceObject, v8);
    }
