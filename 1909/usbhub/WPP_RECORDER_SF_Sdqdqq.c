/*
 * XREFs of WPP_RECORDER_SF_Sdqdqq @ 0x1C0053EA0
 * Callers:
...
__int64 WPP_RECORDER_SF_Sdqdqq(__int64 a1, _DWORD a2, _DWORD a3, _DWORD a4, __int64 a5, const wchar_t *a6, ...)
{
  ...
  if ( (HIDWORD(WPP_GLOBAL_Control->Timer) & 1) != 0 )
  {
    ...
    pfnWppTraceMessage(
      ...
      43LL,
      &WPP_7b579768642e3c85c7e1c1dccc25cdce_Traceguids,
      74LL,
      v11,
      v10,
      (__int64 *)va,
  ...
  if ( v12 )
    v6 = L"NULL";
  LOWORD(v14) = 74;
  return WppAutoLogTrace(a1, 0LL, 1LL, &WPP_7b579768642e3c85c7e1c1dccc25cdce_Traceguids, v14, v6);
}
