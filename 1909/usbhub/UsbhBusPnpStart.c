/*
 * XREFs of UsbhBusPnpStart @ 0x1C00283B0
 * Callers:
 *     <none>
 * Callees:
...
LABEL_46:
  ...
  v32 = (struct _IO_WORKITEM *)*((_QWORD *)v4 + 148);
  if ( v32 )
  {
    IoFreeWorkItem(v32);
    *((_QWORD *)v4 + 148) = 0LL;
  ...
  v35 = (IRP *)*((_QWORD *)v4 + 333);
  if ( v35 )
  {
    IoFreeIrp(v35);
    *((_QWORD *)v4 + 333) = 0LL;
  }
  v36 = (void *)*((_QWORD *)v4 + 334);
  if ( v36 )
  {
    ExFreePoolWithTag(v36, 0);
    *((_QWORD *)v4 + 334) = 0LL;
  }
  v37 = (void *)*((_QWORD *)v4 + 335);
  if ( v37 )
  {
    ExFreePoolWithTag(v37, 0);
    *((_QWORD *)v4 + 335) = 0LL;
  }
  v38 = (void *)*((_QWORD *)v4 + 382);
  if ( v38 )
  {
