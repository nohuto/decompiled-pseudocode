/*
 * XREFs of UsbhQueryBusRelations @ 0x1C0010C30
 * Callers:
...
__int64 __fastcall UsbhQueryBusRelations(struct _DEVICE_OBJECT *a1, IRP *a2)
{
  ...
  _BYTE v51[40]; // [rsp+E8h] [rbp-18h] BYREF
  _BYTE v52[40]; // [rsp+110h] [rbp+10h] BYREF
