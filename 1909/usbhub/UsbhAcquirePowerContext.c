/*
 * XREFs of UsbhAcquirePowerContext @ 0x1C00063C0
 * Callers:
...
char *__fastcall UsbhAcquirePowerContext(__int64 a1, __int64 a2, __int64 a3, __int64 a4, __int64 a5, int a6, char a7)
{
  ...
  if ( result )
  {
    ...
    *(_DWORD *)(a2 + 136) = 1;
    ...
    v15 = (_QWORD *)qword_1C006F620;
    v16 = v13 + 8;
    if ( *(__int64 **)qword_1C006F620 != &qword_1C006F618 )
      __fastfail(3u);
    *((_QWORD *)v13 + 2) = qword_1C006F620;
    *v16 = &qword_1C006F618;
    *v15 = v16;
    qword_1C006F620 = (__int64)(v13 + 8);
    *(_DWORD *)(a2 + 136) = 0;
