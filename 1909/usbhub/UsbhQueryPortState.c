/*
 * XREFs of UsbhQueryPortState @ 0x1C0017BE0
 * Callers:
...
__int64 __fastcall UsbhQueryPortState(__int64 a1, unsigned __int16 a2, __int64 a3, _DWORD *a4)
{
  ...
  __int64 v57; // [rsp+58h] [rbp-50h] BYREF
          ...
          if ( v21 )
          {
            ...
            if ( v22 )
            {
              ...
              if ( v14 )
              {
                ...
                v25 = (char *)ExAllocatePoolWithTag(ExDefaultNonPagedPoolType, 0x30uLL, 0x42554855u);
                if ( v25 )
                {
                  *(_QWORD *)(v25 + 4) = 0LL;
                  *(_QWORD *)(v25 + 12) = 0LL;
