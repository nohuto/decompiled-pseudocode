/*
 * XREFs of ??1CAudioDeviceGraph@@QEAA@XZ @ 0x140037060
 * Callers:
 *     _ATL::CComObject_CAudioDeviceGraph_::CComObject_CAudioDeviceGraph__::_1_::dtor$0 @ 0x14001B31D (_ATL--CComObject_CAudioDeviceGraph_--CComObject_CAudioDeviceGraph__--_1_--dtor$0.c)
 *     ??1?$CComAggObject@VCAudioDeviceGraph@@@ATL@@UEAA@XZ @ 0x14002611C (--1-$CComAggObject@VCAudioDeviceGraph@@@ATL@@UEAA@XZ.c)
 *     ??1?$CComContainedObject@VCAudioDeviceGraph@@@ATL@@QEAA@XZ @ 0x140026170 (--1-$CComContainedObject@VCAudioDeviceGraph@@@ATL@@QEAA@XZ.c)
...
void __fastcall CAudioDeviceGraph::~CAudioDeviceGraph(CAudioDeviceGraph *this)
{
  ...
  if ( InitOnceBeginInitialize(&`AudioDgTelemetryProvider::Instance'::`2'::wrapper, 0, &fPending, Context) && fPending )
  {
    ...
    byte_140085EF8 = 1;
    TraceLoggingRegisterEx(qword_140085F00, v2, v3);
    dword_140085EFC = 1;
  ...
  if ( *(_DWORD *)v4 > 4u && TlgKeywordOn(v4, 1uLL) )
    TlgWrite(v5, &unk_14006FA98, (LPCGUID)this + 22, v6, 2u, &pData);
  if ( WPP_GLOBAL_Control != (_UNKNOWN *)&WPP_GLOBAL_Control
    && (*((_DWORD *)WPP_GLOBAL_Control + 7) & 0x20000) != 0
    && *((_BYTE *)WPP_GLOBAL_Control + 25) >= 4u )
  {
