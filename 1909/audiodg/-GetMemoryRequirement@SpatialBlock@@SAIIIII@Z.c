/*
 * XREFs of ?GetMemoryRequirement@SpatialBlock@@SAIIIII@Z @ 0x14005C09C
 * Callers:
 *     ?Create@SpatialBlock@@QEAAJPEAEIIIII@Z @ 0x14005BBE0 (-Create@SpatialBlock@@QEAAJPEAEIIIII@Z.c)
 *     ?Initialize@SpatialBlock@@QEAAJPEAEI@Z @ 0x14005C708 (-Initialize@SpatialBlock@@QEAAJPEAEI@Z.c)
