/*
 * XREFs of ?LogTelemetry@CCrossProcessEndpointGlitchValues@CCrossProcessEndpointTraceLogger@@UEAAXXZ @ 0x140053F30
 * Callers:
 *     <none>
 * Callees:
        ...
        CCrossProcessEndpointTraceLogger::CCrossProcessEndpointGlitchValues *this)
{
  ...
  if ( *((_QWORD *)this + 1) && *((_QWORD *)this + 2) && *((_QWORD *)this + 3) )
  {
    ...
    if ( **((_BYTE **)this + 1) )
    {
      if ( *(_DWORD *)v4 > 3u )
      {
        if ( TlgKeywordOn(v4, 2uLL) )
        {
          ...
          v31 = 4LL;
          v33 = 4LL;
          TlgWrite(v5, &unk_140070146, 0LL, (LPCGUID)v5, 0xDu, &pData);
        }
      }
    }
    else if ( *(_DWORD *)v4 > 3u && TlgKeywordOn(v4, 0x400000000002uLL) )
    {
      ...
      v31 = 4LL;
      v33 = 4LL;
      TlgWrite(v6, &unk_14006FFC2, 0LL, (LPCGUID)v6, 0xDu, &pData);
    }
  }
}
