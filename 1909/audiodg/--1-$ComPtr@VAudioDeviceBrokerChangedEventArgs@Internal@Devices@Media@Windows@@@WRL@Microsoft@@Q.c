/*
 * XREFs of ??1?$ComPtr@VAudioDeviceBrokerChangedEventArgs@Internal@Devices@Media@Windows@@@WRL@Microsoft@@QEAA@XZ @ 0x140045718
 * Callers:
 *     _Windows::Media::Devices::Internal::AudioDeviceBroker::CMModulesNotificationCallback_::_1_::dtor$3 @ 0x140046C9D (_Windows--Media--Devices--Internal--AudioDeviceBroker--CMModulesNotificationCallbac_ea_140046C9D.c)
 *     _Windows::Media::Devices::Internal::AudioDeviceBroker::ThreadpoolCallback_::_1_::dtor$1 @ 0x14004C05D (_Windows--Media--Devices--Internal--AudioDeviceBroker--ThreadpoolCallback_--_1_--dtor$1.c)
 * Callees:
