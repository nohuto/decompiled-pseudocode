/*
 * XREFs of ?CreateInstance@?$CComCreator@V?$CComObject@VCSpatialCrossProcessServerInputEndpoint@@@ATL@@@ATL@@SAJPEAXAEBU_GUID@@PEAPEAX@Z @ 0x140058660
 * Callers:
  ...
  *a3 = 0LL;
  ...
  if ( v11 )
  {
    Microsoft::WRL::Details::SafeUnknownIncrementReference(
      (CSpatialCrossProcessServerInputEndpoint *)((char *)v11 + 1072),
      v10);
    v12 = ATL::CComCriticalSection::Init((struct _RTL_CRITICAL_SECTION *)v11 + 27);
    if ( v12 >= 0 )
    {
      *((_BYTE *)v11 + 1120) = 1;
      v12 = 0;
