/*
 * XREFs of ?GetFrequency@CSpatialCrossProcessClientEndpoint@@UEAAJPEA_K@Z @ 0x14005DAE0
 * Callers:
 *     <none>
 * Callees:
        ...
        unsigned __int64 *a2)
{
  ...
  if ( !a2 )
  {
    v3 = -2147467261;
LABEL_5:
    SpatialCPTraceLoggingErrorHelper("CSpatialCrossProcessClientEndpoint::GetFrequency", 263, v3);
    goto LABEL_7;
  }
  if ( !_InterlockedCompareExchange((volatile signed __int32 *)this - 208, 1, 1) )
  {
    v3 = -2005139437;
    goto LABEL_5;
  }
  *a2 = *(unsigned int *)(*((_QWORD *)this - 94) + 8LL);
LABEL_7:
  if ( v7 )
