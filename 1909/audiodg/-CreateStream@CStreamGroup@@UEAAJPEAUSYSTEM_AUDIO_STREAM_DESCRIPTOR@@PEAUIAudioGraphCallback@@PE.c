/*
 * XREFs of ?CreateStream@CStreamGroup@@UEAAJPEAUSYSTEM_AUDIO_STREAM_DESCRIPTOR@@PEAUIAudioGraphCallback@@PEAUSYSTEM_AUDIO_STREAM@@@Z @ 0x14003C700
 * Callers:
 *     ?CreateStream@CStreamGroup@@WBI@EAAJPEAUSYSTEM_AUDIO_STREAM_DESCRIPTOR@@PEAUIAudioGraphCallback@@PEAUSYSTEM_AUDIO_STREAM@@@Z @ 0x1400183B0 (-CreateStream@CStreamGroup@@WBI@EAAJPEAUSYSTEM_AUDIO_STREAM_DESCRIPTOR@@PEAUIAudioGraphCallback@.c)
 * Callees:
        ...
        struct SYSTEM_AUDIO_STREAM *a4)
{
  ...
  struct SYSTEM_AUDIO_STREAM *v17; // r13
  __int64 result; // rax
  int Stream; // eax
  ...
  struct SYSTEM_AUDIO_STREAM *v26; // [rsp+58h] [rbp-A0h]
  char *v27; // [rsp+60h] [rbp-98h]
  struct _RTL_CRITICAL_SECTION *v28; // [rsp+68h] [rbp-90h]
  struct SYSTEM_AUDIO_STREAM *v29; // [rsp+70h] [rbp-88h]
