/*
 * XREFs of ?RuntimeClassInitialize@CCPAudioHistoryControl@@QEAAJPEAUICrossProcessMemory@@@Z @ 0x140051D9C
 * Callers:
 *     ??$MakeAndInitialize@VCCPAudioHistoryControl@@UICPAudioHistoryControl@@AEAPEAUICrossProcessMemory@@@Details@WRL@Microsoft@@YAJPEAPEAUICPAudioHistoryControl@@AEAPEAUICrossProcessMemory@@@Z @ 0x140051730 (--$MakeAndInitialize@VCCPAudioHistoryControl@@UICPAudioHistoryControl@@AEAPEAUICrossProcessMemor.c)
 * Callees:
        ...
        struct ICrossProcessMemory *a2)
{
  ...
  if ( v4 >= 0 )
  {
    ...
    if ( v12 )
    {
      v9 = *(unsigned int *)(v12 + 340);
      if ( (_DWORD)v9 )
      {
        *((_DWORD *)this + 9) = *(unsigned __int16 *)(v12 + 380);
        *((_DWORD *)this + 10) = *(_DWORD *)(v8 + 372);
        *((_DWORD *)this + 11) = *(_DWORD *)(v8 + 328);
        *((_QWORD *)this + 2) = v8 + v9;
        result = 0LL;
        *((_QWORD *)this + 3) = v8;
      }
