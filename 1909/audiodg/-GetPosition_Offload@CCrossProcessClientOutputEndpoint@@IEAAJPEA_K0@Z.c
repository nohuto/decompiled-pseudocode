/*
 * XREFs of ?GetPosition_Offload@CCrossProcessClientOutputEndpoint@@IEAAJPEA_K0@Z @ 0x140055518
 * Callers:
        ...
        unsigned __int64 *a3)
{
  ...
  if ( (v31 & 4) != 0 )
  {
    ...
    do
    {
      v8 = (unsigned int)_InterlockedCompareExchange((volatile signed __int32 *)(*((_QWORD *)this + 9) + 160LL), 0, 0);
      v9 = *((_QWORD *)this + 9);
      ...
      v13 = *(_DWORD *)(*((_QWORD *)this + 9) + 40 * v8 + 68);
    ...
    if ( v13 && (_DWORD)v8 == v14 )
    {
      *a2 = v34;
      ...
      v28 = *(_QWORD *)(*((_QWORD *)this + 9) + 24LL) / (unsigned __int64)*((unsigned int *)this + 22);
      v35 = v28;
      if ( v23 > v28 )
      {
        if ( (unsigned int)dword_140085000 > 5 )
        {
          ...
          v47 = 8LL;
          v49 = 8LL;
          TlgWrite((TraceLoggingHProvider)&dword_140085000, &unk_1400702A9, 0LL, (LPCGUID)v3, 7u, &pData);
          v28 = v35;
        }
        *a2 = v28;
      }
      *a2 *= *((unsigned int *)this + 22);
    }
    else
    {
      v7 = -2005139393;
  ...
  if ( (unsigned int)dword_140085000 > 5 )
  {
    ...
    v57 = &v38;
    v58 = 8LL;
    TlgWrite((TraceLoggingHProvider)&dword_140085000, &unk_140070317, 0LL, (LPCGUID)v3, 6u, &v50);
  }
  if ( v7 < 0 )
  {
    ...
    {
      WPP_SF_D(*((_QWORD *)WPP_GLOBAL_Control + 2), 0xCu, (__int64)&WPP_cf63f31659183c1d56c0a39f6c8110d7_Traceguids, v7);
    }
    AudCPTraceLoggingErrorHelper("CCrossProcessClientOutputEndpoint::GetPosition_Offload", 0x19Eu, v7);
  }
