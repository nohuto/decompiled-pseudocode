/*
 * XREFs of ?OnStart@SendCommandAsyncOperation@Devices@Media@Windows@@MEAAJXZ @ 0x14004A220
 * Callers:
 *     <none>
 * Callees:
 ...
 *     ??$Make@VModuleCommandResult@Devices@Media@Windows@@W4SendCommandStatus@234@PEAUIBuffer@Streams@Storage@4@@Details@WRL@Microsoft@@YA?AV?$ComPtr@VModuleCommandResult@Devices@Media@Windows@@@12@$$QEAW4SendCommandStatus@Devices@Media@Windows@@$$QEAPEAUIBuffer@Streams@Storage@7@@Z @ 0x140044924 (--$Make@VModuleCommandResult@Devices@Media@Windows@@W4SendCommandStatus@234@PEAUIBuffer@Streams@.c)
 *     ??4?$ComPtr@UIAudioDeviceBroker@Internal@Devices@Media@Windows@@@WRL@Microsoft@@QEAAAEAV012@PEAUIAudioDeviceBroker@Internal@Devices@Media@Windows@@@Z @ 0x140045CCC (--4-$ComPtr@UIAudioDeviceBroker@Internal@Devices@Media@Windows@@@WRL@Microsoft@@QEAAAEAV012@PEAU.c)
