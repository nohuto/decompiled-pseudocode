/*
 * XREFs of ?ParseCommandLine@CAudioDGModule@@QEAA_NPEBGPEAJ@Z @ 0x14002ACE4
 * Callers:
...
char __fastcall CAudioDGModule::ParseCommandLine(wil::details **this, const unsigned __int16 *a2, int *a3)
{
  ...
  if ( v5 <= a2 )
    return 0;
  v7 = (wil::details *)_o__wcstoui64(v5 + 1, 0LL, 16LL);
  wil::details::unique_storage<wil::details::resource_policy<void *,void (*)(void *),&void wil::details::CloseHandle(void *),wistd::integral_constant<unsigned __int64,0>,void *,void *,0,std::nullptr_t>>::reset(
    this + 19,
    v7);
  v8 = (wil::details *)_o__wcstoui64(v6, 0LL, 16LL);
  wil::details::unique_storage<wil::details::resource_policy<void *,void (*)(void *),&void wil::details::CloseHandle(void *),wistd::integral_constant<unsigned __int64,0>,void *,void *,0,std::nullptr_t>>::reset(
    this + 15,
    v8);
