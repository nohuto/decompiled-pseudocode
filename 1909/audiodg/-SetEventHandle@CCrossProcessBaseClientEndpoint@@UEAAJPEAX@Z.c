/*
 * XREFs of ?SetEventHandle@CCrossProcessBaseClientEndpoint@@UEAAJPEAX@Z @ 0x1400530F0
 * Callers:
 *     <none>
 * Callees:
 ...
 *     ?Initialize@HandleSendReceiveClient@@QEAAJPEAG@Z @ 0x140041BC0 (-Initialize@HandleSendReceiveClient@@QEAAJPEAG@Z.c)
 ...
 *     WPP_SF_SD @ 0x1400537F4 (WPP_SF_SD.c)
