/*
 * XREFs of ?GetMany@?$IVectorView_impl@PEAUIBuffer@Streams@Storage@Windows@@$00@Collections@Foundation@Windows@@UEAAJIIPEAPEAUIBuffer@Streams@Storage@4@PEAI@Z @ 0x140048410
 * Callers:
 *     <none>
 * Callees:
 *     <none>
