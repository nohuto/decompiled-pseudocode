/*
 * XREFs of ?GetPingPongWriteIndex@CSpatialCrossProcessBaseEndpoint@@IEAAJPEAI@Z @ 0x14005C518
 * Callers:
...
LABEL_7:
  ...
  {
    v16 = 1;
    (**(void (__fastcall ***)(__int64, _QWORD, int *))(v7 + 752))(v7 + 752, 0LL, &v16);
    v3 = -2005139387;
  ...
  else
  {
    ...
    if ( (_DWORD)v10 != 2 )
    {
      *(_DWORD *)(*(_QWORD *)(v7 + 896) + 4 * v10 + 56) = *(_DWORD *)(v14 + 52);
      *a2 = v10;
      return v3;
    }
    _InterlockedIncrement((volatile signed __int32 *)(v14 + 80));
    v3 = -2005139359;
  }
  SpatialCPTraceLoggingErrorHelper("CSpatialCrossProcessBaseEndpoint::GetPingPongWriteIndex", 644, v3);
  return v3;
}
