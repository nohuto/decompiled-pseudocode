/*
 * XREFs of ?InitializeAPORemote@CAPOWrapperSrv@@UEAAJPEBGPEAU_GUID@@U2@HHHPEAU__MIDL___MIDL_itf_audioenginepolicy_0000_0010_0002@@@Z @ 0x140008070
 * Callers:
 *     <none>
 * Callees:
...
LABEL_42:
      if ( (unsigned int)hProvider > 2 )
      {
        ...
        v33 = 4LL;
        v35 = 4LL;
        TlgWrite((TraceLoggingHProvider)&hProvider, &unk_14006FCD1, 0LL, v11, 5u, &pData);
        v12 = v18;
      }
      goto LABEL_22;
    }
