/*
 * XREFs of ?Allocate@CAtlStringMgr@ATL@@UEAAPEAUCStringData@2@HH@Z @ 0x1400135D0
 * Callers:
 *     <none>
 * Callees:
 *     ??$AtlMultiply@_K@ATL@@YAJPEA_K_K1@Z @ 0x140013658 (--$AtlMultiply@_K@ATL@@YAJPEA_K_K1@Z.c)
