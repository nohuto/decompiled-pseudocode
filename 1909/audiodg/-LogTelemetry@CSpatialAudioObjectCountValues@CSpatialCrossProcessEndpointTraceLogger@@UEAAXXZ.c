/*
 * XREFs of ?LogTelemetry@CSpatialAudioObjectCountValues@CSpatialCrossProcessEndpointTraceLogger@@UEAAXXZ @ 0x14005A440
 * Callers:
 *     <none>
 * Callees:
        ...
        CSpatialCrossProcessEndpointTraceLogger::CSpatialAudioObjectCountValues *this)
{
  ...
  if ( *(_DWORD *)*v1 > 4u && TlgKeywordOn(*v1, 0x400000000000uLL) )
  {
    ...
    v32 = &v10;
    v33 = 8LL;
    TlgWrite(v3, &unk_140070407, 0LL, v6, 0xDu, &pData);
  }
}
