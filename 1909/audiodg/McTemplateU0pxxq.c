/*
 * XREFs of McTemplateU0pxxq @ 0x140055C40
 * Callers:
...
{
  _BYTE v3[16]; // [rsp+38h] [rbp-19h] BYREF
  ...
  va_copy(v10, va3);
  v11 = 4LL;
  return McGenEventWrite(a1, (__int64)&EVT_GLITCH_CP_CLIENT_OUTPUT_SERVER_OVERREAD, v13, 5, (__int64)v3);
}
