/*
 * XREFs of ?LogGrantCompleted@CSpatialCrossProcessEndpointTraceLogger@@QEAAXI@Z @ 0x14005A0C8
 * Callers:
        ...
        const GUID *a4)
{
  ...
  if ( (unsigned int)dword_140085100 > 5 )
  {
    ...
    v10 = 0;
    v9 = 4;
    TlgWrite((TraceLoggingHProvider)&dword_140085100, &unk_140070920, 0LL, a4, 4u, &v4);
  }
}
