/*
 * XREFs of ?AudioDGUnhandledExceptionFilter@@YAJPEAU_EXCEPTION_POINTERS@@@Z @ 0x14002F680
 * Callers:
 *     <none>
 * Callees:
 ...
 *     ?TrackAPOFailureUnhandled@CSystemAudioDeviceSharedBase@@QEAAXM@Z @ 0x14003293C (-TrackAPOFailureUnhandled@CSystemAudioDeviceSharedBase@@QEAAXM@Z.c)
 */
...
__int64 __fastcall AudioDGUnhandledExceptionFilter(struct _EXCEPTION_POINTERS *ExceptionInfo)
{
  ...
  if ( (_DWORD)qword_140086030 )
  {
    ...
    if ( *(_DWORD *)v6 > 2u )
    {
      ...
      v13 = &v10;
      v14 = 4LL;
      TlgWrite(v6, &unk_14006F978, 0LL, v3, 3u, &pData);
    }
    if ( v1 )
    {
      do
