/*
 * XREFs of ?LogClientIndexMap@CSpatialCrossProcessEndpointTraceLogger@@QEAAXIII_NJ@Z @ 0x140059C70
 * Callers:
        ...
        char a6)
{
  ...
  if ( (unsigned int)dword_140085100 > 5 )
  {
    ...
    v19 = 4LL;
    v21 = 4LL;
    TlgWrite((TraceLoggingHProvider)&dword_140085100, &unk_1400709B4, 0LL, a4, 9u, &pData);
  }
}
