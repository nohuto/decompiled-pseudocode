/*
 * XREFs of ?Stop@CAudioDeviceGraph@@UEAAJXZ @ 0x140038C20
 * Callers:
 *     <none>
 * Callees:
 ...
 *     ?Stop@DurationTracker@CAudioDeviceGraph@@QEAA?AUDurationInformation@2@XZ @ 0x14000F780 (-Stop@DurationTracker@CAudioDeviceGraph@@QEAA-AUDurationInformation@2@XZ.c)
    ...
    if ( v4 != -2005139433 )
    {
      if ( v4 >= 0 )
      {
        ...
        if ( **((_DWORD **)Context + 1) > 4u && TlgKeywordOn(*((TraceLoggingHProvider *)Context + 1), 0x400000000001uLL) )
        {
          ...
          v32 = 8LL;
          v34 = 8LL;
          TlgWrite(v14, &unk_14006FA14, (LPCGUID)this + 22, v13, 7u, &pData);
        }
        v2 = 0;
      }
      else
