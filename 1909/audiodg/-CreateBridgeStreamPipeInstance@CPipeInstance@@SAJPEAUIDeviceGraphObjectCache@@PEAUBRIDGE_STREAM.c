/*
 * XREFs of ?CreateBridgeStreamPipeInstance@CPipeInstance@@SAJPEAUIDeviceGraphObjectCache@@PEAUBRIDGE_STREAM_DESCRIPTOR@@PEAUIAudioProcessingObject@@PEAV1@PEAUtWAVEFORMATEX@@PEAUSYSTEM_AUDIO_STREAM@@PEAPEAV1@@Z @ 0x140034B20
 * Callers:
        ...
        struct CPipeInstance **a7)
{
  ...
  int v20; // eax
  int v21; // eax
  CPipeInstance *v23; // [rsp+40h] [rbp-B8h] BYREF
  ...
  long *v35; // [rsp+A0h] [rbp-58h] BYREF
  ATL::CAtlException *v36; // [rsp+A8h] [rbp-50h] BYREF
  ...
  try
  {
    *a7 = 0LL;
    ...
    a6 = v29;
    ATL::CAtlList<CProcessNode *,ATL::CElementTraits<CProcessNode *>>::AddTail((__int64)&v30, &a6);
    v29 = 0LL;
    a6 = 0LL;
    ...
    v23 = a6;
    ATL::CAtlList<CProcessNode *,ATL::CElementTraits<CProcessNode *>>::AddTail((__int64)&v30, &v23);
    a6 = 0LL;
    ...
    *((_QWORD *)v14 + 24) = 0LL;
    ...
    else
    {
      ...
      if ( v18 >= 0 )
      {
        ...
        *(_QWORD *)v14 = a4;
        *((_DWORD *)v14 + 2) = a4 == 0LL;
        ATL::CAtlList<CProcessNode *,ATL::CElementTraits<CProcessNode *>>::AddHeadList((__int64)v14 + 16, (__int64)&v30);
        ...
        *((_QWORD *)v14 + 26) = 1LL;
        v23 = 0LL;
        *a7 = v14;
        ATL::CAutoPtr<CPipeInstance>::Free(&v23, 1u);
        goto LABEL_43;
      }
    }
LABEL_35:
