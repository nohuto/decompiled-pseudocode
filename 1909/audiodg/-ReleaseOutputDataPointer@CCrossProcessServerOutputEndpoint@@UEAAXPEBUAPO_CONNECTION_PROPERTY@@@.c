/*
 * XREFs of ?ReleaseOutputDataPointer@CCrossProcessServerOutputEndpoint@@UEAAXPEBUAPO_CONNECTION_PROPERTY@@@Z @ 0x1400568C0
 * Callers:
 *     <none>
 * Callees:
        ...
        __int64 a2)
{
  ...
  if ( (byte_140086281 & 4) != 0 )
    McTemplateU0pqxxx((__int64)this, a2, (__int64)this - 456, 11, *(_DWORD *)(a2 + 8), 0, 0);
        ...
        if ( u32BufferFlags )
        {
          ...
          if ( v11 )
          {
            ...
            *((_QWORD *)&v27 + 1) += (unsigned int)(int)((double)(int)v21 * 10000000.0 / v18 + 0.5);
            v22((char *)this - 456, 1LL, *(unsigned int *)(v20 + 152), Size / v17, &v26, v24, 0);
            v23 = v14;
          }
          else
          {
...
LABEL_21:
  *((_DWORD *)this + 4) = 3;
  if ( (byte_140086281 & 4) != 0 )
    McTemplateU0pqxxx(v3->u32ValidFrameCount, a2, (__int64)v2, 12, v3->u32ValidFrameCount, 0, v3->u32BufferFlags);
}
