/*
 * XREFs of pre_c_initialization @ 0x140015BF0
 * Callers:
 *     <none>
 * Callees:
 ...
 *     ?AddRef@CRegObject@ATL@@UEAAKXZ @ 0x1400150C0 (-AddRef@CRegObject@ATL@@UEAAKXZ.c)
 *     __scrt_initialize_onexit_tables @ 0x140016320 (__scrt_initialize_onexit_tables.c)
 *     atexit @ 0x140016558 (atexit.c)
 *     _get_startup_file_mode @ 0x1400166DC (_get_startup_file_mode.c)
 *     ?__scrt_initialize_type_info@@YAXXZ @ 0x1400166E8 (-__scrt_initialize_type_info@@YAXXZ.c)
 *     __scrt_fastfail @ 0x140016750 (__scrt_fastfail.c)
 *     __scrt_initialize_mta @ 0x1400168E4 (__scrt_initialize_mta.c)
 *     _RTC_Initialize @ 0x1400169A0 (_RTC_Initialize.c)
 *     __p__commode @ 0x140016CF6 (__p__commode.c)
 *     _configthreadlocale @ 0x140016D56 (_configthreadlocale.c)
 *     _o__configure_wide_argv_0 @ 0x140016D62 (_o__configure_wide_argv_0.c)
 *     _o__initialize_wide_environment_0 @ 0x140016D9E (_o__initialize_wide_environment_0.c)
 *     _set_app_type @ 0x140016DE4 (_set_app_type.c)
 *     _o__set_fmode_0 @ 0x140016DF0 (_o__set_fmode_0.c)
 */
