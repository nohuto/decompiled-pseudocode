/*
 * XREFs of ?AERTCreateHeap@@YAPEAX_K00@Z @ 0x140040854
 * Callers:
 *     ?AERTMemoryInitOnce@@YAHPEAT_RTL_RUN_ONCE@@PEAXPEAPEAX@Z @ 0x140040C50 (-AERTMemoryInitOnce@@YAHPEAT_RTL_RUN_ONCE@@PEAXPEAPEAX@Z.c)
 * Callees:
 *     McTemplateU0pqpqqqqqq @ 0x140041160 (McTemplateU0pqpqqqqqq.c)
 *     WPP_SF_PPPL @ 0x1400412B0 (WPP_SF_PPPL.c)
 */
