/*
 * XREFs of ?InitialRegisterForThread@CpuManager@@EEAAJPEAXPEAURegistrationData@HandleRegistrations@1@@Z @ 0x14002D430
 * Callers:
 *     <none>
 * Callees:
        ...
        struct CpuManager::HandleRegistrations::RegistrationData *a3)
{
  ...
  NTSTATUS v14; // ebx
  HANDLE v15; // rax
  HANDLE TargetHandle; // [rsp+40h] [rbp-E8h] BYREF
  unsigned int v18; // [rsp+50h] [rbp-D8h] BYREF
  _QWORD ThreadInformation[21]; // [rsp+58h] [rbp-D0h] BYREF
