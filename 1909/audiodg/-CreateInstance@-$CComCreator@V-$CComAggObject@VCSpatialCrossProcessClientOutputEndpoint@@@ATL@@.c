/*
 * XREFs of ?CreateInstance@?$CComCreator@V?$CComAggObject@VCSpatialCrossProcessClientOutputEndpoint@@@ATL@@@ATL@@SAJPEAXAEBU_GUID@@PEAPEAX@Z @ 0x140058294
 * Callers:
        ...
        _QWORD *a3)
{
  ...
  if ( v9 )
  {
    v10 = ATL::CComCriticalSection::Init((struct _RTL_CRITICAL_SECTION *)(v9 + 1032));
    if ( v10 >= 0 )
    {
      *(_BYTE *)(v9 + 1072) = 1;
      v10 = 0;
