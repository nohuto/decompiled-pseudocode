/*
 * XREFs of ?LogGetInputDataPointer@CSpatialCrossProcessEndpointTraceLogger@@QEAAXPEBUAPO_CONNECTION_PROPERTY@@_N@Z @ 0x140059F2C
 * Callers:
        ...
        const GUID *a4)
{
  ...
  if ( (unsigned int)dword_140085100 > 5 )
  {
    ...
    v12 = 4LL;
    v14 = 4LL;
    TlgWrite((TraceLoggingHProvider)&dword_140085100, &unk_14007095E, 0LL, a4, 6u, &pData);
  }
}
