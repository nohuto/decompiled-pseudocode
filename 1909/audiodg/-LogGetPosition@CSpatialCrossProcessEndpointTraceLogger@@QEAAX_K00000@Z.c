/*
 * XREFs of ?LogGetPosition@CSpatialCrossProcessEndpointTraceLogger@@QEAAX_K00000@Z @ 0x140059FE0
 * Callers:
        ...
        char a7)
{
  ...
  if ( (unsigned int)dword_140085100 > 5 )
  {
    ...
    v19 = 8LL;
    v21 = 8LL;
    TlgWrite((TraceLoggingHProvider)&dword_140085100, &unk_140070731, 0LL, a4, 9u, &pData);
  }
}
