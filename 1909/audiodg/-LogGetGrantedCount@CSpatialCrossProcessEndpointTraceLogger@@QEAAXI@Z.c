/*
 * XREFs of ?LogGetGrantedCount@CSpatialCrossProcessEndpointTraceLogger@@QEAAXI@Z @ 0x140059E9C
 * Callers:
 *     ?GetGrantedObjectCount@CSpatialCrossProcessBaseEndpoint@@UEAAJPEAI@Z @ 0x14005BFE0 (-GetGrantedObjectCount@CSpatialCrossProcessBaseEndpoint@@UEAAJPEAI@Z.c)
 * Callees:
        ...
        const GUID *a4)
{
  ...
  if ( (unsigned int)dword_140085100 > 5 )
  {
    ...
    v10 = 0;
    v9 = 4;
    TlgWrite((TraceLoggingHProvider)&dword_140085100, &unk_140070A50, 0LL, a4, 4u, &v4);
  }
}
