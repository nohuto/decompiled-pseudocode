/*
 * XREFs of ??1?$ComPtr@VAudioDeviceModuleNotificationEventArgs@Devices@Media@Windows@@@WRL@Microsoft@@QEAA@XZ @ 0x14004573C
 * Callers:
 *     _Windows::Media::Devices::AudioDeviceModulesManager::OnModuleChanged_::_1_::dtor$7 @ 0x14004A20D (_Windows--Media--Devices--AudioDeviceModulesManager--OnModuleChanged_--_1_--dtor$7.c)
 * Callees:
