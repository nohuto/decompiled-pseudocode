/*
 * XREFs of ?CreateDeviceProcessNode@CDeviceProcessNode@@SAJPEAUAUDIO_DEVICE_PIPE_DESCRIPTOR@@PEAPEAV1@@Z @ 0x140003868
 * Callers:
        ...
        struct IAudioMediaType ***a2)
{
  ...
  if ( v4 )
  {
    ...
    {
      WPP_SF_(*((_QWORD *)WPP_GLOBAL_Control + 2), 13LL, &WPP_8d9f8a1f47633de0740c8ad81d33d659_Traceguids);
    }
  ...
  if ( v8 != &WPP_GLOBAL_Control && (*((_DWORD *)v8 + 7) & 0x20000) != 0 && *((_BYTE *)v8 + 25) >= 2u )
    WPP_SF_D(v8[2], 15LL, &WPP_8d9f8a1f47633de0740c8ad81d33d659_Traceguids, (unsigned int)v6);
