/*
 * XREFs of ?Glitch@CCrossProcessEndpointTraceLogger@@QEAAXW4CpGlitchEvent@@PEBDI@Z @ 0x140053DC4
 * Callers:
...
__int64 __fastcall CCrossProcessEndpointTraceLogger::Glitch(__int64 a1, unsigned int a2, const CHAR *a3)
{
  ...
  if ( (unsigned int)dword_140085000 > 5 && TlgKeywordOn((TraceLoggingHProvider)&dword_140085000, 2uLL) )
  {
    v10 = 16LL;
    v9 = a1 + 8;
    *(_DWORD *)pRelatedActivityId.Data4 = a2;
    ...
    TlgWrite((TraceLoggingHProvider)&dword_140085000, &unk_1400700F6, 0LL, &pRelatedActivityId, 6u, &pData);
  }
