/*
 * XREFs of ?Add@CSystemAudioDeviceCollection@@SAHPEBGPEAVCSystemAudioDeviceBase@@@Z @ 0x14000EED8
 * Callers:
...
LABEL_5:
  ...
  if ( StringResourceInstance )
    ATL::CStringT<unsigned short,ATL::StrTraitATL<unsigned short,ATL::ChTraitsCRT<unsigned short>>>::LoadStringW(
      ...
      (unsigned __int16)a1);
LABEL_6:
  v5 = (void *)_o__recalloc(qword_140086020, (int)qword_140086030 + 1, 8LL);
  if ( v5 && (qword_140086020 = v5, (v6 = (void *)_o__recalloc(qword_140086028, (int)qword_140086030 + 1, 8LL)) != 0LL) )
  {
    qword_140086028 = v6;
