/*
 * XREFs of ?CheckGlitches@CSpatialCrossProcessBaseEndpoint@@IEAAXXZ @ 0x14005B76C
 * Callers:
 ...
 *     ?RegisterGlitches@CSpatialCrossProcessEndpointTraceLogger@@QEAAXHH@Z @ 0x14005AA80 (-RegisterGlitches@CSpatialCrossProcessEndpointTraceLogger@@QEAAXHH@Z.c)
 */
...
void __fastcall CSpatialCrossProcessBaseEndpoint::CheckGlitches(CSpatialCrossProcessBaseEndpoint *this)
{
  ...
  v8 = (int)v5;
  if ( (v2 || (_DWORD)v5)
    && (unsigned int)dword_140085100 > 5
    && TlgKeywordOn((TraceLoggingHProvider)&dword_140085100, 1uLL) )
  {
    v11 = 16LL;
    v12 = &v7;
    v10 = (char *)this + 408;
    ...
    v13 = 4LL;
    v15 = 4LL;
    TlgWrite(v6, &unk_140070AF4, (LPCGUID)((char *)this + 408), v5, 5u, &pData);
    v4 = v7;
    LODWORD(v5) = v8;
  }
