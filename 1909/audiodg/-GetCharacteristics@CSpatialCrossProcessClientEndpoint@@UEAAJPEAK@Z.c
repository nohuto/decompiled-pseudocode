/*
 * XREFs of ?GetCharacteristics@CSpatialCrossProcessClientEndpoint@@UEAAJPEAK@Z @ 0x14005DAA0
 * Callers:
 *     <none>
 * Callees:
        ...
        unsigned int *a2)
{
  ...
  {
    v2 = -2147467261;
    SpatialCPTraceLoggingErrorHelper("CSpatialCrossProcessClientEndpoint::GetCharacteristics", 300, -2147467261);
  }
  return v2;
}
