/*
 * XREFs of ?assign@shared_buffer@details@wil@@AEAAXPEAJ_K@Z @ 0x140028D38
 * Callers:
 *     ??0ResultException@wil@@QEAA@AEBV01@@Z @ 0x140025FF4 (--0ResultException@wil@@QEAA@AEBV01@@Z.c)
