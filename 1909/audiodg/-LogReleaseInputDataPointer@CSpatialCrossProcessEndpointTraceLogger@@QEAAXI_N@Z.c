/*
 * XREFs of ?LogReleaseInputDataPointer@CSpatialCrossProcessEndpointTraceLogger@@QEAAXI_N@Z @ 0x14005A204
 * Callers:
        ...
        const GUID *a4)
{
  ...
  if ( (unsigned int)dword_140085100 > 5 )
  {
    ...
    v9 = 4LL;
    v11 = 4LL;
    TlgWrite((TraceLoggingHProvider)&dword_140085100, &unk_1400707D7, 0LL, a4, 5u, &pData);
  }
}
