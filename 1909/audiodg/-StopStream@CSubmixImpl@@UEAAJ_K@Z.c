/*
 * XREFs of ?StopStream@CSubmixImpl@@UEAAJ_K@Z @ 0x14000F470
 * Callers:
 *     ?StopStream@CProcessSubmix@@UEAAJ_K@Z @ 0x14000F810 (-StopStream@CProcessSubmix@@UEAAJ_K@Z.c)
 *     ?StopStream@CStreamGroup@@UEAAJ_K@Z @ 0x14002BA70 (-StopStream@CStreamGroup@@UEAAJ_K@Z.c)
 * Callees:
...
__int64 __fastcall CSubmixImpl::StopStream(CSubmixImpl *this, unsigned __int64 a2)
{
