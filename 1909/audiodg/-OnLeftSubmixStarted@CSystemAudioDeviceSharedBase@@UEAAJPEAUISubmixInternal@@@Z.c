/*
 * XREFs of ?OnLeftSubmixStarted@CSystemAudioDeviceSharedBase@@UEAAJPEAUISubmixInternal@@@Z @ 0x140012B70
 * Callers:
 *     <none>
 * Callees:
 ...
 *     ?SubmixInfluencesSaDeviceState@CSystemAudioDeviceSharedBase@@IEAA_NPEAUISubmixInternal@@@Z @ 0x140012EA8 (-SubmixInfluencesSaDeviceState@CSystemAudioDeviceSharedBase@@IEAA_NPEAUISubmixInternal@@@Z.c)
        ...
        struct ISubmixInternal *a2)
{
          ...
          a2) )
  {
    ...
    {
      WPP_SF_q(*((_QWORD *)WPP_GLOBAL_Control + 2), 29LL, &WPP_f525e75cdaa43c3aecad76b58ec104af_Traceguids, a2);
    }
    goto LABEL_8;
  }
  v10 = 0;
  ...
  *((_DWORD *)this + 11) = v4;
  ...
  if ( WPP_GLOBAL_Control != (_UNKNOWN *)&WPP_GLOBAL_Control
    ...
    && *((_BYTE *)WPP_GLOBAL_Control + 25) >= 4u )
  {
    WPP_SF_D(*((_QWORD *)WPP_GLOBAL_Control + 2), 28LL, &WPP_f525e75cdaa43c3aecad76b58ec104af_Traceguids, v4);
    v5 = *((_DWORD *)this + 11);
  }
  if ( v5 != 1
    || (v6 = CSystemAudioDeviceSharedBase::SetGraphState(
               (char *)this - 304,
               3 - (unsigned int)(*((_DWORD *)this + 8) != 0)),
        v7 = v6,
        v6 >= 0) )
  {
    if ( v10 )
