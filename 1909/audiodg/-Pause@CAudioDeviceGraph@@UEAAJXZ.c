/*
 * XREFs of ?Pause@CAudioDeviceGraph@@UEAAJXZ @ 0x14000F690
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall CAudioDeviceGraph::Pause(CAudioDeviceGraph *this)
{
  ...
  else
  {
      ...
      && fPending )
    {
      ...
      byte_140085EF8 = 1;
      TraceLoggingRegisterEx(qword_140085F00, v9, v10);
      dword_140085EFC = 1;
    ...
    if ( *(_DWORD *)v5 > 4u && TlgKeywordOn(v5, 1uLL) )
    {
      ...
      v22 = 8;
      v25 = 8;
      TlgWrite(v6, &unk_14006FABA, (LPCGUID)this + 22, v7, 5u, &pData);
    }
    v4 = 0;
  }
  if ( v1 )
