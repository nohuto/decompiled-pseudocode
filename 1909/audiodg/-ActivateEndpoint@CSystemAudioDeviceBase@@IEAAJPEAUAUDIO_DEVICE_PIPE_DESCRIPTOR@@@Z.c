/*
 * XREFs of ?ActivateEndpoint@CSystemAudioDeviceBase@@IEAAJPEAUAUDIO_DEVICE_PIPE_DESCRIPTOR@@@Z @ 0x14002ECEC
 * Callers:
  ...
  if ( v4 >= 0 )
  {
    ...
    if ( v4 >= 0 )
    {
      ...
      if ( v4 >= 0 )
      {
        ...
        if ( v43 != v42 )
        {
          ATL::AtlComQIPtrAssign(&v43, v42, &GUID_c537ee8d_5574_454a_9354_aaa4e421d31e);
          v5 = v43;
        }
        if ( !v5 )
        {
