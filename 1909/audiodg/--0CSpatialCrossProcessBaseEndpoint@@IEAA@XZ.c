/*
 * XREFs of ??0CSpatialCrossProcessBaseEndpoint@@IEAA@XZ @ 0x140057360
 * Callers:
 *     ??0CSpatialCrossProcessClientEndpoint@@QEAA@XZ @ 0x14005750C (--0CSpatialCrossProcessClientEndpoint@@QEAA@XZ.c)
 *     ??0CSpatialCrossProcessServerEndpoint@@QEAA@XZ @ 0x140057650 (--0CSpatialCrossProcessServerEndpoint@@QEAA@XZ.c)
 * Callees:
 *     ??0CCriticalSection@ATL@@QEAA@XZ @ 0x14000E274 (--0CCriticalSection@ATL@@QEAA@XZ.c)
 *     _guard_dispatch_icall_nop @ 0x140018220 (_guard_dispatch_icall_nop.c)
 *     ??0PingPongState@@QEAA@XZ @ 0x1400577BC (--0PingPongState@@QEAA@XZ.c)
