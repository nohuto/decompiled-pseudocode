/*
 * XREFs of ?LogObjectCount@CSpatialCrossProcessEndpointTraceLogger@@QEAAXPEBDII@Z @ 0x14005A158
 * Callers:
        ...
        int a4)
{
  ...
  if ( (unsigned int)dword_140085100 > 5 )
  {
    ...
    v9 = &v13;
    v12 = 4LL;
    TlgWrite((TraceLoggingHProvider)&dword_140085100, &unk_140070AAD, 0LL, v4, 6u, &pData);
  }
}
