/*
 * XREFs of ?AddAudioHistoryPacket@CCrossProcessServerOutputEndpoint@@UEAAJIUAE_CURRENT_POSITION@@W4APO_BUFFER_FLAGS@@_K@Z @ 0x140055D40
 * Callers:
 *     <none>
 * Callees:
...
LABEL_5:
  ...
  if ( v17 + (_DWORD)v15 * v25 <= *(_DWORD *)(v16 + 168) && a4 )
  {
    ...
    if ( (unsigned int)dword_140085000 > 5 )
    {
      ...
      v44 = 4;
      v47 = 8;
      TlgWrite((TraceLoggingHProvider)&dword_140085000, &unk_140070369, 0LL, v15, 9u, &pData);
      v17 = v24;
    }
