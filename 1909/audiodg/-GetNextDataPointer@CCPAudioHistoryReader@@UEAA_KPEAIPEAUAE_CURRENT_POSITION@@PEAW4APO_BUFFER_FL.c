/*
 * XREFs of ?GetNextDataPointer@CCPAudioHistoryReader@@UEAA_KPEAIPEAUAE_CURRENT_POSITION@@PEAW4APO_BUFFER_FLAGS@@@Z @ 0x140051A40
 * Callers:
 *     <none>
 * Callees:
        ...
        enum APO_BUFFER_FLAGS *a4)
{
  ...
  if ( *((_DWORD *)this + 18) == -1 )
  {
    if ( (unsigned int)dword_140085000 > 5 )
    {
      ...
      v40 = v21;
      v41 = 8LL;
      TlgWrite((TraceLoggingHProvider)&dword_140085000, &unk_14006FDAE, 0LL, v9, 3u, &v39);
    }
    *a2 = 0;
  }
  else
  {
    ...
    *a4 = *(enum APO_BUFFER_FLAGS *)(((unsigned __int64)*v10 << 6) + *((_QWORD *)this + 8) + 8);
    if ( (unsigned int)dword_140085000 > 5 )
    {
      ...
      v36 = 4LL;
      v38 = 8LL;
      TlgWrite((TraceLoggingHProvider)&dword_140085000, &unk_14006FEB7, 0LL, v15, 0xAu, &pData);
    }
    *v12 = 0;
  }
  if ( v4 )
