/*
 * XREFs of ??1?$CAtlExeModuleT@VCAudioDGModule@@@ATL@@UEAA@XZ @ 0x140029A44
 * Callers:
 *     _CAudioDGModule::CAudioDGModule_::_1_::dtor$0 @ 0x140015779 (_CAudioDGModule--CAudioDGModule_--_1_--dtor$0.c)
 * Callees:
