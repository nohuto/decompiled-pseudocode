/*
 * XREFs of ?OnDisconnectedFromRightSubmix@CSpatialCrossProcessServerEndpoint@@UEAAJ_J@Z @ 0x14005F570
 * Callers:
 *     <none>
 * Callees:
 *     <none>
...
__int64 __fastcall CSpatialCrossProcessServerEndpoint::OnDisconnectedFromRightSubmix(
        ...
        __int64 a2)
{
  _InterlockedAnd((volatile signed __int32 *)(*((_QWORD *)this - 3) + 72LL), 0xFFFFFFF7);
  _InterlockedExchange((volatile __int32 *)this - 194, 1);
