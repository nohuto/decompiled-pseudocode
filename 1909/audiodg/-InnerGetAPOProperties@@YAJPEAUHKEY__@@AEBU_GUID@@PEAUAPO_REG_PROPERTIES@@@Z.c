/*
 * XREFs of ?InnerGetAPOProperties@@YAJPEAUHKEY__@@AEBU_GUID@@PEAUAPO_REG_PROPERTIES@@@Z @ 0x1400077F4
 * Callers:
...
__int64 __fastcall InnerGetAPOProperties(HKEY hkey, const struct _GUID *a2, struct APO_REG_PROPERTIES *a3)
{
  ...
  APO_REG_PROPERTIES v22; // [rsp+50h] [rbp-868h] BYREF
