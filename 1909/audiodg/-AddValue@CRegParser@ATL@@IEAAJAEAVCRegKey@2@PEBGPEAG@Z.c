/*
 * XREFs of ?AddValue@CRegParser@ATL@@IEAAJAEAVCRegKey@2@PEBGPEAG@Z @ 0x14004E390
 * Callers:
 ...
 *     ?AtlHresultFromWin32@ATL@@YAJK@Z @ 0x14004E960 (-AtlHresultFromWin32@ATL@@YAJK@Z.c)
 ...
 *     ?SetMultiStringValue@CRegKey@ATL@@QEAAJPEBG0@Z @ 0x140051120 (-SetMultiStringValue@CRegKey@ATL@@QEAAJPEBG0@Z.c)
 *     ?SkipWhiteSpace@CRegParser@ATL@@IEAAXXZ @ 0x140051218 (-SkipWhiteSpace@CRegParser@ATL@@IEAAXXZ.c)
 *     ?VTFromRegType@CRegParser@ATL@@KAHPEBGAEAG@Z @ 0x140051690 (-VTFromRegType@CRegParser@ATL@@KAHPEBGAEAG@Z.c)
 */
