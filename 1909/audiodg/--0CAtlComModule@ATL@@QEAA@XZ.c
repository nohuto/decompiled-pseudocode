/*
 * XREFs of ??0CAtlComModule@ATL@@QEAA@XZ @ 0x1400153E4
 * Callers:
...
{
  memset_0(&stru_1400860D0, 0, sizeof(stru_1400860D0));
  ATL::_AtlComModule = 0;
  qword_1400860B8 = (__int64)&_ImageBase;
  qword_1400860C0 = (__int64)_pobjMap_CAudioDeviceGraph;
  qword_1400860C8 = (__int64)&_pobjMapEntryLast;
  if ( (int)ATL::CComCriticalSection::Init(&stru_1400860D0) >= 0 )
