 ...
 *     <none>
 * Callees:
 *     _lambda_37f27beb938d7d5fc10370b748edb9fb_::operator() @ 0x140045DF8 (_lambda_37f27beb938d7d5fc10370b748edb9fb_--operator().c)
  ...
  *v17 = 0;
  ...
  if ( v4 >= 0 )
  {
    ...
    if ( v6 )
    {
      while ( 1 )
      {
        v4 = lambda_37f27beb938d7d5fc10370b748edb9fb_::operator()((__int64)v12, v7, &v13);
        if ( v4 < 0 )
          break;
    ...
    {
      v4 = lambda_37f27beb938d7d5fc10370b748edb9fb_::operator()((__int64)v12, v7, (_DWORD *)(a1 + 40));
    }
