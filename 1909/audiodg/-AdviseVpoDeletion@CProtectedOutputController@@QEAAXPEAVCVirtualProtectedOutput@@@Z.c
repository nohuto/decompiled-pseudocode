/*
 * XREFs of ?AdviseVpoDeletion@CProtectedOutputController@@QEAAXPEAVCVirtualProtectedOutput@@@Z @ 0x140036624
 * Callers:
 *     ?Release@CVirtualProtectedOutput@@UEAAKXZ @ 0x140036BB0 (-Release@CVirtualProtectedOutput@@UEAAKXZ.c)
 * Callees:
