/*
 * XREFs of ?GetPingPongReadIndex@CSpatialCrossProcessBaseEndpoint@@IEAAJPEAI@Z @ 0x14005C3F8
 * Callers:
 ...
 *     ?Log@?$LogarithmicLogger@$1?SpatialCPTraceLoggingErrorHelper@@YAXPEBDIJ@Z$0?HHIDPPJO@@@QEAAXPEBDIJ@Z @ 0x14005CB00 (-Log@-$LogarithmicLogger@$1-SpatialCPTraceLoggingErrorHelper@@YAXPEBDIJ@Z$0-HHIDPPJO@@@QEAAXPEBD.c)
 */
        ...
        unsigned int *a2)
{
  ...
  v2 = (volatile signed __int32 **)((char *)this + 192);
  v4 = 0;
...
LABEL_7:
  ...
  {
    v17 = 1;
    (**((void (__fastcall ***)(char *, _QWORD, int *))this + 94))((char *)this + 752, 0LL, &v17);
    v4 = -2005139387;
  ...
  else
  {
    ...
    _InterlockedIncrement((volatile signed __int32 *)(*((_QWORD *)this + 112) + 76LL));
    v4 = -2005139358;
  }
