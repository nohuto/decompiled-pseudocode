/*
 * XREFs of KiAbEntryGetLockedHeadEntry @ 0x140060C30
 * Callers:
 ...
 *     KiAbCompareSnappedEntryState @ 0x140136284 (KiAbCompareSnappedEntryState.c)
...
char *__fastcall KiAbEntryGetLockedHeadEntry(char *Node, int a2, struct _KLOCK_QUEUE_HANDLE *a3)
{
  ...
  __int64 v30; // r9
  char v31; // cl
  $E00D17A58C86F4ACDD80DB44A227A759 *v32; // rbx
...
LABEL_49:
  ...
  if ( *((__int64 *)v7 + 4) >= 0 )
  {
    if ( (v7[25] & 1) != 0 )
    {
      ...
      if ( v31 > 15 )
        v31 = 15;
      v32 = ($E00D17A58C86F4ACDD80DB44A227A759 *)(Root + 64);
      v7[48] = v31;
    ...
    else
    {
      ...
      v32 = ($E00D17A58C86F4ACDD80DB44A227A759 *)(Root + 48);
      v7[48] = v37;
      v38 = v37;
