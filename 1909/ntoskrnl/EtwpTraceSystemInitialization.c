/*
 * XREFs of EtwpTraceSystemInitialization @ 0x140A16090
 * Callers:
...
char EtwpTraceSystemInitialization()
{
  ...
  {
    v26 = KeBootTime;
    if ( stru_140426650.LevelPlus1 > 5 && TlgKeywordOn(&stru_140426650, 0x800000000000uLL) )
    {
      ...
      v62 = 4LL;
      v64 = 1LL;
      TlgWrite(&stru_140426650, &unk_1403939EC, 0LL, 0LL, 0xCu, &pData);
    }
    ...
    if ( (_BYTE)Version )
    {
      ...
      {
        LOBYTE(Version) = TlgKeywordOn(&stru_140426650, 0x400000000000uLL);
        if ( (_BYTE)Version )
        {
          LOBYTE(v14) = v9;
          ...
          v67 = 4LL;
          v69 = 1LL;
          LOBYTE(Version) = TlgWrite(&stru_140426650, &unk_1403939B7, 0LL, 0LL, 4u, &v65);
        }
      }
    }
