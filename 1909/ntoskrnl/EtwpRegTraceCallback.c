/*
 * XREFs of EtwpRegTraceCallback @ 0x1408F8840
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall EtwpRegTraceCallback(PVOID CallbackContext, PVOID Argument1, int *Argument2)
{
  ...
  PCUNICODE_STRING ObjectName; // [rsp+78h] [rbp-90h] BYREF
  __int128 ObjectName_8; // [rsp+80h] [rbp-88h] BYREF
  ...
  *(_QWORD *)&ObjectName_8 = 0LL;
  *((_QWORD *)&ObjectName_8 + 1) = 0LL;
  v4 = 0;
  ObjectName = 0LL;
  v5 = 0LL;
  v70 = 0;
  ...
  if ( (int)Argument1 > 22 )
  {
    ...
    if ( !v28 )
    {
      ...
      v4 = 113;
      v37 = *(PVOID *)Argument2;
      ObjectName_8 = ETW_REGISTRY_EVENT_QUERY_VALUE_KEY;
      v8 = *(__int16 **)(v36 + 8);
      Object = v37;
...
LABEL_52:
    ...
    if ( !v29 )
    {
      ...
      ObjectName_8 = ETW_REGISTRY_EVENT_QUERY_MULTIPLE_VALUE_KEY;
    ...
    if ( v30 )
    {
      ...
      v21 = (__int64)Argument2;
      v34 = (__int16 **)*((_QWORD *)Argument2 + 2);
      ObjectName_8 = ETW_REGISTRY_EVENT_OPEN_KEY;
      Object = v34[1];
      if ( Argument2[2] >= 0 )
        goto LABEL_46;
    }
    else
    {
      v21 = (__int64)Argument2;
      v34 = (__int16 **)*((_QWORD *)Argument2 + 2);
      ObjectName_8 = ETW_REGISTRY_EVENT_CREATE_KEY;
      Object = v34[1];
      if ( Argument2[2] >= 0 )
      {
        v70 = *(_DWORD *)v34[8];
LABEL_46:
  ...
  if ( (_DWORD)Argument1 == 22 )
  {
    ...
    Object = *(PVOID *)Argument2;
    ObjectName_8 = ETW_REGISTRY_EVENT_QUERY_KEY;
  ...
  if ( v10 )
  {
    ...
    if ( v11 )
    {
      ...
      if ( !v12 )
      {
        ...
        v21 = (__int64)Argument2;
        ObjectName_8 = ETW_REGISTRY_EVENT_DELETE_KEY;
        Object = *v26;
        goto LABEL_53;
      }
      v13 = v12 - 1;
      if ( !v13 )
      {
        ...
        ObjectName_8 = ETW_REGISTRY_EVENT_SET_VALUE_KEY;
        v8 = *(__int16 **)(v24 + 8);
      ...
      if ( v14 )
      {
        ...
        v18 = *((_QWORD *)Argument2 + 2);
        Object = *(PVOID *)Argument2;
        ObjectName_8 = ETW_REGISTRY_EVENT_SET_INFORMATION_KEY;
        LODWORD(v68) = *(_DWORD *)(v18 + 8);
        v20 = *(_DWORD *)(v18 + 24);
LABEL_18:
        v4 = 112;
LABEL_13:
      ...
      v21 = (__int64)Argument2;
      v4 = 1;
      ObjectName_8 = ETW_REGISTRY_EVENT_DELETE_VALUE_KEY;
      v8 = *(__int16 **)(v23 + 8);
LABEL_20:
      Object = *(PVOID *)Argument2;
LABEL_53:
      ...
      *((_QWORD *)v39 + 1) = 4LL;
      ...
      {
        v41 = 16LL * v6++;
        *(ULONGLONG *)((char *)&UserData.Ptr + v41) = (ULONGLONG)&v68 + 4;
        *(_QWORD *)((char *)&UserData.Size + v41) = 4LL;
      }
      if ( (v4 & 0x10) != 0 )
      {
        v42 = 16LL * v6++;
        *(ULONGLONG *)((char *)&UserData.Ptr + v42) = (ULONGLONG)&v68;
      ...
      {
        v44 = 16LL * v6++;
        *(ULONGLONG *)((char *)&UserData.Ptr + v44) = (ULONGLONG)&v66;
      ...
      *((_QWORD *)&UserData.Size + v48) = 2LL;
      ...
      if ( v21 == 1 || (v62 = *(int *)(v21 + 8) < 0, BYTE4(ObjectName_8) = 1, !v62) )
        BYTE4(ObjectName_8) = 2;
      EtwWrite(EtwpRegTraceHandle, (PCEVENT_DESCRIPTOR)&ObjectName_8, 0LL, v49, &UserData);
      if ( P )
