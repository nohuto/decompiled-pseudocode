/*
 * XREFs of VrpPostOpenOrCreate @ 0x140843E6C
 * Callers:
...
LABEL_21:
    if ( stru_140425BF8.LevelPlus1 > 2 )
    {
      ...
      v46 = v28;
      v49 = 4;
      TlgWrite(&stru_140425BF8, &unk_14038CA95, &ActivityId, 0LL, 5u, &pData);
    }
    if ( v6 )
    ...
    *(_QWORD *)v10 = 0LL;
    ...
    if ( v30 == 260 || v30 == 872 )
    {
      if ( stru_140425BF8.LevelPlus1 > 5 )
      {
        ...
        v46 = v36;
        v49 = 4;
        TlgWrite(&stru_140425BF8, &unk_14038C777, &ActivityId, 0LL, 5u, &pData);
      }
    }
    else
    {
