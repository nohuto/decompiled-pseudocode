/*
 * XREFs of MmLinkJobProcess @ 0x140688B5C
 * Callers:
...
__int64 __fastcall MmLinkJobProcess(__int64 a1, unsigned __int64 a2)
{
  ...
  v5 = (volatile signed __int64 *)(a2 + 1968);
  ExAcquirePushLockExclusiveEx(a2 + 1968, 0LL);
  if ( (*(_DWORD *)(a2 + 1788) & 0x10) == 0 )
  {
    v6 = (_QWORD *)(a2 + 1976);
    v7 = *(_QWORD **)(a2 + 1976);
    if ( v7 != (_QWORD *)(a2 + 1976) )
    {
      while ( 1 )
      {
        v8 = v7[2];
...
LABEL_6:
    ...
    else if ( (*(_DWORD *)(a2 + 1788) & 8) == 0 )
    {
      _InterlockedOr((volatile signed __int32 *)(a2 + 1788), 8u);
    }
  }
  v12 = *(_QWORD **)(v4 + 48);
  v13 = (_QWORD *)(a2 + 1136);
...
LABEL_35:
  ...
  *(_QWORD *)(a2 + 952) = v4;
  ...
  if ( inserted < 0 )
  {
    for ( i = a2 + 1976; *(_QWORD *)i != i; MiRemoveSharedCommitNode(*(_QWORD **)(*(_QWORD *)i + 16LL), a2, 1) )
      ;
    _InterlockedAnd((volatile signed __int32 *)(a2 + 1788), 0xFFFFFFF7);
    _InterlockedOr((volatile signed __int32 *)(a2 + 1788), 0x10u);
  }
