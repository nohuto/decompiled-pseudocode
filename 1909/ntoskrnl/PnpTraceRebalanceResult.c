/*
 * XREFs of PnpTraceRebalanceResult @ 0x140873F68
 * Callers:
...
BOOLEAN PnpTraceRebalanceResult()
{
  ...
  result = TraceLoggingProviderEnabled(&stru_140425D20, 0, 0x400000000000uLL);
  if ( result )
  {
    ...
    {
      result = TlgKeywordOn(&stru_140425D20, 0x400000000000uLL);
      if ( result )
      {
        v6 = v2 - *((_QWORD *)v4 + 7);
        v9 = *v4;
        ...
        v38 = 8LL;
        v40 = 8LL;
        return TlgWrite(&stru_140425D20, &unk_14038D398, 0LL, 0LL, 0xFu, &pData);
      }
    }
  }
  return result;
