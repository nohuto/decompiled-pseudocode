/*
 * XREFs of _handle_errorf @ 0x1401A4A88
 * Callers:
 *     sqrtf @ 0x1401A1B90 (sqrtf.c)
 * Callees:
 *     __security_check_cookie @ 0x14019EE20 (__security_check_cookie.c)
 *     _call_matherr @ 0x1401A4820 (_call_matherr.c)
 *     _exception_enabled @ 0x1401A4890 (_exception_enabled.c)
 *     _raise_excf @ 0x1401A5160 (_raise_excf.c)
 *     _set_errno_from_matherr @ 0x1401A5190 (_set_errno_from_matherr.c)
