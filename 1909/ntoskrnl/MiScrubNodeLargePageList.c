/*
 * XREFs of MiScrubNodeLargePageList @ 0x1402E6B20
 * Callers:
        ...
        __int64 a10)
{
  ...
  if ( a5 )
  {
    ...
    {
      v17 = MiReservePtes((__int64)&qword_1404666C0, (unsigned __int64 *)(unsigned int)v15);
      v14 = v17;
      if ( !v17 )
        return 1LL;
...
LABEL_127:
  ...
  v28 = v69;
  MiReleasePtes((__int64)&qword_1404666C0, v14, v69);
  v61 = MiReservePtes((__int64)&qword_1404666C0, (unsigned __int64 *)(unsigned int)v69);
  v14 = v61;
  if ( v61 )
  {
  ...
  *((_DWORD *)&v93[1].SwapListEntry + 3) &= ~0x100u;
  if ( a5 )
  {
    if ( (unsigned int)v11 <= 1 )
      return v27;
    if ( v14 )
      MiReleasePtes((__int64)&qword_1404666C0, v14, v28);
  }
  return v65;
}
