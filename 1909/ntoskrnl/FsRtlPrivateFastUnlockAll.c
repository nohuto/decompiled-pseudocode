        ...
        __int64 a6)
{
  ...
  struct _RTL_SPLAY_LINKS *v47; // [rsp+48h] [rbp-70h]
  ...
  v11 = *(struct _RTL_SPLAY_LINKS **)(v6 + 32);
  v12 = v9;
  if ( !v11 && !*(_QWORD *)(v6 + 40) )
  {
...
LABEL_20:
    ...
    v23 = (struct _RTL_SPLAY_LINKS *)v8[1];
    v51 = 0;
    if ( v23 )
    {
