/*
 * XREFs of SepAdtCloseObjectAuditAlarm @ 0x1408DC0D0
 * Callers:
 ...
 *     SeCloseObjectAuditAlarmForNonObObject @ 0x1408DE7A0 (SeCloseObjectAuditAlarmForNonObObject.c)
 * Callees:
        ...
        char a5)
{
  ...
  if ( (unsigned __int8)SepAdtAuditObjectAccessWithContext(a4, a1, 1, 0, (__int64)a3, a5, &v23)
    && (unsigned __int8)SepAdtAuditThisEventWithContext(0x7Bu, 1u, 0, a3) )
  {
