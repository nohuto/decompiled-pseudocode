/*
 * XREFs of AslpFileGetVersionBlock @ 0x14092A0CC
 * Callers:
 ...
 *     VerSetConditionMask @ 0x14017FAD0 (VerSetConditionMask.c)
...
__int64 __fastcall AslpFileGetVersionBlock(_QWORD *a1, _QWORD *a2, __int64 a3)
{
  ...
  v24 = *(_QWORD *)(a3 + 32);
  v25 = *(_QWORD *)(a3 + 40);
  v8 = LdrResSearchResource(v24, v26, 3u, *(_BYTE *)(a3 + 59) == 0 ? 0x200 : 0, (unsigned int **)&Src, &Size, 0LL, 0LL);
  v7 = v8;
  if ( v8 >= 0 )
  {
    v12 = v25;
...
LABEL_16:
    ...
    if ( v7 < 0
      || (AslLogCallPrintf(3LL),
          v24 = v27[3],
          v7 = LdrResSearchResource(v27[3], v26, 3u, 0, (unsigned int **)&Src, &Size, 0LL, 0LL),
