    ...
    if ( a4 )
    {
      ...
      if ( HasBufferBeenTouched )
      {
        ViHalPreprocessOptions(
          ...
          (const void *)4);
        VfReportIssueWithOptions(0xE6u, 0xFuLL, 4uLL, a3, HasBufferBeenTouched, byte_14042B8C8);
      }
      ...
      if ( v11 )
      {
        ViHalPreprocessOptions(
          ...
          (const void *)0x1000000F,
          (const void *)5);
        VfReportIssueWithOptions(0xE6u, 0xFuLL, 5uLL, a3, v11, byte_14042B8C0);
      }
    }
    else
    {
      ...
      if ( v6 )
      {
        ViHalPreprocessOptions(
          ...
          (const void *)0x1000000F);
        VfReportIssueWithOptions(0xE6u, 0xFuLL, 3uLL, v6, 0LL, &dword_14042B8C4);
      }
    }
  }
}
