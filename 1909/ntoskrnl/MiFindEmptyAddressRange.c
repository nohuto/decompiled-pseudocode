/*
 * XREFs of MiFindEmptyAddressRange @ 0x14060C040
 * Callers:
 ...
 *     MiExpandVadBitMap @ 0x140685AF4 (MiExpandVadBitMap.c)
 *     MiFindEmptyAddressRangeInTree @ 0x1406C46D0 (MiFindEmptyAddressRangeInTree.c)
 *     MiFindClearVadBitsAligned @ 0x1406C7BAC (MiFindClearVadBitsAligned.c)
 */
        ...
        _DWORD *a9)
{
  ...
  *a9 = 1;
  if ( (a7 & 2) != 0 )
  {
    v27 = Process[1].ActiveProcessors.Bitmap[17];
    ...
    if ( !a5 && v9 >= (*(_QWORD *)(a1 + 40) << 16) + 0xFFFFLL )
    {
      while ( 1 )
      {
        ...
        if ( v21 != 1 && v21 >= *(_QWORD *)(a1 + 24) )
          v22 = *(_QWORD *)(a1 + 32);
        v23 = *(_QWORD *)(a1 + 8) - qword_140465BD8;
        if ( v15 == 1 )
        {
          v28 = v22 + 8 * v23;
          if ( v28 < v18 || v28 >= v19 )
        ...
        if ( ClearBits != -1LL )
        {
          ...
          {
            *a8 = (v25 + 8 * (*(_QWORD *)(a1 + 8) - qword_140465BD8)) << 16;
            return 0LL;
          }
        }
...
LABEL_35:
  *v16 = 0;
  ...
  if ( v32 > v9 )
  {
    if ( (*(_DWORD *)&Process[2].Spare2[7] & 0x20) == 0 || (v35 = 0x3FFFFFFFLL, v9 <= 0x3FFFFFFF) )
      v35 = 0xFFFFFFLL;
    v32 &= v35;
    if ( !v32 || v32 > v9 )
      v32 = 0x10000LL;
  ...
  if ( !v33 || v9 - v32 + 1 < a2 )
    return 3221225495LL;
  v34 = (_DWORD)Process + 1624;
  result = MiFindEmptyAddressRangeInTree((int)Process + 1624, a2, v12, v10, v32, v9, (__int64)a8);
  if ( (int)result < 0 )
  {
    v36 = v41 << 16;
    if ( v15 != 1 )
