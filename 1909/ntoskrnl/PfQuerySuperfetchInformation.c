/*
 * XREFs of PfQuerySuperfetchInformation @ 0x1405CEA00
 * Callers:
 ...
 *     SepFilterPrivilegeAudits @ 0x1406D0EAC (SepFilterPrivilegeAudits.c)
  ...
  else
  {
    switch ( v10 )
    {
      ...
      case 2:
        ...
        v41 = xmmword_140467684;
        v42 = qword_140467694;
        v43 = dword_14046769C;
        v49 = 17LL;
        v50 = _InterlockedCompareExchange64((volatile signed __int64 *)qword_140467838, 0LL, 17LL);
        if ( v50 != 17 )
      ...
      case 9:
        ...
        *(_DWORD *)Address[0] = dword_140503750;
        *v8 = 4;
        break;
      case 12:
