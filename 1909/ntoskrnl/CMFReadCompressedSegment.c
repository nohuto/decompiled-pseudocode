/*
 * XREFs of CMFReadCompressedSegment @ 0x140915D2C
 * Callers:
 ...
 *     XpressDecode @ 0x14034DBD4 (XpressDecode.c)
 *     XpressDecodeClose @ 0x14034DCFC (XpressDecodeClose.c)
 *     XpressDecodeCreate @ 0x14034DD28 (XpressDecodeCreate.c)
 */

__int64 __fastcall CMFReadCompressedSegment(HANDLE FileHandle, unsigned __int64 a2, unsigned int a3, _DWORD *a4)
{
  _DWORD *v8; // r14
  NTSTATUS v9; // ebx
  int v10; // ebx
...
LABEL_12:
    ...
    v26 = v10 - 4192;
    v16 = 0LL;
    for ( i = v11; (unsigned int)v16 < v12; i = (char *)i + a2 )
    {
      if ( (_DWORD)v16 == v12 - 1 )
      {
        v17 = a4[22];
      ...
      else if ( (unsigned int)XpressDecode((__int64)v8, (__int64)v11, v18, v18, (__int64)v14, v17) != v18 )
      {
        v9 = -1073741217;
        goto LABEL_29;
      }
