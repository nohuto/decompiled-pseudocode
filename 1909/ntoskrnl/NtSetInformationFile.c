/*
 * XREFs of NtSetInformationFile @ 0x14009B240
 * Callers:
 *     <none>
 * Callees:
        ...
        FILE_INFORMATION_CLASS FileInformationClass)
{
  ...
  int Priority; // [rsp+80h] [rbp-C8h] BYREF
  ...
  char v116; // [rsp+D8h] [rbp-70h] BYREF
...
LABEL_38:
  ...
  if ( (*p_Flags & 0x4000000) == 0 )
  {
    ...
    KiAcquireKobjectLockSafe(&v16->Event);
...
LABEL_89:
                ...
                else
                {
                  ...
                  __writecr8(1uLL);
                  IopCompleteRequest((__int64)&v41->Tail, (__int64)v117, v115, (ULONG_PTR *)&v114, v115);
