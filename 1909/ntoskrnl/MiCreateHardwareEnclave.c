/*
 * XREFs of MiCreateHardwareEnclave @ 0x1408932E4
 * Callers:
...
__int64 __fastcall MiCreateHardwareEnclave(__int64 a1, __int64 a2, __int64 a3, __int64 a4, _DWORD *a5)
{
  ...
  VmPartition = (_QWORD *)MiGetVmPartition((__int64)&Process[1].IdealNode[6]);
  v13 = VmPartition;
  if ( v12 )
  {
...
LABEL_11:
  ...
  *(_QWORD *)v17 = v18;
  ...
  v21 = Process[1].ActiveProcessors.Bitmap[6];
  v23 = 0;
  if ( v21 )
  {
    v22 = *(_WORD *)(v21 + 8);
  ...
  if ( (int)result >= 0 )
  {
    ...
    {
      *(_DWORD *)(a2 + 64) |= 4u;
      _InterlockedIncrement((volatile signed __int32 *)(*(_QWORD *)&Process[1].IdealNode[14] + 296LL));
    }
    return 0LL;
  }
  return result;
