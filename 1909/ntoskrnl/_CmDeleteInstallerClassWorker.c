/*
 * XREFs of _CmDeleteInstallerClassWorker @ 0x140935474
 * Callers:
 ...
 *     _CmDeleteInstallerClassRegKey @ 0x140935448 (_CmDeleteInstallerClassRegKey.c)
...
LABEL_22:
  ...
  if ( v13 )
  {
    while ( 1 )
    {
      v17 = CmSetInstallerClassMappedProperty(a1, a2, (__int64)PoolWithTag + 20 * v16, 0, 0LL, 0);
      if ( v17 )
      {
