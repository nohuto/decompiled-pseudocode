/*
 * XREFs of BcdEnumerateObjects @ 0x14092DFE0
 * Callers:
 ...
 *     BiIsEnumerateMatch @ 0x14092E544 (BiIsEnumerateMatch.c)
 */
...
NTSTATUS __fastcall BcdEnumerateObjects(__int64 a1, _DWORD *a2, GUID *a3, unsigned int *a4, unsigned int *a5)
{
  ...
  *(_QWORD *)&DestinationString.Length = 0LL;
  ...
  if ( result >= 0 )
  {
    ...
    v31 = 0LL;
    v10 = 0LL;
    v11 = BiOpenKey(a1, L"Objects", 0x20019u, &v33);
    v12 = v33;
    v13 = v11;
    if ( v11 >= 0 )
    {
      ...
      if ( v14 >= 0 )
      {
        ...
        v19 = 24LL * v15;
        if ( v19 > 0xFFFFFFFF
          || (v20 = (_QWORD *)((char *)&v7->Data1 + (unsigned int)v19), v21 = 8LL * v15, v21 > 0xFFFFFFFF)
