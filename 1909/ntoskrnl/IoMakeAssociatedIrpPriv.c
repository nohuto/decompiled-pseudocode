/*
 * XREFs of IoMakeAssociatedIrpPriv @ 0x14011A4A4
 * Callers:
 *     IoMakeAssociatedIrpEx @ 0x14011A490 (IoMakeAssociatedIrpEx.c)
 *     IoMakeAssociatedIrp @ 0x140170840 (IoMakeAssociatedIrp.c)
 * Callees:
