/*
 * XREFs of ExpSaAllocatorAllocate @ 0x14016DC2C
 * Callers:
...
LABEL_77:
      ...
      if ( v14 && ($C6908ADE9723D0A04AF8EE82D8D15C40 *)v34->ApcState.ApcListHead[0].Flink != &v34->152 )
...
LABEL_53:
  ...
  if ( v14 && ($C6908ADE9723D0A04AF8EE82D8D15C40 *)v18->ApcState.ApcListHead[0].Flink != &v18->152 )
