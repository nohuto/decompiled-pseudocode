/*
 * XREFs of EmpParseRules @ 0x1409FA908
 * Callers:
 ...
 *     EmpInfParseSearchDependencyList @ 0x1409FB6D4 (EmpInfParseSearchDependencyList.c)
 */
      ...
      *(_DWORD *)(v7 + 40) = 0;
      ...
      else
      {
        ...
        *(_DWORD *)(v7 + 44) = strtoul(v12, 0LL, 10);
        SectionLineIndexValueCount = CmpGetSectionLineIndexValueCount(a1, (__int64)"RuleDef", v1);
