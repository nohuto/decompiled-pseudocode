/*
 * XREFs of MiUnloadSystemImage @ 0x1406A5BC8
 * Callers:
 ...
 *     MiVaToSoftwareWsle @ 0x1402E5970 (MiVaToSoftwareWsle.c)
...
void __fastcall MiUnloadSystemImage(__int64 BugCheckParameter2, char a2)
{
    ...
    if ( v8 )
    {
      ...
      if ( v21 )
      {
          ...
          && v9 )
        {
          ...
          MiWalkEntireImage(v22, qword_140464570, 16, 0xFFFFFFFF);
        }
      }
    }
  }
  ...
  if ( v23 && (a2 & 1) != 0 )
  {
    ...
    if ( !(unsigned int)MI_IS_PHYSICAL_ADDRESS((__int64)v4) )
    {
      ...
      qword_140464618 = BugCheckParameter2;
      MiDeleteSystemPagableVm((__int64)AnyMultiplexedVm, v27, v49, v46, 5, v43);
      if ( v27 )
        MiWalkEntireImage(v27, (__int64)v44, 4, 0xFFFFFFFF);
      qword_140464618 = 0LL;
      _InterlockedExchangeAdd((_DWORD *)&xmmword_140464640 + 3, LODWORD(v43[0]) - LODWORD(v43[3]));
      v31 = (__int64)Object;
      if ( !Object )
      {
        MiReleasePrivilegedPtes(v49, (unsigned int)v38);
