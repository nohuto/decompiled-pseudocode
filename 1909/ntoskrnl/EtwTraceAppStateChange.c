...
void __fastcall EtwTraceAppStateChange(__int64 BugCheckParameter1, __int64 a2)
{
  ...
  _QWORD v22[12]; // [rsp+50h] [rbp-B0h] BYREF
  _DWORD v23[11]; // [rsp+B0h] [rbp-50h] BYREF
  _BYTE v24[100]; // [rsp+DCh] [rbp-24h] BYREF
  _BYTE v25[48]; // [rsp+140h] [rbp+40h] BYREF
  _BYTE v26[416]; // [rsp+170h] [rbp+70h] BYREF
  ...
  if ( TraceLoggingProviderEnabled(&stru_140426618, 0, 0x600000000001uLL) )
  {
    ...
    *(_QWORD *)&v24[73] = *(_QWORD *)(a2 + 40) / 0x2710uLL;
    if ( v7 == 3 )
    {
      ...
      v23[0] = ObGetProcessHandleCount(BugCheckParameter1, 0LL);
      v10 = -1;
      v11 = -1;
      *(_QWORD *)&v23[1] = *(_QWORD *)(BugCheckParameter1 + 1264) << 12;
      *(_QWORD *)&v23[3] = *(_QWORD *)(BugCheckParameter1 + 1272) << 12;
      v12 = -1;
      ...
      v23[10] = v10;
      *(_QWORD *)&v23[5] = v22[3];
      EtwpWriteAppStateChangeWithStats(BugCheckParameter1, v24, v23, 1024LL);
      v14 = v23;
    }
    else
    {
    ...
    if ( TraceLoggingProviderEnabled(&stru_140426618, 0, 0x400000000000uLL) )
    {
      ...
      EtwpQueryTokenPackageInfo(v17, v26, &v18);
