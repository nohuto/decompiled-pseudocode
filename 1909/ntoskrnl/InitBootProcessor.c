/*
 * XREFs of InitBootProcessor @ 0x140A08698
 * Callers:
 ...
 *     KvfInitFeatureStates @ 0x14019DC28 (KvfInitFeatureStates.c)
 ...
 *     RtlControlStackTraceDataBase @ 0x14030B298 (RtlControlStackTraceDataBase.c)
 ...
 *     ExComputeTickCountMultiplier @ 0x140A1D568 (ExComputeTickCountMultiplier.c)
 ...
 *     ExpInitializeBootEnvironment @ 0x140A22D5C (ExpInitializeBootEnvironment.c)
 *     ExInitializeHandleTablePackage @ 0x140A22DA4 (ExInitializeHandleTablePackage.c)
 *     HeadlessInit @ 0x140A22FAC (HeadlessInit.c)
 *     ExBurnMemory @ 0x140A383C0 (ExBurnMemory.c)
...
__int64 __fastcall InitBootProcessor(ULONG_PTR a1)
{
  ...
  *(_DWORD *)&HostNtSystemRoot->Length = 34078720;
  ...
  qword_140A4F6A8 = PerformanceCounter.QuadPart;
...
LABEL_61:
  ...
  if ( CmNtCSDVersion )
  {
    ...
    RtlInitAnsiString(&DestinationString, (PCSZ)v62->Text);
...
LABEL_91:
  ...
  if ( (NtGlobalFlag & 0x2000) != 0 )
  {
    ...
    if ( v45 )
    {
      ...
      v65[1] = 0x800000LL;
      v65[2] = 0x800000LL;
      if ( (int)RtlControlStackTraceDataBase(v47, v46, v65) < 0 )
  ...
  if ( !PsInitSystem(0, (void *)a1) || (int)DbgkInitialize() < 0 )
    KeBugCheck(0x60u);
  if ( !(unsigned __int8)PpInitSystem(v50, v49, v51) )
    KeBugCheck(0x8Fu);
