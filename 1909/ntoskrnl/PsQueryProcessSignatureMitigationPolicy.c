/*
 * XREFs of PsQueryProcessSignatureMitigationPolicy @ 0x1406EC4E0
 * Callers:
...
void __fastcall PsQueryProcessSignatureMitigationPolicy(__int64 a1, _DWORD *a2)
{
  ...
  *a2 = 0;
  ...
  else if ( qword_140436440
         && (LOBYTE(a2) = 6, (unsigned int)qword_140436440(a1, a2))
         && qword_140436440
         && (LOBYTE(v6) = *(_BYTE *)(v2 + 1785), LOBYTE(v5) = 6, (unsigned int)qword_140436440(v6, v5)) )
  {
    *v4 |= 2u;
  }
