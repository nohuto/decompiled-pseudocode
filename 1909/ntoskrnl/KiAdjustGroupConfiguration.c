/*
 * XREFs of KiAdjustGroupConfiguration @ 0x1402A6538
 * Callers:
  ...
  if ( (v2 & 8) == 0 && !*(_QWORD *)(a1 + 136) )
  {
    ...
    if ( v3 >= (unsigned __int16)KiActiveGroups )
    {
      ...
      if ( KeNumberNodes )
      {
        ...
        {
          if ( (*(_BYTE *)(*v8 + 181) & 2) != 0 )
            v48[*(unsigned __int16 *)(*v8 + 144)] -= *(unsigned __int8 *)(*v8 + 180);
          ++v8;
          --v9;
        }
        while ( v9 );
...
LABEL_23:
        ...
        if ( KeNumberNodes )
        {
          ...
          {
            v26 = *v7;
            if ( (*(_BYTE *)(*v7 + 181) & 0xA) == 2 && !*(_QWORD *)(v26 + 136) )
            {
        ...
        if ( (unsigned __int16)v24 - 1 > 0 )
        {
          ...
          do
          {
            if ( v28 < (unsigned __int16)v24 )
            {
              ...
              {
                v32 = v50[v29];
                if ( *(_BYTE *)(v32 + 180) < *(_BYTE *)(*v30 + 180LL) )
                {
                  v50[v29] = *v30;
                  *v30 = v32;
                }
...
LABEL_70:
        if ( (_WORD)v24 )
        {
          ...
          do
          {
            ...
            if ( v36 )
            {
              LOBYTE(v2) = (*(_WORD *)(v46 + 144) < (unsigned __int16)KiActiveGroups ? 4 : 0) | *(_BYTE *)(v46 + 181) & 0xFB;
              *(_BYTE *)(v46 + 181) = v2;
            }
            else
            {
