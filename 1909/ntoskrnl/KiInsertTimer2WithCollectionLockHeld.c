/*
 * XREFs of KiInsertTimer2WithCollectionLockHeld @ 0x14009F190
 * Callers:
...
LABEL_20:
  ...
  else
  {
    *(_BYTE *)(a1 + 131) = v21 & 0xEF;
    v22 = (_RTL_RB_TREE *)(0x140000000LL + 24LL * (v21 & 3) + 4511520);
    v23 = *(_QWORD *)(0x140000008LL + 24LL * (v21 & 3) + 4511520);
...
LABEL_49:
    ...
    {
      if ( v30 == (_RTL_BALANCED_NODE *)1 )
        v28 = 0LL;
      else
        v28 = (unsigned __int64)v30 ^ ((unsigned __int64)v22 | 1);
    }
    else
    {
      v28 = (__int64)v22->Min;
