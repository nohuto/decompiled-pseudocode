/*
 * XREFs of PopCompleteNotifyTransitionCommon @ 0x140165460
 * Callers:
 ...
 *     PopPrepChildWake @ 0x140165790 (PopPrepChildWake.c)
 *     PopReadyParentSleep @ 0x1401657FC (PopReadyParentSleep.c)
 *     PopReadyChildWake @ 0x14016587C (PopReadyChildWake.c)
...
LONG __fastcall PopCompleteNotifyTransitionCommon(__int64 a1, __int64 *a2, int a3, __int64 a4)
{
  ...
  v9 = 0;
  v10 = 0;
  KeAcquireInStackQueuedSpinLock((PKSPIN_LOCK)qword_140442F70 + 1, &LockHandle);
  v13 = v5 + 48;
  v14 = (__int64 *)*a2;
