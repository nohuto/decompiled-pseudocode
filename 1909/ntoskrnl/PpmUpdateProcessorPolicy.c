/*
 * XREFs of PpmUpdateProcessorPolicy @ 0x14074760C
 * Callers:
  ...
  if ( LOWORD(v14[0]) )
  {
    ...
    if ( !PpmPerfControlStartPolicyUpdate || (started = PpmPerfControlStartPolicyUpdate(), started >= 0) )
    {
      ...
      while ( (__int64 *)a2 != v8 )
      {
        ...
        {
          v10 = *(_QWORD *)(a2 + 208) + 136LL * i;
          if ( *(_BYTE *)(v10 + 16) )
            PpmUpdateTargetProcessorPolicy(a2, *(_QWORD *)(v10 + 8), v14, (__int64)(v5 + 5), 0LL);
        }
        a2 = *(_QWORD *)a2;
      }
