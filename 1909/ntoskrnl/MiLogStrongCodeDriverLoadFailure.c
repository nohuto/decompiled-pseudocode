/*
 * XREFs of MiLogStrongCodeDriverLoadFailure @ 0x14088A4A4
 * Callers:
  ...
  if ( hProvider )
  {
    if ( hProvider->LevelPlus1 > 5 )
    {
      if ( TlgKeywordOn(hProvider, 0x400000000000uLL) )
      {
        ...
        v24 = 4;
        v27 = 4;
        TlgWriteEx(v6, &unk_14038D9FD, v5, (ULONG)v6, v12, v13, 7u, &pData);
      }
    }
  }
  else
  {
    ...
    if ( PoolWithTag )
    {
      ...
      *(_DWORD *)(v9 + 44) = *(_DWORD *)(a2 + 156);
      v11 = (__int64 *)qword_140464610;
      if ( *(PVOID **)qword_140464610 != &qword_140464608 )
        __fastfail(3u);
      *(_QWORD *)v9 = &qword_140464608;
      *(_QWORD *)(v9 + 8) = v11;
      *v11 = v9;
      qword_140464610 = v9;
    }
