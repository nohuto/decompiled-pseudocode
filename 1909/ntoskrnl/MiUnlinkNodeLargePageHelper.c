/*
 * XREFs of MiUnlinkNodeLargePageHelper @ 0x1400F8050
 * Callers:
...
__int64 __fastcall MiUnlinkNodeLargePageHelper(_QWORD *a1, __int64 a2, unsigned int a3, unsigned int a4, char a5)
{
  ...
  v10 = *(_QWORD *)(qword_140465E88 + 8 * ((*(_QWORD *)(a2 + 40) >> 40) & 0x3FFLL));
  if ( v9 == 1 )
  {
  ...
  *(_QWORD *)(a2 + 8) = 0LL;
  ...
  v23 = (unsigned int)dword_140465840[v6];
  if ( v23 == 16 )
    LODWORD(v22) = v22 & 0xF;
  else
    v22 %= v23;
  ...
  if ( dword_140465F0C == 1 )
  {
    ...
    v29 = v9;
    v30 = (volatile signed __int32 *)(qword_140465F68 + 4 * (v18 >> 5));
    if ( v28 + v9 > 0x20 )
    {
      if ( (v18 & 0x1F) != 0 )
      {
        _InterlockedOr(v30, ((1 << (32 - (v18 & 0x1F))) - 1) << v28);
        v29 = v9 - (32 - (unsigned int)(v18 & 0x1F));
        ++v30;
      }
      if ( v29 >= 0x20 )
      {
...
LABEL_17:
  ...
  else if ( !(_DWORD)v20 && (MiFlags & 0x80u) != 0 && (++dword_14046600C & MmPageValidationFrequency) == 0 )
  {
