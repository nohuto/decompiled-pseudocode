/*
 * XREFs of RtlRemoveUnicodePrefix @ 0x1406B4DC0
 * Callers:
 *     <none>
 * Callees:
...
void __stdcall RtlRemoveUnicodePrefix(PUNICODE_PREFIX_TABLE PrefixTable, PUNICODE_PREFIX_TABLE_ENTRY PrefixTableEntry)
{
  ...
  struct _UNICODE_PREFIX_TABLE_ENTRY *v18; // r8
  struct _UNICODE_PREFIX_TABLE_ENTRY *v19; // rcx
  RTL_SPLAY_LINKS *v20; // rax
  struct _UNICODE_PREFIX_TABLE_ENTRY *v21; // r8
  struct _UNICODE_PREFIX_TABLE_ENTRY *NextPrefixTree; // r8
  struct _UNICODE_PREFIX_TABLE_ENTRY *n; // r9
  ...
  if ( PrefixTableEntry->NodeTypeCode >= 2049 )
  {
    ...
    else
    {
      ...
      else
      {
        ...
        v21 = (struct _UNICODE_PREFIX_TABLE_ENTRY *)PrefixTableEntry->Links.Parent;
        if ( v21 == (struct _UNICODE_PREFIX_TABLE_ENTRY *)&PrefixTableEntry->Links )
        {
          v20->Parent = v20;
