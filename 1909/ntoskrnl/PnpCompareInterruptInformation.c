/*
 * XREFs of PnpCompareInterruptInformation @ 0x140747BC0
 * Callers:
...
char __fastcall PnpCompareInterruptInformation(__int64 a1, const void *a2, unsigned int a3)
{
  ...
  if ( v5 )
  {
    if ( *v5 == a3 )
    {
      ...
      if ( v3 != v4 && stru_140425D20.LevelPlus1 > 5 )
      {
        ...
        if ( (_BYTE)v3 )
        {
          ...
          v20 = &v13;
          v24 = 2;
          LOBYTE(v3) = TlgWrite(&stru_140425D20, &unk_14038CFB5, 0LL, 0LL, 7u, &pData);
        }
      }
    }
    else if ( stru_140425D20.LevelPlus1 > 5 )
    {
      ...
      if ( (_BYTE)v3 )
      {
        ...
        v20 = v14;
        v24 = 2;
        LOBYTE(v3) = TlgWrite(&stru_140425D20, &unk_14038CF5E, 0LL, 0LL, 7u, &pData);
      }
    }
  }
  else if ( stru_140425D20.LevelPlus1 > 5 )
  {
    ...
    if ( (_BYTE)v3 )
    {
      ...
      v17 = &v21;
      v18 = 2;
      LOBYTE(v3) = TlgWrite(&stru_140425D20, &unk_14038D00C, 0LL, 0LL, 5u, &pData);
    }
  }
  return v3;
}
