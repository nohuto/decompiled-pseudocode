/*
 * XREFs of KeInitSystem @ 0x1409FD758
 * Callers:
 ...
 *     KiInitDynamicTraceSupport @ 0x1409FEA8C (KiInitDynamicTraceSupport.c)
 *     KeInitializeSchedulerAssist @ 0x140A22BC4 (KeInitializeSchedulerAssist.c)
 */
    ...
    if ( a1 != 1 )
    {
      ...
      if ( (HvlpFlags & 0x100000) != 0 )
      {
        ...
        if ( PoolWithTag )
        {
          ...
          qword_140446AF8 = (__int64)KiEpfCompletionDpcRoutine;
          qword_140446B00 = 0LL;
          qword_140446B18 = 0LL;
          qword_140446AF0 = 0LL;
