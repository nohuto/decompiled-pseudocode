/*
 * XREFs of PfSnAsyncPrefetchWorker @ 0x14066EA90
 * Callers:
 *     <none>
 * Callees:
 ...
 *     PfSnAsyncPrefetchStep @ 0x140697D2C (PfSnAsyncPrefetchStep.c)
...
LABEL_21:
  ...
  _InterlockedDecrement(&dword_140467A30);
  if ( v4 )
    PfSnPowerBoost((PEX_RUNDOWN_REF)P + 5);
