/*
 * XREFs of sub_14090C800 @ 0x14090C800
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall sub_14090C800(_DWORD *a1, _DWORD *a2, unsigned int a3, _DWORD *a4, _BYTE *a5)
{
  int v9; // eax
...
LABEL_18:
  ...
  {
    *a5 = 1;
    return (unsigned int)sub_14072D380(a1, a2, a3, a4, 4);
  }
  else
  {
    v15 = -1073741772;
