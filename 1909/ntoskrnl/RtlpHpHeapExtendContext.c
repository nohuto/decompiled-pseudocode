/*
 * XREFs of RtlpHpHeapExtendContext @ 0x140137198
 * Callers:
 *     RtlpHpSegLfhExtendContext @ 0x140137180 (RtlpHpSegLfhExtendContext.c)
 * Callees:
...
LABEL_56:
      ...
      {
LABEL_27:
        if ( ($C6908ADE9723D0A04AF8EE82D8D15C40 *)CurrentThread->ApcState.ApcListHead[0].Flink != &CurrentThread->152 )
...
LABEL_86:
    ...
    if ( v21 && ($C6908ADE9723D0A04AF8EE82D8D15C40 *)v37->ApcState.ApcListHead[0].Flink != &v37->152 )
