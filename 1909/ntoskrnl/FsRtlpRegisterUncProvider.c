/*
 * XREFs of FsRtlpRegisterUncProvider @ 0x140781004
 * Callers:
 *     FsRtlRegisterUncProviderEx2 @ 0x140780FE0 (FsRtlRegisterUncProviderEx2.c)
 *     FsRtlRegisterUncProvider @ 0x14084E2E0 (FsRtlRegisterUncProvider.c)
 *     FsRtlRegisterUncProviderEx @ 0x14084E320 (FsRtlRegisterUncProviderEx.c)
 * Callees:
