/*
 * XREFs of PopRequestRead @ 0x1405AD11C
 * Callers:
 *     PopRestoreHiberContext @ 0x140599360 (PopRestoreHiberContext.c)
 *     PopDecompressCallback @ 0x1405ACB50 (PopDecompressCallback.c)
 * Callees:
 ...
 *     PopGetIoLocation @ 0x14059A450 (PopGetIoLocation.c)
    ...
    do
    {
      if ( v8 )
      {
        if ( v8 != 1 )
        {
          ...
          v9 = __rdtsc();
          qword_140443608 += v9 - *(_QWORD *)(BugCheckParameter3 + 336);
          ...
          v10 = __rdtsc();
          qword_140443638 += (((unsigned __int64)HIDWORD(v10) << 32) | (unsigned int)v10) - v9;
        ...
        v17 = __rdtsc();
        qword_140443630 += (((unsigned __int64)HIDWORD(v17) << 32) | (unsigned int)v17) - v14;
...
LABEL_34:
        ...
        v28 = __rdtsc();
        qword_140443630 += (((unsigned __int64)HIDWORD(v28) << 32) | (unsigned int)v28)
