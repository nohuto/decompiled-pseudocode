/*
 * XREFs of RtlpSetTimeZoneInformationWorker @ 0x1408D315C
 * Callers:
 *     ExpRefreshTimeZoneInformation @ 0x1407643E8 (ExpRefreshTimeZoneInformation.c)
 *     RtlSetDynamicTimeZoneInformation @ 0x1408D3120 (RtlSetDynamicTimeZoneInformation.c)
 *     RtlSetTimeZoneInformation @ 0x1408D3140 (RtlSetTimeZoneInformation.c)
