/*
 * XREFs of PsLoadVsmEnclaveData @ 0x140309C48
 * Callers:
...
LABEL_26:
      ...
      if ( (__int64)v26->LockState.LockState < 0 )
        KiAbEntryRemoveFromTree((__int64)&v20->LockEntries[v25]);
...
LABEL_33:
      ...
      if ( v27 && ($C6908ADE9723D0A04AF8EE82D8D15C40 *)v20->ApcState.ApcListHead[0].Flink != &v20->152 )
