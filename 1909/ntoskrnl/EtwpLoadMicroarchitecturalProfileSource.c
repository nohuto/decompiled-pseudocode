/*
 * XREFs of EtwpLoadMicroarchitecturalProfileSource @ 0x1408F7ED0
 * Callers:
...
__int64 __fastcall EtwpLoadMicroarchitecturalProfileSource(const WCHAR *a1, unsigned __int16 *a2, const wchar_t *a3)
{
  ...
  v20 = 4;
  v21 = &v13;
  result = RtlpQueryRegistryValues(0x40000000u, a1, (__int64)v22, 0LL);
  if ( (int)result < 0 )
    return result;
  if ( v10 == -1 || v11 == -1 )
    return 3221225473LL;
  ...
  *((_BYTE *)v9 + 176) = 1;
  *((_DWORD *)v9 + 1) = v12;
  ((void (__fastcall *)(__int64, _QWORD, wchar_t *))off_1404267A0[0])(20LL, 2 * v6 + 178, v9);
