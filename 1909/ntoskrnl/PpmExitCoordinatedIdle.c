/*
 * XREFs of PpmExitCoordinatedIdle @ 0x140033070
 * Callers:
 ...
 *     PpmUpdatePlatformIdleAccounting @ 0x1402F0884 (PpmUpdatePlatformIdleAccounting.c)
          ...
          && (unsigned __int8)PpmExitCoordinatedIdleState(v20 + 256, v28, i) )
        {
          ...
          *(_DWORD *)(*(_QWORD *)(a2 + 16) + 4 * v9) = v18;
          ...
          if ( !v22 )
          {
            ...
            if ( (_BYTE)i )
            {
              PopDiagTraceIdleWakeSource(v14, v27, v23, a8);
              v27 = v30;
            }
            if ( a4 < 0 && v28[0] )
            {
