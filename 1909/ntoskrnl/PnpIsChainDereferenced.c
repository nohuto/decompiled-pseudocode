/*
 * XREFs of PnpIsChainDereferenced @ 0x140172DE8
 * Callers:
 ...
 *     PnpUpdateExtensionFlags @ 0x140172F0C (PnpUpdateExtensionFlags.c)
 *     PnpIsAnyDeviceInUse @ 0x140172F3C (PnpIsAnyDeviceInUse.c)
