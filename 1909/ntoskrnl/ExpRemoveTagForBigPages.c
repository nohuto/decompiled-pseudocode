/*
 * XREFs of ExpRemoveTagForBigPages @ 0x14033918C
 * Callers:
        ...
        _BYTE *a8)
{
  ...
  if ( (v10 & 0x20) != 0 )
  {
    v13 = *(_QWORD *)(qword_1404656D8 + 1272);
    v14 = (volatile signed __int32 *)(qword_1404656D8 + 1144);
    v15 = *(_QWORD *)(qword_1404656D8 + 1280);
  }
  else
  {
