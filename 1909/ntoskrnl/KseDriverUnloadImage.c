/*
 * XREFs of KseDriverUnloadImage @ 0x1407483A8
 * Callers:
    ...
    if ( v8 )
    {
      do
      {
        ...
        if ( !*((_DWORD *)v12 + 6) )
        {
          ...
          dword_140446564[2 * v13] = -1073740768;
          KsepHistoryErrors[2 * v13] = 460155;
...
LABEL_43:
    ...
    *(_QWORD *)(v18 + 8) = v19;
    ...
    if ( *v7 )
    {
      ...
      do
      {
        ...
        if ( (*(_DWORD *)(v23 + 28) & 4) != 0 && !*(_DWORD *)(v23 + 24) )
        {
          ...
          LODWORD(KsepHistoryMessages[v25]) = 460212;
    ...
    LODWORD(KsepHistoryMessages[v27]) = 460220;
    if ( (KsepDebugFlag & 1) != 0 )
