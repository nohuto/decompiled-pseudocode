/*
 * XREFs of PopDiagTracePerfTrackData @ 0x140726A34
 * Callers:
...
char __fastcall PopDiagTracePerfTrackData(__int16 a1)
{
  ...
  if ( PopDiagHandleRegistered )
  {
    ...
    if ( result )
    {
      ...
      v35 = PopQpcTimeInMs(&qword_1404434C0, &qword_1404434C8);
      v34 = PopQpcTimeInMs(&qword_1404434B0, &qword_1404434B8);
      if ( qword_1404434A8 )
      {
        v33 = 0LL;
        v30 = PopQpcTimeInMs(&v33, &qword_1404434A8);
        v28 = v30 + PopQpcTimeInMs(&qword_140443488, &qword_140443490);
        *(_QWORD *)&UserData.Size = 4LL;
        UserData.Ptr = (ULONGLONG)&qword_140443668;
        v44 = &v28;
        v46 = &v30;
        v48 = &v34;
        v50 = &v35;
      ...
      result = dword_1404436B0;
      if ( dword_1404436B0 )
      {
        v4 = qword_140443518;
        v31 = (4 * dword_1404436B0) & 0x3FFFFF;
        v37 = qword_140443518;
        v32 = qword_1404434F0 / v3;
        result = qword_1404436C0;
        v28 = qword_1404436C0;
        if ( (a1 & 8) != 0 )
        {
          if ( !PopShutdownButtonPressTime )
            return result;
          v29 = PopQpcTimeInMs(&PopShutdownButtonPressTime, &qword_140443468) + v4;
          if ( (int)PopReadRegKeyValue(
            ...
            v5 = PopQpcTimeInMs(&v33, &qword_140443520);
          v36 = v5;
          *(_QWORD *)&UserData.Size = 4LL;
          ...
          PopComputeDerivedHiberStats(&qword_1404434D8, v3, &v38);
          LODWORD(v40) = v28;
          v6 = (unsigned __int64)qword_140443698 >> 8;
          HIWORD(v40) = -1;
          if ( (unsigned __int64)qword_140443698 >> 8 > 0x7FFF )
            LOWORD(v6) = 0x7FFF;
          WORD2(v40) = v6 & 0x7FFF;
          if ( (unsigned __int64)qword_1404436A0 >> 8 <= 0xFFFF )
            HIWORD(v40) = (unsigned int)qword_1404436A0 >> 8;
          LOWORD(v41) = -1;
          if ( qword_140443538 / v3 <= 0xFFFF )
            LOWORD(v41) = qword_140443538 / v3;
          WORD1(v41) = -1;
          if ( qword_140443628 / v3 <= 0xFFFF )
            WORD1(v41) = qword_140443628 / v3;
          WORD2(v41) = -1;
          if ( (unsigned int)qword_140443528 <= 0xFFFF )
            WORD2(v41) = qword_140443528;
          HIWORD(v41) = -1;
          if ( (unsigned int)qword_140443668 <= 0xFFFF )
            HIWORD(v41) = qword_140443668;
          v7 = HIDWORD(v38);
          HIWORD(v42) = -1;
          ...
          v10 = (qword_1404435B8 - qword_1404435F0) / v3;
          if ( v10 > 0x1FFF )
            LODWORD(v10) = 0x1FFF;
          v11 = ((_DWORD)v10 << 19) | v9 & 0x7FFFF;
          v12 = (unsigned __int64)qword_140443678 >> 8;
          LODWORD(v42) = v11;
          if ( (unsigned __int64)qword_140443678 >> 8 > 0x7FFF )
            LOWORD(v12) = 0x7FFF;
          WORD2(v42) = v12 & 0x7FFF;
          if ( (unsigned __int64)qword_140443680 >> 8 <= 0xFFFF )
            HIWORD(v42) = (unsigned int)qword_140443680 >> 8;
        ...
        *(_QWORD *)&UserData.Size = 4LL;
        ...
        v17 = qword_140443528;
        if ( (_DWORD)qword_140443528 )
        {
          PopComputeDerivedHiberStats(&qword_1404434D8, v3, &v38);
          LODWORD(v40) = v28;
          v18 = (unsigned __int64)qword_140443698 >> 8;
          if ( (unsigned __int64)qword_140443698 >> 8 > 0x7FFF )
            LOWORD(v18) = 0x7FFF;
          ...
          v22 = (qword_1404435B8 - qword_1404435F0) / v3;
          if ( v22 > 0x1FFF )
            LODWORD(v22) = 0x1FFF;
          LODWORD(v42) = v21 & 0x7FFFF | ((_DWORD)v22 << 19);
          v23 = (unsigned __int64)qword_140443678 >> 8;
          if ( (unsigned __int64)qword_140443678 >> 8 > 0x7FFF )
            LOWORD(v23) = 0x7FFF;
