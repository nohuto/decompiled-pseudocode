/*
 * XREFs of MiRevertValidPte @ 0x14004F990
 * Callers:
...
LABEL_143:
  ...
  {
    v20 = HIBYTE(word_1404658EC);
    goto LABEL_22;
  }
  if ( (unsigned int)MiGetSystemRegionType(v19) != 1 && (v55 < 0xFFFFF68000000000uLL || v55 > v54) )
  {
    if ( v55 < qword_1404672B0 || (v20 = HIBYTE(word_1404658EC), v55 > qword_140465BE0) )
      v20 = (unsigned __int8)word_1404658EC;
    v16 = v65;
LABEL_22:
    if ( !v20 )
      goto LABEL_23;
...
LABEL_23:
  ...
  if ( (v9 & 0x40000000) != 0 )
    v18 &= ~4uLL;
  if ( (v9 & 0x20000000) != 0 )
    v18 ^= ((unsigned __int16)v18 ^ (unsigned __int16)((unsigned __int8)word_1404658EC << 8)) & 0x100;
  if ( (v9 & 0x8000000) != 0 )
    v18 &= ~0x100uLL;
  if ( (v9 & 0x4000000) != 0 )
    v18 |= 0x80uLL;
      ...
      if ( (*(_DWORD *)(a1 + 48) & 0x70) != 0x40 || (result = MiRotatedToFrameBuffer(a2), (_DWORD)result) )
      {
        ...
        if ( (v39 & 0x10) == 0 )
        {
          ...
          *(_BYTE *)(v37 + 34) = v39 | 0x10;
          if ( result )
            v38 = *(_QWORD *)(qword_140465E88 + 8 * ((*(_QWORD *)(v37 + 40) >> 40) & 0x3FFLL));
        }
