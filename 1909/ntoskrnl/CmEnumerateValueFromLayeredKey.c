/*
 * XREFs of CmEnumerateValueFromLayeredKey @ 0x14082750C
 * Callers:
        ...
        __int64 a6)
{
  ...
  __int64 v29[4]; // [rsp+60h] [rbp-89h] BYREF
  __int64 v30; // [rsp+80h] [rbp-69h]
  size_t Size; // [rsp+88h] [rbp-61h]
  int v32[24]; // [rsp+90h] [rbp-59h] BYREF
  ...
  WORD1(v29[0]) = -1;
  v8 = 0;
  CmpValueEnumStackInitialize(v32);
  v9 = *(_QWORD *)(a1 + 8);
  ...
  {
LABEL_15:
    KcbAtLayerHeight = v29[1];
    v21 = v29[1];
    KeyNodeForKcb = CmpGetKeyNodeForKcb(v29[1], (__int64)&v25, 0);
    v11 = KeyNodeForKcb;
  ...
  started = CmpValueEnumStackStartFromKcbStack(v32, v29);
  if ( started < 0 )
    goto LABEL_22;
  started = CmpValueEnumStackAdvance(v32);
  if ( started < 0 )
    goto LABEL_22;
  v19 = 0;
  if ( !(_DWORD)v7 )
...
LABEL_14:
    v20 = v32[0];
    v21 = CmpGetKcbAtLayerHeight((__int64)v29, SHIWORD(v32[1]));
LABEL_18:
    v23 = (*(__int64 (__fastcall **)(_QWORD, _QWORD, __int64 *))(*(_QWORD *)(v21 + 32) + 8LL))(
            *(_QWORD *)(v21 + 32),
            v20,
            &v27);
    started = CmpQueryKeyValueData(v21, v20, v23, v28, (_DWORD *)Size, a5, (int *)v30);
    if ( started >= 0 )
      started = 0;
    v11 = 0LL;
    if ( v23 )
...
LABEL_22:
  ...
  if ( v29[3] )
    CmSiFreeMemory((PPRIVILEGE_SET)v29[3]);
