/*
 * XREFs of MiUpControlAreaRefs @ 0x1402BA560
 * Callers:
...
LABEL_41:
  ...
  __writecr8(v16);
  if ( v10 )
    MiReturnCrossPartitionSectionCharges(*(_QWORD *)(qword_140465E88 + 8LL * (*(_WORD *)(v4 + 60) & 0x3FF)), v34, v10);
  if ( !*(_QWORD *)(v4 + 64) )
  {
    v22 = v37 + 40;
        ...
        if ( v30->LockState.0 )
        {
          if ( v30 )
          {
            ...
            if ( (__int64)v30->LockState.LockState < 0 )
              KiAbEntryRemoveFromTree((__int64)&v23->LockEntries[v29]);
...
LABEL_67:
    ...
    if ( v9 && ($C6908ADE9723D0A04AF8EE82D8D15C40 *)v23->ApcState.ApcListHead[0].Flink != &v23->152 )
