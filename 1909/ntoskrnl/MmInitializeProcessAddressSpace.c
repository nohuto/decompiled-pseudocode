/*
 * XREFs of MmInitializeProcessAddressSpace @ 0x140685748
 * Callers:
 ...
 *     MiInitializeProcessPageTableCommitmentBitMaps @ 0x1400EA4FC (MiInitializeProcessPageTableCommitmentBitMaps.c)
