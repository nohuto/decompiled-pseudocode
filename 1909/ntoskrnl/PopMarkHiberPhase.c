/*
 * XREFs of PopMarkHiberPhase @ 0x1405ACE94
 * Callers:
...
void __fastcall PopMarkHiberPhase(unsigned int *Address)
{
  ...
  PoSetHiberRange(0LL, 0x10000u, qword_1404433D0, Length, 0);
  ...
  PoSetHiberRange(0LL, 0x10000u, qword_140443398, (unsigned int)dword_1404433A0, 0);
