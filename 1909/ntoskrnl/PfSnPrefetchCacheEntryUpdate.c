/*
 * XREFs of PfSnPrefetchCacheEntryUpdate @ 0x1406A74BC
 * Callers:
...
_QWORD *__fastcall PfSnPrefetchCacheEntryUpdate(__int64 a1)
{
  ...
  ExAcquireResourceExclusiveLite(&stru_140467A60, 1u);
  v8 = qword_140467A50 - 16;
  if ( !memcmp((const void *)(qword_140467A50 - 16 + 32), v1, 0x40uLL)
    || (v8 = PfSnPrefetchCacheEntryGet((__int64)&unk_140467A38, v1, v4, 0LL)) != 0 )
  {
    *(_DWORD *)(v8 + 112) = *(_DWORD *)(a1 + 68);
  }
  ExReleaseResourceLite(&stru_140467A60);
