/*
 * XREFs of MmAllocateSecureKernelPages @ 0x1402DCE20
 * Callers:
...
ULONG_PTR *__fastcall MmAllocateSecureKernelPages(ULONG_PTR **a1, __int64 a2, unsigned int a3, int a4, _DWORD *a5)
{
  ...
  ULONG_PTR PartitionNodePagesForMdl; // rsi
  __int64 *v12; // rbp
  __int64 *v13; // r14
  __int64 v14; // r15
  ...
  *a5 = 0;
  ...
  if ( (*((_DWORD *)result + 1) & 8) != 0 )
  {
    ...
    PoolWithTag = (char *)ExAllocatePoolWithTag(NonPagedPoolNx, 8 * v6 + 48, 0x69646D4Du);
    v29 = (ULONG_PTR)PoolWithTag;
    PartitionNodePagesForMdl = (ULONG_PTR)PoolWithTag;
    if ( PoolWithTag )
    {
      v12 = (__int64 *)(PoolWithTag + 48);
      v26 = 64;
      v13 = v12;
      v14 = 8 * v6;
      v15 = (unsigned __int64)&PoolWithTag[8 * v6 + 48];
      v28 = (__int64 *)v15;
      if ( (unsigned __int64)v12 < v15 )
      {
        ...
        do
        {
          SlabPage = MiGetSlabPage(v9, v16, 0, &v27, 0);
          *v13 = SlabPage;
          if ( SlabPage == -1 )
          {
            if ( !v27 )
