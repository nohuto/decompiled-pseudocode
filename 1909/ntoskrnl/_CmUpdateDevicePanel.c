/*
 * XREFs of _CmUpdateDevicePanel @ 0x14070137C
 * Callers:
 ...
 *     _CmGetDevicePanelGroup @ 0x14078C19C (_CmGetDevicePanelGroup.c)
...
__int64 __fastcall CmUpdateDevicePanel(__int64 a1, const WCHAR *a2, __int64 a3)
{
  ...
  unsigned int v68; // [rsp+A8h] [rbp-58h]
  PVOID v69; // [rsp+B0h] [rbp-50h]
  PVOID v70; // [rsp+B8h] [rbp-48h]
  PVOID v71; // [rsp+C0h] [rbp-40h] BYREF
  void *v72; // [rsp+C8h] [rbp-38h] BYREF
  int v73[4]; // [rsp+D0h] [rbp-30h] BYREF
  ...
  if ( DevicePanelPldProperty >= 0 )
  {
    ...
    {
      v63 = 200;
      DeviceParent = CmGetDeviceParent(v3, a2, (wchar_t *)PoolWithTag, &v63);
      if ( DeviceParent < 0 )
        goto LABEL_27;
      ...
      if ( (unsigned int)v24 < 7 )
        v23 = dword_140389730[v24];
      v65 = v23;
      v25 = (wchar_t *)ExAllocatePoolWithTag(v20, 0x72uLL, 0x52504E50u);
      v5 = v25;
      if ( !v25 )
        goto LABEL_102;
      DeviceParent = CmBuildDevicePanelId(v75, DevicePanelGroup, v65, v25);
      if ( DeviceParent < 0 )
        goto LABEL_27;
      v26 = 16;
      for ( i = 16LL; ; i = v57 )
...
LABEL_13:
          ...
          PnpSetObjectProperty(v3, (_DWORD)a2, 1, 0LL, (__int64)v29, 0, 0LL, 0, 0);
LABEL_15:
...
LABEL_18:
            ...
            v74 = 2;
            *(_OWORD *)v73 = DEVPKEY_Device_PhysicalDeviceLocationPanel;
            v77 = 2;
            v76 = DEVPKEY_Device_PhysicalDeviceLocationJoint;
            while ( 2 )
            {
              DeviceParent = CmQueryDevicePanelPldProperty(
                               v3,
                               (int)a2,
                               a3,
                               (int)v73,
              ...
              if ( !v63 )
              {
                ...
                if ( !v31 )
                  goto LABEL_224;
                v63 = 200;
                DeviceParent = CmGetDeviceParent(v3, a2, (wchar_t *)v31, &v63);
                if ( DeviceParent < 0 )
                  goto LABEL_25;
                DeviceParent = PnpGetObjectProperty(
                                 v3,
              ...
              if ( v35 < 7 )
                v34 = (unsigned int)dword_140389730[v35];
              v65 = v34;
              if ( v5 )
              {
LABEL_154:
                DeviceParent = CmBuildDevicePanelId(v75, v33, v34, v5);
                if ( DeviceParent >= 0 )
                {
                  DevicePanel = CmCreateDevicePanel(v3, (_DWORD)v5, v36, (unsigned int)&v72, (__int64)&v55);
                  v6 = v72;
...
LABEL_221:
                          PnpSetObjectProperty(v3, (_DWORD)v5, 6, 0LL, (__int64)v53, 0, 0LL, 0, 0);
                          goto LABEL_222;
                        }
                        v54 = (*v40 >> 5) & 0xF;
                        DeviceParent = PnpSetObjectProperty(
                        ...
                        if ( v70 || (v70 = ExAllocatePoolWithTag(PagedPool, 0x72uLL, 0x52504E50u), (v43 = v70) != 0LL) )
                        {
                          ...
                          if ( ((*(_DWORD *)v62 >> 20) & 7) != 7 )
                            v44 = (unsigned int)dword_140389730[(*(_DWORD *)v62 >> 20) & 7];
                          v54 = v44;
                          DeviceParent = CmBuildDevicePanelId(v75, (unsigned __int8)(*(_DWORD *)v62 >> 12), v44, v43);
                          if ( DeviceParent < 0 )
                            goto LABEL_25;
                          v45 = -1LL;
                          do
                          ...
                          if ( v50 == 32 )
                          {
                            ...
                            if ( (int)PnpSetObjectProperty(
                                        ...
                                        0) < 0 )
                              goto LABEL_222;
                            v54 = *((unsigned __int16 *)v49 + 3) + (unsigned __int16)v49[1];
                            if ( (int)PnpSetObjectProperty(
                                        v3,
                                        (_DWORD)v5,
                                        6,
                          ...
                          else
                          {
                            ...
                            if ( (int)PnpSetObjectProperty(
                                        ...
                                        0) < 0 )
                              goto LABEL_222;
                            v51 = *((unsigned __int16 *)v49 + 3) + (unsigned __int16)v49[1];
                            if ( v51 > 0x168 )
                              v51 = 360;
                            v54 = v51;
                            if ( (int)PnpSetObjectProperty(
