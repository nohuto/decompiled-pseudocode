/*
 * XREFs of KiGetNextTimerExpirationDueTime @ 0x14009CE30
 * Callers:
 *     PpmIdlePrepare @ 0x1400330E0 (PpmIdlePrepare.c)
 *     KePrepareClockTimerForIdle @ 0x140111FD0 (KePrepareClockTimerForIdle.c)
 *     KeEstimateClockTickDuration @ 0x14018AB5C (KeEstimateClockTickDuration.c)
 * Callees:
...
LABEL_8:
  if ( *(_BYTE *)(a1 + 33) )
  {
    ...
    do
    {
      if ( qword_14044D730[3 * v14] < v16 )
      {
        v16 = qword_14044D730[3 * v14];
        if ( v14 == 3 )
          v15 = 1;
      }
      ++v14;
