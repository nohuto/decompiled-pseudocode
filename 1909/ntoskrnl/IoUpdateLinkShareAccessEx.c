/*
 * XREFs of IoUpdateLinkShareAccessEx @ 0x14062CF20
 * Callers:
 *     IoUpdateShareAccess @ 0x14073D0C0 (IoUpdateShareAccess.c)
 *     IoUpdateLinkShareAccess @ 0x140856310 (IoUpdateLinkShareAccess.c)
 * Callees:
 *     <none>
 */
