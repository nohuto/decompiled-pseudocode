/*
 * XREFs of PopSetExecutionRequiredTimer @ 0x14078BC28
 * Callers:
...
__int64 PopSetExecutionRequiredTimer()
{
  ...
  if ( qword_140444BD8 && PopExecutionRequiredTimeout )
  {
    v0 = 10000000LL * (unsigned int)PopExecutionRequiredTimeout;
    if ( MEMORY[0xFFFFF78000000008] - qword_140444BD8 < v0 )
      v1 = MEMORY[0xFFFFF78000000008] - qword_140444BD8 - v0;
    else
      v1 = -10000000LL;
