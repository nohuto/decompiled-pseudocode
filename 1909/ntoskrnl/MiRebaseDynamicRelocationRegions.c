/*
 * XREFs of MiRebaseDynamicRelocationRegions @ 0x1409EFDA4
 * Callers:
...
__int64 __fastcall MiRebaseDynamicRelocationRegions(__int64 a1)
{
  ...
  v18 = qword_140467290;
  v6 = *v2;
  if ( (MiFlags & 0x8000) == 0 && qword_1404672D0 == 0xFFFFF68000000000uLL )
    goto LABEL_18;
  v7 = 0;
  if ( 8 * (((unsigned __int64)qword_1404672D0 >> 39) & 0x1FF) != 3944 )
  {
