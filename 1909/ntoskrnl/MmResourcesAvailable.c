/*
 * XREFs of MmResourcesAvailable @ 0x14003A6E0
 * Callers:
...
__int64 __fastcall MmResourcesAvailable(char a1, unsigned __int64 a2, int a3)
{
  ...
  __int64 v39; // rdx
  $C6908ADE9723D0A04AF8EE82D8D15C40 *v40; // rdx
  __int64 v41; // r8
  __int64 v42; // r9
  ...
  if ( (a1 & 1) == 0 )
  {
    v10 = MiState - qword_1404641C8;
    goto LABEL_4;
  }
  if ( (a1 & 0x20) == 0 )
  {
    v10 = qword_1404666B8 - qword_1404666A8;
LABEL_4:
    v11 = v10 << 12;
    goto LABEL_5;
  }
  ...
  if ( v18 <= v19 )
    v21 = 0LL;
  v11 = v20 + v21;
  v3 = *(ULONG_PTR **)(qword_140465E88 + 8LL * *(unsigned __int16 *)(v8 + 430));
LABEL_5:
  v12 = 0;
  if ( a3 == 16 )
    v13 = a2 + 0x80000;
...
LABEL_57:
      ...
      {
        v40 = &v30->152;
        if ( ($C6908ADE9723D0A04AF8EE82D8D15C40 *)v40->ApcState.ApcListHead[0].Flink != v40 )
