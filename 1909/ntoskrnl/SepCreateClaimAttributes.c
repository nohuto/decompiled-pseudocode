/*
 * XREFs of SepCreateClaimAttributes @ 0x14061D190
 * Callers:
...
LABEL_35:
      ...
      v8 = AuthzBasepSetSecurityAttributesToken(SecurityAttributesList, &v23, a2);
      if ( v8 < 0 )
        goto LABEL_25;
      v21 = 1;
    ...
    if ( a3 )
    {
      ...
      if ( !v17 )
        goto LABEL_37;
      v8 = AuthzBasepSetSecurityAttributesToken(v17, &v23, a3);
      if ( v8 < 0 )
        goto LABEL_25;
      v22 = 1;
