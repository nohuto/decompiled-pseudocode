/*
 * XREFs of KseInitialize @ 0x140A030C8
 * Callers:
...
LABEL_11:
  ...
  v11 = _InterlockedCompareExchange(&dword_140468164, 1, 0);
  if ( v11 == 2 )
    return 0LL;
  if ( v11 == 1 )
    return 259LL;
              ...
              *(unsigned int *)(*(_QWORD *)(a1 + 240) + 72LL)) >= 0 )
  {
    ...
    else
    {
      if ( ViVerifierEnabled )
        dword_140468168 |= 0x40u;
      if ( InitSafeBootMode )
        dword_140468168 |= 0x100u;
      v13 = *(_QWORD *)(a1 + 240);
