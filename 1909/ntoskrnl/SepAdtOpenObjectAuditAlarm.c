/*
 * XREFs of SepAdtOpenObjectAuditAlarm @ 0x1408DCA48
 * Callers:
 ...
 *     SepSecurityDescriptorStrictLength @ 0x1405B4FE4 (SepSecurityDescriptorStrictLength.c)
        ...
        __int64 a19)
{
  ...
  _QWORD v89[2]; // [rsp+4D8h] [rbp+3D0h] BYREF
  ...
  *(_QWORD *)&v87.ImpersonationLevel = 0LL;
  ...
  v71 = 0;
  v87.ClientToken = a7;
  if ( !(unsigned __int8)SepAdtAuditThisEventWithContext(0x7Bu, a12, a12 == 0, &v87) )
    return 1;
  v24 = v89;
  if ( a18 )
    v24 = a18;
...
LABEL_41:
    ...
    PoolWithTag = (char *)ExAllocatePoolWithTag(PagedPool, (unsigned int)v77, 0x70416553u);
    v48 = PoolWithTag;
    if ( !PoolWithTag )
    {
      v22 = Src;
