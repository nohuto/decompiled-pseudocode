/*
 * XREFs of ExRngInitializeSystem @ 0x140A1CB64
 * Callers:
...
__int64 ExRngInitializeSystem()
{
  ...
  memmove(ExpLeftoverBootRngData, (const void *)(v1 + v2 + 1424), 4LL * ((1024 - v1) >> 2));
  memset((void *)(v2 + 1424), 0, 0x400uLL);
