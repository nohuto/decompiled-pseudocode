/*
 * XREFs of MiInitializeCommitment @ 0x14019310C
 * Callers:
...
__int64 __fastcall MiInitializeCommitment(__int64 a1)
{
  ...
  *(_QWORD *)(a1 + 488) = a1 + 488;
  ...
  {
    v4 = 0LL;
    v5 = (unsigned int)dword_1404657B4;
    do
    {
      v6 = (__int64 *)(a1 + 4136);
      v7 = 2LL;
  ...
  *(_QWORD *)(a1 + 8128) = v3;
  ...
  if ( (ULONG_PTR *)a1 == &MiSystemPartition )
  {
    qword_140466730 = *(_QWORD *)(a1 + 8424);
    qword_140466730 -= qword_140466738;
    result = qword_140466758;
    qword_140466730 -= qword_140466758;
  }
  return result;
}
