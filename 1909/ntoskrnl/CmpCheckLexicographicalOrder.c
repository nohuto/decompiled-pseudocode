/*
 * XREFs of CmpCheckLexicographicalOrder @ 0x140664F10
 * Callers:
  ...
  *(_QWORD *)&String2.Length = 0LL;
  ...
  if ( (*(_BYTE *)(v6 + 2) & 0x20) == 0 )
  {
    ...
    if ( v10 )
    {
      ...
      if ( (int)CmpCompareCompressedName(&String2, v9, v19, 0LL) <= 0 )
      {
        v17 = -1073741492;
        goto LABEL_15;
      }
...
LABEL_14:
  ...
  if ( !v10 )
  {
    ...
    if ( (int)CmpCompareCompressedName(&String1, v6 + 76, v13, 0LL) >= 0 )
    {
      v17 = -1073741492;
      goto LABEL_15;
    }
