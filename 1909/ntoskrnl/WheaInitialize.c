/*
 * XREFs of WheaInitialize @ 0x140A03340
 * Callers:
 ...
 *     WheapQueryPshedForErrorSources @ 0x140A03AA8 (WheapQueryPshedForErrorSources.c)
...
__int64 __fastcall WheaInitialize(__int64 a1, unsigned int a2)
{
  ...
  if ( !a2 )
  {
    ...
    stru_1404F27F8.Header.WaitListHead.Blink = &stru_1404F27F8.Header.WaitListHead;
    qword_1404F27F0 = (__int64)&qword_1404F27E8;
    qword_1404F27E8 = (__int64)&qword_1404F27E8;
    stru_1404F27F8.Header.WaitListHead.Flink = &stru_1404F27F8.Header.WaitListHead;
    LOWORD(stru_1404F27F8.Header.Lock) = 1;
    stru_1404F27F8.Header.Size = 6;
    stru_1404F27F8.Header.SignalState = 1;
    ...
    if ( v59 )
    {
      do
      {
        v10 = qword_1405093D8[8 * (__int64)v8[2]](0LL, v8, 0LL);
        if ( v10 < 0 )
  ...
  qword_14042EB58 = (__int64)&WheapPrevErrList;
...
LABEL_71:
  ...
  if ( (unsigned __int64)&WheapConfigTableLock >= 0xFFFF800000000000uLL
    && byte_140467140[(((unsigned __int64)&WheapConfigTableLock >> 39) & 0x1FF) - 256] == 1 )
  {
...
LABEL_68:
  ...
  for ( j = qword_1404F27E8; (__int64 *)j != &qword_1404F27E8; j = *(_QWORD *)j )
  {
    if ( *(_DWORD *)(j + 104) == 7 )
    {
  ...
  v16 = qword_1404F27E8;
  v17 = 0;
  while ( (__int64 *)v16 != &qword_1404F27E8 )
  {
...
LABEL_46:
  ...
  if ( v18 && ($C6908ADE9723D0A04AF8EE82D8D15C40 *)v21->ApcState.ApcListHead[0].Flink != &v21->152 )
