/*
 * XREFs of CcSetDirtyInMask @ 0x14006F190
 * Callers:
...
char __fastcall CcSetDirtyInMask(struct _FAST_MUTEX *a1, __int64 *a2, unsigned int a3, struct _KTHREAD *a4)
{
  ...
  if ( ((v4 ^ v7) & 0xFFFFFFFFFE000000uLL) != 0 )
    KeBugCheckEx(0x34u, 0xC48uLL, 0xFFFFFFFFC0000420uLL, 0LL, 0LL);
  ...
  if ( (__int64)Flink / 4096 <= v10 )
    KeBugCheckEx(0x34u, 0xC5AuLL, 0xFFFFFFFFC0000420uLL, 0LL, 0LL);
  ...
  if ( *(_QWORD *)&a1[3].Count )
  {
    ...
    else
    {
      ...
      if ( _interlockedbittestandset(&dword_140464280, 0x1Fu) )
      {
        ...
        v110 = ExpWaitForSpinLockExclusiveAndAcquire(&dword_140464280, CurrentIrql);
      }
      v15 = dword_140464280;
      while ( (v15 & 0xBFFFFFFF) != 0x80000000 )
      {
        if ( (v15 & 0x40000000) == 0 )
        {
          v85 = _InterlockedCompareExchange(&dword_140464280, v15 | 0x40000000, v15);
          v27 = v15 == v85;
          v15 = v85;
          if ( !v27 )
            continue;
  ...
  for ( i = 0; ; i = 1 )
  {
    while ( 1 )
    {
      if ( v5->Event.Header.WaitListHead.Flink > (struct _LIST_ENTRY *)0x300000 )
      {
        ...
        {
          ++dword_1404F2CD8;
          InitializeMbcb = (PSLIST_ENTRY)((__int64 (__fastcall *)(_QWORD, _QWORD, _QWORD))qword_1404F2CF0)(
                                           (unsigned int)dword_1404F2CE4,
                                           (unsigned int)dword_1404F2CEC,
                                           (unsigned int)dword_1404F2CE8);
          if ( !InitializeMbcb )
          {
...
LABEL_141:
    ...
    if ( *(_QWORD *)&v5[3].Count )
    {
      ...
      if ( (BYTE6(PerfGlobalGroupMask) & 0x21) != 0 )
      {
        ExpAcquireSpinLockExclusiveAtDpcLevelInstrumented(&dword_140464280, v49);
      }
      else
      {
        ...
        if ( _interlockedbittestandset(&dword_140464280, 0x1Fu) )
        {
          ...
          v111 = ExpWaitForSpinLockExclusiveAndAcquire(&dword_140464280, v49);
        }
        v52 = dword_140464280;
        while ( (v52 & 0xBFFFFFFF) != 0x80000000 )
        {
          if ( (v52 & 0x40000000) == 0 )
          {
            v92 = _InterlockedCompareExchange(&dword_140464280, v52 | 0x40000000, v52);
            v27 = v52 == v92;
            v52 = v92;
            if ( !v27 )
              continue;
      ...
      if ( *(_QWORD *)v48 )
        v53 = *(ULONG_PTR **)(qword_140465E88 + 8LL * (*(_WORD *)(*(_QWORD *)v48 + 60LL) & 0x3FF));
      else
...
LABEL_94:
  ...
  {
    ++dword_1404F2CDC;
    if ( LOWORD(CcBitmapLookasideList.Alignment) >= (unsigned __int16)word_1404F2CD0 )
    {
      ++dword_1404F2CE0;
      LOBYTE(InitializeMbcb) = ((__int64 (*)(void))qword_1404F2CF8)();
    }
    else
    {
