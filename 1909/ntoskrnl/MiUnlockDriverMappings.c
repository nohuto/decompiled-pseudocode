/*
 * XREFs of MiUnlockDriverMappings @ 0x140155DC4
 * Callers:
...
__int64 __fastcall MiUnlockDriverMappings(__int64 a1)
{
  ...
  if ( (_InterlockedExchangeAdd64((volatile signed __int64 *)&qword_140464620, 0xFFFFFFFFFFFFFFFFuLL) & 6) == 2 )
    ExfTryToWakePushLock((volatile signed __int64 *)&qword_140464620);
  v14 = 0;
  CurrentThread = KeGetCurrentThread();
  if ( (unsigned int)MiGetSystemRegionType((unsigned __int64)&qword_140464620) == 1 )
  ...
  while ( 1 )
  {
    ...
    if ( (v10->AcquiredByte & 1) != 0
      ...
      && (*(_QWORD *)&v10->LockState.0 & 0x7FFFFFFFFFFFFFFCLL) == ((unsigned __int64)&qword_140464620 & 0x7FFFFFFFFFFFFFFCLL)
  ...
  if ( (*((_DWORD *)&CurrentThread->0 + 1) & 0x10000) == 0 )
    KeBugCheckEx(0x162u, (ULONG_PTR)CurrentThread, (ULONG_PTR)&qword_140464620, SessionId, 0LL);
LABEL_17:
  --CurrentThread->AbAllocationRegionCount;
  KiAbThreadRemoveBoosts((ULONG_PTR)CurrentThread, (__int64)&qword_140464620, &v14);
