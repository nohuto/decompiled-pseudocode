/*
 * XREFs of KiFloatingErrorFaultShadow @ 0x140350880
 * Callers:
 *     <none>
 * Callees:
 *     <none>
...
void __fastcall __noreturn KiFloatingErrorFaultShadow(__int64 a1, unsigned __int64 a2)
{
