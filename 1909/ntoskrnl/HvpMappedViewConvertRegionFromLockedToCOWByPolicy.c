/*
 * XREFs of HvpMappedViewConvertRegionFromLockedToCOWByPolicy @ 0x14072C5F0
 * Callers:
 *     HvpMappedViewConvertLockedPagesToCOWByPolicy @ 0x1407359DC (HvpMappedViewConvertLockedPagesToCOWByPolicy.c)
 * Callees:
