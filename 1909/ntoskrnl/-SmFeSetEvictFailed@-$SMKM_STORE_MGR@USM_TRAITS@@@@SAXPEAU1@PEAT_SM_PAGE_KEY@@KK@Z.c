/*
 * XREFs of ?SmFeSetEvictFailed@?$SMKM_STORE_MGR@USM_TRAITS@@@@SAXPEAU1@PEAT_SM_PAGE_KEY@@KK@Z @ 0x14031F980
 * Callers:
...
LABEL_28:
  ...
  if ( v20 && ($C6908ADE9723D0A04AF8EE82D8D15C40 *)v13->ApcState.ApcListHead[0].Flink != &v13->152 )
