/*
 * XREFs of RtlpLocateRelatedBlocks @ 0x14031A020
 * Callers:
...
LABEL_71:
    ...
    if ( v16 )
    {
      qword_14042AA78 = *(unsigned __int16 *)(a1 + 140) ^ (unsigned __int64)*(unsigned __int16 *)(v16 + 12);
      v25 = *(_DWORD *)(a1 + 124);
    }
    if ( v17 )
    {
    ...
    if ( qword_14042AA78 == (unsigned __int16)result )
    {
      result = *(unsigned __int16 *)(a1 + 140);
      if ( qword_14042AA80 != (result ^ *(unsigned __int16 *)(v17 + 16LL * v26 + 12)) )
        dword_14042AA38 = 7;
    }
    else
    {
