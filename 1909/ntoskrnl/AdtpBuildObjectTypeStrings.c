/*
 * XREFs of AdtpBuildObjectTypeStrings @ 0x14092DA40
 * Callers:
        ...
        _BYTE *a6)
{
  ...
  *(_QWORD *)&v23.Length = 0LL;
  v23.Buffer = 0LL;
  v8 = a4;
  RtlInitUnicodeString(DestinationString, &word_1403813FC);
  v9 = a6;
  *a6 = 0;
  if ( !(_DWORD)v8 )
    return 0LL;
  ...
  do
  {
    ...
    if ( *(_WORD *)v13 >= 4u )
      v17 = 3;
    appended = AdtpAppendZString((__int64)DestinationString, (__int64)v9, off_140376448[v17], &v22);
    if ( appended < 0 )
      return (unsigned int)appended;
    v21[0] = 0;
