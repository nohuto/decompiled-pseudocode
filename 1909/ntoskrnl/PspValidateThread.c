/*
 * XREFs of PspValidateThread @ 0x14009ED80
 * Callers:
...
__int64 __fastcall PspValidateThread(struct _KTHREAD *a1)
{
  if ( a1 != KeGetCurrentPrcb()->IdleThread )
  {
    if ( KeGetCurrentIrql() < 2u
      && (POBJECT_TYPE *)ObTypeIndexTable[(unsigned __int8)ObHeaderCookie ^ LOBYTE(a1[-1].TracingPrivate[0]) ^ (unsigned __int64)(unsigned __int8)((unsigned __int16)((_WORD)a1 - 48) >> 8)] != PsThreadType )
    {
      return 3221225485LL;
    }
