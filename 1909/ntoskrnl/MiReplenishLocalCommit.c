/*
 * XREFs of MiReplenishLocalCommit @ 0x1401259E0
 * Callers:
...
signed __int64 __fastcall MiReplenishLocalCommit(__int64 a1, __int64 a2, unsigned __int64 a3, __int64 a4)
{
  ...
  v5 = a3 + a4;
  result = _InterlockedCompareExchange64((volatile signed __int64 *)(a1 + 8424), a3 + a4, a3);
  if ( a3 == result )
  {
    v9 = *(_QWORD *)(a1 + 7200);
    if ( v5 >= v9 && a3 < v9 || (v10 = *(_QWORD *)(a1 + 7192), v5 >= v10) && a3 < v10 )
      MiSyncCommitSignals(a1, 0LL);
    if ( v5 > *(_QWORD *)(a1 + 7168) )
      *(_QWORD *)(a1 + 7168) = v5;
    ...
    v13 = _InterlockedExchangeAdd64((volatile signed __int64 *)(a1 + 8424), -a4);
    v14 = *(_QWORD *)(a1 + 7200);
