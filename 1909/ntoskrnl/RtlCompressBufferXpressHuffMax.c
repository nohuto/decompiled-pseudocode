/*
 * XREFs of RtlCompressBufferXpressHuffMax @ 0x140315C10
 * Callers:
  ...
  if ( a4 >= 0x12C )
  {
    ...
    *((_QWORD *)a6 + 0x8000) = 0LL;
    if ( a7 && a9 <= v10 )
      ...
      a9 = v10;
    v67[0] = a7;
    v15 = (unsigned __int8 *)(a6 + 1342240);
    v67[1] = a8;
    v68 = v10;
    v70 = 0LL;
    while ( 1 )
    {
      ...
      do
      {
        v26 = (unsigned __int16)XpressHashFunction[*v24] ^ (unsigned __int16)word_14039E610[v24[2]] ^ (unsigned __int64)(unsigned __int16)word_14039E410[v24[1]];
        v27 = *(_QWORD *)&a6[8 * v26];
        *(_QWORD *)&a6[8 * v26] = v24++;
...
LABEL_91:
      ...
      *(_DWORD *)v15 = 2 * v20 + 1;
      ...
      if ( v14 + v63 + 4 * ((unsigned __int64)(XpressBuildHuffmanEncodings(a6 + 1310720) + v62 + 31) >> 5) + 258 >= v66 )
        return 3221225507LL;
      v15 = (unsigned __int8 *)(a6 + 1342240);
      v58 = XpressDoHuffmanPass((int)a6 + 1310720, (int)a6 + 1342240, (_DWORD)v19, v14, v57);
      v10 = a9;
      v14 = v58;
      v64 = v58;
      if ( v57 )
