/*
 * XREFs of CmpMarkValueDataDirty @ 0x140633D4C
 * Callers:
...
char __fastcall CmpMarkValueDataDirty(ULONG_PTR BugCheckParameter2, __int64 a2)
{
  ...
  if ( *(_WORD *)(v11 + 2) )
  {
    while ( 1 )
    {
      ...
      if ( (_DWORD)v14 != -1 && !HvpMarkCellDirty(BugCheckParameter2, v14, 0) )
        break;
      if ( ++v13 >= *(_WORD *)(v11 + 2) )
        goto LABEL_15;
    }
...
LABEL_15:
  v6 = 0;
  if ( HvpMarkCellDirty(BugCheckParameter2, *(unsigned int *)(v11 + 4), 0) )
LABEL_16:
    v6 = 1;
LABEL_17:
  if ( v9 )
...
LABEL_5:
  v6 = 0;
  if ( HvpMarkCellDirty(BugCheckParameter2, *(unsigned int *)(a2 + 8), 0) )
    return 1;
  return v6;
}
