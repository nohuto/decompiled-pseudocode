/*
 * XREFs of DrvDbGetDeviceIdDriverInfMatches @ 0x1406FAE84
 * Callers:
        ...
        char a6)
{
  ...
  v25 = 0;
  *a5 = 0;
  v9 = PnpCtxRegQueryInfoKey(&v24, a2, 0LL, 0LL, &v24, &v26, 0LL);
  if ( v9 >= 0 )
  {
    v10 = v24;
    v11 = v26 + 1;
...
LABEL_36:
              ...
              v9 = DrvDbBuildDeviceIdDriverInfMatch(v16, &v22, &PoolWithTag[v26], v11 - v26);
              if ( v9 < 0 )
                goto LABEL_26;
              v17 = -1LL;
              do
