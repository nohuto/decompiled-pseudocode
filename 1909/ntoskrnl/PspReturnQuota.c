/*
 * XREFs of PspReturnQuota @ 0x140064D10
 * Callers:
...
signed __int64 __fastcall PspReturnQuota(char *a1, ULONG_PTR a2, unsigned int a3, ULONG_PTR a4)
{
  ...
  if ( *(_QWORD *)&a1[v6 + 80] )
  {
    if ( v13 > v12 )
    {
      v14 = (unsigned __int64 *)&qword_140436AA8[7 * (int)a3];
      v15 = *v14;
      if ( v13 - v12 > *v14 )
      {
        if ( v15 > a4 )
  ...
  {
    if ( (v10 & 4) != 0 )
      _InterlockedExchangeAdd64((volatile signed __int64 *)(a2 + 8 * v9 + 792), -(__int64)a4);
  }
  return result;
}
