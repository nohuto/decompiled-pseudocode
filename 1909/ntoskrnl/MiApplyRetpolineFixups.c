/*
 * XREFs of MiApplyRetpolineFixups @ 0x140643670
 * Callers:
        ...
        char a7)
{
  ...
  switch ( a6[3] )
  {
    case 3u:
      ...
      break;
    case 4u:
      result = (_UNKNOWN **)RtlApplyIndirectRelocationToPage(a1, a4, a5, (int)qword_140464568, a6 + 4, (a7 & 1) == 0, 1);
      break;
    case 5u:
  ...
  while ( v11 < v12 )
  {
    ...
    result = (_UNKNOWN **)RtlApplyImportRelocationToPage(a1, a4, a5, (int)qword_140464568, v11, v10, 0, !v15);
    v11 += 4;
  }
  while ( v12 < v13 )
  {
    result = (_UNKNOWN **)RtlApplyIndirectRelocationToPage(a1, a4, a5, (int)qword_140464568, v12, v10, 0);
    v12 += 2;
  }
  while ( v13 < v14 )
  {
    result = (_UNKNOWN **)RtlApplySwitchJumpRelocationToPage(a1, a4, a5, (int)qword_140464568, v13, v10, 0);
    v13 += 2;
  }
  return result;
}
