/*
 * XREFs of FsRtlAddToTunnelCacheEx @ 0x1406B53F0
 * Callers:
 *     FsRtlAddToTunnelCache @ 0x14084E1A0 (FsRtlAddToTunnelCache.c)
 * Callees:
 ...
 *     FsRtlPruneTunnelCache @ 0x1406B5714 (FsRtlPruneTunnelCache.c)
 */
...
LABEL_39:
  ...
  *((_WORD *)v17 + 32) = v26;
  ...
  if ( v10->Length )
  {
    memmove(*((void **)v17 + 9), v10->Buffer, v27);
    v27 = v10->Length;
  }
