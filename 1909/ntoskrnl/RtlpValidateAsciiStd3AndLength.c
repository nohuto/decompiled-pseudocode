/*
 * XREFs of RtlpValidateAsciiStd3AndLength @ 0x1408D4F14
 * Callers:
 *     RtlpNameprepAsciiRealWorker @ 0x140312D24 (RtlpNameprepAsciiRealWorker.c)
 * Callees:
 *     FindEmailAt @ 0x140312974 (FindEmailAt.c)
 *     ValidateStd3Range @ 0x1403130B4 (ValidateStd3Range.c)
 */
...
bool __fastcall RtlpValidateAsciiStd3AndLength(unsigned __int64 a1, int a2, char a3, char a4)
{
  ...
  for ( i = (unsigned __int16 *)a1; i != v9; ++i )
  {
    ...
    else if ( a4 && (v8 == 45 && i == v4 + 1 || !ValidateStd3Range(v8)) || v8 < 0x20u )
    {
      return 0;
    }
  }
  return v6
      ...
      && (__int64)((__int64)v9 - v10) >> 1 <= 256LL - (v8 != 46)
      && (!a4 || v8 != 45);
}
