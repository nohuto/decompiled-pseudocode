/*
 * XREFs of sub_1401B8F7C @ 0x1401B8F7C
 * Callers:
...
void __fastcall sub_1401B8F7C(__int64 a1, int *a2)
{
  int *v2; // r14
  __int64 v3; // rbx
  __int64 v4; // r8
            ...
            if ( !*(_DWORD *)(v3 + 2296) )
            {
              *(_QWORD *)(*(_QWORD *)(v3 + 1424) + 24LL) = v61 ^ v56;
              if ( !*(_DWORD *)(v3 + 2296) )
              {
                ...
                *(_QWORD *)(v3 + 2328) = v43;
                *(_DWORD *)(v3 + 2296) = 1;
                sub_14036B3BC(v3, 0LL, v46, v45);
              }
            }
          }
        }
        sub_1401B8E9C(v3, v43, 0x1000u, (__int64)v153);
        v62 = 16LL;
        v63 = v153;
        while ( 1 )
        {
            ...
            if ( !*(_DWORD *)(v3 + 2296) )
            {
              *(_QWORD *)(*(_QWORD *)(v3 + 1424) + 24LL) = v112 ^ v113;
              if ( !*(_DWORD *)(v3 + 2296) )
              {
                ...
                *(_QWORD *)(v3 + 2328) = v114;
                *(_DWORD *)(v3 + 2296) = 1;
                sub_14036B3BC(v3, 0LL, v114, v108);
              }
            }
          }
          v119 = 16LL;
...
LABEL_159:
          if ( !*(_DWORD *)(v3 + 2296) )
          {
            ...
            *(_QWORD *)(v3 + 2320) = v129;
            *(_DWORD *)(v3 + 2296) = 1;
            sub_14036B3BC(v3, 0LL, v119, v108);
          }
LABEL_161:
          v107 = v159;
LABEL_162:
...
LABEL_174:
  ...
  if ( (*(_DWORD *)(v3 + 2452) & 0x10) != 0 && !*(_DWORD *)(v3 + 2296) )
  {
    ...
    *(_QWORD *)(v3 + 2328) = 1LL;
    *(_DWORD *)(v3 + 2296) = 1;
    sub_14036B3BC(v3, 0LL, v131, v132);
  }
  if ( *((_QWORD *)v2 + 3) != 1LL )
  {
LABEL_185:
