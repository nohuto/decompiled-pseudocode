/*
 * XREFs of NtCreateTimer2 @ 0x1406811A0
 * Callers:
 *     NtCreateIRTimer @ 0x140749EF0 (NtCreateIRTimer.c)
 * Callees:
 *     ExpExTimerAttributesAreValid @ 0x1400E8C4C (ExpExTimerAttributesAreValid.c)
...
__int64 __fastcall NtCreateTimer2(__int64 *a1, __int64 a2, __int64 a3, int a4, ACCESS_MASK a5)
{
  __int64 v7; // rdx
  __int64 v8; // r9
  unsigned int *v9; // r10
  ...
  if ( (a4 & 2) == 0 || (LOBYTE(v7) = PreviousMode, result = ExpCheckIRTimerAccess(v16, v7), (int)result >= 0) )
  {
    ...
    if ( inserted >= 0 )
    {
      ...
      v13[17] = 0LL;
      *((_DWORD *)v13 + 40) = a4;
      inserted = ObInsertObjectEx(v13, 0LL, a5, 0, 0, 0LL, &v18);
      v16 = inserted;
      if ( inserted >= 0 )
        *a1 = v18;
    }
