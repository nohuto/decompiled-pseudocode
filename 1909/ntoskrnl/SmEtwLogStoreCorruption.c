/*
 * XREFs of SmEtwLogStoreCorruption @ 0x140324408
 * Callers:
...
BOOLEAN __fastcall SmEtwLogStoreCorruption(REGHANDLE *a1, __int64 a2, __int64 a3, void *a4, char a5, __int64 *a6)
{
  ...
  PHYSICAL_ADDRESS v12; // [rsp+48h] [rbp-61h] BYREF
  void *v13; // [rsp+50h] [rbp-59h] BYREF
  ...
  v13 = a4;
  v11 = *a6;
  result = EtwEventEnabled(*a1, &StEventStoreCorruption);
  if ( result )
  {
    UserData.Reserved = 0;
    v17 = 0;
    ...
    v28 = 1;
    v31 = 4;
    return EtwWriteEx(v10, &StEventStoreCorruption, 0LL, 1u, 0LL, 0LL, 7u, &UserData);
  }
  return result;
}
