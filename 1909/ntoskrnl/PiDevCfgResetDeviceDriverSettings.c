/*
 * XREFs of PiDevCfgResetDeviceDriverSettings @ 0x140868908
 * Callers:
...
LABEL_42:
    ...
    if ( v11 >= 0 )
    {
      v24 = PnpOpenObjectRegKey(*(__int64 *)&PiPnpRtlCtx, (__int64)UnicodeString.Buffer, 2u, 131097, 0, (__int64)&v32);
      v25 = v29;
      if ( v24 < 0 )
        goto LABEL_47;
