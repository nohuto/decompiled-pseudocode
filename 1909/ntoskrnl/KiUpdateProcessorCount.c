/*
 * XREFs of KiUpdateProcessorCount @ 0x14059F538
 * Callers:
 *     KiUpdateNumberProcessorsIpi @ 0x1405AB390 (KiUpdateNumberProcessorsIpi.c)
 *     KeStartAllProcessors @ 0x1409EDC20 (KeStartAllProcessors.c)
 * Callees:
 *     KeAddProcessorAffinityEx @ 0x14009E060 (KeAddProcessorAffinityEx.c)
 *     KiGetCurrentGroupCount @ 0x14013DCC8 (KiGetCurrentGroupCount.c)
 */
