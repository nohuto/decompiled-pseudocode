/*
 * XREFs of MiMoveDirtyBitsToPfns @ 0x140052C00
 * Callers:
...
__int64 __fastcall MiMoveDirtyBitsToPfns(unsigned __int64 a1, unsigned __int64 a2, __int64 a3, char a4)
{
  ...
  while ( 2 )
  {
    ...
    if ( v28 < 0xFFFF800000000000uLL || v28 >= qword_1404672B0 && v28 <= qword_140465BE0 )
    ...
    if ( v46 + v41 > 8 )
    {
      ...
      if ( !v41 )
        goto LABEL_58;
      v48 = byte_140381050[v41];
    }
    else
    {
      v48 = ~(byte_140382448[v41] << v46);
    }
    *v47 &= v48;
LABEL_58:
    v13 = v101;
...
LABEL_78:
      ...
      if ( (v65 & 0x10) == 0 )
      {
        ...
        *(_BYTE *)(v64 + 34) |= 0x10u;
        if ( v66 )
          v63 = *(_QWORD *)(qword_140465E88 + 8 * ((*(_QWORD *)(v64 + 40) >> 40) & 0x3FFLL));
      }
