/*
 * XREFs of PpmPerfSelectProcessorState @ 0x1400F3D00
 * Callers:
 *     PpmPerfSelectProcessorStates @ 0x1400F3C20 (PpmPerfSelectProcessorStates.c)
 * Callees:
...
char __fastcall PpmPerfSelectProcessorState(__int64 a1)
{
  ...
  if ( (unsigned int)PpmMfBufferingThreshold > 0x64 )
    v3 = 100;
  v7 = &PpmCurrentProfile[341 * dword_140443A2C + 5];
  if ( v6 && PpmCurrentProfile == (__int64 *)PpmLowPowerProfile && byte_140443A6C && *(_BYTE *)(v6 + 305) < v3 )
  {
    v2 = 4096;
    v7 = (__int64 *)((char *)&unk_140437088 + 2728 * dword_140443A2C);
    v44 = 4096;
  }
