/*
 * XREFs of PnpFilterResourceRequirementsList @ 0x140767C6C
 * Callers:
 ...
 * Callees:
 *     RtlCmDecodeMemIoResource @ 0x14013BBD0 (RtlCmDecodeMemIoResource.c)
 *     RtlIoDecodeMemIoResource @ 0x14018DE20 (RtlIoDecodeMemIoResource.c)
