/*
 * XREFs of KiInvokeBugCheckAddTriageDumpDataCallbacks @ 0x1402A927C
 * Callers:
  ...
  if ( KeBugCheckReasonCallbackListHead && qword_14044D668 )
  {
    ...
    while ( 1 )
    {
      ...
      if ( (_BYTE)v0 )
      {
        ...
        v5[3] = qword_14044CF48;
        v5[4] = qword_14044CF50;
        v5[5] = qword_14044CF58;
        v5[6] = qword_14044CF60;
          ...
          && (LOBYTE(v0) = KiValidateComponentName(*((STRSAFE_PCNZCH *)v1 + 3)), (_BYTE)v0) )
        {
          ...
          *(_DWORD *)(v5[0] + 32) = v6 + 1;
          v0 = v5[0];
          v3 = (__int64 *)qword_14044D678;
          if ( *(__int64 **)qword_14044D678 != &KeBugCheckTriageDumpDataArrayListHead )
            __fastfail(3u);
