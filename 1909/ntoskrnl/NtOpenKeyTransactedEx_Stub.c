/*
 * XREFs of NtOpenKeyTransactedEx_Stub @ 0x14093EB0C
 * Callers:
...
__int64 __fastcall NtOpenKeyTransactedEx_Stub(__int64 a1)
{
  ...
  if ( byte_14050EB51 )
  {
    v1 = (NTSTATUS (__stdcall *)(PHANDLE, ACCESS_MASK, POBJECT_ATTRIBUTES, ULONG, HANDLE))qword_14050EB60;
  }
  else
  {
    v1 = ZwOpenKeyTransactedEx;
    byte_14050EB51 = 1;
    qword_14050EB60 = (__int64)ZwOpenKeyTransactedEx;
  }
  if ( v1 )
