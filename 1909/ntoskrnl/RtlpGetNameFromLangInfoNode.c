/*
 * XREFs of RtlpGetNameFromLangInfoNode @ 0x14018E988
 * Callers:
...
__int64 __fastcall RtlpGetNameFromLangInfoNode(__int64 a1, __int64 a2, __int64 a3)
{
  ...
  if ( a1 && a2 && a3 )
  {
    ...
    {
      v10 = *(_WORD *)(a2 + 4);
      if ( ((v10 - 4096) & 0xFBFF) != 0 && (unsigned __int8)RtlLCIDToCultureName(v10, a3) )
        return v3;
    }
    else
    {
      ...
      *(_QWORD *)&v11.Length = 0LL;
      ...
      v7 = *(_WORD *)(a3 + 2);
      Length = v11.Length;
      if ( v11.Length <= v7 && RtlStringCbCopyW(*(NTSTRSAFE_PWSTR *)(a3 + 8), v7, v11.Buffer) >= 0 )
      {
        *(_WORD *)a3 = Length;
        return v3;
      }
