/*
 * XREFs of MiZeroPage @ 0x140029400
 * Callers:
...
void __fastcall MiZeroPage(__int64 a1, __int64 a2)
{
  ...
  *(_DWORD *)v66 = 0;
  ...
  if ( *(_QWORD *)&v66[4] )
  {
    ...
    KeAcquireInStackQueuedSpinLock((PKSPIN_LOCK)(qword_1404681D0 + 1984LL * v77 + 1928), &LockHandle);
    v12 = *(_QWORD *)&v66[4];
    CurrentThread = v73;
  }
  v71 = v3;
    ...
    if ( !v14[70] )
    {
      if ( v62 )
      {
        MiFreeZeroPageSlistSufficient(
          v75,
          dword_1404657B0 & (unsigned int)v10 | (*(_QWORD *)(v3 + 40) >> 58 << byte_14046574D) | (((unsigned int)(*(_QWORD *)(v3 + 40) >> 36) & 3) << byte_14046574E),
          0LL);
        v63 = 1;
        v27 = *(_QWORD *)&v66[4];
      }
