/*
 * XREFs of CmpAddSubKeyToList @ 0x1406C4F28
 * Callers:
...
char __fastcall CmpAddSubKeyToList(ULONG_PTR BugCheckParameter2, unsigned int *a2, unsigned int a3)
{
  ...
  v25 = 0LL;
  v22 = 0;
  v7 = v5(BugCheckParameter2, a3, &v28);
  v8 = v7;
  if ( !v7 )
    return 0;
  v9 = 1;
...
LABEL_10:
  if ( v26 )
    (*(void (__fastcall **)(unsigned __int64, _QWORD))(BugCheckParameter2 + 32))(v14, (unsigned __int16)v12);
  if ( v21 )
  {
