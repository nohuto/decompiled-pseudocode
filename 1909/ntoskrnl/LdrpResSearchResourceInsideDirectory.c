/*
 * XREFs of LdrpResSearchResourceInsideDirectory @ 0x140676888
 * Callers:
 ...
 *     LdrpSectionTableFromVirtualAddress @ 0x140676180 (LdrpSectionTableFromVirtualAddress.c)
              ...
              if ( v23 )
              {
                ...
                if ( !v36 )
                {
                  ...
                  if ( v49 )
                  {
                    ...
                    v38 = v37 + v50 - a4;
                    v51 = LdrpSectionTableFromVirtualAddress(a1 & 0xFFFFFFFFFFFFFFFCuLL, v14, v47, v17, v49, v91);
                    if ( !v51 )
                      goto LABEL_164;
                    if ( *v23 > *(_DWORD *)(v51 + 8) )
                    {
                      ullSubtrahenda = *(_DWORD *)(v51 + 12);
                      v54 = LdrpSectionTableFromVirtualAddress(a1 & 0xFFFFFFFFFFFFFFFCuLL, v92, v52, v53, *v23, v91);
                      if ( !v54 )
                        goto LABEL_164;
                      v94 = *(_DWORD *)(v54 + 12);
                      v57 = LdrpSectionTableFromVirtualAddress(a1 & 0xFFFFFFFFFFFFFFFCuLL, v92, v55, v56, v94, v91);
                      v58 = v57;
                      v39 = -1073741675;
                      if ( v57 )
                      {
