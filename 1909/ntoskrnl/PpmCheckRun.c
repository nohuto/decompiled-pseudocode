/*
 * XREFs of PpmCheckRun @ 0x140107FC0
 * Callers:
 *     <none>
 * Callees:
...
LABEL_4:
    ...
    if ( (stru_140443768.Header.Type & 0x7F) != 0 )
    {
      v4 = 0;
    }
    else
    {
      if ( stru_140443768.Header.SignalState == 1 )
        goto LABEL_11;
      v4 = 1;
    }
    ...
    KiAcquireKobjectLockSafe(&stru_140443768.Header.Lock);
    SignalState = stru_140443768.Header.SignalState;
    stru_140443768.Header.SignalState = 1;
    if ( SignalState )
    {
LABEL_10:
      _InterlockedAnd((volatile signed __int32 *)&stru_140443768, 0xFFFFFF7F);
...
LABEL_11:
    ...
    if ( !v4 )
    {
      Flink = (struct _KEVENT *)stru_140443768.Header.WaitListHead.Flink;
      if ( stru_140443768.Header.WaitListHead.Flink == &stru_140443768.Header.WaitListHead )
        goto LABEL_10;
      while ( 1 )
      {
        ...
        *v12 = v10;
        ...
        {
          if ( !--stru_140443768.Header.SignalState )
            goto LABEL_10;
        }
LABEL_23:
        if ( Flink == (struct _KEVENT *)&stru_140443768.Header.WaitListHead )
          goto LABEL_10;
      }
      if ( v13 != 2 )
      {
...
LABEL_48:
    ...
    v23 = (struct _KEVENT *)stru_140443768.Header.WaitListHead.Flink;
    if ( stru_140443768.Header.WaitListHead.Flink == &stru_140443768.Header.WaitListHead )
    {
LABEL_76:
      stru_140443768.Header.WaitListHead.Blink = &stru_140443768.Header.WaitListHead;
      stru_140443768.Header.WaitListHead.Flink = &stru_140443768.Header.WaitListHead;
      goto LABEL_10;
    }
    while ( 1 )
    {
...
LABEL_75:
      if ( v23 == (struct _KEVENT *)&stru_140443768.Header.WaitListHead )
        goto LABEL_76;
    }
    v33 = v37;
    goto LABEL_68;
