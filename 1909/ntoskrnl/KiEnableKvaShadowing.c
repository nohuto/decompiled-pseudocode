/*
 * XREFs of KiEnableKvaShadowing @ 0x14059F81C
 * Callers:
 ...
 *     HvlRescindEnlightenments @ 0x14013DC90 (HvlRescindEnlightenments.c)
 *     KiInitializeDescriptorIst @ 0x140186240 (KiInitializeDescriptorIst.c)
 *     KiIsKvaLeakSimulated @ 0x14018628C (KiIsKvaLeakSimulated.c)
 *     KiIsKvaShadowDisabled @ 0x1401862A0 (KiIsKvaShadowDisabled.c)
    ...
    if ( KiKvaLeakage || KiKvaLeakageSimulate )
    {
      ...
      *(_QWORD *)(v7 + 4100) = v7 + 16896;
      ...
      else
      {
        ...
        byte_14058CC48 = 1;
        _InterlockedOr(dword_14058D0BC, 0x4000u);
        KiSetAddressPolicy();
        *(_WORD *)(a1 + 28330) = 24;
        v8 = *(_QWORD *)(a1 + 25248);
