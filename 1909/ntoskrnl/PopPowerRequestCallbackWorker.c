/*
 * XREFs of PopPowerRequestCallbackWorker @ 0x1400D68D0
 * Callers:
...
__int64 PopPowerRequestCallbackWorker()
{
  ...
  while ( 1 )
  {
    ...
    {
      v0 = *(_QWORD **)(qword_140444D98 + 8);
      if ( *(__int64 **)qword_140444D98 != &PopPowerRequestCallbacks || *v0 != qword_140444D98 )
        __fastfail(3u);
      v1 = qword_140444D98 - 56;
      qword_140444D98 = *(_QWORD *)(qword_140444D98 + 8);
      v2 = 0;
