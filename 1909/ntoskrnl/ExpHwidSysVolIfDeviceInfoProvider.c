/*
 * XREFs of ExpHwidSysVolIfDeviceInfoProvider @ 0x140623CC0
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall ExpHwidSysVolIfDeviceInfoProvider(__int64 a1)
{
  ...
  *(_QWORD *)&DestinationString.Length = 0LL;
  ...
  for ( i = 0; ; i = 1 )
  {
    ...
    v8 = ((__int64 (__fastcall *)(UNICODE_STRING *, __int64, _QWORD, _QWORD, unsigned int *, unsigned int, _QWORD, _QWORD))ExpHwidSendSynchronousIrpToDevice)(
           &DestinationString,
           5636096LL,
           0LL,
           0LL,
