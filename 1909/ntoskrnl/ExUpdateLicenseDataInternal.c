/*
 * XREFs of ExUpdateLicenseDataInternal @ 0x1406A2590
 * Callers:
 *     ExUpdateLicenseData @ 0x14090BDC0 (ExUpdateLicenseData.c)
 ...
 *     ExpLicensingDescriptorCompare @ 0x1406A30B0 (ExpLicensingDescriptorCompare.c)
...
LABEL_148:
  ...
  *(_OWORD *)MappedBase = *(_OWORD *)a2;
  ...
  LOBYTE(v15) = 1;
  v73 = sub_1406A3938(v14, v15, 0LL, 0LL, NumOfElements);
  if ( v73 != -1073741789 )
    goto LABEL_49;
...
LABEL_127:
  ...
  v73 = sub_1406A3938(MappedBase, 0LL, PoolWithTag, NumOfElements[0], 0LL);
  if ( v73 >= 0 )
...
LABEL_79:
        ...
        if ( (int)v83 >= 0 )
        {
          if ( v131 || (v73 = sub_1406A3E90(), v41 = 0LL, v73 >= 0) )
          {
            if ( v36 || !v131 )
              sub_1406A3ABC(v41);
            v73 = 0;
...
LABEL_100:
  if ( v132 && !byte_1409AE5C0 )
    sub_14090C104(&KernelLicensingCacheCorruptionFixed);
  if ( v76 )
  {
