/*
 * XREFs of MiLogCommitRequestFailed @ 0x140897CE8
 * Callers:
 ...
 *     PsQueryJobMemoryUsageByProcess @ 0x1408C6E5C (PsQueryJobMemoryUsageByProcess.c)
 */
...
char __fastcall MiLogCommitRequestFailed(__int64 a1, __int64 a2, int a3)
{
  ...
  if ( hProvider )
  {
    _m_prefetchw((const void *)(a1 + 1788));
    LODWORD(v3) = *(_DWORD *)(a1 + 1788);
    do
    {
      v7 = (int)v3;
      LODWORD(v3) = _InterlockedCompareExchange(
                      (volatile signed __int32 *)(a1 + 1788),
    ...
    if ( ((unsigned __int16)v3 & 0x400) == 0 )
    {
      ...
      if ( hProvider->LevelPlus1 > 5 )
      {
        ...
        if ( (_BYTE)v3 )
        {
          ...
          v61 = 8LL;
          v63 = 8LL;
          LOBYTE(v3) = TlgWriteEx(v14, &unk_14038E460, 0LL, 1u, 0LL, 0LL, 0xFu, &pData);
        }
      }
    }
  }
