/*
 * XREFs of PopDispatchQuerySetIrp @ 0x1401755A8
 * Callers:
...
LABEL_7:
  ...
  v5 = (_QWORD *)qword_140442F98;
  if ( *(__int64 **)qword_140442F98 != &PopIrpWorkerList )
    goto LABEL_7;
  *v4 = &PopIrpWorkerList;
  a1[22] = v5;
  *v5 = v4;
  qword_140442F98 = (__int64)(a1 + 21);
  return KeReleaseSemaphoreEx((__int64)&PopIrpWorkerSemaphore, 0, 1, v3, 0);
}
