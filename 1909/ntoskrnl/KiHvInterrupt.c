/*
 * XREFs of KiHvInterrupt @ 0x1401C8C70
 * Callers:
...
/*
 * Hex-Rays decompilation failed for KiHvInterrupt @ 0x1401C8C70
 * Reason: Hex-Rays returned no pseudocode for 0x1401C8C70
 * Fallback: raw IDA disassembly follows.
 *
 * 00000001401C8C70: push    0
 ...
 * 00000001401C8F3E: jmp     KiHvInterruptDispatch
 */
