/*
 * XREFs of PopThermalZoneRemove @ 0x1408A8810
 * Callers:
 *     <none>
 * Callees:
 ...
 *     PopDiagTraceThermalStandbyState @ 0x1402FE8F0 (PopDiagTraceThermalStandbyState.c)
...
void __fastcall PopThermalZoneRemove(__int64 a1)
{
  ...
  *(_BYTE *)(a1 + 66) = 1;
  ...
  if ( *(_BYTE *)(a1 + 72) )
  {
    ...
    --dword_1404429E4;
    PopTraceZoneCr3Mitigated(dword_1404429E8, a1);
    if ( !dword_1404429E4 )
    {
