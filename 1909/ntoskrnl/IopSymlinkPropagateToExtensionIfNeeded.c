/*
 * XREFs of IopSymlinkPropagateToExtensionIfNeeded @ 0x140604A70
 * Callers:
...
LABEL_4:
  ...
  IopSymlinkInitializeSymlinkInfo(
    ...
    *(_QWORD *)(v11 + 24),
    ...
    v17,
    0LL);
  *v4 = *(_WORD *)v11 + v4[8] - *(_WORD *)(v11 + 16);
LABEL_13:
  EcpContext = 0LL;
  if ( *(_QWORD *)(a1 + 208) )
  {
  ...
  v7 = IopSetTypeSpecificFoExtension((__int64)EcpContext, 5u, (signed __int64)v4);
LABEL_16:
  if ( v7 >= 0 )
  {
    IopSymlinkFreeRelatedMountPointChain(v4);
