/*
 * XREFs of WmipInitializeDataStructs @ 0x140A1904C
 * Callers:
...
__int64 WmipInitializeDataStructs()
{
  ...
  __int64 v2; // rcx
  __int64 *i; // rax
  char v4[8]; // [rsp+30h] [rbp-49h] BYREF
