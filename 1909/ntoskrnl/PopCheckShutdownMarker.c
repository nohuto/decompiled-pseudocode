/*
 * XREFs of PopCheckShutdownMarker @ 0x1409FBC20
 * Callers:
 ...
 *     RtlGetSystemBootStatusEx @ 0x1407598F0 (RtlGetSystemBootStatusEx.c)
...
char __fastcall PopCheckShutdownMarker(int a1)
{
  ...
  xmmword_14046BA10 = xmmword_140467AE8;
  xmmword_14046BA20 = xmmword_140467AF8;
  ...
  {
    v11 = WORD2(v2);
    v13 = WORD6(xmmword_14046BA10);
    v16 = BYTE6(v2);
    v12 = v2;
    v14 = v2;
    v3 = HIBYTE(v2);
    v8 = v3 & 1;
    v15 = HIWORD(*((_QWORD *)&xmmword_14046BA10 + 1));
    v21 = &PopBsdPhysicalPowerButtonInfoAtBoot;
    v23 = &v11;
    v25 = &v12;
    v27 = &xmmword_14046BA10;
    v29 = &v13;
    v31 = &v14;
    v33 = &v15;
    v35 = &v16;
    ...
    v38 = 1LL;
    v40 = 1LL;
    TlgWrite(&pCallbackContext, &unk_14038E868, 0LL, 0LL, 0xCu, &pData);
  }
  PopBsdPowerTransitionExtensionAtBoot = PopBsdPowerTransitionExtension;
  xmmword_14046BA40 = xmmword_140467E50;
  PopBsdPowerTransitionAtBoot = PopBsdPowerTransition;
  xmmword_14046BA60 = *(_OWORD *)&::Buffer;
  if ( ExIsSoftBoot() )
