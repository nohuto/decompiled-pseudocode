/*
 * XREFs of MiInitializeDriverImages @ 0x1409EE5A4
 * Callers:
...
__int64 __fastcall MiInitializeDriverImages(__int64 a1)
{
  ...
  while ( v6 );
  MxMarkActiveDriverBits((unsigned int)&qword_1404659A0, v1, v4, (unsigned int)&v35, 3);
  v7 = qword_1404659A8;
  v8 = (_DWORD *)((((unsigned __int64)qword_1404659A8 >> 9) & 0x7FFFFFFFF8LL) - 0x98000000000LL);
  for ( i = 0LL; i < qword_1404659A0; i += 0x8000LL )
  {
    if ( (*v8 & 0x800LL) == 0 )
    {
      if ( !(unsigned int)MiSplitBitmapPages(5, v7, 8LL) )
        return 0LL;
      RtlClearBitsEx((__int64)&qword_1404659A0, i, 0x8000uLL);
    }
    v7 += 4096LL;
    v8 += 2;
  }
  ...
  if ( (unsigned int)MiBuildDynamicRegion(v10, v11, 0x2000000000uLL) )
  {
    qword_1404645F0 = -1LL;
    qword_140464620 = 0LL;
    qword_140464600 = (__int64)&qword_1404645F8;
    qword_1404645F8 = (__int64)&qword_1404645F8;
...
LABEL_9:
          ...
          if ( (unsigned int)MiInitializeBootLoadedDriverPfns(a1) && (unsigned int)MiInitializeDriverPtes(a1) )
          {
            ...
            if ( (unsigned int)MiReloadBootLoadedDrivers(a1) && (unsigned int)MiCreateInitialSystemWsles() )
            {
              ...
              result = 1LL;
              qword_140464610 = (__int64)&qword_140464608;
              qword_140464608 = &qword_140464608;
              return result;
            }
          }
          return 0LL;
        ...
        *((_WORD *)PoolWithTag + 9) = v20;
        v21 = (_QWORD *)qword_140464600;
        if ( *(__int64 **)qword_140464600 != &qword_1404645F8 )
          __fastfail(3u);
        *PoolWithTag = &qword_1404645F8;
        PoolWithTag[1] = v21;
        *v21 = PoolWithTag;
        v15 = 0x100002601LL;
        qword_140464600 = (__int64)PoolWithTag;
      }
