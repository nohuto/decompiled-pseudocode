/*
 * XREFs of KeInitThread @ 0x1405952E0
 * Callers:
 ...
 *     KeAbInitializeThreadState @ 0x1400823BC (KeAbInitializeThreadState.c)
        ...
        int a9)
{
  ...
  *(_QWORD *)(a1 + 776) = a1 + 776;
  ...
  while ( v14 );
  *(_DWORD *)(a1 + 120) = *(_DWORD *)(a1 + 120) & 0xFFFFFFFB | (4 * (*(_DWORD *)(a8 + 440) & 1 | 0x8010));
  ...
  *(_BYTE *)a1 = 6;
  if ( !KernelStack )
  {
    ...
    v20 = a9 ? a9 - 1 : *(_WORD *)(a8 + 2LL * Group + 532);
