/*
 * XREFs of MiReservePageFileSpace @ 0x14002F780
 * Callers:
...
char __fastcall MiReservePageFileSpace(__int64 a1, __int64 a2, __int64 a3)
{
  ...
  {
    v37 = v20;
    if ( qword_140465800 && (v20 & 0x10) == 0 )
      v37 = v20 & ~qword_140465800;
  ...
  else
  {
    ...
    if ( qword_140465800 && (v23 & 0x10) == 0 )
      v38 = v23 & ~qword_140465800;
    if ( v26 < HIDWORD(v38) )
    {
      v39 = v23;
      if ( qword_140465800 && (v23 & 0x10) == 0 )
        v39 = v23 & ~qword_140465800;
...
LABEL_35:
    ...
    for ( i = a2 - Address; i <= v29; updated = Address )
    {
      ...
      v36 = v35;
      if ( qword_140465800 && (v35 & 0x10) == 0 )
        v36 = v35 & ~qword_140465800;
      if ( v35 )
      {
        if ( qword_140465800 )
        {
          if ( (v35 & 0x10) != 0 )
            ...
            LODWORD(v35) = v35 & ~(_DWORD)qword_140465800;
        }
      }
      else
      {
