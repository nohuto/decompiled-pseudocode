/*
 * XREFs of ViDeadlockForgetResourceHistory @ 0x14097C7E0
 * Callers:
 *     ViDeadlockTrimResources @ 0x14097D1F8 (ViDeadlockTrimResources.c)
 * Callees:
 *     ViDeadlockRemoveNode @ 0x14097CC64 (ViDeadlockRemoveNode.c)
 */
