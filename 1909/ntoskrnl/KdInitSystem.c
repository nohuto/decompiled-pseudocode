 ...
 *     MmGetPagedPoolCommitPointer @ 0x14013DD34 (MmGetPagedPoolCommitPointer.c)
...
char __fastcall KdInitSystem(int a1, __int64 a2)
{
  ...
  else
  {
    ...
    {
      qword_14044DBA8 = KdDebugDevice;
      qword_140424BF0 = (__int64)MmGetPagedPoolCommitPointer();
      KdpPowerSpinLock = 0LL;
      qword_14045C228 = (__int64)&KdpPowerListHead;
      KdpPowerListHead = (__int64)&KdpPowerListHead;
      qword_14045C218 = (__int64)&KdpDebuggerDataListHead;
      ...
      *((_QWORD *)&xmmword_1404283D8 + 1) = &PsLoadedModuleList;
      *(_WORD *)((char *)&KdVersionBlock + 11) = 13059;
      qword_1404283E8 = (__int64)&KdpDebuggerDataListHead;
    }
    ...
    {
      v11 = 1;
      *(_QWORD *)&xmmword_1404283D8 = PsNtosImageBase;
    }
    Base = (PVOID)xmmword_1404283D8;
    if ( !v5 )
    {
      ...
      if ( (int)KdInitialize(0LL, a2, (char *)&KdDebuggerNotPresent + 5) < 0 )
      {
        KdPitchDebugger = 0;
        v11 = 0;
        LOBYTE(KdDebuggerNotPresent) = 1;
