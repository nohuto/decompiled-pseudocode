/*
 * XREFs of AlpcpSendMessage @ 0x1405E1E30
 * Callers:
...
LABEL_119:
  ...
  {
    ++dword_140503318;
    v20 = (PSLIST_ENTRY)((__int64 (__fastcall *)(_QWORD, _QWORD, _QWORD))qword_140503330)(
                          (unsigned int)dword_140503324,
                          (unsigned int)dword_14050332C,
                          (unsigned int)dword_140503328);
    if ( !v20 )
      return 3221225626LL;
  }
