/*
 * XREFs of PnprMirrorMarkedPages @ 0x1405A9E1C
 * Callers:
 ...
 *     RtlFindFirstRunClear @ 0x14030C680 (RtlFindFirstRunClear.c)
 */
...
__int64 __fastcall PnprMirrorMarkedPages()
{
  ...
  if ( *(_QWORD *)(*(_QWORD *)(PnprContext + 136) + 24 * v0) )
  {
    ...
    do
    {
      v3 = PnprContext;
      v4 = PnprContext + 152;
      v5 = *(struct _RTL_BITMAP **)(PnprContext + 152);
      while ( 2 )
      {
        if ( v5 != (struct _RTL_BITMAP *)v4 )
        {
          ...
          {
            v3 = PnprContext;
            v5 = *(struct _RTL_BITMAP **)&v5->SizeOfBitMap;
            v4 = PnprContext + 152;
            continue;
          }
          v2 = 1;
