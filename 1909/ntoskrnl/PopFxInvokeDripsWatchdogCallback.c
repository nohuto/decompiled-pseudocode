/*
 * XREFs of PopFxInvokeDripsWatchdogCallback @ 0x1408A56EC
 * Callers:
...
__int64 __fastcall PopFxInvokeDripsWatchdogCallback(__int64 a1, __int64 a2, __int64 a3)
{
  ...
  if ( v4 )
  {
    ...
    {
      if ( result == a2
        || (result = (unsigned int)_InterlockedCompareExchange((volatile signed __int32 *)(v4 + 816), 0, 0),
            (result & 8) != 0) )
      {
        result = *(_QWORD *)(v4 + 856);
        v5 = *(_QWORD *)(a2 + 32);
