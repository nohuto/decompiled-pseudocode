/*
 * XREFs of PoDiagTraceDirectedDripsCandidateDevice @ 0x1408ABE64
 * Callers:
 *     IoDiagTraceDirectedDripsCandidateDevices @ 0x1408776DC (IoDiagTraceDirectedDripsCandidateDevices.c)
 * Callees:
...
void PoDiagTraceDirectedDripsCandidateDevice()
{
  ...
  if ( PopTriggerDiagHandleRegistered && pCallbackContext.LevelPlus1 > 5 )
  {
    if ( TlgKeywordOn(&pCallbackContext, 0x400000000000uLL) )
    {
      ...
      v13[1] = v1;
      v15 = 4LL;
      TlgWrite(&pCallbackContext, &unk_14038F9CC, 0LL, 0LL, 7u, &pData);
    }
  }
}
