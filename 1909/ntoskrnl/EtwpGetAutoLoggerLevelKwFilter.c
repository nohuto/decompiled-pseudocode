/*
 * XREFs of EtwpGetAutoLoggerLevelKwFilter @ 0x1408FDA88
 * Callers:
...
void __fastcall EtwpGetAutoLoggerLevelKwFilter(__int64 a1, __int64 a2, PVOID *a3)
{
  ...
  *(_OWORD *)&ObjectAttributes.SecurityDescriptor = 0LL;
  ...
  if ( a2 )
  {
    do
      ++v7;
    while ( *(_WORD *)(a2 + 2 * v7) );
    v14 = (wchar_t *)ExAllocatePoolWithTag(PagedPool, (unsigned int)(2 * v7 + 40), 0x50777445u);
    v6 = v14;
    if ( !v14 )
      goto LABEL_21;
    RegistryValues = RtlStringCbPrintfW(v14, (unsigned int)(2 * v7 + 40), L"%ws\\StackLevelKwFilter", a2);
    if ( RegistryValues )
      goto LABEL_20;
  ...
  *a3 = v16;
  ...
  if ( v16 )
  {
    ...
    v28 = 4;
    v29 = v17 + 17;
    RegistryValues = RtlpQueryRegistryValues(0x40000000u, (const WCHAR *)KeyHandle, (__int64)v30, 0LL);
    if ( RegistryValues >= 0 )
    {
      if ( Handle )
      {
        ...
        v30[19] = v30[5] + 16LL;
        v30[26] = v30[5] + 17LL;
        RtlpQueryRegistryValues(0x40000000u, (const WCHAR *)Handle, (__int64)v30, 0LL);
      }
LABEL_20:
      if ( RegistryValues >= 0 )
        goto LABEL_23;
