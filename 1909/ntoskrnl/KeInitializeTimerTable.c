/*
 * XREFs of KeInitializeTimerTable @ 0x14074E580
 * Callers:
 ...
 *     KiInitializeTimer2Data @ 0x1401877E8 (KiInitializeTimer2Data.c)
...
__int64 __fastcall KeInitializeTimerTable(__int64 a1)
{
  ...
  if ( !*(_DWORD *)(a1 + 36) )
  {
    ...
    {
      KiSerializeTimerExpiration = (unsigned __int8)off_1404245A0[0]() != 0;
    }
