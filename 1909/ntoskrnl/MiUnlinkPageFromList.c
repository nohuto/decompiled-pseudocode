/*
 * XREFs of MiUnlinkPageFromList @ 0x1400B3280
 * Callers:
...
__int64 __fastcall MiUnlinkPageFromList(ULONG_PTR BugCheckParameter2, int a2)
{
  ...
  *v2 = 0LL;
  ...
  if ( v4 )
  {
    if ( (*(_QWORD *)(BugCheckParameter2 + 24) & 0x3FFFFFFFFFFFFFFFLL) != 0 )
      KeBugCheckEx(0x4Eu, 2uLL, (__int64)(BugCheckParameter2 + 0x58000000000LL) / 48, qword_14046A088, v4);
    return 1LL;
  }
  v6 = *(_QWORD *)(BugCheckParameter2 + 40);
  v7 = *(_QWORD *)(qword_140465E88 + 8 * ((v6 >> 40) & 0x3FF));
  ...
  *(_QWORD *)(((unsigned __int64)&v102 & 0xFFFFFFFFFFFFFFE0uLL) + 0x20) = v12;
  ...
  {
    if ( byte_14046945E && _bittest64((const signed __int64 *)qword_140469D80, v12 >> 9) )
      v11 = 81;
  }
  else
  {
  ...
  if ( (_DWORD)v10 != 2 )
  {
    ...
    if ( (_DWORD)v10 == 3 )
    {
      ...
      if ( (*(_DWORD *)(BugCheckParameter2 + 16) & 0x400LL) != 0 )
      {
        ...
        {
          LOBYTE(v50) = -1;
          ExpAcquireSpinLockSharedAtDpcLevelInstrumented(&dword_140465790, v50);
        }
        else
        {
          ...
          v61 = dword_140465790 & 0x7FFFFFFF;
                        ...
                        dword_140465790 & 0x7FFFFFFF) )
          {
            ...
            LOBYTE(v50) = -1;
            ExpWaitForSpinLockSharedAndAcquire(&dword_140465790, v50);
          }
        }
...
LABEL_40:
      ...
      if ( *(_DWORD *)(((unsigned __int64)&v102 & 0xFFFFFFFFFFFFFFE0uLL) + 0x18) == 2 && (v11 & 0x14) == 0 )
      {
        ...
        v36 = (*(_QWORD *)(BugCheckParameter2 + 24) >> 20) & 0xFFFFF0000LL | *(unsigned __int16 *)(BugCheckParameter2
                                                                                                 + 36);
        v37 = (_QWORD *)(*(_QWORD *)(*(_QWORD *)(qword_140465E88
      ...
      *(_QWORD *)BugCheckParameter2 = 0LL;
      ...
      else
      {
        *(_QWORD *)(BugCheckParameter2 + 24) &= 0xFFFFFFF000000000uLL;
        if ( (*(_QWORD *)(BugCheckParameter2 + 40) & 0x10000000000000LL) == 0 && dword_140465F0C == 1 )
        {
          v79 = v12 & 0x1F;
          LOBYTE(v80) = 1;
          v81 = (volatile signed __int32 *)(qword_140465F68 + 4 * (v12 >> 5));
          if ( v79 + 1 > 0x20 )
          {
            if ( (v12 & 0x1F) == 0 )
              goto LABEL_196;
...
LABEL_39:
  ...
  if ( (v6 & 0x10000000000000LL) == 0 )
  {
    ...
    {
      v70 = qword_1404661E0;
      *(_QWORD *)(((unsigned __int64)&v102 & 0xFFFFFFFFFFFFFFE0uLL) + 0x40) = qword_1404661E0;
    ...
    {
      if ( v23 != 0xFFFFFFFFFLL && (v23 < qword_1404661E0 || v23 >= qword_1404661E0 + 2048) )
      {
      ...
      if ( v24 != 0xFFFFFFFFFLL && (v24 < qword_1404661E0 || v24 >= qword_1404661E0 + 2048) )
      {
