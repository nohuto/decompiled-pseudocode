/*
 * XREFs of MiAddViewsForSection @ 0x140071DF0
 * Callers:
...
LABEL_164:
        ...
        if ( v19 && ($C6908ADE9723D0A04AF8EE82D8D15C40 *)v40->ApcState.ApcListHead[0].Flink != &v40->152 )
          KiCheckForKernelApcDelivery();
        KiLeaveGuardedRegionUnsafe((__int64)CurrentThread);
      }
LABEL_168:
...
LABEL_38:
          ...
          if ( v19 && ($C6908ADE9723D0A04AF8EE82D8D15C40 *)v16->ApcState.ApcListHead[0].Flink != &v16->152 )
            KiCheckForKernelApcDelivery();
          KiLeaveGuardedRegionUnsafe((__int64)CurrentThread);
          return 0LL;
        }
...
LABEL_169:
  ...
  if ( v73 )
  {
    ...
    __writecr8(v59);
    if ( v60 )
      MiReturnCrossPartitionSectionCharges(*(_QWORD *)(qword_140465E88 + 8LL * (*(_WORD *)(v3 + 60) & 0x3FF)), v35, v60);
    result = v90;
  }
  if ( (a3 & 1) != 0 )
  {
