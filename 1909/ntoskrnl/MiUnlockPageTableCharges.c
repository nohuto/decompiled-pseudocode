/*
 * XREFs of MiUnlockPageTableCharges @ 0x140020F18
 * Callers:
 ...
 * Callees:
 *     MiIsLowestPageTablePage @ 0x14001FDF4 (MiIsLowestPageTablePage.c)
  ...
  while ( 1 )
  {
    ...
    *(_QWORD *)(v2 + 24) = v10;
    ...
    if ( !v4 )
    {
      ...
      v4 = *(_QWORD *)(qword_140465E88 + 8 * ((*(_QWORD *)(v2 + 40) >> 40) & 0x3FFLL));
    }
    ++v7;
    if ( !v11 )
    {
