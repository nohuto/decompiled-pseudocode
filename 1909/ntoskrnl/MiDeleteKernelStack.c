/*
 * XREFs of MiDeleteKernelStack @ 0x140024240
 * Callers:
...
__int64 __fastcall MiDeleteKernelStack(__int64 a1, char a2)
{
  ...
  if ( (a2 & 1) != 0 )
    ...
    v4 = (unsigned __int8)byte_1404663FC;
  v5 = v4 + 1;
  v6 = v4;
  v7 = 0LL;
  v26 = v4 + 1;
  ...
  v12 = MiLockWorkingSetShared(&unk_140466C80);
  v25 = v12;
  ...
  do
  {
    ...
    MiLockPageTableInternal(&unk_140466C80, v7, 0LL, v14);
LABEL_7:
    v15 = *(_QWORD *)v10;
    ...
    if ( (v15 & 1) != 0 )
    {
      if ( !v8 )
      {
        ...
        v8 = *(_QWORD *)(qword_140465E88 + 8 * ((*(_QWORD *)(v19 + 48 * (v18 & (v17 >> 12))) >> 40) & 0x3FFLL));
      }
      MiDeleteValidSystemPage(&unk_140466C80, v10, 0LL, v24);
      ++v24[0];
    }
    v10 += 8LL;
    v14 = 0xFFFFFA8000000028uLL;
  ...
  v12 = v25;
LABEL_16:
  MiUnlockWorkingSetShared(&unk_140466C80, v12);
  if ( (ULONG_PTR *)v8 == &MiSystemPartition )
  {
    _InterlockedExchangeAdd64(&qword_140466748, -v6);
  ...
  MiReleasePtes(&unk_140466398, v9, (unsigned int)v5);
