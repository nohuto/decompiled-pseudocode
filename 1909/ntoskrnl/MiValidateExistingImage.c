...
__int64 __fastcall MiValidateExistingImage(unsigned int *a1)
{
  ...
  {
    v14 = *(_DWORD *)&KeGetCurrentThread()->ApcState.Process[2].Spare2[7];
  ...
  if ( (v13 & 0x400) != 0 )
  {
    ...
    if ( qword_1404364A0 )
    {
      ...
      v17 = ((__int64 (__fastcall *)(_QWORD, __int64, __int64, _QWORD))qword_1404364A0)(
              v16,
              v8,
              v9,
    ...
    if ( !qword_140436440
      || (LOBYTE(v13) = (unsigned __int8)v13 >> 4, v18 = qword_140436440(v13, v8), v19 = *(_BYTE *)(v11 + 15), !v18)
      || (v16 & 0x40000000) != 0 && (*((_DWORD *)v1 + 23) & 0xC0000) != 0x80000
      || (v19 & 0xF0) == 0 && *(char *)(*(_QWORD *)(v11 + 56) + 46LL) < 0 )
    {
LABEL_48:
      v19 = *(_BYTE *)(v11 + 15);
      v3 = 1;
    ...
    v20 = (int)qword_140436440;
    if ( qword_140436440 )
    {
      LOBYTE(v8) = v2;
      LOBYTE(v13) = v19 >> 4;
      v20 = qword_140436440(v13, v8);
    }
    v4 = v20 == 0;
  }
