/*
 * XREFs of ObpInsertHandleCount @ 0x1406B7F1C
 * Callers:
 *     ObpLockHandleDataBaseEntry @ 0x1406B7DA0 (ObpLockHandleDataBaseEntry.c)
 * Callees:
 *     OBJECT_HEADER_TO_HANDLE_INFO @ 0x14010AB38 (OBJECT_HEADER_TO_HANDLE_INFO.c)
