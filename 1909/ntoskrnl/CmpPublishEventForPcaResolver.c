/*
 * XREFs of CmpPublishEventForPcaResolver @ 0x140826068
 * Callers:
...
unsigned __int8 __fastcall CmpPublishEventForPcaResolver(__int64 a1, unsigned __int16 *a2)
{
  ...
  if ( EtwAppCompatProvRegHandle )
  {
    ...
    if ( result )
    {
      ...
      v7 = *a2;
      v8 = (unsigned __int16 *)CurrentThreadProcess[1].ActiveProcessors.Bitmap[14];
      ...
      if ( (unsigned __int8)v5 != 1 )
        return KiUnstackDetachProcess((struct _KTHREAD *)v13, 0);
    }
  }
  return result;
}
