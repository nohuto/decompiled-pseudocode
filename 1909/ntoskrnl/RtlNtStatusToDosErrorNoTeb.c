/*
 * XREFs of RtlNtStatusToDosErrorNoTeb @ 0x14010C8D0
 * Callers:
...
ULONG __stdcall RtlNtStatusToDosErrorNoTeb(NTSTATUS Status)
{
  ...
  if ( (Status & 0x20000000) == 0 )
  {
    ...
    while ( 1 )
    {
      ...
      if ( v3 >= v6 )
      {
        if ( v7 < (unsigned __int8)byte_140380084[8 * v5] )
        {
          v8 = (unsigned __int16)word_140380086[4 * v5];
          if ( byte_140380085[8 * v5] == 1 )
