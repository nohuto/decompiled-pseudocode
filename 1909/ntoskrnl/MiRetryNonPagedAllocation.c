/*
 * XREFs of MiRetryNonPagedAllocation @ 0x14007C3F8
 * Callers:
...
__int64 __fastcall MiRetryNonPagedAllocation(__int64 a1, __int64 a2)
{
  ...
  for ( i = 1; ; i = KeWaitForSingleObject(&stru_1404694E8, WrFreePage, 0, 0, Timeout) )
  {
    ...
    if ( i == 1 )
    {
      if ( byte_1404641DC == 1 )
      {
        if ( dword_1404641D8 == dword_140469500 )
          goto LABEL_27;
        byte_1404641DC = 0;
      }
    }
    else
    {
      if ( i == 258 )
      {
        if ( !byte_1404641DC )
        {
          dword_1404641D8 = dword_140469500;
          byte_1404641DC = 1;
        }
        goto LABEL_27;
      }
