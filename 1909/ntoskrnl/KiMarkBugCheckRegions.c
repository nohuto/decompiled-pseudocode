/*
 * XREFs of KiMarkBugCheckRegions @ 0x1401AB17C
 * Callers:
...
char __fastcall KiMarkBugCheckRegions(__int64 a1, __int64 a2, unsigned __int64 a3, __int64 a4)
{
  ...
  if ( qword_14042BBA0 )
  {
    *(_QWORD *)&KiMismatchSummary = qword_14042BBA0;
    IoAddTriageDumpDataBlock((ULONG)&KiMismatchSummary, (PVOID)8);
  }
  v7 = 3;
  if ( (_DWORD)a4 == 257 && dword_14042BB98 )
  {
    v8 = qword_14042BB88;
    v9 = 0;
    do
    ...
    while ( v9 < dword_14042BB98 );
    dword_14042BB98 = 4096;
  }
  v18 = &qword_14042BB88;
  v19 = 2LL;
  v20 = &dword_14042BB98;
...
LABEL_47:
  ...
  result = sub_1401BA434(a1, a2, a3, a4);
