/*
 * XREFs of ?SmFeEmpty@?$SMKM_STORE_MGR@USM_TRAITS@@@@SAXPEAU1@@Z @ 0x14031F73C
 * Callers:
...
LABEL_15:
  ...
  if ( (__int64)v11->LockState.LockState < 0 )
    KiAbEntryRemoveFromTree((__int64)&v5->LockEntries[v10]);
...
LABEL_22:
  ...
  if ( v12 && ($C6908ADE9723D0A04AF8EE82D8D15C40 *)v5->ApcState.ApcListHead[0].Flink != &v5->152 )
