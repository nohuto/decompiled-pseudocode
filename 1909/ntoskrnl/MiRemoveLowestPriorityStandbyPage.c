/*
 * XREFs of MiRemoveLowestPriorityStandbyPage @ 0x140161160
 * Callers:
...
LABEL_82:
  ...
  if ( (*(_BYTE *)(CurrentIrql + 34) & 7) != 2
    || *(_QWORD *)(qword_140465E88 + 8 * ((*(_QWORD *)(CurrentIrql + 40) >> 40) & 0x3FFLL)) != a1 )
  {
    goto LABEL_67;
  }
  LockHandle.LockQueue.Lock = v7;
...
LABEL_76:
  ...
  if ( dword_140465F0C == 1 )
  {
    v39 = v11 & 0x1F;
    v13 = 1LL;
    v14 = (volatile signed __int32 *)(qword_140465F68 + 4 * (v11 >> 5));
    if ( v39 + 1 > 0x20 )
    {
      if ( (v11 & 0x1F) != 0 )
      {
