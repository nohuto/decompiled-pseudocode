/*
 * XREFs of ExInitializeTimeRefresh @ 0x140A0EFD4
 * Callers:
...
__int64 *ExInitializeTimeRefresh()
{
  ...
  qword_140432118 = (__int64)ExpTimeRefreshDpcRoutine;
  qword_140432138 = 0LL;
  qword_140432120 = (__int64)&ExpOkToTimeRefresh;
  qword_140432110 = 0LL;
  ...
  qword_1404323A8 = (__int64)&ExpTimerResolutionListHead;
