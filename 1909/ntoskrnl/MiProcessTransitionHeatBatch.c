/*
 * XREFs of MiProcessTransitionHeatBatch @ 0x1402EBD48
 * Callers:
...
LABEL_7:
  ...
  if ( (WORD2(PerfGlobalGroupMask) & 0x200) == 0 )
    goto LABEL_3;
  EtwTraceAutoBoostEntryExhaustion((__int64)v3, (__int64)&qword_140468278);
LABEL_8:
  if ( !v4 )
    goto LABEL_3;
  if ( (unsigned __int64)&qword_140468278 >= 0xFFFF800000000000uLL
    && byte_140467140[(((unsigned __int64)&qword_140468278 >> 39) & 0x1FF) - 256] == 1 )
  {
  ...
  v4->LockState.0 = ($A1A49EE4C6E599293708B9EDC35F5B5E)((unsigned __int64)&qword_140468278 & 0x7FFFFFFFFFFFFFFCLL);
LABEL_16:
  --v3->AbAllocationRegionCount;
  KiAbThreadRemoveBoosts((ULONG_PTR)v3, (__int64)&qword_140468278, &v18);
  ...
  if ( !_InterlockedCompareExchange64((volatile signed __int64 *)&qword_140468278, 17LL, 0LL)
    || ExfTryAcquirePushLockShared(&qword_140468278) )
  {
    if ( v4 )
      v4->AcquiredByte |= 1u;
    for ( i = a1 + 4; ; i += 2 )
...
LABEL_36:
    if ( _InterlockedCompareExchange64((volatile signed __int64 *)&qword_140468278, 0LL, 17LL) != 17 )
      ExfReleasePushLockShared((signed __int64 *)&qword_140468278);
    KeAbPostRelease((ULONG_PTR)&qword_140468278);
  }
  else if ( v4 )
  {
    KeAbPostReleaseEx((ULONG_PTR)&qword_140468278, v4);
  }
