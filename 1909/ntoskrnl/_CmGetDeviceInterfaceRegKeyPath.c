/*
 * XREFs of _CmGetDeviceInterfaceRegKeyPath @ 0x1405C1844
 * Callers:
 ...
 *     RtlStringCchCatExW @ 0x140194EE4 (RtlStringCchCatExW.c)
        ...
        _DWORD *a8)
{
  ...
  pszFormat = (unsigned int)v16 >> 1;
  LOBYTE(v19) = v13;
  dwFlags = (size_t *)PoolWithTag;
  DeviceInterfaceSubkeyPath = CmGetDeviceInterfaceSubkeyPath(v18, a2, v19, v35);
