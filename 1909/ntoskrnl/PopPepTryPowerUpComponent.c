/*
 * XREFs of PopPepTryPowerUpComponent @ 0x1400E0960
 * Callers:
 *     PopPepTriggerComponentActivatingActivity @ 0x1400E06F0 (PopPepTriggerComponentActivatingActivity.c)
 *     PopPepTriggerComponentIdleStateChangeActivity @ 0x140181710 (PopPepTriggerComponentIdleStateChangeActivity.c)
 * Callees:
