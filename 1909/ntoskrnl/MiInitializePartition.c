/*
 * XREFs of MiInitializePartition @ 0x1407506C0
 * Callers:
 ...
 *     MiInitializePfnListHead @ 0x140188EA4 (MiInitializePfnListHead.c)
 *     MiInitializeCombining @ 0x140188ECC (MiInitializeCombining.c)
...
__int64 __fastcall MiInitializePartition(__int64 a1, __int16 a2)
{
  ...
  *(_DWORD *)(a1 + 4) = v3;
  ...
  {
    v6 = 0;
    for ( i = *v5; v6 < dword_1404657B4; i += 40LL )
    {
      *(_DWORD *)(i + 8) = v4;
      ++v6;
  ...
  *(_QWORD *)(a1 + 4168) = v10;
  ...
  v16 = dword_1404657B4;
  v17 = 0;
  for ( k = *(_QWORD *)(a1 + 4136); v17 < 2 * dword_1404657B4; ++v17 )
  {
  ...
  *(_DWORD *)(a1 + 7324) = v20;
  if ( (ULONG_PTR *)a1 == &MiSystemPartition )
    MiInitializePfnListHead((__int64)&qword_1404643C0, 5);
  v21 = 3LL;
  ...
  *(_DWORD *)(a1 + 4) |= 2u;
  v30 = _InterlockedExchangeAdd64((volatile signed __int64 *)&qword_140465E48, 0xFFFFFFFFFFFFFFFFuLL);
  if ( (v30 & 2) != 0 && (v30 & 4) == 0 )
