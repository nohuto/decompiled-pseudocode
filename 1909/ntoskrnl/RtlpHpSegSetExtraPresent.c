/*
 * XREFs of RtlpHpSegSetExtraPresent @ 0x14031B6D4
 * Callers:
 ...
 *     RtlpHpVsChunkSetExtraPresent @ 0x14031BD2C (RtlpHpVsChunkSetExtraPresent.c)
 */
...
unsigned __int64 __fastcall RtlpHpSegSetExtraPresent(__int64 a1, unsigned __int64 a2)
{
  ...
  else
  {
    ...
    if ( v5 == 8 )
    {
      v8 = (unsigned __int16)qword_140436728 ^ *(unsigned __int16 *)(v7 + 40) ^ (unsigned __int64)(unsigned __int16)((unsigned int)v7 >> 12);
      result = 0x4000LL;
