/*
 * XREFs of MiResolvePrivateZeroFault @ 0x1400AD2E0
 * Callers:
...
LABEL_2:
  ...
  v5 = *((_QWORD *)a1 + 1);
  v6 = *(_QWORD *)(v5 + 56);
  v7 = *(_QWORD *)(qword_140465E88 + 8LL * *(unsigned __int16 *)(v6 + 174));
  v42 = v7;
  if ( (v1 & 0x40) != 0 )
  {
...
LABEL_7:
  v15 = *((_QWORD *)a1 + 9);
  if ( v15 )
    v7 = *(_QWORD *)(qword_140465E88 + 8LL * *(unsigned __int16 *)(*(_QWORD *)(v15 + 544) + 1454LL));
  if ( !LargePage )
  {
