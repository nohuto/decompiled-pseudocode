/*
 * XREFs of MiMapCfgBitMapSection @ 0x1406DF860
 * Callers:
...
__int64 __fastcall MiMapCfgBitMapSection(__int64 a1, __int64 a2, __int64 a3, __int64 a4, __int64 a5)
{
  int v5; // r10d
  __int64 v6; // rax
  int v8; // [rsp+40h] [rbp-58h]
  ...
  return MmMapViewOfSectionEx(a2, a1, a4, a3, a5, v5, 1, (__int64)v9, v8, -2147483647, (__int64)&v13);
}
