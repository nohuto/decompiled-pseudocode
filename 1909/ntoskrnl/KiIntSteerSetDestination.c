/*
 * XREFs of KiIntSteerSetDestination @ 0x140134CE0
 * Callers:
 ...
 * Callees:
 *     KiIntSteerVerifyDestination @ 0x140134D5C (KiIntSteerVerifyDestination.c)
...
LABEL_12:
  ...
  result = ((__int64 (__fastcall *)(ULONG_PTR, ULONG_PTR, ULONG_PTR))off_1404245A8[0])(
