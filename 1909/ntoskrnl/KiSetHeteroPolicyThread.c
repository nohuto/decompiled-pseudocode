/*
 * XREFs of KiSetHeteroPolicyThread @ 0x1402AFDA0
 * Callers:
 *     KeSetHeteroCpuPolicyThread @ 0x1402A4930 (KeSetHeteroCpuPolicyThread.c)
 *     KeSetUserHeteroCpuPolicyThread @ 0x1402A494C (KeSetUserHeteroCpuPolicyThread.c)
 *     PopUpdateSingleThreadHeteroPolicies @ 0x1408B3000 (PopUpdateSingleThreadHeteroPolicies.c)
 * Callees:
