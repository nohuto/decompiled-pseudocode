/*
 * XREFs of CmpGetAcpiProfileInformation @ 0x1407613F4
 * Callers:
        ...
        unsigned __int16 *KeyValueInformation)
{
  ...
  OBJECT_ATTRIBUTES ObjectAttributes; // [rsp+60h] [rbp-89h] BYREF
  _OWORD v43[2]; // [rsp+90h] [rbp-59h] BYREF
  __int128 v44; // [rsp+B0h] [rbp-39h] BYREF
  _DWORD KeyInformation[12]; // [rsp+C0h] [rbp-29h] BYREF
  ...
  *(_OWORD *)&ObjectAttributes.SecurityDescriptor = 0LL;
  ...
  if ( v9 < 0 )
    goto LABEL_46;
  ResultLength = 32 * (KeyInformation[5] - 1) + 40;
  ...
  *(_QWORD *)a2 = PoolWithTag;
  ...
  v11 = 0;
  **(_DWORD **)a2 = KeyInformation[5];
  for ( *(_DWORD *)(*(_QWORD *)a2 + 4LL) = 0; v11 < KeyInformation[5]; v5 = 0 )
  {
    ...
    *(_OWORD *)&ObjectAttributes.SecurityDescriptor = 0LL;
    if ( ZwOpenKey(&Handle, 0x20019u, &ObjectAttributes) < 0 )
      break;
    RtlUnicodeStringToInteger(&DestinationString, 0, (PULONG)&v43[1] + 1);
...
LABEL_65:
    ...
    if ( !DWORD1(v43[1]) )
    {
      *(_QWORD *)((char *)&v43[1] + 4) = 0x400000000LL;
      v12 = -1;
      LODWORD(v43[1]) = -1;
    }
    v18 = *(_DWORD **)a2;
...
LABEL_27:
  ...
  *(_OWORD *)&ObjectAttributes.SecurityDescriptor = 0LL;
  ...
  if ( v9 >= 0 )
  {
    v25 = ExAllocatePoolWithTag(PagedPool, 32LL * (unsigned int)(KeyInformation[5] - 1) + 40, 0x20204D43u);
    *(_QWORD *)a3 = v25;
    if ( v25 )
    {
      v25[1] = KeyInformation[5];
      **(_DWORD **)a3 = KeyInformation[5];
      if ( KeyInformation[5] )
      {
        while ( 1 )
        {
