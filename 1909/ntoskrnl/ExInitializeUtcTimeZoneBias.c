/*
 * XREFs of ExInitializeUtcTimeZoneBias @ 0x140A22C8C
 * Callers:
...
__int64 __fastcall ExInitializeUtcTimeZoneBias(PLARGE_INTEGER CurrentTime)
{
  ...
  if ( (int)result >= 0 )
  {
    ...
    RtlpTimeToTimeFields((__int64 *)CurrentTime, &v24, v3);
    if ( HIWORD(v25[8])
      && WORD1(v25[19])
      && RtlCutoverTimeToSystemTime((PTIME_FIELDS)((char *)&v25[8] + 4), &SystemTime, CurrentTime, v6)
      && RtlCutoverTimeToSystemTime((PTIME_FIELDS)&v25[19], &v16, CurrentTime, v7) )
    {
