/*
 * XREFs of NtGetWriteWatch @ 0x14005C290
 * Callers:
 *     <none>
 * Callees:
...
LABEL_217:
  ...
  if ( v64 && ($C6908ADE9723D0A04AF8EE82D8D15C40 *)v21->ApcState.ApcListHead[0].Flink != &v21->152 )
...
LABEL_39:
          ...
          if ( v20 <= v117 )
          {
            ...
            while ( 1 )
            {
              ...
              if ( j < 0xFFFF800000000000uLL || j >= qword_1404672B0 && j <= qword_140465BE0 )
...
LABEL_141:
    ...
    if ( v64 && ($C6908ADE9723D0A04AF8EE82D8D15C40 *)v78->ApcState.ApcListHead[0].Flink != &v78->152 )
      KiCheckForKernelApcDelivery();
    v64 = v76->SpecialApcDisable++ == -1;
    if ( v64 && ($C6908ADE9723D0A04AF8EE82D8D15C40 *)v76->ApcState.ApcListHead[0].Flink != &v76->152 )
      KiCheckForKernelApcDelivery();
    if ( v75 )
