/*
 * XREFs of MiLogReserveVaFailed @ 0x140889574
 * Callers:
...
char __fastcall MiLogReserveVaFailed(__int64 a1, __int64 a2, __int64 a3, __int64 a4)
{
  ...
  if ( hProvider )
  {
    ...
    _m_prefetchw((char *)&Process[2].ActiveProcessors.Bitmap[4] + 4);
    LODWORD(v4) = HIDWORD(Process[2].ActiveProcessors.Bitmap[4]);
    do
    {
      v10 = (int)v4;
    ...
    if ( ((unsigned __int16)v4 & 0x800) == 0 )
    {
      ...
      if ( hProvider->LevelPlus1 > 5 )
      {
        ...
        if ( (_BYTE)v4 )
        {
          ...
          v17 = Process[1].ActiveProcessors.Bitmap[17];
          p_Flink = &Flink;
          v29 = &v14;
          v32 = &v15;
          v35 = &v16;
          ...
          v45 = 8;
          v48 = 8;
          LOBYTE(v4) = TlgWriteEx(v11, &unk_14038D894, 0LL, 1u, 0LL, 0LL, 0xAu, &pData);
        }
      }
    }
  }
