/*
 * XREFs of SmKmStoreHelperCommandProcess @ 0x140148EEC
 * Callers:
 ...
 *     ?SmKmProbeAndLockAddress@@YAJPEAX_KPEAU_MDL@@K@Z @ 0x14014854C (-SmKmProbeAndLockAddress@@YAJPEAX_KPEAU_MDL@@K@Z.c)
