/*
 * XREFs of FopGetTableOffsetAndSize @ 0x140A40D30
 * Callers:
 *     BgpRasInitializeRasterizer @ 0x140A409A0 (BgpRasInitializeRasterizer.c)
 *     BgpFoGetTableOffset @ 0x140A41938 (BgpFoGetTableOffset.c)
 * Callees:
    ...
    if ( v10 )
    {
      while ( 1 )
      {
        ...
        if ( v14 >= 0 )
        {
          ...
          v15 = _byteswap_ulong(HIDWORD(v22));
          v21 = __PAIR64__(_byteswap_ulong(HIDWORD(v21)), v17);
          v22 = __PAIR64__(v15, v16);
        }
        if ( v9 < 0 )
          break;
        if ( v17 == a3 )
