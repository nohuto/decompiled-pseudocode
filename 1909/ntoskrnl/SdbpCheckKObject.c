/*
 * XREFs of SdbpCheckKObject @ 0x140775578
 * Callers:
...
__int64 SdbpCheckKObject(__int64 a1, unsigned int a2, const WCHAR *a3, ...)
{
  ...
  v14 = 0LL;
  if ( !a3
    || (v11 = AslFileMappingCreate((__int64 *)va, a3, (void *)0xFFFFFFFFFFFFFFFFLL, v16, v17), v7 = v14, v11 >= 0) )
  {
    memset((char *)v12 + 4, 0, 0x5CuLL);
    LODWORD(v12[0]) = 26;
