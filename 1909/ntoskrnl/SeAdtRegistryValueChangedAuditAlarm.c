/*
 * XREFs of SeAdtRegistryValueChangedAuditAlarm @ 0x1408DA8F0
 * Callers:
...
LABEL_26:
    ...
    if ( a8 )
    {
      ...
      v48.Buffer = (wchar_t *)&v57;
      AllocatedFullProcessImageName = AdtpBuildReplacementString(v28, &v48);
      if ( AllocatedFullProcessImageName < 0 )
        goto LABEL_43;
    }
    else
    ...
    else
    {
      ...
      AllocatedFullProcessImageName = AdtpBuildReplacementString(v29, &v49);
      if ( AllocatedFullProcessImageName < 0 )
        goto LABEL_43;
    }
    WORD1(v50) = 26;
