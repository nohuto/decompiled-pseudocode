/*
 * XREFs of MiObtainSystemCacheView @ 0x140076770
 * Callers:
...
_QWORD *__fastcall MiObtainSystemCacheView(__int64 a1)
{
  ...
  *(_QWORD *)&LockHandle.OldIrql = 0LL;
  ...
  LockHandle.LockQueue.Lock = qword_140465C20;
  KxAcquireQueuedSpinLock((__int64)&LockHandle, (volatile __int64 *)qword_140465C20);
  if ( *(_BYTE *)(a1 + 7900) )
    goto LABEL_3;
...
LABEL_122:
    ...
    if ( v46 && ($C6908ADE9723D0A04AF8EE82D8D15C40 *)v67->ApcState.ApcListHead[0].Flink != &v67->152 )
...
LABEL_167:
    ...
    if ( (unsigned int)CcUnmapInactiveViews(*(_QWORD *)(a1 + 168), v79, 0LL, &v135) == 1 )
    {
      ...
      if ( MiPteInShadowRange((unsigned __int64)v96) )
      {
        ...
        {
          if ( !HIBYTE(word_1404658EC) && (v101 & 1) != 0 )
            v101 |= v103;
          *v96 = v101;
...
LABEL_175:
          if ( MiPteInShadowRange((unsigned __int64)(v96 + 1)) )
          {
            ...
            {
              if ( !HIBYTE(word_1404658EC) && (v104 & 1) != 0 )
                v104 |= v106;
              v96[1] = v104;
...
LABEL_185:
              if ( MiPteInShadowRange((unsigned __int64)(v96 + 2)) )
              {
                ...
                {
                  if ( !HIBYTE(word_1404658EC) && (v107 & 1) != 0 )
                    v107 |= v109;
                  v96[2] = v107;
          ...
          do
          {
            ...
            if ( qword_140465800 )
            {
              if ( (v28 & 0x10) != 0 )
                ...
                LODWORD(v28) = ~(_DWORD)qword_140465800 & v28;
            }
        ...
        do
        {
          ...
          if ( qword_140465800 )
          {
            if ( (v35 & 0x10) != 0 )
              ...
              v36 = v35 & ~(_DWORD)qword_140465800;
          }
...
LABEL_51:
      ...
      if ( v46 && ($C6908ADE9723D0A04AF8EE82D8D15C40 *)v43->ApcState.ApcListHead[0].Flink != &v43->152 )
        KiCheckForKernelApcDelivery();
      KiLeaveGuardedRegionUnsafe((__int64)CurrentThread);
    }
    if ( v3 == 1 )
...
LABEL_17:
            if ( MiPteInShadowRange(v6 + 16) )
            {
              ...
              {
                if ( !HIBYTE(word_1404658EC) && (v20 & 1) != 0 )
                  v20 |= v115;
                *(_QWORD *)(v6 + 16) = v20;
...
LABEL_98:
  ...
  if ( v46 && ($C6908ADE9723D0A04AF8EE82D8D15C40 *)v56->ApcState.ApcListHead[0].Flink != &v56->152 )
    KiCheckForKernelApcDelivery();
  KiLeaveGuardedRegionUnsafe((__int64)CurrentThread);
  return 0LL;
}
