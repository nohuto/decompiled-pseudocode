/*
 * XREFs of ExAddPrivateDataToCrashDump @ 0x140338B20
 * Callers:
  ...
  while ( 1 )
  {
    ...
    if ( v3 >= 0x500 )
    {
      ...
      if ( ExpNumberOfNonPagedPools )
      {
        while ( 1 )
        {
          v7 = MmAddRangeToCrashDump(a1, ExpNonPagedPoolDescriptor[v6], 512LL);
          if ( v7 < 0 )
          {
            v1 = v7;
            if ( v7 == -1073741789 )
...
LABEL_14:
        ...
        else
        {
          while ( 1 )
          {
            v9 = MmAddRangeToCrashDump(a1, ExpPagedPoolDescriptor[v8], 256LL);
            if ( v9 < 0 )
            {
              v1 = v9;
              if ( v9 == -1073741789 )
