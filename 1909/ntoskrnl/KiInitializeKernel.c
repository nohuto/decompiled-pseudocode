/*
 * XREFs of KiInitializeKernel @ 0x1405A1220
 * Callers:
 ...
 *     KeCompactServiceTable @ 0x14017B018 (KeCompactServiceTable.c)
 ...
 *     KeGetXSaveFeatureFlags @ 0x14018C260 (KeGetXSaveFeatureFlags.c)
...
__int64 __fastcall KiInitializeKernel(__int64 a1, __int64 a2, __int64 a3, ULONG_PTR a4, int a5, __int64 a6)
{
  ...
  *(_QWORD *)(a4 + 24992) = a4 + 24992;
  ...
  else
  {
    ...
    KiInitSystem();
    qword_14044D6D8 = (__int64)&KiProcessListHead;
