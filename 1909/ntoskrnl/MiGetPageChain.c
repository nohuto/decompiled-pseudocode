/*
 * XREFs of MiGetPageChain @ 0x1400AF580
 * Callers:
        ...
        unsigned __int64 *a7)
{
  ...
  if ( a3 )
  {
    ...
    NodeShiftedColor = (unsigned int)((a3 - 1) << byte_14046574D);
  }
  else
  {
  ...
  if ( v19 < v17 )
  {
    while ( 1 )
    {
      ...
      if ( v15 == -1 )
        goto LABEL_14;
      v51 = 15LL;
      if ( (unsigned int)dword_1404657B0 < 0xFuLL )
        v51 = (unsigned int)dword_1404657B0;
      v52 = v51 & v15;
      v68 = v51;
...
LABEL_14:
      ...
      if ( v25 != v58 && ((unsigned __int8)((1 << v25) | (1 << v58)) & (unsigned __int8)byte_140465898) != 0 )
      {
        v53 = v59;
        v71[v59] = Page;
        v59 = v53 + 1;
