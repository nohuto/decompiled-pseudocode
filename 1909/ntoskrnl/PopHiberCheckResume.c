/*
 * XREFs of PopHiberCheckResume @ 0x14059B610
 * Callers:
...
char PopHiberCheckResume()
{
  ...
  v0 = qword_140443000;
  v1 = 0;
  v2 = *(_QWORD *)(qword_140443000 + 200);
  if ( *(_DWORD *)v2 )
  {
    PopCheckpointSystemSleep(25);
    ((void (__fastcall *)(_QWORD))off_140424578[0])(0LL);
    PoResumeFromHibernate = 1;
    v3 = __rdtsc();
    ((void (__fastcall *)(__int64))off_140424400[0])(5LL);
    ((void (__fastcall *)(__int64))off_140424578[0])(1LL);
    if ( HvlHypervisorConnected )
    {
      HvlRestoreEnlightenment(1);
      off_1404244E8[0]();
    }
    ((void (__fastcall *)(__int64))off_140424500[0])(5LL);
    if ( HvlHypervisorConnected )
    {
    ...
    *(_BYTE *)(v0 + 4) = 0;
    qword_1404435A8 = v3;
    qword_140443538 = v3 - qword_140443540;
    if ( (HvlpFlags & 2) != 0 )
      *(_DWORD *)(v0 + 20) = 0;
    return 1;
  }
