/*
 * XREFs of MiCommitExistingVad @ 0x140050A40
 * Callers:
...
LABEL_29:
      ...
      LODWORD(v99) = ((char)v96->AbEntrySummary | (char)v96->AbOrphanedEntrySummary) ^ 0x3F;
...
LABEL_232:
      ...
      else
      {
        ...
        if ( (__int64)v103->LockState.LockState < 0 )
          KiAbEntryRemoveFromTree(&v96->LockEntries[v102], v99);
      ...
      if ( v19 && ($C6908ADE9723D0A04AF8EE82D8D15C40 *)v96->ApcState.ApcListHead[0].Flink != &v96->152 )
  ...
  while ( 1 )
  {
    ...
    if ( !v45 )
    {
      ...
      if ( v28 == 1 )
      {
        ...
        {
          if ( HIBYTE(word_1404658EC) || (v116 & 1) == 0 )
            goto LABEL_284;
LABEL_283:
...
LABEL_86:
  ...
  if ( v133 == 1 )
  {
    ...
    LODWORD(v65) = ((char)v62->AbEntrySummary | (char)v62->AbOrphanedEntrySummary) ^ 0x3F;
...
LABEL_128:
    ...
    else
    {
      ...
      if ( (__int64)v69->LockState.LockState < 0 )
        KiAbEntryRemoveFromTree(&v62->LockEntries[v68], v65);
    ...
    if ( v19 && ($C6908ADE9723D0A04AF8EE82D8D15C40 *)v62->ApcState.ApcListHead[0].Flink != &v62->152 )
      KiCheckForKernelApcDelivery();
    v71 = CurrentThread;
    v19 = CurrentThread->SpecialApcDisable++ == -1;
    if ( v19 && ($C6908ADE9723D0A04AF8EE82D8D15C40 *)v71->ApcState.ApcListHead[0].Flink != &v71->152 )
      KiCheckForKernelApcDelivery();
  }
  if ( v135 == 1 )
  {
