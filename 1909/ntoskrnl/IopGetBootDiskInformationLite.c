/*
 * XREFs of IopGetBootDiskInformationLite @ 0x1409F9CD4
 * Callers:
 *     IoGetBootDiskInformationLite @ 0x140757A80 (IoGetBootDiskInformationLite.c)
 * Callees:
 ...
 *     IopAddBootDiskInformation @ 0x14018A0CC (IopAddBootDiskInformation.c)
