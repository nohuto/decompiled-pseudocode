/*
 * XREFs of MiCheckForUserStackOverflow @ 0x1406C610C
 * Callers:
...
__int64 __fastcall MiCheckForUserStackOverflow(unsigned __int64 a1, int a2)
{
  ...
  else
  {
    ...
    if ( (MiFlags & 0x2000000) == 0 )
      goto LABEL_6;
    v24 = MiObtainReferencedVadEx(a1, 2, &v37);
    v7 = (char *)v24;
    if ( !v24 )
      goto LABEL_6;
    if ( (*(_DWORD *)(v24 + 48) & 0x5100000) != 0x4100000 )
      goto LABEL_6;
    v6 = 1;
    ...
    {
      v27 = ZwAllocateVirtualMemory((HANDLE)0xFFFFFFFFFFFFFFFFLL, &v33, 0LL, &v32, 0x1000u, 0x102u);
      v28 = -1073741571;
      v8 = 275;
      if ( v27 >= 0 )
        v28 = 275;
...
LABEL_6:
  ...
  if ( a1 >= v10 || a1 < v11 )
  {
    v19 = CurrentThread->ApcState.Process[1].ActiveProcessors.Bitmap[6];
    if ( v19 )
    {
      v20 = *(_WORD *)(v19 + 8);
      if ( v20 == 332 || v20 == 452 )
...
LABEL_51:
  ...
  if ( (*(_DWORD *)(CurrentThread->ApcState.Process[1].ActiveProcessors.Bitmap[0] + 188) & 0x10000) != 0 )
  {
    v16 = -1073741523;
  }
  else
