/*
 * XREFs of EtwpAddLastDroppedEvent @ 0x140331B00
 * Callers:
...
__int64 __fastcall EtwpAddLastDroppedEvent(__int64 a1)
{
  ...
  if ( !EtwpAddEventToBuffer(v6, 82LL, v4 + 88, *(_QWORD *)(a1 + 1288), 8 * UsedProcessorCount + 8, v5, &v9) )
    return 3221225990LL;
  v7 = EtwpQueryUsedProcessorCount(a1);
  *v8 = v7;
  memmove(v8 + 2, *(const void **)(a1 + 1288), 8LL * v7);
  return 0LL;
}
