/*
 * XREFs of PopSqmThermalCriticalEvent @ 0x1408B99A0
 * Callers:
 *     PopSqmThermalCriticalShutdown @ 0x1408B9B74 (PopSqmThermalCriticalShutdown.c)
 *     PopSqmThermalHibernate @ 0x1408B9B94 (PopSqmThermalHibernate.c)
 * Callees:
  ...
  if ( v8 )
  {
    ...
    if ( pCallbackContext.LevelPlus1 > 5 )
    {
      ...
      if ( (_BYTE)DeviceAttachmentBaseRefWithTag )
      {
        ...
        LOBYTE(DeviceAttachmentBaseRefWithTag) = TlgWrite(&pCallbackContext, &unk_140391E47, 0LL, 0LL, 0xBu, &pData);
      }
    }
  }
  if ( v7 )
