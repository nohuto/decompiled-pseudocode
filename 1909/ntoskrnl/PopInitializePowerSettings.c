/*
 * XREFs of PopInitializePowerSettings @ 0x140A2103C
 * Callers:
...
const WNF_STATE_NAME *PopInitializePowerSettings()
{
  ...
  qword_140442C68 = (__int64)&PopRegisteredPowerSettingCallbacks;
  PopRegisteredPowerSettingCallbacks = (__int64)&PopRegisteredPowerSettingCallbacks;
  qword_140442C38 = (__int64)&PopPowerSettings;
