/*
 * XREFs of SepDeleteSessionLowboxEntries @ 0x14012D7C8
 * Callers:
...
LABEL_61:
        ...
        if ( v20 && ($C6908ADE9723D0A04AF8EE82D8D15C40 *)v27->ApcState.ApcListHead[0].Flink != &v27->152 )
...
LABEL_87:
    ...
    if ( v20 && ($C6908ADE9723D0A04AF8EE82D8D15C40 *)v35->ApcState.ApcListHead[0].Flink != &v35->152 )
