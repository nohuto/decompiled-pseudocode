/*
 * XREFs of KiCalibrateTimeAdjustment @ 0x14059AE70
 * Callers:
 *     <none>
 * Callees:
 ...
 *     KiPollFreezeExecution @ 0x14013D60C (KiPollFreezeExecution.c)
 *     KeRebaselineInterruptTime @ 0x14015FD9C (KeRebaselineInterruptTime.c)
 *     KiUpdateSystemTime @ 0x14017562C (KiUpdateSystemTime.c)
 *     KiSelectActiveTimerTable @ 0x140179A9C (KiSelectActiveTimerTable.c)
