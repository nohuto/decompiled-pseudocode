/*
 * XREFs of PopAllocateIrp @ 0x140173844
 * Callers:
...
LABEL_21:
    ...
    *((_DWORD *)v34 + 53) = _InterlockedIncrement(&PopCurrentIrpSequenceID);
    ...
    v28 = (_QWORD *)qword_1404436F8;
    if ( *(__int64 **)qword_1404436F8 != &PopIrpList )
      __fastfail(3u);
    *v25 = &PopIrpList;
    v25[1] = v28;
    *v28 = v25;
    qword_1404436F8 = (__int64)v25;
