/*
 * XREFs of ?StDmPageRetrieve@?$ST_STORE@USM_TRAITS@@@@SAJPEAU_ST_DATA_MGR@1@PEAU_STDM_READ_CONTEXT@1@PEAU_ST_WORK_ITEM@1@@Z @ 0x140161FB0
 * Callers:
 ...
 *     MmAreMdlPagesCached @ 0x140164C10 (MmAreMdlPagesCached.c)
...
__int64 __fastcall ST_STORE<SM_TRAITS>::StDmPageRetrieve(__int64 a1, __int64 a2, __int64 a3)
{
  ...
  _QWORD v24[2]; // [rsp+58h] [rbp-18h] BYREF
  ...
  *(_BYTE *)(a3 + 8) = 0;
  ...
  v10 = v24;
  for ( i = ST_STORE<SM_TRAITS>::StDmpSinglePageRetrieve(a1, v4, (unsigned int)&v22, a3, (__int64)v24);
        ;
        i = ST_STORE<SM_TRAITS>::StDmpSinglePageRetrieve(a1, v4, (unsigned int)&v22, a3, (__int64)v10) )
  {
    v15 = i;
    if ( i < 0 )
    {
