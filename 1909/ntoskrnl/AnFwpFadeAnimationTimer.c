        ...
        PVOID SystemArgument2)
{
  ...
  if ( byte_1404F2821 )
  {
    ...
    v56 = qword_140429E48;
    v55 = qword_140429EC0;
    v54 = (_BYTE *)qword_140429E80;
    v57 = (_BYTE *)qword_140429E90;
    v10 = 10 * (dword_140429E40 - dword_140429E40 / (unsigned int)(dword_14042C014 - dword_140429E44));
    v13 = 0;
    if ( (unsigned int)BgpGetBitsPerPixel() == 24 )
    {
      if ( !v9 )
      {
        ...
        v32 = 0LL;
        v33 = *(_QWORD *)(v6 + 24);
        for ( i = *(_QWORD *)(qword_140429E88 + 24);
    ...
    else
    {
      if ( !v9 )
      {
        ...
        v15 = 0LL;
        v16 = *(_QWORD *)(v6 + 24);
        for ( m = *(_QWORD *)(qword_140429E88 + 24);
    ...
    if ( !v7 )
    {
      if ( !v4 && !v22 || (BgpGxDrawRectangle(v54, (__int64)&xmmword_140429E60), !v22) )
        v7 = 1;
    }
    if ( !v8 )
    {
      if ( !v4 && !v23 || (BgpGxDrawRectangle((_BYTE *)v55, (__int64)&xmmword_140429E98), !v23) )
        v8 = 1;
    }
    ...
    if ( v13 || v23 || v22 )
    {
      byte_140429E50 = v7;
      byte_140429E51 = v8;
      dword_140429E40 = v10 / 0xA;
      dword_140429E44 = v4 + 1;
      byte_140429E52 = v9;
    }
    else
    {
