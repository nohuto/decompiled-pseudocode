/*
 * XREFs of PnpQueuePendingSurpriseRemoval @ 0x140731CAC
 * Callers:
...
void __fastcall PnpQueuePendingSurpriseRemoval(PVOID a1, void **a2, int a3, int a4)
{
  ...
  *a2 = 0LL;
  ...
  if ( v5 == v10 )
  {
    ...
    v12 = (__int64 *)qword_140460658;
    if ( *(PVOID **)qword_140460658 != &IopPendingSurpriseRemovals )
LABEL_29:
      __fastfail(3u);
    *(_QWORD *)CriticalMemory = &IopPendingSurpriseRemovals;
    *(_QWORD *)(CriticalMemory + 8) = v12;
    *v12 = CriticalMemory;
    qword_140460658 = CriticalMemory;
  }
  else
  {
