/*
 * XREFs of PpmParkCalculateCoreParkingMask @ 0x140120310
 * Callers:
 *     <none>
 * Callees:
 *     KeGetPrcb @ 0x140005308 (KeGetPrcb.c)
 *     KeEnumerateNextProcessor @ 0x14009E0E0 (KeEnumerateNextProcessor.c)
 *     KeGetClockOwner @ 0x14011FFD0 (KeGetClockOwner.c)
 ...
 *     KeInitializeEnumerationContextFromAffinity @ 0x1402A9990 (KeInitializeEnumerationContextFromAffinity.c)
...
char PpmParkCalculateCoreParkingMask()
{
  ...
  v0 = 0;
  v80 = 0;
  v1 = &PpmCurrentProfile[341 * dword_140443A2C];
  v88 = v1;
