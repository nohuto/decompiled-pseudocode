/*
 * XREFs of MiCompressRelocations @ 0x140643860
 * Callers:
...
char *__fastcall MiCompressRelocations(__int64 a1, int a2)
{
  ...
  if ( !v3 )
    return (char *)a1;
  PoolWithTag = (char *)ExAllocatePoolWithTag(PagedPool, v7 + 8 * (*(_QWORD *)(a1 + 56) + 14LL), 0x65526D4Du);
  v46 = PoolWithTag;
  v22 = PoolWithTag;
  if ( !PoolWithTag )
    return (char *)a1;
  ...
  *((_OWORD *)PoolWithTag + 6) = *(_OWORD *)(a1 + 96);
  PoolWithTag[68] = v5;
  *(_QWORD *)PoolWithTag = PoolWithTag + 112;
  v27 = (__int64)&PoolWithTag[8 * *(_QWORD *)(a1 + 56) + 112];
