/*
 * XREFs of MiIsExtentDangling @ 0x14088C26C
 * Callers:
 *     FsRtlIsExtentDangling @ 0x14084E8D0 (FsRtlIsExtentDangling.c)
...
LABEL_7:
  if ( (v3 & 2) == 0 )
  {
    ...
    ExAcquirePushLockSharedEx((ULONG_PTR)&qword_1404645A8, 0LL);
    v11 = (_QWORD *)qword_1404645A0;
    if ( qword_1404645A0 )
    {
      do
      {
    ...
    if ( _InterlockedCompareExchange64((volatile signed __int64 *)&qword_1404645A8, 0LL, 17LL) != 17 )
      ExfReleasePushLockShared((signed __int64 *)&qword_1404645A8);
