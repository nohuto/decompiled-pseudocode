/*
 * XREFs of RtlpHpSegPageRangeAllocate @ 0x140060280
 * Callers:
 ...
 *     RtlpHpSegHeapAddSegment @ 0x1401364DC (RtlpHpSegHeapAddSegment.c)
 *     RtlpHpSegLargeRangeAllocate @ 0x140176EE4 (RtlpHpSegLargeRangeAllocate.c)
...
LABEL_105:
        ...
        else
        {
          ...
          if ( (__int64)v56->LockState.LockState < 0 )
            KiAbEntryRemoveFromTree(&v49->LockEntries[v55], v52);
        ...
        if ( v23 && ($C6908ADE9723D0A04AF8EE82D8D15C40 *)v49->ApcState.ApcListHead[0].Flink != &v49->152 )
...
LABEL_72:
      ...
      else
      {
        ...
        if ( (__int64)v45->LockState.LockState < 0 )
          KiAbEntryRemoveFromTree(&v38->LockEntries[v44], v41);
      ...
      if ( v23 && ($C6908ADE9723D0A04AF8EE82D8D15C40 *)v38->ApcState.ApcListHead[0].Flink != &v38->152 )
        KiCheckForKernelApcDelivery();
      KiLeaveGuardedRegionUnsafe((__int64)KeGetCurrentThread());
    }
  }
