/*
 * XREFs of RtlpGetTokenNamedObjectPath @ 0x1408D25BC
 * Callers:
 *     RtlGetAppContainerNamedObjectPath @ 0x14030C040 (RtlGetAppContainerNamedObjectPath.c)
 *     RtlGetTokenNamedObjectPath @ 0x1408D1930 (RtlGetTokenNamedObjectPath.c)
 * Callees:
...
LABEL_17:
      AppContainerSidType = NtQueryInformationToken(TokenHandle, TokenIsRestricted|TokenGroups, &v41, 4u, &v40);
      if ( AppContainerSidType < 0 )
        goto LABEL_10;
      if ( v41 )
      {
      ...
      if ( TokenInformation )
      {
        ...
        AppContainerSidType = RtlGetAppContainerParent(v7, (ULONG **)&v38);
        if ( AppContainerSidType < 0
