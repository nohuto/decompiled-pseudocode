/*
 * XREFs of _CmSetDeviceInterfaceMappedPropertyFromRegValue @ 0x14072D3B0
 * Callers:
...
LABEL_11:
  ...
  if ( v19 == 2 )
  {
    ...
    if ( !v23 )
    {
      ...
      if ( a3 )
        v24 = a3;
      v21 = PnpCtxRegCreateKey(a1, v24, L"Device Parameters", 0, 2u, 0LL, &KeyHandle, 0LL);
      if ( v21 == -1073741444 )
        goto LABEL_28;
      if ( v21 < 0 )
        goto LABEL_29;
...
LABEL_54:
  ...
  if ( v8 >= 0 )
  {
    v21 = RegRtlSetValue(Handle, L"DeviceInstance", 1u, a6, a7);
    goto LABEL_19;
  }
LABEL_21:
  if ( Handle )
