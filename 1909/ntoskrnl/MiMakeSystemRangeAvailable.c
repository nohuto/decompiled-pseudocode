/*
 * XREFs of MiMakeSystemRangeAvailable @ 0x1400E6EDC
 * Callers:
        ...
        __int64 a4)
{
  ...
  if ( (_DWORD)a3 == 5 )
    v8 = &qword_140465758[11 * (unsigned int)MiNonPagedPoolToNode(BugCheckParameter2) + 4];
  else
...
LABEL_11:
  ...
  _InterlockedExchangeAdd64(&qword_1404670C8[(int)BugCheckParameter4], -(__int64)v5);
  if ( (_DWORD)BugCheckParameter4 == 8 )
    qword_140465908 += BugCheckParameter3;
