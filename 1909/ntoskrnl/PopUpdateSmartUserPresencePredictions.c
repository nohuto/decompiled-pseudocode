/*
 * XREFs of PopUpdateSmartUserPresencePredictions @ 0x1408B5F7C
 * Callers:
...
void __fastcall PopUpdateSmartUserPresencePredictions(unsigned __int64 a1, unsigned int a2)
{
  ...
  v2 = 0LL;
  if ( !byte_140443A6D && a1 >= MEMORY[0xFFFFF78000000014] && MEMORY[0xFFFFF78000000014] - a1 >= 0x10C388D000LL )
    v2 = a1;
  if ( qword_140442F28 != v2 )
  {
    qword_140442F28 = v2;
    if ( PopSmartUserPresenceAction )
    {
      if ( byte_140442F51 && (PopIdleCancelAoAcDozeS4Timer(a2) || !*((_DWORD *)PopPolicy + 22)) )
