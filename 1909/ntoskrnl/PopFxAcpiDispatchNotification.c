/*
 * XREFs of PopFxAcpiDispatchNotification @ 0x1403042E8
 * Callers:
 *     PoFxPlatformRequestHandler @ 0x140197DA0 (PoFxPlatformRequestHandler.c)
 * Callees:
 ...
 *     PopFxAcpiValidateParameters @ 0x1403048F0 (PopFxAcpiValidateParameters.c)
