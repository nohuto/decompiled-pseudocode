/*
 * XREFs of MiDeletePteList @ 0x140027380
 * Callers:
    ...
    if ( (_DWORD)v6 )
    {
      while ( 1 )
      {
        ...
        do
        {
          ...
          v19 = *(_QWORD *)(v18 + 40);
          v20 = *(_QWORD *)(qword_140465E88 + 8 * ((v19 >> 40) & 0x3FF));
          v60 = v20;
              ...
              if ( *(_WORD *)(v18 + 32) )
              {
                ...
                *(_BYTE *)(v18 + 34) = v56;
                if ( (*(_DWORD *)(v18 + 16) & 0x400LL) == 0 && (unsigned int)MiGetPagingFileOffset(v18 + 16) )
                  *(_BYTE *)(*(_QWORD *)(qword_140465E88 + 8 * ((*(_QWORD *)(v18 + 40) >> 40) & 0x3FFLL)) + 667LL) = 1;
                ++a4[1];
              }
              else if ( (_DWORD)v26 )
              {
                ...
                v28 = *(_QWORD *)(qword_140465E88 + 8 * ((*(_QWORD *)(v18 + 40) >> 40) & 0x3FFLL));
                v68 = *(_QWORD *)(v18 + 16);
                if ( (v68 & 0x400) == 0 )
                {
