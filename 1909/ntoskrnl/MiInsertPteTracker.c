/*
 * XREFs of MiInsertPteTracker @ 0x1402E7A3C
 * Callers:
...
_SLIST_ENTRY *__fastcall MiInsertPteTracker(__int64 a1, int a2, char a3, char a4)
{
  ...
  if ( LOWORD(stru_140466300.Alignment) < 0xAu )
  {
    v8 = RtlpInterlockedPopEntrySList(&stru_140466300);
    goto LABEL_6;
  }
  v9 = RtlpInterlockedFlushSList(&stru_140466300);
  v8 = v9;
  if ( v9 )
  {
    Next = v9->Next;
...
LABEL_15:
  ...
  *((_QWORD *)&v8[3].Next + 1) = *(_QWORD *)(a1 + 48);
  ...
  v22 = (char *)&unk_140466FB0 + 16 * (((unsigned __int8)v21 ^ BYTE4(v21)) & 0xF);
  v23 = *(_QWORD *)v22;
  ...
  *(_QWORD *)v22 = v8;
  qword_1404670B0 += v19;
  v24 = ++qword_1404670B8;
  if ( qword_1404670B8 > (unsigned __int64)qword_1404670C0 )
    qword_1404670C0 = v24;
