/*
 * XREFs of CmpInitializeDelayedCloseTable @ 0x1407589CC
 * Callers:
...
__int64 *CmpInitializeDelayedCloseTable()
{
  ...
  qword_1404637E8 = (__int64)&CmpDelayedLRUListHead;
  ...
  if ( !qword_140464000 )
  {
    ...
    v11 = 4 * xmmword_14058A890;
    v12 = KeServiceDescriptorTable + (unsigned int)(4 * xmmword_14058A890);
    qword_140464018 = v6;
    ...
    qword_140464010 = (__int64)result;
  }
  return result;
}
