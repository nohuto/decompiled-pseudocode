/*
 * XREFs of MiCreateKernelStackNode @ 0x1402C3F5C
 * Callers:
...
_QWORD *__fastcall MiCreateKernelStackNode(_WORD *a1, _QWORD *a2)
{
  ...
  if ( result )
  {
    ...
    result[4] = a2[1];
    *((_WORD *)result + 20) = *a1;
    v6 = ExAcquireSpinLockExclusive(&dword_140466420);
    v7 = (_QWORD *)qword_140466418;
    v8 = 0;
    v9 = v6;
    if ( qword_140466418 )
    {
    ...
    RtlAvlInsertNodeEx((unsigned __int64 *)&qword_140466418, (unsigned __int64)v7, v8, v5);
    ExReleaseSpinLockExclusiveFromDpcLevel(&dword_140466420);
