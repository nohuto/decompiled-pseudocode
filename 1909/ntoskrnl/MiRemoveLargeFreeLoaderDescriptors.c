/*
 * XREFs of MiRemoveLargeFreeLoaderDescriptors @ 0x1409F304C
 * Callers:
...
void __fastcall MiRemoveLargeFreeLoaderDescriptors(__int64 a1)
{
  ...
  qword_140A4F680 = (__int64)&MxDeferredBootFreeDescriptorHead;
