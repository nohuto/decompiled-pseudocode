/*
 * XREFs of MiAddPartitionHugeRange @ 0x1402C180C
 * Callers:
...
__int64 __fastcall MiAddPartitionHugeRange(KSPIN_LOCK *a1, __int64 a2, int a3)
{
  ...
  v11 = v9 & 0x3FFFF;
  v12 = v8 + v11 - 1;
  if ( v12 >= qword_140465EA0 )
    goto LABEL_6;
  if ( v11 > 1 )
  {
    v15 = (__int64 *)(qword_140465EA8 + 8 * (v8 >> 6));
    v16 = *v15;
    v17 = qword_140465EA8 + 8 * (v12 >> 6);
    if ( v15 != (__int64 *)v17 )
    {
...
LABEL_6:
  ...
  else if ( v11 != 1 || _bittest64((const signed __int64 *)qword_140465EA8, v8) )
  {
    goto LABEL_6;
  }
  RtlSetBitsEx((__int64)&qword_140465EA0, v8, v11);
  memset64((void *)(qword_140465EB0 + 8 * v8), v10, v11);
  KeReleaseInStackQueuedSpinLockFromDpcLevel(&LockHandle);
  ...
  v22 = (unsigned __int64 *)(qword_140465EB0 + 8 * v8);
  if ( a3 == 3 )
