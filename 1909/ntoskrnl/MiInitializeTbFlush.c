/*
 * XREFs of MiInitializeTbFlush @ 0x140A0F8D0
 * Callers:
...
ULONG_PTR __fastcall MiInitializeTbFlush(unsigned __int64 a1)
{
  ...
  result = MiReservePtes((__int64)&qword_1404666C0, (unsigned __int64 *)(unsigned int)v1);
  v33 = result;
  v3 = result;
  if ( result )
  {
    v34[3] = 0LL;
    LODWORD(v34[1]) = 20;
    MiMakeValidPte(result, qword_140466548, 1);
    v4 = (__int64)(v3 << 25) >> 16;
    v5 = v4;
    if ( !v1 )
    {
...
LABEL_25:
              if ( v8 == 3 )
                return MiReleasePtes((__int64)&qword_1404666C0, v33, v1);
$exit$104_0:
              qword_140465850 = v10;
              return MiReleasePtes((__int64)&qword_1404666C0, v33, v1);
            }
