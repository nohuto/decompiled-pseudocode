/*
 * XREFs of ViPostPoolAllocation @ 0x140972B4C
 * Callers:
 *     VeAllocatePoolWithTagPriority @ 0x140971F50 (VeAllocatePoolWithTagPriority.c)
 * Callees:
 *     ExpSizeHeapPool @ 0x14033EF18 (ExpSizeHeapPool.c)
 */
  ...
  *a1 = v2;
  ...
  if ( (a2 & 1) != 0 )
  {
    ...
    if ( v12 > *(_DWORD *)(v6 + 104) )
      *(_DWORD *)(v6 + 104) = v12;
    v13 = v7 + _InterlockedExchangeAdd64(&qword_140446370, v7);
    if ( v13 > qword_140446380 )
      qword_140446380 = v13;
    v14 = _InterlockedIncrement(&dword_140446360);
    if ( v14 > dword_140446368 )
      dword_140446368 = v14;
  }
  else
  {
    ...
    if ( v16 > *(_DWORD *)(v6 + 108) )
      *(_DWORD *)(v6 + 108) = v16;
    v17 = v7 + _InterlockedExchangeAdd64(&qword_140446378, v7);
    if ( v17 > qword_140446388 )
      qword_140446388 = v17;
    v18 = _InterlockedIncrement(&dword_140446364);
    if ( v18 > dword_14044636C )
      dword_14044636C = v18;
  }
  result = v2;
  *v9 = a1;
