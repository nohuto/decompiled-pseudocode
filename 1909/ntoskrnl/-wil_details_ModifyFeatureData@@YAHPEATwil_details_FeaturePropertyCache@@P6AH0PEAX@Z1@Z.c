/*
 * XREFs of ?wil_details_ModifyFeatureData@@YAHPEATwil_details_FeaturePropertyCache@@P6AH0PEAX@Z1@Z @ 0x140004530
 * Callers:
        ...
        void *a3)
{
  ...
  while ( 1 )
  {
    LODWORD(v7) = dword_1404F2B94;
    v5 = dword_1404F2B94;
    result = a2(&v7, a3);
    if ( !(_DWORD)result )
      break;
    if ( v5 == _InterlockedCompareExchange(&dword_1404F2B94, (signed __int32)v7, v5) )
      return 1LL;
  }
  return result;
}
