/*
 * XREFs of PopCheckAndHandleThermalConditions @ 0x140196720
 * Callers:
...
LABEL_4:
  ...
  if ( *(_BYTE *)(a1 + 72) != result )
  {
    ...
    *(_BYTE *)(a1 + 72) = v18;
    if ( v18 )
    {
      if ( ++dword_1404429E4 == 1 )
      {
        byte_1404429EC = 1;
        ++dword_1404429E8;
        PopTraceCr3Tripped();
      }
      PopTraceZoneCr3Tripped((unsigned int)dword_1404429E8, a1);
    }
    else
    {
      PopTraceZoneCr3Mitigated((unsigned int)dword_1404429E8, a1);
      --dword_1404429E4;
    }
    if ( dword_1404429E4 )
    {
    ...
    else
    {
      ...
      PopTraceCr3Mitigated((unsigned int)dword_1404429E8);
