/*
 * XREFs of CmpCreateHive @ 0x14068E190
 * Callers:
        ...
        __int64 a12)
{
  ...
  _OWORD *v66; // [rsp+B8h] [rbp-48h]
  __int64 v67; // [rsp+C0h] [rbp-40h]
  _BYTE *v68; // [rsp+C8h] [rbp-38h]
  _OWORD *v69; // [rsp+D0h] [rbp-30h]
  ...
  *(_QWORD *)a12 = v15;
  ...
  if ( v33 == 2 || v33 == 5 || !v33 && a6 && *(_QWORD *)a6 )
  {
    ...
    if ( (unsigned __int8)CmpVolumeContextMustHiveFilePagesBeKeptLocal(*(_QWORD *)(v15 + 4832)) || (a8 & 0x2000000) != 0 )
      ...
      v34 = v57;
    LOBYTE(v36) = v58 == 0;
    ContextForFile = HvHiveStartFileBacked(v15, v36, v34, v62, v71, v61, v49, v64, v66, v69, v68, &v63, a12);
    if ( ContextForFile < 0 )
    {
    ...
    if ( ContextForFile == -2147483606 )
    {
      ...
      else
      {
        ...
        if ( TlgKeywordOn(&stru_140425BC0, 0x400000000000uLL) )
        {
          ...
          v86 = 2LL;
          v89 = 0;
          TlgWrite(&stru_140425BC0, &unk_14038BE7A, 0LL, 0LL, 9u, &pData);
        }
      }
    }
    if ( ContextForFile < 0 )
