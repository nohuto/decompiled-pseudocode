/*
 * XREFs of KiInitializeUserApc @ 0x14012C5E0
 * Callers:
        ...
        unsigned int a7)
{
  ...
  *(_WORD *)(a2 + 368) = 51;
  ...
  if ( result >= qword_1404640D0 )
  {
    ...
    while ( v18 >= 8 )
    {
      v19 = __ROR8__(v19 - *v16++, qword_1404640C8);
      v18 -= 8;
    }
    while ( v18 )
    {
      v19 = __ROR8__(v19 - *(unsigned __int8 *)v16, qword_1404640C8);
      v16 = (_QWORD *)((char *)v16 + 1);
      --v18;
    }
    if ( qword_1404640D8 != v19 )
    {
      if ( qword_140464090 )
        goto LABEL_22;
      qword_140464090 = (unsigned int)__ROR4__(150994945, 88);
      qword_140464098 = 0LL;
      qword_1404640A0 = 0LL;
      qword_1404640A8 = 269LL;
      qword_1404640B0 = v22;
    }
    if ( !qword_140464090 )
    {
LABEL_21:
      ...
      qword_1404640D0 = result;
      return result;
    }
LABEL_22:
    if ( stru_140464050.DeferredRoutine != KiScanQueues )
    {
      stru_140464050.TargetInfoAsUlong = 275;
      stru_140464050.DeferredRoutine = KiScanQueues;
      stru_140464050.DeferredContext = &stru_140464050;
      stru_140464050.DpcData = 0LL;
      stru_140464050.ProcessorHistory = 0LL;
    }
    qword_1404640B8 = 604032LL;
    KeInsertQueueDpc(&stru_140464050, 0LL, 0LL);
    goto LABEL_21;
  }
  return result;
}
