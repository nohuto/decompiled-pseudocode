/*
 * XREFs of MmCreateTeb @ 0x14061001C
 * Callers:
...
__int64 __fastcall MmCreateTeb(_KPROCESS *BugCheckParameter1, __int64 a2, _QWORD *a3, __int64 a4, _QWORD *a5)
{
  ...
  v9 = 3;
  v10 = 0LL;
  v11 = BugCheckParameter1[1].ActiveProcessors.Bitmap[6];
  if ( v11 )
    v10 = *(_QWORD *)v11;
  if ( v10 )
  {
  ...
  *(_QWORD *)(v13 + 96) = v18[1].ActiveProcessors.Bitmap[0];
...
LABEL_9:
  ...
  if ( v9 == 5 )
  {
    ...
    *(_QWORD *)(v13 + 0x2000) = 0xFFFFFFFFLL;
    *(_QWORD *)(v13 + 8288) = v10;
    *(_DWORD *)(v13 + 14144) = 0;
