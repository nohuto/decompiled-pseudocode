/*
 * XREFs of MiOutPageSingleKernelStack @ 0x1400BEC90
 * Callers:
 *     <none>
 * Callees:
...
unsigned __int64 __fastcall MiOutPageSingleKernelStack(__int64 a1, _QWORD *a2, __int64 a3)
{
  ...
  __int64 AnyMultiplexedVm; // [rsp+28h] [rbp-90h]
  ...
  v13 = v11 + 1280;
  v14 = *(_QWORD *)(qword_140465E88 + 8 * v12);
  if ( (ULONG_PTR *)v14 != &MiSystemPartition )
  {
    result = MiCreateKernelStackNode(*(_QWORD *)(qword_140465E88 + 8 * v12), a2);
    if ( !result )
      return result;
    v7 = v54;
    v8 = 0x7FFFFFFFF8LL;
  ...
  v61 = MiLockWorkingSetShared(AnyMultiplexedVm);
...
LABEL_21:
  ...
  MiUnlockWorkingSetShared(v38, v61);
