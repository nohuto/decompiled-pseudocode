/*
 * XREFs of MiMapViewInSystemSpace @ 0x140647E94
 * Callers:
 ...
 *     MmMapViewInSessionSpaceEx @ 0x1406DE560 (MmMapViewInSessionSpaceEx.c)
 *     MmMapViewInSystemSpaceEx @ 0x1406EC210 (MmMapViewInSystemSpaceEx.c)
 * Callees:
