/*
 * XREFs of MiCheckProcessorPteCache @ 0x140030D20
 * Callers:
...
LABEL_33:
  while ( 2 )
  {
    ...
    if ( qword_140466708 )
    {
      while ( qword_1404666C0 < v26 )
      {
        KeAcquireInStackQueuedSpinLock(&qword_1404666F0, &LockHandle);
      ...
      v27 = &v53;
      v53 = qword_1404666C0 - v26;
      v54 = qword_1404666C8 + 8 * (v26 >> 6);
      if ( v25 )
        v25 -= v26;
    }
LABEL_37:
...
LABEL_67:
      if ( !v29 )
      {
        if ( !(unsigned int)MiEmptyPteBins(&qword_1404666C0, 0LL, -1LL, v26) )
          return 0LL;
        v25 = 0LL;
        goto LABEL_33;
      }
...
LABEL_42:
    ...
    v36 = *(_QWORD *)(qword_1404666C8 + 8 * (v35 >> 6));
    v37 = (volatile signed __int64 *)(qword_1404666C8 + 8 * (v35 >> 6));
    if ( v36 == -1LL )
      goto LABEL_92;
    while ( 1 )
    {
...
LABEL_10:
  if ( v5 != -1LL )
  {
    ...
    if ( v14 + a1 <= 8 )
    {
      v16 = byte_140382448[a1] << v14;
      goto LABEL_13;
    }
    if ( (v5 & 7) != 0 )
    {
      *v15++ |= byte_140381050[v14];
    ...
    if ( a1 )
    {
      v16 = byte_140382448[a1];
LABEL_13:
      *v15 |= v16;
    }
LABEL_14:
    v4 = qword_1404666D0 + 8 * (v5 + CurrentPrcb->PteBitOffset);
  }
