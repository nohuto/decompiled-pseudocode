/*
 * XREFs of MiGetNextNonGapPfnPage @ 0x140186558
 * Callers:
...
__int64 __fastcall MiGetNextNonGapPfnPage(unsigned __int64 *a1, unsigned __int64 *a2, char a3, int a4)
{
  ...
  if ( v4 <= v8 )
  {
    while ( 2 )
    {
      ...
      NextPageTable = MiGetNextPageTable(v4, v8, 0LL, a3, v9, &v24);
      v4 = NextPageTable;
      if ( NextPageTable )
      {
        if ( !a4 )
        ...
        else
        {
          ...
          if ( v21 )
          {
            ...
            {
              v23 = v21 + 8;
              if ( v23 > v8 || (v23 & 0xFFF) == 0 || !(unsigned int)MiPfnDatabaseVaIsUnique(v23) )
                break;
            }
            goto LABEL_40;
          }
