/*
 * XREFs of AuthzBasepGetSecurityAttributesCopyoutBufferSize @ 0x1400CF540
 * Callers:
 ...
 *     AuthzBasepGetSecurityAttributeValueCopyoutBufferSize @ 0x1400CFD00 (AuthzBasepGetSecurityAttributeValueCopyoutBufferSize.c)
 */
