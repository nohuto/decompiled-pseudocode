/*
 * XREFs of PopFxEnableWorkOrderWatchdog @ 0x1400E3DE4
 * Callers:
...
__int64 __fastcall PopFxEnableWorkOrderWatchdog(__int64 a1, unsigned int a2)
{
  ...
  __int64 v16; // rdx
  __int64 v17; // rdx
  $C6908ADE9723D0A04AF8EE82D8D15C40 *v18; // rcx
    ...
    *(_QWORD *)(v2 + 168) = KeGetCurrentThread();
    if ( a2 )
    {
      ...
      *(_QWORD *)(v2 + 160) = v3;
      ...
      v4 = (__int64 *)qword_1404443E8;
      if ( *(__int64 **)qword_1404443E8 != &PopWorkOrderList )
        __fastfail(3u);
      *(_QWORD *)(v2 + 8) = qword_1404443E8;
...
LABEL_22:
      ...
      if ( v9 )
      {
        ...
        if ( ($C6908ADE9723D0A04AF8EE82D8D15C40 *)v18->ApcState.ApcListHead[0].Flink != v18 )
