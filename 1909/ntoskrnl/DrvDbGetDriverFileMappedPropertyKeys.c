/*
 * XREFs of DrvDbGetDriverFileMappedPropertyKeys @ 0x14093F6DC
 * Callers:
        ...
        __int64 a6)
{
  ...
  *(_DWORD *)a6 = 0;
  v10 = a4;
  v11 = a1;
  CompositeMappedPropertyKeys = DrvDbGetCompositeMappedPropertyKeys(a1, (_OWORD **)off_1404280F8, 1u, a4, a5, v27);
