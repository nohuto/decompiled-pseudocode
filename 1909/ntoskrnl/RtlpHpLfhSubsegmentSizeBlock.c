/*
 * XREFs of RtlpHpLfhSubsegmentSizeBlock @ 0x14031B7E0
 * Callers:
 *     RtlpHpSegSizeInternal @ 0x14031B754 (RtlpHpSegSizeInternal.c)
 * Callees:
 *     RtlpHpLfhSubsegmentSizeBlockInternal @ 0x14031B89C (RtlpHpLfhSubsegmentSizeBlockInternal.c)
 */
...
__int64 __fastcall RtlpHpLfhSubsegmentSizeBlock(__int64 a1, __int64 a2, __int64 a3)
{
  ...
  v5 = qword_140436728 ^ *(_DWORD *)(a2 + 40) ^ ((unsigned int)a2 >> 12);
