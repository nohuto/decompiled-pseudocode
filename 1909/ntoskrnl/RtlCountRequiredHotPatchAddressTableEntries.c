/*
 * XREFs of RtlCountRequiredHotPatchAddressTableEntries @ 0x1408D7E6C
 * Callers:
 *     MiPrepareToHotPatchImage @ 0x1408904FC (MiPrepareToHotPatchImage.c)
 * Callees:
 *     RtlGetHotPatchSize @ 0x140314F20 (RtlGetHotPatchSize.c)
 *     RtlpCheckFunctionPatchApplied @ 0x1405AE368 (RtlpCheckFunctionPatchApplied.c)
 */
