/*
 * XREFs of MiCreateEnclaveRegions @ 0x140A19A58
 * Callers:
...
LABEL_21:
    ...
    v10 = 0;
LABEL_15:
    RtlAvlInsertNodeEx((unsigned __int64 *)&qword_1404658C8, (unsigned __int64)v11, v10, v1);
LABEL_16:
  ...
  return !qword_1404658C8 || (unsigned int)MiInitializeEnclaveMetadataPage();
}
