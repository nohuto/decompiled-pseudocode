/*
 * XREFs of WmiQueryTraceInformation @ 0x140718910
 * Callers:
        ...
        PVOID Buffer)
{
  ...
  struct _KTHREAD *v57; // [rsp+48h] [rbp-20h]
  ...
  if ( TraceInformationClass > TraceHandleByNameClass )
  {
    ...
    if ( v16 )
    {
      ...
      if ( !v18 )
      {
        ...
        *((_OWORD *)TraceInformation + 1) = *(_OWORD *)off_14094A050;
        *((_OWORD *)TraceInformation + 2) = *(_OWORD *)&off_14094A060;
        *((_OWORD *)TraceInformation + 3) = *(_OWORD *)&off_14094A070;
        *((_OWORD *)TraceInformation + 4) = *(_OWORD *)off_14094A080;
        *((_OWORD *)TraceInformation + 5) = *(_OWORD *)&off_14094A090;
        *((_OWORD *)TraceInformation + 6) = *(_OWORD *)off_14094A0A0;
...
LABEL_96:
  ...
  if ( v57->PreviousMode && *(_WORD *)Buffer )
  {
    v42 = *((_QWORD *)Buffer + 1);
    if ( (v42 & 1) != 0 )
  ...
  if ( (_DWORD)v6 != 8 )
    return -1073741820;
  v55 = 0LL;
  result = EtwQueryTraceHandleByLoggerName((const UNICODE_STRING *)Buffer, &v55);
  v52 = result;
  if ( result >= 0 )
    goto LABEL_96;
  return result;
