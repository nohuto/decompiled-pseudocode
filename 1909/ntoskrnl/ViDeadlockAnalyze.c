/*
 * XREFs of ViDeadlockAnalyze @ 0x14097BEEC
 * Callers:
 ...
 *     ViDeadlockAddParticipant @ 0x14097BB60 (ViDeadlockAddParticipant.c)
 *     ViDeadlockAnalyze @ 0x14097BEEC (ViDeadlockAnalyze.c)
 *     ViDeadlockCertify @ 0x14097C1D0 (ViDeadlockCertify.c)
    ...
    if ( (unsigned int)ViDeadlockCertify(a5, a2) )
    {
      *((_QWORD *)ViDeadlockGlobals + 4107) = a1;
      ViDeadlockPreprocessOptions(
        ...
        a2,
        0LL);
      VfReportIssueWithOptions(0xC4u, 0x1001uLL, a1, a2, 0LL, byte_14042B97C);
      return 0LL;
    }
    v8 = 0;
    goto LABEL_30;
