/*
 * XREFs of MiDecommitHardwareEnclavePages @ 0x1402D3880
 * Callers:
 ...
 *     RtlInterlockedSetClearRun @ 0x14008B4F0 (RtlInterlockedSetClearRun.c)
 ...
 *     MiGetExceptionInfo @ 0x1402C30C4 (MiGetExceptionInfo.c)
          ...
          if ( v24 < 0 )
          {
            ...
            else
            {
              if ( !v57 )
              {
                while ( 1 )
                {
                  v26 = *(unsigned int *)qword_1404658D8;
                  v27 = (*(_DWORD *)(qword_1404658D8 + 8) & 4) != 0LL ? 0x20 : 0;
                  v28 = v27 + v26 - 1;
                  i = -(*(_QWORD *)(qword_1404658D8 + 8) & 4LL);
                  v30 = *(_QWORD *)(qword_1404658D8 + 8) - ((*(_QWORD *)(qword_1404658D8 + 8) & 4LL) != 0 ? 4 : 0);
                  if ( (_DWORD)v26 )
                  {
...
LABEL_32:
                  ...
                  if ( v9 == -1 )
                    break;
                  if ( (unsigned int)RtlInterlockedSetClearRun(qword_1404658D8, v9, 1u) )
                    goto LABEL_45;
                }
...
LABEL_45:
        ...
        else
        {
          do
          {
            ExAcquireSpinLockShared(&dword_1404658E8);
            v35 = KeOutPageEnclavePage(v22, *(_QWORD *)(v61 + 88));
            ExReleaseSpinLockSharedFromDpcLevel(&dword_1404658E8);
          }
...
LABEL_51:
  ...
  if ( v57 )
  {
    ...
    {
      v49 = 1;
      v50 = (volatile signed __int32 *)(*(_QWORD *)(qword_1404658D8 + 8) + 4 * ((unsigned __int64)v9 >> 5));
      v51 = v9 & 0x1F;
      result = v51 + 1;
    ...
    {
      v37 = _InterlockedExchangeAdd64((volatile signed __int64 *)&qword_1404658E0, 0xFFFFFFFFFFFFFFFFuLL);
      v73 = v37;
      if ( (v37 & 2) != 0 && (v37 & 4) == 0 )
        ExfTryToWakePushLock((volatile signed __int64 *)&qword_1404658E0);
      v58 = 0;
      v38 = KeGetCurrentThread();
      if ( (unsigned int)MiGetSystemRegionType((unsigned __int64)&qword_1404658E0) == 1 )
      ...
      while ( 1 )
      {
        ...
        if ( (v44->AcquiredByte & 1) != 0
          ...
          && (*(_QWORD *)&v44->LockState.0 & 0x7FFFFFFFFFFFFFFCLL) == ((unsigned __int64)&qword_1404658E0 & 0x7FFFFFFFFFFFFFFCLL)
      ...
      {
        KeBugCheckEx(0x162u, (ULONG_PTR)v38, (ULONG_PTR)&qword_1404658E0, SessionId, 0LL);
      }
      --v38->AbAllocationRegionCount;
      KiAbThreadRemoveBoosts((ULONG_PTR)v38, (__int64)&qword_1404658E0, &v58);
      v45 = v38->SpecialApcDisable++ == -1;
      if ( v45 && ($C6908ADE9723D0A04AF8EE82D8D15C40 *)v38->ApcState.ApcListHead[0].Flink != &v38->152 )
