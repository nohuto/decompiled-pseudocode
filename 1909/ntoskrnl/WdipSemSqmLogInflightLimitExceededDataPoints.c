/*
 * XREFs of WdipSemSqmLogInflightLimitExceededDataPoints @ 0x1406BCF08
 * Callers:
...
__int64 WdipSemSqmLogInflightLimitExceededDataPoints()
{
  ...
  v3 = (unsigned int)dword_1404333A0;
  if ( dword_1404333A0 )
  {
    v1 = WdipSemSqmIncrementDword(v2, (unsigned int)dword_1404333A0);
    if ( v1 < 0 )
      v1 = 0;
    if ( (_DWORD)v3 )
    {
  ...
  for ( i = 0; i < dword_1404333A0; WdipSemFrequentScenarioTable[v8] = 0LL )
  {
    v8 = i;
