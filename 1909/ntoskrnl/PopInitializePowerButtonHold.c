/*
 * XREFs of PopInitializePowerButtonHold @ 0x140A07328
 * Callers:
...
int __fastcall PopInitializePowerButtonHold(int a1)
{
  ...
  *(_QWORD *)&DestinationString.Length = 0LL;
        ...
        *(_OWORD *)&ObjectAttributes.SecurityDescriptor = 0LL;
        ...
        if ( result >= 0 )
        {
          *(_QWORD *)PopPowerButtonBugcheckWatchWorkItem = 0LL;
          qword_1404388F0 = (__int64)PopPowerButtonBugcheckWatchCallback;
          qword_1404388F8 = (__int64)KeyHandle;
  ...
  else
  {
    ...
    memset(&unk_140438908, 0, 0xC8uLL);
    memset(&PopPowerButtonTriageBlock, 0, 0x70uLL);
    dword_140438A30 = 0;
    dword_140438A34 = 0;
    PopPowerButtonHold = 0LL;
    qword_140438A40 = (__int64)&PopBlackBoxEntries;
    LODWORD(PopPowerButtonTriageBlock) = 2;
    dword_140438A48 = 20;
    return PopInitializeWorkItem((__int64)&unk_140438990, (__int64)PopPowerButtonWorkCallback, 0LL);
  }
  return result;
}
