/*
 * XREFs of ExpOsProductCacheProviderHelper @ 0x1406D2130
 * Callers:
 ...
 *     ExpOsProductContentIdCacheProvider @ 0x14090C530 (ExpOsProductContentIdCacheProvider.c)
 *     ExpOsProductPfnCacheProvider @ 0x14090C570 (ExpOsProductPfnCacheProvider.c)
 * Callees:
        ...
        _BYTE *ResultLength)
{
  ...
  KeyHandle = 0LL;
  *ResultLength = 1;
  ValueKey = ZwOpenKey(&KeyHandle, 0x20019u, (POBJECT_ATTRIBUTES)&stru_140947F40);
  if ( ValueKey >= 0 )
  {
