/*
 * XREFs of RtlCSparseBitmapFindBitSetCapped @ 0x1400202F4
 * Callers:
 *     RtlSparseArrayElementAllocated @ 0x14002029C (RtlSparseArrayElementAllocated.c)
 *     RtlSparseArrayElementFindCapped @ 0x14031B948 (RtlSparseArrayElementFindCapped.c)
 * Callees:
 *     RtlLengthCurrentClearRunForwardEx @ 0x14030D3C4 (RtlLengthCurrentClearRunForwardEx.c)
 */
...
__int64 __fastcall RtlCSparseBitmapFindBitSetCapped(__int64 a1, signed __int64 a2, __int64 a3)
{
  ...
  const signed __int64 *v29; // [rsp+50h] [rbp-48h]
  ...
  while ( a3 )
  {
    ...
    if ( _bittest64((const signed __int64 *)(a1 + 56), (unsigned __int64)a2 >> 30) )
    {
      if ( _bittest64(*(const signed __int64 **)a1, (unsigned __int64)a2 >> 15) )
      {
        ...
        if ( v8 > 1 )
          v10 = v8;
        v11 = (const signed __int64 *)(*(_QWORD *)(a1 + 8) + (v7 << 12));
        v28 = v6 + v10;
        v29 = v11;
        ...
        else if ( v8 <= 0 )
        {
          ...
          v15 = (a2 % 0x8000) & 0x1F;
          v16 = *(_DWORD *)v14 & dword_14037C900[v15];
