/*
 * XREFs of NormBuffer__SortBeforeSameClass @ 0x140313890
 * Callers:
 *     NormBuffer__AppendAndSortDecomposed @ 0x1403132D4 (NormBuffer__AppendAndSortDecomposed.c)
 * Callees:
 *     NormBuffer__GetCurrentOutputChar @ 0x140313380 (NormBuffer__GetCurrentOutputChar.c)
 *     Normalization__PageLookup @ 0x1408D7594 (Normalization__PageLookup.c)
 *     Normalization__TableLookup @ 0x1408D75AC (Normalization__TableLookup.c)
 */
