/*
 * XREFs of CcSetDirtyPinnedData @ 0x140079B20
 * Callers:
...
void __stdcall CcSetDirtyPinnedData(PVOID BcbVoid, PLARGE_INTEGER Lsn)
{
  ...
  if ( *(_WORD *)BcbVoid != 765 && v3 != 762 )
    KeBugCheckEx(0x34u, 0xE54uLL, 0xFFFFFFFFC0000420uLL, 0LL, 0LL);
  v4 = BcbVoid;
  v5 = v53;
  v53[0] = BcbVoid;
  v53[1] = 0LL;
  ...
  if ( *(_QWORD *)(v6 + 168) )
  {
    ...
    else
    {
      ...
      if ( _interlockedbittestandset(&dword_140464280, 0x1Fu) )
      {
        ...
        v56 = ExpWaitForSpinLockExclusiveAndAcquire(&dword_140464280, CurrentIrql);
      }
      v12 = dword_140464280;
      while ( (v12 & 0xBFFFFFFF) != 0x80000000 )
      {
        if ( (v12 & 0x40000000) == 0 )
        {
          v47 = _InterlockedCompareExchange(&dword_140464280, v12 | 0x40000000, v12);
          v25 = v12 == v47;
          v12 = v47;
          if ( !v25 )
            continue;
    ...
    if ( *(_QWORD *)v8 )
      v13 = *(ULONG_PTR **)(qword_140465E88 + 8LL * (*(_WORD *)(*(_QWORD *)v8 + 60LL) & 0x3FF));
    else
  ...
  if ( (v16 & 0x200) != 0 )
  {
    ...
    if ( *v5 )
    {
      while ( 1 )
      {
        ...
        ++v5;
        if ( (v17 & 1) != 0 )
          KeBugCheckEx(0x34u, 0xEB4uLL, 0xFFFFFFFFC0000420uLL, 0LL, 0LL);
        v18 = *(_QWORD *)(v17 + 176);
        v58 = 0;
