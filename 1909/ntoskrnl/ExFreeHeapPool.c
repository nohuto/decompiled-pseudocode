/*
 * XREFs of ExFreeHeapPool @ 0x140064E50
 * Callers:
 ...
 *     ExFreePoolEx @ 0x14012FDC0 (ExFreePoolEx.c)
...
LABEL_7:
      ...
      if ( v32 )
      {
        ...
        if ( v32 != PsInitialSystemProcess )
        {
          ...
          if ( *(_QWORD *)&v65[v70 + 80] )
          {
            if ( v37 > v36 )
            {
              v68 = (unsigned __int64 *)(0x140000000LL + 56LL * (v8 & 1) + 4418216);
              v54 = *v68;
              if ( v37 - v36 > *v68 )
              {
                if ( v54 > v33 )
  ...
  else
  {
    ...
    if ( (v46 & 0x20) != 0 )
    {
      v48 = *(_QWORD *)(qword_1404656D8 + 1272);
      v49 = (volatile signed __int32 *)(qword_1404656D8 + 1144);
      v50 = *(_QWORD *)(qword_1404656D8 + 1280);
    }
    else
    {
