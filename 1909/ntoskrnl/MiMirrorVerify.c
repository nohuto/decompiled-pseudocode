/*
 * XREFs of MiMirrorVerify @ 0x14016A160
 * Callers:
...
__int64 __fastcall MiMirrorVerify(__int64 a1)
{
  ...
  while ( 1 )
  {
    v5 = v4 & -(__int64)(v4 < qword_140465F50);
    v6 = qword_140465F50 - 1;
    while ( 1 )
    {
      if ( v6 - v5 == -1LL )
        goto LABEL_7;
      v7 = (_QWORD *)(qword_140465F58 + 8 * (v5 >> 6));
      for ( i = ~*v7 | ((1LL << (v5 & 0x3F)) - 1); i == -1; i = ~*v7 )
      {
        if ( (unsigned __int64)++v7 > qword_140465F58 + 8 * (v6 >> 6) )
          goto LABEL_7;
      }
      _BitScanForward64(&v10, ~i);
      v9 = v10 + (((__int64)v7 - qword_140465F58) >> 3 << 6);
      if ( v9 > v6 )
      {
LABEL_7:
        v9 = -1LL;
    ...
    if ( qword_140465F50 > v9 )
    {
      v13 = v9;
      v14 = qword_140465F58 + 4 * ((unsigned __int64)(qword_140465F50 - 1) >> 5);
      v15 = (_DWORD *)(qword_140465F58 + 4 * (v9 >> 5));
      if ( v15 != (_DWORD *)v14 && (*v15 | dword_14037C900[v9 & 0x1F]) == -1 )
      {
...
LABEL_38:
        for ( j = v12 + v13;
              j < qword_140465F50 && !_bittest64((const signed __int64 *)qword_140465F58, j) && v12 != -1LL;
              ++j )
        {
          ++v12;
        }
