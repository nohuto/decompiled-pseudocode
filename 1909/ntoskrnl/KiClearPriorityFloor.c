/*
 * XREFs of KiClearPriorityFloor @ 0x140123008
 * Callers:
...
char __fastcall KiClearPriorityFloor(ULONG_PTR BugCheckParameter1, __int64 *a2, char a3, char a4)
{
  ...
  LOBYTE(v11) = v10 - 1;
  *(_BYTE *)(a3 + BugCheckParameter1 + 1392) = v11;
  if ( !(_BYTE)v11 )
  {
    v11 = *(_DWORD *)(BugCheckParameter1 + 1408) ^ (1 << a3);
    *(_DWORD *)(BugCheckParameter1 + 1408) = v11;
    if ( v11 < 1 << a3 )
    {
      ...
      if ( v12 < 16 )
      {
        ...
        if ( v14 < v12 )
          LOBYTE(v11) = KiSetPriorityThread((_BYTE *)BugCheckParameter1, a2, v14);
      }
    }
  }
  if ( !a4 )
