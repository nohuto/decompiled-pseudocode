/*
 * XREFs of MiInsertPartitionPages @ 0x1402EA698
 * Callers:
...
__int64 __fastcall MiInsertPartitionPages(__int64 a1, __int64 a2, __int64 a3, unsigned __int64 a4)
{
  ...
  *(_QWORD *)v78 = a2;
  ...
  if ( (*(_DWORD *)(v4 + 24) & 0x10) == 0 )
  {
    ...
    {
      _InterlockedExchangeAdd64(&qword_140465E90, a4);
    }
    else
    {
...
LABEL_35:
  ...
  if ( (ULONG_PTR *)a2 == &MiSystemPartition )
  {
    v25 = *(_DWORD *)(v4 + 24);
    if ( (v25 & 0x10) == 0 )
      _InterlockedExchangeAdd64(&qword_140465E90, -(__int64)a4);
    ...
    *(_QWORD *)&v79[3] = *(_QWORD *)&v78[48];
    ...
    CurrentThread = (struct _KTHREAD *)v71;
    if ( (v29 & 0x10) == 0 )
      _InterlockedExchangeAdd64(&qword_140465E90, v28);
  }
  if ( !a2 )
    goto LABEL_126;
  --CurrentThread->SpecialApcDisable;
...
LABEL_116:
  ...
  if ( v20 && ($C6908ADE9723D0A04AF8EE82D8D15C40 *)v53->ApcState.ApcListHead[0].Flink != &v53->152 )
