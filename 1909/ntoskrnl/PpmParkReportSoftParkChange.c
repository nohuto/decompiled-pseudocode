/*
 * XREFs of PpmParkReportSoftParkChange @ 0x1401BFE88
 * Callers:
...
__int64 __fastcall PpmParkReportSoftParkChange(__int64 a1)
{
  ...
  v3 = ((unsigned __int64)qword_14042A528[v2 >> 6] >> (v2 & 0x3F)) & 1;
  ...
  if ( (_BYTE)v3 )
    _InterlockedOr64(&qword_14042A478[v5], v6);
  else
    _InterlockedAnd64(&qword_14042A478[v5], ~v6);
  LOBYTE(v4) = v3;
  *(_BYTE *)(a1 + 23859) = v3;
