/*
 * XREFs of EtwpDequeueFreeBuffer @ 0x140003800
 * Callers:
    ...
    if ( v8 )
    {
      ...
      do
      {
        ...
        if ( v11 <= v10 )
          break;
        v12 = v10;
        v10 = _InterlockedCompareExchange64((volatile signed __int64 *)(*(_QWORD *)(a1 + 1280) + 8 * v9), v11, v10);
      }
      while ( v12 != v10 );
      if ( *((_QWORD *)v6 + 3) <= *(_QWORD *)(a1 + 1296) )
      {
        v17 = *(_QWORD *)(*(_QWORD *)(a1 + 1288) + 8 * v9);
        do
        {
          v19 = *((_QWORD *)v6 + 2);
          if ( v19 <= v17 )
            break;
          v18 = v17;
          v17 = _InterlockedCompareExchange64((volatile signed __int64 *)(*(_QWORD *)(a1 + 1288) + 8 * v9), v19, v17);
        }
        while ( v18 != v17 );
      }
    }
