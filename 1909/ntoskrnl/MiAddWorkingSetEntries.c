/*
 * XREFs of MiAddWorkingSetEntries @ 0x1400AEC00
 * Callers:
...
__int64 __fastcall MiAddWorkingSetEntries(__int64 a1, unsigned __int64 a2, __int64 a3, char a4)
{
  ...
  v7 = a2;
  if ( v4 == 2 )
    v9 = (volatile signed __int64 *)&unk_140466F40;
  else
  ...
  if ( v15 <= v16 )
    goto LABEL_14;
  v17 = *(_QWORD **)(qword_140465E88 + 8LL * *(unsigned __int16 *)(a1 + 174));
  v18 = v17[986];
  if ( (v15 & 0x3F) != 0 )
  {
    v19 = -1LL;
  ...
  if ( v15 - v16 < 3 * (v18 >> 2) )
    goto LABEL_14;
  v72 = *(_QWORD *)(qword_140465E88 + 8LL * *(unsigned __int16 *)(a1 + 174));
  v95 = v17[975];
...
LABEL_15:
  ...
  *(_QWORD *)(a1 + 136) += a3;
  ...
  if ( (*(_BYTE *)(a1 + 184) & 7) == 2 )
  {
    ...
    if ( v13 == 1 )
      qword_140466F90 += a3;
    if ( qword_140466F90 > (unsigned __int64)qword_140466F98 )
      qword_140466F98 = qword_140466F90;
  }
  if ( (a4 & 2) != 0 )
  {
    *(_QWORD *)(a1 + 144) += a3;
  ...
  if ( (v22 & 7u) >= 2 )
  {
    v52 = *(_QWORD *)(qword_140465E88 + 8LL * *(unsigned __int16 *)(a1 + 174));
    v53 = (v22 & 7u) - 2;
    ...
    if ( (v22 & 7) == 4 )
    {
      ...
      {
        LODWORD(xmmword_140464640) = a3 + xmmword_140464640;
        goto LABEL_26;
      }
  ...
  if ( v24 && a3 )
  {
    while ( 1 )
    {
      ...
      if ( v27 == 7 )
      {
        ...
        v90 = 0LL;
        v91 = 0LL;
        v45 = *(_QWORD *)(qword_140465E88 + 8 * v43);
        v46 = *(_QWORD *)(v45 + 7800);
