/*
 * XREFs of _CmGetDevicesInBaseContainerList @ 0x140936B40
 * Callers:
  ...
  if ( CachedContextBaseKey >= 0 )
  {
    ...
    if ( CachedContextBaseKey >= 0 )
    {
      ...
      if ( CachedContextBaseKey >= 0 )
      {
        ...
        if ( CachedContextBaseKey >= 0 )
        {
          CachedContextBaseKey = PnpCtxRegQueryInfoKey(v13, Handle, 0LL, 0LL, (__int64)&v22, (__int64)&v26, 0LL);
          if ( CachedContextBaseKey >= 0 )
          {
            v14 = v22 * (v26 + 1) + 1;
            ...
            *a4 = PoolWithTag;
            ...
            {
              LODWORD(v26) = v14 - 1;
              v18 = PnpCtxRegEnumValue(v16, Handle, i, v8, (__int64)&v26, 0LL, 0LL, 0);
