/*
 * XREFs of PopEtInit @ 0x140A1BBB4
 * Callers:
 ...
 *     PopEtInitializeBuiltinAppId @ 0x140784D8C (PopEtInitializeBuiltinAppId.c)
 *     RtlInternTableInitialize @ 0x140784DF0 (RtlInternTableInitialize.c)
 */
