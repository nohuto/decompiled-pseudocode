/*
 * XREFs of RtlpInsertInvertedFunctionTableEntry @ 0x1401555C0
 * Callers:
        ...
        unsigned int a5)
{
  ...
  if ( PsInvertedFunctionTable[0] == dword_140589014 )
  {
    byte_14058901C = 1;
  }
  else
  {
    _InterlockedIncrement(&dword_140589018);
    v9 = 1;
    if ( PsInvertedFunctionTable[0] != 1 )
    {
      if ( PsInvertedFunctionTable[0] > 1u )
      {
        v10 = (unsigned __int64 *)&unk_140589040;
        do
        {
          if ( a2 < *v10 )
            break;
