/*
 * XREFs of RtlpQueryTimeZoneInformationWorker @ 0x1406AEEB0
 * Callers:
 *     EtwpAddLogHeader @ 0x1406AE8E0 (EtwpAddLogHeader.c)
 *     ExpRefreshTimeZoneInformation @ 0x1407643E8 (ExpRefreshTimeZoneInformation.c)
 *     RtlQueryDynamicTimeZoneInformation @ 0x1408D30E0 (RtlQueryDynamicTimeZoneInformation.c)
 *     RtlQueryTimeZoneInformation @ 0x1408D3100 (RtlQueryTimeZoneInformation.c)
 * Callees:
