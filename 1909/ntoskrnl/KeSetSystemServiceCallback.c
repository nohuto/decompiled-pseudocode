/*
 * XREFs of KeSetSystemServiceCallback @ 0x14087F8F0
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall KeSetSystemServiceCallback(_BYTE *a1, char a2, __int64 a3, __int64 a4)
{
  ...
  v4 = 0;
  if ( !a3 || a3 == *(_QWORD *)((char *)&KiDynamicTraceCallouts + (-(__int64)(a2 != 0) & 0xFFFFFFFFFFFFFFF8uLL) + 24) )
  {
