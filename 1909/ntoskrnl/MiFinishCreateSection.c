/*
 * XREFs of MiFinishCreateSection @ 0x1405D7C80
 * Callers:
...
__int64 __fastcall MiFinishCreateSection(int *a1)
{
  ...
  *((_QWORD *)a1 + 15) = v1;
  ...
  if ( !v5 )
  {
    ...
    v3 = v17;
    if ( *((_BYTE *)a1 + 24) <= 1u && (v16 & 0x80000) == 0 )
      a1[35] = v4 | 0x80000000;
  }
  v6 = *(_DWORD *)(v1 + 56);
  if ( (v6 & 0x4000000) != 0 )
...
LABEL_60:
  ...
  v24 = 1;
LABEL_55:
  RtlAvlInsertNodeEx((unsigned __int64 *)&qword_140464288, v26, v24, Object);
  if ( (_InterlockedExchangeAdd64((volatile signed __int64 *)&qword_140464290, 0xFFFFFFFFFFFFFFFFuLL) & 6) == 2 )
    ExfTryToWakePushLock((volatile signed __int64 *)&qword_140464290);
  KeAbPostRelease((ULONG_PTR)&qword_140464290);
  KiLeaveGuardedRegionUnsafe((__int64)CurrentThread);
