/*
 * XREFs of PopWriteImageHeader @ 0x1405AD5E0
 * Callers:
...
__int64 (*__fastcall PopWriteImageHeader(__int64 a1, __int64 a2, unsigned int a3, __int64 a4))(void)
{
  ...
  v8 = __rdtsc();
  qword_1404434F0 = (((unsigned __int64)HIDWORD(v8) << 32) | (unsigned int)v8) - a4;
  dword_1404436B4 = ((unsigned int)dword_1404433A0 >> 4) - 1;
  PerformanceCounter = KeQueryPerformanceCounter(0LL);
  v10 = 0;
  for ( qword_140443520 = PerformanceCounter.QuadPart;
        v10 < *(_DWORD *)(a1 + 256);
        qword_140443500 += *(_QWORD *)(v11 + *(_QWORD *)(a1 + 264) + 80) )
  {
    v11 = v10++;
    v11 <<= 7;
    qword_140443680 += *(_QWORD *)(v11 + *(_QWORD *)(a1 + 264) + 56);
    qword_1404434F8 += *(_QWORD *)(v11 + *(_QWORD *)(a1 + 264) + 40);
  }
  qword_140443690 = qword_1404436A8;
  qword_1404436A0 = (unsigned int)dword_1404436B0;
  qword_1404436A8 += qword_140443688;
  v12 = qword_140443678;
  dword_1404436B0 += qword_140443698;
  *(_QWORD *)(a2 + 88) = qword_140443678;
  if ( byte_1404433C1 )
    *(_QWORD *)(a2 + 88) = qword_140443680 + v12;
  v13 = 3LL;
  v14 = a2 + 136;
  v15 = &qword_1404434D8;
  do
