/*
 * XREFs of KiParkUmsThread @ 0x1402B5E90
 * Callers:
 ...
 *     RtlXRestore @ 0x140131318 (RtlXRestore.c)
 ...
 *     KeResetLegacyFloatingPointState @ 0x1401C4D90 (KeResetLegacyFloatingPointState.c)
 *     KeRestoreLegacyFloatingPointControlWord @ 0x1401C4DB0 (KeRestoreLegacyFloatingPointControlWord.c)
 *     _alloca_probe @ 0x1401CD060 (_alloca_probe.c)
 *     KiUmsRestoreUch @ 0x1401D6E00 (KiUmsRestoreUch.c)
 *     memset @ 0x1401D77C0 (memset.c)
 *     KiIsPrimaryPresent @ 0x1402B5CD0 (KiIsPrimaryPresent.c)
 *     KeUpdateUmsThreadState @ 0x140880294 (KeUpdateUmsThreadState.c)
 *     KiUmsExceptionFilter @ 0x1408808A0 (KiUmsExceptionFilter.c)
