/*
 * XREFs of PopBatteryInitialize @ 0x1408A9470
 * Callers:
...
NTSTATUS __fastcall PopBatteryInitialize(__int64 a1)
{
  ...
  if ( result >= 0 )
  {
    ...
    *(_DWORD *)(a1 + 104) = 3;
    v9 = (_QWORD *)(a1 + 64);
    v10 = (_QWORD *)qword_1404431B8;
    if ( *(__int64 **)qword_1404431B8 != &qword_1404431B0 )
      __fastfail(3u);
    v9[1] = qword_1404431B8;
    *v9 = &qword_1404431B0;
    *v10 = v9;
    ++dword_140443194;
    ++dword_1404431F8;
    result = 0;
    qword_1404431B8 = (__int64)v9;
    byte_140443198 = 1;
  }
  return result;
}
