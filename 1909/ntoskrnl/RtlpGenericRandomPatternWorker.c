/*
 * XREFs of RtlpGenericRandomPatternWorker @ 0x1403155E0
 * Callers:
 *     RtlScrubMemory @ 0x140314F38 (RtlScrubMemory.c)
 * Callees:
 *     RtlpFillMemoryRandomUp @ 0x14031506C (RtlpFillMemoryRandomUp.c)
 *     RtlpTestMemoryRandomUp @ 0x140315AF8 (RtlpTestMemoryRandomUp.c)
 */
