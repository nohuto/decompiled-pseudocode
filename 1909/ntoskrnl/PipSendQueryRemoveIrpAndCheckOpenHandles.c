/*
 * XREFs of PipSendQueryRemoveIrpAndCheckOpenHandles @ 0x14087B850
 * Callers:
 *     PipProcessQueryRemovalInKernelMode @ 0x14087B730 (PipProcessQueryRemovalInKernelMode.c)
 * Callees:
        ...
        _DWORD *a6)
{
  ...
  {
    if ( *v8 == 6 )
      PnpCollectOpenHandles((_QWORD **)a5, a4, (__int64)&v15);
  }
  else
  {
    ...
    if ( v12 < 0 )
    {
      PipRecordOpenHandleVeto(a4, (_QWORD **)a5, v23, (__int64)&v15, (__int64)v8);
