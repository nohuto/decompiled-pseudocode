/*
 * XREFs of MiParseImageLoadConfig @ 0x140643DC8
 * Callers:
...
__int64 __fastcall MiParseImageLoadConfig(__int64 a1, char *a2, unsigned int a3, __int64 a4, __int64 a5, __int64 a6)
{
  ...
  unsigned int v29; // [rsp+80h] [rbp-2E8h] BYREF
  __int64 v30; // [rsp+88h] [rbp-2E0h]
  unsigned __int64 v31; // [rsp+90h] [rbp-2D8h]
  __int64 v32; // [rsp+98h] [rbp-2D0h]
  __int64 v33; // [rsp+A0h] [rbp-2C8h]
  __int64 v34; // [rsp+A8h] [rbp-2C0h]
  unsigned __int64 v35; // [rsp+B0h] [rbp-2B8h]
...
LABEL_13:
          ...
          {
            memmove(v45, v17, v14);
            v10 = MiReferenceControlAreaFile(v30);
            MiLogRelocationRva(*(unsigned int *)(a4 + 96), v14, v10, v30);
            *(_QWORD *)&Src[0] = v41;
            *((_QWORD *)&Src[0] + 1) = v10;
            *(_QWORD *)&Src[1] = v42;
            *((_QWORD *)&Src[1] + 1) = v31;
            ...
            if ( RetpolineRelocationInformation >= 0 )
            {
              ...
              *(_WORD *)(a6 + 8) = *(_WORD *)(v20 + 48);
                    ...
                    RetpolineRelocationInformation >= 0) )
              {
                ...
                {
                  v22 = MiCaptureDynamicRelocationTableRva(
                          a2,
                          a3,
                          v31,
                          523,
...
LABEL_34:
  if ( v10 )
    MiDereferenceControlAreaFile(v30, v10);
