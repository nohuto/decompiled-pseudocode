/*
 * XREFs of MiAllocateEntireImageFileExtents @ 0x14088B46C
 * Callers:
  ...
  *v15 = v10[1];
  ...
  for ( j = 0; j < *v15; v16 += 12 )
  {
    ...
    *((_QWORD *)v16 + 5) = *(_QWORD *)&v10[4 * j + 4];
    v20 = 0;
    v16[6] = v6;
    BugCheckParameter4 = (_QWORD *)qword_1404645A0;
    if ( qword_1404645A0 )
    {
      while ( 1 )
      {
...
LABEL_27:
    RtlAvlInsertNodeEx(&qword_1404645A0, (unsigned __int64)BugCheckParameter4, v18, v16);
    v6 += *((_QWORD *)v16 + 5);
    ++j;
  }
