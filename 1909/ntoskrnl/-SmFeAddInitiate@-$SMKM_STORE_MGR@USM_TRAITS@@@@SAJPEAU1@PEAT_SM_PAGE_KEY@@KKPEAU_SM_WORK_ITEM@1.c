/*
 * XREFs of ?SmFeAddInitiate@?$SMKM_STORE_MGR@USM_TRAITS@@@@SAJPEAU1@PEAT_SM_PAGE_KEY@@KKPEAU_SM_WORK_ITEM@1@PEAU_SM_IO_CONTEXT@1@K@Z @ 0x14014C428
 * Callers:
        ...
        char a7)
{
  ...
  __int64 v34; // rdx
  $C6908ADE9723D0A04AF8EE82D8D15C40 *v35; // rcx
  __int64 v36; // rcx
...
LABEL_78:
      ...
      if ( v29 && ($C6908ADE9723D0A04AF8EE82D8D15C40 *)v38->ApcState.ApcListHead[0].Flink != &v38->152 )
        ...
        if ( v33->LockState.0 )
        {
          if ( v33 )
          {
            ...
            if ( (__int64)v33->LockState.LockState < 0 )
              KiAbEntryRemoveFromTree((__int64)&v25->LockEntries[v32]);
...
LABEL_33:
    ...
    {
      v35 = &v25->152;
      if ( ($C6908ADE9723D0A04AF8EE82D8D15C40 *)v35->ApcState.ApcListHead[0].Flink != v35 )
