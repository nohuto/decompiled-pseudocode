/*
 * XREFs of PspSetupUserProcessAddressSpace @ 0x14067FB08
 * Callers:
 ...
 *     PspWow64SetupUserProcessAddressSpace @ 0x1400E85E4 (PspWow64SetupUserProcessAddressSpace.c)
    ...
    if ( inited >= 0 )
    {
      ...
      if ( inited >= 0 )
      {
        ...
        if ( inited >= 0 )
        {
          ...
          if ( inited >= 0 )
          {
            if ( a2[1].ActiveProcessors.Bitmap[6] )
            {
