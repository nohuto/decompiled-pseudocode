/*
 * XREFs of MmCheckCachedPageStates @ 0x1400B6670
 * Callers:
...
__int64 __fastcall MmCheckCachedPageStates(unsigned __int64 a1, __int64 a2, unsigned int a3, char *a4)
{
  ...
  if ( ((unsigned __int8)v20 & 1) == 0 )
    v21 = v20;
  v184 = *v21;
  v183 = *(_QWORD *)(qword_140465E88 + 8LL * (*(_WORD *)(v184 + 60) & 0x3FF));
  while ( 1 )
  {
    v22 = 1LL;
    if ( v7 > v8 )
...
LABEL_63:
          ...
          v52 = *(ULONG_PTR **)(qword_140465E88 + 8 * ((v47 >> 40) & 0x3FF));
          if ( !v50 || (v140 = MiChargeCommit((__int64)v52, 1uLL, 4u), LOBYTE(CurrentIrql) = v166, v140) )
          {
            ...
            if ( (unsigned int)MiChargePartitionResidentAvailable(v52, 1LL, 0xFFFFFFFFLL) )
            {
              LOBYTE(CurrentIrql) = v166;
              goto LABEL_70;
            }
...
LABEL_118:
        ...
        *(_QWORD *)(v11 + 24) ^= ((*(_QWORD *)(v11 + 24) + 1LL) ^ *(_QWORD *)(v11 + 24)) & 0x3FFFFFFFFFFFFFFFLL;
        ...
        v5 = v167;
        v27 = v78 & 0xFFFFFFFFFFFFFEFBuLL | ((unsigned __int64)(word_1404658EC & 1) << 8);
LABEL_16:
        v7 += 8LL;
        ValidPte = v27;
        if ( v24 >= 2 )
...
LABEL_90:
        ...
        if ( (*(_QWORD *)v31 & 0xC00LL) != 0x800 )
          break;
        if ( !v60 || !qword_140465800 || (v60 & qword_140465800) != 0 )
        {
          v61 = *(_QWORD *)v31;
          if ( qword_140465800 && (v60 & 0x10) == 0 )
            v61 = v60 & ~qword_140465800;
          goto LABEL_90;
        }
      }
      v63 = 0LL;
...
LABEL_207:
        ...
        || (ListEntry = (PSLIST_ENTRY)MiMakeTransitionHeatBatch(v63, 0LL, ((__int64)(v8 - v7) >> 3) + 1)) == 0LL )
      {
        ...
        v112 = *v64;
        if ( qword_140465800 && (v112 & 0x10) == 0 )
          v112 &= ~qword_140465800;
...
LABEL_441:
  ...
  v86 = (v81 >> 40) & 0x3FF;
  v87 = *(_QWORD *)(qword_140465E88 + 8 * v86);
  if ( v4 == 1 )
  {
    MiReturnCommit(*(_QWORD *)(qword_140465E88 + 8 * v86), v22);
    v19 = v159;
    v22 = 1LL;
  }
  ...
  {
LABEL_249:
    _InterlockedExchangeAdd64(&qword_14046A180, v22);
    goto LABEL_143;
  }
