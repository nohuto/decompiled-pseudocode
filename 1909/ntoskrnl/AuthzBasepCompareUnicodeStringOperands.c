/*
 * XREFs of AuthzBasepCompareUnicodeStringOperands @ 0x1400D2BE4
 * Callers:
 ...
 *     AuthzBasepCompareUnicodeStringCaseSensitive @ 0x1403468B8 (AuthzBasepCompareUnicodeStringCaseSensitive.c)
...
LABEL_43:
  ...
  {
    if ( v28 )
      v20 = AuthzBasepEqualUnicodeStringCaseSensitive(&Name);
    else
