/*
 * XREFs of ?RtlStringCbCopyUnicodeString@@YAJPEAG_KPEBU_UNICODE_STRING@@@Z @ 0x140324194
 * Callers:
 *     SmKmKeyGenStart @ 0x1408E9B48 (SmKmKeyGenStart.c)
 * Callees:
 *     RtlUnicodeStringValidateSrcWorker @ 0x140324248 (RtlUnicodeStringValidateSrcWorker.c)
 */
