/*
 * XREFs of NtSetThreadExecutionState @ 0x1406B3A40
 * Callers:
 *     <none>
 * Callees:
 *     MmGetSessionIdEx @ 0x14003F230 (MmGetSessionIdEx.c)
 *     PoDestroyReasonContext @ 0x1400D64DC (PoDestroyReasonContext.c)
 *     PopGetLegacyPowerRequestFlags @ 0x140105164 (PopGetLegacyPowerRequestFlags.c)
 *     PopApplyLegacyPowerRequestFlags @ 0x1401051B8 (PopApplyLegacyPowerRequestFlags.c)
