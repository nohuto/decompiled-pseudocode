/*
 * XREFs of PopRestoreHiberContext @ 0x140599360
 * Callers:
...
struct _KPRCB *__fastcall PopRestoreHiberContext(ULONG_PTR BugCheckParameter3)
{
  ...
  void (*v32)(void); // rax
  __int64 v33; // rax
  PVOID v34; // [rsp+30h] [rbp-58h] BYREF
  PVOID v35; // [rsp+38h] [rbp-50h]
  ...
  if ( Number < *(_DWORD *)(BugCheckParameter3 + 256) )
  {
    ...
    *(_QWORD *)(*(_QWORD *)(BugCheckParameter3 + 264) + ((unsigned __int64)Number << 7) + 80) = 0LL;
    if ( Number == *(_DWORD *)(BugCheckParameter3 + 192) )
    {
      ...
      if ( Address )
      {
        v12 = BgLibraryInitialize(Address, 0xFFFFFFFFLL);
        v13 = byte_140467D68;
        if ( v12 >= 0 )
          v13 = 1;
        byte_140467D68 = v13;
      ...
      v14 = __rdtsc();
      qword_140443640 += (((unsigned __int64)HIDWORD(v14) << 32) | (unsigned int)v14) - v11;
    }
    if ( !Number )
    {
      v5 = 0LL;
      ...
      *(_BYTE *)(BugCheckParameter3 + 4) = 1;
      ...
      if ( *(_QWORD *)(BugCheckParameter3 + 400) )
      {
        ...
        *(_QWORD *)(BugCheckParameter3 + 160) = &v34;
        ...
        v35 = qword_140443398;
        v36 = 0LL;
        ((void (__fastcall *)(_QWORD))off_140424598[0])(0LL);
        ...
        v29 = __rdtsc();
        v10 = v37;
        qword_140443620 = (((unsigned __int64)HIDWORD(v29) << 32) | (unsigned int)v29) - v37;
      ...
      IoNotifyDump(3);
      ((void (__fastcall *)(__int64))off_140424598[0])(1LL);
      ...
      if ( v15 )
      {
        ...
        do
        {
          ...
          qword_140443600 += *(_QWORD *)(v23 + v21 + 64);
          qword_140443610 += *(_QWORD *)(v23 + *(_QWORD *)(BugCheckParameter3 + 264) + 72);
          qword_140443638 += *(_QWORD *)(v23 + *(_QWORD *)(BugCheckParameter3 + 264) + 80);
          v21 = *(_QWORD *)(BugCheckParameter3 + 264);
      ...
      if ( v25 > v24 )
      {
        v33 = 100 * (qword_140443608 * v15 / (v19 + v18 + 1) - v24) / (v25 - v24);
        if ( v33 > 99 )
        {
          dword_1404433C4 = 99;
          goto LABEL_27;
...
LABEL_27:
      v26 = __rdtsc();
      qword_140443628 = (((unsigned __int64)HIDWORD(v26) << 32) | (unsigned int)v26) - v10;
      result = (struct _KPRCB *)(qword_140443628 - qword_140443620 - v4);
      qword_1404435F8 = (__int64)result;
      return result;
    }
