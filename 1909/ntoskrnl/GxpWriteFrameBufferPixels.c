/*
 * XREFs of GxpWriteFrameBufferPixels @ 0x140178DC0
 * Callers:
 *     BgpGxDrawRectangle @ 0x140178D30 (BgpGxDrawRectangle.c)
 * Callees:
 *     GxpAdjustRectangleToFrameBuffer @ 0x140178FFC (GxpAdjustRectangleToFrameBuffer.c)
 ...
 *     GxpGetRotatedPixelOffset @ 0x140348C00 (GxpGetRotatedPixelOffset.c)
...
LABEL_45:
            ...
            while ( 1 )
            {
              ...
              if ( RotatedPixelOffset < 0 )
                goto LABEL_19;
              memmove((char *)qword_14042BFC0 + v8 * (unsigned int)Src, v27, v8);
              ++v26;
              v27 += v8;
              LODWORD(v28) = v26;
              if ( v26 >= *(_DWORD *)(v3 + 4) )
...
LABEL_19:
    ...
    v37 = *(_QWORD *)v3;
    v28 = 0LL;
    if ( (dword_14042C010 & 8) == 0 )
    {
      HIDWORD(v38) = *(_DWORD *)(v3 + 12);
      v39 = *(_QWORD *)(v3 + 24);
      LODWORD(v38) = xmmword_14042BFB0;
      goto LABEL_29;
    }
    if ( (dword_14042C010 & 0xC00) != 0 )
    {
      v24 = 1LL;
      v28 = v46;
    }
    ...
    if ( (int)result >= 0 )
    {
      ...
      LODWORD(v38) = 1;
LABEL_29:
      RotatedPixelOffset = ((__int64 (__fastcall *)(__int64 *, _DWORD *, _QWORD))qword_14042BFC0)(&v37, v2, 0LL);
      if ( v23 && v23 != v46 )
