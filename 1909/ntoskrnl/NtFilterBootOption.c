...
LABEL_31:
              ...
              {
                v13 = (unsigned int *)(qword_14050E9F8 + 8);
                while ( 1 )
                {
                  if ( *(v13 - 1) == a3 )
                  {
                    ...
                    if ( !v14 || v14 == v6 )
                    {
                      v15 = *(_WORD *)(*v13 + qword_14050EA08);
                      if ( ((v15 & 0x20) == 0 || (dword_14046BD2C & 4) != 0)
                        && ((v15 & 0x40) == 0 || (dword_14046BD2C & 0x10) != 0) )
                      {
                        break;
                      }
                    }
                  ...
                  ++v12;
                  v13 += 3;
                  if ( v12 >= *((unsigned __int16 *)qword_140509B40 + 18) )
                    goto LABEL_20;
                }
                if ( v7 == 1 )
                {
                  v8 = SepSecureBootValidateBcdDataAgainstBcdRule(qword_14050E9F8 + 12LL * v12, a4, v9);
                }
                else
                {
                  v8 = 0;
                  v16 = *(unsigned int *)(qword_14050E9F8 + 12LL * v12 + 8);
                  if ( (*(_BYTE *)(v16 + qword_14050EA08) & 0x1F) != 8 || *(_WORD *)(v16 + qword_14050EA08 + 2) )
                    v8 = -1069350910;
                }
              }
              goto LABEL_56;
