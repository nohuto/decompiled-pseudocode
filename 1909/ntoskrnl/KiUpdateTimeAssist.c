/*
 * XREFs of KiUpdateTimeAssist @ 0x14011F3C4
 * Callers:
 *     KeResumeClockTimerFromIdle @ 0x140033DF0 (KeResumeClockTimerFromIdle.c)
 *     KeSynchronizeTimeToQpc @ 0x140169C60 (KeSynchronizeTimeToQpc.c)
 * Callees:
 *     KiComputeNewSystemTime @ 0x14011F588 (KiComputeNewSystemTime.c)
