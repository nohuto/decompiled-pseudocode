/*
 * XREFs of PopExecutePowerAction @ 0x1407274F8
 * Callers:
 ...
 *     PopCriticalShutdown @ 0x1408A8170 (PopCriticalShutdown.c)
 ...
 *     PopPromoteActionFlag @ 0x1407278D8 (PopPromoteActionFlag.c)
 *     PopCompareActions @ 0x140727928 (PopCompareActions.c)
...
LABEL_13:
      ...
      if ( v14 )
      {
        ...
        if ( v14 == 4 )
          v18 = v17;
        v46 = v18;
        if ( (int)PopCompareActions(v14, (unsigned int)qword_140442FC4) < 0 )
        {
          v22 = 2;
        }
        else
        {
          ...
          if ( v26 > SHIDWORD(qword_140442FC4) )
          {
            v45 |= v25;
            HIDWORD(qword_140442FC4) = v26;
          }
        }
        LOBYTE(v20) = 1;
        ...
        else
        {
          ...
          if ( !(unsigned int)PopCompareActions(v36, v35) )
            v37 |= v22;
          LODWORD(qword_140442FC4) = v14;
          v38 = v37 | 5;
          v33 = v14;
          dword_140442FD4 = *(_DWORD *)a1;
          dword_140442FD8 = 0;
          v45 = v38;
          if ( !*(_DWORD *)a1 )
            dword_140442FD8 = *(_DWORD *)(a1 + 16);
        }
        if ( v33 == 3 )
          LODWORD(qword_140442FC4) = v22;
        if ( v38 )
        {
          if ( TtmpEnabled == 1 )
            PopTtmIsSxTransitionInProgress = 1;
          v10 = 1;
          if ( (unsigned __int8)byte_140442FC1 < (unsigned __int8)v22 )
          {
...
LABEL_42:
  ...
  if ( (v40 & 0x20) != 0 )
  {
    if ( v10 )
    {
      v41 = (__int64 *)qword_140443928;
      v40 = *(_QWORD *)(a1 + 8) + 32LL;
      if ( *(__int64 **)qword_140443928 != &PopActionWaiters )
        __fastfail(3u);
