/*
 * XREFs of BgpConsoleScrollScreen @ 0x140993D30
 * Callers:
 *     BgpConsoleDisplayCharacterEx @ 0x140993844 (BgpConsoleDisplayCharacterEx.c)
 * Callees:
...
__int64 BgpConsoleScrollScreen()
{
  ...
  v1 = 0;
  v2 = 0LL;
  v3 = (_DWORD *)(qword_1404F2818 + 60);
  v4 = (_DWORD *)(qword_1404F2818 + 48);
  do
  {
    v5 = 0;
    if ( *(_DWORD *)(v0 + 4) != 1 )
    {
      do
      {
          ...
          || *(_DWORD *)(v0 + 12 * (v2 + v5 + 7LL)) != *(_DWORD *)(v0 + 12 * (v2 + v6 + 7)) )
        {
          ...
          if ( v15 >= 0 )
          {
            *(_WORD *)(qword_1404F2818 + 4 * v10 + 88) = v8;
