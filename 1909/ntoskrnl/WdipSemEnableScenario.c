/*
 * XREFs of WdipSemEnableScenario @ 0x1407467AC
 * Callers:
 ...
 *     WdipSemQueryScenarioTable @ 0x1407468F4 (WdipSemQueryScenarioTable.c)
 *     WdipSemActivateInstance @ 0x14074695C (WdipSemActivateInstance.c)
 *     WdipSemEnableContextProviders @ 0x1407469B0 (WdipSemEnableContextProviders.c)
