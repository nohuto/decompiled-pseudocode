/*
 * XREFs of IopAddRemoveReqDescs @ 0x1407545E8
 * Callers:
 *     IopSelectNextConfiguration @ 0x140752550 (IopSelectNextConfiguration.c)
 *     PnpFindBestConfigurationWorker @ 0x140752A60 (PnpFindBestConfigurationWorker.c)
 *     PnpSelectFirstConfiguration @ 0x140752CD0 (PnpSelectFirstConfiguration.c)
        ...
        if ( a4 )
        {
          ...
          *(_QWORD *)(v10 + 48) = v12;
          if ( (_QWORD *)*v14 == v14 )
          {
            ...
            {
              if ( *(_DWORD *)(*(i - 7) + 136LL) >= *(_DWORD *)(*(_QWORD *)(v10 + 32) + 136LL) )
                break;
            }
            *v14 = i;
            *(_QWORD *)(v10 + 96) = i[1];
