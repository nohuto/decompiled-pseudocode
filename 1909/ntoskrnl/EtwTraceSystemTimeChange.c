/*
 * XREFs of EtwTraceSystemTimeChange @ 0x14059CF90
 * Callers:
...
char __fastcall EtwTraceSystemTimeChange(__int64 *a1, _QWORD *a2, int a3)
{
  ...
  {
    LOBYTE(ProcessId) = TlgKeywordOn(&stru_140426650, 0x400000000000uLL);
    if ( (_BYTE)ProcessId )
    {
      v15 = *a1;
      v16 = *a2;
      ...
      v37[1] = 0;
      v39 = 4LL;
      LOBYTE(ProcessId) = TlgWrite(&stru_140426650, &unk_14039405E, 0LL, 0LL, 8u, &pData);
    }
  }
