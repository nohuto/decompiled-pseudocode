/*
 * XREFs of MmMarkPhysicalMemoryAsBad @ 0x1402BEB40
 * Callers:
...
LABEL_81:
  ...
  if ( (unsigned int)MiAcquireNonPagedResources(v12, 2uLL) )
  {
    ...
    if ( *(_QWORD *)(qword_140465E88 + 8 * ((*(_QWORD *)(v6 + 40) >> 40) & 0x3FFLL)) != v12 )
    {
      _InterlockedAnd64(v7, 0x7FFFFFFFFFFFFFFFuLL);
    ...
    *(_BYTE *)(v6 + 35) = v18 | 0x40;
    ...
    __writecr8(v15);
    ContiguousPages = MiFindContiguousPages(v12, v3, v3, 0LL, 1uLL, 1, 0x80000000, 0x80000000, v5, 0LL, v29);
    v22 = MiLockPageInline(v6);
    v23 = *(_QWORD *)(v6 + 40);
    if ( ContiguousPages < 0 )
    {
      if ( v12 == *(_QWORD *)(qword_140465E88 + 8 * ((*(_QWORD *)(v6 + 40) >> 40) & 0x3FFLL)) )
      {
