/*
 * XREFs of Feature_19H2_Rollback__private_IsEnabledWithReporting @ 0x1401BEC90
 * Callers:
 *     Feature_19H2_Enablement__private_areDependenciesEnabled @ 0x1401BEC70 (Feature_19H2_Enablement__private_areDependenciesEnabled.c)
 * Callees:
