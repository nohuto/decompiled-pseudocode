/*
 * XREFs of PpmGetIdleGenerationCounter @ 0x1402EE41C
 * Callers:
...
__int64 __fastcall PpmGetIdleGenerationCounter(__int64 a1)
{
  ...
  if ( v2 && *(_DWORD *)(a1 + 24024) == 3 )
    return (*(_QWORD *)(*(_QWORD *)(a1 + 24656) + 8LL * DWORD2(xmmword_14050AEB0)) >> 1) & -(__int64)((*(_QWORD *)(*(_QWORD *)(a1 + 24656) + 8LL * DWORD2(xmmword_14050AEB0)) & 1) != 0);
  return v4;
}
