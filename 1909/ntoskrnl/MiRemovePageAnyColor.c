/*
 * XREFs of MiRemovePageAnyColor @ 0x140116BDC
 * Callers:
...
__int64 __fastcall MiRemovePageAnyColor(__int64 a1, unsigned int a2, __int16 a3)
{
  ...
  LODWORD(v5) = a2;
  v6 = (a3 & 2) == 0;
  v7 = *(_QWORD *)(a1 + 16) + 1984 * ((unsigned __int64)a2 >> byte_14046574D);
  if ( (unsigned int)MmNumberOfChannels > 1 )
    v8 = (_QWORD *)(v7
                  + 8
                  * (v6
                   + 2LL * (unsigned __int8)(MiChannelMaximumPowerOf2Mask & ((unsigned int)v5 >> byte_14046574E))
                   + 231));
  else
