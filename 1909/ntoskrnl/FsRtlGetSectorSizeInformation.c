/*
 * XREFs of FsRtlGetSectorSizeInformation @ 0x140736A60
 * Callers:
...
__int64 __fastcall FsRtlGetSectorSizeInformation(PDEVICE_OBJECT DeviceObject, __int64 a2)
{
  ...
  _QWORD v27[2]; // [rsp+140h] [rbp+40h] BYREF
  ...
  *(_QWORD *)(a2 + 16) = 0LL;
  *(_DWORD *)(a2 + 24) = 0;
  result = FsRtlIssueDeviceIoControl(DeviceObject, 0x70000u, 0, v27, 0x18u, 0LL);
  if ( (int)result >= 0 )
  {
    if ( !HIDWORD(v28) || ((HIDWORD(v28) - 1) & HIDWORD(v28)) != 0 )
    {
      return 3221225675LL;
    }
    else
    {
      ...
      *(_DWORD *)(a2 + 12) = v6;
      ...
      v26 = 0LL;
      v16 = 55;
      if ( (int)FsRtlIssueDeviceIoControl(DeviceObject, 0x2D1400u, 0xCu, &v25, 0x10u, (__int64)v14) >= 0
        && v14[0] == 16
        && (v26 & 1) != 0 )
      {
        *(_DWORD *)(a2 + 16) |= 0x10u;
