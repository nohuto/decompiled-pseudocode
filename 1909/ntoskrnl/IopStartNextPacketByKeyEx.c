/*
 * XREFs of IopStartNextPacketByKeyEx @ 0x14029937C
 * Callers:
 *     IoStartNextPacket @ 0x140298AD0 (IoStartNextPacket.c)
 *     IoStartNextPacketByKey @ 0x140298B10 (IoStartNextPacketByKey.c)
 * Callees:
