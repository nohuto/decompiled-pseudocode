/*
 * XREFs of MiSectionInitialization @ 0x140A1F1D8
 * Callers:
  ...
  *(_OWORD *)((char *)&v12[1] + 4) = MiSectionMapping;
  ...
  if ( (int)ObCreateObjectType(&v4, (__int64)v12, 0LL, (__int64)&MmSectionObjectType) >= 0 )
  {
    ...
    if ( PoolWithTag )
    {
      ...
      memset(&qword_1404642B0, 0, 0x110uLL);
      v1[5] = 0LL;
      dword_140464378 |= 0x400u;
      v7 = 0LL;
      v8 = v5;
      qword_1404642B0 = (__int64)&qword_140464340;
      qword_140464340 = (__int64)v1;
      qword_140464358 = 1LL;
      *v1 = &qword_140464340;
      v6[0] = 48;
      v9 = 65552;
      ...
      {
        v2 = Object;
        *((_QWORD *)Object + 5) = &qword_140464340;
