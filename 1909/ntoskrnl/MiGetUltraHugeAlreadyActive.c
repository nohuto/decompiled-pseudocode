/*
 * XREFs of MiGetUltraHugeAlreadyActive @ 0x14018F7E0
 * Callers:
...
unsigned int **__fastcall MiGetUltraHugeAlreadyActive(__int64 a1, __int64 a2, int a3)
{
  ...
  __int16 v7; // r15
  unsigned int *v8; // rbx
  struct _RTL_BITMAP **v10; // r14
  struct _RTL_BITMAP *i; // rsi
  ULONG v12; // eax
  ...
  v10 = (struct _RTL_BITMAP **)(v5 + 32);
  for ( i = *v10; ; i = *(struct _RTL_BITMAP **)&i->SizeOfBitMap )
  {
    if ( i == (struct _RTL_BITMAP *)v10 )
      return 0LL;
    p_Buffer = &i[-5].Buffer;
