        ...
        __int64 a7)
{
  ...
  if ( a3 > 0x10 || v10[1] > 0x10 )
  {
    ...
    {
      ++dword_140505198;
      v7 = (PSLIST_ENTRY)((__int64 (__fastcall *)(_QWORD, _QWORD, _QWORD, _SLIST_HEADER *))qword_1405051B0)(
...
LABEL_26:
  if ( v7 )
  {
    ...
    {
      ++dword_1405051A0;
      ((void (__fastcall *)(PSLIST_ENTRY, _SLIST_HEADER *))qword_1405051B8)(v7, &VmpLargeFaultBatchLookasideList);
    }
  }
