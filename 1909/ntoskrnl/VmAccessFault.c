/*
 * XREFs of VmAccessFault @ 0x1408EC7B0
 * Callers:
 *     <none>
 * Callees:
        ...
        __int64 a7)
{
  ...
  if ( a3 > 0x10 || v10[1] > 0x10 )
  {
    ...
    {
      ++dword_140505198;
      v7 = (PSLIST_ENTRY)((__int64 (__fastcall *)(_QWORD, _QWORD, _QWORD, union _SLIST_HEADER *))qword_1405051B0)(
                           (unsigned int)dword_1405051A4,
                           (unsigned int)dword_1405051AC,
                           (unsigned int)dword_1405051A8,
...
LABEL_26:
  ...
  {
    ++dword_14050519C;
    if ( LOWORD(VmpLargeFaultBatchLookasideList.Alignment) < (unsigned __int16)word_140505190 )
    {
    ...
    {
      ++dword_1405051A0;
      ((void (__fastcall *)(PSLIST_ENTRY, union _SLIST_HEADER *))qword_1405051B8)(v7, &VmpLargeFaultBatchLookasideList);
    }
  }
