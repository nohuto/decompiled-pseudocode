/*
 * XREFs of PiDmGetObjectConstraintList @ 0x1406F2860
 * Callers:
 *     PiDmGetCmObjectConstraintListFromCache @ 0x1406F27CC (PiDmGetCmObjectConstraintListFromCache.c)
 * Callees:
        ...
        unsigned int *a7)
{
  ...
  *a7 = 0;
  ...
  else
  {
    ...
    v17[2] = v12;
    v17[3] = v11;
    v14 = PiDmListEnumObjectsWithCallback(
            v7,
            (ULONG_PTR)P,
