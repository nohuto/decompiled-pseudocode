/*
 * XREFs of SymCryptDetectCpuFeaturesByCpuid @ 0x1401BDDA4
 * Callers:
 *     SymCryptInitEnvWindowsKernelmodeWin8_1nLater @ 0x1401BAA4C (SymCryptInitEnvWindowsKernelmodeWin8_1nLater.c)
 * Callees:
 *     SymCryptCpuidExFunc @ 0x14019EACC (SymCryptCpuidExFunc.c)
...
__int64 __fastcall SymCryptDetectCpuFeaturesByCpuid(char a1)
{
  ...
  SymCryptCpuidExFunc();
  v4 = v12[0];
  v5 = (unsigned __int8 *)&cpuidBitInfo;
  for ( i = 0; i < 0xD; ++i )
  {
    v7 = *v5;
    if ( v7 != v2 )
    ...
    if ( (unsigned __int8)v7 > v4 || (v8 = v12[v5[1]], !_bittest(&v8, v5[2])) )
      v3 |= *((_DWORD *)v5 + 1);
    v5 += 8;
  }
  if ( (a1 & 1) != 0 )
