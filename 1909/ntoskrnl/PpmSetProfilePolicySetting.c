/*
 * XREFs of PpmSetProfilePolicySetting @ 0x14069D694
 * Callers:
...
LABEL_58:
      ...
      while ( 1 )
      {
        v33 = PpmProfiles + 5536LL * (unsigned int)v32;
      ...
      if ( !v36 && !v13 && (v17 & *(_QWORD *)(v35 + 8)) == 0 )
        v18 = 1;
      v37 = PpmInfoAdjustSetting((_DWORD)v12, (int)v33 + 2728 * (int)v6 + 40, v13, v18, v46, a5);
    ...
    else
    {
      ...
      v22 = PpmInfoAdjustSetting((_DWORD)v12, 2728 * v6 + (unsigned int)&PpmDefaultProfile[5], v13, v18, v46, a5);
      v25 = v13;
      v20[v13] |= v17;
      if ( v22 )
      {
        LOBYTE(v24) = v13;
        LOBYTE(v25) = byte_140437068;
