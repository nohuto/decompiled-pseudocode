/*
 * XREFs of MiDemoteLocalLargePage @ 0x1400BBBF0
 * Callers:
        ...
        unsigned __int64 a4)
{
  ...
  {
    v7 = (unsigned __int16)(unsigned __int8)MiChannelMaximumPowerOf2Mask & (unsigned __int16)(a2 >> byte_14046574E);
    v32 = (unsigned __int16)(unsigned __int8)MiChannelMaximumPowerOf2Mask & (unsigned __int16)(a2 >> byte_14046574E);
  }
  v8 = *(_QWORD *)(a1 + 16);
  v9 = 0;
  v10 = a2 >> byte_14046574D;
  v11 = 0LL;
  v12 = 1984LL * (a2 >> byte_14046574D);
  LODWORD(v34) = v10;
  v13 = (_QWORD *)(v12 + v8);
  v38 = v12;
  v14 = 0LL;
