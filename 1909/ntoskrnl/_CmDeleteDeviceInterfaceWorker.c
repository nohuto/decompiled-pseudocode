/*
 * XREFs of _CmDeleteDeviceInterfaceWorker @ 0x140934434
 * Callers:
...
LABEL_16:
    ...
    LODWORD(v21) = 0;
    v20 = 0;
    for ( i = 0LL; ; i = (__int64)PoolWithTag )
    {
      LOBYTE(a4) = 1;
      DeviceInterfaceMappedPropertyKeys = CmGetDeviceInterfaceMappedPropertyKeys(a1, a2, 0, a4, i, v20, (__int64)&v21);
      if ( DeviceInterfaceMappedPropertyKeys != -1073741789 )
        break;
      v12 = v21;
      v13 = 20LL * (unsigned int)v21;
      if ( v13 > 0xFFFFFFFF )
      {
