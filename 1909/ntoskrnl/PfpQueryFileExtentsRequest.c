/*
 * XREFs of PfpQueryFileExtentsRequest @ 0x1408A07E8
 * Callers:
...
__int64 __fastcall PfpQueryFileExtentsRequest(__int64 a1, char a2, _DWORD *a3)
{
  ...
  __int64 FsInformation; // [rsp+130h] [rbp-68h] BYREF
        ...
        *((_WORD *)PoolWithTag + v14) = 92;
        ...
        if ( inited >= 0 )
        {
          ...
          if ( inited >= 0 )
          {
            ...
            inited = v17;
            if ( v17 == 259 )
              KeBugCheckEx(0x191u, 0xF70uLL, 0LL, 0LL, 0LL);
            if ( (v17 & 0xC0000000) != 0xC0000000 )
            {
              LODWORD(Address[0]) = v44;
              ...
              while ( 1 )
              {
                ...
                inited = v20;
                if ( v20 == 259 )
                  KeBugCheckEx(0x191u, 0xFAEuLL, 0LL, 0LL, 0LL);
                if ( v20 >= 0 )
                  break;
                if ( v20 == -1073741807 )
                  goto LABEL_43;
...
LABEL_43:
              ...
              inited = v21;
              if ( v21 == 259 )
                KeBugCheckEx(0x191u, 0xFE9uLL, 0LL, 0LL, 0LL);
              if ( v21 >= 0 )
              {
