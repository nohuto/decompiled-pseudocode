/*
 * XREFs of BgpClearScreen @ 0x1403489D0
 * Callers:
...
__int64 __fastcall BgpClearScreen(unsigned int a1)
{
  ...
  result = BgpGxInitializeRectangle((int *)&v12, BitsPerPixel, (__int64)byte_14050C030, 0x2000u);
  if ( (int)result >= 0 )
  {
    BgpGxFillRectangle((__int64)byte_14050C030, a1);
    if ( v4 )
    {
      v11 = HIDWORD(v15);
      do
      {
        ...
        if ( v3 )
        {
          do
          {
            BgpGxDrawRectangle(byte_14050C030, (__int64)&v15);
            if ( (byte_14050C040 & 0x10) != 0 )
              BgpGxFillRectangle((__int64)byte_14050C030, a1);
            LODWORD(v15) = v9 + v15;
          }
