/*
 * XREFs of CmpInitCmRM @ 0x14068AF98
 * Callers:
...
__int64 __fastcall CmpInitCmRM(__int64 a1, char a2)
{
  ...
  UUID v59; // [rsp+168h] [rbp+60h] BYREF
  GUID ResourceManagerGuid; // [rsp+178h] [rbp+70h] BYREF
  ...
  *(_QWORD *)&LogFileName.Length = 0LL;
  ...
  if ( v7 < 0 || (v7 = CmpUuidCreate(&v59), v7 < 0) )
  {
    *(_DWORD *)(v5 + 4200) = 1;
    *(_DWORD *)(v5 + 4204) = v7;
...
LABEL_69:
  ...
  *((_DWORD *)v10 + 17) = 0;
  ...
  while ( 1 )
  {
    ...
    if ( a1 )
    {
      FileSecurityDescriptor = CmpQueryNameString(*(_QWORD *)(a1 + 1536), &Source);
      if ( FileSecurityDescriptor < 0 )
      {
        *(_DWORD *)(v5 + 4200) = 4;
        goto LABEL_104;
    ...
    if ( !Destination.Buffer )
    {
      ...
      *(_DWORD *)(v5 + 4200) = 5;
LABEL_104:
      CmpLogTxrInitEvent(v19, v5, (unsigned int)FileSecurityDescriptor);
      if ( ClientCookie )
      {
    ...
    RtlFreeAnsiString(&Destination);
    CmpLogTxrInitEvent(v39, v5, (unsigned int)FileSecurityDescriptor);
LABEL_88:
    v4 = 1;
    v44 = 1;
    *(UUID *)(*(_QWORD *)(v5 + 64) + 148LL) = v59;
  ...
  *(_QWORD *)&v23->PolicyFlags = 0LL;
  ...
  FileSecurityDescriptor = ClfsMgmtInstallPolicy(pplfoLog, v24, v26);
...
LABEL_38:
  ...
  *(_OWORD *)&ObjectAttributes.SecurityDescriptor = 0LL;
  ...
  FileSecurityDescriptor = ZwRecoverResourceManager(*v30);
  if ( FileSecurityDescriptor < 0 )
  {
    *(_DWORD *)(v5 + 4200) = 14;
    goto LABEL_104;
...
LABEL_51:
  ...
  v32 = (_QWORD *)qword_140463378;
  if ( *(__int64 **)qword_140463378 != &CmpRmListHead )
    __fastfail(3u);
  *v10 = &CmpRmListHead;
  v10[1] = v32;
  *v32 = v10;
  qword_140463378 = (__int64)v10;
