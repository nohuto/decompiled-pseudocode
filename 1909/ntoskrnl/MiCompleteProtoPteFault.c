/*
 * XREFs of MiCompleteProtoPteFault @ 0x1400B0350
 * Callers:
 ...
 *     MiSetFaultPacketDirectives @ 0x1402D2DE4 (MiSetFaultPacketDirectives.c)
...
__int64 __fastcall MiCompleteProtoPteFault(__int64 a1, __int64 a2, __int64 a3, int a4, __int64 a5)
{
  ...
  v170 = *(_QWORD *)(qword_140465E88 + 8 * ((*(_QWORD *)(BugCheckParameter2 + 40) >> 40) & 0x3FFLL));
...
LABEL_246:
        ...
        {
          v150 = 1;
          v145 = KeAcquireSpinLockRaiseToDpc(&qword_1404679D0);
...
LABEL_198:
      ...
      v71 = v60 >> 9;
      v63 = v154 == 0;
      v154 = dword_140503750;
      v72 = !v63;
      v149 = v72;
      if ( dword_140503750 != *(_DWORD *)(v68 + 404) )
      {
        LogEntry = PfSnTraceGetLogEntry(v68, 1LL, &v167);
        v72 = v149;
        if ( LogEntry >= 0 )
        {
          v107 = v167;
...
LABEL_32:
      ...
      if ( v35 > qword_140465BE0 || v35 < qword_1404672B0 )
        v37 = (unsigned __int8)word_1404658EC;
      else
        v37 = HIBYTE(word_1404658EC);
    }
    else
    {
      v37 = HIBYTE(word_1404658EC);
