/*
 * XREFs of MiConvertStandbyToProto @ 0x140140E3C
 * Callers:
        ...
        __int64 a8)
{
  ...
  v16 = *(_QWORD *)(qword_140465E88 + 8 * v15);
  v53 = v16;
  v18 = *v17;
  v49 = *v17;
  v57 = *v17;
  if ( a8 != -1 )
  {
    ...
    if ( (**(_BYTE **)(a3 + 56) & 1) != 0
      ...
      && v16 == *(_QWORD *)(qword_140465E88 + 8 * ((*(_QWORD *)(BugCheckParameter2 + 40) >> 40) & 0x3FFLL))
    ...
    else
    {
        ...
        && (MiTryLockLeafPage((unsigned __int64 *)(a5 + 48), v22, &v51), (v23 = v51) != 0) )
      {
        if ( (*(_BYTE *)(v51 + 35) & 0x40) == 0
          && v49 == *(ULONG_PTR **)(qword_140465E88 + 8 * ((*(_QWORD *)(v51 + 40) >> 40) & 0x3FFLL))
