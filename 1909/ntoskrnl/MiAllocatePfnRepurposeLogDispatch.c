/*
 * XREFs of MiAllocatePfnRepurposeLogDispatch @ 0x14017EBB0
 * Callers:
 *     <none>
 * Callees:
...
void MiAllocatePfnRepurposeLogDispatch()
{
  ...
  *(_QWORD *)&LockHandle.OldIrql = 0LL;
  ...
  LockHandle.LockQueue.Lock = &qword_140466080;
  KxAcquireQueuedSpinLock((__int64)&LockHandle, (volatile __int64 *)&qword_140466080);
  v3 = P;
  if ( !dword_140466068 )
    goto LABEL_20;
  if ( v2 )
