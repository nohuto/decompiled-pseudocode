/*
 * XREFs of sub_1406B0A34 @ 0x1406B0A34
 * Callers:
...
__int64 __fastcall sub_1406B0A34(
        int a1,
        _BYTE *a2,
        char *a3,
        unsigned int a4,
        ...
        _BYTE *a9)
{
  ...
  v18 = *a5;
  if ( a1 )
    sub_1400010A0((__int64)&v19, a2, a3, a4, v18, a6, a9);
  else
    sub_1400FD880((__int64)&v19, a2, a3, a4, v18, a6, a9);
  return 0LL;
}
