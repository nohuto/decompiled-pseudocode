/*
 * XREFs of BgpBcInitializeCriticalMode @ 0x140A40E74
 * Callers:
 ...
 *     BcpGetMaxResourceProfile @ 0x1401901D0 (BcpGetMaxResourceProfile.c)
...
LABEL_10:
                         ...
                         (__int64)&v35) >= 0 )
          {
            ...
            *v25++ = DWORD2(v35);
            ...
            {
              v23 += 18;
              if ( (__int64)v23 < (__int64)&qword_14042A038 )
                goto LABEL_10;
              HIDWORD(v35) = 0;
              if ( (int)BcpGetMaxResourceProfile((__int64)v34, &v32) >= 0 )
              {
                ...
                if ( Memory )
                {
                  ...
                  qword_14042BF48 = v26;
                  qword_14046B6F0 = BgpDisplayCharacterGetContext((__int64)v34, &v30, 3);
                  if ( qword_14046B6F0 )
                  {
                    dword_14042C010 |= 0x10u;
                    return 0LL;
                  }
                }
              }
      ...
      if ( qword_14046B6F0 )
        BgpDisplayCharacterDestroyContext(qword_14046B6F0);
    }
  }
  return 0LL;
}
