/*
 * XREFs of ExShareAddressSpaceWithDevice @ 0x14033C050
 * Callers:
 *     <none>
 * Callees:
...
LABEL_22:
      ...
      if ( v17 && ($C6908ADE9723D0A04AF8EE82D8D15C40 *)v11->ApcState.ApcListHead[0].Flink != &v11->152 )
...
LABEL_80:
      ...
      if ( v17 && ($C6908ADE9723D0A04AF8EE82D8D15C40 *)v26->ApcState.ApcListHead[0].Flink != &v26->152 )
...
LABEL_113:
      ...
      if ( v17 && ($C6908ADE9723D0A04AF8EE82D8D15C40 *)v37->ApcState.ApcListHead[0].Flink != &v37->152 )
...
LABEL_162:
  ...
  if ( v17 && ($C6908ADE9723D0A04AF8EE82D8D15C40 *)v54->ApcState.ApcListHead[0].Flink != &v54->152 )
    KiCheckForKernelApcDelivery(1LL);
