/*
 * XREFs of MiViewMayContainPage @ 0x1400C0E08
 * Callers:
      ...
      case 1uLL:
        ...
        if ( (*(_DWORD *)(a1 + 56) & 0x20) == 0 )
        {
          if ( v17 && (*(_DWORD *)(a3 - 48) & 0x280) != 0x200 )
            return 0LL;
          v12 = MiStartingOffset(*(__int64 **)(a3 - 24), *(_QWORD *)(a3 - 16), 0xFFFFFFFF);
          v18 = *(_BYTE *)(v9 - 64);
...
LABEL_13:
      ...
      case 3uLL:
        ...
        if ( (*(_DWORD *)(a1 + 56) & 0x20) != 0 )
        {
          ...
          while ( v24 )
          {
            v27 = MiStartingOffset((__int64 *)v24, *(_QWORD *)(v24 + 8), v6);
            if ( a4 < MiEndingOffsetWithLock((_QWORD *)v24) && a4 >= v27 )
            {
              v25 = *(_QWORD *)(v24 + 8);
              v26 = v25 + 8 * ((a4 - v27) >> 12);
