...
__int64 AnFwDisplayFade()
{
  ...
  v40 = 0LL;
  v43 = 0LL;
  if ( (dword_14042C010 & 0x2000) != 0 )
    return (unsigned int)SubRectangle;
  if ( (dword_14042C010 & 0x200000) != 0 )
    goto LABEL_69;
  RegionContext = BgpTxtGetRegionContext(qword_14042C0D0);
  v7 = BgpTxtGetRegionContext(qword_14042C0D8);
  v8 = v7;
  if ( !RegionContext || !v7 )
  {
  ...
  xmmword_140429E60 = *(_OWORD *)RegionContext;
  qword_140429E70 = *(_QWORD *)(RegionContext + 16);
  dword_140429E78 = *(_DWORD *)(RegionContext + 24);
  xmmword_140429E98 = *(_OWORD *)v7;
  qword_140429EA8 = *(_QWORD *)(v7 + 16);
  dword_140429EB0 = *(_DWORD *)(v7 + 24);
  ...
  v36 = 0;
  v9 = BgpGxParseBitmap((__int64)qword_14042C058, &v44);
  v1 = v44;
  SubRectangle = v9;
  if ( v9 < 0 )
    goto LABEL_41;
...
LABEL_10:
  ...
  v13 = qword_14042C06C + dword_14042C074;
  v14 = HIDWORD(qword_14042C06C) + dword_14042C078;
  v15 = xmmword_140429E60 + DWORD2(xmmword_140429E60);
  v5 += ((v12 + 15) & 0xFFFFFFF0) + 32 + 2 * (((v12 + 15) & 0xFFFFFFF0) + 32);
  v16 = DWORD1(xmmword_140429E60) + HIDWORD(xmmword_140429E60);
  if ( (unsigned int)xmmword_140429E60 <= (int)qword_14042C06C + dword_14042C074
    && (unsigned int)xmmword_140429E60 >= (unsigned int)qword_14042C06C
    && DWORD1(xmmword_140429E60) >= HIDWORD(qword_14042C06C)
    && DWORD1(xmmword_140429E60) <= v14 )
  {
    if ( v15 < (unsigned int)qword_14042C06C || v15 > v13 || v16 < HIDWORD(qword_14042C06C) || v16 > v14 )
      goto LABEL_51;
    v33 = 1;
  }
  v17 = xmmword_140429E98 + DWORD2(xmmword_140429E98);
  v18 = DWORD1(xmmword_140429E98) + HIDWORD(xmmword_140429E98);
  if ( (unsigned int)xmmword_140429E98 >= (unsigned int)qword_14042C06C
    && (unsigned int)xmmword_140429E98 <= v13
    && DWORD1(xmmword_140429E98) >= HIDWORD(qword_14042C06C)
    && DWORD1(xmmword_140429E98) <= v14 )
  {
    if ( v17 >= (unsigned int)qword_14042C06C && v17 <= v13 && v18 >= HIDWORD(qword_14042C06C) && v18 <= v14 )
    {
      v34 = 1;
      goto LABEL_12;
    }
...
LABEL_12:
  ...
  {
LABEL_13:
    v19 = BgpGxReadRectangle(&v41, (__int64)&xmmword_140429E60);
    v0 = (__int64)v41;
    SubRectangle = v19;
    if ( v19 < 0 )
      goto LABEL_36;
  ...
  if ( !v34 )
  {
    v23 = BgpGxReadRectangle(&v40, (__int64)&xmmword_140429E98);
    v2 = v40;
    SubRectangle = v23;
    if ( v23 < 0 )
      goto LABEL_36;
  ...
  v25 = qword_14042C06C;
  v26 = HIDWORD(qword_14042C190);
  v40 = (int *)qword_14042C06C;
  if ( !v36 )
  {
    SubRectangle = BgpGxFindSubRectangle(
                     (_DWORD)v1,
                     HIDWORD(qword_14042C190),
                     (unsigned int)&v41,
                     (unsigned int)&v39,
                     (__int64)&v35);
    if ( SubRectangle >= 0 )
  ...
  if ( !v33 )
  {
    ...
    if ( SubRectangle >= 0 )
    {
      ...
      {
        v42 = v41;
        LODWORD(xmmword_140429E60) = v39 + xmmword_140429E60;
        DWORD1(xmmword_140429E60) += HIDWORD(v39);
      }
    }
  }
  if ( !v34 )
  {
    ...
    if ( SubRectangle >= 0 )
    {
      ...
      {
        LODWORD(xmmword_140429E98) = v39 + xmmword_140429E98;
        DWORD1(xmmword_140429E98) += HIDWORD(v39);
        v2 = v41;
      }
    }
  }
...
LABEL_35:
    ...
    qword_140429E48 = v25;
    qword_140429E58 = v0;
    qword_140429E88 = (__int64)v1;
    qword_140429EB8 = (__int64)v2;
    KeResetEvent(&stru_140509160);
    KeInitializeTimerEx(&Timer, NotificationTimer);
    KeInitializeDpc(&stru_1405090A0, AnFwpFadeAnimationTimer, 0LL);
    byte_1404F2821 = 1;
    LogFwStat(1LL, 7LL, 0LL);
    KeSetCoalescableTimer(&Timer, 0LL, 0x1Eu, 0, &stru_1405090A0);
