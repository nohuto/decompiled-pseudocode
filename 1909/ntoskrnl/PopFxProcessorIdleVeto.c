/*
 * XREFs of PopFxProcessorIdleVeto @ 0x1402F41D0
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall PopFxProcessorIdleVeto(__int64 a1, unsigned int a2, unsigned int a3, char a4)
{
  ...
  if ( *(_QWORD *)(a1 + 152) )
  {
    v8 = IoAcquireRemoveLockEx((PIO_REMOVE_LOCK)(a1 + 232), 0LL, &Src, 1u, 0x20u);
    if ( v8 >= 0 )
    {
      ...
      LOBYTE(v14) = a4;
      v8 = v9(v10, &GUID_PROCESSOR_IDLE_VETO, &v13, 12LL, 0LL, 0LL, &v12);
