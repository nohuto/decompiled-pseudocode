/*
 * XREFs of BgpConsoleClearScreenEx @ 0x140993698
 * Callers:
...
__int64 BgpConsoleClearScreenEx()
{
  ...
  v0 = qword_1404F2818;
  v1 = *(_DWORD *)(qword_1404F2818 + 16);
  *(_DWORD *)(qword_1404F2818 + 68) = 0;
  *(_DWORD *)(v0 + 72) = 0;
  v2 = BgpClearScreen(v1);
  if ( v2 >= 0 )
  {
    v3 = (_DWORD *)qword_1404F2818;
    v4 = 0LL;
    v5 = *(_DWORD *)(qword_1404F2818 + 4);
    v6 = 80LL;
    do
    {
