/*
 * XREFs of MiFindFreePageFileSpaceForward @ 0x1402CDFC0
 * Callers:
...
__int64 __fastcall MiFindFreePageFileSpaceForward(__int64 a1, unsigned int *a2, __int64 a3, char a4)
{
  ...
  v9 = 0;
  v18[0] = *(_DWORD *)a1;
  v19 = *(_QWORD *)(*(_QWORD *)(a1 + 112) + 32LL);
  while ( 1 )
  {
    NextClearRunUlong = RtlFindNextClearRunUlong(v18, v4, a3, 0xFFFFFFFF, &v22);
    ...
    if ( NextClearRunUlong >= v5 && (NextClearRunUlong >= v8 || a4 >= 0) )
    {
      ...
      v12 = v22 - v11;
      v13 = v8;
      v17 = *(_QWORD *)(*(_QWORD *)(a1 + 112) + 16LL) + 4 * ((unsigned __int64)(v22 - v11) >> 5);
      LODWORD(v16) = v11 + NextClearRunUlong;
      if ( v8 <= 0x20 )
        v13 = 32;
      v20 = v13;
      while ( 1 )
      {
        v14 = RtlFindNextClearRunUlong((unsigned int *)&v16, v11, a3, v13, &v22);
        if ( !v14 )
          break;
        v13 = v20;
        v11 = v22 + v14;
