/*
 * XREFs of EtwpCoverageSamplerContextSwap @ 0x140335D28
 * Callers:
...
void __fastcall EtwpCoverageSamplerContextSwap(_KTHREAD *a1)
{
  ...
  if ( a1 && a1 != *(_KTHREAD **)qword_140432528 && a1 != KeGetCurrentPrcb()->IdleThread )
  {
    v1 = (*(_QWORD *)(qword_140432528 + 8) >> 4) & 0x1FFLL;
    v2 = ((unsigned int)*(_QWORD *)(qword_140432528 + 8) >> 13) & 0x3FFFF;
