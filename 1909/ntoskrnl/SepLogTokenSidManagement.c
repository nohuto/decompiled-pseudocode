/*
 * XREFs of SepLogTokenSidManagement @ 0x1408DA4B4
 * Callers:
 ...
 *     RtlConvertLuidToUlonglong @ 0x14031D0D4 (RtlConvertLuidToUlonglong.c)
 *     SepGetSidValuesDump @ 0x14031D624 (SepGetSidValuesDump.c)
 *     ExFreePoolWithTag @ 0x14036E0A0 (ExFreePoolWithTag.c)
 *     SepGetSidManagementActionName @ 0x1408DA43C (SepGetSidManagementActionName.c)
 */
...
void __fastcall SepLogTokenSidManagement(int a1, __int64 a2, __int64 a3, __int64 a4)
{
  ...
  ULONG v34; // [rsp+3Ch] [rbp-C4h] BYREF
  int v35; // [rsp+40h] [rbp-C0h] BYREF
  int v36; // [rsp+44h] [rbp-BCh] BYREF
  int v37; // [rsp+48h] [rbp-B8h] BYREF
  ULONG v38; // [rsp+4Ch] [rbp-B4h] BYREF
  ULONGLONG v39; // [rsp+50h] [rbp-B0h] BYREF
  ULONGLONG v40; // [rsp+58h] [rbp-A8h] BYREF
  ...
  ULONGLONG *v53; // [rsp+B0h] [rbp-50h]
  __int64 v54; // [rsp+B8h] [rbp-48h]
  ULONGLONG *v55; // [rsp+C0h] [rbp-40h]
  ...
  if ( EtwKernelProvRegHandle && SepTokenSidManagementLoggingEnabled )
  {
    if ( a4 )
    {
      v39 = RtlConvertLuidToUlonglong((LUID)(a4 + 16));
      v40 = RtlConvertLuidToUlonglong((LUID)(v7 + 24));
      v31 = v8[48];
      v32 = v8[49];
      v33 = v8[50];
    }
    ...
    UserData.Size = v34;
    UserData.Reserved = 0;
    v11 = KeGetCurrentThread()->ApcState.Process[1].ActiveProcessors.Bitmap[14];
    v12 = &unk_14050E9F0;
    if ( v11 && *(_WORD *)v11 )
    {
      v13 = *(void **)(v11 + 8);
    ...
    if ( a2 && v18 )
    {
      SidValuesDump = SepGetSidValuesDump((_DWORD *)a2, &v36);
      v68 = v36;
      v19 = 12;
      v67 = SidValuesDump;
      v69 = 0;
    ...
    *((_QWORD *)&UserData.Size + v22) = 8LL;
    ...
    v26 = v23 + 1;
    v27 = 0LL;
    *(&UserData.Ptr + v25) = (ULONGLONG)&v37;
    *((_QWORD *)&UserData.Size + v25) = 4LL;
    if ( a3 && v24 )
    {
      v28 = SepGetSidValuesDump((_DWORD *)a3, &v38);
      v29 = v38;
      v27 = v28;
      v30 = 2LL * v26++;
