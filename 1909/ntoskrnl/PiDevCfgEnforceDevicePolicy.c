/*
 * XREFs of PiDevCfgEnforceDevicePolicy @ 0x14071E358
 * Callers:
...
__int64 __fastcall PiDevCfgEnforceDevicePolicy(__int64 a1, __int64 a2, const wchar_t *a3)
{
  ...
  wchar_t *Str1; // [rsp+60h] [rbp-41h]
  __int64 v57; // [rsp+68h] [rbp-39h]
  const wchar_t **v58; // [rsp+70h] [rbp-31h]
  OBJECT_ATTRIBUTES ObjectAttributes; // [rsp+78h] [rbp-29h] BYREF
  wchar_t *v60; // [rsp+A8h] [rbp+7h]
  wchar_t *v61; // [rsp+B0h] [rbp+Fh]
...
LABEL_5:
  ...
  *(_OWORD *)&ObjectAttributes.SecurityDescriptor = 0LL;
  ...
  if ( PolicyStringList < 0 )
    v11 = 0LL;
  P = v11;
  v12 = PiDevCfgQueryPolicyStringList(Handle, L"DenyDeviceClasses");
  v13 = Str1;
  if ( v12 < 0 )
    v13 = 0LL;
  v62 = v13;
...
LABEL_35:
  v18 = PiDevCfgQueryPolicyStringList(Handle, L"AllowDeviceIDs");
  v19 = (wchar_t *)v57;
  if ( v18 < 0 )
    v19 = 0LL;
  Str1 = v19;
  v20 = PiDevCfgQueryPolicyStringList(Handle, L"DenyDeviceIDs");
  v21 = (wchar_t *)v58;
  if ( v20 < 0 )
    v21 = 0LL;
  if ( v19 || v21 )
...
LABEL_63:
  ...
  v32 = PiDevCfgQueryPolicyStringList(Handle, L"AllowInstanceIDs");
  v33 = v60;
  if ( v32 < 0 )
    v33 = 0LL;
  v34 = PiDevCfgQueryPolicyStringList(Handle, L"DenyInstanceIDs");
  v35 = v61;
  if ( v34 < 0 )
    v35 = 0LL;
  if ( v33 )
