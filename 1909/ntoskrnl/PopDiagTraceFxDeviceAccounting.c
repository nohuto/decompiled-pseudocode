/*
 * XREFs of PopDiagTraceFxDeviceAccounting @ 0x1402FD4D8
 * Callers:
...
void PopDiagTraceFxDeviceAccounting(__int64 a1, __int64 a2, unsigned __int16 *a3, ...)
{
  ...
  UNICODE_STRING v16; // [rsp+60h] [rbp-A0h] BYREF
  ...
  *(_QWORD *)&v16.Length = 0LL;
  ...
  RtlInitUnicodeString(&v16, (PCWSTR)&pwsz);
      ...
      *(_QWORD *)&UserData.Size = 1LL;
      ...
      if ( *(_DWORD *)(a2 + 12) < 5u )
      {
        ...
        if ( pCallbackContext.LevelPlus1 > 5 && TlgKeywordOn(&pCallbackContext, 0x400000000000uLL) )
        {
          ...
          v48 = 2LL;
          v50[1] = 0;
          TlgWrite(&pCallbackContext, &unk_1403909F6, 0LL, 0LL, 0xFu, &pData);
        }
        if ( v7 )
