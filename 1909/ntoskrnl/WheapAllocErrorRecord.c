/*
 * XREFs of WheapAllocErrorRecord @ 0x14033FBB4
 * Callers:
 *     WheapReportBootError @ 0x14033F4F8 (WheapReportBootError.c)
 *     WheaReportHwError @ 0x14033F730 (WheaReportHwError.c)
 * Callees:
 *     WheapInitializeErrorRecordWrapper @ 0x14018B938 (WheapInitializeErrorRecordWrapper.c)
 *     memset @ 0x1401D77C0 (memset.c)
 *     WheapGetPreallocatedErrorRecord @ 0x140340134 (WheapGetPreallocatedErrorRecord.c)
