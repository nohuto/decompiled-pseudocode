/*
 * XREFs of HvpMappedViewConvertLockedPagesToCOWByPolicy @ 0x1407359DC
 * Callers:
 *     HvpViewMapConvertLockedPagesToCOWByPolicy @ 0x140735940 (HvpViewMapConvertLockedPagesToCOWByPolicy.c)
 * Callees:
