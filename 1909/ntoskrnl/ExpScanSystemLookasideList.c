/*
 * XREFs of ExpScanSystemLookasideList @ 0x140101E28
 * Callers:
 *     KeBalanceSetManager @ 0x14018DE80 (KeBalanceSetManager.c)
 * Callees:
 *     ExpComputeLookasideDepth @ 0x140101FE4 (ExpComputeLookasideDepth.c)
...
__int64 ExpScanSystemLookasideList()
{
  ...
  for ( i = 0; i < dword_14046F750; ++i )
  {
    v12 = 2LL;
    v13 = (char *)&unk_14046F7C0 + 8384 * i;
    do
    {
