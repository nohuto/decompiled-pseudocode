/*
 * XREFs of AdtpPackageParameters @ 0x1401335A8
 * Callers:
 ...
 *     AdtpIsCorrectlyFormedUnicodeString @ 0x140133B7C (AdtpIsCorrectlyFormedUnicodeString.c)
        ...
        __int64 a8)
{
  ...
  UNICODE_STRING *v120; // [rsp+78h] [rbp-8h] BYREF
...
LABEL_51:
            ...
            else
            {
              ...
              if ( *(_QWORD *)(v20 + v14 + 24) )
                v73 = *(void **)(v20 + v14 + 24);
              v74 = 2LL * v10;
              *(_QWORD *)(v17 + 8 * v74) = v73;
              *(_QWORD *)(v17 + 8 * v74 + 8) = 16LL;
            }
          }
          else
          {
...
LABEL_52:
        ...
        v75 = *(_DWORD *)(v20 + v14 + 16);
        if ( v75 >= v16 )
          goto LABEL_98;
        v76 = 32LL * v75;
        if ( *(_DWORD *)(v76 + v14) != (_DWORD)v18 )
          goto LABEL_98;
        v77 = (unsigned __int16 *)(a5 + 16LL * v11);
        ...
        *(_QWORD *)(v17 + 8 * v78) = v79;
        v18 = 1LL;
        *(_DWORD *)(v17 + 8 * v78 + 8) = v81;
LABEL_105:
        v11 = v80 + 1;
        ++v10;
LABEL_30:
...
LABEL_31:
      ...
      {
        case 8:
          v68 = *(unsigned int **)(v20 + v14 + 24);
          if ( !v68 )
            goto LABEL_98;
          v69 = *v68;
          v70 = *v68 ? 12 * v69 + 8 : 8;
          if ( *(_DWORD *)(v20 + v14 + 4) < v70 || v69 > 0x42 )
            goto LABEL_98;
          Destination = (PUNICODE_STRING)&v116;
          v43 = AdtpBuildPrivilegeAuditString(*(_QWORD *)(v20 + v14 + 24), 0LL, v17 + 16LL * v10, v8);
          goto LABEL_35;
        case 0:
        ...
        case 1:
          if ( !(unsigned __int8)AdtpIsCorrectlyFormedUnicodeString(*(_QWORD *)(v20 + v14 + 24)) )
            goto LABEL_98;
LABEL_34:
          v43 = AdtpEtwBuildString((unsigned int)v17 + 16 * v10, v42, v8, (unsigned int)&v116, v10 + a8);
LABEL_35:
          v9 = 0LL;
          v12 = v43;
          if ( v43 < 0 )
        ...
        case 2:
          ...
          goto LABEL_34;
        case 3:
          v43 = AdtpBuildUlongString(*(_DWORD *)(v20 + v14 + 8), (__int64)&v116, v10 + a8);
          goto LABEL_35;
        case 4:
      ...
      if ( v21 != 6 )
      {
        if ( v21 != 7 )
          goto LABEL_98;
        v66 = *(_DWORD *)(v20 + v14 + 16);
        if ( v66 >= v117 )
          goto LABEL_98;
        v67 = 32LL * v66;
        if ( *(_DWORD *)(v67 + v14) != (_DWORD)v18 )
          goto LABEL_98;
      ...
      v51 = 2LL * v10;
      v52 = v18 + v10;
      v53 = 4 * (unsigned __int8)byte_1409AE9D9 + 8;
      ...
      *(_DWORD *)(v17 + 8 * v51 + 12) = (_DWORD)v9;
      do
      {
        AdtpEtwBuildDashString(v17 + 16LL * v52, v54, v18);
        v52 += v18;
        v54 = v55 - v18;
      }
      while ( v54 );
    ...
    if ( v21 > 27 )
    {
      switch ( v21 )
      {
        case 28:
          ...
          v109 = AdtpBuildSockAddrString(*(_QWORD *)(v20 + v14 + 24), v108, v10 + a8, 0LL);
          v9 = 0LL;
          v12 = v109;
          if ( v109 < 0 )
            goto LABEL_39;
...
LABEL_129:
      ...
      {
LABEL_18:
        DestinationString = (PUNICODE_STRING)&v114;
        ...
        if ( v21 != 35 )
          v22 = v9;
        Destination = (PUNICODE_STRING)&v121;
        v24 = AdtpBuildLogonIdStrings(v14 + 8 + v20, v22, &v122, v23 + a5);
        v12 = v24;
        if ( v21 == 35 )
        {
          v26 = v122;
        ...
        if ( v27 == 5 || v27 == 35 )
        {
          if ( !v25 )
          {
            v25 = (UNICODE_STRING *)&AdtpNullSid;
            v26 = 0;
          }
          v28 = 4 * HIBYTE(v25->Length) + 8;
          v29 = v17 + 16LL * v10;
          *(_DWORD *)(v29 + 12) = 0;
          *(_QWORD *)v29 = v25;
          *(_DWORD *)(v29 + 8) = v28;
...
LABEL_29:
      ...
      if ( !v50 )
      {
        v43 = AdtpBuildMultiSzStringListString(*(_QWORD *)(v20 + v14 + 24), v17 + 16LL * v10, v10 + a8);
        goto LABEL_35;
      }
      v65 = v50 == 1;
    }
    else
    {
      ...
      if ( !v61 )
      {
        ...
        LODWORD(Destination) = v89 + 1;
        v91 = AdtpBuildSockAddrString(v87, v90, v89, v90 + 8);
        v9 = 0LL;
        v12 = v91;
        if ( v91 < 0 )
          goto LABEL_39;
        ...
        v83 = v115;
        v84 = *v90 + 2;
        *(_QWORD *)(v17 + 8 * v82) = *((_QWORD *)v90 + 1);
        *(_DWORD *)(v17 + 8 * v82 + 8) = v84;
        v18 = 1LL;
        *(_DWORD *)(v17 + 8 * v82 + 12) = 0;
        v80 = v83 + 1;
        ++v10;
        v85 = *(unsigned __int16 *)(v88 + 16LL * v80) + 2;
        v86 = 2LL * v10;
        *(_QWORD *)(v17 + 8 * v86) = *(_QWORD *)(v88 + 16LL * v80 + 8);
        *(_QWORD *)(v17 + 8 * v86 + 8) = v85;
        goto LABEL_105;
      }
      v62 = v61 - 1;
      if ( !v62 )
      {
        v63 = *(_DWORD *)(v20 + v14 + 8);
        ++v117;
        v8 = v123;
        v64 = AdtpBuildSecurityDescriptorChangeString(
                v63,
                *(_QWORD *)(v20 + v14 + 24),
