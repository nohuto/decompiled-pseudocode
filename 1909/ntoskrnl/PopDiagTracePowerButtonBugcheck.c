/*
 * XREFs of PopDiagTracePowerButtonBugcheck @ 0x1408AFEBC
 * Callers:
...
void __fastcall PopDiagTracePowerButtonBugcheck(int a1)
{
  ...
  if ( a1 == 7000 )
  {
    ...
    if ( pCallbackContext.LevelPlus1 > 5 )
    {
      if ( TlgKeywordOn(&pCallbackContext, 0x400000000000uLL) )
      {
        ...
        v37 = &v11;
        v38 = 4LL;
        TlgWrite(&pCallbackContext, &unk_140391065, 0LL, 0LL, 0xEu, &pData);
      }
    }
  }
  else if ( a1 == 15000 && pCallbackContext.LevelPlus1 > 5 && TlgKeywordOn(&pCallbackContext, 0x800000000000uLL) )
  {
    ...
    v37 = &v4;
    v38 = 4LL;
    TlgWrite(&pCallbackContext, &unk_140391182, 0LL, 0LL, 0xEu, &pData);
  }
}
