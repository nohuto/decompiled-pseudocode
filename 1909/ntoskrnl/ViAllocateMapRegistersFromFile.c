/*
 * XREFs of ViAllocateMapRegistersFromFile @ 0x14096B210
 * Callers:
 ...
 *     ViTagBuffer @ 0x14096D364 (ViTagBuffer.c)
 */
    ...
    do
    {
      ...
      if ( *v16 && v18 >= a2 && v18 < (unsigned __int64)v17 )
      {
        ViHalPreprocessOptions(
          ...
          (const void *)a2,
          v17);
        VfReportIssueWithOptions(0xE6u, 0x1DuLL, a2, (ULONG_PTR)v17, *v16, byte_14042B8DC);
      }
      v16 += 4;
    }
    while ( v16 < v14 );
...
LABEL_11:
  if ( (_DWORD)v8 )
  {
    ...
    ViHalPreprocessOptions(byte_14042B8D4, "Map registers needed: %x available: %x", 0x10000000, 2);
    VfReportIssueWithOptions(0xE6u, 0LL, 2uLL, (unsigned int)v8, v11, byte_14042B8D4);
