/*
 * XREFs of RtlInsertElementGenericTableFull @ 0x140106C90
 * Callers:
 *     RtlInsertElementGenericTable @ 0x140106C20 (RtlInsertElementGenericTable.c)
 * Callees:
        ...
        TABLE_SEARCH_RESULT SearchResult)
{
  ...
  struct _RTL_SPLAY_LINKS *v11; // rbx
  ...
  {
    v11 = (struct _RTL_SPLAY_LINKS *)NodeOrParent;
LABEL_10:
  ...
  {
    v10 = (struct _RTL_SPLAY_LINKS *)((__int64 (*)(void))Table->AllocateRoutine)();
    v11 = v10;
    if ( v10 )
    {
      v10->LeftChild = 0LL;
