/*
 * XREFs of NtSetInformationJobObject @ 0x140615580
 * Callers:
 *     <none>
 * Callees:
 *     PsGetCurrentProcess @ 0x1400065C0 (PsGetCurrentProcess.c)
 *     ObfDereferenceObjectWithTag @ 0x14003F860 (ObfDereferenceObjectWithTag.c)
 *     PspJobIsSilo @ 0x140083CC0 (PspJobIsSilo.c)
 ...
 *     PspIsValidJobSessionId @ 0x1400EBA78 (PspIsValidJobSessionId.c)
 ...
 *     PspGetJobMemoryUsageNotificationViolations @ 0x140613670 (PspGetJobMemoryUsageNotificationViolations.c)
 ...
 *     PspConvertJobNotificationLimitFromV2 @ 0x1406E7610 (PspConvertJobNotificationLimitFromV2.c)
 *     PspSetBackgroundJobTree @ 0x1406EA40C (PspSetBackgroundJobTree.c)
 *     PspUpdateEnforcementTimer @ 0x1406EBAD8 (PspUpdateEnforcementTimer.c)
 *     PspConvertJobNotificationLimitFromV1 @ 0x1406F03EC (PspConvertJobNotificationLimitFromV1.c)
 ...
 *     PspSetJobSiloThreadImpersonationPolicy @ 0x1408C7EB0 (PspSetJobSiloThreadImpersonationPolicy.c)
...
LABEL_6:
  ...
  if ( PreviousMode )
  {
    ...
    if ( (_DWORD)v4 )
    {
      if ( ((dword_1409496DC[v5] - 1) & (unsigned int)Src) != 0 )
