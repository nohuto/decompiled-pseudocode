/*
 * XREFs of McTemplateK0zzjzitd @ 0x14029EE10
 * Callers:
 *     PiDevCfgLogDeviceMigrated @ 0x1408674C0 (PiDevCfgLogDeviceMigrated.c)
 * Callees:
 *     McGenEventWrite @ 0x1401450D0 (McGenEventWrite.c)
 *     __security_check_cookie @ 0x14019EE20 (__security_check_cookie.c)
 */

ULONG __fastcall McTemplateK0zzjzitd(
        __int64 a1,
        ...
        char a10)
{
  ...
  v37 = &a10;
  v38 = 4LL;
  return McGenEventWrite((PMCGEN_TRACE_CONTEXT)&MS_KernelPnP_Provider_Context, a2, 0LL, 8u, &EventData);
}
