/*
 * XREFs of NtAlpcQueryInformation @ 0x1406B43B0
 * Callers:
 *     <none>
 * Callees:
 ...
 *     AlpcpPortQueryBasicInfo @ 0x1406B45E0 (AlpcpPortQueryBasicInfo.c)
...
LABEL_35:
  ...
  if ( v22
    && ($C6908ADE9723D0A04AF8EE82D8D15C40 *)v21->ApcState.ApcListHead[0].Flink != &v21->152
