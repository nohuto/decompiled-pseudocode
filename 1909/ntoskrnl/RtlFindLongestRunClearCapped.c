/*
 * XREFs of RtlFindLongestRunClearCapped @ 0x14030C7D0
 * Callers:
...
LABEL_45:
    ...
    v16 = 8 * v14 - v15 + 8;
    for ( i = *((_BYTE *)&unk_140381058 - v15) | byte_140382448[v21] | v18; ; i |= v25 )
    {
