/*
 * XREFs of PnpCheckDriverDependencies @ 0x140861428
 * Callers:
...
LABEL_35:
      ...
      if ( v10 < 0 )
        goto LABEL_29;
      LODWORD(v20) = 4;
      v11 = RegRtlQueryValue(Handle, L"Phase", &v15, &v19, (unsigned int *)&v20);
      ...
      if ( v19 != 2 )
        break;
      LODWORD(v20) = 4;
      v12 = RegRtlQueryValue(Handle, L"LastAttemptStatus", &v15, &v21, (unsigned int *)&v20);
