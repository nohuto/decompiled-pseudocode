/*
 * XREFs of SeQuerySigningPolicy @ 0x140619F40
 * Callers:
...
LABEL_9:
  ...
  LOBYTE(v14) = 8;
  LOBYTE(v15) = *a5;
  if ( !(unsigned int)qword_140436440(v15, v14)
    || (SeCiDebugOptions & 4) == 0
    && ((SeCiDebugOptions & 2) == 0 || !(_BYTE)KdDebuggerEnabled || (_BYTE)KdDebuggerNotPresent) )
  {
    return (unsigned int)IsMinTCB;
  }
  if ( !qword_140436440 || (LOBYTE(v17) = 8, LOBYTE(v18) = v7, !(unsigned int)qword_140436440(v18, v17)) )
  {
    if ( (*a7 & 7) != 0 )
    {
      *a5 = *a5 & 0x30 | 8;
      v20 = (unsigned int (__fastcall *)(__int64, __int64))qword_140436440;
      if ( qword_140436440 )
      {
        LOBYTE(v18) = 8;
        goto LABEL_33;
