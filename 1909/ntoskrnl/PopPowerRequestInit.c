/*
 * XREFs of PopPowerRequestInit @ 0x140A1E760
 * Callers:
...
__int64 PopPowerRequestInit()
{
  ...
  *(_OWORD *)((char *)&v3[1] + 4) = PopPowerRequestMapping;
  ...
  if ( v0 >= 0 )
  {
    ...
    qword_140444D38 = (__int64)&PopPowerRequestObjectList;
    PopPowerRequestObjectList = (__int64)&PopPowerRequestObjectList;
    qword_140444D88 = (__int64)&PopSpecialPowerRequestObjectList;
    PopSpecialPowerRequestObjectList = (__int64)&PopSpecialPowerRequestObjectList;
    qword_140444D98 = (__int64)&PopPowerRequestCallbacks;
    ...
    *(_QWORD *)&PopExecutionRequiredTimer.Header.Lock = 8LL;
    ...
    qword_140444CD8 = (__int64)PopExecutionRequiredTimeoutCallback;
