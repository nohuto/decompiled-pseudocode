/*
 * XREFs of KeTerminateThread @ 0x1400810BC
 * Callers:
...
LABEL_28:
  ...
  *(_BYTE *)(BugCheckParameter1 + 388) = 4;
  ...
  if ( v14 )
  {
    if ( qword_140436BB8 && _interlockedbittestandreset((volatile signed __int32 *)&qword_140436BB8, 0) )
    {
      v16 = 0xFFFF;
      goto LABEL_20;
    }
...
LABEL_20:
    if ( !ExQueueWorkItemEx(&PsReaperWorkItem, 2u, v16) )
      _interlockedbittestandset((volatile signed __int32 *)&qword_140436BB8, 0);
  }
