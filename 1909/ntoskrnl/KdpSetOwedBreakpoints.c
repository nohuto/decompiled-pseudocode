/*
 * XREFs of KdpSetOwedBreakpoints @ 0x140957B74
 * Callers:
...
void __fastcall KdpSetOwedBreakpoints(__int64 a1)
{
  ...
  if ( KdpOweBreakpoint )
  {
    ...
    while ( 1 )
    {
      ...
      v1 += 5;
      if ( (__int64)v1 >= (__int64)&unk_14044F0E8 )
        return;
    }
    v8 = KdEnterDebugger(0LL);
    KdpOweBreakpoint = 0;
    v9 = (unsigned __int8 *)&unk_14044EC05;
    do
    {
    ...
    while ( (__int64)v9 < (__int64)byte_14044F105 );
    KdExitDebugger(v8);
  }
}
