/*
 * XREFs of HvlGetSparseGpaPagesAccessState @ 0x14034D140
 * Callers:
        ...
        __int64 a6)
{
  ...
  size_t v18; // rbx
  __int64 result; // rax
  PHYSICAL_ADDRESS v20[4]; // [rsp+20h] [rbp-78h] BYREF
  PHYSICAL_ADDRESS v21[11]; // [rsp+40h] [rbp-58h] BYREF
