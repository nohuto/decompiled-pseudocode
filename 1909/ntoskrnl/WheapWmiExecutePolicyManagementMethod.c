/*
 * XREFs of WheapWmiExecutePolicyManagementMethod @ 0x14034284C
 * Callers:
 *     WheapWmiExecuteMethod @ 0x14034271C (WheapWmiExecuteMethod.c)
 * Callees:
 *     WheapCommitPolicy @ 0x140919F04 (WheapCommitPolicy.c)
 *     WheapGetAllPolicyBufferSize @ 0x140919FF4 (WheapGetAllPolicyBufferSize.c)
 *     WheapGetAllPolicyValues @ 0x14091A000 (WheapGetAllPolicyValues.c)
 *     WheapGetPolicyValue @ 0x14091A044 (WheapGetPolicyValue.c)
 *     WheapSetPolicyValue @ 0x14091A188 (WheapSetPolicyValue.c)
 */
