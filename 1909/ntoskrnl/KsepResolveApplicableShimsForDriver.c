/*
 * XREFs of KsepResolveApplicableShimsForDriver @ 0x140883124
 * Callers:
 ...
 *     KsepIsShimRegistered @ 0x14075DDDC (KsepIsShimRegistered.c)
...
LABEL_25:
    if ( v5 )
    {
      ...
      if ( a2 )
      {
        ...
        dword_140446564[2 * v27] = LoadedModulesList;
...
LABEL_31:
  ...
  if ( a2 )
  {
    ...
    dword_140446564[2 * v25] = LoadedModulesList;
...
LABEL_22:
  ...
  dword_140446564[2 * v26] = -1073740782;
