/*
 * XREFs of DbgkUserReportWorkRoutine @ 0x1408498A0
 * Callers:
 *     <none>
 * Callees:
...
LONG_PTR __fastcall DbgkUserReportWorkRoutine(char *P)
{
  ...
  _OWORD v11[3]; // [rsp+90h] [rbp-78h] BYREF
  ...
  {
    ZwSetInformationThread(ThreadHandle, ThreadPriorityBoost|0x20, &unk_140396F20, 4u);
