/*
 * XREFs of ?StDmCheckForCompaction@?$ST_STORE@USM_TRAITS@@@@SA?AW4_ST_COMPACTION_CHECK_RESULT@@PEAU_ST_DATA_MGR@1@K@Z @ 0x1401520DC
 * Callers:
 ...
 * Callees:
 *     ?StDmComputeSpaceUsageForPriority@?$ST_STORE@USM_TRAITS@@@@SAXPEAU_ST_DATA_MGR@1@KPEAK11@Z @ 0x14015226C (-StDmComputeSpaceUsageForPriority@-$ST_STORE@USM_TRAITS@@@@SAXPEAU_ST_DATA_MGR@1@KPEAK11@Z.c)
 */
...
__int64 __fastcall ST_STORE<SM_TRAITS>::StDmCheckForCompaction(__int64 a1, char a2)
{
  ...
  if ( (a2 & 3) != 0 || v2 != 2 )
  {
    ...
    else if ( !*(_QWORD *)(v11 + 6552) && v19 >= v7 )
    {
      v12 = (a2 & 1) == 0
         && (v2 == 1
      ...
      else
      {
        if ( *(_BYTE *)(a1 + 776) )
          return v5;
        v14 = *(_QWORD *)(a1 + 800);
        if ( *(_BYTE *)(v14 + 6022) || !(*(_DWORD *)(v14 + 6100) + *(_DWORD *)(v14 + 6576) + *(_DWORD *)(v14 + 6096)) )
          return v5;
        if ( !v2 || v2 == 3 )
          return 1;
      }
