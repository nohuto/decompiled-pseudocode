/*
 * XREFs of PpmHeteroDetectHgsCores @ 0x140194D0C
 * Callers:
...
char __fastcall PpmHeteroDetectHgsCores(__int64 a1)
{
  ...
  ULONG v30; // [rsp+88h] [rbp+48h] BYREF
    ...
    if ( PpmHeteroHgsPopulated )
    {
      ...
      *(_BYTE *)(a1 + 5) = v20;
      ...
      while ( !(unsigned int)KeEnumerateNextProcessor(&v30, &v24) )
      {
        ...
        v22 = v30 + 2LL;
        v23 = a1 + 2 * v22;
        *(_BYTE *)(v22 + v23 + 2) = v21[24317];
        *(_BYTE *)(v22 + v23 + 1) = v21[24318];
        *(_BYTE *)(v22 + v23) = v21[24319] != v7;
      }
    }
    else if ( v3 != v7 )
    {
      *(_WORD *)(a1 + 4) = 257;
      ...
      while ( !(unsigned int)KeEnumerateNextProcessor(&v30, &v24) )
      {
        v13 = KeGetPrcb(v30);
        v14 = v30 + 2LL;
        v15 = *(_BYTE *)(v13 + 24319) == v7;
        v16 = a1 + 2 * v14;
        v17 = *(_BYTE *)(v13 + 24319) != v7;
        *(_BYTE *)(v14 + v16) = v17;
        *(_BYTE *)(v14 + v16 + 2) = v17;
        *(_BYTE *)(v14 + v16 + 1) = v15;
      }
