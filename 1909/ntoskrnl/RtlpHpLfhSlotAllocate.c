/*
 * XREFs of RtlpHpLfhSlotAllocate @ 0x140038E80
 * Callers:
 *     ExAllocateHeapPool @ 0x140037CE0 (ExAllocateHeapPool.c)
 *     RtlpHpLfhBucketAllocate @ 0x14016F860 (RtlpHpLfhBucketAllocate.c)
 * Callees:
 ...
 *     RtlpHpLfhSlotAddSubsegment @ 0x140121470 (RtlpHpLfhSlotAddSubsegment.c)
 *     RtlpHpLfhSubsegmentDecBlockCounts @ 0x14012743C (RtlpHpLfhSubsegmentDecBlockCounts.c)
 *     RtlpHpLfhSubsegmentSetUnusedBytes @ 0x14016F954 (RtlpHpLfhSubsegmentSetUnusedBytes.c)
...
LABEL_8:
        ...
        v255 = qword_140436728 ^ *(_DWORD *)(v12 + 40) ^ ((unsigned int)v12 >> 12);
...
LABEL_13:
        ...
        *(_WORD *)(v12 + 36) = v32;
        ...
        if ( *(_BYTE *)(v12 + 45) > 1u )
        {
          ...
          LODWORD(v262) = (unsigned __int16)qword_140436728 ^ (unsigned __int16)v261 ^ *(unsigned __int16 *)(v12 + 40);
          v258 = -1;
...
LABEL_368:
                  ...
                  if ( v29 && ($C6908ADE9723D0A04AF8EE82D8D15C40 *)v199->ApcState.ApcListHead[0].Flink != &v199->152 )
                    KiCheckForKernelApcDelivery();
        ...
        if ( v295 < v31 )
        {
          ...
          if ( v153 == 1 )
            ...
            v154 = v153 & 0x3FFF;
          *(_WORD *)(((unsigned __int16)qword_140436728 ^ (unsigned __int16)v261 ^ (unsigned __int64)*(unsigned __int16 *)(v12 + 40))
                   + v46
                   - 2) = v154;
        }
LABEL_32:
...
LABEL_405:
            ...
            if ( v29 && ($C6908ADE9723D0A04AF8EE82D8D15C40 *)v212->ApcState.ApcListHead[0].Flink != &v212->152 )
              KiCheckForKernelApcDelivery();
...
LABEL_253:
        ...
        if ( v29 && ($C6908ADE9723D0A04AF8EE82D8D15C40 *)v139->ApcState.ApcListHead[0].Flink != &v139->152 )
          KiCheckForKernelApcDelivery();
...
LABEL_156:
      ...
      if ( v29 && ($C6908ADE9723D0A04AF8EE82D8D15C40 *)v104->ApcState.ApcListHead[0].Flink != &v104->152 )
        KiCheckForKernelApcDelivery();
...
LABEL_75:
  ...
  v288 = 2 * v65;
  LODWORD(v66) = qword_140436728 ^ v66;
...
LABEL_82:
  ...
  *(_WORD *)(v49 + 36) = v83;
  ...
  v88 = -1;
  v89 = v85 >> v86;
  v268 = (unsigned __int16)qword_140436728 ^ (unsigned __int16)v268 ^ *(unsigned __int16 *)(v49 + 40);
  v259[0] = -1;
  v243 = -1;
  v90 = 2 * v89;
...
LABEL_273:
          ...
          if ( v29 && ($C6908ADE9723D0A04AF8EE82D8D15C40 *)v144->ApcState.ApcListHead[0].Flink != &v144->152 )
            KiCheckForKernelApcDelivery();
...
LABEL_438:
      ...
      if ( v29 && ($C6908ADE9723D0A04AF8EE82D8D15C40 *)v228->ApcState.ApcListHead[0].Flink != &v228->152 )
        KiCheckForKernelApcDelivery();
