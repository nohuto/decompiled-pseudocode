/*
 * XREFs of KsepMatchInitBiosInfo @ 0x140A02B5C
 * Callers:
 ...
 *     KsepRegistryQueryMULTISZ @ 0x14075DA50 (KsepRegistryQueryMULTISZ.c)
...
__int64 KsepMatchInitBiosInfo()
{
  ...
  KeyHandle = 0LL;
  memset(&qword_1405087C8, 0, 0x38uLL);
  v0 = -1;
  ...
  if ( v1 >= 0 )
  {
    ...
    if ( MULTISZ >= 0 )
    {
      ...
      MULTISZ = KsepRegistryQueryMULTISZ(KeyHandle, L"SystemBiosVersion", (__int64)&unk_14046B790, 520LL, (__int64)&v12);
      word_14046B996 = 0;
      v4 = 0LL;
      v5 = &unk_14046B790;
      while ( *v5 != 32 )
...
LABEL_11:
  ...
  {
    qword_1405087C8 = (__int64)&unk_14046B790;
    dword_1405087F0 = v0;
  }
