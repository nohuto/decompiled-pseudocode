/*
 * XREFs of PpmPerfApplyDomainState @ 0x14010C230
 * Callers:
 *     PpmPerfApplyDomainStates @ 0x14010C1C0 (PpmPerfApplyDomainStates.c)
 * Callees:
 *     PpmPerfApplyCapsAndFloors @ 0x14010C7F8 (PpmPerfApplyCapsAndFloors.c)
...
__int64 __fastcall PpmPerfApplyDomainState(__int64 a1)
{
  ...
  v52 = 0;
  v67 = *(_QWORD *)(v2 + 8);
  v4 = &PpmCurrentProfile[341 * dword_140443A2C + 5];
  v60 = v4;
  if ( *(_BYTE *)(a1 + 207) )
    PerfPolicyClass = 0;
  else
