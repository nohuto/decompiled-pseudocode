/*
 * XREFs of IoRegisterFsRegistrationChangeMountAware @ 0x140784E10
 * Callers:
 *     IoRegisterFsRegistrationChange @ 0x140855F70 (IoRegisterFsRegistrationChange.c)
 * Callees:
...
LABEL_5:
  if ( (__int64 *)IopFsNotifyChangeQueueHead != &IopFsNotifyChangeQueueHead
    && *(PDRIVER_OBJECT *)(qword_1404614F8 + 16) == DriverObject
    && *(PDRIVER_FS_NOTIFICATION *)(qword_1404614F8 + 24) == DriverNotificationRoutine )
  {
...
LABEL_9:
  ...
  v10 = (_QWORD *)qword_1404614F8;
  if ( *(__int64 **)qword_1404614F8 != &IopFsNotifyChangeQueueHead )
    __fastfail(3u);
  *PoolWithTag = &IopFsNotifyChangeQueueHead;
  PoolWithTag[1] = v10;
  *v10 = PoolWithTag;
  qword_1404614F8 = (__int64)PoolWithTag;
