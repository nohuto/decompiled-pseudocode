/*
 * XREFs of KsepDbCacheQueryDevice @ 0x14074DA68
 * Callers:
...
__int64 __fastcall KsepDbCacheQueryDevice(PCWSTR SourceString, __int64 a2, _DWORD *a3, unsigned int *a4, void *a5)
{
  ...
  v12 = KsepCacheLookup(qword_1404681A8, (__int64)v16);
  if ( v12 )
    DeviceData = KsepDbCacheQueryDeviceData((__int64)v12, a2, a3, a4, a5);
  v13 = (volatile signed __int64 *)qword_1404681A8;
  v14 = _InterlockedExchangeAdd64((volatile signed __int64 *)qword_1404681A8, 0xFFFFFFFFFFFFFFFFuLL);
  if ( (v14 & 2) != 0 && (v14 & 4) == 0 )
