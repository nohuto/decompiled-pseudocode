/*
 * XREFs of FsRtlIsFatDbcsLegal @ 0x1406D5DE0
 * Callers:
 *     FsRtlIsFatDbcsLegal @ 0x1406D5DE0 (FsRtlIsFatDbcsLegal.c)
 * Callees:
 *     FsRtlIsFatDbcsLegal @ 0x1406D5DE0 (FsRtlIsFatDbcsLegal.c)
 *     FsRtlDissectDbcs @ 0x14084EB20 (FsRtlDissectDbcs.c)
 *     FsRtlDoesDbcsContainWildCards @ 0x14084EC10 (FsRtlDoesDbcsContainWildCards.c)
 */
...
LABEL_4:
  ...
  if ( WildCardsPermissible && FsRtlDoesDbcsContainWildCards(DbcsName) )
  {
    ...
    if ( Length )
    {
      while ( 1 )
      {
        ...
        else if ( (v16 & 0x80u) == 0 && (byte_14037CAE0[v16] & 9) == 0 )
        {
          return 0;
        }
  ...
  if ( Length <= 0xCu )
  {
    ...
    do
    {
      ...
      {
        if ( (v9 & 0x80u) == 0
          && ((unsigned __int8)(WildCardsPermissible != 0 ? 9 : 1) & byte_14037CAE0[(unsigned __int8)v7[v8]]) == 0 )
        {
          return 0;
        }
        if ( v9 == 46 || v9 == 34 )
