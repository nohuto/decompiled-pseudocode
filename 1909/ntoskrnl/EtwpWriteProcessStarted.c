/*
 * XREFs of EtwpWriteProcessStarted @ 0x1406380D4
 * Callers:
...
char __fastcall EtwpWriteProcessStarted(__int64 a1, int *a2, __int64 a3, unsigned __int16 *a4)
{
  ...
  {
    LOBYTE(v4) = TlgKeywordOn(&stru_140426618, 3uLL);
    if ( (_BYTE)v4 )
    {
      v17 = *(_QWORD *)(a1 + 784);
      v12 = *(_DWORD *)(a1 + 744);
      ...
      v51 = 2LL;
      v53[1] = 0;
      LOBYTE(v4) = TlgWrite(&stru_140426618, &unk_140393A82, 0LL, 0LL, 0x13u, &pData);
    }
  }
  return v4;
}
