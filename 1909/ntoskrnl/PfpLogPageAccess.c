/*
 * XREFs of PfpLogPageAccess @ 0x14066DFD0
 * Callers:
...
unsigned __int64 __fastcall PfpLogPageAccess(__int64 a1, unsigned __int64 a2, __int64 *a3, __int64 a4, int a5)
{
  ...
  unsigned __int64 v57; // [rsp+78h] [rbp+10h]
  ...
  {
    v14 = qword_140467358;
    v15 = *(unsigned int *)(qword_140467358 + 16);
    v16 = (qword_140467358 + 47) & 0xFFFFFFFFFFFFFFF8uLL;
    if ( *(_QWORD *)(v16 + 40 * v15) != v12 )
    {
      v40 = *(_DWORD *)(qword_140467358 + 32);
      a2 = (HIBYTE(v57)
          + 37
          * (BYTE6(v57)
           + 37
           * (BYTE5(v57)
            + 37
            * (BYTE4(v57)
             + 37 * (BYTE3(v57) + 37 * (BYTE2(v57) + 37 * (BYTE1(v57) + 37 * ((unsigned __int8)v12 + 11623883)))))))) & (v40 - 1);
      v41 = *(_QWORD *)(v16 + 40 * a2);
      if ( v41 != v12 )
      {
        if ( v41 )
        {
...
LABEL_42:
          ...
          while ( 1 )
          {
            v47 = *(_QWORD *)(v16 + 40LL * v45);
            if ( v47 == v12 )
            {
              *(_DWORD *)(qword_140467358 + 16) = v45;
              LOWORD(v15) = v45;
              goto LABEL_4;
            }
            if ( !v47 )
          ...
          v10 = (HIBYTE(v57)
               ...
               * (BYTE6(v57)
                ...
                * (BYTE5(v57)
                 + 37
                 * (BYTE4(v57)
                  + 37 * (BYTE3(v57) + 37 * (BYTE2(v57) + 37 * (BYTE1(v57) + 37 * ((unsigned __int8)v12 + 24011)))))))) & (v40 - 1);
        }
        goto LABEL_55;
      }
      *(_DWORD *)(qword_140467358 + 16) = a2;
      LOWORD(v15) = (HIBYTE(v57)
                   + 37
                   * (BYTE6(v57)
                    + 37
                    * (BYTE5(v57)
...
LABEL_55:
    ...
    if ( v53 < 3 * (*(_DWORD *)(v14 + 32) >> 2) )
      break;
    if ( (unsigned int)PfTReplaceCurrentBuffer(&unk_140467340, a2) == -1073741823 )
      return 0LL;
  }
  v13 = 1;
  *(_DWORD *)(v14 + 28) = v53 + 1;
...
LABEL_19:
      ...
      v29 = *v5;
      v30 = ((*v5 & 3) == 2) + 1;
      if ( (unsigned int)(v30 + *(_DWORD *)(qword_140467330 + 16)) > *(_DWORD *)(qword_140467330 + 20) )
      {
        while ( (unsigned int)PfTReplaceCurrentBuffer(&unk_140467318, v28) != -1073741823 )
        {
          v28 = qword_140467330;
          if ( (unsigned int)(v30 + *(_DWORD *)(qword_140467330 + 16)) <= *(_DWORD *)(qword_140467330 + 20) )
          {
...
LABEL_20:
  ...
  {
    v18 = (*(_QWORD *)(a1 + 744) ^ *(_QWORD *)(a1 + 784)) & 0x1FFFFFFFFFFFFFFFLL;
    goto LABEL_11;
  }
  v18 = a1;
LABEL_11:
  ...
  {
    v22 = qword_140467358;
    v23 = *(unsigned int *)(v21 + qword_140467358);
    v24 = (qword_140467358 + 47) & 0xFFFFFFFFFFFFFFF8uLL;
      ...
      v43 = (HIBYTE(v19)
           ...
           * (BYTE6(v19)
            ...
            * (BYTE5(v19)
             + 37
             * (BYTE4(v19)
              + 37 * (BYTE3(v19) + 37 * (BYTE2(v19) + 37 * (BYTE1(v19) + 37 * ((unsigned __int8)v19 + 11623883)))))))) & (v42 - 1);
      v44 = *(_QWORD *)(v24 + 40 * v43);
      if ( v44 == v19 )
      {
        *(_DWORD *)(v21 + qword_140467358) = v43;
        LOWORD(v23) = (HIBYTE(v19)
                     ...
                     * (BYTE6(v19)
                      ...
                      * (BYTE5(v19)
                       ...
                       * (BYTE4(v19)
                        + 37
                        * (BYTE3(v19) + 37 * (BYTE2(v19) + 37 * (BYTE1(v19) + 37 * ((unsigned __int8)v19 + 24011)))))))) & (v42 - 1);
        goto LABEL_13;
      }
      if ( v44 )
      {
...
LABEL_52:
        ...
        while ( 1 )
        {
          ...
          if ( v52 == v19 )
          {
            *(_DWORD *)(v21 + qword_140467358) = v50;
            LOWORD(v23) = v50;
            goto LABEL_13;
          }
          if ( !v52 )
                                ...
                                * (BYTE6(v19)
                                 ...
                                 * (BYTE5(v19)
                                  ...
                                  * (BYTE4(v19)
                                   + 37
                                   * (BYTE3(v19)
                                    + 37 * (BYTE2(v19) + 37 * (BYTE1(v19) + 37 * ((unsigned __int8)v19 + 24011)))))))) & (v42 - 1));
      }
LABEL_65:
      LODWORD(v57) = v50;
    }
    ...
    {
      if ( (unsigned int)PfTReplaceCurrentBuffer(&unk_140467340, v50) == -1073741823 )
        return 0LL;
      continue;
    }
    break;
  ...
  if ( v22 )
  {
    ...
    if ( v20 || (*(_BYTE *)(v26 + 8) & 4) != 0 )
    {
      ...
      else
      {
        ...
        *(_QWORD *)(v26 + 8) = v55;
        *(_QWORD *)(v26 + 8) = v55 & 7 | (8LL * (*(_QWORD *)(a1 + 744) ^ *(_QWORD *)(a1 + 784)));
        *(_DWORD *)(v26 + 28) = *(_DWORD *)(a1 + 1180);
        *(_DWORD *)(v26 + 24) = *(_DWORD *)(a1 + 744);
        *(_QWORD *)(v26 + 16) = a1;
      }
    }
    else
