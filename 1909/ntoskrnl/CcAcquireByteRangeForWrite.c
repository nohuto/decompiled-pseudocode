/*
 * XREFs of CcAcquireByteRangeForWrite @ 0x1400780F0
 * Callers:
 ...
 *     CcFindBcb @ 0x14007AB40 (CcFindBcb.c)
...
LABEL_79:
    ...
    while ( (v17 & *v12) != 0 )
    {
      ...
      if ( (unsigned __int64)v12 > v11[5] + 4 * ((unsigned __int64)*((unsigned int *)v11 + 7) >> 5) )
        KeBugCheckEx(0x34u, 0x11AEuLL, 0xFFFFFFFFC0000420uLL, 0LL, 0LL);
    ...
    v50 = *(_DWORD *)(v37 + 8);
    if ( v50 < v48 )
      KeBugCheckEx(0x34u, 0x11DDuLL, 0xFFFFFFFFC0000420uLL, 0LL, 0LL);
