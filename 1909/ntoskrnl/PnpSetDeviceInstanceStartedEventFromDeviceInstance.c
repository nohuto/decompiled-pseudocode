/*
 * XREFs of PnpSetDeviceInstanceStartedEventFromDeviceInstance @ 0x1401459E8
 * Callers:
 *     PnpSetDeviceInstanceStartedEvent @ 0x1401459D0 (PnpSetDeviceInstanceStartedEvent.c)
 * Callees:
