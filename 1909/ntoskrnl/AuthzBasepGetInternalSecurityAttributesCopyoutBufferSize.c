/*
 * XREFs of AuthzBasepGetInternalSecurityAttributesCopyoutBufferSize @ 0x14061CE70
 * Callers:
 *     AuthzBasepQueryInternalSecurityAttributesToken @ 0x14061CDE8 (AuthzBasepQueryInternalSecurityAttributesToken.c)
 * Callees:
 *     AuthzBasepGetInternalSecurityAttributeValueCopyoutBufferSize @ 0x140087C48 (AuthzBasepGetInternalSecurityAttributeValueCopyoutBufferSize.c)
 */
