/*
 * XREFs of KeFoldProcessStatisticsThread @ 0x140082DC8
 * Callers:
 *     PspThreadDelete @ 0x140610F10 (PspThreadDelete.c)
 * Callees:
 *     RtlTimelineBitmapMerge @ 0x140083528 (RtlTimelineBitmapMerge.c)
 */
...
signed __int64 __fastcall KeFoldProcessStatisticsThread(__int64 a1)
{
  ...
  v1 = *(_QWORD *)(a1 + 544);
  *(_DWORD *)(v1 + 628) += *(_DWORD *)(a1 + 652);
  *(_DWORD *)(v1 + 632) += *(_DWORD *)(a1 + 732);
  *(_DWORD *)(v1 + 636) += *(_DWORD *)(a1 + 132);
  *(_QWORD *)(v1 + 600) += *(_QWORD *)(a1 + 72);
  *(_QWORD *)(v1 + 608) += *(unsigned int *)(a1 + 340);
  ...
  if ( v3 )
  {
    RtlTimelineBitmapMerge(*(_QWORD *)(v1 + 1896) + 272LL, v3 + 192);
    v6 = v5 - (_QWORD)v4;
    v7 = 4LL;
    do
    {
