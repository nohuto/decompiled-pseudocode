/*
 * XREFs of PopFxHandleDirectedPowerTransition @ 0x1402F319C
 * Callers:
...
void __fastcall PopFxHandleDirectedPowerTransition(ULONG_PTR BugCheckParameter3)
{
  ...
  PopFxEnableWorkOrderWatchdog(BugCheckParameter3 + 912, v6);
  ...
  if ( _InterlockedExchangeAdd((volatile signed __int32 *)(BugCheckParameter3 + 1152), 0xFFFFFFFF) == 1 )
