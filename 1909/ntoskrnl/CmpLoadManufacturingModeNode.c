/*
 * XREFs of CmpLoadManufacturingModeNode @ 0x140A38FEC
 * Callers:
...
bool __fastcall CmpLoadManufacturingModeNode(__int64 a1, __int64 a2, __int64 *a3, __int64 a4)
{
  ...
  if ( v7 )
  {
    SubKeyByName = CmpFindSubKeyByName(a1, v7, (unsigned __int16 *)&CmpControlString);
    ...
    if ( SubKeyByName != -1 )
    {
      ...
      if ( v9 )
      {
        v10 = CmpFindSubKeyByName(a1, v9, L"\"$");
