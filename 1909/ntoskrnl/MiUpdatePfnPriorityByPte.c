/*
 * XREFs of MiUpdatePfnPriorityByPte @ 0x1400A4880
 * Callers:
...
unsigned __int64 __fastcall MiUpdatePfnPriorityByPte(unsigned __int64 a1, unsigned int a2)
{
  ...
  while ( 1 )
  {
    ...
    else
    {
      if ( (result & 0x400) != 0
        || (result & 0x800) == 0
        || result && qword_140465800 && (result & qword_140465800) == 0 )
      {
        return result;
      }
      if ( qword_140465800 && (result & 0x10) == 0 )
        result &= ~qword_140465800;
      v8 = v5;
    }
          ...
          if ( (v14 & 7) == 2 )
          {
            if ( v16
              ...
              || (IsPteInStore = MiIsPteInStore(
                                   *(_QWORD *)(qword_140465E88 + 8 * ((*(_QWORD *)(v10 + 40) >> 40) & 0x3FFLL)),
                                   *(_QWORD *)(v10 + 16))) == 0 )
            {
