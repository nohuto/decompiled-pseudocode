/*
 * XREFs of PopIsWakeTimerImmanent @ 0x1408ABC7C
 * Callers:
        ...
        unsigned __int64 **a5)
{
  ...
  *a5 = 0LL;
  ...
  v22 = 0LL;
  v12 = -1LL;
  if ( qword_140443080 && PopDozeDeferralMaxSeconds )
  {
    v13 = qword_140443080 + 10000000LL * (unsigned int)PopDozeDeferralMaxSeconds;
    v25 = v13;
    if ( a2 )
    {
