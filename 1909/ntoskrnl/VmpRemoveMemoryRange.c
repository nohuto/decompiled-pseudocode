/*
 * XREFs of VmpRemoveMemoryRange @ 0x14032AC50
 * Callers:
 *     VmDeleteMemoryRange @ 0x1408ECD90 (VmDeleteMemoryRange.c)
 * Callees:
...
LABEL_52:
  ...
  v21->Children[1] = v22;
  P = v19;
  if ( ($E00D17A58C86F4ACDD80DB44A227A759 *)ParentValue[1].ParentValue == &ParentValue[1].16 )
  {
