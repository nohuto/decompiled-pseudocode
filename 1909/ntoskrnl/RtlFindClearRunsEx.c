/*
 * XREFs of RtlFindClearRunsEx @ 0x14017828C
 * Callers:
 *     RtlFindLongestRunClearEx @ 0x140178254 (RtlFindLongestRunClearEx.c)
 * Callees:
 *     <none>
 */
  ...
  if ( v10 )
  {
    ...
    do
    {
      ...
      if ( v14 )
      {
        ...
        v5 = v13 - v9 + 8;
        v17 = *((_BYTE *)&unk_140381058 - v9) | byte_140382448[v15] | v14;
        if ( v17 != 0xFF )
        {
          do
          {
            ...
            v29 = 0;
            for ( j = byte_140382448[v28]; ((unsigned __int8)j & v17) != 0; j *= 2 )
              ++v29;
