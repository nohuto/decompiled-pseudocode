/*
 * XREFs of CmpInitializeTransactions @ 0x1409FBA10
 * Callers:
...
__int64 *CmpInitializeTransactions()
{
  ...
  qword_140463378 = (__int64)&CmpRmListHead;
  ...
  qword_140463608 = (__int64)&CmpLazyCommitListHead;
  ...
  _mm_lfence();
  if ( (void *)qword_1404640C0 == CmpRmListLock.Owner )
  {
    v0 = __rdtsc();
    ...
    qword_1404640D8 = v1;
    qword_1404640D0 = KiQueryUnbiasedInterruptTime() + 41929663 * (__rdtsc() >> 4) % 0x12A05F2000LL + 288000000000LL;
  }
  CmpLazyCommitTimer = 8LL;
  qword_140463678 = (__int64)CmpLazyCommitDpcRoutine;
  CmpLazyCommitDpc = 275;
  qword_140463630 = (__int64)&qword_140463628;
  qword_140463628 = (__int64)&qword_140463628;
  qword_1404633C8 = (__int64)&CmpDelayFreeRMListHead;
  ...
  qword_140463638 = 0LL;
  qword_140463658 = 0LL;
  KeInitializeGuardedMutex(&CmpDelayFreeRMLock);
  CmpDelayFreeRMTimer = 8LL;
  CmpDelayFreeRMWorkItem.WorkerRoutine = (void (__fastcall *)(void *))CmpDelayFreeRMWorker;
  qword_140463458 = (__int64)CmpDelayFreeRMDpcRoutine;
  qword_140463490 = (__int64)&qword_140463488;
  qword_140463488 = (__int64)&qword_140463488;
  ...
  qword_140463498 = 0LL;
  qword_1404634B8 = 0LL;
  qword_1404635C8 = (__int64)&CmpLightTransactionList;
