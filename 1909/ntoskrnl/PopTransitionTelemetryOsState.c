/*
 * XREFs of PopTransitionTelemetryOsState @ 0x14075F968
 * Callers:
...
__int64 __fastcall PopTransitionTelemetryOsState(int a1, int a2)
{
  ...
  v32 = 0LL;
  v4 = 0;
  if ( !TraceLoggingProviderEnabled(&pCallbackContext, 0, 0x800000000000uLL) || !byte_14044206C )
    return v4;
  switch ( a1 )
  {
    case 2:
...
LABEL_66:
  ...
  v4 = dword_140442068;
  if ( a1 != 5 || dword_140442030 == 1 || (unsigned int)(dword_140442030 - 4) <= 1 )
  {
    v8 = (KiQueryUnbiasedInterruptTime() - qword_140442048) / 0x2710uLL;
    v9 = v8 - qword_140442058;
    v10 = (MEMORY[0xFFFFF78000000008] - qword_140442040) / 0x2710uLL;
    qword_140442058 = v8;
    v11 = v10 - qword_140442050;
    v34 = v10 - qword_140442050;
    v12 = v10 - qword_140442050;
    qword_140442050 = v10;
    if ( v9 <= v11 )
      v12 = v9;
    v33 = v12;
    v21 = v7 + dword_140442060;
    dword_140442060 += v7;
    v19 = dword_140442030;
    v20 = dword_140442034;
    if ( a1 != 5 )
