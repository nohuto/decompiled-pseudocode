/*
 * XREFs of MiCombineCandidate @ 0x140140780
 * Callers:
...
__int64 __fastcall MiCombineCandidate(__int64 *a1, char a2, __int64 a3)
{
  ...
  *(__m128i *)BugCheckParameter2 = v3;
  ...
  v18 = v5;
  if ( *(_QWORD *)(qword_140465E88 + 8 * ((v6 >> 40) & 0x3FF)) != v4 && (a2 & 1) == 0
    ...
    || byte_14046945E
    && _bittest64((const signed __int64 *)qword_140469D80, (unsigned __int64)((a3 + 0x58000000000LL) / 48) >> 9) )
  {
    return 0LL;
  }
  v8 = v18;
  ...
  v20 = v8;
  if ( (v8 & 1) != 0 || v8 && qword_140465800 && (qword_140465800 & v8) == 0 )
    return 0LL;
  v9 = (v8 >> 5) & 0x1F;
  if ( (_DWORD)v9 == 31
    || (_DWORD)v9 == 24
  ...
  if ( v10 >= 0xFFFF800000000000uLL )
    v11 = byte_140467140[((v10 >> 39) & 0x1FF) - 256];
  else
    v11 = 0;
  ...
  if ( (unsigned __int8)((v19.m128i_i8[2] & 7) - 2) > 1u || v19.m128i_i16[0] )
  {
    ...
    if ( v12 == 1 && (v8 & 0x400) == 0 )
    {
      ...
      {
        v13 = v8;
        if ( qword_140465800 && (v8 & 0x10) == 0 )
          v13 = v8 & ~qword_140465800;
        if ( HIDWORD(v13) == 1 )
          return 0LL;
      }
