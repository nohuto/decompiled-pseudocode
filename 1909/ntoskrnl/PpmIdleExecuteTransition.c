/*
 * XREFs of PpmIdleExecuteTransition @ 0x140031920
 * Callers:
 ...
 *     PpmIdleSetSynchronizationState @ 0x1402EF560 (PpmIdleSetSynchronizationState.c)
  ...
  if ( !v32 )
  {
    ...
    *(_DWORD *)(v9 + 23860) = a2;
    ...
    if ( v12 || *(_BYTE *)(v153 + 6) || *(_BYTE *)(v153 + 7) )
    {
      ...
      if ( *(_BYTE *)(v153 + 7) )
      {
        v46 = HIDWORD(PpmCurrentProfile[341 * dword_140443A2C + 23]);
      ...
      *(_QWORD *)(v9 + 23888) = v68;
      ...
      if ( v13 >= 0 )
      {
        ...
        if ( a3 != -1 )
        {
          ...
          if ( !qword_140467CC0 && a3 == dword_140467D00 )
            _InterlockedCompareExchange64(&qword_140467CC0, MEMORY[0xFFFFF78000000008], 0LL);
          if ( a5 )
          {
        ...
        *(_BYTE *)(v9 + 248) &= ~1u;
        if ( DeepSleep && *(_BYTE *)(v9 + 23450) )
        {
          ...
          v108->DeepSleep = 0;
          _InterlockedAnd64(
            &qword_140446DC8[(unsigned __int64)(unsigned int)KiProcessorIndexToNumberMappingTable[v109] >> 6],
