/*
 * XREFs of PopRequestWrite @ 0x14059A114
 * Callers:
 *     PopWriteHiberImage @ 0x140599AEC (PopWriteHiberImage.c)
 *     PopCompressCallback @ 0x14059A0F0 (PopCompressCallback.c)
 * Callees:
 ...
 *     PopRecordHibernateDiagnosticInfo @ 0x1405AD030 (PopRecordHibernateDiagnosticInfo.c)
...
char __fastcall PopRequestWrite(ULONG_PTR BugCheckParameter3, __int64 a2, unsigned int a3)
{
  ...
  for ( i = BugCheckParameter3; ; *(_QWORD *)(i + 336) = v27 )
  {
    while ( 1 )
    {
      ...
      if ( v8 == 1 )
      {
        BugCheckParameter4 = (*(int (__fastcall **)(__int64, ULONG_PTR, __int64))(*(_QWORD *)(i + 168) + 128LL))(
                               ...
                               v6);
        v31 = __rdtsc();
        qword_1404434E0 += (((unsigned __int64)HIDWORD(v31) << 32) | (unsigned int)v31) - v19;
      ...
      {
        qword_1404434D8 += v18 - *(_QWORD *)(i + 336);
        ProducerConsumerBufferComplete(v5, v5 + 48, *(_QWORD *)(i + 384), *(_DWORD *)(i + 360));
        v20 = __rdtsc();
        qword_140443500 += (((unsigned __int64)HIDWORD(v20) << 32) | (unsigned int)v20) - v19;
        qword_1404436A8 += *(_QWORD *)(i + 360);
        dword_1404436B0 += (unsigned __int64)(*(_QWORD *)(i + 352) + 4095LL) >> 12;
        v21 = *(_QWORD *)(i + 352);
        *(_QWORD *)(i + 376) += v21;
        *(_QWORD *)(i + 344) += v21;
        *(_QWORD *)(i + 352) = 0LL;
    ...
    *(_QWORD *)(i + 360) = v23;
    if ( v22 + v14 > qword_140443390 )
    {
      ...
      *(_QWORD *)MaxDataSize = MmGetNumberOfPhysicalPages(0LL);
      ...
      KeBugCheckEx(0xA0u, 0xBuLL, qword_140443390, *(unsigned int *)(i + 184), RemainingHibernateRangeDataSize);
    }
    ...
    *(_QWORD *)(i + 352) = v14;
    ...
    v33 = __rdtsc();
    qword_1404434E0 += (((unsigned __int64)HIDWORD(v33) << 32) | (unsigned int)v33) - v27;
...
LABEL_18:
      ...
      v29 = __rdtsc();
      qword_1404434E0 += (((unsigned __int64)HIDWORD(v29) << 32) | (unsigned int)v29) - v27;
