/*
 * XREFs of ObpLookupObjectName @ 0x1405F6F30
 * Callers:
...
LABEL_69:
              ...
              else
              {
                ...
                if ( v17 && ($C6908ADE9723D0A04AF8EE82D8D15C40 *)v53->ApcState.ApcListHead[0].Flink != &v53->152 )
...
LABEL_189:
        ...
        if ( v17 && ($C6908ADE9723D0A04AF8EE82D8D15C40 *)v94->ApcState.ApcListHead[0].Flink != &v94->152 )
