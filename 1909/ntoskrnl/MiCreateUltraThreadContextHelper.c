/*
 * XREFs of MiCreateUltraThreadContextHelper @ 0x1400F8DA8
 * Callers:
...
__int64 __fastcall MiCreateUltraThreadContextHelper(__int64 a1, unsigned int a2, unsigned int a3)
{
  ...
  v3 = dword_14046646C;
  if ( dword_14046646C != dword_140466468 )
  {
    while ( 1 )
    {
      v7 = _InterlockedCompareExchange(&dword_14046646C, v3 + 1, v3);
      v6 = v3 == v7;
      v3 = v7;
      if ( v6 )
        break;
      if ( v7 == dword_140466468 )
        return 0LL;
    }
    *(_QWORD *)a1 = 0LL;
    *(_QWORD *)(a1 + 8) = -1LL;
    *(_QWORD *)(a1 + 16) = -1LL;
    ...
    if ( a2 > 2uLL )
      v8 = 2LL;
    if ( (unsigned int)MiAcquireNonPagedResources((__int64)&MiSystemPartition, (unsigned int)v8) )
    {
      v9 = 0LL;
      if ( v8 )
      {
        ...
        _InterlockedAdd(&dword_14046646C, 0xFFFFFFFF);
        if ( (_DWORD)v9 )
        {
