/*
 * XREFs of PpmIdleUpdateConcurrency @ 0x1402EF7B8
 * Callers:
 *     PpmIdleExecuteTransition @ 0x140031920 (PpmIdleExecuteTransition.c)
 *     PpmIdleInstallConcurrency @ 0x1402EF0B0 (PpmIdleInstallConcurrency.c)
 *     PpmIdleRemoveConcurrency @ 0x1402EF3E0 (PpmIdleRemoveConcurrency.c)
 * Callees:
