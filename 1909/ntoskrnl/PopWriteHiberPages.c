/*
 * XREFs of PopWriteHiberPages @ 0x14059A8E8
 * Callers:
 *     PopWriteSecurePages @ 0x1402F7658 (PopWriteSecurePages.c)
 *     PopWriteSecurePagesCallback @ 0x1402F7700 (PopWriteSecurePagesCallback.c)
  ...
  if ( *(int *)(v6 + 188) >= 0 )
  {
    if ( (a4 + a3) << 12 > qword_140443390 )
    {
      ...
      *(_QWORD *)MaxDataSize = MmGetNumberOfPhysicalPages(0LL);
      ...
      KeBugCheckEx(0xA0u, 0xBuLL, qword_140443390, *(unsigned int *)(v6 + 184), BugCheckParameter4);
    }
    ...
    while ( v11 )
    {
      ...
      v19 = __rdtsc();
      dword_1404436B0 += v14;
      qword_1404434D8 += (((unsigned __int64)HIDWORD(v19) << 32) | (unsigned int)v19) - v17;
      result = v26;
      v11 -= v26;
      v10 += v26;
      a2 += v26;
