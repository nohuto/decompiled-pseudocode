/*
 * XREFs of KiFindNextTimerDueTime @ 0x140034430
 * Callers:
...
LABEL_25:
    ...
    while ( 1 )
    {
      ...
      {
        v27 = (_QWORD *)(qword_140573688[0] + 8 * (v25 >> 6));
        v28 = ((1LL << (v25 & 0x3F)) - 1) | ~*v27;
        if ( v28 == -1 )
        {
          while ( (unsigned __int64)++v27 <= qword_140573688[0] + 8 * (v26 >> 6) )
          {
            v28 = ~*v27;
            if ( *v27 )
              goto LABEL_30;
...
LABEL_30:
        ...
        v29 = v28 + (((__int64)v27 - qword_140573688[0]) >> 3 << 6);
        if ( v29 > v26 )
          goto LABEL_69;
        if ( v29 != -1LL )
          goto LABEL_32;
