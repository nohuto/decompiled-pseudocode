/*
 * XREFs of EtwpDequeueBufferPendingCompression @ 0x1403332FC
 * Callers:
 ...
 *     EtwpDequeueBufferPendingCompressionFromQueue @ 0x1403333F0 (EtwpDequeueBufferPendingCompressionFromQueue.c)
