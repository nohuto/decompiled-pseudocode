/*
 * XREFs of PiDqIrpQueryCreate @ 0x1405B6DD8
 * Callers:
 ...
 *     PnpConvertDevpropcompkeyArrayToString @ 0x14086167C (PnpConvertDevpropcompkeyArrayToString.c)
 *     PiDqConvertObjectTypeToString @ 0x140864928 (PiDqConvertObjectTypeToString.c)
