/*
 * XREFs of PsRestoreImpersonation @ 0x1405D6960
 * Callers:
 ...
 * Callees:
 *     SeQueryTokenTrustLink @ 0x14000A30C (SeQueryTokenTrustLink.c)
...
void __stdcall PsRestoreImpersonation(PETHREAD Thread, PSE_IMPERSONATION_STATE ImpersonationState)
{
  ...
  if ( ImpersonationState->Token )
  {
    *($0C1BE2699A312A75424054B216B8DB7A *)((char *)&Thread[1].116 + 4) = ($0C1BE2699A312A75424054B216B8DB7A)v10;
