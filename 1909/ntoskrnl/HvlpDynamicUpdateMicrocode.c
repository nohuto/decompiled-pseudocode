/*
 * XREFs of HvlpDynamicUpdateMicrocode @ 0x140850C28
 * Callers:
 *     HvlUpdateMicrocodeDatabase @ 0x140850B90 (HvlUpdateMicrocodeDatabase.c)
 * Callees:
 ...
 *     HvcallInitInputControl @ 0x140343A74 (HvcallInitInputControl.c)
