/*
 * XREFs of MiPfnShareCountIsZero @ 0x140026F20
 * Callers:
...
__int64 __fastcall MiPfnShareCountIsZero(ULONG_PTR a1, unsigned __int64 a2, __int64 a3, __int64 a4)
{
  ...
  if ( (v4 & 0x200000000000000LL) != 0 )
  {
    ...
    v18 = v16 & 0xFAFFFFFFFFFFFEFFuLL | ((word_1404658EC & 1 | 0xA000000000000LL) << 8);
  ...
  if ( *(_WORD *)(a1 + 32) )
  {
    ...
    *(_BYTE *)(a1 + 34) = v48;
    if ( (*(_DWORD *)(a1 + 16) & 0x400LL) == 0 && (unsigned int)MiGetPagingFileOffset(a1 + 16) )
      *(_BYTE *)(*(_QWORD *)(qword_140465E88 + 8 * ((*(_QWORD *)(a1 + 40) >> 40) & 0x3FFLL)) + 667LL) = 1;
    return 3LL;
  }
  else
  {
