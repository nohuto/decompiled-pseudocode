/*
 * XREFs of Normalization__NormalizeCharacter @ 0x1408D6D70
 * Callers:
 *     Normalization__AppendDecomposedChar @ 0x1408D5E4C (Normalization__AppendDecomposedChar.c)
 *     Normalization__Normalize @ 0x1408D6BB8 (Normalization__Normalize.c)
 * Callees:
 *     ComposeHangulLV @ 0x1403131D4 (ComposeHangulLV.c)
 *     ComposeHangulLVT @ 0x140313204 (ComposeHangulLVT.c)
 *     IsHangulLV @ 0x140313238 (IsHangulLV.c)
 *     NormBuffer__Append @ 0x14031326C (NormBuffer__Append.c)
 ...
 *     NormBuffer__LastStartBase @ 0x1403135B0 (NormBuffer__LastStartBase.c)
 *     NormBuffer__LastStartBasePair @ 0x1403135DC (NormBuffer__LastStartBasePair.c)
 *     NormBuffer__RecheckStartCombinations @ 0x140313628 (NormBuffer__RecheckStartCombinations.c)
 ...
 *     NormBuffer__RewindOutputCharacter @ 0x140313848 (NormBuffer__RewindOutputCharacter.c)
 *     Normalization__AppendDecomposedChar @ 0x1408D5E4C (Normalization__AppendDecomposedChar.c)
 *     Normalization__CanCombinableCharactersCombine @ 0x1408D5F5C (Normalization__CanCombinableCharactersCombine.c)
 */
