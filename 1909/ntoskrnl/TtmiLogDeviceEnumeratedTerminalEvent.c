/*
 * XREFs of TtmiLogDeviceEnumeratedTerminalEvent @ 0x1408C0BC8
 * Callers:
...
char __fastcall TtmiLogDeviceEnumeratedTerminalEvent(int a1, int a2, int a3, int a4, LPCWSTR pwsz)
{
  ...
  {
    LOBYTE(v5) = TlgKeywordOn(&stru_1409AD8E0, 1uLL);
    if ( (_BYTE)v5 )
    {
      ...
      LOBYTE(v5) = TlgWrite(&stru_1409AD8E0, &unk_140392082, 0LL, 0LL, 8u, &pData);
    }
  }
  return (char)v5;
}
