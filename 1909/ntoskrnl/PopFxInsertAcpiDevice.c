/*
 * XREFs of PopFxInsertAcpiDevice @ 0x1402F3258
 * Callers:
...
_QWORD *__fastcall PopFxInsertAcpiDevice(__int64 a1, __int64 a2, __int64 a3)
{
  ...
  v5 = (_QWORD *)qword_1404442B8;
  v6 = (_QWORD *)(a3 + 200);
  if ( *(__int64 **)qword_1404442B8 != &PopFxAcpiDeviceList )
    __fastfail(3u);
  v6[1] = qword_1404442B8;
  *v6 = &PopFxAcpiDeviceList;
  *v5 = v6;
  qword_1404442B8 = (__int64)v6;
...
LABEL_15:
  ...
  if ( (__int64)v13->LockState.LockState < 0 )
    KiAbEntryRemoveFromTree((__int64)&v7->LockEntries[v12]);
...
LABEL_22:
  ...
  if ( v14 && ($C6908ADE9723D0A04AF8EE82D8D15C40 *)v7->ApcState.ApcListHead[0].Flink != &v7->152 )
