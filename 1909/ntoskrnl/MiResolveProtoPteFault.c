/*
 * XREFs of MiResolveProtoPteFault @ 0x1400B1440
 * Callers:
...
__int64 __fastcall MiResolveProtoPteFault(__int64 a1, __int64 a2, _QWORD *a3)
{
  ...
  *a3 = 0LL;
  ...
  v26 = *(ULONG_PTR **)(qword_140465E88 + 8 * ((v18 >> 40) & 0x3FF));
  if ( v24 )
  {
  ...
  if ( !(unsigned int)MiChargePartitionResidentAvailable(v26, 1LL, 0xFFFFFFFFLL) )
  {
    v102 = (_WORD *)(v11 - 0x57FFFFFFFE0LL);
    if ( !v24 )
      goto LABEL_26;
...
LABEL_32:
    ...
    if ( (*(_QWORD *)v33 & 0xC00LL) != 0x800 )
      break;
    if ( !v34 || !qword_140465800 || (v34 & qword_140465800) != 0 )
    {
      v35 = *(_QWORD *)v33;
      if ( qword_140465800 && (v34 & 0x10) == 0 )
        v35 = v34 & ~qword_140465800;
      goto LABEL_32;
    }
  }
  v36 = 0LL;
LABEL_35:
  ...
  if ( (v38 & 1) == 0 )
  {
    ...
    if ( (v57 & 0x400) == 0 )
      goto LABEL_79;
    v59 = v57;
    if ( qword_140465800 && (v57 & 0x10) == 0 )
      v59 = v57 & ~qword_140465800;
        ...
        if ( MiReadWrite[(unsigned __int8)v38 >> 5] - v61 >= 10 )
        {
          ...
          if ( v60 == 2 && (!v99 || *(_BYTE *)(v101 & 0xFFFFFFFFFFFFFFFEuLL) != 1) )
          {
            ...
            if ( (v37 & 0xC00) == 0x800 )
            {
              ...
              {
                if ( HIBYTE(word_1404658EC) || (v37 & 1) == 0 )
                  goto LABEL_292;
                goto LABEL_291;
              }
...
LABEL_89:
          v65 = v38;
          if ( qword_140465800 && (v38 & 0x10) == 0 )
            v65 = v38 & ~(_WORD)qword_140465800;
          if ( (v65 & 0x400) != 0
            || (v65 & 0x800) != 0
            || (v65 & 4) != 0
            || (v58 & 5) != 5
...
LABEL_126:
                if ( MiPteInShadowRange(v7) )
                {
                  ...
                  {
                    if ( !HIBYTE(word_1404658EC) && (v74 & 1) != 0 )
...
LABEL_50:
    ...
    v52 = *(_QWORD *)(qword_140465E88 + 8 * ((v46 >> 40) & 0x3FF));
    if ( v3 == 1 )
    {
...
LABEL_189:
      ...
      _InterlockedExchangeAdd64(&qword_14046A180, v49);
      goto LABEL_61;
    }
