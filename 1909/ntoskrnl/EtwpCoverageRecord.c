/*
 * XREFs of EtwpCoverageRecord @ 0x1406D6164
 * Callers:
 ...
 *     TelemetryCoverageTableLocateInternal @ 0x14012BAD4 (TelemetryCoverageTableLocateInternal.c)
 *     EtwpCoverageValidateCP @ 0x14012BB28 (EtwpCoverageValidateCP.c)
 *     EtwpCoverageAddToStringBuffer @ 0x14012BC24 (EtwpCoverageAddToStringBuffer.c)
...
LABEL_8:
  ...
  if ( !v4 && v5 && stru_140426688.LevelPlus1 > 5 && TlgKeywordOn(&stru_140426688, 2uLL) )
  {
    ...
    TlgWrite(&stru_140426688, &unk_140393919, 0LL, 0LL, 7u, &pData);
  }
  if ( EtwpCoverageCoreTracingEnabled && stru_140426688.LevelPlus1 > 5 )
  {
    if ( TlgKeywordOn(&stru_140426688, 1uLL) )
    {
      ...
      v46 = 4LL;
      TlgCreateSz(&v47, v19);
      TlgWrite(&stru_140426688, &unk_1403938A5, 0LL, 0LL, 9u, &v34);
    }
  }
}
