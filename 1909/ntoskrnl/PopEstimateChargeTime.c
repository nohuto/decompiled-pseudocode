/*
 * XREFs of PopEstimateChargeTime @ 0x1408A9CD0
 * Callers:
...
unsigned __int64 PopEstimateChargeTime()
{
  ...
  {
    for ( i = qword_1404431B0; (__int64 *)i != &qword_1404431B0; i = *(_QWORD *)i )
    {
      v7 = *(_DWORD *)(i + 64);
      if ( v7 != -1 )
      {
  ...
  if ( pCallbackContext.LevelPlus1 > 5 )
  {
    ...
    v32 = 8;
    v35 = 4;
    TlgWrite(&pCallbackContext, &unk_14038F0FE, 0LL, 0LL, 8u, &pData);
  }
  return v0;
}
