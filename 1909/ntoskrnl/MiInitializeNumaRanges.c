/*
 * XREFs of MiInitializeNumaRanges @ 0x1401894BC
 * Callers:
...
LABEL_12:
        v8 = ExAcquireSpinLockExclusive(&dword_140465790);
        v6 = (void *)qword_140465780;
        v9 = v8;
        if ( qword_140465780 )
          v6 = (void *)(-(__int64)(byte_14046574C != 0) & qword_140465780);
        v10 = (__int64)v17;
        if ( v17 )
        {
          v11 = 0;
        ...
        qword_140465780 = v10;
        dword_140465744 = 0;
        ExReleaseSpinLockExclusiveFromDpcLevel(&dword_140465790);
  ...
  {
    qword_140465770 = -1LL;
    qword_140465780 = (__int64)&unk_140465760;
    return 0LL;
  }
}
