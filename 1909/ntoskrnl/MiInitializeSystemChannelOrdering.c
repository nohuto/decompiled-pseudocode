/*
 * XREFs of MiInitializeSystemChannelOrdering @ 0x140A3C728
 * Callers:
...
void __fastcall MiInitializeSystemChannelOrdering(__int64 a1, unsigned int a2)
{
  ...
  for ( i = qword_140465788; *(_QWORD *)i != -1LL; i += 16LL )
  {
  ...
  if ( MmNumberOfChannels )
  {
    ...
    do
    {
      if ( *v11 == 2 )
      {
        *(_BYTE *)(v9 + v3 + 1938) = v10;
        *(_BYTE *)(v9 + v3 + 1942) = v10;
  ...
  if ( v8 )
  {
    ...
    do
    {
      if ( *v13 == 1 )
      {
        *(_BYTE *)(v9 + v3 + 1938) = v12;
        *(_BYTE *)(v9 + v3 + 1942) = v12;
        v9 = (unsigned int)(v9 + 1);
      }
      ++v12;
      ++v13;
  ...
  if ( v8 )
  {
    ...
    do
    {
      if ( !*v15 )
      {
        *(_BYTE *)(v9 + v3 + 1938) = v14;
        *(_BYTE *)(v9 + v3 + 1942) = v14;
        v9 = (unsigned int)(v9 + 1);
      }
      ++v14;
      ++v15;
