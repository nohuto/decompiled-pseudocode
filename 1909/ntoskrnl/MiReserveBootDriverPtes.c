/*
 * XREFs of MiReserveBootDriverPtes @ 0x140A16C18
 * Callers:
...
__int64 __fastcall MiReserveBootDriverPtes(unsigned __int64 a1, int a2)
{
  ...
  v3 = ((dword_1404645B0 & 0xFFF) != 0) + a2 + ((unsigned int)dword_1404645B0 >> 12);
  v4 = (__int64)(a1 << 25) >> 16;
  if ( (PVOID)v4 != PsNtosImageBase && (PVOID)v4 != PsHalImageBase )
    v3 = (unsigned int)(dword_14046454C + v3);
  v5 = (const void **)qword_140464628[0];
  v6 = (a1 + 4088 + 8 * v3) & 0xFFFFFFFFFFFFF000uLL;
  v7 = a1 & 0xFFFFFFFFFFFFF000uLL;
  if ( qword_140464628[0] )
  {
    v8 = *((_QWORD *)qword_140464628[0] + 1);
    v9 = v8 + 8LL * *((unsigned int *)qword_140464628[0] + 4);
    if ( a1 + 8 * v3 <= v9 )
    {
      RtlSetBits((PRTL_BITMAP)qword_140464628[0] + 1, (__int64)(a1 - v8) >> 3, v3);
      return 1LL;
    }
    v5 = (const void **)((unsigned __int64)qword_140464628[0] & -(__int64)(a1 < v9));
    if ( v5 )
      v7 = *(_QWORD *)(((unsigned __int64)qword_140464628[0] & -(__int64)(a1 < v9)) + 8);
  }
  ...
  if ( result )
  {
    ...
    *(PVOID *)&v12->SizeOfBitMap = qword_140464628[0];
    qword_140464628[0] = v12;
    return 1LL;
  }
  return result;
}
