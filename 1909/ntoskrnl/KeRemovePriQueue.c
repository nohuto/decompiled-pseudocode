/*
 * XREFs of KeRemovePriQueue @ 0x14005A030
 * Callers:
 ...
 *     KiGetDueTimeWithThreadTimerDelay @ 0x1402B1BB0 (KiGetDueTimeWithThreadTimerDelay.c)
 */
...
__int64 __fastcall KeRemovePriQueue(ULONG_PTR a1, char a2, char a3, __int64 a4)
{
  ...
  int v9; // ebp
  $911DE60733D53BFA0F115C3A981F3323 *v10; // r14
