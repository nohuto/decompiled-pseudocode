/*
 * XREFs of EmpEvaluateUpdateRuleEvalState @ 0x140196884
 * Callers:
 *     EmpUpdateRuleState @ 0x1400D4AB0 (EmpUpdateRuleState.c)
 * Callees:
 *     EmpEvaluateTargetRule @ 0x1400D3088 (EmpEvaluateTargetRule.c)
 *     EmpEvaluatePermuteRuleEntries @ 0x140196934 (EmpEvaluatePermuteRuleEntries.c)
  ...
  if ( *(_BYTE *)(v2 + 20) )
  {
    ...
    if ( (_DWORD)v7 )
    {
      ...
      do
      {
        ...
        while ( v12 != v11 )
        {
          ((void (__fastcall *)(_QWORD, _QWORD))*(v12 - 2))(*(_QWORD *)(v10 + *(_QWORD *)(v2 + 56)), *(v12 - 1));
          v9 = *(_QWORD *)(v2 + 56);
          v12 = (_QWORD *)*v12;
          v11 = (_QWORD **)(*(_QWORD *)(v10 + v9) + 56LL);
        }
...
LABEL_20:
        if ( (_DWORD)v7 )
        {
          ...
          do
          {
            *(_QWORD *)&PoolWithTag[v15] = *(_QWORD *)(*(_QWORD *)(v15 + *(_QWORD *)(v2 + 56)) + 32LL) - 16LL;
            v15 += 8LL;
            --v16;
          }
          while ( v16 );
