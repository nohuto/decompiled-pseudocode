/*
 * XREFs of EtwpCoverageResetCP @ 0x1408F2EC0
 * Callers:
...
__int64 __fastcall EtwpCoverageResetCP(__int64 a1, __int64 a2)
{
  ...
  v3 = 0;
  *(_DWORD *)(a2 + 12) = 0;
  if ( (unsigned int)dword_140427F94 < MEMORY[0xFFFFF7800000037C] )
  {
    if ( !dword_140427F90 )
      dword_140427F90 = TelemetryCoverageStringHashInternal(off_140427F88, &v25);
