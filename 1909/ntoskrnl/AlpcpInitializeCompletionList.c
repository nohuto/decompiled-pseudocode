/*
 * XREFs of AlpcpInitializeCompletionList @ 0x1406C2F48
 * Callers:
    ...
    *((_QWORD *)v10 + 8) = v14;
    if ( v14 )
    {
      ...
      *(_DWORD *)(v15 + 40) = *((_DWORD *)v10 + 38);
      ...
      if ( !v25 )
        goto LABEL_23;
      CompletionPacketLookaside = AlpcpAllocateCompletionPacketLookaside(v36 >> 3, v25, *(_QWORD *)(a1 + 40));
...
LABEL_25:
  if ( v8 )
  {
    v29 = _InterlockedExchangeAdd64((volatile signed __int64 *)(a1 + 352), 0xFFFFFFFFFFFFFFFFuLL);
    if ( (v29 & 2) != 0 && (v29 & 4) == 0 )
