/*
 * XREFs of IopDeleteIoCompletionInternal @ 0x1400E3358
 * Callers:
 *     IopCloseIoCompletion @ 0x1406778B0 (IopCloseIoCompletion.c)
 *     IopDeleteIoCompletion @ 0x1406778E0 (IopDeleteIoCompletion.c)
 * Callees:
