/*
 * XREFs of EtwpDisableKernelTrace @ 0x1406E86F4
 * Callers:
 ...
 *     DbgSetDebugPrintCallback @ 0x14030AC70 (DbgSetDebugPrintCallback.c)
  ...
  if ( a2 )
  {
    ...
    if ( (v12 & 0x400) != 0 )
    {
      for ( i = 0; i < EtwpPmcProfile; ++i )
        KeStopProfile((ULONG_PTR)qword_140432A88 + 248 * i);
    }
    if ( (a2[4] & 0x80u) != 0 )
    {
