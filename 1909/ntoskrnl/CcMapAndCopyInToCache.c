/*
 * XREFs of CcMapAndCopyInToCache @ 0x14006DAE0
 * Callers:
  ...
  *(_QWORD *)v149 = 0LL;
  ...
  else
  {
    ...
    if ( _interlockedbittestandset(&dword_140464280, 0x1Fu) )
    {
      ...
      v138 = ExpWaitForSpinLockExclusiveAndAcquire(&dword_140464280, CurrentIrql);
      v13 = a6;
    }
    v23 = dword_140464280;
    ...
    do
    {
      if ( (v23 & 0x40000000) == 0 )
      {
        v100 = _InterlockedCompareExchange(&dword_140464280, v23 | 0x40000000, v23);
        v99 = v23 == v100;
        v23 = v100;
        if ( !v99 )
          continue;
...
LABEL_8:
  v24 = &MiSystemPartition;
  if ( *(_QWORD *)v19 )
    v25 = *(ULONG_PTR **)(qword_140465E88 + 8LL * (*(_WORD *)(*(_QWORD *)v19 + 60LL) & 0x3FF));
  else
...
LABEL_22:
  ...
  if ( *(_QWORD *)(v11 + 168) )
  {
    ...
    if ( (BYTE6(PerfGlobalGroupMask) & 0x21) != 0 )
    {
      ExpAcquireSpinLockExclusiveAtDpcLevelInstrumented(&dword_140464280, v34);
      v32 = v129;
    }
    else
    {
      ...
      if ( _interlockedbittestandset(&dword_140464280, 0x1Fu) )
      {
        ...
        v139 = ExpWaitForSpinLockExclusiveAndAcquire(&dword_140464280, v34);
        v32 = v129;
      }
      v37 = dword_140464280;
      if ( (dword_140464280 & 0xBFFFFFFF) != 0x80000000 )
      {
        do
        {
          if ( (v37 & 0x40000000) == 0 )
          {
            v106 = _InterlockedCompareExchange(&dword_140464280, v37 | 0x40000000, v37);
            v99 = v37 == v106;
            v37 = v106;
            if ( !v99 )
              continue;
    ...
    if ( *(_QWORD *)v33 )
      v24 = *(ULONG_PTR **)(qword_140465E88 + 8LL * (*(_WORD *)(*(_QWORD *)v33 + 60LL) & 0x3FF));
    if ( (BYTE6(PerfGlobalGroupMask) & 1) != 0 )
    {
      ExpReleaseSpinLockExclusiveFromDpcLevelInstrumented(&dword_140464280, retaddr);
      v32 = v129;
