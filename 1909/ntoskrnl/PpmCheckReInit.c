/*
 * XREFs of PpmCheckReInit @ 0x140776E5C
 * Callers:
 ...
 *     PpmPerfClearResponsivenessHints @ 0x1401948D0 (PpmPerfClearResponsivenessHints.c)
 *     PopInterruptSteeringEnabled @ 0x14019492C (PopInterruptSteeringEnabled.c)
 *     PpmPerfCheckRequired @ 0x1401BF708 (PpmPerfCheckRequired.c)
...
__int64 (__fastcall ***PpmCheckReInit())()
{
  ...
  v1 = 0;
  v2 = 0;
  v3 = &PpmCurrentProfile[341 * dword_140443A2C];
