/*
 * XREFs of RtlFindNextClearRunUlong @ 0x14012523C
 * Callers:
 ...
 *     MiFindFreePageFileSpaceForward @ 0x1402CDFC0 (MiFindFreePageFileSpaceForward.c)
 * Callees:
 *     <none>
 */
...
__int64 __fastcall RtlFindNextClearRunUlong(unsigned int *a1, unsigned int a2, __int64 a3, unsigned int a4, _DWORD *a5)
{
  ...
  if ( (v6 & 0x1F) == 0 )
    v10 = v7 + 4 * v8;
  v11 = *v9 | dword_14037C900[a2 & 0x1F];
  v12 = 0;
  do
  {
    while ( 1 )
