/*
 * XREFs of PnpLogActionQueueEvent @ 0x14015E064
 * Callers:
...
__int64 __fastcall PnpLogActionQueueEvent(__int64 a1, int a2, __int64 a3, char a4)
{
  ...
  if ( a2 == 8 )
  {
    ...
    if ( (_DWORD)a3 )
    {
      ...
      {
        if ( (_DWORD)a3 != 2 || (byte_14042BDBB & 8) == 0 )
          return result;
        if ( a1 )
          v6 = *(_QWORD *)(a1 + 48);
...
LABEL_45:
      ...
      if ( (_DWORD)a3 )
      {
        if ( (_DWORD)a3 == 1 )
        {
          if ( (byte_14042BDBB & 0x10) != 0 )
          {
            if ( a1 )
              v9 = *(_QWORD *)(a1 + 48);
            return McTemplateK0zd(a1, (unsigned int)&KMPnPEvt_DeviceAction_Start, 1, v9, a2);
          }
        }
        else if ( (_DWORD)a3 == 2 && (byte_14042BDBB & 0x10) != 0 )
        {
          if ( a1 )
            v9 = *(_QWORD *)(a1 + 48);
          return McTemplateK0zdq(a1, (unsigned int)&KMPnPEvt_DeviceAction_Stop, 2, v9, a2, a4);
        }
      }
      else if ( (byte_14042BDBB & 0x10) != 0 )
      {
        if ( a1 )
          v9 = *(_QWORD *)(a1 + 48);
        return McTemplateK0zd(a1, (unsigned int)&KMPnPEvt_DeviceAction_Queue, 0, v9, a2);
      }
      return result;
    }
    if ( a2 != 14 )
      ...
      if ( a2 != 16 )
      {
        if ( a2 > 20 && a2 <= 24 )
        {
          ...
          if ( (_DWORD)a3 )
          {
            if ( (_DWORD)a3 == 1 )
            {
              if ( (byte_14042BDB9 & 0x20) != 0 )
              {
                if ( a1 )
                  v7 = *(_QWORD *)(a1 + 48);
                return McTemplateK0zd(a1, (unsigned int)&KMPnPEvt_ConfigureDevice_Start, 1, v7, a2);
              }
            }
            else if ( (_DWORD)a3 == 2 && (byte_14042BDB9 & 0x20) != 0 )
            {
              if ( a1 )
                v7 = *(_QWORD *)(a1 + 48);
              return McTemplateK0zdq(a1, (unsigned int)&KMPnPEvt_ConfigureDevice_Stop, 2, v7, a2, a4);
            }
          }
          else if ( (byte_14042BDB9 & 0x20) != 0 )
          {
            if ( a1 )
              v7 = *(_QWORD *)(a1 + 48);
            return McTemplateK0zd(a1, (unsigned int)&KMPnPEvt_ConfigureDevice_Queue, 0, v7, a2);
          }
        }
        return result;
      }
  ...
  if ( (_DWORD)a3 )
  {
    ...
    else if ( (_DWORD)a3 == 2 && (byte_14042BDBB & 8) != 0 )
    {
      if ( a1 )
        v5 = *(_QWORD *)(a1 + 48);
