/*
 * XREFs of PfpRpFileKeyUpdate @ 0x14066A2F0
 * Callers:
 ...
 *     PfpRpRehashIfNeeded @ 0x14066AB88 (PfpRpRehashIfNeeded.c)
 */
...
LABEL_9:
    ...
    if ( a3 )
    {
      ...
      v19 = v31 & v18;
      v35 = (v31 & (unsigned __int64)v18) >> 24;
      v34 = (v31 & (unsigned __int64)v18) >> 16;
      v33 = (v31 & (unsigned __int64)v18) >> 8;
      if ( v17 >= 0x20 )
      {
        v20 = *(_QWORD *)(a1 + 8)
            + 8
            * ((((v31 & (unsigned __int64)v18) >> 56)
              + 37
              * ((unsigned __int8)((v31 & (unsigned __int64)v18) >> 48)
               + 37
               * ((unsigned __int8)((unsigned __int16)((v31 & (unsigned __int64)v18) >> 32) >> 8)
                + 37
                * ((unsigned __int8)((v31 & (unsigned __int64)v18) >> 32)
                 + 37
                 * ((unsigned __int8)v35
                  + 37
                  * ((unsigned __int8)v34
                   + 37 * ((unsigned __int8)v33 + 37 * ((unsigned int)(unsigned __int8)v19 + 11623883)))))))) & ((v17 >> 5) - 1));
        while ( 1 )
        {
          v20 = *(_QWORD *)v20;
          if ( (v20 & 1) != 0 )
