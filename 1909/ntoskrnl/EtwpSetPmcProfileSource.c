/*
 * XREFs of EtwpSetPmcProfileSource @ 0x1408F4FAC
 * Callers:
...
__int64 __fastcall EtwpSetPmcProfileSource(_DWORD *a1, unsigned int a2)
{
  ...
  else
  {
    if ( qword_140432A88 )
    {
      ExFreePoolWithTag(qword_140432A88, 0);
      qword_140432A88 = 0LL;
      EtwpPmcProfile = 0;
    }
    v6 = v2;
    qword_140432A88 = ExAllocatePoolWithTag(NonPagedPoolNx, 248 * v2, 0x58777445u);
    v7 = qword_140432A88;
    if ( qword_140432A88 )
    {
      EtwpPmcProfile = v2;
