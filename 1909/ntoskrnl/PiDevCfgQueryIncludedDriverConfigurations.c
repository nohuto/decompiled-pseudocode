/*
 * XREFs of PiDevCfgQueryIncludedDriverConfigurations @ 0x1406FD584
 * Callers:
...
LABEL_58:
      ...
      if ( v12 )
      {
        ...
        *v12 = 0;
        v14 = *v9;
        v9 = v12 + 1;
        v15 = v14 < asc_14078F970[0];
        v33 = v12 + 1;
        if ( v14 != asc_14078F970[0] )
          goto LABEL_15;
        v16 = v11[1];
        v15 = v16 < asc_14078F970[1];
        if ( v16 == asc_14078F970[1] )
          v17 = 0;
        else
LABEL_15:
          v17 = v15 ? -1 : 1;
        ...
        if ( v18 )
        {
          *v18 = 0;
          v9 = v18 + 1;
          v19 = v18[1] - asc_14078F970[0];
          if ( !v19 )
            v19 = v18[2] - asc_14078F970[1];
          if ( v19 )
          {
            v39 = 0;
            v9 = v18 + 1;
            if ( v18[1] )
            {
              do
              {
                ...
                v3 |= PiDevCfgGetDriverConfigurationKeyScope(v9);
                v9 = v21;
              }
              while ( *v21 );
              v39 = v3;
