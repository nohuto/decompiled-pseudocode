/*
 * XREFs of MiCreatePfnBitMaps @ 0x1407510CC
 * Callers:
...
__int64 __fastcall MiCreatePfnBitMaps(__int64 a1, _DWORD *a2)
{
  ...
  for ( i = 0; i < 3; ++i )
  {
    ...
    v10 = MiReservePtes((__int64)&qword_1404666C0, (unsigned __int64 *)(unsigned int)v9);
    v11 = v10;
    if ( !v10 )
      goto LABEL_17;
    if ( !(unsigned int)MiInitializeDynamicBitmap(v7, (__int64)(v10 << 25) >> 16, v8, 4) )
    {
      MiReleasePtes((__int64)&qword_1404666C0, v11, v9);
LABEL_17:
