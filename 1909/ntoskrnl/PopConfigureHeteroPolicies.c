/*
 * XREFs of PopConfigureHeteroPolicies @ 0x1407774E8
 * Callers:
 ...
 *     KeQueryCycleCounterFrequency @ 0x14013DC60 (KeQueryCycleCounterFrequency.c)
 *     __security_check_cookie @ 0x14019EE20 (__security_check_cookie.c)
 *     ZwClose @ 0x1401C0E30 (ZwClose.c)
 *     ZwOpenKey @ 0x1401C0E90 (ZwOpenKey.c)
 *     ZwQueryValueKey @ 0x1401C0F30 (ZwQueryValueKey.c)
 *     memset @ 0x1401D77C0 (memset.c)
 *     KeConfigureHeteroPolicy @ 0x140777BFC (KeConfigureHeteroPolicy.c)
 *     PpmHeteroComputeBias @ 0x1408B3038 (PpmHeteroComputeBias.c)
 */
  ...
  do
  {
    switch ( v6 )
    {
      ...
      case 3u:
        ...
        {
          v9 = &PpmCurrentProfile[341 * dword_140443A2C + 5];
...
LABEL_20:
    v9 = (__int64 *)(2728LL * dword_140443A2C + v13 + 40);
    v5 = *v9;
LABEL_26:
    v54 = v5;
LABEL_27:
  ...
  if ( a2 )
  {
    ...
    qword_140438CA4 = 0x500000005LL;
    qword_140438CAC = 0x500000005LL;
    qword_140438CB4 = 0x500000005LL;
    qword_140438CBC = 0x500000005LL;
    qword_140438CC4 = 0LL;
    ...
    *(_OWORD *)&ObjectAttributes.SecurityDescriptor = 0LL;
    if ( ZwOpenKey(&KeyHandle, 8u, &ObjectAttributes) >= 0 )
    {
      ...
      for ( i = 0; i < 7; ++i )
      {
        ...
        {
          RtlInitUnicodeString(&ValueName, (&off_140948B38)[3 * i]);
          if ( ZwQueryValueKey(
                 Handle,
                 &ValueName,
          ...
          {
            *(int *)((char *)&PopHeteroLegacyOverride + (unsigned int)dword_140948B40[6 * i]) = v65;
          }
          ZwClose(Handle);
        }
      }
  ...
  do
  {
    ...
    do
    {
      v18 = *(_DWORD *)((char *)&qword_140438CA4 + v15 * 4);
      if ( v18 != 5 )
        v63[v15 + 1] = v18;
      ++v15;
      --v17;
  ...
  v20 = v63[9];
  v21 = v63[11];
  if ( (_DWORD)qword_140438CC4 )
    v20 = qword_140438CC4;
  v22 = v55;
  v63[9] = v20;
  v23 = v63[10];
  if ( HIDWORD(qword_140438CC4) )
    v23 = HIDWORD(qword_140438CC4);
  v63[0] = v19;
  v63[10] = v23;
  if ( dword_140438CCC != -1 )
    v21 = (unsigned int)dword_140438CCC;
  v63[11] = v21;
