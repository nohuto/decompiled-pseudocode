/*
 * XREFs of InsertEventEntryInLookUpTable @ 0x14008BBAC
 * Callers:
 ...
 *     ComputeEventEntryHash @ 0x14008BF64 (ComputeEventEntryHash.c)
    ...
    if ( (KeGetPcr()->Prcb.DpcRequestSummary & 0x10001) == 0 )
    {
      ...
      if ( v13 )
      {
        if ( (unsigned __int64)v9 >= 0xFFFF800000000000uLL
          && byte_140467140[(((unsigned __int64)v9 >> 39) & 0x1FF) - 256] == 1 )
        {
