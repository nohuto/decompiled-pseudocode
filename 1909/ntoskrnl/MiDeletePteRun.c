/*
 * XREFs of MiDeletePteRun @ 0x140028050
 * Callers:
 ...
 *     MiPteIsSessionDynamicBuffer @ 0x1401686B0 (MiPteIsSessionDynamicBuffer.c)
...
__int64 __fastcall MiDeletePteRun(__int64 a1, __int64 a2)
{
  ...
  v130 = v11;
  v126 = 0;
  v15 = *(_QWORD *)(qword_140465E88 + 8 * v12);
  v138 = v15;
  v124 = 0;
  v129 = 0LL;
  v139 = 0LL;
...
LABEL_26:
              ...
              v129 = *(_QWORD *)(qword_140465E88 + 8 * ((*(_QWORD *)(v22 + 40) >> 40) & 0x3FFLL));
              ...
              if ( (((*(_BYTE *)(v27 + 184) & 7) != 0) & _bittest64((const signed __int64 *)(v22 + 40), 0x39u)) != 0 )
              {
                ...
                if ( (v106 & 0x400) == 0 || (BugCheckParameter3 & 0x200) != 0 )
                  goto LABEL_268;
                if ( qword_140465800 && (v106 & 0x10) == 0 )
                  v106 &= ~qword_140465800;
...
LABEL_268:
              ...
              *(_QWORD *)(v22 + 24) = v31;
              ...
              else
              {
                ...
                v61 = v59 & 0xFAFFFFFFFFFFFEFFuLL | ((word_1404658EC & 1 | 0xA000000000000LL) << 8);
                v140 = CurrentPrcb;
...
LABEL_107:
                ...
                if ( (unsigned int)MiPteInShadowRange(v74, v71, v72, v73) )
                {
                  ...
                  if ( !HIBYTE(word_1404658EC) && (v77 & 1) != 0 )
                    v77 |= 0x8000000000000000uLL;
                  *v78 = v77;
...
LABEL_33:
                ...
                if ( *(_WORD *)(v22 + 32) )
                {
                  ...
                  *(_BYTE *)(v22 + 34) = v92;
                  if ( (*(_DWORD *)(v22 + 16) & 0x400LL) == 0 && (unsigned int)MiGetPagingFileOffset(v22 + 16) )
                    *(_BYTE *)(*(_QWORD *)(qword_140465E88 + 8 * ((*(_QWORD *)(v22 + 40) >> 40) & 0x3FFLL)) + 667LL) = 1;
                  v30 = 3;
                  if ( v29 )
                  {
                    v113 = v120;
                ...
                else
                {
                  ...
                  v34 = *(_QWORD *)(qword_140465E88 + 8 * ((*(_QWORD *)(v22 + 40) >> 40) & 0x3FFLL));
                  v137 = *(_QWORD *)(v22 + 16);
                  if ( (v137 & 0x400) == 0 )
                  {
...
LABEL_253:
            ...
            if ( !LOBYTE(v153[0]) )
              goto LABEL_76;
            if ( v26 != v153[1]
              || *(_QWORD *)(qword_140465E88 + 8 * ((*(_QWORD *)(v22 + 40) >> 40) & 0x3FFLL)) != v138
