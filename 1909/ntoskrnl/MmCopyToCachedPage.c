/*
 * XREFs of MmCopyToCachedPage @ 0x14006EAA0
 * Callers:
...
__int64 __fastcall MmCopyToCachedPage(ULONG_PTR a1, void *a2, unsigned int a3, ULONG_PTR a4, unsigned int a5)
{
  ...
  v14 = *v13;
  v65 = v14;
  v15 = *(_QWORD *)(qword_140465E88 + 8LL * (*(_WORD *)(v14 + 60) & 0x3FF)) + 0x2000LL;
  v66 = v15;
  ...
  if ( (a5 & 8) != 0 )
  {
    v18 = MiReservePtes((__int64)&qword_1404666C0, (unsigned __int64 *)1);
    v60 = v18;
    if ( !v18 )
      return 3221225626LL;
    v17 = a5;
...
LABEL_54:
  if ( v60 )
  {
    ...
    v54 = v53;
    v68[0] = v53;
    MiReleasePtes((__int64)&qword_1404666C0, v55, 1u);
    if ( (v54 & 1) != 0 )
    {
