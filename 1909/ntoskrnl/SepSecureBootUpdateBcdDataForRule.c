/*
 * XREFs of SepSecureBootUpdateBcdDataForRule @ 0x1408E1774
 * Callers:
 ...
 *     SepSecureBootGetPolicyDefaultValue @ 0x1408E15F0 (SepSecureBootGetPolicyDefaultValue.c)
...
__int64 __fastcall SepSecureBootUpdateBcdDataForRule(__int64 a1, void *a2, BCD_FLAGS a3)
{
  ...
  v3 = (_WORD *)(qword_14050EA08 + *(unsigned int *)(a1 + 8));
  PoolWithTag = 0LL;
