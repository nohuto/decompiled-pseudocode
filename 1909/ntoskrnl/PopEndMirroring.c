/*
 * XREFs of PopEndMirroring @ 0x140599120
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall PopEndMirroring(ULONG_PTR BugCheckParameter3)
{
  ...
  *(_QWORD *)&Affinity.Group = 0LL;
  ...
  if ( !(_DWORD)v1 )
  {
    ...
    v2 = PopBuildMemoryImageHeader((PVOID)qword_140443000);
    if ( v2 >= 0 )
    {
      ...
      *(_DWORD *)&Affinity.Group = (unsigned __int16)((unsigned int)KiProcessorIndexToNumberMappingTable[0] >> 6);
      ...
      dword_140467DB0 = KeNumberProcessors_0;
      HIDWORD(qword_140467DB8) = KeNumberProcessors_0;
      LODWORD(qword_140467DB8) = 1;
  ...
  v2 = *(_DWORD *)(qword_140443000 + 188);
  if ( v2 < 0 || (v2 = PopInvokeSystemStateHandler(PopHibernatePowerStateHandlerType, qword_140443000), v2 < 0) )
  {
LABEL_23:
    ...
    if ( qword_140443000 )
    {
      ...
      v9 = *(_QWORD *)(qword_140443000 + 168);
      if ( v9 )
        IoAddTriageDumpDataBlock(v9, (PVOID)0x178);
      v10 = *(_QWORD *)(qword_140443000 + 200);
      if ( v10 )
