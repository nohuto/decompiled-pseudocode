/*
 * XREFs of IopAddBugcheckTriageDataFromParameters @ 0x140295CEC
 * Callers:
...
LABEL_47:
  ...
  if ( a1 == 257 )
  {
    if ( a3 )
      return IsSpecialPoolAddress;
    LOBYTE(IsSpecialPoolAddress) = KiIsAddressRangeValid(a4, 36608LL);
    if ( !(_BYTE)IsSpecialPoolAddress )
      return IsSpecialPoolAddress;
    IoAddTriageDumpDataBlock(a4, (PVOID)0x8F00);
    IoAddTriageDumpDataBlock(*(_QWORD *)(a4 + 25280), (PVOID)0x4D0);
    v13 = *(_QWORD *)(a4 + 8);
    if ( KiIsAddressRangeValid(v13, 2080LL) )
      IopAddBugcheckTriageThread(v13);
    LOBYTE(IsSpecialPoolAddress) = IoAddTriageDumpDataBlock(
                                     (*(_DWORD *)(*(_QWORD *)(a4 + 25280) + 152LL) - 4096) & 0xFFFFF000,
                                     (PVOID)0x2000);
  }
  if ( a1 == 416 )
  {
