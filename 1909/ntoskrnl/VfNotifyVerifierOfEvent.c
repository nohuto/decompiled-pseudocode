...
void __fastcall VfNotifyVerifierOfEvent(int a1)
{
  ...
  if ( a1 )
  {
    ...
    if ( v1 )
    {
      ...
      if ( !v2 )
      {
        _InterlockedAdd(&dword_140435E28, 1u);
      ...
      if ( v3 )
      {
        ...
        if ( v4 )
        {
          if ( v4 == 1 )
          {
            _InterlockedAdd(&dword_140435E34, 1u);
        ...
        {
          _InterlockedAdd(&dword_140435E30, 1u);
          VfStartBranchTracing();
        }
        return;
      }
      _InterlockedAdd(&dword_140435E2C, 1u);
    }
    else
    {
      _InterlockedAdd(&dword_140435E24, 1u);
    }
    VfStopBranchTracing();
    return;
  }
