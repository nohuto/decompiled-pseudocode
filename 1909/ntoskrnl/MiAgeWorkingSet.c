/*
 * XREFs of MiAgeWorkingSet @ 0x140048A50
 * Callers:
...
_BOOL8 __fastcall MiAgeWorkingSet(__int64 a1, char a2, int a3, unsigned int a4)
{
  ...
  if ( (a3 & 4) == 0 )
  {
    ...
    v54 = 0LL;
    if ( v15 == 2 )
      v16 = (volatile signed __int64 *)&unk_140466F40;
    else
...
LABEL_17:
  ...
  HIDWORD(v62[1]) = v14;
  PoolWithTag = 0LL;
  v30 = *(_QWORD **)(qword_140465E88 + 8 * v28);
  v31 = v30[975];
  if ( (a3 & 3) != 0 )
  {
    *(_QWORD *)&v26 = v30 + 296;
...
LABEL_46:
  if ( hProvider )
  {
      ...
      && (hProvider->KeywordAll & 1) == hProvider->KeywordAll )
    {
      ...
      v79 = 8LL;
      v81 = 4LL;
      TlgWriteEx(v47, &unk_14038DA4E, 0LL, v48, pActivityId, pActivityId, 0xAu, &pData);
    }
  }
  return v8 == 4;
}
