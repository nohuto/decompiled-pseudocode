/*
 * XREFs of MiIterateOverPartitions @ 0x14016A014
 * Callers:
...
__int64 __fastcall MiIterateOverPartitions(void (__fastcall *a1)(__int64, __int64), __int64 a2)
{
  ...
  while ( 1 )
  {
    v5 = v2 < qword_140465E68->SizeOfBitMap ? v2 : 0;
    v6 = qword_140465E68->SizeOfBitMap - 1;
    v7 = ((__int64)qword_140465E68->Buffer & 4) != 0LL ? 0x20 : 0;
    v8 = (char *)qword_140465E68->Buffer - (((__int64)qword_140465E68->Buffer & 4) != 0 ? 4 : 0);
    while ( 1 )
    {
      v9 = v7 + v6;
      v10 = v7 + v5;
...
LABEL_17:
      ...
      if ( !v5 )
        break;
      SizeOfBitMap = v2 + 1;
      if ( v2 + 1 > qword_140465E68->SizeOfBitMap )
    ...
    if ( (unsigned int)result < v2 || (_DWORD)result == -1 )
      return result;
    v2 = result + 1;
    v16 = *(_QWORD *)(qword_140465E88 + 8LL * (unsigned int)result);
    if ( (*(_DWORD *)(v16 + 4) & 2) != 0 )
      a1(v16, a2);
  }
}
