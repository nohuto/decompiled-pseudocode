/*
 * XREFs of SmAcquireReleaseResAvailForRead @ 0x14016470C
 * Callers:
...
__int64 __fastcall SmAcquireReleaseResAvailForRead(signed __int64 a1, __int64 a2, int a3)
{
  ...
  if ( a3 )
  {
    if ( qword_14058C178 == a1 )
      _InterlockedExchange64(&qword_14058C178, 0LL);
    else
  ...
  else
  {
    ...
    if ( !v5 )
    {
      if ( qword_14058C178 )
        return 0;
      v5 = 1;
      if ( a2 != 1 || _InterlockedCompareExchange64(&qword_14058C178, a1, 0LL) )
        return 0;
    }
  }
  return v5;
