/*
 * XREFs of PspAllocateProcess @ 0x140681A9C
 * Callers:
 ...
 *     PsIsSystemProcess @ 0x14001D1E0 (PsIsSystemProcess.c)
 ...
 *     PsIsProtectedProcessLight @ 0x140086040 (PsIsProtectedProcessLight.c)
 ...
 *     PspInitializeProcessLock @ 0x140306420 (PspInitializeProcessLock.c)
 *     PsReferencePartition @ 0x140309404 (PsReferencePartition.c)
 ...
 *     LpcInitializeProcess @ 0x14068571C (LpcInitializeProcess.c)
 ...
 *     PspReadIFEONodeOptions @ 0x1406DD014 (PspReadIFEONodeOptions.c)
 ...
 *     PspSelectNodeForProcess @ 0x1406DECFC (PspSelectNodeForProcess.c)
 *     PoEnergyContextInitialize @ 0x1406E2358 (PoEnergyContextInitialize.c)
 ...
 *     PspInheritQuota @ 0x1406E5C98 (PspInheritQuota.c)
 *     PspSetProcessPriorityClass @ 0x1406E6B9C (PspSetProcessPriorityClass.c)
 *     PspApplyWin32kFilterOptions @ 0x1406E77D8 (PspApplyWin32kFilterOptions.c)
 *     RtlOpenImageFileOptionsKey @ 0x1406E7AC0 (RtlOpenImageFileOptionsKey.c)
...
LABEL_46:
    *((_QWORD *)Object + 120) = v34;
    ...
    if ( !v17 )
    {
      if ( v34 )
      {
        SectionInformation = MmGetSectionInformation(v34, 4LL, v170);
...
LABEL_94:
        if ( (v51 & 1) != 0 )
        {
          InformationToken = PspAttachSession((unsigned int)v50, &ApcState, &v147);
          if ( InformationToken < 0 )
          {
            LOBYTE(v18) = v51 & 0xFE;
            goto LABEL_315;
        ...
        {
          InformationToken = PspAssignProcessQuotaBlock(0LL, Object, Token, v50);
          if ( InformationToken < 0 )
          {
            if ( (v51 & 1) != 0 )
...
LABEL_104:
        ...
        *((_BYTE *)Object + 449) = v117;
        ...
        if ( v17 )
        {
          PspApplyWin32kFilterOptions(Object, v17);
          *(_OWORD *)(v17 + 360) = v173;
          *(_OWORD *)(v17 + 472) = v174;
        }
...
LABEL_159:
          ...
          if ( (v18 & 8) != 0 )
          {
            if ( v17 )
            {
              InformationToken = PspSetupReservedUserMappings(Object, &ApcState, v17);
              if ( InformationToken < 0 )
                goto LABEL_317;
            }
          }
...
LABEL_314:
    ...
    *((_QWORD *)Object + 222) = *(_QWORD *)(v17 + 456);
    InformationToken = MmGetSectionInformation(v34, 4LL, v17 + 48);
    if ( InformationToken < 0 )
      goto LABEL_317;
    v36 = *(_BYTE *)(v17 + 99);
