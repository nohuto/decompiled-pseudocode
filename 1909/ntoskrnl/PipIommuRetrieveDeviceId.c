/*
 * XREFs of PipIommuRetrieveDeviceId @ 0x140778294
 * Callers:
...
__int64 __fastcall PipIommuRetrieveDeviceId(__int64 a1, _QWORD *a2)
{
  ...
  v2 = *(unsigned int (__fastcall **)(_QWORD, _QWORD, _QWORD, SIZE_T *))(a1 + 64);
  v3 = 0LL;
  if ( !v2 )
  {
    v7 = -1073741637;
  ...
  if ( v2(*(_QWORD *)(a1 + 8), 0LL, 0LL, &NumberOfBytes) != -1073741789 || !NumberOfBytes )
  {
    v7 = -1073741823;
LABEL_7:
    if ( v7 >= 0 )
  ...
  if ( v7 >= 0 )
  {
    PipIommuValidateDeviceId(a1, v3, NumberOfBytes);
    goto LABEL_7;
  }
LABEL_12:
  if ( v3 )
