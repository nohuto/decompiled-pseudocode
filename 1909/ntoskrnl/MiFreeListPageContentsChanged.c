/*
 * XREFs of MiFreeListPageContentsChanged @ 0x1402D8FB0
 * Callers:
...
void __fastcall MiFreeListPageContentsChanged(unsigned __int64 a1)
{
  ...
  v3 = a1;
  v4 = *(_QWORD *)(*(_QWORD *)(qword_140465E88 + 8 * ((v2 >> 40) & 0x3FF)) + 2120LL);
  LockHandle.LockQueue.Next = 0LL;
  LockHandle.LockQueue.Lock = (unsigned __int64 *volatile)(v4
                                                         + 8
                                                         * (5
                                                          * (dword_1404657B0 & (unsigned int)a1 | ((unsigned int)(v2 >> 58) << byte_14046574D) | (((v2 >> 36) & 3) << byte_14046574E))
                                                          + 4));
  ...
  if ( dword_140465F0C == 1 )
  {
    ...
    v6 = a1 & 0x1F;
    LOBYTE(v7) = 1;
    v8 = (volatile signed __int32 *)(qword_140465F68 + 4 * v5);
