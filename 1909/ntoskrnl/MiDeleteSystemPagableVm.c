/*
 * XREFs of MiDeleteSystemPagableVm @ 0x14002D7F0
 * Callers:
        ...
        _QWORD *a6)
{
  ...
  {
    if ( (a5 & 2) != 0 )
      v59 = dword_140466068 != 0;
    v11 = 2;
    v60 = 2;
  }
  v62 = *(_QWORD *)(qword_140465E88 + 8LL * *(unsigned __int16 *)(a1 + 174));
  v73 = 20LL;
  v57 = a5 & 8;
  v70 = v11;
  v71 = 0;
...
LABEL_9:
    ...
    if ( (v17 & 1) != 0 )
    {
      ...
      v26 = *(_QWORD *)(qword_140465E88 + 8 * ((*(_QWORD *)(v25 + 40) >> 40) & 0x3FFLL));
      if ( v57 )
      {
...
LABEL_22:
          ...
          if ( v20 )
          {
            ...
            if ( !HIBYTE(word_1404658EC) && (v36 & 1) != 0 )
              v36 |= 0x8000000000000000uLL;
            *(_QWORD *)a3 = v36;
...
LABEL_24:
          ...
          DeepFreezeStartTime = qword_140465800;
          v37 = v56;
          if ( qword_140465800 && (v56 & 0x10) == 0 )
            v37 = v56 & ~qword_140465800;
