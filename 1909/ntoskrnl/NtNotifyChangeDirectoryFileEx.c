/*
 * XREFs of NtNotifyChangeDirectoryFileEx @ 0x1406DC110
 * Callers:
 *     NtNotifyChangeDirectoryFile @ 0x1406DC0B0 (NtNotifyChangeDirectoryFile.c)
 * Callees:
        ...
        unsigned int a10)
{
  ...
  {
    v17 = FileObject;
    if ( FileObject->CompletionContext && (v37 & 0xFFFFFFFFFFFFFFFEuLL) != 0 )
    {
      v18 = -1073741811;
      goto LABEL_41;
    }
...
LABEL_41:
    ...
    else
    {
      v33[0] = 0;
      if ( PreviousMode )
        IopMarkApcRoutineIfAsynchronousIo32((unsigned int **)&a5, &v37, 0);
    }
    ...
    *(_QWORD *)(v22 - 24) = v17;
    ...
    {
      Mdl = IoAllocateMdl((PVOID)Address, v15, 0, 1u, v21);
      if ( !Mdl )
