/*
 * XREFs of KiOpRetrieveRegMemAddress @ 0x14019C788
 * Callers:
 *     KiOp_Div @ 0x14019C690 (KiOp_Div.c)
 *     KiOp_SGDTSIDT @ 0x1402B3960 (KiOp_SGDTSIDT.c)
 *     KiOp_SLDTSTRSMSW @ 0x1402B3B20 (KiOp_SLDTSTRSMSW.c)
 * Callees:
 *     KiOpComputeLinearAddress @ 0x1402B34CC (KiOpComputeLinearAddress.c)
 */
