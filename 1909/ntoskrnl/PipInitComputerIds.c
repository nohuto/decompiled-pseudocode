/*
 * XREFs of PipInitComputerIds @ 0x1409F5A4C
 * Callers:
 ...
 *     PipSmBiosFindStruct @ 0x1409F6D24 (PipSmBiosFindStruct.c)
 */
...
__int64 __fastcall PipInitComputerIds(__int64 a1)
{
  ...
  unsigned int v113; // [rsp+98h] [rbp-70h]
  PVOID v114; // [rsp+A0h] [rbp-68h] BYREF
  ...
  UNICODE_STRING *v119; // [rsp+D8h] [rbp-30h] BYREF
  UNICODE_STRING *v120; // [rsp+E0h] [rbp-28h] BYREF
  UNICODE_STRING *v121; // [rsp+E8h] [rbp-20h] BYREF
  ...
  *(_QWORD *)&ValueName.Length = 0LL;
  ...
  if ( v5 >= 0 )
  {
    ...
    *(_DWORD *)&ValueName.Length = 1572886;
    ...
    v7 = IopCreateRegistryKeyEx(&Handle, v6, &ValueName, 0xF003Fu, 0, 0LL);
    if ( v7 >= 0 )
    {
      PnpCtxRegDeleteTree(*(__int64 *)&PiPnpRtlCtx, (char *)v6, L"ProductIds");
      *(_DWORD *)&ValueName.Length = 1441812;
      ValueName.Buffer = L"ProductIds";
      v7 = IopCreateRegistryKeyEx(&v115, v6, &ValueName, 0xF003Fu, 0, 0LL);
      if ( v7 >= 0 )
      {
...
LABEL_44:
            ...
            if ( v41 )
            {
              ...
              *(_DWORD *)&ValueName.Length = 1835034;
              ZwSetValueKey(KeyHandle, &ValueName, 0, 4u, &v110, 4u);
            }
            v42 = 0;
            v43 = UnicodeString;
            do
            ...
            v44 = 0;
            v45 = UnicodeString;
            v46 = (PCWSTR *)off_140375380;
            do
            {
              RtlInitUnicodeString(&ValueName, *v46);
              if ( v45->Length )
              {
                if ( (int)PnpUnicodeStringToWstr((__int16 **)&v114, 0LL, &UnicodeString[v44].Length) >= 0 )
                {
                  v47 = v114;
                  v48 = -1LL;
                  do
                    ++v48;
                  while ( *((_WORD *)v114 + v48) );
                  ZwSetValueKey(KeyHandle, &ValueName, 0, 1u, v114, 2 * v48 + 2);
...
LABEL_126:
              ...
              if ( PoolWithTag )
              {
                ...
                v92 = 112 * v51 + 2;
                ValueName.MaximumLength = v92;
                if ( v51 )
                {
                  v114 = L"ComputerMetadata\\";
                  do
                  {
                    v93 = 0LL;
                    ValueName.Length = 0;
                    v94 = 0LL;
                    v7 = 0;
                    if ( (ValueName.MaximumLength & 1) != 0 || v92 == 0xFFFF )
                    {
                      v7 = -1073741811;
                    }
                    else
                    {
                      ...
                      ValueName.Length = 2 * v95;
                      if ( ((v7 + 0x80000000) & 0x80000000) != 0 || v7 == -2147483643 )
                      {
                        ValueName.Length = 0;
                        ValueName.MaximumLength = 2 * v94;
                        ValueName.Buffer = v93;
                      }
                    }
                    if ( v7 < 0 )
                      goto LABEL_149;
                    ...
                    if ( v7 < 0 )
                      goto LABEL_149;
                    v91 = ValueName.Buffer + 39;
                    v92 = ValueName.MaximumLength - 78;
                    ValueName.Buffer += 39;
                    ++v40;
...
LABEL_149:
            ...
            {
              LODWORD(Data) = (unsigned __int8)v108;
              v7 = RtlStringCchPrintfW(pszDest, 8uLL, L"%02x&%02x", HIBYTE(v108), Data);
              if ( v7 < 0 )
                goto LABEL_150;
              ...
              if ( UnicodeString[3].Buffer )
              {
                ...
                while ( v54 );
                v123[2] = &DestinationString;
                v7 = PipCreateComputerId(v50, v52, &v119, 7LL, v125);
                v51 = 1;
                if ( v7 < 0 )
                  goto LABEL_150;
              }
