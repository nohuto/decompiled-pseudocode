/*
 * XREFs of MiGetCcAccessLog @ 0x14064698C
 * Callers:
 ...
 *     MiInitializePageAccessLogging @ 0x140112D7C (MiInitializePageAccessLogging.c)
...
PVOID __fastcall MiGetCcAccessLog(__int64 a1, __int64 a2)
{
  ...
  if ( !qword_140466040 )
    goto LABEL_12;
  v4 = _InterlockedExchange64(&qword_140466040, 0LL);
  if ( !v4 )
    goto LABEL_12;
  v5 = *(_QWORD *)(v4 + 40);
