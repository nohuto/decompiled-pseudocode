/*
 * XREFs of IopGetSetStreamIdentifier @ 0x140298F04
 * Callers:
 *     IoAllocateSfioStreamIdentifier @ 0x1402980D0 (IoAllocateSfioStreamIdentifier.c)
 *     IoGetSfioStreamIdentifier @ 0x140298380 (IoGetSfioStreamIdentifier.c)
 * Callees:
