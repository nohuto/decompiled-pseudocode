/*
 * XREFs of AlpcpReceiveMessagePort @ 0x1405E0800
 * Callers:
 ...
 *     AlpcpQueryHeadCanceledQueue @ 0x1405B0B14 (AlpcpQueryHeadCanceledQueue.c)
 *     AlpcpQueryHeadLargeQueue @ 0x1405E0E80 (AlpcpQueryHeadLargeQueue.c)
...
__int64 __fastcall AlpcpReceiveMessagePort(__int64 *a1, unsigned __int8 a2, __int64 a3, ULONG_PTR *a4, int a5)
{
...
LABEL_72:
        ...
        if ( v8 )
        {
          ...
          if ( v15->Flink != (struct _LIST_ENTRY *)(v7 + 232) )
            goto LABEL_70;
          *(_QWORD *)&p_Timer->Header.Lock = v7 + 232;
          CurrentThread[1].Timer.Header.WaitListHead.Flink = v15;
          v15->Flink = (struct _LIST_ENTRY *)p_Timer;
          *(_QWORD *)(v7 + 240) = p_Timer;
          if ( (_InterlockedExchangeAdd64(v14, 0xFFFFFFFFFFFFFFFFuLL) & 6) == 2 )
            ExfTryToWakePushLock((volatile signed __int64 *)(v7 + 224));
          ...
          {
            ExAcquirePushLockExclusiveEx(v7 + 224, 0LL);
            v23 = &CurrentThread[1].Timer;
            v24 = *(_QWORD *)&CurrentThread[1].Timer.Header.Lock;
            if ( v24 )
            {
              CurrentThread[1].RelativeTimerBias = 0LL;
              Flink = CurrentThread[1].Timer.Header.WaitListHead.Flink;
              if ( *(_KTIMER **)(v24 + 8) != v23 || (_KTIMER *)Flink->Flink != v23 )
LABEL_70:
                __fastfail(3u);
              Flink->Flink = (struct _LIST_ENTRY *)v24;
              *(_QWORD *)(v24 + 8) = Flink;
              *(_QWORD *)&v23->Header.Lock = 0LL;
              if ( (_InterlockedExchangeAdd64(v14, 0xFFFFFFFFFFFFFFFFuLL) & 6) == 2 )
                ExfTryToWakePushLock((volatile signed __int64 *)(v7 + 224));
              KeAbPostRelease(v7 + 224);
            }
