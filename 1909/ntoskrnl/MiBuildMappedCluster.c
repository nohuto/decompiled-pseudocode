/*
 * XREFs of MiBuildMappedCluster @ 0x1400C9B8C
 * Callers:
...
unsigned __int64 *__fastcall MiBuildMappedCluster(_QWORD *a1, unsigned __int64 *a2, int a3)
{
  ...
  v74 = v9;
  v76 = *(_QWORD *)(qword_140465E88 + 8 * ((v7 >> 40) & 0x3FF));
...
LABEL_136:
        ...
        if ( (*(_BYTE *)(v36 + 34) & 0x10) == 0
          || *(_WORD *)(v36 + 32) != v37
          || v76 != *(_QWORD *)(qword_140465E88 + 8 * ((*(_QWORD *)(v36 + 40) >> 40) & 0x3FFLL)) )
        {
          _InterlockedAnd64((volatile signed __int64 *)(v36 + 24), 0x7FFFFFFFFFFFFFFFuLL);
          v21 = v69;
LABEL_55:
...
LABEL_56:
            ...
            if ( v60 )
            {
              ...
              MiReleaseWriteInProgressCharges(v76, v60, 1);
              v39 = v74;
            }
            v21 = v69;
            if ( v69 == v71 + 8 )
...
LABEL_144:
      ...
      if ( (*(_BYTE *)(v54 + 34) & 0x10) == 0
        || *(_WORD *)(v54 + 32) != v55
        || v76 != *(_QWORD *)(qword_140465E88 + 8 * ((*(_QWORD *)(v54 + 40) >> 40) & 0x3FFLL)) )
      {
        break;
      }
      if ( v50 )
...
LABEL_104:
    ...
    if ( v29 < v71 )
    {
      ...
      if ( v65 )
      {
        ...
        MiReleaseWriteInProgressCharges(v76, v65, 1);
      }
      v46 = v81;
      v29 = v49;
      v72 = v49;
