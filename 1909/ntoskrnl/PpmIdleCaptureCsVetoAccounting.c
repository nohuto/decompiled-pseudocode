/*
 * XREFs of PpmIdleCaptureCsVetoAccounting @ 0x1402EE4BC
 * Callers:
...
__int64 __fastcall PpmIdleCaptureCsVetoAccounting(__int64 a1, unsigned int a2)
{
  ...
  __int64 *v33; // [rsp+88h] [rbp+27h]
  int j; // [rsp+90h] [rbp+2Fh]
  ...
  if ( PpmPlatformStates && *(_DWORD *)(PpmPlatformStates + 4) )
  {
    ...
    if ( (_DWORD)v3 != -1 )
    {
      ...
      v10 = 0;
      v33 = &v19;
      LODWORD(v19) = -1429427508;
      v22 = 1;
      v25 = 16;
      for ( j = 16; v10 < *(_DWORD *)(v9 + 108); ++v10 )
      {
        ...
        if ( *(_QWORD *)(v11 + 56) )
        {
          ...
          v13 = *(unsigned __int16 *)(PpmIdleVetoList + 16LL * v10 + 8);
          v29 = 0;
          v18 = v13 >> 1;
          v27 = &v18;
          v28 = 4;
          v14 = *(unsigned __int16 *)(PpmIdleVetoList + 16LL * v10 + 8);
          v15 = *(_QWORD *)(PpmIdleVetoList + 16LL * v10 + 16);
          v32 = 0;
          v38 = 0;
          v30 = v15;
          v31 = v14;
