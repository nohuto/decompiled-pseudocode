/*
 * XREFs of MiReservePageFileSpaceForPage @ 0x14002D250
 * Callers:
...
LABEL_64:
    ...
    if ( v35 )
    {
      ...
      if ( (*(_QWORD *)(v35 + 40) & 0x200000000000000LL) != 0 )
        goto LABEL_25;
LABEL_57:
      if ( *(_QWORD *)(qword_140465E88 + 8 * ((*(_QWORD *)(v10 + 40) >> 40) & 0x3FFLL)) == a1 )
      {
  ...
  if ( (*(_BYTE *)v10 & 1) != 0
    && *(_QWORD *)(qword_140465E88 + 8 * ((*(_QWORD *)(v10 + 40) >> 40) & 0x3FFLL)) == a1
    && (*(_BYTE *)(v10 + 35) & 8) == 0 )
  {
    v15 = *(_QWORD *)(v10 + 16);
    if ( MiPteInShadowRange(v10 + 16)
    ...
    v41 = v15;
    if ( (v15 & 1) == 0
      && (!v15 || !qword_140465800 || (qword_140465800 & v15) != 0)
