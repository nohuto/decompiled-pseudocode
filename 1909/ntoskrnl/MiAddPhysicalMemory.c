/*
 * XREFs of MiAddPhysicalMemory @ 0x14088774C
 * Callers:
...
__int64 __fastcall MiAddPhysicalMemory(ULONG_PTR *a1, _DWORD *a2, _DWORD *a3, int a4, __int64 a5)
{
  ...
  if ( v9 >= v10 + v9 )
    return 3221225711LL;
  v12 = 0xFFFFFFFFFLL;
  if ( ((unsigned __int64)qword_140465800 >> 12) - 1 < 0xFFFFFFFFFLL )
    v12 = ((unsigned __int64)qword_140465800 >> 12) - 1;
  if ( v11 - 1 > v12 )
  {
    if ( (a4 & 2) == 0 )
    {
...
LABEL_9:
  ...
  if ( v9 >= v11 )
    return 3221225711LL;
  if ( v10 + v9 >= qword_1404661E0 && v9 < qword_1404661E0 + 2048 || v10 + v9 >= 0xFFFFFFFFALL )
    return 3221225496LL;
...
LABEL_71:
  ...
  v25 = qword_14046A090 + v10;
  if ( qword_14046A090 + v10 > qword_1404657A8 )
    v11 = v9 + qword_1404657A8 - qword_14046A090;
  v10 = qword_1404657A8 - qword_14046A090;
  if ( v25 <= qword_1404657A8 )
    v10 = v13;
  ...
  if ( v9 < v11 )
  {
    ...
    if ( (unsigned int)MiDescribePageRun((__int64)&P, v9, v10) )
    {
      ...
      {
        v27 = 0;
        while ( (unsigned int)MiSplitMirrorBitMap((unsigned __int64 *)&qword_140465F50[2 * v27], v9, v10) )
        {
          if ( ++v27 >= 2 )
          {
            while ( 1 )
