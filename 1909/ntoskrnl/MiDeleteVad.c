/*
 * XREFs of MiDeleteVad @ 0x1400550D0
 * Callers:
...
LABEL_122:
  ...
  if ( v27 && ($C6908ADE9723D0A04AF8EE82D8D15C40 *)v44->ApcState.ApcListHead[0].Flink != &v44->152 )
    KiCheckForKernelApcDelivery();
  v55 = v215;
  v27 = v215->SpecialApcDisable++ == -1;
  if ( v27 && ($C6908ADE9723D0A04AF8EE82D8D15C40 *)v55->ApcState.ApcListHead[0].Flink != &v55->152 )
    KiCheckForKernelApcDelivery();
  v56 = v3[12];
      ...
      if ( (v3[12] & 0x70) != 0x50 )
      {
        ...
        if ( *v66 )
        {
          ...
          if ( KiIrqlFlags && (KiIrqlFlags & 1) != 0 && v67 < 2u )
            _InterlockedOr((volatile signed __int32 *)KeGetCurrentPrcb()->SchedulerAssist, 0x10000u);
          if ( (v192[92] & 7) == 2 )
            v68 = (unsigned __int64 *)&unk_140466F40;
          else
...
LABEL_196:
  if ( v76 )
  {
    if ( v74 >= 0xFFFF800000000000uLL && byte_140467140[((v74 >> 39) & 0x1FF) - 256] == 1 )
...
LABEL_205:
  ...
  if ( v27 && ($C6908ADE9723D0A04AF8EE82D8D15C40 *)v75->ApcState.ApcListHead[0].Flink != &v75->152 )
    KiCheckForKernelApcDelivery();
...
LABEL_329:
    ...
    if ( *(_QWORD *)(v124 + 216) )
    {
      ...
      while ( 1 )
      {
        ...
        v131 = v120;
        v132 = v129 - qword_140465BD8;
        if ( !v120 )
          v131 = v129 == qword_140465BD8;
        if ( v131 > v121 )
          goto LABEL_384;
        v133 = 8 * v132;
        v227 = 8 * v132;
...
LABEL_353:
      ...
      if ( v143 + v141 > 8 )
      {
        ...
        if ( !v141 )
          goto LABEL_352;
        v145 = byte_140381050[v141];
      }
      else
      {
        v145 = ~(byte_140382448[v141] << v143);
      }
      *v144 &= v145;
LABEL_352:
      v121 = v195;
...
LABEL_398:
  ...
  if ( v27 && ($C6908ADE9723D0A04AF8EE82D8D15C40 *)v158->ApcState.ApcListHead[0].Flink != &v158->152 )
    KiCheckForKernelApcDelivery();
  v167 = v215;
  v27 = v215->SpecialApcDisable++ == -1;
  if ( v27 && ($C6908ADE9723D0A04AF8EE82D8D15C40 *)v167->ApcState.ApcListHead[0].Flink != &v167->152 )
    KiCheckForKernelApcDelivery();
  v168 = v216;
  if ( v216 )
  {
...
LABEL_416:
  ...
  *(_QWORD *)v3 = v221;
  ...
  if ( (v5 & 8) != 0 )
  {
    ...
    if ( v27 && ($C6908ADE9723D0A04AF8EE82D8D15C40 *)v178->ApcState.ApcListHead[0].Flink != &v178->152 )
      KiCheckForKernelApcDelivery();
  }
  ...
  if ( v204 )
  {
    ...
    else
    {
      ...
      --*(_QWORD *)(v180 + 48);
      if ( v157 )
        v183 = *(_QWORD *)(qword_140465E88 + 8LL * (*(_WORD *)(v180 + 60) & 0x3FF));
