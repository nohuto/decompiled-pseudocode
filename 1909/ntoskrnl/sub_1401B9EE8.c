/*
 * XREFs of sub_1401B9EE8 @ 0x1401B9EE8
 * Callers:
...
unsigned __int64 __fastcall sub_1401B9EE8(__int64 a1, int *a2, __int64 a3)
{
...
LABEL_45:
      ...
      if ( !(_DWORD)result )
      {
        ...
        *(_QWORD *)(a1 + 2328) = v37;
        *(_DWORD *)(a1 + 2296) = 1;
        result = sub_14036B3BC(a1, 0LL, 0xA3A03F5891C8B4E8uLL, 0xB3B74BDEE4453415uLL);
      }
    }
LABEL_49:
    ...
    if ( !(_DWORD)v38 )
      return result;
    sub_1401B8E9C(a1, *((_QWORD *)a2 + 1), v38, (__int64)v51);
    v39 = 16LL;
...
LABEL_67:
      ...
      if ( !*(_DWORD *)(a1 + 2296) )
      {
        ...
        *(_QWORD *)(a1 + 2328) = v50;
        *(_DWORD *)(a1 + 2296) = 1;
        result = sub_14036B3BC(a1, 0LL, v39, v40);
      }
    }
LABEL_69:
  ...
  for ( j = ((a2[2] & 0xFFF) + (unsigned __int64)(unsigned int)a2[4] + 4095) >> 12; j; v8 += 4096LL )
  {
    ...
    if ( (_BYTE)result )
    {
      if ( !*(_DWORD *)(a1 + 2296) )
      {
        ...
        *(_QWORD *)(a1 + 2328) = v8;
        *(_DWORD *)(a1 + 2296) = 1;
        result = sub_14036B3BC(a1, 0LL, a3, v10);
      }
    }
    *(_DWORD *)(a1 + 2088) += 256;
  }
