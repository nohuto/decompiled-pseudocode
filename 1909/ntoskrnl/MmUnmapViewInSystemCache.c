/*
 * XREFs of MmUnmapViewInSystemCache @ 0x140070570
 * Callers:
...
void __fastcall MmUnmapViewInSystemCache(ULONG_PTR BugCheckParameter3, ULONG_PTR BugCheckParameter4, char a3)
{
  ...
  v134 = 0;
  v139 = 0LL;
  v142 = *(_QWORD *)(qword_140465E88 + 8 * v7);
  v133 = 2;
  v135 = v142 + 0x2000;
...
LABEL_103:
      ...
      if ( (v87 & 0x20) != 0 )
      {
        ...
        if ( HasShadow )
        {
          if ( !HIBYTE(word_1404658EC) && (v89 & 1) != 0 )
...
LABEL_29:
  ...
  if ( MiPteInShadowRange(v5) )
  {
    ...
    {
      if ( !HIBYTE(word_1404658EC) && (v119 & 1) != 0 )
        v119 |= v121;
      *(_QWORD *)v5 = v119;
...
LABEL_38:
  ...
  if ( MiPteInShadowRange(v147 + 16) )
  {
    ...
    if ( !HIBYTE(word_1404658EC) && (v123 & 1) != 0 )
      v57 |= 0x8000000000000000uLL;
    *(_QWORD *)(v59 + 16) = v57;
...
LABEL_55:
  ...
  if ( MiPteInShadowRange(v59 + 8) )
  {
    ...
    if ( !HIBYTE(word_1404658EC) && (v60 & 1) != 0 )
      v60 |= v124;
    *(_QWORD *)(v64 + 8) = v60;
...
LABEL_57:
  ...
  if ( v134 == 1 )
  {
    if ( qword_140465800 )
    {
      if ( (v131 & 0x10) != 0 )
        ...
        v65 = v131 & ~(_DWORD)qword_140465800;
    }
  ...
  v131 = MiSwizzleInvalidPte(v66, qword_140465800, v62, v63);
  if ( MiPteInShadowRange(v67 + 24) )
  {
    ...
    if ( !HIBYTE(word_1404658EC) && (v125 & 1) != 0 )
      v68 |= v126;
    *(_QWORD *)(v70 + 24) = v68;
