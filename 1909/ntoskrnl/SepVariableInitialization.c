/*
 * XREFs of SepVariableInitialization @ 0x1409FEFAC
 * Callers:
...
bool SepVariableInitialization()
{
  ...
  PSID v82; // [rsp+218h] [rbp+118h]
  PSID v83; // [rsp+220h] [rbp+120h]
  PSID v84; // [rsp+228h] [rbp+128h]
  PSID v85; // [rsp+230h] [rbp+130h]
  PSID v86; // [rsp+238h] [rbp+138h]
  PSID v87; // [rsp+240h] [rbp+140h]
  PSID v88; // [rsp+248h] [rbp+148h]
  PSID v89; // [rsp+250h] [rbp+150h]
  PSID v90; // [rsp+258h] [rbp+158h]
  PSID v91; // [rsp+260h] [rbp+160h]
  ...
  *(_QWORD *)&v65.Length = 2097182LL;
  *(_QWORD *)&v78.Length = 1703960LL;
  ...
  *(_QWORD *)&SeMediumMandatorySid = ExAllocatePoolWithTag((POOL_TYPE)528, v2, 0x69536553u);
  ...
  if ( !SeProcTrustLiteWinTcbSid )
    return 0;
  v84 = (PSID)SeProcTrustLiteWinSid;
  if ( !SeProcTrustLiteWinSid )
    return 0;
  v86 = (PSID)SeProcTrustLiteAppSid;
  if ( !SeProcTrustLiteAppSid )
    return 0;
  v83 = (PSID)SeProcTrustNoneSid;
  if ( !SeProcTrustNoneSid )
    return 0;
  v82 = SeTrustedInstallerSid;
  ...
  RtlInitializeSid(v82, (PSID_IDENTIFIER_AUTHORITY)&v39, 6u);
  ...
  RtlInitializeSid(v83, (PSID_IDENTIFIER_AUTHORITY)&v40, 2u);
  ...
  *((_DWORD *)v62 + 2) = 2;
  ...
  if ( RtlDeriveCapabilitySidsFromName(
         &v67,
         (char *)SeConstrainedImpersonationCapabilityGroupSid,
         SeLpacComCapabilitySid) < 0 )
    return 0;
  if ( RtlDeriveCapabilitySidsFromName(
         &v68,
         (char *)SeConstrainedImpersonationCapabilityGroupSid,
  ...
  *((_DWORD *)SeTrustedInstallerSid + 2) = 80;
  ...
  v33 = (char *)SeConstrainedImpersonationCapabilityGroupSid;
  v23[2] = 32;
  v23[3] = 581;
  ...
  qword_1409AECC8 = (__int64)SeNullSid;
  qword_1409AECD0 = (__int64)SeWorldSid;
  qword_1409AECD8 = (__int64)SeLocalSid;
  qword_1409AECE0 = (__int64)SeCreatorOwnerSid;
  qword_1409AECE8 = (__int64)SeCreatorGroupSid;
  qword_1409AEE10 = (__int64)SeOwnerRightsSid;
  qword_1409AECF0 = (__int64)SeNtAuthoritySid;
  qword_1409AECF8 = SeDialupSid;
  qword_1409AED00 = SeNetworkSid;
  qword_1409AED08 = SeBatchSid;
  qword_1409AED10 = SeInteractiveSid;
  qword_1409AED18 = (__int64)SeLocalSystemSid;
  qword_1409AED60 = SeAuthenticatedUsersSid;
  qword_1409AED68 = *(_QWORD *)&SeRestrictedSid;
  qword_1409AED70 = (__int64)SeAnonymousLogonSid;
  qword_1409AED90 = (__int64)SeLocalServiceSid;
  qword_1409AED98 = (__int64)SeNetworkServiceSid;
  qword_1409AEDE0 = (__int64)SeIUserSid;
  qword_1409AED20 = (__int64)SeAliasAdminsSid;
  qword_1409AED28 = (__int64)SeAliasUsersSid;
  qword_1409AED30 = SeAliasGuestsSid;
  qword_1409AED38 = SeAliasPowerUsersSid;
  qword_1409AED40 = (__int64)SeAliasAccountOpsSid;
  qword_1409AED48 = (__int64)SeAliasSystemOpsSid;
  qword_1409AED50 = (__int64)SeAliasPrintOpsSid;
  qword_1409AED58 = (__int64)SeAliasBackupOpsSid;
  qword_1409AEDE8 = (__int64)SeUntrustedMandatorySid;
  qword_1409AEDF0 = *(_QWORD *)&SeLowMandatorySid;
  ...
  qword_1409AEDF8 = *(_QWORD *)&SeMediumMandatorySid;
  qword_1409AEE00 = (__int64)SeHighMandatorySid;
  qword_1409AEE08 = SeSystemMandatorySid;
  qword_1409AEE18 = (__int64)SeAllAppPackagesSid;
  qword_1409AEE20 = (__int64)SeUserModeDriversSid;
  qword_1409AEE28 = SeProcTrustWinTcbSid;
  qword_1409AEE30 = (__int64)SeTrustedInstallerSid;
  SepExports = 2LL;
  qword_1409AEC18 = 3LL;
  qword_1409AEC20 = 4LL;
  qword_1409AEC28 = 5LL;
  ...
  qword_1409AEC40 = 8LL;
  qword_1409AEC48 = 9LL;
  qword_1409AEC50 = 10LL;
  qword_1409AEC58 = 15LL;
  qword_1409AEC60 = 14LL;
  qword_1409AEC68 = 11LL;
  qword_1409AEC70 = 12LL;
  qword_1409AEC78 = 13LL;
  qword_1409AEC80 = 16LL;
  qword_1409AEC88 = 17LL;
  qword_1409AEC90 = 18LL;
  qword_1409AEC98 = 19LL;
  qword_1409AECA0 = 20LL;
  qword_1409AECA8 = 21LL;
  qword_1409AECB0 = 22LL;
  qword_1409AEE38 = 36LL;
  qword_1409AEDA8 = 29LL;
  qword_1409AEDD0 = 34LL;
  v34 = 5LL;
  qword_1409AEDD8 = 35LL;
  v35 = (char *)&unk_140445BF8;
  qword_1409AECB8 = 23LL;
  qword_1409AECC0 = 24LL;
  qword_1409AED78 = 25LL;
  qword_1409AED80 = 26LL;
  qword_1409AED88 = 27LL;
  qword_1409AEDA0 = 28LL;
  qword_1409AEDB0 = 30LL;
  qword_1409AEDB8 = 31LL;
  qword_1409AEDC0 = 32LL;
  qword_1409AEDC8 = 33LL;
