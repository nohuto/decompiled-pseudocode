/*
 * XREFs of MiUpdateImagePfnImportRelocations @ 0x140155AE8
 * Callers:
 ...
 *     MiUpdateRetpolineImportFixups @ 0x140155CC4 (MiUpdateRetpolineImportFixups.c)
 */
...
LABEL_8:
    ...
    {
      v14 = 1;
      if ( HIBYTE(word_1404658EC) == (_BYTE)v5 )
      {
LABEL_31:
        if ( (a2 & 1) != 0 )
