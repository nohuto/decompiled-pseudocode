/*
 * XREFs of vDbgPrintExWithPrefixInternal @ 0x140126BD0
 * Callers:
 *     PopPrintEx @ 0x140126AC8 (PopPrintEx.c)
 *     DbgPrintEx @ 0x140126B10 (DbgPrintEx.c)
 *     DbgPrint @ 0x140126B50 (DbgPrint.c)
 *     vDbgPrintEx @ 0x140126BA0 (vDbgPrintEx.c)
 *     IopDebugPrint @ 0x14029E798 (IopDebugPrint.c)
 *     KsepDebugPrint @ 0x1402B6DB4 (KsepDebugPrint.c)
 *     DbgPrintReturnControlC @ 0x14030ABB0 (DbgPrintReturnControlC.c)
 *     vDbgPrintExWithPrefix @ 0x14030AFA0 (vDbgPrintExWithPrefix.c)
 ...
 *     DebugPrint @ 0x1401CC500 (DebugPrint.c)
