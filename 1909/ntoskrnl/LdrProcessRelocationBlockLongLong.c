/*
 * XREFs of LdrProcessRelocationBlockLongLong @ 0x1408D7998
 * Callers:
 *     LdrRelocateImageWithBias @ 0x1408D7A54 (LdrRelocateImageWithBias.c)
 * Callees:
 *     LdrpArmProcessRelocation @ 0x140313944 (LdrpArmProcessRelocation.c)
 *     LdrpGenericProcessRelocation @ 0x140313A18 (LdrpGenericProcessRelocation.c)
 *     LdrpThumbProcessRelocation @ 0x140313ABC (LdrpThumbProcessRelocation.c)
 */
