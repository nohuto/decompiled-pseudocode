/*
 * XREFs of NtFreeVirtualMemory @ 0x140608610
 * Callers:
 *     RtlpInitializeStackTraceDatabase @ 0x1408CFAB0 (RtlpInitializeStackTraceDatabase.c)
 * Callees:
...
NTSTATUS __stdcall NtFreeVirtualMemory(HANDLE ProcessHandle, PVOID *BaseAddress, PSIZE_T RegionSize, ULONG FreeType)
{
  ...
  __int64 v8; // rcx
  NTSTATUS result; // eax
  ULONG_PTR v10; // [rsp+38h] [rbp-20h]
  PVOID v11; // [rsp+40h] [rbp-18h]
