/*
 * XREFs of VrpPostEnumerateKey @ 0x140843678
 * Callers:
...
__int64 __fastcall VrpPostEnumerateKey(__int64 a1, __int64 a2)
{
  ...
  *(_QWORD *)ActivityId.Data4 = 0LL;
  ...
  if ( stru_140425BF8.LevelPlus1 > 5 )
  {
    ...
    v74[0] = Length;
    v74[1] = 0;
    TlgWrite(&stru_140425BF8, &unk_14038C93E, &ActivityId, 0LL, 5u, &pData);
  }
...
LABEL_26:
  ...
  if ( v6 < 0 && stru_140425BF8.LevelPlus1 > 2 )
  {
    ...
    v66 = &v42;
    v67 = 4LL;
    TlgWrite(&stru_140425BF8, &unk_14038C8BE, &ActivityId, 0LL, 8u, &v55);
  }
  if ( KeyHandle )
    ZwClose(KeyHandle);
  if ( v43 )
