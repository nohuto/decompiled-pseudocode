/*
 * XREFs of PfFbBufferListAllocateTemporary @ 0x1400D4F04
 * Callers:
 *     PfpEventHandleOutOfBuffers @ 0x1400D4EE0 (PfpEventHandleOutOfBuffers.c)
 *     PfpSectInfoHandleOutOfBuffers @ 0x140749610 (PfpSectInfoHandleOutOfBuffers.c)
 * Callees:
