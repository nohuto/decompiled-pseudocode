/*
 * XREFs of KiFloatingErrorFault @ 0x1401D2A40
 * Callers:
 *     KiFloatingErrorFaultShadow @ 0x140350880 (KiFloatingErrorFaultShadow.c)
 * Callees:
...
void __fastcall __noreturn KiFloatingErrorFault(__int64 a1, unsigned __int64 Object)
{
  ...
  if ( (v16 & 1) != 0 )
  {
    ...
    v4 = *(_QWORD *)&CurrentThread->Process[2].Spare2[23];
    __writegsqword(0x270u, v4);
    __writegsbyte(0x851u, KeGetPcr()->Prcb.BpbRetpolineExitSpecCtrl);
    LOBYTE(v4) = KeGetPcr()->Prcb.BpbState;
    __writegsbyte(0x852u, v4);
