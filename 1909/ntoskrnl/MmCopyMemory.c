/*
 * XREFs of MmCopyMemory @ 0x1400C7740
 * Callers:
 *     <none>
 * Callees:
...
LABEL_9:
  ...
  v12 = 0;
  v42 = MiReservePtes((__int64)&qword_1404666C0, (unsigned __int64 *)(unsigned int)v11);
  v33 = v42;
...
LABEL_19:
    ...
    if ( SystemRegionType == (_DWORD)v27 )
      break;
LABEL_49:
    if ( BaseAddress >= qword_1404672B0 && BaseAddress <= qword_140465BE0 )
    {
      v12 = -1073741585;
      goto LABEL_29;
    }
...
LABEL_30:
  if ( v42 )
    MiReleasePtes((__int64)&qword_1404666C0, v42, v11);
  *v5 += v35;
  return v12;
}
