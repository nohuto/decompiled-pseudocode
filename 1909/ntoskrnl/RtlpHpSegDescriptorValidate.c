/*
 * XREFs of RtlpHpSegDescriptorValidate @ 0x14001EB80
 * Callers:
 *     RtlpHpSegFree @ 0x14001D8B4 (RtlpHpSegFree.c)
 *     RtlpHpSegLfhVsDecommit @ 0x14001EA90 (RtlpHpSegLfhVsDecommit.c)
 *     RtlpHpMetadataCommit @ 0x14019AADC (RtlpHpMetadataCommit.c)
 *     RtlpHpSizeHeapInternal @ 0x14031B1A4 (RtlpHpSizeHeapInternal.c)
 *     RtlpHpSegSetExtraPresent @ 0x14031B6D4 (RtlpHpSegSetExtraPresent.c)
 * Callees:
 *     <none>
 */
