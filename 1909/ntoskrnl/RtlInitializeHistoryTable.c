/*
 * XREFs of RtlInitializeHistoryTable @ 0x140A1BA60
 * Callers:
 *     MiInitSystem @ 0x1409F0D98 (MiInitSystem.c)
 * Callees:
 *     RtlLookupFunctionEntry @ 0x14001A980 (RtlLookupFunctionEntry.c)
 *     RtlpFunctionAddressTableEntry @ 0x140A1BB48 (RtlpFunctionAddressTableEntry.c)
 */
...
PRUNTIME_FUNCTION RtlInitializeHistoryTable()
{
  ...
  for ( i = 0; i < 0xC; ++i )
  {
    ...
    *(_QWORD *)&RtlpUnwindHistoryTable[2 * v3 + 8] = v2;
    if ( v4 < qword_14058A908 )
      qword_14058A908 = v4;
    if ( v5 > qword_14058A910 )
      qword_14058A910 = v5;
  }
