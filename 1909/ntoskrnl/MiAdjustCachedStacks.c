/*
 * XREFs of MiAdjustCachedStacks @ 0x140004EF0
 * Callers:
...
__int64 MiAdjustCachedStacks()
{
  ...
  do
  {
    ...
    do
    {
      ...
      result = (unsigned int)(*((_DWORD *)&qword_140465758[v5 + 1].HeaderX64 + 1)
                            - *((_DWORD *)&qword_140465758[v5 + 1].HeaderX64 + 2));
      if ( (_DWORD)result )
      {
...
LABEL_11:
            *((_DWORD *)&v6[1].HeaderX64 + 2) = *((_DWORD *)&qword_140465758[v5 + 1].HeaderX64 + 1);
            if ( !(_DWORD)result )
              result = 1LL;
