/*
 * XREFs of CcInitializeCacheManager @ 0x140A040E4
 * Callers:
 ...
 *     MmGetNumberOfPhysicalPagesForPartitionObject @ 0x1406F1D4C (MmGetNumberOfPhysicalPagesForPartitionObject.c)
 *     PoRegisterCoalescingCallback @ 0x140758F80 (PoRegisterCoalescingCallback.c)
 *     FsRtlIsMobileOS @ 0x14075E110 (FsRtlIsMobileOS.c)
...
char CcInitializeCacheManager()
{
  ...
  qword_140463A38 = (__int64)&CcVacbFreeList;
  ...
  *((_QWORD *)PspSystemPartition + 1) = Partition;
  ...
  qword_140463A98 = (__int64)&CcVolumeCacheMapList;
  ...
  qword_140463AE8 = (__int64)&CcBcbTrimNotificationList;
  ...
  qword_140463B10 = (__int64)&qword_140463B08;
  qword_140463B08 = (__int64)&qword_140463B08;
  ...
  qword_140463B38 = (__int64)&CcExternalCacheList;
