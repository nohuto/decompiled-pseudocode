/*
 * XREFs of PpmResetPerfTimes @ 0x140180AFC
 * Callers:
 *     PpmResetPerfEngineForProcessor @ 0x14015F44C (PpmResetPerfEngineForProcessor.c)
 *     PpmCheckReset @ 0x14019D830 (PpmCheckReset.c)
 *     PpmCheckProcessorInit @ 0x14019DA30 (PpmCheckProcessorInit.c)
 * Callees:
 *     PpmSnapPerformanceAccumulation @ 0x1400358F0 (PpmSnapPerformanceAccumulation.c)
 *     PpmResetPerformanceAccumulation @ 0x140180BB0 (PpmResetPerformanceAccumulation.c)
 */
