/*
 * XREFs of RtlDecompressBufferXpressHuffProgress @ 0x140317268
 * Callers:
 *     RtlDecompressBufferProgress @ 0x1403171A8 (RtlDecompressBufferProgress.c)
 * Callees:
 *     XpressBuildHuffmanDecodingTable @ 0x1400DED80 (XpressBuildHuffmanDecodingTable.c)
        ...
        __int64 a8)
{
  ...
  if ( !a6 )
    return 3221225704LL;
  v12 = a1;
  v13 = (_WORD *)((a6 + 7) & 0xFFFFFFFFFFFFFFF8uLL);
...
LABEL_7:
  ...
  while ( 1 )
  {
    v24 = v13[((unsigned __int64)v21 >> 22) + 528];
    if ( v24 > 0 )
    {
      v26 = v24 & 0xF;
      v21 <<= v26;
...
LABEL_67:
    ...
    v43 = v13[((unsigned __int64)v21 >> 22) + 528];
    if ( v43 > 0 )
    {
      v45 = v43 & 0xF;
      v21 <<= v45;
