/*
 * XREFs of HvpAddBin @ 0x14068D388
 * Callers:
 ...
 *     HvpViewMapCOWAndUnsealRange @ 0x140635B68 (HvpViewMapCOWAndUnsealRange.c)
...
LABEL_7:
  if ( i )
  {
    ...
    *v27 = v26;
    v26[1] = (__int64)v27;
    v28 = (_DWORD)v3 << 31;
    if ( HvpMarkDirty(BugCheckParameter2, v28 + *((_DWORD *)i + 5), *((_DWORD *)i + 4), 0) )
    {
      v29 = 0LL;
      v4 = v28 + *((_DWORD *)i + 5);
      for ( j = v4; (unsigned int)v29 < v7; *v33 = v34 )
      {
        CellMap = HvpGetCellMap(BugCheckParameter2, (int)v29 + v4);
        v33 = (_QWORD *)CellMap;
        if ( !CellMap )
...
LABEL_77:
    ...
    *(_DWORD *)(v52 + BugCheckParameter2 + 272) = v11;
    ...
    if ( v49 && !v56 )
      HvpFreeBin(BugCheckParameter2, v12 - v11, (__int64)v49);
    if ( v51 )
      (*(void (__fastcall **)(__int64, __int64))(BugCheckParameter2 + 32))(v51, 24LL);
    if ( v50 && !v56 )
      HvpFreeBin(BugCheckParameter2, v13 - v12, (__int64)v50);
    if ( !HIDWORD(Size) )
      return j;
  ...
  if ( (*(_DWORD *)(BugCheckParameter2 + 248) & 1) != 0 )
    v23 = *(_QWORD *)(BugCheckParameter2 + 232);
  else
    v23 = 0x7FFFFFFFFFFFFFFFLL;
  v24 = v23 & 0xFFFFFFFFFFFFF000uLL;
  v54 = 1;
  v57 = 1;
  if ( v24 >= 2147479552 )
    LODWORD(v24) = 2147479552;
  if ( v13 > (int)v24 - 4096 )
  {
LABEL_14:
    v14 = 0;
  ...
  if ( (_DWORD)Size )
  {
    if ( v14 )
    {
      ...
      v55 = v56;
      HIDWORD(Size) = Size;
      if ( (int)HvpViewMapPromoteRangeToMapping(BugCheckParameter2 + 216, v11, (unsigned int)Size, &v49) < 0 )
        goto LABEL_76;
      v55 = v56;
      v35 = HvpViewMapCOWAndUnsealRange(BugCheckParameter2 + 216, v11, Size);
    }
    else
    {
      v55 = 0;
  ...
  if ( v14 )
  {
    ...
    HIDWORD(Size) += v5;
    v55 = v56;
    if ( (int)HvpViewMapPromoteRangeToMapping(BugCheckParameter2 + 216, v12, v5, &v50) < 0 )
      goto LABEL_76;
    v55 = v56;
    v16 = HvpViewMapCOWAndUnsealRange(BugCheckParameter2 + 216, v12, v5);
  }
  else
  {
    v55 = 0;
...
LABEL_76:
    ...
    v55 = 0;
    v16 = HvpProtectBin(v15, v5, (__int64)v50, 1);
  }
  if ( v16 < 0 )
    goto LABEL_76;
  memset(v50, 0, v5);
  ...
  *v17 = 1852400232;
  ...
  v12 += v19;
  HvpPointMapEntriesToBuffer(BugCheckParameter2, v20, 0LL);
  if ( !(_DWORD)v3 )
  {
    if ( (*(_DWORD *)(BugCheckParameter2 + 160) & 1) != 0
      || (v55 = v56, HvpMarkDirty(BugCheckParameter2, v11, v13 - v11, 0)) )
    {
