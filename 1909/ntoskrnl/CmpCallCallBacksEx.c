/*
 * XREFs of CmpCallCallBacksEx @ 0x1405F8BA0
 * Callers:
        ...
        __int64 a7)
{
  ...
  struct _SLIST_ENTRY *v46; // [rsp+38h] [rbp-D0h]
  __int64 *v47; // [rsp+40h] [rbp-C8h]
  struct _SLIST_ENTRY *v48; // [rsp+48h] [rbp-C0h]
  struct _KTHREAD *v49; // [rsp+50h] [rbp-B8h]
  struct _SLIST_ENTRY *v50; // [rsp+58h] [rbp-B0h]
  _QWORD *v51; // [rsp+60h] [rbp-A8h] BYREF
  struct _SLIST_ENTRY *v52; // [rsp+68h] [rbp-A0h]
  ...
  if ( a4 == 1 )
  {
    ...
    while ( 1 )
    {
      ...
      *((_QWORD *)&PoolWithTag[1].Next + 1) = v14;
      ...
      v32 = *(struct _SLIST_ENTRY ***)(a7 + 8);
      if ( *v32 != (struct _SLIST_ENTRY *)a7 )
        __fastfail(3u);
      ...
      *(_QWORD *)(a7 + 8) = PoolWithTag;
      ...
      if ( !a3 || (*((_DWORD *)v14 + 5) & 1) == 0 )
        v33 = (struct _SLIST_ENTRY *)a2;
      v34 = ((__int64 (__fastcall *)(__int64, _QWORD, struct _SLIST_ENTRY *))v14[5])(v14[4], (int)a1, v33);
      v44 = v34;
      if ( a1 == 14 )
      {
        v44 = 0;
      ...
      else if ( v34 < 0 )
      {
        ...
        v37 = (struct _SLIST_ENTRY **)*((_QWORD *)&PoolWithTag->Next + 1);
...
LABEL_7:
    if ( v43 )
    {
      ...
      if ( v19
        && ($C6908ADE9723D0A04AF8EE82D8D15C40 *)v18->ApcState.ApcListHead[0].Flink != &v18->152
  ...
  if ( !v7 )
  {
    ...
    while ( v16->Next != v16 )
    {
      v23 = (struct _SLIST_ENTRY *)*((_QWORD *)&v16->Next + 1);
      v50 = v23;
      ...
      *v24 = v16;
      v46 = (struct _SLIST_ENTRY *)*((_QWORD *)&v23[1].Next + 1);
      v25 = v46;
      ...
      if ( v8 && (HIDWORD(v25[1].Next) & 1) != 0 )
        ...
        v26 = v21;
      v44 = (*((__int64 (__fastcall **)(_SLIST_ENTRY *, _QWORD, struct _SLIST_ENTRY *))&v25[2].Next + 1))(
              v25[2].Next,
              (int)a5,
              v26);
