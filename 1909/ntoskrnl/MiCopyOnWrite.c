/*
 * XREFs of MiCopyOnWrite @ 0x140059130
 * Callers:
...
__int64 __fastcall MiCopyOnWrite(ULONG_PTR BugCheckParameter2, unsigned __int64 a2, ULONG_PTR Page, char a4)
{
  ...
  if ( BugCheckParameter2 < 0xFFFF800000000000uLL )
    goto LABEL_3;
  v80 = byte_140467140[((BugCheckParameter2 >> 39) & 0x1FF) - 256];
  switch ( v80 )
  {
    case 1:
...
LABEL_3:
  ...
  v18 = (*(_BYTE *)v10 & 1) == 0;
  v19 = 0;
  v121 = *(_QWORD *)(qword_140465E88 + 8LL * *(unsigned __int16 *)(AnyMultiplexedVm + 174));
  if ( !v18 )
    v17 = v16;
...
LABEL_16:
  ...
  if ( Page == -1LL )
  {
    if ( v26 )
    {
      ...
      HIDWORD(v118) = (v26 - 1) << byte_14046574D;
    }
    else
    {
  ...
  if ( v19 )
  {
    if ( v19 >= 2 )
    {
      v75 = *(_QWORD *)(qword_140465E88 + 8 * ((*(_QWORD *)(v10 + 40) >> 40) & 0x3FFLL));
  ...
  *(_QWORD *)(v34 + 16) = v35;
  if ( v24 != 10 )
  {
    ...
    v111 = 0LL;
    if ( v36 == 2 )
      v37 = (volatile signed __int64 *)&unk_140466F40;
    else
...
LABEL_69:
  ...
  if ( dword_140466068 && PagePriorityThread >= dword_14046606C )
  ...
  else
  {
    ...
    if ( v66 )
    {
      ...
      {
        if ( !HIBYTE(word_1404658EC) && (v63 & 1) != 0 )
