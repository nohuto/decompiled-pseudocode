/*
 * XREFs of MiLargePageFreeToZero @ 0x1400C4B30
 * Callers:
...
void __fastcall MiLargePageFreeToZero(ULONG_PTR BugCheckParameter2, unsigned int a2, __int64 a3, char a4)
{
  ...
  *(_QWORD *)&LockHandle.OldIrql = 0LL;
  ...
  v49 = v9;
  v11 = v10 >> 36;
  v52 = *(_QWORD *)(qword_140465E88 + 8 * ((v10 >> 40) & 0x3FF));
  ...
  *(_QWORD *)(v8 + 16) = MiSwizzleInvalidPte(128LL);
  if ( a4 )
  {
    if ( dword_140465F0C == 1 )
    {
      ...
      v38 = (volatile signed __int32 *)(qword_140465F68 + 4 * (BugCheckParameter2 >> 5));
      if ( v37 + v18 > 0x20 )
      {
...
LABEL_45:
  ...
  *(_QWORD *)(v21 + 8) = v22;
  if ( v19 )
  {
    *(_QWORD *)(v8 + 16) = MiUpdatePageFileHighInPte(*(_QWORD *)(v8 + 16), 4294967293LL);
    if ( v8 + 48 < v8 + 48 * v18 )
    {
      v42 = (__int64 *)(v8 + 64);
      do
      {
        *v42 = MiUpdatePageFileHighInPte(*v42, 4294967293LL);
        v42 += 6;
      }
      while ( v43 != 1 );
    }
  ...
  v26 = v24;
  v27 = 22LL;
  v28 = 24 * (v26 % (unsigned int)dword_140465840[v20]);
  ...
  if ( dword_140465F0C != 1 )
    goto LABEL_15;
  v44 = v18;
  v45 = (volatile signed __int32 *)(qword_140465F68 + 4 * (BugCheckParameter2 >> 5));
