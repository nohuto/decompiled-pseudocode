/*
 * XREFs of PsRegisterPicoProvider @ 0x1408C9DE0
 * Callers:
 *     <none>
 * Callees:
 *     <none>
...
__int64 __fastcall PsRegisterPicoProvider(__int64 a1, _QWORD *a2)
{
  ...
  xmmword_140436990 = *(_OWORD *)(a1 + 16);
  xmmword_1404369A0 = *(_OWORD *)(a1 + 32);
  xmmword_1404369B0 = *(_OWORD *)(a1 + 48);
  xmmword_1404369C0 = *(_OWORD *)(a1 + 64);
  qword_1404369D0 = *(_QWORD *)(a1 + 80);
  PspPicoProviderRanges = _mm_srli_si128((__m128i)xmmword_1404369B0, 8).m128i_u64[0];
