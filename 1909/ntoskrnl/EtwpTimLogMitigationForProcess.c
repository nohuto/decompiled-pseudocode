/*
 * XREFs of EtwpTimLogMitigationForProcess @ 0x1406E0F44
 * Callers:
...
void __fastcall EtwpTimLogMitigationForProcess(int a1, int a2, const EVENT_DESCRIPTOR *a3, __int64 a4)
{
  ...
  *(_QWORD *)&UserData.Size = 2LL;
  ...
  v18 = P;
  if ( stru_140426650.LevelPlus1 > 5 && TlgKeywordOn(&stru_140426650, 0x200000000000uLL) )
  {
    v26 = v25;
    v28 = &v21;
    v30 = &v22;
    ...
    v39[1] = 0;
    v41 = 8LL;
    TlgWrite(&stru_140426650, &unk_140394669, 0LL, 0LL, 9u, &pData);
  }
  if ( v18 )
