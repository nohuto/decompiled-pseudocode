/*
 * XREFs of PopInvokeSystemStateHandler @ 0x14059871C
 * Callers:
 ...
 *     KeRebaselineInterruptTime @ 0x14015FD9C (KeRebaselineInterruptTime.c)
 *     KeRebaselineSystemTime @ 0x140169C2C (KeRebaselineSystemTime.c)
...
__int64 __fastcall PopInvokeSystemStateHandler(int a1, __int64 a2)
{
  ...
  *(_QWORD *)&Affinity.Group = 0LL;
  ...
  if ( a2 )
  {
    ...
    qword_140467DA0 = DeferredContext[4];
    dword_140467DA8 = DeferredContext[5];
    byte_140467DAC = BYTE4(DeferredContext[5]);
    dword_140467DB0 = DeferredContext[6];
    qword_140467D88 = (__int64)v7;
    v9 = &PopHibernateSystemContext;
    qword_140467D90 = v8;
    qword_140467D98 = v6;
    qword_140467DB8 = DeferredContext[7];
  ...
  if ( SLODWORD(v34[7].Next) >= 0 )
  {
    *((_BYTE *)v9 + 44) = 1;
    ...
    if ( a2 )
    {
      ...
      MmInvalidateDumpAddresses(qword_1404433A8, 19LL);
      v13 = *(_QWORD *)(a2 + 304);
      if ( v13 )
  ...
  if ( a2 )
  {
    ...
    v22 = qword_140443B40 == 0;
    *v9 = (__int64)&unk_140443B38;
    v9[3] = 0LL;
    if ( !v22 )
      PopIssueNextState(v9, v34, 6LL);
...
LABEL_49:
  ...
  if ( Next >= 0 )
  {
    if ( dword_140442FE0 != 4 || PoResumeFromHibernate )
    {
      v15 = 0;
      v24 = KeQueryPerformanceCounter(0LL);
      ((void (__fastcall *)(void *, __int64 *))off_1404243E0[0])(&unk_1404435C8, &qword_1404435D0);
    }
    else
    {
      v15 = 1;
    ...
    if ( v15 )
    {
      ...
      qword_1404434A8 = v24.QuadPart - PerformanceCounter.QuadPart;
    }
  }
  ...
  if ( a2 )
  {
    if ( !byte_1404433C1 && Next == 1073742484 )
    {
      if ( byte_140467D68 )
