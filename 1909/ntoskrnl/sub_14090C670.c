/*
 * XREFs of sub_14090C670 @ 0x14090C670
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall sub_14090C670(_DWORD *a1, _DWORD *a2, unsigned int a3, _DWORD *a4, _BYTE *a5)
{
  int v9; // ebx
...
LABEL_17:
  ...
  {
    *a5 = 1;
    return (unsigned int)sub_14072D380(a1, a2, a3, a4, 0);
  }
  else
  {
    v15 = -1073741772;
