/*
 * XREFs of RtlCreateAtomTableEx @ 0x14010AA70
 * Callers:
 *     RtlCreateAtomTable @ 0x1406B71F0 (RtlCreateAtomTable.c)
 * Callees:
 *     memset @ 0x1401D77C0 (memset.c)
 *     RtlpAllocateAtom @ 0x140695D74 (RtlpAllocateAtom.c)
 *     RtlpInitializeLockAtomTable @ 0x1406B720C (RtlpInitializeLockAtomTable.c)
