/*
 * XREFs of PfHardFaultLog @ 0x14012784C
 * Callers:
  ...
  if ( *a1 || a1[1] )
  {
    if ( a2 )
    {
      ...
      if ( a2 == 2 )
      {
        v10 = 627;
LABEL_13:
        result = (struct _KTHREAD *)EtwTraceSiloTimedEvent(Process[2].ActiveProcessors.Bitmap[3], v10, a3, (int)a1 + 32);
        goto LABEL_3;
      }
    }
    v10 = 544;
...
LABEL_3:
  if ( a1[8] )
  {
    if ( a2 != 2 )
    {
      ...
      v11[0] = 2 * v8;
      v11[1] = dword_140503750;
      v14 = a1[6];
      v12 = (unsigned int)(a1[4] >> 9);
      v13 = a1[5];
      v15 = v9 & 0x1FFFFFFFFFFFFFFFLL;
      return (struct _KTHREAD *)PfLogEvent(29, v7, v11, 0x28u);
    }
  }
  return result;
}
