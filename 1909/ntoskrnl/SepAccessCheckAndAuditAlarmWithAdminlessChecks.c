/*
 * XREFs of SepAccessCheckAndAuditAlarmWithAdminlessChecks @ 0x140622060
 * Callers:
 *     SepAccessCheckAndAuditAlarm @ 0x140621F9C (SepAccessCheckAndAuditAlarm.c)
 * Callees:
 ...
 *     SepFilterToDiscretionary @ 0x14000C48C (SepFilterToDiscretionary.c)
 ...
 *     RtlOwnerAcesPresent @ 0x140088370 (RtlOwnerAcesPresent.c)
 ...
 *     SepLpacCausedAccessFailure @ 0x140134CCC (SepLpacCausedAccessFailure.c)
        ...
        char a18)
{
  ...
  int Cap; // eax
  struct _RTL_DYNAMIC_HASH_TABLE_ENTRY *v93; // rdx
  char *v94; // r10
...
LABEL_223:
    ...
    if ( v90 )
    {
      ScopedPolicySid = SepGetScopedPolicySid((__int64)v90);
      if ( ScopedPolicySid )
      {
        Cap = SepRmReferenceFindCap(ScopedPolicySid, &v205);
        v93 = v205;
        if ( Cap < 0 )
          v93 = (struct _RTL_DYNAMIC_HASH_TABLE_ENTRY *)SepRmDefaultCap;
        v205 = v93;
        v26 = 0;
        v167 = 0;
        v172 = 1;
