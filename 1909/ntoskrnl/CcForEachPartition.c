/*
 * XREFs of CcForEachPartition @ 0x140123270
 * Callers:
 *     CcGetDirtyPages @ 0x140123230 (CcGetDirtyPages.c)
 ...
 *     CcCoalescingCallBack @ 0x14027C720 (CcCoalescingCallBack.c)
 *     CcIsThereDirtyData @ 0x14027D7E0 (CcIsThereDirtyData.c)
