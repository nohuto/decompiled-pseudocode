...
LABEL_58:
      ...
      else if ( !*((_DWORD *)ViDeadlockGlobals + 8196) && *((int *)ViDeadlockGlobals + 8282) <= 1024 )
      {
        ...
        VfReportIssueWithOptions(0xC4u, 0x1007uLL, (ULONG_PTR)a1, (ULONG_PTR)v21, v26, &dword_14042B960);
      }
      goto LABEL_59;
    }
    ViDeadlockPreprocessOptions(
      ...
      (const void *)0x1009);
    VfReportIssueWithOptions(0xC4u, 0x1009uLL, (ULONG_PTR)a1, *v21, v4, byte_14042B96C);
LABEL_59:
    v37 = v45;
