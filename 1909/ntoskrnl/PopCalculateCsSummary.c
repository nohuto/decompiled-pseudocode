...
__int64 __fastcall PopCalculateCsSummary(__int64 a1, int a2)
{
  ...
  LARGE_INTEGER v44[10]; // [rsp+D0h] [rbp+7h] BYREF
  ...
  v5 = InterruptTimePrecise - qword_140467B88;
  v6 = (InterruptTimePrecise - qword_140467B88) / 0xAuLL;
  ...
  if ( qword_140467BD8 )
  {
    if ( qword_140467B88 <= (unsigned __int64)qword_140467BD8 )
      v15 = InterruptTimePrecise - qword_140467BD8;
    else
      v15 = InterruptTimePrecise - qword_140467B88;
