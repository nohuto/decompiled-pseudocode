/*
 * XREFs of SepCreateTokenEx @ 0x14008714C
 * Callers:
 ...
 *     RtlIdentifierAuthoritySid @ 0x14061C7F4 (RtlIdentifierAuthoritySid.c)
    ...
    *((_QWORD *)v56 + 4) = v56 + 8;
    ...
    if ( v59 )
    {
      ...
      *((_QWORD *)v68 + 22) = 0LL;
      ...
      RtlSidHashInitialize(*((__int64 **)v68 + 19), *((_DWORD *)v68 + 31), (_QWORD *)v68 + 29);
      *((_QWORD *)v68 + 20) = 0LL;
      *((_DWORD *)v68 + 32) = 0;
