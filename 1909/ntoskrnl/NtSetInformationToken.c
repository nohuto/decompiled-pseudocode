/*
 * XREFs of NtSetInformationToken @ 0x140678810
 * Callers:
 *     <none>
 * Callees:
 ...
 *     SepRemoveAceFromTokenDefaultDacl @ 0x1401327DC (SepRemoveAceFromTokenDefaultDacl.c)
 ...
 *     SepIdAssignableAsOwner @ 0x1406CC8F8 (SepIdAssignableAsOwner.c)
            ...
            if ( !v35 )
            {
              ...
              if ( !v56 )
              {
                ...
                if ( (*((_DWORD *)Token + 50) & 0x20) == 0 )
                {
                  ...
                  v29 = SepStopReferencingLogonSession((__int64)v16);
                  v110 = v29;
                  if ( v29 < 0 )
                    goto LABEL_29;
                }
