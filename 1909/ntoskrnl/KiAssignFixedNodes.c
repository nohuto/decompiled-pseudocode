/*
 * XREFs of KiAssignFixedNodes @ 0x140A3BCF0
 * Callers:
  ...
  for ( k = 0; k < v7; ++k )
  {
    ...
    if ( (v17 & 8) != 0 )
    {
      if ( k >= a3 )
      {
        ...
        do
        {
          if ( *v22 >= (unsigned int)*(unsigned __int8 *)(v16 + 180) && *v21 < v18 )
          {
            v18 = *v21;
            v19 = v20;
          }
...
LABEL_22:
          ...
          if ( !*(_WORD *)(v16 + 146) )
          {
            ...
            *(_BYTE *)(v24 + 181) &= ~2u;
            --a6[v25];
            a5[v25] += *(unsigned __int8 *)(v24 + 180);
          }
        }
        else
        {
