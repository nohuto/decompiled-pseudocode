/*
 * XREFs of MiRemoveWsle @ 0x14004C5E0
 * Callers:
...
signed __int64 __fastcall MiRemoveWsle(__int64 a1, unsigned __int64 a2, __int64 a3, char a4, int a5, int a6)
{
  ...
  v52 = 0LL;
  if ( (*(_BYTE *)(a1 + 184) & 7) == 2 )
    v10 = (volatile signed __int64 *)&unk_140466F40;
  else
  ...
  if ( (*(_BYTE *)(a1 + 184) & 7) == 4 )
  {
    ...
    {
      LODWORD(xmmword_140464640) = xmmword_140464640 - a3;
    }
...
LABEL_17:
  *(_QWORD *)(a1 + 8LL * v18 + 40) += v20;
  ...
  v32 = *(_QWORD **)(qword_140465E88 + 8 * v30);
  v59 = v32[975];
