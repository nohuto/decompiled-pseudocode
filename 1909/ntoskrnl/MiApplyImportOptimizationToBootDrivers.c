/*
 * XREFs of MiApplyImportOptimizationToBootDrivers @ 0x1409F0318
 * Callers:
...
__int64 __fastcall MiApplyImportOptimizationToBootDrivers(__int64 a1)
{
  ...
  v1 = ((unsigned int)dword_1404645B0 >> 12) + ((dword_1404645B0 & 0xFFF) != 0);
    ...
    while ( v3 != v2 )
    {
      ...
      if ( v5 != PsNtosImageBase && v5 != PsHalImageBase && !(unsigned int)MI_IS_PHYSICAL_ADDRESS(v3[6]) )
      {
        ...
        if ( (MiFlags & 0x10000) != 0 )
        {
          memset(v9, 0, 0x68uLL);
          v9[1] = v5;
          updated = VslpEnterIumSecureMode(2, 221LL, 0LL, (__int64)v9);
        }
        else
        {
