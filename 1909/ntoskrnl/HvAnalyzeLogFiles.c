/*
 * XREFs of HvAnalyzeLogFiles @ 0x14083EF1C
 * Callers:
 ...
 *     HvpDetermineLatestLogFile @ 0x14083FABC (HvpDetermineLatestLogFile.c)
...
LABEL_59:
    if ( stru_140425BC0.LevelPlus1 > 5 && TlgKeywordOn(&stru_140425BC0, 0x400000000000uLL) )
      TlgWrite(&stru_140425BC0, &unk_14038C48F, 0LL, 0LL, 2u, &v92);
  ...
  while ( v36 < v33 );
  LevelPlus1 = stru_140425BC0.LevelPlus1;
  v45 = v80[2];
  v46 = DWORD2(v80[0]);
  if ( stru_140425BC0.LevelPlus1 > 5 )
  {
    ...
    v89 = 4LL;
    v91 = 4LL;
    TlgWrite(&stru_140425BC0, &unk_14038C432, 0LL, 0LL, 7u, &pData);
    LevelPlus1 = stru_140425BC0.LevelPlus1;
  }
  if ( v35 == 1 )
  {
...
LABEL_45:
  ...
  else
  {
    ...
    {
      if ( LevelPlus1 > 5 && TlgKeywordOn(&stru_140425BC0, 0x400000000000uLL) )
        TlgWrite(&stru_140425BC0, &unk_14038C405, 0LL, 0LL, 2u, &v92);
      v53 = v74;
      v54 = *((_QWORD *)v51 + 2);
