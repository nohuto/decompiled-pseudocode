/*
 * XREFs of SepAdtTokenRightAdjusted @ 0x1406786C0
 * Callers:
 ...
 *     SepAdtAuditablePrivilege @ 0x14031D718 (SepAdtAuditablePrivilege.c)
...
void __fastcall SepAdtTokenRightAdjusted(__int64 a1, char *a2, unsigned int a3, char *a4, unsigned int a5, char a6)
{
  ...
  if ( (unsigned __int8)SeAuditingWithTokenForSubcategory(138LL, PrimaryToken)
    && (SepAdtAuditablePrivilege(a2, v7) || SepAdtAuditablePrivilege(a4, a5)) )
  {
    ...
    if ( CurrentThreadProcess[1].ActiveProcessors.Bitmap[14] )
    {
      ...
      if ( (int)PsGetAllocatedFullProcessImageNameEx((__int64)CurrentThreadProcess, (__int64)&P) >= 0 )
      {
        ...
        if ( (_DWORD)v7 )
        {
          v22 = (int *)ExAllocatePoolWithTag(PagedPool, (unsigned int)(12 * v7) + 20LL, 0x70416553u);
          v10 = v22;
          if ( !v22 )
            goto LABEL_4;
          v22[1] = 1;
