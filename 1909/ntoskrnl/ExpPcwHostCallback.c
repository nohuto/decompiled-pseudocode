/*
 * XREFs of ExpPcwHostCallback @ 0x140785090
 * Callers:
 *     <none>
 * Callees:
 *     PsIsDiskCountersEnabled @ 0x14019ABE0 (PsIsDiskCountersEnabled.c)
 *     PcwRegister @ 0x14073CD80 (PcwRegister.c)
 *     EtwRegisterCounters @ 0x140785298 (EtwRegisterCounters.c)
