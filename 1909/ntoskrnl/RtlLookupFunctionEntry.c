/*
 * XREFs of RtlLookupFunctionEntry @ 0x14001A980
 * Callers:
        ...
        PUNWIND_HISTORY_TABLE HistoryTable)
{
  ...
  {
    HistoryTable->Once = 0;
    v31 = &RtlpUnwindHistoryTable[4 * (unsigned __int8)byte_14058A905];
  ...
  if ( !HistoryTable->Search )
    goto LABEL_18;
  if ( ControlPc >= qword_14058A910
    || ControlPc < qword_14058A908
...
LABEL_18:
    v33 = 0uLL;
    v34 = 0LL;
    if ( ControlPc < *((_QWORD *)&xmmword_140589020 + 1)
      || ControlPc >= *((_QWORD *)&xmmword_140589020 + 1) + (unsigned __int64)(unsigned int)qword_140589030 )
    {
      v16 = RtlpxLookupFunctionTable(ControlPc, &v33);
    }
    else
    {
      v16 = xmmword_140589020;
      v33 = xmmword_140589020;
      v34 = qword_140589030;
    }
    v17 = 0LL;
    if ( v16 )
