/*
 * XREFs of KiInitPrcb @ 0x1405A05CC
 * Callers:
 ...
 *     KiInitializeDpcList @ 0x14013DB60 (KiInitializeDpcList.c)
 *     KiIntSteerInitPrcb @ 0x14013DBC0 (KiIntSteerInitPrcb.c)
...
__int64 __fastcall KiInitPrcb(__int64 a1, int a2)
{
  ...
  *(_DWORD *)(a1 + 22752) = 1;
  ...
  if ( !a2 )
  {
    ...
    memset(&unk_140446DC4, 0, 0xA4uLL);
  }
