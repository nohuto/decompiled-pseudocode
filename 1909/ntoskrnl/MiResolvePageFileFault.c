/*
 * XREFs of MiResolvePageFileFault @ 0x1401634B8
 * Callers:
...
__int64 MiResolvePageFileFault(unsigned __int64 *a1, unsigned __int64 a2, ...)
{
  ...
  v14 = *(ULONG_PTR **)(qword_140465E88 + 8 * v13);
LABEL_6:
  v15 = 0LL;
  v144 = v14;
  v16 = v5;
  ...
  if ( v22 && *(_BYTE *)v17 == 4 )
  {
    ...
    v146 = v17;
    LODWORD(v143) = v18 | 8;
    v23 = *(ULONG_PTR **)(qword_140465E88 + 8LL * *(unsigned __int16 *)(*(_QWORD *)(v114 + 544) + 1454LL));
    v144 = v23;
  }
  else if ( ((v11 >> 5) & 0x1F) == 0x1F )
  {
    ...
    if ( v121 )
      v23 = *(ULONG_PTR **)(qword_140465E88 + 8LL * *(unsigned __int16 *)(v121 + 40));
    else
...
LABEL_67:
    ...
    v61 = a2;
    v62 = v11;
    if ( qword_140465800 && (v11 & 0x10) == 0 )
      v62 = v11 & ~qword_140465800;
...
LABEL_146:
  ...
  {
    v130 = updated;
    if ( qword_140465800 && (updated & 0x10) == 0 )
      v130 = updated & ~qword_140465800;
    v131 = v141 - v67;
    v132 = HIDWORD(v130);
    if ( v64 + 8 * v131 <= v61 )
    {
    ...
    if ( (v77 & 1) == 0 && (v77 & 0x400) == 0 && (v77 & 0x800) == 0 )
    {
      ...
      if ( qword_140465800 )
      {
        if ( (v77 & 0x10) != 0 )
          ...
          v80 = v77 & ~qword_140465800;
      }
      v81 = updated;
      if ( qword_140465800 && (updated & 0x10) == 0 )
        v81 = updated & ~qword_140465800;
