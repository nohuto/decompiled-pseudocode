/*
 * XREFs of CmpAddSubKeyEx @ 0x1406C4D40
 * Callers:
    ...
    if ( v11 )
    {
      ...
      if ( v13 != 26220 || v12[1] < 0x1FBu )
      {
        if ( ((v13 - 26732) & 0xFEFF) == 0 && v12[1] >= 0x3F5u )
        {
          ...
          v26 = 0LL;
          Cell = HvAllocateCell(BugCheckParameter2, 12, (unsigned int)v10, (__int64)&v26, (__int64)v27);
          if ( Cell == -1 )
          {
            v14 = 0;
            v12 = v26;
...
LABEL_7:
  ...
  v15 = HvAllocateCell(BugCheckParameter2, v20, (unsigned int)v10, (__int64)&v26, (__int64)v27);
  v12 = v26;
  Cell = v15;
  if ( v15 == -1 )
  {
