/*
 * XREFs of ExpSetTimer2 @ 0x14009A980
 * Callers:
 *     NtSetTimer2 @ 0x14009A960 (NtSetTimer2.c)
 *     NtCancelTimer2 @ 0x14013B8F0 (NtCancelTimer2.c)
 *     NtSetIRTimer @ 0x14013CEA0 (NtSetIRTimer.c)
 * Callees:
