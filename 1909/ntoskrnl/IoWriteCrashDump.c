/*
 * XREFs of IoWriteCrashDump @ 0x14029556C
 * Callers:
...
LABEL_11:
    ...
    ((void (__fastcall *)(__int64, _QWORD, _QWORD))qword_140468060)(1LL, 0LL, v37);
    VfDisableHalVerifier();
    LOBYTE(v16) = 1;
    v32 = ((__int64 (__fastcall *)(__int64))qword_140468090)(v16);
    ...
    *(_QWORD *)(CrashdmpDumpBlock + 1344) = v24 & 0xFFFFFFFFFFFFF000uLL;
    ...
    if ( v10 >= 0 )
      v10 = ((__int64 (__fastcall *)(__int64, __int64))qword_140468068)(CrashdmpDumpBlock, a8);
    if ( v10 != -1073741267 )
      goto LABEL_46;
    if ( (*(_DWORD *)(CrashdmpDumpBlock + 1368) & 4) != 0 )
    {
      ...
      if ( v10 < 0 )
        goto LABEL_46;
      v29 = ((__int64 (__fastcall *)(__int64, __int64))qword_140468068)(CrashdmpDumpBlock, a8);
      v30 = 38;
    }
    else
    {
