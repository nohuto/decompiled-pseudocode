/*
 * XREFs of PspCreatePicoProcess @ 0x1408C9F00
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall PspCreatePicoProcess(__int64 a1, __int64 a2, HANDLE *a3)
{
  ...
  if ( !v9 )
    goto LABEL_10;
  v8 = ObReferenceObjectByHandleWithTag(v9, 9u, (POBJECT_TYPE)SeTokenObjectType, 0, 0x72437350u, &v20, 0LL);
  if ( v8 >= 0 )
  {
    v7 = v20;
LABEL_10:
    ...
    if ( v15 >= 0 )
    {
      v8 = ObReferenceObjectByHandleWithTag(Handle, 0x80u, (POBJECT_TYPE)PsProcessType, 0, 0x72437350u, &v21, 0LL);
      if ( v8 >= 0 )
      {
        v17 = (volatile signed __int32 *)v21;
        PspLockProcessExclusive((__int64)v21, (__int64)CurrentThread);
        if ( (v17[195] & 8) != 0 )
        {
          v8 = -1073741558;
        }
        ...
        {
          _interlockedbittestandset(v17 + 194, 0xAu);
          v16 = 0LL;
          v7 = v20;
          v14 = Object;
          v17 = (volatile signed __int32 *)v21;
