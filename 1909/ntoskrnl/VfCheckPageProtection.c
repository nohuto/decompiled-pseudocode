 ...
 * Callers:
 *     VfCheckNxPageProtection @ 0x140327110 (VfCheckNxPageProtection.c)
...
void __fastcall VfCheckPageProtection(unsigned int a1, ULONG_PTR a2)
{
  if ( (MmVerifierData & 0x2000000) != 0 && (a1 & 0xF0) != 0 )
  {
    ViCiPreprocessOptions(
      ...
      (const void *)0x2001,
      a2);
    VfReportIssueWithOptions(0xC4u, 0x2001uLL, a2, a1, 0LL, byte_14042B870);
    if ( (MmVerifierData & 0x1000) != 0 )
      ViTargetIncrementCounter(a2, 268LL);
    _InterlockedIncrement(&dword_1404463B4);
  }
}
