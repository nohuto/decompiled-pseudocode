/*
 * XREFs of MiRelocateImageAgain @ 0x140648DF4
 * Callers:
...
__int64 __fastcall MiRelocateImageAgain(__int64 a1, int a2)
{
  ...
  {
    v11 = *(_QWORD *)(v6 + 32);
    v8 = MiReservePtes((__int64)&qword_1404666C0, (unsigned __int64 *)1);
    if ( !v8 )
    {
...
LABEL_13:
        ...
        if ( qword_140436480 )
        {
          updated = qword_140436480(*(_QWORD *)(v2 + 40) & 0xFFFFFFFFFFFFFFF8uLL);
          if ( updated >= 0 )
            goto LABEL_13;
        }
        else
...
LABEL_3:
  ...
  if ( v8 )
    MiReleasePtes((__int64)&qword_1404666C0, v8, 1u);
