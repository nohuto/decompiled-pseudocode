/*
 * XREFs of MiReplaceSystemProtoPtesNode @ 0x1402E1794
 * Callers:
...
LABEL_22:
  RtlAvlInsertNodeEx((unsigned __int64 *)&qword_140464438, (unsigned __int64)v7, v6, a2);
  a2[3] |= 8uLL;
