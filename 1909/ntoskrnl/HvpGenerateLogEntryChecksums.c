/*
 * XREFs of HvpGenerateLogEntryChecksums @ 0x14064124C
 * Callers:
 ...
 *     SymCryptMarvin32Init @ 0x1401BA96C (SymCryptMarvin32Init.c)
 *     SymCryptMarvin32Result @ 0x1401BA988 (SymCryptMarvin32Result.c)
