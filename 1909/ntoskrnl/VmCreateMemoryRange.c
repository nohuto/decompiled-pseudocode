/*
 * XREFs of VmCreateMemoryRange @ 0x1408ECBF0
 * Callers:
 *     <none>
 * Callees:
 ...
 *     VmpValidateMemoryRangeParameters @ 0x1408ED8EC (VmpValidateMemoryRangeParameters.c)
 */
...
__int64 __fastcall VmCreateMemoryRange(unsigned __int64 a1, unsigned __int64 a2, __int64 a3, __int64 a4, __int64 a5)
{
  ...
  if ( !VmTbFlushEnabled )
    VmTbFlushEnabled = 1;
  v11 = Process[2].ActiveProcessors.Bitmap[19];
  if ( !v11 )
  {
    ...
    *(_QWORD *)(v11 + 48) = 0LL;
    *(_QWORD *)(v11 + 56) = 0LL;
    if ( _InterlockedCompareExchange64((volatile signed __int64 *)&Process[2].ActiveProcessors.Bitmap[19], v11, 0LL) )
    {
