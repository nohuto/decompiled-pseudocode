/*
 * XREFs of RaspScanConvert @ 0x140183DC0
 * Callers:
 *     RaspRasterize @ 0x140183B00 (RaspRasterize.c)
 * Callees:
 *     BgpFmRoundUp @ 0x1401796B0 (BgpFmRoundUp.c)
 ...
 *     RaspTestIntersection @ 0x140184220 (RaspTestIntersection.c)
 *     RaspRectangleCreate @ 0x14018462C (RaspRectangleCreate.c)
        ...
        _QWORD *a8)
{
  ...
  if ( SegmentList >= 0 )
  {
    ...
    if ( v10 )
    {
      v32 = qword_140A65880;
      v63 = qword_140A65880;
      v14 = BgpGxInitializeRectangle(v64, 1LL, qword_140A65880, 3140LL);
      if ( v14 < 0 )
        goto LABEL_31;
    }
    else
