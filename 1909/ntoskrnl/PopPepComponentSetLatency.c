/*
 * XREFs of PopPepComponentSetLatency @ 0x1402F8C60
 * Callers:
 *     PoFxSetComponentLatency @ 0x1402F1BE0 (PoFxSetComponentLatency.c)
 * Callees:
 ...
 *     PopPepComponentGetLatencyIdleState @ 0x140192484 (PopPepComponentGetLatencyIdleState.c)
 */
