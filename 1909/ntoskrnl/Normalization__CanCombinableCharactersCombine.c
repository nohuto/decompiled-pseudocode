/*
 * XREFs of Normalization__CanCombinableCharactersCombine @ 0x1408D5F5C
 * Callers:
 ...
 *     Normalization__CanCombineWithStartBase @ 0x1408D60C0 (Normalization__CanCombineWithStartBase.c)
 *     Normalization__CanCombineWithStartFirstPair @ 0x1408D610C (Normalization__CanCombineWithStartFirstPair.c)
 *     Normalization__IsNormalized @ 0x1408D64F4 (Normalization__IsNormalized.c)
