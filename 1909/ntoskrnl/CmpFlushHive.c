/*
 * XREFs of CmpFlushHive @ 0x14063725C
 * Callers:
...
__int64 __fastcall CmpFlushHive(ULONG_PTR BugCheckParameter2, unsigned int a2)
{
  ...
  *(_QWORD *)&pData.Size = 0LL;
  ...
  if ( stru_140425BC0.LevelPlus1 > 4 )
  {
    ...
    v70[1] = 0;
    v72 = 4LL;
    TlgWrite(&stru_140425BC0, &unk_14038BC6C, 0LL, 0LL, 7u, UserData);
  }
...
LABEL_118:
  ...
  if ( stru_140425BC0.LevelPlus1 > 4 )
  {
    ...
    v63 = 4LL;
    v65 = 4;
    TlgWrite(&stru_140425BC0, &unk_14038BC21, 0LL, 0LL, 4u, UserData);
  }
  if ( (Ptr & 0x358) == 0 )
    goto LABEL_87;
  if ( (Ptr & 2) == 0 )
...
LABEL_70:
  ...
  if ( stru_140425BC0.LevelPlus1 > 4 )
  {
    ...
    v60 = 4LL;
    TlgWrite(&stru_140425BC0, &unk_14038BBFE, 0LL, 0LL, 3u, &pData);
  }
