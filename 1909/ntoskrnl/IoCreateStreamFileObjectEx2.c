/*
 * XREFs of IoCreateStreamFileObjectEx2 @ 0x1406A0820
 * Callers:
 *     IoCreateStreamFileObjectLite @ 0x1406A07E0 (IoCreateStreamFileObjectLite.c)
 *     IoCreateStreamFileObject @ 0x14072E590 (IoCreateStreamFileObject.c)
 *     IoCreateStreamFileObjectEx @ 0x14073D080 (IoCreateStreamFileObjectEx.c)
 * Callees:
...
LABEL_8:
  ...
  *((_QWORD *)v9 + 24) = v9 + 192;
  if ( v5 )
  {
    ...
    v11 = (struct _SLIST_ENTRY *)*((_QWORD *)v9 - 2);
