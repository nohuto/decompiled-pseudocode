/*
 * XREFs of EtwpTraceSystemShutdown @ 0x1408F54C4
 * Callers:
...
char EtwpTraceSystemShutdown()
{
  ...
  {
    result = TlgKeywordOn(&stru_140426650, 0x400000000000uLL);
    if ( result )
    {
      v8 = 0;
      v11 = 0;
      ...
      v7 = 4;
      v10 = 8;
      result = TlgWrite(&stru_140426650, &unk_14039397A, 0LL, 0LL, 4u, &pData);
    }
  }
