/*
 * XREFs of HvUnCOWReconciledPages @ 0x140119ED8
 * Callers:
 *     CmpFlushHive @ 0x14063725C (CmpFlushHive.c)
 * Callees:
 *     RtlMergeBitMaps @ 0x14011A1E4 (RtlMergeBitMaps.c)
 *     HvpViewMapUnCOWAndSealRange @ 0x1406C2350 (HvpViewMapUnCOWAndSealRange.c)
 */
...
LABEL_26:
          ...
          if ( v19 != (_DWORD *)v9 && (*v19 | dword_14037C900[v11 & 0x1F]) == -1 )
          {
            v11 = v11 - (v11 & 0x1F) + 32;
          ...
          {
            v21 = v11 & 0x1F;
            if ( (*v19 & ~dword_14037C900[v11 & 0x1F]) == 0 )
              break;
          }
LABEL_44:
