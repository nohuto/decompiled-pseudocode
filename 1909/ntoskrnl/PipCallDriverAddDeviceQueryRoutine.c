/*
 * XREFs of PipCallDriverAddDeviceQueryRoutine @ 0x140735D04
 * Callers:
 ...
 *     PnpIsLegacyDriver @ 0x140736274 (PnpIsLegacyDriver.c)
...
LABEL_36:
    ...
    if ( !v14 )
    {
      ServiceStartType = PnpGetServiceStartType(DestinationString.Buffer, v12, &v37);
      v20 = v37;
