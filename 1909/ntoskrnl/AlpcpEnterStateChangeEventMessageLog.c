/*
 * XREFs of AlpcpEnterStateChangeEventMessageLog @ 0x140885278
 * Callers:
 ...
 *     AlpcpAllocateSnapshotMessageLog @ 0x140885034 (AlpcpAllocateSnapshotMessageLog.c)
