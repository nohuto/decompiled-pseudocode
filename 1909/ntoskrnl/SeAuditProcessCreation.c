/*
 * XREFs of SeAuditProcessCreation @ 0x14074A0D0
 * Callers:
...
void __fastcall SeAuditProcessCreation(struct _KPROCESS *BugCheckParameter1, unsigned __int16 *a2)
{
  ...
  PUNICODE_STRING v21; // [rsp+40h] [rbp-C0h] BYREF
  ...
  struct _SINGLE_LIST_ENTRY *v28; // [rsp+80h] [rbp-80h]
  ...
  *(_QWORD *)&DestinationString.Length = 0LL;
  ...
  v28 = Next;
  ProcessImageName = SeLocateProcessImageName(BugCheckParameter1, (PUNICODE_STRING *)&NumberOfBytes[1]);
  if ( ProcessImageName >= 0 )
  {
    ...
    else
    {
      ...
      if ( Process[1].ActiveProcessors.Bitmap[14] )
        SeLocateProcessImageName(Process, &v21);
      else
        v5 = 1844;
    ...
    if ( v9 )
    {
      ...
      if ( (unsigned int)v13 >= *((_DWORD *)v10 + 31) )
        ...
        ProcessImageName = RtlCopySid(0x44u, DestinationSid, *(PSID *)(v10[19] + 16 * v13));
...
LABEL_16:
        ...
        v16 = *((_QWORD *)SubjectContext.PrimaryToken + 3) != __PAIR64__(HIDWORD(v26), v14);
    ...
    {
      ProcessImageName = -1073741700;
    }
    v3 = 0;
  }
  SepAuditFailed((unsigned int)ProcessImageName);
LABEL_21:
