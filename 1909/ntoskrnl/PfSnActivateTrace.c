/*
 * XREFs of PfSnActivateTrace @ 0x14012EA30
 * Callers:
...
__int64 __fastcall PfSnActivateTrace(__int64 a1)
{
  ...
  {
    *(_WORD *)(a1 + 486) |= 2u;
    v2 = KeAcquireSpinLockRaiseToDpc(&qword_1404679D0);
    v3 = PfSnAddProcessTrace(*(_QWORD *)(a1 + 352), a1);
    if ( v3 >= 0 )
    {
      v4 = (_QWORD *)qword_1404679C8;
      v5 = (_QWORD *)(a1 + 8);
      if ( *(__int64 **)qword_1404679C8 != &PfSnGlobals )
        __fastfail(3u);
      ++PfSnNumActiveTraces;
      *v5 = &PfSnGlobals;
      v3 = 0;
