/*
 * XREFs of KeInitializeClock @ 0x1409FCFBC
 * Callers:
 ...
 *     KiSetupTimeIncrement @ 0x14018ADC0 (KiSetupTimeIncrement.c)
...
LABEL_34:
      ...
      dword_14044CFF0 = KeTimeIncrement;
      dword_14044CFF4 = KeTimeIncrement;
      result = KiLastRequestedTimeIncrement;
      dword_14044CFF8 = KiLastRequestedTimeIncrement;
      dword_14044CFFC = KiLastRequestedTimeIncrement;
    }
    else
    {
      if ( (_DWORD)v3 != 2 )
