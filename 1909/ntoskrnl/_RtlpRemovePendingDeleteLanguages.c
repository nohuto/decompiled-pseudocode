/*
 * XREFs of _RtlpRemovePendingDeleteLanguages @ 0x14018E6A4
 * Callers:
 ...
 *     RtlpMuiRegGetInstalledLanguageIndexByName @ 0x140945080 (RtlpMuiRegGetInstalledLanguageIndexByName.c)
 */
        ...
        if ( v10 + 24 < 0x1FE )
        {
          *(_WORD *)(((unsigned __int64)v13 & 0xFFFFFFFFFFFFFFE0uLL) + 0x30 + 2 * (v10 >> 1)) = 0;
                      ...
                      (unsigned __int64)v13 & 0xFFFFFFFFFFFFFFE0uLL) >= 0 )
          {
            ...
            if ( *v2 != -1 && v11 != a2 )
            {
              *(_WORD *)(28LL * v11 + *(_QWORD *)(*(_QWORD *)(a1 + 24) + 16LL)) &= ~0x20u;
