/*
 * XREFs of PopPowerAggregatorExecuteState @ 0x1408B22EC
 * Callers:
...
LABEL_16:
  ...
  if ( DWORD1(xmmword_14043912C) == v8 )
  {
  ...
  else
  {
    ...
    DWORD1(xmmword_14043912C) = v8;
    LODWORD(xmmword_14043912C) = v10;
    PopReleaseRwLock((ULONG_PTR)&PopPowerAggregatorLock);
    if ( qword_14046BB30 )
      qword_14046BB30(*v11);
