...
LONG PopNewWakeInfo()
{
  ...
  if ( v1 )
  {
    ...
    {
      v7 = (_QWORD *)qword_140443E88;
      v8 = *(_QWORD **)(qword_140443E88 + 8);
      if ( *(__int64 **)qword_140443E88 == &PopWakeInfoList && *v8 == qword_140443E88 )
      {
        qword_140443E88 = *(_QWORD *)(qword_140443E88 + 8);
        *v8 = &PopWakeInfoList;
        v7[1] = v7;
        *v7 = v7;
