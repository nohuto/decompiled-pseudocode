/*
 * XREFs of MiDereferenceIoPages @ 0x1400F55EC
 * Callers:
...
void __fastcall MiDereferenceIoPages(int a1, __int64 a2, ULONG_PTR a3)
{
  ...
  v7 = a3;
  i = (unsigned __int64 *)&qword_140466488[a1];
  v39 = i;
  v9 = &qword_140466498;
  if ( a1 != 1 )
    v9 = 0LL;
  v40 = v9;
  v10 = ExAcquireSpinLockExclusive(&dword_140466480);
  v41 = v10;
LABEL_4:
    ...
    if ( v40 )
    {
      ...
      *((_DWORD *)v17 + 14) = KiCacheFlushTimeStamp;
      if ( (__int64 *)qword_1404664A0 == &qword_1404664A0 )
        dword_1404664B0 = v31;
      v32 = (_QWORD *)qword_1404664A8;
      v33 = v17 + 3;
      if ( *(__int64 **)qword_1404664A8 != &qword_1404664A0 )
        __fastfail(3u);
      *v33 = &qword_1404664A0;
      v34 = 0;
      v17[4] = (unsigned __int64)v32;
      *v32 = v33;
      qword_1404664A8 = (__int64)(v17 + 3);
      v35 = (_QWORD *)*v25;
      if ( *v25 )
      {
        while ( 1 )
