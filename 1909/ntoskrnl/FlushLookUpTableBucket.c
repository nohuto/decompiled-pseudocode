/*
 * XREFs of FlushLookUpTableBucket @ 0x140112EBC
 * Callers:
 ...
 *     FlattenEventEntryTree @ 0x1401132C4 (FlattenEventEntryTree.c)
...
LABEL_36:
  ...
  if ( v12 && ($C6908ADE9723D0A04AF8EE82D8D15C40 *)v17->ApcState.ApcListHead[0].Flink != &v17->152 )
    KiCheckForKernelApcDelivery(1LL);
