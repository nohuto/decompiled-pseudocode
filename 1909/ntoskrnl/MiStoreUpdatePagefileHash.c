/*
 * XREFs of MiStoreUpdatePagefileHash @ 0x14014D5C0
 * Callers:
  ...
  if ( a4 )
  {
    do
    {
      ...
      else
      {
        ...
        if ( !v9 )
        {
          result = qword_140465E88;
          v9 = *(_QWORD *)(qword_140465E88 + 8 * ((*(_QWORD *)(v17 + 40) >> 40) & 0x3FFLL));
        }
      }
      if ( v12 == v14 && v18 == v8 )
      {
      ...
      {
        if ( v12 != 16 )
          result = MiMapPageFileHash(*(_QWORD *)(v9 + 8LL * v12 + 7904), v11, v10 - v7, v5, v7);
        v5 = v18;
        v12 = v14;
        v22 = v18;
        v8 = v18;
    ...
    while ( v10 < a4 );
    if ( v12 != 16 )
      return MiMapPageFileHash(*(_QWORD *)(v9 + 8LL * v12 + 7904), a3, v10 - v7, v5, v7);
  }
  return result;
}
