/*
 * XREFs of RtlNumberOfSetBitsInRangeEx @ 0x14030D920
 * Callers:
 *     <none>
 * Callees:
 *     <none>
...
__int64 __fastcall RtlNumberOfSetBitsInRangeEx(unsigned __int64 *a1, unsigned __int64 a2, unsigned __int64 a3)
{
  ...
  v9 = (char *)((a2 >> 3) + a1[1]);
  if ( a2 >> 3 == v6 )
    return RtlpBitsClearTotal[(unsigned __int8)~(*v9 & byte_140381050[v7] & byte_140382448[v8 + 1])];
  if ( (((unsigned __int8)a3 | (unsigned __int8)a2) & 0x3F) != 0 )
  {
    if ( (a2 & 7) != 0 )
    {
      v13 = *v9++;
      ++v5;
      v4 = RtlpBitsClearTotal[(unsigned __int8)~(v13 & byte_140381050[v7])];
    }
    v14 = 8 - (v5 & 7);
    ...
    return v4 + RtlpBitsClearTotal[(unsigned __int8)~(*v9 & byte_140382448[v8 + 1])];
  }
  else
  {
    if ( a3 )
