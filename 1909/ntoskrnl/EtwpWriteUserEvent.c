/*
 * XREFs of EtwpWriteUserEvent @ 0x140656DC0
 * Callers:
 ...
 *     DecodeProviderTraits @ 0x1400C9A0C (DecodeProviderTraits.c)
 *     EtwpReleaseTraceBuffer @ 0x1400C9A50 (EtwpReleaseTraceBuffer.c)
 *     EtwpIsEventNameFilterEnabled @ 0x1400C9A94 (EtwpIsEventNameFilterEnabled.c)
 *     EtwpCreateEventKey @ 0x1400C9AB0 (EtwpCreateEventKey.c)
 ...
 *     EtwpApplyEventIdPayloadFilterOnUserEvent @ 0x1408FE684 (EtwpApplyEventIdPayloadFilterOnUserEvent.c)
 *     EtwpApplyLevelKwFilter @ 0x1408FE798 (EtwpApplyLevelKwFilter.c)
 *     EtwpApplyStackWalkFilterOnUserEvent @ 0x1408FE9CC (EtwpApplyStackWalkFilterOnUserEvent.c)
...
LABEL_218:
  ...
  if ( v28
    && ($C6908ADE9723D0A04AF8EE82D8D15C40 *)v117->ApcState.ApcListHead[0].Flink != &v117->152
