/*
 * XREFs of MiCheckProtoPtePageState @ 0x1400549A0
 * Callers:
...
LABEL_26:
  ...
  v20 = (v18 >> 40) & 0x3FF;
  v21 = *(ULONG_PTR **)(qword_140465E88 + 8 * v20);
  if ( v19 && !(unsigned int)MiChargeCommit(*(_QWORD *)(qword_140465E88 + 8 * v20), 1uLL, 4u) )
    goto LABEL_20;
