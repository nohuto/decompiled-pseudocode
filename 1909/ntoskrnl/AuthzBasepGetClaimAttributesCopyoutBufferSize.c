/*
 * XREFs of AuthzBasepGetClaimAttributesCopyoutBufferSize @ 0x14092C360
 * Callers:
 *     AuthzBasepQueryClaimAttributesToken @ 0x1406D122C (AuthzBasepQueryClaimAttributesToken.c)
 * Callees:
 *     AuthzBasepGetClaimAttributeValueCopyoutBufferSize @ 0x14092C1BC (AuthzBasepGetClaimAttributeValueCopyoutBufferSize.c)
 */
