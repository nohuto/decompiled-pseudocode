/*
 * XREFs of MiProbeLockFrame @ 0x1400CC670
 * Callers:
 ...
 *     ExAcquireRundownProtectionCacheAware @ 0x140104630 (ExAcquireRundownProtectionCacheAware.c)
...
LABEL_11:
      ...
      v11 = (v6 >> 40) & 0x3FF;
      v12 = *(ULONG_PTR **)(qword_140465E88 + 8 * v11);
      if ( v9 && !(unsigned int)MiChargeCommit(*(_QWORD *)(qword_140465E88 + 8 * v11), 1uLL, 8u) )
        goto LABEL_74;
...
LABEL_20:
  ...
  {
    *(_BYTE *)(*(_QWORD *)(qword_140465E88 + 8 * ((*(_QWORD *)(v3 + 40) >> 40) & 0x3FFLL)) + 667LL) = 1;
  }
  v16 = *(_BYTE *)(v3 + 34);
  ...
  v22 = v21 >> 40;
  if ( (v22 & 0x3FF) != 0 )
    ExAcquireRundownProtectionCacheAware(*(PEX_RUNDOWN_REF_CACHE_AWARE *)(*(_QWORD *)(qword_140465E88 + 8 * (v22 & 0x3FF))
                                                                        + 2080LL));
  return 0LL;
}
