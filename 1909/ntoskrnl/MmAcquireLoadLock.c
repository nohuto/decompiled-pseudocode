/*
 * XREFs of MmAcquireLoadLock @ 0x1406A5B70
 * Callers:
...
struct _KTHREAD *MmAcquireLoadLock()
{
  ...
  if ( CurrentThread == (struct _KTHREAD *)qword_1404645D8 )
  {
    ++dword_1404645E0;
  }
  else
  {
    ...
    ExAcquirePushLockExclusiveEx((ULONG_PTR)&qword_1404645D0, 0LL);
    qword_1404645D8 = (__int64)CurrentThread;
    dword_1404645E0 = 1;
  }
