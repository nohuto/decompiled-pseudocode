/*
 * XREFs of KeConnectInterrupt @ 0x14017C9BC
 * Callers:
...
__int64 __fastcall KeConnectInterrupt(__int64 *a1, unsigned __int8 a2, __int64 a3)
{
  ...
  if ( v6 )
  {
    if ( ((int (__fastcall *)(__int64, unsigned int *))off_140424620[0])(v4 + 8, &v24) < 0 )
      return 295;
    v23 = IsInterruptTypeSecondary
        ? KiUnmaskSecondaryInterruptInternal(*(unsigned int *)(*a1 + 88), v24, v21, v22)
        : ((__int64 (__fastcall *)(_QWORD, _QWORD))off_1404244B8[0])(v24, 0LL);
    v11 = v23;
    if ( v23 >= 0 )
      return 295;
LABEL_34:
