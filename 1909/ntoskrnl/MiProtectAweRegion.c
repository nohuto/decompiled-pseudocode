/*
 * XREFs of MiProtectAweRegion @ 0x1402D6EE4
 * Callers:
 ...
 *     MiGetVadCacheAttribute @ 0x1402E5334 (MiGetVadCacheAttribute.c)
 */
      ...
      if ( a3 == 24 )
      {
        ...
        if ( v21 != 512 )
        {
          if ( MiPteInShadowRange(v11) )
          {
            ...
            {
              v45 = v42;
              if ( !HIBYTE(word_1404658EC) && ((unsigned __int8)ValidPte & (unsigned __int8)v42) != 0 )
