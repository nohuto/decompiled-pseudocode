/*
 * XREFs of EtwpLogKernelEvent @ 0x1400A2990
 * Callers:
 ...
 *     EtwpTraceKernelEventWithFilter @ 0x14032F7EC (EtwpTraceKernelEventWithFilter.c)
 ...
 *     EtwpSystemImageEnumCallback @ 0x14071B250 (EtwpSystemImageEnumCallback.c)
