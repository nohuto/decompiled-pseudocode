/*
 * XREFs of PopSpoilBatteryEstimate @ 0x1407305F4
 * Callers:
 *     PopSpoilEstimatesOnPowerStateTransitionWorker @ 0x14072B2F0 (PopSpoilEstimatesOnPowerStateTransitionWorker.c)
...
ULONG __fastcall PopSpoilBatteryEstimate(int a1, unsigned __int8 a2)
{
  ...
  if ( a1 < 2 )
  {
    ...
    if ( pCallbackContext.LevelPlus1 > 5 )
    {
      ...
      v11 = 4;
      v14 = 4;
      return TlgWrite(&pCallbackContext, &unk_14038EDCD, 0LL, 0LL, 4u, &pData);
    }
  }
  return result;
}
