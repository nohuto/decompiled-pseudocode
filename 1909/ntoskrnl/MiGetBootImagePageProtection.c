/*
 * XREFs of MiGetBootImagePageProtection @ 0x140187820
 * Callers:
...
__int64 __fastcall MiGetBootImagePageProtection(unsigned int a1, __int64 a2, __int64 a3, _QWORD *a4)
{
  ...
  if ( a1 < v10 + v11 )
  {
    v12 = MiComputeDriverProtection(0LL, (unsigned int)v6[9]);
  }
  else
  {
LABEL_9:
    ...
    while ( v14 < v15 )
    {
      if ( a1 < *(_DWORD *)(v14 + 12) )
        goto LABEL_7;
      v16 = MiComputeDriverProtection(0LL, *(unsigned int *)(v14 + 36));
      v5 = v17;
      v12 = v16;
      v14 = v17 + 40;
    }
