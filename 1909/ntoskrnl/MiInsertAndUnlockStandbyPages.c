/*
 * XREFs of MiInsertAndUnlockStandbyPages @ 0x140026300
 * Callers:
    ...
    do
    {
      ...
      else
      {
        if ( (v15 & 8) != 0 )
          ...
          v16 = v15 & 7;
        if ( !v9 )
          v9 = *(_QWORD *)(qword_140465E88 + 8LL * ((HIDWORD(v14) >> 8) & 0x3FF));
        if ( v16 != v10 || v9 != *(_QWORD *)(qword_140465E88 + 8 * ((v14 >> 40) & 0x3FF)) )
        {
          if ( v10 != 0xFFFFFF )
          {
            KeReleaseInStackQueuedSpinLockFromDpcLevel(&LockHandle);
          ...
          v10 = v16;
          v9 = *(_QWORD *)(qword_140465E88 + 8 * ((v14 >> 40) & 0x3FF));
