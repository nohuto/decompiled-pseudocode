/*
 * XREFs of CmpInitializePreloadedHive @ 0x140A0DDBC
 * Callers:
...
LABEL_31:
  ...
  *(_DWORD *)(v14 + 160) |= v4 | 0x400;
  ...
  v18 = (_QWORD *)qword_140463968;
  v19 = (_QWORD *)(v14 + 1616);
  if ( *(__int64 **)qword_140463968 != &CmpPreloadedHivesList )
    __fastfail(3u);
  v19[1] = qword_140463968;
  *v19 = &CmpPreloadedHivesList;
  *v18 = v19;
  result = 0LL;
  qword_140463968 = (__int64)v19;
  return result;
}
