/*
 * XREFs of ?StDmpSinglePageRetrieve@?$ST_STORE@USM_TRAITS@@@@SAJPEAU_ST_DATA_MGR@1@PEAU_STDM_READ_CONTEXT@1@PEAU_ST_IO_PARAMS@1@PEAXPEAU_ST_PAGE_LOCATION@1@@Z @ 0x1401620CC
 * Callers:
 ...
 *     ?StDmpSinglePageLookup@?$ST_STORE@USM_TRAITS@@@@SAJPEAU_ST_DATA_MGR@1@PEAU_STDM_READ_CONTEXT@1@PEAU_ST_IO_PARAMS@1@PEAPEAU_ST_PAGE_RECORD@1@@Z @ 0x1401625E4 (-StDmpSinglePageLookup@-$ST_STORE@USM_TRAITS@@@@SAJPEAU_ST_DATA_MGR@1@PEAU_STDM_READ_CONTEXT@1@P.c)
 *     ?SmStMapPhysicalRegion@?$SMKM_STORE@USM_TRAITS@@@@SAPEAXPEAU1@KKKK@Z @ 0x14031FEF0 (-SmStMapPhysicalRegion@-$SMKM_STORE@USM_TRAITS@@@@SAPEAXPEAU1@KKKK@Z.c)
        ...
        __int64 a5)
{
  ...
  {
    v9 = ST_STORE<SM_TRAITS>::StDmpSinglePageLookup(a1, a2, a3, v30);
    if ( v9 < 0 )
  ...
  *(_QWORD *)(a2 + 56) = a3;
  ...
  if ( v7 )
  {
    ...
    else
    {
      ...
      v27 = (struct _MDL *)(v25 & 0xFFFFFFFFFFFFFFF8uLL);
      *(_QWORD *)(v24 + 8 * v12) = v26;
      if ( (v26 & 3) == 0 )
        SmFpFree(v22 + 6592, 5, (__int64)KeGetCurrentThread(), v27);
    }
  }
LABEL_22:
  if ( v8 )
