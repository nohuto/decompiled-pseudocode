/*
 * XREFs of MiMapHotPatchImageInSystemSpace @ 0x14088F8AC
 * Callers:
...
__int64 __fastcall MiMapHotPatchImageInSystemSpace(_QWORD *a1)
{
  ...
  if ( Mdl )
  {
    ...
    if ( v9 )
    {
      ...
      {
        ++v10;
        v11->Next = (struct _MDL *)qword_140466558;
    ...
    v18 = MiReservePtes((__int64)&qword_1404666C0, (unsigned __int64 *)(unsigned int)v3);
    if ( v18 )
    {
