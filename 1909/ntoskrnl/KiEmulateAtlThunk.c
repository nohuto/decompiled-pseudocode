/*
 * XREFs of KiEmulateAtlThunk @ 0x1402B68A0
 * Callers:
 *     KiCheckForAtlThunk @ 0x1402B3464 (KiCheckForAtlThunk.c)
 * Callees:
...
__int64 __fastcall KiEmulateAtlThunk(unsigned int *a1, _DWORD *a2, unsigned int *a3, unsigned int *a4, _DWORD *a5)
{
  ...
  v23 = (unsigned int)*a2;
  v22 = 0;
  v11 = (_WORD *)&KeGetPcr()->NtTib.$9D9B0EC91357685197870F19570BC36A::$178D88066840D12B034B909BF2D1FA47::Self[218].SubSystemTib
      + 1;
  if ( (*v11 & 1) != 0 )
  {
    v12 = 1;
