/*
 * XREFs of PpmEventTraceSoftCoreParkingSelection @ 0x1401C0254
 * Callers:
  ...
  if ( PpmEtwRegistered )
  {
    ...
    if ( (_BYTE)v10 )
    {
      ...
      *(_QWORD *)&UserData.Size = 2LL;
      ...
      v47 = 1LL;
      v49 = 4LL;
      LOBYTE(v10) = EtwWrite(v13, &PPM_ETW_SOFT_PARKING_SELECTION, 0LL, 0xEu, &UserData);
    }
  }
  return (char)v10;
}
