/*
 * XREFs of CmpCopyValue @ 0x140835E48
 * Callers:
...
__int64 __fastcall CmpCopyValue(__int64 a1, __int64 a2, ULONG_PTR a3, unsigned int a4)
{
  ...
  __int64 v23; // rax
  unsigned int Size; // [rsp+40h] [rbp-20h] BYREF
  unsigned int Size_4; // [rsp+44h] [rbp-1Ch] BYREF
...
LABEL_14:
  ...
  else
  {
    v27[1] = 0;
    v27[0] = -1;
    ValueData = CmpGetValueData(a1, v30, v9, &Size, (__int64)&P, (__int64)&v29, (__int64)v27);
    v16 = a3;
    if ( !ValueData )
    {
LABEL_13:
    ...
    v18 = P;
    v12 = Size;
    if ( (int)CmpSetValueDataNew(a3, (char *)P, Size, v31, &Size_4) < 0 )
    {
      if ( (_BYTE)v29 == 1 )
