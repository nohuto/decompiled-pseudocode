/*
 * XREFs of CcAddExternalCache @ 0x140171BE4
 * Callers:
...
__int64 __fastcall CcAddExternalCache(__int64 a1)
{
  ...
  v3 = (_QWORD *)qword_140463B38;
  v4 = (_QWORD *)(a1 + 32);
  if ( *(__int64 **)qword_140463B38 != &CcExternalCacheList )
    __fastfail(3u);
  v4[1] = qword_140463B38;
  *v4 = &CcExternalCacheList;
  *v3 = v4;
  qword_140463B38 = (__int64)v4;
