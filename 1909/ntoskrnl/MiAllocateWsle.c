/*
 * XREFs of MiAllocateWsle @ 0x1400AE730
 * Callers:
 ...
 *     MiFillVirtualFaultInfo @ 0x1402D2544 (MiFillVirtualFaultInfo.c)
 *     MiGetVirtualFaultPageInfo @ 0x1402D279C (MiGetVirtualFaultPageInfo.c)
 *     MiGetAggregationVm @ 0x1402D8B58 (MiGetAggregationVm.c)
 */
...
__int64 __fastcall MiAllocateWsle(__int64 a1, unsigned __int64 a2, _QWORD *a3, int a4, __int64 a5, char a6, __int64 a7)
{
  ...
  if ( (a6 & 1) != 0 )
  {
    ...
    v36 = *(_QWORD *)(qword_140465E88 + 8 * ((*(_QWORD *)(v34 + 40) >> 40) & 0x3FFLL));
