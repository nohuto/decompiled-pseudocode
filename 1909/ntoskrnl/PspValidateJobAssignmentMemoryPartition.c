/*
 * XREFs of PspValidateJobAssignmentMemoryPartition @ 0x140688EBC
 * Callers:
...
bool __fastcall PspValidateJobAssignmentMemoryPartition(__int64 a1, __int64 a2, __int64 a3, int a4)
{
  ...
  if ( a4 == 4 )
  {
    if ( *(_QWORD *)(a1 + 1056) == a1 + 1056
      && !*(_QWORD *)(a1 + 1544)
      && *(_QWORD *)(a3 + 952)
      && *(_QWORD *)(*(_QWORD *)(a3 + 952) + 1544LL)
      && *(_QWORD *)(*(_QWORD *)(a3 + 952) + 1544LL) != -1LL
      && *(_QWORD *)(*(_QWORD *)(a3 + 952) + 1544LL) != *(_QWORD *)(a3 + 2136) )
    {
      return 0;
    }
LABEL_3:
