/*
 * XREFs of PopIrpWorker @ 0x14017B5B0
 * Callers:
 *     <none>
 * Callees:
 ...
 *     PopFxGetDeviceDStateReason @ 0x14017BC58 (PopFxGetDeviceDStateReason.c)
...
NTSTATUS __fastcall PopIrpWorker(PRKSEMAPHORE *Entry)
{
  ...
  ++PopIrpWorkerCount;
  if ( *(__int64 **)qword_140438D58 != &PopIrpThreadList )
LABEL_58:
    __fastfail(3u);
  v28[0] = &PopIrpThreadList;
  v28[1] = qword_140438D58;
  *(_QWORD *)qword_140438D58 = v28;
  qword_140438D58 = (__int64)v28;
