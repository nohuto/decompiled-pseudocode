/*
 * XREFs of VfMapTransfer @ 0x14096A320
 * Callers:
 *     <none>
 * Callees:
 ...
 *     ViCheckMdlLength @ 0x14096B62C (ViCheckMdlLength.c)
 *     ViGetAdapterInformationInternal @ 0x14096C0D8 (ViGetAdapterInformationInternal.c)
 *     ViGetMapRegisterFile @ 0x14096C26C (ViGetMapRegisterFile.c)
    ...
    if ( *(_DWORD *)(v8 + 192) == 3 )
    {
      ...
      if ( v10 )
      {
        ...
        ViHalPreprocessOptions(
          ...
          0LL,
          0LL);
        VfReportIssueWithOptions(0xE6u, 0x24uLL, v11, 0LL, 0LL, byte_14042B900);
      }
    }
    if ( v4 == -559026163 )
    {
