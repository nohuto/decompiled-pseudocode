/*
 * XREFs of VfSuspectDriversParseRegistryString @ 0x140A3E254
 * Callers:
...
LABEL_27:
    ...
    else
    {
      ...
      {
        VfDriverLock();
        v11 = (_QWORD *)qword_140435958;
        if ( *(__int64 **)qword_140435958 != &VfExcludedDriversList )
          __fastfail(3u);
        *v10 = &VfExcludedDriversList;
        v10[1] = v11;
        *v11 = v10;
        qword_140435958 = (__int64)v10;
        goto LABEL_27;
      }
    }
    v4 = 0x100002601LL;
