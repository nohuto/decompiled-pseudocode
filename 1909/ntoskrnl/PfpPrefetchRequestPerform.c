/*
 * XREFs of PfpPrefetchRequestPerform @ 0x1406AADFC
 * Callers:
 ...
 *     PfpPrefetchRequestPatchOffsets @ 0x1406ABBE4 (PfpPrefetchRequestPatchOffsets.c)
...
__int64 __fastcall PfpPrefetchRequestPerform(__int64 a1)
{
  ...
  *(_QWORD *)(v29[5] + 24LL) = v29;
  ...
  if ( v4 >= 0 )
  {
    ...
    if ( *(_BYTE *)(v29[0] + 81LL) )
    {
      _InterlockedAdd(&dword_140503758, 1u);
      p_Event = &Event;
      if ( *(_QWORD *)(v29[0] + 72LL) )
        p_Event = *(struct _KEVENT **)(v29[0] + 72LL);
      v4 = PfpScenCtxPrefetchAbortSet((ULONG_PTR)&qword_140467860, v5, (__int64)p_Event, 0, 0);
      if ( v4 < 0 )
        goto LABEL_26;
      if ( !*(_QWORD *)(v29[0] + 72LL) )
...
LABEL_26:
        if ( v5 )
        {
          _InterlockedDecrement(&dword_140503758);
          PfpScenCtxPrefetchAbortSet((ULONG_PTR)&qword_140467860, v5, 0LL, 1, 0);
        }
        goto LABEL_28;
      }
