/*
 * XREFs of MiObtainDynamicVa @ 0x1400E64B4
 * Callers:
 ...
 *     MiFindNextAlignedForwardRunClearEx @ 0x140196970 (MiFindNextAlignedForwardRunClearEx.c)
...
LABEL_106:
  ...
  if ( v5 == &qword_140465A78 )
  {
    qword_140465908 -= v9 << 21;
    MiReclaimSystemVa(0LL);
  }
  _InterlockedExchangeAdd64(&qword_1404670C8[v32], v9);
  KeReleaseInStackQueuedSpinLockFromDpcLevel(&LockHandle);
