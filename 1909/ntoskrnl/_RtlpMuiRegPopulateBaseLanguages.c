/*
 * XREFs of _RtlpMuiRegPopulateBaseLanguages @ 0x140945E5C
 * Callers:
...
NTSTATUS __fastcall RtlpMuiRegPopulateBaseLanguages(_WORD *a1, __int64 a2, _WORD *a3, __int64 a4)
{
  ...
  *(_QWORD *)(((unsigned __int64)LanguageId & 0xFFFFFFFFFFFFFFE0uLL) + 0x10) = 0LL;
  ...
  v9 = a1[2];
  v10 = 0;
  *(_DWORD *)(((unsigned __int64)LanguageId & 0xFFFFFFFFFFFFFFE0uLL) + 0x30) = 0;
  v11 = 0;
  if ( v9 )
  {
    v13 = a1[3];
  ...
  if ( a3[2] == v9 )
  {
    if ( v13 )
    {
      *(_QWORD *)(((unsigned __int64)LanguageId & 0xFFFFFFFFFFFFFFE0uLL) + 0x28) = ((unsigned __int64)LanguageId & 0xFFFFFFFFFFFFFFE0uLL)
                                                                                 + 768;
      *(_DWORD *)(((unsigned __int64)LanguageId & 0xFFFFFFFFFFFFFFE0uLL) + 4) = 512;
      *(_WORD *)(((unsigned __int64)LanguageId & 0xFFFFFFFFFFFFFFE0uLL) + 0x22) = 170;
      if ( RtlLCIDToCultureName(v13, (PUNICODE_STRING)(v4 + 32)) )
      {
        if ( ZwQueryValueKey(
               *(HANDLE *)(((unsigned __int64)LanguageId & 0xFFFFFFFFFFFFFFE0uLL) + 0x38),
  ...
  v16 = *(void **)(((unsigned __int64)LanguageId & 0xFFFFFFFFFFFFFFE0uLL) + 0x38);
  ...
  *(_DWORD *)(((unsigned __int64)LanguageId & 0xFFFFFFFFFFFFFFE0uLL) + 4) = 170;
  if ( (int)LdrpQueryValueKey(v16, (PUNICODE_STRING)(v4 + 32), (_DWORD *)(v4 + 8), (void *)(v4 + 80), (ULONG *)(v4 + 4)) >= 0
    && *(_DWORD *)(((unsigned __int64)LanguageId & 0xFFFFFFFFFFFFFFE0uLL) + 8) == 1
    && (!(_DWORD)v8
  ...
  if ( v10 != -2147483622 )
  {
    for ( i = *(_DWORD *)(((unsigned __int64)LanguageId & 0xFFFFFFFFFFFFFFE0uLL) + 0x30); ; ++i )
    {
      if ( v11 >= 4
        || ZwEnumerateValueKey(
             *(HANDLE *)(((unsigned __int64)LanguageId & 0xFFFFFFFFFFFFFFE0uLL) + 0x38),
