/*
 * XREFs of PopTraceThermalZonePassiveHistogram @ 0x140166E88
 * Callers:
 ...
 *     PopDiagSnapPassiveHistogram @ 0x140167798 (PopDiagSnapPassiveHistogram.c)
  ...
  if ( v4 )
  {
    ...
    if ( pCallbackContext.LevelPlus1 > 5 )
    {
      ...
      if ( (_BYTE)DeviceAttachmentBaseRefWithTag )
      {
        ...
        v14 = 84;
        v17 = 21;
        LOBYTE(DeviceAttachmentBaseRefWithTag) = TlgWrite(&pCallbackContext, &unk_14039068F, 0LL, 0LL, 7u, &pData);
      }
    }
  }
  if ( v3 )
