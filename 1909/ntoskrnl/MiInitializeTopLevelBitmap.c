/*
 * XREFs of MiInitializeTopLevelBitmap @ 0x1409F09EC
 * Callers:
...
void MiInitializeTopLevelBitmap()
{
  ...
  *(&BitMapHeader.SizeOfBitMap + 1) = 0;
  dword_140465AF0 = (unsigned __int8)ExGenRandom(1);
  memset(dword_140465AD0, 0, sizeof(dword_140465AD0));
  BitMapHeader.SizeOfBitMap = 256;
  BitMapHeader.Buffer = dword_140465AD0;
