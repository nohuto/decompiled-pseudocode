/*
 * XREFs of BgpFwLibraryInitialize @ 0x14098F9A8
 * Callers:
 ...
 *     BgpFwInitializeLock @ 0x140A4144C (BgpFwInitializeLock.c)
 */
...
__int64 __fastcall BgpFwLibraryInitialize(__int64 a1, unsigned int a2)
{
  ...
  if ( (dword_14042C010 & 1) != 0 && (dword_14042C010 & 4) == 0 && (*(_DWORD *)(a1 + 120) & 0x100000) == 0 )
    return 3221225485LL;
  if ( (*(_DWORD *)(a1 + 120) & 0x100000) != 0 )
  {
    ...
    if ( a2 == -1 )
    {
      ...
      dword_14042C010 |= 0x101800u;
      result = BgpFwLibraryEnable(a1 + 32);
      if ( (int)result < 0 )
        return result;
      dword_14042C010 &= ~0x2000u;
      v39 = *(_QWORD *)(a1 + 16);
      if ( v39 )
      {
        BgpFwReservePoolSwap(0, *(_QWORD *)(a1 + 240), *(_DWORD *)(a1 + 248), v39);
        qword_14042C0D8 = ResFwConfigureDisplayStringResources(*(_QWORD *)(a1 + 256));
        qword_14042C0D0 = AnFwConfigureProgressResources(*(int **)(a1 + 264));
      }
      else
      {
        qword_14042C0D8 = 0LL;
  ...
  if ( a2 == -1 )
  {
    dword_14042C010 = BgpFwInitializeLock(0x100000LL) | 0xC04;
    qword_14042C0E8 = (__int64)&qword_14042C0E0;
    qword_14042C0E0 = (__int64)&qword_14042C0E0;
    v40 = *(_QWORD *)(a1 + 240);
    if ( !v40 || !*(_DWORD *)(a1 + 248) )
      return 3221225626LL;
    BgpFwInitializeReservePool(v40, 0x4000LL, &unk_140508860);
    v5 = BgpFwLibraryEnable(a1 + 32);
    if ( v5 < 0 )
      goto LABEL_59;
    xmmword_14042C048 = *(_OWORD *)(a1 + 100);
    if ( *(_QWORD *)(a1 + 88) )
    {
    ...
    if ( *(_DWORD *)(a1 + 116) >= 3u )
    {
      qword_14042C190 = *(_QWORD *)(a1 + 404);
      dword_14042C198 = *(_DWORD *)(a1 + 412);
    }
    dword_14042C178 = *(_DWORD *)(a1 + 400);
  ...
  if ( v5 >= 0 )
  {
    *(PHYSICAL_ADDRESS *)&xmmword_14042BFF0 = MmGetPhysicalAddress(qword_14042BFC0);
    DWORD2(xmmword_14042BFF0) = DWORD2(BgInternal);
    HIDWORD(xmmword_14042BFF0) = DWORD1(BgInternal);
    LODWORD(xmmword_14042C000) = HIDWORD(BgInternal);
    if ( (_DWORD)xmmword_14042BFB0 == 4 )
    {
      DWORD2(xmmword_14042C000) = 3;
    }
    else if ( (_DWORD)xmmword_14042BFB0 == 5 )
    {
      DWORD2(xmmword_14042C000) = 4;
    }
    else
    {
      DWORD2(xmmword_14042C000) = 0;
    }
    v6 = 0;
    v7 = 416;
    v8 = 0;
    xmmword_14042C0F0 = *(_OWORD *)(a1 + 272);
    v9 = 0;
    xmmword_14042C100 = *(_OWORD *)(a1 + 288);
    xmmword_14042C110 = *(_OWORD *)(a1 + 304);
    xmmword_14042C120 = *(_OWORD *)(a1 + 320);
    xmmword_14042C130 = *(_OWORD *)(a1 + 336);
    xmmword_14042C140 = *(_OWORD *)(a1 + 352);
    xmmword_14042C150 = *(_OWORD *)(a1 + 368);
    xmmword_14042C160 = *(_OWORD *)(a1 + 384);
    if ( *(_QWORD *)(a1 + 72) )
    {
      v8 = 2;
      v9 = *(_DWORD *)(a1 + 84);
    ...
    if ( v15 )
    {
      ...
      *((_QWORD *)v16 + 54) = v21;
      dword_14042C010 |= 0x800u;
      v22 = BgpFoInitialize(v16 + 26, 1LL);
      dword_14042C010 &= ~0x800u;
      if ( v22 >= 0 )
        qword_14042C0C0 = (__int64)(v16 + 26);
      if ( !qword_14042C0C0 )
LABEL_76:
      ...
      memset(&qword_14042C058, 0, 0x58uLL);
      if ( *(_QWORD *)(a1 + 144) )
      {
        ...
        if ( v25 )
        {
          ...
          qword_14042C06C = *(_QWORD *)(a1 + 164);
        }
      }
      v26 = *(_QWORD *)(a1 + 184);
      if ( v26 && (int)BgpGxProcessQrCodeBitmap(v26, &qword_14042C098) < 0 )
        qword_14042C098 = 0LL;
      v27 = *(_QWORD *)(a1 + 216);
      if ( v27 )
      {
...
LABEL_35:
          ...
          v32 = *(_DWORD *)(a1 + 400);
          dword_14042C010 |= 0x8000u;
          dword_14042C178 = v32;
          BgpBcInitializeCriticalMode(a1, a2);
          dword_14042C010 = dword_14042C010 & 0xFFFF77FF | 0x800;
          ...
          qword_14042C0D0 = AnFwConfigureProgressResources(*(int **)(a1 + 264));
          v37 = *(_DWORD *)(a1 + 124);
          dword_14042C010 |= v4 | 0x80;
          dword_14042C014 = v37;
          BgpFwReleaseLock();
          qword_14042C0B0 = *(_QWORD *)(a1 + 232);
LABEL_49:
          dword_14042C010 |= 1u;
          v5 = 0;
          goto LABEL_50;
