/*
 * XREFs of MiActOnPte @ 0x1400BE5C0
 * Callers:
        ...
        __int64 *a8)
{
  ...
  char v79; // r9
  bool v80; // zf
  unsigned int v81; // [rsp+20h] [rbp-20h] BYREF
...
LABEL_27:
        ...
        *a8 = v28;
        if ( v28 )
          *a7 = *(_QWORD *)(qword_140465E88 + 8 * ((*(_QWORD *)(v22 + 40) >> 40) & 0x3FFLL));
...
LABEL_103:
    ...
    if ( v34 )
    {
      ...
      if ( a5 == 2 )
      {
        MiUpdatePfnPriority(v22, a6, 1LL);
        v55 = 0;
        goto LABEL_68;
      }
      v36 = *(_BYTE *)(v22 + 34);
...
LABEL_179:
  ...
  v15 = *(_QWORD *)(qword_140465E88 + 8LL * *(unsigned __int16 *)&Process[1].Spare2[69]);
  if ( v8 )
  {
    if ( a2 == 1 )
    {
    ...
    {
      v15 = *(_QWORD *)(qword_140465E88 + 8LL * (*(_WORD *)(*(_QWORD *)v75 + 60LL) & 0x3FF));
    }
  }
