/*
 * XREFs of EtwpGetAutoLoggerProviderFilter @ 0x14074B858
 * Callers:
  ...
  if ( !RegistryValues )
  {
    ...
    *(_OWORD *)&ObjectAttributes.SecurityDescriptor = 0LL;
    ...
    if ( a2 )
    {
      ...
      v39 = (wchar_t *)ExAllocatePoolWithTag(PagedPool, (unsigned int)(2 * v14 + 18), 0x50777445u);
      v15 = v39;
      if ( !v39 )
      {
        RegistryValues = -1073741801;
      ...
      RegistryValues = RtlStringCbPrintfW(v39, (unsigned int)(2 * v14 + 18), L"%ws\\Filters", a2);
      if ( RegistryValues )
        goto LABEL_10;
    ...
    if ( v21 || Handle )
    {
      ...
      do
      {
        *v27++ = ExAllocatePoolWithTag(PagedPool, 0x86uLL, 0x46777445u);
        --v26;
      }
      while ( v26 );
      v22 = v48;
      ...
      *v65 = v28;
      if ( v28 )
      {
        ...
        RegistryValues = RtlpQueryRegistryValues(0x40000000u, (const WCHAR *)KeyHandle, (__int64)v90, 0LL);
        if ( RegistryValues < 0 )
          goto LABEL_10;
        ...
        if ( Handle )
        {
          ...
          RegistryValues = RtlpQueryRegistryValues(0x40000000u, v38, (__int64)v90, 0LL);
          if ( RegistryValues < 0 )
            RegistryValues = 0;
        }
        if ( v30 )
        ...
        *v48 = v58;
        if ( v49 )
        {
          ...
          EtwpGetAutoLoggerEventNameFilter(
            ...
            v68,
            (__int64)v47);
          EtwpGetAutoLoggerLevelKwFilter(PoolWithTag, v15, v69);
          v19 = 2LL;
          goto LABEL_13;
        }
        do
