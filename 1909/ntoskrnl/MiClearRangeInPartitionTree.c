/*
 * XREFs of MiClearRangeInPartitionTree @ 0x1402E9B10
 * Callers:
 *     MiAddMdlToPartitionTree @ 0x1402E9448 (MiAddMdlToPartitionTree.c)
 * Callees:
...
__int64 __fastcall MiClearRangeInPartitionTree(unsigned __int64 *a1, __int64 a2, unsigned __int64 a3)
{
  ...
  if ( v8 )
  {
    while ( 1 )
    {
      ...
      if ( v13 - v5 + 0x40000 <= v3 )
        v12 = v13 - v5 + 0x40000;
      RtlClearBitsEx(v9 + 32, v5 - v13, v12);
      v14 = *(_QWORD *)(v9 + 32);
      v15 = v14 - 1;
      if ( !v14 )
        goto LABEL_24;
