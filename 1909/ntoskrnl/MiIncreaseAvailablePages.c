/*
 * XREFs of MiIncreaseAvailablePages @ 0x14002F640
 * Callers:
...
void __fastcall MiIncreaseAvailablePages(__int64 a1, unsigned __int64 a2)
{
  ...
  if ( a2 != 1 )
  {
    v3 = _InterlockedExchangeAdd64((volatile signed __int64 *)(a1 + 8064), a2);
    v4 = 0;
    v5 = a2 + v3;
    v6 = 0;
    if ( v3 < 0xA0 && v5 >= 0xA0 )
  ...
  v10 = _InterlockedIncrement64((volatile signed __int64 *)(a1 + 8064));
  if ( v10 <= 0x420 )
  {
    switch ( v10 )
    {
