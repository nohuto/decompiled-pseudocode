/*
 * XREFs of MiFreePrivateFixupEntryForSystemImage @ 0x14017AF34
 * Callers:
...
__int64 *__fastcall MiFreePrivateFixupEntryForSystemImage(ULONG_PTR BugCheckParameter2, int a2)
{
  ...
  v3 = 0LL;
  v5 = ExAcquireSpinLockExclusive(&dword_1404645E4);
  v6 = (__int64 *)qword_1404645C0;
  v7 = v5;
  while ( 1 )
  {
    if ( v6 == &qword_1404645C0 )
      goto LABEL_9;
    v3 = (PVOID *)v6;
