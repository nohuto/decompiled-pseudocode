/*
 * XREFs of MiAddSubRegionEntropy @ 0x1409F0914
 * Callers:
...
__int64 MiAddSubRegionEntropy()
{
  ...
  v3 = qword_1404672B0;
  qword_1404672A0 = v0 + (v2 & 0x7FFFFFFFF8LL);
  qword_140465B98[0] = ((unsigned __int64)(unsigned __int8)ExGenRandom(1) << 30) + v3;
  qword_140465BD8 = ((qword_140465B98[0] + 0x8FFFFFFFFFLL) & 0xFFFFFF8000000000uLL)
                  + ((unsigned __int64)(unsigned __int8)ExGenRandom(1) << 30);
  result = MiHyperSpaceSize();
  qword_140465BE0 = (v5 & (qword_140465BD8 + result + 0x7FFFFFFFFFLL)) - 1;
  return result;
}
