/*
 * XREFs of RtlLengthCurrentClearRunForward @ 0x14008A98C
 * Callers:
 *     MiCoalescePageFileBitmapsCache @ 0x14008A450 (MiCoalescePageFileBitmapsCache.c)
 *     MiCheckHintedPageFileSpace @ 0x1400DC904 (MiCheckHintedPageFileSpace.c)
 * Callees:
 *     <none>
 */
...
LABEL_18:
    if ( v5 )
    {
      if ( v10 )
        v11 = v6[1];
      v18 = v11 | ~dword_14037C900[*(_DWORD *)a1 & 0x1F];
      v19 = -1;
