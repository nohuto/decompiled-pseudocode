/*
 * XREFs of MiActivePageClaimCandidate @ 0x1400BA8C0
 * Callers:
 ...
 *     MiHyperPage @ 0x1400BD73C (MiHyperPage.c)
...
__int64 __fastcall MiActivePageClaimCandidate(__int64 a1, __int64 a2, int a3)
{
  ...
  {
    v10 = *(_QWORD *)(a2 + 40);
    if ( *(_QWORD *)(qword_140465E88 + 8 * ((v10 >> 40) & 0x3FF)) == a1 )
    {
      if ( *(_BYTE *)(a1 + 4766) )
      {
        v11 = 0LL;
...
LABEL_8:
            ...
            && (a3 != 1 || !MiIsPfnFileOnly(a2) && !MiIsPfnFromSlabAllocation(a2)) )
          {
            ...
            else
            {
                ...
                && *(__int64 *)(a2 + 8) < 0 )
              {
               ...
               && (v9 < 0xFFFF800000000000uLL || byte_140467140[((v9 >> 39) & 0x1FF) - 256] != 5)
               && ((v10 >> 54) & 7) != 1
               ...
               && v9 <= 0xFFFFF6FFFFFFFFFFuLL )
        {
          ...
          if ( (*(_BYTE *)a2 & 1) == 0 )
          {
            ...
            else if ( !MiVaIsPageFileHash(*(_QWORD *)(qword_140465E88 + 8 * ((v10 >> 40) & 0x3FF)), v15)
          ...
          if ( !PsInitialSystemProcess || v8 != PsInitialSystemProcess->DirectoryTableBase >> 12 )
          {
            ...
            {
              if ( (v20 & 0xFFFFFFFFFLL) == 0 || v15 >= qword_1404656D8 && v15 < qword_1404656D8 + 4096 )
                return v5;
              v22 = *(_WORD *)(a2 + 32);
              if ( v22 > 1u )
                return v5;
