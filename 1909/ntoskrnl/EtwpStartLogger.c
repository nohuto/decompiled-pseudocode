/*
 * XREFs of EtwpStartLogger @ 0x1406A8918
 * Callers:
 ...
 *     EtwpSetQpcDeltaTracking @ 0x1403303D0 (EtwpSetQpcDeltaTracking.c)
...
__int64 __fastcall EtwpStartLogger(__int64 a1, __int64 a2)
{
  ...
  *(_QWORD *)&DestinationString.Length = 0LL;
  ...
  if ( (v5 & 8) != 0 )
  {
    ...
    v46 = *(_QWORD *)(a2 + 24) - SystemTraceControlGuid;
    if ( !v46 )
      v46 = *(_QWORD *)(a2 + 32) - 0x3969A8086000829ALL;
    if ( !v46 )
      goto LABEL_128;
    v47 = *(_QWORD *)(a2 + 24) - CKCLGuid;
    if ( !v47 )
      v47 = *(_QWORD *)(a2 + 32) - 0x74F156D0633E71AFLL;
    if ( !v47 || (v5 & 4) != 0 )
      goto LABEL_128;
  }
...
LABEL_235:
  ...
  v10 = Buf2;
  v11 = *(_QWORD *)(v8 + 456);
  v12 = Buf2 - SystemTraceControlGuid;
  v13 = *((_QWORD *)&Buf2 + 1);
  v74 = v11;
  if ( (_QWORD)Buf2 == SystemTraceControlGuid )
    v12 = *((_QWORD *)&Buf2 + 1) - 0x3969A8086000829ALL;
  if ( !v12 )
    goto LABEL_175;
  v14 = Buf2 - CKCLGuid;
  if ( (_QWORD)Buf2 == CKCLGuid )
    v14 = *((_QWORD *)&Buf2 + 1) - 0x74F156D0633E71AFLL;
  if ( !v14 )
  {
LABEL_175:
    RtlFreeAnsiString(&DestinationString);
    v51 = v10 - SystemTraceControlGuid;
    if ( !v51 )
      v51 = v13 - 0x3969A8086000829ALL;
    if ( v51 )
    {
      v52 = 2;
      v66 = 1;
...
LABEL_128:
  ...
  v16 = Buf2 - AuditLoggerGuid;
  if ( (_QWORD)Buf2 == AuditLoggerGuid )
    v16 = *((_QWORD *)&Buf2 + 1) + 0x6A2DF162E6CE8D6ELL;
  if ( !v16 )
  {
    v64 = 3;
    if ( (v5 & 0x1000000) == 0 )
...
LABEL_219:
  ...
  {
    v57 = v10 - AuditLoggerGuid;
    if ( v10 == AuditLoggerGuid )
      v57 = v13 + 0x6A2DF162E6CE8D6ELL;
    if ( v57 )
      goto LABEL_202;
  }
  v17 = *(_DWORD *)(v8 + 16);
...
LABEL_53:
  ...
  if ( v64 >= *(_DWORD *)(v20 + 16) )
  {
    if ( !byte_14050BF70 )
    {
      ...
      {
        if ( TlgKeywordOn(&stru_140426650, 0x800000000000uLL) )
        {
          v72 = v58;
          v81 = &v72;
          v82 = 4LL;
          TlgWrite(&stru_140426650, &unk_140394430, 0LL, 0LL, 3u, &pData);
        }
      }
    }
    FileName = -1073741670;
...
LABEL_59:
  ...
  if ( FileName < 0 )
    goto LABEL_197;
  v23 = HeapGuid - Buf2;
  if ( HeapGuid == (_QWORD)Buf2 )
    v23 = 0x4AA2F2756B3425A8LL - *((_QWORD *)&Buf2 + 1);
  if ( v23 )
