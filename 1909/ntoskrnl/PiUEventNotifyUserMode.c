/*
 * XREFs of PiUEventNotifyUserMode @ 0x1406989F0
 * Callers:
 ...
 *     PiUEventShouldQueueEvent @ 0x1400EE9B4 (PiUEventShouldQueueEvent.c)
 ...
 *     PiUEventIsDeviceEventVetoable @ 0x140699310 (PiUEventIsDeviceEventVetoable.c)
...
LABEL_35:
    ...
    *(_DWORD *)(v7 + 64) = *(_DWORD *)(a1 + 148) + 8;
    ...
    v11 = (__int64 *)qword_140460C48;
    v12 = (PVOID *)PiUEventUsermodeEventQueue;
    if ( *(PVOID **)qword_140460C48 != &PiUEventUsermodeEventQueue )
      goto LABEL_42;
