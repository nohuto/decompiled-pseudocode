/*
 * XREFs of ExpPrepareNewSvmDevice @ 0x14033D7BC
 * Callers:
    ...
    if ( v15 )
    {
      ...
      if ( v9 >= 0 )
      {
        if ( (v19 & 7) == 7 && 1 << (BYTE4(v19) & 0x1F) >= (unsigned int)ExpSvmAgents )
        {
          ...
          v9 = ((__int64 (__fastcall *)(__int64, _QWORD, __int64 *, ULONG_PTR))HalIommuDispatch[3])(
                 a2,
                 *(_QWORD *)(v12 + 104),
                 &v19,
                 v12 + 112);
