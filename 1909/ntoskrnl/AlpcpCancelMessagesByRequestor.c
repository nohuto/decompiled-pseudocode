/*
 * XREFs of AlpcpCancelMessagesByRequestor @ 0x14065D830
 * Callers:
...
LABEL_7:
  ...
  while ( (ULONG_PTR *)v12 != a3 )
  {
    ...
    if ( *(_QWORD *)(v12 + 24) == v6 || (*(_DWORD *)(v12 + 40) & 0x8000) != 0 )
    {
      ...
      if ( !AlpcpTryLockForCachedReferenceBlob(v12) )
      {
        if ( a4 <= 2 )
        {
...
LABEL_30:
        ...
        *(_DWORD *)(v12 + 240) = 2621440;
        if ( v19 )
        {
          if ( _InterlockedExchange64((volatile __int64 *)(v19 + 1776), 0LL) == v12 )
          {
            KeReleaseSemaphoreEx(*(_QWORD *)(v12 + 32) + 1624LL, 1, 1, v16, 2);
            *(_QWORD *)(v12 + 32) = 0LL;
            *(_WORD *)(v12 - 30) -= 3;
            goto LABEL_35;
          }
