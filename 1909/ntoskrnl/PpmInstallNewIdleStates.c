/*
 * XREFs of PpmInstallNewIdleStates @ 0x1401952E0
 * Callers:
 *     PpmIdleInstallDefaultStates @ 0x1401952C0 (PpmIdleInstallDefaultStates.c)
 * Callees:
 ...
 *     PpmDeepestHardwareIdleState @ 0x140195828 (PpmDeepestHardwareIdleState.c)
 *     PpmResetIdlePolicy @ 0x140195860 (PpmResetIdlePolicy.c)
 *     PpmUpdateProcessorIdleAccounting @ 0x1401959F4 (PpmUpdateProcessorIdleAccounting.c)
