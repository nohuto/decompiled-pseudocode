/*
 * XREFs of LookUpTableFlushComplete @ 0x14078CEBC
 * Callers:
 ...
 *     UpdateInternalStatsOnFlush @ 0x1406BCD40 (UpdateInternalStatsOnFlush.c)
 */
  ...
  if ( v2 )
  {
    ...
    if ( *(_QWORD *)(v5 + 288) )
    {
      if ( stru_140427098.LevelPlus1 > 5 && TlgKeywordOn(&stru_140427098, 0x400000000000uLL) )
      {
        ...
        v33 = 4LL;
        v35 = 4LL;
        TlgWrite(&stru_140427098, &unk_140394CC4, 0LL, 0LL, 0xBu, &pData);
      }
