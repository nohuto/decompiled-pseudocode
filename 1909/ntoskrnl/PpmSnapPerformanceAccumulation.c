/*
 * XREFs of PpmSnapPerformanceAccumulation @ 0x1400358F0
 * Callers:
        ...
        LARGE_INTEGER *a5)
{
  ...
  if ( a3 )
  {
    ...
    if ( v12 )
    {
      ...
      {
        v26 = *(_QWORD *)(a1 + 24656);
        v10.QuadPart = *(_QWORD *)(v26 + 8LL * DWORD2(xmmword_14050AEB0)) >> 1;
        if ( (*(_QWORD *)(v26 + 8LL * DWORD2(xmmword_14050AEB0)) & 1) == 0 )
          v10.QuadPart = 0LL;
      }
    }
    if ( !v10.QuadPart )
  ...
  if ( result )
  {
    ...
    if ( v20 )
    {
      if ( *(_DWORD *)(a1 + 24024) == 3 )
      {
        v20 = *(_QWORD *)(*(_QWORD *)(a1 + 24656) + 8LL * DWORD2(xmmword_14050AEB0)) >> 1;
        if ( (*(_QWORD *)(*(_QWORD *)(a1 + 24656) + 8LL * DWORD2(xmmword_14050AEB0)) & 1) == 0 )
          v20 = 0LL;
      }
    }
    if ( v10.QuadPart == v20 )
