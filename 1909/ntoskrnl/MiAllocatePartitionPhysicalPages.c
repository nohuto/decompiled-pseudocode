/*
 * XREFs of MiAllocatePartitionPhysicalPages @ 0x14089B9D0
 * Callers:
 ...
 *     MiHugeRangeIsZeroed @ 0x1402C22CC (MiHugeRangeIsZeroed.c)
        ...
        __int16 a5)
{
  ...
  if ( (a5 & 0x200) == 0 )
  {
    if ( !(unsigned int)MiAcquireNonPagedResources((__int64)v10, v5) )
      return 3221225626LL;
    v12 = v34;
  }
  v16 = 0x40000LL;
...
LABEL_33:
    ...
    if ( v10 == &MiSystemPartition && !v43 )
      _InterlockedExchangeAdd64(&qword_140466738, v37);
    v5 = v42;
    v13 += v37;
    if ( v13 == v42 )
      goto LABEL_37;
