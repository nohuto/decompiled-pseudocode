/*
 * XREFs of AslpFileMakeStringVersionAttributes @ 0x14092A8E8
 * Callers:
...
__int64 __fastcall AslpFileMakeStringVersionAttributes(__int64 a1, __int64 a2)
{
  ...
  unsigned __int64 v26; // [rsp+98h] [rbp+58h] BYREF
...
LABEL_26:
    ...
    do
    {
      v14 = *(int *)((char *)&unk_140374890 + v12);
      pszSrc = *(const wchar_t **)((char *)&unk_140374890 + v12 + 8);
      LODWORD(v24) = *(_DWORD *)((char *)&unk_140374890 + v12);
