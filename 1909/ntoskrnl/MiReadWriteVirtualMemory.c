/*
 * XREFs of MiReadWriteVirtualMemory @ 0x14067DEE0
 * Callers:
 *     NtWriteVirtualMemory @ 0x14067DE80 (NtWriteVirtualMemory.c)
 *     NtReadVirtualMemory @ 0x14067DEB0 (NtReadVirtualMemory.c)
 * Callees:
 *     ObfDereferenceObjectWithTag @ 0x14003F860 (ObfDereferenceObjectWithTag.c)
 *     PsIsProcessLoggingEnabled @ 0x1400E5BE0 (PsIsProcessLoggingEnabled.c)
  ...
  if ( a4 )
  {
    ...
    if ( v15 >= 0 )
    {
      ...
      if ( (*((_BYTE *)Object + 728) & 1) == 0 || Process == Object || *((_QWORD *)Object + 132) )
      {
        ...
        v22 = MmCopyVirtualMemory((__int64)v21, v20, (__int64)v19, v18, a4, v27, (unsigned __int64 *)v28);
        v14 = v28[0];
        v15 = v22;
      }
      else
