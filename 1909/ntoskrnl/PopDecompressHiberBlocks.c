/*
 * XREFs of PopDecompressHiberBlocks @ 0x14059A6E0
 * Callers:
 ...
 *     RtlDecompressBufferProgress @ 0x1403171A8 (RtlDecompressBufferProgress.c)
        ...
        void (__fastcall *a5)(_DWORD *))
{
  ...
  LODWORD(v8) = (_DWORD)qword_140443418;
  v9 = 0;
  v43 = 0;
  v47 = 0LL;
  v41 = 0;
  ...
  while ( 1 )
  {
    ...
    if ( !qword_140443658 && BugCheckParameter3[48] == KeGetCurrentPrcb()->Number && byte_1404433C0 )
      qword_140443658 = KeQueryPerformanceCounter(0LL).QuadPart;
    Number = KeGetCurrentPrcb()->Number;
    if ( BugCheckParameter3[48] == (_DWORD)Number
      && !byte_1404433C1
      && (!byte_1404433C0 || (unsigned int)dword_1404433A4 > 0x640) )
    {
      v15 = __rdtsc();
      if ( byte_140467D68 )
      {
      ...
      v16 = __rdtsc();
      qword_140443640 += (((unsigned __int64)HIDWORD(v16) << 32) | (unsigned int)v16) - v15;
    }
    v40 = 4;
