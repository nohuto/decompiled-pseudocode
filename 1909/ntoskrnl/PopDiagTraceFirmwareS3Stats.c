/*
 * XREFs of PopDiagTraceFirmwareS3Stats @ 0x1405ADAC8
 * Callers:
...
void PopDiagTraceFirmwareS3Stats()
{
  ...
  if ( ((unsigned int (__fastcall *)(__int64, _QWORD, _QWORD, ULONG *))off_140426798[0])(35LL, 0LL, 0LL, &NumberOfBytes) == -1073741820 )
  {
    if ( NumberOfBytes )
    {
      ...
      if ( PoolWithTag )
      {
        if ( ((int (__fastcall *)(__int64, _QWORD, unsigned int *, ULONG *))off_140426798[0])(
               35LL,
               NumberOfBytes,
               PoolWithTag,
               &NumberOfBytes) >= 0 )
