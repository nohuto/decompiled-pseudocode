/*
 * XREFs of MiWriteComplete @ 0x1400BDA10
 * Callers:
 *     MiGatherMappedPages @ 0x14007B5D8 (MiGatherMappedPages.c)
 *     MiGatherPagefilePages @ 0x14014B04C (MiGatherPagefilePages.c)
 *     MiStoreWriteModifiedCompleteApc @ 0x14015C4E0 (MiStoreWriteModifiedCompleteApc.c)
 * Callees:
...
LABEL_11:
  ...
  {
    v16 = v44;
    while ( v16->Next == (struct _MDL *)qword_140466548 )
    {
...
LABEL_23:
    ...
    if ( (*(_DWORD *)(a1 + 40) & 0x20) != 0 )
    {
      v28 = *(_QWORD *)(qword_140465E88 + 8 * ((*(_QWORD *)(v17 + 40) >> 40) & 0x3FFLL));
