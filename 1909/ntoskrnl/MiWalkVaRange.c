/*
 * XREFs of MiWalkVaRange @ 0x1400BE0F4
 * Callers:
...
LABEL_16:
      ...
      if ( ((v27 & 0xFFFFFFFFFFFFF000uLL) == 0x7FFE0000
         || (v27 & 0xFFFFFFFFFFFFF000uLL) == qword_140465720 && qword_140465720)
