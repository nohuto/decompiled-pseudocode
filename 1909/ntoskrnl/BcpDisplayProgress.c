/*
 * XREFs of BcpDisplayProgress @ 0x140349608
 * Callers:
 ...
 *     BgpDisplayCharacterEx @ 0x140348B34 (BgpDisplayCharacterEx.c)
 *     BcpConvertProgressToString @ 0x140348E60 (BcpConvertProgressToString.c)
 *     BcpCursorLessThan @ 0x140348F38 (BcpCursorLessThan.c)
...
__int64 __fastcall BcpDisplayProgress(unsigned int a1, int a2, unsigned int a3)
{
  ...
  BcpDisplayCriticalString((__int16 *)v28, dword_140429ED0[2 * v6 + 2], v10, a2);
  v12 = &stru_14046B640;
  if ( a1 != 1 )
    v12 = &stru_14046B660;
  BcpDisplayCriticalString((__int16 *)v12, dword_140429ED0[2 * v6 + 2], v11, a2);
  v13 = BcpCursor;
  v14 = dword_140463EC8;
  v24 = BcpCursor;
  v25 = dword_140463EC8;
  if ( BcpCursorLessThan(&v24) )
  {
    ...
    v16 = HIDWORD(v24);
    v22 = v24;
    v17 = *(_DWORD *)(*(_QWORD *)(qword_14046B6F0 + 24) + 40LL);
    if ( BcpTextBoxLeftEdgeOverride )
      v18 = *(_DWORD *)BcpTextBoxLeftEdgeOverride;
    else
      v18 = dword_140429ED0[2 * v6 + 8] + dword_140429ED0[2 * v6 + 4];
    if ( BcpTextBoxRightEdgeOverride )
      v19 = *(_DWORD *)BcpTextBoxRightEdgeOverride;
    else
      v19 = dword_140429ED0[2 * v6 + 8] + dword_140429ED0[2 * v6 + 6] + dword_140429ED0[2 * v6 + 4];
    while ( BcpCursorLessThan(&v22) )
    {
      if ( (int)BgpDisplayCharacterEx(0x20u, (__int64 *)qword_14046B6F0, v15, v16, v17, v17, &v26, &v27, v21) < 0 )
        return 0LL;
      v15 += v26;
      LODWORD(v22) = v15;
      if ( v15 > v19 )
  ...
  if ( (dword_14042C010 & 0x1000000) == 0 )
  {
    BcpProgressEnd = v13;
    dword_14042BF78 = v14;
  }
