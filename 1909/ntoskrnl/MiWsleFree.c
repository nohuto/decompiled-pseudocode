/*
 * XREFs of MiWsleFree @ 0x140025B40
 * Callers:
...
LABEL_32:
    ...
    v25 = v23 & 0xFAFFFFFFFFFFFEFFuLL | ((word_1404658EC & 1 | 0xA000000000000LL) << 8);
...
LABEL_33:
  ...
  if ( v13 || (v74 & 4) != 0 )
  {
    ...
    *(_WORD *)(v8 + 32) = 0;
    ...
    if ( v35 )
      v36 = *(_QWORD *)(qword_140465E88 + 8 * ((*(_QWORD *)(v8 + 40) >> 40) & 0x3FFLL));
      ...
      if ( *(_WORD *)(v8 + 32) )
      {
        ...
        *(_BYTE *)(v8 + 34) = v57;
        if ( (*(_DWORD *)(v8 + 16) & 0x400LL) == 0 && (unsigned int)MiGetPagingFileOffset(v8 + 16) )
          *(_BYTE *)(*(_QWORD *)(qword_140465E88 + 8 * ((*(_QWORD *)(v8 + 40) >> 40) & 0x3FFLL)) + 667LL) = 1;
      }
      else if ( (_DWORD)v43 )
      {
        v63 = *(_BYTE *)(v8 + 35);
        ...
        MiReleasePageFileSpace(
          *(_QWORD *)(qword_140465E88 + 8 * ((*(_QWORD *)(v8 + 40) >> 40) & 0x3FFLL)),
          *(_QWORD *)(v8 + 16),
          1LL);
