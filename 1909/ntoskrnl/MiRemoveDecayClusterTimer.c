/*
 * XREFs of MiRemoveDecayClusterTimer @ 0x14011868C
 * Callers:
...
unsigned __int64 __fastcall MiRemoveDecayClusterTimer(__int64 a1)
{
  ...
  if ( v4 == 0x7FFFFFFF )
    ...
    *(_QWORD *)(48 * (qword_1404661E0 + v4) - 0x58000000000LL + 8) = result ^ (*(_QWORD *)(48 * (qword_1404661E0 + v4)
                                                                                         - 0x58000000000LL
  ...
  {
    *(_QWORD *)(48 * (v5 + qword_1404661E0) - 0x58000000000LL + 8) ^= (result ^ *(_QWORD *)(48 * (v5 + qword_1404661E0)
                                                                                          - 0x58000000000LL
                                                                                          + 8)) & 0xFFFFFFFE;
  }
  return result;
