/*
 * XREFs of EtwTraceEvent @ 0x14032BE40
 * Callers:
...
__int64 __fastcall EtwTraceEvent(unsigned __int16 a1, unsigned __int16 *a2, unsigned int a3, int a4, char a5)
{
  ...
  int v34; // [rsp+40h] [rbp-1B8h]
  _DWORD v35[3]; // [rsp+44h] [rbp-1B4h]
  ...
  unsigned int v42; // [rsp+68h] [rbp-190h]
  void *v43; // [rsp+70h] [rbp-188h]
  __int64 v44; // [rsp+78h] [rbp-180h]
  __int64 v45; // [rsp+80h] [rbp-178h] BYREF
  signed __int64 v46[5]; // [rsp+88h] [rbp-170h] BYREF
      ...
      if ( (v12 & 0x80u) == 0 )
      {
        if ( a5 || (v12 & 0x1000000) == 0 )
        {
          ...
          if ( (v38 & 0x100000) != 0 )
          {
            v16 = (char *)a2 + v5;
            v17 = v35[0] - v5;
            if ( (unsigned int)(v35[0] - v5) > 0x100 )
            {
          ...
          if ( v22 )
          {
            ...
            *((_DWORD *)v23 + 3) = CurrentThread[1].CycleTime;
            ...
            EtwpReleaseTraceBuffer(v46);
            ReserveTraceBufferStatus = v34;
            goto LABEL_72;
          }
