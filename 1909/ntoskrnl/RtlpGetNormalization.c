/*
 * XREFs of RtlpGetNormalization @ 0x1408D8970
 * Callers:
 *     RtlIsNormalizedString @ 0x1408D75D0 (RtlIsNormalizedString.c)
 *     RtlNormalizeString @ 0x1408D7660 (RtlNormalizeString.c)
 * Callees:
 ...
 *     NormalizationList__InsertTail @ 0x14031A9B8 (NormalizationList__InsertTail.c)
 *     NormalizationList__Lock @ 0x14031A9EC (NormalizationList__Lock.c)
 *     NormalizationList__Lookup @ 0x14031AA1C (NormalizationList__Lookup.c)
