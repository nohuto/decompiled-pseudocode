/*
 * XREFs of MiSessionCreate @ 0x140741918
 * Callers:
 ...
 *     MiInitializeSessionPool @ 0x140741EF0 (MiInitializeSessionPool.c)
...
__int64 MiSessionCreate()
{
  ...
  if ( !(unsigned int)MiCreateSystemWsles()
    || !(unsigned int)MiInitializeDynamicBitmap(v3 + 1160, qword_1404656A8, 0x200000LL, 0LL) )
  {
    goto LABEL_31;
  }
  *(_QWORD *)(v3 + 1120) = qword_140464688;
  *(_QWORD *)(v3 + 1112) = 0x10000LL;
  PteAddress = (_QWORD *)MiGetPteAddress(qword_140464688);
  ...
  {
    MiReturnCommit(ProcessPartition, qword_140464690);
    goto LABEL_31;
  }
  v11 = qword_140464690 + *(_QWORD *)(v3 + 48);
  *(_DWORD *)(v3 + 4) |= 8u;
...
LABEL_15:
  *(_DWORD *)(v3 + 4) = v13 | 0x10;
  ...
  v16 = qword_140464698;
  *(_QWORD *)(v3 + 56) = qword_140464698;
  v17 = qword_140464698 - 1;
  *(_QWORD *)(v3 + 64) = qword_140464698 + 0x1FFFFFFFFFLL;
