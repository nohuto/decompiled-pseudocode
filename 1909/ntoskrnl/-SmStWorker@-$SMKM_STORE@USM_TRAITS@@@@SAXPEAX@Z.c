/*
 * XREFs of ?SmStWorker@?$SMKM_STORE@USM_TRAITS@@@@SAXPEAX@Z @ 0x14011C180
 * Callers:
...
LABEL_30:
                    ...
                    if ( v16 && ($C6908ADE9723D0A04AF8EE82D8D15C40 *)v12->ApcState.ApcListHead[0].Flink != &v12->152 )
...
LABEL_60:
                ...
                if ( v16 && ($C6908ADE9723D0A04AF8EE82D8D15C40 *)v25->ApcState.ApcListHead[0].Flink != &v25->152 )
...
LABEL_90:
          ...
          if ( v16 && ($C6908ADE9723D0A04AF8EE82D8D15C40 *)v36->ApcState.ApcListHead[0].Flink != &v36->152 )
