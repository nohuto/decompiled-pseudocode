/*
 * XREFs of VfPnpVerifyIrpStackUpward @ 0x140980050
 * Callers:
 *     <none>
 * Callees:
...
LABEL_15:
  ...
  if ( v13 >= 0 )
  {
    v16 = 558;
LABEL_24:
    result = VfErrorReport1(v16, *(const void **)(a4 + 40), v10);
    goto LABEL_16;
  }
  if ( v13 == -1073741637 )
  {
    result = VfErrorReport1(0x22Fu, *(const void **)(a4 + 40), v10);
LABEL_14:
    if ( v15 )
      goto LABEL_15;
LABEL_16:
    ...
    {
      result = VfErrorReport1(0x216u, v12, v10);
