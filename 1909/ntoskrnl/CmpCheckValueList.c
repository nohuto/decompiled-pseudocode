/*
 * XREFs of CmpCheckValueList @ 0x140663E70
 * Callers:
...
LABEL_143:
      if ( (a6 & 0x20000) != 0 || !BYTE2(NlsMbCodePageTag) && (CmpBootType & 6) == 0 )
      {
      ...
      v52 = (*(__int64 (__fastcall **)(ULONG_PTR, _QWORD, _DWORD *))(BugCheckParameter2 + 8))(
              BugCheckParameter2,
      ...
      if ( !HvpMarkCellDirty(BugCheckParameter2, v51, 0) )
      {
        v55 = 24;
LABEL_158:
        v39 = -1073741443;
      ...
      if ( !HvpMarkCellDirty(BugCheckParameter2, *(unsigned int *)(v52 + 40), 0) )
      {
        v55 = 40;
        goto LABEL_158;
      }
    ...
    else
    {
      ...
      if ( v22 )
      {
        ...
        if ( v23 )
        {
          ...
          (*(void (__fastcall **)(ULONG_PTR, __int64 *))(BugCheckParameter2 + 16))(BugCheckParameter2, &v69);
          if ( !v29 )
          {
LABEL_81:
...
LABEL_156:
          v54 = v62;
LABEL_159:
          (*(void (__fastcall **)(ULONG_PTR, _DWORD *))(BugCheckParameter2 + 16))(BugCheckParameter2, v54);
          return v39;
        }
      }
      v34 = 2 * v31[1];
...
LABEL_139:
      ...
      if ( v37 )
      {
        if ( !(unsigned __int8)HvIsCellAllocated(BugCheckParameter2, v41, v68) )
        {
...
LABEL_106:
        ...
        v42 = (*(__int64 (__fastcall **)(ULONG_PTR, _QWORD, _DWORD *))(BugCheckParameter2 + 8))(
                BugCheckParameter2,
                v41,
                v63);
        if ( !v42 )
      ...
      if ( v37 <= 0x3FD8 || *(_DWORD *)(BugCheckParameter2 + 212) < 4u )
      {
...
LABEL_107:
      ...
      else
      {
        ...
        if ( !(unsigned __int8)HvIsCellAllocated(BugCheckParameter2, v43, v68) )
        {
        ...
        v44 = (*(__int64 (__fastcall **)(ULONG_PTR, _QWORD, _DWORD *))(BugCheckParameter2 + 8))(
                BugCheckParameter2,
                *(unsigned int *)(v42 + 4),
                v66);
        if ( !v44 )
...
LABEL_111:
        ...
        if ( *(_WORD *)(v42 + 2) )
        {
          while ( (unsigned __int8)HvIsCellAllocated(BugCheckParameter2, *(unsigned int *)(v44 + 4 * v46), v68) )
          {
            v47 = (*(__int64 (__fastcall **)(ULONG_PTR, _QWORD, _DWORD *))(BugCheckParameter2 + 8))(
                    BugCheckParameter2,
