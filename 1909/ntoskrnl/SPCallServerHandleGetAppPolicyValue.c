/*
 * XREFs of SPCallServerHandleGetAppPolicyValue @ 0x1406E5DF8
 * Callers:
...
LABEL_178:
  ...
  if ( AddressWithinSection )
  {
    ...
    v112 = v23;
    v35 = (void *)pcbLength;
    v36 = ((__int64 (__fastcall *)(size_t, unsigned int *, _QWORD, _QWORD, PVOID, unsigned int, PVOID, unsigned int, int *, int *, int *))AddressWithinSection)(
            pcbLength,
            v57,
            v33,
            v122,
