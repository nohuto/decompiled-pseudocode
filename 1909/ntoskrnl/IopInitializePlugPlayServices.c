/*
 * XREFs of IopInitializePlugPlayServices @ 0x1409F8468
 * Callers:
 ...
 *     IopPortInitialize @ 0x1407658CC (IopPortInitialize.c)
 *     IopMemInitialize @ 0x140765964 (IopMemInitialize.c)
 *     IopDmaInitialize @ 0x140765A48 (IopDmaInitialize.c)
 *     IopIrqInitialize @ 0x140765ABC (IopIrqInitialize.c)
 *     IopBusNumberInitialize @ 0x140765B24 (IopBusNumberInitialize.c)
 ...
 *     PiDcHandleSystemFirmwareUpdate @ 0x14086387C (PiDcHandleSystemFirmwareUpdate.c)
 ...
 *     PiDqInit @ 0x1409F7788 (PiDqInit.c)
 ...
 *     PnpInitializeDeviceActions @ 0x1409F7CB4 (PnpInitializeDeviceActions.c)
 *     PpProfileInit @ 0x1409F7D10 (PpProfileInit.c)
 ...
 *     PnpInitializeNotification @ 0x1409F7EE0 (PnpInitializeNotification.c)
 *     PnpBusTypeGuidInitialize @ 0x1409F8020 (PnpBusTypeGuidInitialize.c)
 *     PiSwInit @ 0x1409F80AC (PiSwInit.c)
 *     PiDaInit @ 0x1409F8158 (PiDaInit.c)
 *     PipProcessPendingOperations @ 0x1409F8194 (PipProcessPendingOperations.c)
 ...
 *     PnpInitializeLegacyBusInformationTable @ 0x140A1D7B0 (PnpInitializeLegacyBusInformationTable.c)
 ...
 *     PnpDeviceCompletionQueueInitialize @ 0x140A224B4 (PnpDeviceCompletionQueueInitialize.c)
 ...
 *     PiCslInitialize @ 0x140A3B64C (PiCslInitialize.c)
 */
          ...
          *(_QWORD *)&UserData.Size = 80LL;
          ...
          if ( stru_140426750.LevelPlus1 > 4 && TlgKeywordOn(&stru_140426750, 0x400000000000uLL) )
          {
            ...
            *(_QWORD *)&v34.Length = *(_QWORD *)(v25 + 2480);
            ...
            v59 = 8LL;
            v61 = 8LL;
            TlgWrite(&stru_140426750, &unk_14038CEB8, 0LL, 0LL, 0xBu, &pData);
          }
    ...
    if ( (int)result >= 0 )
    {
      ...
      if ( (int)result >= 0 )
      {
        ...
        if ( (int)result >= 0 )
        {
          ...
          ArbInitializeOsInaccessibleRange((unsigned int)dword_14046579C);
          ...
          *(_DWORD *)&v30.Length = 4063292;
          v30.Buffer = L"\\Registry\\Machine\\System\\Setup";
          if ( IopOpenRegistryKeyEx(&Handle, 0LL, &v30, 0x20019u) >= 0 )
          {
            ...
            {
              qword_140461150 = (__int64)PipUpdateSetupInProgressCallback;
              qword_140461158 = (__int64)Handle;
          ...
          CmSetDeviceRegProp(
            *(__int64 *)&PiPnpRtlCtx,
            ...
            0);
          ZwClose(v21);
          qword_1404605C8 = (__int64)&IopPendingEjects;
          IopPendingEjects = (__int64)&IopPendingEjects;
          qword_140460658 = (__int64)&IopPendingSurpriseRemovals;
