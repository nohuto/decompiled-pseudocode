/*
 * XREFs of MiCopyHeaderIfResident @ 0x14008FF40
 * Callers:
...
__int64 __fastcall MiCopyHeaderIfResident(__int64 a1, ULONG_PTR a2)
{
  ...
  while ( 1 )
  {
    v4 = ExAcquireSpinLockExclusive(&dword_140464280);
    v5 = *(__int64 **)(a1 + 40);
    v6 = v4;
    if ( !v5 || (v7 = *v5) == 0 )
    {
  ...
  if ( (*(_DWORD *)(v7 + 56) & 3) != 0
    || (v12 = *(_QWORD *)(v7 + 136)) == 0
    || (v21 = 0LL, v22 = 0LL, (int)MiTryLockProtoPoolPageAtDpc(v12, v11, &v22, &v21) < 0) )
  {
