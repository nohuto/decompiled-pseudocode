/*
 * XREFs of NormBuffer__ReplaceLastStartBasePair @ 0x1403137D4
 * Callers:
 ...
 *     Normalization__GetThirdAndLastDecomposedCharPlane0 @ 0x1408D6458 (Normalization__GetThirdAndLastDecomposedCharPlane0.c)
 */
