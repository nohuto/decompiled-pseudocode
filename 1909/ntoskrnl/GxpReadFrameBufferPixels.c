...
__int64 __fastcall GxpReadFrameBufferPixels(__int64 *a1, __int64 a2)
{
  ...
  if ( (int)result >= 0 )
  {
    ...
    if ( !(_BYTE)BgInternal )
    {
      ...
      LODWORD(v31) = xmmword_14042BFB0;
      v32 = a1[3];
      v13 = ((__int64 (__fastcall *)(__int64 *, __int64, __int64))qword_14042BFC0)(&v30, v3, v12);
      goto LABEL_19;
    }
    v14 = (char *)a1[3];
    v15 = *(_DWORD *)a1;
    v21 = (char *)qword_14042BFC0;
    if ( BYTE2(BgInternal) )
    {
      HIDWORD(v36) = 0;
      if ( !v15 )
...
LABEL_30:
    ...
    {
      v16 = (char *)qword_14042BFC0 + v5 * (*(_DWORD *)v3 + v23 * *(_DWORD *)(v3 + 4));
      if ( !v15 )
      {
LABEL_19:
