/*
 * XREFs of AlpcpAllocateSnapshotMessageLog @ 0x140885034
 * Callers:
  ...
  while ( 1 )
  {
    ...
    *(_QWORD *)(v3 + 8) = v4;
    ...
    while ( 1 )
    {
      ...
      *v5 = v7;
      v7[1] = v5;
      v8 = (_QWORD *)qword_140446498;
      if ( *(__int64 **)qword_140446498 != &AlpcpFreeMessageSnapshotListHead )
        goto LABEL_19;
      *v6 = &AlpcpFreeMessageSnapshotListHead;
      v6[1] = v8;
      *v8 = v6;
      qword_140446498 = (__int64)v6;
    }
    v9 = (__int64 *)qword_140446468;
    if ( *(__int64 **)qword_140446468 != &AlpcpFreeMessageLogListHead )
      goto LABEL_19;
