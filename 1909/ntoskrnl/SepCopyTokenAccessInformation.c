/*
 * XREFs of SepCopyTokenAccessInformation @ 0x14061C81C
 * Callers:
 ...
 *     SepConvertTokenPrivilegesToLuidAndAttributes @ 0x140087BC0 (SepConvertTokenPrivilegesToLuidAndAttributes.c)
 *     SeQueryMandatoryPolicyToken @ 0x140087E58 (SeQueryMandatoryPolicyToken.c)
 *     memmove @ 0x1401D7480 (memmove.c)
 *     RtlCopySidAndAttributesArray @ 0x14061CB00 (RtlCopySidAndAttributesArray.c)
 *     AuthzBasepQueryInternalSecurityAttributesToken @ 0x14061CDE8 (AuthzBasepQueryInternalSecurityAttributesToken.c)
 */
  ...
  if ( v27 )
  {
    RtlCopySidAndAttributesArray(
      ...
      *(PSID_AND_ATTRIBUTES *)(a1 + 160),
      ...
      &RemainingSidArea,
      (PULONG)&RemainingSidArea);
    RtlSidHashInitialize((__int64 *)(v25 + 272), *(_DWORD *)(a1 + 128), (_QWORD *)v25);
  }
  v28 = v26 + a7;
  ...
  if ( v30 )
  {
    RtlCopySidAndAttributesArray(
      ...
      *(PSID_AND_ATTRIBUTES *)(a1 + 792),
      ...
      &RemainingSidArea,
      (PULONG)&RemainingSidArea);
    RtlSidHashInitialize((__int64 *)(v28 + 272), *(_DWORD *)(a1 + 800), (_QWORD *)v28);
  }
  v31 = (char *)(v29 + a10);
  v32 = 0LL;
  if ( a9 )
