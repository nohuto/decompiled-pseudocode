/*
 * XREFs of VrpPreOpenOrCreate @ 0x1408452F8
 * Callers:
...
LABEL_14:
    if ( stru_140425BF8.LevelPlus1 > 2 )
    {
      ...
      v49 = 0;
      v51 = 4LL;
      TlgWrite(&stru_140425BF8, &unk_14038C88A, &ActivityId, 0LL, 5u, &pData);
    }
    goto LABEL_18;
  }
LABEL_43:
  if ( stru_140425BF8.LevelPlus1 > 5 )
  {
    ...
    v49 = 0;
    v51 = 4LL;
    TlgWrite(&stru_140425BF8, &unk_14038C84B, &ActivityId, 0LL, 5u, &pData);
  }
LABEL_18:
  if ( v4 )
