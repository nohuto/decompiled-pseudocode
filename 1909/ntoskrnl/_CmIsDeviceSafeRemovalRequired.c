/*
 * XREFs of _CmIsDeviceSafeRemovalRequired @ 0x14071ADB8
 * Callers:
...
bool __fastcall CmIsDeviceSafeRemovalRequired(__int64 a1, const WCHAR *a2, __int64 a3)
{
  ...
  unsigned int v24; // [rsp+7Ch] [rbp-84h] BYREF
      ...
      if ( !v10 && v6 )
      {
        ...
        for ( i = (wchar_t *)a2; RtlStringCchCopyExW(pszDest, 0xC8uLL, i, 0LL, 0LL, 0x800u) >= 0; i = pszSrc )
        {
          ...
          if ( CmGetDeviceParent(a1, pszDest, pszSrc, &v24) < 0 )
            return v10;
          v18 = 4;
          v13 = CmGetDeviceRegProp(a1, (__int64)pszSrc, 0LL, 16, (__int64)v25, (__int64)&v19, (__int64)&v18, 0);
          v14 = v19;
          if ( v13 < 0 )
            v14 = 0;
          v19 = v14;
