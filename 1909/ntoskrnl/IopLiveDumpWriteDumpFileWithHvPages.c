/*
 * XREFs of IopLiveDumpWriteDumpFileWithHvPages @ 0x14085A094
 * Callers:
 ...
 *     IopLiveDumpGetHvMergePages @ 0x1408598D4 (IopLiveDumpGetHvMergePages.c)
 *     IopLiveDumpGetNtMergePages @ 0x140859A68 (IopLiveDumpGetNtMergePages.c)
...
__int64 __fastcall IopLiveDumpWriteDumpFileWithHvPages(__int64 a1)
{
  ...
  *(_QWORD *)(a1 + 536) = 0LL;
  ...
  v35 = 0;
  v52 = CurrentThread;
  IopLiveDumpGetNtMergePages(a1, (__int64)v57, &v42, &v39, &v46);
  v44 = (__int64 *)v57;
