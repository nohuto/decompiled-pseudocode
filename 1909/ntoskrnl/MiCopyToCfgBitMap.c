/*
 * XREFs of MiCopyToCfgBitMap @ 0x1405ED100
 * Callers:
 ...
 *     RtlEnumRvaListFirst @ 0x1406CE680 (RtlEnumRvaListFirst.c)
 */
        ...
        size_t Size)
{
  ...
  if ( v9 <= 1 )
  {
    PoolWithTag = (char *)qword_140466568;
    if ( !v9 )
      PoolWithTag = (char *)qword_140466570;
    goto LABEL_11;
  }
