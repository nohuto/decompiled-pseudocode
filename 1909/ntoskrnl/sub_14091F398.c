/*
 * XREFs of sub_14091F398 @ 0x14091F398
 * Callers:
...
__int64 __fastcall sub_14091F398(__int64 a1, __int64 a2, __int64 a3, __int64 a4)
{
  unsigned int v6; // r8d
  unsigned int *v7; // rax
  unsigned int i; // ecx
...
LABEL_19:
  if ( (v6 & 0x80000000) == 0 )
  {
    ...
    {
      if ( stru_14042C980.Header.SignalState || !dword_1409AD16C )
      {
