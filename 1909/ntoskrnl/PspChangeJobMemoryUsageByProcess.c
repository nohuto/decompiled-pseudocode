/*
 * XREFs of PspChangeJobMemoryUsageByProcess @ 0x1406B15F0
 * Callers:
...
char __fastcall PspChangeJobMemoryUsageByProcess(char a1, __int64 a2, __int64 a3, __int64 a4)
{
  ...
  $C6908ADE9723D0A04AF8EE82D8D15C40 *v25; // rcx
  __int64 v26; // rax
  __int64 i; // rdi
  ...
  v35 = a4;
  v34 = a3;
  if ( (a1 & 2) == 0 || !*(_QWORD *)(a3 + 952) )
    return 1;
  v6 = 1;
  CurrentThread = KeGetCurrentThread();
  v28 = 0;
  v29 = 0LL;
  v30 = *(_QWORD *)(*(_QWORD *)(a3 + 912) + 1080LL);
  if ( CurrentThread )
...
LABEL_28:
    ...
    if ( *(_QWORD *)(v10 + 456) && (*(_DWORD *)(v10 + 876) & 0x200) != 0 && (*(_DWORD *)(v34 + 776) & 0x24) == 4 )
    {
      _InterlockedOr((volatile signed __int32 *)(v34 + 776), 0x20u);
      PspSendJobNotification(v10, 10LL, *(_QWORD *)(v34 + 744), 1);
      v16 = v32;
    }
    goto LABEL_19;
  }
LABEL_32:
  ...
  if ( CurrentThread )
  {
    if ( CurrentThread->SpecialApcDisable++ == -1 )
    {
      ...
      if ( ($C6908ADE9723D0A04AF8EE82D8D15C40 *)v25->ApcState.ApcListHead[0].Flink != v25 )
