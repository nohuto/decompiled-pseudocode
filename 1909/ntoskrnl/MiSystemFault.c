/*
 * XREFs of MiSystemFault @ 0x140075390
 * Callers:
...
__int64 __fastcall MiSystemFault(_QWORD *a1)
{
  ...
  if ( v3 >= 0xFFFFF68000000000uLL && v3 <= 0xFFFFF6FFFFFFFFFFuLL && v4 >= qword_1404672B0 && v4 <= qword_140465BE0 )
    a1[1] |= 2uLL;
  v59 = 0;
  if ( (a1[1] & 0x100000000000000LL) != 0 )
  {
    if ( v3 < 0xFFFFF68000000000uLL
      ...
      || v4 > 0x7FFFFFFEFFFFLL && (v4 < qword_1404672B0 || v4 > qword_140465BE0) )
    {
      return 3489660934LL;
    }
    return 192LL;
  ...
  if ( v4 < 0xFFFF800000000000uLL
    || v4 >= qword_140465BD8
    && v4 < qword_140465BD8 + MiHyperSpaceSize(v3, 0x100000000000000LL, 0xFFFFF68000000000uLL, 0xFFFFF6FFFFFFFFFFuLL) )
  {
    return 192LL;
  }
  ...
  if ( dword_140465DC4 )
  {
    v43 = ExAcquireSpinLockShared(&dword_140465DC0);
    v44 = (_QWORD *)qword_140465DC8;
    v45 = v43;
    if ( qword_140465DC8 )
    {
      do
...
LABEL_23:
  ...
  HIDWORD(v62[0]) = 1;
  v20 = byte_140467140[((v4 >> 39) & 0x1FF) - 256];
  if ( (a1[10] & 8) != 0 )
  {
    if ( (_DWORD)v20 == 6 )
      goto LABEL_30;
  ...
  if ( (_DWORD)v20 == 8 )
  {
    SessionVm = &unk_14046A1C0;
  }
  else if ( (_DWORD)v20 == 1 )
  {
    SessionVm = (void *)MiGetSessionVm(byte_140467140, v19, v20);
    if ( !SessionVm )
      goto LABEL_155;
    v59 = 1;
  }
  else
  {
    ...
    {
LABEL_30:
      SessionVm = &unk_140466A00;
      goto LABEL_31;
    }
    if ( (_DWORD)v20 == 12 )
    {
      SessionVm = &unk_1404668C0;
    }
    else
    {
      if ( (_DWORD)v20 == 14 )
