/*
 * XREFs of MiLogOutswappedProcessCommitReacquire @ 0x1402BB0DC
 * Callers:
  ...
  if ( hProvider )
  {
    if ( a3 )
    {
      if ( a4 )
      {
        if ( hProvider->LevelPlus1 > 5 && TlgKeywordOn(hProvider, 4uLL) )
        {
          ...
          v24 = v10;
          v27 = 8;
          TlgWriteEx(v12, &unk_14038D6D1, v11, v10, v17, v18, 5u, &pData);
        }
      }
      else if ( hProvider->LevelPlus1 > 5 && TlgKeywordOn(hProvider, 4uLL) )
      {
        ...
        v24 = v14;
        v27 = 8;
        TlgWriteEx(v16, &unk_14038D725, v15, v14, v17, v18, 5u, &pData);
      }
    }
    else if ( hProvider->LevelPlus1 > 5 )
    {
      if ( TlgKeywordOn(hProvider, 4uLL) )
      {
        ...
        v24 = v6;
        v27 = 8;
        TlgWriteEx(v8, &unk_14038D7DF, v7, v6, v17, v18, 5u, &pData);
      }
    }
  }
}
