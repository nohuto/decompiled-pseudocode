/*
 * XREFs of TtmiLogTerminalDestroyed @ 0x1408C3264
 * Callers:
 *     TtmpDeleteTerminal @ 0x1408BC550 (TtmpDeleteTerminal.c)
 * Callees:
...
void TtmiLogTerminalDestroyed()
{
  ...
  if ( stru_1409AD8E0.LevelPlus1 > 5 )
  {
    if ( TlgKeywordOn(&stru_1409AD8E0, 1uLL) )
    {
      ...
      v1 = v0;
      v4 = 8;
      TlgWrite(&stru_1409AD8E0, &unk_140391F84, 0LL, 0LL, 3u, &pData);
    }
  }
}
