/*
 * XREFs of MiGetTransitionPageHeatList @ 0x1402EB98C
 * Callers:
...
PSLIST_ENTRY MiGetTransitionPageHeatList()
{
  ...
  result = RtlpInterlockedPopEntrySList(&stru_140466250);
  v1 = result;
  if ( result )
  {
  ...
  else
  {
    ...
    {
      v3 = v2;
      v2 = _InterlockedCompareExchange(&dword_140466260, v2 - 1, v2);
      if ( v3 == v2 )
        return v1;
    }
