/*
 * XREFs of SeMarkLogonSessionForTerminationNotificationEx @ 0x1406F10C0
 * Callers:
 *     SeMarkLogonSessionForTerminationNotification @ 0x1406F10A0 (SeMarkLogonSessionForTerminationNotification.c)
 * Callees:
