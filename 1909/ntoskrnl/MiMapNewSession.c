/*
 * XREFs of MiMapNewSession @ 0x14074270C
 * Callers:
...
__int64 __fastcall MiMapNewSession(unsigned __int64 a1, unsigned __int16 a2)
{
  ...
  while ( v6 );
  MiFillPteHierarchy(qword_1404656D8, v35);
  v9 = 2560;
  v10 = 4LL;
  v11 = 0xFFFFFFFFFLL;
  do
  {
    ...
    *v15 = 0LL;
    ...
    if ( v10 == 3 )
    {
      *(_QWORD *)(v13 + 8) = MiGetPteAddress(qword_1404656D8);
...
LABEL_10:
  ...
  v22 = 0;
  v23 = (_QWORD *)MiGetPteAddress(qword_1404656D8);
  ...
  while ( 2 )
  {
    ...
    if ( v22 )
      goto LABEL_13;
    *(_QWORD *)(v25 + 8) = MiGetPteAddress(qword_1404656D8);
