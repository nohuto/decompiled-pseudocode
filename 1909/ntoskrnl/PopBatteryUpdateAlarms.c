/*
 * XREFs of PopBatteryUpdateAlarms @ 0x14075AF6C
 * Callers:
...
__int64 __fastcall PopBatteryUpdateAlarms(char a1, __int64 a2)
{
  ...
  if ( (unsigned int)a2 < v17 )
  {
    ...
    do
    {
      if ( (int)PopGetPowerSettingValue((__int64)GUIDS_BATTERY_DISCHARGE_ACTION[v18], a2, v2, &v30, v26, &v31) >= 0 )
      {
        v22 = v30;
        if ( v30 <= 6 )
        {
      ...
      if ( (int)PopGetPowerSettingValue((__int64)GUIDS_BATTERY_DISCHARGE_LEVEL[v18], v21, v2, &v30, v27, &v31) >= 0 )
      {
        v24 = v30;
        if ( v30 > 0x64 )
          v24 = 100;
      ...
      if ( (int)PopGetPowerSettingValue((__int64)GUIDS_BATTERY_DISCHARGE_FLAGS[v18], v23, v2, &v30, v28, &v31) >= 0 )
        v19[3] = v30 & 7;
      v19 += 6;
      ++v18;
      --v20;
