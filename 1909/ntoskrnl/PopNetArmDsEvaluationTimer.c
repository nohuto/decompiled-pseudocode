/*
 * XREFs of PopNetArmDsEvaluationTimer @ 0x1408B36A4
 * Callers:
...
_BOOL8 PopNetArmDsEvaluationTimer()
{
  ...
  if ( MEMORY[0xFFFFF78000000008] < (unsigned __int64)(v1 + qword_140467B88) )
    v0 = qword_140467B88 + v1 - MEMORY[0xFFFFF78000000008];
