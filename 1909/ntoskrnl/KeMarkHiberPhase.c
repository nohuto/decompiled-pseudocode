/*
 * XREFs of KeMarkHiberPhase @ 0x1405AAD28
 * Callers:
...
void __fastcall KeMarkHiberPhase(_QWORD *Address)
{
  ...
  if ( qword_140446D98 )
    PoSetHiberRange(0LL, 0x10000u, qword_140446D98, 16 * (unsigned int)(unsigned __int8)qword_140446D88, 0x7272744Du);
  if ( qword_140446DA0 )
    PoSetHiberRange(0LL, 0x10000u, qword_140446DA0, 0x58uLL, 0x7272744Du);
  v13 = *(_QWORD **)(v1 + 8);
