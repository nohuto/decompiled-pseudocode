/*
 * XREFs of IopInitializeResourceMap @ 0x1409F4BC8
 * Callers:
 *     IopInitializePlugPlayServices @ 0x1409F8468 (IopInitializePlugPlayServices.c)
 * Callees:
 *     RtlInitUnicodeString @ 0x140043CD0 (RtlInitUnicodeString.c)
 *     RtlCmEncodeMemIoResource @ 0x140189910 (RtlCmEncodeMemIoResource.c)
...
LABEL_33:
        ...
        LOBYTE(v33) = 1;
        v34 = 1;
        v5 = (unsigned int *)MmInitializeMemoryLimits(v1, (__int64)v32);
        if ( !v5 )
          goto LABEL_25;
      }
      else
