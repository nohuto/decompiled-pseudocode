/*
 * XREFs of ExCleanTimerResolutionRequest @ 0x14013D618
 * Callers:
...
__int64 __fastcall ExCleanTimerResolutionRequest(__int64 a1)
{
  ...
  v3 = Process[2].Affinity.Bitmap[17];
  v4 = (_KPROCESS **)Process[2].Affinity.Bitmap[18];
  if ( *(_KPROCESS **)(v3 + 8) != (_KPROCESS *)&Process[2].Affinity.Bitmap[17]
    || *v4 != (_KPROCESS *)&Process[2].Affinity.Bitmap[17] )
  {
    __fastfail(3u);
  }
  *v4 = (_KPROCESS *)v3;
  *(_QWORD *)(v3 + 8) = v4;
  ...
  __writecr8(v2);
  v5 = Process[2].Affinity.Bitmap[19];
  Process[2].Affinity.Bitmap[19] = 0LL;
