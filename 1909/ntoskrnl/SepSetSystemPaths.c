/*
 * XREFs of SepSetSystemPaths @ 0x140783194
 * Callers:
...
__int64 __fastcall SepSetSystemPaths(__int64 a1)
{
  ...
  v4 = *((unsigned __int16 *)CurrentServerSiloGlobals + 524) + 30LL;
  ...
  if ( PoolWithTag )
  {
    ...
    RtlStringCbPrintfW((NTSTRSAFE_PWSTR)PoolWithTag + 24, v4, L"\\??\\%ws\\System32\\", CurrentServerSiloGlobals[132]);
    RtlInitUnicodeString((PUNICODE_STRING)v6, v7);
    v8 = (wchar_t *)&v7[v4 >> 1];
    RtlStringCbPrintfW(v8, v4, L"\\??\\%ws\\SysWOW64\\", CurrentServerSiloGlobals[132]);
