/*
 * XREFs of HvWriteExternal @ 0x140833788
 * Callers:
...
__int64 __fastcall HvWriteExternal(ULONG_PTR BugCheckParameter2)
{
  ...
  _DWORD *v12; // r13
  __int64 (__fastcall *v14)(ULONG_PTR, __int64, __int64 *, __int64, _DWORD); // rax
  int v15; // ebx
  unsigned int v16; // ebx
  __int64 v17; // rax
  unsigned __int64 v18; // rax
  int v19; // r12d
  int (__fastcall *v20)(ULONG_PTR, __int64, __int64 *); // rax
...
LABEL_9:
    if ( v6 >= *(_DWORD *)(BugCheckParameter2 + 272) )
    {
      ...
      v14 = *(__int64 (__fastcall **)(ULONG_PTR, __int64, __int64 *, __int64, _DWORD))(BugCheckParameter2 + 40);
      LODWORD(v21) = 0;
      v22 = v12;
      LODWORD(v23) = 4096;
      ...
      if ( v4 )
      {
        while ( 1 )
        {
          ...
          if ( !v17 )
            KeBugCheckEx(0x51u, 1uLL, BugCheckParameter2, v16, 0xD39uLL);
          v18 = *(_QWORD *)(v17 + 8) & 0xFFFFFFFFFFFFFFF0uLL;
          v19 = *(_DWORD *)(v18 + 8);
          v22 = (_DWORD *)v18;
          v20 = *(int (__fastcall **)(ULONG_PTR, __int64, __int64 *))(BugCheckParameter2 + 40);
          LODWORD(v21) = v10;
          LODWORD(v23) = v19;
