/*
 * XREFs of NtCreateKeyTransacted_Stub @ 0x14093EA90
 * Callers:
        ...
        __int64 a8)
{
  ...
  if ( byte_14050EB50 )
  {
    v8 = (NTSTATUS (__stdcall *)(PHANDLE, ACCESS_MASK, POBJECT_ATTRIBUTES, ULONG, PUNICODE_STRING, ULONG, HANDLE, PULONG))qword_14050EB48;
  }
  else
  {
    v8 = ZwCreateKeyTransacted;
    byte_14050EB50 = 1;
    qword_14050EB48 = (__int64)ZwCreateKeyTransacted;
  }
  if ( v8 )
