/*
 * XREFs of EtwpEnableKernelTrace @ 0x1406E8458
 * Callers:
...
LABEL_57:
  ...
  {
    v14 = v27[0] | 0x2000000;
    qword_140424830 = (__int64)EtwpTraceFileIo;
    v13 = *(_DWORD *)a2;
    v27[0] |= 0x2000000u;
  }
  if ( (v13 & 0x4000000) != 0 )
  {
    v14 |= 0x4000000u;
    qword_140424828 = (__int64)EtwpTraceFileIo;
    v13 = *(_DWORD *)a2;
    v27[0] = v14;
  }
  if ( (v13 & 0x200) != 0 )
  {
    v14 |= 0x200u;
    qword_140424820 = (__int64)EtwpTraceFileName;
    v13 = *(_DWORD *)a2;
    v27[0] = v14;
  }
  if ( (v13 & 0x100) != 0 )
  {
    ...
    qword_140424810 = (__int64)EtwpTraceRedirectedIo;
    v13 = *(_DWORD *)a2;
    v27[0] = v14;
  }
  if ( (v13 & 0x400) != 0 )
  {
    v14 |= 0x400u;
    qword_140463E88 = (__int64)EtwpTraceIoInit;
    v27[0] = v14;
  }
  v15 = *((_DWORD *)a2 + 4);
  v16 = v27[4];
  ...
  {
    v16 = v27[4] | 1;
    qword_140463E90 = (__int64)EtwpTraceOpticalIo;
    v15 = *((_DWORD *)a2 + 4);
    v27[4] |= 1u;
  }
  if ( (v15 & 2) != 0 )
  {
    v16 |= 2u;
    qword_140463E98 = (__int64)EtwpTraceOpticalIoInit;
    v27[4] = v16;
  }
  ...
  {
    v16 |= 0x400000u;
    qword_1404247F0 = (__int64)EtwpTraceFltIo;
    v17 = *((_DWORD *)a2 + 4);
    v27[4] = v16;
  }
  if ( (v17 & 0x80000) != 0 )
  {
    v16 |= 0x80000u;
    qword_1404247F8 = (__int64)EtwpTraceFltIo;
    v17 = *((_DWORD *)a2 + 4);
    v27[4] = v16;
  }
  if ( (v17 & 0x100000) != 0 )
  {
    v16 |= 0x100000u;
    qword_140424800 = (__int64)EtwpTraceFltTimedIo;
    v17 = *((_DWORD *)a2 + 4);
    v27[4] = v16;
  }
  if ( (v17 & 0x200000) != 0 )
  {
    v16 |= 0x200000u;
    qword_140424808 = (__int64)EtwpTraceFltTimedIo;
    v17 = *((_DWORD *)a2 + 4);
    v27[4] = v16;
  }
  if ( (v17 & 0x1000000) != 0 )
  {
    v16 |= 0x1000000u;
    qword_14042A8C0 = (__int64)EtwpTraceWdf;
    v17 = *((_DWORD *)a2 + 4);
    v27[4] = v16;
  }
  if ( (v17 & 0x2000000) != 0 )
  {
    v16 |= 0x2000000u;
    qword_14042A8C8 = (__int64)EtwpTraceWdf;
    v27[4] = v16;
  }
  if ( (*((_DWORD *)a2 + 2) & 0x8000000) != 0 )
  {
    v27[2] |= 0x8000000u;
    qword_14042A8D0 = (__int64)EtwpSystemTraceWdf;
  }
  v18 = *(_DWORD *)a2;
...
LABEL_50:
    ...
    if ( (v19 & 0x400) != 0 )
    {
      for ( i = 0; i < EtwpPmcProfile; ++i )
        KeStartProfile((ULONG_PTR)qword_140432A88 + 248 * i);
      v27[1] = v10 | 0x400;
    }
