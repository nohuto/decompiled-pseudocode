/*
 * XREFs of BgkSetVirtualFrameBuffer @ 0x14019C3F0
 * Callers:
 *     <none>
 * Callees:
 ...
 *     BgReleaseSpinLock @ 0x140991AA0 (BgReleaseSpinLock.c)
 *     BgAcquireSpinLock @ 0x140991AB4 (BgAcquireSpinLock.c)
 *     BgGetIsColorOverridden @ 0x140991AC8 (BgGetIsColorOverridden.c)
 *     BgConvertResources @ 0x1409934CC (BgConvertResources.c)
 */
