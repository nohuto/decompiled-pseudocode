/*
 * XREFs of PopUpdateTimeouts @ 0x140725CE4
 * Callers:
...
__int64 __fastcall PopUpdateTimeouts(int a1, unsigned int *a2, unsigned int *a3)
{
  ...
  if ( a3 )
  {
    v10 = "Computed";
    if ( !*((_BYTE *)a3 + 4) )
      v10 = (const char *)qword_140794B60;
  }
  else
  {
    v10 = "NULL";
  ...
  if ( !*((_BYTE *)a2 + 5) )
    v7 = (const char *)qword_140794B60;
  if ( !*((_BYTE *)a2 + 4) )
    v9 = (const char *)qword_140794B60;
  PopPrintEx(
    3u,
    ...
    *a2,
    ...
    v6);
  result = *(_QWORD *)a2;
  qword_14043878C = *(_QWORD *)a2;
  if ( a3 )
  {
    qword_140438784 = *(_QWORD *)a3;
    result = PopDiagTraceInputTimeout(*a3, *((unsigned __int8 *)a3 + 5), *((unsigned __int8 *)a3 + 4));
  }
  if ( *((_BYTE *)a2 + 4) )
  {
    result = MEMORY[0xFFFFF78000000320];
    dword_14043879C = (MEMORY[0xFFFFF78000000320] * (unsigned __int64)MEMORY[0xFFFFF78000000004]) >> 24;
  }
  return result;
}
