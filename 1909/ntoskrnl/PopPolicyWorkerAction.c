/*
 * XREFs of PopPolicyWorkerAction @ 0x140727BB0
 * Callers:
...
__int64 PopPolicyWorkerAction()
{
  ...
  qword_140443168 = (__int64)KeGetCurrentThread();
  if ( byte_140442FC1 == 1 )
  {
    v1 = (int)qword_140442FC4;
    v2 = HIDWORD(qword_140442FC4);
    v3 = dword_140442FCC;
    ...
    if ( (PopAction & 2) != 0 )
    {
      if ( HIDWORD(qword_140442FC4) == 5 )
        v4 = 6;
      dword_140442FD4 = v4;
      dword_140442FCC = dword_140442FCC & 0x7FFFFFDC | 0x80000020;
