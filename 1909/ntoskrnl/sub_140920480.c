/*
 * XREFs of sub_140920480 @ 0x140920480
 * Callers:
...
__int64 __fastcall sub_140920480(__int64 a1, __int64 a2, __int64 a3, __int64 a4)
{
  unsigned int v6; // r8d
  unsigned int *v7; // rdx
  unsigned int *v8; // rax
...
LABEL_17:
  ...
  if ( v18 )
    v19 = v7 + 1;
  v20 = qword_1409AD3D8 ? qword_1409AD3D8(v19, v18) : -1073741637;
  v21 = *(_DWORD *)(a2 + 32);
