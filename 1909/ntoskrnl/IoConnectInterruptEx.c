/*
 * XREFs of IoConnectInterruptEx @ 0x140743110
 * Callers:
 *     <none>
 * Callees:
...
NTSTATUS __stdcall IoConnectInterruptEx(PIO_CONNECT_INTERRUPT_PARAMETERS Parameters)
{
  ...
  _DWORD v30[23]; // [rsp+7Ch] [rbp-5h] BYREF
...
LABEL_49:
      ...
      if ( (_DWORD)Version == 4 )
        ...
        Group = 0;
      if ( IopGetInterruptConnectionData(Parameters->FullySpecified.PhysicalDeviceObject, &P) >= 0 )
      {
        ...
        if ( *(_DWORD *)P )
        {
          ...
          *(_OWORD *)&v30[5] = *(_OWORD *)((char *)P + 88 * v9 + 24);
          ...
          *(_QWORD *)&v30[21] = v14;
          *(_OWORD *)&v30[17] = v15;
          if ( !_mm_cvtsi128_si32(v13) && (v30[16] & 1) != 0 )
