/*
 * XREFs of MiAddMdlTracker @ 0x1402BF5AC
 * Callers:
 ...
 *     MiGetInstructionPointer @ 0x1402BD600 (MiGetInstructionPointer.c)
 */
...
__int64 __fastcall MiAddMdlTracker(ULONG_PTR BugCheckParameter3, __int64 a2, int a3)
{
  ...
  if ( v3 || (v3 = PsInitialSystemProcess) != 0LL )
  {
    ...
    if ( v8 )
    {
      if ( *(_DWORD *)(v8 + 32) )
      {
        result = (__int64)ExAllocateFromNPagedLookasideList(&stru_140466280);
        v9 = result;
        if ( result )
        {
