/*
 * XREFs of MmGetDumpRange @ 0x1402C5E4C
 * Callers:
...
char __fastcall MmGetDumpRange(ULONG_PTR BugCheckParameter2, int a2, char a3)
{
  ...
  while ( 1 )
  {
    v15 = v14 < qword_140465E68->SizeOfBitMap ? v14 : 0;
    v16 = qword_140465E68->SizeOfBitMap - 1;
    v17 = ((__int64)qword_140465E68->Buffer & 4) != 0LL ? 0x20 : 0;
    v18 = (char *)qword_140465E68->Buffer - (((__int64)qword_140465E68->Buffer & 4) != 0 ? 4 : 0);
    while ( 1 )
    {
      v19 = v17 + v16;
      if ( v16 - v15 == -1 )
...
LABEL_22:
      ...
      if ( !v15 )
        break;
      SizeOfBitMap = v14 + 1;
      if ( v14 + 1 > qword_140465E68->SizeOfBitMap )
    ...
    if ( v25 < v14 || v25 == -1 )
      break;
    v14 = v25 + 1;
    v26 = *(_QWORD *)(qword_140465E88 + 8LL * v25);
    if ( (*(_DWORD *)(v26 + 4) & 2) != 0 )
    {
  ...
  {
    LOBYTE(v25) = 0;
    if ( 48 * qword_14046A088 - 0x58000000000LL >= 0xFFFFFA8000000000uLL )
    {
      v28 = 0LL;
      v29 = 48 * qword_14046A088 / 0x30 + 1;
      do
      {
