/*
 * XREFs of ExpWatchProductTypeInitialization @ 0x140A0A8D8
 * Callers:
...
char __fastcall ExpWatchProductTypeInitialization(__int64 a1)
{
  ...
  *(_OWORD *)&ObjectAttributes.SecurityDescriptor = 0LL;
  ...
  qword_140431F90 = (__int64)ExpWatchProductTypeWork;
  qword_140431F98 = 0LL;
    ...
    if ( PoolWithTag )
    {
      ...
      else
      {
        ...
        if ( NtQueryValueKey(ExpProductTypeKey, &ValueName, KeyValuePartialInformation, v41, 0x10u, &ResultLength) != -2147483643 )
          goto LABEL_18;
        ResultLength += 16;
        qword_14046B998 = ExAllocatePoolWithTag(PagedPool, ResultLength, 0x2079654Bu);
        if ( !qword_14046B998 )
        ...
        if ( NtQueryValueKey(
               ...
               ResultLength,
               &ResultLength) >= 0
          || (ExFreePoolWithTag(qword_14046B998, 0), qword_14046B998 = 0LL, !ExpSetupModeDetected) )
        {
LABEL_18:
          v11 = -1LL;
          do
