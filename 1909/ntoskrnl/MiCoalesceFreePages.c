/*
 * XREFs of MiCoalesceFreePages @ 0x14002BB50
 * Callers:
...
__int64 __fastcall MiCoalesceFreePages(__int64 a1)
{
  ...
  if ( MmPhysicalMemoryBlock )
  {
    ...
    v4 = *(_QWORD *)(qword_140465E88 + 8 * ((*(_QWORD *)(v1 + 40) >> 40) & 0x3FFLL));
    v46 = v4;
    ...
    while ( 2 )
    {
      if ( v6 <= 0xFFFFFFFFFLL
        && ((*v8 >> 53) & 1) != 0
        && *(_QWORD *)(qword_140465E88 + 8 * ((*(_QWORD *)(v7 + 6) >> 40) & 0x3FFLL)) == v4
        && (*(_BYTE *)v7 & 7u) <= 1 )
      {
...
LABEL_15:
              if ( v9 )
              {
                if ( v12 >= 0xFFFF800000000000uLL && byte_140467140[((v12 >> 39) & 0x1FF) - 256] == 1 )
                {
...
LABEL_42:
              ...
              if ( v13 <= 0xFFFFFFFFFLL
                ...
                && *(_QWORD *)(qword_140465E88 + 8 * ((*(_QWORD *)(v22 + 40) >> 40) & 0x3FFLL)) == v46
                && (*(_BYTE *)(v22 + 34) & 7u) <= 1
                && !_interlockedbittestandset64((volatile signed __int32 *)(v22 + 24), 0x3FuLL) )
              {
                ...
                {
                  v26 = *(_QWORD *)(v22 + 40);
                  if ( *(_QWORD *)(qword_140465E88 + 8 * ((v26 >> 40) & 0x3FF)) == v46 )
                  {
