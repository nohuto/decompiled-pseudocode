/*
 * XREFs of RtlIoDecodeMemIoResource @ 0x14018DE20
 * Callers:
 *     PnpFilterResourceRequirementsList @ 0x140767C6C (PnpFilterResourceRequirementsList.c)
 *     IopGenericScoreRequirement @ 0x1407682E0 (IopGenericScoreRequirement.c)
 *     IopGenericUnpackRequirement @ 0x140768360 (IopGenericUnpackRequirement.c)
 * Callees:
 *     <none>
 */
