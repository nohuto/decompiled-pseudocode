/*
 * XREFs of KeRemoveQueueEx @ 0x140044C00
 * Callers:
        ...
        ULONG Count)
{
  ...
  _DWORD *v16; // rcx
  $911DE60733D53BFA0F115C3A981F3323 *v17; // r14
  __int64 v18; // rbp
...
LABEL_32:
    ...
    v28 = (struct _LIST_ENTRY *)KiCommitThreadWait((__int64)CurrentThread, (__int64 *)v17, v24, v18);
