/*
 * XREFs of MiAddPrivateFixupEntryForSystemImage @ 0x140180C9C
 * Callers:
...
LABEL_7:
  ...
  v7 = ExAcquireSpinLockExclusive(&dword_1404645E4);
  v8 = (_QWORD *)qword_1404645C8;
  v9 = v7;
  if ( *(__int64 **)qword_1404645C8 != &qword_1404645C0 )
    __fastfail(3u);
  v5[1] = qword_1404645C8;
  *v5 = &qword_1404645C0;
  *v8 = v5;
  qword_1404645C8 = (__int64)v5;
  ExReleaseSpinLockExclusiveFromDpcLevel(&dword_1404645E4);
