/*
 * XREFs of PpmIdleCheckProcessorStateEligibility @ 0x1402EECE4
 * Callers:
 *     PpmIdleSelectStates @ 0x14018A5C0 (PpmIdleSelectStates.c)
 *     PpmIdleSelectCoordinatedProcessorDependency @ 0x1402EF4A8 (PpmIdleSelectCoordinatedProcessorDependency.c)
 * Callees:
 *     _guard_dispatch_icall @ 0x1401CD170 (_guard_dispatch_icall.c)
 *     PpmCheckIdleVeto @ 0x1402EE084 (PpmCheckIdleVeto.c)
 */
