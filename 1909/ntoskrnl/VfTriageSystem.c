/*
 * XREFs of VfTriageSystem @ 0x140A1E4C4
 * Callers:
 *     ViInitSystemPhase0 @ 0x140A1E29C (ViInitSystemPhase0.c)
 * Callees:
 *     DbgPrintEx @ 0x140126B10 (DbgPrintEx.c)
 *     MmTriageActiveInLastCrash @ 0x140A3C4B4 (MmTriageActiveInLastCrash.c)
 ...
 *     TriageGetBugcheckData @ 0x140A4012C (TriageGetBugcheckData.c)
 */
