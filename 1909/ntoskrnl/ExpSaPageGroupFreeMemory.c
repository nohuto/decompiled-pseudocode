/*
 * XREFs of ExpSaPageGroupFreeMemory @ 0x14016EE64
 * Callers:
...
bool __fastcall ExpSaPageGroupFreeMemory(__int64 a1, unsigned __int64 a2, unsigned int a3)
{
  ...
  __int64 v23; // rdx
  $C6908ADE9723D0A04AF8EE82D8D15C40 *v24; // rcx
...
LABEL_31:
  ...
  {
    v24 = &v16->152;
    if ( ($C6908ADE9723D0A04AF8EE82D8D15C40 *)v24->ApcState.ApcListHead[0].Flink != v24 )
