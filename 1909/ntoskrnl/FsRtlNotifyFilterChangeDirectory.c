/*
 * XREFs of FsRtlNotifyFilterChangeDirectory @ 0x1406C1170
 * Callers:
 *     FsRtlNotifyChangeDirectory @ 0x14084FB70 (FsRtlNotifyChangeDirectory.c)
 *     FsRtlNotifyFullChangeDirectory @ 0x14084FD00 (FsRtlNotifyFullChangeDirectory.c)
 * Callees:
 ...
 *     FsRtlCheckNotifyForDelete @ 0x14084FAC4 (FsRtlCheckNotifyForDelete.c)
 */
