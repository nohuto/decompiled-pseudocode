/*
 * XREFs of SecureDump_EncryptSymmetricKeyWithPublicKey @ 0x14029B4F8
 * Callers:
    ...
    if ( Property >= 0 )
    {
      ...
      if ( Property >= 0 )
      {
        ...
        else if ( pbOutput == 2048 )
        {
          ...
          if ( Property >= 0 )
          {
            qword_140464178 = ExAllocatePoolWithTag(NonPagedPoolNx, ::pcbResult, 0x706D6453u);
            if ( !qword_140464178 )
              goto LABEL_3;
