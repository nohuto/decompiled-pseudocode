/*
 * XREFs of CmpMarkIndexDirty @ 0x1406D86CC
 * Callers:
...
char __fastcall CmpMarkIndexDirty(ULONG_PTR BugCheckParameter2, unsigned int a2, unsigned int a3)
{
  ...
  if ( (*(_BYTE *)(v6 + 2) & 0x20) != 0 )
  {
    ...
    if ( PoolWithTag )
    {
      CmpCopyCompressedName((unsigned __int64)PoolWithTag, v9, v6 + 76, *(unsigned __int16 *)(v6 + 72));
      goto LABEL_5;
    }
...
LABEL_26:
  ...
  while ( 1 )
  {
    ...
    if ( *v16 != 26994 )
      break;
    if ( (int)CmpFindSubKeyInRoot(BugCheckParameter2, (__int64)v16, (int)&v21, &v23) < 0 )
    {
LABEL_24:
    ...
    if ( v23 != -1 )
    {
      if ( !HvpMarkCellDirty(BugCheckParameter2, v15, 0) )
        goto LABEL_25;
      v15 = v18;
      v16 = (_WORD *)(*(__int64 (__fastcall **)(ULONG_PTR, _QWORD, _DWORD *))(BugCheckParameter2 + 8))(
                       BugCheckParameter2,
...
LABEL_15:
  ...
  CmpFindSubKeyInLeafWithStatus(BugCheckParameter2, (__int64)v16, (unsigned __int16 *)&v21, &v23, &v24);
  if ( v24 < 0 )
    goto LABEL_24;
  (*(void (__fastcall **)(ULONG_PTR, _DWORD *))(BugCheckParameter2 + 16))(BugCheckParameter2, v20);
  if ( v23 == -1 )
  ...
  if ( v10 )
    ExFreePoolWithTag(v12, 0);
  (*(void (__fastcall **)(ULONG_PTR, _DWORD *))(BugCheckParameter2 + 16))(BugCheckParameter2, v19);
  return HvpMarkCellDirty(BugCheckParameter2, v15, 0);
}
