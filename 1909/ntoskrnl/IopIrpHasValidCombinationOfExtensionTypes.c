/*
 * XREFs of IopIrpHasValidCombinationOfExtensionTypes @ 0x14029A08C
 * Callers:
 *     IoSetAdapterCryptoEngineExtension @ 0x140299F30 (IoSetAdapterCryptoEngineExtension.c)
 *     IoSetFsTrackOffsetState @ 0x140299F80 (IoSetFsTrackOffsetState.c)
