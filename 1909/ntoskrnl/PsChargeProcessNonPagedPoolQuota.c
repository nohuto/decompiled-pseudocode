/*
 * XREFs of PsChargeProcessNonPagedPoolQuota @ 0x1400734A0
 * Callers:
...
LABEL_4:
    for ( i = v8; ; v8 = i )
    {
      v9 = v6 + a2;
      if ( v6 + a2 < v6 )
        return (unsigned int)dword_140572A04;
      if ( v9 <= v8 )
        break;
      if ( (v5 & 1) == 0 || !v4[10] )
        return (unsigned int)dword_140572A04;
  ...
  if ( (v5 & 4) != 0 )
  {
    v13 = a2 + _InterlockedExchangeAdd64((volatile signed __int64 *)(a1 + 792), a2);
    ...
    if ( v13 > v14 )
    {
      ...
      {
        v16 = v14;
        v14 = _InterlockedCompareExchange64((volatile signed __int64 *)(a1 + 808), v13, v14);
      }
