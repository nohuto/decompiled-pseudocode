/*
 * XREFs of VfDeadlockAcquireResource @ 0x14097A93C
 * Callers:
 ...
 *     VerifierKeAcquireSpinLockRaiseToDpc @ 0x140977EB0 (VerifierKeAcquireSpinLockRaiseToDpc.c)
 ...
 *     ViKeObjectAcquired @ 0x140979614 (ViKeObjectAcquired.c)
 ...
 *     VerifierExAcquireFastMutexUnsafe @ 0x1409819F0 (VerifierExAcquireFastMutexUnsafe.c)
 *     VerifierExTryToAcquireFastMutex @ 0x140981BE0 (VerifierExTryToAcquireFastMutex.c)
 * Callees:
 ...
 *     ViDeadlockSimilarNode @ 0x14097D1B0 (ViDeadlockSimilarNode.c)
 *     ViDeadlockUpdateChildrenCount @ 0x14097D254 (ViDeadlockUpdateChildrenCount.c)
  ...
  if ( *v20 != (_DWORD)v5 )
  {
    if ( ((unsigned int)(v5 - 3) > 1 || (unsigned int)(v22 - 3) > 1) && (v22 != 7 || (unsigned int)(v5 - 5) > 1) )
    {
      ViDeadlockPreprocessOptions(
        ...
        (const void *)0x1008);
      VfReportIssueWithOptions(0xC4u, 0x1008uLL, a1, *v20, v5, byte_14042B970);
LABEL_36:
      v18 = v52;
      v19 = 0;
LABEL_80:
  ...
  if ( v23 )
  {
    if ( v25 > 1u )
    {
      ...
      ViDeadlockPreprocessOptions(
        ...
        (const void *)0x1000);
      VfReportIssueWithOptions(0xC4u, 0x1000uLL, a1, (ULONG_PTR)v20, v9, &dword_14042B968);
      goto LABEL_36;
    }
    v26 = a4;
    v27 = (_QWORD *)(v23 + 8);
