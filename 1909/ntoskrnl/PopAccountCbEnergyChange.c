/*
 * XREFs of PopAccountCbEnergyChange @ 0x14073ABD0
 * Callers:
...
int PopAccountCbEnergyChange()
{
  ...
  if ( (__int64 *)qword_1404431B0 != &qword_1404431B0 )
  {
    ...
    while ( (__int64 *)v2 != &qword_1404431B0 );
    LODWORD(v17) = v3;
  }
  if ( v3 != (_DWORD)xmmword_140443368 || v1 != *((_QWORD *)&xmmword_140443368 + 1) )
  {
    v4 = v1 - *((_QWORD *)&xmmword_140443368 + 1);
    xmmword_140443368 = v17;
    if ( pCallbackContext.LevelPlus1 > 5 )
    {
      ...
      *(_QWORD *)&v17 = v4;
      ...
      if ( (unk_1404431C0 & 1) == 0 )
        v8 = "DC Power";
      if ( (unk_1404431C0 & 2) == 0 )
        v9 = "-";
      if ( (unk_1404431C0 & 4) == 0 )
        v10 = "-";
      if ( (unk_1404431C0 & 8) == 0 )
        v11 = "-";
      if ( (unk_1404431C0 & 0x10) == 0 )
        v12 = "-";
      if ( HIDWORD(qword_1404431E0) )
      {
        v16 = ((HIDWORD(qword_1404431E0) >> 1) + 100 * dword_1404431C4) / HIDWORD(qword_1404431E0);
        v13 = 100000 * (unsigned __int64)dword_1404431C4 / HIDWORD(qword_1404431E0);
      }
      else
      {
        v16 = 0;
      ...
      v49 = 4LL;
      v51 = 4LL;
      LODWORD(v1) = TlgWrite(&pCallbackContext, &unk_14038EA24, 0LL, 0LL, 0x14u, &pData);
    }
  }
  return v1;
}
