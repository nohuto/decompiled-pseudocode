/*
 * XREFs of MiWalkEntireImage @ 0x140053AF0
 * Callers:
...
__int64 __fastcall MiWalkEntireImage(ULONG_PTR a1, __int64 a2, int a3, unsigned int a4)
{
  ...
  ULONG_PTR BugCheckParameter2; // [rsp+78h] [rbp-1A0h] BYREF
  ...
  ULONG_PTR DecayPfn; // [rsp+D8h] [rbp-140h]
  ...
  v103 = a3;
  v106 = a4;
  v10 = *(_QWORD *)(qword_140465E88 + 8 * v8);
...
LABEL_37:
      ...
      if ( (*(_QWORD *)v22 & 0xC00LL) != 0x800 )
        break;
      if ( !v19 || !qword_140465800 || (v19 & qword_140465800) != 0 )
      {
        v20 = *(_QWORD *)v22;
        if ( qword_140465800 && (v19 & 0x10) == 0 )
          v20 = v19 & ~qword_140465800;
        goto LABEL_37;
      }
    }
    v21 = 0LL;
...
LABEL_26:
  ...
  else if ( qword_140465800 && (v28 & 0x10) == 0 )
  {
    v28 &= ~qword_140465800;
  }
...
LABEL_64:
  ...
  v41 = (v39 >> 40) & 0x3FF;
  v42 = *(ULONG_PTR **)(qword_140465E88 + 8 * v41);
  if ( !v40 || (unsigned int)MiChargeCommit(*(_QWORD *)(qword_140465E88 + 8 * v41), 1uLL, 4u) )
  {
...
LABEL_91:
  if ( v33 != 8 && !DecayPfn && (v9 & 1) == 0 )
    DecayPfn = MiCreateDecayPfn(v33);
  ...
  if ( !v25 )
  {
    ...
    v57 = BugCheckParameter2 + 16;
    if ( BugCheckParameter2 + 16 >= 0xFFFFF6FB7DBED000uLL && v57 <= 0xFFFFF6FB7DBED7F8uLL && (MiFlags & 0xC00000) != 0 )
    {
        ...
        && ((v56 & 0x20) == 0 || (v56 & 0x42) == 0) )
      {
        ...
        if ( v82 )
        {
          ...
          v84 = v56 | 0x20;
          if ( (v83 & 0x20) == 0 )
            v84 = *(_QWORD *)(BugCheckParameter2 + 16);
          v56 = v84;
          if ( (v83 & 0x42) != 0 )
            v56 = v84 | 0x42;
        }
    ...
    if ( (v56 & 0x400) == 0 )
    {
      ...
      v51 = *(_QWORD *)(qword_140465E88 + 8 * ((*(_QWORD *)(v55 + 40) >> 40) & 0x3FFLL));
    }
  }
  ...
  if ( (unsigned int)MiRemoveLockedPageCharge(v55) )
  {
    ...
    {
      MiInsertAndUnlockStandbyPages(DecayPfn, (__int64 *)&BugCheckParameter2, 1u, CurrentIrql);
      v101[0] = 17;
    }
  }
