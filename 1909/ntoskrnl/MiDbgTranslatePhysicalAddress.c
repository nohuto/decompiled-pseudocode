/*
 * XREFs of MiDbgTranslatePhysicalAddress @ 0x1402D0EBC
 * Callers:
 ...
 *     MiCheckPhysicalAddressRange @ 0x1402D0380 (MiCheckPhysicalAddressRange.c)
...
unsigned __int64 __fastcall MiDbgTranslatePhysicalAddress(unsigned __int64 a1, char a2, __int64 a3)
{
  ...
  v3 = qword_1404660C8;
  v6 = a1;
  if ( !qword_1404660C8 || !(unsigned int)MiCheckPhysicalAddressRange(a1, 1LL) )
    return 0LL;
  v8 = v7 >> 12;
  v9 = v3 << 25 >> 16;
  *(_DWORD *)a3 = 0;
  ...
  *(_BYTE *)(a3 + 4) = CurrentIrql;
  ...
  {
    *(_DWORD *)a3 = 8;
    if ( !(unsigned int)ExTryAcquireSpinLockExclusiveAtDpcLevel(&dword_140466480) )
      return 0LL;
  }
  else
  {
...
LABEL_67:
  v25 = v10 | 0xA0000000;
  v26 = (volatile signed __int64 *)qword_1404660C8;
  ValidPte = MiMakeValidPte(qword_1404660C8, v8, v25);
  if ( (a2 & 0x41) != 0 )
    byte_1404660C0 = 1;
