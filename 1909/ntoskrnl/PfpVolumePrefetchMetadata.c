/*
 * XREFs of PfpVolumePrefetchMetadata @ 0x1406AB18C
 * Callers:
 ...
 *     PfpFileSetupObjectAttributes @ 0x14062B3BC (PfpFileSetupObjectAttributes.c)
...
LABEL_52:
      ...
      if ( v18 < 0 )
        goto LABEL_15;
      if ( v18 == 259 )
        KeBugCheckEx(0x191u, 0x15F9uLL, 0LL, 0LL, 0LL);
      v8 = v39;
    }
        ...
        while ( 1 )
        {
          *(_DWORD *)(Src + 4) = 0;
          ...
          if ( v18 < 0 )
            goto LABEL_15;
          if ( v18 == 259 )
            KeBugCheckEx(0x191u, 0x165EuLL, 0LL, 0LL, 0LL);
          if ( v23 >= *(_DWORD *)(v6 + 16) )
            break;
          v22 = v47;
        }
