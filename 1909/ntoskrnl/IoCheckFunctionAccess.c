/*
 * XREFs of IoCheckFunctionAccess @ 0x140714300
 * Callers:
 *     <none>
 * Callees:
 *     SeSetSecurityAccessMask @ 0x1406215B0 (SeSetSecurityAccessMask.c)
 *     SeQuerySecurityAccessMask @ 0x1406BD710 (SeQuerySecurityAccessMask.c)
 */
