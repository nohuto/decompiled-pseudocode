/*
 * XREFs of PopFxInitializeSocSubsystemStaticInfo @ 0x1408A5370
 * Callers:
...
__int64 __fastcall PopFxInitializeSocSubsystemStaticInfo(unsigned int a1)
{
  ...
  _BYTE v23[56]; // [rsp+30h] [rbp-A1h] BYREF
  unsigned int v24; // [rsp+68h] [rbp-69h] BYREF
  __int64 v25; // [rsp+6Ch] [rbp-65h]
  wchar_t pszDest[64]; // [rsp+78h] [rbp-59h] BYREF

  memset(v23, 0, sizeof(v23));
  memset(pszDest, 0, sizeof(pszDest));
  if ( PopFxProcessorPlugin && (v24 = a1, v25 = 0LL, (unsigned __int8)PopPluginQuerySocSubsystemCount(v2, &v24)) )
  {
    v4 = v25;
    ...
    if ( PoolWithTag )
    {
      ...
      if ( v4 )
      {
        while ( 1 )
        {
          ...
          *(_DWORD *)v23 = a1;
          *(_QWORD *)&v23[8] = 0LL;
          *(_DWORD *)&v23[4] = v5[v10 + 14];
          *(_OWORD *)&v23[16] = *(_OWORD *)&v5[v10 + 6];
          v11 = *(_OWORD *)&v5[v10 + 10];
          *(_QWORD *)&v23[48] = 0LL;
          *(_OWORD *)&v23[32] = v11;
          PopPluginInitializeSocSubsystemStaticInfo(v8, v23);
          LOWORD(v5[v10 + 10]) = *(_WORD *)&v23[32];
          LOWORD(v5[v10 + 6]) = *(_WORD *)&v23[16];
          *(_QWORD *)&v5[v10 + 16] = *(_QWORD *)&v23[8];
          v5[v10 + 26] = *(_DWORD *)&v23[48];
...
LABEL_18:
      ...
      if ( v3 )
        goto LABEL_29;
      v20 = (unsigned int **)qword_1404443C8;
      if ( *(__int64 **)qword_1404443C8 != &SocSubsystemsList )
        __fastfail(3u);
      *(_QWORD *)v5 = &SocSubsystemsList;
      *((_QWORD *)v5 + 1) = v20;
      *v20 = v5;
      qword_1404443C8 = (__int64)v5;
    }
    else
    {
