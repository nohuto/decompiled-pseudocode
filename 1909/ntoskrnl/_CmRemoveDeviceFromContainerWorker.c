/*
 * XREFs of _CmRemoveDeviceFromContainerWorker @ 0x140936FC4
 * Callers:
      ...
      if ( CachedContextBaseKey >= 0 )
      {
        ...
        if ( CachedContextBaseKey >= 0 )
        {
          *(_QWORD *)&DestinationString.Length = 0LL;
          ...
          CachedContextBaseKey = PnpCtxRegQueryInfoKey(v13, KeyHandle, 0LL, 0LL, (__int64)&v18, 0LL, 0LL);
          if ( CachedContextBaseKey >= 0 )
          {
            if ( !v18 )
            {
            ...
            CachedContextBaseKey = PnpCtxRegQueryInfoKey(v14, Handle, (__int64)&v18, 0LL, 0LL, 0LL, 0LL);
            if ( CachedContextBaseKey >= 0 )
            {
              if ( !v18 )
              {
