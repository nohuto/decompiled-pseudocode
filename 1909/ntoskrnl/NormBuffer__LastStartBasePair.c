/*
 * XREFs of NormBuffer__LastStartBasePair @ 0x1403135DC
 * Callers:
 ...
 *     Normalization__GetSecondDecomposedCharPlane0 @ 0x1408D63E4 (Normalization__GetSecondDecomposedCharPlane0.c)
 */
