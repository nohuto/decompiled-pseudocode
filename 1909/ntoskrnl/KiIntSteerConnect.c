/*
 * XREFs of KiIntSteerConnect @ 0x14017CD2C
 * Callers:
...
__int64 __fastcall KiIntSteerConnect(_QWORD *a1, unsigned int a2, __int64 a3)
{
  ...
  {
    v35 = *(_DWORD *)(a3 + 56);
    if ( (unsigned __int8)off_1404244C0[0]() )
    {
      v7 = 0;
      v27 = ((__int64 (__fastcall *)(__int64, int *))off_1404244A8[0])(a3, &v35);
      if ( !v27 )
        goto LABEL_33;
    }
    else
      ...
      if ( i )
      {
        ...
        if ( v16 >= 0 )
        {
          ...
          *(_OWORD *)(i + 13) = *(_OWORD *)(a3 + 64);
          ...
          v22 = (ULONG_PTR **)qword_140446B38;
          if ( *(ULONG_PTR **)qword_140446B38 != &KiIntTrackRootList )
            goto LABEL_48;
          *i = (ULONG_PTR)&KiIntTrackRootList;
          i[1] = (ULONG_PTR)v22;
          *v22 = i;
          ++KiIntTrackRootCount;
          qword_140446B38 = (__int64)i;
