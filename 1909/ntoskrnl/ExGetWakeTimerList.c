/*
 * XREFs of ExGetWakeTimerList @ 0x14033B030
 * Callers:
...
LABEL_15:
  ...
  if ( v11 && ($C6908ADE9723D0A04AF8EE82D8D15C40 *)v5->ApcState.ApcListHead[0].Flink != &v5->152 )
...
LABEL_64:
  ...
  if ( (__int64)v33->LockState.LockState < 0 )
    KiAbEntryRemoveFromTree((__int64)&v27->LockEntries[v32]);
...
LABEL_71:
  ...
  if ( v11 && ($C6908ADE9723D0A04AF8EE82D8D15C40 *)v27->ApcState.ApcListHead[0].Flink != &v27->152 )
    KiCheckForKernelApcDelivery(1LL);
