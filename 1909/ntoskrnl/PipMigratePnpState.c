/*
 * XREFs of PipMigratePnpState @ 0x140A212F4
 * Callers:
...
LABEL_32:
              v26 = 259;
              CachedContextBaseKey = PnpCtxRegSetValue(v3, v16, (__int64)L"MigrationStatus", 4LL, (__int64)&v26, 4u);
              if ( CachedContextBaseKey < 0 )
                goto LABEL_3;
              CachedContextBaseKey = PnpCtxRegSetValue(v3, v15, (__int64)L"MigrationTime", 3LL, (__int64)&Source2, 8u);
              if ( CachedContextBaseKey < 0 )
                goto LABEL_3;
              v24 = 4;
              v0 = 1;
              ...
              CachedContextBaseKey = PnpCtxRegCopyTree(v3, (int)v17, 0, (int)v20, 0LL);
              if ( CachedContextBaseKey < 0 )
                goto LABEL_50;
              v9 = PnpCtxRegOpenKey(
                     *(__int64 *)&PiPnpRtlCtx,
...
LABEL_50:
              ...
              PnpCtxRegSetValue(v3, v16, (__int64)L"MigrationStatus", 4LL, (__int64)&v26, 4u);
              goto LABEL_51;
            }
          }
          CachedContextBaseKey = -1073741823;
