/*
 * XREFs of NtCreateJobObject @ 0x140689AC0
 * Callers:
 *     <none>
 * Callees:
...
NTSTATUS __stdcall NtCreateJobObject(PHANDLE JobHandle, ACCESS_MASK DesiredAccess, POBJECT_ATTRIBUTES ObjectAttributes)
{
  ...
  v6 = CurrentThread->$24A664F1AFBF48775CBEA2BECCC9B900::gap0[10];
  if ( v6 )
  {
    v7 = 0x7FFFFFFF0000LL;
  ...
  *JobHandle = 0LL;
  ...
  else
  {
    ...
    *(_QWORD *)&v12[53].Header.Lock = (char *)v12 + 1264;
    ...
    v13 = v12 + 1;
    v14 = (struct _LIST_ENTRY *)qword_1409AD390;
    if ( *(__int64 **)qword_1409AD390 != &PspJobList )
      __fastfail(3u);
    *(_QWORD *)&v13->Header.Lock = &PspJobList;
    v12[1].Header.WaitListHead.Flink = v14;
    v14->Flink = (struct _LIST_ENTRY *)v13;
    qword_1409AD390 = (__int64)&v12[1];
    ...
    if ( inserted >= 0 )
    {
      ...
      if ( v15 )
        HIDWORD(v12[50].Header.WaitListHead.Blink) = v15;
      else
        inserted = -1073741670;
    }
