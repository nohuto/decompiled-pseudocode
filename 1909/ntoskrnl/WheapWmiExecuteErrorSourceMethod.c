/*
 * XREFs of WheapWmiExecuteErrorSourceMethod @ 0x1403422F4
 * Callers:
...
LABEL_28:
  ...
  else
  {
    ...
    if ( !dword_1404F27DC )
      goto LABEL_35;
    v14 = 972 * dword_1404F27DC + 12;
    if ( v14 > a2 )
      goto LABEL_37;
    *a3 = 0;
    v38 = (unsigned int *)(a3 + 1);
    v39 = (__int64 *)qword_1404F27E8;
    v40 = a3 + 2;
    v41 = a3 + 3;
    v42 = 0;
    for ( i = 0; v39 != &qword_1404F27E8; v39 = (__int64 *)*v39 )
    {
      if ( i >= dword_1404F27DC )
        break;
      v44 = v41;
      v45 = v39 + 12;
      v46 = 7LL;
