/*
 * XREFs of EtwpCoverageSamplerReadyThread @ 0x140336100
 * Callers:
...
char __fastcall EtwpCoverageSamplerReadyThread(__int64 a1)
{
  ...
  if ( *(struct _KTHREAD **)qword_140432528 != CurrentThread && *(_QWORD *)qword_140432528 != a1 )
  {
    CurrentPrcb = KeGetCurrentPrcb();
    CurrentThread = KeGetCurrentThread();
    if ( CurrentThread != CurrentPrcb->IdleThread || CurrentPrcb->NestingLevel > 1u )
    {
      v3 = (*(_QWORD *)(qword_140432528 + 8) >> 4) & 0x1FFLL;
      v4 = ((unsigned int)*(_QWORD *)(qword_140432528 + 8) >> 13) & 0x3FFFF;
