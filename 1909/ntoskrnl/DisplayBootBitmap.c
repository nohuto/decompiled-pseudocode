/*
 * XREFs of DisplayBootBitmap @ 0x14018AF08
 * Callers:
 *     DisplayFilter @ 0x14027B6F0 (DisplayFilter.c)
 ...
 *     RotBarInit @ 0x140291E1C (RotBarInit.c)
...
int __fastcall DisplayBootBitmap(char a1)
{
  ...
  if ( a1 )
  {
    ...
    if ( qword_140467F68 )
    {
      v3 = *(__int64 (__fastcall **)(_QWORD, _QWORD, _QWORD))(qword_140467F68 + 72);
      if ( v3 )
      {
...
LABEL_29:
  ...
  qword_140467F70 = (__int64)DisplayFilter;
  ...
  if ( v7 )
  {
    ...
    if ( qword_140467F68 )
    {
      v10 = *(void (__fastcall **)(__int64, _QWORD, _QWORD))(qword_140467F68 + 96);
      if ( v10 )
      {
        v10(v7, 0LL, 0LL);
        v5 = qword_140467F68;
