/*
 * XREFs of ?BTreeSearchResultDeref@?$B_TREE@KU_ST_HASH_ENTRY@?$ST_STORE@USM_TRAITS@@@@$0BAAA@UNP_CONTEXT@@UST_HASH_ENTRY_COMPARATOR@2@@@SAXPEAU1@PEAUSEARCH_RESULT@1@@Z @ 0x14011BBB0
 * Callers:
        ...
        __int64 a2)
{
  ...
  void **v24; // rax
  _QWORD v25[5]; // [rsp+20h] [rbp+0h] BYREF
