/*
 * XREFs of VfXdvExcludeParseRegistryString @ 0x140A3E41C
 * Callers:
      ...
      do
      {
        ...
        else
        {
          ...
          if ( v7 )
          {
            ...
            {
              VfDriverLock();
              v9 = (_QWORD *)qword_140435948;
              if ( *(__int64 **)qword_140435948 != &VfXdvExcludedDriversList )
                __fastfail(3u);
              *v8 = &VfXdvExcludedDriversList;
              v8[1] = v9;
              *v9 = v8;
              qword_140435948 = (__int64)v8;
