/*
 * XREFs of SmpParseCommandLine @ 0x140001930
 * Callers:
 ...
 *     SmpExpandEnvironmentString @ 0x140001E5C (SmpExpandEnvironmentString.c)
 *     SmpQueryEnvVariable @ 0x140002270 (SmpQueryEnvVariable.c)
