/*
 * XREFs of SmpInitializeKnownDllsInternal @ 0x140007D20
 * Callers:
 *     SmpInitializeKnownDlls @ 0x1400082A0 (SmpInitializeKnownDlls.c)
 * Callees:
 *     SmpRandomizeDllList @ 0x140008170 (SmpRandomizeDllList.c)
...
LABEL_27:
      ...
      if ( *((PVOID **)v32 + 1) != &v32
        || *v33 != &v32
        || (*v33 = v32, v25[1] = v26, v27 = qword_140022248, *((PVOID **)SmpKnownDllsList + 1) != &SmpKnownDllsList)
        || *(PVOID **)qword_140022248 != &SmpKnownDllsList
        || *(_QWORD **)(*v25 + 8LL) != v25
        || *v26 != v25 )
      {
LABEL_38:
      ...
      *(_QWORD *)qword_140022248 = v25;
      qword_140022248 = v25[1];
