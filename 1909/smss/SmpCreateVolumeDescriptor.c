/*
 * XREFs of SmpCreateVolumeDescriptor @ 0x140006DC0
 * Callers:
 ...
 *     SmpIsVhdVolume @ 0x140007414 (SmpIsVhdVolume.c)
...
LABEL_33:
  ...
  *(_QWORD *)(v7 + 32) = v10;
  ...
  if ( (v12 & 1) == 0 )
  {
    v14 = (__int64 *)qword_140022578;
    if ( *(__int64 **)qword_140022578 == &SmpVolumeDescriptorList )
    {
