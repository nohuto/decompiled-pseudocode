/*
 * XREFs of SmpStartCsr @ 0x140004B40
 * Callers:
 ...
 *     SmpAllocateControlBlock @ 0x140002DEC (SmpAllocateControlBlock.c)
 ...
 *     SmpRecordControlBlock @ 0x140004DEC (SmpRecordControlBlock.c)
    ...
    if ( CoreProcessIds >= 0 )
    {
      ...
      if ( v7 >= 0 )
      {
        ...
        *((_DWORD *)v4 + 2) = ProcessInformation;
        v10 = _InterlockedIncrement(&dword_140022A50);
        if ( v10 > SmpNumberInitialSessions )
          _InterlockedDecrement(&dword_140022A50);
        else
