/*
 * XREFs of SmpSavePageFile @ 0x140011B2C
 * Callers:
 *     SmpCheckForCrashDump @ 0x14000B264 (SmpCheckForCrashDump.c)
 *     SmpSaveOldPageFile @ 0x140011980 (SmpSaveOldPageFile.c)
 * Callees:
 *     RtlStringCbCopyW @ 0x140007C8C (RtlStringCbCopyW.c)
 ...
 *     SmpSetEndOfFile @ 0x140011E98 (SmpSetEndOfFile.c)
 */
