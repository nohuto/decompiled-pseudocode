/*
 * XREFs of ?ReportStopActivity@?$ActivityBase@VShellPlacementLogging@Logging@CreativeFramework@@$00$0A@$04$0A@U_TlgReflectorTag_Param0IsProviderType@@@wil@@AEAAXJ@Z @ 0x180030C68
 * Callers:
  ...
  if ( a2 < 0 )
  {
    ...
    if ( v6 )
    {
        ...
        && (*((_QWORD *)v7 + 3) & 0x200000000000LL) == *((_QWORD *)v7 + 3) )
      {
        ...
        v75 = 2 * v11 + 2;
        v76 = 0;
        TlgWrite(v8, &unk_18016BA4D, (LPCGUID)(*((_QWORD *)this + 6) + 8LL), 0LL, 0x11u, &pData);
      }
    }
           ...
           && (*((_QWORD *)v7 + 3) & 0x200000000000LL) == *((_QWORD *)v7 + 3) )
    {
      ...
      v88 = 2 * v28 + 2;
      v89 = 0;
      TlgWrite(v8, &unk_18016C242, (LPCGUID)(v26 + 8), 0LL, 7u, &v77);
    }
  }
