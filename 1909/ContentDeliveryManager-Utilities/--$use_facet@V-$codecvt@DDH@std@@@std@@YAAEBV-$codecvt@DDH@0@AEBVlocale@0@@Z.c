/*
 * XREFs of ??$use_facet@V?$codecvt@DDH@std@@@std@@YAAEBV?$codecvt@DDH@0@AEBVlocale@0@@Z @ 0x1800AFDE8
 * Callers:
 ...
 *     ?_Getcat@?$codecvt@DDH@std@@SA_KPEAPEBVfacet@locale@2@PEBV42@@Z @ 0x1800B0B20 (-_Getcat@-$codecvt@DDH@std@@SA_KPEAPEBVfacet@locale@2@PEBV42@@Z.c)
