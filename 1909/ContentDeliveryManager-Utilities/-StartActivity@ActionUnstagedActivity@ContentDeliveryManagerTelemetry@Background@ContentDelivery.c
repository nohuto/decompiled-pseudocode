/*
 * XREFs of ?StartActivity@ActionUnstagedActivity@ContentDeliveryManagerTelemetry@Background@ContentDeliveryManager@@QEAAXPEBG00@Z @ 0x18004E2D0
 * Callers:
        ...
        const unsigned __int16 *a4)
{
    ...
    && (*((_QWORD *)v8 + 3) & 0x200000000000LL) == *((_QWORD *)v8 + 3) )
  {
    ...
    TlgWrite(v8, &unk_18016D906, (LPCGUID)(v15 + 8), v16, 7u, &pData);
  }
  if ( !*((_DWORD *)this + 8) )
