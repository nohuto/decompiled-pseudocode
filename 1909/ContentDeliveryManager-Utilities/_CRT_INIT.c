/*
 * XREFs of _CRT_INIT @ 0x1800CA59C
 * Callers:
 *     __DllMainCRTStartup @ 0x1800CA824 (__DllMainCRTStartup.c)
 * Callees:
 *     _amsg_exit_0 @ 0x1800CB385 (_amsg_exit_0.c)
 *     _IsNonwritableInCurrentImage @ 0x1800CB3F0 (_IsNonwritableInCurrentImage.c)
 *     _initterm_0 @ 0x1800CB55E (_initterm_0.c)
