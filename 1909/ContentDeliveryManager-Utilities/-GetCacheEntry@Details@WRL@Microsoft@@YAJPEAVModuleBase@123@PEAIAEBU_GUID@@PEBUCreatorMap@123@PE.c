/*
 * XREFs of ?GetCacheEntry@Details@WRL@Microsoft@@YAJPEAVModuleBase@123@PEAIAEBU_GUID@@PEBUCreatorMap@123@PEAPEAUIUnknown@@@Z @ 0x18001F248
 * Callers:
 *     DllGetClassObject @ 0x180020450 (DllGetClassObject.c)
 *     DllGetActivationFactory @ 0x180020520 (DllGetActivationFactory.c)
 * Callees:
