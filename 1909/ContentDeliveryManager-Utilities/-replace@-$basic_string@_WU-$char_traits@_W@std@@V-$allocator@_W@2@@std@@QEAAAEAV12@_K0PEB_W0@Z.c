/*
 * XREFs of ?replace@?$basic_string@_WU?$char_traits@_W@std@@V?$allocator@_W@2@@std@@QEAAAEAV12@_K0PEB_W0@Z @ 0x180076F94
 * Callers:
...
LABEL_37:
    if ( v6 < a5 )
    {
      v18 = v8[3] < 8uLL ? v8 : (_QWORD *)*v8;
      v19 = v8[3] < 8uLL ? v8 : (_QWORD *)*v8;
      if ( v13 )
        memmove_0((char *)v19 + 2 * a2 + 2 * a5, (char *)v18 + 2 * a2 + 2 * v6, 2 * v13);
    }
    v20 = v8[3];
    if ( v20 < 8 )
      v21 = (char *)v8;
