        ...
        __int64 a4)
{
  ...
  __int64 v43; // rdi
  _QWORD *iter; // rax
  _QWORD v45[10]; // [rsp+28h] [rbp-50h] BYREF
  ...
  if ( v13[v12] == *a1 )
    ...
    v14 = *(_QWORD **)v13[v12 + 1];
  do
  {
    if ( v14 == (_QWORD *)v13[v12] )
      goto LABEL_51;
    v14 = (_QWORD *)v14[1];
    v15 = v14 + 2;
    v16 = v14[4];
...
LABEL_22:
  ...
  for ( k = v24 == 0; ; k = v24 == 0 )
  {
    ...
    if ( *(_WORD *)v22 != *(_WORD *)v5 )
      break;
    v22 = (_QWORD *)((char *)v22 + 2);
    v5 = (_QWORD *)((char *)v5 + 2);
    --v24;
  }
  v26 = *(_WORD *)v22 < *(_WORD *)v5 ? -1 : 1;
LABEL_41:
  v27 = v23 != v8;
  if ( v23 < v8 )
    v27 = -1;
...
LABEL_51:
    ...
    {
      v34 = (__int64 *)v32[v12 + 1];
      v35 = *v34;
      v32[v12 + 1] = *v34;
      if ( v35 != a4 )
        *(_QWORD *)(a1[2] + 8 * v12 + 8) = *(_QWORD *)(*(_QWORD *)(a1[2] + 8 * v12 + 8) + 8LL);
    }
    v36 = a1[1];
    v37 = a1[6];
    v38 = (float)(int)v36;
    if ( v36 < 0 )
      v38 = v38 + 1.8446744e19;
    v39 = (float)(int)v37;
    if ( v37 < 0 )
      v39 = v39 + 1.8446744e19;
    if ( (float)(v38 / v39) > *((float *)a1 + 14) )
    {
      if ( (unsigned __int64)v37 >= 0x200 )
      {
        if ( (unsigned __int64)v37 < 0xFFFFFFFFFFFFFFFLL )
          v37 *= 2LL;
      }
      else
      {
