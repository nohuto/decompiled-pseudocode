/*
 * XREFs of _wil::CallAndWaitForCompletion_Windows::Storage::IStorageFileStatics_HSTRING_____Windows::Foundation::IAsyncOperation_Windows::Storage::StorageFile________HSTRING______::_1_::dtor$2 @ 0x1800D155B
 * Callers:
 *     <none>
 * Callees:
