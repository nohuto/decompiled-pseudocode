        ...
        __int64 a5)
{
  ...
  {
    v8 = v9;
    v11 = std::less<std::wstring>::operator()(a1, a4, v9 + 4);
    v10 = v11;
    if ( v11 )
      v9 = (__int64 *)*v9;
    else
  ...
  try
  {
    ...
    if ( v10 )
    {
      ...
      std::_Tree_const_iterator<std::_Tree_val<std::_Tree_simple_types<std::pair<std::wstring const,std::wstring>>>>::operator--(&v16);
      v12 = v16;
    }
    if ( (unsigned __int8)std::less<std::wstring>::operator()(a1, v12 + 4, a4) )
    {
      *(_QWORD *)a2 = *(_QWORD *)std::_Tree<std::_Tmap_traits<std::wstring,std::wstring,std::less<std::wstring>,std::allocator<std::pair<std::wstring const,std::wstring>>,0>>::_Insert_at<std::pair<std::wstring const,std::wstring> &,std::_Tree_node<std::pair<std::wstring const,std::wstring>,void *> *>(
                                   a1,
                                   (unsigned int)&v16,
