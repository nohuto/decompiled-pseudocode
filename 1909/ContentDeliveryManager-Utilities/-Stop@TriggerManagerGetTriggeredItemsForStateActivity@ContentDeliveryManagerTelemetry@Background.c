/*
 * XREFs of ?Stop@TriggerManagerGetTriggeredItemsForStateActivity@ContentDeliveryManagerTelemetry@Background@ContentDeliveryManager@@QEAAXIPEBD@Z @ 0x180063AA4
 * Callers:
  ...
  if ( v7 )
  {
    ...
    **((_DWORD **)this + 6) = 2;
    ...
    if ( *(_DWORD *)v9 > 5u )
    {
      ...
      v96 = a3;
      v97 = v12 + 1;
      TlgWrite(v9, &unk_18016DF99, (LPCGUID)(*((_QWORD *)this + 6) + 8LL), 0LL, 0x17u, &pData);
    }
  }
  else
  {
    ...
    **((_DWORD **)this + 6) = 2;
    ...
    if ( *(_DWORD *)v31 > 5u )
    {
      ...
      if ( !a3 )
        a3 = (const char *)&word_1800FD7D0;
      v108 = a3;
      TlgWrite(v31, &unk_18016DDA7, (LPCGUID)(*((_QWORD *)this + 6) + 8LL), 0LL, 7u, &v99);
    }
  }
  if ( *((_DWORD *)this + 8) )
  {
