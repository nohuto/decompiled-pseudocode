/*
 * XREFs of ??$LayoutAndItemsRetrieved@_NII@LayoutResolver@ShellPlacementTelemetry@Logging@CreativeFramework@@QEAAX$$QEA_N$$QEAI1@Z @ 0x1800A50DC
 * Callers:
        ...
        __int64 a4)
{
  ...
  if ( *(_DWORD *)v8 > 5u )
  {
    ...
    v15 = a4;
    v16 = 4LL;
    LODWORD(v8) = TlgWrite(v8, &unk_18016F5D1, (LPCGUID)(*(_QWORD *)(a1 + 48) + 8LL), 0LL, 5u, &pData);
  }
  return (int)v8;
}
