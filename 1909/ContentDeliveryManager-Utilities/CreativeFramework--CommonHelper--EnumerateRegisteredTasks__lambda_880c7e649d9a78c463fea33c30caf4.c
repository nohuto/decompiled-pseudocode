/*
 * XREFs of CreativeFramework::CommonHelper::EnumerateRegisteredTasks__lambda_880c7e649d9a78c463fea33c30caf4e7___ @ 0x1800AC6E8
 * Callers:
...
LABEL_31:
  ...
  v31 = 0LL;
  ActivationFactory = RoGetActivationFactory(string, &GUID_4c542f69_b000_42ba_a093_6a563c65e3f8, &v31);
  v4 = retaddr;
...
LABEL_32:
  ...
  v5 = *v31;
  v32 = 0LL;
  v6 = (*(__int64 (__fastcall **)(__int64 *, __int64 *))(v5 + 48))(v31, &v32);
  v7 = retaddr;
  if ( v6 < 0 )
  {
LABEL_33:
  ...
  v33 = 0LL;
  v8 = (**(__int64 (__fastcall ***)(__int64, GUID *, HSTRING *))v32)(
         v32,
...
LABEL_18:
  ...
  if ( v31 )
    return (*(__int64 (__fastcall **)(__int64 *))(*v31 + 16))(v31);
  return result;
}
