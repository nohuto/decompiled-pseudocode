/*
 * XREFs of ?ProcessShutdown@FeatureStateData@details_abi@wil@@QEAAXXZ @ 0x180008684
 * Callers:
 ...
 * Callees:
 *     ?Swap@RawUsageIndex@details_abi@wil@@QEAAXAEAV123@@Z @ 0x18000723C (-Swap@RawUsageIndex@details_abi@wil@@QEAAXAEAV123@@Z.c)
