/*
 * XREFs of __GSHandlerCheck_EH @ 0x1800CB2B8
 * Callers:
 *     <none>
 * Callees:
 *     __CxxFrameHandler3_0 @ 0x1800CAA76 (__CxxFrameHandler3_0.c)
 *     __GSHandlerCheckCommon @ 0x1800CB224 (__GSHandlerCheckCommon.c)
 */
