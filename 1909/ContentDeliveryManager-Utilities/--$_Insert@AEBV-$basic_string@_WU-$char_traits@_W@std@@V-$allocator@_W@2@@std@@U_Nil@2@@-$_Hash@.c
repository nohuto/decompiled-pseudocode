 ...
 * Callees:
 *     ?_Check_size@?$_Hash@V?$_Uset_traits@V?$basic_string@_WU?$char_traits@_W@std@@V?$allocator@_W@2@@std@@V?$_Uhash_compare@V?$basic_string@_WU?$char_traits@_W@std@@V?$allocator@_W@2@@std@@U?$hash@V?$basic_string@_WU?$char_traits@_W@std@@V?$allocator@_W@2@@std@@@2@U?$equal_to@V?$basic_string@_WU?$char_traits@_W@std@@V?$allocator@_W@2@@std@@@2@@2@V?$allocator@V?$basic_string@_WU?$char_traits@_W@std@@V?$allocator@_W@2@@std@@@2@$0A@@std@@@std@@IEAAXXZ @ 0x180089550 (-_Check_size@-$_Hash@V-$_Uset_traits@V-$basic_string@_WU-$char_traits@_W@std@@V-$allocator@_W@2@.c)
        ...
        _QWORD *a3)
{
  ...
  v12 = a1[2];
  v13 = *a1;
  if ( (__int64 *)v12[v11] == *a1 )
    v14 = *a1;
  else
    v14 = *(__int64 **)v12[v11 + 1];
  if ( v14 == (__int64 *)v12[v11] )
  {
LABEL_53:
    v28 = *v13;
    v29 = std::_List_buy<std::wstring>::_Buynode<std::wstring const &>(v9, *v13, *(_QWORD *)(*v13 + 8), a3, -2LL);
    v30 = a1[1];
    ...
    **(_QWORD **)(v29 + 8) = v29;
    ...
    v35 = a1[2];
    if ( (__int64 *)v35[v11] == v31 )
    {
      v35[v11] = v32;
      v36 = a1[2];
      v36[v11 + 1] = v32;
    }
    else if ( (__int64 *)v35[v11] == v14 )
    {
      v35[v11] = v32;
    }
    else
    {
      v37 = (__int64 *)v35[v11 + 1];
      v38 = *v37;
      v35[v11 + 1] = *v37;
      if ( v38 != v32 )
      {
