/*
 * XREFs of _Strcoll @ 0x1800CA0B0
 * Callers:
 *     ?do_compare@?$collate@D@std@@MEBAHPEBD000@Z @ 0x1800C7E70 (-do_compare@-$collate@D@std@@MEBAHPEBD000@Z.c)
 * Callees:
 *     _GetLocaleHandleByColl @ 0x1800B766C (_GetLocaleHandleByColl.c)
 *     _GetLocaleHandleById @ 0x1800B7678 (_GetLocaleHandleById.c)
 *     __crtCompareStringA_Stub @ 0x1800B76FC (__crtCompareStringA_Stub.c)
