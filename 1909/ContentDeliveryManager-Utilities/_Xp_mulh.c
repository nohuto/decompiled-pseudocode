/*
 * XREFs of _Xp_mulh @ 0x1800B70D4
 * Callers:
 *     _Xp_mulx @ 0x1800B72C8 (_Xp_mulx.c)
 * Callees:
 *     _Dscale @ 0x1800B69BC (_Dscale.c)
 *     _Xp_addh @ 0x1800B6C48 (_Xp_addh.c)
 *     _Feraise @ 0x1800C9AA8 (_Feraise.c)
 *     _Dtest @ 0x1800C9E28 (_Dtest.c)
 *     _Dint @ 0x1800C9E90 (_Dint.c)
 *     _Dunscale @ 0x1800C9FB0 (_Dunscale.c)
...
double *__fastcall Xp_mulh(double *a1, int a2, double a3)
{
  ...
  double v21[4]; // [rsp+30h] [rbp-50h] BYREF
...
LABEL_18:
      ...
      Dunscale(v18, &v20);
      Dint(&v20, 26LL);
      Dscale((unsigned __int16 *)&v20, v18[0]);
      Xp_addh(a1, v3, v20);
      Xp_addh(a1, v3, v21[0] - v20);
      for ( i = 1LL; i < v10; ++i )
      {
        v16 = v21[i];
        v21[i - 1] = v16;
