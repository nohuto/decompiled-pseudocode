/*
 * XREFs of ??$ReportLaunchStatus@_N_NPEBG@MobilityExperienceTelemetry@Telemetry@MobilityExperience@@SAX$$QEA_N0$$QEAPEBG@Z @ 0x18004B624
 * Callers:
        ...
        const WCHAR **a3)
{
  ...
  if ( *(_DWORD *)v6 > 5u )
  {
      ...
      && (*((_QWORD *)v7 + 3) & 0x800000000000LL) == *((_QWORD *)v7 + 3) )
    {
      ...
      v18 = 2 * v10 + 2;
      v19 = 0;
      LODWORD(v6) = TlgWrite(v7, &unk_18016C9AF, 0LL, 0LL, 5u, &pData);
    }
  }
  return (int)v6;
}
