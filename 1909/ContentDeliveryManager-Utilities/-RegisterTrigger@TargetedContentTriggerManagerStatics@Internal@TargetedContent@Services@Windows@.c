/*
 * XREFs of ?RegisterTrigger@TargetedContentTriggerManagerStatics@Internal@TargetedContent@Services@Windows@@UEAAJPEAU?$IVectorView@PEAVTargetedContentTriggerInternal@Internal@TargetedContent@Services@Windows@@@Collections@Foundation@5@PEAUHSTRING__@@1@Z @ 0x180064A70
 * Callers:
 *     <none>
 * Callees:
    ...
    if ( v34 )
    {
      while ( 1 )
      {
        ...
        v8 = Windows::Services::TargetedContent::Internal::TargetedContentTriggerManagerStatics::RegisterTriggerInternal(
               ...
               v13,
               (__int64)v12);
        if ( ((v8 + 0x80000000) & 0x80000000) == 0 && v8 != -2147483638 )
        {
          v20 = v8;
          v21 = 197LL;
          goto LABEL_24;
