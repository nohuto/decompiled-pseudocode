/*
 * XREFs of ?get_AppManager@ContentManagementBrokerServer@ContentManagement@@UEAAJPEAPEAUIAppManager@2@@Z @ 0x1800104B0
 * Callers:
 *     <none>
 * Callees:
        ...
        bool *a3)
{
  ...
  __int64 (__fastcall ***v20)(_QWORD, GUID *, struct ContentManagement::IAppManager **); // [rsp+50h] [rbp+30h] BYREF

  *a2 = 0LL;
  v4 = CallerIdentity::CheckCallerCapability((CallerIdentity *)L"targetedContent", &v19, a3);
  v5 = v4;
  if ( v4 >= 0 )
  {
    if ( !(_BYTE)v19 )
...
LABEL_15:
  ...
  if ( v9 < 0 )
    goto LABEL_15;
  v16 = (**v20)(v20, &GUID_8c1d35c6_1c6c_4e16_9799_12b4f4b195b2, a2);
  v9 = v16;
  if ( v16 >= 0 )
  {
    v17 = v20;
