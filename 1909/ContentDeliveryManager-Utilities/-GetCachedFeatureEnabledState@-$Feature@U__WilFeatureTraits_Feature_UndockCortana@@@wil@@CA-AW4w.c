/*
 * XREFs of ?GetCachedFeatureEnabledState@?$Feature@U__WilFeatureTraits_Feature_UndockCortana@@@wil@@CA?AW4wil_details_CachedFeatureEnabledState@@_N@Z @ 0x180096D70
 * Callers:
