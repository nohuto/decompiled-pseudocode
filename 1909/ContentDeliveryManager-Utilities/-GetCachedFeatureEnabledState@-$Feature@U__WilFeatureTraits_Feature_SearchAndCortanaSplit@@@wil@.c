/*
 * XREFs of ?GetCachedFeatureEnabledState@?$Feature@U__WilFeatureTraits_Feature_SearchAndCortanaSplit@@@wil@@CA?AW4wil_details_CachedFeatureEnabledState@@_N@Z @ 0x180096C00
 * Callers:
