/*
 * XREFs of _Toupper @ 0x1800B8128
 * Callers:
 *     ?do_toupper@?$ctype@D@std@@MEBADD@Z @ 0x1800B5360 (-do_toupper@-$ctype@D@std@@MEBADD@Z.c)
 *     ?do_toupper@?$ctype@D@std@@MEBAPEBDPEADPEBD@Z @ 0x1800B5380 (-do_toupper@-$ctype@D@std@@MEBAPEBDPEADPEBD@Z.c)
 * Callees:
