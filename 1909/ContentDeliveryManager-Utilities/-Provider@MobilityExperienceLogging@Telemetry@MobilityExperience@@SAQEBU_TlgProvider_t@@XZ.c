/*
 * XREFs of ?Provider@MobilityExperienceLogging@Telemetry@MobilityExperience@@SAQEBU_TlgProvider_t@@XZ @ 0x18000A7AC
 * Callers:
...
const struct _TlgProvider_t *MobilityExperience::Telemetry::MobilityExperienceLogging::Provider(void)
{
  ...
  if ( InitOnceBeginInitialize(
    ...
    && fPending )
  {
    Context = qword_18018ECD0;
    qword_18018ECD0[0] = &CreativeFramework::Logging::ShellPlacementLogging::`vftable';
    qword_18018ECE8 = (struct _TlgProvider_t *)&`MobilityExperience::Telemetry::MobilityExperienceLogging::StaticHandle::StaticHandle'::`2'::__hInner;
    atexit(lambda_e5247b73c30e393fca6255a7d4a63886_::_lambda_invoker_cdecl_);
    wil::TraceLoggingProvider::Register((wil::TraceLoggingProvider *)qword_18018ECD0, qword_18018ECE8);
    InitOnceComplete(
      &`MobilityExperience::Telemetry::MobilityExperienceLogging::Instance'::`2'::wrapper,
      0,
      qword_18018ECD0);
