/*
 * XREFs of ?Stop@HandleResumableTaskNotificationActivity@MobilityExperienceTelemetry@Telemetry@MobilityExperience@@QEAAXPEBD@Z @ 0x180045E90
 * Callers:
  ...
  if ( v6 )
  {
    ...
    **((_DWORD **)this + 6) = 2;
      ...
      && (*((_QWORD *)v8 + 3) & 0x800000000000LL) == *((_QWORD *)v8 + 3) )
    {
      ...
      v84 = a2;
      v85 = v12 + 1;
      TlgWrite(v9, &unk_18016CDDF, (LPCGUID)(*((_QWORD *)this + 6) + 8LL), 0LL, 0x13u, &pData);
    }
  }
  else
  {
    ...
    **((_DWORD **)this + 6) = 2;
      ...
      && (*((_QWORD *)v29 + 3) & 0x800000000000LL) == *((_QWORD *)v29 + 3) )
    {
      ...
      if ( !a2 )
        a2 = (const char *)&word_1800FD7D0;
      v94 = a2;
      TlgWrite(v30, &unk_18016CA6C, (LPCGUID)(*((_QWORD *)this + 6) + 8LL), 0LL, 6u, &v87);
    }
  }
  if ( *((_DWORD *)this + 8) )
  {
