/*
 * XREFs of ??$make_shared@VUtcApiWrapper@Diagnostics@Microsoft@@@std@@YA?AV?$shared_ptr@VUtcApiWrapper@Diagnostics@Microsoft@@@0@XZ @ 0x180015B20
 * Callers:
 *     ?DownloadLatestUtcSettings@FeatureManager@ContentManagement@@UEAAJXZ @ 0x18000DBC0 (-DownloadLatestUtcSettings@FeatureManager@ContentManagement@@UEAAJXZ.c)
 * Callees:
