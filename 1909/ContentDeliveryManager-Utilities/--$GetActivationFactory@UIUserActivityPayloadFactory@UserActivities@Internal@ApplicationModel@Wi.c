/*
 * XREFs of ??$GetActivationFactory@UIUserActivityPayloadFactory@UserActivities@Internal@ApplicationModel@Windows@@@wil@@YA?AV?$com_ptr_t@UIUserActivityPayloadFactory@UserActivities@Internal@ApplicationModel@Windows@@Uerr_exception_policy@wil@@@0@PEBG@Z @ 0x18004B004
 * Callers:
        ...
        const WCHAR *a1)
{
  ...
  v6[3] = a1;
  v6[0] = L"Windows.ApplicationModel.Internal.UserActivities.UserActivityPayload";
  *(_QWORD *)a1 = 0LL;
