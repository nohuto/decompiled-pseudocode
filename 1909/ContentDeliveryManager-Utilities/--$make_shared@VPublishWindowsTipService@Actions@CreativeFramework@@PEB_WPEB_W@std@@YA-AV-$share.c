/*
 * XREFs of ??$make_shared@VPublishWindowsTipService@Actions@CreativeFramework@@PEB_WPEB_W@std@@YA?AV?$shared_ptr@VPublishWindowsTipService@Actions@CreativeFramework@@@0@$$QEAPEB_W0@Z @ 0x180094948
 * Callers:
 ...
 * Callees:
 *     ??$?0PEB_WPEB_W@?$_Ref_count_obj@VPublishWindowsTipService@Actions@CreativeFramework@@@std@@QEAA@$$QEAPEB_W0@Z @ 0x1800949B8 (--$-0PEB_WPEB_W@-$_Ref_count_obj@VPublishWindowsTipService@Actions@CreativeFramework@@@std@@QEAA.c)
