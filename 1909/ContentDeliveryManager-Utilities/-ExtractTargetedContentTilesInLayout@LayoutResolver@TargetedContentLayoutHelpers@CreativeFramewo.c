/*
 * XREFs of ?ExtractTargetedContentTilesInLayout@LayoutResolver@TargetedContentLayoutHelpers@CreativeFramework@@AEAAXXZ @ 0x1800A3CA4
 * Callers:
        ...
        CreativeFramework::TargetedContentLayoutHelpers::LayoutResolver *this)
{
  ...
  v20 = 0LL;
  v4 = RoActivateInstance(v3[1].Reserved.Reserved1, &v20);
  if ( v4 < 0 )
  {
  ...
  v33 = 0LL;
  v5 = (**(__int64 (__fastcall ***)(__int64, GUID *, _QWORD *))v20)(
         v20,
...
LABEL_32:
  ...
  if ( v26 != v27 )
  {
    ...
    do
    {
      ...
      v19 = v15;
      if ( v15 )
        (*(void (__fastcall **)(_QWORD *, _QWORD))(*v15 + 8LL))(v15, *v15);
      v25 = *NodeTileId;
      if ( !v31 )
        goto LABEL_32;
