/*
 * XREFs of ?OnErrorReported@ContentDeliveryManagerLogging@Background@ContentDeliveryManager@@UEAAX_NAEBUFailureInfo@wil@@@Z @ 0x18001FF40
 * Callers:
 *     <none>
 * Callees:
        ...
        const struct wil::FailureInfo *a3)
{
    ...
    && (*((_QWORD *)v4 + 3) & 0x400000000000LL) == *((_QWORD *)v4 + 3) )
  {
    ...
    v76 = v7 + 1;
    v77 = 0;
    TlgWrite(v4, &unk_18016B49E, 0LL, 0LL, 0x14u, &pData);
  }
}
