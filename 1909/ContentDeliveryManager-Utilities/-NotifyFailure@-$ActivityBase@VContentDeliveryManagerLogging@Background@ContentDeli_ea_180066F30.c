/*
 * XREFs of ?NotifyFailure@?$ActivityBase@VContentDeliveryManagerLogging@Background@ContentDeliveryManager@@$00$0A@$04$0A@U_TlgReflectorTag_Param0IsProviderType@@@wil@@UEAA_NAEBUFailureInfo@2@@Z @ 0x180066F30
 * Callers:
 *     <none>
 * Callees:
        ...
        int *a2)
{
  ...
  else if ( *(_DWORD *)v5 > 2u )
  {
    ...
    v98 = v26 + 1;
    v99 = 0;
    TlgWrite(v6, &unk_18016BB64, (LPCGUID)(a1[6] + 8LL), 0LL, 0x14u, &pData);
  }
