/*
 * XREFs of ?_Xbad_function_call@std@@YAXXZ @ 0x1800AE0F0
 * Callers:
 *     ?GetSubscriptionBehavior@TargetedContent@CreativeFramework@@YA?AW4TargetedContentSubscriptionBehavior@12@PEBG@Z @ 0x1800270E0 (-GetSubscriptionBehavior@TargetedContent@CreativeFramework@@YA-AW4TargetedContentSubscriptionBeh.c)
 ...
 * Callees:
 *     ??0bad_function_call@std@@QEAA@PEBD@Z @ 0x1800ADFA0 (--0bad_function_call@std@@QEAA@PEBD@Z.c)
