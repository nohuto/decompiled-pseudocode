/*
 * XREFs of _Wcscoll @ 0x1800CA208
 * Callers:
 *     ?do_compare@?$collate@_W@std@@MEBAHPEB_W000@Z @ 0x1800C0BE0 (-do_compare@-$collate@_W@std@@MEBAHPEB_W000@Z.c)
 * Callees:
 *     _GetLocaleHandleByColl @ 0x1800B766C (_GetLocaleHandleByColl.c)
 *     _GetLocaleHandleById @ 0x1800B7678 (_GetLocaleHandleById.c)
 *     __crtCompareStringW_Stub @ 0x1800B7708 (__crtCompareStringW_Stub.c)
 */
