/*
 * XREFs of ?CopyFaviconToEdge@@YAJPEAUHSTRING__@@PEAPEAU1@@Z @ 0x180099220
 * Callers:
...
LABEL_22:
  ...
  newString = 0LL;
  v14 = Microsoft::WRL::Wrappers::HStringReference::HStringReference(&v32, (const WCHAR **)off_1800F6000);
  ...
  *v18 = 0LL;
  ...
  v21 = Microsoft::WRL::Wrappers::HStringReference::HStringReference(&v32, (const WCHAR **)off_1800F5FF8);
