/*
 * XREFs of ?assign@?$basic_string@GU?$char_traits@G@std@@V?$allocator@G@2@@std@@QEAAAEAV12@AEBV12@_K1@Z @ 0x180032230
 * Callers:
 *     _anonymous_namespace_::SplitString @ 0x180028DA8 (_anonymous_namespace_--SplitString.c)
 ...
 *     ?do_get@?$messages@G@std@@MEBA?AV?$basic_string@GU?$char_traits@G@std@@V?$allocator@G@2@@2@HHHAEBV32@@Z @ 0x1800C0C40 (-do_get@-$messages@G@std@@MEBA-AV-$basic_string@GU-$char_traits@G@std@@V-$allocator@G@2@@2@HHHAE.c)
