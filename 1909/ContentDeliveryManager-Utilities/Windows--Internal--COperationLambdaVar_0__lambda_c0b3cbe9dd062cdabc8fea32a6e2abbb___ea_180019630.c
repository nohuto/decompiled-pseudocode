/*
 * XREFs of Windows::Internal::COperationLambdaVar_0__lambda_c0b3cbe9dd062cdabc8fea32a6e2abbb__Windows::Internal::CNoResult_::_scalar_deleting_destructor_ @ 0x180019630
 * Callers:
 *     <none>
 * Callees:
...
_QWORD *__fastcall Windows::Internal::COperationLambdaVar_0__lambda_c0b3cbe9dd062cdabc8fea32a6e2abbb__Windows::Internal::CNoResult_::_scalar_deleting_destructor_(
        _QWORD *a1,
        char a2)
{
  HSTRING v4; // rcx
