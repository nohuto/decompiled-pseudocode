/*
 * XREFs of ??$ContentIdsReceived@AEAI@LayoutResolver@ShellPlacementTelemetry@Logging@CreativeFramework@@QEAAXAEAI@Z @ 0x1800A53BC
 * Callers:
        ...
        __int64 a2)
{
  ...
  if ( *(_DWORD *)v4 > 5u )
  {
    ...
    v7 = a2;
    v8 = 4;
    LODWORD(v4) = TlgWrite(v4, &unk_18016F672, (LPCGUID)(*(_QWORD *)(a1 + 48) + 8LL), 0LL, 3u, &pData);
  }
  return (int)v4;
}
