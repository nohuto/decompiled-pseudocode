/*
 * XREFs of _wil::details::WaitForCompletion_Windows::Foundation::IAsyncOperation_Windows::Services::TargetedContent::TargetedContentSubscription_______::_2_::CompletionDelegate::Invoke @ 0x18001C020
 * Callers:
 *     <none>
 * Callees:
        ...
        int a3)
{
  ...
  *(_DWORD *)(a1 + 48) = a3;
  ...
  {
    wil::details::in1diag3::_FailFast_GetLastError(retaddr, (void *)0x8E6, v3, v4);
    JUMPOUT(0x18001C04CLL);
  }
  return 0LL;
}
