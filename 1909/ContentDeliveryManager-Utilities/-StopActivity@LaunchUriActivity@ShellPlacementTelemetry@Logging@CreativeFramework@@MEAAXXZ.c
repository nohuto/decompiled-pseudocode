/*
 * XREFs of ?StopActivity@LaunchUriActivity@ShellPlacementTelemetry@Logging@CreativeFramework@@MEAAXXZ @ 0x180025AE0
 * Callers:
 *     <none>
 * Callees:
  ...
  if ( v4 )
  {
    ...
    **((_DWORD **)this + 6) = 2;
      ...
      && (*((_QWORD *)v6 + 3) & 0x200000000000LL) == *((_QWORD *)v6 + 3) )
    {
      ...
      v78 = 2 * v11 + 2;
      v79 = 0;
      TlgWrite(v7, &unk_18016BC9C, (LPCGUID)(*((_QWORD *)this + 6) + 8LL), 0LL, 0x12u, &pData);
    }
  }
  else
  {
    ...
    **((_DWORD **)this + 6) = 2;
      ...
      && (*((_QWORD *)v26 + 3) & 0x200000000000LL) == *((_QWORD *)v26 + 3) )
    {
      ...
      v33 = CurrentThreadId;
      v85 = &v33;
      TlgWrite(v27, &unk_18016C1C4, (LPCGUID)(*((_QWORD *)this + 6) + 8LL), 0LL, 5u, &v80);
    }
  }
  if ( *((_DWORD *)this + 8) )
  {
