    ...
    if ( v6 >= 0 )
    {
      ...
      if ( *(_DWORD *)(*(_QWORD *)(*(_QWORD *)(a1 + 80) + 72LL) + 12LL) )
      {
        ...
        if ( v6 >= 0 && v8 )
        {
          v9 = *(_QWORD *)(a1 + 80);
          if ( v9 )
            (*(void (__fastcall **)(_QWORD))(*(_QWORD *)v9 + 8LL))(*(_QWORD *)(a1 + 80));
          *a2 = v9;
          v10 = *(_QWORD *)(a1 + 88);
          if ( v10 )
            (*(void (__fastcall **)(_QWORD))(*(_QWORD *)v10 + 8LL))(*(_QWORD *)(a1 + 88));
          *a3 = v10;
        }
      }
    }
