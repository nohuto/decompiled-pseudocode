/*
 * XREFs of ??$_Getvals@_W@?$time_get@_WV?$istreambuf_iterator@_WU?$char_traits@_W@std@@@std@@@std@@IEAAX_WAEBV_Locinfo@1@@Z @ 0x1800AB440
 * Callers:
 ...
 * Callees:
 *     ??4?$_Yarn@_W@std@@QEAAAEAV01@PEB_W@Z @ 0x1800AB5C0 (--4-$_Yarn@_W@std@@QEAAAEAV01@PEB_W@Z.c)
