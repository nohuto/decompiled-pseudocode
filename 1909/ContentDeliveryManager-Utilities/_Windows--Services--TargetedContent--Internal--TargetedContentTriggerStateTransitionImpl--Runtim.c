/*
 * XREFs of _Windows::Services::TargetedContent::Internal::TargetedContentTriggerStateTransitionImpl::RuntimeClassInitialize_::_1_::catch$0 @ 0x1800CFA13
 * Callers:
 *     <none>
 * Callees:
