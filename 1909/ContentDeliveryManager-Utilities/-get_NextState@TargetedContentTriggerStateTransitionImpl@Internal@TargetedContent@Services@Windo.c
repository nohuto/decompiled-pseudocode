/*
 * XREFs of ?get_NextState@TargetedContentTriggerStateTransitionImpl@Internal@TargetedContent@Services@Windows@@UEAAJPEAW4TargetedContentTriggerState@2345@@Z @ 0x18005EA60
 * Callers:
 *     <none>
 * Callees:
 *     <none>
