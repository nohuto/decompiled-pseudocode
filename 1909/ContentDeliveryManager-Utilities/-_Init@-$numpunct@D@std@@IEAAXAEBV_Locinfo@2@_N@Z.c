/*
 * XREFs of ?_Init@?$numpunct@D@std@@IEAAXAEBV_Locinfo@2@_N@Z @ 0x1800B2DE8
 * Callers:
 *     ?_Getcat@?$numpunct@D@std@@SA_KPEAPEBVfacet@locale@2@PEBV42@@Z @ 0x1800B0E64 (-_Getcat@-$numpunct@D@std@@SA_KPEAPEBVfacet@locale@2@PEBV42@@Z.c)
