/*
 * XREFs of ?clear@ios_base@std@@QEAAXH_N@Z @ 0x180024F20
 * Callers:
 ...
 * Callees:
 *     ?make_error_code@std@@YA?AVerror_code@1@W4io_errc@31@@Z @ 0x180024E20 (-make_error_code@std@@YA-AVerror_code@1@W4io_errc@31@@Z.c)
