/*
 * XREFs of ?GetToastContentXML@ToastHelpers@NotificationManager@CreativeFramework@@QEAA?AV?$basic_string@_WU?$char_traits@_W@std@@V?$allocator@_W@2@@std@@XZ @ 0x18009ACF8
 * Callers:
...
void **__fastcall CreativeFramework::NotificationManager::ToastHelpers::GetToastContentXML(__int64 a1, void **a2)
{
  ...
  while ( v6 != v5 )
  {
    ...
    std::wstring::append(v34, (char *)L"{", asc_18015F5B0[0] != 0);
    std::wstring::append((char *)v34, v6 + 4, 0LL, 0xFFFFFFFFFFFFFFFFuLL);
    v10 = std::wstring::append(v34, (char *)L"}", asc_18015F5B4[0] != 0);
    v41 = 7LL;
    v40[2] = 0LL;
    LOWORD(v40[0]) = 0;
