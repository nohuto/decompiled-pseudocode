/*
 * XREFs of ?ReportFailure@details@wil@@YAXPEAXIPEBD110W4FailureType@2@JPEBGW4ReportFailureOptions@12@@Z @ 0x180002EFC
 * Callers:
 ...
 * Callees:
 *     ?RethrowCaughtException@wil@@YAXXZ @ 0x1800028EC (-RethrowCaughtException@wil@@YAXXZ.c)
 *     ?ThrowResultException@wil@@YAXAEBUFailureInfo@1@@Z @ 0x180002910 (-ThrowResultException@wil@@YAXAEBUFailureInfo@1@@Z.c)
