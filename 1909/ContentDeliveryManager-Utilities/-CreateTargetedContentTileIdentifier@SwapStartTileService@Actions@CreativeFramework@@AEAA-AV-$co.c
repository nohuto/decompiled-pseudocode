/*
 * XREFs of ?CreateTargetedContentTileIdentifier@SwapStartTileService@Actions@CreativeFramework@@AEAA?AV?$com_ptr_t@UIUnifiedTileIdentifier@UnifiedTile@Shell@WindowsInternal@@Uerr_exception_policy@wil@@@wil@@PEB_W0@Z @ 0x180086468
 * Callers:
 *     _lambda_84d899b7d93de90bfed2062708934b25_::operator() @ 0x180086118 (_lambda_84d899b7d93de90bfed2062708934b25_--operator().c)
 * Callees:
