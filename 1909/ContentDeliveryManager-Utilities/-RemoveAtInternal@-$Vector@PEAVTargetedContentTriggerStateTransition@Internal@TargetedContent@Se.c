...
LABEL_14:
  ...
  v10 = 16LL * a2;
  v11 = *(_QWORD *)(a1 + 88);
  if ( (unsigned __int8)_mm_cvtsi128_si32(_mm_srli_si128(*(__m128i *)(v10 + v11), 8)) )
    --*(_DWORD *)(a1 + 80);
  v12 = *(_OWORD *)(v10 + v11);
