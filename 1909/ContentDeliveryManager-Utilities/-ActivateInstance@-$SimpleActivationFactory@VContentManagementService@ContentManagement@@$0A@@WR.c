/*
 * XREFs of ?ActivateInstance@?$SimpleActivationFactory@VContentManagementService@ContentManagement@@$0A@@WRL@Microsoft@@UEAAJPEAPEAUIInspectable@@@Z @ 0x1800229E0
 * Callers:
 *     <none>
 * Callees:
 ...
 *     ??0ContentManagementService@ContentManagement@@QEAA@XZ @ 0x180023290 (--0ContentManagementService@ContentManagement@@QEAA@XZ.c)
