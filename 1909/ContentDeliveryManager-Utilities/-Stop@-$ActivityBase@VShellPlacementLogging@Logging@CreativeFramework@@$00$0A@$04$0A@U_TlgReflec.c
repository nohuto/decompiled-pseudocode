/*
 * XREFs of ?Stop@?$ActivityBase@VShellPlacementLogging@Logging@CreativeFramework@@$00$0A@$04$0A@U_TlgReflectorTag_Param0IsProviderType@@@wil@@QEAAXJ@Z @ 0x18002F338
 * Callers:
  ...
  *(_DWORD *)(v2 + 72) = v5;
  ...
  if ( v5 )
  {
    ...
    if ( *(_DWORD *)v6 > 5u )
    {
      ...
      p_SRWLock = &SRWLock;
      v24 = 4;
      LODWORD(v6) = TlgWrite(v7, &unk_18016BEDA, (LPCGUID)(*((_QWORD *)this + 6) + 8LL), 0LL, 5u, &pData);
    }
  }
  else
  {
