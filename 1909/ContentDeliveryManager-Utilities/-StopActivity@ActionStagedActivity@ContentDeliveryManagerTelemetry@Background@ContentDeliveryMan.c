/*
 * XREFs of ?StopActivity@ActionStagedActivity@ContentDeliveryManagerTelemetry@Background@ContentDeliveryManager@@MEAAXXZ @ 0x18004D890
 * Callers:
 *     <none>
 * Callees:
  ...
  if ( v4 )
  {
    ...
    **((_DWORD **)this + 6) = 2;
      ...
      && (*((_QWORD *)v6 + 3) & 0x200000000000LL) == *((_QWORD *)v6 + 3) )
    {
      ...
      v75 = 2 * v11 + 2;
      v76 = 0;
      TlgWrite(v7, &unk_18016D15D, (LPCGUID)(*((_QWORD *)this + 6) + 8LL), 0LL, 0x12u, &pData);
    }
  }
  else
  {
    ...
    **((_DWORD **)this + 6) = 2;
      ...
      && (*((_QWORD *)v26 + 3) & 0x200000000000LL) == *((_QWORD *)v26 + 3) )
    {
      ...
      v30 = CurrentThreadId;
      v82 = &v30;
      TlgWrite(v27, &unk_18016D49D, (LPCGUID)(*((_QWORD *)this + 6) + 8LL), 0LL, 5u, &v77);
    }
  }
