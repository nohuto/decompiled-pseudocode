/*
 * XREFs of ?StartActivity@TriggerManagerRegisterActivity@ContentDeliveryManagerTelemetry@Background@ContentDeliveryManager@@QEAAXPEBD@Z @ 0x18006213C
 * Callers:
        ...
        const char *a2)
{
  ...
  *(_DWORD *)v4 = 1;
  ...
  if ( *(_DWORD *)v8 > 5u )
  {
    ...
    TlgWrite(v8, &unk_18016E7B7, (LPCGUID)(v11 + 8), v12, 5u, &pData);
  }
  if ( !*((_DWORD *)this + 8) )
