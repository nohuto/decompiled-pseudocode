/*
 * XREFs of ??_EUtcWrapperBase@Diagnostics@Microsoft@@UEAAPEAXI@Z @ 0x180017A80
 * Callers:
 *     <none>
 * Callees:
 *     ??1UtcWrapperBase@Diagnostics@Microsoft@@UEAA@XZ @ 0x1800A9014 (--1UtcWrapperBase@Diagnostics@Microsoft@@UEAA@XZ.c)
 */
