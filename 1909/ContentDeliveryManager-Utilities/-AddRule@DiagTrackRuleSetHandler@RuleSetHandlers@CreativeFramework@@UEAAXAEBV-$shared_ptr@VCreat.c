/*
 * XREFs of ?AddRule@DiagTrackRuleSetHandler@RuleSetHandlers@CreativeFramework@@UEAAXAEBV?$shared_ptr@VCreativeRule@RuleSetHandlers@CreativeFramework@@@std@@@Z @ 0x18007A100
 * Callers:
 *     ?RegisterTrigger@Internal@TargetedContent@Services@Windows@@YAXPEAUITargetedContentTriggerInternal@1234@V?$shared_ptr@VCorrelationVectorWrapper@Background@ContentDeliveryManager@@@std@@@Z @ 0x180064480 (-RegisterTrigger@Internal@TargetedContent@Services@Windows@@YAXPEAUITargetedContentTriggerIntern.c)
 ...
 *     ??$GetActivationFactory@UIStorageFileStatics@Storage@Windows@@@wil@@YA?AV?$com_ptr_t@UIStorageFileStatics@Storage@Windows@@Uerr_exception_policy@wil@@@0@PEB_W@Z @ 0x18007B620 (--$GetActivationFactory@UIStorageFileStatics@Storage@Windows@@@wil@@YA-AV-$com_ptr_t@UIStorageFi.c)
...
void __fastcall CreativeFramework::RuleSetHandlers::DiagTrackRuleSetHandler::AddRule(__int64 a1, void ***a2)
{
  ...
  HSTRING v27; // [rsp+58h] [rbp-B0h] BYREF
  __int64 v28; // [rsp+60h] [rbp-A8h] BYREF
  const WCHAR *v29; // [rsp+68h] [rbp-A0h] BYREF
  PVOID Reserved1; // [rsp+70h] [rbp-98h] BYREF
  __int64 v31; // [rsp+78h] [rbp-90h] BYREF
  const WCHAR *v32; // [rsp+80h] [rbp-88h] BYREF
  PVOID v33; // [rsp+88h] [rbp-80h] BYREF
  _QWORD v34[2]; // [rsp+90h] [rbp-78h] BYREF
  wchar_t *v35[2]; // [rsp+A0h] [rbp-68h] BYREF
  __int64 v36; // [rsp+B0h] [rbp-58h]
  unsigned __int64 v37; // [rsp+B8h] [rbp-50h]
  void *v38[2]; // [rsp+C0h] [rbp-48h] BYREF
  __int64 v39; // [rsp+D0h] [rbp-38h]
  unsigned __int64 v40; // [rsp+D8h] [rbp-30h]
  void *v41[3]; // [rsp+E0h] [rbp-28h] BYREF
  unsigned __int64 v42; // [rsp+F8h] [rbp-10h]
  HSTRING_HEADER hstringHeader; // [rsp+100h] [rbp-8h] BYREF
  HSTRING string; // [rsp+118h] [rbp+10h] BYREF
  void **v45; // [rsp+128h] [rbp+20h] BYREF
  _QWORD v46[3]; // [rsp+130h] [rbp+28h] BYREF
  int v47; // [rsp+148h] [rbp+40h]
  int *v48; // [rsp+150h] [rbp+48h]
  int *v49; // [rsp+158h] [rbp+50h]
  int v50; // [rsp+160h] [rbp+58h] BYREF
  char v51; // [rsp+164h] [rbp+5Ch]
  int v52; // [rsp+188h] [rbp+80h] BYREF
  const char *v53; // [rsp+190h] [rbp+88h]
  __int64 v54; // [rsp+198h] [rbp+90h]
  char v55; // [rsp+1A0h] [rbp+98h]
  __int64 v56; // [rsp+1A8h] [rbp+A0h]
  _BYTE v57[144]; // [rsp+1B0h] [rbp+A8h] BYREF
  __int64 v58; // [rsp+240h] [rbp+138h]
  __int64 v59; // [rsp+248h] [rbp+140h]
  __int64 v60; // [rsp+250h] [rbp+148h]
  volatile signed __int32 *v61; // [rsp+258h] [rbp+150h]
  HSTRING_HEADER v62; // [rsp+268h] [rbp+160h] BYREF
  __int64 v63; // [rsp+280h] [rbp+178h]
  HSTRING_HEADER v64; // [rsp+288h] [rbp+180h] BYREF
  __int64 v65; // [rsp+2A0h] [rbp+198h]
  WCHAR sourceString[264]; // [rsp+2A8h] [rbp+1A0h] BYREF
  ...
  v36 = 0LL;
  LOWORD(v35[0]) = 0;
  std::wstring::assign((void **)v35, *a2, 0LL, 0xFFFFFFFFFFFFFFFFuLL);
  v5 = (const wchar_t *)v35;
  if ( v37 >= 8 )
    v5 = v35[0];
  v45 = &wil::ActivityBase<ContentDeliveryManager::Background::ContentDeliveryManagerLogging,0,0,5,0,_TlgReflectorTag_Param0IsProviderType>::`vftable';
  v46[0] = 0LL;
  v46[1] = &v45;
  v46[2] = 0LL;
  v47 = 0;
  ...
  v55 = 0;
  v52 = 0;
  v53 = "DiagTrackRuleSetHandlerAddRule";
  v54 = 0LL;
  v56 = 1LL;
  v58 = 0LL;
  ...
  v60 = 0LL;
  v61 = 0LL;
  v45 = &ContentDeliveryManager::Background::ContentDeliveryManagerTelemetry::DiagTrackRuleSetHandlerAddRule::`vftable';
  ContentDeliveryManager::Background::ContentDeliveryManagerTelemetry::DiagTrackRuleSetHandlerAddRule::StartActivity(
    (ContentDeliveryManager::Background::ContentDeliveryManagerTelemetry::DiagTrackRuleSetHandlerAddRule *)&v45,
    v5,
    0,
    (const char *)(v4 + 8));
  if ( v37 >= 8 )
  ...
  v36 = 0LL;
  LOWORD(v35[0]) = 0;
  CreativeFramework::RuleSetHandlers::DiagTrackRuleSetHandler::GetFileNameForRule(v6, v41, *a2);
  ...
  if ( v10 < 0 )
  {
    ...
    JUMPOUT(0x18007A591LL);
  }
  v27 = string;
  v11 = (_QWORD *)wil::GetActivationFactory<Windows::Storage::IStorageFolderStatics>(&v28);
  ...
  v39 = 0LL;
  LOWORD(v38[0]) = 0;
  std::wstring::assign(v38, v13 + 4, 0LL, 0xFFFFFFFFFFFFFFFFuLL);
  v14 = (const WCHAR *)v38;
  if ( v40 >= 8 )
    v14 = (const WCHAR *)v38[0];
  v29 = v14;
  Reserved1 = Microsoft::WRL::Wrappers::HStringReference::HStringReference(&v62, &v29)[1].Reserved.Reserved1;
  v15 = (_QWORD *)wil::GetActivationFactory<Windows::Storage::IStorageFileStatics>(&v31);
  ...
  v32 = v17;
  v33 = Microsoft::WRL::Wrappers::HStringReference::HStringReference(&v64, &v32)[1].Reserved.Reserved1;
  v34[0] = v25;
  ...
  *(_BYTE *)(a1 + 24) = 1;
  ...
  LOWORD(v41[0]) = 0;
  v45 = &ContentDeliveryManager::Background::ContentDeliveryManagerTelemetry::DiagTrackRuleSetHandlerAddRule::`vftable';
  wil::ActivityBase<ContentDeliveryManager::Background::ContentDeliveryManagerLogging,0,0,5,0,_TlgReflectorTag_Param0IsProviderType>::Destroy(&v45);
  if ( v61 )
  {
