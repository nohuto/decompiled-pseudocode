/*
 * XREFs of ?OnPublishError@ActivityToastNotificationCallback@ToastNotification@@UEAAJPEBU_GUID@@J@Z @ 0x180048020
 * Callers:
 *     <none>
 * Callees:
        ...
        unsigned int a3)
{
  ...
  if ( !SetEvent(this[3]) )
  {
    wil::details::in1diag3::_FailFast_GetLastError(retaddr, (void *)0x8E6, v4, v5);
    JUMPOUT(0x180048073LL);
  }
  return 0LL;
}
