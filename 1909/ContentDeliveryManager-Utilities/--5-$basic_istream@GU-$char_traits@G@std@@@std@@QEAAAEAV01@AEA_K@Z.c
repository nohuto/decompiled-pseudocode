/*
 * XREFs of ??5?$basic_istream@GU?$char_traits@G@std@@@std@@QEAAAEAV01@AEA_K@Z @ 0x1800303A4
 * Callers:
 ...
 *     ?_Ipfx@?$basic_istream@GU?$char_traits@G@std@@@std@@QEAA_N_N@Z @ 0x1800324E8 (-_Ipfx@-$basic_istream@GU-$char_traits@G@std@@@std@@QEAA_N_N@Z.c)
...
_QWORD *__fastcall std::basic_istream<unsigned short>::operator>>(_QWORD *a1, __int64 a2)
{
  ...
  if ( (unsigned __int8)std::basic_istream<unsigned short>::_Ipfx(v3) )
  {
    ...
    v7 = std::use_facet<std::num_get<unsigned short,std::istreambuf_iterator<unsigned short>>>(&v28);
    if ( v6 )
    {
