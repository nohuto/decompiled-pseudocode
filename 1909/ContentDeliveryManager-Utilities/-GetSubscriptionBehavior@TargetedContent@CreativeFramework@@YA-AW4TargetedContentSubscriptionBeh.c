/*
 * XREFs of ?GetSubscriptionBehavior@TargetedContent@CreativeFramework@@YA?AW4TargetedContentSubscriptionBehavior@12@PEBG@Z @ 0x1800270E0
 * Callers:
...
__int64 __fastcall CreativeFramework::TargetedContent::GetSubscriptionBehavior(__int64 a1)
{
  ...
  v7 = -2LL;
  v5 = a1;
  v8 = *(_OWORD *)&off_1800E6760;
  v9 = xmmword_1800E6770;
  v10 = 3600LL;
  *(_QWORD *)&v6 = &v5;
  *((_QWORD *)&v6 + 1) = &v8;
  v12 = 0LL;
  ...
  if ( !v1 )
    std::_Xbad_alloc();
  *(_QWORD *)v1 = off_1800DC070;
  *(_OWORD *)(v1 + 8) = v6;
  v12 = v1;
  v2 = (void **)off_1800DB430;
  while ( 1 )
  {
    if ( !v1 )
