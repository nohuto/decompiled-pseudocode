/*
 * XREFs of ?GetFailureLogString@wil@@YAJPEAG_KAEBUFailureInfo@1@@Z @ 0x180001C7C
 * Callers:
 *     ?what@ResultException@wil@@UEBAPEBDXZ @ 0x180002710 (-what@ResultException@wil@@UEBAPEBDXZ.c)
 ...
 *     _wil::details::ResultFromCaughtExceptionInternal_::_1_::catch$0 @ 0x1800CBF91 (_wil--details--ResultFromCaughtExceptionInternal_--_1_--catch$0.c)
 *     _wil::details::ResultFromCaughtExceptionInternal_::_1_::catch$3 @ 0x1800CC066 (_wil--details--ResultFromCaughtExceptionInternal_--_1_--catch$3.c)
 * Callees:
 *     ?LogStringPrintf@details@wil@@YAPEAGPEAGPEBG1ZZ @ 0x180001C2C (-LogStringPrintf@details@wil@@YAPEAGPEAGPEBG1ZZ.c)
