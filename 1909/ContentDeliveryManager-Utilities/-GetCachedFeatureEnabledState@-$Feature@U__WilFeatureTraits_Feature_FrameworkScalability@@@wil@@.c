/*
 * XREFs of ?GetCachedFeatureEnabledState@?$Feature@U__WilFeatureTraits_Feature_FrameworkScalability@@@wil@@CA?AW4wil_details_CachedFeatureEnabledState@@_N@Z @ 0x180033C24
 * Callers:
...
LABEL_5:
  ...
  if ( v4 )
    ...
    v5 = 1;
  v6 = v5 + 1;
  v7 = ((unsigned int)`wil::Feature<__WilFeatureTraits_Feature_FrameworkScalability>::GetFeaturePropertyCache'::`2'::data >> 2) & 1;
  if ( v0 )
    v6 = v0;
  else
    v7 = v3;
  ...
  if ( v0 )
  {
    ...
    while ( (((unsigned int)`wil::Feature<__WilFeatureTraits_Feature_FrameworkScalability>::GetFeaturePropertyCache'::`2'::data >> 4) & 3) != v10
         && v11 != _InterlockedCompareExchange(
                     ...
                     `wil::Feature<__WilFeatureTraits_Feature_FrameworkScalability>::GetFeaturePropertyCache'::`2'::data & 0xFFFFFFCF | (16 * v10),
                     `wil::Feature<__WilFeatureTraits_Feature_FrameworkScalability>::GetFeaturePropertyCache'::`2'::data) );
  }
  else
  {
