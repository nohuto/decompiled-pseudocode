/*
 * XREFs of ?_Getmfld@?$money_get@_WV?$istreambuf_iterator@_WU?$char_traits@_W@std@@@std@@@std@@AEBA?AV?$basic_string@DU?$char_traits@D@std@@V?$allocator@D@2@@2@AEAV?$istreambuf_iterator@_WU?$char_traits@_W@std@@@2@0_NAEAVios_base@2@PEA_W@Z @ 0x1800BC990
 * Callers:
        ...
        __int16 *a7)
{
  ...
  {
    v11 = 32;
    v12 = std::use_facet<std::moneypunct<wchar_t,1>>((__int64 *)&v95);
  }
  else
  {
    v11 = 64;
    v12 = std::use_facet<std::moneypunct<wchar_t,0>>((__int64 *)&v95);
  }
  v96 = v12;
  if ( v10 )
  {
  ...
  *v9 = 0;
  ...
  v15 = v11 | 0x81;
  v16 = std::use_facet<std::ctype<wchar_t>>((__int64 *)&v95);
  v104 = v16;
  if ( v14 )
  {
      ...
      if ( !std::istreambuf_iterator<wchar_t>::equal(a3, v97) )
      {
        ...
        do
        {
          ...
          std::string::append(
            v9,
            1uLL,
            `std::money_get<wchar_t,std::istreambuf_iterator<wchar_t>>::_Getmfld'::`2'::_Src[v60]);
          std::istreambuf_iterator<unsigned short>::_Inc(a3);
        }
        ...
        && *(_WORD *)std::istreambuf_iterator<unsigned short>::operator*(a3) == v53 )
      {
        ...
        while ( !std::istreambuf_iterator<wchar_t>::equal(a3, v54) )
        {
          ...
          std::string::append(
            v9,
            1uLL,
            `std::money_get<wchar_t,std::istreambuf_iterator<wchar_t>>::_Getmfld'::`2'::_Src[v64]);
          ++v26;
          std::istreambuf_iterator<unsigned short>::_Inc(a3);
        }
        v65 = v93;
...
LABEL_121:
    ...
    while ( 1 )
    {
      ...
      std::string::append(
        v33,
        1uLL,
        `std::money_get<wchar_t,std::istreambuf_iterator<wchar_t>>::_Getmfld'::`2'::_Src[v38]);
      v39 = v107;
      if ( v30 >= 0x10 )
        v39 = v32;
