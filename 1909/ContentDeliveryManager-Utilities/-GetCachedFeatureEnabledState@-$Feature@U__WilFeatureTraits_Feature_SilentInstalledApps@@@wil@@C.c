/*
 * XREFs of ?GetCachedFeatureEnabledState@?$Feature@U__WilFeatureTraits_Feature_SilentInstalledApps@@@wil@@CA?AW4wil_details_CachedFeatureEnabledState@@_N@Z @ 0x1800351F0
 * Callers:
...
__int64 wil::Feature<__WilFeatureTraits_Feature_SilentInstalledApps>::GetCachedFeatureEnabledState()
{
  ...
  v2 = ((__int64 (__fastcall *)(__int64, _QWORD))v1)(8025889LL, 0LL);
LABEL_8:
  v3 = v2 & 0x80;
  v4 = (v2 >> 6) & 1;
  v5 = 2;
  ...
  v8 = ((unsigned int)`wil::Feature<__WilFeatureTraits_Feature_SilentInstalledApps>::GetFeaturePropertyCache'::`2'::data >> 2) & 1;
  if ( v0 )
    v5 = v0;
  else
    v8 = v4;
  ...
  if ( v0 )
  {
    ...
    v11 = (v3 != 0) + 1;
    do
      v12 = `wil::Feature<__WilFeatureTraits_Feature_SilentInstalledApps>::GetFeaturePropertyCache'::`2'::data;
    while ( (((unsigned int)`wil::Feature<__WilFeatureTraits_Feature_SilentInstalledApps>::GetFeaturePropertyCache'::`2'::data >> 4) & 3) != v11
         && v12 != _InterlockedCompareExchange(
                     &`wil::Feature<__WilFeatureTraits_Feature_SilentInstalledApps>::GetFeaturePropertyCache'::`2'::data,
                     `wil::Feature<__WilFeatureTraits_Feature_SilentInstalledApps>::GetFeaturePropertyCache'::`2'::data & 0xFFFFFFCF | (16 * v11),
                     `wil::Feature<__WilFeatureTraits_Feature_SilentInstalledApps>::GetFeaturePropertyCache'::`2'::data) );
  }
  else
  {
    ...
    do
    {
      v14 = `wil::Feature<__WilFeatureTraits_Feature_SilentInstalledApps>::GetFeaturePropertyCache'::`2'::data;
      v10 = `wil::Feature<__WilFeatureTraits_Feature_SilentInstalledApps>::GetFeaturePropertyCache'::`2'::data;
    }
