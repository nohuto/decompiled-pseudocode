/*
 * XREFs of ?StartActivity@DiagTrackRuleSetHandlerAddRule@ContentDeliveryManagerTelemetry@Background@ContentDeliveryManager@@QEAAXPEB_WIPEBD@Z @ 0x180078E6C
 * Callers:
        ...
        const char *a4)
{
  ...
  *(_DWORD *)v7 = 1;
  ...
  if ( *(_DWORD *)v11 > 5u )
  {
    ...
    TlgWrite(v11, &unk_18016EA94, (LPCGUID)(v14 + 8), v15, 7u, &pData);
  }
  if ( !*((_DWORD *)this + 8) )
