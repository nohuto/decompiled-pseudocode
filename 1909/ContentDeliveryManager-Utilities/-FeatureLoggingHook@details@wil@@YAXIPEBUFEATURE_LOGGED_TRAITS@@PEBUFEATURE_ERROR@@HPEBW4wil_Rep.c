/*
 * XREFs of ?FeatureLoggingHook@details@wil@@YAXIPEBUFEATURE_LOGGED_TRAITS@@PEBUFEATURE_ERROR@@HPEBW4wil_ReportingKind@@PEBW4wil_VariantReportingKind@@E_K@Z @ 0x18000A990
 * Callers:
 *     <none>
 * Callees:
  ...
  if ( v11 && *v11 )
  {
    ...
    if ( a5 )
    {
        ...
        && (*(_QWORD *)(v13 + 24) & 2LL) == *(_QWORD *)(v13 + 24) )
      {
        ...
        v63 = 4LL;
        v65 = 8LL;
        TlgWrite((TraceLoggingHProvider)v13, &unk_18016B111, 0LL, 0LL, 9u, &pData);
      }
      if ( *((_BYTE *)a2 + 4) == 1 )
      {
        if ( v8 )
        {
            ...
            && (*(_QWORD *)(v17 + 24) & 0xALL) == *(_QWORD *)(v17 + 24) )
          {
            ...
            v63 = 4LL;
            v65 = 8LL;
            TlgWrite((TraceLoggingHProvider)v17, &unk_18016AF86, 0LL, 0LL, 9u, &pData);
          }
        }
      }
    }
    else
    {
      ...
      if ( a6 )
      {
          ...
          && (*(_QWORD *)(v19 + 24) & 4LL) == *(_QWORD *)(v19 + 24) )
        {
          ...
          v65 = 1LL;
          v67 = 8LL;
          TlgWrite((TraceLoggingHProvider)v19, &unk_18016B416, 0LL, 0LL, 0xAu, &pData);
        }
      }
      else if ( a3 )
      {
          ...
          && (*(_QWORD *)(v23 + 24) & 1LL) == *(_QWORD *)(v23 + 24) )
        {
          ...
          v92 = 0;
          v94 = 4LL;
          TlgWrite((TraceLoggingHProvider)v23, &unk_18016B182, 0LL, 0LL, 0x14u, &pData);
        }
      }
    }
  }
