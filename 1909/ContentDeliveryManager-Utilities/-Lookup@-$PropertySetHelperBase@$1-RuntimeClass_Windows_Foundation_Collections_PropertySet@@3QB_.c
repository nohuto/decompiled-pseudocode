/*
 * XREFs of ?Lookup@?$PropertySetHelperBase@$1?RuntimeClass_Windows_Foundation_Collections_PropertySet@@3QB_WB@Triggers@CreativeFramework@@QEBAJPEB_WPEAPEAUIPropertyValue@Foundation@Windows@@@Z @ 0x180076E34
 * Callers:
        ...
        _QWORD *a3)
{
  ...
  unsigned int v5; // ebx
  __int64 v6; // rbx
  __int64 (__fastcall *v7)(__int64, PVOID, _QWORD); // rsi
  HSTRING_HEADER *v8; // rdi
  int v9; // eax
  __int64 v10; // rdx
  ...
  *a3 = 0LL;
  ...
  v14 = 0LL;
  v6 = v15;
  v7 = *(__int64 (__fastcall **)(__int64, PVOID, _QWORD))(*(_QWORD *)v15 + 48LL);
