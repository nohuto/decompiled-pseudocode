/*
 * XREFs of StorpInititalizePerUnitPerfTelemetry @ 0x1C006FFAC
 * Callers:
...
__int64 __fastcall StorpInititalizePerUnitPerfTelemetry(LARGE_INTEGER *a1)
{
  ...
  a1[276].QuadPart = (__int64)Pool;
  if ( Pool )
  {
    memset(Pool, 0, (unsigned int)Size);
    v5 = RaidAllocatePool(NonPagedPoolNx, HIDWORD(qword_1C0062480), 0x65546152u, a1[1].QuadPart);
    a1[278].QuadPart = (__int64)v5;
    if ( v5 )
    {
      memset(v5, 0, HIDWORD(qword_1C0062480));
      if ( UseQPCTime )
        PerformanceCounter = KeQueryPerformanceCounter(0LL);
      else
        PerformanceCounter.QuadPart = KeQueryUnbiasedInterruptTime();
      v7 = a1[1].QuadPart;
      a1[277] = PerformanceCounter;
      v8 = RaidAllocatePool(NonPagedPoolNx, (unsigned int)dword_1C006249C, 0x65546152u, v7);
      a1[279].QuadPart = (__int64)v8;
      if ( v8 )
        memset(v8, 0, (unsigned int)dword_1C006249C);
      result = 0LL;
      a1[280].QuadPart = 0LL;
      a1[281].QuadPart = 0LL;
      a1[282].QuadPart = 0LL;
  ...
  v10 = (void *)a1[278].QuadPart;
  if ( v10 )
  {
    ExFreePoolWithTag(v10, 0x65546152u);
    a1[278].QuadPart = 0LL;
  }
  v11 = (void *)a1[279].QuadPart;
  if ( v11 )
  {
