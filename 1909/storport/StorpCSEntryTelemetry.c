/*
 * XREFs of StorpCSEntryTelemetry @ 0x1C004CF30
 * Callers:
...
void __fastcall StorpCSEntryTelemetry(__int64 a1)
{
  ...
  if ( a1 )
  {
    ...
    *(_QWORD *)(a1 + 5280) = 0LL;
    v4 = (unsigned __int64)(v3 - *(_QWORD *)(a1 + 5272)) * (unsigned __int128)0x346DC5D63886594BuLL;
    v5 = *(_QWORD *)(a1 + 5024);
    *(_QWORD *)(a1 + 5272) = v2;
    v6 = *((_QWORD *)&v4 + 1) >> 11;
    *(_QWORD *)(a1 + 5288) = 0LL;
    ...
    *(_DWORD *)(a1 + 5368) = 0;
    if ( v5 )
    {
      ...
      if ( (unsigned int)dword_1C0062058 > 5 && TlgKeywordOn((TraceLoggingHProvider)v5, 0x400000000000uLL) )
      {
        v23 = *(_DWORD *)(a1 + 56);
        v55 = a1 + 5128;
        v57 = &v23;
        ...
        v58 = 4LL;
        v60 = 8LL;
        TlgWrite(v8, &unk_1C0057822, v9, v10, 5u, &pData);
      }
    }
      ...
      if ( RaidUnitCheckAndAcquirePoFx((__int64)(i - 7)) )
      {
        ...
        if ( (unsigned int)dword_1C0062058 > 5 )
        {
          if ( TlgKeywordOn(v13, 0x400000000000uLL) )
          {
            ...
            v51 = 8LL;
            v53 = 4LL;
            TlgWrite(v14, &unk_1C0057887, v15, v16, 0xDu, &v31);
          }
        }
