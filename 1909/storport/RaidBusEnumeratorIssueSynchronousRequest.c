/*
 * XREFs of RaidBusEnumeratorIssueSynchronousRequest @ 0x1C00140B4
 * Callers:
 ...
 *     RaidBuildScsiIrp @ 0x1C00144D8 (RaidBuildScsiIrp.c)
        ...
        unsigned __int8 a5)
{
  ...
  unsigned __int8 v81; // [rsp+238h] [rbp+138h]
...
LABEL_3:
  ...
  v78 = v51;
  v79 = v41;
  v52 = (__int64)a4 + *((unsigned int *)a4 + 13);
  if ( *(_WORD *)v52 == 1 )
  {
    v10 = *(_BYTE *)(v52 + 8);
    v11 = *(_BYTE *)(v52 + 9);
...
LABEL_46:
      ...
      && BYTE1(WPP_GLOBAL_Control->Timer) >= 4u )
    {
      ...
      if ( !v83 )
        v57 = "not retried";
      WPP_SF_qdddDDs(WPP_GLOBAL_Control->AttachedDevice, v81, v12, *a1, v10, v11, v12, v81, v26, (__int64)v57);
    }
LABEL_18:
    if ( !v83-- )
      return (unsigned int)Status;
