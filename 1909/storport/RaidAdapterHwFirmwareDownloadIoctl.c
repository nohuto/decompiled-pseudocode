/*
 * XREFs of RaidAdapterHwFirmwareDownloadIoctl @ 0x1C0035040
 * Callers:
 ...
 *     RaidAdapterHwFirmwareGetInfoFromMiniport @ 0x1C003518C (RaidAdapterHwFirmwareGetInfoFromMiniport.c)
