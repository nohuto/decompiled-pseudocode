/*
 * XREFs of RaidUnitCompleteResetRequest @ 0x1C0048580
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall RaidUnitCompleteResetRequest(__int64 a1)
{
  ...
  if ( v7 != 16 )
  {
    if ( (_BYTE)a1 == 40 )
      v6 = *(_DWORD *)(v1 + 20);
    _InterlockedDecrement((volatile signed __int32 *)(v4 + 1292));
    if ( v6 >= 0x12 )
    {
      if ( v6 <= 0x13 )
      {
  ...
  if ( v8 == 16 && (unsigned int)dword_1C0062058 > 5 && TlgKeywordOn((TraceLoggingHProvider)a1, 0x400000000000uLL) )
  {
    v11 = *(_QWORD *)(v4 + 24);
    ...
    v37 = (int)v10;
    v40 = (int)v10;
    TlgWrite(v12, &unk_1C00573E0, v9, v10, 9u, &v20);
  }
