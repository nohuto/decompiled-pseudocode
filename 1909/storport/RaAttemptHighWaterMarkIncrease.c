/*
 * XREFs of RaAttemptHighWaterMarkIncrease @ 0x1C004A700
 * Callers:
 ...
 *     RaAttemptHighWaterMarkIncreasePassive @ 0x1C0023780 (RaAttemptHighWaterMarkIncreasePassive.c)
 * Callees:
...
char __fastcall RaAttemptHighWaterMarkIncrease(__int64 a1, int a2)
{
  ...
  if ( KeGetCurrentIrql() && !*(_BYTE *)(a1 + 184) )
  {
    ...
    if ( *(_QWORD *)(v4 + 5704)
      || (WorkItem = IoAllocateWorkItem(*(PDEVICE_OBJECT *)(v4 + 8)), (*(_QWORD *)(v4 + 5704) = WorkItem) != 0LL) )
    {
      if ( !_InterlockedCompareExchange((volatile signed __int32 *)(v4 + 5720), 1, 0) )
        IoQueueWorkItem(
          *(PIO_WORKITEM *)(v4 + 5704),
