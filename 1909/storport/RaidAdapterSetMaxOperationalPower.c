/*
 * XREFs of RaidAdapterSetMaxOperationalPower @ 0x1C0040AB8
 * Callers:
 ...
 *     RaidAdapterPassiveCoolingCallback @ 0x1C00408B0 (RaidAdapterPassiveCoolingCallback.c)
 * Callees:
 ...
 *     RaidAdapterEffectiveMaxOperationalPower @ 0x1C004087C (RaidAdapterEffectiveMaxOperationalPower.c)
 */
...
LABEL_11:
  ...
  if ( (unsigned int)dword_1C0062058 > 5 )
  {
    if ( TlgKeywordOn(v14, 0x400000000000uLL) )
    {
      ...
      v56 = 8LL;
      v58 = 8LL;
      TlgWrite(v17, &unk_1C0056EFC, v18, v19, 0xEu, &pData);
    }
  }
