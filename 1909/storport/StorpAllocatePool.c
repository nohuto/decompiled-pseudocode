/*
 * XREFs of StorpAllocatePool @ 0x1C00184C4
 * Callers:
  ...
  if ( a4 )
  {
    *a4 = 0LL;
    if ( KeGetCurrentIrql() > 2u )
    {
      ...
      {
        WPP_SF_(WPP_GLOBAL_Control->AttachedDevice, 27LL, &WPP_6f3540a332da34b92ff0af100460ee8b_Traceguids);
      }
      ...
      *a4 = PoolWithTag;
      if ( !PoolWithTag )
      {
        if ( WPP_GLOBAL_Control != (PDEVICE_OBJECT)&WPP_GLOBAL_Control
          ...
          && BYTE1(WPP_GLOBAL_Control->Timer) >= 2u )
        {
          WPP_SF_(WPP_GLOBAL_Control->AttachedDevice, 28LL, &WPP_6f3540a332da34b92ff0af100460ee8b_Traceguids);
        }
