/*
 * XREFs of RaidZoneWriteGroupListSearchRequest @ 0x1C0039CF8
 * Callers:
 ...
 *     PortSrbGetLbaFromCdb @ 0x1C00521C8 (PortSrbGetLbaFromCdb.c)
 */
...
LABEL_42:
  ...
  v35 = *(_QWORD *)(v32 + 3032) / (unsigned __int64)v46;
  ...
  if ( a5 )
  {
    ...
    if ( PoolWithTag )
    {
      ...
      *((_DWORD *)PoolWithTag + 15) = 0;
      ...
      PoolWithTag[6] = 0LL;
      PoolWithTag[2] = v36;
      PoolWithTag[4] = (unsigned int)v35;
      *((_DWORD *)PoolWithTag + 14) = 0;
      RaidGetIoStartingLbaAndLength(v12, (__int64)(PoolWithTag + 5), (__int64)&v45);
      if ( i != (_QWORD *)(a1 + 128) )
      {
        v41 = (_QWORD *)*i;
        if ( *(_QWORD **)(*i + 8LL) == i )
