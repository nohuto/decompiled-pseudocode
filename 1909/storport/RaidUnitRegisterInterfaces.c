/*
 * XREFs of RaidUnitRegisterInterfaces @ 0x1C0018EA4
 * Callers:
...
__int64 __fastcall RaidUnitRegisterInterfaces(__int64 a1)
{
  ...
  if ( (int)result >= 0 )
  {
    ...
    v8 = *(_QWORD *)(PortGetDeviceType(**(_BYTE **)(a1 + 104) & 0x1F, v4, v7) + 16);
    v12 = -1LL;
    do
      ++v12;
    while ( *(_WORD *)(v8 + 2 * v12) );
    PortMapBuildLunEntry((int)Handle, v14, v11, a1 + 112, v10, v9, v8, v12, v13);
    ZwClose(Handle);
