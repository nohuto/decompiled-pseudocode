/*
 * XREFs of StorpTelemetryLogUnitQosDataMeasures @ 0x1C004F578
 * Callers:
...
void __fastcall StorpTelemetryLogUnitQosDataMeasures(const struct _TlgProvider_t *a1)
{
  ...
  if ( (unsigned int)dword_1C0062058 > 5 )
  {
    if ( TlgKeywordOn(a1, 0x400000000000uLL) )
    {
      ...
      *(_DWORD *)hProvider = *(_DWORD *)(v2 + 2980);
      *(_DWORD *)&hProvider[4] = *(_DWORD *)(v2 + 2984);
      *(_QWORD *)&hProvider[8] = *(_QWORD *)(v2 + 2988);
      *(_QWORD *)&hProvider[16] = *(_QWORD *)(v2 + 2996);
      v6 = (*(_BYTE *)(v2 + 450) & 2) != 0;
      v21 = 16LL;
      v14 = v6;
      *(_OWORD *)&hProvider[36] = *(_OWORD *)(v2 + 2080);
      v15 = *(_BYTE *)(v3 + 32);
      *(_QWORD *)&hProvider[52] = *(_QWORD *)(v2 + 2096);
      v18 = *(_QWORD *)(v2 + 2104);
      *(_QWORD *)&hProvider[24] = *(_QWORD *)(v2 + 2112);
      *(_DWORD *)&hProvider[32] = *(_DWORD *)(v3 + 28);
      ...
      v62 = 4LL;
      v64 = 4LL;
      TlgWrite((TraceLoggingHProvider)hProvider, &unk_1C0058104, v9, v10, 0x1Au, &pData);
    }
  }
}
