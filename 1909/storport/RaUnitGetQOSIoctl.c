/*
 * XREFs of RaUnitGetQOSIoctl @ 0x1C00459D0
 * Callers:
...
__int64 __fastcall RaUnitGetQOSIoctl(__int64 a1, IRP *a2)
{
  ...
  if ( a2->Tail.Overlay.CurrentStackLocation->Parameters.Read.Length >= 0x24 )
  {
    ...
    *(_DWORD *)(&MasterIrp->Size + 1) = 36;
    LOBYTE(MasterIrp->MdlAddress) = *(_BYTE *)(a1 + 2976);
    LODWORD(MasterIrp->ThreadListEntry.Flink) = *(_DWORD *)(a1 + 2988);
    HIDWORD(MasterIrp->MdlAddress) = *(_DWORD *)(a1 + 2980);
    *(&MasterIrp->Flags + 1) = 1000 * *(_DWORD *)(a1 + 2992);
    v6 = -1;
    v7 = *(_DWORD *)(a1 + 2984);
    if ( v7 == -1 )
      v8 = -1;
    ...
    if ( v9 != -1 )
      v6 = 500 * v9;
    MasterIrp->Flags = v6;
    MasterIrp->AssociatedIrp.IrpCount = 1000 * *(_DWORD *)(a1 + 2996);
    v5 = 0;
    v4 = 36LL;
  }
  else
