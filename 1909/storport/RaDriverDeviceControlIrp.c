/*
 * XREFs of RaDriverDeviceControlIrp @ 0x1C00075B0
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall RaDriverDeviceControlIrp(__int64 a1, __int64 a2)
{
  ...
  {
    WPP_SF_qq(WPP_GLOBAL_Control->AttachedDevice, 16LL, &WPP_0ece2f36f1a933110a118c5b83c83ab6_Traceguids, a1, a2);
  }
  *(_BYTE *)(a2 + 141) = -88;
  v4 = **(_DWORD **)(a1 + 64);
  if ( v4 )
  {
    ...
    v5 = RaUnitDeviceControlIrp(*(_QWORD *)(a1 + 64), (PIRP)a2);
  }
  else
  {
...
LABEL_7:
  if ( WPP_GLOBAL_Control != (PDEVICE_OBJECT)&WPP_GLOBAL_Control
    ...
    && BYTE1(WPP_GLOBAL_Control->Timer) >= 4u )
  {
    WPP_SF_qqD(WPP_GLOBAL_Control->AttachedDevice, 17LL, &WPP_0ece2f36f1a933110a118c5b83c83ab6_Traceguids, a1, a2, v6);
  }
  return v6;
}
