/*
 * XREFs of StorpMeasuresMiniportEventUnit @ 0x1C004DF08
 * Callers:
...
char __fastcall StorpMeasuresMiniportEventUnit(__int64 a1, __int64 a2, __int64 a3, int *a4)
{
  ...
  *(_DWORD *)v94 = 0;
  ...
  {
    LOBYTE(v4) = TlgKeywordOn((TraceLoggingHProvider)a1, 0x400000000000uLL);
    if ( (_BYTE)v4 )
    {
      if ( v9 && (v10 = *(_BYTE **)(v9 + 104)) != 0LL )
        v11 = *v10 & 0x1F;
      else
        v11 = 31;
      v22 = v11;
      ...
      *(_QWORD *)&hProvider.LevelPlus1 = v16;
      ...
      LOBYTE(v4) = TlgWrite(&hProvider, &unk_1C00590FD, v19, v20, 0x24u, (EVENT_DATA_DESCRIPTOR *)&hProvider.RegHandle);
    }
  }
  return v4;
}
