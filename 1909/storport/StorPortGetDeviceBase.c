/*
 * XREFs of StorPortGetDeviceBase @ 0x1C001DBC0
 * Callers:
 *     StorPortGetDeviceBaseVrfy @ 0x1C0078240 (StorPortGetDeviceBaseVrfy.c)
 * Callees:
 *     RaidAllocateAddressMapping @ 0x1C001DC88 (RaidAllocateAddressMapping.c)
 *     RaidTranslateResourceListAddress @ 0x1C001DD24 (RaidTranslateResourceListAddress.c)
