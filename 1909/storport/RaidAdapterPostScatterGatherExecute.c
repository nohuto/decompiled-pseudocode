/*
 * XREFs of RaidAdapterPostScatterGatherExecute @ 0x1C00046A0
 * Callers:
 ...
 *     RaAllocateConcurrentChannelToken @ 0x1C0022B6C (RaAllocateConcurrentChannelToken.c)
...
__int64 __fastcall RaidAdapterPostScatterGatherExecute(__int64 a1, _QWORD *a2)
{
  ...
  if ( v7 )
  {
    ...
    else if ( *(_BYTE *)(v7 + 692) && (v8 & 0x10) == 0 || *(_BYTE *)(v7 + 693) && (v8 & 0x80000) == 0 )
    {
      goto LABEL_97;
    }
  }
...
LABEL_50:
  ...
  if ( *(_BYTE *)(a1 + 4450) )
  {
    ...
    if ( v14 )
      ...
      v15 = 1;
    if ( StorEtwLoggingEnabled && ((byte_1C0062741 & 2) != 0 || (byte_1C0062743 & 2) != 0) )
    {
      if ( UseQPCTime )
...
LABEL_146:
  if ( (unsigned __int8)IsZonedWriteRequest(v5[28], 0LL, v5) )
  {
    ...
    v59 = v5[28];
    v87 = 0;
    v60 = RaidZoneWriteGroupListSearchRequest((int)v59 + 656, 0, (_DWORD)v5, *(_DWORD *)(v59 + 836), 0);
    ...
    KeAcquireInStackQueuedSpinLock((PKSPIN_LOCK)(v5[28] + 800LL), &v83);
    --*(_DWORD *)(v60 + 56);
    if ( (unsigned __int64)(v61 - *(_QWORD *)(v60 + 16)) >= *(_QWORD *)(v60 + 32) )
    {
      ...
      RaidZoneWriteGroupListRemoveRequest(v5[28] + 656LL, v60, 0LL);
    }
  ...
  if ( v51 )
  {
    ...
    if ( !v67 && *v51 == 0x94 && v51[1] == 4 )
    {
      ...
      {
        v72 = RaidZoneWriteGroupListSearchRequest(v71, 0, (_DWORD)v5, *(_DWORD *)(v68 + 836), 0);
        if ( !v72 )
          goto LABEL_178;
        v71 = v5[28] + 656LL;
      }
...
LABEL_28:
  ...
  *((_BYTE *)v5 + 16) = v5[2] & 0xE3 | 0xC;
  ...
  if ( (qword_1C00622B0 & 4) != 0 && *(_DWORD *)(a1 + 4996) && *(_QWORD *)(a1 + 5000) )
  {
    v38 = *(_QWORD *)(a1 + 5000)
