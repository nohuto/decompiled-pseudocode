/*
 * XREFs of RaUnitWaitForRemoveLock @ 0x1C001736C
 * Callers:
...
__int64 __fastcall RaUnitWaitForRemoveLock(__int64 a1)
{
  ...
  if ( v3 + _InterlockedExchangeAdd((volatile signed __int32 *)(a1 + 936), v3 - 0x10000000) - 0x10000000 > 0 )
  {
    ...
    {
      WPP_SF_(WPP_GLOBAL_Control->AttachedDevice, 11LL, &WPP_039d08731c2235659c9f4b1fdc9bb8d6_Traceguids);
    }
  }
  else
  {
  ...
  _InterlockedExchangeAdd((volatile signed __int32 *)(a1 + 936), 0x10000000u);
  if ( (_DWORD)v4 )
  {
    v9 = 0LL;
    v10 = v4;
