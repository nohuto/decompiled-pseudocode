/*
 * XREFs of McTemplateK0pquuutq @ 0x1C003FDB8
 * Callers:
...
ULONG McTemplateK0pquuutq(struct _MCGEN_TRACE_CONTEXT *a1, __int64 a2, __int64 a3, ...)
{
  ...
  v17 = 4LL;
  v19 = 4LL;
  return McGenEventWrite(a1, &EventUnitPowerNotRequiredStart, 0LL, 8u, &EventData);
}
