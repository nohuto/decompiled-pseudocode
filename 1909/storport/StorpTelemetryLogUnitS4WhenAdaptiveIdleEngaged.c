/*
 * XREFs of StorpTelemetryLogUnitS4WhenAdaptiveIdleEngaged @ 0x1C0010840
 * Callers:
 *     RaidUnitSetSystemPowerIrp @ 0x1C00105C4 (RaidUnitSetSystemPowerIrp.c)
 * Callees:
 *     RaidUnitGetMinimumPowerCyclePeriod @ 0x1C0006A58 (RaidUnitGetMinimumPowerCyclePeriod.c)
...
void __fastcall StorpTelemetryLogUnitS4WhenAdaptiveIdleEngaged(__int64 a1)
{
  ...
  if ( RaidUnitCheckAndAcquirePoFx(a1) )
  {
    ...
    if ( (v2 & 0x80u) != 0 && (v2 & 0x100) != 0 && (unsigned int)dword_1C0062058 > 5 )
    {
      if ( TlgKeywordOn(*(TraceLoggingHProvider *)(a1 + 1744), 0x400000000000uLL) )
      {
        ...
        v31 = 4LL;
        v33 = 8LL;
        TlgWrite(v6, &unk_1C0057F97, v7, v5, 0xBu, &pData);
      }
    }
