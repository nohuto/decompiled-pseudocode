/*
 * XREFs of TranslateToExtendedSrb @ 0x1C0042F60
 * Callers:
 ...
 *     TranslateScsiRequestBlockToStorageRequestBlock @ 0x1C0042E44 (TranslateScsiRequestBlockToStorageRequestBlock.c)
 */
...
LABEL_51:
  ...
  if ( (Microsoft_Windows_StorPortEnableBits & 0x40) != 0 )
    McTemplateK0zx(v20.QuadPart, v19.QuadPart, v21.QuadPart, (char *)L"Translate SCSI_REQUEST_BLOCK", v6);
