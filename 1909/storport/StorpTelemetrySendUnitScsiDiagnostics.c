/*
 * XREFs of StorpTelemetrySendUnitScsiDiagnostics @ 0x1C0023EA0
 * Callers:
 ...
 *     StorpTelemetryGetReadErrorCounter @ 0x1C0023D10 (StorpTelemetryGetReadErrorCounter.c)
 *     StorpTelemetryGetStartStopCycleCounter @ 0x1C0023D70 (StorpTelemetryGetStartStopCycleCounter.c)
 *     StorpTelemetryGetWriteErrorCounter @ 0x1C0023E44 (StorpTelemetryGetWriteErrorCounter.c)
        ...
        while ( 1 )
        {
          ...
          if ( v6 >= 8 )
          {
            if ( (byte_1C0062744 & 8) != 0 )
              McTemplateK0quuujjzssstxuuzqqqqxxxxxxhuuqqbr29qbr31qbr33qbr35qbr37qbr39qbr41qbr43(
                v1 + 186,
                v1 + 169,
                v1 + 160,
                ...
                *(_BYTE *)(v1 + 98),
                v1 + 1976,
                *(_QWORD *)(v1 + 24) + 5128LL,
                *(char **)(*(_QWORD *)(v1 + 24) + 4800LL),
                (const struct _MCGEN_TRACE_CONTEXT *)(v1 + 160),
                (const struct _MCGEN_TRACE_CONTEXT *)(v1 + 169),
                (const struct _MCGEN_TRACE_CONTEXT *)(v1 + 186),
                *(_BYTE *)(v1 + 450) & 1,
                v20,
                v26[0],
                SBYTE1(v26[0]),
                (struct _MCGEN_TRACE_CONTEXT *)((char *)v26 + 2),
                SBYTE4(v26[8]),
                v26[9],
                SBYTE4(v26[9]),
                v26[10],
