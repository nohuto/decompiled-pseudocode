/*
 * XREFs of SrbShimHookDeviceControl @ 0x1C0022F90
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall SrbShimHookDeviceControl(__int64 a1, __int64 a2)
{
  ...
  if ( *((_DWORD *)v2 + 6) == 2954240 )
  {
    ...
    if ( v8 )
    {
      if ( !v8[1] && *v8 == 1 && *((_DWORD *)v2 + 2) >= 0x20u )
      {
        ...
        (*(void (__fastcall **)(__int64, __int64, __int64 (__fastcall *)(), _QWORD))(qword_1C00620E0 + 8))(
          a1,
          a2,
  ...
  v6 = (*(__int64 (__fastcall **)(_QWORD))qword_1C00620E0)(*(_QWORD *)(a1 + 8));
