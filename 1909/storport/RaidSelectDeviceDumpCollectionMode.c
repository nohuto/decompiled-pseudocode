/*
 * XREFs of RaidSelectDeviceDumpCollectionMode @ 0x1C0014E84
 * Callers:
 ...
 *     RaidRegGetDeviceDumpSupportLevel @ 0x1C0014FAC (RaidRegGetDeviceDumpSupportLevel.c)
 *     RaidRegGetDeviceDumpMaxSize @ 0x1C001503C (RaidRegGetDeviceDumpMaxSize.c)
