/*
 * XREFs of RaidpAdapterDpcRoutine @ 0x1C000ED40
 * Callers:
 *     <none>
 * Callees:
        ...
        PVOID SystemArgument2)
{
  ...
  *(_QWORD *)&Affinity.Group = 0LL;
  ...
  if ( StorEtwLoggingEnabled && (byte_1C0062743 & 4) != 0 )
  {
    if ( UseQPCTime )
  ...
  v8 = 0;
  v9 = *(_QWORD *)(v4 + 240) != 0LL;
  if ( DpcCompletionLimit )
  {
    do
    {
      p_Next = *(_QWORD **)(v4 + 240);
      if ( !p_Next )
      {
        if ( v8 )
          break;
        v11 = ExpInterlockedFlushSList((PSLIST_HEADER)(v4 + 224));
        *(_QWORD *)(v4 + 240) = v11;
        v8 = 1;
        p_Next = &v11->Next;
        if ( !v11 )
...
LABEL_16:
  ...
  if ( (unsigned int)(MEMORY[0xFFFFF78000000320] - v31) > *(_DWORD *)(v4 + 4792) )
  {
    *(_DWORD *)(v4 + 4792) = v28;
    *(_DWORD *)(v4 + 4796) = v7;
  }
  if ( v7 > *(_DWORD *)(v4 + 4788) )
    *(_DWORD *)(v4 + 4788) = v7;
  if ( StorEtwLoggingEnabled && (byte_1C0062743 & 4) != 0 && v7 >= 0x19 )
  {
