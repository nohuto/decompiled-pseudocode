/*
 * XREFs of RaUnitSmartDataIoctl @ 0x1C0046560
 * Callers:
 ...
 *     RaUnitBuildSrbForSmartReadData @ 0x1C004525C (RaUnitBuildSrbForSmartReadData.c)
 *     RaUnitBuildSrbForSmartReturnStatus @ 0x1C00454AC (RaUnitBuildSrbForSmartReturnStatus.c)
...
__int64 __fastcall RaUnitSmartDataIoctl(__int64 a1, IRP *a2)
{
  ...
  P = 0LL;
  v12 = *(_DWORD *)(v11 + 4356);
  if ( (((v12 - 8) & 0xFFFFFFFD) != 0 || (*(_BYTE *)(a1 + 450) & 0x10) == 0) && v12 != 11 )
  {
    Status = -1073741637;
LABEL_5:
    v13 = 0LL;
