/*
 * XREFs of RaidStartIoPacket @ 0x1C0008210
 * Callers:
...
LABEL_140:
    ...
    *(_QWORD *)(v126 + 16) = 0LL;
    ...
    if ( !*(_QWORD *)(v69 + 5024) )
      goto LABEL_167;
LABEL_145:
    if ( KeGetCurrentIrql() >= 2u || *(char *)(a1 + 448) < 0 || (v70 = *(_BYTE *)(a1 + 449), (v70 & 1) != 0) )
    {
    ...
    else
    {
      ...
      if ( v70 < 0 && ExAcquireRundownProtectionCacheAware(*(PEX_RUNDOWN_REF_CACHE_AWARE *)(a1 + 1736)) )
      {
        if ( *(char *)(v69 + 108) < 0 )
        {
        ...
        v75 = *(volatile signed __int32 **)(a1 + 1744);
        if ( (v75[35] & 1) != 0 )
        {
...
LABEL_167:
    ...
    PoolWithTag = 0LL;
    if ( *(_DWORD *)(a1 + 3000) != -1 || *(_DWORD *)(a1 + 2984) != -1 || *(_DWORD *)(a1 + 2988) )
    {
      v79 = *(_QWORD *)(a1 + 8);
      ...
      if ( PoolWithTag )
      {
        ...
        *(_DWORD *)PoolWithTag = 300819165;
        if ( *(_DWORD *)(a1 + 3000) == -1 )
          ...
          v80 = (unsigned int)(5000000 * *(_DWORD *)(a1 + 3000)) + KeQueryUnbiasedInterruptTime();
        PoolWithTag[1] = v80;
        v81 = a2;
        v136 |= 0x10u;
        PoolWithTag[5] = a2;
...
LABEL_186:
        ...
        *(_QWORD *)(v84 + 32) = a1;
        ...
        inserted = RaidInsertDeviceQueue((int)a1 + 656, a2, v136, Number, v85, (__int64)&v124, (__int64)&v123);
        if ( inserted )
        {
          if ( v85 )
            ++*(_QWORD *)(a1 + 1968);
        ...
        if ( (v136 & 8) == 0 && *(_BYTE *)(a1 + 695) && *(char *)(a1 + 449) >= 0 )
...
LABEL_235:
              ...
              (IoResource = (PSLIST_ENTRY)RaAllocateIoResource((PSLIST_HEADER)(v93 + 64))) != 0LL) )
        {
          ...
          *((_DWORD *)&v106[48].Next + 2) = 0;
          v106[49].Next = Next;
          (*(void (__fastcall **)(_QWORD, __int64, __int64 *))(a1 + 648))(*(_QWORD *)(a1 + 640), a2, &v128);
          v111 = 1;
          goto LABEL_254;
        }
        KeAcquireInStackQueuedSpinLockAtDpcLevel((PKSPIN_LOCK)v93, &v127);
...
LABEL_83:
  ...
  if ( !v29 || ((LOBYTE(v29->SecurityQos) - 10) & 0x5F) != 0 || (v47 = *(_DWORD *)(a1 + 836)) == 0 )
  {
    v4 = (IRP *)a2;
    goto LABEL_128;
  }
  ...
  if ( (SecurityQos & 0x1000) == 0 )
    goto LABEL_128;
  v49 = RaidZoneWriteGroupListSearchRequest((int)a1 + 656, a2, 0, v47, 1);
  if ( v49 )
  {
...
LABEL_115:
    ...
    if ( v125 > v61 && (*(_DWORD *)(a1 + 672) != v60 || *(_DWORD *)(a1 + 732) != v60) )
    {
      v3 = v136 | 0x20;
      v136 |= 0x20u;
      goto LABEL_129;
