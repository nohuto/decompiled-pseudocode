/*
 * XREFs of StorpTelemetrySendUnitPerfData @ 0x1C000C9E4
 * Callers:
...
__int64 __fastcall StorpTelemetrySendUnitPerfData(__int64 a1)
{
  ...
  v2 = (unsigned int)qword_1C0062480;
  v3 = 0LL;
  v44 = 0LL;
  Pool = 0LL;
  v5 = 0LL;
  ...
  if ( *(_QWORD *)(a1 + 2208) )
  {
          ...
          (v5 = RaidAllocatePool(NonPagedPoolNx, Size, 0x65546152u, v8)) != 0LL) )
    {
      ...
      v10 = v9;
      if ( v9.QuadPart > 0 && (v11 = *(_QWORD *)(a1 + 2216), v9.QuadPart < v11) )
        v12 = v9.QuadPart - v11 - 1;
      else
        v12 = v9.QuadPart - *(_QWORD *)(a1 + 2216);
      if ( UseQPCTime )
      {
        v13 = 0LL;
      ...
      qword_1C0062490 = v10.QuadPart;
      v14 = *(const void **)(a1 + 2208);
      *(LARGE_INTEGER *)(a1 + 2216) = v10;
      v48[36] = v13;
      ...
      memmove(v19, Pool, HIDWORD(qword_1C0062480));
      if ( v48[75] )
      {
        v48[75] = 0LL;
        if ( (_WORD)TelemetryPerfContext )
        {
          if ( WORD1(TelemetryPerfContext) )
          {
            ...
            if ( (_DWORD)v2 )
            {
              ...
              do
              {
                if ( (unsigned int)v26 < dword_1C006247C && (unsigned int)v26 >= dword_1C006244C )
                {
        ...
        if ( *(_QWORD *)(a1 + 2232) )
        {
          ...
          do
          {
            v31 = (unsigned __int64 *)(*(_QWORD *)(a1 + 2232) + dword_1C0062498 * (unsigned int)v30);
            v32 = *v31;
            v33 = *v31 <= v3;
            *v31 = 0LL;
            if ( !v33 )
          ...
          *((_QWORD *)&v46 + 1) = v6;
          v34 = v6 - *(_QWORD *)(a1 + 2248);
          v47 = v7;
          v35 = v7 - *(_QWORD *)(a1 + 2256);
          v36 = v47;
          *(_QWORD *)&v46 = v3;
          v48[77] = v3;
          v48[78] = v34;
