/*
 * XREFs of StorpTelemetrySendAdaptiveIdleCounters @ 0x1C000E634
 * Callers:
...
void __fastcall StorpTelemetrySendAdaptiveIdleCounters(__int64 a1)
{
  ...
  if ( RaidUnitCheckAndAcquirePoFx(a1) )
  {
    if ( (*(_DWORD *)(*(_QWORD *)(a1 + 1744) + 32LL) & 0x80u) != 0 )
    {
      ...
      v2 = MEMORY[0xFFFFF78000000014] - *(_QWORD *)(a1 + 2968);
      if ( v2 > 0 )
      ...
      if ( (unsigned int)dword_1C0062058 > 5 )
      {
        if ( TlgKeywordOn((TraceLoggingHProvider)v2, 0x400000000000uLL) )
        {
          ...
          v43 = 8LL;
          v45 = 8LL;
          TlgWrite((TraceLoggingHProvider)v12, &unk_1C005972D, (LPCGUID)v6, v3, 0xFu, &pData);
        }
      }
