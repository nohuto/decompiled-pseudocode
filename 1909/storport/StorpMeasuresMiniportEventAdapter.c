/*
 * XREFs of StorpMeasuresMiniportEventAdapter @ 0x1C004DC04
 * Callers:
...
void __fastcall StorpMeasuresMiniportEventAdapter(const struct _TlgProvider_t *a1, int *a2)
{
  __int64 v3; // rcx
  const WCHAR *v4; // rdx
  __int64 v5; // r10
  ...
  if ( (unsigned int)dword_1C0062058 > 5 )
  {
    if ( TlgKeywordOn(a1, 0x400000000000uLL) )
    {
      ...
      *(_QWORD *)&hProvider.LevelPlus1 = *((_QWORD *)a2 + 47);
      hProvider.CallbackContext = (void *)(v3 + 5128);
      v22 = 16LL;
      ...
      TlgWrite(&hProvider, &unk_1C0057451, v7, v8, 0x1Cu, (EVENT_DATA_DESCRIPTOR *)&hProvider.KeywordAny);
    }
  }
}
