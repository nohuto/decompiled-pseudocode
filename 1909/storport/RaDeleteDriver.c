/*
 * XREFs of RaDeleteDriver @ 0x1C007482C
 * Callers:
 *     StorPortInitialize @ 0x1C001AF20 (StorPortInitialize.c)
 *     RaDriverUnload @ 0x1C00395A0 (RaDriverUnload.c)
 * Callees:
 *     RaidReleasePortData @ 0x1C00101D4 (RaidReleasePortData.c)
 *     _guard_dispatch_icall_nop @ 0x1C0024A40 (_guard_dispatch_icall_nop.c)
 *     McGenEventUnregister @ 0x1C00394B4 (McGenEventUnregister.c)
 *     RaFreeDriverInitData @ 0x1C0039614 (RaFreeDriverInitData.c)
 *     RaidRemovePortDriver @ 0x1C003A508 (RaidRemovePortDriver.c)
