/*
 * XREFs of RaidAdapterRestartQueues @ 0x1C0016154
 * Callers:
 ...
 *     RaidAdapterRestartDpcRoutine @ 0x1C0036280 (RaidAdapterRestartDpcRoutine.c)
...
void __fastcall RaidAdapterRestartQueues(__int64 a1)
{
  ...
  while ( 1 )
  {
    ...
    if ( *(int *)(v1 + 280) > 0 )
    {
      KeAcquireInStackQueuedSpinLock((PKSPIN_LOCK)v1, &v15);
      v4 = 1;
    }
    if ( *(_DWORD *)(v1 + 24) )
    {
...
LABEL_31:
    if ( !v3 )
      goto LABEL_6;
    v14 = *(_QWORD *)(v3[8] + 32);
    (*(void (__fastcall **)(_QWORD, __int64 *, _QWORD *))(v14 + 648))(*(_QWORD *)(v14 + 640), v3 - 15, v17);
  }
  if ( !v4 )
    KeAcquireInStackQueuedSpinLock((PKSPIN_LOCK)v1, &v15);
  if ( *(_DWORD *)(v1 + 24) && *(int *)(v1 + 40) <= 0 && *(int *)(v1 + 44) <= 0 )
  {
    v7 = (_QWORD *)(v1 + 8);
    v3 = *(__int64 **)(v1 + 8);
    if ( v3[1] != v1 + 8 || (v8 = *v3, *(__int64 **)(*v3 + 8) != v3) )
LABEL_33:
      __fastfail(3u);
    *v7 = v8;
    *(_QWORD *)(v8 + 8) = v7;
