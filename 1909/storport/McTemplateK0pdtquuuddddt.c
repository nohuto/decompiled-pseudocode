/*
 * XREFs of McTemplateK0pdtquuuddddt @ 0x1C004ABE8
 * Callers:
...
ULONG McTemplateK0pdtquuuddddt(struct _MCGEN_TRACE_CONTEXT *a1, __int64 a2, const GUID *a3, ...)
{
  ...
  v26 = 4LL;
  v28 = 4LL;
  return McGenEventWrite(a1, &EventPassThroughProtocolCommand, a3, 0xDu, &EventData);
}
