/*
 * XREFs of RaidUnitResetUnit @ 0x1C0049498
 * Callers:
 ...
 *     StorpAggregateHierarchicalResetLun @ 0x1C004CE88 (StorpAggregateHierarchicalResetLun.c)
 */
...
__int64 __fastcall RaidUnitResetUnit(__int64 a1)
{
  ...
  unsigned __int64 *p_RegHandle; // [rsp+98h] [rbp-70h]
  ...
  if ( Srb )
  {
    ...
    if ( v13 )
    {
      ...
      if ( (unsigned int)dword_1C0062058 > 5 )
      {
        ...
        v44 = 1LL;
        v46 = 8LL;
        TlgWrite(v21, &unk_1C00571E5, v17, v18, 0xAu, &pData);
      }
