/*
 * XREFs of McTemplateK0pqtqq @ 0x1C003354C
 * Callers:
...
ULONG McTemplateK0pqtqq(struct _MCGEN_TRACE_CONTEXT *a1, __int64 a2, __int64 a3, ...)
{
  ...
  va_copy(v13, va4);
  v14 = 4LL;
  return McGenEventWrite(a1, &EventAdapterPoFxRegistered, 0LL, 6u, &EventData);
}
