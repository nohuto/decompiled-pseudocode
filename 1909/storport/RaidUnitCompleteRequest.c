/*
 * XREFs of RaidUnitCompleteRequest @ 0x1C0009590
 * Callers:
 *     <none>
 * Callees:
 ...
 *     StorpTelemetryCollectPerfData @ 0x1C000AB20 (StorpTelemetryCollectPerfData.c)
 ...
 *     RaidAdapterReleaseCryptoKeyResources @ 0x1C0035B08 (RaidAdapterReleaseCryptoKeyResources.c)
 ...
 *     RaidZoneWriteGroupListPendingIoCount @ 0x1C0039C14 (RaidZoneWriteGroupListPendingIoCount.c)
 *     RaidZoneWriteGroupListRemoveRequest @ 0x1C0039C94 (RaidZoneWriteGroupListRemoveRequest.c)
 ...
 *     RaidFreeRemappedScatterGatherListMdl @ 0x1C004A2C4 (RaidFreeRemappedScatterGatherListMdl.c)
...
LABEL_30:
    if ( StorEtwLoggingEnabled )
    {
      ...
      if ( *(_DWORD *)(v8 + 1812) && (byte_1C0062743 & 2) != 0 )
...
LABEL_88:
  ...
  if ( v133 / *(_DWORD *)(v8 + 584) < HighestNodeNumber + 1 )
    HighestNodeNumber = v133 / *(_DWORD *)(v8 + 584);
  ExpInterlockedPushEntrySList(
    (PSLIST_HEADER)(*(_QWORD *)(v8 + 512) + ((unsigned __int64)HighestNodeNumber << 6)),
    (PSLIST_ENTRY)(*(_QWORD *)(v8 + 576) + 16LL * v133));
  v134 = 0;
  ...
  if ( (*(_BYTE *)(v8 + 450) & 2) != 0 && (unsigned __int8)RaidIsUnresponsiveBlockedCmd(v5) )
  {
    v61 = *(_BYTE *)(v5 + 2) == 40;
    *(_BYTE *)(v5 + 3) = 56;
    if ( v61 )
...
LABEL_123:
  ...
  if ( (*(_BYTE *)(v5 + 3) & 0x3F) == 1 )
  {
    ...
    {
      StorRemoveEventQueue(*(_QWORD *)(v78 + 504), &v79[4]);
      if ( StorEtwLoggingEnabled )
      {
        v155[0] = 0LL;
        v155[1] = 0LL;
...
LABEL_156:
        ...
        {
LABEL_180:
          if ( !_InterlockedDecrement((volatile signed __int32 *)(v78 + 936)) )
            KeSetEvent((PRKEVENT)(v78 + 464), 0, 0);
        }
        else
        {
          while ( 1 )
          ...
          if ( Pool )
          {
            ...
            *Pool = WorkItem;
            if ( WorkItem )
            {
              ...
              _InterlockedIncrement((volatile signed __int32 *)(v8 + 936));
        ...
        {
          v102 = v136;
          if ( v143 && (v103 = *v143, !v136) && (v103 == 37 || v103 == -98) && !*(_DWORD *)(v8 + 836) )
          {
            if ( *(_BYTE *)(v5 + 2) == 40 )
              v104 = *(_QWORD *)(v5 + 64);
            else
...
LABEL_213:
          ...
          {
            if ( *v143 == -108 && v143[1] == 4 && *(_DWORD *)(v8 + 836) )
            {
              v61 = (v143[14] & 1) == 0;
              ...
              if ( v61 )
              {
                v109 = RaidZoneWriteGroupListSearchRequest(
                         (unsigned int)*(_QWORD *)(v105 + 224) + 656,
                         0,
                         v105,
                         *(_DWORD *)(*(_QWORD *)(v105 + 224) + 836LL),
                         0);
                v110 = (__int64 *)v109;
                if ( v109 )
                {
                  if ( (qword_1C00622B0 & 0x1000) != 0 )
                  {
                    v111 = RaidZoneWriteGroupListPendingIoCount(v8 + 656, v109);
                    DbgLogRequest(*(_QWORD *)(*(_QWORD *)(v105 + 224) + 24LL), 43, v110[2], v110[4], v110[5], v111, 0LL);
                  }
                  KeAcquireInStackQueuedSpinLock((PKSPIN_LOCK)(*(_QWORD *)(v105 + 224) + 800LL), &v152);
                  LOBYTE(v112) = 1;
                  RaidZoneWriteGroupListRemoveRequest(*(_QWORD *)(v105 + 224) + 656LL, v110, v112);
              ...
              else
              {
                if ( (qword_1C00622B0 & 0x1000) != 0 )
                {
                  v113 = RaidZoneWriteGroupListPendingIoCount(v8 + 656, 0LL);
                  DbgLogRequest(*(_QWORD *)(*(_QWORD *)(v105 + 224) + 24LL), 43, 0LL, 0LL, 0LL, v113, 0LL);
                }
                RaidZoneWriteGroupListPurge(*(_QWORD *)(v105 + 224) + 656LL);
              }
            }
            else if ( *v143 == -107 && !v143[1] && *(_DWORD *)(v8 + 836) )
            {
              if ( *(_BYTE *)(v5 + 2) == 40 ? *(_QWORD *)(v5 + 64) : *(_QWORD *)(v5 + 24) )
              {
                if ( MmIsAddressValid(*(PVOID *)(v105 + 184)) )
                {
                  ...
                  BYTE1(v141) = v115[78];
                  LOBYTE(v141) = v115[79];
                  v116 = v141 * *(unsigned int *)(v8 + 836);
                  if ( *(_QWORD *)(v8 + 3032) != v116 )
                    *(_QWORD *)(v8 + 3032) = v116;
                }
              }
            }
...
LABEL_248:
  if ( (v135 & 0x1C) != 0xC && v101 )
  {
    ...
    if ( v146 )
      (*(void (__fastcall **)(_QWORD, __int64, __int64 *))(*(_QWORD *)(*(_QWORD *)(v146 + 64) + 32LL) + 648LL))(
        *(_QWORD *)(*(_QWORD *)(*(_QWORD *)(v146 + 64) + 32LL) + 640LL),
        v146 - 120,
        &v147);
    if ( v118 )
    ...
    v125 = *(_DWORD *)(v8 + 836);
    v126 = ExAcquireSpinLockShared((PEX_SPIN_LOCK)(v8 + 728));
    if ( v134 || *(_DWORD *)(v8 + 688) || *(_DWORD *)(v8 + 696) || *(_DWORD *)(v8 + 676) || *(_DWORD *)(v8 + 672) )
    {
      ExReleaseSpinLockShared((PEX_SPIN_LOCK)(v8 + 728), v126);
      v127 = ExAcquireSpinLockExclusive((PEX_SPIN_LOCK)(v8 + 728));
      RiDeleteDeviceQueueEntry(v8 + 656, v134);
      v128 = RiNormalizeDeviceQueue(v8 + 656, v119, v125);
      ExReleaseSpinLockExclusive((PEX_SPIN_LOCK)(v8 + 728), v127);
      if ( v128 )
      {
        if ( StorEtwLoggingEnabled )
        {
        ...
        if ( !(unsigned __int8)StorSubmitIoGatewayItem(*(PKSPIN_LOCK *)(v8 + 664)) )
          (*(void (__fastcall **)(_QWORD, __int64, _QWORD *))(v8 + 648))(*(_QWORD *)(v8 + 640), v128 - 120, v151);
      }
      if ( v134 )
      {
        ...
        {
          if ( !(unsigned __int8)StorSubmitIoGatewayItem(*(PKSPIN_LOCK *)(v8 + 664)) )
            (*(void (__fastcall **)(_QWORD, __int64, _QWORD *))(v8 + 648))(*(_QWORD *)(v8 + 640), j - 120, v151);
        }
      }
    }
    else
