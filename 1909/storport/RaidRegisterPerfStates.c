/*
 * XREFs of RaidRegisterPerfStates @ 0x1C0040DC4
 * Callers:
 ...
 *     RaidGetStorPoFxPerfState @ 0x1C003B8A4 (RaidGetStorPoFxPerfState.c)
 *     RaidValidatePerfSets @ 0x1C00415E8 (RaidValidatePerfSets.c)
 */
