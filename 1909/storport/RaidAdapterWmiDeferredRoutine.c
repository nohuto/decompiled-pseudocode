/*
 * XREFs of RaidAdapterWmiDeferredRoutine @ 0x1C004A320
 * Callers:
 *     <none>
 * Callees:
 *     RaidFreeDeferredItem @ 0x1C0001C10 (RaidFreeDeferredItem.c)
...
PSLIST_ENTRY __fastcall RaidAdapterWmiDeferredRoutine(__int64 a1, __int64 a2)
{
  ...
  else
  {
    ...
    if ( !LogicalUnit || (*(_BYTE *)(LogicalUnit + 448) & 0x10) == 0 )
      return RaidFreeDeferredItem((union _SLIST_HEADER *)(v2 + 1472), a2);
