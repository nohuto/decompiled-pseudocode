/*
 * XREFs of StorpLogPhysicalTopologyInfo @ 0x1C001DF74
 * Callers:
...
char __fastcall StorpLogPhysicalTopologyInfo(__int64 a1, __int64 a2, unsigned int a3)
{
  ...
  *(_QWORD *)psz = 0LL;
  ...
  v11 = v9;
  if ( (unsigned int)dword_1C0062058 > 5 && TlgKeywordOn(v8, 0x400000000000uLL) )
  {
    v44 = a1 + 5128;
    ...
    *(&hProvider.LevelPlus1 + 1) = v6;
    ...
    v50 = v13;
    v52 = v13;
    TlgWrite(&hProvider, &unk_1C00582B8, v14, v15, 7u, (EVENT_DATA_DESCRIPTOR *)&hProvider.RegHandle);
    v11 = *(_DWORD *)(a2 + 8);
  }
  LOBYTE(v16) = v11;
