/*
 * XREFs of StorpTelemetryLogUnitPerfDataMeasures @ 0x1C000E130
 * Callers:
  ...
  if ( (unsigned int)dword_1C0062058 > 5 )
  {
    if ( TlgKeywordOn(a1, 0x400000000000uLL) )
    {
      ...
      *(_QWORD *)&hProvider.LevelPlus1 = *(_QWORD *)(a2 + 288) / 0x2710uLL;
      ...
      TlgCreateWsz(&v70, (LPCWSTR)&Context.EnableBitMask + 2);
      v72 = 8LL;
      v73 = &v17;
      v76 = 8 * v17;
      ...
      v75 = v6;
      v77 = 0;
      TlgWrite(&hProvider, &unk_1C0059AAE, v10, v11, 0x1Eu, (EVENT_DATA_DESCRIPTOR *)&hProvider.ProviderMetadataPtr);
    }
  }
}
