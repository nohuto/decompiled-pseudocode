/*
 * XREFs of StorpTelemetryLogUnitDeviceStatisticsCriticalData @ 0x1C004E3BC
 * Callers:
...
void __fastcall StorpTelemetryLogUnitDeviceStatisticsCriticalData(const struct _TlgProvider_t *a1)
{
  ...
  if ( (unsigned int)dword_1C0062058 > 5 && TlgKeywordOn(a1, 0x800000000000uLL) )
  {
    v4 = *(_QWORD *)(v1 + 24);
    v5 = *(_QWORD **)(v3 + 296);
    v51 = v4 + 5128;
    ...
    *(_QWORD *)&hProvider.LevelPlus1 = g_SystemUptime_s;
    ...
    v119[1] = 0;
    v121 = 1LL;
    TlgWrite(&hProvider, &unk_1C0059841, v32, 0LL, 0x26u, (EVENT_DATA_DESCRIPTOR *)&hProvider.EnableCallback);
  }
}
