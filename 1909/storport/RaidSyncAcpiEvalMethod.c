/*
 * XREFs of RaidSyncAcpiEvalMethod @ 0x1C001F4C4
 * Callers:
...
LABEL_9:
  ...
  if ( !v11 )
  {
    ...
    {
      WPP_SF_q(WPP_GLOBAL_Control->AttachedDevice, 12LL, &WPP_bda341a9323f32b668d48d296e0ff956_Traceguids, DeviceObject);
    }
    Status = -1073741670;
    goto LABEL_9;
  }
