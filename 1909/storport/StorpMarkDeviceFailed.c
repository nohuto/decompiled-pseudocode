/*
 * XREFs of StorpMarkDeviceFailed @ 0x1C003EE08
 * Callers:
...
void __fastcall StorpMarkDeviceFailed(__int64 a1, __int64 a2, int a3, const WCHAR *a4)
{
  ...
  if ( a2 )
  {
    ...
    if ( (((a3 & 1) != 0) & (unsigned __int8)~(*(_BYTE *)(Unit + 450) >> 5)) == 0 )
      goto LABEL_13;
    v14 = *(struct _DEVICE_OBJECT **)(Unit + 8);
    *(_BYTE *)(Unit + 450) |= 0x20u;
LABEL_12:
...
LABEL_21:
  if ( (unsigned int)dword_1C0062058 > 5 )
  {
    if ( TlgKeywordOn(v16, 0x400000000000uLL) )
    {
      ...
      TlgWrite(v22, &unk_1C0056D17, v23, v24, 0xEu, &pData);
    }
  }
}
