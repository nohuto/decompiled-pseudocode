/*
 * XREFs of StorpTelemetryLogUnitPerfDataCriticalData @ 0x1C004F1E8
 * Callers:
...
void __fastcall StorpTelemetryLogUnitPerfDataCriticalData(const struct _TlgProvider_t *a1, __int64 a2)
{
  ...
  unsigned __int64 *p_KeywordAny; // [rsp+B0h] [rbp-50h]
  ...
  if ( (unsigned int)dword_1C0062058 > 5 )
  {
    if ( TlgKeywordOn(a1, 0x800000000000uLL) )
    {
      ...
      *(_QWORD *)&hProvider.LevelPlus1 = *(_QWORD *)(a2 + 288) / 0x2710uLL;
      ...
      p_KeywordAny = &a1[35].KeywordAny;
      v30 = &v16;
      v32 = &v11;
      v34 = &v12;
      v36 = &v13;
      v15 = 3 * qword_1C0062480;
      v38 = &v17;
      v31 = 4LL;
      v33 = 1LL;
      v35 = 1LL;
      ...
      TlgCreateWsz(&v67, (LPCWSTR)&Context.EnableBitMask + 2);
      v69 = 8LL;
      v70 = &v15;
      v73 = 8 * v15;
      ...
      v72 = v8;
      v74 = 0;
      TlgWrite(&hProvider, &unk_1C005857B, v9, v10, 0x1Eu, (EVENT_DATA_DESCRIPTOR *)&hProvider.ProviderMetadataPtr);
    }
  }
}
