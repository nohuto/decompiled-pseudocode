/*
 * XREFs of StRtlIoStorInfoGetNvCachePriority @ 0x1C005344C
 * Callers:
 *     TranslateScsiRequestBlockToIoInfoSrbExData @ 0x1C0042C84 (TranslateScsiRequestBlockToIoInfoSrbExData.c)
