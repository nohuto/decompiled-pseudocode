/*
 * XREFs of McTemplateK0pquuqqd @ 0x1C0039840
 * Callers:
...
ULONG McTemplateK0pquuqqd(struct _MCGEN_TRACE_CONTEXT *a1, __int64 a2, const GUID *a3, ...)
{
  ...
  v17 = 4LL;
  v19 = 4LL;
  return McGenEventWrite(a1, &LunQueue, a3, 8u, &EventData);
}
