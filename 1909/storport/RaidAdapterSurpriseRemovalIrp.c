/*
 * XREFs of RaidAdapterSurpriseRemovalIrp @ 0x1C00745C8
 * Callers:
...
NTSTATUS __fastcall RaidAdapterSurpriseRemovalIrp(__int64 a1, IRP *a2)
{
  ...
  *(_DWORD *)(a1 + 88) = 5;
  ...
  if ( (unsigned int)dword_1C0062058 > 5 && TlgKeywordOn((TraceLoggingHProvider)a1, 0x400000000000uLL) )
  {
    v9 = *(_BYTE *)(a1 + 4356);
    ...
    *(unsigned int *)((char *)&hProvider.LevelPlus1 + 7) = v5;
    ...
    v36 = v12;
    v39 = v14;
    TlgWrite(&hProvider, &unk_1C0056BF8, v15, v16, 0xAu, (EVENT_DATA_DESCRIPTOR *)((char *)&hProvider.KeywordAll + 7));
  }
