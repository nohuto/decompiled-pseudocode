 ...
 *     RaidUnitPowerCycleCheck @ 0x1C0041290 (RaidUnitPowerCycleCheck.c)
...
void __fastcall RaidUnitAdaptiveIdleTimeout(__int64 a1)
{
  ...
  if ( (unsigned __int8)RaidUnitCheckAndAcquirePoFx(a1) )
  {
    if ( (*(_DWORD *)(*(_QWORD *)(a1 + 1744) + 32LL) & 0x80u) != 0 )
    {
      ...
      {
        ++*(_QWORD *)(v3 + 48);
        v9 = MEMORY[0xFFFFF78000000014] - *(_QWORD *)(a1 + 2968);
        if ( v9 > 0 )
        {
          v10 = v9 / 10000;
          v11 = v9 / 10000 / v5;
          ...
          if ( v11 <= *(unsigned int *)(a1 + 2960) )
          {
            ++*(_QWORD *)(*(_QWORD *)(a1 + 1744) + 40LL);
            v13 = *(_QWORD *)(a1 + 1744);
            v14 = 10000 * (v10 - v5 * (*(unsigned int *)(a1 + 2960) + 1LL));
            if ( !*(_QWORD *)(v13 + 112) )
            {
