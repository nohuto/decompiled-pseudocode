/*
 * XREFs of TranslateResultToScsiRequestBlock @ 0x1C0042AB4
 * Callers:
...
LABEL_19:
  ...
  if ( (Microsoft_Windows_StorPortEnableBits & 0x40) != 0 )
    McTemplateK0zx(v14.QuadPart, v13.QuadPart, v15.QuadPart, (char *)L"Translate STORAGE_REQUEST_BLOCK result", v2);
  return v6;
}
