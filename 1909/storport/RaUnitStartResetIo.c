/*
 * XREFs of RaUnitStartResetIo @ 0x1C0046E0C
 * Callers:
...
LABEL_42:
  ...
  if ( v9 >= 0 )
  {
    ...
    if ( (_DWORD)FullCreateOptions != 16 )
    {
      ...
      _InterlockedAdd((volatile signed __int32 *)(v3 + 1292), 1u);
      if ( v18 >= 0x12 )
      {
        if ( v18 <= 0x13 )
        {
    ...
    if ( v15 == 16 && (unsigned int)dword_1C0062058 > 5 )
    {
      v21 = v31;
      if ( TlgKeywordOn((TraceLoggingHProvider)FullCreateOptions, 0x400000000000uLL) )
      {
        ...
        v46 = (int)v20;
        v49 = (int)v20;
        TlgWrite(v19, &unk_1C0057023, v11, v20, 8u, &v32);
      }
    }
    else
    {
  ...
  if ( v9 < 0 )
  {
    if ( v6 )
    {
      ...
      _InterlockedDecrement((volatile signed __int32 *)(v3 + 1292));
      if ( v25 >= 0x12 )
      {
        if ( v25 <= 0x13 )
        {
