/*
 * XREFs of StorEtwMiniportEvent @ 0x1C001EBF0
 * Callers:
 ...
 *     StorEtwMiniportGetKeyword @ 0x1C004C5BC (StorEtwMiniportGetKeyword.c)
 */
...
LABEL_95:
  ...
  if ( a9 && StorEtwLoggingEnabled && (byte_1C0062743 & 0x10) != 0 )
  {
    v15 = a10;
    if ( a10 > 2 )
    {
  ...
  if ( !StorEtwLoggingEnabled )
    return 0;
  if ( (byte_1C0062743 & 0x10) == 0 )
  {
LABEL_8:
    if ( !StorEtwLoggingEnabled || (byte_1C0062743 & 0x10) == 0 )
      return 0;
    v15 = a10;
    if ( a10 > 2 )
    {
