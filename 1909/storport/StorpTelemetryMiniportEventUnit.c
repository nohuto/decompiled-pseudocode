/*
 * XREFs of StorpTelemetryMiniportEventUnit @ 0x1C0020080
 * Callers:
  ...
  if ( (unsigned int)dword_1C0062058 > 5 )
  {
    ...
    if ( (_BYTE)v2 )
    {
      ...
      *(_QWORD *)&hProvider.LevelPlus1 = *((_QWORD *)v5 + 47);
      ...
      LOBYTE(v2) = TlgWrite(&hProvider, &unk_1C00588AF, v28, v29, 0x24u, (EVENT_DATA_DESCRIPTOR *)&hProvider.RegHandle);
    }
  }
  return v2;
}
