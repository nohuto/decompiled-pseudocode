/*
 * XREFs of RaidCreateAdapter @ 0x1C001A91C
 * Callers:
 ...
 *     StorCreateDictionary @ 0x1C001AB9C (StorCreateDictionary.c)
 *     memset @ 0x1C0024DC0 (memset.c)
 *     RaCreateBus @ 0x1C006B7F8 (RaCreateBus.c)
 *     RaidCreateResourceList @ 0x1C006B81C (RaidCreateResourceList.c)
