/*
 * XREFs of StorpTelemetryMarkUnitUnresponsive @ 0x1C004FE78
 * Callers:
...
void __fastcall StorpTelemetryMarkUnitUnresponsive(__int64 a1)
{
  ...
  if ( (*(_BYTE *)(a1 + 450) & 2) == 0 && (unsigned int)dword_1C0062058 > 5 )
  {
    if ( TlgKeywordOn((TraceLoggingHProvider)a1, 0x400000000000uLL) )
    {
      ...
      v35 = 4LL;
      v37 = 4LL;
      TlgWrite(v5, &unk_1C0059EDD, v2, (LPCGUID)v3, 0xDu, &pData);
    }
  }
}
