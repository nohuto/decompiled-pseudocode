/*
 * XREFs of McTemplateK0qpd @ 0x1C003FF48
 * Callers:
...
ULONG __fastcall McTemplateK0qpd(struct _MCGEN_TRACE_CONTEXT *a1, __int64 a2, const GUID *a3, int a4, char a5, char a6)
{
  ...
  v10 = &a5;
  v12 = &a6;
  return McGenEventWrite(a1, &EventAdapterPowerRequestComplete, a3, 4u, &EventData);
}
