/*
 * XREFs of RaUnitTelemetryIdIoctl @ 0x1C0020700
 * Callers:
...
LABEL_13:
  ...
  *(_OWORD *)&MasterIrp->AssociatedIrp.MasterIrp = *(_OWORD *)(*(_QWORD *)(a1 + 24) + 5128LL);
  ...
  if ( (unsigned int)dword_1C0062058 > 5 && TlgKeywordOn(Length, 0x400000000000uLL) )
  {
    ...
    v27 = 1LL;
    v29 = 1LL;
    TlgWrite(v10, &unk_1C0057089, v7, (LPCGUID)v8, 8u, &pData);
  }
  v11 = 0;
  return RaidCompleteRequestEx(a2, 0, v11);
}
