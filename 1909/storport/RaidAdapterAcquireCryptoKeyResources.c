/*
 * XREFs of RaidAdapterAcquireCryptoKeyResources @ 0x1C00341E8
 * Callers:
 *     RaUnitStartIo @ 0x1C00035A0 (RaUnitStartIo.c)
 * Callees:
 *     RaidAllocatePool @ 0x1C0006850 (RaidAllocatePool.c)
 *     RaidAdapterGetCryptoKeyIndex @ 0x1C0034E78 (RaidAdapterGetCryptoKeyIndex.c)
 */
...
__int64 __fastcall RaidAdapterAcquireCryptoKeyResources(__int64 a1, struct _SLIST_ENTRY *a2)
{
  ...
  *((_QWORD *)&Next->Next + 1) = 0LL;
  ...
  {
    ExAcquireSpinLockSharedAtDpcLevel((PEX_SPIN_LOCK)(a1 + 5656));
    CryptoKeyIndex = RaidAdapterGetCryptoKeyIndex(a1, &v6[1].Next + 1, 0LL);
    if ( CryptoKeyIndex != *(_DWORD *)(a1 + 5640) )
    {
      v25 = *(_QWORD *)(a1 + 5648) + ((unsigned __int64)CryptoKeyIndex << 6);
      v26 = *v29;
      v27 = *(_DWORD *)v25;
      ...
      *((_DWORD *)&a2[49].Next->Next + 2) = v27;
      ...
      ExReleaseSpinLockSharedFromDpcLevel((PEX_SPIN_LOCK)(a1 + 5656));
    ...
    if ( v11 != v12 )
    {
      ...
      *((_DWORD *)&a2[49].Next->Next + 2) = v23;
      ...
      if ( !v24 )
      {
        ...
        ExReleaseSpinLockExclusiveFromDpcLevel((PEX_SPIN_LOCK)(a1 + 5656));
        return AdapterCryptoEngineExtension;
      }
      _InterlockedAdd((volatile signed __int32 *)(v21 + v20 + 40), 1u);
    ...
    for ( i = 0; i < v12; ++i )
    {
      if ( !*(_DWORD *)(((unsigned __int64)i << 6) + *(_QWORD *)(a1 + 5648) + 44) )
        break;
    }
    if ( i == v12 )
    {
LABEL_16:
      ...
      *(_BYTE *)(a1 + 5644) = 1;
      if ( v12 )
      {
        do
        {
          if ( !*(_DWORD *)(((unsigned __int64)i << 6) + *(_QWORD *)(a1 + 5648) + 40) )
            break;
          ++i;
        }
        while ( i < *(_DWORD *)(a1 + 5640) );
      }
    }
    if ( i == *(_DWORD *)(a1 + 5640) )
    {
    ...
    if ( WorkItem && Pool )
    {
      v17 = *(_QWORD *)(a1 + 5648) + ((unsigned __int64)i << 6);
