/*
 * XREFs of McTemplateK0quuujppxii @ 0x1C0033970
 * Callers:
...
ULONG __fastcall McTemplateK0quuujppxii(
        ...
        char a13)
{
  ...
  v32 = 8LL;
  v34 = 8LL;
  return McGenEventWrite(a1, &EventSMROutOfOrderWrite, 0LL, 0xBu, &EventData);
}
