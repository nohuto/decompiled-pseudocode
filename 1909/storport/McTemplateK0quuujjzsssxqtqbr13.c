/*
 * XREFs of McTemplateK0quuujjzsssxqtqbr13 @ 0x1C00015D4
 * Callers:
...
ULONG __fastcall McTemplateK0quuujjzsssxqtqbr13(
        __int64 a1,
        __int64 a2,
        __int64 a3,
        int a4,
        ...
        __int64 a18)
{
  ...
  struct _MCGEN_TRACE_CONTEXT *v55; // [rsp+E0h] [rbp-20h]
  ...
  if ( a11 )
  {
    ...
    do
      ++v23;
    while ( *((_BYTE *)&a11->RegistrationHandle + v23) );
    v24 = v23 + 1;
  }
  else
  {
  ...
  if ( a12 )
  {
    ...
    do
      ++v26;
    while ( *((_BYTE *)&a12->RegistrationHandle + v26) );
    v27 = v26 + 1;
  }
  else
  {
  ...
  if ( a13 )
  {
    do
      ++v19;
    while ( *((_BYTE *)&a13->RegistrationHandle + v19) );
    v29 = v19 + 1;
  }
  else
  {
  ...
  v60 = &a15;
  if ( !a13 )
    v28 = (struct _MCGEN_TRACE_CONTEXT *)&Context;
  v55 = v28;
  v62 = &a16;
  v61 = 4LL;
  v64 = &v31;
  ...
  v65 = 4LL;
  v67 = 512LL;
  return McGenEventWrite(v28, &EventUnitSmartAttributes, 0LL, 0x10u, &EventData);
}
