/*
 * XREFs of StorPortUnitPowerNotRequiredStep2 @ 0x1C00421F8
 * Callers:
 *     StorPortUnitPowerNotRequiredStep1 @ 0x1C0042110 (StorPortUnitPowerNotRequiredStep1.c)
 *     StorPortUnitPowerNotRequiredStep2Passive @ 0x1C0042480 (StorPortUnitPowerNotRequiredStep2Passive.c)
 * Callees:
...
void __fastcall StorPortUnitPowerNotRequiredStep2(char *Context)
{
  ...
  {
    KeCancelTimer((PKTIMER)(Context + 952));
    v4 = 0;
    v5 = *((_QWORD *)Context + 3);
    v6 = Context[449] | 0x20;
    Context[449] = v6;
