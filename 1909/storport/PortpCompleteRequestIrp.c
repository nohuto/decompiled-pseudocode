/*
 * XREFs of PortpCompleteRequestIrp @ 0x1C0052D28
 * Callers:
 *     PortpAsyncCompletion @ 0x1C0052C00 (PortpAsyncCompletion.c)
 *     PortpCancelRoutine @ 0x1C0052C90 (PortpCancelRoutine.c)
 * Callees:
