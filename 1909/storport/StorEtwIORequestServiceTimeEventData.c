/*
 * XREFs of StorEtwIORequestServiceTimeEventData @ 0x1C004B924
 * Callers:
...
int __fastcall StorEtwIORequestServiceTimeEventData(__int64 a1, char a2, unsigned __int64 a3)
{
  ...
  struct _MCGEN_TRACE_CONTEXT *QuadPart; // rcx
  __int64 v12; // rdx
  ...
  QuadPart = (struct _MCGEN_TRACE_CONTEXT *)v35.QuadPart;
  if ( !a2 )
  {
...
LABEL_42:
    LOBYTE(v28) = v5;
    LODWORD(v14) = McTemplateK0xpuupuuuuuqxx(
                     QuadPart,
                     v26,
                     (const GUID *)(a1 + 728),
                     a3,
