/*
 * XREFs of McTemplateK0pddp @ 0x1C00332C4
 * Callers:
...
ULONG McTemplateK0pddp(struct _MCGEN_TRACE_CONTEXT *a1, __int64 a2, const GUID *a3, ...)
{
  ...
  va_copy(v11, va3);
  v12 = 8LL;
  return McGenEventWrite(a1, &EventPnpRequest, a3, 5u, &EventData);
}
