/*
 * XREFs of RaUnitScsiFreeDumpPointersIoctl @ 0x1C001105C
 * Callers:
...
__int64 __fastcall RaUnitScsiFreeDumpPointersIoctl(__int64 a1, IRP *a2, __int64 a3, __int64 a4)
{
  ...
  if ( *(_BYTE *)(a1 + 1733) == 1 && v4 )
  {
    ...
    *(_QWORD *)(v10 + 656) = RaidXrbSignalCompletion;
    ...
    {
      WPP_SF_qq(WPP_GLOBAL_Control->AttachedDevice, 35LL, &WPP_bda341a9323f32b668d48d296e0ff956_Traceguids, v10, Srb);
    }
    if ( *(_BYTE *)(v4 + 4450) )
