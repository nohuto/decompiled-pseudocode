/*
 * XREFs of RaUnitStorageFreeDumpInfo @ 0x1C004712C
 * Callers:
 ...
 *     StorPortReleaseAdditionalCrashDumpArea @ 0x1C0011440 (StorPortReleaseAdditionalCrashDumpArea.c)
 ...
 *     RaidUnitFreeDumpInfo @ 0x1C0048880 (RaidUnitFreeDumpInfo.c)
...
LABEL_24:
    ...
    *(_QWORD *)(v11 + 8) = v12;
    ...
    if ( (int)RaidAcquireAdapterRemoveLock(v14) >= 0 )
    {
      ...
      StorPortReleaseAdditionalCrashDumpArea(v14 + 696, v13 + 64);
      if ( *(_WORD *)(v14 + 5090) )
      {
      ...
      ExReleaseRundownProtectionCacheAware(*(PEX_RUNDOWN_REF_CACHE_AWARE *)(v14 + 256));
    }
