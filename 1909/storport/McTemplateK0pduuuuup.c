/*
 * XREFs of McTemplateK0pduuuuup @ 0x1C003335C
 * Callers:
...
ULONG McTemplateK0pduuuuup(struct _MCGEN_TRACE_CONTEXT *a1, __int64 a2, const GUID *a3, ...)
{
  ...
  v18 = 1LL;
  v20 = 8LL;
  return McGenEventWrite(a1, &EventIORequestComplete, a3, 9u, &EventData);
}
