/*
 * XREFs of ?OnHandSpatialObjectAdded@SpatialInteractionHandObjectDevice@SpatialInteractions@Internal@Windows@@AEAAJAEBU_GUID@@@Z @ 0x1800F53D0
 * Callers:
        ...
        const struct _GUID *a2)
{
  ...
  struct Windows::Internal::Holographic::ISpatialObjectDevice *Ptr; // [rsp+30h] [rbp-78h] BYREF
  std::_Ref_count_base **v17; // [rsp+38h] [rbp-70h] BYREF
  _OWORD *v18[4]; // [rsp+40h] [rbp-68h] BYREF
  std::_Ref_count_base *v19[2]; // [rsp+60h] [rbp-48h] BYREF
  std::_Ref_count_base *v20[2]; // [rsp+70h] [rbp-38h] BYREF
  std::_Ref_count_base **v21; // [rsp+80h] [rbp-28h] BYREF
  wil::details::in1diag3 *retaddr; // [rsp+A8h] [rbp+0h]
  __int64 v23; // [rsp+B0h] [rbp+8h] BYREF
  struct Windows::Internal::Holographic::ISpatialObject *v24; // [rsp+C0h] [rbp+18h] BYREF
  struct Windows::Internal::Holographic::ISpatialObject *v25; // [rsp+C8h] [rbp+20h] BYREF
