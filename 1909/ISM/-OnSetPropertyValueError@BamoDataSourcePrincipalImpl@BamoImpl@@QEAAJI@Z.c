/*
 * XREFs of ?OnSetPropertyValueError@BamoDataSourcePrincipalImpl@BamoImpl@@QEAAJI@Z @ 0x1800D0494
 * Callers:
 *     ?Thunk_OnSetPropertyValueError_5@?$IDataSourcePrincipal_Receive@VBamoDataSourcePrincipalImpl@BamoImpl@@@@SAJPEAXPEAPEAX@Z @ 0x1800D1C20 (-Thunk_OnSetPropertyValueError_5@-$IDataSourcePrincipal_Receive@VBamoDataSourcePrincipalImpl@Bam.c)
 * Callees:
