/*
 * XREFs of ?SetButtonRoutingPolicy@BamoPenEventsDispatcherProxyImpl@BamoImpl@@QEAAJW4RoutingPolicy@Input@Devices@Internal@Windows@@@Z @ 0x18002E7FC
 * Callers:
...
LABEL_3:
  ...
  v1 = Microsoft::BamoImpl::BamoProxyImpl::PrepareForRemoteCall(a1, &v8, &v6, &v7);
  if ( v1 < 0 )
  {
    v2 = 11852LL;
    goto LABEL_3;
  ...
  v4[0] = v6;
  v4[1] = v7;
  return CoreUICallSend(v8, v4, 2LL, 42LL);
}
