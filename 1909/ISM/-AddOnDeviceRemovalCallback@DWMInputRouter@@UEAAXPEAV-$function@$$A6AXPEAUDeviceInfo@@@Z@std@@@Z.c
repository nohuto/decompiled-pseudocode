/*
 * XREFs of ?AddOnDeviceRemovalCallback@DWMInputRouter@@UEAAXPEAV?$function@$$A6AXPEAUDeviceInfo@@@Z@std@@@Z @ 0x1800C2C10
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall DWMInputRouter::AddOnDeviceRemovalCallback(__int64 a1, __int64 a2)
{
  __int64 v2; // rcx
  __int64 result; // rax
  _BYTE *v4; // rdx
