/*
 * XREFs of ?_FailFast_Unexpected@in1diag3@details@wil@@YAXPEAXIPEBD@Z @ 0x18004F3F4
 * Callers:
 ...
 *     ?s_OnKernelInputEventStatic@?$KernelInputConnection@U_MIT_INPUT_FOCUS_MESSAGE@@@@CAJPEAX0H@Z @ 0x1800085B0 (-s_OnKernelInputEventStatic@-$KernelInputConnection@U_MIT_INPUT_FOCUS_MESSAGE@@@@CAJPEAX0H@Z.c)
 *     ?GetActivationListenerInputObject@BamoInputSiteElementProxy@@UEAAPEAVBamoActivationListenerInputObjectProxy@@XZ @ 0x180009590 (-GetActivationListenerInputObject@BamoInputSiteElementProxy@@UEAAPEAVBamoActivationListenerInput.c)
 *     ?GetUIAHitTestInputObject@BamoInputSiteElementProxy@@UEAAPEAVBamoUIAHitTestInputObjectProxy@@XZ @ 0x1800095E0 (-GetUIAHitTestInputObject@BamoInputSiteElementProxy@@UEAAPEAVBamoUIAHitTestInputObjectProxy@@XZ.c)
 *     ?GetContainerInfoInputObject@BamoInputSiteElementProxy@@UEAAPEAVBamoContainerInfoInputObjectProxy@@XZ @ 0x180009630 (-GetContainerInfoInputObject@BamoInputSiteElementProxy@@UEAAPEAVBamoContainerInfoInputObjectProx.c)
 *     ?GetMPCInputObject@BamoInputSiteElementProxy@@UEAAPEAVBamoMPCInputObjectProxy@@XZ @ 0x180009680 (-GetMPCInputObject@BamoInputSiteElementProxy@@UEAAPEAVBamoMPCInputObjectProxy@@XZ.c)
 *     ?GetDropTargetClient@BamoInputSiteElementProxy@@UEAAPEAVBamoDropTargetClientProxy@@XZ @ 0x1800096D0 (-GetDropTargetClient@BamoInputSiteElementProxy@@UEAAPEAVBamoDropTargetClientProxy@@XZ.c)
 *     ?GetDragAreaClient@BamoInputSiteElementProxy@@UEAAPEAVBamoDragAreaClientProxy@@XZ @ 0x180009720 (-GetDragAreaClient@BamoInputSiteElementProxy@@UEAAPEAVBamoDragAreaClientProxy@@XZ.c)
 *     ?GetDragSourceClient@BamoInputSiteElementProxy@@UEAAPEAVBamoDragSourceClientProxy@@XZ @ 0x180009770 (-GetDragSourceClient@BamoInputSiteElementProxy@@UEAAPEAVBamoDragSourceClientProxy@@XZ.c)
 *     ?GetDragManagerClient@BamoInputSiteElementProxy@@UEAAPEAVBamoDragManagerClientProxy@@XZ @ 0x1800097C0 (-GetDragManagerClient@BamoInputSiteElementProxy@@UEAAPEAVBamoDragManagerClientProxy@@XZ.c)
 *     ?GetActuationClient@BamoInputSiteElementProxy@@UEAAPEAVBamoActuationClientProxy@@XZ @ 0x180009810 (-GetActuationClient@BamoInputSiteElementProxy@@UEAAPEAVBamoActuationClientProxy@@XZ.c)
 *     ?GetActivationConfigurationInputObject@BamoInputSiteElementProxy@@UEAAPEAVBamoActivationConfigurationInputObjectProxy@@XZ @ 0x180009860 (-GetActivationConfigurationInputObject@BamoInputSiteElementProxy@@UEAAPEAVBamoActivationConfigur.c)
 *     ?GetAttachableInputObjectSample@BamoInputSiteElementProxy@@UEAAPEAVBamoAttachableInputObjectSampleProxy@@XZ @ 0x1800098B0 (-GetAttachableInputObjectSample@BamoInputSiteElementProxy@@UEAAPEAVBamoAttachableInputObjectSamp.c)
 ...
 *     ?s_OnKernelInputEventStatic@?$KernelInputConnection@U_MIT_DEVICE_IDENTIFICATION_MESSAGE@@@@CAJPEAX0H@Z @ 0x180029210 (-s_OnKernelInputEventStatic@-$KernelInputConnection@U_MIT_DEVICE_IDENTIFICATION_MESSAGE@@@@CAJPE.c)
 *     ?s_OnKernelInputEventStatic@?$KernelInputConnection@U_MIT_INPUT_CONFIG_MESSAGE@@@@CAJPEAX0H@Z @ 0x180029AE0 (-s_OnKernelInputEventStatic@-$KernelInputConnection@U_MIT_INPUT_CONFIG_MESSAGE@@@@CAJPEAX0H@Z.c)
 *     ?s_OnKernelInputEventStatic@?$KernelInputConnection@U_MIT_PNP_DEVICE_NOTIFICATION_MESSAGE@@@@CAJPEAX0H@Z @ 0x180029B30 (-s_OnKernelInputEventStatic@-$KernelInputConnection@U_MIT_PNP_DEVICE_NOTIFICATION_MESSAGE@@@@CAJ.c)
 ...
 *     ?GetSupportedInputTypes@DWMInputTarget@@UEAAJPEAK@Z @ 0x18002A420 (-GetSupportedInputTypes@DWMInputTarget@@UEAAJPEAK@Z.c)
 ...
 *     ?s_OnKernelInputEventStatic@?$KernelInputConnection@U_MIT_PEN_EVENT_MESSAGE@@@@CAJPEAX0H@Z @ 0x180034800 (-s_OnKernelInputEventStatic@-$KernelInputConnection@U_MIT_PEN_EVENT_MESSAGE@@@@CAJPEAX0H@Z.c)
 ...
 *     ?WaitOnConnection@ViewHierarchy@@UEAAXXZ @ 0x180059AA0 (-WaitOnConnection@ViewHierarchy@@UEAAXXZ.c)
 ...
 *     ?s_OnKernelInputEventStatic@?$KernelInputConnection@U_MIT_BASE_INPUT_OBSERVER_PACKET@@@@CAJPEAX0H@Z @ 0x180068B40 (-s_OnKernelInputEventStatic@-$KernelInputConnection@U_MIT_BASE_INPUT_OBSERVER_PACKET@@@@CAJPEAX0.c)
 ...
 *     ?s_OnKernelInputEventStatic@?$KernelInputConnection@U_MIT_KEYBOARD_INPUT_ATTEMPTED_MESSAGE@@@@CAJPEAX0H@Z @ 0x180070910 (-s_OnKernelInputEventStatic@-$KernelInputConnection@U_MIT_KEYBOARD_INPUT_ATTEMPTED_MESSAGE@@@@CA.c)
 ...
 *     ?s_OnKernelInputEventStatic@?$KernelInputConnection@U_MIT_INVALIDATE_INPUT_MESSAGE@@@@CAJPEAX0H@Z @ 0x180098DF0 (-s_OnKernelInputEventStatic@-$KernelInputConnection@U_MIT_INVALIDATE_INPUT_MESSAGE@@@@CAJPEAX0H@.c)
 ...
 *     std::_Func_impl_no_alloc__lambda_babb9bad59cf0c747d6b9e9cc33ad5e6__void_InputInfo___::_Do_call @ 0x1800BF200 (std--_Func_impl_no_alloc__lambda_babb9bad59cf0c747d6b9e9cc33ad5e6__void_InputInfo___--_Do_call.c)
 *     ?s_OnKernelInputEventStatic@?$KernelInputConnection@U_MIT_INPUT_INTEROP_MESSAGE@@@@CAJPEAX0H@Z @ 0x1800BFBD0 (-s_OnKernelInputEventStatic@-$KernelInputConnection@U_MIT_INPUT_INTEROP_MESSAGE@@@@CAJPEAX0H@Z.c)
 *     ?s_OnKernelInputEventStatic@?$KernelInputConnection@U_MIT_KEYBOARD_INPUT_MESSAGE@@@@CAJPEAX0H@Z @ 0x1800BFC30 (-s_OnKernelInputEventStatic@-$KernelInputConnection@U_MIT_KEYBOARD_INPUT_MESSAGE@@@@CAJPEAX0H@Z.c)
 *     ?s_OnKernelInputEventStatic@?$KernelInputConnection@U_MIT_KEYBOARD_OVERRIDER_INPUT_MESSAGE@@@@CAJPEAX0H@Z @ 0x1800BFC90 (-s_OnKernelInputEventStatic@-$KernelInputConnection@U_MIT_KEYBOARD_OVERRIDER_INPUT_MESSAGE@@@@CA.c)
 *     ?s_OnKernelInputEventStatic@?$KernelInputConnection@U_MIT_MOUSE_INPUT_MESSAGE@@@@CAJPEAX0H@Z @ 0x1800BFCF0 (-s_OnKernelInputEventStatic@-$KernelInputConnection@U_MIT_MOUSE_INPUT_MESSAGE@@@@CAJPEAX0H@Z.c)
 ...
 *     ?s_OnKernelInputEventStatic@?$KernelInputConnection@U_MIT_POINTER_INPUT_DOWN_MESSAGE@@@@CAJPEAX0H@Z @ 0x1800C5B20 (-s_OnKernelInputEventStatic@-$KernelInputConnection@U_MIT_POINTER_INPUT_DOWN_MESSAGE@@@@CAJPEAX0.c)
 ...
 *     ?GetSupportedInputDevices@DWMInputTarget@@UEAAJPEAK@Z @ 0x1800C7330 (-GetSupportedInputDevices@DWMInputTarget@@UEAAJPEAK@Z.c)
 ...
 *     ?SetInteractionObject@EdgyInputTarget@@UEAAJI@Z @ 0x180104870 (-SetInteractionObject@EdgyInputTarget@@UEAAJI@Z.c)
 *     ?OnInterestedPropertyChanged@HotkeyContextualProcessor@@UEAAJGPEBXI@Z @ 0x180108490 (-OnInterestedPropertyChanged@HotkeyContextualProcessor@@UEAAJGPEBXI@Z.c)
 ...
 *     ?s_OnKernelInputEventStatic@?$KernelInputConnection@UtagQMSGINPUTREPORT@@@@CAJPEAX0H@Z @ 0x180109E60 (-s_OnKernelInputEventStatic@-$KernelInputConnection@UtagQMSGINPUTREPORT@@@@CAJPEAX0H@Z.c)
 ...
 *     ?PopulateTargetingData@MPCInputProviderBase@@UEAAXPEAUMPCHolographicInputContext@@PEAUInputInfo@@@Z @ 0x18013E4F0 (-PopulateTargetingData@MPCInputProviderBase@@UEAAXPEAUMPCHolographicInputContext@@PEAUInputInfo@.c)
 ...
 *     ??$_Callback_once@V?$tuple@$$QEAV_lambda_0768ca99b5f0498451ffc3dbd3bcf85b_@@AEAVexception_ptr@std@@@std@@U?$integer_sequence@_K$0A@@2@$00@std@@YAHPEAX0PEAPEAX@Z @ 0x18013EA90 (--$_Callback_once@V-$tuple@$$QEAV_lambda_0768ca99b5f0498451ffc3dbd3bcf85b_@@AEAVexception_ptr@st.c)
 ...
 *     ?ShouldAttachDevice@MPCHeadProcessor@@UEAA_NPEAUDeviceInfo@@@Z @ 0x18013F470 (-ShouldAttachDevice@MPCHeadProcessor@@UEAA_NPEAUDeviceInfo@@@Z.c)
