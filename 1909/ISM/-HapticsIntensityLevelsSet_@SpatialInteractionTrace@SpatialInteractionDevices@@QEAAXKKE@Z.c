/*
 * XREFs of ?HapticsIntensityLevelsSet_@SpatialInteractionTrace@SpatialInteractionDevices@@QEAAXKKE@Z @ 0x180165FF4
 * Callers:
        ...
        char a4)
{
  ...
  if ( *(_DWORD *)v4 > 4u )
  {
    if ( TlgKeywordOn(v4, 2uLL) )
    {
      ...
      v11 = v6;
      v13 = 1LL;
      TlgWrite(v5, &unk_1801A4A13, 0LL, 0LL, 5u, &pData);
    }
  }
}
