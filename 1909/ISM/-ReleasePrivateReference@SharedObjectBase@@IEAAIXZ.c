/*
 * XREFs of ?ReleasePrivateReference@SharedObjectBase@@IEAAIXZ @ 0x1800D67D0
 * Callers:
 ...
 *     ?ReleasePrivateReference@SipcServer@@UEAAXXZ @ 0x1800D6850 (-ReleasePrivateReference@SipcServer@@UEAAXXZ.c)
 * Callees:
