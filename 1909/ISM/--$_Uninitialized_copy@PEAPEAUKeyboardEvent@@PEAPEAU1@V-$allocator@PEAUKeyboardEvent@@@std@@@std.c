/*
 * XREFs of ??$_Uninitialized_copy@PEAPEAUKeyboardEvent@@PEAPEAU1@V?$allocator@PEAUKeyboardEvent@@@std@@@std@@YAPEAPEAUKeyboardEvent@@QEAPEAU1@0PEAPEAU1@AEAV?$allocator@PEAUKeyboardEvent@@@0@@Z @ 0x1800BFF94
 * Callers:
 *     ?_Growmap@?$deque@UKeyboardEvent@@V?$allocator@UKeyboardEvent@@@std@@@std@@IEAAX_K@Z @ 0x1800C124C (-_Growmap@-$deque@UKeyboardEvent@@V-$allocator@UKeyboardEvent@@@std@@@std@@IEAAX_K@Z.c)
 *     ?_Growmap@?$deque@U_MIT_KEYBOARD_OVERRIDER_INPUT_MESSAGE@@V?$allocator@U_MIT_KEYBOARD_OVERRIDER_INPUT_MESSAGE@@@std@@@std@@IEAAX_K@Z @ 0x1800C139C (-_Growmap@-$deque@U_MIT_KEYBOARD_OVERRIDER_INPUT_MESSAGE@@V-$allocator@U_MIT_KEYBOARD_OVERRIDER_.c)
