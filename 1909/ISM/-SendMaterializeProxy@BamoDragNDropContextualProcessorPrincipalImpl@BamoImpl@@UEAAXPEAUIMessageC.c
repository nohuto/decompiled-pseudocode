/*
 * XREFs of ?SendMaterializeProxy@BamoDragNDropContextualProcessorPrincipalImpl@BamoImpl@@UEAAXPEAUIMessageCallSendHost@@PEAVBamoStubImpl@2Microsoft@@@Z @ 0x1800049F0
 * Callers:
 *     <none>
 * Callees:
