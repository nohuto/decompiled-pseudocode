/*
 * XREFs of ?StartActivity@CreateSpatialGraphNodeReference@HolographicDriverClientContinuousTrace@@QEAAXAEBU_GUID@@AEBUSPATIAL_NODE_ID@@W4SPATIAL_TRACKING_STATE@@@Z @ 0x18015DB54
 * Callers:
        ...
        int a4)
{
  ...
  if ( *(_DWORD *)v9 > 5u )
  {
    ...
    TlgWrite(v9, &unk_1801A3814, (LPCGUID)(*(_QWORD *)(a1 + 48) + 8LL), v11, 7u, &pData);
  }
  if ( !*(_DWORD *)(a1 + 32) )
