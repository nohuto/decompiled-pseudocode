/*
 * XREFs of ?CompositorRunningStateChanged@SpatialInteractionSourceDeviceCollection@SpatialInteractions@Internal@Windows@@UEAAJ_NPEAUISpatialInteractionSourceCollectionCallbacks@234@@Z @ 0x1800EBAE0
 * Callers:
 *     <none>
 * Callees:
 ...
 *     ?CreateDevice@SpatialInteractionHeadObjectDevice@SpatialInteractions@Internal@Windows@@QEAAJPEAUISpatialInteractionSourceCollectionCallbacks@234@@Z @ 0x1800F079C (-CreateDevice@SpatialInteractionHeadObjectDevice@SpatialInteractions@Internal@Windows@@QEAAJPEAU.c)
 */
