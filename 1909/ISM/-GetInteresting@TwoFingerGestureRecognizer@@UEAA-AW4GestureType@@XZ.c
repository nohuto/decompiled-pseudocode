/*
 * XREFs of ?GetInteresting@TwoFingerGestureRecognizer@@UEAA?AW4GestureType@@XZ @ 0x18010CBC0
 * Callers:
 *     <none>
 * Callees:
 ...
 *     ?GetDragInfo@TwoFingerDragRecognizer@@QEAA_NPEAUGestureData@@@Z @ 0x18010D430 (-GetDragInfo@TwoFingerDragRecognizer@@QEAA_NPEAUGestureData@@@Z.c)
 *     ?GetTapInfo@TwoFingerClickRecognizer@@QEAA_NPEAUGestureData@@@Z @ 0x18010D920 (-GetTapInfo@TwoFingerClickRecognizer@@QEAA_NPEAUGestureData@@@Z.c)
 */
