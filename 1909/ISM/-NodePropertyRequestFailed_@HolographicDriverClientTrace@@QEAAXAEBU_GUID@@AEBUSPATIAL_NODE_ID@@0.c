/*
 * XREFs of ?NodePropertyRequestFailed_@HolographicDriverClientTrace@@QEAAXAEBU_GUID@@AEBUSPATIAL_NODE_ID@@0J@Z @ 0x18015A25C
 * Callers:
        ...
        char a5)
{
  ...
  if ( *(_DWORD *)v8 > 4u )
  {
    if ( TlgKeywordOn(v8, 2uLL) )
    {
      ...
      v16 = 16LL;
      v18 = 4LL;
      TlgWrite(v9, &unk_1801A3C02, 0LL, 0LL, 6u, &pData);
    }
  }
}
