/*
 * XREFs of ?HapticsOutputReportPeriodMicrosecondsSet_@SpatialInteractionTrace@SpatialInteractionDevices@@QEAAXKKI@Z @ 0x1801660AC
 * Callers:
        ...
        int a4)
{
  ...
  if ( *(_DWORD *)v4 > 4u )
  {
    if ( TlgKeywordOn(v4, 2uLL) )
    {
      ...
      v11 = v6;
      v13 = v6;
      TlgWrite(v5, &unk_1801A4B32, 0LL, 0LL, 5u, &pData);
    }
  }
}
