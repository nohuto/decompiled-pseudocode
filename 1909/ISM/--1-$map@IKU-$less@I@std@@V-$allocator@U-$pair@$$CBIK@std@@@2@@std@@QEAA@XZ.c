/*
 * XREFs of ??1?$map@IKU?$less@I@std@@V?$allocator@U?$pair@$$CBIK@std@@@2@@std@@QEAA@XZ @ 0x180095580
 * Callers:
 *     _SpectrumListener::SpectrumListener_::_1_::dtor$4 @ 0x18009551D (_SpectrumListener--SpectrumListener_--_1_--dtor$4.c)
 * Callees:
