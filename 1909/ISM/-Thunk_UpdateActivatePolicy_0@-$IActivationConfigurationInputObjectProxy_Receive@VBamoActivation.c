/*
 * XREFs of ?Thunk_UpdateActivatePolicy_0@?$IActivationConfigurationInputObjectProxy_Receive@VBamoActivationConfigurationInputObjectProxyImpl@BamoImpl@@@@SAJPEAXPEAPEAX@Z @ 0x180009EF0
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall IActivationConfigurationInputObjectProxy_Receive<BamoImpl::BamoActivationConfigurationInputObjectProxyImpl>::Thunk_UpdateActivatePolicy_0(
        __int64 a1,
        _DWORD **a2)
{
  int v4; // eax
