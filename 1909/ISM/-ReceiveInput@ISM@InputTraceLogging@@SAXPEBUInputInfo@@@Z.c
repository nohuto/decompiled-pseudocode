/*
 * XREFs of ?ReceiveInput@ISM@InputTraceLogging@@SAXPEBUInputInfo@@@Z @ 0x180092CF8
 * Callers:
...
void __fastcall InputTraceLogging::ISM::ReceiveInput(const struct InputInfo *a1)
{
  ...
  if ( *(_DWORD *)v2[1] > 4u )
  {
    if ( TlgKeywordOn((TraceLoggingHProvider)v2[1], 0x200uLL) )
    {
      v3 = *((_QWORD *)a1 + 2);
      v4 = *(_DWORD *)a1;
      v13 = 0;
      ...
      v8 = v6;
      v16 = 4;
      TlgWrite(v7, &unk_18019C2A9, 0LL, 0LL, 5u, &pData);
    }
  }
}
