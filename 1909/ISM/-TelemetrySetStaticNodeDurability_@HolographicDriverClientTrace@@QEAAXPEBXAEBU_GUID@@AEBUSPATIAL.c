/*
 * XREFs of ?TelemetrySetStaticNodeDurability_@HolographicDriverClientTrace@@QEAAXPEBXAEBU_GUID@@AEBUSPATIAL_NODE_ID@@W4SPATIAL_STATIC_NODE_DURABILITY@@@Z @ 0x18015FC6C
 * Callers:
        ...
        int a5)
{
  ...
  if ( *(_DWORD *)v8 > 4u )
  {
    ...
    if ( (_BYTE)v7 )
    {
      ...
      v12 = 0x2000000LL;
      v23 = 8LL;
      LOBYTE(v7) = TlgWrite(v9, &unk_1801A343D, 0LL, 0LL, 7u, &pData);
    }
  }
  return v7;
}
