/*
 * XREFs of ?Thunk_UpdateEatPolicy_0@?$IActivationConfigurationInputObjectProxy_Receive@VBamoActivationConfigurationInputObjectProxyImpl@BamoImpl@@@@SAJPEAXPEAPEAX@Z @ 0x180009EB0
 * Callers:
 *     <none>
 * Callees:
