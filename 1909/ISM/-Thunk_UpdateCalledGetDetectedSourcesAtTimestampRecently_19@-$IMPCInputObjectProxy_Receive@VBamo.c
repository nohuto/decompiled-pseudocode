/*
 * XREFs of ?Thunk_UpdateCalledGetDetectedSourcesAtTimestampRecently_19@?$IMPCInputObjectProxy_Receive@VBamoMPCInputObjectProxyImpl@BamoImpl@@@@SAJPEAXPEAPEAX@Z @ 0x180062DF0
 * Callers:
 *     <none>
 * Callees:
