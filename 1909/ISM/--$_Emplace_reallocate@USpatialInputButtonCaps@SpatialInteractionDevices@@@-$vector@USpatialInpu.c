/*
 * XREFs of ??$_Emplace_reallocate@USpatialInputButtonCaps@SpatialInteractionDevices@@@?$vector@USpatialInputButtonCaps@SpatialInteractionDevices@@V?$allocator@USpatialInputButtonCaps@SpatialInteractionDevices@@@std@@@std@@QEAAPEAUSpatialInputButtonCaps@SpatialInteractionDevices@@QEAU23@$$QEAU23@@Z @ 0x1800DB0AC
 * Callers:
 ...
 *     ?_Change_array@?$vector@USpatialInputButtonCaps@SpatialInteractionDevices@@V?$allocator@USpatialInputButtonCaps@SpatialInteractionDevices@@@std@@@std@@AEAAXQEAUSpatialInputButtonCaps@SpatialInteractionDevices@@_K1@Z @ 0x1800DD74C (-_Change_array@-$vector@USpatialInputButtonCaps@SpatialInteractionDevices@@V-$allocator@USpatial.c)
 */
        ...
        __int64 a3)
{
  ...
  try
  {
    ...
    *((_DWORD *)v13 + v15 + 2) = *(_DWORD *)(a3 + 8);
    ...
    std::vector<SpatialInteractionDevices::SpatialInputButtonCaps>::_Change_array(a1, v14, v8, v11, -2LL);
