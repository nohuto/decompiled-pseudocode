/*
 * XREFs of ?SendGamepadAsPointerAndManipulation@ControllerProcessor@@AEAAJPEAUGamepadReading@Input@Gaming@Windows@@@Z @ 0x180076E14
 * Callers:
 ...
 *     ?ApplyPanDelta@ControllerProcessor@@AEAAJXZ @ 0x1800750FC (-ApplyPanDelta@ControllerProcessor@@AEAAJXZ.c)
 *     ?ApplyPanDeltaToScroll@ControllerProcessor@@AEAAXXZ @ 0x180075188 (-ApplyPanDeltaToScroll@ControllerProcessor@@AEAAXXZ.c)
 *     ?ApplyZoomDelta@ControllerProcessor@@AEAAJXZ @ 0x1800752AC (-ApplyZoomDelta@ControllerProcessor@@AEAAJXZ.c)
 ...
 *     SignedNormalize @ 0x180077A48 (SignedNormalize.c)
 */
