/*
 * XREFs of ?OnVoiceEvent@BamoMPCInputObjectProxy@@UEAAJAEBUMPCTraceInfo@@AEBW4PhrasePriv@Internal@Spatial@Input@UI@Windows@@AEBUPoseDataMsg@45678@AEBUHitObjectMsg@45678@@Z @ 0x180060530
 * Callers:
 *     <none>
 * Callees:
...
{
  BamoMPCInputObjectProxy *v6; // rbx
  ...
  LODWORD(v6) = BamoImpl::BamoMPCInputObjectProxyImpl::OnVoiceEvent(
                  (BamoMPCInputObjectProxy *)((char *)v6 + 8),
                  a2,
                  a3,
                  a4,
                  a5);
