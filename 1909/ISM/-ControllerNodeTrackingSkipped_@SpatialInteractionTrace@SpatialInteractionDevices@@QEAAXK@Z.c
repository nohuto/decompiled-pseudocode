/*
 * XREFs of ?ControllerNodeTrackingSkipped_@SpatialInteractionTrace@SpatialInteractionDevices@@QEAAXK@Z @ 0x1800E15FC
 * Callers:
        ...
        int a2)
{
  ...
  if ( *(_DWORD *)v2 > 4u )
  {
    if ( TlgKeywordOn(v2, 2uLL) )
    {
      ...
      v5 = &v8;
      v6 = 4;
      TlgWrite(v3, &unk_18019E52E, 0LL, 0LL, 3u, &pData);
    }
  }
}
