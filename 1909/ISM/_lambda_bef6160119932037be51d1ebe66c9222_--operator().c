/*
 * XREFs of _lambda_bef6160119932037be51d1ebe66c9222_::operator() @ 0x1800DBF98
 * Callers:
...
__int64 __fastcall lambda_bef6160119932037be51d1ebe66c9222_::operator()(__int64 a1, USAGE a2, USHORT a3)
{
  NTSTATUS Usages; // eax
