/*
 * XREFs of ?FindView@ViewHelper@@SAJPEAUIViewHierarchy@@V?$function@$$A6A_NPEAUIMonitorView@Server@Navigation@@@Z@std@@PEAPEAUIMonitorView@Server@Navigation@@@Z @ 0x180057CB0
 * Callers:
