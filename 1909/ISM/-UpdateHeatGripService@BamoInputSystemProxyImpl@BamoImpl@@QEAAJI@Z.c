/*
 * XREFs of ?UpdateHeatGripService@BamoInputSystemProxyImpl@BamoImpl@@QEAAJI@Z @ 0x1800642DC
 * Callers:
 *     ?Thunk_UpdateHeatGripService_0@?$IInputSystemProxy_Receive@VBamoInputSystemProxyImpl@BamoImpl@@@@SAJPEAXPEAPEAX@Z @ 0x1800632B0 (-Thunk_UpdateHeatGripService_0@-$IInputSystemProxy_Receive@VBamoInputSystemProxyImpl@BamoImpl@@@.c)
 * Callees:
