/*
 * XREFs of ?BroadcastRemoteClear@BamoList_PenDevicePrincipal_Principal@ISMBamos_AutoBamos@Lib@Bamo@Microsoft@@UEAAJXZ @ 0x180127E40
 * Callers:
 *     <none>
 * Callees:
        ...
        struct Microsoft::BamoImpl::ConnectionIndirector **this)
{
  ...
  if ( *(_QWORD *)(*((_QWORD *)this[3] + 3) + 40LL) )
  {
    for ( i = this[5]; ; i = (struct Microsoft::BamoImpl::ConnectionIndirector *)*((_QWORD *)i + 6) )
    {
      ...
      if ( *((_BYTE *)i + 32) )
      {
        v7 = Microsoft::Bamo::Lib::BamoImpl::ISMBamos_AutoBamos::BamoList_PenDevicePrincipal_PrincipalImpl::CallRemoteClearOnStub(i);
        v2 = v7;
        if ( v7 < 0 )
          break;
      }
    ...
    v3 = (unsigned int)v7;
    v4 = "internal\\mincore\\priv_sdk\\inc\\BamoPrincipal.inl";
    v5 = 471LL;
  }
  else
  {
