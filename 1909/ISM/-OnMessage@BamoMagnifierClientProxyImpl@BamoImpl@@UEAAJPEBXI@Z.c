/*
 * XREFs of ?OnMessage@BamoMagnifierClientProxyImpl@BamoImpl@@UEAAJPEBXI@Z @ 0x18006F7C0
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall BamoImpl::BamoMagnifierClientProxyImpl::OnMessage(
        ...
        const void *a2)
{
  ...
  result = CoreUICallReceive(
             *(_QWORD *)(*(_QWORD *)(*(_QWORD *)(*((_QWORD *)this + 2) + 24LL) + 24LL) + 56LL),
             &IMagnifierClientProxy_Receive<BamoImpl::BamoMagnifierClientProxyImpl>::Type,
