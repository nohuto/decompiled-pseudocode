/*
 * XREFs of ?OnProxyCreated@TextInputStateAdapter@@UEAAJPEAUIMessageProxy@@@Z @ 0x180148780
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall TextInputStateAdapter::OnProxyCreated(TextInputStateAdapter *this, struct IMessageProxy *a2)
{
  ...
  {
    if ( v2 == -2147024882 )
      FailFastWithHR(-2147024882, retaddr, 0x3CuLL);
    FailFastWithHR(v3, retaddr, 0x3CuLL);
  }
  return v3;
}
