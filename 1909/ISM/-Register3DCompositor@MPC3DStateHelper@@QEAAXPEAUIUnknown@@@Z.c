/*
 * XREFs of ?Register3DCompositor@MPC3DStateHelper@@QEAAXPEAUIUnknown@@@Z @ 0x18007C2F0
 * Callers:
 ...
 *     ?On3DCompositorStateChanged@MPC3DStateHelper@@AEAA_N_N@Z @ 0x18007C25C (-On3DCompositorStateChanged@MPC3DStateHelper@@AEAA_N_N@Z.c)
 */
