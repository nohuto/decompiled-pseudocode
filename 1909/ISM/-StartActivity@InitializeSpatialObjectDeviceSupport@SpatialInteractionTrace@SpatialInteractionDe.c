/*
 * XREFs of ?StartActivity@InitializeSpatialObjectDeviceSupport@SpatialInteractionTrace@SpatialInteractionDevices@@QEAAXXZ @ 0x1800EE08C
 * Callers:
        ...
        SpatialInteractionDevices::SpatialInteractionTrace::InitializeSpatialObjectDeviceSupport *this)
{
  ...
  if ( *(_DWORD *)v3 > 4u )
  {
    ...
    TlgWrite(v3, &unk_18019F8DD, (LPCGUID)(*((_QWORD *)this + 6) + 8LL), v4, 4u, &pData);
  }
  if ( !*((_DWORD *)this + 8) )
