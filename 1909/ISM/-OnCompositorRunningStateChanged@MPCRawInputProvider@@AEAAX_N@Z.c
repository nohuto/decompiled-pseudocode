/*
 * XREFs of ?OnCompositorRunningStateChanged@MPCRawInputProvider@@AEAAX_N@Z @ 0x1800945E0
 * Callers:
...
void __fastcall MPCRawInputProvider::OnCompositorRunningStateChanged(MPCRawInputProvider *this, char a2)
{
  ...
  volatile int *v11[2]; // [rsp+20h] [rbp-28h] BYREF
  PVOID v12; // [rsp+30h] [rbp-18h]
  volatile int *v13; // [rsp+60h] [rbp+18h] BYREF
  struct MPCRawInputProvider *v14; // [rsp+68h] [rbp+20h] BYREF

  v11[1] = (volatile int *)-2LL;
  v3 = *((_BYTE *)this + 80);
  if ( a2 )
  {
    if ( !v3 )
