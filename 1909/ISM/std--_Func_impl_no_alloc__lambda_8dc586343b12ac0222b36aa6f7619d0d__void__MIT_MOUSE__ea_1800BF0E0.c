/*
 * XREFs of std::_Func_impl_no_alloc__lambda_8dc586343b12ac0222b36aa6f7619d0d__void__MIT_MOUSE_INPUT_MESSAGE_const___::_Do_call @ 0x1800BF0E0
 * Callers:
 *     <none>
 * Callees:
        ...
        const struct _MIT_MOUSE_INPUT_MESSAGE **a2)
{
  ...
  v3 = *a2;
  InputTraceLogging::PerfRegion::PerfRegion((InputTraceLogging::PerfRegion *)v4, L"MITEP_MOUSE_INPUT", 0LL);
