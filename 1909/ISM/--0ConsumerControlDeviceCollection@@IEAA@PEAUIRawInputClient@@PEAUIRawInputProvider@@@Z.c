/*
 * XREFs of ??0ConsumerControlDeviceCollection@@IEAA@PEAUIRawInputClient@@PEAUIRawInputProvider@@@Z @ 0x1800A26B0
 * Callers:
        ...
        struct IRawInputProvider *a3)
{
  ...
  *((_QWORD *)this + 346) = 0LL;
  *((_QWORD *)this + 347) = 0LL;
  *((_QWORD *)this + 346) = std::_List_alloc<std::_List_base_types<std::pair<unsigned long const,MobileButtonDeviceCollection::UsageList>>>::_Buynode0(
                              v5,
                              0LL,
                              0LL);
  *((_QWORD *)this + 348) = 0LL;
