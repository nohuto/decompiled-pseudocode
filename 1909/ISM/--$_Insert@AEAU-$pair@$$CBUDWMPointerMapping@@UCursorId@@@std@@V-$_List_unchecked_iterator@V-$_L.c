        ...
        __int64 *a4)
{
  ...
  {
    do
      v8 = 0x100000001B3LL * (*v9++ ^ (unsigned __int64)v8);
    while ( v9 - a3 != (a3 + 4 >= a3 ? 4 : 0) );
  }
  v10 = a3 + 4;
  if ( a3 + 4 < a3 + 8 )
  {
    do
      v7 = 0x100000001B3LL * (*v10++ ^ (unsigned __int64)v7);
    while ( v10 - (a3 + 4) != (a3 + 8 >= a3 + 4 ? 4 : 0) );
  }
  v11 = 2 * (*(_QWORD *)(a1 + 48) & (v8 ^ v7));
  v12 = *(_QWORD *)(a1 + 24);
  v13 = *(_QWORD *)(a1 + 8);
  if ( *(_QWORD *)(v12 + 8 * v11) != v13 )
  {
    try
    {
    ...
    {
      std::list<std::pair<unsigned long const,MobileButtonDeviceCollection::UsageList>>::erase(v30 + 8, &v30, v32);
      throw;
    }
  }
  v14 = v13;
  while ( v14 != *(_QWORD *)(v12 + 8 * v11) )
  {
    v13 = *(_QWORD *)(v13 + 8);
    v14 = v13;
    if ( *(_DWORD *)a3 == *(_DWORD *)(v13 + 16) && *((_DWORD *)a3 + 1) == *(_DWORD *)(v13 + 20) )
    {
      std::list<std::pair<unsigned long const,MobileButtonDeviceCollection::UsageList>>::erase(a1 + 8, &v31, a4);
      *(_QWORD *)a2 = v13;
      *(_BYTE *)(a2 + 8) = 0;
      return a2;
    }
  ...
  {
    v24 = *(__int64 ***)(v17 + 8 * v11 + 8);
    v25 = *v24;
    *(_QWORD *)(v17 + 8 * v11 + 8) = *v24;
    if ( v25 != a4 )
      *(_QWORD *)(*(_QWORD *)(a1 + 24) + 8 * v11 + 8) = *(_QWORD *)(*(_QWORD *)(*(_QWORD *)(a1 + 24) + 8 * v11 + 8) + 8LL);
  }
  v19 = *(_QWORD *)(a1 + 16);
  v20 = *(_QWORD *)(a1 + 56);
  v21 = (float)(int)v19;
