/*
 * XREFs of ?ParseReportDescriptors@HidLampArrayDevice@@AEAAJPEAUParsedHidReportDescriptor@@I@Z @ 0x1800B4670
 * Callers:
        ...
        unsigned int a3)
{
  ...
  struct HidLampArrayAttributesReportParser *v26; // [rsp+78h] [rbp+48h] BYREF
