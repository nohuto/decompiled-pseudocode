/*
 * XREFs of ?SuppressInputOfType@BamoInputObserverManagerPrincipalImpl@BamoImpl@@QEAAJW4InputObserverType@InputObservation@@I@Z @ 0x180067870
 * Callers:
 *     ?Thunk_SuppressInputOfType_137@?$IInputObserverManagerPrincipal_Receive@VBamoInputObserverManagerPrincipalImpl@BamoImpl@@@@SAJPEAXPEAPEAX@Z @ 0x1800679E0 (-Thunk_SuppressInputOfType_137@-$IInputObserverManagerPrincipal_Receive@VBamoInputObserverManage.c)
 * Callees:
        ...
        unsigned int a3)
{
  ...
  v13 = (*(__int64 (__fastcall **)(_QWORD *, __int64, _QWORD, char *))(*((_QWORD *)a1 - 2) + 88LL))(
          (_QWORD *)a1 - 2,
          v7,
          a2,
          v12);
