/*
 * XREFs of ?RegisterFor3DCompositorRunningChanged@MPC3DStateHelper@@QEAAXV?$function@$$A6AX_N@Z@std@@PEAI@Z @ 0x18001F660
 * Callers:
...
__int64 __fastcall MPC3DStateHelper::RegisterFor3DCompositorRunningChanged(
        PSRWLOCK SRWLock,
        __int64 a2,
        unsigned int *a3)
{
  ...
  *a3 = Ptr;
  ...
  while ( !*((_BYTE *)v9 + 25) );
  if ( v8 == SRWLock[4].Ptr || Ptr < *((_DWORD *)v8 + 8) )
  {
LABEL_6:
    v15[0] = a3;
  ...
  if ( v13 == v16 || *((char **)v11 + 7) == v11 )
  {
    v19 = 0LL;
    std::_Func_class<void,_MIT_INPUT_INTEROP_MESSAGE const *>::_Reset_move(v18, v16);
    std::_Func_class<void,_MIT_INPUT_INTEROP_MESSAGE const *>::_Reset_move(v16, v11);
    std::_Func_class<void,_MIT_INPUT_INTEROP_MESSAGE const *>::_Reset_move(v11, v18);
    std::_Func_class<void,_MIT_INPUT_INTEROP_MESSAGE const *>::_Tidy(v18);
  }
  else
  {
    v17 = (_BYTE *)*((_QWORD *)v11 + 7);
    *((_QWORD *)v11 + 7) = v13;
  }
