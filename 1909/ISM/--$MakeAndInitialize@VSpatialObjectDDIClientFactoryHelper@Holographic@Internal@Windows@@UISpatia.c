/*
 * XREFs of ??$MakeAndInitialize@VSpatialObjectDDIClientFactoryHelper@Holographic@Internal@Windows@@UISpatialObjectDDIClientFactory@234@$$V@Details@WRL@Microsoft@@YAJPEAPEAUISpatialObjectDDIClientFactory@Holographic@Internal@Windows@@@Z @ 0x1800E9C94
 * Callers:
 ...
 *     ??0SpatialObjectDDIClientFactoryHelper@Holographic@Internal@Windows@@QEAA@XZ @ 0x1800EA7E4 (--0SpatialObjectDDIClientFactoryHelper@Holographic@Internal@Windows@@QEAA@XZ.c)
