/*
 * XREFs of ?HasDynamicNode@SpatialInteractionSourceDevice@SpatialInteractions@Internal@Windows@@QEBA_NXZ @ 0x1800E2734
 * Callers:
 ...
 *     ?CanSendPoses@SpatialInteractionEyeGazeSourceObject@SpatialInteractions@Internal@Windows@@UEBA_NXZ @ 0x1800F0790 (-CanSendPoses@SpatialInteractionEyeGazeSourceObject@SpatialInteractions@Internal@Windows@@UEBA_N.c)
 *     ?CanSendPoses@SpatialInteractionSourceController@SpatialInteractions@Internal@Windows@@UEBA_NXZ @ 0x1801640E0 (-CanSendPoses@SpatialInteractionSourceController@SpatialInteractions@Internal@Windows@@UEBA_NXZ.c)
 * Callees:
 *     <none>
 */
