/*
 * XREFs of ??0SpatialInteractionEyeGazeSourceObject@SpatialInteractions@Internal@Windows@@QEAA@PEB_WPEAUISpatialObjectDevice@Holographic@23@PEAUISpatialObject@523@@Z @ 0x1800F03FC
 * Callers:
        ...
        struct Windows::Internal::Holographic::ISpatialObject *a4)
{
  ...
  *(_OWORD *)((char *)this + 564) = *(_OWORD *)(*(__int64 (__fastcall **)(struct Windows::Internal::Holographic::ISpatialObject *, char **))(*(_QWORD *)a4 + 48LL))(
                                                 a4,
                                                 &v10);
  return this;
}
