/*
 * XREFs of ??$IoctlRanLong@AEBU_GUID@@AEAKJAEAMAEBK@HolographicDriverClientTrace@@SAXAEBU_GUID@@AEAK$$QEAJAEAMAEBK@Z @ 0x18014ABB4
 * Callers:
        ...
        float *a4)
{
  ...
  if ( HolographicDriverClientTrace::IsEnabled((unsigned __int8)a1, (unsigned __int64)a2) )
  {
    ...
    HolographicDriverClientTrace::IoctlRanLong_(v9, a1, *a2, *a3, *a4, 244);
  }
}
