/*
 * XREFs of ?SpatialObjectStoppedTracking_@SpatialInteractionTrace@SpatialInteractionDevices@@QEAAXAEBU_GUID@@I@Z @ 0x1800EDC24
 * Callers:
        ...
        int a3)
{
  ...
  if ( *(_DWORD *)v4 > 4u )
  {
    if ( TlgKeywordOn(v4, 2uLL) )
    {
      ...
      v9 = 16;
      v12 = cData;
      TlgWrite(v5, &unk_18019EC7D, 0LL, 0LL, cData, &pData);
    }
  }
}
