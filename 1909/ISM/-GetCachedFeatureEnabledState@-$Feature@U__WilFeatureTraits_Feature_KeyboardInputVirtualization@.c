/*
 * XREFs of ?GetCachedFeatureEnabledState@?$Feature@U__WilFeatureTraits_Feature_KeyboardInputVirtualization@@@wil@@CA?AW4wil_details_CachedFeatureEnabledState@@_N@Z @ 0x180107BE8
 * Callers:
 *     ?ReportUsageToService@?$Feature@U__WilFeatureTraits_Feature_KeyboardInputVirtualization@@@wil@@CAX_NW4ReportingKind@2@_K@Z @ 0x1801082AC (-ReportUsageToService@-$Feature@U__WilFeatureTraits_Feature_KeyboardInputVirtualization@@@wil@@C.c)
 * Callees:
...
__int64 __fastcall wil::Feature<__WilFeatureTraits_Feature_KeyboardInputVirtualization>::GetCachedFeatureEnabledState(
        __int64 a1)
{
  unsigned int v1; // ebx
  char v2; // si
  ...
  LOBYTE(v8) = a1;
  v1 = `wil::Feature<__WilFeatureTraits_Feature_KeyboardInputVirtualization>::GetFeaturePropertyCache'::`2'::data & 3;
  if ( (`wil::Feature<__WilFeatureTraits_Feature_KeyboardInputVirtualization>::GetFeaturePropertyCache'::`2'::data & 3) != 0 )
  {
    v2 = 0;
  ...
  v8 = 0;
  CurrentFeatureEnabledState = wil::Feature<__WilFeatureTraits_Feature_KeyboardInputVirtualization>::GetCurrentFeatureEnabledState(
                                 a1,
                                 &v8,
                                 &v9);
  v4 = (`wil::Feature<__WilFeatureTraits_Feature_KeyboardInputVirtualization>::GetFeaturePropertyCache'::`2'::data >> 2) & 1;
  if ( v2 )
  {
    v4 = v9;
  ...
  wil_details_ModifyFeatureData(
    (union wil_details_FeaturePropertyCache *)&`wil::Feature<__WilFeatureTraits_Feature_KeyboardInputVirtualization>::GetFeaturePropertyCache'::`2'::data,
    v5,
    (void *)v6);
  return v1;
}
