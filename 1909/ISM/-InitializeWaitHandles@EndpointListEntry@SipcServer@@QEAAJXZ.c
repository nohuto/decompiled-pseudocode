/*
 * XREFs of ?InitializeWaitHandles@EndpointListEntry@SipcServer@@QEAAJXZ @ 0x1800D6094
 * Callers:
 ...
 *     ?GetWaitHandles@SipcEndpoint@@QEBAXAEAPEAX00@Z @ 0x1800D5F98 (-GetWaitHandles@SipcEndpoint@@QEBAXAEAPEAX00@Z.c)
 */
...
__int64 __fastcall SipcServer::EndpointListEntry::InitializeWaitHandles(SipcServer::EndpointListEntry *this)
{
  ...
  result = AggregateWaitHandle::AddHandle((AggregateWaitHandle *)(*((_QWORD *)this + 3) + 144LL), *((void **)this + 4));
  v3 = 0;
  if ( (int)result >= 0 )
  {
    v4 = AggregateWaitHandle::AddHandle((AggregateWaitHandle *)(*((_QWORD *)this + 3) + 144LL), *((void **)this + 5));
    if ( v4 < 0 )
