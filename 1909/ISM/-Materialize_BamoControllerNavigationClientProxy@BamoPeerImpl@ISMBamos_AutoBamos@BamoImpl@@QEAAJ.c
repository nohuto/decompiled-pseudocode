/*
 * XREFs of ?Materialize_BamoControllerNavigationClientProxy@BamoPeerImpl@ISMBamos_AutoBamos@BamoImpl@@QEAAJI@Z @ 0x18005DDC0
 * Callers:
 *     ?Thunk_Materialize_BamoControllerNavigationClientProxy_0@?$IBamoPeer_ISMBamos_AutoBamos_Receive@VBamoPeerImpl@ISMBamos_AutoBamos@BamoImpl@@@@SAJPEAXPEAPEAX@Z @ 0x180062A20 (-Thunk_Materialize_BamoControllerNavigationClientProxy_0@-$IBamoPeer_ISMBamos_AutoBamos_Receive@.c)
 * Callees:
