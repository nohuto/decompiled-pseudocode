/*
 * XREFs of ?HandReportIgnored_@SpatialInteractionTraceContinuous@SpatialInteractionDevices@@QEAAXU_GUID@@_JHH_N2@Z @ 0x1800F4A10
 * Callers:
        ...
        bool a7)
{
  ...
  if ( *(_DWORD *)v8 > 5u )
  {
    if ( TlgKeywordOn(v8, 2uLL) )
    {
      ...
      v22 = 1LL;
      v24 = 1LL;
      TlgWrite(v10, &unk_18019FD72, 0LL, 0LL, v9 + 6, &pData);
    }
  }
}
