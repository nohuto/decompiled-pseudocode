/*
 * XREFs of ?SendLampRangeUpdateReport@HidLampArrayDevice@@QEAAJPEBULampRangeUpdateDeviceReport@@@Z @ 0x1800B5268
 * Callers:
        ...
        const struct LampRangeUpdateDeviceReport *a2)
{
  ...
  if ( (unsigned int)hProvider > 5 )
  {
    ...
    TlgWrite((TraceLoggingHProvider)&hProvider, &unk_18019D6A9, 0LL, 0LL, 4u, &pData);
  }
  v4 = *((_QWORD *)this + 77);
  ...
  if ( v5 >= 0 )
  {
    ...
    if ( HidD_SetFeature(*(HANDLE *)(*((_QWORD *)this + 2) + 40LL), ReportBuffer, ReportBufferLength) )
    {
      if ( (unsigned int)hProvider > 5 )
      {
        ...
        TlgWrite((TraceLoggingHProvider)&hProvider, &unk_18019D6A9, 0LL, 0LL, 4u, &v21);
      }
      if ( v9 )
