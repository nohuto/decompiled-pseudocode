/*
 * XREFs of ?Thunk_UpdateBounds_27@?$IControllerNavigationClientProxy_Receive@VBamoControllerNavigationClientProxyImpl@BamoImpl@@@@SAJPEAXPEAPEAX@Z @ 0x1800712F0
 * Callers:
 *     <none>
 * Callees:
