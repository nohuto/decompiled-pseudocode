/*
 * XREFs of ?ControllerDeviceUpdate_@RawInputProvidersTracing@@QEAAXJKPEAUDeviceInfo@@@Z @ 0x18009C38C
 * Callers:
        ...
        struct DeviceInfo *a4)
{
  ...
  if ( a4 )
  {
    ...
    if ( *(_DWORD *)v5 > 4u )
    {
      if ( TlgKeywordOn(v5, 2uLL) )
      {
        ...
        v25 = v7 - 3;
        v28 = v7 - 3;
        TlgWrite(v6, &unk_18019CBC0, 0LL, 0LL, 8u, &pData);
      }
    }
  }
  else
  {
    ...
    if ( *(_DWORD *)v8 > 4u && TlgKeywordOn(v8, 2uLL) )
    {
      ...
      v13 = cData;
      v16 = cData;
      TlgWrite(v9, &unk_18019CB8C, 0LL, 0LL, cData, &pData);
    }
  }
}
