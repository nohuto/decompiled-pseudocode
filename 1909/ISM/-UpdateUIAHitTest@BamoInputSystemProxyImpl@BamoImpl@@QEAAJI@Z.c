/*
 * XREFs of ?UpdateUIAHitTest@BamoInputSystemProxyImpl@BamoImpl@@QEAAJI@Z @ 0x180064DB4
 * Callers:
 *     ?Thunk_UpdateUIAHitTest_0@?$IInputSystemProxy_Receive@VBamoInputSystemProxyImpl@BamoImpl@@@@SAJPEAXPEAPEAX@Z @ 0x180063B20 (-Thunk_UpdateUIAHitTest_0@-$IInputSystemProxy_Receive@VBamoInputSystemProxyImpl@BamoImpl@@@@SAJP.c)
 * Callees:
