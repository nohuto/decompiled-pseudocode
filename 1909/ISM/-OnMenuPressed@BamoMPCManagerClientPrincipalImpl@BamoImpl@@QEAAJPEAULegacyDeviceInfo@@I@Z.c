/*
 * XREFs of ?OnMenuPressed@BamoMPCManagerClientPrincipalImpl@BamoImpl@@QEAAJPEAULegacyDeviceInfo@@I@Z @ 0x180115C90
 * Callers:
 *     ?Thunk_OnMenuPressed_54@?$IMPCManagerClientPrincipal_Receive@VBamoMPCManagerClientPrincipalImpl@BamoImpl@@@@SAJPEAXPEAPEAX@Z @ 0x1801163C0 (-Thunk_OnMenuPressed_54@-$IMPCManagerClientPrincipal_Receive@VBamoMPCManagerClientPrincipalImpl@.c)
 * Callees:
        ...
        unsigned int a3)
{
  ...
  v8 = (*(__int64 (__fastcall **)(char *, __int64, struct LegacyDeviceInfo *, _QWORD))(*((_QWORD *)this - 2) + 80LL))(
         (char *)this - 16,
         v7,
         a2,
         a3);
