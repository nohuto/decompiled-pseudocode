/*
 * XREFs of ?TimestampClampedDueToLatency_@SpatialInteractionTrace@SpatialInteractionDevices@@QEAAXKK_J0@Z @ 0x180168E40
 * Callers:
        ...
        ...)
{
  ...
  if ( *(_DWORD *)v4 > 4u )
  {
    if ( TlgKeywordOn(v4, 2uLL) )
    {
      ...
      v13 = 8LL;
      v15 = 8LL;
      TlgWrite(v5, &unk_1801A4953, 0LL, 0LL, 6u, &pData);
    }
  }
}
