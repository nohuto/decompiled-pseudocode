/*
 * XREFs of ?SpatialObjectDeviceInitializationDone_@SpatialInteractionTrace@SpatialInteractionDevices@@QEAAXPEB_WJ@Z @ 0x1800ED70C
 * Callers:
        ...
        int a3)
{
  ...
  if ( *(_DWORD *)v4[1] > 4u )
  {
    if ( TlgKeywordOn((TraceLoggingHProvider)v4[1], 2uLL) )
    {
      ...
      v9 = &v12;
      v10 = cData;
      TlgWrite(v6, &unk_18019ED85, 0LL, 0LL, cData, &pData);
    }
  }
}
