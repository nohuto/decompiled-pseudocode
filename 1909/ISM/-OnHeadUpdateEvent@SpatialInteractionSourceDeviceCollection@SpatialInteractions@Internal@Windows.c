/*
 * XREFs of ?OnHeadUpdateEvent@SpatialInteractionSourceDeviceCollection@SpatialInteractions@Internal@Windows@@UEAAJAEBUMPCMatrix4x4@@PEAUIPerceptionTimestamp@Perception@4@PEAUISpatialInteractionSourceCollectionCallbacks@234@@Z @ 0x1800ECA90
 * Callers:
 *     <none>
 * Callees:
        ...
        struct Windows::Internal::SpatialInteractions::ISpatialInteractionSourceCollectionCallbacks *a4)
{
  ...
  struct _RTL_CRITICAL_SECTION *v18; // [rsp+50h] [rbp-20h] BYREF
  __int64 v19; // [rsp+58h] [rbp-18h] BYREF
  struct _RTL_CRITICAL_SECTION *v20; // [rsp+60h] [rbp-10h] BYREF
  wil::details::in1diag3 *retaddr; // [rsp+98h] [rbp+28h]
  struct Windows::Internal::Holographic::ISpatialGraphNodeReference *v22; // [rsp+A0h] [rbp+30h] BYREF
  ...
  v18 = (struct _RTL_CRITICAL_SECTION *)((char *)this + 352);
  v7 = (struct Windows::Internal::Holographic::ISpatialGraphNodeReference *)*((_QWORD *)this + 53);
  if ( v7 )
  {
    (*(void (__fastcall **)(_QWORD))(*(_QWORD *)v7 + 8LL))(*((_QWORD *)this + 53));
    v17 = 0LL;
    v22 = v7;
    Microsoft::WRL::ComPtr<Windows::Gaming::Input::Internal::IGipGameControllerProviderPrivate>::InternalRelease(&v17);
  }
  Microsoft::WRL::Wrappers::Details::SyncLockCriticalSection::InternalUnlock(&v18);
  EnterCriticalSection((LPCRITICAL_SECTION)((char *)this + 432));
  v8 = (__int64 *)*((_QWORD *)this + 59);
  v20 = (struct _RTL_CRITICAL_SECTION *)((char *)this + 432);
  v9 = *v8;
  v16 = *v8;
  while ( (__int64 *)v9 != v8 )
  {
  ...
  Microsoft::WRL::Wrappers::Details::SyncLockCriticalSection::InternalUnlock(&v20);
  v13 = (unsigned int *)*((_QWORD *)this + 86);
  if ( v13 )
  {
    v14 = *v13;
