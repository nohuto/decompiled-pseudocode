/*
 * XREFs of ?OnActivationListenerInputObjectChanged@InputSiteElementProxy@@MEAAJXZ @ 0x18000DEB0
 * Callers:
 *     <none>
 * Callees:
        ...
        const char *a4)
{
  ...
  v16 = (*(__int64 (__fastcall **)(__int64))(*((_QWORD *)v4 + 1) + 120LL))((__int64)v4 + 8);
  if ( v16 )
  {
    v21 = v4;
    v18 = v16 + 8;
