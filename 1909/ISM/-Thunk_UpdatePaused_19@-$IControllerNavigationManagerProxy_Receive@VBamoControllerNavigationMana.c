/*
 * XREFs of ?Thunk_UpdatePaused_19@?$IControllerNavigationManagerProxy_Receive@VBamoControllerNavigationManagerProxyImpl@BamoImpl@@@@SAJPEAXPEAPEAX@Z @ 0x180063780
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall IControllerNavigationManagerProxy_Receive<BamoImpl::BamoControllerNavigationManagerProxyImpl>::Thunk_UpdatePaused_19(
        __int64 a1,
        _BYTE **a2)
{
  int v3; // eax
