/*
 * XREFs of _SystemCursorController::DestroyCustomCursorShapeAnimation_::_1_::catch$4 @ 0x1800CA1BA
 * Callers:
 *     <none>
 * Callees:
...
void *__fastcall SystemCursorController::DestroyCustomCursorShapeAnimation_::_1_::catch_4(
        __int64 a1,
        __int64 a2,
        __int64 a3,
        const char *a4)
