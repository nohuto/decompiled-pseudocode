/*
 * XREFs of ?UpdateSupportedFeedback@BamoSimpleHapticsControllerProxyImpl@BamoImpl@@QEAAJI@Z @ 0x180064A84
 * Callers:
 *     ?Thunk_UpdateSupportedFeedback_0@?$ISimpleHapticsControllerProxy_Receive@VBamoSimpleHapticsControllerProxyImpl@BamoImpl@@@@SAJPEAXPEAPEAX@Z @ 0x1800638E0 (-Thunk_UpdateSupportedFeedback_0@-$ISimpleHapticsControllerProxy_Receive@VBamoSimpleHapticsContr.c)
 * Callees:
