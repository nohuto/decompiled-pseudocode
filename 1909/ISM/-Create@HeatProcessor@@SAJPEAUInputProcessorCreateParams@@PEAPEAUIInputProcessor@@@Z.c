/*
 * XREFs of ?Create@HeatProcessor@@SAJPEAUInputProcessorCreateParams@@PEAPEAUIInputProcessor@@@Z @ 0x1801261D0
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall HeatProcessor::Create(struct InputProcessorCreateParams *a1, struct IInputProcessor **a2)
{
  ...
  if ( v4 )
  {
    ...
    *((_DWORD *)v4 + 8) = 1;
    ...
    v4[2] = &KeyboardProcessor::`vftable'{for `IInputFocusListener'};
