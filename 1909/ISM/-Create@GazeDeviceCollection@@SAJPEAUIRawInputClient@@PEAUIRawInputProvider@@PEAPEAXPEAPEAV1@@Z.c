/*
 * XREFs of ?Create@GazeDeviceCollection@@SAJPEAUIRawInputClient@@PEAUIRawInputProvider@@PEAPEAXPEAPEAV1@@Z @ 0x18001FECC
 * Callers:
        ...
        struct GazeDeviceCollection **a4)
{
  ...
  if ( a1 && a3 && a4 )
  {
    ...
    {
      LODWORD(v19) = 1179649;
      v13 = HIDDeviceCollection::Initialize(v12, v10, (struct _RIM_USAGE_ANDPAGE *const)&v19, v11, 0x40u, a3);
      v15 = v13;
      if ( v13 < 0 )
