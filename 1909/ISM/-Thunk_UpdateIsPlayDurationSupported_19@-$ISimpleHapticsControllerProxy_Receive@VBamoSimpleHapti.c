/*
 * XREFs of ?Thunk_UpdateIsPlayDurationSupported_19@?$ISimpleHapticsControllerProxy_Receive@VBamoSimpleHapticsControllerProxyImpl@BamoImpl@@@@SAJPEAXPEAPEAX@Z @ 0x180063630
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall ISimpleHapticsControllerProxy_Receive<BamoImpl::BamoSimpleHapticsControllerProxyImpl>::Thunk_UpdateIsPlayDurationSupported_19(
        __int64 a1,
        _BYTE **a2)
{
  int v3; // eax
