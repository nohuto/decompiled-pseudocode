/*
 * XREFs of ?OnInput@ContextualProcessing@InputTraceLogging@@SAXPEBUInputInfo@@PEBGW4ContextualProcessorDecision@@PEBUIInputTarget@@J@Z @ 0x1800FAF10
 * Callers:
        ...
        char a5)
{
  ...
  if ( *(_DWORD *)v9[1] > 4u )
  {
    ...
    if ( (_BYTE)v9 )
    {
      ...
      v30 = 8LL;
      v32 = 4LL;
      LOBYTE(v9) = TlgWrite(v16, &unk_1801A0423, 0LL, 0LL, 9u, &pData);
    }
  }
  return (char)v9;
}
