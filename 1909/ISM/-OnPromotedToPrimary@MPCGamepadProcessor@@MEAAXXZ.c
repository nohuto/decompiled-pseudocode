/*
 * XREFs of ?OnPromotedToPrimary@MPCGamepadProcessor@@MEAAXXZ @ 0x180138650
 * Callers:
 *     <none>
 * Callees:
...
void __fastcall MPCGamepadProcessor::OnPromotedToPrimary(MPCGamepadProcessor *this)
{
  ...
  *((_QWORD *)this + 894) = *((_QWORD *)Instance + 28);
  *((_DWORD *)this + 1790) = *((_DWORD *)Instance + 58);
  ...
  v6[2] = v10;
  v6[3] = v11;
  v4 = Windows::Foundation::Numerics::transform(v5, (float *)this + 1788, (float *)v6);
  *(_QWORD *)((char *)this + 7164) = *(_QWORD *)v4;
  *(float *)&v4 = v4[2];
  *(_OWORD *)((char *)this + 7192) = 0LL;
  *((_DWORD *)this + 1793) = (_DWORD)v4;
}
