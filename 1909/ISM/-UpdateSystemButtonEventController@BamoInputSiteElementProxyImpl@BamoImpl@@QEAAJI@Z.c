/*
 * XREFs of ?UpdateSystemButtonEventController@BamoInputSiteElementProxyImpl@BamoImpl@@QEAAJI@Z @ 0x18002F470
 * Callers:
 *     ?Thunk_UpdateSystemButtonEventController_0@?$IInputSiteElementProxy_Receive@VBamoInputSiteElementProxyImpl@BamoImpl@@@@SAJPEAXPEAPEAX@Z @ 0x18002F460 (-Thunk_UpdateSystemButtonEventController_0@-$IInputSiteElementProxy_Receive@VBamoInputSiteElemen.c)
 * Callees:
        ...
        unsigned int a2)
{
  ...
  *((_QWORD *)this + 17) = v7;
  ...
  if ( *((_BYTE *)this + 28) )
  {
    ...
    Microsoft::BamoImpl::DropAndReacquireLock::~DropAndReacquireLock((Microsoft::BamoImpl::DropAndReacquireLock *)&v12);
  }
  return 0LL;
}
