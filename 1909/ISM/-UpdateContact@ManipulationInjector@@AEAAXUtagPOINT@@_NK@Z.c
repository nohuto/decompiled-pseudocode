/*
 * XREFs of ?UpdateContact@ManipulationInjector@@AEAAXUtagPOINT@@_NK@Z @ 0x1800E9208
 * Callers:
 ...
 *     ?DeskToDigiPt@ManipulationInjector@@AEAA?AUtagPOINT@@U2@@Z @ 0x1800E77E0 (-DeskToDigiPt@ManipulationInjector@@AEAA-AUtagPOINT@@U2@@Z.c)
 *     ?GetFirstContactIndexForDeviceId@ManipulationInjector@@AEAAIK@Z @ 0x1800E7998 (-GetFirstContactIndexForDeviceId@ManipulationInjector@@AEAAIK@Z.c)
 */
        ...
        const char *a4)
{
  ...
  if ( !(_BYTE)a3 || *((_DWORD *)this + 178) == (_DWORD)a4 )
  {
    ...
    *(_DWORD *)((char *)this + v7 + 124) = 4 * (v4 ^ 1) + 131074;
  }
}
