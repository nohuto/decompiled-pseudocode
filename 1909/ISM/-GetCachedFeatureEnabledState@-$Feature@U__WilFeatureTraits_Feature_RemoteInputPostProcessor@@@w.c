/*
 * XREFs of ?GetCachedFeatureEnabledState@?$Feature@U__WilFeatureTraits_Feature_RemoteInputPostProcessor@@@wil@@CA?AW4wil_details_CachedFeatureEnabledState@@_N@Z @ 0x18001D3D0
 * Callers:
 ...
 *     ?GetCurrentFeatureEnabledState@?$Feature@U__WilFeatureTraits_Feature_RemoteInputPostProcessor@@@wil@@CA?AW4wil_details_CachedFeatureEnabledState@@_NPEAW4wil_details_CachedHasNotificationState@@PEAH@Z @ 0x18001E2A4 (-GetCurrentFeatureEnabledState@-$Feature@U__WilFeatureTraits_Feature_RemoteInputPostProcessor@@@.c)
