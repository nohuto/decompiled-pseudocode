/*
 * XREFs of PoseClientStatics::SpatialTrackingPoseToInversePoseWithDifferentials @ 0x18015D90C
 * Callers:
 ...
 *     ??0PoseWithDifferentials@PosePredictionTools@@QEAA@XZ @ 0x180150DEC (--0PoseWithDifferentials@PosePredictionTools@@QEAA@XZ.c)
