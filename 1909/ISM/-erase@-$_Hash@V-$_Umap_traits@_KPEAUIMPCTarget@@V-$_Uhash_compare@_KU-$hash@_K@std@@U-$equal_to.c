/*
 * XREFs of ?erase@?$_Hash@V?$_Umap_traits@_KPEAUIMPCTarget@@V?$_Uhash_compare@_KU?$hash@_K@std@@U?$equal_to@_K@2@@std@@V?$allocator@U?$pair@$$CB_KPEAUIMPCTarget@@@std@@@3@$0A@@std@@@std@@QEAA?AV?$_List_iterator@V?$_List_val@U?$_List_simple_types@U?$pair@$$CB_KPEAUIMPCTarget@@@std@@@std@@@std@@@2@V?$_List_const_iterator@V?$_List_val@U?$_List_simple_types@U?$pair@$$CB_KPEAUIMPCTarget@@@std@@@std@@@std@@@2@@Z @ 0x1800565FC
 * Callers:
 *     _std::_Hash_std::_Umap_traits_unsigned___int64_IMPCTarget___std::_Uhash_compare_unsigned___int64_std::hash_unsigned___int64__std::equal_to_unsigned___int64____std::allocator_std::pair_unsigned___int64_const__IMPCTarget______0___::_Insert_std::pair_unsigned___int64_const__IMPCTarget____&_std::_List_unchecked_iterator_std::_List_val_std::_List_simple_types_std::pair_unsigned___int64_const__IMPCTarget____________::_1_::catch$55 @ 0x1800534EC (_std--_Hash_std--_Umap_traits_unsigned___int64_IMPCTarget___std--_Uhash_compare_uns_ea_1800534EC.c)
        ...
        _QWORD *a3)
{
  ...
  std::list<std::pair<unsigned long const,IRawInputProvider *>>::erase(a1 + 1, a2, a3);
  return a2;
}
