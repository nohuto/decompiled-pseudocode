/*
 * XREFs of ?UnsuppressInputOfType@BamoInputObserverManagerProxy@@UEAAJW4InputObserverType@InputObservation@@PEAVBamoInputObserverClientPrincipal@@@Z @ 0x180063D40
 * Callers:
 *     <none>
 * Callees:
