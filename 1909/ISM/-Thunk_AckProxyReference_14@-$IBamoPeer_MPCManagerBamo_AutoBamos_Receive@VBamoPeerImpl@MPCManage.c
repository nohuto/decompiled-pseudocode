/*
 * XREFs of ?Thunk_AckProxyReference_14@?$IBamoPeer_MPCManagerBamo_AutoBamos_Receive@VBamoPeerImpl@MPCManagerBamo_AutoBamos@BamoImpl@@@@SAJPEAXPEAPEAX@Z @ 0x18007F570
 * Callers:
 *     <none>
 * Callees:
        ...
        unsigned int **a2)
{
  ...
  Microsoft::BamoImpl::BamoPrincipalImpl *v10; // [rsp+40h] [rbp+8h] BYREF
  ...
  if ( v5 != -2018375675 )
  {
    ...
    Stub = (volatile signed __int32 *)Microsoft::BamoImpl::BamoPrincipalImpl::FindStub(v10, *((_DWORD *)a1 + 9));
    if ( !*((_DWORD *)Stub + 4) )
    {
