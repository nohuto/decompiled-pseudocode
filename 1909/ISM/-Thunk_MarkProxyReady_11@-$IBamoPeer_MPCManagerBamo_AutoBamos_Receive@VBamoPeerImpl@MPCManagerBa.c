/*
 * XREFs of ?Thunk_MarkProxyReady_11@?$IBamoPeer_MPCManagerBamo_AutoBamos_Receive@VBamoPeerImpl@MPCManagerBamo_AutoBamos@BamoImpl@@@@SAJPEAXPEAPEAX@Z @ 0x18007F6E0
 * Callers:
 *     <none>
 * Callees:
        ...
        unsigned int **a2)
{
  ...
  *((_BYTE *)Item + 28) = 1;
  ...
  Microsoft::BamoImpl::DropAndReacquireLock::DropAndReacquireLock(
    ...
    *(struct Microsoft::BamoImpl::BaseBamoConnectionImpl **)(*(_QWORD *)(*(_QWORD *)(v4 + 16) + 24LL) + 24LL));
