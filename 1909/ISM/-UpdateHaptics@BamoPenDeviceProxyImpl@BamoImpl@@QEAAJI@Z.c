/*
 * XREFs of ?UpdateHaptics@BamoPenDeviceProxyImpl@BamoImpl@@QEAAJI@Z @ 0x1800641CC
 * Callers:
 *     ?Thunk_UpdateHaptics_0@?$IPenDeviceProxy_Receive@VBamoPenDeviceProxyImpl@BamoImpl@@@@SAJPEAXPEAPEAX@Z @ 0x1800632A0 (-Thunk_UpdateHaptics_0@-$IPenDeviceProxy_Receive@VBamoPenDeviceProxyImpl@BamoImpl@@@@SAJPEAXPEAP.c)
 * Callees:
