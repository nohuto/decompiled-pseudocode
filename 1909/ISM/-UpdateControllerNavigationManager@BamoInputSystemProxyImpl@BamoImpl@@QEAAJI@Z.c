/*
 * XREFs of ?UpdateControllerNavigationManager@BamoInputSystemProxyImpl@BamoImpl@@QEAAJI@Z @ 0x180063E9C
 * Callers:
 *     ?Thunk_UpdateControllerNavigationManager_0@?$IInputSystemProxy_Receive@VBamoInputSystemProxyImpl@BamoImpl@@@@SAJPEAXPEAPEAX@Z @ 0x180062F30 (-Thunk_UpdateControllerNavigationManager_0@-$IInputSystemProxy_Receive@VBamoInputSystemProxyImpl.c)
 * Callees:
