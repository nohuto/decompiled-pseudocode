/*
 * XREFs of ?QueryInterface@BamoMPCConstantManagerClientPrincipal@@UEAAJAEBU_GUID@@PEAPEAX@Z @ 0x18008A4D0
 * Callers:
 *     ?QueryInterface@BamoMPCConstantManagerClientPrincipal@@W7EAAJAEBU_GUID@@PEAPEAX@Z @ 0x180038130 (-QueryInterface@BamoMPCConstantManagerClientPrincipal@@W7EAAJAEBU_GUID@@PEAPEAX@Z.c)
 * Callees:
