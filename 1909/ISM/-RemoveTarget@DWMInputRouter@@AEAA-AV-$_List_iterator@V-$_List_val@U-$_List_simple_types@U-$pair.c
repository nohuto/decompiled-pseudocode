/*
 * XREFs of ?RemoveTarget@DWMInputRouter@@AEAA?AV?$_List_iterator@V?$_List_val@U?$_List_simple_types@U?$pair@$$CBUtagMsgRoutingInfo@@PEAUIInputTarget@@@std@@@std@@@std@@@std@@V23@@Z @ 0x1800C4DB0
 * Callers:
 ...
 *     ?NotifyProxyDisposed@DWMInputRouter@@UEAAJII@Z @ 0x1800C48A0 (-NotifyProxyDisposed@DWMInputRouter@@UEAAJII@Z.c)
