/*
 * XREFs of ?Create@ViewHierarchy@@SA?AV?$ComPtr@UIViewHierarchy@@@WRL@Microsoft@@XZ @ 0x180027F6C
 * Callers:
 *     ?GetViewHierarchy@ISMStatics@@SAPEAUIViewHierarchy@@XZ @ 0x18000DFD4 (-GetViewHierarchy@ISMStatics@@SAPEAUIViewHierarchy@@XZ.c)
 * Callees:
 *     ??$MakeAndInitialize@VViewHierarchy@@UIViewHierarchy@@W4TestMode@1@@Details@WRL@Microsoft@@YAJPEAPEAUIViewHierarchy@@$$QEAW4TestMode@ViewHierarchy@@@Z @ 0x180027FB8 (--$MakeAndInitialize@VViewHierarchy@@UIViewHierarchy@@W4TestMode@1@@Details@WRL@Microsoft@@YAJPE.c)
