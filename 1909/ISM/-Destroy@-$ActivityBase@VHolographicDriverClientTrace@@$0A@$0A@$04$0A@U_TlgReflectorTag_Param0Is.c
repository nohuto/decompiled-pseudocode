/*
 * XREFs of ?Destroy@?$ActivityBase@VHolographicDriverClientTrace@@$0A@$0A@$04$0A@U_TlgReflectorTag_Param0IsProviderType@@@wil@@IEAAXXZ @ 0x180154AB0
 * Callers:
 *     ??1OpenHolographicDevice@HolographicDriverClientTrace@@QEAA@XZ @ 0x180151CAC (--1OpenHolographicDevice@HolographicDriverClientTrace@@QEAA@XZ.c)
