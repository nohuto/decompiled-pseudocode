/*
 * XREFs of ??$MakeAndInitialize@VViewHierarchy@@UIViewHierarchy@@W4TestMode@1@@Details@WRL@Microsoft@@YAJPEAPEAUIViewHierarchy@@$$QEAW4TestMode@ViewHierarchy@@@Z @ 0x180027FB8
 * Callers:
