/*
 * XREFs of ?GetDevicePropertyOfKnownSize@SpatialGraphDriverClient@Holographic@Internal@Windows@@AEAAJAEBU_GUID@@PEAX_KP6AJPEBX_K@ZW4PropertyCacheBehavior@234@@Z @ 0x1801556E8
 * Callers:
 ...
 *     ??$DevicePropertyCacheMiss@W4TraceDriverType@@AEBU_GUID@@AEBU2@AEB_N@HolographicDriverClientTrace@@SAX$$QEAW4TraceDriverType@@AEBU_GUID@@1AEB_N@Z @ 0x18014A038 (--$DevicePropertyCacheMiss@W4TraceDriverType@@AEBU_GUID@@AEBU2@AEB_N@HolographicDriverClientTrac.c)
        ...
        char a6)
{
  ...
  v13 = *v8;
  v14 = *(Windows::Internal::Holographic::HolographicDriverHandleWrapper **)(a1 + 104);
  if ( *(_BYTE *)(a1 + 121) )
  {
    v21 = 0LL;
