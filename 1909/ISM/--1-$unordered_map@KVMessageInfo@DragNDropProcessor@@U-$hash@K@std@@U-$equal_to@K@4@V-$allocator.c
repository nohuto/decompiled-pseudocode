/*
 * XREFs of ??1?$unordered_map@KVMessageInfo@DragNDropProcessor@@U?$hash@K@std@@U?$equal_to@K@4@V?$allocator@U?$pair@$$CBKVMessageInfo@DragNDropProcessor@@@std@@@4@@std@@QEAA@XZ @ 0x18006A4C0
 * Callers:
 *     _DragNDropProcessor::DragNDropProcessor_::_1_::dtor$4 @ 0x18006A396 (_DragNDropProcessor--DragNDropProcessor_--_1_--dtor$4.c)
 * Callees:
