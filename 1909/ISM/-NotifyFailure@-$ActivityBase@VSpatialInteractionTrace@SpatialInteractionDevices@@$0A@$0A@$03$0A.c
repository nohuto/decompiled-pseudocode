/*
 * XREFs of ?NotifyFailure@?$ActivityBase@VSpatialInteractionTrace@SpatialInteractionDevices@@$0A@$0A@$03$0A@U_TlgReflectorTag_Param0IsProviderType@@@wil@@UEAA_NAEBUFailureInfo@2@@Z @ 0x1800E2D90
 * Callers:
 *     <none>
 * Callees:
        ...
        int *a2)
{
  ...
  if ( *(_DWORD *)wil::details::static_lazy<SpatialInteractionDevices::SpatialInteractionTrace>::get(
                    a1,
                    (void (__cdecl *)())lambda_169e34f0547c812b04d058e5b6da2245_::_lambda_invoker_cdecl_)[1] > 2u )
  {
    ...
    v68 = v21;
    TlgCreateSz(&v70, v20);
    TlgWrite(v22, &unk_18019E84C, (LPCGUID)(*(_QWORD *)(a1 + 48) + 8LL), 0LL, 0x14u, &pData);
  }
