/*
 * XREFs of ?NotifyCurrentGamepadReading@WGIController@@AEAAJ_N@Z @ 0x1800AA2A0
 * Callers:
 *     ?OnInputReceived@WGIController@@UEAAJ_KEIPEBE@Z @ 0x1800AB1B0 (-OnInputReceived@WGIController@@UEAAJ_KEIPEBE@Z.c)
 *     ?OnInputReportReceived@WGIController@@UEAAJ_KEIPEBE@Z @ 0x1800AB1D0 (-OnInputReportReceived@WGIController@@UEAAJ_KEIPEBE@Z.c)
 *     ?OnInputSuspended@WGIController@@UEAAJ_K@Z @ 0x1800AB1F0 (-OnInputSuspended@WGIController@@UEAAJ_K@Z.c)
