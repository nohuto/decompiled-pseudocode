/*
 * XREFs of ?SetDockRoutingPolicy@BamoPenEventsDispatcherPrincipalImpl@BamoImpl@@QEAAJW4RoutingPolicy@Input@Devices@Internal@Windows@@@Z @ 0x180032CC8
 * Callers:
 *     ?Thunk_SetDockRoutingPolicy_3@?$IPenEventsDispatcherPrincipal_Receive@VBamoPenEventsDispatcherPrincipalImpl@BamoImpl@@@@SAJPEAXPEAPEAX@Z @ 0x180033340 (-Thunk_SetDockRoutingPolicy_3@-$IPenEventsDispatcherPrincipal_Receive@VBamoPenEventsDispatcherPr.c)
 * Callees:
