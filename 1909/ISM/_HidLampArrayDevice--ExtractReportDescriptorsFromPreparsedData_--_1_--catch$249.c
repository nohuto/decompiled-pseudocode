/*
 * XREFs of _HidLampArrayDevice::ExtractReportDescriptorsFromPreparsedData_::_1_::catch$249 @ 0x1800B3CA7
 * Callers:
 *     <none>
 * Callees:
...
void *__fastcall HidLampArrayDevice::ExtractReportDescriptorsFromPreparsedData_::_1_::catch_249(
        __int64 a1,
        __int64 a2,
        __int64 a3,
        const char *a4)
