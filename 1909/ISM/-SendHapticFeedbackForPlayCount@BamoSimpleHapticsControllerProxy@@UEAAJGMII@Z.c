/*
 * XREFs of ?SendHapticFeedbackForPlayCount@BamoSimpleHapticsControllerProxy@@UEAAJGMII@Z @ 0x180062560
 * Callers:
 *     <none>
 * Callees:
        ...
        unsigned int a5)
{
  ...
  LODWORD(v6) = BamoImpl::BamoSimpleHapticsControllerProxyImpl::SendHapticFeedbackForPlayCount(
