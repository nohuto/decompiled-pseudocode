/*
 * XREFs of ?CreateInputProcessorWorker@@YAJPEAUInputProcessorCreateParams@@PEAPEAUIInputProcessor@@W4InputType@@H@Z @ 0x180019478
 * Callers:
...
__int64 __fastcall CreateInputProcessorWorker(_QWORD *a1, __int64 a2, int a3, unsigned int a4)
{
  ...
  if ( a4 < 0x12 )
  {
    v9 = (char *)&unk_1801DE010 + 48 * (int)a4;
    do
    {
