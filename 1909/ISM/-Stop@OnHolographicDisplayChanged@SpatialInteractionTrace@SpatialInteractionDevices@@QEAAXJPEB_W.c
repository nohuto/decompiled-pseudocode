/*
 * XREFs of ?Stop@OnHolographicDisplayChanged@SpatialInteractionTrace@SpatialInteractionDevices@@QEAAXJPEB_W_N1@Z @ 0x1800E5084
 * Callers:
        ...
        bool a5)
{
  ...
  if ( v10 )
  {
    if ( *(_DWORD *)v12[1] > 4u )
    {
      ...
      v71 = 4LL;
      v70 = &v72;
      TlgWrite(v21, &unk_18019E272, (LPCGUID)(*((_QWORD *)this + 6) + 8LL), 0LL, 0x19u, &pData);
    }
  }
  else
  {
    ...
    if ( *(_DWORD *)v22 > 4u )
    {
      ...
      *(_QWORD *)&v45.Size = 1LL;
      v47 = 4LL;
      TlgWrite(v22, &unk_18019E7C2, (LPCGUID)(*((_QWORD *)this + 6) + 8LL), 0LL, 9u, &pData);
    }
  }
  if ( *((_DWORD *)this + 8) )
