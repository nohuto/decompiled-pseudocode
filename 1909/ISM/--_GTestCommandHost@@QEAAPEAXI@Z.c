/*
 * XREFs of ??_GTestCommandHost@@QEAAPEAXI@Z @ 0x1800D34B4
 * Callers:
 *     ?Initialize@InputStateManager@@IEAAJXZ @ 0x18001042C (-Initialize@InputStateManager@@IEAAJXZ.c)
 *     ??1?$unique_ptr@VTestCommandHost@@U?$default_delete@VTestCommandHost@@@std@@@std@@QEAA@XZ @ 0x18002B180 (--1-$unique_ptr@VTestCommandHost@@U-$default_delete@VTestCommandHost@@@std@@@std@@QEAA@XZ.c)
 * Callees:
