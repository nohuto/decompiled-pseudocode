/*
 * XREFs of ?CreateAndInitialize@HidLampMultiUpdateReportBuilder@@SAJPEAVHidLampArrayDevice@@IPEAPEAV1@@Z @ 0x1800B664C
 * Callers:
 ...
 *     ??0HidLampMultiUpdateReportBuilder@@AEAA@XZ @ 0x1800B64CC (--0HidLampMultiUpdateReportBuilder@@AEAA@XZ.c)
