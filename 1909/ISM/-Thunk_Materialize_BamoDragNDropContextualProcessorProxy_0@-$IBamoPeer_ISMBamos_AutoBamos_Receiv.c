/*
 * XREFs of ?Thunk_Materialize_BamoDragNDropContextualProcessorProxy_0@?$IBamoPeer_ISMBamos_AutoBamos_Receive@VBamoPeerImpl@ISMBamos_AutoBamos@BamoImpl@@@@SAJPEAXPEAPEAX@Z @ 0x180062A80
 * Callers:
 *     <none>
 * Callees:
