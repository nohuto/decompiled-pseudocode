/*
 * XREFs of ?QueryInterface@DragNDropProcessor@@UEAAJAEBU_GUID@@PEAPEAX@Z @ 0x18006C720
 * Callers:
 *     ?QueryInterface@DragNDropProcessor@@W7EAAJAEBU_GUID@@PEAPEAX@Z @ 0x180037F40 (-QueryInterface@DragNDropProcessor@@W7EAAJAEBU_GUID@@PEAPEAX@Z.c)
 * Callees:
