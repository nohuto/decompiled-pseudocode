/*
 * XREFs of ??$SE3_exp@M@ST@@YAXAEAU?$SE3@M@0@QEBM@Z @ 0x180169BF4
 * Callers:
 ...
 * Callees:
 *     ??$SO3_build_exp_matrix@M@ST@@YAXQEAMQEBMMM@Z @ 0x18016A488 (--$SO3_build_exp_matrix@M@ST@@YAXQEAMQEBMMM@Z.c)
