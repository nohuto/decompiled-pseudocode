/*
 * XREFs of ?AddHandleOpenCloseCallbacks@HolographicDriverHandleWrapper@Holographic@Internal@Windows@@QEAAXPEBV?$function@$$A6AXXZ@std@@0@Z @ 0x180152FEC
 * Callers:
 ...
 * Callees:
 *     ??$_Emplace_reallocate@AEBQEBV?$function@$$A6AXXZ@std@@@?$vector@PEBV?$function@$$A6AXXZ@std@@V?$allocator@PEBV?$function@$$A6AXXZ@std@@@2@@std@@QEAAPEAPEBV?$function@$$A6AXXZ@1@QEAPEBV21@AEBQEBV21@@Z @ 0x18014C048 (--$_Emplace_reallocate@AEBQEBV-$function@$$A6AXXZ@std@@@-$vector@PEBV-$function@$$A6AXXZ@std@@V-.c)
 */
