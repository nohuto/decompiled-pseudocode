/*
 * XREFs of ??$_Emplace_reallocate@AEBUSPATIAL_NODE_ID@@@?$vector@USPATIAL_NODE_ID@@V?$allocator@USPATIAL_NODE_ID@@@std@@@std@@QEAAPEAUSPATIAL_NODE_ID@@QEAU2@AEBU2@@Z @ 0x18014C198
 * Callers:
