/*
 * XREFs of ?DragInactive@TwoFingerDragRecognizer@@AEAAJPEBVGestureSession@@_KKKPEBUTouchContactInfo@@@Z @ 0x18010D1C8
 * Callers:
        ...
        const struct TouchContactInfo *a6)
{
  ...
  if ( (a3 & 1) != 0 )
  {
    if ( a5 <= 2 )
    {
      ...
      {
        v13 = *((_WORD *)this + 8);
        if ( TwoFingerDragRecognizer::ContactsAreValid(this, a5, a6) )
        {
          *((_WORD *)this + 8) = v13 | 4;
          LODWORD(v16) = (*((_DWORD *)a6 + 1) + *((_DWORD *)a6 + 11)) / 2;
          v14 = *((_DWORD *)a6 + 2) + *((_DWORD *)a6 + 12);
          *((_DWORD *)this + 5) = 2;
          HIDWORD(v16) = v14 / 2;
          *(_QWORD *)((char *)this + 68) = v16;
