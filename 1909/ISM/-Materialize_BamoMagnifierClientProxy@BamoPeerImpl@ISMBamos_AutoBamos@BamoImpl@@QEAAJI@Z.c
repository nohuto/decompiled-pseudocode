/*
 * XREFs of ?Materialize_BamoMagnifierClientProxy@BamoPeerImpl@ISMBamos_AutoBamos@BamoImpl@@QEAAJI@Z @ 0x18005EAF8
 * Callers:
 *     ?Thunk_Materialize_BamoMagnifierClientProxy_0@?$IBamoPeer_ISMBamos_AutoBamos_Receive@VBamoPeerImpl@ISMBamos_AutoBamos@BamoImpl@@@@SAJPEAXPEAPEAX@Z @ 0x180062BA0 (-Thunk_Materialize_BamoMagnifierClientProxy_0@-$IBamoPeer_ISMBamos_AutoBamos_Receive@VBamoPeerIm.c)
 * Callees:
        ...
        struct Microsoft::Bamo::BamoProxy **a4)
{
  ...
  BamoImpl::CreateMagnifierClientProxy(
