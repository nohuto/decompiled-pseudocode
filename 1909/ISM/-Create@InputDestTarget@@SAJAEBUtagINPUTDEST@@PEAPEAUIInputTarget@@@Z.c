/*
 * XREFs of ?Create@InputDestTarget@@SAJAEBUtagINPUTDEST@@PEAPEAUIInputTarget@@@Z @ 0x1800C78A0
 * Callers:
 ...
 *     ??0InputDestTarget@@QEAA@AEBUtagINPUTDEST@@@Z @ 0x1800C77D4 (--0InputDestTarget@@QEAA@AEBUtagINPUTDEST@@@Z.c)
 */
