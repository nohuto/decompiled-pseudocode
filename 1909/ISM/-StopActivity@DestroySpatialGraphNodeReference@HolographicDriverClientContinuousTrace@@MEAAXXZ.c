/*
 * XREFs of ?StopActivity@DestroySpatialGraphNodeReference@HolographicDriverClientContinuousTrace@@MEAAXXZ @ 0x18015EF80
 * Callers:
 *     <none>
 * Callees:
        ...
        HolographicDriverClientContinuousTrace::DestroySpatialGraphNodeReference *this)
{
  ...
  if ( v4 )
  {
    if ( **(_DWORD **)(v6 + 8) > 5u )
    {
      ...
      v62 = 4LL;
      TlgCreateSz(&v63, v14);
      TlgWrite(v15, &unk_1801A25DC, (LPCGUID)(*((_QWORD *)this + 6) + 8LL), 0LL, 0x15u, &pData);
    }
  }
  else
  {
    ...
    if ( *(_DWORD *)v16 > 5u )
    {
      ...
      v19 = CurrentThreadId;
      v32 = &v19;
      TlgWrite(v16, &unk_1801A2525, (LPCGUID)(*((_QWORD *)this + 6) + 8LL), 0LL, 5u, &v27);
    }
  }
  if ( *((_DWORD *)this + 8) )
