/*
 * XREFs of ?Undocked@BamoPenEventsClientProxyImpl@BamoImpl@@QEAAJXZ @ 0x1800336F0
 * Callers:
...
__int64 __fastcall BamoImpl::BamoPenEventsClientProxyImpl::Undocked(BamoImpl::BamoPenEventsClientProxyImpl *this)
{
  int v1; // ebx
  __int64 v2; // rdx
