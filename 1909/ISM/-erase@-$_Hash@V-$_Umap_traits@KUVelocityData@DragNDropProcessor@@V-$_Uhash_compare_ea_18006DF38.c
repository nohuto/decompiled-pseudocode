/*
 * XREFs of ?erase@?$_Hash@V?$_Umap_traits@KUVelocityData@DragNDropProcessor@@V?$_Uhash_compare@KU?$hash@K@std@@U?$equal_to@K@2@@std@@V?$allocator@U?$pair@$$CBKUVelocityData@DragNDropProcessor@@@std@@@4@$0A@@std@@@std@@QEAA_KAEBK@Z @ 0x18006DF38
 * Callers:
        ...
        unsigned __int8 *a2)
{
  ...
  {
    std::list<std::pair<unsigned long const,DragNDropProcessor::VelocityData>>::clear((__int64)(a1 + 1));
