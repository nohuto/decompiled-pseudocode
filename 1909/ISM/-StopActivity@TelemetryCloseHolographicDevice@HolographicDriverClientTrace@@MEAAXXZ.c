/*
 * XREFs of ?StopActivity@TelemetryCloseHolographicDevice@HolographicDriverClientTrace@@MEAAXXZ @ 0x18015F520
 * Callers:
 *     <none>
 * Callees:
        ...
        HolographicDriverClientTrace::TelemetryCloseHolographicDevice *this)
{
  ...
  if ( v4 )
  {
    if ( **(_DWORD **)(v6 + 8) > 5u && TlgKeywordOn(*(TraceLoggingHProvider *)(v6 + 8), 0x400000000000uLL) )
    {
      ...
      TlgWrite(v13, &unk_1801A3169, (LPCGUID)(*((_QWORD *)this + 6) + 8LL), 0LL, 0x12u, &pData);
    }
  }
  else
  {
    ...
    if ( *(_DWORD *)v14 > 5u && TlgKeywordOn(*(TraceLoggingHProvider *)(v6 + 8), 0x400000000000uLL) )
    {
      ...
      v17 = CurrentThreadId;
      v28 = &v17;
      TlgWrite(v14, &unk_1801A422D, (LPCGUID)(*((_QWORD *)this + 6) + 8LL), 0LL, 5u, &v23);
    }
  }
  if ( *((_DWORD *)this + 8) )
