/*
 * XREFs of ??$As@UIActivationListenerInputObjectProxy@@@?$ComPtr@UIUnknown@@@WRL@Microsoft@@QEBAJV?$ComPtrRef@V?$ComPtr@UIActivationListenerInputObjectProxy@@@WRL@Microsoft@@@Details@12@@Z @ 0x18000DE28
 * Callers:
