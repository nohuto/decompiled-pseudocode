/*
 * XREFs of ?UpdateClientOwner@Cursor@InputTraceLogging@@SAXUCursorId@@@Z @ 0x180144C9C
 * Callers:
 *     ?UpdateClientOwner@DWMCursor@@UEAAJXZ @ 0x180144D40 (-UpdateClientOwner@DWMCursor@@UEAAJXZ.c)
 * Callees:
...
char __fastcall InputTraceLogging::Cursor::UpdateClientOwner(__int64 a1)
{
  ...
  if ( *(_DWORD *)v3 > 4u )
  {
    ...
    if ( (_BYTE)v2 )
    {
      ...
      v10 = cData;
      v13 = v4;
      LOBYTE(v2) = TlgWrite(v5, &unk_1801A1997, 0LL, 0LL, cData, &pData);
    }
  }
  return (char)v2;
}
