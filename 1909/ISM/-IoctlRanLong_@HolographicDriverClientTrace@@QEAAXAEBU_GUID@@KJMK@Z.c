/*
 * XREFs of ?IoctlRanLong_@HolographicDriverClientTrace@@QEAAXAEBU_GUID@@KJMK@Z @ 0x180159638
 * Callers:
 *     ??$IoctlRanLong@AEBU_GUID@@AEAKJAEAMAEBK@HolographicDriverClientTrace@@SAXAEBU_GUID@@AEAK$$QEAJAEAMAEBK@Z @ 0x18014ABB4 (--$IoctlRanLong@AEBU_GUID@@AEAKJAEAMAEBK@HolographicDriverClientTrace@@SAXAEBU_GUID@@AEAK$$QEAJA.c)
 * Callees:
        ...
        char a6)
{
  ...
  if ( *(_DWORD *)v8 > 3u )
  {
    if ( TlgKeywordOn(v8, 0x200000000000uLL) )
    {
      ...
      v11 = 0x1000000LL;
      v24 = 8LL;
      TlgWrite(v9, &unk_1801A3CF1, 0LL, 0LL, 8u, &pData);
    }
  }
}
