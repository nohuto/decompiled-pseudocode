/*
 * XREFs of ?CreateSpatialPayloadDescriptor@SpatialObjectDDIClientFactoryHelper@Holographic@Internal@Windows@@UEAAJPEBX_KPEAPEAUISpatialPayloadDescriptor@234@@Z @ 0x1800EC140
 * Callers:
 *     <none>
 * Callees:
