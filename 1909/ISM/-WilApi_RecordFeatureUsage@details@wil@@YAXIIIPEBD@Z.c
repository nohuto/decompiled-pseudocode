/*
 * XREFs of ?WilApi_RecordFeatureUsage@details@wil@@YAXIIIPEBD@Z @ 0x180052368
 * Callers:
 ...
 *     ?RecordSRUMFeatureUsage@details@wil@@YAXIII@Z @ 0x180050940 (-RecordSRUMFeatureUsage@details@wil@@YAXIII@Z.c)
 * Callees:
