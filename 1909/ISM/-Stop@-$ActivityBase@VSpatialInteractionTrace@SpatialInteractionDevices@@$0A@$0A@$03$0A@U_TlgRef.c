/*
 * XREFs of ?Stop@?$ActivityBase@VSpatialInteractionTrace@SpatialInteractionDevices@@$0A@$0A@$03$0A@U_TlgReflectorTag_Param0IsProviderType@@@wil@@QEAAXJ@Z @ 0x1800E4ED0
 * Callers:
        ...
        int a2)
{
  ...
  else
  {
    ...
    if ( *(_DWORD *)v7 > 5u )
    {
      ...
      v19 = (int *)&v9;
      v20 = 4;
      TlgWrite(v7, &unk_18019E769, (LPCGUID)(*(_QWORD *)(a1 + 48) + 8LL), 0LL, 5u, &pData);
    }
  }
  if ( *(_DWORD *)(a1 + 32) )
