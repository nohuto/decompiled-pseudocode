/*
 * XREFs of ?UpdateTestCommands@BamoInputSystemProxyImpl@BamoImpl@@QEAAJI@Z @ 0x180064CA4
 * Callers:
 *     ?Thunk_UpdateTestCommands_0@?$IInputSystemProxy_Receive@VBamoInputSystemProxyImpl@BamoImpl@@@@SAJPEAXPEAPEAX@Z @ 0x180063900 (-Thunk_UpdateTestCommands_0@-$IInputSystemProxy_Receive@VBamoInputSystemProxyImpl@BamoImpl@@@@SA.c)
 * Callees:
