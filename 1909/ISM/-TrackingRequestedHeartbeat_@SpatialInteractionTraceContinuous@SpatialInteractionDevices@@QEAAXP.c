/*
 * XREFs of ?TrackingRequestedHeartbeat_@SpatialInteractionTraceContinuous@SpatialInteractionDevices@@QEAAXPEB_WKKI_N10AEBU_GUID@@IAEAY02$$CBMAEAY03$$CBM34@Z @ 0x1800E5BC4
 * Callers:
        ...
        const float (*a14)[4])
{
  ...
  if ( **(_DWORD **)(v21 + 8) > 5u && TlgKeywordOn(*(TraceLoggingHProvider *)(v21 + 8), 2uLL) )
  {
    ...
    TlgWrite(v22, &unk_18019E639, 0LL, 0LL, 0xDu, &pData);
  }
  _o_setlocale(4LL);
}
