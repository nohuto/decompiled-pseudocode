/*
 * XREFs of ??$As@UIDragAreaClientProxy@@@?$ComPtr@UIUnknown@@@WRL@Microsoft@@QEBAJV?$ComPtrRef@V?$ComPtr@UIDragAreaClientProxy@@@WRL@Microsoft@@@Details@12@@Z @ 0x1800666D4
 * Callers:
        ...
        __int64 *a2)
{
  ...
  return v4(v2, &GUID_e718b12a_faef_306d_9346_9fccb7899886, a2);
}
