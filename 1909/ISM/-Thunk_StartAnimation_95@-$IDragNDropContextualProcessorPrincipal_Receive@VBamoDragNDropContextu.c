/*
 * XREFs of ?Thunk_StartAnimation_95@?$IDragNDropContextualProcessorPrincipal_Receive@VBamoDragNDropContextualProcessorPrincipalImpl@BamoImpl@@@@SAJPEAXPEAPEAX@Z @ 0x180069190
 * Callers:
 *     <none>
 * Callees:
 *     <none>
