/*
 * XREFs of ?OnPointerInputDown@DWMInputRouter@@IEAAXIKW4InputType@@PEAUHMONITOR__@@UtagPOINT@@@Z @ 0x1800C49D0
 * Callers:
 ...
 *     std::_Func_impl_no_alloc__lambda_61c4b1ef6c1727f04a15d7ac99fb15e3__void__MIT_POINTER_INPUT_DOWN_MESSAGE_const___::_Do_call @ 0x1800C56F0 (std--_Func_impl_no_alloc__lambda_61c4b1ef6c1727f04a15d7ac99fb15e3__void__MIT_POINTE_ea_1800C56F0.c)
 * Callees:
