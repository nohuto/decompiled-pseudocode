/*
 * XREFs of ?Thunk_UpdateEndpointId_45@?$IUIAHitTestInputObjectProxy_Receive@VBamoUIAHitTestInputObjectProxyImpl@BamoImpl@@@@SAJPEAXPEAPEAX@Z @ 0x1800630A0
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall IUIAHitTestInputObjectProxy_Receive<BamoImpl::BamoUIAHitTestInputObjectProxyImpl>::Thunk_UpdateEndpointId_45(
        __int64 a1,
        _OWORD **a2)
{
  int v3; // eax
