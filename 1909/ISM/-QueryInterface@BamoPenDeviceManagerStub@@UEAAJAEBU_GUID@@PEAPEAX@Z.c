/*
 * XREFs of ?QueryInterface@BamoPenDeviceManagerStub@@UEAAJAEBU_GUID@@PEAPEAX@Z @ 0x180128810
 * Callers:
 *     ?QueryInterface@BamoPenDeviceManagerStub@@W7EAAJAEBU_GUID@@PEAPEAX@Z @ 0x180039CB0 (-QueryInterface@BamoPenDeviceManagerStub@@W7EAAJAEBU_GUID@@PEAPEAX@Z.c)
 * Callees:
