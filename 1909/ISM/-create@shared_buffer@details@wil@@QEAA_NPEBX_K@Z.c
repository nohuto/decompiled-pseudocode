/*
 * XREFs of ?create@shared_buffer@details@wil@@QEAA_NPEBX_K@Z @ 0x18005276C
 * Callers:
 ...
 *     ?assign@shared_buffer@details@wil@@AEAAXPEAJ_K@Z @ 0x1800526C4 (-assign@shared_buffer@details@wil@@AEAAXPEAJ_K@Z.c)
