/*
 * XREFs of ?QueryInterface@RawButtonProcessor@@UEAAJAEBU_GUID@@PEAPEAX@Z @ 0x180109180
 * Callers:
 *     ?QueryInterface@RawButtonProcessor@@W7EAAJAEBU_GUID@@PEAPEAX@Z @ 0x180039140 (-QueryInterface@RawButtonProcessor@@W7EAAJAEBU_GUID@@PEAPEAX@Z.c)
 * Callees:
