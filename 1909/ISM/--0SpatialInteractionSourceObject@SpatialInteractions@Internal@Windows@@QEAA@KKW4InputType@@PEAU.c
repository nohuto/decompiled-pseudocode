/*
 * XREFs of ??0SpatialInteractionSourceObject@SpatialInteractions@Internal@Windows@@QEAA@KKW4InputType@@PEAUISpatialObjectDevice@Holographic@23@PEAUISpatialObject@623@@Z @ 0x1800EA6D4
 * Callers:
