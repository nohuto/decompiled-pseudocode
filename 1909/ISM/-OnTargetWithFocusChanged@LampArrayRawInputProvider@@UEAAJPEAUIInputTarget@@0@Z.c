/*
 * XREFs of ?OnTargetWithFocusChanged@LampArrayRawInputProvider@@UEAAJPEAUIInputTarget@@0@Z @ 0x18000C600
 * Callers:
 *     <none>
 * Callees:
...
LABEL_7:
  ...
  if ( hProvider > 5u )
  {
    ...
    v26 = &v19;
    v27 = 4LL;
    TlgWrite((TraceLoggingHProvider)&hProvider, &unk_18019D0FB, 0LL, 0LL, 5u, &pData);
    v4 = v16;
  }
