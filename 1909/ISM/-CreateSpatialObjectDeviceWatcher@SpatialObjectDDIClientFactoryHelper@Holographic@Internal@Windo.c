/*
 * XREFs of ?CreateSpatialObjectDeviceWatcher@SpatialObjectDDIClientFactoryHelper@Holographic@Internal@Windows@@UEAAJAEBU_GUID@@PEAUISpatialObjectDeviceWatcherCallback@234@PEAPEAUISpatialObjectDeviceWatcher@234@@Z @ 0x1800EC0D0
 * Callers:
 *     <none>
 * Callees:
