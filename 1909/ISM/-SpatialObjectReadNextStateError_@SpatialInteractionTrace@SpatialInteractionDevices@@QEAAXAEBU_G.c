/*
 * XREFs of ?SpatialObjectReadNextStateError_@SpatialInteractionTrace@SpatialInteractionDevices@@QEAAXAEBU_GUID@@J_J@Z @ 0x1800F17D0
 * Callers:
        ...
        __int64 a4)
{
  ...
  if ( *(_DWORD *)v5 > 4u )
  {
    if ( TlgKeywordOn(v5, 2uLL) )
    {
      ...
      v11 = 8LL;
      v13 = 4LL;
      TlgWrite(v6, &unk_18019FB61, 0LL, 0LL, 5u, &pData);
    }
  }
}
