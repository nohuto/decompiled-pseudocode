/*
 * XREFs of ?Thunk_OnUnregisterError_5@?$IDataProviderRegistrarProxy_Receive@VBamoDataProviderRegistrarProxyImpl@BamoImpl@@@@SAJPEAXPEAPEAX@Z @ 0x1800D1C30
 * Callers:
 *     <none>
 * Callees:
        ...
        unsigned int **a2)
{
  ...
  v4 = (*(__int64 (__fastcall **)(__int64, _QWORD))(*(_QWORD *)(a1 - 16) + 64LL))(a1 - 16, v3);
  v5 = v7;
  if ( v7 )
  {
