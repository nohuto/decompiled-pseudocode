/*
 * XREFs of ?Thunk_UpdateResumePosition_9@?$IControllerNavigationOverrideProxy_Receive@VBamoControllerNavigationOverrideProxyImpl@BamoImpl@@@@SAJPEAXPEAPEAX@Z @ 0x1800716D0
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall IControllerNavigationOverrideProxy_Receive<BamoImpl::BamoControllerNavigationOverrideProxyImpl>::Thunk_UpdateResumePosition_9(
        __int64 a1,
        _QWORD **a2)
{
  int v3; // eax
