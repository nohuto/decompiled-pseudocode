/*
 * XREFs of ?SetAllConstantsForInputTypeToDefault@BamoMPCConstantManagerClientPrincipalImpl@BamoImpl@@QEAAJW4InputType@@I@Z @ 0x18008A720
 * Callers:
 *     ?Thunk_SetAllConstantsForInputTypeToDefault_21@?$IMPCConstantManagerClientPrincipal_Receive@VBamoMPCConstantManagerClientPrincipalImpl@BamoImpl@@@@SAJPEAXPEAPEAX@Z @ 0x18008AED0 (-Thunk_SetAllConstantsForInputTypeToDefault_21@-$IMPCConstantManagerClientPrincipal_Receive@VBam.c)
 * Callees:
