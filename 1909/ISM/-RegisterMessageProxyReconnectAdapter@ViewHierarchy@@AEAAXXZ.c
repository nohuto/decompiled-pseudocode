/*
 * XREFs of ?RegisterMessageProxyReconnectAdapter@ViewHierarchy@@AEAAXXZ @ 0x180010B18
 * Callers:
 *     ?RegisterMessageProxyReconnectAdapterStatic@ViewHierarchy@@CAJPEAX@Z @ 0x180010B00 (-RegisterMessageProxyReconnectAdapterStatic@ViewHierarchy@@CAJPEAX@Z.c)
