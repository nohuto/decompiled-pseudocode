/*
 * XREFs of ?GetForCurrentThread@MPCManagerClientFactory@@UEAAJPEAPEAUIMPCManagerClient@MPCManager@Input@Internal@Windows@@@Z @ 0x180111120
 * Callers:
 *     <none>
 * Callees:
        ...
        struct Windows::Internal::Input::MPCManager::IMPCManagerClient **a2)
{
  ...
  v15[1] = (__int64 (__fastcall ***)(_QWORD, GUID *, __int64 *))-2LL;
