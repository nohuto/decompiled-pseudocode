/*
 * XREFs of ?TryCreateAndInitialize@HidLampAttributesRequestReportParser@@SAJPEBUParsedHidReportDescriptor@@PEAPEAV1@@Z @ 0x1800B72E8
 * Callers:
  ...
  *a2 = 0LL;
  ...
  if ( v5 )
  {
    ...
    v10 = (unsigned int)(*(_DWORD *)(*((_QWORD *)a1 + 2) + 72LL * (unsigned int)(*((_DWORD *)a1 + 2) - 1) + 4)
                       ...
                       + 7) >> 3;
    *((_DWORD *)v5 + 5) = v10;
    if ( v5[17] == 2 && HidChannelValueInfo::IsValid((HidChannelValueInfo *)(v5 + 24), v10, 0x7FFFFFFFLL) )
    {
      v6 = 0LL;
