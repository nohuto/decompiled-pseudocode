        ...
        _BYTE *a3)
{
  ...
  __int64 v9; // r8
  __int64 v10; // rbx
  Windows::Internal::Holographic::SpatialGraphDriverClient *v12; // [rsp+28h] [rbp-10h]
  ...
  *a1 = 0LL;
  ...
  if ( v6 )
  {
    ...
    LOBYTE(v9) = *a3;
    v10 = (__int64)v13;
    v7 = Windows::Internal::Holographic::SpatialGraphDriverClient::RuntimeClassInitialize(v13, *a2, v9, 0LL, -2LL, v12);
    if ( v7 >= 0 )
