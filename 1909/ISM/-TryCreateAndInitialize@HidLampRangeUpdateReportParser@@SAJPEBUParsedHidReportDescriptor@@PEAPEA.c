/*
 * XREFs of ?TryCreateAndInitialize@HidLampRangeUpdateReportParser@@SAJPEBUParsedHidReportDescriptor@@PEAPEAV1@@Z @ 0x1800B9234
 * Callers:
 ...
 *     ??0HidLampRangeUpdateReportParser@@AEAA@XZ @ 0x1800B8D9C (--0HidLampRangeUpdateReportParser@@AEAA@XZ.c)
