/*
 * XREFs of ?GetCachedFeatureEnabledState@?$Feature@U__WilFeatureTraits_Feature_PenIdentity@@@wil@@CA?AW4wil_details_CachedFeatureEnabledState@@_N@Z @ 0x18001D738
 * Callers:
 ...
 *     ?GetCurrentFeatureEnabledState@?$Feature@U__WilFeatureTraits_Feature_PenIdentity@@@wil@@CA?AW4wil_details_CachedFeatureEnabledState@@_NPEAW4wil_details_CachedHasNotificationState@@PEAH@Z @ 0x18001E310 (-GetCurrentFeatureEnabledState@-$Feature@U__WilFeatureTraits_Feature_PenIdentity@@@wil@@CA-AW4wi.c)
...
__int64 __fastcall wil::Feature<__WilFeatureTraits_Feature_PenIdentity>::GetCachedFeatureEnabledState(__int64 a1)
{
  unsigned int v1; // ebx
  char v2; // si
  ...
  LOBYTE(v8) = a1;
  v1 = `wil::Feature<__WilFeatureTraits_Feature_PenIdentity>::GetFeaturePropertyCache'::`2'::data & 3;
  if ( (`wil::Feature<__WilFeatureTraits_Feature_PenIdentity>::GetFeaturePropertyCache'::`2'::data & 3) != 0 )
  {
    v2 = 0;
  ...
  v8 = 0;
  CurrentFeatureEnabledState = wil::Feature<__WilFeatureTraits_Feature_PenIdentity>::GetCurrentFeatureEnabledState(
                                 a1,
                                 &v8,
                                 &v9);
  v4 = (`wil::Feature<__WilFeatureTraits_Feature_PenIdentity>::GetFeaturePropertyCache'::`2'::data >> 2) & 1;
  if ( v2 )
  {
    v4 = v9;
  ...
  wil_details_ModifyFeatureData(
    (union wil_details_FeaturePropertyCache *)&`wil::Feature<__WilFeatureTraits_Feature_PenIdentity>::GetFeaturePropertyCache'::`2'::data,
    v5,
    (void *)v6);
  return v1;
}
