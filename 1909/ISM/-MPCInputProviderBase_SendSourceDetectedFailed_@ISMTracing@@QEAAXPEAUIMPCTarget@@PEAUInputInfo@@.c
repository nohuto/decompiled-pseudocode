/*
 * XREFs of ?MPCInputProviderBase_SendSourceDetectedFailed_@ISMTracing@@QEAAXPEAUIMPCTarget@@PEAUInputInfo@@IJ@Z @ 0x18013DF14
 * Callers:
        ...
        int a5)
{
  ...
  if ( *(_DWORD *)v8 > 4u )
  {
    if ( TlgKeywordOn((TraceLoggingHProvider)v7[1], 1uLL) )
    {
      ...
      v34 = 4;
      v37 = 4;
      TlgWrite(v8, &unk_1801A1150, 0LL, 0LL, 0xAu, &pData);
    }
  }
}
