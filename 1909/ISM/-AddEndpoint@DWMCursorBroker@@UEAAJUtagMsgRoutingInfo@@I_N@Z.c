/*
 * XREFs of ?AddEndpoint@DWMCursorBroker@@UEAAJUtagMsgRoutingInfo@@I_N@Z @ 0x1801436E0
 * Callers:
 *     <none>
 * Callees:
...
LABEL_10:
  ...
  v11 = v16[0];
  v12 = 3LL * v16[0];
  NextEndpointIndex = (*(__int64 (__fastcall **)(_QWORD, __int64, __int64))(**(_QWORD **)(a1 + 168) + 104LL))(
                        *(_QWORD *)(a1 + 168),
                        a2,
                        a1 + 8 * (v12 + 26));
  if ( NextEndpointIndex < 0 )
  ...
  *(_BYTE *)(a1 + 24 * v11 + 216) = a4;
  ...
  {
    NextEndpointIndex = DWMCursorBroker::CreateMotionTransformAndVerifySend(v4, (struct DWMCursor *)i[4], v16[0]);
    if ( NextEndpointIndex < 0 )
    {
      v10 = 224LL;
      goto LABEL_10;
