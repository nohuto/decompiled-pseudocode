/*
 * XREFs of ?Initialize@MPCInputRouter@@AEAAJXZ @ 0x18001F868
 * Callers:
...
__int64 __fastcall MPCInputRouter::Initialize(MPCInputRouter *this)
{
  ...
  else
  {
    ...
    *(_QWORD *)&v7 = MPCInputRouter::On3DCompositorRunningChanged;
    ...
    v13 = &v9;
    v10 = v7;
    MPC3DStateHelper::RegisterFor3DCompositorRunningChanged(Instance, (__int64)&v9, (unsigned int *)this + 227);
