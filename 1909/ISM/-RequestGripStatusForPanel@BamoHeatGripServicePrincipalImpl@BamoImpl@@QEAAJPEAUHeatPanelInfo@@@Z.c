/*
 * XREFs of ?RequestGripStatusForPanel@BamoHeatGripServicePrincipalImpl@BamoImpl@@QEAAJPEAUHeatPanelInfo@@@Z @ 0x18007A514
 * Callers:
 *     ?Thunk_RequestGripStatusForPanel_122@?$IHeatGripServicePrincipal_Receive@VBamoHeatGripServicePrincipalImpl@BamoImpl@@@@SAJPEAXPEAPEAX@Z @ 0x18007A6C0 (-Thunk_RequestGripStatusForPanel_122@-$IHeatGripServicePrincipal_Receive@VBamoHeatGripServicePri.c)
 * Callees:
        ...
        struct HeatPanelInfo *a2)
{
  ...
  v6 = (*(__int64 (__fastcall **)(char *, __int64, struct HeatPanelInfo *))(*((_QWORD *)this - 2) + 72LL))(
         (char *)this - 16,
         v5,
         a2);
  if ( v6 < 0 )
