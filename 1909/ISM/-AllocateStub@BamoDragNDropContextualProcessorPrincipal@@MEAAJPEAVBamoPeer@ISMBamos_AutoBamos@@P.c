/*
 * XREFs of ?AllocateStub@BamoDragNDropContextualProcessorPrincipal@@MEAAJPEAVBamoPeer@ISMBamos_AutoBamos@@PEAPEAVBamoDragNDropContextualProcessorStub@@@Z @ 0x1800092D0
 * Callers:
 *     <none>
 * Callees:
