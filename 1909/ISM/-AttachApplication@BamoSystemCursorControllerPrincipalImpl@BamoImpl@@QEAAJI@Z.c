/*
 * XREFs of ?AttachApplication@BamoSystemCursorControllerPrincipalImpl@BamoImpl@@QEAAJI@Z @ 0x1800C909C
 * Callers:
 *     ?Thunk_AttachApplication_0@?$ISystemCursorControllerPrincipal_Receive@VBamoSystemCursorControllerPrincipalImpl@BamoImpl@@@@SAJPEAXPEAPEAX@Z @ 0x1800CA960 (-Thunk_AttachApplication_0@-$ISystemCursorControllerPrincipal_Receive@VBamoSystemCursorControlle.c)
 * Callees:
