/*
 * XREFs of ?OnHitTest@ContextualProcessing@InputTraceLogging@@SAXPEBUInputInfo@@PEBGW4ContextualProcessorState@@@Z @ 0x1800F92DC
 * Callers:
...
char __fastcall InputTraceLogging::ContextualProcessing::OnHitTest(__int64 a1, const WCHAR *a2, unsigned int a3)
{
  ...
  if ( *(_DWORD *)v6[1] > 4u )
  {
    ...
    if ( (_BYTE)v6 )
    {
      ...
      TlgCreateSz(&v25, v11);
      LOBYTE(v6) = TlgWrite(v12, &unk_1801A030B, 0LL, 0LL, 7u, &pData);
    }
  }
  return (char)v6;
}
