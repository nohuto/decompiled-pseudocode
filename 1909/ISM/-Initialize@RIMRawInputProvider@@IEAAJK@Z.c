/*
 * XREFs of ?Initialize@RIMRawInputProvider@@IEAAJK@Z @ 0x1800206A4
 * Callers:
 ...
 *     ??B?$ComPtrRef@V?$ComPtr@VSystemControlDeviceCollection@@@WRL@Microsoft@@@Details@WRL@Microsoft@@QEAAPEAPEAVSystemControlDeviceCollection@@XZ @ 0x180098AFC (--B-$ComPtrRef@V-$ComPtr@VSystemControlDeviceCollection@@@WRL@Microsoft@@@Details@WRL@Microsoft@.c)
