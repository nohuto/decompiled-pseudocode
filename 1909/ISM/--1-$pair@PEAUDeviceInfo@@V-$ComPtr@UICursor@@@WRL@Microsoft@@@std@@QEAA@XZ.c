/*
 * XREFs of ??1?$pair@PEAUDeviceInfo@@V?$ComPtr@UICursor@@@WRL@Microsoft@@@std@@QEAA@XZ @ 0x180139FF8
 * Callers:
 *     _MPCMouseProcessor::AttachMouse_::_1_::dtor$2 @ 0x18003CB71 (_MPCMouseProcessor--AttachMouse_--_1_--dtor$2.c)
 * Callees:
 *     <none>
 */
