/*
 * XREFs of ?OnPenEventsClientProxyDisconnected@PenEventsDispatcherPrincipal@@QEAAJPEAVBamoPenEventsClientProxy@@@Z @ 0x180032484
 * Callers:
        ...
        struct BamoPenEventsClientProxy *a2)
{
  ...
  if ( *(_DWORD *)v4 > 4u && TlgKeywordOn(v4, 0x200uLL) )
    TlgWrite(v5, &unk_18019B3AD, 0LL, 0LL, 2u, &pData);
