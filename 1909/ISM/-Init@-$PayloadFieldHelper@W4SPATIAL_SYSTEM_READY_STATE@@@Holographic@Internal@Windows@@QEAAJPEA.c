/*
 * XREFs of ?Init@?$PayloadFieldHelper@W4SPATIAL_SYSTEM_READY_STATE@@@Holographic@Internal@Windows@@QEAAJPEAUISpatialPayloadDescriptor@234@AEBU_GUID@@@Z @ 0x1800F4EB4
 * Callers:
