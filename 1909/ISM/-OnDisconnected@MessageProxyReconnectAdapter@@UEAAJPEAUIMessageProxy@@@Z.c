/*
 * XREFs of ?OnDisconnected@MessageProxyReconnectAdapter@@UEAAJPEAUIMessageProxy@@@Z @ 0x18005A170
 * Callers:
 *     <none>
 * Callees:
 ...
 *     ??$As@UIMessageProxy@@@?$ComPtr@UIMessageProxy@@@WRL@Microsoft@@QEBAJV?$ComPtrRef@V?$ComPtr@UIMessageProxy@@@WRL@Microsoft@@@Details@12@@Z @ 0x180059E00 (--$As@UIMessageProxy@@@-$ComPtr@UIMessageProxy@@@WRL@Microsoft@@QEBAJV-$ComPtrRef@V-$ComPtr@UIMe.c)
