/*
 * XREFs of ?UpdateInputSiteManager@BamoInputSystemProxyImpl@BamoImpl@@QEAAJI@Z @ 0x180064610
 * Callers:
 *     ?Thunk_UpdateInputSiteManager_0@?$IInputSystemProxy_Receive@VBamoInputSystemProxyImpl@BamoImpl@@@@SAJPEAXPEAPEAX@Z @ 0x1800634E0 (-Thunk_UpdateInputSiteManager_0@-$IInputSystemProxy_Receive@VBamoInputSystemProxyImpl@BamoImpl@@.c)
 * Callees:
