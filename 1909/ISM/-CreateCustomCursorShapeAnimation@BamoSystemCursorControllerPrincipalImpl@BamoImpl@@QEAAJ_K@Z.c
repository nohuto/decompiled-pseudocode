/*
 * XREFs of ?CreateCustomCursorShapeAnimation@BamoSystemCursorControllerPrincipalImpl@BamoImpl@@QEAAJ_K@Z @ 0x1800C97EC
 * Callers:
 *     ?Thunk_CreateCustomCursorShapeAnimation_6@?$ISystemCursorControllerPrincipal_Receive@VBamoSystemCursorControllerPrincipalImpl@BamoImpl@@@@SAJPEAXPEAPEAX@Z @ 0x1800CA990 (-Thunk_CreateCustomCursorShapeAnimation_6@-$ISystemCursorControllerPrincipal_Receive@VBamoSystem.c)
 * Callees:
...
__int64 __fastcall BamoImpl::BamoSystemCursorControllerPrincipalImpl::CreateCustomCursorShapeAnimation(
        ...
        __int64 a2)
{
  ...
  v6 = (*(__int64 (__fastcall **)(char *, __int64, __int64))(*((_QWORD *)this - 2) + 104LL))((char *)this - 16, v5, a2);
  if ( v6 < 0 )
