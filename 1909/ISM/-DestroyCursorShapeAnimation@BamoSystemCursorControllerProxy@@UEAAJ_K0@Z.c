/*
 * XREFs of ?DestroyCursorShapeAnimation@BamoSystemCursorControllerProxy@@UEAAJ_K0@Z @ 0x18005C440
 * Callers:
 *     <none>
 * Callees:
        ...
        unsigned __int64 a3)
{
  ...
  LODWORD(v4) = BamoImpl::BamoSystemCursorControllerProxyImpl::DestroyCursorShapeAnimation(
