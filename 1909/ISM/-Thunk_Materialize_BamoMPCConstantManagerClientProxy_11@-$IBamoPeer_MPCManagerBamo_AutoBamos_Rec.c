/*
 * XREFs of ?Thunk_Materialize_BamoMPCConstantManagerClientProxy_11@?$IBamoPeer_MPCManagerBamo_AutoBamos_Receive@VBamoPeerImpl@MPCManagerBamo_AutoBamos@BamoImpl@@@@SAJPEAXPEAPEAX@Z @ 0x18007F7E0
 * Callers:
 *     <none>
 * Callees:
 *     <none>
