/*
 * XREFs of std::_Func_impl_no_alloc__lambda_74c2b2c0e9aa5d0a847dc755b1427617__bool_wil::com_ptr_t_PenEventsClientCustomProxy_wil::err_exception_policy___::_Do_call @ 0x180033C70
 * Callers:
 *     <none>
 * Callees:
