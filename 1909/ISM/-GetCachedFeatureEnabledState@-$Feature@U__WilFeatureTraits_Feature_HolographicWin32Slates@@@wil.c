/*
 * XREFs of ?GetCachedFeatureEnabledState@?$Feature@U__WilFeatureTraits_Feature_HolographicWin32Slates@@@wil@@CA?AW4wil_details_CachedFeatureEnabledState@@_N@Z @ 0x18002DF34
 * Callers:
 ...
 *     ?GetCurrentFeatureEnabledState@?$Feature@U__WilFeatureTraits_Feature_HolographicWin32Slates@@@wil@@CA?AW4wil_details_CachedFeatureEnabledState@@_NPEAW4wil_details_CachedHasNotificationState@@PEAH@Z @ 0x18002DFFC (-GetCurrentFeatureEnabledState@-$Feature@U__WilFeatureTraits_Feature_HolographicWin32Slates@@@wi.c)
 */
