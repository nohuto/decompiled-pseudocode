/*
 * XREFs of ?StartActivity@DestroySpatialGraphNodeReference@HolographicDriverClientContinuousTrace@@QEAAXAEBU_GUID@@AEBUSPATIAL_NODE_ID@@@Z @ 0x18015DC7C
 * Callers:
 ...
 *     ?zInternalStart@?$ActivityBase@VHolographicDriverClientContinuousTrace@@$0A@$0A@$04$0A@U_TlgReflectorTag_Param0IsProviderType@@@wil@@QEAAXXZ @ 0x180161AA4 (-zInternalStart@-$ActivityBase@VHolographicDriverClientContinuousTrace@@$0A@$0A@$04$0A@U_TlgRefl.c)
 */
        ...
        const struct SPATIAL_NODE_ID *a3)
{
  ...
  if ( *(_DWORD *)v7 > 5u )
  {
    ...
    TlgWrite(v7, &unk_1801A3662, (LPCGUID)(*((_QWORD *)this + 6) + 8LL), v9, 6u, &pData);
  }
  if ( !*((_DWORD *)this + 8) )
