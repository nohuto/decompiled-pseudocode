/*
 * XREFs of ?QueryInterface@BamoAsyncResult_PROPVARIANT_Stub@@UEAAJAEBU_GUID@@PEAPEAX@Z @ 0x180122D10
 * Callers:
 *     ?QueryInterface@BamoAsyncResult_PROPVARIANT_Stub@@W7EAAJAEBU_GUID@@PEAPEAX@Z @ 0x180039AF0 (-QueryInterface@BamoAsyncResult_PROPVARIANT_Stub@@W7EAAJAEBU_GUID@@PEAPEAX@Z.c)
 * Callees:
