/*
 * XREFs of ?ControllerGetDynamicNodeFailed_@SpatialInteractionTrace@SpatialInteractionDevices@@QEAAXJK@Z @ 0x180164B00
 * Callers:
        ...
        int a3)
{
  ...
  if ( *(_DWORD *)v3 > 4u )
  {
    if ( TlgKeywordOn(v3, 2uLL) )
    {
      ...
      v8 = cData;
      v11 = cData;
      TlgWrite(v4, &unk_1801A485E, 0LL, 0LL, cData, &pData);
    }
  }
}
