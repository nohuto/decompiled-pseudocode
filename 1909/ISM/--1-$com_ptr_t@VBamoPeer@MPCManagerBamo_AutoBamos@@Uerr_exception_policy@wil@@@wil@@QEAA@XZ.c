/*
 * XREFs of ??1?$com_ptr_t@VBamoPeer@MPCManagerBamo_AutoBamos@@Uerr_exception_policy@wil@@@wil@@QEAA@XZ @ 0x18007D170
 * Callers:
 *     _MPCManager::OnPeerConnected_::_1_::dtor$0 @ 0x18007EC59 (_MPCManager--OnPeerConnected_--_1_--dtor$0.c)
 * Callees:
