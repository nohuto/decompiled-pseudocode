/*
 * XREFs of ?PerformDropOffStabilization@RayStabilizer@@AEAAXAEAVRayStabilizationResult@@@Z @ 0x18012CB00
 * Callers:
...
void __fastcall RayStabilizer::PerformDropOffStabilization(__m128 *this, struct RayStabilizationResult *a2)
{
  ...
  unsigned __int32 v20; // [rsp+2Ch] [rbp-DCh]
  ...
  if ( (unsigned __int8)RayStabilizer::TransformRay(&v24, &v22) )
  {
           ...
           (struct RayStabilizer::ProcessedHistoryData *)v28) )
    {
      ...
      v19 = v17.m128_i32[0];
      v20 = _mm_shuffle_ps(v17, v17, 85).m128_u32[0];
      v26.m128_i32[3] = v17.m128_i32[0];
      v5 = v26;
      v17.m128_i32[0] = _mm_shuffle_ps(v17, v17, 170).m128_u32[0];
      v21 = v17.m128_f32[0];
      v27 = __PAIR64__(v17.m128_u32[0], v20);
      v6 = __PAIR64__(v17.m128_u32[0], v20);
    }
    else
    {
      v9 = (__m128)v25;
