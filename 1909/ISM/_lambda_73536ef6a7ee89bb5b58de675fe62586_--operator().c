/*
 * XREFs of _lambda_73536ef6a7ee89bb5b58de675fe62586_::operator() @ 0x1800EAE7C
 * Callers:
 *     std::_Func_impl_no_alloc__lambda_73536ef6a7ee89bb5b58de675fe62586__void_Windows::Internal::SpatialInteractions::ISpatialInteractionSourceCollectionCallbacks___::_Do_call @ 0x1800EFE00 (std--_Func_impl_no_alloc__lambda_73536ef6a7ee89bb5b58de675fe62586__void_Windows--In_ea_1800EFE00.c)
 * Callees:
...
{
  int v4; // eax
  _QWORD v5[40]; // [rsp+30h] [rbp-158h] BYREF
