/*
 * XREFs of ??$_Insert@AEAU?$pair@$$CBKPEAUDeviceInfo@@@std@@V?$_List_unchecked_iterator@V?$_List_val@U?$_List_simple_types@U?$pair@$$CBKPEAUDeviceInfo@@@std@@@std@@@std@@@2@@?$_Hash@V?$_Umap_traits@KPEAUDeviceInfo@@V?$_Uhash_compare@KU?$hash@K@std@@U?$equal_to@K@2@@std@@V?$allocator@U?$pair@$$CBKPEAUDeviceInfo@@@std@@@3@$0A@@std@@@std@@IEAA?AU?$pair@V?$_List_iterator@V?$_List_val@U?$_List_simple_types@U?$pair@$$CBKPEAUDeviceInfo@@@std@@@std@@@std@@@std@@_N@1@AEAU?$pair@$$CBKPEAUDeviceInfo@@@1@V?$_List_unchecked_iterator@V?$_List_val@U?$_List_simple_types@U?$pair@$$CBKPEAUDeviceInfo@@@std@@@std@@@std@@@1@@Z @ 0x1800132A8
 * Callers:
        ...
        __int64 *a4)
{
  ...
  if ( *(_QWORD *)(v11 + 16 * (v8 & *(_QWORD *)(a1 + 48))) != v12 )
  {
    ...
    {
      std::list<std::pair<unsigned long const,IRawInputProvider *>>::erase(v29 + 8, &v29, v31);
      throw;
    }
  }
  v13 = v12;
  while ( v13 != *(_QWORD *)(v11 + 16 * (v8 & *(_QWORD *)(a1 + 48))) )
  {
    ...
    {
      std::list<std::pair<unsigned long const,IRawInputProvider *>>::erase(a1 + 8, &v30, a4);
      *(_QWORD *)a2 = v12;
      *(_BYTE *)(a2 + 8) = 0;
      return a2;
    }
  ...
  {
    v23 = *(__int64 ***)(v16 + 8 * v10 + 8);
    v24 = *v23;
    *(_QWORD *)(v16 + 8 * v10 + 8) = *v23;
    if ( v24 != a4 )
