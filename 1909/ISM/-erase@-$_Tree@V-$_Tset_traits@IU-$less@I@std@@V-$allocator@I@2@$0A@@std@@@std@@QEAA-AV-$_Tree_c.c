/*
 * XREFs of ?erase@?$_Tree@V?$_Tset_traits@IU?$less@I@std@@V?$allocator@I@2@$0A@@std@@@std@@QEAA?AV?$_Tree_const_iterator@V?$_Tree_val@U?$_Tree_simple_types@I@std@@@std@@@2@V32@0@Z @ 0x180147748
 * Callers:
 *     ??0HotKeyProcessor@@QEAA@XZ @ 0x1801457FC (--0HotKeyProcessor@@QEAA@XZ.c)
 *     ??1?$set@IU?$less@I@std@@V?$allocator@I@2@@std@@QEAA@XZ @ 0x180145AA8 (--1-$set@IU-$less@I@std@@V-$allocator@I@2@@std@@QEAA@XZ.c)
