/*
 * XREFs of ?Docked@BamoPenEventsClientProxyImpl@BamoImpl@@QEAAJXZ @ 0x180031A50
 * Callers:
...
__int64 __fastcall BamoImpl::BamoPenEventsClientProxyImpl::Docked(BamoImpl::BamoPenEventsClientProxyImpl *this)
{
  int v1; // ebx
  __int64 v2; // rdx
