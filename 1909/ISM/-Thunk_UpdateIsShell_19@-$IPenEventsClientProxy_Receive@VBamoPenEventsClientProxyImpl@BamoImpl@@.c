/*
 * XREFs of ?Thunk_UpdateIsShell_19@?$IPenEventsClientProxy_Receive@VBamoPenEventsClientProxyImpl@BamoImpl@@@@SAJPEAXPEAPEAX@Z @ 0x1800333E0
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall IPenEventsClientProxy_Receive<BamoImpl::BamoPenEventsClientProxyImpl>::Thunk_UpdateIsShell_19(
        __int64 a1,
        _BYTE **a2)
{
  int v3; // eax
