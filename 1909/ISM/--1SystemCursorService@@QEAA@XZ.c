/*
 * XREFs of ??1SystemCursorService@@QEAA@XZ @ 0x1800C8DD8
 * Callers:
 *     ?_Destroy@?$_Ref_count_obj@VSystemCursorService@@@std@@EEAAXXZ @ 0x1800CAB00 (-_Destroy@-$_Ref_count_obj@VSystemCursorService@@@std@@EEAAXXZ.c)
 * Callees:
