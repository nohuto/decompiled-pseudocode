/*
 * XREFs of ?NodePropertyRequestAdded_@HolographicDriverClientTrace@@QEAAXAEBU_GUID@@AEBUSPATIAL_NODE_ID@@0@Z @ 0x18015A190
 * Callers:
        ...
        const struct _GUID *a4)
{
  ...
  if ( *(_DWORD *)v7 > 4u )
  {
    if ( TlgKeywordOn(v7, 2uLL) )
    {
      ...
      v14 = a4;
      v15 = 16LL;
      TlgWrite(v8, &unk_1801A23D7, 0LL, 0LL, 5u, &pData);
    }
  }
}
