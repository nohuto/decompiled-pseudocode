/*
 * XREFs of ?QueryInterface@BamoActivationConfigurationInputObjectProxy@@UEAAJAEBU_GUID@@PEAPEAX@Z @ 0x18000DDB0
 * Callers:
 *     ?QueryInterface@BamoActivationConfigurationInputObjectProxy@@W7EAAJAEBU_GUID@@PEAPEAX@Z @ 0x180037CD0 (-QueryInterface@BamoActivationConfigurationInputObjectProxy@@W7EAAJAEBU_GUID@@PEAPEAX@Z.c)
 * Callees:
