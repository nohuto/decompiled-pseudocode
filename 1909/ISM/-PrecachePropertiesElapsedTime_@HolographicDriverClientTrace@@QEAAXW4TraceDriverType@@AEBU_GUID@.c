/*
 * XREFs of ?PrecachePropertiesElapsedTime_@HolographicDriverClientTrace@@QEAAXW4TraceDriverType@@AEBU_GUID@@_K@Z @ 0x18015B448
 * Callers:
  ...
  if ( v23 < 0xBB8 )
  {
    ...
    if ( **(_DWORD **)(v5 + 8) > 4u )
    {
      ...
      if ( (_BYTE)v5 )
      {
        ...
        v16 = 16LL;
        v18 = 8LL;
        LOBYTE(v5) = TlgWrite(v9, &unk_1801A285B, 0LL, 0LL, 5u, &pData);
      }
    }
  }
  else
  {
    ...
    if ( **(_DWORD **)(v5 + 8) > 4u )
    {
      ...
      if ( (_BYTE)v5 )
      {
        ...
        v12 = 0x1000000LL;
        v22 = 8LL;
        LOBYTE(v5) = TlgWrite(v7, &unk_1801A2F56, 0LL, 0LL, 7u, &pData);
      }
    }
  }
  return v5;
