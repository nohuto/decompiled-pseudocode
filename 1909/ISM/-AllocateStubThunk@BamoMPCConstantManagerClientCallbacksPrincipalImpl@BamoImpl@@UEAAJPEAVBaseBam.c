/*
 * XREFs of ?AllocateStubThunk@BamoMPCConstantManagerClientCallbacksPrincipalImpl@BamoImpl@@UEAAJPEAVBaseBamoPeerImpl@2Microsoft@@PEAPEAVBamoStub@Bamo@4@@Z @ 0x180124090
 * Callers:
 *     <none>
 * Callees:
