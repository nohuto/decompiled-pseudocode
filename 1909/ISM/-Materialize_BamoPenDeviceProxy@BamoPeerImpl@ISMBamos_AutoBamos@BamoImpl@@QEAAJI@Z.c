/*
 * XREFs of ?Materialize_BamoPenDeviceProxy@BamoPeerImpl@ISMBamos_AutoBamos@BamoImpl@@QEAAJI@Z @ 0x18005EC80
 * Callers:
 *     ?Thunk_Materialize_BamoPenDeviceProxy_0@?$IBamoPeer_ISMBamos_AutoBamos_Receive@VBamoPeerImpl@ISMBamos_AutoBamos@BamoImpl@@@@SAJPEAXPEAPEAX@Z @ 0x180062C00 (-Thunk_Materialize_BamoPenDeviceProxy_0@-$IBamoPeer_ISMBamos_AutoBamos_Receive@VBamoPeerImpl@ISM.c)
 * Callees:
