/*
 * XREFs of ?NodePropertyCache_SetValue_@HolographicDriverClientTrace@@QEAAXAEBU_GUID@@AEBUSPATIAL_NODE_ID@@0PEBX_K@Z @ 0x180159E08
 * Callers:
        ...
        char a6)
{
  ...
  if ( *(_DWORD *)v9 > 4u )
  {
    if ( TlgKeywordOn(v9, 2uLL) )
    {
      ...
      v17 = 16LL;
      v19 = 8LL;
      TlgWrite(v10, &unk_1801A2737, 0LL, 0LL, 6u, &pData);
    }
  }
}
