/*
 * XREFs of ?CheckForFlick@FlickRecognizer@@AEAAXPEBVGestureSession@@@Z @ 0x18010AF44
 * Callers:
 ...
 * Callees:
 *     ?FindFirstRelevantFlickData@FlickRecognizer@@AEAAHXZ @ 0x18010B074 (-FindFirstRelevantFlickData@FlickRecognizer@@AEAAHXZ.c)
 */
