/*
 * XREFs of _lambda_94bf11a16993f060fe03c20fc4fc2394_::operator() @ 0x1800E0D18
 * Callers:
 *     wil::details::lambda_call__lambda_94bf11a16993f060fe03c20fc4fc2394___::_lambda_call__lambda_94bf11a16993f060fe03c20fc4fc2394___ @ 0x1800E06AC (wil--details--lambda_call__lambda_94bf11a16993f060fe03c20fc4fc2394___--_lambda_call__lambda_94bf.c)
  ...
  if ( SpatialInteractionDevices::SpatialInteractionTrace::IsEnabled(v10) )
  {
    ...
    if ( *(_DWORD *)v13[1] > 4u )
    {
      if ( TlgKeywordOn((TraceLoggingHProvider)v13[1], 2uLL) )
      {
        ...
        TlgWrite(v14, &unk_18019E984, 0LL, 0LL, 3u, &pData);
      }
    }
  }
  ...
  if ( (_BYTE)v15 )
  {
    ...
    if ( *(_DWORD *)v15[1] > 4u )
    {
      ...
      if ( (_BYTE)v15 )
      {
        ...
        LOBYTE(v15) = TlgWrite(v18, &unk_18019E4AD, 0LL, 0LL, 3u, &pData);
      }
    }
  }
  return (char)v15;
