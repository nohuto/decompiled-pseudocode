/*
 * XREFs of _std::_List_alloc_std::_List_base_types_ISystemContextObserver___std::allocator_ISystemContextObserver_______::_Buynode0_::_1_::catch$6 @ 0x18003AB8B
 * Callers:
 *     <none>
 * Callees:
