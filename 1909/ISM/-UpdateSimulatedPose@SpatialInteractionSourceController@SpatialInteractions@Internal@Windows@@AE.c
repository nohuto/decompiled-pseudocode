/*
 * XREFs of ?UpdateSimulatedPose@SpatialInteractionSourceController@SpatialInteractions@Internal@Windows@@AEAAX_JAEBUPoseData@SpatialInteractionDevices@@PEAUISpatialGraphNodeReference@Holographic@34@AEBUMatrix4x4@Numerics@Foundation@4@3@Z @ 0x18016953C
 * Callers:
        ...
        const struct Windows::Foundation::Numerics::Matrix4x4 *a6)
{
  ...
  else
  {
    ...
    v39[0] = a2;
    v6 = xmmword_180199488;
    v40 = 3;
    v41 = (__m128)xmmword_180199478;
    v42 = (__m128)xmmword_180199488;
    v43 = xmmword_180199498;
  }
