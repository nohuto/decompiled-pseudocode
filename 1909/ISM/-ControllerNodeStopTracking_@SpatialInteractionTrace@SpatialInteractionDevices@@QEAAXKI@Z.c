/*
 * XREFs of ?ControllerNodeStopTracking_@SpatialInteractionTrace@SpatialInteractionDevices@@QEAAXKI@Z @ 0x180164F08
 * Callers:
        ...
        int a3)
{
  ...
  if ( *(_DWORD *)v3 > 4u )
  {
    if ( TlgKeywordOn(v3, 0x400000000000uLL) )
    {
      ...
      v8 = cData;
      v11 = cData;
      TlgWrite(v4, &unk_1801A489A, 0LL, 0LL, cData, &pData);
    }
  }
}
