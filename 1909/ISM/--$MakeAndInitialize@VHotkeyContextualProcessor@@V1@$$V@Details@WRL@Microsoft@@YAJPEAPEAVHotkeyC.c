/*
 * XREFs of ??$MakeAndInitialize@VHotkeyContextualProcessor@@V1@$$V@Details@WRL@Microsoft@@YAJPEAPEAVHotkeyContextualProcessor@@@Z @ 0x1800C1A60
 * Callers:
 ...
 *     ??0HotkeyContextualProcessor@@QEAA@XZ @ 0x1800C2058 (--0HotkeyContextualProcessor@@QEAA@XZ.c)
