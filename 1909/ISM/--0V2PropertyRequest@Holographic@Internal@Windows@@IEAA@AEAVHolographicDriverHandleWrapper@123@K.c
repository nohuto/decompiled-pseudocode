/*
 * XREFs of ??0V2PropertyRequest@Holographic@Internal@Windows@@IEAA@AEAVHolographicDriverHandleWrapper@123@KIPEBX_KAEAU_LUID@@P6AJ1_K@Z@Z @ 0x180151584
 * Callers:
        ...
        int (*a8)(const void *, unsigned __int64))
{
  ...
  *((_DWORD *)this + 12) = a3;
  *((_DWORD *)this + 13) = a4;
  std::vector<unsigned char>::vector<unsigned char>((char **)this + 10, 0xCuLL);
  *((_DWORD *)this + 26) = 0;
  *((_DWORD *)this + 30) = 0;
  *((_QWORD *)this + 14) = a8;
  return this;
