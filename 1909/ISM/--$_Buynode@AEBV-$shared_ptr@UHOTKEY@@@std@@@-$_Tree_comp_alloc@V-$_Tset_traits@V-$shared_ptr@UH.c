/*
 * XREFs of ??$_Buynode@AEBV?$shared_ptr@UHOTKEY@@@std@@@?$_Tree_comp_alloc@V?$_Tset_traits@V?$shared_ptr@UHOTKEY@@@std@@U?$less@V?$shared_ptr@UHOTKEY@@@std@@@2@V?$allocator@V?$shared_ptr@UHOTKEY@@@std@@@2@$0A@@std@@@std@@QEAAPEAU?$_Tree_node@V?$shared_ptr@UHOTKEY@@@std@@PEAX@1@AEBV?$shared_ptr@UHOTKEY@@@1@@Z @ 0x180144E80
 * Callers:
