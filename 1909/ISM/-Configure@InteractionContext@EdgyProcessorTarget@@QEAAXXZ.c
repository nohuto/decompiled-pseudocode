/*
 * XREFs of ?Configure@InteractionContext@EdgyProcessorTarget@@QEAAXXZ @ 0x180102D18
 * Callers:
...
void __fastcall EdgyProcessorTarget::InteractionContext::Configure(EdgyProcessorTarget::InteractionContext *this)
{
  ...
  *(__m128i *)v10 = _mm_load_si128((const __m128i *)&_xmm);
  v6 = SetPropertyInteractionContext(v5, 3LL);
  if ( v6 < 0 )
  {
    wil::details::in1diag3::FailFast_Hr(
      retaddr,
  ...
  v7 = SetPropertyInteractionContext(*v1, 2LL);
  if ( v7 < 0 )
  {
    wil::details::in1diag3::FailFast_Hr(
      retaddr,
