/*
 * XREFs of ?QueryInterface@BamoAttachableInputObjectSampleProxy@@UEAAJAEBU_GUID@@PEAPEAX@Z @ 0x180060C60
 * Callers:
 *     ?QueryInterface@BamoAttachableInputObjectSampleProxy@@W7EAAJAEBU_GUID@@PEAPEAX@Z @ 0x180037D00 (-QueryInterface@BamoAttachableInputObjectSampleProxy@@W7EAAJAEBU_GUID@@PEAPEAX@Z.c)
 * Callees:
