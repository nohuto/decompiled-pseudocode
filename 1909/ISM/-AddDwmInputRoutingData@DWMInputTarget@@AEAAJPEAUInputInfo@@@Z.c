/*
 * XREFs of ?AddDwmInputRoutingData@DWMInputTarget@@AEAAJPEAUInputInfo@@@Z @ 0x1800C68CC
 * Callers:
 ...
 *     ?GetIsCoreWindow@LegacyInputSinkData@@QEBA_NXZ @ 0x180066DCC (-GetIsCoreWindow@LegacyInputSinkData@@QEBA_NXZ.c)
 ...
 *     ?ToCompositionInputType@@YA?AW4CompositionInputType@@W4InputType@@@Z @ 0x1800C535C (-ToCompositionInputType@@YA-AW4CompositionInputType@@W4InputType@@@Z.c)
 */
