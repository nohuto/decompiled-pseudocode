/*
 * XREFs of ??_GInputRedirectionTarget@@MEAAPEAXI@Z @ 0x18010728C
 * Callers:
 *     ??_EInputRedirectionTarget@@OBA@EAAPEAXI@Z @ 0x1800390A0 (--_EInputRedirectionTarget@@OBA@EAAPEAXI@Z.c)
 * Callees:
