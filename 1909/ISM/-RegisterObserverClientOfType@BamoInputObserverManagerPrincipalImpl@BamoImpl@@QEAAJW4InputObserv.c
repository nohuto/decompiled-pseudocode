/*
 * XREFs of ?RegisterObserverClientOfType@BamoInputObserverManagerPrincipalImpl@BamoImpl@@QEAAJW4InputObserverType@InputObservation@@I@Z @ 0x180067724
 * Callers:
 *     ?Thunk_RegisterObserverClientOfType_137@?$IInputObserverManagerPrincipal_Receive@VBamoInputObserverManagerPrincipalImpl@BamoImpl@@@@SAJPEAXPEAPEAX@Z @ 0x1800679C0 (-Thunk_RegisterObserverClientOfType_137@-$IInputObserverManagerPrincipal_Receive@VBamoInputObser.c)
 * Callees:
