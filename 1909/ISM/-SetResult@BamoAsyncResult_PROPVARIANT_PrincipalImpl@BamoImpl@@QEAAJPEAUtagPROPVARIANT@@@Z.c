/*
 * XREFs of ?SetResult@BamoAsyncResult_PROPVARIANT_PrincipalImpl@BamoImpl@@QEAAJPEAUtagPROPVARIANT@@@Z @ 0x180123028
 * Callers:
 *     ?Thunk_SetResult_0@?$IAsyncResult_PROPVARIANT_Principal_Receive@VBamoAsyncResult_PROPVARIANT_PrincipalImpl@BamoImpl@@@@SAJPEAXPEAPEAX@Z @ 0x180123120 (-Thunk_SetResult_0@-$IAsyncResult_PROPVARIANT_Principal_Receive@VBamoAsyncResult_PROPVARIANT_Pri.c)
 * Callees:
        ...
        struct tagPROPVARIANT *a2)
{
  ...
  v6 = (*(__int64 (__fastcall **)(char *, __int64, struct tagPROPVARIANT *))(*((_QWORD *)this - 2) + 72LL))(
         (char *)this - 16,
         v5,
         a2);
  if ( v6 < 0 )
