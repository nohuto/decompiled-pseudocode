...
__int64 **__fastcall std::_Tree<std::_Tmap_traits<std::wstring,Windows::Internal::Holographic::SpatialGraphSnapshot,Windows::Internal::Holographic::CaseInsensitiveStringLess,std::allocator<std::pair<std::wstring const,Windows::Internal::Holographic::SpatialGraphSnapshot>>,0>>::erase(
        _QWORD *a1,
        __int64 **a2,
        __int64 *a3)
{
  ...
  v8 = std::_Tree_val<std::_Tree_simple_types<std::pair<unsigned int const,std::shared_ptr<CustomCursorApplication>>>>::_Extract(
         v3,
         a3);
  std::wstring::_Tidy_deallocate((__int64)(v8 + 8));
  std::wstring::_Tidy_deallocate((__int64)(v8 + 4));
  std::_Deallocate<16,0>(v8, (const struct std::nothrow_t *)0x88);
  result = a2;
  *a2 = i;
  return result;
}
