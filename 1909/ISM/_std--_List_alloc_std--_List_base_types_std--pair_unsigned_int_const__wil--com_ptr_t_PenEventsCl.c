/*
 * XREFs of _std::_List_alloc_std::_List_base_types_std::pair_unsigned_int_const__wil::com_ptr_t_PenEventsClientCustomProxy_wil::err_exception_policy____std::allocator_std::pair_unsigned_int_const__wil::com_ptr_t_PenEventsClientCustomProxy_wil::err_exception_policy_________::_Buynode0_::_1_::catch$6 @ 0x1800338BE
 * Callers:
 *     <none>
 * Callees:
