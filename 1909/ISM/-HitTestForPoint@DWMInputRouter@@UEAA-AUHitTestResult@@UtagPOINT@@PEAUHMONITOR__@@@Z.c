/*
 * XREFs of ?HitTestForPoint@DWMInputRouter@@UEAA?AUHitTestResult@@UtagPOINT@@PEAUHMONITOR__@@@Z @ 0x1800C4560
 * Callers:
 *     <none>
 * Callees:
 ...
 *     ?ToExternalResult@HitTestHelper@@CA?AUHitTestResult@@$$QEAUInternalHitTestResult@1@@Z @ 0x1800C7D48 (-ToExternalResult@HitTestHelper@@CA-AUHitTestResult@@$$QEAUInternalHitTestResult@1@@Z.c)
 */
