/*
 * XREFs of ?StartActivity@TelemetryCloseHolographicDevice@HolographicDriverClientTrace@@QEAAXPEB_WW4TraceDriverType@@AEBU_GUID@@@Z @ 0x18015DEA0
 * Callers:
        ...
        __int64 a4)
{
  ...
  if ( *(_DWORD *)v10 > 5u && TlgKeywordOn(*(TraceLoggingHProvider *)(v9 + 8), 0x400000000000uLL) )
  {
    ...
    TlgWrite(v10, &unk_1801A2792, (LPCGUID)(*(_QWORD *)(a1 + 48) + 8LL), v12, 7u, &pData);
  }
  if ( !*(_DWORD *)(a1 + 32) )
