/*
 * XREFs of ??$GetPropertyValue@K@@YAJPEAUIPropertySet@Collections@Foundation@Windows@@PEBGPEAK@Z @ 0x1800A8278
 * Callers:
...
__int64 __fastcall GetPropertyValue<unsigned long>(__int64 a1, __int64 a2, __int64 a3)
{
  ...
  const WCHAR *v16[3]; // [rsp+40h] [rbp-40h] BYREF
  HSTRING_HEADER v17; // [rsp+58h] [rbp-28h] BYREF
  wil::details::in1diag3 *retaddr; // [rsp+98h] [rbp+18h]

  v16[2] = (const WCHAR *)-2LL;
  v16[0] = L"GamepadAccessibilityVibrationSetting";
  v15 = 0LL;
  v14 = 0LL;
  v12 = 0LL;
  v13 = 0LL;
...
LABEL_13:
  ...
  v7 = (*(__int64 (__fastcall **)(__int64, __int64))(*(_QWORD *)v13 + 96LL))(v13, a3);
  v4 = v7;
  if ( v7 < 0 )
  {
    v6 = 120LL;
