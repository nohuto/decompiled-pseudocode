/*
 * XREFs of ?GetToggleEnabled@BamoMagnifierClientProxy@@UEAA_NXZ @ 0x180031F70
 * Callers:
 *     ?GetEnabled@ControllerNavigationClientProxy@@UEAA_NXZ @ 0x180070F70 (-GetEnabled@ControllerNavigationClientProxy@@UEAA_NXZ.c)
 * Callees:
