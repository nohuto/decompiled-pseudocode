/*
 * XREFs of ??1?$set@V?$shared_ptr@UHOTKEY@@@std@@U?$less@V?$shared_ptr@UHOTKEY@@@std@@@2@V?$allocator@V?$shared_ptr@UHOTKEY@@@std@@@2@@std@@QEAA@XZ @ 0x180145ADC
 * Callers:
 *     _HotKeyProcessor::HotKeyProcessor_::_1_::dtor$3 @ 0x1801459AC (_HotKeyProcessor--HotKeyProcessor_--_1_--dtor$3.c)
 * Callees:
