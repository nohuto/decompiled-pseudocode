/*
 * XREFs of ??1?$map@KUHOTKEY@@U?$less@K@std@@V?$allocator@U?$pair@$$CBKUHOTKEY@@@std@@@3@@std@@QEAA@XZ @ 0x180145A40
 * Callers:
 *     _HotKeyProcessor::HotKeyProcessor_::_1_::dtor$10 @ 0x180145A22 (_HotKeyProcessor--HotKeyProcessor_--_1_--dtor$10.c)
 * Callees:
