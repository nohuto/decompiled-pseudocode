/*
 * XREFs of ?Thunk_UpdateEnabled_19@?$IAttachableInputObjectSampleProxy_Receive@VBamoAttachableInputObjectSampleProxyImpl@BamoImpl@@@@SAJPEAXPEAPEAX@Z @ 0x180062F60
 * Callers:
 *     <none>
 * Callees:
