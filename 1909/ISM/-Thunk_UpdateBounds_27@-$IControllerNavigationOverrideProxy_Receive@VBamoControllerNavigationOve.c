/*
 * XREFs of ?Thunk_UpdateBounds_27@?$IControllerNavigationOverrideProxy_Receive@VBamoControllerNavigationOverrideProxyImpl@BamoImpl@@@@SAJPEAXPEAPEAX@Z @ 0x1800713A0
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall IControllerNavigationOverrideProxy_Receive<BamoImpl::BamoControllerNavigationOverrideProxyImpl>::Thunk_UpdateBounds_27(
        __int64 a1,
        _OWORD **a2)
{
  int v3; // eax
