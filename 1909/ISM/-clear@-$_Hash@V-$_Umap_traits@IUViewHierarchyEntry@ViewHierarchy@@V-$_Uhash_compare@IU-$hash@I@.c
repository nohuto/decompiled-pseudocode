/*
 * XREFs of ?clear@?$_Hash@V?$_Umap_traits@IUViewHierarchyEntry@ViewHierarchy@@V?$_Uhash_compare@IU?$hash@I@std@@U?$equal_to@I@2@@std@@V?$allocator@U?$pair@$$CBIUViewHierarchyEntry@ViewHierarchy@@@std@@@4@$0A@@std@@@std@@QEAAXXZ @ 0x180059C08
 * Callers:
 ...
 *     ?OnClear@ViewHierarchy@@UEAAJPEAUIMessageList@@@Z @ 0x180059650 (-OnClear@ViewHierarchy@@UEAAJPEAUIMessageList@@@Z.c)
