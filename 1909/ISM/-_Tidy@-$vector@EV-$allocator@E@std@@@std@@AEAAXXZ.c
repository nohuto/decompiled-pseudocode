/*
 * XREFs of ?_Tidy@?$vector@EV?$allocator@E@std@@@std@@AEAAXXZ @ 0x1800B5CF4
 * Callers:
 ...
 *     _std::vector_unsigned_char_std::allocator_unsigned_char___::vector_unsigned_char_std::allocator_unsigned_char____::_1_::catch$25 @ 0x1800B2D6B (_std--vector_unsigned_char_std--allocator_unsigned_char___--vector_unsigned_char_std--allocator_.c)
 *     ?ValidateReportParsers@HidLampArrayDevice@@AEAAJXZ @ 0x1800B56A8 (-ValidateReportParsers@HidLampArrayDevice@@AEAAJXZ.c)
 *     ??1EyeProperty@HolographicDisplaySnapshot@Holographic@Internal@Windows@@QEAA@XZ @ 0x1800D7B50 (--1EyeProperty@HolographicDisplaySnapshot@Holographic@Internal@Windows@@QEAA@XZ.c)
