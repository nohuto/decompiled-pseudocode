/*
 * XREFs of ?CheckOverlap@ManipulationInjector@@AEAA_NI@Z @ 0x1800E73E4
 * Callers:
 *     ?CheckOverlapAndEvent@ManipulationInjector@@AEAA_NXZ @ 0x1800E7568 (-CheckOverlapAndEvent@ManipulationInjector@@AEAA_NXZ.c)
 *     ?UpdatePanOverlapState@ManipulationInjector@@AEAAXXZ @ 0x1800E9310 (-UpdatePanOverlapState@ManipulationInjector@@AEAAXXZ.c)
 * Callees:
