/*
 * XREFs of ??1SipcPrivateNamespace@@QEAA@XZ @ 0x1800D4180
 * Callers:
 ...
 * Callees:
 *     ?_FailFast_GetLastError@in1diag0@details@wil@@YAXXZ @ 0x1800D6C74 (-_FailFast_GetLastError@in1diag0@details@wil@@YAXXZ.c)
 */
