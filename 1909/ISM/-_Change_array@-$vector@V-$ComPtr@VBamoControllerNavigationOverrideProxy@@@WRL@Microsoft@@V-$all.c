/*
 * XREFs of ?_Change_array@?$vector@V?$ComPtr@VBamoControllerNavigationOverrideProxy@@@WRL@Microsoft@@V?$allocator@V?$ComPtr@VBamoControllerNavigationOverrideProxy@@@WRL@Microsoft@@@std@@@std@@AEAAXQEAV?$ComPtr@VBamoControllerNavigationOverrideProxy@@@WRL@Microsoft@@_K1@Z @ 0x180073E38
 * Callers:
