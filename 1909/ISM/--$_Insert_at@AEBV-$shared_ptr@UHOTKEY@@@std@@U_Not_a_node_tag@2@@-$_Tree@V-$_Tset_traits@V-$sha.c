/*
 * XREFs of ??$_Insert_at@AEBV?$shared_ptr@UHOTKEY@@@std@@U_Not_a_node_tag@2@@?$_Tree@V?$_Tset_traits@V?$shared_ptr@UHOTKEY@@@std@@U?$less@V?$shared_ptr@UHOTKEY@@@std@@@2@V?$allocator@V?$shared_ptr@UHOTKEY@@@std@@@2@$0A@@std@@@std@@IEAA?AV?$_Tree_const_iterator@V?$_Tree_val@U?$_Tree_simple_types@V?$shared_ptr@UHOTKEY@@@std@@@std@@@std@@@1@_NPEAU?$_Tree_node@V?$shared_ptr@UHOTKEY@@@std@@PEAX@1@AEBV?$shared_ptr@UHOTKEY@@@1@U_Not_a_node_tag@1@@Z @ 0x180145090
 * Callers:
 ...
 *     ??$_Buynode@AEBV?$shared_ptr@UHOTKEY@@@std@@@?$_Tree_comp_alloc@V?$_Tset_traits@V?$shared_ptr@UHOTKEY@@@std@@U?$less@V?$shared_ptr@UHOTKEY@@@std@@@2@V?$allocator@V?$shared_ptr@UHOTKEY@@@std@@@2@$0A@@std@@@std@@QEAAPEAU?$_Tree_node@V?$shared_ptr@UHOTKEY@@@std@@PEAX@1@AEBV?$shared_ptr@UHOTKEY@@@1@@Z @ 0x180144E80 (--$_Buynode@AEBV-$shared_ptr@UHOTKEY@@@std@@@-$_Tree_comp_alloc@V-$_Tset_traits@V-$shared_ptr@UH.c)
 */
