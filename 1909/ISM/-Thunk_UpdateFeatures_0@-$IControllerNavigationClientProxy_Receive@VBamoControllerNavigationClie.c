/*
 * XREFs of ?Thunk_UpdateFeatures_0@?$IControllerNavigationClientProxy_Receive@VBamoControllerNavigationClientProxyImpl@BamoImpl@@@@SAJPEAXPEAPEAX@Z @ 0x1800714F0
 * Callers:
 *     <none>
 * Callees:
