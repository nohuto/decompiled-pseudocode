/*
 * XREFs of ?ReportTraceLoggingFailure@TraceLoggingProvider@wil@@IEAAXAEBUFailureInfo@2@@Z @ 0x180051308
 * Callers:
 *     ?OnErrorReported@TraceLoggingProvider@wil@@MEAAX_NAEBUFailureInfo@2@@Z @ 0x1800500E0 (-OnErrorReported@TraceLoggingProvider@wil@@MEAAX_NAEBUFailureInfo@2@@Z.c)
 * Callees:
        ...
        const struct wil::FailureInfo *a2)
{
  ...
  if ( **((_DWORD **)this + 1) > 2u )
  {
    ...
    v66 = 4;
    TlgCreateSz(&v68, v22);
    TlgWrite(v23, &unk_18019A35D, 0LL, 0LL, 0x14u, &pData);
  }
}
