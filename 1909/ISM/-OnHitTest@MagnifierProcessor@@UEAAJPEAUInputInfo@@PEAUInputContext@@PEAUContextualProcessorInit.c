/*
 * XREFs of ?OnHitTest@MagnifierProcessor@@UEAAJPEAUInputInfo@@PEAUInputContext@@PEAUContextualProcessorInitialState@@@Z @ 0x180105240
 * Callers:
 *     <none>
 * Callees:
 ...
 *     ?Active@MagnifierRecognizer@@QEAA_NXZ @ 0x180106278 (-Active@MagnifierRecognizer@@QEAA_NXZ.c)
