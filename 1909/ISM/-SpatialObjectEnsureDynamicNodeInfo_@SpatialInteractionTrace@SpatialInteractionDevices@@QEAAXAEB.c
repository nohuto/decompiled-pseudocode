/*
 * XREFs of ?SpatialObjectEnsureDynamicNodeInfo_@SpatialInteractionTrace@SpatialInteractionDevices@@QEAAXAEBU_GUID@@0@Z @ 0x1800ED9CC
 * Callers:
        ...
        const struct _GUID *a3)
{
  ...
  if ( *(_DWORD *)v5 > 4u )
  {
    if ( TlgKeywordOn(v5, 2uLL) )
    {
      ...
      v9 = a2;
      v12 = a3;
      TlgWrite(v7, &unk_18019F002, 0LL, 0LL, 4u, &pData);
    }
  }
}
