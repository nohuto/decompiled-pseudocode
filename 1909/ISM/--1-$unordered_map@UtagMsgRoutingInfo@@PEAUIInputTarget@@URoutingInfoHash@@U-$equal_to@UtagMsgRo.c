/*
 * XREFs of ??1?$unordered_map@UtagMsgRoutingInfo@@PEAUIInputTarget@@URoutingInfoHash@@U?$equal_to@UtagMsgRoutingInfo@@@std@@V?$allocator@U?$pair@$$CBUtagMsgRoutingInfo@@PEAUIInputTarget@@@std@@@5@@std@@QEAA@XZ @ 0x1800C22BC
 * Callers:
 *     _DWMInputRouter::DWMInputRouter_::_1_::dtor$1 @ 0x18003B6DB (_DWMInputRouter--DWMInputRouter_--_1_--dtor$1.c)
 * Callees:
        ...
        _QWORD *a1)
{
  ...
  *(_QWORD *)(a1[1] + 8LL) = a1[1];
  ...
  if ( v4 != v5 )
  {
    ...
    {
      v6 = (_QWORD *)*v4;
      std::_Deallocate<16,0>(v4, (const struct std::nothrow_t *)0x40);
      v5 = (_QWORD *)a1[1];
      v4 = v6;
    }
    while ( v6 != v5 );
