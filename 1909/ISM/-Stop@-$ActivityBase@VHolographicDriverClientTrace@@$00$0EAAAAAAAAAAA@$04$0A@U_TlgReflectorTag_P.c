/*
 * XREFs of ?Stop@?$ActivityBase@VHolographicDriverClientTrace@@$00$0EAAAAAAAAAAA@$04$0A@U_TlgReflectorTag_Param0IsProviderType@@@wil@@QEAAXJ@Z @ 0x18015E764
 * Callers:
        ...
        __int64 a1)
{
  ...
  else
  {
    ...
    if ( *(_DWORD *)v6 > 5u && TlgKeywordOn(*(TraceLoggingHProvider *)(v5 + 8), 0x400000000000uLL) )
    {
      ...
      v18 = (int *)&v8;
      v19 = 4;
      TlgWrite(v6, &unk_18019E3F6, (LPCGUID)(*(_QWORD *)(a1 + 48) + 8LL), 0LL, 5u, &pData);
    }
  }
  if ( *(_DWORD *)(a1 + 32) )
