 ...
 *     ?_Change_array@?$vector@V?$com_ptr_t@VAsyncStringPrincipal@@Uerr_exception_policy@wil@@@wil@@V?$allocator@V?$com_ptr_t@VAsyncStringPrincipal@@Uerr_exception_policy@wil@@@wil@@@std@@@std@@AEAAXQEAV?$com_ptr_t@VAsyncStringPrincipal@@Uerr_exception_policy@wil@@@wil@@_K1@Z @ 0x1801216B4 (-_Change_array@-$vector@V-$com_ptr_t@VAsyncStringPrincipal@@Uerr_exception_policy@wil@@@wil@@V-$.c)
 */
        ...
        void (__fastcall ****a3)(_QWORD))
{
  ...
  try
  {
    ...
    else
    {
      ...
      {
        v20 = v29;
        v25 = &v14[v29 - (_QWORD)v4];
        do
        {
          v26 = *(_QWORD *)v4;
          *(_QWORD *)v4 = 0LL;
          *(_QWORD *)&v4[(_QWORD)v25 + 8] = v26;
          v4 += 8;
        }
        while ( v4 != v16 );
        goto LABEL_15;
    ...
    v20 = v29;
LABEL_15:
    std::vector<wil::com_ptr_t<AsyncStringPrincipal,wil::err_exception_policy>>::_Change_array(a1, v14, v8, v11);
    result = (__int64)&(*a1)[v20];
  }
  catch ( ... )
  {
    std::vector<wil::com_ptr_t<BamoPenDevicePrincipal,wil::err_returncode_policy>>::_Destroy(v21, v30, v27);
    std::_Deallocate<16,0>(v28, (const struct std::nothrow_t *)(8 * v11));
    throw;
  }
  return result;
}
