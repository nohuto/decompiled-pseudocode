/*
 * XREFs of ?UnsuppressInputOfType@BamoInputObserverManagerPrincipalImpl@BamoImpl@@QEAAJW4InputObserverType@InputObservation@@I@Z @ 0x180067B90
 * Callers:
 *     ?Thunk_UnsuppressInputOfType_137@?$IInputObserverManagerPrincipal_Receive@VBamoInputObserverManagerPrincipalImpl@BamoImpl@@@@SAJPEAXPEAPEAX@Z @ 0x180067A20 (-Thunk_UnsuppressInputOfType_137@-$IInputObserverManagerPrincipal_Receive@VBamoInputObserverMana.c)
 * Callees:
        ...
        unsigned int a3)
{
  ...
  v13 = (*(__int64 (__fastcall **)(_QWORD *, __int64, _QWORD, char *))(*((_QWORD *)a1 - 2) + 96LL))(
          (_QWORD *)a1 - 2,
          v7,
          a2,
          v12);
