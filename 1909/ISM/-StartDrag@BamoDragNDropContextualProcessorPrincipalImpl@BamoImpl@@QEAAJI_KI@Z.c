/*
 * XREFs of ?StartDrag@BamoDragNDropContextualProcessorPrincipalImpl@BamoImpl@@QEAAJI_KI@Z @ 0x180069010
 * Callers:
 *     ?Thunk_StartDrag_90@?$IDragNDropContextualProcessorPrincipal_Receive@VBamoDragNDropContextualProcessorPrincipalImpl@BamoImpl@@@@SAJPEAXPEAPEAX@Z @ 0x1800691B0 (-Thunk_StartDrag_90@-$IDragNDropContextualProcessorPrincipal_Receive@VBamoDragNDropContextualPro.c)
 * Callees:
