/*
 * XREFs of ?CalculatePanDelta@ControllerProcessor@@AEAAJMM@Z @ 0x180075934
 * Callers:
...
__int64 __fastcall ControllerProcessor::CalculatePanDelta(ControllerProcessor *this, float a2, float a3)
{
  ...
  {
    v7 = sqrtf_0((float)(a3 * a3) + (float)(a2 * a2));
    if ( v7 > 1.0 )
    {
      v3 = a2 / v7;
      v4 = a3 / v7;
    ...
    if ( v8 == 0.0
      ...
      || *(float *)&dword_1801E0BD4 >= v10
      || v10 >= (float)(1.0 / *(float *)&dword_1801E0BD4) )
    {
    ...
    v12 = v9 + *((float *)this + 578);
    *((float *)this + 577) = v8 + *((float *)this + 577);
    *((float *)this + 578) = v12;
  }
  return 0LL;
}
