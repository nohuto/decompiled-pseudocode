/*
 * XREFs of SpatialInteractionDevices::ParseFloatData_DirectX::XMFLOAT4_ @ 0x1800DAA9C
 * Callers:
  ...
  for ( i = 0; i < 4; ++i )
    result = result
          && (int)SpatialInteractionDevices::Internal::HIDGetFloat(
                    this,
                    a2,
                    (struct SpatialInteractionDevices::HID_REPORT *)&unk_180171E00,
                    (enum _HIDP_REPORT_TYPE)*((unsigned __int16 *)&unk_180171E00 + 8 * i),
                    *((_WORD *)&unk_180171E00 + 8 * i + 1),
                    *((_WORD *)&unk_180171E00 + 8 * i + 2),
                    *((_WORD *)&unk_180171E00 + 8 * i + 3),
