/*
 * XREFs of ?CanCastTo@?$ImplementsHelper@U?$RuntimeClassFlags@$02@WRL@Microsoft@@$00UIWeakReferenceSource@@UIMPCManagerClient@MPCManager@Input@Internal@Windows@@UIMPCManagerConnection@6789@@Details@WRL@Microsoft@@IEAAJAEBU_GUID@@PEAPEAXPEA_N@Z @ 0x18011059C
 * Callers:
        ...
        _DWORD *a2)
{
  ...
  {
    if ( InlineIsEqualGUID(v2, &GUID_0020db1e_b549_408b_a7d5_fd458a887746) )
    {
      *v7 = v9;
    }
