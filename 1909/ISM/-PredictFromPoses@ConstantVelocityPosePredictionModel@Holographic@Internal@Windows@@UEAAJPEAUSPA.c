/*
 * XREFs of ?PredictFromPoses@ConstantVelocityPosePredictionModel@Holographic@Internal@Windows@@UEAAJPEAUSPATIAL_GRAPH_DYNAMIC_NODE_POSE@@_K_J0@Z @ 0x18015BC00
 * Callers:
 *     <none>
 * Callees:
 ...
 *     PoseClientStatics::SpatialGraphDifferentialsToSE3 @ 0x18015D728 (PoseClientStatics--SpatialGraphDifferentialsToSE3.c)
