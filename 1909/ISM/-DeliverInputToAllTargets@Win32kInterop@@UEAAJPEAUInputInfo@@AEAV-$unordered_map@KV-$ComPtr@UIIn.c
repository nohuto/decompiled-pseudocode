/*
 * XREFs of ?DeliverInputToAllTargets@Win32kInterop@@UEAAJPEAUInputInfo@@AEAV?$unordered_map@KV?$ComPtr@UIInputTarget@@@WRL@Microsoft@@U?$hash@K@std@@U?$equal_to@K@5@V?$allocator@U?$pair@$$CBKV?$ComPtr@UIInputTarget@@@WRL@Microsoft@@@std@@@5@@std@@@Z @ 0x1800BBB40
 * Callers:
 *     <none>
 * Callees:
 ...
 *     ?GetSizeForPointerCount@PointerInputInfo@@SAKK@Z @ 0x180075E04 (-GetSizeForPointerCount@PointerInputInfo@@SAKK@Z.c)
