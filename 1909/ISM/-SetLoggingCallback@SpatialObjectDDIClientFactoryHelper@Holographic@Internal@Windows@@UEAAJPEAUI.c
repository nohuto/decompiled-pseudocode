/*
 * XREFs of ?SetLoggingCallback@SpatialObjectDDIClientFactoryHelper@Holographic@Internal@Windows@@UEAAJPEAUISpatialObjectDDIClientLoggingCallback@234@@Z @ 0x1800ED670
 * Callers:
 *     <none>
 * Callees:
