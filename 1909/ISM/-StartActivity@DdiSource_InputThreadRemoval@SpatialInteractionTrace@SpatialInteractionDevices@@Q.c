/*
 * XREFs of ?StartActivity@DdiSource_InputThreadRemoval@SpatialInteractionTrace@SpatialInteractionDevices@@QEAAXPEB_WAEBU_GUID@@@Z @ 0x1800EDF84
 * Callers:
        ...
        const struct _GUID *a3)
{
  ...
  if ( *(_DWORD *)v7 > 4u )
  {
    ...
    TlgWrite(v7, &unk_18019EF32, (LPCGUID)(*((_QWORD *)this + 6) + 8LL), v8, 6u, &pData);
  }
  if ( !*((_DWORD *)this + 8) )
