/*
 * XREFs of ??0SubscriptionList@details_abi@wil@@QEAA@XZ @ 0x1800290E8
 * Callers:
 *     ?construct@?$manually_managed_shutdown_aware_object@VFeatureStateManager@details@wil@@@wil@@QEAAXXZ @ 0x18002AF2C (-construct@-$manually_managed_shutdown_aware_object@VFeatureStateManager@details@wil@@@wil@@QEAA.c)
