        ...
        __int64 *a5)
{
  ...
  try
  {
    ...
    if ( *(_DWORD *)(v12 + 32) >= *a4 )
    {
      Microsoft::WRL::ComPtr<InputRedirectionProcessor>::InternalRelease(a5 + 6);
