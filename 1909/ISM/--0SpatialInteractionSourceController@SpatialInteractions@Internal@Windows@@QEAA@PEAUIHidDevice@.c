/*
 * XREFs of ??0SpatialInteractionSourceController@SpatialInteractions@Internal@Windows@@QEAA@PEAUIHidDevice@123@KKV?$function@$$A6AXXZ@std@@@Z @ 0x180162D7C
 * Callers:
 ...
 *     ??0SpatialInteractionSourceDevice@SpatialInteractions@Internal@Windows@@QEAA@KKW4InputType@@@Z @ 0x1801630F4 (--0SpatialInteractionSourceDevice@SpatialInteractions@Internal@Windows@@QEAA@KKW4InputType@@@Z.c)
        ...
        __int64 a5)
{
  ...
  _QWORD *v16; // rax
  __int64 v17; // rdx
  __m256i v19; // [rsp+28h] [rbp-48h] BYREF
  ...
  *((_WORD *)this + 592) = 0;
  memset_0((char *)this + 1024, 0, 0xA0uLL);
  memset_0((char *)this + 960, 0, 0x40uLL);
  v19.m256i_i64[0] = qword_1801E1420;
  v19.m256i_i32[2] = dword_1801E1428;
  *(_OWORD *)((char *)&v19.m256i_u64[1] + 4) = xmmword_1801994A8;
  ...
  *((_BYTE *)this + 804) = 100;
  ...
  if ( v16 )
  {
    ...
    *v16 = 0LL;
    ...
    v16[3] = 0LL;
    *((_DWORD *)v16 + 8) = 0;
    *(_QWORD *)((char *)v16 + 36) = 0LL;
    *(_QWORD *)((char *)v16 + 44) = 0LL;
    *(_QWORD *)((char *)v16 + 52) = 0LL;
    *((_DWORD *)v16 + 15) = 0;
  }
  else
  {
