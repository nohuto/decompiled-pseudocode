/*
 * XREFs of ?SetOnlyMixedWorldRouting@BamoMPCManagerProxyImpl@BamoImpl@@QEAAJ_N@Z @ 0x1801146F0
 * Callers:
...
__int64 __fastcall BamoImpl::BamoMPCManagerProxyImpl::SetOnlyMixedWorldRouting(BamoImpl::BamoMPCManagerProxyImpl *this)
{
  int v1; // ebx
  __int64 v2; // rdx
