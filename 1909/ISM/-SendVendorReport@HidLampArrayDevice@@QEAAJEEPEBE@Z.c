/*
 * XREFs of ?SendVendorReport@HidLampArrayDevice@@QEAAJEEPEBE@Z @ 0x1800B5408
 * Callers:
        ...
        const unsigned __int8 *a4)
{
  ...
  if ( (unsigned int)hProvider > 5 )
  {
    ...
    TlgWrite((TraceLoggingHProvider)&hProvider, &unk_18019D65E, 0LL, 0LL, 4u, &pData);
  }
    ...
    *v16 = a2;
    ...
    if ( HidD_SetFeature(*(HANDLE *)(*((_QWORD *)this + 2) + 40LL), ReportBuffer, v11) )
    {
      if ( (unsigned int)hProvider > 5 )
      {
        ...
        TlgWrite((TraceLoggingHProvider)&hProvider, &unk_18019D65E, 0LL, 0LL, 4u, &v27);
      }
