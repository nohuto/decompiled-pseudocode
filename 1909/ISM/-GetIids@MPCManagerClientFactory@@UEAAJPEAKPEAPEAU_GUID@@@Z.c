/*
 * XREFs of ?GetIids@MPCManagerClientFactory@@UEAAJPEAKPEAPEAU_GUID@@@Z @ 0x180111300
 * Callers:
 *     ?GetIids@MPCManagerClientFactory@@WCI@EAAJPEAKPEAPEAU_GUID@@@Z @ 0x180039260 (-GetIids@MPCManagerClientFactory@@WCI@EAAJPEAKPEAPEAU_GUID@@@Z.c)
 * Callees:
 *     <none>
 */
