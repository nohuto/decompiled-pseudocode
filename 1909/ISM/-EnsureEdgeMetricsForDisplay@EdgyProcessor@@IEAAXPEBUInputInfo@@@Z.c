/*
 * XREFs of ?EnsureEdgeMetricsForDisplay@EdgyProcessor@@IEAAXPEBUInputInfo@@@Z @ 0x1801008E8
 * Callers:
 ...
 *     ?HimetricToPixels@EdgyProcessor@@QEAAXPEAUD2D_VECTOR_2F@@@Z @ 0x1801009E4 (-HimetricToPixels@EdgyProcessor@@QEAAXPEAUD2D_VECTOR_2F@@@Z.c)
