/*
 * XREFs of ??$_Create@UISpatialGraphNodeReferenceFactory@Holographic@Internal@Windows@@@?$Singleton@VSpatialGraphNodeReferenceFactory@Holographic@Internal@Windows@@V1234@@WRL@Microsoft@@CAJPEAPEAUISpatialGraphNodeReferenceFactory@Holographic@Internal@Windows@@W4Behavior@012@@Z @ 0x18014BDF4
 * Callers:
        ...
        _QWORD *a1)
{
  ...
  __int64 v11; // rcx
  std::_Ref_count_base *v13[2]; // [rsp+30h] [rbp-10h]
      ...
      if ( v2 >= 0 && !v14 )
      {
        *(_OWORD *)v13 = 0LL;
        ...
        else
        {
          ...
          v2 = Microsoft::WRL::AsWeak<Windows::Internal::SpatialInteractions::ISpatialInteractionSourceDeviceCollectionInternal>(
                 v5,
                 v6);
          v15 = 0LL;
