/*
 * XREFs of ?OnComboButtonRegistryComplete@ButtonRecognizer@@AEAAJIPEAUtagMsgRoutingInfo@@@Z @ 0x1800FD924
 * Callers:
        ...
        struct tagMsgRoutingInfo *a3)
{
  ...
  v9 = 0LL;
  v4 = (*(__int64 (__fastcall **)(_QWORD, struct tagMsgRoutingInfo *, __int64 *))(**((_QWORD **)this + 20) + 104LL))(
         *((_QWORD *)this + 20),
         a3,
         &v9);
  if ( v4 < 0 )
...
LABEL_3:
  ...
  (*(void (__fastcall **)(_QWORD, __int64))(**((_QWORD **)this + 20) + 152LL))(*((_QWORD *)this + 20), v9);
  return 0LL;
}
