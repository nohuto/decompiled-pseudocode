/*
 * XREFs of ??$emplace@AEAKH@?$_Hash@V?$_Umap_traits@K_KV?$_Uhash_compare@KU?$hash@K@std@@U?$equal_to@K@2@@std@@V?$allocator@U?$pair@$$CBK_K@std@@@2@$0A@@std@@@std@@QEAA?AU?$pair@V?$_List_iterator@V?$_List_val@U?$_List_simple_types@U?$pair@$$CBK_K@std@@@std@@@std@@@std@@_N@1@AEAK$$QEAH@Z @ 0x1800FE1AC
 * Callers:
        ...
        int *a4)
{
  ...
  v8 = (__int64)*v5;
  v9 = (_QWORD *)(*v5)[1];
  v10 = std::_List_buy<std::pair<unsigned long const,unsigned __int64>>::_Buynode<unsigned long &,int>(
          a1,
          *v5,
          v9,
          a3,
