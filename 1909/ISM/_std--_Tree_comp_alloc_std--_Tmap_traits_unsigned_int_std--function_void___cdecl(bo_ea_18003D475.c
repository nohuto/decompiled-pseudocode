...
void __fastcall __noreturn std::_Tree_comp_alloc_std::_Tmap_traits_unsigned_int_std::function_void___cdecl_bool___std::less_unsigned_int__std::allocator_std::pair_unsigned_int_const__std::function_void___cdecl_bool_______0___::_Buynode_std::piecewise_construct_t_const___std::tuple_unsigned_int_const____std::tuple_____::_1_::catch_7(
        __int64 a1,
        __int64 a2)
{
  std::_Deallocate<16,0>(*(void **)(a2 + 88), (const struct std::nothrow_t *)0x68);
  throw;
}
