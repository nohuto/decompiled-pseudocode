/*
 * XREFs of std::_Func_impl_no_alloc__lambda_058d11e6f27672706f8c366ba991dba7__void__MIT_DEVICE_IDENTIFICATION_MESSAGE_const___::_Do_call @ 0x180014B30
 * Callers:
 *     <none>
 * Callees:
    ...
    if ( TlgKeywordOn(v1, 1uLL) )
    {
      ...
      if ( **(_DWORD **)(v3 + 8) > 6u )
      {
        if ( TlgKeywordOn(*(TraceLoggingHProvider *)(v3 + 8), 1uLL) )
        {
          ...
          TlgWrite(v4, &unk_18019D8C8, &ActivityId, pRelatedActivityId, 3u, &pData);
        }
      }
    }
  }
