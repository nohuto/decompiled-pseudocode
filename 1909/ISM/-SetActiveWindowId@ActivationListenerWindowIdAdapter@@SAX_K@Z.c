/*
 * XREFs of ?SetActiveWindowId@ActivationListenerWindowIdAdapter@@SAX_K@Z @ 0x18000C120
 * Callers:
 ...
 *     ??$As@UIActivationListenerInputObjectProxy@@@?$ComPtr@UIUnknown@@@WRL@Microsoft@@QEBAJV?$ComPtrRef@V?$ComPtr@UIActivationListenerInputObjectProxy@@@WRL@Microsoft@@@Details@12@@Z @ 0x18000DE28 (--$As@UIActivationListenerInputObjectProxy@@@-$ComPtr@UIUnknown@@@WRL@Microsoft@@QEBAJV-$ComPtrR.c)
