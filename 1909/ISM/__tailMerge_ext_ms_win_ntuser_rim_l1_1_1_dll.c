/*
 * XREFs of __tailMerge_ext_ms_win_ntuser_rim_l1_1_1_dll @ 0x18002DA0B
 * Callers:
 *     __imp_load_InitializePointerDeviceInjectionEx @ 0x18002D9FF (__imp_load_InitializePointerDeviceInjectionEx.c)
 * Callees:
