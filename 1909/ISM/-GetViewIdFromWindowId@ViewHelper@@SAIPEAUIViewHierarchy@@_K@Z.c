/*
 * XREFs of ?GetViewIdFromWindowId@ViewHelper@@SAIPEAUIViewHierarchy@@_K@Z @ 0x18005869C
 * Callers:
 ...
 *     ?FindView@ViewHelper@@SAJPEAUIViewHierarchy@@V?$function@$$A6A_NPEAUIMonitorView@Server@Navigation@@@Z@std@@PEAPEAUIMonitorView@Server@Navigation@@@Z @ 0x180057CB0 (-FindView@ViewHelper@@SAJPEAUIViewHierarchy@@V-$function@$$A6A_NPEAUIMonitorView@Server@Navigati.c)
 */
