/*
 * XREFs of ?Stop@?$ActivityBase@VHolographicDriverClientContinuousTrace@@$0A@$0A@$04$0A@U_TlgReflectorTag_Param0IsProviderType@@@wil@@QEAAXJ@Z @ 0x18015E634
 * Callers:
        ...
        __int64 a1)
{
  ...
  else
  {
    ...
    if ( *(_DWORD *)v5 > 5u )
    {
      ...
      v17 = (int *)&v7;
      v18 = 4;
      TlgWrite(v5, &unk_18019E769, (LPCGUID)(*(_QWORD *)(a1 + 48) + 8LL), 0LL, 5u, &pData);
    }
  }
  if ( *(_DWORD *)(a1 + 32) )
