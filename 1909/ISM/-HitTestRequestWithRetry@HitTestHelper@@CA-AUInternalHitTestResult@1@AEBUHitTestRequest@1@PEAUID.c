/*
 * XREFs of ?HitTestRequestWithRetry@HitTestHelper@@CA?AUInternalHitTestResult@1@AEBUHitTestRequest@1@PEAUIDWMInputProxy@@@Z @ 0x18000CD40
 * Callers:
 ...
 *     ?_Tidy@?$vector@PEAXV?$allocator@PEAX@std@@@std@@AEAAXXZ @ 0x1800086B8 (-_Tidy@-$vector@PEAXV-$allocator@PEAX@std@@@std@@AEAAXXZ.c)
 ...
 *     ??0?$vector@PEAXV?$allocator@PEAX@std@@@std@@QEAA@_KAEBV?$allocator@PEAX@1@@Z @ 0x1800C7B68 (--0-$vector@PEAXV-$allocator@PEAX@std@@@std@@QEAA@_KAEBV-$allocator@PEAX@1@@Z.c)
 */
        ...
        __int64 (__fastcall ***a3)(_QWORD, __int128 *))
{
    ...
    if ( TlgKeywordOn(v6, 1uLL) )
    {
      ...
      if ( **(_DWORD **)(v25 + 8) > 6u )
      {
        if ( TlgKeywordOn(*(TraceLoggingHProvider *)(v25 + 8), 1uLL) )
        {
          ...
          TlgWrite(v26, &unk_18019D8C8, &ActivityId, pRelatedActivityId, 3u, &pData);
        }
      }
    }
  }
  ...
  *(_DWORD *)(a1 + 116) = v22;
  ...
  {
    TlgCreateWsz(&pDesc, pwsz);
    TlgWrite(v40, &unk_18019D8E7, &ActivityId, pRelatedActivityId, 3u, &pData);
  }
  return a1;
}
