/*
 * XREFs of ?RuntimeClassInitialize@HapticsEngine@SpatialInteractions@Internal@Windows@@QEAAJ_N_J1E00V?$function@$$A6AXE@Z@std@@PEAUIHapticsTimerProvider@234@@Z @ 0x180167CC4
 * Callers:
 ...
 *     ??0AverageHapticsFilter@SpatialInteractions@Internal@Windows@@QEAA@_JH_N1@Z @ 0x180162988 (--0AverageHapticsFilter@SpatialInteractions@Internal@Windows@@QEAA@_JH_N1@Z.c)
 */
