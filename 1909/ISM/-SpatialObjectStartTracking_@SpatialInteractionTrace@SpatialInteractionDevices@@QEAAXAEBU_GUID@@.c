/*
 * XREFs of ?SpatialObjectStartTracking_@SpatialInteractionTrace@SpatialInteractionDevices@@QEAAXAEBU_GUID@@JW4SPATIAL_TRACKING_STATE@@AEBUDynamicNodeInfo@Holographic@Internal@Windows@@@Z @ 0x1800EDA78
 * Callers:
        ...
        __int64 a5)
{
  ...
  if ( *(_DWORD *)v8 > 4u )
  {
    ...
    if ( (_BYTE)v7 )
    {
      ...
      v23 = a5;
      v24 = 16LL;
      LOBYTE(v7) = TlgWrite(v9, &unk_18019F808, 0LL, 0LL, 7u, &pData);
    }
  }
  return (char)v7;
}
