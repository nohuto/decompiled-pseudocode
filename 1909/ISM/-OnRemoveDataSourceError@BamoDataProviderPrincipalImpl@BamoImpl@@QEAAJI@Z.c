/*
 * XREFs of ?OnRemoveDataSourceError@BamoDataProviderPrincipalImpl@BamoImpl@@QEAAJI@Z @ 0x1800D03B4
 * Callers:
 *     ?Thunk_OnRemoveDataSourceError_5@?$IDataProviderPrincipal_Receive@VBamoDataProviderPrincipalImpl@BamoImpl@@@@SAJPEAXPEAPEAX@Z @ 0x1800D1C10 (-Thunk_OnRemoveDataSourceError_5@-$IDataProviderPrincipal_Receive@VBamoDataProviderPrincipalImpl.c)
 * Callees:
