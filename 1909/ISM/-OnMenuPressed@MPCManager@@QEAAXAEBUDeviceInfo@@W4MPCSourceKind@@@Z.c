/*
 * XREFs of ?OnMenuPressed@MPCManager@@QEAAXAEBUDeviceInfo@@W4MPCSourceKind@@@Z @ 0x18007E8FC
 * Callers:
...
__int64 __fastcall MPCManager::OnMenuPressed(__int64 a1, __int64 a2, unsigned int a3)
{
  __int64 *v3; // rbx
  __int64 result; // rax
  int v7; // eax
  ...
  {
    v7 = (*(__int64 (__fastcall **)(_QWORD, __int64, _QWORD))(**(_QWORD **)(result + 40) + 32LL))(
           *(_QWORD *)(result + 40),
           a2,
           a3);
    if ( v7 < 0 )
