/*
 * XREFs of ?UpdateMagnifierServer@BamoInputSystemProxyImpl@BamoImpl@@QEAAJI@Z @ 0x180064720
 * Callers:
 *     ?Thunk_UpdateMagnifierServer_0@?$IInputSystemProxy_Receive@VBamoInputSystemProxyImpl@BamoImpl@@@@SAJPEAXPEAPEAX@Z @ 0x180063770 (-Thunk_UpdateMagnifierServer_0@-$IInputSystemProxy_Receive@VBamoInputSystemProxyImpl@BamoImpl@@@.c)
 * Callees:
