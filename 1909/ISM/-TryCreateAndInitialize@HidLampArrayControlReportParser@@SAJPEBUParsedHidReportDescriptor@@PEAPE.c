/*
 * XREFs of ?TryCreateAndInitialize@HidLampArrayControlReportParser@@SAJPEBUParsedHidReportDescriptor@@PEAPEAV1@@Z @ 0x1800B96B4
 * Callers:
        ...
        struct HidLampArrayControlReportParser **a2)
{
  ...
  *a2 = 0LL;
  ...
  if ( v5 )
  {
    ...
    v9 = (unsigned int)(*(_DWORD *)(*((_QWORD *)a1 + 2) + 72LL * (unsigned int)(*((_DWORD *)a1 + 2) - 1) + 4)
                      + *(_DWORD *)(*((_QWORD *)a1 + 2) + 72LL * (unsigned int)(*((_DWORD *)a1 + 2) - 1))
                      + 7) >> 3;
    *((_DWORD *)v5 + 5) = v9;
    if ( v5[17] == 2 && HidChannelValueInfo::IsValid((HidChannelValueInfo *)(v5 + 24), v9, 1LL) )
    {
      v6 = 0LL;
