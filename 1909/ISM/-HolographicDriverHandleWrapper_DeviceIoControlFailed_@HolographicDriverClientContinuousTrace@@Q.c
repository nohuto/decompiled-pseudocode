/*
 * XREFs of ?HolographicDriverHandleWrapper_DeviceIoControlFailed_@HolographicDriverClientContinuousTrace@@QEAAXKKPEBXAEBU_GUID@@@Z @ 0x180158DD4
 * Callers:
        ...
        const struct _GUID *a5)
{
  ...
  if ( *(_DWORD *)v5 > 5u )
  {
    if ( TlgKeywordOn(v5, 2uLL) )
    {
      ...
      v15 = 8LL;
      v17 = 16LL;
      TlgWrite(v6, &unk_1801A229B, 0LL, 0LL, 7u, &pData);
    }
  }
}
