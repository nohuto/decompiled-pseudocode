/*
 * XREFs of ?Thunk_UpdateType_45@?$IDragAreaClientProxy_Receive@VBamoDragAreaClientProxyImpl@BamoImpl@@@@SAJPEAXPEAPEAX@Z @ 0x180063910
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall IDragAreaClientProxy_Receive<BamoImpl::BamoDragAreaClientProxyImpl>::Thunk_UpdateType_45(
        __int64 a1,
        _OWORD **a2)
{
  int v3; // eax
