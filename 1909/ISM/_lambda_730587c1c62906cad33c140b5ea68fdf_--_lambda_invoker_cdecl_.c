/*
 * XREFs of _lambda_730587c1c62906cad33c140b5ea68fdf_::_lambda_invoker_cdecl_ @ 0x180161C00
 * Callers:
 *     <none>
 * Callees:
 *     ??R?$_Func_class@X$$V@std@@QEBAXXZ @ 0x180080478 (--R-$_Func_class@X$$V@std@@QEBAXXZ.c)
 *     ?EnsureWorkerTimer@KeepAliveTimer@ThreadpoolTimerHelpers@@AEAAX_K@Z @ 0x1800E2154 (-EnsureWorkerTimer@KeepAliveTimer@ThreadpoolTimerHelpers@@AEAAX_K@Z.c)
 */
