/*
 * XREFs of ?ResultFromCaughtExceptionInternal@details@wil@@YAJPEAG_KPEA_N@Z @ 0x1800514F0
 * Callers:
 *     <none>
 * Callees:
        ...
        bool *a4)
{
  ...
  wchar_t *v18; // [rsp+60h] [rbp+8h]
  const struct wil::ResultException *v19; // [rsp+60h] [rbp+8h]
  wchar_t *v20; // [rsp+60h] [rbp+8h]
  wchar_t *v21; // [rsp+60h] [rbp+8h]
