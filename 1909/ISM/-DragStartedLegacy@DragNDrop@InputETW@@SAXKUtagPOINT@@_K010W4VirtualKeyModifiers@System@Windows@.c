/*
 * XREFs of ?DragStartedLegacy@DragNDrop@InputETW@@SAXKUtagPOINT@@_K010W4VirtualKeyModifiers@System@Windows@@@Z @ 0x1800FEE10
 * Callers:
  ...
  if ( (_BYTE)v10 )
  {
    ...
    if ( *(_DWORD *)v12 > 5u )
    {
      ...
      if ( (_BYTE)v10 )
      {
        ...
        v49 = 8;
        v52 = 8;
        LOBYTE(v10) = TlgWrite(v13, &unk_1801A0535, 0LL, 0LL, 0xCu, &pData);
      }
    }
  }
  return (char)v10;
