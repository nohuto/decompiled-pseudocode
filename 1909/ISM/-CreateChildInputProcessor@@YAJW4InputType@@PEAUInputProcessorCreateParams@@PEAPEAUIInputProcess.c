/*
 * XREFs of ?CreateChildInputProcessor@@YAJW4InputType@@PEAUInputProcessorCreateParams@@PEAPEAUIInputProcessor@@@Z @ 0x18001666C
 * Callers:
 ...
 *     ?CreateInputProcessorWorker@@YAJPEAUInputProcessorCreateParams@@PEAPEAUIInputProcessor@@W4InputType@@H@Z @ 0x180019478 (-CreateInputProcessorWorker@@YAJPEAUInputProcessorCreateParams@@PEAPEAUIInputProcessor@@W4InputT.c)
 *     ?ValidateParams@@YAJPEBUInputProcessorCreateParams@@_N@Z @ 0x18002AB00 (-ValidateParams@@YAJPEBUInputProcessorCreateParams@@_N@Z.c)
 *     ?IsSingleBit@@YAHJ@Z @ 0x18002AC98 (-IsSingleBit@@YAHJ@Z.c)
