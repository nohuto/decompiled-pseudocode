/*
 * XREFs of ?EnsureServiceAndRegisterClient@SystemCursorController@@MEAAJPEAVBamoSystemCursorControllerStub@@PEAVBamoSystemCursorControllerClientProxy@@@Z @ 0x1800CA300
 * Callers:
 *     <none>
 * Callees:
        ...
        struct BamoSystemCursorControllerClientProxy *a3)
{
  ...
  SystemCursorService *v14; // [rsp+28h] [rbp-30h] BYREF
  std::_Ref_count_base *v15; // [rsp+30h] [rbp-28h]
  wil::details::in1diag3 *retaddr; // [rsp+58h] [rbp+0h]
  unsigned int v17; // [rsp+60h] [rbp+8h] BYREF
  struct BamoSystemCursorControllerClientProxy *v18; // [rsp+68h] [rbp+10h] BYREF
  struct SystemCursorController *v19; // [rsp+70h] [rbp+18h] BYREF
  ...
  *((_DWORD *)this + 18) = 0;
  std::_Tree<std::_Tmap_traits<__int64,std::shared_ptr<Windows::Internal::SpatialInteractions::SpatialInteractionSourceDevice>,std::less<__int64>,std::allocator<std::pair<__int64 const,std::shared_ptr<Windows::Internal::SpatialInteractions::SpatialInteractionSourceDevice>>>,0>>::clear((char *)this + 80);
  *((_QWORD *)this + 12) = 0LL;
