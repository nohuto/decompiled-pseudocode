/*
 * XREFs of ?SetButtonRoutingPolicy@PenEventsDispatcherPrincipal@@MEAAJPEAVBamoPenEventsDispatcherStub@@W4RoutingPolicy@Input@Devices@Internal@Windows@@@Z @ 0x180032BC0
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall PenEventsDispatcherPrincipal::SetButtonRoutingPolicy(__int64 a1, __int64 a2, int a3)
{
  ...
  if ( *(_DWORD *)v5 > 4u && TlgKeywordOn(v5, 0x200uLL) )
  {
    ...
    TlgWrite(v7, &unk_18019B457, 0LL, 0LL, 3u, &pData);
  }
