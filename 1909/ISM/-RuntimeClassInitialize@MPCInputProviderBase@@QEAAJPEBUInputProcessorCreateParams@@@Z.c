/*
 * XREFs of ?RuntimeClassInitialize@MPCInputProviderBase@@QEAAJPEBUInputProcessorCreateParams@@@Z @ 0x180021264
 * Callers:
 ...
 *     ?Initialize@MPCPerfCounter@@QEAAXKI@Z @ 0x1800213D8 (-Initialize@MPCPerfCounter@@QEAAXKI@Z.c)
