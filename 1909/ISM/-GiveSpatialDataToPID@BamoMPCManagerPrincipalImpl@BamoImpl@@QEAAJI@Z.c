/*
 * XREFs of ?GiveSpatialDataToPID@BamoMPCManagerPrincipalImpl@BamoImpl@@QEAAJI@Z @ 0x18007DE24
 * Callers:
 *     ?Thunk_GiveSpatialDataToPID_25@?$IMPCManagerPrincipal_Receive@VBamoMPCManagerPrincipalImpl@BamoImpl@@@@SAJPEAXPEAPEAX@Z @ 0x18007F6D0 (-Thunk_GiveSpatialDataToPID_25@-$IMPCManagerPrincipal_Receive@VBamoMPCManagerPrincipalImpl@BamoI.c)
 * Callees:
        ...
        unsigned int a2)
{
  ...
  v6 = (*(__int64 (__fastcall **)(char *, __int64, _QWORD))(*((_QWORD *)this - 2) + 72LL))((char *)this - 16, v5, a2);
  if ( v6 < 0 )
