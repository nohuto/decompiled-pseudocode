/*
 * XREFs of ?EnsureDisplayWatcher@SpatialInteractionSourceDeviceCollection@SpatialInteractions@Internal@Windows@@AEAAJAEBVSyncLockCriticalSection@Details@Wrappers@WRL@Microsoft@@@Z @ 0x1800E1C30
 * Callers:
...
LABEL_3:
  ...
  if ( !this[41] )
  {
    ...
    v6 = (**(__int64 (__fastcall ***)(volatile int *, GUID *, __int64 *))this[51])(
           this[51],
