/*
 * XREFs of ?QueryInterface@DragNDropProcessorLegacy@@UEAAJAEBU_GUID@@PEAPEAX@Z @ 0x1800FF9D0
 * Callers:
 *     ?QueryInterface@DragNDropProcessorLegacy@@W7EAAJAEBU_GUID@@PEAPEAX@Z @ 0x180038FA0 (-QueryInterface@DragNDropProcessorLegacy@@W7EAAJAEBU_GUID@@PEAPEAX@Z.c)
 * Callees:
