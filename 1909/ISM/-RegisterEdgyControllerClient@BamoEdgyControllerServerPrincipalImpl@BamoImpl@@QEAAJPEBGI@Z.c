/*
 * XREFs of ?RegisterEdgyControllerClient@BamoEdgyControllerServerPrincipalImpl@BamoImpl@@QEAAJPEBGI@Z @ 0x18006F4E4
 * Callers:
 *     ?Thunk_RegisterEdgyControllerClient_118@?$IEdgyControllerServerPrincipal_Receive@VBamoEdgyControllerServerPrincipalImpl@BamoImpl@@@@SAJPEAXPEAPEAX@Z @ 0x18006F660 (-Thunk_RegisterEdgyControllerClient_118@-$IEdgyControllerServerPrincipal_Receive@VBamoEdgyContro.c)
 * Callees:
