/*
 * XREFs of ?SendLampMultiUpdateReport@HidLampArrayDevice@@QEAAJPEBULampMultiUpdateDeviceReport@@@Z @ 0x1800B50C8
 * Callers:
        ...
        const struct LampMultiUpdateDeviceReport *a2)
{
  ...
  if ( (unsigned int)hProvider > 5 )
  {
    ...
    TlgWrite((TraceLoggingHProvider)&hProvider, &unk_18019D6FD, 0LL, 0LL, 4u, &pData);
  }
  v4 = *((_QWORD *)this + 76);
  ReportBufferLength = 0;
  ReportBuffer = 0LL;
  v5 = HidLampMultiUpdateReportParser::CreateAndInitializeOutputBuffer(v4, a2, &ReportBuffer, &ReportBufferLength);
  v6 = v5;
  if ( v5 >= 0 )
  {
    v9 = ReportBuffer;
    if ( HidD_SetFeature(*(HANDLE *)(*((_QWORD *)this + 2) + 40LL), ReportBuffer, ReportBufferLength) )
    {
      if ( (unsigned int)hProvider > 5 )
      {
        ...
        TlgWrite((TraceLoggingHProvider)&hProvider, &unk_18019D6FD, 0LL, 0LL, 4u, &v21);
      }
      if ( v9 )
