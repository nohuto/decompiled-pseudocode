/*
 * XREFs of ?ApplyCursorAttraction@CursorAttraction@@QEAA?AUtagPOINT@@AEBU2@AEBUtagRECT@@@Z @ 0x1800F7808
 * Callers:
 ...
 * Callees:
 *     operator___0 @ 0x1800F77DC (operator___0.c)
 *     ?ClampCursorAttractionDelta@CursorAttraction@@AEAA?AUXMFLOAT2@DirectX@@AEBUtagPOINT@@@Z @ 0x1800F79B0 (-ClampCursorAttractionDelta@CursorAttraction@@AEAA-AUXMFLOAT2@DirectX@@AEBUtagPOINT@@@Z.c)
 *     ?ComputeAverageCursorVelocity@CursorAttraction@@AEAA?AUXMFLOAT2@DirectX@@XZ @ 0x1800F7A38 (-ComputeAverageCursorVelocity@CursorAttraction@@AEAA-AUXMFLOAT2@DirectX@@XZ.c)
 *     ?IsCursorAtRest@CursorAttraction@@AEAA_NXZ @ 0x1800F7B0C (-IsCursorAtRest@CursorAttraction@@AEAA_NXZ.c)
 *     ?IsPointInRect@CursorAttraction@@AEAA_NAEBUtagPOINT@@AEBUtagRECT@@@Z @ 0x1800F7BA0 (-IsPointInRect@CursorAttraction@@AEAA_NAEBUtagPOINT@@AEBUtagRECT@@@Z.c)
