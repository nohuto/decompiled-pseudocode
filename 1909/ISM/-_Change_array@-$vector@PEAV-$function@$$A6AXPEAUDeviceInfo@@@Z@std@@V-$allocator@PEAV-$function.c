/*
 * XREFs of ?_Change_array@?$vector@PEAV?$function@$$A6AXPEAUDeviceInfo@@@Z@std@@V?$allocator@PEAV?$function@$$A6AXPEAUDeviceInfo@@@Z@std@@@2@@std@@AEAAXQEAPEAV?$function@$$A6AXPEAUDeviceInfo@@@Z@2@_K1@Z @ 0x1800AF9C0
 * Callers:
