/*
 * XREFs of ??0?$RuntimeClass@U?$RuntimeClassFlags@$01@WRL@Microsoft@@UIRawInputProvider@@VMPCInputProviderBase@@@WRL@Microsoft@@QEAA@XZ @ 0x180136C24
 * Callers:
        ...
        __int64 a1)
{
  ...
  *(_QWORD *)(a1 + 24) = &MPCGamepadProcessor::`vftable'{for `IInputFocusListener'};
