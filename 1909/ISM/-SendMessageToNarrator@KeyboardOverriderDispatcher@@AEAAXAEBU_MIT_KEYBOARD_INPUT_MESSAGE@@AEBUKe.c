/*
 * XREFs of ?SendMessageToNarrator@KeyboardOverriderDispatcher@@AEAAXAEBU_MIT_KEYBOARD_INPUT_MESSAGE@@AEBUKeyboardInputInfo@@@Z @ 0x1800C0BD8
 * Callers:
 ...
 *     ?push_back@?$deque@UKeyboardEvent@@V?$allocator@UKeyboardEvent@@@std@@@std@@QEAAXAEBUKeyboardEvent@@@Z @ 0x1800C1520 (-push_back@-$deque@UKeyboardEvent@@V-$allocator@UKeyboardEvent@@@std@@@std@@QEAAXAEBUKeyboardEve.c)
 *     ?CreateKeyboardEvent@InputServiceProcessor@@SA?AUKeyboardEvent@@QEBUKeyboardInputInfo@@@Z @ 0x1801078FC (-CreateKeyboardEvent@InputServiceProcessor@@SA-AUKeyboardEvent@@QEBUKeyboardInputInfo@@@Z.c)
 */
        ...
        const struct KeyboardInputInfo *a3)
{
  ...
  int v33; // edx
  int v34; // eax
  int cchBuff; // [rsp+28h] [rbp-E0h]
  int wFlags; // [rsp+30h] [rbp-D8h]
  WCHAR pwszBuff[4]; // [rsp+58h] [rbp-B0h] BYREF
  int v38[2]; // [rsp+60h] [rbp-A8h] BYREF
  int v39[2]; // [rsp+68h] [rbp-A0h] BYREF
  WCHAR *v40; // [rsp+70h] [rbp-98h]
  __int64 v41; // [rsp+78h] [rbp-90h]
  __int64 v42; // [rsp+80h] [rbp-88h] BYREF
  int v43; // [rsp+1A8h] [rbp+A0h] BYREF
  unsigned __int16 v44; // [rsp+1B0h] [rbp+A8h]
  unsigned __int64 v45; // [rsp+1B8h] [rbp+B0h]
  __int64 v46; // [rsp+1C0h] [rbp+B8h]
  unsigned __int16 v47[4]; // [rsp+2D8h] [rbp+1D0h] BYREF
  _BYTE v48[40]; // [rsp+2E0h] [rbp+1D8h] BYREF
  ...
  {
    *((_BYTE *)this + 360) = 1;
    v6 = (_OWORD *)InputServiceProcessor::CreateKeyboardEvent(&v42, a3);
    v7 = &v43;
    v8 = 2LL;
    do
    {
    ...
    *(_QWORD *)v38 = 0LL;
    MsgBlobCreateShared((char *)this + 104, 256LL, v38);
    if ( v43 )
    {
      if ( v43 == 1 )
      {
        v24 = (*(__int64 (__fastcall **)(_QWORD, _QWORD, _QWORD, __int64, _QWORD))(**((_QWORD **)this + 9) + 32LL))(
                *((_QWORD *)this + 9),
                v44,
                WORD1(v45),
                v46,
      ...
      else if ( v43 == 2 )
      {
        ...
        if ( (v9 & 0x100) != 0 )
        {
          std::deque<KeyboardEvent>::push_back((char *)this + 368, &v43);
          ...
          if ( (v9 & 0x200) != 0 )
          {
            ...
            while ( 1 )
            {
              ...
              if ( *v11 )
                ...
                v14 = 0LL;
              v15 = *(_OWORD **)(*(_QWORD *)(v14 + 8) + 8 * (*((_QWORD *)this + 49) & (*(_QWORD *)(v14 + 16) - 1LL)));
              v16 = &v43;
              v17 = 2LL;
              do
              {
            ...
            *(_QWORD *)v47 = 0LL;
            ...
            v20 = (*(__int64 (__fastcall **)(_QWORD, __int64, __int64))(**((_QWORD **)this + 9) + 40LL))(
                    *((_QWORD *)this + 9),
                    5LL,
                    231LL);
            if ( v20 < 0 )
            ...
            *(_DWORD *)pwszBuff = 0;
            SurrogateCharAccumulator::OnKey(
              ...
              *((_WORD *)a2 + 138),
              ...
              (int *)pwszBuff);
            *(_QWORD *)v39 = 0LL;
            v22 = MsgStringCreateShared(v47, *(unsigned int *)pwszBuff, v39);
            if ( v22 < 0 )
            {
              wil::details::in1diag3::FailFast_Hr(
                retaddr,
            ...
            LOWORD(wFlags) = 0;
            v23 = (*(__int64 (__fastcall **)(_QWORD, _QWORD, __int64, _QWORD, _QWORD, int, _WORD, _QWORD))(**((_QWORD **)this + 9) + 40LL))(
                    *((_QWORD *)this + 9),
                    v44,
                    231LL,
    ...
    else
    {
      ...
      *(_DWORD *)pwszBuff = 0;
      ...
      v39[0] = v33 | 0x80000000;
      LOWORD(cchBuff) = v28;
      v34 = v31(v30, HIWORD(v45), v44, *((unsigned __int16 *)a3 + 18), cchBuff, v39, *(_QWORD *)v38);
      if ( v34 < 0 )
      {
        wil::details::in1diag3::FailFast_Hr(
          retaddr,
