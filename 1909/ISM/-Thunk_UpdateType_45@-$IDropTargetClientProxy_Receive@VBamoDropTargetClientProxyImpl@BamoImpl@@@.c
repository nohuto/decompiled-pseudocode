/*
 * XREFs of ?Thunk_UpdateType_45@?$IDropTargetClientProxy_Receive@VBamoDropTargetClientProxyImpl@BamoImpl@@@@SAJPEAXPEAPEAX@Z @ 0x180063A70
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall IDropTargetClientProxy_Receive<BamoImpl::BamoDropTargetClientProxyImpl>::Thunk_UpdateType_45(
        __int64 a1,
        _OWORD **a2)
{
  int v3; // eax
