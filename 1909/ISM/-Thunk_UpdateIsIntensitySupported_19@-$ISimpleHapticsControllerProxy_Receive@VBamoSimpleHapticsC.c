/*
 * XREFs of ?Thunk_UpdateIsIntensitySupported_19@?$ISimpleHapticsControllerProxy_Receive@VBamoSimpleHapticsControllerProxyImpl@BamoImpl@@@@SAJPEAXPEAPEAX@Z @ 0x1800634F0
 * Callers:
 *     <none>
 * Callees:
