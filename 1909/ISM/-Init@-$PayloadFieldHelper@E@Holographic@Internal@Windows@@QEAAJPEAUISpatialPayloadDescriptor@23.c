/*
 * XREFs of ?Init@?$PayloadFieldHelper@E@Holographic@Internal@Windows@@QEAAJPEAUISpatialPayloadDescriptor@234@AEBU_GUID@@@Z @ 0x1800F0928
 * Callers:
...
__int64 __fastcall Windows::Internal::Holographic::PayloadFieldHelper<unsigned char>::Init(
        __int64 *a1,
        __int64 a2,
        __int64 a3)
{
