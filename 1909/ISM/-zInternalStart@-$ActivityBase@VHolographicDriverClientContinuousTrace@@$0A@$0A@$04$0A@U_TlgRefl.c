/*
 * XREFs of ?zInternalStart@?$ActivityBase@VHolographicDriverClientContinuousTrace@@$0A@$0A@$04$0A@U_TlgReflectorTag_Param0IsProviderType@@@wil@@QEAAXXZ @ 0x180161AA4
 * Callers:
        ...
        __int64 a1)
{
  ...
  if ( *(_DWORD *)wil::details::static_lazy<HolographicDriverClientContinuousTrace>::get(
                    v3,
                    (void (__cdecl *)())lambda_fbd0f72fdb52924b760b88d2d8805198_::_lambda_invoker_cdecl_)[1] <= 5u )
  {
    *(_QWORD *)(v2 + 8) = 0LL;
    *(_QWORD *)(v2 + 16) = 0LL;
  }
