/*
 * XREFs of ?PublishAdditionIfNeeded@SpatialInteractionSourceHand@SpatialInteractions@Internal@Windows@@UEAAJPEAUISpatialInteractionSourceCollectionCallbacks@234@@Z @ 0x1800F5ED0
 * Callers:
 *     <none>
 * Callees:
