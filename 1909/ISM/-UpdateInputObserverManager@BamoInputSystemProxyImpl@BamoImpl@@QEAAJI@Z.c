/*
 * XREFs of ?UpdateInputObserverManager@BamoInputSystemProxyImpl@BamoImpl@@QEAAJI@Z @ 0x1800644FC
 * Callers:
 *     ?Thunk_UpdateInputObserverManager_0@?$IInputSystemProxy_Receive@VBamoInputSystemProxyImpl@BamoImpl@@@@SAJPEAXPEAPEAX@Z @ 0x1800634D0 (-Thunk_UpdateInputObserverManager_0@-$IInputSystemProxy_Receive@VBamoInputSystemProxyImpl@BamoIm.c)
 * Callees:
