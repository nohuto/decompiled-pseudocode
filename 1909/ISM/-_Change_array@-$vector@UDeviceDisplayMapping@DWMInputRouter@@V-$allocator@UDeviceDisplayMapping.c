/*
 * XREFs of ?_Change_array@?$vector@UDeviceDisplayMapping@DWMInputRouter@@V?$allocator@UDeviceDisplayMapping@DWMInputRouter@@@std@@@std@@AEAAXQEAUDeviceDisplayMapping@DWMInputRouter@@_K1@Z @ 0x1800C55F0
 * Callers:
