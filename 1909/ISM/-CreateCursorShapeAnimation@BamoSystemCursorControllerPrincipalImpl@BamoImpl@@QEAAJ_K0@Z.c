/*
 * XREFs of ?CreateCursorShapeAnimation@BamoSystemCursorControllerPrincipalImpl@BamoImpl@@QEAAJ_K0@Z @ 0x1800C95A8
 * Callers:
 *     ?Thunk_CreateCursorShapeAnimation_203@?$ISystemCursorControllerPrincipal_Receive@VBamoSystemCursorControllerPrincipalImpl@BamoImpl@@@@SAJPEAXPEAPEAX@Z @ 0x1800354E0 (-Thunk_CreateCursorShapeAnimation_203@-$ISystemCursorControllerPrincipal_Receive@VBamoSystemCurs.c)
 * Callees:
...
__int64 __fastcall BamoImpl::BamoSystemCursorControllerPrincipalImpl::CreateCursorShapeAnimation(
        ...
        __int64 a3)
{
  ...
  v8 = (*(__int64 (__fastcall **)(char *, __int64, __int64, __int64))(*((_QWORD *)this - 2) + 96LL))(
         (char *)this - 16,
         v7,
         a2,
         a3);
