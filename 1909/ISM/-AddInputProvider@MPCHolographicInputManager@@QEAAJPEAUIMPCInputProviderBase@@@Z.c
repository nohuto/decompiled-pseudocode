/*
 * XREFs of ?AddInputProvider@MPCHolographicInputManager@@QEAAJPEAUIMPCInputProviderBase@@@Z @ 0x180021464
 * Callers:
        ...
        struct IMPCInputProviderBase *a2)
{
  ...
  if ( v8 == *((_QWORD **)this + 323)
    ...
    && (*(unsigned __int8 (__fastcall **)(_QWORD))(***((_QWORD ***)this + 322) + 256LL))(**((_QWORD **)this + 322)) )
  {
    MPCHolographicInputManager::AddPrimaryInputProvider(this, a2);
  }
  if ( *((_QWORD *)this + 297) )
    (*(void (__fastcall **)(struct IMPCInputProviderBase *))(*(_QWORD *)a2 + 280LL))(a2);
  return 0LL;
}
