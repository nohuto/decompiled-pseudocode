/*
 * XREFs of ?AllocateStubThunk@BamoDragNDropContextualProcessorPrincipalImpl@BamoImpl@@UEAAJPEAVBaseBamoPeerImpl@2Microsoft@@PEAPEAVBamoStub@Bamo@4@@Z @ 0x180009C60
 * Callers:
 *     <none>
 * Callees:
