/*
 * XREFs of ?CreateClientView@HidLampArrayDevice@@QEAAJPEAUISIPCEndpoint@@PEAPEAULampArrayDeviceView@@@Z @ 0x1800B3380
 * Callers:
 ...
 *     ?Initialize@LampArrayDeviceView@@QEAAXPEAGPEAUHardwareAttributes@@PEAUDeviceAttributes@@PEAULampAttributes@@@Z @ 0x1800B4550 (-Initialize@LampArrayDeviceView@@QEAAXPEAGPEAUHardwareAttributes@@PEAUDeviceAttributes@@PEAULamp.c)
 */
...
{
  struct DeviceAttributes *v5; // rbp
  __int64 v6; // r8
  int v7; // eax
  unsigned int v8; // ebx
  wil::details::in1diag3 *retaddr; // [rsp+58h] [rbp+0h]
  LampArrayDeviceView *v11; // [rsp+60h] [rbp+8h] BYREF

  *a3 = 0LL;
  v5 = (HidLampArrayDevice *)((char *)this + 544);
  v6 = -1LL;
  do
    ++v6;
