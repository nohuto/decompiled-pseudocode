/*
 * XREFs of ?StopHapticsFeedback_@SpatialInteractionTraceContinuous@SpatialInteractionDevices@@QEAAXKK@Z @ 0x180168C70
 * Callers:
        ...
        int a3)
{
  ...
  if ( *(_DWORD *)v3 > 5u )
  {
    if ( TlgKeywordOn(v3, 2uLL) )
    {
      ...
      v7 = 4;
      v10 = 4;
      TlgWrite(v4, &unk_1801A4667, 0LL, 0LL, 4u, &pData);
    }
  }
}
