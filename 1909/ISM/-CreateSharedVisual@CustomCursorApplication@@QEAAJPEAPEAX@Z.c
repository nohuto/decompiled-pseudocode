/*
 * XREFs of ?CreateSharedVisual@CustomCursorApplication@@QEAAJPEAPEAX@Z @ 0x1800CCD08
 * Callers:
 *     ?AttachApplication@SystemCursorController@@MEAAJPEAVBamoSystemCursorControllerStub@@PEAVBamoCustomCursorControllerClientProxy@@@Z @ 0x1800C91B0 (-AttachApplication@SystemCursorController@@MEAAJPEAVBamoSystemCursorControllerStub@@PEAVBamoCust.c)
 * Callees:
...
__int64 __fastcall CustomCursorApplication::CreateSharedVisual(CustomCursorApplication *this, void **a2)
{
  ...
  __int64 v28[2]; // [rsp+30h] [rbp-28h] BYREF
  __int64 v29; // [rsp+40h] [rbp-18h] BYREF
  std::_Ref_count_base *v30; // [rsp+48h] [rbp-10h]
  ...
  *a2 = (void *)-1LL;
  ...
  if ( v6 >= 0 )
  {
    v33 = 0LL;
    v7 = v26;
    v8 = *(__int64 (__fastcall **)(__int64, __int64 (__fastcall ****)(_QWORD, GUID *, __int64 *)))(*(_QWORD *)v26 + 96LL);
...
LABEL_29:
    ...
    v14 = v26;
    v15 = *(__int64 (__fastcall **)(__int64, __int64, HANDLE *))(*(_QWORD *)v26 + 168LL);
...
LABEL_28:
    Microsoft::WRL::ComPtr<Windows::Gaming::Input::Internal::IGipGameControllerProviderPrivate>::InternalRelease(&v34);
    Microsoft::WRL::ComPtr<Windows::Gaming::Input::Internal::IGipGameControllerProviderPrivate>::InternalRelease(&v27);
    goto LABEL_29;
  }
  wil::details::in1diag3::Return_Hr(
    retaddr,
