/*
 * XREFs of _Windows::Internal::SpatialInteractions::SpatialInteractionHandObjectDevice::OnHandSpatialObjectAdded_::_1_::catch$29 @ 0x1800F573C
 * Callers:
 *     <none>
 * Callees:
