/*
 * XREFs of ?TryGetPointer@SemaphoreValue@details_abi@wil@@SAJPEBGPEAPEAX@Z @ 0x18002423C
 * Callers:
        ...
        bool *a4)
{
  ...
  *a2 = 0LL;
  ...
  if ( v7 < 0 )
  {
    wil::details::in1diag3::Return_Hr(retaddr, (void *)0x62, (__int64)"wil", (const char *)(unsigned int)v7);
