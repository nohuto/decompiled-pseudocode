/*
 * XREFs of ?OnConnected@SystemButtonEventController@@MEAAJXZ @ 0x18002FA00
 * Callers:
 *     <none>
 * Callees:
 ...
 *     ??4?$ComPtr@VSystemButtonEventController@@@WRL@Microsoft@@QEAAAEAV012@PEAVSystemButtonEventController@@@Z @ 0x18002FF28 (--4-$ComPtr@VSystemButtonEventController@@@WRL@Microsoft@@QEAAAEAV012@PEAVSystemButtonEventContr.c)
