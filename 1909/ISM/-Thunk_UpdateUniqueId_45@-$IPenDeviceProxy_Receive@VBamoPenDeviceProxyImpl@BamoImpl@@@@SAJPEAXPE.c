/*
 * XREFs of ?Thunk_UpdateUniqueId_45@?$IPenDeviceProxy_Receive@VBamoPenDeviceProxyImpl@BamoImpl@@@@SAJPEAXPEAPEAX@Z @ 0x180063B30
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall IPenDeviceProxy_Receive<BamoImpl::BamoPenDeviceProxyImpl>::Thunk_UpdateUniqueId_45(
        __int64 a1,
        _OWORD **a2)
{
  int v3; // eax
