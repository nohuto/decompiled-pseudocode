/*
 * XREFs of ?Parse@SpatialInteractionSourceController@SpatialInteractions@Internal@Windows@@UEAAJPEADKPEAUISpatialGraphNodeReference@Holographic@34@_JAEBUMatrix4x4@Numerics@Foundation@4@3PEA_NPEAW4MPCAugmentedInputGestureType@@44@Z @ 0x180166CB0
 * Callers:
 *     <none>
 * Callees:
 ...
 *     ??$ButtonsStateChanged@AEAKAEAKAEAI@SpatialInteractionTrace@SpatialInteractionDevices@@SAXAEAK0AEAI@Z @ 0x180161D88 (--$ButtonsStateChanged@AEAKAEAKAEAI@SpatialInteractionTrace@SpatialInteractionDevices@@SAXAEAK0A.c)
 *     ??$ResetReportDueToFirmwareUpdate@AEAKAEAK@SpatialInteractionTrace@SpatialInteractionDevices@@SAXAEAK0@Z @ 0x18016234C (--$ResetReportDueToFirmwareUpdate@AEAKAEAK@SpatialInteractionTrace@SpatialInteractionDevices@@SA.c)
 *     ??$TimestampClampedDueToLatency@AEAKAEAKAEB_JAEB_J@SpatialInteractionTrace@SpatialInteractionDevices@@SAXAEAK0AEB_J1@Z @ 0x1801624BC (--$TimestampClampedDueToLatency@AEAKAEAKAEB_JAEB_J@SpatialInteractionTrace@SpatialInteractionDev.c)
 *     _anonymous_namespace_::UpdateIfChanged_float_ @ 0x180162524 (_anonymous_namespace_--UpdateIfChanged_float_.c)
 ...
 *     ?CheckForDeviceInformationUpdate@SpatialInteractionSourceController@SpatialInteractions@Internal@Windows@@AEAAXPEA_N@Z @ 0x180164198 (-CheckForDeviceInformationUpdate@SpatialInteractionSourceController@SpatialInteractions@Internal.c)
 *     ?OnParse@SpatialInteractionHeartbeat@SpatialInteractionDevices@@QEAAXI@Z @ 0x1801669E8 (-OnParse@SpatialInteractionHeartbeat@SpatialInteractionDevices@@QEAAXI@Z.c)
