/*
 * XREFs of ?GetConstantsForInputType@BamoMPCConstantManagerClientPrincipalImpl@BamoImpl@@QEAAJW4InputType@@I@Z @ 0x1800899E4
 * Callers:
 *     ?Thunk_GetConstantsForInputType_21@?$IMPCConstantManagerClientPrincipal_Receive@VBamoMPCConstantManagerClientPrincipalImpl@BamoImpl@@@@SAJPEAXPEAPEAX@Z @ 0x18008AEB0 (-Thunk_GetConstantsForInputType_21@-$IMPCConstantManagerClientPrincipal_Receive@VBamoMPCConstant.c)
 * Callees:
        ...
        unsigned int a3)
{
  ...
  v13 = (*(__int64 (__fastcall **)(_QWORD *, __int64, _QWORD, char *))(*((_QWORD *)a1 - 2) + 120LL))(
          (_QWORD *)a1 - 2,
          v7,
          a2,
          v12);
