/*
 * XREFs of ?GetThreadDesktopName@@YAHPEA_WK@Z @ 0x18002826C
 * Callers:
 *     ?GetDesktopUniqueName@@YAXPEB_WPEA_WK@Z @ 0x18002819C (-GetDesktopUniqueName@@YAXPEB_WPEA_WK@Z.c)
 * Callees:
 *     ?StringCchCopyW@@YAJPEA_W_KPEB_W@Z @ 0x18002830C (-StringCchCopyW@@YAJPEA_W_KPEB_W@Z.c)
...
__int64 __fastcall GetThreadDesktopName(wchar_t *a1)
{
  ...
  {
    v7 = 260LL;
    v8 = (char *)&word_180182F5B + 1 - (char *)a1;
    do
    {
      if ( v7 == -2147483386 )
        break;
