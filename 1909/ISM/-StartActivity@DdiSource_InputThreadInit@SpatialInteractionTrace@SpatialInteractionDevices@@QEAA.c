/*
 * XREFs of ?StartActivity@DdiSource_InputThreadInit@SpatialInteractionTrace@SpatialInteractionDevices@@QEAAXAEBU_GUID@@@Z @ 0x1800EDE8C
 * Callers:
        ...
        const struct _GUID *a2)
{
  ...
  if ( *(_DWORD *)v5 > 4u )
  {
    ...
    TlgWrite(v5, &unk_18019ED2A, (LPCGUID)(*((_QWORD *)this + 6) + 8LL), v6, 5u, &pData);
  }
  if ( !*((_DWORD *)this + 8) )
