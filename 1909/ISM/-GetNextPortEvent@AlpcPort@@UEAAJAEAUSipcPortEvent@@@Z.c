/*
 * XREFs of ?GetNextPortEvent@AlpcPort@@UEAAJAEAUSipcPortEvent@@@Z @ 0x1800D59E0
 * Callers:
 *     <none>
 * Callees:
 ...
 *     ?DisconnectAllSections@SipcPort@@IEAAXXZ @ 0x1800D5394 (-DisconnectAllSections@SipcPort@@IEAAXXZ.c)
 ...
 *     ?GetValue@?$SerializedIntegral@I@@QEBAIXZ @ 0x1800D5F5C (-GetValue@-$SerializedIntegral@I@@QEBAIXZ.c)
