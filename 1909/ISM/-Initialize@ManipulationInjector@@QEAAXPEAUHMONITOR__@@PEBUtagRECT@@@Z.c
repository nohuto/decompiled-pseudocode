/*
 * XREFs of ?Initialize@ManipulationInjector@@QEAAXPEAUHMONITOR__@@PEBUtagRECT@@@Z @ 0x1800E79E0
 * Callers:
 ...
 *     ?InitializeOverlapEvent@ManipulationInjector@@AEAAXXZ @ 0x1800E7E5C (-InitializeOverlapEvent@ManipulationInjector@@AEAAXXZ.c)
 */
