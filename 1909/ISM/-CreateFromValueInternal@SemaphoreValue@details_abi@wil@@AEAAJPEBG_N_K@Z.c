/*
 * XREFs of ?CreateFromValueInternal@SemaphoreValue@details_abi@wil@@AEAAJPEBG_N_K@Z @ 0x18004F114
 * Callers:
 ...
 *     ?StringCchCopyW@@YAJPEAG_KPEBG@Z @ 0x180051E14 (-StringCchCopyW@@YAJPEAG_KPEBG@Z.c)
        ...
        unsigned __int64 a4)
{
  ...
  if ( LastErrorFailHr >= 0 )
  {
    ...
    {
      wil::details::in1diag3::Return_Hr(retaddr, (void *)0x80, (__int64)"wil", (const char *)(unsigned int)v34);
