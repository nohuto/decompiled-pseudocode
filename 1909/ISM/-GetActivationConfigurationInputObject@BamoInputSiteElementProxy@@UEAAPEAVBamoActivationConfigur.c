/*
 * XREFs of ?GetActivationConfigurationInputObject@BamoInputSiteElementProxy@@UEAAPEAVBamoActivationConfigurationInputObjectProxy@@XZ @ 0x180009860
 * Callers:
 *     <none>
 * Callees:
