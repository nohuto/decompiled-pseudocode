/*
 * XREFs of ?Initialize@InputRedirectionTarget@@IEAAJXZ @ 0x180107520
 * Callers:
 ...
 *     ?reset@?$unique_storage@U?$handle_null_resource_policy@P6AJPEAX@Z$1?NtCloseCompositionInputSink@@YAJ0@Z@details@wil@@@details@wil@@QEAAXPEAX@Z @ 0x180066EF0 (-reset@-$unique_storage@U-$handle_null_resource_policy@P6AJPEAX@Z$1-NtCloseCompositionInputSink@.c)
...
LABEL_3:
  ...
  v7 = (*(__int64 (__fastcall **)(_QWORD, char *, char *))(*(_QWORD *)*v3 + 104LL))(
         *v3,
         (char *)this + 72,
         (char *)this + 40);
  if ( v7 < 0 )
