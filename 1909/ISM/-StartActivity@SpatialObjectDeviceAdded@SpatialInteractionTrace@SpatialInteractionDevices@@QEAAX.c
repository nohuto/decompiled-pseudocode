/*
 * XREFs of ?StartActivity@SpatialObjectDeviceAdded@SpatialInteractionTrace@SpatialInteractionDevices@@QEAAXPEB_W@Z @ 0x1800EE16C
 * Callers:
        ...
        const wchar_t *a2)
{
  ...
  if ( *(_DWORD *)v5 > 4u )
  {
    ...
    TlgWrite(v5, &unk_18019F3E0, (LPCGUID)(*((_QWORD *)this + 6) + 8LL), v6, 5u, &pData);
  }
  if ( !*((_DWORD *)this + 8) )
