/*
 * XREFs of ?QueryInterface@BamoInputSiteElementProxy@@UEAAJAEBU_GUID@@PEAPEAX@Z @ 0x180066C20
 * Callers:
 *     ?QueryInterface@BamoInputSiteElementProxy@@W7EAAJAEBU_GUID@@PEAPEAX@Z @ 0x180037ED0 (-QueryInterface@BamoInputSiteElementProxy@@W7EAAJAEBU_GUID@@PEAPEAX@Z.c)
 * Callees:
