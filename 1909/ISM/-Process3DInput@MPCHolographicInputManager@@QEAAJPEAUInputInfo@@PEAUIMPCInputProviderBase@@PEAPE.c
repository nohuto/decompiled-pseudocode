/*
 * XREFs of ?Process3DInput@MPCHolographicInputManager@@QEAAJPEAUInputInfo@@PEAUIMPCInputProviderBase@@PEAPEAUIMPCTarget@@@Z @ 0x180082828
 * Callers:
 ...
 *     ?ReportUsageToService@?$Feature@U__WilFeatureTraits_Feature_UseEyeGazeForGazeCursor@@@wil@@CAX_NW4ReportingKind@2@_K@Z @ 0x180034A30 (-ReportUsageToService@-$Feature@U__WilFeatureTraits_Feature_UseEyeGazeForGazeCursor@@@wil@@CAX_N.c)
 ...
 *     ?ProcessCapture@MPCHolographicInputManager@@AEAAXPEAUInputInfo@@PEAUIMPCInputProviderBase@@PEAPEAUIMPCTarget@@@Z @ 0x180082E58 (-ProcessCapture@MPCHolographicInputManager@@AEAAXPEAUInputInfo@@PEAUIMPCInputProviderBase@@PEAPE.c)
 ...
 *     ?UpdatePrimary@MPCHolographicInputManager@@AEAAXXZ @ 0x180083E00 (-UpdatePrimary@MPCHolographicInputManager@@AEAAXXZ.c)
 *     ?_Tidy@?$vector@UPointData3D@@V?$allocator@UPointData3D@@@std@@@std@@AEAAXXZ @ 0x180084238 (-_Tidy@-$vector@UPointData3D@@V-$allocator@UPointData3D@@@std@@@std@@AEAAXXZ.c)
 */
