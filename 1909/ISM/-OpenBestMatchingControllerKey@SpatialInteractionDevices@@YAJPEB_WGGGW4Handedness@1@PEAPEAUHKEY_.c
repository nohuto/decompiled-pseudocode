/*
 * XREFs of ?OpenBestMatchingControllerKey@SpatialInteractionDevices@@YAJPEB_WGGGW4Handedness@1@PEAPEAUHKEY__@@PEA_N@Z @ 0x1800D84D4
 * Callers:
...
LABEL_11:
  ...
  swprintf_s<64>(SubKey, L"%04x_%04x_%04x_%ws", a2, v8, a4, v12);
  if ( !RegOpenKeyExW(hKey[0], SubKey, 0, 0x20019u, phkResult)
    || (swprintf_s<64>(SubKey, L"%04x_%04x_%ws", a2, v8, v12), !RegOpenKeyExW(hKey[0], SubKey, 0, 0x20019u, phkResult)) )
  {
    v11 = 0;
    *a7 = 1;
    goto LABEL_11;
