/*
 * XREFs of ?RecordCachedUsageUnderLock@EnabledStateManager@details@wil@@AEAAXXZ @ 0x180050674
 * Callers:
 ...
 *     ?OnTimer@EnabledStateManager@details@wil@@QEAAXXZ @ 0x1800502AC (-OnTimer@EnabledStateManager@details@wil@@QEAAXXZ.c)
 * Callees:
 ...
 *     ?WilApi_RecordFeatureUsage@details@wil@@YAXIIIPEBD@Z @ 0x180052368 (-WilApi_RecordFeatureUsage@details@wil@@YAXIIIPEBD@Z.c)
 */
