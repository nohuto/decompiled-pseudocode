/*
 * XREFs of ?CancelDrag@BamoDragNDropContextualProcessorPrincipalImpl@BamoImpl@@QEAAJII@Z @ 0x180068BFC
 * Callers:
 *     ?Thunk_CancelDrag_95@?$IDragNDropContextualProcessorPrincipal_Receive@VBamoDragNDropContextualProcessorPrincipalImpl@BamoImpl@@@@SAJPEAXPEAPEAX@Z @ 0x180069170 (-Thunk_CancelDrag_95@-$IDragNDropContextualProcessorPrincipal_Receive@VBamoDragNDropContextualPr.c)
 * Callees:
