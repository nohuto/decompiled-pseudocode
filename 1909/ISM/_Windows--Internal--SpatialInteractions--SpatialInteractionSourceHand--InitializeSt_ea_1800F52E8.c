/*
 * XREFs of _Windows::Internal::SpatialInteractions::SpatialInteractionSourceHand::InitializeStreamReaderHelpers_::_1_::catch$6 @ 0x1800F52E8
 * Callers:
 *     <none>
 * Callees:
