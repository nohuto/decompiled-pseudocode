        ...
        _DWORD **a4)
{
  ...
  v7 = (__int64)*v4;
  v8 = (_QWORD *)(*v4)[1];
  v9 = std::_List_buy<std::pair<unsigned long const,std::shared_ptr<LegacyDeviceInfo>>>::_Buynode<std::piecewise_construct_t const &,std::tuple<unsigned long const &>,std::tuple<>>(
         a1,
         *v4,
         v8,
         (__int64)a4,
