/*
 * XREFs of ?GetCachedFeatureEnabledState@?$Feature@U__WilFeatureTraits_Feature_19H2_Enablement@@@wil@@CA?AW4wil_details_CachedFeatureEnabledState@@_N@Z @ 0x180034A8C
 * Callers:
