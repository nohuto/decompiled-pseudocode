/*
 * XREFs of ?GetNodeErrorStatuses@SpatialGraphDriverClient@Holographic@Internal@Windows@@UEAAJAEBUSPATIAL_NODE_ID@@PEAPEAUHOLOGRAPHIC_DEVICE_ERROR_STATUS@@PEA_K@Z @ 0x180156A70
 * Callers:
 *     ?GetNodeErrorStatuses@SpatialGraphDriverClient@Holographic@Internal@Windows@@WBA@EAAJAEBUSPATIAL_NODE_ID@@PEAPEAUHOLOGRAPHIC_DEVICE_ERROR_STATUS@@PEA_K@Z @ 0x18003A1B0 (-GetNodeErrorStatuses@SpatialGraphDriverClient@Holographic@Internal@Windows@@WBA@EAAJAEBUSPATIAL.c)
 * Callees:
 ...
 *     ??$make_unique_cotaskmem_nothrow@$$BY0A@UHOLOGRAPHIC_DEVICE_ERROR_STATUS@@@wil@@YA?AV?$unique_ptr@$$BY0A@UHOLOGRAPHIC_DEVICE_ERROR_STATUS@@U?$function_deleter@P6AXPEAX@Z$1?CoTaskMemFree@@YAX0@Z@wil@@@wistd@@_K@Z @ 0x18015098C (--$make_unique_cotaskmem_nothrow@$$BY0A@UHOLOGRAPHIC_DEVICE_ERROR_STATUS@@@wil@@YA-AV-$unique_pt.c)
