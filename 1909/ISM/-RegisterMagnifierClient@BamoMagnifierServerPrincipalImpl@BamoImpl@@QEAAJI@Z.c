/*
 * XREFs of ?RegisterMagnifierClient@BamoMagnifierServerPrincipalImpl@BamoImpl@@QEAAJI@Z @ 0x180070144
 * Callers:
 *     ?Thunk_RegisterMagnifierClient_0@?$IMagnifierServerPrincipal_Receive@VBamoMagnifierServerPrincipalImpl@BamoImpl@@@@SAJPEAXPEAPEAX@Z @ 0x180070280 (-Thunk_RegisterMagnifierClient_0@-$IMagnifierServerPrincipal_Receive@VBamoMagnifierServerPrincip.c)
 * Callees:
...
__int64 __fastcall BamoImpl::BamoMagnifierServerPrincipalImpl::RegisterMagnifierClient(
        BamoImpl::BamoMagnifierServerPrincipalImpl *this,
        unsigned int a2)
{
