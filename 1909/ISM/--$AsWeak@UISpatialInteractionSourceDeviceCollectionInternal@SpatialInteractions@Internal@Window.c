/*
 * XREFs of ??$AsWeak@UISpatialInteractionSourceDeviceCollectionInternal@SpatialInteractions@Internal@Windows@@@WRL@Microsoft@@YAJPEAUISpatialInteractionSourceDeviceCollectionInternal@SpatialInteractions@Internal@Windows@@PEAVWeakRef@01@@Z @ 0x1800E9978
 * Callers:
...
__int64 __fastcall Microsoft::WRL::AsWeak<Windows::Internal::SpatialInteractions::ISpatialInteractionSourceDeviceCollectionInternal>(
