/*
 * XREFs of ?_Tidy@?$vector@UColor@UI@Windows@@V?$allocator@UColor@UI@Windows@@@std@@@std@@AEAAXXZ @ 0x18002B0AC
 * Callers:
 *     _std::vector_std::pair_unsigned_short_bool__std::allocator_std::pair_unsigned_short_bool_____::_Range_construct_or_tidy_std::pair_unsigned_short_bool__const____::_1_::catch$9 @ 0x18003C192 (_std--vector_std--pair_unsigned_short_bool__std--allocator_std--pair_unsigned_short_bool_____--_.c)
 *     _dynamic_atexit_destructor_for__c_taskSwitcherLaunchSequence__ @ 0x18003DBD0 (_dynamic_atexit_destructor_for__c_taskSwitcherLaunchSequence__.c)
 *     ?Update3DFocusWNF@MPCInputRouter@@AEAAXXZ @ 0x180055BF4 (-Update3DFocusWNF@MPCInputRouter@@AEAAXXZ.c)
 *     _MPCInputRouter::Update3DFocusWNF_::_1_::dtor$0 @ 0x180055DCD (_MPCInputRouter--Update3DFocusWNF_--_1_--dtor$0.c)
 *     _ViewHierarchy::GetAllAncestors_::_1_::dtor$0 @ 0x180059453 (_ViewHierarchy--GetAllAncestors_--_1_--dtor$0.c)
 *     _InputAttemptedTargetManager::ProcessInputAttempt_::_1_::dtor$0 @ 0x180070ADA (_InputAttemptedTargetManager--ProcessInputAttempt_--_1_--dtor$0.c)
 *     ??1ViewMenuChordedKeyHandler@@MEAA@XZ @ 0x180079650 (--1ViewMenuChordedKeyHandler@@MEAA@XZ.c)
 *     ??1?$vector@UColor@UI@Windows@@V?$allocator@UColor@UI@Windows@@@std@@@std@@QEAA@XZ @ 0x180093AA0 (--1-$vector@UColor@UI@Windows@@V-$allocator@UColor@UI@Windows@@@std@@@std@@QEAA@XZ.c)
 ...
 *     ??4?$vector@UColor@UI@Windows@@V?$allocator@UColor@UI@Windows@@@std@@@std@@QEAAAEAV01@$$QEAV01@@Z @ 0x1800AE2BC (--4-$vector@UColor@UI@Windows@@V-$allocator@UColor@UI@Windows@@@std@@@std@@QEAAAEAV01@$$QEAV01@@.c)
 ...
 *     ??1?$list@U?$pair@QEAUIDCompInputTarget@@V?$vector@KV?$allocator@K@std@@@std@@@std@@V?$allocator@U?$pair@QEAUIDCompInputTarget@@V?$vector@KV?$allocator@K@std@@@std@@@std@@@2@@std@@QEAA@XZ @ 0x1800BA9C0 (--1-$list@U-$pair@QEAUIDCompInputTarget@@V-$vector@KV-$allocator@K@std@@@std@@@std@@V-$allocator.c)
 *     ??1?$unordered_map@PEAUIDCompInputTarget@@V?$vector@KV?$allocator@K@std@@@std@@UDCompTargetHash@@UDCompTargetEqual@@V?$allocator@U?$pair@QEAUIDCompInputTarget@@V?$vector@KV?$allocator@K@std@@@std@@@std@@@3@@std@@QEAA@XZ @ 0x1800BABDC (--1-$unordered_map@PEAUIDCompInputTarget@@V-$vector@KV-$allocator@K@std@@@std@@UDCompTargetHash@.c)
 ...
 *     _std::vector_enum__Button_std::allocator_enum__Button___::_Range_construct_or_tidy_enum__Button_const____::_1_::catch$5 @ 0x1800FC81E (_std--vector_enum__Button_std--allocator_enum__Button___--_Range_construct_or_tidy_enum__Button_.c)
 ...
 *     _std::vector_enum__Button_std::allocator_enum__Button___::vector_enum__Button_std::allocator_enum__Button____::_1_::catch$16 @ 0x1800FCC85 (_std--vector_enum__Button_std--allocator_enum__Button___--vector_enum__Button_std--allocator_enu.c)
 *     ??1ButtonRecognizer@@MEAA@XZ @ 0x1800FCD7C (--1ButtonRecognizer@@MEAA@XZ.c)
 *     ??1ComboButtonRegistration@@QEAA@XZ @ 0x1800FCE60 (--1ComboButtonRegistration@@QEAA@XZ.c)
