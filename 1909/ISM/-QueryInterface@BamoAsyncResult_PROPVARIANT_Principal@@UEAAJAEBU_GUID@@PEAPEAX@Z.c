/*
 * XREFs of ?QueryInterface@BamoAsyncResult_PROPVARIANT_Principal@@UEAAJAEBU_GUID@@PEAPEAX@Z @ 0x180122C80
 * Callers:
 *     ?QueryInterface@BamoAsyncResult_PROPVARIANT_Principal@@W7EAAJAEBU_GUID@@PEAPEAX@Z @ 0x180039AE0 (-QueryInterface@BamoAsyncResult_PROPVARIANT_Principal@@W7EAAJAEBU_GUID@@PEAPEAX@Z.c)
 * Callees:
