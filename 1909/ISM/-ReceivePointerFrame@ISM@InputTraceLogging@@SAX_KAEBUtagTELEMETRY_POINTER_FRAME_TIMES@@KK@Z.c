/*
 * XREFs of ?ReceivePointerFrame@ISM@InputTraceLogging@@SAX_KAEBUtagTELEMETRY_POINTER_FRAME_TIMES@@KK@Z @ 0x1800BE8A4
 * Callers:
        ...
        int a4)
{
  ...
  if ( *(_DWORD *)v6 > 4u )
  {
    if ( TlgKeywordOn(v6, 0x200uLL) )
    {
      ...
      v26 = v8;
      v28 = v8;
      TlgWrite(v7, &unk_18019D7E4, 0LL, 0LL, 9u, &pData);
    }
  }
}
