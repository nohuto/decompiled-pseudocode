/*
 * XREFs of ??1?$unique_ptr@UDeviceRemovalEventArgs@WGIController@@U?$default_delete@UDeviceRemovalEventArgs@WGIController@@@std@@@std@@QEAA@XZ @ 0x1800A88F0
 * Callers:
 *     _WGIController::NotifyDeviceRemoval_::_1_::dtor$0 @ 0x1800AA958 (_WGIController--NotifyDeviceRemoval_--_1_--dtor$0.c)
 *     _WGIController::NotifyDeviceRemovalCallback_::_1_::dtor$0 @ 0x1800AAA63 (_WGIController--NotifyDeviceRemovalCallback_--_1_--dtor$0.c)
 * Callees:
