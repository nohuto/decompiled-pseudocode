/*
 * XREFs of ?Thunk_UpdateTailButtonClickedEventsRequired_19@?$IPenEventsClientProxy_Receive@VBamoPenEventsClientProxyImpl@BamoImpl@@@@SAJPEAXPEAPEAX@Z @ 0x180033470
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall IPenEventsClientProxy_Receive<BamoImpl::BamoPenEventsClientProxyImpl>::Thunk_UpdateTailButtonClickedEventsRequired_19(
        __int64 a1,
        _BYTE **a2)
{
  int v3; // eax
