/*
 * XREFs of ?CreateMultiUpdateReportBuilder@HidLampArrayDevice@@QEAAJPEAPEAVHidLampMultiUpdateReportBuilder@@@Z @ 0x1800B346C
 * Callers:
        ...
        struct HidLampMultiUpdateReportBuilder **a2)
{
  ...
  RefCountedObject *v7; // [rsp+40h] [rbp+8h] BYREF
