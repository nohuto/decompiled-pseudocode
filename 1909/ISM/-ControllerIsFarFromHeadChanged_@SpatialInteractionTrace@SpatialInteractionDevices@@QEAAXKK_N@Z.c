/*
 * XREFs of ?ControllerIsFarFromHeadChanged_@SpatialInteractionTrace@SpatialInteractionDevices@@QEAAXKK_N@Z @ 0x180164C7C
 * Callers:
        ...
        char a4)
{
  ...
  if ( *(_DWORD *)v5 > 4u )
  {
    if ( TlgKeywordOn(v5, 2uLL) )
    {
      ...
      v8 = a4;
      v15 = 1LL;
      TlgWrite(v6, &unk_1801A4424, 0LL, 0LL, 5u, &pData);
    }
  }
}
