...
__int64 **__fastcall std::_Tree<std::_Tmap_traits<enum GazeProperty,unsigned short,std::less<enum GazeProperty>,std::allocator<std::pair<enum GazeProperty const,unsigned short>>,0>>::erase(
        __int64 ***a1,
        __int64 **a2,
        __int64 *a3,
        __int64 *a4)
  ...
  else
  {
    while ( v5 != a4 )
    {
      ...
      v14 = std::_Tree_val<std::_Tree_simple_types<std::pair<unsigned int const,std::shared_ptr<CustomCursorApplication>>>>::_Extract(
              a1,
              v9);
      std::_Deallocate<16,0>(v14, (const struct std::nothrow_t *)0x28);
    }
    *a2 = v5;
  }
  return a2;
