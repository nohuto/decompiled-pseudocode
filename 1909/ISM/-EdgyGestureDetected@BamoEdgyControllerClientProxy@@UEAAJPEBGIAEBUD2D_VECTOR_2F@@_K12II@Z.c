/*
 * XREFs of ?EdgyGestureDetected@BamoEdgyControllerClientProxy@@UEAAJPEBGIAEBUD2D_VECTOR_2F@@_K12II@Z @ 0x18006E8A0
 * Callers:
...
__int64 __fastcall BamoEdgyControllerClientProxy::EdgyGestureDetected(
        ...
        unsigned int a9)
{
  BamoEdgyControllerClientProxy *v10; // rbx
  ...
  LODWORD(v10) = BamoImpl::BamoEdgyControllerClientProxyImpl::EdgyGestureDetected(
                   (BamoEdgyControllerClientProxy *)((char *)v10 + 8),
                   a2,
                   a3,
                   a4,
                   a5,
