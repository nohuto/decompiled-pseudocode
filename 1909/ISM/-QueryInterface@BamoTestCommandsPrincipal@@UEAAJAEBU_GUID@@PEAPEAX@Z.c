/*
 * XREFs of ?QueryInterface@BamoTestCommandsPrincipal@@UEAAJAEBU_GUID@@PEAPEAX@Z @ 0x1800F8DE0
 * Callers:
 *     ?QueryInterface@BamoTestCommandsPrincipal@@W7EAAJAEBU_GUID@@PEAPEAX@Z @ 0x180038EE0 (-QueryInterface@BamoTestCommandsPrincipal@@W7EAAJAEBU_GUID@@PEAPEAX@Z.c)
 * Callees:
