/*
 * XREFs of ??1SipcEndpoint@@EEAA@XZ @ 0x1800D40F8
 * Callers:
...
void __fastcall SipcEndpoint::~SipcEndpoint(SharedObjectBase *this)
{
  *(_QWORD *)this = &SipcEndpoint::`vftable'{for `SharedObjectBase'};
  *((_QWORD *)this + 2) = &SipcEndpoint::`vftable'{for `ISIPCEndpoint'};
  ...
  *((_QWORD *)this + 11) = &SipcEndpoint::`vftable'{for `IUnknown's `SharedUnknownBase<ISIPCEndpoint,IUnknown,IUnknown,IUnknown,IUnknown,IUnknown,IUnknown,IUnknown,IUnknown,IUnknown>'};
  SharedUnknownBase<ISIPCEndpoint,IUnknown,IUnknown,IUnknown,IUnknown,IUnknown,IUnknown,IUnknown,IUnknown,IUnknown>::~SharedUnknownBase<ISIPCEndpoint,IUnknown,IUnknown,IUnknown,IUnknown,IUnknown,IUnknown,IUnknown,IUnknown,IUnknown>(this);
}
