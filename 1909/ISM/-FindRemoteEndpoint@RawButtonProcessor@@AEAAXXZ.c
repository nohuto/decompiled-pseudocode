/*
 * XREFs of ?FindRemoteEndpoint@RawButtonProcessor@@AEAAXXZ @ 0x180108F60
 * Callers:
 *     ?Create@RawButtonProcessor@@SAJPEAPEAV1@@Z @ 0x180108E10 (-Create@RawButtonProcessor@@SAJPEAPEAV1@@Z.c)
 *     ?OnFocusRequest@RawButtonProcessor@@UEAAJPEAUDeviceInfo@@PEAUInputContext@@PEAUContextualProcessorInitialState@@@Z @ 0x180109050 (-OnFocusRequest@RawButtonProcessor@@UEAAJPEAUDeviceInfo@@PEAUInputContext@@PEAUContextualProcess.c)
 * Callees:
