/*
 * XREFs of ?GetConstant@BamoMPCConstantManagerClientProxy@@UEAAJW4InputType@@PEBGPEAVBamoAsyncResult_PROPVARIANT_Principal@@@Z @ 0x180110E40
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall BamoMPCConstantManagerClientProxy::GetConstant(__int64 a1, unsigned int a2, __int64 a3, __int64 a4)
{
  ...
  LODWORD(v7) = BamoImpl::BamoMPCConstantManagerClientProxyImpl::GetConstant(v7 + 8, a2, a3, a4, -2LL);
