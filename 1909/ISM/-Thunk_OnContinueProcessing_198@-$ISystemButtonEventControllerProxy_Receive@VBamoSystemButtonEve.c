/*
 * XREFs of ?Thunk_OnContinueProcessing_198@?$ISystemButtonEventControllerProxy_Receive@VBamoSystemButtonEventControllerProxyImpl@BamoImpl@@@@SAJPEAXPEAPEAX@Z @ 0x18002FEA0
 * Callers:
 *     <none>
 * Callees:
