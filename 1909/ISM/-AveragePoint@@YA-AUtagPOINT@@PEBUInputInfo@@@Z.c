/*
 * XREFs of ?AveragePoint@@YA?AUtagPOINT@@PEBUInputInfo@@@Z @ 0x180105A38
 * Callers:
 ...
 *     ?DeliverInput@MagnifierToggleTarget@@UEAAJPEAUInputInfo@@@Z @ 0x180105BF0 (-DeliverInput@MagnifierToggleTarget@@UEAAJPEAUInputInfo@@@Z.c)
 * Callees:
 *     <none>
 */
