        ...
        _QWORD *a3)
{
  ...
  if ( !*(_BYTE *)(v8 + 25) )
  {
    do
    {
      if ( Windows::Internal::Holographic::CaseInsensitiveStringLess::operator()((__int64)a1, (_QWORD *)(v8 + 32), a3) )
      {
        v8 = *(_QWORD *)(v8 + 16);
      }
      else
  ...
  if ( v3 == v7
    || Windows::Internal::Holographic::CaseInsensitiveStringLess::operator()((__int64)a1, a3, (_QWORD *)(v3 + 32)) )
  {
    v11 = a3;
    v9 = std::_Tree_comp_alloc<std::_Tmap_traits<std::wstring,Windows::Internal::Holographic::SpatialGraphSnapshot,Windows::Internal::Holographic::CaseInsensitiveStringLess,std::allocator<std::pair<std::wstring const,Windows::Internal::Holographic::SpatialGraphSnapshot>>,0>>::_Buynode<std::piecewise_construct_t const &,std::tuple<std::wstring const &>,std::tuple<>>((__int64)a1);
