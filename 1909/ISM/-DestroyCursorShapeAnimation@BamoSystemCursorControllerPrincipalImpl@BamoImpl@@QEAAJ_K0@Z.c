/*
 * XREFs of ?DestroyCursorShapeAnimation@BamoSystemCursorControllerPrincipalImpl@BamoImpl@@QEAAJ_K0@Z @ 0x1800C9BA0
 * Callers:
 *     ?Thunk_DestroyCursorShapeAnimation_203@?$ISystemCursorControllerPrincipal_Receive@VBamoSystemCursorControllerPrincipalImpl@BamoImpl@@@@SAJPEAXPEAPEAX@Z @ 0x180035500 (-Thunk_DestroyCursorShapeAnimation_203@-$ISystemCursorControllerPrincipal_Receive@VBamoSystemCur.c)
 * Callees:
        ...
        __int64 a3)
{
  ...
  v8 = (*(__int64 (__fastcall **)(char *, __int64, __int64, __int64))(*((_QWORD *)this - 2) + 112LL))(
         (char *)this - 16,
         v7,
         a2,
         a3);
