/*
 * XREFs of ?Create@ViewMenuChordedKeyHandler@@SAJP6AJPEAXAEAV?$vector@U?$pair@G_N@std@@V?$allocator@U?$pair@G_N@std@@@2@@std@@_N@Z0AEBV23@PEAPEAV1@@Z @ 0x180079A94
 * Callers:
 ...
 *     ??0ViewMenuChordedKeyHandler@@IEAA@XZ @ 0x1800795D0 (--0ViewMenuChordedKeyHandler@@IEAA@XZ.c)
        ...
        ViewMenuChordedKeyHandler **a4)
{
  ...
  ViewMenuChordedKeyHandler *v15; // [rsp+50h] [rbp+18h] BYREF
