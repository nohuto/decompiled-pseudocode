/*
 * XREFs of ?RegisterClient@BamoControllerNavigationManagerPrincipalImpl@BamoImpl@@QEAAJI@Z @ 0x1800732B4
 * Callers:
 *     ?Thunk_RegisterClient_0@?$IControllerNavigationManagerPrincipal_Receive@VBamoControllerNavigationManagerPrincipalImpl@BamoImpl@@@@SAJPEAXPEAPEAX@Z @ 0x180073D60 (-Thunk_RegisterClient_0@-$IControllerNavigationManagerPrincipal_Receive@VBamoControllerNavigatio.c)
 * Callees:
