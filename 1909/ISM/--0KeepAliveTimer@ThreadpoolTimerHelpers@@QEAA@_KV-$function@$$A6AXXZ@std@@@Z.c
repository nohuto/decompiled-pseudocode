/*
 * XREFs of ??0KeepAliveTimer@ThreadpoolTimerHelpers@@QEAA@_KV?$function@$$A6AXXZ@std@@@Z @ 0x180162B24
 * Callers:
...
RTL_SRWLOCK *__fastcall ThreadpoolTimerHelpers::KeepAliveTimer::KeepAliveTimer(RTL_SRWLOCK *pv, __int64 a2, __int64 a3)
{
  ...
  {
    Microsoft::WRL::Wrappers::HandleT<Microsoft::WRL::Wrappers::HandleTraits::ThreadpoolTimerTraitsImpl>::Close(pv);
