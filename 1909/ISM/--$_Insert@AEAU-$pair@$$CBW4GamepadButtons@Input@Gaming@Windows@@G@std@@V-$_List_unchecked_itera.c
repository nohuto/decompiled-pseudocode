AA?AU?$pair@V?$_List_iterator@V?$_List_val@U?$_List_simple_types@U?$pair@$$CBW4GamepadButtons@Input@Gaming@Windows@@G@std@@@std@@@std@@@std@@_N@1@AEAU?$pair@$$CBW4GamepadButtons@Input@Gaming@Windows@@G@1@V?$_List_unchecked_iterator@V?$_List_val@U?$_List_simple_types@U?$pair@$$CBW4GamepadButtons@Input@Gaming@Windows@@G@std@@@std@@@std@@@1@@Z @ 0x180012FCC (--$_Insert@AEAU-$pair@$$CBW4GamepadButtons@Input@Gaming@Windows@@G@std@@V-$_List_unchecked_itera.c)
...
__int64 __fastcall std::_Hash<std::_Umap_traits<enum Windows::Gaming::Input::GamepadButtons,unsigned short,std::_Uhash_compare<enum Windows::Gaming::Input::GamepadButtons,std::hash<enum Windows::Gaming::Input::GamepadButtons>,std::equal_to<enum Windows::Gaming::Input::GamepadButtons>>,std::allocator<std::pair<enum Windows::Gaming::Input::GamepadButtons const,unsigned short>>,0>>::_Insert<std::pair<enum Windows::Gaming::Input::GamepadButtons const,unsigned short> &,std::_List_unchecked_iterator<std::_List_val<std::_List_simple_types<std::pair<enum Windows::Gaming::Input::GamepadButtons const,unsigned short>>>>>(
        __int64 a1,
        __int64 a2,
        unsigned __int8 *a3,
        __int64 *a4)
{
  ...
  if ( *(_QWORD *)(v11 + 16 * (v8 & *(_QWORD *)(a1 + 48))) != v12 )
  {
    ...
    {
      std::list<ISystemContextObserver *>::erase(v29 + 8, &v29, v31);
      throw;
    }
  }
  v13 = v12;
  while ( v13 != *(_QWORD *)(v11 + 16 * (v8 & *(_QWORD *)(a1 + 48))) )
  {
    v12 = *(_QWORD *)(v12 + 8);
    v13 = v12;
    if ( *(_DWORD *)v5 == *(_DWORD *)(v12 + 16) )
    {
      std::list<ISystemContextObserver *>::erase(a1 + 8, &v30, a4);
      *(_QWORD *)a2 = v12;
      *(_BYTE *)(a2 + 8) = 0;
      return a2;
    }
  ...
  {
    v23 = *(__int64 ***)(v15 + 8 * v10 + 8);
    v24 = *v23;
    *(_QWORD *)(v15 + 8 * v10 + 8) = *v23;
    if ( v24 != a4 )
  ...
  if ( (float)(v19 / v20) > *(float *)a1 )
  {
    try
    {
      if ( (unsigned __int64)v18 >= 0x200 )
      {
        if ( (unsigned __int64)v18 < 0xFFFFFFFFFFFFFFFLL )
          v18 *= 2LL;
      }
      else
      {
