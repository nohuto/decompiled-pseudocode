/*
 * XREFs of ?Process3DInput@MPCClickerProcessor@@UEAAJPEAUInputInfo@@@Z @ 0x180140030
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall MPCClickerProcessor::Process3DInput(unsigned __int64 this, struct InputInfo *a2)
{
  ...
  int v8; // eax
  const char *v9; // r9
  signed int v12; // [rsp+20h] [rbp-38h]
  wil::details::in1diag3 *retaddr; // [rsp+58h] [rbp+0h]
  struct IMPCTarget *v14; // [rsp+60h] [rbp+8h] BYREF
  struct IMPCTarget *v15; // [rsp+68h] [rbp+10h] BYREF
