/*
 * XREFs of ?Thunk_UpdateViewInstanceId_0@?$IInputAttemptedDeliveryClientProxy_Receive@VBamoInputAttemptedDeliveryClientProxyImpl@BamoImpl@@@@SAJPEAXPEAPEAX@Z @ 0x180002920
 * Callers:
 *     <none>
 * Callees:
