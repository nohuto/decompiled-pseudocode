/*
 * XREFs of ??0HotKeyProcessor@@QEAA@XZ @ 0x1801457FC
 * Callers:
 ...
 *     ?_Buyheadnode@?$_Tree_comp_alloc@V?$_Tset_traits@IU?$less@I@std@@V?$allocator@I@2@$0A@@std@@@std@@QEAAPEAU?$_Tree_node@IPEAX@2@XZ @ 0x18014721C (-_Buyheadnode@-$_Tree_comp_alloc@V-$_Tset_traits@IU-$less@I@std@@V-$allocator@I@2@$0A@@std@@@std.c)
...
HotKeyProcessor *__fastcall HotKeyProcessor::HotKeyProcessor(HotKeyProcessor *this)
{
  ...
  __int64 v3; // rcx
  __int64 **v4; // rax
  _BYTE v6[8]; // [rsp+28h] [rbp-40h] BYREF
  __int128 v7; // [rsp+30h] [rbp-38h] BYREF
  __int128 v8; // [rsp+40h] [rbp-28h] BYREF
  __int128 v9; // [rsp+50h] [rbp-18h] BYREF
  __int64 *v10; // [rsp+A0h] [rbp+38h] BYREF
  char v11; // [rsp+A8h] [rbp+40h] BYREF

  *((_DWORD *)this + 5) = 1;
  *(_QWORD *)this = &Microsoft::WRL::RuntimeClass<Microsoft::WRL::RuntimeClassFlags<2>,IRemoteHotKeyProcessor,IMessageProxyReconnectAdapterOwner>::`vftable'{for `IRemoteHotKeyProcessor'};
  *((_QWORD *)this + 1) = &Microsoft::WRL::RuntimeClass<Microsoft::WRL::RuntimeClassFlags<2>,IRemoteHotKeyProcessor,IMessageProxyReconnectAdapterOwner>::`vftable'{for `Microsoft::WRL::Details::ImplementsHelper<Microsoft::WRL::RuntimeClassFlags<2>,1,IMessageProxyReconnectAdapterOwner>'};
  ...
  *((_QWORD *)this + 3) = 0LL;
  *((_QWORD *)this + 4) = 0LL;
  *((_QWORD *)this + 3) = std::_Tree_comp_alloc<std::_Tmap_traits<unsigned char,std::shared_ptr<SpatialInteractionDevices::SpatialInputReportCaps>,std::less<unsigned char>,std::allocator<std::pair<unsigned char const,std::shared_ptr<SpatialInteractionDevices::SpatialInputReportCaps>>>,0>>::_Buyheadnode();
  *((_QWORD *)this + 5) = 0LL;
  *((_QWORD *)this + 6) = 0LL;
  *((_QWORD *)this + 5) = std::_Tree_comp_alloc<std::_Tset_traits<unsigned int,std::less<unsigned int>,std::allocator<unsigned int>,0>>::_Buyheadnode(v2);
  *((_QWORD *)this + 8) = 0LL;
  *((_QWORD *)this + 9) = 0LL;
  ...
  *((_QWORD *)this + 17) = 0LL;
  v8 = 0LL;
  *(_QWORD *)&v8 = std::_Tree_comp_alloc<std::_Tmap_traits<_GUID,std::vector<unsigned char>,Windows::Internal::Holographic::PropertyCache::GuidLess,std::allocator<std::pair<_GUID const,std::vector<unsigned char>>>,0>>::_Buyheadnode();
  v7 = 0LL;
  *(_QWORD *)&v7 = std::_Tree_comp_alloc<std::_Tset_traits<unsigned int,std::less<unsigned int>,std::allocator<unsigned int>,0>>::_Buyheadnode(v3);
  *((_BYTE *)this + 60) = 1;
  *((_DWORD *)this + 14) = 0;
  v9 = 0LL;
  v4 = (__int64 **)std::_Tree_comp_alloc<std::_Tmap_traits<unsigned int,unsigned long,std::less<unsigned int>,std::allocator<std::pair<unsigned int const,unsigned long>>,0>>::_Buyheadnode();
  *(_QWORD *)&v9 = v4;
  *((_WORD *)this + 40) = 0;
  std::_Tree<std::_Tmap_traits<enum GazeProperty,unsigned short,std::less<enum GazeProperty>,std::allocator<std::pair<enum GazeProperty const,unsigned short>>,0>>::erase(
    ...
    *v4,
    (__int64 *)v4);
  std::_Deallocate<16,0>((void *)v9, (const struct std::nothrow_t *)0x28);
  std::_Tree<std::_Tset_traits<unsigned int,std::less<unsigned int>,std::allocator<unsigned int>,0>>::erase(
    ...
    *(_QWORD *)v7,
    v7,
    -2LL);
  std::_Deallocate<16,0>((void *)v7, (const struct std::nothrow_t *)0x20);
