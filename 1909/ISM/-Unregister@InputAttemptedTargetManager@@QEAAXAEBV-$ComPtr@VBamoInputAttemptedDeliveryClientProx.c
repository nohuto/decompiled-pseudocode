/*
 * XREFs of ?Unregister@InputAttemptedTargetManager@@QEAAXAEBV?$ComPtr@VBamoInputAttemptedDeliveryClientProxy@@@WRL@Microsoft@@@Z @ 0x180070AEC
 * Callers:
 *     ?OnDisconnected@InputAttemptedDeliveryClientProxy@@UEAAJXZ @ 0x180070410 (-OnDisconnected@InputAttemptedDeliveryClientProxy@@UEAAJXZ.c)
 * Callees:
