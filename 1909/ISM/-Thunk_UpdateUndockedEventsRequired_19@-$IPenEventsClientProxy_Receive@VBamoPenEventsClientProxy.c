/*
 * XREFs of ?Thunk_UpdateUndockedEventsRequired_19@?$IPenEventsClientProxy_Receive@VBamoPenEventsClientProxyImpl@BamoImpl@@@@SAJPEAXPEAPEAX@Z @ 0x180033620
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall IPenEventsClientProxy_Receive<BamoImpl::BamoPenEventsClientProxyImpl>::Thunk_UpdateUndockedEventsRequired_19(
        __int64 a1,
        _BYTE **a2)
{
  int v3; // eax
  ...
  *(_BYTE *)(a1 + 36) = **a2;
  if ( *(_BYTE *)(a1 + 28) )
  {
    ...
    v3 = (*(__int64 (__fastcall **)(__int64))(*(_QWORD *)(a1 - 16) + 88LL))(a1 - 16);
    if ( v3 < 0 )
    {
