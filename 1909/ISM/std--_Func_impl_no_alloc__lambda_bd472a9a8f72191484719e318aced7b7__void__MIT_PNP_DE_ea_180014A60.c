/*
 * XREFs of std::_Func_impl_no_alloc__lambda_bd472a9a8f72191484719e318aced7b7__void__MIT_PNP_DEVICE_NOTIFICATION_MESSAGE_const___::_Do_call @ 0x180014A60
 * Callers:
 *     <none>
 * Callees:
 ...
 *     ?ComputePnpAction@Win32kInterop@@AEBA?AW4PnPHandlingAction@@W4_KnownRIMDeviceKind@@@Z @ 0x1800BB648 (-ComputePnpAction@Win32kInterop@@AEBA-AW4PnPHandlingAction@@W4_KnownRIMDeviceKind@@@Z.c)
    ...
    if ( TlgKeywordOn(v5, 1uLL) )
    {
      ...
      if ( **(_DWORD **)(v8 + 8) > 6u )
      {
        if ( TlgKeywordOn(*(TraceLoggingHProvider *)(v8 + 8), 1uLL) )
        {
          ...
          TlgWrite(v9, &unk_18019D8C8, &ActivityId, pRelatedActivityId, 3u, &pData);
        }
      }
    }
  }
