/*
 * XREFs of ?MPCMouseProcessor_InjectPress_@ISMTracing@@QEAAXJJKKK@Z @ 0x18013B054
 * Callers:
...
void __fastcall ISMTracing::MPCMouseProcessor_InjectPress_(ISMTracing *this, int a2, int a3, int a4, char a5, char a6)
{
  __int64 v6; // rcx
  ...
  if ( ISMTracing::IsEnabled((__int64)this) )
  {
    ...
    if ( *(_DWORD *)v7 > 4u )
    {
      if ( TlgKeywordOn(v7, 1uLL) )
      {
        ...
        v21 = v9;
        v24 = v9;
        TlgWrite(v8, &unk_1801A106E, 0LL, 0LL, 7u, &pData);
      }
    }
  }
}
