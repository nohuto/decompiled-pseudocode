/*
 * XREFs of ?PointerCrossedOverrideBounds@ControllerNavigationManager@InputETW@@SAXKUtagPOINT@@@Z @ 0x1800730AC
 * Callers:
 *     ?OnPointerCrossedOverrideBounds@ControllerNavigationManager@@QEAAXUtagPOINT@@@Z @ 0x180072D4C (-OnPointerCrossedOverrideBounds@ControllerNavigationManager@@QEAAXUtagPOINT@@@Z.c)
 * Callees:
  ...
  if ( InputETW::IsEnabled(a1) )
  {
    ...
    if ( *(_DWORD *)v5 > 5u )
    {
      if ( TlgKeywordOn(v5, 1uLL) )
      {
        ...
        v15 = 8;
        v18 = 8;
        TlgWrite(v6, &unk_18019B1C1, 0LL, 0LL, 5u, &pData);
      }
    }
  }
}
