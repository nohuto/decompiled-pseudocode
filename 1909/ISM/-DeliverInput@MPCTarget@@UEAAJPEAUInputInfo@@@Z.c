/*
 * XREFs of ?DeliverInput@MPCTarget@@UEAAJPEAUInputInfo@@@Z @ 0x180057330
 * Callers:
 *     ?DeliverInput@MPCFocusTarget@@UEAAJPEAUInputInfo@@@Z @ 0x180056DE0 (-DeliverInput@MPCFocusTarget@@UEAAJPEAUInputInfo@@@Z.c)
 * Callees:
 ...
 *     ??$As@UIMPCInputObjectProxy@@@?$ComPtr@UIUnknown@@@WRL@Microsoft@@QEBAJV?$ComPtrRef@V?$ComPtr@UIMPCInputObjectProxy@@@WRL@Microsoft@@@Details@12@@Z @ 0x180057078 (--$As@UIMPCInputObjectProxy@@@-$ComPtr@UIUnknown@@@WRL@Microsoft@@QEBAJV-$ComPtrRef@V-$ComPtr@UI.c)
 ...
 *     GetHandEventType @ 0x180057610 (GetHandEventType.c)
 *     GetInputEventType @ 0x180057670 (GetInputEventType.c)
 *     IsSubscribedForEventType @ 0x1800576D8 (IsSubscribedForEventType.c)
 *     IsSubscribedForEventType_0 @ 0x18005774C (IsSubscribedForEventType_0.c)
