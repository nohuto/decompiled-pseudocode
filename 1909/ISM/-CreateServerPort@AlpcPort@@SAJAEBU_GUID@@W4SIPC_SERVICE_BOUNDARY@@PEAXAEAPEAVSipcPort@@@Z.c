/*
 * XREFs of ?CreateServerPort@AlpcPort@@SAJAEBU_GUID@@W4SIPC_SERVICE_BOUNDARY@@PEAXAEAPEAVSipcPort@@@Z @ 0x180022190
 * Callers:
...
__int64 __fastcall AlpcPort::CreateServerPort(__int64 a1, __int64 a2, __int64 a3, AlpcPort **a4)
{
  ...
  *a4 = 0LL;
  ...
  if ( v8 < 0 )
    goto LABEL_19;
  AlpcPortString::AlpcPortString(v18, &xmmword_180181868, 1LL);
