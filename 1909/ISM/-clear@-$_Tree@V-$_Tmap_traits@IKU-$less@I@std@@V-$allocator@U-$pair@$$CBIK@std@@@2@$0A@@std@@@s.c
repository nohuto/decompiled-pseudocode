/*
 * XREFs of ?clear@?$_Tree@V?$_Tmap_traits@IKU?$less@I@std@@V?$allocator@U?$pair@$$CBIK@std@@@2@$0A@@std@@@std@@QEAAXXZ @ 0x18009620C
 * Callers:
 *     ??1?$map@IKU?$less@I@std@@V?$allocator@U?$pair@$$CBIK@std@@@2@@std@@QEAA@XZ @ 0x180095580 (--1-$map@IKU-$less@I@std@@V-$allocator@U-$pair@$$CBIK@std@@@2@@std@@QEAA@XZ.c)
