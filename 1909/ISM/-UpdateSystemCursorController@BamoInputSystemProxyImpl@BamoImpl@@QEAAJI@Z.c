/*
 * XREFs of ?UpdateSystemCursorController@BamoInputSystemProxyImpl@BamoImpl@@QEAAJI@Z @ 0x180064B94
 * Callers:
 *     ?Thunk_UpdateSystemCursorController_0@?$IInputSystemProxy_Receive@VBamoInputSystemProxyImpl@BamoImpl@@@@SAJPEAXPEAPEAX@Z @ 0x1800638F0 (-Thunk_UpdateSystemCursorController_0@-$IInputSystemProxy_Receive@VBamoInputSystemProxyImpl@Bamo.c)
 * Callees:
