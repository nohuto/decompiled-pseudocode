/*
 * XREFs of ?UpdateRestrictToProcessIdRemoteCache@BamoDataSourcePrincipalImpl@BamoImpl@@AEAAXPEAVBamoStubImpl@2Microsoft@@@Z @ 0x1800D1EB8
 * Callers:
        ...
        struct Microsoft::BamoImpl::BamoStubImpl *a2)
{
  ...
  if ( *(_QWORD *)(v2 + 40) )
  {
    ...
    v5[0] = *(unsigned int *)(*((_QWORD *)a2 + 5) + 36LL);
    v5[1] = v3;
