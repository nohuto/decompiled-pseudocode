/*
 * XREFs of ?SpatialInteractionEyeGaze_CombinedGaze_@SpatialInteractionTraceContinuous@SpatialInteractionDevices@@QEAAXMMMMMM@Z @ 0x1800F16F4
 * Callers:
        ...
        float a7)
{
  ...
  if ( *(_DWORD *)v7 > 4u )
  {
    if ( TlgKeywordOn(v7, 2uLL) )
    {
      ...
      v20 = v9;
      v22 = v9;
      TlgWrite(v8, &unk_18019FBAC, 0LL, 0LL, 8u, &pData);
    }
  }
}
