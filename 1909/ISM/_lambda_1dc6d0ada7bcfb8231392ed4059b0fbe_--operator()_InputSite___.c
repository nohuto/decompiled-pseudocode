/*
 * XREFs of _lambda_1dc6d0ada7bcfb8231392ed4059b0fbe_::operator()_InputSite___ @ 0x18002ED04
 * Callers:
 ...
 * Callees:
 *     ?GetProcessId@InputSite@@QEBAKXZ @ 0x18002F7A8 (-GetProcessId@InputSite@@QEBAKXZ.c)
 */
