/*
 * XREFs of ??$MakeAndInitialize@VMPCRawInputProvider@@UIRawInputProvider@@AEAPEAUIRawInputClient@@@Details@WRL@Microsoft@@YAJPEAPEAUIRawInputProvider@@AEAPEAUIRawInputClient@@@Z @ 0x180017C5C
 * Callers:
 ...
 *     ??0MPCRawInputProvider@@QEAA@XZ @ 0x180029FE4 (--0MPCRawInputProvider@@QEAA@XZ.c)
