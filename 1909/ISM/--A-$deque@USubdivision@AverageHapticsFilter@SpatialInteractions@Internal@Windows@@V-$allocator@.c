/*
 * XREFs of ??A?$deque@USubdivision@AverageHapticsFilter@SpatialInteractions@Internal@Windows@@V?$allocator@USubdivision@AverageHapticsFilter@SpatialInteractions@Internal@Windows@@@std@@@std@@QEAAAEAUSubdivision@AverageHapticsFilter@SpatialInteractions@Internal@Windows@@_K@Z @ 0x180163460
 * Callers:
