/*
 * XREFs of ?Thunk_UpdateGestureDistance_0@?$IEdgyControllerClientProxy_Receive@VBamoEdgyControllerClientProxyImpl@BamoImpl@@@@SAJPEAXPEAPEAX@Z @ 0x18006EEE0
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall IEdgyControllerClientProxy_Receive<BamoImpl::BamoEdgyControllerClientProxyImpl>::Thunk_UpdateGestureDistance_0(
        __int64 a1,
        _DWORD **a2)
{
  int v3; // eax
