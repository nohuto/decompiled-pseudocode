/*
 * XREFs of ?CreateCustomCursorSharedTarget@SystemCursor@@QEAAJPEAUIContainerVisual@Composition@UI@Windows@@PEAPEAX@Z @ 0x1800CC974
 * Callers:
        ...
        void **a3)
{
  ...
  __int64 v29[2]; // [rsp+40h] [rbp-20h] BYREF
  __int64 v30; // [rsp+50h] [rbp-10h] BYREF
  std::_Ref_count_base *v31; // [rsp+58h] [rbp-8h]
...
LABEL_21:
      ...
      Microsoft::WRL::ComPtr<Windows::Gaming::Input::Internal::IGipGameControllerProviderPrivate>::InternalRelease((__int64 *)&v28);
      goto LABEL_33;
    }
    v34 = 0LL;
    v9 = v26;
    v10 = *(__int64 (__fastcall **)(__int64, __int64 (__fastcall ****)(_QWORD, GUID *, __int64 *)))(*(_QWORD *)v26 + 88LL);
...
LABEL_18:
    ...
    hObject = 0LL;
    v18 = v26;
    v19 = *(__int64 (__fastcall **)(__int64, __int64, HANDLE *))(*(_QWORD *)v26 + 168LL);
