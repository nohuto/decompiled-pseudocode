/*
 * XREFs of _Windows::Internal::SpatialInteractions::SpatialInteractionEyeGazeObjectDevice::StopListeningToSpatialObjects_::_1_::catch$2 @ 0x1800F1D78
 * Callers:
 *     <none>
 * Callees:
