/*
 * XREFs of ??$MakeAndInitialize@VAnimationDataProvider@@UIAnimationDataProvider@@$$V@Details@WRL@Microsoft@@YAJPEAPEAUIAnimationDataProvider@@@Z @ 0x1800188E8
 * Callers:
 ...
 * Callees:
 *     ??0AnimationDataProvider@@QEAA@XZ @ 0x180018998 (--0AnimationDataProvider@@QEAA@XZ.c)
