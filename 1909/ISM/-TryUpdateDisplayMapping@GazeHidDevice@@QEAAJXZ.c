/*
 * XREFs of ?TryUpdateDisplayMapping@GazeHidDevice@@QEAAJXZ @ 0x1800A6A4C
 * Callers:
    ...
    if ( v5 >= 0 )
    {
      ...
      if ( v8 >= 0 )
      {
        ...
        HMonitorFromEdid = DisplayEdidHelpers::GetHMonitorFromEdid(
                             ...
                             (const struct EdidIdentificationBlock *)(v2 + 24),
                             v10);
        ...
        AdapterAndTargetFromEdid = DisplayEdidHelpers::GetAdapterAndTargetFromEdid(
                                     (DisplayEdidHelpers *)&v22,
                                     (const struct EdidIdentificationBlock *)(v2 + 1592),
                                     (struct _LUID *)(v2 + 1600),
                                     v12);
        ...
        v14 = GazeHidParser::GetCalibratedRegion(v3, v16, v7, (struct tagRECT *)(v2 + 1572));
        if ( v14 < 0 )
          wil::details::in1diag3::_Log_Hr(
            retaddr,
            233LL,
