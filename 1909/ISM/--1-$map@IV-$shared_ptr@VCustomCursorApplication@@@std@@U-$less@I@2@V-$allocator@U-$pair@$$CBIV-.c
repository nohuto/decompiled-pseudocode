/*
 * XREFs of ??1?$map@IV?$shared_ptr@VCustomCursorApplication@@@std@@U?$less@I@2@V?$allocator@U?$pair@$$CBIV?$shared_ptr@VCustomCursorApplication@@@std@@@std@@@2@@std@@QEAA@XZ @ 0x1800C8D50
 * Callers:
 *     _SystemCursorController::SystemCursorController_::_1_::dtor$2 @ 0x18003D136 (_SystemCursorController--SystemCursorController_--_1_--dtor$2.c)
 * Callees:
