/*
 * XREFs of ?MPCInputRouter_GetFrameworkViewTypeFromFocusTarget_@ISMTracing@@QEAAXPEAUIInputTarget@@KI_K@Z @ 0x180054A18
 * Callers:
        ...
        unsigned __int64 a5)
{
  ...
  if ( *(_DWORD *)v8 > 4u && TlgKeywordOn((TraceLoggingHProvider)v7[1], 1uLL) )
  {
            ...
            if ( v13 )
            {
              ...
              if ( v14 )
              {
                if ( v14 == 1 )
                  ...
                  v15 = (const unsigned __int16 *)((char *)&word_180182F5B + 1);
              }
              else
              {
                v15 = L"Shell";
    ...
    v29 = &a5;
    v30 = 8;
    TlgWrite(v8, &unk_18019A7F2, 0LL, 0LL, 7u, &pData);
  }
}
