/*
 * XREFs of ?FxStubDriverUnloadCommon@@YAXXZ @ 0x1C0001C64
 * Callers:
...
void FxStubDriverUnloadCommon(void)
{
  ...
  if ( off_1C0013148 != &__KMDF_CLASS_BIND_START && &__KMDF_CLASS_BIND_END <= off_1C0013148 )
  {
    do
    {
