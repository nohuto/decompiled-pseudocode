/*
 * XREFs of ProcLibTraceSummary2 @ 0x1C001CB00
 * Callers:
...
char __fastcall ProcLibTraceSummary2(__int64 a1, char a2)
{
  ...
  v2 = (const EVENT_DESCRIPTOR *)&PPM_ETW_SUMMARY2_RUNDOWN;
  v29 = 0;
  if ( !a2 )
    v2 = EventDescriptor;
    ...
    if ( ProcessorNumber >= 0 )
    {
      ...
      else
      {
        if ( (v5 & 0x8000000) == 0 )
        {
          ...
          {
            v25 = 2;
            v10 = *(_DWORD *)(qword_1C0013908 + 28);
            v22 = v10;
            v24 = 100 * *(_DWORD *)(qword_1C0013908 + 36) / v10;
            v23 = 100 * *(_DWORD *)(qword_1C0013908 + 32) / v10;
          }
          else
          {
            if ( (v5 & 0x73300000) == 0 )
...
LABEL_42:
        ...
        *(_QWORD *)&UserData.Size = 2LL;
        ...
        v44 = 4LL;
        v46 = 4LL;
        EtwWrite((REGHANDLE)WPP_MAIN_CB.Queue.ListEntry.Flink, v2, 0LL, 9u, &UserData);
