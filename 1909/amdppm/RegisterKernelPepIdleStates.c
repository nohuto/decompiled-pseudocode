/*
 * XREFs of RegisterKernelPepIdleStates @ 0x1C00280EC
 * Callers:
...
__int64 __fastcall RegisterKernelPepIdleStates(__int64 a1, __int64 a2, __int64 a3)
{
  ...
  (*(void (__fastcall **)(PWDF_DRIVER_GLOBALS, __int64, _QWORD))(WdfFunctions_01015 + 2504))(
    ...
    qword_1C0013418,
    0LL);
  if ( !dword_1C0013970 || PlatformStatesRegistered )
  {
    v7 = 0;
  }
  else
  {
    HIDWORD(v30[0]) = dword_1C0013970;
    LODWORD(v30[0]) = 62;
    v30[5] = PepQueryPlatformStateResidency;
    v7 = ((__int64 (__fastcall *)(_QWORD *))qword_1C0013658)(v30);
    if ( v7 >= 0 )
    {
