/*
 * XREFs of wil_details_FeaturePropertyCache_ReportUsageToServiceDirect @ 0x1C0001698
 * Callers:
...
__int64 __fastcall wil_details_FeaturePropertyCache_ReportUsageToServiceDirect(__int64 a1, __int64 a2, int a3)
{
  ...
  v3 = 0;
  v16 = 0uLL;
  v4 = Feature_AmdPpmAllowPseudoEpp__private_propertyCache & 0x30;
  v5 = 0;
  v17 = 0LL;
  if ( a3 < 0 )
    goto LABEL_27;
...
LABEL_21:
    ...
    while ( 1 )
    {
      v15 = Feature_AmdPpmAllowPseudoEpp__private_propertyCache;
      v10 = Feature_AmdPpmAllowPseudoEpp__private_propertyCache;
      if ( !v9(&v15, &v24) )
        goto LABEL_19;
      if ( v10 == _InterlockedCompareExchange(&Feature_AmdPpmAllowPseudoEpp__private_propertyCache, v15, v10) )
      {
LABEL_18:
        v8 = 0;
        goto LABEL_20;
...
LABEL_27:
    if ( (unsigned int)(a3 - 320) <= 0x3F
      && a3 - 320 == (((unsigned int)Feature_AmdPpmAllowPseudoEpp__private_propertyCache >> 7) & 0x3F) )
    {
      if ( (Feature_AmdPpmAllowPseudoEpp__private_propertyCache & 0x40) != 0 )
      {
        LODWORD(v17) = 1;
        goto LABEL_34;
      }
      ...
      do
      {
        v11 = Feature_AmdPpmAllowPseudoEpp__private_propertyCache;
        LODWORD(v16) = 0;
      }
      while ( (v22 & Feature_AmdPpmAllowPseudoEpp__private_propertyCache) != v22
           && v11 != _InterlockedCompareExchange(
                       &Feature_AmdPpmAllowPseudoEpp__private_propertyCache,
                       v22 | Feature_AmdPpmAllowPseudoEpp__private_propertyCache,
                       Feature_AmdPpmAllowPseudoEpp__private_propertyCache) );
    }
...
LABEL_6:
  ...
  while ( 1 )
  {
    v7 = Feature_AmdPpmAllowPseudoEpp__private_propertyCache;
    LODWORD(v16) = 0;
    if ( (v19 & Feature_AmdPpmAllowPseudoEpp__private_propertyCache) == v19 )
      break;
    v14 = v19 | Feature_AmdPpmAllowPseudoEpp__private_propertyCache;
    if ( (((unsigned __int8)v19 | (unsigned __int8)Feature_AmdPpmAllowPseudoEpp__private_propertyCache) & 8) == 0 )
    {
      LODWORD(v16) = 1;
      v14 = v19 | Feature_AmdPpmAllowPseudoEpp__private_propertyCache | 8;
    }
...
LABEL_34:
  ...
  if ( g_wil_details_recordFeatureUsage )
  {
    ...
    if ( v4 == 32 )
    {
      v31 = ((unsigned int)Feature_AmdPpmAllowPseudoEpp__private_propertyCache >> 2) & 1;
      v28 = 0LL;
      v30 = 0LL;
      v29 = a3;
      g_wil_details_recordFeatureUsage(19581266LL, (unsigned int)a3, 1LL, 0LL, &v28);
    }
  }
