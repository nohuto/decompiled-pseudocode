/*
 * XREFs of RegisterKernelCoordinatedLpiStates @ 0x1C0028D18
 * Callers:
...
__int64 __fastcall RegisterKernelCoordinatedLpiStates(__int64 a1)
{
  ...
  v10 = 0LL;
  v11 = 0LL;
  CoordinatedLpiStates = AcpiGetCoordinatedLpiStates(a1, (unsigned int **)&qword_1C00139A0);
  if ( CoordinatedLpiStates >= 0 )
  {
    ...
    *(_QWORD *)(v5 + 24) = v6;
    ...
    qword_1C0013988 = v5;
    qword_1C0013990 = v7;
    CoordinatedLpiStates = ((__int64 (__fastcall *)(__int64))qword_1C0013660)(v5);
    if ( CoordinatedLpiStates >= 0 )
      return 0;
