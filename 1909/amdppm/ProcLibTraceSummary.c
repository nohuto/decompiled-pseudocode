/*
 * XREFs of ProcLibTraceSummary @ 0x1C001C7F0
 * Callers:
...
char __fastcall ProcLibTraceSummary(_QWORD *a1)
{
  ...
  v2 = 0LL;
  v3 = 0LL;
  LOBYTE(ProcessorNumber) = EtwEventEnabled((REGHANDLE)WPP_MAIN_CB.Queue.ListEntry.Flink, &PPM_ETW_SUMMARY_RUNDOWN);
...
LABEL_26:
      ...
      EtwWrite((REGHANDLE)WPP_MAIN_CB.Queue.ListEntry.Flink, &PPM_ETW_SUMMARY_RUNDOWN, 0LL, v6, &UserData);
      goto LABEL_26;
    }
  }
  return ProcessorNumber;
