/*
 * XREFs of ProcLibTraceProcessorRundown @ 0x1C001D5D0
 * Callers:
...
char __fastcall ProcLibTraceProcessorRundown(__int64 a1)
{
  ...
  struct _PROCESSOR_NUMBER v16; // [rsp+54h] [rbp-15h] BYREF
  ULONG RequiredSize; // [rsp+58h] [rbp-11h] BYREF
