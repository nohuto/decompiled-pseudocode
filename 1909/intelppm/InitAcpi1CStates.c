/*
 * XREFs of InitAcpi1CStates @ 0x1C00321B0
 * Callers:
...
__int64 __fastcall InitAcpi1CStates(__int64 a1)
{
  ...
  *(_QWORD *)(a1 + 256) |= v1 & 7;
  ...
  if ( (v1 & 2) != 0
    ...
    && IsValidAcpiGenericAddress((unsigned __int8 *)&dword_1C001BDAC)
  ...
  if ( (v7 & 4) != 0
    && (unsigned __int16)word_1C001BD92 <= 0x3E8u
    && IsValidAcpiGenericAddress((unsigned __int8 *)&dword_1C001BDC4)
    && IsValidAcpiGenericAddress((unsigned __int8 *)&dword_1C001BD94)
    && IsValidAcpiGenericAddress((unsigned __int8 *)&dword_1C001BDAC)
    && IsValidAcpiGenericAddress((unsigned __int8 *)(a1 + 184))
    && dword_1C001B394 == 1 )
  {
  ...
  if ( PoolWithTag )
  {
    ...
    *v10 = v11;
    ...
    if ( v5 )
    {
      ...
      HIWORD(v10[5 * *v10 + 4]) = word_1C001BD92;
      v10[5 * *v10 + 5] = 0;
      if ( *(_DWORD *)(a1 + 188) != -5 )
      {
        LOBYTE(v10[5 * *v10 + 1]) = 1;
