/*
 * XREFs of DisplayGenAddr @ 0x1C0002648
 * Callers:
 ...
 *     GetGenAddrType @ 0x1C000BD78 (GetGenAddrType.c)
 *     WPP_RECORDER_SF_sDs @ 0x1C000C660 (WPP_RECORDER_SF_sDs.c)
 *     WPP_RECORDER_SF_si @ 0x1C000C95C (WPP_RECORDER_SF_si.c)
 */

unsigned __int8 __fastcall DisplayGenAddr(char *a1, __int64 a2, int a3, int a4)
{
