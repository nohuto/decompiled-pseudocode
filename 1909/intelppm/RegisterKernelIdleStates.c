/*
 * XREFs of RegisterKernelIdleStates @ 0x1C0003A60
 * Callers:
 *     <none>
 * Callees:
 ...
 *     RegisterHiddenIdleStates @ 0x1C0033E74 (RegisterHiddenIdleStates.c)
 *     RegisterKernelLpiStates @ 0x1C003442C (RegisterKernelLpiStates.c)
...
LABEL_22:
      ...
      if ( (*(_QWORD *)(a1 + 264) & 0x100300000300LL) != 0 && *(_QWORD *)(a1 + 696) )
        *((_BYTE *)v1 + 17) = 1;
      v14 = ((__int64 (__fastcall *)(void *))qword_1C001B5C8)(v1);
