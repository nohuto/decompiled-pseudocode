/*
 * XREFs of PepIdlePrepare @ 0x1C000EA40
 * Callers:
 *     <none>
 * Callees:
 ...
 *     PepIdleCancel @ 0x1C000E7E0 (PepIdleCancel.c)
 */
...
__int64 __fastcall PepIdlePrepare(_QWORD **a1)
{
  ...
  if ( dword_1C001B8E8 >= (unsigned int)dword_1C001B394 )
  {
    ...
    HIDWORD(v18) = !v7;
    if ( (int)((__int64 (__fastcall *)(_QWORD, ULONG_PTR *))qword_1C001B640)(
    ...
    if ( !LOBYTE(BugCheckParameter3[1]) )
    {
      ...
      if ( LODWORD(BugCheckParameter3[4]) != -1 && LODWORD(BugCheckParameter3[4]) >= dword_1C001B8F0 )
