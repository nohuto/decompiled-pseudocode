/*
 * XREFs of PepParkPreference @ 0x1C000FFE0
 * Callers:
 *     <none>
 * Callees:
        ...
        __int64 a8)
{
  ...
  while ( v14 < v11 )
  {
    ...
    v13 = *((_QWORD *)&WPP_MAIN_CB.Queue.ListEntry.Flink->Flink + v20);
...
LABEL_22:
  ...
  if ( v14 && v13 )
  {
    ...
    v22[2] = a2;
    v22[1] = PepParkLists;
    result = ((__int64 (__fastcall *)(_QWORD, _QWORD *))qword_1C001B630)(*(_QWORD *)(v13 + 1104), v22);
    if ( (int)result < 0 )
    {
