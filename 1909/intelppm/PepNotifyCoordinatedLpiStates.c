/*
 * XREFs of PepNotifyCoordinatedLpiStates @ 0x1C003605C
 * Callers:
 *     RegisterKernelCoordinatedLpiStates @ 0x1C00341AC (RegisterKernelCoordinatedLpiStates.c)
 * Callees:
...
__int64 __fastcall PepNotifyCoordinatedLpiStates(__int64 a1, _DWORD *a2, unsigned int *a3, __int64 a4)
{
  ...
  v15 = (96 * (_DWORD)v4 + 15) & 0xFFFFFFF8;
  v16 = (unsigned int)(v15 + 24 * v8);
  ...
  if ( PoolWithTag )
  {
    ...
    *v19 = v4;
        ...
        *v24 = v21;
        ...
        if ( (_DWORD)v26 )
        {
          do
          {
            ...
            v29 = 3LL * v25;
            if ( *(_DWORD *)v28 != -1 )
              *(_QWORD *)(v27 + 24LL * v25) = *(_QWORD *)(GetDevExtFromIndex(*(_DWORD *)v28) + 1104);
            v30 = *(_DWORD *)(v28 + 4);
            v31 = 0;
            *(_QWORD *)(v27 + 8 * v29 + 16) = v22;
    ...
    ((void (__fastcall *)(_QWORD, _DWORD *, __int64, __int64))qword_1C001B658)(*(_QWORD *)(a1 + 1104), v19, v20, i);
