/*
 * XREFs of InitEnergyCountersMsrEx @ 0x1C00299E4
 * Callers:
 ...
 *     ActivateFixedFunctionCounters @ 0x1C0005C00 (ActivateFixedFunctionCounters.c)
 */
...
_DWORD *InitEnergyCountersMsrEx()
{
  ...
  if ( !v1 )
  {
    ...
    *(_DWORD *)&WPP_MAIN_CB.DeviceQueue.Type |= 0x40u;
    qword_1C001BA40[0] = (__int64)SnapEnergyCounters;
    result = ComputeProcessorEnergyMsrEx;
    qword_1C001BA38[0] = (__int64)ComputeProcessorEnergyMsrEx;
  }
  return result;
}
