/*
 * XREFs of ?FreeFrame@Pointer@InputTraceLogging@@SAXPEBUCPointerInputFrame@@@Z @ 0x1C0164CFC
 * Callers:
...
void __fastcall InputTraceLogging::Pointer::FreeFrame(const struct CPointerInputFrame *a1)
{
  __int64 v1; // r9
  ...
  if ( dword_1C020CB50 > 5u )
  {
    if ( TlgKeywordOn((TraceLoggingHProvider)&dword_1C020CB50, 0x20uLL) )
    {
      ...
      v8 = 8LL;
      v10 = 4LL;
      TlgWrite((TraceLoggingHProvider)&dword_1C020CB50, &unk_1C01E4466, 0LL, 0LL, 5u, &pData);
    }
  }
}
