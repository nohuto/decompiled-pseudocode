/*
 * XREFs of ?CapturePointer@CApplicationChannel@DirectComposition@@QEAAJIW4CapturePointerType@@I_K@Z @ 0x1C01A32C8
 * Callers:
 ...
 *     ?OwnsPointerId@CInputManager@@SA_NII@Z @ 0x1C01C5998 (-OwnsPointerId@CInputManager@@SA_NII@Z.c)
 */
        ...
        __int64 a5)
{
  ...
  if ( !v11 || !(*(unsigned __int8 (__fastcall **)(__int64, __int64))(*(_QWORD *)v11 + 120LL))(v11, 87LL) )
    return (unsigned int)-1073741811;
  if ( !a3 )
  {
    v9 = CDynamicArray<unsigned int,2003858261>::Grow(v11 + 264);
    if ( v9 >= 0 )
    {
      *(_DWORD *)(*(_QWORD *)(v11 + 264) + 4LL * (unsigned int)(*(_DWORD *)(v11 + 272))++) = a4;
      *(_DWORD *)(v11 + 16) |= 0x80u;
    }
    goto LABEL_22;
  }
  ...
  *((_QWORD *)&v14 + 1) = a5;
  v9 = 0;
  LODWORD(v14) = a4;
  if ( *(_DWORD *)(v11 + 288) == *(_DWORD *)(v11 + 292) )
  {
    v9 = CDynamicArray<InjectManipulationArgs *,2003858261>::Grow(v11 + 280);
    if ( v9 < 0 )
    {
LABEL_22:
      if ( v9 >= 0 )
  ...
  if ( v9 >= 0 )
  {
    ...
    {
      *v12 = v14;
      *(_QWORD *)(*(_QWORD *)(v11 + 280) + 8LL * (unsigned int)(*(_DWORD *)(v11 + 288))++) = v12;
      goto LABEL_22;
    }
  }
  return (unsigned int)v9;
