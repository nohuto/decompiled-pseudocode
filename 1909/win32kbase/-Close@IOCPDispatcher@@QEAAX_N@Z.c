/*
 * XREFs of ?Close@IOCPDispatcher@@QEAAX_N@Z @ 0x1C009C320
 * Callers:
 ...
 *     ?CleanupThreadDispatcherObjects@IOCPDispatcher@@AEAAXXZ @ 0x1C009C59C (-CleanupThreadDispatcherObjects@IOCPDispatcher@@AEAAXXZ.c)
 *     ?CleanupInputDispatcherObjects@IOCPDispatcher@@AEAAXXZ @ 0x1C009C604 (-CleanupInputDispatcherObjects@IOCPDispatcher@@AEAAXXZ.c)
        ...
        if ( v32 && (*(int *)(v32 + 24) > 0 || *(_DWORD *)(v47 + 48)) )
        {
          ...
          if ( dword_1C020CB50 > 6u )
          {
            if ( TlgKeywordOn((TraceLoggingHProvider)&dword_1C020CB50, 0x2000uLL) )
            {
              ...
              v51 = &v40;
              v52 = 4LL;
              TlgWrite((TraceLoggingHProvider)&dword_1C020CB50, &unk_1C01E1517, &ActivityId, 0LL, 3u, &v50);
            }
          }
        }
      }
      ...
      if ( InputTraceLogging::Perf::s_userCritLoggingEnabled && v47 && (*(_DWORD *)(v47 + 48) || *(int *)(v47 + 24) > 0) )
      {
        ...
        *(GUID *)(v47 + 28) = ActivityId;
        if ( dword_1C020CB50 > 6u )
        {
          ...
          if ( v33 > 6 && TlgKeywordOn((TraceLoggingHProvider)&dword_1C020CB50, 0x2000uLL) )
          {
            v42 = v48;
            v57 = &v42;
            v58 = 4LL;
