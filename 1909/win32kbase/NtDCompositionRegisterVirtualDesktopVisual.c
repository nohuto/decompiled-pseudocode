/*
 * XREFs of NtDCompositionRegisterVirtualDesktopVisual @ 0x1C01A0760
 * Callers:
 *     <none>
 * Callees:
  ...
  if ( v7 >= 0 )
  {
    ...
    if ( *((_DWORD *)Object + 9) == 189 )
    {
      ...
      if ( v7 >= 0 )
      {
        ...
        v7 = DwmAsyncRegisterSharedVirtualDesktopVisual(v9, a1, v6, Object, v11);
      }
      GreUnlockDwmState();
    }
    else
