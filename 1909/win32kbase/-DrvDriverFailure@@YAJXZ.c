/*
 * XREFs of ?DrvDriverFailure@@YAJXZ @ 0x1C010FD7C
 * Callers:
 *     ?UserInitialize@@YAJXZ @ 0x1C005EBE8 (-UserInitialize@@YAJXZ.c)
 * Callees:
 *     __security_check_cookie @ 0x1C00B7F30 (__security_check_cookie.c)
 *     memset @ 0x1C00BF640 (memset.c)
 *     ??4tagKERNELDISPLAYINFO@@QEAAAEAU0@AEAU0@@Z @ 0x1C010FB5C (--4tagKERNELDISPLAYINFO@@QEAAAEAU0@AEAU0@@Z.c)
...
__int64 DrvDriverFailure(void)
{
  ...
  *(_QWORD *)&DestinationString.Length = 0LL;
  ...
  if ( v0 != 1 )
  {
    ...
    if ( gpDispInfo )
      tagKERNELDISPLAYINFO::operator=(&v13[29]);
