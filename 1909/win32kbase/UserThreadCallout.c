/*
 * XREFs of UserThreadCallout @ 0x1C002D0D0
 * Callers:
 *     <none>
 * Callees:
      ...
      *(GUID *)(v79 + 28) = ActivityId;
      if ( dword_1C020CB50 > 6u )
      {
        if ( TlgKeywordOn((TraceLoggingHProvider)&dword_1C020CB50, 0x2000uLL) )
        {
          ...
          v89 = &v73;
          v90 = 4;
          TlgWrite((TraceLoggingHProvider)&dword_1C020CB50, &unk_1C01E14C0, &ActivityId, 0LL, 3u, &v88);
          v48 = dword_1C020CB50;
        }
        if ( v48 > 6 && TlgKeywordOn((TraceLoggingHProvider)&dword_1C020CB50, 0x2000uLL) )
        {
          v95 = 0;
          v74 = v80;
          v93 = &v74;
          v94 = 4;
          TlgWrite((TraceLoggingHProvider)&dword_1C020CB50, &unk_1C01E14ED, &ActivityId, 0LL, 3u, &v92);
        }
      }
    }
      ...
      if ( v54 && (*(int *)(v54 + 24) > 0 || *(_DWORD *)(v82 + 48)) )
      {
        ...
        if ( dword_1C020CB50 > 6u )
        {
          if ( TlgKeywordOn((TraceLoggingHProvider)&dword_1C020CB50, 0x2000uLL) )
          {
            ...
            v97 = &v75;
            v98 = 4LL;
            TlgWrite((TraceLoggingHProvider)&dword_1C020CB50, &unk_1C01E1517, &pActivityId, 0LL, 3u, &v96);
          }
        }
      }
    }
      ...
      *(GUID *)(v82 + 28) = pActivityId;
      if ( dword_1C020CB50 > 6u )
      {
        if ( TlgKeywordOn((TraceLoggingHProvider)&dword_1C020CB50, 0x2000uLL) )
        {
          ...
          v100 = &v76;
          v101 = 4LL;
          TlgWrite((TraceLoggingHProvider)&dword_1C020CB50, &unk_1C01E14C0, &pActivityId, 0LL, 3u, &v99);
          v55 = dword_1C020CB50;
        }
        if ( v55 > 6 && TlgKeywordOn((TraceLoggingHProvider)&dword_1C020CB50, 0x2000uLL) )
        {
          v77 = v83;
          v103 = &v77;
          v104 = 4LL;
          TlgWrite((TraceLoggingHProvider)&dword_1C020CB50, &unk_1C01E14ED, &pActivityId, 0LL, 3u, &v102);
        }
      }
    }
    EtwTraceAcquiredExclusiveUserCrit();
