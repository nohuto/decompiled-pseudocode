/*
 * XREFs of ?UpdateActivePointer@CTouchProcessor@@QEAAGPEBUCPointerInputFrame@@PEBUtagPOINTEREVENTINT@@VCInputDest@@PEAV4@PEAKPEAGPEAIK@Z @ 0x1C017386C
 * Callers:
  ...
  *a8 = 0;
  ...
  if ( NodeById )
  {
    if ( (*(_DWORD *)(a3 + 20) & 1) == 0 )
    {
      ...
      if ( !CTouchProcessor::SetNewValidState(a1, v14, NodeById) )
      {
        ...
        {
          LOBYTE(v27) = 2;
          WPP_RECORDER_SF_((_DWORD)gBaseLog, v27, 7, 60, (__int64)&WPP_dde6ae6ba4d53e169de0efe5dbb74602_Traceguids);
          if ( WPP_RECORDER_INITIALIZED != (_UNKNOWN *)&WPP_RECORDER_INITIALIZED )
          {
            if ( LOWORD(WPP_GLOBAL_Control->DeviceType) )
            {
  ...
  else
  {
    ...
    if ( !NodeById )
    {
      ...
      {
        LOBYTE(v20) = 2;
        WPP_RECORDER_SF_((_DWORD)gBaseLog, v20, 7, 56, (__int64)&WPP_dde6ae6ba4d53e169de0efe5dbb74602_Traceguids);
        if ( WPP_RECORDER_INITIALIZED != (_UNKNOWN *)&WPP_RECORDER_INITIALIZED )
        {
          if ( LOWORD(WPP_GLOBAL_Control->DeviceType) )
          {
