/*
 * XREFs of ?ProcessTapsFor3orMoreContacts@CPTPEngine@@AEAAHPEAUPTPInput@@K@Z @ 0x1C01953F8
 * Callers:
 ...
 *     ?Send2FingerTap@CPTPEngine@@AEAAXPEAUPTPInput@@@Z @ 0x1C0196744 (-Send2FingerTap@CPTPEngine@@AEAAXPEAUPTPInput@@@Z.c)
 ...
 *     ?SuppressContactForMultiFingerTap@CPTPEngine@@AEAAHPEBUCContactState@@@Z @ 0x1C0197278 (-SuppressContactForMultiFingerTap@CPTPEngine@@AEAAHPEBUCContactState@@@Z.c)
 */
...
__int64 __fastcall CPTPEngine::ProcessTapsFor3orMoreContacts(CPTPEngine *this, struct PTPInput *a2, unsigned int a3)
{
  ...
  while ( v9 != v11 )
  {
    if ( ((unsigned __int8)*(_DWORD *)v9 & (unsigned __int8)v4) != 0 )
    {
      ...
      else if ( *((_DWORD *)v9 + 33) < *((_DWORD *)this + 765) )
      {
        v8 = 0;
      }
    }
...
LABEL_34:
  if ( (v3 & 0x1000000) == 0 )
    return 0LL;
  CPTPEngine::SendMouseUpIfPending(this, (unsigned int *)this + 735);
  v24 = *((_DWORD *)this + 814);
  if ( (v24 & 8) != 0 || (v24 & 0x10) != 0 )
  {
    *((_DWORD *)this + 814) = v24 & 0xFEFFFFFF;
    return 0LL;
  }
  if ( v14 == *((_DWORD *)a2 + 12) - v10 )
  {
    ...
    if ( v25 == 3 )
    {
      CBasePTPEngine::SendShellOutput(this, 0LL, v23);
      v27 = 3LL;
      goto LABEL_42;
    }
    if ( v25 == 4 )
    {
      CBasePTPEngine::SendShellOutput(this, 1LL, v23);
      v27 = 4LL;
LABEL_42:
      v28 = (unsigned __int64)v27;
      v29 = 0LL;
      CBasePTPEngine::SendTelemetryOutput(this, 4LL, &v28);
    }
    else if ( v25 == 2 && (*((_DWORD *)this + 104) & 0x400) != 0 )
    {
      if ( v8 )
