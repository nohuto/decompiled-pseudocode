/*
 * XREFs of ?SpeedHitTest@Pointer@InputTraceLogging@@SAXAEBTPOINTERINFOUNION@@AEBVCInputDest@@K_N@Z @ 0x1C01727AC
 * Callers:
...
LABEL_5:
  ...
  *(_OWORD *)pwsz = *(_OWORD *)(WindowDetails + 16);
  ...
  if ( a4 )
  {
    if ( dword_1C020CB50 > 4u )
    {
      if ( TlgKeywordOn((TraceLoggingHProvider)&dword_1C020CB50, 0x20uLL) )
      {
        ...
        TlgWrite((TraceLoggingHProvider)&dword_1C020CB50, &unk_1C01E4CCE, 0LL, 0LL, 0xEu, &pData);
      }
    }
  }
  else if ( dword_1C020CB50 > 4u && TlgKeywordOn((TraceLoggingHProvider)&dword_1C020CB50, 0x20uLL) )
  {
    ...
    TlgCreateWsz(&v49, v26[1]);
    TlgCreateSz(&v50, (LPCSTR)v26[0]);
    TlgWrite((TraceLoggingHProvider)&dword_1C020CB50, &unk_1C01E4D95, 0LL, 0LL, 0xEu, &pData);
  }
}
