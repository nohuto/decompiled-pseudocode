/*
 * XREFs of ?SetQFrameNonCoalescable@CTouchProcessor@@AEAAHPEBUCPointerInputFrame@@PEBUCPointerInfoNode@@@Z @ 0x1C0172374
 * Callers:
        ...
        const struct CPointerInfoNode *a3)
{
  ...
  result = 1LL;
  *(_DWORD *)(168LL * (unsigned int)v11 + v12 + 148) &= ~1u;
  return result;
}
