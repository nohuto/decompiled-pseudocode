/*
 * XREFs of NtDCompositionProcessChannelBatchBuffer @ 0x1C0013460
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall NtDCompositionProcessChannelBatchBuffer(__int64 a1, unsigned int a2, unsigned int *a3, bool *a4)
{
  ...
  int v17; // ebx
  bool v18; // dl
  unsigned int v20; // [rsp+34h] [rbp-74h] BYREF
  unsigned int v21; // [rsp+38h] [rbp-70h]
  signed int v22; // [rsp+3Ch] [rbp-6Ch]
  __int64 v23; // [rsp+40h] [rbp-68h]
  __int64 v24; // [rsp+48h] [rbp-60h]
  int v25; // [rsp+50h] [rbp-58h]
  int Buffer; // [rsp+58h] [rbp-50h] BYREF
  __int64 v27; // [rsp+5Ch] [rbp-4Ch]
  int v28; // [rsp+64h] [rbp-44h]
