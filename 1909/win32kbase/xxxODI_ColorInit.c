/*
 * XREFs of xxxODI_ColorInit @ 0x1C00611B0
 * Callers:
 *     InitUserScreen @ 0x1C00625FC (InitUserScreen.c)
 * Callees:
 *     xxxSetSysColors @ 0x1C0050550 (xxxSetSysColors.c)
 *     ?CI_GetClrVal@@YAKPEAGK@Z @ 0x1C0061420 (-CI_GetClrVal@@YAKPEAGK@Z.c)
...
__int64 __fastcall xxxODI_ColorInit(__int64 a1)
{
  ...
  *(_OWORD *)(v1 + 4584) = xmmword_1C01DB140;
  *(_OWORD *)(v1 + 4600) = xmmword_1C01DB150;
  *(_OWORD *)(v1 + 4616) = xmmword_1C01DB160;
  *(_OWORD *)(v1 + 4632) = xmmword_1C01DB170;
  *(_OWORD *)(v1 + 4648) = xmmword_1C01DB180;
  *(_OWORD *)(v1 + 4664) = xmmword_1C01DB190;
