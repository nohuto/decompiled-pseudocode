/*
 * XREFs of ?HandleInterception@Mouse@InputTraceLogging@@SAX_KW4_MOUSE_INTERCEPTION_RESULT@@AEBU_MouseProcessorData@@@Z @ 0x1C018F708
 * Callers:
...
void InputTraceLogging::Mouse::HandleInterception()
{
  ...
  if ( dword_1C020CB50 > 4u && TlgKeywordOn((TraceLoggingHProvider)&dword_1C020CB50, 0x40uLL) )
  {
    ...
    v6 = v5;
    v14 = 4;
    TlgWrite((TraceLoggingHProvider)&dword_1C020CB50, &unk_1C01E61C0, 0LL, 0LL, 5u, &pData);
  }
}
