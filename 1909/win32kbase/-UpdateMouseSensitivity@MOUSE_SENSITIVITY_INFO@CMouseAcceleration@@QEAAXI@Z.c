/*
 * XREFs of ?UpdateMouseSensitivity@MOUSE_SENSITIVITY_INFO@CMouseAcceleration@@QEAAXI@Z @ 0x1C00A2B40
 * Callers:
 *     ??0CMouseAcceleration@@IEAA@I@Z @ 0x1C00A2AB4 (--0CMouseAcceleration@@IEAA@I@Z.c)
 *     UpdateMouseSensitivity @ 0x1C00A2B10 (UpdateMouseSensitivity.c)
 * Callees:
