/*
 * XREFs of ?UploadTelemetryData@DelayZoneTelemetry@@AEAAX_N@Z @ 0x1C018DA08
 * Callers:
    ...
    *((_DWORD *)this + 2) = v7;
    if ( v7 )
    {
      ...
      do
      {
        ...
        if ( v13 + 96 >= 0x800 )
        {
          if ( hProvider > 5u && TlgKeywordOn((TraceLoggingHProvider)&hProvider, 0x400000000000uLL) )
          {
            ...
            TlgWrite((TraceLoggingHProvider)&hProvider, &unk_1C01E5F62, 0LL, 0LL, 3u, &pData);
          }
          v9 = 0LL;
          v13 = 0LL;
          v4 = 1;
      ...
      if ( v9 )
      {
        ...
        {
          TlgCreateSz(&v17, v2);
          TlgWrite((TraceLoggingHProvider)&hProvider, &unk_1C01E5F62, 0LL, 0LL, 3u, &v16);
        }
        v4 = 1;
      }
      if ( v4 )
