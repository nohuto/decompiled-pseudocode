/*
 * XREFs of ?GetAdjustedHimetric@@YAHUtagPOINT@@00PEAU1@PEAUtagHID_POINTER_DEVICE_INFO@@@Z @ 0x1C0181A34
 * Callers:
 *     GetAdjustedPointerLocations @ 0x1C0181F40 (GetAdjustedPointerLocations.c)
 * Callees:
