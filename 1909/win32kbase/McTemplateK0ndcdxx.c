/*
 * XREFs of McTemplateK0ndcdxx @ 0x1C010D6DC
 * Callers:
...
ULONG __fastcall McTemplateK0ndcdxx(
        ...
        char a10)
{
  EVENT_DATA_DESCRIPTOR EventData; // [rsp+30h] [rbp-59h] BYREF
  ...
  v21 = 8LL;
  v23 = 8LL;
  return McGenEventWrite(a1, &UIPIHookEvent, (LPCGUID)&Context.Flags, 7u, &EventData);
}
