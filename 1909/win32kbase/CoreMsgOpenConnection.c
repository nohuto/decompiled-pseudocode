/*
 * XREFs of CoreMsgOpenConnection @ 0x1C0048F54
 * Callers:
 ...
 *     UserCoreMsgOpenConnectionHandle @ 0x1C0184FF0 (UserCoreMsgOpenConnectionHandle.c)
 * Callees:
...
__int64 __fastcall CoreMsgOpenConnection(char a1, const struct tagMsgRoutingInfo *a2, void **a3)
{
  ...
  if ( dword_1C020C5E0 > 5u )
  {
    ...
    v23 = 8;
    v26 = 16;
    TlgWrite((TraceLoggingHProvider)&dword_1C020C5E0, &unk_1C01E8056, 0LL, 0LL, 7u, &pData);
  }
  CoreMessagingK::EntryLock::Acquire(v9, 3LL);
  ...
  if ( dword_1C020C5E0 > 5u )
  {
    ...
    v14 = 4;
    v17 = 8;
    TlgWrite((TraceLoggingHProvider)&dword_1C020C5E0, &unk_1C01E7FA4, 0LL, 0LL, 4u, &pData);
  }
  if ( v9[0] )
