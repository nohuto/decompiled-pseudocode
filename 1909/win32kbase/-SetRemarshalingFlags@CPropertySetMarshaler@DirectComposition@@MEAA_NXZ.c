/*
 * XREFs of ?SetRemarshalingFlags@CPropertySetMarshaler@DirectComposition@@MEAA_NXZ @ 0x1C01A8230
 * Callers:
 *     <none>
 * Callees:
        ...
        DirectComposition::CPropertySetMarshaler *this)
{
  ...
  if ( *((_DWORD *)this + 16) )
  {
    ...
    {
      v4 = v3++;
      *(_DWORD *)(*((_QWORD *)this + 7) + 8 * v4 + 4) = *(_DWORD *)(*((_QWORD *)this + 7) + 8 * v4 + 4) & 0x1FFFFFFF | 0x20000000;
    }
