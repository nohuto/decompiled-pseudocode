/*
 * XREFs of ?xxxMKMoveAccelCursorTimer@@YAXPEAUtagWND@@I_K_J@Z @ 0x1C015CEF0
 * Callers:
 *     <none>
 * Callees:
...
LABEL_6:
    ...
    {
      v3 = (unsigned __int8)byte_1C0211532;
      giMouseMoveTable = 1;
    ...
    {
      a2 = byte_1C02114B1;
      v3 = byte_1C02114B1[giMouseMoveTable++];
    }
    if ( !v3 )
      return;
    goto LABEL_10;
  }
  v3 = 4 * (unsigned __int8)byte_1C0211532;
LABEL_10:
