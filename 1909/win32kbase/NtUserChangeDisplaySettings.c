/*
 * XREFs of NtUserChangeDisplaySettings @ 0x1C0046390
 * Callers:
 *     <none>
 * Callees:
    ...
    *(GUID *)(v49 + 28) = pActivityId;
    if ( dword_1C020CB50 > 6u )
    {
      if ( TlgKeywordOn((TraceLoggingHProvider)&dword_1C020CB50, 0x2000uLL) )
      {
        ...
        v57 = &v45;
        v58 = 4LL;
        TlgWrite((TraceLoggingHProvider)&dword_1C020CB50, &unk_1C01E14C0, &pActivityId, 0LL, 3u, &v56);
        v37 = dword_1C020CB50;
      }
      if ( v37 > 6 && TlgKeywordOn((TraceLoggingHProvider)&dword_1C020CB50, 0x2000uLL) )
      {
        ...
        v60 = &v46;
        v61 = 4LL;
        TlgWrite((TraceLoggingHProvider)&dword_1C020CB50, &unk_1C01E14ED, &pActivityId, 0LL, 3u, &v59);
      }
    }
  }
