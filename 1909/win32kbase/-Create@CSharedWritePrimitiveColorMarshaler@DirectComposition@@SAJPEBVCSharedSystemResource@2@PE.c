/*
 * XREFs of ?Create@CSharedWritePrimitiveColorMarshaler@DirectComposition@@SAJPEBVCSharedSystemResource@2@PEAPEAV12@@Z @ 0x1C01C3E28
 * Callers:
 *     CreateSharedWritePrimitiveColorMarshaler @ 0x1C01C3FD0 (CreateSharedWritePrimitiveColorMarshaler.c)
 * Callees:
