/*
 * XREFs of ldevLoadImage @ 0x1C006B620
 * Callers:
...
struct _LDEV *__fastcall ldevLoadImage(const WCHAR *a1, int a2, int *a3, int a4, int a5, __int64 a6)
{
  ...
  if ( !*a3
    ...
    && dword_1C020C458 > 5u
    && TlgKeywordOn((TraceLoggingHProvider)&dword_1C020C458, 0x400000000000uLL) )
  {
    v10 = *(const WCHAR **)v7;
    v18 = 0;
    v16 = &v14;
    ...
    v30 = 4;
    v33 = 4;
    TlgWrite((TraceLoggingHProvider)&dword_1C020C458, &unk_1C01E1EC1, 0LL, 0LL, 9u, &pData);
  }
