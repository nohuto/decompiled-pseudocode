/*
 * XREFs of ?MouseHitTest@CMouseProcessor@@AEAA?AVCInputDest@@PEAUtagPOINT@@PEBU_SUBPIXELS@@_KW4DIT_HITTESTATTRIBUTES@@KW4MouseHitTestOptions@@PEAI@Z @ 0x1C0030950
 * Callers:
        ...
        unsigned int *a9)
{
  ...
  *(struct tagPOINT *)&v39[1] = *a3;
  ...
  if ( (a8 & 1) != 0 )
  {
    ...
    CInputDest::CInputDest((CInputDest *)v43, (const struct CInputDest *)(a1 + 3272));
