/*
 * XREFs of ?ProcessMouseWheel@CMouseProcessor@@AEAAXAEBVCWheelEvent@1@@Z @ 0x1C0190550
 * Callers:
 ...
 *     _anonymous_namespace_::HasThreadRequestedFocusMouseWheelRouting @ 0x1C018F9D8 (_anonymous_namespace_--HasThreadRequestedFocusMouseWheelRouting.c)
        ...
        const struct CMouseProcessor::CWheelEvent *a2)
{
  ...
  if ( (*(_DWORD *)(*((_QWORD *)a2 + 1) + 104LL) & 0x80u) == 0 && CBaseProcessor::IsUMSuppressed(this) )
  {
    ...
    {
      LOBYTE(v9) = 4;
      WPP_RECORDER_SF_((_DWORD)gBaseLog, v9, 6, 39, (__int64)&WPP_b8c433785e023797b5d19953e3eae191_Traceguids);
    }
    goto LABEL_53;
  }
  v10 = *((_QWORD *)a2 + 1);
  ...
  {
    if ( WPP_RECORDER_INITIALIZED != (_UNKNOWN *)&WPP_RECORDER_INITIALIZED )
      WPP_RECORDER_SF_((_DWORD)gBaseLog, 4, 6, 40, (__int64)&WPP_b8c433785e023797b5d19953e3eae191_Traceguids);
    goto LABEL_53;
  }
  if ( gpqForeground
  ...
  {
    CMouseProcessor::CMouseRawInput::PostRawMouse((__int64)this + 3160, 0, 0);
  }
  ...
  {
    v85 = *((_QWORD *)gpsi + 619);
    v16 = _InterlockedCompareExchange((volatile signed __int32 *)this + 850, 1, 1) != 0;
    ...
    if ( ShouldDeliverWheelEventToInputDest )
    {
      ...
      {
        CMouseProcessor::CMouseRawInput::PostRawMouse((__int64)this + 3160, (int)v105, 0);
      }
...
LABEL_27:
      ...
      {
        if ( WPP_RECORDER_INITIALIZED != (_UNKNOWN *)&WPP_RECORDER_INITIALIZED )
          WPP_RECORDER_SF_((_DWORD)gBaseLog, 4, 6, 41, (__int64)&WPP_b8c433785e023797b5d19953e3eae191_Traceguids);
        goto LABEL_53;
      }
      ...
      {
        if ( WPP_RECORDER_INITIALIZED != (_UNKNOWN *)&WPP_RECORDER_INITIALIZED )
          WPP_RECORDER_SF_((_DWORD)gBaseLog, 4, 6, 42, (__int64)&WPP_b8c433785e023797b5d19953e3eae191_Traceguids);
