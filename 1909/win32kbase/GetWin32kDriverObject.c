/*
 * XREFs of GetWin32kDriverObject @ 0x1C00A6D00
 * Callers:
...
__int64 GetWin32kDriverObject()
{
  ...
  *(_QWORD *)&v1.Length = 0LL;
  ...
  if ( !gbFirstConnectionDone )
  {
    ...
    dword_1C0211370 = (MEMORY[0xFFFFF78000000320] * (unsigned __int64)MEMORY[0xFFFFF78000000004]) >> 24;
    result = ObReferenceObjectByName(&v1, 64LL, 0LL);
    dword_1C0211374 = (MEMORY[0xFFFFF78000000320] * (unsigned __int64)MEMORY[0xFFFFF78000000004]) >> 24;
    if ( (int)result < 0 )
      return 0LL;
  }
  return result;
