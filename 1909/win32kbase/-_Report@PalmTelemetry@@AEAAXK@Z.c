/*
 * XREFs of ?_Report@PalmTelemetry@@AEAAXK@Z @ 0x1C015A204
 * Callers:
    ...
    if ( *((_DWORD *)this + 3) )
    {
      do
      {
        ...
        if ( v15 + 48 >= 0x800 )
        {
          ...
          if ( dword_1C020C538 > 5u && TlgKeywordOn((TraceLoggingHProvider)&dword_1C020C538, 0x400000000000uLL) )
          {
            TlgCreateSz(&pDesc, v3);
            TlgWrite((TraceLoggingHProvider)&dword_1C020C538, &unk_1C01E3D82, 0LL, 0LL, 3u, &pData);
          }
      ...
      {
        Feature_PenTapped_ReportUsage();
        if ( dword_1C020C538 > 5u )
        {
          if ( TlgKeywordOn((TraceLoggingHProvider)&dword_1C020C538, 0x400000000000uLL) )
          {
            TlgCreateSz(&v20, v3);
            TlgWrite((TraceLoggingHProvider)&dword_1C020C538, &unk_1C01E3D82, 0LL, 0LL, 3u, &v19);
          }
        }
      }
    }
