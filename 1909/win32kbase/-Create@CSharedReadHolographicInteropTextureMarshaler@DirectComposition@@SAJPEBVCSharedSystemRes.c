/*
 * XREFs of ?Create@CSharedReadHolographicInteropTextureMarshaler@DirectComposition@@SAJPEBVCSharedSystemResource@2@PEAPEAV12@@Z @ 0x1C01C4804
 * Callers:
 *     CreateSharedReadHolographicInteropTextureMarshaler @ 0x1C01C4940 (CreateSharedReadHolographicInteropTextureMarshaler.c)
 * Callees:
