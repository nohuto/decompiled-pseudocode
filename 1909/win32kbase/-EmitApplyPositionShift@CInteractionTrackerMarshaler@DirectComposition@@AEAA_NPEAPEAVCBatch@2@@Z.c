/*
 * XREFs of ?EmitApplyPositionShift@CInteractionTrackerMarshaler@DirectComposition@@AEAA_NPEAPEAVCBatch@2@@Z @ 0x1C01A9B38
 * Callers:
        ...
        struct DirectComposition::CBatch ***a2)
{
  ...
  for ( ; *((_DWORD *)this + 91) < *((_DWORD *)this + 90); *((_DWORD *)this + 91) += v5 )
  {
    ...
    v5 = (unsigned int)(*((_DWORD *)this + 90) - *((_DWORD *)this + 91));
    if ( v5 >= (v4 - 16) / 0xC )
  ...
  if ( v13 == v14 )
  {
    ...
    *((_DWORD *)this + 91) = 0;
    ...
    if ( *((_QWORD *)this + 44) )
    {
      DirectComposition::CDCompDynamicArray<PositionShift>::`scalar deleting destructor'(*((__int64 **)this + 44));
      v16 = *((_DWORD *)this + 91);
      v17 = *((_DWORD *)this + 90);
    }
    *((_QWORD *)this + 44) = 0LL;
