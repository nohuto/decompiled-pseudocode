/*
 * XREFs of ?LockExclusive@CInpLockGuard@@QEAAXAEAVCLockListEntryStack@@@Z @ 0x1C00A3D70
 * Callers:
  ...
  while ( 1 )
  {
          ...
          *(GUID *)(v61 + 28) = ActivityId;
          if ( dword_1C020CB50 > 6u )
          {
            if ( TlgKeywordOn((TraceLoggingHProvider)&dword_1C020CB50, 0x2000uLL) )
            {
              ...
              v71 = &v56;
              v72 = 4LL;
              TlgWrite((TraceLoggingHProvider)&dword_1C020CB50, &unk_1C01E14C0, &ActivityId, 0LL, 3u, &v70);
              v21 = dword_1C020CB50;
            }
            if ( v21 > 6 && TlgKeywordOn((TraceLoggingHProvider)&dword_1C020CB50, 0x2000uLL) )
            {
              ...
              v74 = &v57;
              v75 = 4LL;
              TlgWrite((TraceLoggingHProvider)&dword_1C020CB50, &unk_1C01E14ED, &ActivityId, 0LL, 3u, &v73);
            }
          }
        }
          ...
          if ( v40 && (*(int *)(v40 + 24) > 0 || *(_DWORD *)(v64 + 48)) )
          {
            ...
            if ( dword_1C020CB50 > 6u )
            {
              if ( TlgKeywordOn((TraceLoggingHProvider)&dword_1C020CB50, 0x2000uLL) )
              {
                ...
                v77 = &v59;
                v78 = 4LL;
                TlgWrite((TraceLoggingHProvider)&dword_1C020CB50, &unk_1C01E1517, &pActivityId, 0LL, 3u, &v76);
              }
            }
          }
        }
    ...
    if ( InputTraceLogging::Perf::s_userCritLoggingEnabled )
    {
      ...
      if ( v52 )
      {
        ...
        {
          TlgWrite((TraceLoggingHProvider)&dword_1C020CB50, &unk_1C01E14A1, (LPCGUID)(v53 + 28), 0LL, 2u, &v79);
        }
        *(_DWORD *)(v53 + 44) = 0;
        v60 = 0uLL;
        *(_OWORD *)(v53 + 28) = 0uLL;
