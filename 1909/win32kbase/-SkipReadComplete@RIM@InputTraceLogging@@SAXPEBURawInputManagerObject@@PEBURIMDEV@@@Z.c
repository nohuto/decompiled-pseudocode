/*
 * XREFs of ?SkipReadComplete@RIM@InputTraceLogging@@SAXPEBURawInputManagerObject@@PEBURIMDEV@@@Z @ 0x1C0150468
 * Callers:
        ...
        const struct RIMDEV *a2)
{
  ...
  if ( v2 )
  {
    if ( v2 == 2 )
    {
      if ( (*((_DWORD *)a2 + 50) & 0x80u) == 0 )
      {
        if ( dword_1C020CB50 > 4u && TlgKeywordOn((TraceLoggingHProvider)&dword_1C020CB50, 0x100uLL) )
        {
          ...
          *(_QWORD *)&pDesc.Size = 4LL;
          ...
          v27 = &v15;
          v28 = 4LL;
          TlgWrite((TraceLoggingHProvider)&dword_1C020CB50, &unk_1C01E3911, 0LL, 0LL, 7u, &v19);
        }
      }
      else if ( dword_1C020CB50 > 4u && TlgKeywordOn((TraceLoggingHProvider)&dword_1C020CB50, 0x100uLL) )
      {
        ...
        v29 = &v16;
        v30 = 4LL;
        TlgWrite((TraceLoggingHProvider)&dword_1C020CB50, &unk_1C01E38A1, 0LL, 0LL, cData, &v19);
      }
    }
    else if ( v2 == 1 && dword_1C020CB50 > 4u && TlgKeywordOn((TraceLoggingHProvider)&dword_1C020CB50, 0x100uLL) )
    {
      v17 = v14;
      v32 = &v17;
      v33 = 8LL;
      TlgWrite((TraceLoggingHProvider)&dword_1C020CB50, &unk_1C01E396A, 0LL, 0LL, 3u, &pData);
    }
  }
  else if ( dword_1C020CB50 > 4u )
  {
    if ( TlgKeywordOn((TraceLoggingHProvider)&dword_1C020CB50, 0x100uLL) )
    {
      ...
      v32 = &v16;
      v33 = 8LL;
      TlgWrite((TraceLoggingHProvider)&dword_1C020CB50, &unk_1C01E386E, 0LL, 0LL, 3u, &pData);
    }
  }
}
