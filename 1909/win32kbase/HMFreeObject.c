/*
 * XREFs of HMFreeObject @ 0x1C0028D60
 * Callers:
...
__int64 __fastcall HMFreeObject(_QWORD *a1, __int64 a2, __int64 a3)
{
  ...
  PMCGEN_TRACE_CONTEXT v25; // rcx
  const GUID *Arg3; // r8
  void *v27; // rcx
  unsigned int v28; // [rsp+28h] [rbp-30h]
  __int64 v29; // [rsp+60h] [rbp+8h] BYREF

  v4 = 0LL;
  GetDomainLockRef(14LL, a2, a3);
  v6 = *(unsigned int *)a1;
  v7 = (char *)qword_1C0210758 + dword_1C0210760 * (unsigned int)(unsigned __int16)v6;
  v8 = (const void ***)((char *)gpKernelHandleTable + 24 * (unsigned __int16)v6);
  v9 = *((_WORD *)&unk_1C01D0EAC + 12 * (unsigned __int8)v7[24]);
  if ( v8[2] )
...
LABEL_7:
  ...
  if ( (BYTE5(Microsoft_Windows_Win32kEnableBits) & 2) != 0 )
  {
    ...
    McTemplateK0pqqq(v25, &UserDestroyHandle, Arg3, **v8, Arg1, v28, (const unsigned int)Arg3);
  }
  if ( (v7[25] & 0x20) != 0 )
  {
  ...
  if ( (v9 & 0x10) != 0 )
  {
    ...
    if ( v17 )
    {
      ...
      UnlockObjectAssignment(&v29, v19, v20);
    }
    else
    {
      Win32FreePool(a1[5]);
      HMFreeUserOrIsolatedType(v9, v7[24], a1);
      UnlockObjectAssignment(&v29, v22, v23);
    }
    goto LABEL_22;
  }
  if ( (v9 & 0x40) != 0 )
  {
    ...
    if ( v21 )
    {
      RtlFreeHeap(gpvSharedAlloc, 0, v21);
      HMFreeUserOrIsolatedType(v9, v7[24], a1);
    }
    else
    {
...
LABEL_48:
  ...
  {
    v29 = a1[3];
    UnlockObjectAssignment(&v29, v6, v11);
  }
  if ( (v9 & 0x200) != 0 )
  {
    HMFreeIsolatedType((unsigned __int8)v7[24], (__int64)a1);
  }
...
LABEL_22:
  ...
  *v8 = 0LL;
  ...
  v8[2] = 0LL;
  *((_WORD *)v7 + 13) = v13;
  v14 = (v7 - (char *)qword_1C0210758) >> 5;
  if ( (v14 & 1) != 0 )
  {
    *v8 = (const void **)qword_1C0210700;
    qword_1C0210700 = v14;
  }
  else
  {
    *v8 = (const void **)qword_1C02106F8;
    qword_1C02106F8 = v14;
  }
