/*
 * XREFs of ?CitpInputTimesAddTo@@YAXPEAU_CIT_INPUT_TIMES@@PEBU1@@Z @ 0x1C0038680
 * Callers:
...
void __fastcall CitpInputTimesAddTo(struct _CIT_INPUT_TIMES *a1, const struct _CIT_INPUT_TIMES *a2)
{
  ...
  if ( v2 )
  {
    ...
    CitpStatIncrement((unsigned __int16 *)(v14 + 14), *(_WORD *)(v13 + 14));
    CitpStatIncrement((unsigned __int16 *)(v16 + 12), *(_WORD *)(v15 + 12));
  }
}
