/*
 * XREFs of ?OnEngineOutput@PTPEngineTraceProducer@@UEAAXPEBUPTPEngineOutput@@@Z @ 0x1C0198160
 * Callers:
 *     <none>
 * Callees:
...
void __fastcall PTPEngineTraceProducer::OnEngineOutput(PTPEngineTraceProducer *this, const struct PTPEngineOutput *a2)
{
  ...
  v2 = dword_1C020C490;
  if ( dword_1C020C490 > 5u && TlgKeywordOn((TraceLoggingHProvider)&dword_1C020C490, 5uLL) )
  {
    v10 = 0;
    v13 = 0;
    v16 = 0;
    ...
    v17 = a2;
    v18 = 20;
    TlgWrite((TraceLoggingHProvider)&dword_1C020C490, &unk_1C01E6C37, 0LL, 0LL, 6u, &pData);
    v2 = dword_1C020C490;
  }
  if ( *((_DWORD *)a2 + 4) && v2 > 5 && TlgKeywordOn((TraceLoggingHProvider)&dword_1C020C490, 5uLL) )
  {
    v10 = 0;
    v13 = 0;
    v16 = 0;
    ...
    v12 = 4;
    v15 = 2;
    TlgWrite((TraceLoggingHProvider)&dword_1C020C490, &unk_1C01E6BF5, 0LL, 0LL, 6u, &pData);
  }
