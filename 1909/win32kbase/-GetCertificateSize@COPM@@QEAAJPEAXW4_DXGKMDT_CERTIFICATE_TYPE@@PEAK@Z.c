/*
 * XREFs of ?GetCertificateSize@COPM@@QEAAJPEAXW4_DXGKMDT_CERTIFICATE_TYPE@@PEAK@Z @ 0x1C00AECCC
 * Callers:
 *     NtGdiGetCertificateSizeByHandle @ 0x1C00AE650 (NtGdiGetCertificateSizeByHandle.c)
