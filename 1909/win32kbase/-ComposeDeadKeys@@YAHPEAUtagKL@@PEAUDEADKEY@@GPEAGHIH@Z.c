/*
 * XREFs of ?ComposeDeadKeys@@YAHPEAUtagKL@@PEAUDEADKEY@@GPEAGHIH@Z @ 0x1C0184AB0
 * Callers:
        ...
        int a7)
{
  ...
  if ( a5 >= 1 )
  {
      ...
      while ( *(_DWORD *)v8 )
      {
        if ( *(_DWORD *)v8 == v12 )
        {
          if ( (*((_BYTE *)v8 + 6) & 1) != 0 )
          {
            ...
            if ( WPP_RECORDER_INITIALIZED != (_UNKNOWN *)&WPP_RECORDER_INITIALIZED )
              WPP_RECORDER_SF_hD(0, (_DWORD)a2, a3, 13, v16, *((_WORD *)a1 + 37), *((_WORD *)a1 + 37));
            return 0xFFFFFFFFLL;
          }
          v13 = *((unsigned __int16 *)v8 + 2);
          *a4 = v13;
          if ( WPP_RECORDER_INITIALIZED != (_UNKNOWN *)&WPP_RECORDER_INITIALIZED )
            WPP_RECORDER_SF_hD(v13, (_DWORD)a2, a3, 14, v16, v13, v13);
          return 1LL;
        }
    ...
    *a4 = HIWORD(v12);
    if ( a5 <= 1 )
    {
      if ( WPP_RECORDER_INITIALIZED != (_UNKNOWN *)&WPP_RECORDER_INITIALIZED )
      {
        WPP_RECORDER_SF_hD(HIWORD(v12), (_DWORD)a2, a3, 16, v16, SBYTE2(v12), SBYTE2(v12));
        if ( WPP_RECORDER_INITIALIZED != (_UNKNOWN *)&WPP_RECORDER_INITIALIZED )
          WPP_RECORDER_SF_hD((unsigned __int16)v12, v14, v15, 17, v17, v12, v12);
      }
      return 1LL;
    }
    else
  ...
  else
  {
    ...
    {
      LOBYTE(a2) = 4;
      WPP_RECORDER_SF_((_DWORD)gBaseLog, (_DWORD)a2, 16, 12, (__int64)&WPP_1521667368713990dadd5db48e8e739e_Traceguids);
    }
    return 0LL;
  }
}
