/*
 * XREFs of W32kEtwEnableCallback @ 0x1C005F83C
 * Callers:
      ...
      *(GUID *)(v124 + 28) = ActivityId;
      if ( dword_1C020CB50 > 6u )
      {
        if ( TlgKeywordOn((TraceLoggingHProvider)&dword_1C020CB50, 0x2000uLL) )
        {
          ...
          v137 = &v113;
          v138 = 4LL;
          TlgWrite((TraceLoggingHProvider)&dword_1C020CB50, &unk_1C01E14C0, &ActivityId, 0LL, 3u, &v136);
          v30 = dword_1C020CB50;
        }
        if ( v30 > 6 && TlgKeywordOn((TraceLoggingHProvider)&dword_1C020CB50, 0x2000uLL) )
        {
          ...
          v140 = &v114;
          v141 = 4LL;
          TlgWrite((TraceLoggingHProvider)&dword_1C020CB50, &unk_1C01E14ED, &ActivityId, 0LL, 3u, &v139);
        }
      }
    }
...
LABEL_27:
    ...
    if ( ((a4 & 0x8000000000040000uLL) == 0
       ...
       || (qword_1C020C420 & 0x8000000000040000uLL) == 0
       || (qword_1C020C428 & 0x8000000000040000uLL) != qword_1C020C428)
        ...
        if ( v49 && (*(int *)(v49 + 24) > 0 || *(_DWORD *)(v127 + 48)) )
        {
          ...
          if ( dword_1C020CB50 > 6u )
          {
            if ( TlgKeywordOn((TraceLoggingHProvider)&dword_1C020CB50, 0x2000uLL) )
            {
              ...
              v143 = &v115;
              v144 = 4LL;
              TlgWrite((TraceLoggingHProvider)&dword_1C020CB50, &unk_1C01E1517, &pActivityId, 0LL, 3u, &v142);
            }
          }
        }
      }
        ...
        *(GUID *)(v127 + 28) = pActivityId;
        if ( dword_1C020CB50 > 6u )
        {
          if ( TlgKeywordOn((TraceLoggingHProvider)&dword_1C020CB50, 0x2000uLL) )
          {
            ...
            v146 = &v116;
            v147 = 4LL;
            TlgWrite((TraceLoggingHProvider)&dword_1C020CB50, &unk_1C01E14C0, &pActivityId, 0LL, 3u, &v145);
            v57 = dword_1C020CB50;
          }
          if ( v57 > 6 && TlgKeywordOn((TraceLoggingHProvider)&dword_1C020CB50, 0x2000uLL) )
          {
            ...
            v149 = &v117;
            v150 = 4LL;
            TlgWrite((TraceLoggingHProvider)&dword_1C020CB50, &unk_1C01E14ED, &pActivityId, 0LL, 3u, &v148);
          }
        }
      }
      EtwTraceAcquiredExclusiveUserCrit();
      ...
      if ( v80 && (*(int *)(v80 + 24) > 0 || *(_DWORD *)(v130 + 48)) )
      {
        ...
        if ( dword_1C020CB50 > 6u )
        {
          if ( TlgKeywordOn((TraceLoggingHProvider)&dword_1C020CB50, 0x2000uLL) )
          {
            ...
            v152 = &v118;
            v153 = 4LL;
            TlgWrite((TraceLoggingHProvider)&dword_1C020CB50, &unk_1C01E1517, &v132, 0LL, 3u, &v151);
          }
        }
      }
    }
      ...
      *(GUID *)(v130 + 28) = v132;
      if ( dword_1C020CB50 > 6u )
      {
        if ( TlgKeywordOn((TraceLoggingHProvider)&dword_1C020CB50, 0x2000uLL) )
        {
          ...
          v155 = ResultLength;
          v156 = 4LL;
          TlgWrite((TraceLoggingHProvider)&dword_1C020CB50, &unk_1C01E14C0, &v132, 0LL, 3u, &v154);
          v88 = dword_1C020CB50;
        }
        if ( v88 > 6 && TlgKeywordOn((TraceLoggingHProvider)&dword_1C020CB50, 0x2000uLL) )
        {
          v111 = v131;
          v158 = &v111;
          v159 = 4LL;
          TlgWrite((TraceLoggingHProvider)&dword_1C020CB50, &unk_1C01E14ED, &v132, 0LL, 3u, &v157);
        }
      }
    }
    EtwTraceAcquiredExclusiveUserCrit();
