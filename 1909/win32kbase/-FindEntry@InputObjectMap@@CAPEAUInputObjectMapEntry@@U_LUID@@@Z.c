/*
 * XREFs of ?FindEntry@InputObjectMap@@CAPEAUInputObjectMapEntry@@U_LUID@@@Z @ 0x1C01C60EC
 * Callers:
...
struct InputObjectMapEntry *__fastcall InputObjectMap::FindEntry(struct _LUID a1)
{
  ...
  v3 = -1LL << (dword_1C02157CC & 0x1F);
  v4 = v3 & v2;
  if ( (unsigned int)dword_1C02157CC >> 5 )
  {
    v7 = v3 & v2;
    v5 = (char *)qword_1C02157D0
       + 8
       * ((37
         * (BYTE6(v7)
          + 37
         ...
         + HIBYTE(v7)) & (((unsigned int)dword_1C02157CC >> 5) - 1));
    do
    {
      v5 = (_QWORD *)*v5;
