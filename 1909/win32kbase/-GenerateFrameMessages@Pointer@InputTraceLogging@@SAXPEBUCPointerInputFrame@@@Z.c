/*
 * XREFs of ?GenerateFrameMessages@Pointer@InputTraceLogging@@SAXPEBUCPointerInputFrame@@@Z @ 0x1C0165898
 * Callers:
...
void __fastcall InputTraceLogging::Pointer::GenerateFrameMessages(const struct CPointerInputFrame *a1)
{
  ...
  if ( dword_1C020CB50 > 4u )
  {
    if ( TlgKeywordOn((TraceLoggingHProvider)&dword_1C020CB50, 0x20uLL) )
    {
      ...
      v11 = v2;
      v13 = v2;
      TlgWrite((TraceLoggingHProvider)&dword_1C020CB50, &unk_1C01E4C6B, 0LL, 0LL, 6u, &pData);
    }
  }
}
