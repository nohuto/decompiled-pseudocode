/*
 * XREFs of ?ivRootPnpCreated@CBaseInput@@AEAAJPEAURawInputManagerDeviceObject@@AEBUCONTAINER_ID@@@Z @ 0x1C018CF3C
 * Callers:
        ...
        const struct CONTAINER_ID *a3)
{
  ...
  *(_QWORD *)&v23.Length = 0LL;
  ...
  if ( *(_BYTE *)(v7 + 0x30) <= 2u )
  {
    ...
    v9 = *(char **)((((unsigned __int64)a2 + 88) & -(__int64)(a2 != 0LL)) + 0x530);
    v10 = 0LL;
    v27 = 0LL;
    if ( v9 )
    {
