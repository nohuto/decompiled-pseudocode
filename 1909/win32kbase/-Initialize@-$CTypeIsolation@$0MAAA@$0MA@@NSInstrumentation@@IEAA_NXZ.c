/*
 * XREFs of ?Initialize@?$CTypeIsolation@$0MAAA@$0MA@@NSInstrumentation@@IEAA_NXZ @ 0x1C008F880
 * Callers:
 ...
 * Callees:
 *     ?Create@?$CSectionEntry@$0MAAA@$0MA@@NSInstrumentation@@SAPEAV12@XZ @ 0x1C0095E40 (-Create@-$CSectionEntry@$0MAAA@$0MA@@NSInstrumentation@@SAPEAV12@XZ.c)
...
char __fastcall NSInstrumentation::CTypeIsolation<49152,192>::Initialize(__int64 a1)
{
  ...
  if ( !NSInstrumentation::PlatformDebugModeEnabled((NSInstrumentation *)a1) )
  {
    ...
    *(_QWORD *)(a1 + 16) = PoolWithTag;
    ...
    {
      *PoolWithTag = 0LL;
      v3 = (_QWORD *)NSInstrumentation::CSectionEntry<49152,192>::Create();
      if ( v3 )
      {
        v4 = *(_QWORD **)(a1 + 8);
        *(_DWORD *)(a1 + 32) = 252;
