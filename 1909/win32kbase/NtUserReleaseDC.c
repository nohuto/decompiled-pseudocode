/*
 * XREFs of NtUserReleaseDC @ 0x1C002A9F0
 * Callers:
 *     <none>
 * Callees:
...
_BOOL8 __fastcall NtUserReleaseDC(__int64 a1)
{
  ...
  *(_QWORD *)ActivityId.Data4 = 0LL;
  ...
  v13 = (unsigned int)ReleaseCacheDC(a1, 0, v10) != 2;
  ...
  if ( InputTraceLogging::Perf::s_userCritLoggingEnabled )
  {
    ...
    if ( v17 )
    {
      ...
      {
        TlgWrite((TraceLoggingHProvider)&dword_1C020CB50, &unk_1C01E14A1, (LPCGUID)(v18 + 28), 0LL, 2u, &v28);
      }
      *(_DWORD *)(v18 + 44) = 0;
      v21 = 0uLL;
      *(_OWORD *)(v18 + 28) = 0uLL;
  ...
  EtwTraceReleaseUserCrit(v12, v11, v14);
  ExReleaseResourceAndLeaveCriticalRegion(gpresUser);
  return v13;
}
