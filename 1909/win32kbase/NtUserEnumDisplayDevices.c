/*
 * XREFs of NtUserEnumDisplayDevices @ 0x1C003B880
 * Callers:
 *     <none>
 * Callees:
    ...
    if ( v20 )
    {
      ...
      if ( InputTraceLogging::Perf::s_userCritLoggingEnabled )
      {
        ...
        if ( CurrentThreadWin32Thread )
        {
          ...
          {
            TlgWrite((TraceLoggingHProvider)&dword_1C020CB50, &unk_1C01E14A1, (LPCGUID)(v15 + 28), 0LL, 2u, &pData);
          }
          *(_DWORD *)(v15 + 44) = 0;
          v21 = 0uLL;
          *(_OWORD *)(v15 + 28) = 0uLL;
  ...
  if ( InputTraceLogging::Perf::s_userCritLoggingEnabled )
  {
    ...
    if ( v17 )
    {
      ...
      if ( (*(_DWORD *)(v18 + 44) || *(_DWORD *)(v18 + 48) || v19 > 0)
        ...
        && TlgKeywordOn((TraceLoggingHProvider)&dword_1C020CB50, 0x2000uLL) )
      {
        TlgWrite((TraceLoggingHProvider)&dword_1C020CB50, &unk_1C01E14A1, (LPCGUID)(v18 + 28), 0LL, 2u, &v24);
      }
      *(_DWORD *)(v18 + 44) = 0;
      v22 = 0uLL;
      *(_OWORD *)(v18 + 28) = 0uLL;
