/*
 * XREFs of ?SetReferenceArrayProperty@CVisualMarshaler@DirectComposition@@UEAAJPEAVCApplicationChannel@2@IPEAPEAVCResourceMarshaler@2@_KPEA_N@Z @ 0x1C007BED0
 * Callers:
        ...
        bool *a6)
{
  ...
  *a6 = 0;
  ...
  if ( !v7 )
  {
    result = DirectComposition::CResourceMarshalerArray::Set((char *)this + 280, a2, a4, a5, 33);
    if ( (int)result < 0 )
      return result;
    *((_QWORD *)this + 41) = 0LL;
    *((_DWORD *)this + 86) |= 1u;
  ...
  if ( v7 != 1 )
    return 3221225485LL;
  result = DirectComposition::CResourceMarshalerArray::Set((char *)this + 304, a2, a4, a5, 33);
  if ( (int)result >= 0 )
  {
    *((_QWORD *)this + 42) = 0LL;
    *((_DWORD *)this + 86) |= 2u;
