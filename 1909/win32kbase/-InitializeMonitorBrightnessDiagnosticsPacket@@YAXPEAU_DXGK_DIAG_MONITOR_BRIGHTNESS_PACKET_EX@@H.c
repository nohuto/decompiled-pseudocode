/*
 * XREFs of ?InitializeMonitorBrightnessDiagnosticsPacket@@YAXPEAU_DXGK_DIAG_MONITOR_BRIGHTNESS_PACKET_EX@@H@Z @ 0x1C00B9E10
 * Callers:
        ...
        char a2)
{
  ...
  *((_DWORD *)a1 + 14) = dword_1C02127A0;
  *((_DWORD *)a1 + 15) = dword_1C021278C;
  *((_DWORD *)a1 + 16) = dword_1C0212788;
  *((_DWORD *)a1 + 17) = dword_1C0212794;
  v4 = dword_1C0212790;
  *((_DWORD *)a1 + 19) = -1;
  *((_DWORD *)a1 + 18) = v4;
  v5 = dword_1C021279C;
  *((_DWORD *)a1 + 21) &= ~2u;
  v6 = *((_DWORD *)a1 + 21);
  *((_DWORD *)a1 + 20) = v5;
  v7 = v6 ^ ((unsigned __int8)v6 ^ (unsigned __int8)(4 * dword_1C02127F8)) & 4;
  *((_DWORD *)a1 + 21) = v7;
  *((_DWORD *)a1 + 21) = a2 & 1 | v7 & 0xFFFFFFF6 | (8 * (dword_1C02127F4 & 1));
}
