/*
 * XREFs of ?WaitAndDispatch@LegacyInputDispatcher@@QEAAJXZ @ 0x1C0053C20
 * Callers:
 *     <none>
 * Callees:
 ...
 *     ?NeedsUpdateKeyboardLEDs@@YA_NXZ @ 0x1C0053EA8 (-NeedsUpdateKeyboardLEDs@@YA_NXZ.c)
        ...
        *(GUID *)(v45 + 28) = ActivityId_8;
        if ( dword_1C020CB50 > 6u )
        {
          if ( TlgKeywordOn((TraceLoggingHProvider)&dword_1C020CB50, 0x2000uLL) )
          {
            ...
            v53 = &v43;
            v54 = 4;
            TlgWrite((TraceLoggingHProvider)&dword_1C020CB50, &unk_1C01E14C0, &ActivityId_8, 0LL, 3u, &v52);
            v36 = dword_1C020CB50;
          }
