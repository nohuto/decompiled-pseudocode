/*
 * XREFs of ?DrvWriteDisplayDriverParameters@@YAJPEAUtagGRAPHICS_DEVICE@@KPEBGQEAU_devicemodeW@@HH@Z @ 0x1C0041158
 * Callers:
 *     DrvUpdateDisplayDriverParameters @ 0x1C003E120 (DrvUpdateDisplayDriverParameters.c)
 * Callees:
 *     ?DrvWriteAttachedSettings@@YAJKPEBGQEAU_devicemodeW@@HPEAK@Z @ 0x1C00415E4 (-DrvWriteAttachedSettings@@YAJKPEBGQEAU_devicemodeW@@HPEAK@Z.c)
    ...
    if ( a4 )
    {
      ...
      if ( v9 >= 0 )
      {
        do
        {
          if ( v15 >= v18 )
            break;
          v16 = RtlWriteRegistryValue(0x40000000u, a3, off_1C01D1B10[v15], 4u, &v22[v15], 4u);
          ++v15;
          v9 = v16;
        }
        while ( v16 >= 0 );
