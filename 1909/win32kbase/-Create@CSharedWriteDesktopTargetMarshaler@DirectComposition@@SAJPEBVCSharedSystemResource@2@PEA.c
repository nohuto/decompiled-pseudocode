/*
 * XREFs of ?Create@CSharedWriteDesktopTargetMarshaler@DirectComposition@@SAJPEBVCSharedSystemResource@2@PEAPEAV12@@Z @ 0x1C00A51A8
 * Callers:
 *     CreateSharedWriteDesktopTargetMarshaler @ 0x1C00A5170 (CreateSharedWriteDesktopTargetMarshaler.c)
 * Callees:
