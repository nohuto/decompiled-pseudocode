/*
 * XREFs of NtUserEnableTouchPad @ 0x1C0114A70
 * Callers:
 *     <none>
 * Callees:
    ...
    *(GUID *)(v42 + 28) = ActivityId_8;
    if ( dword_1C020CB50 > 6u )
    {
      if ( TlgKeywordOn((TraceLoggingHProvider)&dword_1C020CB50, 0x2000uLL) )
      {
        ...
        v49 = &v37;
        v50 = 4LL;
        TlgWrite((TraceLoggingHProvider)&dword_1C020CB50, &unk_1C01E14C0, &ActivityId_8, 0LL, 3u, &v48);
        v13 = dword_1C020CB50;
      }
      if ( v13 > 6 && TlgKeywordOn((TraceLoggingHProvider)&dword_1C020CB50, 0x2000uLL) )
      {
        ...
        v52 = &v38;
        v53 = 4LL;
        TlgWrite((TraceLoggingHProvider)&dword_1C020CB50, &unk_1C01E14ED, &ActivityId_8, 0LL, 3u, &v51);
      }
    }
  }
