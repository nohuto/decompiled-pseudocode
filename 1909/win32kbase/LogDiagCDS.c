/*
 * XREFs of LogDiagCDS @ 0x1C0047688
 * Callers:
 ...
 *     ?FillSimpleDevModeField@@YAXQEAU_devicemodeW@@PEAU_DXGK_DIAG_SIMPLE_DEVMODE@@@Z @ 0x1C00478A0 (-FillSimpleDevModeField@@YAXQEAU_devicemodeW@@PEAU_DXGK_DIAG_SIMPLE_DEVMODE@@@Z.c)
        ...
        struct _devicemodeW *a14)
{
  ...
  if ( v18 )
  {
    ...
    *(_DWORD *)(v19 + 48) = v20;
    ...
    ((void (__fastcall *)(__int64))qword_1C0212140)(v19);
    Win32FreePool(v19);
  }
  else
  {
