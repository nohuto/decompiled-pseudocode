/*
 * XREFs of ?UpdateKeyboardLEDs@CKeyboardSensor@@QEAAXXZ @ 0x1C0053F80
 * Callers:
 ...
 *     ??0RIMDropAndReAcquireSyncLock@@QEAA@PEAURawInputManagerObject@@@Z @ 0x1C00536B8 (--0RIMDropAndReAcquireSyncLock@@QEAA@PEAURawInputManagerObject@@@Z.c)
...
void __fastcall CKeyboardSensor::UpdateKeyboardLEDs(struct RawInputManagerObject **this, __int64 a2, __int64 a3)
{
    ...
    && this[147] )
  {
    ...
    v49 = gbRemoteSession;
    qword_1C0211F68 = gKbdImeStatus;
    gdwUpdateKeyboard &= 0xFFFFFFF8;
    dword_1C0211F5C = gktp;
    word_1C0211F60 = word_1C0215A28;
    dword_1C0211F58 = gklp;
    dword_1C0211F70 = dword_1C0215A20;
    v6 = this[2];
    v7 = this[1];
    dword_1C0211F80 = dword_1C0210B00;
    qword_1C0211F78 = gRemoteClientKeyboardType;
    ...
    if ( (_DWORD)v10 )
    {
      ...
      do
      {
        if ( v15 )
        {
          RIMDeviceIoControl(v7, *v18, 720900LL, &dword_1C0211F5C, 6, 0LL, 0, v50, &giosbKbdControl, 1, 0, 0);
          i = 0LL;
        }
        if ( v16 )
        {
          RIMDeviceIoControl(v7, *v18, 720904LL, &dword_1C0211F58, 4, 0LL, 0, v50, &giosbKbdControl, 1, 0, 0);
          i = 0LL;
        }
        if ( v17
          && (*((_BYTE *)v18 + 8) == 7 && *((_BYTE *)v18 + 9) == 82 || v49 && qword_1C0211F78 == 0x2000200000007LL) )
        {
          RIMDeviceIoControl(v7, *v18, 724996LL, &qword_1C0211F68, 12, 0LL, 0, v53, &giosbKbdControl, 1, 0, 0);
          i = 0LL;
        }
        v18 += 2;
        --v10;
      ...
      *(GUID *)(v57 + 28) = ActivityId;
      if ( dword_1C020CB50 > 6u )
      {
        if ( TlgKeywordOn((TraceLoggingHProvider)&dword_1C020CB50, 0x2000uLL) )
        {
          ...
          v64 = &v51;
          v65 = 4LL;
          TlgWrite((TraceLoggingHProvider)&dword_1C020CB50, &unk_1C01E14C0, &ActivityId, 0LL, 3u, &v63);
          v43 = dword_1C020CB50;
        }
        if ( v43 > 6 && TlgKeywordOn((TraceLoggingHProvider)&dword_1C020CB50, 0x2000uLL) )
        {
          LODWORD(v52) = v58;
          v67 = &v52;
          v68 = 4LL;
          TlgWrite((TraceLoggingHProvider)&dword_1C020CB50, &unk_1C01E14ED, &ActivityId, 0LL, 3u, &v66);
        }
      }
    }
