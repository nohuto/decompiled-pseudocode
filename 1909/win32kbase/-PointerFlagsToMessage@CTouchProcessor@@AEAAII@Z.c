/*
 * XREFs of ?PointerFlagsToMessage@CTouchProcessor@@AEAAII@Z @ 0x1C016C654
 * Callers:
...
__int64 __fastcall CTouchProcessor::PointerFlagsToMessage(CTouchProcessor *this, int a2)
{
  ...
  if ( WPP_RECORDER_INITIALIZED != (_UNKNOWN *)&WPP_RECORDER_INITIALIZED )
  {
    v3 = a2;
    LOBYTE(a2) = 2;
    WPP_RECORDER_SF_L((_DWORD)this, a2, 7, 296, (__int64)&WPP_dde6ae6ba4d53e169de0efe5dbb74602_Traceguids, v3);
  }
  return 0LL;
}
