/*
 * XREFs of ?SetPointerInfoNodeMessagePosted@CTouchProcessor@@IEAAH_KIH@Z @ 0x1C0171C40
 * Callers:
...
LABEL_14:
    LOBYTE(v8) = 5;
    WPP_RECORDER_SF_(v11->DeviceExtension, v8, 7, v12, (__int64)&WPP_dde6ae6ba4d53e169de0efe5dbb74602_Traceguids);
    return 0LL;
  }
