/*
 * XREFs of ?Initialize@?$CTypeIsolation@$0GAAA@$0GA@@NSInstrumentation@@IEAA_NXZ @ 0x1C008EFF4
 * Callers:
 ...
 * Callees:
 *     ?Create@?$CSectionEntry@$0GAAA@$0GA@@NSInstrumentation@@SAPEAV12@XZ @ 0x1C0095724 (-Create@-$CSectionEntry@$0GAAA@$0GA@@NSInstrumentation@@SAPEAV12@XZ.c)
...
char __fastcall NSInstrumentation::CTypeIsolation<24576,96>::Initialize(__int64 a1)
{
  ...
  if ( !NSInstrumentation::PlatformDebugModeEnabled((NSInstrumentation *)a1) )
  {
    ...
    *(_QWORD *)(a1 + 16) = PoolWithTag;
    ...
    {
      *PoolWithTag = 0LL;
      v3 = (_QWORD *)NSInstrumentation::CSectionEntry<24576,96>::Create();
      if ( v3 )
      {
        v4 = *(_QWORD **)(a1 + 8);
        *(_DWORD *)(a1 + 32) = 252;
