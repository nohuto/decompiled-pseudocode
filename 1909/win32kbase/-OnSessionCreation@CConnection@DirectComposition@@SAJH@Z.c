/*
 * XREFs of ?OnSessionCreation@CConnection@DirectComposition@@SAJH@Z @ 0x1C006CF40
 * Callers:
 ...
 *     ??0CConnection@DirectComposition@@AEAA@XZ @ 0x1C006FE30 (--0CConnection@DirectComposition@@AEAA@XZ.c)
