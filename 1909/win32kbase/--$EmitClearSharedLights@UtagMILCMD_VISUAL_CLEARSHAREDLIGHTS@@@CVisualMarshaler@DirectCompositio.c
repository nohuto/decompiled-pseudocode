/*
 * XREFs of ??$EmitClearSharedLights@UtagMILCMD_VISUAL_CLEARSHAREDLIGHTS@@@CVisualMarshaler@DirectComposition@@IEAA_NW4VisualMarshalerExtendedFlag@01@W4MILCMD@@PEAPEAVCBatch@1@@Z @ 0x1C000A0FC
 * Callers:
