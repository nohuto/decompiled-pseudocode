/*
 * XREFs of ?SetIntegerProperty@CVisualMarshaler@DirectComposition@@UEAAJPEAVCApplicationChannel@2@I_JPEA_N@Z @ 0x1C007DBC0
 * Callers:
 *     ?SetIntegerProperty@CLayerVisualMarshaler@DirectComposition@@UEAAJPEAVCApplicationChannel@2@I_JPEA_N@Z @ 0x1C00973F0 (-SetIntegerProperty@CLayerVisualMarshaler@DirectComposition@@UEAAJPEAVCApplicationChannel@2@I_JP.c)
 *     ?SetIntegerProperty@CParticleEmitterVisualMarshaler@DirectComposition@@UEAAJPEAVCApplicationChannel@2@I_JPEA_N@Z @ 0x1C01B4B30 (-SetIntegerProperty@CParticleEmitterVisualMarshaler@DirectComposition@@UEAAJPEAVCApplicationChan.c)
 * Callees:
  ...
  if ( a3 > 0x1B )
  {
    switch ( a3 )
    {
      case '%':
        ...
        break;
      case '&':
        if ( *((unsigned __int8 *)this + 272) >> 7 == (a4 != 0) )
          return v5;
        v13 = *((_BYTE *)this + 272) & 0x7F | (a4 != 0 ? 0x80 : 0);
...
LABEL_25:
      ...
      case '+':
        ...
        *((_BYTE *)this + 272) = ((_DWORD)a4 != 0) | v24 & 0xFE;
        goto LABEL_25;
      case ',':
      ...
      case '-':
        ...
        *((_BYTE *)this + 273) = v23 & 0xFD | ((_DWORD)a4 != 0 ? 2 : 0);
        goto LABEL_25;
      case '2':
        v22 = *((_BYTE *)this + 273);
        if ( ((v22 & 4) != 0) == ((_DWORD)a4 != 0) )
          return v5;
        *((_BYTE *)this + 273) = (4 * ((_DWORD)a4 != 0)) | v22 & 0xFB;
        *((_DWORD *)this + 86) |= 4u;
        goto LABEL_25;
      case '3':
        v20 = *((_BYTE *)this + 272);
