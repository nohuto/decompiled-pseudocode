/*
 * XREFs of ?AddMapping@InputObjectMap@@SAJU_LUID@@PEBUCompositionInputObject@@@Z @ 0x1C01C5D74
 * Callers:
 ...
 *     ?AllocateBucket@InputObjectMap@@CAPEAX_KPEAX@Z @ 0x1C01C60C0 (-AllocateBucket@InputObjectMap@@CAPEAX_KPEAX@Z.c)
...
__int64 __fastcall InputObjectMap::AddMapping(struct _LUID a1, struct _EX_PUSH_LOCK *Object)
{
  ...
  {
    v5 = 2 * ((unsigned int)dword_1C02157CC >> 5);
    if ( InputObjectMap::s_hashTable >= (unsigned int)v5 )
    {
      ...
      if ( Bucket )
      {
        ...
        v9 = dword_1C02157CC;
        v10 = 0;
        v11 = -1LL << (dword_1C02157CC & 0x1F);
        if ( (dword_1C02157CC & 0xFFFFFFE0) != 0 )
        {
          do
          {
            v12 = qword_1C02157D0;
          ...
          while ( v10 < (unsigned int)dword_1C02157CC >> 5 );
        }
        v15 = qword_1C02157D0;
        qword_1C02157D0 = Bucket;
        dword_1C02157CC = (32 * v5) | v9 & 0x1F;
        if ( v15 )
          InputObjectMap::DeallocateBucket(v15, 0LL);
      }
      else if ( (dword_1C02157CC & 0xFFFFFFE0) == 0 )
      {
LABEL_26:
        v4 = -1073741670;
        goto LABEL_28;
    ...
    if ( PoolWithTag )
    {
      ...
      v23 = v17 & (-1LL << (dword_1C02157CC & 0x1F));
      v18 = qword_1C02157D0;
      v19 = (HIBYTE(v23)
           + 37
           * (BYTE6(v23)
            ...
            * (BYTE5(v23)
             + 37
             * (BYTE4(v23)
              + 37 * (BYTE3(v23) + 37 * (BYTE2(v23) + 37 * (BYTE1(v23) + 37 * ((unsigned __int8)v23 + 11623883)))))))) & (((unsigned int)dword_1C02157CC >> 5) - 1);
      *PoolWithTag = *(struct _LUID *)((char *)qword_1C02157D0 + 8 * v19);
      v18[v19] = PoolWithTag;
