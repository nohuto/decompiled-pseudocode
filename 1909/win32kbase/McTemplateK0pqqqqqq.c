/*
 * XREFs of McTemplateK0pqqqqqq @ 0x1C012FDF4
 * Callers:
 *     EtwDevLockEndUpdate @ 0x1C007DB20 (EtwDevLockEndUpdate.c)
 *     EtwDevLockEndTightUpdate @ 0x1C0092BD0 (EtwDevLockEndTightUpdate.c)
 * Callees:
