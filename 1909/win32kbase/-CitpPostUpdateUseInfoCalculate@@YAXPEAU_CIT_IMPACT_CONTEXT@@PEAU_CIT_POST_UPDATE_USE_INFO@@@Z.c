/*
 * XREFs of ?CitpPostUpdateUseInfoCalculate@@YAXPEAU_CIT_IMPACT_CONTEXT@@PEAU_CIT_POST_UPDATE_USE_INFO@@@Z @ 0x1C0082A28
 * Callers:
...
void __fastcall CitpPostUpdateUseInfoCalculate(struct _CIT_IMPACT_CONTEXT *a1, struct _CIT_POST_UPDATE_USE_INFO *a2)
{
  ...
  *((_DWORD *)a2 + 9) += ((int)v4 - dword_1C0215838) / 0x3E8u;
  v10 = Citp100NSToMS(v6 - qword_1C0215828 - v5);
