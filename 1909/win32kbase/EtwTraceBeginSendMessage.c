/*
 * XREFs of EtwTraceBeginSendMessage @ 0x1C0076DE0
 * Callers:
 *     <none>
 * Callees:
...
char __fastcall EtwTraceBeginSendMessage(__int64 a1, __int64 a2, __int64 a3)
{
  ...
  {
    LOBYTE(v3) = byte_1C020C438 - 1;
    if ( (unsigned __int8)(byte_1C020C438 - 1) > 2u && (qword_1C020C420 & 0x400000000400000LL) != 0 )
    {
      LOBYTE(v3) = 0;
      if ( (qword_1C020C428 & 0x400000000400000LL) == qword_1C020C428 )
      {
        LOBYTE(v5) = 0;
        if ( a2 && a3 )
          LOBYTE(v3) = 3;
