/*
 * XREFs of ?SetShellClip@Mouse@InputTraceLogging@@SAXPEAUtagRECT@@K@Z @ 0x1C0175A34
 * Callers:
...
void __fastcall InputTraceLogging::Mouse::SetShellClip(struct tagRECT *a1, unsigned int a2)
{
  ...
  if ( dword_1C020CB50 > 4u && TlgKeywordOn((TraceLoggingHProvider)&dword_1C020CB50, 0x40uLL) )
  {
    ...
    v7 = 4;
    TlgWrite((TraceLoggingHProvider)&dword_1C020CB50, &unk_1C01E4F61, 0LL, 0LL, 3u, &pData);
    v2 = v18;
  }
  for ( i = 0; i < v2; ++i )
  {
    if ( dword_1C020CB50 > 4u )
    {
      if ( TlgKeywordOn((TraceLoggingHProvider)&dword_1C020CB50, 0x40uLL) )
      {
        ...
        p_bottom = &v6->bottom;
        v16 = 4;
        TlgWrite((TraceLoggingHProvider)&dword_1C020CB50, &unk_1C01E4F8F, 0LL, 0LL, 6u, &pData);
        v2 = v18;
      }
    }
  }
