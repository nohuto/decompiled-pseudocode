/*
 * XREFs of McTemplateK0qqqqzzzzqx @ 0x1C00586D8
 * Callers:
        ...
        char a13)
{
  ...
  int v19; // r9d
  const struct _MCGEN_TRACE_CONTEXT *v20; // rcx
  __int64 v21; // rdx
  int v22; // r9d
  ...
  if ( a9 )
  {
    ...
    do
      ++v26;
    while ( *((_WORD *)&a9->RegistrationHandle + v26) );
    v19 = 2 * v26 + 2;
  }
  else
  {
  ...
  if ( a10 )
  {
    ...
    do
      ++v21;
    while ( *((_WORD *)&a10->RegistrationHandle + v21) );
    v22 = 2 * v21 + 2;
  }
  else
  {
  ...
  v49 = 4LL;
  if ( v24 )
    v23 = (struct _MCGEN_TRACE_CONTEXT *)&Context;
  v45 = v23;
  v51 = 8LL;
  return McGenEventWrite(v23, (PCEVENT_DESCRIPTOR)&Context.EnableBitMask, (LPCGUID)&Context.Flags, 0xBu, &EventData);
}
