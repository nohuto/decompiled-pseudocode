/*
 * XREFs of ?RemoveInertiaInfo@Win32k@InputTraceLogging@@SAXAEBUINERTIA_INFO_INTERNAL@@@Z @ 0x1C017C00C
 * Callers:
...
void __fastcall InputTraceLogging::Win32k::RemoveInertiaInfo(const struct INERTIA_INFO_INTERNAL *a1)
{
  ...
  if ( dword_1C020CB50 > 4u )
  {
    if ( TlgKeywordOn((TraceLoggingHProvider)&dword_1C020CB50, 2uLL) )
    {
      ...
      v22 = &v10;
      v10 = -__CFSHR__(v4, 4);
      TlgWrite((TraceLoggingHProvider)&dword_1C020CB50, &unk_1C01E5464, 0LL, 0LL, v6 + 4, &pData);
    }
  }
}
