/*
 * XREFs of ?DrvUpdateRemoteAdapterInfo@@YAJPEAUtagGRAPHICS_DEVICE@@@Z @ 0x1C00B77CC
 * Callers:
...
LABEL_19:
  ...
  else if ( !Object && (unsigned __int8)((__int64 (*)(void))qword_1C02122A0)() )
  {
    qword_1C0212BA4 = *((_QWORD *)a1 + 37);
