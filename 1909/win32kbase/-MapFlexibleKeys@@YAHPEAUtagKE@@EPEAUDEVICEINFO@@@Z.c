/*
 * XREFs of ?MapFlexibleKeys@@YAHPEAUtagKE@@EPEAUDEVICEINFO@@@Z @ 0x1C0182E84
 * Callers:
 *     ?MapScancode@@YAHPEAUtagKE@@PEAEPEAUDEVICEINFO@@@Z @ 0x1C018316C (-MapScancode@@YAHPEAUtagKE@@PEAEPEAUDEVICEINFO@@@Z.c)
 * Callees:
 *     __security_check_cookie @ 0x1C00B7F30 (__security_check_cookie.c)
 *     ?IsKeyDownSpecified@@YAHEPEBE@Z @ 0x1C0182D20 (-IsKeyDownSpecified@@YAHEPEBE@Z.c)
...
__int64 __fastcall MapFlexibleKeys(struct tagKE *a1, char a2, struct DEVICEINFO *a3)
{
  ...
  _BYTE v37[8]; // [rsp+40h] [rbp-20h] BYREF
  _BYTE v38[8]; // [rsp+48h] [rbp-18h] BYREF
...
LABEL_32:
  ...
  if ( *((__int16 *)v5 + 1) < 0 )
    WORD2(v35) = v7 | v26;
  WORD1(v35) = *((unsigned __int8 *)gpFlexMap + 16 * v6 + 8);
  LOWORD(v35) = 0;
