/*
 * XREFs of ?CitpUTCToMS@@YAI_KI@Z @ 0x1C0082BF4
 * Callers:
...
__int64 __fastcall CitpUTCToMS(unsigned __int64 a1, unsigned int a2)
{
  ...
  if ( MEMORY[0xFFFFF78000000014] > a1 )
  {
    ...
    if ( MEMORY[0xFFFFF78000000014] - a1 >= MEMORY[0xFFFFF78000000008] - qword_1C0215820 )
      v4 = MEMORY[0xFFFFF78000000008] - qword_1C0215820;
    v5 = Citp100NSToMS(v4);
    return v6 - v5;
  }
  return a2;
