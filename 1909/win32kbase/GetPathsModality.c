/*
 * XREFs of GetPathsModality @ 0x1C0048CC4
 * Callers:
 ...
 *     ?DrvCreatePathModalityFromAllPaths@@YAJPEAPEAUD3DKMT_GETPATHSMODALITY@@I0@Z @ 0x1C0127A68 (-DrvCreatePathModalityFromAllPaths@@YAJPEAPEAUD3DKMT_GETPATHSMODALITY@@I0@Z.c)
...
__int64 __fastcall GetPathsModality(__int64 a1, struct D3DKMT_GETPATHSMODALITY **a2, __int64 a3, unsigned __int16 a4)
{
  ...
  do
  {
    ...
    v12 = ((__int64 (__fastcall *)(_QWORD, struct D3DKMT_GETPATHSMODALITY *, unsigned __int16 *))qword_1C02120A0)(
            v5,
            v8,
            &v18);
    v13 = v12;
