/*
 * XREFs of ?RimDeviceHidData@RIM@InputTraceLogging@@SAXPEBURIMDEV@@@Z @ 0x1C01325A4
 * Callers:
...
void __fastcall InputTraceLogging::RIM::RimDeviceHidData(const struct RIMDEV *a1)
{
  ...
  if ( dword_1C020CB50 > 4u )
  {
    if ( TlgKeywordOn((TraceLoggingHProvider)&dword_1C020CB50, 0x100uLL) )
    {
      ...
      v12 = &v5;
      v13 = v2;
      TlgWrite((TraceLoggingHProvider)&dword_1C020CB50, &unk_1C01E25BB, 0LL, 0LL, 5u, &pData);
    }
  }
}
