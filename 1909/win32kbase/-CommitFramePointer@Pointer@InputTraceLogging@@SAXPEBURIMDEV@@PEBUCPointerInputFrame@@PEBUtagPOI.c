/*
 * XREFs of ?CommitFramePointer@Pointer@InputTraceLogging@@SAXPEBURIMDEV@@PEBUCPointerInputFrame@@PEBUtagPOINTEREVENTINT@@@Z @ 0x1C0161030
 * Callers:
        ...
        const struct tagPOINTEREVENTINT *a3)
{
  ...
  if ( (unsigned int)(v5 - 1) > 3 )
  {
    if ( (unsigned int)(v5 - 5) > 1 )
    {
      if ( v5 == 7 )
      {
        if ( dword_1C020CB50 > 4u && TlgKeywordOn((TraceLoggingHProvider)&dword_1C020CB50, 0x20uLL) )
        {
          v22 = *(_DWORD *)(v21 + 8);
          v48 = &v46;
          v45 = *((_QWORD *)a2 + 13);
          ...
          v102 = v26;
          v104 = v26;
          TlgWrite((TraceLoggingHProvider)&dword_1C020CB50, &unk_1C01E474D, 0LL, 0LL, 0x1Fu, &pData);
        }
      }
      else if ( dword_1C020CB50 > 4u && TlgKeywordOn((TraceLoggingHProvider)&dword_1C020CB50, 0x20uLL) )
      {
        ...
        v78 = v33;
        v80 = v33;
        TlgWrite((TraceLoggingHProvider)&dword_1C020CB50, &unk_1C01E48BF, 0LL, 0LL, 0x13u, &pData);
      }
    }
    else if ( dword_1C020CB50 > 4u && TlgKeywordOn((TraceLoggingHProvider)&dword_1C020CB50, 0x20uLL) )
    {
      ...
      v90 = v19;
      v92 = v19;
      TlgWrite((TraceLoggingHProvider)&dword_1C020CB50, &unk_1C01E4623, 0LL, 0LL, 0x19u, &pData);
    }
  }
  else if ( dword_1C020CB50 > 4u )
  {
    if ( TlgKeywordOn((TraceLoggingHProvider)&dword_1C020CB50, 0x20uLL) )
    {
      ...
      v102 = v12;
      v104 = v12;
      TlgWrite((TraceLoggingHProvider)&dword_1C020CB50, &unk_1C01E44AF, 0LL, 0LL, 0x1Fu, &pData);
    }
  }
}
