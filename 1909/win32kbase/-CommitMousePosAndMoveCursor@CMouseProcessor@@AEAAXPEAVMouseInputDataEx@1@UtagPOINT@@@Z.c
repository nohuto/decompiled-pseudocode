/*
 * XREFs of ?CommitMousePosAndMoveCursor@CMouseProcessor@@AEAAXPEAVMouseInputDataEx@1@UtagPOINT@@@Z @ 0x1C009327C
 * Callers:
...
LABEL_5:
  if ( dword_1C020CB50 > 4u && TlgKeywordOn((TraceLoggingHProvider)&dword_1C020CB50, 0x40uLL) )
  {
    ...
    v31 = 4LL;
    v33 = 4LL;
    TlgWrite((TraceLoggingHProvider)&dword_1C020CB50, &unk_1C01E64B7, 0LL, 0LL, 5u, &pData);
  }
  if ( v17 && (v17 & 1) == 0 )
  ...
  *((_DWORD *)a2 + 19) = v17;
  ...
  {
    *((_OWORD *)this + 202) = *((_OWORD *)a2 + 3);
    *((_QWORD *)this + 406) = *((_QWORD *)a2 + 8);
  }
}
