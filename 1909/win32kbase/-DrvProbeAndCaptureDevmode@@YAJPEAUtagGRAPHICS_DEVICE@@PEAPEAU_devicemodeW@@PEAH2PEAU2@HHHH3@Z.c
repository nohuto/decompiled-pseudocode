/*
 * XREFs of ?DrvProbeAndCaptureDevmode@@YAJPEAUtagGRAPHICS_DEVICE@@PEAPEAU_devicemodeW@@PEAH2PEAU2@HHHH3@Z @ 0x1C0044A2C
 * Callers:
 ...
 *     ?AreEquivalentDevModes@@YA_NQEBU_devicemodeW@@0@Z @ 0x1C004498C (-AreEquivalentDevModes@@YA_NQEBU_devicemodeW@@0@Z.c)
 ...
 *     ?GetClosestMode@@YAPEAU_devicemodeW@@PEAUtagGRAPHICS_DEVICE@@PEAU1@HH@Z @ 0x1C00A1574 (-GetClosestMode@@YAPEAU_devicemodeW@@PEAUtagGRAPHICS_DEVICE@@PEAU1@HH@Z.c)
        ...
        struct _devicemodeW *a10)
{
  ...
  *a3 = 0;
  ...
  if ( v16 )
  {
    ...
    v22 = (struct _devicemodeW *)PALLOCMEM2(dmSize + dmDriverExtra, 0x76656447u, 0);
    v13 = v22;
    if ( !v22 )
      goto LABEL_129;
    memmove(v22, Src, v21);
...
LABEL_129:
    ...
    *(_DWORD *)&v16->dmSize = -8739;
    ...
    else
    {
      ...
      *(_QWORD *)&v85->dmReserved2 = *(_QWORD *)&v16->dmReserved2;
      ...
      else if ( v13->dmPelsWidth || v13->dmPelsHeight )
      {
        ...
        v77 = dmDisplayFrequency;
        if ( (*((_DWORD *)a1 + 40) & 0x800000) != 0 && v21 == 244 )
        {
          v65 = WdLogNewEntry5_WdWarning(dmBitsPerPel, &v85->dmFormName[13], 0LL);
    ...
    if ( v87 )
      v82 = v16->dmDisplayFixedOutput == 0;
    ...
    v39 = (struct _devicemodeW *)PALLOCMEM2(v38 + 220, 0x76656447u, 1);
    if ( !v39 )
      goto LABEL_128;
    if ( v38 )
    {
...
LABEL_62:
    ...
    if ( v16->dmBitsPerPel || v16->dmPelsWidth || v16->dmPelsHeight || v16->dmDisplayOrientation )
    {
        ...
        && v16->dmDisplayFrequency )
      {
        ...
        if ( *((_DWORD *)a1 + 47) )
        {
          v72 = *(_OWORD **)(*((_QWORD *)a1 + 24) + 8LL);
          if ( v72 )
          {
            *(_OWORD *)v16->dmDeviceName = *v72;
            *(_OWORD *)&v16->dmDeviceName[8] = v72[1];
            *(_OWORD *)&v16->dmDeviceName[16] = v72[2];
            *(_OWORD *)&v16->dmDeviceName[24] = v72[3];
          }
        }
        v83 = 1;
        v44 = 2;
    ...
    else
    {
      ...
      else
      {
        ...
        v67 = !v66;
        v68 = 8LL * !v66;
        v69 = (DWORD *)((char *)&unk_1C01EA828 + v68 + 4);
        if ( v84 )
        {
          do
          {
        ...
        v16->dmPelsWidth = *(_DWORD *)((char *)&unk_1C01EA828 + v68);
        v71 = *v69;
        v25 = a1;
        v16->dmPelsHeight = v71;
      }
    }
    v44 = 0;
LABEL_68:
      ...
      if ( v90 )
      {
        do
        {
          ...
          if ( v16->dmDisplayOrientation != v52
            || v86 && v16->dmDisplayFixedOutput != v42->dmDisplayFixedOutput && (v74 == 1 || v46 == 2 && v44 == 2) )
          {
            goto LABEL_76;
          }
          v53 = v42;
...
LABEL_88:
          ...
          if ( v46 != 2 && (v16->dmDisplayFixedOutput == v42->dmDisplayFixedOutput || !v86) )
          {
            v41 = v42;
            v46 = 2;
            v47 = 0;
...
LABEL_76:
    ...
    if ( v41 )
    {
      ...
      if ( (*((_DWORD *)v25 + 40) & 0x800000) != 0
        && v78 + v41->dmSize == 244
        && !v16->dmDisplayFrequency
        && v77 != v42->dmDisplayFrequency )
      {
        v56 = 0;
      }
      if ( a8 && v47 != 2 && v41->dmDisplayFrequency == v16->dmDisplayFrequency )
        v47 = 2;
      if ( (*((_DWORD *)v25 + 40) & 0x800000) != 0 && v44 == 2 && v46 == 2 && (v74 & 0xFFFFFFFD) == 0 )
        v47 = 2;
...
LABEL_118:
          ...
          if ( (*((_DWORD *)v25 + 40) & 0x800000) != 0 && v56 + v39->dmSize == 244 )
            ((void (__fastcall *)(struct _devicemodeW *, struct _devicemodeW *))qword_1C02120F8)(v39, v39);
          if ( v87 )
          {
            if ( *(_DWORD *)&v87[1].dmDeviceName[6] )
            {
              v73 = v39->dmFields | 0x2000000;
              v39->dmFields = v73;
              v39->dmMediaType = *(_DWORD *)&v87[1].dmDeviceName[6];
              if ( v82 )
              {
                v39->dmFields = v73 | 0x4000000;
                v39->dmDisplayFixedOutput = *(_DWORD *)&v87[1].dmDeviceName[8];
              }
            }
          }
      ...
      {
        v39->dmFields = v58 | (v75 != 0 ? 0x20 : 0);
      }
      v39->dmPosition.x = x;
      v39->dmPosition.y = v80;
      goto LABEL_118;
    }
