/*
 * XREFs of ?AddEdgeToGET@@YAPEAVEDGE@@PEAV1@0PEAU_POINTFIX@@1PEAU_RECTL@@@Z @ 0x1C00ACC48
 * Callers:
        ...
        struct _RECTL *a5)
{
  ...
  *((_DWORD *)a2 + 5) = v23;
  if ( v22 >= v10 )
  {
    v36 = v22;
    v35 = v22 >> 31;
    v37 = __SPAIR64__(v35, v36) / v10;
    v22 = __SPAIR64__(v35, v36) % v10;
    *((_DWORD *)a2 + 8) = v37;
    if ( v24 == -1 )
      *((_DWORD *)a2 + 8) = -v37;
  }
