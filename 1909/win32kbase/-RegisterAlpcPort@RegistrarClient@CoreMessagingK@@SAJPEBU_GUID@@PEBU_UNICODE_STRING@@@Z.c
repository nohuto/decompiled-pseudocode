/*
 * XREFs of ?RegisterAlpcPort@RegistrarClient@CoreMessagingK@@SAJPEBU_GUID@@PEBU_UNICODE_STRING@@@Z @ 0x1C009BD7C
 * Callers:
        ...
        const struct _UNICODE_STRING *a2)
{
  ...
  v5 = CoreUICallSend(
         ...
         1,
         10,
         (__int64)&unk_1C01D7062,
         &v13,
         Buffer,
         0LL,
         &CoreMessagingK::SendHost::s_Vtbl);
  if ( v5 < 0 )
  {
  ...
  if ( dword_1C020C5E0 > 5u )
  {
    ...
    v19 = &v11;
    v20 = 4;
    TlgWrite((TraceLoggingHProvider)&dword_1C020C5E0, &unk_1C01E82DF, 0LL, 0LL, 5u, &pData);
  }
  return v7;
}
