/*
 * XREFs of ?InsertObject@CLinearObjectTableBase@DirectComposition@@QEAAJPEAXPEAI@Z @ 0x1C0014D3C
 * Callers:
 *     ?CreateChannelHandle@CConnection@DirectComposition@@AEAAJPEAVCChannel@2@PEAI@Z @ 0x1C000D9C4 (-CreateChannelHandle@CConnection@DirectComposition@@AEAAJPEAVCChannel@2@PEAI@Z.c)
