/*
 * XREFs of ?Create@?$CTypeIsolation@$0NPAAA@$0NPA@@NSInstrumentation@@SAPEAV12@XZ @ 0x1C008E84C
 * Callers:
...
void *NSInstrumentation::CTypeIsolation<913408,3568>::Create()
{
  ...
  *PoolWithTag = PoolWithTag;
  if ( !(unsigned __int8)NSInstrumentation::CTypeIsolation<913408,3568>::Initialize(PoolWithTag) )
  {
