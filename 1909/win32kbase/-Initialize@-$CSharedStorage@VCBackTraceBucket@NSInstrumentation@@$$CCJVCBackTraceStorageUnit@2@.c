/*
 * XREFs of ?Initialize@?$CSharedStorage@VCBackTraceBucket@NSInstrumentation@@$$CCJVCBackTraceStorageUnit@2@VCBackTrace@2@@NSInstrumentation@@QEAA_NI@Z @ 0x1C0131340
 * Callers:
 *     ?Create@CBackTraceStoreEx@NSInstrumentation@@SAPEAV12@XZ @ 0x1C01312E4 (-Create@CBackTraceStoreEx@NSInstrumentation@@SAPEAV12@XZ.c)
 * Callees:
 *     <none>
 */
