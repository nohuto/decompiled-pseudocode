/*
 * XREFs of ?CheckandDeliverContainerInput@CTouchProcessor@@AEAAXPEBUCPointerInputFrame@@HH@Z @ 0x1C015FF5C
 * Callers:
...
LABEL_46:
          LOBYTE(v13) = 2;
          WPP_RECORDER_SF_((_DWORD)gBaseLog, v13, 7, v23, (__int64)&WPP_dde6ae6ba4d53e169de0efe5dbb74602_Traceguids);
          return;
        }
        v24 = 0;
        if ( *((_DWORD *)a2 + 12) )
