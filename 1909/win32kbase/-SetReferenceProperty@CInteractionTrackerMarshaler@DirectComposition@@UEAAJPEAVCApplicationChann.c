/*
 * XREFs of ?SetReferenceProperty@CInteractionTrackerMarshaler@DirectComposition@@UEAAJPEAVCApplicationChannel@2@IPEAVCResourceMarshaler@2@PEA_N@Z @ 0x1C01AB710
 * Callers:
 *     <none>
 * Callees:
        ...
        bool *a5)
{
  ...
  if ( v9 )
  {
    ...
    if ( v10 )
    {
      ...
      DirectComposition::CApplicationChannel::ReleaseResource(a2, this[v17 + 27]);
      this[v17 + 27] = a4;
      if ( a4 )
