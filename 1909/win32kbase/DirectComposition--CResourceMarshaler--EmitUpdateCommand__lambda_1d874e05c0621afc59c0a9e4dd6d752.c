/*
 * XREFs of DirectComposition::CResourceMarshaler::EmitUpdateCommand__lambda_1d874e05c0621afc59c0a9e4dd6d7528___ @ 0x1C01B36DC
 * Callers:
        ...
        __int64 *a3)
{
  ...
  *((_DWORD *)v5 + 2) = *(_DWORD *)(a1 + 24);
  v6 = *a3;
  *(_QWORD *)(v5 + 12) = *(_QWORD *)(*a3 + 412);
  *((_DWORD *)v5 + 5) = *(_DWORD *)(v6 + 420);
  return 1;
}
