/*
 * XREFs of UserSessionSwitchEnterCrit @ 0x1C0086C70
 * Callers:
    ...
    *(GUID *)(v76 + 28) = ActivityId_8;
    if ( dword_1C020CB50 > 6u )
    {
      if ( TlgKeywordOn((TraceLoggingHProvider)&dword_1C020CB50, 0x2000uLL) )
      {
        ...
        v86 = &v69;
        v87 = 4LL;
        TlgWrite((TraceLoggingHProvider)&dword_1C020CB50, &unk_1C01E14C0, &ActivityId_8, 0LL, 3u, &v85);
        v52 = dword_1C020CB50;
      }
      if ( v52 > 6 && TlgKeywordOn((TraceLoggingHProvider)&dword_1C020CB50, 0x2000uLL) )
      {
        ...
        v89 = &v70;
        v90 = 4LL;
        TlgWrite((TraceLoggingHProvider)&dword_1C020CB50, &unk_1C01E14ED, &ActivityId_8, 0LL, 3u, &v88);
      }
    }
  }
  ...
  while ( gfSwitchInProgress )
  {
    ...
    if ( InputTraceLogging::Perf::s_userCritLoggingEnabled )
    {
      ...
      if ( v58 )
      {
        ...
        {
          TlgWrite((TraceLoggingHProvider)&dword_1C020CB50, &unk_1C01E14A1, (LPCGUID)(v59 + 28), 0LL, 2u, &v100);
        }
        *(_DWORD *)(v59 + 44) = 0;
        v74 = 0LL;
        v75 = 0LL;
      ...
      if ( v61 && (*(int *)(v61 + 24) > 0 || *(_DWORD *)(v79 + 48)) )
      {
        ...
        if ( dword_1C020CB50 > 6u )
        {
          if ( TlgKeywordOn((TraceLoggingHProvider)&dword_1C020CB50, 0x2000uLL) )
          {
            ...
            v92 = &v71;
            v93 = 4LL;
            TlgWrite((TraceLoggingHProvider)&dword_1C020CB50, &unk_1C01E1517, &pActivityId, 0LL, 3u, &v91);
          }
        }
      }
    }
      ...
      *(GUID *)(v79 + 28) = pActivityId;
      if ( dword_1C020CB50 > 6u )
      {
        if ( TlgKeywordOn((TraceLoggingHProvider)&dword_1C020CB50, 0x2000uLL) )
        {
          ...
          v95 = &v72;
          v96 = 4LL;
          TlgWrite((TraceLoggingHProvider)&dword_1C020CB50, &unk_1C01E14C0, &pActivityId, 0LL, 3u, &v94);
          v62 = dword_1C020CB50;
        }
        if ( v62 > 6 && TlgKeywordOn((TraceLoggingHProvider)&dword_1C020CB50, 0x2000uLL) )
        {
          v73 = v80;
          v98 = &v73;
          v99 = 4LL;
          TlgWrite((TraceLoggingHProvider)&dword_1C020CB50, &unk_1C01E14ED, &pActivityId, 0LL, 3u, &v97);
        }
      }
    }
    EtwTraceAcquiredExclusiveUserCrit();
