/*
 * XREFs of ?DropButton@Mouse@InputTraceLogging@@SAX_KW4DropReason@12@@Z @ 0x1C018E638
 * Callers:
...
void InputTraceLogging::Mouse::DropButton()
{
  ...
  if ( dword_1C020CB50 > 4u )
  {
    if ( TlgKeywordOn((TraceLoggingHProvider)&dword_1C020CB50, 0x40uLL) )
    {
      ...
      TlgWrite((TraceLoggingHProvider)&dword_1C020CB50, &unk_1C01E642E, 0LL, 0LL, 4u, &pData);
    }
  }
}
