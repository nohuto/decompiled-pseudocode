/*
 * XREFs of ApplyPathsModality @ 0x1C0041800
 * Callers:
        ...
        __int64 a8)
{
  ...
  *a6 = 0;
  if ( (unsigned int)ApplyPathModalityToCdsRegistryStore(a1) )
  {
    ...
    if ( (int)((__int64 (__fastcall *)(__int64, __int64, __int64))qword_1C02120B0)(v15, a1, a8) < 0 )
    {
      *a6 = 1;
      v24 = -1;
    }
    else
    {
      ...
      if ( v24 < 0 )
        *a6 = 1;
      ((void (__fastcall *)(__int64))qword_1C02120B8)(a1);
      if ( v24 != 2 )
      {
LABEL_24:
