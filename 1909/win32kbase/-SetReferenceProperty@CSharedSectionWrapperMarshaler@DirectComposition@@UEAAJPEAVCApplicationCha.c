/*
 * XREFs of ?SetReferenceProperty@CSharedSectionWrapperMarshaler@DirectComposition@@UEAAJPEAVCApplicationChannel@2@IPEAVCResourceMarshaler@2@PEA_N@Z @ 0x1C01B6F10
 * Callers:
 *     <none>
 * Callees:
