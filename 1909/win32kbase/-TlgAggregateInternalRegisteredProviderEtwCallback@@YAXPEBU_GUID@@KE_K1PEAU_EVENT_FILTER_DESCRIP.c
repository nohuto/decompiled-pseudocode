/*
 * XREFs of ?TlgAggregateInternalRegisteredProviderEtwCallback@@YAXPEBU_GUID@@KE_K1PEAU_EVENT_FILTER_DESCRIPTOR@@PEAX@Z @ 0x1C0246010
 * Callers:
 *     <none>
 * Callees:
 *     _guard_dispatch_icall_nop @ 0x1C00BF5D0 (_guard_dispatch_icall_nop.c)
 *     LookUpTableFlushComplete @ 0x1C0246A80 (LookUpTableFlushComplete.c)
 *     LookUpTableFlushPartial @ 0x1C0247334 (LookUpTableFlushPartial.c)
 */
