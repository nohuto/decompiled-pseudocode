/*
 * XREFs of ?Create@CSharedWriteScalarMarshaler@DirectComposition@@SAJPEBVCSharedSystemResource@2@PEAPEAV12@@Z @ 0x1C01C413C
 * Callers:
 *     CreateSharedWriteScalarMarshaler @ 0x1C01C4280 (CreateSharedWriteScalarMarshaler.c)
 * Callees:
