/*
 * XREFs of ?GestureOutput@PTP@InputTraceLogging@@SAXPEBUCPointerInputFrame@@PEBUPTPEngineOutput@@_N@Z @ 0x1C0178778
 * Callers:
        ...
        const struct PTPEngineOutput *a2)
{
  ...
  {
    if ( TlgKeywordOn((TraceLoggingHProvider)&dword_1C020CB50, 0x80uLL) )
    {
      v5 = *(_DWORD *)(v3 + 8) == 0;
      v8 = *(_QWORD *)(v2 + 104);
      v11 = &v8;
      ...
      v20 = 4LL;
      v22 = 4LL;
      TlgWrite((TraceLoggingHProvider)&dword_1C020CB50, &unk_1C01E51B3, 0LL, 0LL, 8u, &pData);
    }
  }
}
