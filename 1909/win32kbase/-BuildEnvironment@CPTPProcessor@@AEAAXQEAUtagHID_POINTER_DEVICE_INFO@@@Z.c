/*
 * XREFs of ?BuildEnvironment@CPTPProcessor@@AEAAXQEAUtagHID_POINTER_DEVICE_INFO@@@Z @ 0x1C0177D04
 * Callers:
...
void __fastcall CPTPProcessor::BuildEnvironment(CPTPProcessor *this, struct tagHID_POINTER_DEVICE_INFO *const a2)
{
  ...
  *(_QWORD *)((char *)this + 1044) = *(_QWORD *)&qword_1C0210A18;
  *(_OWORD *)((char *)this + 1052) = gAapState;
  *(_OWORD *)((char *)this + 1068) = xmmword_1C0215FF0;
  *(_OWORD *)((char *)this + 1084) = xmmword_1C0216000;
  *(_OWORD *)((char *)this + 1100) = xmmword_1C0216010;
  *(_OWORD *)((char *)this + 1116) = xmmword_1C0216020;
  *(_OWORD *)((char *)this + 1132) = xmmword_1C0216030;
