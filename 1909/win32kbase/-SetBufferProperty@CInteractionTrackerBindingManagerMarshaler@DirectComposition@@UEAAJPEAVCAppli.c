/*
 * XREFs of ?SetBufferProperty@CInteractionTrackerBindingManagerMarshaler@DirectComposition@@UEAAJPEAVCApplicationChannel@2@IPEBX_KPEA_N@Z @ 0x1C01ABDD0
 * Callers:
 *     <none>
 * Callees:
        ...
        bool *a6)
{
  ...
  *a6 = 0;
  if ( !a3 && a5 == 12 )
  {
    ...
    if ( v11
      && v13
      && (*(unsigned __int8 (__fastcall **)(__int64, __int64))(*(_QWORD *)v11 + 120LL))(v11, 88LL)
      && (*(unsigned __int8 (__fastcall **)(__int64, __int64))(*(_QWORD *)v13 + 120LL))(v13, 88LL)
      && v11 != v13 )
    {
      v14 = *((_QWORD *)this + 10);
      v15 = 0LL;
...
LABEL_24:
      if ( v9 )
      {
        v22 = *(DirectComposition::CInteractionTrackerBindingManagerMarshaler **)(v11 + 408);
        if ( !v22 || v22 == this )
        {
          v23 = *(DirectComposition::CInteractionTrackerBindingManagerMarshaler **)(v13 + 408);
          if ( !v23 || v23 == this )
          {
            v24 = (*(_DWORD *)(v11 + 48))++ == -1;
            if ( v24 )
            ...
            else
            {
              ...
              if ( !v24 )
              {
                ...
                memmove(
                  (void *)(*((_QWORD *)this + 7) + *((_QWORD *)this + 11) * (*((_QWORD *)this + 10) - 1LL)),
                  v28,
                  *((_QWORD *)this + 11));
