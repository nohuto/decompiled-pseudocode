/*
 * XREFs of ?SetReferenceProperty@CSurfaceBrushMarshaler@DirectComposition@@UEAAJPEAVCApplicationChannel@2@IPEAVCResourceMarshaler@2@PEA_N@Z @ 0x1C007DEF0
 * Callers:
 *     <none>
 * Callees:
        ...
        bool *a5)
{
  ...
  *a5 = 0;
  if ( a3 )
  {
    ...
    if ( a4 )
    {
      v10 = (*(__int64 (__fastcall **)(struct DirectComposition::CResourceMarshaler *, __int64))(*(_QWORD *)a4 + 120LL))(
              a4,
              26LL);
      v11 = 64LL;
      goto LABEL_6;
...
LABEL_17:
  ...
  if ( (*(unsigned __int8 (__fastcall **)(struct DirectComposition::CResourceMarshaler *, __int64))(*(_QWORD *)a4 + 120LL))(
    ...
    || (*(unsigned __int8 (__fastcall **)(struct DirectComposition::CResourceMarshaler *, __int64))(*(_QWORD *)a4 + 120LL))(
         a4,
         194LL)
    || (v14 = (*(unsigned __int8 (__fastcall **)(struct DirectComposition::CResourceMarshaler *, __int64))(*(_QWORD *)a4 + 120LL))(
                a4,
                125LL) == 0,
        v10 = 0,
        !v14) )
