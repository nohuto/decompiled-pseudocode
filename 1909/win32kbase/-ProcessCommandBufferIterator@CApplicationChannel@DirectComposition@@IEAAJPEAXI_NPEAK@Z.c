/*
 * XREFs of ?ProcessCommandBufferIterator@CApplicationChannel@DirectComposition@@IEAAJPEAXI_NPEAK@Z @ 0x1C00136C0
 * Callers:
 ...
 *     ?OpenSharedResource@CApplicationChannel@DirectComposition@@QEAAJIPEAXI_N@Z @ 0x1C000E89C (-OpenSharedResource@CApplicationChannel@DirectComposition@@QEAAJIPEAXI_N@Z.c)
        ...
        unsigned int *a5)
{
  ...
  DirectComposition::CApplicationChannel *v73; // [rsp+C0h] [rbp+8h]
  char v74; // [rsp+D8h] [rbp+20h]

  v74 = a4;
  v73 = (DirectComposition::CApplicationChannel *)this;
  v5 = a3;
...
LABEL_152:
      ...
      Resource = (*(__int64 (__fastcall **)(struct DirectComposition::CResourceMarshaler *, _QWORD, unsigned int *, unsigned __int8 *))(*(_QWORD *)v13 + 144LL))(
                   v13,
                   v16,
                   a5,
                   &v61);
    ...
    else
    {
      switch ( v10 )
      {
        case 8:
          ...
          if ( !v13 )
            goto LABEL_152;
          Resource = (*(__int64 (__fastcall **)(struct DirectComposition::CResourceMarshaler *, DirectComposition::CApplicationChannel *, _QWORD, __int64, char *))(*(_QWORD *)v13 + 136LL))(
                       v13,
                       v7,
                       v20,
                       v19,
        ...
        case 13:
          ...
          if ( v25 && v27 < *((_QWORD *)v73 + 10) )
          {
            ...
            if ( v29 )
            {
              ...
              {
                v65[0] = 0;
                Resource = (*(__int64 (__fastcall **)(struct DirectComposition::CResourceMarshaler *, DirectComposition::CApplicationChannel *, _QWORD, __int64, _BYTE *))(*(_QWORD *)v29 + 176LL))(
                             v29,
                             v73,
                             v24,
                             v26,
                             v65);
                if ( Resource >= 0 && v65[0] )
                  DirectComposition::CApplicationChannel::PutResourceOnUpdatedList(v73, v29);
              }
              goto LABEL_47;
            }
          }
...
LABEL_47:
          if ( (BYTE2(Microsoft_Windows_Win32kEnableBits) & 0x20) != 0
            && Resource >= 0
            && (*(unsigned __int8 (__fastcall **)(struct DirectComposition::CResourceMarshaler *, __int64))(*(_QWORD *)v29 + 120LL))(
                 v29,
                 125LL)
            && (BYTE2(Microsoft_Windows_Win32kEnableBits) & 0x20) != 0 )
          {
            v55 = *((_DWORD *)v29 + 6);
            v56 = (*(__int64 (__fastcall **)(struct DirectComposition::CResourceMarshaler *))(*(_QWORD *)v29 + 16LL))(v29);
            v60 = v25;
            v7 = v73;
            McTemplateK0qqqqq(
              v66,
...
LABEL_131:
          ...
          if ( !v13 )
            goto LABEL_152;
          v64 = 0;
          Resource = (*(__int64 (__fastcall **)(struct DirectComposition::CResourceMarshaler *, DirectComposition::CApplicationChannel *, unsigned __int64, char *, __int64, char *))(*(_QWORD *)v13 + 168LL))(
                       v13,
                       v7,
                       a3,
                       v33,
...
LABEL_99:
                ...
                v51 = v49;
                v7 = v73;
                Resource = DirectComposition::CApplicationChannel::ProcessCommandBufferIterator(v73, v47, v51, 0, v59);
              }
              else
              {
                Resource = -1073741811;
...
LABEL_100:
            ...
            case 7:
              ...
              if ( !v13 )
                goto LABEL_152;
              Resource = (*(__int64 (__fastcall **)(struct DirectComposition::CResourceMarshaler *, __int64, char *))(*(_QWORD *)v13 + 192LL))(
                           v13,
                           v12,
                           &v63);
              if ( Resource < 0 )
            ...
            case 11:
              ...
              v5 -= 16;
              a3 = v53[3];
              v72 = (v53[3] * (unsigned __int128)8uLL) >> 64;
              this = 8 * a3;
...
LABEL_26:
    ...
    if ( (BYTE2(Microsoft_Windows_Win32kEnableBits) & 0x20) != 0 )
    {
      McTemplateK0qx(this, 0x1C0000000uLL, a3, *v9, Resource);
      a4 = v74;
    }
  }
  if ( (BYTE2(Microsoft_Windows_Win32kEnableBits) & 0x20) != 0 )
