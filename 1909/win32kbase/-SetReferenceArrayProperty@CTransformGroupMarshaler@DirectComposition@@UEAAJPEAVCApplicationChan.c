/*
 * XREFs of ?SetReferenceArrayProperty@CTransformGroupMarshaler@DirectComposition@@UEAAJPEAVCApplicationChannel@2@IPEAPEAVCResourceMarshaler@2@_KPEA_N@Z @ 0x1C0004CD0
 * Callers:
 *     <none>
 * Callees:
        ...
        bool *a6)
{
  ...
  *a6 = 0;
  if ( a3 )
    return 3221225485LL;
  result = DirectComposition::CResourceMarshalerArray::Set((char *)this + 56, a2, a4, a5, 179);
  if ( (int)result >= 0 )
  {
    *((_DWORD *)this + 20) = 0;
    *((_DWORD *)this + 4) |= 0x80u;
