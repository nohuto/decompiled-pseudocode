/*
 * XREFs of ?CreateDefaultAcceleratorCurve@CDeviceAcceleration@@QEAAXPEAU_UNICODE_STRING@@@Z @ 0x1C0060344
 * Callers:
 *     ReadDefaultAccelerationCurves @ 0x1C0060060 (ReadDefaultAccelerationCurves.c)
 * Callees:
        ...
        struct _UNICODE_STRING *a2)
{
  ...
  else
  {
    if ( *((_BYTE *)this + 8) )
      goto LABEL_6;
    *((_OWORD *)this + 1) = xmmword_1C02104B8;
    *((_OWORD *)this + 2) = xmmword_1C02104C8;
    *((_QWORD *)this + 6) = qword_1C02104D8;
    *(_OWORD *)((char *)this + 56) = xmmword_1C0210490;
    *(_OWORD *)((char *)this + 72) = xmmword_1C02104A0;
    v10 = qword_1C02104B0;
  }
  *((_QWORD *)this + 11) = v10;
LABEL_6:
