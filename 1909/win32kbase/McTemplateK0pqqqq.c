/*
 * XREFs of McTemplateK0pqqqq @ 0x1C010E054
 * Callers:
 *     EtwTraceTimerProc @ 0x1C0079410 (EtwTraceTimerProc.c)
 *     EtwTraceInternalSetTimer @ 0x1C007AE10 (EtwTraceInternalSetTimer.c)
 *     EtwDirtyRectUpdate @ 0x1C007D7E0 (EtwDirtyRectUpdate.c)
 *     EtwLogicalSurfRemovedTranslationFromDirtyEvent @ 0x1C012F8D0 (EtwLogicalSurfRemovedTranslationFromDirtyEvent.c)
 *     EtwLogicalSurfRemovedTranslationFromMoveEvent @ 0x1C012F910 (EtwLogicalSurfRemovedTranslationFromMoveEvent.c)
 *     EtwTranslationUpdate @ 0x1C012FCA0 (EtwTranslationUpdate.c)
 * Callees:
