/*
 * XREFs of ?UnqueuePowerRequest@@YAPEAUtagPOWERREQUEST@@XZ @ 0x1C0065760
 * Callers:
...
struct tagPOWERREQUEST *UnqueuePowerRequest(void)
{
  ...
  {
    v0 = qword_1C0214668;
    v2 = *(_QWORD **)(qword_1C0214668 + 8);
    if ( *(struct _LIST_ENTRY **)qword_1C0214668 != &gPowerRequestList || *v2 != qword_1C0214668 )
      __fastfail(3u);
    qword_1C0214668 = *(_QWORD *)(qword_1C0214668 + 8);
