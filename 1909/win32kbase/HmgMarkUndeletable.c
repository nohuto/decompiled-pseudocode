/*
 * XREFs of HmgMarkUndeletable @ 0x1C0050BB0
 * Callers:
 *     ?vGlobal@BRUSHMEMOBJ@@QEAAXXZ @ 0x1C0050514 (-vGlobal@BRUSHMEMOBJ@@QEAAXXZ.c)
 *     SetSysColor @ 0x1C0050768 (SetSysColor.c)
 *     GreMarkUndeletableBitmap @ 0x1C0050B90 (GreMarkUndeletableBitmap.c)
 *     GreMarkUndeletableBrush @ 0x1C00A85B0 (GreMarkUndeletableBrush.c)
