/*
 * XREFs of ?RegisterPort@RegistrarClient@CoreMessagingK@@SAJPEBGPEBU_GUID@@@Z @ 0x1C009B4EC
 * Callers:
...
__int64 __fastcall CoreMessagingK::RegistrarClient::RegisterPort(const unsigned __int16 *a1, const struct _GUID *a2)
{
  ...
  if ( dword_1C020C5E0 > 5u )
  {
    ...
    v18 = 16;
    v21 = 4;
    TlgWrite((TraceLoggingHProvider)&dword_1C020C5E0, &unk_1C01E82A5, 0LL, 0LL, 5u, &pData);
  }
  return v6;
}
