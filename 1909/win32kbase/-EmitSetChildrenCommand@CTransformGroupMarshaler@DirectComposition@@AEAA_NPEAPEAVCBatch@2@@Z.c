/*
 * XREFs of ?EmitSetChildrenCommand@CTransformGroupMarshaler@DirectComposition@@AEAA_NPEAPEAVCBatch@2@@Z @ 0x1C000380C
 * Callers:
 *     ?EmitUpdateCommands@CTransformGroupMarshaler@DirectComposition@@MEAA_NPEAPEAVCBatch@2@@Z @ 0x1C00037C0 (-EmitUpdateCommands@CTransformGroupMarshaler@DirectComposition@@MEAA_NPEAPEAVCBatch@2@@Z.c)
 * Callees:
        ...
        struct DirectComposition::CBatch **a2)
{
  ...
  if ( (*((_DWORD *)this + 4) & 0x80u) != 0 && (unsigned __int64)*((unsigned int *)this + 20) < *((_QWORD *)this + 8) )
  {
    do
    {
      ...
      DirectComposition::CBatch::EnsureBatchBuffer(a2, (unsigned int)(4 * v6 + 20), &v17);
      v7 = (char *)v17;
      *(_DWORD *)v17 = 4 * v6 + 20;
      v8 = *((_DWORD *)this + 20) == 0;
      *(_QWORD *)(v7 + 4) = 0LL;
