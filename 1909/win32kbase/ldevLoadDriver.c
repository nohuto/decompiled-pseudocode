/*
 * XREFs of ldevLoadDriver @ 0x1C006B340
 * Callers:
 ...
 *     ?IsCddCddRemoteSessionFilteringAllowed@@YAHXZ @ 0x1C006BA2C (-IsCddCddRemoteSessionFilteringAllowed@@YAHXZ.c)
...
LABEL_39:
  ...
  *((_DWORD *)Image + 6) = v4;
  ...
  if ( !v20 )
    goto LABEL_31;
  if ( !v20(qword_1C0212B78, qword_1C0212B70, FileObject, qword_1C0212B80) )
    goto LABEL_39;
  *((_DWORD *)Image + 15) = 1;
LABEL_31:
