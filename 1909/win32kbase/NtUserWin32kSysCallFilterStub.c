/*
 * XREFs of NtUserWin32kSysCallFilterStub @ 0x1C011C220
 * Callers:
 *     <none>
 * Callees:
 ...
 *     ?_ShouldCaptureWerReport@@YAHK@Z @ 0x1C0110BF4 (-_ShouldCaptureWerReport@@YAHK@Z.c)
 *     EtwSyscallFilterMessage @ 0x1C012F950 (EtwSyscallFilterMessage.c)
 *     ExtractAggregateFieldTypes @ 0x1C01C85E4 (ExtractAggregateFieldTypes.c)
...
void __fastcall NtUserWin32kSysCallFilterStub(LPCSTR psz, unsigned int a2)
{
  ...
  {
    if ( !HIDWORD(qword_1C0211688[2 * (unsigned int)Win32KFilterSet]) && (unsigned int)_ShouldCaptureWerReport(a2) )
    {
    ...
    if ( dword_1C020C500 > 5u )
    {
      if ( TlgKeywordOn((TraceLoggingHProvider)&dword_1C020C500, 0x800000000000uLL) )
      {
        v31 = 0;
        v29 = &v23;
        v23 = 1LL;
        ...
        *(_DWORD *)&EventDescriptor.Level = 5;
        ...
        UserData.Ptr = (ULONGLONG)off_1C020C508;
        *(_DWORD *)&EventDescriptor.Id = 184549376;
        UserData.Size = *(unsigned __int16 *)off_1C020C508;
        v26 = &unk_1C01E1DA2;
        UserData.Reserved = 2;
        v27 = 108;
        v28 = v16;
        LODWORD(pwsz) = (unsigned int)&TraceLoggingMetadataEnd - (unsigned int)&TraceLoggingMetadata;
        if ( (ETWENABLECALLBACK *)qword_1C020C528 == TlgAggregateInternalRegisteredProviderEtwCallback )
        {
          ...
          if ( v17 )
            ...
            EtwWriteTransfer(qword_1C020C520, &EventDescriptor, 0LL, 0LL, 7u, &UserData);
        }
      }
    }
  }
