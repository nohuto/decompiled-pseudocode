/*
 * XREFs of ?bCleanDC@XDCOBJ@@QEAAHH@Z @ 0x1C001E190
 * Callers:
  ...
  if ( v134 )
  {
          ...
          v74 == 5) )
    {
      TrackObjectReferenceIncrement(
        0,
        *(struct NSInstrumentation::CReferenceTracker::CReferenceCountedType::SCircularBuffer **)(v72 + 680));
    }
    else if ( v74 == 16 )
    {
...
LABEL_136:
  ...
  if ( v136 )
  {
          ...
          v92 == 5) )
    {
      TrackObjectReferenceIncrement(
        0,
        *(struct NSInstrumentation::CReferenceTracker::CReferenceCountedType::SCircularBuffer **)(v90 + 680));
    }
    else if ( v92 == 16 )
    {
