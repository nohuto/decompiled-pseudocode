/*
 * XREFs of McTemplateK0qqqxxqtt @ 0x1C01A47CC
 * Callers:
...
ULONG __fastcall McTemplateK0qqqxxqtt(
        ...
        char a11)
{
  ...
  v26 = 4LL;
  v28 = 4LL;
  return McGenEventWrite(a1, &DCompResourceMapping, (LPCGUID)&Context.Flags, 9u, &EventData);
}
