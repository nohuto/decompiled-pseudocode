/*
 * XREFs of ?Create@CSharedReadVisualReferenceMarshaler@DirectComposition@@SAJPEBVCSharedSystemResource@2@PEAPEAV12@@Z @ 0x1C01C36CC
 * Callers:
 *     CreateSharedReadVisualReferenceMarshaler @ 0x1C01C38E0 (CreateSharedReadVisualReferenceMarshaler.c)
 * Callees:
