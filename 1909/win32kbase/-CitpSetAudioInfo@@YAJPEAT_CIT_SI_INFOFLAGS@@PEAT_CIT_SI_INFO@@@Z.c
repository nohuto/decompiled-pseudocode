/*
 * XREFs of ?CitpSetAudioInfo@@YAJPEAT_CIT_SI_INFOFLAGS@@PEAT_CIT_SI_INFO@@@Z @ 0x1C0098B28
 * Callers:
...
__int64 __fastcall CitpSetAudioInfo(union _CIT_SI_INFOFLAGS *a1, union _CIT_SI_INFO *a2)
{
  ...
  if ( v4 )
  {
    if ( (unsigned int)dword_1C020CCF4 < MEMORY[0xFFFFF7800000037C] )
      EtwTelemetryCoverageReport(&off_1C020CCE8);
    v11 = (char *)(v7 + 11);
    v12 = 10LL;
    if ( v10 )
      v9 = (char *)v10 + 104;
  ...
  {
    if ( (unsigned int)dword_1C020C0DC < MEMORY[0xFFFFF7800000037C] )
      EtwTelemetryCoverageReport(&off_1C020C0D0);
    v11 = (char *)v7 + 89;
    v12 = 11LL;
    if ( v10 )
      v9 = (char *)v10 + 112;
