/*
 * XREFs of W32CalloutDispatch @ 0x1C0023A70
 * Callers:
 *     <none>
 * Callees:
 ...
 *     ?vReleaseDwmHitTestWaiters@@YAXXZ @ 0x1C010465C (-vReleaseDwmHitTestWaiters@@YAXXZ.c)
  ...
  if ( a2 == 2 )
  {
      ...
      if ( v70 && (*(int *)(v70 + 24) > 0 || *(_DWORD *)(v93 + 48)) )
      {
        ...
        if ( dword_1C020CB50 > 6u )
        {
          if ( TlgKeywordOn((TraceLoggingHProvider)&dword_1C020CB50, 0x2000uLL) )
          {
            ...
            v106 = &v85;
            v107 = 4LL;
            TlgWrite((TraceLoggingHProvider)&dword_1C020CB50, &unk_1C01E1517, &pActivityId, 0LL, 3u, &v105);
          }
        }
      }
    }
      ...
      *(GUID *)(v93 + 28) = pActivityId;
      if ( dword_1C020CB50 > 6u )
      {
        if ( TlgKeywordOn((TraceLoggingHProvider)&dword_1C020CB50, 0x2000uLL) )
        {
          ...
          v109 = &v86;
          v110 = 4LL;
          TlgWrite((TraceLoggingHProvider)&dword_1C020CB50, &unk_1C01E14C0, &pActivityId, 0LL, 3u, &v108);
          v71 = dword_1C020CB50;
        }
        if ( v71 > 6 && TlgKeywordOn((TraceLoggingHProvider)&dword_1C020CB50, 0x2000uLL) )
        {
          v87 = v94;
          v112 = &v87;
          v113 = 4LL;
          TlgWrite((TraceLoggingHProvider)&dword_1C020CB50, &unk_1C01E14ED, &pActivityId, 0LL, 3u, &v111);
        }
      }
    }
    ...
    *a3 = v28;
    ...
    if ( (_DWORD)gdwInAtomicOperation )
    {
      ...
      v31 = (unsigned int)gdwInAtomicOperation;
      if ( (_DWORD)gdwInAtomicOperation )
      {
    ...
    if ( InputTraceLogging::Perf::s_userCritLoggingEnabled )
    {
      ...
      if ( v79 )
      {
        ...
        {
          TlgWrite((TraceLoggingHProvider)&dword_1C020CB50, &unk_1C01E14A1, (LPCGUID)(v80 + 28), 0LL, 2u, &v114);
        }
        *(_DWORD *)(v80 + 44) = 0;
        v89 = 0uLL;
        *(_OWORD *)(v80 + 28) = 0uLL;
    ...
    EtwTraceReleaseUserCrit(v31, v30, v40);
    ExReleaseResourceAndLeaveCriticalRegion(gpresUser);
    return 0LL;
  }
  switch ( a2 )
...
LABEL_89:
    ...
    case 0x15u:
      ...
      break;
    case 0x16u:
      ((void (__fastcall *)(__int64 *))qword_1C0212040)(a3);
      result = UserProcessFreezeCallout(a3);
      break;
    case 0x17u:
      ((void (__fastcall *)(__int64 *))qword_1C0212048)(a3);
      result = UserProcessThawCallout(a3);
      break;
    case 0x18u:
      ((void (__fastcall *)(__int64, __int64))qword_1C0212208)(*a3, a3[1]);
      return 0LL;
    case 0x19u:
      ((void (__fastcall *)(__int64 *))qword_1C0212210)(a3);
      return 0LL;
    case 0x1Au:
        ...
        *(GUID *)(v90 + 28) = ActivityId;
        if ( dword_1C020CB50 > 6u )
        {
          if ( TlgKeywordOn((TraceLoggingHProvider)&dword_1C020CB50, 0x2000uLL) )
          {
            ...
            v100 = &v83;
            v101 = 4LL;
            TlgWrite((TraceLoggingHProvider)&dword_1C020CB50, &unk_1C01E14C0, &ActivityId, 0LL, 3u, &v99);
            v52 = dword_1C020CB50;
          }
          if ( v52 > 6 && TlgKeywordOn((TraceLoggingHProvider)&dword_1C020CB50, 0x2000uLL) )
          {
            v84 = v91;
            v103 = &v84;
            v104 = 4LL;
            TlgWrite((TraceLoggingHProvider)&dword_1C020CB50, &unk_1C01E14ED, &ActivityId, 0LL, 3u, &v102);
          }
        }
      }
      EtwTraceAcquiredExclusiveUserCrit();
