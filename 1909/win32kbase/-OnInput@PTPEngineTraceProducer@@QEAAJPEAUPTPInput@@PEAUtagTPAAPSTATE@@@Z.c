/*
 * XREFs of ?OnInput@PTPEngineTraceProducer@@QEAAJPEAUPTPInput@@PEAUtagTPAAPSTATE@@@Z @ 0x1C0198428
 * Callers:
 *     ?ProcessInput@CPTPProcessor@@QEAAXPEAX0HHH@Z @ 0x1C0179538 (-ProcessInput@CPTPProcessor@@QEAAXPEAX0HHH@Z.c)
 *     ?OnInput@PTPEngineTraceProducer@@UEAAJPEAUPTPInput@@@Z @ 0x1C0198620 (-OnInput@PTPEngineTraceProducer@@UEAAJPEAUPTPInput@@@Z.c)
 * Callees:
        ...
        struct tagTPAAPSTATE *a3)
{
  ...
  if ( dword_1C020C490 > 5u && TlgKeywordOn((TraceLoggingHProvider)&dword_1C020C490, 3uLL) )
  {
    ...
    v22 = 56;
    v25 = 2;
    TlgWrite((TraceLoggingHProvider)&dword_1C020C490, &unk_1C01E6A66, 0LL, 0LL, 8u, &pData);
    v3 = dword_1C020C490;
  }
  if ( *((_DWORD *)a2 + 12) && v3 > 5 && TlgKeywordOn((TraceLoggingHProvider)&dword_1C020C490, 3uLL) )
  {
    v14 = 0;
    v17 = 0;
    v20 = 0;
    ...
    v16 = 4;
    v19 = 2;
    TlgWrite((TraceLoggingHProvider)&dword_1C020C490, &unk_1C01E6BB4, 0LL, 0LL, 6u, &pData);
  }
