/*
 * XREFs of ?CitpUpdateBootStats@@YAXPEAU_CIT_IMPACT_CONTEXT@@@Z @ 0x1C008111C
 * Callers:
  ...
  if ( (int)CitpUpdateActiveBootId(v2, 1u, &v21, &v20, v19) >= 0 )
  {
    ...
    if ( v20 )
    {
      ...
      if ( v21 )
      {
        if ( v21 != v9 )
        {
          CitpStatIncrement((unsigned __int16 *)a1 + 151, 1);
          CitpStatIncrement((unsigned __int16 *)a1 + 279, v18);
