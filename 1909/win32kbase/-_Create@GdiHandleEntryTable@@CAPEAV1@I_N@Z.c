/*
 * XREFs of ?_Create@GdiHandleEntryTable@@CAPEAV1@I_N@Z @ 0x1C008FF70
 * Callers:
 *     ?AcquireEntryIndex@GdiHandleEntryDirectory@@QEAA_NPEAI@Z @ 0x1C002A5C0 (-AcquireEntryIndex@GdiHandleEntryDirectory@@QEAA_NPEAI@Z.c)
