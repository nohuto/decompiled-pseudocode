/*
 * XREFs of ?CreateHandles@CRIMBase@@IEAAJQEBW4DispatcherHandleName@1@_KP6AXPEAURIMDevChangeStruct@@@ZPEAX@Z @ 0x1C0059D80
 * Callers:
 ...
 *     RIMRegisterForInput @ 0x1C005A220 (RIMRegisterForInput.c)
        ...
        void *a5)
{
  ...
  if ( a3 )
  {
    do
    {
      ...
      if ( (unsigned int)v9 >= 0x10 )
        return 3221225485LL;
      if ( dword_1C01D7220[3 * v9] != (_DWORD)v9 )
        MicrosoftTelemetryAssertTriggeredNoArgsKM(dword_1C01D7220, a2, a3);
      DispatcherHandles = CRIMBase::SensorDispatcherObject::CreateDispatcherHandles(
                            ...
                            (const struct CRIMBase::DispatcherCreation *)&dword_1C01D7220[3 * v9]);
  ...
  *((_QWORD *)this + 9) = (char *)this + 80;
  if ( (*((_BYTE *)this + 144) & 0x1C) == 0x1C )
  {
    ...
    if ( v20 )
    {
      if ( CRIMBase::IsDispatcherObjectValid(this, 3LL, v21) )
      {
        v27 = CRIMBase::GetDispatcherHandleByName(this, 3LL);
        v19 = v27;
        if ( !v27 )
  ...
  if ( v22 >= 0 )
  {
    v22 = RawInputManagerObjectResolveHandle(*((char **)this + 1), 3u, 1, (PVOID *)this + 2);
    if ( v22 < 0 )
