/*
 * XREFs of ?Win32kNtUserCleanup@@YAHXZ @ 0x1C00B2660
 * Callers:
      ...
      *(GUID *)(v36 + 28) = ActivityId;
      if ( dword_1C020CB50 > 6u )
      {
        if ( TlgKeywordOn((TraceLoggingHProvider)&dword_1C020CB50, 0x2000uLL) )
        {
          ...
          v43 = &v34;
          v44 = 4LL;
          TlgWrite((TraceLoggingHProvider)&dword_1C020CB50, &unk_1C01E14C0, &ActivityId, 0LL, 3u, &v42);
          v16 = dword_1C020CB50;
        }
        if ( v16 > 6 && TlgKeywordOn((TraceLoggingHProvider)&dword_1C020CB50, 0x2000uLL) )
        {
          ...
          v46 = &v35;
          v47 = 4LL;
          TlgWrite((TraceLoggingHProvider)&dword_1C020CB50, &unk_1C01E14ED, &ActivityId, 0LL, 3u, &v45);
        }
      }
    }
