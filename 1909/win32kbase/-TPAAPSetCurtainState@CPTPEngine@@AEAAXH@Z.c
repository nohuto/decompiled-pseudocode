/*
 * XREFs of ?TPAAPSetCurtainState@CPTPEngine@@AEAAXH@Z @ 0x1C01972A4
 * Callers:
 ...
 *     ?ProcessInitialization@CPTPEngine@@MEAAJXZ @ 0x1C01953B0 (-ProcessInitialization@CPTPEngine@@MEAAJXZ.c)
