/*
 * XREFs of ?DxgkEngEnterUserCrit@@YAXH@Z @ 0x1C00970E0
 * Callers:
 *     <none>
 * Callees:
      ...
      *(GUID *)(v44 + 28) = ActivityId_8;
      if ( dword_1C020CB50 > 6u )
      {
        if ( TlgKeywordOn((TraceLoggingHProvider)&dword_1C020CB50, 0x2000uLL) )
        {
          ...
          v54 = &v41;
          v55 = 4LL;
          TlgWrite((TraceLoggingHProvider)&dword_1C020CB50, &unk_1C01E14C0, &ActivityId_8, 0LL, 3u, &v53);
          v33 = dword_1C020CB50;
        }
        if ( v33 > 6 && TlgKeywordOn((TraceLoggingHProvider)&dword_1C020CB50, 0x2000uLL) )
        {
          ...
          v57 = &v42;
          v58 = 4LL;
          TlgWrite((TraceLoggingHProvider)&dword_1C020CB50, &unk_1C01E14ED, &ActivityId_8, 0LL, 3u, &v56);
        }
      }
    }
      ...
      if ( v39 && (*(int *)(v39 + 24) > 0 || *(_DWORD *)(v47 + 48)) )
      {
        ...
        if ( dword_1C020CB50 > 6u )
        {
          if ( TlgKeywordOn((TraceLoggingHProvider)&dword_1C020CB50, 0x2000uLL) )
          {
            ...
            v60 = &v43;
            v61 = 4LL;
            TlgWrite((TraceLoggingHProvider)&dword_1C020CB50, &unk_1C01E1517, &pActivityId, 0LL, 3u, &v59);
          }
        }
      }
    }
