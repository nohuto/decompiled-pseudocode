/*
 * XREFs of ?SetReferenceProperty@CShapeMarshaler@DirectComposition@@UEAAJPEAVCApplicationChannel@2@IPEAVCResourceMarshaler@2@PEA_N@Z @ 0x1C01AEDB0
 * Callers:
        ...
        bool *a5)
{
  ...
  v5 = (struct DirectComposition::CResourceMarshaler **)((char *)this + 40);
  v6 = 0;
  *a5 = 0;
  v10 = a3 == 0 ? 0x20 : 0;
  if ( a3 )
