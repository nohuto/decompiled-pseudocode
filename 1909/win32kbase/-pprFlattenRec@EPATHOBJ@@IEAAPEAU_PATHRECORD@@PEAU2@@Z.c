/*
 * XREFs of ?pprFlattenRec@EPATHOBJ@@IEAAPEAU_PATHRECORD@@PEAU2@@Z @ 0x1C0078750
 * Callers:
 *     ?bFlatten@EPATHOBJ@@QEAAHXZ @ 0x1C0078700 (-bFlatten@EPATHOBJ@@QEAAHXZ.c)
 * Callees:
 *     ?bNext@BEZIER32@@QEAAHPEAU_POINTFIX@@@Z @ 0x1C0078950 (-bNext@BEZIER32@@QEAAHPEAU_POINTFIX@@@Z.c)
 *     ?bInit@BEZIER32@@QEAAHPEAU_POINTFIX@@PEAU_RECTFX@@@Z @ 0x1C0078BE0 (-bInit@BEZIER32@@QEAAHPEAU_POINTFIX@@PEAU_RECTFX@@@Z.c)
 ...
 *     ?bNext@BEZIER64@@QEAAHPEAU_POINTFIX@@@Z @ 0x1C01249C0 (-bNext@BEZIER64@@QEAAHPEAU_POINTFIX@@@Z.c)
 *     ?vInit@BEZIER64@@QEAAXPEAU_POINTFIX@@PEAU_RECTFX@@PEB_J@Z @ 0x1C0124F70 (-vInit@BEZIER64@@QEAAXPEAU_POINTFIX@@PEAU_RECTFX@@PEB_J@Z.c)
 */
...
LABEL_10:
  --*((_DWORD *)this + 1);
  v11 = gpeqErrorLow;
  if ( BEZIER32::bInit((BEZIER32 *)v25, v7, 0LL) )
  {
    v26 = 1;
  }
  else
  {
    v26 = 0;
    BEZIER64::vInit((BEZIER64 *)v25, v7, 0LL, v11);
  }
  while ( *v5 < v22 )
  {
LABEL_13:
