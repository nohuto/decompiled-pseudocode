/*
 * XREFs of ?Win32KDriverUnload@@YAXPEAU_DRIVER_OBJECT@@@Z @ 0x1C00B2090
 * Callers:
 ...
 *     Win32FreePagedLookasideList @ 0x1C00B3430 (Win32FreePagedLookasideList.c)
 *     ??_GCConnection@DirectComposition@@AEAAPEAXI@Z @ 0x1C00B4C20 (--_GCConnection@DirectComposition@@AEAAPEAXI@Z.c)
 *     ?RemoveAnyObject@?$CGenericTable@UMaterialPropertyId@MaterialProperty@@U2@$0HEHCEDEE@$0A@@DirectComposition@@QEAAPEAUMaterialProperty@@XZ @ 0x1C00B4D24 (-RemoveAnyObject@-$CGenericTable@UMaterialPropertyId@MaterialProperty@@U2@$0HEHCEDEE@$0A@@Direct.c)
 ...
 *     ?FreeWin32KSyscallFilter@@YAXXZ @ 0x1C00B4F5C (-FreeWin32KSyscallFilter@@YAXXZ.c)
 *     RIMUnInitialize @ 0x1C00B4FE0 (RIMUnInitialize.c)
 *     CoreMsgUninitialize @ 0x1C00B511C (CoreMsgUninitialize.c)
 *     McGenEventUnregister @ 0x1C00B5264 (McGenEventUnregister.c)
...
void __fastcall Win32KDriverUnload(struct _DRIVER_OBJECT *a1)
{
  ...
  if ( qword_1C0210758 )
  {
    ...
    for ( i = (void (*)(void))DestroyHandleFirstPass; ; i = (void (*)(void))DestroyHandleSecondPass )
    {
      ...
      do
      {
        if ( *((_BYTE *)qword_1C0210758 + 32 * v7 + 24) )
          i();
        ++v7;
      }
      while ( v7 <= giheLast );
  ...
  {
    EtwUnregister(qword_1C020C590);
    qword_1C020C590 = 0LL;
    hProvider = 0;
    EtwUnregister(qword_1C020C558);
    qword_1C020C558 = 0LL;
    dword_1C020C538 = 0;
    EtwUnregister(qword_1C020C4E8);
    qword_1C020C4E8 = 0LL;
    dword_1C020C4C8 = 0;
    EtwUnregister(qword_1C020C4B0);
    qword_1C020C4B0 = 0LL;
    dword_1C020C490 = 0;
    EtwUnregister(qword_1C020CB70);
    qword_1C020CB70 = 0LL;
    dword_1C020CB50 = 0;
