/*
 * XREFs of ?HandleConnectionRequest@ServerPorts@CoreMessagingK@@CAXPEAUServerPortInfo@2@PEAU_PORT_MESSAGE@@@Z @ 0x1C009B618
 * Callers:
        ...
        struct _PORT_MESSAGE *a2)
{
  ...
  if ( dword_1C020C5E0 > 5u )
  {
    ...
    v36 = 4;
    v39 = 4;
    TlgWrite((TraceLoggingHProvider)&dword_1C020C5E0, &unk_1C01E831B, 0LL, 0LL, 8u, &pData);
  }
}
