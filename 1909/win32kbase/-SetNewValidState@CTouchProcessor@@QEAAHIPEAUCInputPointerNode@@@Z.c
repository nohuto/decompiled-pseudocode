/*
 * XREFs of ?SetNewValidState@CTouchProcessor@@QEAAHIPEAUCInputPointerNode@@@Z @ 0x1C0170604
 * Callers:
...
_BOOL8 __fastcall CTouchProcessor::SetNewValidState(struct _KTHREAD **this, __int64 a2, struct CInputPointerNode *a3)
{
  ...
  v5 = &WPP_dde6ae6ba4d53e169de0efe5dbb74602_Traceguids;
      ...
      else
      {
        ...
        else
        {
          if ( (v4 & 0x70006) != 0x40002 )
          {
            ...
            {
              LOBYTE(v5) = 2;
              WPP_RECORDER_SF_L(1, (_DWORD)v5, 7, 64, (__int64)&WPP_dde6ae6ba4d53e169de0efe5dbb74602_Traceguids, v4);
            }
            goto LABEL_14;
          }
          v9 = 1;
...
LABEL_14:
  ...
  if ( (*((_DWORD *)a3 + 72) & 8) != 0 )
  {
    v7 = (v4 & 0x8000) != 0;
    if ( (v4 & 0x8000) == 0 )
      MicrosoftTelemetryAssertTriggeredNoArgsKM(1LL, &WPP_dde6ae6ba4d53e169de0efe5dbb74602_Traceguids, a3);
  }
  if ( v7 )
  {
    *((_DWORD *)a3 + 13) = v9;
