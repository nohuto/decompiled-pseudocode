/*
 * XREFs of ?BeginFrame@CConnection@DirectComposition@@QEAAJAEBUCOMPOSITION_FRAME_INFO@@PEA_K@Z @ 0x1C006F0E0
 * Callers:
        ...
        unsigned __int64 *a3)
{
  ...
  *v3 = 0LL;
  ...
  if ( *((_QWORD *)this + 23)
    || (v8 = (*(__int64 (__fastcall **)(_QWORD))(**((_QWORD **)this + 31) + 160LL))(*((_QWORD *)this + 31)), v8 >= 0) )
  {
...
LABEL_15:
      ...
      if ( v11 )
      {
        do
        {
          ...
          if ( v28 )
          {
            ...
            *(_QWORD *)(v28 + 24) = 0LL;
            v36 = (struct _SLIST_ENTRY *)*((_QWORD *)&v11[1].Next + 1);
      ...
      if ( v14 )
      {
        ...
        do
        {
          ...
          if ( *(_BYTE *)(v34 + 49) )
          {
            if ( (*(_BYTE *)(v34 + 241) & 4) != 0 )
            {
              v39 = *(LARGE_INTEGER **)(v34 + 720);
              v39[5].QuadPart = v33;
              v39[6] = KeQueryPerformanceCounter(0LL);
            }
            *(_BYTE *)(v34 + 49) = 0;
          }
          v35 = (PSLIST_ENTRY *)v14;
          v14 = (_QWORD *)*v14;
        }
        while ( v14 );
        v15 = *v13;
...
LABEL_12:
      ...
      while ( 1 )
      {
        ...
        *((_QWORD *)&v15[3].Next + 1) = v21;
        ...
        if ( *(_BYTE *)(*((_QWORD *)&v15->Next + 1) + 242LL) )
          break;
        v25 = v15[4].Next;
        ...
        if ( !v27 || (v40 = BYTE1(v27[2].Next)) != 0 && SHIDWORD(v27[2].Next) <= 0 )
        {
          if ( ((__int64)v15[2].Next & 8) != 0 )
            *(_BYTE *)(*((_QWORD *)&v15->Next + 1) + 242LL) = 1;
          v16 = &v15->Next;
          goto LABEL_33;
        }
        v30 = 6;
