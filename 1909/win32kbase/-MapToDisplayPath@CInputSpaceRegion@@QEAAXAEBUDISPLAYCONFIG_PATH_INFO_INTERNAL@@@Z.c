/*
 * XREFs of ?MapToDisplayPath@CInputSpaceRegion@@QEAAXAEBUDISPLAYCONFIG_PATH_INFO_INTERNAL@@@Z @ 0x1C00A3370
 * Callers:
        ...
        const struct DISPLAYCONFIG_PATH_INFO_INTERNAL *a2)
{
  ...
  *((_DWORD *)this + 12) = *((_DWORD *)a2 + 26);
  v9[0] = 0LL;
  v9[1] = 0LL;
  RIMUpdatePointerDeviceScalingInfo((_DWORD *)this + 13, a2, (int *)v9, (__int64)this + 68);
  v8 = *v4;
