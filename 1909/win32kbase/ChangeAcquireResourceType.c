/*
 * XREFs of ChangeAcquireResourceType @ 0x1C0091170
 * Callers:
 *     <none>
 * Callees:
...
void __fastcall ChangeAcquireResourceType(__int64 a1, __int64 a2, __int64 a3)
{
  ...
  if ( InputTraceLogging::Perf::s_userCritLoggingEnabled )
  {
    ...
    if ( CurrentThreadWin32Thread )
    {
      ...
      {
        TlgWrite((TraceLoggingHProvider)&dword_1C020CB50, &unk_1C01E14A1, (LPCGUID)(v27 + 28), 0LL, 2u, &pData);
      }
      *(_DWORD *)(v27 + 44) = 0;
      v39 = 0LL;
      v40 = 0LL;
    ...
    if ( v29 && (*(int *)(v29 + 24) > 0 || *(_DWORD *)(v41 + 48)) )
    {
      ...
      if ( dword_1C020CB50 > 6u )
      {
        if ( TlgKeywordOn((TraceLoggingHProvider)&dword_1C020CB50, 0x2000uLL) )
        {
          ...
          v45 = &v36;
          v46 = 4LL;
          TlgWrite((TraceLoggingHProvider)&dword_1C020CB50, &unk_1C01E1517, &ActivityId_8, 0LL, 3u, &v44);
        }
      }
    }
  }
    ...
    *(GUID *)(v41 + 28) = ActivityId_8;
    if ( dword_1C020CB50 > 6u )
    {
      if ( TlgKeywordOn((TraceLoggingHProvider)&dword_1C020CB50, 0x2000uLL) )
      {
        ...
        v48 = &v37;
        v49 = 4LL;
        TlgWrite((TraceLoggingHProvider)&dword_1C020CB50, &unk_1C01E14C0, &ActivityId_8, 0LL, 3u, &v47);
        v30 = dword_1C020CB50;
      }
      if ( v30 > 6 && TlgKeywordOn((TraceLoggingHProvider)&dword_1C020CB50, 0x2000uLL) )
      {
        v38 = ActivityId_4;
        v51 = &v38;
        v52 = 4LL;
        TlgWrite((TraceLoggingHProvider)&dword_1C020CB50, &unk_1C01E14ED, &ActivityId_8, 0LL, 3u, &v50);
      }
    }
  }
