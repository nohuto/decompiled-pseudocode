/*
 * XREFs of ?TransformPointWithUniformSpaceMapping@@YAHPEAU_MDEV@@PEAH1H@Z @ 0x1C004FF50
 * Callers:
 *     DrvPixelSpaceToUniformSpacePoint @ 0x1C004F690 (DrvPixelSpaceToUniformSpacePoint.c)
 *     DrvUniformSpaceToPixelSpacePoint @ 0x1C004FF20 (DrvUniformSpaceToPixelSpacePoint.c)
 * Callees:
