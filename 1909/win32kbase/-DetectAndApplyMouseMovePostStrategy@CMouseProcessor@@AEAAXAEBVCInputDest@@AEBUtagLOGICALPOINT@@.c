/*
 * XREFs of ?DetectAndApplyMouseMovePostStrategy@CMouseProcessor@@AEAAXAEBVCInputDest@@AEBUtagLOGICALPOINT@@AEBVCMoveEvent@1@@Z @ 0x1C0037E48
 * Callers:
        ...
        const struct CMouseProcessor::CMoveEvent *a4)
{
  ...
  if ( dword_1C020CB50 > 5u && TlgKeywordOn((TraceLoggingHProvider)&dword_1C020CB50, 0x40uLL) )
  {
    *((_QWORD *)&v41 + 1) = 8LL;
    v23 = *((_QWORD *)v36 + 1);
    v37 = v15;
    ...
    *(_QWORD *)&v42 = &v37;
    v36 = v24;
    TlgWrite((TraceLoggingHProvider)&dword_1C020CB50, &unk_1C01E6234, 0LL, 0LL, 4u, &pData);
  }
  if ( *((_DWORD *)a2 + 23) == 2 )
    v19 = *((_QWORD *)a2 + 10);
  else
