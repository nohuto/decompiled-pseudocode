 ...
 * Callees:
 *     RtlUpcaseUnicodeToMultiByteN_0 @ 0x1C00B9D82 (RtlUpcaseUnicodeToMultiByteN_0.c)
 *     RtlAnsiCharToUnicodeChar_0 @ 0x1C00B9D94 (RtlAnsiCharToUnicodeChar_0.c)
 */
