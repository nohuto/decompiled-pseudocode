/*
 * XREFs of ?InjectInput@RIM@InputTraceLogging@@SAXPEBURIMDEV@@W4InputTracing_RimInjectionSource@@@Z @ 0x1C0145948
 * Callers:
 ...
 *     ?PointerDeviceTypeToString@InputTraceLogging@@CAPEBDK@Z @ 0x1C0131F40 (-PointerDeviceTypeToString@InputTraceLogging@@CAPEBDK@Z.c)
 *     ?InjectionSourceToString@InputTraceLogging@@CAPEBDW4InputTracing_RimInjectionSource@@@Z @ 0x1C0145C48 (-InjectionSourceToString@InputTraceLogging@@CAPEBDW4InputTracing_RimInjectionSource@@@Z.c)
 */
    ...
    if ( (*(_DWORD *)(a1 + 200) & 0x80u) == 0 )
    {
      if ( dword_1C020CB50 > 4u && TlgKeywordOn((TraceLoggingHProvider)&dword_1C020CB50, 0x100uLL) )
      {
        ...
        *(_QWORD *)&v34.Size = v20;
        ...
        v35 = &v27;
        v36 = v20;
        TlgWrite((TraceLoggingHProvider)&dword_1C020CB50, &unk_1C01E2F0E, 0LL, 0LL, 6u, &pData);
      }
    }
    else if ( dword_1C020CB50 > 4u && TlgKeywordOn((TraceLoggingHProvider)&dword_1C020CB50, 0x100uLL) )
    {
      v29 = v5;
      v32.Ptr = (ULONGLONG)&v29;
      *(_QWORD *)&v32.Size = 8LL;
      ...
      v39 = &v28;
      v40 = v9;
      TlgWrite((TraceLoggingHProvider)&dword_1C020CB50, &unk_1C01E2EA0, 0LL, 0LL, 8u, &pData);
    }
  }
  else if ( v4 )
  {
    if ( v4 == 1 && dword_1C020CB50 > 4u && TlgKeywordOn((TraceLoggingHProvider)&dword_1C020CB50, 0x100uLL) )
    {
      ...
      *(_QWORD *)&pDesc.Size = 8LL;
      TlgWrite((TraceLoggingHProvider)&dword_1C020CB50, &unk_1C01E2F8A, 0LL, 0LL, v26, &pData);
    }
  }
  else if ( dword_1C020CB50 > 4u && TlgKeywordOn((TraceLoggingHProvider)&dword_1C020CB50, 0x100uLL) )
  {
    ...
    pDesc.Ptr = (ULONGLONG)&v29;
    *(_QWORD *)&pDesc.Size = 8LL;
    TlgWrite((TraceLoggingHProvider)&dword_1C020CB50, &unk_1C01E2F54, 0LL, 0LL, cData, &pData);
  }
}
