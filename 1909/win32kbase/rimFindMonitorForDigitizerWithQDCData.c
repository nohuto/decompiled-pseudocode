/*
 * XREFs of rimFindMonitorForDigitizerWithQDCData @ 0x1C0144A88
 * Callers:
 ...
 *     DrvDisplayConfigGetDeviceInfo @ 0x1C003B860 (DrvDisplayConfigGetDeviceInfo.c)
 ...
 *     RIMGetDisplayMonitor @ 0x1C0143C58 (RIMGetDisplayMonitor.c)
...
__int64 __fastcall rimFindMonitorForDigitizerWithQDCData(__int64 a1, __int64 a2, int *a3)
{
  ...
  if ( *(_DWORD *)v5 )
  {
    ...
    do
    {
      ...
      v32 = *(_QWORD *)(a1 + 2104) - v64;
      if ( !v32 )
        v32 = *(_QWORD *)(a1 + 2112) - v65;
      if ( !v32 )
      {
        v33 = v62 - *(_QWORD *)(a1 + 2104);
        if ( v62 == *(_QWORD *)(a1 + 2104) )
          v33 = v62 - *(_QWORD *)(a1 + 2112);
        if ( v33 )
        {
          v34 = *(_QWORD *)(v5 + 8);
          ++v49;
      ...
      if ( *(_DWORD *)(a1 + 1352) == 6 )
      {
        ...
        if ( *(_DWORD *)(a1 + 1868) == v38[4] && *(_DWORD *)(a1 + 1872) == v38[5] && *(_DWORD *)(a1 + 1876) == v38[6] )
          v7 = v16 + *(_QWORD *)(v5 + 8);
      }
