/*
 * XREFs of ?CoalesceQFrames@CTouchProcessor@@AEAAHPEBUCPointerInputFrame@@PEAUCPointerQFrame@@PEAU2@@Z @ 0x1C01608BC
 * Callers:
 ...
 *     ?IsFullyReleased@CPointerInfoNode@@QEBAHXZ @ 0x1C016B8F0 (-IsFullyReleased@CPointerInfoNode@@QEBAHXZ.c)
