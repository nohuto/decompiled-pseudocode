/*
 * XREFs of TlgRegisterAggregateProviderEx @ 0x1C02460A4
 * Callers:
...
TLG_STATUS __fastcall TlgRegisterAggregateProviderEx(__int64 a1)
{
  ...
  if ( !TlgAggregateSession )
    return TraceLoggingRegisterEx((TraceLoggingHProvider)&dword_1C020C500, 0LL, 0LL);
  *(_QWORD *)(TlgAggregateSession + 328) = 0LL;
  *(_QWORD *)(TlgAggregateSession + 336) = 0LL;
  *(_QWORD *)(TlgAggregateSession + 344) = &dword_1C020C500;
  *(_BYTE *)(TlgAggregateSession + 373) = 1;
  v3 = TraceLoggingRegisterEx(
         (TraceLoggingHProvider)&dword_1C020C500,
  ...
  else
  {
    ...
    if ( !qword_1C0215850 )
    {
      TraceLoggingRegisterEx(
        (TraceLoggingHProvider)&dword_1C020C618,
