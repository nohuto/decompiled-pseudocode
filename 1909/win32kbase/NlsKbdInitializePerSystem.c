/*
 * XREFs of NlsKbdInitializePerSystem @ 0x1C00A37D0
 * Callers:
 *     <none>
 * Callees:
 *     ?NlsSetKeyStateToggle@@YAXE@Z @ 0x1C00A3A24 (-NlsSetKeyStateToggle@@YAXE@Z.c)
...
void NlsKbdInitializePerSystem()
{
  ...
  *(_QWORD *)&v2.Length = 0LL;
  ...
  if ( gKeyboardInfo == 7 && byte_1C020D5C9 == 3 )
