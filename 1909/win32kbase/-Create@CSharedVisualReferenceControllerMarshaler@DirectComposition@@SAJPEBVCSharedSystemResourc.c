/*
 * XREFs of ?Create@CSharedVisualReferenceControllerMarshaler@DirectComposition@@SAJPEBVCSharedSystemResource@2@PEAPEAV12@@Z @ 0x1C01C3778
 * Callers:
 *     CreateSharedVisualReferenceControllerMarshaler @ 0x1C01C3920 (CreateSharedVisualReferenceControllerMarshaler.c)
 * Callees:
