/*
 * XREFs of ?ConvertPathPreferredScalingToAdapterDefault@@YAXPEAUD3DKMT_PATHMODALITY_DESCRIPTOR@@@Z @ 0x1C0127104
 * Callers:
        ...
        __int64 a3)
{
  ...
  if ( *((_DWORD *)a1 + 35) == 253 )
  {
    ...
    ((void (__fastcall *)(char *, char *))qword_1C0212148)((char *)a1 + 16, (char *)a1 + 140);
  }
