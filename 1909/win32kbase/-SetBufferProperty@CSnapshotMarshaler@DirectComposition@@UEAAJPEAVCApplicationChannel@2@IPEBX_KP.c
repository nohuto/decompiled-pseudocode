/*
 * XREFs of ?SetBufferProperty@CSnapshotMarshaler@DirectComposition@@UEAAJPEAVCApplicationChannel@2@IPEBX_KPEA_N@Z @ 0x1C01C1380
 * Callers:
 *     <none>
 * Callees:
        ...
        bool *a6)
{
  ...
  *a6 = 0;
  if ( a3 == 4 && a5 == 64 )
  {
    if ( memcmp((char *)this + 60, a4, 0x40uLL) )
    {
