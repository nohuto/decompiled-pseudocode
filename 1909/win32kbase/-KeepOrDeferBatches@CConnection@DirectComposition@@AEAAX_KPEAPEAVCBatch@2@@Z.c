/*
 * XREFs of ?KeepOrDeferBatches@CConnection@DirectComposition@@AEAAX_KPEAPEAVCBatch@2@@Z @ 0x1C01A17AC
 * Callers:
 *     ?GetReadyBatches@CConnection@DirectComposition@@QEAAJ_KPEAPEAVCBatch@2@@Z @ 0x1C01A1720 (-GetReadyBatches@CConnection@DirectComposition@@QEAAJ_KPEAPEAVCBatch@2@@Z.c)
 * Callees:
 *     McTemplateK0qpqxxq @ 0x1C010E3F4 (McTemplateK0qpqxxq.c)
 *     ?ShouldDefer@CBatch@DirectComposition@@QEAA_N_J_NPEAVCEvent@2@PEAW4DeferReason@12@@Z @ 0x1C01A4CBC (-ShouldDefer@CBatch@DirectComposition@@QEAA_N_J_NPEAVCEvent@2@PEAW4DeferReason@12@@Z.c)
 */
      ...
      *((_QWORD *)v3 + 7) = a2;
             ...
             (enum DirectComposition::CBatch::DeferReason *)&v14) )
      {
        if ( ((unsigned __int8)Microsoft_Windows_Win32kEnableBits & 1) != 0 )
          McTemplateK0qpqxxq(
            *((struct _MCGEN_TRACE_CONTEXT **)v3 + 1),
            v10,
            v11,
