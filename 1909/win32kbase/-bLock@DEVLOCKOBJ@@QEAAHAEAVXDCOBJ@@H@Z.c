/*
 * XREFs of ?bLock@DEVLOCKOBJ@@QEAAHAEAVXDCOBJ@@H@Z @ 0x1C00258B0
 * Callers:
 *     GreGetClipBox @ 0x1C0017FA0 (GreGetClipBox.c)
 * Callees:
 *     ?SaveAttributes@XDCOBJ@@AEAAHXZ @ 0x1C001B738 (-SaveAttributes@XDCOBJ@@AEAAHXZ.c)
  ...
  *((_QWORD *)this + 9) = *(_QWORD *)*a2;
  ...
  if ( (*((_DWORD *)*a2 + 9) & 0x200) != 0 )
  {
    ...
    *((_DWORD *)this + 6) |= 8u;
    ...
    {
      v18 = (struct _ERESOURCE *)*((_QWORD *)v14 + 8);
      *(_QWORD *)this = v18;
...
LABEL_161:
          ...
          v57 = XDCOBJ::SaveAttributes((DC **)this + 4);
          v58 = *((_QWORD *)this + 4);
          if ( !v57 )
          {
