/*
 * XREFs of EtwTraceAcquiredExclusiveUserCrit @ 0x1C00268F0
 * Callers:
...
__int64 EtwTraceAcquiredExclusiveUserCrit()
{
  ...
  if ( result )
  {
    ...
    _InterlockedIncrement64(&qword_1C0212520[v6]);
LABEL_9:
    _InterlockedExchangeAdd64(&qword_1C0212688, v5);
    _InterlockedIncrement64(&qword_1C02126A0);
    if ( (dword_1C021251C & 1) == 0 )
    {
      dword_1C021251C |= 1u;
      memset(qword_1C0212520, 0, 0x198uLL);
    ...
    UserCritTelemetry::SendUserCritSummary((UserCritTelemetry *)qword_1C0212520);
