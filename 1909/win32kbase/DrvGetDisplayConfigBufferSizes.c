/*
 * XREFs of DrvGetDisplayConfigBufferSizes @ 0x1C003D410
 * Callers:
...
__int64 __fastcall DrvGetDisplayConfigBufferSizes(__int64 a1, __int64 a2, __int64 a3)
{
  ...
  *(_QWORD *)(v5 + 24) = v4;
  ...
  if ( (unsigned int)DrvIsWddmDriverPresent() )
  {
    if ( (v4 & 7) == 4 )
    {
      v12 = (unsigned __int8)((__int64 (*)(void))qword_1C0212228)() != 0;
    ...
    v9 = ((__int64 (__fastcall *)(_QWORD, __int64))qword_1C02120E0)((unsigned int)v4, a2);
  }
  else
  {
    v9 = -1073741637;
