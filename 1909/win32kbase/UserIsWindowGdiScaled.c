/*
 * XREFs of UserIsWindowGdiScaled @ 0x1C007E040
 * Callers:
 *     DxgkEngGetWindowGdiDpiScalingFactor @ 0x1C012DD30 (DxgkEngGetWindowGdiDpiScalingFactor.c)
 * Callees:
...
__int64 __fastcall UserIsWindowGdiScaled(__int64 a1, _WORD *a2)
{
  ...
  if ( !*(_QWORD *)(W32GetThreadWin32Thread((__int64)KeGetCurrentThread()) + 448) )
    return 0LL;
  if ( (*(_DWORD *)(**(_QWORD **)(*(_QWORD *)(W32GetThreadWin32Thread((__int64)KeGetCurrentThread()) + 448) + 8LL) + 64LL) & 1) == 0 )
    return 0LL;
  v5 = *(_QWORD *)(v4 + 40);
