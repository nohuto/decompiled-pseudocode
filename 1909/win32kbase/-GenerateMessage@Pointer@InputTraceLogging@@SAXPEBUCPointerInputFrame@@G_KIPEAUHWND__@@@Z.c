/*
 * XREFs of ?GenerateMessage@Pointer@InputTraceLogging@@SAXPEBUCPointerInputFrame@@G_KIPEAUHWND__@@@Z @ 0x1C0165CF8
 * Callers:
        ...
        HWND a5)
{
  ...
  if ( dword_1C020CB50 > 4u )
  {
    if ( TlgKeywordOn((TraceLoggingHProvider)&dword_1C020CB50, 0x20uLL) )
    {
      ...
      v25 = 4LL;
      v27 = 8LL;
      TlgWrite((TraceLoggingHProvider)&dword_1C020CB50, &unk_1C01E439A, 0LL, 0LL, 9u, &pData);
    }
  }
}
