/*
 * XREFs of DrvDxgkLogCodePointPacket @ 0x1C00B6660
 * Callers:
 ...
 *     ?bDynamicMatchEnoughForModeChange@@YAHPEAUHDEV__@@0@Z @ 0x1C006C3E4 (-bDynamicMatchEnoughForModeChange@@YAHPEAUHDEV__@@0@Z.c)
 ...
 *     ?EnforceSDCCloneSourceIndexCoherency@@YAJIPEAUDISPLAYCONFIG_PATH_INFO_INTERNAL@@@Z @ 0x1C0129164 (-EnforceSDCCloneSourceIndexCoherency@@YAJIPEAUDISPLAYCONFIG_PATH_INFO_INTERNAL@@@Z.c)
 * Callees:
...
__int64 __fastcall DrvDxgkLogCodePointPacket(int a1, int a2, int a3, int a4)
{
  ...
  v12 = a3;
  v13 = a4;
  return ((__int64 (__fastcall *)(_DWORD *))qword_1C0212140)(v5);
}
