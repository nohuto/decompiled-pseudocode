/*
 * XREFs of ?OnTelemetryOutput@CPTPProcessor@@UEAAXPEBUPTPTelemetryOutput@@@Z @ 0x1C01792D0
 * Callers:
 *     <none>
 * Callees:
 ...
 *     EtwTraceTouchPadAAP @ 0x1C010BD70 (EtwTraceTouchPadAAP.c)
 *     EtwTraceTouchPadCurtainState @ 0x1C010BE40 (EtwTraceTouchPadCurtainState.c)
 *     ?OnEndSession@Telemetry@CPTPProcessor@@SAX_J@Z @ 0x1C0178D8C (-OnEndSession@Telemetry@CPTPProcessor@@SAX_J@Z.c)
 *     ?OnNewSession@Telemetry@CPTPProcessor@@SAX_J@Z @ 0x1C017927C (-OnNewSession@Telemetry@CPTPProcessor@@SAX_J@Z.c)
        ...
        if ( v6 )
        {
          ...
          if ( v7 )
          {
            ...
            if ( (_DWORD)v8 )
            {
                ...
                if ( v10 )
                {
                  ...
                  if ( v11 )
                  {
                    ...
                    else
                    {
                      ...
                      {
                        if ( v14 == 1 )
                          qword_1C0215FD8 = *(_QWORD *)((char *)a2 + 12);
                      }
                      else
                      {
                        qword_1C0215FD0 = *(_QWORD *)((char *)a2 + 12);
                      }
                    }
                  }
                  else
                  {
                    ...
                    {
                      qword_1C0215FB0 += v16;
                      if ( v16 > qword_1C0215FB8 )
                        qword_1C0215FB8 = v16;
                      if ( !qword_1C0215FC0 || v16 < qword_1C0215FC0 )
                        qword_1C0215FC0 = v16;
                    }
                  }
                }
              ...
              else if ( qword_1C02109B8 < qword_1C0215D58 )
              {
                qword_1C02109B8 = *((_QWORD *)a2 + 1);
              }
            }
            else
            {
