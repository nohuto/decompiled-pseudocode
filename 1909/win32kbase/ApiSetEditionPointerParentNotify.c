/*
 * XREFs of ApiSetEditionPointerParentNotify @ 0x1C019B124
 * Callers:
...
__int64 __fastcall ApiSetEditionPointerParentNotify(__int64 a1, __int64 a2, __int64 a3)
{
  __int64 v4; // rsi
  __int64 result; // rax
  int v7; // edx
  ...
  if ( (int)result >= 0 )
  {
    ...
    *(_QWORD *)&v12 = *(_QWORD *)(a1 + 112);
    v14[6] = v13;
    v15 = v12;
    result = EditionPointerParentNotify(v14, v4, a3);
  }
