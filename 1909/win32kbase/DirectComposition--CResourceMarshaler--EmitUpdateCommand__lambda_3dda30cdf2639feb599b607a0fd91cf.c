/*
 * XREFs of DirectComposition::CResourceMarshaler::EmitUpdateCommand__lambda_3dda30cdf2639feb599b607a0fd91cf7___ @ 0x1C01B39B0
 * Callers:
...
char __fastcall DirectComposition::CResourceMarshaler::EmitUpdateCommand__lambda_3dda30cdf2639feb599b607a0fd91cf7___(
        __int64 a1,
        ...
        __int64 *a3)
{
  ...
  *((_DWORD *)v5 + 2) = *(_DWORD *)(a1 + 24);
  v6 = *a3;
  *(_QWORD *)(v5 + 12) = *(_QWORD *)(*a3 + 400);
  *((_DWORD *)v5 + 5) = *(_DWORD *)(v6 + 408);
  return 1;
}
