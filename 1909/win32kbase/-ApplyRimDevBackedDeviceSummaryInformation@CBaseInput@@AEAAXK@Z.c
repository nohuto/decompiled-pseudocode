/*
 * XREFs of ?ApplyRimDevBackedDeviceSummaryInformation@CBaseInput@@AEAAXK@Z @ 0x1C0053A2C
 * Callers:
...
void __fastcall CBaseInput::ApplyRimDevBackedDeviceSummaryInformation(CBaseInput *this, int a2)
{
  ...
  if ( CBaseInput::_spDevList )
  {
    ...
    while ( 1 )
    {
      ...
      if ( v5 == a2 )
      {
        ApiSetGatherDeviceInfoSummaryInformation((__int64)v3, &v10, &v8, &v7, &v9, &v13, &v12);
        v4 = v10;
        goto LABEL_7;
      }
      if ( a2 != 2 )
