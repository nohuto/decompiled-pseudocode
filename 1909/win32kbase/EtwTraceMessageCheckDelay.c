/*
 * XREFs of EtwTraceMessageCheckDelay @ 0x1C0035310
 * Callers:
...
LABEL_39:
  ...
  if ( (*((_DWORD *)v19 + 203) & 0x30) == 0x10 )
  {
    ...
    if ( hProvider > 5u && TlgKeywordOn((TraceLoggingHProvider)&hProvider, 0x40000uLL) )
    {
      ...
      v110 = v28;
      v111 = 0;
      TlgWrite((TraceLoggingHProvider)&hProvider, &unk_1C01E1C72, 0LL, 0LL, 0xFu, &pData);
    }
  ...
  else
  {
    ...
    if ( hProvider > 5u && TlgKeywordOn((TraceLoggingHProvider)&hProvider, 0x40000uLL) )
    {
      ...
      v80 = v29;
      v81 = 0;
      TlgWrite((TraceLoggingHProvider)&hProvider, &unk_1C01E1BAB, 0LL, 0LL, 0xCu, &v57);
    }
  }
  if ( Buffer )
