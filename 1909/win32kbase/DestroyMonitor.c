/*
 * XREFs of DestroyMonitor @ 0x1C00B4610
 * Callers:
 ...
 *     ?GetKernelHandleToRimObj@CHidInput@@QEAAJPEAPEAX@Z @ 0x1C00A02D0 (-GetKernelHandleToRimObj@CHidInput@@QEAAJPEAPEAX@Z.c)
...
__int64 __fastcall DestroyMonitor(struct tagMONITOR *a1)
{
  ...
  *((_QWORD *)a1 + 7) = 0LL;
  ...
  if ( (_DWORD)result )
  {
    ...
    while ( v17 < 0x12 );
    return HMFreeObject(a1, v14, v15);
  }
  return result;
}
