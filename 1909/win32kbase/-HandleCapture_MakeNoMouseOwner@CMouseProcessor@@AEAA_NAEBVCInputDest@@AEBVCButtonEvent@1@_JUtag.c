/*
 * XREFs of ?HandleCapture_MakeNoMouseOwner@CMouseProcessor@@AEAA_NAEBVCInputDest@@AEBVCButtonEvent@1@_JUtagPOINT@@I@Z @ 0x1C004EDF0
 * Callers:
 ...
 *     IsWindowDesktopComposed @ 0x1C0040420 (IsWindowDesktopComposed.c)
        ...
        unsigned int a6)
{
  ...
  if ( (*(&InputDelegation::CInputDelegationInfo::gInstance + 4) & 2) == 0 )
  {
    ...
    *(_QWORD *)&v15 = *(_QWORD *)(InputDestFromForegroundCapture + 112);
    ...
    if ( v51 == 2 )
      v25 = v50;
    if ( !v25 || (unsigned int)IsWindowDesktopComposed(v25) )
    {
...
LABEL_3:
    ...
    v22 = (v21 | *((_DWORD *)this + 817)) == 0;
    *((_DWORD *)this + 817) |= v21;
    if ( v22 )
      MicrosoftTelemetryAssertTriggeredNoArgsKM(v18, v17, v19);
    CMouseProcessor::MouseOwner::Set((CMouseProcessor *)((char *)this + 3272), a2);
    v20 = 1;
    goto LABEL_8;
  }
  return 1;
