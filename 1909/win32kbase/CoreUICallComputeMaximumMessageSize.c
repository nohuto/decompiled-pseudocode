/*
 * XREFs of CoreUICallComputeMaximumMessageSize @ 0x1C0090124
 * Callers:
 *     ?Initialize@RegistrarClient@CoreMessagingK@@SAXXZ @ 0x1C00A59A8 (-Initialize@RegistrarClient@CoreMessagingK@@SAXXZ.c)
 * Callees:
 *     ?ComputeMaximumMessageSize@SendProcessor@Calling@CoreMessaging@@QEAAJPEAUIMessageCallSendHost@@PEAPEBEIIIIPEAI@Z @ 0x1C00904E0 (-ComputeMaximumMessageSize@SendProcessor@Calling@CoreMessaging@@QEAAJPEAUIMessageCallSendHost@@P.c)
