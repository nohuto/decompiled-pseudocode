/*
 * XREFs of ?WriteSystemMetricsKey@CInputSystemMetrics@@AEBAXKW4tagHPD_REGISTRY_HIVE@@@Z @ 0x1C00A9284
 * Callers:
 *     ?Initialize@CInputSystemMetrics@@SAJXZ @ 0x1C00A91B0 (-Initialize@CInputSystemMetrics@@SAJXZ.c)
 *     ForceUpdatePointerDeviceSystemMetrics @ 0x1C00A9240 (ForceUpdatePointerDeviceSystemMetrics.c)
