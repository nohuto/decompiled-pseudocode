/*
 * XREFs of xxxUpdatePerUserAccessPackSettings @ 0x1C00604F0
 * Callers:
 *     <none>
 * Callees:
 ...
 *     ?CalculateMouseTable@@YAXXZ @ 0x1C0061A40 (-CalculateMouseTable@@YAXXZ.c)
 *     __security_check_cookie @ 0x1C00B7F30 (__security_check_cookie.c)
 *     ?MKShowMouseCursor@@YAXXZ @ 0x1C015C260 (-MKShowMouseCursor@@YAXXZ.c)
...
void __fastcall xxxUpdatePerUserAccessPackSettings(const UNICODE_STRING *a1)
{
  ...
  if ( (((unsigned __int8)gdwPUDFlags ^ (unsigned __int8)dword_1C021161C) & 1) == 0 )
  {
    if ( v3 )
      v27 = dword_1C021161C | 1;
    else
      v27 = dword_1C021161C & 0xFFFFFFFE;
    dword_1C021161C = v27;
  }
  if ( (dword_1C0211614 & 1) == (((unsigned int)gdwPUDFlags >> 1) & 1) )
  {
...
LABEL_64:
  v28 = gdwPUDFlags;
  if ( (((unsigned __int8)dword_1C02115F4 ^ (unsigned __int8)((unsigned int)gdwPUDFlags >> 2)) & 1) == 0 )
  {
    if ( v5 )
      v29 = dword_1C02115F4 | 1;
    else
      v29 = dword_1C02115F4 & 0xFFFFFFFE;
    dword_1C02115F4 = v29;
  }
  if ( (((unsigned __int8)dword_1C02115DC ^ (unsigned __int8)((unsigned int)gdwPUDFlags >> 3)) & 1) == 0 )
  {
    if ( v6 )
      v30 = dword_1C02115DC | 1;
    else
      v30 = dword_1C02115DC & 0xFFFFFFFE;
    dword_1C02115DC = v30;
  }
  if ( (((unsigned __int8)dword_1C02115E4 ^ (unsigned __int8)((unsigned int)gdwPUDFlags >> 4)) & 1) == 0 )
  {
    if ( v7 )
      v31 = dword_1C02115E4 | 1;
    else
      v31 = dword_1C02115E4 & 0xFFFFFFFE;
    dword_1C02115E4 = v31;
  }
  ...
  if ( (((unsigned __int8)dword_1C02115CC ^ (unsigned __int8)(v28 >> 7)) & 1) == 0 )
  {
    if ( v8 )
      v32 = dword_1C02115CC | 1;
    else
      v32 = dword_1C02115CC & 0xFFFFFFFE;
    dword_1C02115CC = v32;
  }
LABEL_22:
  ...
  FastGetProfileIntW((int)a1, 15, (int)L"AutoRepeatRate", 500, &dword_1C0211628, 0);
  FastGetProfileIntW((int)a1, 15, (int)L"AutoRepeatDelay", 1000, &dword_1C0211624, 0);
  FastGetProfileIntW((int)a1, 15, (int)L"BounceTime", 0, &dword_1C021162C, 0);
  FastGetProfileIntW((int)a1, 19, (int)L"Flags", 2, &dword_1C0214624, 0);
  FastGetProfileIntW((int)a1, 19, (int)L"FSTextEffect", 0, &dword_1C0214628, 0);
  FastGetProfileIntW((int)a1, 19, (int)L"WindowsEffect", 0, &dword_1C0214640, 0);
  ...
  *((_DWORD *)gpsi + 544) = (v17 >> 15) & 1;
  ...
  Value = v19;
  dword_1C02115F4 = v19;
  FastGetProfileIntW((int)a1, 16, (int)L"MaximumSpeed", 40, &dword_1C02115F8, 0);
  FastGetProfileIntW((int)a1, 16, (int)L"TimeToMaximumSpeed", 3000, &dword_1C02115FC, 0);
  if ( dword_1C02115F8 - 10 > 0x15E )
    dword_1C02115F8 = 40;
  if ( dword_1C02115FC - 1000 > 0xFA0 )
    dword_1C02115FC = 3000;
  CalculateMouseTable();
  gbMKMouseMode = ((dword_1C02115F4 & 0x80) != 0) ^ (((unsigned __int8)(1 << (2 * (gNumLockVk & 3) + 1)) & *((_BYTE *)&gafAsyncKeyState + ((unsigned __int64)(unsigned __int8)gNumLockVk >> 2))) != 0);
  if ( (dword_1C02115F4 & 1) != 0 )
    MKShowMouseCursor();
  else
    MKHideMouseCursor();
  ...
  FastGetProfileIntW((int)a1, 18, (int)L"TimeToWait", 300000, &dword_1C02115E8, 0);
  FastGetProfileIntW((int)a1, 29, (int)L"Flags", 82, &Value, 0);
  if ( (dword_1C02115CC & 1) != 0 )
    v22 = Value | 1;
  else
...
LABEL_51:
  ...
  FastGetProfileIntW((int)a1, 48, (int)L"On", 0, &dword_1C02115BC, 0);
  FastGetProfileIntW((int)a1, 48, (int)L"Locale", 0, &dword_1C02115C0, 0);
  AccessTimeOutReset();
