/*
 * XREFs of ?SetHeatMapColorHelper@CVisualMarshaler@DirectComposition@@QEAAJPEAVCApplicationChannel@2@PEBX_KPEA_N@Z @ 0x1C01A6CDC
 * Callers:
        ...
        bool *a5)
{
  ...
  if ( a4 == 16 )
  {
    v8 = *((_QWORD *)this + 31) - *a3;
    if ( !v8 )
      v8 = *((_QWORD *)this + 32) - a3[1];
    if ( v8 )
    {
      *((_DWORD *)this + 4) |= 0x40000u;
      v7 = 1;
      *(_OWORD *)((char *)this + 248) = *(_OWORD *)a3;
    }
  }
  else
  {
