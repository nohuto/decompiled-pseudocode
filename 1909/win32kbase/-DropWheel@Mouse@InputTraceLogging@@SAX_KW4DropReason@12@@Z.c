/*
 * XREFs of ?DropWheel@Mouse@InputTraceLogging@@SAX_KW4DropReason@12@@Z @ 0x1C018E8DC
 * Callers:
...
void InputTraceLogging::Mouse::DropWheel()
{
  ...
  if ( dword_1C020CB50 > 4u )
  {
    if ( TlgKeywordOn((TraceLoggingHProvider)&dword_1C020CB50, 0x40uLL) )
    {
      ...
      TlgWrite((TraceLoggingHProvider)&dword_1C020CB50, &unk_1C01E63A5, 0LL, 0LL, 4u, &pData);
    }
  }
}
