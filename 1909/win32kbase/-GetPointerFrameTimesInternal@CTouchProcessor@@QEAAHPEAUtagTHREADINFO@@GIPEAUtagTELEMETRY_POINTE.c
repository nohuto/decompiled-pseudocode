/*
 * XREFs of ?GetPointerFrameTimesInternal@CTouchProcessor@@QEAAHPEAUtagTHREADINFO@@GIPEAUtagTELEMETRY_POINTER_FRAME_TIMES@@@Z @ 0x1C0168AEC
 * Callers:
        ...
        struct tagTELEMETRY_POINTER_FRAME_TIMES *a5)
{
  ...
  if ( !ThreadPointerData )
  {
    ...
    {
      LOBYTE(v9) = 2;
      WPP_RECORDER_SF_D((_DWORD)gBaseLog, v9, 7, 323, (__int64)&WPP_dde6ae6ba4d53e169de0efe5dbb74602_Traceguids, v7);
    }
LABEL_7:
  ...
  if ( !(unsigned int)CTouchProcessor::GetPointerDataTimes(v5, ThreadPointerData, a4, a5) )
  {
    ...
    {
      LOBYTE(v9) = 2;
      WPP_RECORDER_SF_((_DWORD)gBaseLog, v9, 7, 324, (__int64)&WPP_dde6ae6ba4d53e169de0efe5dbb74602_Traceguids);
    }
    goto LABEL_7;
  }
  return 1LL;
