/*
 * XREFs of ?GetPointerDataTimes@CTouchProcessor@@QEAAH_KIPEAUtagTELEMETRY_POINTER_FRAME_TIMES@@@Z @ 0x1C0167E60
 * Callers:
...
LABEL_10:
    LOBYTE(v7) = 5;
    WPP_RECORDER_SF_(v10->DeviceExtension, v7, 7, v11, (__int64)&WPP_dde6ae6ba4d53e169de0efe5dbb74602_Traceguids);
LABEL_11:
