/*
 * XREFs of ?AddVisualChild@CApplicationChannel@DirectComposition@@QEAAJIIHI@Z @ 0x1C0013240
 * Callers:
        ...
        unsigned int a5)
{
  ...
  if ( v10 )
  {
    if ( !(*(unsigned __int8 (__fastcall **)(struct DirectComposition::CResourceMarshaler *, __int64))(*(_QWORD *)v10 + 120LL))(
            v10,
            189LL) )
    ...
    if ( !v12 || !(*(unsigned __int8 (__fastcall **)(__int64, __int64))(*(_QWORD *)v12 + 120LL))(v12, 189LL) )
      return (unsigned int)-1073741811;
    if ( !a5 )
      goto LABEL_16;
    v13 = a5 - 1;
    ...
    if ( v5 && (*(unsigned __int8 (__fastcall **)(__int64, __int64))(*(_QWORD *)v5 + 120LL))(v5, 189LL) )
    {
LABEL_16:
      v14 = (*(__int64 (__fastcall **)(struct DirectComposition::CResourceMarshaler *, DirectComposition::CApplicationChannel *, __int64, _QWORD, __int64, char *))(*(_QWORD *)v10 + 248LL))(
              v10,
              this,
              v12,
              a4,
