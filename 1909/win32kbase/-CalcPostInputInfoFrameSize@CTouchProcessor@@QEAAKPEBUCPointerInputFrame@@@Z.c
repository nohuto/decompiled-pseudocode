/*
 * XREFs of ?CalcPostInputInfoFrameSize@CTouchProcessor@@QEAAKPEBUCPointerInputFrame@@@Z @ 0x1C015F438
 * Callers:
 ...
 *     CalcPostInputInfoFrameSize @ 0x1C0174A70 (CalcPostInputInfoFrameSize.c)
 * Callees:
