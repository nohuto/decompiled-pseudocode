/*
 * XREFs of ?Create@CSharedReadScalarMarshaler@DirectComposition@@SAJPEBVCSharedSystemResource@2@PEAPEAV12@@Z @ 0x1C01C4070
 * Callers:
 *     CreateSharedReadScalarMarshaler @ 0x1C01C4230 (CreateSharedReadScalarMarshaler.c)
 * Callees:
