/*
 * XREFs of ?EtwCaptureStateCallback@@YAXXZ @ 0x1C0109E90
 * Callers:
...
void __fastcall EtwCaptureStateCallback(__int64 a1)
{
  ...
  *(_QWORD *)ActivityId_8.Data4 = 0LL;
    ...
    *(GUID *)(v44 + 28) = ActivityId_8;
    if ( dword_1C020CB50 > 6u )
    {
      if ( TlgKeywordOn((TraceLoggingHProvider)&dword_1C020CB50, 0x2000uLL) )
      {
        ...
        v51 = &ThreadId;
        v52 = 4LL;
        TlgWrite((TraceLoggingHProvider)&dword_1C020CB50, &unk_1C01E14C0, &ActivityId_8, 0LL, 3u, &v50);
        v11 = dword_1C020CB50;
      }
      if ( v11 > 6 && TlgKeywordOn((TraceLoggingHProvider)&dword_1C020CB50, 0x2000uLL) )
      {
        ...
        v54 = &v40;
        v55 = 4LL;
        TlgWrite((TraceLoggingHProvider)&dword_1C020CB50, &unk_1C01E14ED, &ActivityId_8, 0LL, 3u, &v53);
      }
    }
  }
  ...
  if ( (W32kEtwEnabledKeyword & 0x8000000000080000uLL) != 0
    && (unsigned __int8)(byte_1C020C438 - 1) > 2u
    && (qword_1C020C420 & 0x8000000000080000uLL) != 0
    && (qword_1C020C428 & 0x8000000000080000uLL) == qword_1C020C428 )
  {
    v32 = grpWinStaList;
