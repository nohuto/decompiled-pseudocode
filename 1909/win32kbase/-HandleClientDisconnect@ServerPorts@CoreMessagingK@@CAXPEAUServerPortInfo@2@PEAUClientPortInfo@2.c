/*
 * XREFs of ?HandleClientDisconnect@ServerPorts@CoreMessagingK@@CAXPEAUServerPortInfo@2@PEAUClientPortInfo@2@@Z @ 0x1C00A0ADC
 * Callers:
        ...
        struct CoreMessagingK::ClientPortInfo *a2)
{
  ...
  if ( dword_1C020C5E0 > 5u )
  {
    ...
    v17 = 4;
    v16 = (char *)a2 + 12;
    TlgWrite((TraceLoggingHProvider)&dword_1C020C5E0, &unk_1C01E8388, 0LL, 0LL, 6u, &pData);
  }
