/*
 * XREFs of McTemplateK0cpppqqq @ 0x1C010CCB8
 * Callers:
...
ULONG __fastcall McTemplateK0cpppqqq(
        ...
        char a10)
{
  ...
  EVENT_DATA_DESCRIPTOR EventData; // [rsp+50h] [rbp-69h] BYREF
  ...
  v26 = 4LL;
  v28 = 4LL;
  return McGenEventWrite(a1, &RetrieveInputMessage, (LPCGUID)&Context.Flags, 8u, &EventData);
}
