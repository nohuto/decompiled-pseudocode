/*
 * XREFs of ??0DCMEMOBJ@@QEAA@KHH@Z @ 0x1C0021470
 * Callers:
...
DCMEMOBJ *__fastcall DCMEMOBJ::DCMEMOBJ(DCMEMOBJ *this, __int64 a2, int a3)
{
  ...
  *((_DWORD *)this + 4) = 0;
  if ( (unsigned int)a2 > 2 )
    return this;
  LOBYTE(a2) = 1;
  v6 = (_QWORD *)HmgAlloc(2112LL, a2, 17LL);
  *(_QWORD *)this = v6;
  v7 = v6;
  if ( !v6 )
    return this;
  ...
  if ( v50 )
  {
          ...
          v20 == 5) )
    {
      TrackObjectReferenceIncrement(
        0,
        *(struct NSInstrumentation::CReferenceTracker::CReferenceCountedType::SCircularBuffer **)(v18 + 680));
    }
    else if ( v20 == 16 )
    {
