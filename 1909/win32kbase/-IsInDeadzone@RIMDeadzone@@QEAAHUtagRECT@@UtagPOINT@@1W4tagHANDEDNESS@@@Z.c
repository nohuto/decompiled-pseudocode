/*
 * XREFs of ?IsInDeadzone@RIMDeadzone@@QEAAHUtagRECT@@UtagPOINT@@1W4tagHANDEDNESS@@@Z @ 0x1C0158AE4
 * Callers:
 ...
 *     ?_IsAngleWithinRange@RIMDeadzone@@CAHKUtagRIMDEADZONE_RANGE@@@Z @ 0x1C0159078 (-_IsAngleWithinRange@RIMDeadzone@@CAHKUtagRIMDEADZONE_RANGE@@@Z.c)
...
__int64 __fastcall RIMDeadzone::IsInDeadzone(__int64 a1, _DWORD *a2, __int64 a3, __int64 a4, int a5)
{
  ...
  __int64 v22; // rcx
  __int64 v23; // r8
  struct tagPOINT v24; // [rsp+20h] [rbp-58h]
  struct tagPOINT v25; // [rsp+80h] [rbp+8h]
  unsigned int Angle; // [rsp+80h] [rbp+8h]
  int v28; // [rsp+94h] [rbp+1Ch]
  int v29; // [rsp+9Ch] [rbp+24h]
  ...
  v12 = *((_DWORD *)v5 + 8);
  v13 = 0;
  v14 = (v8 / 100 - v7 / 100) * (v8 / 100 - v7 / 100) + (v28 / 100 - v29 / 100) * (v28 / 100 - v29 / 100);
  if ( v12 )
  {
    v15 = *((_QWORD *)v5 + 3);
    while ( 1 )
