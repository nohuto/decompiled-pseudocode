/*
 * XREFs of ?DropInput@Pointer@InputTraceLogging@@SAXPEBUCPointerInputFrame@@PEBUtagPOINTEREVENTINT@@W4DropReason@12@@Z @ 0x1C0164284
 * Callers:
...
void InputTraceLogging::Pointer::DropInput()
{
  ...
  if ( dword_1C020CB50 > 4u && TlgKeywordOn((TraceLoggingHProvider)&dword_1C020CB50, 0x20uLL) )
  {
    ...
    TlgWrite((TraceLoggingHProvider)&dword_1C020CB50, &unk_1C01E4EBE, 0LL, 0LL, 6u, &pData);
  }
}
