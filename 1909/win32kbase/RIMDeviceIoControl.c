/*
 * XREFs of RIMDeviceIoControl @ 0x1C0055DE0
 * Callers:
        ...
        int a12)
{
  ...
  {
    LOBYTE(a2) = 4;
    WPP_RECORDER_SF_((_DWORD)gRimLog, a2, 1, 132, (__int64)&WPP_2d6ecbd811d03edf33b26cf20b4442f4_Traceguids);
  }
  v29 = 0LL;
  Object = 0LL;
  if ( a12 == 1 )
  ...
  if ( Status >= 0 )
  {
    ...
    {
      Status = RawInputManagerDeviceObjectResolveHandle(v13, 3LL, 1LL, &Object);
      v20 = 0;
      if ( Status >= 0 )
      {
        v21 = Object;
