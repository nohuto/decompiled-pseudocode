/*
 * XREFs of McTemplateK0qqhhh @ 0x1C010E56C
 * Callers:
...
ULONG __fastcall McTemplateK0qqhhh(
        ...
        char a8)
{
  ...
  v18 = &a8;
  v19 = 2LL;
  return McGenEventWrite(a1, &PowerDisplayEvent, (LPCGUID)&Context.Flags, 6u, &EventData);
}
