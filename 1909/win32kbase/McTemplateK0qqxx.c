/*
 * XREFs of McTemplateK0qqxx @ 0x1C010F024
 * Callers:
 *     EtwGdiSysMemToken @ 0x1C0097640 (EtwGdiSysMemToken.c)
 *     EtwTraceTokenIndependentFlipSkipCompleteEvent @ 0x1C010BC80 (EtwTraceTokenIndependentFlipSkipCompleteEvent.c)
 * Callees:
