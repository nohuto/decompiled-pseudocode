/*
 * XREFs of ?RimDevicePointerData@RIM@InputTraceLogging@@SAXPEBURIMDEV@@@Z @ 0x1C0132814
 * Callers:
...
void __fastcall InputTraceLogging::RIM::RimDevicePointerData(const struct RIMDEV *a1)
{
  ...
  if ( dword_1C020CB50 > 4u )
  {
    if ( TlgKeywordOn((TraceLoggingHProvider)&dword_1C020CB50, 0x100uLL) )
    {
      ...
      TlgWrite((TraceLoggingHProvider)&dword_1C020CB50, &unk_1C01E22FC, 0LL, 0LL, 0x37u, &pData);
    }
  }
}
