/*
 * XREFs of ?Free@?$CTypeIsolation@$0NPAAA@$0NPA@@NSInstrumentation@@IEAAXPEAX@Z @ 0x1C0122154
 * Callers:
 ...
 *     ?CheckAllocationStatus@?$CSectionBitmapAllocator@$0NPAAA@$0NPA@@NSInstrumentation@@QEAA?AW4AllocationStatus@2@PEBX@Z @ 0x1C0098E78 (-CheckAllocationStatus@-$CSectionBitmapAllocator@$0NPAAA@$0NPA@@NSInstrumentation@@QEAA-AW4Alloc.c)
...
void __fastcall NSInstrumentation::CTypeIsolation<913408,3568>::Free(__int64 a1, struct _SLIST_ENTRY *a2)
{
  ...
  if ( a2 )
  {
    if ( !*(_BYTE *)(a1 + 36) )
    {
      ...
      for ( i = *(_QWORD **)a1; ; i = (_QWORD *)*i )
      {
        ...
        v6 = (__int64 *)i[4];
        v7 = NSInstrumentation::CSectionBitmapAllocator<913408,3568>::CheckAllocationStatus(v6, (unsigned __int64)a2);
        if ( v7 )
        {
          v8 = v7 - 1;
          if ( !v8 )
