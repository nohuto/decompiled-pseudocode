/*
 * XREFs of ?bMerge@RGNOBJ@@QEAAHAEAV1@0E@Z @ 0x1C0023310
 * Callers:
...
LABEL_4:
  ...
  if ( gulGdiHmgrTraceObjectType == 4 )
    ...
    v8 = 0;
  if ( dword_1C02119A0 >= v34 )
  {
    v35 = Win32AllocateFromPagedLookasideList(qword_1C02128D0);
    if ( v35 )
    {
      *(_QWORD *)v35 = 0LL;
      *(_QWORD *)(v35 + 8) = 0LL;
