/*
 * XREFs of McTemplateK0dddd @ 0x1C010D258
 * Callers:
 *     EtwTraceTouchTargetingOffset @ 0x1C010C0B0 (EtwTraceTouchTargetingOffset.c)
 * Callees:
 *     McGenEventWrite @ 0x1C0058898 (McGenEventWrite.c)
 *     __security_check_cookie @ 0x1C00B7F30 (__security_check_cookie.c)
 */

ULONG __fastcall McTemplateK0dddd(
        ...
        char a7)
{
  ...
  v16 = 4LL;
  v15 = &a7;
  return McGenEventWrite(a1, &TouchTargetingOffset, (LPCGUID)&Context.Flags, 5u, &EventData);
}
