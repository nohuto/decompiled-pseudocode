/*
 * XREFs of ?DestroyHandle@CConnection@DirectComposition@@SAJPEAUHDCOMPOSITIONCONNECTION__@@@Z @ 0x1C006D2F0
 * Callers:
 ...
 *     NtDCompositionDestroyConnection @ 0x1C01A0150 (NtDCompositionDestroyConnection.c)
 * Callees:
