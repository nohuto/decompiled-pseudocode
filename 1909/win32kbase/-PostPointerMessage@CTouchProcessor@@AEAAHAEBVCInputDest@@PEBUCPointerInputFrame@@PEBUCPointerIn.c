/*
 * XREFs of ?PostPointerMessage@CTouchProcessor@@AEAAHAEBVCInputDest@@PEBUCPointerInputFrame@@PEBUCPointerInfoNode@@_KIKHH@Z @ 0x1C016D44C
 * Callers:
 ...
 * Callees:
 *     CheckAccess @ 0x1C002BDB0 (CheckAccess.c)
 ...
 *     flagString @ 0x1C01748B0 (flagString.c)
 *     messageString @ 0x1C01749AC (messageString.c)
 *     WPP_RECORDER_SF_LsHHsLLLL @ 0x1C0175090 (WPP_RECORDER_SF_LsHHsLLLL.c)
 *     GetPointerInputSource @ 0x1C01846B0 (GetPointerInputSource.c)
...
LABEL_19:
    ...
    {
      LOBYTE(v34) = 4;
      WPP_RECORDER_SF_((_DWORD)gBaseLog, v34, 7, 284, (__int64)&WPP_dde6ae6ba4d53e169de0efe5dbb74602_Traceguids);
    }
  ...
  else
  {
    ...
    {
      LOBYTE(v24) = 3;
      WPP_RECORDER_SF_((_DWORD)gBaseLog, v24, 7, 282, (__int64)&WPP_dde6ae6ba4d53e169de0efe5dbb74602_Traceguids);
    }
