/*
 * XREFs of ?EmitOptions@CVisualMarshaler@DirectComposition@@IEAA_NPEAPEAVCBatch@2@@Z @ 0x1C000A448
 * Callers:
        ...
        struct DirectComposition::CBatch **a2)
{
  ...
  if ( DirectComposition::CBatch::EnsureBatchBuffer(a2, 0x10uLL, &v5) )
  {
    ...
    *((_DWORD *)v4 + 2) = *((_DWORD *)this + 6);
    v4[12] = (*((_BYTE *)this + 272) & 0x10) != 0;
    v4[13] = (*((_BYTE *)this + 272) & 8) != 0;
    v4[14] = (*((_BYTE *)this + 272) & 0x40) != 0;
    v4[15] = (*((_BYTE *)this + 273) & 2) != 0;
