/*
 * XREFs of ?Process2FingerTap@CPTPEngine@@AEAAHPEAUPTPInput@@H@Z @ 0x1C0194BE0
 * Callers:
...
LABEL_46:
  ...
  if ( v4 == 1 )
  {
    if ( (v13 & 0x40000) != 0 && (*((_DWORD *)this + 814) & 1) == a3 )
    {
                                                                                            ...
                                                                                            / 0x3E8) )
      {
        ...
        *((_DWORD *)this + 814) = v17;
        ...
        v20 = (int)((HIDWORD(v19) - HIDWORD(*((_QWORD *)this + 381)))
                  * (HIDWORD(v19) - HIDWORD(*((_QWORD *)this + 381)))
                  + (v19 - *((_QWORD *)this + 381)) * (v19 - *((_QWORD *)this + 381))) <= (unsigned __int64)*((unsigned int *)this + 74);
        goto LABEL_20;
      }
    }
    if ( (v13 & 0x20000) != 0 && (*((_DWORD *)this + 814) & 1) == a3 )
    {
  ...
  *((_DWORD *)this + 814) = v14 & 0xFFFFDFFF;
  return 0LL;
}
