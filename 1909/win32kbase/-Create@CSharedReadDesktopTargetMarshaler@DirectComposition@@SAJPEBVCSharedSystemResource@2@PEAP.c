/*
 * XREFs of ?Create@CSharedReadDesktopTargetMarshaler@DirectComposition@@SAJPEBVCSharedSystemResource@2@PEAPEAV12@@Z @ 0x1C01C43D8
 * Callers:
 *     CreateSharedReadDesktopTargetMarshaler @ 0x1C01C4490 (CreateSharedReadDesktopTargetMarshaler.c)
 * Callees:
