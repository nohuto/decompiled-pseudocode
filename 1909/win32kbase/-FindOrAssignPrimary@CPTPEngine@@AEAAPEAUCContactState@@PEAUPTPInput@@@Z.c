/*
 * XREFs of ?FindOrAssignPrimary@CPTPEngine@@AEAAPEAUCContactState@@PEAUPTPInput@@@Z @ 0x1C01946F4
 * Callers:
...
struct CContactState *__fastcall CPTPEngine::FindOrAssignPrimary(CPTPEngine *this, struct PTPInput *a2)
{
  ...
  if ( v2 )
  {
    ...
    do
    {
      v8 = *((_DWORD *)this + 74 * (*(v7 - 2) % v6) + 290);
      if ( (v8 & 1) != 0 && (v8 & 0x400) == 0 )
      {
        if ( (*v7 & 0x2000) != 0 )
          return (CPTPEngine *)((char *)this + 296 * (*(v7 - 2) % v6) + 1160);
        if ( !v4 )
          v4 = (_DWORD *)((char *)this + 296 * (*(v7 - 2) % v6) + 1160);
      }
      ++v5;
      v7 += 24;
    }
