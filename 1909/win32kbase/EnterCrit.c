/*
 * XREFs of EnterCrit @ 0x1C0026390
 * Callers:
  ...
  if ( InputTraceLogging::Perf::s_userCritLoggingEnabled && v34 && (*(_DWORD *)(v34 + 48) || *(int *)(v34 + 24) > 0) )
  {
    ...
    *(GUID *)(v34 + 28) = ActivityId;
    if ( dword_1C020CB50 > 6u )
    {
      ...
      if ( v25 > 6 && TlgKeywordOn((TraceLoggingHProvider)&dword_1C020CB50, 0x2000uLL) )
      {
        v33 = v35;
        v44 = &v33;
        v45 = 4LL;
        TlgWrite((TraceLoggingHProvider)&dword_1C020CB50, &unk_1C01E14ED, &ActivityId, 0LL, 3u, &v43);
      }
    }
  }
