/*
 * XREFs of xxxUserChangeDisplaySettings @ 0x1C0046620
 * Callers:
 ...
 *     _xxxUserChangeDisplaySettings_::_2_::_AUTO_KM::__AUTO_KM @ 0x1C0046F1C (_xxxUserChangeDisplaySettings_--_2_--_AUTO_KM--__AUTO_KM.c)
...
LABEL_20:
  ...
  if ( v19 )
  {
    ...
    *(_DWORD *)(v21 + 52) = v18;
    ...
    ((void (__fastcall *)(__int64, __int64, char *))qword_1C0212140)(v21, v25, v20);
    v58 = MEMORY[0xFFFFF78000000320];
    v54 = v58 * KeQueryTimeIncrement();
    EtwActivityIdControl(3u, &ActivityId);
    v30 = dword_1C020C458;
    if ( dword_1C020C458 > 5u && TlgKeywordOn((TraceLoggingHProvider)&dword_1C020C458, 0x200000000004uLL) )
    {
      ...
      v94 = &v33;
      v95 = 1LL;
      TlgWrite((TraceLoggingHProvider)&dword_1C020C458, &unk_1C01E186E, &ActivityId, 0LL, 9u, &pData);
      v30 = dword_1C020C458;
    }
    if ( (*(_DWORD *)(v21 + 140) & 1) != 0 && v30 > 5 )
    {
      if ( TlgKeywordOn((TraceLoggingHProvider)&dword_1C020C458, 0x200000000004uLL) )
      {
        v43 = *(_DWORD *)(v21 + 64);
        v62 = &v43;
        v63 = 4LL;
        ...
        v80 = &v52;
        v81 = 4LL;
        TlgWrite((TraceLoggingHProvider)&dword_1C020C458, &unk_1C01E17E1, &ActivityId, 0LL, 0xCu, &v61);
      }
    }
    Win32FreePool(v21);
  }
