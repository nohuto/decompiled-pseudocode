/*
 * XREFs of ?GetPointerFrameDataWithHistory@CTouchProcessor@@QEAAH_KKHKPEAI1PEAE@Z @ 0x1C0168670
 * Callers:
...
LABEL_20:
    LOBYTE(v15) = 5;
    WPP_RECORDER_SF_(v16->DeviceExtension, v15, 7, v17, (__int64)&WPP_dde6ae6ba4d53e169de0efe5dbb74602_Traceguids);
LABEL_21:
    PointerFrameData = 0;
    goto LABEL_48;
  }
