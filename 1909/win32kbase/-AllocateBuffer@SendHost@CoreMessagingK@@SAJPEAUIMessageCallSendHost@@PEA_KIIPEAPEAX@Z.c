/*
 * XREFs of ?AllocateBuffer@SendHost@CoreMessagingK@@SAJPEAUIMessageCallSendHost@@PEA_KIIPEAPEAX@Z @ 0x1C0049670
 * Callers:
 *     <none>
 * Callees:
        ...
        void **a5)
{
  ...
  *a5 = 0LL;
  ...
  v8 = v6 + 80;
  v9 = CoreMessagingK::BufferCache::AllocUninitialized<AlpcBufferK>(v8, &a5);
  if ( v9 >= 0 )
  {
    v11 = v8;
    v12 = a5;
