/*
 * XREFs of ?SetReferenceArrayProperty@CRenderTargetGroupMarshaler@DirectComposition@@UEAAJPEAVCApplicationChannel@2@IPEAPEAVCResourceMarshaler@2@_KPEA_N@Z @ 0x1C009F8B0
 * Callers:
 *     <none>
 * Callees:
