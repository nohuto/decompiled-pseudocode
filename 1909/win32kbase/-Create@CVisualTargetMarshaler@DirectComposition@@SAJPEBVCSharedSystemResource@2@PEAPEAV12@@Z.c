/*
 * XREFs of ?Create@CVisualTargetMarshaler@DirectComposition@@SAJPEBVCSharedSystemResource@2@PEAPEAV12@@Z @ 0x1C008D5D0
 * Callers:
 *     CreateVisualTargetMarshaler @ 0x1C008D580 (CreateVisualTargetMarshaler.c)
 * Callees:
