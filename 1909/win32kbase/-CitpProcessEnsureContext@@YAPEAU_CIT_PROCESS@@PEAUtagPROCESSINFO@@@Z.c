/*
 * XREFs of ?CitpProcessEnsureContext@@YAPEAU_CIT_PROCESS@@PEAUtagPROCESSINFO@@@Z @ 0x1C00366D0
 * Callers:
 ...
 *     ?CitpDPGetAppIndex@@YAIPEAU_CIT_PROCESS@@@Z @ 0x1C008D6A4 (-CitpDPGetAppIndex@@YAIPEAU_CIT_PROCESS@@@Z.c)
...
struct _CIT_PROCESS *__fastcall CitpProcessEnsureContext(struct _CIT_PROCESS **a1)
{
  ...
  if ( CitpProcessInfoIsValid(a1[115]) )
  ...
  if ( !v4 )
  {
    a1[115] = (struct _CIT_PROCESS *)52976;
    CitpLogFailureWorker(-1073741670, v5, 0xF4Bu);
    return 0LL;
  }
  memset(v4, 0, 0x60uLL);
