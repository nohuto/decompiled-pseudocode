/*
 * XREFs of ?ivSendSettingsUpdateToContainer@@YAXAEBUCONTAINER_ID@@@Z @ 0x1C018586C
 * Callers:
...
void __fastcall ivSendSettingsUpdateToContainer(const struct CONTAINER_ID *a1)
{
  ...
  if ( v10 )
  {
    ...
    *(_DWORD *)(v2 + 16) = qword_1C0210A18;
    *(_DWORD *)(v2 + 20) = WORD6(gTouchPadParameters) & 0x7FF | ((*(_BYTE *)(&qword_1C0210A18 + 1) & 0x7F) << 11);
