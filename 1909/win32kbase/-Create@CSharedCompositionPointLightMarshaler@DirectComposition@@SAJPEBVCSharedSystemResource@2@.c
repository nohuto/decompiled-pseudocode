/*
 * XREFs of ?Create@CSharedCompositionPointLightMarshaler@DirectComposition@@SAJPEBVCSharedSystemResource@2@PEAPEAV12@@Z @ 0x1C01C4D60
 * Callers:
 *     CreateSharedCompositionPointLightMarshaler @ 0x1C01C4F00 (CreateSharedCompositionPointLightMarshaler.c)
 * Callees:
