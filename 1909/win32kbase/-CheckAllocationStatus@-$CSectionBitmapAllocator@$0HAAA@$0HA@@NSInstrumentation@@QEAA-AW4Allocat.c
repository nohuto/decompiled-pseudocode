/*
 * XREFs of ?CheckAllocationStatus@?$CSectionBitmapAllocator@$0HAAA@$0HA@@NSInstrumentation@@QEAA?AW4AllocationStatus@2@PEBX@Z @ 0x1C00BA1C4
 * Callers:
  ...
  if ( v6 == 112 * v8 )
    return 2
         - (unsigned int)(RtlTestBit(
                            (PRTL_BITMAP)(v2 ^ a1[3]),
                            v8 + 36 * ((v3 - ((unsigned int)v2 ^ *((_DWORD *)a1 + 2))) >> 12)) != 0);
  else
    return 3LL;
}
