/*
 * XREFs of ?LogDeviceRemovedEvent@CHidInput@@AEAAXGIIKKHPEAU_UNICODE_STRING@@0@Z @ 0x1C017C830
 * Callers:
...
void __fastcall CHidInput::LogDeviceRemovedEvent(
        CHidInput *this,
        __int64 a2,
        int a3,
        int a4,
        ...
        struct _UNICODE_STRING *a9)
{
  ...
  if ( hProvider > 5u )
  {
    if ( TlgKeywordOn((TraceLoggingHProvider)&hProvider, 0x800000000000uLL) )
    {
      ...
      v29 = 2LL;
      v31[1] = 0;
      TlgWrite((TraceLoggingHProvider)&hProvider, &unk_1C01E553D, 0LL, 0LL, 0xCu, &pData);
    }
  }
}
