/*
 * XREFs of ?ProcessInput@CKeyboardProcessor@@QEAA?AW4InputProcessingResult@@PEAUDEVICEINFO@@PEAU_KEYBOARD_INPUT_DATA@@K_N@Z @ 0x1C017AEA0
 * Callers:
    ...
    *(GUID *)(v47 + 28) = ActivityId;
    if ( dword_1C020CB50 > 6u )
    {
      ...
      if ( v18 > 6 && TlgKeywordOn((TraceLoggingHProvider)&dword_1C020CB50, 0x2000uLL) )
      {
        ...
        v59 = &v45;
        v60 = 4;
        TlgWrite((TraceLoggingHProvider)&dword_1C020CB50, &unk_1C01E14ED, &ActivityId, 0LL, 3u, &v58);
      }
    }
  }
