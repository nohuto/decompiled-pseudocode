/*
 * XREFs of ?CommitFrame@Pointer@InputTraceLogging@@SAXPEBURIMDEV@@PEBUCPointerInputFrame@@@Z @ 0x1C0160D04
 * Callers:
...
void __fastcall InputTraceLogging::Pointer::CommitFrame(const struct RIMDEV *a1, const struct CPointerInputFrame *a2)
{
    ...
    if ( (unsigned int)(v2 - 5) > 1 )
    {
      if ( v2 == 7 )
      {
        if ( dword_1C020CB50 > 4u && TlgKeywordOn((TraceLoggingHProvider)&dword_1C020CB50, 0x20uLL) )
        {
          ...
          v26 = v9;
          v28 = v9;
          TlgWrite((TraceLoggingHProvider)&dword_1C020CB50, &unk_1C01E4A74, 0LL, 0LL, 7u, &pData);
        }
      }
      else if ( dword_1C020CB50 > 4u && TlgKeywordOn((TraceLoggingHProvider)&dword_1C020CB50, 0x20uLL) )
      {
        ...
        v26 = v12;
        v28 = v12;
        TlgWrite((TraceLoggingHProvider)&dword_1C020CB50, &unk_1C01E4AD1, 0LL, 0LL, 7u, &pData);
      }
    }
    else if ( dword_1C020CB50 > 4u && TlgKeywordOn((TraceLoggingHProvider)&dword_1C020CB50, 0x20uLL) )
    {
      ...
      v26 = v6;
      v28 = v6;
      TlgWrite((TraceLoggingHProvider)&dword_1C020CB50, &unk_1C01E4A17, 0LL, 0LL, 7u, &pData);
    }
  }
  else if ( dword_1C020CB50 > 4u )
  {
    if ( TlgKeywordOn((TraceLoggingHProvider)&dword_1C020CB50, 0x20uLL) )
    {
      ...
      v26 = v3;
      v28 = v3;
      TlgWrite((TraceLoggingHProvider)&dword_1C020CB50, &unk_1C01E49B8, 0LL, 0LL, 7u, &pData);
    }
  }
}
