/*
 * XREFs of McTemplateK0ppxq @ 0x1C010DE20
 * Callers:
 *     EtwTraceDITResolveDCompInputHandleToHwnd @ 0x1C0002C30 (EtwTraceDITResolveDCompInputHandleToHwnd.c)
 * Callees:
 *     McGenEventWrite @ 0x1C0058898 (McGenEventWrite.c)
 *     __security_check_cookie @ 0x1C00B7F30 (__security_check_cookie.c)
 */

ULONG McTemplateK0ppxq(struct _MCGEN_TRACE_CONTEXT *a1, __int64 a2, __int64 a3, ...)
{
  ...
  v12 = 4LL;
  va_copy(v11, va3);
  return McGenEventWrite(a1, &DITResolveDCompInputHandleToHwnd, (LPCGUID)&Context.Flags, 5u, &EventData);
}
