/*
 * XREFs of ?UpdateDisplayState@@YAXW4_MONITOR_DISPLAY_STATE@@W4POWER_MONITOR_REQUEST_REASON@@HH@Z @ 0x1C00B13C0
 * Callers:
...
void __fastcall UpdateDisplayState(unsigned int a1, enum POWER_MONITOR_REQUEST_REASON a2, char a3)
{
  ...
  else
  {
    ...
    {
      LODWORD(qword_1C02127DC) = 1;
    }
    else
    {
      LODWORD(qword_1C02127DC) = 0;
  ...
  BYTE5(v45) = v8;
  BYTE6(v45) = a3;
  if ( gPowerTransitionsState || (_DWORD)qword_1C02127DC || (HIBYTE(v45) = 0, HIDWORD(qword_1C02127DC)) )
    HIBYTE(v45) = 1;
  ZwPowerInformation(SessionDisplayState, &InputBuffer, 0x10u, 0LL, 0);
  if ( gSystemIsAoAc )
  {
    if ( (gPowerTransitionsState || qword_1C02127DC) && !HIDWORD(qword_1C02127DC) )
      v32 = 0LL;
    else
      v32 = 2LL;
    SetInputMode(v32);
