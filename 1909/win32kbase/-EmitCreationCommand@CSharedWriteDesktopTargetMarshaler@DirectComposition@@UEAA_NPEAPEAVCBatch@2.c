/*
 * XREFs of ?EmitCreationCommand@CSharedWriteDesktopTargetMarshaler@DirectComposition@@UEAA_NPEAPEAVCBatch@2@@Z @ 0x1C0005E00
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall DirectComposition::CSharedWriteDesktopTargetMarshaler::EmitCreationCommand(
