/*
 * XREFs of ?bInit@BEZIER32@@QEAAHPEAU_POINTFIX@@PEAU_RECTFX@@@Z @ 0x1C0078BE0
 * Callers:
 *     ?pprFlattenRec@EPATHOBJ@@IEAAPEAU_PATHRECORD@@PEAU2@@Z @ 0x1C0078750 (-pprFlattenRec@EPATHOBJ@@IEAAPEAU_PATHRECORD@@PEAU2@@Z.c)
 * Callees:
 *     ?vSteadyState@HFDBASIS32@@QEAAXJ@Z @ 0x1C0078E70 (-vSteadyState@HFDBASIS32@@QEAAXJ@Z.c)
 *     ?vBoundBox@@YAXPEAU_POINTFIX@@PEAU_RECTFX@@@Z @ 0x1C0078EA4 (-vBoundBox@@YAXPEAU_POINTFIX@@PEAU_RECTFX@@@Z.c)
 *     ?bIntersect@@YA_NPEAU_RECTFX@@0@Z @ 0x1C0124994 (-bIntersect@@YA_NPEAU_RECTFX@@0@Z.c)
 */
  ...
  *((_DWORD *)this + 8) = 6144 * (v17 + v15 - 2 * v18);
  if ( !a3 || bIntersect(v4, a3) )
  {
    while ( 1 )
    {
      ...
      *((_DWORD *)this + 3) = v37;
      *((_DWORD *)this + 2) = (*((_DWORD *)this + 2) - (v37 >> v7)) >> 1;
      v38 = *((_DWORD *)this + 6);
      v39 = (*((_DWORD *)this + 7) + *((_DWORD *)this + 8)) >> 1;
      *((_DWORD *)this + 7) = v39;
      *((_DWORD *)this + 6) = (v38 - (v39 >> v7)) >> 1;
      *(_DWORD *)this *= 2;
    }
  }
