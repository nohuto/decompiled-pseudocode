/*
 * XREFs of ?RimDevice@RIM@InputTraceLogging@@SAXPEBURIMDEV@@K@Z @ 0x1C0058A7C
 * Callers:
...
void __fastcall InputTraceLogging::RIM::RimDevice(const struct RIMDEV *a1)
{
  ...
  if ( TraceLoggingProviderEnabled((TraceLoggingHProvider)&dword_1C020CB50, 0, 0LL) )
  {
    if ( dword_1C020CB50 > 4u && TlgKeywordOn((TraceLoggingHProvider)&dword_1C020CB50, 0x100uLL) )
    {
      ...
      v19 = v16;
      v52 = 8LL;
      TlgWrite((TraceLoggingHProvider)&dword_1C020CB50, &unk_1C01E26B2, 0LL, 0LL, 0x14u, &pData);
    }
