/*
 * XREFs of ?CitpPostUpdateUseInfoLoad@@YAJPEAU_CIT_IMPACT_CONTEXT@@@Z @ 0x1C0081B44
 * Callers:
...
LABEL_17:
  ...
  CIT_USER_ACTIVE_TRACKER::CalculateUpToTime((struct _CIT_IMPACT_CONTEXT *)((char *)a1 + 192), v21);
  v22 = *((_QWORD *)a1 + 26);
  v23 = (unsigned int)dword_1C02157EC;
  v24 = (unsigned int)v22 + 1000LL * *(unsigned int *)&v55[6];
  *((_DWORD *)a1 + 134) = v21;
  v25 = v24 % v23;
  v26 = *(_DWORD *)&v55[56];
  *((_DWORD *)a1 + 135) = v22 - v25;
