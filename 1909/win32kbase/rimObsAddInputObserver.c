/*
 * XREFs of rimObsAddInputObserver @ 0x1C015735C
 * Callers:
 *     NtRIMAddInputObserver @ 0x1C0133AC0 (NtRIMAddInputObserver.c)
 *     RIMAddInputObserver @ 0x1C01350C0 (RIMAddInputObserver.c)
 * Callees:
 ...
 *     RawInputManagerInputObserverObjectResolveHandle @ 0x1C01455EC (RawInputManagerInputObserverObjectResolveHandle.c)
