/*
 * XREFs of ?Create@CSharedWriteAnimationTriggerMarshaler@DirectComposition@@SAJPEBVCSharedSystemResource@2@PEAPEAV12@@Z @ 0x1C0004068
 * Callers:
 *     CreateSharedWriteAnimationTriggerMarshaler @ 0x1C0004030 (CreateSharedWriteAnimationTriggerMarshaler.c)
 * Callees:
