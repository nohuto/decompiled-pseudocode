/*
 * XREFs of ?GetItemForWrite@CMouseQueue@CMouseProcessor@@QEAAPEAURawMouseEvent@2@_N@Z @ 0x1C0031258
 * Callers:
        ...
        __int64 a3)
{
  ...
  if ( !(_BYTE)a2 )
  {
    this = (CMouseProcessor::CMouseQueue *)*((unsigned __int16 *)this + 1281);
    v4 = (_WORD)this == 16;
    if ( (unsigned __int16)this > 0x10u )
    {
      MicrosoftTelemetryAssertTriggeredNoArgsKM(this, a2, a3);
      this = (CMouseProcessor::CMouseQueue *)*((unsigned __int16 *)v3 + 1281);
      v4 = (_WORD)this == 16;
    }
    if ( v4 )
      return 0LL;
    LOWORD(this) = (_WORD)this + 1;
    *((_WORD *)v3 + 1280) = ((unsigned __int8)*((_WORD *)v3 + 1280) + 1) & 0xF;
    *((_WORD *)v3 + 1281) = (_WORD)this;
  }
  if ( *((_WORD *)v3 + 1281) > 0x10u )
    MicrosoftTelemetryAssertTriggeredNoArgsKM(this, a2, a3);
  return (CMouseProcessor::CMouseQueue *)((char *)v3 + 160 * *((unsigned __int16 *)v3 + 1280));
}
