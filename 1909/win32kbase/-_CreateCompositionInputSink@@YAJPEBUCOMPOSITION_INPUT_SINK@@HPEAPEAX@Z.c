/*
 * XREFs of ?_CreateCompositionInputSink@@YAJPEBUCOMPOSITION_INPUT_SINK@@HPEAPEAX@Z @ 0x1C008855C
 * Callers:
 *     NtCreateImplicitCompositionInputSink @ 0x1C0088520 (NtCreateImplicitCompositionInputSink.c)
 *     NtCreateCompositionInputSink @ 0x1C0088540 (NtCreateCompositionInputSink.c)
 * Callees:
