/*
 * XREFs of DrvFunctionalizeDisplayConfig @ 0x1C012B584
 * Callers:
 ...
 *     ?AllocatePathModalityForDisplayConfig@@YAJIPEAUDISPLAYCONFIG_PATH_INFO_INTERNAL@@PEAPEAUD3DKMT_GETPATHSMODALITY@@@Z @ 0x1C0126838 (-AllocatePathModalityForDisplayConfig@@YAJIPEAUDISPLAYCONFIG_PATH_INFO_INTERNAL@@PEAPEAUD3DKMT_G.c)
 *     ?ConvertDisplayConfigToPathModality@@YAJIPEBUDISPLAYCONFIG_PATH_INFO_INTERNAL@@PEAUD3DKMT_GETPATHSMODALITY@@PEA_N@Z @ 0x1C0126E40 (-ConvertDisplayConfigToPathModality@@YAJIPEBUDISPLAYCONFIG_PATH_INFO_INTERNAL@@PEAUD3DKMT_GETPAT.c)
        ...
        int a6)
{
  ...
  v15 = *a1;
  v28[0] = (struct D3DKMT_GETPATHSMODALITY *)&off_1C01D1F30;
  *(_OWORD *)v29 = 0LL;
  a6 = v6 & 1;
  if ( (v6 & 1) != 0 )
  {
...
LABEL_21:
  ...
  if ( PathModalityForDisplayConfig >= 0 )
  {
    if ( a4 )
    {
      PathModalityForDisplayConfig = ((__int64 (__fastcall *)(__int64, __int64, struct D3DKMT_GETPATHSMODALITY **))qword_1C0212300)(
                                       a4,
                                       0x20000LL,
                                       &v29[1]);
      if ( PathModalityForDisplayConfig < 0 )
    ...
    if ( a6 )
    {
      ...
      v26 = ((__int64 (__fastcall *)(_QWORD, struct D3DKMT_GETPATHSMODALITY *, _QWORD, char *, char *))qword_1C02122F0)(
              v22,
              v24,
              v23,
              (char *)v8 - 176,
    ...
    {
      PathModalityForDisplayConfig = ((__int64 (__fastcall *)(_QWORD, struct D3DKMT_GETPATHSMODALITY *))qword_1C02120A8)(
                                       v22 | 0x8000,
                                       v29[0]);
      if ( PathModalityForDisplayConfig < 0 )
        goto LABEL_35;
      ...
      v26 = ((__int64 (__fastcall *)(struct D3DKMT_GETPATHSMODALITY *, unsigned int *, struct DISPLAYCONFIG_PATH_INFO_INTERNAL *, __int64))qword_1C02122D0)(
              v29[0],
              a1,
              v8,
              a5);
