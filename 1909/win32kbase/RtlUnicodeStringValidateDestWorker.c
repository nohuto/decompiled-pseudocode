/*
 * XREFs of RtlUnicodeStringValidateDestWorker @ 0x1C015B25C
 * Callers:
 *     ?RtlUnicodeStringCatString@@YAJPEAU_UNICODE_STRING@@PEBG@Z @ 0x1C015B1E8 (-RtlUnicodeStringCatString@@YAJPEAU_UNICODE_STRING@@PEBG@Z.c)
