/*
 * XREFs of ?DeliverConfigRequest@RIM@InputTraceLogging@@SAXPEBURIMDEV@@GK@Z @ 0x1C0140394
 * Callers:
...
void __fastcall InputTraceLogging::RIM::DeliverConfigRequest(const struct RIMDEV *a1, __int16 a2, int a3)
{
  ...
  if ( dword_1C020CB50 > 4u )
  {
    if ( TlgKeywordOn((TraceLoggingHProvider)&dword_1C020CB50, 0x100uLL) )
    {
      ...
      v9 = 2LL;
      v11 = 4LL;
      TlgWrite((TraceLoggingHProvider)&dword_1C020CB50, &unk_1C01E2C20, 0LL, 0LL, 5u, &pData);
    }
  }
}
