/*
 * XREFs of ?Win32kNtUserCleanupInternal@@YAXXZ @ 0x1C00B2884
 * Callers:
 ...
 *     ?CSTPop@@YAHPEAIPEAPEAX@Z @ 0x1C00A1A84 (-CSTPop@@YAHPEAIPEAPEAX@Z.c)
...
void Win32kNtUserCleanupInternal(void)
{
  ...
  if ( (int)IsFreeSMSSupported() >= 0 )
  {
    ...
    qword_1C02158B0 = (__int64)&gsmsList;
    gsmsList = &gsmsList;
  }
  ...
  if ( qword_1C0215DF0 )
  {
    if ( (int)IsFreeMessageListSupported(v4) >= 0 )
      FreeMessageList(qword_1C0215DF0 + 24);
    Win32FreeToPagedLookasideList((__int64)QLookaside, qword_1C0215DF0);
    qword_1C0215DF0 = 0LL;
  }
  if ( QLookaside )
  {
