/*
 * XREFs of _handle_error @ 0x1C00BEF84
 * Callers:
 *     exp @ 0x1C00BE790 (exp.c)
 *     log @ 0x1C00BEB78 (log.c)
 * Callees:
 *     __security_check_cookie @ 0x1C00B7F30 (__security_check_cookie.c)
 *     _call_matherr @ 0x1C00BEE54 (_call_matherr.c)
 *     _exception_enabled @ 0x1C00BEEC4 (_exception_enabled.c)
 *     _raise_exc @ 0x1C00BF180 (_raise_exc.c)
 *     _set_errno_from_matherr @ 0x1C00BF440 (_set_errno_from_matherr.c)
