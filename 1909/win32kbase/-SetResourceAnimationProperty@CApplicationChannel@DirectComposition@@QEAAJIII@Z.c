/*
 * XREFs of ?SetResourceAnimationProperty@CApplicationChannel@DirectComposition@@QEAAJIII@Z @ 0x1C006E0D0
 * Callers:
        ...
        int a4)
{
  ...
  if ( v8 )
  {
    v9 = (struct DirectComposition::CBaseAnimation *)(*(__int64 (__fastcall **)(__int64))(*(_QWORD *)v8 + 128LL))(v8);
    if ( v9 )
    {
      ...
      if ( (*(unsigned __int8 (__fastcall **)(struct DirectComposition::CResourceMarshaler *, _QWORD, _QWORD))(v12 + 200))(
             v11,
             a3,
             v13) )
      {
