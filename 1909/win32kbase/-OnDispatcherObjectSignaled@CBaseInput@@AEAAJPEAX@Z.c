/*
 * XREFs of ?OnDispatcherObjectSignaled@CBaseInput@@AEAAJPEAX@Z @ 0x1C0054860
 * Callers:
 *     ?_OnDispatcherObjectSignaled@CBaseInput@@CAJPEAX0@Z @ 0x1C0054840 (-_OnDispatcherObjectSignaled@CBaseInput@@CAJPEAX0@Z.c)
 * Callees:
 ...
 *     ?DispatcherHandleNameToString@InputTraceLogging@@CAPEBDW4DispatcherHandleName@CRIMBase@@@Z @ 0x1C017647C (-DispatcherHandleNameToString@InputTraceLogging@@CAPEBDW4DispatcherHandleName@CRIMBase@@@Z.c)
...
LABEL_9:
  ...
  else
  {
    ...
    if ( dword_1C020CB50 > 4u && TlgKeywordOn((TraceLoggingHProvider)&dword_1C020CB50, 2uLL) )
    {
      ...
      TlgWrite((TraceLoggingHProvider)&dword_1C020CB50, &unk_1C01E509F, 0LL, 0LL, 3u, &pData);
    }
    if ( v43 != *((_DWORD *)&unk_1C01D10E0 + 6 * v43) )
      MicrosoftTelemetryAssertTriggeredNoArgsKM(v12, v11, v13);
    if ( *((_BYTE *)&unk_1C01D10E0 + 24 * v43 + 16) )
    {
      ...
      *(_QWORD *)ActivityId.Data4 = 0LL;
        ...
        if ( v45 && (*(int *)(v45 + 24) > 0 || *(_DWORD *)(v57 + 48)) )
        {
          ...
          if ( dword_1C020CB50 > 6u )
          {
            if ( TlgKeywordOn((TraceLoggingHProvider)&dword_1C020CB50, 0x2000uLL) )
            {
              ...
              v61 = &v52;
              v62 = 4;
              TlgWrite((TraceLoggingHProvider)&dword_1C020CB50, &unk_1C01E1517, &ActivityId, 0LL, 3u, &v60);
            }
          }
        }
      }
        ...
        *(GUID *)(v57 + 28) = ActivityId;
        if ( dword_1C020CB50 > 6u )
        {
          if ( TlgKeywordOn((TraceLoggingHProvider)&dword_1C020CB50, 0x2000uLL) )
          {
            ...
            v65 = &v53;
            v66 = 4;
            TlgWrite((TraceLoggingHProvider)&dword_1C020CB50, &unk_1C01E14C0, &ActivityId, 0LL, 3u, &v64);
            v46 = dword_1C020CB50;
          }
          if ( v46 > 6 && TlgKeywordOn((TraceLoggingHProvider)&dword_1C020CB50, 0x2000uLL) )
          {
            ...
            v69 = &v54;
            v70 = 4;
            TlgWrite((TraceLoggingHProvider)&dword_1C020CB50, &unk_1C01E14ED, &ActivityId, 0LL, 3u, &v68);
          }
        }
      }
      ...
      v36 = (*((__int64 (__fastcall **)(CBaseInput *))&unk_1C01D10E0 + 3 * v43 + 1))(v4);
