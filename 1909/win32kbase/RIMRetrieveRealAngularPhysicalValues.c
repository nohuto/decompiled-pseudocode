/*
 * XREFs of RIMRetrieveRealAngularPhysicalValues @ 0x1C015AB18
 * Callers:
 *     RIMRetrieveNormalizationRange @ 0x1C015A9DC (RIMRetrieveNormalizationRange.c)
 * Callees:
 *     RIMComputePower @ 0x1C015A8B0 (RIMComputePower.c)
      ...
      if ( v19 == 4 )
      {
        ...
        if ( v8 < -4 )
        {
          ...
          do
          {
            ...
            --v9;
            ++v3;
            v20 = dword_1C01EC0D0[v21] + 10 * v20;
          }
          while ( v9 > v8 );
          v23 = v20;
        }
