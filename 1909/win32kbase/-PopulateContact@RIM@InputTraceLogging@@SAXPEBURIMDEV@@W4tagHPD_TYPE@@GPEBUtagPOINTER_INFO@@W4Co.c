/*
 * XREFs of ?PopulateContact@RIM@InputTraceLogging@@SAXPEBURIMDEV@@W4tagHPD_TYPE@@GPEBUtagPOINTER_INFO@@W4ContactPopulationSource@12@@Z @ 0x1C0152594
 * Callers:
...
void __fastcall InputTraceLogging::RIM::PopulateContact(__int64 a1, __int64 a2, __int16 a3, __int64 a4, int a5)
{
  ...
  if ( dword_1C020CB50 > 4u && TlgKeywordOn((TraceLoggingHProvider)&dword_1C020CB50, 0x100uLL) )
  {
    ...
    TlgCreateSz(&v23, v9);
    TlgWrite((TraceLoggingHProvider)&dword_1C020CB50, &unk_1C01E3C8C, 0LL, 0LL, 7u, &pData);
  }
}
