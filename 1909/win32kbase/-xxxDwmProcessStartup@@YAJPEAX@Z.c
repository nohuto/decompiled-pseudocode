/*
 * XREFs of ?xxxDwmProcessStartup@@YAJPEAX@Z @ 0x1C006747C
 * Callers:
 ...
 *     ?SetDwmApiPort@@YAXPEAX@Z @ 0x1C0067ABC (-SetDwmApiPort@@YAXPEAX@Z.c)
...
__int64 __fastcall xxxDwmProcessStartup(HANDLE Handle)
{
  ...
  GreUnlockDwmState();
  if ( v5 < 0 || (v5 = ((__int64 (*)(void))qword_1C02121E0)(), v5 < 0) )
  {
LABEL_25:
    GreLockDwmState();
    if ( g_pepDwm == v4 )
