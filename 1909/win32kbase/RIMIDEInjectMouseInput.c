/*
 * XREFs of RIMIDEInjectMouseInput @ 0x1C0148930
 * Callers:
...
__int64 __fastcall RIMIDEInjectMouseInput(__int64 a1, __int128 *a2, unsigned int a3)
{
  __int64 v3; // rbp
  __int64 v4; // rbx
  __int64 v5; // rdi
    ...
    else
    {
      if ( (_DWORD)v5 )
      {
        ...
        do
        {
          ...
          v18 = ((unsigned __int8)*(_DWORD *)(v4 + 924) + 1) & 0xF;
          *(_DWORD *)(v4 + 924) = v18;
          v19 = 3 * v18;
          *(_OWORD *)(v4 + 8 * v19 + 928) = v16;
          *(_QWORD *)(v4 + 8 * v19 + 944) = v17;
          ++*(_DWORD *)(v4 + 920);
          --v15;
        }
        while ( v15 );
