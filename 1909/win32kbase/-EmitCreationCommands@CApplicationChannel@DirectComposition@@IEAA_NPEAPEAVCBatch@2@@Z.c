/*
 * XREFs of ?EmitCreationCommands@CApplicationChannel@DirectComposition@@IEAA_NPEAPEAVCBatch@2@@Z @ 0x1C000BF64
 * Callers:
        ...
        struct DirectComposition::CBatch **a2)
{
        ...
        *((_QWORD *)this + 50) = i )
  {
    *(_DWORD *)(*((_QWORD *)this + 50) + 16LL) |= 1u;
    ...
    if ( (*(_DWORD *)(v5 + 16) & 2) != 0 )
    {
      v6 = (*(unsigned __int8 (__fastcall **)(__int64, __int64))(*(_QWORD *)v5 + 120LL))(v5, 167LL) != 0 ? 8 : 0;
