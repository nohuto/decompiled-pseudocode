/*
 * XREFs of lookForMatchingMinuserHwnd @ 0x1C0103780
 * Callers:
 *     <none>
 * Callees:
...
_BOOL8 __fastcall lookForMatchingMinuserHwnd(_QWORD *a1, __int64 a2, __int64 a3)
{
  ...
  result = *(_BYTE *)(a2 + 24) == 23
        && ((v5 = a1[1],
             v6 = a1[2],
             v7 = *((_QWORD *)gpKernelHandleTable + 3 * (unsigned int)((a2 - (__int64)qword_1C0210758) >> 5) + 1),
             !v5)
         || *(_QWORD *)(v7 + 416) == v5)
        && (!v6 || v7 == v6)
        && *(_QWORD *)(*((_QWORD *)gpKernelHandleTable + 3 * (unsigned int)((a2 - (__int64)qword_1C0210758) >> 5)) + 56LL) == *a1;
  return result;
}
