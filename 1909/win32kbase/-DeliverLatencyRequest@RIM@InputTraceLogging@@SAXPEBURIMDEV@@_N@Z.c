/*
 * XREFs of ?DeliverLatencyRequest@RIM@InputTraceLogging@@SAXPEBURIMDEV@@_N@Z @ 0x1C0140514
 * Callers:
...
void __fastcall InputTraceLogging::RIM::DeliverLatencyRequest(const struct RIMDEV *a1)
{
  ...
  if ( dword_1C020CB50 > 4u )
  {
    if ( TlgKeywordOn((TraceLoggingHProvider)&dword_1C020CB50, 0x100uLL) )
    {
      ...
      v8 = 8;
      v11 = cData;
      TlgWrite((TraceLoggingHProvider)&dword_1C020CB50, &unk_1C01E2B7D, 0LL, 0LL, cData, &pData);
    }
  }
}
