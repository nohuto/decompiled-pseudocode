/*
 * XREFs of ?PostInitialize@CMouseSensor@@EEAAJXZ @ 0x1C00A8E30
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall CMouseSensor::PostInitialize(struct RawInputManagerObject **this, __int64 a2, __int64 a3)
{
  unsigned int v3; // ebx
  CMouseProcessor *v5; // rax
  CMouseProcessor *v6; // rax

  v3 = 0;
  if ( this[152] )
    MicrosoftTelemetryAssertTriggeredNoArgsKM(this, a2, a3);
  this[152] = 0LL;
  v5 = (CMouseProcessor *)Win32AllocPool(4528LL, 0x70724D50u);
  if ( v5 )
    v6 = CMouseProcessor::CMouseProcessor(v5);
  else
    v6 = 0LL;
  if ( v6 )
  {
    ...
    {
      if ( isRootPartition() )
        return (unsigned int)CBaseInput::ivRegisterChildNotification((CBaseInput *)this, 0);
      else
        return (unsigned int)CBaseInput::ivChildLoop((CBaseInput *)this, 0, this[2]);
    }
  }
  else
  {
