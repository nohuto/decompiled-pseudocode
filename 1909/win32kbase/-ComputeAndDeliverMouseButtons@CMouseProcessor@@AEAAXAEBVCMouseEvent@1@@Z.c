/*
 * XREFs of ?ComputeAndDeliverMouseButtons@CMouseProcessor@@AEAAXAEBVCMouseEvent@1@@Z @ 0x1C004A1B0
 * Callers:
 *     <none>
 * Callees:
    ...
    do
    {
      ...
      if ( (v6 & 3) != 0 )
      {
        if ( (v6 & 1) != 0 )
        {
          ...
          CMouseProcessor::CButtonEvent::CButtonEvent((__int64)v15, v8, 1LL, v10, (__int64)a2);
          CMouseProcessor::ProcessMouseButton(this, (const struct CMouseProcessor::CButtonEvent *)v15);
        }
        if ( (v6 & 2) != 0 )
        {
          CMouseProcessor::CButtonEvent::CButtonEvent((__int64)v15, v8, 2LL, 0, (__int64)a2);
          CMouseProcessor::ProcessMouseButton(this, (const struct CMouseProcessor::CButtonEvent *)v15);
        }
        v11 = *((_QWORD *)a2 + 1);
