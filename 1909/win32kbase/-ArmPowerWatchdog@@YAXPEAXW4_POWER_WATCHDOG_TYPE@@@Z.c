/*
 * XREFs of ?ArmPowerWatchdog@@YAXPEAXW4_POWER_WATCHDOG_TYPE@@@Z @ 0x1C0066970
 * Callers:
...
LABEL_7:
    ...
    {
      if ( TlgKeywordOn((TraceLoggingHProvider)&dword_1C020C458, 0x400000000000uLL) )
      {
        v16 = 0;
        v19 = 0;
        v22 = 0;
        ...
        v10 = v2;
        v21 = 4;
        TlgWrite((TraceLoggingHProvider)&dword_1C020C458, &unk_1C01E1699, 0LL, 0LL, 5u, &pData);
      }
    }
  }
}
