/*
 * XREFs of ?CoalesceFrame@Pointer@InputTraceLogging@@SAXPEBUCPointerInputFrame@@@Z @ 0x1C01603E4
 * Callers:
...
void __fastcall InputTraceLogging::Pointer::CoalesceFrame(const struct CPointerInputFrame *a1)
{
  ...
  if ( dword_1C020CB50 > 4u )
  {
    if ( TlgKeywordOn((TraceLoggingHProvider)&dword_1C020CB50, 0x20uLL) )
    {
      ...
      v8 = 8LL;
      v10 = 4LL;
      TlgWrite((TraceLoggingHProvider)&dword_1C020CB50, &unk_1C01E4419, 0LL, 0LL, 5u, &pData);
    }
  }
}
