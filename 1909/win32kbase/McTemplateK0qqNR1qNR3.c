/*
 * XREFs of McTemplateK0qqNR1qNR3 @ 0x1C010E4B4
 * Callers:
 *     EtwTraceTimerDelayStatistics @ 0x1C010BBD0 (EtwTraceTimerDelayStatistics.c)
 * Callees:
 *     McGenEventWrite @ 0x1C0058898 (McGenEventWrite.c)
 *     __security_check_cookie @ 0x1C00B7F30 (__security_check_cookie.c)
 */

ULONG __fastcall McTemplateK0qqNR1qNR3(
        ...
        __int64 a10)
{
  EVENT_DATA_DESCRIPTOR EventData; // [rsp+30h] [rbp-49h] BYREF
  ...
  v21 = a10;
  v22 = a9 * a8;
  return McGenEventWrite(a1, &TimerDelayStatistics, (LPCGUID)&Context.Flags, 6u, &EventData);
}
