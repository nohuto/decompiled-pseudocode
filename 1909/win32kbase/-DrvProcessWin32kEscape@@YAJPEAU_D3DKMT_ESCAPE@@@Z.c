/*
 * XREFs of ?DrvProcessWin32kEscape@@YAJPEAU_D3DKMT_ESCAPE@@@Z @ 0x1C012817C
 * Callers:
 *     ?DxgkEngProcessWin32kEscape@@YAJPEAU_D3DKMT_ESCAPE@@@Z @ 0x1C011FC90 (-DxgkEngProcessWin32kEscape@@YAJPEAU_D3DKMT_ESCAPE@@@Z.c)
 * Callees:
 ...
 *     GreIsInLowBox @ 0x1C01235F0 (GreIsInLowBox.c)
  ...
  if ( Type > D3DKMT_ESCAPE_WIN32K_DDA_TEST_CTL )
  {
    ...
    if ( !v21 )
    {
      if ( a1->PrivateDriverDataSize != 40 )
        goto LABEL_16;
      HipDeviceInfo = ((__int64 (__fastcall *)(_DWORD *))qword_1C02122A8)(v5);
      goto LABEL_33;
    }
...
LABEL_45:
    ...
    wil_details_FeaturePropertyCache_ReportUsageToService(
      ...
      0x10AA02Cu,
      (const struct FEATURE_LOGGED_TRAITS *)&unk_1C01E8E9C,
      0,
      3);
LABEL_51:
...
LABEL_20:
        ...
        {
          if ( qword_1C0212228 )
            v5[1] = (unsigned __int8)qword_1C0212228() != 0;
          else
            HipDeviceInfoSupported = -1073741637;
          goto LABEL_68;
        }
