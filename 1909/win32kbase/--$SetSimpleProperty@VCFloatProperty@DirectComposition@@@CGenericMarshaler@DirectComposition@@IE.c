/*
 * XREFs of ??$SetSimpleProperty@VCFloatProperty@DirectComposition@@@CGenericMarshaler@DirectComposition@@IEAAJIMPEA_N@Z @ 0x1C01A1C9C
 * Callers:
 *     ?SetFloatProperty@CGenericMarshaler@DirectComposition@@UEAAJIMPEA_N@Z @ 0x1C01A41E0 (-SetFloatProperty@CGenericMarshaler@DirectComposition@@UEAAJIMPEA_N@Z.c)
 * Callees:
        ...
        _BYTE *a4)
{
  ...
  if ( v10 == (__int64 *)(*(_QWORD *)(a1 + 48) + 8LL * *(_QWORD *)(a1 + 56)) )
  {
