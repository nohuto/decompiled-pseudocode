/*
 * XREFs of PowerIsDisplayIdleExpired @ 0x1C007F3B0
 * Callers:
 *     <none>
 * Callees:
 *     ?IsTimeFromLastInputEvent@CInputGlobals@@QEBA_NK@Z @ 0x1C007E260 (-IsTimeFromLastInputEvent@CInputGlobals@@QEBA_NK@Z.c)
 ...
 *     PowerIsDisplayBurstActive @ 0x1C0106220 (PowerIsDisplayBurstActive.c)
...
_BOOL8 __fastcall PowerIsDisplayIdleExpired(int a1, int *a2)
{
  ...
  if ( CInputGlobals::GetGlobalTickCount(gpInputGlobals, 0LL) < (unsigned __int64)qword_1C0212758 )
  {
