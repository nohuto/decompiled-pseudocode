/*
 * XREFs of RIMRegisterForInputWithCallbacks @ 0x1C005A290
 * Callers:
...
LABEL_7:
    ...
    {
      Object = 0LL;
      if ( (int)rimFindReferencedKernelModeRimObj(a1, (struct _LIST_ENTRY **)&Object) >= 0 )
      {
