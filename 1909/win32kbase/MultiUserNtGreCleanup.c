/*
 * XREFs of MultiUserNtGreCleanup @ 0x1C00B2F08
 * Callers:
 ...
 *     ?DrvCleanupGraphicsDeviceList@@YAXPEAUtagGRAPHICS_DEVICE@@@Z @ 0x1C00B3DF0 (-DrvCleanupGraphicsDeviceList@@YAXPEAUtagGRAPHICS_DEVICE@@@Z.c)
...
__int64 MultiUserNtGreCleanup()
{
  ...
  if ( qword_1C0212B88 )
  {
    Win32FreePool((__int64)qword_1C0212B88);
    qword_1C0212B88 = 0LL;
  }
  v23 = qword_1C0212B98;
  if ( qword_1C0212B98 )
  {
    Win32FreePool((__int64)qword_1C0212B98);
    qword_1C0212B98 = 0LL;
  }
