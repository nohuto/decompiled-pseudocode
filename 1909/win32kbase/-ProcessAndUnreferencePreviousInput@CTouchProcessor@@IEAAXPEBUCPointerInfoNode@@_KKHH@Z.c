/*
 * XREFs of ?ProcessAndUnreferencePreviousInput@CTouchProcessor@@IEAAXPEBUCPointerInfoNode@@_KKHH@Z @ 0x1C016D858
 * Callers:
        ...
        int a6)
{
  ...
  if ( (v12 & 1) != 0 )
  {
    ...
    {
      LOBYTE(v10) = 2;
      WPP_RECORDER_SF_((_DWORD)gBaseLog, v10, 7, 198, (__int64)&WPP_dde6ae6ba4d53e169de0efe5dbb74602_Traceguids);
      if ( WPP_RECORDER_INITIALIZED != (_UNKNOWN *)&WPP_RECORDER_INITIALIZED )
      {
...
LABEL_48:
          LOBYTE(v10) = 5;
          WPP_RECORDER_SF_(v13->DeviceExtension, v10, 7, v14, (__int64)&WPP_dde6ae6ba4d53e169de0efe5dbb74602_Traceguids);
        }
      }
    }
  }
...
LABEL_43:
  ...
  {
    LOBYTE(v10) = 2;
    WPP_RECORDER_SF_((_DWORD)gBaseLog, v10, 7, 200, (__int64)&WPP_dde6ae6ba4d53e169de0efe5dbb74602_Traceguids);
    if ( WPP_RECORDER_INITIALIZED != (_UNKNOWN *)&WPP_RECORDER_INITIALIZED )
    {
      v13 = WPP_GLOBAL_Control;
      if ( LOWORD(WPP_GLOBAL_Control->DeviceType) )
