/*
 * XREFs of ?EmitSetRequestedScaleAnimation@CInteractionTrackerMarshaler@DirectComposition@@AEAA_NPEAPEAVCBatch@2@@Z @ 0x1C01AA924
 * Callers:
        ...
        struct DirectComposition::CBatch **a2)
{
  ...
  if ( !v4
    ...
    || (*(unsigned __int8 (__fastcall **)(_QWORD, struct DirectComposition::CBatch **))(**(_QWORD **)(*((_QWORD *)this + 26) + 16LL)
                                                                                      + 80LL))(
         ...
         a2) )
  {
    if ( DirectComposition::CBatch::EnsureBatchBuffer(a2, 0x24uLL, &v11) )
    {
      ...
      *v6 = 243;
      ...
      v6[2] = 0;
      v6[1] = v7;
      *((_BYTE *)v6 + 12) = (*((_BYTE *)this + 416) & 2) == 0;
      v6[4] = *((_DWORD *)this + 41);
      v6[5] = *((_DWORD *)this + 42);
      v6[7] = *((_DWORD *)this + 40);
      v8 = *((_QWORD *)this + 26);
