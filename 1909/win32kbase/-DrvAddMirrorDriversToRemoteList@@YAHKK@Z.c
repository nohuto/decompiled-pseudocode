/*
 * XREFs of ?DrvAddMirrorDriversToRemoteList@@YAHKK@Z @ 0x1C00B3B28
 * Callers:
 ...
 *     ?DrvAddEntryToGraphicsDeviceList@@YAXPEAUtagGRAPHICS_DEVICE@@@Z @ 0x1C0127454 (-DrvAddEntryToGraphicsDeviceList@@YAXPEAUtagGRAPHICS_DEVICE@@@Z.c)
 */
