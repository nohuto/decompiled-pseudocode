/*
 * XREFs of ?RIMCallBack@CBaseInput@@AEAAXPEAURIMDevChangeStruct@@@Z @ 0x1C005584C
 * Callers:
 *     ?_RIMCallBack@CBaseInput@@CAXPEAURIMDevChangeStruct@@@Z @ 0x1C0055830 (-_RIMCallBack@CBaseInput@@CAXPEAURIMDevChangeStruct@@@Z.c)
 * Callees:
...
void __fastcall CBaseInput::RIMCallBack(CBaseInput *this, struct RIMDevChangeStruct *a2)
{
  ...
  if ( (unsigned int)v7 < 5 )
  {
    ...
    if ( *((_DWORD *)&off_1C01D1260 + 4 * (unsigned int)v7 + 2) != *(_DWORD *)a2 )
    ...
    v17 = (*(&off_1C01D1260 + v8))(this, (struct RawInputManagerDeviceObject *)v2);
    if ( *(_DWORD *)a2 == 1 )
    {
      if ( v13 )
