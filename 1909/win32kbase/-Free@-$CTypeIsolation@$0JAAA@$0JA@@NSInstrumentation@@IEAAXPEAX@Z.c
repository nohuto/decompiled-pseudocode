/*
 * XREFs of ?Free@?$CTypeIsolation@$0JAAA@$0JA@@NSInstrumentation@@IEAAXPEAX@Z @ 0x1C012D4AC
 * Callers:
 *     _lambda_4244bae6fa0a501e9e28a4e0afb3a818_::_lambda_invoker_cdecl__void____LOOKASIDE_LIST_EX___ @ 0x1C00940E0 (_lambda_4244bae6fa0a501e9e28a4e0afb3a818_--_lambda_invoker_cdecl__void____LOOKASIDE_LIST_EX___.c)
 * Callees:
...
LABEL_18:
      ...
      while ( 1 )
      {
        v6 = (__int64 *)v5[4];
        v7 = v6[1] ^ v6[2];
        if ( (unsigned __int64)a2 < v7 || (unsigned __int64)a2 >= v7 + 36864 )
        {
          v8 = 0;
        }
        else if ( ((unsigned __int16)a2 & 0xFFF) == 144 * (((unsigned __int16)a2 & 0xFFFu) / 0x90uLL) )
        {
          v8 = 2
             - (RtlTestBit(
                  (PRTL_BITMAP)(v6[2] ^ v6[3]),
                  28 * (((unsigned int)a2 - (*((_DWORD *)v6 + 2) ^ (unsigned int)v6[2])) >> 12)
