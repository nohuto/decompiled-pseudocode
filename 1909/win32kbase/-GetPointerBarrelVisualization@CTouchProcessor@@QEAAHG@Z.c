/*
 * XREFs of ?GetPointerBarrelVisualization@CTouchProcessor@@QEAAHG@Z @ 0x1C0167600
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall CTouchProcessor::GetPointerBarrelVisualization(CTouchProcessor *this, unsigned __int16 a2)
{
  ...
  CInpLockGuardShared::CInpLockGuardShared((CInpLockGuardShared *)&v8, (CTouchProcessor *)((char *)this + 48));
  NodeById = CTouchProcessor::FindNodeById(this, a2, 0, 0);
  if ( NodeById )
  {
    v6 = *((_DWORD *)NodeById + 72);
    if ( (v6 & 0x800) != 0 )
      v5 = (v6 & 0x400) != 0 ? 1 : -1;
    else
      v5 = 0;
