/*
 * XREFs of HMIsHandleEntrySecureWorker @ 0x1C0102E80
 * Callers:
 *     ??0CHMRefHwndByHandle@@QEAA@PEAUHWND__@@_N111@Z @ 0x1C00243F0 (--0CHMRefHwndByHandle@@QEAA@PEAUHWND__@@_N111@Z.c)
 * Callees:
 *     ?IsHandleEntrySecureWorker@@YAHPEAXPEAU_HANDLEENTRY@@@Z @ 0x1C0102B4C (-IsHandleEntrySecureWorker@@YAHPEAXPEAU_HANDLEENTRY@@@Z.c)
 */
...
__int64 __fastcall HMIsHandleEntrySecureWorker(void *a1)
{
  ...
  {
    v3 = (struct _HANDLEENTRY *)((char *)qword_1C0210758 + (unsigned int)(unsigned __int16)a1 * dword_1C0210760);
