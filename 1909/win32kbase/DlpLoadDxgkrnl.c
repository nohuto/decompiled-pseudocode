/*
 * XREFs of DlpLoadDxgkrnl @ 0x1C00A40F8
 * Callers:
 ...
 *     DlpUnloadDxgkrnl @ 0x1C019F35C (DlpUnloadDxgkrnl.c)
 */
  ...
  *(_QWORD *)&ObjectName.Length = 0LL;
  ...
  if ( v5 )
  {
    ...
    if ( (int)(DeviceObjectPointer + 0x80000000) < 0 || DeviceObjectPointer == -1073741554 )
    {
      ...
      while ( 1 )
      {
        DeviceObjectPointer = IoGetDeviceObjectPointer(&ObjectName, 0xC0000000, &gpDxgkFileObject, &gpDxgkDeviceObject);
