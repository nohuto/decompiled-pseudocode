/*
 * XREFs of ?GetReadyBatches@CConnection@DirectComposition@@QEAAJ_KPEAPEAVCBatch@2@@Z @ 0x1C01A1720
 * Callers:
 ...
 * Callees:
 *     ?GetNewBatches@CConnection@DirectComposition@@QEAAXPEAPEAVCBatch@2@@Z @ 0x1C006D93C (-GetNewBatches@CConnection@DirectComposition@@QEAAXPEAPEAVCBatch@2@@Z.c)
 *     ?GetDeferredBatches@CConnection@DirectComposition@@AEAA_N_KPEAPEAVCBatch@2@1@Z @ 0x1C01A166C (-GetDeferredBatches@CConnection@DirectComposition@@AEAA_N_KPEAPEAVCBatch@2@1@Z.c)
