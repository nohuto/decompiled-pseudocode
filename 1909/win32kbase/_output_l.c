/*
 * XREFs of _output_l @ 0x1C00B8758
 * Callers:
 ...
 *     write_multi_char @ 0x1C00B8FD0 (write_multi_char.c)
 *     write_string @ 0x1C00B9028 (write_string.c)
 *     _get_printf_count_output @ 0x1C00B9B18 (_get_printf_count_output.c)
 *     wctomb_s @ 0x1C00B9BE8 (wctomb_s.c)
...
LABEL_120:
                  ...
                  {
                    LOBYTE(v17) = 32;
                    write_multi_char(v17, v34, v55, &v47);
                  }
                  write_string(v48, v33, v55, &v47);
                  v36 = v55;
                  if ( (v6 & 0xC) == 8 )
                  {
                    LOBYTE(v35) = 48;
                    write_multi_char(v35, v34, v55, &v47);
                  }
                  v37 = SizeConverted;
                  if ( v50 && SizeConverted > 0 )
                  {
                    ...
                    while ( 1 )
                    {
                      ...
                      if ( wctomb_s(&v56, v59, 6uLL, v39) || !v56 )
                        break;
                      write_string(v59, (unsigned int)v56, v55, &v47);
                      if ( !v37 )
                        goto LABEL_134;
                    }
                    v12 = -1;
                  ...
                  {
                    write_string(v9, (unsigned int)SizeConverted, v36, &v47);
LABEL_134:
                    v12 = v47;
                  }
                  if ( v12 >= 0 && (v6 & 4) != 0 )
                  {
                    LOBYTE(v40) = 32;
                    write_multi_char(v40, v34, v55, &v47);
                    a2 = v57;
                    v8 = v46;
                    goto LABEL_165;
                  }
