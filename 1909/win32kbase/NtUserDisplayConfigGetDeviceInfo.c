/*
 * XREFs of NtUserDisplayConfigGetDeviceInfo @ 0x1C003B090
 * Callers:
 *     <none>
 * Callees:
...
LABEL_114:
    if ( v48 )
    {
      ...
      {
        dword_1C0216828 = 1;
        ((void (__fastcall *)(__int64, __int64, __int64, __int64, _QWORD))qword_1C02122F8)(403LL, 2061LL, v38, v37, 0LL);
      }
    }
    goto LABEL_125;
  }
