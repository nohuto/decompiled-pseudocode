/*
 * XREFs of ?SetReferenceArrayProperty@CGlyphRunVisualMarshaler@DirectComposition@@UEAAJPEAVCApplicationChannel@2@IPEAPEAVCResourceMarshaler@2@_KPEA_N@Z @ 0x1C01B6670
 * Callers:
 *     <none>
 * Callees:
    ...
    if ( a3 == 52 )
    {
      ...
      if ( v9 >= 0 )
      {
        ...
        *((_DWORD *)this + 92) |= 2u;
        ...
        {
          do
            DirectComposition::CResourceMarshaler::AddRef(*(DirectComposition::CResourceMarshaler **)(*((_QWORD *)this + 44) + 8LL * v6++));
