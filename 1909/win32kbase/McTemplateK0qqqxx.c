/*
 * XREFs of McTemplateK0qqqxx @ 0x1C01A6FB4
 * Callers:
...
ULONG __fastcall McTemplateK0qqqxx(
        ...
        char a8)
{
  ...
  v18 = &a8;
  v19 = 8LL;
  return McGenEventWrite(a1, &DCompVisualSetInteraction, (LPCGUID)&Context.Flags, 6u, &EventData);
}
