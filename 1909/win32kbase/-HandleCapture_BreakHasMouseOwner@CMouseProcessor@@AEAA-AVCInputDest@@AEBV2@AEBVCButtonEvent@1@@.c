/*
 * XREFs of ?HandleCapture_BreakHasMouseOwner@CMouseProcessor@@AEAA?AVCInputDest@@AEBV2@AEBVCButtonEvent@1@@Z @ 0x1C004EA08
 * Callers:
        ...
        __int64 a4)
{
  ...
  CInputDest::CInputDest((CInputDest *)a2, (const struct CInputDest *)(a1 + 3272));
  CInputDest::GetThreadInfo((CInputDest *)(a1 + 3272));
...
LABEL_14:
  ...
  v17 = CInputDest::operator==((unsigned int *)(a1 + 3272), (__int64)a3, v11);
LABEL_17:
  if ( !v17 )
  {
...
LABEL_7:
  ...
  v14 = ~v13;
  v15 = (v14 & *(_DWORD *)(a1 + 3268)) == 0;
  *(_DWORD *)(a1 + 3268) &= v14;
  if ( v15 )
  {
    CInputDest::SetEmpty((CInputDest *)(a1 + 3272), v10, v11);
    _InterlockedExchange((volatile __int32 *)(a1 + 3400), 0);
  }
  return a2;
}
