/*
 * XREFs of ?Create@CSharedWriteRemotingRenderTargetMarshaler@DirectComposition@@SAJPEBVCSharedSystemResource@2@PEAPEAV12@@Z @ 0x1C01C45A8
 * Callers:
 *     CreateSharedWriteRemotingRenderTargetMarshaler @ 0x1C01C4700 (CreateSharedWriteRemotingRenderTargetMarshaler.c)
 * Callees:
