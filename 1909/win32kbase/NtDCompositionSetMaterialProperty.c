/*
 * XREFs of NtDCompositionSetMaterialProperty @ 0x1C0089F60
 * Callers:
 *     <none>
 * Callees:
 ...
 *     ?Store@MaterialProperty@@QEAAJPEBUResourceObject@DirectComposition@@@Z @ 0x1C008A054 (-Store@MaterialProperty@@QEAAJPEBUResourceObject@DirectComposition@@@Z.c)
 *     FindOrCreateMaterialProperty @ 0x1C008A0C8 (FindOrCreateMaterialProperty.c)
 *     CheckShellExperienceComposerAccess @ 0x1C01A0E9C (CheckShellExperienceComposerAccess.c)
 */
