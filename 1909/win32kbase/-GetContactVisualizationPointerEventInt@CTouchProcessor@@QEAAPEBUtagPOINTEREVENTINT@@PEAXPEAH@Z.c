/*
 * XREFs of ?GetContactVisualizationPointerEventInt@CTouchProcessor@@QEAAPEBUtagPOINTEREVENTINT@@PEAXPEAH@Z @ 0x1C0167310
 * Callers:
 *     <none>
 * Callees:
        ...
        int *a3)
{
  ...
  if ( !(unsigned int)CPointerInfoNode::IsValid(a2) || (*v3 & 0x1000) != 0 )
    return 0LL;
  *v4 = -__CFSHR__(*v3, 4);
  return (const struct tagPOINTEREVENTINT *)(v3 + 42);
}
