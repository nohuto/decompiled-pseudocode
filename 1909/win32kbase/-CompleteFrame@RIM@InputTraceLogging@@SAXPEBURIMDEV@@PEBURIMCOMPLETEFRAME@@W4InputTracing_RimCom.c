/*
 * XREFs of ?CompleteFrame@RIM@InputTraceLogging@@SAXPEBURIMDEV@@PEBURIMCOMPLETEFRAME@@W4InputTracing_RimCompletionReason@@@Z @ 0x1C014BFA4
 * Callers:
...
void __fastcall InputTraceLogging::RIM::CompleteFrame(__int64 a1, __int64 a2, unsigned int a3)
{
  ...
  if ( dword_1C020CB50 > 4u )
  {
    if ( TlgKeywordOn((TraceLoggingHProvider)&dword_1C020CB50, 0x100uLL) )
    {
      ...
      TlgWrite((TraceLoggingHProvider)&dword_1C020CB50, &unk_1C01E3002, 0LL, 0LL, 0xAu, &pData);
    }
  }
}
