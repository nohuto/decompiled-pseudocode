/*
 * XREFs of ?PowerMonitorDimStateTelemetry@@YAXPEAU_DIM_UNDIM_TELEMETRY_DATA@@@Z @ 0x1C00B9EEC
 * Callers:
...
LABEL_6:
  ...
  if ( !v1 )
    return;
LABEL_9:
  if ( dword_1C020C458 > 5u )
  {
    if ( TlgKeywordOn((TraceLoggingHProvider)&dword_1C020C458, 0x400000000100uLL) )
    {
      v14 = &v12;
      v16 = &v10;
      ...
      v27 = 1LL;
      v29 = 4LL;
      TlgWrite((TraceLoggingHProvider)&dword_1C020C458, &unk_1C01E156A, 0LL, 0LL, 0xAu, &pData);
    }
  }
}
