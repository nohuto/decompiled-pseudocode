/*
 * XREFs of ?Free@?$CTypeIsolation@$0BFAAA@$0BFA@@NSInstrumentation@@IEAAXPEAX@Z @ 0x1C010275C
 * Callers:
 *     ?HMFreeIsolatedType@@YAXEPEAX@Z @ 0x1C0010A94 (-HMFreeIsolatedType@@YAXEPEAX@Z.c)
 * Callees:
 *     ?CheckAllocationStatus@?$CSectionBitmapAllocator@$0BFAAA@$0BFA@@NSInstrumentation@@QEAA?AW4AllocationStatus@2@PEBX@Z @ 0x1C007CA68 (-CheckAllocationStatus@-$CSectionBitmapAllocator@$0BFAAA@$0BFA@@NSInstrumentation@@QEAA-AW4Alloc.c)
