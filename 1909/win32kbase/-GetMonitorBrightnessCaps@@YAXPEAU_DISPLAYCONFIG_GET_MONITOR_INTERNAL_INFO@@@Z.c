/*
 * XREFs of ?GetMonitorBrightnessCaps@@YAXPEAU_DISPLAYCONFIG_GET_MONITOR_INTERNAL_INFO@@@Z @ 0x1C00992EC
 * Callers:
...
void __fastcall GetMonitorBrightnessCaps(struct _DISPLAYCONFIG_GET_MONITOR_INTERNAL_INFO *a1)
{
  ...
  v4 = ((__int64 (__fastcall *)(char *, _QWORD, PVOID *, PDEVICE_OBJECT *))qword_1C02121D8)(
         (char *)a1 + 8,
         *((unsigned int *)a1 + 4),
         &Object,
         &DeviceObject);
...
LABEL_5:
      ...
      if ( v6 )
        ...
        v7 = v5 & 0xFFFFFFFC | 2;
      v1[78] = v7;
      v8 = PALLOCMEM2(0xD0uLL, 0x706D7447u, 1);
      if ( v8 )
      {
