/*
 * XREFs of ?Create@CSharedReadRemotingRenderTargetMarshaler@DirectComposition@@SAJPEBVCSharedSystemResource@2@PEAPEAV12@@Z @ 0x1C01C44FC
 * Callers:
 *     CreateSharedReadRemotingRenderTargetMarshaler @ 0x1C01C46C0 (CreateSharedReadRemotingRenderTargetMarshaler.c)
 * Callees:
