/*
 * XREFs of ?DrvValidateAndApplyDevMode@@YAJPEAU_DISPLAYCONFIG_CDS_REQUEST@@PEAPEAUD3DKMT_GETPATHSMODALITY@@@Z @ 0x1C0045D28
 * Callers:
        ...
        struct D3DKMT_GETPATHSMODALITY **a2)
{
  ...
  *(_QWORD *)((char *)v41 + 4) = *(_QWORD *)(v7 + 248);
  ...
  v41[4] = *((_QWORD *)a1 + 4);
  LODWORD(v41[3]) = -2;
  v9 = ((__int64 (__fastcall *)(_QWORD *))qword_1C02120D0)(v41);
  v13 = v9;
  ...
  if ( v9 == -1073741266 )
  {
    *((_DWORD *)a1 + 13) = 2;
    *((_DWORD *)a1 + 12) = -2;
    v34 = (_QWORD *)WdLogNewEntry5_WdWarning(v11, v10, v12);
    v34[3] = -1073741266LL;
    v34[4] = *((_QWORD *)a1 + 4);
    v34[5] = *((int *)a1 + 13);
    v34[6] = *((int *)a1 + 12);
...
LABEL_15:
  ...
  *(_QWORD *)((char *)v41 + 4) = *(_QWORD *)(v7 + 248);
  ...
  v41[4] = v25;
  if ( v26 || *((_DWORD *)a1 + 6) )
    v27 = ((__int64 (__fastcall *)(struct D3DKMT_GETPATHSMODALITY **, _QWORD *))qword_1C0212268)(a2, v41);
  else
    v27 = ((__int64 (__fastcall *)(_QWORD *))qword_1C02120D0)(v41);
  v31 = v27;
  if ( v27 >= 0 )
    return 0LL;
  *((_DWORD *)a1 + 12) = -1;
