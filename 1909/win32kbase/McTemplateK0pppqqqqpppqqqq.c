/*
 * XREFs of McTemplateK0pppqqqqpppqqqq @ 0x1C010DB1C
 * Callers:
 *     EtwTraceWindowRenderingOldToNewRedirectionBitmap @ 0x1C00A4FB0 (EtwTraceWindowRenderingOldToNewRedirectionBitmap.c)
 *     EtwWindowRendering @ 0x1C012FD40 (EtwWindowRendering.c)
 * Callees:
