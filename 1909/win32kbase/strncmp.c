/*
 * XREFs of strncmp @ 0x1C00B8600
 * Callers:
 *     rimFindImageProcAddress @ 0x1C005E4DC (rimFindImageProcAddress.c)
 *     ivrFindImageProcAddress @ 0x1C018C1F8 (ivrFindImageProcAddress.c)
 * Callees:
 *     <none>
 */
