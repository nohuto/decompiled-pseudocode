/*
 * XREFs of ?OnReadNotification@CBaseInput@@AEAAJXZ @ 0x1C01769C0
 * Callers:
 *     <none>
 * Callees:
      ...
      *(GUID *)(v48 + 28) = ActivityId;
      if ( dword_1C020CB50 > 6u )
      {
        if ( TlgKeywordOn((TraceLoggingHProvider)&dword_1C020CB50, 0x2000uLL) )
        {
          ...
          v55 = &v44;
          v56 = 4LL;
          TlgWrite((TraceLoggingHProvider)&dword_1C020CB50, &unk_1C01E14C0, &ActivityId, 0LL, 3u, &v54);
          v14 = dword_1C020CB50;
        }
