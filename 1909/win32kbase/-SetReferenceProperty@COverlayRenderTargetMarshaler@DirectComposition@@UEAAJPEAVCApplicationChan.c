/*
 * XREFs of ?SetReferenceProperty@COverlayRenderTargetMarshaler@DirectComposition@@UEAAJPEAVCApplicationChannel@2@IPEAVCResourceMarshaler@2@PEA_N@Z @ 0x1C01BBF50
 * Callers:
 *     <none>
 * Callees:
