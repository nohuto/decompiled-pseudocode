/*
 * XREFs of xxxUserProcessCallout @ 0x1C002CAF0
 * Callers:
 *     <none>
 * Callees:
 ...
 *     ?UserProcessImmersiveType@@YAJPEAU_WIN32_PROCESS_CALLOUT_PARAMETERS@@PEAXPEAW4_PROCESS_IMMERSIVE_TYPE@@PEAKPEAH@Z @ 0x1C00803C4 (-UserProcessImmersiveType@@YAJPEAU_WIN32_PROCESS_CALLOUT_PARAMETERS@@PEAXPEAW4_PROCESS_IMMERSIVE.c)
...
__int64 __fastcall xxxUserProcessCallout(struct _W32PROCESS *a1, PEPROCESS *a2)
{
      ...
      *(GUID *)(v102 + 28) = ActivityId;
      if ( dword_1C020CB50 > 6u )
      {
        if ( TlgKeywordOn((TraceLoggingHProvider)&dword_1C020CB50, 0x2000uLL) )
        {
          ...
          v112 = &v91;
          v113 = 4;
          TlgWrite((TraceLoggingHProvider)&dword_1C020CB50, &unk_1C01E14C0, &ActivityId, 0LL, 3u, &v111);
          v52 = dword_1C020CB50;
        }
        if ( v52 > 6 && TlgKeywordOn((TraceLoggingHProvider)&dword_1C020CB50, 0x2000uLL) )
        {
          ...
          v116 = &v92;
          v117 = 4;
          TlgWrite((TraceLoggingHProvider)&dword_1C020CB50, &unk_1C01E14ED, &ActivityId, 0LL, 3u, &v115);
        }
      }
    }
  ...
  else
  {
    ...
    *(_QWORD *)pActivityId.Data4 = 0LL;
      ...
      if ( v69 && (*(int *)(v69 + 24) > 0 || *(_DWORD *)(v105 + 48)) )
      {
        ...
        if ( dword_1C020CB50 > 6u )
        {
          if ( TlgKeywordOn((TraceLoggingHProvider)&dword_1C020CB50, 0x2000uLL) )
          {
            ...
            v120 = &v94;
            v121 = 4LL;
            TlgWrite((TraceLoggingHProvider)&dword_1C020CB50, &unk_1C01E1517, &pActivityId, 0LL, 3u, &v119);
          }
        }
      }
    }
      ...
      *(GUID *)(v105 + 28) = pActivityId;
      if ( dword_1C020CB50 > 6u )
      {
        if ( TlgKeywordOn((TraceLoggingHProvider)&dword_1C020CB50, 0x2000uLL) )
        {
          ...
          v123 = &v95;
          v124 = 4;
          TlgWrite((TraceLoggingHProvider)&dword_1C020CB50, &unk_1C01E14C0, &pActivityId, 0LL, 3u, &v122);
          v70 = dword_1C020CB50;
        }
        if ( v70 > 6 && TlgKeywordOn((TraceLoggingHProvider)&dword_1C020CB50, 0x2000uLL) )
        {
          v129 = 0;
          v96 = v106;
          v127 = &v96;
          v128 = 4;
          TlgWrite((TraceLoggingHProvider)&dword_1C020CB50, &unk_1C01E14ED, &pActivityId, 0LL, 3u, &v126);
        }
      }
    }
    EtwTraceAcquiredExclusiveUserCrit();
    ...
    {
      v37 = giheLast;
      for ( i = (char *)qword_1C0210758 + 32 * (unsigned int)giheLast; i > (char *)qword_1C0210758 && !i[24]; i -= 32 )
        giheLast = --v37;
      GreLockVisRgn(*(_QWORD *)(gpDispInfo + 40), (int)qword_1C0210758, v36);
      v45 = (__int64 *)(gpDispInfo + 24);
      ...
      if ( v46 )
      {
        do
        {
          ...
          v48 = v46;
          v49 = v46;
          if ( (*(_DWORD *)(v46 + 64) & 0x400000) != 0 )
          {
            DestroyCacheDC(v45, *(_QWORD *)(v46 + 8));
            v49 = *v45;
          }
          v50 = v49;
          if ( v46 == v49 )
