/*
 * XREFs of DrvChangeDisplaySettings @ 0x1C00478FC
 * Callers:
        ...
        __int64 a15)
{
  ...
  __int64 v44; // rax
  __int64 v45; // rax
  _BYTE v46[4]; // [rsp+88h] [rbp-80h] BYREF
  ...
  _QWORD v52[7]; // [rsp+A8h] [rbp-60h] BYREF
  ...
  *a9 = 0LL;
  ...
  v55[0] = off_1C01CB158;
  v22 = DrvChangeDisplaySettingsPreValidate(String1, a2, (__int64)a3, a5, a6, (wchar_t **)&v50, &v47);
  if ( !v22 )
  {
    if ( v47 )
    {
