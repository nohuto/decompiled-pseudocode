/*
 * XREFs of RawInputManagerDeviceObjectCreate @ 0x1C00593F4
 * Callers:
...
__int64 __fastcall RawInputManagerDeviceObjectCreate(__int64 a1, __int64 a2, __int64 a3, __int64 a4, PHANDLE Handle)
{
  ...
  LOBYTE(a4) = 1;
  LOBYTE(a1) = 1;
  inserted = ObCreateObject(a1, ExRawInputManagerObjectType, 0LL, a4, 0LL, 2304, 0, 0, &Object);
  if ( inserted >= 0 )
  {
    memset(Object, 0, 0x900uLL);
    v6 = Object;
