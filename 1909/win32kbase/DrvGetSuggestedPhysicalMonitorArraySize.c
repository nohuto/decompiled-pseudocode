/*
 * XREFs of DrvGetSuggestedPhysicalMonitorArraySize @ 0x1C00A0DE0
 * Callers:
 ...
 *     ?DrvGetNumberOfPhysicalMonitors@@YAJPEAUtagGRAPHICS_DEVICE@@PEAK@Z @ 0x1C00A0E60 (-DrvGetNumberOfPhysicalMonitors@@YAJPEAUtagGRAPHICS_DEVICE@@PEAK@Z.c)
