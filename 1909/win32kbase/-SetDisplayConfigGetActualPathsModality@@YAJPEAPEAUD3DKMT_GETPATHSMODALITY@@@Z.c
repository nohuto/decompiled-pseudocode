/*
 * XREFs of ?SetDisplayConfigGetActualPathsModality@@YAJPEAPEAUD3DKMT_GETPATHSMODALITY@@@Z @ 0x1C0047E68
 * Callers:
...
__int64 __fastcall SetDisplayConfigGetActualPathsModality(struct D3DKMT_GETPATHSMODALITY **a1)
{
  ...
  if ( (unsigned int)((__int64 (__fastcall *)(_QWORD *, _QWORD))qword_1C02122E0)(v35, 0LL) == -1073741789 )
  {
