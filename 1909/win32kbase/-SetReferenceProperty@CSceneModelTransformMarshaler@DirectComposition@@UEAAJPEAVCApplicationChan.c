/*
 * XREFs of ?SetReferenceProperty@CSceneModelTransformMarshaler@DirectComposition@@UEAAJPEAVCApplicationChannel@2@IPEAVCResourceMarshaler@2@PEA_N@Z @ 0x1C01BA7A0
 * Callers:
 *     <none>
 * Callees:
