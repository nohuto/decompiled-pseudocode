/*
 * XREFs of RIMIDEPopulateExtendedPointerDeviceProperties @ 0x1C014A9E8
 * Callers:
...
__int64 __fastcall RIMIDEPopulateExtendedPointerDeviceProperties(__int64 a1, __int64 a2, __int64 a3)
{
  ...
  if ( *(_DWORD *)(a2 + 24) == 7 )
  {
    ...
    *(_QWORD *)(a2 + 300) = v7;
    *(_DWORD *)(a2 + 308) = v5;
    *(_DWORD *)(a2 + 304) = dword_1C020CC64;
    result = (unsigned int)dword_1C020CC74;
    *(_DWORD *)(a2 + 308) = dword_1C020CC74;
  }
  return result;
}
