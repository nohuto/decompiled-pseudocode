/*
 * XREFs of ?GetAnimationTimeState@CAnimationMarshaler@DirectComposition@@IEAAXPEA_NPEA_JPEA_K@Z @ 0x1C01AF804
 * Callers:
 ...
 *     ?GetAnimationTime@CAnimationMarshaler@DirectComposition@@IEAAX_KPEA_J@Z @ 0x1C01AF7A8 (-GetAnimationTime@CAnimationMarshaler@DirectComposition@@IEAAX_KPEA_J@Z.c)
 * Callees:
 *     ?CalculateAnimationTimeState@CAnimationMarshaler@DirectComposition@@IEAAXPEAVCAnimationTimeList@2@_KPEA_KPEA_NPEA_J2@Z @ 0x1C0091B48 (-CalculateAnimationTimeState@CAnimationMarshaler@DirectComposition@@IEAAXPEAVCAnimationTimeList@.c)
 */
        ...
        unsigned __int64 *a4)
{
  ...
  if ( (*(_DWORD *)(*((_QWORD *)this + 8) + 24LL) & 3) != 0 )
  {
    PerformanceCounter = KeQueryPerformanceCounter(0LL);
    v9 = (struct DirectComposition::CAnimationTimeList *)*((_QWORD *)this + 8);
