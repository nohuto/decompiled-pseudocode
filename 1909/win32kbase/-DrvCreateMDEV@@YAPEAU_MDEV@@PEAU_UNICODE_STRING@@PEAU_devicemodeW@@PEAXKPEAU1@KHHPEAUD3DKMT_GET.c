/*
 * XREFs of ?DrvCreateMDEV@@YAPEAU_MDEV@@PEAU_UNICODE_STRING@@PEAU_devicemodeW@@PEAXKPEAU1@KHHPEAUD3DKMT_GETPATHSMODALITY@@@Z @ 0x1C0042E30
 * Callers:
 ...
 *     ?DxgkEngQueryWin32Info@@YAJPEAU_DXGK_QUERY_WIN32_INFO@@@Z @ 0x1C003E290 (-DxgkEngQueryWin32Info@@YAJPEAU_DXGK_QUERY_WIN32_INFO@@@Z.c)
 ...
 *     UserSetScaleFactorsFromRemoteMetric @ 0x1C00441B8 (UserSetScaleFactorsFromRemoteMetric.c)
 ...
 *     ?IsPrimaryPathInCloneGroup@@YAEPEBUD3DKMT_GETPATHSMODALITY@@I@Z @ 0x1C00449F0 (-IsPrimaryPathInCloneGroup@@YAEPEBUD3DKMT_GETPATHSMODALITY@@I@Z.c)
 ...
 *     ?FillDpiInfo@@YAXAEBUtagSIZE@@0PEBU_DPI_SCALE_FACTOR_COLLECTION@@IIIHPEAU_DPI_INFORMATION@@@Z @ 0x1C00B66DC (-FillDpiInfo@@YAXAEBUtagSIZE@@0PEBU_DPI_SCALE_FACTOR_COLLECTION@@IIIHPEAU_DPI_INFORMATION@@@Z.c)
 ...
 *     ?MapMonitorToUnifromSpaceInStripe@@YAXPEAU_MDEV@@KKHK@Z @ 0x1C01295FC (-MapMonitorToUnifromSpaceInStripe@@YAXPEAU_MDEV@@KKHK@Z.c)
 */
        ...
        struct D3DKMT_GETPATHSMODALITY *a9)
{
  ...
  struct _devicemodeW *v153; // rbx
  int v154; // eax
  struct PDEV *v155; // rax
  struct _devicemodeW *v156; // rbx
  int v157; // eax
  int v158; // eax
  ...
  int v194; // [rsp+38h] [rbp-D0h]
  struct _DPI_INFORMATION *v195; // [rsp+40h] [rbp-C8h]
  int v196; // [rsp+40h] [rbp-C8h]
  int v197; // [rsp+58h] [rbp-B0h]
  unsigned int v198; // [rsp+5Ch] [rbp-ACh]
  struct tagSIZE v199; // [rsp+60h] [rbp-A8h] BYREF
  int v200; // [rsp+68h] [rbp-A0h]
  int v201; // [rsp+6Ch] [rbp-9Ch]
  int PruneFlag; // [rsp+70h] [rbp-98h]
  unsigned int v203; // [rsp+74h] [rbp-94h]
  __int64 v204; // [rsp+78h] [rbp-90h]
  HDEV v205; // [rsp+80h] [rbp-88h] BYREF
  void *Buf2; // [rsp+88h] [rbp-80h]
  unsigned int v207; // [rsp+90h] [rbp-78h] BYREF
  int v208; // [rsp+94h] [rbp-74h]
  int v209; // [rsp+98h] [rbp-70h]
  struct _devicemodeW *v210; // [rsp+A0h] [rbp-68h]
  int v211; // [rsp+A8h] [rbp-60h] BYREF
  unsigned int v212; // [rsp+ACh] [rbp-5Ch] BYREF
  int v213; // [rsp+B0h] [rbp-58h]
  struct tagSIZE v214; // [rsp+B8h] [rbp-50h]
  int v215; // [rsp+C0h] [rbp-48h]
  struct tagSIZE v216; // [rsp+C8h] [rbp-40h] BYREF
  _DWORD v217[2]; // [rsp+D0h] [rbp-38h] BYREF
  struct tagSIZE *v218; // [rsp+D8h] [rbp-30h]
  struct tagSIZE v219[13]; // [rsp+E0h] [rbp-28h] BYREF
  PCUNICODE_STRING String1a; // [rsp+158h] [rbp+50h]
  unsigned int v224; // [rsp+168h] [rbp+60h]
  unsigned int v226; // [rsp+170h] [rbp+68h]
  struct _MDEV *v227; // [rsp+178h] [rbp+70h]
  int v228; // [rsp+178h] [rbp+70h]
      ...
      while ( 1 )
      {
        ...
        if ( a1 )
        {
          if ( !v24 )
          {
            ...
            v20 = a6;
            v214 = (struct tagSIZE)DeviceFromName;
            v18 = a5 != 0LL ? v198 : 0;
            v19 = 0LL;
            v198 = v18;
        ...
        if ( v13 )
        {
          ...
          v138 = (struct NSInstrumentation::CReferenceTracker::CReferenceCountedType::SCircularBuffer *)*((_QWORD *)v28 + 443);
          ++*((_DWORD *)v28 + 3);
          ++*((_DWORD *)v28 + 2);
          TrackObjectReferenceIncrement(1u, v138);
          ...
          v139 = (struct _ERESOURCE *)*((_QWORD *)v28 + 6);
          if ( v139 )
          {
          ...
          v15 = v198;
          v20 = a6;
          v140 = (*((_DWORD *)DeviceFromName + 40) >> 2) & 1;
          v207 = 1;
          v212 = v140;
          goto LABEL_15;
        }
...
LABEL_15:
        if ( v22 == 4 )
        {
          if ( v28 )
          {
            v141 = WdLogNewEntry5_WdAssertion(v15, v18, v24);
...
LABEL_120:
          if ( DeviceFromName && (*((_DWORD *)DeviceFromName + 41) & 1) == 0 )
          {
            ...
            {
              v142 = WdLogNewEntry5_WdAssertion(v87, v84, v85);
            ...
            {
              v143 = WdLogNewEntry5_WdAssertion(0x1000000000LL, v84, v85);
              WdLogEvent5_WdAssertion(v143);
            }
            if ( !*(_QWORD *)((char *)v21 + v89 + 272) )
            {
              v144 = WdLogNewEntry5_WdAssertion(v88, v84, v85);
...
LABEL_225:
          ...
          {
            v148 = WdLogNewEntry5_WdAssertion(v146, v145, v147);
          ...
          if ( (unsigned __int16)v19 < *((_WORD *)v21 + 10) )
          {
            do
            {
              v149 = 272LL * (unsigned __int16)v15;
              if ( *(_DWORD *)((char *)v21 + v149 + 232) == *((_DWORD *)v21 + 68 * v81 + 58) )
                *(_DWORD *)((char *)v21 + v149 + 240) = -1073741823;
              LOWORD(v15) = v15 + 1;
            }
...
LABEL_136:
          ...
          *(_QWORD *)(56LL * *(unsigned int *)(v16 + 20) + v16 + 48) = v205;
          v101 = *(_DWORD *)(v16 + 20);
          if ( v101 + 2 >= v101 )
          {
        ...
        if ( gForceDisconnect != (_DWORD)v19 || v22 == 3 )
          ...
          v31 = gProtocolType;
        PrimaryAttachFlags = GetPrimaryAttachFlags((struct tagGRAPHICS_DEVICE *)DeviceFromName, v31, &v212, &v207);
        v19 = 0LL;
        ...
        else
        {
          if ( v22 != 2 )
          {
            v151 = WdLogNewEntry5_WdAssertion(v15, v18, v24);
            WdLogEvent5_WdAssertion(v151);
            v19 = 0LL;
            if ( (*((_DWORD *)DeviceFromName + 40) & 8) != 0 || (_DWORD)v204 )
              goto LABEL_27;
            goto LABEL_96;
          }
          v150 = *((_DWORD *)DeviceFromName + 40);
          if ( (v150 & 8) == 0 )
          {
            if ( (v150 & 0x2000000) != 0 || (_DWORD)v204 || gProtocolType == -1 )
              goto LABEL_27;
            goto LABEL_96;
          }
          if ( !v207 )
...
LABEL_96:
        ...
        {
          v76 = v210;
          memset(v210, 0, sizeof(struct _devicemodeW));
          v77 = v76;
          v76->dmSize = 220;
        }
        v78 = DrvProbeAndCaptureDevmode(
                (struct tagGRAPHICS_DEVICE *)DeviceFromName,
                (struct _devicemodeW **)&v199,
                &v211,
                0LL,
                v77,
                0,
...
LABEL_104:
        ...
        if ( v78 == -1073741776 )
        {
          v152 = *(struct _devicemodeW **)(*(_QWORD *)(v16 + 40) + 2592LL);
          if ( *(_QWORD *)&v199 && *(struct _devicemodeW **)&v199 != v210 )
          {
            Win32FreePool(*(_QWORD *)&v199);
            v199 = 0LL;
          }
          v78 = DrvProbeAndCaptureDevmode(
                  (struct tagGRAPHICS_DEVICE *)DeviceFromName,
...
LABEL_105:
        ...
        if ( !v28 )
        {
          ...
          memset(v210, 0, sizeof(struct _devicemodeW));
          v153->dmSize = 220;
          v154 = DrvProbeAndCaptureDevmode(
                   (struct tagGRAPHICS_DEVICE *)DeviceFromName,
                   (struct _devicemodeW **)&v199,
                   &v211,
                   0LL,
          ...
          if ( v154 >= 0 )
          {
            v155 = hCreateHDEV(
                     ...
                     *(struct _devicemodeW **)&v199,
                     ...
                     &v205);
            Buf2 = v155;
            if ( v155 || v79->dmPelsWidth == 640 && v79->dmPelsHeight == 480 && v79->dmBitsPerPel == 4 )
            {
LABEL_272:
              v28 = (HDEV)v155;
            }
            else
            {
              ...
              v156->dmSize = 220;
              v157 = v201;
              v156->dmBitsPerPel = (*((_DWORD *)DeviceFromName + 40) & 0x800000) != 0 ? 32 : 4;
              v196 = a7;
              v194 = PruneFlag;
              v156->dmPelsWidth = 640;
              v156->dmPelsHeight = 480;
              v156->dmFields = 1835008;
              v158 = DrvProbeAndCaptureDevmode(
                       (struct tagGRAPHICS_DEVICE *)DeviceFromName,
                       (struct _devicemodeW **)&v199,
                       &v211,
                       0LL,
          ...
          {
            v161 = 2LL;
            dmPelsHeight = v210->dmPelsHeight;
            dmPelsWidth = v210->dmPelsWidth;
          }
          DrvDxgkLogCodePointPacket(26LL, v161, dmPelsWidth, dmPelsHeight);
          v80 = 0LL;
LABEL_278:
          if ( !v28 && !v80 )
          {
...
LABEL_33:
      if ( v22 == 4 )
      {
        ...
        v164 = WdLogNewEntry5_WdError(v15, v18, v24);
        *(_QWORD *)(v164 + 24) = -1073741823LL;
...
LABEL_153:
    ...
    if ( v22 == 1 )
    {
      v162 = WdLogNewEntry5_WdTrace(v15);
...
LABEL_292:
  ...
  if ( !v25 )
  {
    v166 = WdLogNewEntry5_WdTrace(v15);
    WdLogEvent5_WdTrace(v166);
    goto LABEL_294;
  }
  v165 = WdLogNewEntry5_WdTrace(v15);
...
LABEL_37:
  if ( (a4 & 2) != 0 )
    goto LABEL_87;
  v226 = (unsigned int)v19;
  v227 = (struct _MDEV *)v19;
      ...
      if ( v44 )
      {
        if ( v45 )
        {
          ...
          *(_DWORD *)(*(_QWORD *)(*(_QWORD *)&v54 + 2576LL) + 160LL) |= 4u;
            ...
            do
            {
              ...
              if ( (*(_DWORD *)(*(_QWORD *)(v56 + 2576) + 160LL) & 0x800000) != 0 )
              {
                ...
                *(_DWORD *)(v56 + 2548) = *(_DWORD *)(v56 + 2548) & 0xFFFFFFDF | v57;
                a6 = ((__int64 (__fastcall *)(_QWORD, _QWORD, __int64))qword_1C0212218)(
                       *(_QWORD *)(*(_QWORD *)(v56 + 2576) + 240LL),
                       *(unsigned int *)(*(_QWORD *)(v56 + 2576) + 256LL),
                       v56 + 2136);
                if ( a6 < 0 )
                {
                  v169 = (_QWORD *)WdLogNewEntry5_WdError(v59, v58, v60);
                  v169[3] = a6;
                  v169[4] = *(_QWORD *)(*(_QWORD *)(v56 + 2576) + 240LL);
                  v169[5] = *(unsigned int *)(*(_QWORD *)(v56 + 2576) + 256LL);
              ...
              if ( v55 )
              {
                do
                {
                  ...
                  *(_WORD *)(v119 + 166) = gdmLogPixels;
                  if ( gDrvDpiWin8Style )
                  {
                    v170 = 100 * gdmLogPixels;
                    *(_DWORD *)(v118 + 2540) = 1234568;
                    *(_DWORD *)(v118 + 2464) = (v170 + 48) / 0x60u;
                  }
                  v55 = *(_DWORD *)(v16 + 20);
                  ++v116;
                }
          ...
          if ( (unsigned int)UserRemoteConnectedSessionUsingXddm() )
          {
            ...
            if ( v55 )
            {
              do
              {
                ...
                v214 = (struct tagSIZE)__PAIR64__(v124, v125);
                ...
                v205 = (HDEV)__PAIR64__(v126, v128);
                v199 = (struct tagSIZE)__PAIR64__(v126, v128);
                memset(v219, 0, 0x20uLL);
                v217[0] = 1;
                v218 = v219;
                v217[1] = 32;
                if ( (int)DxgkEngQueryWin32Info((struct _DXGK_QUERY_WIN32_INFO *)v217, v129, v130) < 0 )
                {
                  v171 = WdLogNewEntry5_WdAssertion(v132, v131, v133);
                  WdLogEvent5_WdAssertion(v171);
                }
                v195 = (struct _DPI_INFORMATION *)(v121 + 2456);
                if ( v122 )
                {
                  FillDpiInfo(&v216, &v199, (struct tagSIZE)v219, v134, 0, HIWORD(v122), v193, v195);
                ...
                else
                {
                  *(_DWORD *)(v121 + 2548) &= ~0x200u;
                  v120 = 0;
                  v228 = 0;
                  FillDpiInfo(&v216, &v199, (struct tagSIZE)v219, v134, gdmLogPixels, 0, v193, v195);
                }
          ...
          AlignRects(v46, v224);
          v44 = Buf2;
          if ( memcmp(v46, Buf2, 16LL * v224) )
          {
            v172 = WdLogNewEntry5_WdWarning();
          ...
          {
            v173 = PALLOCMEM2((unsigned int)(4 * *(_DWORD *)(v16 + 20)), 0x73726447u, 0);
            if ( v173 )
            {
              v174 = *(_DWORD *)(v16 + 20);
              v175 = 0;
              ...
              do
              {
                ...
                else
                {
                  do
                  {
                    ...
                    v179 = (unsigned int)v173[v178];
                    v180 = (unsigned int)v173[v177];
                    if ( *(_DWORD *)(56 * (v180 + 1) + v16) > *(_DWORD *)(56 * (v179 + 1) + v16) )
                    {
                      v173[v177] = v179;
                      v176 = 1;
                      v173[v178] = v180;
                  ...
                  while ( (unsigned int)v178 < v174 - 1 );
                }
              }
              while ( v176 );
              v46 = (struct tagRECT *)a9;
              ...
              {
LABEL_344:
                v188 = &v173[(unsigned int)v182];
                MapMonitorToUnifromSpaceInStripe((struct _MDEV *)v16, *v188, 0xFFFFFFFF, 0, Src);
                v189 = v182;
                if ( (unsigned int)v182 < *(_DWORD *)(v16 + 20) - 1 )
                {
                  do
                  {
                    v190 = (unsigned int)(v189 + 1);
                    MapMonitorToUnifromSpaceInStripe((struct _MDEV *)v16, v173[v190], v173[v189], 1, Srca);
                    v189 = v190;
                  }
                  while ( (unsigned int)v190 < *(_DWORD *)(v16 + 20) - 1 );
                  v46 = (struct tagRECT *)a9;
                }
                while ( (_DWORD)v182 )
                {
                  v182 = (unsigned int)(v182 - 1);
                  MapMonitorToUnifromSpaceInStripe((struct _MDEV *)v16, v173[v182], *v188--, 0, Srca);
                }
                *(_DWORD *)(v16 + 16) |= 2u;
                *(_DWORD *)(v16 + 32) = 96;
              ...
              else
              {
                while ( 1 )
                {
                  ...
                  v185 = 56 * ((unsigned int)v173[v183] + 1LL);
                  v186 = 56 * ((unsigned int)v173[v184] + 1LL);
                  v187 = *(_DWORD *)(v186 + v16);
                  if ( *(_DWORD *)(v185 + v16 + 8) != v187 )
                    break;
                  if ( *(_DWORD *)(v185 + v16) || *(_DWORD *)(v185 + v16 + 4) )
                  {
                    if ( !v187 && !*(_DWORD *)(v186 + v16 + 4) )
                      LODWORD(v182) = v183 + 1;
                  }
                  else
                  {
                  ...
                  ++v183;
                  if ( (unsigned int)v184 >= v181 )
                    goto LABEL_344;
                }
              }
              Win32FreePool((__int64)v173);
              v44 = Buf2;
            }
          }
          else
