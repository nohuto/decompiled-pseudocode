/*
 * XREFs of ?StopAndEndInertia@CTouchProcessor@@QEAAHIPEAX@Z @ 0x1C0172ABC
 * Callers:
...
__int64 __fastcall CTouchProcessor::StopAndEndInertia(CTouchProcessor *this, int a2, void *a3)
{
  ...
  if ( WPP_RECORDER_INITIALIZED != (_UNKNOWN *)&WPP_RECORDER_INITIALIZED )
  {
    v20 = a2;
    LOBYTE(a2) = 4;
    WPP_RECORDER_SF_D((_DWORD)gBaseLog, a2, 7, 305, (__int64)&WPP_dde6ae6ba4d53e169de0efe5dbb74602_Traceguids, v20);
  }
...
LABEL_9:
    ...
    {
      LOBYTE(v5) = 2;
      WPP_RECORDER_SF_((_DWORD)gBaseLog, v5, 7, 306, (__int64)&WPP_dde6ae6ba4d53e169de0efe5dbb74602_Traceguids);
    }
  ...
  if ( WPP_RECORDER_INITIALIZED != (_UNKNOWN *)&WPP_RECORDER_INITIALIZED )
  {
    ...
    LOBYTE(v11) = 2;
LABEL_14:
    WPP_RECORDER_SF_((_DWORD)DeviceExtension, v11, 7, v13, (__int64)&WPP_dde6ae6ba4d53e169de0efe5dbb74602_Traceguids);
  }
LABEL_15:
  v8 = 0;
LABEL_16:
