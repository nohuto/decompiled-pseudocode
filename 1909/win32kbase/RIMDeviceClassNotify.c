/*
 * XREFs of RIMDeviceClassNotify @ 0x1C0056C30
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall RIMDeviceClassNotify(char *NotificationStructure, __int64 *Context, __int64 a3)
{
  ...
  if ( v11 )
  {
    ...
    if ( !v32 && dword_1C020CB50 > 4u && TlgKeywordOn((TraceLoggingHProvider)&dword_1C020CB50, 0x100uLL) )
    {
      v84 = 2LL;
      v83 = v86;
      v85 = *((_QWORD *)v33 + 1);
      v86[0] = *v33;
      v86[1] = 0;
      TlgWrite((TraceLoggingHProvider)&dword_1C020CB50, &unk_1C01E3246, 0LL, 0LL, 4u, &v82);
    }
  }
  else if ( dword_1C020CB50 > 4u && TlgKeywordOn((TraceLoggingHProvider)&dword_1C020CB50, 0x100uLL) )
  {
    ...
    v81[0] = *v31;
    v81[1] = 0;
    TlgWrite((TraceLoggingHProvider)&dword_1C020CB50, &unk_1C01E3212, 0LL, 0LL, 4u, &pData);
  }
      ...
      if ( v13 )
      {
        ...
        if ( (*((_DWORD *)v13 + 50) & 0x20) != 0 )
        {
            ...
            && TlgKeywordOn((TraceLoggingHProvider)&hProvider, 0x400000000000uLL) )
          {
            ...
            v54 = -v36;
            v75 = &v54;
            TlgWrite((TraceLoggingHProvider)&hProvider, &unk_1C01E313B, 0LL, 0LL, 0xAu, &v61);
          }
          if ( *((_BYTE *)v13 + 48) == 3 )
          {
            v48 = 0;
