/*
 * XREFs of ?ResetDragThresholds@CPTPEngine@@AEAAXPEAUPTPInput@@@Z @ 0x1C0195758
 * Callers:
    ...
    do
    {
      ...
      if ( (*(_DWORD *)v7 & 1) != 0 )
      {
        if ( (v8 & 2) == 0 )
        {
          *((_QWORD *)v7 + 1) = *v5;
          *((_QWORD *)v7 + 5) = *v5;
          CPTPEngine::SetupDragRectsForContact(this, (CPTPEngine *)((char *)this + 296 * v6 + 1160));
          v8 = *(_DWORD *)v7;
        }
