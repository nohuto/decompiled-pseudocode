/*
 * XREFs of ?InitializeSecurityDescriptor@RegistrarClient@CoreMessagingK@@CAJPEAU_SECURITY_DESCRIPTOR@@@Z @ 0x1C009BA98
 * Callers:
        ...
        PSECURITY_DESCRIPTOR SecurityDescriptor)
{
  ...
  v2 = RtlLengthSid(&unk_1C01D8868) + 20;
  ...
  if ( v3 >= 0 )
  {
    ...
    if ( v5 >= 0 )
    {
      v5 = RtlAddAccessAllowedAce(v4, 2u, 1u, &unk_1C01D8868);
      if ( v5 >= 0 )
      {
