/*
 * XREFs of ?SetIntegerProperty@CCompositionSkyBoxBrushMarshaler@DirectComposition@@UEAAJPEAVCApplicationChannel@2@I_JPEA_N@Z @ 0x1C01AD800
 * Callers:
 *     <none>
 * Callees:
 *     <none>
