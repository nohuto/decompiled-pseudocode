/*
 * XREFs of ?SendMousePerfSummaryTelemetry@MousePerfSummary@@AEAAXXZ @ 0x1C0191650
 * Callers:
 ...
 *     ?Reset@MousePerfSummary@@AEAAXXZ @ 0x1C0191584 (-Reset@MousePerfSummary@@AEAAXXZ.c)
 */
...
void __fastcall MousePerfSummary::SendMousePerfSummaryTelemetry(MousePerfSummary *this)
{
  ...
  if ( (unsigned __int64)(1000 * (PerformanceCounter.QuadPart - *((_QWORD *)this + 43))) / gliQpcFreq.QuadPart > 0x927C0
    || *((_DWORD *)this + 85) != *((_DWORD *)this + 84) )
  {
    if ( hProvider > 5u )
    {
      if ( TlgKeywordOn((TraceLoggingHProvider)&hProvider, 0x400000000000uLL) )
      {
        ...
        v70 = 8LL;
        v72 = 8LL;
        TlgWrite((TraceLoggingHProvider)&hProvider, &unk_1C01E685E, 0LL, 0LL, 0x20u, &pData);
      }
    }
    MousePerfSummary::Reset(this);
    *((_DWORD *)this + 84) = *((_DWORD *)this + 85);
    *((LARGE_INTEGER *)this + 43) = PerformanceCounter;
  }
}
