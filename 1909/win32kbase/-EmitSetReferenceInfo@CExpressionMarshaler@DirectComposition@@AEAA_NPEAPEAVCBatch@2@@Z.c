/*
 * XREFs of ?EmitSetReferenceInfo@CExpressionMarshaler@DirectComposition@@AEAA_NPEAPEAVCBatch@2@@Z @ 0x1C00084CC
 * Callers:
        ...
        struct DirectComposition::CBatch **a2)
{
  ...
  for ( ; *((_DWORD *)this + 51) < *((_DWORD *)this + 50); *((_DWORD *)this + 51) += v5 )
  {
    ...
    if ( v5 >= v6 )
      LODWORD(v5) = v6;
    DirectComposition::CBatch::EnsureBatchBuffer(a2, (unsigned int)(24 * v5 + 20), &v14);
    v7 = (char *)v14;
    v8 = 0;
    *(_DWORD *)v14 = 24 * v5 + 20;
    v9 = v7 + 20;
    ...
    *((_DWORD *)v7 + 3) = v5;
    for ( *((_DWORD *)v7 + 4) = *((_DWORD *)this + 50);
          v8 < (unsigned int)v5;
