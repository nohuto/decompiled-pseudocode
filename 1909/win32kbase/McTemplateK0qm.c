/*
 * XREFs of McTemplateK0qm @ 0x1C00BA80C
 * Callers:
 *     EtwTraceUiAuditWriteClipboard @ 0x1C00BA7B0 (EtwTraceUiAuditWriteClipboard.c)
 *     EtwTraceUiLimitWriteClipboard @ 0x1C00BA7E0 (EtwTraceUiLimitWriteClipboard.c)
 * Callees:
