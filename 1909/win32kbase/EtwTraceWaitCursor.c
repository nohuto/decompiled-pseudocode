/*
 * XREFs of EtwTraceWaitCursor @ 0x1C0094740
 * Callers:
 *     <none>
 * Callees:
 *     ?EtwpGetWaitCursorType@@YAKQEAUtagCURSOR@@@Z @ 0x1C010A550 (-EtwpGetWaitCursorType@@YAKQEAUtagCURSOR@@@Z.c)
...
void __fastcall EtwTraceWaitCursor(__int64 a1, struct tagCURSOR *a2)
{
    ...
    && (qword_1C020C428 & 0x8000000000040000uLL) == qword_1C020C428 )
  {
    ...
    if ( gpqCursor )
    {
      v6 = *((_QWORD *)gpqCursor + 14);
      if ( v6 )
        v7 = *(_QWORD *)(v6 + 16);
      else
        v7 = *((_QWORD *)gpqCursor + 12);
      W32kEtwWaitCursorThreadId = (unsigned int)PsGetThreadId(*(PETHREAD *)v7);
      W32kEtwWaitCursorProcessId = *(_DWORD *)(*(_QWORD *)(v7 + 416) + 56LL);
    }
    else
    {
