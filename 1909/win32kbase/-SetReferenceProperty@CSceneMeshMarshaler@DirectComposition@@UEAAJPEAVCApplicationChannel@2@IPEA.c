/*
 * XREFs of ?SetReferenceProperty@CSceneMeshMarshaler@DirectComposition@@UEAAJPEAVCApplicationChannel@2@IPEAVCResourceMarshaler@2@PEA_N@Z @ 0x1C01BA390
 * Callers:
 *     <none>
 * Callees:
  ...
  if ( !v9 )
  {
    if ( !a4
      || (*(unsigned __int8 (__fastcall **)(struct DirectComposition::CResourceMarshaler *, __int64))(*(_QWORD *)a4 + 120LL))(
           ...
           168LL) )
    {
      v21 = (struct DirectComposition::CResourceMarshaler *)*((_QWORD *)this + 6);
      if ( a4 != v21 )
      {
        if ( v21 )
  ...
  if ( !v10 )
  {
    if ( !a4
      || (*(unsigned __int8 (__fastcall **)(struct DirectComposition::CResourceMarshaler *, __int64))(*(_QWORD *)a4 + 120LL))(
           ...
           168LL) )
    {
      v20 = (struct DirectComposition::CResourceMarshaler *)*((_QWORD *)this + 7);
      if ( a4 != v20 )
      {
        if ( v20 )
  ...
  if ( !v11 )
  {
    if ( !a4
      || (*(unsigned __int8 (__fastcall **)(struct DirectComposition::CResourceMarshaler *, __int64))(*(_QWORD *)a4 + 120LL))(
           ...
           168LL) )
    {
      v19 = (struct DirectComposition::CResourceMarshaler *)*((_QWORD *)this + 8);
      if ( a4 != v19 )
      {
        if ( v19 )
  ...
  if ( !v13 )
  {
    if ( !a4
      || (*(unsigned __int8 (__fastcall **)(struct DirectComposition::CResourceMarshaler *, __int64))(*(_QWORD *)a4 + 120LL))(
           ...
           168LL) )
    {
      v17 = (struct DirectComposition::CResourceMarshaler *)*((_QWORD *)this + 10);
      if ( a4 != v17 )
      {
        if ( v17 )
    ...
    if ( v14 == 1
      && (!a4
       || (*(unsigned __int8 (__fastcall **)(struct DirectComposition::CResourceMarshaler *, __int64))(*(_QWORD *)a4 + 120LL))(
            ...
            168LL)) )
    {
      v15 = (struct DirectComposition::CResourceMarshaler *)*((_QWORD *)this + 12);
      if ( a4 != v15 )
      {
        if ( v15 )
...
LABEL_65:
  ...
  v16 = (struct DirectComposition::CResourceMarshaler *)*((_QWORD *)this + 11);
  if ( a4 != v16 )
  {
    if ( v16 )
