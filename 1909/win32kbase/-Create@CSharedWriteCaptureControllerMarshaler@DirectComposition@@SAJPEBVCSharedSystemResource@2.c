/*
 * XREFs of ?Create@CSharedWriteCaptureControllerMarshaler@DirectComposition@@SAJPEBVCSharedSystemResource@2@PEAPEAV12@@Z @ 0x1C01C4BCC
 * Callers:
 *     CreateSharedWriteCaptureControllerMarshaler @ 0x1C01C4D10 (CreateSharedWriteCaptureControllerMarshaler.c)
 * Callees:
