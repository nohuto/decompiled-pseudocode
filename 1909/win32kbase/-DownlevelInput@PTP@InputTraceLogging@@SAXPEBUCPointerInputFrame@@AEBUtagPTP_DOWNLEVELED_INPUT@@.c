/*
 * XREFs of ?DownlevelInput@PTP@InputTraceLogging@@SAXPEBUCPointerInputFrame@@AEBUtagPTP_DOWNLEVELED_INPUT@@_K@Z @ 0x1C0178310
 * Callers:
 ...
 *     ?PTPDownlevelActionToString@InputTraceLogging@@CAPEBDW4tagPTP_DOWNLEVEL_ACTION@@@Z @ 0x1C0179504 (-PTPDownlevelActionToString@InputTraceLogging@@CAPEBDW4tagPTP_DOWNLEVEL_ACTION@@@Z.c)
 */
        ...
        __int64 a3)
{
  ...
  if ( *(int *)a2 >= 0 )
  {
    if ( v3 <= 1 )
    {
      if ( dword_1C020CB50 > 4u && TlgKeywordOn((TraceLoggingHProvider)&dword_1C020CB50, 0x80uLL) )
      {
        if ( v14 )
          v16 = *(_QWORD *)(v14 + 104);
        else
        ...
        v23 = a3;
        v41 = v21;
        TlgWrite((TraceLoggingHProvider)&dword_1C020CB50, &unk_1C01E528C, 0LL, 0LL, v21, &pData);
      }
    }
    else if ( v3 == 2 && dword_1C020CB50 > 4u && TlgKeywordOn((TraceLoggingHProvider)&dword_1C020CB50, 0x80uLL) )
    {
      if ( v6 )
        v8 = *(_QWORD *)(v6 + 104);
      else
      ...
      v25 = a3;
      v41 = cData;
      TlgWrite((TraceLoggingHProvider)&dword_1C020CB50, &unk_1C01E52F4, 0LL, 0LL, cData, &pData);
    }
  }
}
