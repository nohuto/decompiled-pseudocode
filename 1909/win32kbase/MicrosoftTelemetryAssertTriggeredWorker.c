/*
 * XREFs of MicrosoftTelemetryAssertTriggeredWorker @ 0x1C01C8C10
 * Callers:
 ...
 *     TakeTelemetryAssertsLock @ 0x1C00B4F28 (TakeTelemetryAssertsLock.c)
...
LABEL_40:
  ...
  v20 = "<unknown>";
  if ( (unsigned int)dword_1C0245040 > 5 && TlgKeywordOn((TraceLoggingHProvider)&dword_1C0245040, 0x400000000000uLL) )
  {
    v21 = "<unknown>";
    v29 = 10;
    v30 = v15;
    ...
    TlgWrite((TraceLoggingHProvider)&dword_1C0245040, &unk_1C01E8690, 0LL, 0LL, 0xBu, &pData);
  }
  if ( TraceLoggingProviderEnabled((TraceLoggingHProvider)&dword_1C0245078, 0, 0LL) && !v19 && !KeGetCurrentIrql() )
  {
    v24 = DbgkWerCaptureLiveKernelDump(L"TELASSERT", 465LL, v15, g_ModuleName, v12, v13, v23, v23, v23);
    if ( (unsigned int)dword_1C0245040 > 5 && TlgKeywordOn((TraceLoggingHProvider)&dword_1C0245040, 0x400000000000uLL) )
    {
      v36 = 10;
      v37 = v15;
      ...
      v56 = 4LL;
      v58 = 4LL;
      TlgWrite((TraceLoggingHProvider)&dword_1C0245040, &unk_1C01E8627, 0LL, v25, cData, &v43);
    }
