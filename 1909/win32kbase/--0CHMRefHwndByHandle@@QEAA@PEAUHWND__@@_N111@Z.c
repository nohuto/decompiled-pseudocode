/*
 * XREFs of ??0CHMRefHwndByHandle@@QEAA@PEAUHWND__@@_N111@Z @ 0x1C00243F0
 * Callers:
 *     <none>
 * Callees:
 ...
 *     HMIsHandleEntrySecureWorker @ 0x1C0102E80 (HMIsHandleEntrySecureWorker.c)
 */
        ...
        bool a6)
{
  ...
  *((_QWORD *)this + 1) = 0LL;
  ...
  if ( WPP_RECORDER_INITIALIZED != (_UNKNOWN *)&WPP_RECORDER_INITIALIZED && LOWORD(WPP_GLOBAL_Control->DeviceType) )
  {
    ...
    WPP_RECORDER_SF_(
      ...
      20,
      10,
      (__int64)&WPP_cb4bf1212dce3af1ac37829981315776_Traceguids);
  }
  *(_QWORD *)this = 0LL;
  LODWORD(v10) = (unsigned __int16)v8;
  if ( (unsigned __int64)(unsigned __int16)v8 >= *((_QWORD *)gpsi + 1) )
    goto LABEL_15;
  v11 = (char *)qword_1C0210758 + (unsigned int)(unsigned __int16)v8 * dword_1C0210760;
  v12 = (char *)gpKernelHandleTable + 24 * ((__int64)((unsigned int)(unsigned __int16)v8 * dword_1C0210760) >> 5);
  ...
  *(_QWORD *)this = v13;
  ...
  v35 = *(_QWORD *)(ThreadWin32Thread + 400);
...
LABEL_14:
    ...
    || (v10 = *(struct tagPROCESSINFO **)(v17 + 416), *(PVOID *)v10 == gpepCSRSS) )
  {
    ...
    {
      CLockDomainSharedAllowAllRecursion<DLT_HANDLEMANAGER>::CLockDomainSharedAllowAllRecursion<DLT_HANDLEMANAGER>(&v34);
