/*
 * XREFs of ?Create@CSharedHolographicInteropTextureMarshaler@DirectComposition@@SAJPEBVCSharedSystemResource@2@PEAPEAV12@@Z @ 0x1C01C4738
 * Callers:
 *     CreateSharedHolographicInteropTextureMarshaler @ 0x1C01C4900 (CreateSharedHolographicInteropTextureMarshaler.c)
 * Callees:
