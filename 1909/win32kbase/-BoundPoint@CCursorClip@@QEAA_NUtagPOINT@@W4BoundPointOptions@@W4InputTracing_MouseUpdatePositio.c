/*
 * XREFs of ?BoundPoint@CCursorClip@@QEAA_NUtagPOINT@@W4BoundPointOptions@@W4InputTracing_MouseUpdatePositionReason@@PEAU2@@Z @ 0x1C0052AC0
 * Callers:
 *     <none>
 * Callees:
...
LABEL_4:
  ...
  if ( dword_1C020CB50 > 4u && TlgKeywordOn((TraceLoggingHProvider)&dword_1C020CB50, 0x40uLL) )
  {
    ...
    v38 = v19;
    v40 = v19;
    TlgWrite((TraceLoggingHProvider)&dword_1C020CB50, &unk_1C01E4FD8, 0LL, 0LL, 9u, &pData);
  }
  if ( a5->x != a2.x || a5->y != y )
    v10 = 1;
