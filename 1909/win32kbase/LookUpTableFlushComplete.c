/*
 * XREFs of LookUpTableFlushComplete @ 0x1C0246A80
 * Callers:
 ...
 *     ?TlgAggregateInternalProviderCallback@@YAXPEBU_GUID@@KE_K1PEAU_EVENT_FILTER_DESCRIPTOR@@PEAX@Z @ 0x1C0246060 (-TlgAggregateInternalProviderCallback@@YAXPEBU_GUID@@KE_K1PEAU_EVENT_FILTER_DESCRIPTOR@@PEAX@Z.c)
 *     TlgUnregisterAggregateProvider @ 0x1C0246928 (TlgUnregisterAggregateProvider.c)
 *     ?TlgAggregateInternalFlushWorkItemRoutineKernelMode@@YAXPEAX@Z @ 0x1C02473B0 (-TlgAggregateInternalFlushWorkItemRoutineKernelMode@@YAXPEAX@Z.c)
 * Callees:
 *     _TlgKeywordOn @ 0x1C0031E60 (_TlgKeywordOn.c)
 *     _TlgWrite @ 0x1C0084244 (_TlgWrite.c)
 *     __security_check_cookie @ 0x1C00B7F30 (__security_check_cookie.c)
 *     memset @ 0x1C00BF640 (memset.c)
 *     FlushLookUpTableBucket @ 0x1C01C86B4 (FlushLookUpTableBucket.c)
 *     UpdateInternalStatsOnFlush @ 0x1C024743C (UpdateInternalStatsOnFlush.c)
 */
...
_UNKNOWN **__fastcall LookUpTableFlushComplete(__int64 a1)
{
  ...
  if ( *(_DWORD *)(a1 + 256) )
  {
    ...
    if ( *(_QWORD *)(v4 + 288) )
    {
      if ( (unsigned int)dword_1C020C618 > 5 && TlgKeywordOn((TraceLoggingHProvider)&dword_1C020C618, 0x400000000000uLL) )
      {
        ...
        v32 = 4LL;
        v34 = 4LL;
        TlgWrite((TraceLoggingHProvider)&dword_1C020C618, &unk_1C01E84B2, 0LL, 0LL, 0xBu, &pData);
      }
