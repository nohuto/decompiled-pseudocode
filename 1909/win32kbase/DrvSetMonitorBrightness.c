/*
 * XREFs of DrvSetMonitorBrightness @ 0x1C00BC954
 * Callers:
      ...
      if ( *(_DWORD *)(v19 + 216) )
      {
        do
        {
          ...
          if ( (*(_DWORD *)(v20 + 20LL * v18) & 1) != 0
            ...
            && (int)((__int64 (__fastcall *)(__int64, _QWORD, PVOID *, PDEVICE_OBJECT *))qword_1C02121D8)(
                      v20 + 4 * (5LL * v18 + 2),
              ...
              if ( *(_QWORD *)(v19 + 144) )
              {
                  ...
                  && (*(_DWORD *)(v9 + 20) == 1 && *(_DWORD *)(v19 + 216) == 1 || !a4) )
                {
                  wil_details_FeaturePropertyCache_ReportUsageToService(
                    ...
                    0x801B31u,
                    (const struct FEATURE_LOGGED_TRAITS *)&unk_1C01D70BC,
                    1,
                    3);
                  v28[0] = 1;
                  v28[1] = a4;
