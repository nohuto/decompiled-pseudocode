/*
 * XREFs of ?CitpUpdateActiveBootId@@YAJIEPEAG0PEAX@Z @ 0x1C008128C
 * Callers:
 ...
 * Callees:
 *     ?CitpBytesToString@@YAXPEBXIPEAG@Z @ 0x1C00814B4 (-CitpBytesToString@@YAXPEBXIPEAG@Z.c)
...
__int64 __fastcall CitpUpdateActiveBootId(int a1, char a2, unsigned __int16 *a3, unsigned __int16 *a4)
{
  ...
  *(_QWORD *)&Handle.Length = 0LL;
  ...
  v11 = (const unsigned __int16 *)&stru_1C01E8A24.MatchAllKeyword + 2;
    ...
    *(_QWORD *)&DestinationString.Length = 0LL;
    ...
    if ( v13 )
    {
      ...
      if ( v15 == -1073741772 )
        v15 = 0;
      if ( v15 < 0 )
        CitpLogFailureWorker(v15, v16, 0x5CDu);
      goto LABEL_12;
    }
      ...
      if ( KeyInformation[8] > 8u )
      {
        ...
        while ( v4 < v21 )
        {
          ...
          *(_QWORD *)&Handle.Length = 0LL;
          ...
          {
            ++v24;
            CitpLogFailureWorker(v26, v27, 0x5B2u);
          }
          else
          {
            --v23;
