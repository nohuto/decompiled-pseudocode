/*
 * XREFs of ?Create@CSharedReadTransformMarshaler@DirectComposition@@SAJPEBVCSharedSystemResource@2@PEAPEAV12@@Z @ 0x1C0092E70
 * Callers:
 *     CreateSharedReadTransformMarshaler @ 0x1C0092E30 (CreateSharedReadTransformMarshaler.c)
 * Callees:
