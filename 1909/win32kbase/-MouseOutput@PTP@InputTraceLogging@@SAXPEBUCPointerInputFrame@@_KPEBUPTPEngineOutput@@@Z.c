/*
 * XREFs of ?MouseOutput@PTP@InputTraceLogging@@SAXPEBUCPointerInputFrame@@_KPEBUPTPEngineOutput@@@Z @ 0x1C0178BDC
 * Callers:
        ...
        const struct PTPEngineOutput *a3)
{
  ...
  if ( dword_1C020CB50 > 4u && TlgKeywordOn((TraceLoggingHProvider)&dword_1C020CB50, 0x80uLL) )
  {
    ...
    v38 = 4;
    v41 = 4;
    TlgWrite((TraceLoggingHProvider)&dword_1C020CB50, &unk_1C01E5225, 0LL, 0LL, 9u, &pData);
  }
}
