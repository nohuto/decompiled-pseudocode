/*
 * XREFs of HmgIncrementShareReferenceCount @ 0x1C0021040
 * Callers:
...
void __fastcall HmgIncrementShareReferenceCount(struct _BASEOBJECT *a1)
{
  ...
  if ( v20 )
  {
       ...
       || (RECALTLOCKSTACKBACKTRACE((unsigned __int16)*(_DWORD *)a1, a1), v5 = *((_BYTE *)v4 + 14), v5 == 5)) )
    {
      ...
      if ( v6 && qword_1C020D538 )
        NSInstrumentation::CReferenceTracker::CReferenceCountedType::ReferenceDereferenceCommon(qword_1C020D538, v6, 1);
    }
    else if ( v5 == 16 )
    {
