/*
 * XREFs of ?DispBrokerUpdateKernelDisplayPolicies@@YAXXZ @ 0x1C0063B28
 * Callers:
...
void DispBrokerUpdateKernelDisplayPolicies(void)
{
  ...
  v2 = *v0;
  ((void (__fastcall *)(__int64, bool))qword_1C0212318)(1LL, *v0 != 0);
  ((void (__fastcall *)(__int64, bool))qword_1C0212318)(2LL, v2 == 0);
  LOBYTE(v1) = v2 <= 1;
  ((void (__fastcall *)(__int64, _QWORD))qword_1C0212318)(3LL, v1);
  ((void (__fastcall *)(__int64, _QWORD))qword_1C0212318)(
    4LL,
