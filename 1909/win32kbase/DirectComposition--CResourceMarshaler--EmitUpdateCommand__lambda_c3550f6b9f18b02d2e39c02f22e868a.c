/*
 * XREFs of DirectComposition::CResourceMarshaler::EmitUpdateCommand__lambda_c3550f6b9f18b02d2e39c02f22e868a9___ @ 0x1C01AC7DC
 * Callers:
        ...
        __int64 *a3)
{
  ...
  *((_DWORD *)v5 + 2) = *(_DWORD *)(*a3 + 24);
  v6 = *a3;
  *(_QWORD *)(v5 + 12) = *(_QWORD *)(*a3 + 136);
  *((_DWORD *)v5 + 5) = *(_DWORD *)(v6 + 144);
  return 1;
}
