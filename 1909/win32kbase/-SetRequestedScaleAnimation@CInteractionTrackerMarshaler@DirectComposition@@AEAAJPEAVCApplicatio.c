/*
 * XREFs of ?SetRequestedScaleAnimation@CInteractionTrackerMarshaler@DirectComposition@@AEAAJPEAVCApplicationChannel@2@PEAVCBaseExpressionMarshaler@2@PEA_N@Z @ 0x1C01ABA9C
 * Callers:
        ...
        bool *a4)
{
  ...
  else
  {
    ...
    v11 = (struct DirectComposition::CWeakReferenceBase *)*((_QWORD *)this + 26);
    if ( v11 )
