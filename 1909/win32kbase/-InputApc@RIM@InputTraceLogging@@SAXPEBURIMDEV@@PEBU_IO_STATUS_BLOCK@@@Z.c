/*
 * XREFs of ?InputApc@RIM@InputTraceLogging@@SAXPEBURIMDEV@@PEBU_IO_STATUS_BLOCK@@@Z @ 0x1C00A74E0
 * Callers:
...
void __fastcall InputTraceLogging::RIM::InputApc(const struct RIMDEV *a1, const struct _IO_STATUS_BLOCK *a2)
{
    ...
    if ( v3 == 2 )
    {
      if ( (*((_DWORD *)a1 + 50) & 0x80u) != 0 )
      {
        ...
        if ( dword_1C020CB50 > 4u && TlgKeywordOn((TraceLoggingHProvider)&dword_1C020CB50, 0x100uLL) )
        {
          ...
          v43 = &v29;
          v44 = v13;
          TlgWrite((TraceLoggingHProvider)&dword_1C020CB50, &unk_1C01E3538, 0LL, 0LL, 9u, &pData);
        }
      }
      else if ( dword_1C020CB50 > 4u )
      {
        if ( TlgKeywordOn((TraceLoggingHProvider)&dword_1C020CB50, 0x100uLL) )
        {
          ...
          *(_QWORD *)&pDesc.Size = v18;
          ...
          v39 = &v27;
          v40 = v18;
          TlgWrite((TraceLoggingHProvider)&dword_1C020CB50, &unk_1C01E35AB, 0LL, 0LL, 7u, &pData);
        }
      }
    }
    else if ( v3 == 1 && dword_1C020CB50 > 4u )
    {
      if ( TlgKeywordOn((TraceLoggingHProvider)&dword_1C020CB50, 0x100uLL) )
      {
        v30 = v24;
        ...
        v35 = v23;
        v37 = 8LL;
        TlgWrite((TraceLoggingHProvider)&dword_1C020CB50, &unk_1C01E35FD, 0LL, 0LL, 5u, &pData);
      }
    }
  }
  else if ( dword_1C020CB50 > 4u )
  {
    if ( TlgKeywordOn((TraceLoggingHProvider)&dword_1C020CB50, 0x100uLL) )
    {
      ...
      v35 = v4;
      v37 = 8LL;
      TlgWrite((TraceLoggingHProvider)&dword_1C020CB50, &unk_1C01E34F6, 0LL, 0LL, 5u, &pData);
    }
  }
}
