/*
 * XREFs of ?PopulatePointerInfoNode@CTouchProcessor@@QEAAHPEAUCPointerInputFrame@@PEAUCPointerInfoNode@@K@Z @ 0x1C016C9CC
 * Callers:
 ...
 *     ?GetButtonChange@CTouchProcessor@@AEAA?AW4tagPOINTER_BUTTON_CHANGE_TYPE@@KK@Z @ 0x1C01671F8 (-GetButtonChange@CTouchProcessor@@AEAA-AW4tagPOINTER_BUTTON_CHANGE_TYPE@@KK@Z.c)
        ...
        struct CPointerInfoNode *a3)
{
  ...
  if ( (*((_DWORD *)a2 + 28) & 1) == 0 )
    MicrosoftTelemetryAssertTriggeredNoArgsKM(v7, v6, v8);
  v10 = &WPP_dde6ae6ba4d53e169de0efe5dbb74602_Traceguids;
  ...
  *((_DWORD *)a3 + 2) = -1;
  ...
  this[2] = *(struct _KTHREAD **)(*(_QWORD *)(*((_QWORD *)a2 + 18) + 16LL) + 1344LL);
...
LABEL_56:
  ...
  if ( (*((_DWORD *)a3 + 47) & 2) != 0 || (*((_DWORD *)a3 + 1) & 0x200) == 0 || *((_QWORD *)a3 + 25) )
  {
    if ( WPP_RECORDER_INITIALIZED == (_UNKNOWN *)&WPP_RECORDER_INITIALIZED )
      goto LABEL_75;
    LOBYTE(v11) = 2;
    WPP_RECORDER_SF_L(updated, v11, 7, 51, (__int64)&WPP_dde6ae6ba4d53e169de0efe5dbb74602_Traceguids, *v13);
  }
  if ( WPP_RECORDER_INITIALIZED != (_UNKNOWN *)&WPP_RECORDER_INITIALIZED && LOWORD(WPP_GLOBAL_Control->DeviceType) )
  {
    LOBYTE(v11) = 5;
