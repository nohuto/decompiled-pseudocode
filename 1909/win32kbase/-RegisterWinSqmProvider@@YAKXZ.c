/*
 * XREFs of ?RegisterWinSqmProvider@@YAKXZ @ 0x1C00A30D4
 * Callers:
...
__int64 __fastcall RegisterWinSqmProvider(__int64 a1, __int64 a2, __int64 a3)
{
  ...
  v4 = _InterlockedCompareExchange64(&qword_1C0215848, 255LL, 0LL);
  if ( v4 )
  {
    switch ( v4 )
    {
      ...
      case 255LL:
        ...
        do
        {
          ...
          v7 = _InterlockedExchange64(&qword_1C0215848, qword_1C0215848);
          if ( v7 != 255 )
            break;
          ++v3;
        }
        while ( v3 < 10 );
        if ( v3 == 10 )
          v7 = _InterlockedCompareExchange64(&qword_1C0215848, 204LL, 255LL);
  ...
  else
  {
    ...
    if ( (unsigned int)IsSessionDisabled(0LL, 0) )
      dword_1C0212B38 |= 1u;
    _InterlockedExchange64(&qword_1C0215848, v5 != 0 ? 238LL : 221LL);
  }
  return v5;
}
