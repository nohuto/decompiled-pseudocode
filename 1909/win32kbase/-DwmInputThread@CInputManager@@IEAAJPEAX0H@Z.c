/*
 * XREFs of ?DwmInputThread@CInputManager@@IEAAJPEAX0H@Z @ 0x1C01C53E0
 * Callers:
 ...
 *     ?ValidateUserEvent@CInputManager@@CAJPEAXPEAPEAX@Z @ 0x1C01C5B78 (-ValidateUserEvent@CInputManager@@CAJPEAXPEAPEAX@Z.c)
