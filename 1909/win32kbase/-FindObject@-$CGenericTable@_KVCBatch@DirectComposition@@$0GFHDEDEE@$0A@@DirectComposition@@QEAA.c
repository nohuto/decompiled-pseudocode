/*
 * XREFs of ?FindObject@?$CGenericTable@_KVCBatch@DirectComposition@@$0GFHDEDEE@$0A@@DirectComposition@@QEAAPEAVCBatch@2@_K@Z @ 0x1C007BB1C
 * Callers:
 ...
 *     ?NotifyPresent@CSynchronizationManager@DirectComposition@@SAX_K_N@Z @ 0x1C007BA7C (-NotifyPresent@CSynchronizationManager@DirectComposition@@SAX_K_N@Z.c)
 * Callees:
 *     <none>
 */
