/*
 * XREFs of bDynamicModeChange @ 0x1C00686C0
 * Callers:
 ...
 *     ?SETFLAG@@YAXHAECKK@Z @ 0x1C0069C2C (-SETFLAG@@YAXHAECKK@Z.c)
 ...
 *     ?bDynamicIntersectVisRect@@YAHPEAVSURFACE@@UtagSIZE@@@Z @ 0x1C0126420 (-bDynamicIntersectVisRect@@YAHPEAVSURFACE@@UtagSIZE@@@Z.c)
...
LABEL_112:
  ...
  *(_DWORD *)(v7 + 120) = 0;
  *(_QWORD *)(v41 + 248) = 0LL;
  EBRUSHOBJ::vInitBrush((char *)a1 + 1544, v7, v39, ppalDefault, v40, v28, 1);
  EBRUSHOBJ::vInitBrush((char *)a2 + 1544, v7, v39, ppalDefault, v124, v29, 1);
