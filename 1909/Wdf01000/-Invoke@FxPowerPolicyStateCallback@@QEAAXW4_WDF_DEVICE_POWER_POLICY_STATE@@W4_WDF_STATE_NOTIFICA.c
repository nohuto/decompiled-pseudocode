/*
 * XREFs of ?Invoke@FxPowerPolicyStateCallback@@QEAAXW4_WDF_DEVICE_POWER_POLICY_STATE@@W4_WDF_STATE_NOTIFICATION_TYPE@@PEAUWDFDEVICE__@@PEBU_WDF_DEVICE_POWER_POLICY_NOTIFICATION_DATA@@@Z @ 0x1C007FB84
 * Callers:
        ...
        const _WDF_DEVICE_POWER_POLICY_NOTIFICATION_DATA *NotificationData)
{
  ...
  if ( v6 )
  {
    if ( (Type & *((_DWORD *)&this[-6] + 4 * v5 - 632)) != 0 )
