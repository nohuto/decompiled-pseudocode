/*
 * XREFs of ?FxVerifierDriverReportedBugcheck@@YAXPEAU_FX_DRIVER_GLOBALS@@K_K111@Z @ 0x1C005B810
 * Callers:
 *     imp_WdfCxVerifierKeBugCheck @ 0x1C004AC90 (imp_WdfCxVerifierKeBugCheck.c)
 *     imp_WdfVerifierKeBugCheck @ 0x1C004AD30 (imp_WdfVerifierKeBugCheck.c)
