/*
 * XREFs of imp_WdfFdoInitAllocAndQueryPropertyEx @ 0x1C0046850
 * Callers:
 *     <none>
 * Callees:
        ...
        unsigned int *Type)
{
  ...
  *PropertyMemory = 0LL;
  ...
  if ( result >= 0 )
  {
    if ( v10->FxVerifierOn )
    {
      if ( WPP_GLOBAL_WDF_Control.Dpc.DeferredRoutine )
        WPP_GLOBAL_WDF_Control.Dpc.DeferredRoutine((_KDPC *)(unsigned int)PoolType, retaddr, (void *)v10->Tag, v14);
    }
