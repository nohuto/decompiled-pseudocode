/*
 * XREFs of WPP_IFR_SF_dqqd @ 0x1C004FEF8
 * Callers:
 ...
 *     ?PowerPolSystemWakeDeviceToD0@FxPkgPnp@@KA?AW4_WDF_DEVICE_POWER_POLICY_STATE@@PEAV1@@Z @ 0x1C0017C80 (-PowerPolSystemWakeDeviceToD0@FxPkgPnp@@KA-AW4_WDF_DEVICE_POWER_POLICY_STATE@@PEAV1@@Z.c)
