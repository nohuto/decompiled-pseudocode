/*
 * XREFs of ?InitDevice@FxUsbDevice@@QEAAJK@Z @ 0x1C0075990
 * Callers:
...
LABEL_12:
  ...
  *(_WORD *)&CurrentStackLocation->MajorFunction = 2075;
  ...
  if ( v5 < 0 )
  {
    ...
    v25 = request.m_TrueRequest->m_Irp.m_Irp;
    v26 = v25->Tail.Overlay.CurrentStackLocation;
    v25->IoStatus.Status = -1073741637;
    --v26;
    *(_WORD *)&v26->MajorFunction = 2075;
    v26->Parameters.Read.ByteOffset.QuadPart = (__int64)&busIf;
    v26->Parameters.CreatePipe.Parameters = 0LL;
    v26->Parameters.Create.Options = 64;
    v26->Parameters.WMI.ProviderId = (unsigned __int64)&USB_BUS_INTERFACE_USBDI_GUID;
    FxRequestBase::VerifierSetFormatted(request.m_TrueRequest);
