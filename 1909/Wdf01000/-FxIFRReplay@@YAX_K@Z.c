/*
 * XREFs of ?FxIFRReplay@@YAX_K@Z @ 0x1C003E0C0
 * Callers:
...
void __fastcall FxIFRReplay(unsigned __int64 LoggerHandle)
{
  ...
  *(_QWORD *)&currentDriverUnicode.Length = 0LL;
  multiStringLength = 0;
  currentDriverUnicode.Buffer = 0LL;
  *(_QWORD *)&currentDriverAnsi.Length = 0LL;
  currentDriverAnsi.Buffer = 0LL;
