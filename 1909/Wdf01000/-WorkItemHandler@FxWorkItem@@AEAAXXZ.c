/*
 * XREFs of ?WorkItemHandler@FxWorkItem@@AEAAXXZ @ 0x1C001400C
 * Callers:
 *     ?WorkItemThunk@FxWorkItem@@CAXPEAU_DEVICE_OBJECT@@PEAX@Z @ 0x1C0013EF0 (-WorkItemThunk@FxWorkItem@@CAXPEAU_DEVICE_OBJECT@@PEAX@Z.c)
 * Callees:
...
void __fastcall FxWorkItem::WorkItemHandler(FxWorkItem *this)
{
  ...
  if ( m_CallbackLock )
  {
    ...
    v11 = *(void (__fastcall **)(void (__fastcall **)(WDFWORKITEM__ *), __int64, __int64, __int64, char))(unk_1C00AEEC0 + 24LL);
    if ( v11 )
  ...
  {
    v6 = *(void (__fastcall **)(void (__fastcall **)(WDFWORKITEM__ *), __int64, __int64, __int64, char))(unk_1C00AEEC0 + 24LL);
    if ( v6 )
