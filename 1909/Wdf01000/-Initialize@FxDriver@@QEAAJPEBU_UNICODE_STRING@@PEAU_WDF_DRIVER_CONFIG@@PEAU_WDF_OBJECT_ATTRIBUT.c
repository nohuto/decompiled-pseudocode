/*
 * XREFs of ?Initialize@FxDriver@@QEAAJPEBU_UNICODE_STRING@@PEAU_WDF_DRIVER_CONFIG@@PEAU_WDF_OBJECT_ATTRIBUTES@@@Z @ 0x1C005565C
 * Callers:
 ...
 *     ?ConfigureConstraints@FxDriver@@QEAAXPEAU_WDF_OBJECT_ATTRIBUTES@@@Z @ 0x1C0055520 (-ConfigureConstraints@FxDriver@@QEAAXPEAU_WDF_OBJECT_ATTRIBUTES@@@Z.c)
 ...
 *     ?AllocateDriverObjectExtensionAndStoreFxDriver@FxDriver@@QEAAJXZ @ 0x1C00572C8 (-AllocateDriverObjectExtensionAndStoreFxDriver@FxDriver@@QEAAJXZ.c)
 */
        ...
        _WDF_OBJECT_ATTRIBUTES *DriverAttributes)
{
  ...
  __int64 (__fastcall *v11)(_DEVICE_OBJECT *, _IRP *); // r8
    ...
    if ( DriverObjectExtensionAndStoreFxDriver >= 0 )
    {
      ...
      if ( DriverObjectExtensionAndStoreFxDriver >= 0 )
      {
        ...
        if ( ArgRegistryPath )
        {
          ...
          v16 = (wchar_t *)FxPoolAllocator(v14, &v14->FxPoolFrameworks, 1u, v15, v14->Tag, Caller);
          this->m_RegistryPath.Buffer = v16;
          if ( v16 )
          {
        ...
        else if ( DriverObjectExtensionAndStoreFxDriver >= 0 )
        {
          ...
          if ( (v17 & 2) == 0 )
          {
            ...
            do
            {
              v11 = FxDevice::DispatchWithLock;
              *(_QWORD *)((char *)&this->m_DriverObject.m_DriverObject->Type + v19) = FxDevice::DispatchWithLock;
              v19 += 8LL;
              --v17;
            }
            while ( v17 );
