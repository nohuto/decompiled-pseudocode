/*
 * XREFs of imp_WdfDeviceResumeIdleActual @ 0x1C0017020
 * Callers:
 *     <none>
 * Callees:
        ...
        char *File)
{
  ...
  v10 = *(FxPowerIdleMachine **)(*(_QWORD *)&v8[6].m_ObjectFlags + 888LL);
  if ( v10 )
  {
    FxPowerIdleMachine::IoDecrement(v10, Tag, Line, File);
    v11 = *((_QWORD *)PPObject + 81);
    if ( *(_BYTE *)(v11 + 1236) == 1
      && _InterlockedExchangeAdd((volatile signed __int32 *)(v11 + 1232), 0xFFFFFFFF) == 1 )
    {
      v12 = *(_QWORD *)(v11 + 1224);
      if ( v12 )
      {
