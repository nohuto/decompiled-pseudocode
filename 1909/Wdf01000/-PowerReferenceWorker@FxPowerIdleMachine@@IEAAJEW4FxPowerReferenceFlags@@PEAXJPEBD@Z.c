/*
 * XREFs of ?PowerReferenceWorker@FxPowerIdleMachine@@IEAAJEW4FxPowerReferenceFlags@@PEAXJPEBD@Z @ 0x1C0012130
 * Callers:
 *     ?DispatchEvents@FxIoQueue@@QEAAEEPEAVFxRequest@@@Z @ 0x1C0008860 (-DispatchEvents@FxIoQueue@@QEAAEEPEAVFxRequest@@@Z.c)
 *     ?SetTransitionFromEmpty@FxIoQueue@@AEAAXXZ @ 0x1C0014488 (-SetTransitionFromEmpty@FxIoQueue@@AEAAXXZ.c)
    ...
    else
    {
      ...
      if ( (v32 & 0x10) != 0 )
      {
        if ( FxVerboseOn )
        {
          ...
          if ( !v37 )
            v38 = 0LL;
          WPP_IFR_SF_qid(v34, 5u, 0xCu, 0xDu, WPP_PowerIdleStateMachine_cpp_Traceguids, v38, (__int64)_a2a, -1073741101);
        }
      }
      else if ( FxVerboseOn )
      {
        ...
        v40 = WORD1(v39[1].Next);
        v41 = (const void *)((unsigned __int64)v39 ^ 0xFFFFFFFFFFFFFFF8uLL);
        if ( !v40 )
          v41 = 0LL;
        WPP_IFR_SF_qid(v34, 5u, 0xCu, 0xEu, WPP_PowerIdleStateMachine_cpp_Traceguids, v41, (__int64)_a2b, -1073741101);
      }
      --this->m_IoCount;
