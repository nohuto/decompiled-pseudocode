/*
 * XREFs of StopIdleWorker @ 0x1C0047ED8
 * Callers:
 *     imp_WdfDeviceStopIdleNoTrack @ 0x1C0049F70 (imp_WdfDeviceStopIdleNoTrack.c)
 * Callees:
        ...
        char *File)
{
  ...
  if ( p_m_PowerIdleMachine )
  {
    ...
    if ( m_Globals->FxVerboseOn )
      WPP_IFR_SF_qdd(m_Globals, 5u, 0x12u, 0x26u, WPP_FxDeviceApi_cpp_Traceguids, Device, WaitForD0, _a3);
    if ( v13 >= 0 )
    {
