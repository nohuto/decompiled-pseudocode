/*
 * XREFs of ?EndScan@FxChildList@@QEAAXPEAK@Z @ 0x1C00035F8
 * Callers:
 ...
 *     ?MarkDescriptionNotPresentWorker@FxChildList@@IEAAXPEAUFxDeviceDescriptionEntry@@E@Z @ 0x1C003CC1C (-MarkDescriptionNotPresentWorker@FxChildList@@IEAAXPEAUFxDeviceDescriptionEntry@@E@Z.c)
 *     ?MarkModificationNotPresentWorker@FxChildList@@IEAAXPEAU_LIST_ENTRY@@PEAUFxDeviceDescriptionEntry@@@Z @ 0x1C003CC70 (-MarkModificationNotPresentWorker@FxChildList@@IEAAXPEAU_LIST_ENTRY@@PEAUFxDeviceDescriptionEntr.c)
      ...
      else if ( (unsigned int)(LODWORD(i[1].Flink) - 1) <= 1 && !LOBYTE(i[5].Flink) )
      {
        ...
        if ( v25 )
        {
          if ( FxVerboseOn )
          {
            ...
            if ( !WORD1(v25->Blink) )
              v27 = 0LL;
            WPP_IFR_SF_qq(v24, 5u, 0xCu, 0xFu, WPP_FxChildList_cpp_Traceguids, v27, v25[9].Flink);
          }
        }
        else if ( FxVerboseOn )
        {
          WPP_IFR_SF_q(v24, 5u, 0xCu, 0x10u, WPP_FxChildList_cpp_Traceguids, i);
        }
