/*
 * XREFs of ?PnpQueryDeviceRelations@FxPkgPdo@@AEAAJPEAVFxIrp@@@Z @ 0x1C0003A84
 * Callers:
 *     ?_PnpQueryDeviceRelations@FxPkgPdo@@CAJPEAVFxPkgPnp@@PEAVFxIrp@@@Z @ 0x1C0003A70 (-_PnpQueryDeviceRelations@FxPkgPdo@@CAJPEAVFxPkgPnp@@PEAVFxIrp@@@Z.c)
 * Callees:
  ...
  if ( Length )
  {
    ...
    else if ( Length == 4 )
    {
      ...
      else
      {
        ...
        if ( !m_ObjectSize )
          _a1 = 0LL;
        WPP_IFR_SF_qL(this->m_Globals, 2u, 0xCu, 0xBu, WPP_FxPkgPdo_cpp_Traceguids, _a1, 0xC000009A);
      }
    }
  }
  else
