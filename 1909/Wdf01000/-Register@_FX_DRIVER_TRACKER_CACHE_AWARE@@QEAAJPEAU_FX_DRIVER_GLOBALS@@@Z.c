/*
 * XREFs of ?Register@_FX_DRIVER_TRACKER_CACHE_AWARE@@QEAAJPEAU_FX_DRIVER_GLOBALS@@@Z @ 0x1C0094760
 * Callers:
 *     FxRegisterBugCheckCallback @ 0x1C0094CB8 (FxRegisterBugCheckCallback.c)
 * Callees:
 *     WdmlibProcgrpInitialize @ 0x1C00C9E88 (WdmlibProcgrpInitialize.c)
 */
