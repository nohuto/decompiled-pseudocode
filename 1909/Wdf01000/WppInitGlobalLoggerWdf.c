        ...
        unsigned __int8 *pLevel)
{
  ...
  if ( v7 <= 0x7FFFFFFF )
  {
    ...
    if ( PoolWithTag )
    {
      ...
      *(_QWORD *)&LoggerNameStr.Length = 0LL;
      LoggerNameStr.Buffer = 0LL;
