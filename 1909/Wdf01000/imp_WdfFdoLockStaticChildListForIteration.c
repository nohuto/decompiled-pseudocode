/*
 * XREFs of imp_WdfFdoLockStaticChildListForIteration @ 0x1C0001240
 * Callers:
 *     <none>
 * Callees:
 *     ?BeginIteration@FxChildList@@QEAAXPEAU_WDF_CHILD_LIST_ITERATOR@@@Z @ 0x1C00012D4 (-BeginIteration@FxChildList@@QEAAXPEAU_WDF_CHILD_LIST_ITERATOR@@@Z.c)
