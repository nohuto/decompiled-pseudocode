/*
 * XREFs of imp_WdfDeviceStopIdleActual @ 0x1C0016ED0
 * Callers:
 *     <none>
 * Callees:
        ...
        char *File)
{
  ...
  v11 = *(FxPowerIdleMachine **)(*(_QWORD *)&v9[6].m_ObjectFlags + 888LL);
  if ( v11 )
  {
    _a3 = FxPowerIdleMachine::PowerReferenceWorker(v11, WaitForD0, FxPowerReferenceDefault, Tag, Line, File);
    v13 = _a3;
    if ( m_Globals->FxVerboseOn )
      WPP_IFR_SF_qdd(m_Globals, 5u, 0x12u, 0x26u, WPP_FxDeviceApi_cpp_Traceguids, v8, WaitForD0, _a3);
    if ( v13 >= 0 )
    {
      v14 = *((_QWORD *)PPObject + 81);
      if ( *(_BYTE *)(v14 + 1236) == 1 && _InterlockedIncrement((volatile signed __int32 *)(v14 + 1232)) == 1 )
      {
        v16 = *(_QWORD *)(v14 + 1224);
        if ( v16 )
        {
  ...
  {
    v13 = -1073741436;
    WPP_IFR_SF_qL(m_Globals, 2u, 0x12u, 0x25u, WPP_FxDeviceApi_cpp_Traceguids, v8, 0xC0000184);
  }
  return (unsigned int)v13;
}
