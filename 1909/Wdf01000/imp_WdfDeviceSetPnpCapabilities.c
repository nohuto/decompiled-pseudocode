/*
 * XREFs of imp_WdfDeviceSetPnpCapabilities @ 0x1C0049C40
 * Callers:
 *     <none>
 * Callees:
 ...
 *     ?SetPnpCaps@FxPkgPnp@@QEAAXPEAU_WDF_DEVICE_PNP_CAPABILITIES@@@Z @ 0x1C00865D0 (-SetPnpCaps@FxPkgPnp@@QEAAXPEAU_WDF_DEVICE_PNP_CAPABILITIES@@@Z.c)
 */
