/*
 * XREFs of ?SleepStudyRegisterBlockingComponents@FxPkgPnp@@QEAAJXZ @ 0x1C0089460
 * Callers:
...
__int64 __fastcall FxPkgPnp::SleepStudyRegisterBlockingComponents(FxPkgPnp *this)
{
  ...
  _UNICODE_STRING friendlyName; // [rsp+58h] [rbp-A8h] BYREF
  ...
  *(_QWORD *)&parentGuid.Data1 = 0LL;
  *(_QWORD *)parentGuid.Data4 = 0LL;
  *(_QWORD *)&thisGuid.Data1 = 0LL;
  *(_QWORD *)thisGuid.Data4 = 0LL;
