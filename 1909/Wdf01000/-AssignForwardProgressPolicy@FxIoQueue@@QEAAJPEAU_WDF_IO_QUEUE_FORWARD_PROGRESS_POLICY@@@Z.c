/*
 * XREFs of ?AssignForwardProgressPolicy@FxIoQueue@@QEAAJPEAU_WDF_IO_QUEUE_FORWARD_PROGRESS_POLICY@@@Z @ 0x1C007A8F4
 * Callers:
 ...
 *     ?FreeAllReservedRequests@FxIoQueue@@AEAAXE@Z @ 0x1C007AB00 (-FreeAllReservedRequests@FxIoQueue@@AEAAXE@Z.c)
 */
        ...
        _WDF_IO_QUEUE_FORWARD_PROGRESS_POLICY *Policy)
{
  ...
  _FXIO_FORWARD_PROGRESS_CONTEXT *v10; // rax
  ...
  v10 = (_FXIO_FORWARD_PROGRESS_CONTEXT *)FxPoolAllocator(
                                            m_Globals,
                                            ...
                                            m_Globals->Tag,
                                            retaddr);
  this->m_FwdProgContext = v10;
  if ( v10 )
  {
    memset(v10, 0, sizeof(_FXIO_FORWARD_PROGRESS_CONTEXT));
    v11 = 0;
