/*
 * XREFs of ?ProcessEvent@FxWakeInterruptMachine@@QEAAXW4FxWakeInterruptEvents@@@Z @ 0x1C008FCA0
 * Callers:
 ...
 *     ?WakeInterruptIsr@FxInterrupt@@QEAAEXZ @ 0x1C008DC1C (-WakeInterruptIsr@FxInterrupt@@QEAAEXZ.c)
 * Callees:
 *     WPP_IFR_SF_qqLL @ 0x1C0012020 (WPP_IFR_SF_qqLL.c)
 *     ?QueueToThread@FxThreadedEventQueue@@QEAAXXZ @ 0x1C00153E8 (-QueueToThread@FxThreadedEventQueue@@QEAAXXZ.c)
