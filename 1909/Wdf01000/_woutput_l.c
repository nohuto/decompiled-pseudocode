/*
 * XREFs of _woutput_l @ 0x1C001A54C
 * Callers:
 ...
 *     _get_printf_count_output @ 0x1C001AFB8 (_get_printf_count_output.c)
...
__int64 __fastcall woutput_l(_iobuf *stream, wchar_t *format, localeinfo_struct *plocinfo, char *argptr)
{
  ...
  wchar_t wchar; // [rsp+4Ch] [rbp-B4h] BYREF
      ...
      while ( 1 )
      {
        ...
        switch ( v13 )
        {
          ...
          case 6:
            ...
            if ( v10 == 73 )
            {
              if ( *format == 54 && v14[2] == 52 )
              {
                format = (wchar_t *)(v14 + 3);
                goto LABEL_139;
              }
              if ( *format == 51 && v14[2] == 50 )
              {
                format = (wchar_t *)(v14 + 3);
                v6 &= ~0x8000u;
                goto LABEL_139;
      ...
      if ( v10 > 0x69u )
      {
        switch ( v10 )
        {
          case 'n':
            v60 = (char *)(v9 + 4);
            v35 = *(_WORD **)v9;
            if ( !(unsigned int)get_printf_count_output((unsigned int)(v13 - 6), (unsigned int)v10 - 110, v14) )
              goto LABEL_193;
            if ( (v6 & 0x20) != 0 )
              *v35 = v11;
            else
...
$COMMON_INT:
            ...
            p_buffer = (union {char sz[512];wchar_t wz[512];} *)(v28 + 1);
            if ( (v6 & 0x200) != 0 )
            {
              if ( !(_DWORD)v12 || (v60 = v17, v52 = v29, p_buffer->sz[0] != 48) )
              {
        ...
        if ( v10 != 83 )
        {
          if ( v10 != 88 )
          {
            if ( v10 == 90 )
            {
              ...
              v60 = (char *)(v9 + 4);
              if ( v19 && (p_buffer = (union {char sz[512];wchar_t wz[512];} *)*((_QWORD *)v19 + 1)) != 0LL )
              {
                if ( v19[1] < *v19 )
                  goto LABEL_193;
                LODWORD(v12) = *v19;
                if ( (v6 & 0x800) != 0 )
                {
                  if ( (v12 & 1) != 0 || ((unsigned __int8)p_buffer & 1) != 0 )
                    goto LABEL_193;
                  LODWORD(v12) = *v19 >> 1;
                  v54 = 1;
                }
...
LABEL_120:
                  v37 = v59 - v12 - v36;
                  if ( (v6 & 0xC) == 0 )
                    write_multi_char(0x20u, v37, f, &charsout);
                  write_string(prefix, v36, f, &charsout);
                  v38 = f;
                  if ( (v6 & 0xC) == 8 )
                    write_multi_char(0x30u, v37, f, &charsout);
                  if ( v54 || (int)v12 <= 0 )
                  {
                    write_string((wchar_t *)p_buffer, v12, v38, &charsout);
LABEL_134:
                    v11 = charsout;
                  }
                  else
                  {
                    v39 = (const char *)p_buffer;
                    v40 = v12;
                    while ( 1 )
                    {
                      --v40;
                      v41 = mbtowc(&wchar, v39, _mb_cur_max);
                      v42 = v41;
                      if ( v41 == 2 )
                        --v40;
                      if ( v41 <= 0 )
                  ...
                  write_multi_char(0x20u, v37, v38, &charsout);
                  format = (wchar_t *)v63;
LABEL_138:
                  v11 = charsout;
                  v13 = v55;
