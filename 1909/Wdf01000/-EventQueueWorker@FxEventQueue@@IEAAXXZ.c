/*
 * XREFs of ?EventQueueWorker@FxEventQueue@@IEAAXXZ @ 0x1C008EE74
 * Callers:
 *     ?_WorkerThreadRoutine@FxThreadedEventQueue@@KAXPEAX@Z @ 0x1C008F0D0 (-_WorkerThreadRoutine@FxThreadedEventQueue@@KAXPEAX@Z.c)
