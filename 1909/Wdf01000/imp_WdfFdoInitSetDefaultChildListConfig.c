/*
 * XREFs of imp_WdfFdoInitSetDefaultChildListConfig @ 0x1C0046D20
 * Callers:
 *     <none>
 * Callees:
 ...
 *     ?_ValidateConfig@FxChildList@@SAJPEAU_FX_DRIVER_GLOBALS@@PEAU_WDF_CHILD_LIST_CONFIG@@PEA_K@Z @ 0x1C003DA2C (-_ValidateConfig@FxChildList@@SAJPEAU_FX_DRIVER_GLOBALS@@PEAU_WDF_CHILD_LIST_CONFIG@@PEA_K@Z.c)
