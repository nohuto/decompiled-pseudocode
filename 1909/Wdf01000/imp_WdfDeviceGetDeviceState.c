/*
 * XREFs of imp_WdfDeviceGetDeviceState @ 0x1C00491F0
 * Callers:
 *     <none>
 * Callees:
 ...
 *     ?GetPnpState@FxPkgPnp@@QEAAXPEAU_WDF_DEVICE_STATE@@@Z @ 0x1C0083E10 (-GetPnpState@FxPkgPnp@@QEAAXPEAU_WDF_DEVICE_STATE@@@Z.c)
 */
