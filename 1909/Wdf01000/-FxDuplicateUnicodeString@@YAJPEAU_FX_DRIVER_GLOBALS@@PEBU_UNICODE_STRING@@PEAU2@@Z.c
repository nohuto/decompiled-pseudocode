/*
 * XREFs of ?FxDuplicateUnicodeString@@YAJPEAU_FX_DRIVER_GLOBALS@@PEBU_UNICODE_STRING@@PEAU2@@Z @ 0x1C0064474
 * Callers:
 ...
 *     ?Assign@FxString@@QEAAJPEBG@Z @ 0x1C006432C (-Assign@FxString@@QEAAJPEBG@Z.c)
