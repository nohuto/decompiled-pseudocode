/*
 * XREFs of ?Connect@FxInterrupt@@QEAAJK@Z @ 0x1C000D1A0
 * Callers:
 *     ?PowerWakingConnectInterrupt@FxPkgPnp@@KA?AW4_WDF_DEVICE_POWER_STATE@@PEAV1@@Z @ 0x1C000D0E0 (-PowerWakingConnectInterrupt@FxPkgPnp@@KA-AW4_WDF_DEVICE_POWER_STATE@@PEAV1@@Z.c)
 ...
 * Callees:
 *     ?InterruptEnable@FxInterrupt@@AEAAJXZ @ 0x1C000D258 (-InterruptEnable@FxInterrupt@@AEAAJXZ.c)
