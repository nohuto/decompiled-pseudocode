/*
 * XREFs of ?_PowerPolicyWaitWakeCompletionRoutine@FxPkgPnp@@KAJPEAU_DEVICE_OBJECT@@PEAU_IRP@@PEAX@Z @ 0x1C008CAE0
 * Callers:
 *     <none>
 * Callees:
        ...
        void *Context)
{
  ...
  if ( _InterlockedExchange64((volatile __int64 *)Context + 114, 0LL)
    || _InterlockedExchange((volatile __int32 *)(*((_QWORD *)Context + 111) + 568LL), 1) == 1 )
  {
