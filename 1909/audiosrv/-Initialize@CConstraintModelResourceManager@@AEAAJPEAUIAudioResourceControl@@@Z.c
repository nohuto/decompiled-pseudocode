/*
 * XREFs of ?Initialize@CConstraintModelResourceManager@@AEAAJPEAUIAudioResourceControl@@@Z @ 0x1800614D4
 * Callers:
 ...
 *     ??0CConstraintModel@@QEAA@XZ @ 0x1800574CC (--0CConstraintModel@@QEAA@XZ.c)
 *     ?SetupKeywordDetectorPriority@CConstraintModelResourceManager@@AEAAJXZ @ 0x180061600 (-SetupKeywordDetectorPriority@CConstraintModelResourceManager@@AEAAJXZ.c)
