/*
 * XREFs of ?ProcessDeviceStateChanged@CMonitorManager@@AEAAXXZ @ 0x18010BC50
 * Callers:
...
void __fastcall CMonitorManager::ProcessDeviceStateChanged(CMonitorManager *this)
{
  ...
  CMonitorManager::DeviceStateChangedContext *v8; // [rsp+70h] [rbp+20h] BYREF
  __int64 v9; // [rsp+78h] [rbp+28h]
      ...
      *((_BYTE *)this + 248) = 1;
      while ( *((_QWORD *)this + 27) )
      {
        ...
        *v2 = 0LL;
        ...
        if ( (*(_BYTE *)(v3 + 8) & 0xA) != 0 )
        {
          CMonitorManager::HandleDeviceRemoved(this, *(unsigned __int16 **)v3);
        }
