...
__int64 BuildDeviceGraphForStream(int a1, __int64 a2, __int64 a3, __int64 a4, int a5, int a6, int a7, int a8, ...)
{
  ...
  __int64 v49; // [rsp+148h] [rbp+87h] BYREF
...
LABEL_44:
        ...
        v42 = 0LL;
        v43 = 1;
        v15 = (*(__int64 (__fastcall **)(__int64, _QWORD *, _QWORD, va_list *))(*(_QWORD *)v25 + 304LL))(
                v25,
                v17,
                v23,
                &v42);
