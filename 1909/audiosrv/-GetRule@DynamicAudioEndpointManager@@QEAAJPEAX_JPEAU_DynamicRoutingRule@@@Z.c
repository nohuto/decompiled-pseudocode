/*
 * XREFs of ?GetRule@DynamicAudioEndpointManager@@QEAAJPEAX_JPEAU_DynamicRoutingRule@@@Z @ 0x18012A9E4
 * Callers:
 *     PolicyConfigGetDynamicRoutingRule @ 0x1800E1D90 (PolicyConfigGetDynamicRoutingRule.c)
 * Callees:
