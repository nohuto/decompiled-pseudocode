/*
 * XREFs of ?GetStaticObjectPosition@SpatialAudioDevicePropertyReader@@UEAAJW4AudioObjectType@@PEAM11@Z @ 0x180130E80
 * Callers:
 *     <none>
 * Callees:
        ...
        float *a5)
{
  ...
  else
  {
    ...
    {
      v20 = 58LL;
      v19 = "SpatialAudioDevicePropertyReader::GetStaticObjectPosition";
      v21 = &v16;
      v23 = &v17;
      v16 = 613;
      v22 = 4LL;
      ...
      v24 = 4LL;
      TlgWrite((TraceLoggingHProvider)&dword_1801B53C0, &unk_18017BCAD, v11, v12, 5u, &pData);
    }
