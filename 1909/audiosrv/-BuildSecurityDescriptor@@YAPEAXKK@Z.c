/*
 * XREFs of ?BuildSecurityDescriptor@@YAPEAXKK@Z @ 0x18005D238
 * Callers:
...
__int64 __fastcall BuildSecurityDescriptor()
{
  ...
  *(_WORD *)&pIdentifierAuthority.Value[4] = 256;
  ...
  if ( !v3 )
  {
    ...
    v11 = 10LL;
LABEL_24:
    WPP_SF_(*((_QWORD *)v10 + 2), v11, &WPP_cdec8e7e3ff63eace1bce253fb909d75_Traceguids);
    goto LABEL_12;
  }
  if ( !InitializeSecurityDescriptor(v3, 1u) )
  {
    ...
    v13 = 11LL;
LABEL_33:
    WPP_SF_d(*((_QWORD *)WPP_GLOBAL_Control + 2), v13, &WPP_cdec8e7e3ff63eace1bce253fb909d75_Traceguids, LastError);
    goto LABEL_12;
  }
