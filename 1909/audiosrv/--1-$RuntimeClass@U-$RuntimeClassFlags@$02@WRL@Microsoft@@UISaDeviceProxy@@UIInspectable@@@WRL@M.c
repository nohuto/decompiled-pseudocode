/*
 * XREFs of ??1?$RuntimeClass@U?$RuntimeClassFlags@$02@WRL@Microsoft@@UISaDeviceProxy@@UIInspectable@@@WRL@Microsoft@@UEAA@XZ @ 0x1800ED250
 * Callers:
 *     _CSaDeviceProxy::_CSaDeviceProxy_::_1_::dtor$0 @ 0x180073F00 (_CSaDeviceProxy--_CSaDeviceProxy_--_1_--dtor$0.c)
 *     _CAudioResourceManager::CAudioResourceManager_::_1_::dtor$0 @ 0x18007473A (_CAudioResourceManager--CAudioResourceManager_--_1_--dtor$0.c)
 * Callees:
 *     <none>
 */
