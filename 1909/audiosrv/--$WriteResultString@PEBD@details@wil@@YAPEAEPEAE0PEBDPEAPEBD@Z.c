/*
 * XREFs of ??$WriteResultString@PEBD@details@wil@@YAPEAEPEAE0PEBDPEAPEBD@Z @ 0x1800BB324
 * Callers:
 ...
 * Callees:
 *     ?ResultStringSize@details@wil@@YA_KPEBD@Z @ 0x1800BC1A8 (-ResultStringSize@details@wil@@YA_KPEBD@Z.c)
