/*
 * XREFs of AudioServerGetSharedModeEnginePeriod @ 0x1800E8170
 * Callers:
 *     <none>
 * Callees:
        ...
        int *a9)
{
    ...
    && fPending[0] )
  {
    ...
    wil::TraceLoggingProvider::Register((wil::TraceLoggingProvider *)&qword_1801B7588, qword_1801B75A0, v15);
