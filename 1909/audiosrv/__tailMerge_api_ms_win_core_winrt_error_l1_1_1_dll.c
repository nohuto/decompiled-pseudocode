/*
 * XREFs of __tailMerge_api_ms_win_core_winrt_error_l1_1_1_dll @ 0x180066C4F
 * Callers:
 *     __imp_load_RoGetMatchingRestrictedErrorInfo @ 0x180066C43 (__imp_load_RoGetMatchingRestrictedErrorInfo.c)
 * Callees:
