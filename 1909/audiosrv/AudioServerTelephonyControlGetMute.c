/*
 * XREFs of AudioServerTelephonyControlGetMute @ 0x1800EA620
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall AudioServerTelephonyControlGetMute(__int64 a1, __int64 a2, unsigned int a3, __int64 a4)
{
  ...
  CWatchdogTimer<1>::CWatchdogTimer<1>(pv, v12[1], v7, (struct _TP_TIMER *)L"AudioServerTelephonyControlGetMute");
  v9 = ((__int64 (__fastcall *)(struct IUnknown *, __int64, _QWORD, __int64))g_TelephonyControl->lpVtbl[4].QueryInterface)(
         g_TelephonyControl,
         a2,
         a3,
         a4);
