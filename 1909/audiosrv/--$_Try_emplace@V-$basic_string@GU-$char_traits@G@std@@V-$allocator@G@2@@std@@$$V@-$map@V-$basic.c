...
__int64 __fastcall std::map<std::wstring,std::unique_ptr<_RecurringTask>>::_Try_emplace<std::wstring,>(
        __int64 *a1,
        __int64 a2,
        char *a3)
{
...
LABEL_20:
    v19 = a3;
    v17 = std::_Tree_comp_alloc<std::_Tmap_traits<std::wstring,std::unique_ptr<_RecurringTask>,std::less<std::wstring>,std::allocator<std::pair<std::wstring const,std::unique_ptr<_RecurringTask>>>,0>>::_Buynode<std::piecewise_construct_t const &,std::tuple<std::wstring &&>,std::tuple<>>(
            (__int64)a1,
            v7,
            (__int64 *)&v19);
