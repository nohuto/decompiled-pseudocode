/*
 * XREFs of ?RuntimeClassInitialize@SpatialAudioDevicePropertyWriter@@QEAAJPEBGPEAUIPropertyStore@@@Z @ 0x180050E18
 * Callers:
        ...
        if ( Instance >= 0 )
        {
          ...
          if ( Instance >= 0 )
          {
            ...
            Instance = CoCreateInstance(
                         ...
                         v25);
            v29 = Instance;
            if ( Instance < 0 && (unsigned int)dword_1801B53C0 > 2 )
            {
              v35 = "SpatialAudioDevicePropertyWriter::RuntimeClassInitialize";
              v36 = 57LL;
              v30 = 147;
              ...
              v39 = &v29;
              v40 = 4LL;
              TlgWrite((TraceLoggingHProvider)&dword_1801B53C0, &unk_18017BC7B, v27, v28, 5u, &pData);
            }
          }
