/*
 * XREFs of ?GetSpatialFormatForAudioFormat@CSpatialProperties@@QEAAJPEBG_NPEBUtWAVEFORMATEX@@PEAUIPropertyStore@@V?$function@$$A6A_NPEBUWAVEFORMATEXTENSIBLE@@@Z@std@@PEAUSpatialAudioSettings@@@Z @ 0x1800016FC
 * Callers:
        ...
        char *a7)
{
  ...
  _EVENT_DATA_DESCRIPTOR pDesc; // [rsp+7C0h] [rbp+6A0h] BYREF
...
LABEL_4:
  ...
  if ( a3 )
  {
    if ( (unsigned int)hProvider > 4 )
    {
      ...
      TlgWrite((TraceLoggingHProvider)&hProvider, &unk_18017A273, v15, v16, 3u, &pData);
    }
    goto LABEL_164;
  }
        ...
        if ( AsUInt32With >= 0 )
        {
          ...
          if ( AsUInt32With >= 0 )
          {
            ...
            if ( (unsigned int)hProvider > 4 )
            {
              ...
              v211 = &v130;
              v212 = 16LL;
              TlgWrite((TraceLoggingHProvider)&hProvider, &unk_18017A0E7, v19, v20, 0x15u, &v175);
              v18 = v71;
            }
            v21 = 0;
            v87 = 0;
            if ( v18 >= 0 )
            {
              ...
              do
              {
                ...
                if ( (unsigned int)hProvider > 4 )
                {
                  ...
                  v110 = 0LL;
                  v141 = off_1801B5488;
                  v142 = *(unsigned __int16 *)off_1801B5488;
                  v143 = v25;
                  v144 = &unk_18017A30E;
                  v145 = 267;
                  v146 = 1;
                  LODWORD(v94) = (unsigned int)&TraceLoggingMetadataEnd - (unsigned int)&TraceLoggingMetadata;
                  EtwEventWriteTransfer(qword_1801B54A0, v109, 0LL, 0LL, 17, &v141);
                  v18 = v71;
                  v21 = v87;
                }
                v87 = ++v21;
            ...
            else
            {
              ...
              if ( (unsigned __int8)IsSpatialOnlyFormat(v26, v17) )
              {
                if ( (unsigned int)hProvider > 2 )
                {
                  ...
                  TlgWrite((TraceLoggingHProvider)&hProvider, &unk_18017A2BD, v28, v29, 3u, &v245);
                }
            ...
            if ( v18 < 0 || v80 > 8 )
            {
              if ( (unsigned int)hProvider > 4 )
              {
                ...
                v230 = &v71;
                v231 = 4LL;
                TlgWrite((TraceLoggingHProvider)&hProvider, &unk_180179FEB, v31, v32, 4u, &v228);
              }
              v80 = 0;
              memset_0(&v126, 0, 0x48uLL);
...
LABEL_165:
            ...
            if ( (a7[64] & 3) != 0 )
            {
              if ( (unsigned int)hProvider > 4 )
              {
                ...
                v235 = 4;
                v236 = 0;
                TlgWrite((TraceLoggingHProvider)&hProvider, &unk_180179FA6, v33, v34, 4u, &v232);
              }
              goto LABEL_164;
            }
            v35 = v69 || (a7[64] & 8) != 0;
            ...
            if ( !v27 )
            {
              ...
              if ( (unsigned int)hProvider > 4 )
              {
                if ( TlgKeywordOn((TraceLoggingHProvider)&hProvider, 0x400000000000uLL) )
                {
                  ...
                  TlgWrite((TraceLoggingHProvider)&hProvider, &unk_18017A088, v43, v44, 5u, &v237);
                }
              }
            }
            v70 = 1;
            ...
            while ( 1 )
            {
              ...
              if ( !v48 || v49 < 0 )
              {
                if ( (unsigned int)hProvider > 4 )
                {
                  ...
                  v226 = &v91;
                  v227 = 4LL;
                  TlgWrite((TraceLoggingHProvider)&hProvider, &unk_180179ED7, v62, v63, 7u, &v220);
                }
                p_wFormatTag = &v102->wFormatTag;
                goto LABEL_135;
              }
...
LABEL_133:
              if ( (unsigned int)hProvider > 4 )
              {
                ...
                v218 = &v91;
                v219 = 4LL;
                TlgWrite((TraceLoggingHProvider)&hProvider, &unk_18017A021, v58, v59, 6u, &v213);
              }
LABEL_135:
              v60 = v82;
              v12 = 0xFFFFFFFFLL;
