/*
 * XREFs of ??_GCPerStreamVolumeAudioStream@@UEAAPEAXI@Z @ 0x18004AC00
 * Callers:
 *     ??_ECPerStreamVolumeAudioStream@@WBI@EAAPEAXI@Z @ 0x18006CBF0 (--_ECPerStreamVolumeAudioStream@@WBI@EAAPEAXI@Z.c)
 * Callees:
