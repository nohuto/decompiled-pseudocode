...
void __fastcall __noreturn std::_Tree_comp_alloc_std::_Tmap_traits_std::basic_string_unsigned_short_std::char_traits_unsigned_short__std::allocator_unsigned_short____Microsoft::WRL::ComPtr_IDeviceGraphObjectsStore__std::less_std::basic_string_unsigned_short_std::char_traits_unsigned_short__std::allocator_unsigned_short______std::allocator_std::pair_std::basic_string_unsigned_short_std::char_traits_unsigned_short__std::allocator_unsigned_short____const__Microsoft::WRL::ComPtr_IDeviceGraphObjectsStore______0___::_Buynode_std::piecewise_construct_t_const___std::tuple_std::basic_string_unsigned_short_std::char_traits_unsigned_short__std::allocator_unsigned_short________std::tuple_____::_1_::catch_17(
        __int64 a1,
        __int64 a2)
{
