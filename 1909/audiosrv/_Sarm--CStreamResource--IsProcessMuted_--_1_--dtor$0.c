/*
 * XREFs of _Sarm::CStreamResource::IsProcessMuted_::_1_::dtor$0 @ 0x180124304
 * Callers:
 *     <none>
 * Callees:
 *     <none>
...
__int64 __fastcall Sarm::CStreamResource::IsProcessMuted_::_1_::dtor_0(__int64 a1, __int64 a2)
{
