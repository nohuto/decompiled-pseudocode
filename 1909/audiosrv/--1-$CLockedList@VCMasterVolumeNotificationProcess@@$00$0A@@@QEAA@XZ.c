/*
 * XREFs of ??1?$CLockedList@VCMasterVolumeNotificationProcess@@$00$0A@@@QEAA@XZ @ 0x1800C8834
 * Callers:
 *     _CVolumeStrip::CVolumeStrip_::_1_::dtor$1 @ 0x1800747EA (_CVolumeStrip--CVolumeStrip_--_1_--dtor$1.c)
 * Callees:
