/*
 * XREFs of _lambda_1cf1c298c02d1937c63822c825393df5_::operator() @ 0x1801152A0
 * Callers:
...
bool __fastcall lambda_1cf1c298c02d1937c63822c825393df5_::operator()(__int64 a1, __int64 a2, DWORD a3, WORD a4)
{
  bool v5; // si
