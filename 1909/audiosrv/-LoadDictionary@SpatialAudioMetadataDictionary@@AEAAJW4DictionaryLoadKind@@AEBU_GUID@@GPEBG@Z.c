/*
 * XREFs of ?LoadDictionary@SpatialAudioMetadataDictionary@@AEAAJW4DictionaryLoadKind@@AEBU_GUID@@GPEBG@Z @ 0x180136A88
 * Callers:
          ...
          if ( SpatialAudioDevicePropertyReader >= 0 )
          {
            ...
            *(_QWORD *)(a1 + 128) = v23;
            SpatialAudioDevicePropertyReader = (*(__int64 (__fastcall **)(__int64, LPVOID, _QWORD))(*(_QWORD *)v30 + 48LL))(
                                                 ...
                                                 v29);
            v27 = SpatialAudioDevicePropertyReader;
            if ( SpatialAudioDevicePropertyReader < 0 && (unsigned int)dword_1801B53C0 > 2 )
            {
              v33 = "SpatialAudioMetadataDictionary::LoadDictionary";
              v34 = 47LL;
              v28 = 226;
