/*
 * XREFs of ?EndInitialization@CAudioSrv@@UEAAJJ@Z @ 0x18005D8C0
 * Callers:
 *     <none>
 * Callees:
...
LABEL_21:
    ...
    *((_DWORD *)this + 26) = 1;
    ...
    if ( !LastError )
    {
      started = StartRpcServer(v3, L"Audiosrv", &unk_1801513C0, SecurityDescriptor);
      v34 = started;
      v6 = started == 0;
      *((_DWORD *)this + 14) = v6;
      if ( !started )
      {
        v7 = StartRpcServer((unsigned __int16 *)v6, L"PlaybackManagerRpc", &unk_180151360, 0LL);
        v34 = v7;
        v8 = v7 == 0;
        *((_DWORD *)this + 15) = v8;
        if ( !v7 )
        {
          v9 = StartRpcServer((unsigned __int16 *)v8, L"AudioSrvDiagnosticsRpc", &unk_180151300, 0LL);
          v34 = v9;
          v10 = v9 == 0;
          *((_DWORD *)this + 16) = v10;
          if ( !v9 )
            ...
            if ( !v11 )
            {
                ...
                || pvData )
              {
                ...
                if ( g_streamMonitorManager )
                {
                  ...
                  if ( qword_1801B7C00 )
                  {
                    _InterlockedIncrement((volatile signed __int32 *)qword_1801B7C00 + 3);
                    v15 = qword_1801B7C00;
                  }
...
LABEL_28:
  ...
  if ( InitOnceBeginInitialize(&`AudioSrvTelemetryProvider::Instance'::`2'::wrapper, 0, &fPending, &Context) && fPending )
  {
    ...
    wil::TraceLoggingProvider::Register((wil::TraceLoggingProvider *)&qword_1801B7588, qword_1801B75A0, v18);
  ...
  if ( *(_DWORD *)v19 > 2u && TlgKeywordOn(v19, 0x400000000000uLL) )
  {
    v32 = &v34;
    v33 = 4LL;
    TlgWrite(v20, &unk_1801767CB, v21, v22, 3u, &pData);
  }
LABEL_22:
