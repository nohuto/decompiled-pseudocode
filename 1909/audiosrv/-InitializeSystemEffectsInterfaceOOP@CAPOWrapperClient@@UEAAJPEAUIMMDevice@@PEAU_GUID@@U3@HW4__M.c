/*
 * XREFs of ?InitializeSystemEffectsInterfaceOOP@CAPOWrapperClient@@UEAAJPEAUIMMDevice@@PEAU_GUID@@U3@HW4__MIDL___MIDL_itf_audioengineendpoint_0000_0000_0001@@PEAPEAUIAudioSystemEffects2@@@Z @ 0x1800419C0
 * Callers:
 *     <none>
 * Callees:
...
LABEL_10:
      if ( (unsigned int)dword_1801B54B8 > 2 )
      {
        ...
        v25 = 4LL;
        v27 = 4LL;
        TlgWrite((TraceLoggingHProvider)&dword_1801B54B8, &unk_18017BD9D, v11, v12, 5u, &pData);
        v13 = v17;
      }
    }
    v7 = pv;
