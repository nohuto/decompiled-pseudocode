/*
 * XREFs of ?Add@?$InterfaceMap@UISaDeviceProxy@@VCEndpointResourcePool@Sarm@@@util@@QEAAPEAVCEndpointResourcePool@Sarm@@PEAUISaDeviceProxy@@PEAPEAU__POSITION@@@Z @ 0x18011F424
 * Callers:
        ...
        __int64 *a3)
{
  ...
  char v21[8]; // [rsp+78h] [rbp-30h] BYREF
  ATL::CAtlException *v22; // [rsp+80h] [rbp-28h] BYREF
