/*
 * XREFs of ??1CDacl@ATL@@UEAA@XZ @ 0x18002D00C
 * Callers:
 ...
 *     _CAudioDGProcess::GetADGProcessSD_::_1_::dtor$1 @ 0x18007114C (_CAudioDGProcess--GetADGProcessSD_--_1_--dtor$1.c)
 *     _DetermineLowRightsKeySecurityDescriptor_::_1_::dtor$1 @ 0x18007123D (_DetermineLowRightsKeySecurityDescriptor_--_1_--dtor$1.c)
 *     _DetermineLowRightsKeySecurityDescriptor_::_1_::dtor$2 @ 0x18007124F (_DetermineLowRightsKeySecurityDescriptor_--_1_--dtor$2.c)
