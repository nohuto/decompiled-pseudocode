/*
 * XREFs of ?UpdateSpatialSessionState@CExclusiveModeListener@@AEAAJW4SpatialRendererSelectionMode@@@Z @ 0x180127108
 * Callers:
        ...
        const GUID *a4)
{
  ...
  if ( (unsigned int)dword_1801B5350 > 5 )
  {
    ...
    v23 = 4;
    v24 = 0;
    TlgWrite((TraceLoggingHProvider)&dword_1801B5350, &unk_180179C5F, a3, a4, 4u, &pData);
    v6 = *(_DWORD *)(a1 + 152);
  }
  if ( a2 == v6 )
    return 0LL;
