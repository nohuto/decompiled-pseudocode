/*
 * XREFs of ?OnNotify@CPerEndpointVolumeAudioSession@@EEAAJPEAUAUDIO_VOLUME_NOTIFICATION_DATA@@@Z @ 0x1800CFBA0
 * Callers:
 *     <none>
 * Callees:
 ...
 *     ?RecalculateSessionVolume@CAudioSession@@UEAAXW4AudioVolumeChangeType@@PEBU_GUID@@K_NPEA_J@Z @ 0x180047E60 (-RecalculateSessionVolume@CAudioSession@@UEAAXW4AudioVolumeChangeType@@PEBU_GUID@@K_NPEA_J@Z.c)
 ...
 *     WPP_SF_qdgg @ 0x1800C8514 (WPP_SF_qdgg.c)
 *     WPP_SF_q_guid__guid_ @ 0x1800D1EA4 (WPP_SF_q_guid__guid_.c)
 *     WPP_SF_qdd @ 0x1800D1F10 (WPP_SF_qdd.c)
 *     WPP_SF_qgg_HEX__HEX_ @ 0x1800D1F68 (WPP_SF_qgg_HEX__HEX_.c)
 */
  ...
  if ( v9 )
  {
    ...
    if ( v4 || v37 || v3 )
    {
      if ( v12 != (CAudioSessionManager *)&WPP_GLOBAL_Control
        ...
        && *((_BYTE *)v12 + 25) >= 4u )
      {
        WPP_SF_(*((_QWORD *)v12 + 2), 0x81u, (__int64)&WPP_7f1ef5860f2032d8a1536e1a5abdceb7_Traceguids);
        v12 = WPP_GLOBAL_Control;
      }
      if ( v3 )
      {
        ...
        if ( v12 != (CAudioSessionManager *)&WPP_GLOBAL_Control
          ...
          && *((_BYTE *)v12 + 25) >= 4u )
        {
          WPP_SF_(*((_QWORD *)v12 + 2), 0x82u, (__int64)&WPP_7f1ef5860f2032d8a1536e1a5abdceb7_Traceguids);
        }
        v32 = 0;
        lpCriticalSection = (LPCRITICAL_SECTION)((char *)this - 176);
        ATL::CCritSecLock::Lock(&lpCriticalSection);
      ...
      if ( v37 )
      {
        if ( v12 != (CAudioSessionManager *)&WPP_GLOBAL_Control
          ...
          && *((_BYTE *)v12 + 25) >= 4u )
        {
          WPP_SF_(*((_QWORD *)v12 + 2), 0x83u, (__int64)&WPP_7f1ef5860f2032d8a1536e1a5abdceb7_Traceguids);
        }
        v32 = 0;
        lpCriticalSection = (LPCRITICAL_SECTION)((char *)this - 176);
        ATL::CCritSecLock::Lock(&lpCriticalSection);
    ...
    operator delete(v39);
         ...
         && *((_BYTE *)v7 + 25) >= 4u )
  {
    WPP_SF_q(*((_QWORD *)v7 + 2), 0x7Cu, (__int64)&WPP_7f1ef5860f2032d8a1536e1a5abdceb7_Traceguids, (char *)this - 984);
  }
  return 0LL;
}
