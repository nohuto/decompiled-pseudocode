/*
 * XREFs of ?ServiceMain@@YAXKQEAPEAG@Z @ 0x1800607F0
 * Callers:
 *     <none>
 * Callees:
 ...
 *     WppInitUm @ 0x180060F44 (WppInitUm.c)
...
void __fastcall ServiceMain(unsigned int a1, LPCWSTR *a2)
{
  ...
  if ( !hEventShutdown )
  {
    dword_1801B74B0 = GetLastError();
    v7 = (unsigned int)dword_1801B74B0;
LABEL_19:
    ReportStatusToSCMgr(1LL, v7, 0LL, v6);
    return;
  }
  dword_1801B74B0 = (*((__int64 (__fastcall **)(HANDLE *, LPCWSTR, HANDLE, void (__fastcall *)(void *, unsigned __int8), _QWORD, int))gpSvchostSharedGlobals
                     + 24))(
                      &hEventShutdownWait,
                      *a2,
                      hEventShutdown,
...
LABEL_14:
      ...
      dword_1801B74B0 = GetLastError();
      v18 = (unsigned int)dword_1801B74B0;
      goto LABEL_22;
    }
    v13 = 0LL;
    while ( 1 )
