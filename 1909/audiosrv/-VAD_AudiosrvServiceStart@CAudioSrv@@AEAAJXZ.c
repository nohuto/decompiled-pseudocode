/*
 * XREFs of ?VAD_AudiosrvServiceStart@CAudioSrv@@AEAAJXZ @ 0x18005D4C8
 * Callers:
...
LABEL_45:
  ...
  if ( pvData[0] )
  {
    ...
    v39 = v6;
    v7 = v6 ? CAudioHealthMonitor::CAudioHealthMonitor(v6, pvData[0]) : 0LL;
  ...
  v34 = 0LL;
  wil::com_query_to<IPolicyConfigInternal,Microsoft::WRL::ComPtr<CPolicyConfig> &>(v11, &v34);
  v37 = v34;
...
LABEL_60:
          ...
          pcbData) )
  {
    *(double *)&v26 = _wtof(String);
    if ( *(double *)&v26 != 0.0 )
    {
      ...
      CVolumeUnit::SetDBRange(g_RenderStreamTaperTranslator, v29, -96.0, 0.0, SLODWORD(FLOAT_1_5), v26);
    }
  }
  ...
  v21 = RpcServerRegisterIf3(&unk_180150CF0, 0LL, 0LL, 33LL, 1234, 0, AudioSrvRpcIfCallback, SecurityDescriptor);
  if ( !v21 )
  {
    *((_DWORD *)this + 25) = 1;
    if ( WPP_GLOBAL_Control != (CAudioSessionManager *)&WPP_GLOBAL_Control
