/*
 * XREFs of ?LaunchAndWaitForADGStartup@CAudioDGProcess@@AEAAJ_N@Z @ 0x18002C9D0
 * Callers:
...
__int64 __fastcall CAudioDGProcess::LaunchAndWaitForADGStartup(CAudioDGProcess *this, bool a2)
{
  ...
  if ( (unsigned int)dword_1801B54B8 > 4
    && (qword_1801B54C8 & 0x200000000000LL) != 0
    && (qword_1801B54D0 & 0x200000000000LL) == qword_1801B54D0 )
  {
    v16 = 0;
    v19 = 0;
    v22 = 0;
    ...
    v27 = 4;
    v30 = 8;
    TlgWrite((TraceLoggingHProvider)&dword_1801B54B8, &unk_18017BE32, (LPCGUID)0x200000000000LL, v5, 8u, &pData);
  }
  result = v9;
  if ( v11 < 0 )
