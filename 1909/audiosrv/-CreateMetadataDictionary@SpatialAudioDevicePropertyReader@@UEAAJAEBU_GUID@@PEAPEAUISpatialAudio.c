/*
 * XREFs of ?CreateMetadataDictionary@SpatialAudioDevicePropertyReader@@UEAAJAEBU_GUID@@PEAPEAUISpatialAudioMetadataDictionaryData@@@Z @ 0x18012FB20
 * Callers:
 *     <none>
 * Callees:
  ...
  if ( a3 )
  {
    ...
    if ( PropertyIndexForMetadataFormatID >= 0 )
    {
      ...
      if ( PropertyIndexForMetadataFormatID >= 0 )
      {
        if ( (_WORD)pvar == 65 )
        {
          ...
          if ( PropertyIndexForMetadataFormatID >= 0 )
          {
            ...
            v21 = PropertyIndexForMetadataFormatID;
            if ( PropertyIndexForMetadataFormatID < 0 && (unsigned int)dword_1801B53C0 > 2 )
            {
        ...
        else
        {
          ...
          if ( (unsigned int)dword_1801B53C0 > 2 )
          {
            ...
            v36 = (int *)&v21;
            v37 = 4LL;
            TlgWrite((TraceLoggingHProvider)&dword_1801B53C0, &unk_18017BCAD, v12, v13, 5u, &pData);
          }
        }
      }
      else if ( (unsigned int)dword_1801B53C0 > 2 )
      {
        ...
        v36 = (int *)&v21;
        v37 = 4LL;
        TlgWrite((TraceLoggingHProvider)&dword_1801B53C0, &unk_18017BC7B, v12, v13, 5u, &pData);
      }
    }
    else if ( (unsigned int)dword_1801B53C0 > 2 )
    {
  ...
  else
  {
    ...
    if ( (unsigned int)dword_1801B53C0 > 2 )
    {
      ...
      *(_DWORD *)v23 = -2147024809;
      v36 = (int *)v23;
      v37 = 4LL;
      TlgWrite((TraceLoggingHProvider)&dword_1801B53C0, &unk_18017BCAD, v7, v8, 5u, &pData);
    }
  }
