/*
 * XREFs of ?DeriveMixFormatFromDevicePipeFormat@CEndpointCharacteristics@@QEAAJU_GUID@@W4__MIDL___MIDL_itf_audioengineendpoint_0000_0000_0001@@PEAUIAudioMediaType@@PEAPEAU4@3@Z @ 0x180006564
 * Callers:
        ...
        struct IAudioMediaType **a6)
{
  ...
  __int64 v30[2]; // [rsp+78h] [rbp+7h] BYREF
  struct _GUID v31; // [rsp+88h] [rbp+17h] BYREF
  __int64 v32[2]; // [rsp+98h] [rbp+27h] BYREF
...
LABEL_49:
    ...
    v24 = 0LL;
    v18 = ((__int64 (__fastcall *)(struct IAudioProcessingObject *, struct IAudioMediaType *, __int64, __int64 *))v26->lpVtbl->IsOutputFormatSupported)(
            v26,
            a4,
            v30[0],
            &v24);
...
LABEL_44:
        ...
        if ( ((int (__fastcall *)(struct IAudioProcessingObject *, __int64, __int64, __int64 *))v22->lpVtbl->IsOutputFormatSupported)(
               v22,
               v28,
               v30[0],
               &v24) < 0 )
