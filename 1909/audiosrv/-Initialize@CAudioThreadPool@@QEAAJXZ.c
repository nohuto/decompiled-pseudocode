/*
 * XREFs of ?Initialize@CAudioThreadPool@@QEAAJXZ @ 0x180060E10
 * Callers:
...
{
  struct CAudioThreadPool *v1; // rdi
  unsigned int v2; // ebx
...
LABEL_7:
    ...
    {
      WPP_SF_d(*((_QWORD *)WPP_GLOBAL_Control + 2), 10LL, &WPP_2867a39f176c3dc2c300b28ea7d59b37_Traceguids, v2);
    }
    return v2;
  }
