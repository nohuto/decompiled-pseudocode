/*
 * XREFs of ??1?$CAutoPtrList@VWorkItemBase@@@ATL@@QEAA@XZ @ 0x18014558C
 * Callers:
 *     _AudioDeviceMgr::AudioDeviceMgr_::_1_::dtor$7 @ 0x180071EF4 (_AudioDeviceMgr--AudioDeviceMgr_--_1_--dtor$7.c)
 * Callees:
 *     <none>
 */
