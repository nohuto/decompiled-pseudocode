/*
 * XREFs of ?QueryInterface@EndpointDevice@@UEAAJAEBU_GUID@@PEAPEAX@Z @ 0x180053700
 * Callers:
 *     ?QueryInterface@EndpointDevice@@W7EAAJAEBU_GUID@@PEAPEAX@Z @ 0x18006D810 (-QueryInterface@EndpointDevice@@W7EAAJAEBU_GUID@@PEAPEAX@Z.c)
 * Callees:
