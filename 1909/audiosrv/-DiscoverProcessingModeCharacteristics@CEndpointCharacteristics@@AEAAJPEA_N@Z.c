/*
 * XREFs of ?DiscoverProcessingModeCharacteristics@CEndpointCharacteristics@@AEAAJPEA_N@Z @ 0x1800524FC
 * Callers:
 ...
 *     ?Start@CQPCStopWatch@@QEAAHXZ @ 0x1800E6790 (-Start@CQPCStopWatch@@QEAAHXZ.c)
  ...
  if ( ProcessingModeCharacteristicsFromPropertyStore < 0 )
  {
    ...
    *(__int64 *)((char *)&v32[28] + 4) = 0LL;
      ...
      && TlgKeywordOn((TraceLoggingHProvider)&hProvider, 0x200000000000uLL) )
    {
      ...
      v40 = 8LL;
      TlgWrite((TraceLoggingHProvider)&hProvider, &unk_180178FB3, v13, v14, 5u, &pData);
    }
