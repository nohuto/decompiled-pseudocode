/*
 * XREFs of AudioEncoderIdToRenderingMode @ 0x18012F7E0
 * Callers:
          ...
          if ( v9 )
          {
            ...
            if ( v10 )
            {
              ...
              if ( v11 )
              {
                ...
                if ( v12 && (unsigned int)dword_1801B53C0 > 2 )
                {
                  v18 = 30LL;
                  ...
                  v15 = -2147418113;
                  v22 = 4LL;
                  TlgWrite((TraceLoggingHProvider)&dword_1801B53C0, &unk_18017BCE7, a3, a4, 5u, &pData);
                }
              }
            }
            else
