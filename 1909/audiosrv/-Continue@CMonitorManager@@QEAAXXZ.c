/*
 * XREFs of ?Continue@CMonitorManager@@QEAAXXZ @ 0x180107C58
 * Callers:
 *     ?ResumeAllMonitors@CStreamConnectionManagerImpl@@UEAAXXZ @ 0x18010CA00 (-ResumeAllMonitors@CStreamConnectionManagerImpl@@UEAAXXZ.c)
 * Callees:
...
void __fastcall CMonitorManager::Continue(CMonitorManager *this)
{
  ...
  {
    WPP_SF_(*((_QWORD *)WPP_GLOBAL_Control + 2), 0x14u, (__int64)&WPP_b9a18bca3a9f3fb3e4a3d91d80ef7b5a_Traceguids);
  }
  if ( *((_QWORD *)this + 16) )
  {
