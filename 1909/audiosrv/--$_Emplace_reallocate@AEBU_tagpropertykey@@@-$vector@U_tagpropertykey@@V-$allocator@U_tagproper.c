/*
 * XREFs of ??$_Emplace_reallocate@AEBU_tagpropertykey@@@?$vector@U_tagpropertykey@@V?$allocator@U_tagpropertykey@@@std@@@std@@QEAAPEAU_tagpropertykey@@QEAU2@AEBU2@@Z @ 0x18011C010
 * Callers:
 ...
 *     ?_Change_array@?$vector@U_tagpropertykey@@V?$allocator@U_tagpropertykey@@@std@@@std@@AEAAXQEAU_tagpropertykey@@_K1@Z @ 0x18011C810 (-_Change_array@-$vector@U_tagpropertykey@@V-$allocator@U_tagpropertykey@@@std@@@std@@AEAAXQEAU_t.c)
 */
