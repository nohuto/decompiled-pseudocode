/*
 * XREFs of ?ReportSpatialLicenseChanged@CPolicyConfig@@UEAAJPEBG@Z @ 0x1800DFFC0
 * Callers:
 *     <none>
 * Callees:
        ...
        const char *a4)
{
  ...
  *(_OWORD *)v11 = 0LL;
  ...
  if ( v11[0] && *(_QWORD *)v11[0] )
  {
    ...
    v14[7] = v14;
    v14[2] = v6;
    v7 = (*(__int64 (__fastcall **)(unsigned __int64))(*(_QWORD *)g_AudioService + 120LL))(g_AudioService);
