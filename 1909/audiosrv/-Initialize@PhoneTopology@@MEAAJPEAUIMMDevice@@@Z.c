/*
 * XREFs of ?Initialize@PhoneTopology@@MEAAJPEAUIMMDevice@@@Z @ 0x180062290
 * Callers:
 *     <none>
 * Callees:
      ...
      *((_QWORD *)pv + 4) = ThreadpoolWait;
      if ( ThreadpoolWait )
      {
        ...
        if ( Instance >= 0 )
        {
          ...
          if ( Instance >= 0 )
          {
            Instance = (*(__int64 (__fastcall **)(__int64, __int64 *))(*(_QWORD *)v13 + 64LL))(v13, &v12);
            if ( Instance >= 0 )
            {
              Instance = (**(__int64 (__fastcall ***)(__int64, GUID *, __int64 *))v12)(
                           v12,
              ...
              if ( Instance >= 0 )
              {
                ...
                if ( Instance >= 0 )
                {
                  Instance = (*(__int64 (__fastcall **)(__int64, _QWORD *))(*(_QWORD *)v11 + 96LL))(v11, v15);
                  if ( Instance >= 0 )
                  {
