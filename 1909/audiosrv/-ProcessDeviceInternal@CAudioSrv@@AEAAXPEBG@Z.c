/*
 * XREFs of ?ProcessDeviceInternal@CAudioSrv@@AEAAXPEBG@Z @ 0x1800BF8B8
 * Callers:
...
LABEL_22:
  ...
  if ( **((_DWORD **)Context + 1) > 4u )
  {
    ...
    TlgWrite(v9, &unk_1801766AF, v8, (LPCGUID)v9, 3u, &pData);
  }
  ...
  if ( AudioSessionManagerProvider >= 0 )
  {
    ...
    if ( AudioSessionManager >= 0 )
    {
      if ( pv )
      {
        ...
        if ( v4 < 0 )
        {
          Microsoft::WRL::Details::RuntimeClassImpl<Microsoft::WRL::RuntimeClassFlags<2>,1,0,0,ISessionInternalEvents>::Release((__int64)v13);
          if ( v11 )
            Microsoft::WRL::Details::RuntimeClassImpl<Microsoft::WRL::RuntimeClassFlags<2>,1,0,0,IUnknown>::Release((__int64)v11);
          goto LABEL_49;
        }
      }
    }
