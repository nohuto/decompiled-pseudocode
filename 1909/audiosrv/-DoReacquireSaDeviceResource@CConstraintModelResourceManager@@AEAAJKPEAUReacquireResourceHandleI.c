/*
 * XREFs of ?DoReacquireSaDeviceResource@CConstraintModelResourceManager@@AEAAJKPEAUReacquireResourceHandleInfo@@@Z @ 0x1800FF824
 * Callers:
 ...
 *     WPP_SF_ddI @ 0x180102424 (WPP_SF_ddI.c)
 *     WPP_SF_ddID @ 0x180102488 (WPP_SF_ddID.c)
