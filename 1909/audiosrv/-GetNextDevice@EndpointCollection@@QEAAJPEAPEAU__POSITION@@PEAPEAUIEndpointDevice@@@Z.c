/*
 * XREFs of ?GetNextDevice@EndpointCollection@@QEAAJPEAPEAU__POSITION@@PEAPEAUIEndpointDevice@@@Z @ 0x180146A90
 * Callers:
 *     ?GetNextDevice@EndpointIterator@@UEAAJPEAPEAUIEndpointDevice@@@Z @ 0x180146B40 (-GetNextDevice@EndpointIterator@@UEAAJPEAPEAUIEndpointDevice@@@Z.c)
 * Callees:
