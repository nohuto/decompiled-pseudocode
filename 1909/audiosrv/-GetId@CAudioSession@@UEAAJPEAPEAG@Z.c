/*
 * XREFs of ?GetId@CAudioSession@@UEAAJPEAPEAG@Z @ 0x1800CE2C0
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall CAudioSession::GetId(CAudioSession *this, unsigned __int16 **a2)
{
  ...
  v4 = CAudioSessionInstanceId::ToPersistedString((__int64 *)this + 82, &v10, 0);
  v5 = v10;
  v6 = v4;
  if ( v4 < 0 )
    goto LABEL_6;
  ...
  *a2 = v8;
  if ( v8 )
  {
    ...
    *a2 = 0LL;
LABEL_6:
    AudSrvTraceLoggingErrorHelper("CAudioSession::GetId", 479, v6);
    goto LABEL_7;
  }
  v6 = -2147024882;
LABEL_7:
