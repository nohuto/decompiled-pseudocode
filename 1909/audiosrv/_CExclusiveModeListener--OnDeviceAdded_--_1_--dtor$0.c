/*
 * XREFs of _CExclusiveModeListener::OnDeviceAdded_::_1_::dtor$0 @ 0x180125CD3
 * Callers:
 *     <none>
 * Callees:
 *     <none>
...
__int64 __fastcall CExclusiveModeListener::OnDeviceAdded_::_1_::dtor_0(__int64 a1, __int64 a2)
{
