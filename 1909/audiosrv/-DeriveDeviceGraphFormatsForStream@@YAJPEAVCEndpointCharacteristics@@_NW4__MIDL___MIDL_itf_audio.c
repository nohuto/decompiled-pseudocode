/*
 * XREFs of ?DeriveDeviceGraphFormatsForStream@@YAJPEAVCEndpointCharacteristics@@_NW4__MIDL___MIDL_itf_audioengineendpoint_0000_0000_0001@@W4_AUDCLNT_SHAREMODE@@U_GUID@@44PEAUtWAVEFORMATEX@@PEAPEAU5@666@Z @ 0x18003B330
 * Callers:
 ...
 *     wil::details::lambda_call__lambda_0f4e3b5a6e80b3671c62d563ecc98ae0___::_lambda_call__lambda_0f4e3b5a6e80b3671c62d563ecc98ae0___ @ 0x1800EB430 (wil--details--lambda_call__lambda_0f4e3b5a6e80b3671c62d563ecc98ae0___--_lambda_call__lambda_0f4e.c)
...
LABEL_211:
  for ( i = 0; i < *((_DWORD *)v96 + 10); ++i )
  {
          ...
          ++j )
    {
      ...
      v116 = (_QWORD *)ATL::CSimpleArray<_GUID,ATL::CSimpleArrayEqualHelper<_GUID>>::operator[](v115, j);
      if ( (unsigned int)ATL::CSimpleArray<_GUID,ATL::CSimpleArrayEqualHelper<_GUID>>::Find((__int64 *)&Block, v116) == -1 )
      {
        v117 = *(_QWORD *)ATL::CSimpleArray<_GUID,ATL::CSimpleArrayEqualHelper<_GUID>>::operator[](
                            (__int64)(v96 + 32),
                            i);
        v118 = (_OWORD *)ATL::CSimpleArray<_GUID,ATL::CSimpleArrayEqualHelper<_GUID>>::operator[](v117, j);
        if ( !(unsigned int)ATL::CSimpleArray<_GUID,ATL::CSimpleArrayEqualHelper<_GUID>>::Add((__int64)&Block, v118) )
        {
          v97 = retaddr;
          v98 = 584LL;
          goto LABEL_183;
...
LABEL_155:
  ...
  v277 = *v236;
  v86 = 0;
  while ( *(_OWORD *)&qword_1801B65F0[2 * v86] != *(_OWORD *)&v277 )
  {
    if ( ++v86 >= 9 )
    {
...
LABEL_162:
  ...
  *(_DWORD *)pRelatedActivityId.Data4 = (_DWORD)v16;
  ...
  if ( (int)v16 < 0 && (unsigned int)hProvider > 3 && TlgKeywordOn((TraceLoggingHProvider)&hProvider, 4uLL) )
  {
    ...
    v299 = 4LL;
    TlgWrite((TraceLoggingHProvider)&hProvider, &unk_1801793C3, v87, &pRelatedActivityId, 5u, &pData);
  }
...
LABEL_383:
  ...
  if ( (int)v16 >= 0 )
  {
    ...
    if ( (int)v16 >= 0 )
    {
      ...
      v278 = *a5;
      v188 = 0;
      while ( *(_OWORD *)&qword_1801B65F0[2 * v188] != *(_OWORD *)&v278 )
      {
        if ( ++v188 >= 9 )
        {
          wil::details::in1diag3::Return_Hr(
