/*
 * XREFs of ?DisconnectStreamGroupFromSaDevice@CDeviceGraphManager@@UEAAJPEAUIStreamGroupProxy@@PEAUISaDeviceProxy@@@Z @ 0x1800EEA10
 * Callers:
 *     <none>
 * Callees:
        ...
        struct ISaDeviceProxy *a3)
{
  ...
  if ( v5 >= 0 )
  {
    ...
    if ( *(_DWORD *)v11 > 4u )
    {
      ...
      v15 = a3;
      v21 = 8;
      TlgWrite(v11, &unk_180177578, v8, v9, 4u, &pData);
    }
    return 0LL;
  }
  else
