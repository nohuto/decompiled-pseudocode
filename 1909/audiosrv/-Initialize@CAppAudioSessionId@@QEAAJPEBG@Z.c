/*
 * XREFs of ?Initialize@CAppAudioSessionId@@QEAAJPEBG@Z @ 0x1800DB368
 * Callers:
 ...
 *     ??$AtlConvAllocMemory@G@ATL@@YAXPEAPEAGHPEAGH@Z @ 0x1800DB000 (--$AtlConvAllocMemory@G@ATL@@YAXPEAPEAGHPEAGH@Z.c)
 ...
 *     ?GetAt@?$CSimpleStringT@G$0A@@ATL@@QEBAGH@Z @ 0x1800DB240 (-GetAt@-$CSimpleStringT@G$0A@@ATL@@QEBAGH@Z.c)
...
__int64 __fastcall CAppAudioSessionId::Initialize(CAppAudioSessionId *this, unsigned __int16 *a2)
{
  ...
  *((GUID *)v3 + 1) = GUID_00000000_0000_0000_0000_000000000000;
  ...
  {
    ATL::CSimpleStringT<unsigned short,0>::SetString((__int64 *)&v31, word_180161DC4);
  }
  else
  {
...
LABEL_12:
  ...
  if ( v13 - 24 != (char *)Src - 24 )
  {
    ...
    {
      ATL::CSimpleStringT<unsigned short,0>::SetString((__int64 *)&Src, v13, *((_DWORD *)v13 - 4));
      v11 = (char *)Src;
    }
  }
  ATL::CStringData::Release((ATL::CStringData *)(v33 - 24));
...
LABEL_20:
  ...
  if ( v31 - 12 != (unsigned __int16 *)v23 )
  {
    ...
    {
      ATL::CSimpleStringT<unsigned short,0>::SetString((__int64 *)v3, v31, *((_DWORD *)v31 - 4));
    }
  }
