/*
 * XREFs of _lambda_12caadf06097df6adadb33ec639f4e18_::operator() @ 0x18000B368
 * Callers:
 *     std::_Func_impl_no_alloc__lambda_12caadf06097df6adadb33ec639f4e18__long_SystemEffectDescriptor___SystemEffectChainDescriptor___::_Do_call @ 0x18000B350 (std--_Func_impl_no_alloc__lambda_12caadf06097df6adadb33ec639f4e18__long_SystemEffectDescriptor__.c)
 * Callees:
        ...
        __int64 a3)
{
  ...
  for ( i = 0; (signed int)i < *(_DWORD *)(a3 + 8); ++i )
  {
...
LABEL_24:
    ...
    SystemEffectDescriptor::UpdateEffectsInOverridingChain(
      ...
      a3,
      v8,
      (unsigned __int64)&unk_1801B6690 & -(__int64)v8,
      v18,
      v9 != -1);
  }
  *(_DWORD *)(a3 + 16) = 28;
