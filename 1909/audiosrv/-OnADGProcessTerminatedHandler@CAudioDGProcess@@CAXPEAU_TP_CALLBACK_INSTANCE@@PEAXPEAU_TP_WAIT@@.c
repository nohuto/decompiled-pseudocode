/*
 * XREFs of ?OnADGProcessTerminatedHandler@CAudioDGProcess@@CAXPEAU_TP_CALLBACK_INSTANCE@@PEAXPEAU_TP_WAIT@@J@Z @ 0x180137780
 * Callers:
 *     <none>
 * Callees:
        ...
        const GUID *a4)
{
  ...
  v4 = dword_1801B54B8;
  if ( (unsigned int)dword_1801B54B8 > 2 && TlgKeywordOn((TraceLoggingHProvider)&dword_1801B54B8, 0x400000000000uLL) )
  {
    TlgWrite((TraceLoggingHProvider)&dword_1801B54B8, &unk_18017BEBC, a3, a4, 2u, &pData);
  ...
  if ( (_DWORD)a4 )
  {
    if ( v4 > 2 )
    {
      ...
      v12 = 4;
      v15 = 4;
      TlgWrite((TraceLoggingHProvider)&dword_1801B54B8, &unk_18017BD9D, a3, a4, 5u, &v7);
    }
  }
  else
  {
