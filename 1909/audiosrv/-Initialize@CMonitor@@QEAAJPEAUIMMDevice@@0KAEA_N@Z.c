/*
 * XREFs of ?Initialize@CMonitor@@QEAAJPEAUIMMDevice@@0KAEA_N@Z @ 0x18010E0A0
 * Callers:
 ...
 *     ?Create@CEvent@ATL@@QEAAHPEAU_SECURITY_ATTRIBUTES@@HHPEBG@Z @ 0x180107D50 (-Create@CEvent@ATL@@QEAAHPEAU_SECURITY_ATTRIBUTES@@HHPEBG@Z.c)
        ...
        bool *a5)
{
  ...
  {
    WPP_SF_q(*((_QWORD *)WPP_GLOBAL_Control + 2), 0xAu, (__int64)&WPP_70b4bc2e72a23cf5637e1be4ab06d41d_Traceguids, v7);
  }
  if ( *((_DWORD *)v7 + 14) && *((_DWORD *)v7 + 14) != 6 )
  {
    ...
    {
      WPP_SF_(*((_QWORD *)WPP_GLOBAL_Control + 2), 0xBu, (__int64)&WPP_70b4bc2e72a23cf5637e1be4ab06d41d_Traceguids);
    }
    v9 = -2147467259;
    goto LABEL_135;
  }
  ...
  *((_QWORD *)v7 + 62) = ThreadpoolWork;
  if ( !ThreadpoolWork )
  {
    ...
    if ( WPP_GLOBAL_Control != (CAudioSessionManager *)&WPP_GLOBAL_Control
      ...
      && *((_BYTE *)WPP_GLOBAL_Control + 25) >= 2u )
    {
      WPP_SF_d(*((_QWORD *)WPP_GLOBAL_Control + 2), 0xCu, (__int64)&WPP_70b4bc2e72a23cf5637e1be4ab06d41d_Traceguids, v9);
    }
    goto LABEL_134;
  }
  if ( WPP_GLOBAL_Control != (CAudioSessionManager *)&WPP_GLOBAL_Control
...
LABEL_35:
  ...
  *v35 = 0;
  ...
  if ( v15 < 0
    ...
    && *((_BYTE *)WPP_GLOBAL_Control + 25) >= 2u )
  {
    WPP_SF_d(*((_QWORD *)WPP_GLOBAL_Control + 2), 0x10u, (__int64)&WPP_70b4bc2e72a23cf5637e1be4ab06d41d_Traceguids, v15);
  }
  ...
  if ( v9 >= 0 )
  {
    ...
    if ( v9 >= 0 )
    {
      ...
      if ( v9 >= 0 )
      {
        ...
        *((_QWORD *)v7 + 56) = v24;
        v25 = *((_QWORD *)v7 + 55) * *(unsigned int *)(v23 + 4) / 10000LL;
        *((_QWORD *)v7 + 57) = v25 * v24;
        try
        {
          ATL::CEvent::Create((CMonitor *)((char *)v7 + 296), (struct _SECURITY_ATTRIBUTES *)v25);
        }
