/*
 * XREFs of ?ReadLastLogTime@AudioJournal@@AEAA?AT_ULARGE_INTEGER@@XZ @ 0x18004FF94
 * Callers:
...
union _ULARGE_INTEGER __fastcall AudioJournal::ReadLastLogTime(AudioJournal *this, _DWORD *a2)
{
  ...
  *a2 = 0;
  v7 = 8;
  a2[1] = 0;
  ValueW = RegGetValueW(HKEY_LOCAL_MACHINE, &word_1801B8248, L"LastLogTime", 0x48u, 0LL, a2, &v7);
  if ( ValueW )
  {
    *(_QWORD *)a2 = 0LL;
    if ( ValueW != 2 )
