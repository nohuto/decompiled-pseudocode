/*
 * XREFs of ?CreateStreamConnection@CMonitorManager@@QEAAJAEBV?$basic_string@GU?$char_traits@G@std@@V?$allocator@G@2@@std@@0W4_AUDIO_STREAM_EXTENDED_CATEGORY@@AEAV?$shared_ptr@VCStreamConnection@@@3@@Z @ 0x1801081C8
 * Callers:
 *     ?CreateStreamConnection@CStreamConnectionManagerImpl@@UEAAJAEBV?$basic_string@GU?$char_traits@G@std@@V?$allocator@G@2@@std@@0W4_AUDIO_STREAM_EXTENDED_CATEGORY@@AEAV?$shared_ptr@VCStreamConnection@@@3@@Z @ 0x1801083B0 (-CreateStreamConnection@CStreamConnectionManagerImpl@@UEAAJAEBV-$basic_string@GU-$char_traits@G@.c)
 * Callees:
 ...
 *     ??$_Setp@VCStreamConnectionImpl@CMonitorManager@@@?$shared_ptr@VCStreamConnection@@@std@@AEAAXPEAVCStreamConnectionImpl@CMonitorManager@@U?$integral_constant@_N$0A@@1@@Z @ 0x180106DE0 (--$_Setp@VCStreamConnectionImpl@CMonitorManager@@@-$shared_ptr@VCStreamConnection@@@std@@AEAAXPE.c)
