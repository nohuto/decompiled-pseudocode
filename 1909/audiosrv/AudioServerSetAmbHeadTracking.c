/*
 * XREFs of AudioServerSetAmbHeadTracking @ 0x1800E9AD0
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall AudioServerSetAmbHeadTracking(char *a1, __int64 a2, unsigned int a3)
{
  ...
  v6 = (*(__int64 (__fastcall **)(char *, __int64, _QWORD))(*(_QWORD *)a1 + 144LL))(a1, a2, a3);
  v7 = v6;
  if ( v6 < 0 )
    AudSrvTraceLoggingErrorHelper("AudioServerSetAmbHeadTracking", 4627, v6);
