/*
 * XREFs of ?UpdateAudioCaptureStatus@CCaptureNotifier@@AEAAXW4REFERENCE_OPERATION@@K_N1@Z @ 0x1800FB834
 * Callers:
 *     ??_GCCaptureReference@@QEAAPEAXI@Z @ 0x1800FB558 (--_GCCaptureReference@@QEAAPEAXI@Z.c)
