/*
 * XREFs of ?TrackSystemEffectBehavior@@YAJPEAUIMMDevice@@W4APO_TYPE@@_N2AEBU_GUID@@M@Z @ 0x180137BDC
 * Callers:
 ...
 *     IsSkipAPOFailureCheck @ 0x180137B60 (IsSkipAPOFailureCheck.c)
 */
...
__int64 __fastcall TrackSystemEffectBehavior(__int64 a1, int a2, __int64 a3, __int64 a4, __int64 a5, float a6)
{
  ...
  v6 = a2;
  v14 = 0LL;
  if ( dword_1801B8A28 > *(_DWORD *)(*((_QWORD *)NtCurrentTeb()->ThreadLocalStoragePointer + (unsigned int)tls_index)
                                   + 4LL) )
  {
    Init_thread_header(&dword_1801B8A28);
    if ( dword_1801B8A28 == -1 )
    {
      xmmword_1801B89D4 = PKEY_Endpoint_LFX_FailCount;
      dword_1801B89E4 = 9;
      xmmword_1801B89E8 = PKEY_Endpoint_GFX_FailCount;
      dword_1801B89F8 = 8;
      xmmword_1801B89FC = PKEY_Endpoint_EFX_FailCount;
      dword_1801B8A0C = 31;
      xmmword_1801B8984 = PKEY_Endpoint_LFX_ExceptionCount;
      dword_1801B8994 = 33;
      xmmword_1801B8998 = PKEY_Endpoint_GFX_ExceptionCount;
      dword_1801B89A8 = 34;
      xmmword_1801B89AC = PKEY_Endpoint_EFX_ExceptionCount;
      dword_1801B89BC = 35;
      Init_thread_footer(&dword_1801B8A28);
    }
  }
  ...
  else
  {
    ...
    if ( *(_DWORD *)g_SysFxUtilTlp > 2u && TlgKeywordOn(g_SysFxUtilTlp, 0x400000000000uLL) )
    {
      ...
      TlgWrite(v11, &unk_18017BED9, v10, (LPCGUID)v11, 7u, &pData);
    }
    if ( pwsz )
