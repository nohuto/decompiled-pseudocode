/*
 * XREFs of ?SetDynamicObjects@CStreamResource@Sarm@@QEAAJI_J@Z @ 0x1801248BC
 * Callers:
 *     ?GrantApplicationResources@CSpatialAudioResourceManager@Sarm@@AEAAXK@Z @ 0x1801201E8 (-GrantApplicationResources@CSpatialAudioResourceManager@Sarm@@AEAAXK@Z.c)
...
__int64 __fastcall Sarm::CStreamResource::SetDynamicObjects(Sarm::CStreamResource *this, unsigned int a2, __int64 a3)
{
  ...
  if ( v12 >= 0 )
  {
    if ( (unsigned int)dword_1801B5350 > 5 )
    {
      ...
      v35 = 8;
      v38 = 4;
      TlgWrite((TraceLoggingHProvider)&dword_1801B5350, &unk_1801798AC, v13, v14, 9u, &pData);
    }
    return 0LL;
  }
  else
