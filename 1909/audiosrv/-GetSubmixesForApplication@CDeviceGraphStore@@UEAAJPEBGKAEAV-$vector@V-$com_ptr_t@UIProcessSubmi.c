/*
 * XREFs of ?GetSubmixesForApplication@CDeviceGraphStore@@UEAAJPEBGKAEAV?$vector@V?$com_ptr_t@UIProcessSubmixProxy@@Uerr_returncode_policy@wil@@@wil@@V?$allocator@V?$com_ptr_t@UIProcessSubmixProxy@@Uerr_returncode_policy@wil@@@wil@@@std@@@std@@@Z @ 0x1800F3640
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall CDeviceGraphStore::GetSubmixesForApplication(__int64 a1, __int64 a2, int a3, char **a4)
{
