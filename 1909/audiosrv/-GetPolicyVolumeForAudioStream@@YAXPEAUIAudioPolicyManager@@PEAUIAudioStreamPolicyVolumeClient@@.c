/*
 * XREFs of ?GetPolicyVolumeForAudioStream@@YAXPEAUIAudioPolicyManager@@PEAUIAudioStreamPolicyVolumeClient@@PEBU_TlgProvider_t@@PEAMPEA_JW4GPV_REASON@@@Z @ 0x18001E100
 * Callers:
  ...
  *a4 = v11;
  ...
  if ( *a4 > 0.0 && (*(unsigned int (__fastcall **)(__int64))(*(_QWORD *)a2 + 56LL))(a2) != 21 )
  {
    if ( (*(unsigned int (__fastcall **)(struct IAudioPolicyManager *))(*(_QWORD *)v8 + 280LL))(v8)
      && dword_1801833E0[(*(unsigned int (__fastcall **)(__int64))(*(_QWORD *)a2 + 56LL))(a2)] )
    {
      LODWORD(v54) = 0;
      v13 = 0.0;
    }
