/*
 * XREFs of ?SetSpatialAudioSettings@CSpatialProperties@@QEAAXPEBG_NPEAUIPropertyStore@@PEBUtWAVEFORMATEX@@V?$function@$$A6A_NPEBUWAVEFORMATEXTENSIBLE@@@Z@std@@@Z @ 0x180008A64
 * Callers:
  ...
  *(_QWORD *)v31 = a4;
  ...
  if ( a4 )
  {
    ...
    if ( (unsigned int)hProvider > 4 )
    {
      ...
      v46 = v10;
      TlgWrite((TraceLoggingHProvider)&hProvider, &unk_18017BA3F, v11, v10, 8u, &pData);
    }
        ...
        else
        {
          ...
          while ( 1 )
          {
            ...
            if ( v9 == 3 && (unsigned int)hProvider > 2 )
            {
              ...
              v37 = &v25;
              v38 = 2LL;
              TlgWrite((TraceLoggingHProvider)&hProvider, &unk_18017BAD9, v20, v21, 4u, &pData);
            }
            ...
            if ( (unsigned int)hProvider > 4 )
            {
              ...
              v40 = 2LL;
              TlgWrite((TraceLoggingHProvider)&hProvider, &unk_18017B98A, v22, v23, 5u, &pData);
              v19 = lpCriticalSection[171].SpinCount;
            }
            if ( v19 != 3 )
            {
          ...
          if ( (unsigned int)hProvider > 4 )
          {
            ...
            v37 = &v25;
            v38 = 2LL;
            TlgWrite((TraceLoggingHProvider)&hProvider, &unk_18017B9EC, v15, v16, 4u, &pData);
          }
          EnterCriticalSection(lpCriticalSection);
          LODWORD(lpCriticalSection[171].SpinCount) = 0;
        }
