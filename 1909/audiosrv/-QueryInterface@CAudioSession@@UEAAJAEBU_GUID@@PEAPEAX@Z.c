/*
 * XREFs of ?QueryInterface@CAudioSession@@UEAAJAEBU_GUID@@PEAPEAX@Z @ 0x18002ECF0
 * Callers:
 *     ?QueryInterface@CAudioSession@@W7EAAJAEBU_GUID@@PEAPEAX@Z @ 0x18006CA80 (-QueryInterface@CAudioSession@@W7EAAJAEBU_GUID@@PEAPEAX@Z.c)
 *     ?QueryInterface@CAudioSession@@WBA@EAAJAEBU_GUID@@PEAPEAX@Z @ 0x18006CA90 (-QueryInterface@CAudioSession@@WBA@EAAJAEBU_GUID@@PEAPEAX@Z.c)
 *     ?QueryInterface@CAudioSession@@WBI@EAAJAEBU_GUID@@PEAPEAX@Z @ 0x18006CAA0 (-QueryInterface@CAudioSession@@WBI@EAAJAEBU_GUID@@PEAPEAX@Z.c)
 *     ?QueryInterface@CAudioSession@@WCA@EAAJAEBU_GUID@@PEAPEAX@Z @ 0x18006CAB0 (-QueryInterface@CAudioSession@@WCA@EAAJAEBU_GUID@@PEAPEAX@Z.c)
 *     ?QueryInterface@CPerEndpointVolumeAudioSession@@EEAAJAEBU_GUID@@PEAPEAX@Z @ 0x1800D0960 (-QueryInterface@CPerEndpointVolumeAudioSession@@EEAAJAEBU_GUID@@PEAPEAX@Z.c)
 * Callees:
...
__int64 __fastcall CAudioSession::QueryInterface(CAudioSession *this, const struct _GUID *a2, void **a3)
{
  ...
  v6 = *(_QWORD *)&a2->Data1 - *(_QWORD *)&GUID_766f2bf0_bcaf_4cd0_a45e_0a166fb7e35c.Data1;
  if ( *(_QWORD *)&a2->Data1 == *(_QWORD *)&GUID_766f2bf0_bcaf_4cd0_a45e_0a166fb7e35c.Data1 )
    v6 = *(_QWORD *)a2->Data4 - *(_QWORD *)GUID_766f2bf0_bcaf_4cd0_a45e_0a166fb7e35c.Data4;
  if ( !v6 )
  {
    v8 = (char *)this + 24;
    if ( !this )
