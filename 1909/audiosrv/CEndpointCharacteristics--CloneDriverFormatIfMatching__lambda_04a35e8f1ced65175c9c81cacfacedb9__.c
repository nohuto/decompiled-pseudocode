/*
 * XREFs of CEndpointCharacteristics::CloneDriverFormatIfMatching__lambda_04a35e8f1ced65175c9c81cacfacedb9___ @ 0x180112BFC
 * Callers:
...
__int64 __fastcall CEndpointCharacteristics::CloneDriverFormatIfMatching__lambda_04a35e8f1ced65175c9c81cacfacedb9___(
        __int64 a1,
        __int64 a2,
        unsigned int *a3,
        ...
        if ( v10 <= 0x28 )
        {
          ...
          if ( _bittest64(&v11, v10) )
          {
            ...
            if ( v10 >= (unsigned __int64)v12->cbSize + 18
              && (unsigned __int8)lambda_04a35e8f1ced65175c9c81cacfacedb9_::operator()(a2, v12) )
            {
