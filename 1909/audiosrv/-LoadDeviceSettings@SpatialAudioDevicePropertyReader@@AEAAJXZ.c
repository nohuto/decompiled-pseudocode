/*
 * XREFs of ?LoadDeviceSettings@SpatialAudioDevicePropertyReader@@AEAAJXZ @ 0x18000D4B0
 * Callers:
...
__int64 __fastcall SpatialAudioDevicePropertyReader::LoadDeviceSettings(SpatialAudioDevicePropertyReader *this)
{
  ...
  if ( v26 < 0 )
  {
    if ( (unsigned int)dword_1801B53C0 > 2 )
    {
      ...
      v36 = 4LL;
      v38 = 4LL;
      TlgWrite((TraceLoggingHProvider)&dword_1801B53C0, &unk_18017BC7B, v3, v4, 5u, &pData);
    }
  }
  else
  {
              ...
              while ( 1 )
              {
                ...
                if ( (_WORD)pvar != 65 )
                {
                  ...
                  if ( (unsigned int)dword_1801B53C0 > 2 )
                  {
                    ...
                    v25 = -2147024809;
                    v38 = 4LL;
                    TlgWrite((TraceLoggingHProvider)&dword_1801B53C0, &unk_18017BCAD, v18, v19, 5u, &pData);
                  }
                  goto LABEL_19;
                }
                v20 = 6LL;
