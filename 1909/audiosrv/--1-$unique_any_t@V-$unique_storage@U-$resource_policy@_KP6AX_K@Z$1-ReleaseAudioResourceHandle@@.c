/*
 * XREFs of ??1?$unique_any_t@V?$unique_storage@U?$resource_policy@_KP6AX_K@Z$1?ReleaseAudioResourceHandle@@YAX0@ZU?$integral_constant@_K$0A@@wistd@@_K_K$0A@$$T@details@wil@@@details@wil@@@wil@@QEAA@XZ @ 0x1800ED2E4
 * Callers:
 *     _CSaDeviceProxy::_CSaDeviceProxy_::_1_::dtor$3 @ 0x180073F60 (_CSaDeviceProxy--_CSaDeviceProxy_--_1_--dtor$3.c)
 *     _TelephonyController::CreateCallInstance_::_1_::dtor$0 @ 0x1801497EB (_TelephonyController--CreateCallInstance_--_1_--dtor$0.c)
 * Callees:
