/*
 * XREFs of ?Initialize@AudioDeviceMgr@@AEAAJPEAUIEndpointNotificationCallback@@@Z @ 0x1800571EC
 * Callers:
 ...
 *     ?CreateWorkItemThread@AudioDeviceMgr@@AEAAJXZ @ 0x180063648 (-CreateWorkItemThread@AudioDeviceMgr@@AEAAJXZ.c)
