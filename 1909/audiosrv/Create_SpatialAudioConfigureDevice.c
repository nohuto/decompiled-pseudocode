/*
 * XREFs of Create_SpatialAudioConfigureDevice @ 0x18005112C
 * Callers:
        ...
        const GUID *a4)
{
  ...
  const GUID *v6; // r9
  unsigned int v7; // ebx
  unsigned __int16 *v9; // [rsp+30h] [rbp-39h] BYREF
  ...
  unsigned __int16 **v16; // [rsp+80h] [rbp+17h]
  int v17; // [rsp+88h] [rbp+1Fh]
  int v18; // [rsp+8Ch] [rbp+23h]
  unsigned __int16 **v19; // [rsp+90h] [rbp+27h]
