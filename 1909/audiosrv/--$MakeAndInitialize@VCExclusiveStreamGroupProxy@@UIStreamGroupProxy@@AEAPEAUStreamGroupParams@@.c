/*
 * XREFs of ??$MakeAndInitialize@VCExclusiveStreamGroupProxy@@UIStreamGroupProxy@@AEAPEAUStreamGroupParams@@AEAV?$CComHeapPtr@USTREAM_GROUP_DESCRIPTOR@@@ATL@@AEAK@Details@WRL@Microsoft@@YAJPEAPEAUIStreamGroupProxy@@AEAPEAUStreamGroupParams@@AEAV?$CComHeapPtr@USTREAM_GROUP_DESCRIPTOR@@@ATL@@AEAK@Z @ 0x1800EC7DC
 * Callers:
 ...
 *     ??0CExclusiveStreamGroupProxy@@QEAA@XZ @ 0x1800ED030 (--0CExclusiveStreamGroupProxy@@QEAA@XZ.c)
        ...
        unsigned int *a4)
{
  ...
  *a1 = 0LL;
  v8 = (CExclusiveStreamGroupProxy *)operator new(0x240uLL, (const struct std::nothrow_t *)&std::nothrow);
  if ( v8 )
  {
