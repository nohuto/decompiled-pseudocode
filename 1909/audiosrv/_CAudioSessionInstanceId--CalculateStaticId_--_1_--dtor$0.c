/*
 * XREFs of _CAudioSessionInstanceId::CalculateStaticId_::_1_::dtor$0 @ 0x180070460
 * Callers:
 *     <none>
 * Callees:
 *     <none>
...
__int64 __fastcall CAudioSessionInstanceId::CalculateStaticId_::_1_::dtor_0(__int64 a1, __int64 a2)
{
