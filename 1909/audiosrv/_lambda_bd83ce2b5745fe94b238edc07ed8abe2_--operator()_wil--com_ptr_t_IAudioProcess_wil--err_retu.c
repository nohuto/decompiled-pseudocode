/*
 * XREFs of _lambda_bd83ce2b5745fe94b238edc07ed8abe2_::operator()_wil::com_ptr_t_IAudioProcess_wil::err_returncode_policy___ @ 0x1800CC600
 * Callers:
...
char __fastcall lambda_bd83ce2b5745fe94b238edc07ed8abe2_::operator()_wil::com_ptr_t_IAudioProcess_wil::err_returncode_policy___(
        __int64 *a1,
        __int64 *a2)
{
  int v4; // eax
    ...
    && *((_BYTE *)WPP_GLOBAL_Control + 25) >= 4u )
  {
    ...
    WPP_SF_d(*((_QWORD *)WPP_GLOBAL_Control + 2), 0x28u, (__int64)&WPP_7f1ef5860f2032d8a1536e1a5abdceb7_Traceguids, v4);
  }
  v5 = *a1;
