/*
 * XREFs of ?EnsureSpatialSettingsAreInitialized@CSpatialProperties@@QEAAXPEBG@Z @ 0x18005163C
 * Callers:
           ...
           &v11) < 0 )
    {
      ...
      *(GUID *)((char *)&lpCriticalSection[2].SpinCount + 4) = v16;
      ...
      if ( (unsigned int)hProvider > 4 )
      {
        ...
        v29 = (int)v9;
        v30 = 0;
        TlgWrite((TraceLoggingHProvider)&hProvider, &unk_18017BB2E, v10, v9, 7u, &pData);
      }
    }
