/*
 * XREFs of AudioServerTelephonyControlGetVOIPMute @ 0x1800EA8C0
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall AudioServerTelephonyControlGetVOIPMute(__int64 a1, __int64 a2)
{
  ...
  CWatchdogTimer<1>::CWatchdogTimer<1>(pv, v9[1], v3, (struct _TP_TIMER *)L"AudioServerTelephonyControlGetVOIPMute");
  v5 = ((__int64 (__fastcall *)(struct IUnknown *, __int64))g_TelephonyControl->lpVtbl[4].Release)(
         g_TelephonyControl,
         a2);
