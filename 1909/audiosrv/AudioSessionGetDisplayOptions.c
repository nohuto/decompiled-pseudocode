/*
 * XREFs of AudioSessionGetDisplayOptions @ 0x1800D3320
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall AudioSessionGetDisplayOptions(__int64 *a1, __int64 a2)
{
  ...
  CWatchdogTimer<1>::CWatchdogTimer<1>(pv, v10[1], v4, (struct _TP_TIMER *)L"AudioSessionGetDisplayOptions");
  v6 = (*(__int64 (__fastcall **)(__int64, __int64))(*(_QWORD *)v2 + 176LL))(v2, a2);
