/*
 * XREFs of _CVirtualAudioStream::RuntimeClassInitialize_::_1_::dtor$0 @ 0x18010428F
 * Callers:
 *     <none>
 * Callees:
 *     <none>
...
__int64 __fastcall CVirtualAudioStream::RuntimeClassInitialize_::_1_::dtor_0(__int64 a1, __int64 a2)
{
