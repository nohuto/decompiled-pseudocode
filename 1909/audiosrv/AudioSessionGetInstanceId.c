/*
 * XREFs of AudioSessionGetInstanceId @ 0x1800D3750
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall AudioSessionGetInstanceId(__int64 *a1, __int64 a2)
{
  ...
  CWatchdogTimer<1>::CWatchdogTimer<1>(pv, v11[1], v4, (struct _TP_TIMER *)L"AudioSessionGetInstanceId");
  v6 = (*(__int64 (__fastcall **)(__int64, __int64))(*(_QWORD *)v2 + 120LL))(v2, a2);
  v7 = v6;
  if ( v6 < 0 )
    AudSrvTraceLoggingErrorHelper("AudioSessionGetInstanceId", 1574, v6);
