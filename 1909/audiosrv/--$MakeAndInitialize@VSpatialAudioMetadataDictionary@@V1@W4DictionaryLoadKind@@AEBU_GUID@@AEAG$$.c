/*
 * XREFs of ??$MakeAndInitialize@VSpatialAudioMetadataDictionary@@V1@W4DictionaryLoadKind@@AEBU_GUID@@AEAG$$TAEAPEAEAEAI@Details@WRL@Microsoft@@YAJPEAPEAVSpatialAudioMetadataDictionary@@$$QEAW4DictionaryLoadKind@@AEBU_GUID@@AEAG$$QEA$$TAEAPEAEAEAI@Z @ 0x180135E98
 * Callers:
 ...
 *     ??0SpatialAudioMetadataDictionary@@QEAA@XZ @ 0x180136068 (--0SpatialAudioMetadataDictionary@@QEAA@XZ.c)
