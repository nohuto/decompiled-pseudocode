/*
 * XREFs of ?CreateInstance@TelephonyController@@SAJPEAPEAUITelephonyController@@@Z @ 0x18014980C
 * Callers:
 ...
 *     ??0TelephonyController@@IEAA@XZ @ 0x1801493F0 (--0TelephonyController@@IEAA@XZ.c)
 ...
 *     ?GetSupportedVolumeStepping@TelephonyController@@AEAAJXZ @ 0x180149E50 (-GetSupportedVolumeStepping@TelephonyController@@AEAAJXZ.c)
