/*
 * XREFs of ?RecordFeatureUsageCallback@details@wil@@YAXIW4wil_details_ServiceReportingKind@@IPEATwil_details_FeaturePropertyCache@@PEAUwil_details_RecordUsageResult@@@Z @ 0x180038E30
 * Callers:
 *     <none>
 * Callees:
        ...
        _DWORD *a5)
{
  ...
  if ( a4 )
  {
    ...
    AcquireSRWLockExclusive(&stru_1801B7398);
    v9 = (void *)*(&xmmword_1801B73C0 + 1);
    v10 = xmmword_1801B73D0;
    v11 = xmmword_1801B73D0 - xmmword_1801B73C0;
    LODWORD(Source[0]) = v6;
    Source[1] = a4;
    if ( (unsigned __int64)(*(&xmmword_1801B73C0 + 1) - xmmword_1801B73C0 + 16LL) >= (_QWORD)xmmword_1801B73D0
                                                                                   - xmmword_1801B73C0 )
    {
      v14 = 2 * v11;
      if ( (unsigned __int64)(2 * v11) <= 0x10 )
        v14 = 16LL;
      if ( !wil::details_abi::heap_buffer::reserve((wil::details_abi::heap_buffer *)&xmmword_1801B73C0, v14) )
        goto LABEL_21;
      v10 = xmmword_1801B73D0;
      v9 = (void *)*(&xmmword_1801B73C0 + 1);
    }
...
LABEL_21:
    ...
    ReleaseSRWLockExclusive(&stru_1801B7398);
LABEL_6:
    v8 = v7[1];
    if ( v8 )
