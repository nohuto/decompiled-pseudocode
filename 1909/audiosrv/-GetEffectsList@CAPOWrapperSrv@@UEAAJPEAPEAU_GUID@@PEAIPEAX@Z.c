/*
 * XREFs of ?GetEffectsList@CAPOWrapperSrv@@UEAAJPEAPEAU_GUID@@PEAIPEAX@Z @ 0x180138390
 * Callers:
 *     <none>
 * Callees:
...
LABEL_9:
    if ( (unsigned int)dword_1801B54B8 > 2 )
    {
      ...
      v18 = 4;
      v21 = 4;
      TlgWrite((TraceLoggingHProvider)&dword_1801B54B8, &unk_18017BD9D, a3, a4, 5u, &pData);
      return v11;
    }
    return result;
  }
