/*
 * XREFs of ??0DynamicAudioEndpointManager@@QEAA@XZ @ 0x18005E988
 * Callers:
        ...
        DynamicAudioEndpointManager *this)
{
  ...
  *((_QWORD *)this + 121) = 0LL;
  *((_QWORD *)this + 122) = 0LL;
  *((_QWORD *)this + 121) = std::_Tree_comp_alloc<std::_Tmap_traits<unsigned long,APPLICATION_REF_DATA,std::less<unsigned long>,std::allocator<std::pair<unsigned long const,APPLICATION_REF_DATA>>,0>>::_Buyheadnode(v2);
  *((_QWORD *)this + 123) = 1LL;
  return this;
}
