/*
 * XREFs of ?SetRegistryKeyIntegrityLevel@@YAJPEAUHKEY__@@PEAX@Z @ 0x180045DE8
 * Callers:
...
__int64 __fastcall SetRegistryKeyIntegrityLevel(HKEY hKey, PSID pSid)
{
  ...
  if ( v9 < 0 )
  {
    ...
    AudSrvTraceLoggingErrorHelper("AddSidToSACL", 349, v13);
  }
  if ( KeySecurity > 0 )
  ...
  if ( KeySecurity < 0 )
LABEL_29:
    AudSrvTraceLoggingErrorHelper("SetRegistryKeyIntegrityLevel", 413, KeySecurity);
