/*
 * XREFs of ??1?$unique_ptr@VCVpoContextProxy@@U?$default_delete@VCVpoContextProxy@@@std@@@std@@QEAA@XZ @ 0x1800E3C64
 * Callers:
 *     AudioServerGetEndpointVpoContext$dtor$4 @ 0x1800E8121 (AudioServerGetEndpointVpoContext$dtor$4.c)
 *     AudioServerGetStreamVpoContext$dtor$6 @ 0x1800E9042 (AudioServerGetStreamVpoContext$dtor$6.c)
 * Callees:
