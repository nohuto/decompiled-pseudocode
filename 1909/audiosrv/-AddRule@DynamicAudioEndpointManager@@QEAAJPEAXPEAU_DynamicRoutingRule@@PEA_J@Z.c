/*
 * XREFs of ?AddRule@DynamicAudioEndpointManager@@QEAAJPEAXPEAU_DynamicRoutingRule@@PEA_J@Z @ 0x18012A36C
 * Callers:
 *     PolicyConfigAddDynamicRoutingRule @ 0x1800E1650 (PolicyConfigAddDynamicRoutingRule.c)
 * Callees:
