/*
 * XREFs of ?CompleteRevocation@CStreamResource@Sarm@@QEAAXXZ @ 0x180123CB8
 * Callers:
...
void __fastcall Sarm::CStreamResource::CompleteRevocation(Sarm::CStreamResource *this)
{
  ...
  if ( v3 )
  {
    if ( (unsigned int)dword_1801B5350 > 4 )
    {
      ...
      v24 = 4;
      v27 = 8;
      TlgWrite((TraceLoggingHProvider)&dword_1801B5350, &unk_180179A0D, (LPCGUID)4, v2, 9u, &pData);
      v3 = *((_DWORD *)this + 21);
    }
