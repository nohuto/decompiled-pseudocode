/*
 * XREFs of AudioSessionSetDisplayName @ 0x1800D4AE0
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall AudioSessionSetDisplayName(__int64 *a1, __int64 a2, __int64 a3)
{
  ...
  CWatchdogTimer<1>::CWatchdogTimer<1>(pv, v13[1], v6, (struct _TP_TIMER *)L"AudioSessionSetDisplayName");
  v8 = (*(__int64 (__fastcall **)(__int64, __int64, __int64))(*(_QWORD *)v3 + 192LL))(v3, a2, a3);
  v9 = v8;
  if ( v8 < 0 )
    AudSrvTraceLoggingErrorHelper("AudioSessionSetDisplayName", 1891, v8);
