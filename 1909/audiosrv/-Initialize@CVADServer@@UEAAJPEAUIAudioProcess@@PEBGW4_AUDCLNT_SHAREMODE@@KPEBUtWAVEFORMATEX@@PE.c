/*
 * XREFs of ?Initialize@CVADServer@@UEAAJPEAUIAudioProcess@@PEBGW4_AUDCLNT_SHAREMODE@@KPEBUtWAVEFORMATEX@@PEBU_GUID@@PEAUVadServerSettings@@PEAPEAGPEAUIProcessSubmixProxy@@@Z @ 0x180026450
 * Callers:
 *     <none>
 * Callees:
 ...
 *     WPP_SF_DDd @ 0x1800EB310 (WPP_SF_DDd.c)
 *     wil::details::lambda_call__lambda_98722233a2fe73481c7416c90accfe9a___::_lambda_call__lambda_98722233a2fe73481c7416c90accfe9a___ @ 0x1801024F8 (wil--details--lambda_call__lambda_98722233a2fe73481c7416c90accfe9a___--_lambda_call__lambda_9872.c)
 *     ?AddError@AudioJournal@@AEAAXJPEAUErrorInfo@1@@Z @ 0x180102958 (-AddError@AudioJournal@@AEAAXJPEAUErrorInfo@1@@Z.c)
 *     ?UseAutoConvertPCMForLoopbackStreams@CEndpointCharacteristics@@QEAA_NXZ @ 0x18011B0B4 (-UseAutoConvertPCMForLoopbackStreams@CEndpointCharacteristics@@QEAA_NXZ.c)
 */
...
LABEL_83:
  ...
  *((_DWORD *)this + 46) = 1;
  ...
  v62 = g_VADServerList;
  i = (__int64 *)qword_1801B6820;
  if ( !qword_1801B6820 )
  {
    if ( dword_1801B6828 )
    {
      if ( 0xFFFFFFFFFFFFFFFFuLL / (unsigned int)dword_1801B6828 < 0x18 )
        goto LABEL_206;
      v64 = 24LL * (unsigned int)dword_1801B6828;
    }
    else
    {
      v64 = 0LL;
    ...
    if ( (unsigned __int64)~v64 >= 8 )
    {
      ...
      {
        *v65 = qword_1801B6818;
        qword_1801B6818 = (__int64)v65;
        v66 = &v65[3 * (unsigned int)(dword_1801B6828 - 1) + 1];
        v67 = dword_1801B6828 - 1;
        for ( i = (__int64 *)qword_1801B6820; v67 >= 0; --v67 )
        {
          *v66 = (__int64)i;
          i = v66;
          qword_1801B6820 = (__int64)v66;
          v66 -= 3;
        }
        goto LABEL_153;
      }
...
LABEL_194:
  ...
  v75 = lpData;
  if ( lpData == (BYTE *)&unk_1801B7D98 )
  {
    v76 = L"Render";
    v77 = 600;
  }
  else if ( lpData == (BYTE *)&unk_1801B7FF0 )
  {
    v76 = L"Capture";
    v77 = 400;
  }
  ...
  v90 = 1;
  Key = RegCreateKeyExW(HKEY_LOCAL_MACHINE, &word_1801B8248, 0, 0LL, 0, 2u, 0LL, (PHKEY)&pv, 0LL);
  v16 = Key;
  if ( Key > 0 )
