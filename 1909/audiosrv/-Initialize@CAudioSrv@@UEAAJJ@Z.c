/*
 * XREFs of ?Initialize@CAudioSrv@@UEAAJJ@Z @ 0x18005CA90
 * Callers:
 *     <none>
 * Callees:
 ...
 *     ??0CAudioDGProcess@@QEAA@PEAUIMonitorDGTermination@@@Z @ 0x18005EFBC (--0CAudioDGProcess@@QEAA@PEAUIMonitorDGTermination@@@Z.c)
...
__int64 __fastcall CAudioSrv::Initialize(CAudioSrv *this, int a2)
{
  ...
  if ( !a2 )
  {
    ...
    if ( v6 )
    {
      v7 = (CPowerReferenceManager **)std::make_unique<CPowerReferenceManager,,0>(&ppv);
