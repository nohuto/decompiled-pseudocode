...
LABEL_9:
  ...
  *v17 = v18;
  ...
  if ( *a1 )
  {
    ...
    std::_Deallocate<16,0>(v21, ((char *)a1[2] - (char *)v21) & 0xFFFFFFFFFFFFFFF8uLL);
  }
  *a1 = (__int64 *)v15;
  a1[1] = (__int64 *)(v15 + 8 * v8);
  a1[2] = (__int64 *)(v12 + v15);
