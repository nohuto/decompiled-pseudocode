/*
 * XREFs of ?OnDeviceDescriptionChanged@CMonitorManager@@AEAAXPEBGPEBU_tagpropertykey@@@Z @ 0x18010B080
 * Callers:
 *     <none>
 * Callees:
        ...
        const struct _tagpropertykey *a3)
{
  ...
  else
  {
    ...
    if ( v8[0] )
    {
      CMonitor::OnDeviceDescriptionChanged((CMonitor *)v8[0][25].lpVtbl, v10);
      v6 = v8[0];
    }
    if ( v6 )
