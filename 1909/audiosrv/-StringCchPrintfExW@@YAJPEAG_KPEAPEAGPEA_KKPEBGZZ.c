/*
 * XREFs of ?StringCchPrintfExW@@YAJPEAG_KPEAPEAGPEA_KKPEBGZZ @ 0x1800C108C
 * Callers:
        ...
        ...)
{
  ...
  else
  {
    ...
    if ( (dwFlags & 0x100) != 0 )
    {
      v12 = (const wchar_t *)&unk_180161DC4;
      if ( pszFormat )
        v12 = pszFormat;
    }
    else
    ...
    else if ( cchDest )
    {
      ...
      v13 = StringVPrintfWorkerW_0(pszDest, cchDest, pcchNewDestLength, v12, argList);
