/*
 * XREFs of ?StopStream@CVADServer@@UEAAJ_KW4__MIDL___MIDL_itf_virtualaudiorpc_0000_0000_0002@@@Z @ 0x180027510
 * Callers:
 *     <none>
 * Callees:
      ...
      if ( g_AudioJournal )
      {
        ...
        if ( StreamInfo >= 0 )
        {
          *(double *)&lpData[200 * v43[1] + 168] = v23 + *(double *)&lpData[200 * v43[1] + 168];
          ...
          if ( v28 == (BYTE *)&unk_1801B7D98 )
          {
            v29 = L"Render";
            v30 = 600;
          }
          else if ( v28 == (BYTE *)&unk_1801B7FF0 )
          {
            v29 = L"Capture";
            v30 = 400;
          }
...
LABEL_84:
          ...
          *(_QWORD *)&v52 = &hKey;
          BYTE8(v52) = 1;
          v31 = RegCreateKeyExW(HKEY_LOCAL_MACHINE, &word_1801B8248, 0, 0LL, 0, 2u, 0LL, &hKey, 0LL);
          v10 = v31;
          if ( v31 > 0 )
