/*
 * XREFs of ?GetPropertyIndexForMetadataFormatID@SpatialAudioDevicePropertyReader@@AEAAJAEBU_GUID@@PEAGPEAI@Z @ 0x1801308A8
 * Callers:
 ...
 *     ?IsSpatialAudioStreamAvailable@SpatialAudioDevicePropertyReader@@UEAAJAEBU_GUID@@PEBUtagPROPVARIANT@@@Z @ 0x180131630 (-IsSpatialAudioStreamAvailable@SpatialAudioDevicePropertyReader@@UEAAJAEBU_GUID@@PEBUtagPROPVARI.c)
 * Callees:
        ...
        while ( 1 )
        {
          ...
          if ( (_WORD)pvar != 65 || (_DWORD)v20 != 18 )
          {
            ...
            if ( (unsigned int)dword_1801B53C0 > 2 )
            {
              ...
              v30 = &v17;
              v31 = 4LL;
              TlgWrite((TraceLoggingHProvider)&dword_1801B53C0, &unk_18017BCAD, v13, v14, 5u, &pData);
            }
            goto LABEL_18;
          }
