/*
 * XREFs of ?GetEffectsList@CAPOWrapperClient@@UEAAJPEAPEAU_GUID@@PEAIPEAX@Z @ 0x180003330
 * Callers:
 *     <none>
 * Callees:
        ...
        void *a4)
{
  ...
  v13 = result;
  if ( result < 0 && (unsigned int)dword_1801B54B8 > 2 )
  {
    v19 = 0;
    v22 = 0;
    v25 = 0;
    ...
    v21 = 4;
    v24 = 4;
    TlgWrite((TraceLoggingHProvider)&dword_1801B54B8, &unk_18017BD9D, v9, v10, 5u, &pData);
    return v13;
  }
  return result;
}
