/*
 * XREFs of AudioSessionGetVolume @ 0x18002D070
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall AudioSessionGetVolume(__int64 *a1, __int64 a2)
{
  ...
  v4 = (*(__int64 (__fastcall **)(__int64, __int64))(*(_QWORD *)v2 + 288LL))(v2, a2);
  v5 = v4;
  if ( v4 < 0 )
    AudSrvTraceLoggingErrorHelper("AudioSessionGetVolume", 0x813u, v4);
