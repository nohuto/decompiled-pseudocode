/*
 * XREFs of ?ConfigureForSpatialAudioEncoderSettings@SpatialAudioConfigureDevice@@UEAAJPEAUSpatialAudioSettings@@PEAUSpatialAudioEncoderDescriptor@@I@Z @ 0x1800487C0
 * Callers:
 *     <none>
 * Callees:
        ...
        unsigned int a4)
{
  ...
  if ( v11 < 0 )
  {
    ...
    v48 = &v38;
    v49 = 4LL;
    TlgWrite((TraceLoggingHProvider)&dword_1801B53C0, &unk_18017BC7B, v14, v15, 5u, &pData);
    goto LABEL_70;
  }
  if ( v40 )
  {
  ...
  if ( v36 < 0 )
  {
    if ( (unsigned int)dword_1801B53C0 > 2 )
    {
      ...
      v48 = &v38;
      v49 = 4LL;
      TlgWrite((TraceLoggingHProvider)&dword_1801B53C0, &unk_18017BC7B, v23, v24, 5u, &pData);
    }
LABEL_69:
    Microsoft::WRL::ComPtr<ISpatialAudioPositionCalc>::InternalRelease((__int64 *)&v39);
    goto LABEL_70;
...
LABEL_57:
  ...
  if ( v33 || *(_DWORD *)a2 )
  {
    ...
    if ( (unsigned int)dword_1801B53C0 > 2 )
    {
      ...
      v48 = &v36;
      v49 = 4LL;
      TlgWrite((TraceLoggingHProvider)&dword_1801B53C0, &unk_18017BCAD, v23, v24, 5u, &pData);
    }
    goto LABEL_69;
  }
LABEL_62:
  ...
  if ( v36 < 0 )
  {
    ...
    v48 = &v38;
    v49 = 4LL;
    TlgWrite((TraceLoggingHProvider)&dword_1801B53C0, &unk_18017BC7B, v34, v35, 5u, &pData);
    goto LABEL_70;
  }
LABEL_10:
