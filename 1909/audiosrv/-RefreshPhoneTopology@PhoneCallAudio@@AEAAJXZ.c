/*
 * XREFs of ?RefreshPhoneTopology@PhoneCallAudio@@AEAAJXZ @ 0x1801286A8
 * Callers:
 *     ?OnEndpointDeviceAdded@PhoneCallAudio@@UEAAXPEAUIEndpointDevice@@@Z @ 0x1801281D0 (-OnEndpointDeviceAdded@PhoneCallAudio@@UEAAXPEAUIEndpointDevice@@@Z.c)
 * Callees:
