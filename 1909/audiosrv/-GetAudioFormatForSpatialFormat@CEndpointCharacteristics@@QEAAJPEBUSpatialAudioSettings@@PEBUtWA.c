/*
 * XREFs of ?GetAudioFormatForSpatialFormat@CEndpointCharacteristics@@QEAAJPEBUSpatialAudioSettings@@PEBUtWAVEFORMATEX@@1PEAUWAVEFORMATEXTENSIBLE@@PEA_N@Z @ 0x180117214
 * Callers:
...
LABEL_4:
  ...
  *(struct _GUID *)&v19[8] = v18;
  ...
  v16 = *((_QWORD *)this + 5);
  v17 = *((_DWORD *)this + 39) == 0;
  v20 = (__int64)off_18015CFF8;
  LOBYTE(v15) = !v17;
  v22 = *(_QWORD *)&v19[16];
  v23 = &v20;
  v21 = *(_OWORD *)v19;
