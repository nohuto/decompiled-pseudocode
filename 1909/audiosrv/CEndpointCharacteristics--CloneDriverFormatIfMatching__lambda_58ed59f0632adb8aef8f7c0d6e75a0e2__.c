/*
 * XREFs of CEndpointCharacteristics::CloneDriverFormatIfMatching__lambda_58ed59f0632adb8aef8f7c0d6e75a0e2___ @ 0x180112D58
 * Callers:
...
__int64 __fastcall CEndpointCharacteristics::CloneDriverFormatIfMatching__lambda_58ed59f0632adb8aef8f7c0d6e75a0e2___(
        __int64 a1,
        __int64 a2,
        unsigned int *a3,
      ...
      if ( !v9 && *a3 > 0x40 )
      {
        ...
        if ( v10 <= 0x28 )
        {
          ...
          if ( _bittest64(&v11, v10) )
          {
            ...
            {
              v16[0] = 0;
              lambda_53c21122ac2ea0b62ae7643ed09637d7_::operator()(a2, v12, v16);
              if ( v16[0] )
