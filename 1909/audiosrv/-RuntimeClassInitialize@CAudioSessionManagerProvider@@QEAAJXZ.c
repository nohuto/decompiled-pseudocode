/*
 * XREFs of ?RuntimeClassInitialize@CAudioSessionManagerProvider@@QEAAJXZ @ 0x18005E5B8
 * Callers:
...
__int64 __fastcall CAudioSessionManagerProvider::RuntimeClassInitialize(CAudioSessionManagerProvider *this)
{
  ...
  DynamicAudioEndpointManager *v16; // [rsp+30h] [rbp-20h] BYREF
  __int64 v17[3]; // [rsp+38h] [rbp-18h] BYREF
  wil::details::in1diag3 *retaddr; // [rsp+68h] [rbp+18h]
  CAudioSessionManagerProvider *v19; // [rsp+70h] [rbp+20h] BYREF
  struct IAudioPolicyManager *v20; // [rsp+78h] [rbp+28h] BYREF
  struct ITelephonyControl *v21; // [rsp+80h] [rbp+30h] BYREF
  struct ISessionInternalEvents *v22; // [rsp+88h] [rbp+38h] BYREF
  ...
  if ( v3 >= 0 )
  {
    v20 = 0LL;
    v4 = v21;
    v5 = ActivatePolicyManager(g_pEndpointCharacteristicsCache, g_pVolumeProvider, v17[0], v21, &v20);
    v2 = v5;
    if ( v5 < 0 )
    {
      wil::details::in1diag3::Return_Hr(
