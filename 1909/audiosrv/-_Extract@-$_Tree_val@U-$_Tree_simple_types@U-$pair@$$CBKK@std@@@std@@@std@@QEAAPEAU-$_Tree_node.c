/*
 * XREFs of ?_Extract@?$_Tree_val@U?$_Tree_simple_types@U?$pair@$$CBKK@std@@@std@@@std@@QEAAPEAU?$_Tree_node@U?$pair@$$CBKK@std@@PEAX@2@V?$_Tree_const_iterator@V?$_Tree_val@U?$_Tree_simple_types@U?$pair@$$CBKK@std@@@std@@@std@@@2@@Z @ 0x18003B250
 * Callers:
        ...
        __int64 *a2)
{
  ...
  {
    i = std::_Tree_val<std::_Tree_simple_types<std::pair<std::wstring const,std::wstring>>>::_Min(a2[2], a2, v3, v2);
  }
  if ( *(_BYTE *)(*v5 + 25) )
    goto LABEL_4;
  if ( *(_BYTE *)(v2 + 25) )
...
LABEL_4:
    ...
    if ( (__int64 *)**v4 == v5 )
    {
      if ( *(_BYTE *)(v2 + 25) )
        ...
        v9 = std::_Tree_val<std::_Tree_simple_types<std::pair<std::wstring const,std::wstring>>>::_Min(v2, a2, v3, v2);
      *v3 = v9;
      v3 = *v4;
      v8 = *v4;
    }
