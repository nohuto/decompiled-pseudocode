/*
 * XREFs of ??1?$CAutoPtrArray@VCAccessAce@CDacl@ATL@@@ATL@@QEAA@XZ @ 0x1800DCA84
 * Callers:
 *     _DetermineLowRightsKeySecurityDescriptor_::_1_::dtor$5 @ 0x180071285 (_DetermineLowRightsKeySecurityDescriptor_--_1_--dtor$5.c)
 * Callees:
