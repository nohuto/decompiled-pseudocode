/*
 * XREFs of ?CalculateStaticId@CAudioSessionInstanceId@@AEAAJXZ @ 0x180023700
 * Callers:
 ...
 *     ?SafeStringLen@?$ChTraitsCRT@G@ATL@@SAHPEBG@Z @ 0x1800262A8 (-SafeStringLen@-$ChTraitsCRT@G@ATL@@SAHPEBG@Z.c)
