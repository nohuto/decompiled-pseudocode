...
__int64 __fastcall std::pair<std::wstring const,Microsoft::WRL::ComPtr<IDeviceGraphObjectsStore>>::`scalar deleting destructor'(
        __int64 a1)
{
  __int64 v2; // rcx
  ...
  if ( v3 >= 8 )
  {
    v4 = (struct std::nothrow_t *)(2 * v3 + 2);
    v7 = v4;
    v5 = *(void **)a1;
    v8 = *(void **)a1;
