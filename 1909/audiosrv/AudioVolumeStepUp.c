/*
 * XREFs of AudioVolumeStepUp @ 0x1800CB380
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall AudioVolumeStepUp(_QWORD *a1, __int64 a2, __int64 a3)
{
  __int64 v6; // r8
  void *v7; // r8
  unsigned int v8; // ebx
  ...
  CWatchdogTimer<1>::CWatchdogTimer<1>(pv, v12[1], v6, (struct _TP_TIMER *)L"AudioVolumeStepUp");
  v8 = (*(__int64 (__fastcall **)(_QWORD, __int64, __int64))(*(_QWORD *)*a1 + 128LL))(*a1, a2, a3);
