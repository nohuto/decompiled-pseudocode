/*
 * XREFs of ?AcquireResourceHandle@CConstraintModelResourceManager@@AEAAJPEAU_ResourceInfo@@KKHPEA_K@Z @ 0x1800FF1C4
 * Callers:
 ...
 *     ?GetRmResourceSet@CConstraintModelResourceManager@@AEAAJPEAU_ResourceInfo@@KKPEAURmResourceInfo@@@Z @ 0x1800FFF88 (-GetRmResourceSet@CConstraintModelResourceManager@@AEAAJPEAU_ResourceInfo@@KKPEAURmResourceInfo@.c)
 ...
 *     WPP_SF_dI @ 0x18010236C (WPP_SF_dI.c)
 */
        ...
        unsigned __int64 *a6)
{
  ...
  _QWORD v22[2]; // [rsp+68h] [rbp-11h] BYREF
