/*
 * XREFs of ?Initialize@CEndpointResourcePool@Sarm@@QEAAJPEAUISaDeviceProxy@@PEAU__POSITION@@@Z @ 0x1801236FC
 * Callers:
 ...
 *     ??$make_shared@UPool@CEndpointResourcePool@Sarm@@AEAIAEAIAEA_J@std@@YA?AV?$shared_ptr@UPool@CEndpointResourcePool@Sarm@@@0@AEAI0AEA_J@Z @ 0x180123514 (--$make_shared@UPool@CEndpointResourcePool@Sarm@@AEAIAEAIAEA_J@std@@YA-AV-$shared_ptr@UPool@CEnd.c)
 */
...
LABEL_5:
  ...
  if ( (unsigned int)dword_1801B5350 > 4 )
  {
    ...
    TlgWrite((TraceLoggingHProvider)&dword_1801B5350, &unk_1801797F9, v10, v11, 7u, &pData);
  }
  try
  {
    v12 = v17 != 0;
