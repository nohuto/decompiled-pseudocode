/*
 * XREFs of ?Start@CMonitor@@QEAAJXZ @ 0x180110DA0
 * Callers:
 ...
 *     ?AllocateBytes@?$CHeapPtrBase@EVCCRTAllocator@ATL@@@ATL@@QEAA_N_K@Z @ 0x18010DBD8 (-AllocateBytes@-$CHeapPtrBase@EVCCRTAllocator@ATL@@@ATL@@QEAA_N_K@Z.c)
