/*
 * XREFs of ?Initialize@CAppInstanceId@@QEAAJPEBG@Z @ 0x1800DB8D4
 * Callers:
...
__int64 __fastcall CAppInstanceId::Initialize(CAppInstanceId *this, unsigned __int16 *a2)
{
  ...
  if ( v5 - 24 != (char *)(v24 - 12) )
  {
    ...
    {
      ATL::CSimpleStringT<unsigned short,0>::SetString((__int64 *)&v24, v5, *((_DWORD *)v5 - 4));
      v7 = v24;
    }
  }
...
LABEL_29:
  ...
  if ( v11 - 24 != (char *)(String - 12) )
  {
    ...
    {
      ATL::CSimpleStringT<unsigned short,0>::SetString((__int64 *)&String, v11, *((_DWORD *)v11 - 4));
      v13 = String;
    }
  }
  ATL::CStringData::Release((ATL::CStringData *)(v31 - 24));
