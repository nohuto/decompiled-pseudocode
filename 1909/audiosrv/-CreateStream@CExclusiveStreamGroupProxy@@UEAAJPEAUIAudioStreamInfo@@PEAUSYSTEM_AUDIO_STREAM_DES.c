/*
 * XREFs of ?CreateStream@CExclusiveStreamGroupProxy@@UEAAJPEAUIAudioStreamInfo@@PEAUSYSTEM_AUDIO_STREAM_DESCRIPTOR@@PEAUIAudioGraphCallback@@KPEAUSYSTEM_AUDIO_STREAM@@@Z @ 0x1800EE3D0
 * Callers:
 *     <none>
 * Callees:
        ...
        struct SYSTEM_AUDIO_STREAM *a6)
{
  ...
  if ( v10 >= 0 )
  {
    ...
    *(_QWORD *)(this + 424) = v19;
    v20 = *(struct IAudioGraphCallback **)(this + 560);
    if ( v20 != a4 )
    {
      if ( a4 )
      {
    ...
    *((_QWORD *)a6 + 6) = this & -(__int64)(this != 8);
    ...
    Microsoft::WRL::Details::StrongReference::IncrementStrongReference((Microsoft::WRL::Details::StrongReference *)(2 * v21 + 16));
LABEL_16:
