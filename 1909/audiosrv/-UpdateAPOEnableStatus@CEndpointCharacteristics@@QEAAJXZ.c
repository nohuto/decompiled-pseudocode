/*
 * XREFs of ?UpdateAPOEnableStatus@CEndpointCharacteristics@@QEAAJXZ @ 0x18011AB28
 * Callers:
  ...
  while ( 1 )
  {
    ...
    if ( (*(int (__fastcall **)(_QWORD, LPCWSTR *))(**((_QWORD **)this + 2) + 40LL))(*((_QWORD *)this + 2), &pwsz) >= 0 )
    {
      ...
      if ( (unsigned int)hProvider > 4 && TlgKeywordOn((TraceLoggingHProvider)&hProvider, 0x200000000000uLL) )
      {
        ...
        v31 = &v24;
        v32 = 4LL;
        TlgWrite((TraceLoggingHProvider)&hProvider, &unk_18017900D, v5, v6, 5u, &pData);
      }
      if ( v23 )
        ...
        && (unsigned int)CEndpointCharacteristics::AreAllNonCriticalAPOsDisabled(this) )
      {
        ...
        if ( (*(int (__fastcall **)(_QWORD, LPCWSTR *))(**((_QWORD **)this + 2) + 40LL))(*((_QWORD *)this + 2), &pwsz) >= 0 )
        {
          ...
          if ( (unsigned int)hProvider > 4 && TlgKeywordOn((TraceLoggingHProvider)&hProvider, 0x200000000000uLL) )
          {
            ...
            TlgWrite((TraceLoggingHProvider)&hProvider, &unk_180179064, v11, v12, 4u, &pData);
          }
          if ( v18 )
