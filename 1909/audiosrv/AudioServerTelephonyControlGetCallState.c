/*
 * XREFs of AudioServerTelephonyControlGetCallState @ 0x1800EA3A0
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall AudioServerTelephonyControlGetCallState(__int64 a1, __int64 a2, __int64 a3)
{
  ...
  CWatchdogTimer<1>::CWatchdogTimer<1>(pv, v9[1], v5, (struct _TP_TIMER *)L"AudioServerTelephonyControlGetCallState");
  v7 = ((__int64 (__fastcall *)(struct IUnknown *, __int64, __int64))g_TelephonyControl->lpVtbl[3].QueryInterface)(
         g_TelephonyControl,
         a2,
         a3);
