/*
 * XREFs of ?InitializeAPORemote@CAPOWrapperSrv@@UEAAJPEBGPEAU_GUID@@U2@HHHPEAU__MIDL___MIDL_itf_audioenginepolicy_0000_0010_0002@@@Z @ 0x1801387F0
 * Callers:
 *     <none>
 * Callees:
...
LABEL_30:
        if ( (unsigned int)dword_1801B54B8 > 2 )
        {
          ...
          v34 = 4;
          v37 = 4;
          TlgWrite((TraceLoggingHProvider)&dword_1801B54B8, &unk_18017BD9D, v13, v14, 5u, &pData);
          v12 = Instance;
        }
        goto LABEL_32;
      }
