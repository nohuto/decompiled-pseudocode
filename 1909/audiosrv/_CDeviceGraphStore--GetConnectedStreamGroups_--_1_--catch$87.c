/*
 * XREFs of _CDeviceGraphStore::GetConnectedStreamGroups_::_1_::catch$87 @ 0x1800F2DC7
 * Callers:
 *     <none>
 * Callees:
...
void *__fastcall CDeviceGraphStore::GetConnectedStreamGroups_::_1_::catch_87(
        __int64 a1,
        __int64 a2,
        __int64 a3,
        const char *a4)
