/*
 * XREFs of ??0CExclusiveModeListener@@QEAA@XZ @ 0x18011EC30
 * Callers:
 ...
 * Callees:
 *     ??0CSpatialAudioResourceManagerTraceLogger@@QEAA@XZ @ 0x180059EEC (--0CSpatialAudioResourceManagerTraceLogger@@QEAA@XZ.c)
 ...
 *     ?_Buyheadnode@?$_Tree_comp_alloc@V?$_Tmap_traits@U_GUID@@UHmdInfo@@U?$less@U_GUID@@@std@@V?$allocator@U?$pair@$$CBU_GUID@@UHmdInfo@@@std@@@4@$0A@@std@@@std@@QEAAPEAU?$_Tree_node@U?$pair@$$CBU_GUID@@UHmdInfo@@@std@@PEAX@2@XZ @ 0x180122430 (-_Buyheadnode@-$_Tree_comp_alloc@V-$_Tmap_traits@U_GUID@@UHmdInfo@@U-$less@U_GUID@@@std@@V-$allo.c)
 */
