/*
 * XREFs of ?RemoveAt@?$CAtlArray@V?$CAutoPtr@VCAccessAce@CDacl@ATL@@@ATL@@V?$CAutoPtrElementTraits@VCAccessAce@CDacl@ATL@@@2@@ATL@@QEAAX_K0@Z @ 0x1800DFF04
 * Callers:
 *     ?RemoveAce@CDacl@ATL@@UEAAXI@Z @ 0x1800DFEF0 (-RemoveAce@CDacl@ATL@@UEAAXI@Z.c)
 * Callees:
