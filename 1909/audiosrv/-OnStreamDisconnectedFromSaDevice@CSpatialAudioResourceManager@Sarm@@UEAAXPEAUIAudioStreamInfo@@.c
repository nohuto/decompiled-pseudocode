/*
 * XREFs of ?OnStreamDisconnectedFromSaDevice@CSpatialAudioResourceManager@Sarm@@UEAAXPEAUIAudioStreamInfo@@@Z @ 0x18004BA50
 * Callers:
 *     <none>
 * Callees:
        ...
        struct IAudioStreamInfo *a2)
{
  ...
  if ( (unsigned int)dword_1801B5350 > 5 )
  {
    ...
    v29 = off_1801B5358;
    v21 = 0x50B000000uLL;
    v30 = *(unsigned __int16 *)off_1801B5358;
    v32 = &unk_18017972F;
    v31 = 2;
    v33 = 21;
    v34 = 1;
    v17 = (unsigned int)&TraceLoggingMetadataEnd - (unsigned int)&TraceLoggingMetadata;
    EtwEventWriteTransfer(qword_1801B5370, &v21, 0LL, 0LL, 4, &v29);
  }
  v22 = 0LL;
  v5 = 0LL;
  if ( a2 )
...
LABEL_6:
      ...
      if ( v5 )
      {
        ...
        if ( (unsigned int)dword_1801B5350 > 4 )
        {
          ...
          v24 = v10;
          v51 = 8LL;
          TlgWrite((TraceLoggingHProvider)&dword_1801B5350, &unk_1801793F2, v7, (LPCGUID)v8, 8u, &pData);
        }
