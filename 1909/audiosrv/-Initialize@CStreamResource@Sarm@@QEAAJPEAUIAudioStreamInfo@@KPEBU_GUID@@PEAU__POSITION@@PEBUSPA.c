/*
 * XREFs of ?Initialize@CStreamResource@Sarm@@QEAAJPEAUIAudioStreamInfo@@KPEBU_GUID@@PEAU__POSITION@@PEBUSPATIAL_STREAM_PROPERTIES@@PEAVCEndpointResourcePool@2@@Z @ 0x180123FC0
 * Callers:
  ...
  if ( v11 >= 0 )
  {
    ...
    *((_QWORD *)this + 1) = a7;
    ...
    if ( (unsigned int)dword_1801B5350 > 4 )
    {
      ...
      v46 = v23;
      v47 = 8LL;
      TlgWrite((TraceLoggingHProvider)&dword_1801B5350, &unk_180179B02, v14, v15, 0xEu, &pData);
    }
    v12 = 0;
  }
  else
