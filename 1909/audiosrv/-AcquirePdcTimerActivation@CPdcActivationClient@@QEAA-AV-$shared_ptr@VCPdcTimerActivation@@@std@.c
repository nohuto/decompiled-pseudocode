/*
 * XREFs of ?AcquirePdcTimerActivation@CPdcActivationClient@@QEAA?AV?$shared_ptr@VCPdcTimerActivation@@@std@@PEAVCVADServer@@@Z @ 0x180020C00
 * Callers:
  ...
  try
  {
    ...
    *a2 = 0LL;
    ...
    if ( *(_QWORD *)a1 )
    {
      ...
      if ( *(_QWORD **)(a1 + 24) == v8 )
      {
        std::vector<CVADServer *>::_Emplace_reallocate<CVADServer * const &>(a1 + 8, v8, &v29);
        v3 = v29;
      }
      else
      {
