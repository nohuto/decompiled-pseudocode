/*
 * XREFs of ?ReacquireResourceHandle@CConstraintModelResourceManager@@AEAAJ_KPEAU_ResourceInfo@@KKPEA_K@Z @ 0x180101394
 * Callers:
        ...
        unsigned __int64 *a6)
{
  ...
  LPCRITICAL_SECTION v16; // [rsp+48h] [rbp-20h] BYREF
