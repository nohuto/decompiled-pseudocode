/*
 * XREFs of ?GetLicenseStatusForEndpointId@AtmosCheck@@AEAAJPEBG0PEAU__MIDL___MIDL_itf_spatialaudiolicenseserver_0000_0000_0001@@@Z @ 0x18013EAF0
 * Callers:
        ...
        const GUID *a4)
{
  ...
  if ( *((_BYTE *)this + 216) )
  {
    ...
    else if ( *((_BYTE *)this + 32 * v9 + 256) )
    {
      if ( (unsigned int)dword_1801B54F0 > 5 )
      {
        ...
        v22 = 4;
        v23 = 0;
        TlgWrite((TraceLoggingHProvider)&dword_1801B54F0, &unk_18017C287, v10, v11, 4u, &pData);
      }
      v18[0] = 0LL;
      ...
      if ( SpatialAudioLicenseServer >= 0 )
      {
        ...
        if ( (unsigned int)dword_1801B54F0 > 5 )
        {
          ...
          v28 = 4;
          v29 = 0;
          TlgWrite((TraceLoggingHProvider)&dword_1801B54F0, &unk_18017C019, v14, v15, 6u, &pData);
          v13 = v17;
        }
      }
      else
  ...
  {
    if ( (unsigned int)dword_1801B54F0 > 5 )
      TlgWrite((TraceLoggingHProvider)&dword_1801B54F0, &unk_18017C118, a3, a4, 2u, &pData);
    return 0LL;
  }
}
