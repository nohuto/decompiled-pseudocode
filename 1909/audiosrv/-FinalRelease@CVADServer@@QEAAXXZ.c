/*
 * XREFs of ?FinalRelease@CVADServer@@QEAAXXZ @ 0x18004C8E0
 * Callers:
...
void __fastcall CVADServer::FinalRelease(CServerAudioSessionControl **this, __int64 a2, __int64 a3)
{
  ...
  {
    WPP_SF_q(*((_QWORD *)WPP_GLOBAL_Control + 2), 14LL, &WPP_68f7ce5d5567395ebc4ef499649768ed_Traceguids, this[21]);
    v9 = WPP_GLOBAL_Control;
  }
  v10 = this[21];
  if ( v10 )
  ...
  if ( v9 != (CAudioSessionManager *)&WPP_GLOBAL_Control )
  {
    ...
    {
      WPP_SF_(*((_QWORD *)v9 + 2), 15LL, &WPP_68f7ce5d5567395ebc4ef499649768ed_Traceguids);
      v9 = WPP_GLOBAL_Control;
    }
    if ( v9 != (CAudioSessionManager *)&WPP_GLOBAL_Control
      && (*((_DWORD *)v9 + 7) & 0x100) != 0
      && *((_BYTE *)v9 + 25) >= 5u )
    {
      WPP_SF_q(*((_QWORD *)v9 + 2), 16LL, &WPP_68f7ce5d5567395ebc4ef499649768ed_Traceguids, this[19]);
      v9 = WPP_GLOBAL_Control;
    }
  }
  v11 = this[19];
  ...
  if ( v9 != (CAudioSessionManager *)&WPP_GLOBAL_Control
    ...
    && *((_BYTE *)v9 + 25) >= 5u )
  {
    WPP_SF_(*((_QWORD *)v9 + 2), 17LL, &WPP_68f7ce5d5567395ebc4ef499649768ed_Traceguids);
  }
  v17 = 0;
  ...
  if ( g_VADServerList )
  {
    ...
    {
      v14 = *(_QWORD *)v13;
      if ( *(CServerAudioSessionControl ***)(v13 + 16) == this )
        break;
      v13 = *(_QWORD *)v13;
      if ( !v14 )
        goto LABEL_56;
    ...
    if ( v13 == g_VADServerList )
      ...
      **(_QWORD **)(v13 + 8) = v14;
    if ( v13 == qword_1801B6808 )
      qword_1801B6808 = *(_QWORD *)(v13 + 8);
    else
      *(_QWORD *)(*(_QWORD *)v13 + 8LL) = *(_QWORD *)(v13 + 8);
    *(_QWORD *)v13 = qword_1801B6820;
    v15 = qword_1801B6810-- == 1;
    qword_1801B6820 = v13;
    if ( v15 )
