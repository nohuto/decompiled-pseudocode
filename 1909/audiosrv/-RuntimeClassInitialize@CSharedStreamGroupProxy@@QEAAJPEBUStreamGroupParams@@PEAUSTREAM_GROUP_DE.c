/*
 * XREFs of ?RuntimeClassInitialize@CSharedStreamGroupProxy@@QEAAJPEBUStreamGroupParams@@PEAUSTREAM_GROUP_DESCRIPTOR@@K@Z @ 0x18003AB20
 * Callers:
...
LABEL_35:
  ...
  if ( (int)Microsoft::WRL::AsWeak<IStreamGroupProxy>(ppMalloc[0], v38) < 0
    || (LODWORD(p_DebugInfo) = 0,
        Microsoft::WRL::ComPtr<ISpatialAudioPositionCalc>::InternalRelease((char *)this + 1592),
