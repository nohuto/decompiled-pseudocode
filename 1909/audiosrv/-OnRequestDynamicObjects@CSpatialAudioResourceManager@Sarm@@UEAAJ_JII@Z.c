/*
 * XREFs of ?OnRequestDynamicObjects@CSpatialAudioResourceManager@Sarm@@UEAAJ_JII@Z @ 0x180120B10
 * Callers:
 ...
 *     ?WaitForWorkToComplete@CWorkFifo@@QEAA_NXZ @ 0x1801223B0 (-WaitForWorkToComplete@CWorkFifo@@QEAA_NXZ.c)
