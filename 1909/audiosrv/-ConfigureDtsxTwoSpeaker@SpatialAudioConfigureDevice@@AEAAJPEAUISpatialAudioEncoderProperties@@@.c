/*
 * XREFs of ?ConfigureDtsxTwoSpeaker@SpatialAudioConfigureDevice@@AEAAJPEAUISpatialAudioEncoderProperties@@@Z @ 0x180132FB4
 * Callers:
  ...
  if ( MetadataDictionaryData >= 0 )
  {
    ...
    if ( MetadataDictionaryData >= 0 )
    {
      ...
      if ( MetadataDictionaryData >= 0 )
      {
        ...
        MetadataDictionaryData = Create_MetadataDictionaryData(v11, &DTSX_SPEAKERS_METADATA_V1_0, v12, v20);
        v18 = MetadataDictionaryData;
        if ( MetadataDictionaryData >= 0 )
        {
          ...
          {
            v23 = "SpatialAudioConfigureDevice::ConfigureDtsxTwoSpeaker";
            v24 = 53LL;
            v19 = 451;
            v25 = &v19;
            v26 = 4LL;
