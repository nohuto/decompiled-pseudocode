/*
 * XREFs of __tailMerge_api_ms_win_core_winrt_error_l1_1_0_dll @ 0x180066A19
 * Callers:
 *     __imp_load_RoOriginateError @ 0x180066A0D (__imp_load_RoOriginateError.c)
 *     __imp_load_SetRestrictedErrorInfo @ 0x180066C31 (__imp_load_SetRestrictedErrorInfo.c)
 * Callees:
