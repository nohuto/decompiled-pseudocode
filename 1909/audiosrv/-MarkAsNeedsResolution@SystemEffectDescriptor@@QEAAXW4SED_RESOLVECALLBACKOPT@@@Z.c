/*
 * XREFs of ?MarkAsNeedsResolution@SystemEffectDescriptor@@QEAAXW4SED_RESOLVECALLBACKOPT@@@Z @ 0x18000DD48
 * Callers:
    ...
    if ( *(int *)(a1 + 40) > 0 )
    {
      ...
      do
      {
        if ( v5 < 0 || v5 >= *(_DWORD *)(a1 + 40) )
        {
          ...
          JUMPOUT(0x18007A137LL);
        }
        if ( (a2 & *(_DWORD *)(*(_QWORD *)(*(_QWORD *)(a1 + 32) + v6) + 16LL)) != 0 )
          *(_BYTE *)(*(_QWORD *)ATL::CSimpleArray<_GUID,ATL::CSimpleArrayEqualHelper<_GUID>>::operator[](a1 + 32, v5)
                   + 20LL) = 1;
        ++v5;
        v6 += 16LL;
      }
