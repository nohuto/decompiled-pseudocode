/*
 * XREFs of std::_Func_impl_no_alloc__lambda_5b4f55a98d7fda8daa27f269950a02d8__bool_Microsoft::WRL::ComPtr_IProcessSubmixProxy__const_&_::_Do_call @ 0x1800F3A40
 * Callers:
 *     <none>
 * Callees:
