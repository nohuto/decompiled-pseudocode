/*
 * XREFs of AudioVolumeSetMute @ 0x1800CB180
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall AudioVolumeSetMute(_QWORD *a1, unsigned int a2, __int64 a3, __int64 a4)
{
  __int64 v8; // r8
  void *v9; // r8
  ...
  CWatchdogTimer<1>::CWatchdogTimer<1>(pv, v12[1], v8, (struct _TP_TIMER *)L"AudioVolumeSetMute");
  v10 = (*(__int64 (__fastcall **)(_QWORD, _QWORD, __int64, __int64))(*(_QWORD *)*a1 + 144LL))(*a1, a2, a3, a4);
