/*
 * XREFs of ?Create@CSystemEffectWrapper@@SAJAEBU_GUID@@PEAUIMMDevice@@PEBGW4APO_TYPE@@PEAUIUnknown@@PEAPEAU5@@Z @ 0x1801396B4
 * Callers:
 ...
 * Callees:
 *     ??0CSystemEffectWrapper@@QEAA@XZ @ 0x180138F24 (--0CSystemEffectWrapper@@QEAA@XZ.c)
 ...
 *     ?AERTGetDLLRTHeap@@YAPEAXXZ @ 0x18013BA8C (-AERTGetDLLRTHeap@@YAPEAXXZ.c)
 */
