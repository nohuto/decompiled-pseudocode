/*
 * XREFs of ?QueueRecurringItem@CSerialWorkQueue@@QEAAJKKV?$function@$$A6AXXZ@std@@AEAV?$unique_ptr@U_RecurringTask@@U?$default_delete@U_RecurringTask@@@std@@@3@@Z @ 0x18004FADC
 * Callers:
 ...
 *     ?Initialize@CSerialWorkQueue@@AEAAJXZ @ 0x18004FC4C (-Initialize@CSerialWorkQueue@@AEAAJXZ.c)
