/*
 * XREFs of ?QueryAvailabilitySaDeviceResource@CConstraintModelResourceManager@@UEAAHPEBGW4AUDIO_DIRECTION@@U_GUID@@W4__MIDL___MIDL_itf_audioengineendpoint_0000_0000_0001@@K@Z @ 0x180100B60
 * Callers:
 *     <none>
 * Callees:
  ...
  if ( v18 >= 0 && v10 )
  {
    ...
    if ( v17 >= 0 )
    {
        ...
        && fPending )
      {
        ...
        wil::TraceLoggingProvider::Register((wil::TraceLoggingProvider *)&qword_1801B7588, qword_1801B75A0, v22);
      ...
      if ( **((_DWORD **)Context + 1) > 4u )
      {
        ...
        v46 = &a6;
        v49 = 4LL;
        TlgWrite(v24, &unk_180178BFB, v23, (LPCGUID)v24, 5u, &v44);
      }
      v17 = v31;
      if ( v31 >= 0 )
      {
LABEL_20:
        ...
        if ( v31 < 0 )
        {
            ...
            && fPending )
          {
            ...
            qword_1801B75A0 = (struct _TlgProvider_t *)&`AudioSrvTelemetryProvider::StaticHandle::StaticHandle'::`2'::__hInner;
            atexit(lambda_b4cb8953ddd9016186cd5ae31274160b_::_lambda_invoker_cdecl_);
            wil::TraceLoggingProvider::Register((wil::TraceLoggingProvider *)&qword_1801B7588, qword_1801B75A0, v25);
            InitOnceComplete(&`AudioSrvTelemetryProvider::Instance'::`2'::wrapper, 0, &qword_1801B7588);
          }
          if ( **((_DWORD **)Context + 1) > 4u )
          {
            ...
            v46 = &a6;
            v49 = v26;
            TlgWrite(v28, &unk_180178B82, v27, (LPCGUID)v28, 5u, &v44);
          }
          v17 = v31;
        }
      }
