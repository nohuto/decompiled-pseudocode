/*
 * XREFs of ?RemoveRule@DynamicAudioEndpointManager@@QEAAJPEAX_J@Z @ 0x18012BAC8
 * Callers:
 *     PolicyConfigRemoveDynamicRoutingRule @ 0x1800E24B0 (PolicyConfigRemoveDynamicRoutingRule.c)
 * Callees:
