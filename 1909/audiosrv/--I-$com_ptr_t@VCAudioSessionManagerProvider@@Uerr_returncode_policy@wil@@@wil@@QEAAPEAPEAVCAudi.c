/*
 * XREFs of ??I?$com_ptr_t@VCAudioSessionManagerProvider@@Uerr_returncode_policy@wil@@@wil@@QEAAPEAPEAVCAudioSessionManagerProvider@@XZ @ 0x1800BE248
 * Callers:
...
__int64 *__fastcall wil::com_ptr_t<CAudioSessionManagerProvider,wil::err_returncode_policy>::operator&(__int64 *a1)
{
  __int64 v2; // rcx
