/*
 * XREFs of ??$MakeAndInitialize@VSpatialAudioMetadataDictionaryData@@V1@AEAW4DictionaryLoadKind@@AEBU_GUID@@AEAG@Details@WRL@Microsoft@@YAJPEAPEAVSpatialAudioMetadataDictionaryData@@AEAW4DictionaryLoadKind@@AEBU_GUID@@AEAG@Z @ 0x1801355DC
 * Callers:
 ...
 *     ??0SpatialAudioMetadataDictionaryData@@QEAA@XZ @ 0x18013574C (--0SpatialAudioMetadataDictionaryData@@QEAA@XZ.c)
