/*
 * XREFs of ?HandleDeviceRemoved@CMonitorManager@@AEAAXPEBG@Z @ 0x180109D94
 * Callers:
 ...
 *     ?IsConnectedTo@CaptureMonitor@CMonitorManager@@QEBA_NPEBG@Z @ 0x18010A714 (-IsConnectedTo@CaptureMonitor@CMonitorManager@@QEBA_NPEBG@Z.c)
...
void __fastcall CMonitorManager::HandleDeviceRemoved(CMonitorManager *this, unsigned __int16 *a2)
{
  ...
  CMonitorManager::CaptureMonitor *v21; // [rsp+A0h] [rbp+8h] BYREF
  unsigned __int16 *v22; // [rsp+A8h] [rbp+10h]
  int v23; // [rsp+B0h] [rbp+18h]
  CMonitorManager::CaptureMonitor *v24; // [rsp+B8h] [rbp+20h] BYREF
