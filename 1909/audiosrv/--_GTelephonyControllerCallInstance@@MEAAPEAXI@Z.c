/*
 * XREFs of ??_GTelephonyControllerCallInstance@@MEAAPEAXI@Z @ 0x18014B638
 * Callers:
 *     ??_ETelephonyControllerCallInstance@@O7EAAPEAXI@Z @ 0x18006D860 (--_ETelephonyControllerCallInstance@@O7EAAPEAXI@Z.c)
 * Callees:
