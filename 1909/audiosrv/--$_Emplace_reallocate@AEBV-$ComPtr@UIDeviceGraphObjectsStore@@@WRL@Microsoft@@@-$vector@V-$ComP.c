/*
 * XREFs of ??$_Emplace_reallocate@AEBV?$ComPtr@UIDeviceGraphObjectsStore@@@WRL@Microsoft@@@?$vector@V?$ComPtr@UIDeviceGraphObjectsStore@@@WRL@Microsoft@@V?$allocator@V?$ComPtr@UIDeviceGraphObjectsStore@@@WRL@Microsoft@@@std@@@std@@QEAAPEAV?$ComPtr@UIDeviceGraphObjectsStore@@@WRL@Microsoft@@QEAV234@AEBV234@@Z @ 0x1800F16E8
 * Callers:
...
char *__fastcall std::vector<Microsoft::WRL::ComPtr<IDeviceGraphObjectsStore>>::_Emplace_reallocate<Microsoft::WRL::ComPtr<IDeviceGraphObjectsStore> const &>(
        char **a1,
        char *a2,
        __int64 *a3)
{
...
LABEL_15:
  ...
  while ( v4 != v15 );
LABEL_16:
  std::vector<Microsoft::WRL::ComPtr<IDeviceGraphObjectsStore>>::_Change_array(a1, v13, v8, v11, v22, v13, -2LL);
  return &(*a1)[v18];
}
