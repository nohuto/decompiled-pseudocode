/*
 * XREFs of s_SetScreenReaderState @ 0x180104D10
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall s_SetScreenReaderState(__int64 a1, unsigned int a2, unsigned int a3)
{
  ...
  __int64 v7; // r8
  void *v8; // r8
  struct _TP_TIMER **v10; // [rsp+30h] [rbp-58h] BYREF
  struct _TP_TIMER *pv[7]; // [rsp+38h] [rbp-50h] BYREF
  WINBOOL v12; // [rsp+A8h] [rbp+20h] BYREF

  v6 = 0;
  v10 = 0LL;
  if ( InitOnceBeginInitialize(&`AudioSrvTelemetryProvider::Instance'::`2'::wrapper, 0, &v12, (LPVOID *)&v10) && v12 )
  {
  ...
  CWatchdogTimer<1>::CWatchdogTimer<1>(pv, v10[1], v7, (struct _TP_TIMER *)L"s_SetScreenReaderState");
  if ( (unsigned int)IsScreenReaderStateSupported() )
    v6 = PbmSetScreenReaderState(a1, a2, a3);
