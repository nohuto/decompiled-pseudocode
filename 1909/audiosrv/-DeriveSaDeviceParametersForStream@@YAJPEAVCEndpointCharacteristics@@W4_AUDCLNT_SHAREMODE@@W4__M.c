/*
 * XREFs of ?DeriveSaDeviceParametersForStream@@YAJPEAVCEndpointCharacteristics@@W4_AUDCLNT_SHAREMODE@@W4__MIDL___MIDL_itf_audioengineendpoint_0000_0000_0001@@U_GUID@@3PEAUtWAVEFORMATEX@@4_JPEAPEAUSaDeviceParams@@@Z @ 0x1800410B0
 * Callers:
    ...
    *(_QWORD *)&v28.Data1 = 0LL;
    ...
    DeviceDefaults = (*(__int64 (__fastcall **)(_QWORD, LPVOID *))(**((_QWORD **)a1 + 2) + 40LL))(
                       *((_QWORD *)a1 + 2),
                       &pv);
    if ( DeviceDefaults >= 0 )
      DeviceDefaults = (*(__int64 (__fastcall **)(CPolicyConfig *, LPVOID, _QWORD, __int64 *, __int64 *))(*(_QWORD *)g_PolicyConfig + 56LL))(
                         g_PolicyConfig,
                         pv,
                         0LL,
                         &v25,
    ...
    if ( DeviceDefaults < 0 )
    {
      ...
      AudSrvTraceLoggingErrorHelper("GetDeviceDefaults", 5815, DeviceDefaults);
    }
  }
  if ( DeviceDefaults >= 0 )
  {
