/*
 * XREFs of _AtmosCheck::GetDefaultAudioDeviceId_::_1_::dtor$0 @ 0x18013E3A0
 * Callers:
 *     <none>
 * Callees:
 *     <none>
...
__int64 __fastcall AtmosCheck::GetDefaultAudioDeviceId_::_1_::dtor_0(__int64 a1, __int64 a2)
{
