/*
 * XREFs of dllmain_crt_process_detach @ 0x180064998
 * Callers:
 ...
 *     __scrt_dllmain_uninitialize_critical @ 0x180065000 (__scrt_dllmain_uninitialize_critical.c)
 *     __scrt_release_startup_lock @ 0x1800651EC (__scrt_release_startup_lock.c)
 *     __scrt_uninitialize_crt @ 0x180065218 (__scrt_uninitialize_crt.c)
 *     ?__scrt_uninitialize_type_info@@YAXXZ @ 0x1800657C8 (-__scrt_uninitialize_type_info@@YAXXZ.c)
