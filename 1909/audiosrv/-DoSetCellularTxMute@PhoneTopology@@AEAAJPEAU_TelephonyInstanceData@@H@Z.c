/*
 * XREFs of ?DoSetCellularTxMute@PhoneTopology@@AEAAJPEAU_TelephonyInstanceData@@H@Z @ 0x18014785C
 * Callers:
 *     ?Process@CallTxMuteWorkItem@@UEAAXPEAVPhoneTopology@@@Z @ 0x1801488A0 (-Process@CallTxMuteWorkItem@@UEAAXPEAVPhoneTopology@@@Z.c)
 * Callees:
...
LABEL_10:
  ...
  if ( *(_DWORD *)v13 > 4u )
  {
    ...
    v32 = 4;
    v33 = 0;
    TlgWrite(v13, &unk_18017C5B1, v10, v11, 5u, &pData);
  }
