/*
 * XREFs of ?IsSPDIFEndpoint@@YAHPEAUIMMDevice@@@Z @ 0x1800E5580
 * Callers:
...
__int64 __fastcall IsSPDIFEndpoint(struct IMMDevice *a1)
{
  ...
  if ( (_WORD)pvar != 19 )
  {
    v3 = -2147467259;
LABEL_5:
    AudSrvTraceLoggingErrorHelper("IsSPDIFEndpoint", 5136, v3);
    goto LABEL_6;
  }
  ...
  {
    WPP_SF_(*((_QWORD *)WPP_GLOBAL_Control + 2), 0x3Eu, (__int64)&WPP_68f7ce5d5567395ebc4ef499649768ed_Traceguids);
  }
  ...
  if ( WPP_GLOBAL_Control != (CAudioSessionManager *)&WPP_GLOBAL_Control
    ...
    && *((_BYTE *)WPP_GLOBAL_Control + 25) >= 4u )
  {
    WPP_SF_d(*((_QWORD *)WPP_GLOBAL_Control + 2), 0x3Fu, (__int64)&WPP_68f7ce5d5567395ebc4ef499649768ed_Traceguids, v5);
  }
  if ( v6 )
LABEL_20:
    v2 = 1;
