/*
 * XREFs of ?CopyTo@?$CComPtrBase@UIEndpointCollection@@@ATL@@QEAAJPEAPEAUIEndpointCollection@@@Z @ 0x180057D7C
 * Callers:
...
__int64 __fastcall ATL::CComPtrBase<IEndpointCollection>::CopyTo(_QWORD *a1, _QWORD *a2)
{
  __int64 v2; // rcx
