/*
 * XREFs of ?UpdateAudioVolume@CPerEndpointVolumeAudioSession@@EEAAJW4AudioVolumeChangeType@@_NMIPEAM_J@Z @ 0x1800D1800
 * Callers:
 *     <none>
 * Callees:
    ...
    if ( a5 )
    {
      ...
      do
      {
        if ( v19 != (CAudioSessionManager *)&WPP_GLOBAL_Control
          ...
          && *((_BYTE *)v19 + 25) >= 4u )
        {
          WPP_SF_dg(*((_QWORD *)v19 + 2), 0x7Au, (__int64)&WPP_7f1ef5860f2032d8a1536e1a5abdceb7_Traceguids, v17);
          v19 = WPP_GLOBAL_Control;
        }
        if ( v17 < v23 )
        {
