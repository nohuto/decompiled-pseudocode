/*
 * XREFs of ?ToString@CAudioEndpointId@@QEBAJAEAV?$CStringT@GV?$StrTraitATL@GV?$ChTraitsCRT@G@ATL@@@ATL@@@ATL@@@Z @ 0x180026390
 * Callers:
...
__int64 __fastcall CAudioEndpointId::ToString(const void **a1, _QWORD *a2)
{
  ...
  if ( v5 != v6 )
  {
    try
    {
      ...
      {
        ATL::CSimpleStringT<unsigned short,0>::SetString(a2, v4, *(v4 - 4));
      }
    }
    catch ( ATL::CAtlException *v13 )
    {
      ...
      v3 = *v9;
      if ( v14 < 0 )
        AudSrvTraceLoggingErrorHelper("CAudioEndpointId::ToString", 0xBCu, v14);
    }
  }
  return v3;
}
