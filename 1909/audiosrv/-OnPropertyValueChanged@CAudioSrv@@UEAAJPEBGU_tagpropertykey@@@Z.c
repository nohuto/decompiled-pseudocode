/*
 * XREFs of ?OnPropertyValueChanged@CAudioSrv@@UEAAJPEBGU_tagpropertykey@@@Z @ 0x1800292B0
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall CAudioSrv::OnPropertyValueChanged(CAudioSrv *this, unsigned __int16 *a2, struct _tagpropertykey *a3)
{
  GUID fmtid; // xmm0
