/*
 * XREFs of ?ResultFromCaughtException@wil@@YAJXZ @ 0x1800C0DBC
 * Callers:
...
__int64 __fastcall wil::ResultFromCaughtException(wil *this)
{
  ...
  {
    wil::details::in1diag3::_FailFast_Hr(retaddr, (void *)0x940, (unsigned int)"wil", (const char *)0x8007023ELL, v2);
    __debugbreak();
  }
  return result;
}
