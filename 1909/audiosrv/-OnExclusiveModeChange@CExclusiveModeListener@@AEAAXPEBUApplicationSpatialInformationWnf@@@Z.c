/*
 * XREFs of ?OnExclusiveModeChange@CExclusiveModeListener@@AEAAXPEBUApplicationSpatialInformationWnf@@@Z @ 0x180125D14
 * Callers:
 *     ?SpatialApplicationInfoUpdateCallback@CExclusiveModeListener@@CAJU_WNF_STATE_NAME@@KPEAU_WNF_TYPE_ID@@PEAXPEBXK@Z @ 0x180127030 (-SpatialApplicationInfoUpdateCallback@CExclusiveModeListener@@CAJU_WNF_STATE_NAME@@KPEAU_WNF_TYP.c)
 * Callees:
...
LABEL_8:
  ...
  else
  {
    ...
    if ( (unsigned int)dword_1801B5350 > 4 )
    {
      ...
      v17 = 4;
      v18 = 0;
      TlgWrite((TraceLoggingHProvider)&dword_1801B5350, &unk_180179B9F, v5, (LPCGUID)v6, 3u, &pData);
    }
