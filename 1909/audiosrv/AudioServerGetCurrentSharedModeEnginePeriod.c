/*
 * XREFs of AudioServerGetCurrentSharedModeEnginePeriod @ 0x1800E7360
 * Callers:
 *     <none>
 * Callees:
 ...
 *     ??1TraceLoggingThreadActivityIdSetter@@QEAA@XZ @ 0x1800CB6A8 (--1TraceLoggingThreadActivityIdSetter@@QEAA@XZ.c)
 ...
 *     std::for_each_std::_Vector_iterator_std::_Vector_val_std::_Simple_types_Microsoft::WRL::ComPtr_ISaDeviceProxy_________lambda_5e14c2903f19bc99334c762d192b5b2b___ @ 0x1800E3A18 (std--for_each_std--_Vector_iterator_std--_Vector_val_std--_Simple_types_Microsoft--WRL--ComPtr_I.c)
