/*
 * XREFs of ?ParseStreamSwitchId@CAudioSession@@SAJPEBG0AEAVCAudioSessionInstanceId@@PEAK2PEA_N@Z @ 0x1800D015C
 * Callers:
        ...
        bool *a6)
{
  ...
  if ( v8 - 24 != (char *)(v40 - 12) )
  {
    ...
    {
      ATL::CSimpleStringT<unsigned short,0>::SetString((__int64 *)&v40, v8, *((_DWORD *)v8 - 4));
    }
  }
  ...
  if ( v18 - 24 != (char *)(v38 - 12) )
  {
    ...
    {
      ATL::CSimpleStringT<unsigned short,0>::SetString((__int64 *)&v38, v18, *((_DWORD *)v18 - 4));
    }
  }
  ATL::CStringData::Release((ATL::CStringData *)(v35 - 24));
  if ( v34 == -1 )
  ...
  if ( v23 - 24 != (char *)(v37 - 12) )
  {
    ...
    {
      ATL::CSimpleStringT<unsigned short,0>::SetString((__int64 *)&v37, v23, *((_DWORD *)v23 - 4));
    }
  }
  ATL::CStringData::Release((ATL::CStringData *)(v35 - 24));
  if ( v34 == -1 )
