/*
 * XREFs of ?ReadStreamInfo@AudioJournal@@AEAAJPEAUStreamInfo@1@@Z @ 0x18004FE58
 * Callers:
...
__int64 __fastcall AudioJournal::ReadStreamInfo(AudioJournal *this, struct AudioJournal::StreamInfo *pvData)
{
  ...
  Size = 0;
  pcbData = 0;
  if ( pvData == (struct AudioJournal::StreamInfo *)&unk_1801B7D98 )
  {
    v3 = L"Render";
    v4 = 600;
  }
  else if ( pvData == (struct AudioJournal::StreamInfo *)&unk_1801B7FF0 )
  {
    v3 = L"Capture";
    v4 = 400;
  }
  ...
  {
    if ( pvData != (struct AudioJournal::StreamInfo *)&unk_1801B8180 )
    {
      v6 = -2147024809;
      v14 = 409LL;
      goto LABEL_25;
  ...
  Size = v4;
  pcbData = v4;
  ValueW = RegGetValueW(HKEY_LOCAL_MACHINE, &word_1801B8248, v3, 8u, 0LL, pvData, &pcbData);
  v6 = ValueW;
