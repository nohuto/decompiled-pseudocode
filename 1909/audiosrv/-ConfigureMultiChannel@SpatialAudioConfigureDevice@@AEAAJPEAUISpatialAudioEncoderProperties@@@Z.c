/*
 * XREFs of ?ConfigureMultiChannel@SpatialAudioConfigureDevice@@AEAAJPEAUISpatialAudioEncoderProperties@@@Z @ 0x180133608
 * Callers:
  ...
  if ( v13[0] >= 0 )
  {
    ...
    if ( v12 >= 0 )
    {
      ...
      if ( v12 < 0 && (unsigned int)dword_1801B53C0 > 2 )
      {
        ...
        v21 = 0;
        v24 = 0;
        v16 = "SpatialAudioConfigureDevice::ConfigureMultiChannel";
        v19 = v13;
        v20 = 4;
        v23 = 4;
        v17 = 51;
