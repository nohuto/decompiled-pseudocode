/*
 * XREFs of __tailMerge_ext_ms_win_session_wtsapi32_l1_1_0_dll @ 0x180066FF5
 * Callers:
 *     __imp_load_WTSQuerySessionInformationW @ 0x180066FE9 (__imp_load_WTSQuerySessionInformationW.c)
 *     __imp_load_WTSFreeMemory @ 0x1800670C8 (__imp_load_WTSFreeMemory.c)
 * Callees:
