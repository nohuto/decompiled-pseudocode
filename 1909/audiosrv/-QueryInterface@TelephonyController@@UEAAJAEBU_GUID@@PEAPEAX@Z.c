/*
 * XREFs of ?QueryInterface@TelephonyController@@UEAAJAEBU_GUID@@PEAPEAX@Z @ 0x18014AE00
 * Callers:
 *     ?QueryInterface@TelephonyController@@W7EAAJAEBU_GUID@@PEAPEAX@Z @ 0x18006D850 (-QueryInterface@TelephonyController@@W7EAAJAEBU_GUID@@PEAPEAX@Z.c)
 * Callees:
