...
unsigned __int64 __fastcall std::vector<std::unique_ptr<CAppSubmixClient>>::_Emplace_reallocate<std::unique_ptr<CAppSubmixClient>>(
        char **a1,
        char *a2,
        __int64 *a3)
{
  ...
  *(_QWORD *)&v13[v14] = v15;
  ...
  std::vector<std::unique_ptr<CAppSubmixClient>>::_Change_array(a1, v13, v8, v11, v13, -2LL);
