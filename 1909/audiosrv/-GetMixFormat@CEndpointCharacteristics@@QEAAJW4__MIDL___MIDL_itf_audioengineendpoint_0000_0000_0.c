/*
 * XREFs of ?GetMixFormat@CEndpointCharacteristics@@QEAAJW4__MIDL___MIDL_itf_audioengineendpoint_0000_0000_0001@@U_GUID@@PEAPEAUtWAVEFORMATEX@@@Z @ 0x18001B840
 * Callers:
  ...
  *a4 = 0LL;
  ...
  else
  {
    ...
    if ( v10 )
    {
      ...
      while ( 1 )
      {
        v12 = qword_1801B65F0[2 * v11] - v52;
        if ( !v12 )
          v12 = qword_1801B65F0[2 * v11 + 1] - *((_QWORD *)&v52 + 1);
        if ( !v12 )
          break;
        if ( ++v11 >= 9 )
        {
