/*
 * XREFs of ?RecalculateVolume@CAudioStream@@UEAAJ_N_J@Z @ 0x18001FE20
 * Callers:
  ...
  if ( v9 >= 0 )
  {
      ...
      if ( v14 && !v13 && ((_BYTE)v38 != 0) != (v37[0] != 0) )
      {
        ...
        else if ( *((_QWORD *)this + 8) )
        {
          ...
          if ( *(_DWORD *)v27 > 4u && TlgKeywordOn(*((TraceLoggingHProvider *)Context + 1), 0x400000000000uLL) )
          {
            ...
            p_fPending = &fPending;
            v53 = 4LL;
            TlgWrite(v27, &unk_180176EBA, v29, v30, 6u, &pData);
          }
        }
      }
    }
      ...
      && (*(_QWORD *)(v15 + 24) & 2LL) == *(_QWORD *)(v15 + 24) )
    {
      ...
      *(_QWORD *)&pDesc.Size = 1LL;
      ...
      v57 = (char *)this + 92;
      v58 = 4LL;
      TlgWrite((TraceLoggingHProvider)v15, &unk_180176E45, v34, v35, 9u, &pData);
    }
    v16 = *((_QWORD *)this + 21);
    if ( v16 )
    {
