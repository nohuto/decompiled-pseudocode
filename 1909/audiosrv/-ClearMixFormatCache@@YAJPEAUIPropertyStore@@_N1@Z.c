/*
 * XREFs of ?ClearMixFormatCache@@YAJPEAUIPropertyStore@@_N1@Z @ 0x180007CA0
 * Callers:
...
LABEL_11:
      ...
      while ( 1 )
      {
        if ( a2 )
        {
          ...
          while ( 1 )
          {
            v13 = qword_1801B65F0[2 * v12] - v41;
            if ( !v13 )
              v13 = qword_1801B65F0[2 * v12 + 1] - *((_QWORD *)&v41 + 1);
            if ( !v13 )
              break;
            if ( ++v12 >= 9 )
            {
          ...
          while ( 1 )
          {
            v16 = qword_1801B65F0[2 * v15] - v41;
            if ( !v16 )
              v16 = qword_1801B65F0[2 * v15 + 1] - *((_QWORD *)&v41 + 1);
            if ( !v16 )
              break;
            if ( ++v15 >= 9 )
              goto LABEL_30;
...
LABEL_30:
        ...
        if ( a3 )
        {
          ...
          while ( 1 )
          {
            v18 = qword_1801B65F0[2 * v17] - v41;
            if ( !v18 )
              v18 = qword_1801B65F0[2 * v17 + 1] - *((_QWORD *)&v41 + 1);
            if ( !v18 )
              break;
            if ( ++v17 >= 9 )
            {
          ...
          while ( 1 )
          {
            v21 = qword_1801B65F0[2 * v20] - v41;
            if ( !v21 )
              v21 = qword_1801B65F0[2 * v20 + 1] - *((_QWORD *)&v41 + 1);
            if ( !v21 )
              break;
            if ( ++v20 >= 9 )
              goto LABEL_49;
        ...
        if ( v10 >= 9 )
        {
          ...
          while ( 1 )
          {
            if ( a2 )
            {
              ...
              while ( 1 )
              {
                v25 = qword_1801B65F0[2 * v24] - v41;
                if ( !v25 )
                  v25 = qword_1801B65F0[2 * v24 + 1] - *((_QWORD *)&v41 + 1);
                if ( !v25 )
                  break;
                if ( ++v24 >= 9 )
                {
            ...
            if ( a3 )
            {
              ...
              while ( 1 )
              {
                v28 = qword_1801B65F0[2 * v27] - v41;
                if ( !v28 )
                  v28 = qword_1801B65F0[2 * v27 + 1] - *((_QWORD *)&v41 + 1);
                if ( !v28 )
                  break;
                if ( ++v27 >= 9 )
                {
            ...
            if ( v22 >= 9 )
            {
              ...
              while ( 1 )
              {
                if ( a2 )
                {
                  ...
                  while ( 1 )
                  {
                    v33 = qword_1801B65F0[2 * v32] - v41;
                    if ( !v33 )
                      v33 = qword_1801B65F0[2 * v32 + 1] - *((_QWORD *)&v41 + 1);
                    if ( !v33 )
                      break;
                    if ( ++v32 >= 9 )
                    {
                ...
                if ( a3 )
                {
                  ...
                  while ( 1 )
                  {
                    v36 = qword_1801B65F0[2 * v35] - v41;
                    if ( !v36 )
                      v36 = qword_1801B65F0[2 * v35 + 1] - *((_QWORD *)&v41 + 1);
                    if ( !v36 )
                      break;
                    if ( ++v35 >= 9 )
                    {
