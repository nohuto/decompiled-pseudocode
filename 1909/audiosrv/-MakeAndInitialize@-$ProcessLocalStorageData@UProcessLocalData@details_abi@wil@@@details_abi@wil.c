/*
 * XREFs of ?MakeAndInitialize@?$ProcessLocalStorageData@UProcessLocalData@details_abi@wil@@@details_abi@wil@@CAJPEBG$$QEAV?$unique_any_t@V?$mutex_t@V?$unique_storage@U?$resource_policy@PEAXP6AXPEAX@Z$1?CloseHandle@details@wil@@YAX0@ZU?$integral_constant@_K$0A@@wistd@@PEAXPEAX$0A@$$T@details@wil@@@details@wil@@Uerr_returncode_policy@3@@wil@@@3@PEAPEAV123@@Z @ 0x1800601B4
 * Callers:
 ...
 *     ?FailFastImmediate_Unexpected@in1diag3@details@wil@@YAXXZ @ 0x1800BC9E8 (-FailFastImmediate_Unexpected@in1diag3@details@wil@@YAXXZ.c)
 */
  ...
  *a3 = 0LL;
  ...
  if ( v7 )
  {
    *(_OWORD *)v18 = 0LL;
    ...
    if ( v11 < 0 )
    {
      wil::details::in1diag3::Return_Hr(retaddr, (void *)0x138, (__int64)"wil", (const char *)(unsigned int)v11);
