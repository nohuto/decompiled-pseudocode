/*
 * XREFs of ??0AudioEffectsWatcher@@QEAA@XZ @ 0x1800CB490
 * Callers:
...
AudioEffectsWatcher *__fastcall AudioEffectsWatcher::AudioEffectsWatcher(AudioEffectsWatcher *this)
{
  ...
  *(_OWORD *)((char *)this + 104) = xmmword_1801B60A0;
  *(_OWORD *)((char *)this + 120) = xmmword_1801B60B0;
  *(_OWORD *)((char *)this + 136) = xmmword_1801B60C0;
  *(_OWORD *)((char *)this + 152) = xmmword_1801B60D0;
  *(_OWORD *)((char *)this + 168) = xmmword_1801B60E0;
  *(_OWORD *)((char *)this + 184) = xmmword_1801B60F0;
  return this;
}
