/*
 * XREFs of ?CreateInstance@?$CComObject@VCVADServer@@@ATL@@SAJPEAPEAV12@@Z @ 0x180029750
 * Callers:
 ...
 *     ?SafeUnknownIncrementReference@Details@WRL@Microsoft@@YAKAECJ@Z @ 0x180067C4C (-SafeUnknownIncrementReference@Details@WRL@Microsoft@@YAKAECJ@Z.c)
...
__int64 __fastcall ATL::CComObject<CVADServer>::CreateInstance(_QWORD *a1)
{
  ...
  *a1 = 0LL;
  ...
  v5 = HeapAlloc(ProcessHeap, 0, 0x228uLL);
  try
  {
    v7 = v5;
    if ( v5 )
