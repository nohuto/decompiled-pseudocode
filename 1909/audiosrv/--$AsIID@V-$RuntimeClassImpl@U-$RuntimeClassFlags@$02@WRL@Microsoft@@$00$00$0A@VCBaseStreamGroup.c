/*
 * XREFs of ??$AsIID@V?$RuntimeClassImpl@U?$RuntimeClassFlags@$02@WRL@Microsoft@@$00$00$0A@VCBaseStreamGroupProxy@@UIInspectable@@@Details@WRL@Microsoft@@@?$RuntimeClassBaseT@$02@Details@WRL@Microsoft@@KAJPEAV?$RuntimeClassImpl@U?$RuntimeClassFlags@$02@WRL@Microsoft@@$00$00$0A@VCBaseStreamGroupProxy@@UIInspectable@@@123@AEBU_GUID@@PEAPEAX@Z @ 0x1800EC734
 * Callers:
        ...
        _QWORD *a3)
{
  ...
  *a3 = 0LL;
    ...
    && !InlineIsEqualGUID(v3, &GUID_af86e2e0_b12d_4c6a_9c5a_d7aa65101e90) )
  {
    ...
    {
      if ( InlineIsEqualGUID(v8, &GUID_1ca5414f_db68_41cf_b04d_27cfcf56d352) )
      {
        *v9 = v12;
        CanCastTo = 0;
      }
