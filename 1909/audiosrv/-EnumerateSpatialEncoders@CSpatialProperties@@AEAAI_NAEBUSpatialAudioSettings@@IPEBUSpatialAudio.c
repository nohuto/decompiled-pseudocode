      ...
      while ( 1 )
      {
        ...
        if ( v38 == 2 )
        {
          if ( WORD1(v95.Ptr) == 2 )
          {
            ...
            {
              TlgWrite((TraceLoggingHProvider)&hProvider, &unk_18017B953, v37, 0LL, 2u, &Buf2);
              goto LABEL_116;
            }
            goto LABEL_117;
          }
...
LABEL_113:
          if ( (unsigned int)hProvider > 2 )
          {
            ...
            TlgWrite((TraceLoggingHProvider)&hProvider, &unk_18017B87E, v69, v70, 7u, &Buf1);
            v46 = v72;
          }
...
LABEL_117:
        ...
        if ( (unsigned int)hProvider > 4 )
        {
          ...
          v108 = &v81;
          v109 = 4LL;
          TlgWrite((TraceLoggingHProvider)&hProvider, &unk_18017B8DE, v51, v52, 8u, &Buf1);
          v46 = v72;
        }
        if ( !v74 || a7 )
          goto LABEL_91;
