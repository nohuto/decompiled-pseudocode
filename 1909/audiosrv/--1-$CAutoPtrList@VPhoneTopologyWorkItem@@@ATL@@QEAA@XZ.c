/*
 * XREFs of ??1?$CAutoPtrList@VPhoneTopologyWorkItem@@@ATL@@QEAA@XZ @ 0x180147098
 * Callers:
 *     _PhoneTopology::PhoneTopology_::_1_::dtor$3 @ 0x180072044 (_PhoneTopology--PhoneTopology_--_1_--dtor$3.c)
 * Callees:
 *     <none>
 */
