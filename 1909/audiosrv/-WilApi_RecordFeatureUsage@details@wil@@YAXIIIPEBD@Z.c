/*
 * XREFs of ?WilApi_RecordFeatureUsage@details@wil@@YAXIIIPEBD@Z @ 0x18006422C
 * Callers:
 ...
 *     ?RecordSRUMFeatureUsage@details@wil@@YAXIII@Z @ 0x1800C09D0 (-RecordSRUMFeatureUsage@details@wil@@YAXIII@Z.c)
 * Callees:
