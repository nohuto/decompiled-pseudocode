/*
 * XREFs of ?LogUnsubscribe@CSpatialAudioResourceManagerTraceLogger@@QEAAXK_NI@Z @ 0x1801232E0
 * Callers:
        ...
        const GUID *a4)
{
  ...
  if ( (unsigned int)dword_1801B5350 > 5 )
  {
    ...
    v10 = 4LL;
    v12 = 4LL;
    TlgWrite((TraceLoggingHProvider)&dword_1801B5350, &unk_180179520, a3, a4, 5u, &pData);
  }
}
