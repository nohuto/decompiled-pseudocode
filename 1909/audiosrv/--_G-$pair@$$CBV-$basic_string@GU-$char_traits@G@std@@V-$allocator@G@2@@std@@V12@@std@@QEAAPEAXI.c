/*
 * XREFs of ??_G?$pair@$$CBV?$basic_string@GU?$char_traits@G@std@@V?$allocator@G@2@@std@@V12@@std@@QEAAPEAXI@Z @ 0x18013D998
 * Callers:
 ...
 *     ??1?$list@U?$pair@$$CBV?$basic_string@GU?$char_traits@G@std@@V?$allocator@G@2@@std@@V12@@std@@V?$allocator@U?$pair@$$CBV?$basic_string@GU?$char_traits@G@std@@V?$allocator@G@2@@std@@V12@@std@@@2@@std@@QEAA@XZ @ 0x18013D4B4 (--1-$list@U-$pair@$$CBV-$basic_string@GU-$char_traits@G@std@@V-$allocator@G@2@@std@@V12@@std@@V-.c)
...
__int64 __fastcall std::pair<std::wstring const,std::wstring>::`scalar deleting destructor'(__int64 a1)
{
  ...
  __int64 result; // rax
  struct std::nothrow_t *v9; // [rsp+30h] [rbp+10h] BYREF
  ...
  if ( v1 >= 8 )
  {
    ...
    {
      std::_Adjust_manually_vector_aligned(&v10, (unsigned __int64 *)&v9);
      v4 = v9;
      v3 = v10;
    }
