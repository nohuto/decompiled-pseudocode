/*
 * XREFs of ?UpdateLicenseRefreshTimer@AtmosCheck@@AEAAXXZ @ 0x18005A4C4
 * Callers:
 ...
 *     ?GetNearestLicenseExpiryDate@AtmosCheck@@AEAA_KXZ @ 0x18013ECF8 (-GetNearestLicenseExpiryDate@AtmosCheck@@AEAA_KXZ.c)
    ...
    *((_QWORD *)pv + 25) = ThreadpoolTimer;
    ...
    else
    {
      ...
      if ( (unsigned int)dword_1801B54F0 > 5 )
      {
        ...
        v11 = &v8;
        v12 = 4;
        TlgWrite((TraceLoggingHProvider)&dword_1801B54F0, &unk_18017C331, v6, v7, 3u, &pData);
      }
    }
  }
}
