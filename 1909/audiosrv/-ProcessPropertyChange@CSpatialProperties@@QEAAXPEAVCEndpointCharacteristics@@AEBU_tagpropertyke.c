/*
 * XREFs of ?ProcessPropertyChange@CSpatialProperties@@QEAAXPEAVCEndpointCharacteristics@@AEBU_tagpropertykey@@PEAUIPropertyStore@@PEAUSpatialAudioRelatedGlobalSettings@@PEBUtWAVEFORMATEX@@V?$function@$$A6A_NPEBUWAVEFORMATEXTENSIBLE@@@Z@std@@PEAH@Z @ 0x18000B570
 * Callers:
    ...
    if ( v11 || *(_DWORD *)(a3 + 16) != *(_DWORD *)(a1 + 100) )
    {
        ...
        && (int)ValidateWaveFormatEx((const struct tWAVEFORMATEX *)pvar.bstrblobVal.pData) >= 0 )
      {
        ...
        if ( (unsigned int)hProvider > 4 )
        {
          ...
          v90 = 16LL;
          TlgWrite((TraceLoggingHProvider)&hProvider, &unk_18017AD37, v55, v56, 9u, &pData);
        }
      }
        ...
        && (*(int (__fastcall **)(_QWORD, GUID *))(**(_QWORD **)(a1 + 56) + 48LL))(*(_QWORD *)(a1 + 56), &v71) >= 0 )
      {
        ...
        if ( v13 )
        {
          if ( (unsigned int)hProvider > 4 )
          {
            ...
            v75 = (LPVOID *)&v58;
            v76 = 2LL;
            TlgWrite((TraceLoggingHProvider)&hProvider, &unk_18017B14B, v52, v53, 4u, &v72);
            v13 = *(_DWORD *)(a1 + 6872);
          }
          if ( v13 == 1 )
            *(_DWORD *)(a1 + 6872) = 2;
          ...
          *(_BYTE *)(a1 + 76) = *a5 != 0;
          ...
          if ( *(_DWORD *)(a1 + 6876) == 1 )
          {
              ...
              if ( !v70.Format.wFormatTag )
              {
                ...
                *(_DWORD *)(a1 + 6876) = v29 + 3;
                if ( (unsigned int)hProvider > 4 )
                {
                  ...
                  v90 = 2LL;
                  TlgWrite((TraceLoggingHProvider)&hProvider, &unk_18017B1DB, v30, v31, 9u, &pData);
                }
            ...
            else
            {
              ...
              {
                TlgCreateWsz(&v74, v9[3]);
                TlgWrite((TraceLoggingHProvider)&hProvider, &unk_18017B19D, v32, v33, 3u, &v72);
              }
              *(_DWORD *)(a1 + 6876) = 2;
          ...
          if ( v70.Format.wFormatTag )
          {
            ...
            if ( !v36 && v60 )
            {
              ...
              if ( (unsigned int)hProvider > 2 )
              {
                ...
                v102 = 16LL;
                TlgWrite((TraceLoggingHProvider)&hProvider, &unk_18017AFA1, v37, v38, 0xFu, &pData);
              }
...
LABEL_46:
            ...
            *v65 = v19;
            ...
            {
              TlgCreateWsz(&v74, v9[3]);
              TlgWrite((TraceLoggingHProvider)&hProvider, &unk_18017AF75, v41, v42, 3u, &v72);
            }
                    ...
                    if ( (unsigned __int8)IsSpatialOnlyFormat(p_wFormatTag + 12, v21) )
                    {
                      ...
                      if ( v43 >= 0 )
                      {
                        ...
                        if ( (unsigned int)hProvider > 4 )
                        {
                          ...
                          p_Type = (char *)&v72.Size + 2;
                          v90 = 2LL;
                          TlgWrite((TraceLoggingHProvider)&hProvider, &unk_18017B0D8, v45, v46, 9u, &pData);
                        }
                        CEndpointCharacteristics::SetDeviceFormatAndSpatialSettings(
                          (CEndpointCharacteristics *)v9,
                          eHostProcessConnector,
          ...
          while ( 1 )
          {
            ...
            if ( v24 == 3 && (unsigned int)hProvider > 2 )
            {
              ...
              v75 = &pv;
              v76 = 2LL;
              TlgWrite((TraceLoggingHProvider)&hProvider, &unk_18017B085, v47, v48, 4u, &v72);
            }
            EnterCriticalSection((LPCRITICAL_SECTION)a1);
            v25 = *(_DWORD *)(a1 + 6872);
            if ( v25 <= 1 )
            ...
            if ( (unsigned int)hProvider > 4 )
            {
              ...
              p_Ptr_high = &v58;
              v82 = 2LL;
              TlgWrite((TraceLoggingHProvider)&hProvider, &unk_18017ADBA, v49, v50, 5u, &pData);
              v25 = *(_DWORD *)(a1 + 6872);
            }
            if ( v25 != 3 )
              break;
