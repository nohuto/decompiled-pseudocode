/*
 * XREFs of ?IsStreamFormatSupportedForMixFormat@@YAJPEAVCEndpointCharacteristics@@U_GUID@@W4__MIDL___MIDL_itf_audioengineendpoint_0000_0000_0001@@PEBUtWAVEFORMATEX@@3PEAPEAU4@@Z @ 0x18001BC50
 * Callers:
    ...
    if ( !v80 )
    {
      ...
      if ( *((int *)v148 + 10) > 0 )
      {
        ...
        while ( 1 )
        {
          ...
          {
            RaiseException(0xC000008C, 1u, 0, 0LL);
            JUMPOUT(0x180082848LL);
          }
          if ( *(_BYTE *)(*(_QWORD *)(v14 + *((_QWORD *)v148 + 4)) + 20LL) )
          {
            v137 = (__int64 **)ATL::CSimpleArray<_GUID,ATL::CSimpleArrayEqualHelper<_GUID>>::operator[](
                                 (__int64)v148 + 32,
                                 v81);
...
LABEL_369:
  ...
  if ( (unsigned int)ATL::CSimpleArray<_GUID,ATL::CSimpleArrayEqualHelper<_GUID>>::Find((__int64 *)v148, &v204) == -1 )
    goto LABEL_226;
LABEL_188:
  v161 = 0LL;
  v149 = 0LL;
  ...
  while ( 1 )
  {
    ...
    if ( !*(_BYTE *)(*(_QWORD *)(v14 + *((_QWORD *)v148 + 4)) + 20LL) )
      goto LABEL_194;
LABEL_383:
    v140 = (__int64 **)ATL::CSimpleArray<_GUID,ATL::CSimpleArrayEqualHelper<_GUID>>::operator[]((__int64)v148 + 32, v83);
