/*
 * XREFs of ?NotifyClientOfGrant@CStreamResource@Sarm@@AEAAJI_J@Z @ 0x1801244D0
 * Callers:
...
__int64 __fastcall Sarm::CStreamResource::NotifyClientOfGrant(Sarm::CStreamResource *this, unsigned int a2, __int64 a3)
{
  ...
  if ( v5 >= 0 )
  {
    ...
    {
      if ( TlgKeywordOn((TraceLoggingHProvider)&dword_1801B5350, 0x400000000000uLL) )
      {
        v17 = 8LL;
        v16 = (char *)this + 40;
        v18 = (char *)this + 16;
        ...
        v23 = 8LL;
        v25 = v11;
        TlgWrite(v8, &unk_1801799B8, v9, v10, 7u, &pData);
      }
    }
    return 0LL;
  }
