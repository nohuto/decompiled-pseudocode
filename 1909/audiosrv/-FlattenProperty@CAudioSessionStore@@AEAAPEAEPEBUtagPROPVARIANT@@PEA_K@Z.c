/*
 * XREFs of ?FlattenProperty@CAudioSessionStore@@AEAAPEAEPEBUtagPROPVARIANT@@PEA_K@Z @ 0x1800DE800
 * Callers:
 *     ?Commit@CAudioSessionStore@@UEAAJXZ @ 0x18003DD00 (-Commit@CAudioSessionStore@@UEAAJXZ.c)
 * Callees:
 *     ??3@YAXPEAX@Z @ 0x18001CC20 (--3@YAXPEAX@Z.c)
 *     ?StringCchCopyA@@YAJPEAD_KPEBD@Z @ 0x180046790 (-StringCchCopyA@@YAJPEAD_KPEBD@Z.c)
 ...
 *     ?IsValidProperty@CAudioSessionStore@@AEAA_NPEBUtagPROPVARIANT@@@Z @ 0x1800DFAD8 (-IsValidProperty@CAudioSessionStore@@AEAA_NPEBUtagPROPVARIANT@@@Z.c)
 *     ?StringCbLengthA@@YAJPEBD_KPEA_K@Z @ 0x1800E0FBC (-StringCbLengthA@@YAJPEBD_KPEA_K@Z.c)
 *     ?StringCbLengthW@@YAJPEBG_KPEA_K@Z @ 0x1800E1014 (-StringCbLengthW@@YAJPEBG_KPEA_K@Z.c)
 *     WPP_SF_dP @ 0x1800E390C (WPP_SF_dP.c)
 */
