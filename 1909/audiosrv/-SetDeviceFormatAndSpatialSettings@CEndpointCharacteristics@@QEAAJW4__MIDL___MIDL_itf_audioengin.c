/*
 * XREFs of ?SetDeviceFormatAndSpatialSettings@CEndpointCharacteristics@@QEAAJW4__MIDL___MIDL_itf_audioengineendpoint_0000_0000_0001@@PEBUtWAVEFORMATEX@@PEBUSpatialAudioSettings@@@Z @ 0x180004A8C
 * Callers:
    ...
    if ( a4 )
    {
      ...
      if ( (unsigned int)hProvider > 4 )
      {
        ...
        *(_QWORD *)&v45.Size = 1LL;
        ...
        v58 = 16LL;
        TlgWrite((TraceLoggingHProvider)&hProvider, &unk_180178ED0, v9, v10, 0xBu, &pData);
      }
    }
    else
    {
      ...
      if ( (unsigned int)hProvider > 4 )
      {
        ...
        *(_QWORD *)&v50.Size = 4LL;
        ...
        v52 = 16LL;
        TlgWrite((TraceLoggingHProvider)&hProvider, &unk_180178E54, v11, v12, 8u, &pData);
      }
    }
  }
  else if ( a4 )
  {
    if ( (unsigned int)hProvider > 4 )
    {
      ...
      *(_QWORD *)&v45.Size = 1LL;
      ...
      p_Data2 = (DWORD *)&Data2;
      v49 = 2LL;
      TlgWrite((TraceLoggingHProvider)&hProvider, &unk_180178DF1, v14, v13, 6u, &pData);
    }
  }
  else if ( (unsigned int)hProvider > 4 )
  {
    TlgCreateWsz(&pDesc, *((LPCWSTR *)this + 3));
    TlgWrite((TraceLoggingHProvider)&hProvider, &unk_180178DB0, v15, v16, 3u, &pData);
  }
...
LABEL_41:
    ...
    if ( v4 )
    {
      ...
      AudioFormatForSpatialFormat = CEndpointCharacteristics::SetSpatialAudioSettings((LPCWSTR *)this, v4, &v5->Format);
      DeviceFormatAndSpatialSettings = AudioFormatForSpatialFormat;
      if ( AudioFormatForSpatialFormat < 0 )
      {
        v22 = 8701LL;
