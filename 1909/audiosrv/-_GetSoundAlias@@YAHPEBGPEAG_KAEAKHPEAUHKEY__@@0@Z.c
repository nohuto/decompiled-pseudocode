/*
 * XREFs of ?_GetSoundAlias@@YAHPEBGPEAG_KAEAKHPEAUHKEY__@@0@Z @ 0x18004D310
 * Callers:
        ...
        unsigned __int16 *a7)
{
  ...
  if ( a1 && a2 && hkey )
  {
    ...
    if ( !(unsigned int)StringCchLengthW(v12, 0x28uLL, (unsigned __int64 *)&phkResult)
      ...
      && ((*a4 & 0x400000) == 0 || (Registry = sndQueryRegistry(v13, aszExplorer, v12, a2, pdwType, a4, hkey)) == 0) )
    {
      ...
      if ( !Registry )
      {
        ...
        {
          Registry = RegGetValueW(phkResult, 0LL, PSZ_SOUNDS_SOUND, 2u, 0LL, a2, &pcbData) == 0;
