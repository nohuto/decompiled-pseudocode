/*
 * XREFs of ?LogStreamIdentifierExpired@CSpatialAudioResourceManagerTraceLogger@@QEAAXI_J@Z @ 0x180122F78
 * Callers:
        ...
        const GUID *a4)
{
  ...
  if ( (unsigned int)dword_1801B5350 > 4 )
  {
    ...
    v10 = 0;
    v9 = 8;
    TlgWrite((TraceLoggingHProvider)&dword_1801B5350, &unk_1801794E9, a3, a4, 4u, &v4);
  }
}
