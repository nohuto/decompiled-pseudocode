/*
 * XREFs of ?SendSpatialResourceChangeNotification@CAudioStream@@UEAAJK_JI@Z @ 0x1800DA9B0
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall CAudioStream::SendSpatialResourceChangeNotification(CAudioStream *this, int a2, __int64 a3, int a4)
{
  ...
  if ( *(_DWORD *)v7 > 4u )
  {
    ...
    v38 = &v26;
    v39 = 4;
    TlgWrite(v7, &unk_180176D94, v10, v11, 6u, &pData);
  }
  v12 = *((_QWORD *)this + 7);
  if ( !v12 )
    return 0LL;
  ...
  if ( v16 )
  {
    ...
    *((_DWORD *)v16 + 16) = v43;
    *((_DWORD *)v16 + 17) = a2;
    MediaEvent = StringCbCopyW(v16 + 72, v14, *(char **)(*((_QWORD *)this + 7) + 728LL));
    v18 = MediaEvent;
    if ( MediaEvent < 0 )
    {
      v19 = 1802LL;
