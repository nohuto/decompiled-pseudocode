/*
 * XREFs of ??1AudioDeviceMgr@@MEAA@XZ @ 0x180145598
 * Callers:
 *     ??_EAudioDeviceMgr@@MEAAPEAXI@Z @ 0x180145680 (--_EAudioDeviceMgr@@MEAAPEAXI@Z.c)
 * Callees:
 *     _guard_dispatch_icall_nop @ 0x18006C990 (_guard_dispatch_icall_nop.c)
 *     ?RemoveAll@?$CAtlList@V?$CAutoPtr@VWorkItemBase@@@ATL@@V?$CAutoPtrElementTraits@VWorkItemBase@@@2@@ATL@@QEAAXXZ @ 0x18014624C (-RemoveAll@-$CAtlList@V-$CAutoPtr@VWorkItemBase@@@ATL@@V-$CAutoPtrElementTraits@VWorkItemBase@@@.c)
