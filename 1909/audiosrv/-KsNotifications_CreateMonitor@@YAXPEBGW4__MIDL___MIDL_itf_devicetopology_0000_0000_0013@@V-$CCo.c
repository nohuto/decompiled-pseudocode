/*
 * XREFs of ?KsNotifications_CreateMonitor@@YAXPEBGW4__MIDL___MIDL_itf_devicetopology_0000_0000_0013@@V?$CComPtr@UIConnector@@@ATL@@V?$CComPtr@UIDeviceTopology@@@3@@Z @ 0x180054E84
 * Callers:
 ...
 *     ?AddTail@?$TList@VCKsNotificationsMonitor@@@@QEAAPEAXPEAVCKsNotificationsMonitor@@@Z @ 0x180054E00 (-AddTail@-$TList@VCKsNotificationsMonitor@@@@QEAAPEAXPEAVCKsNotificationsMonitor@@@Z.c)
    ...
    if ( v10 )
    {
      ...
      if ( ((int (__fastcall *)(struct IPart *, __int64, GUID *, _QWORD *))v12->lpVtbl->Activate)(
        ...
        || (result = (void **)(*(__int64 (__fastcall **)(_QWORD, void *, __int64))(*(_QWORD *)v13[0] + 24LL))(
            ...
            (int)result >= 0) )
      {
        if ( (int)CKsNotificationsMonitor::Initialize(v10, (struct IUnknown *)v12, a1) >= 0 )
        {
          lpCriticalSection = &g_csKsNotificationMonitors;
          v15 = 0;
          ATL::CCritSecLock::Lock(&lpCriticalSection);
          if ( TList<CKsNotificationsMonitor>::AddTail(v11, (__int64)v10) )
