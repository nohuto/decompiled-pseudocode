/*
 * XREFs of ?ToPersistedString@CAudioSessionInstanceId@@QEBAJAEAV?$CStringT@GV?$StrTraitATL@GV?$ChTraitsCRT@G@ATL@@@ATL@@@ATL@@H@Z @ 0x18002F6DC
 * Callers:
...
__int64 __fastcall CAudioSessionInstanceId::ToPersistedString(__int64 *a1, wchar_t **a2, int a3)
{
  ...
  if ( a3 )
    ...
    v6 = CAudioEndpointId::ToString((const void **)a1, &Str);
  v7 = v6;
  if ( v6 < 0 )
    goto LABEL_161;
  v7 = CAppAudioSessionId::ToString((__int64)(a1 + 1), &v81);
  v84 = v7;
  if ( v7 < 0 )
  {
    v5 = v81;
