/*
 * XREFs of ?GetVpoContext@CProcessSubmixProxy@@UEAAJPEAPEAUIVpoContext@@@Z @ 0x1800EF3C0
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall CProcessSubmixProxy::GetVpoContext(CProcessSubmixProxy *this, struct IVpoContext **a2)
{
  ...
  if ( v4 >= 0 )
  {
    v6 = *((_QWORD *)this + 24);
    v12[0] = 0LL;
    v7 = (*(__int64 (__fastcall **)(__int64, __int64 *))(*(_QWORD *)v6 + 200LL))(v6, v12);
    v5 = v7;
    if ( v7 < 0 )
    {
...
LABEL_12:
    ...
    v15 = 0LL;
    v8 = (*(__int64 (__fastcall **)(__int64, __int64 *))(*(_QWORD *)v12[0] + 56LL))(v12[0], &v15);
    v5 = v8;
    if ( v8 >= 0 )
    {
      v8 = (*(__int64 (__fastcall **)(LPVOID, _QWORD, __int64))(*(_QWORD *)ppv + 24LL))(ppv, *((_QWORD *)this + 5), v15);
      v5 = v8;
      if ( v8 >= 0 )
      {
