/*
 * XREFs of ??$CompareTo@UResourceHandleInfo@@@ExclusiveEndpointInfo@@QEBA_NAEBUResourceHandleInfo@@@Z @ 0x1800FEDB4
 * Callers:
 ...
 * Callees:
 *     ?SimpleWildcardStringCompare@@YAHQEBG_K01@Z @ 0x180101CCC (-SimpleWildcardStringCompare@@YAHQEBG_K01@Z.c)
 */
