/*
 * XREFs of ?ProcessAwayModeStateChange@CAudioSrv@@AEAAKE@Z @ 0x1800BF4C0
 * Callers:
...
__int64 __fastcall CAudioSrv::ProcessAwayModeStateChange(CAudioSrv *this, unsigned __int8 a2)
{
      ...
      for ( i = 0; i < v20; ++i )
      {
        ...
        if ( (*(int (__fastcall **)(_QWORD, _QWORD, __int64 *))(*(_QWORD *)v16[0] + 32LL))(v16[0], i, &v22) >= 0 )
        {
          ...
          else
          {
            ...
            {
              WPP_SF_S(*((_QWORD *)WPP_GLOBAL_Control + 2), 34LL, &WPP_caac46b4f1e3331f0b6e69ee555f6535_Traceguids, pv);
            }
            CoTaskMemFree(pv);
              ...
              else if ( (*(int (__fastcall **)(__int64, unsigned int *))(*(_QWORD *)v14 + 152LL))(v14, &v21) >= 0 )
              {
                ...
                if ( a2 )
                {
                  ...
                  v11 = (*(__int64 (__fastcall **)(__int64, void *, PROPVARIANT *))(*(_QWORD *)v23 + 48LL))(
                          ...
                          &pvar);
                  if ( v11 < 0 )
                    AudSrvTraceLoggingErrorHelper("CAudioSrv::ProcessAwayModeStateChange", 1367, v11);
                }
                else
                {
                ...
                if ( v21 != v9 )
                {
                  v12 = (*(__int64 (__fastcall **)(__int64, _QWORD, void *, _QWORD))(*(_QWORD *)v14 + 144LL))(
                          ...
                          0LL);
                  if ( v12 < 0 )
                    AudSrvTraceLoggingErrorHelper("CAudioSrv::ProcessAwayModeStateChange", 1390, v12);
                }
              }
            }
          }
  ...
  if ( WPP_GLOBAL_Control != (CAudioSessionManager *)&WPP_GLOBAL_Control
    ...
    && *((_BYTE *)WPP_GLOBAL_Control + 25) >= 4u )
  {
    WPP_SF_d(*((_QWORD *)WPP_GLOBAL_Control + 2), 33LL, &WPP_caac46b4f1e3331f0b6e69ee555f6535_Traceguids, v6);
LABEL_48:
    v4 = v16[0];
  }
LABEL_49:
