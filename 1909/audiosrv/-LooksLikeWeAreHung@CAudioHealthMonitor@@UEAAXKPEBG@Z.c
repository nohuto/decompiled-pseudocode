/*
 * XREFs of ?LooksLikeWeAreHung@CAudioHealthMonitor@@UEAAXKPEBG@Z @ 0x1800BD550
 * Callers:
 *     <none>
 * Callees:
    ...
    *((_DWORD *)this + 2) = v7;
    if ( v7 >= *((_DWORD *)this + 3) && *((_DWORD *)this + 4) == 16 && !*((_DWORD *)this + 16) )
    {
      ...
      if ( **((_DWORD **)Context + 1) > 4u && TlgKeywordOn(*((TraceLoggingHProvider *)Context + 1), 0x400000000001uLL) )
      {
        ...
        v32 = (char *)this + 12;
        v33 = 4LL;
        TlgWrite(v10, &unk_180176634, v9, (LPCGUID)v10, 6u, &pData);
      }
      *((_DWORD *)this + 16) = 1;
      ...
      if ( *(_DWORD *)v12 > 4u && TlgKeywordOn(v12, 1uLL) )
      {
        ...
        *(_QWORD *)&pDesc.Size = 4LL;
        TlgWrite(v13, &unk_180176610, v14, v15, 3u, &pData);
      }
      if ( v19 >= 0 )
        Sleep(0xEA60u);
