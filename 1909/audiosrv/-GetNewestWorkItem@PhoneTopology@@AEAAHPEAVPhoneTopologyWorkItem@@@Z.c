/*
 * XREFs of ?GetNewestWorkItem@PhoneTopology@@AEAAHPEAVPhoneTopologyWorkItem@@@Z @ 0x18014847C
 * Callers:
 ...
 *     ??4PhoneTopologyWorkItem@@QEAAAEBV0@AEBV0@@Z @ 0x1801470A4 (--4PhoneTopologyWorkItem@@QEAAAEBV0@AEBV0@@Z.c)
 */
