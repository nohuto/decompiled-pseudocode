/*
 * XREFs of ?ProviderFinalRelease@CVolumeStrip@@UEAAXXZ @ 0x1800C99C0
 * Callers:
 *     <none>
 * Callees:
...
void __fastcall CVolumeStrip::ProviderFinalRelease(unsigned __int64 this)
{
  ...
  {
    WPP_SF_(*((_QWORD *)WPP_GLOBAL_Control + 2), 0xAu, (__int64)&WPP_1af60ca396c231183a59f5c311004dee_Traceguids);
  }
  v2 = *(_QWORD *)(this + 240);
  if ( v2 )
