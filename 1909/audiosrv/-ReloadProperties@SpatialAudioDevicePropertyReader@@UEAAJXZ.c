/*
 * XREFs of ?ReloadProperties@SpatialAudioDevicePropertyReader@@UEAAJXZ @ 0x180020200
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall SpatialAudioDevicePropertyReader::ReloadProperties(SpatialAudioDevicePropertyReader *this)
{
  ...
  *((_QWORD *)this + 63) = 0LL;
  ...
  if ( v31 < 0 )
  {
    if ( (unsigned int)dword_1801B53C0 > 2 )
    {
      ...
      v37 = 4LL;
      v39 = 4LL;
      TlgWrite((TraceLoggingHProvider)&dword_1801B53C0, &unk_18017BC7B, v6, v7, 5u, &pData);
    }
  }
  else
  {
    ...
    else
    {
      ...
      if ( DeviceSettings < 0 && (unsigned int)dword_1801B53C0 > 2 )
      {
        v34 = "SpatialAudioDevicePropertyReader::ReloadProperties";
        v36 = &v31;
        p_DeviceSettings = &DeviceSettings;
        ...
        v37 = 4LL;
        v39 = 4LL;
        TlgWrite((TraceLoggingHProvider)&dword_1801B53C0, &unk_18017BC7B, v10, v11, 5u, &pData);
      }
    }
  }
  if ( v32 )
  {
    ...
    *(_OWORD *)((char *)this + 134) = xmmword_180170810;
    *((_WORD *)this + 66) = 0;
    *(_OWORD *)((char *)this + 150) = xmmword_180170820;
    *(_OWORD *)((char *)this + 166) = xmmword_180170830;
    *(_OWORD *)((char *)this + 182) = xmmword_180170840;
    *(_OWORD *)((char *)this + 198) = xmmword_180170850;
    *(_OWORD *)((char *)this + 214) = xmmword_180170860;
    *(_OWORD *)((char *)this + 230) = xmmword_180170870;
  ...
  *((_QWORD *)this + 7) = v23;
  ...
  DeviceSettings = v21;
  if ( v21 < 0 && (unsigned int)dword_1801B53C0 > 2 )
  {
    v34 = "SpatialAudioDevicePropertyReader::ReloadProperties";
    v36 = &v31;
    p_DeviceSettings = &DeviceSettings;
