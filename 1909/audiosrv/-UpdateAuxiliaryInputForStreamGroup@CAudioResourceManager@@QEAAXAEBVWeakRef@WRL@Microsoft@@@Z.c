/*
 * XREFs of ?UpdateAuxiliaryInputForStreamGroup@CAudioResourceManager@@QEAAXAEBVWeakRef@WRL@Microsoft@@@Z @ 0x1800F9654
 * Callers:
 *     ?UpdateAuxiliaryInputForStreamGroup@@YAXAEBVWeakRef@WRL@Microsoft@@@Z @ 0x1800F9634 (-UpdateAuxiliaryInputForStreamGroup@@YAXAEBVWeakRef@WRL@Microsoft@@@Z.c)
 * Callees:
  ...
  if ( (int)Microsoft::WRL::WeakRef::As<IInspectable>(a2, &v17) >= 0 && v17 )
  {
    ...
    if ( (int)Microsoft::WRL::ComPtr<IInspectable>::As<IStreamGroupProxy>(&v17, &v14) >= 0 )
    {
      ...
      if ( **(_DWORD **)&lpCriticalSection->LockCount > 4u )
      {
        ...
        v22 = &v15;
        v23 = cData;
        TlgWrite(v11, &unk_18017817A, v10, (LPCGUID)v11, cData, &pData);
      }
      v12 = v19[0];
      if ( v19[0] )
      {
