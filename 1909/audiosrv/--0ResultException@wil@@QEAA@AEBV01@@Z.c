/*
 * XREFs of ??0ResultException@wil@@QEAA@AEBV01@@Z @ 0x1800BB460
 * Callers:
 *     <none>
 * Callees:
 *     _o___std_exception_copy_0 @ 0x180065C1E (_o___std_exception_copy_0.c)
 *     ?assign@shared_buffer@details@wil@@AEAAXPEAJ_K@Z @ 0x1800BCA28 (-assign@shared_buffer@details@wil@@AEAAXPEAJ_K@Z.c)
 */
