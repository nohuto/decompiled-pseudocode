/*
 * XREFs of ??1?$out_param_t@V?$com_ptr_t@UIProcessSubmixProxy@@Uerr_returncode_policy@wil@@@wil@@@details@wil@@QEAA@XZ @ 0x1800F521C
 * Callers:
 *     _BuildDeviceGraphForStream_::_1_::dtor$7 @ 0x1800737A0 (_BuildDeviceGraphForStream_--_1_--dtor$7.c)
 * Callees:
