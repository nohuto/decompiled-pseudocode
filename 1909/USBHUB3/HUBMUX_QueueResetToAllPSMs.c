/*
 * XREFs of HUBMUX_QueueResetToAllPSMs @ 0x1C000EE6C
 * Callers:
 *     HUBHSM_NotifyingHubResetToPortsOnResetOnResume @ 0x1C0008230 (HUBHSM_NotifyingHubResetToPortsOnResetOnResume.c)
 * Callees:
