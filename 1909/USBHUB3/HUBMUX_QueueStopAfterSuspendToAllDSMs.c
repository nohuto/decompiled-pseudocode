/*
 * XREFs of HUBMUX_QueueStopAfterSuspendToAllDSMs @ 0x1C000F42C
 * Callers:
 *     HUBHSM_NotifyingHubStopToDevicesOnSuspriseRemove @ 0x1C0008380 (HUBHSM_NotifyingHubStopToDevicesOnSuspriseRemove.c)
 * Callees:
