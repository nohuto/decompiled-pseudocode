/*
 * XREFs of HUBMISC_ValidateAndCacheMSOSExtendedPropertyDescriptor @ 0x1C002E63C
 * Callers:
 *     HUBDSM_ValidatingMSOSExtendedPropertyDescriptor @ 0x1C00211D0 (HUBDSM_ValidatingMSOSExtendedPropertyDescriptor.c)
 * Callees:
...
LABEL_29:
  ...
  WPP_RECORDER_SF_(*(_QWORD *)(v6 + 1432), 2u, 5u, v7, (__int64)&WPP_699d44e6015a36edc2e41426686ae77e_Traceguids);
LABEL_31:
