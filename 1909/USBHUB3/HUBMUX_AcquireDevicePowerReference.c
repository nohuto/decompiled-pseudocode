/*
 * XREFs of HUBMUX_AcquireDevicePowerReference @ 0x1C000FA24
 * Callers:
 *     HUBDSM_AcquiringPowerReferenceOnHubResume @ 0x1C001BB70 (HUBDSM_AcquiringPowerReferenceOnHubResume.c)
 * Callees:
