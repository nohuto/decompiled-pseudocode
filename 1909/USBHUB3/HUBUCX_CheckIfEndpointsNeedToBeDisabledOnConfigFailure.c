/*
 * XREFs of HUBUCX_CheckIfEndpointsNeedToBeDisabledOnConfigFailure @ 0x1C0025990
 * Callers:
 *     HUBDSM_CheckingIfEndpointsToBeDisabledOnDetach @ 0x1C00216A0 (HUBDSM_CheckingIfEndpointsToBeDisabledOnDetach.c)
 * Callees:
