/*
 * XREFs of USBD_QueryUsbCapability @ 0x1C003EBC0
 * Callers:
 *     HUBFDO_SetupHubPostErrataQuery @ 0x1C000D44C (HUBFDO_SetupHubPostErrataQuery.c)
 * Callees:
 *     USBDInternal_BuildandSendIoctlSynchronously @ 0x1C003E134 (USBDInternal_BuildandSendIoctlSynchronously.c)
