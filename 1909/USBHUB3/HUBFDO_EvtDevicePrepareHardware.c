/*
 * XREFs of HUBFDO_EvtDevicePrepareHardware @ 0x1C0070DB0
 * Callers:
 *     <none>
 * Callees:
 ...
 *     HUBCONNECTOR_MapIntegratedHubPorts @ 0x1C0078BE4 (HUBCONNECTOR_MapIntegratedHubPorts.c)
 *     HUBCONNECTOR_MapExternalHubPorts @ 0x1C0078CE4 (HUBCONNECTOR_MapExternalHubPorts.c)
 *     HUBCONNECTOR_MapAcpiPorts @ 0x1C0078DC0 (HUBCONNECTOR_MapAcpiPorts.c)
...
LABEL_78:
  ...
  *(_QWORD *)(v10 + 24) = v34;
  ...
  {
    LODWORD(v38) = v6;
    McTemplateK0pq(v35, &USBHUB3_ETW_EVENT_HUB_PREPARE_HARDWARE_COMPLETE, 0LL, *(_QWORD *)(v4 + 248), v38);
  }
  if ( WPP_RECORDER_INITIALIZED != (_UNKNOWN *)&WPP_RECORDER_INITIALIZED )
  {
