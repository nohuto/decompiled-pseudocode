/*
 * XREFs of ?FxStubDriverUnloadCommon@@YAXXZ @ 0x1C003D3DC
 * Callers:
...
void FxStubDriverUnloadCommon(void)
{
  ...
  if ( off_1C0067798 != &__KMDF_CLASS_BIND_START && &__KMDF_CLASS_BIND_END <= off_1C0067798 )
  {
    do
    {
