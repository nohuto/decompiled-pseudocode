/*
 * XREFs of HUBPSM20_ReleasingInterruptReferenceOnResetTransferFailure @ 0x1C00105B0
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall HUBPSM20_ReleasingInterruptReferenceOnResetTransferFailure(__int64 a1)
{
  __int64 v1; // rbx
