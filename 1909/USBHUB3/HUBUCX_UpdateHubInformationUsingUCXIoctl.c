/*
 * XREFs of HUBUCX_UpdateHubInformationUsingUCXIoctl @ 0x1C0024E14
 * Callers:
 *     HUBHSM_UpdatingHubInfoInUCX @ 0x1C00090C0 (HUBHSM_UpdatingHubInfoInUCX.c)
 * Callees:
...
void __fastcall HUBUCX_UpdateHubInformationUsingUCXIoctl(__int64 a1)
{
  ...
  _QWORD v7[12]; // [rsp+60h] [rbp-9h] BYREF
  void *v8; // [rsp+D0h] [rbp+67h] BYREF
  __int64 v9; // [rsp+D8h] [rbp+6Fh] BYREF
  ...
  if ( v3 >= 0 )
  {
    memset(v8, 0, 0x28uLL);
    *(_DWORD *)v8 = 40;
    *((_QWORD *)v8 + 1) = *(_QWORD *)(a1 + 248);
    *((_QWORD *)v8 + 2) = *(_QWORD *)(a1 + 248);
    *((_DWORD *)v8 + 6) = *(unsigned __int16 *)(a1 + 48);
    if ( *(_DWORD *)(a1 + 256) == 2 )
    {
      ...
      *((_DWORD *)v8 + 8) = (*(unsigned __int16 *)(a1 + 1183) >> 5) & 3;
    }
...
LABEL_4:
    LODWORD(v6) = v3;
    WPP_RECORDER_SF_d(*(_QWORD *)(a1 + 2520), 2u, 3u, v5, (__int64)&WPP_df5029fda23434fb8c7e6119726b3851_Traceguids, v6);
  }
LABEL_17:
  if ( v4 < 0 )
  {
