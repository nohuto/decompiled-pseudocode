/*
 * XREFs of HUBHTX_Get30PortChangeEvent @ 0x1C0004FE0
 * Callers:
 *     HUBPSM30_EnablingInterruptsAndGettingPortEvent @ 0x1C00118F0 (HUBPSM30_EnablingInterruptsAndGettingPortEvent.c)
 *     HUBPSM30_EnablingInterruptsAndGettingPortEventInNoChange @ 0x1C0011930 (HUBPSM30_EnablingInterruptsAndGettingPortEventInNoChange.c)
  ...
  *((_WORD *)v4 + 96) = v7;
  ...
  if ( (v7 & 0x200) == 0 )
  {
    if ( WPP_RECORDER_INITIALIZED != (_UNKNOWN *)&WPP_RECORDER_INITIALIZED )
    {
      v14 = 86;
LABEL_121:
      WPP_RECORDER_SF_(v4[179], 2u, 4u, v14, (__int64)&WPP_74185d68226e30ea568d483797443b73_Traceguids);
      goto LABEL_122;
    }
    goto LABEL_122;
  }
...
LABEL_122:
        ...
        *(_DWORD *)(v25 + 2596) = 1073872896;
        if ( (BYTE1(WPP_MAIN_CB.Queue.Wcb.DmaWaitEntry.Blink) & 0x40) != 0 )
        {
          ...
          McTemplateK0pq(
            (struct _MCGEN_TRACE_CONTEXT *)v25,
      ...
      if ( WPP_RECORDER_INITIALIZED != (_UNKNOWN *)&WPP_RECORDER_INITIALIZED )
        WPP_RECORDER_SF_(v4[179], 2u, 4u, 0x57u, (__int64)&WPP_74185d68226e30ea568d483797443b73_Traceguids);
    }
    if ( (v7 & 1) != 0 )
    {
      v6 = 3081;
  ...
  if ( (v7 & 0x1E0) != 0xA0 || (v8 & 0x200) == 0 || (v8 & 0x1E0) == 0xA0 )
  {
    ...
    {
      if ( WPP_RECORDER_INITIALIZED != (_UNKNOWN *)&WPP_RECORDER_INITIALIZED )
        WPP_RECORDER_SF_(v4[179], 2u, 4u, 0x59u, (__int64)&WPP_74185d68226e30ea568d483797443b73_Traceguids);
      goto LABEL_37;
    }
LABEL_47:
    v16 = v7 & 0x1E0;
        ...
        || *(_BYTE *)(*v4 + 240LL) )
      {
        if ( WPP_RECORDER_INITIALIZED != (_UNKNOWN *)&WPP_RECORDER_INITIALIZED )
          WPP_RECORDER_SF_dD(
            ...
            (v7 >> 5) & 0xF,
            v7 & 1);
        v21 = (struct _MCGEN_TRACE_CONTEXT *)*(unsigned int *)(*v4 + 2592LL);
        if ( ((unsigned __int16)v21 & 0x100) != 0 )
...
LABEL_60:
        ...
        WPP_RECORDER_SF_dD(v4[179], 2u, 4u, v20, (__int64)&WPP_74185d68226e30ea568d483797443b73_Traceguids, v28, v29);
        goto LABEL_105;
      }
      goto LABEL_105;
    }
    if ( v16 == 192 )
    {
      ...
      {
        if ( WPP_RECORDER_INITIALIZED != (_UNKNOWN *)&WPP_RECORDER_INITIALIZED )
          WPP_RECORDER_SF_(v4[179], 2u, 4u, 0x5Fu, (__int64)&WPP_74185d68226e30ea568d483797443b73_Traceguids);
        v6 = 3017;
        goto LABEL_133;
      }
      if ( *((_DWORD *)v4 + 2) != 3053 )
      {
        if ( (v7 & 2) != 0 )
        {
          ...
          if ( WPP_RECORDER_INITIALIZED == (_UNKNOWN *)&WPP_RECORDER_INITIALIZED )
            goto LABEL_105;
          WPP_RECORDER_SF_(v4[179], 2u, 4u, 0x61u, (__int64)&WPP_74185d68226e30ea568d483797443b73_Traceguids);
        }
        if ( WPP_RECORDER_INITIALIZED != (_UNKNOWN *)&WPP_RECORDER_INITIALIZED )
        {
          v20 = 99;
...
LABEL_105:
        ...
        if ( WPP_RECORDER_INITIALIZED != (_UNKNOWN *)&WPP_RECORDER_INITIALIZED )
        {
          ...
          WPP_RECORDER_SF_qd(v4[179], 2u, 4u, 0x6Bu, (__int64)&WPP_74185d68226e30ea568d483797443b73_Traceguids, v4, v29);
        }
...
LABEL_50:
        ...
        if ( WPP_RECORDER_INITIALIZED != (_UNKNOWN *)&WPP_RECORDER_INITIALIZED )
          WPP_RECORDER_SF_(v4[179], 2u, 4u, 0x67u, (__int64)&WPP_74185d68226e30ea568d483797443b73_Traceguids);
        goto LABEL_105;
      }
      if ( (v7 & 2) != 0 )
      {
    ...
    LODWORD(v28) = v23;
    WPP_RECORDER_SF_d(v4[179], v24, 4u, v22, (__int64)&WPP_74185d68226e30ea568d483797443b73_Traceguids, v28);
    return v6;
  }
LABEL_37:
  v6 = 3017;
