/*
 * XREFs of HUBMUX_QueueStopToAllPSMs @ 0x1C000EC28
 * Callers:
 *     HUBHSM_NotifyingHubStopToPortsOnReset @ 0x1C00083A0 (HUBHSM_NotifyingHubStopToPortsOnReset.c)
 *     HUBHSM_WaitingForPortsToReleaseReferenceOnResetOnResume @ 0x1C00083C0 (HUBHSM_WaitingForPortsToReleaseReferenceOnResetOnResume.c)
 * Callees:
