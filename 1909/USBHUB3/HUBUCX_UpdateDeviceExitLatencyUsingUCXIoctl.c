/*
 * XREFs of HUBUCX_UpdateDeviceExitLatencyUsingUCXIoctl @ 0x1C0023634
 * Callers:
 *     HUBDSM_UpdatingDeviceExitLatencyInTheControllerAfterIncreasingExitLatency @ 0x1C0021CD0 (HUBDSM_UpdatingDeviceExitLatencyInTheControllerAfterIncreasingExitLatency.c)
 * Callees:
...
void __fastcall HUBUCX_UpdateDeviceExitLatencyUsingUCXIoctl(__int64 a1)
{
  ...
  else
  {
    ...
    *((_QWORD *)v3 + 2) = *(_QWORD *)(a1 + 24);
    ...
    v4 = HUBUCX_SubmitUcxIoctl((__int64 *)a1, 0x491023u);
