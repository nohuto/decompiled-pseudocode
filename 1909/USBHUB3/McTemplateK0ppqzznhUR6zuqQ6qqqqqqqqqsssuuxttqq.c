/*
 * XREFs of McTemplateK0ppqzznhUR6zuqQ6qqqqqqqqqsssuuxttqq @ 0x1C00013D4
 * Callers:
...
ULONG __fastcall McTemplateK0ppqzznhUR6zuqQ6qqqqqqqqqsssuuxttqq(
        __int64 a1,
        ...
        char a35)
{
  ...
  v124 = 4LL;
  v126 = 4LL;
  return McGenEventWrite((PMCGEN_TRACE_CONTEXT)v55, a2, a3, 0x20u, &EventData);
}
