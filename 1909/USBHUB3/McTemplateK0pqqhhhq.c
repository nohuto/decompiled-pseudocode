/*
 * XREFs of McTemplateK0pqqhhhq @ 0x1C0012684
 * Callers:
 ...
 *     EventWriteUSBHUB3_ETW_EVENT_CLIENT_INITIATED_RECOVERY_ACTION_Cleanup @ 0x1C0019E6C (EventWriteUSBHUB3_ETW_EVENT_CLIENT_INITIATED_RECOVERY_ACTION_Cleanup.c)
 * Callees:
 *     McGenEventWrite @ 0x1C0001254 (McGenEventWrite.c)
 *     __security_check_cookie @ 0x1C0041200 (__security_check_cookie.c)
 */

ULONG McTemplateK0pqqhhhq(struct _MCGEN_TRACE_CONTEXT *a1, __int64 a2, const GUID *a3, ...)
{
  ...
  v16 = 2LL;
  v18 = 4LL;
  return McGenEventWrite(a1, &USBHUB3_ETW_EVENT_CLIENT_INITIATED_RECOVERY_ACTION_V1, a3, 8u, &EventData);
}
