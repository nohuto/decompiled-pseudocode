/*
 * XREFs of WER_CreateReport @ 0x1C003BABC
 * Callers:
 ...
 *     WER_StoreDeviceContext @ 0x1C003B7D4 (WER_StoreDeviceContext.c)
...
__int64 __fastcall WER_CreateReport(__int64 a1, __int64 a2, __int64 a3, int a4, unsigned int a5)
{
  ...
  int v48; // [rsp+38h] [rbp-39h]
  __int64 v49; // [rsp+40h] [rbp-31h] BYREF
  ...
  v52[0] = 0LL;
  v52[1] = 0LL;
  DeviceWerThrottleMask = HUBREG_QueryDeviceWerThrottleMask(v8, v7);
  inserted = ((1 << (v5 & 0x1F)) & DeviceWerThrottleMask) != 0 ? 0xC0000001 : 0;
  if ( ((1 << (v5 & 0x1F)) & DeviceWerThrottleMask) != 0 )
    goto LABEL_75;
  v12 = *(_WORD *)(a1 + 2468);
  v13 = *(_WORD *)(a1 + 2466);
  inserted = RtlStringCchPrintfA(
               pszDest,
               5uLL,
               (NTSTRSAFE_PCSTR)&pActivityId.Data4[4],
               *(unsigned __int16 *)(a1 + 2464));
  if ( inserted < 0 )
    goto LABEL_75;
  inserted = RtlStringCchPrintfA(&pszDest[5], 5uLL, (NTSTRSAFE_PCSTR)&pActivityId.Data4[4], v13);
  if ( inserted < 0 )
    goto LABEL_75;
  inserted = RtlStringCchPrintfA(&pszDest[10], 5uLL, (NTSTRSAFE_PCSTR)&pActivityId.Data4[4], v12);
  if ( inserted < 0 )
    goto LABEL_75;
  v14 = *(_QWORD *)(a1 + 16);
  ...
  *(_OWORD *)&pszDest[24] = 0LL;
  ...
  Report = TelemetryData_CreateReport(v16, v15, v5, (unsigned int)pszDest, a5);
  v9 = Report;
  if ( Report )
  {
    ...
    if ( inserted >= 0 )
    {
      inserted = TelemetryData_InsertTriageDataBlock(v9, a1, 2664LL);
      if ( inserted >= 0 )
      {
        ...
        if ( inserted >= 0 )
        {
          ...
          {
            inserted = imp_WppRecorderLogDumpLiveData(WPP_GLOBAL_Control, *(_QWORD *)(a1 + 2520), &v49, &v46, v52);
            if ( inserted >= 0 )
            {
              inserted = TelemetryData_InsertTriageDataBlock(v9, v49, v46);
              if ( inserted >= 0 )
              {
                inserted = imp_WppRecorderDumpLiveDriverData(WPP_GLOBAL_Control, &v50, &v47, v52);
                if ( inserted >= 0 )
                {
...
LABEL_75:
  ...
  else
  {
    ...
    if ( inserted >= 0 )
      WER_UpdateThrottlePolicy(*(_QWORD *)(a1 + 16), v5, *(_QWORD *)(a1 + 2520));
  }
  if ( v9 )
  {
    if ( *(_DWORD *)(v9 + 8) )
