/*
 * XREFs of HUBPDO_FindAndStoreMatchingInternalPipeHandle @ 0x1C0015300
 * Callers:
 *     HUBDSM_GettingMatchingPipeHandleOnClientResetPipe @ 0x1C001C2C0 (HUBDSM_GettingMatchingPipeHandleOnClientResetPipe.c)
 * Callees:
