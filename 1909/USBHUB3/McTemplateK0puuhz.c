/*
 * XREFs of McTemplateK0puuhz @ 0x1C0025B10
 * Callers:
...
ULONG McTemplateK0puuhz(__int64 a1, __int64 a2, const GUID *a3, ...)
{
  __int64 v3; // rax
  __int64 v4; // rcx
  ...
  if ( v27 )
    v5 = v27;
  v16 = v5;
  return McGenEventWrite((PMCGEN_TRACE_CONTEXT)v4, &USBHUB3_ETW_EVENT_BILLBOARD, a3, 6u, &EventData);
}
