/*
 * XREFs of HUBSM_RunStateMachine @ 0x1C000AB88
 * Callers:
...
KIRQL __fastcall HUBSM_RunStateMachine(__int64 a1, int a2, KIRQL *a3, char a4)
{
  ...
  while ( 1 )
  {
    if ( a2 == 1000 )
    {
        ...
        if ( v14 == 3006 )
        {
          ...
          if ( (*(_DWORD *)(v23 + 1336) & 2) != 0 )
          {
            ...
            if ( (*(_DWORD *)(v26 + 1636) & 0x400) != 0 )
            {
              ...
              _InterlockedAnd((volatile signed __int32 *)(v26 + 1636), 0xFFFFFBFF);
            }
          }
          else
          {
      ...
      {
LABEL_36:
        v22 = KeAcquireSpinLockRaiseToDpc(v5);
        v7 = v46;
        *a3 = v22;
        goto LABEL_53;
      }
