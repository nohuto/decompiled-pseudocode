/*
 * XREFs of HUBUCX_AcquireAddress0OwnershipUsingUCXIoctl @ 0x1C0022B98
 * Callers:
 *     HUBDSM_AcquiringAddressZeroOwnershipOnRenum @ 0x1C001D180 (HUBDSM_AcquiringAddressZeroOwnershipOnRenum.c)
 * Callees:
