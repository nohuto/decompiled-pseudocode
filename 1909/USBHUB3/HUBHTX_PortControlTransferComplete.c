/*
 * XREFs of HUBHTX_PortControlTransferComplete @ 0x1C0003840
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall HUBHTX_PortControlTransferComplete(__int64 a1, __int64 a2, __int64 a3, __int64 a4)
{
  ...
  _DWORD v25[3]; // [rsp+70h] [rbp-48h] BYREF
      ...
      if ( *(_DWORD *)(v5 + 1256) == 5000 )
      {
        ...
        if ( WPP_RECORDER_INITIALIZED != (_UNKNOWN *)&WPP_RECORDER_INITIALIZED )
        {
          ...
          if ( WPP_RECORDER_INITIALIZED != (_UNKNOWN *)&WPP_RECORDER_INITIALIZED )
          {
            ...
            WPP_RECORDER_SF_cccccc(*(_QWORD *)(v5 + 1432), v11, v12, v13, Arg1a);
          }
        }
      }
      else
      {
        ...
        if ( WPP_RECORDER_INITIALIZED != (_UNKNOWN *)&WPP_RECORDER_INITIALIZED )
        {
          ...
          if ( WPP_RECORDER_INITIALIZED != (_UNKNOWN *)&WPP_RECORDER_INITIALIZED )
          {
            ...
            WPP_RECORDER_SF_ccccc(*(_QWORD *)(v5 + 1432), v14, v15, v16, Arg1b);
          }
        }
      }
    }
