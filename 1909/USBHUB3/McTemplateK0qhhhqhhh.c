/*
 * XREFs of McTemplateK0qhhhqhhh @ 0x1C0001E7C
 * Callers:
...
ULONG __fastcall McTemplateK0qhhhqhhh(
        ...
        char a11)
{
  ...
  v26 = 2LL;
  v28 = 2LL;
  return McGenEventWrite(a1, &USBHUB3_ETW_EVENT_PORT_STATUS_ERROR_V1, a3, 9u, &EventData);
}
