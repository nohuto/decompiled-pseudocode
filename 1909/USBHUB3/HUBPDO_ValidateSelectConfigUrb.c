/*
 * XREFs of HUBPDO_ValidateSelectConfigUrb @ 0x1C001497C
 * Callers:
 *     HUBDSM_ValidatingSelectConfigUrbFromConfigured @ 0x1C001CFF0 (HUBDSM_ValidatingSelectConfigUrbFromConfigured.c)
 * Callees:
...
__int64 __fastcall HUBPDO_ValidateSelectConfigUrb(__int64 a1)
{
  ...
  __int64 result; // rax
  _QWORD v18[5]; // [rsp+40h] [rbp-58h] BYREF
