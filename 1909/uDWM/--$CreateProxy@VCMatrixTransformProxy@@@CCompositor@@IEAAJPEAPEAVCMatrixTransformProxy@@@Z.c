/*
 * XREFs of ??$CreateProxy@VCMatrixTransformProxy@@@CCompositor@@IEAAJPEAPEAVCMatrixTransformProxy@@@Z @ 0x180024B04
 * Callers:
...
__int64 __fastcall CCompositor::CreateProxy<CMatrixTransformProxy>(__int64 a1, __int64 *a2)
{
  __int64 v4; // rax
  __int64 v5; // rbx
  int v6; // eax
