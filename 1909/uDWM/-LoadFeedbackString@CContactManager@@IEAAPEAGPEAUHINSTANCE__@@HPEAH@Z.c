/*
 * XREFs of ?LoadFeedbackString@CContactManager@@IEAAPEAGPEAUHINSTANCE__@@HPEAH@Z @ 0x180096B5C
 * Callers:
 ...
 *     ?LoadPenResources@CContactManager@@AEAAXXZ @ 0x180096C24 (-LoadPenResources@CContactManager@@AEAAXXZ.c)
 * Callees:
