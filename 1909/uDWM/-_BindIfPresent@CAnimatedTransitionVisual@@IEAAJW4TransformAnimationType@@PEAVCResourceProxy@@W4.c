/*
 * XREFs of ?_BindIfPresent@CAnimatedTransitionVisual@@IEAAJW4TransformAnimationType@@PEAVCResourceProxy@@W4Enum@DwmResourceProperty@@@Z @ 0x18003B038
 * Callers:
...
__int64 __fastcall CAnimatedTransitionVisual::_BindIfPresent(__int64 a1, int a2, __int64 a3, unsigned int a4)
{
  ...
  if ( v5 )
  {
    ...
    v4 = v7;
    if ( v7 < 0 )
      MilInstrumentationCheckHR_MaybeFailFast(0x14u, 0LL, 0, v7, 0x7A8u, v8);
  }
  return v4;
}
