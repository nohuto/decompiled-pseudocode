/*
 * XREFs of ??$CreateProxy@VCIndirectSwapchainRenderTargetProxy@@@CCompositor@@IEAAJPEAPEAVCIndirectSwapchainRenderTargetProxy@@@Z @ 0x1800B59A0
 * Callers:
...
__int64 __fastcall CCompositor::CreateProxy<CIndirectSwapchainRenderTargetProxy>(__int64 a1, __int64 *a2)
{
  ...
  *a2 = 0LL;
  ...
  if ( v5 )
  {
    ...
    v6 = CResource::Create(0x12u, *(_QWORD *)(a1 + 16), (__int64 *)(v5 + 16));
    v7 = v6;
    if ( v6 >= 0 )
      v7 = 0;
    else
