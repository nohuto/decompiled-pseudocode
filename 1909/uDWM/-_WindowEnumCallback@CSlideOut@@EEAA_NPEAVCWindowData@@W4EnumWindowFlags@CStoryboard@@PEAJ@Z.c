/*
 * XREFs of ?_WindowEnumCallback@CSlideOut@@EEAA_NPEAVCWindowData@@W4EnumWindowFlags@CStoryboard@@PEAJ@Z @ 0x180032B90
 * Callers:
 *     <none>
 * Callees:
...
char __fastcall CSlideOut::_WindowEnumCallback(CSlide *a1, __int64 a2, char a3, int *a4)
{
  ...
  *(_QWORD *)&v39.right = 0LL;
  ...
  if ( (v10 & 0xFFF) != 0 )
  {
    if ( (*(_DWORD *)(a2 + 612) & 0xFFF) == 8 )
    {
      ...
      *(_DWORD *)(a2 + 612) |= 0x200000u;
      ...
      if ( v34 < 0 )
        ...
        *(_BYTE *)(*(_QWORD *)(*(_QWORD *)&v39.left + 40LL) + 976LL) = 1;
      goto LABEL_18;
    }
    if ( (*(_DWORD *)(a2 + 612) & 0xFFF) == 0xB )
    {
      *(_DWORD *)(a2 + 612) = v10 | 0x200000;
    ...
    if ( (*(_DWORD *)(a2 + 612) & 0xFFF) != 0x18 && (*(_DWORD *)(a2 + 612) & 0xFFF) != 0x2A )
    {
      if ( (*(_DWORD *)(a2 + 612) & 0xFFF) == 0x45 )
      {
        v18 = CSlide::_SlideWindowVertically(a1, (struct CWindowData *)a2, &v41, 0, (struct CAnimationComponent **)&v39);
        v4 = v18;
        if ( v18 < 0 )
          MilInstrumentationCheckHR_MaybeFailFast(
            0x14u,
      ...
      if ( (*(_DWORD *)(a2 + 612) & 0xFFF) == 0x46 )
      {
        if ( (v10 & 0x1800000) == 0 )
          goto LABEL_25;
        v17 = CSlide::_SlideWindow(a1, (struct CWindowData *)a2, 1.0, (struct CAnimationComponent **)&v39);
        v4 = v17;
        if ( v17 < 0 )
          MilInstrumentationCheckHR_MaybeFailFast(
            0x14u,
...
LABEL_23:
    ...
    if ( CWindowPropertyTracker::IsWindowTrackedAndCloakChanged(
           ...
           *(HWND *)(a2 + 40),
           1)
      || ((v19 = *(_DWORD *)(a2 + 612) & 0xFFF, v19 == 42) || v19 == 87)
      && !CTransitionVisualController::HasVisibleStyle(*(HWND *)(a2 + 40)) )
    {
      ...
      if ( WindowDataByHwnd )
      {
        *((_DWORD *)WindowDataByHwnd + 153) = *(_DWORD *)(a2 + 612) & 0xEBFFF000 | 0x1400002A;
        if ( *(float *)(*(_QWORD *)(*((_QWORD *)a1 + 16) + 40LL) + 744LL) == 1.0 )
        {
          v23 = (*(__int64 (__fastcall **)(CSlide *, _QWORD))(*(_QWORD *)a1 + 112LL))(a1, *(unsigned int *)(a2 + 612));
...
LABEL_18:
          ...
          v25 = CSlide::_SlideWindowHorizontally(a1, v22, &v41, 0, 0LL, (struct CAnimationComponent **)&v39.right);
          v4 = v25;
          if ( v25 < 0 )
          {
            MilInstrumentationCheckHR_MaybeFailFast(
...
LABEL_48:
        ...
        else
        {
          ...
          v27 = CSlide::_SlideWindowHorizontally(a1, v22, &v41, 0, 0LL, (struct CAnimationComponent **)&v39.right);
          v4 = v27;
          if ( v27 < 0 )
          {
            MilInstrumentationCheckHR_MaybeFailFast(
...
LABEL_9:
      ...
      if ( v5 && *((_DWORD *)v5 + 17) != 2 )
        *((_DWORD *)v5 + 17) = 3;
      v14 = (*(__int64 (__fastcall **)(CSlide *, _QWORD))(*(_QWORD *)a1 + 112LL))(a1, *(_DWORD *)(a2 + 612) & 0xFFF);
      v15 = CStoryboard::_CreateAndAddBlurBehindComponent(a1, (__m128i *)a2, v14, &v40);
      v4 = v15;
      if ( v15 < 0 )
      {
        MilInstrumentationCheckHR_MaybeFailFast(
      ...
      else
      {
        ...
        if ( v40 )
        {
          v28 = *(_QWORD *)(*(_QWORD *)&v39.left + 40LL);
          v29 = *(struct tagRECT *)(v28 + 856);
          v30 = *(_OWORD *)(v28 + 872);
          v31 = (struct tagPOINT *)*((_QWORD *)v40 + 5);
          v41 = v29;
          CAnimatedTransitionVisual::SetBeginRect(v31, &v41);
          v32 = *((_QWORD *)v6 + 5);
          *(_OWORD *)(v32 + 872) = v30;
          CVisual::SetDirtyFlags((CVisual *)(v32 + 8), 4096);
  ...
  else if ( v10 < 0 )
  {
    ...
    v4 = v35;
    if ( v35 < 0 )
      MilInstrumentationCheckHR_MaybeFailFast(0x14u, &CStoryboard::MILINSTRUMENTATIONHRESULTLIST, 1u, v35, 0x3E5u, v36);
  }
LABEL_25:
  result = 1;
  *v7 = v4;
