/*
 * XREFs of ?GetLegacyPhoneScaleFactor@@YA?AW4DEVICE_SCALE_FACTOR@@UtagSIZE@@0@Z @ 0x1800B99B8
 * Callers:
 ...
 * Callees:
 *     ?LoadScalingOverrides@@YAXXZ @ 0x18003A9C8 (-LoadScalingOverrides@@YAXXZ.c)
 ...
 *     ?CalcBucketedScaleFactor@@YAIUtagSIZE@@0@Z @ 0x1800B984C (-CalcBucketedScaleFactor@@YAIUtagSIZE@@0@Z.c)
 */
