/*
 * XREFs of ?_EnsureResources@CDesktopThumbnailCVI@@IEAAJXZ @ 0x1800AFCDC
 * Callers:
...
__int64 __fastcall CDesktopThumbnailCVI::_EnsureResources(CDesktopThumbnailCVI *this)
{
  ...
  if ( v4 < 0 )
  {
    MilInstrumentationCheckHR_MaybeFailFast(0x14u, 0LL, 0LL, v4, 0x242u);
    goto LABEL_13;
  }
  ...
  if ( v5 < 0 )
  {
    MilInstrumentationCheckHR_MaybeFailFast(0x14u, 0LL, 0LL, v5, 0x245u);
    goto LABEL_13;
  }
  ...
  if ( v6 < 0 )
  {
    MilInstrumentationCheckHR_MaybeFailFast(0x14u, 0LL, 0LL, v6, 0x248u);
    goto LABEL_13;
  }
  v7 = v18[0];
  v8 = v18[1];
  ...
  *(double *)&v20[1] = (double)v9;
  ...
  v15 = CCachedVisualImageProxy::Update(*v2, (__int64)v19, (__int64)v20, 0, 0, *(_QWORD *)(v14 + 16), 0);
  v1 = v15;
  if ( v15 < 0 )
  {
    MilInstrumentationCheckHR_MaybeFailFast(0x14u, 0LL, 0LL, v15, 0x268u);
LABEL_13:
    if ( *v2 )
    {
