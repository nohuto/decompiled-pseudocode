/*
 * XREFs of ?get_Name@?$EffectBase@UIGaussianBlurEffect@Effects@Composition@UI@Microsoft@@@Effects@Composition@UI@Microsoft@@UEAAJPEAPEAUHSTRING__@@@Z @ 0x18003D170
 * Callers:
 *     <none>
 * Callees:
 *     <none>
