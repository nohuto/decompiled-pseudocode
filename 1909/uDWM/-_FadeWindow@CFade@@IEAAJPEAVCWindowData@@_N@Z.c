/*
 * XREFs of ?_FadeWindow@CFade@@IEAAJPEAVCWindowData@@_N@Z @ 0x18004CAB4
 * Callers:
 ...
 *     ?GetOwnedInclusiveClipRect@CTransitionVisualController@@QEAAXPEAVCWindowData@@PEAUtagRECT@@@Z @ 0x1800A3D64 (-GetOwnedInclusiveClipRect@CTransitionVisualController@@QEAAXPEAVCWindowData@@PEAUtagRECT@@@Z.c)
...
__int64 __fastcall CFade::_FadeWindow(CFade *this, struct CWindowData *a2, char a3)
{
  ...
  int v26; // eax
  int v27; // eax
  void *v28; // [rsp+30h] [rbp-41h]
  void *v29; // [rsp+30h] [rbp-41h]
  void *v30; // [rsp+30h] [rbp-41h]
  CBaseObject *v31; // [rsp+58h] [rbp-19h] BYREF
  CBaseObject *v32; // [rsp+60h] [rbp-11h] BYREF
  struct tagRECT v33; // [rsp+68h] [rbp-9h] BYREF
  struct tagRECT rc; // [rsp+78h] [rbp+7h] BYREF

  v31 = 0LL;
  v32 = 0LL;
  if ( (*((_DWORD *)a2 + 153) & 0x100000) != 0 )
    IsWindowTrackedAndCloakChanged = *((char *)a2 + 607) >= 0
    ...
    IsWindowTrackedAndCloakChanged = CWindowPropertyTracker::IsWindowTrackedAndCloakChanged(
                                       ...
                                       *((HWND *)a2 + 5),
                                       a3 ^ 1);
  v7 = CImmersiveState::Create(&v32, *((_QWORD *)a2 + 15));
  if ( v7 < 0 )
  {
    MilInstrumentationCheckHR_MaybeFailFast(0x14u, &CStoryboard::MILINSTRUMENTATIONHRESULTLIST, 1u, v7, 0x1E6u, v28);
    goto LABEL_20;
  }
  IsLauncherShownAboveWindow = CImmersiveState::IsLauncherShownAboveWindow(v32, (const struct tagRECT *)a2);
  v10 = 0;
...
LABEL_10:
  if ( (*((_DWORD *)a2 + 153) & 0x20000) != 0 )
  {
    ...
    v26 = (*(__int64 (__fastcall **)(CFade *, _QWORD))(*(_QWORD *)this + 112LL))(this, *((unsigned int *)a2 + 153));
    v27 = CStoryboard::_CreateAndAddAnimationComponentControlReuse(this, a2, 1, v26, &rc, 0LL, 0xFFFFFFFF, 1, &v31);
    if ( v27 >= 0 )
    {
      v15 = (struct tagPOINT **)v31;
      goto LABEL_13;
    }
    MilInstrumentationCheckHR_MaybeFailFast(0x14u, &CStoryboard::MILINSTRUMENTATIONHRESULTLIST, 1u, v27, 0x205u, v30);
  }
  else
  {
    v13 = (*(__int64 (__fastcall **)(CFade *))(*(_QWORD *)this + 112LL))(this);
    v14 = CStoryboard::_CreateAndAddAnimationComponentControlReuse(this, a2, 1, v13, 0LL, 0LL, 0xFFFFFFFF, 1, &v31);
    if ( v14 >= 0 )
    {
      v15 = (struct tagPOINT **)v31;
      v33 = *(struct tagRECT *)((char *)v31 + 88);
LABEL_13:
      v16 = *((_DWORD *)a2 + 153);
      v17 = (struct tagRECT *)((char *)a2 + 632);
      if ( (v16 & 0x1000000) != 0 )
        v33 = *v17;
      v18 = (v16 & 0x800000) != 0;
      v19 = &v33;
      if ( v18 )
        v19 = v17;
      v20 = *v19;
      CAnimatedTransitionVisual::SetBeginRect(v15[5], &v33);
      v21 = v15[5];
    ...
    MilInstrumentationCheckHR_MaybeFailFast(0x14u, &CStoryboard::MILINSTRUMENTATIONHRESULTLIST, 1u, v14, 0x209u, v29);
  }
  v15 = (struct tagPOINT **)v31;
LABEL_18:
  if ( v15 )
