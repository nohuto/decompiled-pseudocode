/*
 * XREFs of ?MoveSize@CWindowList@@UEAAJPEAUIDwmWindow@@@Z @ 0x18001DFD0
 * Callers:
 *     <none>
 * Callees:
 ...
 *     ?WillEndAnimationCloaked@CWindowData@@QEBA_NXZ @ 0x1800931A8 (-WillEndAnimationCloaked@CWindowData@@QEBA_NXZ.c)
 */
...
__int64 __fastcall CWindowList::MoveSize(CWindowList *this, struct IDwmWindow *a2)
{
  ...
  __int64 v84; // rcx
  __int64 v85; // rcx
  const struct CStoryboard *v86; // r15
  __int64 v87; // rbx
  char v88; // r13
  struct CStoryboard *v89; // r15
  __int64 v90; // r9
  struct tagPOINT v91; // rbx
  struct CStoryboard *v92; // r13
  char v93; // r15
  int v94; // eax
  __int64 v95; // rdx
  __int64 v96; // rcx
  ...
  CTransitionVisualController *v109; // rcx
  __int64 v110; // rdx
  __int64 v111; // rcx
  int started; // eax
  struct CWindowData *v113; // rdx
  __int64 v114; // r12
  __int64 v115; // r12
  CAccentBlurBehind *v116; // rcx
  CWindowList *v117; // rcx
  CTopLevelWindow *v118; // rcx
  HWND v119; // rdx
  bool v120; // bl
  HWND v121; // rcx
  int v122; // ecx
  ...
  int v125; // r9d
  int v126; // r8d
  void *v127; // [rsp+28h] [rbp-D8h]
  char v128; // [rsp+30h] [rbp-D0h]
  char v129; // [rsp+30h] [rbp-D0h]
  bool v130; // [rsp+31h] [rbp-CFh] BYREF
  bool v131; // [rsp+32h] [rbp-CEh] BYREF
  int v132; // [rsp+34h] [rbp-CCh] BYREF
  int v133; // [rsp+38h] [rbp-C8h]
  struct CWindowData *v134; // [rsp+40h] [rbp-C0h] BYREF
  int v135; // [rsp+48h] [rbp-B8h]
  struct CStoryboard *v136; // [rsp+50h] [rbp-B0h] BYREF
  unsigned __int64 v137; // [rsp+58h] [rbp-A8h]
  struct tagPOINT v138; // [rsp+60h] [rbp-A0h] BYREF
  struct CStoryboard *v139; // [rsp+68h] [rbp-98h]
  int v140; // [rsp+70h] [rbp-90h] BYREF
  struct IDwmWindow *v141; // [rsp+78h] [rbp-88h]
  struct tagPOINT v142; // [rsp+80h] [rbp-80h] BYREF
  CWindowList *v143; // [rsp+88h] [rbp-78h]
  __int64 v144; // [rsp+90h] [rbp-70h]
  _DWORD v145[2]; // [rsp+98h] [rbp-68h] BYREF
  struct _RTL_CRITICAL_SECTION *v146; // [rsp+A0h] [rbp-60h] BYREF
  _QWORD v147[3]; // [rsp+A8h] [rbp-58h] BYREF
  struct CTransitionWindowSnapshot *v148; // [rsp+C0h] [rbp-40h] BYREF
  __int64 v149; // [rsp+C8h] [rbp-38h] BYREF
  int v150; // [rsp+D0h] [rbp-30h]
  int v151; // [rsp+D4h] [rbp-2Ch]
  RECT rc1; // [rsp+D8h] [rbp-28h] BYREF
  RECT v153; // [rsp+E8h] [rbp-18h] BYREF
  RECT rc2; // [rsp+F8h] [rbp-8h] BYREF
  RECT v155; // [rsp+108h] [rbp+8h] BYREF
  WCHAR ClassName[264]; // [rsp+120h] [rbp+20h] BYREF

  v143 = this;
  v141 = a2;
  v147[2] = &CDesktopManager::s_csDwmInstance;
  v3 = a2;
  ...
  if ( v7 || !(*(__int64 (__fastcall **)(struct IDwmWindow *))(*(_QWORD *)v3 + 16LL))(v3) )
    goto LABEL_2;
  v100 = (CWindowData *)(*(__int64 (__fastcall **)(WPF::HeapBase *, __int64))(*(_QWORD *)WPF::g_pProcessHeap + 16LL))(
                          WPF::g_pProcessHeap,
                          752LL);
  if ( !v100 || (v101 = CWindowData::CWindowData(v100), (v7 = v101) == 0LL) )
  {
    v6 = -2147024882;
    MilInstrumentationCheckHR_MaybeFailFast(0x14u, 0LL, 0, -2147024882, 0x891u, v127);
    goto LABEL_165;
  }
  *((_QWORD *)v101 + 3) = v3;
  (**(void (__fastcall ***)(struct IDwmWindow *, CWindowData *))v3)(v3, v101);
  *((_QWORD *)v7 + 5) = (*(__int64 (__fastcall **)(struct IDwmWindow *))(*(_QWORD *)v3 + 24LL))(v3);
  v102 = CWindowList::SyncWindowData(this, v3, v7);
  v6 = v102;
  if ( v102 >= 0 )
LABEL_2:
    v5 = v7;
  else
    MilInstrumentationCheckHR_MaybeFailFast(0x14u, 0LL, 0, v102, 0x895u, v127);
  v135 = v6;
  if ( v6 < 0 )
  {
LABEL_165:
    v23 = v6;
    MilInstrumentationCheckHR_MaybeFailFast(0x14u, 0LL, 0, v6, 0xB7Cu, v127);
    goto LABEL_37;
  }
  if ( !v5 )
  {
  ...
  v8 = 0;
  (*(void (__fastcall **)(struct IDwmWindow *, __int64 *))(*(_QWORD *)v3 + 88LL))(v3, &v149);
  v9 = (struct tagRECT *)((char *)v5 + 180);
  v10 = 0;
  v11 = v149 - *((_DWORD *)v5 + 45);
  v12 = *((_QWORD *)CDesktopManager::s_pDesktopManagerInstance + 30);
  v13 = HIDWORD(v149) - *((_DWORD *)v5 + 46);
  v14 = *((_QWORD *)v5 + 5);
  v133 = v11;
  v15 = *(_DWORD *)(v12 + 72);
  if ( v15 )
  {
    ...
    {
      _mm_lfence();
      v81 = *(_QWORD *)(*(_QWORD *)(v12 + 48) + 8LL * (unsigned int)v10);
      if ( (*(_BYTE *)(v81 + 40) & 4) != 0 )
      {
        v82 = *(_QWORD *)(v81 + 104);
        v11 = v149 - v82;
        v13 = HIDWORD(v149) - HIDWORD(v82);
        v133 = v149 - v82;
      }
    }
  }
LABEL_6:
  ...
  {
    v144 = v149;
    v139 = (struct CStoryboard *)*((_QWORD *)CDesktopManager::s_pDesktopManagerInstance + 30);
    EnterCriticalSection(&CDesktopManager::s_csDwmInstance);
    v8 = 0;
    v128 = 0;
    if ( *((_DWORD *)v139 + 10) )
    {
      ...
      do
      {
        v139 = *(struct CStoryboard **)(*((_QWORD *)v89 + 2) + 8LL * v4);
        if ( CAnimationScheduler::_ShouldTrack((CAnimationScheduler *)v4, v5, v139, 0) )
        {
          v136 = (struct CStoryboard *)&CDesktopManager::s_csDwmInstance;
          EnterCriticalSection(&CDesktopManager::s_csDwmInstance);
          v94 = CWindowPropertyTracker::_EnsureRecordExists((struct CStoryboard *)((char *)v89 + 48), v139, v5, &v132);
          LODWORD(v137) = v94;
          if ( v94 < 0 )
          {
            MilInstrumentationCheckHR_MaybeFailFast(0x14u, 0LL, 0, v94, 0x35u, v127);
          }
          else
          {
            v95 = (unsigned int)v132;
            *(_QWORD *)(*(_QWORD *)(*((_QWORD *)v89 + 6) + 8LL * (unsigned int)v132) + 104LL) = v87;
            v96 = *(_QWORD *)(*((_QWORD *)v89 + 6) + 8 * v95);
            *(_DWORD *)(v96 + 40) |= 4u;
          }
          CGuard<CDwmCS>::~CGuard<CDwmCS>((struct _RTL_CRITICAL_SECTION **)&v136);
          v88 |= (v137 & 0x80000000) == 0LL;
        }
        ++v4;
      }
      while ( v4 < *((_DWORD *)v89 + 10) );
      v3 = v141;
      v4 = 0;
      v11 = v133;
      v128 = v88;
    ...
    if ( !v8 )
    {
      ...
      {
        v90 = *(_QWORD *)(v48 + 24);
        while ( !*(_BYTE *)(v90 + 24LL * v47 + 16) || *((_QWORD *)v5 + 50) != *(_QWORD *)(v90 + 24LL * v47) )
        {
          if ( ++v47 >= v49 )
            goto LABEL_51;
        }
        v103 = *(CVisual **)(v90 + 24LL * v47 + 8);
        v138.x = v9->left;
        v138.y = *((_DWORD *)v5 + 46);
        CVisual::SetOffset(v103, &v138);
      }
LABEL_51:
      v134 = v5;
      v50 = *((_DWORD *)v5 + 87);
      ...
      if ( (v50 & 1) != 0 )
      {
        v104 = (float)*((int *)v5 + 80) / (float)*((int *)v5 + 86);
        if ( v104 != 1.0 )
        {
      ...
      {
        v105 = (float)*((int *)v5 + 80) / (float)*((int *)v5 + 81);
        if ( v105 != 1.0 )
        {
          left = (int)floor_0((float)((float)left * v105) + 0.5);
          top = (int)floor_0((float)((float)top * v105) + 0.5);
        }
        left += *((_DWORD *)v5 + 84) - (int)floor_0((float)((float)*((int *)v5 + 82) * v105) + 0.5);
        top += *((_DWORD *)v5 + 85) - (int)floor_0((float)((float)*((int *)v5 + 83) * v105) + 0.5);
      }
      else
      {
        v53 = *((_DWORD *)v5 + 82);
      ...
      if ( v56 )
      {
        ...
        v59 = *(_DWORD *)(v58 + 48);
        v60 = *(_DWORD *)(v58 + 52);
        v137 = __PAIR64__(v60, v59);
        if ( !v57 )
        {
          v59 = -32000;
          v137 = 0xFFFF8300FFFF8300uLL;
          v60 = -32000;
        }
        ...
        v55 = v134;
        if ( (*((_BYTE *)v134 + 608) & 1) != 0 )
        {
          v145[0] = *((_DWORD *)v134 + 12);
          v145[1] = *((_DWORD *)v134 + 13);
          v147[0] = &v134;
          v147[1] = v145;
          CWindowList::ForEachSoftwareCursorListener__lambda_1a2d7eb9b07ca6f2dc9b65c4384631da___(v143, v147);
          v55 = v134;
        }
      }
      v64 = *((_QWORD *)v55 + 51);
      ...
      if ( *(char *)(v65 + 607) < 0
        ...
        || (v107 = (CTransitionVisualController *)*((_QWORD *)CDesktopManager::s_pDesktopManagerInstance + 31),
            v136 = *(struct CStoryboard **)(v65 + 40),
            SnapshotIndex = CTransitionVisualController::_GetSnapshotIndex(v107, (HWND)v136),
            (int)CTransitionVisualController::GetStoredSnapshotNoRefByIndex(v109, SnapshotIndex, &v148) < 0) )
      {
      ...
      else
      {
        if ( (Microsoft_Windows_Dwm_UdwmEnableBits & 1) != 0 )
          McTemplateU0pq(v111, v110, v136, 0LL);
        started = CTopLevelWindow3D::StartAnimation(v64, 9u);
        if ( started < 0 )
          MilInstrumentationCheckHR_MaybeFailFast(0x14u, 0LL, 0, started, 0x1A5u, v127);
      }
      v55 = v134;
LABEL_77:
      ...
      {
        v80 = *(_QWORD *)(*((_QWORD *)v55 + 56) + 8LL * i);
        if ( *(struct CWindowData **)(v80 + 64) == v67 && *(_DWORD *)(v80 + 72) == 1 )
        {
      ...
      for ( j = 0; j < *((_DWORD *)v69 + 140); ++j )
      {
        ...
        {
          v113 = *(struct CWindowData **)(v71 + 16LL * j);
          v114 = *((_QWORD *)v113 + 50);
          if ( v114 )
          {
            if ( !v55 || *((_QWORD *)v113 + 15) == *((_QWORD *)v55 + 15) )
            {
              v115 = *(_QWORD *)(v114 + 264);
              if ( v115 )
              {
                v116 = *(CAccentBlurBehind **)(v115 + 336);
                if ( v116 )
                {
                  if ( *((_QWORD *)v113 + 5) == *(_QWORD *)(v115 + 400)
                    || CAccentBlurBehind::IsBlurBehindDirty(
                         v116,
                         v113,
                         (const struct tagRECT *)(v115 + 616),
                         *(_QWORD *)(v115 + 408),
                         *(HWND *)(v115 + 400)) )
                  {
                    (*(void (__fastcall **)(__int64, __int64))(*(_QWORD *)v115 + 24LL))(v115, 0x10000LL);
                  }
                }
              }
            }
  ...
  if ( v150 - (int)v149 < 0 )
    v16 = 0;
  v17 = v151 - HIDWORD(v149);
  v133 = v151 - HIDWORD(v149);
  if ( v151 - HIDWORD(v149) < 0 )
  {
    v17 = 0;
    v133 = 0;
  }
  ...
  if ( v18 >= 0
    && (_mm_lfence(), v83 = *(_QWORD *)(*(_QWORD *)(v19 + 48) + 8LL * (unsigned int)v18),
                      (*(_BYTE *)(v83 + 40) & 2) != 0) )
  {
    v136 = *(struct CStoryboard **)(v83 + 112);
    v21 = (int)v136;
    v22 = (unsigned __int64)v136 >> 32;
  }
  else
  {
LABEL_13:
      ...
      if ( *((_DWORD *)v5 + 146) )
      {
        do
        {
            ...
            && (*(char *)(v27 + 104) >= 0 || (*(_DWORD *)(v27 + 612) & 0xFFF) == 0x11) )
          {
            if ( *(_QWORD *)(v27 + 32) )
            {
              v120 = CWindowData::WillEndAnimationCloaked(v28);
              if ( CWindowData::WillEndAnimationCloaked((CWindowData *)v27) == v120
                && ContainsRect(
                     ...
                     (const struct tagRECT *)(v27 + 48)) )
              {
                v121 = *(HWND *)(v27 + 40);
                ClassName[0] = 0;
                if ( !GetClassNameW(v121, ClassName, 260) )
                {
LABEL_212:
                  v29 = 1;
                  goto LABEL_28;
                ...
                while ( 1 )
                {
                  ...
                  do
                  {
                    v125 = *(WCHAR *)((char *)v124 + (char *)*v123 - (char *)ClassName);
                    v126 = *v124 - v125;
                    if ( v126 )
                      break;
                    ++v124;
...
LABEL_28:
  ...
  else
  {
    v138.x = v16;
    v138.y = v17;
    v136 = (struct CStoryboard *)*((_QWORD *)CDesktopManager::s_pDesktopManagerInstance + 30);
    v72 = v136;
    EnterCriticalSection(&CDesktopManager::s_csDwmInstance);
    v129 = 0;
    if ( *((_DWORD *)v72 + 10) )
    {
      ...
      do
      {
        v136 = *(struct CStoryboard **)(*((_QWORD *)v92 + 2) + 8LL * v4);
        if ( CAnimationScheduler::_ShouldTrack((CAnimationScheduler *)v4, v5, v136, 0) )
        {
          v146 = &CDesktopManager::s_csDwmInstance;
          EnterCriticalSection(&CDesktopManager::s_csDwmInstance);
          v97 = CWindowPropertyTracker::_EnsureRecordExists((struct CStoryboard *)((char *)v92 + 48), v136, v5, &v140);
          v132 = v97;
          if ( v97 < 0 )
          {
            MilInstrumentationCheckHR_MaybeFailFast(0x14u, 0LL, 0, v97, 0x25u, v127);
          }
          else
          {
            v98 = (unsigned int)v140;
            *(struct tagPOINT *)(*(_QWORD *)(*((_QWORD *)v92 + 6) + 8LL * (unsigned int)v140) + 112LL) = v91;
            v99 = *(_QWORD *)(*((_QWORD *)v92 + 6) + 8 * v98);
            *(_DWORD *)(v99 + 40) |= 2u;
          }
    ...
    if ( !v129 )
    {
      ...
      *((_DWORD *)v5 + 48) = v17 + *((_DWORD *)v5 + 46);
      CWindowData::EstablishPixelAlignedScale(v5, &v131);
      ...
      *((_DWORD *)v5 + 15) = (_DWORD)v77;
      if ( v57 || (v78 = CWindowData::OnWindowSizeUpdated(v5), v23 = v78, v78 >= 0) )
      {
        if ( v131 )
        {
          ...
          CWindowList::OnClientGlassChange(v117, v5);
          v118 = (CTopLevelWindow *)*((_QWORD *)v5 + 50);
          if ( v118 )
            CTopLevelWindow::OnWindowScaleUpdated(v118);
          v119 = (HWND)*((_QWORD *)v5 + 5);
          v142 = (struct tagPOINT)*((_QWORD *)v5 + 6);
          v130 = 0;
          ...
          CAnimationScheduler::OnWindowPositionChange(
            *((CAnimationScheduler **)CDesktopManager::s_pDesktopManagerInstance + 30),
            ...
            &v130);
          if ( !v130 )
            CWindowList::OnPositionChange(v143, v5, 1);
        }
      }
      else
      {
        MilInstrumentationCheckHR_MaybeFailFast(0x14u, 0LL, 0, v78, 0xD54u, v127);
      }
      if ( v23 < 0 )
      {
        MilInstrumentationCheckHR_MaybeFailFast(0x14u, 0LL, 0, v23, 0xBB5u, v127);
        goto LABEL_37;
      }
      goto LABEL_20;
    }
  ...
  if ( v30 >= 0
    && (_mm_lfence(), v84 = *(_QWORD *)(*(_QWORD *)(v31 + 48) + 8LL * (unsigned int)v30),
                      (*(_BYTE *)(v84 + 40) & 8) != 0) )
  {
    v33 = *(RECT *)(v84 + 120);
  }
...
LABEL_32:
  ...
  if ( (int)v34 >= 0
    && (_mm_lfence(),
        v85 = *(_QWORD *)(*(_QWORD *)(v36 + 48) + 8LL * (unsigned int)v34),
        (*(_BYTE *)(v85 + 40) & 0x10) != 0) )
  {
    v38 = *(RECT *)(v85 + 136);
  }
...
LABEL_34:
  ...
  (*(void (__fastcall **)(struct IDwmWindow *, RECT *))(*(_QWORD *)v3 + 104LL))(v3, &v153);
  (*(void (__fastcall **)(struct IDwmWindow *, __int64))(*(_QWORD *)v3 + 112LL))(v3, (__int64)v5 + 228);
  if ( !EqualRect(&rc1, &rc2) || !EqualRect(&v153, &v155) )
  {
    ...
    if ( *(_DWORD *)(v41 + 40) )
    {
      do
      {
        v86 = *(const struct CStoryboard **)(*(_QWORD *)(v41 + 16) + 8LL * v4);
        if ( CAnimationScheduler::_ShouldTrack((CAnimationScheduler *)v4, v5, v86, 0) )
