/*
 * XREFs of ?CreateFromValueInternal@SemaphoreValue@details_abi@wil@@AEAAJPEBG_N_K@Z @ 0x1800763D0
 * Callers:
 ...
 * Callees:
 *     ?StringCchCopyW@@YAJPEAG_KPEBG@Z @ 0x180029330 (-StringCchCopyW@@YAJPEAG_KPEBG@Z.c)
