/*
 * XREFs of ?Initialize@CAnimatedGlassSheet@@MEAAJ_N@Z @ 0x180093AB0
 * Callers:
 ...
 *     ?GetWindowFramePart@CTopLevelWindow@@CAPEAVCBitmapSource@@PEAUWindowFrame@1@I@Z @ 0x18008D420 (-GetWindowFramePart@CTopLevelWindow@@CAPEAVCBitmapSource@@PEAUWindowFrame@1@I@Z.c)
 */
  ...
  if ( v4 >= 0 )
  {
    ...
    *(double *)v20.m128i_i64 = _mm_cvtepi32_pd(v20).m128d_f64[0] * *((double *)v8 + 60);
    ...
    while ( 1 )
    {
      ...
      if ( v26 < 0 )
        break;
      CAtlasedRectsVisual::InsertAtlasImageAtIndex(this, *v22, *((_DWORD *)this + 66));
