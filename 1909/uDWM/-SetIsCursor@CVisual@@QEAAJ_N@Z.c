/*
 * XREFs of ?SetIsCursor@CVisual@@QEAAJ_N@Z @ 0x18004AF70
 * Callers:
...
__int64 __fastcall CVisual::SetIsCursor(CVisual *this, char a2)
{
  ...
  LOBYTE(v3) = a2;
  v6 = (*(__int64 (__fastcall **)(__int64, __int64, __int64))(*(_QWORD *)v4 + 272LL))(v4, v5, v3);
  v7 = v6;
  if ( v6 < 0 )
    MilInstrumentationCheckHR_MaybeFailFast(0x14u, 0LL, 0, v6, 0x1C8u, v9);
  return v7;
}
