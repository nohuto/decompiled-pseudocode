/*
 * XREFs of ?Start@CFlickVisual@@QEAAJPEBUtagPOINT@@W4FLICK_TYPE@@I@Z @ 0x18009E8B0
 * Callers:
 ...
 *     ?MonitorDpiFromPoint@CDesktopManager@@SAIUtagPOINT@@@Z @ 0x180045CC4 (-MonitorDpiFromPoint@CDesktopManager@@SAIUtagPOINT@@@Z.c)
