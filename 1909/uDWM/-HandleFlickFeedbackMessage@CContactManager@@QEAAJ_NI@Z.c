/*
 * XREFs of ?HandleFlickFeedbackMessage@CContactManager@@QEAAJ_NI@Z @ 0x18009663C
 * Callers:
 ...
 *     ?Initialize@CTrackingTooltip@@QEAAJPEBUtagPOINT@@PEAG@Z @ 0x18009E5B8 (-Initialize@CTrackingTooltip@@QEAAJPEBUtagPOINT@@PEAG@Z.c)
 *     ?Update@CTrackingTooltip@@QEAAXPEBUtagPOINT@@PEAG@Z @ 0x18009E628 (-Update@CTrackingTooltip@@QEAAXPEBUtagPOINT@@PEAG@Z.c)
 */
  ...
  if ( v3 )
  {
    ...
    if ( (int)v6 >= 0 )
    {
      ...
      if ( a2 )
      {
        ...
        v5 = CContactManager::LoadFeedbackString(v14, ModuleHandleW, dword_1800CAFA0[v12], &v28);
        if ( !v5 )
        {
          v27 = 1772;
LABEL_12:
