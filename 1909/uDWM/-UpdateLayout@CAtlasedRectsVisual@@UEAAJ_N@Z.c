/*
 * XREFs of ?UpdateLayout@CAtlasedRectsVisual@@UEAAJ_N@Z @ 0x180036480
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall CAtlasedRectsVisual::UpdateLayout(CAtlasedRectsVisual *this)
{
  ...
  if ( v2 )
  {
    ...
    if ( __PAIR64__(v5, v4) != 0x7FFFFFFF7FFFFFFFLL || v7 != 0x7FFFFFFF || v6 != 0x7FFFFFFF )
    {
      ...
      if ( SHIDWORD(v19) <= 0 )
        HIDWORD(v19) = 0;
      v11 = (*(__int64 (__fastcall **)(CAtlasedRectsVisual *, unsigned __int64 *))(*(_QWORD *)this + 96LL))(this, &v19);
      v3 = v11;
      if ( v11 < 0 )
      {
        MilInstrumentationCheckHR_MaybeFailFast(0x14u, 0LL, 0, v11, 0x115u, v18);
        goto LABEL_22;
      }
...
LABEL_22:
  if ( v3 < 0 )
    MilInstrumentationCheckHR_MaybeFailFast(0x14u, 0LL, 0, v3, 0x88u, v18);
  else
