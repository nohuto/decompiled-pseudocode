/*
 * XREFs of ?Create@CDCompDesktopThumbnail@@SAJPEAPEAV1@@Z @ 0x18008F328
 * Callers:
...
__int64 __fastcall CDCompDesktopThumbnail::Create(struct CDCompDesktopThumbnail **a1)
{
  ...
  {
    v2 = -2147024809;
    MilInstrumentationCheckHR_MaybeFailFast(0x14u, 0LL, 0LL, -2147024809, 0x112u);
  ...
  if ( v4 )
  {
    ...
    {
      MilInstrumentationCheckHR_MaybeFailFast(0x14u, 0LL, 0LL, v5, 0x112u);
    }
    if ( v2 >= 0 )
      goto LABEL_13;
  }
  ...
  {
    v2 = -2147024882;
    MilInstrumentationCheckHR_MaybeFailFast(0x14u, 0LL, 0LL, -2147024882, 0x112u);
  }
  *a1 = 0LL;
LABEL_13:
  if ( v4 )
