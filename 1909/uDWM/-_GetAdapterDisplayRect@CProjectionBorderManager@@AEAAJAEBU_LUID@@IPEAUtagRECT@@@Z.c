/*
 * XREFs of ?_GetAdapterDisplayRect@CProjectionBorderManager@@AEAAJAEBU_LUID@@IPEAUtagRECT@@@Z @ 0x1800896C8
 * Callers:
  ...
  *(_QWORD *)&a4->right = 0LL;
  ...
  if ( DisplayConfigBufferSizes >= 0 )
  {
    ...
    if ( !is_mul_ok((unsigned int)numPathArrayElements, 0x48uLL) )
      v11 = -1LL;
    v7 = (DISPLAYCONFIG_PATH_INFO *)(*(__int64 (__fastcall **)(WPF::HeapBase *, __int64))(*(_QWORD *)WPF::g_pProcessHeap
                                                                                        + 8LL))(
                                      WPF::g_pProcessHeap,
                                      v11);
