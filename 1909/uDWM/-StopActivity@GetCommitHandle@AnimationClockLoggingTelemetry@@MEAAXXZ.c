/*
 * XREFs of ?StopActivity@GetCommitHandle@AnimationClockLoggingTelemetry@@MEAAXXZ @ 0x1800B2D40
 * Callers:
 *     <none>
 * Callees:
        ...
        AnimationClockLoggingTelemetry::GetCommitHandle *this)
{
  ...
  if ( v4 )
  {
    if ( *(_DWORD *)v6[1] > 4u )
    {
      ...
      v62 = 4LL;
      TlgCreateSz(&v63, v14);
      TlgWrite(v15, &unk_1800C95A6, (LPCGUID)(*((_QWORD *)this + 6) + 8LL), 0LL, 0x15u, &pData);
    }
  }
  else
  {
    ...
    {
      v29 = 8LL;
      v28 = &`AnimationClockLoggingTelemetry::TriggerClock::StopActivity'::`19'::_TlgActivityPrivacyTag;
      ...
      v19 = CurrentThreadId;
      v32 = &v19;
      TlgWrite(v16, &unk_1800C96F0, (LPCGUID)(*((_QWORD *)this + 6) + 8LL), 0LL, 5u, &v27);
    }
  }
  if ( *((_DWORD *)this + 8) )
