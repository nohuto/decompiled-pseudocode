/*
 * XREFs of ?UpdateTransition@CAnimatedGlassSheet@@AEAAJXZ @ 0x18009451C
 * Callers:
 ...
 *     ?InterpolateValueLinear@CAnimatedGlassSheet@@AEAAJJJM@Z @ 0x180093F74 (-InterpolateValueLinear@CAnimatedGlassSheet@@AEAAJJJM@Z.c)
