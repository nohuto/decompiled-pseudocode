/*
 * XREFs of ??$CreateProxy@VCWindowNodeProxy@@@CCompositor@@IEAAJPEAPEAVCWindowNodeProxy@@@Z @ 0x18003A8DC
 * Callers:
...
__int64 __fastcall CCompositor::CreateProxy<CWindowNodeProxy>(__int64 a1, CBaseObject **a2)
{
  __int64 v4; // rax
  CBaseObject *v5; // rbx
  int v6; // eax
