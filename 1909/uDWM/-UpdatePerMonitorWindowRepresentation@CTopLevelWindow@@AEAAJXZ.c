/*
 * XREFs of ?UpdatePerMonitorWindowRepresentation@CTopLevelWindow@@AEAAJXZ @ 0x18001ABF0
 * Callers:
...
__int64 __fastcall CTopLevelWindow::UpdatePerMonitorWindowRepresentation(CTopLevelWindow *this)
{
  ...
  if ( (*((_BYTE *)v1 + 348) & 2) != 0 )
  {
    ...
    if ( !v6 )
    {
      ...
      if ( v7 < 0 )
      {
        MilInstrumentationCheckHR_MaybeFailFast(0x14u, 0LL, 0, v7, 0x166Au, v31);
        return v2;
      }
      v1 = (struct CWindowData *)*((_QWORD *)this + 90);
      v6 = *v5;
          ...
          if ( inserted >= 0 )
          {
            if ( *(_BYTE *)(*((_QWORD *)CDesktopManager::s_pDesktopManagerInstance + 61) + 601LL) )
            {
              ...
              if ( v12 )
              {
                ...
                if ( v14 < 0 )
                {
                  MilInstrumentationCheckHR_MaybeFailFast(0x14u, 0LL, 0, v14, 0x1684u, v31);
                  return v2;
                }
                ...
                if ( v15 < 0 )
                {
                  MilInstrumentationCheckHR_MaybeFailFast(0x14u, 0LL, 0, v15, 0x1685u, v31);
                  return v2;
                }
              }
              else
              {
                ...
                if ( v16 < 0 )
                {
                  MilInstrumentationCheckHR_MaybeFailFast(0x14u, 0LL, 0, v16, 0x1689u, v31);
                  return v2;
                }
                ...
                if ( v17 < 0 )
                {
                  MilInstrumentationCheckHR_MaybeFailFast(0x14u, 0LL, 0, v17, 0x168Au, v31);
                  return v2;
                }
              }
            }
            else
            {
              ...
              if ( v18 < 0 )
              {
                MilInstrumentationCheckHR_MaybeFailFast(0x14u, 0LL, 0, v18, 0x168Fu, v31);
                return v2;
              }
              ...
              if ( v19 < 0 )
              {
                MilInstrumentationCheckHR_MaybeFailFast(0x14u, 0LL, 0, v19, 0x1690u, v31);
                return v2;
              }
            }
            ...
            v2 = v20;
            if ( v20 < 0 )
              MilInstrumentationCheckHR_MaybeFailFast(0x14u, 0LL, 0, v20, 0x1693u, v31);
          }
          else
          {
            MilInstrumentationCheckHR_MaybeFailFast(0x14u, 0LL, 0, inserted, 0x167Cu, v31);
          }
        }
      }
        ...
        if ( v21 >= 0 )
        {
          if ( *(_BYTE *)(*((_QWORD *)CDesktopManager::s_pDesktopManagerInstance + 61) + 601LL) )
          {
            ...
            if ( v23 )
            {
              ...
              if ( v24 < 0 )
              {
                MilInstrumentationCheckHR_MaybeFailFast(0x14u, 0LL, 0, v24, 0x16A3u, v31);
                return v2;
              }
              ...
              if ( v25 < 0 )
              {
                MilInstrumentationCheckHR_MaybeFailFast(0x14u, 0LL, 0, v25, 0x16A4u, v31);
                return v2;
              }
            }
            else
            {
              ...
              if ( v26 < 0 )
              {
                MilInstrumentationCheckHR_MaybeFailFast(0x14u, 0LL, 0, v26, 0x16A8u, v31);
                return v2;
              }
              ...
              if ( v27 < 0 )
              {
                MilInstrumentationCheckHR_MaybeFailFast(0x14u, 0LL, 0, v27, 0x16A9u, v31);
                return v2;
              }
            }
          }
          else
          {
            ...
            if ( v28 < 0 )
            {
              MilInstrumentationCheckHR_MaybeFailFast(0x14u, 0LL, 0, v28, 0x16AEu, v31);
              return v2;
            }
            ...
            if ( v29 < 0 )
            {
              MilInstrumentationCheckHR_MaybeFailFast(0x14u, 0LL, 0, v29, 0x16AFu, v31);
              return v2;
            }
          }
          ...
          v2 = v30;
          if ( v30 < 0 )
            MilInstrumentationCheckHR_MaybeFailFast(0x14u, 0LL, 0, v30, 0x16B2u, v31);
        }
        else
        {
          MilInstrumentationCheckHR_MaybeFailFast(0x14u, 0LL, 0, v21, 0x169Bu, v31);
        }
      }
    }
    else
    {
      MilInstrumentationCheckHR_MaybeFailFast(0x14u, 0LL, 0, v8, 0x1670u, v31);
    }
  }
  return v2;
}
