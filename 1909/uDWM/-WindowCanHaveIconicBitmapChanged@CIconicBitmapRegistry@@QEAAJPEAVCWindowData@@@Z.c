/*
 * XREFs of ?WindowCanHaveIconicBitmapChanged@CIconicBitmapRegistry@@QEAAJPEAVCWindowData@@@Z @ 0x18001434C
 * Callers:
...
LABEL_7:
    ...
    if ( v9 && *(struct CWindowData **)(v9 + 72) == a2 )
    {
      ...
      *((_BYTE *)this + 88) = 0;
      ...
      if ( v10 < 0 )
        MilInstrumentationCheckHR_MaybeFailFast(0x14u, 0LL, 0, v10, 0x347u, v13);
      ...
      v3 = v11;
      if ( v11 < 0 )
        MilInstrumentationCheckHR_MaybeFailFast(0x14u, 0LL, 0, v11, 0x349u, v13);
    }
  }
  else
  {
    MilInstrumentationCheckHR_MaybeFailFast(0x14u, 0LL, 0, v8, 0x33Eu, v13);
  }
  return v3;
}
