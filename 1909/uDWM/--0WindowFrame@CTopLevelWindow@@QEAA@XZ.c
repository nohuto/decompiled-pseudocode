/*
 * XREFs of ??0WindowFrame@CTopLevelWindow@@QEAA@XZ @ 0x1800481A8
 * Callers:
 *     ?EnsureWindowFrames@CTopLevelWindow@@CAJXZ @ 0x18002CFE4 (-EnsureWindowFrames@CTopLevelWindow@@CAJXZ.c)
 * Callees:
 *     ??0DPIImages@WindowFrame@CTopLevelWindow@@QEAA@XZ @ 0x180047E74 (--0DPIImages@WindowFrame@CTopLevelWindow@@QEAA@XZ.c)
 */
