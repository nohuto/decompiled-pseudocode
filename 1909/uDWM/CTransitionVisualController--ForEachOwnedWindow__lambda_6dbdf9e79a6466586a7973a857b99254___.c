/*
 * XREFs of CTransitionVisualController::ForEachOwnedWindow__lambda_6dbdf9e79a6466586a7973a857b99254___ @ 0x18004B2A8
 * Callers:
  ...
  if ( !a3 || (*(_DWORD *)(a1 + 612) & 0x10000000) != 0 )
  {
    ...
    if ( !v6 || (*(_BYTE *)(v6 + 240) & 0x18) == 0 )
    {
      for ( i = 0LL; (unsigned int)i < *(_DWORD *)(a1 + 584); i = (unsigned int)(i + 1) )
      {
        ...
        {
          v3 = 0;
          if ( *(_QWORD *)(v8 + 400) && CTransitionVisualController::ShouldCloneWindow(*(HWND *)(v8 + 40)) )
            v3 = CVisual::RenderRecursive(*(CVisual **)(v8 + 400));
          if ( v3 >= 0 )
