/*
 * XREFs of ?HandleKeystateFeedbackMessage@CContactManager@@QEAAJ_NI@Z @ 0x180096864
 * Callers:
 ...
 *     ?BuildFeedbackString@CContactManager@@IEAAJKPEAGI@Z @ 0x180095FCC (-BuildFeedbackString@CContactManager@@IEAAJKPEAGI@Z.c)
