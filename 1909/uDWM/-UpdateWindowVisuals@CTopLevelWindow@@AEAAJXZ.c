/*
 * XREFs of ?UpdateWindowVisuals@CTopLevelWindow@@AEAAJXZ @ 0x180017770
 * Callers:
 ...
 *     ?GetNonClientCaptionFont@CWindowData@@QEAAXPEAUtagLOGFONTW@@@Z @ 0x18003816C (-GetNonClientCaptionFont@CWindowData@@QEAAXPEAUtagLOGFONTW@@@Z.c)
 *     ?BlendColors@@YAKKKM@Z @ 0x180038E04 (-BlendColors@@YAKKKM@Z.c)
 *     ?Create@CImage@@SAJPEAPEAV1@@Z @ 0x1800390E4 (-Create@CImage@@SAJPEAPEAV1@@Z.c)
 *     ?IsSheetOfGlass@CTopLevelWindow@@AEAA_NXZ @ 0x180039AC4 (-IsSheetOfGlass@CTopLevelWindow@@AEAA_NXZ.c)
...
LABEL_22:
  ...
  if ( v6 )
  {
    ...
    CAtlasedImage::SetDirtyFlags(v39, 1, 0x2000u);
  }
LABEL_57:
  ...
  if ( updated < 0 )
  {
    MilInstrumentationCheckHR_MaybeFailFast(0x14u, 0LL, 0, updated, 0x83Au, v97);
    return v2;
  }
  v41 = *((_DWORD *)v1 + 146);
  v42 = *((_QWORD *)v1 + 65);
  if ( (v41 & 0x10080) != 0 )
  {
    if ( !v42 )
    {
      ...
      if ( v70 < 0 )
      {
        MilInstrumentationCheckHR_MaybeFailFast(0x14u, 0LL, 0, v70, 0x840u, v97);
        return v2;
      }
      ...
      if ( inserted < 0 )
      {
        MilInstrumentationCheckHR_MaybeFailFast(0x14u, 0LL, 0, inserted, 0x841u, v97);
        return v2;
      }
  ...
  else
  {
    if ( v42 )
    {
      ...
      if ( v90 )
      {
        ...
        if ( v91 < 0 )
        {
          MilInstrumentationCheckHR_MaybeFailFast(0x14u, 0LL, 0, v91, 0x850u, v97);
          return v2;
        }
  ...
  if ( (*((_BYTE *)v1 + 584) & 8) != 0 )
  {
    if ( !v44 )
    {
      ...
      if ( v72 < 0 )
      {
        MilInstrumentationCheckHR_MaybeFailFast(0x14u, 0LL, 0, v72, 0x85Du, v97);
        return v2;
      }
      ...
      if ( v73 < 0 )
      {
        MilInstrumentationCheckHR_MaybeFailFast(0x14u, 0LL, 0, v73, 0x860u, v97);
        return v2;
      }
  ...
  else if ( v44 )
  {
    ...
    if ( v93 < 0 )
    {
      MilInstrumentationCheckHR_MaybeFailFast(0x14u, 0LL, 0, v93, 0x889u, v97);
      return v2;
    }
  ...
  if ( v45 < 0 )
  {
    MilInstrumentationCheckHR_MaybeFailFast(0x14u, 0LL, 0, v45, 0x88Eu, v97);
    return v2;
  }
  v2 = 0;
  if ( (*((_BYTE *)v1 + 241) & 2) != 0 )
  {
    ...
    if ( HolographicSlate < 0 )
      MilInstrumentationCheckHR_MaybeFailFast(0x14u, 0LL, 0, HolographicSlate, 0x179u, v97);
  }
  else
  {
