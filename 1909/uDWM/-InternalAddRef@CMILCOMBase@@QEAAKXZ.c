/*
 * XREFs of ?InternalAddRef@CMILCOMBase@@QEAAKXZ @ 0x18004BB9C
 * Callers:
 ...
 *     ?AddRef@CCompoundBitmapLock@@UEAAKXZ @ 0x18004BB90 (-AddRef@CCompoundBitmapLock@@UEAAKXZ.c)
 * Callees:
