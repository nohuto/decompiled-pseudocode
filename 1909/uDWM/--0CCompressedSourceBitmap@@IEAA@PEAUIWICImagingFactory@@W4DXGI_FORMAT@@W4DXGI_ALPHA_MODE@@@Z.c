/*
 * XREFs of ??0CCompressedSourceBitmap@@IEAA@PEAUIWICImagingFactory@@W4DXGI_FORMAT@@W4DXGI_ALPHA_MODE@@@Z @ 0x18004996C
 * Callers:
 ...
 * Callees:
 *     ??0CBitmap@@QEAA@XZ @ 0x180049A54 (--0CBitmap@@QEAA@XZ.c)
