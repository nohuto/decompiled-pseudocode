/*
 * XREFs of ?ResizeToSnapshot@CStoryboard@@SAXPEAUHWND__@@AEBUtagRECT@@PEAU3@@Z @ 0x1800A8F9C
 * Callers:
...
void __fastcall CStoryboard::ResizeToSnapshot(HWND a1, const struct tagRECT *a2, struct tagRECT *a3)
{
  ...
  *a3 = *a2;
  SnapshotIndex = CTransitionVisualController::_GetSnapshotIndex(*((CTransitionVisualController **)v3 + 31), a1);
  ...
  if ( StoredSnapshotNoRefByIndex >= 0 )
  {
    v9 = 0;
    v10 = *((_QWORD *)v12 + 40);
    v11 = _mm_srli_si128(*((__m128i *)v12 + 20), 8).m128i_u64[0];
