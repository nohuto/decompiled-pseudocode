/*
 * XREFs of ?DwmLivePreviewWndProc@CDesktopManager@@CA_JPEAUHWND__@@I_K_J@Z @ 0x18007EF20
 * Callers:
 *     <none>
 * Callees:
    ...
    if ( Msg == 71 )
    {
      if ( (*(_BYTE *)(lParam + 32) & 0x40) != 0 )
      {
        ...
        else
        {
          ...
          if ( v13 >= 0 )
            v13 = -2003304445;
          MilInstrumentationCheckHR_MaybeFailFast(0x14u, 0LL, 0LL, v13, 0x94Fu);
        }
        EnterCriticalSection(&CDesktopManager::s_csDwmInstance);
        v9 = v13 < 0;
LABEL_26:
    ...
    if ( Msg != 257 )
    {
      if ( Msg == 1028 )
      {
        ...
        if ( !SetWindowPos(wParam, 0LL, 0, 0, 0, 0, lParam != 0 ? 67 : 83) )
        {
          ...
          if ( v12 >= 0 )
            v12 = -2003304445;
          MilInstrumentationCheckHR_MaybeFailFast(0x14u, 0LL, 0LL, v12, 0x939u);
          v9 = wParam == hWnd;
        }
        v10 = 0;
        EnterCriticalSection(&CDesktopManager::s_csDwmInstance);
