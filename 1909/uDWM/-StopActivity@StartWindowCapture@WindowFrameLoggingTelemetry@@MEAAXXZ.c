/*
 * XREFs of ?StopActivity@StartWindowCapture@WindowFrameLoggingTelemetry@@MEAAXXZ @ 0x1800878B0
 * Callers:
 *     <none>
 * Callees:
        ...
        WindowFrameLoggingTelemetry::StartWindowCapture *this)
{
  ...
  if ( v4 )
  {
      ...
      && (*(_QWORD *)(v7 + 24) & 0x200000000000LL) == *(_QWORD *)(v7 + 24) )
    {
      ...
      TlgWrite(v14, &unk_1800C8A86, (LPCGUID)(*((_QWORD *)this + 6) + 8LL), 0LL, 0x12u, &pData);
    }
  }
  else
  {
      ...
      && (*((_QWORD *)v15 + 3) & 0x200000000000LL) == *((_QWORD *)v15 + 3) )
    {
      ...
      v18 = CurrentThreadId;
      v29 = &v18;
      TlgWrite(v15, &unk_1800C8BB0, (LPCGUID)(*((_QWORD *)this + 6) + 8LL), 0LL, 5u, &v24);
    }
  }
  if ( *((_DWORD *)this + 8) )
