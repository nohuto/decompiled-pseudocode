/*
 * XREFs of ?StopActivity@EndAnimationClock@AnimationClockLoggingTelemetry@@MEAAXXZ @ 0x1800074A0
 * Callers:
 *     <none>
 * Callees:
        ...
        AnimationClockLoggingTelemetry::EndAnimationClock *this)
{
  ...
  if ( v4 )
  {
    if ( **(_DWORD **)(v6 + 8) > 4u )
    {
      ...
      v62 = 4LL;
      TlgCreateSz(&v63, v17);
      TlgWrite(v18, &unk_1800C9740, (LPCGUID)(*((_QWORD *)this + 6) + 8LL), 0LL, 0x15u, &v34);
    }
  }
  else
  {
    ...
    if ( *(_DWORD *)v7 > 4u )
    {
      ...
      v19 = CurrentThreadId;
      v32 = &v19;
      TlgWrite(v7, &unk_1800C988C, (LPCGUID)(*((_QWORD *)this + 6) + 8LL), 0LL, 5u, &pData);
    }
  }
  if ( *((_DWORD *)this + 8) )
