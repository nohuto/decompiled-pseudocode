/*
 * XREFs of ?ReportFailure_Msg@details@wil@@YAXPEAXIPEBD110W4FailureType@2@J1PEAD@Z @ 0x18008507C
 * Callers:
 *     ?ReportFailure_HrMsg@details@wil@@YAXPEAXIPEBD110W4FailureType@2@J1PEAD@Z @ 0x180085070 (-ReportFailure_HrMsg@details@wil@@YAXPEAXIPEBD110W4FailureType@2@J1PEAD@Z.c)
 * Callees:
 ...
 *     ?StringCchVPrintfW@@YAJPEAG_KPEBGPEAD@Z @ 0x1800783A8 (-StringCchVPrintfW@@YAJPEAG_KPEBGPEAD@Z.c)
 */
        ...
        char *a10)
{
  ...
  wil::details::ReportFailure(a1, a2, a3, 0LL, 0LL, a6, 2, a8, v13, 0);
}
