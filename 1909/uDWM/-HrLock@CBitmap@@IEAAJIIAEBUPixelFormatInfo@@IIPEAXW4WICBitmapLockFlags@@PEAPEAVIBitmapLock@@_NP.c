/*
 * XREFs of ?HrLock@CBitmap@@IEAAJIIAEBUPixelFormatInfo@@IIPEAXW4WICBitmapLockFlags@@PEAPEAVIBitmapLock@@_NPEAUIUnknown@@@Z @ 0x18004849C
 * Callers:
 ...
 *     ??0CBitmapLock@@QEAA@XZ @ 0x180049034 (--0CBitmapLock@@QEAA@XZ.c)
        ...
        struct IUnknown *a11)
{
  ...
  if ( (a8 & 2) != 0 )
  {
    if ( !_InterlockedCompareExchange((volatile signed __int32 *)this + 53, 0x80000000, 0) )
      goto LABEL_8;
    v17 = -2003292403;
    MilInstrumentationCheckHR_MaybeFailFast(0x14u, 0LL, 0, -2003292403, 0x5Au, v24);
    v23 = 667;
LABEL_31:
    MilInstrumentationCheckHR_MaybeFailFast(0x14u, 0LL, 0, v17, v23, v24);
    return v17;
  }
  if ( (a8 & 1) == 0 )
  {
  ...
  v15 = -2003292403;
  MilInstrumentationCheckHR_MaybeFailFast(0x14u, 0LL, 0, -2003292403, 0x3Bu, v24);
LABEL_6:
  v17 = v15;
  if ( v15 < 0 )
  {
    MilInstrumentationCheckHR_MaybeFailFast(0x14u, 0LL, 0, v15, 0x29Fu, v24);
    return v17;
  }
  v12 = a3;
  v13 = a2;
LABEL_8:
  ...
  if ( v19 )
  {
    ...
    MilInstrumentationCheckHR_MaybeFailFast(0x14u, 0LL, 0, v20, 0x2B5u, v25);
  }
  else
  {
    v17 = -2147024882;
    MilInstrumentationCheckHR_MaybeFailFast(0x14u, 0LL, 0, -2147024882, 0x2A9u, v24);
  }
  if ( (a8 & 2) != 0 )
  {
    *((_DWORD *)this + 53) = 0;
