/*
 * XREFs of ?construct@?$manually_managed_shutdown_aware_object@VFeatureStateManager@details@wil@@@wil@@QEAAXXZ @ 0x18004DE30
 * Callers:
 ...
 * Callees:
 *     ??0SubscriptionList@details_abi@wil@@QEAA@XZ @ 0x180033F64 (--0SubscriptionList@details_abi@wil@@QEAA@XZ.c)
 */
