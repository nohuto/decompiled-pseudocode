/*
 * XREFs of ?CreateHostBackdropBrush@UI@WindowsInternal@@YAJPEAUIDCompositionDesktopDevicePartner@@PEAPEAUICompositionBrush@Composition@1Windows@@@Z @ 0x18003D4E4
 * Callers:
 ...
 *     ?put_BlurAmount@GaussianBlurEffect@Effects@Composition@UI@Microsoft@@UEAAJM@Z @ 0x18003DA60 (-put_BlurAmount@GaussianBlurEffect@Effects@Composition@UI@Microsoft@@UEAAJM@Z.c)
...
LABEL_34:
  ...
  *(_DWORD *)(v37 + 76) = 0;
  ...
  v26 = v40;
  v39 = 0LL;
  v27 = *(__int64 (__fastcall **)(__int64, __int64, __int64 *))(*(_QWORD *)v40 + 88LL);
