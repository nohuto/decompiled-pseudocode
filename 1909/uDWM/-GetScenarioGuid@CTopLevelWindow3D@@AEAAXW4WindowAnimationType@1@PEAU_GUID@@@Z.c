/*
 * XREFs of ?GetScenarioGuid@CTopLevelWindow3D@@AEAAXW4WindowAnimationType@1@PEAU_GUID@@@Z @ 0x18000BF70
 * Callers:
    ...
    if ( v4 )
    {
      ...
      if ( v5 )
      {
        ...
        if ( v6 )
        {
          ...
          {
            if ( v7 == 1 )
              v8 = (GUID)xmmword_1800C46A8;
            else
              v8 = GUID_NULL;
          }
          else
          {
            v8 = (GUID)xmmword_1800C46B8;
          }
        }
        else
        {
          v8 = (GUID)xmmword_1800C51E8;
        }
      }
      else
      {
        v8 = (GUID)xmmword_1800C46C8;
      }
    }
    else
    {
      v8 = (GUID)xmmword_1800C51F8;
    }
  }
  else
  {
    v8 = (GUID)xmmword_1800C46D8;
  }
  *a3 = v8;
}
