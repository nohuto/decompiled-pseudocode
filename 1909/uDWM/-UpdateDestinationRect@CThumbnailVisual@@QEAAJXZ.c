/*
 * XREFs of ?UpdateDestinationRect@CThumbnailVisual@@QEAAJXZ @ 0x18000DD38
 * Callers:
...
__int64 __fastcall CThumbnailVisual::UpdateDestinationRect(CThumbnailVisual *this)
{
  ...
  int v58; // edx
  int v59; // edx
  void *v60; // [rsp+30h] [rbp-31h]
  __int128 v61; // [rsp+38h] [rbp-29h] BYREF
  __m128i v62; // [rsp+48h] [rbp-19h] BYREF
  int v63[4]; // [rsp+58h] [rbp-9h] BYREF
  float v64; // [rsp+68h] [rbp+7h] BYREF
  float v65; // [rsp+6Ch] [rbp+Bh]
  float v66; // [rsp+70h] [rbp+Fh]
  float v67; // [rsp+74h] [rbp+13h]
  ...
  if ( !v8 )
  {
    if ( v5 )
    {
      ...
      {
        v28 = 0;
        v62.m128i_i32[0] = -*((_DWORD *)this + 28);
        v62.m128i_i32[1] = -*((_DWORD *)this + 29);
        if ( v27[47] - v27[45] >= 0 )
          v28 = v27[47] - v27[45];
        v29 = v62.m128i_i32[2];
  ...
  if ( *((_QWORD *)this + 50) && *((_QWORD *)this + 51) )
  {
    *(_QWORD *)&v61 = 0LL;
    v9 = *((_DWORD *)this + 30);
    v10 = *((_DWORD *)this + 31);
    *((_QWORD *)&v61 + 1) = __PAIR64__(v10, v9);
    ...
    if ( IsImmersiveIconic )
    {
      ...
      if ( v34 < 0 )
      {
        MilInstrumentationCheckHR_MaybeFailFast(0x14u, 0LL, 0, v34, 0x3F5u, v60);
        return v2;
      }
      v35 = *((_QWORD *)this + 47);
      v36 = 0;
      ...
      v47 = *((_QWORD *)this + 50);
      v67 = (float)v45 + v43;
      v48 = (*(__int64 (__fastcall **)(_QWORD, _QWORD, float *))(**(_QWORD **)(v47 + 16) + 320LL))(
              *(_QWORD *)(v47 + 16),
              *(unsigned int *)(v47 + 24),
              &v64);
      v2 = v48;
      if ( v48 < 0 )
      {
        MilInstrumentationCheckHR_MaybeFailFast(0x14u, 0LL, 0, v48, 0x3FFu, v60);
        return v2;
      }
    }
    else
    {
      ...
      v66 = (float)v9 + 0.0;
      v67 = (float)v10 + 0.0;
      v12 = (*(__int64 (__fastcall **)(_QWORD, _QWORD, float *))(**(_QWORD **)(v11 + 16) + 320LL))(
              *(_QWORD *)(v11 + 16),
              *(unsigned int *)(v11 + 24),
              &v64);
      v2 = v12;
      if ( v12 < 0 )
      {
        MilInstrumentationCheckHR_MaybeFailFast(0x14u, 0LL, 0, v12, 0x40Cu, v60);
        return v2;
      }
    }
    v13 = *((_QWORD *)this + 58);
...
LABEL_17:
        ...
        *(double *)&v63[2] = v21;
        ...
        {
          v22 = (*(__int64 (__fastcall **)(_QWORD, _QWORD, int *))(**(_QWORD **)(*((_QWORD *)this + 51) + 16LL) + 328LL))(
          ...
          if ( v22 < 0 )
          {
            MilInstrumentationCheckHR_MaybeFailFast(0x14u, 0LL, 0, v22, 0x42Eu, v60);
            return v2;
          }
          v23 = *(_OWORD *)v63;
          *((_BYTE *)this + 474) = 1;
...
LABEL_20:
        if ( v8 )
          *(_OWORD *)v63 = v61;
          ...
          IntersectRectT<MilPointAndSizeL>(v63, &v61, &v62);
        if ( CThumbnailVisual::_HasBorder(this) && *((_QWORD *)this + 53) )
        {
          ...
          {
            MilInstrumentationCheckHR_MaybeFailFast(0x14u, 0LL, 0, RectangleGeometry, 0x444u, v60);
            return v2;
          }
          v57 = *((_DWORD *)this + 30);
          v58 = *((_DWORD *)this + 31);
          LODWORD(v61) = *((_DWORD *)this + 124);
          DWORD1(v61) = v61;
          v59 = v58 - 2 * v61;
          DWORD2(v61) = v57 - 2 * v61;
          HIDWORD(v61) = v59;
          if ( SDWORD2(v61) > 0 && v59 > 0 )
          {
            if ( v8 )
              *(_OWORD *)v63 = v61;
            else
        ...
        *(_OWORD *)((char *)this + 500) = v61;
        *(__m128i *)((char *)this + 532) = v6;
        v24 = (struct CRectangleGeometryProxy **)((char *)this + 416);
        if ( *v24 )
        {
          v25 = ResourceHelper::CreateRectangleGeometry(v63[0], v63[1], v63[2], v63[3], v24);
          v2 = v25;
          if ( v25 < 0 )
            MilInstrumentationCheckHR_MaybeFailFast(0x14u, 0LL, 0, v25, 0x45Du, v60);
        }
        return v2;
      }
