/*
 * XREFs of ?StartActivity@TriggerClock@AnimationClockLoggingTelemetry@@QEAAXU_GUID@@@Z @ 0x180006F54
 * Callers:
        ...
        struct _GUID *a2)
{
  ...
  if ( *(_DWORD *)v5 > 4u )
  {
    ...
    TlgWrite(v5, &unk_1800C93BA, (LPCGUID)(*((_QWORD *)this + 6) + 8LL), v7, 5u, &pData);
  }
  if ( !*((_DWORD *)this + 8) )
    wil::details::ThreadFailureCallbackHolder::StartWatching((AnimationClockLoggingTelemetry::TriggerClock *)((char *)this + 8));
}
