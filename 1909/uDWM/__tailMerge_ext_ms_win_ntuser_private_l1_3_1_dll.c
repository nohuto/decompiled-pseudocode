/*
 * XREFs of __tailMerge_ext_ms_win_ntuser_private_l1_3_1_dll @ 0x18004E8C5
 * Callers:
 *     __imp_load_GetSystemMetricsForDpi @ 0x18004E8B9 (__imp_load_GetSystemMetricsForDpi.c)
 * Callees:
