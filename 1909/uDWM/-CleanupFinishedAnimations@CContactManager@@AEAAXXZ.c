/*
 * XREFs of ?CleanupFinishedAnimations@CContactManager@@AEAAXXZ @ 0x1800962C8
 * Callers:
 ...
 *     ?IsOKToCleanup@CFlickVisual@@UEAA_NXZ @ 0x180096B20 (-IsOKToCleanup@CFlickVisual@@UEAA_NXZ.c)
 *     ?RemoveAt@?$DynArray@UCStationaryAnimation@@$0A@@@QEAAJI@Z @ 0x180099788 (-RemoveAt@-$DynArray@UCStationaryAnimation@@$0A@@@QEAAJI@Z.c)
 *     ?IsOKToCleanup@CContactStationaryVisual@@UEAA_NXZ @ 0x18009A310 (-IsOKToCleanup@CContactStationaryVisual@@UEAA_NXZ.c)
 *     ?IsOKToCleanup@CTouchPressHoldVisual@@UEAA_NXZ @ 0x1800B0A10 (-IsOKToCleanup@CTouchPressHoldVisual@@UEAA_NXZ.c)
 */
