/*
 * XREFs of ?_UpdateResourcesForMonitorHelper@CLivePreview@@AEAAJPEBVCTopLevelWindow@@PEAULivePreviewResource@@@Z @ 0x18007DB1C
 * Callers:
 ...
 *     ?CreateRoundRectRgnCoerceInvalid@@YAPEAUHRGN__@@HHHHHH@Z @ 0x18007A784 (-CreateRoundRectRgnCoerceInvalid@@YAPEAUHRGN__@@HHHHHH@Z.c)
 *     ?GetCornerRadius@CTopLevelWindow@@QEBAHXZ @ 0x18008D084 (-GetCornerRadius@CTopLevelWindow@@QEBAHXZ.c)
 *     ?GetLivePreviewWindowRect@CTopLevelWindow@@QEBA?AUtagRECT@@_N@Z @ 0x18008D2C0 (-GetLivePreviewWindowRect@CTopLevelWindow@@QEBA-AUtagRECT@@_N@Z.c)
        ...
        struct LivePreviewResource *a3)
{
  ...
  if ( v6 && *(char *)(*((_QWORD *)a2 + 90) + 606LL) >= 0 )
    UnionRect((LPRECT)a3, (const RECT *)a3, &rcDst);
  v7 = *((_QWORD *)a2 + 90);
  if ( (*(_BYTE *)(v7 + 606) & 0x40) == 0 && *(_DWORD *)(v7 + 112) == 1 )
  {
    if ( v6 )
...
LABEL_17:
        ...
        if ( UnionRect(&rc1, &rcSrc2, &rcDst) && !EqualRect(&rc1, &rcDst) )
        {
          ...
          if ( !v23 )
          {
            ...
            MilInstrumentationCheckHR_MaybeFailFast(0x14u, 0LL, 0LL, v5, 0x4D6u);
            return (unsigned int)v5;
          }
          SetLastError(0);
