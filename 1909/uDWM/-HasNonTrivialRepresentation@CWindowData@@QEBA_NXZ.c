/*
 * XREFs of ?HasNonTrivialRepresentation@CWindowData@@QEBA_NXZ @ 0x1800135E4
 * Callers:
 ...
 *     ?IsSplashScreen@CWindowData@@QEBA_NXZ @ 0x18003BBF4 (-IsSplashScreen@CWindowData@@QEBA_NXZ.c)
 */
