/*
 * XREFs of ?RecordCachedUsageUnderLock@EnabledStateManager@details@wil@@AEAAXXZ @ 0x18003523C
 * Callers:
 *     ?OnTimer@EnabledStateManager@details@wil@@QEAAXXZ @ 0x180033F9C (-OnTimer@EnabledStateManager@details@wil@@QEAAXXZ.c)
  ...
  if ( v6 )
  {
    ...
    while ( v4 != v7 )
    {
      ...
      wil_details_ModifyFeatureData(
        v8,
        (__int64 (__fastcall *)(signed __int32 *, void *))lambda_13f119b44549d7aec2177494846f39c3_::_lambda_invoker_cdecl_,
        v12);
      v9 = (unsigned int *)v13;
      do
      {
