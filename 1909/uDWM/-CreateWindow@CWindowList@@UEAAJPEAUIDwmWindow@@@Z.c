/*
 * XREFs of ?CreateWindow@CWindowList@@UEAAJPEAUIDwmWindow@@@Z @ 0x18008FBF0
 * Callers:
 *     <none>
 * Callees:
 ...
 *     ?IsKernelDebuggerPresent@@YAHXZ @ 0x1800B75D8 (-IsKernelDebuggerPresent@@YAHXZ.c)
 */
...
LABEL_26:
  ...
  {
    v3 = -2147024882;
    MilInstrumentationCheckHR_MaybeFailFast(0x14u, 0LL, 0LL, -2147024882, 0x7FBu);
  }
