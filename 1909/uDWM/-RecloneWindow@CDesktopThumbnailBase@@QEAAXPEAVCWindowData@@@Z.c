/*
 * XREFs of ?RecloneWindow@CDesktopThumbnailBase@@QEAAXPEAVCWindowData@@@Z @ 0x1800AF420
 * Callers:
 ...
 *     ?_GetIndex@CDesktopThumbnailBase@@IEAAHPEBVCTopLevelWindow@@@Z @ 0x1800AFEB0 (-_GetIndex@CDesktopThumbnailBase@@IEAAHPEBVCTopLevelWindow@@@Z.c)
 */
...
void __fastcall CDesktopThumbnailBase::RecloneWindow(CDesktopThumbnailBase *this, struct CWindowData *a2)
{
  ...
  __int64 v12; // rsi
  struct CTopLevelWindow *v13; // rdi
  __int64 v14; // rax
  struct CTopLevelWindow *v15; // [rsp+48h] [rbp+10h] BYREF

  v15 = 0LL;
  v3 = (const struct CTopLevelWindow *)*((_QWORD *)a2 + 50);
  if ( v3 )
  {
    ...
    if ( Index >= 0 )
    {
      ...
      v10 = CTopLevelWindow::CloneVisualTreeForLivePreview(*((CTopLevelWindow **)a2 + 50), 0, v8, v9, &v15);
      if ( v10 >= 0 )
      {
        v12 = v7;
        v13 = v15;
        ...
        VisualCollection::Remove(
          ...
          *(struct CVisual **)(*((_QWORD *)this + 30) + 8 * v12 + 8));
        v14 = *((_QWORD *)this + 30);
        v11 = *(struct CTopLevelWindow **)(v14 + 8 * v12 + 8);
