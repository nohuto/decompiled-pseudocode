/*
 * XREFs of ?OnSetRenderTargetTextures@CMagnifier@@QEAAJPEBUMAGN_ADAPTERTEXTURES@@@Z @ 0x180083DC8
 * Callers:
...
__int64 __fastcall CMagnifier::OnSetRenderTargetTextures(CMagnifier *this, const struct MAGN_ADAPTERTEXTURES *a2)
{
  ...
  if ( *(_DWORD *)a2 <= v5 )
  {
    ...
    *((_DWORD *)this + 43) = *((_DWORD *)a2 + 2);
    ...
    v13 = v25;
    if ( v25 < 0 )
      MilInstrumentationCheckHR_MaybeFailFast(0x14u, 0LL, 0LL, v25, 0x195u);
  }
  else
  {
    if ( v5 )
    {
      ...
      if ( v12 < 0 )
      {
        MilInstrumentationCheckHR_MaybeFailFast(0x14u, 0LL, 0LL, v12, 0x163u);
        return v13;
      }
      ...
      if ( v14 < 0 )
      {
        MilInstrumentationCheckHR_MaybeFailFast(0x14u, 0LL, 0LL, v14, 0x165u);
        return v13;
      }
      v15 = CMagnifierRenderTargetProxy::SetColorTransform(*((CMagnifierRenderTargetProxy **)this + 3), 0);
      v13 = v15;
      if ( v15 < 0 )
      {
        MilInstrumentationCheckHR_MaybeFailFast(0x14u, 0LL, 0LL, v15, 0x167u);
        return v13;
      }
      ...
      *((_DWORD *)this + 42) = 0;
      ...
      if ( v17 < 0 )
      {
        MilInstrumentationCheckHR_MaybeFailFast(0x14u, 0LL, 0LL, v17, 0x16Cu);
        return v13;
      }
      ...
      if ( v18 < 0 )
      {
        MilInstrumentationCheckHR_MaybeFailFast(0x14u, 0LL, 0LL, v18, 0x16Du);
        return v13;
      }
      v4 = *(_DWORD *)a2;
    }
    ...
    *((_DWORD *)this + 43) = *((_DWORD *)a2 + 2);
    ...
    v13 = v21;
    if ( v21 < 0 )
      MilInstrumentationCheckHR_MaybeFailFast(0x14u, 0LL, 0LL, v21, 0x17Fu);
  }
  return v13;
}
