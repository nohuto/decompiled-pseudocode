/*
 * XREFs of ?StartActivity@UpdateWindowCapture@WindowFrameLoggingTelemetry@@QEAAXPEAUHWND__@@II@Z @ 0x180086CB4
 * Callers:
 ...
 *     ?zInternalStart@?$ActivityBase@VWindowFrameLogging@@$00$0CAAAAAAAAAAA@$04$0A@U_TlgReflectorTag_Param0IsProviderType@@@wil@@QEAAXXZ @ 0x18008A76C (-zInternalStart@-$ActivityBase@VWindowFrameLogging@@$00$0CAAAAAAAAAAA@$04$0A@U_TlgReflectorTag_P.c)
 */
        ...
        int a4)
{
  ...
  HWND v12; // [rsp+40h] [rbp-41h] BYREF
    ...
    && (*((_QWORD *)v8 + 3) & 0x200000000000LL) == *((_QWORD *)v8 + 3) )
  {
    ...
    TlgWrite(v8, &unk_1800C8046, (LPCGUID)(*((_QWORD *)this + 6) + 8LL), v10, 7u, &pData);
  }
  if ( !*((_DWORD *)this + 8) )
