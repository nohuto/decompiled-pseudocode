/*
 * XREFs of ?Create@CMagnifier@@SAJPEAUHWND__@@HPEAVCVisual@@PEAPEAV1@@Z @ 0x1800835B4
 * Callers:
 ...
 *     ??0CMagnifier@@AEAA@PEAUHWND__@@HPEAVCVisual@@@Z @ 0x18008344C (--0CMagnifier@@AEAA@PEAUHWND__@@HPEAVCVisual@@@Z.c)
