/*
 * XREFs of ??$CreateProxy@VCImageLegacyMilBrushProxy@@@CCompositor@@IEAAJPEAPEAVCImageLegacyMilBrushProxy@@@Z @ 0x18003D31C
 * Callers:
...
__int64 __fastcall CCompositor::CreateProxy<CImageLegacyMilBrushProxy>(__int64 a1, __int64 *a2)
{
  __int64 v4; // rax
  __int64 v5; // rbx
  int v6; // eax
  ...
  *a2 = 0LL;
  ...
  if ( v5 )
  {
    ...
    v6 = CResource::Create(0x11u, *(_QWORD *)(a1 + 16), (__int64 *)(v5 + 16));
    v7 = v6;
    if ( v6 < 0 )
      MilInstrumentationCheckHR_MaybeFailFast(0x14u, 0LL, 0, v6, 0x34u, v9);
    else
      v7 = 0;
    if ( v7 < 0 )
    {
