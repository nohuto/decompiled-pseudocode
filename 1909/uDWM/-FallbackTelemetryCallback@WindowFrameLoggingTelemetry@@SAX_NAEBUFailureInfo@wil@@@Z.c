/*
 * XREFs of ?FallbackTelemetryCallback@WindowFrameLoggingTelemetry@@SAX_NAEBUFailureInfo@wil@@@Z @ 0x180085390
 * Callers:
 *     <none>
 * Callees:
 *     atexit @ 0x18004E32C (atexit.c)
 *     ?OnErrorReported@TraceLoggingProvider@wil@@MEAAX_NAEBUFailureInfo@2@@Z @ 0x180079950 (-OnErrorReported@TraceLoggingProvider@wil@@MEAAX_NAEBUFailureInfo@2@@Z.c)
...
void __fastcall WindowFrameLoggingTelemetry::FallbackTelemetryCallback(char a1, const struct wil::FailureInfo *a2)
{
  ...
  if ( InitOnceBeginInitialize(&`WindowFrameLoggingTelemetry::Instance'::`2'::wrapper, 0, &v6, (LPVOID *)&v7) && v6 )
  {
    ...
    v7 = (wil::TraceLoggingProvider *)&qword_1800DEA48;
    qword_1800DEA48 = (__int64)&WindowFrameLogging::`vftable';
