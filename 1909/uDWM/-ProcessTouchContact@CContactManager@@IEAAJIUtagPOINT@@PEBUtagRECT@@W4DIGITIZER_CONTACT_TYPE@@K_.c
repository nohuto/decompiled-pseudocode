/*
 * XREFs of ?ProcessTouchContact@CContactManager@@IEAAJIUtagPOINT@@PEBUtagRECT@@W4DIGITIZER_CONTACT_TYPE@@K_K@Z @ 0x180098B60
 * Callers:
 ...
 *     ?CheckShowContact@CContactManager@@AEAA_NW4DWM_SHOWCONTACT@@0@Z @ 0x1800962A4 (-CheckShowContact@CContactManager@@AEAA_NW4DWM_SHOWCONTACT@@0@Z.c)
 ...
 *     ?IsOKToCleanup@CPressTapVisual@@UEAA_NXZ @ 0x180096B40 (-IsOKToCleanup@CPressTapVisual@@UEAA_NXZ.c)
 ...
 *     ?IsInInitialDelay@CDirectTouchVisual@@QEBA_NXZ @ 0x180099C90 (-IsInInitialDelay@CDirectTouchVisual@@QEBA_NXZ.c)
 ...
 *     ?IsHolding@CTouchPressHoldVisual@@QEAA_NXZ @ 0x1800B09E0 (-IsHolding@CTouchPressHoldVisual@@QEAA_NXZ.c)
