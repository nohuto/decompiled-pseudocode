/*
 * XREFs of ?GetScalingFactorForCVI@CDesktopManager@@QEBAMAEBUtagRECT@@@Z @ 0x180009AE0
 * Callers:
 ...
 *     ?_IsSameAsTargetCachedCVI@CDesktopManager@@CA_NHH@Z @ 0x18003BF40 (-_IsSameAsTargetCachedCVI@CDesktopManager@@CA_NHH@Z.c)
