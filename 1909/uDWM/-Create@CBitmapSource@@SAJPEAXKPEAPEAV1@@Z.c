/*
 * XREFs of ?Create@CBitmapSource@@SAJPEAXKPEAPEAV1@@Z @ 0x1800467D4
 * Callers:
...
__int64 __fastcall CBitmapSource::Create(void *a1, unsigned int a2, struct CBitmapSource **a3)
{
  ...
  enum DXGI_FORMAT v18; // [rsp+28h] [rbp-30h]
  enum DXGI_ALPHA_MODE v19; // [rsp+30h] [rbp-28h]
  struct IBitmapSource *v20[3]; // [rsp+40h] [rbp-18h] BYREF
  wil::details::in1diag3 *retaddr; // [rsp+58h] [rbp+0h]
  struct IWICBitmap *v22; // [rsp+78h] [rbp+20h] BYREF
...
LABEL_16:
  ...
  v8 = (**(__int64 (__fastcall ***)(struct IBitmapSource *, GUID *, struct IWICBitmap **))v20[0])(
         v20[0],
  ...
  *(_DWORD *)(v9 + 92) = 0x80000000;
  v12 = CBitmapSource::Initialize((CBaseObject **)v9);
  v7 = v12;
  if ( v12 < 0 )
  {
    v16 = 91LL;
  ...
  {
    v12 = CBitmapSource::Update(v10, v22);
    v7 = v12;
    if ( v12 >= 0 )
    {
      v11 = 0LL;
