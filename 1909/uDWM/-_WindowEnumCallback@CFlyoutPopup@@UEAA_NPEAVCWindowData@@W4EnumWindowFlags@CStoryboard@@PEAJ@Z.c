/*
 * XREFs of ?_WindowEnumCallback@CFlyoutPopup@@UEAA_NPEAVCWindowData@@W4EnumWindowFlags@CStoryboard@@PEAJ@Z @ 0x180002930
 * Callers:
 ...
 *     ?GetWindowEndCloak@CWindowPropertyTracker@@QEAAJPEAUHWND__@@PEA_N@Z @ 0x180032E34 (-GetWindowEndCloak@CWindowPropertyTracker@@QEAAJPEAUHWND__@@PEA_N@Z.c)
...
char __fastcall CFlyoutPopup::_WindowEnumCallback(CStoryboard *a1, __int64 a2, char a3, int *a4)
{
  ...
  if ( v11 >= 0 )
  {
    ...
    if ( WindowEndCloak >= 0 )
    {
      ...
      v19 = *(_DWORD *)(a2 + 612);
      if ( (v19 & 0x1000000) != 0 )
        rc = *(struct tagRECT *)(a2 + 632);
      if ( (v19 & 0x800000) != 0 )
        v40 = *(struct tagRECT *)(a2 + 664);
      CAnimatedTransitionVisual::SetBeginRect(*((CAnimatedTransitionVisual **)v12 + 5), &rc);
      v20 = *((_QWORD *)v12 + 5);
      *(struct tagRECT *)(v20 + 872) = v40;
