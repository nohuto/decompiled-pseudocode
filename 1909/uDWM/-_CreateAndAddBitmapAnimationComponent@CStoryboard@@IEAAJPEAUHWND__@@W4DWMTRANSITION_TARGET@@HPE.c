/*
 * XREFs of ?_CreateAndAddBitmapAnimationComponent@CStoryboard@@IEAAJPEAUHWND__@@W4DWMTRANSITION_TARGET@@HPEAPEAVCAnimationComponent@@@Z @ 0x1800A98D8
 * Callers:
        ...
        volatile signed __int32 **a5)
{
  ...
  if ( BitmapAnimationComponent >= 0 )
  {
    ...
    if ( v9 < 0 )
    {
      MilInstrumentationCheckHR_MaybeFailFast(0x14u, &CStoryboard::MILINSTRUMENTATIONHRESULTLIST, 1LL, v9, 0x1534u);
      goto LABEL_8;
    }
    *a5 = v8;
    if ( !v8 )
