/*
 * XREFs of ?QueryInterface@GaussianBlurEffect@Effects@Composition@UI@Microsoft@@UEAAJAEBU_GUID@@PEAPEAX@Z @ 0x18003DB50
 * Callers:
 *     ?QueryInterface@GaussianBlurEffect@Effects@Composition@UI@Microsoft@@W7EAAJAEBU_GUID@@PEAPEAX@Z @ 0x18004FFD0 (-QueryInterface@GaussianBlurEffect@Effects@Composition@UI@Microsoft@@W7EAAJAEBU_GUID@@PEAPEAX@Z.c)
 *     ?QueryInterface@GaussianBlurEffect@Effects@Composition@UI@Microsoft@@WBA@EAAJAEBU_GUID@@PEAPEAX@Z @ 0x18004FFE0 (-QueryInterface@GaussianBlurEffect@Effects@Composition@UI@Microsoft@@WBA@EAAJAEBU_GUID@@PEAPEAX@.c)
 *     ?QueryInterface@GaussianBlurEffect@Effects@Composition@UI@Microsoft@@WBI@EAAJAEBU_GUID@@PEAPEAX@Z @ 0x18004FFF0 (-QueryInterface@GaussianBlurEffect@Effects@Composition@UI@Microsoft@@WBI@EAAJAEBU_GUID@@PEAPEAX@.c)
 *     ?QueryInterface@GaussianBlurEffect@Effects@Composition@UI@Microsoft@@WCA@EAAJAEBU_GUID@@PEAPEAX@Z @ 0x180050000 (-QueryInterface@GaussianBlurEffect@Effects@Composition@UI@Microsoft@@WCA@EAAJAEBU_GUID@@PEAPEAX@.c)
 * Callees:
