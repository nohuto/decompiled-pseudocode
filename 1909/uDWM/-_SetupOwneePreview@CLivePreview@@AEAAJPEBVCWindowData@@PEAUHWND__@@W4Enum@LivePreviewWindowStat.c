/*
 * XREFs of ?_SetupOwneePreview@CLivePreview@@AEAAJPEBVCWindowData@@PEAUHWND__@@W4Enum@LivePreviewWindowState@@@Z @ 0x18007C9B0
 * Callers:
...
__int64 __fastcall CLivePreview::_SetupOwneePreview(__int64 a1, __int64 a2, __int64 a3, __int64 a4)
{
  ...
  if ( *(_DWORD *)(a2 + 584) )
  {
    while ( 1 )
    {
      v10 = *(_QWORD *)(*(_QWORD *)(a2 + 560) + 8 * v5);
      if ( (*(_BYTE *)(v10 + 606) & 0x20) == 0 && ((*(_BYTE *)(v10 + 604) & 1) != 0 || *(_QWORD *)(v10 + 432)) )
      {
        LOBYTE(v13) = 1;
        LOBYTE(a4) = 1;
      ...
      if ( (unsigned int)v5 >= *(_DWORD *)(a2 + 584) )
        return v4;
    }
    MilInstrumentationCheckHR_MaybeFailFast(0x14u, 0LL, 0LL, v11, 0x16Bu);
  }
  return v4;
}
