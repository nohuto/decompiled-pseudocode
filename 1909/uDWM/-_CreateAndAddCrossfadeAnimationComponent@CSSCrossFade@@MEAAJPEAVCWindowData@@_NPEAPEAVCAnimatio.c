/*
 * XREFs of ?_CreateAndAddCrossfadeAnimationComponent@CSSCrossFade@@MEAAJPEAVCWindowData@@_NPEAPEAVCAnimationComponent@@@Z @ 0x1800A9A20
 * Callers:
 *     <none>
 * Callees:
        ...
        struct CAnimationComponent **a4)
{
  ...
  if ( (_BYTE)a3 )
  {
    *((_DWORD *)a2 + 153) |= 0x200000u;
  }
  else if ( (*((_DWORD *)a2 + 153) & 0x10000000) == 0
