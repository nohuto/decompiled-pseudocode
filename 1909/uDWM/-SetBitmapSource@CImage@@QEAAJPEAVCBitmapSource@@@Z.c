/*
 * XREFs of ?SetBitmapSource@CImage@@QEAAJPEAVCBitmapSource@@@Z @ 0x18003DCF4
 * Callers:
 ...
 *     ?UpdateTransition@CPenPressHoldVisual@@MEAAJXZ @ 0x18009F230 (-UpdateTransition@CPenPressHoldVisual@@MEAAJXZ.c)
