/*
 * XREFs of ?GetNCAreaHorizontalStripHelper@CTopLevelWindow@@CAJPEAXHHW4NCAreaPart@1@11PEAUWindowFrame@1@2@Z @ 0x1800473EC
 * Callers:
    ...
    else
    {
      ...
      while ( 2 )
      {
        ...
        do
        {
          ...
          if ( v24 < 0 )
          {
            MilInstrumentationCheckHR_MaybeFailFast(0x14u, &dword_1800DC078, 1u, v24, 0x54Eu, v27);
            return v25;
          }
          ++v22;
          ++v21;
