/*
 * XREFs of ?Create@CStoryboardFactory@@SAJHPEAVCStoryboard@@PEAPEAV2@@Z @ 0x18002ECF4
 * Callers:
 ...
 * Callees:
 *     ??0CLauncherAnimationBase@@IEAA@XZ @ 0x180001758 (--0CLauncherAnimationBase@@IEAA@XZ.c)
 ...
 *     ??0CSlideIn@@QEAA@XZ @ 0x18003B768 (--0CSlideIn@@QEAA@XZ.c)
 *     ??0CSlideOut@@QEAA@XZ @ 0x18003B794 (--0CSlideOut@@QEAA@XZ.c)
 ...
 *     ??0CAppArrangementBase@@IEAA@_N@Z @ 0x1800A6E58 (--0CAppArrangementBase@@IEAA@_N@Z.c)
 *     ??0CCrossFade@@QEAA@XZ @ 0x1800A6EA4 (--0CCrossFade@@QEAA@XZ.c)
 *     ??0CFadeOut@@QEAA@XZ @ 0x1800A6ED4 (--0CFadeOut@@QEAA@XZ.c)
 *     ??0CLaunchSwitchBase@@QEAA@XZ @ 0x1800A6F48 (--0CLaunchSwitchBase@@QEAA@XZ.c)
 *     ??0CPanelAnimation@@QEAA@XZ @ 0x1800A6F88 (--0CPanelAnimation@@QEAA@XZ.c)
...
__int64 __fastcall CStoryboardFactory::Create(int a1, struct CStoryboard *a2, struct CStoryboard **a3)
{
  ...
  int v17; // ebx
  int v19; // ecx
  CLauncherAnimationBase *v20; // rax
  CStoryboard *v21; // rax
  CStoryboard *v22; // rax
  int v23; // ecx
  int v24; // ecx
  ...
  if ( a1 <= 66 )
  {
    ...
    if ( a1 > 19 )
    {
      ...
      if ( v5 )
      {
        ...
        if ( !v6 )
        {
          v21 = (CStoryboard *)(*(__int64 (__fastcall **)(WPF::HeapBase *, __int64))(*(_QWORD *)WPF::g_pProcessHeap + 8LL))(
                                 WPF::g_pProcessHeap,
                                 120LL);
          v9 = v21;
          if ( v21 )
          {
            CStoryboard::CStoryboard(v21, 0);
...
LABEL_16:
        ...
        if ( !v19 )
        {
          v20 = (CLauncherAnimationBase *)(*(__int64 (__fastcall **)(WPF::HeapBase *, __int64))(*(_QWORD *)WPF::g_pProcessHeap
                                                                                              + 8LL))(
                                            WPF::g_pProcessHeap,
                                            144LL);
          v9 = v20;
...
LABEL_97:
  ...
  if ( !v14 )
  {
    v15 = (CSlideOut *)(*(__int64 (__fastcall **)(WPF::HeapBase *, __int64))(*(_QWORD *)WPF::g_pProcessHeap + 8LL))(
                         WPF::g_pProcessHeap,
                         136LL);
    v9 = v15;
    if ( !v15 )
      goto LABEL_36;
    CSlideOut::CSlideOut(v15);
    v10 = &CSlide::`vftable'{for `IAnimationListener'};
...
LABEL_17:
  *a3 = v9;
  ...
  {
    v17 = -2147024882;
    MilInstrumentationCheckHR_MaybeFailFast(0x14u, 0LL, 0, -2147024882, 0x1865u, v73);
LABEL_120:
    if ( *a3 )
    {
  ...
  v16 = (*(__int64 (__fastcall **)(CStoryboard *))(*(_QWORD *)v9 + 8LL))(v9);
  v17 = v16;
  if ( v16 < 0 )
  {
    MilInstrumentationCheckHR_MaybeFailFast(0x14u, 0LL, 0, v16, 0x1867u, v73);
  }
  else if ( a2 )
  {
