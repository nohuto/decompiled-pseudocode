/*
 * XREFs of ?UpdatePinnedParts@CTopLevelWindow@@AEAAJXZ @ 0x1800203F0
 * Callers:
...
__int64 __fastcall CTopLevelWindow::UpdatePinnedParts(CTopLevelWindow *this)
{
  ...
  *(_OWORD *)((char *)this + 652) = v54;
  ...
  do
  {
    ...
    if ( *(_QWORD *)v33 )
    {
      ...
      if ( v40 != 0x7FFFFFFF )
      {
        ...
        if ( *(_DWORD *)(*(_QWORD *)v33 + 28LL) != v40 )
        {
          *(_DWORD *)(v41 + 96) |= 1u;
          *(_QWORD *)(v41 + 24) = v50;
          v42 = *(_QWORD *)(v41 + 80);
          if ( v42 )
            (*(void (__fastcall **)(__int64, __int64))(*(_QWORD *)v42 + 24LL))(v42, 0x2000LL);
        }
      }
    }
    v33 += 8;
  ...
  while ( v35 );
  (*(void (__fastcall **)(_QWORD, __int64))(**((_QWORD **)this + 34) + 24LL))(*((_QWORD *)this + 34), 4096LL);
  return 0LL;
}
