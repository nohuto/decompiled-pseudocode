/*
 * XREFs of ?Lock@CWICBitmapWrapper@@UEAAJPEBUWICRect@@W4WICBitmapLockFlags@@PEAPEAVIBitmapLock@@@Z @ 0x1800482F0
 * Callers:
 *     <none>
 * Callees:
 ...
 *     ?GetPixelFormatSize@@YAEW4DXGI_FORMAT@@@Z @ 0x1800487C0 (-GetPixelFormatSize@@YAEW4DXGI_FORMAT@@@Z.c)
        ...
        struct IBitmapLock **a4)
{
  ...
  *a4 = 0LL;
  (***((void (__fastcall ****)(_QWORD, GUID *, __int64 *))this + 27))(*((_QWORD *)this + 27), &IID_IWICBitmap, &v36);
  if ( v36 )
  {
  ...
  else
  {
    ...
    {
      v10 = -2003292412;
      MilInstrumentationCheckHR_MaybeFailFast(0x14u, 0LL, 0, -2003292412, 0x84u, v29);
      goto LABEL_56;
    }
    ...
    if ( a2 )
    {
      ...
      {
        MilInstrumentationCheckHR_MaybeFailFast(0x14u, 0LL, 0, -2147024809, 0xBAu, v29);
      }
      else
      {
        ...
        *(__m128i *)v40 = *a2;
        ...
        if ( v16 <= 0 || v18 <= 0 )
          MilInstrumentationCheckHR_MaybeFailFast(0x14u, 0LL, 0, -2147024809, 0xB2u, v29);
      }
    }
    else
    {
      v19 = *((_DWORD *)this + 41);
      v40[2] = *((_DWORD *)this + 40);
      v40[3] = v19;
    }
      ...
      if ( v23 <= 0xFFFFFFFF )
      {
        ...
        if ( v24 )
        {
          ...
          if ( v26 >= 0 )
          {
            ...
            v10 = v27;
            if ( v27 < 0 )
              MilInstrumentationCheckHR_MaybeFailFast(0x14u, 0LL, 0, v27, 0xDBu, v30);
            else
              v25 = 0LL;
          }
          else
          {
            MilInstrumentationCheckHR_MaybeFailFast(0x14u, 0LL, 0, v26, 0xD1u, v29);
          }
          if ( v25 )
        ...
        {
          v10 = -2147024882;
          MilInstrumentationCheckHR_MaybeFailFast(0x14u, 0LL, 0, -2147024882, 0xCCu, v29);
        }
        goto LABEL_56;
      }
      v28 = 201;
  ...
  MilInstrumentationCheckHR_MaybeFailFast(0x14u, 0LL, 0, v12, v28, v29);
LABEL_56:
  if ( v31 )
...
LABEL_10:
  ...
  CGuard<CMTALock>::~CGuard<CMTALock>(&v39);
  return v10;
}
