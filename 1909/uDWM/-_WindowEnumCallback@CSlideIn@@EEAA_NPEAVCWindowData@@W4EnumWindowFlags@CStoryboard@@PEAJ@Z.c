/*
 * XREFs of ?_WindowEnumCallback@CSlideIn@@EEAA_NPEAVCWindowData@@W4EnumWindowFlags@CStoryboard@@PEAJ@Z @ 0x180033250
 * Callers:
 *     <none>
 * Callees:
 ...
 *     ?GetWindowEndSize@CWindowPropertyTracker@@QEAAJPEAUHWND__@@PEAUtagSIZE@@@Z @ 0x180032DA4 (-GetWindowEndSize@CWindowPropertyTracker@@QEAAJPEAUHWND__@@PEAUtagSIZE@@@Z.c)
 ...
 *     ?SetChopPosition@CAnimatedTransitionVisual@@QEAAXPEBN0I@Z @ 0x1800A0458 (-SetChopPosition@CAnimatedTransitionVisual@@QEAAXPEBN0I@Z.c)
      ...
      *(double *)&v46 = 0.0;
      ...
      else
      {
        ...
        *(_BYTE *)(*((_QWORD *)v45 + 5) + 976LL) = 1;
        ...
        v16 = CStoryboard::_CreateAndAddBlurBehindComponent(a1, (__m128i *)a2, v15, &v47);
        v4 = v16;
        if ( v16 < 0 )
        {
          MilInstrumentationCheckHR_MaybeFailFast(
