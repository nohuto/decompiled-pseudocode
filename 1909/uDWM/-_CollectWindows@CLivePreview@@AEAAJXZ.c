/*
 * XREFs of ?_CollectWindows@CLivePreview@@AEAAJXZ @ 0x18007B77C
 * Callers:
  ...
  while ( 1 )
  {
    ...
    *(_BYTE *)(Blink + 606) &= 0x3Fu;
    ...
    if ( !IsTrulyMaximized )
    {
      ...
      {
        v14 = 0;
        v15 = (const wchar_t **)off_1800C0610;
...
LABEL_20:
      ...
      {
LABEL_28:
        v13 = *(_BYTE *)(Blink + 606) & 0xBF | (v16 << 6);
        *(_BYTE *)(Blink + 606) = v13;
        goto LABEL_29;
      }
LABEL_27:
        ...
        else
        {
          ...
          *((_DWORD *)this + 143) = v19 + 1;
          if ( *((_DWORD *)this + 82) )
          {
            ...
            --*((_DWORD *)this + 143);
            *(_BYTE *)(Blink + 606) |= 0x80u;
          }
LABEL_41:
          v18 = *(_BYTE *)(Blink + 606);
        }
      }
      if ( (v18 & 0x40) == 0 && ((*(_DWORD *)(Blink + 112) - 8) & 0xFFFFFFFD) == 0 )
      {
        v22 = 0LL;
        if ( !v5 )
          goto LABEL_50;
...
LABEL_50:
          ...
          if ( v5 + 1 >= v5 )
          {
            if ( v23 > v33 )
            {
              v25 = DynArrayImpl<0>::AddMultipleAndSet((__int64)&v31[1], 8, 1, v31);
              if ( v25 < 0 )
...
LABEL_58:
    ...
    *(_OWORD *)&v35.m256i_u64[1] = 0LL;
    ...
    {
      v29 = DynArrayImpl<0>::AddMultipleAndSet((__int64)this + 304, 40, 1, &v35);
      v2 = v29;
      if ( v29 < 0 )
