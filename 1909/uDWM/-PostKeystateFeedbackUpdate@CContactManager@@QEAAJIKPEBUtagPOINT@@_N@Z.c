/*
 * XREFs of ?PostKeystateFeedbackUpdate@CContactManager@@QEAAJIKPEBUtagPOINT@@_N@Z @ 0x180098828
 * Callers:
  ...
  if ( a5 )
  {
    ...
    *(_QWORD *)&v19 = __PAIR64__(a3, v5);
    ...
    if ( (int)v11 + 1 >= (unsigned int)v11 )
    {
      ...
      {
        v17 = DynArrayImpl<0>::AddMultipleAndSet((__int64)this + 216, 40, 1, &v19);
        if ( v17 < 0 )
