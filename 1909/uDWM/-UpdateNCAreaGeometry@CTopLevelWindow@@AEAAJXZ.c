/*
 * XREFs of ?UpdateNCAreaGeometry@CTopLevelWindow@@AEAAJXZ @ 0x180035750
 * Callers:
...
LABEL_18:
  ...
  if ( RoundRectRgn )
  {
    ...
    if ( v34 < 0 )
    {
      MilInstrumentationCheckHR_MaybeFailFast(0x14u, &dword_1800C3FB0, 0xBu, v34, 0x125Bu, h);
      goto LABEL_68;
    }
    ...
    if ( v36 < 0 )
    {
      MilInstrumentationCheckHR_MaybeFailFast(0x14u, &dword_1800C3FB0, 0xBu, v36, 0x1261u, h);
      goto LABEL_97;
    }
    SetLastError(0);
    v37 = hrgnDst;
...
LABEL_61:
      ...
      if ( !RectRgn )
      {
        ...
        MilInstrumentationCheckHR_MaybeFailFast(0x14u, &dword_1800C3FB0, 0xBu, v35, 0x1270u, h);
LABEL_122:
        if ( v37 )
LABEL_67:
          DeleteObject(v37);
...
LABEL_121:
        MilInstrumentationCheckHR_MaybeFailFast(0x14u, &dword_1800C3FB0, 0xBu, v51, w, h);
        goto LABEL_122;
      }
      MilInstrumentationCheckHR_MaybeFailFast(0x14u, &dword_1800C3FB0, 0xBu, v44, 0x1278u, h);
LABEL_97:
      v37 = hrgnDst;
      goto LABEL_122;
    }
  ...
  MilInstrumentationCheckHR_MaybeFailFast(0x14u, &dword_1800C3FB0, 0xBu, v35, 0x1259u, h);
  return (unsigned int)v35;
}
