/*
 * XREFs of ?BitmapReceived@CImmersiveIconicBitmapRegistry@@QEAAJPEAVCWindowData@@KIIPEAX_K@Z @ 0x1800820A8
 * Callers:
        ...
        unsigned __int64 a7)
{
    ...
    && v12 )
  {
    ...
    {
      MilInstrumentationCheckHR_MaybeFailFast(0x14u, &dword_1800CABB0, 1LL, v16, 0x173u);
    }
    if ( v17 )
  ...
  else
  {
    if ( (Microsoft_Windows_Dwm_UdwmEnableBits & 1) != 0 )
      McTemplateU0qp(v11, (int)&UdwmManageIconicThumbnail_Info, 1, a2[5]);
    v18 = -2147024809;
    MilInstrumentationCheckHR_MaybeFailFast(0x14u, &dword_1800CABB0, 1LL, -2147024809, 0x16Fu);
  }
  return v18;
}
