/*
 * XREFs of ??$CreateProxy@VCRotateTransformProxy@@@CCompositor@@IEAAJPEAPEAVCRotateTransformProxy@@@Z @ 0x18003C984
 * Callers:
...
__int64 __fastcall CCompositor::CreateProxy<CRotateTransformProxy>(__int64 a1, __int64 *a2)
{
  __int64 v4; // rax
  __int64 v5; // rbx
  int v6; // eax
