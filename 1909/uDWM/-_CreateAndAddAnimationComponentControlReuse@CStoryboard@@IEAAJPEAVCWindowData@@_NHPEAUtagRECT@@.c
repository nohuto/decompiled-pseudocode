/*
 * XREFs of ?_CreateAndAddAnimationComponentControlReuse@CStoryboard@@IEAAJPEAVCWindowData@@_NHPEAUtagRECT@@2H1PEAPEAVCAnimationComponent@@@Z @ 0x18002E918
 * Callers:
        ...
        struct CAnimationComponent **a9)
{
  ...
  CBaseObject *v20; // [rsp+78h] [rbp+10h] BYREF
  ...
  if ( ((*(__int64 (__fastcall **)(CStoryboard *, _QWORD))(*(_QWORD *)this + 120LL))(
          this,
          *((_DWORD *)a2 + 153) & 0xFFF) & 4) != 0 )
    *((_DWORD *)a2 + 153) |= 0x4000000u;
  ...
  if ( v13 < 0 )
  {
    MilInstrumentationCheckHR_MaybeFailFast(0x14u, &CStoryboard::MILINSTRUMENTATIONHRESULTLIST, 1u, v13, 0x14ECu, v19);
LABEL_8:
    v15 = (volatile signed __int32 *)v20;
    goto LABEL_9;
  }
  v15 = (volatile signed __int32 *)v20;
  v16 = CStoryboard::_AddAnimationComponent(this, v20);
  v14 = v16;
  if ( v16 >= 0 )
  {
  ...
  MilInstrumentationCheckHR_MaybeFailFast(0x14u, &CStoryboard::MILINSTRUMENTATIONHRESULTLIST, 1u, v16, 0x14EDu, v19);
LABEL_9:
  if ( v15 )
