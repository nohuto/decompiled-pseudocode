/*
 * XREFs of ?ReportUsageToService@?$Feature@U__WilFeatureTraits_Feature_HolographicSecureDesktop@@@wil@@CAX_NW4ReportingKind@2@_K@Z @ 0x18003A7C0
 * Callers:
...
void __fastcall wil::Feature<__WilFeatureTraits_Feature_HolographicSecureDesktop>::ReportUsageToService(
        __int64 a1,
        __int64 a2,
        __int64 a3)
{
  ...
  if ( (`wil::Feature<__WilFeatureTraits_Feature_HolographicSecureDesktop>::GetFeaturePropertyCache'::`2'::data & 0x30) == 0 )
    wil::Feature<__WilFeatureTraits_Feature_HolographicSecureDesktop>::GetCachedFeatureEnabledState();
  LOBYTE(v3) = 1;
  v4 = 0;
  v5 = v3;
