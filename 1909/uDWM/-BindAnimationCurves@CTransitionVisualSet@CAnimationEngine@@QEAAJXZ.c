/*
 * XREFs of ?BindAnimationCurves@CTransitionVisualSet@CAnimationEngine@@QEAAJXZ @ 0x18003C044
 * Callers:
        ...
        CAnimationEngine::CTransitionVisualSet *this)
{
  ...
  if ( *((_DWORD *)this + 5) )
  {
    ...
    MilInstrumentationCheckHR_MaybeFailFast(0x14u, 0LL, 0, v6, 0x6CFu, v7);
  }
  return v1;
}
