/*
 * XREFs of ?_GetIdealWindowRect@CStoryboard@@KAXPEAVCWindowData@@_NPEBUtagRECT@@PEAU3@PEAPEAU3@@Z @ 0x180002C80
 * Callers:
        ...
        struct tagRECT **a5)
{
  ...
  v5 = 32 * (a2 ^ 1LL);
  v6 = (struct tagRECT *)((char *)a1 + v5 + 616);
  v10 = (char *)a1 + v5;
  if ( (((a2 + 1) << 23) & *((_DWORD *)a1 + 153)) != (a2 + 1) << 23 || IsRectEmpty((const RECT *)(v10 + 632)) )
  {
    if ( a3 )
      v11 = *a3;
    else
