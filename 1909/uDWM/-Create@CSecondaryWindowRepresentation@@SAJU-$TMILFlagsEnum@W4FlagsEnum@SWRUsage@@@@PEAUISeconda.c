/*
 * XREFs of ?Create@CSecondaryWindowRepresentation@@SAJU?$TMILFlagsEnum@W4FlagsEnum@SWRUsage@@@@PEAUISecondaryWindowRepresentationChangedListener@@PEAVCWindowData@@IW4DEVICE_SCALE_FACTOR@@PEAPEAV1@@Z @ 0x1800110E8
 * Callers:
 ...
 *     ??0CSecondaryWindowRepresentation@@IEAA@XZ @ 0x1800255F4 (--0CSecondaryWindowRepresentation@@IEAA@XZ.c)
