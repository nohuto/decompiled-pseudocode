/*
 * XREFs of ?_SlideWindowHorizontally@CSlide@@IEAAJPEAVCWindowData@@AEBUtagRECT@@_NPEBU3@PEAPEAVCAnimationComponent@@@Z @ 0x180030FBC
 * Callers:
        ...
        struct CAnimationComponent **a6)
{
  ...
  v32 = 0LL;
  v12 = v11(this, v7);
  v13 = CStoryboard::_CreateAndAddAnimationComponentControlReuse(this, a2, 1, v12, 0LL, 0LL, 0xFFFFFFFF, 1, &v32);
  v14 = v13;
  if ( v13 < 0 )
  {
