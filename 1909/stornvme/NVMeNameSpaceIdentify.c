/*
 * XREFs of NVMeNameSpaceIdentify @ 0x1C0016B28
 * Callers:
...
char __fastcall NVMeNameSpaceIdentify(__int64 a1)
{
  ...
  if ( v6 > 0xFF || (v4 = *(_DWORD *)(v1 + 516), v6) )
  {
    ...
    do
    {
      if ( !*(_BYTE *)(a1 + 16) || *(_DWORD *)(a1 + 184) == v7 )
      {
        v8 = *(void **)(a1 + 904);
        *(_BYTE *)(a1 + 819) = 0;
        ...
        *(_DWORD *)(a1 + 808) = 1;
        do
          *(_BYTE *)(*(_QWORD *)(a1 + 904) + 4253LL) |= ++v9;
        while ( v9 < 2 );
        *(_WORD *)(*(_QWORD *)(a1 + 904) + 4244LL) = 0;
        v10 = *(_QWORD *)(a1 + 904);
        *(_QWORD *)(v10 + 4120) = *(_QWORD *)(a1 + 1640);
        *(_BYTE *)(v10 + 4136) = v7 == 0;
        *(_BYTE *)(v10 + 4096) = 6;
        *(_DWORD *)(v10 + 4100) = v7;
        ...
        if ( *(_BYTE *)(a1 + 819) == 1 )
        {
            ...
            || *v2 )
          {
            if ( !v11 )
            {
              LOBYTE(v1) = StorPortExtendedFunction(0LL, a1, 104LL);
              break;
            }
            v12 = *(char **)(a1 + 1552);
            v15 = v12;
            *(_QWORD *)(a1 + 1552) = v12 + 104;
            ...
            *((_WORD *)v15 + 1) = 0;
            ...
            v15[10] = v7 - 1;
            *((_DWORD *)v15 + 4) = v7;
            *(_QWORD *)(a1 + 8LL * (unsigned int)(v7 - 1) + 1648) = v15;
            LOBYTE(v1) = v7;
            *(_DWORD *)(a1 + 192) = (unsigned __int16)v7;
          }
        }
        if ( *(_BYTE *)(a1 + 16) )
          break;
