/*
 * XREFs of NVMeLogTelemetryControllerInfo @ 0x1C000C56C
 * Callers:
...
__int64 __fastcall NVMeLogTelemetryControllerInfo(__int64 a1)
{
  ...
  NVMeLogTelemetry(
    ...
    v20,
    "MQES",
    (unsigned __int16)*(_DWORD *)(a1 + 160),
    "MDTS",
    ...
    *(unsigned __int16 *)(a1 + 804),
    "MessageCount",
    *(unsigned __int16 *)(a1 + 240),
    "ProcessorCount",
    *(unsigned __int16 *)(a1 + 202));
  v3 = 0;
  NVMeLogTelemetry(
    a1,
    0LL,
