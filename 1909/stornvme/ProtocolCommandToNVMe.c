/*
 * XREFs of ProtocolCommandToNVMe @ 0x1C0012400
 * Callers:
 ...
 *     FillClippedSGL @ 0x1C000DF34 (FillClippedSGL.c)
 *     NVMeValidateProtocolCommandRequest @ 0x1C0012088 (NVMeValidateProtocolCommandRequest.c)
 */
