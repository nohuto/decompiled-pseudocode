/*
 * XREFs of AdminQueueInitialize @ 0x1C0008768
 * Callers:
 *     NVMeControllerInitPart1 @ 0x1C000AF04 (NVMeControllerInitPart1.c)
 * Callees:
 *     NVMeZeroMemory @ 0x1C0001FDC (NVMeZeroMemory.c)
 *     NVMeCompletionQueueInit @ 0x1C000A664 (NVMeCompletionQueueInit.c)
 *     NVMeSubmissionQueueInit @ 0x1C000DA9C (NVMeSubmissionQueueInit.c)
 */
