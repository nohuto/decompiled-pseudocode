/*
 * XREFs of NVMeCompletionDpcRoutine @ 0x1C00041E0
 * Callers:
 *     NVMeHwMSIInterrupt @ 0x1C0004A80 (NVMeHwMSIInterrupt.c)
 *     NVMeIoPollingDpcRoutine @ 0x1C0015740 (NVMeIoPollingDpcRoutine.c)
 *     ProcessCompletionQueues @ 0x1C0018BE0 (ProcessCompletionQueues.c)
 * Callees:
 *     CalculateTimeDurationIn100ns @ 0x1C0004990 (CalculateTimeDurationIn100ns.c)
 *     _guard_dispatch_icall_nop @ 0x1C0005610 (_guard_dispatch_icall_nop.c)
