/*
 * XREFs of ACPIBusIrpQueryInterface @ 0x1C000B2A0
 * Callers:
 *     <none>
 * Callees:
 ...
 *     ACPICacheCoherencyInterface @ 0x1C00934B8 (ACPICacheCoherencyInterface.c)
...
LABEL_64:
  ...
  {
    InterfaceInformation = AcpiFanEjectInterface(a1, (__int64)a2);
LABEL_28:
