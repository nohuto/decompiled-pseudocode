 ...
 *     ArbFreeOrderingList @ 0x1C009E6B4 (ArbFreeOrderingList.c)
...
__int64 __fastcall ArbBuildAssignmentOrdering(__int64 a1)
{
  ...
  _OWORD v27[2]; // [rsp+B8h] [rbp+7h] BYREF
  ...
  *(_OWORD *)&ObjectAttributes.SecurityDescriptor = 0LL;
  ...
  for ( i = v6 + 8; i < &v6[32 * *((unsigned int *)v6 + 1) + 8]; i += 32 )
  {
    ...
    {
      v4 = (*(__int64 (__fastcall **)(_OWORD *, __int64 *, __int64 *, char *, char *))(a1 + 120))(
             v27,
             &v24,
             &v23,
             v25,
