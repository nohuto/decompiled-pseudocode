/*
 * XREFs of WPP_RECORDER_SF_ss @ 0x1C005A20C
 * Callers:
        ...
        const char *a7)
{
  ...
  if ( (HIDWORD(WPP_GLOBAL_Control->Timer) & 0x100000) != 0 && BYTE1(WPP_GLOBAL_Control->Timer) >= 2u )
  {
    ...
    pfnWppTraceMessage(
      ...
      43LL,
      &WPP_81d8e93eb8cd366f72cf11447b36d96d_Traceguids,
      11LL,
      v14,
      v13,
      v11);
  ...
  if ( !a6 )
    v8 = "NULL";
  LOWORD(v17) = 11;
  return WppAutoLogTrace(a1, 2LL, 21LL, &WPP_81d8e93eb8cd366f72cf11447b36d96d_Traceguids, v17, v8);
}
