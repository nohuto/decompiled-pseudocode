/*
 * XREFs of RtlStringCchPrintfW @ 0x1C00265E8
 * Callers:
 ...
 *     ACPIGetConvertToSerialIDWide @ 0x1C0055764 (ACPIGetConvertToSerialIDWide.c)
 ...
 * Callees:
 *     RtlStringVPrintfWorkerW_0 @ 0x1C0026640 (RtlStringVPrintfWorkerW_0.c)
 */
