/*
 * XREFs of WPP_RECORDER_SF_sDqss @ 0x1C003099C
 * Callers:
        ...
        __int64 a10)
{
  ...
  if ( (HIDWORD(WPP_GLOBAL_Control->Timer) & 0x800) != 0 && BYTE1(WPP_GLOBAL_Control->Timer) >= 4u )
  {
    ...
    pfnWppTraceMessage(
      ...
      43LL,
      &WPP_ed40076b1570389cf10b919aaf05b677_Traceguids,
      30LL,
      v22,
      v21,
      &a7);
  ...
  if ( !a6 )
    v14 = "NULL";
  LOWORD(v23) = 30;
  return WppAutoLogTrace(a1, 4LL, 12LL, &WPP_ed40076b1570389cf10b919aaf05b677_Traceguids, v23, v14);
}
