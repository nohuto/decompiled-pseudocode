/*
 * XREFs of WPP_RECORDER_SF_qsD @ 0x1C0054C10
 * Callers:
...
__int64 __fastcall WPP_RECORDER_SF_qsD(__int64 a1, __int64 a2, __int64 a3, __int64 a4, int a5, char a6, const char *a7)
{
  ...
  if ( (HIDWORD(WPP_GLOBAL_Control->Timer) & 0x100000) != 0 && BYTE1(WPP_GLOBAL_Control->Timer) >= 2u )
  {
    ...
    pfnWppTraceMessage(
      ...
      43LL,
      &WPP_05a11f23d0943a3100389a2588cd23f4_Traceguids,
      13LL,
      &a6,
      8LL,
      v11);
  ...
  LOWORD(v13) = 13;
  return WppAutoLogTrace(a1, 2LL, 21LL, &WPP_05a11f23d0943a3100389a2588cd23f4_Traceguids, v13, &a6);
}
