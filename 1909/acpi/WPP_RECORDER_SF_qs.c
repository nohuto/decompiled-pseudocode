/*
 * XREFs of WPP_RECORDER_SF_qs @ 0x1C002EBCC
 * Callers:
 *     OSNotifyDeviceEnum @ 0x1C002EA54 (OSNotifyDeviceEnum.c)
 *     ACPIBuildIssueNotifyInvalidateRelationsForDockDevice @ 0x1C004B570 (ACPIBuildIssueNotifyInvalidateRelationsForDockDevice.c)
