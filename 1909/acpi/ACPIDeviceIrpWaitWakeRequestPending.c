/*
 * XREFs of ACPIDeviceIrpWaitWakeRequestPending @ 0x1C0021170
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall ACPIDeviceIrpWaitWakeRequestPending(__int64 a1, int a2, __int64 a3, _QWORD *a4)
{
  ...
  v12 = (_QWORD *)qword_1C0082178;
  if ( *(__int64 **)qword_1C0082178 != &AcpiPowerWaitWakeList )
    __fastfail(3u);
  *a4 = &AcpiPowerWaitWakeList;
  a4[1] = v12;
  *v12 = a4;
  qword_1C0082178 = (__int64)a4;
  if ( !*(_BYTE *)(v6 + 68) )
  {
    *((_DWORD *)a4 + 14) |= 0x40u;
