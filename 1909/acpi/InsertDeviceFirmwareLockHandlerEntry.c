/*
 * XREFs of InsertDeviceFirmwareLockHandlerEntry @ 0x1C00306EC
 * Callers:
 *     AcpiRegisterDeviceFirmwareLockHandler @ 0x1C00A28CC (AcpiRegisterDeviceFirmwareLockHandler.c)
 * Callees:
...
__int64 __fastcall InsertDeviceFirmwareLockHandlerEntry(__int64 a1)
{
  ...
  else
  {
    ...
    v4 = (__int64 *)qword_1C00821C8;
    if ( *(__int64 **)qword_1C00821C8 != &AcpiDeviceFirmwareLockHandlerList )
      __fastfail(3u);
