/*
 * XREFs of ACPIEmQueryEnableD3ColdOnSurpriseRemovalRule @ 0x1C00B599C
 * Callers:
...
__int64 __fastcall ACPIEmQueryEnableD3ColdOnSurpriseRemovalRule(int a1, _WORD *a2)
{
  ...
  v4[0] = v5;
  v8 = v4;
  return EmClientRuleEvaluate(&GUID_EM_RULE_ACPI_DEVICE_ENABLE_D3COLD_ON_SURPRISE_REMOVAL, &v8, 1LL, v2);
}
