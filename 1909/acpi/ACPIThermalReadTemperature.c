/*
 * XREFs of ACPIThermalReadTemperature @ 0x1C00B50C8
 * Callers:
...
LABEL_47:
  ...
  *(_BYTE *)(v29 - 72) = 14;
  *(_DWORD *)(v29 - 48) = 2703504;
  *(_DWORD *)(v29 - 56) = 12;
  *(_DWORD *)(v29 - 64) = 4;
  *(_QWORD *)(*(_QWORD *)(v2 + 208) + 24LL) = v7;
  v30 = *(struct _DEVICE_OBJECT **)(v2 + 216);
  if ( a2 )
  {
    ...
    v33 = *v7;
    *(_BYTE *)(v2 + 272) = 0;
    ACPIThermalUpdateTemperature(a1, v33);
  }
  else
  {
    KeClearEvent((PRKEVENT)(v2 + 248));
    v31 = *(_QWORD *)(*(_QWORD *)(v2 + 208) + 184LL);
    *(_QWORD *)(v31 - 16) = ACPIThermalReadTemperatureComplete;
    *(_QWORD *)(v31 - 8) = a1;
    *(_BYTE *)(v31 - 69) = -32;
    IofCallDriver(v30, *(PIRP *)(v2 + 208));
  }
  return 0LL;
}
