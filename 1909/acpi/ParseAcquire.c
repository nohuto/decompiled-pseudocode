/*
 * XREFs of ParseAcquire @ 0x1C0024F00
 * Callers:
 *     <none>
 * Callees:
...
LABEL_57:
  ...
  if ( *(_DWORD *)v12 < *(_DWORD *)(a1 + 112) )
  {
    ...
    PrintDebugMessage(5, 0LL, 0LL, 0LL, 0LL);
  }
  else
  {
    v14 = *((_DWORD *)v12 + 1);
    ...
    else
    {
      ...
      else
      {
        ...
        PrintDebugMessage(4, 0LL, 0LL, 0LL, 0LL);
      }
    }
  }
  ...
  if ( (_DWORD)v5 == 32772 )
  {
    ...
    if ( (v39 & 0x20000) != 0 )
    {
      *(_DWORD *)(a2 + 16) = v39 & 0xFFFDFFFF;
      v5 = (const void *)(int)ReleaseGL(a1);
      v40 = *(_DWORD *)(a2 + 16);
      if ( (_DWORD)v5 )
      {
        *(_DWORD *)(a2 + 16) = v40 + 3;
        ...
        PrintDebugMessage(119, v5, 0LL, 0LL, 0LL);
...
LABEL_20:
  if ( (_DWORD)v5 == 32773
    ...
    || (LODWORD(v5) = PerformMutexDriverCallbacks(
                        2,
                        *(_QWORD *)(a2 + 32),
                        a1,
                        *(_QWORD *)(a1 + 80),
      ...
      if ( (v4 & 0x20000) != 0 )
      {
        *(_DWORD *)(a2 + 16) = v4 & 0xFFFDFFFF;
        ...
        if ( v41 )
        {
          LogError(-1072431101);
          AcpiDiagTraceAmlError(a1, -1072431101);
          PrintDebugMessage(172, (const void *)v41, 0LL, 0LL, 0LL);
          LODWORD(v5) = -1072431101;
        }
      }
