/*
 * XREFs of ACPIBuildProcessDevicePhaseHrv @ 0x1C000FBD0
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall ACPIBuildProcessDevicePhaseHrv(__int64 a1)
{
  ...
  v1 = *(_QWORD *)(a1 + 40);
  v3 = AMLIGetNamedChild(*(_QWORD *)(v1 + 712), 1448233055LL);
  v4 = 0;
  *(_DWORD *)(a1 + 32) = 12;
  v5 = v3;
  if ( !v3 )
  ...
  if ( (*(_BYTE *)(v1 + 952) & 8) == 0 )
  {
    ...
    v4 = ACPIGet((__int64 *)v1, 1448233055, 537149442, 0LL, 0, (__int64)ACPIBuildCompleteMustSucceed, a1, v1 + 584, 0LL);
    *(_DWORD *)(a1 + 32) = 11;
  }
