/*
 * XREFs of WPP_RECORDER_SF_sqss @ 0x1C001D524
 * Callers:
 *     ACPIBuildProcessSynchronizationList @ 0x1C001D2C8 (ACPIBuildProcessSynchronizationList.c)
        ...
        const char *a9)
{
  ...
  if ( !a6 )
    v12 = "NULL";
  LOWORD(v31) = a4;
  return WppAutoLogTrace(a1, a2, a3, &WPP_7da7a47bb83432ecae707d7e950ce950_Traceguids, v31, v12);
}
