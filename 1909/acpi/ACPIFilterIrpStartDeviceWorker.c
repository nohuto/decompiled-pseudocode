/*
 * XREFs of ACPIFilterIrpStartDeviceWorker @ 0x1C009F8C0
 * Callers:
 *     <none>
 * Callees:
 ...
 *     PnpCmResourcesExcludeSidebandResources @ 0x1C00B3F2C (PnpCmResourcesExcludeSidebandResources.c)
 */
...
void __fastcall ACPIFilterIrpStartDeviceWorker(__int64 a1)
{
  ...
  _DWORD *v34; // [rsp+D0h] [rbp+67h] BYREF
  void *v35; // [rsp+D8h] [rbp+6Fh] BYREF
  __int64 v36; // [rsp+E0h] [rbp+77h]
  ...
  if ( v9 )
  {
    v22 = PnpCmResourcesExcludeSidebandResources(v9, v10, v11, (unsigned int)&v34, (__int64)&v35);
    v6 = v34;
    v12 = v22;
    v7 = v35;
  }
  ...
  *(_BYTE *)(v15 - 69) = -32;
  ...
  v21 = IofCallDriver(*(PDEVICE_OBJECT *)(v5 + 728), *(PIRP *)(a1 + 40));
  if ( v21 == 259 )
  {
  ...
  else
  {
    ...
    *(_QWORD *)(v8 + 16) = v37;
    if ( (*(_QWORD *)(v5 + 8) & 0x102000000LL) != 0 )
      ACPIWakeInitializePciDevice(*(_QWORD *)(v5 + 720));
  }
  if ( v6 )
