/*
 * XREFs of ACPIBuildProcessRunMethodPhaseRecurse @ 0x1C0015F30
 * Callers:
 *     <none>
 * Callees:
                                   ...
                                   BuildRequestLookAsideList.L.Tag)) != 0LL) )
      {
        if ( *(_DWORD *)(v6 + 684) )
        {
          ...
          *((_QWORD *)&v12[2].Next + 1) = v6;
          ...
          v13 = (PSLIST_ENTRY *)qword_1C00823F8;
          if ( *(__int64 **)qword_1C00823F8 != &AcpiBuildQueueList )
            __fastfail(3u);
          v12->Next = (_SLIST_ENTRY *)&AcpiBuildQueueList;
          *((_QWORD *)&v12->Next + 1) = v13;
          *v13 = v12;
          qword_1C00823F8 = (__int64)v12;
