/*
 * XREFs of AcpiPccGetInterfaceInformation @ 0x1C0059AA4
 * Callers:
...
__int64 __fastcall AcpiPccGetInterfaceInformation(ULONG_PTR a1, __int64 a2)
{
  ...
  if ( !v8 )
    return (unsigned int)-1073741637;
  v9 = KeAcquireSpinLockRaiseToDpc((PKSPIN_LOCK)(v8 + 520));
  if ( (*(_BYTE *)v8 & 0x3C) == 0xC )
  {
    *(_DWORD *)v8 = *(_DWORD *)v8 & 0xFFFFFFC3 | 0x30;
    KeReleaseSpinLock((PKSPIN_LOCK)(v8 + 520), v9);
    *(_DWORD *)v5 = 65624;
    *(_QWORD *)(v5 + 16) = PciConfigPinToLine;
    *(_QWORD *)(v5 + 24) = PciConfigPinToLine;
    *(_QWORD *)(v5 + 8) = 0LL;
    *(_QWORD *)(v5 + 40) = *(_QWORD *)(v8 + 96);
    *(_DWORD *)(v5 + 48) = *(_DWORD *)(v8 + 104);
    *(_QWORD *)(v5 + 72) = *(_QWORD *)(v8 + 80);
    *(_DWORD *)(v5 + 80) = *(_DWORD *)(v8 + 88);
    *(_QWORD *)(v5 + 64) = *(_QWORD *)(v8 + 64);
    *(_QWORD *)(v5 + 56) = *(_QWORD *)(v8 + 56);
    PciConfigPinToLine();
  }
  else
  {
