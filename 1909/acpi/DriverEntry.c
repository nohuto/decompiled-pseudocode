/*
 * XREFs of DriverEntry @ 0x1C00BB7B4
 * Callers:
 ...
 *     AcpiInitializeExternalResourceTranslation @ 0x1C00905C4 (AcpiInitializeExternalResourceTranslation.c)
 ...
 *     ACPIInitGetEmOverride @ 0x1C00BCDF0 (ACPIInitGetEmOverride.c)
 */
...
NTSTATUS __stdcall DriverEntry(_DRIVER_OBJECT *DriverObject, PUNICODE_STRING RegistryPath)
{
  ...
  _QWORD SystemInformation[2]; // [rsp+48h] [rbp-40h] BYREF
  ...
  *(_QWORD *)&WPP_MAIN_CB.Type = 0LL;
  ...
  qword_1C0081E78 = (__int64)&gBBNResultCacheListHead;
  ...
  *(_QWORD *)&WPP_MAIN_CB.Dpc.TargetInfoAsUlong = ACPIFilterFastIoDetachCallback;
  ...
  qword_1C00821C8 = (__int64)&AcpiDeviceFirmwareLockHandlerList;
