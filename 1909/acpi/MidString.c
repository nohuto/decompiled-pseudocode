/*
 * XREFs of MidString @ 0x1C0069810
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall MidString(struct _SLIST_ENTRY *a1, __int64 a2)
{
  ...
  if ( !v5 )
  {
    v5 = ValidateTarget((__int64)a1, *(_QWORD *)(a2 + 80) + 120LL, 0x87u, (__int64)&v16);
    if ( !v5 )
    {
      ...
      *(_WORD *)(*(_QWORD *)(a2 + 88) + 2LL) = v6;
      ...
      if ( v9 < v8 )
      {
        ...
        {
          v13 = HeapAlloc((struct _SLIST_ENTRY *)gpheapGlobal, 1381258056, v12 + 1);
        ...
        {
          v14 = HeapAlloc((struct _SLIST_ENTRY *)gpheapGlobal, 1179992648, v12);
