/*
 * XREFs of ACPIProcessorContainerStartDeviceWorker @ 0x1C005D3F0
 * Callers:
 *     <none>
 * Callees:
...
LABEL_14:
    ...
    {
      v11 = (_QWORD *)qword_1C0081B28;
      if ( *(__int64 **)qword_1C0081B28 == &AcpiProcessorContainerRootList )
      {
        *v9 = &AcpiProcessorContainerRootList;
        v4[24] = v11;
        *v11 = v9;
        qword_1C0081B28 = (__int64)(v4 + 23);
        goto LABEL_14;
      }
    }
    __fastfail(3u);
