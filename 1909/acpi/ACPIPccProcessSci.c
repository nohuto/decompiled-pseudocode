/*
 * XREFs of ACPIPccProcessSci @ 0x1C005945C
 * Callers:
 *     ACPIInterruptServiceRoutineDPC @ 0x1C0021910 (ACPIInterruptServiceRoutineDPC.c)
 * Callees:
 *     AcpiPccCommandComplete @ 0x1C0059768 (AcpiPccCommandComplete.c)
 *     AcpiPccPlatformNotification @ 0x1C0059BF8 (AcpiPccPlatformNotification.c)
 */
