/*
 * XREFs of ACPIDockIrpSetSystemPower @ 0x1C004A5B4
 * Callers:
...
__int64 __fastcall ACPIDockIrpSetSystemPower(PDEVICE_OBJECT DeviceObject, PIRP *Irp)
{
  ...
  v10.SystemState = *(_SYSTEM_POWER_STATE *)(DeviceExtension + 4 * IrpCount + 460);
  *(_DWORD *)(v9 + 500) = IrpCount;
  if ( LODWORD(v2->ThreadListEntry.Flink) == 7 )
  {
    v11 = Irp[23];
    *((_DWORD *)Irp + 12) = 0;
    HIBYTE(v11->Size) |= 1u;
    _InterlockedIncrement((volatile signed __int32 *)(v9 + 680));
  ...
  else if ( *(_DWORD *)(DeviceExtension + 336) == v10.SystemState )
  {
