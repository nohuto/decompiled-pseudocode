/*
 * XREFs of wil_details_RecordUsageInPropertyCache @ 0x1C00066A4
 * Callers:
...
LABEL_11:
      ...
      {
        v10 = ((unsigned int)Feature_Pldr_Ignore_Vetoes__private_propertyCache >> 7) & 0x3F;
        if ( a3 - 320 == (_DWORD)v10 )
        {
          ...
          v16 = 1;
          v14 = v6;
          wil_details_ModifyFeatureData(v10, wil_details_SetPropertyFlagCallback, &v14);
        }
      }
      *((_DWORD *)v6 + 2) = a3;
      *((_DWORD *)v6 + 1) = 1;
...
LABEL_4:
  ...
  v11 = a1;
LABEL_7:
  LOBYTE(v4) = (unsigned int)wil_details_ModifyFeatureData(a1, v8, v7) == 0;
  *((_DWORD *)v6 + 4) = v4;
  return v6;
}
