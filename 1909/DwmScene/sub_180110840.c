/*
 * XREFs of sub_180110840 @ 0x180110840
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall sub_180110840(__int64 a1)
{
  __int64 v2; // rdi
  __int64 v3; // rdi
  __int64 v4; // rbx
  ...
  v5 = v4 | sub_1800D2044(0, 3, 0LL);
  v6 = v5 | sub_1800D2084(0, 2, 0LL);
  result = v6 | sub_1800D20A4(0, 2, 0LL);
