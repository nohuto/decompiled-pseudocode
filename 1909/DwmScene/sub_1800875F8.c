...
char __fastcall sub_1800875F8(_DWORD *a1, _OWORD *a2, _OWORD *a3, double a4)
{
  __m128 v4; // xmm0
  __m128 v5; // xmm1
  __m128 v6; // xmm2
  ...
  v9 = a1;
  if ( !a1 )
    wassert(L"outScale != nullptr", L"d:\\os\\public\\amd64fre\\sdk\\inc\\DirectXMathMatrix.inl", 0x3D4u);
  if ( !a2 )
    wassert(L"outRotQuat != nullptr", L"d:\\os\\public\\amd64fre\\sdk\\inc\\DirectXMathMatrix.inl", 0x3D5u);
  if ( !a3 )
    wassert(L"outTrans != nullptr", L"d:\\os\\public\\amd64fre\\sdk\\inc\\DirectXMathMatrix.inl", 0x3D6u);
  v62 = v4;
  v10 = _mm_mul_ps(v4, v4);
  v61[0] = &v62;
  *a3 = *(_OWORD *)&a4;
  v64[1] = xmmword_180143DB0;
  v61[1] = &v63;
  v61[2] = v64;
  v63 = v5;
  v64[0] = v6;
  ...
  *a1 = _mm_sqrt_ps(_mm_shuffle_ps(v10, v10, 0)).m128_u32[0];
  ...
  if ( a1 == (_DWORD *)-4LL )
    wassert(L"x != nullptr", L"d:\\os\\public\\amd64fre\\sdk\\inc\\DirectXMathVector.inl", 0x1F0u);
...
LABEL_24:
  ...
  v31 = _mm_sqrt_ps(v30);
  v32 = _mm_cmpneq_ps(v30, (__m128)xmmword_180143E90);
  v33 = _mm_or_ps(
          _mm_and_ps(_mm_and_ps(_mm_div_ps(*v27, v31), _mm_cmpneq_ps((__m128)0LL, v31)), v32),
          _mm_andnot_ps(v32, (__m128)xmmword_180143EA0));
  *v27 = v33;
  if ( *(float *)&v9[v26] < 0.000099999997 )
  {
    v34 = fabs(v33.m128_f32[0]);
    v35 = fabs(_mm_shuffle_ps(v33, v33, 85).m128_f32[0]);
    ...
    v38 = _mm_shuffle_ps(*(__m128 *)off_180259750[v7], *(__m128 *)off_180259750[v7], 210);
  ...
  v43 = _mm_sqrt_ps(v42);
  v44 = _mm_cmpneq_ps(v42, (__m128)xmmword_180143E90);
  v45 = _mm_or_ps(
          _mm_and_ps(_mm_and_ps(_mm_div_ps(*v39, v43), _mm_cmpneq_ps((__m128)0LL, v43)), v44),
          _mm_andnot_ps(v44, (__m128)xmmword_180143EA0));
  *v39 = v45;
  ...
  v52 = _mm_sqrt_ps(v51);
  v53 = _mm_cmpneq_ps(v51, (__m128)xmmword_180143E90);
  *v48 = _mm_or_ps(
           _mm_and_ps(_mm_and_ps(_mm_cmpneq_ps((__m128)0LL, v52), _mm_div_ps(*v48, v52)), v53),
           _mm_andnot_ps(v53, (__m128)xmmword_180143EA0));
  v54 = v62.m128_u64[1];
  v58 = sub_180087B04(a1, v20);
  if ( v58 < 0.0 )
  {
    v58 = -v58;
  ...
  if ( (float)((float)(v58 + -1.0) * (float)(v58 + -1.0)) > 0.000099999997 )
    return 0;
  *((_QWORD *)&v60 + 1) = v54;
  *(double *)&v60 = sub_180087F94(v56, v55, v57);
  *a2 = v60;
  return 1;
}
