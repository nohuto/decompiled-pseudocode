/*
 * XREFs of sub_18003BD10 @ 0x18003BD10
 * Callers:
 *     <none>
 * Callees:
...
_QWORD *__fastcall sub_18003BD10(__int64 a1, _QWORD *a2, int a3)
{
  int v4; // r8d
  int v5; // r8d
  __int64 *v6; // rcx
  ...
  if ( v4 )
  {
    ...
    if ( v5 )
    {
      ...
      if ( *(_QWORD *)(a1 + 192) )
      {
        v6 = (__int64 *)sub_18009EC74(*(_QWORD *)(a1 + 192), v26, *(unsigned int *)(a1 + 88));
        v7 = 12;
        v8 = *v6;
      }
      else
...
LABEL_35:
    ...
    else
    {
      if ( *(_QWORD *)(a1 + 176) )
      {
        v11 = (__int64 *)sub_18009EC74(*(_QWORD *)(a1 + 176), v28, *(unsigned int *)(a1 + 88));
        v12 = 36;
        v13 = *v11;
      }
      else
  ...
  else
  {
    if ( *(_QWORD *)(a1 + 144) )
    {
      v15 = (__int64 *)sub_18009EC74(*(_QWORD *)(a1 + 144), v30, *(unsigned int *)(a1 + 88));
      v16 = 5;
      v17 = *v15;
    }
    else
