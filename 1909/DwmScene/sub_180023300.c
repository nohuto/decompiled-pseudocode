/*
 * XREFs of sub_180023300 @ 0x180023300
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall sub_180023300(__int64 a1)
{
  _QWORD *v1; // rbx
  __int64 v2; // rcx
  __int64 v3; // rcx
  ...
  (**(void (__fastcall ***)(_QWORD, void *, __int64 *))*v1)(*v1, &unk_18014B280, &v18);
  v3 = v13[0];
  if ( v13[0] )
  {
    v13[0] = 0LL;
  ...
  if ( v18 )
  {
    ...
    if ( v5 < 0 )
    {
      ...
      sub_18000E4E8(v16);
      v12 = (unsigned int)sub_18000E4E8(v15);
      sub_180065920((unsigned int)pExceptionObject, v12, 1042, v5, (__int64)v16, 0);
