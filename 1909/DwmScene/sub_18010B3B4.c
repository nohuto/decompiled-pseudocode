/*
 * XREFs of sub_18010B3B4 @ 0x18010B3B4
 * Callers:
...
__int64 __fastcall sub_18010B3B4(__int64 a1, __int64 *a2, _QWORD *a3, __int64 a4, unsigned int a5)
{
  __int64 v8; // rdx
  __int64 result; // rax
  ...
  v17 = 0LL;
  v18 = 0LL;
  sub_1800AE9F0(a1, &v17, a2);
  sub_18006A724(v17, (__int64)a3, a4, a5);
  v13 = 0LL;
  v8 = a3[1];
  if ( v8 )
  {
  ...
  *(_QWORD *)&v13 = *a3;
  *((_QWORD *)&v13 + 1) = v8;
  result = sub_1800B1094(a1, (__int64 *)&v13);
  v10 = v18;
  if ( v18 )
  {
