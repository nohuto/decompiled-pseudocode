/*
 * XREFs of __scrt_initialize_onexit_tables @ 0x180125E68
 * Callers:
 ...
 * Callees:
 *     _o__initialize_onexit_table @ 0x180125B23 (_o__initialize_onexit_table.c)
...
char __fastcall _scrt_initialize_onexit_tables(unsigned int a1)
{
  ...
  if ( !byte_18026C410 )
  {
    ...
    if ( !v2 || a1 )
    {
      ...
      *(_QWORD *)&v5 = v4;
      *((_QWORD *)&v5 + 1) = v4;
      xmmword_18026C3E0 = v5;
      *(_QWORD *)&v5 = v4;
      *((_QWORD *)&v5 + 1) = v4;
      qword_18026C3F0 = v4;
      xmmword_18026C3F8 = v5;
      qword_18026C408 = v4;
    }
