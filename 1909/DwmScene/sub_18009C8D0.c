/*
 * XREFs of sub_18009C8D0 @ 0x18009C8D0
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall sub_18009C8D0(__int64 a1, __int64 a2, __int64 a3, __int64 *a4)
{
  __int64 v4; // rax
  int v6; // ecx
  __int64 result; // rax
  ...
  if ( (v6 & 0x410000) == 0x410000 )
  {
    ...
    while ( v8 );
    sub_180099950((unsigned __int64 *)(a1 + 88), &v17);
    v14 = xmmword_1801EFF80;
    LODWORD(v11) = v20;
    v15 = xmmword_1801EFF80;
    v13 = v18;
    v10 = v19;
    v12 = v17;
    sub_1800F0FE4(a1, (unsigned int)&v12, (unsigned int)&v10, (unsigned int)&v15, (__int64)&v14, 1077936128);
  }
  return result;
}
