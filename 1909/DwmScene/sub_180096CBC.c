...
__int64 __fastcall sub_180096CBC(__int64 a1, __int64 a2)
{
  __int64 *v3; // rax
  __int64 *v4; // rax
  ...
  if ( *(_BYTE *)(a1 + 310) )
  {
    sub_18000E4E8(v6);
    v4 = sub_18000E4E8(v5);
    sub_18006586C(pExceptionObject, v4, 704LL, (__int64)v6, 0);
  ...
  if ( !a2 )
  {
    sub_18000E4E8(v5);
    v3 = sub_18000E4E8(v6);
    sub_180095130(pExceptionObject, v3, 709, (__int64)v5, 0);
    throw (Spectre::Engine::EngineInvalidPointerException *)pExceptionObject;
  }
  return sub_180096D8C(a1, a2, *(unsigned int *)(a1 + 120));
}
