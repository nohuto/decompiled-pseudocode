/*
 * XREFs of sub_1800AAC3C @ 0x1800AAC3C
 * Callers:
...
unsigned __int64 __fastcall sub_1800AAC3C(_QWORD *a1, __int64 a2, __int64 a3)
{
  __int64 v5; // rsi
  __int64 v6; // rax
  ...
  v11 = sub_180031E4C((__int64)a1, v10);
  v21 = v11;
  ...
  *((_QWORD *)v13 + 3) = 0LL;
  try
  {
    sub_18001115C((__int64 *)((char *)v11 + v12), a3);
    ...
    if ( a2 != v14 )
    {
      sub_1800AB9F8(v17, a2, v11, a1, v19, v11, -2LL);
      v25 = v11;
      v15 = a1;
      v16 = (__int64 *)(v13 + 32);
      v14 = a1[1];
    ...
    sub_1800AB9F8(v17, v14, v16, v15, v19, v21, v23);
    sub_1800B2A34(a1, v11, v7, v10);
    result = v12 + *a1;
  }
  catch ( ... )
  {
    sub_18006DFB4((__int64)a1, v25, v20);
    sub_180031EBC((__int64)a1, v22, v10);
    throw;
  }
  return result;
}
