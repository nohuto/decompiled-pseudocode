/*
 * XREFs of sub_1800AE7D0 @ 0x1800AE7D0
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall sub_1800AE7D0(__int64 a1, __int64 *a2)
{
  __int64 result; // rax
  ...
  LODWORD(v10) = sub_18006CEC8(*a2);
  result = sub_1800657B8((__int64 *)(a1 + 448), (unsigned int *)&v10);
