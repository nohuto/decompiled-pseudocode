/*
 * XREFs of sub_1800DAEA4 @ 0x1800DAEA4
 * Callers:
...
__int64 __fastcall sub_1800DAEA4(__int64 *a1, __int64 a2, unsigned __int8 (__fastcall *a3)(__int64, __int64))
{
  __int64 result; // rax
  char *v6; // rbx
  ...
  if ( result >= 32 )
  {
    ...
    *((_QWORD *)v6 + 1) = 0LL;
    ...
    result = sub_1800DADBC((__int64)a1, 0LL, (v6 - (char *)a1) >> 4, (int)&v10, a3);
    v7 = v11;
    if ( v11 )
    {
