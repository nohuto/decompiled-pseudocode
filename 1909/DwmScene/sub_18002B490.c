/*
 * XREFs of sub_18002B490 @ 0x18002B490
 * Callers:
 *     <none>
 * Callees:
...
void __fastcall sub_18002B490(__int64 a1, __int64 a2, __int64 a3, __int64 a4, int a5)
{
  int v6; // edx
  int v7; // r8d
  int v8; // r9d
  ...
  if ( *(float *)&v17 != (*(float (__fastcall **)(__int64))(*(_QWORD *)a1 + 120LL))(a1) )
  {
    ...
    sub_18011DA98(&unk_180259080, 3LL, "  non-uniform scale factors: x=%.0f%% y=%.0f%%", (float)(v19 * 100.0), v18);
  }
  v24 = 0LL;
