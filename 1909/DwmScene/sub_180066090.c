/*
 * XREFs of sub_180066090 @ 0x180066090
 * Callers:
...
__int64 __fastcall sub_180066090(__int64 *a1, __int64 a2)
{
  __int64 v4; // r15
  __int64 v5; // rdx
  ...
  try
  {
    ...
    if ( a2 == v12 )
    {
      sub_1800666D8(v13, v12, v10, a1);
    }
    else
    {
      sub_1800667DC(v13, a2, v10, a1);
      v17 = v10;
      sub_1800667DC(a2, a1[1], v11 + 152, a1);
    }
  }
  catch ( ... )
  {
    sub_1800696BC(a1, v17, v11 + 152);
    sub_180069D48(a1, v10, v9);
    throw;
  }
  sub_1800694D4(a1, v10, v6, v9);
  return v15 + *a1;
}
