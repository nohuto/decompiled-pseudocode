/*
 * XREFs of sub_1800FB8B0 @ 0x1800FB8B0
 * Callers:
...
__int64 __fastcall sub_1800FB8B0(const void **a1, _BYTE *a2, _WORD *a3)
{
  __int64 v6; // r15
  __int64 v7; // r14
  ...
  v12 = sub_1800114D0((__int64)a1, v11);
  *((_WORD *)v12 + v6) = *a3;
  v13 = a1[1];
  v14 = *a1;
  v15 = (char *)v12;
  ...
  memmove(v15, v14, v16);
  sub_1800FC6F0(a1, v12, v8, v11, v11, v12, a1, -2LL);
