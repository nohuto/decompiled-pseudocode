/*
 * XREFs of sub_180043CC0 @ 0x180043CC0
 * Callers:
 *     <none>
 * Callees:
...
char __fastcall sub_180043CC0(__int64 a1, __int64 *a2)
{
  __int64 v4; // rdx
  __int64 v5; // rdi
  __int64 v6; // rbx
  ...
  if ( *(_BYTE *)(a1 + 96) )
  {
    ...
    sub_180027880(pExceptionObject, v20, 38, (__int64)v22, 0);
...
LABEL_6:
    ...
    if ( v12 < 0 )
    {
      sub_18011DA98(&unk_1802591B8, 5LL, "ERROR: Failed to create Domain shader.\n");
    }
    else
    {
      *(_BYTE *)(a1 + 96) = 1;
