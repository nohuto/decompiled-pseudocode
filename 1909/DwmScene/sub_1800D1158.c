/*
 * XREFs of sub_1800D1158 @ 0x1800D1158
 * Callers:
...
__int64 __fastcall sub_1800D1158(__int64 **a1, char *a2, char *a3)
{
  __int64 *v6; // rbx
  __int64 *v7; // r15
  ...
  if ( v8 > v10 / 48 )
  {
    if ( v8 <= 0x555555555555555LL )
    {
      ...
      *a1 = 0LL;
      ...
      if ( v8 <= 0x555555555555555LL )
      {
        v16 = sub_1800B2C7C((__int64)a1, v8);
        *a1 = v16;
        a1[1] = v16;
        a1[2] = &(*a1)[6 * v8];
LABEL_18:
        ...
        v18 = a2;
LABEL_26:
        result = ((__int64 (__fastcall *)(char *, char *, __int64 *, __int64 **, _BYTE))sub_1800D1464)(
                   v18,
                   a3,
                   v17,
                   a1,
  ...
  if ( v8 > v9 )
  {
    ...
    if ( a2 != v19 )
    {
      ...
      do
      {
        sub_180011764(v6, (__int64 *)(v20 - 9));
        *((_DWORD *)v6 + 8) = *(v20 - 1);
        v21 = *v20;
        v20 += 12;
        *((_DWORD *)v6 + 9) = v21;
  ...
  if ( a2 != a3 )
  {
    ...
    do
    {
      sub_180011764(v6, (__int64 *)(v23 - 9));
      *((_DWORD *)v6 + 8) = *(v23 - 1);
      v24 = *v23;
      v23 += 12;
      *((_DWORD *)v6 + 9) = v24;
  ...
  for ( i = v22; i != v7; i += 6 )
    result = (__int64)sub_1800676B8(i, 0);
  a1[1] = v22;
  return result;
}
