/*
 * XREFs of sub_1800682B4 @ 0x1800682B4
 * Callers:
...
__int64 __fastcall sub_1800682B4(__int64 a1)
{
  int v2; // r12d
  _QWORD *v3; // rax
  __int64 v4; // r14
      ...
      while ( v7 != v6 )
      {
        ...
        if ( v8 )
        {
          if ( v8 == 1 )
          {
            ...
            v33 = 0;
            v10 = sub_180065C24(&v38, (__int64)(v7 + 4), &v33);
            sub_180066498(&v38, (__int64)&v37, 0, (size_t *)v10 + 4, v10);
        ...
        else
        {
          ...
          if ( (unsigned __int64)v7[7] >= 0x10 )
            v12 = (const void *)v7[4];
          v13 = v7[6];
          if ( v13 == (_QWORD)xmmword_18025DD30 && !memcmp(v12, v11, v13) )
          {
            sub_180065A80(
              *(__int64 ***)(a1 + 384),
              (__int64)"..\\Source\\Engine\\RenderOutput.cpp",
          ...
          {
            v14 = sub_180011540(Src, &qword_180259688, v7 + 4);
            if ( v14[3] >= 0x10uLL )
              v14 = (_QWORD *)*v14;
            sub_180065A80(
              *(__int64 ***)(a1 + 384),
...
LABEL_56:
      ...
      while ( v20 != v19 )
      {
        v21 = sub_180011540(Src, &qword_180259688, v20 + 4);
        v22 = &qword_18025DD00;
        if ( *((_QWORD *)&xmmword_18025DD10 + 1) >= 0x10uLL )
          v22 = (__int64 *)qword_18025DD00;
        v23 = std::string::append(v21, v22, xmmword_18025DD10);
        v40 = 0uLL;
        v39 = *(_OWORD *)v23;
        v40 = *((_OWORD *)v23 + 1);
        v23[2] = 0LL;
