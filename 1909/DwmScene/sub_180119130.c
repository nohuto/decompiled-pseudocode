/*
 * XREFs of sub_180119130 @ 0x180119130
 * Callers:
 *     <none>
 * Callees:
...
ULONG __fastcall sub_180119130(__int64 a1, int a2, _BYTE *a3)
{
  void *v3; // rbx
  ULONG result; // eax
  ...
  if ( (unsigned int)dword_18025EE60 > 5 && (qword_18025EE70 & 0x400000000000LL) != 0 )
  {
    ...
    if ( (qword_18025EE78 & 0x400000000000LL) == qword_18025EE78 )
    {
      ...
      v22 = v8 + 1;
      v21 = a3;
      return sub_180001128((__int64)&dword_18025EE60, (unsigned __int8 *)dword_180224CDA, 0LL, 0LL, 7u, &v11);
    }
  }
  return result;
}
