/*
 * XREFs of sub_1800A7D1C @ 0x1800A7D1C
 * Callers:
 *     sub_1800A5BA0 @ 0x1800A5BA0 (sub_1800A5BA0.c)
 * Callees:
...
__int64 __fastcall sub_1800A7D1C(__int64 a1)
{
  __int64 v2; // rcx
...
LABEL_11:
  ...
  *(_QWORD *)(a1 + 520) = 15LL;
  *(_BYTE *)(a1 + 496) = 0;
  sub_1800AA2EC(a1 + 480, v23, **(_QWORD **)(a1 + 480), *(_QWORD *)(a1 + 480), -2LL);
  j_j__o_free(*(_QWORD *)(a1 + 480));
  sub_18011E1A0(a1 + 472);
  ...
  sub_1800AA154(a1 + 416, v24, **(_QWORD **)(a1 + 416));
  ...
  sub_180069DD0((__int64 ***)(a1 + 80), &v25, **(__int64 ***)(a1 + 80), *(__int64 **)(a1 + 80));
  j_j__o_free(*(_QWORD *)(a1 + 80));
  v26 = *(__int64 **)(a1 + 48);
  v27 = (__int64 *)*v26;
  sub_1800A6168((__int64 ***)(a1 + 48), &v28, v27, v26);
