/*
 * XREFs of sub_180044860 @ 0x180044860
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall sub_180044860(__int64 a1, __int64 a2, int a3)
{
  __int64 v6; // rbx
  __int64 v7; // rdx
  __int64 v8; // rbx
...
LABEL_4:
  ...
  v22 = 0LL;
  sub_180033E2C(*(_QWORD **)(a1 + 120), &v22);
  v10 = *(_DWORD *)(a1 + 140);
  if ( !v10 )
  {
    v24 = 0LL;
