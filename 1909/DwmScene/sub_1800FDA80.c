/*
 * XREFs of sub_1800FDA80 @ 0x1800FDA80
 * Callers:
 *     <none>
 * Callees:
...
bool __fastcall sub_1800FDA80(__int64 a1, __int64 a2)
{
  __int64 v4; // rdi
  bool result; // al
  ...
  if ( sub_1800AE280(a1, a2) )
  {
    v4 = _RTDynamicCast(
           ...
           1);
    if ( !sub_180081F1C((unsigned __int64 *)(v4 + 1800), (unsigned __int64 *)(a1 + 1800))
