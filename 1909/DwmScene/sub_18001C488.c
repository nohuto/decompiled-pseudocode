/*
 * XREFs of sub_18001C488 @ 0x18001C488
 * Callers:
...
__int64 __fastcall sub_18001C488(_QWORD *a1, _QWORD *a2)
{
  _QWORD *v3; // r14
  _QWORD *v4; // rax
  signed int v5; // edi
  ...
  v16[2] = 0LL;
  v16[3] = 0LL;
  sub_18001115C(v16, (__int64)&unk_1802597A8);
  v4 = (_QWORD *)sub_18008B3B0(*v3, v12, v16);
  v5 = sub_18001BEE0(a1 + 4, v4);
  v6 = v13;
  if ( v13 )
  {
...
LABEL_7:
  ...
  v17[2] = 0LL;
  v17[3] = 0LL;
  sub_18001115C(v17, (__int64)&qword_180259808);
  v10 = (_QWORD *)sub_18008B3B0(*v3, v14, v17);
  v5 = sub_18001BEE0(a1 + 5, v10);
  v11 = v15;
