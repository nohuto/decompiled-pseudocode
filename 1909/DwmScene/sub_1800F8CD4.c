/*
 * XREFs of sub_1800F8CD4 @ 0x1800F8CD4
 * Callers:
 ...
 *     sub_1800F94E4 @ 0x1800F94E4 (sub_1800F94E4.c)
 * Callees:
 ...
 *     sub_1800A9448 @ 0x1800A9448 (sub_1800A9448.c)
...
__int64 __fastcall sub_1800F8CD4(_QWORD *a1, __int64 *a2, __int64 a3, __int64 *a4)
{
  __int64 v8; // rdx
  __int64 v9; // rcx
  int v10; // eax
  ...
  if ( !a2[2] )
  {
    v8 = a1[2] + 496LL;
    v50 = 0LL;
    sub_18000F444(v49, v8);
    sub_180017D44(a2, (__int64)v49);
  ...
  if ( !a4[2] )
  {
    v10 = sub_1800A9448(a1[2]);
    v11 = sub_1800A52F4(v58, v10);
    sub_180017D44(a4, (__int64)v11);
    if ( v59 >= 0x10 )
    {
      v12 = v58[0];
      if ( v59 + 1 >= 0x1000 )
  ...
  v62 = 0LL;
  v63 = 0LL;
  sub_1800A9414(a1[2], &v62);
  v61[0] = 0LL;
  v61[1] = 0LL;
  sub_1800A4440(v62, v61, a3);
  sub_1800A54C8(v66, v61);
  v13 = sub_18002C0E4((const void **)&v51, a2, byte_18020BC58);
  v14 = a4;
  ...
  v15->m128i_i8[0] = 0;
  v16 = (__m128i *)std::string::append(&Src, &unk_18020BC54, 1uLL);
  si128 = 0LL;
  v45 = *v16;
  si128 = v16[1];
  ...
  *(_BYTE *)v18 = 0;
  ...
  v48 = _mm_load_si128(xmmword_180145F90);
  Src.m128i_i8[0] = 0;
  ...
  v52 = _mm_load_si128(xmmword_180145F90);
  LOBYTE(v51) = 0;
  sub_18002C0E4(v76, &v64, "/Vertex");
  sub_18002C0E4(v74, &v64, "/Pixel");
  sub_18002C0E4(v72, &v64, "/Geometry");
  sub_18002C0E4(v70, &v64, "/Domain");
  sub_18002C0E4(v68, &v64, "/Hull");
  v53[2] = 0LL;
  v53[3] = 0LL;
  sub_18000F444(v53, (__int64)v76);
  sub_1800F8AAC(a1, 1, v53);
  v54[2] = 0LL;
  v54[3] = 0LL;
  sub_18000F444(v54, (__int64)v74);
  sub_1800F8AAC(a1, 5, v54);
  v55[2] = 0LL;
  v55[3] = 0LL;
  sub_18000F444(v55, (__int64)v72);
  sub_1800F8AAC(a1, 4, v55);
  v56[2] = 0LL;
  v56[3] = 0LL;
  sub_18000F444(v56, (__int64)v70);
  sub_1800F8AAC(a1, 3, v56);
  v57[2] = 0LL;
  v57[3] = 0LL;
  sub_18000F444(v57, (__int64)v68);
  sub_1800F8AAC(a1, 2, v57);
  ...
  v69 = _mm_load_si128(xmmword_180145F90);
  LOBYTE(v68[0]) = 0;
  ...
  v77 = _mm_load_si128(xmmword_180145F90);
  LOBYTE(v76[0]) = 0;
  ...
  v67 = _mm_load_si128(xmmword_180145F90);
  LOBYTE(v66[0]) = 0;
  sub_1800A6168((__int64 ***)v61, v60, *(__int64 **)v61[0], v61[0]);
