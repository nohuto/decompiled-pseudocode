/*
 * XREFs of sub_1801057F0 @ 0x1801057F0
 * Callers:
...
__int64 __fastcall sub_1801057F0(__int64 a1, __int64 a2, __int64 a3)
{
  __int64 v4; // r12
...
LABEL_54:
  ...
  do
  {
    ...
    if ( v19 >= 0x10 )
      v22 = v18;
    v23 = sub_180103940((__int64)v22, v16, 0LL, (unsigned __int64)" \t", 2LL);
    if ( v16 < v23 )
      v23 = v16;
    v24 = Buf1;
    if ( v19 >= 0x10 )
    ...
    if ( (_BYTE)v27 )
    {
      ...
      v55 = 0LL;
      v56 = 0LL;
      sub_18000F444(&v54, (__int64)v72);
      v58 = 0LL;
      v59 = 0LL;
      sub_18000F444(&v57, (__int64)Buf1);
      if ( (unsigned __int8)sub_1801061A0(&v57, &v54) )
      {
        pExceptionObject[2] = 0LL;
        v80 = 15LL;
        LOBYTE(pExceptionObject[0]) = 0;
        sub_1800B8E18(pExceptionObject, Buf1, v73 + 1, 0xFFFFFFFFFFFFFFFFuLL);
        v53 = (int)sub_180106394(pExceptionObject, 0LL, 10LL);
        v5 = v53 * v53 * v53;
        v51 = 1;
        v14 = v80;
        if ( v80 >= 0x10 )
    ...
    if ( v51
      && (v61 = &v57,
          v58 = 0LL,
          v59 = 0LL,
          sub_18000F444(&v57, (__int64)v77),
          v55 = 0LL,
          v56 = 0LL,
          sub_18000F444(&v54, (__int64)Buf1),
          (unsigned __int8)sub_1801061A0(&v54, &v57)) )
    {
      v52[0] = 1;
    }
    else if ( v52[0] )
    {
      ...
      v58 = 0LL;
      v59 = 0LL;
      sub_18000F444(&v57, (__int64)v75);
      v55 = 0LL;
      v56 = 0LL;
      sub_18000F444(&v54, (__int64)Buf1);
      if ( (unsigned __int8)sub_1801061A0(&v54, &v57) )
      {
        v6 = 1;
        v49 = 1;
        goto LABEL_45;
...
LABEL_45:
    ...
    v36 = sub_1800B7A24(v34, Buf1, v35);
...
LABEL_47:
  ...
  {
    sub_18000E4E8(&v54);
    v48 = sub_18000E4E8(&v57);
    sub_180027880(pExceptionObject, v48, 395, (__int64)&v54, 0);
    throw (Spectre::Engine::EngineInvalidArgException *)pExceptionObject;
  }
  v37 = (_QWORD *)v60;
  v38 = (_DWORD **)(v60 + 8);
  result = sub_180103750((__int64 *)(v60 + 8), v5);
  if ( v5 )
  {
    v15 = *v38;
    v39 = (int *)(v7 + 4);
...
LABEL_55:
  *v37 = v4;
  ...
  v78 = _mm_load_si128(xmmword_180145F90);
  LOBYTE(v77[0]) = 0;
  v45 = v74;
  if ( v74 >= 0x10 )
  {
