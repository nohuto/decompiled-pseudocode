/*
 * XREFs of sub_180038F50 @ 0x180038F50
 * Callers:
 *     <none>
 * Callees:
 ...
 *     sub_1800D31A0 @ 0x1800D31A0 (sub_1800D31A0.c)
 *     __security_check_cookie @ 0x1801261A0 (__security_check_cookie.c)
 *     _guard_dispatch_icall_nop @ 0x180127740 (_guard_dispatch_icall_nop.c)
 */

// Hidden C++ exception states: #wind=2
char __fastcall sub_180038F50(_QWORD *a1, __int64 a2, unsigned int a3, int a4, char *String)
{
  __int64 v6; // r14
  const char *v9; // rdi
  char result; // al
