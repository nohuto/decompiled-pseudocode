/*
 * XREFs of sub_18007C700 @ 0x18007C700
 * Callers:
 ...
 *     sub_18006CE44 @ 0x18006CE44 (sub_18006CE44.c)
...
__int64 __fastcall sub_18007C700(__int64 a1, unsigned __int64 *a2)
{
  __int64 result; // rax
...
LABEL_3:
  if ( v6 )
  {
    ...
    sub_180072DF8((__int64 **)(a1 + 1440), (__int64)&v37, &v48);
    *(_QWORD *)(v37 + 40) = v50;
    sub_180072D50((__int64 ***)(a1 + 1424), (__int64)&v38, &v48);
    v7 = v38;
    v8 = (char *)(v38 + 64);
    v29 = 0LL;
    v30 = 0LL;
    sub_18001115C(&v28, v38 + 64);
    v9 = v29;
    ...
    if ( !v9 )
    {
      ...
      if ( (_QWORD)v47 )
      {
        v14 = sub_18006CE9C(v47, v45);
        v15 = sub_18006CE6C(v13, v44);
        v16 = sub_18006CE44(v13, v43);
        ...
        v17[3] = 7LL;
        *(_WORD *)v17 = 0;
        v18 = (_QWORD *)sub_18001C908((__int64)v42, &v33, (__int64)v15);
        ...
        v19[3] = 7LL;
        *(_WORD *)v19 = 0;
        v20 = sub_18001C908((__int64)v41, &v31, (__int64)v14);
        if ( v8 != (char *)v20 )
        {
          v21 = (void *)v20;
          if ( *(_QWORD *)(v20 + 24) >= 8uLL )
            v21 = *(void **)v20;
          sub_180026278(v8, v21, *(_QWORD *)(v20 + 16));
        }
