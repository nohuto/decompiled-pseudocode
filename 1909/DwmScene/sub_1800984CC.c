/*
 * XREFs of sub_1800984CC @ 0x1800984CC
 * Callers:
...
__int64 __fastcall sub_1800984CC(__int64 a1, __int64 *a2)
{
  __int64 v4; // rcx
  __int64 v5; // rbx
  ...
  *(_QWORD *)(a1 + 160) = 0LL;
  *(_BYTE *)(a1 + 168) = -1;
  *(_OWORD *)(a1 + 172) = xmmword_18025EF88;
  v5 = *a2;
  sub_180087524(*a2);
  *(_QWORD *)(v5 + 448) |= 8uLL;
  sub_180097E90((__int64 *)(a1 + 104), 1uLL, a1 + 104);
