/*
 * XREFs of sub_18003B7FC @ 0x18003B7FC
 * Callers:
...
__int64 __fastcall sub_18003B7FC(__int64 a1, __int64 a2)
{
  _QWORD *v4; // r12
  _QWORD *v5; // r14
  ...
  *((_QWORD *)&v24 + 1) = v8;
  v9 = a2 + 8;
  sub_180039C68(a2 + 8, (__int64)&v24, *(_DWORD *)a2, v7);
  v10 = (__int64 *)sub_18009EC74(*v5, v35, *(unsigned int *)(a1 + 88));
  ...
  {
    sub_18000E4E8(v38);
    v23 = sub_18000E4E8(v37);
    sub_180027880(v41, v23, 411, (__int64)v38, 0);
  ...
  if ( *(_BYTE *)(a2 + 4) )
  {
    ...
    {
      sub_18000E4E8(v40);
      v22 = sub_18000E4E8(v39);
      sub_180027880(pExceptionObject, v22, 418, (__int64)v40, 0);
    ...
    *((_QWORD *)&v25 + 1) = v17;
    sub_180039C68(v9, (__int64)&v25, 3, 64);
    sub_180015F14(v4, &v31, 1u);
    ...
    *((_QWORD *)&v26 + 1) = v19;
    result = sub_180039C68(v9, (__int64)&v26, 3, 1);
    if ( *((_QWORD *)&v43 + 1) )
    {
