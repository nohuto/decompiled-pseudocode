/*
 * XREFs of sub_1800CD334 @ 0x1800CD334
 * Callers:
 *     sub_1800CE8F0 @ 0x1800CE8F0 (sub_1800CE8F0.c)
 * Callees:
...
_QWORD *__fastcall sub_1800CD334(__int64 a1, _QWORD *a2, __int64 a3, __int64 *a4)
{
  __int64 v7; // rbx
