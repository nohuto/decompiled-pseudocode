/*
 * XREFs of sub_1800F5F30 @ 0x1800F5F30
 * Callers:
...
__int64 __fastcall sub_1800F5F30(__int64 a1, unsigned __int16 a2, __int64 *a3)
{
  __int64 *v6; // rsi
  _DWORD *v7; // rax
  __int64 result; // rax
  ...
  if ( !sub_1800F3134(*(_QWORD *)(a1 + 16), a2) )
  {
    ...
    sub_180027880(v26, v17, 433, v16, 0);
  ...
  if ( v7[9] != 8 )
  {
    ...
    sub_180027880(v27, v18, 437, (__int64)v21, 0);
  ...
  if ( v7[12] == 2 )
  {
    ...
    sub_180027880(pExceptionObject, v12, 442, (__int64)v23, 0);
