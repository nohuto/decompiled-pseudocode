/*
 * XREFs of sub_180119DC0 @ 0x180119DC0
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall sub_180119DC0(__int64 a1, __int64 *a2, _BYTE *a3, int a4, void *a5)
{
  void *v5; // rbx
    ...
    && (qword_18025EE78 & 0x400000000000LL) == qword_18025EE78 )
  {
    ...
    v32 = v11;
    v33 = v10 + 1;
    sub_180001128((__int64)&dword_18025EE60, (unsigned __int8 *)dword_180225605, 0LL, 0LL, 9u, &v17);
  }
