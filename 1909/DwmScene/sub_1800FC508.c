/*
 * XREFs of sub_1800FC508 @ 0x1800FC508
 * Callers:
...
__int64 __fastcall sub_1800FC508(float a1, float a2, char a3, int a4, __int64 *a5, __int64 *a6, __int64 *a7)
{
  float v8; // xmm11_4
  float v9; // xmm6_4
  int v10; // xmm9_4
  ...
  do
  {
    ...
    do
    {
      ...
      *(float *)&v19 = (float)((float)v12 * v9) - a1;
      if ( a5[2] == v13 )
      {
        sub_1800FB710(a5, v13, (__int64)&v19);
      }
      else
      {
        v14 = v20;
      ...
      if ( a6[2] == v15 )
      {
        result = sub_1800FB710(a6, v15, (__int64)&v21);
      }
      else
      {
        result = v22;
      ...
      *(float *)&v18 = (float)v12 / v8;
      if ( (char *)a7[2] == v17 )
      {
        result = sub_1800FB5CC(a7, v17, &v18);
      }
      else
      {
        *(_QWORD *)v17 = v18;
