/*
 * XREFs of sub_18011F0A0 @ 0x18011F0A0
 * Callers:
...
__int64 __fastcall sub_18011F0A0(__int64 a1, __int64 *a2, double a3)
{
  __int64 *v3; // rbx
  ...
  do
    ++v5;
  while ( *((_WORD *)a2 + v5) );
  sub_180026278((char *)v8, a2, v5);
  sub_180121C7C(a1 + 64, v11, v8);
  v6 = v11[0];
