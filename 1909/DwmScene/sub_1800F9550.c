/*
 * XREFs of sub_1800F9550 @ 0x1800F9550
 * Callers:
...
char __fastcall sub_1800F9550(_QWORD *a1, float a2, float a3, float a4, char a5, int a6)
{
  __int64 v7; // rcx
  __int64 v8; // rax
  __int64 v9; // rcx
    ...
    || HIDWORD(v20) != a6 )
  {
    ...
    *(_QWORD *)&v17 = __PAIR64__(LODWORD(a3), LODWORD(a4));
    BYTE8(v17) = a5;
    HIDWORD(v20) = a6;
    LOBYTE(v8) = sub_1800CC1A0(v7, (__int64)&v16, 0LL);
    v9 = a1[8];
    if ( v9 )
    {
      v10 = *(_QWORD *)(v9 + 112);
      ...
      *(_QWORD *)&v17 = __PAIR64__(LODWORD(a3), LODWORD(a4));
      BYTE8(v17) = a5;
      LOBYTE(v8) = sub_1800CC1A0(v9, (__int64)&v16, 0LL);
    }
    v11 = a1[10];
    if ( v11 )
    {
      ...
      *(_QWORD *)&v17 = __PAIR64__(LODWORD(a3), LODWORD(a4));
      BYTE8(v17) = a5;
      LOBYTE(v8) = sub_1800CC1A0(v11, (__int64)&v16, 0LL);
    }
    v13 = a1[12];
    if ( v13 )
    {
      ...
      *(_QWORD *)&v17 = __PAIR64__(LODWORD(a3), LODWORD(a4));
      BYTE8(v17) = a5;
      LOBYTE(v8) = sub_1800CC1A0(v13, (__int64)&v16, 0LL);
    }
  }
  return v8;
}
