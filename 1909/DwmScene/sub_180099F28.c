/*
 * XREFs of sub_180099F28 @ 0x180099F28
 * Callers:
 ...
 *     sub_18006CED0 @ 0x18006CED0 (sub_18006CED0.c)
 *     sub_180081DBC @ 0x180081DBC (sub_180081DBC.c)
 *     GsDriverEntry @ 0x180085BBC (GsDriverEntry.c)
 *     sub_180096488 @ 0x180096488 (sub_180096488.c)
 *     sub_1800964EC @ 0x1800964EC (sub_1800964EC.c)
 *     sub_18009654C @ 0x18009654C (sub_18009654C.c)
 *     sub_18009810C @ 0x18009810C (sub_18009810C.c)
 *     sub_18009A750 @ 0x18009A750 (sub_18009A750.c)
 *     sub_18009C748 @ 0x18009C748 (sub_18009C748.c)
 *     sub_18009CE10 @ 0x18009CE10 (sub_18009CE10.c)
...
_QWORD *__fastcall sub_180099F28(
        __int64 a1,
        _QWORD *a2,
        __int64 a3,
        unsigned int a4,
        ...
        char a11)
{
  ...
  v57[3] = (__int64)a5;
  v55 = 0;
  sub_1800176CC(&v72, a8);
  v14 = sub_18009A750(&v72);
  if ( *((float *)&v72 + 3) != 0.0 || v73 != 0.0 || v74 != 0.0 || (v15 = 1, v75 != 1.0) )
    v15 = 0;
  if ( !v14 || !v15 )
  {
    sub_180081DBC(&v72, &xmmword_18025EFE0);
    ...
    sub_18011DA98(&unk_18025D740, 4LL, v19, *(_QWORD *)(v52 + 368));
    if ( *((_QWORD *)&v52 + 1) )
    {
  ...
  v23 = sub_18006CED0(v64);
  v24 = sub_1800E2690(v23, a6, a4);
  *a2 = 0LL;
  a2[1] = 0LL;
  v57[4] = (__int64)&v56;
  v57[0] = a1;
  v25 = sub_18009810C(&v58, v57, &v64);
  v56 = 0LL;
  v56 = *(_OWORD *)v25;
  *v25 = 0LL;
  v25[1] = 0LL;
  v26 = sub_18006CED0(v64);
  sub_1800E286C(v26, a2, v24, &v56);
  v55 = 1;
  v27 = v59;
  if ( v59 )
  {
  ...
  if ( *(_BYTE *)(a1 + 72) )
  {
    v28 = sub_18009654C(*a5);
    v29 = sub_180096488(*a5);
    sub_18011DA98(&unk_18025D740, 3LL, "MeshInstance: Vertex count %u", v28);
    sub_18011DA98(&unk_18025D740, 3LL, "MeshInstance: Index count  %u", v29);
    sub_18011DA98(&unk_18025D740, 3LL, "MeshInstance: Index per Vertex count %f", (float)((float)v29 / (float)v28));
    if ( v28 )
    {
      v50 = 0LL;
      v51 = 0LL;
      ...
      if ( v30 )
      {
        while ( 1 )
        {
          ...
          if ( v34 == _InterlockedCompareExchange((volatile signed __int32 *)(v30 + 8), v34 + 1, v34) )
          {
            v31 = *(_QWORD *)(a1 + 64);
            *((_QWORD *)&v49 + 1) = v31;
            sub_180012680(*(_QWORD *)(a1 + 56), &v50);
            goto LABEL_43;
          }
        }
      }
      v31 = 0LL;
      sub_180012680(0LL, &v50);
LABEL_43:
      if ( v31 )
      {
      ...
      if ( fdtest(&Px) > 0 || (v66 = (float)(a9[1] + *a9) + a9[2], fdtest(&v66) > 0) )
      {
        ...
        sub_18011DA98(&unk_18025D740, 4LL, v41, a7);
        v39 = 0;
        if ( v71.m128i_i64[1] >= 0x10uLL )
        {
          v42 = v70[0];
      ...
      if ( v39 )
      {
        ...
        *(float *)&v67[4] = a10[1];
        *(float *)&v67[5] = a10[2];
        sub_18009CE10(v32, v67);
      }
      else
      {
LABEL_92:
        v47 = sub_1800964EC(*a5, &v62, 0);
        sub_18009C748(v32, v47, (unsigned int)v28);
        v48 = v63;
        if ( v63 )
        {
