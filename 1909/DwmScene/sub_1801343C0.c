/*
 * XREFs of sub_1801343C0 @ 0x1801343C0
 * Callers:
 *     <none>
 * Callees:
...
void __fastcall __noreturn sub_1801343C0(__int64 a1, _QWORD *a2)
{
  __int64 v3; // rdi
  char *v4; // rbx
  char *v5; // r14
  ...
  sub_18011E7FC((__int64 *)v5, *LocaleT, v7);
  v9 = a2[8];
  sub_180011218((__int64)v6, v9, (__int64)*LocaleT);
  *LocaleT = (__int64 *)v9;
  throw;
}
