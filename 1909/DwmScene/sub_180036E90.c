/*
 * XREFs of sub_180036E90 @ 0x180036E90
 * Callers:
 *     <none>
 * Callees:
...
void __fastcall sub_180036E90(__int64 a1, int a2, __int64 *a3, unsigned int a4)
{
  __int64 v5; // rcx
  __int64 v8; // r8
  __int64 v9; // rbx
  ...
  if ( *a3 )
  {
    ...
    v18 = 0LL;
    v19 = 0LL;
    sub_18009F9A4(v5, &v18, v8);
    v14 = 0LL;
    v15 = 0LL;
    sub_180032EFC(&v14, &v18);
    v9 = *(_QWORD *)(v14 + 184);
    v16 = v9;
    if ( v9 )
