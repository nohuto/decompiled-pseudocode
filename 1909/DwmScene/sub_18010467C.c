/*
 * XREFs of sub_18010467C @ 0x18010467C
 * Callers:
...
__int64 __fastcall sub_18010467C(__int64 a1, unsigned __int64 a2, __int64 a3)
{
  __int64 v5; // rsi
        ...
        do
        {
          ...
          *(float *)&v27 = v17 * v8;
          ...
          if ( !v18 )
          {
            ...
            JUMPOUT(0x180104909LL);
          }
          (*(void (__fastcall **)(__int64, __m128 *, __int128 *))(*(_QWORD *)v18 + 16LL))(v18, &v32, &v29);
          v32 = _mm_min_ps(_mm_max_ps(v32, (__m128)xmmword_180143E20), (__m128)xmmword_180143E10);
          *(__m128 *)(v25 + v30) = v32;
          ++v15;
          v25 += 16LL;
        }
  ...
  sub_180106004(v5, a2, &v30, 0LL);
  result = sub_1801041DC(v5);
  v21 = v30;
  if ( (_QWORD)v30 )
  {
