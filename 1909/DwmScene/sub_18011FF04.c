...
__int64 __fastcall sub_18011FF04(__int64 a1, _QWORD *a2, double *a3)
{
  ...
  if ( (unsigned __int8)sub_1801247BC(v9 + 64, v10) )
  {
    ...
    if ( (unsigned __int8)sub_180124844(v13) )
    {
      ...
      if ( (unsigned __int8)sub_1801247BC(v13, v14)
        && (v20[2] = 0LL,
            ...
            v15 = sub_180124658(v13, v20),
            (unsigned __int8)sub_180124834(v15)) )
      {
        *a3 = sub_1801246BC(v15);
        v11 = 0;
      }
      else
      {
    ...
    else if ( (unsigned __int8)sub_180124834(v13) )
    {
      *a3 = *(double *)(v13 + 48);
      v11 = 0;
    }
