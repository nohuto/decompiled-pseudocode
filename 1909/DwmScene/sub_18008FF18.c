/*
 * XREFs of sub_18008FF18 @ 0x18008FF18
 * Callers:
...
__int64 __fastcall sub_18008FF18(__int64 a1, __int64 a2, __int64 a3, __int64 *a4, char a5)
{
  __int64 v9; // rbx
  __int64 v10; // rax
  __int64 v11; // r9
  ...
  v32 = 0;
  v9 = *(_QWORD *)(a1 + 152);
  v10 = sub_180064400(*(_QWORD *)(a1 + 136));
  v11 = *(unsigned int *)(*a4 + 104);
  v39 = 0LL;
  v40 = 0LL;
  sub_1800A90D0(*(_QWORD *)(a1 + 136), &v39, v9 | v10 | a3, v11);
  if ( v39 )
  {
    v12 = *a4;
    v35 = 0LL;
    ...
    if ( !v16 )
    {
      ...
      for ( i = 0; i < 6; ++i )
      {
        if ( ((1 << i) & v42) != 0 )
        {
          v21 = *(_QWORD *)sub_1800F8490(v39, v37, i);
          v22 = v38;
          if ( v38 )
          {
      ...
      sub_1800F7424(v39, (_DWORD)a4, (*(_BYTE *)(a1 + 112) & 0x40) == 0, v32, a5);
      sub_1800F4B70(*(_QWORD *)(a1 + 120), a4, v32);
      v23 = *(_QWORD *)(a1 + 168);
      if ( v23 )
      {
        v24 = *(__int64 **)(v23 + 128);
...
LABEL_40:
        ...
        if ( v25 == v24 )
        {
          ...
          sub_1800CC010(*(_QWORD *)(a1 + 168), &v41);
