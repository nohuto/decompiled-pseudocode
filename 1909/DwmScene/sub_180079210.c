/*
 * XREFs of sub_180079210 @ 0x180079210
 * Callers:
 *     <none>
 * Callees:
 ...
 *     sub_18007F65C @ 0x18007F65C (sub_18007F65C.c)
...
__int64 __fastcall sub_180079210(__int64 a1, __int64 a2)
{
  int i; // eax
  int v4; // eax
  ...
  sub_1800635BC(a1 + 8, a2);
  for ( i = sub_180077C8C(a1); i; i = sub_180077C8C(a1) )
  {
    v4 = sub_180077C8C(a1);
    v17 = 0LL;
    v18 = 0LL;
    sub_180077BAC(a1, &v17, v4 - 1);
    sub_180076718(a1, &v17);
    if ( v18 )
    {
  ...
  v7 = a1 + 728;
  v8 = *(_QWORD *)(a1 + 728);
  sub_18007E450(a1 + 728, *(_QWORD *)(v8 + 8));
