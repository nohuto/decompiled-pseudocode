/*
 * XREFs of sub_1800E17A8 @ 0x1800E17A8
 * Callers:
...
_QWORD *__fastcall sub_1800E17A8(_QWORD *a1)
{
  int v2; // ebx
  _BYTE *v3; // rdi
  __int64 v4; // rbp
  ...
  `eh vector constructor iterator'(
    ...
    0x28uLL,
    0x40uLL,
    (void (*)(void *))sub_1800E1790,
    (void (*)(void *))sub_1800425D0);
  v2 = 0;
  v3 = a1;
  v4 = 15LL;
  v5 = 31LL;
  do
  {
    sub_18000E05C(v86, v2);
    v6 = sub_180056A54(v86, 0LL, "System", 6uLL);
    v82 = *(_OWORD *)v6;
    v83 = *((_OWORD *)v6 + 1);
    v6[2] = 0LL;
    v6[3] = (const void *)15;
    *(_BYTE *)v6 = 0;
    sub_180017D44(&a1[4 * v2 + 1 + v2], (__int64)&v82);
