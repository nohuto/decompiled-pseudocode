/*
 * XREFs of sub_1800F8BDC @ 0x1800F8BDC
 * Callers:
...
__int64 __fastcall sub_1800F8BDC(__int64 a1, __int64 *a2)
{
  __int128 v4; // xmm6
  __int64 result; // rax
  ...
  v15[2] = 0LL;
  v15[3] = 0LL;
  sub_18000F444(v15, (__int64)a2);
  result = sub_1800F8CD4(a1, v15, v4, v12);
  v6 = a2[3];
  if ( v6 >= 0x10 )
  {
    v7 = v6 + 1;
