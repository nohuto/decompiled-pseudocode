/*
 * XREFs of sub_180099600 @ 0x180099600
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall sub_180099600(__int64 a1, __int64 *a2)
{
  __int64 result; // rax
  unsigned int v5; // esi
  _QWORD *v6; // rbp
  ...
  for ( i = *(_QWORD **)(a1 + 104); i != v6; i += 11 )
  {
    v8 = i[3];
    if ( v8 )
      result = sub_1800F5520(v8, v5);
    v9 = i[5];
    if ( v9 )
      result = sub_1800F5520(v9, v5);
    v10 = i[7];
    if ( v10 )
      result = sub_1800F5520(v10, v5);
    v11 = i[9];
    if ( v11 )
      result = sub_1800F5520(v11, v5);
  }
