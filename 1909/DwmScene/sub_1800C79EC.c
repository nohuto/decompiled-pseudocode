/*
 * XREFs of sub_1800C79EC @ 0x1800C79EC
 * Callers:
 ...
 *     sub_1800FE58C @ 0x1800FE58C (sub_1800FE58C.c)
 *     sub_1800FE5A8 @ 0x1800FE5A8 (sub_1800FE5A8.c)
 *     __security_check_cookie @ 0x1801261A0 (__security_check_cookie.c)
 *     _guard_dispatch_icall_nop @ 0x180127740 (_guard_dispatch_icall_nop.c)
 */

// Hidden C++ exception states: #wind=2
__int64 __fastcall sub_1800C79EC(__int64 a1, _QWORD *a2, char a3, char a4)
{
  __int64 result; // rax
  __int64 v9; // r10
  __int64 v10; // r9
  ...
  if ( *a2 )
  {
    ...
    v16 = sub_180077A8C(a1, *(_DWORD *)(v38 + 112));
    v36 = qword_18025EEE8;
    v37 = dword_18025EEF0;
    v17 = 0.0;
    v30 = 0LL;
    v31 = 0LL;
    result = (__int64)sub_1800C1EE4(a1, &v30, (__int64 *)&v38);
    if ( v30 )
    {
      v28 = 0LL;
      v29 = 0LL;
      sub_180012680(v30, &v28);
      result = v28;
      if ( v28 )
      {
        v18 = *(float *)(v28 + 104);
    ...
    if ( a3 )
    {
      *(double *)v25.m128_u64 = (*(double (__fastcall **)(__int64, void *))(*(_QWORD *)v16 + 88LL))(v16, &unk_18025C038);
      v25.m128_f32[0] = v25.m128_f32[0] * v17;
      v34 = 0;
      v32 = _mm_unpacklo_ps((__m128)0LL, v25).m128_u64[0];
      v33 = 0;
      result = sub_1800FE58C(*a2, &v32);
    }
    if ( a4 )
    {
      v26 = *a2;
      (*(void (__fastcall **)(__int64, void *))(*(_QWORD *)v16 + 88LL))(v16, &unk_18025BE38);
      result = sub_1800FE5A8(v26);
    }
    if ( *((_QWORD *)&v38 + 1) )
    {
