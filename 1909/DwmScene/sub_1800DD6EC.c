/*
 * XREFs of sub_1800DD6EC @ 0x1800DD6EC
 * Callers:
...
_QWORD *__fastcall sub_1800DD6EC(__int64 a1, _QWORD *a2, int a3)
{
  __int64 v3; // r14
  _QWORD **v6; // rsi
  _QWORD *v7; // rax
  ...
  if ( !*v6 )
  {
    v7 = (_QWORD *)sub_18006CE94(*(_QWORD *)(a1 + 32));
    sub_180026880(v7, &v14, 1u);
    ...
    v9 = (int)ceilf((float)*(int *)(a1 + 8) / flt_1801F9038[v3]);
    v10 = ceilf((float)*(int *)(a1 + 12) / flt_1801F9038[v3]);
    if ( v9 < 1 )
      v9 = 1;
    v11 = (int)v10;
    if ( (int)v10 < 1 )
      v11 = 1;
    sub_1800D0458(*v6, v9, v11, 1u, 0, *(_QWORD *)(a1 + 32));
  }
  *a2 = 0LL;
  a2[1] = 0LL;
