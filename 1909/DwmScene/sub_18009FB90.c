/*
 * XREFs of sub_18009FB90 @ 0x18009FB90
 * Callers:
...
__int64 __fastcall sub_18009FB90(__int64 a1, __int64 a2, __int64 *a3, _QWORD *a4)
{
  __int64 v5; // rcx
  ...
  *a3 = 0LL;
  ...
  v10[2] = 0LL;
  v10[3] = 0LL;
  sub_18000F444(v10, a2);
  sub_1800A7764(a1 + 16, v10, &v8, &v7, -2LL, v7, *((_QWORD *)&v7 + 1), v8, v9);
  return a1;
}
