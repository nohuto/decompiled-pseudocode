/*
 * XREFs of sub_180076FD4 @ 0x180076FD4
 * Callers:
...
unsigned __int64 __fastcall sub_180076FD4(_QWORD *a1, __int64 *a2)
{
  ...
  v30 = 0LL;
  v31 = 0LL;
  sub_1800632D0((__int64)(a1 + 1), &v30);
  v28 = 0LL;
  v29 = 0LL;
  sub_1800632D0((__int64)(a1 + 138), &v28);
  v26 = 0LL;
  v27 = 0LL;
  sub_1800632D0(*a2 + 24, &v26);
  v4 = sub_18006CEC8(*a2);
  v5 = (const char *)sub_18001DA04(v20);
  if ( *((_QWORD *)v5 + 3) >= 0x10uLL )
    v5 = *(const char **)v5;
  sub_18011DA98(&unk_1802596D8, 3LL, "Engine::DetachDevice() -- detaching device id %u -- %s", v4, v5);
  if ( v21 >= 0x10 )
  {
    v6 = v20[0];
    if ( v21 + 1 >= 0x1000 )
  ...
  *((_QWORD *)&v17 + 1) = v7;
  ...
  if ( v10 != v11 )
  {
    do
    {
      v24 = 0LL;
      v25 = 0LL;
      sub_1800632D0(*v10 + 16, &v24);
      sub_18006EDF4(*v10, (__int64)v32);
      if ( (_BYTE)v25 )
        sub_180063778(v24);
      v10 += 2;
    }
  ...
  if ( (_BYTE)v29 )
    result = sub_180063778(v28);
  if ( (_BYTE)v31 )
    result = sub_180063778(v30);
