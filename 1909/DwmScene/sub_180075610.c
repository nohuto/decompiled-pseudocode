/*
 * XREFs of sub_180075610 @ 0x180075610
 * Callers:
 *     <none>
 * Callees:
 ...
 *     sub_1800836C4 @ 0x1800836C4 (sub_1800836C4.c)
...
__int64 __fastcall sub_180075610(__int64 a1, __int64 *a2)
{
  __int64 v4; // rbx
  __int64 v5; // r8
  __int64 v6; // rcx
  ...
  *(_QWORD *)&v14 = v22;
  ...
  v22[2] = 0LL;
  v22[3] = 0LL;
  sub_18001115C(v22, (__int64)&unk_1802597E8);
  v4 = *a2;
  v5 = sub_1800836C4(&v15);
  sub_180089B48(v4, &v23, v5, v22);
  ...
  v19 = 0;
  v7 = v13;
  sub_180011764((__int64 *)(v13 + 24), &Src);
  if ( v21 >= 0x10 )
  {
    v8 = Src;
    if ( v21 + 1 >= 0x1000 )
