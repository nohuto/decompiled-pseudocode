/*
 * XREFs of sub_18006B158 @ 0x18006B158
 * Callers:
...
_QWORD *__fastcall sub_18006B158(_QWORD *a1, _QWORD *a2, _QWORD *a3)
{
  __int64 v6; // rax
  __int64 v7; // rcx
  _QWORD *v8; // rdx
  ...
  *a2 = 0LL;
  ...
  v19 = 0LL;
  v20 = 0LL;
  sub_1800632D0((__int64)(a1 + 101), &v19);
  v6 = a2[1];
  if ( v6 )
  {
