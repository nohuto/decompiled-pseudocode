/*
 * XREFs of sub_180091700 @ 0x180091700
 * Callers:
...
__int64 __fastcall sub_180091700(__int64 a1, __int64 *a2, __int64 a3, int a4)
{
  ...
  *(_DWORD *)(a1 + 32) = 1;
  v15 = (float)a4;
  sub_1800913CC((_QWORD *)(a1 + 40), 1uLL, &v15);
...
LABEL_9:
    sub_18000E4E8(v19);
    v14 = sub_18000E4E8(v18);
    sub_180027880(pExceptionObject, v14, 436, (__int64)v19, 0);
