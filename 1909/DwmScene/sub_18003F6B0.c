/*
 * XREFs of sub_18003F6B0 @ 0x18003F6B0
 * Callers:
...
int __fastcall sub_18003F6B0(__int64 a1)
{
  _UNKNOWN **v1; // rax
  int v2; // edi
  void *v3; // rax
  ...
  if ( !*(_QWORD *)(a1 + 512) )
  {
    ...
    if ( (int)v1 < 0 )
    {
      ...
      sub_18000E4E8(v12);
      v7 = (unsigned int)sub_18000E4E8(v11);
      v9 = 0;
      sub_180065920((unsigned int)pExceptionObject, v7, 138, v2, (__int64)v12, v9, -2LL);
