/*
 * XREFs of sub_18009DF38 @ 0x18009DF38
 * Callers:
...
__int64 __fastcall sub_18009DF38(__int64 a1, _QWORD *a2, char a3)
{
  int **v6; // rcx
  int *v7; // rax
  int v8; // r11d
  ...
  if ( v15 )
    ...
    v16 = 0;
  LODWORD(v20) = 0;
  sub_18009E070(a1, v16, v14, v12, v10, v8, a3, 0LL, v20, 0LL);
  v17 = a2[1];
  v21 = 0LL;
  if ( v17 )
  {
