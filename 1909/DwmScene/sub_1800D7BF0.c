/*
 * XREFs of sub_1800D7BF0 @ 0x1800D7BF0
 * Callers:
...
__int64 __fastcall sub_1800D7BF0(__int64 a1, __int64 a2, char a3)
{
  __int64 v3; // rdx
  __int64 result; // rax
  __int64 v7; // rbp
  ...
  if ( v7 >> 1 > 0 )
  {
    ...
    do
    {
      ...
      *(_BYTE *)(v9 - 24) = 0;
      ...
      v16 = v11;
      v17 = v12;
      result = sub_1800D815C(a1, v8, v7, &v15, v14);
