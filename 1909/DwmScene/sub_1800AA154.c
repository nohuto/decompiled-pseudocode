/*
 * XREFs of sub_1800AA154 @ 0x1800AA154
 * Callers:
...
_QWORD *__fastcall sub_1800AA154(_QWORD **a1, _QWORD *a2, _QWORD *a3, _QWORD *a4)
{
  _QWORD *v5; // rbx
  _QWORD *v8; // rsi
  _QWORD *v9; // r8
  ...
  {
    sub_1800A9FA8((__int64)a1, (__int64 ***)v8[1]);
    (*a1)[1] = v8;
    **a1 = v8;
    (*a1)[2] = v8;
    a1[1] = 0LL;
