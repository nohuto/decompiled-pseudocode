/*
 * XREFs of sub_1800F5588 @ 0x1800F5588
 * Callers:
 ...
 *     sub_1800F3124 @ 0x1800F3124 (sub_1800F3124.c)
 *     memmove @ 0x180125BAC (memmove.c)
 */

__int64 __fastcall sub_1800F5588(__int64 a1, __int64 a2, int a3)
{
  ...
  sub_1800F2D08(*(_QWORD *)(a1 + 16));
  try
  {
    v6 = sub_1800F2454(*(_QWORD *)(a1 + 16), a2, a3);
    v7 = *(_QWORD *)(a1 + 16);
  }
  catch ( Spectre::Utils::SpectreException *v23 )
  {
    v21 = sub_18001153C(a1 + 16);
    sub_1800F2BD4(v21);
    sub_18000E6B8((__int64)v24, (__int64)v23);
    throw (Spectre::Utils::SpectreException *)v24;
  }
  sub_1800F2BD4(v7);
  v8 = *(_QWORD *)(a1 + 16);
  *(_BYTE *)(a1 + 148) = *(_BYTE *)(v8 + 1242);
  v9 = sub_1800F3058(v8, v6);
  v10 = v9;
  if ( *(_DWORD *)(v9 + 36) == 8 )
  {
    sub_1800F1A2C((_QWORD *)(a1 + 56), *(_QWORD *)(*(_QWORD *)(a1 + 16) + 104LL) + 40LL * *(unsigned int *)(v9 + 40));
  }
  else
  {
    v11 = sub_1800F3124(*(_QWORD *)(a1 + 16));
    sub_1800F175C(a1 + 32, v11);
    v12 = *(_DWORD *)(v10 + 36);
    v13 = 0LL;
