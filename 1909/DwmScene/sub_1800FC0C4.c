/*
 * XREFs of sub_1800FC0C4 @ 0x1800FC0C4
 * Callers:
...
__int64 *__fastcall sub_1800FC0C4(__int64 *a1, _QWORD *a2, __int64 a3, __int64 a4, char a5, int a6, char a7)
{
  __int64 *v7; // r13
  unsigned int v8; // edi
  int v9; // r8d
  ...
  LOBYTE(v9) = a5;
  sub_1800FC508(v11, v10, v9, v8, (__int64)&v46, (__int64)&v44, (__int64)v43);
  v12 = v8 + 1;
  v41 = 0LL;
  v42 = 0LL;
  if ( a5 )
    ...
    if ( v8 )
    {
      ...
      do
      {
        ...
        if ( v21 > 1 )
        {
          ...
          if ( *((_BYTE **)&v42 + 1) == v23 )
          {
            sub_1800FB8B0((const void **)&v41, v23, v34);
            v23 = (_BYTE *)v42;
          }
          else
          {
        ...
        for ( i = 0; i <= v8; ++i )
        {
          ...
          if ( *((_BYTE **)&v42 + 1) == v26 )
          {
            sub_1800FB8B0((const void **)&v41, v26, v34);
            v23 = (_BYTE *)v42;
          }
          else
          {
    ...
    if ( v8 )
    {
      ...
      do
      {
        ...
        if ( v13 > 1 )
        {
          ...
          if ( *((_BYTE **)&v42 + 1) == v15 )
          {
            sub_1800FB8B0((const void **)&v41, v15, v34);
            v15 = (_BYTE *)v42;
          }
          else
          {
        ...
        else
        {
          ...
          do
          {
            ...
            if ( *((_BYTE **)&v42 + 1) == v19 )
            {
              sub_1800FB8B0((const void **)&v41, v19, v34);
              v15 = (_BYTE *)v42;
              v18 = v36;
            }
            else
  ...
  *v7 = 0LL;
  v7[1] = 0LL;
  sub_1800FBF88(v7, v38, 3, (__int64 *)&v46, (__int64 *)&v41, (__int64 *)&v44, (__int64 *)v43, a7, 1, 1);
  v35 = 1;
  sub_180095E9C(*v7, 0);
  v27 = v41;
  if ( v41 )
  ...
  sub_1800F6600((__int64 *)&v44);
  sub_1800F6600((__int64 *)&v46);
  return v7;
}
