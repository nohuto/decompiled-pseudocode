/*
 * XREFs of sub_18011C700 @ 0x18011C700
 * Callers:
 *     <none>
 * Callees:
...
void sub_18011C700(__int64 a1, _BYTE *a2, __int64 a3, ...)
{
  __int64 v3; // rax
  void *v4; // rcx
  bool v5; // zf
  ...
  if ( (unsigned int)dword_18025EE98 > 5 )
  {
    ...
    va_copy(v23, va1);
    v24 = 4LL;
    sub_180001128((__int64)&dword_18025EE98, (unsigned __int8 *)dword_180225C61, 0LL, 0LL, 8u, &v9);
  }
}
