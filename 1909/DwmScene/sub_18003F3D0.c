/*
 * XREFs of sub_18003F3D0 @ 0x18003F3D0
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall sub_18003F3D0(_QWORD *a1)
{
  __int64 v2; // rcx
  __int64 v3; // rcx
  __int64 result; // rax
  ...
  if ( v16 )
  {
    ...
    if ( v18 )
    {
      v14 = 0LL;
      v15 = 0LL;
      sub_180027778((__int64 *)&v14, &v18);
      v8 = sub_180033E2C(v14, &v24);
      v5 = *v8;
      *v8 = 0LL;
      v23 = v5;
      v9 = v24;
    ...
    v21 = 0LL;
    sub_180068A30(a1, &v21);
    v22[0] = 0LL;
    result = sub_1800688F8(a1, v22);
    if ( v5 )
    {
