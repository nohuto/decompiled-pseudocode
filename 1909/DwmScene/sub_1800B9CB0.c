/*
 * XREFs of sub_1800B9CB0 @ 0x1800B9CB0
 * Callers:
...
_QWORD *__fastcall sub_1800B9CB0(__int64 a1, _QWORD *a2, _QWORD *a3, _QWORD *a4)
{
  __int64 v8; // r8
  __int64 v9; // rdx
  ...
  sub_1800C1C08(a1, &v31, &v22, &v21, v21, *((_QWORD *)&v21 + 1), *a3, v11);
  if ( v31 )
  {
    v12 = (__int128 *)sub_1800BAD2C(v31, v28);
    v13 = 5;
  }
  else
  {
