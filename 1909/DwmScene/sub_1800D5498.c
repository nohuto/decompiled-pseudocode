/*
 * XREFs of sub_1800D5498 @ 0x1800D5498
 * Callers:
...
char __fastcall sub_1800D5498(__int64 a1, _QWORD *a2, __int64 a3)
{
  ...
  *(_QWORD *)(a1 + 192) = a3;
  if ( *(_BYTE *)(a1 + 184) )
  {
    ...
    *(_QWORD *)&v10 = *a2;
    *((_QWORD *)&v10 + 1) = v7;
    v8 = sub_1800D5314((_QWORD *)a1, &v10, *(_QWORD *)(a1 + 192));
  ...
  else
  {
    ...
    {
      (**(void (__fastcall ***)(volatile signed __int32 *, _QWORD *, __int64, __int64, __int64))v5)(
        v5,
        a2,
        a3,
        a1,
