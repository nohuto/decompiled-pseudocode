/*
 * XREFs of sub_1800F1208 @ 0x1800F1208
 * Callers:
...
__int64 __fastcall sub_1800F1208(_QWORD *a1, __int64 a2, __int64 a3)
{
  __int64 v5; // rsi
  __int64 v6; // rdx
  ...
  v19 = v10;
  v11 = sub_1800E9E48((__int64)a1, v10);
  v12 = v11;
  v22 = (__int64)v11;
  v21 = 56 * v5;
  v13 = &v11[7 * v5];
  ...
  try
  {
    ...
    *((_DWORD *)v13 + 12) = *(_DWORD *)(a3 + 48);
    ...
    if ( a2 != v14 )
    {
      sub_1800F1878(v17, a2, v12, a1, v10);
      v25 = v12;
      v15 = a1;
      v16 = v13 + 7;
      v14 = a1[1];
    ...
    sub_1800F1878(v17, v14, v16, v15, v19);
    sub_1800F39E8(a1, v12, v7, v10);
    result = v21 + *a1;
  }
  catch ( ... )
  {
    sub_1800F3BAC(a1, v25, v13 + 7);
    sub_180038DEC((__int64)a1, v22, v20);
    throw;
  }
  return result;
}
