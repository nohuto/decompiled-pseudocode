/*
 * XREFs of sub_1800B2608 @ 0x1800B2608
 * Callers:
 *     sub_1800B1D20 @ 0x1800B1D20 (sub_1800B1D20.c)
 * Callees:
 *     sub_1800B27D4 @ 0x1800B27D4 (sub_1800B27D4.c)
 */

float __fastcall sub_1800B2608(float a1, float a2, float a3, float a4)
{
  float v5; // xmm1_4
  float v6; // xmm1_4
  float v7; // xmm2_4
