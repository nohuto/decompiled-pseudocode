/*
 * XREFs of sub_18011D7AC @ 0x18011D7AC
 * Callers:
...
void __fastcall sub_18011D7AC(__int64 a1, int a2, int a3, __int64 a4)
{
  __int64 v4; // rsi
  int v6; // r13d
  size_t v7; // rbx
  ...
  v27 = -2LL;
  v4 = a2;
  if ( dword_18026C2A8 <= 0 )
  {
    v17 = *(_DWORD *)(a1 + 8);
    v6 = *(_DWORD *)(a1 + 4);
    v18 = *(_DWORD *)a1;
    v7 = -1LL;
    sub_180127444((unsigned int)v29, 2048, -1, a3, a4);
    v8 = unknown_libname_121(a1, v25);
    v9 = sub_18011D32C(&v23);
    if ( (unsigned __int64)v8[3] >= 0x10 )
      v8 = (__int64 *)*v8;
    v10 = (const char *)*(&off_18025F080 + 3 * v4);
    ...
    if ( (int)v4 >= v6 )
    {
      v20 = _mm_load_si128(xmmword_180145F90);
      LOBYTE(v19[0]) = 0;
      do
        ++v7;
      while ( Src[v7] );
      ...
      v22 = _mm_load_si128(xmmword_180145F90);
      LOBYTE(v21[0]) = 0;
      unknown_libname_113(v21, *(_BYTE **)(a1 + 16));
      sub_18011D5B4((__int64)v21, v4, (__int64)v19);
