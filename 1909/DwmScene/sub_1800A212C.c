/*
 * XREFs of sub_1800A212C @ 0x1800A212C
 * Callers:
...
__int64 __fastcall sub_1800A212C(__int64 *a1, __int64 a2, size_t *a3)
{
  __int64 *v6; // rax
  __int64 *v7; // rbx
  const void *v8; // rdx
...
LABEL_14:
    v16[0] = (__int64)a3;
    v14 = sub_1800A032C(a1, (__int64)&unk_1801F0900, v16);
    sub_1800706FC((__int64 ***)a1, v16, v7, v14 + 4, v14);
    *(_QWORD *)a2 = v16[0];
    *(_BYTE *)(a2 + 8) = 1;
    return a2;
  }
