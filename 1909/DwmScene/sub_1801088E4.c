/*
 * XREFs of sub_1801088E4 @ 0x1801088E4
 * Callers:
 *     sub_1801098BC @ 0x1801098BC (sub_1801098BC.c)
 * Callees:
 *     sub_1801083CC @ 0x1801083CC (sub_1801083CC.c)
 *     memcmp @ 0x180125BB8 (memcmp.c)
 */

__int64 __fastcall sub_1801088E4(_QWORD *a1, __int64 a2, char a3, size_t *a4, _QWORD *a5)
{
  _QWORD *v8; // r13
  __int64 *v9; // rbx
  ...
  try
  {
    *(_QWORD *)a2 = *sub_1801083CC(a1, &v25, v10, v8, (int)a4, v25);
    *(_BYTE *)(a2 + 8) = 1;
    result = a2;
  }
  catch ( ... )
  {
    sub_18010A464(v27, v26);
    throw;
  }
  return result;
}
