...
unsigned __int64 __fastcall sub_18009C760(_QWORD *a1, unsigned __int64 *a2, _BYTE *a3)
{
  __int64 v6; // rdx
  __int64 v7; // rbx
...
LABEL_3:
  ...
  result = sub_18008C968(a1 + 11, &v11, *(double *)&v16, *(double *)&v17);
  if ( *a3 )
  {
    v13 = xmmword_1801E48A0;
    v14 = 0x3F8000003F800000LL;
    result = sub_18008A500(&v13, a2, (unsigned __int64 *)&v11);
    *(_OWORD *)a2 = v13;
    a2[2] = v14;
  }
  else
