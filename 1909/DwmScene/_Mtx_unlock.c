/*
 * XREFs of _Mtx_unlock @ 0x180127520
 * Callers:
 *     sub_18000DB30 @ 0x18000DB30 (sub_18000DB30.c)
 *     ??1?$lock_guard@Vmutex@std@@@std@@QEAA@XZ @ 0x18000E82C (--1-$lock_guard@Vmutex@std@@@std@@QEAA@XZ.c)
 ...
 *     ??1?$unique_lock@Vmutex@std@@@std@@QEAA@XZ @ 0x1800205F8 (--1-$unique_lock@Vmutex@std@@@std@@QEAA@XZ.c)
