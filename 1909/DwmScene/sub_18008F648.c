/*
 * XREFs of sub_18008F648 @ 0x18008F648
 * Callers:
...
__int64 __fastcall sub_18008F648(__int64 **a1, __int64 a2, char a3, unsigned __int16 *a4, _QWORD *a5)
{
  __int64 *v8; // rdx
  __int64 *v9; // rsi
  __int64 v10; // rax
  ...
  {
    sub_1800646D8((__int64)v17, (__int64)v16);
    throw;
  }
  return result;
}
