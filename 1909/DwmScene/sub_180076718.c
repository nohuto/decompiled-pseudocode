...
__int64 __fastcall sub_180076718(__int64 a1, _QWORD *a2)
{
  __int64 v3; // rdi
  __int64 v4; // rbx
  __int64 v5; // r14
  ...
  *(_OWORD *)&v33[1] = v30;
  sub_180078B68(a1, 8LL, &v33[1], &v37);
  v64 = 0LL;
  v65 = 0LL;
  sub_1800632D0(a1 + 8, &v64);
  v62 = 0LL;
  v63 = 0LL;
  sub_180063288(a1 + 1104, &v62);
  v34 = 0LL;
  if ( v3 )
  {
    _InterlockedIncrement((volatile signed __int32 *)(v3 + 8));
  ...
  v34 = v30;
  sub_18007B318(a1, &v34);
  sub_18011DA98(
    &unk_1802596D8,
    3LL,
    "-----------------------------------------------------------------------------------");
  v6 = (const char *)sub_18001DA04(v44);
  v7 = v6;
  if ( *((_QWORD *)v6 + 3) >= 0x10uLL )
    v7 = *(const char **)v6;
  v8 = sub_18006CEC8(v30);
  sub_18011DA98(&unk_1802596D8, 3LL, "Engine::DeleteDevice() -- removing device id %u -- %s", v8, v7);
  if ( v45 >= 0x10 )
  {
    v9 = v44[0];
    if ( v45 + 1 >= 0x1000 )
  ...
  v48 = 0LL;
  v49 = 0LL;
  sub_180063468(a1 + 112, &v48);
  if ( sub_18006CE94(v30) != a1 )
    goto LABEL_83;
  v10 = *(_QWORD **)(a1 + 96);
  v39 = v10;
  ...
  {
LABEL_83:
    result = sub_18011DA98(&unk_1802596D8, 3LL, "Engine::DeleteDevice() -- device is not attached to this engine");
    if ( (_BYTE)v49 )
      result = sub_180063780(v48);
  }
  else
  {
    if ( (_BYTE)v49 )
    ...
    v58 = 0LL;
    v59 = 0LL;
    sub_1800632D0(v30 + 24, &v58);
    v12 = sub_18006CEC8(v30);
    v13 = sub_18006CF84(v30);
    v14 = 0;
    if ( v13 )
    {
      do
      {
        v46 = 0LL;
        v47 = 0LL;
        sub_18006CF04(v30, &v46, v14);
        v52 = 0LL;
        v53 = 0LL;
        sub_180063288(v46 + 8, &v52);
        v50 = 0LL;
        v51 = 0LL;
    ...
    if ( v5 )
    {
      ...
      v35 = v30;
      sub_180072F70((__int64 **)(a1 + 184), (__int64)&v42, &v35);
      v18 = v42;
      v19 = *(_QWORD *)(v42 + 56);
      if ( v19 )
      {
    ...
    v36 = v30;
    sub_180076FD4(a1, &v36);
    if ( sub_18006D658(v30) )
    ...
    sub_1800A4154(*(_QWORD *)(a1 + 512));
    sub_1800A3FB0(*(_QWORD *)(a1 + 512), v12);
    while ( (unsigned int)sub_18006CF84(v30) )
    {
      v56 = 0LL;
      v57 = 0LL;
      sub_18006CF04(v30, &v56, 0);
      sub_18006CC30(v30, &v56);
      v25 = v57;
      if ( v57 )
      {
    ...
    if ( sub_18006D658(v30) )
      sub_18006DB4C((_BYTE *)v30);
    if ( (_BYTE)v59 != (_BYTE)v5 )
      sub_180063778(v58);
    v60 = 0LL;
    v61 = 0LL;
    sub_1800632D0(a1 + 112, &v60);
    v26 = sub_180077DDC(a1, &v30);
    sub_18006E4D8(a1 + 88, &v40, *(_QWORD *)(a1 + 88) + 16LL * v26);
    ...
    *(_OWORD *)&v32[1] = 0LL;
    ...
    sub_18011DA98(&unk_1802596D8, 3LL, "Engine::DeleteDevice() -- completed");
    sub_18011DA98(
      &unk_1802596D8,
      3LL,
      "-----------------------------------------------------------------------------------");
    sub_180079C94(a1);
    sub_18007A1B4(a1);
    result = sub_180078CFC(a1);
    v4 = *((_QWORD *)&v30 + 1);
  }
  if ( (_BYTE)v63 != (_BYTE)v5 )
    result = sub_180063778(v62);
  if ( (_BYTE)v65 != (_BYTE)v5 )
    result = sub_180063778(v64);
  if ( v4 )
  {
