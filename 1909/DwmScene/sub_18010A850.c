/*
 * XREFs of sub_18010A850 @ 0x18010A850
 * Callers:
...
__int64 __fastcall sub_18010A850(_QWORD *a1, __int64 *a2, __int64 *a3, __int64 *a4, __int64 a5, __int64 *a6)
{
  _QWORD *v9; // rbx
  _QWORD *v10; // rdi
  __int64 v11; // rcx
  ...
  while ( v9 != v10 )
  {
    ...
    *(_QWORD *)&v40 = *a2;
    *((_QWORD *)&v40 + 1) = v15;
    sub_18010A850(*v9, (unsigned int)&v40, (unsigned int)&v39, (unsigned int)&v38, (__int64)v52, (__int64)&v37);
    v9 += 2;
  }
  v16 = *(_QWORD *)(a5 + 56);
  if ( !v16 )
  ...
  *(_BYTE *)(v21 + 72) = 0;
  ...
  result = sub_1800DB384((__int64)&v54);
