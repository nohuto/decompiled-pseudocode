/*
 * XREFs of sub_1800BD388 @ 0x1800BD388
 * Callers:
 *     sub_1800BD484 @ 0x1800BD484 (sub_1800BD484.c)
...
__int64 __fastcall sub_1800BD388(_QWORD *a1)
{
  __int64 v2; // rcx
