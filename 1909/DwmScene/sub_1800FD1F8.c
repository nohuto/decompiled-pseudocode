/*
 * XREFs of sub_1800FD1F8 @ 0x1800FD1F8
 * Callers:
 ...
 *     sub_180132C7C @ 0x180132C7C (sub_180132C7C.c)
 *     ?dtor$0@?0??do_put@?$money_put@_WV?$ostreambuf_iterator@_WU?$char_traits@_W@std@@@std@@@std@@MEBA?AV?$ostreambuf_iterator@_WU?$char_traits@_W@std@@@2@V32@_NAEAVios_base@2@_WO@Z@4HA_8 @ 0x180132D44 (-dtor$0@-0--do_put@-$money_put@_WV-$ostreambuf_iterator@_WU-$char_traits@_W@std@@@s_ea_180132D44.c)
 *     sub_180132D50 @ 0x180132D50 (sub_180132D50.c)
 * Callees:
 *     _guard_dispatch_icall_nop @ 0x180127740 (_guard_dispatch_icall_nop.c)
 */

__int64 __fastcall sub_1800FD1F8(_QWORD *a1, __int64 a2)
{
  _QWORD *v2; // rbx
  _QWORD *v4; // rcx
  __int64 result; // rax
