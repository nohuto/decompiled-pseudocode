/*
 * XREFs of __isa_available_init @ 0x180126C20
 * Callers:
...
int __cdecl _isa_available_init()
{
  ...
  if ( (v16 & 0x100000) != 0 )
  {
    ...
    if ( (v16 & 0x8000000) != 0 && (v16 & 0x10000000) != 0 )
    {
      ...
      if ( (_RAX & 6) == 6 )
      {
        v26 = dword_18025F278 | 8;
        dword_18025F274 = 3;
        dword_18025F278 |= 8u;
        if ( (v5 & 0x20) != 0 )
        {
          dword_18025F274 = 5;
          dword_18025F278 = v26 | 0x20;
        }
      }
    }
  }
