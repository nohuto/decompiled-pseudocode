/*
 * XREFs of sub_1800D2E34 @ 0x1800D2E34
 * Callers:
...
__int64 __fastcall sub_1800D2E34(__int64 a1, __int64 a2)
{
  __int64 v4; // rdx
  _QWORD ***v5; // r10
  __int64 v6; // rdx
  ...
  v16 = 0LL;
  v17 = 0LL;
  sub_1800632D0(a2 + 24, &v16);
  v5 = (_QWORD ***)sub_18006CDF8(a2, v4);
  v13 = 0LL;
  v6 = *(_QWORD *)(a1 + 104);
  if ( !v6 )
  {
LABEL_16:
  ...
  if ( v8 )
    ...
    v9 = 0;
  sub_18006ADD0(*v5, (__int64)&v13, *(_QWORD *)(a1 + 136), v9);
  ...
  v11 = sub_18006CEC8(a2);
  result = sub_1800644BC(a1, v11);
  if ( (_BYTE)v17 )
    return sub_180063778(v16);
  return result;
}
