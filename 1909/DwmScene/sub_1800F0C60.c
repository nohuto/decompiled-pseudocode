/*
 * XREFs of sub_1800F0C60 @ 0x1800F0C60
 * Callers:
 *     <none>
 * Callees:
...
_QWORD *__fastcall sub_1800F0C60(__int64 a1, _QWORD *a2, _DWORD *a3, __int64 a4)
{
  ...
  if ( (*a3 & 0x10000) == 0 )
  {
    v8 = (_QWORD *)sub_180078140(a1);
    v9 = sub_18009FC40(&Src, "Component::Clone() -- component '", v8);
    v10 = (_QWORD *)sub_18002C088((__int64)v18, v9, "' of type ");
    v11 = _RTtypeid(a1);
    v12 = (_BYTE *)sub_180088338(v11);
    v13 = (_QWORD *)sub_18002C088((__int64)v19, v10, v12);
    v14 = sub_18002C088((__int64)v20, v13, " does not support cloning.");
    v15 = sub_18000E4E8(v16);
    sub_180098268(pExceptionObject, v15, 43, v14, 0);
