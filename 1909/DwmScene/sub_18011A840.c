...
__int64 __fastcall sub_18011A840(__int64 a1, __int64 *a2, char a3, _BYTE *a4, __int64 a5, __int64 a6, __int64 a7)
{
  void *v7; // rbx
    ...
    && (qword_18025EE78 & 0x400000000000LL) == qword_18025EE78 )
  {
    ...
    v66 = 4LL;
    v68 = 4LL;
    sub_180001128((__int64)&dword_18025EE60, (unsigned __int8 *)dword_180224E3C, 0LL, 0LL, 0x17u, &v23);
  }
