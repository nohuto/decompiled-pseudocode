/*
 * XREFs of sub_1800CD430 @ 0x1800CD430
 * Callers:
 *     sub_1800CE910 @ 0x1800CE910 (sub_1800CE910.c)
 * Callees:
...
_QWORD *__fastcall sub_1800CD430(__int64 a1, _QWORD *a2, __int64 a3, __int64 *a4)
{
  __int64 v7; // rbx
