/*
 * XREFs of sub_180085C60 @ 0x180085C60
 * Callers:
...
unsigned __int64 __fastcall sub_180085C60(__int64 a1, __int64 *a2)
{
  __int64 v4; // rdx
...
LABEL_110:
  ...
  {
    sub_18000E4E8(v55);
    v38 = sub_18000E4E8(v54);
    sub_180027880(v58, v38, 605, (__int64)v55, 0);
  ...
  if ( *a2 )
  {
    ...
    *(_QWORD *)&v44 = *a2;
    *((_QWORD *)&v44 + 1) = v6;
    if ( (unsigned __int8)sub_180086F3C(a1, &v44) )
    {
      sub_18000E4E8(v57);
      v37 = sub_18000E4E8(v56);
      sub_180027880(pExceptionObject, v37, 608, (__int64)v57, 0);
  ...
  *(_QWORD *)(a1 + 64) = v17;
    ...
    if ( (_QWORD)v39 )
    {
      ...
      do
      {
        ...
        *(_QWORD *)(v19 + 80) = *((_QWORD *)&v41 + 1);
        ...
        v21 = sub_180083A24(v39, &v49, (__int64 *)&v42);
  ...
  if ( (_QWORD)v39 )
  {
    while ( 1 )
    {
      ...
      if ( v11 && (_QWORD)v60 )
      {
        ...
        v46 = v24;
        sub_18008A824(v60, &v46);
      }
      v27 = sub_180083A24(v39, &v51, v40.m128i_i64);
  ...
  v30 = _InterlockedExchangeAdd64(&qword_180259748, 1uLL);
  *(_QWORD *)(a1 + 208) = v30 + 1;
