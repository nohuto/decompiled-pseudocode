/*
 * XREFs of sub_180106394 @ 0x180106394
 * Callers:
 ...
 *     ?_Xinvalid_argument@std@@YAXPEBD@Z @ 0x180127708 (-_Xinvalid_argument@std@@YAXPEBD@Z.c)
 */

__int64 __fastcall sub_180106394(char *a1, _QWORD *a2, __int64 a3)
{
  unsigned int v3; // ebp
  char *v5; // rbx
  _DWORD *v6; // rax
