/*
 * XREFs of sub_1800F48A0 @ 0x1800F48A0
 * Callers:
...
__int64 __fastcall sub_1800F48A0(__int64 a1, __int64 *a2)
{
  __int64 v4; // rax
  __int64 v5; // rdx
  char **v6; // rax
  ...
  *(_QWORD *)(a1 + 88) = 0LL;
  *(_QWORD *)(a1 + 96) = 0LL;
  *(_QWORD *)(a1 + 88) = sub_18002565C();
  *(_DWORD *)(a1 + 104) = 0;
  *(_QWORD *)(a1 + 112) = 0LL;
  *(_QWORD *)(a1 + 120) = 0LL;
  *(_QWORD *)(a1 + 128) = 0LL;
  *(_QWORD *)(a1 + 136) = 0LL;
  *(_DWORD *)(a1 + 144) = sub_180064338(*a2);
  *(_BYTE *)(a1 + 148) = *(_BYTE *)(*a2 + 1242);
  v5 = *a2;
  v6 = (char **)(*a2 + 80);
  if ( (char **)(a1 + 32) != v6 )
  {
    sub_180016920(a1 + 32, *v6, *(_QWORD *)(*a2 + 88));
    v5 = *a2;
  }
  v7 = (__int64 *)(v5 + 104);
  if ( (__int64 *)(a1 + 56) != v7 )
    sub_1800F436C((__int64 *)(a1 + 56), *v7, v7[1]);
  return a1;
}
