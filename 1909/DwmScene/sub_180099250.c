/*
 * XREFs of sub_180099250 @ 0x180099250
 * Callers:
...
__int64 __fastcall sub_180099250(__int64 a1, _QWORD *a2, int *a3)
{
  __int64 v6; // rcx
  int v7; // ecx
  __int64 v8; // r8
  ...
  *(_QWORD *)&v24 = *a2;
  *((_QWORD *)&v24 + 1) = v6;
  sub_1800F0DA0(a1, &v24);
  v22 = 0LL;
  v23 = 0LL;
  sub_180012994(&v22, a2);
  v7 = *a3;
  if ( (*a3 & 8) != 0 )
  {
    sub_18000E4E8(v28);
    v19 = sub_18000E4E8(v27);
    sub_180098268(v35, v19, 82, (__int64)v28, 0);
    throw (Spectre::Engine::EngineNotImplException *)v35;
  }
  if ( v22 + 104 != a1 + 104 )
  {
    sub_180097C04((__int64 *)(v22 + 104), *(_QWORD *)(a1 + 104), *(_QWORD *)(a1 + 112));
    v7 = *a3;
  }
  if ( (v7 & 4) != 0 )
  {
    ...
    sub_180098268(v36, v20, 95, (__int64)v30, 0);
  ...
  {
    sub_18000E4E8(v32);
    v21 = sub_18000E4E8(v31);
    sub_180098268(v37, v21, 104, (__int64)v32, 0);
  ...
  *(_QWORD *)(v8 + 144) = v9;
  ...
  if ( (*(_BYTE *)a3 & 0x20) != 0 )
  {
    ...
    sub_180098268(pExceptionObject, v18, 113, (__int64)v34, 0);
