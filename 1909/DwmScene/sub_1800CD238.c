/*
 * XREFs of sub_1800CD238 @ 0x1800CD238
 * Callers:
 *     sub_1800CE8D0 @ 0x1800CE8D0 (sub_1800CE8D0.c)
 * Callees:
...
_QWORD *__fastcall sub_1800CD238(__int64 a1, _QWORD *a2, __int64 a3, __int64 *a4)
{
  __int64 v7; // rbx
