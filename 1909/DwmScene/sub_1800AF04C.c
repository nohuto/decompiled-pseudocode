/*
 * XREFs of sub_1800AF04C @ 0x1800AF04C
 * Callers:
...
__int64 __fastcall sub_1800AF04C(_QWORD *a1, __int64 *a2, _QWORD *a3)
{
  _QWORD *v6; // rdi
  __int64 result; // rax
  __int64 v8; // rdx
  ...
  v30[3] = -2LL;
  v6 = a1 + 212;
  result = _std_type_info_compare(a1[212] + 8LL, &unk_180265A70);
  if ( (_DWORD)result )
  {
    sub_18002C0E4(Src, a1 + 3, " effect");
    v41 = 0uLL;
    v9 = sub_18006CDF8(*a2, v8);
    v41 = 0LL;
    v10 = *(_QWORD *)(v9 + 8);
    if ( v10 )
    ...
    if ( v44 != v45 )
    {
      ...
      {
        sub_18000E4E8(v36);
        v25 = sub_18000E4E8(v35);
        sub_180027880(v39, v25, 858, (__int64)v36, 0);
        throw (Spectre::Engine::EngineInvalidArgException *)v39;
      }
      if ( *(_DWORD *)(*(_QWORD *)v44 + 176LL) != 1 )
      {
        sub_18000E4E8(v38);
        v24 = sub_18000E4E8(v37);
        sub_180027880(pExceptionObject, v24, 865, (__int64)v38, 0);
      ...
      if ( *(_BYTE *)(*(_QWORD *)v44 + 136LL) )
      {
        ...
        *((_QWORD *)&v27 + 1) = v19;
        sub_1800DB98C(v28, (unsigned int)&v42, (_DWORD)a3, (unsigned int)&v27, (__int64)&v26);
        if ( v16 )
        {
