/*
 * XREFs of sub_1801186AC @ 0x1801186AC
 * Callers:
...
__int64 __fastcall sub_1801186AC(__int64 a1)
{
  __int64 v2; // r8
  _BYTE **v3; // rdi
  __int64 *v4; // rcx
  ...
  *(_BYTE *)(a1 + 80) = 0;
  ...
  {
    LOBYTE(v2) = 0;
    sub_18000E168(v4, 0xDuLL, v2, "CanvasDefault");
  }
  else
  {
    *(_QWORD *)(a1 + 96) = 13LL;
...
LABEL_28:
        LOBYTE(v6) = 0;
        sub_18000E168((__int64 *)(a1 + 48), v7, v6, v9);
        goto LABEL_29;
      }
      v7 = 3LL;
      if ( *(_QWORD *)(a1 + 72) < 3uLL )
...
LABEL_35:
  ...
  sub_18011BB6C(v17);
  if ( !_InterlockedExchangeAdd64(&qword_18026C260, 1uLL) )
    sub_180001000((ULONGLONG *)&dword_18025EE60, 0LL, 0LL);
  v18 = sub_180118628(&v22, a1 + 8, a1 + 16, a1 + 48);
