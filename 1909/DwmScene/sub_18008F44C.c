/*
 * XREFs of sub_18008F44C @ 0x18008F44C
 * Callers:
...
_QWORD *__fastcall sub_18008F44C(__int64 **a1, _QWORD *a2, __int64 *a3, unsigned __int16 *a4, _QWORD *a5)
{
  __int64 *v9; // rdi
  _QWORD *result; // rax
  __int64 v11; // r9
  ...
  if ( a1[1] )
  {
    ...
    {
LABEL_30:
      *a2 = *(_QWORD *)sub_18008F648((_DWORD)a1, (unsigned int)v21, 0, (_DWORD)a4, (__int64)a5);
      return a2;
    }
    if ( v15 )
  ...
  else
  {
    ...
    {
      sub_1800646D8(v21[0], (__int64)v20);
      throw;
    }
  }
  return result;
