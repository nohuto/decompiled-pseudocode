/*
 * XREFs of sub_1800387E0 @ 0x1800387E0
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall sub_1800387E0(__int64 a1, _QWORD *a2)
{
  __int64 v3; // rax
  __int64 *v4; // rcx
  char v5; // di
  ...
  if ( *a2 )
  {
    v4 = (__int64 *)sub_1800D1FE4(*a2, v19, *(unsigned int *)(a1 + 88));
    v5 = 1;
    v3 = *v4;
  }
  else
