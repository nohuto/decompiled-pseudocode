/*
 * XREFs of sub_1800F1F44 @ 0x1800F1F44
 * Callers:
...
__int64 __fastcall sub_1800F1F44(__int64 a1, size_t *a2, unsigned int a3, unsigned int a4)
{
  __int64 v8; // r14
  int v9; // ebx
  __int64 v10; // rsi
  ...
  {
    sub_18000E4E8(v25);
    v16 = sub_18000E4E8(Src);
    sub_180027880(v28, v16, 586, (__int64)v25, 0);
    throw (Spectre::Engine::EngineInvalidArgException *)v28;
  }
  if ( !a2[2] )
  {
    sub_18000E4E8(Src);
    v17 = sub_18000E4E8(v25);
    sub_180027880(v28, v17, 589, (__int64)Src, 0);
    throw (Spectre::Engine::EngineInvalidArgException *)v28;
  }
  if ( (*(_QWORD *)(a1 + 64) - *(_QWORD *)(a1 + 56)) / 56LL == 512 )
  {
    sub_18000E4E8(Src);
    v18 = sub_18000E4E8(v25);
    sub_180027880(v28, v18, 592, (__int64)Src, 0);
    throw (Spectre::Engine::EngineInvalidArgException *)v28;
  }
  v8 = (unsigned __int16)sub_1800A36E4(*(_QWORD *)(a1 + 1152), a2);
  if ( *(_WORD *)(a1 + 2 * v8 + 128) != 0xFFFF )
  {
    v19 = sub_18009FC40(Src, "ShaderPropertyLayout::AddArrayProperty() -- variable '", a2);
    v20 = sub_18002C088((__int64)v28, v19, "' is already defined");
    v21 = sub_18000E4E8(v25);
    sub_180027880(pExceptionObject, v21, 598, v20, 0);
    throw (Spectre::Engine::EngineInvalidArgException *)pExceptionObject;
  }
  if ( ((a3 - 5) & 0xFFFFFFFD) != 0 )
  {
    sub_18000E4E8(Src);
    v22 = sub_18000E4E8(v25);
    sub_180027880(pExceptionObject, v22, 601, (__int64)Src, 0);
    throw (Spectre::Engine::EngineInvalidArgException *)pExceptionObject;
  }
  v9 = 1;
  if ( a4 <= 1 )
  {
    sub_18000E4E8(Src);
    v23 = sub_18000E4E8(v25);
    sub_180027880(pExceptionObject, v23, 604, (__int64)Src, 0);
    throw (Spectre::Engine::EngineInvalidArgException *)pExceptionObject;
  }
  sub_1800F2A18(a1);
  ...
  {
    sub_18000E4E8(Src);
    v15 = sub_18000E4E8(v25);
    sub_180027880(pExceptionObject, v15, 614, (__int64)Src, 0);
    throw (Spectre::Engine::EngineInvalidArgException *)pExceptionObject;
  }
  v29 = 0LL;
  sub_18000F444(v28, (__int64)a2);
  v30 = v8;
  v31 = a3;
  v32 = v10;
  v33 = a4;
  ...
  sub_1800F19B8((_QWORD *)(a1 + 56), (__int64)v28);
  *(_WORD *)(a1 + 2LL * (unsigned __int16)v8 + 128) = v12;
  sub_1800F175C(a1 + 80, v11);
