/*
 * XREFs of sub_1800FB4C0 @ 0x1800FB4C0
 * Callers:
 *     <none>
 * Callees:
...
char __fastcall sub_1800FB4C0(__int64 a1, __int64 a2, int a3, int a4, char a5, __int64 a6)
{
  __int64 v10; // rax
  ...
  v15[3] = 15LL;
  LOBYTE(v15[0]) = 0;
  sub_18000E168(v15, 0x25uLL, 0LL, "ImageProcessingEffectPlanarReflection");
  sub_1800645F4(*(_QWORD *)(a1 + 200), v15);
  return sub_180064DAC(*(_QWORD *)(a1 + 200), a3, a4, a5, a6, a2);
}
