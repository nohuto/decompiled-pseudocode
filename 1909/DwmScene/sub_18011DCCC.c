/*
 * XREFs of sub_18011DCCC @ 0x18011DCCC
 * Callers:
...
_QWORD *__fastcall sub_18011DCCC(_QWORD *Src, unsigned __int64 a2, __int64 a3, __int64 a4, __int16 a5)
{
  __int64 v5; // r12
  __int64 v6; // rdi
  ...
  if ( v6 == -1 )
    v13 = -1LL;
  v14 = sub_1800114D0((__int64)Src, v13);
  Src[3] = v6;
  v15 = 2 * v5;
  Src[2] = v10;
  v16 = v14;
