/*
 * XREFs of sub_1800155E4 @ 0x1800155E4
 * Callers:
...
_QWORD *__fastcall sub_1800155E4(__int64 a1, _QWORD *a2, __int64 a3, __int64 a4)
{
  void *v8; // rax
  __int64 v9; // r8
  void *v10; // rbx
  ...
  if ( v8 )
  {
    ...
    *((_QWORD *)&v19 + 1) = v11;
    v8 = (void *)sub_1800B5E6C(v10, a1, &v19);
  }
  v17 = 0LL;
  LOBYTE(v9) = v16;
  ...
  v26 = 0LL;
  v12 = v17;
  sub_180063288(v17 + 24, &v25);
  sub_18006D420(v12, a3, a4);
  v20 = 0LL;
  v13 = *((_QWORD *)&v17 + 1);
  if ( *((_QWORD *)&v17 + 1) )
  {
