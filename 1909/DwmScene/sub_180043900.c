/*
 * XREFs of sub_180043900 @ 0x180043900
 * Callers:
 *     <none>
 * Callees:
...
char __fastcall sub_180043900(__int64 a1, __int64 *a2)
{
  __int64 v4; // rdx
  __int64 v5; // rdi
  __int64 v6; // rbx
...
LABEL_6:
    ...
    if ( v12 < 0 )
    {
      sub_18011DA98(&unk_180259190, 5LL, "ERROR: Failed to create Geometry shader.\n");
    }
    else
    {
      *(_BYTE *)(a1 + 96) = 1;
