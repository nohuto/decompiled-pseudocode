/*
 * XREFs of sub_1800A4D60 @ 0x1800A4D60
 * Callers:
...
__int64 __fastcall sub_1800A4D60(__int64 a1, __int64 *a2)
{
  _QWORD *v3; // rbx
  __int64 v4; // rbx
...
LABEL_9:
    v12 = sub_18009FC40(&Src, "ShaderManager::GetShaderProgram() -- shader program for name '", a2);
    v13 = sub_18002C088((__int64)v18, v12, "' does not exist");
    v14 = sub_18000E4E8(v16);
    sub_180027880(pExceptionObject, v14, 158, v13, 0);
