/*
 * XREFs of sub_18003AA50 @ 0x18003AA50
 * Callers:
...
_QWORD *__fastcall sub_18003AA50(_QWORD *a1, __int64 *a2, int a3, int a4, const char *a5)
{
  int v9; // eax
  __int64 v10; // rbx
  __int64 *v11; // rcx
  ...
  if ( v12 < 0 )
  {
    ...
    sub_18000E4E8(v47);
    v39 = (unsigned int)sub_18000E4E8(v46);
    sub_180065920((unsigned int)pExceptionObject, v39, 283, v12, (__int64)v47, 0);
    throw (Spectre::Engine::EngineException *)pExceptionObject;
  }
  v14 = a5;
  if ( *((_QWORD *)a5 + 3) >= 0x10uLL )
    v14 = *(const char **)a5;
  sub_18000EE78(v50, v14);
  v58 = 0;
  v59 = 5LL;
  v51 = 0LL;
  v15 = *sub_18002328C(*a2, &v40);
  v16 = v51;
  if ( v51 )
  {
    v51 = 0LL;
  ...
  *a1 = 0LL;
  ...
  sub_180039D40(v20, &v41, (__int64 *)&v40, 5u);
  v21 = v51;
  if ( v51 )
  {
    v51 = 0LL;
...
LABEL_30:
    ...
    sub_18000F7E4(v47, v17);
    v33 = (void *)unknown_libname_174(v52, (__int64)" HRESULT=");
    unknown_libname_112(v33);
    std::string::_Tidy_deallocate(v47);
    unknown_libname_3(v52);
    sub_18000E4E8(v45);
    v34 = (unsigned int)sub_18000E4E8(v46);
    sub_180065920((unsigned int)pExceptionObject, v34, 292, v17, (__int64)v45, 0);
    throw (Spectre::Engine::EngineException *)pExceptionObject;
  }
LABEL_28:
  *((_QWORD *)a5 + 2) = 0LL;
