/*
 * XREFs of sub_18011B440 @ 0x18011B440
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall sub_18011B440(__int64 a1, __int64 *a2, char a3, _BYTE *a4, __int64 a5, __int64 a6)
{
  void *v6; // rbx
    ...
    && (qword_18025EE78 & 0x400000000000LL) == qword_18025EE78 )
  {
    ...
    v45 = 4LL;
    v47 = 4LL;
    sub_180001128((__int64)&dword_18025EE60, (unsigned __int8 *)dword_180225015, 0LL, 0LL, 0xDu, &v22);
  }
