/*
 * XREFs of sub_1800D815C @ 0x1800D815C
 * Callers:
...
__int64 __fastcall sub_1800D815C(__int64 a1, __int64 a2, __int64 a3, __int64 a4)
{
  __int64 v5; // rbp
  __int64 v8; // r13
  __int64 i; // r14
