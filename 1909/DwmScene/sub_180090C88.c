/*
 * XREFs of sub_180090C88 @ 0x180090C88
 * Callers:
...
char __fastcall sub_180090C88(_QWORD *a1, int a2, int a3, int a4)
{
  ...
  v18 = a1[17];
  v19 = v8;
  v9 = *(_QWORD *)sub_1800A9414(v18, v20);
  v10 = (_QWORD *)sub_1800A41C8(v9);
  v11 = v21;
  if ( v21 )
  {
  ...
  v22[1] = a4;
  v12 = a1[21];
  if ( !v12 || (result = sub_18008FB70(*(_QWORD *)(v12 + 112), (__int64)v22)) == 0 )
  {
    sub_18001D8E4(v10, &v15, 1u);
    ...
    return sub_1800CC1A0(a1[21], v22, 0LL);
  }
  return result;
}
