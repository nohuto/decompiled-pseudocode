/*
 * XREFs of sub_180010550 @ 0x180010550
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall sub_180010550(__int64 a1, __int64 a2)
{
  __int64 v4; // r13
  _QWORD *v5; // r15
  __int64 v6; // r8
  ...
  *((_QWORD *)&v41 + 1) = v15;
  ...
  if ( (_QWORD)v61 != (_QWORD)v41 )
  {
    ...
    else
    {
      ...
      sub_180077B00(*(_QWORD *)(v4 + 56), &v52);
      ...
      v69 = 0LL;
      v21 = v43;
      sub_1800632D0(v43 + 16, &v68);
      v55 = 0LL;
      v56 = 0LL;
      sub_18001115C(v54, &qword_180259808);
      v22 = (__int64 *)sub_18008B3B0(v21, v58, v54);
    ...
    if ( (_QWORD)v60 == v21 )
    {
      ...
      *(_QWORD *)&v49 = *v5;
      *((_QWORD *)&v49 + 1) = v32;
      sub_18008C610(v60, &v49, &v51);
    }
    else
    {
      v72 = 0LL;
      v73 = 0LL;
      sub_1800632D0(v21 + 16, &v72);
      if ( (*(_DWORD *)(a1 + 48) & 0xFFFFFFFB) != 0 && !v24 )
      {
        v62 = 0LL;
        v63 = 0LL;
        v64 = 0LL;
        sub_18000FB5C(v21, &v62);
        for ( j = v62; j != v63; j += 2 )
        {
      ...
      if ( *((_QWORD *)&v41 + 1) )
        _InterlockedIncrement((volatile signed __int32 *)(*((_QWORD *)&v41 + 1) + 8LL));
      v50 = v41;
      sub_180082948(*v5, &v70, 131075LL, &v50);
      v48 = 0LL;
      v29 = v5[1];
      if ( v29 )
      {
    ...
    if ( (*(_DWORD *)(a1 + 48) & 0xFFFFFFFB) == 0 )
    {
      if ( (_QWORD)v61 )
      {
        v34 = sub_180018C78(v4);
        if ( v34 )
        {
          if ( *(_DWORD *)(a1 + 48) )
            sub_18001C114(v34, a1 + 72);
          else
            sub_18001BFBC(v34, a1 + 52);
        }
      }
      if ( (_QWORD)v41 )
      {
        v35 = sub_180018C78(v4);
        if ( v35 )
        {
          if ( *(_DWORD *)(a1 + 48) )
            sub_18001C114(v35, a1 + 72);
          else
            sub_18001BFBC(v35, a1 + 52);
        }
      }
    }
    if ( *((_QWORD *)&v43 + 1) )
