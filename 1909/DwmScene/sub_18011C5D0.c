/*
 * XREFs of sub_18011C5D0 @ 0x18011C5D0
 * Callers:
 *     <none>
 * Callees:
...
void __fastcall sub_18011C5D0(__int64 a1, _BYTE *a2, __int64 a3, double a4, void *a5, void *a6, char a7)
{
  __int64 v7; // rax
  void *v8; // rcx
  bool v9; // zf
  ...
  if ( (unsigned int)dword_18025EE98 > 5 )
  {
    ...
    v27 = &a7;
    v28 = 4LL;
    sub_180001128((__int64)&dword_18025EE98, (unsigned __int8 *)dword_180225B8F, 0LL, 0LL, 8u, &v13);
  }
}
