/*
 * XREFs of sub_1800EFF30 @ 0x1800EFF30
 * Callers:
 *     <none>
 * Callees:
...
char __fastcall sub_1800EFF30(__int64 a1, __int64 a2, __int64 a3)
{
  __int64 v5; // rax
  __int64 v6; // rax
  unsigned int v7; // ebx
  ...
  v15 = 0LL;
  v16 = 0LL;
  sub_180099A60(a2, (__int64)&v15);
  if ( (unsigned __int8)sub_18009123C(v15, (__int64)&qword_18025C638) )
  {
    v5 = sub_18006CE94(a3);
    v6 = sub_180077A8C(v5, 1);
    if ( (*(unsigned __int8 (__fastcall **)(__int64, void *, _QWORD))(*(_QWORD *)v6 + 64LL))(v6, &unk_180259F38, 0LL)
  ...
  v8 = sub_180099B50(a2, &v13);
  LOBYTE(v9) = sub_180095E9C(*v8, v7);
  v10 = v14;
  if ( v14 )
  {
