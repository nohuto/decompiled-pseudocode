/*
 * XREFs of sub_1800AAAA0 @ 0x1800AAAA0
 * Callers:
...
__int64 __fastcall sub_1800AAAA0(_QWORD *a1, __int64 a2, __int64 a3)
{
  __int64 v6; // r12
  __int64 v7; // rdx
  ...
  *(_QWORD *)(v14 + 40) = *(_QWORD *)(a3 + 40);
  ...
  if ( a2 != v16 )
  {
    sub_1800AB968(v19, a2, v12, a1, v11, v12, -2LL);
    v17 = a1;
    v18 = v13 + v12 + 48;
    v16 = a1[1];
    v19 = a2;
  }
  sub_1800AB968(v19, v16, v18, v17, v21, v22, v23);
  sub_1800B2954(a1, v12, v8, v11);
  return v13 + *a1;
}
