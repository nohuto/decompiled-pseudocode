/*
 * XREFs of sub_18003D500 @ 0x18003D500
 * Callers:
...
HRESULT __fastcall sub_18003D500(
        ...
        ID3D11DeviceContext **a10)
{
  ...
  if ( dword_180269FE4 > *(_DWORD *)(*((_QWORD *)NtCurrentTeb()->ThreadLocalStoragePointer + (unsigned int)TlsIndex)
                                   + 44LL) )
  {
    Init_thread_header(&dword_180269FE4);
    if ( dword_180269FE4 == -1 )
    {
      byte_180269FE0 = 1;
      Init_thread_footer(&dword_180269FE4);
    }
    goto LABEL_4;
  }
  while ( 1 )
