/*
 * XREFs of sub_180118D80 @ 0x180118D80
 * Callers:
 *     <none>
 * Callees:
...
ULONG __fastcall sub_180118D80(_QWORD *a1, _BYTE *a2)
{
  void *v2; // rbx
  ULONG result; // eax
  ...
  if ( (unsigned int)dword_18025EE60 > 5 && (qword_18025EE70 & 0x400000000000LL) != 0 )
  {
    ...
    if ( (qword_18025EE78 & 0x400000000000LL) == qword_18025EE78 )
    {
      ...
      v21 = v7 + 1;
      v20 = a2;
      return sub_180001128((__int64)&dword_18025EE60, (unsigned __int8 *)dword_180225380, 0LL, 0LL, 7u, &v10);
    }
  }
  return result;
}
