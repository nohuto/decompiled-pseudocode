/*
 * XREFs of sub_1800D2B40 @ 0x1800D2B40
 * Callers:
...
__int64 __fastcall sub_1800D2B40(_QWORD *a1, void *a2, unsigned int a3, unsigned int a4, int a5, int a6)
{
...
LABEL_22:
    v21 = a4;
    v11 = a4;
    v22 = (__int64 *)sub_1800D217C(&v46, a4, a2, v13);
    ...
    sub_18006456C((__int64)a1, v21, 0xFu);
    goto LABEL_27;
  }
LABEL_28:
