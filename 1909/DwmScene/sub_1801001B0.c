/*
 * XREFs of sub_1801001B0 @ 0x1801001B0
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall sub_1801001B0(__int64 a1, _QWORD *a2)
{
  __int64 v4; // rdx
  __int64 v5; // rbx
  __int64 result; // rax
  ...
  *(_DWORD *)(v5 + 1968) = *(_DWORD *)(a1 + 1968);
  sub_180011764((__int64 *)(v5 + 1768), (__int64 *)(a1 + 1768));
  result = (__int64)sub_180011764((__int64 *)(v5 + 1848), (__int64 *)(a1 + 1848));
  if ( v10 )
  {
