/*
 * XREFs of sub_180084F94 @ 0x180084F94
 * Callers:
...
__int64 __fastcall sub_180084F94(__int64 a1, __int64 *a2)
{
  _QWORD *i; // r8
  __int64 v5; // rbx
  __int64 v6; // rdx
  ...
  sub_18006E4D8(a1 + 32, &v15, (__int64)i);
  v5 = *a2;
  sub_180087450(*a2);
  v17 = 0LL;
  v6 = *(_QWORD *)(v5 + 120);
  ...
  v18 = 0LL;
  v19 = 0LL;
  result = (__int64)sub_180083798(*a2, &v18);
  if ( (_QWORD)v17 )
  {
    sub_180085BF4(v17, &v18);
    v16[1] = 0LL;
    v9 = *a2;
    result = sub_180087524(*a2);
    *(_QWORD *)(v9 + 112) = 0LL;
