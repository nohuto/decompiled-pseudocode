/*
 * XREFs of sub_1800187A0 @ 0x1800187A0
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall sub_1800187A0(__int64 a1, __int64 a2, __int64 a3, __int64 *a4)
{
  __int64 v8; // rcx
  __int64 *v9; // rax
  ...
  *(_QWORD *)v30 = 0LL;
  v31 = 0LL;
  sub_180015F14(*(_QWORD **)(a1 + 56), v30, 1u);
  v8 = *(_QWORD *)(a1 + 56);
  v29 = 0uLL;
  v9 = (__int64 *)sub_180077BAC(v8, v25, 1LL);
  sub_180015A44(*v9, &v29);
  v10 = v26;
  if ( v26 )
  {
  ...
  v28 = 0LL;
  v13 = sub_1800167F8(&v28, (__int64)v30);
  v14 = v13;
  if ( v13 >= 0 )
  {
    v16 = v28;
