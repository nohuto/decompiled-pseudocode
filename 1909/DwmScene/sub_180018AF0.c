/*
 * XREFs of sub_180018AF0 @ 0x180018AF0
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall sub_180018AF0(__int64 a1, __int64 *a2)
{
  signed int v4; // eax
  unsigned int v5; // edi
  __int64 v6; // rcx
  ...
  v13 = 0LL;
  v14 = 0LL;
  sub_1800766BC(*(_QWORD *)(a1 + 56), &v13);
  v15 = 0LL;
  v16 = 0LL;
  sub_1800632D0(v13 + 16, &v15);
  v12 = 0LL;
  v4 = sub_1800168E0(&v12, (__int64)&v13);
  v5 = v4;
  if ( v4 >= 0 )
  {
    v11[0] = v12;
    ...
    if ( *(_BYTE **)(a1 + 128) == v7 )
    {
      sub_180016A80((const void **)(a1 + 112), v7, v11);
    }
    else
    {
      *(_QWORD *)v7 = v12;
