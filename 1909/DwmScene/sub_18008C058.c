/*
 * XREFs of sub_18008C058 @ 0x18008C058
 * Callers:
...
__int64 __fastcall sub_18008C058(__int64 a1, __int64 *a2)
{
  __int64 v4; // rcx
  __int64 v5; // rsi
  __int64 *v6; // rax
  ...
  {
    sub_18000E4E8(v27);
    v16 = sub_18000E4E8(v26);
    sub_180027880(v32, v16, 391, (__int64)v27, 0);
  ...
  *(_QWORD *)&v20 = *a2;
  *((_QWORD *)&v20 + 1) = v4;
  sub_18008B02C(a1, &v18, (__int64 *)&v20);
  v5 = v18;
  if ( !v18 )
  {
    sub_18000E4E8(v29);
    v17 = sub_18000E4E8(v28);
    sub_180027880(v33, v17, 397, (__int64)v29, 0);
    throw (Spectre::Engine::EngineInvalidArgException *)v33;
  }
  v6 = sub_18008B530(v18, &v24);
  v8 = *a2;
  v9 = *v6;
  v10 = v25;
  if ( v25 )
  ...
  {
    sub_18000E4E8(v31);
    v15 = sub_18000E4E8(v30);
    sub_180027880(pExceptionObject, v15, 402, (__int64)v31, 0);
    throw (Spectre::Engine::EngineInvalidArgException *)pExceptionObject;
  }
  sub_1800635BC(a1 + 16, v7);
  for ( i = (volatile signed __int32 *)(v5 + 76); _interlockedbittestandset(i, 0); i = (volatile signed __int32 *)(v5 + 76) )
    ;
  v21 = 0LL;
  sub_180085C60(*a2, (__int64 *)&v21);
  result = v5 + 76;
  *(_DWORD *)(v5 + 76) = 0;
  if ( v19 )
  {
