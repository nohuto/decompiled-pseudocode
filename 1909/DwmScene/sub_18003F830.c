...
int __fastcall sub_18003F830(__int64 a1)
{
  int result; // eax
  int v3; // edi
  __int64 v4; // rsi
  ...
  v34 = -2LL;
  result = sub_18003F6B0(a1);
  if ( *(_QWORD *)(a1 + 536) )
  {
    v32 = 0LL;
    v33 = 0LL;
    sub_180040174(a1, &v32);
    v48 = 0LL;
    sub_18002328C(v32, &v48);
    v47 = 0LL;
    v3 = (**v48)(v48, &unk_18014B280, &v47);
    if ( v3 < 0 )
    {
      sub_18000E4E8(v49);
      ...
      sub_18000E4E8(v37);
      v23 = (unsigned int)sub_18000E4E8(v36);
      v30 = 0;
      sub_180065920((unsigned int)v44, v23, 187, v3, (__int64)v37, v30);
    ...
    if ( v7 < 0 )
    {
      ...
      sub_18000E4E8(v40);
      v28 = (unsigned int)sub_18000E4E8(v39);
      v31 = 0;
      sub_180065920((unsigned int)v45, v28, 189, v7, (__int64)v40, v31);
    ...
    if ( v10 < 0 )
    {
      ...
      sub_18000E4E8(v43);
      v18 = (unsigned int)sub_18000E4E8(v42);
      v29 = 0;
      sub_180065920((unsigned int)pExceptionObject, v18, 191, v10, (__int64)v43, v29);
