/*
 * XREFs of sub_1800C7D30 @ 0x1800C7D30
 * Callers:
...
char __fastcall sub_1800C7D30(_BYTE *a1, __int64 *a2, char a3)
{
  __int64 v6; // rbx
  ...
  v46 = -2LL;
  v6 = sub_180077A8C((__int64)a1, *(_DWORD *)(*a2 + 112));
  LOBYTE(v7) = (*(__int64 (__fastcall **)(__int64, void *, _QWORD))(*(_QWORD *)v6 + 64LL))(v6, &unk_18025A178, 0LL);
  if ( !(_BYTE)v7 )
    return v7;
  v8 = (*(double (__fastcall **)(__int64, __int64 *))(*(_QWORD *)v6 + 88LL))(v6, &qword_18025A158);
  LOBYTE(v9) = 1;
  (*(void (__fastcall **)(__int64, void *, __int64))(*(_QWORD *)v6 + 64LL))(v6, &unk_18025A198, v9);
  v11 = v10;
  v12 = (*(double (__fastcall **)(__int64, __int64 *))(*(_QWORD *)v6 + 88LL))(v6, &qword_18025A1B8);
  v13 = LODWORD(v12);
  v14 = (*(double (__fastcall **)(__int64, __int64 *))(*(_QWORD *)v6 + 88LL))(v6, &qword_18025A1D8);
  v15 = LODWORD(v14);
  v16 = (*(double (__fastcall **)(__int64, __int64 *))(*(_QWORD *)v6 + 88LL))(v6, &qword_18025A1F8);
  v17 = LODWORD(v16);
  v18 = (*(double (__fastcall **)(__int64, __int64 *))(*(_QWORD *)v6 + 88LL))(v6, &qword_18025A218);
  v19 = LODWORD(v18);
  v20 = (*(double (__fastcall **)(__int64, __int64 *))(*(_QWORD *)v6 + 88LL))(v6, &qword_18025A238);
  v21 = LODWORD(v20);
  v22 = (*(double (__fastcall **)(__int64, __int64 *))(*(_QWORD *)v6 + 88LL))(v6, &qword_18025A258);
  v23 = LODWORD(v22);
  (*(void (__fastcall **)(__int64, __int64 *))(*(_QWORD *)v6 + 88LL))(v6, &qword_18025A278);
  v36 = 0LL;
  v37 = 0LL;
  sub_1800C1EE4((__int64)a1, &v36, a2);
  v24 = (_DWORD *)v36;
  LOBYTE(v7) = v36 != 0;
  if ( !v36 )
    goto LABEL_25;
  ...
  v52 = v17;
  v49 = qword_18026C298;
  v25 = *((float *)&qword_18026C298 + 1);
  v50 = dword_18026C2A0;
  if ( v11 )
  {
    v40 = 0LL;
    v41 = 0LL;
    sub_180012680((__int64)v24, &v40);
    if ( v40 )
  ...
  sub_1800821B4(v53, (unsigned __int64 *)&v49, &v51);
  sub_180087524((__int64)v24);
  v24[36] = v53[0];
  v24[37] = v53[1];
  v24[38] = v53[2];
  v27 = _InterlockedIncrement64(&qword_180259748);
  v28 = v36;
  *(_QWORD *)(v36 + 208) = v27;
  v29 = *(_QWORD *)(v28 + 216);
  if ( v27 >= v29 )
...
LABEL_19:
    ...
    sub_180087EB0(*(double *)v30.m128_u64);
    v54 = v30;
    v47 = v30;
    sub_18008644C(v28, &v47);
    if ( a3 )
    {
LABEL_22:
      sub_180087450(v28);
      v44 = *(_QWORD *)(v28 + 172);
      v45 = *(_DWORD *)(v28 + 180);
      v31 = sub_18008E2E4(v48, v8, &v44);
      v42 = *(_QWORD *)v31;
      v43 = v31[2];
      sub_180087524(v28);
      *(_QWORD *)(v28 + 172) = v42;
      *(_DWORD *)(v28 + 180) = v43;
      v32 = _InterlockedExchangeAdd64(&qword_180259748, 1uLL);
      v33 = v36;
