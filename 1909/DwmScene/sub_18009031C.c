/*
 * XREFs of sub_18009031C @ 0x18009031C
 * Callers:
...
__int64 __fastcall sub_18009031C(_QWORD *a1, _QWORD *a2)
{
  _QWORD *v4; // rsi
  _QWORD *v5; // rax
  ...
  v5 = (_QWORD *)sub_1800A9360(*a2, 2LL);
  ...
  v7 = (__int64 *)sub_1800F2A54(*v5, v18);
  ...
  v9 = (_QWORD *)sub_1800A9000(*v4, v20);
