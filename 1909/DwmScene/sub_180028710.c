...
__int64 __fastcall sub_180028710(__int64 a1)
{
  __int64 result; // rax
  int v3; // ebx
  int v4; // r8d
  ...
  if ( v13 )
  {
    ...
    *(_QWORD *)&v9 = v11;
    ...
    v11[3] = 15LL;
    LOBYTE(v11[0]) = 0;
    sub_18000E168(v11, 0x18uLL, 0LL, "RenderOutput DepthBuffer");
    v3 = (*(__int64 (__fastcall **)(__int64))(*(_QWORD *)a1 + 88LL))(a1);
    v4 = (*(__int64 (__fastcall **)(__int64))(*(_QWORD *)a1 + 80LL))(a1);
    sub_18003AA50((unsigned int)&v15, (unsigned int)&v13, v4, v3, (__int64)v11);
    v5 = (_QWORD *)sub_18006CE94(v13);
    v12 = 0uLL;
    sub_180026880(v5, &v12, 1u);
    v10 = 0LL;
    if ( *((_QWORD *)&v15 + 1) )
      _InterlockedIncrement((volatile signed __int32 *)(*((_QWORD *)&v15 + 1) + 8LL));
    v10 = v15;
    sub_1800D07C8(v12, &v10, 0LL);
    v9 = v12;
    v12 = 0uLL;
    result = sub_1800688F8(a1, &v9);
