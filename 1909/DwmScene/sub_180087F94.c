/*
 * XREFs of sub_180087F94 @ 0x180087F94
 * Callers:
...
__m128 __fastcall sub_180087F94(double a1, double a2, double a3)
{
  __m128 v3; // xmm5
  __m128 v4; // xmm6
  __m128 v5; // xmm3
  ...
  v7 = _mm_cmple_ps(v6, (__m128)xmmword_180143E20);
  v8 = _mm_cmple_ps(_mm_add_ps(v5, v3), (__m128)xmmword_180143E20);
  v9 = _mm_cmple_ps(_mm_sub_ps(v5, v3), (__m128)xmmword_180143E20);
  v10 = _mm_add_ps(_mm_mul_ps((__m128)xmmword_1801E46E0, v5), _mm_mul_ps((__m128)xmmword_1801E46D0, v3));
  ...
  v14 = _mm_add_ps(_mm_add_ps(v10, _mm_mul_ps((__m128)xmmword_1801E46F0, v6)), (__m128)xmmword_180143E10);
  v15 = _mm_mul_ps(
          _mm_sub_ps(_mm_shuffle_ps(*(__m128 *)&a3, *(__m128 *)&a2, 1), _mm_shuffle_ps(v13, v13, 120)),
          (__m128)xmmword_1801E46E0);
