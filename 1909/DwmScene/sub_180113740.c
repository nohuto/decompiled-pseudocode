/*
 * XREFs of sub_180113740 @ 0x180113740
 * Callers:
 *     sub_180113720 @ 0x180113720 (sub_180113720.c)
 * Callees:
...
char __fastcall sub_180113740(__int64 a1, __int64 a2)
{
  __int64 v4; // rax
  __int64 v5; // rbx
  __int64 *v6; // rax
  ...
  *v14 = 0;
  ...
  switch ( v15 )
  {
    ...
    case 32:
      v16 = &qword_18025E268;
LABEL_21:
      sub_180011764(v13, v16);
      break;
  }
  v17 = (_QWORD *)sub_18006CE94(a2);
  sub_180015DF4(v17, &v21, 1u);
  ...
  v23[3] = 15LL;
  LOBYTE(v23[0]) = 0;
  sub_18000E168(v23, 0x1DuLL, 0LL, "Image Processing Blur Sampler");
  sub_1800645F4(*(_QWORD *)(a1 + 320), v23);
  v32 = 0;
  v36 = 0;
  v19 = *(_QWORD **)(a1 + 320);
  v37 = 2139095039;
  ...
  v31[0] = 0x200000002LL;
  v31[1] = 0x200000002LL;
  return sub_18009F6C0(v19, v31, 0LL);
}
