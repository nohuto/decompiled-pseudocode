/*
 * XREFs of sub_1800C36BC @ 0x1800C36BC
 * Callers:
 *     sub_1800C8208 @ 0x1800C8208 (sub_1800C8208.c)
 * Callees:
 *     sub_1800B8B04 @ 0x1800B8B04 (sub_1800B8B04.c)
 *     sub_1800BB1FC @ 0x1800BB1FC (sub_1800BB1FC.c)
 */

__int64 __fastcall sub_1800C36BC(__int64 a1, _DWORD *a2, __int64 *a3)
{
  __int64 result; // rax
  __int64 *v5; // rdi
  __int64 v6; // rbx
  ...
  result = sub_1800BB1FC(*a3, (__int64)a2);
  v5 = *(__int64 **)(result + 104);
  v6 = *v5;
  while ( (__int64 *)v6 != v5 )
  {
    sub_1800B8B04(*(_DWORD **)(v6 + 40), a2);
    result = *(_QWORD *)(v6 + 16);
    if ( *(_BYTE *)(result + 25) )
    {
