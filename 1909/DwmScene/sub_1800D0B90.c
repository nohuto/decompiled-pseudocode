/*
 * XREFs of sub_1800D0B90 @ 0x1800D0B90
 * Callers:
 *     <none>
 * Callees:
...
char __fastcall sub_1800D0B90(__int64 a1, __int64 a2, unsigned int a3)
{
  __int64 **v3; // r9
  __int64 *v4; // rcx
  unsigned int v7; // edx
  ...
  if ( v4 == *v3 || v7 < *((_DWORD *)v4 + 8) )
    v4 = *v3;
  if ( v4 == *v3 )
    return 0;
  v11[0] = v7;
  sub_1800CFA44(v3, (__int64)&v10, v11);
