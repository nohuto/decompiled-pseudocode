/*
 * XREFs of sub_18001BFBC @ 0x18001BFBC
 * Callers:
...
__m128 *__fastcall sub_18001BFBC(__m128 *a1, float *a2, float a3)
{
  float v5; // xmm1_4
  float v6; // xmm0_4
  ...
  v8[2] = v5;
  v8[3] = 1.0;
  sub_1800CB758(v19, v8);
  sub_1800B74D4(&v10, v19);
  sub_18001BF20(a1 + 3, &v10);
  sub_18001BF20(a1 + 4, &v11);
  sub_18001BF20(a1 + 5, &v12);
  sub_18001BF20(a1 + 6, &v13);
  sub_18001BF20(a1 + 7, &v14);
  sub_18001BF20(a1 + 8, &v15);
  sub_18001BF20(a1 + 9, &v16);
  sub_18001BF20(a1 + 10, &v17);
  return sub_18001BF20(a1 + 11, v18);
}
