/*
 * XREFs of sub_18002CB20 @ 0x18002CB20
 * Callers:
...
_QWORD *__fastcall sub_18002CB20(_QWORD *a1, __int64 *a2, int a3, int a4, __int64 **a5, const char *a6)
{
  const char *v10; // rdx
  __int64 v11; // r15
  __int64 *v12; // rcx
  ...
  if ( *((_QWORD *)a6 + 3) >= 0x10uLL )
    v10 = *(const char **)a6;
  sub_18000EE78(*a5, v10);
  v46 = 0;
  *(_DWORD *)v45 = sub_180029AD8(16, 0);
  ...
  *(_QWORD *)&v56[12] = 3LL;
  ...
  if ( v13 < 0 )
  {
    ...
    sub_18000E4E8(&v44);
    v40 = (unsigned int)sub_18000E4E8(v49);
    sub_180065920((unsigned int)pExceptionObject, v40, 185, v13, (__int64)&v44, 0);
    throw (Spectre::Engine::EngineException *)pExceptionObject;
  }
  sub_18000EE78(v53, "BackBufferStaging");
  v52 = 0LL;
  v15 = *sub_18002328C(*a2, &v41);
  v16 = v52;
  if ( v52 )
  {
    v52 = 0LL;
  ...
  sub_1800254C0(*a2, v17);
  if ( v17 < 0 )
    goto LABEL_32;
  v19 = a6;
  if ( *((_QWORD *)a6 + 3) >= 0x10uLL )
    v19 = *(const char **)a6;
  sub_18000EE78(v52, v19);
  *a1 = 0LL;
  a1[1] = 0LL;
  sub_18000DA30(*a2, a1);
  v43 = 1;
  ...
  sub_18002C2E0(v20, (__int64 *)&v42, v47, &v41, a3, a4);
...
LABEL_32:
    ...
    sub_18000F7E4(&v44, v17);
    v34 = (void *)unknown_libname_174(v54, (__int64)" HRESULT=");
    unknown_libname_112(v34);
    std::string::_Tidy_deallocate((__int64 *)&v44);
    unknown_libname_3(v54);
    sub_18000E4E8(v48);
    v35 = (unsigned int)sub_18000E4E8(v49);
    sub_180065920((unsigned int)pExceptionObject, v35, 200, v17, (__int64)v48, 0);
    throw (Spectre::Engine::EngineException *)pExceptionObject;
  }
LABEL_30:
  *((_QWORD *)a6 + 2) = 0LL;
