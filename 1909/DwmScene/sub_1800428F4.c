 ...
 *     sub_1800D1FD8 @ 0x1800D1FD8 (sub_1800D1FD8.c)
 *     __security_check_cookie @ 0x1801261A0 (__security_check_cookie.c)
 */

// Hidden C++ exception states: #wind=1
__int64 __fastcall sub_1800428F4(__int64 a1, __int64 a2, _OWORD *a3)
{
  int v6; // esi
  unsigned int v7; // edi
  __int64 v8; // rax
  ...
  if ( (a2 & 1) != 0 )
  {
    *(_QWORD *)&v20 = "POSITION";
    DWORD2(v20) = 0;
    HIDWORD(v20) = dword_180151A20[(int)sub_1800D1FD8(a2, 32LL) + ((a2 & 0x10000) != 0 ? 18LL : 12LL)];
    v7 = 1;
    v6 = 1;
    *a3 = v20;
    a3[1] = 0u;
  ...
  if ( (a2 & 2) != 0 )
  {
    *(_QWORD *)&v21 = "VERTEX_LAYOUT_SLOT_NORMAL";
    DWORD2(v21) = 0;
    HIDWORD(v21) = dword_180151A20[(int)sub_1800D1FD8(a2, 35LL) + ((a2 & 0x20000) != 0 ? 18LL : 12LL)];
    v6 = v7 + 1;
    v8 = 2LL * v7;
    a3[v8] = v21;
    a3[v8 + 1] = 1uLL;
  ...
  if ( (a2 & 4) != 0 )
  {
    *(_QWORD *)&v22 = "VERTEX_LAYOUT_SLOT_TANGENT";
    DWORD2(v22) = 0;
    HIDWORD(v22) = dword_180151A20[(int)sub_1800D1FD8(a2, 41LL) + ((a2 & 0x80000) != 0 ? 18LL : 12LL)];
    v6 = v7 + 1;
    v9 = 2LL * v7;
    a3[v9] = v22;
    a3[v9 + 1] = 2uLL;
  ...
  if ( (a2 & 8) != 0 )
  {
    *(_QWORD *)&v23 = "VERTEX_LAYOUT_SLOT_BINORMAL";
    DWORD2(v23) = 0;
    HIDWORD(v23) = dword_180151A20[(int)sub_1800D1FD8(a2, 44LL) + 12];
    v6 = v7 + 1;
    v10 = 2LL * v7;
    a3[v10] = v23;
    a3[v10 + 1] = 3uLL;
  ...
  if ( (a2 & 0x10) != 0 )
  {
    *(_QWORD *)&v24 = "VERTEX_LAYOUT_SLOT_COLOR";
    DWORD2(v24) = 0;
    HIDWORD(v24) = dword_180151A20[(int)sub_1800D1FD8(a2, 38LL) + ((a2 & 0x40000) != 0 ? 18LL : 12LL)];
    v6 = v7 + 1;
    v11 = 2LL * v7;
    a3[v11] = v24;
    a3[v11 + 1] = 4uLL;
  ...
  if ( (a2 & 0x20) != 0 )
  {
    *(_QWORD *)&v25 = "VERTEX_LAYOUT_SLOT_TEXCOORD";
    DWORD2(v25) = 0;
    HIDWORD(v25) = dword_180151A20[(int)sub_1800D1FD8(a2, 47LL)
                                 + 6
  ...
  if ( (a2 & 0x40) != 0 )
  {
    *(_QWORD *)&v26 = "VERTEX_LAYOUT_SLOT_TEXCOORD";
    DWORD2(v26) = 1;
    HIDWORD(v26) = dword_180151A20[(int)sub_1800D1FD8(a2, 50LL) + (v12 != 0 ? 18LL : 6LL)];
    v6 = v7 + 1;
    v14 = 2LL * v7;
    a3[v14] = v26;
    a3[v14 + 1] = 6uLL;
  ...
  if ( (a2 & 0x200) != 0 )
  {
    *(_QWORD *)&v29 = "VERTEX_LAYOUT_SLOT_BLENDWEIGHT";
    DWORD2(v29) = 0;
    HIDWORD(v29) = dword_180151A20[(int)sub_1800D1FD8(a2, 53LL) + 18];
    v6 = v7 + 1;
    v17 = 2LL * v7;
    a3[v17] = v29;
    a3[v17 + 1] = 9uLL;
  ...
  if ( (a2 & 0x400) != 0 )
  {
    *(_QWORD *)&v30 = "VERTEX_LAYOUT_SLOT_BLENDINDICES";
    DWORD2(v30) = 0;
    HIDWORD(v30) = dword_180151A20[(int)sub_1800D1FD8(a2, 56LL) + 18];
    v6 = v7 + 1;
    v18 = 2LL * v7;
    a3[v18] = v30;
    a3[v18 + 1] = 0xAuLL;
