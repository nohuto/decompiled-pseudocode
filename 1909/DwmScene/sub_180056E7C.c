/*
 * XREFs of sub_180056E7C @ 0x180056E7C
 * Callers:
...
__int64 sub_180056E7C()
{
  ...
  if ( dword_18026A930 > *(_DWORD *)(v0 + 44) )
  {
    Init_thread_header(&dword_18026A930);
    if ( dword_18026A930 == -1 )
    {
      *(_QWORD *)&Src = &unk_1801A15C0;
      *((_QWORD *)&Src + 1) = &unk_1801A1E8C;
      *(_QWORD *)&v35 = 0x100000005LL;
      v38 = Src;
      v39 = v35;
      sub_180056B44();
      v2 = (_QWORD *)sub_1800D45C8(v36);
      v3 = sub_180056A54(v2, 0LL, "ImageProcessingBlur/ShaderModel40/", 0x22uLL);
      si128 = 0LL;
      Src = *(_OWORD *)v3;
      si128 = *((__m128i *)v3 + 1);
      v3[2] = 0LL;
      ...
      *(_BYTE *)v3 = 0;
      ...
      v4[3] = 15LL;
      *(_BYTE *)v4 = 0;
      byte_18026A92C = sub_1800D46B4(&v34, &v38);
      ...
      Init_thread_footer(&dword_18026A930);
    }
  }
  if ( dword_18026A938 > *(_DWORD *)(v0 + 44) )
  {
    Init_thread_header(&dword_18026A938);
    if ( dword_18026A938 == -1 )
    {
      *(_QWORD *)&Src = &unk_1801A1E90;
      *((_QWORD *)&Src + 1) = &unk_1801A2A4C;
      *(_QWORD *)&v37 = 0x100000005LL;
      v38 = Src;
      v39 = v37;
      sub_180056B44();
      v7 = (_QWORD *)sub_1800D45C8(v36);
      v8 = sub_180056A54(v7, 0LL, "ImageProcessingBlur/ShaderModel40/", 0x22uLL);
      si128 = 0LL;
      Src = *(_OWORD *)v8;
      si128 = *((__m128i *)v8 + 1);
      v8[2] = 0LL;
      ...
      *(_BYTE *)v8 = 0;
      ...
      v9[3] = 15LL;
      *(_BYTE *)v9 = 0;
      byte_18026A934 = sub_1800D46B4(&v34, &v38);
      if ( si128.m128i_i64[1] >= 0x10uLL )
      {
        v10 = Src;
        if ( (unsigned __int64)(si128.m128i_i64[1] + 1) >= 0x1000 )
      ...
      Init_thread_footer(&dword_18026A938);
    }
  }
  if ( dword_18026A940 > *(_DWORD *)(v0 + 44) )
  {
    Init_thread_header(&dword_18026A940);
    if ( dword_18026A940 == -1 )
    {
      *(_QWORD *)&Src = &unk_1801A2A50;
      *((_QWORD *)&Src + 1) = &unk_1801A3BEC;
      *(_QWORD *)&v37 = 0x100000005LL;
      v38 = Src;
      v39 = v37;
      sub_180056B44();
      v12 = (_QWORD *)sub_1800D45C8(v36);
      v13 = sub_180056A54(v12, 0LL, "ImageProcessingBlur/ShaderModel40/", 0x22uLL);
      si128 = 0LL;
      Src = *(_OWORD *)v13;
      si128 = *((__m128i *)v13 + 1);
      v13[2] = 0LL;
      ...
      *(_BYTE *)v13 = 0;
      ...
      v14[3] = 15LL;
      *(_BYTE *)v14 = 0;
      byte_18026A93C = sub_1800D46B4(&v34, &v38);
      if ( si128.m128i_i64[1] >= 0x10uLL )
      {
        v15 = Src;
        if ( (unsigned __int64)(si128.m128i_i64[1] + 1) >= 0x1000 )
      ...
      Init_thread_footer(&dword_18026A940);
    }
  }
  if ( dword_18026A948 > *(_DWORD *)(v0 + 44) )
  {
    Init_thread_header(&dword_18026A948);
    if ( dword_18026A948 == -1 )
    {
      *(_QWORD *)&Src = &unk_1801A3BF0;
      *((_QWORD *)&Src + 1) = &unk_1801A41DC;
      *(_QWORD *)&v37 = 0x100000001LL;
      v38 = Src;
      v39 = v37;
      sub_180056B44();
      v17 = (_QWORD *)sub_1800D45C8(v36);
      v18 = sub_180056A54(v17, 0LL, "ImageProcessingBlur/ShaderModel40/", 0x22uLL);
      si128 = 0LL;
      Src = *(_OWORD *)v18;
      si128 = *((__m128i *)v18 + 1);
      v18[2] = 0LL;
      ...
      *(_BYTE *)v18 = 0;
      ...
      v19[3] = 15LL;
      *(_BYTE *)v19 = 0;
      byte_18026A944 = sub_1800D46B4(&v34, &v38);
      if ( si128.m128i_i64[1] >= 0x10uLL )
      {
        v20 = Src;
        if ( (unsigned __int64)(si128.m128i_i64[1] + 1) >= 0x1000 )
      ...
      Init_thread_footer(&dword_18026A948);
    }
  }
  if ( dword_18026A950 > *(_DWORD *)(v0 + 44) )
  {
    Init_thread_header(&dword_18026A950);
    if ( dword_18026A950 == -1 )
    {
      *(_QWORD *)&Src = &unk_1801A3BF0;
      *((_QWORD *)&Src + 1) = &unk_1801A41DC;
      *(_QWORD *)&v37 = 0x100000001LL;
      ...
      v39 = v37;
      sub_180056B44();
      v22 = (_QWORD *)sub_1800D45C8(v36);
      v23 = sub_180056A54(v22, 0LL, "ImageProcessingBlur/ShaderModel40/", 0x22uLL);
      si128 = 0LL;
      Src = *(_OWORD *)v23;
      si128 = *((__m128i *)v23 + 1);
      v23[2] = 0LL;
      ...
      *(_BYTE *)v23 = 0;
      ...
      v24[3] = 15LL;
      *(_BYTE *)v24 = 0;
      byte_18026A94C = sub_1800D46B4(&v34, &v38);
      if ( si128.m128i_i64[1] >= 0x10uLL )
      {
        v25 = Src;
        if ( (unsigned __int64)(si128.m128i_i64[1] + 1) >= 0x1000 )
      ...
      Init_thread_footer(&dword_18026A950);
    }
  }
  if ( dword_18026A958 > *(_DWORD *)(v0 + 44) )
  {
    Init_thread_header(&dword_18026A958);
    if ( dword_18026A958 == -1 )
    {
      *(_QWORD *)&Src = &unk_1801A3BF0;
      *((_QWORD *)&Src + 1) = &unk_1801A41DC;
      *(_QWORD *)&v37 = 0x100000001LL;
      ...
      v39 = v37;
      sub_180056B44();
      v27 = (_QWORD *)sub_1800D45C8(v36);
      v28 = sub_180056A54(v27, 0LL, "ImageProcessingBlur/ShaderModel40/", 0x22uLL);
      si128 = 0LL;
      Src = *(_OWORD *)v28;
      si128 = *((__m128i *)v28 + 1);
      v28[2] = 0LL;
      ...
      *(_BYTE *)v28 = 0;
      ...
      v29[3] = 15LL;
      *(_BYTE *)v29 = 0;
      byte_18026A954 = sub_1800D46B4(&v34, &v38);
      if ( si128.m128i_i64[1] >= 0x10uLL )
      {
        v30 = Src;
        if ( (unsigned __int64)(si128.m128i_i64[1] + 1) >= 0x1000 )
      ...
      Init_thread_footer(&dword_18026A958);
    }
  }
  return 0LL;
}
