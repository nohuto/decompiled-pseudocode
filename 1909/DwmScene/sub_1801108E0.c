/*
 * XREFs of sub_1801108E0 @ 0x1801108E0
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall sub_1801108E0(__int64 a1, __int128 *a2, __int64 a3)
{
  __int64 v6; // rdx
  __int64 v7; // rsi
...
LABEL_22:
  ...
  v19[2] = 0LL;
  v19[3] = 0LL;
  sub_18000F444(v19, (__int64)v24);
  v9 = sub_1800A3CBC(a2, &v20, v19, &v18);
  v10 = (__int64 *)(a1 + 56);
  ...
  sub_1800EBFE8(*v10, v12);
  v13 = *v10 + 528;
  if ( v13 != a3 )
    sub_180016920(v13, *(char **)a3, *(_QWORD *)(a3 + 8));
