/*
 * XREFs of sub_1801012B0 @ 0x1801012B0
 * Callers:
 *     <none>
 * Callees:
 ...
 *     sub_180100524 @ 0x180100524 (sub_180100524.c)
 *     sub_180100558 @ 0x180100558 (sub_180100558.c)
 *     sub_1801006E8 @ 0x1801006E8 (sub_1801006E8.c)
 *     sub_18010071C @ 0x18010071C (sub_18010071C.c)
 *     _guard_dispatch_icall_nop @ 0x180127740 (_guard_dispatch_icall_nop.c)
 */

// Hidden C++ exception states: #wind=9
__int64 __fastcall sub_1801012B0(__int64 a1, __int64 *a2, _QWORD *a3)
{
  __int64 v6; // rax
  __int64 v7; // rsi
...
LABEL_37:
      ...
      *(_QWORD *)&v28 = 0x100000001LL;
      DWORD2(v28) = v14;
      HIDWORD(v28) = v14;
      sub_1800B11FC(a1, &v28);
      sub_1800AF560(a1, a2, a3);
      v15 = sub_18010071C(a1, &v32);
      sub_1800A5238(v7, a1 + 1768, v15);
      v16 = v33;
      if ( v33 )
      {
      ...
      v17 = sub_180100558(a1, &v34);
      sub_1800A5238(v7, a1 + 1848, v17);
      v18 = v35;
      if ( v35 )
      {
...
LABEL_45:
  v19 = sub_1801006E8(a1, &v36);
  sub_1800A527C(v7, a1 + 1768, v19);
  v20 = v37;
  if ( v37 )
  {
  ...
  v21 = sub_180100524(a1, &v38);
  result = sub_1800A527C(v7, a1 + 1848, v21);
  v23 = v39;
  if ( v39 )
  {
