/*
 * XREFs of sub_180134770 @ 0x180134770
 * Callers:
 *     <none>
 * Callees:
...
void __fastcall __noreturn sub_180134770(__int64 a1, _QWORD *a2)
{
  __int64 v3; // rdi
  char *v4; // rbx
  char *v5; // r14
  ...
  sub_1800B2C60((__int64)v6, &v4[a2[8]], v5, v4);
  v7 = (__int64)&v4[32 * v3];
  LocaleT = (__int64 *)_LocaleUpdate::GetLocaleT(v6);
  sub_1800AB644((__int64)v5, *LocaleT, v7);
  v9 = (__int64 *)a2[6];
  sub_18006DFB4((__int64)v6, v9, (__int64 *)*LocaleT);
  *LocaleT = (__int64)v9;
  throw;
}
