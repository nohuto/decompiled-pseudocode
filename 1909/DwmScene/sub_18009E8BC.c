/*
 * XREFs of sub_18009E8BC @ 0x18009E8BC
 * Callers:
...
__int64 __fastcall sub_18009E8BC(__int64 a1, __int64 a2, __int64 a3)
{
  unsigned int v6; // eax
  __int64 *v7; // r8
  __int64 *v8; // rcx
