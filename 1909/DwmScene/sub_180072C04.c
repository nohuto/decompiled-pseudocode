/*
 * XREFs of sub_180072C04 @ 0x180072C04
 * Callers:
...
__int64 __fastcall sub_180072C04(__int64 **a1, __int64 a2, _DWORD *a3)
{
  __int64 *v3; // rbx
  __int64 v6; // rax
  int v7; // edx
...
LABEL_10:
    v11 = a3;
    v8 = sub_180032564((__int64)a1, (__int64)&unk_1801E0D04, &v11);
