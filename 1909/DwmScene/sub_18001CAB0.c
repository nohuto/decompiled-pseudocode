/*
 * XREFs of sub_18001CAB0 @ 0x18001CAB0
 * Callers:
...
_QWORD *__fastcall sub_18001CAB0(_QWORD *a1, _QWORD *a2, __int64 a3, __int64 a4, __int64 a5)
{
  __int64 v9; // rax
  __int64 v10; // rcx
  __int64 v11; // r8
