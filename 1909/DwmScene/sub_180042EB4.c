/*
 * XREFs of sub_180042EB4 @ 0x180042EB4
 * Callers:
...
__int64 __fastcall sub_180042EB4(__int64 a1, __int64 **a2)
{
  __int64 *v4; // r14
  __int64 *v5; // rbx
  ...
  while ( v5 != v4 )
  {
    ...
    *(_QWORD *)&v17 = v7;
    ...
    HIDWORD(v17) = dword_180151A20[6 * *((unsigned __int8 *)v5 + 40) - 6 + *((int *)v5 + 9)];
    v18 = *((unsigned int *)v5 + 11);
    v8 = *((_QWORD *)&v21 + 1);
    if ( v22 == *((_QWORD *)&v21 + 1) )
    {
      sub_180042480((const void **)&v21, *((_BYTE **)&v21 + 1), &v17);
    }
    else
    {
      **((_OWORD **)&v21 + 1) = v17;
    ...
    v9 = sub_18002C0E4((const void **)&v17, v5, " ");
    v10 = v9;
  ...
  *(_QWORD *)(a1 + 40) = 0LL;
  *(_QWORD *)(a1 + 48) = 0LL;
  sub_18000F444((_QWORD *)(a1 + 24), (__int64)Src);
