/*
 * XREFs of sub_18003ED60 @ 0x18003ED60
 * Callers:
...
__int64 __fastcall sub_18003ED60(__int64 **a1, __int64 a2, unsigned int *a3)
{
  __int64 *v3; // rbx
  __int64 v6; // rax
  unsigned int v7; // edx
...
LABEL_10:
    v11 = a3;
    v8 = sub_180032564((__int64)a1, (__int64)&unk_1801502A2, &v11);
