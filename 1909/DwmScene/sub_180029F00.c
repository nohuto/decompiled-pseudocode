/*
 * XREFs of sub_180029F00 @ 0x180029F00
 * Callers:
...
__int64 __fastcall sub_180029F00(_QWORD **a1)
{
  __int64 result; // rax
  __int64 v3; // rax
  ...
  if ( !(_DWORD)result )
  {
    if ( (_DWORD)v5 )
    {
      sub_1800276D4(a1 + 206, (__int64)v4, (unsigned int *)&v5);
      v3 = v4[0];
      *(_OWORD *)(v4[0] + 40LL) = v5;
      *(_OWORD *)(v3 + 56) = v6;
      sub_180027630(a1 + 208, (__int64)v4, (unsigned int *)&v5 + 2);
      result = v4[0];
      *(_QWORD *)(v4[0] + 40LL) = v6;
    }
  }
