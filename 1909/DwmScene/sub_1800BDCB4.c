/*
 * XREFs of sub_1800BDCB4 @ 0x1800BDCB4
 * Callers:
...
__int64 __fastcall sub_1800BDCB4(__int64 a1, _QWORD *a2)
{
  ...
  v34 = 7LL;
  LOWORD(v32[0]) = 0;
  sub_180026278((char *)v32, L"Lighting.", 9uLL);
  v30 = 0LL;
  v31 = 7LL;
  LOWORD(v29[0]) = 0;
  sub_180026278((char *)v29, L"/Internal/Lighting.", 0x13uLL);
...
LABEL_14:
  ...
  v25 = _mm_load_si128((const __m128i *)&xmmword_18014BA40);
  LOWORD(v24[0]) = 0;
  v14 = v30;
  v15 = v30;
  if ( a2[2] < v30 )
