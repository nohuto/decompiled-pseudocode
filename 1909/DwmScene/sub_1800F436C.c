/*
 * XREFs of sub_1800F436C @ 0x1800F436C
 * Callers:
...
__int64 __fastcall sub_1800F436C(__int64 *a1, __int64 a2, __int64 a3)
{
  __int64 v4; // rsi
  __int64 v6; // rbx
  __int64 v7; // rbp
  ...
  if ( v8 > v10 )
  {
    if ( v8 <= 0x666666666666666LL )
    {
      ...
      *a1 = 0LL;
      ...
      if ( v8 <= 0x666666666666666LL )
      {
        v14 = sub_1800F3D74((__int64)a1, v8);
        *a1 = (__int64)v14;
        a1[1] = (__int64)v14;
        a1[2] = *a1 + 40 * v8;
LABEL_18:
        ...
        v16 = v4;
LABEL_25:
        result = sub_1800F471C(v16, a3, v15, a1);
        a1[1] = result;
        return result;
      }
    }
