/*
 * XREFs of sub_180044660 @ 0x180044660
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall sub_180044660(__int64 a1, _QWORD *a2, _QWORD *a3)
{
  __int64 *v6; // rax
  ...
  volatile signed __int32 *v15; // [rsp+40h] [rbp-58h]
  __int64 v16; // [rsp+48h] [rbp-50h] BYREF
  volatile signed __int32 *v17; // [rsp+50h] [rbp-48h]
  __int64 v18; // [rsp+58h] [rbp-40h] BYREF

  v6 = sub_180027778(&v14, a3);
  ...
  v18 = 0LL;
  sub_180033E2C(*(_QWORD **)(a1 + 104), &v18);
