/*
 * XREFs of sub_18002D0C8 @ 0x18002D0C8
 * Callers:
...
__int64 __fastcall sub_18002D0C8(__int64 a1, int a2, int a3, int a4, int a5)
{
  int v6; // r12d
  int v7; // r15d
  __int64 v9; // rdx
  ...
  sub_180064408(a1, v28);
  if ( !v29 )
  {
    if ( v30 < 0x11 )
    {
      sub_18000E168((__int64 *)v28, 0x11uLL, 0LL, "RenderTargetD3D11");
    }
    else
    {
      v14 = v28[0];
  ...
  v21[2] = 0LL;
  v21[3] = 0LL;
  sub_18000F444(v21, (__int64)v28);
  sub_1800645F4(*v12, v21);
  sub_18009D310((unsigned int)v31, v7, v6, a4, a5 & 0xFFFFFF7C | 3, 0);
  result = sub_18009DEA4(*v12, v31);
  if ( (a5 & 0x80u) != 0 )
  {
    if ( !*(_QWORD *)(a1 + 112) )
    {
      v16 = sub_180015A44(v27, &v24);
    ...
    v18 = sub_18002C0E4(&Src, v28, " (staging)");
    sub_1800645F4(*(_QWORD *)(a1 + 112), v18);
    sub_18009D310((unsigned int)v32, v7, v6, a4, a5 & 0xFFFFFF7C | 0x80, 3);
    result = sub_18009DEA4(*(_QWORD *)(a1 + 112), v32);
  }
  if ( v30 >= 0x10 )
  {
    v19 = v28[0];
