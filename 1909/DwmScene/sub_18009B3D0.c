/*
 * XREFs of sub_18009B3D0 @ 0x18009B3D0
 * Callers:
...
__int64 __fastcall sub_18009B3D0(__int64 a1, __int64 a2, __int64 a3, __int64 a4)
{
  int v4; // edi
  __int64 result; // rax
  __int64 v6; // r8
  ...
  if ( (*(_DWORD *)(*(_QWORD *)a4 + 440LL) & 0x810000) == 0x810000 )
  {
    ...
    v19 = v6;
    v20 = v7;
    result = (__int64)sub_180012680(v6, &v23);
    if ( v7 )
    {
    ...
    if ( v23 )
    {
      ...
      while ( v11 );
      sub_180099950((unsigned __int64 *)(v10 + 88), &v25);
      v21 = xmmword_1801EFDE0;
      v22 = xmmword_1801EFDE0;
      v14 = v27;
      LODWORD(v15) = v28;
      v16 = v25;
      v17 = v26;
      sub_1800F0FE4(v4, (unsigned int)&v16, (unsigned int)&v14, (unsigned int)&v22, (__int64)&v21, 1077936128);
    }
    v13 = v24;
    if ( v24 )
    {
