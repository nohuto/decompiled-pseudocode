/*
 * XREFs of sub_18000F058 @ 0x18000F058
 * Callers:
...
__int64 __fastcall sub_18000F058(__int64 a1, __int64 a2, unsigned int a3, unsigned int a4)
{
  unsigned int v8; // eax
  unsigned int v9; // ecx
