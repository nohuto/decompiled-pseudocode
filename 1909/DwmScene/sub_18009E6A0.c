/*
 * XREFs of sub_18009E6A0 @ 0x18009E6A0
 * Callers:
...
__int64 *__fastcall sub_18009E6A0(__int64 *a1, int *a2, unsigned __int64 a3)
{
...
LABEL_9:
    ...
    v16 = *(&v18 + a2[4]);
    v29[0] = v6 * v7;
    sub_18009D070(a1, v29, (__int64 *)&v17, &v16, &v32, (int *)&v31, &v30);
    v31 = ++v7;
    if ( v7 >= v5 )
      return a1;
    v6 = v17;
