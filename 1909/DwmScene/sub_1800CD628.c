/*
 * XREFs of sub_1800CD628 @ 0x1800CD628
 * Callers:
 *     sub_1800CE950 @ 0x1800CE950 (sub_1800CE950.c)
 * Callees:
...
_QWORD *__fastcall sub_1800CD628(__int64 a1, _QWORD *a2, __int64 a3, __int64 *a4)
{
  __int64 v7; // rbx
