/*
 * XREFs of sub_1800712F4 @ 0x1800712F4
 * Callers:
...
_QWORD *__fastcall sub_1800712F4(__int64 **a1, _QWORD *a2, __int64 *a3, _QWORD *a4, _QWORD *a5)
{
  __int64 *v9; // rcx
  _QWORD *result; // rax
  __int64 *v11; // rbx
  ...
  if ( a1[1] )
  {
    ...
    if ( a3 == v9 )
    {
      ...
      {
        sub_1800325A8(a1, a2, 0, (_QWORD *)(*a1)[2], (int)a4, a5);
        return a2;
      }
      goto LABEL_29;
    }
    if ( (int)_std_type_info_compare(*a4 + 8LL, a3[4] + 8) >= 0
      || (v16 = a3, sub_180020BC0(&v16), v11 = v16, (int)_std_type_info_compare(v16[4] + 8, *a4 + 8LL) >= 0) )
    {
      ...
      {
LABEL_29:
        *a2 = *(_QWORD *)sub_180071F58((_DWORD)a1, (unsigned int)v18, 0, (_DWORD)a4, (__int64)a5);
        return a2;
      }
      if ( *(_BYTE *)(a3[2] + 25) )
        sub_1800325A8(a1, a2, 0, a3, (int)a4, a5);
      else
        sub_1800325A8(a1, a2, 1, (_QWORD *)v12, (int)a4, a5);
      return a2;
    }
    else
    {
  ...
  else
  {
    ...
    {
      sub_180038DB4(v18[0], (__int64)v17);
      throw;
    }
  }
  return result;
