/*
 * XREFs of sub_1800BC470 @ 0x1800BC470
 * Callers:
...
__int64 __fastcall sub_1800BC470(_QWORD *a1, __int64 a2, char a3, size_t *a4, _QWORD *a5)
{
  _QWORD *v7; // rax
  __int64 *v8; // rdx
  __int64 *v9; // r13
  ...
  try
  {
    ...
    if ( v11 )
    {
      if ( v9 == (__int64 *)*v8 )
      {
        *(_QWORD *)a2 = *sub_1800BBDD0(a1, &v34, 1, v9, (int)a4, v7);
        *(_BYTE *)(a2 + 8) = 1;
        return a2;
      }
      sub_180020BC0(&v32);
    ...
    {
      *(_QWORD *)a2 = *sub_1800BBDD0(v34, &v32, v11, v9, (int)a4, v33);
      *(_BYTE *)(a2 + 8) = 1;
    }
    result = a2;
  }
