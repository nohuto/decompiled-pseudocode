/*
 * XREFs of sub_18003C0C0 @ 0x18003C0C0
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall sub_18003C0C0(__int64 a1, _QWORD *a2, int *a3, int *a4)
{
  int v5; // edi
  int v6; // esi
  _QWORD *v7; // rax
  ...
  *a2 = 0LL;
  ...
  v5 = *a4;
  v6 = *a3;
  v7 = (_QWORD *)sub_180064408(*(_QWORD *)(a1 + 8), v21);
