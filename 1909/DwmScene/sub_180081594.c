/*
 * XREFs of sub_180081594 @ 0x180081594
 * Callers:
...
__int64 __fastcall sub_180081594(__int64 a1, _QWORD *a2, __int64 a3)
{
  __int64 v5; // rax
  ...
  *(_QWORD *)(a1 + 576) = 0LL;
  *(_QWORD *)(a1 + 584) = 0LL;
  v6 = _InterlockedIncrement64(&qword_180259748);
  *(_QWORD *)(a1 + 208) = v6;
  v7 = *(_QWORD *)(a1 + 216);
  if ( v6 >= v7 )
    v7 = v6;
