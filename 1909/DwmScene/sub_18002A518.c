/*
 * XREFs of sub_18002A518 @ 0x18002A518
 * Callers:
...
void __fastcall sub_18002A518(__int64 a1)
{
  int v2; // ecx
  signed int v3; // esi
  __int64 **v4; // r15
  ...
  do
  {
    ...
    v44 = v5;
    if ( sub_18002BC14(a1 + 1648, &v44) )
    {
      sub_1800276D4((__int64 **)(a1 + 1648), (__int64)&v41, &v44);
      sub_180029D4C(a1, &v39, *(_DWORD *)(v41 + 44));
      v6 = v39;
      if ( v39 <= 0 )
        break;
      sub_180027630((__int64 **)(a1 + 1680), (__int64)&v42, &v44);
      v7 = v42;
      goto LABEL_21;
    }
    v8 = *v4;
    ...
    if ( v9 == *(__int64 **)(a1 + 1648) )
      break;
    v12 = v38;
    sub_180029D4C(a1, &v40, *((_DWORD *)v38 + 11));
    sub_180029D4C(a1, &v37, *((_DWORD *)v9 + 11));
    if ( v40 <= 0 || v37 <= 0 )
      break;
    v6 = v40
       + (int)(v44 - *((_DWORD *)v12 + 8)) * ((v37 - v40) / (unsigned int)(*((_DWORD *)v9 + 8) - *((_DWORD *)v12 + 8)));
    sub_180027630((__int64 **)(a1 + 1680), (__int64)&v43, &v44);
    v7 = v43;
LABEL_21:
    *(_QWORD *)(v7 + 40) = v6;
    --*(_DWORD *)(a1 + 1640);
