/*
 * XREFs of sub_180063064 @ 0x180063064
 * Callers:
...
_QWORD *__fastcall sub_180063064(_QWORD *a1, __int64 *a2, int a3, __int64 a4, char a5)
{
  ...
  v17[2] = 0LL;
  v17[3] = 0LL;
  sub_18000F444(v17, (__int64)a2);
  sub_180065920((_DWORD)a1, (unsigned int)v17, a3, -2147024891, a4, a5);
