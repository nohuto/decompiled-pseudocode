/*
 * XREFs of sub_180124C90 @ 0x180124C90
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall sub_180124C90(__int64 a1)
{
  int v2; // eax
  char v3; // si
  _QWORD *v4; // rdx
  ...
  *(_BYTE *)(a1 + 112) = 1;
  ...
  sub_18006E354((_QWORD **)&v16, &v15, (_QWORD *)*v8, v8);
