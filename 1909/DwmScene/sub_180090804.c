/*
 * XREFs of sub_180090804 @ 0x180090804
 * Callers:
...
__int64 __fastcall sub_180090804(__int64 a1, _QWORD *a2, unsigned __int16 a3, __int64 a4)
{
  __int64 *v8; // rdx
  __int64 *v9; // rax
  __int64 *v10; // rcx
  ...
  _BYTE v16[8]; // [rsp+38h] [rbp-60h] BYREF
  volatile signed __int32 *v17; // [rsp+40h] [rbp-58h]
...
LABEL_8:
  ...
  {
    *((_DWORD *)v9 + 8) = 2;
    v11 = (_QWORD *)sub_1800A9000(*(_QWORD *)(a1 + 136), v16);
  ...
  {
    *((_DWORD *)v9 + 8) = 3;
    v14 = (_QWORD *)sub_1800A9000(*(_QWORD *)(a1 + 136), v18);
