/*
 * XREFs of sub_180015B44 @ 0x180015B44
 * Callers:
...
_QWORD *__fastcall sub_180015B44(__int64 *a1, _QWORD *a2)
{
  ...
  v6 = _std_type_info_hash(&qword_18025FFC8);
  v7 = (__int64 *)*a1;
  v8 = *(__int64 **)(*a1 + 8);
  if ( *((_BYTE *)v8 + 25) )
    goto LABEL_10;
