/*
 * XREFs of sub_180013C50 @ 0x180013C50
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall sub_180013C50(__int64 a1, __int64 *a2)
{
  __int64 v4; // r8
  __int64 v5; // rdx
  ...
  sub_180089934(v18, &v19, -1LL, &v15, *(_QWORD *)(a1 + 32), v7, v16);
  v17 = 0LL;
  v8 = sub_180013A60(&v17, &v19);
  v9 = v8;
  if ( v8 >= 0 )
  {
    v11 = v17;
