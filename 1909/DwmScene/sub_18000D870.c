/*
 * XREFs of sub_18000D870 @ 0x18000D870
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall sub_18000D870(volatile signed __int32 *a1)
{
  __int64 v1; // r9
  __int64 v2; // r8
  unsigned int v3; // ebx
  ...
  {
    if ( a1 )
      (*(void (__fastcall **)(volatile signed __int32 *, __int64, __int64, __int64))(*(_QWORD *)a1 + 112LL))(
        a1,
        1LL,
        v2,
        0x7FFFFFFFLL);
