/*
 * XREFs of sub_180099150 @ 0x180099150
 * Callers:
 *     <none>
 * Callees:
...
_QWORD *__fastcall sub_180099150(__int64 a1, _QWORD *a2, __int64 a3, _QWORD *a4)
{
  __int64 v8; // rbx
  __int64 v9; // xmm6_8
