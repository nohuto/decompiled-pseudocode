/*
 * XREFs of sub_18011FA28 @ 0x18011FA28
 * Callers:
 *     sub_180122D00 @ 0x180122D00 (sub_180122D00.c)
 * Callees:
 ...
 *     sub_180124654 @ 0x180124654 (sub_180124654.c)
 *     sub_180124658 @ 0x180124658 (sub_180124658.c)
 *     sub_1801247BC @ 0x1801247BC (sub_1801247BC.c)
 *     sub_18012482C @ 0x18012482C (sub_18012482C.c)
...
__int64 __fastcall sub_18011FA28(__int64 a1, _QWORD *a2, char a3, int a4)
{
  ...
  if ( (unsigned __int8)sub_1801247BC(v18[0] + 64, v12) )
  {
    ...
    else
    {
      ...
      if ( (unsigned __int8)sub_180124844(v13) )
      {
        ...
        if ( (unsigned __int8)sub_1801247BC(v13, v14)
          && (v19 = 0LL,
              ...
              v15 = sub_180124658(v13, v18),
              (unsigned __int8)sub_18012482C(v15)) )
        {
          if ( (unsigned __int8)sub_180124654(v15) != a3 )
          {
            v19 = 0LL;
            v20 = 0LL;
            sub_18001115C(v18, (__int64)v26);
            sub_18011F964(v13, v18, a3);
            v10 = 1;
          }
        }
        else
      ...
      else if ( (unsigned __int8)sub_18012482C(v13) )
      {
        if ( (unsigned __int8)sub_180124654(v13) != a3 )
        {
          v22 = 0LL;
          v23 = 0LL;
          sub_18001115C(v21, (__int64)a2);
          sub_18011F964(v11, v21, a3);
          v10 = 1;
        }
      }
      else
