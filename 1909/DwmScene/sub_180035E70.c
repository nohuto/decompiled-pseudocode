/*
 * XREFs of sub_180035E70 @ 0x180035E70
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall sub_180035E70(__int64 a1, int a2, __int64 a3, unsigned int a4)
{
  __int64 v7; // rax
  __int64 *v8; // rcx
  char v9; // di
  ...
  if ( *(_QWORD *)a3 )
  {
    sub_180033F18((__int64 *)(*(_QWORD *)a3 + 112LL), &v18, *(_DWORD *)(a1 + 88));
    v8 = &v18;
    v9 = 1;
    v7 = v18;
  }
