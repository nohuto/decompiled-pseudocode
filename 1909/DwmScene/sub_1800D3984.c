/*
 * XREFs of sub_1800D3984 @ 0x1800D3984
 * Callers:
 *     sub_1800D4190 @ 0x1800D4190 (sub_1800D4190.c)
 * Callees:
 *     sub_180020BC0 @ 0x180020BC0 (sub_180020BC0.c)
 *     sub_1800D346C @ 0x1800D346C (sub_1800D346C.c)
 *     sub_1800D3D98 @ 0x1800D3D98 (sub_1800D3D98.c)
 *     memcmp @ 0x180125BB8 (memcmp.c)
 */

_QWORD *__fastcall sub_1800D3984(__int64 ***a1, _QWORD *a2, __int64 *a3, size_t *a4, _QWORD *a5)
{
  __int64 **v9; // rsi
  const void *v10; // rdx
  const void *v11; // rcx
  ...
  if ( a1[1] )
  {
    ...
    if ( a3 == **a1 )
    {
      ...
      if ( v15 < 0 )
      {
        sub_1800D346C(a1, a2, 1, a3, (int)a4, a5);
        return a2;
      }
      goto LABEL_91;
    }
    if ( a3 == (__int64 *)v9 )
    {
      ...
      if ( v23 < 0 )
      {
        sub_1800D346C(a1, a2, 0, v17, (int)a4, a5);
        return a2;
      }
      goto LABEL_91;
    }
    ...
    if ( v29 < 0 )
    {
      ...
      {
        if ( *(_BYTE *)(v30[2] + 25) )
          sub_1800D346C(a1, a2, 0, v30, (int)a4, a5);
        else
          sub_1800D346C(a1, a2, 1, a3, (int)a4, a5);
        return a2;
      }
    ...
    if ( (__int64 **)v39 != v9 )
    {
      ...
      {
LABEL_91:
        *a2 = *(_QWORD *)sub_1800D3D98((_DWORD)a1, (unsigned int)v54, 0, (_DWORD)a4, (__int64)a5);
        return a2;
      }
    }
    if ( v49 )
      sub_1800D346C(a1, a2, 0, a3, (int)a4, a5);
    else
      sub_1800D346C(a1, a2, 1, (_QWORD *)v39, (int)a4, a5);
    return a2;
  }
  else
  {
    try
    {
      sub_1800D346C(a1, a2, 1, *a1, (int)a4, a5);
      result = a2;
    }
    catch ( ... )
    {
      sub_1800D48B8(v54[0], v53);
      throw;
    }
  }
  return result;
