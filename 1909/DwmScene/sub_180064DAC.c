...
char __fastcall sub_180064DAC(__int64 a1, int a2, int a3, char a4, int a5, __int64 a6)
{
  int v6; // r12d
  int v7; // r15d
  _QWORD *v9; // r13
  ...
  *(_DWORD *)(a1 + 112) = a5;
  ...
  sub_180064408(a1, v33);
  if ( !v34 )
  {
    if ( v35 < 0x11 )
    {
      sub_18000E168((__int64 *)v33, 0x11uLL, 0LL, "RenderTargetD3D11");
    }
    else
    {
      v12 = v33[0];
  ...
  v31[2] = 0LL;
  v31[3] = 0LL;
  sub_18000F444(v31, (__int64)v33);
  sub_1800645F4(*v10, v31);
  sub_180064684(*v10, 1, 0);
  sub_180064684(*v10, 2, 0);
  sub_180064684(*v10, 4, 0);
  sub_180064684(*v10, 8, 0);
  v13 = a5 & 0x7C | 3;
  LODWORD(Size) = 0;
  sub_18009E070(*v10, v7, v6, 0, a4, 0, v13, 0LL, Size, 0LL);
  if ( (a5 & 0x80u) != 0 )
  {
    v14 = (__int64 *)(a1 + 152);
    if ( !*(_QWORD *)(a1 + 152) )
    {
      sub_180015F14(v9, &v29, 1u);
    ...
    v16 = (__int64 *)sub_18002C0E4(&Src, v33, " (staging)");
    sub_1800645F4(*v14, v16);
    sub_180064684(*v14, 1, 0);
    sub_180064684(*v14, 2, 0);
    sub_180064684(*v14, 4, 0);
    sub_180064684(*v14, 8, 0);
    LODWORD(Sizea) = 0;
    sub_18009E070(*v14, v7, v6, 0, a4, 3, v13 & 0x7C | 0x80, 0LL, Sizea, 0LL);
  }
  v17 = 0LL;
  v17.m128_f32[0] = (float)v6;
  v18 = 0LL;
  v18.m128_f32[0] = (float)v7;
  sub_180065720(a1, _mm_unpacklo_ps(v18, v17).m128_u64[0]);
  if ( a6 )
  ...
  if ( result )
  {
    ...
    else
    {
      ...
      result = sub_1800113D8((__int64 *)&v36);
    }
  }
  if ( v35 >= 0x10 )
  {
