/*
 * XREFs of sub_1800B53B0 @ 0x1800B53B0
 * Callers:
...
void __fastcall sub_1800B53B0(__int64 a1)
{
  ...
  v9 = _std_type_info_hash(&qword_180261210);
  sub_18001F560((__int64 **)a1, (__int64)&v6, (unsigned __int64 *)&v9);
  ...
  v8 = v7;
  sub_180026024((__int64)v7, v6 + 40);
  if ( v8 )
  {
    v4 = v7;
    LOBYTE(v4) = v8 != v7;
