/*
 * XREFs of sub_180014040 @ 0x180014040
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall sub_180014040(__int64 a1, __int128 *a2)
{
  __int64 v4; // r8
  __int64 v5; // r9
  ...
  v18[2] = v21;
  v18[3] = v22;
  if ( (unsigned __int8)sub_1800865F0(*(_QWORD *)(a1 + 32), v18) )
  {
    v17 = 0LL;
