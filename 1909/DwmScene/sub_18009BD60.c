/*
 * XREFs of sub_18009BD60 @ 0x18009BD60
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall sub_18009BD60(_QWORD *a1)
{
  __int64 result; // rax
  __int64 v3; // rdx
  __int64 *v4; // rdi
  ...
  v10 = 0LL;
  v11 = 0LL;
  result = (__int64)sub_180099A7C((__int64)a1, &v10, 0LL);
  if ( v10 )
  {
    v15 = 0LL;
    v3 = a1[8];
    ...
    if ( v4[9] )
    {
      ...
      if ( (_QWORD)v14 )
      {
        sub_180090B14(*v4, (__int64)&qword_18025D6D8, 1);
        v12 = 0LL;
        v6 = v4[10];
        if ( v6 )
        {
