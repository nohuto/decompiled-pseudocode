/*
 * XREFs of sub_180117F54 @ 0x180117F54
 * Callers:
...
void __fastcall sub_180117F54(__m128 *a1, unsigned int a2, __int64 a3, __int64 a4, __int64 a5, char a6)
{
  ...
  if ( a2 )
  {
    ...
    do
    {
      ...
      v29 = v15;
      v30 = v16;
      *(_QWORD *)&v17 = sub_18008362C(&v26, &v24).m128_u64[0];
      v18 = (unsigned __int64 *)sub_180082090(v22, &v26, v17);
      sub_18008210C(v28, &v24, v18);
      v19 = v28[1];
      *((_DWORD *)v6 - 2) = v28[0];
      *(_DWORD *)v6 = v28[2];
      *((_DWORD *)v6 - 1) = v19;
      sub_1800C2200(v9);
      v20 = (unsigned __int64 *)sub_180083430(&v26, v23, &v24);
      if ( sub_18008362C(v20, &v29).m128_f32[0] >= 0.0 )
        v21 = 1.0;
      else
        v21 = -1.0;
      if ( a6 )
