/*
 * XREFs of sub_18010363C @ 0x18010363C
 * Callers:
...
unsigned __int64 __fastcall sub_18010363C(__int64 a1, unsigned __int64 a2)
{
  _BYTE *v4; // rdi
  _BYTE *v5; // rcx
