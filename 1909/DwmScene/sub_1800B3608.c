/*
 * XREFs of sub_1800B3608 @ 0x1800B3608
 * Callers:
...
void __fastcall sub_1800B3608(_Thrd_imp_t *a1, __int64 *a2)
{
  __int64 v4; // rax
  int v5; // eax
  int v6; // ecx
