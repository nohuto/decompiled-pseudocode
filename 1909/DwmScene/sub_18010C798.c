/*
 * XREFs of sub_18010C798 @ 0x18010C798
 * Callers:
...
char *__fastcall sub_18010C798(char *a1, __int64 *a2, __int64 a3)
{
  __int64 *v3; // rbx
...
LABEL_4:
    ...
    while ( 1 )
    {
      ...
      if ( !*(_BYTE *)(v71 + 72) )
      {
        v93.m128_u64[0] = xmmword_18025F030;
        v93.m128_i32[2] = DWORD2(xmmword_18025F030);
      }
      v10 = v71;
      ...
      v22 = (float *)sub_180083754(v68, (__int64)v89);
      v23 = -v22[10];
      v24 = -v22[9];
      *(float *)&v91 = -v22[8];
      *((float *)&v91 + 1) = v24;
...
LABEL_49:
      v28 = a3;
      *(_OWORD *)(*(_QWORD *)(a3 + 64) + 16 * (v5 + 25)) = xmmword_18026C270;
LABEL_50:
      v97 = v93.m128_u64[0];
      v98 = v93.m128_i32[2];
      if ( v12 == 2 )
      ...
      else
      {
        ...
        *(float *)&v29 = *(float *)&v16 * *(float *)&v16;
        sub_180082320(&v97, v29);
        v30 = 1065353216;
      }
      v37 = sub_180082090(v87, &v97, *(double *)&v9);
      v75 = *(_QWORD *)v37;
      v76 = v37[2];
      ...
      *(float *)(v41 + 12) = *(float *)&v16 * *(float *)&v11;
      if ( v5 < 3 )
      {
        ...
        if ( v49 )
        {
          ...
          if ( *(_BYTE *)(v71 + 124) )
          {
            sub_1800AEAC8(v49, v101);
            v51 = a3;
            sub_1800B18A0(v101, (_OWORD *)(*(_QWORD *)(a3 + 64) + (v5 << 6)));
          }
          else
          {
            v52 = (_OWORD *)sub_1800814E0(
                              (__int64)v90,
                              (int *)&xmmword_18026C270,
                              &xmmword_18026C270,
                              &xmmword_18026C270,
                              &xmmword_18026C270);
            v51 = a3;
            sub_180081DBC((_OWORD *)(*(_QWORD *)(a3 + 64) + (v5 << 6)), v52);
          }
