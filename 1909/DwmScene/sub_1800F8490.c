/*
 * XREFs of sub_1800F8490 @ 0x1800F8490
 * Callers:
...
_QWORD *__fastcall sub_1800F8490(__int64 a1, _QWORD *a2, unsigned int a3)
{
  _QWORD *v6; // rcx
  __int64 v7; // rdx
  __int64 *v8; // rax
  ...
  v15[2] = 0LL;
  v15[3] = 0LL;
  sub_18000F444(v15, v7);
  v8 = sub_1800A9414(*(_QWORD *)(a1 + 16), &v16);
  sub_1800A4608(*v8, &v18, v15);
  v9 = v17;
  if ( v17 )
  {
