/*
 * XREFs of sub_18009DA28 @ 0x18009DA28
 * Callers:
...
__int64 __fastcall sub_18009DA28(__int64 a1, _QWORD *a2)
{
  __int64 v4; // r14
  __int64 *v5; // rbx
  char v6; // r15
  ...
  {
    sub_18000E4E8(v25);
    v18 = sub_18000E4E8(v24);
    sub_18006586C(v28, v18, 961LL, (__int64)v25, 0);
  ...
  {
    v6 = 0;
    if ( !sub_18009D788(*(_DWORD **)(a1 + 128), v5)
      || (v20 = *(_QWORD *)(v4 + 152),
          v22 = *(_QWORD *)(a1 + 144),
          v7 = 0LL,
          ...
          (_mm_movemask_ps(_mm_cmpeq_ps(_mm_unpacklo_ps(v8, (__m128)HIDWORD(v20)), _mm_unpacklo_ps(v7, (__m128)HIDWORD(v22)))) & 3) != 3) )
    {
      ...
      sub_18006586C(pExceptionObject, v17, 977LL, (__int64)v27, 0);
