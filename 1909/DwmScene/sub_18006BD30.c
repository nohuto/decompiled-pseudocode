/*
 * XREFs of sub_18006BD30 @ 0x18006BD30
 * Callers:
...
__int64 __fastcall sub_18006BD30(__int64 a1, __int64 a2, _QWORD *a3)
{
  unsigned int v6; // eax
  ...
  *(_QWORD *)(a1 + 16) = 0LL;
  if ( a2 )
    v6 = sub_1800634F4(a2 + 8);
  else
    v6 = 1;
  sub_18006314C(a1 + 24, v6);
  ...
  *(_WORD *)(a1 + 208) = 0;
  *(_DWORD *)(a1 + 240) = 1;
  *(_DWORD *)(a1 + 244) = _InterlockedExchangeAdd(&dword_1802596D4, 1u);
  *(_QWORD *)(a1 + 248) = 0LL;
  *(_QWORD *)(a1 + 256) = 0LL;
  *(_QWORD *)(a1 + 264) = 0LL;
  *(_QWORD *)(a1 + 272) = 0LL;
  ...
  *(_QWORD *)(a1 + 496) = 0LL;
  *(_QWORD *)(a1 + 504) = 0LL;
  *(_QWORD *)(a1 + 496) = sub_18006DF24(a1 + 496);
  ...
  *a3 = 0LL;
  a3[1] = 0LL;
  sub_1800E22F8(a1 + 608);
  sub_1800E22F8(a1 + 832);
  sub_1800E22F8(a1 + 1056);
  sub_1800E17A8(a1 + 1280);
  *(_QWORD *)(a1 + 3840) = 0LL;
  *(_QWORD *)(a1 + 3848) = 0LL;
  *(_QWORD *)(a1 + 3856) = 0LL;
  *(_QWORD *)(a1 + 3864) = 0LL;
  ...
  *(_DWORD *)(a1 + 4044) = 1065353216;
  sub_18006BCC8((_QWORD *)(a1 + 4096), a1);
  *(_OWORD *)(a1 + 424) = 0LL;
  *(_OWORD *)(a1 + 440) = 0LL;
  *(_OWORD *)(a1 + 456) = 0LL;
  *(_OWORD *)(a1 + 472) = 0LL;
