/*
 * XREFs of sub_18010F964 @ 0x18010F964
 * Callers:
 ...
 *     sub_1800A9F10 @ 0x1800A9F10 (sub_1800A9F10.c)
...
bool __fastcall sub_18010F964(__int64 a1, __int64 a2, char a3)
{
  __int64 v6; // r13
  int v7; // edx
  int v8; // eax
  ...
  if ( (*(_DWORD *)(v6 + 560) & 2) == 0 )
    v8 = v7;
  v33 = v8;
  v9 = sub_1800A8F24(*(_QWORD *)(a1 + 56), (__int64)&qword_18025D5F8);
  v10 = sub_1800A8F24(*(_QWORD *)(a1 + 56), (__int64)&qword_18025D598);
  v11 = sub_1800A8F24(*(_QWORD *)(a1 + 56), (__int64)&qword_18025D6D8);
  v12 = sub_1800A8F24(*(_QWORD *)(a1 + 56), (__int64)&qword_18025D5D8);
  v32 = v12;
  v13 = 1LL << v9;
  v37 = v13;
  if ( a3 )
  ...
  while ( 1 )
  {
    ...
    if ( !v20 || !v21 && (v19 & v18) == 0 )
    {
      v63 = 0LL;
      v64 = 0LL;
      sub_1800A8660(*(_QWORD *)(a1 + 56), &v63, v19, v15 & ~v19, 1);
      v69 = 0;
      v70 = 0;
      v71 = 0;
      v72 = 0;
      ...
      v79 = 1;
      v62 = 0uLL;
      sub_18001D8E4((_QWORD *)v6, &v62, 1u);
      sub_1800CC1A0(v62, (__int64)&v66, 0LL);
      *(_OWORD *)&v38[1] = 0LL;
      if ( *((_QWORD *)&v62 + 1) )
        _InterlockedIncrement((volatile signed __int32 *)(*((_QWORD *)&v62 + 1) + 8LL));
      *(_OWORD *)&v38[1] = v62;
      sub_1800F8864((__int64)v63, &v38[1]);
      if ( !v20 )
      {
        v67 = 1;
        sub_18001D8E4((_QWORD *)v6, &v44, 1u);
        ...
        if ( *((_QWORD *)&v62 + 1) )
          _InterlockedIncrement((volatile signed __int32 *)(*((_QWORD *)&v62 + 1) + 8LL));
        v39 = v62;
        sub_1800F87AC((__int64)v63, &v39);
        HIBYTE(v80) = 0;
        sub_18001D8E4((_QWORD *)v6, &v46, 1u);
        ...
        if ( *((_QWORD *)&v62 + 1) )
          _InterlockedIncrement((volatile signed __int32 *)(*((_QWORD *)&v62 + 1) + 8LL));
        v40 = v62;
        sub_1800F8750((__int64)v63, &v40);
        v67 = 2;
        HIBYTE(v80) = 0;
        sub_18001D8E4((_QWORD *)v6, &v48, 1u);
      ...
      if ( v21 )
      {
        ...
        v54 = 0LL;
        v55 = 0LL;
        sub_1800F9530((__int64)v63, (__int64)&v51);
      }
      else
      {
        v26 = *(_QWORD *)(a1 + 120);
        ...
        v59 = 0LL;
        v60 = 0LL;
        sub_1800F9530((__int64)v63, (__int64)&v56);
        v50[3] = 15LL;
        v50[2] = 0LL;
        LOBYTE(v50[0]) = 0;
        sub_1800F8AAC(v63, 5, v50);
      }
      v27 = *(_QWORD *)(a1 + 136);
      if ( *(_QWORD *)(a1 + 144) == v27 )
      {
        sub_18000FC30((char **)(a1 + 128), (char *)v27, &v63);
      }
      else
      {
        *(_QWORD *)v27 = 0LL;
