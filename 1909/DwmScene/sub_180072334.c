/*
 * XREFs of sub_180072334 @ 0x180072334
 * Callers:
...
void __fastcall sub_180072334(__int64 *a1, char *a2, char *a3, char *a4)
{
  ...
  if ( v7 <= (v9 - (__int64)v10) >> 4 )
  {
    ...
    else
    {
      ...
      a1[1] = (__int64)v29;
      LOBYTE(a4) = 0;
      sub_180072A8C(a2, &v10[-v28], v10, a4);
      v30 = a2;
      v31 = &a2[v28];
      if ( a2 != v31 )
      {
  ...
  else
  {
    ...
    v16 = sub_18000F60C((__int64)a1, v15);
    v17 = 2 * (v8 + v7);
    v18 = &v16[v17];
    if ( a3 != v46 )
    {
    ...
    sub_18000F370(a1, (__int64)v16, v45, v15);
  }
}
