/*
 * XREFs of sub_180104CCC @ 0x180104CCC
 * Callers:
...
__int64 __fastcall sub_180104CCC(__int64 a1, __int64 a2, __int64 a3)
{
  __int64 v4; // rsi
      ...
      if ( v33 != 1 || ((v13 = *v12, v13 != 13) ? (v14 = v13 < 0xDu ? -1 : 1) : (v14 = 0), v14) )
      {
        ...
        if ( *v15 != 35 )
        {
          if ( v5 )
          {
            ...
            sub_1800B7C58((__int64)v35, (__int64)v32, 1, 1);
