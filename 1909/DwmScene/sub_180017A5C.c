/*
 * XREFs of sub_180017A5C @ 0x180017A5C
 * Callers:
...
__int64 __fastcall sub_180017A5C(__int64 a1)
{
  __int64 v2; // rcx
  __int64 result; // rax
  __int64 v4; // rcx
  ...
  *(_QWORD *)a1 = &off_180144840;
  *(_QWORD *)(a1 + 16) = off_1801448C0;
  v2 = *(_QWORD *)(a1 + 136);
  if ( v2 )
  {
    *(_QWORD *)(a1 + 136) = 0LL;
  ...
  *(_QWORD *)(a1 + 120) = *(_QWORD *)(a1 + 112);
  result = qword_180269E48;
  if ( a1 == qword_180269E48 )
    result = 0LL;
  qword_180269E48 = result;
  v4 = *(_QWORD *)(a1 + 136);
  if ( v4 )
  {
    *(_QWORD *)(a1 + 136) = 0LL;
