...
__int64 __fastcall sub_18007CB28(__int64 a1)
{
  ...
  LOWORD(Src[0]) = 0;
  sub_180026278((char *)Src, L"CPU", 3uLL);
  if ( (void **)(a1 + 1392) != Src )
  {
    v9 = Src;
    if ( si128.m128i_i64[1] >= 8uLL )
      v9 = (void **)Src[0];
    sub_180026278((char *)(a1 + 1392), v9, si128.m128i_u64[0]);
  }
