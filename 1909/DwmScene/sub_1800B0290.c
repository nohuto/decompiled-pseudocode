/*
 * XREFs of sub_1800B0290 @ 0x1800B0290
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall sub_1800B0290(__int64 a1, __int64 a2, __int64 a3, __int64 a4)
{
  int v4; // edi
  __int64 result; // rax
  int *v6; // rax
  ...
  if ( (_DWORD)result == 1114112 && *(_QWORD *)a4 != a1 )
  {
    ...
    do
    {
      v9 = *(_DWORD *)((char *)&unk_18025D7D0 + v8 + 8);
      v15 = *(_QWORD *)((char *)&unk_18025D7D0 + v8);
      v10 = HIDWORD(v15);
    ...
    do
    {
      ...
      v15 = *v11;
      LODWORD(v16) = v12;
      v13 = (_DWORD *)sub_1800B1694(v4, (unsigned int)&v17, (unsigned int)&v15, 2, 1);
      *(_DWORD *)v11 = *v13;
      v14 = v13[1];
      *((_DWORD *)v11 + 2) = v13[2];
      *((_DWORD *)v11 + 1) = v14;
    ...
    while ( v11 != &v26 );
    v19 = xmmword_1801E4880;
    LODWORD(v16) = v25;
    v20 = xmmword_1801E4880;
    v18 = v23;
    v15 = v24;
    v17 = v22;
    sub_1800F0FE4(v4, (unsigned int)&v17, (unsigned int)&v15, (unsigned int)&v20, (__int64)&v19, 0x40000000);
  }
  return result;
}
