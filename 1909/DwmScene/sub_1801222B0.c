/*
 * XREFs of sub_1801222B0 @ 0x1801222B0
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall sub_1801222B0(__int64 a1, __int64 *a2)
{
  ...
  sub_180121A58((__int64 **)(a1 + 240), (__int64)v11, &v12);
  sub_1800AC384((__int64)(v11[0] + 5), (__int64)a2);
  v6 = v12;
  v7 = Mtx_unlock(v4);
  if ( v7 )
