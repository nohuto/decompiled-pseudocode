/*
 * XREFs of sub_180108A44 @ 0x180108A44
 * Callers:
 *     sub_180109218 @ 0x180109218 (sub_180109218.c)
 *     sub_18010A230 @ 0x18010A230 (sub_18010A230.c)
 * Callees:
 *     sub_180108658 @ 0x180108658 (sub_180108658.c)
 *     memcmp @ 0x180125BB8 (memcmp.c)
 */

__int64 __fastcall sub_180108A44(_QWORD *a1, __int64 a2, char a3, size_t *a4, _QWORD *a5)
{
  _QWORD *v8; // r13
  __int64 *v9; // rbx
  ...
  try
  {
    *(_QWORD *)a2 = *sub_180108658(a1, &v25, v10, v8, (int)a4, v25);
    *(_BYTE *)(a2 + 8) = 1;
    result = a2;
  }
  catch ( ... )
  {
    sub_18010A48C(v27, v26);
    throw;
  }
  return result;
}
