/*
 * XREFs of ?StartKernelRedirection@CDwmAppHost@@AEAAJXZ @ 0x140001E20
 * Callers:
...
__int64 __fastcall CDwmAppHost::StartKernelRedirection(CDwmAppHost *this, __int64 a2, void *a3, __int64 a4)
{
  ...
  v4 = 4LL;
  if ( dword_140010A4C > *(_DWORD *)(*(_QWORD *)NtCurrentTeb()->ThreadLocalStoragePointer + 4LL) )
  {
    Init_thread_header(&dword_140010A4C, 4LL, a3, a4);
    if ( dword_140010A4C == -1 )
    {
      dword_140010984 = -2147024865;
      Init_thread_footer(&dword_140010A4C);
    }
  }
  if ( *(&g_dwmAppHost + 1) )
  {
    ...
    else
    {
      ...
      if ( (unsigned int)DwmKernelStartup() )
      {
        ...
        if ( v6 < 0 )
          MilInstrumentationCheckHR_MaybeFailFast(0x14u, &dword_140010984, 1u, v6, 0x132u);
        goto LABEL_11;
      }
    ...
    MilInstrumentationCheckHR_MaybeFailFast(0x14u, &dword_140010984, 1u, v6, v9);
LABEL_11:
