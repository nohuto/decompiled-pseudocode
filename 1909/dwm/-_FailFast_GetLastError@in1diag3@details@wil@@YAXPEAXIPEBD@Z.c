/*
 * XREFs of ?_FailFast_GetLastError@in1diag3@details@wil@@YAXPEAXIPEBD@Z @ 0x1400083A4
 * Callers:
        ...
        const char *a4)
{
  ...
  wil::details::ReportFailure_GetLastError((__int64)this, a2, a3, (__int64)a4, v4, retaddr);
}
