/*
 * XREFs of Controller_DriverInstalledDueToCompatibleIdMatch @ 0x1C0060270
 * Callers:
...
char __fastcall Controller_DriverInstalledDueToCompatibleIdMatch(_QWORD *a1)
{
  ...
  else if ( WPP_RECORDER_INITIALIZED != (_UNKNOWN *)&WPP_RECORDER_INITIALIZED )
  {
    ...
    WPP_RECORDER_SF_d(a1[9], 3u, 4u, 0x8Fu, (__int64)&Context.Logger + 4, Data);
  }
  return v2;
}
