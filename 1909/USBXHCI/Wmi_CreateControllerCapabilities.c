/*
 * XREFs of Wmi_CreateControllerCapabilities @ 0x1C003F5FC
 * Callers:
    ...
    *((_DWORD *)a1 + 2) = ExtendedCapabilityTotalSize + 184;
    ...
    if ( PoolWithTag )
    {
      ...
      *(_DWORD *)(a1[2] + 12) = *(unsigned __int8 *)(*a1 + 256);
      v5 = *a1;
      v6 = a1[2];
      *(_DWORD *)(v6 + 16) = *(_DWORD *)(*a1 + 304);
      *(_BYTE *)(v6 + 20) = *(_BYTE *)(v5 + 308);
      v7 = *a1;
      v8 = a1[2];
      *(_DWORD *)(v8 + 21) = *(_DWORD *)(*a1 + 309);
      *(_BYTE *)(v8 + 25) = *(_BYTE *)(v7 + 313);
      v9 = *a1;
      v10 = a1[2];
      *(_DWORD *)(v10 + 26) = *(_DWORD *)(*a1 + 314);
      *(_BYTE *)(v10 + 30) = *(_BYTE *)(v9 + 318);
