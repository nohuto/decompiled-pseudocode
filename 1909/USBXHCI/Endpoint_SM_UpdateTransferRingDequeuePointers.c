/*
 * XREFs of Endpoint_SM_UpdateTransferRingDequeuePointers @ 0x1C001B05C
 * Callers:
 *     ESM_UpdatingTransferRingDequeuePointers @ 0x1C0046730 (ESM_UpdatingTransferRingDequeuePointers.c)
 * Callees:
