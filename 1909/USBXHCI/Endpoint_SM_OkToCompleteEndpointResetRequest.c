/*
 * XREFs of Endpoint_SM_OkToCompleteEndpointResetRequest @ 0x1C001AAA8
 * Callers:
 ...
 *     ESM_WaitingForControllerResetCompletion @ 0x1C0046750 (ESM_WaitingForControllerResetCompletion.c)
 * Callees:
