/*
 * XREFs of Crashdump_UsbDevice_Configure @ 0x1C004388C
 * Callers:
 *     Crashdump_UsbDevice_ReConfigureOnControllerReset @ 0x1C0044444 (Crashdump_UsbDevice_ReConfigureOnControllerReset.c)
 *     Crashdump_UsbDevice_ReConfigureOnPortReset @ 0x1C0044598 (Crashdump_UsbDevice_ReConfigureOnPortReset.c)
 * Callees:
...
__int64 __fastcall Crashdump_UsbDevice_Configure(__int64 a1, int a2)
{
  ...
  if ( v4 >= 0 )
  {
    ...
    {
      v7 = *(_QWORD *)(a1 + 120);
      WORD1(v16) = *(unsigned __int8 *)(a1 + 369);
      LOWORD(v16) = 2304;
      HIDWORD(v16) = 0;
      ...
      if ( v8 >= 0 )
      {
        ...
        if ( v9
          && (v10 = *(_QWORD *)(a1 + 120),
              WORD1(v16) = v9,
              WORD2(v16) = *(unsigned __int8 *)(a1 + 370),
              LOWORD(v16) = 2817,
        ...
        else if ( *(_BYTE *)(a1 + 368) )
        {
          ...
          {
            v12 = *(_QWORD *)(a1 + 120);
            *(_DWORD *)((char *)&v16 + 2) = (unsigned __int16)(*(_WORD *)(a1 + 372) - 1);
            LOWORD(v16) = 3104;
