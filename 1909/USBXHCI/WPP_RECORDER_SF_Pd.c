/*
 * XREFs of WPP_RECORDER_SF_Pd @ 0x1C000381C
 * Callers:
...
__int64 WPP_RECORDER_SF_Pd(__int64 a1, __int64 a2, __int64 a3, __int64 a4, int a5, int a6, ...)
{
  ...
  if ( (HIDWORD(WPP_GLOBAL_Control->Timer) & 0x10) != 0 && BYTE1(WPP_GLOBAL_Control->Timer) >= 3u )
    ((void (__fastcall *)(_DEVICE_OBJECT *, __int64, void *, __int64, _QWORD *, __int64, char *, __int64, _QWORD))pfnWppTraceMessage)(
      ...
      0LL);
  LOWORD(v8) = 13;
  return WppAutoLogTrace(a1, 3LL, 5LL, &WPP_3606c96a59cd3573e5bf0fe73b80610c_Traceguids, v8, v9);
}
