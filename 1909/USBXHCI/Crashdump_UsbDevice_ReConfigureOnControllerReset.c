/*
 * XREFs of Crashdump_UsbDevice_ReConfigureOnControllerReset @ 0x1C0044444
 * Callers:
 *     Crashdump_InitializeWithControllerReset @ 0x1C00404BC (Crashdump_InitializeWithControllerReset.c)
 * Callees:
