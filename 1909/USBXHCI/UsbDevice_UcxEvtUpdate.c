/*
 * XREFs of UsbDevice_UcxEvtUpdate @ 0x1C003CF00
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall UsbDevice_UcxEvtUpdate(__int64 a1, __int64 a2)
{
  ...
  if ( (*(_DWORD *)(v4 + 24) & 4) != 0 )
  {
    InputContextBufferVA = (void *)XilCoreUsbDevice_GetInputContextBufferVA(v5 + (*(_BYTE *)(v5 + 657) != 0
                                                                                ? 616LL
                                                                                : 608LL));
    memset(InputContextBufferVA, 0, v11);
    v12 = XilCoreUsbDevice_GetInputContextBufferVA(v6 + (*(_BYTE *)(v6 + 657) != 0 ? 616LL : 608LL));
    v13 = *(_DWORD *)(v9 + 100) & 4;
    v14 = v12;
    *(_DWORD *)(v12 + 4) |= 1u;
    ...
    *(_QWORD *)(v6 + 480) = XilCoreUsbDevice_GetInputContextBufferLA(v6 + (*(_BYTE *)(v6 + 657) != 0 ? 616LL : 608LL));
    *(_QWORD *)(v6 + 528) = XilCoreUsbDevice_GetInputContextBufferVA(v6 + (*(_BYTE *)(v6 + 657) != 0 ? 616LL : 608LL));
    InputContextBufferSize = XilCoreUsbDevice_GetInputContextBufferSize(v6 + (*(_BYTE *)(v6 + 657) != 0 ? 616LL : 608LL));
    v17 = *(_QWORD *)(v6 + 8);
