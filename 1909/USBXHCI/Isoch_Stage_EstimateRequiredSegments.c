/*
 * XREFs of Isoch_Stage_EstimateRequiredSegments @ 0x1C0030BE8
 * Callers:
...
__int64 __fastcall Isoch_Stage_EstimateRequiredSegments(__int64 a1, __int64 a2)
{
  ...
  if ( (*(_QWORD *)(v5 + 336) & 0x800000000000LL) == 0
  ...
  if ( (v11 < 0x39u || v11 > 0x3Au) && *(_DWORD *)(*(_QWORD *)(a2 + 64) + 40LL) < *(_DWORD *)(a2 + 52) )
    v10 += 2;
  v12 = *(_DWORD *)(a1 + 196);
