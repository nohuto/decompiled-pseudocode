/*
 * XREFs of McTemplateK0pppxsb16b16 @ 0x1C0002A34
 * Callers:
...
ULONG McTemplateK0pppxsb16b16(__int64 a1, __int64 a2, __int64 a3, ...)
{
  ...
  struct _MCGEN_TRACE_CONTEXT *v16; // [rsp+80h] [rbp-19h]
  ...
  struct _MCGEN_TRACE_CONTEXT *v31; // [rsp+108h] [rbp+6Fh]
  ...
  v31 = va_arg(va4, struct _MCGEN_TRACE_CONTEXT *);
  ...
  if ( v31 )
  {
    ...
    do
      ++v4;
    while ( *((_BYTE *)&v31->RegistrationHandle + v4) );
    v5 = v4 + 1;
  }
  else
  {
  ...
  v20 = 16LL;
  v22 = 16LL;
  return McGenEventWrite(v3, &USBXHCI_ETW_EVENT_CONTROLLER_ERROR, 0LL, 8u, &EventData);
}
