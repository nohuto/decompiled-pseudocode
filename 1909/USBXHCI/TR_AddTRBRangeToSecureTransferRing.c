/*
 * XREFs of TR_AddTRBRangeToSecureTransferRing @ 0x1C00281D8
 * Callers:
...
LABEL_31:
    ...
    *(_DWORD *)(v11 + 84) = v12;
    ...
    if ( v25 )
      KfRaiseIrql(2u);
    if ( v29 >= 0 && v35 < 0 && WPP_RECORDER_INITIALIZED != (_UNKNOWN *)&WPP_RECORDER_INITIALIZED )
    {
      v30 = *(_QWORD *)(a1 + 56);
      v34 = v35;
