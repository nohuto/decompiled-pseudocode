/*
 * XREFs of Controller_TelemetryAddControllerData @ 0x1C0062970
 * Callers:
 ...
 *     XilDeviceSlot_GetNumberOfDeviceSlots @ 0x1C00161C4 (XilDeviceSlot_GetNumberOfDeviceSlots.c)
...
char __fastcall Controller_TelemetryAddControllerData(_QWORD *a1, __int64 *a2)
{
  ...
  v20[1] = 0LL;
  if ( !a1
    || (LODWORD(UsbDeviceHandleArray) = TelemetryData_InsertTriageDataBlock(a2, a1, 0x350u),
