/*
 * XREFs of McTemplateK0ptqqp @ 0x1C00143E0
 * Callers:
...
ULONG McTemplateK0ptqqp(struct _MCGEN_TRACE_CONTEXT *a1, __int64 a2, __int64 a3, ...)
{
  ...
  va_copy(v13, va4);
  v14 = 8LL;
  return McGenEventWrite(a1, &USBXHCI_ETW_EVENT_START_TRACKING_FOR_TIME_SYNC, 0LL, 6u, &EventData);
}
