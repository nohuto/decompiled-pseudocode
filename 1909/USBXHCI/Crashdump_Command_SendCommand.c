/*
 * XREFs of Crashdump_Command_SendCommand @ 0x1C00427CC
 * Callers:
 *     Crashdump_Command_TestCommandRingOperation @ 0x1C0042B44 (Crashdump_Command_TestCommandRingOperation.c)
 *     Crashdump_Endpoint_SetDequeuePointer @ 0x1C00434A0 (Crashdump_Endpoint_SetDequeuePointer.c)
 *     Crashdump_Endpoint_StopEndpoint @ 0x1C004356C (Crashdump_Endpoint_StopEndpoint.c)
 ...
 *     Crashdump_UsbDevice_SendEnableSlotCommand @ 0x1C0044B08 (Crashdump_UsbDevice_SendEnableSlotCommand.c)
 *     Crashdump_UsbDevice_SendResetDeviceCommand @ 0x1C0044BC4 (Crashdump_UsbDevice_SendResetDeviceCommand.c)
 * Callees:
