/*
 * XREFs of XilDeviceSlot_CreateSecureObject @ 0x1C0015F44
 * Callers:
...
__int64 __fastcall XilDeviceSlot_CreateSecureObject(_QWORD *a1)
{
  ...
  if ( v4 >= 0 )
  {
    ...
    else
    {
      ...
      {
        v7 = v8;
        WPP_RECORDER_SF_d(v2[9], 2u, 0xAu, 0xBu, (__int64)&WPP_3f8b46f1ac0c359a7a67cbd4c4174885_Traceguids, v7);
      }
      Debug_FreAssertMsg(
  ...
  {
    v6 = v4;
    WPP_RECORDER_SF_d(v2[9], 2u, 0xAu, 0xAu, (__int64)&WPP_3f8b46f1ac0c359a7a67cbd4c4174885_Traceguids, v6);
  }
