/*
 * XREFs of Crashdump_InitializeWithoutControllerReset @ 0x1C00406E0
 * Callers:
 *     Crashdump_Initialize @ 0x1C003FF60 (Crashdump_Initialize.c)
 * Callees:
 *     Crashdump_Register_PrepareForHibernate @ 0x1C0041684 (Crashdump_Register_PrepareForHibernate.c)
 *     Crashdump_EventRing_PrepareForHibernate @ 0x1C0042550 (Crashdump_EventRing_PrepareForHibernate.c)
...
__int64 __fastcall Crashdump_InitializeWithoutControllerReset(char *Address)
{
  ...
  PoSetHiberRange(0LL, 0x10000u, *((PVOID *)Address + 77), 0x350uLL, 0x43434858u);
