/*
 * XREFs of ?LoadStringW@?$CStringT@GV?$StrTraitATL@GV?$ChTraitsCRT@G@ATL@@@ATL@@@ATL@@QEAAHPEAUHINSTANCE__@@I@Z @ 0x180015328
 * Callers:
 ...
 *     _o_wmemcpy_s_0 @ 0x1800350C0 (_o_wmemcpy_s_0.c)
 */
