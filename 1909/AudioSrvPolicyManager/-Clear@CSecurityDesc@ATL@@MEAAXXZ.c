/*
 * XREFs of ?Clear@CSecurityDesc@ATL@@MEAAXXZ @ 0x180031980
 * Callers:
 *     ??_GCSecurityDesc@ATL@@UEAAPEAXI@Z @ 0x180031450 (--_GCSecurityDesc@ATL@@UEAAPEAXI@Z.c)
 *     ??1CSecurityDesc@ATL@@UEAA@XZ @ 0x180031494 (--1CSecurityDesc@ATL@@UEAA@XZ.c)
