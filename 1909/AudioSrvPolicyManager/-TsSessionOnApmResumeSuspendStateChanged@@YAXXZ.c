/*
 * XREFs of ?TsSessionOnApmResumeSuspendStateChanged@@YAXXZ @ 0x180026DB8
 * Callers:
 ...
 *     ?TsSessionGetPrimaryConsoleAudioSession@@YAJPEAPEAVTSSession@@@Z @ 0x180025154 (-TsSessionGetPrimaryConsoleAudioSession@@YAJPEAPEAVTSSession@@@Z.c)
