/*
 * XREFs of ?OnNotify@_CEndpointVolumeNotificationDelegator@CEndpointVolumeState@@UEAAJPEAUAUDIO_VOLUME_NOTIFICATION_DATA@@@Z @ 0x18002B7C0
 * Callers:
 *     <none>
 * Callees:
 *     _o_log10_0 @ 0x18003509C (_o_log10_0.c)
 */
