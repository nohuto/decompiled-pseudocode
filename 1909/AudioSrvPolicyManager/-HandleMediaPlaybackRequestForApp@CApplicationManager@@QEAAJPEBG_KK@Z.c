/*
 * XREFs of ?HandleMediaPlaybackRequestForApp@CApplicationManager@@QEAAJPEBG_KK@Z @ 0x18001B7F4
 * Callers:
  ...
  else
  {
    ...
    if ( v14 )
    {
      ...
      if ( active < 0 )
      {
        ...
        {
          WPP_SF_d(*((_QWORD *)WPP_GLOBAL_Control + 2), 0x24u, &WPP_48f5b41a97d23634bb345404f49671c8_Traceguids, active);
        }
...
LABEL_26:
      ...
      {
        WPP_SF_S(*((_QWORD *)WPP_GLOBAL_Control + 2), 0x23u, &WPP_48f5b41a97d23634bb345404f49671c8_Traceguids, a2);
      }
    }
    v13 = v7;
  }
