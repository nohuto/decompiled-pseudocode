/*
 * XREFs of ??1?$CAutoPtrArray@VCAccessAce@CDacl@ATL@@@ATL@@QEAA@XZ @ 0x1800303AC
 * Callers:
 *     _DetermineLowRightsKeySecurityDescriptor_::_1_::dtor$5 @ 0x180037BDD (_DetermineLowRightsKeySecurityDescriptor_--_1_--dtor$5.c)
 * Callees:
