/*
 * XREFs of ?ReadBackgroundAudioTaskCapability@CApplicationManager@@QEAAJPEAXPEAH1@Z @ 0x18001AF50
 * Callers:
        ...
        int *a4)
{
  ...
  *a4 = 0;
  ...
  if ( v7 >= 0 )
  {
    ...
    {
      WPP_SF_d(*((_QWORD *)WPP_GLOBAL_Control + 2), 0x1Au, &WPP_48f5b41a97d23634bb345404f49671c8_Traceguids, v8);
    }
  }
  CoUninitialize();
  if ( v7 < 0 )
...
LABEL_13:
    ...
    {
      WPP_SF_d(*((_QWORD *)WPP_GLOBAL_Control + 2), 0x1Bu, &WPP_48f5b41a97d23634bb345404f49671c8_Traceguids, v7);
    }
