/*
 * XREFs of dllmain_crt_process_attach @ 0x180033F78
 * Callers:
 ...
 *     __scrt_is_nonwritable_in_current_image @ 0x18003484C (__scrt_is_nonwritable_in_current_image.c)
 *     __scrt_release_startup_lock @ 0x1800348EC (__scrt_release_startup_lock.c)
 *     ?__scrt_initialize_type_info@@YAXXZ @ 0x180034B58 (-__scrt_initialize_type_info@@YAXXZ.c)
 *     __scrt_initialize_default_local_stdio_options @ 0x180034B80 (__scrt_initialize_default_local_stdio_options.c)
 *     __scrt_get_dyn_tls_init_callback @ 0x180034BA4 (__scrt_get_dyn_tls_init_callback.c)
 *     __scrt_fastfail @ 0x180034BC4 (__scrt_fastfail.c)
 *     _RTC_Initialize @ 0x180034D18 (_RTC_Initialize.c)
 *     _initterm_0 @ 0x180034F76 (_initterm_0.c)
 *     _initterm_e_0 @ 0x180034F82 (_initterm_e_0.c)
