/*
 * XREFs of __scrt_dllmain_after_initialize_c @ 0x1800345BC
 * Callers:
 *     dllmain_crt_process_attach @ 0x180033F78 (dllmain_crt_process_attach.c)
 * Callees:
 *     ?AddRef@CStreamPolicyVolumeClient@@UEAAKXZ @ 0x1800080B0 (-AddRef@CStreamPolicyVolumeClient@@UEAAKXZ.c)
 *     __isa_available_init @ 0x180034DA0 (__isa_available_init.c)
 *     __scrt_is_ucrt_dll_in_use @ 0x180034F60 (__scrt_is_ucrt_dll_in_use.c)
 *     _o__configure_narrow_argv_0 @ 0x180035006 (_o__configure_narrow_argv_0.c)
 *     _initialize_narrow_environment @ 0x180035036 (_initialize_narrow_environment.c)
 */
