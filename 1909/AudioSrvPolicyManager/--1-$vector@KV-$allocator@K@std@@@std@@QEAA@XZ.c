/*
 * XREFs of ??1?$vector@KV?$allocator@K@std@@@std@@QEAA@XZ @ 0x180017C48
 * Callers:
 *     _CApplication::RegisterProcessWithApplicationSpecificEndpointInfo_::_1_::dtor$7 @ 0x1800365B0 (_CApplication--RegisterProcessWithApplicationSpecificEndpointInfo_--_1_--dtor$7.c)
 *     _CProcess::CProcess_::_1_::dtor$3 @ 0x180036689 (_CProcess--CProcess_--_1_--dtor$3.c)
 * Callees:
