/*
 * XREFs of ?OnAutoDuckWorkItem@CDuckingManager@@AEAAXPEAVCDuckWorkItem@@@Z @ 0x18000AED4
 * Callers:
...
void __fastcall CDuckingManager::OnAutoDuckWorkItem(CDuckingManager *this, struct CDuckWorkItem *a2)
{
  ...
  const unsigned __int16 *v37; // [rsp+98h] [rbp+7h]
  ...
  if ( !(*(unsigned int (__fastcall **)(_QWORD))(**(_QWORD **)a2 + 48LL))(*(_QWORD *)a2) && !*((_DWORD *)a2 + 4) )
  {
    ...
    if ( *(_DWORD *)v5 > 4u )
    {
      ...
      v38 = 2 * v10 + 2;
      v39 = 0;
      TlgWrite(v5, &unk_180042D21, v7, v8, 3u, &pData);
    }
