/*
 * XREFs of ?deallocate@?$allocator@U?$_List_node@V?$com_ptr_t@VCPBMStreamClassVolumeGainStage@@Uerr_returncode_policy@wil@@@wil@@PEAX@std@@@std@@QEAAXQEAU?$_List_node@V?$com_ptr_t@VCPBMStreamClassVolumeGainStage@@Uerr_returncode_policy@wil@@@wil@@PEAX@2@_K@Z @ 0x180027DE8
 * Callers:
 *     _std::_List_alloc_std::_List_base_types_wil::com_ptr_t_CPBMStreamClassVolumeGainStage_wil::err_returncode_policy__std::allocator_wil::com_ptr_t_CPBMStreamClassVolumeGainStage_wil::err_returncode_policy_______::_Buynode0_::_1_::catch$0 @ 0x18003735E (_std--_List_alloc_std--_List_base_types_wil--com_ptr_t_CPBMStreamClassVolumeGainStage_wil--err_r.c)
 *     _std::_List_buy_wil::com_ptr_t_CPBMStreamClassVolumeGainStage_wil::err_returncode_policy__std::allocator_wil::com_ptr_t_CPBMStreamClassVolumeGainStage_wil::err_returncode_policy_____::_Buynode_wil::com_ptr_t_CPBMStreamClassVolumeGainStage_wil::err_returncode_policy__const_&__::_1_::catch$0 @ 0x180037505 (_std--_List_buy_wil--com_ptr_t_CPBMStreamClassVolumeGainStage_wil--err_returncode_policy__std--a.c)
 * Callees:
 *     <none>
 */
