/*
 * XREFs of ?TsSessionIdIsAudioInStandbyAllowed@@YAHK@Z @ 0x180026228
 * Callers:
 *     ?GetSessionDisplayPolicyVolume@CProcess@@UEAAMXZ @ 0x180013FC0 (-GetSessionDisplayPolicyVolume@CProcess@@UEAAMXZ.c)
 * Callees:
...
__int64 __fastcall TsSessionIdIsAudioInStandbyAllowed(DWORD a1)
{
  ...
  if ( !(unsigned int)TsSessionFromSessionId(a1, 0, 0LL, v8) )
  {
    ...
    if ( *(_DWORD *)v5 > 4u )
    {
      ...
      v21 = 4LL;
      TlgWrite(v5, &unk_180042EC3, (LPCGUID)v5, v6, 8u, &pData);
    }
  }
  if ( v3 )
