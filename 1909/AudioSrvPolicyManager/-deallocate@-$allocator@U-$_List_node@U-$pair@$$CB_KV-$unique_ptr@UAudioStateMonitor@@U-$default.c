/*
 * XREFs of ?deallocate@?$allocator@U?$_List_node@U?$pair@$$CB_KV?$unique_ptr@UAudioStateMonitor@@U?$default_delete@UAudioStateMonitor@@@wistd@@@wistd@@@std@@PEAX@std@@@std@@QEAAXQEAU?$_List_node@U?$pair@$$CB_KV?$unique_ptr@UAudioStateMonitor@@U?$default_delete@UAudioStateMonitor@@@wistd@@@wistd@@@std@@PEAX@2@_K@Z @ 0x180017260
 * Callers:
 *     _std::_List_alloc_std::_List_base_types_std::pair_unsigned___int64_const__wistd::unique_ptr_AudioStateMonitor_wistd::default_delete_AudioStateMonitor______std::allocator_std::pair_unsigned___int64_const__wistd::unique_ptr_AudioStateMonitor_wistd::default_delete_AudioStateMonitor___________::_Buynode0_::_1_::catch$0 @ 0x180036C2E (_std--_List_alloc_std--_List_base_types_std--pair_unsigned___int64_const__wistd--unique_ptr_Audi.c)
 *     _std::_List_buy_std::pair_unsigned___int64_const__wistd::unique_ptr_AudioStateMonitor_wistd::default_delete_AudioStateMonitor______std::allocator_std::pair_unsigned___int64_const__wistd::unique_ptr_AudioStateMonitor_wistd::default_delete_AudioStateMonitor_________::_Buynode_unsigned___int64_&_AudioStateMonitor____::_1_::catch$1 @ 0x180037750 (_std--_List_buy_std--pair_unsigned___int64_const__wistd--unique_ptr_AudioStateMonitor_wistd--def.c)
 * Callees:
 *     <none>
 */
