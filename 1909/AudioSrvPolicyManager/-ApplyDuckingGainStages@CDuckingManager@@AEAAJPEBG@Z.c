/*
 * XREFs of ?ApplyDuckingGainStages@CDuckingManager@@AEAAJPEBG@Z @ 0x18000B4C0
 * Callers:
...
__int64 __fastcall CDuckingManager::ApplyDuckingGainStages(CDuckingManager *this, const unsigned __int16 *a2)
{
  ...
  const unsigned __int16 *v37; // [rsp+A0h] [rbp+Fh]
...
LABEL_45:
    ...
    while ( 1 )
    {
      ...
      if ( *(_DWORD *)v6 > 4u )
      {
        ...
        v38 = 2 * v11 + 2;
        v39 = 0;
        TlgWrite(v6, &unk_180042CED, v8, v9, 3u, &pData);
      }
      v29 = 0LL;
