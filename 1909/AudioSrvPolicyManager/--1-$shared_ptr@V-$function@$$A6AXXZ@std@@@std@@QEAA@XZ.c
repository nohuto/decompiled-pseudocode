/*
 * XREFs of ??1?$shared_ptr@V?$function@$$A6AXXZ@std@@@std@@QEAA@XZ @ 0x180029878
 * Callers:
 *     _CGenericWorkItem::CGenericWorkItem_::_1_::dtor$2 @ 0x180037445 (_CGenericWorkItem--CGenericWorkItem_--_1_--dtor$2.c)
 * Callees:
