/*
 * XREFs of ?GetTsAudioProtocol@@YAIK@Z @ 0x18002A568
 * Callers:
 ...
 *     IsWinStationIsSessionRemoteablePresent @ 0x180035344 (IsWinStationIsSessionRemoteablePresent.c)
 *     IsWTSQuerySessionInformationWPresent @ 0x18003545C (IsWTSQuerySessionInformationWPresent.c)
 */
