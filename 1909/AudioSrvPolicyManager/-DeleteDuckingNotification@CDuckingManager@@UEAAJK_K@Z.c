/*
 * XREFs of ?DeleteDuckingNotification@CDuckingManager@@UEAAJK_K@Z @ 0x180009F10
 * Callers:
 *     <none>
 * Callees:
 *     WPP_SF_d @ 0x1800041E0 (WPP_SF_d.c)
 *     ?AudPolicyLogError@@YAXPEBDHJ@Z @ 0x180004B98 (-AudPolicyLogError@@YAXPEBDHJ@Z.c)
 *     WPP_SF_di @ 0x180008B5C (WPP_SF_di.c)
...
LABEL_13:
    ...
    {
      WPP_SF_d(*((_QWORD *)WPP_GLOBAL_Control + 2), 0x20u, &WPP_2f08ed43560a3dfd6165ccd158e2df11_Traceguids, v8);
    }
    AudPolicyLogError("CDuckingManager::DeleteDuckingNotification", 613, v8);
    goto LABEL_18;
  }
  v18 = v14;
  v19 = v15;
