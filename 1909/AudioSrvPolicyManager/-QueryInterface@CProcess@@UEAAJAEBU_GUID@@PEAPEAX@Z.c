/*
 * XREFs of ?QueryInterface@CProcess@@UEAAJAEBU_GUID@@PEAPEAX@Z @ 0x180011D70
 * Callers:
 ...
 *     ?QueryInterface@CProcess@@WBA@EAAJAEBU_GUID@@PEAPEAX@Z @ 0x180016F50 (-QueryInterface@CProcess@@WBA@EAAJAEBU_GUID@@PEAPEAX@Z.c)
 *     ?QueryInterface@CProcess@@WBI@EAAJAEBU_GUID@@PEAPEAX@Z @ 0x180016F60 (-QueryInterface@CProcess@@WBI@EAAJAEBU_GUID@@PEAPEAX@Z.c)
 * Callees:
...
__int64 __fastcall CProcess::QueryInterface(CProcess *this, const struct _GUID *a2, void **a3)
{
  ...
  if ( *(_QWORD *)&a2->Data1 == *(_QWORD *)&GUID_a0da1994_c8cf_4956_b4eb_7882030bf9d5.Data1
    && *(_QWORD *)a2->Data4 == *(_QWORD *)GUID_a0da1994_c8cf_4956_b4eb_7882030bf9d5.Data4 )
  {
