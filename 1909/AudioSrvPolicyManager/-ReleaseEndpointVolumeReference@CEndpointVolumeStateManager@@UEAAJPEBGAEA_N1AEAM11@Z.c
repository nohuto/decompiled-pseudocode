/*
 * XREFs of ?ReleaseEndpointVolumeReference@CEndpointVolumeStateManager@@UEAAJPEBGAEA_N1AEAM11@Z @ 0x18002BBD0
 * Callers:
 *     <none>
 * Callees:
 ...
 *     ?Log_IfFailedMsg@in1diag3@details@wil@@YAJPEAXIPEBDJ1ZZ @ 0x18002B574 (-Log_IfFailedMsg@in1diag3@details@wil@@YAJPEAXIPEBDJ1ZZ.c)
        ...
        bool *a7)
{
  ...
  char v20[32]; // [rsp+38h] [rbp-B0h] BYREF
  char v21[32]; // [rsp+58h] [rbp-90h] BYREF
  char v22[32]; // [rsp+78h] [rbp-70h] BYREF
