/*
 * XREFs of ??1?$com_ptr_t@VCPBMStreamClassVolumeGainStage@@Uerr_returncode_policy@wil@@@wil@@QEAA@XZ @ 0x180027E80
 * Callers:
 *     _CStreamClassPolicyGains::UpdateStreamClassGainStage_::_1_::dtor$1 @ 0x1800374F3 (_CStreamClassPolicyGains--UpdateStreamClassGainStage_--_1_--dtor$1.c)
 * Callees:
