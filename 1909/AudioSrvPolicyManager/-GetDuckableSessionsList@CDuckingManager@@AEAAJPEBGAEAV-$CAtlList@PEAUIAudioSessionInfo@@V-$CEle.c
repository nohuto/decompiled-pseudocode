/*
 * XREFs of ?GetDuckableSessionsList@CDuckingManager@@AEAAJPEBGAEAV?$CAtlList@PEAUIAudioSessionInfo@@V?$CElementTraits@PEAUIAudioSessionInfo@@@ATL@@@ATL@@@Z @ 0x18000BB48
 * Callers:
      ...
      && !(*(unsigned int (__fastcall **)(__int64))(*(_QWORD *)v8 + 56LL))(v8) )
    {
      ...
      if ( !(unsigned int)_o__wcsicmp(v4, v9) )
      {
        ...
        catch ( ATL::CAtlException *v15 )
        {
          ...
          {
            WPP_SF_d(*((_QWORD *)WPP_GLOBAL_Control + 2), 0x36u, &WPP_2f08ed43560a3dfd6165ccd158e2df11_Traceguids, v21);
LABEL_18:
            v12 = (_UNKNOWN **)WPP_GLOBAL_Control;
          }
          if ( v6 < 0 )
          {
            if ( v12 != &WPP_GLOBAL_Control && (*((_DWORD *)v12 + 7) & 0x8000000) != 0 && *((_BYTE *)v12 + 25) >= 2u )
              WPP_SF_d((TRACEHANDLE)v12[2], 0x37u, &WPP_2f08ed43560a3dfd6165ccd158e2df11_Traceguids, v6);
            AudPolicyLogError("CDuckingManager::GetDuckableSessionsList", 1654, v6);
          }
          if ( v17 )
