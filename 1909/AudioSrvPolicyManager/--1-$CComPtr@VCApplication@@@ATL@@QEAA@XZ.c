/*
 * XREFs of ??1?$CComPtr@VCApplication@@@ATL@@QEAA@XZ @ 0x180005884
 * Callers:
 *     _CApplicationManager::SendBackgroundStreamStateChangedNotifiction_::_1_::dtor$1 @ 0x180035C39 (_CApplicationManager--SendBackgroundStreamStateChangedNotifiction_--_1_--dtor$1.c)
 * Callees:
