/*
 * XREFs of ?NotifyVirtualStreamStateChange@CWindowsPolicyManager@@UEAAJPEAUIAudioProcess@@PEBGKW4__MIDL___MIDL_itf_mmdeviceapi_0000_0000_0001@@W4_AudioStreamState@@3@Z @ 0x180006F70
 * Callers:
 *     <none>
 * Callees:
        ...
        int a7)
{
  ...
  if ( *(_DWORD *)v11 > 4u )
  {
    ...
    v18 = a7;
    v29 = 4LL;
    TlgWrite(v11, &unk_1800429C9, (LPCGUID)v11, 0LL, 6u, &pData);
  }
