/*
 * XREFs of ??_G?$CGenericApplicationManagerWorkItem@UModernStandbyStateChangedContext@@@@UEAAPEAXI@Z @ 0x18001E8D0
 * Callers:
 *     <none>
 * Callees:
...
_QWORD *__fastcall CGenericApplicationManagerWorkItem<ModernStandbyStateChangedContext>::`scalar deleting destructor'(
        _QWORD *a1,
        char a2)
{
  CApplicationManager *v4; // rdi

  *a1 = &CGenericApplicationManagerWorkItem<ModernStandbyStateChangedContext>::`vftable';
