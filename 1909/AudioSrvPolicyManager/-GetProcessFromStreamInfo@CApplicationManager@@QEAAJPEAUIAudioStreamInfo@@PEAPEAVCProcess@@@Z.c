/*
 * XREFs of ?GetProcessFromStreamInfo@CApplicationManager@@QEAAJPEAUIAudioStreamInfo@@PEAPEAVCProcess@@@Z @ 0x1800193A0
 * Callers:
        ...
        struct CProcess **a3)
{
  ...
  CApplicationManager *v10; // [rsp+40h] [rbp+8h] BYREF
