/*
 * XREFs of DxgkCompleteTopologyTransition @ 0x1C0140DA0
 * Callers:
 *     <none>
 * Callees:
 ...
 *     ?ToggleTopologyTransition@DXGGLOBAL@@QEAAEE@Z @ 0x1C00194E0 (-ToggleTopologyTransition@DXGGLOBAL@@QEAAEE@Z.c)
