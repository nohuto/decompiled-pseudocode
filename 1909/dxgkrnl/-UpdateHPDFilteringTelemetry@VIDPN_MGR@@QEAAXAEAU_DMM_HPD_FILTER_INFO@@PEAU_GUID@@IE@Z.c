/*
 * XREFs of ?UpdateHPDFilteringTelemetry@VIDPN_MGR@@QEAAXAEAU_DMM_HPD_FILTER_INFO@@PEAU_GUID@@IE@Z @ 0x1C015B6AC
 * Callers:
        ...
        unsigned __int8 a5)
{
  ...
  v10 = *(_QWORD *)(v5 + 16);
  TargetById = DMMVIDEOPRESENTTARGETSET::GetTargetById(*((DMMVIDEOPRESENTTARGETSET **)this + 10), (unsigned int)v6);
...
LABEL_19:
    ...
    if ( dword_1C00A1888 > 5u )
    {
      if ( TlgKeywordOn((TraceLoggingHProvider)&dword_1C00A1888, 0x400000000080uLL) )
      {
        ...
        v38 = (char)v26;
        v85 = 1LL;
        TlgWrite((TraceLoggingHProvider)&dword_1C00A1888, &unk_1C00746DF, v16, v26, 0x18u, &pData);
        v22 = *((_DWORD *)a2 + 10);
      }
    }
