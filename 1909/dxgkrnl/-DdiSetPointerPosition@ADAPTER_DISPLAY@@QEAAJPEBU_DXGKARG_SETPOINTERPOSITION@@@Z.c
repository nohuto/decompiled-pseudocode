/*
 * XREFs of ?DdiSetPointerPosition@ADAPTER_DISPLAY@@QEAAJPEBU_DXGKARG_SETPOINTERPOSITION@@@Z @ 0x1C00D551C
 * Callers:
        ...
        const GUID *a3)
{
  ...
  DXGETWPROFILER_BASE_PushProfilerEntry((__int64)&v30, 5019LL);
...
LABEL_16:
  ...
  v15 = (*(int (__fastcall **)(_QWORD, const struct _DXGKARG_SETPOINTERPOSITION *))(*((_QWORD *)this + 2) + 424LL))(
  ...
  v21[4] = v23;
  v21[5] = a2->Flags.Value & 1;
  v21[6] = a2->X;
  Y = a2->Y;
  v21[7] = Y;
  if ( (_DWORD)v15 )
  {
    v25 = WdLogNewEntry5_WdError(Y, v23, v22);
    *(_QWORD *)(v25 + 24) = v15;
