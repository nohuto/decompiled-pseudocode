/*
 * XREFs of ?_SetColorSpaceTransform@DXGMONITOR@@AEAAJKPEAX@Z @ 0x1C00CD548
 * Callers:
...
__int64 __fastcall DXGMONITOR::_SetColorSpaceTransform(DXGMONITOR *this, __int64 a2, int *a3)
{
  ...
  __int64 v38; // rcx
  __int64 v39; // r8
  enum _D3DDDI_GAMMARAMP_TYPE v40; // ecx
  __int64 v41; // rdx
  __int64 v42; // rcx
  __int64 v43; // r8
  int v44; // eax
...
LABEL_43:
  ...
  v31 = operator new[](0x30uLL, 0x4B677844u, PagedPool);
  v12 = v31;
  if ( v31 )
  {
    v31[20] = 0;
  ...
  LODWORD(v17) = DXGK_GAMMA_RAMP::Initialize((DXGK_GAMMA_RAMP *)v12, (enum _D3DDDI_GAMMARAMP_TYPE)v29, 0LL);
  if ( (int)v17 >= 0 )
  {
    v40 = a3[3];
    *(_QWORD *)&v60.Type = (unsigned int)v40;
    v60.DataSize = GetSizeFromGammaRampType(v40);
    v60.Data.pRgb256x3x16 = (D3DDDI_GAMMA_RAMP_RGB256x3x16 *)(a3 + 4);
    LODWORD(v17) = ColorSpaceTransformConvert(&v60, (struct _D3DKMDT_GAMMA_RAMP *)(v12 + 8));
    if ( (int)v17 >= 0 )
    {
