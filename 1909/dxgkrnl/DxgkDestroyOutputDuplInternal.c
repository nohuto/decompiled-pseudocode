/*
 * XREFs of DxgkDestroyOutputDuplInternal @ 0x1C0275C08
 * Callers:
 *     DxgkCreateOutputDupl @ 0x1C0275990 (DxgkCreateOutputDupl.c)
 *     DxgkDestroyOutputDupl @ 0x1C0275BF0 (DxgkDestroyOutputDupl.c)
 * Callees:
...
__int64 __fastcall DxgkDestroyOutputDuplInternal(__int64 a1, int a2, const GUID *a3)
{
  ULONG64 v4; // rbx
  __int64 v5; // rdx
  __int64 v6; // rcx
  ...
  DXGETWPROFILER_BASE_PushProfilerEntry((__int64)&v13, 2062LL);
  *(_QWORD *)v16 = 0LL;
  v17 = 0;
  if ( a2 )
  {
