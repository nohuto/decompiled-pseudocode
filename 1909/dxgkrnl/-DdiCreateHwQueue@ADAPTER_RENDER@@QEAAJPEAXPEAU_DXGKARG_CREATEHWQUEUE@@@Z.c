/*
 * XREFs of ?DdiCreateHwQueue@ADAPTER_RENDER@@QEAAJPEAXPEAU_DXGKARG_CREATEHWQUEUE@@@Z @ 0x1C01F895C
 * Callers:
 *     ?ADAPTER_RENDER_DdiCreateHwQueue@@YAJPEAVADAPTER_RENDER@@PEAXPEAU_DXGKARG_CREATEHWQUEUE@@@Z @ 0x1C003DEA0 (-ADAPTER_RENDER_DdiCreateHwQueue@@YAJPEAVADAPTER_RENDER@@PEAXPEAU_DXGKARG_CREATEHWQUEUE@@@Z.c)
...
__int64 __fastcall ADAPTER_RENDER::DdiCreateHwQueue(ADAPTER_RENDER *this, void *a2, const GUID *a3)
{
  ...
  __int64 v18; // rdx
  __int64 v19; // r8
  __int64 (__fastcall *v20)(void *, const GUID *); // rax
  int v21; // ebx
  __int64 v22; // rcx
  _QWORD *v23; // rax
  ...
  DXGETWPROFILER_BASE_PushProfilerEntry((__int64)&v31, 5110LL);
...
LABEL_16:
  ...
  v20 = *(__int64 (__fastcall **)(void *, const GUID *))(*((_QWORD *)this + 2) + 984LL);
  if ( v20 )
    v21 = v20(a2, a3);
  else
    v21 = -1073741822;
  ...
  {
    v23 = (_QWORD *)WdLogNewEntry5_WdCriticalError(v22, v18);
    v23[3] = 275LL;
    v23[4] = 16LL;
    v23[5] = this;
    v23[6] = CurrentIrql;
  ...
  {
    v25 = (_QWORD *)WdLogNewEntry5_WdCriticalError(v22, v18);
    v25[3] = 275LL;
    v25[4] = 38LL;
    v25[5] = *(int *)(v12 + 136);
    v25[6] = v17;
  ...
  {
    v26 = WdLogNewEntry5_WdError(v22, v18, v19);
    *(_QWORD *)(v26 + 24) = v21;
