/*
 * XREFs of ??1VIDPN_MGR@@UEAA@XZ @ 0x1C005373C
 * Callers:
 *     ??_GVIDPN_MGR@@UEAAPEAXI@Z @ 0x1C0054300 (--_GVIDPN_MGR@@UEAAPEAXI@Z.c)
 * Callees:
 ...
 *     ??1?$Queue@VDMMVIDPN@@@@UEAA@XZ @ 0x1C0053598 (--1-$Queue@VDMMVIDPN@@@@UEAA@XZ.c)
