/*
 * XREFs of ?ProcessActiveInstances@DXGTRACKEDWORKLOAD@@QEAAJPEAVDXGDEVICE@@PEAVCOREDEVICEACCESS@@_KPEA_K@Z @ 0x1C02978FC
 * Callers:
 ...
 *     ?Add@RollingStats@@QEAAXN@Z @ 0x1C00645A0 (-Add@RollingStats@@QEAAXN@Z.c)
 *     ?GetCurrentPowerLevel@TrackedWorkloadMonitor@@QEAAIXZ @ 0x1C006466C (-GetCurrentPowerLevel@TrackedWorkloadMonitor@@QEAAIXZ.c)
