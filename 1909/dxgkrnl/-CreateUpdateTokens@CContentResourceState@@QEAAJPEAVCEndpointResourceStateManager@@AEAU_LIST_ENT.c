/*
 * XREFs of ?CreateUpdateTokens@CContentResourceState@@QEAAJPEAVCEndpointResourceStateManager@@AEAU_LIST_ENTRY@@@Z @ 0x1C0064074
 * Callers:
 ...
 * Callees:
 *     ?FindPoolBufferIndex@CEndpointResourceStateManager@@QEAAI_K@Z @ 0x1C0062578 (-FindPoolBufferIndex@CEndpointResourceStateManager@@QEAAI_K@Z.c)
