/*
 * XREFs of ?TdrDeleteRecoveryContext@@YAXPEAU_TDR_RECOVERY_CONTEXT@@@Z @ 0x1C023E404
 * Callers:
 ...
 * Callees:
 *     ??_GCTDR_DUMP_BUFFER@@QEAAPEAXI@Z @ 0x1C023C9C4 (--_GCTDR_DUMP_BUFFER@@QEAAPEAXI@Z.c)
 */
