/*
 * XREFs of ?FlushScheduler@ADAPTER_RENDER@@QEAAJW4DXGADAPTER_FLUSHSCHEDULER_REASON@@IH@Z @ 0x1C00D2D88
 * Callers:
...
__int64 __fastcall ADAPTER_RENDER::FlushScheduler(__int64 a1, int a2, unsigned int a3, int a4)
{
  ...
  if ( *(_BYTE *)(v6 + 185) )
  {
    v30 = (DXG_VMBUS_CHANNEL_BASE *)(v6 + 4144);
    v31 = (struct _MDL *)*(unsigned int *)(*(_QWORD *)(v6 + 4200) + 4208LL);
    v48 = 0LL;
    v49 = 0;
    v50 = 0;
    v51 = 43;
...
LABEL_46:
    ...
    && *(_DWORD *)(*(_QWORD *)(a1 + 16) + 152LL) != 2 )
  {
    ...
    *(_QWORD *)(v39 + 24) = 2854LL;
    WdLogEvent5_WdAssertion(v39);
  }
  v40 = (*(__int64 (__fastcall **)(_QWORD, _QWORD))(*(_QWORD *)(*(_QWORD *)(a1 + 520) + 8LL) + 40LL))(
          *(_QWORD *)(a1 + 528),
          v16);
  v43 = v40;
  if ( v16 >= 6 && v40 < 0 )
