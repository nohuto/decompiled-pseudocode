/*
 * XREFs of ?VidMmGetAllocationFlipQueueReferencesPointer@VIDMM_EXPORT@@QEAAPEAUVIDMM_FLIP_QUEUE_REFERENCES@@PEAVVIDMM_GLOBAL@@PEAU_VIDMM_MULTI_ALLOC@@@Z @ 0x1C003BEF4
 * Callers:
