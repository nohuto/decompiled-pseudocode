/*
 * XREFs of DxgkUseAdapterViewInCurrentSession @ 0x1C0147CB4
 * Callers:
 ...
 *     ?AddDisplaySource@SESSION_ADAPTER@@QEAAJPEAVDISPLAY_SOURCE@@@Z @ 0x1C0147E80 (-AddDisplaySource@SESSION_ADAPTER@@QEAAJPEAVDISPLAY_SOURCE@@@Z.c)
...
LABEL_8:
      if ( (_DWORD)v4 != -1 )
      {
        ...
        v24 = COREADAPTERACCESS::AcquireExclusive(&v48, (unsigned int)(v23 + 1));
        v17 = v24;
        if ( v24 >= 0 )
        {
          v28 = *((_QWORD *)v22 + 319);
