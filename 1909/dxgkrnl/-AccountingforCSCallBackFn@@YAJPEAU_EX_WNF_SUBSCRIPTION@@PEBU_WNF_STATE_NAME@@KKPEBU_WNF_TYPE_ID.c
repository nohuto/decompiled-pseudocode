/*
 * XREFs of ?AccountingforCSCallBackFn@@YAJPEAU_EX_WNF_SUBSCRIPTION@@PEBU_WNF_STATE_NAME@@KKPEBU_WNF_TYPE_ID@@PEAX@Z @ 0x1C0241380
 * Callers:
 *     <none>
 * Callees:
        ...
        int a4)
{
  ...
  unsigned __int8 v20[8]; // [rsp+40h] [rbp-10h]
  ...
  *(_DWORD *)v20 = 0;
  ...
  if ( v4 >= 0 )
  {
    ...
    {
      DXGGLOBAL::InitializeCSAccounting(Global, v20[0]);
    }
    return 0LL;
  }
  else
