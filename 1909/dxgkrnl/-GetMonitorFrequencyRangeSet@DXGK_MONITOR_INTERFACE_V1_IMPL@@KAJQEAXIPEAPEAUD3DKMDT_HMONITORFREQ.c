/*
 * XREFs of ?GetMonitorFrequencyRangeSet@DXGK_MONITOR_INTERFACE_V1_IMPL@@KAJQEAXIPEAPEAUD3DKMDT_HMONITORFREQUENCYRANGESET__@@PEAPEBU_DXGK_MONITORFREQUENCYRANGESET_INTERFACE@@@Z @ 0x1C02CCF20
 * Callers:
 *     <none>
 * Callees:
        ...
        const struct _DXGK_MONITORFREQUENCYRANGESET_INTERFACE **a4)
{
  ...
  DXGETWPROFILER_BASE_PushProfilerEntry((__int64)&v33, 7054LL);
  ...
  if ( *((_QWORD *)v20 + 319) )
  {
    ...
    else if ( MonitorHandle >= 0 )
    {
      ...
      *a4 = &DXGK_MONITORFREQUENCYRANGESET_INTERFACE_V1_IMPL::DxgMonitorFrequencyRangeSetInterfaceV1;
      MonitorReleaseMonitorHandle(v20, v6, DXGK_MONITOR_INTERFACE_V1_IMPL::GetMonitorFrequencyRangeSet);
      LODWORD(v6) = 0;
    }
    else
    {
