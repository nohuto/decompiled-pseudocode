/*
 * XREFs of ?VmBusChannelProcessPacket@DXG_HOST_GLOBAL_VMBUS@@SAXPEAUVMBCHANNEL__@@PEAUVMBPACKETCOMPLETION__@@PEAXII@Z @ 0x1C003D120
 * Callers:
 *     <none>
 * Callees:
...
LABEL_5:
  ...
  if ( PoolWithTag )
  {
    ...
    v15[1].Parameter = (PVOID)((__int64 (__fastcall *)(struct _LIST_ENTRY *))qword_1C00A3C38)(a1);
