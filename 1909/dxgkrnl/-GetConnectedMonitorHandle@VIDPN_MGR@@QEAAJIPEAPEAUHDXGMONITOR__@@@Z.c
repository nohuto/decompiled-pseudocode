/*
 * XREFs of ?GetConnectedMonitorHandle@VIDPN_MGR@@QEAAJIPEAPEAUHDXGMONITOR__@@@Z @ 0x1C01298E8
 * Callers:
 ...
 *     ?GetMonitorIdFromTargetId@DpiPersistence@@YAJIAEBU_LUID@@PEAVVIDPN_MGR@@GPEAG@Z @ 0x1C012CF38 (-GetMonitorIdFromTargetId@DpiPersistence@@YAJIAEBU_LUID@@PEAVVIDPN_MGR@@GPEAG@Z.c)
...
__int64 __fastcall VIDPN_MGR::GetConnectedMonitorHandle(VIDPN_MGR *this, __int64 a2, struct HDXGMONITOR__ **a3)
{
  ...
  *a3 = 0LL;
  ...
  if ( IndexedSet<DMMVIDEOPRESENTTARGET>::FindById(v6, v3) )
  {
    ...
    MonitorHandle = MonitorGetMonitorHandle(*(DXGADAPTER **)(v10 + 16), (unsigned int)v3, 0, (void *)0x4E506456, a3);
  }
  else
  {
