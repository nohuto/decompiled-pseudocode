/*
 * XREFs of DxgkAcquireHandleDataCB @ 0x1C0137CA0
 * Callers:
 *     <none>
 * Callees:
 ...
 *     ?ReleaseShared@DXGAUTOPUSHLOCK@@QEAAXXZ @ 0x1C0023464 (-ReleaseShared@DXGAUTOPUSHLOCK@@QEAAXXZ.c)
