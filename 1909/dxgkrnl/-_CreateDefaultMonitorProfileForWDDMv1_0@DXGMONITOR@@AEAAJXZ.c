/*
 * XREFs of ?_CreateDefaultMonitorProfileForWDDMv1_0@DXGMONITOR@@AEAAJXZ @ 0x1C02CF15C
 * Callers:
...
__int64 __fastcall DXGMONITOR::_CreateDefaultMonitorProfileForWDDMv1_0(DXGMONITOR *this, __int64 a2)
{
  ...
  *((_QWORD *)&v36 + 1) = 8LL;
  while ( 2 )
  {
    v10 = 0LL;
    v11 = (unsigned int)v9;
    v12 = &word_1C00824B0[2 * v9];
    v13 = L"<FHKU";
    do
    {
      memset(&v37, 0, sizeof(v37));
      VideoModeDescriptor = GTF_GetVideoModeDescriptor(*v12, word_1C00824B0[2 * v11 + 1], *v13, 1u, 0, &v37);
  ...
  {
    v29 = WdLogNewEntry5_WdAssertion(word_1C00824B0, v24);
