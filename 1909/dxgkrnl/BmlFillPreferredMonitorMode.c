/*
 * XREFs of BmlFillPreferredMonitorMode @ 0x1C013BAE0
 * Callers:
 ...
 *     BmlIsLowResAnalogTvOutput @ 0x1C013BF14 (BmlIsLowResAnalogTvOutput.c)
      ...
      while ( 1 )
      {
        ...
        if ( NextMonitorSourceMode == 1075708748 )
        {
          ...
          if ( (unsigned __int8)BmlIsLowResAnalogTvOutput(a3) )
          {
            ...
            if ( v6 < 0x300 )
              v6 = 768;
            v20 = BmlCompareModeExtents((int *)&qword_1C00703C8, &v24);
            v21 = v24;
            if ( v20 == 1 )
              v21 = 0x30000000400LL;
            v24 = v21;
