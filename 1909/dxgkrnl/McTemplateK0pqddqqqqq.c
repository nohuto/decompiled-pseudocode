/*
 * XREFs of McTemplateK0pqddqqqqq @ 0x1C00481A4
 * Callers:
...
ULONG McTemplateK0pqddqqqqq(__int64 a1, const EVENT_DESCRIPTOR *a2, const GUID *a3, ...)
{
  ...
  v20 = 4LL;
  v22 = 4LL;
  return McGenEventWrite((PMCGEN_TRACE_CONTEXT)&DxgkControlGuid_Context, a2, a3, 0xAu, &EventData);
}
