/*
 * XREFs of PiRegStateReadStackCreationSettingsFromKey @ 0x1C017C7B0
 * Callers:
 ...
 *     CmRegUtilUcValueGetFullBuffer @ 0x1C017C3F4 (CmRegUtilUcValueGetFullBuffer.c)
 *     CmRegUtilWstrValueGetDword @ 0x1C017C978 (CmRegUtilWstrValueGetDword.c)
 *     SeUtilSecurityInfoFromSecurityDescriptor @ 0x1C017CBB0 (SeUtilSecurityInfoFromSecurityDescriptor.c)
 */
