/*
 * XREFs of ?IsCurrentThreadAppContainer@DXGPROCESS@@SA_NXZ @ 0x1C025EF2C
 * Callers:
 ...
 * Callees:
 *     ?OpenCurrentThreadToken@DXGPROCESS@@SAJPEAPEAX@Z @ 0x1C025F014 (-OpenCurrentThreadToken@DXGPROCESS@@SAJPEAPEAX@Z.c)
 */
