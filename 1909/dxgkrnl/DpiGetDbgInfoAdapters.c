/*
 * XREFs of DpiGetDbgInfoAdapters @ 0x1C004A810
 * Callers:
        ...
        do
        {
          if ( *((_DWORD *)v4 + 4) == 1953656900 && *((_DWORD *)v4 + 5) == 2 && *((_DWORD *)v4 + 59) == 2 )
          {
            if ( v1 >= 7 )
              break;
            v5 = 2LL * v1;
            *(_DWORD *)(a1 + 8 * v5) = *(_DWORD *)(v4[487] + 2452);
            *(_DWORD *)(a1 + 8 * v5 + 4) = *((_DWORD *)v4 + 281);
            *(_DWORD *)(a1 + 8 * v5 + 8) = *((_DWORD *)v4 + 282);
            v6 = (*(_DWORD *)(v4[487] + 176) == 1) | *(_DWORD *)(a1 + 16LL * v1 + 12) & 0xFFFFFFFE;
