/*
 * XREFs of ?NotifyTokenInFrame@CFlipExBuffer@@UEAAJAEBVCToken@@PEA_N@Z @ 0x1C0016640
 * Callers:
 *     <none>
 * Callees:
...
LABEL_14:
    ...
    if ( (*(unsigned __int8 (__fastcall **)(const struct CToken *))(*(_QWORD *)v7 + 160LL))(v7) )
    {
      *((_DWORD *)this + 88) = -1;
    }
    else
    {
      if ( !*((_BYTE *)v7 + 557) || *((_QWORD *)v7 + 71) != *((_QWORD *)this + 60) )
        goto LABEL_14;
      *((_DWORD *)this + 88) = 2;
    }
LABEL_32:
