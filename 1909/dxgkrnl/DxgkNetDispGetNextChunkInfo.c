/*
 * XREFs of DxgkNetDispGetNextChunkInfo @ 0x1C0203980
 * Callers:
 *     <none>
 * Callees:
        ...
        _DWORD *a7)
{
  ...
  __int64 v39; // [rsp+50h] [rbp-1A8h] BYREF
  _DWORD *v40; // [rsp+58h] [rbp-1A0h]
  _DWORD *v41; // [rsp+60h] [rbp-198h]
  PVOID Object[5]; // [rsp+68h] [rbp-190h] BYREF
  ...
  if ( (unsigned int)v8 <= 4 )
  {
    ...
    if ( !v10 )
    {
      ...
      *(_QWORD *)(v28 + 24) = 7852LL;
      WdLogEvent5_WdWarning(v28);
      LODWORD(v8) = -1073741801;
      goto LABEL_32;
    }
    LODWORD(v8) = DxgkMiracastGetNextChunkInfo(&v39, v36, (__int64)v43, &v33, v10, &v37);
    v34 = v8;
    LODWORD(v16) = v33;
    v23 = v40;
    v24 = v41;
