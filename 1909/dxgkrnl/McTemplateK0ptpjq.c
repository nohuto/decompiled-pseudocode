/*
 * XREFs of McTemplateK0ptpjq @ 0x1C0051F30
 * Callers:
...
ULONG McTemplateK0ptpjq(__int64 a1, __int64 a2, const GUID *a3, ...)
{
  ...
  v12 = 16LL;
  v14 = 4LL;
  return McGenEventWrite((PMCGEN_TRACE_CONTEXT)&DxgkControlGuid_Context, &EventOPMGetInformation, a3, 6u, &EventData);
}
