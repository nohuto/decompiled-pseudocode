/*
 * XREFs of ?DxgkCddEvict@@YAJIEPEAU_D3DKMT_EVICT@@PEAD@Z @ 0x1C0135440
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall DxgkCddEvict(__int64 a1, char a2, const GUID *a3, char *a4)
{
  __int64 v7; // rsi
  __int64 v8; // rdx
  __int64 v9; // rcx
  ...
  if ( (*(_BYTE *)(&DxgkControlGuid_Context + 2) & 2) != 0 )
  {
    ...
    if ( (Microsoft_Windows_DxgKrnlEnableBits & 0x2000) != 0 )
      McTemplateK0q(a1, &EventProfilerEnter, a3, 3061);
  }
  else
  {
    v64 = 0;
  }
  DXGETWPROFILER_BASE_PushProfilerEntry((__int64)&v62, 3061LL);
  v66[0] = 0LL;
  v67 = 0;
  if ( !a2 )
    goto LABEL_4;
  ...
  if ( v61 )
  {
    ...
    v29 = COREDEVICEACCESS::AcquireShared((__int64)v68, 0xBF5u, 0LL);
    v31 = v29;
    if ( v29 < 0 )
    {
...
LABEL_4:
        v10 = DxgkEvictInternal(a3, 0LL, 3061LL, a4);
        goto LABEL_5;
      }
