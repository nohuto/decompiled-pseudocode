/*
 * XREFs of ?MarkForPendingDestroy@OUTPUTDUPL_CONTEXT@@QEAAXXZ @ 0x1C0279A14
 * Callers:
 ...
 *     ?Abandon@DXGDXGIKEYEDMUTEX@@QEAAXXZ @ 0x1C0271180 (-Abandon@DXGDXGIKEYEDMUTEX@@QEAAXXZ.c)
...
void __fastcall OUTPUTDUPL_CONTEXT::MarkForPendingDestroy(OUTPUTDUPL_CONTEXT *this, __int64 a2)
{
  ...
  v7 = (DXGSESSIONMGR *)*((_QWORD *)DXGGLOBAL::GetGlobal((__int64)this, a2) + 74);
  if ( v7 )
  {
    if ( !*((_DWORD *)this + 76) )
    {
