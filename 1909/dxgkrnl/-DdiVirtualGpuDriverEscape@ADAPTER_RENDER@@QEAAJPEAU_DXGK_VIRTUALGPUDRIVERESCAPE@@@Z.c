/*
 * XREFs of ?DdiVirtualGpuDriverEscape@ADAPTER_RENDER@@QEAAJPEAU_DXGK_VIRTUALGPUDRIVERESCAPE@@@Z @ 0x1C0214D14
 * Callers:
 *     ?VirtualGpuDriverEscape@DXGK_VIRTUAL_GPU_GPUP@@UEAAJPEAU_DXGK_VIRTUALGPUDRIVERESCAPE@@@Z @ 0x1C02177E0 (-VirtualGpuDriverEscape@DXGK_VIRTUAL_GPU_GPUP@@UEAAJPEAU_DXGK_VIRTUALGPUDRIVERESCAPE@@@Z.c)
 * Callees:
        ...
        const GUID *a3)
{
  ...
  if ( (*(_BYTE *)(&DxgkControlGuid_Context + 2) & 2) != 0 )
  {
    ...
    if ( (Microsoft_Windows_DxgKrnlEnableBits & 0x2000) != 0 )
      McTemplateK0q((__int64)this, &EventProfilerEnter, a3, 5105);
  }
  else
  {
    v31 = 0;
  }
  DXGETWPROFILER_BASE_PushProfilerEntry((__int64)&v29, 5105LL);
...
LABEL_16:
  ...
  v15 = (*(int (__fastcall **)(_QWORD, struct _DXGK_VIRTUALGPUDRIVERESCAPE *))(*(_QWORD *)(*((_QWORD *)this + 2) + 928LL)
                                                                             + 112LL))(
  ...
  if ( (_DWORD)v15 != -1073741823 && (_DWORD)v15 != -1073741811 )
  {
    v22 = (int)v15 < 0;
    if ( !(_DWORD)v15 )
      goto LABEL_28;
    v23 = WdLogNewEntry5_WdError(v17, v14, v16);
    *(_QWORD *)(v23 + 24) = v15;
...
LABEL_28:
  if ( v22 )
  {
    v24 = WdLogNewEntry5_WdWarning(v17, v14, v16);
    *(_QWORD *)(v24 + 24) = v15;
