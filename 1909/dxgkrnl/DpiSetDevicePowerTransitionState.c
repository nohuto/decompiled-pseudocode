/*
 * XREFs of DpiSetDevicePowerTransitionState @ 0x1C004AF5C
 * Callers:
 ...
 *     ?DpiStartSuspendingAdapter@@YAEPEAU_FDO_CONTEXT@@@Z @ 0x1C004B3A0 (-DpiStartSuspendingAdapter@@YAEPEAU_FDO_CONTEXT@@@Z.c)
 * Callees:
