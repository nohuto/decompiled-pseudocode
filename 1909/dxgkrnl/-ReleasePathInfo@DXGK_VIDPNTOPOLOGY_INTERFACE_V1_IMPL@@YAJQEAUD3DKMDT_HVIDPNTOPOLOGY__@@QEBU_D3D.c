/*
 * XREFs of ?ReleasePathInfo@DXGK_VIDPNTOPOLOGY_INTERFACE_V1_IMPL@@YAJQEAUD3DKMDT_HVIDPNTOPOLOGY__@@QEBU_D3DKMDT_VIDPN_PRESENT_PATH@@@Z @ 0x1C0100950
 * Callers:
 *     <none>
 * Callees:
        ...
        const GUID *a3)
{
  ...
  DXGETWPROFILER_BASE_PushProfilerEntry((__int64)&v19, 7039LL);
  ...
  *(_QWORD *)(v7 + 32) = this;
  if ( a2 )
  {
    ...
    if ( v11 )
    {
      v13 = DMMVIDPNTOPOLOGY::ReleaseDdiEnumerator(v11, a2);
    }
    else
    {
