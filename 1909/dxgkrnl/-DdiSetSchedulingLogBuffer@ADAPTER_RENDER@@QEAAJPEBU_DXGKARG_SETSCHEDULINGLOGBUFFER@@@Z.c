/*
 * XREFs of ?DdiSetSchedulingLogBuffer@ADAPTER_RENDER@@QEAAJPEBU_DXGKARG_SETSCHEDULINGLOGBUFFER@@@Z @ 0x1C01FD554
 * Callers:
 *     ?ADAPTER_RENDER_DdiSetSchedulingLogBuffer@@YAJPEAVADAPTER_RENDER@@PEBU_DXGKARG_SETSCHEDULINGLOGBUFFER@@@Z @ 0x1C003E0A0 (-ADAPTER_RENDER_DdiSetSchedulingLogBuffer@@YAJPEAVADAPTER_RENDER@@PEBU_DXGKARG_SETSCHEDULINGLOGB.c)
 * Callees:
        ...
        const GUID *a3)
{
  ...
  __int64 v18; // r8
  __int64 v19; // rcx
  __int64 (__fastcall *v20)(_QWORD, const struct _DXGKARG_SETSCHEDULINGLOGBUFFER *); // rax
  int v21; // edi
  __int64 v22; // rcx
  _QWORD *v23; // rax
  ...
  DXGETWPROFILER_BASE_PushProfilerEntry((__int64)&v32, 5114LL);
...
LABEL_16:
  ...
  v19 = *((_QWORD *)this + 2);
  v20 = *(__int64 (__fastcall **)(_QWORD, const struct _DXGKARG_SETSCHEDULINGLOGBUFFER *))(v19 + 1152);
  if ( v20 )
