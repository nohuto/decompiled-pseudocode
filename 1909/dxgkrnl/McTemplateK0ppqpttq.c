/*
 * XREFs of McTemplateK0ppqpttq @ 0x1C003F3A4
 * Callers:
 *     TraceDxgkDevice @ 0x1C00244D0 (TraceDxgkDevice.c)
...
ULONG McTemplateK0ppqpttq(__int64 a1, const EVENT_DESCRIPTOR *a2, const GUID *a3, ...)
{
