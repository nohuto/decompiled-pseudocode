/*
 * XREFs of ?_PrepareMonitorCCDName@DXGMONITOR@@AEAAJXZ @ 0x1C0176EBC
 * Callers:
...
LABEL_25:
          ...
          if ( Flink )
          {
            ...
            *(_WORD *)(v38 + 2 * v34 + 24) = 0;
            v46 = (__int64 *)qword_1C00A39F8;
            if ( *(struct _LIST_ENTRY **)qword_1C00A39F8 != &DXGMONITOR::_UniqueEntryList )
              __fastfail(3u);
