/*
 * XREFs of ?CollectDbgInfo@DXGADAPTER@@QEAAJPEAU_TDR_RECOVERY_CONTEXT@@PEAPEAXPEAI@Z @ 0x1C01EC700
 * Callers:
 ...
 *     ?CollectDbgInfo@ADAPTER_DISPLAY@@QEAAJPEAUDXGADAPTERDBGINFO@@@Z @ 0x1C01F0930 (-CollectDbgInfo@ADAPTER_DISPLAY@@QEAAJPEAUDXGADAPTERDBGINFO@@@Z.c)
 */
        ...
        unsigned int *a4)
{
  ...
  *((_QWORD *)v14 + 8) = *((_QWORD *)v12 + 8);
  v16 = (ADAPTER_DISPLAY *)this[319];
  if ( v16 )
    ADAPTER_DISPLAY::CollectDbgInfo(v16, (struct DXGADAPTERDBGINFO *)v11);
  v17 = this[320];
  if ( v17 )
  {
    *((_OWORD *)v11 + 49) = *(_OWORD *)&v17[5].Reserved2;
    *((_OWORD *)v11 + 50) = *(_OWORD *)&v17[5].SpinLock;
  }
  *a3 = (char *)*a3 + 1072;
  *a4 -= 1072;
  return 0LL;
