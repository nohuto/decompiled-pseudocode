/*
 * XREFs of ?DdiFlipOverlay@ADAPTER_RENDER@@QEAAJPEAXPEAU_DXGKARG_FLIPOVERLAY@@@Z @ 0x1C01FA36C
 * Callers:
...
__int64 __fastcall ADAPTER_RENDER::DdiFlipOverlay(ADAPTER_RENDER *this, void *a2, const GUID *a3)
{
  __int64 v6; // rdx
  __int64 v7; // rcx
  ...
  if ( (*(_BYTE *)(&DxgkControlGuid_Context + 2) & 2) != 0 )
  {
    ...
    if ( (Microsoft_Windows_DxgKrnlEnableBits & 0x2000) != 0 )
      McTemplateK0q((__int64)this, &EventProfilerEnter, a3, 5034);
  }
  else
  {
    v33 = 0;
  }
  DXGETWPROFILER_BASE_PushProfilerEntry((__int64)&v31, 5034LL);
...
LABEL_16:
  ...
  v16 = (*(int (__fastcall **)(void *, const GUID *))(*((_QWORD *)this + 2) + 624LL))(a2, a3);
  if ( v34[0] )
  ...
  v22 = (_QWORD *)WdLogNewEntry5_WdTrace(v17, v15);
  v22[3] = v16;
  v25 = *(HANDLE *)&a3->Data1;
  ...
  {
    v26 = WdLogNewEntry5_WdError(v25, v23, v24);
    *(_QWORD *)(v26 + 24) = v16;
