/*
 * XREFs of ?LogDisplayBlackScreenDiagPacket@DISPLAYSTATECHECKER@@AEAAXXZ @ 0x1C02968CC
 * Callers:
 *     ?LogAllDisplayDiagInfo@DISPLAYSTATECHECKER@@QEAAXPEAU_DXGK_DISPLAY_SCENARIO_CONTEXT@@@Z @ 0x1C029670C (-LogAllDisplayDiagInfo@DISPLAYSTATECHECKER@@QEAAXPEAU_DXGK_DISPLAY_SCENARIO_CONTEXT@@@Z.c)
 * Callees:
...
void __fastcall DISPLAYSTATECHECKER::LogDisplayBlackScreenDiagPacket(DISPLAYSTATECHECKER *this)
{
  ...
  struct _DXGK_DIAG_BLACK_SCREEN_PACKET *v3; // rax
  __int64 v4; // rdx
  __int64 v5; // rcx
  __int64 v6; // r8
  struct _DXGK_DIAG_BLACK_SCREEN_PACKET *v7; // rbx
  __int64 v8; // rax
  __int64 v9; // rdx
  __int64 v10; // rcx
  ...
  v3 = (struct _DXGK_DIAG_BLACK_SCREEN_PACKET *)operator new[](BlackScreenDiagDataSize, 0x4B677844u, PagedPool);
  v7 = v3;
  if ( v3 )
  {
    ...
    DxgkWriteDiagEntry(v7, CurrentProcessSessionId, v12);
    operator delete[](v7);
  }
  else
  {
