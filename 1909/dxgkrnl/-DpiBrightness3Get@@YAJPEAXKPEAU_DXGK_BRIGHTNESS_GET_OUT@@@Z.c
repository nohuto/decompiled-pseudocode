/*
 * XREFs of ?DpiBrightness3Get@@YAJPEAXKPEAU_DXGK_BRIGHTNESS_GET_OUT@@@Z @ 0x1C02A6680
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall DpiBrightness3Get(_QWORD *a1, unsigned int a2, struct _DXGK_BRIGHTNESS_GET_OUT *a3)
{
  ...
  __int64 v12; // rax
  __int64 v13; // r9
  __int64 (__fastcall *v14)(_QWORD, _QWORD, struct _DXGK_BRIGHTNESS_GET_OUT *); // rax
  ...
  if ( v7 >= 0 )
  {
    ...
    if ( v13 )
    {
      v14 = *(__int64 (__fastcall **)(_QWORD, _QWORD, struct _DXGK_BRIGHTNESS_GET_OUT *))(v13 + 40);
      if ( v14 )
