/*
 * XREFs of ??1ADAPTER_RENDER@@QEAA@XZ @ 0x1C01F4C8C
 * Callers:
 ...
 *     ??1?$DXGNODELIST@VADAPTER_RENDER@@VDXGDEVICE@@@@AEAA@XZ @ 0x1C0036E64 (--1-$DXGNODELIST@VADAPTER_RENDER@@VDXGDEVICE@@@@AEAA@XZ.c)
