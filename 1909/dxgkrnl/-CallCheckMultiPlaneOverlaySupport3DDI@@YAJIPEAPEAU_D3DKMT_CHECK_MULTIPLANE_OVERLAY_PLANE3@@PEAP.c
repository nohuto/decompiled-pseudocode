/*
 * XREFs of ?CallCheckMultiPlaneOverlaySupport3DDI@@YAJIPEAPEAU_D3DKMT_CHECK_MULTIPLANE_OVERLAY_PLANE3@@PEAPEAXIPEAPEAU_D3DKMT_MULTIPLANE_OVERLAY_POST_COMPOSITION_WITH_SOURCE@@PEAVADAPTER_DISPLAY@@PEAHPEAUD3DKMT_CHECK_MULTIPLANE_OVERLAY_SUPPORT_RETURN_INFO@@@Z @ 0x1C022C618
 * Callers:
        ...
        struct D3DKMT_CHECK_MULTIPLANE_OVERLAY_SUPPORT_RETURN_INFO *a8)
{
  ...
  __int64 v20; // rdx
  __int64 v21; // rcx
  D3DKMT_MULTIPLANE_OVERLAY_POST_COMPOSITION *p_HighPart; // r8
...
LABEL_7:
  ...
  if ( v23 )
  {
      ...
      && v28 )
    {
      if ( a1 )
      {
        p_HighPart = (D3DKMT_MULTIPLANE_OVERLAY_POST_COMPOSITION *)&v23->CompSurfaceLuid.HighPart;
        ...
        do
        {
          *(struct _D3DKMT_CHECK_MULTIPLANE_OVERLAY_PLANE3 **)((char *)v10 + v34) = v23;
          v36 = *v10;
          *(_QWORD *)&p_HighPart[-1].DstRect.right = *(struct _D3DKMT_CHECK_MULTIPLANE_OVERLAY_PLANE3 **)((char *)v10 + v35);
          p_HighPart[-1].Rotation = v36->VidPnSourceId;
          p_HighPart->Flags.Value = v36->LayerIndex;
          *(RECT *)&p_HighPart->SrcRect.top = v36->pPlaneAttributes->SrcRect;
          *(RECT *)&p_HighPart->DstRect.top = v36->pPlaneAttributes->DstRect;
          *(RECT *)&p_HighPart[1].Flags.0 = v36->pPlaneAttributes->ClipRect;
          p_HighPart[1].SrcRect.bottom = v36->pPlaneAttributes->Rotation;
          p_HighPart[1].DstRect.top = v36->pPlaneAttributes->ColorSpace;
          p_HighPart->SrcRect.left ^= (p_HighPart->SrcRect.left ^ v36->pPlaneAttributes->Flags) & 1;
          p_HighPart->SrcRect.left ^= ((unsigned __int8)p_HighPart->SrcRect.left ^ (unsigned __int8)v36->pPlaneAttributes->Flags) & 2;
          p_HighPart[1].DstRect.left ^= (p_HighPart[1].DstRect.left ^ v36->pPlaneAttributes->Blend) & 1;
          if ( v36->pPlaneAttributes->StretchQuality == DXGKMT_MULTIPLANE_OVERLAY_STRETCH_QUALITY_BILINEAR )
          {
            p_HighPart[1].DstRect.right = 1;
          }
          else if ( v36->pPlaneAttributes->StretchQuality == DXGKMT_MULTIPLANE_OVERLAY_STRETCH_QUALITY_HIGH )
          {
            p_HighPart[1].DstRect.right = 2;
          }
          v23 = (struct _D3DKMT_CHECK_MULTIPLANE_OVERLAY_PLANE3 *)((char *)v23 + 104);
          ++v10;
          p_HighPart[1].DstRect.bottom = v36->pPlaneAttributes->SDRWhiteLevel;
          p_HighPart = (D3DKMT_MULTIPLANE_OVERLAY_POST_COMPOSITION *)((char *)p_HighPart + 104);
          --v12;
        }
        while ( v12 );
        a1 = v43;
      ...
      {
        v37 = a5;
        p_HighPart = &v8->PostComposition;
        v38 = v13;
        do
        {
          *(struct _D3DKMT_MULTIPLANE_OVERLAY_POST_COMPOSITION_WITH_SOURCE **)((char *)v37 + (char *)v27 - (char *)a5) = v8++;
          v39 = (__int64)*v37++;
          Value = p_HighPart->Flags.Value;
          p_HighPart[-1].Rotation = *(_DWORD *)v39;
          p_HighPart->SrcRect = *(RECT *)(v39 + 8);
          p_HighPart->DstRect = *(RECT *)(v39 + 24);
          p_HighPart->Rotation = *(_DWORD *)(v39 + 40);
          p_HighPart->Flags.Value ^= (*(_DWORD *)(v39 + 4) ^ Value) & 1;
          p_HighPart->Flags.Value ^= (*(_DWORD *)(v39 + 4) ^ p_HighPart->Flags.Value) & 2;
          p_HighPart = (D3DKMT_MULTIPLANE_OVERLAY_POST_COMPOSITION *)((char *)p_HighPart + 44);
          --v38;
        }
        while ( v38 );
      }
      ...
      *(_QWORD *)&v51.Supported = 0LL;
      ...
      v41 = ADAPTER_DISPLAY::DdiCheckMultiPlaneOverlaySupport3(v48, &v51, (const GUID *)p_HighPart);
      if ( v41 >= 0 )
      {
        *v49 = v51.Supported;
