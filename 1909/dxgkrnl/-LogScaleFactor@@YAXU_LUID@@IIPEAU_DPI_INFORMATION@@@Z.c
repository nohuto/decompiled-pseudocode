/*
 * XREFs of ?LogScaleFactor@@YAXU_LUID@@IIPEAU_DPI_INFORMATION@@@Z @ 0x1C012E694
 * Callers:
...
void __fastcall LogScaleFactor(struct _LUID a1, __int64 a2, int a3, struct _DPI_INFORMATION *a4)
{
  int v4; // eax
  unsigned int v5; // eax
  __int64 v6; // r8
  ...
  v5 = ((__int64 (__fastcall *)(_QWORD, _QWORD))PsGetCurrentProcessSessionId)(a1, a2);
  DxgkWriteDiagEntry((struct _DXGK_DIAG_HEADER *)v7, v5, v6);
}
