/*
 * XREFs of ?DdiUpdateMonitorLinkInfo@ADAPTER_DISPLAY@@QEAAJPEAU_DXGKARG_UPDATEMONITORLINKINFO@@@Z @ 0x1C01FFB30
 * Callers:
        ...
        const GUID *a3)
{
  ...
  DXGETWPROFILER_BASE_PushProfilerEntry((__int64)&v30, 5072LL);
...
LABEL_16:
  ...
  {
    v25 = WdLogNewEntry5_WdError(Value, v23, v22);
    *(_QWORD *)(v25 + 24) = v15;
