/*
 * XREFs of ?CsExitInitiatedWnfCallbackInternal@DXGGLOBAL@@QEAAXE_J@Z @ 0x1C0241F24
 * Callers:
      ...
      if ( *((_QWORD *)v10 + 320) && *((_DWORD *)v10 + 687) && *((_DWORD *)v10 + 684) )
      {
        ...
        if ( (_BYTE)v11 )
        {
          ...
          if ( dword_1C00A1888 > 5u && TlgKeywordOn((TraceLoggingHProvider)&dword_1C00A1888, 0x400000000004uLL) )
          {
            ...
            v37 = 4;
            v40 = 8;
            TlgWrite((TraceLoggingHProvider)&dword_1C00A1888, &unk_1C0073856, 0LL, v19, 5u, &pData);
          }
          if ( (int)v14 < 0 )
          {
