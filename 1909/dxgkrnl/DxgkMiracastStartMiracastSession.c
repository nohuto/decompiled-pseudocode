/*
 * XREFs of DxgkMiracastStartMiracastSession @ 0x1C004E6D8
 * Callers:
 ...
 *     ?AllocateNewChunks@MIRACAST_CHUNK_LIST@@QEAAEK@Z @ 0x1C004BE60 (-AllocateNewChunks@MIRACAST_CHUNK_LIST@@QEAAEK@Z.c)
