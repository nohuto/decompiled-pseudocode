/*
 * XREFs of ??1DXGSESSIONDATA@@QEAA@XZ @ 0x1C014520C
 * Callers:
 ...
 *     ?CleanupForSession@DXGVALIDATION@@QEAAXPEAVDXGSESSIONDATA@@@Z @ 0x1C001A4DC (-CleanupForSession@DXGVALIDATION@@QEAAXPEAVDXGSESSIONDATA@@@Z.c)
 *     ??_GOUTPUTDUPL_SESSION_MGR@@QEAAPEAXI@Z @ 0x1C001A4FC (--_GOUTPUTDUPL_SESSION_MGR@@QEAAPEAXI@Z.c)
