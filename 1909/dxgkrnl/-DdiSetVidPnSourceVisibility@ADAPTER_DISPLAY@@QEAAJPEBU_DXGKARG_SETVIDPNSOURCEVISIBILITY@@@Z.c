/*
 * XREFs of ?DdiSetVidPnSourceVisibility@ADAPTER_DISPLAY@@QEAAJPEBU_DXGKARG_SETVIDPNSOURCEVISIBILITY@@@Z @ 0x1C00D0118
 * Callers:
        ...
        const GUID *a3)
{
  ...
  __int64 v31; // [rsp+38h] [rbp-21h]
  char v32; // [rsp+40h] [rbp-19h]
  _BYTE v33[8]; // [rsp+48h] [rbp-11h] BYREF
  struct _KAPC_STATE ApcState; // [rsp+50h] [rbp-9h] BYREF

  if ( bTracingEnabled && (Microsoft_Windows_DxgKrnlEnableBits & 0x40) != 0 )
    McTemplateK0pqt((__int64)this, (__int64)a2, a3, this, a2->VidPnSourceId, a2->Visible != 0);
  v30 = -1;
  v31 = 0LL;
  if ( (*(_BYTE *)(&DxgkControlGuid_Context + 2) & 2) != 0 )
  {
    ...
    if ( (Microsoft_Windows_DxgKrnlEnableBits & 0x2000) != 0 )
      McTemplateK0q((__int64)this, &EventProfilerEnter, a3, 5011);
  }
  else
  {
    v32 = 0;
  }
  DXGETWPROFILER_BASE_PushProfilerEntry((__int64)&v30, 5011LL);
...
LABEL_19:
  ...
  v15 = (*(int (__fastcall **)(_QWORD, const struct _DXGKARG_SETVIDPNSOURCEVISIBILITY *))(*((_QWORD *)this + 2) + 512LL))(
  ...
  if ( (int)v15 >= 0 )
  {
    v26 = 3968LL * a2->VidPnSourceId;
    *(_BYTE *)(v26 + *((_QWORD *)this + 14) + 721) = a2->Visible;
  }
