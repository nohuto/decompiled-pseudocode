/*
 * XREFs of ??1DXGGLOBAL@@AEAA@XZ @ 0x1C0240D88
 * Callers:
 ...
 *     ??1REMOTE_VSYNC@@QEAA@XZ @ 0x1C0263808 (--1REMOTE_VSYNC@@QEAA@XZ.c)
...
void __fastcall DXGGLOBAL::~DXGGLOBAL(DXGGLOBAL *this)
{
  ...
  if ( (_QWORD *)*v31 != v31 )
  {
    ...
    *(_QWORD *)(v32 + 24) = 1471LL;
    WdLogEvent5_WdAssertion(v32);
  }
  if ( *((_QWORD *)this + 141) )
  {
    v33 = WdLogNewEntry5_WdAssertion(v23, v20);
    *(_QWORD *)(v33 + 24) = 1472LL;
    WdLogEvent5_WdAssertion(v33);
  }
  DXGFASTMUTEX::~DXGFASTMUTEX((DXGGLOBAL *)((char *)this + 304160));
