/*
 * XREFs of DxgkPresentMultiPlaneOverlay @ 0x1C02830D0
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall DxgkPresentMultiPlaneOverlay(struct D3DKMT_PRESENT_MULTIPLANE_OVERLAY *a1)
{
  ...
  struct D3DKMT_MULTIPLANE_OVERLAY *v84; // [rsp+B0h] [rbp-50h] BYREF
  ...
  D3DKMT_PRESENT_MULTIPLANE_OVERLAY v93; // [rsp+130h] [rbp+30h] BYREF
  ...
  DXGETWPROFILER_BASE_PushProfilerEntry((__int64)&v86, 2092LL);
  ...
  v84 = 0LL;
  v85 = 0LL;
  v76 = CapturePresentMultiPlaneOverlayArgs(a1, &v93, &v84, &v85);
  if ( v76 < 0 )
  {
