/*
 * XREFs of ?_EnableDisableMonitorInternal@MONITOR_MGR@@QEAAJIEW4MONITOR_EVENT@@_KPEAU_DXGK_DISPLAY_SCENARIO_CONTEXT@@@Z @ 0x1C0159DA8
 * Callers:
        ...
        __int64 a6)
{
        ...
        if ( (_DWORD)v6 == -1 || *(_DWORD *)(v14 + 44) == (_DWORD)v6 )
        {
          ...
          if ( *(_DWORD *)(v14 + 432) != 1 )
          {
            ...
            if ( v23 )
            {
              ...
              KeEnterCriticalRegion();
              ExAcquireResourceExclusiveLite((PERESOURCE)(v23 + 296), 1u);
              v27 = *(DXGMONITOR **)(v14 + 440);
              if ( a4 == 1 )
              {
                LOBYTE(v26) = a3;
                DXGMONITOR::_ChangeLIDStatus(v27, v26);
              }
              else
              {
                *((_DWORD *)v27 + 10) = *((_DWORD *)v27 + 10) & 0xFFFFFFDF | (a3 == 0 ? 0x20 : 0);
              }
              ExReleaseResourceLite((PERESOURCE)(v23 + 296));
              KeLeaveCriticalRegion();
            }
          }
        }
  ...
  {
    v29 = WdLogNewEntry5_WdError(v18, v17, v19);
    *(_QWORD *)(v29 + 24) = v6;
    *(_QWORD *)(v29 + 32) = a1;
