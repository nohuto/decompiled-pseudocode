/*
 * XREFs of ?ReleaseBuffer@DXGSWAPCHAIN@@QEAAJPEAU_D3DKMT_RELEASESWAPCHAIN@@PEAXD@Z @ 0x1C0287B4C
 * Callers:
...
LABEL_25:
    ...
    *((_DWORD *)v41 + 1) = DXGSWAPCHAIN::SwitchClient(v40, *((unsigned int *)v10 + 7));
    ...
    if ( (_DWORD)pDeferredFreeList_low )
    {
      ...
      v60 = a2->bProducer;
      LODWORD(v48) = pDeferredFreeList_low;
      v62 = 0LL;
      v63 = 0;
      v61 = 0;
...
LABEL_50:
  if ( (Microsoft_Windows_DxgKrnlEnableBits & 0x40000000) != 0 )
  {
    ...
    LODWORD(v48) = v16;
    McTemplateK0pqdqp(pDeferredFreeList_low, v21, (const GUID *)v23, this, v48, Src, v50, v7);
  }
