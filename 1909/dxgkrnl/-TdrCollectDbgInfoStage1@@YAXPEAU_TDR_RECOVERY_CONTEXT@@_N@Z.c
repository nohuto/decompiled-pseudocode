/*
 * XREFs of ?TdrCollectDbgInfoStage1@@YAXPEAU_TDR_RECOVERY_CONTEXT@@_N@Z @ 0x1C023D420
 * Callers:
 ...
 *     DpiGetAdapterDebugData @ 0x1C004A78C (DpiGetAdapterDebugData.c)
 *     DpiGetDbgInfoAdapters @ 0x1C004A810 (DpiGetDbgInfoAdapters.c)
 *     DpiGetGlobalDebugData @ 0x1C004A900 (DpiGetGlobalDebugData.c)
 ...
 *     ??0CTDR_DUMP_BUFFER@@QEAA@GPEAXK@Z @ 0x1C023C904 (--0CTDR_DUMP_BUFFER@@QEAA@GPEAXK@Z.c)
 *     ??0CTDR_DUMP_BUFFER_CANARY@@QEAA@PEAXK@Z @ 0x1C023C970 (--0CTDR_DUMP_BUFFER_CANARY@@QEAA@PEAXK@Z.c)
 *     ?AddSegment@CTDR_DUMP_BUFFER@@QEAAPEAXKK@Z @ 0x1C023CAA8 (-AddSegment@CTDR_DUMP_BUFFER@@QEAAPEAXKK@Z.c)
 *     ?Check@CTDR_DUMP_BUFFER_CANARY@@QEBA_NXZ @ 0x1C023CB3C (-Check@CTDR_DUMP_BUFFER_CANARY@@QEBA_NXZ.c)
 ...
 *     ?TdrIsDisplayOnlyTdr@@YA_NW4_TDR_TIMEOUT_REASON@@@Z @ 0x1C023E664 (-TdrIsDisplayOnlyTdr@@YA_NW4_TDR_TIMEOUT_REASON@@@Z.c)
      ...
      if ( v7 )
      {
        ...
        *((_DWORD *)a1 + 36) = 2;
        ...
        if ( v44 )
        {
          ...
          AdapterDebugData = DpiGetAdapterDebugData(*(_QWORD *)(*((_QWORD *)a1 + 4) + 192LL), v45);
        ...
        *((_DWORD *)a1 + 36) = 6;
        ...
        if ( !IsDisplayOnlyTdr && (_DWORD)v93 != 6 )
        {
          ...
          if ( v56 )
          {
            ...
            v58 = v55;
            v59 = (*(__int64 (__fastcall **)(struct _TDR_RECOVERY_CONTEXT *, char *, _QWORD))(*(_QWORD *)(*(_QWORD *)(*(_QWORD *)(*((_QWORD *)a1 + 4) + 2560LL) + 520LL) + 8LL)
                                                                                            + 600LL))(
                    a1,
                    v57,
                    v55);
        ...
        if ( (_DWORD)v64 != 3 && !(unsigned __int8)TdrIsDisplayOnlyTdr(v64) && v53 != 6 )
        {
          ...
          if ( v67 )
          {
            ...
            if ( v69 )
              ...
              v70 = 0LL;
            if ( !(*(__int64 (__fastcall **)(_QWORD, _QWORD, _QWORD, __int64, char *, _QWORD))(*(_QWORD *)(*(_QWORD *)(*(_QWORD *)(*((_QWORD *)a1 + 4) + 2560LL) + 544LL) + 8LL)
                                                                                             + 344LL))(
                    *(_QWORD *)(*(_QWORD *)(*((_QWORD *)a1 + 4) + 2560LL) + 552LL),
                    *((unsigned int *)a1 + 14),
                    *((_QWORD *)a1 + 8),
                    v70,
                    v68,
