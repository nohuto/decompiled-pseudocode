/*
 * XREFs of ?PrepareStagingBuffer@DXGPRESENT@@QEAAJPEAVDXGDEVICE@@IPEAVCOREDEVICEACCESS@@PEAI@Z @ 0x1C025B150
 * Callers:
        ...
        unsigned int *a5)
{
  ...
  if ( !*((_DWORD *)this + 105) )
  {
    ...
    if ( !(unsigned __int8)ExTryAcquirePushLockSharedEx(v15 + 184, 0LL) )
    {
      if ( bTracingEnabled )
      {
        v18 = *(_DWORD *)(v15 + 200);
      ...
      ExAcquirePushLockSharedEx(v15 + 184, 0LL);
    }
    v19 = ((unsigned int)v7 >> 6) & 0xFFFFFF;
    if ( (unsigned int)v19 < *(_DWORD *)(v15 + 224) )
    {
      v20 = *(_QWORD *)(v15 + 208);
        ...
        && (v21 & 0x1F) != 0 )
      {
        ...
        v23 = WdLogNewEntry5_WdError(((unsigned int)v7 >> 25) & 0x60, v22, 2LL * (unsigned int)v19);
        *(_QWORD *)(v23 + 24) = 267LL;
...
LABEL_22:
    ...
    if ( v38 )
    {
      ...
      {
        v30 = (_QWORD *)WdLogNewEntry5_WdError(v29, v28, v27);
        v13 = -1073741811;
        v30[3] = a2;
        v30[4] = v38;
        v30[5] = -1073741811LL;
