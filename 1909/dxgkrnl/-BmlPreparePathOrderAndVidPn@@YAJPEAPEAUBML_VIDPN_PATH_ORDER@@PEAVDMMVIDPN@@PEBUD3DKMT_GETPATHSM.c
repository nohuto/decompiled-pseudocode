/*
 * XREFs of ?BmlPreparePathOrderAndVidPn@@YAJPEAPEAUBML_VIDPN_PATH_ORDER@@PEAVDMMVIDPN@@PEBUD3DKMT_GETPATHSMODALITY@@GGW4DXGK_DIAG_CCD_BML_ORIGIN@@I@Z @ 0x1C00DDF98
 * Callers:
 ...
 *     ?DivideAndRound@DMMVIDEOSIGNALMODE@@SA_K_K0@Z @ 0x1C0003A0C (-DivideAndRound@DMMVIDEOSIGNALMODE@@SA_K_K0@Z.c)
 ...
 *     ?GetDisplayOnlyDriverUseRawModes@ADAPTER_DISPLAY@@QEBAHXZ @ 0x1C003FAEC (-GetDisplayOnlyDriverUseRawModes@ADAPTER_DISPLAY@@QEBAHXZ.c)
 ...
 *     ?BmlGetScaledAspectRatio@@YAHAEBU_D3DKMDT_2DREGION@@@Z @ 0x1C00DC46C (-BmlGetScaledAspectRatio@@YAHAEBU_D3DKMDT_2DREGION@@@Z.c)
  ...
  *((_DWORD *)v23 + 1) = a7;
  ...
  if ( (_BYTE)v41 )
  {
    do
    {
      ...
      if ( (int)(v43 + 1) > 32 )
      {
        v144 = WdLogNewEntry5_WdAssertion(v44, v30);
        *(_QWORD *)(v144 + 24) = *v7;
        *(_QWORD *)(v144 + 32) = v43;
...
LABEL_65:
      ...
      if ( *(_BYTE *)(v79 + 129) && (*(_DWORD *)v79 & 0x20000LL) != 0 )
      {
