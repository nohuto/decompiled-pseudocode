/*
 * XREFs of ?TdrInit@@YAXXZ @ 0x1C015ECF0
 * Callers:
...
void TdrInit(void)
{
  ...
  if ( dword_1C00A2D64 != v26 )
  {
    v18 = WdLogNewEntry5_WdWarning(v3, v2, v4);
    *(_QWORD *)(v18 + 24) = v26;
    *(_QWORD *)(v18 + 32) = (unsigned int)dword_1C00A2D64;
  ...
  if ( dword_1C00A2D68 != v27 )
  {
    v19 = WdLogNewEntry5_WdWarning(v3, v2, v4);
    *(_QWORD *)(v19 + 24) = v27;
    *(_QWORD *)(v19 + 32) = (unsigned int)dword_1C00A2D68;
  ...
  if ( dword_1C00A2D6C != v28 )
  {
    v20 = WdLogNewEntry5_WdWarning(v3, v2, v4);
    *(_QWORD *)(v20 + 24) = v28;
    *(_QWORD *)(v20 + 32) = (unsigned int)dword_1C00A2D6C;
  ...
  if ( dword_1C00A2D70 != v29 )
  {
    v21 = WdLogNewEntry5_WdWarning(v3, v2, v4);
    *(_QWORD *)(v21 + 24) = v29;
    *(_QWORD *)(v21 + 32) = (unsigned int)dword_1C00A2D70;
  ...
  if ( dword_1C00A2D78 != v30 )
  {
    v22 = WdLogNewEntry5_WdWarning(v3, v2, v4);
    *(_QWORD *)(v22 + 24) = v30;
    *(_QWORD *)(v22 + 32) = (unsigned int)dword_1C00A2D78;
  ...
  if ( dword_1C00A2D7C != v31 )
  {
    v23 = WdLogNewEntry5_WdWarning(3600LL, v2, v4);
    *(_QWORD *)(v23 + 24) = v31;
    *(_QWORD *)(v23 + 32) = (unsigned int)dword_1C00A2D7C;
    WdLogEvent5_WdWarning(v23);
  }
  LOBYTE(v12) = 1;
  byte_1C00A2D74 = (unsigned __int8)WdIsDebuggerPresent(v12) != 0;
  if ( v25 <= 3 )
    v0 = v25;
  g_TdrDebugMode = v0;
  if ( v0 != v25 )
