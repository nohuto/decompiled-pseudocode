/*
 * XREFs of ?SetSessionStatus@DXGPROTECTEDSESSION@@QEAAJW4_DXGK_PROTECTED_SESSION_STATUS@@@Z @ 0x1C0044A54
 * Callers:
 ...
 * Callees:
 *     ?QueueSignal@DXGPROTECTEDSESSION@@QEAAJXZ @ 0x1C0261C28 (-QueueSignal@DXGPROTECTEDSESSION@@QEAAJXZ.c)
 */
