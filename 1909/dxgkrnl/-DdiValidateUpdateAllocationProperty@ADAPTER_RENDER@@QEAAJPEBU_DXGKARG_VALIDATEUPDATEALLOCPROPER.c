/*
 * XREFs of ?DdiValidateUpdateAllocationProperty@ADAPTER_RENDER@@QEAAJPEBU_DXGKARG_VALIDATEUPDATEALLOCPROPERTY@@@Z @ 0x1C0200120
 * Callers:
        ...
        const GUID *a3)
{
  ...
  DXGETWPROFILER_BASE_PushProfilerEntry((__int64)&v27, 5073LL);
...
LABEL_16:
  ...
  v15 = (*(int (__fastcall **)(_QWORD, const struct _DXGKARG_VALIDATEUPDATEALLOCPROPERTY *))(*((_QWORD *)this + 2)
                                                                                           + 960LL))(
