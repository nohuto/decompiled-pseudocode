/*
 * XREFs of ?IsDisplayingOnVidPnSource@DXGDEVICE@@QEAA_NI@Z @ 0x1C022F520
 * Callers:
 *     DXGDEVICE_IsDisplayingOnVidPnSource @ 0x1C003E3D0 (DXGDEVICE_IsDisplayingOnVidPnSource.c)
 * Callees:
