/*
 * XREFs of ?CreateVmBusGuestSubscribers@DXGVAILGUESTOBJECT@@IEAAJXZ @ 0x1C0290564
 * Callers:
 *     ?Initialize@DXGVAILGUESTOBJECT@@QEAAJXZ @ 0x1C0290F24 (-Initialize@DXGVAILGUESTOBJECT@@QEAAJXZ.c)
 * Callees:
