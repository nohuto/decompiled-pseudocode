/*
 * XREFs of ?SendVmBusMessage@DXG_VMBUS_CHANNEL_BASE@@QEAAJPEAXI0PEAI@Z @ 0x1C0219F0C
 * Callers:
...
LABEL_6:
  ...
  v12 = ((__int64 (__fastcall *)(struct _KTHREAD *, void *, _QWORD, _QWORD, int, void *, unsigned int *, _QWORD))qword_1C00A3CA0)(
          *this,
          a2,
          a3,
          0LL,
