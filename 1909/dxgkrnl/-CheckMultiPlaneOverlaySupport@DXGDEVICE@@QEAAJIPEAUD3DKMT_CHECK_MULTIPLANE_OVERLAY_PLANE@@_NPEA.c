/*
 * XREFs of ?CheckMultiPlaneOverlaySupport@DXGDEVICE@@QEAAJIPEAUD3DKMT_CHECK_MULTIPLANE_OVERLAY_PLANE@@_NPEAH@Z @ 0x1C022DFBC
 * Callers:
        ...
        int *a5)
{
  ...
  __int64 v26; // rax
  struct D3DKMT_CHECK_MULTIPLANE_OVERLAY_SUPPORT_RETURN_INFO v27; // [rsp+40h] [rbp-438h] BYREF
  struct _D3DKMT_CHECK_MULTIPLANE_OVERLAY_PLANE3 *v28[8]; // [rsp+50h] [rbp-428h] BYREF
  char v29; // [rsp+90h] [rbp-3E8h] BYREF
  char v30; // [rsp+94h] [rbp-3E4h] BYREF
  char v31; // [rsp+190h] [rbp-2E8h] BYREF
  char v32; // [rsp+194h] [rbp-2E4h] BYREF

  *a5 = 0;
  if ( ADAPTER_RENDER::IsMultiPlaneOverlaySupported(this[2]) && (v10 = *((_QWORD *)this[2] + 2), *(_QWORD *)(v10 + 768)) )
  {
    v12 = 0;
    if ( a2 )
    {
