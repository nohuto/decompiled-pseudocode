/*
 * XREFs of ?EnumPathTargetsFromSource@DMMVIDPNTOPOLOGY@@QEBAJI_KPEAI@Z @ 0x1C00EDB7C
 * Callers:
...
__int64 __fastcall DMMVIDPNTOPOLOGY::EnumPathTargetsFromSource(char **this, __int64 a2, __int64 a3, unsigned int *a4)
{
  ...
  *a4 = -1;
  ...
  {
LABEL_18:
    *(_QWORD *)(WdLogNewEntry5_WdTrace(this, v9) + 24) = v7;
  }
  else
  {
    if ( v10 )
    {
      v13 = (_QWORD *)WdLogNewEntry5_WdTrace(0LL, v9);
      v13[3] = v7;
      v13[4] = v4;
      v13[5] = a3;
      return 1075708748LL;
    }
    v14 = WdLogNewEntry5_WdTrace(0LL, v9);
    *(_QWORD *)(v14 + 24) = v4;
    *(_QWORD *)(v14 + 32) = v7;
  }
  return 3223192377LL;
