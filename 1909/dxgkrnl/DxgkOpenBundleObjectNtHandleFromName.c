/*
 * XREFs of DxgkOpenBundleObjectNtHandleFromName @ 0x1C0252C50
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall DxgkOpenBundleObjectNtHandleFromName(ULONG64 a1, __int64 a2, const GUID *a3)
{
  __int64 v4; // r8
  ULONG64 v5; // rax
  ULONG64 v6; // rdx
  ...
  DXGETWPROFILER_BASE_PushProfilerEntry((__int64)&v12, 2205LL);
  v5 = a1;
