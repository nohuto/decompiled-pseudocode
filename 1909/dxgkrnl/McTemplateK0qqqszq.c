/*
 * XREFs of McTemplateK0qqqszq @ 0x1C00245C0
 * Callers:
...
ULONG __fastcall McTemplateK0qqqszq(
        __int64 a1,
        ...
        char a9)
{
  ...
  const GUID *v24; // [rsp+70h] [rbp-11h]
  ...
  v27 = v14;
  v30 = &a9;
  return McGenEventWrite((PMCGEN_TRACE_CONTEXT)&DxgkControlGuid_Context, a2, (LPCGUID)a2, 7u, &EventData);
}
