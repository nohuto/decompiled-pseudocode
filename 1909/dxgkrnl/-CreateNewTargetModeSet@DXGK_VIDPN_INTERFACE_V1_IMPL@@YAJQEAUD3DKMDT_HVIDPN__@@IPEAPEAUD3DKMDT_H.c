/*
 * XREFs of ?CreateNewTargetModeSet@DXGK_VIDPN_INTERFACE_V1_IMPL@@YAJQEAUD3DKMDT_HVIDPN__@@IPEAPEAUD3DKMDT_HVIDPNTARGETMODESET__@@PEAPEBU_DXGK_VIDPNTARGETMODESET_INTERFACE@@@Z @ 0x1C0141400
 * Callers:
 *     <none>
 * Callees:
        ...
        struct D3DKMDT_HVIDPNTARGETMODESET__ **a4)
{
  ...
  struct DMMVIDPNTARGETMODESET *v40; // [rsp+80h] [rbp+40h] BYREF
  ...
  DXGETWPROFILER_BASE_PushProfilerEntry((__int64)&v36, 7050LL);
  ...
  if ( a3 && a4 )
  {
    ...
    *a4 = 0LL;
    ...
    if ( v14 )
    {
      v17 = *(struct D3DKMDT_HVIDPNTARGETMODESET__ **)(*(_QWORD *)(v14 + 48) + 392LL);
      v18 = (DMMVIDPNTARGET *)IndexedSet<DMMVIDPNTARGET>::FindById(*(_QWORD *)(v14 + 312), v7);
      v22 = v18;
      if ( v18 )
      {
        v39 = 0LL;
        v40 = 0LL;
        v23 = DMMVIDPNTARGET::CreateNewCofuncModeSet(v18, &v40, v21);
        v6 = v23;
        if ( v23 < 0 )
        {
