/*
 * XREFs of ColorSpaceTransformCombine @ 0x1C0058D6C
 * Callers:
    ...
    do
    {
      ...
      else
      {
        if ( v14 )
        {
          ...
          v32 = (float)((float)((float)v14 * v18[3 * v30 + 7]) + (float)((float)v19 * v18[3 * v15 + 7])) / 4095.0;
          v33 = (float)((float)((float)v14 * v18[3 * v30 + 8]) + (float)((float)v19 * v18[3 * v15 + 8])) / 4095.0;
        }
        else
        {
          v31 = v18[3 * v15 + 6];
        ...
        v29 = (float)(v32 * v18[1]) + v18[4];
        v28 = (float)(v33 * v18[2]) + v18[5];
        if ( v27 >= 0.0 )
          v34 = fminf(1.0, v27);
        else
          v34 = 0.0;
