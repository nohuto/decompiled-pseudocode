/*
 * XREFs of McTemplateK0pqqxxx @ 0x1C0037440
 * Callers:
...
ULONG McTemplateK0pqqxxx(__int64 a1, __int64 a2, const GUID *a3, ...)
{
  ...
  v14 = 8LL;
  v16 = 8LL;
  return McGenEventWrite((PMCGEN_TRACE_CONTEXT)&DxgkControlGuid_Context, &EventCalibrateGpuClock, a3, 7u, &EventData);
}
