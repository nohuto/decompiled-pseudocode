/*
 * XREFs of ?EdidSupportsHDR@DXGMONITOR@@QEAAEXZ @ 0x1C0175E4C
 * Callers:
 ...
 * Callees:
 *     ?EdidColorDepthMoreThanSDR@DXGMONITOR@@QEAAEXZ @ 0x1C00200EC (-EdidColorDepthMoreThanSDR@DXGMONITOR@@QEAAEXZ.c)
 */
