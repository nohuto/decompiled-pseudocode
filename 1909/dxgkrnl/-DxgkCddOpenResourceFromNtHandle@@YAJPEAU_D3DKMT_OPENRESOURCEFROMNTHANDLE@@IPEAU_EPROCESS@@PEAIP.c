/*
 * XREFs of ?DxgkCddOpenResourceFromNtHandle@@YAJPEAU_D3DKMT_OPENRESOURCEFROMNTHANDLE@@IPEAU_EPROCESS@@PEAIPEAPEAXPEA_K@Z @ 0x1C020C150
 * Callers:
 *     <none>
 * Callees:
 ...
 *     ?GdiNodeSupportsGpuVa@ADAPTER_RENDER@@QEBAEXZ @ 0x1C003C144 (-GdiNodeSupportsGpuVa@ADAPTER_RENDER@@QEBAEXZ.c)
