/*
 * XREFs of DpiFdoHandleSurpriseRemoval @ 0x1C02A15D0
 * Callers:
 *     <none>
 * Callees:
...
NTSTATUS __fastcall DpiFdoHandleSurpriseRemoval(struct _DEVICE_OBJECT *a1, IRP *a2)
{
  ...
  if ( v7 != 6 )
  {
    ...
    {
      v9 = *(_QWORD *)(DeviceExtension + 2728);
      if ( v9 )
        v8 = *(_QWORD *)(v9 + 64);
    }
    if ( !*(_BYTE *)(DeviceExtension + 232)
      && (v7 == 2 || *(_DWORD *)(DeviceExtension + 240) == 2 && ((v7 - 3) & 0xFFFFFFFD) == 0) )
    {
...
LABEL_20:
    ...
    if ( v8 == DeviceExtension )
    {
      KeEnterCriticalRegion();
      ExAcquireResourceExclusiveLite((PERESOURCE)(v8 + 3792), 1u);
      *(_DWORD *)(v8 + 4LL * (*(_DWORD *)(v8 + 276) & 7) + 244) = *(_DWORD *)(v8 + 240);
      v13 = *(_DWORD *)(v8 + 236);
      ++*(_DWORD *)(v8 + 276);
      *(_DWORD *)(v8 + 240) = v13;
      *(_DWORD *)(v8 + 236) = 6;
      ExReleaseResourceLite((PERESOURCE)(v8 + 3792));
