/*
 * XREFs of ?GetDxgiGammaRamp@ADAPTER_DISPLAY@@QEAAJIPEAPEBUDXGK_GAMMA_RAMP@@@Z @ 0x1C00CDCEC
 * Callers:
        ...
        const struct DXGK_GAMMA_RAMP **a3)
{
  ...
  *a3 = 0LL;
  if ( !*((_DWORD *)v10 + 474) )
    return 0LL;
  SourceConnectedToTargetInClientVidPn = DmmGetSourceConnectedToTargetInClientVidPn(v10, v4, &v33);
  if ( SourceConnectedToTargetInClientVidPn >= 0 )
  {
    if ( v33 == -1 )
    {
      v19 = WdLogNewEntry5_WdAssertion(v14, v13);
      *(_QWORD *)(v19 + 24) = 7459LL;
      ...
      if ( v23 )
      {
        ...
        if ( v24 )
        {
          inited = DXGK_GAMMA_RAMP::Initialize(
                     (DXGK_GAMMA_RAMP *)v11,
                     (enum _D3DDDI_GAMMARAMP_TYPE)*(_DWORD *)(v24 + 16),
                     *(const void **)(v24 + 32));
        }
        else
        {
          ...
          if ( SourceConnectedToTargetInClientVidPn < 0 )
            goto LABEL_34;
          inited = ColorSpaceTransformInitIdentityTransform((__int64)(v11 + 8));
        }
