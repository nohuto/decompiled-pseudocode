/*
 * XREFs of ?DeferredInitialize@DXGPROCESS@@QEAAJI@Z @ 0x1C0101190
 * Callers:
...
__int64 __fastcall DXGPROCESS::DeferredInitialize(DXGPROCESS *this, __int64 a2)
{
  ...
  *(_QWORD *)(v10 + 8 * v11 + 16) = v7;
  ...
  v14 = (*(__int64 (__fastcall **)(DXGPROCESS *))(*(_QWORD *)(v13 + 8) + 352LL))(this);
  v10 = *((_QWORD *)this + 9);
