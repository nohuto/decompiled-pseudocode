/*
 * XREFs of ??1CFlipExBuffer@@MEAA@XZ @ 0x1C00103C4
 * Callers:
 *     ??_GCFlipExBuffer@@MEAAPEAXI@Z @ 0x1C0010380 (--_GCFlipExBuffer@@MEAAPEAXI@Z.c)
 *     ??_GCCompositionSwapchainBuffer@@MEAAPEAXI@Z @ 0x1C005D390 (--_GCCompositionSwapchainBuffer@@MEAAPEAXI@Z.c)
 * Callees:
 *     ??1CCompositionBuffer@@UEAA@XZ @ 0x1C0012ED0 (--1CCompositionBuffer@@UEAA@XZ.c)
 *     ?ReleaseHDR10MetaData@CFlipExBuffer@@IEAAXXZ @ 0x1C0012F68 (-ReleaseHDR10MetaData@CFlipExBuffer@@IEAAXXZ.c)
 *     ?ReleasePendingPresentLimits@CFlipExBuffer@@IEAAXXZ @ 0x1C0012F90 (-ReleasePendingPresentLimits@CFlipExBuffer@@IEAAXXZ.c)
