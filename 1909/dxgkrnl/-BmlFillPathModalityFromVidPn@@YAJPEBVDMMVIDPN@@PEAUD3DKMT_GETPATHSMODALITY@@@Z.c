/*
 * XREFs of ?BmlFillPathModalityFromVidPn@@YAJPEBVDMMVIDPN@@PEAUD3DKMT_GETPATHSMODALITY@@@Z @ 0x1C0127F50
 * Callers:
      ...
      while ( v7 )
      {
        ...
        if ( (*((_QWORD *)v9 + 6) & 0x700000000000LL) == 0x700000000000LL )
        {
            ...
            && *((_DWORD *)v9 + 19) == *(_DWORD *)(*((_QWORD *)v4 + 12) + 24LL) )
          {
            ...
            _BmlFillOnePathModalityFromVidPn<D3DKMT_PATHMODALITY_DESCRIPTOR>(
              (__int64)v4,
              (__int64)(v9 + 48),
              (__int64)v3);
            v14 = *((_QWORD *)v4 + 11);
