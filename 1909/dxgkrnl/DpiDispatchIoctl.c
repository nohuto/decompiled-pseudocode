/*
 * XREFs of DpiDispatchIoctl @ 0x1C01492A0
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall DpiDispatchIoctl(__int64 a1, IRP *a2)
{
  ...
  if ( bTracingEnabled )
  {
    ...
    if ( (Microsoft_Windows_DxgKrnlEnableBits & 0x40) != 0 )
      McTemplateK0phbr1q(v6, &EventEnterDpiDispatchIoctl, v7, a1);
  }
  v8 = *(_QWORD *)(a1 + 64);
  ...
  v14 = *(__int64 (__fastcall **)(__int64, IRP *))(v8 + 120);
  v2 = 1;
  if ( !v14 )
  {
    if ( *(_BYTE *)(v8 + 56) == 1 && *(_QWORD *)(v8 + 160) )
    {
      ...
      v15 = IofCallDriver(*(PDEVICE_OBJECT *)(v8 + 160), a2);
      goto LABEL_7;
    }
...
LABEL_9:
  if ( bTracingEnabled && (Microsoft_Windows_DxgKrnlEnableBits & 0x40) != 0 )
  {
    ...
    McTemplateK0xq(v16, &EventExitDpiDispatchIoctl, v17, a1, RemlockSize);
  }
