/*
 * XREFs of ?InvalidateDisplayModeListCacheOnSource@ADAPTER_DISPLAY@@QEAAXI@Z @ 0x1C014DAA4
 * Callers:
...
void __fastcall ADAPTER_DISPLAY::InvalidateDisplayModeListCacheOnSource(PERESOURCE **this, unsigned int a2)
{
  ...
  if ( !DXGADAPTER::IsCoreResourceExclusiveOwner(this[2]) )
  {
    ...
    *(_QWORD *)(v10 + 24) = 2916LL;
    WdLogEvent5_WdAssertion(v10);
  }
  if ( (unsigned int)v3 >= *((_DWORD *)this + 20) )
  {
    v11 = WdLogNewEntry5_WdAssertion(v5, v4);
    *(_QWORD *)(v11 + 24) = 2917LL;
    WdLogEvent5_WdAssertion(v11);
  }
  DxgkLogCodePointPacket(0x1Cu, v3 + 0x80000000, 0, 0, *(__int64 *)((char *)this[2] + 276));
  if ( bTracingEnabled && (Microsoft_Windows_DxgKrnlEnableBits & 0x40) != 0 )
  {
    ...
    McTemplateK0pquutttq(v7, v6, v8, this, v12, v13, v14, v15, v16, v17, v18);
  }
  v9 = 496 * v3;
