/*
 * XREFs of ?BltQueueWorker@BLTQUEUE@@QEAAXXZ @ 0x1C015C290
 * Callers:
 *     ?BltQueueWorkerThread@BLTQUEUE@@SAXPEAX@Z @ 0x1C015C250 (-BltQueueWorkerThread@BLTQUEUE@@SAXPEAX@Z.c)
 * Callees:
 ...
 *     ?TdrIsDodVSyncTimeoutForcedFlip@@YA_NXZ @ 0x1C023E694 (-TdrIsDodVSyncTimeoutForcedFlip@@YA_NXZ.c)
