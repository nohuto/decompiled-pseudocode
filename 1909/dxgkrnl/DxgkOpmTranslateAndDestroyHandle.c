/*
 * XREFs of DxgkOpmTranslateAndDestroyHandle @ 0x1C0154DFC
 * Callers:
...
__int64 __fastcall DxgkOpmTranslateAndDestroyHandle(struct _KTHREAD ***this, void *a2, void **a3)
{
  ...
  if ( v9 )
  {
    ...
    return ADAPTER_DISPLAY::OpmTranslateAndDestroyHandle((ADAPTER_DISPLAY *)v9, a2, a3);
  }
  else
  {
