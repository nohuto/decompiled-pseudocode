/*
 * XREFs of ?DxgkAllocateMdlMemoryTracker@@YAJQEAXPEAU_MDL@@W4DXG_DRIVER_MEMORY_TRACKER_TYPE@@PEAPEAUDXG_DRIVER_MEMORY_TRACKER@@@Z @ 0x1C003E2AC
 * Callers:
 *     DxgkAllocatePagesForMdlCB @ 0x1C003E870 (DxgkAllocatePagesForMdlCB.c)
 *     DxgkMapMdlToIoMmuCB @ 0x1C003ED40 (DxgkMapMdlToIoMmuCB.c)
 * Callees:
