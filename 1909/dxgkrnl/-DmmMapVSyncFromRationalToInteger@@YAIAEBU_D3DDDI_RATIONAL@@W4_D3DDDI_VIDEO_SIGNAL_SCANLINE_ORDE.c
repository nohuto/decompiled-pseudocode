/*
 * XREFs of ?DmmMapVSyncFromRationalToInteger@@YAIAEBU_D3DDDI_RATIONAL@@W4_D3DDDI_VIDEO_SIGNAL_SCANLINE_ORDERING@@PEAE@Z @ 0x1C00DB95C
 * Callers:
 ...
 *     DxgkUpdateCddDevmodeExtraData @ 0x1C014F340 (DxgkUpdateCddDevmodeExtraData.c)
 *     DxgkCddVerifyCddDevMode @ 0x1C014F500 (DxgkCddVerifyCddDevMode.c)
...
__int64 __fastcall DmmMapVSyncFromRationalToInteger(const struct _D3DDDI_RATIONAL *a1, __int64 a2, unsigned __int8 *a3)
{
  ...
  v10 = (unsigned int *)&unk_1C006E180;
  v11 = 0;
  while ( 1 )
  {
    if ( (_DWORD)v9 )
