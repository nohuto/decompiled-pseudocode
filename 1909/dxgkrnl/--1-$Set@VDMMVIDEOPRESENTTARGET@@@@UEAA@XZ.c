/*
 * XREFs of ??1?$Set@VDMMVIDEOPRESENTTARGET@@@@UEAA@XZ @ 0x1C00535F0
 * Callers:
 *     ??1DMMVIDEOPRESENTTARGETSET@@UEAA@XZ @ 0x1C0053690 (--1DMMVIDEOPRESENTTARGETSET@@UEAA@XZ.c)
 *     ??_G?$IndexedSet@VDMMVIDEOPRESENTTARGET@@@@UEAAPEAXI@Z @ 0x1C0053F50 (--_G-$IndexedSet@VDMMVIDEOPRESENTTARGET@@@@UEAAPEAXI@Z.c)
 *     ??_G?$Set@VDMMVIDEOPRESENTTARGET@@@@UEAAPEAXI@Z @ 0x1C00540E0 (--_G-$Set@VDMMVIDEOPRESENTTARGET@@@@UEAAPEAXI@Z.c)
 * Callees:
