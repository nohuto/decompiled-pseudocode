/*
 * XREFs of ?CollectPathsFromLegacyVidPn@CCD_BTL_ACTIVE_PATHS_COLLECTOR@@QEAAJPEAVDMMVIDPN@@@Z @ 0x1C02C2C24
 * Callers:
        ...
        struct DMMVIDPN *a2)
{
  ...
  if ( v4 >= 0 )
  {
    ...
    if ( *(_WORD *)(v6 + 20) )
    {
      do
      {
        if ( (((unsigned int)D3DKMDT_VPPR_GET_CONTENT_ROTATION(*(_DWORD *)(272LL * v5 + v6 + 180)) - 1) & 0xFFFFFFFD) != 0 )
        {
          v8 = *(_DWORD *)(v7 + v6 + 148);
          v9 = *(_DWORD *)(v7 + v6 + 144);
        }
        ...
        if ( (v10 & 0x4000000000000LL) == 0 )
        {
          for ( i = v5; i < *(unsigned __int16 *)(v6 + 20); ++i )
          {
              ...
              && *(_DWORD *)(v12 + v6 + 68) == *(_DWORD *)(v7 + v6 + 68) )
            {
              ...
              *(_DWORD *)(v12 + v6 + 232) = v5 | 0xFE570000;
            }
          }
        }
        ++v5;
