/*
 * XREFs of ??0ApplyPermissionWithinThisScope@@IEAA@QEAVProtectableFromChange@@EW4ActionPermission_T@1@E_KE@Z @ 0x1C00E4244
 * Callers:
        ...
        unsigned __int64 a6)
{
  ...
  *(_BYTE *)(a1 + 9) = _bittest(&v9, a3);
  ...
  {
    v15 = WdLogNewEntry5_WdAssertion(a3, a2);
  ...
  *(_QWORD *)(a1 + 16) = v12;
  if ( v11 )
  {
    ...
    {
      v17 = WdLogNewEntry5_WdAssertion(v12, a2);
      WdLogEvent5_WdAssertion(v17);
      v12 = *(_QWORD *)(a1 + 16);
    }
    if ( v12 )
    {
      v18 = WdLogNewEntry5_WdAssertion(v12, a2);
