/*
 * XREFs of ?Initialize@CFlipExBuffer@@AEAAJAEBUCSM_BUFFER_ATTRIBUTES@@AEBUCSM_SWAPCHAIN_BUFFER_INFO@@_N@Z @ 0x1C00127A4
 * Callers:
        ...
        bool a4)
{
  ...
  __int64 v10; // rbp
  __int64 v11; // xmm1_8
  void (__fastcall ***v12)(PVOID, __int64); // r14
  PVOID v14; // rax
  struct _OBJECT_TYPE *SharedSyncObjectType; // rax
  PVOID v16; // rax
  PVOID Object; // [rsp+30h] [rbp-48h] BYREF
  _DWORD v18[2]; // [rsp+38h] [rbp-40h] BYREF
