/*
 * XREFs of ?DdiResetFromTimeout@ADAPTER_RENDER@@QEAAJXZ @ 0x1C01FC498
 * Callers:
...
__int64 __fastcall ADAPTER_RENDER::DdiResetFromTimeout(ADAPTER_RENDER *this, __int64 a2, const GUID *a3)
{
  ...
  DXGETWPROFILER_BASE_PushProfilerEntry((__int64)&v29, 5020LL);
...
LABEL_16:
  ...
  v14 = (*(int (__fastcall **)(_QWORD))(*((_QWORD *)this + 2) + 440LL))(*(_QWORD *)(*((_QWORD *)this + 2) + 248LL));
  if ( v32[0] )
