/*
 * XREFs of DxgkEnumerateModesForPathsModality @ 0x1C026DCB0
 * Callers:
 *     <none>
 * Callees:
 ...
 *     ??0CCD_TOPOLOGY@@QEAA@PEAUD3DKMT_GETPATHSMODALITY@@@Z @ 0x1C00DAD10 (--0CCD_TOPOLOGY@@QEAA@PEAUD3DKMT_GETPATHSMODALITY@@@Z.c)
 *     DMMVideoSignalInfoToDisplayConfigVideoSignalInfo @ 0x1C00DF038 (DMMVideoSignalInfoToDisplayConfigVideoSignalInfo.c)
 *     ??0CCD_MODE_RESULT_SET@@QEAA@XZ @ 0x1C02C00BC (--0CCD_MODE_RESULT_SET@@QEAA@XZ.c)
