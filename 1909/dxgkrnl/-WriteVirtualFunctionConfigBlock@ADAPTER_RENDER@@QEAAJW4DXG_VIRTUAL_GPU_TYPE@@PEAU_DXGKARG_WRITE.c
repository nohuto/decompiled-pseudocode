/*
 * XREFs of ?WriteVirtualFunctionConfigBlock@ADAPTER_RENDER@@QEAAJW4DXG_VIRTUAL_GPU_TYPE@@PEAU_DXGKARG_WRITEVIRTUALFUNCTIONCONFIGBLOCK@@@Z @ 0x1C02100A4
 * Callers:
 *     DxgkDdiWriteVirtualFunctionConfigBlock @ 0x1C0210F84 (DxgkDdiWriteVirtualFunctionConfigBlock.c)
 * Callees:
...
__int64 __fastcall ADAPTER_RENDER::WriteVirtualFunctionConfigBlock(__int64 a1, int a2, __int64 a3)
{
  ...
  {
    v11 = (*(__int64 (__fastcall **)(struct DXGK_VIRTUAL_GPU *, __int64))(*(_QWORD *)VirtualGpuByIndex + 64LL))(
            VirtualGpuByIndex,
            a3);
  }
  else
