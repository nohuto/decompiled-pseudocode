/*
 * XREFs of ??ROBTAIN_MODES_ON_SOURCE@@QEBAJPEAPEAU_D3DKMT_DISPLAYMODE@@PEAI01@Z @ 0x1C01711FC
 * Callers:
 ...
 *     ?BmlIsSupportedPathScaling@@YA_NW4_D3DKMDT_VIDPN_PRESENT_PATH_SCALING@@U_D3DKMDT_VIDPN_PRESENT_PATH_SCALING_SUPPORT@@@Z @ 0x1C0127A88 (-BmlIsSupportedPathScaling@@YA_NW4_D3DKMDT_VIDPN_PRESENT_PATH_SCALING@@U_D3DKMDT_VIDPN_PRESENT_P.c)
...
LABEL_34:
                      ...
                      *(_QWORD *)v199 = 0LL;
                      ...
                      if ( v86 >= 0 )
                      {
                        ...
                        v64 = (int *)&unk_1C0070CD8;
                        v193 = v63;
                        v208 = (char *)&unk_1C0070CD8;
                        while ( 1 )
                        {
                          if ( !v63 )
                            goto LABEL_24;
