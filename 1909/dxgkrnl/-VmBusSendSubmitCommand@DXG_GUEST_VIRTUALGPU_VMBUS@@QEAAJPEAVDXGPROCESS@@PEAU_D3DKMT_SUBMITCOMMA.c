/*
 * XREFs of ?VmBusSendSubmitCommand@DXG_GUEST_VIRTUALGPU_VMBUS@@QEAAJPEAVDXGPROCESS@@PEAU_D3DKMT_SUBMITCOMMAND@@@Z @ 0x1C022722C
 * Callers:
...
LABEL_35:
            ...
            {
LABEL_43:
              DXGHANDLETABLELOCKSHARED::~DXGHANDLETABLELOCKSHARED((DXGHANDLETABLELOCKSHARED *)v70);
            ...
            while ( 1 )
            {
              ...
              if ( (unsigned int)v45 >= *((_DWORD *)v4 + 56) )
                break;
              v46 = *((_QWORD *)v4 + 26);
              ...
              if ( (_BYTE)v30 != 7 )
              {
                v59 = WdLogNewEntry5_WdError(v30, v43, v44);
                *(_QWORD *)(v59 + 24) = 267LL;
