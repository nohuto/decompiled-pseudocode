/*
 * XREFs of ?DisplayConfigHandleMonitorInvalidation@@YAJ_KPEAUMONITORSCOUNT_CALLBACK_CONTEXT@@PEAU_DXGK_DISPLAY_SCENARIO_CONTEXT@@@Z @ 0x1C0141040
 * Callers:
        ...
        struct _DXGK_DISPLAY_SCENARIO_CONTEXT *a3)
{
  ...
  *(_WORD *)((char *)&v29 + 5) = 0;
  ...
  v12 = (int)DXGGLOBAL::IterateAdaptersWithCallback(
               (__int64)Global,
               (__int64)DisplayConfigDestroySimulatedMonitors,
               (__int64)&v29,
               4);
  if ( (a1 & 1) == 0 )
  {
...
LABEL_24:
      if ( (a1 & 4) != 0 )
      {
        ...
        DXGGLOBAL::IterateAdaptersWithCallback((__int64)v27, (__int64)InvalidateChildRelationsOnAdapterCallback, 0LL, 4);
      }
      return (unsigned int)v12;
    }
    if ( (a1 & 4) != 0 )
