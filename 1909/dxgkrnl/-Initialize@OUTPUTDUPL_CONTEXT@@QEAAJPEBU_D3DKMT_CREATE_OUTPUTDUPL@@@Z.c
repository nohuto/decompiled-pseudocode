/*
 * XREFs of ?Initialize@OUTPUTDUPL_CONTEXT@@QEAAJPEBU_D3DKMT_CREATE_OUTPUTDUPL@@@Z @ 0x1C02796AC
 * Callers:
 ...
 *     ?Initialize@DXGDXGIKEYEDMUTEX@@QEAAJPEAX@Z @ 0x1C027312C (-Initialize@DXGDXGIKEYEDMUTEX@@QEAAJPEAX@Z.c)
