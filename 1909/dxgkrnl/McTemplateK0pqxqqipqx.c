/*
 * XREFs of McTemplateK0pqxqqipqx @ 0x1C0047618
 * Callers:
...
ULONG McTemplateK0pqxqqipqx(__int64 a1, __int64 a2, __int64 a3, ...)
{
  ...
  EVENT_DATA_DESCRIPTOR EventData; // [rsp+60h] [rbp-A0h] BYREF
  ...
  v26 = 4LL;
  v28 = 8LL;
  return McGenEventWrite((PMCGEN_TRACE_CONTEXT)&DxgkControlGuid_Context, &EventVSyncDPC, 0LL, 0xAu, &EventData);
}
