/*
 * XREFs of McTemplateK0pqUR1qqtqqqqqqx @ 0x1C004B130
 * Callers:
...
ULONG McTemplateK0pqUR1qqtqqqqqqx(__int64 a1, __int64 a2, const GUID *a3, ...)
{
  ...
  v29 = 4LL;
  v31 = 8LL;
  return McGenEventWrite((PMCGEN_TRACE_CONTEXT)&DxgkControlGuid_Context, &EventDpiReportAdapter, a3, 0xEu, &EventData);
}
