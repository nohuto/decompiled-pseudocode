/*
 * XREFs of DpiPdoDispatchIoctl @ 0x1C00D05B0
 * Callers:
 *     <none>
 * Callees:
    ...
    if ( MonitorInstance >= 0 )
    {
      ...
      if ( v12 )
      {
        ...
        if ( (_DWORD)v13 != -1 )
        {
          ...
          v18 = *(MONITOR_MGR **)(v17 + 96);
          if ( v18 )
          {
            v26 = 0LL;
            MonitorInstance = MONITOR_MGR::_GetMonitorInstance(v18, v13, 1u, &v26);
            if ( MonitorInstance < 0 )
            {
          ...
          v22 = WdLogNewEntry5_WdError(v15, v14, v16);
          *(_QWORD *)(v22 + 24) = v12;
