/*
 * XREFs of ?CreateClientVmBusChannel@@YAJPEAXPEAU_DEVICE_OBJECT@@U_GUID@@2PEBU_UNICODE_STRING@@PEAU_VMB_CHANNEL_STATE_CHANGE_CALLBACKS@@P6AXPEAUVMBCHANNEL__@@PEAUVMBPACKETCOMPLETION__@@0II@ZP6AX5I@ZPEAPEAU5@@Z @ 0x1C0217884
 * Callers:
        ...
        struct VMBCHANNEL__ **a9)
{
  ...
  *a9 = 0LL;
  ...
  {
    v22 = 0LL;
    v14 = ((__int64 (__fastcall *)(struct _DEVICE_OBJECT *, _QWORD, struct VMBCHANNEL__ **))qword_1C00A3BF0)(
            a2,
            0LL,
            &v22);
    if ( v14 < 0 )
      goto LABEL_10;
    ((void (__fastcall *)(struct VMBCHANNEL__ *, __int64))qword_1C00A3C60)(v22, 0x20000LL);
    ((void (__fastcall *)(struct VMBCHANNEL__ *, __int64, __int64))qword_1C00A3CD8)(v22, 256LL, 256LL);
    ((void (__fastcall *)(struct VMBCHANNEL__ *, struct _VMB_CHANNEL_STATE_CHANGE_CALLBACKS *))qword_1C00A3C70)(
      v22,
      v26);
    ((void (__fastcall *)(struct VMBCHANNEL__ *, void (*)(struct VMBCHANNEL__ *, struct VMBPACKETCOMPLETION__ *, void *, unsigned int, unsigned int), _QWORD))qword_1C00A3C68)(
      v22,
      v27,
      0LL);
    ((void (__fastcall *)(struct VMBCHANNEL__ *, __int64))qword_1C00A3CB8)(v22, a1);
    v14 = ((__int64 (__fastcall *)(struct VMBCHANNEL__ *, struct _GUID *, struct _GUID *, _QWORD))qword_1C00A3CE0)(
            v22,
            a3,
            a4,
            0LL);
    if ( v14 < 0
      || (((void (__fastcall *)(struct VMBCHANNEL__ *, _QWORD))qword_1C00A3CA8)(v22, 0LL),
          ((void (__fastcall *)(struct VMBCHANNEL__ *, const struct _UNICODE_STRING *))qword_1C00A3C50)(v22, a5),
          v14 = ((__int64 (__fastcall *)(struct VMBCHANNEL__ *))qword_1C00A3C20)(v22),
          v14 < 0) )
    {
LABEL_10:
      if ( v22 )
    ...
    {
      ((void (__fastcall *)(struct VMBCHANNEL__ *))qword_1C00A3CD0)(v22);
      *a9 = v22;
    }
  }
