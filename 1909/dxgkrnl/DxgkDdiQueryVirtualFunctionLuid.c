/*
 * XREFs of DxgkDdiQueryVirtualFunctionLuid @ 0x1C0210A20
 * Callers:
...
__int64 __fastcall DxgkDdiQueryVirtualFunctionLuid(_QWORD *a1, __int64 a2, __int64 a3, __int64 a4)
{
  __int64 v5; // rcx
  int v6; // edi
  ...
  if ( v7
    && (VirtualGpuByIndex = DXGVIRTUALGPUMANAGER::GetVirtualGpuByIndex(v7, (unsigned int)a3, a3),
        (a3 = (__int64)VirtualGpuByIndex) != 0) )
  {
  ...
  {
    v10 = WdLogNewEntry5_WdError(v7, a2, a3);
    *(_QWORD *)(v10 + 24) = v12[0];
    WdLogEvent5_WdError(v10);
    v9 = -1073741811;
  }
  if ( bTracingEnabled )
    VgpuTrace(1, v9, a1, L"DxgkDdiQueryVirtualFunctionLuid", (wchar_t *)L"%d", v6);
  return v9;
}
