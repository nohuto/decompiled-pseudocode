/*
 * XREFs of ?_MonitorOnOffTelemetry@MONITOR_MGR@@QEAAXAEBU_GUID@@W4Enum@MONITOR_ON_OFF_CALLER_ORIGIN@@@Z @ 0x1C015D240
 * Callers:
...
void __fastcall MONITOR_MGR::_MonitorOnOffTelemetry(__int64 a1, __int64 a2, char a3)
{
  ...
  v6 = (struct _FAST_MUTEX *)(a1 + 168);
  if ( a1 == -168 )
  {
    v14 = WdLogNewEntry5_WdAssertion(-168LL, a2);
    WdLogEvent5_WdAssertion(v14);
  }
  KeAcquireGuardedMutex(v6);
  v9 = a1 + 128;
  v10 = *(_QWORD *)(a1 + 128);
  if ( v10 != a1 + 128 )
  {
