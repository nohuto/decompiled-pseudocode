/*
 * XREFs of ?TdrUpdateDbgReport@@YA_NPEAU_TDR_RECOVERY_CONTEXT@@_N@Z @ 0x1C023EC00
 * Callers:
 ...
 *     ?TdrRetrieveSecondaryBucketingKey@@YAXPEAU_TDR_RECOVERY_CONTEXT@@PEAK@Z @ 0x1C023EB54 (-TdrRetrieveSecondaryBucketingKey@@YAXPEAU_TDR_RECOVERY_CONTEXT@@PEAK@Z.c)
...
char __fastcall TdrUpdateDbgReport(struct _TDR_RECOVERY_CONTEXT *a1, char a2)
{
  ...
  if ( !v8 || v3 )
  {
    ...
    TdrRetrieveSecondaryBucketingKey(a1, &v26);
    if ( v9 )
      v11 = *(_QWORD *)(v9 + 2560) == 0LL;
    else
      v11 = 0;
    if ( *((_DWORD *)a1 + 4) == 6 )
    ...
    if ( v9 )
      ...
      v13 = 0LL;
    v14 = WdDbgReportRecreate(v13, v12, a1, v10, v26, *((_QWORD *)a1 + 351), v11, v8);
    *((_QWORD *)a1 + 354) = v14;
    if ( !v14 )
    {
...
LABEL_21:
  ...
  if ( *((_QWORD *)a1 + 355) )
  {
    if ( *((_QWORD *)a1 + 356) )
    {
      ...
      {
        *((_DWORD *)a1 + 29) |= 0x80000000;
        v18 = WdLogNewEntry5_WdError(v24, v23, v25);
        *(_QWORD *)(v18 + 24) = a1;
        *(_QWORD *)(v18 + 32) = *((_QWORD *)a1 + 356);
        goto LABEL_21;
      }
    }
  }
