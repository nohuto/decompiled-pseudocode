/*
 * XREFs of ?ReleaseTargetModeSet@DXGK_VIDPN_INTERFACE_V1_IMPL@@YAJQEAUD3DKMDT_HVIDPN__@@QEAUD3DKMDT_HVIDPNTARGETMODESET__@@@Z @ 0x1C0101B90
 * Callers:
 *     <none>
 * Callees:
        ...
        const GUID *a3)
{
  ...
  if ( (*(_BYTE *)(&DxgkControlGuid_Context + 2) & 2) != 0 )
  {
    ...
    if ( (Microsoft_Windows_DxgKrnlEnableBits & 0x2000) != 0 )
      McTemplateK0q((__int64)this, &EventProfilerEnter, a3, 7049);
  }
  else
  {
    v33 = 0;
  }
  DXGETWPROFILER_BASE_PushProfilerEntry((__int64)&v31, 7049LL);
  ...
  *(_QWORD *)(v7 + 32) = this;
  ...
  if ( v11 )
  {
    ...
    if ( v12 )
    {
      v13 = (DMMVIDPNTARGET *)*((_QWORD *)v12 + 14);
      if ( !v13 )
      {
      ...
      if ( v15 == v11 )
      {
        DMMVIDPNTARGET::ReleaseModeSet(v13, (struct DMMVIDPNTARGETMODESET *)v12, v10);
        v17 = 0;
      }
      else
      {
