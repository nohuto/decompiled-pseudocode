/*
 * XREFs of ??0?$DoublyLinkedList@VDMMVIDPNSOURCEMODE@@U?$DoubleLinkedListElementDeleter@VDMMVIDPNSOURCEMODE@@@@@@QEAA@AEBV0@@Z @ 0x1C0009640
 * Callers:
  ...
  if ( v8 )
  {
    while ( 1 )
    {
      ...
      *PoolWithTag = &SetElement::`vftable';
      ...
      PoolWithTag[2] = 0LL;
      PoolWithTag[1] = 0LL;
      *((_DWORD *)PoolWithTag + 6) = *(_DWORD *)(v8 + 24);
      ...
      *PoolWithTag = &DMMVIDPNSOURCEMODE::`vftable'{for `IndexedSetElement<unsigned int>'};
      PoolWithTag[4] = &DMMVIDPNSOURCEMODE::`vftable'{for `ContainedBy<DMMVIDPNSOURCEMODESET>'};
      PoolWithTag[6] = &DMMVIDPNSOURCEMODE::`vftable'{for `SignedWithClassSignature<DMMVIDPNSOURCEMODE>'};
...
LABEL_20:
    ...
    v21 = WdLogNewEntry5_WdLowResource(v13, v12, 0LL, v14);
    *(_QWORD *)(v21 + 24) = 172LL;
