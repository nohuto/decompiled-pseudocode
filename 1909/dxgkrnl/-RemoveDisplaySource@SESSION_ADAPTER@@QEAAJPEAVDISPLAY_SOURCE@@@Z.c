/*
 * XREFs of ?RemoveDisplaySource@SESSION_ADAPTER@@QEAAJPEAVDISPLAY_SOURCE@@@Z @ 0x1C0148098
 * Callers:
...
__int64 __fastcall SESSION_ADAPTER::RemoveDisplaySource(SESSION_ADAPTER *this, struct DISPLAY_SOURCE *a2, __int64 a3)
{
  int v6; // ecx
  _QWORD *v7; // rbx
  __int64 v8; // rcx
