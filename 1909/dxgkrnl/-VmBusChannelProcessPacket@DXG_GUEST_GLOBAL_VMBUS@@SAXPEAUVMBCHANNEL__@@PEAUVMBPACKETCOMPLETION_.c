/*
 * XREFs of ?VmBusChannelProcessPacket@DXG_GUEST_GLOBAL_VMBUS@@SAXPEAUVMBCHANNEL__@@PEAUVMBPACKETCOMPLETION__@@PEAXII@Z @ 0x1C003CF70
 * Callers:
 *     <none>
 * Callees:
 ...
 *     ?VmBusSetGuestData@DXG_GUEST_GLOBAL_VMBUS@@SAXPEAUDXGKVMB_COMMAND_SETGUESTDATA@@@Z @ 0x1C003D9C0 (-VmBusSetGuestData@DXG_GUEST_GLOBAL_VMBUS@@SAXPEAUDXGKVMB_COMMAND_SETGUESTDATA@@@Z.c)
    ...
    if ( v10 )
    {
      ...
      else
      {
        ...
        if ( PoolWithTag )
        {
          ...
          v16[2].List.Flink = (struct _LIST_ENTRY *)((__int64 (__fastcall *)(struct _LIST_ENTRY *))qword_1C00A3C38)(a1);
          ExQueueWorkItem(v16, NormalWorkQueue);
          goto LABEL_13;
        }
        v19 = WdLogNewEntry5_WdLowResource(v13, v12, v14, v15);
        *(_QWORD *)(v19 + 24) = 9263LL;
