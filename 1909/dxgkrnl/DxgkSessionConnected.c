/*
 * XREFs of DxgkSessionConnected @ 0x1C01409D0
 * Callers:
 *     <none>
 * Callees:
 ...
 *     ?GetHdrPowerPolicyCalloutPending@DXGGLOBAL@@QEAA_NXZ @ 0x1C00245AC (-GetHdrPowerPolicyCalloutPending@DXGGLOBAL@@QEAA_NXZ.c)
