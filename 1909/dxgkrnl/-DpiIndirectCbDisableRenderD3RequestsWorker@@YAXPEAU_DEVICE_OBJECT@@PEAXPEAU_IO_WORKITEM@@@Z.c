/*
 * XREFs of ?DpiIndirectCbDisableRenderD3RequestsWorker@@YAXPEAU_DEVICE_OBJECT@@PEAXPEAU_IO_WORKITEM@@@Z @ 0x1C02AB0D0
 * Callers:
 *     <none>
 * Callees:
 ...
 *     ?Release@AUTO_PNPPOWER_LOCK@@QEAAXXZ @ 0x1C001DC7C (-Release@AUTO_PNPPOWER_LOCK@@QEAAXXZ.c)
 *     ?Release@AUTO_REMOVE_LOCK@@QEAAXXZ @ 0x1C001DCD8 (-Release@AUTO_REMOVE_LOCK@@QEAAXXZ.c)
...
void __fastcall DpiIndirectCbDisableRenderD3RequestsWorker(PVOID IoObject, PVOID Context, PIO_WORKITEM IoWorkItem)
{
  ...
  while ( 1 )
  {
    ...
    v4 = (char *)qword_1C00A2CF0;
    if ( qword_1C00A2CF0 == &qword_1C00A2CF0 )
      break;
    if ( *((void ***)qword_1C00A2CF0 + 1) != &qword_1C00A2CF0
      || (v5 = *(_QWORD *)qword_1C00A2CF0, *(void **)(*(_QWORD *)qword_1C00A2CF0 + 8LL) != qword_1C00A2CF0) )
    {
      __fastfail(3u);
    }
    qword_1C00A2CF0 = *(void **)qword_1C00A2CF0;
    *(_QWORD *)(v5 + 8) = &qword_1C00A2CF0;
