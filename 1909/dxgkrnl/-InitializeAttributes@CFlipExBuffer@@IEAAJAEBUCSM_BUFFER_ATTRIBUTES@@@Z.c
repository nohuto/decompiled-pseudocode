/*
 * XREFs of ?InitializeAttributes@CFlipExBuffer@@IEAAJAEBUCSM_BUFFER_ATTRIBUTES@@@Z @ 0x1C0012C54
 * Callers:
...
__int64 __fastcall CFlipExBuffer::InitializeAttributes(CFlipExBuffer *this, const struct CSM_BUFFER_ATTRIBUTES *a2)
{
  ...
  v5 = (*(__int64 (__fastcall **)(char *))(*((_QWORD *)Global + 38000) + 16LL))((char *)this + 248);
  if ( v5 >= 0 )
  {
    ...
    *((_QWORD *)this + 20) = *((_QWORD *)a2 + 14);
    ...
    if ( (v8 & 0x40) != 0
      && (v8 & 0x10) != 0
      && ((v10 = DXGGLOBAL::GetGlobal(v7, v6), (*(unsigned int (**)(void))(*((_QWORD *)v10 + 38000) + 128LL))())
       || (v13 = DXGGLOBAL::GetGlobal(v12, v11), (*(unsigned int (**)(void))(*((_QWORD *)v13 + 38000) + 216LL))())
