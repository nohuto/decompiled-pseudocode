/*
 * XREFs of ?ReleaseAnalogTokensAndGetUpdates@CTokenQueue@@QEAA_NIPEAUCSM_SURFACE_UPDATE@@IPEA_NPEAIPEAPEAVCToken@@@Z @ 0x1C005A588
 * Callers:
        ...
        struct CToken **a7)
{
  ...
  *v13 = this;
  ...
  while ( 1 )
  {
    ...
    if ( (*(int (__fastcall **)(_QWORD *, __int64, bool **))(*((_QWORD *)v12 - 1) + 176LL))((_QWORD *)v12 - 1, a2, &a5) < 0 )
    {
LABEL_10:
      ...
      do
      {
        ...
        else
        {
          *((_DWORD *)a3 + 7) = (*(__int64 (__fastcall **)(const struct CToken *))(*(_QWORD *)v22 + 112LL))(v22);
          ...
          (*(void (__fastcall **)(CompositionSurfaceObject *, _QWORD))(*((_QWORD *)Global + 38000) + 64LL))(v23, v24);
          *v21 = v22;
        }
        v18 = (_QWORD *)v30[0];
        if ( *(_QWORD **)(v30[0] + 8LL) != v30 )
