/*
 * XREFs of ?DdiSetPalette@ADAPTER_DISPLAY@@QEAAJPEBU_DXGKARG_SETPALETTE@@@Z @ 0x1C01FCFC8
 * Callers:
        ...
        const GUID *a3)
{
  ...
  if ( (*(_BYTE *)(&DxgkControlGuid_Context + 2) & 2) != 0 )
  {
    ...
    if ( (Microsoft_Windows_DxgKrnlEnableBits & 0x2000) != 0 )
      McTemplateK0q((__int64)this, &EventProfilerEnter, a3, 5017);
  }
  else
  {
    v32 = 0;
  }
  DXGETWPROFILER_BASE_PushProfilerEntry((__int64)&v30, 5017LL);
...
LABEL_16:
  ...
  v15 = (*(int (__fastcall **)(_QWORD, const struct _DXGKARG_SETPALETTE *))(*((_QWORD *)this + 2) + 416LL))(
  ...
  if ( (_DWORD)v15 )
  {
    v25 = WdLogNewEntry5_WdError(VidPnSourceId, v23, v22);
    *(_QWORD *)(v25 + 24) = v15;
