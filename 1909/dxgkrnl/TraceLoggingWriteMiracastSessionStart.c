/*
 * XREFs of TraceLoggingWriteMiracastSessionStart @ 0x1C0052BAC
 * Callers:
...
void TraceLoggingWriteMiracastSessionStart()
{
  ...
  {
    if ( TlgKeywordOn((TraceLoggingHProvider)&dword_1C00A1888, 0x800000000002uLL) )
    {
      v14 = v0[197];
      v30 = v0 + 28;
      v32 = &v14;
      ...
      v28 = (v11 >> 2) & 1;
      v73 = 4LL;
      TlgWrite((TraceLoggingHProvider)&dword_1C00A1888, &unk_1C0074454, v13, v12, 0x1Cu, &pData);
    }
  }
}
