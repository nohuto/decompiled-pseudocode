/*
 * XREFs of _DxgDbgBugcheckCallback @ 0x1C003F900
 * Callers:
 *     <none>
 * Callees:
        ...
        ULONG ReasonSpecificDataLength)
{
  ...
  {
    if ( KiBugCheckData == 278 && qword_1C00A4198 )
    {
      v4 = (unsigned int)(dword_1C00A4190 - 1);
      if ( dword_1C00A4190 != 1 )
      {
        do
        {
          if ( *(_BYTE *)(v4 + qword_1C00A4198) )
            break;
          v5 = (_DWORD)v4 == 1;
      ...
      v6 = v4 + 1;
      v7 = xmmword_1C00A2D18;
      ReasonSpecificData[4] = qword_1C00A4198;
    ...
    else
    {
      ...
      *((_OWORD *)ReasonSpecificData + 1) = xmmword_1C00A2D18;
      if ( v5 )
      {
