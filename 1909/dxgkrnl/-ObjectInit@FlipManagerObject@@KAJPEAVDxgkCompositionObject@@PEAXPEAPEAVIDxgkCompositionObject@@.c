/*
 * XREFs of ?ObjectInit@FlipManagerObject@@KAJPEAVDxgkCompositionObject@@PEAXPEAPEAVIDxgkCompositionObject@@@Z @ 0x1C00605D0
 * Callers:
 *     <none>
 * Callees:
 *     ??0FlipManagerObject@@IEAA@XZ @ 0x1C0060530 (--0FlipManagerObject@@IEAA@XZ.c)
 *     ?Initialize@CFlipManager@@IEAAJXZ @ 0x1C0061404 (-Initialize@CFlipManager@@IEAAJXZ.c)
 */
