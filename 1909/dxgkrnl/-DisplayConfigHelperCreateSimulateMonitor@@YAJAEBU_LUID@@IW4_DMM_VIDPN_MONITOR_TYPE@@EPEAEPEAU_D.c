/*
 * XREFs of ?DisplayConfigHelperCreateSimulateMonitor@@YAJAEBU_LUID@@IW4_DMM_VIDPN_MONITOR_TYPE@@EPEAEPEAU_DXGK_DISPLAY_SCENARIO_CONTEXT@@@Z @ 0x1C026E4E8
 * Callers:
        ...
        __int64 a6)
{
  ...
  if ( v11 )
  {
    ...
    v18 = COREADAPTERACCESS::AcquireExclusive(&v30, (unsigned int)(v17 + 2));
