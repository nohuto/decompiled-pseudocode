/*
 * XREFs of _BmlLogDiagnosticsPacket @ 0x1C0144B34
 * Callers:
 ...
 * Callees:
 *     ?GetFirstPath@DMMVIDPNTOPOLOGY@@QEBAPEAVDMMVIDPNPRESENTPATH@@XZ @ 0x1C00064F0 (-GetFirstPath@DMMVIDPNTOPOLOGY@@QEBAPEAVDMMVIDPNPRESENTPATH@@XZ.c)
