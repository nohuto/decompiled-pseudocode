/*
 * XREFs of McTemplateK0ppqqppqi @ 0x1C0044ED4
 * Callers:
...
ULONG McTemplateK0ppqqppqi(__int64 a1, const EVENT_DESCRIPTOR *a2, __int64 a3, ...)
{
  ...
  v19 = 4LL;
  v21 = 8LL;
  return McGenEventWrite((PMCGEN_TRACE_CONTEXT)&DxgkControlGuid_Context, a2, (LPCGUID)4, 9u, &EventData);
}
