/*
 * XREFs of DpiGdoDispatchInternalIoctl @ 0x1C00E7630
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall DpiGdoDispatchInternalIoctl(__int64 a1, IRP *a2)
{
  ...
  _D3DKMDT_VIDEO_OUTPUT_TECHNOLOGY v59; // [rsp+34h] [rbp-34h] BYREF
  ...
  if ( CurrentStackLocation->Parameters.Read.ByteOffset.LowPart == 2301967 )
  {
    ...
    if ( v52 >= 0 )
      goto LABEL_24;
LABEL_70:
    v56 = WdLogNewEntry5_WdError(v15, v14, v16);
    *(_QWORD *)(v56 + 24) = v7;
...
LABEL_46:
  ...
  {
    v54 = WdLogNewEntry5_WdError(0x80000000LL, v18, v19);
    *(_QWORD *)(v54 + 24) = v7;
...
LABEL_67:
  ...
  v20 = v65;
  v21 = ((_BYTE)v65 != D3DDDI_VSSLO_UNINITIALIZED ? v66 : 0) + *(_DWORD *)(v10 + 3664);
  if ( !v21 )
    goto LABEL_23;
  ...
  if ( !PoolWithTag )
  {
    ...
    v55 = WdLogNewEntry5_WdLowResource(v24, v23, v25, v26);
...
LABEL_66:
  ...
  LODWORD(v7) = DpiAcquireCoreSyncAccessSafe(v63, 0);
  if ( (int)v7 < 0 )
  {
  ...
  while ( *v28 != *(_QWORD *)(v10 + 3648) )
  {
    ...
    v29[16] = IsInternalVideoOutput(v59);
    v32 = *(_DWORD *)(v4 + 156);
    v33 = *(void **)(v10 + 3896);
    LOBYTE(v66) = 0;
    DmmIsPresentPathInClientVidPnTopology(v33, v32, v58, (unsigned __int8 *)&v66);
    if ( !(_BYTE)v66 )
    {
      if ( !*((_BYTE *)v28 + 944) )
        goto LABEL_20;
      ...
      LOBYTE(v65) = 0;
      if ( (int)DmmCanAddPresentPathToClientVidPn(v35, v34, v58, (unsigned __int8 *)&v65) < 0 || !(_BYTE)v65 )
        goto LABEL_20;
      v38 = 0;
      goto LABEL_27;
    }
...
LABEL_22:
  DpiReleaseCoreSyncAccessSafe(v63, 0);
  ExReleaseResourceLite((PERESOURCE)Size);
  KeLeaveCriticalRegion();
LABEL_23:
  DxgkReleaseSessionModeChangeLock();
