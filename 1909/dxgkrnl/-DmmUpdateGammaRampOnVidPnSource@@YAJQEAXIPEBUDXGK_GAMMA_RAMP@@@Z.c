/*
 * XREFs of ?DmmUpdateGammaRampOnVidPnSource@@YAJQEAXIPEBUDXGK_GAMMA_RAMP@@@Z @ 0x1C00D3184
 * Callers:
  ...
  if ( v11 )
  {
    ...
    if ( v13 )
    {
      ...
      *(_QWORD *)(v17 + 128) = a3;
      ...
      if ( v48 )
      {
        v24 = (DMMVIDPNTOPOLOGY *)(v48 + 96);
        for ( i = 0LL; ; ++i )
        {
          v47 = -1;
          v26 = DMMVIDPNTOPOLOGY::EnumPathTargetsFromSource(v24, v4, i, &v47);
          v6 = (DXGADAPTER *)v26;
          if ( v26 < 0 )
            break;
          if ( v47 == -1 )
          ...
          Path = DMMVIDPNTOPOLOGY::FindPath(v24, v4, v47);
          if ( !Path )
          {
