/*
 * XREFs of ?DmmGetMacrovisonSupportFromClientVidPnSource@@YAJQEAXIPEAU_D3DKMDT_VIDPN_PRESENT_PATH_COPYPROTECTION_SUPPORT@@@Z @ 0x1C02B3594
 * Callers:
  ...
  if ( v11 )
  {
    ...
    if ( v42 )
    {
      ...
      while ( 1 )
      {
        ...
        TargetById = DMMVIDEOPRESENTTARGETSET::GetTargetById((DMMVIDEOPRESENTTARGETSET *)v24, (unsigned int)v30);
        if ( TargetById )
        {
