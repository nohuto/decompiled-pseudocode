/*
 * XREFs of ?DxgkpQueryRegistry@@YAJPEAVDXGADAPTER@@PEAXI@Z @ 0x1C0145F88
 * Callers:
 ...
 *     __report_rangecheckfailure @ 0x1C0023380 (__report_rangecheckfailure.c)
 *     memset @ 0x1C0025440 (memset.c)
 *     ?RtlStringCbCatW@@YAJPEAG_KPEBG@Z @ 0x1C00345A4 (-RtlStringCbCatW@@YAJPEAG_KPEBG@Z.c)
 *     ?RtlStringCbCopyUnicodeString@@YAJPEAG_KPEBU_UNICODE_STRING@@@Z @ 0x1C003B7E8 (-RtlStringCbCopyUnicodeString@@YAJPEAG_KPEBU_UNICODE_STRING@@@Z.c)
 *     DpiGetPnpRegistryKeyName @ 0x1C0146420 (DpiGetPnpRegistryKeyName.c)
...
__int64 __fastcall DxgkpQueryRegistry(struct DXGADAPTER *a1, unsigned int *a2, __int64 a3)
{
  ...
  struct _UNICODE_STRING v58; // [rsp+30h] [rbp-D0h] BYREF
  ...
  _BYTE v68[40]; // [rsp+88h] [rbp-78h] BYREF
  unsigned __int16 v69[264]; // [rsp+B0h] [rbp-50h] BYREF
  unsigned __int16 v70[264]; // [rsp+2C0h] [rbp+1C0h] BYREF
  ...
  if ( (unsigned int)a3 >= 0x228 )
  {
    ...
    else
    {
      ...
      else
      {
        ...
        v13 = a2 + 134;
        a2[134] = v3 - 544;
        v14 = *(_QWORD *)(v12 + *((_QWORD *)a1 + 305) + 8);
        if ( (unsigned int)v11 <= 1 )
        {
          ...
          *(_QWORD *)v16 = *(_QWORD *)v15;
          v69[259] = 0;
          PnpRegistryKeyName = DpiGetPnpRegistryKeyName(v14, (unsigned int)((_DWORD)v11 != 1) + 2, &v58);
          ...
          {
            v28 = *(_QWORD *)&v58.Length;
            v29 = v69[0];
            v30 = v69;
            v31 = 0;
            LODWORD(v32) = 0;
            v33 = *(unsigned __int16 **)(*(_QWORD *)&v58.Length + 8LL);
            if ( v69[0] )
            {
              do
              {
              ...
              if ( v34 )
              {
                ...
                v69[v34] = 0;
                LODWORD(v5) = RtlStringCbCopyW(v70, 0x208uLL, *(size_t **)(v28 + 8));
                if ( (int)v5 < 0 )
                  goto LABEL_61;
                v49 = 260LL;
                v51 = v70;
                ...
                if ( (int)v5 < 0 || (LODWORD(v5) = RtlStringCbCatW(v70, v48, (size_t *)v69), (int)v5 < 0) )
                {
LABEL_61:
                  v39 = WdLogNewEntry5_WdWarning(v49, v48, v50);
                  *(_QWORD *)(v39 + 24) = (int)v5;
                  *(_QWORD *)(v39 + 32) = 2667LL;
                  goto LABEL_18;
                }
                v30 = &v69[v31 + 1];
                v33 = v70;
        ...
        if ( !a2[132] && (v7 & 1) == 0 )
        {
          ...
          else
          {
            *(_QWORD *)&v58.Length = 0LL;
            v58.Buffer = 0LL;
            LODWORD(v5) = IoQueryFullDriverPath(*(_QWORD *)(*(_QWORD *)(*(_QWORD *)(v14 + 64) + 40LL) + 32LL), &v58);
            if ( (int)v5 < 0 )
            {
LABEL_39:
              v39 = WdLogNewEntry5_WdWarning(v44, v43, v45);
              *(_QWORD *)(v39 + 24) = (int)v5;
              *(_QWORD *)(v39 + 32) = 2721LL;
              goto LABEL_18;
            }
            v46 = RtlStringCbCopyUnicodeString((char *)a2 + 544, (unsigned int)*v13, &v58);
            Buffer = v58.Buffer;
            LODWORD(v5) = v46;
            *v13 = v58.Length;
