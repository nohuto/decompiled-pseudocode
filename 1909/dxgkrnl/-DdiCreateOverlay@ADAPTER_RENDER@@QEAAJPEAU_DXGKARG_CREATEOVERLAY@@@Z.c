/*
 * XREFs of ?DdiCreateOverlay@ADAPTER_RENDER@@QEAAJPEAU_DXGKARG_CREATEOVERLAY@@@Z @ 0x1C01F8C34
 * Callers:
        ...
        const GUID *a3)
{
  ...
  DXGETWPROFILER_BASE_PushProfilerEntry((__int64)&v30, 5032LL);
...
LABEL_16:
  ...
  v15 = (*(int (__fastcall **)(_QWORD, struct _DXGKARG_CREATEOVERLAY *))(*((_QWORD *)this + 2) + 568LL))(
  ...
  v21[3] = v15;
  v21[4] = a2->OverlayInfo.hAllocation;
  v21[5] = a2->hOverlay;
