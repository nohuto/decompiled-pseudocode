/*
 * XREFs of McTemplateK0pqtqqqqqqqq @ 0x1C0036BD4
 * Callers:
 *     ?CreateNewPostCompositionConfig@DISPLAY_SOURCE@@AEAAXEPEBUtagRECT@@0@Z @ 0x1C01F0FC4 (-CreateNewPostCompositionConfig@DISPLAY_SOURCE@@AEAAXEPEBUtagRECT@@0@Z.c)
 * Callees:
