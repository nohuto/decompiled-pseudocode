/*
 * XREFs of ?RemoveProcessEntry@DripsBlockerTrackingHelper@@QEAAJ_KPEADPEAU_EPROCESS@@W4_DXGKETW_PROFILER_TYPE@@@Z @ 0x1C0245BB4
 * Callers:
 ...
 *     ?UpdateLastActiveEntry@DripsBlockerTrackingHelper@@AEAAXII@Z @ 0x1C0246B3C (-UpdateLastActiveEntry@DripsBlockerTrackingHelper@@AEAAXII@Z.c)
 */
