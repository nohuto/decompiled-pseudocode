/*
 * XREFs of ?BmlPickColorSpaceAndWireFormat@@YAJPEBUBML_VIDPN_PATH_ORDER@@W4DXGK_DIAG_CCD_BML_ORIGIN@@PEAVDMMVIDPN@@@Z @ 0x1C0126EC8
 * Callers:
 ...
 *     ?ModeSupportsHighDepthColorFormat@@YA_NPEAVDMMVIDPNTARGETMODE@@PEAT_D3DKMDT_WIRE_FORMAT_AND_PREFERENCE@@@Z @ 0x1C02C22AC (-ModeSupportsHighDepthColorFormat@@YA_NPEAVDMMVIDPNTARGETMODE@@PEAT_D3DKMDT_WIRE_FORMAT_AND_PREF.c)
 */
...
__int64 __fastcall BmlPickColorSpaceAndWireFormat(unsigned __int8 *a1, int a2, __int64 a3)
{
  ...
  unsigned int v92; // [rsp+28h] [rbp-40h] BYREF
  ...
  char v99; // [rsp+B0h] [rbp+48h] BYREF
  int v100; // [rsp+B8h] [rbp+50h]
  __int64 v101; // [rsp+C0h] [rbp+58h]
  char v102; // [rsp+C8h] [rbp+60h] BYREF
  ...
  for ( i = (DMMVIDPNTOPOLOGY *)(a3 + 96); ; i = (DMMVIDPNTOPOLOGY *)(v4 + 96) )
  {
    ...
    IsMonitorAndLinkHDRCapable = MonitorIsMonitorAndLinkHDRCapable(
                                   *(struct HDXGMONITOR__ **)(*(_QWORD *)(v17 + 96) + 112LL),
                                   &v92);
    ...
    IsAdvancedColorEnabled = MonitorIsAdvancedColorEnabled(
                               *(_QWORD *)(*(_QWORD *)(*((_QWORD *)v13 + 12) + 96LL) + 112LL),
                               &v99);
    ...
    if ( !v43 )
    {
      v44 = *(_DWORD *)(v42 + 204);
      v45 = *(_DWORD *)(v42 + 208);
      if ( (unsigned __int8)BmlDoesTargetModeSupportWireFormat(v95, v44) )
      {
        v90 = v44;
