/*
 * XREFs of ?BmlGetTargetModePreferenceOnMonitor@@YA?AW4BML_MONITOR_SOURCE_MODE_PREFERENCE@@PEBVDMMVIDPNTARGETMODE@@EPEAVDMMVIDEOPRESENTTARGET@@@Z @ 0x1C013B960
 * Callers:
 ...
 *     MonitorGetNextMonitorSourceMode @ 0x1C013BCF0 (MonitorGetNextMonitorSourceMode.c)
 *     BmlGetMonitorModePreference @ 0x1C013BE0C (BmlGetMonitorModePreference.c)
 *     BmlIsEDIDCapableOutputTechonology @ 0x1C013C034 (BmlIsEDIDCapableOutputTechonology.c)
 */
...
__int64 __fastcall BmlGetTargetModePreferenceOnMonitor(__int64 a1, __int64 a2, __int64 a3)
{
  ...
  while ( 1 )
  {
    ...
    if ( NextMonitorSourceMode < 0 )
    {
      v3 = v17;
LABEL_33:
      v16 = (_QWORD *)WdLogNewEntry5_WdError(v10, a2, a3);
      v16[3] = v3;
      v16[4] = *(_QWORD *)(a3 + 112);
      v16[5] = v12;
