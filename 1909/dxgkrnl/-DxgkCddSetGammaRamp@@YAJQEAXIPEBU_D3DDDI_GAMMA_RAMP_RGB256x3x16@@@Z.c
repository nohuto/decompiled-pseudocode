/*
 * XREFs of ?DxgkCddSetGammaRamp@@YAJQEAXIPEBU_D3DDDI_GAMMA_RAMP_RGB256x3x16@@@Z @ 0x1C00D3D80
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall DxgkCddSetGammaRamp(struct DXGADAPTER *a1, unsigned int a2, const GUID *a3)
{
  ...
  __int64 v23; // rcx
  __int64 v24; // r8
  DXGK_GAMMA_RAMP *v25; // rbx
  DXGK_GAMMA_RAMP *v26; // rax
  __int64 v27; // rdx
  __int64 v28; // rcx
  __int64 v29; // r8
  __int64 v30; // r9
...
LABEL_33:
  ...
  if ( !a3 )
    goto LABEL_13;
  v26 = (DXGK_GAMMA_RAMP *)operator new[](0x30uLL, 0x4B677844u, PagedPool);
  v25 = v26;
  if ( v26 )
  {
    *((_WORD *)v26 + 20) = 0;
  ...
  LODWORD(v11) = DXGK_GAMMA_RAMP::Initialize(v25, D3DDDI_GAMMARAMP_RGB256x3x16, a3);
  if ( (int)v11 >= 0 )
  {
LABEL_13:
    ...
    if ( PrimaryDisplaySource )
    {
      do
      {
        ...
        if ( *((_BYTE *)v35[319] + 235) == (_BYTE)v36 )
          ...
          v37 = COREADAPTERACCESS::AcquireExclusive(&v55, (unsigned int)(v36 + 1));
        updated = v37;
        if ( v37 >= 0 )
        {
          ADAPTER_DISPLAY::SetGdiGammaRamp(v35[319], v34, v25);
          updated = ADAPTER_DISPLAY::UpdateGammaRamp((DXGADAPTER **)v35[319], v34);
          if ( updated < 0 )
  ...
  if ( v25 )
    ReferenceCounted::Release(v25, v31, v32);
LABEL_23:
  if ( v49[0] )
