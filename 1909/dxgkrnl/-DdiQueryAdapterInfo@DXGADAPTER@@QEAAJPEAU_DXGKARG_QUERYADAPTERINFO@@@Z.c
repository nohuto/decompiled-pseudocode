/*
 * XREFs of ?DdiQueryAdapterInfo@DXGADAPTER@@QEAAJPEAU_DXGKARG_QUERYADAPTERINFO@@@Z @ 0x1C00E2C84
 * Callers:
 *     DXGADAPTER_DdiQueryAdapterInfo @ 0x1C00232C0 (DXGADAPTER_DdiQueryAdapterInfo.c)
