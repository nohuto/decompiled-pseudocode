/*
 * XREFs of ?DdiSetVirtualGpuVmBus@ADAPTER_RENDER@@QEAAJPEAU_DXGKARG_SETVIRTUALGPUVMBUS@@@Z @ 0x1C0214A2C
 * Callers:
        ...
        const GUID *a3)
{
  ...
  DXGETWPROFILER_BASE_PushProfilerEntry((__int64)&v29, 5104LL);
...
LABEL_16:
  ...
  v15 = (*(int (__fastcall **)(_QWORD, struct _DXGKARG_SETVIRTUALGPUVMBUS *))(*(_QWORD *)(*((_QWORD *)this + 2) + 928LL)
                                                                            + 120LL))(
