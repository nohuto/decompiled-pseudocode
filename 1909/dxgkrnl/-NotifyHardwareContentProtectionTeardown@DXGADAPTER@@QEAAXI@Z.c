/*
 * XREFs of ?NotifyHardwareContentProtectionTeardown@DXGADAPTER@@QEAAXI@Z @ 0x1C00332CC
 * Callers:
...
LABEL_3:
  ...
  *((_DWORD *)PoolWithTag + 3) = PsGetCurrentProcessSessionId(v6, v5);
  v9[2] = *(_QWORD *)((char *)this + 276);
  v11 = (struct _DEVICE_OBJECT *)*((_QWORD *)this + 24);
