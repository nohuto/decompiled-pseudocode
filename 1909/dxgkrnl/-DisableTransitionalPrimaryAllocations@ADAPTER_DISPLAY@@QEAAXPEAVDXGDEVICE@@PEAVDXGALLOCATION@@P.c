/*
 * XREFs of ?DisableTransitionalPrimaryAllocations@ADAPTER_DISPLAY@@QEAAXPEAVDXGDEVICE@@PEAVDXGALLOCATION@@PEAVCOREDEVICEACCESS@@@Z @ 0x1C01F174C
 * Callers:
        ...
        struct COREDEVICEACCESS *a4)
{
  ...
  while ( a3 )
  {
    ...
    if ( (v25 & 0x10) != 0 )
    {
      ...
      *(_QWORD *)(v26 + 24) = 3446LL;
      WdLogEvent5_WdAssertion(v26);
    }
    if ( ADAPTER_DISPLAY::GetVidPnSourceOwner(this, v18) == a2 )
    {
