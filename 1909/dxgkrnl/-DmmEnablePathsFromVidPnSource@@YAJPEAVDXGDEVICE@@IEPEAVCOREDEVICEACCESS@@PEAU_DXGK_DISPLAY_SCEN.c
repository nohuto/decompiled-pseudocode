/*
 * XREFs of ?DmmEnablePathsFromVidPnSource@@YAJPEAVDXGDEVICE@@IEPEAVCOREDEVICEACCESS@@PEAU_DXGK_DISPLAY_SCENARIO_CONTEXT@@@Z @ 0x1C00C7454
 * Callers:
...
LABEL_10:
    ...
    *(_QWORD *)(v14 + 32) = v13;
    ...
    v39[8] = 1 << v6;
    v15 = VIDPN_MGR::SetTimingsFromVidPn(v13, 0LL, 5LL, 0LL, v39, v37, 0, 0LL, 0LL);
    v16 = v15;
    if ( v15 < 0 )
    {
      v39[20] = -1;
