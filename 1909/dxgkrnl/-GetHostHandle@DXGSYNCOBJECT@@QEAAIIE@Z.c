/*
 * XREFs of ?GetHostHandle@DXGSYNCOBJECT@@QEAAIIE@Z @ 0x1C0269C04
 * Callers:
 ...
 *     ?VmBusSubmitSignalToHwQueueHelper@@YAJPEAVDXGPROCESS@@_NIIPEBI2PEB_KPEAI4PEA_K@Z @ 0x1C022A5A0 (-VmBusSubmitSignalToHwQueueHelper@@YAJPEAVDXGPROCESS@@_NIIPEBI2PEB_KPEAI4PEA_K@Z.c)
