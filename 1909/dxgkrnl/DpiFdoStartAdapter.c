/*
 * XREFs of DpiFdoStartAdapter @ 0x1C01631F8
 * Callers:
 ...
 *     ?DpiFdoSetAdapterLuid@@YAJPEAU_FDO_CONTEXT@@@Z @ 0x1C001F320 (-DpiFdoSetAdapterLuid@@YAJPEAU_FDO_CONTEXT@@@Z.c)
 ...
 *     DpiFdoIsCompatibleWithHighResolutionBoot @ 0x1C0183A98 (DpiFdoIsCompatibleWithHighResolutionBoot.c)
    ...
    if ( (*v85 & 1) != 0 && *(int *)(v9 + 3912) >= 0x2000 && !*(_BYTE *)(v9 + 1159) )
    {
      if ( (v15 & 8) != 0 )
      {
        wil_details_FeaturePropertyCache_ReportUsageToService(
          ...
          17586977LL,
          (const struct FEATURE_LOGGED_TRAITS *)&unk_1C0081F24,
          0,
          v173);
      }
      else
      {
        wil_details_FeaturePropertyCache_ReportUsageToService(
          ...
          15689327LL,
          (const struct FEATURE_LOGGED_TRAITS *)&unk_1C0081F1C,
          1,
          v173);
        *(_BYTE *)(v9 + 3905) |= 0x10u;
      }
