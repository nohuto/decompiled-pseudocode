/*
 * XREFs of DxgkOpenSyncObjectNtHandleFromName @ 0x1C02537D0
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall DxgkOpenSyncObjectNtHandleFromName(ULONG64 a1, __int64 a2, const GUID *a3)
{
  __int64 v4; // r8
  ULONG64 v5; // rax
  ULONG64 v6; // rdx
  ...
  if ( (*(_BYTE *)(&DxgkControlGuid_Context + 2) & 2) != 0 )
  {
    ...
    if ( (Microsoft_Windows_DxgKrnlEnableBits & 0x2000) != 0 )
      McTemplateK0q(a1, &EventProfilerEnter, a3, 2204);
  }
  else
  {
    v14 = 0;
  }
  DXGETWPROFILER_BASE_PushProfilerEntry((__int64)&v12, 2204LL);
  v5 = a1;
  ...
  v16 = *(_QWORD *)(v5 + 16);
  LOBYTE(v4) = 1;
  v7 = ObOpenObjectByName(*((_QWORD *)&v15 + 1), g_pDxgkSharedSyncObjectType, v4, 0LL, v15, 0LL, &v17);
  if ( v7 >= 0 )
  {
    v8 = (_QWORD *)(a1 + 16);
