/*
 * XREFs of ?DestroyCopyProtection@ADAPTER_DISPLAY@@QEAAJII@Z @ 0x1C01F138C
 * Callers:
 ...
 *     ??_GDXGCOPYPROTECTION@@QEAAPEAXI@Z @ 0x1C0035DE0 (--_GDXGCOPYPROTECTION@@QEAAPEAXI@Z.c)
 ...
 *     ?FindCopyProtection@ADAPTER_DISPLAY@@QEAAPEAVDXGCOPYPROTECTION@@IIPEAVDXGPROCESS@@@Z @ 0x1C01F22B8 (-FindCopyProtection@ADAPTER_DISPLAY@@QEAAPEAVDXGCOPYPROTECTION@@IIPEAVDXGPROCESS@@@Z.c)
 */
