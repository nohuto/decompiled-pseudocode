/*
 * XREFs of DxgkSetGammaRamp @ 0x1C0233830
 * Callers:
 *     <none>
 * Callees:
 *     ??0DXGK_GAMMA_RAMP@@QEAA@XZ @ 0x1C0002624 (--0DXGK_GAMMA_RAMP@@QEAA@XZ.c)
...
LABEL_8:
  ...
  if ( v36 )
  {
    LODWORD(v19) = DXGK_GAMMA_RAMP::Initialize(v36, v58[2], 0LL);
    if ( (int)v19 >= 0 )
    {
