/*
 * XREFs of ?AddTarget@DMMVIDPNTARGETSET@@QEAAJV?$auto_ptr@VDMMVIDPNTARGET@@@@@Z @ 0x1C01017F4
 * Callers:
 ...
 * Callees:
 *     ??$Add@VDMMVIDPNTARGET@@@?$IndexedSet@VDMMVIDPNTARGET@@@@QEAA?AW4SETSTATUS@0@PEAVDMMVIDPNTARGET@@@Z @ 0x1C0009CCC (--$Add@VDMMVIDPNTARGET@@@-$IndexedSet@VDMMVIDPNTARGET@@@@QEAA-AW4SETSTATUS@0@PEAVDMMVIDPNTARGET@.c)
