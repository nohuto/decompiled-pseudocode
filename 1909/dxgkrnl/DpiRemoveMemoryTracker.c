/*
 * XREFs of DpiRemoveMemoryTracker @ 0x1C0050A08
 * Callers:
 *     ?DxgkFreeMemoryTracker@@YAXQEAXPEAUDXG_DRIVER_MEMORY_TRACKER@@@Z @ 0x1C003E37C (-DxgkFreeMemoryTracker@@YAXQEAXPEAUDXG_DRIVER_MEMORY_TRACKER@@@Z.c)
 *     DxgkFreeContiguousMemoryCB @ 0x1C003EAA0 (DxgkFreeContiguousMemoryCB.c)
 ...
 *     DpiUnmapMemoryTrackerFromIoMmu @ 0x1C0050CB4 (DpiUnmapMemoryTrackerFromIoMmu.c)
 */
