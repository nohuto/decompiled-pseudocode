/*
 * XREFs of ?EmitSleepStudyBlockerTelemetry@DripsBlockerTrackingHelper@@AEAAXEAEB_KPEAU_UNICODE_STRING@@I@Z @ 0x1C0242FF4
 * Callers:
        ...
        unsigned int a5)
{
  ...
  if ( dword_1C00A1888 > 5u )
  {
    if ( TlgKeywordOn((TraceLoggingHProvider)&dword_1C00A1888, 0x400000002000uLL) )
    {
      ...
      v15 = 50331648LL;
      v44 = 8LL;
      TlgWrite((TraceLoggingHProvider)&dword_1C00A1888, &unk_1C00736AD, 0LL, v6, 0x10u, &pData);
    }
  }
}
