/*
 * XREFs of DxgGetCaptureAddressCB @ 0x1C0231280
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall DxgGetCaptureAddressCB(unsigned int *a1)
{
  ...
  *((_QWORD *)a1 + 1) = 0LL;
  ...
  if ( (_BYTE)v10 != 5 )
  {
    v11 = WdLogNewEntry5_WdError(v10, v9, (*a1 >> 25) & 0x60);
    *(_QWORD *)(v11 + 24) = 267LL;
...
LABEL_8:
  ...
  if ( !v17 )
  {
    v19 = *(_QWORD *)(*(_QWORD *)(*(_QWORD *)(*(_QWORD *)(v26[1].Count + 16) + 16LL) + 192LL) + 64LL);
    v20 = *(_QWORD *)(v19 + 40);
    if ( *(_DWORD *)(v20 + 28) >= 0x2003u )
    {
      v21 = (_QWORD *)WdLogNewEntry5_WdCriticalError(v19, v20);
      v21[3] = 275LL;
      v21[4] = 20LL;
      v21[5] = *(_QWORD *)(*(_QWORD *)(v26[1].Count + 16) + 16LL);
      v21[6] = 0LL;
      v21[7] = 0LL;
  ...
  {
    (*(void (__fastcall **)(_QWORD, _QWORD, unsigned int *, unsigned int *, _QWORD))(*(_QWORD *)(*(_QWORD *)(*(_QWORD *)(v18[1].Count + 16) + 544LL)
                                                                                               + 8LL)
                                                                                   + 216LL))(
      *(_QWORD *)(*(_QWORD *)(v18[1].Count + 16) + 552LL),
      *(_QWORD *)(Count + 8),
      a1 + 1,
      a1 + 2,
      0LL);
