/*
 * XREFs of ?CleanupPresentHistoryTokenQueue@ADAPTER_RENDER@@QEAAXXZ @ 0x1C014E7DC
 * Callers:
...
void __fastcall ADAPTER_RENDER::CleanupPresentHistoryTokenQueue(struct _KTHREAD **this)
{
  ...
  DXGAUTOPUSHLOCK::DXGAUTOPUSHLOCK((DXGAUTOPUSHLOCK *)v7, this + 92, 0);
  ...
  if ( CurrentProcessSessionId < *((_DWORD *)this + 190) )
  {
    ...
    v6 = (DXGPRESENTHISTORYTOKENQUEUE *)*((_QWORD *)this[96] + CurrentProcessSessionId);
    if ( v6 )
    {
      DXGPRESENTHISTORYTOKENQUEUE::`scalar deleting destructor'(v6);
      *((_QWORD *)this[96] + v5) = 0LL;
    }
  }
