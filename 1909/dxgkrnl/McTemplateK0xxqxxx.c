/*
 * XREFs of McTemplateK0xxqxxx @ 0x1C0049EE4
 * Callers:
...
ULONG McTemplateK0xxqxxx(__int64 a1, __int64 a2, const GUID *a3, ...)
{
  ...
  v14 = 8LL;
  v16 = 8LL;
  return McGenEventWrite((PMCGEN_TRACE_CONTEXT)&DxgkControlGuid_Context, &TrackedWorkloadDeadline, a3, 7u, &EventData);
}
