/*
 * XREFs of ?DdiRenderKm@ADAPTER_RENDER@@QEAAJPEAXPEAU_DXGKARG_RENDER@@@Z @ 0x1C00E3790
 * Callers:
...
__int64 __fastcall ADAPTER_RENDER::DdiRenderKm(ADAPTER_RENDER *this, void *a2, const GUID *a3)
{
  ...
  if ( (*(_BYTE *)(&DxgkControlGuid_Context + 2) & 2) != 0 )
  {
    ...
    if ( (Microsoft_Windows_DxgKrnlEnableBits & 0x2000) != 0 )
      McTemplateK0q((__int64)this, &EventProfilerEnter, a3, 5045);
  }
  else
  {
    v34 = 0;
  }
  DXGETWPROFILER_BASE_PushProfilerEntry((__int64)&v32, 5045LL);
...
LABEL_16:
  ...
  v17 = (*(int (__fastcall **)(void *, const GUID *))(*((_QWORD *)this + 2) + 664LL))(a2, a3);
  if ( v36[0] )
  ...
  v23[3] = v17;
  v23[4] = a2;
  v23[5] = *(_QWORD *)&a3[1].Data1;
  v23[6] = *(unsigned int *)a3[1].Data4;
  v26 = *(_QWORD *)&a3[3].Data1;
  v23[7] = v26;
  if ( (unsigned int)(v17 + 1073741816) > 0xF || (v26 = 32801LL, !_bittest((const int *)&v26, v17 + 1073741816)) )
  {
    if ( (_DWORD)v17 != -1073741592 && (_DWORD)v17 != -1071775743 && (_DWORD)v17 != -1071775232 && (_DWORD)v17 )
    {
      v27 = WdLogNewEntry5_WdError(v26, v24, v25);
      *(_QWORD *)(v27 + 24) = v17;
