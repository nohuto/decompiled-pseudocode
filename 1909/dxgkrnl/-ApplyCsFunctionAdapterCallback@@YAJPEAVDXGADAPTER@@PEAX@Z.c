/*
 * XREFs of ?ApplyCsFunctionAdapterCallback@@YAJPEAVDXGADAPTER@@PEAX@Z @ 0x1C025D8F0
 * Callers:
 *     <none>
 * Callees:
 ...
 *     ?SetCsStartRunningTime@DXGPROCESS@@QEAAXI_K@Z @ 0x1C00447DC (-SetCsStartRunningTime@DXGPROCESS@@QEAAXI_K@Z.c)
