/*
 * XREFs of DpReadSpbResource @ 0x1C02ADB00
 * Callers:
 *     <none>
 * Callees:
 *     DpiValidateSpbResource @ 0x1C02AE1E4 (DpiValidateSpbResource.c)
 */
        ...
        PIO_STATUS_BLOCK a7)
{
  ...
  result = DpiValidateSpbResource(a1, a2, (unsigned int)&DpReadSpbResource, 0, (__int64)&v21);
  if ( (int)result >= 0 )
  {
    v15 = v21;
    if ( !Ptr )
      Ptr = v21[7].Ptr;
    LODWORD(Ptr) = ZwReadFile(v21[5].Ptr, Ptr, 0LL, 0LL, IoStatusBlock, a4, Length, ByteOffset, 0LL);
    if ( (_DWORD)Ptr == 259 )
    {
      if ( v10 )
        goto LABEL_17;
