/*
 * XREFs of ?DmmUpdateCopyProtectionOnAllClientVidPnPathsFromSource@@YAJQEAXIW4_D3DKMDT_VIDPN_PRESENT_PATH_COPYPROTECTION_TYPE@@I@Z @ 0x1C0129C74
 * Callers:
...
LABEL_22:
  ...
  if ( v12 )
  {
    ...
    if ( v49 )
    {
      ...
      {
        v52 = -1;
        v21 = DMMVIDPNTOPOLOGY::EnumPathTargetsFromSource(v19, (unsigned int)v6, v20, &v52);
        v25 = v21;
        if ( v21 < 0 )
        {
        ...
        if ( v52 == -1 )
          goto LABEL_19;
        Path = DMMVIDPNTOPOLOGY::FindPath((DMMVIDPNTOPOLOGY *)v19, v6, v52);
        if ( !Path )
        {
        ...
        if ( v40 == -1071774970 )
        {
          v46 = (_QWORD *)WdLogNewEntry5_WdDmmEvent(v42, v41);
          v46[3] = v5;
          v46[4] = v6;
          v46[5] = v52;
          v46[6] = a1;
