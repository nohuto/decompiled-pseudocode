/*
 * XREFs of ?DxgkDestroySynchronizationObjectImpl@@YAJPEBU_D3DKMT_DESTROYSYNCHRONIZATIONOBJECT@@H@Z @ 0x1C00F426C
 * Callers:
 *     DxgkDestroySynchronizationObject @ 0x1C00F4250 (DxgkDestroySynchronizationObject.c)
