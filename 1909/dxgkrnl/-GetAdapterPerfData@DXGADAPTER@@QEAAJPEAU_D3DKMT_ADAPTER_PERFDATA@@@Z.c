/*
 * XREFs of ?GetAdapterPerfData@DXGADAPTER@@QEAAJPEAU_D3DKMT_ADAPTER_PERFDATA@@@Z @ 0x1C01ED26C
 * Callers:
...
__int64 __fastcall DXGADAPTER::GetAdapterPerfData(DXGADAPTER *this, struct _D3DKMT_ADAPTER_PERFDATA *a2, __int64 a3)
{
    ...
    && (PhysicalAdapterIndex = a2->PhysicalAdapterIndex, (unsigned int)PhysicalAdapterIndex < *((_DWORD *)this + 64)) )
  {
    ...
    v6 = *((_QWORD *)this + 305) + 352 * PhysicalAdapterIndex;
    ...
    else
    {
      ...
      *(_QWORD *)&v18.Flags.0 = 0LL;
      ...
      v10 = DXGADAPTER::DdiQueryAdapterInfo(this, &v18, (const GUID *)v8.QuadPart);
      v14 = v10;
      if ( v10 < 0 )
      {
