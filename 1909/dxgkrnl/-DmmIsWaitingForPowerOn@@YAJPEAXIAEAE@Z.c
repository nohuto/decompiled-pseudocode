/*
 * XREFs of ?DmmIsWaitingForPowerOn@@YAJPEAXIAEAE@Z @ 0x1C0158B90
 * Callers:
 ...
 *     ?IsPathFromSourcePoweredOff@DMMVIDPN@@QEBAEI@Z @ 0x1C0158CA0 (-IsPathFromSourcePoweredOff@DMMVIDPN@@QEBAEI@Z.c)
 */
