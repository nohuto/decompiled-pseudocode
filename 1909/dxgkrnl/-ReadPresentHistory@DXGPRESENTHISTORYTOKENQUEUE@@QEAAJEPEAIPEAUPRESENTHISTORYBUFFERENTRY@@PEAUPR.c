/*
 * XREFs of ?ReadPresentHistory@DXGPRESENTHISTORYTOKENQUEUE@@QEAAJEPEAIPEAUPRESENTHISTORYBUFFERENTRY@@PEAUPRESENTHISTORYBITS@@@Z @ 0x1C000B740
 * Callers:
        ...
        struct PRESENTHISTORYBITS *a5)
{
  ...
  if ( a3 && a4 )
  {
    ...
    *((_DWORD *)this + 4) = ((_WORD)v15 + (_WORD)v24 + (_WORD)v10) & 0x7FF;
    *a3 = v15 + v24;
