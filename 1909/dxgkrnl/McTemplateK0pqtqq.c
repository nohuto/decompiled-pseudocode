/*
 * XREFs of McTemplateK0pqtqq @ 0x1C0035958
 * Callers:
 *     DpIndicateChildStatus @ 0x1C0049FB0 (DpIndicateChildStatus.c)
 *     DpiMiracastIoCompleteRoutine @ 0x1C004CE60 (DpiMiracastIoCompleteRoutine.c)
...
ULONG McTemplateK0pqtqq(__int64 a1, const EVENT_DESCRIPTOR *a2, const GUID *a3, ...)
{
