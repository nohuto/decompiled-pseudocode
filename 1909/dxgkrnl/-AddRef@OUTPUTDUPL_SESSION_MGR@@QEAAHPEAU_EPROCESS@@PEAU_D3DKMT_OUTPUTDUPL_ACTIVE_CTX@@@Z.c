/*
 * XREFs of ?AddRef@OUTPUTDUPL_SESSION_MGR@@QEAAHPEAU_EPROCESS@@PEAU_D3DKMT_OUTPUTDUPL_ACTIVE_CTX@@@Z @ 0x1C02713A8
 * Callers:
 ...
 *     ?TriggerLowBoxActiveContextWNF@OUTPUTDUPL_SESSION_MGR@@AEAAJXZ @ 0x1C027585C (-TriggerLowBoxActiveContextWNF@OUTPUTDUPL_SESSION_MGR@@AEAAJXZ.c)
 */
...
LABEL_12:
    ...
    if ( v9 < *(_DWORD *)this || v7 )
    {
      ...
      if ( v19 && v19 != a2 )
      {
        v20 = WdLogNewEntry5_WdAssertion(v6, v10);
        *(_QWORD *)(v20 + 24) = 4240LL;
      ...
      if ( v8 != -1 )
      {
        ...
        if ( *(_DWORD *)&v12[v18] )
        {
          v21 = WdLogNewEntry5_WdAssertion(v6, v10);
          *(_QWORD *)(v21 + 24) = 4245LL;
