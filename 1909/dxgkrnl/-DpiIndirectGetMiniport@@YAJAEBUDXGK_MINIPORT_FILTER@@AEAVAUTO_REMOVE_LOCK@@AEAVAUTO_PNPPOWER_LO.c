/*
 * XREFs of ?DpiIndirectGetMiniport@@YAJAEBUDXGK_MINIPORT_FILTER@@AEAVAUTO_REMOVE_LOCK@@AEAVAUTO_PNPPOWER_LOCK@@PEAPEAU_FDO_CONTEXT@@@Z @ 0x1C02AB668
 * Callers:
 ...
 *     ?Acquire@AUTO_REMOVE_LOCK@@QEAAJXZ @ 0x1C001D994 (-Acquire@AUTO_REMOVE_LOCK@@QEAAJXZ.c)
        ...
        struct _FDO_CONTEXT **a4)
{
  ...
  PVOID v18; // [rsp+50h] [rbp-20h] BYREF
  ...
  v7 = qword_1C00A2778;
  v14 = 0;
  if ( (__int64 *)qword_1C00A2778 == &qword_1C00A2778 )
    goto LABEL_33;
  do
  {
...
LABEL_27:
  ...
  while ( (__int64 *)v7 != &qword_1C00A2778 );
  v5 = v15;
