/*
 * XREFs of ?GetDisplayOnlyDriverIgnoreMonitorFreqCheck@ADAPTER_DISPLAY@@QEBAHXZ @ 0x1C0055F38
 * Callers:
 ...
 * Callees:
 *     ?SupportHWVSync@DXGADAPTER@@QEBAEXZ @ 0x1C0006694 (-SupportHWVSync@DXGADAPTER@@QEBAEXZ.c)
 */
