/*
 * XREFs of ?_IssueMonitorEvent@MONITOR_MGR@@QEAAJIW4MONITOR_EVENT@@_KW4_DMM_VIDPN_MONITOR_TYPE@@PEAU_DXGK_DISPLAY_SCENARIO_CONTEXT@@@Z @ 0x1C015CA0C
 * Callers:
    ...
    *(_QWORD *)ActivityId.Data4 = 0LL;
    ...
    if ( dword_1C00A1888 > 5u )
    {
      if ( TlgKeywordOn((TraceLoggingHProvider)&dword_1C00A1888, 0x400000000080uLL) )
      {
        ...
        TlgWrite((TraceLoggingHProvider)&dword_1C00A1888, &unk_1C00748B4, p_ActivityId, v15, 8u, &pData);
      }
    }
  }
  if ( !(_DWORD)v7 )
