/*
 * XREFs of ?TdrCollectBugcheckSecondaryDumpData@@YAKPEAXK_N@Z @ 0x1C0040B58
 * Callers:
 *     _DxgDbgBugcheckCallback @ 0x1C003F900 (_DxgDbgBugcheckCallback.c)
      ...
      if ( v11 + 16 <= v4 )
      {
        ...
        if ( a1 )
        {
          ...
          *(_DWORD *)((char *)a1 + v11 + 8) = v28[4 * j + 2];
          v14 = (*(_DWORD *)((char *)a1 + v11 + 12) ^ v28[4 * j + 3]) & 3;
          *(_DWORD *)((char *)a1 + v11) = v13;
          *(_DWORD *)((char *)a1 + v11 + 12) ^= v14;
          v15 = v9;
          HIDWORD(a1[v15]) = j + 32;
          LODWORD(a1[v15]) = v11;
        }
