/*
 * XREFs of DxgkSetVidPnSourceOwner @ 0x1C00CB800
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall DxgkSetVidPnSourceOwner(struct _D3DKMT_SETVIDPNSOURCEOWNER *a1)
{
  ...
  DXGETWPROFILER_BASE_PushProfilerEntry((__int64)&v22, 2077LL);
...
LABEL_9:
    ...
    {
      if ( (Microsoft_Windows_DxgKrnlEnableBits & 0x2000) != 0 )
        McTemplateK0q(v10, &EventProfilerExit, v11, v22);
    }
    return v9;
  }
  v13 = a1;
  ...
  v18 = WdLogNewEntry5_WdError(MmUserProbeAddress, p_VidPnSourceCount, v16);
