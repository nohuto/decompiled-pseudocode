/*
 * XREFs of ?DdiCreateContext@ADAPTER_RENDER@@QEAAJPEAXPEAU_DXGKARG_CREATECONTEXT@@@Z @ 0x1C00E2804
 * Callers:
 *     ?ADAPTER_RENDER_DdiCreateContext@@YAJPEAVADAPTER_RENDER@@PEAXPEAU_DXGKARG_CREATECONTEXT@@@Z @ 0x1C0023320 (-ADAPTER_RENDER_DdiCreateContext@@YAJPEAVADAPTER_RENDER@@PEAXPEAU_DXGKARG_CREATECONTEXT@@@Z.c)
...
__int64 __fastcall ADAPTER_RENDER::DdiCreateContext(ADAPTER_RENDER *this, void *a2, const GUID *a3)
{
  ...
  DXGETWPROFILER_BASE_PushProfilerEntry((__int64)&v34, 5041LL);
...
LABEL_16:
  ...
  v17 = (*(int (__fastcall **)(void *, const GUID *))(*((_QWORD *)this + 2) + 640LL))(a2, a3);
  if ( v38[0] )
  ...
  v23[3] = v17;
  v23[4] = a2;
  v23[5] = *(_QWORD *)&a3->Data1;
  v23[6] = *(unsigned int *)&a3[2].Data2;
  v23[7] = a3[3].Data1;
