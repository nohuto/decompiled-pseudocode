/*
 * XREFs of ?MapFrameBufferPointer@DXGADAPTER@@QEAAJI_KPEA_KPEAPEAX@Z @ 0x1C01EDE28
 * Callers:
...
LABEL_11:
  ...
  v9 = *((_QWORD *)this + 305) + 352LL * (unsigned int)a2;
  if ( v6 + a3 > *(_QWORD *)(v9 + 48) || v6 + a3 < v6 )
  {
    v8 = (_QWORD *)WdLogNewEntry5_WdError(this, a2, a3);
    v8[3] = v17;
    v8[4] = v6;
  ...
  v16 = 0LL;
  v18 = v6;
  v12 = MmMapViewInSystemSpaceEx(*(_QWORD *)(v9 + 56), &v16, &v17, &v18, 0LL);
  if ( v12 >= 0 )
  {
    *a5 = v16;
    *a4 -= v18;
