/*
 * XREFs of McTemplateK0pqqqqqqqqqqqq @ 0x1C0001980
 * Callers:
 ...
 *     ?ReportState@ADAPTER_DISPLAY@@QEAAXXZ @ 0x1C01F3D34 (-ReportState@ADAPTER_DISPLAY@@QEAAXXZ.c)
 * Callees:
 *     McGenEventWrite @ 0x1C0001F10 (McGenEventWrite.c)
 *     __security_check_cookie @ 0x1C0023340 (__security_check_cookie.c)
 */

ULONG McTemplateK0pqqqqqqqqqqqq(__int64 a1, __int64 a2, const GUID *a3, ...)
{
  ...
  v28 = 4LL;
  v30 = 4LL;
  return McGenEventWrite((PMCGEN_TRACE_CONTEXT)&DxgkControlGuid_Context, &EventSetDisplayMode, a3, 0xEu, &EventData);
}
