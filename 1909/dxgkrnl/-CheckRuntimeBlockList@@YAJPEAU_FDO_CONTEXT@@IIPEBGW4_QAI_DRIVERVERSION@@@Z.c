/*
 * XREFs of ?CheckRuntimeBlockList@@YAJPEAU_FDO_CONTEXT@@IIPEBGW4_QAI_DRIVERVERSION@@@Z @ 0x1C016B9C4
 * Callers:
 ...
 *     wcscmp_0 @ 0x1C00250A8 (wcscmp_0.c)
...
LABEL_43:
        if ( (v34 || v42) && dword_1C00A1888 > 5u )
        {
          ...
          if ( v43 )
          {
            ...
            v80 = &v56;
            v81 = 4LL;
            TlgWrite((TraceLoggingHProvider)&dword_1C00A1888, &unk_1C0073FBA, 0LL, v46, 8u, &pData);
            goto LABEL_56;
          }
        }
        else
...
LABEL_56:
        if ( v54[0] && dword_1C00A1888 > 5u && TlgKeywordOn((TraceLoggingHProvider)&dword_1C00A1888, 0x400000001000uLL) )
        {
          ...
          TlgWrite((TraceLoggingHProvider)&dword_1C00A1888, &unk_1C0073F56, 0LL, v50, 7u, &pData);
        }
        v13 = v66;
