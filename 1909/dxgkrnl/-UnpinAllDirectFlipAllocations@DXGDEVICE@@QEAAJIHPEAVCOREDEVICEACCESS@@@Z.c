/*
 * XREFs of ?UnpinAllDirectFlipAllocations@DXGDEVICE@@QEAAJIHPEAVCOREDEVICEACCESS@@@Z @ 0x1C014DC2C
 * Callers:
        ...
        struct COREDEVICEACCESS *a4)
{
  ...
  do
  {
    ...
    if ( v11 )
    {
      ((void (__fastcall *)(PERESOURCE, _QWORD))this[2][68]->SystemResourcesList.Blink[14].Blink)(
        this[2][69],
        *((_QWORD *)v11 + 3));
  ...
  if ( v13 == (PERESOURCE *)this[2][2] )
    ADAPTER_DISPLAY::DisableOverlayPlanes((ADAPTER_DISPLAY *)v13[319], (unsigned int)v5);
  return 0LL;
}
