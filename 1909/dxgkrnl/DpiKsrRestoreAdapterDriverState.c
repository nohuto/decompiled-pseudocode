/*
 * XREFs of DpiKsrRestoreAdapterDriverState @ 0x1C02A992C
 * Callers:
 ...
 *     ??1DXGK_ENUMERATE_KSR_MEMORY_CONTEXT@@QEAA@XZ @ 0x1C02A889C (--1DXGK_ENUMERATE_KSR_MEMORY_CONTEXT@@QEAA@XZ.c)
