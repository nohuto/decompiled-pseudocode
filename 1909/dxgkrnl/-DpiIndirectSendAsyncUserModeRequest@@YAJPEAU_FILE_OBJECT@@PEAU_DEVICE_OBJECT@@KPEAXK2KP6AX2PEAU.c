/*
 * XREFs of ?DpiIndirectSendAsyncUserModeRequest@@YAJPEAU_FILE_OBJECT@@PEAU_DEVICE_OBJECT@@KPEAXK2KP6AX2PEAU_IO_STATUS_BLOCK@@@Z2PEA_NPEAPEAU_IRP@@@Z @ 0x1C02ABA28
 * Callers:
 *     DpiIndirectCbSendMessage @ 0x1C02AC130 (DpiIndirectCbSendMessage.c)
 * Callees:
