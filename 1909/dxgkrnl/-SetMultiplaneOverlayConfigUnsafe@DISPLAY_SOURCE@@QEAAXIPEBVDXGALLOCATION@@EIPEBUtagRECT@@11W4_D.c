/*
 * XREFs of ?SetMultiplaneOverlayConfigUnsafe@DISPLAY_SOURCE@@QEAAXIPEBVDXGALLOCATION@@EIPEBUtagRECT@@11W4_D3DDDI_ROTATION@@W4D3DKMT_MULTIPLANE_OVERLAY_BLEND@@W4D3DDDI_COLOR_SPACE_TYPE@@IW4_D3DDDIFORMAT@@E@Z @ 0x1C00FCE60
 * Callers:
 ...
 * Callees:
 *     ?CreateNewPlaneConfig@DISPLAY_SOURCE@@AEAAXIPEBVDXGALLOCATION@@EIPEBUtagRECT@@11W4_D3DDDI_ROTATION@@W4D3DKMT_MULTIPLANE_OVERLAY_BLEND@@W4D3DDDI_COLOR_SPACE_TYPE@@IW4_D3DDDIFORMAT@@E@Z @ 0x1C014AC4C (-CreateNewPlaneConfig@DISPLAY_SOURCE@@AEAAXIPEBVDXGALLOCATION@@EIPEBUtagRECT@@11W4_D3DDDI_ROTATI.c)
 */
...
LABEL_28:
        if ( *((_DWORD *)this + 934) <= (unsigned int)v16 )
        {
          ...
          *(_QWORD *)(v30 + 24) = 9131LL;
          WdLogEvent5_WdAssertion(v30);
        }
        v25 = *((_DWORD *)v20 + 2) & 0xFFFFFFFE;
        *(_QWORD *)v20 = a3;
        *((_DWORD *)v20 + 2) = (2 * (a4 & 1)) | a4 & 1 | v25 & 0xFFFFFFFD;
        return;
      }
    }
  }
LABEL_36:
  ...
  if ( a13 == (D3DDDIFMT_FORCE_UINT|0x80000000) && v20 )
    v26 = *((_DWORD *)v20 + 18);
  DISPLAY_SOURCE::CreateNewPlaneConfig(this, v16, a3, a4, v21, v23, v24, a8, a9, a10, a11, a12, v26, a14);
  if ( (unsigned int)v16 >= *((_DWORD *)this + 934) )
