/*
 * XREFs of DxgkReleaseKeyedMutex2 @ 0x1C026C980
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall DxgkReleaseKeyedMutex2(__int64 a1, __int64 a2, const GUID *a3)
{
  ULONG64 v3; // rbx
  __int64 v4; // rdx
  __int64 v5; // rcx
  ...
  unsigned int v31[4]; // [rsp+48h] [rbp-30h]
  void *v32[2]; // [rsp+58h] [rbp-20h]
  unsigned int v33[2]; // [rsp+68h] [rbp-10h]
  DXGKEYEDMUTEX *v34; // [rsp+88h] [rbp+10h] BYREF
  struct DXGKEYEDMUTEX *v35; // [rsp+90h] [rbp+18h] BYREF
  ...
  DXGETWPROFILER_BASE_PushProfilerEntry((__int64)&v28, 2069LL);
...
LABEL_7:
  ...
  *(_OWORD *)v32 = *(_OWORD *)(v3 + 16);
  *(_QWORD *)v33 = *(_QWORD *)(v3 + 32);
  v14 = v31[0];
  DXGKEYEDMUTEXBYHANDLE::DXGKEYEDMUTEXBYHANDLE((DXGKEYEDMUTEXBYHANDLE *)&v34, v31[0], Current, &v35);
  v18 = v35;
  if ( !v35 )
  {
  ...
  v20 = DXGKEYEDMUTEX::ReleaseSync(v35, v14, *(__int64 *)&v31[2], (struct _LIST_ENTRY *)v32[0], (char *)v32[1], v33[0]);
  v24 = v20;
  if ( v20 < 0 )
  {
