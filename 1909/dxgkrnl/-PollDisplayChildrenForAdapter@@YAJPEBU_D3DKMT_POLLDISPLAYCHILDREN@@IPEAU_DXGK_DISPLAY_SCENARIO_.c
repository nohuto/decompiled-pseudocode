/*
 * XREFs of ?PollDisplayChildrenForAdapter@@YAJPEBU_D3DKMT_POLLDISPLAYCHILDREN@@IPEAU_DXGK_DISPLAY_SCENARIO_CONTEXT@@@Z @ 0x1C0201270
 * Callers:
        ...
        struct _DXGK_DISPLAY_SCENARIO_CONTEXT *a3)
{
  ...
  LODWORD(v21) = COREADAPTERACCESS::AcquireExclusive(&v56, (unsigned int)(v20 + 1));
  if ( (int)v21 >= 0 )
  {
...
LABEL_26:
          if ( (*((_DWORD *)a1 + 1) & 4) != 0 )
          {
            v42 = COREADAPTERACCESS::AcquireExclusive(&v56, 1LL);
            v46 = v42;
            if ( v42 < 0 )
            {
