/*
 * XREFs of MonitorSetAdvancedColorParams @ 0x1C02C9F88
 * Callers:
        ...
        unsigned int a8)
{
  ...
  __int128 v20; // xmm1
  __int64 v21; // r9
  struct DXGMONITOR *v22; // [rsp+20h] [rbp-60h] BYREF
  _QWORD *v23; // [rsp+28h] [rbp-58h]
  _QWORD *v24; // [rsp+30h] [rbp-50h]
  ...
  if ( !a1 || !a7 || !a8 || a8 > a7 || a6 >= a7 || a6 >= a8 )
    return 3221225485LL;
  v22 = 0LL;
  result = MONITOR_MGR::_GetMonitorFromHandle(a1, &v22);
  if ( (int)result >= 0 )
  {
    v13 = v22;
    if ( !v22 )
    ...
    *((_QWORD *)&v26 + 1) = *a5;
    ...
    else
    {
      ...
      *((_DWORD *)v13 + 174) = 6;
      ...
      DXGMONITOR::_SendAdjustedHDRParamsToDriver(v13, 0, 0, v21);
    }
