/*
 * XREFs of ??1?$NT_OBJECT_REFERENCE@PEAUDXGDISPLAYMANAGEROBJECT_CONTAINER@@@@QEAA@XZ @ 0x1C00CB2BC
 * Callers:
 ...
 *     DxgkDispMgrReferenceObjectByHandle @ 0x1C028D890 (DxgkDispMgrReferenceObjectByHandle.c)
