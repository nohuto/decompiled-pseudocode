/*
 * XREFs of ?reset@?$auto_rc@VDMMVIDPN@@@@QEAAXPEAVDMMVIDPN@@@Z @ 0x1C0004518
 * Callers:
 ...
 *     ??_GCOMMITVIDPNREQUEST@VIDPN_MGR@@UEAAPEAXI@Z @ 0x1C0054170 (--_GCOMMITVIDPNREQUEST@VIDPN_MGR@@UEAAPEAXI@Z.c)
