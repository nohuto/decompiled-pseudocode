/*
 * XREFs of ?DdiRestartFromTimeout@ADAPTER_RENDER@@QEAAJXZ @ 0x1C01FC778
 * Callers:
...
__int64 __fastcall ADAPTER_RENDER::DdiRestartFromTimeout(ADAPTER_RENDER *this, __int64 a2, const GUID *a3)
{
  __int64 v4; // rdx
  __int64 v5; // rcx
  ...
  DXGETWPROFILER_BASE_PushProfilerEntry((__int64)&v29, 5021LL);
...
LABEL_16:
  ...
  v14 = (*(int (__fastcall **)(_QWORD))(*((_QWORD *)this + 2) + 448LL))(*(_QWORD *)(*((_QWORD *)this + 2) + 248LL));
  if ( v32[0] )
  ...
  *(_QWORD *)(v20 + 24) = v14;
  *(_QWORD *)(v20 + 32) = *(_QWORD *)(*((_QWORD *)this + 2) + 248LL);
