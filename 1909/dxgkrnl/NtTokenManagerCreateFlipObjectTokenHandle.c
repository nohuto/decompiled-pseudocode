/*
 * XREFs of NtTokenManagerCreateFlipObjectTokenHandle @ 0x1C00596C0
 * Callers:
 *     <none>
 * Callees:
        ...
        _QWORD *a8)
{
  ...
  _QWORD v27[11]; // [rsp+90h] [rbp-58h] BYREF
  ...
  if ( a7 )
  {
    ...
    v14 = (*(__int64 (__fastcall **)(__int64, __int64 *))(*((_QWORD *)Global + 38000) + 192LL))(0x80000000LL, &v20);
    if ( v14 >= 0 )
    {
  ...
  if ( v20 )
  {
    ...
    (*(void (__fastcall **)(__int64))(*((_QWORD *)v18 + 38000) + 312LL))(v20);
  }
  if ( Handle )
    NtClose(Handle);
