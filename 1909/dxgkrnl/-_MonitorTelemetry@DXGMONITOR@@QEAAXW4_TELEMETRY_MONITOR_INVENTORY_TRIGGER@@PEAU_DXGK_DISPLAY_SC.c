/*
 * XREFs of ?_MonitorTelemetry@DXGMONITOR@@QEAAXW4_TELEMETRY_MONITOR_INVENTORY_TRIGGER@@PEAU_DXGK_DISPLAY_SCENARIO_CONTEXT@@@Z @ 0x1C0176B44
 * Callers:
 ...
 *     ?SetEnforceWideColorMode@DXGMONITOR@@QEAAJE@Z @ 0x1C02CDE30 (-SetEnforceWideColorMode@DXGMONITOR@@QEAAJE@Z.c)
 *     ?SetSDRWhiteLevel@DXGMONITOR@@QEAAJK@Z @ 0x1C02CE028 (-SetSDRWhiteLevel@DXGMONITOR@@QEAAJK@Z.c)
 * Callees:
 ...
 *     ?EDID_V1_RemovePII@@YAJKPEAE@Z @ 0x1C0021834 (-EDID_V1_RemovePII@@YAJKPEAE@Z.c)
  ...
  *(_QWORD *)v181 = 0LL;
  ...
  if ( v27 )
  {
    ...
    if ( dword_1C00A1888 > 5u && TlgKeywordOn((TraceLoggingHProvider)&dword_1C00A1888, 0x800000000020uLL) )
    {
      ...
      v178 = 2LL;
      v180[1] = v59;
      TlgWrite((TraceLoggingHProvider)&dword_1C00A1888, &unk_1C00749C9, pActivityId, v61, 0x3Cu, &pData);
    }
    operator delete[](v27);
    if ( v26 )
      operator delete[](v26);
