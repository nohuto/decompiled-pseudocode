/*
 * XREFs of ?AcquireSourceSet@DXGDMM_INTERFACE_V1_IMPL@@YAJQEAXPEAPEAUD3DKMDT_HVIDEOPRESENTSOURCESET__@@PEAPEBU_DXGDMM_VIDEOPRESENTSOURCESET_INTERFACE@@@Z @ 0x1C02B8230
 * Callers:
 *     <none>
 * Callees:
        ...
        const struct _DXGDMM_VIDEOPRESENTSOURCESET_INTERFACE **a4)
{
  ...
  struct D3DKMDT_HVIDEOPRESENTSOURCESET__ *v26; // [rsp+58h] [rbp+10h]
  ...
  if ( (*(_BYTE *)(&DxgkControlGuid_Context + 2) & 2) != 0 )
  {
    ...
    if ( (Microsoft_Windows_DxgKrnlEnableBits & 0x2000) != 0 )
      McTemplateK0q((__int64)this, &EventProfilerEnter, (const GUID *)a3, 6048);
  }
  else
  {
    v25 = 0;
  }
  DXGETWPROFILER_BASE_PushProfilerEntry((__int64)&v23, 6048LL);
  if ( a2 && a3 )
  {
    *a2 = 0LL;
    *a3 = 0LL;
    if ( this )
    {
      ...
      {
        v19 = *(_QWORD *)(v18 + 88);
        v26 = *(struct D3DKMDT_HVIDEOPRESENTSOURCESET__ **)(v19 + 408);
        _InterlockedIncrement((volatile signed __int32 *)(*(_QWORD *)(v19 + 72) + 72LL));
        v11 = *(_QWORD *)(v19 + 72);
