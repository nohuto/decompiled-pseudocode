/*
 * XREFs of ?CreateAllocationObjects@DXGDEVICE@@QEAAJIPEAPEAVDXGALLOCATION@@PEAVDXGRESOURCE@@0@Z @ 0x1C00FFA80
 * Callers:
 ...
 *     ??0DXGALLOCATION@@QEAA@PEAVDXGDEVICE@@@Z @ 0x1C0206CFC (--0DXGALLOCATION@@QEAA@PEAVDXGDEVICE@@@Z.c)
 */
