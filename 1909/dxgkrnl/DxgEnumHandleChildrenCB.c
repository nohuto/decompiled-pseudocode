/*
 * XREFs of DxgEnumHandleChildrenCB @ 0x1C0231090
 * Callers:
 *     <none>
 * Callees:
 ...
 *     ??1DXGVALIDATIONPROCESSREATTACH@@QEAA@XZ @ 0x1C003DD38 (--1DXGVALIDATIONPROCESSREATTACH@@QEAA@XZ.c)
...
LABEL_8:
  ...
  if ( v25 )
  {
    ...
    {
      v19 = *(_QWORD *)(*(_QWORD *)(*(_QWORD *)(*(_QWORD *)(v25[1].Count + 16) + 16LL) + 192LL) + 64LL);
      v20 = *(_QWORD *)(v19 + 40);
      if ( *(_DWORD *)(v20 + 28) >= 0x2003u )
      {
        ...
        v21[3] = 275LL;
        v21[4] = 20LL;
        v21[5] = *(_QWORD *)(*(_QWORD *)(v25[1].Count + 16) + 16LL);
        v21[6] = 0LL;
        v21[7] = 0LL;
