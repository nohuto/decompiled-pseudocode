/*
 * XREFs of ?DisableOverlayPlanes@ADAPTER_DISPLAY@@QEAAXI@Z @ 0x1C00FCC10
 * Callers:
...
void __fastcall ADAPTER_DISPLAY::DisableOverlayPlanes(ADAPTER_DISPLAY *this, __int64 a2)
{
  ...
  v2 = (unsigned int)a2;
  v27 = (struct _KTHREAD **)((char *)this + 504);
  v28 = 0;
  if ( this == (ADAPTER_DISPLAY *)-504LL )
  {
    v17 = WdLogNewEntry5_WdAssertion(-504LL, a2);
    *(_QWORD *)(v17 + 24) = 660LL;
    ...
    if ( !(unsigned __int8)ExTryAcquirePushLockExclusiveEx(v5, 0LL) )
    {
      if ( bTracingEnabled )
      {
        ...
        if ( v22 != -1 && (Microsoft_Windows_DxgKrnlEnableBits & 0x40) != 0 )
          McTemplateK0q(v9, &EventBlockThread, v10, v22);
      }
