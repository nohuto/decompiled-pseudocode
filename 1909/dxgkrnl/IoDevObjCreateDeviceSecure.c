/*
 * XREFs of IoDevObjCreateDeviceSecure @ 0x1C017C1A0
 * Callers:
 *     <none>
 * Callees:
 ...
 *     IopDevObjApplyPostCreationSettings @ 0x1C017CACC (IopDevObjApplyPostCreationSettings.c)
  ...
  if ( updated >= 0 )
  {
    ...
    if ( !a8
      || (v22[0] = 2LL,
          v22[2] = 0LL,
          v22[1] = v18,
          updated = PpRegStateUpdateStackCreationSettings(a8, (__int64)v22),
          updated >= 0) )
    {
LABEL_9:
      v16 = a4;
      ...
      if ( (DeviceType[0] & 8) != 0 )
        a6 = v21[1];
      updated = IoCreateDevice(DriverObject, DeviceExtensionSize, a3, v16, DeviceCharacteristics, a6, &DeviceObject);
      if ( updated >= 0 )
      {
