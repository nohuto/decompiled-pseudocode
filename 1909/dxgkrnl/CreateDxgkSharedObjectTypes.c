/*
 * XREFs of CreateDxgkSharedObjectTypes @ 0x1C01706C8
 * Callers:
 *     ?Initialize@DXGGLOBAL@@QEAAJXZ @ 0x1C016DDBC (-Initialize@DXGGLOBAL@@QEAAJXZ.c)
 * Callees:
 *     ?GenericMapping@DxgkCompositionObject@@SA?AU_GENERIC_MAPPING@@XZ @ 0x1C001B8C8 (-GenericMapping@DxgkCompositionObject@@SA-AU_GENERIC_MAPPING@@XZ.c)
...
__int64 CreateDxgkSharedObjectTypes()
{
  ...
  if ( g_pDxgkSharedAllocationObjectType
    || (v1 = (struct _GENERIC_MAPPING)xmmword_1C0070C98,
        ...
        (int)result >= 0) )
  {
    ...
    {
      v1 = (struct _GENERIC_MAPPING)xmmword_1C0070CB8;
      result = CreateSharedObject(
    ...
    if ( (int)result >= 0 )
    {
      ...
      {
        v1 = (struct _GENERIC_MAPPING)xmmword_1C0070CC8;
        result = CreateSharedObject(
          ...
          if ( (int)result >= 0 )
          {
            ...
            if ( (int)result >= 0 )
            {
              ...
              if ( (int)result >= 0 )
              {
                ...
                {
                  v1 = (struct _GENERIC_MAPPING)xmmword_1C0070CA8;
                  result = CreateSharedObject(
