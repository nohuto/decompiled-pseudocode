/*
 * XREFs of ?ReleaseCoreResource@DXGADAPTER@@AEAAXW4_DXGKETW_PROFILER_TYPE@@PEAD@Z @ 0x1C010C150
 * Callers:
...
void __fastcall DXGADAPTER::ReleaseCoreResource(__int64 a1, int a2, __int64 a3)
{
  ...
  if ( v10 && *(_BYTE *)(v10 + 536) )
  {
    ...
    {
      LOBYTE(v6) = 1;
      ADAPTER_RENDER::ResumeScheduler(*(ADAPTER_RENDER **)(a1 + 2560), v6, 0);
      v12 = *(_QWORD *)(a1 + 2560);
    }
    *(_BYTE *)(v12 + 536) = 0;
  }
