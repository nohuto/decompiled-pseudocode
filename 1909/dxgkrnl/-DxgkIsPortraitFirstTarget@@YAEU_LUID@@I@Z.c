/*
 * XREFs of ?DxgkIsPortraitFirstTarget@@YAEU_LUID@@I@Z @ 0x1C026E97C
 * Callers:
    ...
    if ( (int)v16 >= 0 )
    {
      ...
      if ( v21 )
      {
        ...
        if ( v22 )
        {
          ...
          v23 = *(_QWORD *)(v22 + 80);
          TargetById = DMMVIDEOPRESENTTARGETSET::GetTargetById((DMMVIDEOPRESENTTARGETSET *)v23, (unsigned int)v4);
          if ( TargetById )
          {
