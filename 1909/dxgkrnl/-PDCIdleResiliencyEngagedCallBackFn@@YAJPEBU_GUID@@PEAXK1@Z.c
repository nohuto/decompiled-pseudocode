/*
 * XREFs of ?PDCIdleResiliencyEngagedCallBackFn@@YAJPEBU_GUID@@PEAXK1@Z @ 0x1C0244C50
 * Callers:
 *     <none>
 * Callees:
        ...
        PVOID Context)
{
  ...
  v4 = *Value;
  v6 = *((unsigned __int8 *)DXGGLOBAL::GetGlobal(SettingGuid, (__int64)Value) + 303824);
  if ( (_DWORD)v6 != v4 )
  {
    ...
    if ( v4 )
    {
      if ( (Microsoft_Windows_DxgKrnlEnableBits & 0x4000) != 0 )
        McTemplateK0(v7, &CSAccountingInProgress_Start, v9);
      v10 = 1LL;
    }
    else
    {
      if ( (Microsoft_Windows_DxgKrnlEnableBits & 0x4000) != 0 )
        McTemplateK0(v7, &CSAccountingInProgress_Stop, v9);
      v10 = 2LL;
    }
