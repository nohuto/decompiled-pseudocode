/*
 * XREFs of ?HandleMonitorArrival@@YAJPEAUMONITORSCOUNT_CALLBACK_CONTEXT@@AEBU_LUID@@IW4MONITOR_EVENT@@_KPEAU_DXGK_DISPLAY_SCENARIO_CONTEXT@@@Z @ 0x1C026EDBC
 * Callers:
 ...
 *     ?GetPathsCount@CCD_TOPOLOGY@@QEBAGXZ @ 0x1C00039A8 (-GetPathsCount@CCD_TOPOLOGY@@QEBAGXZ.c)
