/*
 * XREFs of DpiFdoDispatchPnp @ 0x1C0183D10
 * Callers:
 *     <none>
 * Callees:
 ...
 *     DpiFdoCloseDeviceFileObject @ 0x1C029F394 (DpiFdoCloseDeviceFileObject.c)
 */
...
__int64 __fastcall DpiFdoDispatchPnp(struct _DEVICE_OBJECT *a1, IRP *a2)
{
  ...
  POWER_STATE State; // [rsp+3Ch] [rbp-6Ch] BYREF
  unsigned int v16; // [rsp+40h] [rbp-68h]
  unsigned int v17; // [rsp+44h] [rbp-64h]
  _QWORD *v18; // [rsp+48h] [rbp-60h]
  ...
  POWER_STATE v24; // [rsp+78h] [rbp-30h]
  ...
  switch ( MinorFunction )
  {
    ...
    case 1u:
      ...
      if ( *(_BYTE *)(DeviceExtension + 484) )
        DpiCheckForOutstandingD3Requests(DeviceExtension);
      ExAcquireResourceExclusiveLite(*(PERESOURCE *)(DeviceExtension + 168), 1u);
      if ( byte_1C00A2751 && !*(_BYTE *)(DeviceExtension + 481) || *(_BYTE *)(DeviceExtension + 480) )
      {
        v12 = 1;
        Status = -1073741823;
        v20 = (_QWORD *)WdLogNewEntry5_WdError(v5, v4, v6);
        v20[3] = a1;
        v20[4] = (unsigned __int8)byte_1C00A2751;
      ...
      else
      {
        ...
        {
          v18 = (_QWORD *)WdLogNewEntry5_WdCriticalError(v5, v4);
          v18[3] = 275LL;
          v18[4] = 21LL;
          v18[5] = DeviceExtension;
          v18[6] = -1073741823LL;
    ...
    case 4u:
      ...
      *(_DWORD *)(DeviceExtension + 4LL * (*(_DWORD *)(DeviceExtension + 276) % 8u) + 244) = *(_DWORD *)(DeviceExtension + 240);
      ++*(_DWORD *)(DeviceExtension + 276);
      v3 = *(unsigned int *)(DeviceExtension + 236);
      *(_DWORD *)(DeviceExtension + 240) = v3;
      *(_DWORD *)(DeviceExtension + 236) = 4;
      Status = 0;
      v21 = WdLogNewEntry5_WdEvent(v3);
      *(_QWORD *)(v21 + 24) = a1;
    ...
    case 6u:
      ...
      {
        *(_DWORD *)(DeviceExtension + 236) = *(_DWORD *)(DeviceExtension + 240);
        v16 = *(_DWORD *)(DeviceExtension + 276) - 1;
        *(_DWORD *)(DeviceExtension + 276) = v16;
        *(_DWORD *)(DeviceExtension + 240) = *(_DWORD *)(DeviceExtension + 4LL * (v16 % 8) + 244);
      }
      if ( *(_BYTE *)(DeviceExtension + 484) )
        DpiEnableD3Requests(*(_QWORD *)(DeviceExtension + 24));
      goto LABEL_81;
    ...
    case 0x17u:
      ...
      *(_DWORD *)(DeviceExtension + 236) = 6;
      Status = 0;
      v23 = WdLogNewEntry5_WdEvent(v10);
      *(_QWORD *)(v23 + 24) = a1;
