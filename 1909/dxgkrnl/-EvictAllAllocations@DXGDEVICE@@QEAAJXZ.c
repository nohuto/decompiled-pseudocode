/*
 * XREFs of ?EvictAllAllocations@DXGDEVICE@@QEAAJXZ @ 0x1C022F088
 * Callers:
...
__int64 __fastcall DXGDEVICE::EvictAllAllocations(DXGDEVICE *this, __int64 a2)
{
  ...
  if ( (int)COREDEVICEACCESS::AcquireShared((__int64)v11, 0xFFFFFFFF, 0LL) >= 0 )
  {
    ...
    for ( i = *((_QWORD *)this + 6); i; i = *(_QWORD *)(i + 64) )
    {
      v7 = *(_QWORD *)(i + 24);
      if ( v7 )
        (*(void (__fastcall **)(_QWORD, __int64, _QWORD, _QWORD))(*(_QWORD *)(v2[68] + 8LL) + 720LL))(
          v2[69],
          v7,
          0LL,
          0LL);
