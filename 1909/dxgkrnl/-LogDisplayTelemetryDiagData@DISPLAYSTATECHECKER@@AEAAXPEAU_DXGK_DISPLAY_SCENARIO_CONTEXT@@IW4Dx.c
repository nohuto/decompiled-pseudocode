/*
 * XREFs of ?LogDisplayTelemetryDiagData@DISPLAYSTATECHECKER@@AEAAXPEAU_DXGK_DISPLAY_SCENARIO_CONTEXT@@IW4DxgkrnlLiveDumpFailureReason@1@@Z @ 0x1C0296980
 * Callers:
...
void __fastcall DISPLAYSTATECHECKER::LogDisplayTelemetryDiagData(__int64 a1, __int64 a2)
{
  ...
  if ( dword_1C00A1888 > 5u && TlgKeywordOn((TraceLoggingHProvider)&dword_1C00A1888, 0x400000000400uLL) )
  {
    ...
    v36 = &v20;
    v37 = 4LL;
    TlgWrite((TraceLoggingHProvider)&dword_1C00A1888, &unk_1C0073D6E, (LPCGUID)(a2 + 8), v7, 0xAu, &pData);
  }
  v8 = (_DWORD *)(a1 + 1812);
  v9 = *(_DWORD *)(a1 + 1812);
  if ( (_BYTE)v9 == 8 )
