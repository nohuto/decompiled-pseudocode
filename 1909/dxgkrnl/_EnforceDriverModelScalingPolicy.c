/*
 * XREFs of _EnforceDriverModelScalingPolicy @ 0x1C00CE28C
 * Callers:
...
void __fastcall EnforceDriverModelScalingPolicy(__int64 a1, enum _D3DKMDT_VIDPN_PRESENT_PATH_SCALING *a2)
{
  ...
  {
    v5 = *a2;
    if ( *(int *)(*(_QWORD *)(v4 + 16) + 2452LL) < 1105 )
    {
    ...
    EXCLUSIVEACCESS<VIDPN_MGR>::EXCLUSIVEACCESS<VIDPN_MGR>(&v8, *(_QWORD *)(v4 + 88));
    AdapterDefaultScaling = VIDPN_MGR::GetAdapterDefaultScaling(*(VIDPN_MGR **)(*(_QWORD *)(a1 + 2552) + 88LL));
    v7 = v8;
