/*
 * XREFs of DxgkGetCachedHybridQueryValue @ 0x1C0142B40
 * Callers:
 *     <none>
 * Callees:
 ...
 *     ?GetGpuPreferenceDListState@DXGPROCESS@@QEAA?AW4_D3DKMT_GPU_PREFERENCE_QUERY_STATE@@I@Z @ 0x1C0044734 (-GetGpuPreferenceDListState@DXGPROCESS@@QEAA-AW4_D3DKMT_GPU_PREFERENCE_QUERY_STATE@@I@Z.c)
