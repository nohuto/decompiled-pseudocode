/*
 * XREFs of ?ReportState@ADAPTER_RENDER@@QEAAXXZ @ 0x1C01F6318
 * Callers:
 *     ?ReportState@DXGADAPTER@@QEAAXXZ @ 0x1C01EEA10 (-ReportState@DXGADAPTER@@QEAAXXZ.c)
 * Callees:
 *     _guard_dispatch_icall_nop @ 0x1C00250D0 (_guard_dispatch_icall_nop.c)
 *     ?ClearStateReportingFlags@DXGDEVICE@@QEAAXXZ @ 0x1C022E178 (-ClearStateReportingFlags@DXGDEVICE@@QEAAXXZ.c)
