/*
 * XREFs of ?LogCheckMutiplaneOverlaySupport@@YAXJHIPEAPEAU_D3DKMT_CHECK_MULTIPLANE_OVERLAY_PLANE3@@PEAPEAXIPEAPEAU_D3DKMT_MULTIPLANE_OVERLAY_POST_COMPOSITION_WITH_SOURCE@@PEAVADAPTER_RENDER@@@Z @ 0x1C022F9D0
 * Callers:
  ...
  if ( bTracingEnabled )
  {
    ...
    if ( (_DWORD)v9 )
    {
      ...
      do
      {
        ...
        if ( *v24 )
          v26 = (const GUID *)(unsigned int)IsYUVAllocation(*v24, a8);
        if ( (Microsoft_Windows_DxgKrnlEnableBits & 0x40) != 0 )
        {
