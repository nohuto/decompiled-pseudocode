/*
 * XREFs of ?SetGdiGammaRamp@ADAPTER_DISPLAY@@QEAAXIPEBUDXGK_GAMMA_RAMP@@@Z @ 0x1C00D28CC
 * Callers:
        ...
        const struct DXGK_GAMMA_RAMP *a3)
{
  ...
  v5 = 3968LL * a2;
  DXGAUTOMUTEX::DXGAUTOMUTEX((DXGAUTOMUTEX *)v10, (struct DXGFASTMUTEX *const)(v5 + *((_QWORD *)this + 14) + 864LL), 0);
  DXGAUTOMUTEX::Acquire((DXGAUTOMUTEX *)v10);
  if ( a3 )
    _InterlockedIncrement((volatile signed __int32 *)a3 + 2);
  v8 = *((_QWORD *)this + 14);
  v9 = *(ReferenceCounted **)(v5 + v8 + 904);
  if ( v9 )
  {
    ReferenceCounted::Release(v9, v6, v7);
    v8 = *((_QWORD *)this + 14);
  }
  *(_QWORD *)(v5 + v8 + 904) = a3;
  if ( v10[8] )
