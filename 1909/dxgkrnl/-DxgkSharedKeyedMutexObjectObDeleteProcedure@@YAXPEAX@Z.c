/*
 * XREFs of ?DxgkSharedKeyedMutexObjectObDeleteProcedure@@YAXPEAX@Z @ 0x1C0251410
 * Callers:
 *     <none>
 * Callees:
...
void __fastcall DxgkSharedKeyedMutexObjectObDeleteProcedure(DXGKEYEDMUTEX **a1, __int64 a2, const GUID *a3)
{
  ...
  DXGETWPROFILER_BASE_PushProfilerEntry((__int64)&v8, 16001LL);
  DXGKEYEDMUTEX::ReleaseReference(*a1, v4);
  *a1 = 0LL;
  DXGETWPROFILER_BASE::PopProfilerEntry((DXGETWPROFILER_BASE *)&v8, v5);
  if ( v10 )
  {
    if ( (Microsoft_Windows_DxgKrnlEnableBits & 0x2000) != 0 )
