/*
 * XREFs of ?DmmAppendCcdConnectedSetForAdapter@@YAJQEAXPEAU_UNICODE_STRING@@@Z @ 0x1C0129658
 * Callers:
...
__int64 __fastcall DmmAppendCcdConnectedSetForAdapter(DXGADAPTER *a1, struct _UNICODE_STRING *a2)
{
  ...
  while ( 1 )
  {
    if ( !*(_DWORD *)(v14 + 88) )
    {
      v16 = *(struct HDXGMONITOR__ **)(v14 + 112);
      if ( v16 )
        break;
    }
LABEL_10:
  ...
  CCDMonitorID = MonitorGetCCDMonitorID(v16, v20, v26);
  v7 = CCDMonitorID;
