/*
 * XREFs of ?AcquireTargetModeSet@DXGDMM_VIDPN_INTERFACE_V1_IMPL@@YAJQEAUD3DKMDT_HVIDPN__@@IPEAPEAUD3DKMDT_HVIDPNTARGETMODESET__@@PEAPEBU_DXGDMM_VIDPNTARGETMODESET_INTERFACE@@@Z @ 0x1C01448C0
 * Callers:
 *     <none>
 * Callees:
        ...
        struct D3DKMDT_HVIDPNTARGETMODESET__ **a4)
{
  ...
  struct D3DKMDT_HVIDPNTARGETMODESET__ *v40; // [rsp+70h] [rbp+18h]
  ...
  if ( (*(_BYTE *)(&DxgkControlGuid_Context + 2) & 2) != 0 )
  {
    ...
    if ( (Microsoft_Windows_DxgKrnlEnableBits & 0x2000) != 0 )
      McTemplateK0q((__int64)this, &EventProfilerEnter, a3, 6036);
  }
  else
  {
    v39 = 0;
  }
  DXGETWPROFILER_BASE_PushProfilerEntry((__int64)&v37, 6036LL);
  if ( !a3 || !a4 )
  {
  ...
  *a4 = 0LL;
  ...
  if ( !DMMVIDPNTOPOLOGY::IsTargetInTopology((DMMVIDPNTOPOLOGY *)(v11 + 96), v7) )
  {
  ...
  v40 = *(struct D3DKMDT_HVIDPNTARGETMODESET__ **)(v19 + 448);
  v20 = IndexedSet<DMMVIDPNTARGET>::FindById(*(_QWORD *)(v15 + 312), v7);
  v24 = v20;
  if ( !v20 )
  {
