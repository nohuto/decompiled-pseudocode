/*
 * XREFs of ?Initialize@DXGPROCESS@@QEAAJXZ @ 0x1C00FFF10
 * Callers:
 ...
 *     ?DxgkIsExpandedResourceApplication@@YA_NPEAU_EPROCESS@@@Z @ 0x1C025DFA8 (-DxgkIsExpandedResourceApplication@@YA_NPEAU_EPROCESS@@@Z.c)
