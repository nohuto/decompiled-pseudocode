/*
 * XREFs of ?DestroyDxgProcess@DXGPROCESS@@SAXPEAV1@@Z @ 0x1C00FA5F0
 * Callers:
...
void __fastcall DXGPROCESS::DestroyDxgProcess(struct DXGPROCESS *this)
{
  ...
  if ( this )
  {
    ...
    v13 = ((unsigned __int64)this + 8) & ((unsigned __int128)-(__int128)(unsigned __int64)this >> 64);
    v14 = *(_QWORD *)v13;
    if ( *(_QWORD *)(*(_QWORD *)v13 + 8LL) != v13
      || (v15 = *(_QWORD **)((((unsigned __int64)this + 8) & ((unsigned __int128)-(__int128)(unsigned __int64)this >> 64))
                           + 8),
          *v15 != v13) )
    {
      __fastfail(3u);
    ...
    *(_QWORD *)(v14 + 8) = v15;
    ...
    DXGPROCESS::ReleaseReference(this, v13);
    if ( v31 )
