/*
 * XREFs of DxgDetermineBootImageMode @ 0x1C015E980
 * Callers:
...
LABEL_8:
      ...
      else
      {
        ...
        *((_OWORD *)Global + 71) = *(_OWORD *)a1;
        *((_OWORD *)Global + 72) = *(_OWORD *)(a1 + 16);
        v22 = *a2;
        *((_QWORD *)DXGGLOBAL::GetGlobal(v24, v23) + 141) = v22;
        v25 = a2[2];
        *((_QWORD *)DXGGLOBAL::GetGlobal(v27, v26) + 154) = v25;
        *((_DWORD *)DXGGLOBAL::GetGlobal(v29, v28) + 280) = 1;
...
LABEL_22:
  ...
  *((_DWORD *)DXGGLOBAL::GetGlobal(v17, v16) + 280) = 3;
