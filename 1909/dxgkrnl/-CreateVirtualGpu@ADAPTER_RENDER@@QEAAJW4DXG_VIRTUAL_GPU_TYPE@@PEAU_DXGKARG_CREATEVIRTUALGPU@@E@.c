/*
 * XREFs of ?CreateVirtualGpu@ADAPTER_RENDER@@QEAAJW4DXG_VIRTUAL_GPU_TYPE@@PEAU_DXGKARG_CREATEVIRTUALGPU@@E@Z @ 0x1C020E360
 * Callers:
...
LABEL_24:
      ...
      if ( v9[546] == 9216 )
      {
        wil_details_FeaturePropertyCache_ReportUsageToService(
          ...
          18097744LL,
          (const struct FEATURE_LOGGED_TRAITS *)&unk_1C00772D8,
          0,
          cData[0]);
        goto LABEL_24;
      }
  ...
  else if ( !(_DWORD)v4 )
  {
    wil_details_FeaturePropertyCache_ReportUsageToService(
      ...
      19276463LL,
      (const struct FEATURE_LOGGED_TRAITS *)&unk_1C00772D0,
      1,
      cData[0]);
    v9 = (_DWORD *)*((_QWORD *)a1 + 2);
LABEL_27:
...
LABEL_34:
  ...
  if ( dword_1C00A1888 > 5u && TlgKeywordOn((TraceLoggingHProvider)&dword_1C00A1888, 0x400000008000uLL) )
  {
    ...
    v61 = 4LL;
    v63 = 4LL;
    TlgWrite((TraceLoggingHProvider)&dword_1C00A1888, &unk_1C0072BB2, 0LL, (LPCGUID)v27, 0xDu, &v41);
  }
  if ( bTracingEnabled )
  {
