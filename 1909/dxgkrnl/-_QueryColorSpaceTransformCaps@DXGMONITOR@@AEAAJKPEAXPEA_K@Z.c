/*
 * XREFs of ?_QueryColorSpaceTransformCaps@DXGMONITOR@@AEAAJKPEAXPEA_K@Z @ 0x1C014F86C
 * Callers:
        ...
        unsigned __int64 *a4)
{
  ...
  *a4 = 0LL;
  if ( DXGMONITOR::_IsTargetMatrix_3x4Supported(this) )
  {
    if ( v7 >= 0x40 )
    {
      v10 = *(_OWORD *)((char *)this + 1080);
      *a4 = 64LL;
      *a3 = v10;
      a3[1] = *(_OWORD *)((char *)this + 1096);
      a3[2] = *(_OWORD *)((char *)this + 1112);
      a3[3] = *(_OWORD *)((char *)this + 1128);
    }
    else
    {
