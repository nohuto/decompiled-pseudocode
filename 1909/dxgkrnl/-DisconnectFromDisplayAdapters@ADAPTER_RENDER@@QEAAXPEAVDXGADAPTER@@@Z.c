/*
 * XREFs of ?DisconnectFromDisplayAdapters@ADAPTER_RENDER@@QEAAXPEAVDXGADAPTER@@@Z @ 0x1C01F527C
 * Callers:
...
void __fastcall ADAPTER_RENDER::DisconnectFromDisplayAdapters(ADAPTER_RENDER *this, PDEVICE_OBJECT *a2)
{
  ...
  if ( (int)COREADAPTERACCESS::AcquireExclusive(&v15, (unsigned int)(v6 + 1)) >= 0 )
  {
