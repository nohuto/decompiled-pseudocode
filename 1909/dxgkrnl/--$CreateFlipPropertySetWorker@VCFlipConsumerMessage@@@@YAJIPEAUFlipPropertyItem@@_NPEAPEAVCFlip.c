/*
 * XREFs of ??$CreateFlipPropertySetWorker@VCFlipConsumerMessage@@@@YAJIPEAUFlipPropertyItem@@_NPEAPEAVCFlipConsumerMessage@@@Z @ 0x1C005DAB0
 * Callers:
 ...
 *     ??0CFlipConsumerMessage@@QEAA@IPEAUFlipPropertyItem@@PEAXI@Z @ 0x1C005E2D8 (--0CFlipConsumerMessage@@QEAA@IPEAUFlipPropertyItem@@PEAXI@Z.c)
 */
...
LABEL_50:
    ...
    else
    {
      ...
      while ( v5 >= 0 && v19 < a1 )
      {
        ...
        if ( v29 && (&v23[v22] < v23 || (unsigned __int64)&v23[v22] > MmUserProbeAddress) )
          *(_BYTE *)MmUserProbeAddress = 0;
        memmove(v18, v23, v22);
        *((_QWORD *)v21 + 3) = v18;
