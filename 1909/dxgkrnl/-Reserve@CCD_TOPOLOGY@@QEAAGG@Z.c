/*
 * XREFs of ?Reserve@CCD_TOPOLOGY@@QEAAGG@Z @ 0x1C00DAE84
 * Callers:
 ...
 *     ?_LoadTopologyDescriptorCallback@CCD_RECENT_TOPOLOGY_RETRIEVER@@CAJPEAVTOPOLOGY_SET_DESCRIPTOR@CCD_STORE@@PEAX@Z @ 0x1C014AFC0 (-_LoadTopologyDescriptorCallback@CCD_RECENT_TOPOLOGY_RETRIEVER@@CAJPEAVTOPOLOGY_SET_DESCRIPTOR@C.c)
...
__int64 __fastcall CCD_TOPOLOGY::Reserve(CCD_TOPOLOGY *this, __int64 a2)
{
  ...
  if ( *((_BYTE *)this + 72) )
  {
      ...
      && (v7 = operator new[](272 * ((unsigned __int16)a2 - 1LL) + 320, 0x63644356u, PagedPool)) != 0LL )
    {
      ...
      *((_WORD *)v7 + 11) = v3;
      memset(&v7[17 * v6 + 3], 0, 272 * (v3 - (unsigned __int64)v6));
