/*
 * XREFs of ?PopulateGdiDisplayModeFromPath@VIDPN_MGR@@SAJPEBVDMMVIDPNPRESENTPATH@@PEAU_CDD_DEVMODE@@@Z @ 0x1C0127BF4
 * Callers:
 ...
 *     ?GetBitsPerPixel@DMMVIDPNSOURCEMODE@@QEBAIXZ @ 0x1C0054700 (-GetBitsPerPixel@DMMVIDPNSOURCEMODE@@QEBAIXZ.c)
...
LABEL_9:
  auto_rc<DMMVIDPNTARGETMODESET>::reset(&v38, v6);
