/*
 * XREFs of DpiFdoConnectInterrupt @ 0x1C01619BC
 * Callers:
 *     DpiFdoStartAdapter @ 0x1C01631F8 (DpiFdoStartAdapter.c)
 * Callees:
 *     memset @ 0x1C0025440 (memset.c)
 *     DpiFdoGetInterruptIrql @ 0x1C0161AEC (DpiFdoGetInterruptIrql.c)
 *     DpiLdaGetInterruptIrqlForChain @ 0x1C02AE32C (DpiLdaGetInterruptIrqlForChain.c)
 */
