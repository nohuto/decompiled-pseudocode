/*
 * XREFs of DxgkSetAllocationPriority @ 0x1C0209EE0
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall DxgkSetAllocationPriority(__int64 a1, __int64 a2, const GUID *a3)
{
  ...
  _QWORD v35[2]; // [rsp+58h] [rbp-F0h] BYREF
  _D3DKMT_SETALLOCATIONPRIORITY v36; // [rsp+68h] [rbp-E0h] BYREF
  ...
  DXGETWPROFILER_BASE_PushProfilerEntry((__int64)&v31, 2007LL);
...
LABEL_7:
  ...
  v36 = *v3;
  DXGDEVICEBYHANDLE::DXGDEVICEBYHANDLE((DXGDEVICEBYHANDLE *)&v30, v36.hDevice, Current, &v34);
  v18 = v34;
  if ( !v34 )
  {
    v19 = WdLogNewEntry5_WdError(v16, v15, v17);
    *(_QWORD *)(v19 + 24) = v36.hDevice;
    v10 = -1073741811;
...
LABEL_15:
  ...
  DXGDEVICEACCESSLOCKEXCLUSIVE::DXGDEVICEACCESSLOCKEXCLUSIVE((DXGDEVICEACCESSLOCKEXCLUSIVE *)v35, v34);
  COREDEVICEACCESS::COREDEVICEACCESS((__int64)v37, (__int64)v18, 0, v20, 0);
  v21 = COREDEVICEACCESS::AcquireShared((__int64)v37, 0xFFFFFFFF, 0LL);
  v25 = v21;
  if ( v21 >= 0 )
  {
    v10 = DXGDEVICE::SetAllocationPriority(v18, &v36);
