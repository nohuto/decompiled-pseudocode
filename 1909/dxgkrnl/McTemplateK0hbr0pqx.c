/*
 * XREFs of McTemplateK0hbr0pqx @ 0x1C0052604
 * Callers:
...
ULONG __fastcall McTemplateK0hbr0pqx(
        __int64 a1,
        ...
        char a8)
{
  ...
  v18 = 4LL;
  v20 = 8LL;
  return McGenEventWrite((PMCGEN_TRACE_CONTEXT)&DxgkControlGuid_Context, a2, 0LL, 6u, &EventData);
}
