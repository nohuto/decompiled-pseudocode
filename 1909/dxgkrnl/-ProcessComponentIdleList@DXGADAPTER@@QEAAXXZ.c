/*
 * XREFs of ?ProcessComponentIdleList@DXGADAPTER@@QEAAXXZ @ 0x1C003410C
 * Callers:
 *     ?DxgkpComponentIdleListTimerDpc@@YAXPEAU_KDPC@@PEAX11@Z @ 0x1C003B350 (-DxgkpComponentIdleListTimerDpc@@YAXPEAU_KDPC@@PEAX11@Z.c)
 * Callees:
...
void __fastcall DXGADAPTER::ProcessComponentIdleList(KSPIN_LOCK *this)
{
  ...
  if ( !*((_BYTE *)this + 3030) )
  {
    ...
    KeAcquireInStackQueuedSpinLockAtDpcLevel(this + 391, &LockHandle);
    v16[1] = v16;
    v3 = this + 385;
    v16[0] = v16;
    v4 = (_QWORD *)this[385];
