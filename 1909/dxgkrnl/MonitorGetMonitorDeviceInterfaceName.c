/*
 * XREFs of MonitorGetMonitorDeviceInterfaceName @ 0x1C012EAA8
 * Callers:
 ...
 *     ?RtlStringCchCopyUnicodeString@@YAJPEAG_KPEBU_UNICODE_STRING@@@Z @ 0x1C0019E28 (-RtlStringCchCopyUnicodeString@@YAJPEAG_KPEBU_UNICODE_STRING@@@Z.c)
