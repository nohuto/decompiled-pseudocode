/*
 * XREFs of ?DdiBeginExclusiveAccess@ADAPTER_RENDER@@QEAAJXZ @ 0x1C01F74AC
 * Callers:
...
__int64 __fastcall ADAPTER_RENDER::DdiBeginExclusiveAccess(ADAPTER_RENDER *this, __int64 a2, const GUID *a3)
{
  __int64 v4; // rdx
  __int64 v5; // rcx
  __int64 v6; // rdi
  ...
  DXGETWPROFILER_BASE_PushProfilerEntry((__int64)&v29, 5130LL);
  v5 = *((_QWORD *)this + 2);
  LODWORD(v6) = 0;
  if ( *(_QWORD *)(v5 + 1208) )
  {
...
LABEL_17:
    ...
    v16 = *((_QWORD *)this + 2);
    v28 = 0;
    v6 = (*(int (__fastcall **)(_QWORD, int *))(v16 + 1208))(*(_QWORD *)(v16 + 248), &v28);
    if ( v32[0] )
