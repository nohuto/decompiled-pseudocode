/*
 * XREFs of ?DmmLogCommitVidPnFailedPacket@@YAXPEAU_DXGKARG_COMMITVIDPN@@JW4DXGK_DIAG_COMMIT_VIDPN_STAGE@@@Z @ 0x1C02B49B0
 * Callers:
...
void __fastcall DmmLogCommitVidPnFailedPacket(__int64 a1, int a2, int a3)
{
  ...
  if ( v5 )
  {
    ...
    v12 = *((_DWORD *)v9 + 10);
    v13 = *(_QWORD *)(*(_QWORD *)(v10 + 16) + 276LL);
    v14 = 144 * v12 + 80;
      ...
      *((_DWORD *)v16 + 17) = v18 ^ v19;
      ...
      if ( v20 < 0
        || (CurrentProcessSessionId = PsGetCurrentProcessSessionId(v22, v21),
            v20 = DxgkWriteDiagEntry((struct _DXGK_DIAG_HEADER *)v16, CurrentProcessSessionId, v24),
            v20 < 0) )
      {
