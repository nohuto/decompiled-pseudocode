/*
 * XREFs of ?AllocatePresentToHwQueueParams@DXGGLOBAL@@QEAAPEAU_D3DKMT_SUBMITPRESENTTOHWQUEUE@@XZ @ 0x1C000116C
 * Callers:
...
struct _D3DKMT_SUBMITPRESENTTOHWQUEUE *__fastcall DXGGLOBAL::AllocatePresentToHwQueueParams(DXGGLOBAL *this)
{
  ...
  v1 = (char *)this + 864;
  ++*((_DWORD *)this + 221);
  v2 = ExpInterlockedPopEntrySList((PSLIST_HEADER)this + 54);
  if ( v2
