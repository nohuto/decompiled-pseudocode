/*
 * XREFs of ?_ConstructClone@BTL_TOPOLOGY_CONSTRUCTOR@@AEAAJ_N@Z @ 0x1C02C4C04
 * Callers:
    ...
    else
    {
      ...
      *((_BYTE *)this + 10) = 0;
      ...
      if ( v9 < 0 )
      {
        ...
        v13[3] = v7;
        v13[4] = *((int *)this + 4);
        v13[5] = *((unsigned int *)this + 3);
        v13[6] = *((unsigned int *)this + 5);
        v13[7] = *(_QWORD *)(*(_QWORD *)this + 64LL);
        WdLogEvent5_WdError(v13);
        return (unsigned int)v7;
      }
      if ( IsInternalVideoOutput(*((enum _D3DKMDT_VIDEO_OUTPUT_TECHNOLOGY *)this + 7)) )
      {
        v14 = *(_QWORD *)(*(_QWORD *)this + 64LL);
        if ( v14 )
          v6 = *(_WORD *)(v14 + 20);
        if ( v6 >= 2u )
