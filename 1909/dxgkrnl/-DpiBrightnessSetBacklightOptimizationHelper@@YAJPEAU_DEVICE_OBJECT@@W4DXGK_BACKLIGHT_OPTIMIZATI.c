/*
 * XREFs of ?DpiBrightnessSetBacklightOptimizationHelper@@YAJPEAU_DEVICE_OBJECT@@W4DXGK_BACKLIGHT_OPTIMIZATION_LEVEL@@@Z @ 0x1C02A82A0
 * Callers:
        ...
        enum DXGK_BACKLIGHT_OPTIMIZATION_LEVEL a2)
{
  ...
  if ( !v4 )
    return 3221225659LL;
  if ( !*((_QWORD *)v4 + 9) || a2 == *((_DWORD *)DeviceExtension + 1095) )
    return 0LL;
  result = DpiCallDrvSetBacklightOptimizationLevel(a1);
  if ( (int)result >= 0 )
    *((_DWORD *)DeviceExtension + 1095) = a2;
  return result;
}
