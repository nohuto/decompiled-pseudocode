/*
 * XREFs of ?DdiPresentDisplayOnly@ADAPTER_DISPLAY@@QEAAJPEAU_DXGKARG_PRESENT_DISPLAYONLY@@@Z @ 0x1C01FB50C
 * Callers:
        ...
        const GUID *a3)
{
  ...
  DXGETWPROFILER_BASE_PushProfilerEntry((__int64)&v30, 5048LL);
...
LABEL_16:
  ...
  v15 = (*(int (__fastcall **)(_QWORD, struct _DXGKARG_PRESENT_DISPLAYONLY *))(*((_QWORD *)this + 2) + 696LL))(
  ...
  v21[7] = NumDirtyRects;
  if ( (_DWORD)v15 != -1073741801 && (_DWORD)v15 && (_DWORD)v15 != 259 )
  {
    v25 = WdLogNewEntry5_WdError(NumDirtyRects, v22, v23);
    *(_QWORD *)(v25 + 24) = v15;
