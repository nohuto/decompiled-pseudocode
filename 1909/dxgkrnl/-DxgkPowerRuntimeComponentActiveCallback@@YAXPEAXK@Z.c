/*
 * XREFs of ?DxgkPowerRuntimeComponentActiveCallback@@YAXPEAXK@Z @ 0x1C003B050
 * Callers:
 *     <none>
 * Callees:
...
void __fastcall DxgkPowerRuntimeComponentActiveCallback(DXGADAPTER *this, unsigned int a2, const GUID *a3, __int64 a4)
{
