/*
 * XREFs of ?ReleaseTargetModeSet@DXGDMM_VIDPN_INTERFACE_V1_IMPL@@YAJQEAUD3DKMDT_HVIDPN__@@QEAUD3DKMDT_HVIDPNTARGETMODESET__@@@Z @ 0x1C0145AB0
 * Callers:
 *     <none>
 * Callees:
        ...
        const GUID *a3)
{
  ...
  DXGETWPROFILER_BASE_PushProfilerEntry((__int64)&v36, 6037LL);
  ...
  if ( v5 )
  {
    ...
    else
    {
      ...
      v14 = (struct DMMVIDPNTARGETMODESET *)v10;
      if ( v10 )
      {
        v15 = *(DMMVIDPNTARGET **)(v10 + 112);
        if ( !v15 )
        {
        ...
        if ( ContainedBy<DMMVIDPN>::GetContainer(v16 + 64, v11) == v9 )
        {
          ...
          DMMVIDPNTARGET::ReleaseModeSet(v15, v14, v20);
