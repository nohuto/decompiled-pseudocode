/*
 * XREFs of DpiDispatchPnp @ 0x1C0143850
 * Callers:
 *     <none>
 * Callees:
 *     LoadEtwStackLocation @ 0x1C00069C4 (LoadEtwStackLocation.c)
 *     DpiGdoDispatchGdiPnp @ 0x1C001A068 (DpiGdoDispatchGdiPnp.c)
...
__int64 __fastcall DpiDispatchPnp(__int64 a1, IRP *a2)
{
  ...
  if ( bTracingEnabled )
  {
    ...
    if ( (Microsoft_Windows_DxgKrnlEnableBits & 0x40) != 0 )
      McTemplateK0phbr1q(v6, &EventEnterDpiDispatchPnp, v7, a1);
  }
  v8 = *(_QWORD *)(a1 + 64);
  ...
  else
  {
    ...
    if ( *(_DWORD *)(v8 + 16) == 1953656900 && *(_DWORD *)(v8 + 20) == 6 )
      LODWORD(v14) = DpiGdoDispatchGdiPnp(a1, (__int64)a2, v13);
  }
