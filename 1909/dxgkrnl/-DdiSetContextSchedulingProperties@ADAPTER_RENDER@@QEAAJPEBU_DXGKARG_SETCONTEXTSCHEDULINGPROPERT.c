/*
 * XREFs of ?DdiSetContextSchedulingProperties@ADAPTER_RENDER@@QEAAJPEBU_DXGKARG_SETCONTEXTSCHEDULINGPROPERTIES@@@Z @ 0x1C01FCD10
 * Callers:
 *     ?ADAPTER_RENDER_DdiSetContextSchedulingProperties@@YAJPEAVADAPTER_RENDER@@PEBU_DXGKARG_SETCONTEXTSCHEDULINGPROPERTIES@@@Z @ 0x1C003E080 (-ADAPTER_RENDER_DdiSetContextSchedulingProperties@@YAJPEAVADAPTER_RENDER@@PEBU_DXGKARG_SETCONTEX.c)
 * Callees:
