/*
 * XREFs of ??1?$Set@VCONTEXT_DATA@ContextDataAssignee@@@@UEAA@XZ @ 0x1C0055CD0
 * Callers:
 *     ??1DMMVIDEOPRESENTSOURCE@@UEAA@XZ @ 0x1C0055CFC (--1DMMVIDEOPRESENTSOURCE@@UEAA@XZ.c)
 *     ??_G?$Set@VCONTEXT_DATA@ContextDataAssignee@@@@UEAAPEAXI@Z @ 0x1C0055DF0 (--_G-$Set@VCONTEXT_DATA@ContextDataAssignee@@@@UEAAPEAXI@Z.c)
 * Callees:
