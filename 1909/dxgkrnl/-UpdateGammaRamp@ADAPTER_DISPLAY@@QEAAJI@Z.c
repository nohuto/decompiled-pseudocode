/*
 * XREFs of ?UpdateGammaRamp@ADAPTER_DISPLAY@@QEAAJI@Z @ 0x1C00D2A50
 * Callers:
 ...
 *     ColorSpaceTransformInitIdentityTransform @ 0x1C0024D2C (ColorSpaceTransformInitIdentityTransform.c)
 ...
 *     ?AdjustFullscreenGammaRamp@ADAPTER_DISPLAY@@QEAAJPEBUDXGK_GAMMA_RAMP@@PEAU2@PEAUDXGK_GAMMA_ADJUSTMENT@@@Z @ 0x1C01F060C (-AdjustFullscreenGammaRamp@ADAPTER_DISPLAY@@QEAAJPEBUDXGK_GAMMA_RAMP@@PEAU2@PEAUDXGK_GAMMA_ADJUS.c)
...
LABEL_29:
      ...
      if ( !DXGADAPTER::IsCoreResourceExclusiveOwner(v24) )
      {
        ...
        *(_QWORD *)(v27 + 24) = 7214LL;
        WdLogEvent5_WdAssertion(v27);
      }
      LODWORD(v10) = ADAPTER_RENDER::SuspendScheduler(*((ADAPTER_RENDER **)this[2] + 320), 0, 0);
      if ( (int)v10 < 0 )
      {
...
LABEL_35:
        ...
        v32 = 0LL;
        for ( i = 0; DmmEnumClientVidPnPathTargetsFromSource(this[2], v3, v32, &v41) >= 0; v32 = i )
        {
          v21 = v41;
          ++i;
          if ( v41 == -1 )
        ...
        if ( *((_BYTE *)this + 235) && DXGADAPTER::IsFullWDDMAdapter(this[2]) )
          ADAPTER_RENDER::ResumeScheduler(*(ADAPTER_RENDER **)(v39 + 2560), 0, 0);
      }
      goto LABEL_44;
    }
LABEL_27:
  ...
  if ( v18 )
  {
    if ( v12 )
    {
      inited = DXGK_GAMMA_RAMP::Initialize(
                 (DXGK_GAMMA_RAMP *)v18,
                 (enum _D3DDDI_GAMMARAMP_TYPE)*(_DWORD *)(v12 + 16),
                 *(const void **)(v12 + 32));
    }
    else
    {
