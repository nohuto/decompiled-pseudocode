/*
 * XREFs of DpiFdoHandleQueryFlexibleIovInterface @ 0x1C02A9DC0
 * Callers:
 *     <none>
 * Callees:
    ...
    if ( v8 == 1 )
    {
      if ( v9 >= 0x78u )
      {
        ...
        if ( *(_BYTE *)(v5 + 5264) )
        {
          ...
          if ( *(_QWORD *)(v5 + 5304) )
          {
            qword_1C00A1A58 = (__int64)&DpiIovGetBackingResource;
            qword_1C00A1A60 = (__int64)DpiIovGetMmioRangeCount;
            qword_1C00A1A68 = (__int64)DpiIovGetMmioRanges;
          }
          else
          {
            v18 = 0LL;
            ...
            qword_1C00A1A58 = (__int64)v18;
          }
          memmove(a4, &unk_1C00A1A20, 0x78uLL);
