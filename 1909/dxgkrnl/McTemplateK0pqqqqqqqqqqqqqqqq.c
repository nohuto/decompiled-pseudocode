/*
 * XREFs of McTemplateK0pqqqqqqqqqqqqqqqq @ 0x1C0055210
 * Callers:
...
ULONG McTemplateK0pqqqqqqqqqqqqqqqq(__int64 a1, __int64 a2, const GUID *a3, ...)
{
  ...
  v36 = 4LL;
  v38 = 4LL;
  return McGenEventWrite((PMCGEN_TRACE_CONTEXT)&DxgkControlGuid_Context, &SetTimingsFromVidPn, a3, 0x12u, &EventData);
}
