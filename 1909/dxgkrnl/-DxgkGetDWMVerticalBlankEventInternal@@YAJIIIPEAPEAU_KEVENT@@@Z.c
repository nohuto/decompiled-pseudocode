/*
 * XREFs of ?DxgkGetDWMVerticalBlankEventInternal@@YAJIIIPEAPEAU_KEVENT@@@Z @ 0x1C014D384
 * Callers:
 *     DxgkGetDWMVerticalBlankEvent @ 0x1C014D260 (DxgkGetDWMVerticalBlankEvent.c)
 * Callees:
