/*
 * XREFs of ?Initialize@DXGGLOBAL@@QEAAJXZ @ 0x1C016DDBC
 * Callers:
...
LABEL_85:
  ...
  *((_QWORD *)v1 + 139) = v83;
  if ( !v83 )
  {
    ...
    *(_QWORD *)(v95 + 24) = 1915LL;
    goto LABEL_63;
  }
  KeInitializeSpinLock(&qword_1C00A2DC8);
