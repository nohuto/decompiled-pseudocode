/*
 * XREFs of ?DmmGetPathContentFromClientVidPnSource@@YAJQEAXIPEAW4_D3DKMDT_VIDPN_PRESENT_PATH_CONTENT@@@Z @ 0x1C02B3D88
 * Callers:
  ...
  if ( v15 )
  {
    ...
    if ( v47 )
    {
      ...
      while ( 1 )
      {
        ...
        TargetById = DMMVIDEOPRESENTTARGETSET::GetTargetById((DMMVIDEOPRESENTTARGETSET *)v28, (unsigned int)v34);
        if ( TargetById )
        {
