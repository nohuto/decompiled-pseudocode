/*
 * XREFs of ?DxgkSendDisplayBrokerMessage@@YAJKPEAU_PORT_MESSAGE@@PEAU_ALPC_MESSAGE_ATTRIBUTES@@0PEA_K1PEAT_LARGE_INTEGER@@@Z @ 0x1C014F660
 * Callers:
        ...
        union _LARGE_INTEGER *a7)
{
  ...
  v10 = a1;
  v13 = (DXGSESSIONMGR *)*((_QWORD *)DXGGLOBAL::GetGlobal(a1, (__int64)a2) + 74);
  if ( v13 )
  {
  ...
  if ( SessionDataForSpecifiedSession )
    return DispBrokerClient::SendDisplayBrokerMessage(
             (struct DXGSESSIONDATA *)((char *)SessionDataForSpecifiedSession + 18776),
             v10,
             a2,
             a3,
             a4,
