/*
 * XREFs of TraceLoggingWriteMiracastSessionStop @ 0x1C0052EF8
 * Callers:
...
void __fastcall TraceLoggingWriteMiracastSessionStop(__int64 a1, int a2, int a3)
{
  ...
  if ( dword_1C00A1888 > 5u )
  {
    if ( TlgKeywordOn((TraceLoggingHProvider)&dword_1C00A1888, 0x800000000002uLL) )
    {
      ...
      v108 = 4LL;
      v109 = &v44;
      v45 = dword_1C00A2B70 - *(_DWORD *)(v14 + 672);
      v111 = &v45;
      v46 = *(_DWORD *)(v14 + 676);
      v113 = &v46;
      v115 = &v47;
      ...
      v47 = a3;
      v116 = 4LL;
      TlgWrite((TraceLoggingHProvider)&dword_1C00A1888, &unk_1C0074104, v20, v19, 0x28u, &pData);
    }
  }
}
