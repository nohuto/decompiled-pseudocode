/*
 * XREFs of ?SetVidPnSourceVisibility@ADAPTER_DISPLAY@@QEAAJIEIE@Z @ 0x1C00D20C0
 * Callers:
 *     ?ADAPTER_DISPLAY_SetVidPnSourceVisibility@@YAJPEAVADAPTER_DISPLAY@@IEIE@Z @ 0x1C003DE40 (-ADAPTER_DISPLAY_SetVidPnSourceVisibility@@YAJPEAVADAPTER_DISPLAY@@IEIE@Z.c)
...
LABEL_9:
  ...
  if ( v14 && v13 )
  {
    ...
    if ( v12 )
    {
      ADAPTER_RENDER::FlushScheduler(*(_QWORD *)(v17 + 2560), 6LL, (unsigned int)v5);
    }
    else
    {
  ...
  if ( a3 )
  {
    v35 = ADAPTER_DISPLAY::DdiSetVidPnSourceVisibility(this, &v51, (const GUID *)v11);
    v27 = v35;
    if ( v35 >= 0 )
    {
...
LABEL_37:
  ...
  v22 = ADAPTER_DISPLAY::DdiSetVidPnSourceVisibility(this, &v51, v21);
  v27 = v22;
  if ( v22 < 0 )
    goto LABEL_37;
LABEL_21:
...
LABEL_22:
  ...
  if ( v31 && v12 )
    ADAPTER_RENDER::FlushScheduler(v31, 7LL, (unsigned int)v5);
