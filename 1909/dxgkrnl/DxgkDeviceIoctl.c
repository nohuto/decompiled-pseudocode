/*
 * XREFs of DxgkDeviceIoctl @ 0x1C0040170
 * Callers:
 *     <none>
 * Callees:
 ...
 *     ?CreateHandle@DxgkCompositionObject@@QEBAJK_NDPEAPEAX@Z @ 0x1C00563D4 (-CreateHandle@DxgkCompositionObject@@QEBAJK_NDPEAPEAX@Z.c)
