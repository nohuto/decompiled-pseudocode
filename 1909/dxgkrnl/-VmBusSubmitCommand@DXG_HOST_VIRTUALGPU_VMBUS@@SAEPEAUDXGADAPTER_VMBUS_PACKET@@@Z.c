/*
 * XREFs of ?VmBusSubmitCommand@DXG_HOST_VIRTUALGPU_VMBUS@@SAEPEAUDXGADAPTER_VMBUS_PACKET@@@Z @ 0x1C022A200
 * Callers:
 *     <none>
 * Callees:
      ...
      if ( v12 - 408 >= (unsigned __int64)(unsigned int)v11 )
      {
        ...
        if ( v14 >= *(unsigned int *)(v10 + 320) )
        {
          ...
          *(_QWORD *)(v10 + 312) = (unsigned int)v11 + v10 + 408;
          Current = DXGPROCESS::GetCurrent(v14, (unsigned int)v11);
          v17 = DxgkSubmitCommandInternal((struct _D3DKMT_SUBMITCOMMAND *)(v10 + 24), Current, v16);
LABEL_12:
