/*
 * XREFs of ?DdiSetTargetGamma@ADAPTER_DISPLAY@@QEAAJPEBU_DXGKARG_SETTARGETGAMMA@@@Z @ 0x1C01FE07C
 * Callers:
        ...
        const GUID *a3)
{
  ...
  DXGETWPROFILER_BASE_PushProfilerEntry((__int64)&v30, 5077LL);
...
LABEL_16:
  ...
  v15 = (*(int (__fastcall **)(_QWORD, const struct _DXGKARG_SETTARGETGAMMA *))(*((_QWORD *)this + 2) + 1056LL))(
  ...
  *(_QWORD *)(v21 + 24) = v15;
  *(_QWORD *)(v21 + 32) = a2->TargetId;
  WdLogEvent5_WdEvent(v21);
  if ( (_DWORD)v15 != -1073741801 && (_DWORD)v15 != -1071774904 && (_DWORD)v15 )
  {
