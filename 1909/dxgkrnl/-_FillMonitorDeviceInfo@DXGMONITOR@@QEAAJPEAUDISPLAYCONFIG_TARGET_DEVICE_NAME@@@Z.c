/*
 * XREFs of ?_FillMonitorDeviceInfo@DXGMONITOR@@QEAAJPEAUDISPLAYCONFIG_TARGET_DEVICE_NAME@@@Z @ 0x1C01290D8
 * Callers:
...
__int64 __fastcall DXGMONITOR::_FillMonitorDeviceInfo(DXGMONITOR *this, struct DISPLAYCONFIG_TARGET_DEVICE_NAME *a2)
{
  ...
  if ( v7 )
  {
    ...
    if ( v10 < 0 )
    {
      v18 = WdLogNewEntry5_WdDmmEvent(v12, v11);
      *(_QWORD *)(v18 + 24) = *((_QWORD *)this + 18) + 24LL;
      *(_QWORD *)(v18 + 32) = v13;
