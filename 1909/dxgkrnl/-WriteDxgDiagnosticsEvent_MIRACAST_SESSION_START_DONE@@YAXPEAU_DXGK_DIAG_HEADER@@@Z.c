/*
 * XREFs of ?WriteDxgDiagnosticsEvent_MIRACAST_SESSION_START_DONE@@YAXPEAU_DXGK_DIAG_HEADER@@@Z @ 0x1C0041848
 * Callers:
...
void __fastcall WriteDxgDiagnosticsEvent_MIRACAST_SESSION_START_DONE(struct _DXGK_DIAG_HEADER *a1)
{
  ...
  {
    if ( TlgKeywordOn(v1, 0x200000000400uLL) )
    {
      v7 = 4LL;
      v6 = &unk_1C006E57C;
      v8 = v11;
      ...
      v10 = v3;
      v11[1] = (_DWORD)v2;
      TlgWrite(v4, &unk_1C0072D99, 0LL, v2, 5u, &pData);
    }
  }
}
