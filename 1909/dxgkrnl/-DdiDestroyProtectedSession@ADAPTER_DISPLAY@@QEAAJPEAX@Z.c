/*
 * XREFs of ?DdiDestroyProtectedSession@ADAPTER_DISPLAY@@QEAAJPEAX@Z @ 0x1C01F9DD8
 * Callers:
...
__int64 __fastcall ADAPTER_DISPLAY::DdiDestroyProtectedSession(ADAPTER_DISPLAY *this, void *a2, const GUID *a3)
{
  ...
  DXGETWPROFILER_BASE_PushProfilerEntry((__int64)&v30, 5109LL);
...
LABEL_16:
  ...
  v15 = (*(int (__fastcall **)(_QWORD, void *))(*((_QWORD *)this + 2) + 1144LL))(
