/*
 * XREFs of NtGdiCLIPOBJ_cEnumStart @ 0x1C02AAC30
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall NtGdiCLIPOBJ_cEnumStart(__int64 a1, __int64 a2, __int64 a3, unsigned int a4, unsigned int a5)
{
  int v7; // r14d
  int v8; // r15d
...
LABEL_7:
  ...
  v12 = XCLIPOBJ::cEnumStart(v13, v8, v7, a4, a5);
LABEL_8:
  if ( v11 )
    --*((_DWORD *)v11 + 105);
  return v12;
