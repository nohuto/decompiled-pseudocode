/*
 * XREFs of ?PromoteToMouse@Pointer@InputTraceLogging@@SAXKGKG@Z @ 0x1C0207B74
 * Callers:
...
void __fastcall InputTraceLogging::Pointer::PromoteToMouse(int a1, __int16 a2)
{
  ...
  {
    if ( TlgKeywordOn((TraceLoggingHProvider)&dword_1C03202C0, 0x20uLL) )
    {
      v9 = v4;
      v8 = &v16;
      v10 = &v17;
      ...
      v13 = v4;
      v15 = v4;
      TlgWrite((TraceLoggingHProvider)&dword_1C03202C0, &unk_1C02E787B, 0LL, 0LL, 6u, &pData);
    }
  }
}
