/*
 * XREFs of DefSetText @ 0x1C0028FAC
 * Callers:
 ...
 *     ??4?$SharedPointerFieldBuffer@G@ProtectedLargeUnicodeStringWNDstrName@tagWND@@QEAAPEAGPEAG@Z @ 0x1C002924C (--4-$SharedPointerFieldBuffer@G@ProtectedLargeUnicodeStringWNDstrName@tagWND@@QEAAPEAGPEAG@Z.c)
...
LABEL_26:
  ...
  if ( (*(_DWORD *)(a1[5] + 188LL) & 0x7FFFFFFFu) >= (unsigned int)v6 )
    goto LABEL_14;
  if ( *v7 )
  {
...
LABEL_14:
    ...
    {
      *(_DWORD *)(v12 + 184) = v6 - 2;
      *((_WORD *)*v7 + ((unsigned __int64)*(unsigned int *)(a1[5] + 184LL) >> 1)) = 0;
      goto LABEL_20;
    }
    v9 = 0;
    goto LABEL_26;
