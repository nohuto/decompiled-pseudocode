/*
 * XREFs of TimersProc @ 0x1C0078D30
 * Callers:
 ...
 *     ?CoalescableDueTime@@YAKPEBUtagTIMER@@@Z @ 0x1C01EBC44 (-CoalescableDueTime@@YAKPEBUtagTIMER@@@Z.c)
 *     ?ReadyTimer@@YAXPEAUtagTIMER@@K@Z @ 0x1C01EBCE0 (-ReadyTimer@@YAXPEAUtagTIMER@@K@Z.c)
 *     ThreadLockExchangeWorker @ 0x1C01EBF18 (ThreadLockExchangeWorker.c)
 */
