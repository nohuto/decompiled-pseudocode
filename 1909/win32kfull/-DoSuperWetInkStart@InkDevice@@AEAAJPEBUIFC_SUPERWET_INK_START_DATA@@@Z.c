/*
 * XREFs of ?DoSuperWetInkStart@InkDevice@@AEAAJPEBUIFC_SUPERWET_INK_START_DATA@@@Z @ 0x1C02505C4
 * Callers:
  ...
  if ( v5 >= 0 )
  {
    ...
    if ( v7 >= 0 )
    {
      if ( dword_1C031F298 > 4u )
      {
        ...
        v72 = &v17;
        v17 = -__CFSHR__(v9, 3);
        TlgWrite((TraceLoggingHProvider)&dword_1C031F298, &unk_1C02E8B0E, 0LL, 0LL, 0x1Bu, &v24);
      }
    }
