/*
 * XREFs of DestroyThreadHidObjects @ 0x1C00E6C10
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall DestroyThreadHidObjects(__int64 a1)
{
  ...
  __int64 v12; // rax
  __int64 v13; // rax
  const struct tagPROCESSINFO *v14; // rcx
  struct tagPROCESSINFO *v15; // rcx
  struct tagPROCESS_HID_REQUEST *v16; // rcx
  ...
  *(_DWORD *)(v2 + 96) = 0;
  ...
  {
    v14 = *(const struct tagPROCESSINFO **)(a1 + 416);
    *(_DWORD *)(a1 + 1224) = result & 0xFFDFFFFF;
    result = HasRawKeyboardPerThreadRegistration(v14);
    if ( !(_DWORD)result )
    {
      result = (__int64)SearchProcessHidRequest(v15, 1u, 6u, &v17);
      if ( result )
      {
  ...
  while ( v10 != (struct tagPROCESS_HID_REQUEST *)(v2 + 48) )
  {
    ...
    if ( result && *(_QWORD *)(result + 16) == a1 )
    {
      result = FreeHidProcessRequest(v16);
      v6 = 1;
    }
  }
  if ( v6 )
