/*
 * XREFs of ?GenerateMessages@InteractiveControlDefaultScroller@@QEAAJPEAUtagINTERACTIVECTRL_INFO@@W4tagINTERACTIVECTRL_PROMOTION_TYPE@@@Z @ 0x1C0255108
 * Callers:
        ...
        *((_DWORD *)a1 + 15) = v9;
        ...
        if ( updated >= 0 )
        {
          ...
          if ( updated >= 0 )
          {
            ...
            if ( updated >= 0 || dword_1C031F308 <= 2u )
              return (unsigned int)updated;
          }
