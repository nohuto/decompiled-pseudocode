/*
 * XREFs of ?CreatePhysicalMonitor@CMonitorAPI@@QEAAJAEAU_LUID@@KPEAPEAX@Z @ 0x1C026DBF0
 * Callers:
 *     CreatePhysicalMonitorWrap @ 0x1C026F060 (CreatePhysicalMonitorWrap.c)
 * Callees:
 *     _guard_dispatch_icall_nop @ 0x1C01680F0 (_guard_dispatch_icall_nop.c)
 *     ??0CPhysicalMonitorHandle@@QEAA@AEAU_LUID@@KPEAJ@Z @ 0x1C026D908 (--0CPhysicalMonitorHandle@@QEAA@AEAU_LUID@@KPEAJ@Z.c)
...
__int64 __fastcall CMonitorAPI::CreatePhysicalMonitor(CMonitorAPI *this, struct _LUID *a2, unsigned int a3, void **a4)
{
  ...
  v14 = this;
  v4 = qword_1C032A778;
  OPM::CAutoMutex::CAutoMutex((OPM::CAutoMutex *)v13, (struct OPM::CMutex *)qword_1C032A778);
  v12 = 0LL;
  LODWORD(v14) = 0;
