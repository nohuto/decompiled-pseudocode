/*
 * XREFs of PostPointerEventMessage @ 0x1C01EF700
 * Callers:
 *     PostDeviceNotification @ 0x1C00E7D84 (PostDeviceNotification.c)
 *     PostPointerDeviceInRangeMessage @ 0x1C01EF6C0 (PostPointerDeviceInRangeMessage.c)
 *     PostPointerDeviceOutOfRangeMessage @ 0x1C01EF6E0 (PostPointerDeviceOutOfRangeMessage.c)
 * Callees:
