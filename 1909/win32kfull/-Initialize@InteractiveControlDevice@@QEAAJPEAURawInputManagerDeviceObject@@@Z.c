/*
 * XREFs of ?Initialize@InteractiveControlDevice@@QEAAJPEAURawInputManagerDeviceObject@@@Z @ 0x1C0253484
 * Callers:
 ...
 *     ?InitializeWaveformOrdinalForDevice@InteractiveControlDevice@@QEAAJXZ @ 0x1C02538FC (-InitializeWaveformOrdinalForDevice@InteractiveControlDevice@@QEAAJXZ.c)
...
NTSTATUS __fastcall InteractiveControlDevice::Initialize(InteractiveControlDevice *this, char *Object)
{
  ...
  {
    v6 = dword_1C0323B9C;
    *((_DWORD *)this + 2) = dword_1C0323B9C;
    *(_QWORD *)this = Object;
    dword_1C0323B9C = v6 + 1;
