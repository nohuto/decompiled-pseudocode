/*
 * XREFs of ?vAddStartCap@WIDENER@@IEAAXXZ @ 0x1C015B438
 * Callers:
...
void __fastcall WIDENER::vAddStartCap(WIDENER *this)
{
  ...
  if ( v2 )
  {
    ...
    if ( v3 )
    {
      if ( v3 != 1 )
        return;
      v4 = WIDENER::vecOutPerp(this, &v17);
      v5 = 1;
    ...
    else
    {
      ...
      v11 = -HIDWORD(*(_QWORD *)(v9 + 56));
      LODWORD(v17) = -(int)*(_QWORD *)(v9 + 56);
      v10 = v17;
      HIDWORD(v17) = v11;
      v18 = v17;
      v12 = WIDENER::vecOutPerp(this, &v19);
      v13 = v12[1];
      LODWORD(v17) = v10 + *v12;
      HIDWORD(v17) = v11 + v13;
  ...
  else
  {
    if ( (*((_DWORD *)this + 10) & 0x10) != 0 )
      ...
      v16 = WIDENER::vecOutPerp(this, &v17);
    v8 = (struct _POINTFIX *)((char *)this + 692);
    v7 = (WIDENER *)((char *)this + 1136);
    v17 = *v16;
