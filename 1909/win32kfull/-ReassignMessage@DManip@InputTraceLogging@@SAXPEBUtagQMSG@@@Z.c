/*
 * XREFs of ?ReassignMessage@DManip@InputTraceLogging@@SAXPEBUtagQMSG@@@Z @ 0x1C01E27F0
 * Callers:
...
void __fastcall InputTraceLogging::DManip::ReassignMessage(const struct tagQMSG *a1)
{
  ...
  if ( IsPointerInputMessage(*((_DWORD *)a1 + 6)) )
  {
    if ( dword_1C03202C0 > 4u )
    {
      if ( TlgKeywordOn((TraceLoggingHProvider)&dword_1C03202C0, 0x1000uLL) )
      {
        ...
        v11 = v3;
        v28 = v2;
        TlgWrite((TraceLoggingHProvider)&dword_1C03202C0, &unk_1C02E7579, 0LL, 0LL, 7u, &pData);
      }
    }
  }
         ...
         && TlgKeywordOn((TraceLoggingHProvider)&dword_1C03202C0, 0x1000uLL) )
  {
    ...
    v11 = v7;
    v19 = cData;
    TlgWrite((TraceLoggingHProvider)&dword_1C03202C0, &unk_1C02E75E2, 0LL, 0LL, cData, &pData);
  }
}
