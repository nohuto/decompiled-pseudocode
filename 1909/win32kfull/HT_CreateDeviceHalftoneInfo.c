/*
 * XREFs of HT_CreateDeviceHalftoneInfo @ 0x1C00C5780
 * Callers:
 ...
 *     GetCIEPrims @ 0x1C00C5F7C (GetCIEPrims.c)
 *     ComputeHTCell @ 0x1C00C6178 (ComputeHTCell.c)
 *     MulDivFD6Pairs @ 0x1C00C690C (MulDivFD6Pairs.c)
