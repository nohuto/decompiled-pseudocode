/*
 * XREFs of ?ParseInputReport@InteractiveControlParser@@SAJPEAVInteractiveControlDevice@@PEAEKPEAUtagINTERACTIVECTRL_INFO@@@Z @ 0x1C0258C14
 * Callers:
...
LABEL_13:
    ...
    if ( v6 < 0 )
    {
      if ( v6 != -2146369535 && dword_1C031F308 > 2u )
      {
        v48 = 0;
        v51 = 0;
        v54 = 0;
        ...
        v56 = 4;
        v59 = 4;
        TlgWrite((TraceLoggingHProvider)&dword_1C031F308, &unk_1C02E9082, 0LL, 0LL, 7u, &pData);
      }
      v6 = 0;
      goto LABEL_52;
    }
      ...
      case 3:
        if ( v15 )
        {
          ...
          else if ( dword_1C031F308 > 2u )
          {
            ...
            v59 = 4;
            v62 = 4;
            TlgWrite((TraceLoggingHProvider)&dword_1C031F308, &unk_1C02E9006, 0LL, 0LL, 8u, &pData);
          }
        }
        goto LABEL_52;
      case 5:
    ...
    if ( !*((_QWORD *)a1 + 30) )
    {
      ...
      if ( v30 == 100 )
      {
        if ( dword_1C031F308 > 3u )
        {
          ...
          v66 = 72;
          TlgWrite((TraceLoggingHProvider)&dword_1C031F308, &unk_1C02E8FD6, 0LL, 0LL, 3u, &v64);
        }
