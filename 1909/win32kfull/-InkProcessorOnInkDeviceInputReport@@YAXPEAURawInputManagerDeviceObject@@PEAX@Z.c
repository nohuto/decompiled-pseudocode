/*
 * XREFs of ?InkProcessorOnInkDeviceInputReport@@YAXPEAURawInputManagerDeviceObject@@PEAX@Z @ 0x1C020ECF4
 * Callers:
        ...
        const void *a3)
{
  ...
  else if ( dword_1C031F298 > 2u )
  {
    ...
    v6 = 4;
    TlgWrite((TraceLoggingHProvider)&dword_1C031F298, &unk_1C02E7931, 0LL, 0LL, 3u, &v4);
  }
}
