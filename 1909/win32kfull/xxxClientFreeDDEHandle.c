/*
 * XREFs of xxxClientFreeDDEHandle @ 0x1C021EA4C
 * Callers:
...
__int64 __fastcall xxxClientFreeDDEHandle(__int64 a1, int a2, __int64 a3)
{
  int v3; // ebx
  __int64 v4; // rdx
  __int64 v5; // r8
  ...
  v3 = KeUserModeCallback(67LL, &v8, 16LL, &v14, &v13);
