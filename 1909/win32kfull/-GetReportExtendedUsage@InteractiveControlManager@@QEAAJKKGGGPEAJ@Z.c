/*
 * XREFs of ?GetReportExtendedUsage@InteractiveControlManager@@QEAAJKKGGGPEAJ@Z @ 0x1C024DB84
 * Callers:
 ...
 *     ?ExtractCustomUsage@InteractiveControlParser@@SAJPEAU_HIDP_PREPARSED_DATA@@PEAEKGGGPEAJ@Z @ 0x1C0258790 (-ExtractCustomUsage@InteractiveControlParser@@SAJPEAU_HIDP_PREPARSED_DATA@@PEAEKGGGPEAJ@Z.c)
 */
        ...
        int *a7)
{
  ...
  if ( dword_1C031F308 > 4u )
  {
    ...
    v29 = 2LL;
    v31 = 2LL;
    TlgWrite((TraceLoggingHProvider)&dword_1C031F308, &unk_1C02E866A, 0LL, 0LL, 8u, &pData);
  }
  ...
  else
  {
    ...
    v21 = 17LL;
    v23 = 4LL;
    TlgWrite((TraceLoggingHProvider)&dword_1C031F308, &unk_1C02E83ED, v12, 0LL, 4u, &pData);
  }
  result = v14;
LABEL_12:
  if ( dword_1C031F308 > 4u )
  {
    ...
    v23 = 4LL;
    v25 = 4LL;
    TlgWrite((TraceLoggingHProvider)&dword_1C031F308, &unk_1C02E862A, 0LL, 0LL, 5u, &pData);
    return v14;
  }
  return result;
}
