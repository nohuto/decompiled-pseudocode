/*
 * XREFs of ?xxxActivateWindowWithOptions@@YA_NPEAUtagWND@@W4ActivateWindowKind@@W4ComputeWindowToActivateStrategy@@W4WindowActivateReason@@@Z @ 0x1C0133A90
 * Callers:
...
LABEL_44:
  ...
  if ( *(_QWORD *)(v11 + 424) == *(_QWORD *)(gptiCurrent + 424LL) )
  {
    ...
    if ( v8 )
      ...
      v24 = anonymous_namespace_::xxxLocalActivateWindow((struct tagWND *)v10, 0, -(a4 != 0) - 127);
  }
  else
  {
    if ( v11 == gptiCurrent )
