/*
 * XREFs of ?ppfeGetAMatch@@YAPEAVPFE@@AEAVXDCOBJ@@PEAUtagENUMLOGFONTEXDVW@@PEBGKKPEAKPEAU_POINTL@@3H@Z @ 0x1C0047D74
 * Callers:
        ...
        int a9)
{
  ...
  {
    v29 |= 0x80u;
    v14 = DEVICE_PFTOBJ::pPFFGet((DEVICE_PFTOBJ *)&v19, *(HDEV *)(*(_QWORD *)a1 + 48LL), 0LL);
    v16 = v14;
    if ( v14 )
    {
