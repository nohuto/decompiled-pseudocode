/*
 * XREFs of ?SetComponentResolution@InteractiveControlDevice@@QEAAJW4_INTERACTIVECTRL_COMPONENT_TYPE@@JPEAW4tagINTERACTIVECTRL_HAPTICS_MODE@@@Z @ 0x1C0253F50
 * Callers:
...
__int64 __fastcall InteractiveControlDevice::SetComponentResolution(__int64 a1, int a2, int a3, _DWORD *a4)
{
  ...
  USHORT v27[2]; // [rsp+48h] [rbp-B8h] BYREF
  NTSTATUS v28; // [rsp+4Ch] [rbp-B4h] BYREF
  _DWORD *v29; // [rsp+50h] [rbp-B0h]
  _QWORD *v30; // [rsp+58h] [rbp-A8h]
  ...
  const char *v36; // [rsp+130h] [rbp+30h]
...
LABEL_58:
  ...
  if ( SpecificValueCaps >= 0 )
  {
    ...
    if ( *((_DWORD *)v15 + 31) != LogicalMin || v29 && *v29 != *(_DWORD *)(a1 + 60) )
    {
      if ( !v9 )
      {
      ...
      *v9 = ValueCaps.ReportID;
        ...
        && SimpleHapticsController::SendDeviceIOControl(v20, 0xB0192u, 0LL, 0, v9, *(unsigned __int16 *)(a1 + 84), 0LL) >= 0 )
      {
        if ( v29 )
        {
          ...
          v27[0] = 1;
          HidP_GetSpecificValueCaps(HidP_Feature, 0xEu, 0, 0x20u, &v32, v27, *(PHIDP_PREPARSED_DATA *)(a1 + 256));
          HidP_SetUsageValue(
            HidP_Feature,
            0xEu,
            v32.LinkCollection,
...
LABEL_57:
  ...
  if ( SpecificValueCaps == -1072627708 )
  {
    ...
    {
      v38 = 0;
      v36 = "Device does not support resolution multiplier. Falling back to OS based scaling.";
      v37 = 81;
  ...
  if ( dword_1C031F308 > 2u )
  {
    v32.LogicalMax = 0;
    v34 = 0;
    *(_QWORD *)&v32.UnitsExp = "Failed to updated device resolution multiplier. Keeping existing actual resolution.";
    *(_QWORD *)&v32.PhysicalMin = &v28;
    v25 = *((_DWORD *)v15 + 28);
    *(_QWORD *)&v32.NotRange.DesignatorIndex = &v25;
    v32.LogicalMin = 84;
    v28 = SpecificValueCaps;
    *(_QWORD *)&v32.Range.UsageMin = 4LL;
    v33 = 4;
    TlgWrite((TraceLoggingHProvider)&dword_1C031F308, &unk_1C02E8CEF, 0LL, 0LL, 5u, (EVENT_DATA_DESCRIPTOR *)&v32);
  }
LABEL_63:
  if ( v9 )
    Win32FreePool(v9);
