/*
 * XREFs of ?GreAddSpriteOverlapPresent@@YAHPEAUHDEV__@@PEAUHWND__@@@Z @ 0x1C027BACC
 * Callers:
 ...
 * Callees:
 *     ?pSpGetPresent@@YAPEAU_PRESENT@@PEAUHDEV__@@PEAUHWND__@@@Z @ 0x1C0038360 (-pSpGetPresent@@YAPEAU_PRESENT@@PEAUHDEV__@@PEAUHWND__@@@Z.c)
 ...
 *     ?vSpRemovePresent@@YAXPEAUHDEV__@@PEAU_PRESENT@@@Z @ 0x1C0280D60 (-vSpRemovePresent@@YAXPEAUHDEV__@@PEAU_PRESENT@@@Z.c)
 */
...
__int64 __fastcall GreAddSpriteOverlapPresent(_DWORD *a1, HWND a2)
{
  ...
  while ( 1 )
  {
    ...
    Present = pSpGetPresent(*(_QWORD **)(*((_QWORD *)a1 + 19) + 8LL * v7), a2);
    if ( !Present )
      break;
LABEL_6:
  ...
  for ( i = 0; i < a1[37]; ++i )
  {
    ...
    v12 = pSpGetPresent(*(_QWORD **)(*((_QWORD *)a1 + 19) + 8LL * i), a2);
    Present = v12;
    if ( v12 )
    {
