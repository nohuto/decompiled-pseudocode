/*
 * XREFs of ?Disconnect@CUserPlaySound@@AEAAJXZ @ 0x1C01133F4
 * Callers:
 *     NtUserDoSoundConnect @ 0x1C011A4D0 (NtUserDoSoundConnect.c)
 *     NtUserDoSoundDisconnect @ 0x1C011C4C0 (NtUserDoSoundDisconnect.c)
 * Callees:
 *     PlaySoundDisconnect @ 0x1C03680F0 (PlaySoundDisconnect.c)
 */
