/*
 * XREFs of ?bLoadFonts@PUBLIC_PFTOBJ@@QEAAHPEAGKKPEAUtagDESIGNVECTOR@@KPEAKKPEAPEAVPFF@@KHPEAU_EUDCLOAD@@HH@Z @ 0x1C0092F60
 * Callers:
        ...
        int a14)
{
  ...
  void **v88; // [rsp+C0h] [rbp-50h] BYREF
  struct PFF **v89; // [rsp+C8h] [rbp-48h] BYREF
  HDEV v90; // [rsp+D0h] [rbp-40h] BYREF
  HDEV v91; // [rsp+D8h] [rbp-38h] BYREF
  ...
  if ( a2 && a4 <= 3 )
  {
    ...
    if ( !a11 )
    {
      ...
      *a7 = 0;
      v22 = a12;
      v85[0] = a12 != 0LL;
      v23 = PUBLIC_PFTOBJ::pPFFGet(v16, v21, v20, v15, a5, a6, &v89, v85[0]);
      *v14 = v23;
      if ( v23 )
      {
...
LABEL_13:
      ...
      v27 = PUBLIC_PFTOBJ::pPFFGet(v16, SourceString, v98, v15, a5, a6, &v89, v22 == 0LL);
      if ( v27 && !a14 && !*((_QWORD *)v27 + 19) )
      {
        ...
        if ( v86[0] )
        {
          if ( (unsigned int)PFFMEMOBJ::bLoadFontFileTable((PFFMEMOBJ *)v86, SourceString, v64, 0LL, a12) )
          {
            ...
            GreAcquireSemaphore(ghsemPublicPFT);
            v65 = PUBLIC_PFTOBJ::pPFFGet(v16, SourceString, v98, v15, a5, a6, &v89, v85[0]);
            *v14 = v65;
            if ( v65
    ...
    v92 = 0LL;
    SEMOBJ::vUnlock((SEMOBJ *)&v93);
    MALLOCOBJ::MALLOCOBJ((MALLOCOBJ *)&v88, 12 * v15);
    v28 = v88;
    if ( !v88
      || (v94 = (unsigned int *)&v88[v15],
          v90 = (HDEV)PALLOCMEM2((unsigned int)((_DWORD)v15 << 7)),
          (v29 = (struct _FONTFILEVIEW **)v90) == 0LL) )
    {
      v17 = 0;
      goto LABEL_61;
    }
    ...
    v31 = SourceString;
    *(_QWORD *)v85 = SourceString;
    v91 = (HDEV)((char *)v90 + (unsigned int)(8 * v15));
    if ( (_DWORD)v15 )
    {
      v32 = v94;
      v33 = v28;
      v34 = v91;
      v35 = v90;
      v36 = (char *)v33 - (char *)v90;
      v37 = v15;
      do
      {
        *(_QWORD *)v35 = v34;
        *((_QWORD *)v34 + 10) = v31;
        *(_DWORD *)(*(_QWORD *)v35 + 40LL) = *(_DWORD *)(*(_QWORD *)v35 + 40LL) & 0xFFFFFFF7 | (8
                                                                                              * IsTrustedFontFilePath(v31));
        v31 = *(const WCHAR **)v85;
        *(_QWORD *)((char *)v35 + v36) = 0LL;
        *v32 = 0;
        while ( *v31++ )
          ;
        v34 += 30;
...
LABEL_30:
        ...
        if ( !v92 )
          goto LABEL_59;
        FontFile = PDEVOBJ::QueryFontFile((PDEVOBJ *)&v90, v92, 2u, 0, 0LL);
        v41 = FontFile;
...
LABEL_57:
          ...
          v90 = (HDEV)ghsemPublicPFT;
          GreAcquireSemaphore(ghsemPublicPFT);
          FontFile = a12 != 0LL;
          v44 = PUBLIC_PFTOBJ::pPFFGet(v16, SourceString, v98, v15, a5, a6, &v89, FontFile);
          v45 = a9;
          *a9 = v44;
          if ( v44 )
          {
