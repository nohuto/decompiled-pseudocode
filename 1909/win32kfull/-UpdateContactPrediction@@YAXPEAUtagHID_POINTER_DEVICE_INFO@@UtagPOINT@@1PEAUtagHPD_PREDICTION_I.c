/*
 * XREFs of ?UpdateContactPrediction@@YAXPEAUtagHID_POINTER_DEVICE_INFO@@UtagPOINT@@1PEAUtagHPD_PREDICTION_INFO@@PEAU2@3@Z @ 0x1C01EE1F0
 * Callers:
 ...
 *     ?DeltaOvershootCompensation@Prediction@@YA_J_J0@Z @ 0x1C01ECE8C (-DeltaOvershootCompensation@Prediction@@YA_J_J0@Z.c)
 ...
 *     ?Smooth@tagExpoSmoother@Prediction@@QEAA?AVCFixPred@2@V32@@Z @ 0x1C01EE060 (-Smooth@tagExpoSmoother@Prediction@@QEAA-AVCFixPred@2@V32@@Z.c)
 */
