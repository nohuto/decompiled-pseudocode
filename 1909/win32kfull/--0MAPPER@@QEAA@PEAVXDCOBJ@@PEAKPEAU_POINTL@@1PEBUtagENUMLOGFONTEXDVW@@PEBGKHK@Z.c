/*
 * XREFs of ??0MAPPER@@QEAA@PEAVXDCOBJ@@PEAKPEAU_POINTL@@1PEBUtagENUMLOGFONTEXDVW@@PEBGKHK@Z @ 0x1C0045CC0
 * Callers:
 ...
 *     ?bGetFaceName@MAPPER@@AEAAHXZ @ 0x1C00E04CC (-bGetFaceName@MAPPER@@AEAAHXZ.c)
...
LABEL_76:
  ...
  *((_DWORD *)this + 42) = abs32(v42);
  ...
  if ( !(unsigned int)IsThreadCrossSessionAttached(a6, (unsigned int)(v42 >> 31), v19) )
  {
    ...
    if ( ThreadWin32Thread )
    {
      ...
      if ( *ThreadWin32Thread )
      {
        ...
        if ( *(_DWORD *)(v48 + 340) )
        {
          LOBYTE(v41) = *(_DWORD *)(v48 + 340);
        }
        else
        {
          CurrentProcessWin32Process = PsGetCurrentProcessWin32Process(v47, v44);
  ...
  if ( (v51 & 1) != 0 && (v41 & 0xFu) - 1 > 1 )
    v52 = 96;
  else
    v52 = *(_DWORD *)&a6[5].elfEnumLogfontEx.elfLogFont.lfFaceName[24];
  *((_DWORD *)this + 61) = v52;
  v53 = KeGetCurrentThread();
  if ( !(unsigned int)IsThreadCrossSessionAttached(v51, v44, v45) )
  {
