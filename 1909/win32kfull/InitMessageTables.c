/*
 * XREFs of InitMessageTables @ 0x1C037F1E0
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall InitMessageTables(int a1)
{
  ...
  if ( WPP_RECORDER_INITIALIZED != (_UNKNOWN *)&WPP_RECORDER_INITIALIZED )
    WPP_RECORDER_SF_(a1, 4, 3, 12, (__int64)&WPP_d004ad31927635d751620a95da27af8f_Traceguids);
  LODWORD(v1) = 0;
