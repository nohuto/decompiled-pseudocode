/*
 * XREFs of GreWindowResizeStarted @ 0x1C026D63C
 * Callers:
 ...
 *     UserDCompositionCreateSynchronizationObject @ 0x1C020F094 (UserDCompositionCreateSynchronizationObject.c)
...
__int64 __fastcall GreWindowResizeStarted(__int64 a1, HWND a2, int a3, unsigned int *a4, unsigned int *a5)
{
  ...
  if ( g_pDwmState )
  {
    DWMSPRITELOCK::DWMSPRITELOCK((DWMSPRITELOCK *)&v33, v10, 0LL, 0);
