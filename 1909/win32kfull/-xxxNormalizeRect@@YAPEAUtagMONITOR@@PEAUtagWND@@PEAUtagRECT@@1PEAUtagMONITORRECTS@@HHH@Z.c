/*
 * XREFs of ?xxxNormalizeRect@@YAPEAUtagMONITOR@@PEAUtagWND@@PEAUtagRECT@@1PEAUtagMONITORRECTS@@HHH@Z @ 0x1C01303AC
 * Callers:
        ...
        int a7)
{
  ...
  __m128i v94; // [rsp+B0h] [rbp-50h] BYREF
  ...
  if ( !v13 || !(unsigned int)IsValidMonitor(v13) )
  {
    ...
    if ( !NewMonitor )
    {
      v15 = *(_QWORD *)(GetDispInfo(v60, v59) + 96);
  ...
  if ( v18 == 2 )
  {
    if ( a7 && (*(_DWORD *)(*((_QWORD *)a1 + 2) + 640LL) & 0x2000000) == 0 && !a6 && (_WORD)v17 != (_WORD)v16 )
    {
      ...
      v92 = 0LL;
      v93 = 0LL;
      ThreadWin32Thread = W32GetThreadWin32Thread((__int64)KeGetCurrentThread(), v17, v16);
      v88 = *(_QWORD *)(ThreadWin32Thread + 408);
      *(_QWORD *)(ThreadWin32Thread + 408) = &v88;
      v89 = a1;
      HMLockObject(a1);
      v62 = NewMonitor;
      v65 = W32GetThreadWin32Thread((__int64)KeGetCurrentThread(), v63, v64);
      v91 = *(_QWORD *)(v65 + 408);
      *(_QWORD *)(v65 + 408) = &v91;
      v92 = v62;
      HMLockObject(v62);
...
LABEL_7:
  if ( a6 )
  {
    if ( a6 == 1 )
    {
      v48 = *GetMonitorWorkRectForWindow(&v95, v15, a1);
      v49 = (struct tagRECT *)&v97;
      v97 = v48;
    }
    else
    {
      v56 = *GetMonitorRectForWindow(&v96, v15, a1);
      v49 = (struct tagRECT *)&v98;
      v98 = v56;
    }
    v50 = *((_DWORD *)a1 + 77) == 0;
    v85 = *v49;
    if ( v50 )
    {
      WindowBordersWithDpiAwareness = GetWindowBordersWithDpiAwareness((__int64)a1, v47);
      v52 = v85.left - WindowBordersWithDpiAwareness;
      v53 = v85.top - WindowBordersWithDpiAwareness;
      a2->left = v85.left - WindowBordersWithDpiAwareness;
      a2->top = v53;
      WindowBordersWithDpiAwareness *= 2;
      v54 = v53 + WindowBordersWithDpiAwareness - v85.top;
      v55 = v85.right + v52 + WindowBordersWithDpiAwareness - v85.left;
      a2->bottom = v85.bottom + v54;
      a2->right = v55;
    }
    else
    {
