/*
 * XREFs of ?vXlatGlyphArray@RFONTOBJ@@QEAAXPEBGIPEAKKH@Z @ 0x1C009D0E0
 * Callers:
        ...
        int a6)
{
  ...
  if ( a6 )
  {
    ...
    {
      v8 = *(__int64 **)(v6[16] + 8LL * ((v39 - 1) & 0xFFFFFFFE) + 216);
      v51 = v8;
      v52 = v8;
      if ( v8 )
      {
...
LABEL_53:
        ...
        {
          v47 = *a2;
          if ( *a2 >= gqlTTSystem && v47 <= (unsigned __int16)word_1C032C032 )
          {
            v48 = v47 - gqlTTSystem;
            ...
            if ( ((0x80000000 >> v49) & *(_DWORD *)(qword_1C032C038 + 4LL * (v48 >> 5))) != 0 )
LABEL_55:
