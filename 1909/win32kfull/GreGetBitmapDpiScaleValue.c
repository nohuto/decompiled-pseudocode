/*
 * XREFs of GreGetBitmapDpiScaleValue @ 0x1C0298AF8
 * Callers:
 *     zzzUpdateWindowsAfterModeChange @ 0x1C00CBC74 (zzzUpdateWindowsAfterModeChange.c)
 *     NtGdiGetBitmapDpiScaleValue @ 0x1C02A72F0 (NtGdiGetBitmapDpiScaleValue.c)
 * Callees:
...
__int64 __fastcall GreGetBitmapDpiScaleValue(__int64 a1, __int64 a2)
{
  ...
  v3 = v2;
  if ( !v2 || (*(_DWORD *)(v2 + 116) & 0x800) == 0 || (v4 = bFToL(*(float *)(v2 + 660), (int *)&v7, 6u), v5 = v7, !v4) )
    v5 = 1;
  if ( v3 )
