/*
 * XREFs of MicrosoftTelemetryAssertTriggeredWorker @ 0x1C02D497C
 * Callers:
...
LABEL_40:
  ...
  v21 = "<unknown>";
  if ( (unsigned int)dword_1C0367040 > 5 && TlgKeywordOn((TraceLoggingHProvider)&dword_1C0367040, 0x400000000000uLL) )
  {
    v22 = "<unknown>";
    v29 = 10;
    v30 = v15;
    ...
    TlgWrite((TraceLoggingHProvider)&dword_1C0367040, &unk_1C02E955F, 0LL, 0LL, 0xBu, &pData);
  }
  if ( TraceLoggingProviderEnabled((TraceLoggingHProvider)&dword_1C0367078, v20, 0LL) && !v19 && !KeGetCurrentIrql() )
  {
    ...
    if ( (unsigned int)dword_1C0367040 > 5 && TlgKeywordOn((TraceLoggingHProvider)&dword_1C0367040, 0x400000000000uLL) )
    {
      ...
      v56 = 4LL;
      v58 = 4LL;
      TlgWrite((TraceLoggingHProvider)&dword_1C0367040, &unk_1C02E94F6, 0LL, v25, cData, &v43);
    }
