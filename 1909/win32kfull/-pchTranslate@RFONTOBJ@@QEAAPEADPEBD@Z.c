/*
 * XREFs of ?pchTranslate@RFONTOBJ@@QEAAPEADPEBD@Z @ 0x1C02A1140
 * Callers:
 *     ?pjTable@RFONTOBJ@@QEAAPEAEKPEAK@Z @ 0x1C02A1400 (-pjTable@RFONTOBJ@@QEAAPEAEKPEAK@Z.c)
 *     ?pvFile@RFONTOBJ@@QEAAPEAXPEAK@Z @ 0x1C02A14B0 (-pvFile@RFONTOBJ@@QEAAPEAXPEAK@Z.c)
 * Callees:
 *     ?MapFontFileInKernel@@YAJPEAXPEAPEAX@Z @ 0x1C02A0B3C (-MapFontFileInKernel@@YAJPEAXPEAPEAX@Z.c)
