/*
 * XREFs of ?bGetNtoWScale@@YAHPEAVEFLOAT@@AEAVDCOBJ@@AEAVRFONTOBJ@@AEAVPFEOBJ@@@Z @ 0x1C01450E8
 * Callers:
 *     GreGetKerningPairs @ 0x1C0144EE4 (GreGetKerningPairs.c)
 * Callees:
 *     ?pptlBaseline@IFIOBJ@@QEAAPEAU_POINTL@@XZ @ 0x1C0098990 (-pptlBaseline@IFIOBJ@@QEAAPEAU_POINTL@@XZ.c)
...
__int64 __fastcall bGetNtoWScale(struct EFLOAT *a1, struct DCOBJ *a2, struct RFONTOBJ *a3, struct PFEOBJ *a4)
{
  ...
  _BYTE v23[40]; // [rsp+80h] [rbp-21h] BYREF
  _BYTE v24[40]; // [rsp+A8h] [rbp+7h] BYREF

  memset(v23, 0, 0x24uLL);
  memset(v24, 0, 0x24uLL);
  EXFORMOBJ::EXFORMOBJ((EXFORMOBJ *)v20, (struct MATRIX *)v23, 0);
  EXFORMOBJ::EXFORMOBJ((EXFORMOBJ *)v18, (struct MATRIX *)v24, 0);
