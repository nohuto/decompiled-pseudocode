/*
 * XREFs of GreMaskBlt @ 0x1C0124474
 * Callers:
 ...
 *     NtGdiMaskBlt @ 0x1C01210B0 (NtGdiMaskBlt.c)
 * Callees:
        ...
        int a13)
{
  ...
  if ( !(unsigned int)XDCOBJ::bValidSurf((XDCOBJ *)v36) )
  {
    ...
    if ( (v30 & 0xE0) != 0 )
    {
      ...
      v45 = v38 + a5;
      if ( !(unsigned int)EXFORMOBJ::bXform((EXFORMOBJ *)v41, (struct ERECTL *)&v43) )
        goto LABEL_36;
...
LABEL_24:
  ...
  if ( ((unsigned __int8)*(_DWORD *)(*(_QWORD *)v46 + 32LL) & (unsigned __int8)v16) != 0 )
  {
    ...
    {
      if ( v40 && !(unsigned int)BLTRECORD::bEqualExtents((BLTRECORD *)v46) )
