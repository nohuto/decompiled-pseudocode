/*
 * XREFs of ?UnlinkAndFreeThreadPointerData@@YAXPEAUtagTHREADINPUTPOINTERLIST@@PEAUtagTHREADPOINTERDATA@@@Z @ 0x1C01F2374
 * Callers:
 *     xxxCleanupThreadPointerInputInfo @ 0x1C00E9610 (xxxCleanupThreadPointerInputInfo.c)
 *     EditionUnlinkAndFreeThreadPointerData @ 0x1C01F2FC0 (EditionUnlinkAndFreeThreadPointerData.c)
 * Callees:
 *     <none>
 */
