/*
 * XREFs of ?AcquireDeviceBackgroundAccess@InteractiveControlManager@@QEAAJKIIPEAUtagWND@@@Z @ 0x1C0079428
 * Callers:
        ...
        struct tagWND *a5)
{
  ...
  if ( dword_1C031F308 > 4u )
  {
    ...
    v15[0] = a5;
    v30 = 8;
    TlgWrite((TraceLoggingHProvider)&dword_1C031F308, &unk_1C02E8573, 0LL, 0LL, 7u, &pData);
    a4 = v33;
    a3 = v32;
  }
  while ( a3 <= a4 )
