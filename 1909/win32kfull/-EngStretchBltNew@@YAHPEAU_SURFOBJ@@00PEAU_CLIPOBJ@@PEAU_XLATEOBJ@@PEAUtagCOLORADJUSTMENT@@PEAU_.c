/*
 * XREFs of ?EngStretchBltNew@@YAHPEAU_SURFOBJ@@00PEAU_CLIPOBJ@@PEAU_XLATEOBJ@@PEAUtagCOLORADJUSTMENT@@PEAU_POINTL@@PEAU_RECTL@@54K@Z @ 0x1C00A7038
 * Callers:
 ...
 *     ?vInitBuffer@@YAXPEAU_STRRUN@@PEAU_RECTL@@K@Z @ 0x1C00EB584 (-vInitBuffer@@YAXPEAU_STRRUN@@PEAU_RECTL@@K@Z.c)
        ...
        unsigned int a11)
{
  ...
  SURFOBJ *v98; // rax
  int v99; // eax
  unsigned int (__fastcall *v100)(struct _SURFOBJ *, SURFOBJ *, _QWORD, XCLIPOBJ *, _QWORD, struct tagCOLORADJUSTMENT *, struct _POINTL *, struct _RECTL *, __int64 *, struct _POINTL *, unsigned int); // rax
  int v101; // ecx
  int v102; // eax
  int v103; // eax
  __int64 v104; // r13
  ...
  struct _POINTL *v141; // [rsp+128h] [rbp-440h]
  __int64 v142; // [rsp+130h] [rbp-438h]
  struct _POINTL *v143; // [rsp+138h] [rbp-430h]
...
LABEL_67:
  ...
  if ( v24 )
    goto LABEL_67;
  v55 = EngHTBlt(v25, v23, v26, v135, v136, v140, v141, a8, v14, v143, 0, 0LL);
  if ( v55 == -1 )
    goto LABEL_67;
  if ( v55 )
  {
                  ...
                  if ( v98 )
                  {
                    ...
                    if ( (*(_DWORD *)(v16 + 112) & 0x400) != 0 )
                      ...
                      v99 = ((__int64 (__fastcall *)(SURFOBJ *, struct _SURFOBJ *, _QWORD, unsigned __int64, __int64 *, struct _RECTL *))EngCopyBits)(
                              ...
                              v14);
                    if ( !v99
                      || (v100 = *(unsigned int (__fastcall **)(struct _SURFOBJ *, SURFOBJ *, _QWORD, XCLIPOBJ *, _QWORD, struct tagCOLORADJUSTMENT *, struct _POINTL *, struct _RECTL *, __int64 *, struct _POINTL *, unsigned int))(v20 + 2848)) == 0LL
...
LABEL_38:
  ...
  else
  {
    ...
    v141 = (struct _POINTL *)v14;
    v43 = 0LL;
    if ( !v112 )
      v43 = (struct _SURFOBJ *)v136;
    v119 = v43;
  }
  v181 = *(_QWORD *)(v40 + 48);
              ...
              if ( !ERECTL::bEmpty((ERECTL *)&v186) )
              {
                ...
                if ( v63 >= v14->left )
                {
                  ...
                  if ( v64 >= v65 )
                  {
                    ...
                    {
                      v68 = (struct _STRDDA *)PALLOCMEM2(4 * v67 + 40, 1752462151LL, 0);
...
LABEL_218:
                        ...
                        if ( v137 )
                        {
                          LODWORD(v151) = v186.left + v143->x - v14->left;
                          v139 = *(_QWORD *)(v150 + 80) + *(_DWORD *)(v150 + 88) * (v186.top + v143->y - v14->top);
                        }
                        else
                        {
                          v139 = 0LL;
