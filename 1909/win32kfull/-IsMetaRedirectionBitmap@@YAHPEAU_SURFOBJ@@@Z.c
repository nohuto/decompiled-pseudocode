/*
 * XREFs of ?IsMetaRedirectionBitmap@@YAHPEAU_SURFOBJ@@@Z @ 0x1C0299CB8
 * Callers:
 ...
 *     MulProcessChildRedirectionDfbSurfaces2 @ 0x1C02A00A0 (MulProcessChildRedirectionDfbSurfaces2.c)
 * Callees:
 *     <none>
 */
