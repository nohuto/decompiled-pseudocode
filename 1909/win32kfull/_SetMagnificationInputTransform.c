/*
 * XREFs of _SetMagnificationInputTransform @ 0x1C015FE60
 * Callers:
 ...
 *     ?ComputeMagnificationFactor@@YAXPEAU_MAGNIFICATION_INPUT_TRANSFORM@@@Z @ 0x1C0202FC0 (-ComputeMagnificationFactor@@YAXPEAU_MAGNIFICATION_INPUT_TRANSFORM@@@Z.c)
