/*
 * XREFs of ?GetElement@?$CList@VCPhysicalMonitorHandle@@@OPM@@QEAAJKPEAPEAVCPhysicalMonitorHandle@@@Z @ 0x1C026ECF4
 * Callers:
 *     MonitorAPIProcessTerminating @ 0x1C00EEB60 (MonitorAPIProcessTerminating.c)
