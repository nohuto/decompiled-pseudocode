/*
 * XREFs of ?TraceLoggingScreenOrientationChangeEvent@@YAXKW4arInitiatedBy@@HW4arFailureReason@@@Z @ 0x1C01CF25C
 * Callers:
...
void __fastcall TraceLoggingScreenOrientationChangeEvent(__int64 a1, __int64 a2, int a3)
{
  ...
  if ( hProvider > 5u )
  {
    if ( TlgKeywordOn((TraceLoggingHProvider)&hProvider, 0x400000000001uLL) )
    {
      ...
      v8 = v3;
      v20 = 4LL;
      TlgWrite((TraceLoggingHProvider)&hProvider, &unk_1C02E5D6A, 0LL, 0LL, 7u, &pData);
    }
  }
}
