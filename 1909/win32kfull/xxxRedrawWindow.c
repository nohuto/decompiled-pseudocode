/*
 * XREFs of xxxRedrawWindow @ 0x1C0064FD8
 * Callers:
 ...
 *     NtUserInvalidateRgn @ 0x1C00F6EA0 (NtUserInvalidateRgn.c)
 *     xxxValidateRect @ 0x1C01063F4 (xxxValidateRect.c)
 *     xxxValidateRgn @ 0x1C010A5E0 (xxxValidateRgn.c)
...
LABEL_9:
    ...
    v18 = 0LL;
    if ( !(unsigned int)IsThreadCrossSessionAttached(v8, a2, a3) )
    {
