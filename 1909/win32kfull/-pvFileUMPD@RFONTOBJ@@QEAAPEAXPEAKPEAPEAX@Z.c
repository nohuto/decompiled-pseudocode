/*
 * XREFs of ?pvFileUMPD@RFONTOBJ@@QEAAPEAXPEAKPEAPEAX@Z @ 0x1C02A1530
 * Callers:
 ...
 * Callees:
 *     ?pchTranslateUMPD@RFONTOBJ@@QEAAPEADPEBDPEAPEAX@Z @ 0x1C02A12A0 (-pchTranslateUMPD@RFONTOBJ@@QEAAPEADPEBDPEAPEAX@Z.c)
