/*
 * XREFs of ?pSpGrowRanges@@YAPEAU_SPRITERANGE@@PEAU_SPRITESTATE@@PEAU1@PEAPEAU_SPRITESCAN@@PEAPEAU1@@Z @ 0x1C0081378
 * Callers:
        ...
        struct _SPRITERANGE **a4)
{
  ...
  v9 = (char *)a2 - v4;
  v10 = (char *)*a3 - v4;
  v11 = (void *)PALLOCMEM2((unsigned int)(*((_DWORD *)a1 + 36) - v4 + 360));
