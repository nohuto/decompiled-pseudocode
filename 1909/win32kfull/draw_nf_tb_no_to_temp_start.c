/*
 * XREFs of draw_nf_tb_no_to_temp_start @ 0x1C014C4D0
 * Callers:
 *     <none>
 * Callees:
  ...
  if ( a2 )
  {
    ...
    do
    {
      ...
      else
      {
        ...
        if ( v16 > v17 )
          v18 = 2LL;
        result = ((__int64 (__fastcall *)(_QWORD, _QWORD, _QWORD, __int64, __int64, int))OrInitialTableNarrow[(v13 == 0) | (unsigned int)(4 * ((int)(v14 + v13 + 7) >> 3)) | (unsigned __int64)v18])(
                   v12,
                   v13,
                   a5,
                   v11 + 16,
