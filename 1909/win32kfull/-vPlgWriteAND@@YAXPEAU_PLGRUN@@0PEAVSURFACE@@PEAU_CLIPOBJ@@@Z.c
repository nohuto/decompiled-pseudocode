/*
 * XREFs of ?vPlgWriteAND@@YAXPEAU_PLGRUN@@0PEAVSURFACE@@PEAU_CLIPOBJ@@@Z @ 0x1C02CF300
 * Callers:
 *     <none>
 * Callees:
              ...
              do
              {
                ...
                if ( !v31 )
                {
                  if ( v33 )
                    *v30 = v32;
                  ++v30;
                  v31 = *((_BYTE *)&dword_1C02F0E98 + (v27 & 7));
                  v37 = v31;
                  if ( (int)v27 < 0
                    || (int)v27 >= *((_DWORD *)a3 + 14)
                    || (unsigned __int64)v30 < v4
    ...
    else if ( a1 < a2 )
    {
      do
      {
        ...
        for ( j = *((_QWORD *)a3 + 10) + v10; v11; --v11 )
        {
          ...
          v18 = *((_BYTE *)&dword_1C02F0E98 + (*(_DWORD *)v5 & 7));
              ...
              if ( !v18 )
              {
                *v17++ = v19;
                if ( (unsigned __int64)v17 < v4 || (unsigned __int64)v17 > v9 )
                  ...
                  v19 = *v17;
                v18 = *((_BYTE *)&dword_1C02F0E98 + (v15 & 7));
              }
            }
            while ( v20 > 0 );
            v8 = a2;
