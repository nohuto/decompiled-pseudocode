/*
 * XREFs of ?bIntersectMoveWithDirty@METAREGION@@AEAAHPEAU_RECTL@@@Z @ 0x1C02B9940
 * Callers:
 ...
 *     ?TraceMoveRemovedMoveRegions@METAREGION@@AEAAXPEAU_RECTL@@@Z @ 0x1C02B98B8 (-TraceMoveRemovedMoveRegions@METAREGION@@AEAAXPEAU_RECTL@@@Z.c)
...
__int64 __fastcall METAREGION::bIntersectMoveWithDirty(METAREGION *this, struct _RECTL *a2)
{
  ...
  if ( *((_DWORD *)this + 10) == 1 && (*((_QWORD *)this + 1) || *(_QWORD *)this) )
  {
      ...
      && (v6 = RGNOBJ::iCombine((RGNOBJ *)v9, (struct RGNOBJ *)v11, (struct RGNOBJ *)&v13, 1)) != 0 )
    {
      if ( v6 != 1 )
      {
        v14[0] = *(_DWORD *)(v9[0] + 88LL);
        v14[1] = *(_DWORD *)(v9[0] + 92LL);
        v14[2] = *(_DWORD *)(v9[0] + 96LL);
        v14[3] = *(_DWORD *)(v9[0] + 100LL);
