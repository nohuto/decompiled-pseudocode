/*
 * XREFs of ?bGetNtoW_Win31@@YAHPEAVMATRIX@@PEAUtagLOGFONTW@@AEAVIFIOBJ@@PEAVDCOBJ@@KH@Z @ 0x1C00476D0
 * Callers:
        ...
        int a6)
{
  ...
  *(float *)&v69 = (float)(int)a3;
  ...
  if ( (int)v24 <= 40 )
  {
    ...
    v34 = -((unsigned __int64)(v33 + 0x80000000LL) >> 32);
    if ( v31 >= 0.0 )
      v34 = (unsigned __int64)(v33 + 0x80000000LL) >> 32;
    if ( v34 > 0 && v28 && (int)a3 / 256 < v34 )
      goto LABEL_64;
  }
...
LABEL_65:
    ...
    LOBYTE(v39) = 18;
    v71 = *(_QWORD *)(v36 + 128);
    if ( !(unsigned int)IsThreadCrossSessionAttached(v24, v36, a3) )
    {
      ...
      if ( ThreadWin32Thread )
      {
        ...
        if ( *ThreadWin32Thread )
        {
          ...
          if ( *(_DWORD *)(v44 + 340) )
          {
            LOBYTE(v39) = *(_DWORD *)(v44 + 340);
          }
          else
          {
            CurrentProcessWin32Process = PsGetCurrentProcessWin32Process(v41, v40);
            if ( CurrentProcessWin32Process )
              v39 = *(_DWORD *)(CurrentProcessWin32Process + 280);
          }
        }
      }
    }
    v46 = v70;
    v47 = 96;
    if ( (v70[10] & 1) == 0 || (v48 = 96, (v39 & 0xFu) - 1 <= 1) )
      v48 = v70[544];
    ...
    if ( v58 == v56 )
      ...
      v35 = (float)((float)v56 * v66) / (float)v58;
  }
  if ( !v13 )
    v35 = v35 / v20;
  *(float *)a1 = v35;
