/*
 * XREFs of vInitFontsDirectoryNameInformation @ 0x1C0118B50
 * Callers:
 *     <none>
 * Callees:
 *     ?bAppendSysDirectory@@YAHPEAGPEBGI@Z @ 0x1C008F0B4 (-bAppendSysDirectory@@YAHPEAGPEBGI@Z.c)
 *     PALLOCMEM2 @ 0x1C0095D7C (PALLOCMEM2.c)
 *     ?QueryNameStringFromHandle@@YAJPEAXPEAU_OBJECT_NAME_INFORMATION@@KD@Z @ 0x1C0123198 (-QueryNameStringFromHandle@@YAJPEAXPEAU_OBJECT_NAME_INFORMATION@@KD@Z.c)
 */
...
int vInitFontsDirectoryNameInformation()
{
  ...
  *(_OWORD *)&ObjectAttributes.SecurityDescriptor = 0LL;
  ...
  if ( (int)v0 >= 0 )
  {
    ...
    if ( v4 )
    {
      if ( (unsigned int)bAppendSysDirectory(v4, &word_1C02D83A8) )
      {
        v5 = -1LL;
        do
          ++v5;
