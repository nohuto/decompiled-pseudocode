/*
 * XREFs of ?SendSynchronousIoControl@RimBackedDeviceBase@Rim@@QEBAJKPEAXK0KPEAK@Z @ 0x1C0239D70
 * Callers:
 ...
 * Callees:
 *     ??1DeviceObjectPointer@Io@@QEAA@XZ @ 0x1C023999C (--1DeviceObjectPointer@Io@@QEAA@XZ.c)
 ...
 *     SendSynchronousIoControl @ 0x1C0239E7C (SendSynchronousIoControl.c)
 */
