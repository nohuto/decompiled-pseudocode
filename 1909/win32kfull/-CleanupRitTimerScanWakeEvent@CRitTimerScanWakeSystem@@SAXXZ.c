/*
 * XREFs of ?CleanupRitTimerScanWakeEvent@CRitTimerScanWakeSystem@@SAXXZ @ 0x1C00799C4
 * Callers:
 *     RawInputThread @ 0x1C0077DE0 (RawInputThread.c)
 *     EditionBaseDriverUnloadUninitialize @ 0x1C011C4A0 (EditionBaseDriverUnloadUninitialize.c)
 * Callees:
