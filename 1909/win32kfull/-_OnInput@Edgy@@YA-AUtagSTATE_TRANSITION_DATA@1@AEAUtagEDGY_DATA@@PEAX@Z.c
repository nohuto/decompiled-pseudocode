/*
 * XREFs of ?_OnInput@Edgy@@YA?AUtagSTATE_TRANSITION_DATA@1@AEAUtagEDGY_DATA@@PEAX@Z @ 0x1C01F7A18
 * Callers:
 *     ?ProcessInput@Edgy@@YAHPEAXPEAPEAX@Z @ 0x1C01F6C14 (-ProcessInput@Edgy@@YAHPEAXPEAPEAX@Z.c)
 * Callees:
 ...
 *     ?_OnEnterDisambiguation@Edgy@@YAXAEAUtagEDGY_DATA@@AEBUtagARC_DATA@1@@Z @ 0x1C01F79A0 (-_OnEnterDisambiguation@Edgy@@YAXAEAUtagEDGY_DATA@@AEBUtagARC_DATA@1@@Z.c)
...
__int64 __fastcall Edgy::_OnInput(__int64 a1, __int64 a2, __int64 a3)
{
  ...
  v7 = 4;
  v8 = dword_1C02EB3B0[(_QWORD)v6];
  v9 = *((_OWORD *)ArcData + 1);
  v10 = dword_1C02EB3B4[(_QWORD)v6];
  ...
  *(_QWORD *)&v9 = ArcData[6];
  ...
  while ( v8 < v10 )
  {
    if ( ((__int64)v15[1] & dword_1C02EB238[4 * v8]) == dword_1C02EB23C[4 * v8] )
    {
      v7 = dword_1C02EB234[4 * v8];
      break;
    }
    ++v8;
  }
