/*
 * XREFs of ?GetScaledComponentValue@InteractiveControlParser@@SAJPEAUtagINTERACTIVECTRL_COMPONENT_ENTRY@@J@Z @ 0x1C0258B28
 * Callers:
        ...
        int a2)
{
  ...
  if ( dword_1C031F308 > 3u )
  {
    ...
    v11 = v4;
    v20 = 4LL;
    TlgWrite((TraceLoggingHProvider)&dword_1C031F308, &unk_1C02E90ED, 0LL, 0LL, 6u, &pData);
  }
  return 1LL;
}
