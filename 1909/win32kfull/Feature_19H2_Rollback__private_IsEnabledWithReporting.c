/*
 * XREFs of Feature_19H2_Rollback__private_IsEnabledWithReporting @ 0x1C0164B60
 * Callers:
 *     ?Feature_19H2_Enablement__private_areDependenciesEnabled@@YAHXZ @ 0x1C0164B40 (-Feature_19H2_Enablement__private_areDependenciesEnabled@@YAHXZ.c)
 * Callees:
...
_BOOL8 Feature_19H2_Rollback__private_IsEnabledWithReporting()
{
  ...
  wil_details_FeaturePropertyCache_ReportUsageToService(
    ...
    20442546LL,
    (const struct FEATURE_LOGGED_TRAITS *)&unk_1C02DC780,
    v0,
    0);
  return v0;
}
