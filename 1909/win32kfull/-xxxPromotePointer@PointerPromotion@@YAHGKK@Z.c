/*
 * XREFs of ?xxxPromotePointer@PointerPromotion@@YAHGKK@Z @ 0x1C02083F0
 * Callers:
 ...
 *     EditionPromotePointer @ 0x1C0208770 (EditionPromotePointer.c)
 * Callees:
...
LABEL_12:
  ...
  if ( word_1C032A2F0 != v4 || (v6 = v13, dword_1C032A2F4 != *((_DWORD *)v13 + 8)) )
  {
  ...
  if ( (v12 & 0x80000) == 0 )
  {
    v9 = (dword_1C032A304 != 0 ? 50331648 : 0x1000000) | ((dword_1C032A300 != 0) + 1) | v12 & 0xFFFF00;
    goto LABEL_12;
  }
  if ( dword_1C032A300 )
    v7 = v12 >> 1;
