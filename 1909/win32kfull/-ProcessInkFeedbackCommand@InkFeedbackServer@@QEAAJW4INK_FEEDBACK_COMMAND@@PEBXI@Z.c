/*
 * XREFs of ?ProcessInkFeedbackCommand@InkFeedbackServer@@QEAAJW4INK_FEEDBACK_COMMAND@@PEBXI@Z @ 0x1C024FD98
 * Callers:
        ...
        unsigned int a4)
{
  ...
  if ( dword_1C031F298 > 4u )
  {
    ...
    v10[0] = a2;
    v20 = 1;
    TlgWrite((TraceLoggingHProvider)&dword_1C031F298, &unk_1C02E878D, 0LL, 0LL, 5u, &pData);
  }
  ...
  if ( dword_1C031F298 > 2u )
  {
    ...
    v19 = v10;
    v20 = 1;
    TlgWrite((TraceLoggingHProvider)&dword_1C031F298, &unk_1C02E8752, 0LL, 0LL, 5u, &pData);
  }
  return 3221225473LL;
}
