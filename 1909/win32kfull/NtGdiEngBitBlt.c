/*
 * XREFs of NtGdiEngBitBlt @ 0x1C014AB20
 * Callers:
 *     <none>
 * Callees:
        ...
        ROP4 rop4)
{
  ...
  struct _POINTL v45; // [rsp+D8h] [rbp-B0h] BYREF
  struct _POINTL v46; // [rsp+E0h] [rbp-A8h] BYREF
  struct _POINTL v47; // [rsp+E8h] [rbp-A0h] BYREF
  struct _CLIPOBJ *v48; // [rsp+F0h] [rbp-98h]
  struct UMPDOBJ *v49; // [rsp+F8h] [rbp-90h]
  ...
  *(_QWORD *)&v51.right = 0LL;
  ...
  CapturePOINTL(&v32, &v45);
  CapturePOINTL(&v40, &v46);
