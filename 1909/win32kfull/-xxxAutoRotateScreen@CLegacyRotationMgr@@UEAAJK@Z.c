/*
 * XREFs of ?xxxAutoRotateScreen@CLegacyRotationMgr@@UEAAJK@Z @ 0x1C01D5250
 * Callers:
 *     <none>
 * Callees:
 ...
 *     ?AutoRotationUpdateRegistry@CLegacyRotationMgr@@UEAAXXZ @ 0x1C010C320 (-AutoRotationUpdateRegistry@CLegacyRotationMgr@@UEAAXXZ.c)
 ...
 *     ?GetDockedOrientationValue@CLegacyRotationMgr@@AEAAKPEAK@Z @ 0x1C01D49AC (-GetDockedOrientationValue@CLegacyRotationMgr@@AEAAKPEAK@Z.c)
