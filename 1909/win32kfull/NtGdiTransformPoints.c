/*
 * XREFs of NtGdiTransformPoints @ 0x1C00D94F0
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall NtGdiTransformPoints(int a1, char *a2, char *a3, int a4, int a5)
{
  __int64 v5; // rsi
  unsigned int v9; // edi
  _BYTE *v10; // rbx
  ...
  if ( a4 > 0 )
  {
    ...
    if ( v9 )
    {
      v9 = GreTransformPoints(a1, (_DWORD)v10, (_DWORD)v10, v5, a5);
      if ( v9 )
      {
        v12 = 8LL * (int)v5;
