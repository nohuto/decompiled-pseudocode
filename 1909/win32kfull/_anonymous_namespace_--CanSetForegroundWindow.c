/*
 * XREFs of _anonymous_namespace_::CanSetForegroundWindow @ 0x1C01335E4
 * Callers:
...
__int64 __fastcall anonymous_namespace_::CanSetForegroundWindow(__int64 a1, _WORD *a2, __int64 a3, __int64 a4)
{
  ...
  v7 = grpdeskRitInput;
  if ( *(_QWORD *)(gptiCurrent + 448LL) == grpdeskRitInput && ((_DWORD)a2 == 31 || IAMThreadAccessGranted(gptiCurrent)) )
  {
    if ( WPP_RECORDER_INITIALIZED != (_UNKNOWN *)&WPP_RECORDER_INITIALIZED )
    {
      LOBYTE(a2) = 4;
