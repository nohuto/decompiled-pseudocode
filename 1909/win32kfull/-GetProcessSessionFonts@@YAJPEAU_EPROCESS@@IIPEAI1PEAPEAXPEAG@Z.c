/*
 * XREFs of ?GetProcessSessionFonts@@YAJPEAU_EPROCESS@@IIPEAI1PEAPEAXPEAG@Z @ 0x1C011F90C
 * Callers:
 ...
 *     ?PffDuplicateFileHandle@@YAJPEAVPFF@@PEAU_EPROCESS@@1PEAPEAX@Z @ 0x1C026F844 (-PffDuplicateFileHandle@@YAJPEAVPFF@@PEAU_EPROCESS@@1PEAPEAX@Z.c)
 */
...
LABEL_24:
      ...
      if ( v25 < 0 )
      {
        ...
        TlgWrite((TraceLoggingHProvider)&hProvider, &unk_1C02E9232, 0LL, 0LL, cData, &pData);
      }
      else
      {
