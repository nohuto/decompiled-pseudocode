/*
 * XREFs of EditionHandleAndPostKeyEvent @ 0x1C001D320
 * Callers:
 *     <none>
 * Callees:
    ...
    || (a5 != 9 || (a6 & 1) != 0) && (a5 != 27 || (a6 & 2) != 0) )
  {
      ...
      && (unsigned __int8)(a5 + 90) <= 0x11u )
    {
      ...
      if ( v18
        ...
        && ((a15 - 256) & 0xFFFB) == 0
        && *(_QWORD *)(v18 + 32) == v17
        && !(unsigned int)IsProcessedByInputService(v18)
        && *(_WORD *)(v18 + 42) == HIWORD(v23) )
      {
        if ( (unsigned __int8)IsKeyboardDelegationEnabledForThread(*(_QWORD *)(gpqForeground + 104LL))
          || (unsigned int)GetKeyboardInputRoutingPolicy() == 1 )
        {
          v24 = IsKeyboardDelegationEnabledForThread(*(_QWORD *)(gpqForeground + 104LL));
          CKeyboardProcessor::ForwardInputToISM(a1 != 0, v22, a8, a10, a13, a12, v24 == 0, 0LL);
        }
        if ( !(unsigned __int8)IsKeyboardDelegationEnabledForThread(*(_QWORD *)(gpqForeground + 104LL)) )
        {
          *(_QWORD *)(v18 + 40) = (HIWORD(v23) << 16) | (unsigned __int16)(*(_WORD *)(v18 + 40) + 1);
          WakeSomeone(gpqForeground, 0LL, a15, v18);
        }
        return 0LL;
      }
      ...
      if ( !a4 && gpqForeground )
      {
        if ( (unsigned __int8)(a5 + 83) <= 2u )
        {
          ...
          if ( v25 || (v25 = *(_QWORD *)(gpqForeground + 128LL)) != 0 )
          {
            v26 = *(unsigned __int8 **)(*(_QWORD *)(v25 + 16) + 424LL);
            if ( v26 )
            {
              MouseKeyFlags = GetMouseKeyFlags(v26);
...
LABEL_48:
          ...
          || (unsigned int)GetKeyboardInputRoutingPolicy() == 1 )
        {
          ...
          CKeyboardProcessor::ForwardInputToISM(a1 != 0, v22, a8, a10, a13, a12, v30 == 0, 0LL);
        }
        if ( !(unsigned __int8)IsKeyboardDelegationEnabledForThread(*(_QWORD *)(gpqForeground + 104LL)) )
        {
                               ...
                               (__int64)&v53) )
          {
            ...
            v57 = v51;
            v58 = v52;
            PostInputMessage(gpqForeground, 0LL, a15, v23, a12, 0LL, a14, 0, a11, (__int64)a13, 0LL, v53, v55);
          }
        }
        return 0LL;
      }
  ...
  v16 = gpqForeground;
  if ( !gpqForeground )
    v16 = *(_QWORD *)(gptiRit + 424LL);
  ++*(_DWORD *)(v16 + 404);
  PushW32ThreadLock(v16, &v57, UnlockQueue);
