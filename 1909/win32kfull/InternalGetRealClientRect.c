/*
 * XREFs of InternalGetRealClientRect @ 0x1C00EC190
 * Callers:
...
__int64 __fastcall InternalGetRealClientRect(__int64 a1, __int64 a2, __int64 a3, __int64 a4, int a5)
{
  ...
  char v19[16]; // [rsp+20h] [rbp-58h] BYREF
  ...
  if ( (_DWORD)v9 == 669 )
  {
    ...
    if ( !a5 )
      v10 = ((unsigned int)W32GetCurrentThreadDpiAwarenessContext(v9, a2, a3) >> 8) & 0x1FF;
    if ( (v7 & 4) != 0 )
      MonitorRectForDpi = (__m128i *)GetMonitorRectForDpi(v19, v6, v10);
    else
  ...
  else
  {
    ...
    if ( (v7 & 1) != 0 )
    {
      ...
      if ( (*(_BYTE *)(v16 + 16) & 4) != 0 )
      {
        DpiForSystem = GetDpiForSystem(v16, v14, v15);
      ...
      if ( (*(_BYTE *)(v16 + 16) & 2) != 0 )
      {
        v18 = GetDpiForSystem(v16, v14, v15);
