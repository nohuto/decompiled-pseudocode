/*
 * XREFs of ?bSpDwmValidateSurface@@YAHAEAVXDCOBJ@@HHHH@Z @ 0x1C00B7F30
 * Callers:
 ...
 *     ?bContain@RGNOBJ@@QEAAHAEAU_RECTL@@@Z @ 0x1C00F0578 (-bContain@RGNOBJ@@QEAAHAEAU_RECTL@@@Z.c)
...
LABEL_83:
  ...
  {
    return bSpDwmUpdateSurface(0LL, v47, a1, v42[0], 1.0, left, v39[0], (struct ERECTL *)&v58, v9);
  }
  else if ( v9 )
  {
    REGION::vDeleteREGION(v9);
