/*
 * XREFs of ?Remove@CPointerHashTable@NSInstrumentation@@QEAA_NPEBXPEAPEAX@Z @ 0x1C00959C4
 * Callers:
 ...
 *     ?_RemoveAllocationFromLookup@UmfdAllocation@@CAXPEAX00@Z @ 0x1C010A370 (-_RemoveAllocationFromLookup@UmfdAllocation@@CAXPEAX00@Z.c)
        ...
        void **a3)
{
  ...
  while ( v7 )
  {
    ...
    ExReleasePushLockSharedEx(this, 0LL, v17, v18);
