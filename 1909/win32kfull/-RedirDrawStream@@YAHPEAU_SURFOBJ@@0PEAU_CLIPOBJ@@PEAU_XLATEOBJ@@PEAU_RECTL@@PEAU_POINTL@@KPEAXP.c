/*
 * XREFs of ?RedirDrawStream@@YAHPEAU_SURFOBJ@@0PEAU_CLIPOBJ@@PEAU_XLATEOBJ@@PEAU_RECTL@@PEAU_POINTL@@KPEAXPEAU_DSSTATE@@@Z @ 0x1C0295C90
 * Callers:
 *     <none>
 * Callees:
        ...
        struct _DSSTATE *a9)
{
        ...
        if ( (v15 & 0x20000) != 0 )
        {
          for ( i = **(struct _DISPSURF ***)(v14 + 1800); i; i = *(struct _DISPSURF **)i )
          {
            ...
            if ( v17 )
            {
              ...
              {
                if ( *(_QWORD *)(*(_QWORD *)(v17 + 1792) + 784LL) )
                {
                  ...
                  (*(void (__fastcall **)(struct _SURFOBJ *, struct _SURFOBJ *, struct _CLIPOBJ *, struct _XLATEOBJ *, struct _RECTL *, struct _POINTL *, unsigned int, _DWORD *, struct _DSSTATE *))(v19 + 784))(
                    v21,
                    DevBitmap,
                    a3,
                    a4,
  ...
  v22 = EngDrawStream((__int64)a1, (__int64)a2, (__int64)a3, (__int64)a4, (int)a5, (int *)a6, a7, a8, a9);
  if ( v25 )
    bMakeOpaque(v25);
  if ( v26 )
    bMakeOpaque(v26);
