/*
 * XREFs of ?HandleRawInput@@YA?AW4RAW_INPUT_PROCESSING_RESULT@@PEAXPEAU_KEYBOARD_INPUT_DATA@@PEBURAW_INPUT_SUPPLEMENTAL_INFO@@@Z @ 0x1C001DB48
 * Callers:
...
LABEL_2:
  ...
  if ( v9 )
  {
    if ( *(_DWORD *)(a3 + 16)
      ...
      && (v14 = *(_DWORD *)(*(_QWORD *)(*(_QWORD *)(v10 + 416) + 824LL) + 100LL), (v14 & 0x20) != 0)
