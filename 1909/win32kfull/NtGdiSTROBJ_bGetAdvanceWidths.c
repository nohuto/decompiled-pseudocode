/*
 * XREFs of NtGdiSTROBJ_bGetAdvanceWidths @ 0x1C02ADB70
 * Callers:
 *     <none>
 * Callees:
 ...
 *     STROBJ_bGetAdvanceWidths @ 0x1C02B7480 (STROBJ_bGetAdvanceWidths.c)
 */

__int64 __fastcall NtGdiSTROBJ_bGetAdvanceWidths(__int64 a1, __int64 a2, __int64 a3, void *a4)
{
  __int64 v5; // r14
  ULONG v6; // r12d
  ...
  AdvanceWidths = STROBJ_bGetAdvanceWidths(v11, v6, v5, v12);
  if ( AdvanceWidths )
  {
