/*
 * XREFs of ?InitializeContactPrediction@@YAXPEAUtagHID_POINTER_DEVICE_INFO@@UtagPOINT@@1PEAUtagHPD_PREDICTION_INFO@@PEAU2@3@Z @ 0x1C01ED64C
 * Callers:
 *     DoPrediction @ 0x1C01EF320 (DoPrediction.c)
 * Callees:
