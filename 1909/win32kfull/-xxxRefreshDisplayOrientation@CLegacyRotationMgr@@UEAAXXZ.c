/*
 * XREFs of ?xxxRefreshDisplayOrientation@CLegacyRotationMgr@@UEAAXXZ @ 0x1C0058310
 * Callers:
 *     <none>
 * Callees:
...
void __fastcall CLegacyRotationMgr::xxxRefreshDisplayOrientation(CLegacyRotationMgr *this)
{
  ...
  if ( hProvider > 5u && TlgKeywordOn((TraceLoggingHProvider)&hProvider, 0x200000000001uLL) )
  {
    ...
    v13 = &dword_1C0325D7C;
    v14 = 4;
    TlgWrite((TraceLoggingHProvider)&hProvider, &unk_1C02E61F2, 0LL, 0LL, 3u, &pData);
  }
  ...
  if ( hProvider > 5u && TlgKeywordOn((TraceLoggingHProvider)&hProvider, 0x200000000001uLL) )
  {
    ...
    v7 = 4;
    v10 = 4;
    TlgWrite((TraceLoggingHProvider)&hProvider, &unk_1C02E6239, 0LL, 0LL, 4u, &v5);
    v2 = v4[0];
  }
  if ( dword_1C0325D84 && !v2 && !dword_1C0325D80 )
  {
  ...
  if ( hProvider > 5u && TlgKeywordOn((TraceLoggingHProvider)&hProvider, 0x200000000001uLL) )
  {
    ...
    v7 = 4;
    v10 = 4;
    TlgWrite((TraceLoggingHProvider)&hProvider, &unk_1C02E6292, 0LL, 0LL, 4u, &v5);
    v3 = v4[0];
  }
  if ( dword_1C0325D80 && !v3 && !dword_1C0325D84 )
  {
    CLegacyRotationMgr::xxxRestoreSlateAutorotationPreferences(this);
    v3 = v4[0];
  }
  dword_1C0325D80 = v3;
  if ( dword_1C0325D84 || v3 )
