/*
 * XREFs of ?EditionHandleAltTab@@YAXEGFK_KPEAUtagINPUT_MESSAGE_SOURCE@@PEAXG@Z @ 0x1C01169E0
 * Callers:
 *     <none>
 * Callees:
        ...
        unsigned __int16 a8)
{
  ...
  if ( gspwndAltTab )
  {
    ...
    if ( gspwndActivate )
    {
      v36 = *(_QWORD *)(gspwndActivate + 16);
      if ( gpqForeground == *(_QWORD *)(v36 + 424) )
      {
        SetNewForegroundQueue(0LL, v36, v34);
        v36 = *(_QWORD *)(v35 + 16);
      }
      CInputGlobals::SetPtiLastWoken(gpInputGlobals, (struct tagTHREADINFO *)v36, 0);
      ThreadWin32Thread = W32GetThreadWin32Thread((__int64)KeGetCurrentThread(), v37, v38);
      v47 = *(_QWORD *)(ThreadWin32Thread + 408);
      *(_QWORD *)(ThreadWin32Thread + 408) = &v47;
      v48 = v35;
      HMLockObject(v35);
      xxxSetForegroundWindow2(v35, 0LL, 18LL);
      if ( (*(_BYTE *)(*(_QWORD *)(v35 + 40) + 31LL) & 0x40) != 0 )
        xxxSetWindowPos((struct tagWND *)v35, 0LL, 0LL, 0LL, 0, 0, 16387);
