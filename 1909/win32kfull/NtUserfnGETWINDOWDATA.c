/*
 * XREFs of NtUserfnGETWINDOWDATA @ 0x1C00E02F0
 * Callers:
 *     <none>
 * Callees:
 *     _guard_dispatch_icall_nop @ 0x1C01680F0 (_guard_dispatch_icall_nop.c)
 *     ?GetWindowData@@YA_JPEAUtagWND@@_JH_N@Z @ 0x1C0228BE0 (-GetWindowData@@YA_JPEAUtagWND@@_JH_N@Z.c)
 */
...
__int64 __fastcall NtUserfnGETWINDOWDATA(struct tagWND *a1, __int64 a2, __int64 a3, __int64 a4, ULONG64 a5, int a6)
{
  ...
  if ( a6 == 689 && a4 < 3 )
  {
    ...
    else
    {
      ...
      {
        WindowData = ((__int64 (__fastcall *)(struct tagWND *, _QWORD, __int64, __int64, ULONG64))qword_1C0329828)(
                       a1,
                       v17,
                       a3,
                       a4,
        ...
        if ( a4 == 2 && (*(_DWORD *)(*(_QWORD *)(*((_QWORD *)a1 + 2) + 416LL) + 12LL) & 0x80u) != 0 )
        {
          if ( (*(_BYTE *)(*((_QWORD *)a1 + 5) + 18LL) & 1) == 0 || a3 )
            ...
            v16 = 17LL;
          return (((__int64 (__fastcall *)(struct tagWND *, _QWORD, __int64))qword_1C0329828)(a1, v17, v16) << 32) | WindowData;
        }
      }
