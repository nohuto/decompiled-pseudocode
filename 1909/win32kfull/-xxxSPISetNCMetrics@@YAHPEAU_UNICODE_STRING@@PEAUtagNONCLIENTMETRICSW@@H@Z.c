/*
 * XREFs of ?xxxSPISetNCMetrics@@YAHPEAU_UNICODE_STRING@@PEAUtagNONCLIENTMETRICSW@@H@Z @ 0x1C01D9D94
 * Callers:
 ...
 *     ?RescaleNonClientMetrics@@YAXPEAUtagNONCLIENTMETRICSW@@@Z @ 0x1C01D9084 (-RescaleNonClientMetrics@@YAXPEAUtagNONCLIENTMETRICSW@@@Z.c)
...
__int64 __fastcall xxxSPISetNCMetrics(struct _UNICODE_STRING *a1, struct tagNONCLIENTMETRICSW *a2, __int64 a3)
{
  ...
  RescaleNonClientMetrics(v4, (__int64)a2);
  v13 = 50;
  if ( *((int *)v4 + 1) > 1 )
    v8 = *((_DWORD *)v4 + 1);
  if ( v8 < 50 )
