/*
 * XREFs of ?FNTCacheValidateFntFileInfo@@YA?AW4FntFileInfoValidationResult@@PEAPEAU_FONTFILEVIEW@@K@Z @ 0x1C02851C8
 * Callers:
...
__int64 __fastcall FNTCacheValidateFntFileInfo(__int64 *a1, unsigned int a2)
{
  ...
  if ( a2 )
  {
    ...
    v2 = 2;
LABEL_9:
    if ( v2 == 1 && qword_1C032A328 )
      *(_DWORD *)(qword_1C032A328 + 16) |= 2u;
  }
  return v2;
}
