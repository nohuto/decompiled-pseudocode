/*
 * XREFs of _SetLayeredWindowAttributes @ 0x1C0032170
 * Callers:
...
__int64 __fastcall SetLayeredWindowAttributes(struct tagWND *a1, unsigned int a2, BYTE a3, int a4)
{
  ...
  struct tagSIZE v23; // [rsp+68h] [rbp-1h] BYREF
  struct tagPOINT v24; // [rsp+70h] [rbp+7h] BYREF
  ...
  if ( RedirectionBitmap )
  {
    ...
    v21 = v19;
    v23.cx = v20[24] - v20[22];
    v23.cy = v20[25] - v20[23];
