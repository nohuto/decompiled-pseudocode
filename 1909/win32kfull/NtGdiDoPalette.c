/*
 * XREFs of NtGdiDoPalette @ 0x1C00F4A80
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall NtGdiDoPalette(HPALETTE a1, unsigned __int16 a2, unsigned __int16 a3, char *a4, unsigned int a5)
{
  ...
  v10 = 16LL * a5;
  v15 = v10;
  if ( !*(_DWORD *)((char *)&off_1C02D5920[1] + v10) )
  {
    if ( a4 )
    {
      if ( a3 )
    ...
    if ( v8 )
    {
      v11 = (*(__int64 (__fastcall **)(HPALETTE, unsigned int, unsigned int, struct tagPALETTEENTRY *))((char *)off_1C02D5920 + v10))(
              a1,
              a2,
              a3,
              v9);
  ...
  v7 = off_1C02D5920[2 * a5](a1, a2, a3, v9);
LABEL_10:
  if ( v9 )
    FreeTmpBuffer(v9);
  return v7;
