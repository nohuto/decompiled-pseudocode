/*
 * XREFs of ProcessSuspendedEventMessage @ 0x1C0109770
 * Callers:
 ...
 *     ?FindQMsgForCoalesce@@YAPEAUtagQMSG@@PEAUtagMLIST@@IPEAUHWND__@@PEAU1@@Z @ 0x1C0109864 (-FindQMsgForCoalesce@@YAPEAUtagQMSG@@PEAUtagMLIST@@IPEAUHWND__@@PEAU1@@Z.c)
 *     ?ProcessComplexCoalescence@@YAHII_K_JPEA_KPEA_J@Z @ 0x1C010989C (-ProcessComplexCoalescence@@YAHII_K_JPEA_KPEA_J@Z.c)
 */
