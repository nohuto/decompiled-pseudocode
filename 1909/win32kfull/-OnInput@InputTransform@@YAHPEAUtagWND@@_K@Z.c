/*
 * XREFs of ?OnInput@InputTransform@@YAHPEAUtagWND@@_K@Z @ 0x1C00F1810
 * Callers:
 *     PostInputMessage @ 0x1C002A06C (PostInputMessage.c)
 *     StoreQMessage @ 0x1C0045990 (StoreQMessage.c)
 *     InputTransformOnInput @ 0x1C01F6670 (InputTransformOnInput.c)
 *     SetManipulationInputTargetTransform @ 0x1C01F66A0 (SetManipulationInputTargetTransform.c)
 * Callees:
 ...
 *     MagpRemoveTransformOutputMagFac @ 0x1C00F1A64 (MagpRemoveTransformOutputMagFac.c)
