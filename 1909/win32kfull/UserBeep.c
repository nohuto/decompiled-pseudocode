 ...
 *     ?EditionUserBeep@@YAHKK@Z @ 0x1C01CD200 (-EditionUserBeep@@YAHKK@Z.c)
 *     ?DisplayDiagHotkeyCallback@@YAX_K_J@Z @ 0x1C01DB040 (-DisplayDiagHotkeyCallback@@YAX_K_J@Z.c)
