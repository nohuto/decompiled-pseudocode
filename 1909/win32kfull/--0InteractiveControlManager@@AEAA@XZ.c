/*
 * XREFs of ??0InteractiveControlManager@@AEAA@XZ @ 0x1C0079574
 * Callers:
        ...
        InteractiveControlManager *this)
{
  ...
  *((_DWORD *)this + 2) = 1;
  ...
  TraceLoggingRegisterEx((TraceLoggingHProvider)&dword_1C031F308, 0LL, 0LL);
  TraceLoggingRegisterEx((TraceLoggingHProvider)&dword_1C031F2D0, 0LL, 0LL);
