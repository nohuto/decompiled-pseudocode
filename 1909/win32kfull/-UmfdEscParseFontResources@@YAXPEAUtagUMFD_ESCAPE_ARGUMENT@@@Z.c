/*
 * XREFs of ?UmfdEscParseFontResources@@YAXPEAUtagUMFD_ESCAPE_ARGUMENT@@@Z @ 0x1C011DC44
 * Callers:
...
void __fastcall UmfdEscParseFontResources(struct tagUMFD_ESCAPE_ARGUMENT *a1)
{
  ...
  if ( UmfdFileviewLookup
    && (LODWORD(v7) = *(_DWORD *)v1,
        (unsigned __int8)NSInstrumentation::CSortedVector<unsigned int,_FONTFILEVIEW *>::LookUp(v3, &v7, v6))
    && *(_QWORD *)(v6[0] + 16LL) )
  {
