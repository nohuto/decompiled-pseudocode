/*
 * XREFs of ?bWritePoint@RTP_PATHMEMOBJ@@AEAAHXZ @ 0x1C02B9798
 * Callers:
 *     ?bDiagonalizeSubPath@RTP_PATHMEMOBJ@@AEAAHXZ @ 0x1C02B941C (-bDiagonalizeSubPath@RTP_PATHMEMOBJ@@AEAAHXZ.c)
 * Callees:
 *     <none>
 */
