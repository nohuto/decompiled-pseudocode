/*
 * XREFs of ReadPointerDeviceSettings @ 0x1C005B8B4
 * Callers:
 ...
 *     ?IsFlicksDisabledByGroupPolicy@@YAHXZ @ 0x1C005B158 (-IsFlicksDisabledByGroupPolicy@@YAHXZ.c)
...
__int64 __fastcall ReadPointerDeviceSettings(int a1, __int64 a2, unsigned __int16 *a3, unsigned int a4)
{
  ...
  if ( !(_DWORD)v6 )
  {
    ...
    v24 = off_1C031F058;
    GetLocalMachineRegistryDWORDValues(v6, L"\\Software\\Microsoft\\Wisp\\Touch", (__int128 *)off_1C031F058);
  ...
  if ( !v8 )
  {
    v48 = off_1C031F688;
    if ( !gModeMonitor )
      GetDWORDSettingValues(7LL, off_1C031F688, 7LL);
    v49 = *((_DWORD *)v48 + 3);
    if ( v49 == -1 )
      v49 = *((_DWORD *)v48 + 2);
    *(_DWORD *)a2 = v49;
  ...
  if ( v41 == 2 )
  {
    if ( !gPredictionMonitor )
      gPredictionMonitor = (int)CreatePredictionSettings(off_1C031F018, a2, a3, a4) >= 0;
    if ( gPredictionMonitor == 1 )
    {
      v42 = off_1C031F018;
      GetPredictionSettings(off_1C031F018, a2, a3, a4);
      v43 = *((_DWORD *)v42 + 3);
      v44 = 60;
      if ( v43 == -1 )
      {
