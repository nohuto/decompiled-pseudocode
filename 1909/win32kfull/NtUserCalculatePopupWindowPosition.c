/*
 * XREFs of NtUserCalculatePopupWindowPosition @ 0x1C0229800
 * Callers:
 *     <none>
 * Callees:
...
LABEL_3:
  ...
  *(_QWORD *)v23 = *a2;
  ...
  else
  {
    ...
    if ( (a3 & 4) != 0 )
    {
      LODWORD(v15) = v15 - v23[0] / 2;
    }
    else if ( (a3 & 8) != 0 )
    {
      LODWORD(v15) = v15 - v23[0];
    }
    if ( (a3 & 0x10) != 0 )
    {
      LODWORD(v16) = v23[1] / -2 + v16;
    }
    else if ( (a3 & 0x20) != 0 )
    {
      LODWORD(v16) = v16 - v23[1];
    }
    v9 = 1;
    SmartObjStackRef<tagPOPUPMENU>::SmartObjStackRef<tagPOPUPMENU>(v25, 0LL);
    BestPos = FindBestPos(v15, v16, v23[0], v23[1], (__int64)a4, a3 | 0x20000u, (__int64)v25, v17, v24);
    SmartObjStackRef<tagPOPUPMENU>::~SmartObjStackRef<tagPOPUPMENU>(v25, v19, v20);
    v21 = a5;
    ...
    *a5 = (__int16)BestPos;
    ...
    v14 = (unsigned int)(SHIWORD(BestPos) + v23[1]);
    a5[3] = v14;
  }
LABEL_28:
