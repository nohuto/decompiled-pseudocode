/*
 * XREFs of bInitSystemFont @ 0x1C0381200
 * Callers:
...
__int64 __fastcall bInitSystemFont(unsigned __int16 *a1, int a2)
{
  ...
  struct _FONTHASH **v14; // [rsp+48h] [rbp-B8h] BYREF
  struct PFF *v15; // [rsp+50h] [rbp-B0h] BYREF
  ...
  if ( !a2 )
    return v4;
  v14 = gpPFTPublic;
  if ( !(unsigned int)PUBLIC_PFTOBJ::bLoadAFont((PUBLIC_PFTOBJ *)&v14, a1, &v13, 2u, &v15, 0LL, 0) || !v13 || !v15 )
    return v4;
  v5 = 0x7FFFFFFF;
  v6 = 0LL;
  v7 = 0;
