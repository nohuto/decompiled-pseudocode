/*
 * XREFs of ?LogFontLoadAttempt@@YAXPEAXW4_W32KFontSourceType@@PEBGH@Z @ 0x1C026F74C
 * Callers:
...
char __fastcall LogFontLoadAttempt(void *a1, unsigned int a2, __int64 a3, unsigned int a4)
{
  ...
  if ( hProvider > 5u )
  {
    ...
    if ( result )
    {
      ...
      v14 = 4;
      v17 = 4;
      result = TlgWrite((TraceLoggingHProvider)&hProvider, &unk_1C02E927A, 0LL, 0LL, 4u, &pData);
    }
  }
  if ( v7 )
