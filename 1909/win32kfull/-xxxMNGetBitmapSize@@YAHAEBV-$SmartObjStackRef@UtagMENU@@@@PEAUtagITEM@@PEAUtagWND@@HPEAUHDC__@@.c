/*
 * XREFs of ?xxxMNGetBitmapSize@@YAHAEBV?$SmartObjStackRef@UtagMENU@@@@PEAUtagITEM@@PEAUtagWND@@HPEAUHDC__@@@Z @ 0x1C012A974
 * Callers:
 ...
 *     MNUpdateUAHMaxPopupWidths @ 0x1C010FCA8 (MNUpdateUAHMaxPopupWidths.c)
