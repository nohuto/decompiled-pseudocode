/*
 * XREFs of _anonymous_namespace_::SetForegroundPriorityProcess @ 0x1C012FF2C
 * Callers:
 ...
 * Callees:
 *     _anonymous_namespace_::SetProcessPriorityByClass @ 0x1C0130038 (_anonymous_namespace_--SetProcessPriorityByClass.c)
