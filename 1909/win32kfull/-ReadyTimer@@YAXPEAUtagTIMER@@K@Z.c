/*
 * XREFs of ?ReadyTimer@@YAXPEAUtagTIMER@@K@Z @ 0x1C01EBCE0
 * Callers:
 ...
 *     ?ApplyTimerDelay@@YAXPEAUtagTIMER@@@Z @ 0x1C01EBC10 (-ApplyTimerDelay@@YAXPEAUtagTIMER@@@Z.c)
 */
  ...
  if ( (v5 & 1) == 0 )
  {
    ...
    else
    {
      ...
      *((_DWORD *)a1 + 12) = v5 | 1;
      ...
      ++*(_DWORD *)(v6 + 596);
      v8 = *((_QWORD *)a1 + 3) + 1208LL;
      v9 = *(__int64 ***)(*((_QWORD *)a1 + 3) + 1216LL);
      if ( *v9 != (__int64 *)v8 )
        __fastfail(3u);
      *((_QWORD *)a1 + 8) = v9;
      *v7 = v8;
      ...
      *(_QWORD *)(v8 + 8) = v7;
      ...
      ++*(_DWORD *)(*(_QWORD *)(*((_QWORD *)a1 + 3) + 416LL) + 1040LL);
    }
  }
}
