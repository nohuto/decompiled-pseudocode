/*
 * XREFs of ?UMPDDrvStrokePath@@YAHPEAU_SURFOBJ@@PEAU_PATHOBJ@@PEAU_CLIPOBJ@@PEAU_XFORMOBJ@@PEAU_BRUSHOBJ@@PEAU_POINTL@@PEAU_LINEATTRS@@K@Z @ 0x1C02A5460
 * Callers:
 *     <none>
 * Callees:
  ...
  if ( v23 )
  {
          ...
          (v19 = v14) != 0) )
    {
      ...
      if ( !(unsigned int)UMPDOBJ::ThunkDDIOBJ(v12, (UMPDOBJ *)((char *)v12 + 144), (const void **)&v28[7], 0x18u, 0LL)
        ...
        || (LODWORD(Size) = 4, (unsigned int)UMPDOBJ::Thunk(v12, v28, 96LL, &v19, Size) == -1)
        || (v15 = 1, !v19) )
      {
LABEL_17:
        v15 = 0;
