/*
 * XREFs of WakeSomeone @ 0x1C002A434
 * Callers:
 ...
 *     EditionWakeThreadForInput @ 0x1C0029690 (EditionWakeThreadForInput.c)
 ...
 *     ?JournalTimer@@YAXPEAUtagWND@@I_K_J@Z @ 0x1C01EBCB0 (-JournalTimer@@YAXPEAUtagWND@@I_K_J@Z.c)
 * Callees:
