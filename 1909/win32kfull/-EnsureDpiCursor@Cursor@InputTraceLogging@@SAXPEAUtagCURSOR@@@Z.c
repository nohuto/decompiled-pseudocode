/*
 * XREFs of ?EnsureDpiCursor@Cursor@InputTraceLogging@@SAXPEAUtagCURSOR@@@Z @ 0x1C01CBEA4
 * Callers:
...
void __fastcall InputTraceLogging::Cursor::EnsureDpiCursor(unsigned __int64 a1)
{
  ...
  if ( dword_1C03202C0 > 5u )
  {
    if ( TlgKeywordOn((TraceLoggingHProvider)&dword_1C03202C0, 8uLL) )
    {
      ...
      v40 = 4LL;
      v42 = 8LL;
      TlgWrite((TraceLoggingHProvider)&dword_1C03202C0, &unk_1C02E490D, 0LL, 0LL, 0xFu, &pData);
    }
  }
}
