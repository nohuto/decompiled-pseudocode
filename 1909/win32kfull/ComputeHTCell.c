...
__int64 __fastcall ComputeHTCell(unsigned __int16 a1, __int64 a2, __int64 a3)
{
  ...
  unsigned int v32; // [rsp+B0h] [rbp+40h] BYREF
  char *v33; // [rsp+C8h] [rbp+58h]
...
LABEL_24:
  ...
  if ( v26 == 1433629235 )
  {
    v27 = ComputeChecksum(v11, v25, v21);
...
LABEL_9:
  ...
  if ( v28 )
  {
    if ( (unsigned int)GenerateWORDPat(v9, (__int64)v11, (__int64)v8, v28, v30, (unsigned int)v33, v32) )
      goto LABEL_9;
    EngFreeMem(v29);
  }
  return 4294967294LL;
