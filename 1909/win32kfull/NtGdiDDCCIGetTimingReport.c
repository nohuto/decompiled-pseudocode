/*
 * XREFs of NtGdiDDCCIGetTimingReport @ 0x1C026F130
 * Callers:
 *     <none>
 * Callees:
 *     ?DdcciGetTimingReport@CMonitorAPI@@QEAAJPEAXPEAU_MC_TIMING_REPORT@@@Z @ 0x1C026E50C (-DdcciGetTimingReport@CMonitorAPI@@QEAAJPEAXPEAU_MC_TIMING_REPORT@@@Z.c)
 */
