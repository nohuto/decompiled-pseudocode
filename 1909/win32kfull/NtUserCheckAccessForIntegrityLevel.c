/*
 * XREFs of NtUserCheckAccessForIntegrityLevel @ 0x1C0229A70
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall NtUserCheckAccessForIntegrityLevel(int a1, int a2, _DWORD *a3)
{
  ...
  if ( !ProcessWin32Process )
    goto LABEL_2;
  if ( PsGetCurrentProcess(v8, v7, v10, v11) != gpepCSRSS
    && ProcessWin32Process != PsGetCurrentProcessWin32Process(gpepCSRSS, v12) )
  {
    v6 = -1073741790;
    goto LABEL_12;
  }
...
LABEL_2:
  ...
  v14 = (unsigned __int8)CheckAccess(ProcessWin32Process + 872, v13 + 872);
  v15 = a3;
