/*
 * XREFs of NtGdiEnumObjects @ 0x1C02B10B0
 * Callers:
 *     <none>
 * Callees:
...
LABEL_4:
      ...
      if ( v8 < 0x14 )
      {
        if ( v8 < 0x10 )
        {
          ...
          if ( v8 < 8 )
          {
            v10 = *(_DWORD *)(*(_QWORD *)(v19[0] + 48LL) + 2168LL);
            if ( v8 >= 2 )
              v10 = 2;
          }
        }
      ...
      else
      {
        ...
        v12 = (char *)&unk_1C0325500 + 4 * v10;
        v13 = a2 - 1;
        if ( v13 )
        {
          if ( v13 == 1 )
          {
            for ( i = (char *)&unk_1C0325500; i < v12; i += 4 )
            {
              *v4 = 0;
              v4[1] = *(_DWORD *)i;
              *((_QWORD *)v4 + 1) = 0LL;
            ...
            for ( j = (unsigned int *)&gaulHatchStyles; j < dword_1C03254E8; ++j )
            {
              for ( k = (char *)&unk_1C0325500; k < v12; k += 4 )
              {
                *v4 = 2;
                v4[1] = *(_DWORD *)k;
                *((_QWORD *)v4 + 1) = *j;
        ...
        {
          for ( m = dword_1C03254E8; m < &dword_1C03254FC; ++m )
          {
            for ( n = (char *)&unk_1C0325500; n < v12; n += 4 )
            {
              *(_QWORD *)(v4 + 1) = 0LL;
              *v4 = *m;
              v4[3] = *(_DWORD *)n;
