/*
 * XREFs of ?Reset@InteractiveControlDefaultScroller@@AEAAXPEAUtagWND@@@Z @ 0x1C0255734
 * Callers:
...
void __fastcall InteractiveControlDefaultScroller::Reset(InteractiveControlDefaultScroller *this, struct tagWND *a2)
{
  ...
  dword_1C0330E28 = 0;
  dword_1C0330E18 = v4;
  dword_1C0330E14 = *((_DWORD *)InteractiveControlManager::Instance() + 59);
  dword_1C0330E1C = *((_DWORD *)InteractiveControlManager::Instance() + 61);
  dword_1C0330E24 = *((_DWORD *)InteractiveControlManager::Instance() + 63);
  dword_1C0330E2C = *((_DWORD *)InteractiveControlManager::Instance() + 65);
