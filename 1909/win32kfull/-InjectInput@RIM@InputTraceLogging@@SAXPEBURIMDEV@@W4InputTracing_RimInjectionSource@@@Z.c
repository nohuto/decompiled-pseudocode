/*
 * XREFs of ?InjectInput@RIM@InputTraceLogging@@SAXPEBURIMDEV@@W4InputTracing_RimInjectionSource@@@Z @ 0x1C01DE1CC
 * Callers:
 ...
 *     ?PointerDeviceTypeToString@InputTraceLogging@@CAPEBDK@Z @ 0x1C01DE4B4 (-PointerDeviceTypeToString@InputTraceLogging@@CAPEBDK@Z.c)
 */
...
void __fastcall InputTraceLogging::RIM::InjectInput(__int64 a1)
{
  ...
  if ( v2 == 2 )
  {
    ...
    {
      if ( dword_1C03202C0 > 4u && TlgKeywordOn((TraceLoggingHProvider)&dword_1C03202C0, 0x100uLL) )
      {
        v23 = v13;
        ...
        *(_QWORD *)&v28.Size = v16;
        ...
        v29 = &v21;
        v30 = v16;
        TlgWrite((TraceLoggingHProvider)&dword_1C03202C0, &unk_1C02E64FD, 0LL, 0LL, 6u, &pData);
      }
    }
    else if ( dword_1C03202C0 > 4u && TlgKeywordOn((TraceLoggingHProvider)&dword_1C03202C0, 0x100uLL) )
    {
      v23 = v3;
      v26.Ptr = (ULONGLONG)&v23;
      *(_QWORD *)&v26.Size = 8LL;
      ...
      v33 = &v22;
      v34 = v6;
      TlgWrite((TraceLoggingHProvider)&dword_1C03202C0, &unk_1C02E648F, 0LL, 0LL, 8u, &pData);
    }
  }
  else if ( v2 )
  {
    if ( v2 == 1 && dword_1C03202C0 > 4u && TlgKeywordOn((TraceLoggingHProvider)&dword_1C03202C0, 0x100uLL) )
    {
      TlgCreateSz(&v26, "InjectTouchInput");
      v23 = v19;
      pDesc.Ptr = (ULONGLONG)&v23;
      *(_QWORD *)&pDesc.Size = 8LL;
      TlgWrite((TraceLoggingHProvider)&dword_1C03202C0, &unk_1C02E6579, 0LL, 0LL, v20, &pData);
    }
  }
  else if ( dword_1C03202C0 > 4u && TlgKeywordOn((TraceLoggingHProvider)&dword_1C03202C0, 0x100uLL) )
  {
    ...
    pDesc.Ptr = (ULONGLONG)&v23;
    *(_QWORD *)&pDesc.Size = 8LL;
    TlgWrite((TraceLoggingHProvider)&dword_1C03202C0, &unk_1C02E6543, 0LL, 0LL, cData, &pData);
  }
}
