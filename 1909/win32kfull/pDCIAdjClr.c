/*
 * XREFs of pDCIAdjClr @ 0x1C00C37D8
 * Callers:
 ...
 *     Log @ 0x1C00C4868 (Log.c)
 *     ComputeColorSpaceXForm @ 0x1C00C5410 (ComputeColorSpaceXForm.c)
 *     CompareMemory @ 0x1C00C7460 (CompareMemory.c)
 *     __security_check_cookie @ 0x1C0163A80 (__security_check_cookie.c)
 *     memset @ 0x1C0168440 (memset.c)
 *     GenCMYMaskXlate @ 0x1C025E570 (GenCMYMaskXlate.c)
 *     TintAngle @ 0x1C025E7A0 (TintAngle.c)
 */
...
__int64 __fastcall pDCIAdjClr(__int64 a1, __m128i *a2, char **a3, unsigned int a4, __int16 a5, int a6, _DWORD *a7)
{
  ...
  if ( a1 && (v11 = a1 + 40, *(_DWORD *)(a1 + 40) == 1414021956) )
  {
    ...
    {
      dwABPreMul = 0;
      v94 = (unsigned int *)&unk_1C0323BB4;
      for ( i = 1; i < 0x100; ++i )
      {
        v96 = (i - 16777217) / i;
        *v94++ = v96;
