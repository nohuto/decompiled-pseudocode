/*
 * XREFs of DwmAsyncRegisterSharedThumbnailVisual @ 0x1C000A31C
 * Callers:
 *     DwmAsyncRegisterSharedThumbnailVisualApiExt @ 0x1C000A2E0 (DwmAsyncRegisterSharedThumbnailVisualApiExt.c)
 * Callees:
