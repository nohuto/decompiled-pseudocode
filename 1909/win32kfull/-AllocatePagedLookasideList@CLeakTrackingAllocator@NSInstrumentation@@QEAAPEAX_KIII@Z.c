/*
 * XREFs of ?AllocatePagedLookasideList@CLeakTrackingAllocator@NSInstrumentation@@QEAAPEAX_KIII@Z @ 0x1C010D814
 * Callers:
 *     Win32AllocPagedLookasideListImpl @ 0x1C010D7F0 (Win32AllocPagedLookasideListImpl.c)
