/*
 * XREFs of ?SetExternalParameters@InteractiveControlManager@@QEAAJPEAUtagINTERACTIVECTRL_PARAMETERS@@H@Z @ 0x1C024EEEC
 * Callers:
 ...
 *     ?WriteSettings@InteractiveControlSettings@@QEAAJXZ @ 0x1C02528C4 (-WriteSettings@InteractiveControlSettings@@QEAAJXZ.c)
 */
        ...
        int a3)
{
  ...
  if ( dword_1C031F308 > 4u )
  {
    ...
    v11 = 55;
    v14 = 4;
    TlgWrite((TraceLoggingHProvider)&dword_1C031F308, &unk_1C02E8455, 0LL, 0LL, 4u, &pData);
  }
  if ( a2 )
  {
    v6 = *(_DWORD *)a2;
