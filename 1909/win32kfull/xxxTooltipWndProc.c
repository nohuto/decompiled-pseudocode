/*
 * XREFs of xxxTooltipWndProc @ 0x1C00E96D0
 * Callers:
 *     <none>
 * Callees:
 ...
 *     InitTooltipDelay @ 0x1C00EA560 (InitTooltipDelay.c)
...
ULONG_PTR __fastcall xxxTooltipWndProc(struct tagWND *a1, unsigned int a2, HDC a3, HICON a4)
{
  __int64 v9; // rbx
  __int64 v10; // rcx
  ...
  if ( !(unsigned int)xxxValidateClassAndSize((_DWORD)a1, a2, (_DWORD)a3, (_DWORD)a4, 694, 129, (__int64)v17) )
    return v17[0];
  v9 = *((_QWORD *)a1 + 35);
  *(_QWORD *)v9 = a1;
...
LABEL_22:
    ...
    {
      FadeInternal = CreateFadeInternal((ULONG_PTR)a1, 0LL, 0x87u, 0x21u, 0);
    }
    if ( FadeInternal )
    {
      v16 = *(__int64 **)v9;
