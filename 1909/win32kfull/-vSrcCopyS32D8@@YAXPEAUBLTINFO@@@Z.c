/*
 * XREFs of ?vSrcCopyS32D8@@YAXPEAUBLTINFO@@@Z @ 0x1C014FAC0
 * Callers:
 *     <none>
 * Callees:
...
{
  char (__fastcall *v1)(struct _XLATEOBJ *, const unsigned __int8 *, unsigned int); // r12
  unsigned int v2; // ebp
  ...
  v1 = (char (__fastcall *)(struct _XLATEOBJ *, const unsigned __int8 *, unsigned int))XLATEOBJ_ulIndexToPalSurf;
  v2 = *((_DWORD *)a1 + 7);
  v3 = a1;
  ...
  if ( (v11 & 4) != 0 )
  {
    v1 = (char (__fastcall *)(struct _XLATEOBJ *, const unsigned __int8 *, unsigned int))XLATEOBJ_RGB32ToPalSurf;
  }
  else if ( (v11 & 8) != 0 )
  {
  ...
  if ( Xlate555 )
  {
    while ( 1 )
    {
      ...
      if ( v21 )
      {
        ...
        do
        {
          v15 = (unsigned __int8)v1(v4, Xlate555, v13[3]) << 8;
          v16 = (v15 | (unsigned __int8)v1(v4, Xlate555, v13[2])) << 8;
          v17 = v16 | (unsigned __int8)v1(v25, Xlate555, v13[1]);
          v4 = v25;
