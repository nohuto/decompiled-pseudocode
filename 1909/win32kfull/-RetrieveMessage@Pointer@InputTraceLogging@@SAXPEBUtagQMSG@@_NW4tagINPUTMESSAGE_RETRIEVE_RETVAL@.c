/*
 * XREFs of ?RetrieveMessage@Pointer@InputTraceLogging@@SAXPEBUtagQMSG@@_NW4tagINPUTMESSAGE_RETRIEVE_RETVAL@@@Z @ 0x1C01E2A74
 * Callers:
...
void InputTraceLogging::Pointer::RetrieveMessage()
{
  ...
  if ( dword_1C03202C0 > 4u && TlgKeywordOn((TraceLoggingHProvider)&dword_1C03202C0, 0x20uLL) )
  {
    v3 = *(_QWORD *)(v2 + 136);
    v17 = 0;
    v20 = 0;
    ...
    v12 = v8;
    v32 = 4;
    TlgWrite((TraceLoggingHProvider)&dword_1C03202C0, &unk_1C02E6999, 0LL, 0LL, 9u, &pData);
  }
}
