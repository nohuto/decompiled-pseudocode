/*
 * XREFs of vSrcTranCopyS1D8 @ 0x1C01435E0
 * Callers:
 *     <none>
 * Callees:
 *     <none>
        ...
        unsigned __int8 a9)
{
  ...
  if ( (a6 & 0xFFFFFFF8) != (a5 & 0xFFFFFFF8) )
  {
    ...
    do
    {
      ...
      {
        v37 = dword_1C02E4550[(unsigned __int64)(unsigned __int8)(v17 & *v21) >> 4] | ((unsigned __int64)dword_1C02E4550[(unsigned __int8)v17 & *v21 & 0xF] << 32);
        *v15 = v14 & v37 | *v15 & ~v37;
      }
      v24 = v15 + 1;
      v25 = v21 + 1;
      ...
      if ( v27 )
      {
        do
        {
          if ( *v25 )
          {
            v36 = dword_1C02E4550[(unsigned __int64)(unsigned __int8)*v25 >> 4] | ((unsigned __int64)dword_1C02E4550[*v25 & 0xF] << 32);
            *v24 = v14 & v36 | *v24 & ~v36;
          }
          ++v25;
          ++v24;
