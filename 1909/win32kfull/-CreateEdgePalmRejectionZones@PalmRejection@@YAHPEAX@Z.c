/*
 * XREFs of ?CreateEdgePalmRejectionZones@PalmRejection@@YAHPEAX@Z @ 0x1C01F67D4
 * Callers:
 *     EditionCreateEdgePalmRejectionZones @ 0x1C01F69C0 (EditionCreateEdgePalmRejectionZones.c)
 * Callees:
