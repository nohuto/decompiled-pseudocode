/*
 * XREFs of ?TryResurrectPffApcRoutine@UmfdHostLifeTimeManager@@CAXPEAX00@Z @ 0x1C02BA5D0
 * Callers:
 ...
 *     ?HFFToPPFF@PFTOBJ@@QEAAPEAVPFF@@_K@Z @ 0x1C026F714 (-HFFToPPFF@PFTOBJ@@QEAAPEAVPFF@@_K@Z.c)
