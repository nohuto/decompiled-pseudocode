/*
 * XREFs of _UserTestForWinStaAccess @ 0x1C007E064
 * Callers:
    ...
    if ( v8 == -1073741789 )
    {
      ...
      if ( v10 )
      {
        ...
        if ( v8 >= 0 )
        {
          ...
          {
            v12 = v10[2];
            v13 = *(_DWORD *)(grpWinStaList + 152LL);
            if ( a2 )
            {
              if ( v12 == v13 && v10[3] == *(_DWORD *)(grpWinStaList + 156LL)
            ...
            else if ( v12 == v13 && v10[3] == *(_DWORD *)(grpWinStaList + 156LL) )
            {
              v8 = 0;
            }
          }
