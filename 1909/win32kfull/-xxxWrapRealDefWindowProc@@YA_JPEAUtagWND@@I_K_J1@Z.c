/*
 * XREFs of ?xxxWrapRealDefWindowProc@@YA_JPEAUtagWND@@I_K_J1@Z @ 0x1C00A9E40
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall xxxWrapRealDefWindowProc(struct tagWND *a1, __int64 a2, unsigned __int64 a3, HICON a4)
{
  unsigned int v6; // ebx
  ...
  if ( a1 != (struct tagWND *)-1LL )
  {
    ...
    if ( v6 != 717 )
    {
      ...
      if ( v12 )
      {
        MSGSQMAddMessage(v9, (struct tagPROCESSINFO *)v10, v6, a3, (unsigned __int64)a4, 1, 2);
      }
      else
      {
        if ( v6 == 274 && ((a3 - 61472) & 0xFFFFFFFFFFFFFEBFuLL) == 0 && a3 != 61792 )
        {
          MSGSQMAddMessage(v9, (struct tagPROCESSINFO *)v10, 0x112u, a3, (unsigned __int64)a4, 1, 2);
          return xxxRealDefWindowProc(a1, v6, a3, a4);
        }
        if ( *(_QWORD *)v10 == gpepCSRSS )
          ...
          v21 = *(_QWORD *)(v10 + 872);
        v13 = CheckAccess((char *)v9 + 872, &v21);
        v12 = v13;
        if ( v13 )
        {
          ...
          if ( v15 )
            v16 = 1;
          MSGSQMAddMessage(v9, (struct tagPROCESSINFO *)v10, v6, a3, (unsigned __int64)a4, 1, v16);
        }
        if ( v12 )
          return xxxRealDefWindowProc(a1, v6, a3, a4);
        if ( v6 == 793 )
        ...
        MSGSQMAddMessage(v9, (struct tagPROCESSINFO *)v10, v6, a3, (unsigned __int64)a4, 1, 0);
      }
      if ( v12 )
        return xxxRealDefWindowProc(a1, v6, a3, a4);
    }
  ...
  UserSetLastError(5LL, a2, a3, (__int64)a4);
  return 0LL;
}
