/*
 * XREFs of ?bWiden@EPATHOBJ@@QEAAHAEAV1@PEAU_XFORMOBJ@@PEAU_LINEATTRS@@@Z @ 0x1C00F2BBC
 * Callers:
 ...
 * Callees:
 *     ?vMakeItWide@WIDENER@@QEAAXAEAVEPATHOBJ@@@Z @ 0x1C00F2C60 (-vMakeItWide@WIDENER@@QEAAXAEAVEPATHOBJ@@@Z.c)
