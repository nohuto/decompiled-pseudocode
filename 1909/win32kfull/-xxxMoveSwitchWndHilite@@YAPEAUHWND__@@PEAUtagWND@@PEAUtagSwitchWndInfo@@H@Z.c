/*
 * XREFs of ?xxxMoveSwitchWndHilite@@YAPEAUHWND__@@PEAUtagWND@@PEAUtagSwitchWndInfo@@H@Z @ 0x1C01F41DC
 * Callers:
...
LABEL_23:
  ...
  *((_DWORD *)v6 + 17) = v10;
  ...
  if ( v6 )
  {
    ...
    _ReleaseDC(DCEx);
    xxxWindowEvent(0x8005u, a1, 4294967292LL, v10 + v4 * *((_DWORD *)v6 + 14) + 1, 1);
  }
  else
  {
    _ReleaseDC(DCEx);
