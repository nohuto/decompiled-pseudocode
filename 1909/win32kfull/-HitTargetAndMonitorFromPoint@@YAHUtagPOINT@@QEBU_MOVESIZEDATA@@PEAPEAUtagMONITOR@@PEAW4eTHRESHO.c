/*
 * XREFs of ?HitTargetAndMonitorFromPoint@@YAHUtagPOINT@@QEBU_MOVESIZEDATA@@PEAPEAUtagMONITOR@@PEAW4eTHRESHOLD_MARGIN_DIRECTION@@@Z @ 0x1C01FA4F0
 * Callers:
 ...
 *     ?ComputeSizeOutcome@@YA?AW4_MOUSE_SIZE_OUTCOME@@UtagPOINT@@QEBU_MOVESIZEDATA@@PEAPEAUtagMONITOR@@PEAW4eTHRESHOLD_MARGIN_DIRECTION@@@Z @ 0x1C01F9BD8 (-ComputeSizeOutcome@@YA-AW4_MOUSE_SIZE_OUTCOME@@UtagPOINT@@QEBU_MOVESIZEDATA@@PEAPEAUtagMONITOR@.c)
 ...
 *     ?PtInRectSpace@@YAHPEBUtagRECT@@UtagPOINT@@W4eTHRESHOLD_MARGIN_DIRECTION@@@Z @ 0x1C01FB10C (-PtInRectSpace@@YAHPEBUtagRECT@@UtagPOINT@@W4eTHRESHOLD_MARGIN_DIRECTION@@@Z.c)
        ...
        enum eTHRESHOLD_MARGIN_DIRECTION *a4)
{
  ...
  *(_QWORD *)&v25.right = 0LL;
  ...
  {
    if ( !v10 )
      v10 = gWinArrGlobal[dword_1C02E1314[4 * (unsigned int)v9]];
    if ( !v11 )
      v11 = gWinArrGlobal[dword_1C02E1318[4 * v9]];
    if ( !v12 )
      v12 = gWinArrGlobal[dword_1C02E131C[4 * v9]];
  }
  v13 = v25;
  v14 = v25.left + v10;
...
LABEL_20:
  ...
  *(struct tagRECT *)v24 = v13;
  LODWORD(v24[0]) = _mm_srli_si128((__m128i)v13, 8).m128i_u32[0] - v11;
