/*
 * XREFs of ?vSpAddAndCompactDirtyRegion@@YAXPEAVSPRITE@@PEAVREGION@@@Z @ 0x1C0162B24
 * Callers:
...
void __fastcall vSpAddAndCompactDirtyRegion(struct SPRITE *a1, struct REGION *a2)
{
  ...
  unsigned __int128 v11; // [rsp+50h] [rbp-20h] BYREF
        ...
        if ( RGNOBJ::bMerge((RGNOBJ *)v10, (struct RGNOBJ *)&v6, (struct RGNOBJ *)&v7, BYTE2(gafjRgnOp)) )
        {
          ...
          if ( v5 == 3 && (unsigned int)RGNOBJ::iComplexity((RGNOBJ *)&v6) == 2 )
          {
            ...
            if ( v8 )
            {
              v11 = 0uLL;
              v11 = *(_OWORD *)(v6 + 88);
              RGNOBJ::vSet((RGNOBJ *)&v8, (struct _RECTL *)&v11);
