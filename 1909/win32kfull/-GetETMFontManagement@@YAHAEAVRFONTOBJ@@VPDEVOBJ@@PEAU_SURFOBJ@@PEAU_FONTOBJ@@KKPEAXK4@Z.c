/*
 * XREFs of ?GetETMFontManagement@@YAHAEAVRFONTOBJ@@VPDEVOBJ@@PEAU_SURFOBJ@@PEAU_FONTOBJ@@KKPEAXK4@Z @ 0x1C01592D8
 * Callers:
        ...
        void *a7)
{
  ...
  v16 = *(_QWORD *)a1;
  if ( a2 != qword_1C0330E80 || v16 && *(_DWORD *)(*(_QWORD *)(v16 + 24) + 8LL) == 3 )
  {
    v23 = *(void **)(v16 + 128);
