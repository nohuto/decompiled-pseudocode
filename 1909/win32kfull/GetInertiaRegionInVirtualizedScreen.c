/*
 * XREFs of GetInertiaRegionInVirtualizedScreen @ 0x1C0207018
 * Callers:
 ...
 * Callees:
 *     D3DXVec4Transform @ 0x1C01E61D0 (D3DXVec4Transform.c)
 */
  ...
  *a2 = *v7;
  ...
  if ( (*(_DWORD *)(a1 + 184) & 4) != 0 )
  {
    ...
    do
    {
      ...
      *(float *)&v11 = v10;
      DWORD1(v11) = _mm_cvtepi32_ps(v9).m128_u32[0];
      D3DXVec4Transform(&v11, (float *)&v11, v8);
      *a2 = (int)*(float *)&v11;
      a2 += 2;
      *(a2 - 1) = (int)*((float *)&v11 + 1);
      --v6;
    }
    while ( v6 );
  }
