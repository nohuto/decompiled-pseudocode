/*
 * XREFs of _GetRegisteredRawInputDevices @ 0x1C01D8284
 * Callers:
 *     NtUserGetRegisteredRawInputDevices @ 0x1C022E8F0 (NtUserGetRegisteredRawInputDevices.c)
 * Callees:
 *     UserSetLastError @ 0x1C002862C (UserSetLastError.c)
 *     ?SortRegisteredDevices@@YAXPEAUtagRAWINPUTDEVICE@@H@Z @ 0x1C01D7C04 (-SortRegisteredDevices@@YAXPEAUtagRAWINPUTDEVICE@@H@Z.c)
 */
...
__int64 __fastcall GetRegisteredRawInputDevices(struct tagRAWINPUTDEVICE *a1, unsigned int *a2)
{
  ...
  if ( a1 )
  {
    ...
    if ( (_DWORD)v16 )
    {
      ...
      v20 = *(_QWORD *)(CurrentProcessWin32Process + 824);
      if ( v20 )
      {
        if ( (unsigned int)v16 >= v5 )
        {
          ...
          while ( 1 )
          {
            v23 = *(_QWORD *)(CurrentProcessWin32Process + 824);
...
LABEL_48:
          ...
          while ( 1 )
          {
            v34 = *(_QWORD *)(CurrentProcessWin32Process + 824);
          ...
          v38 = *(__int64 **)(v34 + 48);
          while ( v38 != (__int64 *)(*(_QWORD *)(CurrentProcessWin32Process + 824) + 48LL) && v21 < (unsigned int)v16 )
          {
            HIDWORD(v42) = 16;
