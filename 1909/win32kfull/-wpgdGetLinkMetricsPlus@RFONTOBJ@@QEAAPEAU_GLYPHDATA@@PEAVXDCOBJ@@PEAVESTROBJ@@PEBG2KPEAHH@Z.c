/*
 * XREFs of ?wpgdGetLinkMetricsPlus@RFONTOBJ@@QEAAPEAU_GLYPHDATA@@PEAVXDCOBJ@@PEAVESTROBJ@@PEBG2KPEAHH@Z @ 0x1C0090FA8
 * Callers:
        ...
        int a8)
{
  ...
  if ( !*(_DWORD *)(*(_QWORD *)a2 + 304LL) )
  {
    ...
    if ( *(_DWORD *)(v17 + 708)
      && v18 >= gqlTTSystem
      && v18 <= (unsigned __int16)word_1C032C032
      && ((0x80000000 >> ((v18 - gqlTTSystem) % 32)) & *(_DWORD *)(qword_1C032C038 + 4LL * ((v18 - gqlTTSystem) / 32))) != 0 )
    {
      if ( *(_QWORD *)(v17 + 720) )
      {
