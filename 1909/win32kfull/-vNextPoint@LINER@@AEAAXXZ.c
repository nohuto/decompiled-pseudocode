/*
 * XREFs of ?vNextPoint@LINER@@AEAAXXZ @ 0x1C00F33B4
 * Callers:
 ...
 *     ?vInit@BEZIER@@QEAAXPEAU_POINTFIX@@PEAU_RECTFX@@PEB_J@Z @ 0x1C015AA5C (-vInit@BEZIER@@QEAAXPEAU_POINTFIX@@PEAU_RECTFX@@PEB_J@Z.c)
