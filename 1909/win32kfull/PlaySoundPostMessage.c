/*
 * XREFs of PlaySoundPostMessage @ 0x1C0368008
 * Callers:
 *     ?PlaySync@CUserPlaySound@@AEAAJK@Z @ 0x1C00E31E0 (-PlaySync@CUserPlaySound@@AEAAJK@Z.c)
 * Callees:
 *     I_PlaySoundkPostMessage @ 0x1C00E3278 (I_PlaySoundkPostMessage.c)
 *     PlaySndClient_midl_user_allocate @ 0x1C00E32D0 (PlaySndClient_midl_user_allocate.c)
 *     ?PlatformFree@NSInstrumentation@@YAXPEAX@Z @ 0x1C00EF350 (-PlatformFree@NSInstrumentation@@YAXPEAX@Z.c)
 */
