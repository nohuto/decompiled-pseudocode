/*
 * XREFs of ?MulDestroyFont@@YAXPEAU_FONTOBJ@@@Z @ 0x1C029B850
 * Callers:
 *     <none>
 * Callees:
 *     ?DestroyFont@PDEVOBJ@@QEAAXPEAU_FONTOBJ@@@Z @ 0x1C0096218 (-DestroyFont@PDEVOBJ@@QEAAXPEAU_FONTOBJ@@@Z.c)
 *     ??0MULTIFONT@@QEAA@PEAU_FONTOBJ@@JPEAU_VDEV@@@Z @ 0x1C029994C (--0MULTIFONT@@QEAA@PEAU_FONTOBJ@@JPEAU_VDEV@@@Z.c)
 *     ??1MULTIFONT@@QEAA@XZ @ 0x1C0299AF8 (--1MULTIFONT@@QEAA@XZ.c)
 *     ?DestroyTable@MULTIFONT@@QEAAXXZ @ 0x1C0299C28 (-DestroyTable@MULTIFONT@@QEAAXXZ.c)
 */
