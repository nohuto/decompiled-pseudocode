/*
 * XREFs of UmfdLoadFontFileView @ 0x1C0121224
 * Callers:
 ...
 * Callees:
 *     ?bIsPathInSystemFontsDir@@YAHPEBG@Z @ 0x1C011F8AC (-bIsPathInSystemFontsDir@@YAHPEBG@Z.c)
 ...
 *     ?LookUpFNTCacheTable@@YAHKPEAGPEAK1PEAPEAVPDEV@@1HPEAH3PEAPEAU_FONTFILEVIEW@@KPEAUtagDESIGNVECTOR@@K@Z @ 0x1C01217FC (-LookUpFNTCacheTable@@YAHKPEAGPEAK1PEAPEAVPDEV@@1HPEAH3PEAPEAU_FONTFILEVIEW@@KPEAUtagDESIGNVECTO.c)
 ...
 *     ?PutFntCacheDrvAndFileInfo@@YAXKPEAVPDEV@@KPEAPEAU_FONTFILEVIEW@@K@Z @ 0x1C02852F8 (-PutFntCacheDrvAndFileInfo@@YAXKPEAVPDEV@@KPEAPEAU_FONTFILEVIEW@@K@Z.c)
 */
  ...
  *v15 = 0LL;
  if ( (_BYTE)result )
  {
    ...
    if ( !v41 )
    {
      ...
      v21 = v47;
      v22 = 1;
      for ( i = qword_1C0330E80; v20 < v47; v21 = v47 )
      {
        v23 = v20++;
        *((_DWORD *)v46[v23] + 16) = 0;
      }
      ...
      else
      {
        ...
        PutFntCacheDrvAndFileInfo(*v17, qword_1C0330E80, v39, v46, v47);
      }
      if ( v30 )
      {
        *v15 = qword_1C0330E80;
