/*
 * XREFs of ?SetCapture@Mouse@InputTraceLogging@@SAXPEBUtagQ@@PEAUtagWND@@_N@Z @ 0x1C001E2FC
 * Callers:
    ...
    *(_OWORD *)pwsz_8 = *(_OWORD *)(WindowDetails + 16);
    ...
    if ( dword_1C03202C0 > 4u )
    {
      if ( TlgKeywordOn((TraceLoggingHProvider)&dword_1C03202C0, 0x40uLL) )
      {
        ...
        TlgWrite((TraceLoggingHProvider)&dword_1C03202C0, &unk_1C02E795A, 0LL, 0LL, 0xCu, &pData);
      }
    }
  }
}
