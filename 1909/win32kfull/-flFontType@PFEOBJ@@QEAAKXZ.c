/*
 * XREFs of ?flFontType@PFEOBJ@@QEAAKXZ @ 0x1C0098260
 * Callers:
 ...
 *     ?vDeletePFELink@FHOBJ@@QEAAXPEAU_HASHBUCKET@@IAEAVPFEOBJ@@@Z @ 0x1C0095FE8 (-vDeletePFELink@FHOBJ@@QEAAXPEAU_HASHBUCKET@@IAEAVPFEOBJ@@@Z.c)
