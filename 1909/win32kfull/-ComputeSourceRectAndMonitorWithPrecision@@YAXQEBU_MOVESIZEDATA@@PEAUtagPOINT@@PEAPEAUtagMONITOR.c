/*
 * XREFs of ?ComputeSourceRectAndMonitorWithPrecision@@YAXQEBU_MOVESIZEDATA@@PEAUtagPOINT@@PEAPEAUtagMONITOR@@PEAUtagRECT@@@Z @ 0x1C01F9C98
 * Callers:
        ...
        struct tagRECT *a4)
{
  ...
  CurrentThreadDpiAwarenessContext = W32GetCurrentThreadDpiAwarenessContext((__int64)a1, (__int64)a2, (__int64)a3);
  v9 = *((_DWORD *)a1 + 49);
  v10 = CurrentThreadDpiAwarenessContext;
  if ( (v9 & 0x38000) == 0x30000 )
  {
    v19 = MonitorFromPoint((__int64)*a2, 2u, CurrentThreadDpiAwarenessContext);
...
LABEL_13:
  ...
  if ( *(_DWORD *)*gpDispInfo <= 1u || (*(_DWORD *)(*(_QWORD *)(*((_QWORD *)a1 + 2) + 40LL) + 288LL) & 0xF) == 2 )
  {
    ...
    v15 = MonitorFromPoint((__int64)*a2, 2u, 0x12u);
