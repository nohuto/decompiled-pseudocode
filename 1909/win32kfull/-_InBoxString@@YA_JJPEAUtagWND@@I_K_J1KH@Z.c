/*
 * XREFs of ?_InBoxString@@YA_JJPEAUtagWND@@I_K_J1KH@Z @ 0x1C010A3F4
 * Callers:
 *     NtUserfnINLBOXSTRING @ 0x1C010A3B0 (NtUserfnINLBOXSTRING.c)
 *     NtUserfnINCBOXSTRING @ 0x1C015EA70 (NtUserfnINCBOXSTRING.c)
 * Callees:
