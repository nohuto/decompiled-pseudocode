/*
 * XREFs of ?CallDefaultInputHandler@Delivery@InputTraceLogging@@SAXPEBUtagMSG@@@Z @ 0x1C0214394
 * Callers:
...
void __fastcall InputTraceLogging::Delivery::CallDefaultInputHandler(const struct tagMSG *a1)
{
  ...
  if ( IsPointerInputMessage(*((_DWORD *)a1 + 2)) )
  {
    ...
    if ( v3 == 1 )
    {
      if ( dword_1C03202C0 > 4u )
      {
        if ( TlgKeywordOn((TraceLoggingHProvider)&dword_1C03202C0, 0x10uLL) )
        {
          ...
          v33 = v4;
          v35 = v4;
          TlgWrite((TraceLoggingHProvider)&dword_1C03202C0, &unk_1C02E79F4, 0LL, 0LL, 9u, &pData);
        }
      }
    }
    else if ( dword_1C03202C0 > 4u && TlgKeywordOn((TraceLoggingHProvider)&dword_1C03202C0, 0x10uLL) )
    {
      ...
      v35 = v7;
      v37 = v7;
      TlgWrite((TraceLoggingHProvider)&dword_1C03202C0, &unk_1C02E7A88, 0LL, 0LL, 0xAu, &pData);
    }
  }
         ...
         && TlgKeywordOn((TraceLoggingHProvider)&dword_1C03202C0, 0x10uLL) )
  {
    ...
    v31 = v29;
    v33 = v11;
    TlgWrite((TraceLoggingHProvider)&dword_1C03202C0, &unk_1C02E7B2B, 0LL, 0LL, v10 - 8, &pData);
  }
}
