/*
 * XREFs of InitializePointerDevicesPresenceState @ 0x1C0079B70
 * Callers:
 *     ?InitiateWin32kCleanup@@YAHXZ @ 0x1C007A04C (-InitiateWin32kCleanup@@YAHXZ.c)
 * Callees:
 *     FreePointerDeviceClientList @ 0x1C0079BD0 (FreePointerDeviceClientList.c)
 */
...
int __fastcall InitializePointerDevicesPresenceState(int a1)
{
  ...
  if ( a1 )
  {
    ...
    qword_1C032B058 = (__int64)&gPointerDeviceClients;
