/*
 * XREFs of ?TraceLoggingYieldedHotkey@@YAXII@Z @ 0x1C01CF7F4
 * Callers:
...
void __fastcall TraceLoggingYieldedHotkey(__int64 a1, __int64 a2)
{
  ...
  if ( hProvider > 5u && TlgKeywordOn((TraceLoggingHProvider)&hProvider, 0x400000000000uLL) )
  {
    ...
    if ( v2 )
      ...
      ProcessImageFileName = (const CHAR *)&unk_1C02DA5C1;
    TlgCreateSz(&pDesc, ProcessImageFileName);
    TlgWrite((TraceLoggingHProvider)&hProvider, &unk_1C02E4D92, 0LL, 0LL, 6u, &pData);
  }
}
