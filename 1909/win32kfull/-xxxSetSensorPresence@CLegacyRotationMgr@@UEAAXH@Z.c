/*
 * XREFs of ?xxxSetSensorPresence@CLegacyRotationMgr@@UEAAXH@Z @ 0x1C01D58D0
 * Callers:
 *     <none>
 * Callees:
              ...
              L"\\Registry\\Machine\\Software\\Microsoft\\Windows\\CurrentVersion\\AutoRotation") >= 0 )
  {
    ...
    if ( hProvider > 5u )
    {
      if ( TlgKeywordOn((TraceLoggingHProvider)&hProvider, 0x400000000001uLL) )
      {
        ...
        v4 = &v2;
        v5 = 4;
        TlgWrite((TraceLoggingHProvider)&hProvider, &unk_1C02E62E6, 0LL, 0LL, 3u, &pData);
      }
    }
  }
}
