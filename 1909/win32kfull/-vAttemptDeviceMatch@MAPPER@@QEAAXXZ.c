/*
 * XREFs of ?vAttemptDeviceMatch@MAPPER@@QEAAXXZ @ 0x1C028E08C
 * Callers:
 ...
 *     ?ppfeFirst@ENUMFHOBJ@@QEAAPEAVPFE@@XZ @ 0x1C028E018 (-ppfeFirst@ENUMFHOBJ@@QEAAPEAVPFE@@XZ.c)
 *     ?ppfeNext@ENUMFHOBJ@@QEAAPEAVPFE@@XZ @ 0x1C028E04C (-ppfeNext@ENUMFHOBJ@@QEAAPEAVPFE@@XZ.c)
 *     ?vSetBest@MAPPER@@QEAAXPEAVPFE@@HE@Z @ 0x1C028E37C (-vSetBest@MAPPER@@QEAAXPEAVPFE@@HE@Z.c)
 *     ulCharsetToCodePage @ 0x1C02D2354 (ulCharsetToCodePage.c)
 */
        ...
        *((_DWORD *)this + 45) = 3;
        ...
        for ( i = ENUMFHOBJ::ppfeFirst((ENUMFHOBJ *)v13); ; i = ENUMFHOBJ::ppfeNext((ENUMFHOBJ *)v13) )
        {
          ...
          if ( (unsigned int)MAPPER::bNearMatch(this, &v16, &v15, 0) )
          {
            ...
            if ( !v8 )
            {
              if ( !_wcsicmp((const wchar_t *)(*((_QWORD *)v9 + 4) + *(int *)(*((_QWORD *)v9 + 4) + 8LL)), L"Arial") )
              {
