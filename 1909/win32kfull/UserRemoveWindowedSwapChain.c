/*
 * XREFs of UserRemoveWindowedSwapChain @ 0x1C015DE50
 * Callers:
 *     <none>
 * Callees:
 ...
 *     ??$RemoveProp@VCSwapChainProp@@@CWindowProp@@SAHPEAUtagWND@@PEAPEAVCSwapChainProp@@@Z @ 0x1C0239908 (--$RemoveProp@VCSwapChainProp@@@CWindowProp@@SAHPEAUtagWND@@PEAPEAVCSwapChainProp@@@Z.c)
 */
