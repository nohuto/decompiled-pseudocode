/*
 * XREFs of NtGdiEngStretchBlt @ 0x1C00A1240
 * Callers:
 *     <none>
 * Callees:
        ...
        ULONG iMode)
{
  ...
  struct _POINTL v45; // [rsp+D0h] [rbp-A8h] BYREF
  POINTL v46; // [rsp+D8h] [rbp-A0h] BYREF
  struct _CLIPOBJ *v47; // [rsp+E0h] [rbp-98h]
  struct UMPDOBJ *v48; // [rsp+E8h] [rbp-90h]
  unsigned __int128 v49; // [rsp+F0h] [rbp-88h] BYREF
  unsigned __int128 v50; // [rsp+100h] [rbp-78h] BYREF
  __int128 v51; // [rsp+110h] [rbp-68h] BYREF
  __int64 v52; // [rsp+120h] [rbp-58h]
  struct _RECTL v53; // [rsp+128h] [rbp-50h] BYREF
  ...
  if ( psoDest && psoSrc && (v22 = prclDest) != 0LL && (v23 = (struct _RECTL *)a9) != 0LL )
  {
    ...
    if ( !(unsigned int)bCheckDestSurfaceOverlap(psoDest, (struct _RECTL *)&v49) )
    {
      if ( v36 )
        EngUnlockSurface(pso);
      if ( v33 )
    ...
    pco = UMPDOBJ::GetDDIOBJ(v18, v47, &v21->sizlBitmap);
    v31 = UMPDOBJ::GetDDIOBJ<_XLATEOBJ>(v18, a5);
    if ( (unsigned int)bOrder((struct _RECTL *)&v50) && (unsigned int)bCheckXlate(psoSrc, pxlo) )
    {
      v28 = 1;
      if ( pso )
      {
        ...
        *(_QWORD *)&v53.right = 0LL;
        ...
        if ( v28 )
        {
          v29 = pRect(pptlMask, &v53, v38, v37);
