/*
 * XREFs of ?Free@?$CTypeIsolation@$0DJAAA@$0DJA@@NSInstrumentation@@IEAAXPEAX@Z @ 0x1C00E4808
 * Callers:
...
LABEL_18:
      ...
      while ( 1 )
      {
        v8 = (__int64 *)v7[4];
        v9 = v8[1] ^ v8[2];
        if ( (unsigned __int64)a2 < v9 || (unsigned __int64)a2 >= v9 + 233472 )
        {
          v10 = 0;
        }
        else
          ...
          if ( v6 == 912 * (v6 / 0x390) )
            v10 = 2
                - (RtlTestBit(
                     ...
                     4 * (((unsigned int)a2 - (*((_DWORD *)v8 + 2) ^ (unsigned int)v8[2])) >> 12)
        ...
        if ( !v11 )
        {
          NSInstrumentation::CSectionBitmapAllocator<233472,912>::Free(v8, a2);
