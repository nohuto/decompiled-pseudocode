/*
 * XREFs of MagGetLensContextInformation @ 0x1C01CFF90
 * Callers:
 ...
 *     _GetMagnificationInputTransform @ 0x1C0203270 (_GetMagnificationInputTransform.c)
        ...
        int *a7)
{
  ...
  switch ( a5 )
  {
    ...
    case 3:
      if ( !a3 )
        return updated;
      if ( a3 != -1 || (v52 = *(__int64 **)(*(_QWORD *)(ThreadContext[2] + 448LL) + 224LL)) == 0LL )
      {
      ...
      else
      {
        ...
        *(_OWORD *)(a6 + 16) = xmmword_1C03236A8;
      }
      return 0;
    case 4:
    ...
    case 5:
      if ( !a3 )
        return updated;
      if ( a3 != -1 || (v50 = *(__int64 **)(*(_QWORD *)(ThreadContext[2] + 448LL) + 232LL)) == 0LL )
      {
      ...
      else
      {
        ...
        *(_OWORD *)(a6 + 16) = xmmword_1C03236D0;
        *(_OWORD *)(a6 + 32) = xmmword_1C03236E0;
        *(_OWORD *)(a6 + 48) = xmmword_1C03236F0;
        *(_OWORD *)(a6 + 64) = xmmword_1C0323700;
        *(_OWORD *)(a6 + 80) = xmmword_1C0323710;
        v51 = dword_1C0323720;
      }
      *(_DWORD *)(a6 + 96) = v51;
      return 0;
  ...
  v20 = *((_DWORD *)v15 + 4);
  v21 = (v20 >> 6) & 1;
  if ( (v20 & 0x20) != 0 || !*((_DWORD *)v19 + 60) )
  {
    v28 = a6;
    *(_DWORD *)a6 = 0;
    *(_DWORD *)(a6 + 8) = 0;
    *(_QWORD *)(a6 + 40) = 0LL;
    *(_DWORD *)(a6 + 4) = *((_DWORD *)v19 + 60);
    *(_DWORD *)(a6 + 12) = *((_DWORD *)v19 + 61);
    *(_DWORD *)(a6 + 16) = *((_DWORD *)v19 + 62);
    *(_DWORD *)(a6 + 20) = *((_DWORD *)v19 + 63);
LABEL_44:
  ...
  *(_QWORD *)(ThreadWin32Thread + 408) = &v55;
  ...
  v26 = (void *)ReferenceDwmApiPort(v23, gdwInAtomicOperation, v24);
