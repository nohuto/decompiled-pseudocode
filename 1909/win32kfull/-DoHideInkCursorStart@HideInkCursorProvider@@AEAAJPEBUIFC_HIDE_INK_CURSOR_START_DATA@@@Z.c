/*
 * XREFs of ?DoHideInkCursorStart@HideInkCursorProvider@@AEAAJPEBUIFC_HIDE_INK_CURSOR_START_DATA@@@Z @ 0x1C024F23C
 * Callers:
        ...
        const struct IFC_HIDE_INK_CURSOR_START_DATA *a2)
{
  ...
  *v2 = v4 + 1;
  if ( dword_1C031F298 > 4u )
  {
    ...
    v21 = v2;
    v22 = v6;
    TlgWrite((TraceLoggingHProvider)&dword_1C031F298, &unk_1C02E885A, 0LL, 0LL, 7u, &pData);
  }
  return 0LL;
}
