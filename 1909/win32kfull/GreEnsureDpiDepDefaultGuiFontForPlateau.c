/*
 * XREFs of GreEnsureDpiDepDefaultGuiFontForPlateau @ 0x1C028D590
 * Callers:
 *     NtGdiEnsureDpiDepDefaultGuiFontForPlateau @ 0x1C02A7270 (NtGdiEnsureDpiDepDefaultGuiFontForPlateau.c)
 * Callees:
