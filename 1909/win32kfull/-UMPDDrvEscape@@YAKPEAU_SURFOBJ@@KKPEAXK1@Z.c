/*
 * XREFs of ?UMPDDrvEscape@@YAKPEAU_SURFOBJ@@KKPEAXK1@Z @ 0x1C00F0810
 * Callers:
 *     <none>
 * Callees:
...
LABEL_15:
        if ( (!a3
           ...
           || (unsigned int)UMPDOBJ::ThunkMemBlock(v17, (const void **)&v31[5], a3))
          && (!Size || (v31[7] = UMPDOBJ::_AllocUserMem(v10, Size, 1)) != 0LL) )
        {
          ...
          {
            LODWORD(v20) = 4;
            if ( (unsigned int)UMPDOBJ::Thunk(v10, v31, 64LL, &v22, v20) != -1 )
            {
              if ( Size )
              {
                KernelPtr = UMPDOBJ::GetKernelPtr(v10, (char *)v31[7]);
      ...
      v23 = 0;
      if ( (unsigned int)UMPDOBJ::ThunkDDIOBJ(v10, (UMPDOBJ *)((char *)v10 + 272), (const void **)&v25, 4u, &v23) )
      {
        v15 = (_QWORD *)v31[5];
        v16 = v25;
        goto LABEL_14;
