/*
 * XREFs of ?GetTiltKeyName@@YAJU_UNICODE_STRING@@PEAPEAGH@Z @ 0x1C01D1A34
 * Callers:
 ...
 *     ?GetDeviceId@@YAJU_UNICODE_STRING@@PEAPEAG1@Z @ 0x1C01D1904 (-GetDeviceId@@YAJU_UNICODE_STRING@@PEAPEAG1@Z.c)
 *     ?GetInstanceId@@YAJU_UNICODE_STRING@@PEAPEAG1@Z @ 0x1C01D198C (-GetInstanceId@@YAJU_UNICODE_STRING@@PEAPEAG1@Z.c)
 */
