/*
 * XREFs of ?TemplateWindow@CWindow@@QEAA_NPEAUtagWND@@W4TemplateWindowOptions@@@Z @ 0x1C023DB60
 * Callers:
...
char __fastcall CWindow::TemplateWindow(__int64 a1, __int64 a2, __int64 a3)
{
  __int64 v3; // rbp
  char v4; // di
  char v5; // bl
  ...
  v4 = a3;
  v5 = 0;
  v6 = HMValidateHandleNoSecure(*(_QWORD *)(a1 + 16), a2, a3);
  v7 = v6;
  if ( v6 )
  {
    if ( v6 == v3 )
            ...
            else
            {
              for ( i = *(struct tagWND **)(v6 + 96); i; i = *(struct tagWND **)(v15 + 96) )
              {
                ...
                if ( v11 != (*(_BYTE *)(v18 + 24) & 8) || v12 != *(_DWORD *)(v18 + 236) )
                {
                  if ( !v8 )
                    v8 = (__int64 *)v15;
                  return CloneWindowPosAndArrangementAsync(v3, v7, v8, (v4 & 2) != 0);
                }
              }
            }
          }
