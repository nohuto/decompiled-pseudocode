/*
 * XREFs of ?bInit@PFEMEMOBJ@@QEAAHPEAVPFF@@KPEAU_FD_GLYPHSET@@_KPEAU_IFIMETRICS@@2HPEAU_UNIVERSAL_FONT_ID@@H@Z @ 0x1C008BEF4
 * Callers:
 ...
 *     IsAnyCharsetDbcs @ 0x1C008C5B4 (IsAnyCharsetDbcs.c)
        ...
        int a10)
{
  ...
  _BYTE v37[32]; // [rsp+48h] [rbp-79h] BYREF
  ...
  *(_DWORD *)(*(_QWORD *)this + 80LL) = _InterlockedIncrement(&dword_1C032BF20);
  ...
  *(_DWORD *)(*(_QWORD *)this + 68LL) = v18;
  ...
  PushThreadGuardedObject(v37, *(_QWORD *)this, vDeletePFE);
  ...
  if ( v22 )
  {
    *(_DWORD *)(*(_QWORD *)this + 132LL) = 0;
    if ( *(_DWORD *)(*(_QWORD *)(*(_QWORD *)this + 32LL) + 40LL) )
    {
      ...
      cCapString(v38, v19 + *v35, 32LL, v23);
      if ( v24 < v25 )
      {
        v26 = v38[0];
        v27 = v24 + 195;
