/*
 * XREFs of ?ProbeAndReadFD_KERNINGPAIR@@YAPEAU_FD_KERNINGPAIR@@PEBU1@H_K@Z @ 0x1C02A20A4
 * Callers:
 ...
 *     ??9@YA_NAEBU_FD_KERNINGPAIR@@0@Z @ 0x1C02A1B00 (--9@YA_NAEBU_FD_KERNINGPAIR@@0@Z.c)
 */
