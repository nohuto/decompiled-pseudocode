/*
 * XREFs of ?bSpTransferShape@@YAHPEAVSPRITE@@0@Z @ 0x1C027DCB0
 * Callers:
...
__int64 __fastcall bSpTransferShape(struct SPRITE *a1, struct SPRITE *a2)
{
  ...
  *(_DWORD *)a1 |= *(_DWORD *)a2 & 0x10;
  ...
  if ( v5 )
  {
    ...
    {
      v6 = *(_QWORD *)(SURFOBJ_TO_SURFACE_NOT_NULL(*(_QWORD *)(*((_QWORD *)a1 + 2) + 32LL)) + 128);
      v7 = *((_QWORD *)a2 + 18);
      v10 = 0LL;
      if ( (unsigned int)EXLATEOBJ::bInitXlateObj(
                           ...
                           0) )
      {
        v8 = SURFOBJ_TO_SURFACE_NOT_NULL(*(_QWORD *)(*((_QWORD *)a1 + 2) + 32LL));
        bSpCreateShape(
          a1,
          (struct _POINTL *)a2 + 17,
