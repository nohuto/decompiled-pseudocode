/*
 * XREFs of UnregisterModernAppThreadForRawKeyboard @ 0x1C01D8218
 * Callers:
 ...
 *     ?HasRawKeyboardPerThreadRegistration@@YAHPEBUtagPROCESSINFO@@@Z @ 0x1C01D7854 (-HasRawKeyboardPerThreadRegistration@@YAHPEBUtagPROCESSINFO@@@Z.c)
 */
      ...
      if ( (v3 & 0x200000) != 0 )
      {
        *(_DWORD *)(a1 + 1224) = v3 & 0xFFDFFFFF;
        if ( !(unsigned int)HasRawKeyboardPerThreadRegistration((const struct tagPROCESSINFO *)v2) )
          RegisterRawInputDevices((__int64)&unk_1C0323728, 1LL, 2u);
      }
    }
  }
  return 1LL;
