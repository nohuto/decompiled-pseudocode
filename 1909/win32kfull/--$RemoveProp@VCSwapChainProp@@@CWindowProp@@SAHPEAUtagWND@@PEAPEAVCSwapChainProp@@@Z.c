/*
 * XREFs of ??$RemoveProp@VCSwapChainProp@@@CWindowProp@@SAHPEAUtagWND@@PEAPEAVCSwapChainProp@@@Z @ 0x1C0239908
 * Callers:
...
__int64 __fastcall CWindowProp::RemoveProp<CSwapChainProp>(__int64 a1, __int64 *a2)
{
  ...
  v5 = 0;
  if ( LOWORD(WPP_MAIN_CB.Queue.Wcb.CurrentIrp) == word_1C032A65C )
    *(_QWORD *)(*(_QWORD *)(a1 + 40) + 312LL) = 0LL;
  v6 = RealInternalRemoveProp(v2, CurrentIrp_low, 1LL, v2);
  *a2 = v6;
  if ( v6 )
    *(_QWORD *)(v6 + 8) = 0LL;
  LOBYTE(v5) = v6 != 0;
