/*
 * XREFs of ?UMPDDrvStrokeAndFillPath@@YAHPEAU_SURFOBJ@@PEAU_PATHOBJ@@PEAU_CLIPOBJ@@PEAU_XFORMOBJ@@PEAU_BRUSHOBJ@@PEAU_LINEATTRS@@4PEAU_POINTL@@KK@Z @ 0x1C02A5150
 * Callers:
 *     <none>
 * Callees:
  ...
  if ( v25 )
  {
          ...
          (v21 = v16) != 0) )
    {
      ...
      if ( !(unsigned int)UMPDOBJ::ThunkDDIOBJ(v14, (UMPDOBJ *)((char *)v14 + 144), (const void **)&v31[7], 0x18u, 0LL)
        ...
        || (LODWORD(Size) = 4, (unsigned int)UMPDOBJ::Thunk(v14, v31, 96LL, &v21, Size) == -1)
        || (v17 = 1, !v21) )
      {
LABEL_18:
        v17 = 0;
