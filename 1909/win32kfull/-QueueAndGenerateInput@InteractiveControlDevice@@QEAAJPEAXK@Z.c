/*
 * XREFs of ?QueueAndGenerateInput@InteractiveControlDevice@@QEAAJPEAXK@Z @ 0x1C0253BF4
 * Callers:
 ...
 *     ??_GInteractiveControlInput@@QEAAPEAXI@Z @ 0x1C0252B2C (--_GInteractiveControlInput@@QEAAPEAXI@Z.c)
 ...
 *     ?GetPreviousInputReport@InteractiveControlDevice@@QEAAHPEAU_LIST_ENTRY@@PEAPEAVInteractiveControlInput@@@Z @ 0x1C025345C (-GetPreviousInputReport@InteractiveControlDevice@@QEAAHPEAU_LIST_ENTRY@@PEAPEAVInteractiveContro.c)
 ...
 *     ?QueueInput@InteractiveControlDevice@@QEAAXPEAU_LIST_ENTRY@@PEAVInteractiveControlInput@@@Z @ 0x1C0253E5C (-QueueInput@InteractiveControlDevice@@QEAAXPEAU_LIST_ENTRY@@PEAVInteractiveControlInput@@@Z.c)
 ...
 *     ??0InteractiveControlInput@@QEAA@PEAVInteractiveControlDevice@@@Z @ 0x1C02547FC (--0InteractiveControlInput@@QEAA@PEAVInteractiveControlDevice@@@Z.c)
 *     ?GenerateMessages@InteractiveControlInput@@QEAAJPEAUtagWND@@W4tagINTERACTIVECTRL_PROMOTION_TYPE@@I@Z @ 0x1C02549A4 (-GenerateMessages@InteractiveControlInput@@QEAAJPEAUtagWND@@W4tagINTERACTIVECTRL_PROMOTION_TYPE@.c)
        ...
        unsigned int a3)
{
  ...
  if ( a3 % (unsigned int)v3 )
  {
    ...
    if ( dword_1C031F308 > 2u )
    {
      ...
      LODWORD(v13) = v3;
      v24 = 4LL;
      TlgWrite((TraceLoggingHProvider)&dword_1C031F308, &unk_1C02E8D39, 0LL, 0LL, 6u, &pData);
    }
  }
  else
  {
