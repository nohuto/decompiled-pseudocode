/*
 * XREFs of xxxCallHandleMenuMessages @ 0x1C0222BB0
 * Callers:
...
__int64 __fastcall xxxCallHandleMenuMessages(__int64 a1, __int64 *a2, __int64 a3, __int64 a4, __int64 a5)
{
  ...
  *(_DWORD *)(a1 + 8) = v5 | 0x200;
  ...
  SmartObjStackRefBase<tagPOPUPMENU>::~SmartObjStackRefBase<tagPOPUPMENU>(v17, v13, v14);
  v15 = *(_DWORD *)(a1 + 8);
  *(_DWORD *)(a1 + 8) = v15 & 0xFFFFFDFF;
  if ( v12 && (v15 & 0x100) != 0 && ((v15 & 4) == 0 || (**(_DWORD **)a1 & 0x8000) != 0) )
  {
