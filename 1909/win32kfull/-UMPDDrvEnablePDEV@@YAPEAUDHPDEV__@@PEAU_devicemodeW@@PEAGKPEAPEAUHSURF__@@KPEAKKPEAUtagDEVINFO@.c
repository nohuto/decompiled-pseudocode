/*
 * XREFs of ?UMPDDrvEnablePDEV@@YAPEAUDHPDEV__@@PEAU_devicemodeW@@PEAGKPEAPEAUHSURF__@@KPEAKKPEAUtagDEVINFO@@PEAUHDEV__@@1PEAX@Z @ 0x1C00F65F0
 * Callers:
 *     <none>
 * Callees:
      ...
      if ( v17 )
      {
        ...
        if ( (unsigned int)UMPDOBJ::ThunkMemBlock(v14, (const void **)&v43[4], v16) )
        {
          if ( (unsigned int)UMPDOBJ::ThunkStringW(v14, (unsigned __int16 **)&v43[5]) )
          {
            ...
            {
              LODWORD(v33) = 8;
              if ( (unsigned int)UMPDOBJ::Thunk(v14, v43, 176LL, &v38, v33) != -1 )
              {
                if ( a4 )
                {
