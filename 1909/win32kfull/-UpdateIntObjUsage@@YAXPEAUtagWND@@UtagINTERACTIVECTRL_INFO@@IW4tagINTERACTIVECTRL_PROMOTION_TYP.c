/*
 * XREFs of ?UpdateIntObjUsage@@YAXPEAUtagWND@@UtagINTERACTIVECTRL_INFO@@IW4tagINTERACTIVECTRL_PROMOTION_TYPE@@_K@Z @ 0x1C0254E14
 * Callers:
...
__int64 __fastcall UpdateIntObjUsage(__int64 a1, __int64 a2, __int16 a3, int a4, unsigned __int64 a5)
{
  ...
  else
  {
    ...
    if ( (v5 & 4) != 0 && (a3 & 0x1000) != 0 )
    {
      ...
      v13 = DOUBLE_1_0;
      v14 = 2;
      for ( i = (double)((int)v25 - (int)qword_1C0330D84); ; i = i * i )
      {
        v16 = v14;
        if ( (v14 & 1) != 0 )
          v13 = v13 * i;
      ...
      v17 = 2;
      for ( j = (double)(HIDWORD(v25) - HIDWORD(qword_1C0330D84)); ; j = j * j )
      {
        v19 = v17;
        if ( (v17 & 1) != 0 )
          v12 = v12 * j;
    ...
    if ( (a3 & 0x400) != 0 )
    {
      gmsInputEndTime = a5;
      if ( a5 > gmsInputStartTime && gmsInputStartTime )
        qword_1C0330DD8 += a5 - gmsInputStartTime;
      gmsInputStartTime = a5;
    ...
    if ( (a3 & 0x800) != 0 )
    {
      ...
      {
        if ( gmsInputStartTime )
          qword_1C0330E08 += a5 - gmsInputStartTime;
      }
      gmsInputStartTime = a5;
    }
  }
  ...
  dword_1C0330D90 = result;
  *(__int64 *)((char *)&qword_1C0330D84 + 4) = v24;
  return result;
}
