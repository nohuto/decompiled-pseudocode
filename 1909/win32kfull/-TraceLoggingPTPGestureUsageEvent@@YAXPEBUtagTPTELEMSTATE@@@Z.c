/*
 * XREFs of ?TraceLoggingPTPGestureUsageEvent@@YAXPEBUtagTPTELEMSTATE@@@Z @ 0x1C01CDF84
 * Callers:
...
void __fastcall TraceLoggingPTPGestureUsageEvent(const struct tagTPTELEMSTATE *a1)
{
  ...
  if ( hProvider > 5u )
  {
    if ( TlgKeywordOn((TraceLoggingHProvider)&hProvider, 0x400000000000uLL) )
    {
      ...
      v72 = 4LL;
      v74 = 4LL;
      TlgWrite((TraceLoggingHProvider)&hProvider, &unk_1C02E59BD, 0LL, 0LL, 0x1Au, &pData);
    }
  }
}
