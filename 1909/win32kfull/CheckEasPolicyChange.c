/*
 * XREFs of CheckEasPolicyChange @ 0x1C01D71BC
 * Callers:
...
__int64 CheckEasPolicyChange()
{
  ...
  *(_OWORD *)&ObjectAttributes.SecurityDescriptor = 0LL;
  ...
  if ( qword_1C032C0E0 != KeyInformation )
  {
    qword_1C032C0E0 = KeyInformation;
    return 1;
  }
  ...
  *(_OWORD *)&ObjectAttributes.SecurityDescriptor = 0LL;
  ...
  if ( qword_1C032C0D8 != KeyInformation )
  {
    qword_1C032C0D8 = KeyInformation;
    return 1;
  }
  return v0;
}
