/*
 * XREFs of CheckHandleFlag @ 0x1C0029EC8
 * Callers:
 *     OkayToCloseWindowStation @ 0x1C0029610 (OkayToCloseWindowStation.c)
 *     OkayToCloseDesktop @ 0x1C00296C0 (OkayToCloseDesktop.c)
...
__int64 __fastcall CheckHandleFlag(PRKPROCESS PROCESS, int a2, unsigned int a3, int a4)
{
  ...
  {
    ProcessWin32Process = PsGetCurrentProcessWin32Process(v10, v9);
  }
