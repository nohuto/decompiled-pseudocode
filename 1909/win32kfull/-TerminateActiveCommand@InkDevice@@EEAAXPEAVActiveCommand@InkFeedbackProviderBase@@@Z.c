/*
 * XREFs of ?TerminateActiveCommand@InkDevice@@EEAAXPEAVActiveCommand@InkFeedbackProviderBase@@@Z @ 0x1C0251F70
 * Callers:
 *     <none>
 * Callees:
...
void __fastcall InkDevice::TerminateActiveCommand(InkDevice *this, struct InkFeedbackProviderBase::ActiveCommand *a2)
{
  ...
  else if ( dword_1C031F298 > 2u )
  {
    ...
    v7 = 18LL;
    TlgWrite((TraceLoggingHProvider)&dword_1C031F298, &unk_1C02E8230, 0LL, 0LL, 4u, &v3);
  }
}
