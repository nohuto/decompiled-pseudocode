/*
 * XREFs of ?DwmMovePointer@@YAXPEAU_SURFOBJ@@JJPEAU_RECTL@@K@Z @ 0x1C0106924
 * Callers:
              ...
              *((_QWORD *)g_pDwmState + 14) = v9;
              if ( *((struct DwmState **)g_pDwmState + 15) == (struct DwmState *)((char *)g_pDwmState + 120) )
              {
                ...
                if ( v26 )
                {
                  ...
                  {
                    v34 = 0LL;
                    DWMSPRITEREF::LockSpriteObj((DWMSPRITEREF *)&v34, v26);
                    v27 = v34;
                    if ( v34 )
            ...
            *(_QWORD *)(v10 + 8) = v11;
            ...
            if ( *v12 == (struct DwmState *)((char *)g_pDwmState + 120) )
            {
              ...
              *((_QWORD *)g_pDwmState + 16) = v9;
              v31.x = v7 + *((_DWORD *)hdev + 646) - *((_DWORD *)g_pDwmState + 38);
              v31.y = v6 + *((_DWORD *)hdev + 647) - *((_DWORD *)g_pDwmState + 39);
              v13 = (HSPRITE)*((_QWORD *)g_pDwmState + 17);
              DrvPixelSpaceToUniformSpacePoint(&v31, &v31.y);
              GreUpdateSprite(a1->hdev, 0LL, v13, 0LL, &v31, 0LL, 0LL, 0LL, 0, 0LL, 0x40200000u, 0LL, 0LL, 1, 0);
              v35 = 0LL;
              ...
              if ( v35 )
              {
                ...
                PUSHLOCKEX::PUSHLOCKEX((PUSHLOCKEX *)v36, (struct DWMSPRITE *)((char *)v14 + 88));
...
LABEL_33:
      ...
      {
        v32 = 0LL;
        DWMSPRITEREF::LockSpriteObj((DWMSPRITEREF *)&v32, v20);
        v21 = v32;
        if ( v32 )
        {
          if ( (*((_DWORD *)v32 + 41) & 1) != 0 )
            break;
        }
    ...
    else
    {
      ...
      DWMSPRITEREF::LockSpriteObj((DWMSPRITEREF *)&v33, v22);
      v23 = v33;
      if ( v33 )
