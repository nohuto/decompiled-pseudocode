/*
 * XREFs of EngStrokePath @ 0x1C014CCD0
 * Callers:
 ...
 *     W32kCddStrokePath @ 0x1C014CC20 (W32kCddStrokePath.c)
 ...
 *     ??1BOUNDCLIPRGNTOSURFACE@@QEAA@XZ @ 0x1C010FB64 (--1BOUNDCLIPRGNTOSURFACE@@QEAA@XZ.c)
        ...
        MIX mix)
{
  ...
  if ( v19 )
  {
    ...
    else if ( (ppo->fl & 1) == 0 || EPATHOBJ::bFlatten((EPATHOBJ *)ppo) )
    {
      if ( *(_WORD *)(v12 + 100) )
      {
        v14 = *(__int64 (__fastcall **)(__int64, PATHOBJ *, CLIPOBJ *, XFORMOBJ *, BRUSHOBJ *, POINTL *, LINEATTRS *, MIX))(*(_QWORD *)(v12 + 48) + 2800LL);
        if ( !v14 )
          goto LABEL_23;
