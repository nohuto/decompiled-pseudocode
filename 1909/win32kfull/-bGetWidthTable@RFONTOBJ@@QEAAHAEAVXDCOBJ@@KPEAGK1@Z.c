/*
 * XREFs of ?bGetWidthTable@RFONTOBJ@@QEAAHAEAVXDCOBJ@@KPEAGK1@Z @ 0x1C009C870
 * Callers:
          ...
          else
          {
            if ( !(unsigned int)RFONTOBJ::bIsLinkedGlyph(this, v44) )
            {
              if ( !*(_DWORD *)(*(_QWORD *)this + 708LL)
                ...
                || v49 > (unsigned __int16)word_1C032C032
                || (v43 = v63,
                    ((0x80000000 >> ((v49 - gqlTTSystem) % 32)) & *(_DWORD *)(qword_1C032C038
