/*
 * XREFs of ?bExtraRectsToPath@ESTROBJ@@QEAAHAEAVEPATHOBJ@@@Z @ 0x1C02B5D80
 * Callers:
 ...
 *     ?bLinkedGlyphs@ESTROBJ@@QEBAHXZ @ 0x1C02924CC (-bLinkedGlyphs@ESTROBJ@@QEBAHXZ.c)
 *     ?cGetGlyphData@RFONTOBJ@@QEAAKKPEAU_GLYPHPOS@@@Z @ 0x1C02A0444 (-cGetGlyphData@RFONTOBJ@@QEAAKKPEAU_GLYPHPOS@@@Z.c)
 *     ?GetLinkedRfontOnIndex@ESTROBJ@@QEAAPEAVRFONT@@JAEAVRFONTOBJ@@@Z @ 0x1C02B5AFC (-GetLinkedRfontOnIndex@ESTROBJ@@QEAAPEAVRFONT@@JAEAVRFONTOBJ@@@Z.c)
...
LABEL_33:
      ...
      while ( 1 )
      {
        ...
        {
          LODWORD(v51) = v54;
          if ( !(unsigned int)bAddPgmToPath(a2, v56 + v73 + v64, v55 + v63 + v72, v53, v52, v65, v51) )
            break;
        }
        if ( (*((_DWORD *)this + 58) & 0x80u) != 0 )
        {
          LODWORD(v51) = v59;
          if ( !(unsigned int)bAddPgmToPath(a2, v58 + v50 + v73, v57 + v49 + v72, v53, v52, v60, v51) )
            break;
        }
        v33 = v67;
        v17 = v62 + 24;
