/*
 * XREFs of _GetQueueStatus @ 0x1C0130820
 * Callers:
 *     NtUserGetThreadState @ 0x1C00DD420 (NtUserGetThreadState.c)
 * Callees:
...
__int64 __fastcall GetQueueStatus(__int64 a1, int a2)
{
