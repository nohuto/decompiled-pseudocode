/*
 * XREFs of ??0PFFMEMOBJ@@QEAA@IPEBGKKPEAUtagDESIGNVECTOR@@K_KPEAUHDEV__@@PEAUDHPDEV__@@PEAVPFT@@KKPEAU_FNTCHECKSUM@@PEAPEAU_FONTFILEVIEW@@PEAU_UNIVERSAL_FONT_ID@@H@Z @ 0x1C00F8AB4
 * Callers:
      ...
      *(_DWORD *)(*(_QWORD *)this + 136LL) = 0;
      ...
      else if ( a15 )
      {
        *(_DWORD *)(*(_QWORD *)this + 136LL) = *((_DWORD *)a14 + 1);
        ...
        {
          v38 = *(_QWORD *)this;
          *(_DWORD *)(v38 + 136) += ComputeFileviewCheckSum(Src, (unsigned int)Size);
        }
      }
    }
  }
