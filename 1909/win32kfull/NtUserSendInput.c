/*
 * XREFs of NtUserSendInput @ 0x1C001DD40
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall NtUserSendInput(unsigned int a1, volatile void *a2, int a3, int a4)
{
  ...
  {
    if ( WPP_RECORDER_INITIALIZED != (_UNKNOWN *)&WPP_RECORDER_INITIALIZED )
      WPP_RECORDER_SF_dd(v8, v7, v9, 11, (__int64)&WPP_0005b7b05e953d15cfa73aaf0a7b9adf_Traceguids, a3, 40);
    goto LABEL_11;
  }
  if ( !(_DWORD)v6 )
  {
    ...
    {
      LOBYTE(v7) = 2;
      WPP_RECORDER_SF_(v8, v7, 20, 12, (__int64)&WPP_0005b7b05e953d15cfa73aaf0a7b9adf_Traceguids);
    }
LABEL_11:
    v13 = 0;
