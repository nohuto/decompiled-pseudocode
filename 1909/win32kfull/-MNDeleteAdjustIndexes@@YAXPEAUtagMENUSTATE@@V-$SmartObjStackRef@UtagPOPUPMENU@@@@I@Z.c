/*
 * XREFs of ?MNDeleteAdjustIndexes@@YAXPEAUtagMENUSTATE@@V?$SmartObjStackRef@UtagPOPUPMENU@@@@I@Z @ 0x1C0246BC0
 * Callers:
 ...
 *     ?NNDeleteAdjustIndex@@YAXPEAII@Z @ 0x1C0246C48 (-NNDeleteAdjustIndex@@YAXPEAII@Z.c)
 */
...
_QWORD *__fastcall MNDeleteAdjustIndexes(__int64 a1, __int64 a2, unsigned int a3)
{
  ...
  return SmartObjStackRefBase<tagPOPUPMENU>::~SmartObjStackRefBase<tagPOPUPMENU>(v5, v3, v4);
}
