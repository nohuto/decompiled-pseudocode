/*
 * XREFs of OutputAATo4BPP @ 0x1C0260AC0
 * Callers:
 *     <none>
 * Callees:
 *     <none>
        ...
        __int64 a9)
{
  ...
  if ( (_BYTE)a9 )
  {
    ...
    if ( a2[7] )
    {
      *a4 = *a4 & 0xF0 | v12 ^ (BYTE14(v36) & ((*(_DWORD *)(a5 + 4LL * *v11) - (unsigned int)*a6) >> 16) | BYTE2(v37) & ((*(_DWORD *)(a5 + 4LL * v11[1] + 1024) - (unsigned int)a6[1]) >> 16) | BYTE6(v37) & ((*(_DWORD *)(a5 + 4LL * v11[2] + 2048) - (unsigned int)a6[2]) >> 16));
      v15 = HIDWORD(v36);
    }
    ++a4;
    v16 = a6 + 3;
...
LABEL_26:
  ...
  if ( (unsigned __int64)v17 < a3 )
  {
    ...
    do
    {
      ...
      v26 = *v16;
      v16 += 6;
      *a4++ = v40 ^ (v23 | v24 | BYTE2(v36) & ((unsigned int)(*(_DWORD *)(a5 + 4 * v10) - v26) >> 16) | v22 | v35 & BYTE2(v25) | v21);
      if ( (unsigned __int64)v16 >= a7 )
      {
        LOBYTE(v10) = a8;
        v16 = (unsigned __int16 *)((char *)v16 + a8);
...
LABEL_15:
  ...
  {
    LOBYTE(v10) = *a4 & 0xF;
    *a4 = v10 | BYTE2(v38) ^ (BYTE2(v36) & ((*(_DWORD *)(a5 + 4LL * *v17) - (unsigned int)*v16) >> 16) | v19 & ((*(_DWORD *)(a5 + 4LL * v17[1] + 1024) - (unsigned int)v16[1]) >> 16) | v18 & ((*(_DWORD *)(a5 + 4LL * v17[2] + 2048) - (unsigned int)v16[2]) >> 16));
  }
  return v10;
}
