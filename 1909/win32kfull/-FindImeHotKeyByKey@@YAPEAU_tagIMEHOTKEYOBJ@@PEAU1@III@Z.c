/*
 * XREFs of ?FindImeHotKeyByKey@@YAPEAU_tagIMEHOTKEYOBJ@@PEAU1@III@Z @ 0x1C0055358
 * Callers:
 *     CheckImeHotKey @ 0x1C0052870 (CheckImeHotKey.c)
 * Callees:
 *     GetActiveHKL @ 0x1C0055404 (GetActiveHKL.c)
 *     ?GetHotKeyLangID@@YAGK@Z @ 0x1C00FB328 (-GetHotKeyLangID@@YAGK@Z.c)
 *     ?GetLangIdMatchLevel@@YAHPEAUHKL__@@G@Z @ 0x1C020C248 (-GetLangIdMatchLevel@@YAHPEAUHKL__@@G@Z.c)
 */
