/*
 * XREFs of ?bMergeScanline@RGNMEMOBJ@@QEAAHAEAVSTACKOBJ@@@Z @ 0x1C02B17F8
 * Callers:
 ...
 *     ?vMergeSpans@@YAXPEAU_SPAN@@0000@Z @ 0x1C02B2040 (-vMergeSpans@@YAXPEAU_SPAN@@0000@Z.c)
 */
...
__int64 __fastcall RGNMEMOBJ::bMergeScanline(RGNMEMOBJ *this, struct STACKOBJ *a2)
{
  ...
  if ( v6 != 120 )
  {
    ...
    if ( v20 > v8 - v6 )
    {
      if ( !RGNOBJ::bExpand(this, v20 + v8 + 4936) )
        return 0LL;
      v4 = a2;
      v19 = v37;
    }
    v21 = *(_DWORD *)v3;
    v22 = (unsigned int *)(*(_QWORD *)this + 104LL);
    v23 = *(unsigned int **)(*(_QWORD *)this + 40LL);
    if ( *(_DWORD *)v3 > *(_DWORD *)(*(_QWORD *)this + 108LL) )
    {
      do
        v22 += *v22 + 4;
      while ( v21 > (int)v22[1] );
    ...
    if ( v21 != v24 )
    {
      ...
      if ( *(_DWORD *)v3 < *(_DWORD *)(*(_QWORD *)this + 92LL) )
        *(_DWORD *)(*(_QWORD *)this + 92LL) = *(_DWORD *)v3;
      goto LABEL_22;
    }
    if ( v24 + 1 != v22[2] )
    {
      ++*(_DWORD *)(*(_QWORD *)this + 84LL);
      *(_DWORD *)(*(_QWORD *)this + 100LL) = *(_DWORD *)v3 + 1;
      v22[1] = *(_DWORD *)v3 + 1;
      goto LABEL_22;
    }
    v25 = *((_QWORD *)v4 + 2);
...
LABEL_22:
    ...
    *v22 = v29;
    ...
    v34 = *(_DWORD **)this;
    v35 = v22[3];
    if ( *(_DWORD *)(*(_QWORD *)this + 88LL) > v35 )
    {
      v34[22] = v35;
      v34 = *(_DWORD **)this;
    }
  ...
  *(_DWORD *)(*(_QWORD *)this + 92LL) = *(_DWORD *)v3;
  *(_DWORD *)(*(_QWORD *)this + 100LL) = *(_DWORD *)v3 + 1;
  *(_DWORD *)(*(_QWORD *)this + 88LL) = v14[3];
  *(_DWORD *)(*(_QWORD *)this + 96LL) = v14[v9 + 2];
  v17 = &v14[*v14 + 4];
  *v17 = 0;
  v18 = *(_DWORD *)v3 + 1;
