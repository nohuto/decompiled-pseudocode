/*
 * XREFs of _OpenClipboard @ 0x1C0058EC0
 * Callers:
...
__int64 __fastcall OpenClipboard(__int64 a1, int *a2, __int64 a3, __int64 a4)
{
  ...
  {
    v7 = CheckClipboardAccess(a1, a2, a3);
    v11 = v7;
    if ( v7 )
    {
      v12 = v7 + 64;
...
LABEL_8:
        ...
        *(_QWORD *)(v11 + 48) = gptiCurrent;
        ...
        {
          v14 = *(_QWORD *)(v11 + 80);
          if ( !v14 || *(_QWORD *)(gptiCurrent + 416LL) != *(_QWORD *)(*(_QWORD *)(v14 + 16) + 416LL) )
            v4 = 1;
          *a2 = v4;
          *(_DWORD *)(*(_QWORD *)(gptiCurrent + 416LL) + 704LL) = *(_DWORD *)(v11 + 108);
        }
        return 1LL;
      }
      ...
      {
        v16 = *(_QWORD *)(v11 + 48);
        v18 = *(_DWORD *)(*(_QWORD *)(v16 + 416) + 56LL);
        v21 = &v18;
        v22 = 4LL;
        TlgCreateWsz(&pDesc, (LPCWSTR)(*(_QWORD *)(v16 + 416) + 984LL));
        TlgWrite((TraceLoggingHProvider)&hProvider, &unk_1C02E78FA, 0LL, 0LL, cData, &pData);
      }
    }
  }
  return 0LL;
