/*
 * XREFs of DCEHitTestWindow @ 0x1C01E62DC
 * Callers:
 ...
 *     ?DCEPointInTriangle@@YAHPEAU_D3DVERTEX@@MM@Z @ 0x1C01E5568 (-DCEPointInTriangle@@YAHPEAU_D3DVERTEX@@MM@Z.c)
 *     BuildVertexList @ 0x1C01E60C4 (BuildVertexList.c)
