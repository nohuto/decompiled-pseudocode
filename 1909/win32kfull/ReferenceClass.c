/*
 * XREFs of ReferenceClass @ 0x1C00EC900
 * Callers:
...
__int64 __fastcall ReferenceClass(__int64 a1, __int64 a2)
{
  ...
  if ( v8 )
  {
    ...
    *(_WORD *)(v8 + 102) = *(_WORD *)(a1 + 102);
    ...
    if ( v2 )
    {
      *(_QWORD *)(*((_QWORD *)v7 + 1) + 48LL) = &v11[*((_QWORD *)v7 + 2) - *((_QWORD *)v7 + 1)];
      *((_QWORD *)v7 + 13) = v11;
    }
    else
    {
    ...
    if ( (v12 & 0xFFFFFFFFFFFF0000uLL) != 0 )
    {
      ...
      if ( (v17 & 0xFFFFFFFFFFFF0000uLL) != 0 )
        v18 = -1LL;
      *(_QWORD *)(*((_QWORD *)v7 + 1) + 40LL) = v18;
      *((_QWORD *)v7 + 12) = v17;
      if ( !v17 )
      {
LABEL_21:
        ClassFree(v2, *((char **)v7 + 13));
LABEL_22:
    ...
    *((_QWORD *)&v19 + 1) = *(_QWORD *)(a1 + 80);
    ...
    v19 = *(_OWORD *)LockPointer(&v20, (__int64)(v7 + 112), *(__int64 **)(a1 + 112));
    HMAssignmentLock(&v19);
