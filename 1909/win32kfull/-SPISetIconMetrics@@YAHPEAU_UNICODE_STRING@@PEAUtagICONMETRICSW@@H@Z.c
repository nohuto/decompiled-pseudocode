/*
 * XREFs of ?SPISetIconMetrics@@YAHPEAU_UNICODE_STRING@@PEAUtagICONMETRICSW@@H@Z @ 0x1C01D93FC
 * Callers:
 ...
 *     ?RescaleIconMetrics@@YAXPEAUtagICONMETRICSW@@@Z @ 0x1C01D8FA8 (-RescaleIconMetrics@@YAXPEAUtagICONMETRICSW@@@Z.c)
