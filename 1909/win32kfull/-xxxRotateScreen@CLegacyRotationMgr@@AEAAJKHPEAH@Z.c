/*
 * XREFs of ?xxxRotateScreen@CLegacyRotationMgr@@AEAAJKHPEAH@Z @ 0x1C01D53C0
 * Callers:
...
LABEL_12:
  if ( v51 != 0x80000000 && v51 != 11 && v51 != 13 )
  {
    ...
    if ( hProvider > 5u )
    {
      if ( TlgKeywordOn((TraceLoggingHProvider)&hProvider, 0x200000000001uLL) )
      {
        ...
        v17 = 1003;
        v34 = 4LL;
        TlgWrite((TraceLoggingHProvider)&hProvider, &unk_1C02E6071, 0LL, 0LL, 5u, &pData);
      }
    }
    return 0LL;
  }
  ...
  if ( v6 == v52 )
  {
    ...
    if ( hProvider > 5u && TlgKeywordOn((TraceLoggingHProvider)&hProvider, 0x200000000001uLL) )
    {
      ...
      v19 = 1001;
      v41 = 4LL;
      TlgWrite((TraceLoggingHProvider)&hProvider, &unk_1C02E6071, 0LL, 0LL, 5u, &v35);
    }
    return 0LL;
  }
  if ( hProvider > 5u && TlgKeywordOn((TraceLoggingHProvider)&hProvider, 0x200000000001uLL) )
  {
    ...
    v21 = 1000;
    v48 = 4LL;
    TlgWrite((TraceLoggingHProvider)&hProvider, &unk_1C02E6071, 0LL, 0LL, 5u, &v42);
    v11 = v52;
  }
  v13 = v49;
  if ( v6 != v11 )
