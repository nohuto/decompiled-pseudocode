/*
 * XREFs of ?DxLddmSharedPrimaryLockNotification@@YAJU_LUID@@IPEBU_RECTL@@@Z @ 0x1C0272B74
 * Callers:
        ...
        if ( (unsigned int)PDEVOBJ::bLddmDriver((PDEVOBJ *)&v32) )
        {
          if ( LowPart == PDEVOBJ::pAdapterLuid((PDEVOBJ *)&v32)->LowPart )
          {
            ...
            if ( v36.HighPart == v11->HighPart && *(_DWORD *)(*((_QWORD *)v32 + 322) + 256LL) == v7 )
            {
              ...
              {
                LODWORD(v38) = *(_DWORD *)PDEVOBJ::sizl((PDEVOBJ *)&v32).cx;
                a3 = (const struct _RECTL *)&v37;
                HIDWORD(v38) = *(_DWORD *)(*(_QWORD *)&PDEVOBJ::sizl((PDEVOBJ *)&v32) + 4LL);
              }
              if ( v5 >= 0 )
              {
