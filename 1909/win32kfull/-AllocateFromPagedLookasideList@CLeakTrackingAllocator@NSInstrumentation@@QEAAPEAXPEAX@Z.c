/*
 * XREFs of ?AllocateFromPagedLookasideList@CLeakTrackingAllocator@NSInstrumentation@@QEAAPEAXPEAX@Z @ 0x1C02D290C
 * Callers:
 *     Win32UAFMAllocateFromPagedLookasideListImpl @ 0x1C020EA70 (Win32UAFMAllocateFromPagedLookasideListImpl.c)
 * Callees:
