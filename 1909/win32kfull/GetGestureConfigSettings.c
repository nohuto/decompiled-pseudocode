/*
 * XREFs of GetGestureConfigSettings @ 0x1C0213950
 * Callers:
 *     NtUserGetGestureConfig @ 0x1C022BF10 (NtUserGetGestureConfig.c)
 * Callees:
 *     ?IsBitSet@@YAHPEAEI@Z @ 0x1C000F4B8 (-IsBitSet@@YAHPEAEI@Z.c)
 *     ?GetWindowGCList@@YAPEAPEAXPEAUtagWND@@@Z @ 0x1C000F528 (-GetWindowGCList@@YAPEAPEAXPEAUtagWND@@@Z.c)
 ...
 *     ?FindGID@@YAHPEAPEAUtagGESTURECONFIGLIST@@I0@Z @ 0x1C0213774 (-FindGID@@YAHPEAPEAUtagGESTURECONFIGLIST@@I0@Z.c)
 */
...
LABEL_37:
      ...
      else
      {
        if ( !*((_DWORD *)v26 + 2) )
        {
          ...
          v37 = ~*(v30 - 1) & dword_1C02DF5D0[v31];
          goto LABEL_37;
        }
        *(v30 - 1) = ~*v30 & dword_1C02DF5D0[v31];
      }
LABEL_39:
      ++v29;
      v30 += 3;
