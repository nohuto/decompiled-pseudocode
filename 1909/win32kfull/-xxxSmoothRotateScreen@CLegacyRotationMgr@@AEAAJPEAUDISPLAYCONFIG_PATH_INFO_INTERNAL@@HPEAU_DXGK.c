/*
 * XREFs of ?xxxSmoothRotateScreen@CLegacyRotationMgr@@AEAAJPEAUDISPLAYCONFIG_PATH_INFO_INTERNAL@@HPEAU_DXGK_DISPLAY_SCENARIO_CONTEXT@@@Z @ 0x1C01D5A74
 * Callers:
 ...
 *     ?ConvertDisplayConfigRotationToDMDO@@YAKW4DISPLAYCONFIG_ROTATION@@@Z @ 0x1C010C850 (-ConvertDisplayConfigRotationToDMDO@@YAKW4DISPLAYCONFIG_ROTATION@@@Z.c)
 *     __security_check_cookie @ 0x1C0163A80 (__security_check_cookie.c)
 *     ?IsExtendTopology@@YAHXZ @ 0x1C01D4A24 (-IsExtendTopology@@YAHXZ.c)
        ...
        struct _DXGK_DISPLAY_SCENARIO_CONTEXT *a4)
{
  ...
  if ( hProvider > 5u && TlgKeywordOn((TraceLoggingHProvider)&hProvider, 0x200000000001uLL) )
  {
    ...
    v38 = 4;
    v41 = 4;
    TlgWrite((TraceLoggingHProvider)&hProvider, &unk_1C02E60D5, 0LL, 0LL, 6u, &pData);
  }
  return v28;
}
