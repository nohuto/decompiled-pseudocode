/*
 * XREFs of ??0BOUNDCLIPRGNTOSURFACE@@QEAA@PEAU_SURFOBJ@@PEAPEAU_CLIPOBJ@@@Z @ 0x1C014CEEC
 * Callers:
 ...
 *     ?bContain@ERECTL@@QEBAHAEBU_RECTL@@@Z @ 0x1C014CFB4 (-bContain@ERECTL@@QEBAHAEBU_RECTL@@@Z.c)
