/*
 * XREFs of ?GetMenuDepth@@YAIAEBV?$SmartObjStackRef@UtagMENU@@@@I@Z @ 0x1C00EFF2C
 * Callers:
...
__int64 __fastcall GetMenuDepth(__int64 a1, int a2)
{
  ...
  if ( v4 )
  {
    ...
    do
    {
      ...
      if ( *v5 )
      {
        SmartObjStackRefBase<tagMENU>::Init(v10, *v5);
        v10[2] = 0LL;
        MenuDepth = GetMenuDepth(v10, (unsigned int)(a2 - 1));
        SmartObjStackRefBase<tagPOPUPMENU>::~SmartObjStackRefBase<tagPOPUPMENU>(v10, v8, v9);
        if ( MenuDepth > v2 )
        {
          if ( MenuDepth >= 0x19 )
            return 25LL;
