/*
 * XREFs of EngMapFontFileFDInternal @ 0x1C011F680
 * Callers:
 *     ?TryMapAllFileViews@UmfdClientSideFileViewMapper@@AEAAIXZ @ 0x1C011E170 (-TryMapAllFileViews@UmfdClientSideFileViewMapper@@AEAAIXZ.c)
 *     ?MapFontFiles@@YA_NKPEAPEAU_FONTFILEVIEW@@PEAPEAXPEAK@Z @ 0x1C011F600 (-MapFontFiles@@YA_NKPEAPEAU_FONTFILEVIEW@@PEAPEAXPEAK@Z.c)
 *     EngMapFontFileFD @ 0x1C0286990 (EngMapFontFileFD.c)
...
LABEL_17:
              ...
              (unsigned __int64 *)&v24[9]) >= 0 )
  {
    ...
    GreReleaseFastMutex(ghfmMemory);
    if ( !v16 )
      vUnmapFileFD((struct _FILEVIEW *)v24, 1u);
    goto LABEL_17;
  }
