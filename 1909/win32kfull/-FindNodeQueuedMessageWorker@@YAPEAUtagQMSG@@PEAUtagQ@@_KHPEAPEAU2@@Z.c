/*
 * XREFs of ?FindNodeQueuedMessageWorker@@YAPEAUtagQMSG@@PEAUtagQ@@_KHPEAPEAU2@@Z @ 0x1C01CD418
 * Callers:
 *     EditionFindNodeQueuedMessage @ 0x1C01CD570 (EditionFindNodeQueuedMessage.c)
 * Callees:
