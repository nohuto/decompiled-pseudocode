/*
 * XREFs of ?BuildComponentInformation@InteractiveControlParser@@CAJPEAU_HIDP_PREPARSED_DATA@@GPEAVInteractiveControlDevice@@@Z @ 0x1C0257ECC
 * Callers:
 ...
 *     ?CreateAndLinkComponent@InteractiveControlParser@@CAJPEAU_HIDP_VALUE_CAPS@@HPEAU_INTERACTIVECTRL_CAPABILITIES@@PEAPEAUtagINTERACTIVECTRL_COMPONENT_ENTRY@@@Z @ 0x1C0258540 (-CreateAndLinkComponent@InteractiveControlParser@@CAJPEAU_HIDP_VALUE_CAPS@@HPEAU_INTERACTIVECTRL.c)
  ...
  *((_QWORD *)v4 + 14) = v4 + 112;
  ...
  if ( ValueCapsLength[0] )
  {
    ...
    if ( !ValueCaps )
    {
      v10 = -1073741670;
LABEL_33:
      InteractiveControlParser::FreeComponentInformation((struct _INTERACTIVECTRL_CAPABILITIES *)v4);
    ...
    if ( HidP_GetSpecificValueCaps(HidP_Input, 0, 0, 0, ValueCaps, ValueCapsLength, PreparsedData) >= 0 )
    {
      ...
      if ( ValueCapsLength[0] )
      {
        do
        {
          v10 = InteractiveControlParser::CreateAndLinkComponent(
                  &ValueCaps[v3],
                  0,
                  (struct _INTERACTIVECTRL_CAPABILITIES *)v4,
                  v19);
          if ( v10 < 0 )
            goto LABEL_28;
