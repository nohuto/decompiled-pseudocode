/*
 * XREFs of ?UnreferenceUndispatchedFrameList@@YAXXZ @ 0x1C00F1E30
 * Callers:
 *     <none>
 * Callees:
 *     <none>
...
void UnreferenceUndispatchedFrameList(void)
{
  ...
  v0 = (struct _LIST_ENTRY *)(gptiCurrent + 1136LL);
  while ( v0->Flink != v0 )
  {
    v1 = *(struct _LIST_ENTRY **)(gptiCurrent + 1144LL);
    if ( v1->Flink != v0 || (Blink = v1->Blink, Blink->Flink != v1) )
      __fastfail(3u);
    *(_QWORD *)(gptiCurrent + 1144LL) = Blink;
    Blink->Flink = v0;
    v1->Blink = v1;
    v1->Flink = v1;
