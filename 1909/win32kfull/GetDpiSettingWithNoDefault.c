/*
 * XREFs of GetDpiSettingWithNoDefault @ 0x1C0141350
 * Callers:
 *     GetDpiSetting @ 0x1C0141330 (GetDpiSetting.c)
 *     ?PerformWin8DpiUpgrade@@YAHPEAU_UNICODE_STRING@@K@Z @ 0x1C01D705C (-PerformWin8DpiUpgrade@@YAHPEAU_UNICODE_STRING@@K@Z.c)
 * Callees:
