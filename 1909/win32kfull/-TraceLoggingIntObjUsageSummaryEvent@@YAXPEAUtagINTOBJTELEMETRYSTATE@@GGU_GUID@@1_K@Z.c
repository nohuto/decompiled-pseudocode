/*
 * XREFs of ?TraceLoggingIntObjUsageSummaryEvent@@YAXPEAUtagINTOBJTELEMETRYSTATE@@GGU_GUID@@1_K@Z @ 0x1C01CDB1C
 * Callers:
        ...
        unsigned __int64 a6)
{
  ...
  struct _GUID *v35; // [rsp+E0h] [rbp-20h]
  ...
  struct tagINTOBJTELEMETRYSTATE near **v47; // [rsp+140h] [rbp+40h]
  ...
  unsigned int *v63; // [rsp+1C0h] [rbp+C0h]
  ...
  void *v81; // [rsp+250h] [rbp+150h]
  __int64 v82; // [rsp+258h] [rbp+158h]
  __int16 v83; // [rsp+288h] [rbp+188h] BYREF
  __int16 v84; // [rsp+290h] [rbp+190h] BYREF
  ...
  if ( hProvider > 5u )
  {
    if ( TlgKeywordOn((TraceLoggingHProvider)&hProvider, 0x800000000000uLL) )
    {
      ...
      v57 = &v15;
      v17 = dword_1C0330DCC;
      v10 = (unsigned int)qword_1C0330DD8 / 0x3E8;
      v27 = 0x2000000LL;
      v30 = 8LL;
      v31 = v6;
      v32 = 16LL;
      ...
      v79 = &v26;
      v81 = &unk_1C0330E00;
      v18 = (unsigned int)qword_1C0330E08 / 0x3E8;
      v64 = 4LL;
      v66 = 4LL;
      v68 = 4LL;
      v70 = 4LL;
      ...
      v80 = 4LL;
      v82 = 8LL;
      TlgWrite((TraceLoggingHProvider)&hProvider, &unk_1C02E4E57, 0LL, 0LL, 0x1Du, &pData);
    }
  }
}
