/*
 * XREFs of NtGdiEngGradientFill @ 0x1C02AB6F0
 * Callers:
 *     <none>
 * Callees:
 ...
 *     ?bValidVertexMeshData@@YAHPEAU_TRIVERTEX@@PEAXKKK@Z @ 0x1C02AA7B0 (-bValidVertexMeshData@@YAHPEAU_TRIVERTEX@@PEAXKKK@Z.c)
 */
