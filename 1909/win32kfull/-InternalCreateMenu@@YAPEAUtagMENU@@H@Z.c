/*
 * XREFs of ?InternalCreateMenu@@YAPEAUtagMENU@@H@Z @ 0x1C00F56E8
 * Callers:
 ...
 *     _CreatePopupMenu @ 0x1C00F56B0 (_CreatePopupMenu.c)
 *     _CreateMenu @ 0x1C00F56D0 (_CreateMenu.c)
 * Callees:
 *     CheckGrantedAccess @ 0x1C005FC14 (CheckGrantedAccess.c)
 *     ??$InitLookAsideRef@UtagMENU@@@@YAEPEAUtagMENU@@@Z @ 0x1C00F57A4 (--$InitLookAsideRef@UtagMENU@@@@YAEPEAUtagMENU@@@Z.c)
 */
