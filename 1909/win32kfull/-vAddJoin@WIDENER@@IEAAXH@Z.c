/*
 * XREFs of ?vAddJoin@WIDENER@@IEAAXH@Z @ 0x1C00F37B4
 * Callers:
 *     ?bWiden@WIDENER@@IEAAHXZ @ 0x1C00F3050 (-bWiden@WIDENER@@IEAAHXZ.c)
 * Callees:
 *     ?vAddLeft@WIDENER@@IEAAXAEAVEVECTORFX@@H@Z @ 0x1C00F38F8 (-vAddLeft@WIDENER@@IEAAXAEAVEVECTORFX@@H@Z.c)
 ...
 *     ?bMiterInLimit@WIDENER@@IEAAHVEVECTORFX@@@Z @ 0x1C00F3980 (-bMiterInLimit@WIDENER@@IEAAHVEVECTORFX@@@Z.c)
 *     ?bComputeIntersect@@YAHPEAVEVECTORFX@@0000@Z @ 0x1C00F39EC (-bComputeIntersect@@YAHPEAVEVECTORFX@@0000@Z.c)
 *     ?vecOutPerp@WIDENER@@IEAA?AVEVECTORFX@@XZ @ 0x1C00F3E10 (-vecOutPerp@WIDENER@@IEAA-AVEVECTORFX@@XZ.c)
 *     ?vecInPerp@WIDENER@@IEAA?AVEVECTORFX@@XZ @ 0x1C00F3E54 (-vecInPerp@WIDENER@@IEAA-AVEVECTORFX@@XZ.c)
 *     ?bTurnLeftRandom@@YAHPEAVEVECTORFX@@0@Z @ 0x1C00F3E9C (-bTurnLeftRandom@@YAHPEAVEVECTORFX@@0@Z.c)
