/*
 * XREFs of ?GreGetDIBitsInternalWorker@@YAHKAEAVDCOBJ@@AEAVPDEVOBJ@@AEAVSURFREF@@AEAVXEPALOBJ@@PEAUHDC__@@PEAUHBITMAP__@@IIPEAEPEAUtagBITMAPINFO@@III@Z @ 0x1C00BCB48
 * Callers:
 ...
 *     ?bIdenticalFormat@@YAHVXEPALOBJ@@H@Z @ 0x1C00C052C (-bIdenticalFormat@@YAHVXEPALOBJ@@H@Z.c)
 ...
 *     ?vFill_triples@XEPALOBJ@@QEAAXPEAUtagRGBTRIPLE@@KK@Z @ 0x1C02B58B0 (-vFill_triples@XEPALOBJ@@QEAAXPEAUtagRGBTRIPLE@@KK@Z.c)
        ...
        unsigned int a14)
{
  ...
  __int64 *v77; // [rsp+C8h] [rbp-E0h] BYREF
...
LABEL_34:
      ...
      if ( v27 == 1 )
      {
        if ( a14 >= v75 + 2 * (unsigned __int64)v22 )
        {
          ...
          if ( !v17 && LODWORD(v87[0]) == 3 && *(_QWORD *)(*v77 + 72) )
          {
            v31 = 0LL;
            v67 = 0LL;
            v45 = pxlo;
            ...
            do
            {
              ...
              if ( (_WORD)v51 )
              {
                while ( *(unsigned __int8 *)(v50 + *(_QWORD *)(*v49 + 72) + 4LL) != v48 )
                {
...
LABEL_121:
          ...
          else
          {
            ...
            XEPALOBJ::vGetEntriesFrom(&v67, *v77, v55, v53, v22);
          }
          SEMOBJ::vUnlock((SEMOBJ *)&v72);
          goto LABEL_51;
        }
        ...
        if ( v40 )
        {
          ...
          if ( PALMEMOBJ::bCreatePalette((PALMEMOBJ *)&v70, v41, v22, 0LL, 0x7C00u, 0x3E0u, 0x1Fu, 0x200u, 1) )
          {
            ...
            if ( *(_DWORD *)(*(_QWORD *)v76 + 96LL) == LODWORD(v87[0]) && LODWORD(v87[0]) == 3 )
            {
              ...
              XEPALOBJ::vGetEntriesFrom(&v67, *v77, v90, v57, v22);
...
LABEL_75:
                ...
                *(_QWORD *)&prclDest.left = 0LL;
                ...
                ERECTL::operator*=(&prclDest.left, (int *)&v77);
