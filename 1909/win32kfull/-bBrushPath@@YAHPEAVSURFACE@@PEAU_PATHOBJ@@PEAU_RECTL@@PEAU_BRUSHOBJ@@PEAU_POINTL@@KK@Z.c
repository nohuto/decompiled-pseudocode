/*
 * XREFs of ?bBrushPath@@YAHPEAVSURFACE@@PEAU_PATHOBJ@@PEAU_RECTL@@PEAU_BRUSHOBJ@@PEAU_POINTL@@KK@Z @ 0x1C02C7B10
 * Callers:
        ...
        unsigned int a7)
{
  ...
  if ( (unsigned int)(*((_DWORD *)a1 + 24) - 1) > 5 && bUMPDSecurityGateEx((__int64)a1, (__int64)a2, (__int64)a3) )
  {
    if ( gfUMPDDebug )
