/*
 * XREFs of ?_TTWindowPenalty@@YAIPEAUtagWND@@PEAUtagPNTRWINDOWHITTTESTARGS@@I@Z @ 0x1C020441C
 * Callers:
 ...
 *     TouchTargetingBigTargetWindow @ 0x1C025B54C (TouchTargetingBigTargetWindow.c)
 *     TouchTargetingDownrank @ 0x1C025BA48 (TouchTargetingDownrank.c)
 */
