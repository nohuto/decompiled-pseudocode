/*
 * XREFs of ?RemoveComponentInternal@CoreWindowProp@@KAJPEAUtagWND@@0@Z @ 0x1C023A600
 * Callers:
 *     ?Delete@CoreWindowProp@@UEAAXXZ @ 0x1C011AEF0 (-Delete@CoreWindowProp@@UEAAXXZ.c)
...
__int64 __fastcall CoreWindowProp::RemoveComponentInternal(struct tagWND *this, struct tagWND *a2)
{
  ...
  if ( CWindowProp::GetProp<CoreWindowProp>((__int64)this, (__int64 *)&v10) )
  {
    ...
    if ( Component )
    {
      ...
      v4 = 0;
      if ( !*((_DWORD *)v6 + 10) )
        CoreWindowProp::ChangeRole(this, 2, 0);
