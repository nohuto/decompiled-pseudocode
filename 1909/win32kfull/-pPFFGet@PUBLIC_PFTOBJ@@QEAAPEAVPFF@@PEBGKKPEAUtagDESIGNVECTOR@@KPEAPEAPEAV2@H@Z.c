/*
 * XREFs of ?pPFFGet@PUBLIC_PFTOBJ@@QEAAPEAVPFF@@PEBGKKPEAUtagDESIGNVECTOR@@KPEAPEAPEAV2@H@Z @ 0x1C009377C
 * Callers:
 ...
 *     GreRemoveFontResourceW @ 0x1C0287B34 (GreRemoveFontResourceW.c)
 ...
 * Callees:
 *     ?iHash@@YAIPEBGI@Z @ 0x1C0093BEC (-iHash@@YAIPEBGI@Z.c)
