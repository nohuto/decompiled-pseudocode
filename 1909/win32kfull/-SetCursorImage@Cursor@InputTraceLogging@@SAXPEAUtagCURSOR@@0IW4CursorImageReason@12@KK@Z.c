/*
 * XREFs of ?SetCursorImage@Cursor@InputTraceLogging@@SAXPEAUtagCURSOR@@0IW4CursorImageReason@12@KK@Z @ 0x1C0138DF4
 * Callers:
...
void __fastcall InputTraceLogging::Cursor::SetCursorImage(__int64 a1, __int64 a2, int a3, int a4, char a5, char a6)
{
  ...
  v69 = a3;
  if ( dword_1C03202C0 > 4u && TlgKeywordOn((TraceLoggingHProvider)&dword_1C03202C0, 8uLL) )
  {
    ...
    v25 = v18;
    v68 = 4LL;
    TlgWrite((TraceLoggingHProvider)&dword_1C03202C0, &unk_1C02E4AFA, 0LL, 0LL, 0x15u, &pData);
  }
}
