/*
 * XREFs of BRUSHOBJ_pvAllocRbrush @ 0x1C026A7C0
 * Callers:
 *     VerifierBRUSHOBJ_pvAllocRbrush @ 0x1C0297F30 (VerifierBRUSHOBJ_pvAllocRbrush.c)
 *     ?MulRealizeBrush@@YAHPEAU_BRUSHOBJ@@PEAU_SURFOBJ@@11PEAU_XLATEOBJ@@K@Z @ 0x1C029C920 (-MulRealizeBrush@@YAHPEAU_BRUSHOBJ@@PEAU_SURFOBJ@@11PEAU_XLATEOBJ@@K@Z.c)
 * Callees:
