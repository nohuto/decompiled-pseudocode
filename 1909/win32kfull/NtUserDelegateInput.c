/*
 * XREFs of NtUserDelegateInput @ 0x1C0103DF0
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall NtUserDelegateInput(unsigned int a1, __int64 a2, __int64 a3, __int64 a4, int a5)
{
  ...
  if ( v9 )
  {
    ...
    if ( *(char *)(v17 + 19) >= 0 && *(char *)(v17 + 20) >= 0 )
    {
      v18 = *(_QWORD *)(v15 + 16);
      v19 = *(_QWORD *)(v18 + 416);
      if ( v19 == PsGetCurrentProcessWin32Process(v11, v10) )
      {
        v20 = *(_DWORD *)(v15 + 260);
        if ( v20 )
        {
        ...
        {
          v11 = 1LL;
          if ( *(_DWORD *)(*(_QWORD *)(v16 + 424) + 400LL) == 1
      ...
      v22 = 5LL;
LABEL_26:
      UserSetLastError(v22, v10, v12, v13);
      goto LABEL_16;
    }
LABEL_25:
    v22 = 87LL;
