/*
 * XREFs of ?_TTUpdateRankWithSegment@@YAXJJJJPEAUtagPOINT@@PEAGUtagRECT@@PEBUtagTOUCHTARGETINGCONTACT@@@Z @ 0x1C025B340
 * Callers:
 *     TouchTargetingRankForRect @ 0x1C025BCF8 (TouchTargetingRankForRect.c)
 * Callees:
 *     TouchTargetingIntersectSegment @ 0x1C025BADC (TouchTargetingIntersectSegment.c)
