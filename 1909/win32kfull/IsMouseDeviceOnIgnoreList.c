/*
 * XREFs of IsMouseDeviceOnIgnoreList @ 0x1C0105970
 * Callers:
 *     <none>
 * Callees:
 *     ?IsDeviceOnRegistryList@@YAHU_UNICODE_STRING@@0H@Z @ 0x1C0105AD4 (-IsDeviceOnRegistryList@@YAHU_UNICODE_STRING@@0H@Z.c)
