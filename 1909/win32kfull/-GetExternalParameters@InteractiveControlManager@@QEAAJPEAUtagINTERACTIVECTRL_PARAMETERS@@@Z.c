/*
 * XREFs of ?GetExternalParameters@InteractiveControlManager@@QEAAJPEAUtagINTERACTIVECTRL_PARAMETERS@@@Z @ 0x1C024DA00
 * Callers:
        ...
        int a3)
{
  ...
  if ( dword_1C031F308 > 4u )
  {
    ...
    v11 = 55;
    TlgWrite((TraceLoggingHProvider)&dword_1C031F308, &unk_1C02E8425, 0LL, 0LL, 3u, &pData);
  }
  if ( a2 )
  {
