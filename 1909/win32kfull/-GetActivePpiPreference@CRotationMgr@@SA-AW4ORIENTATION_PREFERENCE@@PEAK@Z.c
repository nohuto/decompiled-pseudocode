/*
 * XREFs of ?GetActivePpiPreference@CRotationMgr@@SA?AW4ORIENTATION_PREFERENCE@@PEAK@Z @ 0x1C01D4924
 * Callers:
 ...
 *     ?IsOrientationWithinPreferences@CLegacyRotationMgr@@AEAAHK@Z @ 0x1C01D4BB0 (-IsOrientationWithinPreferences@CLegacyRotationMgr@@AEAAHK@Z.c)
 * Callees:
...
__int64 __fastcall CRotationMgr::GetActivePpiPreference(_DWORD *a1)
{
  ...
  if ( grpdeskRitInput )
  {
    ...
    if ( v3 )
    {
      ...
      v2 = *(_DWORD *)(*(_QWORD *)(grpdeskRitInput + 256LL) + 912LL);
    }
  }
