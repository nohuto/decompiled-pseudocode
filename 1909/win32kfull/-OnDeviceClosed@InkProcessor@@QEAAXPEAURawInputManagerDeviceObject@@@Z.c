/*
 * XREFs of ?OnDeviceClosed@InkProcessor@@QEAAXPEAURawInputManagerDeviceObject@@@Z @ 0x1C0244FC8
 * Callers:
 ...
 *     ?OnDeviceClosed@RimBackedDeviceBase@Rim@@UEAAXXZ @ 0x1C0239CE0 (-OnDeviceClosed@RimBackedDeviceBase@Rim@@UEAAXXZ.c)
 *     ?FindInkDeviceByRimDeviceObject@InkProcessor@@AEBAPEAVInkDevice@@PEBURawInputManagerDeviceObject@@@Z @ 0x1C0244CA4 (-FindInkDeviceByRimDeviceObject@InkProcessor@@AEBAPEAVInkDevice@@PEBURawInputManagerDeviceObject.c)
 */
  ...
  if ( *((_BYTE *)this + 8) )
  {
    ...
    if ( InkDeviceByRimDeviceObject )
    {
      ...
      if ( dword_1C031F298 > 4u )
      {
        ...
        v8 = a2;
        v20 = 8;
        TlgWrite((TraceLoggingHProvider)&dword_1C031F298, &unk_1C02E82D1, 0LL, 0LL, 6u, &pData);
      }
    }
  }
