/*
 * XREFs of ?vSynchronizeDriver@@YAXK@Z @ 0x1C00BE7A4
 * Callers:
 *     GreFlush @ 0x1C00BE2E0 (GreFlush.c)
 *     ?GreSynchronizeTimer@@YAXPEAXI_K_J@Z @ 0x1C0298A50 (-GreSynchronizeTimer@@YAXPEAXI_K_J@Z.c)
 * Callees:
 *     <none>
 */
