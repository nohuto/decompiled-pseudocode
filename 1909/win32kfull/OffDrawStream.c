/*
 * XREFs of OffDrawStream @ 0x1C02C0F14
 * Callers:
...
__int64 __fastcall OffDrawStream(
        __int64 (__fastcall *a1)(__int64, __int64, struct _CLIPOBJ *, __int64, __int64 *, __int64 *, int, __int64, __int64),
        LONG *a2,
        __int64 a3,
        __int64 a4,
        struct _CLIPOBJ *a5,
        ...
        __int64 a11)
{
  ...
  if ( a7 )
  {
    ...
    LODWORD(v26) = v14 + *((_DWORD *)a7 + 2);
    HIDWORD(v25) = v11 + *((_DWORD *)a7 + 1);
    v16 = &v25;
    HIDWORD(v26) = v11 + *((_DWORD *)a7 + 3);
  }
  v20 = 0LL;
  if ( a8 )
  {
