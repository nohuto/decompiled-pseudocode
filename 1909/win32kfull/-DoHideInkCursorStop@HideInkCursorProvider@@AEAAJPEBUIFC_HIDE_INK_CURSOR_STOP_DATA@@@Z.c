/*
 * XREFs of ?DoHideInkCursorStop@HideInkCursorProvider@@AEAAJPEBUIFC_HIDE_INK_CURSOR_STOP_DATA@@@Z @ 0x1C024F340
 * Callers:
 ...
 *     ?TerminateActiveCommand@HideInkCursorProvider@@UEAAXPEAVActiveCommand@InkFeedbackProviderBase@@@Z @ 0x1C0250080 (-TerminateActiveCommand@HideInkCursorProvider@@UEAAXPEAVActiveCommand@InkFeedbackProviderBase@@@.c)
 * Callees:
        ...
        const struct IFC_HIDE_INK_CURSOR_STOP_DATA *a2)
{
  ...
  if ( dword_1C031F298 > 4u )
  {
    ...
    v19 = v2;
    v20 = v6;
    TlgWrite((TraceLoggingHProvider)&dword_1C031F298, &unk_1C02E885A, 0LL, v7, 7u, &pData);
  }
  return 0LL;
}
