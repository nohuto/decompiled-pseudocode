        ...
        const struct tagINPUT_TRANSFORM *a5)
{
  ...
  if ( (unsigned __int8)InputTraceLogging::Enabled(0LL) && dword_1C03202C0 > 5u )
  {
    if ( TlgKeywordOn((TraceLoggingHProvider)&dword_1C03202C0, 4uLL) )
    {
      v22 = v6;
      v15 = &v11;
      v17 = &v12;
      ...
      v52 = 4LL;
      v54 = 4LL;
      TlgWrite((TraceLoggingHProvider)&dword_1C03202C0, &unk_1C02E7708, 0LL, v7, 0x16u, &pData);
    }
  }
}
