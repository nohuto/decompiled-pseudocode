/*
 * XREFs of ?bRealizeFont@RFONTOBJ@@QEAAHPEAVXDCOBJ@@PEAVPDEVOBJ@@PEAUtagENUMLOGFONTEXDVW@@PEAVPFE@@PEAU_FD_XFORM@@QEAU_POINTL@@KKHHK@Z @ 0x1C0097464
 * Callers:
 ...
 *     UmfdQueryFontCapsEx @ 0x1C009867C (UmfdQueryFontCapsEx.c)
 ...
 *     ?ulSimpleDeviceOrientation@@YAKAEAVRFONTOBJ@@@Z @ 0x1C00F2644 (-ulSimpleDeviceOrientation@@YAKAEAVRFONTOBJ@@@Z.c)
 *     ?ulSimpleOrientation@RFONTOBJ@@QEAAKPEAVXDCOBJ@@@Z @ 0x1C00F26B4 (-ulSimpleOrientation@RFONTOBJ@@QEAAKPEAVXDCOBJ@@@Z.c)
        ...
        unsigned int a12)
{
  ...
  *(_QWORD *)(*(_QWORD *)this + 472LL) = *(_QWORD *)v73;
  ...
  v78 = v23;
  v70[0] = *(_WORD *)(v23 + 116);
  RFONTOBJ::vXlatGlyphArray(this, v70, 1u, v73, 2u, 0);
...
LABEL_17:
  ...
  *(_DWORD *)(*(_QWORD *)this + 656LL) = a10;
  ...
  if ( (struct PDEV *)v40 == qword_1C0330E80 )
  {
