/*
 * XREFs of ?TPAAPShouldAllowNow@@YAHKHH@Z @ 0x1C020281C
 * Callers:
 *     EditionLegacyTouchPadMouseAllowTap @ 0x1C0202D60 (EditionLegacyTouchPadMouseAllowTap.c)
 * Callees:
 *     ?TPAAPSqmBlockedCount@@YAXH@Z @ 0x1C0202954 (-TPAAPSqmBlockedCount@@YAXH@Z.c)
 */
