/*
 * XREFs of Feature_19H2_Enablement__private_IsEnabledWithReporting @ 0x1C0164AE4
 * Callers:
 *     ?Feature_PenTailDockEvents__private_areDependenciesEnabled@@YAHXZ @ 0x1C0164C30 (-Feature_PenTailDockEvents__private_areDependenciesEnabled@@YAHXZ.c)
 * Callees:
...
_BOOL8 Feature_19H2_Enablement__private_IsEnabledWithReporting()
{
  ...
  wil_details_FeaturePropertyCache_ReportUsageToService(
    ...
    20455539LL,
    (const struct FEATURE_LOGGED_TRAITS *)&unk_1C02DC778,
    v0,
    0);
  return v0;
}
