/*
 * XREFs of ?GetDeviceInfo@InteractiveControlManager@@QEAAJKPEAUtagINTERACTIVECTRL_DEVICE_INFO@@@Z @ 0x1C024D630
 * Callers:
        ...
        struct tagINTERACTIVECTRL_DEVICE_INFO *a3)
{
  ...
  if ( Device < 0 )
  {
    ...
    v17 = Device;
    v25 = 4;
    TlgWrite((TraceLoggingHProvider)&dword_1C031F308, &unk_1C02E83ED, v6, 0LL, 4u, &pData);
    goto LABEL_6;
  }
  v8 = v18;
