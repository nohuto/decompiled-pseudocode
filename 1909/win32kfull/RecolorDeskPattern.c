/*
 * XREFs of RecolorDeskPattern @ 0x1C011BBA0
 * Callers:
...
__int64 RecolorDeskPattern()
{
  ...
  if ( g_hbmDesktopPattern )
  {
    ...
    else
    {
      ...
      v18 = 2;
      v19 = BYTE2(v3);
      v4 = *(_BYTE *)(gpsi + 4572LL);
      v20 = BYTE1(v3);
      v5 = *(_DWORD *)(gpsi + 4600LL);
      v21 = v4;
      v22 = BYTE2(v5);
      v6 = *(_BYTE *)(gpsi + 4600LL);
      v23 = BYTE1(v5);
      v24 = v6;
      v13[0] = 40;
      v13[1] = 8;
    ...
    {
      v10 = GreSelectBitmap(ghdcMem2, CompatibleBitmapInternal);
