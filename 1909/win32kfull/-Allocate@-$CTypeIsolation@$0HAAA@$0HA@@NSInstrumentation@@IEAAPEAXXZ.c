/*
 * XREFs of ?Allocate@?$CTypeIsolation@$0HAAA@$0HA@@NSInstrumentation@@IEAAPEAXXZ @ 0x1C024045C
 * Callers:
 ...
 *     ?Allocate@?$CSectionBitmapAllocator@$0HAAA@$0HA@@NSInstrumentation@@QEAAPEAXXZ @ 0x1C0240348 (-Allocate@-$CSectionBitmapAllocator@$0HAAA@$0HA@@NSInstrumentation@@QEAAPEAXXZ.c)
 *     ?Create@?$CSectionEntry@$0HAAA@$0HA@@NSInstrumentation@@SAPEAV12@XZ @ 0x1C024079C (-Create@-$CSectionEntry@$0HAAA@$0HA@@NSInstrumentation@@SAPEAV12@XZ.c)
...
void *__fastcall NSInstrumentation::CTypeIsolation<28672,112>::Allocate(__int64 **a1, void *a2)
{
  ...
  {
    v8 = NSInstrumentation::CSectionBitmapAllocator<28672,112>::Allocate(i[4]);
    if ( v8 )
    {
  ...
  ExReleasePushLockSharedEx(v3, 0LL, v5, v6);
  KeLeaveCriticalRegion();
  v9 = NSInstrumentation::CSectionEntry<28672,112>::Create();
  v10 = (__int64 *)v9;
  if ( v9 )
  {
    v4 = NSInstrumentation::CSectionBitmapAllocator<28672,112>::Allocate(*(__int64 **)(v9 + 32));
    if ( v4 )
    {
      v11 = a1[2];
      KeEnterCriticalRegion();
