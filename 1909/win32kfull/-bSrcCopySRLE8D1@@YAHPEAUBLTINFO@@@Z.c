/*
 * XREFs of ?bSrcCopySRLE8D1@@YAHPEAUBLTINFO@@@Z @ 0x1C02C43B0
 * Callers:
 *     <none>
 * Callees:
    ...
    if ( (_DWORD)v19 )
    {
      ...
      else
      {
        ...
        if ( (unsigned __int8)(7 - v38) < (unsigned __int8)v19 )
        {
          ...
          v44 = ((unsigned __int8)v19 - (unsigned __int8)v40 - 1) >> 3;
          v45 = *((_BYTE *)&unk_1C02F0C4F - (unsigned __int8)v40);
          if ( v41 )
            v46 = ~v45 | v13;
          else
            v46 = v45 & v13;
          *(_BYTE *)(v21 + v3) = v46;
          ...
          {
            LOBYTE(v40) = -(v41 != 0);
            memset((void *)(v3 + v47), v40, v44);
            v5 = v53;
            v41 = v60;
            v48 = (unsigned int)v48 - 8 * v44;
          }
          v13 = 0;
