/*
 * XREFs of ?Initialize@SimpleHapticsController@@QEAAJPEAU_UNICODE_STRING@@@Z @ 0x1C0256330
 * Callers:
...
__int64 __fastcall SimpleHapticsController::Initialize(SimpleHapticsController *this, struct _UNICODE_STRING *a2)
{
  ...
  if ( (unsigned int)dword_1C031F2D0 > 4 )
  {
    ...
    TlgWrite((TraceLoggingHProvider)&dword_1C031F2D0, &unk_1C02E8DD5, 0LL, 0LL, 3u, &pData);
  }
  if ( !a2 )
  {
...
LABEL_22:
  if ( (unsigned int)dword_1C031F2D0 > 4 )
  {
    ...
    v22 = 4LL;
    v24 = 4LL;
    TlgWrite((TraceLoggingHProvider)&dword_1C031F2D0, &unk_1C02E8F50, 0LL, 0LL, 5u, &pData);
  }
