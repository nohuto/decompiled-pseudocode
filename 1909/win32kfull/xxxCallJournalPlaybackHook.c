/*
 * XREFs of xxxCallJournalPlaybackHook @ 0x1C01E7FA4
 * Callers:
...
LABEL_41:
    ...
    *(_DWORD *)(a1 + 24) = v35;
    ...
    {
      if ( !HIDWORD(v35)
        || (LOBYTE(v6) = 1, (v4 = (InputTransform *)HMValidateHandleNoSecure(SHIDWORD(v35), v6, v8)) == 0LL) )
      {
  ...
  v2.QuadPart = (int)v29;
  CurrentThreadDpiAwarenessContext = W32GetCurrentThreadDpiAwarenessContext(v29, 128LL, v8);
