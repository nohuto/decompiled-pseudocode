/*
 * XREFs of ?DxLddmSharedPrimaryUnLockNotification@@YAJU_LUID@@I@Z @ 0x1C0272EE8
 * Callers:
 *     NtGdiDdDDISharedPrimaryUnLockNotification @ 0x1C0274E10 (NtGdiDdDDISharedPrimaryUnLockNotification.c)
 * Callees:
