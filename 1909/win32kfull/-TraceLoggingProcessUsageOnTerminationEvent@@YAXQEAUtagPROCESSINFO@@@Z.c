/*
 * XREFs of ?TraceLoggingProcessUsageOnTerminationEvent@@YAXQEAUtagPROCESSINFO@@@Z @ 0x1C00E8BF0
 * Callers:
 *     DestroyProcessInfoEditionRundown @ 0x1C00E8BC0 (DestroyProcessInfoEditionRundown.c)
 * Callees:
...
void __fastcall TraceLoggingProcessUsageOnTerminationEvent(struct tagPROCESSINFO *const a1)
{
  ...
  if ( hProvider > 5u )
  {
    if ( TlgKeywordOn((TraceLoggingHProvider)&hProvider, 0x400000000000uLL) )
    {
      ...
      v12 = -__CFSHR__(v4, 3);
      v44 = 4LL;
      TlgWrite((TraceLoggingHProvider)&hProvider, &unk_1C02E5E49, 0LL, 0LL, 0x11u, &pData);
    }
  }
}
