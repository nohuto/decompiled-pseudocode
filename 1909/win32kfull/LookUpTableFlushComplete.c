/*
 * XREFs of LookUpTableFlushComplete @ 0x1C0368820
 * Callers:
 *     TlgUnregisterAggregateProvider @ 0x1C03686C8 (TlgUnregisterAggregateProvider.c)
 *     ?TlgAggregateInternalFlushWorkItemRoutineKernelMode@@YAXPEAX@Z @ 0x1C0369170 (-TlgAggregateInternalFlushWorkItemRoutineKernelMode@@YAXPEAX@Z.c)
 *     ?TlgAggregateInternalProviderCallback@@YAXPEBU_GUID@@KE_K1PEAU_EVENT_FILTER_DESCRIPTOR@@PEAX@Z @ 0x1C0369200 (-TlgAggregateInternalProviderCallback@@YAXPEBU_GUID@@KE_K1PEAU_EVENT_FILTER_DESCRIPTOR@@PEAX@Z.c)
 ...
 *     FlushLookUpTableBucket @ 0x1C025922C (FlushLookUpTableBucket.c)
 *     UpdateInternalStatsOnFlush @ 0x1C03692EC (UpdateInternalStatsOnFlush.c)
 */
...
_UNKNOWN **__fastcall LookUpTableFlushComplete(__int64 a1)
{
  ...
  if ( *(_DWORD *)(a1 + 256) )
  {
    ...
    if ( *(_QWORD *)(v4 + 288) )
    {
      if ( (unsigned int)dword_1C031F340 > 5 && TlgKeywordOn((TraceLoggingHProvider)&dword_1C031F340, 0x400000000000uLL) )
      {
        ...
        v32 = 4LL;
        v34 = 4LL;
        TlgWrite((TraceLoggingHProvider)&dword_1C031F340, &unk_1C02E9167, 0LL, 0LL, 0xBu, &pData);
      }
