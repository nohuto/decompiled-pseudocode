/*
 * XREFs of ?InitMapSharedSection@@YAJPEAU_EPROCESS@@PEAU_USERCONNECT@@@Z @ 0x1C002C740
 * Callers:
...
__int64 __fastcall InitMapSharedSection(struct _EPROCESS *a1, struct _USERCONNECT *a2)
{
  ...
  else
  {
    ...
    if ( (int)result < 0 )
      return result;
    if ( WPP_RECORDER_INITIALIZED != (_UNKNOWN *)&WPP_RECORDER_INITIALIZED )
      WPP_RECORDER_SF_q(v7, v6, 3, 15, (__int64)&WPP_d004ad31927635d751620a95da27af8f_Traceguids, v16);
    v14 = 0LL;
    v15 = 2101248LL;
