/*
 * XREFs of ?InitiateWin32kCleanup@@YAHXZ @ 0x1C007A04C
 * Callers:
 ...
 *     ?Deinitialize@InteractiveControlManager@@AEAAXXZ @ 0x1C0118F08 (-Deinitialize@InteractiveControlManager@@AEAAXXZ.c)
...
__int64 InitiateWin32kCleanup(void)
{
  ...
  EmptyMousePromotionQueue((struct tagMOUSE_PROMOTION_QUEUE *)&qword_1C032A290);
  v4 = (struct tagMOUSE_PROMOTION_QUEUE *)&unk_1C032A220;
  v5 = 5LL;
  do
  {
  ...
  if ( InteractiveControlManager::s_pInstance )
  {
    ...
    EtwUnregister(qword_1C031F328);
    qword_1C031F328 = 0LL;
    dword_1C031F308 = 0;
    EtwUnregister(qword_1C031F2F0);
    qword_1C031F2F0 = 0LL;
    dword_1C031F2D0 = 0;
