/*
 * XREFs of ?bHobbyize@WIDEPENOBJ@@AEAAHQEAVEVECTORFX@@@Z @ 0x1C00F4460
 * Callers:
...
__int64 __fastcall WIDEPENOBJ::bHobbyize(WIDEPENOBJ *this, struct EVECTORFX *const a2)
{
  ...
  if ( v3 < 576 )
  {
    ...
    v5 = (unsigned int *)&unk_1C031FAD8;
  }
  else if ( v3 >= 1600 )
  {
    if ( v3 < 3136 )
    {
      v4 = (struct _POINTFIX **)&off_1C031FAF0;
      v5 = (unsigned int *)&unk_1C031FAF8;
    }
    else if ( v3 >= 5184 )
    {
      if ( v3 < 7744 )
      {
        v4 = (struct _POINTFIX **)&off_1C031FB10;
        v5 = (unsigned int *)&unk_1C031FB18;
      }
      else
      {
        v4 = (struct _POINTFIX **)&off_1C031FB20;
        v5 = (unsigned int *)&unk_1C031FB28;
      }
    }
    else
    {
      v4 = (struct _POINTFIX **)&off_1C031FB00;
      v5 = (unsigned int *)&unk_1C031FB08;
    }
  }
  else
  {
    v4 = (struct _POINTFIX **)&off_1C031FAE0;
    v5 = (unsigned int *)&unk_1C031FAE8;
  }
