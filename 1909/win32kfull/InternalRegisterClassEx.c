/*
 * XREFs of InternalRegisterClassEx @ 0x1C0038490
 * Callers:
 ...
 *     ??$InitLookAsideRef@UtagCLS@@@@YAEPEAUtagCLS@@@Z @ 0x1C0036C20 (--$InitLookAsideRef@UtagCLS@@@@YAEPEAUtagCLS@@@Z.c)
 ...
 *     ?ClassAllocString@@YAPEAXQEAUtagDESKTOP@@KK@Z @ 0x1C0036D74 (-ClassAllocString@@YAPEAXQEAUtagDESKTOP@@KK@Z.c)
    ...
    if ( (*(_WORD *)(*(_QWORD *)(*(_QWORD *)v45[0] + 8LL) + 6LL) & 1) == 0 )
    {
      ...
      if ( v20 )
      {
        ...
        *(_QWORD *)(*(_QWORD *)(*(_QWORD *)v45[0] + 8LL) + 32LL) = v20;
        ...
        v41 = 6LL * v39;
        v42 = dword_1C02D55E8[2 * v41];
        if ( *(_DWORD *)(*(_QWORD *)(*(_QWORD *)v45[0] + 8LL) + 80LL) >= v42 )
        {
          *(_DWORD *)(*(_QWORD *)(*(_QWORD *)v45[0] + 8LL) + 84LL) = v42;
          *(_DWORD *)(*(_QWORD *)(*(_QWORD *)v45[0] + 8LL) + 80LL) -= dword_1C02D55E8[2 * v41];
        }
      }
    }
LABEL_25:
