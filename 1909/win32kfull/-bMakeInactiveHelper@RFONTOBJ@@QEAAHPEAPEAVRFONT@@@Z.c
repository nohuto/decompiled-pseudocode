/*
 * XREFs of ?bMakeInactiveHelper@RFONTOBJ@@QEAAHPEAPEAVRFONT@@@Z @ 0x1C00B8770
 * Callers:
...
__int64 __fastcall RFONTOBJ::bMakeInactiveHelper(struct RFONT **this, struct RFONT **a2)
{
  ...
  struct _FONTOBJ *v38; // [rsp+90h] [rbp+8h] BYREF
    ...
    if ( *(_DWORD *)(v20 + 56) || *(_DWORD *)(v20 + 60) || *(_QWORD *)(v20 + 144) )
    {
      ...
      if ( v22 >= 0x80 )
      {
        ...
        for ( j = v30; v30; v30 = (struct RFONT *)*((_QWORD *)v30 + 84) )
          v5 = v30;
        v39 = j;
        v38 = (struct _FONTOBJ *)v5;
        RFONTOBJ::vRemove((__int64)&v38, (unsigned __int64 *)&v39, 1);
