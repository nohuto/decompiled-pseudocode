/*
 * XREFs of ?vUpdateCosmeticStyleState@EPATHOBJ@@QEAAXPEAVSURFACE@@PEAU_LINEATTRS@@@Z @ 0x1C014C9B4
 * Callers:
 ...
 * Callees:
 *     ?bInit@DDA_CLIPLINE@@QEAAHPEAU_POINTFIX@@0@Z @ 0x1C014E48C (-bInit@DDA_CLIPLINE@@QEAAHPEAU_POINTFIX@@0@Z.c)
...
void __fastcall EPATHOBJ::vUpdateCosmeticStyleState(EPATHOBJ *this, struct SURFACE *a2, struct _LINEATTRS *a3)
{
  ...
  _DWORD v31[12]; // [rsp+38h] [rbp-70h] BYREF
...
LABEL_23:
      ...
      if ( (v26 & 0xFFFF0000) != 0 )
      {
        v14 = ((int)v14 + v24 * v26) % (unsigned __int64)(unsigned int)v6;
      }
      else
      {
        LODWORD(v14) = v24 * v26 + v14;
        if ( (int)v14 >= v6 )
          LODWORD(v14) = (int)v14 % v6;
      }
LABEL_26:
      v15 = v16++;
    }
