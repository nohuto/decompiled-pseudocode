/*
 * XREFs of HT_HalftoneBitmap @ 0x1C00C15F4
 * Callers:
 *     EngHTBlt @ 0x1C00C0A94 (EngHTBlt.c)
 * Callees:
 *     SanityCheckDimension @ 0x1C00C18A0 (SanityCheckDimension.c)
 *     AAHalftoneBitmap @ 0x1C00C18CC (AAHalftoneBitmap.c)
 *     pDCIAdjClr @ 0x1C00C37D8 (pDCIAdjClr.c)
 *     CheckABInfo @ 0x1C025D090 (CheckABInfo.c)
 */
