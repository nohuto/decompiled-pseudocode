/*
 * XREFs of NtGdiExtEscape @ 0x1C0121B20
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall NtGdiExtEscape(HDC a1, char *a2, int a3, __int64 a4, int a5, char *Src, int a7, char *a8)
{
  ...
  _QWORD v20[4]; // [rsp+70h] [rbp-2D8h] BYREF
  _QWORD v21[4]; // [rsp+90h] [rbp-2B8h] BYREF
  ...
  {
    UmfdDispatchWinLogonEscape((unsigned __int64)Src);
    return 0LL;
  }
