/*
 * XREFs of ?UMPDDrvTextOut@@YAHPEAU_SURFOBJ@@PEAU_STROBJ@@PEAU_FONTOBJ@@PEAU_CLIPOBJ@@PEAU_RECTL@@4PEAU_BRUSHOBJ@@5PEAU_POINTL@@K@Z @ 0x1C009A240
 * Callers:
 *     <none>
 * Callees:
...
LABEL_5:
  ...
  if ( v12
    ...
    && UMPDOBJ::pstro(v14, (struct _STROBJ **)&v42[4])
    && (unsigned int)UMPDOBJ::pfo(v14, (__m128i **)&v42[5])
    ...
    && (unsigned int)UMPDOBJ::ThunkMemBlock(v14, (const void **)&v42[11], 8u) )
  {
    *(_QWORD *)v31 = v16;
    ...
    LODWORD(Size) = 4;
    v17 = UMPDOBJ::Thunk(v14, v42, 104LL, &v30, Size);
    v12 = v30;
    if ( v17 == -1 )
      v12 = 0;
