/*
 * XREFs of NtGdiModifyWorldTransform @ 0x1C00BA280
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall NtGdiModifyWorldTransform(__int64 a1, struct _XFORML *a2, unsigned int a3)
{
  ...
  struct _XFORML v22; // [rsp+48h] [rbp-11h] BYREF
  _BYTE Buf1[36]; // [rsp+60h] [rbp+7h] BYREF
...
LABEL_46:
  ...
  if ( v5 )
  {
    v8 = ProbeAndConvertXFORM(v5, &v22);
    v6 = v17;
    v3 = v8;
  }
  else
...
LABEL_37:
    ...
    if ( a3 > 3 )
    {
      if ( a3 != 4 )
        goto LABEL_25;
      if ( v22.eM11 == 1.0 && v22.eM12 == 0.0 && v22.eM21 == 0.0 && v22.eM22 == 1.0 && v22.eDx == 0.0 && v22.eDy == 0.0 )
        goto LABEL_37;
      vConvertXformToMatrix(&v22, Buf1);
      if ( (unsigned int)bWorldMatrixInRange((struct MATRIX *)Buf1) )
      {
        v9 = v17;
        *(_OWORD *)((char *)v17 + 392) = *(_OWORD *)Buf1;
        *(_OWORD *)((char *)v9 + 408) = *(_OWORD *)&Buf1[16];
        v10 = *((_QWORD *)v17 + 122);
        *(_OWORD *)(v10 + 356) = *(_OWORD *)Buf1;
        *(_OWORD *)(v10 + 372) = *(_OWORD *)&Buf1[16];
        goto LABEL_22;
      }
      goto LABEL_54;
    }
...
LABEL_54:
    ...
    if ( (unsigned int)bWorldMatrixInRange((struct MATRIX *)Buf1) )
    {
      *(_OWORD *)((char *)v6 + 392) = *(_OWORD *)Buf1;
      *(_OWORD *)((char *)v6 + 408) = *(_OWORD *)&Buf1[16];
      v16 = *((_QWORD *)v17 + 122);
      *(_OWORD *)(v16 + 356) = *(_OWORD *)Buf1;
      *(_OWORD *)(v16 + 372) = *(_OWORD *)&Buf1[16];
