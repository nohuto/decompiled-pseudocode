/*
 * XREFs of ?vSpDwmMigrateSpriteLSurfReference@@YAXPEAUHDEV__@@PEAVSFMLOGICALSURFACE@@PEAVSURFACE@@1@Z @ 0x1C00E1EC4
 * Callers:
 *     vSpDwmMigrateSpriteLSurfReferenceWrap @ 0x1C00E1EB0 (vSpDwmMigrateSpriteLSurfReferenceWrap.c)
 * Callees:
