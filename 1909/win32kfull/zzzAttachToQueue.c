/*
 * XREFs of zzzAttachToQueue @ 0x1C01362F0
 * Callers:
 ...
 *     ?CheckTransferState@@YAKPEAUtagTHREADINFO@@PEAUtagQ@@JH@Z @ 0x1C01366BC (-CheckTransferState@@YAKPEAUtagTHREADINFO@@PEAUtagQ@@JH@Z.c)
...
LABEL_11:
  ...
  if ( a1 == *(struct tagTHREADINFO **)(v17 + 72) )
  {
    *((_DWORD *)a2 + 99) ^= (*((_DWORD *)a2 + 99) ^ *(_DWORD *)(v17 + 396)) & 0xFFEFFFFF;
    ...
    {
      v25 = (unsigned int)v25 & 0xFFFFFFBF;
      *((_DWORD *)a2 + 99) = v25;
    }
