/*
 * XREFs of ?GetMessageW@Delivery@InputTraceLogging@@SAXPEBUtagMSG@@PEBUtagTHREADINFO@@PEAUtagWND@@PEAUtagBWND@@_N@Z @ 0x1C003F628
 * Callers:
        ...
        bool a5)
{
  ...
  if ( dword_1C03202C0 && TlgKeywordOn((TraceLoggingHProvider)&dword_1C03202C0, 0LL) )
  {
    ...
    if ( IsPointerInputMessage(v9) )
    {
        ...
        if ( dword_1C03202C0 > 4u )
        {
          if ( TlgKeywordOn((TraceLoggingHProvider)&dword_1C03202C0, 0x10uLL) )
          {
            ...
            *(_QWORD *)&v75.Size = v14;
            ...
            TlgWrite((TraceLoggingHProvider)&dword_1C03202C0, &unk_1C02E6DBC, 0LL, 0LL, 0x13u, &pData);
          }
        }
      }
      else if ( dword_1C03202C0 > 4u && TlgKeywordOn((TraceLoggingHProvider)&dword_1C03202C0, 0x10uLL) )
      {
        ...
        *(_QWORD *)&v76.Size = v19;
        ...
        TlgWrite((TraceLoggingHProvider)&dword_1C03202C0, &unk_1C02E6EBC, 0LL, 0LL, 0x14u, &pData);
      }
    }
    else if ( InputTraceLogging::IsMouseInputMessage(v10) )
    {
      if ( dword_1C03202C0 > 4u && TlgKeywordOn((TraceLoggingHProvider)&dword_1C03202C0, 0x10uLL) )
      {
        ...
        *(_QWORD *)&v74.Size = v24;
        ...
        TlgWrite((TraceLoggingHProvider)&dword_1C03202C0, &unk_1C02E6FCB, 0LL, 0LL, 0x12u, &pData);
      }
    }
      ...
      if ( v20 == 255 )
      {
        if ( dword_1C03202C0 > 4u && TlgKeywordOn((TraceLoggingHProvider)&dword_1C03202C0, 0x10uLL) )
        {
          ...
          *(_QWORD *)&v74.Size = v32;
          TlgCreateWsz(&v75, v46[1]);
          TlgCreateSz(&v76, (LPCSTR)v46[0]);
          TlgWrite((TraceLoggingHProvider)&dword_1C03202C0, &unk_1C02E71A6, 0LL, 0LL, 0x12u, &pData);
        }
      }
      else if ( (unsigned int)(v20 - 571) <= 1
             && dword_1C03202C0 > 4u
             && TlgKeywordOn((TraceLoggingHProvider)&dword_1C03202C0, 0x10uLL) )
      {
        v35 = *(_QWORD *)a1;
        v53 = (BOOL *)&v41;
        v55 = &v40;
        ...
        *(_QWORD *)&v74.Size = v36;
        TlgCreateWsz(&v75, v46[1]);
        TlgCreateSz(&v76, (LPCSTR)v46[0]);
        TlgWrite((TraceLoggingHProvider)&dword_1C03202C0, &unk_1C02E729D, 0LL, 0LL, 0x12u, &pData);
      }
    }
    else if ( dword_1C03202C0 > 4u && TlgKeywordOn((TraceLoggingHProvider)&dword_1C03202C0, 0x10uLL) )
    {
      ...
      *(_QWORD *)&v72.Size = v28;
      ...
      TlgWrite((TraceLoggingHProvider)&dword_1C03202C0, &unk_1C02E70BF, 0LL, 0LL, 0x10u, &pData);
    }
  }
}
