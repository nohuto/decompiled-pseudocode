/*
 * XREFs of ?xxxProcessPointerInputAsMouse@PointerPromotion@@YAXAEBUtagPOINTER_INFO@@GG@Z @ 0x1C02081E8
 * Callers:
 *     EditionProcessPointerInputAsMouse @ 0x1C0208750 (EditionProcessPointerInputAsMouse.c)
 * Callees:
 *     ?CancelAutoPromotion@@YAXXZ @ 0x1C020716C (-CancelAutoPromotion@@YAXXZ.c)
 *     ?CoalesceMousePromotionEntry@@YAHAEBUtagPOINTER_INFO@@G@Z @ 0x1C020723C (-CoalesceMousePromotionEntry@@YAHAEBUtagPOINTER_INFO@@G@Z.c)
 ...
 *     ?QueueMousePromotionEntry@@YAXAEAUtagMOUSE_PROMOTION_QUEUE@@PEAUtagMOUSE_PROMOTION_ENTRY@@@Z @ 0x1C0207C44 (-QueueMousePromotionEntry@@YAXAEAUtagMOUSE_PROMOTION_QUEUE@@PEAUtagMOUSE_PROMOTION_ENTRY@@@Z.c)
        ...
        __int16 a3)
{
  ...
  *(__m128i *)v22 = v3;
  ...
  if ( v12 )
  {
    v13 = dword_1C032A318 & 0xFFFFFFF7;
    dword_1C032A318 &= ~8u;
  }
  v14 = v22[2];
  if ( v22[2] != word_1C032A210[0] || (a3 & 0x10) != 0 )
  {
    if ( (v13 & 2) != 0 )
    {
      CancelAutoPromotion();
    ...
    dword_1C032A318 = v13 & 0xFFFFFFF7;
  ...
  qword_1C032A308 = v23.m128i_i64[1];
  dword_1C032A214 = v10;
  if ( MousePromotionEntry )
  {
    v16 = dword_1C032A318;
    if ( (dword_1C032A318 & 2) != 0 )
    {
      if ( (dword_1C032A318 & 4) != 0 )
      {
      ...
      QueueMousePromotionEntry((struct tagMOUSE_PROMOTION_QUEUE *)&qword_1C032A290, MousePromotionEntry);
      if ( (*((_DWORD *)MousePromotionEntry + 5) & 0x40000) != 0 )
        dword_1C032A318 &= 0xFFFFFFE9;
      goto LABEL_31;
    }
    QueueMousePromotionEntry((struct tagMOUSE_PROMOTION_QUEUE *)&unk_1C032A220, MousePromotionEntry);
  }
  if ( v15 || MousePromotionEntry )
  {
    if ( (dword_1C032A318 & 8) != 0 )
    {
      v17 = DetectPromotionType(0LL, qword_1C032A228);
      if ( v17 == 0x10000000 )
        goto LABEL_31;
      v19 = v17;
      v20 = v10;
