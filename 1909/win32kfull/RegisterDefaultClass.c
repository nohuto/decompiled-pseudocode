/*
 * XREFs of RegisterDefaultClass @ 0x1C0036DB8
 * Callers:
...
__int64 __fastcall RegisterDefaultClass(wchar_t *Str1)
{
  ...
  while ( 1 )
  {
    if ( v3 && (*(_DWORD *)v6 & 1) == 0 || ((*(_DWORD *)(*(_QWORD *)(gptiCurrent + 416LL) + 832LL) >> v5) & 1) != 0 )
      goto LABEL_8;
    v2 = 0;
    if ( IntegerAtom )
      break;
...
LABEL_8:
  ...
  v9 = v27 == *(_WORD *)(gpsi + 2LL * ((*(_DWORD *)v6 >> 3) & 0x1F) + 868);
LABEL_13:
  if ( !v9 )
    goto LABEL_8;
  v16 = 0LL;
  ...
  if ( (*((_DWORD *)&gDefaultServerClasses + 12 * v5) & 2) != 0 && (v10 = (__int64 *)gasyscur[1]) != 0LL )
    ...
    v19 = 0LL;
  v11 = *((unsigned __int16 *)&gDefaultServerClasses + 24 * v5 + 2);
  v12 = *((unsigned __int16 *)&gDefaultServerClasses + 24 * v5 + 3) | 0x41u;
  v20 = *((_QWORD *)&gDefaultServerClasses + 6 * v5 + 4);
  v22 = *((_QWORD *)&gDefaultServerClasses + 6 * v5 + 5);
  v24 = v22;
  result = InternalRegisterClassEx(v13, v11, v12, 0LL);
  if ( result )
  {
    *(_DWORD *)(*(_QWORD *)(gptiCurrent + 416LL) + 832LL) |= 1 << v5;
LABEL_9:
    if ( v2 )
