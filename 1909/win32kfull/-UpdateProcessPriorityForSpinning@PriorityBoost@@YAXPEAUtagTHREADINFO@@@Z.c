/*
 * XREFs of ?UpdateProcessPriorityForSpinning@PriorityBoost@@YAXPEAUtagTHREADINFO@@@Z @ 0x1C012FE2C
 * Callers:
  ...
  if ( (*((_DWORD *)this + 120) & 0x400) != 0 )
  {
    if ( (v4 & 0x800) == 0 )
    {
      *(_DWORD *)(v3 + 12) = v4 | 0x800;
      if ( (*(_DWORD *)(*((_QWORD *)this + 52) + 812LL) & 0x60000) == 0x20000 )
      {
        v6 = 2LL;
LABEL_10:
  ...
  else if ( (v4 & 0x800) != 0 )
  {
    ...
    *(_DWORD *)(v3 + 12) = v4 & 0xFFFFF7FF;
    if ( (*(_DWORD *)(*((_QWORD *)this + 52) + 812LL) & 0x60000) == 0x40000 )
    {
      v6 = 1LL;
      goto LABEL_10;
    }
