/*
 * XREFs of ?IsCandidateTransformOwner@@YAHPEAUtagWND@@0@Z @ 0x1C0013DAC
 * Callers:
...
_BOOL8 __fastcall IsCandidateTransformOwner(struct tagWND *a1, struct tagWND *a2)
{
  ...
  if ( !v5 && !v6 )
    return 1LL;
  v15 = (const struct tagRECT *)(v10 + 88);
  v16 = v3 + 88;
  v17 = IsAdjacentRect((const struct tagRECT *)v16, v15);
  if ( v5 )
  {
    if ( !v17 && !(unsigned int)IntersectRect(&v19, v16, v15) )
      return 0LL;
  }
  if ( !v6 || v17 )
    return 1LL;
