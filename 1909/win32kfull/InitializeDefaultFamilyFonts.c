/*
 * XREFs of InitializeDefaultFamilyFonts @ 0x1C038095C
 * Callers:
 *     vInitMapper @ 0x1C0380DB0 (vInitMapper.c)
 * Callees:
...
int InitializeDefaultFamilyFonts()
{
  ...
  if ( result >= 0 )
  {
    for ( i = 0LL; i < 6; ++i )
    {
      if ( bQueryValueKey(*(PCWSTR *)&algn_1C02D78F8[i * 8], Handle, KeyValueInformation, 0x54u) && v8 == 1 )
      {
        v2 = 33LL;
