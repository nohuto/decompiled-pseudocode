/*
 * XREFs of ?bCleanupPFT@PUBLIC_PFTOBJ@@QEAAXW4eCleanupMode@1@PEAK@Z @ 0x1C0108BE4
 * Callers:
 *     vCleanupPrivateFonts @ 0x1C008CCB0 (vCleanupPrivateFonts.c)
 *     ?RegistryNotificaionEnumerationEnd@@YAXPEAK@Z @ 0x1C0108B34 (-RegistryNotificaionEnumerationEnd@@YAXPEAK@Z.c)
 * Callees:
