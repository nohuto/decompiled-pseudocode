/*
 * XREFs of vInitFontSubTable @ 0x1C03800C0
 * Callers:
 *     <none>
 * Callees:
...
LABEL_5:
  ...
  if ( gpfsTable )
  {
    *(_OWORD *)gpfsTable = xmmword_1C02DFEF8;
    v1[1] = xmmword_1C02DFF08;
    *((_DWORD *)v1 + 8) = 6684777;
    *((_WORD *)v1 + 18) = 0;
    v2 = gpfsTable;
    *((_OWORD *)gpfsTable + 4) = xmmword_1C02DFED0;
    v2[5] = xmmword_1C02DFEE0;
    *((_DWORD *)v2 + 24) = 4587593;
    *((_WORD *)v2 + 50) = 0;
    v3 = (char *)gpfsTable;
    *(_OWORD *)((char *)gpfsTable + 130) = xmmword_1C02DFF20;
