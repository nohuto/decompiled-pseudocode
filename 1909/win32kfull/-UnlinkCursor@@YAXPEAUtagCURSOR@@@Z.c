/*
 * XREFs of ?UnlinkCursor@@YAXPEAUtagCURSOR@@@Z @ 0x1C01011F8
 * Callers:
 *     ?_DestroyCursor@@YA_NPEAUtagCURSOR@@K@Z @ 0x1C002404C (-_DestroyCursor@@YA_NPEAUtagCURSOR@@K@Z.c)
 *     ZombieCursor @ 0x1C01EC0F0 (ZombieCursor.c)
 * Callees:
...
LABEL_7:
    ...
    v2 = 1;
    v5 = (struct tagCURSOR **)(*((_QWORD *)CurrentLogicalCursorThread + 52) + 728LL);
  }
  v8 = gSharedInfo[1];
  v9 = v8 + 32LL * giheLast;
