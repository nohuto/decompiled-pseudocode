/*
 * XREFs of ?vPatCpyRect4_8x8@@YAXPEAU_PATBLTFRAME@@H@Z @ 0x1C02BEEA0
 * Callers:
 *     ?vBrushPath4_8x8Enum@@YAXPEAU_RECTL@@KPEAX@Z @ 0x1C02C80C0 (-vBrushPath4_8x8Enum@@YAXPEAU_RECTL@@KPEAX@Z.c)
 * Callees:
 *     __security_check_cookie @ 0x1C0163A80 (__security_check_cookie.c)
 *     ?vPatternCopyLoop@@YAXPEAU_RECTL@@PEAKPEAU_PATBLTFRAME@@HKKKKJJJPEBK3@Z @ 0x1C02C02A4 (-vPatternCopyLoop@@YAXPEAU_RECTL@@PEAKPEAU_PATBLTFRAME@@HKKKKJJJPEBK3@Z.c)
 */
...
void __fastcall vPatCpyRect4_8x8(struct _PATBLTFRAME *a1, int a2)
{
  ...
  do
  {
    v13 = dword_1C02F0BB8[v3->left & 7];
    v14 = ~v13;
    v15 = dword_1C02F0BB8[v3->right & 7];
    if ( !v15 )
      v15 = -1;
