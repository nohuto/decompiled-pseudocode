/*
 * XREFs of ?xxxCallGenerateIAMKey@@YAJPEAUtagIAM_KKEY@@@Z @ 0x1C01D60A8
 * Callers:
...
NTSTATUS __fastcall xxxCallGenerateIAMKey(struct tagIAM_KKEY *a1)
{
  ...
  _QWORD v12[3]; // [rsp+80h] [rbp+17h] BYREF
  ...
  *(_QWORD *)&DestinationString.Length = 0LL;
  ...
  if ( result >= 0 )
  {
    ...
    PushW32ThreadLock((__int64)DeviceObject, v12, UserDereferenceObject);
    ...
    PopAndFreeW32ThreadLock((__int64)v12, v4, v5);
    return Status;
  }
  return result;
}
