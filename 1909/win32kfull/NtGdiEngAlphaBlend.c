/*
 * XREFs of NtGdiEngAlphaBlend @ 0x1C02AAD90
 * Callers:
 *     <none>
 * Callees:
 ...
 *     ??$GetDDIOBJ@U_BLENDOBJ@@@UMPDOBJ@@QEAAPEAU_BLENDOBJ@@PEAU1@@Z @ 0x1C02AA0E8 (--$GetDDIOBJ@U_BLENDOBJ@@@UMPDOBJ@@QEAAPEAU_BLENDOBJ@@PEAU1@@Z.c)
 */
