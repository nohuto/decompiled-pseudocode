/*
 * XREFs of ?bDelete@COLORTRANSFORMOBJ@@QEAAHAEAVXDCOBJ@@H@Z @ 0x1C028DC04
 * Callers:
 *     XDCOBJ_vCleanupColorTransformWrap @ 0x1C00DE5E0 (XDCOBJ_vCleanupColorTransformWrap.c)
 ...
 *     ?bRemoveColorTransform@XDCOBJ@@QEAAHPEAX@Z @ 0x1C028DDB4 (-bRemoveColorTransform@XDCOBJ@@QEAAHPEAX@Z.c)
 */
