/*
 * XREFs of ?DelegateDiscardMessages@@YAXPEAUtagQ@@HPEAUtagDELEGATEPOINTERMAP@@@Z @ 0x1C01F0404
 * Callers:
 ...
 *     ?GetPwndFromPointerMsgId@@YAPEAUtagWND@@_K@Z @ 0x1C01F068C (-GetPwndFromPointerMsgId@@YAPEAUtagWND@@_K@Z.c)
