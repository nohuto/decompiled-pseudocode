/*
 * XREFs of ?SpDdCreateFullscreenSprite@@YAJPEAUHDC__@@KPEAPEAXPEAPEAU1@@Z @ 0x1C026AE58
 * Callers:
 *     NtGdiDdCreateFullscreenSprite @ 0x1C0274CB0 (NtGdiDdCreateFullscreenSprite.c)
 * Callees:
 ...
 *     ??0DEVLOCKOBJ@@QEAA@AEAVPDEVOBJ@@@Z @ 0x1C0165ED0 (--0DEVLOCKOBJ@@QEAA@AEAVPDEVOBJ@@@Z.c)
...
__int64 __fastcall SpDdCreateFullscreenSprite(HDC a1, unsigned int a2, void **a3, HDC *a4)
{
  ...
  v29 = HDEV;
  DWMSPRITELOCK::DWMSPRITELOCK((DWMSPRITELOCK *)v24, v11, 0LL, 0);
