/*
 * XREFs of ?_PostTransformableMessageExtended@@YAPEAUtagQMSG@@PEAUtagWND@@I_K_JPEAUtagINPUT_MESSAGE_SOURCE@@H@Z @ 0x1C00451E0
 * Callers:
 ...
 *     ?GenerateCtrlInputMessages@InteractiveControlInput@@IEAAJPEAUtagWND@@I@Z @ 0x1C025488C (-GenerateCtrlInputMessages@InteractiveControlInput@@IEAAJPEAUtagWND@@I@Z.c)
 * Callees:
...
LABEL_99:
        ...
        else if ( v38 == 281 && !HMValidateHandle(v82, 21) )
        {
          goto LABEL_63;
        }
      }
      else
      {
        ...
        v78 = v50;
        v79 = v51;
        PostUpdateKeyStateEvent(v46, v41, v39);
      }
      if ( (*(_DWORD *)(v32 + 1224) & 0x20) != 0 )
      {
        if ( v32 == W32GetThreadWin32Thread(KeGetCurrentThread()) )
        {
          a5 = v81;
        }
        else
