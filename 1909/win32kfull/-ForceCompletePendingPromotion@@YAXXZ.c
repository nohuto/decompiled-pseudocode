/*
 * XREFs of ?ForceCompletePendingPromotion@@YAXXZ @ 0x1C0207570
 * Callers:
 ...
 *     ?ResetPendingPromotion@@YAXXZ @ 0x1C0207D50 (-ResetPendingPromotion@@YAXXZ.c)
...
void ForceCompletePendingPromotion(void)
{
  ...
  v0 = word_1C032A2F0;
  v2 = ((dword_1C032A300 != 0) + 16842753) | (dword_1C032A304 != 0 ? 0x2000000 : 0);
  if ( !ValidatePointerPromotion(word_1C032A2F0, dword_1C032A2F4, &v2, &v4, &v3) )
    goto LABEL_5;
  v1 = v3;
  if ( v3 )
  {
