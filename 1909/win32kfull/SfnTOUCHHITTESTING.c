/*
 * XREFs of SfnTOUCHHITTESTING @ 0x1C021CAD0
 * Callers:
 *     <none>
 * Callees:
        ...
        __int64 a6)
{
  ...
  if ( a1 )
    ...
    v14 = 0LL;
  result = AllocCallbackMessage(88, 1u, 48LL, v50, 1, 0x200uLL);
  v18 = result;
  v39 = result;
  if ( result )
  {
    ...
    *((_DWORD *)v18 + 12) = a2;
    *((_QWORD *)v18 + 7) = a3;
    if ( (int)CaptureCallbackData((struct _CAPTUREBUF *)v18, a4, 0x30u, (void **)v18 + 8) < 0 )
      goto LABEL_26;
    *((_QWORD *)v18 + 9) = a5;
    *((_QWORD *)v18 + 10) = a6;
    ...
    *((_QWORD *)v18 + 2) = 0LL;
    v26 = KeUserModeCallback(115LL, v18, *(unsigned int *)v18, &v40, v38);
