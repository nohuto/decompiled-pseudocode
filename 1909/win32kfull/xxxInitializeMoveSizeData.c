/*
 * XREFs of xxxInitializeMoveSizeData @ 0x1C0200FD8
 * Callers:
 ...
 *     ?AreDockTargetsActive@@YAEPEAU_MOVESIZEDATA@@@Z @ 0x1C01F9914 (-AreDockTargetsActive@@YAEPEAU_MOVESIZEDATA@@@Z.c)
...
__int64 __fastcall xxxInitializeMoveSizeData(struct tagWND *a1, struct _MOVESIZEDATA *a2, int a3, int a4, int a5)
{
  ...
  int v67; // eax
  __int64 result; // rax
  struct tagPOINT v69; // [rsp+30h] [rbp-41h]
  struct tagRECT v70; // [rsp+40h] [rbp-31h] BYREF
  _QWORD v71[2]; // [rsp+50h] [rbp-21h] BYREF
  __int128 v72; // [rsp+60h] [rbp-11h] BYREF
  struct tagRECT v73; // [rsp+70h] [rbp-1h] BYREF

  v72 = 0uLL;
  v9 = 16;
  if ( WPP_RECORDER_INITIALIZED != (_UNKNOWN *)&WPP_RECORDER_INITIALIZED )
    WPP_RECORDER_SF_q((_DWORD)a1, (_DWORD)a2, 1, 16, (__int64)&WPP_c0d2aea0028b3d709fe1f4aa428b688d_Traceguids, a1);
  ...
  *(_OWORD *)((char *)a2 + 136) = *(_OWORD *)(*((_QWORD *)a1 + 5) + 88LL);
  ...
  if ( v11 == DesktopWindow )
  {
    ...
    {
      v13 = (int *)((char *)a2 + 88);
      *(_OWORD *)((char *)a2 + 88) = *(_OWORD *)GetScreenRectForWindow(&v70, a1);
    ...
    else
    {
      ...
      v13 = (int *)((char *)a2 + 88);
      *(_OWORD *)((char *)a2 + 88) = *GetMonitorWorkRectForWindow(&v70, *(_QWORD *)(DispInfo + 96), a1);
    ...
    *(_OWORD *)((char *)a2 + 88) = *(_OWORD *)(*(_QWORD *)(v11 + 40) + 104LL);
    ...
    if ( TopLevelWindow )
    {
      ...
      if ( v18 )
      {
        v71[0] = 0LL;
        v71[1] = 0LL;
        if ( (unsigned int)GreGetRgnBox(v18, v71) )
          IntersectRect((_DWORD *)a2 + 22, (int *)a2 + 22, (int *)v71);
      }
    }
    v13 = (int *)((char *)a2 + 88);
    v73 = *(struct tagRECT *)((char *)a2 + 88);
    if ( (unsigned int)IsWindowDesktopComposed(a1) && (*(_DWORD *)(*((_QWORD *)a1 + 5) + 288LL) & 0xF) != 2 )
      LogicalToPhysicalDPIRect(&v73, &v73, *(unsigned int *)(*((_QWORD *)a1 + 5) + 288LL), 0LL);
  }
  v19 = *((_QWORD *)a1 + 13);
  v20 = (int *)((char *)a2 + 120);
  v21 = (__int16)a4;
  ...
  if ( *(_QWORD *)(*(_QWORD *)(v19 + 40) + 168LL) )
  {
    ...
    v71[0] = __PAIR64__(v22, v21);
    v72 = v23;
    TransformRectBetweenCoordinateSpaces(&v72, &v72, v19, a1);
    TransformPointBetweenCoordinateSpaces(v71, v71, *((_QWORD *)a1 + 13), a1);
    v25 = GreRectInRegion(*(_QWORD *)(*(_QWORD *)(*((_QWORD *)a1 + 13) + 40LL) + 168LL), &v72);
    v26 = HIDWORD(v71[0]);
    v27 = LODWORD(v71[0]);
  ...
  *((_DWORD *)a2 + 49) = v28;
  ...
  {
    v70 = v73;
    CCursorClip::SetClip(gpCursorClip, &v70);
  }
...
LABEL_88:
  ...
  *((_DWORD *)a2 + 48) = v22;
  ...
  v24 = (__int64)v69;
  zzzInternalSetCursorPos(v21, v69.y, 1, 0);
  xxxMS_FlushWigglies();
  v57 = *((_DWORD *)a2 + 49);
  if ( (v57 & 0x400) == 0 )
    *v35 = 4;
...
LABEL_100:
  ...
  *((_QWORD *)a2 + 26) = ValidateHmonitorNoRip(*(_QWORD *)(*((_QWORD *)a1 + 5) + 256LL));
  v60 = *((_DWORD *)a2 + 49) ^ (*((_DWORD *)a2 + 49) ^ ~(*((_DWORD *)a2 + 49) << 23)) & 0x10000000;
  *((_DWORD *)a2 + 49) = v60;
  v61 = v60 & 0xFFFFDFFF | ((*(_BYTE *)(*((_QWORD *)a1 + 5) + 233LL) & 1) << 13);
  *((_DWORD *)a2 + 49) = v61;
  v62 = v61 & 0xFFFFBFFF | ((*(_BYTE *)(*((_QWORD *)a1 + 5) + 233LL) & 2) << 13);
  v63 = ((unsigned __int16)v62 ^ (unsigned __int16)(v62 >> 5)) & 0x100 ^ v62;
  v64 = (((unsigned __int16)v63 ^ (unsigned __int16)(v63 >> 5)) & 0x200 ^ v63) & 0xDFF7FFFF;
  *((_DWORD *)a2 + 49) = v64;
  if ( (v64 & 2) != 0 )
  {
    v65 = v64 & 0xFFFFF3FF;
    *((_DWORD *)a2 + 49) = v65;
    if ( (*(_BYTE *)(*((_QWORD *)a1 + 5) + 233LL) & 3) != 0 )
      *((_DWORD *)a2 + 49) = v65 | 0xC00C00;
  }
  *((_DWORD *)a2 + 45) = dword_1C02EB658[a3];
  *((_DWORD *)a2 + 46) = dword_1C02EB628[a3];
  v66 = dword_1C02EB6B8[a3];
  if ( v66 != -1 )
    *((_DWORD *)a2 + 42) = *((_DWORD *)a2 + (__int16)v66 + 30) - v21;
  v67 = dword_1C02EB688[a3];
  if ( v67 != -1 )
    *((_DWORD *)a2 + 43) = *((_DWORD *)a2 + (__int16)v67 + 30) - v22;
