/*
 * XREFs of STROBJ_bGetAdvanceWidths @ 0x1C02B7480
 * Callers:
 *     NtGdiSTROBJ_bGetAdvanceWidths @ 0x1C02ADB70 (NtGdiSTROBJ_bGetAdvanceWidths.c)
 * Callees:
 *     ?STROBJ_bGetAdvanceWidthsLinked@@YAHPEAVESTROBJ@@KKPEAU_POINTQF@@@Z @ 0x1C02B5C34 (-STROBJ_bGetAdvanceWidthsLinked@@YAHPEAVESTROBJ@@KKPEAU_POINTQF@@@Z.c)
 */
