__int64 __fastcall InitializeTelemetryAssertsKMWorkerInternal(const void **a1)
{
        ...
        (g_ModuleName = v4) != 0LL) )
  {
    ...
    qword_1C035D4F8 = (__int64)&g_MicrosoftTelemetryAssertsTriggeredList;
    g_MicrosoftTelemetryAssertsTriggeredList = (__int64)&g_MicrosoftTelemetryAssertsTriggeredList;
    TraceLoggingRegisterEx_EtwRegister_EtwSetInformation(&dword_1C039B040);
    TraceLoggingRegisterEx_EtwRegister_EtwSetInformation(&dword_1C039B008);
    TraceLoggingRegisterEx_EtwRegister_EtwSetInformation(&dword_1C039B078);
