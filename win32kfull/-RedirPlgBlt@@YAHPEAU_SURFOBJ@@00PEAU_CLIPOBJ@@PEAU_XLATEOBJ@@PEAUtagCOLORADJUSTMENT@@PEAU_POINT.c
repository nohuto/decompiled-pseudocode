/*
 * XREFs of ?RedirPlgBlt@@YAHPEAU_SURFOBJ@@00PEAU_CLIPOBJ@@PEAU_XLATEOBJ@@PEAUtagCOLORADJUSTMENT@@PEAU_POINTL@@PEAU_POINTFIX@@PEAU_RECTL@@4K@Z @ 0x1C02A7B60
 * Callers:
 *     <none>
 * Callees:
        ...
        ULONG iMode)
{
        ...
        if ( (*(_DWORD *)(v19 + 40) & 0x20000) != 0 )
        {
          for ( i = **(struct _DISPSURF ***)(v19 + 1768); i; i = *(struct _DISPSURF **)i )
          {
              ...
              && *(_QWORD *)(*(_QWORD *)(v21 + 1760) + 624LL) )
            {
              ...
              (*(void (__fastcall **)(struct _SURFOBJ *, __int64, struct _SURFOBJ *, CLIPOBJ *, XLATEOBJ *, COLORADJUSTMENT *, POINTL *, POINTFIX *, RECTL *, POINTL *, ULONG))(*(_QWORD *)(v21 + 1760) + 624LL))(
                v23,
                v24,
                DevBitmap,
                pco,
  ...
  v25 = EngPlgBlt(a1, a2, a3, pco, pxlo, pca, pptlBrushOrg, pptfx, prcl, pptl, iMode);
  if ( v28 )
    bMakeOpaque(v28);
  if ( v29 )
    bMakeOpaque(v29);
