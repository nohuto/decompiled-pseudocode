/*
 * XREFs of UmfdLoadFontFileView @ 0x1C011859C
 * Callers:
 ...
 * Callees:
 *     ?bIsPathInSystemFontsDir@@YAHPEBG@Z @ 0x1C00E13F8 (-bIsPathInSystemFontsDir@@YAHPEBG@Z.c)
 ...
 *     ?FNTCacheValidateFntFileInfo@@YA?AW4FntFileInfoValidationResult@@PEAPEAU_FONTFILEVIEW@@K@Z @ 0x1C028C4DC (-FNTCacheValidateFntFileInfo@@YA-AW4FntFileInfoValidationResult@@PEAPEAU_FONTFILEVIEW@@K@Z.c)
