/*
 * XREFs of GreAngleArc @ 0x1C02ADE64
 * Callers:
 *     NtGdiAngleArc @ 0x1C02C46B0 (NtGdiAngleArc.c)
 * Callees:
 ...
 *     ??0EBOX@@QEAA@AEAVEXFORMOBJ@@AEAU_RECTL@@@Z @ 0x1C02C7E14 (--0EBOX@@QEAA@AEAVEXFORMOBJ@@AEAU_RECTL@@@Z.c)
