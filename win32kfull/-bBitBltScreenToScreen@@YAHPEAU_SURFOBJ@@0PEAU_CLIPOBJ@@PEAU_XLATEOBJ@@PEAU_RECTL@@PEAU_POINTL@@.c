/*
 * XREFs of ?bBitBltScreenToScreen@@YAHPEAU_SURFOBJ@@0PEAU_CLIPOBJ@@PEAU_XLATEOBJ@@PEAU_RECTL@@PEAU_POINTL@@4PEAU_BRUSHOBJ@@4K@Z @ 0x1C02B4900
 * Callers:
 ...
 *     ??1MULTISORTBLTORDER@@QEAA@XZ @ 0x1C02B098C (--1MULTISORTBLTORDER@@QEAA@XZ.c)
