/*
 * XREFs of SfnINLPHLPSTRUCT @ 0x1C020BB30
 * Callers:
 *     <none>
 * Callees:
...
unsigned __int8 *__fastcall SfnINLPHLPSTRUCT(_QWORD *a1, unsigned int a2, __int64 a3, char *a4, __int64 a5, __int64 a6)
{
  ...
  if ( a1 )
    ...
    v13 = 0LL;
  result = AllocCallbackMessage(88, 1u, *(unsigned __int16 *)a4, v40, 1, 0x200uLL);
  v16 = result;
  ...
  if ( result )
  {
    ...
    *((_DWORD *)v16 + 12) = a2;
    *((_QWORD *)v16 + 7) = a3;
    if ( (int)CaptureCallbackData((struct _CAPTUREBUF *)v16, a4, *(unsigned __int16 *)a4, (void **)v16 + 8) < 0 )
      goto LABEL_21;
    *((_QWORD *)v16 + 9) = a5;
    *((_QWORD *)v16 + 10) = a6;
    ThreadLock(a1, &v37);
    ...
    *((_QWORD *)v16 + 2) = 0LL;
    v20 = KeUserModeCallback(14LL, v16, *(unsigned int *)v16, &v30, &v28);
