/*
 * XREFs of SfnTOUCHHITTESTING @ 0x1C0212AE0
 * Callers:
 *     <none>
 * Callees:
        ...
        __int64 a6)
{
  ...
  if ( result )
  {
    ...
    *((_DWORD *)v16 + 12) = a2;
    *((_QWORD *)v16 + 7) = a3;
    if ( (int)CaptureCallbackData((struct _CAPTUREBUF *)v16, a4, 0x30u, (void **)v16 + 8) < 0 )
      goto LABEL_21;
    *((_QWORD *)v16 + 9) = a5;
    *((_QWORD *)v16 + 10) = a6;
    ThreadLock(a1, &v37);
    ...
    *((_QWORD *)v16 + 2) = 0LL;
    v20 = KeUserModeCallback(115LL, v16, *(unsigned int *)v16, &v30, &v28);
