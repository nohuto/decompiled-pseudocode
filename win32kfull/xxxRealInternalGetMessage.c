/*
 * XREFs of xxxRealInternalGetMessage @ 0x1C006F2F0
 * Callers:
 ...
 *     Feature_MTestAbSh1__private_IsEnabledDeviceUsage @ 0x1C012D720 (Feature_MTestAbSh1__private_IsEnabledDeviceUsage.c)
 ...
 *     ?UnblockDeferredInput@@YAXPEAUtagTHREADINFO@@@Z @ 0x1C01B7188 (-UnblockDeferredInput@@YAXPEAUtagTHREADINFO@@@Z.c)
 ...
 *     ?PopFirstPendingDelegateCapture@@YA_KPEAUtagTHREADINPUTPOINTERLIST@@@Z @ 0x1C01C723C (-PopFirstPendingDelegateCapture@@YA_KPEAUtagTHREADINPUTPOINTERLIST@@@Z.c)
