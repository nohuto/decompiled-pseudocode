/*
 * XREFs of ?EndLoop@MoveSize@InputTraceLogging@@SAXPEAUtagWND@@PEBD@Z @ 0x1C01EA638
 * Callers:
...
void __fastcall InputTraceLogging::MoveSize::EndLoop(struct tagWND *a1, const char *a2)
{
  __int64 v2; // r8
  __int64 *v3; // r9
  __int64 v4; // r10
