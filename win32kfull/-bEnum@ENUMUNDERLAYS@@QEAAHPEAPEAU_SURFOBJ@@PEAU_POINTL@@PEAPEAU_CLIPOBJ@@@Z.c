/*
 * XREFs of ?bEnum@ENUMUNDERLAYS@@QEAAHPEAPEAU_SURFOBJ@@PEAU_POINTL@@PEAPEAU_CLIPOBJ@@@Z @ 0x1C001C4E4
 * Callers:
 ...
 *     ??1UNDOENGUPDATEDEVICESURFACE@@QEAA@XZ @ 0x1C027C538 (--1UNDOENGUPDATEDEVICESURFACE@@QEAA@XZ.c)
