/*
 * XREFs of ?SetWindowCompositionHolographic@@YAJPEAUtagWND@@PEBUtagWINDOWCOMPOSITIONATTRIBDATA_UNION@@@Z @ 0x1C01F830C
 * Callers:
...
__int64 __fastcall SetWindowCompositionHolographic(
        struct tagWND *a1,
        const struct tagWINDOWCOMPOSITIONATTRIBDATA_UNION *a2)
{
  ...
  {
    if ( -__CFSHR__(v7[0], 14) == v5 )
    {
      return 0;
    }
    else
    {
      v7[0] = (v5 << 13) | v7[0] & 0xFFFFDFFF;
