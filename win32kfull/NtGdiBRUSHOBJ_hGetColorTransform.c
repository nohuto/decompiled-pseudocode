/*
 * XREFs of NtGdiBRUSHOBJ_hGetColorTransform @ 0x1C02CA7D0
 * Callers:
 *     <none>
 * Callees:
...
struct UMPDOBJ *__fastcall NtGdiBRUSHOBJ_hGetColorTransform(__int64 a1)
{
  ...
  {
    ++*((_DWORD *)result + 105);
    v5 = (BRUSHOBJ *)UMPDOBJ::GetDDIOBJ<_BRUSHOBJ>((__int64)result, a1);
    if ( v5 )
