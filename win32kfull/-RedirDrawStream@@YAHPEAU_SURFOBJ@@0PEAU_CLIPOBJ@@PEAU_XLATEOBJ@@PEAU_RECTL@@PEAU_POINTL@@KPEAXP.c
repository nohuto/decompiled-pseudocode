/*
 * XREFs of ?RedirDrawStream@@YAHPEAU_SURFOBJ@@0PEAU_CLIPOBJ@@PEAU_XLATEOBJ@@PEAU_RECTL@@PEAU_POINTL@@KPEAXPEAU_DSSTATE@@@Z @ 0x1C02A6FC0
 * Callers:
 *     <none>
 * Callees:
        ...
        struct _DSSTATE *a9)
{
        ...
        if ( (*(_DWORD *)(v17 + 40) & 0x20000) != 0 )
        {
          for ( i = **(struct _DISPSURF ***)(v17 + 1768); i; i = *(struct _DISPSURF **)i )
          {
            ...
            if ( v20 )
            {
              ...
              {
                if ( *(_QWORD *)(*(_QWORD *)(v20 + 1760) + 784LL) )
                {
                  ...
                  (*(void (__fastcall **)(struct _SURFOBJ *, __int64, struct _CLIPOBJ *, struct _XLATEOBJ *, struct _RECTL *, struct _POINTL *, unsigned int, _DWORD *, struct _DSSTATE *))(*(_QWORD *)(v20 + 1760) + 784LL))(
                    DevBitmap,
                    v22,
                    a3,
                    a4,
  ...
  v23 = EngDrawStream((__int64)a1, (__int64)a2, (__int64)a3, (__int64)a4, (int)a5, (int *)a6, a7, a8, v14);
  if ( v26 )
    bMakeOpaque(v26);
  if ( v27 )
    bMakeOpaque(v27);
