/*
 * XREFs of ?RedirTextOut@@YAHPEAU_SURFOBJ@@PEAU_STROBJ@@PEAU_FONTOBJ@@PEAU_CLIPOBJ@@PEAU_RECTL@@4PEAU_BRUSHOBJ@@5PEAU_POINTL@@K@Z @ 0x1C02A8890
 * Callers:
 *     <none>
 * Callees:
        ...
        MIX a10)
{
        ...
        if ( (*(_DWORD *)(v19 + 40) & 0x20000) != 0 )
        {
          for ( i = **(_QWORD ***)(v19 + 1768); i; i = (_QWORD *)*i )
          {
            ...
            if ( v22 )
            {
              ...
              {
                if ( *(_QWORD *)(*(_QWORD *)(v22 + 1760) + 248LL) )
                {
                  MARK_ACCDRV_NOTIFICATION::MARK_ACCDRV_NOTIFICATION(
                    (MARK_ACCDRV_NOTIFICATION *)&v26,
                    (struct PDEVOBJ *)&v37,
                    a1);
                  (*(void (__fastcall **)(struct _SURFOBJ *, STROBJ *, FONTOBJ *, CLIPOBJ *, RECTL *, RECTL *, BRUSHOBJ *, BRUSHOBJ *, POINTL *, MIX))(*(_QWORD *)(v23 + 1760) + 248LL))(
                    a1,
                    pstro,
                    pfo,
                    pco,
  ...
  v24 = EngTextOut(a1, pstro, pfo, pco, prclExtra, prclOpaque, pboFore, pboOpaque, pptlOrg, mix);
  if ( v27 )
    bMakeOpaque(v27);
  return v24;
}
