/*
 * XREFs of ?vSpReadFromScreen@@YAXPEAU_SPRITESTATE@@PEAU_POINTL@@PEAU_SURFOBJ@@PEAU_RECTL@@@Z @ 0x1C0283F18
 * Callers:
 ...
 *     ??1NEEDDDILOCK@@QEAA@XZ @ 0x1C027C488 (--1NEEDDDILOCK@@QEAA@XZ.c)
