/*
 * XREFs of dllmain_crt_process_attach @ 0x180003FF8
 * Callers:
 *     dllmain_crt_dispatch @ 0x180003FA0 (dllmain_crt_dispatch.c)
 * Callees:
 *     ?__scrt_initialize_type_info@@YAXXZ @ 0x18000443C (-__scrt_initialize_type_info@@YAXXZ.c)
 ...
 *     __scrt_is_nonwritable_in_current_image @ 0x180004714 (__scrt_is_nonwritable_in_current_image.c)
 *     __scrt_release_startup_lock @ 0x1800047B4 (__scrt_release_startup_lock.c)
 *     __scrt_get_dyn_tls_init_callback @ 0x180004810 (__scrt_get_dyn_tls_init_callback.c)
 *     __scrt_fastfail @ 0x180004830 (__scrt_fastfail.c)
 *     _RTC_Initialize @ 0x180004984 (_RTC_Initialize.c)
 *     _initterm_0 @ 0x180004D86 (_initterm_0.c)
 *     _initterm_e_0 @ 0x180004D92 (_initterm_e_0.c)
