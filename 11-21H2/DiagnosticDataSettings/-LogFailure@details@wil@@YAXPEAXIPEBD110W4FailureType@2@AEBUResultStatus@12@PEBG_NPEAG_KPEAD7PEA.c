/*
 * XREFs of ?LogFailure@details@wil@@YAXPEAXIPEBD110W4FailureType@2@AEBUResultStatus@12@PEBG_NPEAG_KPEAD7PEAUFailureInfo@2@@Z @ 0x18000366C
 * Callers:
 ...
 * Callees:
 *     ?RecordFailFast@details@wil@@YAHJ@Z @ 0x180001050 (-RecordFailFast@details@wil@@YAHJ@Z.c)
 *     ?RecordException@details@wil@@YAHJ@Z @ 0x18000312C (-RecordException@details@wil@@YAHJ@Z.c)
 ...
 *     ?RecordLog@details@wil@@YAHJ@Z @ 0x1800032E8 (-RecordLog@details@wil@@YAHJ@Z.c)
