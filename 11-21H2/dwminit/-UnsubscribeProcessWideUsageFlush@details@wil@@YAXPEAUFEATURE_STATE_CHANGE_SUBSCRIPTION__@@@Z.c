/*
 * XREFs of ?UnsubscribeProcessWideUsageFlush@details@wil@@YAXPEAUFEATURE_STATE_CHANGE_SUBSCRIPTION__@@@Z @ 0x18000D640
 * Callers:
 *     <none>
 * Callees:
        ...
        struct FEATURE_STATE_CHANGE_SUBSCRIPTION__ *a2)
{
  ...
  {
    if ( SRWLock )
      wil::details_abi::SubscriptionList::Unsubscribe((struct _RTL_CRITICAL_SECTION *)&SRWLock[25], SRWLock, this);
  }
}
