/*
 * XREFs of ?LogFailure@details@wil@@YAXPEAXIPEBD110W4FailureType@2@AEBUResultStatus@12@PEBG_NPEAG_KPEAD7PEAUFailureInfo@2@@Z @ 0x18000504C
 * Callers:
 ...
 * Callees:
 *     ?RecordFailFast@details@wil@@YAHJ@Z @ 0x1800035C0 (-RecordFailFast@details@wil@@YAHJ@Z.c)
 ...
 *     ?RecordException@details@wil@@YAHJ@Z @ 0x180005C1C (-RecordException@details@wil@@YAHJ@Z.c)
 *     ?RecordLog@details@wil@@YAHJ@Z @ 0x180005C3C (-RecordLog@details@wil@@YAHJ@Z.c)
