/*
 * XREFs of ??$ReportFailure_NoReturn@$02@details@wil@@YAXPEAXIPEBD110AEBUResultStatus@01@PEBGW4ReportFailureOptions@01@@Z @ 0x1800039EC
 * Callers:
        ...
        __int64 a7)
{
  ...
  v22 = *(_DWORD *)a7;
  v23 = v10;
  v11 = wil::details::RecordFailFast((wil::details *)(unsigned int)v22);
  v12 = *(_BYTE *)(a7 + 8) == 0;
  v13 = v11;
  LODWORD(v21) = 3;
  v14 = 0;
  ...
  {
    v22 = -2147418113;
    v23 = wil::details::HrToNtStatus((wil::details *)0x8000FFFFLL, v15);
  }
  ...
  wil::details::WilFailFast((wil::details *)&v21, v19);
}
