/*
 * XREFs of ?_lambda_invoker_cdecl_@_lambda_5035b992506f4af81a770c5842624510_@@CAXPEAU_TP_CALLBACK_INSTANCE@@PEAXPEAU_TP_TIMER@@@Z @ 0x180009550
 * Callers:
 *     <none>
 * Callees:
        ...
        PTP_TIMER Timer)
{
  ...
  if ( LOBYTE(Context->Ptr) )
  {
    ...
    if ( v4 )
    {
      ...
      v5 = v4;
      wistd::invoke<void (*)(_RTL_SRWLOCK *),_RTL_SRWLOCK * &>(&v6, &v5);
    }
  }
}
