/*
 * XREFs of ?RecordFeatureUsage@FeatureStateManager@details@wil@@QEAAXIW4wil_details_ServiceReportingKind@@_K@Z @ 0x18000BA04
 * Callers:
        ...
        unsigned int a4)
{
  ...
  int v9; // eax
  char v10; // bl
  __int64 (__fastcall *v11[5])(_QWORD); // [rsp+20h] [rbp-28h] BYREF
...
LABEL_17:
      ...
      && (!wil::details::g_pfnDllShutdownInProgress || !(unsigned __int8)wil::details::g_pfnDllShutdownInProgress()) )
    {
      ...
      wil::details::EnsureCoalescedTimer<wil::details::FeatureStateManager>(
        (struct _FILETIME *)(a1 + 48),
        (_BYTE *)(a1 + 65),
        (void *)a1);
      if ( a1 != -32 )
      {
        v11[0] = (__int64 (__fastcall *)(_QWORD))ReleaseSRWLockExclusive;
        v12 = a1 + 32;
        wistd::invoke<void (*)(_RTL_SRWLOCK *),_RTL_SRWLOCK * &>(v11, &v12);
      }
    }
    return;
  }
