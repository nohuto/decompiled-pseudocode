/*
 * XREFs of ?ReportAggregatedValues@_unnamed_type_gDwmInitTelemetryAggregator_@@QEAAXXZ @ 0x180005C7C
 * Callers:
        ...
        _unnamed_type_gDwmInitTelemetryAggregator_ *this)
{
  ...
  if ( (gDwmInitTelemetryAggregator
     || (_DWORD)qword_180015B64
     || __PAIR64__(HIDWORD(qword_180015B64), 0) != (unsigned int)qword_180015B6C)
    ...
    && (qword_180015018 & 0x400000000000LL) == qword_180015018 )
  {
    ...
    tlgWriteTransfer_EventWriteTransfer(
      ...
      (unsigned __int8 *)dword_18001117B,
      0LL,
      0LL,
      9u,
      &v6);
