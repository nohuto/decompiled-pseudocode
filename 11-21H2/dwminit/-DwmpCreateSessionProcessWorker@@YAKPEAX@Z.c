/*
 * XREFs of ?DwmpCreateSessionProcessWorker@@YAKPEAX@Z @ 0x1800044C0
 * Callers:
...
LABEL_34:
  ...
  if ( v3 < 0 )
  {
    LODWORD(qword_180015B6C) = qword_180015B6C + 1;
    ++HIDWORD(qword_180015B6C);
    if ( SHIDWORD(qword_180015B6C) > 10 )
    {
