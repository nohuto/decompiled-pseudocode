/*
 * XREFs of ??$ReportFailure_Return@$00@details@wil@@YAXPEAXIPEBD110AEBUResultStatus@01@PEBGW4ReportFailureOptions@01@@Z @ 0x180003C84
 * Callers:
 ...
 *     ?RecordReturn@details@wil@@YAHJ@Z @ 0x180005C5C (-RecordReturn@details@wil@@YAHJ@Z.c)
