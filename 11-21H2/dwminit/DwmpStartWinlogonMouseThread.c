/*
 * XREFs of DwmpStartWinlogonMouseThread @ 0x180007080
 * Callers:
 *     <none>
 * Callees:
 ...
 *     ??$?8VCKstWinLogon@@U?$default_delete@VCKstWinLogon@@@std@@@std@@YA_NAEBV?$unique_ptr@VCKstWinLogon@@U?$default_delete@VCKstWinLogon@@@std@@@0@$$T@Z @ 0x180003808 (--$-8VCKstWinLogon@@U-$default_delete@VCKstWinLogon@@@std@@@std@@YA_NAEBV-$unique_ptr@VCKstWinLo.c)
