/*
 * XREFs of dllmain_crt_process_attach @ 0x180002C18
 * Callers:
 ...
 *     __scrt_is_nonwritable_in_current_image @ 0x18000209C (__scrt_is_nonwritable_in_current_image.c)
 *     __scrt_release_startup_lock @ 0x18000213C (__scrt_release_startup_lock.c)
 *     __scrt_fastfail @ 0x1800023D0 (__scrt_fastfail.c)
 *     ?__scrt_initialize_type_info@@YAXXZ @ 0x180003208 (-__scrt_initialize_type_info@@YAXXZ.c)
 *     __scrt_initialize_default_local_stdio_options @ 0x180003230 (__scrt_initialize_default_local_stdio_options.c)
 *     __scrt_get_dyn_tls_init_callback @ 0x180003254 (__scrt_get_dyn_tls_init_callback.c)
 *     _RTC_Initialize @ 0x180003264 (_RTC_Initialize.c)
 *     _initterm_0 @ 0x18000332C (_initterm_0.c)
 *     _initterm_e_0 @ 0x180003338 (_initterm_e_0.c)
