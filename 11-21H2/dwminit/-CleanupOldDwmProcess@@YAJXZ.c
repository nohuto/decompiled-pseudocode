/*
 * XREFs of ?CleanupOldDwmProcess@@YAJXZ @ 0x18000411C
 * Callers:
 ...
 *     ?GetPrimaryDisplayDeviceInfo@@YA_NPEAU_DISPLAY_DEVICEW@@@Z @ 0x180004DEC (-GetPrimaryDisplayDeviceInfo@@YA_NPEAU_DISPLAY_DEVICEW@@@Z.c)
...
LABEL_19:
  ...
  if ( v4 )
  {
    ...
    v7 = StringCchPrintfW(v25, 0xBuLL, L"0x%08x", ExitCode);
    v8 = v25;
    if ( v7 < 0 )
      v8 = 0LL;
    Strings[0] = v8;
    v9 = StringCchPrintfW(v26, 0xCuLL, L"%i", (unsigned int)gDwmNumRetriesSoFar);
    v10 = v26;
    if ( v9 < 0 )
      v10 = 0LL;
    Strings[1] = v10;
