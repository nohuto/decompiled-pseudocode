/*
 * XREFs of ?IsRightFormatSupported@CAPOProcessNode@@UEAAJPEAUIAudioMediaType@@PEAPEAU2@0@Z @ 0x1400296E0
 * Callers:
 *     <none>
 * Callees:
        ...
        struct IAudioMediaType *a4)
{
  ...
  if ( v6 < 0 )
  {
    ...
    AudDGTraceLoggingErrorHelper("CAPOProcessNode::IsRightFormatSupported", 0x2CCu, v7);
  }
  return v7;
}
