/*
 * XREFs of ?CreateInstance@?$CComCreator@V?$CComAggObject@VCVpoContext@@@ATL@@@ATL@@SAJPEAXAEBU_GUID@@PEAPEAX@Z @ 0x140061724
 * Callers:
 ...
 *     ??0?$CComAggObject@VCVpoContext@@@ATL@@QEAA@PEAX@Z @ 0x140061388 (--0-$CComAggObject@VCVpoContext@@@ATL@@QEAA@PEAX@Z.c)
 */
