/*
 * XREFs of ?SetMute@CSystemAudioDeviceOffloadGraph@@UEAAJEPEA_JW4AUDIO_CURVE_TYPE@@0@Z @ 0x140058D10
 * Callers:
 *     <none>
 * Callees:
        ...
        enum AUDIO_CURVE_TYPE a4)
{
  ...
  if ( v7 < 0 )
  {
    ...
    {
      WPP_SF_d(*((_QWORD *)WPP_GLOBAL_Control + 2), 0xFu, (__int64)&WPP_6a6aaf124706356e0ec6025c89b7f8a8_Traceguids, v7);
    }
    AudDGTraceLoggingErrorHelper("CSystemAudioDeviceOffloadGraph::SetMute", 0x155u, v7);
  }
  EtwEventActivityIdControl(4LL, &v9);
