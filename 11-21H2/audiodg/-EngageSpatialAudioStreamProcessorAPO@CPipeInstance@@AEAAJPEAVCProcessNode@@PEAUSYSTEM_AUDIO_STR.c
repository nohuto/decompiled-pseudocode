/*
 * XREFs of ?EngageSpatialAudioStreamProcessorAPO@CPipeInstance@@AEAAJPEAVCProcessNode@@PEAUSYSTEM_AUDIO_STREAM_DESCRIPTOR@@@Z @ 0x14002A240
 * Callers:
        ...
        struct SYSTEM_AUDIO_STREAM_DESCRIPTOR *a3)
{
  ...
  if ( (*((_DWORD *)a3 + 34) & 0x800000) != 0 )
  {
    ...
    if ( v4 < 0 )
      AudDGTraceLoggingErrorHelper("CPipeInstance::EngageSpatialAudioStreamProcessorAPO", 0x3ECu, v4);
  }
