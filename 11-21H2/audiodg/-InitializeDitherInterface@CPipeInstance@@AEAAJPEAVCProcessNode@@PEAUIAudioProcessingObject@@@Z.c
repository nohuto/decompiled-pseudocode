/*
 * XREFs of ?InitializeDitherInterface@CPipeInstance@@AEAAJPEAVCProcessNode@@PEAUIAudioProcessingObject@@@Z @ 0x140016E28
 * Callers:
        ...
        struct IAudioProcessingObject *a3)
{
  ...
  else
  {
    ...
    if ( v4 < 0 )
    {
      ...
      AudDGTraceLoggingErrorHelper("CPipeInstance::InitializeDitherInterface", 0xD74u, v4);
    }
  }
  if ( v6 )
