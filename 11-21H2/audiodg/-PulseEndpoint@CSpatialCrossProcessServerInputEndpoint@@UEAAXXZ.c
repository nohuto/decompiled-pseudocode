/*
 * XREFs of ?PulseEndpoint@CSpatialCrossProcessServerInputEndpoint@@UEAAXXZ @ 0x140095700
 * Callers:
 *     <none>
 * Callees:
        ...
        __int64 a4)
{
  ...
  if ( *((_BYTE *)this - 1336) )
  {
    ...
    if ( `PingPongState::GetEmptyBufferCount'::`2'::emptyBufferCount_[(unsigned int)PingPongState::GetState((__int64)this - 856)] )
      *((_BYTE *)v4 + 1336) = CSpatialCrossProcessServerEndpoint::SignalCompletionEvent(v4, v5);
  }
  else
  {
