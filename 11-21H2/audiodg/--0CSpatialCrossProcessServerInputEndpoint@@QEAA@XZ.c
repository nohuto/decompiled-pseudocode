/*
 * XREFs of ??0CSpatialCrossProcessServerInputEndpoint@@QEAA@XZ @ 0x14008D080
 * Callers:
 ...
 * Callees:
 *     ??0CSpatialCrossProcessServerEndpoint@@QEAA@XZ @ 0x14008CFCC (--0CSpatialCrossProcessServerEndpoint@@QEAA@XZ.c)
 */
