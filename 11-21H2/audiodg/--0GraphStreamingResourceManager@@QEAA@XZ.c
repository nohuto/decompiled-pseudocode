/*
 * XREFs of ??0GraphStreamingResourceManager@@QEAA@XZ @ 0x14000A6C8
 * Callers:
 *     ??$MakeAndInitialize@VGraphStreamingResourceManager@@V1@$$V@Details@WRL@Microsoft@@YAJPEAPEAVGraphStreamingResourceManager@@@Z @ 0x140007F94 (--$MakeAndInitialize@VGraphStreamingResourceManager@@V1@$$V@Details@WRL@Microsoft@@YAJPEAPEAVGra.c)
 * Callees:
 ...
 *     ??0HandleRegistrations@GraphStreamingResourceManager@@QEAA@XZ @ 0x140002C7C (--0HandleRegistrations@GraphStreamingResourceManager@@QEAA@XZ.c)
        ...
        GraphStreamingResourceManager *this)
{
  ...
  *((_QWORD *)this + 1) = &GraphStreamingResourceManager::`vftable'{for `Microsoft::WRL::Details::ImplementsHelper<Microsoft::WRL::RuntimeClassFlags<2>,1,IAudioStreamingResourceRegistration>'};
  ...
  GraphStreamingResourceManager::HandleRegistrations::HandleRegistrations(
    (GraphStreamingResourceManager *)((char *)this + 64),
    v2);
  GraphStreamingResourceManager::HandleRegistrations::HandleRegistrations(
    (GraphStreamingResourceManager *)((char *)this + 136),
    v3);
  *((_QWORD *)this + 26) = 0LL;
  *((_QWORD *)this + 27) = 0LL;
  *((_DWORD *)this + 56) = 17;
