/*
 * XREFs of ?FormatTagFromWfx@@YAGPEBUtWAVEFORMATEX@@@Z @ 0x1400312F0
 * Callers:
 *     ?ValidateWaveFormat@@YAHPEBUtWAVEFORMATEX@@@Z @ 0x1400319A4 (-ValidateWaveFormat@@YAHPEBUtWAVEFORMATEX@@@Z.c)
 * Callees:
 *     <none>
 */
