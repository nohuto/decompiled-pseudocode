/*
 * XREFs of ?Reallocate@CAtlStringMgr@ATL@@UEAAPEAUCStringData@2@PEAU32@HH@Z @ 0x14006DD60
 * Callers:
 *     <none>
 * Callees:
        ...
        unsigned int a4)
{
  ...
  if ( v8 > 0xFFFFFFE7 )
    return 0LL;
  result = (struct ATL::CStringData *)(*(__int64 (__fastcall **)(_QWORD, __int64, _QWORD))(**(_QWORD **)(v5 + 8) + 16LL))(
                                        *(_QWORD *)(v5 + 8),
                                        v6,
                                        v8 + 24);
  if ( !result )
