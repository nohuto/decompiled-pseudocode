/*
 * XREFs of ?GetResults@SendCommandAsyncOperation@Devices@Media@Windows@@UEAAJPEAPEAUIModuleCommandResult@234@@Z @ 0x140078D60
 * Callers:
 *     <none>
 * Callees:
        ...
        struct Windows::Media::Devices::IModuleCommandResult **a2)
{
  ...
  *a2 = 0LL;
  ...
  if ( (Status & 0x80000000) == 0 )
  {
    ...
    {
      case 1:
        v6 = (struct Windows::Media::Devices::IModuleCommandResult *)*((_QWORD *)this + 21);
        if ( v6 )
        {
          *a2 = v6;
