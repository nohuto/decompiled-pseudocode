/*
 * XREFs of ?GetMute@CSystemAudioDeviceOffloadGraph@@UEAAJPEAE@Z @ 0x140058380
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall CSystemAudioDeviceOffloadGraph::GetMute(CSystemAudioDeviceOffloadGraph *this, unsigned __int8 *a2)
{
  ...
  if ( v4 < 0 )
  {
    ...
    {
      WPP_SF_d(*((_QWORD *)WPP_GLOBAL_Control + 2), 0xEu, (__int64)&WPP_6a6aaf124706356e0ec6025c89b7f8a8_Traceguids, v4);
    }
