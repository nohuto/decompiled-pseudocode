/*
 * XREFs of ?create@shared_buffer@details@wil@@QEAA_NPEBX_K@Z @ 0x14004F4C4
 * Callers:
 ...
 * Callees:
 *     ?assign@shared_buffer@details@wil@@AEAAXPEAJ_K@Z @ 0x14004F480 (-assign@shared_buffer@details@wil@@AEAAXPEAJ_K@Z.c)
