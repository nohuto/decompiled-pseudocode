/*
 * XREFs of ?QueryService@CAPOServiceProvider@@UEAAJAEBU_GUID@@0PEAPEAX@Z @ 0x140018AC0
 * Callers:
 *     <none>
 * Callees:
...
LABEL_10:
    ...
    v9 = *(_QWORD *)&a3->Data1 - *(_QWORD *)&GUID_acd65e2f_955b_4b57_b9bf_ac297bb752c9.Data1;
    if ( *(_QWORD *)&a3->Data1 == *(_QWORD *)&GUID_acd65e2f_955b_4b57_b9bf_ac297bb752c9.Data1 )
      v9 = *(_QWORD *)a3->Data4 - *(_QWORD *)GUID_acd65e2f_955b_4b57_b9bf_ac297bb752c9.Data4;
    if ( v9 )
    {
      v6 = 30LL;
      goto LABEL_9;
    }
    v7 = Microsoft::WRL::Details::RuntimeClassBaseT<2>::AsIID<Microsoft::WRL::Details::RuntimeClassImpl<Microsoft::WRL::RuntimeClassFlags<2>,1,0,0,IServiceProvider,IAudioProcessingObjectLoggingService,IAudioProcessingObjectRTQueueService>>(
           (__int64)this,
           a3,
           a4);
    if ( v7 < 0 )
  ...
  {
    v10 = *(_QWORD *)&a3->Data1 - *(_QWORD *)&GUID_698f0107_1745_4708_95a5_d84478a62a65.Data1;
    if ( *(_QWORD *)&a3->Data1 == *(_QWORD *)&GUID_698f0107_1745_4708_95a5_d84478a62a65.Data1 )
      v10 = *(_QWORD *)a3->Data4 - *(_QWORD *)GUID_698f0107_1745_4708_95a5_d84478a62a65.Data4;
    if ( v10 )
    {
      v6 = 25LL;
      goto LABEL_9;
