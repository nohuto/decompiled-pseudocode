/*
 * XREFs of ??0CSpatialCrossProcessBaseEndpoint@@IEAA@XZ @ 0x14008CC6C
 * Callers:
 *     ??0CSpatialCrossProcessClientEndpoint@@QEAA@XZ @ 0x14008CE98 (--0CSpatialCrossProcessClientEndpoint@@QEAA@XZ.c)
