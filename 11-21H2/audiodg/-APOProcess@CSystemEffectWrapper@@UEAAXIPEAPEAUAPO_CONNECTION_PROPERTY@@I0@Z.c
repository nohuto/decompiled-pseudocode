/*
 * XREFs of ?APOProcess@CSystemEffectWrapper@@UEAAXIPEAPEAUAPO_CONNECTION_PROPERTY@@I0@Z @ 0x140022D20
 * Callers:
 *     <none>
 * Callees:
...
{
  (*(void (__fastcall **)(_QWORD, _QWORD, struct APO_CONNECTION_PROPERTY **))(**((_QWORD **)this + 18) + 24LL))(
    *((_QWORD *)this + 18),
    a2,
    a3);
}
