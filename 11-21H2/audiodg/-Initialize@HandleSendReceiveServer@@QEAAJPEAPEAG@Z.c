/*
 * XREFs of ?Initialize@HandleSendReceiveServer@@QEAAJPEAPEAG@Z @ 0x140028714
 * Callers:
 ...
 *     ?SecurityCreateSecurityDescriptor@HandleSendReceiveServer@@AEAAJPEAPEAX@Z @ 0x140028924 (-SecurityCreateSecurityDescriptor@HandleSendReceiveServer@@AEAAJPEAPEAX@Z.c)
...
__int64 __fastcall HandleSendReceiveServer::Initialize(HandleSendReceiveServer *this, unsigned __int16 **a2)
{
  ...
  __int64 Seed; // [rsp+30h] [rbp-A9h] BYREF
  int v23; // [rsp+38h] [rbp-A1h]
  unsigned __int16 **v24; // [rsp+40h] [rbp-99h]
  HLOCAL hMem; // [rsp+48h] [rbp-91h] BYREF
  HandleSendReceiveServer *v26; // [rsp+50h] [rbp-89h]
  int v27; // [rsp+58h] [rbp-81h] BYREF
  __int64 v28; // [rsp+60h] [rbp-79h]
  _UNICODE_STRING *p_DestinationString; // [rsp+68h] [rbp-71h]
  int v30; // [rsp+70h] [rbp-69h]
  HLOCAL v31; // [rsp+78h] [rbp-61h]
  __int64 v32; // [rsp+80h] [rbp-59h]
  char *v33; // [rsp+88h] [rbp-51h]
  _UNICODE_STRING DestinationString; // [rsp+90h] [rbp-49h] BYREF
  _BYTE v35[16]; // [rsp+A0h] [rbp-39h] BYREF
...
LABEL_30:
  ...
  if ( v9 < 0 )
    goto LABEL_35;
  Thread = (char *)CreateThread(0LL, 0LL, HandleSendReceiveServer::AeServerApiProc, v2, 0, 0LL);
  *((_QWORD *)v2 + 6) = Thread;
