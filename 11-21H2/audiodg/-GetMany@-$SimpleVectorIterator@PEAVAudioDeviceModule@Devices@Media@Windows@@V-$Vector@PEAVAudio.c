  ...
  *v17 = 0;
  ...
  if ( v4 >= 0 )
  {
    ...
    if ( v6 )
    {
      while ( 1 )
      {
        v4 = _lambda_2083f91e0d512bb3c6e05bd8cdd88fcf_::operator()((__int64)v12, v7, &v13);
        if ( v4 < 0 )
          break;
    ...
    {
      v4 = _lambda_2083f91e0d512bb3c6e05bd8cdd88fcf_::operator()((__int64)v12, v7, (_DWORD *)(a1 + 40));
    }
