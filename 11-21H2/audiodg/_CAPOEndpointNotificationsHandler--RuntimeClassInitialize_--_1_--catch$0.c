/*
 * XREFs of _CAPOEndpointNotificationsHandler::RuntimeClassInitialize_::_1_::catch$0 @ 0x14006A238
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall CAPOEndpointNotificationsHandler::RuntimeClassInitialize_::_1_::catch_0(
        __int64 a1,
        __int64 a2,
        __int64 a3,
        const char *a4)
