/*
 * XREFs of ?reset@?$com_ptr_t@UIAudioProcessRT@@Uerr_returncode_policy@wil@@@wil@@QEAAXXZ @ 0x14002D0C0
 * Callers:
...
__int64 __fastcall wil::com_ptr_t<IAudioProcessRT,wil::err_returncode_policy>::reset(__int64 *a1)
{
  __int64 v1; // rdx
  __int64 result; // rax
