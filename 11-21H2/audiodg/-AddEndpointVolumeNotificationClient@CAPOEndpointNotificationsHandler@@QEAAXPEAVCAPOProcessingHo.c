/*
 * XREFs of ?AddEndpointVolumeNotificationClient@CAPOEndpointNotificationsHandler@@QEAAXPEAVCAPOProcessingHostObject@@@Z @ 0x1400696E8
 * Callers:
...
void __fastcall CAPOEndpointNotificationsHandler::AddEndpointVolumeNotificationClient(
        ...
        struct CAPOProcessingHostObject *a2)
{
  ...
  v10 = v4;
  for ( i = (__int64 **)*((_QWORD *)this + 23); i; i = (__int64 **)*i )
  {
    if ( i[1] == (__int64 *)a2 )
    {
  ...
  try
  {
    v6 = CAPOEndpointNotificationsHandler::RegisterControlChangeNotify(this);
    if ( v6 < 0 )
