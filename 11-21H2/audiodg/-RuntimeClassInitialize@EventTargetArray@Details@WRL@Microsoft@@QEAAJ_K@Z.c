/*
 * XREFs of ?RuntimeClassInitialize@EventTargetArray@Details@WRL@Microsoft@@QEAAJ_K@Z @ 0x140015680
 * Callers:
  ...
  if ( v7 )
  {
    *v7 = a2;
    ...
    `eh vector constructor iterator'(
      ...
      8uLL,
      a2,
      ATL::CComPtr<IAudioProcessingObjectNotifications>::CComPtr<IAudioProcessingObjectNotifications>,
