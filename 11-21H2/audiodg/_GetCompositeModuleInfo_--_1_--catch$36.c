/*
 * XREFs of _GetCompositeModuleInfo_::_1_::catch$36 @ 0x140039C21
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall GetCompositeModuleInfo_::_1_::catch_36(__int64 a1, __int64 a2, __int64 a3, const char *a4)
{
