/*
 * XREFs of ?InitializeLimiterInterface@CPipeInstance@@AEAAJPEAVCProcessNode@@PEAUIAudioProcessingObject@@@Z @ 0x140016828
 * Callers:
        ...
        struct IAudioProcessingObject *a3)
{
         ...
         &v9) >= 0 )
  {
          ...
          v6 < 0) )
    {
      ...
      AudDGTraceLoggingErrorHelper("CPipeInstance::InitializeLimiterInterface", 0xEF0u, v6);
    }
  }
  else
  {
