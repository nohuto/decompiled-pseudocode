/*
 * XREFs of _ATL::CAtlArray_APO_CONNECTION_DESCRIPTOR___ATL::CElementTraits_APO_CONNECTION_DESCRIPTOR_____::InsertAt_::_1_::catch$0 @ 0x140037710
 * Callers:
 *     <none>
 * Callees:
        ...
        _QWORD *a2)
{
  ...
  ATL::CElementTraitsBase<APO_CONNECTION_DESCRIPTOR *>::RelocateElements(
    ...
    *v3 + 8 * (a2[11] + 1LL),
    a2[13] - a2[11]);
  ATL::CAtlArray<APO_CONNECTION_DESCRIPTOR *,ATL::CElementTraits<APO_CONNECTION_DESCRIPTOR *>>::SetCount(v3, a2[13]);
  throw;
}
