/*
 * XREFs of ?Empty@?$CSimpleStringT@G$0A@@ATL@@QEAAXXZ @ 0x140054684
 * Callers:
 ...
 *     ?SetLength@?$CSimpleStringT@G$0A@@ATL@@AEAAXH@Z @ 0x14002D114 (-SetLength@-$CSimpleStringT@G$0A@@ATL@@AEAAXH@Z.c)
