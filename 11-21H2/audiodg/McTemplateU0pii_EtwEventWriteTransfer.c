/*
 * XREFs of McTemplateU0pii_EtwEventWriteTransfer @ 0x14006BC44
 * Callers:
...
__int64 McTemplateU0pii_EtwEventWriteTransfer(__int64 a1, __int64 a2, ...)
{
  ...
  v9 = 8LL;
  va_copy(v8, va2);
  return McGenEventWrite_EtwEventWriteTransfer(a1, (__int64)&AudioCore_Pump_ProcPassDuration, v11, 4, (__int64)v3);
}
