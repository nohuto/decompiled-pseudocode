/*
 * XREFs of ?Create@CAudioMediaType@@SAJPEBUtWAVEFORMATEX@@IPEAPEAUIAudioMediaType@@MH@Z @ 0x140031214
 * Callers:
 ...
 *     ??1CAudioMediaType@@MEAA@XZ @ 0x140031190 (--1CAudioMediaType@@MEAA@XZ.c)
 *     ?QueryInterface@CAudioMediaType@@UEAAJAEBU_GUID@@PEAPEAX@Z @ 0x1400317A0 (-QueryInterface@CAudioMediaType@@UEAAJAEBU_GUID@@PEAPEAX@Z.c)
