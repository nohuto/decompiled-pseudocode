/*
 * XREFs of ?Acquire@?$ProcessLocalStorageData@VFeatureStateData@details_abi@wil@@@details_abi@wil@@SAJPEBDPEAPEAV123@@Z @ 0x140074C98
 * Callers:
        ...
        void **a2)
{
  ...
  wil::details *v21[2]; // [rsp+40h] [rbp-C0h] BYREF
