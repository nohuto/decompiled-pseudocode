/*
 * XREFs of ?ReleaseInputDataPointer@CSpatialCrossProcessServerInputEndpoint@@UEAAXI_K@Z @ 0x140095770
 * Callers:
 *     <none>
 * Callees:
 ...
 *     ?CheckGlitches@CSpatialCrossProcessBaseEndpoint@@IEAAXXZ @ 0x14009101C (-CheckGlitches@CSpatialCrossProcessBaseEndpoint@@IEAAXXZ.c)
