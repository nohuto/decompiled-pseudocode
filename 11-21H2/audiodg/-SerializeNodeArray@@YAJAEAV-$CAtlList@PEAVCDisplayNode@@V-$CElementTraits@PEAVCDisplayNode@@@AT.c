/*
 * XREFs of ?SerializeNodeArray@@YAJAEAV?$CAtlList@PEAVCDisplayNode@@V?$CElementTraits@PEAVCDisplayNode@@@ATL@@@ATL@@AEAPEAEAEAI@Z @ 0x14005F314
 * Callers:
...
__int64 __fastcall SerializeNodeArray(__int64 a1, __int64 *a2, unsigned int *a3)
{
  ...
  *a3 = v3 + 4;
  ...
  LODWORD(v16) = v8;
  if ( memcpy_s_0(v9, (unsigned int)(4096 - (v3 + 4)), &v16, 4uLL) )
  {
