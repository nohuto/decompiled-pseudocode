/*
 * XREFs of ?NewNode@?$CAtlList@PEAVCStreamInstance@@V?$CElementTraits@PEAVCStreamInstance@@@ATL@@@ATL@@AEAAPEAVCNode@12@AEBQEAVCStreamInstance@@PEAV312@1@Z @ 0x140029A20
 * Callers:
...
__int64 *__fastcall ATL::CAtlList<CStreamInstance *,ATL::CElementTraits<CStreamInstance *>>::NewNode(
        __int64 a1,
        __int64 *a2,
        __int64 a3,
        __int64 a4)
