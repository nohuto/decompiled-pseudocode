        ...
        __int64 *a3)
{
  ...
  if ( a2 )
  {
    ...
    while ( 1 )
    {
      v15 = XWinRT::InterfaceLifetimeTraits::Construct<Windows::Media::Devices::Internal::IAudioDeviceBrokerDevice>(
              &v6[v8],
              *a3);
      v7 = v15;
      if ( v15 < 0 )
...
LABEL_9:
  ...
  if ( v6 )
  {
    if ( (_DWORD)v8 )
    {
      ...
      do
      {
        XWinRT::InterfaceLifetimeTraits::Destroy<Windows::Media::Devices::Internal::IAudioDeviceBrokerDevice>(v12++);
        --v8;
      }
      while ( v8 );
    }
