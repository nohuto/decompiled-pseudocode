/*
 * XREFs of ?NewNode@?$CAtlList@PEAVCPipeInstance@@V?$CElementTraits@PEAVCPipeInstance@@@ATL@@@ATL@@AEAAPEAVCNode@12@AEBQEAVCPipeInstance@@PEAV312@1@Z @ 0x14002994C
 * Callers:
...
__int64 *__fastcall ATL::CAtlList<CPipeInstance *,ATL::CElementTraits<CPipeInstance *>>::NewNode(
        __int64 a1,
        __int64 *a2,
        __int64 a3,
        __int64 a4)
