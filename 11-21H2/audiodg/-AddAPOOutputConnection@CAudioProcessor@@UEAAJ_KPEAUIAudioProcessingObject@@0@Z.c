/*
 * XREFs of ?AddAPOOutputConnection@CAudioProcessor@@UEAAJ_KPEAUIAudioProcessingObject@@0@Z @ 0x14000E820
 * Callers:
 *     <none>
 * Callees:
...
LABEL_94:
  ...
  {
LABEL_24:
    v22 = CAudioProcessor::ValidateConnection(v57, v17, v21, (_DWORD)pv, v57 + 128);
    v23 = v22;
    if ( v22 < 0 )
    {
      wil::details::in1diag3::Return_Hr(
    ...
    {
LABEL_32:
      *(_QWORD *)(*(_QWORD *)(v24 + 160) + 8 * v25) = v17;
      ++*(_QWORD *)(v24 + 168);
      v61 = v25;
      *(_QWORD *)&p_pv = &v57;
      *((_QWORD *)&p_pv + 1) = &v61;
...
LABEL_38:
          *(_QWORD *)(v30 + 304) = v34;
LABEL_39:
          *(_QWORD *)(*(_QWORD *)(v30 + 288) + 8 * v31) = *(_QWORD *)(v17 + 104);
          ++*(_QWORD *)(v30 + 296);
          v64 = v31;
          *(_QWORD *)&p_pv = &v57;
          *((_QWORD *)&p_pv + 1) = &v64;
          ...
          *(_QWORD *)(v17 + 152) = this;
          ...
          wil::details::in1diag3::Return_Hr(
            ...
            v52);
          ATL::CAtlArray<CConnectionNode *,CConnectionNodeTraits>::RemoveAt(v57 + 288, v64);
          ATL::CAtlArray<CConnectionNode *,CConnectionNodeTraits>::RemoveAt(v57 + 160, v61);
          if ( v54 )
          {
            LeaveCriticalSection(v54);
            v54 = 0LL;
...
LABEL_31:
  ...
  while ( *(_QWORD *)(*(_QWORD *)(v57 + 160) + 8 * v21) != v17 )
  {
    if ( ++v21 >= v20 )
      goto LABEL_24;
  }
