/*
 * XREFs of ?GetFramesPerPacket@CCrossProcessBaseEndpoint@@UEAAJPEAI@Z @ 0x140088830
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall CCrossProcessBaseEndpoint::GetFramesPerPacket(CCrossProcessBaseEndpoint *this, unsigned int *a2)
{
  ...
  AudCPTraceLoggingErrorHelper("CCrossProcessBaseEndpoint::GetFramesPerPacket", 0x20Au, v2);
  return v2;
}
