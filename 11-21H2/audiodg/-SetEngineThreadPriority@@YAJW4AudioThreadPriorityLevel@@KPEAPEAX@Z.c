/*
 * XREFs of ?SetEngineThreadPriority@@YAJW4AudioThreadPriorityLevel@@KPEAPEAX@Z @ 0x140028DFC
 * Callers:
...
__int64 __fastcall SetEngineThreadPriority(__int64 a1, DWORD a2, _QWORD *a3)
{
  ...
  {
    v9 = ResetEngineThreadPriority(&v17);
    if ( v9 < 0 )
    {
      v10 = 2220LL;
LABEL_11:
