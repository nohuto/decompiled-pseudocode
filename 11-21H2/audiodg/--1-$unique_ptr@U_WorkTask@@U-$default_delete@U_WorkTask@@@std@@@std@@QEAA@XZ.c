/*
 * XREFs of ??1?$unique_ptr@U_WorkTask@@U?$default_delete@U_WorkTask@@@std@@@std@@QEAA@XZ @ 0x140067B98
 * Callers:
 *     _CSerialWorkQueue::QueueWorkItem_::_1_::dtor$2 @ 0x1400683D2 (_CSerialWorkQueue--QueueWorkItem_--_1_--dtor$2.c)
 * Callees:
