/*
 * XREFs of ?GetCurrentPadding@CCrossProcessBaseClientEndpoint@@UEAAJPEAI@Z @ 0x140088460
 * Callers:
 *     <none>
 * Callees:
        ...
        unsigned int *a2)
{
  ...
  AudCPTraceLoggingErrorHelper("CCrossProcessBaseClientEndpoint::GetCurrentPadding", 0x4BCu, v2);
  return v2;
}
