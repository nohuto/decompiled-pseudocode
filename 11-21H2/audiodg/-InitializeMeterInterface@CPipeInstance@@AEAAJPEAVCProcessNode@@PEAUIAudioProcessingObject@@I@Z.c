/*
 * XREFs of ?InitializeMeterInterface@CPipeInstance@@AEAAJPEAVCProcessNode@@PEAUIAudioProcessingObject@@I@Z @ 0x140016F20
 * Callers:
...
LABEL_13:
      ...
      AudDGTraceLoggingErrorHelper("CPipeInstance::InitializeMeterInterface", 0xD3Du, v7);
    }
  }
  else
  {
