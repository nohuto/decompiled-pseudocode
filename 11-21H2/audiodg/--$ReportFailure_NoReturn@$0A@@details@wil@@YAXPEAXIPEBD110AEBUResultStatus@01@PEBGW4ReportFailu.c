/*
 * XREFs of ??$ReportFailure_NoReturn@$0A@@details@wil@@YAXPEAXIPEBD110AEBUResultStatus@01@PEBGW4ReportFailureOptions@01@@Z @ 0x140054C00
 * Callers:
 ...
 *     ?ThrowResultException@wil@@YAXAEBUFailureInfo@1@@Z @ 0x14004F250 (-ThrowResultException@wil@@YAXAEBUFailureInfo@1@@Z.c)
