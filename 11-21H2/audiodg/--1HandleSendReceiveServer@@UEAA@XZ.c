/*
 * XREFs of ??1HandleSendReceiveServer@@UEAA@XZ @ 0x140028698
 * Callers:
 *     ??_EHandleSendReceiveServer@@UEAAPEAXI@Z @ 0x140028660 (--_EHandleSendReceiveServer@@UEAAPEAXI@Z.c)
 * Callees:
 *     ?SendStopListeningMessage@HandleSendReceiveServer@@AEAAJXZ @ 0x14006EA50 (-SendStopListeningMessage@HandleSendReceiveServer@@AEAAJXZ.c)
 */
