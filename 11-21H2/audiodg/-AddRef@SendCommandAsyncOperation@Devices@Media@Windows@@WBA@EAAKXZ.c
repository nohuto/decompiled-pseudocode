/*
 * XREFs of ?AddRef@SendCommandAsyncOperation@Devices@Media@Windows@@WBA@EAAKXZ @ 0x140034410
 * Callers:
 *     <none>
 * Callees:
 *     <none>
...
__int64 __fastcall Windows::Media::Devices::SendCommandAsyncOperation::AddRef(__int64 a1)
{
