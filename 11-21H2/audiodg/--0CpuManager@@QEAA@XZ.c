/*
 * XREFs of ??0CpuManager@@QEAA@XZ @ 0x140002BD8
 * Callers:
...
CpuManager *__fastcall CpuManager::CpuManager(CpuManager *this)
{
  ...
  *(_QWORD *)this = &CpuManager::`vftable';
  ...
  GraphStreamingResourceManager::HandleRegistrations::HandleRegistrations((CpuManager *)((char *)this + 56));
  GraphStreamingResourceManager::HandleRegistrations::HandleRegistrations((CpuManager *)((char *)this + 128));
  *((_QWORD *)this + 25) = 0LL;
  *((_QWORD *)this + 26) = 0LL;
  *((_DWORD *)this + 54) = 17;
