/*
 * XREFs of ?BubbleInputFramesToOutput@CAudioProcessor@@AEAAXPEBV?$CAtlList@PEAVCAPONode@@VCAPONodeTraits@@@ATL@@@Z @ 0x140081A70
 * Callers:
 ...
 *     ??A?$CAtlArray@PEAUAPO_CONNECTION_PROPERTY_V_INTERNAL@@V?$CElementTraits@PEAUAPO_CONNECTION_PROPERTY_V_INTERNAL@@@ATL@@@ATL@@QEAAAEAPEAUAPO_CONNECTION_PROPERTY_V_INTERNAL@@_K@Z @ 0x1400819E4 (--A-$CAtlArray@PEAUAPO_CONNECTION_PROPERTY_V_INTERNAL@@V-$CElementTraits@PEAUAPO_CONNECTION_PROP.c)
 *     ?GetNext@?$CAtlList@PEAVCAPONode@@VCAPONodeTraits@@@ATL@@QEBAAEBQEAVCAPONode@@AEAPEAU__POSITION@@@Z @ 0x1400820B4 (-GetNext@-$CAtlList@PEAVCAPONode@@VCAPONodeTraits@@@ATL@@QEBAAEBQEAVCAPONode@@AEAPEAU__POSITION@.c)
 */
