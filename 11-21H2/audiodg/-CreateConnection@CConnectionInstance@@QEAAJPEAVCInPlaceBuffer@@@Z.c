/*
 * XREFs of ?CreateConnection@CConnectionInstance@@QEAAJPEAVCInPlaceBuffer@@@Z @ 0x140016088
 * Callers:
...
LABEL_7:
  ...
  if ( v6 < 0 )
  {
    ...
    AudDGTraceLoggingErrorHelper("CConnectionInstance::CreateConnection", 0x63u, v6);
  }
