/*
 * XREFs of McTemplateU0pi_EtwEventWriteTransfer @ 0x14006BBCC
 * Callers:
...
__int64 McTemplateU0pi_EtwEventWriteTransfer(__int64 a1, __int64 a2, ...)
{
  ...
  v8 = 0;
  v7 = 8;
  return McGenEventWrite_EtwEventWriteTransfer(8LL, (__int64)&AudioCore_Pump_ProcPassSkip, v10, 3, (__int64)v3);
}
