/*
 * XREFs of ?NonRTCancelSafePointer@?$CRealTimeSafeStruct@VCProcessingData@@$00@@QEAAXXZ @ 0x140082358
 * Callers:
...
void __fastcall CRealTimeSafeStruct<CProcessingData,1>::NonRTCancelSafePointer(__int64 a1)
{
  ...
  try
  {
    ...
    *(_BYTE *)(a1 + 376) = 1;
    ...
    v20 = 10;
    v3 = 0;
    CProcessingData::operator=((void *)(a1 + 144 * (*(unsigned __int16 *)(a1 + 328) ^ 1LL)), (__int64)&v6);
  }
