/*
 * XREFs of ?InitializeSecurity@CAudioDGModule@@AEAAJKKK@Z @ 0x140001B2C
 * Callers:
...
__int64 __fastcall CAudioDGModule::InitializeSecurity(CAudioDGModule *this)
{
         ...
         &SecurityDescriptorSize) )
  {
           ...
           &dwPrimaryGroupSize) )
    {
      ...
      {
        WPP_SF_D(*((_QWORD *)WPP_GLOBAL_Control + 2), 20LL, &WPP_7648ed4640253b865e503c6e3d6ace76_Traceguids, 12320LL);
      }
      ...
      WPP_SF_D(v13[2], v14, &WPP_7648ed4640253b865e503c6e3d6ace76_Traceguids, (unsigned int)v7);
      goto LABEL_31;
    }
  }
  LastError = GetLastError();
      ...
      && *((_BYTE *)WPP_GLOBAL_Control + 25) >= 2u )
    {
      WPP_SF_d(
        *((_QWORD *)WPP_GLOBAL_Control + 2),
        23LL,
        &WPP_7648ed4640253b865e503c6e3d6ace76_Traceguids,
        (unsigned int)v7);
    }
