/*
 * XREFs of ?GetInputDataPointer@CSpatialCrossProcessServerInputEndpoint@@UEAAXPEAUAPO_CONNECTION_PROPERTY@@PEAUAE_CURRENT_POSITION@@@Z @ 0x1400952F0
 * Callers:
 *     <none>
 * Callees:
        ...
        struct AE_CURRENT_POSITION *a3)
{
  ...
  v8 = u32ValidFrameCount * *((_WORD *)this - 560);
  *((_BYTE *)this + 73) = (v7 & 0x10) != 0;
  (*(void (__fastcall **)(char *, struct AE_CURRENT_POSITION *, _QWORD))(*((_QWORD *)this - 179) + 80LL))(
    (char *)this - 1432,
    a3,
    u32ValidFrameCount);
  if ( u32ValidFrameCount )
  {
    if ( CSpatialCrossProcessBaseEndpoint::IsRunning((CSpatialCrossProcessServerInputEndpoint *)((char *)this - 1432)) )
    {
      *((_DWORD *)this + 20) = 2;
      ...
      ObjectsAvailableForProcessing = CSpatialCrossProcessBaseEndpoint::GetObjectsAvailableForProcessing(
                                        (CSpatialCrossProcessServerInputEndpoint *)((char *)this - 1432),
  ...
  if ( (byte_1400C1841 & 4) != 0 )
    McTemplateU0pqxxx_EventWriteTransfer(v10, v9, (__int64)this - 1432, 23, 0, u32ValidFrameCount, 101);
  a2->u32BufferFlags = BUFFER_SILENT;
  *((_DWORD *)this + 19) = 0;
LABEL_17:
  a2->pBuffer = *((_QWORD *)this - 166);
  if ( (byte_1400C1841 & 4) != 0 )
    McTemplateU0pqxxx_EventWriteTransfer(v10, v9, (__int64)this - 1432, 6, v8, v8, 0);
}
