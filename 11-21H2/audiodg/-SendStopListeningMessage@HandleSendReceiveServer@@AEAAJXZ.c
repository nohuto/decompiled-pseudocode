/*
 * XREFs of ?SendStopListeningMessage@HandleSendReceiveServer@@AEAAJXZ @ 0x14006EA50
 * Callers:
 *     ??1HandleSendReceiveServer@@UEAA@XZ @ 0x140028698 (--1HandleSendReceiveServer@@UEAA@XZ.c)
 * Callees:
 *     <none>
 */
