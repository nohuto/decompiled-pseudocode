/*
 * XREFs of ?ActivateEndpoint@CSystemAudioDeviceBase@@IEAAJPEAUAUDIO_DEVICE_PIPE_DESCRIPTOR@@@Z @ 0x140053D84
 * Callers:
...
LABEL_10:
          ...
          *(_OWORD *)(v10 + 28) = *(_OWORD *)((char *)a2 + 152);
      ...
      && *((_BYTE *)WPP_GLOBAL_Control + 25) >= 2u )
    {
      WPP_SF_Ds(
        *((_QWORD *)WPP_GLOBAL_Control + 2),
        14,
        (unsigned int)&WPP_3846f10c19233d8d066b6da0bd90496d_Traceguids,
        v5,
