/*
 * XREFs of ?CheckGlitches@CSpatialCrossProcessBaseEndpoint@@IEAAXXZ @ 0x14009101C
 * Callers:
        ...
        __int64 a4)
{
  ...
  v6 = v5 != 0;
  v7 = _InterlockedExchange((volatile __int32 *)(*((_QWORD *)this + 162) + 72LL), 0) != 0;
  if ( (v5 || v7)
    && (unsigned int)dword_1400C00E8 > 5
    && (byte_1400C00F8 & 1) != 0
    && (qword_1400C0100 & 1) == qword_1400C0100 )
  {
    v8 = v7;
    v9 = v5 != 0;
