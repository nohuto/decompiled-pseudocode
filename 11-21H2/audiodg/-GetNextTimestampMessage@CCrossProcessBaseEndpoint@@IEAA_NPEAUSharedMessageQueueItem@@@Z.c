/*
 * XREFs of ?GetNextTimestampMessage@CCrossProcessBaseEndpoint@@IEAA_NPEAUSharedMessageQueueItem@@@Z @ 0x140088940
 * Callers:
        ...
        struct SharedMessageQueueItem *a2)
{
  ...
  if ( v21 != v17 )
  {
    ...
    {
      AudCPTraceLoggingErrorHelper("CCrossProcessBaseEndpoint::GetNextTimestampMessage", 0x591u, -2147467259);
    }
  }
  return v3;
}
