/*
 * XREFs of ?GetVolumeCoefficients@CSystemAudioDeviceOffloadGraph@@UEAAJIPEAM@Z @ 0x140058560
 * Callers:
 *     <none>
 * Callees:
        ...
        float *a3)
{
  ...
  if ( v6 < 0 )
  {
    ...
    {
      WPP_SF_d(*((_QWORD *)WPP_GLOBAL_Control + 2), 0xBu, (__int64)&WPP_6a6aaf124706356e0ec6025c89b7f8a8_Traceguids, v6);
    }
