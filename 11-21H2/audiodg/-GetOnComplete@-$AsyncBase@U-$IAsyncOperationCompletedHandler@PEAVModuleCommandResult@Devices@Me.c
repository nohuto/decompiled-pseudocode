        ...
        _QWORD *a2)
{
  ...
  *a2 = 0LL;
  ...
  if ( v4 >= 0 )
  {
    Microsoft::WRL::ComPtr<Windows::Foundation::IAsyncOperationCompletedHandler<Windows::Media::Devices::ModuleCommandResult *>>::InternalAddRef((__int64 *)(a1 + 24));
    *a2 = *(_QWORD *)(a1 + 24);
  }
