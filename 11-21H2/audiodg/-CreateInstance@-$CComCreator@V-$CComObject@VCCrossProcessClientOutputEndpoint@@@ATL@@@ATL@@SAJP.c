/*
 * XREFs of ?CreateInstance@?$CComCreator@V?$CComObject@VCCrossProcessClientOutputEndpoint@@@ATL@@@ATL@@SAJPEAXAEBU_GUID@@PEAPEAX@Z @ 0x140084DF0
 * Callers:
        ...
        _QWORD *a3)
{
  ...
  *a3 = 0LL;
  ...
  try
  {
    v9 = (CCrossProcessClientOutputEndpoint *)AERTAllocate(0x230uLL, v7, v8);
    if ( v9 )
