/*
 * XREFs of ??_GAudioProcessingObjectTelemetryProvider@@UEAAPEAXI@Z @ 0x140050BF0
 * Callers:
 *     <none>
 * Callees:
 *     ??3@YAXPEAX_K@Z @ 0x14002FC18 (--3@YAXPEAX_K@Z.c)
 *     ??1TraceLoggingProvider@wil@@MEAA@XZ @ 0x140050B58 (--1TraceLoggingProvider@wil@@MEAA@XZ.c)
 */
