/*
 * XREFs of ?IsLeftFormatSupported@CAPOProcessNode@@UEAAJPEAUIAudioMediaType@@PEAPEAU2@0@Z @ 0x140028510
 * Callers:
 *     <none>
 * Callees:
        ...
        struct IAudioMediaType *a4)
{
  ...
  if ( v6 < 0 )
  {
    ...
    AudDGTraceLoggingErrorHelper("CAPOProcessNode::IsLeftFormatSupported", 0x28Fu, v7);
  }
  return v7;
}
