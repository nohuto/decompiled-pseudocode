/*
 * XREFs of ?RecordWnfUsageIndex@details_abi@wil@@YAXPEBU__WIL__WNF_STATE_NAME@@_KAEBVRawUsageIndex@12@@Z @ 0x14007D15C
 * Callers:
 ...
 *     ?NtStatusToHr@details@wil@@YAJJ@Z @ 0x14007B930 (-NtStatusToHr@details@wil@@YAJJ@Z.c)
