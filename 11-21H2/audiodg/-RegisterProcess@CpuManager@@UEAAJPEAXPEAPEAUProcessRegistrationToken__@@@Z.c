/*
 * XREFs of ?RegisterProcess@CpuManager@@UEAAJPEAXPEAPEAUProcessRegistrationToken__@@@Z @ 0x140053180
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall CpuManager::RegisterProcess(CpuManager *this, void *a2, struct ProcessRegistrationToken__ **a3)
{
  ...
  v7 = (*(__int64 (__fastcall **)(CpuManager *, void *, __int64))(*(_QWORD *)v5 + 80LL))(v5, v4, v9 + 16);
  if ( v7 >= 0 )
  {
LABEL_11:
    *v3 = (struct ProcessRegistrationToken__ *)v9;
    v7 = 0;
    goto LABEL_12;
  }
LABEL_7:
