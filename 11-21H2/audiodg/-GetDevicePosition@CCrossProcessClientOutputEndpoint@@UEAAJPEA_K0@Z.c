/*
 * XREFs of ?GetDevicePosition@CCrossProcessClientOutputEndpoint@@UEAAJPEA_K0@Z @ 0x14008A580
 * Callers:
 *     <none>
 * Callees:
        ...
        __int64 a4)
{
  ...
  if ( a2 )
  {
    if ( a3 )
      *a3 = 0LL;
    _InterlockedCompareExchange((volatile signed __int32 *)(*((_QWORD *)this - 44) + 164LL), 0, 0);
    v7 = 0;
    a4 = 3LL;
    while ( 1 )
    {
      v8 = (unsigned int)_InterlockedCompareExchange((volatile signed __int32 *)(*((_QWORD *)this - 44) + 160LL), 0, 0);
      a2 = 5 * v8;
      v9 = *(_QWORD *)(*((_QWORD *)this - 44) + 40 * v8 + 32);
      v10 = *(_DWORD *)(*((_QWORD *)this - 44) + 40 * v8 + 68);
      if ( (_DWORD)v8 == _InterlockedCompareExchange((volatile signed __int32 *)(*((_QWORD *)this - 44) + 160LL), 0, 0) )
        break;
...
LABEL_12:
  ...
  if ( (byte_1400C1841 & 4) != 0 )
  {
    ...
    if ( v5 )
      v15 = *v5;
    McTemplateU0pqxxxx_EventWriteTransfer(v14, a2, (__int64)this - 424, 7, 0, v15, 0, v14);
  }
  if ( v5 )
    *((_QWORD *)this - 29) = *v5;
  if ( v7 < 0 )
    AudCPTraceLoggingErrorHelper("CCrossProcessClientOutputEndpoint::GetDevicePosition", 579, (unsigned int)v7, a4);
