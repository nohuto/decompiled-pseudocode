/*
 * XREFs of ??$MakeAndInitialize@VEventTargetArray@Details@WRL@Microsoft@@V1234@AEA_K@Details@WRL@Microsoft@@YAJPEAPEAVEventTargetArray@012@AEA_K@Z @ 0x140071B44
 * Callers:
        ...
        unsigned __int64 *a2)
{
  ...
  *a1 = 0LL;
  ...
  if ( v4 )
  {
    ...
    v11 = 0LL;
    Microsoft::WRL::ComPtr<Microsoft::WRL::Details::EventTargetArray>::Attach((__int64 *)&v11, (__int64)v6);
    v7 = *a2;
