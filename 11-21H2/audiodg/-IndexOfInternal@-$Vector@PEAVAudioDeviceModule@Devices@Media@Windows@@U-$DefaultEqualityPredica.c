/*
 * XREFs of ?IndexOfInternal@?$Vector@PEAVAudioDeviceModule@Devices@Media@Windows@@U?$DefaultEqualityPredicate@PEAVAudioDeviceModule@Devices@Media@Windows@@@Internal@Collections@Foundation@4@U?$DefaultLifetimeTraits@PEAVAudioDeviceModule@Devices@Media@Windows@@@6784@U?$DefaultVectorOptions@PEAVAudioDeviceModule@Devices@Media@Windows@@@6784@@Internal@Collections@Foundation@Windows@@AEAAJPEAPEAUIAudioDeviceModule@Devices@Media@5@IPEAU6785@PEAIPEAE@Z @ 0x14007A38C
 * Callers:
 ...
 * Callees:
 *     ??$?RUIAudioDeviceModule@Devices@Media@Windows@@@InterfaceEquals@XWinRT@@QEBAJPEAUIAudioDeviceModule@Devices@Media@Windows@@0PEA_N@Z @ 0x14006EF84 (--$-RUIAudioDeviceModule@Devices@Media@Windows@@@InterfaceEquals@XWinRT@@QEBAJPEAUIAudioDeviceMo.c)
 */
