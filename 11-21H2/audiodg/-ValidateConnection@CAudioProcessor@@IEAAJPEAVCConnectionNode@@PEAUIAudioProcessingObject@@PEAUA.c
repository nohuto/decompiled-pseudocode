/*
 * XREFs of ?ValidateConnection@CAudioProcessor@@IEAAJPEAVCConnectionNode@@PEAUIAudioProcessingObject@@PEAUAPO_REG_PROPERTIES@@PEAV?$CAtlArray@PEAVCConnectionNode@@VCConnectionNodeTraits@@@ATL@@_N@Z @ 0x140010FE0
 * Callers:
