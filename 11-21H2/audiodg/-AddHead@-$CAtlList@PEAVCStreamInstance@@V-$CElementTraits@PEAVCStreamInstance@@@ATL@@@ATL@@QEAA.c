/*
 * XREFs of ?AddHead@?$CAtlList@PEAVCStreamInstance@@V?$CElementTraits@PEAVCStreamInstance@@@ATL@@@ATL@@QEAAPEAU__POSITION@@AEBQEAVCStreamInstance@@@Z @ 0x1400299EC
 * Callers:
 ...
 * Callees:
 *     ?NewNode@?$CAtlList@PEAVCStreamInstance@@V?$CElementTraits@PEAVCStreamInstance@@@ATL@@@ATL@@AEAAPEAVCNode@12@AEBQEAVCStreamInstance@@PEAV312@1@Z @ 0x140029A20 (-NewNode@-$CAtlList@PEAVCStreamInstance@@V-$CElementTraits@PEAVCStreamInstance@@@ATL@@@ATL@@AEAA.c)
 */
        ...
        __int64 a3)
{
  ...
  result = ATL::CAtlList<CStreamInstance *,ATL::CElementTraits<CStreamInstance *>>::NewNode(a1, a2, a3, *a1);
  if ( *a1 )
    *(_QWORD *)(*a1 + 8) = result;
  else
    a1[1] = result;
