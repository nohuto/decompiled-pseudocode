/*
 * XREFs of ?RemoveAPOInputConnection@CAudioProcessor@@UEAAJ_KPEAUIAudioProcessingObject@@0@Z @ 0x14000DC90
 * Callers:
 *     <none>
 * Callees:
...
LABEL_16:
    ...
    if ( v14 )
    {
      ...
      if ( v17 )
      {
        ...
        if ( !v23
          || (v28 = memmove_s(
                      (void *const)(*(_QWORD *)(v12 + 256) + 8 * v18),
                      8 * v23,
                      (const void *const)(*(_QWORD *)(v12 + 256) + 8 * v20),
                      8 * v23)) == 0 )
        {
LABEL_28:
          --*(_QWORD *)(v12 + 264);
