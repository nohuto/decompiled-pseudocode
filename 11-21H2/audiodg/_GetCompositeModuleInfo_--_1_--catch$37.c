/*
 * XREFs of _GetCompositeModuleInfo_::_1_::catch$37 @ 0x140039C5E
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall GetCompositeModuleInfo_::_1_::catch_37(__int64 a1, __int64 a2, __int64 a3, const char *a4)
{
