/*
 * XREFs of ??$_Reallocate_for@V_lambda_05cef1f6fdf474c9f3ed207deba0f73b_@@PEBG@?$basic_string@GU?$char_traits@G@std@@V?$allocator@G@2@@std@@AEAAAEAV01@_KV_lambda_05cef1f6fdf474c9f3ed207deba0f73b_@@PEBG@Z @ 0x140026BF8
 * Callers:
        ...
        const void *a4)
{
  ...
  v12 = std::_Allocate<16,std::_Default_allocate_traits,0>(2 * v11);
  a1[3] = v4;
  a1[2] = a2;
  v13 = v12;
