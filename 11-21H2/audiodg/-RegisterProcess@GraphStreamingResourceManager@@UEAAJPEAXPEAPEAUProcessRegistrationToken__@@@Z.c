/*
 * XREFs of ?RegisterProcess@GraphStreamingResourceManager@@UEAAJPEAXPEAPEAUProcessRegistrationToken__@@@Z @ 0x140007B70
 * Callers:
 *     <none>
 * Callees:
        ...
        struct ProcessRegistrationToken__ **a3)
{
  ...
  __int64 Node; // rax
  struct ProcessRegistrationToken__ *v8; // rbx
  int v9; // edi
  char v11; // [rsp+30h] [rbp-88h] BYREF
  struct ProcessRegistrationToken__ *v12; // [rsp+38h] [rbp-80h]
  ...
  Node = ATL::CAtlMap<unsigned long,GraphStreamingResourceManager::HandleRegistrations::ListValue,ATL::CElementTraits<unsigned long>,ATL::CElementTraits<GraphStreamingResourceManager::HandleRegistrations::ListValue>>::GetNode(
           ...
           (unsigned int)&v18,
           (__int64)v15);
  v8 = (struct ProcessRegistrationToken__ *)Node;
  if ( Node )
  {
  ...
  v17 = 0LL;
  LODWORD(v16) = 1;
  v8 = (struct ProcessRegistrationToken__ *)ATL::CAtlMap<unsigned long,GraphStreamingResourceManager::HandleRegistrations::ListValue,ATL::CElementTraits<unsigned long>,ATL::CElementTraits<GraphStreamingResourceManager::HandleRegistrations::ListValue>>::SetAt(
                                              (char *)this + 56,
                                              ProcessId,
                                              &v16);
  v12 = v8;
  v9 = (*(__int64 (__fastcall **)(char *, void *, __int64))(*((_QWORD *)this - 1) + 32LL))(
         (char *)this - 8,
         a2,
         (__int64)v8 + 16);
  if ( v9 >= 0 )
