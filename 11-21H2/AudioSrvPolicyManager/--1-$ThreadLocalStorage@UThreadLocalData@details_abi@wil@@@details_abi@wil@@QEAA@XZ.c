/*
 * XREFs of ??1?$ThreadLocalStorage@UThreadLocalData@details_abi@wil@@@details_abi@wil@@QEAA@XZ @ 0x180004E5C
 * Callers:
 ...
 * Callees:
 *     ??1ThreadLocalData@details_abi@wil@@QEAA@XZ @ 0x180005018 (--1ThreadLocalData@details_abi@wil@@QEAA@XZ.c)
 */
