/*
 * XREFs of _TsSessionIdAddNotify_::_1_::catch$10 @ 0x180046203
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall TsSessionIdAddNotify_::_1_::catch_10(__int64 a1, __int64 a2, __int64 a3, const char *a4)
{
