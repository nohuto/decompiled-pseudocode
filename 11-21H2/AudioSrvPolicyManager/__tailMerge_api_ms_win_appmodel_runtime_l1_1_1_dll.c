/*
 * XREFs of __tailMerge_api_ms_win_appmodel_runtime_l1_1_1_dll @ 0x180003A5C
 * Callers:
 *     __imp_load_ParseApplicationUserModelId @ 0x180003A50 (__imp_load_ParseApplicationUserModelId.c)
 * Callees:
