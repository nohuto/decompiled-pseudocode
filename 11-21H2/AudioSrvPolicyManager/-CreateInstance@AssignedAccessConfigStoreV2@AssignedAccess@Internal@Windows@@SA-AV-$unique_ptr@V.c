/*
 * XREFs of ?CreateInstance@AssignedAccessConfigStoreV2@AssignedAccess@Internal@Windows@@SA?AV?$unique_ptr@VAssignedAccessConfigStoreBase@AssignedAccess@Internal@Windows@@U?$default_delete@VAssignedAccessConfigStoreBase@AssignedAccess@Internal@Windows@@@wistd@@@wistd@@XZ @ 0x180042A04
 * Callers:
...
_QWORD *__fastcall Windows::Internal::AssignedAccess::AssignedAccessConfigStoreV2::CreateInstance(_QWORD *a1)
{
  ...
  *v3 = &Windows::Internal::AssignedAccess::AssignedAccessConfigStoreV2::`vftable';
  if ( !((unsigned __int8 (__fastcall *)(_QWORD *))*(&Windows::Internal::AssignedAccess::AssignedAccessConfigStoreV2::`vftable'
                                                   + 5))(v3) )
  {
    (**v4)(v4, 1LL);
LABEL_4:
