/*
 * XREFs of ?Left@?$CStringT@GV?$StrTraitATL@GV?$ChTraitsCRT@G@ATL@@@ATL@@@ATL@@QEBA?AV12@H@Z @ 0x18003C378
 * Callers:
        ...
        int a3)
{
  ...
  if ( v5 < *((_DWORD *)v4 - 4) )
  {
    v8 = *(v4 - 3);
    if ( v8
      && (v9 = (__int64 (__fastcall ***)(_QWORD, _QWORD, __int64))(*(__int64 (__fastcall **)(__int64))(*(_QWORD *)v8 + 32LL))(v8)) != 0LL )
    {
      v10 = *a1;
    }
    else
    {
      v13 = ((__int64 (__fastcall *)(void ***))ATL::g_strmgr[4])(&ATL::g_strmgr);
      v10 = *a1;
      v9 = (__int64 (__fastcall ***)(_QWORD, _QWORD, __int64))v13;
      if ( !v13 )
