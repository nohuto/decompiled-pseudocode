/*
 * XREFs of ?AddHead@?$CAtlList@PEAVCApplication@@V?$CElementTraits@PEAVCApplication@@@ATL@@@ATL@@QEAAPEAU__POSITION@@AEBQEAVCApplication@@@Z @ 0x18001EE88
 * Callers:
...
_QWORD *__fastcall ATL::CAtlList<CApplication *,ATL::CElementTraits<CApplication *>>::AddHead(__int64 *a1, _QWORD *a2)
{
  __int64 v3; // rsi
