/*
 * XREFs of _CDuckingNotification::Init_::_1_::catch$3 @ 0x180044E61
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall CDuckingNotification::Init_::_1_::catch_3(__int64 a1, __int64 a2, __int64 a3, const char *a4)
{
