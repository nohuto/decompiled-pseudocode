/*
 * XREFs of ?TsSessionIdAreAccessibilityAudioSettingsInitialized@@YA_NK@Z @ 0x18002E4D0
 * Callers:
...
bool __fastcall TsSessionIdAreAccessibilityAudioSettingsInitialized(DWORD SessionId)
{
