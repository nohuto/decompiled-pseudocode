/*
 * XREFs of ?AddHead@?$CAtlList@PEAVCProcess@@V?$CElementTraits@PEAVCProcess@@@ATL@@@ATL@@QEAAPEAU__POSITION@@AEBQEAVCProcess@@@Z @ 0x1800156A0
 * Callers:
...
_QWORD *__fastcall ATL::CAtlList<CProcess *,ATL::CElementTraits<CProcess *>>::AddHead(__int64 *a1, _QWORD *a2)
{
  __int64 v3; // rsi
