/*
 * XREFs of ??$ReportFailure_NoReturn@$02@details@wil@@YAXPEAXIPEBD110AEBUResultStatus@01@PEBGW4ReportFailureOptions@01@@Z @ 0x180004328
 * Callers:
 ...
 *     ?RecordFailFast@details@wil@@YAHJ@Z @ 0x1800064C0 (-RecordFailFast@details@wil@@YAHJ@Z.c)
