 ...
 *     ?LogState@CApplicationManager@@QEAAXXZ @ 0x1800208D4 (-LogState@CApplicationManager@@QEAAXXZ.c)
 * Callees:
        ...
        __int64 a10)
{
  ...
  v18 = v14;
  v19 = 0;
  return tlgWriteTransfer_EventWriteTransfer(a1, a2, 0LL, 0LL, 8u, &v16);
}
