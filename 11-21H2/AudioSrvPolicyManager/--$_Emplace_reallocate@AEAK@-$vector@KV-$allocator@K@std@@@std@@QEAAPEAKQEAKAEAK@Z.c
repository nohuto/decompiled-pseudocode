/*
 * XREFs of ??$_Emplace_reallocate@AEAK@?$vector@KV?$allocator@K@std@@@std@@QEAAPEAKQEAKAEAK@Z @ 0x18002A7A8
 * Callers:
...
_DWORD *__fastcall std::vector<unsigned long>::_Emplace_reallocate<unsigned long &>(__int64 a1, _BYTE *a2, _DWORD *a3)
{
  __int64 v6; // rsi
  __int64 v7; // rax
  __int64 v8; // rcx
