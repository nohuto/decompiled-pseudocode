/*
 * XREFs of ??$ReportFailure_Return@$01@details@wil@@YAXPEAXIPEBD110AEBUResultStatus@01@PEBGW4ReportFailureOptions@01@@Z @ 0x1800048A8
 * Callers:
 ...
 *     ?RecordLog@details@wil@@YAHJ@Z @ 0x1800064D4 (-RecordLog@details@wil@@YAHJ@Z.c)
