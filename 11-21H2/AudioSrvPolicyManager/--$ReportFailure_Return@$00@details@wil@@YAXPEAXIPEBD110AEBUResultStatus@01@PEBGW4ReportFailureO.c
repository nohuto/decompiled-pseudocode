/*
 * XREFs of ??$ReportFailure_Return@$00@details@wil@@YAXPEAXIPEBD110AEBUResultStatus@01@PEBGW4ReportFailureOptions@01@@Z @ 0x1800045D8
 * Callers:
 ...
 *     ?RecordReturn@details@wil@@YAHJ@Z @ 0x1800064F4 (-RecordReturn@details@wil@@YAHJ@Z.c)
