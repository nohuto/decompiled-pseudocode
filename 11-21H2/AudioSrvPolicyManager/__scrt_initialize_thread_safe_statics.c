/*
 * XREFs of __scrt_initialize_thread_safe_statics @ 0x180002BD0
 * Callers:
 *     <none>
 * Callees:
...
__int64 _scrt_initialize_thread_safe_statics()
{
  ...
  InitializeCriticalSectionAndSpinCount(&stru_18005C268, 0xFA0u);
  ...
  if ( ProcAddress && v2 )
  {
    qword_18005C290 = (__int64)ProcAddress;
    qword_18005C298 = (__int64)v2;
    goto LABEL_7;
  }
