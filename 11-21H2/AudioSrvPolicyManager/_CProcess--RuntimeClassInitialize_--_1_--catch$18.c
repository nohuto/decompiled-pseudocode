/*
 * XREFs of _CProcess::RuntimeClassInitialize_::_1_::catch$18 @ 0x18004568C
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall CProcess::RuntimeClassInitialize_::_1_::catch_18(__int64 a1, __int64 a2, __int64 a3, const char *a4)
{
