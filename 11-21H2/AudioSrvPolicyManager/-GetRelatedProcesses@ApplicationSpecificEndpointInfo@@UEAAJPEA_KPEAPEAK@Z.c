/*
 * XREFs of ?GetRelatedProcesses@ApplicationSpecificEndpointInfo@@UEAAJPEA_KPEAPEAK@Z @ 0x18003C270
 * Callers:
 *     <none>
 * Callees:
 *     ?Return_Hr@in1diag3@details@wil@@YAXPEAXIPEBDJ@Z @ 0x180006854 (-Return_Hr@in1diag3@details@wil@@YAXPEAXIPEBDJ@Z.c)
 *     ?_Xrange@?$vector@KV?$allocator@K@std@@@std@@CAXXZ @ 0x18003D794 (-_Xrange@-$vector@KV-$allocator@K@std@@@std@@CAXXZ.c)
 */
      ...
      if ( (*((_QWORD *)this + 8) - v11) >> 2 <= i )
      {
        ...
        catch ( ... )
        {
          ...
          *((_DWORD *)v13 + 16) = wil::details::in1diag3::Return_CaughtException(
                                    ...
                                    (void *)0x14A,
                                    (int)"avcore\\audiocore\\server\\audiosrv\\applicationspecificendpointinfo\\applicati"
