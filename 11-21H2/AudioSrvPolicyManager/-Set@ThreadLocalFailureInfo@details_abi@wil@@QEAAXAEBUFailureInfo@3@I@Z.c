/*
 * XREFs of ?Set@ThreadLocalFailureInfo@details_abi@wil@@QEAAXAEBUFailureInfo@3@I@Z @ 0x180006A2C
 * Callers:
...
LABEL_41:
    ...
    v30 = wil::details::WriteResultString<unsigned short const *>(v22, v25, *((_WORD **)a2 + 3), v5);
    memset_0(v30, 0, v25 - v30);
  }
}
