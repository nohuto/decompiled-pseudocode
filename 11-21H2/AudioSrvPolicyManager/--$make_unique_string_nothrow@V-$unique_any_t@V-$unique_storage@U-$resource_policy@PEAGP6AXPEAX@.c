 ...
 *     ?_FailFast_Unexpected@in1diag3@details@wil@@YAXPEAXIPEBD@Z @ 0x180031120 (-_FailFast_Unexpected@in1diag3@details@wil@@YAXPEAXIPEBD@Z.c)
        ...
        const char *a4)
{
  ...
  v4 = a3;
  if ( !a2 && a3 == -1LL )
    wil::details::in1diag3::_FailFast_Unexpected(retaddr, (void *)0xCAF, 0xFFFFFFFF, a4);
  v7 = a3;
  if ( a2 )
  {
    v8 = a3;
