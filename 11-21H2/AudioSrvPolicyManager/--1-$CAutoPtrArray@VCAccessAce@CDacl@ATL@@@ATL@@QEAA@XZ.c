/*
 * XREFs of ??1?$CAutoPtrArray@VCAccessAce@CDacl@ATL@@@ATL@@QEAA@XZ @ 0x18003DD88
 * Callers:
 *     _DetermineLowRightsKeySecurityDescriptor_::_1_::dtor$7 @ 0x180046A58 (_DetermineLowRightsKeySecurityDescriptor_--_1_--dtor$7.c)
 * Callees:
 *     <none>
 */
