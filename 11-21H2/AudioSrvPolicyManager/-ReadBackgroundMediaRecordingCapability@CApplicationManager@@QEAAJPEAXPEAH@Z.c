/*
 * XREFs of ?ReadBackgroundMediaRecordingCapability@CApplicationManager@@QEAAJPEAXPEAH@Z @ 0x180021C7C
 * Callers:
        ...
        int *a3)
{
  ...
  *a3 = 0;
  ...
  {
    WPP_SF_d(*((_QWORD *)WPP_GLOBAL_Control + 2), 0x16u, &WPP_7bcb4e64156732b2305239eaa24ad5b8_Traceguids, v4);
  }
  if ( (_BYTE)v7 )
    *a3 = 1;
  return 0LL;
