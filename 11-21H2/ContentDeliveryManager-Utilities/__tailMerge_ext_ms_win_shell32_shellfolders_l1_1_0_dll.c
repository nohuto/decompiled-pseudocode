/*
 * XREFs of __tailMerge_ext_ms_win_shell32_shellfolders_l1_1_0_dll @ 0x180022C21
 * Callers:
 *     __imp_load_SHGetKnownFolderPath @ 0x180022C15 (__imp_load_SHGetKnownFolderPath.c)
 * Callees:
