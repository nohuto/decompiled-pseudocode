/*
 * XREFs of ??0AppInstallService@Actions@CreativeFramework@@QEAA@PEB_W0_N111000@Z @ 0x1800B9BAC
 * Callers:
        ...
        wchar_t *a10)
{
  ...
  *(_QWORD *)this = &CreativeFramework::Actions::AppInstallService::`vftable';
  v13 = (unsigned __int64 *)((char *)this + 8);
  v13[3] = 7LL;
  v14 = 0LL;
  v13[2] = 0LL;
  *(_WORD *)v13 = 0;
  ...
  *((_WORD *)this + 20) = 0;
  ...
  std::wstring::assign((unsigned __int64 *)this + 5, (char *)a3, v17);
  *((_BYTE *)this + 72) = a4;
  *((_BYTE *)this + 73) = a6;
  *((_BYTE *)this + 74) = a5;
  *((_BYTE *)this + 75) = a7;
  ...
  *((_WORD *)this + 56) = 0;
  ...
  std::wstring::assign((unsigned __int64 *)this + 14, (char *)Src, v18);
  *((_QWORD *)this + 21) = 7LL;
  *((_QWORD *)this + 20) = 0LL;
  *((_WORD *)this + 72) = 0;
  *((_QWORD *)this + 25) = 7LL;
  ...
  *((_WORD *)this + 104) = 0;
  ...
  std::wstring::assign((unsigned __int64 *)this + 26, (char *)a9, v19);
  *((_QWORD *)this + 33) = 7LL;
  *((_QWORD *)this + 32) = 0LL;
  *((_WORD *)this + 120) = 0;
  if ( *a10 )
  ...
  std::wstring::assign((unsigned __int64 *)this + 30, (char *)a10, v14);
  return this;
}
