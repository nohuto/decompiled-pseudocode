/*
 * XREFs of ?get_ContextualSuggestionsManager@ContentManagementBrokerServer@ContentManagement@@UEAAJPEAPEAUIContextualSuggestionsManager@2@@Z @ 0x180049140
 * Callers:
 *     <none>
 * Callees:
        ...
        struct ContentManagement::IContextualSuggestionsManager **a2)
{
  ...
  __int64 (__fastcall ***v10)(_QWORD, GUID *, struct ContentManagement::IContextualSuggestionsManager **); // rcx
  int v12; // eax
  unsigned int v13; // ebx
  __int64 (__fastcall ***v14)(_QWORD, GUID *, struct ContentManagement::IContextualSuggestionsManager **); // rcx
  __int64 (__fastcall ***v15)(_QWORD, GUID *, struct ContentManagement::IContextualSuggestionsManager **); // rcx
  wil::details::in1diag3 *retaddr; // [rsp+38h] [rbp+18h]
  __int64 (__fastcall ***v17)(_QWORD, GUID *, struct ContentManagement::IContextualSuggestionsManager **); // [rsp+48h] [rbp+28h] BYREF
...
LABEL_8:
    ...
    {
      v17 = 0LL;
      ((void (__fastcall *)(__int64 (__fastcall ***)(_QWORD, GUID *, struct ContentManagement::IContextualSuggestionsManager **)))(*v10)[2])(v10);
    }
  ...
  *v6 = &ContentManagement::ContextualSuggestionsManager::`vftable'{for `Microsoft::WRL::Details::ImplementsHelper<Microsoft::WRL::RuntimeClassFlags<3>,1,Microsoft::WRL::Details::ImplementsMarker<Microsoft::WRL::FtmBase>,IWeakReferenceSource,ContentManagement::IContextualSuggestionsManager>'};
  ...
  v5 = (*(__int64 (__fastcall **)(_QWORD *, GUID *, _QWORD))*v4)(v4, &GUID_b56a8e91_f7d4_47db_a915_40f6f26a2ed6, &v17);
  (*(void (__fastcall **)(_QWORD *))(*v4 + 16LL))(v4);
  if ( v5 < 0 )
    goto LABEL_8;
  v12 = (**v17)(v17, &GUID_b56a8e91_f7d4_47db_a915_40f6f26a2ed6, a2);
  v13 = v12;
  if ( v12 >= 0 )
  {
    v15 = v17;
    ...
    {
      v17 = 0LL;
      ((void (__fastcall *)(__int64 (__fastcall ***)(_QWORD, GUID *, struct ContentManagement::IContextualSuggestionsManager **)))(*v15)[2])(v15);
    }
    return 0LL;
  }
  else
  {
    ...
    {
      v17 = 0LL;
      ((void (__fastcall *)(__int64 (__fastcall ***)(_QWORD, GUID *, struct ContentManagement::IContextualSuggestionsManager **)))(*v14)[2])(v14);
    }
    return v13;
  }
}
