...
float *__fastcall FXp_mulh(float *a1, int a2, float a3)
{
  ...
  __int64 i; // rax
  float v15; // xmm0_4
  float v17; // [rsp+20h] [rbp-50h] BYREF
  __int16 v18; // [rsp+24h] [rbp-4Ch] BYREF
