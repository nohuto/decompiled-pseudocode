/*
 * XREFs of ?do_get@?$time_get@GV?$istreambuf_iterator@GU?$char_traits@G@std@@@std@@@std@@MEBA?AV?$istreambuf_iterator@GU?$char_traits@G@std@@@2@V32@0AEAVios_base@2@AEAHPEAUtm@@DD@Z @ 0x180017C20
 * Callers:
 *     <none>
 * Callees:
...
LABEL_52:
  ...
  if ( a8 != 109 )
    goto LABEL_73;
  v26 = std::time_get<unsigned short,std::istreambuf_iterator<unsigned short>>::_Getint(
          (__int64)a1,
          a3,
          a4,
          1,
