/*
 * XREFs of ?do_put@?$money_put@DV?$ostreambuf_iterator@DU?$char_traits@D@std@@@std@@@std@@MEBA?AV?$ostreambuf_iterator@DU?$char_traits@D@std@@@2@V32@_NAEAVios_base@2@DAEBV?$basic_string@DU?$char_traits@D@std@@V?$allocator@D@2@@2@@Z @ 0x180020590
 * Callers:
 *     <none>
 * Callees:
        ...
        _QWORD *a7)
{
  ...
  void *v27[5]; // [rsp+78h] [rbp-51h] BYREF
  void *v28[2]; // [rsp+A0h] [rbp-29h] BYREF
  __int64 v29; // [rsp+B0h] [rbp-19h]
  unsigned __int64 v30; // [rsp+B8h] [rbp-11h]
  _BYTE v31[16]; // [rsp+C0h] [rbp-9h] BYREF
  ...
  *(_QWORD *)&v26 = v11;
  ...
  v29 = 0LL;
  LOBYTE(v28[0]) = 0;
  std::string::assign(v28, (char *)v10 + v15, i - v15);
  if ( !v29 )
