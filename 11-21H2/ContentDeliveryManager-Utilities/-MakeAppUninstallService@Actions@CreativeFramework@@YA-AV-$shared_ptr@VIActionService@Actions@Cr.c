 ...
 *     ??$make_shared@VAppUninstallService@Actions@CreativeFramework@@PEB_W@std@@YA?AV?$shared_ptr@VAppUninstallService@Actions@CreativeFramework@@@0@$$QEAPEB_W@Z @ 0x1800B9AF4 (--$make_shared@VAppUninstallService@Actions@CreativeFramework@@PEB_W@std@@YA-AV-$shared_ptr@VApp.c)
 */

// Hidden C++ exception states: #wind=1
__int64 __fastcall CreativeFramework::Actions::MakeAppUninstallService(__int64 a1, __int64 a2, _QWORD *a3)
{
  __int64 v4; // rax
  _QWORD *v5; // rax
  ...
  if ( *(_QWORD *)(v4 + 24) >= 8uLL )
    v4 = *(_QWORD *)v4;
  v7 = (char *)v4;
  v5 = std::make_shared<CreativeFramework::Actions::AppUninstallService,wchar_t const *>(v8, &v7);
  *(_QWORD *)a1 = *v5;
  *(_QWORD *)(a1 + 8) = v5[1];
  *v5 = 0LL;
  v5[1] = 0LL;
