    ...
    if ( v9 )
    {
      for ( i = 0LL; (unsigned int)i < v6; i = (unsigned int)(i + 1) )
      {
        if ( (unsigned int)i + a2 >= v35 )
          break;
        v14 = XWinRT::StorageTempTraits<XWinRT::detail::GitStorageType<IInspectable>,IInspectable *,XWinRT::detail::GitStorageType<IInspectable>,Windows::Foundation::Collections::Internal::DefaultLifetimeTraits<IInspectable *>>::ResolveDemand(
