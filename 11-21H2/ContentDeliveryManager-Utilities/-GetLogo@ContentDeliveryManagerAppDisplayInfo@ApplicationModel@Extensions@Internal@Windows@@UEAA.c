/*
 * XREFs of ?GetLogo@ContentDeliveryManagerAppDisplayInfo@ApplicationModel@Extensions@Internal@Windows@@UEAAJUSize@Foundation@5@PEAPEAUIRandomAccessStreamReference@Streams@Storage@5@@Z @ 0x1800D9B30
 * Callers:
 *     <none>
 * Callees:
