/*
 * XREFs of ?GetCachedFeatureEnabledState@?$FeatureImpl@U__WilFeatureTraits_Feature_ActionCenterNotification@@@details@wil@@AEAA?ATwil_details_FeatureStateCache@@XZ @ 0x18005BC5C
 * Callers:
 *     ?IsEnabled@?$Feature@U__WilFeatureTraits_Feature_ActionCenterNotification@@@wil@@SA_NXZ @ 0x18005F7C0 (-IsEnabled@-$Feature@U__WilFeatureTraits_Feature_ActionCenterNotification@@@wil@@SA_NXZ.c)
  ...
  *a2 = *a1;
  if ( (v2 & 3) != 3 )
  {
    ...
    if ( g_wil_details_internalGetFeatureEnabledState || (v6 = g_wil_details_apiGetFeatureEnabledState) != 0LL )
      v7 = ((__int64 (__fastcall *)(__int64, _QWORD, int *))v6)(8598334LL, 0LL, &v19);
    else
      v7 = 0;
    v21 = 0;
    v8 = v7 & 0xFFFFFF3F;
    ...
    while ( 1 )
    {
      *a2 = v13;
      ...
      v13 = _InterlockedCompareExchange(a1, v16, v13);
      if ( v15 == v13 )
        break;
      v14 = v19;
      LOWORD(v12) = v20;
