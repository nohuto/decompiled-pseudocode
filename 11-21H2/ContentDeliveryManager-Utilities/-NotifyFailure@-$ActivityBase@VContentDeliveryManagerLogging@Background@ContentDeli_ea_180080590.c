/*
 * XREFs of ?NotifyFailure@?$ActivityBase@VContentDeliveryManagerLogging@Background@ContentDeliveryManager@@$00$0EAAAAAAAAAAA@$04$0CAAAAAA@U_TlgReflectorTag_Param0IsProviderType@@@wil@@UEAA_NAEBUFailureInfo@2@@Z @ 0x180080590
 * Callers:
 *     <none>
 * Callees:
        ...
        int *a2)
{
  ...
  else
  {
    ...
    if ( *(_DWORD *)v4 > 2u
      && (*((_QWORD *)v4 + 2) & 0x600000000000LL) != 0
      && (*((_QWORD *)v4 + 3) & 0x600000000000LL) == *((_QWORD *)v4 + 3) )
    {
      v12 = *((_QWORD *)a2 + 15);
      v11 = *((_QWORD *)a2 + 14);
