/*
 * XREFs of ?do_get@?$num_get@DV?$istreambuf_iterator@DU?$char_traits@D@std@@@std@@@std@@MEBA?AV?$istreambuf_iterator@DU?$char_traits@D@std@@@2@V32@0AEAVios_base@2@AEAHAEAK@Z @ 0x1800098D0
 * Callers:
 *     <none>
 * Callees:
        ...
        _DWORD *a7)
{
  ...
  if ( v16 )
  {
    v13 = (void (__fastcall ***)(_QWORD, __int64))(*(__int64 (**)(void))(*(_QWORD *)v16 + 16LL))();
    if ( v13 )
      (**v13)(v13, 1LL);
  }
