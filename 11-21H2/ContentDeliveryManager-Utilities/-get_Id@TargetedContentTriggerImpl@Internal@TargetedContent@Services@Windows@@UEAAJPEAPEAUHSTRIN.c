/*
 * XREFs of ?get_Id@TargetedContentTriggerImpl@Internal@TargetedContent@Services@Windows@@UEAAJPEAPEAUHSTRING__@@@Z @ 0x180096A70
 * Callers:
 *     <none>
 * Callees:
        ...
        HSTRING *a2)
{
  ...
  v5 = WindowsDuplicateString(*((HSTRING *)this + 11), a2);
  v6 = v5;
  if ( v5 >= 0 )
  {
    if ( v4 )
