/*
 * XREFs of ?do_get@?$num_get@_WV?$istreambuf_iterator@_WU?$char_traits@_W@std@@@std@@@std@@MEBA?AV?$istreambuf_iterator@_WU?$char_traits@_W@std@@@2@V32@0AEAVios_base@2@AEAHAEA_J@Z @ 0x1800CD6E0
 * Callers:
 *     <none>
 * Callees:
        ...
        unsigned __int64 *a7)
{
  ...
  unsigned __int8 v18[32]; // [rsp+48h] [rbp-30h] BYREF
