/*
 * XREFs of ?CreateLaunchArgumentsFromUrl@PinnedWebsiteManager@Actions@CreativeFramework@@YA?AVHString@Wrappers@WRL@Microsoft@@PEB_W@Z @ 0x1800D33CC
 * Callers:
        ...
        const WCHAR *a2)
{
  ...
  *(_QWORD *)a1 = 0LL;
  ...
  v6 = Microsoft::WRL::Wrappers::HStringReference::HStringReference(&v11, (const WCHAR **)off_18011A178, v5);
