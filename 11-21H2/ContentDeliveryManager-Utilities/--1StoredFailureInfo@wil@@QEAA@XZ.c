/*
 * XREFs of ??1StoredFailureInfo@wil@@QEAA@XZ @ 0x18002973C
 * Callers:
 *     ??1ResultException@wil@@UEAA@XZ @ 0x1800296B8 (--1ResultException@wil@@UEAA@XZ.c)
