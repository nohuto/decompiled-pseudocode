/*
 * XREFs of ?CreateYourPhoneTaskbarIconIfNeeded@Pinning@Mobility@@YAXKKK@Z @ 0x1800317E4
 * Callers:
 *     ?CreateYourPhoneTaskbarIconIfNeeded@MobilityExperienceSettings@ContentManagement@@UEAAJKKK@Z @ 0x1800317C0 (-CreateYourPhoneTaskbarIconIfNeeded@MobilityExperienceSettings@ContentManagement@@UEAAJKKK@Z.c)
 * Callees:
...
void __fastcall Mobility::Pinning::CreateYourPhoneTaskbarIconIfNeeded(Mobility::Pinning *this, __int64 a2, __int64 a3)
{
  ...
  const char *v7; // r9
  _DWORD v8[4]; // [rsp+20h] [rbp-78h] BYREF
  _QWORD v9[2]; // [rsp+30h] [rbp-68h] BYREF
  _QWORD v10[3]; // [rsp+40h] [rbp-58h] BYREF
  __int16 v11; // [rsp+58h] [rbp-40h]
  void **v12; // [rsp+60h] [rbp-38h] BYREF
  struct wil::details_abi::ThreadLocalData *v13; // [rsp+68h] [rbp-30h]
  ...
  try
  {
    wil::details::FeatureImpl<__WilFeatureTraits_Feature_YourPhoneTaskbarIcon>::ReportUsage(
      ...
      a2,
      a3);
    v9[0] = &wil::details::functor_wrapper_void<_lambda_ce3eaa413337f6bd175b4ae2c9280e26_ &>::`vftable';
    v9[1] = v8;
