/*
 * XREFs of ?CreateSupportedWnfNameStateMap@Triggers@CreativeFramework@@YA?AV?$map@PEBGPEBU_WNF_STATE_NAME@@Uless@Triggers@CreativeFramework@@V?$allocator@U?$pair@QEBGPEBU_WNF_STATE_NAME@@@std@@@std@@@std@@XZ @ 0x1800B2F88
 * Callers:
 ...
 *     ??0?$_Tree@V?$_Tmap_traits@PEBGPEBU_WNF_STATE_NAME@@Uless@Triggers@CreativeFramework@@V?$allocator@U?$pair@QEBGPEBU_WNF_STATE_NAME@@@std@@@std@@$0A@@std@@@std@@QEAA@AEBV01@AEBV?$allocator@U?$pair@QEBGPEBU_WNF_STATE_NAME@@@std@@@1@@Z @ 0x1800B2E44 (--0-$_Tree@V-$_Tmap_traits@PEBGPEBU_WNF_STATE_NAME@@Uless@Triggers@CreativeFramework@@V-$allocat.c)
 */
...
__int64 *__fastcall CreativeFramework::Triggers::CreateSupportedWnfNameStateMap(__int64 *a1)
{
  ...
  AcquireSRWLockShared(&stru_1801AF310);
  v2 = &stru_1801AF310;
  if ( !qword_1801AF4C0 )
  {
    LastError = GetLastError();
    ReleaseSRWLockShared(&stru_1801AF310);
    SetLastError(LastError);
    v2 = 0LL;
    AcquireSRWLockExclusive(&stru_1801AF310);
    if ( qword_1801AF4C0 )
    {
      ...
      ReleaseSRWLockExclusive(&stru_1801AF310);
      return a1;
    }
    v4 = off_180111D08;
    v5 = 1375LL;
