/*
 * XREFs of ?str@?$basic_stringbuf@_WU?$char_traits@_W@std@@V?$allocator@_W@2@@std@@QEBA?AV?$basic_string@_WU?$char_traits@_W@std@@V?$allocator@_W@2@@2@XZ @ 0x1800AF9FC
 * Callers:
...
LABEL_6:
      ...
      v10 = 0LL;
      LOWORD(v9[0]) = 0;
      std::wstring::assign((unsigned __int64 *)v9, v5, v6 >> 1);
      a2[3] = 7LL;
      a2[2] = 0LL;
      *(_WORD *)a2 = 0;
      goto LABEL_11;
