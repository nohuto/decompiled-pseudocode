        ...
        void **a4)
{
  ...
  *((_WORD *)v5 + 8) = 0;
  ...
  {
    std::_Wrap_alloc<std::allocator<std::_List_node<std::pair<std::wstring const,std::shared_ptr<ContentManagement::TargetedContent::Internal::SubscriptionManagerImpl::SubscriptionMapValue>>,void *>>>::deallocate(
      v7,
      v9);
    throw;
  }
