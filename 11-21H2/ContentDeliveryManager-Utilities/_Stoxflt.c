 ...
 *     memchr_0 @ 0x1800223B1 (memchr_0.c)
 */
  ...
  *a4 = 0;
  ...
  if ( v12 )
  {
    ...
    do
    {
      ...
      {
        ++v11;
        v35[v13++] = byte_18011F158[v12 - "0123456789abcdefABCDEF"];
      }
  ...
  if ( v17 )
  {
    ...
    do
    {
      ...
      {
        ++v11;
        v35[v18++] = byte_18011F158[v17 - "0123456789abcdefABCDEF"];
        --*a4;
      }
      v17 = memchr_0("0123456789abcdefABCDEF", (char)*++v16, 0x16uLL);
    }
