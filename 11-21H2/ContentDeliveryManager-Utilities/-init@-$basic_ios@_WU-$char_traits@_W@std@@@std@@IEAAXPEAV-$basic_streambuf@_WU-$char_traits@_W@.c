/*
 * XREFs of ?init@?$basic_ios@_WU?$char_traits@_W@std@@@std@@IEAAXPEAV?$basic_streambuf@_WU?$char_traits@_W@std@@@2@_N@Z @ 0x1800AF2B0
 * Callers:
...
void __fastcall std::wios::init(std::ios_base *this, __int64 a2)
{
  ...
  *((_QWORD *)this + 10) = 0LL;
  ...
  LOBYTE(v6) = 32;
  *((_WORD *)this + 44) = (*(__int64 (__fastcall **)(struct std::_Facet_base *, __int64, void (__fastcall ***)(_QWORD, __int64)))(*(_QWORD *)v7 + 96LL))(
                            v7,
                            v6,
                            v8);
  if ( !*((_QWORD *)this + 9) )
