/*
 * XREFs of ??$_Getvals@G@?$time_get@GV?$istreambuf_iterator@GU?$char_traits@G@std@@@std@@@std@@IEAAXGAEBV_Locinfo@1@@Z @ 0x18000E144
 * Callers:
 *     ?_Init@?$time_get@GV?$istreambuf_iterator@GU?$char_traits@G@std@@@std@@@std@@IEAAXAEBV_Locinfo@2@@Z @ 0x180013F58 (-_Init@-$time_get@GV-$istreambuf_iterator@GU-$char_traits@G@std@@@std@@@std@@IEAAXAEBV_Locinfo@2.c)
 * Callees:
        ...
        __int64 a3)
{
  ...
  *(_OWORD *)(a1 + 76) = *(_OWORD *)&v5->_Isleadbyte[20];
  ...
  if ( *(_QWORD *)(a3 + 8) )
    v8 = *(char **)(a3 + 8);
  *(_QWORD *)(a1 + 16) = std::_Maklocstr<unsigned short>(v8);
  v9 = _Getmonths();
  v10 = v9;
  if ( v9 )
  {
    std::_Yarn<char>::operator=(a3 + 24, v9);
    free(v10);
  }
  ...
  if ( *(_QWORD *)(a3 + 24) )
    v11 = *(char **)(a3 + 24);
  *(_QWORD *)(a1 + 24) = std::_Maklocstr<unsigned short>(v11);
