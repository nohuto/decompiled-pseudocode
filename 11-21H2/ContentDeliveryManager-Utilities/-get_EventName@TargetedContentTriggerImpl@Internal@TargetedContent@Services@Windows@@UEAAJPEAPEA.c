/*
 * XREFs of ?get_EventName@TargetedContentTriggerImpl@Internal@TargetedContent@Services@Windows@@UEAAJPEAPEAUHSTRING__@@@Z @ 0x180096910
 * Callers:
 *     <none>
 * Callees:
        ...
        HSTRING *a2)
{
  ...
  v5 = WindowsDuplicateString(*((HSTRING *)this + 19), a2);
  v6 = v5;
  if ( v5 >= 0 )
  {
    if ( v4 )
