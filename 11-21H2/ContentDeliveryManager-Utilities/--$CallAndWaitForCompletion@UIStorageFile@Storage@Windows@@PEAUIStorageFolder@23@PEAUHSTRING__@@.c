 ...
 *     ??_9IStorageFile@Storage@Windows@@$BGA@AA @ 0x1800B06F4 (--_9IStorageFile@Storage@Windows@@$BGA@AA.c)
        ...
        unsigned int *a6)
{
  ...
  v11 = 0LL;
  v7 =  Windows::Storage::IStorageFile::`vcall'{96,{flat}}(a2, *a4, *a5, *a6);
  if ( v7 < 0 )
