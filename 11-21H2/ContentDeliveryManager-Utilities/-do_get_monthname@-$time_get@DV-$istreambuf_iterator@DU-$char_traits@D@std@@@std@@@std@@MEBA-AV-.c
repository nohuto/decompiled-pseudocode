/*
 * XREFs of ?do_get_monthname@?$time_get@DV?$istreambuf_iterator@DU?$char_traits@D@std@@@std@@@std@@MEBA?AV?$istreambuf_iterator@DU?$char_traits@D@std@@@2@V32@0AEAVios_base@2@AEAHPEAUtm@@@Z @ 0x180020090
 * Callers:
 *     <none>
 * Callees:
        ...
        __int64 a7)
{
  ...
  v9 = std::_Getloctxt<char,std::istreambuf_iterator<char>>((__int64)a3, a4, 0LL, *(_BYTE **)(a1 + 24));
  if ( v9 >= 0 )
    *(_DWORD *)(a7 + 16) = v9 >> 1;
  else
    *a6 |= 2u;
