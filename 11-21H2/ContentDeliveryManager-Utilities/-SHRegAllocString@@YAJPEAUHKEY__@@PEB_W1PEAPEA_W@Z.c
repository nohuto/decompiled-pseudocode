/*
 * XREFs of ?SHRegAllocString@@YAJPEAUHKEY__@@PEB_W1PEAPEA_W@Z @ 0x1800D18DC
 * Callers:
...
__int64 __fastcall SHRegAllocString(HKEY a1, const wchar_t *a2, const wchar_t *a3, LPVOID *a4)
{
  int v6; // esi
  LSTATUS v7; // ebx
  LSTATUS ValueW; // eax
...
LABEL_18:
  ...
  {
    pvData = (wchar_t *)CoTaskMemAlloc(pcbData);
    *a4 = pvData;
    if ( pvData )
    {
      if ( v7 )
