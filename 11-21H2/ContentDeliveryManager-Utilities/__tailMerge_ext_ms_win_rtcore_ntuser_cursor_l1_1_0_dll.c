/*
 * XREFs of __tailMerge_ext_ms_win_rtcore_ntuser_cursor_l1_1_0_dll @ 0x180022793
 * Callers:
 *     __imp_load_SetCursor @ 0x180022787 (__imp_load_SetCursor.c)
 *     __imp_load_LoadCursorW @ 0x180022812 (__imp_load_LoadCursorW.c)
 * Callees:
