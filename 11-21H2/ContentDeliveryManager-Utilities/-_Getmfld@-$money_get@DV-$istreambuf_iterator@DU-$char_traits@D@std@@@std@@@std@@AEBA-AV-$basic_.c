/*
 * XREFs of ?_Getmfld@?$money_get@DV?$istreambuf_iterator@DU?$char_traits@D@std@@@std@@@std@@AEBA?AV?$basic_string@DU?$char_traits@D@std@@V?$allocator@D@2@@2@AEAV?$istreambuf_iterator@DU?$char_traits@D@std@@@2@0_NAEAVios_base@2@PEAD@Z @ 0x18001D30C
 * Callers:
...
LABEL_186:
      ...
      case '+':
        ...
        if ( !v95 )
          goto LABEL_126;
        (*(void (__fastcall **)(struct std::_Facet_base *, void **))(*(_QWORD *)v13 + 56LL))(v13, Src);
        v56 |= 0x404u;
        v57 = Src;
        if ( v99 >= 0x10 )
          v57 = (void **)Src[0];
...
LABEL_137:
        ...
        if ( !v95 )
          goto LABEL_143;
        (*(void (__fastcall **)(struct std::_Facet_base *, void **))(*(_QWORD *)v13 + 64LL))(v13, Src);
        v60 |= 0x2010u;
        v61 = Src;
        if ( v99 >= 0x10 )
          v61 = (void **)Src[0];
...
LABEL_83:
      ...
      case 'v':
        ...
        v87 = v28;
        v29 = v83;
        (*(void (__fastcall **)(struct std::_Facet_base *, void **))(*(_QWORD *)v83 + 40LL))(v83, Src);
        v18 |= 0x20000u;
        v91 = v18;
        if ( v98 )
        {
