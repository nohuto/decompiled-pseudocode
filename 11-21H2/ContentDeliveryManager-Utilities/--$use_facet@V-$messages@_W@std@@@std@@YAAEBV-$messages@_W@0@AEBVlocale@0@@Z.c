/*
 * XREFs of ??$use_facet@V?$messages@_W@std@@@std@@YAAEBV?$messages@_W@0@AEBVlocale@0@@Z @ 0x18000EA04
 * Callers:
 ...
 *     ?_Getcat@?$messages@_W@std@@SA_KPEAPEBVfacet@locale@2@PEBV42@@Z @ 0x180010DB4 (-_Getcat@-$messages@_W@std@@SA_KPEAPEBVfacet@locale@2@PEBV42@@Z.c)
