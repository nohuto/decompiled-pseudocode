/*
 * XREFs of ?Commit@DiagTrackRuleSetHandler@RuleSetHandlers@CreativeFramework@@UEAAXXZ @ 0x1800B0BF0
 * Callers:
 *     <none>
 * Callees:
        ...
        CreativeFramework::RuleSetHandlers::DiagTrackRuleSetHandler *this)
{
  ...
  if ( *((_BYTE *)this + 24) )
  {
    v1 = RtlPublishWnfStateData(WNF_SHEL_SOFTLANDING_RULES_UPDATED, 0LL, 0LL, 0LL) | 0x10000000;
    if ( v1 < 0 )
