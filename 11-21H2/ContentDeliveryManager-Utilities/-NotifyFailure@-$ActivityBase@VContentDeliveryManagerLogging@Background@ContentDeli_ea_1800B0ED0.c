/*
 * XREFs of ?NotifyFailure@?$ActivityBase@VContentDeliveryManagerLogging@Background@ContentDeliveryManager@@$0A@$0A@$04$0A@U_TlgReflectorTag_Param0IsProviderType@@@wil@@UEAA_NAEBUFailureInfo@2@@Z @ 0x1800B0ED0
 * Callers:
 *     <none>
 * Callees:
        ...
        int *a2)
{
  ...
  __int64 v21[3]; // [rsp+108h] [rbp-28h] BYREF
  PSRWLOCK SRWLock; // [rsp+130h] [rbp+0h] BYREF
  __int64 v23; // [rsp+138h] [rbp+8h] BYREF
  __int64 v24; // [rsp+140h] [rbp+10h] BYREF
  __int64 v25; // [rsp+148h] [rbp+18h] BYREF
  ...
  v5 = *(_DWORD **)(a1 + 48);
  v6 = a2[2];
  if ( v6 != v5[22] && (v6 != v5[19] || (int)v5[19] >= 0) )
    wil::StoredFailureInfo::SetFailureInfo((wil::StoredFailureInfo *)(v5 + 20), (const struct wil::FailureInfo *)a2);
  if ( SRWLock )
