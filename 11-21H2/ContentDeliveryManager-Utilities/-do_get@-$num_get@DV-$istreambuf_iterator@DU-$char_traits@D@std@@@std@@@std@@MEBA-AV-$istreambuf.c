/*
 * XREFs of ?do_get@?$num_get@DV?$istreambuf_iterator@DU?$char_traits@D@std@@@std@@@std@@MEBA?AV?$istreambuf_iterator@DU?$char_traits@D@std@@@2@V32@0AEAVios_base@2@AEAHAEAG@Z @ 0x1800094A0
 * Callers:
 *     <none>
 * Callees:
        ...
        _WORD *a7)
{
  ...
  if ( v17 )
  {
    v12 = (void (__fastcall ***)(_QWORD, __int64))(*(__int64 (**)(void))(*(_QWORD *)v17 + 16LL))();
    if ( v12 )
      (**v12)(v12, 1LL);
  }
  v13 = &v20;
