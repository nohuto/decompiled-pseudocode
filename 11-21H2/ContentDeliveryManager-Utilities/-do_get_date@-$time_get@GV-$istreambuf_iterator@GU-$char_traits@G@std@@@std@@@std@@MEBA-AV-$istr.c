/*
 * XREFs of ?do_get_date@?$time_get@GV?$istreambuf_iterator@GU?$char_traits@G@std@@@std@@@std@@MEBA?AV?$istreambuf_iterator@GU?$char_traits@G@std@@@2@V32@0AEAVios_base@2@AEAHPEAUtm@@@Z @ 0x1800181C0
 * Callers:
 *     <none>
 * Callees:
        ...
        __int64 a7)
{
  ...
  v13 = std::use_facet<std::ctype<unsigned short>>(&v45);
  v47 = v13;
  if ( v10 )
  {
...
LABEL_24:
  ...
  while ( 1 )
  {
    ...
    if ( !(*(unsigned __int8 (__fastcall **)(__int64, __int64, _QWORD))(*(_QWORD *)v47 + 32LL))(
            v47,
            72LL,
            *(unsigned __int16 *)(a3 + 10)) )
      break;
...
LABEL_44:
      if ( !v22 )
        std::istreambuf_iterator<wchar_t>::_Peek(a3);
      v24 = (*(__int64 (__fastcall **)(__int64, _QWORD, _QWORD))(*(_QWORD *)v47 + 112LL))(
              v47,
              *(unsigned __int16 *)(a3 + 10),
              0LL);
...
LABEL_99:
      if ( !v33 )
        std::istreambuf_iterator<wchar_t>::_Peek(a3);
      v34 = (*(__int64 (__fastcall **)(__int64, _QWORD, _QWORD))(*(_QWORD *)v47 + 112LL))(
              v47,
              *(unsigned __int16 *)(a3 + 10),
              0LL);
