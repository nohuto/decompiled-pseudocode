/*
 * XREFs of ?put_PlacementName@TargetedContentTriggerImpl@Internal@TargetedContent@Services@Windows@@UEAAJPEAUHSTRING__@@@Z @ 0x1800979E0
 * Callers:
 *     <none>
 * Callees:
        ...
        HSTRING a2)
{
  ...
  if ( a2 && a2 == *((HSTRING *)this + 17)
    || (WindowsDeleteString(*((HSTRING *)this + 17)),
        *((_QWORD *)this + 17) = 0LL,
        v5 = WindowsDuplicateString(a2, (HSTRING *)this + 17),
        v6 = v5,
        v5 >= 0) )
  {
    if ( v4 )
