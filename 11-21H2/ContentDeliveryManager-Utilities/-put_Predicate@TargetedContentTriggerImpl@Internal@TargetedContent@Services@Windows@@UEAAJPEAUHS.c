/*
 * XREFs of ?put_Predicate@TargetedContentTriggerImpl@Internal@TargetedContent@Services@Windows@@UEAAJPEAUHSTRING__@@@Z @ 0x180097B80
 * Callers:
 *     <none>
 * Callees:
        ...
        HSTRING a2)
{
  ...
  if ( a2 && a2 == *((HSTRING *)this + 12)
    || (WindowsDeleteString(*((HSTRING *)this + 12)),
        *((_QWORD *)this + 12) = 0LL,
        v5 = WindowsDuplicateString(a2, (HSTRING *)this + 12),
        v6 = v5,
        v5 >= 0) )
  {
    if ( v4 )
