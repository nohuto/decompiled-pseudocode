/*
 * XREFs of ?do_get@?$num_get@_WV?$istreambuf_iterator@_WU?$char_traits@_W@std@@@std@@@std@@MEBA?AV?$istreambuf_iterator@_WU?$char_traits@_W@std@@@2@V32@0AEAVios_base@2@AEAHAEAK@Z @ 0x1800CD0C0
 * Callers:
 *     <none>
 * Callees:
        ...
        _DWORD *a7)
{
  ...
  v11 = std::num_get<wchar_t,std::istreambuf_iterator<wchar_t>>::_Getifld(a1, v18, a3, a4, *(_DWORD *)(a5 + 24), &v16);
