  ...
  *a5 = 0;
  ...
  if ( *(_DWORD *)(v7 + 80) )
  {
    ...
    if ( !v11 )
    {
      v14 = -2147024882;
LABEL_21:
      RoOriginateError((unsigned int)v14, 0LL, a3, a4);
      goto LABEL_41;
    }
    v7 = a1;
  }
...
LABEL_39:
    ...
    *v5 = 0LL;
    v14 = (*(__int64 (__fastcall **)(__int64, _QWORD, GUID *, _QWORD *))(*(_QWORD *)qword_1801AF3F0 + 40LL))(
            qword_1801AF3F0,
