/*
 * XREFs of _CRT_INIT @ 0x18002187C
 * Callers:
 *     __DllMainCRTStartup @ 0x180021B24 (__DllMainCRTStartup.c)
 * Callees:
 *     _amsg_exit_0 @ 0x1800224B1 (_amsg_exit_0.c)
 *     _IsNonwritableInCurrentImage @ 0x180022510 (_IsNonwritableInCurrentImage.c)
 *     _initterm_0 @ 0x18002267E (_initterm_0.c)
