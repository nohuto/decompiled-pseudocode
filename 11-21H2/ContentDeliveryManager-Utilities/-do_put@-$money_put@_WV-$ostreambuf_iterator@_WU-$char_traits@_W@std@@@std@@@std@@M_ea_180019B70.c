/*
 * XREFs of ?do_put@?$money_put@_WV?$ostreambuf_iterator@_WU?$char_traits@_W@std@@@std@@@std@@MEBA?AV?$ostreambuf_iterator@_WU?$char_traits@_W@std@@@2@V32@_NAEAVios_base@2@_WO@Z @ 0x180019B70
 * Callers:
 *     <none>
 * Callees:
        ...
        double a7)
{
  ...
  __int64 v24[5]; // [rsp+80h] [rbp-69h] BYREF
  ...
  if ( v11 >= 0 )
  {
    ...
    v25[2] = 0LL;
    LOWORD(v25[0]) = 0;
    std::wstring::assign(v25, v12, 0LL);
    v19 = v25;
    if ( v26 >= 8 )
      v19 = (void **)v25[0];
