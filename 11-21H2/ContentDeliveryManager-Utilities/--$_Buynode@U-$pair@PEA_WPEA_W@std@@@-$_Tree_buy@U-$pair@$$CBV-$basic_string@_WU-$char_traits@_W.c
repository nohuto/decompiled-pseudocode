 ...
 *     ?_Buynode0@?$_Tree_buy@U?$pair@$$CBV?$basic_string@_WU?$char_traits@_W@std@@V?$allocator@_W@2@@std@@V12@@std@@V?$allocator@U?$pair@$$CBV?$basic_string@_WU?$char_traits@_W@std@@V?$allocator@_W@2@@std@@V12@@std@@@2@@std@@QEAAPEAU?$_Tree_node@U?$pair@$$CBV?$basic_string@_WU?$char_traits@_W@std@@V?$allocator@_W@2@@std@@V12@@std@@PEAX@2@XZ @ 0x1800B8C50 (-_Buynode0@-$_Tree_buy@U-$pair@$$CBV-$basic_string@_WU-$char_traits@_W@std@@V-$allo_ea_1800B8C50.c)
 */
        ...
        char **a2)
{
  ...
  __int64 v11; // rcx
  __int64 result; // rax
  void *v13; // [rsp+48h] [rbp+10h]

  v3 = std::_Tree_buy<std::pair<std::wstring const,std::wstring>>::_Buynode0();
  v4 = v3;
  v13 = (void *)v3;
  v5 = 0LL;
  *(_WORD *)(v3 + 24) = 0;
  ...
  *(_WORD *)(v3 + 32) = 0;
  ...
  try
  {
    std::wstring::assign((unsigned __int64 *)(v3 + 32), v7, v9);
    v10 = a2[1];
    v6[7] = 7LL;
    v6[6] = 0LL;
    *((_WORD *)v6 + 16) = 0;
