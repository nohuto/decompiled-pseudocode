/*
 * XREFs of ?Start@?$AsyncBase@UIAsyncActionCompletedHandler@Foundation@Windows@@VNil@Details@WRL@Microsoft@@$00U?$AsyncCausalityOptions@$1?InvokeOperationName@?A0xa4ce9b83@@3QBGB$1?GUID_CAUSALITY_WINDOWS_PLATFORM_ID@@3U_GUID@@B$01@67@@WRL@Microsoft@@MEAAJXZ @ 0x1800819A0
 * Callers:
 *     <none>
 * Callees:
        ...
        __int64 a4)
{
  ...
  if ( v13[0] == -1 && (v6 = _InterlockedCompareExchange((volatile signed __int32 *)(a1 + 48), 0, -1), v6 == v13[0]) )
  {
      ...
      && Microsoft::WRL::gCausality )
    {
      ...
      *(_QWORD *)&v14.Data1 = L"Windows.Services.TargetedContent.Internal.TargetedContentActionInternalImpl.InvokeAsync";
