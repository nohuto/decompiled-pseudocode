/*
 * XREFs of ?do_get_time@?$time_get@_WV?$istreambuf_iterator@_WU?$char_traits@_W@std@@@std@@@std@@MEBA?AV?$istreambuf_iterator@_WU?$char_traits@_W@std@@@2@V32@0AEAVios_base@2@AEAHPEAUtm@@@Z @ 0x1800EA1A0
 * Callers:
 *     <none>
 * Callees:
        ...
        _DWORD *a7)
{
  ...
  v14 = a7;
  v15 = std::time_get<wchar_t,std::istreambuf_iterator<wchar_t>>::_Getint(a1, a3, a4, 0, 23, a7 + 2, (__int64)v12);
  v16 = a6;
  v17 = (v15 | *a6) == 0;
  *a6 |= v15;
  if ( !v17 )
         ...
         0LL) == 58 )
  {
    ...
    *v16 |= std::time_get<wchar_t,std::istreambuf_iterator<wchar_t>>::_Getint(a1, a3, a4, 0, 59, v14 + 1, (__int64)v12);
  }
  else
  {
LABEL_9:
