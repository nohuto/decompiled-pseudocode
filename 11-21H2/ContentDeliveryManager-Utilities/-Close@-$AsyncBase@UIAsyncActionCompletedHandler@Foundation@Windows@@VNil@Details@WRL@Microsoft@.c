/*
 * XREFs of ?Close@?$AsyncBase@UIAsyncActionCompletedHandler@Foundation@Windows@@VNil@Details@WRL@Microsoft@@$00U?$AsyncCausalityOptions@$1?ProcessCreativeEventOperationName@?A0xb8965cb7@@3QBGB$1?GUID_CAUSALITY_WINDOWS_PLATFORM_ID@@3U_GUID@@B$01@67@@WRL@Microsoft@@UEAAJXZ @ 0x180030A30
 * Callers:
 *     <none>
 * Callees:
        ...
        volatile signed __int32 *a1)
{
  ...
  else
  {
    ...
    {
      v2 = -2147483635;
      RoOriginateError(2147483661LL, 0LL, 4294967294LL, 4LL);
    }
  }
  return v2;
}
