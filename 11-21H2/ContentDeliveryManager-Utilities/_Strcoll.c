/*
 * XREFs of _Strcoll @ 0x180021390
 * Callers:
 *     ?do_compare@?$collate@D@std@@MEBAHPEBD000@Z @ 0x18001F1B0 (-do_compare@-$collate@D@std@@MEBAHPEBD000@Z.c)
 * Callees:
 *     _GetLocaleHandleByColl @ 0x18000D228 (_GetLocaleHandleByColl.c)
 *     _GetLocaleHandleById @ 0x18000D234 (_GetLocaleHandleById.c)
 *     __crtCompareStringA_Stub @ 0x18000D29C (__crtCompareStringA_Stub.c)
