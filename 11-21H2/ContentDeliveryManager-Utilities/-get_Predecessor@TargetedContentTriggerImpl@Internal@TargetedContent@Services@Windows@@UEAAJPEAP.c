/*
 * XREFs of ?get_Predecessor@TargetedContentTriggerImpl@Internal@TargetedContent@Services@Windows@@UEAAJPEAPEAUHSTRING__@@@Z @ 0x180096D70
 * Callers:
 *     <none>
 * Callees:
        ...
        HSTRING *a2)
{
  ...
  v5 = WindowsDuplicateString(*((HSTRING *)this + 14), a2);
  v6 = v5;
  if ( v5 >= 0 )
  {
    if ( v4 )
