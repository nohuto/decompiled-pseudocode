/*
 * XREFs of _CreativeFramework::Actions::IsMsaConnected_::_1_::dtor$18 @ 0x1800F43FF
 * Callers:
 *     <none>
 * Callees:
...
void __fastcall CreativeFramework::Actions::IsMsaConnected_::_1_::dtor_18(__int64 a1, __int64 a2)
{
  if ( (*(_DWORD *)(a2 + 56) & 4) != 0 )
  {
    *(_DWORD *)(a2 + 56) &= ~4u;
