/*
 * XREFs of ?GetMany@?$IVectorView_impl@PEAUIInspectable@@$00@Collections@Foundation@Windows@@UEAAJIIPEAPEAUIInspectable@@PEAI@Z @ 0x1800DE7C0
 * Callers:
 *     <none>
 * Callees:
 *     memset_0 @ 0x18002245D (memset_0.c)
 *     ??$_Cleanup@UIInspectable@@I@Detail@Collections@Foundation@Windows@@YAXQEAPEAUIInspectable@@I@Z @ 0x1800DB9B0 (--$_Cleanup@UIInspectable@@I@Detail@Collections@Foundation@Windows@@YAXQEAPEAUIInspectable@@I@Z.c)
