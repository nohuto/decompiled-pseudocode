/*
 * XREFs of ??$use_facet@V?$codecvt@DDH@std@@@std@@YAAEBV?$codecvt@DDH@0@AEBVlocale@0@@Z @ 0x18000607C
 * Callers:
 ...
 *     ?_Getcat@?$codecvt@DDH@std@@SA_KPEAPEBVfacet@locale@2@PEBV42@@Z @ 0x180006EA4 (-_Getcat@-$codecvt@DDH@std@@SA_KPEAPEBVfacet@locale@2@PEBV42@@Z.c)
