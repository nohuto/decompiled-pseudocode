/*
 * XREFs of _Windows::Services::TargetedContent::Internal::SubscribeToFeatureReportingUsage_::_1_::catch$3 @ 0x1800F2DA7
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall Windows::Services::TargetedContent::Internal::SubscribeToFeatureReportingUsage_::_1_::catch_3(
        __int64 a1,
        __int64 a2,
        __int64 a3,
        const char *a4)
