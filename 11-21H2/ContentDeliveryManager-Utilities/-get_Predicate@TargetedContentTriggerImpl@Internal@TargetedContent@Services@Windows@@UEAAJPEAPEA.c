/*
 * XREFs of ?get_Predicate@TargetedContentTriggerImpl@Internal@TargetedContent@Services@Windows@@UEAAJPEAPEAUHSTRING__@@@Z @ 0x180096E20
 * Callers:
 *     <none>
 * Callees:
        ...
        HSTRING *a2)
{
  ...
  v5 = WindowsDuplicateString(*((HSTRING *)this + 12), a2);
  v6 = v5;
  if ( v5 >= 0 )
  {
    if ( v4 )
