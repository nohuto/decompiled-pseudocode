...
_QWORD *__fastcall CreativeFramework::Actions::MakeSetLockScreenHotspotsService(_QWORD *a1, __int64 a2, void ***a3)
{
  ...
  char v15; // bl
  int v17[2]; // [rsp+40h] [rbp-69h] BYREF
  __int64 v18; // [rsp+50h] [rbp-59h]
  unsigned __int64 v19; // [rsp+58h] [rbp-51h]
  void *v20[3]; // [rsp+60h] [rbp-49h] BYREF
  unsigned __int64 v21; // [rsp+78h] [rbp-31h]
  void *v22[3]; // [rsp+80h] [rbp-29h] BYREF
  unsigned __int64 v23; // [rsp+98h] [rbp-11h]
  void *v24[4]; // [rsp+A0h] [rbp-9h] BYREF
