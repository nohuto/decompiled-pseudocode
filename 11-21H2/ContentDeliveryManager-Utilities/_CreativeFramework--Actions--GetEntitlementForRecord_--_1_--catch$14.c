/*
 * XREFs of _CreativeFramework::Actions::GetEntitlementForRecord_::_1_::catch$14 @ 0x1800F429C
 * Callers:
 *     <none>
 * Callees:
...
void __fastcall __noreturn CreativeFramework::Actions::GetEntitlementForRecord_::_1_::catch_14(
        wil *a1,
        __int64 a2,
        unsigned int a3)
{
