/*
 * XREFs of ?message@_Iostream_error_category@std@@UEBA?AV?$basic_string@DU?$char_traits@D@std@@V?$allocator@D@2@@2@H@Z @ 0x18004A9B0
 * Callers:
 *     <none>
 * Callees:
 *     ?_Syserror_map@std@@YAPEBDH@Z @ 0x180004390 (-_Syserror_map@std@@YAPEBDH@Z.c)
