/*
 * XREFs of ?_Getffldx@?$num_get@_WV?$istreambuf_iterator@_WU?$char_traits@_W@std@@@std@@@std@@AEBAHPEADAEAV?$istreambuf_iterator@_WU?$char_traits@_W@std@@@2@1AEAVios_base@2@PEAH@Z @ 0x1800CB720
 * Callers:
        ...
        int *a6)
{
  ...
  v11 = std::use_facet<std::numpunct<wchar_t>>(&v64);
  v64 = (__int64)v11;
  if ( v9 )
  {
  ...
  v14 = std::use_facet<std::ctype<wchar_t>>(&v63);
  if ( v13 )
  {
