/*
 * XREFs of ??$?0PEB_WPEB_WPEB_W_N@?$_Ref_count_obj@VPinToStartService@Actions@CreativeFramework@@@std@@QEAA@$$QEAPEB_W00$$QEA_N@Z @ 0x1800BBEE8
 * Callers:
        ...
        char *a5)
{
  ...
  *(_WORD *)(v6 + 40) = 0;
  ...
  std::wstring::assign((unsigned __int64 *)(v6 + 40), v9, v15);
  *(_QWORD *)(v6 + 96) = 7LL;
  *(_QWORD *)(v6 + 88) = 0LL;
  *(_WORD *)(v6 + 72) = 0;
  if ( *(_WORD *)v8 )
  ...
  std::wstring::assign((unsigned __int64 *)(v6 + 72), v8, v12);
  *(_BYTE *)(v6 + 104) = v7;
  return a1;
}
