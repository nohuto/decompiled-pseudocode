/*
 * XREFs of ?LaunchToastNotification@NotificationManager@ContentManagement@@UEAAJPEAUHSTRING__@@0E_K0@Z @ 0x18003AE70
 * Callers:
 *     <none>
 * Callees:
        ...
        HSTRING string)
{
  ...
  try
  {
    ...
    v9 = *v19;
    v18 = 0LL;
    v10 = (*(__int64 (__fastcall **)(__int64 *, __int64 *))(v9 + 24))(v19, &v18);
    if ( v10 < 0 )
      wil::details::in1diag3::Throw_Hr(
        retaddr,
        (void *)0xE8,
