/*
 * XREFs of ?do_transform@?$collate@_W@std@@MEBA?AV?$basic_string@_WU?$char_traits@_W@std@@V?$allocator@_W@2@@2@PEB_W0@Z @ 0x18001B420
 * Callers:
 *     <none>
 * Callees:
  ...
  *(_WORD *)a2 = 0;
  ...
  if ( v8 )
  {
    ...
    while ( 1 )
    {
      if ( v8 > v10 )
      {
        std::wstring::append(a2, v8 - v10, 0LL);
      }
      else
      {
