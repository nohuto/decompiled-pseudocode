/*
 * XREFs of ?FireCompletion@?$AsyncBase@U?$IAsyncOperationCompletedHandler@PEAUHSTRING__@@@Foundation@Windows@@VNil@Details@WRL@Microsoft@@$00U?$AsyncOptions@$0?0$0A@$1?GUID_CAUSALITY_WINDOWS_PLATFORM_ID@@3U_GUID@@B$01@67@@WRL@Microsoft@@UEAAJXZ @ 0x180032D90
 * Callers:
 *     <none>
 * Callees:
        ...
        signed __int32 *a1)
{
  ...
  if ( *((_QWORD *)a1 + 3) && _InterlockedIncrement(a1 + 4) == 1 )
  {
    ...
    if ( v5(a1, &GUID_3e1fe603_f897_5263_b328_0806426b8a79, &v15) >= 0 )
    {
      v14 = -2;
