/*
 * XREFs of ??_G_Fac_node@std@@QEAAPEAXI@Z @ 0x180004D80
 * Callers:
 *     std::_dynamic_atexit_destructor_for___Fac_tidy_reg___0 @ 0x1800F7740 (std--_dynamic_atexit_destructor_for___Fac_tidy_reg___0.c)
 * Callees:
