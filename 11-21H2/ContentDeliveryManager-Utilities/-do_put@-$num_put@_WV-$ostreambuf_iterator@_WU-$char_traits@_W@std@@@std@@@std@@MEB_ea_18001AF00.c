/*
 * XREFs of ?do_put@?$num_put@_WV?$ostreambuf_iterator@_WU?$char_traits@_W@std@@@std@@@std@@MEBA?AV?$ostreambuf_iterator@_WU?$char_traits@_W@std@@@2@V32@AEAVios_base@2@_W_N@Z @ 0x18001AF00
 * Callers:
 *     <none>
 * Callees:
        ...
        char a6)
{
  ...
  if ( (*(_DWORD *)(a4 + 24) & 0x4000) != 0 )
  {
    ...
    v10 = (__int64 *)std::use_facet<std::numpunct<wchar_t>>(v21);
    if ( v9 )
    {
