/*
 * XREFs of ?CreateCreativeRule@Internal@TargetedContent@Services@Windows@@YA?AV?$shared_ptr@VCreativeRule@RuleSetHandlers@CreativeFramework@@@std@@PEAUITargetedContentTriggerInternal@1234@@Z @ 0x18009C22C
 * Callers:
...
_QWORD *__fastcall Windows::Services::TargetedContent::Internal::CreateCreativeRule(_QWORD *a1, __int64 a2)
{
  ...
  HSTRING v16; // [rsp+88h] [rbp+50h] BYREF
  HSTRING string; // [rsp+90h] [rbp+58h] BYREF
  _DWORD *v18; // [rsp+98h] [rbp+60h]
