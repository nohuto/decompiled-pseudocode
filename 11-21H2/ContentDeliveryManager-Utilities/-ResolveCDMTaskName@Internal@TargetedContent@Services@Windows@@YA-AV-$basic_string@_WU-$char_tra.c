/*
 * XREFs of ?ResolveCDMTaskName@Internal@TargetedContent@Services@Windows@@YA?AV?$basic_string@_WU?$char_traits@_W@std@@V?$allocator@_W@2@@std@@PEB_W@Z @ 0x1800A65A0
 * Callers:
...
_QWORD *__fastcall Windows::Services::TargetedContent::Internal::ResolveCDMTaskName(_QWORD *a1, __int64 a2)
{
  ...
  std::wstring::assign((unsigned __int64 *)v11, v4, v5);
  a1[3] = 7LL;
  a1[2] = 0LL;
  *(_WORD *)a1 = 0;
