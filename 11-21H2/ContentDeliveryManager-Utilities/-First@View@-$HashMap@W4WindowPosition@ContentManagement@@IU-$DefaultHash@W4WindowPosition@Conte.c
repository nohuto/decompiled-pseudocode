        ...
        __int64 a4)
{
  ...
  v4 = *(_QWORD *)(a1 + 56);
  if ( *(_QWORD *)(v4 + 176) == *(_QWORD *)(a1 + 64) )
    return (*(__int64 (__fastcall **)(__int64))(*(_QWORD *)(v4 + 16) + 48LL))(v4 + 16);
  RoOriginateError(2147483660LL, 0LL, v4, a4);
  return 2147483660LL;
}
