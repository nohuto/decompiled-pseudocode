/*
 * XREFs of ??1ActionRevertedActivity@ContentDeliveryManagerTelemetry@Background@ContentDeliveryManager@@QEAA@XZ @ 0x18007E520
 * Callers:
 *     __lambda_d05d40dcdd1d56fa321a7e7a2b4d6dca_::operator()_::_1_::dtor$3 @ 0x1800F18BC (__lambda_d05d40dcdd1d56fa321a7e7a2b4d6dca_--operator()_--_1_--dtor$3.c)
 * Callees:
