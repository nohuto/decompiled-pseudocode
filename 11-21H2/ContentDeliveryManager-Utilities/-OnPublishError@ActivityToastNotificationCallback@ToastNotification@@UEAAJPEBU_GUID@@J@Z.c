/*
 * XREFs of ?OnPublishError@ActivityToastNotificationCallback@ToastNotification@@UEAAJPEBU_GUID@@J@Z @ 0x180079BC0
 * Callers:
 *     <none>
 * Callees:
 ...
 *     ?Log_HrMsg@in1diag3@details@wil@@YAJPEAXIPEBDJ1ZZ @ 0x1800797D0 (-Log_HrMsg@in1diag3@details@wil@@YAJPEAXIPEBDJ1ZZ.c)
 */
        ...
        unsigned int a3)
{
  ...
  wil::details::in1diag3::Log_HrMsg(
    ...
    v7);
  if ( !SetEvent(this[3]) )
    wil::details::in1diag3::_FailFast_GetLastError(retaddr, (void *)0x91F, v4, v5);
  return 0LL;
}
