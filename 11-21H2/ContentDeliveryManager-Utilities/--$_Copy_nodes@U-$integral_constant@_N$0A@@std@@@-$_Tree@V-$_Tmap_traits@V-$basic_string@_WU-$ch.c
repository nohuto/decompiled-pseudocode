        ...
        char a4)
{
  ...
  if ( !*(_BYTE *)(a2 + 25) )
  {
    ...
    *((_BYTE *)v9 + 24) = *(_BYTE *)(a2 + 24);
    ...
    try
    {
      *v9 = (void *)std::_Tree<std::_Tmap_traits<std::wstring,std::wstring,std::less<std::wstring>,std::allocator<std::pair<std::wstring const,std::wstring>>,0>>::_Copy_nodes<std::integral_constant<bool,0>>(
                      a1,
                      *(_QWORD *)a2,
                      v9,
                      v10);
