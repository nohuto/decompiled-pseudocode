/*
 * XREFs of ?do_get@?$num_get@_WV?$istreambuf_iterator@_WU?$char_traits@_W@std@@@std@@@std@@MEBA?AV?$istreambuf_iterator@_WU?$char_traits@_W@std@@@2@V32@0AEAVios_base@2@AEAHAEAPEAX@Z @ 0x1800CD580
 * Callers:
 *     <none>
 * Callees:
        ...
        unsigned __int64 *a7)
{
  ...
  v11 = std::num_get<wchar_t,std::istreambuf_iterator<wchar_t>>::_Getifld(a1, v18, a3, a4, 2048, &v16);
  if ( v16 )
  {
