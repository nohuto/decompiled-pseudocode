/*
 * XREFs of ?GetLocal@?$ThreadLocalStorage@PEAVThreadFailureCallbackHolder@details@wil@@@details_abi@wil@@QEAAPEAPEAVThreadFailureCallbackHolder@details@3@_N@Z @ 0x180036444
 * Callers:
        ...
        char a2)
{
  ...
  if ( !a2 )
    return 0LL;
  v8 = wil::details::ProcessHeapAlloc(0, 0x18uLL, v5);
  ...
  *(_DWORD *)v8 = CurrentThreadId;
  v8[1] = 0LL;
  v8[2] = 0LL;
  _m_prefetchw((const void *)(v3 + 8 * v6));
  do
  {
    v10 = *(_QWORD *)(v3 + 8 * v6);
    *(_QWORD *)(v9 + 8) = v10;
  }
  while ( v10 != _InterlockedCompareExchange64((volatile signed __int64 *)(v3 + 8 * v6), v9, v10) );
  return v9 + 16;
}
