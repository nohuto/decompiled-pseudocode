/*
 * XREFs of _lambda_0d276c7ea3d710d19b822c1822ed0068_::operator() @ 0x18007E7F8
 * Callers:
 *     Windows::Internal::COperationLambdaVar_0__lambda_0d276c7ea3d710d19b822c1822ed0068__Windows::Internal::CNoResult_::Run @ 0x180080E70 (Windows--Internal--COperationLambdaVar_0__lambda_0d276c7ea3d710d19b822c1822ed0068__Windows--Inte.c)
 * Callees:
...
__int64 __fastcall lambda_0d276c7ea3d710d19b822c1822ed0068_::operator()(_QWORD *a1)
{
  __int64 v1; // r15
  __int64 *v2; // rbx
  __int64 v3; // rax
  ...
  v34 = 0LL;
  v35 = 0LL;
  v21[0] = &ContentDeliveryManager::Background::ContentDeliveryManagerTelemetry::ActionStagedActivity::`vftable';
  ContentDeliveryManager::Background::ContentDeliveryManagerTelemetry::ActionStagedActivity::StartActivity(
    (ContentDeliveryManager::Background::ContentDeliveryManagerTelemetry::ActionStagedActivity *)v21,
    v8,
    v6,
    v4);
  if ( v14 >= 8 )
  ...
  try
  {
    ...
    v19 = 0LL;
    LOWORD(v18[0]) = 0;
    (*(void (__fastcall **)(_QWORD))(**(_QWORD **)(v1 + 72) + 24LL))(*(_QWORD *)(v1 + 72));
