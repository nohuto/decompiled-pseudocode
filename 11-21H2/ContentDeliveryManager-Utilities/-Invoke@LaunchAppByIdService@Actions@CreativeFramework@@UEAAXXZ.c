/*
 * XREFs of ?Invoke@LaunchAppByIdService@Actions@CreativeFramework@@UEAAXXZ @ 0x1800C5D20
 * Callers:
 *     <none>
 * Callees:
        ...
        unsigned int a3)
{
  ...
  v4 = *v13;
  v12 = 0LL;
  v5 = (*(__int64 (__fastcall **)(__int64 *, __int64 *))(v4 + 88))(v13, &v12);
  if ( v5 < 0 )
    wil::details::in1diag3::Throw_Hr(
      ...
      v12);
  v7 = v12;
  v8 = *(__int64 (__fastcall **)(__int64, PVOID))(*(_QWORD *)v12 + 64LL);
