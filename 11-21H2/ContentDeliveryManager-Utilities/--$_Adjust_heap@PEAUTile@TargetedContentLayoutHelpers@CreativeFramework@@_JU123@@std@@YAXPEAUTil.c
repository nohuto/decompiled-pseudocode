/*
 * XREFs of ??$_Adjust_heap@PEAUTile@TargetedContentLayoutHelpers@CreativeFramework@@_JU123@@std@@YAXPEAUTile@TargetedContentLayoutHelpers@CreativeFramework@@_J1$$QEAU123@@Z @ 0x1800E4840
 * Callers:
        ...
        __int64 a4)
{
  ...
  if ( a2 < v7 )
  {
    ...
    {
      v14 = (v7 - 1) / 2;
      if ( !(unsigned __int8)CreativeFramework::TargetedContentLayoutHelpers::Tile::operator<(a1 + 56 * v14, a4) )
        break;
