/*
 * XREFs of _Towupper @ 0x180005E24
 * Callers:
 *     ?do_toupper@?$ctype@G@std@@MEBAGG@Z @ 0x18006B5B0 (-do_toupper@-$ctype@G@std@@MEBAGG@Z.c)
 *     ?do_toupper@?$ctype@_W@std@@MEBAPEB_WPEA_WPEB_W@Z @ 0x18006B5D0 (-do_toupper@-$ctype@_W@std@@MEBAPEB_WPEA_WPEB_W@Z.c)
 * Callees:
 *     _GetLocaleHandleByType @ 0x18000D254 (_GetLocaleHandleByType.c)
 *     __crtLCMapStringW_Stub @ 0x18000D314 (__crtLCMapStringW_Stub.c)
 */
