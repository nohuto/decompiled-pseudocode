/*
 * XREFs of ??$CreateActivationFactory@V?$SimpleSealedActivationFactory@VContentDeliveryManagerAppInfoProvider@ApplicationModel@Extensions@Internal@Windows@@$0A@@WRL@Microsoft@@@Details@WRL@Microsoft@@YAJPEAIPEBUCreatorMap@012@AEBU_GUID@@PEAPEAUIUnknown@@@Z @ 0x1800D80B0
 * Callers:
 *     <none>
 * Callees:
    ...
    *a4 = v9;
    if ( (*a1 & 4) == 0 )
    {
      ...
      while ( v11 != 0x7FFFFFFF
           && v11 != _InterlockedCompareExchange((volatile signed __int32 *)(v9 + 12), v11 + 1, v11) );
    }
