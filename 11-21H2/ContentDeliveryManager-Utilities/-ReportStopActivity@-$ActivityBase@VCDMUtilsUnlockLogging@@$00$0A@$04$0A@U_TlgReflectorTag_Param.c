/*
 * XREFs of ?ReportStopActivity@?$ActivityBase@VCDMUtilsUnlockLogging@@$00$0A@$04$0A@U_TlgReflectorTag_Param0IsProviderType@@@wil@@AEAAXJ@Z @ 0x1800B6EA0
 * Callers:
        ...
        int a2)
{
  ...
  if ( a2 < 0 )
  {
    ...
    {
      v9 = CDMUtilsUnlockLogging::Provider();
      v10 = (__int64)v9;
      if ( *(_DWORD *)v9 > 2u
