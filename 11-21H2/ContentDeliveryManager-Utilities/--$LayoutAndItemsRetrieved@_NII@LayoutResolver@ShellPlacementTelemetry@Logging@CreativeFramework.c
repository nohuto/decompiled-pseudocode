/*
 * XREFs of ??$LayoutAndItemsRetrieved@_NII@LayoutResolver@ShellPlacementTelemetry@Logging@CreativeFramework@@QEAAX$$QEA_N$$QEAI1@Z @ 0x1800DAEA0
 * Callers:
        ...
        int *a4)
{
  ...
  if ( *(_DWORD *)v8 > 5u )
  {
    ...
    LODWORD(v8) = tlgWriteTransfer_EventWriteTransfer(
                    (__int64)v8,
                    (unsigned __int8 *)dword_180194353,
                    (const GUID *)(v11 + 8),
                    0LL,
                    5u,
                    &v16);
