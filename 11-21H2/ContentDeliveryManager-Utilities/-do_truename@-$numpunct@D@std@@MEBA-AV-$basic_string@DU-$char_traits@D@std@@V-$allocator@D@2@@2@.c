/*
 * XREFs of ?do_truename@?$numpunct@D@std@@MEBA?AV?$basic_string@DU?$char_traits@D@std@@V?$allocator@D@2@@2@XZ @ 0x18000AF60
 * Callers:
 *     <none>
 * Callees:
...
_QWORD *__fastcall std::numpunct<char>::do_truename(__int64 a1, _QWORD *a2)
{
  size_t v3; // r8
  _BYTE *v4; // rdx
  __int64 v5; // rax
