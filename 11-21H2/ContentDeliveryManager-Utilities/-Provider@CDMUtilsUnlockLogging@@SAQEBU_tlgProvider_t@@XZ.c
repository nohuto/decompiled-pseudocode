/*
 * XREFs of ?Provider@CDMUtilsUnlockLogging@@SAQEBU_tlgProvider_t@@XZ @ 0x1800B63B4
 * Callers:
...
const struct _tlgProvider_t *CDMUtilsUnlockLogging::Provider(void)
{
  ...
  {
    Context = &qword_1801AF508;
    qword_1801AF508 = &CreativeFramework::Logging::ShellPlacementLogging::`vftable';
    qword_1801AF520 = (struct _tlgProvider_t *)&`CDMUtilsUnlockLogging::StaticHandle::StaticHandle'::`2'::__hInner;
    atexit(_lambda_fcb9b5ef2ad8bfd832238adf5d8bb457_::_lambda_invoker_cdecl_);
    wil::TraceLoggingProvider::Register((wil::TraceLoggingProvider *)&qword_1801AF508, qword_1801AF520, v0);
    InitOnceComplete(&`CDMUtilsUnlockLogging::Instance'::`2'::wrapper, 0, &qword_1801AF508);
  }
