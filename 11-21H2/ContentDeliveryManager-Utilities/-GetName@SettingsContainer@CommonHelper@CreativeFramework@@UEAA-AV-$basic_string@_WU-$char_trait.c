/*
 * XREFs of ?GetName@SettingsContainer@CommonHelper@CreativeFramework@@UEAA?AV?$basic_string@_WU?$char_traits@_W@std@@V?$allocator@_W@2@@std@@XZ @ 0x1800ECB40
 * Callers:
 *     <none>
 * Callees:
...
unsigned __int64 *__fastcall CreativeFramework::CommonHelper::SettingsContainer::GetName(
        __int64 a1,
        unsigned __int64 *a2)
{
  int v3; // eax
