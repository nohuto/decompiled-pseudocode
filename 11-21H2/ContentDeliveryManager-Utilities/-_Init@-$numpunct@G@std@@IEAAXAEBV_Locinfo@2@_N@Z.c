/*
 * XREFs of ?_Init@?$numpunct@G@std@@IEAAXAEBV_Locinfo@2@_N@Z @ 0x180068DB8
 * Callers:
 ...
 *     ?_Getcat@?$numpunct@G@std@@SA_KPEAPEBVfacet@locale@2@PEBV42@@Z @ 0x180067204 (-_Getcat@-$numpunct@G@std@@SA_KPEAPEBVfacet@locale@2@PEBV42@@Z.c)
 * Callees:
...
wchar_t *__fastcall std::numpunct<unsigned short>::_Init(mbstate_t a1, __int64 a2, char a3)
{
  ...
  *(_QWORD *)(*(_QWORD *)&a1 + 40LL) = 0LL;
  ...
  {
    ((void (__fastcall *)(_QWORD))std::numpunct<wchar_t>::_Tidy)(v15);
    throw;
  }
  if ( a3 )
  {
