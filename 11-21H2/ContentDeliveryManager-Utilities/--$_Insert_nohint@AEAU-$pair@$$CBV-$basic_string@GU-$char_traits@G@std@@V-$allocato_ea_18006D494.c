        ...
        _QWORD *a5)
{
  ...
  {
    v8 = v9;
    v11 = std::less<std::wstring>::operator()((__int64)a1, a4, v9 + 4);
    v10 = v11;
    if ( v11 )
      v9 = (__int64 *)*v9;
    else
  ...
  try
  {
    ...
    {
      v15 = a5;
      std::pair<std::wstring const,std::wstring>::~pair<std::wstring const,std::wstring>(a5 + 4);
      operator delete(v15);
      *(_QWORD *)a2 = v12;
      *(_BYTE *)(a2 + 8) = 0;
    }
