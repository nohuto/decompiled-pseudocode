/*
 * XREFs of ?StartActivity@LayoutResolver@ShellPlacementTelemetry@Logging@CreativeFramework@@QEAAXPEB_W@Z @ 0x1800E38BC
 * Callers:
        ...
        const wchar_t *a2)
{
  ...
  const wchar_t *v20; // [rsp+88h] [rbp+27h]
  ...
  *(_DWORD *)v4 = 1;
    ...
    && (*((_QWORD *)v6 + 3) & 0x400000000000LL) == *((_QWORD *)v6 + 3) )
  {
    ...
    v16 = &v14;
    v17 = 8LL;
    tlgWriteTransfer_EventWriteTransfer(v7, (unsigned __int8 *)dword_18019444C, v10, v9, 5u, &v15);
  }
  if ( !*((_DWORD *)this + 8) )
