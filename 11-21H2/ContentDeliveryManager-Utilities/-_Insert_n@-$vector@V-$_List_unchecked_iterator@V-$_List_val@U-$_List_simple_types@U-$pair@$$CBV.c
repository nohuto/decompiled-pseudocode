        ...
        __int64 *a5)
{
  ...
  bool v23; // cc
  _QWORD *v24; // r14
  _QWORD *v26; // [rsp+60h] [rbp+8h] BYREF
  _QWORD *v27; // [rsp+68h] [rbp+10h]
  ...
  if ( a4 )
  {
    ...
    if ( (__int64)(*(_QWORD *)(a1 + 16) - (_QWORD)v10) >> 3 >= a4 )
    {
      ...
      if ( v10 - a3 >= a4 )
      {
        v24 = &v10[v20 / 0xFFFFFFFFFFFFFFF8uLL];
        *(_QWORD *)(a1 + 8) = std::_Uninit_move<std::_List_unchecked_iterator<std::_List_val<std::_List_simple_types<std::pair<std::wstring const,std::shared_ptr<ContentManagement::TargetedContent::Internal::SubscriptionManagerImpl::SubscriptionMapValue>>>>> *,std::_List_unchecked_iterator<std::_List_val<std::_List_simple_types<std::pair<std::wstring const,std::shared_ptr<ContentManagement::TargetedContent::Internal::SubscriptionManagerImpl::SubscriptionMapValue>>>>> *,std::_Wrap_alloc<std::allocator<std::_List_unchecked_iterator<std::_List_val<std::_List_simple_types<std::pair<std::wstring const,std::shared_ptr<ContentManagement::TargetedContent::Internal::SubscriptionManagerImpl::SubscriptionMapValue>>>>>>>,std::_List_unchecked_iterator<std::_List_val<std::_List_simple_types<std::pair<std::wstring const,std::shared_ptr<ContentManagement::TargetedContent::Internal::SubscriptionManagerImpl::SubscriptionMapValue>>>>>>(
        ...
        {
          --v24;
          v24[(unsigned __int64)v20 / 8] = *v24;
        }
        v22 = (unsigned __int64)(v20 + 7) >> 3;
        v23 = a3 <= &a3[(unsigned __int64)v20 / 8];
      }
      else
      {
        v26 = (_QWORD *)*a5;
    ...
    else
    {
      ...
      if ( v12 )
      {
        if ( v12 > 0x1FFFFFFFFFFFFFFFLL || (v15 = operator new(8 * v12), (v26 = v15) == 0LL) )
          std::_Xbad_alloc();
      }
      ...
      {
        std::_Wrap_alloc<std::_Wrap_alloc<std::allocator<std::_List_unchecked_iterator<std::_List_val<std::_List_simple_types<std::pair<std::wstring const,std::shared_ptr<ContentManagement::TargetedContent::Internal::SubscriptionManagerImpl::SubscriptionMapValue>>>>>>>>::deallocate(
          v17,
          v26);
        throw;
      }
