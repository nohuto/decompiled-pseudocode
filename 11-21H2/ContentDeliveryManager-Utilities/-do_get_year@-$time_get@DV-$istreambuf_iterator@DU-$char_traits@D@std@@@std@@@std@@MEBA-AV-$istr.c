/*
 * XREFs of ?do_get_year@?$time_get@DV?$istreambuf_iterator@DU?$char_traits@D@std@@@std@@@std@@MEBA?AV?$istreambuf_iterator@DU?$char_traits@D@std@@@2@V32@0AEAVios_base@2@AEAHPEAUtm@@@Z @ 0x180020340
 * Callers:
 *     <none>
 * Callees:
        ...
        __int64 a7)
{
  ...
  LODWORD(a5) = 0;
  v14 = std::time_get<char,std::istreambuf_iterator<char>>::_Getint(a1, a3, a4, 0, 2035, &a5, (__int64)v12);
  v15 = a6;
  v16 = v14 | *a6;
  *a6 = v16;
  if ( (v16 & 2) == 0 )
