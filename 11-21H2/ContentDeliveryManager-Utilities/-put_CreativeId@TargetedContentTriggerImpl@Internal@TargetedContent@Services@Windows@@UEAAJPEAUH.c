/*
 * XREFs of ?put_CreativeId@TargetedContentTriggerImpl@Internal@TargetedContent@Services@Windows@@UEAAJPEAUHSTRING__@@@Z @ 0x1800974A0
 * Callers:
 *     <none>
 * Callees:
        ...
        HSTRING a2)
{
  ...
  if ( a2 && a2 == *((HSTRING *)this + 16)
    || (WindowsDeleteString(*((HSTRING *)this + 16)),
        *((_QWORD *)this + 16) = 0LL,
        v5 = WindowsDuplicateString(a2, (HSTRING *)this + 16),
        v6 = v5,
        v5 >= 0) )
  {
    if ( v4 )
