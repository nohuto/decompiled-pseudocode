/*
 * XREFs of ??0?$basic_stringstream@GU?$char_traits@G@std@@V?$allocator@G@2@@std@@QEAA@H@Z @ 0x18006DC44
 * Callers:
        ...
        char a3)
{
  ...
  *a1 = &std::basic_stringstream<unsigned short,std::char_traits<unsigned short>,std::allocator<unsigned short>>::`vbtable'{for `std::basic_istream<unsigned short>'};
  ...
  v4 = (__int64)(a1 + 3);
  std::basic_istream<unsigned short>::basic_istream<unsigned short>(a1, (__int64)(a1 + 3), a3);
  *(_QWORD *)((char *)a1 + *(int *)(a1[2] + 4LL) + 16) = &std::basic_ostream<unsigned short>::`vftable';
  v5 = *(int *)(a1[2] + 4LL);
  *(_DWORD *)((char *)a1 + v5 + 12) = v5 - 16;
