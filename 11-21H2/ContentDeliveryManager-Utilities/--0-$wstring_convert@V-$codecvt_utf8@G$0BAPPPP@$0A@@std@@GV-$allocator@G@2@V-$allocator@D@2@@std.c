/*
 * XREFs of ??0?$wstring_convert@V?$codecvt_utf8@G$0BAPPPP@$0A@@std@@GV?$allocator@G@2@V?$allocator@D@2@@std@@QEAA@XZ @ 0x1800760D8
 * Callers:
        ...
        __int64 a1)
{
  ...
  _Cvtvec v13; // [rsp+20h] [rbp-B8h] BYREF
  _BYTE v14[136]; // [rsp+50h] [rbp-88h] BYREF
  struct std::locale::facet *v15; // [rsp+E8h] [rbp+10h] BYREF
  ...
  *(_QWORD *)(a1 + 8) = v3;
  ...
  if ( v3 )
  {
    ...
    std::locale::_Locimp::_Locimp_Addfac((void **)v5, v3, v6);
    *((_DWORD *)v5 + 8) = 0;
