/*
 * XREFs of ?QueryInterface@?$RuntimeClassImpl@U?$RuntimeClassFlags@$01@WRL@Microsoft@@$00$0A@$0A@U?$IAsyncOperationCompletedHandler@PEAU?$IVectorView@PEAVWebAccount@Credentials@Security@Windows@@@Collections@Foundation@Windows@@@Foundation@Windows@@VFtmBase@23@@Details@WRL@Microsoft@@UEAAJAEBU_GUID@@PEAPEAX@Z @ 0x18003CF80
 * Callers:
 *     ?QueryInterface@?$RuntimeClassImpl@U?$RuntimeClassFlags@$01@WRL@Microsoft@@$00$0A@$0A@U?$IAsyncOperationCompletedHandler@PEAU?$IVectorView@PEAVWebAccount@Credentials@Security@Windows@@@Collections@Foundation@Windows@@@Foundation@Windows@@VFtmBase@23@@Details@WRL@Microsoft@@W7EAAJAEBU_GUID@@PEAPEAX@Z @ 0x18003D070 (-QueryInterface@-$RuntimeClassImpl@U-$RuntimeClassFlags@$01@WRL@Microsoft@@$00$0A@$_ea_18003D070.c)
 * Callees:
        ...
        __int64 *a3)
{
  ...
  *a3 = 0LL;
  ...
  {
    if ( *a2 == -1039594100
      && a2[1] == *(_DWORD *)&GUID_c2090d8c_37d8_5c47_9581_0f17b91a0cd3.Data2
      && a2[2] == *(_DWORD *)GUID_c2090d8c_37d8_5c47_9581_0f17b91a0cd3.Data4
      && a2[3] == *(_DWORD *)&GUID_c2090d8c_37d8_5c47_9581_0f17b91a0cd3.Data4[4] )
    {
      goto LABEL_19;
    }
LABEL_10:
