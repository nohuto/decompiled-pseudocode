/*
 * XREFs of ??$CreateClassFactory@V?$SimpleClassFactory@VNotificationsTargetedContentClient@ToastNotification@@$0A@@WRL@Microsoft@@@Details@WRL@Microsoft@@YAJPEAIPEBUCreatorMap@012@AEBU_GUID@@PEAPEAUIUnknown@@@Z @ 0x180074870
 * Callers:
 *     <none>
 * Callees:
        ...
        __int64 a4)
{
  ...
  *(_QWORD *)v7 = &Microsoft::WRL::SimpleClassFactory<ToastNotification::NotificationsTargetedContentClient,0>::`vftable';
  Microsoft::WRL::ClassFactory<Microsoft::WRL::Details::Nil,Microsoft::WRL::Details::Nil,Microsoft::WRL::Details::Nil,0>::AddRef(v7);
