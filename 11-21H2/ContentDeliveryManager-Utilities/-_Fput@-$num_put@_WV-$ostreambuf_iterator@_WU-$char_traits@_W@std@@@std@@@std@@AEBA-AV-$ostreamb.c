/*
 * XREFs of ?_Fput@?$num_put@_WV?$ostreambuf_iterator@_WU?$char_traits@_W@std@@@std@@@std@@AEBA?AV?$ostreambuf_iterator@_WU?$char_traits@_W@std@@@2@V32@AEAVios_base@2@_WPEBD_K444@Z @ 0x180010460
 * Callers:
 *     ?do_put@?$num_put@_WV?$ostreambuf_iterator@_WU?$char_traits@_W@std@@@std@@@std@@MEBA?AV?$ostreambuf_iterator@_WU?$char_traits@_W@std@@@2@V32@AEAVios_base@2@_WN@Z @ 0x18001A940 (-do_put@-$num_put@_WV-$ostreambuf_iterator@_WU-$char_traits@_W@std@@@std@@@std@@MEB_ea_18001A940.c)
 *     ?do_put@?$num_put@_WV?$ostreambuf_iterator@_WU?$char_traits@_W@std@@@std@@@std@@MEBA?AV?$ostreambuf_iterator@_WU?$char_traits@_W@std@@@2@V32@AEAVios_base@2@_WO@Z @ 0x18001AB10 (-do_put@-$num_put@_WV-$ostreambuf_iterator@_WU-$char_traits@_W@std@@@std@@@std@@MEB_ea_18001AB10.c)
 * Callees:
        ...
        unsigned __int64 a10)
{
  ...
  *(_QWORD *)&v51 = strcspn(Str, (const char *)&Control);
  ...
  v53 = std::use_facet<std::ctype<wchar_t>>(&v53);
  if ( v15 )
  {
  ...
  v19 = v53;
  LOBYTE(v16) = 48;
  v50 = (*(__int64 (__fastcall **)(__int64, __int64, void (__fastcall ***)(_QWORD, __int64)))(*(_QWORD *)v53 + 96LL))(
          v53,
          v16,
          v17);
  v59 = 7LL;
  ...
  v22 = std::use_facet<std::numpunct<wchar_t>>(&v53);
  if ( v21 )
  {
  ...
  (*(void (__fastcall **)(__int64, void **, void (__fastcall ***)(_QWORD, __int64)))(*(_QWORD *)v22 + 40LL))(
    ...
    v60,
    v23);
  v52 = (*(__int64 (__fastcall **)(__int64))(*(_QWORD *)v22 + 32LL))(v22);
  v25 = v51;
  v26 = v50;
  if ( (_QWORD)v51 != a10 )
  {
