/*
 * XREFs of ?do_put@?$money_put@_WV?$ostreambuf_iterator@_WU?$char_traits@_W@std@@@std@@@std@@MEBA?AV?$ostreambuf_iterator@_WU?$char_traits@_W@std@@@2@V32@_NAEAVios_base@2@_WAEBV?$basic_string@_WU?$char_traits@_W@std@@V?$allocator@_W@2@@2@@Z @ 0x180019900
 * Callers:
 *     <none>
 * Callees:
        ...
        _QWORD *a7)
{
  ...
  *(_QWORD *)&v26 = v11;
  ...
  v12 = std::use_facet<std::ctype<wchar_t>>(&v26);
  if ( v11 )
  {
  ...
  v26 = *a3;
  std::money_put<wchar_t,std::ostreambuf_iterator<wchar_t>>::_Putmfld(a1, a2, &v26, a4, a5, a6, v14, v27, v23);
  if ( v30 >= 8 )
