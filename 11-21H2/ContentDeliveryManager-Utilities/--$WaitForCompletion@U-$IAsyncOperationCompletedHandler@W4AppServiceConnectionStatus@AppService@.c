        ...
        void **a3)
{
  ...
  __int64 v13; // rcx
  void **v14; // rcx
  APTTYPE v16; // [rsp+20h] [rbp-28h]
  APTTYPEQUALIFIER v17; // [rsp+28h] [rbp-20h]
  void *v18[3]; // [rsp+30h] [rbp-18h] BYREF
  __int64 v19; // [rsp+70h] [rbp+28h] BYREF
  signed int v20; // [rsp+78h] [rbp+30h] BYREF
...
LABEL_5:
  ...
  *(_QWORD *)v4 = `WaitForCompletion<Windows::Foundation::IAsyncOperationCompletedHandler<enum Windows::ApplicationModel::AppService::AppServiceConnectionStatus>,Windows::Foundation::IAsyncOperation<enum Windows::ApplicationModel::AppService::AppServiceConnectionStatus>>'::`2'::FTMEventDelegate::`vftable';
  *((_QWORD *)v4 + 1) = &Microsoft::WRL::RuntimeClass<Microsoft::WRL::RuntimeClassFlags<2>,Windows::Foundation::IAsyncOperationCompletedHandler<enum Windows::ApplicationModel::AppService::AppServiceConnectionStatus>,Microsoft::WRL::FtmBase>::`vftable'{for `Microsoft::WRL::Details::ImplementsHelper<Microsoft::WRL::RuntimeClassFlags<2>,1,Microsoft::WRL::Details::ImplementsMarker<Microsoft::WRL::FtmBase>>'};
  v4[12] = 0;
  *((_QWORD *)v4 + 7) = 0LL;
  ...
  if ( v5 >= 0 )
  {
    ...
    if ( v5 >= 0 && *((_DWORD *)v21 + 12) != 1 )
    {
      ...
      if ( v11(a1, &GUID_00000036_0000_0000_c000_000000000046, v12) >= 0 )
        (*(void (__fastcall **)(__int64, signed int *))(*(_QWORD *)v19 + 64LL))(v19, &v20);
      v5 = v20;
    }
    v13 = v19;
    if ( v19 )
