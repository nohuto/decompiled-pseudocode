/*
 * XREFs of ??$?5_WU?$char_traits@_W@std@@_W@std@@YAAEAV?$basic_istream@_WU?$char_traits@_W@std@@@0@AEAV10@AEBU?$_Timeobj@_W@0@@Z @ 0x1800E7DE0
 * Callers:
...
__int64 *__fastcall std::operator>><wchar_t,std::char_traits<wchar_t>,wchar_t>(__int64 *a1, __int64 *a2)
{
  ...
  if ( std::wistream::_Ipfx(v3) )
  {
    ...
    {
      v19 = (char *)a1 + *(int *)(*a1 + 4);
      v20 = *((_DWORD *)v19 + 4) | 4;
      if ( !*((_QWORD *)v19 + 9) )
        LOBYTE(v20) = v19[16] | 4;
      std::ios_base::clear((std::ios_base *)((char *)a1 + *(int *)(*a1 + 4)), v20, 1);
      v3 = a1;
      v4 = a1;
    }
  }
  ...
  if ( v30 )
  {
    ...
    if ( *((_QWORD *)v14 + 9) )
      v16 = v15;
    std::ios_base::clear((std::ios_base *)v14, v16, 0);
    v13 = *v4;
  }
  v17 = *(__int64 *)((char *)v3 + *(int *)(v13 + 4) + 72);
  if ( v17 )
