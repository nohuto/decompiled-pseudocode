/*
 * XREFs of ??$ReportFailure_HrMsg@$01@details@wil@@YAXPEAXIPEBD110J1PEAD@Z @ 0x180074EEC
 * Callers:
        ...
        wil::details *a7)
{
  ...
  wchar_t v18[2048]; // [rsp+70h] [rbp-1028h] BYREF
  ...
  v16 = v14;
  v17 = v15;
  wil::details::PrintLoggingMessage(v18, v10, v11, v12);
