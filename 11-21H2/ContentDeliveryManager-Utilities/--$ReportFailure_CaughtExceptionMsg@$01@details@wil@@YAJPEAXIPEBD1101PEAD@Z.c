/*
 * XREFs of ??$ReportFailure_CaughtExceptionMsg@$01@details@wil@@YAJPEAXIPEBD1101PEAD@Z @ 0x180074E24
 * Callers:
        ...
        char *a8)
{
  ...
  v10 = (int)a2;
  wil::details::PrintLoggingMessage(v16, a2, a7, a8);
  StringCchCatW(v16, 2048LL, (char *)L" -- ");
