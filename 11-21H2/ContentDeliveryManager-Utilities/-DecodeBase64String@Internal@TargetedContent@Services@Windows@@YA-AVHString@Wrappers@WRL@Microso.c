/*
 * XREFs of ?DecodeBase64String@Internal@TargetedContent@Services@Windows@@YA?AVHString@Wrappers@WRL@Microsoft@@PEAUHSTRING__@@@Z @ 0x1800A4A60
 * Callers:
...
HSTRING *__fastcall Windows::Services::TargetedContent::Internal::DecodeBase64String(HSTRING *a1, __int64 a2)
{
  ...
  v9 = 0;
  sourceString = 0LL;
  Windows::Services::TargetedContent::Internal::DecodeBase64ToBtyeArray(a2, &sourceString, &v9);
  v3 = v9 >> 1;
  *a1 = 0LL;
