/*
 * XREFs of ?GetFileNameForRule@DiagTrackRuleSetHandler@RuleSetHandlers@CreativeFramework@@AEAA?AV?$basic_string@_WU?$char_traits@_W@std@@V?$allocator@_W@2@@std@@PEAVCreativeRule@23@@Z @ 0x1800B0D68
 * Callers:
        ...
        void **a3)
{
  ...
  *(_WORD *)a2 = 0;
  ...
  std::wstring::append((char *)a2, (char *)L".xml", 4uLL);
  return a2;
}
