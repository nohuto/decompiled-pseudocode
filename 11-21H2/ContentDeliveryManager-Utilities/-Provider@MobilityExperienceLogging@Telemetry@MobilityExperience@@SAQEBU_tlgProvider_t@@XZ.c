/*
 * XREFs of ?Provider@MobilityExperienceLogging@Telemetry@MobilityExperience@@SAQEBU_tlgProvider_t@@XZ @ 0x18003C030
 * Callers:
...
const struct _tlgProvider_t *MobilityExperience::Telemetry::MobilityExperienceLogging::Provider(void)
{
  ...
  if ( InitOnceBeginInitialize(
    ...
    && fPending )
  {
    Context = qword_1801AEDC0;
    qword_1801AEDC0[0] = &CreativeFramework::Logging::ShellPlacementLogging::`vftable';
    qword_1801AEDD8 = (struct _tlgProvider_t *)&`MobilityExperience::Telemetry::MobilityExperienceLogging::StaticHandle::StaticHandle'::`2'::__hInner;
    atexit(_lambda_e5247b73c30e393fca6255a7d4a63886_::_lambda_invoker_cdecl_);
    wil::TraceLoggingProvider::Register((wil::TraceLoggingProvider *)qword_1801AEDC0, qword_1801AEDD8, v0);
    InitOnceComplete(
      &`MobilityExperience::Telemetry::MobilityExperienceLogging::Instance'::`2'::wrapper,
      0,
      qword_1801AEDC0);
