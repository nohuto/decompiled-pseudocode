/*
 * XREFs of _lambda_1535a6ac74a46a99e57700c911cef706_::operator() @ 0x18007EB34
 * Callers:
 *     Windows::Internal::COperationLambdaVar_0__lambda_1535a6ac74a46a99e57700c911cef706__Windows::Internal::CNoResult_::Run @ 0x180080EB0 (Windows--Internal--COperationLambdaVar_0__lambda_1535a6ac74a46a99e57700c911cef706__Windows--Inte.c)
 * Callees:
...
__int64 __fastcall lambda_1535a6ac74a46a99e57700c911cef706_::operator()(_QWORD *a1)
{
  ...
  v34 = 0LL;
  v35 = 0LL;
  v21[0] = &ContentDeliveryManager::Background::ContentDeliveryManagerTelemetry::ActionCommittedActivity::`vftable';
  ContentDeliveryManager::Background::ContentDeliveryManagerTelemetry::ActionCommittedActivity::StartActivity(
    (ContentDeliveryManager::Background::ContentDeliveryManagerTelemetry::ActionCommittedActivity *)v21,
    v8,
    v6,
    v4);
  if ( v14 >= 8 )
