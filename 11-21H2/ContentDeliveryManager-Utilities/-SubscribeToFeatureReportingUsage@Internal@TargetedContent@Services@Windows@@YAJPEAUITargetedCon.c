/*
 * XREFs of ?SubscribeToFeatureReportingUsage@Internal@TargetedContent@Services@Windows@@YAJPEAUITargetedContentTriggerInternal@1234@V?$shared_ptr@VCorrelationVectorWrapper@Background@ContentDeliveryManager@@@std@@@Z @ 0x1800A6D90
 * Callers:
 *     <none>
 * Callees:
        ...
        unsigned __int16 *a4)
{
  ...
  try
  {
    ...
    v9 = (*(__int64 (__fastcall **)(_QWORD, _QWORD, _QWORD, _QWORD))(*(_QWORD *)v13[0] + 24LL))(
           v13[0],
           v17,
