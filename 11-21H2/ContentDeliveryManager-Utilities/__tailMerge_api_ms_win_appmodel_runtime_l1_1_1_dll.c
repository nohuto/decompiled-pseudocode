/*
 * XREFs of __tailMerge_api_ms_win_appmodel_runtime_l1_1_1_dll @ 0x1800234CE
 * Callers:
 *     __imp_load_FormatApplicationUserModelId @ 0x1800234C2 (__imp_load_FormatApplicationUserModelId.c)
 * Callees:
