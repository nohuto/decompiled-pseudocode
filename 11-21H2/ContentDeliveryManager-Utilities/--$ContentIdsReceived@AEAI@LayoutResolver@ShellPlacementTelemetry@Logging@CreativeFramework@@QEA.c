/*
 * XREFs of ??$ContentIdsReceived@AEAI@LayoutResolver@ShellPlacementTelemetry@Logging@CreativeFramework@@QEAAXAEAI@Z @ 0x1800DAE0C
 * Callers:
        ...
        int *a2)
{
  ...
  if ( *(_DWORD *)v4 > 5u )
  {
    ...
    LODWORD(v4) = tlgWriteTransfer_EventWriteTransfer(
                    (__int64)v4,
                    (unsigned __int8 *)dword_1801943B4,
                    (const GUID *)(v6 + 8),
                    0LL,
                    3u,
                    &v9);
