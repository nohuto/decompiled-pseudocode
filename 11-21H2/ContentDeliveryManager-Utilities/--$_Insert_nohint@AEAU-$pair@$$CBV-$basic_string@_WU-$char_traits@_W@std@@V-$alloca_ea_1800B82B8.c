        ...
        _QWORD *a5)
{
  ...
  try
  {
    ...
    {
      v15 = a5;
      std::pair<std::wstring const,std::wstring>::~pair<std::wstring const,std::wstring>((__int64)(a5 + 4));
      operator delete(v15);
      *(_QWORD *)a2 = v12;
      *(_BYTE *)(a2 + 8) = 0;
    }
