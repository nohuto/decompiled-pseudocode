/*
 * XREFs of ?GetNodeTileId@TargetedContentLayoutXmlUtilities@TargetedContentLayoutHelpers@CreativeFramework@@AEAA?AVHString@Wrappers@WRL@Microsoft@@AEBV?$com_ptr_t@UIXmlNode@Dom@Xml@Data@Windows@@Uerr_exception_policy@wil@@@wil@@@Z @ 0x1800DEFFC
 * Callers:
        ...
        _QWORD *a3)
{
  ...
  v16[1] = a2;
  v16[0] = 0LL;
  v4 = (*(__int64 (__fastcall **)(_QWORD, _QWORD *))(*(_QWORD *)*a3 + 128LL))(*a3, v16);
  if ( v4 < 0 )
  ...
  v15 = 0LL;
  v5 = v16[0];
  v6 = *(__int64 (__fastcall **)(__int64, HSTRING, __int64 *))(*(_QWORD *)v16[0] + 64LL);
  v7 = -1LL;
  do
    ++v7;
  while ( aTileid[v7] );
  ...
  *a2 = 0LL;
  v14 = 0LL;
  v9 = (**(__int64 (__fastcall ***)(__int64, GUID *, __int64 *))v15)(
         v15,
