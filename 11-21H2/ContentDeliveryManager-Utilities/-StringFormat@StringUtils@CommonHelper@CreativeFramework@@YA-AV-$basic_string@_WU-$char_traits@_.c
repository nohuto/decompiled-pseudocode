/*
 * XREFs of ?StringFormat@StringUtils@CommonHelper@CreativeFramework@@YA?AV?$basic_string@_WU?$char_traits@_W@std@@V?$allocator@_W@2@@std@@PEB_WZZ @ 0x1800E8B68
 * Callers:
...
unsigned __int64 *CreativeFramework::CommonHelper::StringUtils::StringFormat(
        unsigned __int64 *a1,
        wchar_t *Format,
        ...)
{
