/*
 * XREFs of ?do_positive_sign@?$_Mpunct@G@std@@MEBA?AV?$basic_string@GU?$char_traits@G@std@@V?$allocator@G@2@@2@XZ @ 0x180019370
 * Callers:
 *     <none>
 * Callees:
...
_QWORD *__fastcall std::_Mpunct<unsigned short>::do_positive_sign(__int64 a1, _QWORD *a2)
{
  _WORD *v3; // rdx
  __int64 v4; // rax
