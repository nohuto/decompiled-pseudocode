        ...
        __int64 a3)
{
  ...
  v3 = *(_QWORD **)(a1 + 72);
  if ( v3[22] == *(_QWORD *)(a1 + 80) )
    return (*(__int64 (__fastcall **)(_QWORD))(*v3 + 48LL))(*(_QWORD *)(a1 + 72));
  RoOriginateError(2147483660LL, 0LL, a3, v3);
  return 2147483660LL;
}
