/*
 * XREFs of ?GetContextAndNotifyFailure@details@wil@@YAXPEAUFailureInfo@2@PEAD_K@Z @ 0x180035340
 * Callers:
 *     <none>
 * Callees:
  ...
  *(_BYTE *)a2 = 0;
  ...
  if ( `wil::SetLastError'::`2'::lastThread != v11 )
  {
    if ( _InterlockedIncrement(&`wil::SetLastError'::`5'::depth) < 4 )
    {
      ...
      ThreadLocalDataCache = wil::details_abi::GetThreadLocalDataCache(0LL, v12);
