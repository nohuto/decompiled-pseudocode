/*
 * XREFs of ?do_falsename@?$numpunct@_W@std@@MEBA?AV?$basic_string@_WU?$char_traits@_W@std@@V?$allocator@_W@2@@2@XZ @ 0x1800CCC00
 * Callers:
 *     <none>
 * Callees:
...
unsigned __int64 *__fastcall std::numpunct<wchar_t>::do_falsename(__int64 a1, unsigned __int64 *a2)
{
