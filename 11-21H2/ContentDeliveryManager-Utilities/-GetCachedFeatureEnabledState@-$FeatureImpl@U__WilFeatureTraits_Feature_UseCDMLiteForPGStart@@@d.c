/*
 * XREFs of ?GetCachedFeatureEnabledState@?$FeatureImpl@U__WilFeatureTraits_Feature_UseCDMLiteForPGStart@@@details@wil@@AEAA?ATwil_details_FeatureStateCache@@XZ @ 0x18005CAD4
 * Callers:
 *     ?__private_IsEnabled@?$FeatureImpl@U__WilFeatureTraits_Feature_UseCDMLiteForPGStart@@@details@wil@@QEAA_NXZ @ 0x18006999C (-__private_IsEnabled@-$FeatureImpl@U__WilFeatureTraits_Feature_UseCDMLiteForPGStart@@@details@wi.c)
 * Callees:
...
signed __int32 *__fastcall wil::details::FeatureImpl<__WilFeatureTraits_Feature_UseCDMLiteForPGStart>::GetCachedFeatureEnabledState(
  ...
  *a2 = *a1;
  if ( (v2 & 3) != 3 )
  {
    ...
    if ( g_wil_details_internalGetFeatureEnabledState || (v6 = g_wil_details_apiGetFeatureEnabledState) != 0LL )
      v7 = ((__int64 (__fastcall *)(__int64, __int64, int *))v6)(33410451LL, 1LL, &v19);
    else
      v7 = 0;
    v21 = 0;
    v8 = v7 & 0xFFFFFF3F;
