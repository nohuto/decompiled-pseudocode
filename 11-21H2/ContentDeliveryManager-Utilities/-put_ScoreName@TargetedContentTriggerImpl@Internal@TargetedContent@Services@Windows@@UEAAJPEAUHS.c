/*
 * XREFs of ?put_ScoreName@TargetedContentTriggerImpl@Internal@TargetedContent@Services@Windows@@UEAAJPEAUHSTRING__@@@Z @ 0x180097D40
 * Callers:
 *     <none>
 * Callees:
        ...
        HSTRING a2)
{
  ...
  if ( a2 && a2 == *((HSTRING *)this + 22)
    || (WindowsDeleteString(*((HSTRING *)this + 22)),
        *((_QWORD *)this + 22) = 0LL,
        v5 = WindowsDuplicateString(a2, (HSTRING *)this + 22),
        v6 = v5,
        v5 >= 0) )
  {
    if ( v4 )
