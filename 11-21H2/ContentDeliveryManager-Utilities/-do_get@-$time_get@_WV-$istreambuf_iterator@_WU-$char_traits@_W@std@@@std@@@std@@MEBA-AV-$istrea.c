/*
 * XREFs of ?do_get@?$time_get@_WV?$istreambuf_iterator@_WU?$char_traits@_W@std@@@std@@@std@@MEBA?AV?$istreambuf_iterator@_WU?$char_traits@_W@std@@@2@V32@0AEAVios_base@2@AEAHPEAUtm@@DD@Z @ 0x1800E92C0
 * Callers:
 *     <none>
 * Callees:
 ...
 *     ?_Getfmt@?$time_get@_WV?$istreambuf_iterator@_WU?$char_traits@_W@std@@@std@@@std@@IEBA?AV?$istreambuf_iterator@_WU?$char_traits@_W@std@@@2@V32@0AEAVios_base@2@AEAHPEAUtm@@PEBD@Z @ 0x1800E8D04 (-_Getfmt@-$time_get@_WV-$istreambuf_iterator@_WU-$char_traits@_W@std@@@std@@@std@@IEBA-AV-$istre.c)
...
LABEL_21:
        v22 = &v36;
LABEL_56:
        v25 = *std::time_get<wchar_t,std::istreambuf_iterator<wchar_t>>::_Getfmt(
                 a1,
                 v22,
                 v21,
                 v20,
...
LABEL_72:
  ...
  if ( a8 > 110 )
  {
    if ( a8 == 112 )
    {
      v29 = std::_Getloctxt<char,std::istreambuf_iterator<wchar_t>>(a3, a4, 0LL, ":AM:am:PM:pm");
      if ( v29 < 0 )
        goto LABEL_72;
      a7[2] += 12 * v29;
      goto LABEL_74;
...
LABEL_52:
  ...
  if ( a8 != 109 )
    goto LABEL_72;
  v26 = std::time_get<wchar_t,std::istreambuf_iterator<wchar_t>>::_Getint((__int64)a1, a3, a4, 1, 12, &a5, (__int64)v14) | *v16;
  *v16 = v26;
  if ( (v26 & 2) == 0 )
    a7[4] = a5 - 1;
LABEL_74:
