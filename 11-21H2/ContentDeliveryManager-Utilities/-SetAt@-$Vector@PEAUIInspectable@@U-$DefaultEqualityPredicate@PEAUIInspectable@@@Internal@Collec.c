/*
 * XREFs of ?SetAt@?$Vector@PEAUIInspectable@@U?$DefaultEqualityPredicate@PEAUIInspectable@@@Internal@Collections@Foundation@Windows@@U?$DefaultLifetimeTraits@PEAUIInspectable@@@3456@U?$VectorOptions@PEAUIInspectable@@$0A@$00$0A@@3456@@Internal@Collections@Foundation@Windows@@UEAAJIPEAUIInspectable@@@Z @ 0x1800E32E0
 * Callers:
 *     <none>
 * Callees:
        ...
        __int64 a3)
{
  ...
  *(_QWORD *)&v11 = 0LL;
  BYTE8(v11) = 0;
  v5 = XWinRT::InterfaceLifetimeTraits::Construct<IInspectable>((__int64)&v11, a3);
  if ( v5 < 0 )
  {
    *(_QWORD *)&v11 = 0LL;
    BYTE8(v11) = 0;
