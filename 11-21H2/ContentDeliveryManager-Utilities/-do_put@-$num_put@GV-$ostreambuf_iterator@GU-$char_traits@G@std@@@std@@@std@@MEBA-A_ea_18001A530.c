/*
 * XREFs of ?do_put@?$num_put@GV?$ostreambuf_iterator@GU?$char_traits@G@std@@@std@@@std@@MEBA?AV?$ostreambuf_iterator@GU?$char_traits@G@std@@@2@V32@AEAVios_base@2@G_N@Z @ 0x18001A530
 * Callers:
 *     <none>
 * Callees:
        ...
        char a6)
{
  ...
  if ( (*(_DWORD *)(a4 + 24) & 0x4000) != 0 )
  {
    ...
    v10 = (__int64 *)std::use_facet<std::numpunct<unsigned short>>(v21);
    if ( v9 )
    {
