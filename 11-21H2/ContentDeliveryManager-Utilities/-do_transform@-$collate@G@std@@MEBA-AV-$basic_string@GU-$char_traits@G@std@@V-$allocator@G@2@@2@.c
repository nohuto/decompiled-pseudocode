/*
 * XREFs of ?do_transform@?$collate@G@std@@MEBA?AV?$basic_string@GU?$char_traits@G@std@@V?$allocator@G@2@@2@PEBG0@Z @ 0x18001B300
 * Callers:
 *     <none>
 * Callees:
...
_QWORD *__fastcall std::collate<unsigned short>::do_transform(__int64 a1, _QWORD *a2, const void *a3, __int64 a4)
{
  ...
  *(_WORD *)a2 = 0;
  ...
  if ( v7 )
  {
    ...
    do
    {
      std::wstring::append(a2, v7 - v8, 0LL);
      if ( a2[3] < 8uLL )
        v9 = a2;
      else
        v9 = (_QWORD *)*a2;
