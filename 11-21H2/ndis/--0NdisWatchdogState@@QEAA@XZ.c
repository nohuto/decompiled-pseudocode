/*
 * XREFs of ??0NdisWatchdogState@@QEAA@XZ @ 0x1C01068A4
 * Callers:
...
NdisWatchdogState *__fastcall NdisWatchdogState::NdisWatchdogState(char *DeferredContext)
{
  ...
  *((_QWORD *)DeferredContext + 16) = 0LL;
  ...
  v2 = (_QWORD *)qword_1C00ECD00;
  v5.m_State = Exclusive;
  v3 = DeferredContext + 272;
  if ( *(struct _LIST_ENTRY **)qword_1C00ECD00 != &g_ndisWatchdogList )
    __fastfail(3u);
  *((_QWORD *)DeferredContext + 35) = qword_1C00ECD00;
  *v3 = &g_ndisWatchdogList;
  *v2 = v3;
  qword_1C00ECD00 = (__int64)(DeferredContext + 272);
