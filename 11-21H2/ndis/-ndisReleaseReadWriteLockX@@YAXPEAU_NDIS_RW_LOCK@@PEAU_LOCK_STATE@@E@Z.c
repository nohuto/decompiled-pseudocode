/*
 * XREFs of ?ndisReleaseReadWriteLockX@@YAXPEAU_NDIS_RW_LOCK@@PEAU_LOCK_STATE@@E@Z @ 0x1C0039D92
 * Callers:
 *     NdisReleaseReadWriteLock @ 0x1C0039EA0 (NdisReleaseReadWriteLock.c)
 *     NdisDprReleaseReadWriteLock @ 0x1C00A5B90 (NdisDprReleaseReadWriteLock.c)
 * Callees:
 *     ?ndisReleaseReadLockSharedRefCnt@@YAXPEAU_NDIS_RW_LOCK@@@Z @ 0x1C00A5AC4 (-ndisReleaseReadLockSharedRefCnt@@YAXPEAU_NDIS_RW_LOCK@@@Z.c)
 */
