/*
 * XREFs of ?ndisSetFilterDefaultParameter@@YAHPEBU_UNICODE_STRING@@PEAX0E@Z @ 0x1C0061734
 * Callers:
    ...
    if ( !Value )
    {
      ...
      if ( !DestinationString.Buffer )
      {
        if ( !String2.Buffer )
          goto LABEL_17;
        v13 = 0;
        while ( RtlCompareUnicodeString((PCUNICODE_STRING)((char *)&unk_1C00D0A10 + 24 * v13), &String2, 1u) )
        {
          if ( ++v13 >= 6 )
            goto LABEL_17;
        }
        v14 = (const WCHAR *)&unk_1C00D2784;
        if ( (unsigned int)(*((_DWORD *)&unk_1C00D0A10 + 6 * v13 + 4) - 4) > 1 )
LABEL_17:
          v14 = L"0";
