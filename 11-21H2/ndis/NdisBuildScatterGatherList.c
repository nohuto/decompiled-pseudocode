/*
 * XREFs of NdisBuildScatterGatherList @ 0x1C00C9250
 * Callers:
 *     <none>
 * Callees:
...
LABEL_5:
  ...
  if ( v8 )
  {
    ...
    if ( Mdl )
    {
      ...
      {
        v3 = (*(__int64 (__fastcall **)(_QWORD, _QWORD, _MDL *, char *, unsigned int, void (__fastcall *)(_DEVICE_OBJECT *, void *, _SCATTER_GATHER_LIST *, void *), void *, _BYTE, _SCATTER_GATHER_LIST *, unsigned int))(*(_QWORD *)(*(_QWORD *)(v8 + 40) + 8LL) + 112LL))(
               *(_QWORD *)(v8 + 40),
               *(_QWORD *)(v5 + 3824),
               Mdl,
               v10,
        ...
        {
          v3 = -1073676266;
          if ( (*(int (__fastcall **)(_QWORD, _MDL *, char *, _QWORD, unsigned int *, _QWORD))(*(_QWORD *)(*(_QWORD *)(v8 + 40) + 8LL)
                                                                                             + 104LL))(
                 *(_QWORD *)(v8 + 40),
