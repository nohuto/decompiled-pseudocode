/*
 * XREFs of WPP_RECORDER_SF__guid_ZDDDIDDDIDDDIDDDIDDDIDDDIDDDI @ 0x1C00AA674
 * Callers:
...
LABEL_11:
  LOWORD(v40) = 43;
  return WppAutoLogTrace(a1, 4LL, 15LL, &WPP_197eb4ab19783370fa11e732ea3b5a2d_Traceguids, v40, a6);
}
