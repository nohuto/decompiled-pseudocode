/*
 * XREFs of ?ndisNetBufferToPacket@@YAHPEAU_NET_BUFFER@@EPEAPEAU_NDIS_PACKET@@@Z @ 0x1C006DF14
 * Callers:
...
__int64 __fastcall ndisNetBufferToPacket(struct _NET_BUFFER *a1, char a2, struct _NDIS_PACKET **a3)
{
  ...
  __int64 result; // rax
  PNDIS_PACKET v8; // rcx
  $B96795C5183796DD6A1A00BEAE57B57E *ProtocolReserved; // r10
  _MDL *CurrentMdl; // rdx
  ...
  *a3 = 0LL;
  ...
  if ( !Status )
  {
    ...
    ProtocolReserved = ($B96795C5183796DD6A1A00BEAE57B57E *)v8->ProtocolReserved;
    if ( !a2 )
