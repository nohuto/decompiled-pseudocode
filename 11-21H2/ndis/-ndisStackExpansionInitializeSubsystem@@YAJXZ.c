/*
 * XREFs of ?ndisStackExpansionInitializeSubsystem@@YAJXZ @ 0x1C01561B4
 * Callers:
        ...
        unsigned __int8 (*a3)(void *, const struct KnobDescriptor *, unsigned __int64 *))
{
  ...
  ndisRegisterKnobs(&stru_1C00CE218, 1LL, a3, 0LL);
  qword_1C00EC728 = (__int64)ndisAllocatePerProcessorSlot(0x78457453u);
  qword_1C00EC720 = (__int64)ndisAllocatePerProcessorSlot(0x78457453u);
  if ( !qword_1C00EC720 )
    return 3221225626LL;
