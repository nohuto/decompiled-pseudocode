/*
 * XREFs of ?ndisVBusNmrClientAttachProvider@@YAJPEAX0PEBU_NPI_REGISTRATION_INSTANCE@@@Z @ 0x1C0115B30
 * Callers:
 *     <none>
 * Callees:
        ...
        const struct _NPI_REGISTRATION_INSTANCE *a3)
{
  ...
  if ( v8 >= 0 )
  {
    *(_QWORD *)&WPP_MAIN_CB.DeviceQueue.Type = NmrBindingHandle;
    ...
    ndisBindEnumerateProtocolDrivers(lambda_9f85fcd2040f04b850747010404e3e47_::_lambda_invoker_cdecl_, 0LL);
  }
