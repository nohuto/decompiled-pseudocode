/*
 * XREFs of ?ndisWdmSetBusyAsync@@YAEPEAU_NDIS_MINIPORT_BLOCK@@KW4_NDIS_SS_BUSY_REASON@@PEAXK@Z @ 0x1C00A9988
 * Callers:
...
char __fastcall ndisWdmSetBusyAsync(__int64 a1, int a2, unsigned int a3, __int64 a4, unsigned int a5)
{
  ...
  else
  {
    ...
    ndisPendWorkOnSetBusyAsyncLocked(
      ...
      v27,
      a5,
      (struct _NDIS_SELECTIVE_SUSPEND *)&v23,
      &v24,
      &v25);
