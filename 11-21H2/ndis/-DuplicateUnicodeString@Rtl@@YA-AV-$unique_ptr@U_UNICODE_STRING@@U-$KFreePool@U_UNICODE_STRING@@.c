/*
 * XREFs of ?DuplicateUnicodeString@Rtl@@YA?AV?$unique_ptr@U_UNICODE_STRING@@U?$KFreePool@U_UNICODE_STRING@@@@@wistd@@AEBU_UNICODE_STRING@@K@Z @ 0x1C01137A4
 * Callers:
...
_QWORD *__fastcall Rtl::DuplicateUnicodeString(_QWORD *a1, const void **a2)
{
  ...
  {
    MakeSizedPoolPtr<_UNICODE_STRING>(&v6, 1851868238LL);
    v4 = v6;
    if ( v6 )
    {
      *(_QWORD *)(v6 + 8) = v6 + 16;
