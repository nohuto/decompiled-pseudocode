/*
 * XREFs of ?ndisNblTrackerTransferOwnershipSingleNbl@@YAXPEAU_NET_BUFFER_LIST@@PEAUNDIS_NBL_TRACKER_HANDLE__@@1E@Z @ 0x1C006CE6C
 * Callers:
        ...
        unsigned __int64 a3)
{
  ...
  if ( *(int *)ndisNblTrackerMode >= 3 )
    ndisNblTrackerRecordEventInternal((unsigned __int64)a1, 0LL, 0x86u, a3, 1);
  v6 = a3 & 0xFFFFFFFFFFFFFFFDuLL;
  v7 = (unsigned __int8 *)ndisSourceHandleFromOwner(v6);
  if ( (v6 & 1) != 0 )
    v6 |= 2LL * (v3 & 1);
