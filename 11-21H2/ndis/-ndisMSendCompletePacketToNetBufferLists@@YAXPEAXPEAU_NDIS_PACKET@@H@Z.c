/*
 * XREFs of ?ndisMSendCompletePacketToNetBufferLists@@YAXPEAXPEAU_NDIS_PACKET@@H@Z @ 0x1C00C4E68
 * Callers:
        ...
        unsigned int a3)
{
  ...
  if ( v5 )
  {
    ...
    ndisInvokeNextSendCompleteHandler(
      ...
      0LL,
      a1,
      (struct _NDIS_OBJECT_HEADER *)a1[2].Bind,
      *(void **)&a1[2].PMCurrentParameters.EnabledProtocolOffloads,
      (void (*)(void *, struct _NET_BUFFER_LIST *, unsigned int))a1[2].VerifierContext);
  }
}
