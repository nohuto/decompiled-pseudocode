/*
 * XREFs of ??$ndisExpandDataPathStack@$0A@$$A6AXPEAXPEAU_NET_BUFFER_LIST@@KK@Z@@YAJPEAU_NET_BUFFER_LIST@@KKKPEAX1P6AX10KK@Z@Z @ 0x1C0024788
 * Callers:
        ...
        void (__fastcall *a7)(__int64, __int64, _QWORD, _QWORD))
{
  ...
  v12 = *(_QWORD *)(v10 + qword_1C00EC728);
  LowLimit = v12;
  HighLimit = *(_QWORD *)(v10 + qword_1C00EC720);
