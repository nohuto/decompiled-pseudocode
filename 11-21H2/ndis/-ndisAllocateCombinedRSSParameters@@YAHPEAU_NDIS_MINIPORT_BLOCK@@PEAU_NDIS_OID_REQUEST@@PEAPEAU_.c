/*
 * XREFs of ?ndisAllocateCombinedRSSParameters@@YAHPEAU_NDIS_MINIPORT_BLOCK@@PEAU_NDIS_OID_REQUEST@@PEAPEAU_NDIS_VPORT_BLOCK@@PEAPEAU_NDIS_RECEIVE_SCALE_PARAMETERS@@33@Z @ 0x1C0080C8C
 * Callers:
        ...
        struct _NDIS_RECEIVE_SCALE_PARAMETERS **a6)
{
  ...
  __int64 v17; // rax
  struct _NDIS_RECEIVE_SCALE_PARAMETERS *v18; // rax
  ...
  else
  {
    ...
    {
      v17 = ExAllocatePool2(72LL, 2216LL, 1936868430);
      VPortBlockForRequest->RssParametersBuffer = (_NDIS_MINIPORT_RSS_PARAMETERS_CACHE *)v17;
      RssParametersBuffer = v17;
      if ( !v17 )
        return (unsigned int)-1073741670;
    }
    v18 = VPortBlockForRequest->CombinedNdisRSSParameters;
    if ( !v18 )
    {
      ndisCreateRssV1Parameters((struct _NDIS_RECEIVE_SCALE_PARAMETERS *)RssParametersBuffer, 1u, 1u);
      *(_WORD *)(RssParametersBuffer + 4) = 16;
      _BitScanForward64(&v19, VPortBlockForRequest->VPortParams.ProcessorAffinity.Mask);
      *(_WORD *)(RssParametersBuffer + 42) = (unsigned __int8)v19;
      v20 = *(unsigned int *)(RssParametersBuffer + 16);
      *(_WORD *)(RssParametersBuffer + 40) = VPortBlockForRequest->VPortParams.ProcessorAffinity.Group;
      *(_DWORD *)(v20 + RssParametersBuffer) = *(_DWORD *)(RssParametersBuffer + 40);
      v18 = (struct _NDIS_RECEIVE_SCALE_PARAMETERS *)RssParametersBuffer;
