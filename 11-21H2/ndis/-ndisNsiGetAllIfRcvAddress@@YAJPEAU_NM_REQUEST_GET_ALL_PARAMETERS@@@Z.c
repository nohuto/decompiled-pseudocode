/*
 * XREFs of ?ndisNsiGetAllIfRcvAddress@@YAJPEAU_NM_REQUEST_GET_ALL_PARAMETERS@@@Z @ 0x1C00B53D0
 * Callers:
 *     <none>
 * Callees:
 ...
 *     ndisIfFindNextRcvAddress @ 0x1C0133218 (ndisIfFindNextRcvAddress.c)
 *     ndisIfFindRcvAddress @ 0x1C01332A8 (ndisIfFindRcvAddress.c)
...
__int64 __fastcall ndisNsiGetAllIfRcvAddress(struct _NM_REQUEST_GET_ALL_PARAMETERS *a1)
{
  ...
  __int64 v17; // rax
  KIRQL v18; // bl
  char v20[64]; // [rsp+40h] [rbp-58h] BYREF
