/*
 * XREFs of ?ndisReferenceProtocol@@YAEPEAU_NDIS_PROTOCOL_BLOCK@@W4_NDIS_PT_REFTAG@@@Z @ 0x1C001E30C
 * Callers:
 ...
 *     ?ndisPDReferenceClientDriver@@YAEPEAX@Z @ 0x1C0128F38 (-ndisPDReferenceClientDriver@@YAEPEAX@Z.c)
...
unsigned __int8 __fastcall ndisReferenceProtocol(struct _NDIS_PROTOCOL_BLOCK *a1, unsigned __int8 a2)
{
