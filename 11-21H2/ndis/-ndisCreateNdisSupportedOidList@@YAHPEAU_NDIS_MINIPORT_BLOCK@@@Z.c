/*
 * XREFs of ?ndisCreateNdisSupportedOidList@@YAHPEAU_NDIS_MINIPORT_BLOCK@@@Z @ 0x1C002F1B8
 * Callers:
  ...
  if ( Pool2 )
  {
    ...
    *(_DWORD *)(Pool2 + 176) = *((_DWORD *)&ndisHandledNdis5Ndis6GenOids + 44);
    if ( a1->MajorNdisVersion >= 6u )
    {
      ...
      *((_OWORD *)v8 + 1) = *(_OWORD *)(0x1C0000000LL + 1383152);
      *((_OWORD *)v8 + 2) = *(_OWORD *)(0x1C0000000LL + 1383168);
      *((_OWORD *)v8 + 3) = *(_OWORD *)(0x1C0000000LL + 1383184);
      *((_OWORD *)v8 + 4) = *(_OWORD *)(0x1C0000000LL + 1383200);
      *((_OWORD *)v8 + 5) = *(_OWORD *)(0x1C0000000LL + 1383216);
      *((_OWORD *)v8 + 6) = *(_OWORD *)(0x1C0000000LL + 1383232);
      *((_OWORD *)v8 + 7) = *(_OWORD *)(0x1C0000000LL + 1383248);
      *((_OWORD *)v8 + 8) = *(_OWORD *)(0x1C0000000LL + 1383264);
      *((_QWORD *)v8 + 18) = *(_QWORD *)(0x1C0000000LL + 1383280);
    }
    if ( a1->MediaType == NdisMedium802_3 )
    {
