/*
 * XREFs of NdisSetOptionalHandlers @ 0x1C0018DD0
 * Callers:
 *     <none>
 * Callees:
 ...
 *     ?ndisPDSetBufferManagerHandlers@@YAHPEAXPEBU_NDIS_DRIVER_OPTIONAL_HANDLERS@@@Z @ 0x1C0128F64 (-ndisPDSetBufferManagerHandlers@@YAHPEAXPEBU_NDIS_DRIVER_OPTIONAL_HANDLERS@@@Z.c)
 ...
 *     ?ndisSetNDKHandlers@@YAHPEAXPEAU_NDIS_DRIVER_OPTIONAL_HANDLERS@@@Z @ 0x1C012C87C (-ndisSetNDKHandlers@@YAHPEAXPEAU_NDIS_DRIVER_OPTIONAL_HANDLERS@@@Z.c)
 *     ?ndisSetSSHandlers@@YAHPEAXPEAU_NDIS_DRIVER_OPTIONAL_HANDLERS@@@Z @ 0x1C012D38C (-ndisSetSSHandlers@@YAHPEAXPEAU_NDIS_DRIVER_OPTIONAL_HANDLERS@@@Z.c)
 */
        ...
        switch ( *(_BYTE *)NdisHandle )
        {
          case 3:
            ...
            *((_QWORD *)NdisHandle + 99) = *(_QWORD *)&OptionalHandlers[6].Header.Type;
            v18 = *(_QWORD *)&OptionalHandlers[2].Header.Type;
LABEL_77:
            *((_QWORD *)NdisHandle + 100) = v18;
            goto LABEL_9;
          case 0x11:
    ...
    if ( v10 )
    {
      ...
      if ( v13 )
      {
        ...
        else
        {
          ...
          {
LABEL_29:
            v17 = *(_DWORD *)&OptionalHandlers[2] == 1;
            goto LABEL_43;
          }
      ...
      *((_QWORD *)NdisHandle + 98) = *(_QWORD *)&OptionalHandlers[4].Header.Type;
      *((_QWORD *)NdisHandle + 99) = *(_QWORD *)&OptionalHandlers[6].Header.Type;
      v18 = *(_QWORD *)&OptionalHandlers[8].Header.Type;
      goto LABEL_77;
    }
