/*
 * XREFs of ndisMQueueReceiveNetBufferLists @ 0x1C0039896
 * Callers:
 ...
 *     ndisMPeriodicPendingReceives @ 0x1C00A4B30 (ndisMPeriodicPendingReceives.c)
 *     ndisMPeriodicReceivesResources @ 0x1C00A4CA0 (ndisMPeriodicReceivesResources.c)
 */

void __fastcall ndisMQueueReceiveNetBufferLists(struct _NDIS_MINIPORT_BLOCK *a1, int a2, int a3, int a4, char a5)
{
  char v5; // bl
  ...
  if ( (a5 & 2) != 0 )
  {
    v8 = ndisMPeriodicReceivesResources((_DWORD)a1, a2, a3, a4, a5);
  }
  else
  {
    v8 = ndisMPeriodicPendingReceives((_DWORD)a1, a2, a3, a4, a5, (__int64)&v9);
    v6 = v9;
  }
  if ( v8 )
  {
