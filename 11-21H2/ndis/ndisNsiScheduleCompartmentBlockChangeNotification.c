/*
 * XREFs of ndisNsiScheduleCompartmentBlockChangeNotification @ 0x1C0035DA0
 * Callers:
...
void __fastcall ndisNsiScheduleCompartmentBlockChangeNotification(__int64 a1)
{
  ...
  if ( (_QWORD *)*v1 == v1 )
  {
    ...
    v2 = (_QWORD *)qword_1C00ECC40;
    if ( *(__int64 **)qword_1C00ECC40 != &qword_1C00ECC38 )
      __fastfail(3u);
    v3 = byte_1C00EC194 == 0;
    *v1 = &qword_1C00ECC38;
    v1[1] = v2;
    *v2 = v1;
    qword_1C00ECC40 = (__int64)v1;
    if ( v3 )
    {
      ndisScheduleWorkItemInternal(&stru_1C00EC1A0);
      byte_1C00EC194 = 1;
    }
  }
}
