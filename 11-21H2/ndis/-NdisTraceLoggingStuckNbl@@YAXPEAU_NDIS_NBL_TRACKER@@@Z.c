/*
 * XREFs of ?NdisTraceLoggingStuckNbl@@YAXPEAU_NDIS_NBL_TRACKER@@@Z @ 0x1C0086D18
 * Callers:
 *     ?ndisNblTrackerWatchdogTimer@@YAXPEAU_EX_TIMER@@PEAX@Z @ 0x1C0008620 (-ndisNblTrackerWatchdogTimer@@YAXPEAU_EX_TIMER@@PEAX@Z.c)
 * Callees:
...
LABEL_9:
  ...
  else if ( (unsigned int)dword_1C00EB1D8 > 5 && tlgKeywordOn((__int64)&dword_1C00EB1D8, 0x400000000000LL) )
  {
    v7 = v4 + 664;
    v21 = 1;
    v6 = &unk_1C00D6BCD;
