/*
 * XREFs of ?ReadKnobFromKey@NetSetupKnobCollection@@EEAAJAEAVKRegKey@@AEBUKnobDescriptor@@AEAUKnobState@@@Z @ 0x1C0134860
 * Callers:
 *     <none>
 * Callees:
 ...
 *     ?LookupNetSetupPropertyKey@@YAJPEB_WAEAU_NETSETUPPROPKEY@@@Z @ 0x1C01346AC (-LookupNetSetupPropertyKey@@YAJPEB_WAEAU_NETSETUPPROPKEY@@@Z.c)
 */
        ...
        struct KnobState *a4)
{
  ...
  if ( !(_DWORD)result )
  {
    ...
    else
    {
      ...
      {
        v13 = 0;
        v10 = NetSetupPropertyBag::ReadUint32((void ***)&v15, (const struct _NETSETUPPROPKEY *)&v16, &v13);
        v11 = v13;
      }
      v14 = v11;
    }
