/*
 * XREFs of WPP_RECORDER_SF_qDDD @ 0x1C00C9B20
 * Callers:
...
__int64 WPP_RECORDER_SF_qDDD(__int64 a1, _DWORD a2, _DWORD a3, _DWORD a4, __int64 a5, ...)
{
  ...
  if ( (*((_DWORD *)WPP_GLOBAL_Control + 11) & 1) != 0 && *((_BYTE *)WPP_GLOBAL_Control + 41) >= 4u )
    ndisWppFastTraceMessage(
      &WPP_0ce672c581b5354e1037f225da7b2621_Traceguids,
      0x25u,
      va,
      8LL,
      va1,
      ...
      0LL);
  LOWORD(v7) = 37;
  return WppAutoLogTrace(a1, 4LL, 1LL, &WPP_0ce672c581b5354e1037f225da7b2621_Traceguids, v7, (__int64 *)va);
}
