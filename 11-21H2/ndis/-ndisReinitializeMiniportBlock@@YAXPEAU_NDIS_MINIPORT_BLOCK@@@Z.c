/*
 * XREFs of ?ndisReinitializeMiniportBlock@@YAXPEAU_NDIS_MINIPORT_BLOCK@@@Z @ 0x1C0147E4C
 * Callers:
 ...
 *     ?ndisOpenULongRef@@YAXPEAU_ULONG_REFERENCE@@@Z @ 0x1C00ACC60 (-ndisOpenULongRef@@YAXPEAU_ULONG_REFERENCE@@@Z.c)
