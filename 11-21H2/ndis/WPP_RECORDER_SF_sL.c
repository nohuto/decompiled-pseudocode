/*
 * XREFs of WPP_RECORDER_SF_sL @ 0x1C0095B68
 * Callers:
...
__int64 WPP_RECORDER_SF_sL(__int64 a1, __int64 a2, __int64 a3, __int64 a4, int a5, const char *a6, ...)
{
  ...
  if ( (*((_DWORD *)WPP_GLOBAL_Control + 11) & 0x2000) != 0 && *((_BYTE *)WPP_GLOBAL_Control + 41) >= 2u )
  {
    ...
    if ( !a6 )
      v11 = "NULL";
    ndisWppFastTraceMessage(&WPP_c5d0b5f7d8c43de1f0150a9d8e7af364_Traceguids, 0x4Bu, v11, v10, va, 4LL, 0LL);
  }
  if ( a6 )
  {
    do
  ...
  if ( !a6 )
    v6 = "NULL";
  LOWORD(v13) = 75;
  return WppAutoLogTrace(a1, 2LL, 14LL, &WPP_c5d0b5f7d8c43de1f0150a9d8e7af364_Traceguids, v13, v6);
}
