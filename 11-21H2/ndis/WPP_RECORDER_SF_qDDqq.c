/*
 * XREFs of WPP_RECORDER_SF_qDDqq @ 0x1C000DA80
 * Callers:
...
__int64 WPP_RECORDER_SF_qDDqq(__int64 a1, _DWORD a2, _DWORD a3, _DWORD a4, __int64 a5, ...)
{
  ...
  if ( (*((_DWORD *)WPP_GLOBAL_Control + 11) & 0x400) != 0 && *((_BYTE *)WPP_GLOBAL_Control + 41) >= 4u )
    ndisWppFastTraceMessage(
      &WPP_492abc64950d3d1c0cf6ddade1213689_Traceguids,
      0xCu,
      va,
      8LL,
      va1,
      ...
      0LL);
  LOWORD(v7) = 12;
  return WppAutoLogTrace(a1, 4LL, 11LL, &WPP_492abc64950d3d1c0cf6ddade1213689_Traceguids, v7, (__int64 *)va);
}
