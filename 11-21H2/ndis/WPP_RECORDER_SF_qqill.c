/*
 * XREFs of WPP_RECORDER_SF_qqill @ 0x1C00BE800
 * Callers:
 *     NdisSetCoalescableTimerObject @ 0x1C00BE6B0 (NdisSetCoalescableTimerObject.c)
 * Callees:
 *     ?ndisWppFastTraceMessage@@YAXPEBU_GUID@@GZZ @ 0x1C00AC73C (-ndisWppFastTraceMessage@@YAXPEBU_GUID@@GZZ.c)
 */

__int64 WPP_RECORDER_SF_qqill(__int64 a1, _DWORD a2, _DWORD a3, _DWORD a4, __int64 a5, ...)
{
  ...
  if ( (*((_DWORD *)WPP_GLOBAL_Control + 11) & 0x800) != 0 && *((_BYTE *)WPP_GLOBAL_Control + 41) >= 4u )
    ndisWppFastTraceMessage(
      &WPP_1199be12e998382f89b5427f6f01d2c3_Traceguids,
      0xBu,
      va,
      8LL,
      va1,
      ...
      0LL);
  LOWORD(v7) = 11;
  return WppAutoLogTrace(a1, 4LL, 12LL, &WPP_1199be12e998382f89b5427f6f01d2c3_Traceguids, v7, (__int64 *)va);
}
