/*
 * XREFs of WPP_RECORDER_SF_DqLL @ 0x1C0010010
 * Callers:
...
__int64 WPP_RECORDER_SF_DqLL(__int64 a1, __int64 a2, __int64 a3, __int64 a4, int a5, ...)
{
  ...
  if ( (*((_DWORD *)WPP_GLOBAL_Control + 11) & 0x200000) != 0 && *((_BYTE *)WPP_GLOBAL_Control + 41) >= 4u )
    ndisWppFastTraceMessage(
      ...
      0LL);
  LOWORD(v7) = 20;
  return WppAutoLogTrace(a1, 4LL, 22LL, &WPP_ebf57095e638305b5a9962a85db12dfe_Traceguids, v7, (__int64 *)va);
}
