/*
 * XREFs of ?ndisXlateSendCompletePacketToNetBufferList@@YAPEAU_NET_BUFFER_LIST@@PEAU_NDIS_PACKET@@H@Z @ 0x1C006E698
 * Callers:
  ...
  if ( (a1->Private.Flags & 0x4000) != 0 )
  {
    ...
    *(_MDL **)((char *)&a1[1].Private.Head + a1->Private.NdisPacketOobOffset) = 0LL;
    if ( *(int *)ndisNblTrackerMode >= 3 )
      ndisNblTrackerRecordEventInternal(v5, 0LL, 0x18u, (unsigned __int64)a1, 0);
  }
  else
  {
    *(_MDL **)((char *)&a1[1].Private.Head + NdisPacketOobOffset) = 0LL;
    ...
    if ( *(int *)ndisNblTrackerMode >= 3 )
      ndisNblTrackerRecordEventInternal(v5, 0LL, 0x14u, (unsigned __int64)a1, 0);
