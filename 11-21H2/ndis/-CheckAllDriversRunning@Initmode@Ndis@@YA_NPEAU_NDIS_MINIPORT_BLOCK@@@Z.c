/*
 * XREFs of ?CheckAllDriversRunning@Initmode@Ndis@@YA_NPEAU_NDIS_MINIPORT_BLOCK@@@Z @ 0x1C0112DA0
 * Callers:
...
LABEL_15:
  ...
  v6 = *((unsigned int *)this + 1253);
  for ( j = 0LL; j != v6; ++j )
  {
    if ( j >= v6 )
      goto LABEL_15;
    v8 = *(_QWORD *)(*(_QWORD *)(*((_QWORD *)this + 627) + 8 * j) + 80LL);
