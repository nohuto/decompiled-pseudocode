/*
 * XREFs of ndisFreeSharedMemoryInternal @ 0x1C0058888
 * Callers:
...
void __fastcall ndisFreeSharedMemoryInternal(
        ...
        __int64 a5)
{
  struct _NDIS_SG_DMA_BLOCK *v5; // rbx
  ...
  _InterlockedIncrement64(&qword_1C00EE898);
  v20 = 16;
  ...
  if ( (unsigned __int64)v15 + 8 < 0x1000 )
  {
    ...
    if ( (*(_DWORD *)((a4 & 0xFFFFFFFFFFFFF000uLL) + 0xFFC))-- == 1 )
    {
      ...
      ((void (__fastcall *)(_DMA_ADAPTER *, __int64, __int64, ULONG_PTR, char))FreeCommonBuffer)(
        ...
        BugCheckParameter4a);
      v17 = a3 != 0 ? 8 : 0;
      if ( (void *)(a4 & 0xFFFFFFFFFFFFF000uLL) == *(void **)((char *)v5->SharedMemoryPage + v17) )
      {
        *(unsigned int *)((char *)v5->SharedMemoryLeft + (a3 != 0 ? 4 : 0)) = 0;
        *(void **)((char *)v5->SharedMemoryPage + v17) = 0LL;
      }
    }
  }
  else
