/*
 * XREFs of ?ndisQueuedPnPIrpSurpriseRemoval@@YAXPEAX@Z @ 0x1C012A350
 * Callers:
 *     <none>
 * Callees:
...
void __fastcall ndisQueuedPnPIrpSurpriseRemoval(_QWORD *a1)
{
  ...
  ndisPnPIrpSurpriseRemovalInner((struct _NDIS_MINIPORT_BLOCK *)(a1 - 621));
  v2 = (_IRP *)a1[4];
  if ( v2 )
  {
    ...
    *(_OWORD *)&CurrentStackLocation[-1].Parameters.ReadWriteConfig.Length = *(_OWORD *)&CurrentStackLocation->Parameters.ReadWriteConfig.Length;
    ...
    IofCallDriver((PDEVICE_OBJECT)*(a1 - 141), v2);
  }
}
