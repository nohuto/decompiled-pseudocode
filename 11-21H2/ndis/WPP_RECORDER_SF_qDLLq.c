/*
 * XREFs of WPP_RECORDER_SF_qDLLq @ 0x1C00BB544
 * Callers:
...
__int64 WPP_RECORDER_SF_qDLLq(__int64 a1, _DWORD a2, _DWORD a3, _DWORD a4, __int64 a5, ...)
{
  ...
  if ( (*((_DWORD *)WPP_GLOBAL_Control + 11) & 0x80000) != 0 && *((_BYTE *)WPP_GLOBAL_Control + 41) >= 4u )
    ndisWppFastTraceMessage(
      ...
      0LL);
  LOWORD(v7) = 30;
  return WppAutoLogTrace(a1, 4LL, 20LL, &WPP_de7b4475eb543019aeb186df8ee4bca2_Traceguids, v7, (__int64 *)va);
}
