/*
 * XREFs of ?ndisInvokeNextSendHandler@@YAXPEAU_NET_BUFFER_LIST@@KKPEAU_NDIS_OBJECT_HEADER@@PEAXP6AX20KK@Z@Z @ 0x1C0025F38
 * Callers:
        ...
        void (*a6)(void *, struct _NET_BUFFER_LIST *, unsigned int, unsigned int))
{
  ...
  {
    if ( byte_1C00EC210 && (*((_DWORD *)&a4->PktMonComp + 13) & 2) != 0 )
