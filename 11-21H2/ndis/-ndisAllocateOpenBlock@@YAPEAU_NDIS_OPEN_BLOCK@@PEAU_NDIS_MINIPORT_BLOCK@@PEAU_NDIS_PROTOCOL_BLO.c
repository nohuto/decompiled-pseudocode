/*
 * XREFs of ?ndisAllocateOpenBlock@@YAPEAU_NDIS_OPEN_BLOCK@@PEAU_NDIS_MINIPORT_BLOCK@@PEAU_NDIS_PROTOCOL_BLOCK@@E@Z @ 0x1C0021598
 * Callers:
        ...
        char a3)
{
  ...
  if ( !PerProcessorSlot )
    return 0LL;
  v7 = (a1->Flags & 0x20000) != 0 ? 1160 : 1016;
  Pool2 = ExAllocatePool2(64LL, (a1->Flags & 0x20000) != 0 ? 1160LL : 1016LL, 1869431886);
