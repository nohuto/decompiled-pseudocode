/*
 * XREFs of ?ndisRefCountBlockFromRefCountHandle@@YAPEAU_NDIS_REFCOUNT_BLOCK@@PEAUNDIS_REFCOUNT_HANDLE__@@@Z @ 0x1C000FFE0
 * Callers:
 ...
 *     NdisGetRefCount @ 0x1C00BFF90 (NdisGetRefCount.c)
 * Callees:
