/*
 * XREFs of ?ndisUpdateOperationalStatus@@YAXPEAU_NDIS_MINIPORT_BLOCK@@@Z @ 0x1C0017FD0
 * Callers:
...
void __fastcall ndisUpdateOperationalStatus(struct _NDIS_MINIPORT_BLOCK *a1)
{
  ...
  v2 = NewIrql[0];
  v3 = ndisIfSetInterfaceState(a1, 1u, NewIrql[0]);
  ...
  if ( v3 )
  {
    ...
    ndisIndicateStatusInternal(a1, &v7, 2u);
