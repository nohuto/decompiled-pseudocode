/*
 * XREFs of ?ndisWdfGetGuidToOidList@@YAXPEBKGPEAU_NDIS_GUID@@PEAG@Z @ 0x1C0088418
 * Callers:
 *     NdisWdfGetGuidToOidMap @ 0x1C005B1A0 (NdisWdfGetGuidToOidMap.c)
 * Callees:
 *     ndisWmiMapOids @ 0x1C002E31C (ndisWmiMapOids.c)
 */
