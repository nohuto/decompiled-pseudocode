/*
 * XREFs of WPP_RECORDER_SF_ZqD @ 0x1C0020998
 * Callers:
...
LABEL_11:
  ...
  ndisWppFastTraceMessage(
    &WPP_00be6b421a7931e0b0f96a5f66efcc23_Traceguids,
    a4,
    v12,
    2LL,
    v11,
...
LABEL_2:
  if ( !a6 )
    v6 = L"\b";
  LOWORD(v13) = a4;
  return WppAutoLogTrace(a1, 4LL, 28LL, &WPP_00be6b421a7931e0b0f96a5f66efcc23_Traceguids, v13, v6);
}
