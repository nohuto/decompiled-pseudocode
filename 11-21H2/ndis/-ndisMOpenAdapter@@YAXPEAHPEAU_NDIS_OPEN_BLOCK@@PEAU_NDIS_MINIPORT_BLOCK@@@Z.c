/*
 * XREFs of ?ndisMOpenAdapter@@YAXPEAHPEAU_NDIS_OPEN_BLOCK@@PEAU_NDIS_MINIPORT_BLOCK@@@Z @ 0x1C013CF90
 * Callers:
 ...
 *     ?ethAllocateOpenMulticastBuffer@@YAHPEAU_X_FILTER@@PEAU_NDIS_OPEN_BLOCK@@@Z @ 0x1C001960C (-ethAllocateOpenMulticastBuffer@@YAHPEAU_X_FILTER@@PEAU_NDIS_OPEN_BLOCK@@@Z.c)
...
LABEL_64:
  ...
  {
    if ( !_bittest((const signed __int32 *)&a3->Flags, 0x11u) )
  ...
  if ( a3->MediaType == NdisMediumWan && !_bittest((const signed __int32 *)&a3->Flags, 0x11u) )
    a2->SendHandler = (int (__fastcall *)(void *, _NDIS_PACKET *))ndisMWanSend;
  if ( _bittest((const signed __int32 *)&a3->Flags, 0x11u) )
  {
  ...
  v13 = a3->DriverHandle;
  if ( a3->MajorNdisVersion < 6u )
    CancelSendPacketsHandler = v13->MiniportCharacteristics.CancelSendPacketsHandler;
  else
    CancelSendPacketsHandler = v13->MiniportDriverCharacteristics.CancelSendHandler;
  ...
  if ( a3->Miniport5InNdis6Mode || v15 )
  {
