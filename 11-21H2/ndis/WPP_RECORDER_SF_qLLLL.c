/*
 * XREFs of WPP_RECORDER_SF_qLLLL @ 0x1C0057A50
 * Callers:
...
__int64 WPP_RECORDER_SF_qLLLL(__int64 a1, __int64 a2, __int64 a3, __int64 a4, int a5, ...)
{
  ...
  if ( (*((_DWORD *)WPP_GLOBAL_Control + 11) & 0x40) != 0 && *((_BYTE *)WPP_GLOBAL_Control + 41) >= 4u )
    ndisWppFastTraceMessage(
      &WPP_089a512067333d51f5b66ea612d009fe_Traceguids,
      0x16u,
      va,
      8LL,
      va1,
      ...
      0LL);
  LOWORD(v7) = 22;
  return WppAutoLogTrace(a1, 4LL, 7LL, &WPP_089a512067333d51f5b66ea612d009fe_Traceguids, v7, (__int64 *)va);
}
