/*
 * XREFs of ?ndisUpdatePMCurrentCapabilities@@YAEPEAU_NDIS_MINIPORT_BLOCK@@@Z @ 0x1C0025AD8
 * Callers:
 ...
 *     ?ndisConvertPMCapabilitiesToPnp@@YAXPEAU_NDIS_PM_CAPABILITIES@@PEAU_NDIS_PNP_CAPABILITIES@@@Z @ 0x1C010C2F4 (-ndisConvertPMCapabilitiesToPnp@@YAXPEAU_NDIS_PM_CAPABILITIES@@PEAU_NDIS_PNP_CAPABILITIES@@@Z.c)
 */
...
unsigned __int8 __fastcall ndisUpdatePMCurrentCapabilities(struct _NDIS_MINIPORT_BLOCK *a1)
{
  ...
  v25 = v3;
  v26 = HIDWORD(v6);
  v27 = *(_OWORD *)&a1->PMAdvertisedCapabilities.NumArpOffloadIPv4Addresses;
  v28 = *(_QWORD *)&a1->PMAdvertisedCapabilities.MinLinkChangeWakeUp;
    ...
    && a1->DeviceCaps.SystemWake )
  {
      ...
      if ( (Flags & 4) != 0 )
      {
        ...
        if ( (Flags & 0xC) == 0xC )
        {
          ...
          if ( *(unsigned int **)&WPP_RECORDER_INITIALIZED != &WPP_RECORDER_INITIALIZED )
          {
            ...
            v13 = a1->PMHardwareCapabilities.Flags;
          }
        }
      }
    }
    ...
    if ( (PnPCapabilities & 0x10) == 0 )
    {
      ...
      if ( (unsigned int)(MinPatternWakeUp - 2) <= 2 && (v18 & 3) != 1 && (PnPCapabilities & 0x100) == 0 )
      {
        ...
        v24 = a1->PMAdvertisedCapabilities.SupportedWoLPacketPatterns;
        if ( (SupportedWoLPacketPatterns & 1) != 0 )
        {
          a1->PMAdvertisedCapabilities.MinPatternWakeUp = MinPatternWakeUp;
          v24 |= 1u;
        }
        a1->PMAdvertisedCapabilities.SupportedWoLPacketPatterns = v24 | SupportedWoLPacketPatterns & 0xFFFFFFFC;
      }
    }
  }
  ndisConvertPMCapabilitiesToPnp(p_PMAdvertisedCapabilities, &a1->PMCapabilities61);
  if ( *(_QWORD *)&a1->PMAdvertisedCapabilities.Flags != *(_QWORD *)((char *)&v25 + 4)
    || a1->PMAdvertisedCapabilities.SupportedProtocolOffloads != v26
    || *(_QWORD *)&a1->PMAdvertisedCapabilities.MinMagicPacketWakeUp != *((_QWORD *)&v27 + 1)
    || a1->PMAdvertisedCapabilities.MinLinkChangeWakeUp != (_DWORD)v28 )
  {
    return 1;
  }
  return v4;
