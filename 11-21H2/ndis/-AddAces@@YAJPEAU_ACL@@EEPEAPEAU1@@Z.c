/*
 * XREFs of ?AddAces@@YAJPEAU_ACL@@EEPEAPEAU1@@Z @ 0x1C01559EC
 * Callers:
 *     ?CreateDeviceDriverSecurityDescriptor@@YAJPEAXEEPEAU_ACL@@@Z @ 0x1C01556F8 (-CreateDeviceDriverSecurityDescriptor@@YAJPEAXEEPEAU_ACL@@@Z.c)
 * Callees:
