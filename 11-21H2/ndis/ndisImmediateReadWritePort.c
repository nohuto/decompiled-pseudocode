/*
 * XREFs of ndisImmediateReadWritePort @ 0x1C00BF180
 * Callers:
 *     NdisImmediateReadPortUchar @ 0x1C00BF4D0 (NdisImmediateReadPortUchar.c)
 *     NdisImmediateReadPortUlong @ 0x1C00BF4F0 (NdisImmediateReadPortUlong.c)
 *     NdisImmediateReadPortUshort @ 0x1C00BF510 (NdisImmediateReadPortUshort.c)
 *     NdisImmediateWritePortUchar @ 0x1C00BF550 (NdisImmediateWritePortUchar.c)
 *     NdisImmediateWritePortUlong @ 0x1C00BF580 (NdisImmediateWritePortUlong.c)
 *     NdisImmediateWritePortUshort @ 0x1C00BF5B0 (NdisImmediateWritePortUshort.c)
 * Callees:
