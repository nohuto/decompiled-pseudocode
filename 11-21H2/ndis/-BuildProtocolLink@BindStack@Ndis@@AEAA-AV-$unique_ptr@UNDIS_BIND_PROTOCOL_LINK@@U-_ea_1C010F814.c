/*
 * XREFs of ?BuildProtocolLink@BindStack@Ndis@@AEAA?AV?$unique_ptr@UNDIS_BIND_PROTOCOL_LINK@@U?$default_delete@UNDIS_BIND_PROTOCOL_LINK@@@wistd@@@wistd@@AEAV?$KRef@UNDIS_BIND_PROTOCOL_DRIVER@@@@@Z @ 0x1C010F814
 * Callers:
 ...
 *     ??0NDIS_BIND_LINK_BASE@@QEAA@XZ @ 0x1C0110DF0 (--0NDIS_BIND_LINK_BASE@@QEAA@XZ.c)
 */
