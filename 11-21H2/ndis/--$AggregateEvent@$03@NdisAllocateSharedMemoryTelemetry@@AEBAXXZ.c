/*
 * XREFs of ??$AggregateEvent@$03@NdisAllocateSharedMemoryTelemetry@@AEBAXXZ @ 0x1C00C9E04
 * Callers:
...
char __fastcall NdisAllocateSharedMemoryTelemetry::AggregateEvent<4>(__int64 a1)
{
  ...
  {
    LOBYTE(v3) = tlgKeywordOn((__int64)&dword_1C00EB5C8, 2048LL);
    if ( (_BYTE)v3 )
    {
      v28 = *(_DWORD *)(v6 + 52);
      v26 = &v31;
