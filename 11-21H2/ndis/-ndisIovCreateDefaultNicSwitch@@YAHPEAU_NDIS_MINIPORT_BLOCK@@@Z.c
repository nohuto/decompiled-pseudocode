/*
 * XREFs of ?ndisIovCreateDefaultNicSwitch@@YAHPEAU_NDIS_MINIPORT_BLOCK@@@Z @ 0x1C002EDFC
 * Callers:
 ...
 *     ?ndisIovInitializeNicSwitch@@YAHPEAU_NDIS_MINIPORT_BLOCK@@PEAU_NDIS_NIC_SWITCH_PARAMETERS@@PEAPEAU_NDIS_NIC_SWITCH_BLOCK@@PEAPEAU_NDIS_PF_BLOCK@@PEAPEAU_NDIS_VPORT_BLOCK@@@Z @ 0x1C0071074 (-ndisIovInitializeNicSwitch@@YAHPEAU_NDIS_MINIPORT_BLOCK@@PEAU_NDIS_NIC_SWITCH_PARAMETERS@@PEAPE.c)
...
__int64 __fastcall ndisIovCreateDefaultNicSwitch(struct _NDIS_MINIPORT_BLOCK *a1)
{
  ...
  struct _NDIS_CONFIGURATION_OBJECT ConfigObject; // [rsp+70h] [rbp-98h] BYREF
      ...
      if ( (SriovCurrentCapabilities->SriovCapabilities & 3) == 3 )
      {
          ...
          && NicSwitchCurrentCapabilities->Header.Size >= 0x74u )
        {
          ...
          SwitchConfiguration = ndisIovInitializeNicSwitch(
                                  ...
                                  (struct _NDIS_NIC_SWITCH_BLOCK **)&ConfigObject,
                                  (struct _NDIS_PF_BLOCK **)&v19,
                                  (struct _NDIS_VPORT_BLOCK **)&P);
          if ( SwitchConfiguration )
            goto LABEL_29;
          LODWORD(ConfigObject.NdisHandle) = 1573289;
          *(_QWORD *)&ConfigObject.Flags = a1;
          LODWORD(v21) = 0;
          v10 = NdisOpenConfigurationEx((PNDIS_CONFIGURATION_OBJECT)&ConfigObject.NdisHandle, &ConfigurationHandle);
          ...
          *(_QWORD *)&v22.DATA.METHOD_INFORMATION.OutputBufferLength = 552LL;
          ...
          SwitchConfiguration = ndisIovFinalizeNicSwitch(
                                  a1,
                                  (struct _NDIS_NIC_SWITCH_PARAMETERS *)v25,
                                  *(struct _NDIS_NIC_SWITCH_BLOCK **)&ConfigObject.Header.Type,
                                  (struct _NDIS_PF_BLOCK *)v19,
                                  (struct _NDIS_VPORT_BLOCK *)P);
        }
        else
...
LABEL_29:
        ...
        if ( *(_QWORD *)&ConfigObject.Header.Type )
          ExFreePoolWithTag(*(PVOID *)&ConfigObject.Header.Type, 0);
        goto LABEL_35;
      }
    }
  }
