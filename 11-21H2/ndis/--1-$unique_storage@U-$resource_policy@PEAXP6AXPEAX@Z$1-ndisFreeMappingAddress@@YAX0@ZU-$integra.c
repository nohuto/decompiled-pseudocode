/*
 * XREFs of ??1?$unique_storage@U?$resource_policy@PEAXP6AXPEAX@Z$1?ndisFreeMappingAddress@@YAX0@ZU?$integral_constant@_K$00@wistd@@PEAXPEAX$0A@$$T@details@wil@@@details@wil@@IEAA@XZ @ 0x1C0031244
 * Callers:
 *     ?ndisAllocateNumaStripedPages@@YAPEAXXZ @ 0x1C0114288 (-ndisAllocateNumaStripedPages@@YAPEAXXZ.c)
 * Callees:
 *     ?ndisFreeMappingAddress@@YAXPEAX@Z @ 0x1C00ABC80 (-ndisFreeMappingAddress@@YAXPEAX@Z.c)
 */
