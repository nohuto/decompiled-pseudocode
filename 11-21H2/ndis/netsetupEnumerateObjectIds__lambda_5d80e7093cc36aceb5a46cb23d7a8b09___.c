/*
 * XREFs of netsetupEnumerateObjectIds__lambda_5d80e7093cc36aceb5a46cb23d7a8b09___ @ 0x1C012F428
 * Callers:
...
__int64 netsetupEnumerateObjectIds__lambda_5d80e7093cc36aceb5a46cb23d7a8b09_()
{
  unsigned int v0; // edi
  unsigned int v1; // eax
...
LABEL_4:
  ...
  for ( i = 0; ; ++i )
  {
    ...
    *(_OWORD *)&GuidString[1] = 0LL;
    ...
    {
      ProtocolById = ndisReadProtocolById(ProtocolById + 1, &GuidString[1]);
      if ( ProtocolById )
        goto LABEL_14;
    }
    if ( v5 )
