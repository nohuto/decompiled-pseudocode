/*
 * XREFs of ?ndisPcwEnumerateSingleInstance@@YAJPEAU_PCW_BUFFER@@PEAU_NDIS_MINIPORT_BLOCK@@K@Z @ 0x1C010D3A8
 * Callers:
  ...
  *(_DWORD *)&Name.Length = 33685504;
  ...
  else
  {
    ...
    if ( (Name.Length & 1) != 0
      ...
      || (v12 = pModifiedInstanceName->Buffer) == 0LL && ((_WORD)Length || MaximumLength) )
    {
      v7 = -1073741811;
    }
    else
