/*
 * XREFs of ?ndisSetMiniportRSSv1ParametersForMiniportV2@@YAEPEAU_NDIS_MINIPORT_BLOCK@@PEAU_NDIS_OID_REQUEST@@PEAH@Z @ 0x1C00827B8
 * Callers:
...
unsigned __int8 __fastcall ndisSetMiniportRSSv1ParametersForMiniportV2(
        ...
        int a4)
{
  struct _NDIS_RECEIVE_SCALE_PARAMETERS *InformationBuffer; // r15
  int v5; // r12d
