/*
 * XREFs of NdisCmDispatchIncomingCall @ 0x1C00B8E30
 * Callers:
 *     <none>
 * Callees:
 ...
 *     ?ndisDereferenceSap@@YAXPEAU_NDIS_CO_SAP_BLOCK@@@Z @ 0x1C00B9460 (-ndisDereferenceSap@@YAXPEAU_NDIS_CO_SAP_BLOCK@@@Z.c)
 */
