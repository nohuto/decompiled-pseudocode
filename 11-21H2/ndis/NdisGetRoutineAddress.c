/*
 * XREFs of NdisGetRoutineAddress @ 0x1C00AD630
 * Callers:
 *     ?ndisVerifierGetRoutineAddress@@YAPEAXPEAU_UNICODE_STRING@@@Z @ 0x1C00AD250 (-ndisVerifierGetRoutineAddress@@YAPEAXPEAU_UNICODE_STRING@@@Z.c)
 * Callees:
 *     _guard_dispatch_icall_nop @ 0x1C0036040 (_guard_dispatch_icall_nop.c)
 *     FindExportedRoutineByName @ 0x1C00AD534 (FindExportedRoutineByName.c)
 */
