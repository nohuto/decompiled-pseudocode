/*
 * XREFs of WPP_RECORDER_SF_qLLDDDDDDDDDD @ 0x1C0027720
 * Callers:
...
__int64 WPP_RECORDER_SF_qLLDDDDDDDDDD(__int64 a1, __int64 a2, __int64 a3, __int64 a4, int a5, ...)
{
  ...
  if ( (*((_DWORD *)WPP_GLOBAL_Control + 11) & 0x20000) != 0 && *((_BYTE *)WPP_GLOBAL_Control + 41) >= 4u )
    ndisWppFastTraceMessage(
      &WPP_a3deceaeb6403c5105309677219e7454_Traceguids,
      0x1Du,
      va,
      8LL,
      va1,
      ...
      0LL);
  LOWORD(v7) = 29;
  return WppAutoLogTrace(a1, 4LL, 18LL, &WPP_a3deceaeb6403c5105309677219e7454_Traceguids, v7, (__int64 *)va);
}
