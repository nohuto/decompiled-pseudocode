/*
 * XREFs of ?NdisTraceLoggingDeviceInitialized@@YAXPEAU_NDIS_MINIPORT_BLOCK@@AEBVKStopwatch@@W4_NDIS_TRACEFORMAT_FAILURE_REASON@@H@Z @ 0x1C0024AB8
 * Callers:
...
void __fastcall NdisTraceLoggingDeviceInitialized(__int64 a1, KStopwatch *a2, __int64 a3, __int64 a4)
{
  ...
  if ( (_DWORD)a4 )
  {
    if ( (unsigned int)dword_1C00EB1D8 > 5 && (unsigned __int8)tlgKeywordOn(&dword_1C00EB1D8, 0x400000000000LL, a3, a4) )
    {
      v20 = *(_BYTE *)(v12 + 33);
      v14[0] = *(_BYTE *)(v12 + 32);
  ...
  {
    if ( (unsigned __int8)tlgKeywordOn(&dword_1C00EB1D8, 0x400000000000LL, a3, a4) )
    {
      v20 = *(_BYTE *)(v5 + 33);
      v14[0] = *(_BYTE *)(v5 + 32);
      v15 = *(_DWORD *)(v5 + 1832);
