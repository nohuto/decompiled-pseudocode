/*
 * XREFs of NdisMStartBufferPhysicalMapping @ 0x1C006C590
 * Callers:
 *     <none>
 * Callees:
        ...
        PUINT ArraySize)
{
  ...
  v12 = *(__int64 (__fastcall **)(_QWORD, _QWORD, _QWORD, _QWORD, _QWORD, _DWORD))(*(_QWORD *)(*(_QWORD *)(v6 + 40) + 8LL)
                                                                                 + 64LL);
  v21 = 0;
  v19 = v12;
  if ( ByteCount )
  {
    ...
    do
    {
      ...
      LOBYTE(v18) = v13;
      v15 = v7;
      v16.QuadPart = v12(*(_QWORD *)(v6 + 40), Buffer, *(_QWORD *)(*(_QWORD *)(v6 + 152) + 8 * v14), v9, &v21, v18);
  ...
  *(_BYTE *)(*(_QWORD *)(v6 + 152) + 16 * v11 + 8) = WriteToDevice;
  *ArraySize = v7;
}
