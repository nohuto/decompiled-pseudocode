/*
 * XREFs of ?ndisIfLuidAllocatorSubsystemInitialize@@YAJXZ @ 0x1C015339C
 * Callers:
...
NTSTATUS ndisIfLuidAllocatorSubsystemInitialize(void)
{
  ...
  Status = 0;
  qword_1C00ECE90 = (__int64)&qword_1C00ECE88;
  qword_1C00ECE88 = &qword_1C00ECE88;
