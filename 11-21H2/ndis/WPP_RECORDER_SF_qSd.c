/*
 * XREFs of WPP_RECORDER_SF_qSd @ 0x1C00581E8
 * Callers:
...
__int64 WPP_RECORDER_SF_qSd(__int64 a1, __int64 a2, __int64 a3, __int64 a4, int a5, ...)
{
  ...
  if ( (*((_DWORD *)WPP_GLOBAL_Control + 11) & 0x80u) != 0 && *((_BYTE *)WPP_GLOBAL_Control + 41) >= 2u )
  {
    ...
    if ( !v15 )
      v10 = L"NULL";
    ndisWppFastTraceMessage(&WPP_231a7ad8765e3b8a0571d07bdac2bb37_Traceguids, 0x10u, va, 8LL, v10, v9, va1, 4LL, 0LL);
  }
  if ( v5 )
  {
    do
  ...
  LOWORD(v12) = 16;
  return WppAutoLogTrace(a1, 2LL, 8LL, &WPP_231a7ad8765e3b8a0571d07bdac2bb37_Traceguids, v12, (__int64 *)va);
}
