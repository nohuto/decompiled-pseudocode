/*
 * XREFs of ??0_NDIS_MINIPORT_BLOCK@@QEAA@XZ @ 0x1C002D47C
 * Callers:
 ...
 *     ??0BindEngine@Ndis@@QEAA@XZ @ 0x1C01128CC (--0BindEngine@Ndis@@QEAA@XZ.c)
 *     ??0KPushLock@@QEAA@XZ @ 0x1C012DD8C (--0KPushLock@@QEAA@XZ.c)
 */
