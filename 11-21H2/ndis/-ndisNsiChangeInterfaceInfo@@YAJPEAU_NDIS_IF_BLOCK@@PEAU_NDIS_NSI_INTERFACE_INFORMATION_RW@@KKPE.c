/*
 * XREFs of ?ndisNsiChangeInterfaceInfo@@YAJPEAU_NDIS_IF_BLOCK@@PEAU_NDIS_NSI_INTERFACE_INFORMATION_RW@@KKPEAK@Z @ 0x1C0021894
 * Callers:
...
LABEL_9:
        ...
        case 1088:
          v18 = *((_DWORD *)a2 + 272);
          if ( (unsigned int)v18 > NDIS_NSI_INTERFACE_PURPOSE_INTERNAL_VSWITCH_NIC )
            goto LABEL_29;
          a1->ifPurpose = v18;
          v14 = 4;
          v13 = 1092;
