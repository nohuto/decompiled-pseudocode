/*
 * XREFs of ?ndisMpHookNmrInitializeClient@@YAJXZ @ 0x1C01565C4
 * Callers:
 ...
 *     ?FillDefaultHandlers@MINIPORT_HOOK_DRIVER@@QEAAXXZ @ 0x1C01157D0 (-FillDefaultHandlers@MINIPORT_HOOK_DRIVER@@QEAAXXZ.c)
 *     ??0MINIPORT_HOOK_DRIVER@@QEAA@XZ @ 0x1C0115ABC (--0MINIPORT_HOOK_DRIVER@@QEAA@XZ.c)
 *     ??_EMINIPORT_HOOK_DRIVER@@QEAAPEAXI@Z @ 0x1C0131F80 (--_EMINIPORT_HOOK_DRIVER@@QEAAPEAXI@Z.c)
 */
