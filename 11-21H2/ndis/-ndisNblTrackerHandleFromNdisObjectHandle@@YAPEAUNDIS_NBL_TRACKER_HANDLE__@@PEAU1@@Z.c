/*
 * XREFs of ?ndisNblTrackerHandleFromNdisObjectHandle@@YAPEAUNDIS_NBL_TRACKER_HANDLE__@@PEAU1@@Z @ 0x1C006C82C
 * Callers:
        ...
        struct NDIS_NBL_TRACKER_HANDLE__ *a1)
{
  ...
  if ( ((unsigned __int8)a1 & 1) == 0 && ((unsigned __int8)a1 & 2) == 0 )
  {
    ...
    {
      case 5:
        return (struct NDIS_NBL_TRACKER_HANDLE__ *)*((_QWORD *)a1 + 81);
      case 0x11:
