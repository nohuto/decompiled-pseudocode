/*
 * XREFs of ?ndisMIndicateNetBufferListsToOpen@@YAXPEAU_NDIS_OPEN_BLOCK@@PEAU_NET_BUFFER_LIST@@KKK@Z @ 0x1C0002C10
 * Callers:
...
LABEL_5:
  if ( MiniportHandle->CheckPacketFilters && !v11->PacketFilters
    || (v11->PacketFilters & 0x10000) != 0 && !v13 && (Flags & 0x80u) != 0 )
  {
LABEL_7:
    if ( (a5 & 2) == 0 )
    {
  ...
  do
  {
    ...
    while ( Alignment->NetBufferListInfo[27] == v24 )
    {
      ...
      {
        Alignment->SourceHandle = (void *)ndisSourceHandleFromOwner(32LL, v15, a3, v20);
      }
      SourceHandle = (char *)Alignment->SourceHandle;
      if ( SourceHandle )
      {
        v15 = (unsigned __int8)*SourceHandle;
...
LABEL_13:
  ...
  v11->ReceiveNetBufferLists(v11->ReceiveNetBufferListsContext, a2, v51, v8, v16);
  if ( (v42 & 0x800000000LL) != 0 )
  {
  ...
  if ( (v16 & 2) != 0 && *(_DWORD *)ndisNblTrackerMode )
