/*
 * XREFs of WPP_RECORDER_SF_qq_guid_qd @ 0x1C005BD70
 * Callers:
...
__int64 WPP_RECORDER_SF_qq_guid_qd(__int64 a1, __int64 a2, __int64 a3, __int64 a4, int a5, ...)
{
  ...
  if ( (*((_DWORD *)WPP_GLOBAL_Control + 11) & 1) != 0 && *((_BYTE *)WPP_GLOBAL_Control + 41) >= 4u )
    ndisWppFastTraceMessage(
      &WPP_39285a130bc13dc3f0681d114c7faf72_Traceguids,
      0x98u,
      va,
      8LL,
      va1,
      ...
      0LL);
  LOWORD(v7) = 152;
  return WppAutoLogTrace(a1, 4LL, 1LL, &WPP_39285a130bc13dc3f0681d114c7faf72_Traceguids, v7, (__int64 *)va);
}
