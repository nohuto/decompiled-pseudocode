/*
 * XREFs of ?ndisSelectiveSuspendInitialize@@YAXPEAU_NDIS_MINIPORT_BLOCK@@@Z @ 0x1C012CF14
 * Callers:
    ...
    && DriverHandle->CancelIdleNotificationHandler )
  {
    ...
    if ( Pool2 )
    {
      ...
      *((_QWORD *)v4 + 75) = v5;
      if ( v5 )
      {
        *(_OWORD *)v5 = xmmword_1C00DBB50;
        *(_OWORD *)(v5 + 16) = xmmword_1C00DBB60;
        *(_OWORD *)(v5 + 32) = xmmword_1C00DBB70;
        *(_OWORD *)(v5 + 48) = xmmword_1C00DBB80;
        *(_OWORD *)(v5 + 64) = xmmword_1C00DBB90;
        *(_OWORD *)(v5 + 80) = xmmword_1C00DBBA0;
        *(_OWORD *)(v5 + 96) = xmmword_1C00DBBB0;
        *(_QWORD *)(v5 + 112) = 0LL;
        *((_QWORD *)v4 + 68) = 0LL;
