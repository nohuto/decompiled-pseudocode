/*
 * XREFs of WPP_RECORDER_SF_qLqL @ 0x1C00B505C
 * Callers:
...
__int64 WPP_RECORDER_SF_qLqL(__int64 a1, __int64 a2, __int64 a3, __int64 a4, int a5, ...)
{
  ...
  if ( (*((_DWORD *)WPP_GLOBAL_Control + 11) & 0x200000) != 0 && *((_BYTE *)WPP_GLOBAL_Control + 41) >= 4u )
    ndisWppFastTraceMessage(
      &WPP_56ea039682543cc41749bafffb9946f1_Traceguids,
      0x11u,
      va,
      8LL,
      va1,
      ...
      0LL);
  LOWORD(v7) = 17;
  return WppAutoLogTrace(a1, 4LL, 22LL, &WPP_56ea039682543cc41749bafffb9946f1_Traceguids, v7, (__int64 *)va);
}
