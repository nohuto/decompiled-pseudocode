/*
 * XREFs of ndisGetSharedMemoryAllocationDetails @ 0x1C00C7AF0
 * Callers:
...
__int64 __fastcall ndisGetSharedMemoryAllocationDetails(struct _NDIS_MINIPORT_BLOCK *a1, __int64 a2, __int64 a3)
{
  ...
  __int64 v9; // rcx
  KIRQL v10; // dl
  _NDIS_RECEIVE_QUEUE_BLOCK *DefaultReceiveQueue; // rax
  ...
  *(_QWORD *)(a3 + 8) = a1;
  ...
  if ( *(_DWORD *)(a2 + 8) )
  {
    ...
    *(_QWORD *)(v9 + 520) = 0LL;
    ...
    DefaultReceiveQueue = *(_NDIS_RECEIVE_QUEUE_BLOCK **)(a3 + 24);
  }
  else
  {
    DefaultReceiveQueue = a1->DefaultReceiveQueue;
    *(_QWORD *)(a3 + 24) = DefaultReceiveQueue;
  }
