/*
 * XREFs of ?IndicateReceivedNbls@NdisPoll@@AEAAXPEAU_EXECUTION_CONTEXT_POLL_PARAMETERS@@@Z @ 0x1C00C07C0
 * Callers:
 *     ?EvtIndicateReceivedNbls@NdisPoll@@CAXPEAXPEAU_EXECUTION_CONTEXT_POLL_PARAMETERS@@@Z @ 0x1C00C0740 (-EvtIndicateReceivedNbls@NdisPoll@@CAXPEAXPEAU_EXECUTION_CONTEXT_POLL_PARAMETERS@@@Z.c)
 * Callees:
...
void __fastcall NdisPoll::IndicateReceivedNbls(NdisPoll *this, struct _EXECUTION_CONTEXT_POLL_PARAMETERS *a2)
{
  ...
  v7 = (struct _NET_BUFFER_LIST *)*((_QWORD *)this + 28);
  if ( v7 )
    NdisMIndicateReceiveNetBufferLists(*((NDIS_HANDLE *)this + 70), v7, 0, v2, v6 | (*(_BYTE *)a2 == 2));
  *((_QWORD *)this + 28) = 0LL;
  *((_DWORD *)this + 60) = 0;
  *((_DWORD *)this + 58) = 0;
  *((_DWORD *)this + 59) = 0;
