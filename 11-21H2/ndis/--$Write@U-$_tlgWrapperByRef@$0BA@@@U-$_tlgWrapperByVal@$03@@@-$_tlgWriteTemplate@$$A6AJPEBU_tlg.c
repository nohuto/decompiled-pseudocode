 ...
 *     ?NdisTraceLoggingMiniportWakeBufferTooLarge@@YAXPEAU_NDIS_MINIPORT_BLOCK@@K@Z @ 0x1C0085EFC (-NdisTraceLoggingMiniportWakeBufferTooLarge@@YAXPEAU_NDIS_MINIPORT_BLOCK@@K@Z.c)
 * Callees:
        ...
        __int64 a6)
{
  ...
  v10 = 0;
  v9 = 16;
  return tlgWriteTransfer_EtwWriteTransfer((__int64)&dword_1C00EB1D8, a2, 0LL, 0LL, 4u, &v7);
}
