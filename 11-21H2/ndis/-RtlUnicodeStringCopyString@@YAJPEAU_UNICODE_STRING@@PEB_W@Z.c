/*
 * XREFs of ?RtlUnicodeStringCopyString@@YAJPEAU_UNICODE_STRING@@PEB_W@Z @ 0x1C0028ABC
 * Callers:
 ...
 * Callees:
 *     RtlWideCharArrayCopyStringWorker @ 0x1C0028B24 (RtlWideCharArrayCopyStringWorker.c)
 *     RtlUnicodeStringValidateDestWorker @ 0x1C0028B8C (RtlUnicodeStringValidateDestWorker.c)
 */
