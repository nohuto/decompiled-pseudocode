/*
 * XREFs of ?ndisCoSendPacketsToNdisPackets@@YAXPEAXPEAPEAU_NDIS_PACKET@@I@Z @ 0x1C00BCC10
 * Callers:
...
LABEL_20:
  ...
  while ( v9 < v21 );
  if ( v8 )
    ((void (__fastcall *)(_QWORD, struct _NDIS_PACKET **, _QWORD))a1[26])(a1[25], &v5[v16], v8);
LABEL_23:
