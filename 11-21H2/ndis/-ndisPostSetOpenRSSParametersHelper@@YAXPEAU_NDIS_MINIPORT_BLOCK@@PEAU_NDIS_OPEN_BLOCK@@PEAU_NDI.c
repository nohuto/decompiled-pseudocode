/*
 * XREFs of ?ndisPostSetOpenRSSParametersHelper@@YAXPEAU_NDIS_MINIPORT_BLOCK@@PEAU_NDIS_OPEN_BLOCK@@PEAU_NDIS_RECEIVE_SCALE_PARAMETERS@@@Z @ 0x1C0027F1C
 * Callers:
        ...
        struct _NDIS_RECEIVE_SCALE_PARAMETERS *a3)
{
  ...
  for ( i = a1->OpenQueue; i; i = i->MiniportNextOpen )
  {
    ...
    if ( NdisRSSParameters && i != a2 )
    {
      ...
      {
        v16 = NdisRSSParameters->HashInformation & 0xFFFF00;
        memmove(NdisRSSParameters, a3, v9);
        i->NdisRSSParameters->HashInformation = HashInformation | v16;
      }
    }
  }
  if ( !HashInformation || v11 )
