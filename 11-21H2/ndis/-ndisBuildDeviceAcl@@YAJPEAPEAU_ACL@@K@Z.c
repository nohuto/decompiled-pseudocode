/*
 * XREFs of ?ndisBuildDeviceAcl@@YAJPEAPEAU_ACL@@K@Z @ 0x1C0031400
 * Callers:
 ...
 *     ?ndisCreateSecurityDescriptorEx@@YAJPEAXK@Z @ 0x1C01145CC (-ndisCreateSecurityDescriptorEx@@YAJPEAXK@Z.c)
 * Callees:
...
__int64 __fastcall ndisBuildDeviceAcl(struct _ACL **a1, char a2)
{
  ...
  *(_WORD *)&IdentifierAuthority.Value[4] = 1280;
  ...
  if ( (a2 & 0x10) != 0 )
  {
    v15 = RtlLengthSid(&unk_1C00D30D0);
    v16 = RtlLengthSid(&unk_1C00D30B0) + v15;
    v6 += v16 + 32 + RtlLengthSid(&unk_1C00D3090);
  }
  v22 = a2 & 4;
  if ( (a2 & 4) != 0 )
  {
...
LABEL_43:
  ...
  v10 = a2 & 0x80;
  if ( v10 )
    v6 += RtlLengthSid(&unk_1C00D3070) + 8;
  ...
  if ( v11 )
  {
    ...
    else
    {
      ...
      if ( v21 )
      {
        RtlAddAccessAllowedAce(v12, 2u, AccessMask, &unk_1C00D3090);
        RtlAddAccessAllowedAce(v12, 2u, AccessMask, &unk_1C00D30B0);
        RtlAddAccessAllowedAce(v12, 2u, AccessMask, &unk_1C00D30D0);
      }
      if ( v22 )
      ...
      if ( v10 )
        RtlAddAccessAllowedAce(v12, 2u, AccessMask, &unk_1C00D3070);
      Acl = 0;
      *v25 = v12;
    }
  }
