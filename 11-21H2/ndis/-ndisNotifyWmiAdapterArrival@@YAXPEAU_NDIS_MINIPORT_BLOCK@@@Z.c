/*
 * XREFs of ?ndisNotifyWmiAdapterArrival@@YAXPEAU_NDIS_MINIPORT_BLOCK@@@Z @ 0x1C0032D8C
 * Callers:
 *     NdisWdfNotifyWmiAdapterArrival @ 0x1C005B3F0 (NdisWdfNotifyWmiAdapterArrival.c)
