/*
 * XREFs of ?ndisReferenceMiniportByName@@YAXPEBU_UNICODE_STRING@@PEAPEAU_NDIS_MINIPORT_BLOCK@@EW4_NDIS_MP_REFTAG@@@Z @ 0x1C0139420
 * Callers:
  ...
  if ( *(unsigned int **)&WPP_RECORDER_INITIALIZED != &WPP_RECORDER_INITIALIZED )
    WPP_RECORDER_SF_Z(
      *((_QWORD *)WPP_GLOBAL_Control + 8),
      ...
      0xDu,
      0xAu,
      (struct _GUID *)&WPP_dc12ede7e5783ca416b94229a508177d_Traceguids,
      &a1->Length);
  *a2 = 0LL;
  ...
  if ( DestinationString.Buffer )
  {
    ...
    if ( ndisMiniDriverList )
    {
      ...
      while ( 1 )
      {
        ...
        while ( 1 )
        {
          PnPFlags = MiniportQueue->PnPFlags;
          if ( a3 )
            break;
          if ( (PnPFlags & 0x2000000) == 0 )
          {
...
LABEL_21:
        ...
        if ( (PnPFlags & 0x2000000) != 0
          || !ndisEqualUnicodeStringDispatchLevel(&DestinationString, &MiniportQueue->MiniportName) )
        {
          goto LABEL_21;
        }
