/*
 * XREFs of NdisMIdleNotificationConfirm @ 0x1C00A9EA0
 * Callers:
 *     <none>
 * Callees:
 ...
 *     ?ndisAoAcIdleRequestConfirm@@YAJPEAU_NDIS_MINIPORT_BLOCK@@@Z @ 0x1C0052B58 (-ndisAoAcIdleRequestConfirm@@YAJPEAU_NDIS_MINIPORT_BLOCK@@@Z.c)
