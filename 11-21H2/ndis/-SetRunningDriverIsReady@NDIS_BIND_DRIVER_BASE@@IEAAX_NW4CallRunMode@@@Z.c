/*
 * XREFs of ?SetRunningDriverIsReady@NDIS_BIND_DRIVER_BASE@@IEAAX_NW4CallRunMode@@@Z @ 0x1C010F404
 * Callers:
        ...
        enum CallRunMode a3)
{
  ...
  NDIS_BIND_DRIVER_BASE::ForEachLink(
    this,
    (void (*)(struct NDIS_BIND_LINK_BASE *))lambda_1547dc6d0e90217ea0a9abc5d2ee1198_::_lambda_invoker_cdecl_);
