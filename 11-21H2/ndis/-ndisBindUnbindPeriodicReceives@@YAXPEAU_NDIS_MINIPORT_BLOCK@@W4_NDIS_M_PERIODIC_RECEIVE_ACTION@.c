/*
 * XREFs of ?ndisBindUnbindPeriodicReceives@@YAXPEAU_NDIS_MINIPORT_BLOCK@@W4_NDIS_M_PERIODIC_RECEIVE_ACTION@@@Z @ 0x1C00A2FBC
 * Callers:
    ...
    if ( a2 >= 0 )
    {
      if ( a2 <= 2 )
      {
        ...
        *(_QWORD *)(a1 + 3184) = KeGetCurrentThread();
        ++*(_DWORD *)(a1 + 3216);
        if ( !*(_DWORD *)(a1 + 464) && byte_1C00EC241 == 1 && dword_1C00EC244 != -1 && !*(_DWORD *)(a1 + 3168) )
      ...
      if ( a2 <= 5 )
      {
        ...
        *(_QWORD *)(a1 + 3184) = CurrentThread;
        if ( v6 && *(_DWORD *)(a1 + 3168) )
        {
          ...
          v7 = qword_1C00EC258;
          if ( qword_1C00EC258 == (void *)a1 )
          {
            qword_1C00EC258 = (void *)*((_QWORD *)qword_1C00EC258 + 395);
          }
          else
          {
            while ( v7 )
