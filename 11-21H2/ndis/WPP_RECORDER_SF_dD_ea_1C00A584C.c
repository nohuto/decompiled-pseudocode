/*
 * XREFs of WPP_RECORDER_SF_dD @ 0x1C00A584C
 * Callers:
...
__int64 WPP_RECORDER_SF_dD(__int64 a1, _DWORD a2, _DWORD a3, _DWORD a4, __int64 a5, ...)
{
  ...
  if ( (*((_DWORD *)WPP_GLOBAL_Control + 11) & 0x800) != 0 && *((_BYTE *)WPP_GLOBAL_Control + 41) >= 2u )
    ndisWppFastTraceMessage(&WPP_04120f1ead0836c58aece9b177b8d3ef_Traceguids, 0xFu, va, 4LL, va1, 4LL, 0LL);
  LOWORD(v7) = 15;
  return WppAutoLogTrace(a1, 2LL, 12LL, &WPP_04120f1ead0836c58aece9b177b8d3ef_Traceguids, v7, (__int64 *)va);
}
