/*
 * XREFs of WPP_RECORDER_SF_qDd @ 0x1C000B300
 * Callers:
 ...
 *     ?ndisMFakeOidRequest@@YAHPEAXPEAU_NDIS_OID_REQUEST@@@Z @ 0x1C0066140 (-ndisMFakeOidRequest@@YAHPEAXPEAU_NDIS_OID_REQUEST@@@Z.c)
 ...
 *     ?ndisMFakeDirectOidRequest@@YAHPEAXPEAU_NDIS_OID_REQUEST@@@Z @ 0x1C00AFFA0 (-ndisMFakeDirectOidRequest@@YAHPEAXPEAU_NDIS_OID_REQUEST@@@Z.c)
 * Callees:
