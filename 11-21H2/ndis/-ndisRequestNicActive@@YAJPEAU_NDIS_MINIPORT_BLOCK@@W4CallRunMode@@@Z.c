/*
 * XREFs of ?ndisRequestNicActive@@YAJPEAU_NDIS_MINIPORT_BLOCK@@W4CallRunMode@@@Z @ 0x1C0054BD8
 * Callers:
...
__int64 __fastcall ndisRequestNicActive(struct _NDIS_MINIPORT_BLOCK *a1, enum CallRunMode a2)
{
  ...
  struct _NDIS_MINIPORT_AOAC *v17; // rbx
  ...
  if ( v12 == 2 )
  {
    if ( !*((_BYTE *)AoAc + 387) )
    {
      *((_DWORD *)AoAc + 94) = 3;
      ...
      v10 = *((_BYTE *)AoAc + 1073) != 0;
      *((_QWORD *)AoAc + 104) = MEMORY[0xFFFFF78000000008];
      *((_QWORD *)AoAc + 105) = v14 & -(__int64)v10;
      KeClearEvent(&a1->PowerD0CompleteEvent);
      KeReleaseSpinLock((PKSPIN_LOCK)AoAc, v11);
      v15 = ndisRequestDevicePowerD0(a1, NdisMEventD0_NicActive);
      v16 = v15;
      if ( v15 != 259 )
      {
        v17 = a1->AoAc;
        NdisTraceLoggingUnexpectedAoAcError(a1, 1u, v15);
        *((_WORD *)v17 + 225) = *((_WORD *)v17 + 224);
        *((_WORD *)v17 + 224) = 1;
