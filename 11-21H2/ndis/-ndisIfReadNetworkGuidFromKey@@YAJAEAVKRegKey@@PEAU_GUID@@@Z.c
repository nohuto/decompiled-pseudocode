/*
 * XREFs of ?ndisIfReadNetworkGuidFromKey@@YAJAEAVKRegKey@@PEAU_GUID@@@Z @ 0x1C002AEC8
 * Callers:
 ...
 *     ??0NetSetupPropertyBag@@QEAA@AEAVKRegKey@@@Z @ 0x1C0101118 (--0NetSetupPropertyBag@@QEAA@AEAVKRegKey@@@Z.c)
...
__int64 __fastcall ndisIfReadNetworkGuidFromKey(struct KRegKey *a1, struct _GUID *a2)
{
  ...
  v3 = NetSetupPropertyBag::ReadGuid((NetSetupPropertyBag *)&v10, (const struct _NETSETUPPROPKEY *)&unk_1C00D25C8, &v11);
  Guid = NetSetupPropertyBag::ReadGuid((NetSetupPropertyBag *)&v10, (const struct _NETSETUPPROPKEY *)&unk_1C00D25B0, a2);
  v5 = 0;
  if ( v3 < 0 )
  {
    if ( Guid >= 0 )
