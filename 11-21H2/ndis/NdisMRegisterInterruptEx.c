/*
 * XREFs of NdisMRegisterInterruptEx @ 0x1C0149430
 * Callers:
 *     <none>
 * Callees:
 ...
 *     GetMsgDpc @ 0x1C005F17C (GetMsgDpc.c)
  ...
  if ( *(unsigned int **)&WPP_RECORDER_INITIALIZED != &WPP_RECORDER_INITIALIZED )
  {
    WPP_RECORDER_SF_q(
      *((_QWORD *)WPP_GLOBAL_Control + 8),
      ...
      1u,
      0xAu,
      (struct _GUID *)&WPP_d6f9ee23862e32d1b410ecc78cf8ba08_Traceguids,
  ...
  *(_QWORD *)(v4 + 216) = v4 + v24;
  ...
  if ( v50 / 0x50 )
  {
    ...
    do
    {
      ...
      v34[3] = v34;
      *v34 = 0LL;
      KeInitializeSpinLock((PKSPIN_LOCK)(80 * v33 + 72 + *(_QWORD *)(v4 + 216)));
      v33 = ++v31;
    }
    while ( v31 < v32 );
  }
