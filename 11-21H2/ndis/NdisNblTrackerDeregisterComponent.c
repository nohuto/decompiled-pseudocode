/*
 * XREFs of NdisNblTrackerDeregisterComponent @ 0x1C0020910
 * Callers:
 ...
 *     ?ndisNblTrackerDeleteTracker@@YAXPEAU_NDIS_NBL_TRACKER@@@Z @ 0x1C001761C (-ndisNblTrackerDeleteTracker@@YAXPEAU_NDIS_NBL_TRACKER@@@Z.c)
 */
