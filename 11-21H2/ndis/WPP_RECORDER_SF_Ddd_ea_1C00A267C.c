/*
 * XREFs of WPP_RECORDER_SF_Ddd @ 0x1C00A267C
 * Callers:
...
__int64 WPP_RECORDER_SF_Ddd(__int64 a1, __int64 a2, __int64 a3, __int64 a4, int a5, ...)
{
  ...
  if ( (*((_DWORD *)WPP_GLOBAL_Control + 11) & 0x400) != 0 && *((_BYTE *)WPP_GLOBAL_Control + 41) >= 2u )
    ndisWppFastTraceMessage(&WPP_1914ea0fddb73983daf9dda2a115606b_Traceguids, 0xAu, va, 4LL, va1, 4LL, va2, 4LL, 0LL);
  LOWORD(v7) = 10;
  return WppAutoLogTrace(a1, 2LL, 11LL, &WPP_1914ea0fddb73983daf9dda2a115606b_Traceguids, v7, (__int64 *)va);
}
