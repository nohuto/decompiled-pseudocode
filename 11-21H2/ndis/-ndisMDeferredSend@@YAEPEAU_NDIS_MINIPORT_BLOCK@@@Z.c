/*
 * XREFs of ?ndisMDeferredSend@@YAEPEAU_NDIS_MINIPORT_BLOCK@@@Z @ 0x1C00C2DD0
 * Callers:
 *     <none>
 * Callees:
    ...
    else
    {
      ...
      *((_DWORD *)v10 + 2) = 0;
      ...
      if ( *(_MDL **)((char *)&i[1].Private.Head + NdisPacketOobOffset) )
        ndisMSendCompletePacketToNetBufferLists(&a1->Header, i, v6);
      else
