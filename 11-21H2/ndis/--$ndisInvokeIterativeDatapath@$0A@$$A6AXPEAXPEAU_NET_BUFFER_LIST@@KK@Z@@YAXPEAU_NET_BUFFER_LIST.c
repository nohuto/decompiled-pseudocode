/*
 * XREFs of ??$ndisInvokeIterativeDatapath@$0A@$$A6AXPEAXPEAU_NET_BUFFER_LIST@@KK@Z@@YAXPEAU_NET_BUFFER_LIST@@KKKPEAU_NDIS_OBJECT_HEADER@@PEAXP6AX20KK@Z@Z @ 0x1C0034B30
 * Callers:
...
{
  __int64 v5; // r12
  _NDIS_ITERATIVE_DATA_PATH_TRACKER_ENTRY *v6; // rsi
  __int64 result; // rax
  _NDIS_ITERATIVE_DATA_PATH_TRACKER_ENTRY *v9; // rbx
