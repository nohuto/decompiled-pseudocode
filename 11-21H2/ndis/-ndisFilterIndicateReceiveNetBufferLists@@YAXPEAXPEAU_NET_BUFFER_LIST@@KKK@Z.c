/*
 * XREFs of ?ndisFilterIndicateReceiveNetBufferLists@@YAXPEAXPEAU_NET_BUFFER_LIST@@KKK@Z @ 0x1C00607B0
 * Callers:
 *     <none>
 * Callees:
        ...
        unsigned int a5)
{
  ...
  else
  {
    ...
    {
      if ( *(_DWORD *)ndisNblTrackerMode )
        ndisNblTrackerTransferOwnershipInternal(a2, *((_QWORD *)a1 + 64), *((_QWORD *)a1 + 81), 0x8Cu, a5 & 1);
    }
  }
}
