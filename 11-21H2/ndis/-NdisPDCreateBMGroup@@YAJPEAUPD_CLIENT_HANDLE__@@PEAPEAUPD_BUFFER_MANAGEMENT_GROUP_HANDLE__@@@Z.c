/*
 * XREFs of ?NdisPDCreateBMGroup@@YAJPEAUPD_CLIENT_HANDLE__@@PEAPEAUPD_BUFFER_MANAGEMENT_GROUP_HANDLE__@@@Z @ 0x1C01256A0
 * Callers:
 *     <none>
 * Callees:
  ...
  *a2 = 0LL;
  ...
  if ( PoolWithTag )
  {
    ...
    *((_QWORD *)v6 + 5) = (char *)v6 + 40;
    v10.m_Lock = (KPushLockBase *)qword_1C00EC710;
    *((_QWORD *)v6 + 2) = a1;
