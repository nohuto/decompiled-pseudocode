/*
 * XREFs of ?ndisIfQueryBindingMiniportIfIndex@@YAHPEAU_NDIS_MINIPORT_BLOCK@@PEAKPEAT_NET_LUID_LH@@12@Z @ 0x1C01072B0
 * Callers:
        ...
        union _NET_LUID_LH *a5)
{
  ...
  *a4 = 0;
  ...
  {
    *a4 = a1->BaseMiniport->$BE092A68170FD08DDFD1C57936DBF0A6::IfIndex;
