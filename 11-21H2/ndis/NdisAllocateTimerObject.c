/*
 * XREFs of NdisAllocateTimerObject @ 0x1C00253C0
 * Callers:
 *     <none>
 * Callees:
 *     <none>
  ...
  *(_QWORD *)(v8 + 176) = FunctionContext;
  ...
  if ( *(_BYTE *)NdisHandle == 17 )
  {
    *(_QWORD *)(v8 + 192) = NdisHandle;
    KeInitializeDpc(v11, ndisMTimerObjectDpc, (PVOID)v8);
  }
  else
  {
    KeInitializeDpc(v11, (PKDEFERRED_ROUTINE)TimerCharacteristics->TimerFunction, TimerCharacteristics->FunctionContext);
