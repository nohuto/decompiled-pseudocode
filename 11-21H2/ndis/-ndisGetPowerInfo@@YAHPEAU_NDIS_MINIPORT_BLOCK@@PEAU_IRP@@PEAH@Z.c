/*
 * XREFs of ?ndisGetPowerInfo@@YAHPEAU_NDIS_MINIPORT_BLOCK@@PEAU_IRP@@PEAH@Z @ 0x1C0063BC4
 * Callers:
 ...
 *     ?ndisXlateSSResume@@YA?AW4_NDIS_USER_RESUME_REASON@@T_NDIS_SS_RESUME_REASON@@@Z @ 0x1C0064364 (-ndisXlateSSResume@@YA-AW4_NDIS_USER_RESUME_REASON@@T_NDIS_SS_RESUME_REASON@@@Z.c)
 *     ?ndisGetListEntriesCount@@YAKPEAU_SINGLE_LIST_ENTRY@@@Z @ 0x1C008D944 (-ndisGetListEntriesCount@@YAKPEAU_SINGLE_LIST_ENTRY@@@Z.c)
 */
  ...
  if ( *((_BYTE *)CurrentStackLocation->FileObject->FsContext + 24) )
  {
    ...
    if ( Length >= 0x35C )
    {
      ...
      *(_DWORD *)&v9.MasterIrp[4].AllocationProcessorNumber = a1->PMAdvertisedCapabilities.MediaSpecificWakeUpEvents;
      v31 = (unsigned int)(*((_DWORD *)&v9.MasterIrp[2].Tail.CompletionKey + 9) + 60);
      *((_DWORD *)&v9.MasterIrp[2].Tail.CompletionKey + 10) = v31;
      *(_OWORD *)((char *)&v9.MasterIrp->Type + v31) = *(_OWORD *)&a1->PMCurrentParameters.Header.Type;
      *(unsigned int *)((char *)&v9.MasterIrp->Flags + (unsigned int)v31) = a1->PMCurrentParameters.MediaSpecificWakeUpEvents;
      v9.MasterIrp[3].Overlay.AllocationSize.LowPart = a1->LastWakeReason;
      SelectiveSuspend = a1->SelectiveSuspend;
      if ( SelectiveSuspend )
      {
        v33 = (MEMORY[0xFFFFF78000000014] - a1->TimeOfInitialization.QuadPart) / 10000 - a1->TotalSystemSleepTimeMs;
        LOBYTE(v35) = KeAcquireSpinLockRaiseToDpc((PKSPIN_LOCK)a1->SelectiveSuspend);
        *(_DWORD *)&v9.MasterIrp[3].AllocationProcessorNumber = *((_DWORD *)SelectiveSuspend + 2);
        ...
        v36 = *((_QWORD *)SelectiveSuspend + 86);
        if ( (*((_DWORD *)SelectiveSuspend + 126) & 0x10) != 0 )
        {
          v34 = (MEMORY[0xFFFFF78000000014] - *((_QWORD *)SelectiveSuspend + 81)) / 10000LL;
          v36 += v34;
        }
        v37 = *((_DWORD *)SelectiveSuspend + 161);
        if ( v37 )
        {
          v9.MasterIrp[3].Flags = *((_QWORD *)SelectiveSuspend + 84) / (unsigned __int64)v37;
          v34 = v36 % *((unsigned int *)SelectiveSuspend + 161);
          v9.MasterIrp[3].AssociatedIrp.MasterIrp = (_IRP *)(v36 / *((unsigned int *)SelectiveSuspend + 161));
        }
        if ( v33 )
        {
          v34 = 100 * v36 % v33;
          LODWORD(v9.MasterIrp[3].ThreadListEntry.Flink) = 100 * v36 / v33;
        }
        ...
        KeReleaseSpinLock((PKSPIN_LOCK)SelectiveSuspend, v41);
      }
      AoAc = a1->AoAc;
      if ( AoAc )
      {
        HIDWORD(v9.MasterIrp[2].CancelRoutine) |= 0x80000u;
        v43 = KeAcquireSpinLockRaiseToDpc((PKSPIN_LOCK)AoAc);
        ...
        KeReleaseSpinLock((PKSPIN_LOCK)AoAc, v43);
      }
