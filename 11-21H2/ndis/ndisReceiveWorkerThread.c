/*
 * XREFs of ndisReceiveWorkerThread @ 0x1C0030DC0
 * Callers:
 *     <none>
 * Callees:
 ...
 *     ndisPeriodicReceivesGetTimerPeriod @ 0x1C0039920 (ndisPeriodicReceivesGetTimerPeriod.c)
...
unsigned int *__fastcall ndisReceiveWorkerThread(ULONG a1)
{
  ...
  v2 = (KSPIN_LOCK *)((char *)qword_1C00EC280 + 64 * (unsigned __int64)a1);
...
LABEL_8:
      *((_DWORD *)qword_1C00EC278 + a1) = 0;
      KeCancelTimer((PKTIMER)((char *)qword_1C00EC270 + v8));
      goto LABEL_9;
    }
    v3 = (_QWORD *)*v2;
    ...
    *v3 = 0LL;
    ...
    KeSetTimer((PKTIMER)((char *)qword_1C00EC270 + v10), v9, (PKDPC)((char *)qword_1C00EC270 + v10 + 64));
LABEL_9:
...
LABEL_15:
  ...
  if ( (KSPIN_LOCK *)*v2 != v2 )
  {
    ndisInsertInWorkQueue((struct _KSEMAPHORE *)v2, (struct _WORK_QUEUE_ITEM *)ndisPerCpuPoisonPills + a1, 1);
    goto LABEL_15;
  }
  if ( v4 != 2 )
    KeLowerIrql(v4);
