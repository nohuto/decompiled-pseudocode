/*
 * XREFs of WPP_RECORDER_SF_i @ 0x1C006D11C
 * Callers:
...
__int64 WPP_RECORDER_SF_i(__int64 a1, __int64 a2, __int64 a3, __int64 a4, int a5, ...)
{
  ...
  if ( (*((_DWORD *)WPP_GLOBAL_Control + 11) & 1) != 0 && *((_BYTE *)WPP_GLOBAL_Control + 41) >= 3u )
    ndisWppFastTraceMessage(&WPP_44b390fadec23ba9bcae0cc9320a34b9_Traceguids, 0xEu, va, 8LL, 0LL);
  LOWORD(v7) = 14;
  return WppAutoLogTrace(a1, 3LL, 1LL, &WPP_44b390fadec23ba9bcae0cc9320a34b9_Traceguids, v7, va);
}
