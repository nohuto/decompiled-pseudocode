/*
 * XREFs of ?ndisTranslateResources@@YAHPEAU_NDIS_MINIPORT_BLOCK@@HT_LARGE_INTEGER@@PEAT2@PEAPEAU_CM_PARTIAL_RESOURCE_DESCRIPTOR@@@Z @ 0x1C0057408
 * Callers:
 ...
 *     ?ndisImmediateReadWriteSharedMemory@@YAXPEAXKPEAEKE@Z @ 0x1C00BF2F0 (-ndisImmediateReadWriteSharedMemory@@YAXPEAXKPEAEKE@Z.c)
