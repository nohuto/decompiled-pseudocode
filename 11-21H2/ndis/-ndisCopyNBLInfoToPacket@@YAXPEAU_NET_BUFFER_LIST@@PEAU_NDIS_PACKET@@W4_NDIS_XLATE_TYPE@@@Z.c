/*
 * XREFs of ?ndisCopyNBLInfoToPacket@@YAXPEAU_NET_BUFFER_LIST@@PEAU_NDIS_PACKET@@W4_NDIS_XLATE_TYPE@@@Z @ 0x1C006DC84
 * Callers:
 ...
 * Callees:
 *     ndisIPsecNblInfoToPktInfo @ 0x1C006DE48 (ndisIPsecNblInfoToPktInfo.c)
 */
