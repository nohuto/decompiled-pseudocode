/*
 * XREFs of ?ndisIfFindInterfaceByNetLuid@@YAPEAU_NDIS_IF_BLOCK@@T_NET_LUID_LH@@@Z @ 0x1C00256E4
 * Callers:
 ...
 *     NdisIfGetInterfaceIndexFromNetLuid @ 0x1C00B24C0 (NdisIfGetInterfaceIndexFromNetLuid.c)
