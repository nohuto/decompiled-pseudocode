/*
 * XREFs of WPP_RECORDER_SF_qqqqL @ 0x1C00225C8
 * Callers:
...
__int64 WPP_RECORDER_SF_qqqqL(__int64 a1, __int64 a2, __int64 a3, __int64 a4, int a5, ...)
{
  ...
  if ( (*((_DWORD *)WPP_GLOBAL_Control + 11) & 0x200000) != 0 && *((_BYTE *)WPP_GLOBAL_Control + 41) >= 4u )
    ndisWppFastTraceMessage(
      &WPP_16eb98c3925833bf94e97087bc83531a_Traceguids,
      0xDu,
      va,
      8LL,
      va1,
      ...
      0LL);
  LOWORD(v7) = 13;
  return WppAutoLogTrace(a1, 4LL, 22LL, &WPP_16eb98c3925833bf94e97087bc83531a_Traceguids, v7, (__int64 *)va);
}
