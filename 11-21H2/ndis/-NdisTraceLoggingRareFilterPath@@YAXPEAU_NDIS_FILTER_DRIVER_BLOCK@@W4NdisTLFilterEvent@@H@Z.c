/*
 * XREFs of ?NdisTraceLoggingRareFilterPath@@YAXPEAU_NDIS_FILTER_DRIVER_BLOCK@@W4NdisTLFilterEvent@@H@Z @ 0x1C012ADC4
 * Callers:
...
void __fastcall NdisTraceLoggingRareFilterPath(__int64 a1)
{
  ...
  else if ( (unsigned int)dword_1C00EB1D8 > 5 && tlgKeywordOn((__int64)&dword_1C00EB1D8, 0x400000000000LL) )
  {
    ...
    v10 = v7;
    v9 = v8;
    tlgWriteTransfer_EtwWriteTransfer((__int64)&dword_1C00EB1D8, (unsigned __int8 *)dword_1C00D6A25, 0LL, 0LL, 4u, &v15);
  }
}
