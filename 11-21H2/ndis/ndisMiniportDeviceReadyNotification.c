/*
 * XREFs of ndisMiniportDeviceReadyNotification @ 0x1C0115170
 * Callers:
 *     <none>
 * Callees:
 ...
 *     ndisFindMiniportByPdo @ 0x1C0032E6C (ndisFindMiniportByPdo.c)
            ...
            if ( *(unsigned int **)&WPP_RECORDER_INITIALIZED != &WPP_RECORDER_INITIALIZED )
              WPP_RECORDER_SF_q(
                *((_QWORD *)WPP_GLOBAL_Control + 8),
                ...
                1u,
                0xAu,
                (struct _GUID *)&WPP_f2c4b1f7b8f63ce0f40173d4296b5311_Traceguids,
                MiniportByPdo);
