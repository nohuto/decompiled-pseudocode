/*
 * XREFs of ?ndisFDoLoopbackNetBufferList@@YAXPEAU_NDIS_FILTER_BLOCK@@PEAU_NET_BUFFER@@PEAU_NET_BUFFER_LIST@@KK@Z @ 0x1C005FE70
 * Callers:
        ...
        char a5)
{
  ...
  if ( (v9 + DataLength) >> 32 )
    return;
  Pool2 = ExAllocatePool2(64LL, (unsigned int)(v9 + DataLength), 1886143566);
  v11 = (struct _MDL *)Pool2;
  if ( !Pool2 )
    return;
  v12 = v9 + Pool2;
...
LABEL_35:
  ...
  a1->FilterIndicateReceiveNetBufferListsHandler(a1, v14, a4, 1u, 2u);
  if ( *(_DWORD *)ndisNblTrackerMode )
