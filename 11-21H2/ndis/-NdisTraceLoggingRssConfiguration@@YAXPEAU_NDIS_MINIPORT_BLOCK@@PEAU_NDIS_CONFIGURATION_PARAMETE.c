/*
 * XREFs of ?NdisTraceLoggingRssConfiguration@@YAXPEAU_NDIS_MINIPORT_BLOCK@@PEAU_NDIS_CONFIGURATION_PARAMETER@@H@Z @ 0x1C00325C4
 * Callers:
        ...
        struct _NDIS_CONFIGURATION_PARAMETER *a2)
{
  ...
  {
    v3 = tlgKeywordOn((__int64)&dword_1C00EB1D8, 0x200000000000LL);
    v8 = 0;
    if ( v3 )
    {
      if ( v6 )
