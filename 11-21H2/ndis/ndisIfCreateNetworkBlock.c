/*
 * XREFs of ndisIfCreateNetworkBlock @ 0x1C002C3E0
 * Callers:
...
LABEL_36:
  ...
  *v14 = v14;
  ...
  while ( v10 );
  v23 = *a3;
  v24 = (__int64 *)qword_1C00ECDD0;
  *v15 = v23;
  while ( v24 != &qword_1C00ECDD0 )
  {
...
LABEL_33:
    if ( ++v33 == 0xFFFFFFF )
    {
      *((_DWORD *)v12 + 22) = 0xFFFFFFF;
      dword_1C00EB958 = v32 & 0xF0000000 | 0xFFFFFFE;
      v8 = -1073741670;
      goto LABEL_35;
    }
    for ( i = qword_1C00ECDD0; (__int64 *)i != &qword_1C00ECDD0; i = *(_QWORD *)i )
    {
      if ( v33 == *(_DWORD *)(i + 88) )
        goto LABEL_33;
    }
    *((_DWORD *)v12 + 22) = v33;
    dword_1C00EB958 = (v33 ^ v32) & 0xFFFFFFF ^ v32;
    goto LABEL_15;
  }
  dword_1C00EB958 ^= (dword_1C00EB958 ^ (dword_1C00EB958 + 1)) & 0xFFFFFFF;
  if ( (dword_1C00EB958 & 0xFFFFFFF) == 0xFFFFFFF )
  {
    byte_1C00EE650 = 1;
    v32 = dword_1C00EB958 & 0xF0000000 | 0x7FFFFFF;
    dword_1C00EB958 = v32;
    goto LABEL_32;
  }
  *((_DWORD *)v12 + 22) = dword_1C00EB958 & 0xFFFFFFF;
LABEL_15:
  v26 = v24[1];
  ++dword_1C00EC1FC;
  v27 = *(_QWORD *)v26;
