/*
 * XREFs of FlushLookUpTableBucket @ 0x1C00CD510
 * Callers:
 *     LookUpTableFlushComplete @ 0x1C01147D0 (LookUpTableFlushComplete.c)
 *     LookUpTableFlushPartial @ 0x1C0138318 (LookUpTableFlushPartial.c)
 * Callees:
 *     FlattenEventEntryTree @ 0x1C00CD4C8 (FlattenEventEntryTree.c)
 *     FlushEventEntryList @ 0x1C0138278 (FlushEventEntryList.c)
 */
