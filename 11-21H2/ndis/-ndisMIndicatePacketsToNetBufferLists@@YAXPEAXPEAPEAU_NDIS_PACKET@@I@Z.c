/*
 * XREFs of ?ndisMIndicatePacketsToNetBufferLists@@YAXPEAXPEAPEAU_NDIS_PACKET@@I@Z @ 0x1C00C4980
 * Callers:
 *     <none>
 * Callees:
    ...
    if ( byte_1C00EC210 )
    {
      ...
      if ( CompContext )
      {
        if ( (*((_DWORD *)CompContext + 13) & 1) != 0 )
          PktMonClientNblLogNdis((__int64)&a1->PktMonEdge, (__int64)v7, v15, 1LL);
      }
    }
