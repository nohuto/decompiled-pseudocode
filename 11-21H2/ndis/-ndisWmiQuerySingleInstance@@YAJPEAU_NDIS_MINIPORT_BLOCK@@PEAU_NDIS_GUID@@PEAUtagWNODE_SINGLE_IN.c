/*
 * XREFs of ?ndisWmiQuerySingleInstance@@YAJPEAU_NDIS_MINIPORT_BLOCK@@PEAU_NDIS_GUID@@PEAUtagWNODE_SINGLE_INSTANCE@@KPEAK@Z @ 0x1C0026CB0
 * Callers:
 *     ndisWMIDispatch @ 0x1C00102C0 (ndisWMIDispatch.c)
 *     NdisWdfQuerySingleInstance @ 0x1C005B610 (NdisWdfQuerySingleInstance.c)
 * Callees:
