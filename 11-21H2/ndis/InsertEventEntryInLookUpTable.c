/*
 * XREFs of InsertEventEntryInLookUpTable @ 0x1C00CD5F4
 * Callers:
 ...
 * Callees:
 *     CompareEventEntry @ 0x1C00CD064 (CompareEventEntry.c)
 *     ComputeEventEntryHash @ 0x1C00CD0F0 (ComputeEventEntryHash.c)
