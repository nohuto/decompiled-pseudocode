/*
 * XREFs of ?ndisGetAdapterRssInfo@@YAHPEAU_NDIS_MINIPORT_BLOCK@@PEAU_IRP@@PEAH@Z @ 0x1C0028FD8
 * Callers:
        ...
        *((_DWORD *)&v8.MasterIrp->Overlay.AllocationSize + 3) = CombinedNdisRSSParameters->DefaultProcessorNumber;
        ...
        else
        {
          ...
          memmove(
            ...
            a1->CombinedNdisRSSParameters->IndirectionTableSize);
          v7 = a1->CombinedNdisRSSParameters->IndirectionTableSize + v12;
        }
      }
      else
      {
        ...
        if ( RssProcessorInformation >= 0 )
        {
          ...
          *(_QWORD *)&v16 = *(_QWORD *)&v15[1].Header.Type;
          ...
          else
          {
            ...
            v8.MasterIrp->Tail.Apc.SpareLong0 = v7 - 104;
            memmove((char *)v8.MasterIrp + v7, v20, v17);
            v7 += v17;
          }
        }
