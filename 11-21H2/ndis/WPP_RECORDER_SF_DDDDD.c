/*
 * XREFs of WPP_RECORDER_SF_DDDDD @ 0x1C00AC80C
 * Callers:
...
__int64 WPP_RECORDER_SF_DDDDD(__int64 a1, __int64 a2, __int64 a3, __int64 a4, int a5, ...)
{
  ...
  if ( (*((_DWORD *)WPP_GLOBAL_Control + 11) & 2) != 0 && *((_BYTE *)WPP_GLOBAL_Control + 41) )
    ndisWppFastTraceMessage(
      &WPP_11a28086b84d3ef8c5fd89228ccff39a_Traceguids,
      0xFu,
      va,
      4LL,
      va1,
      ...
      0LL);
  LOWORD(v7) = 15;
  return WppAutoLogTrace(a1, 1LL, 2LL, &WPP_11a28086b84d3ef8c5fd89228ccff39a_Traceguids, v7, (__int64 *)va);
}
