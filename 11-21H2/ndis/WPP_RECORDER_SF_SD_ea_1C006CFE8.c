/*
 * XREFs of WPP_RECORDER_SF_SD @ 0x1C006CFE8
 * Callers:
...
__int64 WPP_RECORDER_SF_SD(__int64 a1, __int64 a2, __int64 a3, unsigned __int16 a4, int a5, const wchar_t *a6, ...)
{
  ...
  if ( (*((_DWORD *)WPP_GLOBAL_Control + 11) & 0x4000000) != 0 && *((_BYTE *)WPP_GLOBAL_Control + 41) >= 4u )
  {
    ...
    if ( !a6 )
      v12 = L"NULL";
    ndisWppFastTraceMessage(&WPP_44b390fadec23ba9bcae0cc9320a34b9_Traceguids, a4, v12, v11, va, 4LL, 0LL);
  }
  v13 = a6 == 0LL;
  if ( a6 )
  {
  ...
  if ( v13 )
    v6 = L"NULL";
  LOWORD(v15) = a4;
  return WppAutoLogTrace(a1, 4LL, 27LL, &WPP_44b390fadec23ba9bcae0cc9320a34b9_Traceguids, v15, v6);
}
