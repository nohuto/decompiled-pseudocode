/*
 * XREFs of ?GetCurrentFeatureEnabledState@?$FeatureImpl@U__WilFeatureTraits_Feature_MTCATest@@@details@wil@@AEAA?ATwil_details_FeatureStateCache@@PEAH@Z @ 0x18003EB1C
 * Callers:
 *     ?GetCachedFeatureEnabledState@?$FeatureImpl@U__WilFeatureTraits_Feature_MTCATest@@@details@wil@@AEAA?ATwil_details_FeatureStateCache@@XZ @ 0x18003EC8C (-GetCachedFeatureEnabledState@-$FeatureImpl@U__WilFeatureTraits_Feature_MTCATest@@@details@wil@@.c)
 * Callees:
...
_QWORD *__fastcall wil::details::FeatureImpl<__WilFeatureTraits_Feature_MTCATest>::GetCurrentFeatureEnabledState(
        __int64 a1,
        _QWORD *a2,
        ...
        int *a4)
{
  ...
  FeatureEnabledState = wil::details::WilApi_GetFeatureEnabledState((wil::details *)0x1BE4A0A, 3u, a3, a4);
  v6 = 0;
  *a2 = 0LL;
