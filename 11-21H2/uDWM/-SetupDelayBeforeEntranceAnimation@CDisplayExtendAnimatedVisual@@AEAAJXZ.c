/*
 * XREFs of ?SetupDelayBeforeEntranceAnimation@CDisplayExtendAnimatedVisual@@AEAAJXZ @ 0x1800B79A4
 * Callers:
 *     ?OnAnimationCompleteImpl@CDisplayExtendAnimatedVisual@@EEAAJI@Z @ 0x1800B7760 (-OnAnimationCompleteImpl@CDisplayExtendAnimatedVisual@@EEAAJI@Z.c)
 * Callees:
