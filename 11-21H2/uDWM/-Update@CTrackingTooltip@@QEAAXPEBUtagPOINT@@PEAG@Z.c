/*
 * XREFs of ?Update@CTrackingTooltip@@QEAAXPEBUtagPOINT@@PEAG@Z @ 0x1800E938C
 * Callers:
 ...
 * Callees:
 *     ?UpdateTooltipLocation@CTrackingTooltip@@IEAAXXZ @ 0x1800E9434 (-UpdateTooltipLocation@CTrackingTooltip@@IEAAXXZ.c)
 */
