/*
 * XREFs of ?StartShowAnimation@?$produce@UUserResizeVisual@implementation@Transitions@Udwm@winrt@@UIUserResizeVisual@345@@impl@winrt@@UEAAHXZ @ 0x1800FFA20
 * Callers:
 *     <none>
 * Callees:
        ...
        unsigned __int64 a1)
{
  ...
  {
    CVisual::SetOpacity(
      *(CVisual **)(*(_QWORD *)(*(_QWORD *)(((a1 - 8) & ((unsigned __int128)-(__int128)a1 >> 64)) + 0x28) + 336LL)
                  + 440LL),
      0.0);
    CTopLevelWindow3D::StartAnimation(*(_QWORD *)(v1 + 40), 14);
    v2 = *(CAcrylicSheet **)(v1 + 32);
