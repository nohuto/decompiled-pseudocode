/*
 * XREFs of ?Create@CDisplayDuplicateToExtendAnimatedVisual@@SAJPEAPEAV1@@Z @ 0x1800B98A4
 * Callers:
 ...
 *     ??0CDisplayDuplicateToExtendAnimatedVisual@@IEAA@XZ @ 0x1800B62CC (--0CDisplayDuplicateToExtendAnimatedVisual@@IEAA@XZ.c)
 */
