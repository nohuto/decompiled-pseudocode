/*
 * XREFs of ?put_EndClip@?$produce@UAnimatedTransitionVisualWrapper@implementation@Transitions@Udwm@winrt@@UIAnimatedTransitionVisualWrapper@345@@impl@winrt@@UEAAHURect@Foundation@Windows@3@@Z @ 0x1800F18B0
 * Callers:
 *     <none>
 * Callees:
        ...
        const __m128i *a2)
{
  ...
  try
  {
    ...
    v6 = *((_QWORD *)v3 + 5);
    *(_OWORD *)(v6 + 904) = v8;
    CVisual::SetDirtyFlags((CVisual *)(v6 + 8), 4096);
    result = 0LL;
  }
  catch ( ... )
  {
