/*
 * XREFs of ?_WindowEnumCallback@CInputView_SizeOrModeChangeBase@@EEAA_NPEAVCWindowData@@W4EnumWindowFlags@CStoryboard@@PEAJ@Z @ 0x1800DF060
 * Callers:
 *     <none>
 * Callees:
  ...
  if ( (a3 & 1) != 0 )
  {
    ...
    switch ( *(_DWORD *)(a2 + 672) & 0xFFF )
    {
      ...
      case 43:
        ...
        v4 = v10;
        if ( v10 < 0 )
          MilInstrumentationCheckHR_MaybeFailFast(0x14u, &CStoryboard::MILINSTRUMENTATIONHRESULTLIST, 1LL, v10, 0x1454u);
        break;
      default:
