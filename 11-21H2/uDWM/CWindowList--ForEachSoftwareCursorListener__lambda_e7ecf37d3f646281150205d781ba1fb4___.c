/*
 * XREFs of CWindowList::ForEachSoftwareCursorListener__lambda_e7ecf37d3f646281150205d781ba1fb4___ @ 0x1801014E0
 * Callers:
        ...
        __int64 a2)
{
  ...
  if ( v4 )
  {
    while ( 1 )
    {
      v7 = *(_QWORD *)(*(_QWORD *)(a1 + 664) + 8LL * v6);
      if ( v7 == **(_QWORD **)a2 )
        break;
      if ( ++v6 >= v4 )
        goto LABEL_12;
    ...
    {
      for ( ; (unsigned int)v5 < v9 - 1; v9 = *(_DWORD *)(v8 + 688) )
      {
        v11 = (unsigned int)v5;
        LODWORD(v5) = v5 + 1;
