/*
 * XREFs of ?TransferTransitionVisualAndAnimationEngine@?$consume_Udwm_Transitions_ITransitionState@UITransitionState@Transitions@Udwm@winrt@@@impl@winrt@@QEBA?AUTopLevelWindow3DWrapper@Transitions@Udwm@3@XZ @ 0x180011C40
 * Callers:
