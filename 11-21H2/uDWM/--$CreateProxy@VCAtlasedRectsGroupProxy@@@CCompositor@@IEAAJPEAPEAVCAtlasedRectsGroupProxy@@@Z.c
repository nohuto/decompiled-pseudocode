/*
 * XREFs of ??$CreateProxy@VCAtlasedRectsGroupProxy@@@CCompositor@@IEAAJPEAPEAVCAtlasedRectsGroupProxy@@@Z @ 0x180026C10
 * Callers:
...
LABEL_16:
  ...
  *(_QWORD *)(v7 + 16) = v6;
  v9 = (*(__int64 (__fastcall **)(__int64, __int64, __int64))(*(_QWORD *)v6 + 96LL))(v6, 2LL, v7 + 24);
  if ( v9 < 0 )
  {
    v14 = 68;
LABEL_11:
