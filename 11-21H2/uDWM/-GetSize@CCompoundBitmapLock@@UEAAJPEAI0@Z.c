/*
 * XREFs of ?GetSize@CCompoundBitmapLock@@UEAAJPEAI0@Z @ 0x18005F9B0
 * Callers:
 *     ?GetSize@CCompoundBitmapLock@@W7EAAJPEAI0@Z @ 0x180063E60 (-GetSize@CCompoundBitmapLock@@W7EAAJPEAI0@Z.c)
 * Callees:
 *     <none>
 */
