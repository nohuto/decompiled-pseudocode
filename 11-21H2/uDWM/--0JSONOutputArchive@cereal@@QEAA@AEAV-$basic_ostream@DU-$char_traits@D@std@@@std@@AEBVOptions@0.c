/*
 * XREFs of ??0JSONOutputArchive@cereal@@QEAA@AEAV?$basic_ostream@DU?$char_traits@D@std@@@std@@AEBVOptions@01@@Z @ 0x180042D88
 * Callers:
...
__int64 __fastcall cereal::JSONOutputArchive::JSONOutputArchive(__int64 a1, __int64 a2, __int64 a3)
{
  ...
  *(_DWORD *)(a1 + 396) = v8;
  v13 = 0;
  std::deque<unsigned int>::_Emplace_back_internal<unsigned int>(a1 + 416, &v13);
  v13 = 0;
