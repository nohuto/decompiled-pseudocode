/*
 * XREFs of ?TargetAverageGlitchDuration@CCompFrameStats@@UEBAMAEBUtagCOMPOSITION_TARGET_ID@@PEAM_K2@Z @ 0x18010AC10
 * Callers:
 *     ?TargetAverageGlitchDuration@CAnimationFrameStats@@UEBAMAEBUtagCOMPOSITION_TARGET_ID@@PEAM_K2@Z @ 0x18010A9D0 (-TargetAverageGlitchDuration@CAnimationFrameStats@@UEBAMAEBUtagCOMPOSITION_TARGET_ID@@PEAM_K2@Z.c)
 * Callees:
 ...
 *     std::for_each_std::_Vector_iterator_std::_Vector_val_std::_Simple_types_float_______lambda_f0bf7093c06592d2ef07a5499c562608___ @ 0x18010AAD0 (std--for_each_std--_Vector_iterator_std--_Vector_val_std--_Simple_types_float_______lambda_f0bf7.c)
 */
  ...
  *(_QWORD *)&v37 = v10;
            ...
            if ( v16 )
            {
              ...
              if ( v17 )
              {
                if ( v17 > v16 )
                {
                  ...
                  if ( v12 == v9 )
                  {
                    std::vector<float>::_Emplace_reallocate<float const &>((const void **)&v39, v12, &v41);
                    v9 = v40;
  ...
  if ( v27 )
  {
    ...
    if ( v27 > 1 )
    {
      ...
      std::for_each_std::_Vector_iterator_std::_Vector_val_std::_Simple_types_float_______lambda_f0bf7093c06592d2ef07a5499c562608___(
        &v37,
        (float *)v39,
        v12,
