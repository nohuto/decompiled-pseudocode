/*
 * XREFs of ?ReportUsage@?$FeatureImpl@U__WilFeatureTraits_Feature_SRITest@@@details@wil@@QEAAX_NW4ReportingKind@3@_K@Z @ 0x180053DD0
 * Callers:
...
__int64 __fastcall wil::details::FeatureImpl<__WilFeatureTraits_Feature_SRITest>::ReportUsage(
        _DWORD *a1,
        unsigned __int8 a2,
        __int64 a3,
        __int64 a4)
{
  ...
  if ( (*a1 & 2) == 0 )
  {
    v4 = *(_QWORD *)wil::details::FeatureImpl<__WilFeatureTraits_Feature_SRITest>::GetCachedFeatureEnabledState(a1, v8);
    v11 = v4;
  }
  v9 = 1;
  v10 = 3;
