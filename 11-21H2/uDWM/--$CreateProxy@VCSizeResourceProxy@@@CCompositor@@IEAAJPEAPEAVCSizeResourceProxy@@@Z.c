/*
 * XREFs of ??$CreateProxy@VCSizeResourceProxy@@@CCompositor@@IEAAJPEAPEAVCSizeResourceProxy@@@Z @ 0x18000F810
 * Callers:
...
__int64 __fastcall CCompositor::CreateProxy<CSizeResourceProxy>(__int64 a1, CBaseObject **a2)
{
  __int64 v4; // rax
  CBaseObject *v5; // rbx
  int v6; // eax
  ...
  *a2 = 0LL;
  ...
  if ( v4 )
  {
    ...
    *(_QWORD *)v4 = &CAnimationProxy::`vftable';
    ...
    v6 = CResource::Create(34LL, *(_QWORD *)(a1 + 16), v4 + 16);
    v7 = v6;
    if ( v6 < 0 )
    {
