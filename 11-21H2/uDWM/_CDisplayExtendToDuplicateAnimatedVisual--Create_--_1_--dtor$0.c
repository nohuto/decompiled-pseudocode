/*
 * XREFs of _CDisplayExtendToDuplicateAnimatedVisual::Create_::_1_::dtor$0 @ 0x1800B9BD1
 * Callers:
 *     <none>
 * Callees:
...
void __fastcall CDisplayExtendToDuplicateAnimatedVisual::Create_::_1_::dtor_0(__int64 a1, __int64 a2)
{
