/*
 * XREFs of ?_Update3DResources@CAnimatedTransitionVisual@@IEAAJXZ @ 0x1800A01E4
 * Callers:
 ...
 *     ?PerspectiveProjection@Matrix4x4F@D2D1@@SA?AV12@M@Z @ 0x18009EC54 (-PerspectiveProjection@Matrix4x4F@D2D1@@SA-AV12@M@Z.c)
 *     ?SetProduct@Matrix4x4F@D2D1@@QEAAXAEBV12@0@Z @ 0x18009F114 (-SetProduct@Matrix4x4F@D2D1@@QEAAXAEBV12@0@Z.c)
...
__int64 __fastcall CAnimatedTransitionVisual::_Update3DResources(CAnimatedTransitionVisual *this)
{
  ...
  *(_OWORD *)&v18._41 = _xmm;
  ...
  if ( v9 >= 0 )
  {
    ...
    v20 = *(struct tagRECT *)((char *)this + 296);
