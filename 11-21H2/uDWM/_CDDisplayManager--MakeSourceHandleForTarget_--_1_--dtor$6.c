/*
 * XREFs of _CDDisplayManager::MakeSourceHandleForTarget_::_1_::dtor$6 @ 0x1800AF5F6
 * Callers:
 *     <none>
 * Callees:
 *     <none>
...
__int64 __fastcall CDDisplayManager::MakeSourceHandleForTarget_::_1_::dtor_6(__int64 a1, __int64 a2)
{
