/*
 * XREFs of ?_UpdateResources@CLivePreview@@AEAAJXZ @ 0x1800C4D74
 * Callers:
...
__int64 __fastcall CLivePreview::_UpdateResources(CLivePreview *this)
{
  ...
  if ( *((_DWORD *)this + 100) )
  {
    ...
    MilInstrumentationCheckHR_MaybeFailFast(0x14u, 0LL, 0LL, updated, 0x5C6u);
  }
  else
  {
    SetLastError(0);
    if ( !EnumDisplayMonitors(0LL, 0LL, CLivePreview::s_UpdateResourcesForMonitor, (LPARAM)this) )
    {
      ...
      if ( (v1 & 0x80000000) == 0 )
        v1 = -2003304445;
      MilInstrumentationCheckHR_MaybeFailFast(0x14u, 0LL, 0LL, v1, 0x5C0u);
    }
  }
  return v1;
}
