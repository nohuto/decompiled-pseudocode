/*
 * XREFs of ?assign@shared_buffer@details@wil@@AEAAXPEAJ_K@Z @ 0x180096724
 * Callers:
 *     ??0ResultException@wil@@QEAA@AEBV01@@Z @ 0x180093A48 (--0ResultException@wil@@QEAA@AEBV01@@Z.c)
