/*
 * XREFs of ?EnsureNoiseSurfaceBrush@CAccentAcrylicBlurBehind@@AEAAJXZ @ 0x180055940
 * Callers:
...
__int64 __fastcall CAccentAcrylicBlurBehind::EnsureNoiseSurfaceBrush(CAccentAcrylicBlurBehind *this)
{
  ...
  if ( !*((_QWORD *)this + 42) )
  {
    ...
    if ( v11 < 0 )
    {
      MilInstrumentationCheckHR_MaybeFailFast(0x14u, 0LL, 0LL, v11, 0x7B1u);
      Microsoft::WRL::ComPtr<IUnknown>::InternalRelease(&v50);
    ...
    else
    {
      ...
      if ( v12 < 0 )
      {
        MilInstrumentationCheckHR_MaybeFailFast(0x14u, 0LL, 0LL, v12, 0x7B2u);
        Microsoft::WRL::ComPtr<IUnknown>::InternalRelease(&v50);
        (*(void (__fastcall **)(__int64))(*(_QWORD *)v9 + 16LL))(v9);
      }
      else
      {
        ...
        if ( v14 < 0 )
        {
          MilInstrumentationCheckHR_MaybeFailFast(0x14u, 0LL, 0LL, v14, 0x7B5u);
          Microsoft::WRL::ComPtr<IUnknown>::InternalRelease(&v51);
          Microsoft::WRL::ComPtr<IUnknown>::InternalRelease(&v50);
          (*(void (__fastcall **)(__int64))(*(_QWORD *)v9 + 16LL))(v9);
        }
        else
        {
          ...
          if ( v17 < 0 )
          {
            MilInstrumentationCheckHR_MaybeFailFast(0x14u, 0LL, 0LL, v17, 0x7B8u);
            Microsoft::WRL::ComPtr<IUnknown>::InternalRelease(&v53);
            Microsoft::WRL::ComPtr<IUnknown>::InternalRelease(&v51);
            Microsoft::WRL::ComPtr<IUnknown>::InternalRelease(&v50);
            (*(void (__fastcall **)(__int64))(*(_QWORD *)v9 + 16LL))(v9);
          ...
          else
          {
            ...
            if ( v19 < 0 )
            {
              MilInstrumentationCheckHR_MaybeFailFast(0x14u, 0LL, 0LL, v19, 0x7BBu);
              Microsoft::WRL::ComPtr<IUnknown>::InternalRelease(&v52);
              Microsoft::WRL::ComPtr<IUnknown>::InternalRelease(&v53);
              Microsoft::WRL::ComPtr<IUnknown>::InternalRelease(&v51);
              Microsoft::WRL::ComPtr<IUnknown>::InternalRelease(&v50);
            ...
            else
            {
              ...
              if ( v20 < 0 )
              {
                MilInstrumentationCheckHR_MaybeFailFast(0x14u, 0LL, 0LL, v20, 0x7BCu);
                Microsoft::WRL::ComPtr<IUnknown>::InternalRelease(&v52);
                Microsoft::WRL::ComPtr<IUnknown>::InternalRelease(&v53);
                Microsoft::WRL::ComPtr<IUnknown>::InternalRelease(&v51);
                Microsoft::WRL::ComPtr<IUnknown>::InternalRelease(&v50);
              ...
              else
              {
                ...
                if ( v22 < 0 )
                {
                  MilInstrumentationCheckHR_MaybeFailFast(0x14u, 0LL, 0LL, v22, 0x7BFu);
                  Microsoft::WRL::ComPtr<IUnknown>::InternalRelease(&v54);
                  Microsoft::WRL::ComPtr<IUnknown>::InternalRelease(&v52);
                  Microsoft::WRL::ComPtr<IUnknown>::InternalRelease(&v53);
                  Microsoft::WRL::ComPtr<IUnknown>::InternalRelease(&v51);
                ...
                else
                {
                  ...
                  if ( v23 < 0 )
                  {
                    MilInstrumentationCheckHR_MaybeFailFast(0x14u, 0LL, 0LL, v23, 0x7C4u);
                    Microsoft::WRL::ComPtr<IUnknown>::InternalRelease(&v54);
                    Microsoft::WRL::ComPtr<IUnknown>::InternalRelease(&v52);
                    Microsoft::WRL::ComPtr<IUnknown>::InternalRelease(&v53);
                    Microsoft::WRL::ComPtr<IUnknown>::InternalRelease(&v51);
                  ...
                  else
                  {
                    ...
                    if ( v25 < 0 )
                    {
                      MilInstrumentationCheckHR_MaybeFailFast(0x14u, 0LL, 0LL, v25, 0x7C8u);
                    ...
                    else
                    {
                      ...
                      if ( v26 < 0 )
                      {
                        MilInstrumentationCheckHR_MaybeFailFast(0x14u, 0LL, 0LL, v26, 0x7C9u);
                        Microsoft::WRL::ComPtr<IUnknown>::InternalRelease(&v55);
                        Microsoft::WRL::ComPtr<IUnknown>::InternalRelease(&v54);
                        Microsoft::WRL::ComPtr<IUnknown>::InternalRelease(&v52);
                        Microsoft::WRL::ComPtr<IUnknown>::InternalRelease(&v53);
                      ...
                      else
                      {
                        ...
                        if ( v27 < 0 )
                        {
                          MilInstrumentationCheckHR_MaybeFailFast(0x14u, 0LL, 0LL, v27, 0x7CCu);
                        ...
                        {
                          v56 = 0LL;
                          v28 = (CGraphicsDeviceManager *)*((_QWORD *)CDesktopManager::s_pDesktopManagerInstance + 6);
                          ...
                          if ( v34 < 0 )
                          {
                            MilInstrumentationCheckHR_MaybeFailFast(0x14u, 0LL, 0LL, v34, 0x7D3u);
                            Microsoft::WRL::ComPtr<IUnknown>::InternalRelease((__int64 *)&v56);
                            Microsoft::WRL::ComPtr<IUnknown>::InternalRelease(&v59);
                            Microsoft::WRL::ComPtr<IUnknown>::InternalRelease(&v55);
                            Microsoft::WRL::ComPtr<IUnknown>::InternalRelease(&v54);
                          ...
                          else
                          {
                            ...
                            if ( v35 < 0 )
                            {
                              MilInstrumentationCheckHR_MaybeFailFast(0x14u, 0LL, 0LL, v35, 0x7D6u);
                            ...
                            else
                            {
                              ...
                              if ( v38 < 0 )
                              {
                                MilInstrumentationCheckHR_MaybeFailFast(0x14u, 0LL, 0LL, v38, 0x7DBu);
                                Microsoft::WRL::ComPtr<IUnknown>::InternalRelease(&v57);
                                Microsoft::WRL::ComPtr<IUnknown>::InternalRelease(&v58);
                                Microsoft::WRL::ComPtr<IUnknown>::InternalRelease((__int64 *)&v56);
                                Microsoft::WRL::ComPtr<IUnknown>::InternalRelease(&v59);
                              ...
                              else
                              {
                                ...
                                if ( v40 < 0 )
                                {
                                  MilInstrumentationCheckHR_MaybeFailFast(0x14u, 0LL, 0LL, v40, 0x7DFu);
                                  Microsoft::WRL::ComPtr<IUnknown>::InternalRelease(&v60);
                                  Microsoft::WRL::ComPtr<IUnknown>::InternalRelease(&v57);
                                  Microsoft::WRL::ComPtr<IUnknown>::InternalRelease(&v58);
                                  Microsoft::WRL::ComPtr<IUnknown>::InternalRelease((__int64 *)&v56);
                                ...
                                else
                                {
                                  ...
                                  if ( v41 < 0 )
                                  {
                                    MilInstrumentationCheckHR_MaybeFailFast(0x14u, 0LL, 0LL, v41, 0x7F4u);
                                    Microsoft::WRL::ComPtr<IUnknown>::InternalRelease(&v60);
                                    Microsoft::WRL::ComPtr<IUnknown>::InternalRelease(&v57);
                                    Microsoft::WRL::ComPtr<IUnknown>::InternalRelease(&v58);
                                    Microsoft::WRL::ComPtr<IUnknown>::InternalRelease((__int64 *)&v56);
                                  ...
                                  else
                                  {
                                    ...
                                    if ( v42 < 0 )
                                    {
                                      MilInstrumentationCheckHR_MaybeFailFast(0x14u, 0LL, 0LL, v42, 0x7F7u);
                                    ...
                                    else
                                    {
                                      ...
                                      if ( v43 < 0 )
                                      {
                                        MilInstrumentationCheckHR_MaybeFailFast(0x14u, 0LL, 0LL, v43, 0x7FBu);
                                      ...
                                      else
                                      {
                                        ...
                                        if ( v46 < 0 )
                                        {
                                          MilInstrumentationCheckHR_MaybeFailFast(0x14u, 0LL, 0LL, v46, 0x7FFu);
                                          Microsoft::WRL::ComPtr<IUnknown>::InternalRelease((__int64 *)&v61);
                                          Microsoft::WRL::ComPtr<IUnknown>::InternalRelease(&v65);
                                          Microsoft::WRL::ComPtr<IUnknown>::InternalRelease(&v62);
                                          Microsoft::WRL::ComPtr<IUnknown>::InternalRelease(&v60);
                                        ...
                                        else
                                        {
                                          ...
                                          if ( v47 < 0 )
                                          {
                                            MilInstrumentationCheckHR_MaybeFailFast(0x14u, 0LL, 0LL, v47, 0x800u);
                                            Microsoft::WRL::ComPtr<IUnknown>::InternalRelease((__int64 *)&v61);
                                            Microsoft::WRL::ComPtr<IUnknown>::InternalRelease(&v65);
                                            Microsoft::WRL::ComPtr<IUnknown>::InternalRelease(&v62);
                                            Microsoft::WRL::ComPtr<IUnknown>::InternalRelease(&v60);
                                          ...
                                          else
                                          {
                                            ...
                                            v2 = v48;
                                            if ( v48 < 0 )
                                              MilInstrumentationCheckHR_MaybeFailFast(0x14u, 0LL, 0LL, v48, 0x803u);
                                            Microsoft::WRL::ComPtr<IUnknown>::InternalRelease((__int64 *)&v61);
                                            Microsoft::WRL::ComPtr<IUnknown>::InternalRelease(&v65);
                                            Microsoft::WRL::ComPtr<IUnknown>::InternalRelease(&v62);
                                            Microsoft::WRL::ComPtr<IUnknown>::InternalRelease(&v60);
