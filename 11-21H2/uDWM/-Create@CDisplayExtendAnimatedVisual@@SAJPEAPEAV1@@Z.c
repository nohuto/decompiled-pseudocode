/*
 * XREFs of ?Create@CDisplayExtendAnimatedVisual@@SAJPEAPEAV1@@Z @ 0x1800B99C0
 * Callers:
 ...
 *     ??0CDisplayExtendAnimatedVisual@@IEAA@XZ @ 0x1800B71D0 (--0CDisplayExtendAnimatedVisual@@IEAA@XZ.c)
 */
...
__int64 __fastcall CDisplayExtendAnimatedVisual::Create(struct CDisplayExtendAnimatedVisual **a1)
{
  ...
  struct CDisplayExtendAnimatedVisual *v4; // rdi
  int v5; // r10d

  if ( a1 )
  {
    v3 = (CDisplayExtendAnimatedVisual *)(*(__int64 (__fastcall **)(WPF::HeapBase *, __int64))(*(_QWORD *)WPF::g_pProcessHeap
                                                                                             + 16LL))(
                                           WPF::g_pProcessHeap,
                                           528LL);
    if ( v3 )
