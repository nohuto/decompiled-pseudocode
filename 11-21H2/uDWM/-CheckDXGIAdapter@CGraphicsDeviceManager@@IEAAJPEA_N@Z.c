/*
 * XREFs of ?CheckDXGIAdapter@CGraphicsDeviceManager@@IEAAJPEA_N@Z @ 0x18003C864
 * Callers:
...
__int64 __fastcall CGraphicsDeviceManager::CheckDXGIAdapter(CGraphicsDeviceManager *this, bool *a2)
{
  ...
  CWindowData *i; // rbx
  _QWORD *v16; // rax
  PVOID RestartKey; // [rsp+30h] [rbp-D0h] BYREF
  ...
  v5 = *v4;
  v19[0] = 0LL;
  v6 = (*(__int64 (__fastcall **)(__int64 *, GUID *, _QWORD *))(v5 + 48))(
         v4,
  ...
  if ( (*(int (__fastcall **)(_QWORD))(**((_QWORD **)this + 6) + 312LL))(*((_QWORD *)this + 6)) < 0 )
    goto LABEL_17;
  if ( !(*(unsigned int (__fastcall **)(_QWORD))(*(_QWORD *)v19[0] + 104LL))(v19[0]) )
  {
    memset_0(v20, 0, 0x130uLL);
    v6 = (*(__int64 (__fastcall **)(_QWORD, _BYTE *))(**((_QWORD **)this + 4) + 64LL))(*((_QWORD *)this + 4), v20);
    v7 = v6;
    if ( v6 >= 0 )
    {
      ppFactory = 0LL;
      ...
      if ( v8 < 0 )
      {
        ...
        wil::com_ptr_t<Windows::Devices::Display::Core::IDisplayState,wil::err_returncode_policy>::~com_ptr_t<Windows::Devices::Display::Core::IDisplayState,wil::err_returncode_policy>(&ppFactory);
        goto LABEL_12;
      }
      RestartKey = 0LL;
      v9 = *(_QWORD *)ppFactory;
      RestartKey = 0LL;
      v10 = (*(int (__fastcall **)(void *, __int64, GUID *, PVOID *))(v9 + 208))(
              ppFactory,
              v21,
              &GUID_2411e7e1_12ac_4ccf_bd14_9798e8534dc0,
              &RestartKey) >= 0;
      wil::com_ptr_t<Windows::Devices::Display::Core::IDisplayState,wil::err_returncode_policy>::~com_ptr_t<Windows::Devices::Display::Core::IDisplayState,wil::err_returncode_policy>(&RestartKey);
      wil::com_ptr_t<Windows::Devices::Display::Core::IDisplayState,wil::err_returncode_policy>::~com_ptr_t<Windows::Devices::Display::Core::IDisplayState,wil::err_returncode_policy>(&ppFactory);
      if ( v10 )
        goto LABEL_9;
LABEL_17:
...
LABEL_11:
  v7 = 0;
LABEL_12:
  wil::com_ptr_t<Windows::Devices::Display::Core::IDisplayState,wil::err_returncode_policy>::~com_ptr_t<Windows::Devices::Display::Core::IDisplayState,wil::err_returncode_policy>(v19);
  return v7;
}
