/*
 * XREFs of ?DesktopCreate@CWindowList@@AEAAJPEBUMILCMD_DWM_REDIRECTION_NOTIFYDESKTOPCREATE@@@Z @ 0x18004CAF0
 * Callers:
        ...
        const struct MILCMD_DWM_REDIRECTION_NOTIFYDESKTOPCREATE *a2)
{
  ...
  int v10; // r9d
  unsigned int v11; // [rsp+28h] [rbp-29h]
  __int64 Buffer; // [rsp+38h] [rbp-19h] BYREF
  struct CVisual *v13; // [rsp+40h] [rbp-11h]
  __int128 v14; // [rsp+48h] [rbp-9h]
  __int128 v15; // [rsp+58h] [rbp+7h]
  __int128 v16; // [rsp+68h] [rbp+17h]
  __int64 v17; // [rsp+78h] [rbp+27h]
  char v18; // [rsp+80h] [rbp+2Fh]
  struct _RTL_CRITICAL_SECTION *v19; // [rsp+B8h] [rbp+67h] BYREF
