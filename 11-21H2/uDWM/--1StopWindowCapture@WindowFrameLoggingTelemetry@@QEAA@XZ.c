/*
 * XREFs of ??1StopWindowCapture@WindowFrameLoggingTelemetry@@QEAA@XZ @ 0x1800CB8EC
 * Callers:
 ...
 *     _CProjectionBorderManager::StopWindowCapture_::_1_::dtor$1 @ 0x1800CE23B (_CProjectionBorderManager--StopWindowCapture_--_1_--dtor$1.c)
 * Callees:
