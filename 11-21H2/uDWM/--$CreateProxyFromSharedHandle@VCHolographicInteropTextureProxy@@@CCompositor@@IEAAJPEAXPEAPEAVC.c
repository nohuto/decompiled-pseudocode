/*
 * XREFs of ??$CreateProxyFromSharedHandle@VCHolographicInteropTextureProxy@@@CCompositor@@IEAAJPEAXPEAPEAVCHolographicInteropTextureProxy@@@Z @ 0x1800A9598
 * Callers:
  ...
  *a3 = 0LL;
  ...
  if ( v6 )
  {
    ...
    *(_QWORD *)v6 = &CTransform3dGroupProxy::`vftable';
    ...
    v8 = CResourceProxy::InitializeFromSharedHandle(v6, 0x10u, *(_QWORD *)(a1 + 16), a2);
    v9 = v8;
    if ( v8 >= 0 )
    {
      *a3 = v7;
