/*
 * XREFs of ?UpdateLayout@CCanvasVisual@@UEAAJ_N@Z @ 0x1800201D0
 * Callers:
...
__int64 __fastcall CCanvasVisual::UpdateLayout(CCanvasVisual *this)
{
  ...
  struct tagSIZE v13; // [rsp+60h] [rbp+18h] BYREF
  ...
  if ( v3
    && CVisual::DoCanvasLayout(
         ...
         &v13) )
  {
    v4 = (*(__int64 (__fastcall **)(CCanvasVisual *, struct tagSIZE *))(*(_QWORD *)this + 96LL))(this, &v13);
    v2 = v4;
    if ( v4 < 0 )
    {
      MilInstrumentationCheckHR_MaybeFailFast(0x14u, 0LL, 0LL, v4, 0x116u);
LABEL_18:
      MilInstrumentationCheckHR_MaybeFailFast(0x14u, 0LL, 0LL, v2, 0x53u);
      MilInstrumentationCheckHR_MaybeFailFast(0x14u, 0LL, 0LL, v2, 0x3Bu);
