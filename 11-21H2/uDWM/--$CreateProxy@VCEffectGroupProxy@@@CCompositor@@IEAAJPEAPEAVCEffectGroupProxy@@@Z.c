/*
 * XREFs of ??$CreateProxy@VCEffectGroupProxy@@@CCompositor@@IEAAJPEAPEAVCEffectGroupProxy@@@Z @ 0x180026110
 * Callers:
...
LABEL_16:
    MilInstrumentationCheckHR_MaybeFailFast(0x14u, 0LL, 0LL, v11, 0x10u);
    MilInstrumentationCheckHR_MaybeFailFast(0x14u, 0LL, 0LL, v9, 0x63u);
    goto LABEL_7;
  }
  *(_DWORD *)(v7 + 8) = 1;
  ...
  *(_QWORD *)(v7 + 16) = 0LL;
  *(_QWORD *)(v7 + 16) = v6;
  v9 = (*(__int64 (__fastcall **)(__int64, __int64, __int64))(*(_QWORD *)v6 + 96LL))(v6, 11LL, v7 + 24);
  if ( v9 < 0 )
  {
    v12 = 68;
LABEL_11:
