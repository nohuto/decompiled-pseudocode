/*
 * XREFs of ?AddProjectedShadowCaster@CTopLevelWindow@@QEAAJPEAVCProjectedShadowScene@@PEAX1@Z @ 0x1800E41C4
 * Callers:
...
__int64 __fastcall CTopLevelWindow::AddProjectedShadowCaster(
        ...
        CProjectedShadowScene::CProjectedShadowSceneInstance **a2,
        void *a3,
        void *a4)
{
  int v4; // eax
  ...
  if ( a3 )
  {
    ...
    v5 = v4;
    if ( v4 < 0 )
      MilInstrumentationCheckHR_MaybeFailFast(0x14u, 0LL, 0LL, v4, 0x130Cu);
  }
  else
  {
    ...
    v5 = v6;
    if ( v6 < 0 )
      MilInstrumentationCheckHR_MaybeFailFast(0x14u, 0LL, 0LL, v6, 0x1310u);
  }
  return v5;
}
