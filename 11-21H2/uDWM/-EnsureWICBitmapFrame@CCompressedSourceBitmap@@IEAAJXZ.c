/*
 * XREFs of ?EnsureWICBitmapFrame@CCompressedSourceBitmap@@IEAAJXZ @ 0x18005A4A4
 * Callers:
...
LABEL_21:
  ...
  {
    v1 = -2147024890;
    MilInstrumentationCheckHR_MaybeFailFast(0x14u, 0LL, 0LL, -2147024890, 0x108u);
    goto LABEL_9;
  }
  ...
  {
    v1 = -2147024890;
    MilInstrumentationCheckHR_MaybeFailFast(0x14u, 0LL, 0LL, -2147024890, 0x113u);
    goto LABEL_9;
  }
