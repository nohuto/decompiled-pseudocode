/*
 * XREFs of __tailMerge_ext_ms_win_ntuser_private_l1_1_1_dll @ 0x180061638
 * Callers:
 *     __imp_load_GetWindowBand @ 0x18006162C (__imp_load_GetWindowBand.c)
 *     __imp_load_CreateWindowInBand @ 0x1800616B7 (__imp_load_CreateWindowInBand.c)
 * Callees:
