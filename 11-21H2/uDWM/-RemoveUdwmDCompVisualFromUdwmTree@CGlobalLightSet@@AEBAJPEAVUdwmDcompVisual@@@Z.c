/*
 * XREFs of ?RemoveUdwmDCompVisualFromUdwmTree@CGlobalLightSet@@AEBAJPEAVUdwmDcompVisual@@@Z @ 0x1800BD634
 * Callers:
...
LABEL_14:
  ...
  while ( 1 )
  {
    ...
    Microsoft::WRL::ComPtr<CVisualSurfaceProxy>::InternalRelease(&v17);
    if ( --v7 < 0 )
    {
      v3 = a2[2];
      goto LABEL_14;
