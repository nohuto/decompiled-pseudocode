/*
 * XREFs of ?Initialize@CCubicBezierInterpolator@@IEAAJNPEANI@Z @ 0x1800AE7FC
 * Callers:
...
LABEL_11:
  ...
  *((_QWORD *)this + 3) = v13;
  ...
  v14 = (_DWORD *)(*(__int64 (__fastcall **)(WPF::HeapBase *, __int64))(*(_QWORD *)WPF::g_pProcessHeap + 8LL))(
                    WPF::g_pProcessHeap,
                    800LL);
  *((_QWORD *)this + 8) = v14;
  if ( !v14 )
