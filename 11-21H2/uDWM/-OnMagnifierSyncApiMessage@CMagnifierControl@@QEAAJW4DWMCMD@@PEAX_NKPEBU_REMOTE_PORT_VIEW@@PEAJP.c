/*
 * XREFs of ?OnMagnifierSyncApiMessage@CMagnifierControl@@QEAAJW4DWMCMD@@PEAX_NKPEBU_REMOTE_PORT_VIEW@@PEAJPEAI@Z @ 0x1800C7568
 * Callers:
  ...
  if ( a2 == 1073741928 && a4 )
  {
    *a8 = 40;
    ...
    if ( v12 < 0 )
    {
      ...
      if ( v12 != -2147023728 )
      {
        MilInstrumentationCheckHR_MaybeFailFast(0x14u, &dword_180122BC0, 1LL, v12, 0x1D5u);
        goto LABEL_11;
      }
      v12 = 0;
    }
