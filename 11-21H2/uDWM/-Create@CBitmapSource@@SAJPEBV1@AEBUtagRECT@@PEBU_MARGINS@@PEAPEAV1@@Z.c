/*
 * XREFs of ?Create@CBitmapSource@@SAJPEBV1@AEBUtagRECT@@PEBU_MARGINS@@PEAPEAV1@@Z @ 0x180050B4C
 * Callers:
        ...
        struct CBitmapSource **a4)
{
  ...
  if ( v9 )
  {
    ...
    *(_DWORD *)(v9 + 92) = 0x80000000;
    wil::com_ptr_t<CBitmapSourceProxy,wil::err_returncode_policy>::operator=((CBaseObject **)(v9 + 16), a1[2]);
    v11 = 0;
