/*
 * XREFs of ?_AddProjectionBorderForAllDisplays@CProjectionBorderManager@@AEAAJAEBUDWM_CAPTURE_TOKEN@@@Z @ 0x1800CED78
 * Callers:
        ...
        const struct DWM_CAPTURE_TOKEN *a2)
{
  ...
  v4 = *((_QWORD *)CDesktopManager::s_pDesktopManagerInstance + 17);
  if ( v4 )
  {
    *(_OWORD *)v11 = 0LL;
    v12 = 0;
