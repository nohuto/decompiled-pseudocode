/*
 * XREFs of ?CreateNullAnimationComponentWithWindow@CTransitionVisualController@@QEAAJPEAVCWindowData@@HPEAVCStoryboard@@_NPEAPEAVCAnimationComponent@@@Z @ 0x1800EC5BC
 * Callers:
        ...
        struct CAnimationComponent **a6)
{
  ...
  v11 = 4095;
  if ( a2 )
    v11 = *((_DWORD *)a2 + 168) & 0x400000 | 0xFFF;
