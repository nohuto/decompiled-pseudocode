/*
 * XREFs of ?_AddBorderInstructions@CProjectionBorderVisual@@IEAAJAEBUtagRECT@@IAEBU_D3DCOLORVALUE@@@Z @ 0x1800D09A4
 * Callers:
...
LABEL_13:
    ...
    else
    {
      ...
      v24 = right;
      v25 = bottom;
      v17 = (double)a3 * *((double *)CDesktopManager::s_pDesktopManagerInstance + 51);
      v26 = left;
      v32 = right;
      v23 = bottom - (int)v17;
      v29 = v23;
