/*
 * XREFs of ?ValidateVisual@CDesktopThumbnailCVIVisual@@UEAAJXZ @ 0x1800B32B0
 * Callers:
 *     <none>
 * Callees:
...
LABEL_3:
  ...
  {
    if ( *((_BYTE *)this + 345) || (v5 = 1, (*((_DWORD *)this + 87) & 0x100000) != 0) )
      v5 = 0;
    if ( this[36] )
    {
      if ( this[37] )
      {
        ...
        {
          v7 = *((_DWORD *)this + 32);
          v31.m128i_i64[1] = __PAIR64__(*((_DWORD *)this + 33), v7);
          v31.m128i_i64[0] = 0LL;
          *(__m128i *)v27 = v31;
          if ( v5 )
          {
            *(float *)&v8 = 0.0;
            ...
            HIDWORD(v28) = -*((_DWORD *)this + 31);
            if ( *((_DWORD *)v6 + 56) - *((_DWORD *)v6 + 54) >= 0 )
              v8 = *((_DWORD *)v6 + 56) - *((_DWORD *)v6 + 54);
            v9 = *((_DWORD *)v6 + 57) - *((_DWORD *)v6 + 55);
            v29 = *(float *)&v8;
            v10 = 0.0;
            if ( v9 >= 0 )
              v10 = *(float *)&v9;
...
LABEL_22:
            v23 = *((_DWORD *)this + 83) - v31.m128i_i32[1];
            v24 = this[37];
            ...
            *((float *)&v28 + 1) = (double)v23 + (double)v27[1] / v22;
            ...
            RectangleGeometry = ResourceHelper::CreateRectangleGeometry(v27[0], v27[1], v27[2], v27[3], this + 36);
            if ( RectangleGeometry < 0 )
            {
              v3 = 467LL;
              goto LABEL_3;
