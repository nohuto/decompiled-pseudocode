/*
 * XREFs of ?_UpdateTransitionGradient@CAccent@@IEAAXXZ @ 0x180098D74
 * Callers:
...
void __fastcall CAccent::_UpdateTransitionGradient(CAccent *this)
{
  ...
  v1 = (CRenderDataVisual *)*((_QWORD *)this + 42);
  v2 = 0;
  if ( v1 )
  {
    v4 = 0;
    v5 = *((_DWORD *)this + 159) - *((_DWORD *)this + 157);
    v6 = *((_DWORD *)this + 158) - *((_DWORD *)this + 156);
    v8.m128i_i64[0] = 0LL;
    if ( v6 >= 0 )
      v4 = v6;
    if ( v5 >= 0 )
    ...
    *(float *)&v8.m128i_i32[3] = (float)v2 + 0.0;
    CAccent::_UpdateSolidFill(this, v1, v7, &v8, *((float *)this + 100));
  }
}
