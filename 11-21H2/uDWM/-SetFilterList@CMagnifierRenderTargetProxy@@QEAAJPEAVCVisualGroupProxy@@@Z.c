/*
 * XREFs of ?SetFilterList@CMagnifierRenderTargetProxy@@QEAAJPEAVCVisualGroupProxy@@@Z @ 0x1800C862C
 * Callers:
        ...
        struct CVisualGroupProxy *a2)
{
  ...
  return (*(__int64 (__fastcall **)(_QWORD, _QWORD, _QWORD))(**(_QWORD **)(*((_QWORD *)this + 2) + 16LL) + 680LL))(
