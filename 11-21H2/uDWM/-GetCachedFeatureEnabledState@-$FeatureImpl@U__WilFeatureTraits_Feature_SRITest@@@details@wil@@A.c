/*
 * XREFs of ?GetCachedFeatureEnabledState@?$FeatureImpl@U__WilFeatureTraits_Feature_SRITest@@@details@wil@@AEAA?ATwil_details_FeatureStateCache@@XZ @ 0x180053E58
 * Callers:
...
signed __int32 *__fastcall wil::details::FeatureImpl<__WilFeatureTraits_Feature_SRITest>::GetCachedFeatureEnabledState(
        ...
        signed __int32 *a2)
{
  ...
  *a2 = *a1;
  if ( (v4 & 3) != 3 )
  {
    ...
    wil::details::FeatureImpl<__WilFeatureTraits_Feature_SRITest>::GetCurrentFeatureEnabledState(a1, &v14, &v13);
    v7 = *a2;
    do
    {
      v8 = v7;
