/*
 * XREFs of ?GetCachedVariantState@?$FeatureImpl@U__WilFeatureTraits_Feature_MSARTest@@@details@wil@@AEAA?ATwil_details_FeatureStateCache@@XZ @ 0x180007280
 * Callers:
...
__int64 __fastcall wil::details::FeatureImpl<__WilFeatureTraits_Feature_MSARTest>::GetCachedVariantState(
        ...
        __int64 a2)
{
  ...
  *(_QWORD *)a2 = *a1;
  if ( (v4 & 6) != 6 )
  {
    ...
    wil::details::FeatureImpl<__WilFeatureTraits_Feature_MSARTest>::GetCurrentVariantState(a1, &v16, &v15);
    v6 = *(_QWORD *)a2;
    do
    {
      *(_QWORD *)a2 = v6;
