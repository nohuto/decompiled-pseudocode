/*
 * XREFs of ?RecloneWindow@CDesktopThumbnailBase@@QEAAXPEAVCWindowData@@@Z @ 0x1800B2DC0
 * Callers:
...
void __fastcall CDesktopThumbnailBase::RecloneWindow(CDesktopThumbnailBase *this, struct CWindowData *a2)
{
  ...
  if ( v3 )
  {
    ...
    if ( Index >= 0 )
    {
      ...
      v10 = CTopLevelWindow::CloneVisualTreeForLivePreview(*((CTopLevelWindow **)a2 + 55), 0, v8, v9, &v15);
      if ( v10 >= 0 )
      {
        v12 = v7;
        v13 = v15;
        ...
        VisualCollection::InsertRelative(
          ...
          v15,
          *(struct CVisual **)(*((_QWORD *)this + 31) + 8 * v12 + 8),
          0,
          1);
