/*
 * XREFs of ?GetStillZoneFromOffset@MagnifierExperienceHelper@@AEBA?AUtagRECT@@AEBUtagPOINT@@0@Z @ 0x1800C7F90
 * Callers:
 ...
 *     ?IsEmptyRegionOnVirtualDesktop@MagnifierExperienceHelper@@AEBA_NUtagPOINT@@@Z @ 0x1800C8304 (-IsEmptyRegionOnVirtualDesktop@MagnifierExperienceHelper@@AEBA_NUtagPOINT@@@Z.c)
 */
        ...
        const struct tagPOINT *a4)
{
  ...
  *retstr = 0LL;
  ...
  retstr->right = (int)o_ceilf_0(v17 + v21 - (((double)right - (v17 + v21)) / *(double *)&lprc[1].left * v22 - v27));
  retstr->bottom = (int)o_ceilf_0(v16 + v24 - (((double)bottom - (v16 + v24)) / *(double *)&lprc[1].right * v20 - v23));
  return retstr;
}
