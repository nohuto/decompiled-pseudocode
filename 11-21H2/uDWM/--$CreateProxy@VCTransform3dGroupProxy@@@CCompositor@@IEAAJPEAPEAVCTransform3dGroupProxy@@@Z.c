/*
 * XREFs of ??$CreateProxy@VCTransform3dGroupProxy@@@CCompositor@@IEAAJPEAPEAVCTransform3dGroupProxy@@@Z @ 0x1800A8E90
 * Callers:
  ...
  *a2 = 0LL;
  ...
  if ( v4 )
  {
    ...
    *(_QWORD *)v4 = &CTransform3dGroupProxy::`vftable';
    ...
    v6 = CResource::Create(0x24u, *(_QWORD *)(a1 + 16), (CBaseObject **)(v4 + 16));
    v7 = v6;
    if ( v6 >= 0 )
    {
      *a2 = v5;
