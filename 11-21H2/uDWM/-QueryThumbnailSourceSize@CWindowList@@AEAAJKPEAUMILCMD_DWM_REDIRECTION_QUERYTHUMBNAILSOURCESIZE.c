/*
 * XREFs of ?QueryThumbnailSourceSize@CWindowList@@AEAAJKPEAUMILCMD_DWM_REDIRECTION_QUERYTHUMBNAILSOURCESIZE@@@Z @ 0x18006ADA6
 * Callers:
        ...
        struct MILCMD_DWM_REDIRECTION_QUERYTHUMBNAILSOURCESIZE *a3)
{
  ...
  if ( *((_BYTE *)ThumbnailData + 34) && *((_DWORD *)ThumbnailData + 28) == 2 )
  {
    v9 = (*(__int64 (__fastcall **)(struct CThumbnailData *))(*(_QWORD *)ThumbnailData + 8LL))(ThumbnailData);
    v10 = v9;
    if ( v9 < 0 )
    {
      MilInstrumentationCheckHR_MaybeFailFast(0x14u, 0LL, 0LL, v9, 0x132Eu);
      goto LABEL_23;
    }
    v11 = _mm_srli_si128(*(__m128i *)(*((_QWORD *)v7 + 13) + 328LL), 8).m128i_u64[0];
    v12 = *(_QWORD *)(*((_QWORD *)v7 + 13) + 328LL);
    v13 = 0;
  ...
  else
  {
    ...
    if ( v14 < 0 )
    {
      MilInstrumentationCheckHR_MaybeFailFast(0x14u, 0LL, 0LL, v14, 0x1337u);
      goto LABEL_23;
    }
    ...
    if ( v15 < 0 )
    {
      MilInstrumentationCheckHR_MaybeFailFast(0x14u, 0LL, 0LL, v15, 0x1338u);
      goto LABEL_23;
    }
    v13 = 0;
