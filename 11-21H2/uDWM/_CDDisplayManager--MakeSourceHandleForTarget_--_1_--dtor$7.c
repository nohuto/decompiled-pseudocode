/*
 * XREFs of _CDDisplayManager::MakeSourceHandleForTarget_::_1_::dtor$7 @ 0x1800AF602
 * Callers:
 *     <none>
 * Callees:
 *     <none>
...
__int64 __fastcall CDDisplayManager::MakeSourceHandleForTarget_::_1_::dtor_7(__int64 a1, __int64 a2)
{
