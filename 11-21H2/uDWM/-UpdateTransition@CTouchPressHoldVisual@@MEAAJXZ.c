/*
 * XREFs of ?UpdateTransition@CTouchPressHoldVisual@@MEAAJXZ @ 0x1800E8E70
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall CTouchPressHoldVisual::UpdateTransition(CTouchPressHoldVisual *this)
{
  ...
  v1 = *((_QWORD *)this + 43);
  if ( v1 && (*((float *)this + 84) = *(double *)(v1 + 48), *(_BYTE *)(v1 + 72)) )
  {
    v3 = (*(_DWORD *)(v1 + 8))-- == 1;
  ...
  if ( v5 )
  {
    *((_DWORD *)this + 83) = (int)(float)*(double *)(v5 + 48);
    if ( *(_BYTE *)(v5 + 72) )
    {
      v3 = (*(_DWORD *)(v5 + 8))-- == 1;
      v6 = v4;
  ...
  {
    v8 = *(double *)(v7 + 48);
    v9 = (float)*((int *)this + 80) * v8;
    *((_DWORD *)this + 81) = (int)(float)((float)*((int *)this + 79) * v8);
    *((_DWORD *)this + 82) = (int)v9;
    if ( *(_BYTE *)(v7 + 72) )
    {
      v3 = (*(_DWORD *)(v7 + 8))-- == 1;
      v10 = v4;
...
LABEL_22:
  ...
  if ( !*((_QWORD *)this + 43) && !*((_QWORD *)this + 44) && !*((_QWORD *)this + 45) && !*((_QWORD *)this + 46) )
  {
