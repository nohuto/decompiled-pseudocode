/*
 * XREFs of ?get_local_iids@?$implements@UTransitionState@implementation@Transitions@Udwm@winrt@@U1345@UITransitionStateNative@34@UITransitionStateNativePrivate@34@@winrt@@UEBA?AU?$pair@IPEBUguid@winrt@@@std@@XZ @ 0x18004A100
 * Callers:
 *     <none>
 * Callees:
 *     <none>
