/*
 * XREFs of ?GetCurrentOpacity@CLivePreviewTimeline@@QEAANXZ @ 0x1800C5880
 * Callers:
...
double __fastcall CLivePreviewTimeline::GetCurrentOpacity(CLivePreviewTimeline *this)
{
  ...
  else
  {
    ...
    {
      if ( v3 == 1 )
        return (1.0 - *((double *)this + 15)) * *((double *)this + 6) + *((double *)this + 15);
    }
    else
    {
      return (1.0 - *((double *)this + 6)) * *((double *)this + 15);
    }
  }
  return result;
}
