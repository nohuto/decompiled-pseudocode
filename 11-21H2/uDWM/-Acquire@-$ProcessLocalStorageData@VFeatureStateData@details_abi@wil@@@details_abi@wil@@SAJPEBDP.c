/*
 * XREFs of ?Acquire@?$ProcessLocalStorageData@VFeatureStateData@details_abi@wil@@@details_abi@wil@@SAJPEBDPEAPEAV123@@Z @ 0x18005B498
 * Callers:
        ...
        void **a2)
{
  ...
  wil::details *v18[2]; // [rsp+40h] [rbp-C0h] BYREF
  ...
  *a2 = 0LL;
  ...
  _acquire___mutex_t_V__unique_storage_U__resource_policy_PEAXP6AXPEAX__E_1_CloseHandle_details_wil__YAX0_ZU__integral_constant__K_0A__wistd__PEAXPEAX_0A___T_details_wil___details_wil__Uerr_returncode_policy_3__wil__QEBA_AV__unique_any_t_V__unique_storage_U__resource_policy_PEAXP6AXPEAX__E_1_ReleaseMutex_details_wil__YAX0_ZU__integral_constant__K_01_wistd__PEAXPEAX_0A___T_details_wil___details_wil___2_PEAKKH_Z(
    ...
    v18);
  v17 = 0LL;
  Pointer = wil::details_abi::SemaphoreValue::TryGetPointer(Name, &v17, v7, v8);
  ...
  if ( !v17 )
  {
    ...
    v15 = 302LL;
LABEL_12:
    wil::details::in1diag3::Return_Hr(retaddr, (void *)v15, (int)"wil", (const char *)(unsigned int)Pointer);
    goto LABEL_6;
  }
  *a2 = v17;
  *(_DWORD *)*a2 = *v12 + 1;
