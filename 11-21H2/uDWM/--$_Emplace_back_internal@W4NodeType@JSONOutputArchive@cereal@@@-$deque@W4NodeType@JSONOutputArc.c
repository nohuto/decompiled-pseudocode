/*
 * XREFs of ??$_Emplace_back_internal@W4NodeType@JSONOutputArchive@cereal@@@?$deque@W4NodeType@JSONOutputArchive@cereal@@V?$allocator@W4NodeType@JSONOutputArchive@cereal@@@std@@@std@@AEAAX$$QEAW4NodeType@JSONOutputArchive@cereal@@@Z @ 0x180043A1C
 * Callers:
...
__int64 __fastcall std::deque<enum cereal::JSONOutputArchive::NodeType>::_Emplace_back_internal<enum cereal::JSONOutputArchive::NodeType>(
        _QWORD *a1,
        unsigned int *a2)
{
  __int64 v4; // rcx
