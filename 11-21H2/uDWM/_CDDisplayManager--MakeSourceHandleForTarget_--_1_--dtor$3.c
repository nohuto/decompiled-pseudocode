/*
 * XREFs of _CDDisplayManager::MakeSourceHandleForTarget_::_1_::dtor$3 @ 0x1800AF5D2
 * Callers:
 *     <none>
 * Callees:
 *     <none>
...
__int64 __fastcall CDDisplayManager::MakeSourceHandleForTarget_::_1_::dtor_3(__int64 a1, __int64 a2)
{
