/*
 * XREFs of ?OnAnimationComplete@CScreenRotation@@UEAAJI@Z @ 0x1800D2C10
 * Callers:
 *     <none>
 * Callees:
...
LABEL_20:
  ...
  *((_DWORD *)this + 19) = -1;
  ...
  McGenEventWrite_EtwEventWriteTransfer(Microsoft_Windows_Dwm_Udwm_Provider_Context, (__int64)v6, v5, 1, (__int64)v13);
LABEL_8:
  ...
  if ( *((_BYTE *)this + 49) )
  {
    ...
    v4 = v8;
    if ( v8 < 0 )
      MilInstrumentationCheckHR_MaybeFailFast(0x14u, 0LL, 0LL, v8, 0x138u);
  }
  else
  {
    ...
    v4 = v9;
    if ( v9 < 0 )
      MilInstrumentationCheckHR_MaybeFailFast(0x14u, 0LL, 0LL, v9, 0x13Cu);
  }
LABEL_22:
