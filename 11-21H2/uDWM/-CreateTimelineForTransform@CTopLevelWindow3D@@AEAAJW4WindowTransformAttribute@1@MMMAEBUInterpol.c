/*
 * XREFs of ?CreateTimelineForTransform@CTopLevelWindow3D@@AEAAJW4WindowTransformAttribute@1@MMMAEBUInterpolationParameters@@@Z @ 0x180025CE4
 * Callers:
        ...
        __int64 a6)
{
  ...
  *(_OWORD *)&v15[16] = *(_OWORD *)(a6 + 16);
  ...
  if ( v11 )
  {
    ...
    *(_OWORD *)(v11 + 80) = *(_OWORD *)&v15[8];
    *(_OWORD *)(v11 + 96) = *(_OWORD *)&v15[24];
  ...
  else
  {
    *(_QWORD *)(a1 + 8 * v6 + 392) = 0LL;
    v8 = -2147024882;
    MilInstrumentationCheckHR_MaybeFailFast(0x14u, 0LL, 0LL, -2147024882, 0x117u);
  }
  return v8;
}
