/*
 * XREFs of ?AddMultipleAndSet@?$DynArray@PEAVCWindowData@@$0A@@@QEAAJPEFBQEAVCWindowData@@I@Z @ 0x18003595C
 * Callers:
...
__int64 __fastcall DynArray<CWindowData *,0>::AddMultipleAndSet(__int64 a1, _QWORD *a2)
{
  ...
  else
  {
    ...
    {
      v8 = a2;
      v6 = DynArrayImpl<0>::Grow((char **)a1, 8u, 1, 0, (unsigned __int64 *)&v8);
      v5 = v6;
      if ( v6 < 0 )
