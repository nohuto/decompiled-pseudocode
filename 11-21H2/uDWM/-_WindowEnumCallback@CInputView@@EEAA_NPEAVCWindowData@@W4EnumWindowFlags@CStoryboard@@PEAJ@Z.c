/*
 * XREFs of ?_WindowEnumCallback@CInputView@@EEAA_NPEAVCWindowData@@W4EnumWindowFlags@CStoryboard@@PEAJ@Z @ 0x1800DEE70
 * Callers:
 *     <none>
 * Callees:
...
char __fastcall CInputView::_WindowEnumCallback(CSlide *a1, __int64 a2, char a3, int *a4)
{
  ...
  if ( (*(_DWORD *)(a2 + 672) & 0xFFF) != 2 )
  {
    if ( (*(_DWORD *)(a2 + 672) & 0xFFF) == 3 || (*(_DWORD *)(a2 + 672) & 0xFFF) == 0x19 )
    {
      ...
      if ( v10 >= 0 )
        *(_BYTE *)(*((_QWORD *)v14 + 5) + 976LL) = 1;
        ...
        MilInstrumentationCheckHR_MaybeFailFast(0x14u, &CStoryboard::MILINSTRUMENTATIONHRESULTLIST, 1LL, v10, 0x1405u);
      goto LABEL_18;
    }
    if ( (*(_DWORD *)(a2 + 672) & 0xFFF) != 0x1A )
    {
      if ( (*(_DWORD *)(a2 + 672) & 0xFFF) != 0x2B )
        goto LABEL_20;
      ...
      v4 = v9;
      if ( v9 < 0 )
        MilInstrumentationCheckHR_MaybeFailFast(0x14u, &CStoryboard::MILINSTRUMENTATIONHRESULTLIST, 1LL, v9, 0x1415u);
      goto LABEL_18;
    }
  }
  if ( !CWindowPropertyTracker::IsWindowTrackedAndCloakChanged(
  ...
  if ( v11 >= 0 )
    *(_BYTE *)(*((_QWORD *)v14 + 5) + 976LL) = 1;
    ...
    MilInstrumentationCheckHR_MaybeFailFast(0x14u, &CStoryboard::MILINSTRUMENTATIONHRESULTLIST, 1LL, v11, 0x140Eu);
LABEL_18:
  if ( v14 )
