/*
 * XREFs of ?UDwmHolographicDeviceDriverDetected_@UDwmTrace@@QEAAXXZ @ 0x18009DE78
 * Callers:
...
void __fastcall UDwmTrace::UDwmHolographicDeviceDriverDetected_(UDwmTrace *this)
{
  ...
  if ( *v1 > 4u )
  {
    if ( tlgKeywordOn((__int64)v1, 0x400000000000LL) )
    {
      ...
      v3 = 0x2000000LL;
      v6 = 8;
      tlgWriteTransfer_EtwEventWriteTransfer(v2, byte_18011E710, 0LL, 0LL, 3, (__int64)v4);
    }
  }
}
