/*
 * XREFs of ?NcAdornmentInfoQuery@CTopLevelWindow@@QEAAJPEAUNCADORNMENT_INFO@@@Z @ 0x18000339C
 * Callers:
...
LABEL_16:
  ...
  CVisual::GetLocalToParentVisualTransform((CVisual *)v4, *((struct CVisual **)this + 33), (struct D2DMatrix *)v18);
  ...
  v10 = *((_BYTE *)this + 248) & 4 | 0xA1LL;
  rcSrc2.left = *((_DWORD *)this + v10) + v9[12];
  rcSrc2.top = *((_DWORD *)this + v10 + 2) + v9[13];
  rcSrc2.right = v9[14] - *((_DWORD *)this + v10 + 1);
  rcSrc2.bottom = v9[15] - *((_DWORD *)this + v10 + 3);
