/*
 * XREFs of ?DoHitTest@UdwmTopVisual@@UEAA_NAEBUtagPOINT@@PEAPEAVCVisual@@PEAI@Z @ 0x18000CA40
 * Callers:
 *     <none>
 * Callees:
        ...
        unsigned int *a4)
{
  ...
  {
    v14 = (__int64)*a2;
    LODWORD(v14) = v14 - *(_DWORD *)(v10 + 120);
    HIDWORD(v14) -= *(_DWORD *)(v10 + 124);
    if ( (*(_BYTE *)(v10 + 92) & 2) != 0 )
    {
...
LABEL_6:
  if ( a2->x >= 0 && a2->x < *((_DWORD *)this + 32) )
  {
    y = a2->y;
    if ( y >= 0 && y < *((_DWORD *)this + 33) )
    {
      v6 = *((_DWORD *)this + 50);
      v5 = this;
    }
