/*
 * XREFs of ?_GetIdealWindowRect@CStoryboard@@KAXPEAVCWindowData@@_NPEBUtagRECT@@PEAU3@PEAPEAU3@@Z @ 0x1800DABF8
 * Callers:
        ...
        struct tagRECT **a5)
{
  ...
  v5 = 32 * (a2 ^ 1LL);
  v6 = (struct tagRECT *)((char *)a1 + v5 + 676);
  v10 = (char *)a1 + v5;
  if ( (((a2 + 1) << 23) & *((_DWORD *)a1 + 168)) != (a2 + 1) << 23 || IsRectEmpty((const RECT *)(v10 + 692)) )
  {
    if ( a3 )
      v11 = *a3;
    else
