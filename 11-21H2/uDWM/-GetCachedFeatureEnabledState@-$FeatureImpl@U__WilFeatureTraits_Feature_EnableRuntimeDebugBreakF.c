/*
 * XREFs of ?GetCachedFeatureEnabledState@?$FeatureImpl@U__WilFeatureTraits_Feature_EnableRuntimeDebugBreakForIdd@@@details@wil@@AEAA?ATwil_details_FeatureStateCache@@XZ @ 0x18005E110
 * Callers:
 ...
 *     ?GetCurrentFeatureEnabledState@?$FeatureImpl@U__WilFeatureTraits_Feature_EnableRuntimeDebugBreakForIdd@@@details@wil@@AEAA?ATwil_details_FeatureStateCache@@PEAH@Z @ 0x18005E22C (-GetCurrentFeatureEnabledState@-$FeatureImpl@U__WilFeatureTraits_Feature_EnableRuntimeDebugBreak.c)
 */

// Hidden C++ exception states: #wind=1
signed __int32 *__fastcall wil::details::FeatureImpl<__WilFeatureTraits_Feature_EnableRuntimeDebugBreakForIdd>::GetCachedFeatureEnabledState(
        ...
        signed __int32 *a2)
{
  ...
  *a2 = *a1;
  if ( (v4 & 3) != 3 )
  {
    ...
    wil::details::FeatureImpl<__WilFeatureTraits_Feature_EnableRuntimeDebugBreakForIdd>::GetCurrentFeatureEnabledState(
      a1,
      &v15,
      &v14);
    v7 = v6 != 0 ? v14 : 0;
