/*
 * XREFs of ?GetCachedFeatureEnabledState@?$FeatureImpl@U__WilFeatureTraits_Feature_XamlIslandsDisablesQuirksForShell@@@details@wil@@AEAA?ATwil_details_FeatureStateCache@@XZ @ 0x180056D98
 * Callers:
...
signed __int32 *__fastcall wil::details::FeatureImpl<__WilFeatureTraits_Feature_XamlIslandsDisablesQuirksForShell>::GetCachedFeatureEnabledState(
        ...
        signed __int32 *a2)
{
  ...
  *a2 = *a1;
  if ( (v4 & 3) != 3 )
  {
    ...
    wil::details::FeatureImpl<__WilFeatureTraits_Feature_XamlIslandsDisablesQuirksForShell>::GetCurrentFeatureEnabledState(
      a1,
      &v14,
      &v13);
    v7 = *a2;
