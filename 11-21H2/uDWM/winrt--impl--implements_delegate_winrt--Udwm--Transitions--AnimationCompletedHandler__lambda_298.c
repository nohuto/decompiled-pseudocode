/*
 * XREFs of winrt::impl::implements_delegate_winrt::Udwm::Transitions::AnimationCompletedHandler__lambda_298ff7ed3f48e3f8f0577bc4e02d17e0___::Release @ 0x1800076A0
 * Callers:
 *     <none>
 * Callees:
        ...
        __int64 a1)
{
  ...
  v2 = winrt::impl::atomic_ref_count::operator--(a1 + 16);
  if ( !v2 && a1 )
  {
