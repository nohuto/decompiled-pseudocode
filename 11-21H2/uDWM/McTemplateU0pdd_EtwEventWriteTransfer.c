/*
 * XREFs of McTemplateU0pdd_EtwEventWriteTransfer @ 0x1800A56A4
 * Callers:
...
__int64 __fastcall McTemplateU0pdd_EtwEventWriteTransfer(__int64 a1, __int64 a2, __int64 a3, int a4, char a5)
{
  ...
  v9 = &v14;
  v11 = &a5;
  return McGenEventWrite_EtwEventWriteTransfer(Microsoft_Windows_Dwm_Udwm_Provider_Context, a2, a3, 4, (__int64)v6);
}
