/*
 * XREFs of ??$CreateProxy@VCRenderDataProxy@@@CCompositor@@IEAAJPEAPEAVCRenderDataProxy@@@Z @ 0x180026880
 * Callers:
...
LABEL_16:
  ...
  *(_QWORD *)(v7 + 16) = v6;
  v9 = (*(__int64 (__fastcall **)(__int64, __int64, __int64))(*(_QWORD *)v6 + 96LL))(v6, 30LL, v7 + 24);
  if ( v9 < 0 )
  {
    v14 = 68;
LABEL_11:
