/*
 * XREFs of ?GetPillarBoxColor@CImmersiveState@@SAXPEAU_D3DCOLORVALUE@@@Z @ 0x1800BFD1C
 * Callers:
...
void __fastcall CImmersiveState::GetPillarBoxColor(struct _D3DCOLORVALUE *a1, __int64 a2, __int64 a3, __int64 a4)
{
  ...
  LOBYTE(v5) = CDesktopManager::IsHighContrastMode((__int64)a1, a2, a3, a4);
  StaticImmersiveColorPrivForHighContrastState = GetStaticImmersiveColorPrivForHighContrastState(570LL, v5);
