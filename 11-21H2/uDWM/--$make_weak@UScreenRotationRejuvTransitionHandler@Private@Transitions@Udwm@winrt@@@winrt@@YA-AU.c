/*
 * XREFs of ??$make_weak@UScreenRotationRejuvTransitionHandler@Private@Transitions@Udwm@winrt@@@winrt@@YA?AU?$weak_ref@UScreenRotationRejuvTransitionHandler@Private@Transitions@Udwm@winrt@@@0@AEBUScreenRotationRejuvTransitionHandler@Private@Transitions@Udwm@0@@Z @ 0x180063314
 * Callers:
...
_QWORD *__fastcall winrt::make_weak<winrt::Udwm::Transitions::Private::ScreenRotationRejuvTransitionHandler>(
        _QWORD *a1,
