/*
 * XREFs of ?create@shared_buffer@details@wil@@QEAA_NPEBX_K@Z @ 0x180096788
 * Callers:
 ...
 *     ?assign@shared_buffer@details@wil@@AEAAXPEAJ_K@Z @ 0x180096724 (-assign@shared_buffer@details@wil@@AEAAXPEAJ_K@Z.c)
