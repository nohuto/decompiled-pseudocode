/*
 * XREFs of ?EnableInputHooksHelper@CDesktopManager@@SAJ_N0PEBGPEAPEAUHWND__@@@Z @ 0x1800B0414
 * Callers:
...
__int64 __fastcall CDesktopManager::EnableInputHooksHelper(char a1, char a2, const unsigned __int16 *a3, HWND *a4)
{
  ...
  if ( CDesktopManager::s_pDesktopManagerInstance )
  {
    if ( a1 )
    {
      ...
      {
        v19 = *(_OWORD *)((char *)CDesktopManager::s_pDesktopManagerInstance + 372);
      ...
      if ( !WindowInBand )
      {
        ...
        v13 = -2147024890;
LABEL_11:
        MilInstrumentationCheckHR_MaybeFailFast(0x14u, &dword_1801226F0, 2LL, v13, v12);
      ...
      *a4 = WindowInBand;
      ...
      if ( !a2 )
      {
        *((_QWORD *)CDesktopManager::s_pDesktopManagerInstance + 76) = ForegroundWindow;
    ...
    else if ( *a4 )
    {
      ...
      v16 = (HWND)*((_QWORD *)CDesktopManager::s_pDesktopManagerInstance + 76);
      if ( v16 )
      {
        if ( IsWindow(v16) )
          CDesktopManager::SetForegroundWindowAsync(
            *a4,
            *((HWND *)CDesktopManager::s_pDesktopManagerInstance + 76),
            v17);
        *((_QWORD *)CDesktopManager::s_pDesktopManagerInstance + 76) = 0LL;
      }
