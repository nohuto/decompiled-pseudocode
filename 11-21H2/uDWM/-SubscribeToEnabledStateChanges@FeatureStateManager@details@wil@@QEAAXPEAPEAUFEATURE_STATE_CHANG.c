/*
 * XREFs of ?SubscribeToEnabledStateChanges@FeatureStateManager@details@wil@@QEAAXPEAPEAUFEATURE_STATE_CHANGE_SUBSCRIPTION__@@P6AXPEAX@Z1@Z @ 0x18005BF6C
 * Callers:
        ...
        void *a4)
{
  ...
  *a2 = 0LL;
  if ( LOBYTE(this->Ptr) )
  {
    wil::AcquireSRWLockExclusive(&v11, this + 4);
    p_Ptr = &this[28].Ptr;
    if ( this[28].Ptr )
    {
      v10 = 0;
    ...
    {
      *p_Ptr = 0LL;
      v10 = wil_details_RtlRegisterFeatureConfigurationChangeNotification(
