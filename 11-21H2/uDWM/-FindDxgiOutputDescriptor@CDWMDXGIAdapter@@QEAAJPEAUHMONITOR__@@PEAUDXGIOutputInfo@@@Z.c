/*
 * XREFs of ?FindDxgiOutputDescriptor@CDWMDXGIAdapter@@QEAAJPEAUHMONITOR__@@PEAUDXGIOutputInfo@@@Z @ 0x1800BBF30
 * Callers:
        ...
        struct DXGIOutputInfo *a3)
{
  ...
  {
    v6 = *((_QWORD *)this + 44);
    while ( *(HMONITOR *)(304LL * v4 + v6 + 104) != a2 )
    {
      if ( ++v4 >= v3 )
        return v5;
    }
    v7 = 2LL;
    v8 = (_OWORD *)(v6 + 304LL * v4);
    do
    {
      *(_OWORD *)a3 = *v8;
      *((_OWORD *)a3 + 1) = v8[1];
