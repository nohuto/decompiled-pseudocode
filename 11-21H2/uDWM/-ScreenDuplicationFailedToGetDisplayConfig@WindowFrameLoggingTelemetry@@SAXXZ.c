/*
 * XREFs of ?ScreenDuplicationFailedToGetDisplayConfig@WindowFrameLoggingTelemetry@@SAXXZ @ 0x1800CC408
 * Callers:
...
void __fastcall WindowFrameLoggingTelemetry::ScreenDuplicationFailedToGetDisplayConfig(__int64 a1)
{
  ...
  if ( *v1 > 5u )
  {
    if ( tlgKeywordOn((__int64)v1, 0x200000000000LL) )
      tlgWriteTransfer_EtwEventWriteTransfer(v2, byte_1801208C5, 0LL, 0LL, 2, (__int64)v3);
  }
}
