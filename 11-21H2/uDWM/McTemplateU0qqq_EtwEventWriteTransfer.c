/*
 * XREFs of McTemplateU0qqq_EtwEventWriteTransfer @ 0x1800B1AD4
 * Callers:
...
__int64 __fastcall McTemplateU0qqq_EtwEventWriteTransfer(_QWORD *a1, __int64 a2, __int64 a3, int a4, char a5)
{
  ...
  v10 = 4LL;
  v12 = 4LL;
  return McGenEventWrite_EtwEventWriteTransfer(a1, (__int64)&UdwmProcessModeChange_Info, a3, 4, (__int64)v6);
}
