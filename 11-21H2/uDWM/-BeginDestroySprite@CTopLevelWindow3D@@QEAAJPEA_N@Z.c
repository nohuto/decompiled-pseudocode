/*
 * XREFs of ?BeginDestroySprite@CTopLevelWindow3D@@QEAAJPEA_N@Z @ 0x180038038
 * Callers:
...
__int64 __fastcall CTopLevelWindow3D::BeginDestroySprite(CTopLevelWindow3D *this, bool *a2)
{
  ...
  if ( CTopLevelWindow3D::ShouldDelayTransition(this, 0) )
  {
    ...
    if ( started < 0 )
    {
      MilInstrumentationCheckHR_MaybeFailFast(0x14u, 0LL, 0LL, started, 0x1F4u);
      goto LABEL_3;
    }
    goto LABEL_8;
  }
    ...
    && !CTopLevelWindow3D::IsWindowInSystemArrangementAnimation(this) )
  {
    if ( !*((_QWORD *)this + 46) || *((_DWORD *)this + 96) != 3 )
    {
      ...
      if ( v7 < 0 )
      {
        MilInstrumentationCheckHR_MaybeFailFast(0x14u, 0LL, 0LL, v7, 0x1FFu);
        goto LABEL_3;
      }
    }
LABEL_8:
