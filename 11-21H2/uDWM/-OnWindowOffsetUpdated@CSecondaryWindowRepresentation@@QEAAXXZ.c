/*
 * XREFs of ?OnWindowOffsetUpdated@CSecondaryWindowRepresentation@@QEAAXXZ @ 0x180046C64
 * Callers:
 ...
 *     ?GetOffsetToOwner@CWindowData@@QEAA?AUtagPOINT@@XZ @ 0x180046D08 (-GetOffsetToOwner@CWindowData@@QEAA-AUtagPOINT@@XZ.c)
 */
