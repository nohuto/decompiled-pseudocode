/*
 * XREFs of ?NotifyFailure@?$ActivityBase@VWindowFrameLogging@@$00$0CAAAAAAAAAAA@$04$0A@U_TlgReflectorTag_Param0IsProviderType@@@wil@@UEAA_NAEBUFailureInfo@2@@Z @ 0x1800CBFA0
 * Callers:
 *     <none>
 * Callees:
        ...
        int *a2)
{
  ...
  if ( (*(unsigned __int8 (__fastcall **)(_QWORD *, _QWORD))(*a1 + 16LL))(a1, (unsigned int)a2[4]) )
  {
    ...
    if ( *v9 > 2u && tlgKeywordOn((__int64)v9, 0x200000000000LL) )
    {
      v26 = *((_QWORD *)a2 + 6);
      LODWORD(v30) = a2[17];
      v31 = a2[4];
      v25 = (wchar_t *)*((_QWORD *)a2 + 15);
      v12 = a1[6];
      v24 = (const unsigned __int16 *)*((_QWORD *)a2 + 14);
      v32 = a2[26];
      v23 = (wchar_t *)*((_QWORD *)a2 + 12);
  ...
  wil::ActivityBase<WindowFrameLogging,1,0,5,0,_TlgReflectorTag_Param0IsProviderType>::LockExclusive((__int64)a1, &v30);
  v13 = (_DWORD *)a1[6];
  v14 = a2[2];
  if ( v14 != v13[22] && (v14 != v13[19] || (int)v13[19] >= 0) )
