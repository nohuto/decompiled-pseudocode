/*
 * XREFs of ?LoadTheme@CDesktopManager@@AEAAJXZ @ 0x18004F63C
 * Callers:
 ...
 *     ?ReportUsage@?$FeatureImpl@U__WilFeatureTraits_Feature_AUTest@@@details@wil@@QEAAX_NW4ReportingKind@3@_K@Z @ 0x1800B1498 (-ReportUsage@-$FeatureImpl@U__WilFeatureTraits_Feature_AUTest@@@details@wil@@QEAAX_NW4ReportingK.c)
 */
...
LABEL_29:
  ...
  *((_BYTE *)this + 25) = v13;
  ...
  {
    ThemeInt = GetThemeInt(*((HTHEME *)this + 67), 0, 0, 2431, (int *)this + 106);
    v9 = ThemeInt;
    if ( ThemeInt < 0 )
    {
      v21 = ThemeInt;
    ...
    CurrentThemeName = GetThemeInt(*((HTHEME *)this + 67), 46, 1, 2431, (int *)this + 107);
    v9 = CurrentThemeName;
    if ( CurrentThemeName < 0 )
    {
      pszSizeBuff = 663;
    ...
    {
      CurrentThemeName = GetThemeInt(*((HTHEME *)this + 67), 46, 3, 2431, (int *)this + 108);
      v9 = CurrentThemeName;
      if ( CurrentThemeName >= 0 )
      {
  ...
  MilInstrumentationCheckHR_MaybeFailFast(0x14u, 0LL, 0LL, BitmapsFromAtlasImageStrip, 0x33Au);
  pszSizeBuff = 659;
LABEL_33:
  v21 = v9;
LABEL_37:
  MilInstrumentationCheckHR_MaybeFailFast(0x14u, &dword_18011A2C8, 1LL, v21, pszSizeBuff);
LABEL_20:
  if ( (Microsoft_Windows_Dwm_UdwmEnableBits & 1) != 0 )
    McGenEventWrite_EtwEventWriteTransfer(
      Microsoft_Windows_Dwm_Udwm_Provider_Context,
  ...
  if ( v9 < 0 )
  {
    ...
    {
      v9 = -2003302654;
      MilInstrumentationCheckHR_MaybeFailFast(0x14u, &dword_18011A2C8, 1LL, -2003302654, 0x2A7u);
    }
  }
