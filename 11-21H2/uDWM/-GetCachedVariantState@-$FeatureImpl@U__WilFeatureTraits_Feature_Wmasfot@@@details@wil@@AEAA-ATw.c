/*
 * XREFs of ?GetCachedVariantState@?$FeatureImpl@U__WilFeatureTraits_Feature_Wmasfot@@@details@wil@@AEAA?ATwil_details_FeatureStateCache@@XZ @ 0x180103864
 * Callers:
...
__int64 __fastcall wil::details::FeatureImpl<__WilFeatureTraits_Feature_Wmasfot>::GetCachedVariantState(
        ...
        __int64 a2)
{
  ...
  RTL_SRWLOCK *v18; // [rsp+60h] [rbp+18h] BYREF
  ...
  *(_QWORD *)a2 = *a1;
  if ( (v4 & 6) != 6 )
  {
    ...
    wil::details::FeatureImpl<__WilFeatureTraits_Feature_Wmasfot>::GetCurrentVariantState(a1, &v16, &v15);
    v6 = *(_QWORD *)a2;
    do
    {
      *(_QWORD *)a2 = v6;
    ...
    {
      wil::AcquireSRWLockExclusive(&v18, (RTL_SRWLOCK *)&qword_180142E70);
      if ( !v5
        || v5 != dword_180142E84
        || (v13 = 3, v14 = a1, !wil::details_abi::heap_buffer::push_back((void **)&xmmword_180142EB8, &v13, 0x10uLL)) )
      {
