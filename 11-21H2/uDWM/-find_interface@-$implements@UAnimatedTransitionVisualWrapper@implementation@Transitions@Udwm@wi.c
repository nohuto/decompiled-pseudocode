/*
 * XREFs of ?find_interface@?$implements@UAnimatedTransitionVisualWrapper@implementation@Transitions@Udwm@winrt@@U1345@UITransitionAnimationVisualNative@34@@winrt@@UEBAPEAXAEBUguid@2@@Z @ 0x180009900
 * Callers:
 *     <none>
 * Callees:
 *     <none>
