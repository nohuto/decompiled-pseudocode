        ...
        __int64 a3)
{
  ...
  winrt::Windows::Foundation::IUnknown *v16; // rbx
  ...
  if ( !a1 )
    v13 = 48LL;
  v16 = (winrt::Windows::Foundation::IUnknown *)(*(_QWORD *)v13 + 8 * v3);
  if ( v8 )
  {
    while ( 1 )
    {
      winrt::Windows::Foundation::IUnknown::operator=(v10, v16);
