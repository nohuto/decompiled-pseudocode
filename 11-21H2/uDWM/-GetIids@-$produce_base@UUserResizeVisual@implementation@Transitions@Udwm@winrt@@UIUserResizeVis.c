/*
 * XREFs of ?GetIids@?$produce_base@UUserResizeVisual@implementation@Transitions@Udwm@winrt@@UIUserResizeVisual@345@X@impl@winrt@@UEAAHPEAIPEAPEAUguid@3@@Z @ 0x1800F0D70
 * Callers:
 *     <none>
 * Callees:
 *     <none>
