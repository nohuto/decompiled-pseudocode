/*
 * XREFs of ??$_Emplace_reallocate@PEAUIAnimatedVisual@@@?$vector@PEAUIAnimatedVisual@@V?$allocator@PEAUIAnimatedVisual@@@std@@@std@@QEAAPEAPEAUIAnimatedVisual@@QEAPEAU2@$$QEAPEAU2@@Z @ 0x180099698
 * Callers:
 ...
 *     ?_Change_array@?$vector@PEAUIAnimatedVisual@@V?$allocator@PEAUIAnimatedVisual@@@std@@@std@@AEAAXQEAPEAUIAnimatedVisual@@_K1@Z @ 0x18009BB08 (-_Change_array@-$vector@PEAUIAnimatedVisual@@V-$allocator@PEAUIAnimatedVisual@@@std@@@std@@AEAAX.c)
 *     ?_Dwm_Xlength_error@std@@YAXPEBD@Z @ 0x180107A14 (-_Dwm_Xlength_error@std@@YAXPEBD@Z.c)
 */

char *__fastcall std::vector<IAnimatedVisual *>::_Emplace_reallocate<IAnimatedVisual *>(
        __int64 a1,
        _BYTE *a2,
        _QWORD *a3)
{
  ...
  *(_QWORD *)v14 = *a3;
  ...
  std::vector<IAnimatedVisual *>::_Change_array(a1, v13, v9, v3);
  return v14;
}
