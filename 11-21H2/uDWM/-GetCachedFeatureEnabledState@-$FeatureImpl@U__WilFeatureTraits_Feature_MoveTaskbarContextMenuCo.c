/*
 * XREFs of ?GetCachedFeatureEnabledState@?$FeatureImpl@U__WilFeatureTraits_Feature_MoveTaskbarContextMenuControlsToSettingsApp@@@details@wil@@AEAA?ATwil_details_FeatureStateCache@@XZ @ 0x1800575CC
 * Callers:
...
signed __int32 *__fastcall wil::details::FeatureImpl<__WilFeatureTraits_Feature_MoveTaskbarContextMenuControlsToSettingsApp>::GetCachedFeatureEnabledState(
        ...
        signed __int32 *a2)
{
  ...
  *a2 = *a1;
  if ( (v4 & 3) != 3 )
  {
    ...
    wil::details::FeatureImpl<__WilFeatureTraits_Feature_MoveTaskbarContextMenuControlsToSettingsApp>::GetCurrentFeatureEnabledState(
      a1,
      &v14,
      &v13);
    v7 = *a2;
