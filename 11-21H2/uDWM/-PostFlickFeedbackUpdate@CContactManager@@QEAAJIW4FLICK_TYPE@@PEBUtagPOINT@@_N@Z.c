/*
 * XREFs of ?PostFlickFeedbackUpdate@CContactManager@@QEAAJIW4FLICK_TYPE@@PEBUtagPOINT@@_N@Z @ 0x1800ACA9C
 * Callers:
  ...
  if ( v7 )
  {
    ...
    if ( (int)v6 >= 0 )
    {
      ...
      *(_DWORD *)(*(_QWORD *)(a1 + 184) + 8 * v14 + 4) = a3;
      v15 = a5;
LABEL_15:
      CDesktopManager::PostEventMessage(CDesktopManager::s_pDesktopManagerInstance, 0x407u, v15, v5);
      return 0LL;
    }
  }
LABEL_5:
