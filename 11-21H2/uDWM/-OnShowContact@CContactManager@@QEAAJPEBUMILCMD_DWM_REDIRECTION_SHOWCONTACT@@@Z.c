/*
 * XREFs of ?OnShowContact@CContactManager@@QEAAJPEBUMILCMD_DWM_REDIRECTION_SHOWCONTACT@@@Z @ 0x180068D86
 * Callers:
 ...
 *     ?UpdateShowContact@CDirectTouchVisual@@QEAAJW4DWM_SHOWCONTACT@@@Z @ 0x1800B4160 (-UpdateShowContact@CDirectTouchVisual@@QEAAJW4DWM_SHOWCONTACT@@@Z.c)
 */
    ...
    *(_DWORD *)(*((_QWORD *)this + 7) + v10 + 40) = (_DWORD)v9;
    ...
    else
    {
      ...
      else
      {
        ...
        v17 = *(struct CTouchVisual **)(*((_QWORD *)this + 7) + v10 + 80);
        CContactManager::StopAndRemoveFromRootNode(v16, v17);
        if ( v17 )
          CBaseObject::Release(v17);
        *(_QWORD *)(*((_QWORD *)this + 7) + v10 + 48) = 0LL;
        *(_QWORD *)(*((_QWORD *)this + 7) + v10 + 80) = 0LL;
      }
      v20 = *(_QWORD *)(*((_QWORD *)this + 7) + v10 + 56);
      if ( v20 )
        *(_DWORD *)(v20 + 356) = *((_DWORD *)a2 + 2);
    }
  }
  if ( !(unsigned __int8)CContactManager::CheckShowContact(this, *((unsigned int *)a2 + 2), 2LL, v6) )
