/*
 * XREFs of ?UpdateAngle@?$produce@UTransitionManager@implementation@Transitions@Udwm@winrt@@UIRotationTransitionManager@Private@345@@impl@winrt@@UEAAHHH@Z @ 0x1800FB260
 * Callers:
 *     <none>
 * Callees:
