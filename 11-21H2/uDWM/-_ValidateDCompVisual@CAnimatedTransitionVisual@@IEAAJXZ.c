/*
 * XREFs of ?_ValidateDCompVisual@CAnimatedTransitionVisual@@IEAAJXZ @ 0x1800A0AB8
 * Callers:
...
__int64 __fastcall CAnimatedTransitionVisual::_ValidateDCompVisual(CAnimatedTransitionVisual *this)
{
  ...
  CBaseObject *v14; // [rsp+80h] [rbp+8h] BYREF
  ...
  v11 = CDrawGeometryInstruction::Create(BrushNoRef, *((struct CBaseGeometryProxy **)this + 89), &v14);
  v6 = v11;
  if ( v11 >= 0 )
  {
    v11 = CRenderDataVisual::AddInstruction(*((CRenderDataVisual **)this + 91), v14);
    v6 = v11;
    if ( v11 >= 0 )
    {
LABEL_8:
