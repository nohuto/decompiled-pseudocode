/*
 * XREFs of ?_UpdateAnimated3DResources@CAnimatedTransitionVisual@@IEAAJXZ @ 0x1800A0580
 * Callers:
 ...
 *     ?D2DMatrixRotationQuaternion@@YAPEAUD2DMatrix@@PEAU1@PEBUD2DQuaternion@@@Z @ 0x18010844C (-D2DMatrixRotationQuaternion@@YAPEAUD2DMatrix@@PEAU1@PEBUD2DQuaternion@@@Z.c)
 ...
 *     ?D3DXVec3TransformCoord@@YAPEAUD2DVector3@@PEAU1@PEBU1@PEBUD2DMatrix@@@Z @ 0x1801087F0 (-D3DXVec3TransformCoord@@YAPEAUD2DVector3@@PEAU1@PEBU1@PEBUD2DMatrix@@@Z.c)
 */
  ...
  *((_DWORD *)v3 + 14) = 0;
  ...
  if ( v23 )
  {
    ...
    if ( v24 )
    {
      if ( v24 == 1 )
      {
        v25 = (float)((float)(v21 - v22) * *((float *)this + 194)) + (float)(v22 * *((float *)this + 200));
        v26 = (float)(v17 * *((float *)this + 201)) + (float)((float)(v21 - v17) * *((float *)this + 195));
      }
      else
      {
        v26 = 0.0;
    ...
    v27 = *((_DWORD *)this + 218);
    v28 = 0;
    if ( *((_DWORD *)this + 220) - v27 >= 0 )
      v28 = *((_DWORD *)this + 220) - v27;
    v29 = *((_DWORD *)this + 221);
    v30 = (float)v27;
    v31 = *((_DWORD *)this + 219);
  }
  else
  {
    v32 = *((_DWORD *)this + 214);
    v28 = 0;
    if ( *((_DWORD *)this + 216) - v32 >= 0 )
      v28 = *((_DWORD *)this + 216) - v32;
    v29 = *((_DWORD *)this + 217);
    v30 = (float)v32;
    v31 = *((_DWORD *)this + 215);
  }
  ...
  if ( v34 >= 0 )
    v35 = v34;
  v25 = (float)((float)(v33 * *((float *)this + 200)) + v30)
      - (float)(v18 - (float)((float)((float)(0.5 - *((float *)this + 194)) * v22) + *((float *)this + 194)));
  v26 = (float)((float)((float)v35 * *((float *)this + 201)) + (float)v31)
      - (float)(v20 - (float)((float)((float)(0.5 - *((float *)this + 195)) * v17) + *((float *)this + 195)));
LABEL_19:
  v36 = *((float *)this + 194) - v25;
  v37 = *((float *)this + 195) - v26;
  v58 = 1065353216;
  v53 = 1065353216;
  v48 = 1.0;
  v60 = v36;
  ...
  if ( *((_BYTE *)this + 1036) )
    v4 = v65;
  v40 = *((float *)this + 230) + *((float *)this + 190);
  v60 = 0.0;
  v61 = 0.0;
  v62 = COERCE_UNSIGNED_INT(v40 + v4) ^ _xmm;
  D2DMatrixMultiply((struct D2DMatrix *)v3, (const struct D2DMatrix *)v3, (const struct D2DMatrix *)&v48);
  v42 = CMatrixTransform3dProxy::Update(*((CMatrixTransform3dProxy **)this + 37), v41);
  v44 = v42;
  if ( v42 >= 0 )
  {
    v45 = *((float *)this + 186);
    if ( v45 != *((float *)this + 187) )
    {
      ...
      if ( v46 >= 0 )
        *((_DWORD *)this + 187) = *((_DWORD *)this + 186);
        ...
        MilInstrumentationCheckHR_MaybeFailFast(0x14u, 0LL, 0LL, v46, 0x6CDu);
    }
  }
  else
  {
    MilInstrumentationCheckHR_MaybeFailFast(0x14u, 0LL, 0LL, v42, 0x6C8u);
  }
  return v44;
}
