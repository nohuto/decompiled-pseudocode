/*
 * XREFs of ??$WriteResultString@PEBD@details@wil@@YAPEAEPEAE0PEBDPEAPEBD@Z @ 0x1800938DC
 * Callers:
 ...
 *     ?ResultStringSize@details@wil@@YA_KPEBD@Z @ 0x180095BA0 (-ResultStringSize@details@wil@@YA_KPEBD@Z.c)
 */
