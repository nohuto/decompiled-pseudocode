/*
 * XREFs of ??_ECAnimatedTransitionVisual@@MEAAPEAXI@Z @ 0x18004742C
 * Callers:
 *     ??_ECAnimatedTransitionVisual@@O7EAAPEAXI@Z @ 0x180063860 (--_ECAnimatedTransitionVisual@@O7EAAPEAXI@Z.c)
 * Callees:
