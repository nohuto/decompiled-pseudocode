/*
 * XREFs of ?GetIids@?$produce_base@UTransitionManager@implementation@Transitions@Udwm@winrt@@UIRotationTransitionManager@Private@345@X@impl@winrt@@UEAAHPEAIPEAPEAUguid@3@@Z @ 0x1800F9F60
 * Callers:
 *     <none>
 * Callees:
 *     <none>
