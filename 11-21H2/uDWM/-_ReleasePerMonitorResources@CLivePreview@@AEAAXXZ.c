/*
 * XREFs of ?_ReleasePerMonitorResources@CLivePreview@@AEAAXXZ @ 0x1800C43B8
 * Callers:
...
void __fastcall CLivePreview::_ReleasePerMonitorResources(CLivePreview *this)
{
  ...
  for ( i = 0; i < *((_DWORD *)this + 100); ++i )
  {
    ...
    if ( v5 )
    {
      ...
      *(_QWORD *)(v3 + *((_QWORD *)this + 47) + 16) = 0LL;
      v4 = *((_QWORD *)this + 47);
    }
    ...
    if ( v6 )
    {
      ...
      *(_QWORD *)(v3 + *((_QWORD *)this + 47) + 24) = 0LL;
      v4 = *((_QWORD *)this + 47);
    }
    ...
    if ( v7 )
    {
      ...
      *(_QWORD *)(v3 + *((_QWORD *)this + 47) + 32) = 0LL;
      v4 = *((_QWORD *)this + 47);
    }
    ...
    if ( v8 )
    {
      ...
      *(_QWORD *)(v3 + *((_QWORD *)this + 47) + 56) = 0LL;
      v4 = *((_QWORD *)this + 47);
    }
    ...
    if ( v9 )
    {
      ...
      *(_QWORD *)(v3 + *((_QWORD *)this + 47) + 64) = 0LL;
      v4 = *((_QWORD *)this + 47);
    }
    ...
    if ( v10 )
    {
      ...
      *(_QWORD *)(v3 + *((_QWORD *)this + 47) + 72) = 0LL;
      v4 = *((_QWORD *)this + 47);
    }
    ...
    if ( v11 )
    {
      ...
      *(_QWORD *)(v3 + *((_QWORD *)this + 47) + 104) = 0LL;
    }
  }
  *((_DWORD *)this + 100) = 0;
  DynArrayImpl<0>::ShrinkToSize((__int64)this + 376, 0x88u);
}
