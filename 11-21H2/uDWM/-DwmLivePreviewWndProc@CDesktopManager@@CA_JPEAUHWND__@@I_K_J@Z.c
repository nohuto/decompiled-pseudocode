/*
 * XREFs of ?DwmLivePreviewWndProc@CDesktopManager@@CA_JPEAUHWND__@@I_K_J@Z @ 0x1800B0180
 * Callers:
 *     <none>
 * Callees:
    ...
    if ( Msg == 71 )
    {
      if ( (*(_BYTE *)(lParam + 32) & 0x40) != 0 )
      {
        ...
        else
        {
          ...
          MilInstrumentationCheckHR_MaybeFailFast(0x14u, 0LL, 0LL, LastError, 0xA5Fu);
          v10 = 1;
        }
LABEL_24:
        EnterCriticalSection(&CDesktopManager::s_csDwmInstance);
    ...
    if ( Msg != 257 )
    {
      if ( Msg == 1028 )
      {
        ...
        if ( !SetWindowPos(wParam, 0LL, 0, 0, 0, 0, lParam != 0 ? 67 : 83) )
        {
          ...
          if ( v11 >= 0 )
            v11 = -2003304445;
          MilInstrumentationCheckHR_MaybeFailFast(0x14u, 0LL, 0LL, v11, 0xA49u);
          if ( wParam == hWnd )
            v10 = 1;
        }
        v9 = 0;
...
LABEL_28:
  CLivePreview::DeActivate(*((CLivePreview **)CDesktopManager::s_pDesktopManagerInstance + 55), 0);
LABEL_29:
  if ( v9 )
    goto LABEL_30;
LABEL_31:
