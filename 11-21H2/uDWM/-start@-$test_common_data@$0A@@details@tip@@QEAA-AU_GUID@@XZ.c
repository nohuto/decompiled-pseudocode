/*
 * XREFs of ?start@?$test_common_data@$0A@@details@tip@@QEAA?AU_GUID@@XZ @ 0x1800444CC
 * Callers:
...
_OWORD *__fastcall tip::details::test_common_data<0>::start(__int64 a1, _OWORD *a2)
{
  ...
  __int64 v15; // rbp
  DWORD LastError; // ebx
  RTL_SRWLOCK *v18; // [rsp+40h] [rbp-68h] BYREF
  void *v19; // [rsp+48h] [rbp-60h] BYREF
  unsigned __int64 v20; // [rsp+60h] [rbp-48h]

  v4 = 0;
  LODWORD(v18) = 0;
  wil::AcquireSRWLockExclusive(&v18, (RTL_SRWLOCK *)(a1 + 16));
  if ( (*(_DWORD *)(a1 + 24) & 0x800) != 0 )
  {
    v6 = (_QWORD *)tip::details::test_common_data<0>::data((_QWORD *)a1, (__int64)&v19, 1u);
    v7 = v6;
    if ( v6[3] >= 0x10uLL )
      v7 = (_QWORD *)*v6;
    v4 = 1;
