/*
 * XREFs of ?_WindowEnumCallback@CGrowPanel@@MEAA_NPEAVCWindowData@@W4EnumWindowFlags@CStoryboard@@PEAJ@Z @ 0x1800DE990
 * Callers:
 *     <none>
 * Callees:
...
char __fastcall CGrowPanel::_WindowEnumCallback(__int64 a1, __int64 a2, char a3, int *a4)
{
  ...
  if ( (a3 & 1) == 0 )
  {
    if ( (a3 & 4) == 0 || (*(_DWORD *)(a2 + 672) & 0xFFF) != 0x28 )
      goto LABEL_31;
    v24 = *(_OWORD *)(a2 + 48);
    *(_BYTE *)(a1 + 136) = 1;
    *(_OWORD *)(a1 + 140) = v24;
  ...
  if ( (*(_DWORD *)(a2 + 672) & 0xFFF) == 0x28 )
  {
    ...
    MilInstrumentationCheckHR_MaybeFailFast(0x14u, &CStoryboard::MILINSTRUMENTATIONHRESULTLIST, 1LL, v20, 0x59Du);
LABEL_8:
    v4 = (CAnimatedTransitionVisual **)v28;
LABEL_29:
    if ( v4 )
  ...
  if ( *(_BYTE *)(a1 + 136) )
  {
    v9 = CShrinkPanel::GetPVLTarget(a1, *(_DWORD *)(a2 + 672));
    ...
    if ( v10 >= 0 )
    {
      ...
      v27 = v26;
      if ( CPanelAnimation::_ShouldSlideBasedOnLeft(v11, &v26, (const struct tagRECT *)(a1 + 140)) )
      {
        v12 = 0;
        v13 = *(_DWORD *)(a1 + 140);
    ...
    MilInstrumentationCheckHR_MaybeFailFast(0x14u, &CStoryboard::MILINSTRUMENTATIONHRESULTLIST, 1LL, v10, 0x57Eu);
    goto LABEL_8;
  }
  v18 = CSlide::_SlideWindow((CSlide *)a1, (struct CWindowData *)a2, 0.0, 0LL);
  v5 = v18;
  if ( v18 < 0 )
    MilInstrumentationCheckHR_MaybeFailFast(0x14u, &CStoryboard::MILINSTRUMENTATIONHRESULTLIST, 1LL, v18, 0x595u);
LABEL_31:
  result = 1;
  *a4 = v5;
  return result;
