/*
 * XREFs of ?WriteInstruction@CDrawImageInstruction@@UEAAJPEAUIRenderDataBuilder@@PEBVCVisual@@@Z @ 0x18000D7D0
 * Callers:
 *     <none>
 * Callees:
        ...
        const struct CVisual *a3)
{
  ...
  if ( v6 )
  {
    v9 = _mm_cvtsi32_si128(*((_DWORD *)a3 + 32));
    v10 = _mm_cvtsi32_si128(*((_DWORD *)a3 + 33));
    v11[0] = 0;
    v11[1] = 0;
