/*
 * XREFs of ?_WindowEnumCallback@CVirtualDesktopSwitch@@EEAA_NPEAVCWindowData@@W4EnumWindowFlags@CStoryboard@@PEAJ@Z @ 0x1800E08A0
 * Callers:
 *     <none>
 * Callees:
      ...
      if ( (unsigned int)(v9 - 75) <= 1 )
      {
        ...
        if ( v8 )
        {
          while ( 1 )
          {
            ...
            v26 = *(struct tagRECT *)(*(_QWORD *)(a1 + 160) + 16LL * (unsigned int)v10);
            v11 = v26;
            rc = v26;
            ...
            CAnimatedTransitionVisual::SetBeginRect(
              *(struct tagPOINT **)(*(_QWORD *)(*(_QWORD *)(a1 + 128) + 8 * v10) + 40LL),
              &v26);
            v17 = *(_QWORD *)(*(_QWORD *)(*(_QWORD *)(a1 + 128) + 8 * v10) + 40LL);
