/*
 * XREFs of ?OnCaptureRTBitsWorker@CMagnifier@@AEAAJ_KKPEBUMAGN_UPDATE_TEXTURES_PARAM@@PEAUMILCMD_DWM_CAPTURE_METARENDERTARGET_BITSREPLY@@@Z @ 0x1800C5D78
 * Callers:
        ...
        struct MILCMD_DWM_CAPTURE_METARENDERTARGET_BITSREPLY *a5)
{
  ...
  if ( *((_DWORD *)this + 42) )
  {
    v6 = (*(__int64 (__fastcall **)(_QWORD, _QWORD, _QWORD, _QWORD, __int64, int, const struct MAGN_UPDATE_TEXTURES_PARAM *))(**(_QWORD **)(*(_QWORD *)(*((_QWORD *)this + 3) + 16LL) + 16LL) + 640LL))(
    ...
    {
      MilInstrumentationCheckHR_MaybeFailFast(0x14u, &dword_180122BA0, 8LL, v6, 0x1DCu);
    }
  }
  else
  {
