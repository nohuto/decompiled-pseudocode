/*
 * XREFs of ?RestartTimeline@CLivePreviewTimeline@@QEAAJW4Enum@LivePreviewAnimation@@N@Z @ 0x1800C58C8
 * Callers:
...
__int64 __fastcall CLivePreviewTimeline::RestartTimeline(__int64 a1, int a2, double a3)
{
  ...
  *(_DWORD *)(a1 + 112) = a2;
  ...
  if ( a2 != 3 )
  {
    if ( a2 == 4 )
    {
      v5 = (1.0 - *(double *)(a1 + 48)) * *(double *)(a1 + 120);
      *(double *)(a1 + 120) = v5;
      a3 = a3 * (1.0 - v5);
      goto LABEL_12;
    }
LABEL_11:
  ...
  v4 = (1.0 - *(double *)(a1 + 120)) * *(double *)(a1 + 48) + *(double *)(a1 + 120);
  *(double *)(a1 + 120) = v4;
  a3 = a3 * v4;
LABEL_12:
