/*
 * XREFs of _CWindowData::EnsureClientAreaVisualProxy_::_1_::dtor$0 @ 0x180064874
 * Callers:
 *     <none>
 * Callees:
 *     <none>
...
__int64 __fastcall CWindowData::EnsureClientAreaVisualProxy_::_1_::dtor_0(__int64 a1, __int64 a2)
{
