/*
 * XREFs of ?SetupDelayBeforeEntranceAnimation@CDisplayMixedModeAnimatedVisual@@AEAAJXZ @ 0x1800B8EF4
 * Callers:
 *     ?OnAnimationCompleteImpl@CDisplayMixedModeAnimatedVisual@@EEAAJI@Z @ 0x1800B8C60 (-OnAnimationCompleteImpl@CDisplayMixedModeAnimatedVisual@@EEAAJI@Z.c)
 * Callees:
