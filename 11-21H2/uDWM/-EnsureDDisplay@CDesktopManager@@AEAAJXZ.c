/*
 * XREFs of ?EnsureDDisplay@CDesktopManager@@AEAAJXZ @ 0x1800B0790
 * Callers:
...
__int64 __fastcall CDesktopManager::EnsureDDisplay(CDesktopManager *this)
{
  ...
  v1 = (struct CDDisplayManager **)((char *)this + 760);
  v2 = (CBaseObject *)*((_QWORD *)this + 95);
  *v1 = 0LL;
  if ( v2 )
  ...
  v4 = v3;
  if ( v3 < 0 )
    MilInstrumentationCheckHR_MaybeFailFast(0x14u, 0LL, 0LL, v3, 0x648u);
  return v4;
}
