/*
 * XREFs of _CDisplayMixedModeAnimatedVisual::Create_::_1_::dtor$0 @ 0x1800B9CED
 * Callers:
 *     <none>
 * Callees:
...
void __fastcall CDisplayMixedModeAnimatedVisual::Create_::_1_::dtor_0(__int64 a1, __int64 a2)
{
