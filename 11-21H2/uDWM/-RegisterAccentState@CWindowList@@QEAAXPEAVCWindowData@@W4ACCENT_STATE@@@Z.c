/*
 * XREFs of ?RegisterAccentState@CWindowList@@QEAAXPEAVCWindowData@@W4ACCENT_STATE@@@Z @ 0x1800175E8
 * Callers:
...
LABEL_6:
      ...
      *((_QWORD *)&v9 + 1) = a3;
      ...
      else if ( v7 > *(_DWORD *)(a1 + 612) )
      {
        v8 = DynArrayImpl<0>::AddMultipleAndSet(a1 + 592, 16LL, 1LL, &v9);
        if ( v8 < 0 )
          MilInstrumentationCheckHR_MaybeFailFast(0x14u, 0LL, 0LL, v8, 0xC0u);
      }
      else
      {
        *(_OWORD *)(*(_QWORD *)(a1 + 592) + 16LL * v6) = v9;
        *(_DWORD *)(a1 + 616) = v7;
      }
    }
  }
