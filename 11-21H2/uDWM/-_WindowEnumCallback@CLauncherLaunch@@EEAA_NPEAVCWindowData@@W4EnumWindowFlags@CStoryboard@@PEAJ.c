/*
 * XREFs of ?_WindowEnumCallback@CLauncherLaunch@@EEAA_NPEAVCWindowData@@W4EnumWindowFlags@CStoryboard@@PEAJ@Z @ 0x1800DF590
 * Callers:
 *     <none>
 * Callees:
 ...
 *     ?_WillWindowEndCloaked@CStoryboard@@KA_NPEBVCWindowData@@@Z @ 0x1800DC124 (-_WillWindowEndCloaked@CStoryboard@@KA_NPEBVCWindowData@@@Z.c)
...
char __fastcall CLauncherLaunch::_WindowEnumCallback(struct tagRECT *a1, struct tagRECT *a2, char a3, int *a4)
{
  ...
  if ( (a3 & 1) != 0 )
  {
    v12 = a2[42].left & 0xFFF;
    if ( v12 == 2 )
    {
      if ( a2[8].top == 1 )
        a2[42].left |= 0x4000000u;
