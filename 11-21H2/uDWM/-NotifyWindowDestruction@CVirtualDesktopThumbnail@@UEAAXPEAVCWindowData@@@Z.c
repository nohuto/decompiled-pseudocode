/*
 * XREFs of ?NotifyWindowDestruction@CVirtualDesktopThumbnail@@UEAAXPEAVCWindowData@@@Z @ 0x1800B2D60
 * Callers:
 *     <none>
 * Callees:
        ...
        const struct CTopLevelWindow **a2)
{
  ...
  v4 = a2;
  DynArray<CWindowData *,0>::Remove((__int64 *)(*((_QWORD *)this + 36) + 128LL), &v4);
  DynArray<CWindowData *,0>::Remove((__int64 *)(*((_QWORD *)this + 36) + 160LL), &v4);
