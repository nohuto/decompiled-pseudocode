/*
 * XREFs of ??$CreateProxyFromSharedHandle@VCVisualSurfaceProxy@@@CCompositor@@IEAAJPEAXPEAPEAVCVisualSurfaceProxy@@@Z @ 0x18005EB3C
 * Callers:
  ...
  *a3 = 0LL;
  ...
  if ( v6 )
  {
    ...
    *(_QWORD *)v6 = &CAnimationProxy::`vftable';
    ...
    v8 = CResourceProxy::InitializeFromSharedHandle(v6, 0x2Au, *(_QWORD *)(a1 + 16), a2);
    v9 = v8;
    if ( v8 < 0 )
    {
