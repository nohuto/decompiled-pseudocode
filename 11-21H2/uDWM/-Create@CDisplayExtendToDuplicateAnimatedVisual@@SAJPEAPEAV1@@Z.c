/*
 * XREFs of ?Create@CDisplayExtendToDuplicateAnimatedVisual@@SAJPEAPEAV1@@Z @ 0x1800B9ADC
 * Callers:
 ...
 *     ??0CDisplayExtendToDuplicateAnimatedVisual@@IEAA@XZ @ 0x1800B7C38 (--0CDisplayExtendToDuplicateAnimatedVisual@@IEAA@XZ.c)
 */
