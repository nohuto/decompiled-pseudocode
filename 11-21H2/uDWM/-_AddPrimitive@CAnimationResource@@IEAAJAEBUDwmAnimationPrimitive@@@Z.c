/*
 * XREFs of ?_AddPrimitive@CAnimationResource@@IEAAJAEBUDwmAnimationPrimitive@@@Z @ 0x1800021C8
 * Callers:
...
__int64 __fastcall CAnimationResource::_AddPrimitive(CAnimationResource *this, const struct DwmAnimationPrimitive *a2)
{
  ...
  if ( *(_DWORD *)a2 == 3 )
  {
    if ( !v2 || *((_QWORD *)a2 + 1) == *(_QWORD *)(*((_QWORD *)this + 4) + 8LL) )
      return (unsigned int)-2147024809;
  }
  else if ( !v2 )
  {
  ...
  if ( *(_QWORD *)(32LL * (unsigned int)(v2 - 1) + *((_QWORD *)this + 4) + 8) == *((_QWORD *)a2 + 1) )
    v6 = 1;
LABEL_8:
  switch ( *(_DWORD *)a2 )
  {
