/*
 * XREFs of ?Start@CFlickVisual@@QEAAJPEBUtagPOINT@@W4FLICK_TYPE@@I@Z @ 0x1800BC224
 * Callers:
...
LABEL_36:
  ...
  *(_DWORD *)(a1 + 324) = top + *(_DWORD *)(a1 + 348) + v26;
  CContactManager::PostFlickFeedbackUpdate(*((_QWORD *)v27 + 19), v29, v28, (_QWORD *)(a1 + 320), 1u);
  return (unsigned int)BitmapFromAtlas;
}
