/*
 * XREFs of CWindowList::ForEachSoftwareCursorListener__lambda_3a525a268788499e62ab8aaec5424964___ @ 0x18005EE68
 * Callers:
        ...
        __int64 **a2)
{
  ...
  {
    v5 = *(void (__fastcall ****)(_QWORD, _QWORD))(*(_QWORD *)(a1 + 664) + 8 * i);
    v6 = **a2;
    v7 = *v5;
    if ( (*(_BYTE *)(v6 + 668) & 2) != 0 )
      (*v7)(v5, *(_QWORD *)(v6 + 440));
