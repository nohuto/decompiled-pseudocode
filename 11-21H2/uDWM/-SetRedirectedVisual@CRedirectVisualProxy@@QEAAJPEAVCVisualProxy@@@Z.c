/*
 * XREFs of ?SetRedirectedVisual@CRedirectVisualProxy@@QEAAJPEAVCVisualProxy@@@Z @ 0x1800D181C
 * Callers:
...
__int64 __fastcall CRedirectVisualProxy::SetRedirectedVisual(CRedirectVisualProxy *this, struct CVisualProxy *a2)
{
  ...
  return (*(__int64 (__fastcall **)(_QWORD, _QWORD, _QWORD))(**(_QWORD **)(*((_QWORD *)this + 2) + 16LL) + 320LL))(
