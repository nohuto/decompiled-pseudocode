/*
 * XREFs of _CAnimationClock::_TriggerAnimation_::_1_::dtor$1 @ 0x1800A4476
 * Callers:
 *     <none>
 * Callees:
 *     <none>
...
unsigned int __fastcall CAnimationClock::_TriggerAnimation_::_1_::dtor_1(__int64 a1, __int64 a2)
{
