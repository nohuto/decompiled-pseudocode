/*
 * XREFs of __tailMerge_api_ms_win_service_management_l2_1_0_dll @ 0x180061327
 * Callers:
 *     __imp_load_NotifyServiceStatusChangeW @ 0x18006131B (__imp_load_NotifyServiceStatusChangeW.c)
 * Callees:
