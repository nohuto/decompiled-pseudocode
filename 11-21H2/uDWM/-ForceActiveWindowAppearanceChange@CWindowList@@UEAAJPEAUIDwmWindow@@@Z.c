/*
 * XREFs of ?ForceActiveWindowAppearanceChange@CWindowList@@UEAAJPEAUIDwmWindow@@@Z @ 0x18005F250
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall CWindowList::ForceActiveWindowAppearanceChange(CWindowList *this, struct IDwmWindow *a2)
{
  ...
  {
    MilInstrumentationCheckHR_MaybeFailFast(0x14u, 0LL, 0LL, SyncedWindowData, 0x1776u);
  }
  else
  {
    v6 = v9;
    if ( v9 )
    {
      ...
      if ( *((_QWORD *)v6 + 55) )
      {
        if ( v7 != ((*((_BYTE *)v6 + 667) & 0x10) != 0) )
        {
          *((_BYTE *)v6 + 667) ^= (*((_BYTE *)v6 + 667) ^ (16 * v7)) & 0x10;
          CVisual::SetDirtyFlags(*((CVisual **)v6 + 55), 1081346);
        }
      }
    }
  }
