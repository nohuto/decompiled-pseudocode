/*
 * XREFs of ??1?$_Tree_temp_node@V?$allocator@U?$_Tree_node@U?$pair@$$CBUhstring@winrt@@N@std@@PEAX@std@@@std@@@std@@QEAA@XZ @ 0x1800F9800
 * Callers:
        ...
        __int64 a1)
{
  ...
  if ( v2 )
  {
    winrt::handle_type<winrt::impl::hstring_traits>::close((volatile signed __int32 **)(v2 + 32));
    v3 = *(void **)(a1 + 8);
    if ( v3 )
