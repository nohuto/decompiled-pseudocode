/*
 * XREFs of ?GetNonClientCaptionFont@CWindowData@@QEAAXPEAUtagLOGFONTW@@@Z @ 0x180035E60
 * Callers:
...
void __fastcall CWindowData::GetNonClientCaptionFont(CWindowData *this, struct tagLOGFONTW *a2)
{
  ...
  v4 = *(_OWORD *)((char *)CDesktopManager::s_pDesktopManagerInstance + 296);
  *(_OWORD *)&a2->lfHeight = *(_OWORD *)((char *)CDesktopManager::s_pDesktopManagerInstance + 280);
  v5 = *(_OWORD *)((char *)v2 + 312);
  *(_OWORD *)&a2->lfWeight = v4;
  v6 = *(_OWORD *)((char *)v2 + 328);
  *(_OWORD *)&a2->lfFaceName[2] = v5;
  v7 = *(_OWORD *)((char *)v2 + 344);
  *(_OWORD *)&a2->lfFaceName[10] = v6;
  *(_QWORD *)&v6 = *((_QWORD *)v2 + 45);
  LODWORD(v2) = *((_DWORD *)v2 + 92);
  *(_OWORD *)&a2->lfFaceName[18] = v7;
  *(_QWORD *)&a2->lfFaceName[26] = v6;
  *(_DWORD *)&a2->lfFaceName[30] = (_DWORD)v2;
  v8 = (double)*((int *)this + 87);
