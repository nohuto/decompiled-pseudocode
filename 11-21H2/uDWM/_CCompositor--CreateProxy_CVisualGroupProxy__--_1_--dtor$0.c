/*
 * XREFs of _CCompositor::CreateProxy_CVisualGroupProxy__::_1_::dtor$0 @ 0x1800A931E
 * Callers:
 *     <none>
 * Callees:
 *     <none>
...
unsigned int __fastcall CCompositor::CreateProxy_CVisualGroupProxy__::_1_::dtor_0(__int64 a1, __int64 a2)
{
