/*
 * XREFs of ?QueryInterface@?$implements@UTransitionManager@implementation@Transitions@Udwm@winrt@@U1345@UIRotationTransitionManager@Private@345@UIWindowStateTransitionManager@7345@UITransitionManagerNativePrivate@34@@winrt@@UEAAJAEBU_GUID@@PEAPEAX@Z @ 0x180009C60
 * Callers:
 *     <none>
 * Callees:
        ...
        __int64 *a3)
{
  ...
  if ( a1 != -32 )
    v5 = a1;
  v8 = (*(__int64 (__fastcall **)(__int64))(*(_QWORD *)(v5 + 32) + 48LL))(v5 + 32);
  *a3 = v8;
  if ( v8 )
  {
    v9 = *((_QWORD *)v3 + 1);
