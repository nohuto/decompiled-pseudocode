/*
 * XREFs of ??$WriteResultString@PEBG@details@wil@@YAPEAEPEAE0PEBGPEAPEBG@Z @ 0x180093950
 * Callers:
 ...
 *     ?ResultStringSize@details@wil@@YA_KPEBG@Z @ 0x180095BCC (-ResultStringSize@details@wil@@YA_KPEBG@Z.c)
 */
