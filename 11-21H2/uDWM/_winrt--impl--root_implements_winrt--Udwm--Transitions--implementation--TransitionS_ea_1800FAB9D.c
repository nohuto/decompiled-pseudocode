/*
 * XREFs of _winrt::impl::root_implements_winrt::Udwm::Transitions::implementation::TransitionState_winrt::Udwm::Transitions::TransitionState_Udwm::Transitions::ITransitionStateNative_Udwm::Transitions::ITransitionStateNativePrivate_::NonDelegatingGetTrustLevel_::_1_::catch$0 @ 0x1800FAB9D
 * Callers:
 *     <none>
 * Callees:
