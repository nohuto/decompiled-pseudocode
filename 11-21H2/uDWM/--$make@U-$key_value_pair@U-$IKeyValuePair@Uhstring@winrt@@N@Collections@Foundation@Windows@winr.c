/*
 * XREFs of ??$make@U?$key_value_pair@U?$IKeyValuePair@Uhstring@winrt@@N@Collections@Foundation@Windows@winrt@@@impl@winrt@@AEBUhstring@3@AEBN@winrt@@YA?AU?$IKeyValuePair@Uhstring@winrt@@N@Collections@Foundation@Windows@0@AEBUhstring@0@AEBN@Z @ 0x1800F9244
 * Callers:
        ...
        __int64 *a2)
{
  ...
  __int64 v6; // rcx
  struct winrt::impl::hstring_header *v8; // [rsp+50h] [rbp+8h] BYREF
