/*
 * XREFs of ?Remove@?$DynArray@PEAVCAnimationClock@@$0A@@@QEAAHAEBQEAVCAnimationClock@@@Z @ 0x1800A4FA8
 * Callers:
...
__int64 __fastcall DynArray<CAnimationClock *,0>::Remove(__int64 *a1, _QWORD *a2)
{
  unsigned int v2; // r8d
  __int64 v3; // r9
  __int64 i; // r11
