/*
 * XREFs of ??$CreateProxyFromSharedHandle@VCRemoteAppRenderTargetProxy@@@CCompositor@@IEAAJPEAXPEAPEAVCRemoteAppRenderTargetProxy@@@Z @ 0x1800A96CC
 * Callers:
  ...
  *a3 = 0LL;
  ...
  if ( v6 )
  {
    ...
    *(_QWORD *)v6 = &CRemoteAppRenderTargetProxy::`vftable';
    ...
    v8 = CResourceProxy::InitializeFromSharedHandle(v6, 0x1Du, *(_QWORD *)(a1 + 16), a2);
    v9 = v8;
    if ( v8 >= 0 )
    {
      *a3 = v7;
