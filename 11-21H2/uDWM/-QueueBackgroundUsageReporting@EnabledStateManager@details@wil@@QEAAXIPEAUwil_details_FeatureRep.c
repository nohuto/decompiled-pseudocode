/*
 * XREFs of ?QueueBackgroundUsageReporting@EnabledStateManager@details@wil@@QEAAXIPEAUwil_details_FeatureReportingCache@@@Z @ 0x180041268
 * Callers:
        ...
        struct wil_details_FeatureReportingCache *a3)
{
  ...
  {
    wil::AcquireSRWLockExclusive(&v9, pv + 1);
    v7 = a2;
    v8 = a3;
    ...
    if ( !*((_BYTE *)pv + 24) )
    {
      ...
      wil::details::EnsureCoalescedTimer_SetTimer(pv + 2, (_BYTE *)pv + 24, 300000LL);
    }
