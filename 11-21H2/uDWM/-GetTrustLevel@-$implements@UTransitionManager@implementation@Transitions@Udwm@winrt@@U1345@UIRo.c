/*
 * XREFs of ?GetTrustLevel@?$implements@UTransitionManager@implementation@Transitions@Udwm@winrt@@U1345@UIRotationTransitionManager@Private@345@UIWindowStateTransitionManager@7345@UITransitionManagerNativePrivate@34@@winrt@@UEAAJPEAW4TrustLevel@@@Z @ 0x1800FA320
 * Callers:
 *     <none>
 * Callees:
 *     <none>
