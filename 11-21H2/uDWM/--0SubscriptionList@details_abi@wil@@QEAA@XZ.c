/*
 * XREFs of ??0SubscriptionList@details_abi@wil@@QEAA@XZ @ 0x18003F6B4
 * Callers:
 *     ?construct@?$manually_managed_shutdown_aware_object@VFeatureStateManager@details@wil@@@wil@@QEAAXXZ @ 0x1800141D4 (-construct@-$manually_managed_shutdown_aware_object@VFeatureStateManager@details@wil@@@wil@@QEAA.c)
