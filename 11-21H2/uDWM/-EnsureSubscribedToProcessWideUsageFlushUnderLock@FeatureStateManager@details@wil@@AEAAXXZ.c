/*
 * XREFs of ?EnsureSubscribedToProcessWideUsageFlushUnderLock@FeatureStateManager@details@wil@@AEAAXXZ @ 0x18005C120
 * Callers:
        ...
        wil::details::FeatureStateManager *this)
{
  ...
  v2 = (struct FEATURE_STATE_CHANGE_SUBSCRIPTION__ **)((char *)this + 72);
  if ( !*((_QWORD *)this + 9) )
  {
    ...
    {
      *v2 = 0LL;
      wil::AcquireSRWLockExclusive(&v4, v3);
