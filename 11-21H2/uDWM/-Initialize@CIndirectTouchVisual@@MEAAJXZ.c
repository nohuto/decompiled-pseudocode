/*
 * XREFs of ?Initialize@CIndirectTouchVisual@@MEAAJXZ @ 0x1800C0C50
 * Callers:
...
__int64 __fastcall CIndirectTouchVisual::Initialize(CIndirectTouchVisual *this)
{
  ...
  if ( v2 >= 0 )
  {
    ...
    BitmapsFromAtlasImageStrip = CTopLevelWindow::CreateBitmapsFromAtlasImageStrip(
                                   ...
                                   0xFu,
                                   0LL,
                                   (struct CBitmapSource ***)this + 49);
    v3 = BitmapsFromAtlasImageStrip;
    if ( BitmapsFromAtlasImageStrip >= 0 )
    {
      v6 = (struct CVisual **)((char *)this + 384);
      ...
      *((_DWORD *)this + 86) = 1059760810;
      ...
      if ( v8 >= 0 )
      {
        ...
        if ( inserted >= 0 )
        {
          CVisual::SetSize(*v6, (const struct tagSIZE *)((char *)this + 316));
          *((_QWORD *)this + 45) = 0LL;
          *((_QWORD *)this + 46) = 0LL;
          *((_QWORD *)this + 47) = 0LL;
          *((_DWORD *)this + 87) = 0;
