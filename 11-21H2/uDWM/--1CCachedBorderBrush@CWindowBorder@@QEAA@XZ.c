/*
 * XREFs of ??1CCachedBorderBrush@CWindowBorder@@QEAA@XZ @ 0x18003A7A0
 * Callers:
 *     ?_Destroy@?$_Ref_count_obj2@VCCachedBorderBrush@CWindowBorder@@@std@@EEAAXXZ @ 0x18003A790 (-_Destroy@-$_Ref_count_obj2@VCCachedBorderBrush@CWindowBorder@@@std@@EEAAXXZ.c)
 * Callees:
