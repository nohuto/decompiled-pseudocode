/*
 * XREFs of ?GetWindowRectForLivePreview@CWindowIconic@@AEAAJPEAUtagRECT@@@Z @ 0x1801011E8
 * Callers:
...
__int64 __fastcall CWindowIconic::GetWindowRectForLivePreview(CWindowIconic *this, struct tagRECT *a2)
{
  ...
  if ( (*((_BYTE *)v4 + 666) & 2) == 0 || (MDIOwner = CWindowData::GetMDIOwner(v4)) == 0LL )
  ...
  else
  {
    ...
    {
      MilInstrumentationCheckHR_MaybeFailFast(0x14u, 0LL, 0LL, WindowRestoreRect, 0x1CFu);
      return v3;
    }
  }
  if ( *((_DWORD *)this + 4) == 2 )
