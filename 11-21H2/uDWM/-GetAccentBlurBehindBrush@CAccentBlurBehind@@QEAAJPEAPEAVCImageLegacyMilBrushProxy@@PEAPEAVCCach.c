/*
 * XREFs of ?GetAccentBlurBehindBrush@CAccentBlurBehind@@QEAAJPEAPEAVCImageLegacyMilBrushProxy@@PEAPEAVCCachedVisualImageProxy@@PEAUMilPoint3F@@@Z @ 0x18009798C
 * Callers:
        ...
        struct MilPoint3F *a4)
{
  ...
  v8 = (volatile signed __int32 *)*((_QWORD *)this + 43);
  *a2 = (struct CImageLegacyMilBrushProxy *)v8;
  if ( v8 )
    _InterlockedIncrement(v8 + 2);
  if ( *a3 )
    CBaseObject::Release(*a3);
  v9 = (volatile signed __int32 *)*((_QWORD *)this + 42);
  *a3 = (struct CCachedVisualImageProxy *)v9;
  if ( v9 )
    _InterlockedIncrement(v9 + 2);
  v10 = FLOAT_1_0;
  if ( COERCE_FLOAT(*((_DWORD *)this + 82) & _xmm) >= 0.0000011920929 )
    v10 = 1.0 / *((float *)this + 82);
  *(float *)a4 = v10;
  result = 0LL;
  *((float *)a4 + 1) = v10;
