/*
 * XREFs of ?_lambda_invoker_cdecl_@_lambda_5035b992506f4af81a770c5842624510_@@CAXPEAU_TP_CALLBACK_INSTANCE@@PEAXPEAU_TP_TIMER@@@Z @ 0x180092660
 * Callers:
 *     <none>
 * Callees:
        ...
        PTP_TIMER Timer)
{
  ...
  {
    wil::AcquireSRWLockExclusive(&v4, Context + 5);
