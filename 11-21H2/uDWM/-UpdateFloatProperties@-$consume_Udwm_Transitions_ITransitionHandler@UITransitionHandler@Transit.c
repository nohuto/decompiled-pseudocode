/*
 * XREFs of ?UpdateFloatProperties@?$consume_Udwm_Transitions_ITransitionHandler@UITransitionHandler@Transitions@Udwm@winrt@@@impl@winrt@@QEBAXAEBU?$map@Uhstring@winrt@@N@param@3@@Z @ 0x1800FB4A8
 * Callers:
