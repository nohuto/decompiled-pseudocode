/*
 * XREFs of ?find_interface@?$implements@UUserResizeVisual@implementation@Transitions@Udwm@winrt@@U1345@UIUserResizeVisualNative@34@@winrt@@UEBAPEAXAEBUguid@2@@Z @ 0x1800FF010
 * Callers:
 *     <none>
 * Callees:
 *     <none>
        ...
        _QWORD *a2)
{
  ...
  if ( v2 )
  {
    v4 = *a2 - winrt::impl::guid_v<Udwm::Transitions::IUserResizeVisualNative>;
    if ( *a2 == winrt::impl::guid_v<Udwm::Transitions::IUserResizeVisualNative> )
