/*
 * XREFs of ?UpdateAlignmentTransform@CText@@AEAAJXZ @ 0x1800159E8
 * Callers:
...
__int64 __fastcall CText::UpdateAlignmentTransform(CText *this)
{
  ...
  int v3; // eax
  int v4; // eax
  _MilMatrix3x2D v6; // [rsp+30h] [rbp-48h] BYREF

  v1 = (CMatrixTransformProxy *)*((_QWORD *)this + 50);
  v2 = 0;
  if ( v1 )
  {
    v3 = (*((_DWORD *)this + 33) - *((_DWORD *)this + 103)) / 2;
    *(_OWORD *)&v6.S_11 = _xmm;
    v6.DX = 0.0;
    *(_OWORD *)&v6.S_21 = _xmm;
    v6.DY = (double)v3;
    ...
    v2 = v4;
    if ( v4 < 0 )
      MilInstrumentationCheckHR_MaybeFailFast(0x14u, 0LL, 0LL, v4, 0x1EBu);
  }
  return v2;
}
