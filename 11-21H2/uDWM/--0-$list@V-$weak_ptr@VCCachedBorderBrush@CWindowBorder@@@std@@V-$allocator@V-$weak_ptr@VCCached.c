/*
 * XREFs of ??0?$list@V?$weak_ptr@VCCachedBorderBrush@CWindowBorder@@@std@@V?$allocator@V?$weak_ptr@VCCachedBorderBrush@CWindowBorder@@@std@@@2@@std@@QEAA@XZ @ 0x180013AD4
 * Callers:
...
__int128 *std::list<std::weak_ptr<CWindowBorder::CCachedBorderBrush>>::list<std::weak_ptr<CWindowBorder::CCachedBorderBrush>>()
{
  ...
  v0 = (_QWORD *)std::_Allocate<16,std::_Default_allocate_traits,0>(32LL);
  *v0 = v0;
  v0[1] = v0;
