/*
 * XREFs of ?_UpdateBorderShadowForAccent@CAccent@@IEAAJXZ @ 0x1800988D4
 * Callers:
 ...
 *     ?GetShadowMargins@CAccent@@KA?AU_MARGINS@@PEAUWindowFrame@CTopLevelWindow@@@Z @ 0x180097AD8 (-GetShadowMargins@CAccent@@KA-AU_MARGINS@@PEAUWindowFrame@CTopLevelWindow@@@Z.c)
...
__int64 __fastcall CAccent::_UpdateBorderShadowForAccent(CAccent *this)
{
  ...
  if ( v3 )
    v2 = (int)((double)*(int *)(*(_QWORD *)(v3 + 1480) + 28LL)
             * *((double *)CDesktopManager::s_pDesktopManagerInstance + 51));
  ...
  v11 = v21;
  v12 = 22LL;
  v13 = (CAtlasedImage **)((char *)this + 448);
  v14 = &v20;
  do
  {
    if ( *v13 )
    {
      ...
      if ( v11[1] != 0x7FFFFFFF )
      {
        ...
        CAtlasedImage::SetSize(v16, (const struct tagSIZE *)&v19);
      }
    }
  ...
  while ( v12 );
  (*(void (__fastcall **)(_QWORD, __int64))(**((_QWORD **)this + 54) + 24LL))(*((_QWORD *)this + 54), 4096LL);
  return 0LL;
}
