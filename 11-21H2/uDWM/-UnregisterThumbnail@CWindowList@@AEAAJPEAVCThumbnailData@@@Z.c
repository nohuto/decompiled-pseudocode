/*
 * XREFs of ?UnregisterThumbnail@CWindowList@@AEAAJPEAVCThumbnailData@@@Z @ 0x18000AE08
 * Callers:
...
__int64 __fastcall CWindowList::UnregisterThumbnail(CWindowList *this, struct CVisual **a2)
{
  ...
  {
    v14 = (CTopLevelWindow *)*((_QWORD *)a2[2] + 55);
    if ( v14 )
    {
      v15 = a2[11];
      if ( v15 )
      {
        ...
        if ( v16 < 0 )
        {
          MilInstrumentationCheckHR_MaybeFailFast(0x14u, 0LL, 0LL, v16, 0x1966u);
          return v2;
        }
      }
    }
  }
  DynArray<CThumbnailData *,0>::Remove((char *)a2[2] + 536, &v17);
  v9 = a2[3];
  if ( v9 )
    DynArray<CThumbnailData *,0>::Remove((char *)v9 + 568, &v17);
  v10 = a2[11];
  if ( v10 )
  {
    *((_QWORD *)v10 + 47) = 0LL;
  ...
  DynArray<CThumbnailData *,0>::Remove((char *)this + 384, &v17);
  return v2;
}
