/*
 * XREFs of dllmain_crt_process_attach @ 0x180061FC8
 * Callers:
 ...
 *     __scrt_is_nonwritable_in_current_image @ 0x18006049C (__scrt_is_nonwritable_in_current_image.c)
 *     __scrt_release_startup_lock @ 0x18006053C (__scrt_release_startup_lock.c)
 *     __scrt_fastfail @ 0x180060C60 (__scrt_fastfail.c)
 *     ?__scrt_initialize_type_info@@YAXXZ @ 0x1800623CC (-__scrt_initialize_type_info@@YAXXZ.c)
 *     __scrt_initialize_default_local_stdio_options @ 0x1800623F4 (__scrt_initialize_default_local_stdio_options.c)
 *     __scrt_get_dyn_tls_init_callback @ 0x180062418 (__scrt_get_dyn_tls_init_callback.c)
 *     _RTC_Initialize @ 0x180062428 (_RTC_Initialize.c)
 *     _initterm_0 @ 0x1800624C0 (_initterm_0.c)
 *     _initterm_e_0 @ 0x1800624CC (_initterm_e_0.c)
