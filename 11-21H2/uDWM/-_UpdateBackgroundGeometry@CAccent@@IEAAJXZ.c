/*
 * XREFs of ?_UpdateBackgroundGeometry@CAccent@@IEAAJXZ @ 0x180047880
 * Callers:
...
__int64 __fastcall CAccent::_UpdateBackgroundGeometry(CAccent *this)
{
  ...
  v1 = 0;
  v2 = *((_DWORD *)this + 159) - *((_DWORD *)this + 157);
  v4 = *((_DWORD *)this + 158);
  v5 = 0;
  v15 = 0LL;
  v6 = v4 - *((_DWORD *)this + 156);
  if ( v6 >= 0 )
    v5 = v6;
  ...
  if ( v10
    && (v11 = CAccent::_UpdateSolidFill(this, v10, *((unsigned int *)this + 74), &v15, LODWORD(FLOAT_1_0)),
        ...
        v11 < 0) )
  {
    MilInstrumentationCheckHR_MaybeFailFast(0x14u, 0LL, 0LL, v11, 0x277u);
  }
  else
  {
    v12 = *((_QWORD *)this + 42);
    if ( v12 )
    {
      updated = CAccent::_UpdateSolidFill(this, v12, *((unsigned int *)this + 78), &v15, *((_DWORD *)this + 100));
      v1 = updated;
      if ( updated < 0 )
        MilInstrumentationCheckHR_MaybeFailFast(0x14u, 0LL, 0LL, updated, 0x27Cu);
    }
  }
  return v1;
}
