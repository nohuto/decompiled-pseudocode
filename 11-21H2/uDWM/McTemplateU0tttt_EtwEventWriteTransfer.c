/*
 * XREFs of McTemplateU0tttt_EtwEventWriteTransfer @ 0x1800E0D54
 * Callers:
...
__int64 __fastcall McTemplateU0tttt_EtwEventWriteTransfer(__int64 a1, __int64 a2, __int64 a3, int a4, char a5, char a6)
{
  ...
  return McGenEventWrite_EtwEventWriteTransfer(
           ...
           (__int64)&UdwmSystemAnimation_DelayedArrangementStart,
           a3,
           5,
           (__int64)v7);
}
