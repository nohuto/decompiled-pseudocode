/*
 * XREFs of ?IsCursorChange@CWindowList@@UEAAJPEAUIDwmWindow@@@Z @ 0x18005ED80
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall CWindowList::IsCursorChange(CWindowList *this, struct IDwmWindow *a2)
{
  ...
  {
    MilInstrumentationCheckHR_MaybeFailFast(0x14u, 0LL, 0LL, SyncedWindowData, 0x1E64u);
  }
  else if ( v10 )
  {
    v6 = (*(__int64 (__fastcall **)(struct IDwmWindow *))(*(_QWORD *)a2 + 352LL))(a2);
    *((_BYTE *)v10 + 668) ^= (*((_BYTE *)v10 + 668) ^ (2 * v6)) & 2;
    v7 = (CVisual *)*((_QWORD *)v10 + 55);
    if ( v7 )
    {
      CVisual::SetIsCursor(v7, (*((_BYTE *)v10 + 668) & 2) != 0);
      v11 = &v10;
