/*
 * XREFs of ?UpdateEnableClearForRenderTargets@CDesktopManager@@QEAAXXZ @ 0x1800B15D8
 * Callers:
 ...
 *     ?ShouldClearRenderTargets@CWindowList@@QEBA_NXZ @ 0x180106760 (-ShouldClearRenderTargets@CWindowList@@QEBA_NXZ.c)
 */
...
void __fastcall CDesktopManager::UpdateEnableClearForRenderTargets(CDesktopManager *this)
{
  ...
  v9 = 0;
  v10 = 0;
  if ( (int)CDWMDisplaySet::GetAllDisplaysNoRef(*((_QWORD *)this + 17), (__int64)&v7) >= 0 )
  {
    ShouldClearRenderTargets = CWindowList::ShouldClearRenderTargets(*((CWindowList **)this + 52));
    if ( v10 )
    {
      v4 = v7;
      v5 = v10;
