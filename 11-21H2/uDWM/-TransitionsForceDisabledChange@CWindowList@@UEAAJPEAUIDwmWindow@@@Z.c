/*
 * XREFs of ?TransitionsForceDisabledChange@CWindowList@@UEAAJPEAUIDwmWindow@@@Z @ 0x1801069C0
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall CWindowList::TransitionsForceDisabledChange(CWindowList *this, struct IDwmWindow *a2)
{
  ...
  if ( SyncedWindowData >= 0 )
  {
    ...
    if ( v9 )
    {
      v7 = (*(__int64 (__fastcall **)(struct IDwmWindow *))(*(_QWORD *)a2 + 248LL))(a2);
      *((_BYTE *)v6 + 664) &= ~0x10u;
      *((_BYTE *)v6 + 664) |= 16 * (v7 & 1);
    }
  }
  else
  {
    MilInstrumentationCheckHR_MaybeFailFast(0x14u, 0LL, 0LL, SyncedWindowData, 0x18DDu);
  }
