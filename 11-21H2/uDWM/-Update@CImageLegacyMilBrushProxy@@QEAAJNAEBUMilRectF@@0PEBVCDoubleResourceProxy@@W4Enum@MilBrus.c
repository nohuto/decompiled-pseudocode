/*
 * XREFs of ?Update@CImageLegacyMilBrushProxy@@QEAAJNAEBUMilRectF@@0PEBVCDoubleResourceProxy@@W4Enum@MilBrushMappingMode@@2PEBVCRectResourceProxy@@3W44MilStretch@@W44MilTileMode@@W44MilHorizontalAlignment@@W44MilVerticalAlignment@@PEBVCBaseImageProxy@@@Z @ 0x18001B0D4
 * Callers:
        ...
        __int64 a14)
{
  ...
  if ( a5 )
    ...
    v19 = 0;
  return (*(__int64 (__fastcall **)(_QWORD, _QWORD, _QWORD, __int64, __int64, int, _DWORD, _DWORD, unsigned int, int, int, int, int, _DWORD, int, int, int))(**(_QWORD **)(v14 + 16) + 1024LL))(
           *(_QWORD *)(v14 + 16),
           *(unsigned int *)(v14 + 24),
           a6,
           a3,
