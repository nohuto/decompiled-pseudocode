/*
 * XREFs of ?RegisterWindowClass@CDesktopManager@@SAJPEBGP6A_JPEAUHWND__@@I_K_J@ZPEAG@Z @ 0x1800520A8
 * Callers:
        ...
        unsigned __int16 *a3)
{
  ...
  *a3 = v6;
  if ( !v6 )
  {
    ...
    if ( v5 >= 0 )
      v5 = -2003304445;
    MilInstrumentationCheckHR_MaybeFailFast(0x14u, &dword_18011A2C0, 1LL, v5, 0x8ACu);
  }
  if ( v5 != -2147023486 )
