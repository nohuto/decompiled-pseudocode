/*
 * XREFs of ??$make@UAnimatedTransitionVisualWrapper@implementation@Transitions@Udwm@winrt@@PEAVCTopLevelWindow3D@@@winrt@@YA?AUAnimatedTransitionVisualWrapper@Transitions@Udwm@0@$$QEAPEAVCTopLevelWindow3D@@@Z @ 0x18004497C
 * Callers:
