/*
 * XREFs of ??1StartDisplayCapture@WindowFrameLoggingTelemetry@@QEAA@XZ @ 0x1800CB868
 * Callers:
 ...
 *     _CProjectionBorderManager::StartDisplayCapture_::_1_::dtor$1 @ 0x1800CCBB1 (_CProjectionBorderManager--StartDisplayCapture_--_1_--dtor$1.c)
 ...
 *     _CProjectionBorderManager::StartVirtualMonitorCapture_::_1_::dtor$1 @ 0x1800CCE1D (_CProjectionBorderManager--StartVirtualMonitorCapture_--_1_--dtor$1.c)
 * Callees:
