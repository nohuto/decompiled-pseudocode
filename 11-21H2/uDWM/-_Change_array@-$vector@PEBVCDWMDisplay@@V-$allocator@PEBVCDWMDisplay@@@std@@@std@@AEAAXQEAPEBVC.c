/*
 * XREFs of ?_Change_array@?$vector@PEBVCDWMDisplay@@V?$allocator@PEBVCDWMDisplay@@@std@@@std@@AEAAXQEAPEBVCDWMDisplay@@_K1@Z @ 0x1800BA054
 * Callers:
...
__int64 __fastcall std::vector<CDWMDisplay const *>::_Change_array(__int64 a1, __int64 a2, __int64 a3, __int64 a4)
{
  void *v6; // rcx
  __int64 result; // rax
