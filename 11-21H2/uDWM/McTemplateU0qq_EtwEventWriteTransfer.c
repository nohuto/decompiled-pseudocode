/*
 * XREFs of McTemplateU0qq_EtwEventWriteTransfer @ 0x1800C172C
 * Callers:
...
__int64 __fastcall McTemplateU0qq_EtwEventWriteTransfer(__int64 a1, __int64 a2, __int64 a3, int a4)
{
  ...
  v10 = 0;
  v9 = 4;
  return McGenEventWrite_EtwEventWriteTransfer(Microsoft_Windows_Dwm_Udwm_Provider_Context, a2, a3, 3, (__int64)v5);
}
