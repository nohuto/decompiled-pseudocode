/*
 * XREFs of ?SetRepresentationType@CWindowIconic@@QEAAJW4IconicRepresentationType@@_N@Z @ 0x18004B790
 * Callers:
 ...
 *     ??0?$CTimeline@I@@QEAA@NIIW4InterpolationMode@@@Z @ 0x180101138 (--0-$CTimeline@I@@QEAA@NIIW4InterpolationMode@@@Z.c)
 */
  ...
  if ( a2 != v3 )
  {
    if ( a2 == 1 )
    {
      ...
      *(_QWORD *)(a1 + 64) = v9;
      ...
      {
        v4 = -2147024882;
        MilInstrumentationCheckHR_MaybeFailFast(0x14u, 0LL, 0LL, -2147024882, 0x2DBu);
        return v4;
      }
