/*
 * XREFs of ?UpdateRect@TransitionManager@implementation@Transitions@Udwm@winrt@@QEAAXAEBURect@Foundation@Windows@5@W4ShellTransition@345@@Z @ 0x1800FB548
 * Callers:
 *     ?UpdateRect@?$produce@UTransitionManager@implementation@Transitions@Udwm@winrt@@UITransitionManager@345@@impl@winrt@@UEAAHURect@Foundation@Windows@3@H@Z @ 0x1800FB4F0 (-UpdateRect@-$produce@UTransitionManager@implementation@Transitions@Udwm@winrt@@UITransitionMana.c)
 * Callees:
...
void __fastcall winrt::Udwm::Transitions::implementation::TransitionManager::UpdateRect(__int64 a1, float *a2, int a3)
{
  ...
  if ( v12 )
  {
    hstring_on_heap = (struct winrt::impl::hstring_header *)qword_180143240;
    if ( qword_180143240 )
    {
      if ( (*(_BYTE *)qword_180143240 & 1) != 0 )
        hstring_on_heap = winrt::impl::create_hstring_on_heap(
                            *(winrt::impl **)(qword_180143240 + 16),
                            (winrt::impl *)*(unsigned int *)(qword_180143240 + 4));
      else
        _InterlockedExchangeAdd((volatile signed __int32 *)(qword_180143240 + 24), 1u);
    }
    v18[0] = hstring_on_heap;
    *(double *)&v18[1] = *a2;
    v5 = (struct winrt::impl::hstring_header *)qword_180143238;
    if ( qword_180143238 )
    {
      if ( (*(_BYTE *)qword_180143238 & 1) != 0 )
        v5 = winrt::impl::create_hstring_on_heap(
               *(winrt::impl **)(qword_180143238 + 16),
               (winrt::impl *)*(unsigned int *)(qword_180143238 + 4));
      else
        _InterlockedExchangeAdd((volatile signed __int32 *)(qword_180143238 + 24), 1u);
    }
    v18[2] = v5;
    *(double *)&v18[3] = a2[1];
    v6 = a2[2] + *a2;
    v7 = (struct winrt::impl::hstring_header *)qword_180143250;
    if ( qword_180143250 )
    {
      if ( (*(_BYTE *)qword_180143250 & 1) != 0 )
        v7 = winrt::impl::create_hstring_on_heap(
               *(winrt::impl **)(qword_180143250 + 16),
               (winrt::impl *)*(unsigned int *)(qword_180143250 + 4));
      else
        _InterlockedExchangeAdd((volatile signed __int32 *)(qword_180143250 + 24), 1u);
    }
    v18[4] = v7;
    *(double *)&v18[5] = v6;
    v8 = a2[3] + a2[1];
    v9 = (struct winrt::impl::hstring_header *)qword_180143248;
    if ( qword_180143248 )
    {
      if ( (*(_BYTE *)qword_180143248 & 1) != 0 )
        v9 = winrt::impl::create_hstring_on_heap(
               *(winrt::impl **)(qword_180143248 + 16),
               (winrt::impl *)*(unsigned int *)(qword_180143248 + 4));
      else
        _InterlockedExchangeAdd((volatile signed __int32 *)(qword_180143248 + 24), 1u);
    }
    v18[6] = v9;
    *(double *)&v18[7] = v8;
