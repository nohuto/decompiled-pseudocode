/*
 * XREFs of ?_IsMultiMon@CDesktopManager@@AEBA_NXZ @ 0x180011448
 * Callers:
...
bool __fastcall CDesktopManager::_IsMultiMon(CDesktopManager *this)
{
  ...
  v1 = *((_DWORD *)this + 94);
  rc1.left = *((_DWORD *)this + 93);
  rc1.right = *((_DWORD *)this + 95) + rc1.left;
  v2 = *((_DWORD *)this + 96);
  rc1.top = v1;
  rc1.bottom = v1 + v2;
  return !EqualRect(&rc1, (const RECT *)((char *)this + 388));
}
