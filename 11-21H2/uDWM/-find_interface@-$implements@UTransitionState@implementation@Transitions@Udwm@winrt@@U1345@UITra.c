/*
 * XREFs of ?find_interface@?$implements@UTransitionState@implementation@Transitions@Udwm@winrt@@U1345@UITransitionStateNative@34@UITransitionStateNativePrivate@34@@winrt@@UEBAPEAXAEBUguid@2@@Z @ 0x180044380
 * Callers:
 *     <none>
 * Callees:
 *     <none>
        ...
        _QWORD *a2)
{
  ...
  {
    v6 = v2 + 16;
    return v6 & -(__int64)(v2 != 0);
  }
  v4 = *a2 - winrt::impl::guid_v<Udwm::Transitions::ITransitionStateNative>;
  if ( *a2 == winrt::impl::guid_v<Udwm::Transitions::ITransitionStateNative> )
    v4 = a2[1] + 0x3F004508A35FD080LL;
  if ( v4 )
  {
    v5 = *a2 - winrt::impl::guid_v<Udwm::Transitions::ITransitionStateNativePrivate>;
    if ( *a2 == winrt::impl::guid_v<Udwm::Transitions::ITransitionStateNativePrivate> )
      v5 = a2[1] - 0x1424D6F75F502F8ALL;
    if ( v5 )
      return 0LL;
    v6 = v2 + 8;
    return v6 & -(__int64)(v2 != 0);
