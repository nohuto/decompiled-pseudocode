/*
 * XREFs of ?GetCachedFeatureEnabledState@?$FeatureImpl@U__WilFeatureTraits_Feature_VTFrame@@@details@wil@@AEAA?ATwil_details_FeatureStateCache@@XZ @ 0x180057E00
 * Callers:
...
signed __int32 *__fastcall wil::details::FeatureImpl<__WilFeatureTraits_Feature_VTFrame>::GetCachedFeatureEnabledState(
        ...
        signed __int32 *a2)
{
  ...
  *a2 = *a1;
  if ( (v4 & 3) != 3 )
  {
    ...
    wil::details::FeatureImpl<__WilFeatureTraits_Feature_VTFrame>::GetCurrentFeatureEnabledState(a1, &v14, &v13);
    v7 = *a2;
    do
    {
      v8 = v7;
    ...
    if ( !v10 && wil::details::g_enabledStateManager )
    {
      ...
      if ( !v6
        || v6 != dword_180142E84
        || (v11 = 1, v12 = a1, !wil::details_abi::heap_buffer::push_back((void **)&xmmword_180142EB8, &v11, 0x10uLL)) )
      {
