/*
 * XREFs of ?OnMagnifierDestroy@CMagnifierControl@@AEAAJPEAUHWND__@@@Z @ 0x1800C7494
 * Callers:
...
__int64 __fastcall CMagnifierControl::OnMagnifierDestroy(CMagnifierControl *this, __int64 a2)
{
  ...
  v4 = 0;
  v11 = *((_QWORD *)CDesktopManager::s_pDesktopManagerInstance + 52);
  v10 = &v12;
  ...
  {
    v4 = -2147023728;
    MilInstrumentationCheckHR_MaybeFailFast(0x14u, &dword_180122BC0, 1LL, -2147023728, 0x290u);
  }
  return v4;
}
