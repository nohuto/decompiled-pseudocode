/*
 * XREFs of ?IsWallpaperViewExisted@?$consume_Udwm_Transitions_ITransitionState@UITransitionState@Transitions@Udwm@winrt@@@impl@winrt@@QEBA_NXZ @ 0x1800F4214
 * Callers:
...
char __fastcall winrt::impl::consume_Udwm_Transitions_ITransitionState<winrt::Udwm::Transitions::ITransitionState>::IsWallpaperViewExisted(
        __int64 *a1)
{
  __int64 v1; // rcx
  signed int v2; // eax
