/*
 * XREFs of ??$_Reallocate_grow_by@V_lambda_e1befb086ad3257e3f042a63030725f7_@@_KD@?$basic_string@DU?$char_traits@D@std@@V?$allocator@D@2@@std@@AEAAAEAV01@_KV_lambda_e1befb086ad3257e3f042a63030725f7_@@_KD@Z @ 0x1800F21E8
 * Callers:
        ...
        size_t a4)
{
  ...
  v7 = *((_QWORD *)Src + 3);
  v8 = v4 + a2;
  v9 = std::string::_Calculate_growth((__int64)Src, v4 + a2);
