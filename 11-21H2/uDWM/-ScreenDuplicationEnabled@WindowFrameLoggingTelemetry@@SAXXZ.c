/*
 * XREFs of ?ScreenDuplicationEnabled@WindowFrameLoggingTelemetry@@SAXXZ @ 0x1800CC390
 * Callers:
...
void __fastcall WindowFrameLoggingTelemetry::ScreenDuplicationEnabled(__int64 a1)
{
  ...
  if ( *v1 > 5u )
  {
    if ( tlgKeywordOn((__int64)v1, 0x200000000000LL) )
      tlgWriteTransfer_EtwEventWriteTransfer(v2, byte_18012086E, 0LL, 0LL, 2, (__int64)v3);
  }
}
