/*
 * XREFs of ?OnFlick@CContactManager@@QEAAJPEBUMILCMD_DWM_REDIRECTION_RENDERFLICK@@@Z @ 0x1800AB7DC
 * Callers:
...
__int64 __fastcall CContactManager::OnFlick(CContactManager *this, const struct MILCMD_DWM_REDIRECTION_RENDERFLICK *a2)
{
  ...
  if ( *((_DWORD *)a2 + 1) <= 0x14u )
  {
    ...
    *((_DWORD *)this + 80) = v8 + 1;
    ...
    {
      MilInstrumentationCheckHR_MaybeFailFast(0x14u, 0LL, 0LL, Touch, 0x33Eu);
    }
  }
  else
  {
