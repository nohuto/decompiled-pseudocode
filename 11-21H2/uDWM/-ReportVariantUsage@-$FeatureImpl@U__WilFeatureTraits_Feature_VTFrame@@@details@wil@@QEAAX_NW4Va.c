/*
 * XREFs of ?ReportVariantUsage@?$FeatureImpl@U__WilFeatureTraits_Feature_VTFrame@@@details@wil@@QEAAX_NW4Variant_VTFrame@@W4VariantReportingKind@3@_K@Z @ 0x1800E5D80
 * Callers:
...
void __fastcall wil::details::FeatureImpl<__WilFeatureTraits_Feature_VTFrame>::ReportVariantUsage(
        int *a1,
        unsigned __int8 a2,
        unsigned __int8 a3,
        int a4,
        unsigned __int64 a5)
{
  ...
  {
    v10 = *(_QWORD *)wil::details::FeatureImpl<__WilFeatureTraits_Feature_VTFrame>::GetCachedVariantState(
