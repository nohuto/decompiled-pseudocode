/*
 * XREFs of ?GetColorizationParameters@CWindowList@@AEAAXPEAUMILCMD_DWM_REDIRECTION_GETCOLORIZATIONPARAMETERS@@@Z @ 0x1801039A4
 * Callers:
        ...
        struct MILCMD_DWM_REDIRECTION_GETCOLORIZATIONPARAMETERS *a2)
{
  ...
  v3 = *(__m128i *)((char *)CDesktopManager::s_pDesktopManagerInstance + 476);
  v4 = _mm_srli_si128(*(__m128i *)((char *)CDesktopManager::s_pDesktopManagerInstance + 460), 8).m128i_u64[0];
  *(_QWORD *)((char *)a2 + 4) = *(_QWORD *)((char *)CDesktopManager::s_pDesktopManagerInstance + 460);
