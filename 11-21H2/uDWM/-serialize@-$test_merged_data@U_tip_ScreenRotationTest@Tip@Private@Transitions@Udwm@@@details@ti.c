/*
 * XREFs of ?serialize@?$test_merged_data@U_tip_ScreenRotationTest@Tip@Private@Transitions@Udwm@@@details@tip@@EEAAXAEAVJSONOutputArchive@cereal@@W4serialize_options@23@@Z @ 0x1800F6B40
 * Callers:
 *     <none>
 * Callees:
...
void __fastcall tip::details::test_merged_data<Udwm::Transitions::Private::Tip::_tip_ScreenRotationTest>::serialize(
        __int64 a1,
        __int64 a2,
        char a3)
{
  ...
  if ( (a3 & 1) != 0 )
  {
    ...
    *(_QWORD *)(v6 + 408) = "test";
    ...
    Udwm::Transitions::Private::Tip::_tip_ScreenRotationTest::serialize<cereal::JSONOutputArchive>(
      (a1 + 144) & -(__int64)(a1 != 0),
