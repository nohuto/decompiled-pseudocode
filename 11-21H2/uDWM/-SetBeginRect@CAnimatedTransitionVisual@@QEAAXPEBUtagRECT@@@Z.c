/*
 * XREFs of ?SetBeginRect@CAnimatedTransitionVisual@@QEAAXPEBUtagRECT@@@Z @ 0x180045F18
 * Callers:
  ...
  if ( !LOBYTE(this[121].x) )
  {
    ...
    *(_OWORD *)&this[107].x = v3;
    ...
    if ( HIBYTE(this[121].y) )
    {
      ...
      {
        v5 = this[107];
        v4 = **(struct tagPOINT ***)&this[7];
        CVisual::SetOffset(v4, &v5);
        (*(void (__fastcall **)(struct tagPOINT *))(*(_QWORD *)v4 + 64LL))(v4);
      }
    }
  }
}
