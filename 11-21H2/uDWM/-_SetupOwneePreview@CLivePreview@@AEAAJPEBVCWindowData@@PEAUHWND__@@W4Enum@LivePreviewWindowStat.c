/*
 * XREFs of ?_SetupOwneePreview@CLivePreview@@AEAAJPEBVCWindowData@@PEAUHWND__@@W4Enum@LivePreviewWindowState@@@Z @ 0x1800C45E0
 * Callers:
...
__int64 __fastcall CLivePreview::_SetupOwneePreview(__int64 a1, __int64 a2, __int64 a3, __int64 a4)
{
  ...
  if ( *(_DWORD *)(a2 + 632) )
  {
    while ( 1 )
    {
      ...
      if ( (*(_BYTE *)(v10 + 666) & 0x40) == 0
        && (*(_BYTE *)(v10 + 670) & 8) == 0
        && ((*(_BYTE *)(v10 + 664) & 1) != 0 || *(_QWORD *)(v10 + 480)) )
      {
        LOBYTE(v13) = 1;
        LOBYTE(a4) = 1;
