/*
 * XREFs of ?End@CAnimationClock@@QEAAJXZ @ 0x1800A1ECC
 * Callers:
...
__int64 __fastcall CAnimationClock::End(CAnimationClock *this)
{
  ...
  unsigned int v3; // edi
  int v4; // esi
  struct _RTL_CRITICAL_SECTION *v6; // [rsp+20h] [rbp-178h] BYREF
  ...
  if ( *((_DWORD *)this + 20) == 1 )
  {
    ...
    if ( v4 >= 0 )
    {
      ...
      if ( (Microsoft_Windows_Dwm_UdwmEnableBits & 1) != 0 )
        McTemplateU0ji_EtwEventWriteTransfer(v2, &UdwmAnimationClock_End, (char *)this + 120, v4, v6);
