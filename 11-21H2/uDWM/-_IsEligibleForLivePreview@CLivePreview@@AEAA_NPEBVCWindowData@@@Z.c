/*
 * XREFs of ?_IsEligibleForLivePreview@CLivePreview@@AEAA_NPEBVCWindowData@@@Z @ 0x18006983A
 * Callers:
  ...
  if ( (*((_BYTE *)a2 + 666) & 0x40) == 0 )
  {
    if ( a2[55] )
    {
        ...
        && (*(_DWORD *)(v4 + 116) & 0x20000000) == 0 )
      {
        ...
        {
          v5 = *(HWND *)(v4 + 40);
          if ( v5 != GetDesktopWindow() && v5 != *((HWND *)CDesktopManager::s_pDesktopManagerInstance + 75) )
          {
            CTopLevelWindow::GetLivePreviewWindowRect(a2[55], &rcSrc1, 1);
            v6 = *(_QWORD *)((char *)CDesktopManager::s_pDesktopManagerInstance + 372);
            v7 = _mm_srli_si128(*(__m128i *)((char *)CDesktopManager::s_pDesktopManagerInstance + 372), 8).m128i_u64[0];
            rcSrc2.left = *(_OWORD *)((char *)CDesktopManager::s_pDesktopManagerInstance + 372);
