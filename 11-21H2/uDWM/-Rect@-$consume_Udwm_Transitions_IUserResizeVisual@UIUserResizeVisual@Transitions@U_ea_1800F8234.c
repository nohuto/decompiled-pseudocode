/*
 * XREFs of ?Rect@?$consume_Udwm_Transitions_IUserResizeVisual@UIUserResizeVisual@Transitions@Udwm@winrt@@@impl@winrt@@QEBAXAEBU0Foundation@Windows@3@@Z @ 0x1800F8234
 * Callers:
