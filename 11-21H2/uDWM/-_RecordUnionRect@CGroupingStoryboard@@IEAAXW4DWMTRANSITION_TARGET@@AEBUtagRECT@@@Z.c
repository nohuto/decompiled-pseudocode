/*
 * XREFs of ?_RecordUnionRect@CGroupingStoryboard@@IEAAXW4DWMTRANSITION_TARGET@@AEBUtagRECT@@@Z @ 0x1800DB654
 * Callers:
...
char *__fastcall CGroupingStoryboard::_RecordUnionRect(_QWORD *a1, __int64 a2, RECT *a3)
{
  ...
  return std::vector<tagRECT>::emplace_back<tagRECT const &>((_QWORD *)(*v6 + v7 + 24), a3);
}
