/*
 * XREFs of ?UpdateOwnedWindowVisualTreeRootVisual@CSecondaryWindowRepresentation@@AEAAJXZ @ 0x1800193C0
 * Callers:
...
{
  CBaseObject *v1; // r14
  struct CBaseGeometryProxy *v2; // rbp
  ...
  int v16; // eax
  int v17; // eax
  struct CDrawGeometryInstruction *v18; // [rsp+60h] [rbp+8h] BYREF
  struct CBaseGeometryProxy *v19; // [rsp+68h] [rbp+10h] BYREF
...
LABEL_7:
          ...
          if ( !v11 )
          {
            ...
            MilInstrumentationCheckHR_MaybeFailFast(0x14u, 0LL, 0LL, -2147024882, 0x103u);
            return v5;
          }
          *(_DWORD *)(v11 + 8) = 1;
          ...
          *(_QWORD *)(v11 + 16) = v10;
          ...
          v13 = CRenderDataVisual::AddInstruction(
                  *((CRenderDataVisual **)this + 7),
                  (struct CRenderDataInstruction *)v11);
          v5 = v13;
          if ( v13 < 0 )
            MilInstrumentationCheckHR_MaybeFailFast(0x14u, 0LL, 0LL, v13, 0x106u);
  ...
  if ( v15 >= 0 )
  {
    ...
    if ( v16 < 0 )
    {
      MilInstrumentationCheckHR_MaybeFailFast(0x14u, 0LL, 0LL, v16, 0xF7u);
      v1 = v18;
    }
    else
    {
      ...
      v5 = v17;
      if ( v17 < 0 )
        MilInstrumentationCheckHR_MaybeFailFast(0x14u, 0LL, 0LL, v17, 0xF9u);
    }
LABEL_14:
    if ( v1 )
  ...
  MilInstrumentationCheckHR_MaybeFailFast(0x14u, 0LL, 0LL, v15, 0xF3u);
  v2 = v19;
LABEL_16:
  if ( v2 )
