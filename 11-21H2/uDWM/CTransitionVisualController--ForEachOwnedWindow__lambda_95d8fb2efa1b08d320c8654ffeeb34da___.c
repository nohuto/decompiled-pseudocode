/*
 * XREFs of CTransitionVisualController::ForEachOwnedWindow__lambda_95d8fb2efa1b08d320c8654ffeeb34da___ @ 0x1800E9968
 * Callers:
  ...
  if ( !a3 || (*(_DWORD *)(a1 + 672) & 0x10000000) != 0 )
  {
    ...
    if ( !v6 || (*(_BYTE *)(v6 + 248) & 0x18) == 0 )
    {
      for ( i = 0LL; (unsigned int)i < *(_DWORD *)(a1 + 632); i = (unsigned int)(i + 1) )
      {
        ...
        {
          v9 = lambda_95d8fb2efa1b08d320c8654ffeeb34da_::operator()(a1, *(_QWORD *)(*(_QWORD *)(a1 + 608) + 8 * i));
          v3 = v9;
          if ( v9 >= 0 )
