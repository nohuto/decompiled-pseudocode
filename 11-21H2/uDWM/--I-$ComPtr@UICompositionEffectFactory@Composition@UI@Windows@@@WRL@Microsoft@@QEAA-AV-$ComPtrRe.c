/*
 * XREFs of ??I?$ComPtr@UICompositionEffectFactory@Composition@UI@Windows@@@WRL@Microsoft@@QEAA?AV?$ComPtrRef@V?$ComPtr@UICompositionEffectFactory@Composition@UI@Windows@@@WRL@Microsoft@@@Details@12@XZ @ 0x18003B78C
 * Callers:
...
_QWORD *__fastcall Microsoft::WRL::ComPtr<Windows::UI::Composition::ICompositionEffectFactory>::operator&(
        __int64 a1,
        _QWORD *a2)
{
  *a2 = a1;
