/*
 * XREFs of ?OnWindowDataDestroyed@CDisplayAnimatedVisual@@QEAAXPEAVCWindowData@@@Z @ 0x18005B3D0
 * Callers:
...
void __fastcall CDisplayAnimatedVisual::OnWindowDataDestroyed(CDisplayAnimatedVisual *this, struct CWindowData *a2)
{
  ...
  if ( a2 )
  {
    ...
    {
      v6 = (void *)std::_Tree_val<std::_Tree_simple_types<std::pair<winrt::hstring const,double>>>::_Extract(v4);
    ...
    {
      v7 = (void *)std::_Tree_val<std::_Tree_simple_types<std::pair<winrt::hstring const,double>>>::_Extract(v5);
      std::_Deallocate<16,0>(v7, 0x28uLL);
    }
  }
}
