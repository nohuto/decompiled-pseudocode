/*
 * XREFs of _CWindowList::StopAndSetDisplayAnimatedVisual_::_1_::dtor$0 @ 0x180064DC0
 * Callers:
 *     <none>
 * Callees:
 *     <none>
...
unsigned int __fastcall CWindowList::StopAndSetDisplayAnimatedVisual_::_1_::dtor_0(__int64 a1, __int64 a2)
{
