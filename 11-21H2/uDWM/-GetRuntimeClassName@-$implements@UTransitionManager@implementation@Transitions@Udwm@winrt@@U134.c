/*
 * XREFs of ?GetRuntimeClassName@?$implements@UTransitionManager@implementation@Transitions@Udwm@winrt@@U1345@UIRotationTransitionManager@Private@345@UIWindowStateTransitionManager@7345@UITransitionManagerNativePrivate@34@@winrt@@UEAAJPEAPEAUHSTRING__@@@Z @ 0x1800FA200
 * Callers:
 *     <none>
 * Callees:
 *     <none>
