/*
 * XREFs of ?ScalingCompatCalulationInvoked_@CScalingCompatTelemetry@ScalingCompatTelemetry@@QEBAXW4AppType@2@II@Z @ 0x180109E4C
 * Callers:
        ...
        int a4)
{
  ...
  if ( *v8 > 5u )
  {
    ...
    v17 = 4LL;
    v15 = 4LL;
    LODWORD(v7) = tlgWriteTransfer_EventWriteTransfer(
                    (__int64)v8,
                    (unsigned __int8 *)dword_180120FD2,
                    0LL,
                    0LL,
                    5u,
                    &v13);
