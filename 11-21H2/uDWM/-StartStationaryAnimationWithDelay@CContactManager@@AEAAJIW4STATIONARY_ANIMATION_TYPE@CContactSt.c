/*
 * XREFs of ?StartStationaryAnimationWithDelay@CContactManager@@AEAAJIW4STATIONARY_ANIMATION_TYPE@CContactStationaryVisual@@PEBUtagPOINT@@PEBUtagRECT@@_K_N@Z @ 0x1800ADC3C
 * Callers:
...
LABEL_8:
  ...
  if ( (int)v20 + 1 >= (unsigned int)v20 )
  {
    ...
    {
      v24 = DynArrayImpl<0>::AddMultipleAndSet(a1 + 120, 0x18u, 1, &v26);
      if ( v24 < 0 )
