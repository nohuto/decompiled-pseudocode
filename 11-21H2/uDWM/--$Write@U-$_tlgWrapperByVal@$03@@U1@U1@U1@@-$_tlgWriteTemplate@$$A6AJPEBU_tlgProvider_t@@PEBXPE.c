/*
 * XREFs of ??$Write@U?$_tlgWrapperByVal@$03@@U1@U1@U1@@?$_tlgWriteTemplate@$$A6AJPEBU_tlgProvider_t@@PEBXPEBU_GUID@@2IPEAU_EVENT_DATA_DESCRIPTOR@@@Z$1?_tlgWriteTransfer_EtwEventWriteTransfer@@YAJ0122I3@ZPEBU2@PEBU2@@@SAJPEBU_tlgProvider_t@@PEBXPEBU_GUID@@2AEBU?$_tlgWrapperByVal@$03@@333@Z @ 0x1800B6230
 * Callers:
        ...
        __int64 a8)
{
  ...
  v13 = 4LL;
  v11 = 4LL;
  return tlgWriteTransfer_EtwEventWriteTransfer((__int64)&dword_1801418A0, a2, 0LL, 0LL, 6, (__int64)v9);
}
