/*
 * XREFs of ?GetCachedFeatureEnabledState@?$FeatureImpl@U__WilFeatureTraits_Feature_AUTest@@@details@wil@@AEAA?ATwil_details_FeatureStateCache@@XZ @ 0x1800B08D4
 * Callers:
        ...
        signed __int32 *a2)
{
  ...
  *a2 = *a1;
  if ( (v4 & 3) != 3 )
  {
    ...
    wil::details::FeatureImpl<__WilFeatureTraits_Feature_AUTest>::GetCurrentFeatureEnabledState(a1, &v14, &v13);
    v6 = *a2;
    do
    {
      v7 = v6;
