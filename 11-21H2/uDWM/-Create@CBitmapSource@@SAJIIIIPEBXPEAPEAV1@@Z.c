/*
 * XREFs of ?Create@CBitmapSource@@SAJIIIIPEBXPEAPEAV1@@Z @ 0x180003F50
 * Callers:
        ...
        struct CBitmapSource **a6)
{
  ...
  else
  {
    ...
    {
      v14 = -2147024890;
      MilInstrumentationCheckHR_MaybeFailFast(0x14u, 0LL, 0, -2147024890, 0xDCu, 0LL);
      goto LABEL_7;
    }
    if ( a3 == a1 && a4 == a2 )
    {
LABEL_6:
    ...
    if ( v12 >= 0 )
    {
      ...
      {
        v14 = -2147024890;
        MilInstrumentationCheckHR_MaybeFailFast(0x14u, 0LL, 0, -2147024890, 0xE4u, 0LL);
        goto LABEL_7;
      }
...
LABEL_16:
  v17 = v12;
LABEL_29:
  MilInstrumentationCheckHR_MaybeFailFast(0x14u, 0LL, 0, v17, v18, 0LL);
LABEL_7:
  if ( v19 )
