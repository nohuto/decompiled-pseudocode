/*
 * XREFs of ?s_IsCloseEnoughToReuse@CThumbnailVisual@@CA_NPEBUtagRECT@@0@Z @ 0x1800E3910
 * Callers:
 ...
 * Callees:
 *     ?s_IsCloseEnoughToReuse@CThumbnailVisual@@CA_NNN@Z @ 0x1800E38D8 (-s_IsCloseEnoughToReuse@CThumbnailVisual@@CA_NNN@Z.c)
 */
