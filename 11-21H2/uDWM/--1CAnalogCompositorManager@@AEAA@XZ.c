/*
 * XREFs of ??1CAnalogCompositorManager@@AEAA@XZ @ 0x18005FCC0
 * Callers:
 *     _CAnalogCompositorManager::GetInstance_::_2_::_dynamic_atexit_destructor_for__singletonAnalogCompositorManager__ @ 0x180066500 (_CAnalogCompositorManager--GetInstance_--_2_--_dynamic_atexit_destructor_for__singletonAnalogCom.c)
 * Callees:
 ...
 *     ??1HolographicDriverDetectedWatcher@Mirage@Windows@@QEAA@XZ @ 0x18009C500 (--1HolographicDriverDetectedWatcher@Mirage@Windows@@QEAA@XZ.c)
 */
