/*
 * XREFs of ??$_Lower_bound_duplicate@Uhstring@winrt@@@?$_Tree@V?$_Tmap_traits@Uhstring@winrt@@NU?$less@Uhstring@winrt@@@std@@V?$allocator@U?$pair@$$CBUhstring@winrt@@N@std@@@4@$0A@@std@@@std@@IEBA_NQEAU?$_Tree_node@U?$pair@$$CBUhstring@winrt@@N@std@@PEAX@1@AEBUhstring@winrt@@@Z @ 0x1800F9160
 * Callers:
        ...
        __int64 a2)
{
  ...
  if ( !*(_BYTE *)(a2 + 25) )
  {
    v3 = *(__m128i *)winrt::hstring::operator std::basic_string_view<unsigned short>(a2 + 32, v7);
    v5 = (char **)winrt::hstring::operator std::basic_string_view<unsigned short>(v4, v8);
    return (int)std::_Traits_compare<std::char_traits<unsigned short>>(
                  *v5,
                  _mm_srli_si128(*(__m128i *)v5, 8).m128i_u64[0],
                  (char *)v3.m128i_i64[0],
                  _mm_srli_si128(v3, 8).m128i_u64[0]) >= 0;
  }
  return v2;
}
