/*
 * XREFs of ??$CreateProxy@VCRedirectVisualProxy@@@CCompositor@@IEAAJPEAPEAVCRedirectVisualProxy@@@Z @ 0x1800A8C40
 * Callers:
  ...
  *a2 = 0LL;
  ...
  if ( v4 )
  {
    ...
    *(_QWORD *)v4 = &CRedirectVisualProxy::`vftable';
    ...
    v6 = CResource::Create(0x1Cu, *(_QWORD *)(a1 + 16), (CBaseObject **)(v4 + 16));
    v7 = v6;
    if ( v6 >= 0 )
    {
      *a2 = v5;
