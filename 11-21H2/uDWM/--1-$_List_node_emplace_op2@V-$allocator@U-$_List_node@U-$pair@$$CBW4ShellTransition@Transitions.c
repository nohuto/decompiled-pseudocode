/*
 * XREFs of ??1?$_List_node_emplace_op2@V?$allocator@U?$_List_node@U?$pair@$$CBW4ShellTransition@Transitions@Udwm@winrt@@UITransitionHandler@234@@std@@PEAX@std@@@std@@@std@@QEAA@XZ @ 0x18005B364
 * Callers:
        ...
        __int64 a1)
{
  ...
  if ( v2 )
  {
    if ( *(_QWORD *)(v2 + 24) )
    {
      winrt::Windows::Foundation::IUnknown::unconditional_release_ref((winrt::Windows::Foundation::IUnknown *)(v2 + 24));
      v2 = *(_QWORD *)(a1 + 8);
    }
    if ( v2 )
      std::_Deallocate<16,0>((void *)v2, 0x20uLL);
  }
}
