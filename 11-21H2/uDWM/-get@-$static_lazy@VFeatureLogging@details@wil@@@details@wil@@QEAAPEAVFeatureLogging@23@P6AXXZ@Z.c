/*
 * XREFs of ?get@?$static_lazy@VFeatureLogging@details@wil@@@details@wil@@QEAAPEAVFeatureLogging@23@P6AXXZ@Z @ 0x180010858
 * Callers:
...
__int64 *__fastcall wil::details::static_lazy<wil::details::FeatureLogging>::get(__int64 a1, void (__cdecl *a2)())
{
    ...
    && (_DWORD)v8 )
  {
    ...
    v9 = &qword_180142FE0;
    qword_180142FE0 = (__int64)&WindowFrameLogging::`vftable';
    qword_180142FF8 = (__int64)&`wil::details::FeatureLogging::StaticHandle::StaticHandle'::`2'::__hInner;
    atexit(a2);
    v7 = 0;
