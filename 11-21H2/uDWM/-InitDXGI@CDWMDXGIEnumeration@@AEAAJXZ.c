/*
 * XREFs of ?InitDXGI@CDWMDXGIEnumeration@@AEAAJXZ @ 0x18003CB78
 * Callers:
...
LABEL_46:
    v14 = v3;
LABEL_50:
    MilInstrumentationCheckHR_MaybeFailFast(0x14u, &dword_18011A384, 1LL, v14, v16);
LABEL_30:
    if ( ppFactory )
  ...
  while ( (*(unsigned int (__fastcall **)(void *, _QWORD, __int64 *))(*(_QWORD *)ppFactory + 96LL))(ppFactory, v2, &v20) != -2005270526 )
  {
    ...
    if ( v6 + 1 < v6 )
    {
      ...
      v15 = 181;
LABEL_48:
      MilInstrumentationCheckHR_MaybeFailFast(0x14u, 0LL, 0LL, v4, v15);
      v16 = 286;
LABEL_49:
      v14 = v4;
      goto LABEL_50;
    ...
    {
      v4 = DynArrayImpl<0>::AddMultipleAndSet((__int64)this + 56, 8u, 1, v21);
      if ( v4 < 0 )
      {
        v15 = 192;
        goto LABEL_48;
  ...
  *((_QWORD *)this + 5) = v17;
  if ( v10 )
  {
    (*(void (__fastcall **)(__int64, __int64, __int64))(*(_QWORD *)v10 + 8LL))(v10, v5, v9);
    v8 = v23;
    v9 = v24;
    v10 = v17;
  }
  ...
  *((_QWORD *)this + 2) = ppFactory;
  if ( v12 )
  {
    (*(void (__fastcall **)(void *, __int64, __int64, __int64))(*(_QWORD *)v12 + 8LL))(v12, v11, v9, v10);
    goto LABEL_30;
  }
LABEL_33:
  if ( v8 )
  {
    (*(void (__fastcall **)(__int64, __int64, __int64, __int64))(*(_QWORD *)v8 + 16LL))(v8, v11, v9, v10);
    v9 = v24;
    v10 = v17;
    v11 = v18;
  }
  if ( v9 )
  {
    (*(void (__fastcall **)(__int64, __int64))(*(_QWORD *)v9 + 16LL))(v9, v11);
    v10 = v17;
    v11 = v18;
  }
  if ( v10 )
  {
    (*(void (__fastcall **)(__int64, __int64))(*(_QWORD *)v10 + 16LL))(v10, v11);
    v11 = v18;
  }
  if ( v11 )
