/*
 * XREFs of ?StartEngage@CIndirectTouchVisual@@QEAAJPEBUtagPOINT@@W4DWM_SHOWCONTACT@@@Z @ 0x1800C0E70
 * Callers:
...
__int64 __fastcall CIndirectTouchVisual::StartEngage(__int64 a1)
{
  ...
  *((_DWORD *)v2 + 89) = v3;
  ...
  if ( v5 )
  {
    CTimelineBase::CTimelineBase(v5, *(float *)(a1 + 328), (float)*(int *)(a1 + 352), 14.0, 0);
