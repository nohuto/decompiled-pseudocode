/*
 * XREFs of ?ForceConnectClientNode@CWindowList@@UEAAJPEAUIDwmWindow@@@Z @ 0x1800118E0
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall CWindowList::ForceConnectClientNode(CWindowList *this, struct IDwmWindow *a2)
{
  ...
  {
    MilInstrumentationCheckHR_MaybeFailFast(0x14u, 0LL, 0LL, SyncedWindowData, 0x190Fu);
  }
  else
  {
    v6 = v12;
    if ( v12 )
    {
      ...
      *((_BYTE *)v6 + 668) &= ~0x20u;
      *((_BYTE *)v6 + 668) |= 32 * (v7 & 1);
      v8 = CWindowData::EnsureClientAreaVisualProxy(v6);
      v5 = v8;
      if ( v8 < 0 )
      {
        MilInstrumentationCheckHR_MaybeFailFast(0x14u, 0LL, 0LL, v8, 0x1914u);
      }
      else
      {
        v9 = (CTopLevelWindow *)*((_QWORD *)v6 + 55);
        if ( v9 )
        {
          v11 = CTopLevelWindow::EnsureClientAreaNode(v9);
          v5 = v11;
          if ( v11 < 0 )
            MilInstrumentationCheckHR_MaybeFailFast(0x14u, 0LL, 0LL, v11, 0x1918u);
        }
      }
    }
  }
