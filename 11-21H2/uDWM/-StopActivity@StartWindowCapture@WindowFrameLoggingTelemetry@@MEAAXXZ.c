/*
 * XREFs of ?StopActivity@StartWindowCapture@WindowFrameLoggingTelemetry@@MEAAXXZ @ 0x1800CD490
 * Callers:
 *     <none>
 * Callees:
...
void __fastcall WindowFrameLoggingTelemetry::StartWindowCapture::StopActivity(
        WindowFrameLoggingTelemetry::StartWindowCapture *this)
{
  ...
  if ( v3 >= 0 || v3 != v1[22] || (v4 = v1 + 20, v1 == (int *)-80LL) )
  {
    ...
    v12 = wil::details::static_lazy<WindowFrameLogging>::get(
            v11,
            _lambda_e6d4de8c865c86d40bfbebb968f8a12c_::_lambda_invoker_cdecl_);
    v13 = (_DWORD *)v12[1];
    if ( *v13 > 5u && tlgKeywordOn(v12[1], 0x200000000000LL) )
    {
  ...
  else
  {
    ...
    if ( *v6 > 5u && tlgKeywordOn((__int64)v6, 0x200000000000LL) )
    {
      v9 = (wchar_t *)*((_QWORD *)v4 + 15);
      v10 = *((_QWORD *)this + 6);
      v29[0] = 0LL;
      v20 = v9;
      v21 = (const unsigned __int16 *)*((_QWORD *)v4 + 14);
      v30 = v4[26];
      v22 = (wchar_t *)*((_QWORD *)v4 + 12);
      v23 = (const unsigned __int16 *)*((_QWORD *)v4 + 11);
      v31 = v4[20];
      v24 = (const unsigned __int16 *)*((_QWORD *)v4 + 9);
      LODWORD(v32) = v4[8];
      v25 = (wchar_t *)*((_QWORD *)v4 + 3);
      v33 = *v4;
  ...
  if ( *((_DWORD *)this + 8) )
    wil::details::ThreadFailureCallbackHolder::StopWatching((WindowFrameLoggingTelemetry::StartWindowCapture *)((char *)this + 8));
}
