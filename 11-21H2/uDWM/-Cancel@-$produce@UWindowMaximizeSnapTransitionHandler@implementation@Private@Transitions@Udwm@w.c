/*
 * XREFs of ?Cancel@?$produce@UWindowMaximizeSnapTransitionHandler@implementation@Private@Transitions@Udwm@winrt@@UITransitionHandler@456@@impl@winrt@@UEAAHXZ @ 0x1800F7560
 * Callers:
 *     <none>
 * Callees:
