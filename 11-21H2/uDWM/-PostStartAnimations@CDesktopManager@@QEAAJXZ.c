/*
 * XREFs of ?PostStartAnimations@CDesktopManager@@QEAAJXZ @ 0x1800481B0
 * Callers:
...
__int64 __fastcall CDesktopManager::PostStartAnimations(CDesktopManager *this)
{
  ...
  *((_BYTE *)this + 19) = 0;
  SetLastError(0);
  if ( !PostThreadMessageW(*((_DWORD *)this + 146), 0x400u, 0LL, 0LL) )
  {
    ...
    if ( v2 >= 0 )
      v2 = -2003304445;
    MilInstrumentationCheckHR_MaybeFailFast(0x14u, 0LL, 0LL, v2, 0x75Au);
  }
