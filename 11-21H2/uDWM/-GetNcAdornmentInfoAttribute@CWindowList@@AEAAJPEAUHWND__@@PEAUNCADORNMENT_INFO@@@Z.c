/*
 * XREFs of ?GetNcAdornmentInfoAttribute@CWindowList@@AEAAJPEAUHWND__@@PEAUNCADORNMENT_INFO@@@Z @ 0x180103C48
 * Callers:
...
__int64 __fastcall CWindowList::GetNcAdornmentInfoAttribute(CWindowList *this, HWND a2, struct NCADORNMENT_INFO *a3)
{
  ...
  if ( SyncedWindowDataByHwnd >= 0 )
  {
    if ( v9 )
    {
      v6 = (CTopLevelWindow *)*((_QWORD *)v9 + 55);
      if ( v6 && (v7 = *((_BYTE *)v9 + 664), (v7 & 8) != 0) && (v7 & 1) != 0 )
  ...
  {
    MilInstrumentationCheckHR_MaybeFailFast(0x14u, 0LL, 0LL, SyncedWindowDataByHwnd, 0x150Bu);
  }
  return v5;
}
