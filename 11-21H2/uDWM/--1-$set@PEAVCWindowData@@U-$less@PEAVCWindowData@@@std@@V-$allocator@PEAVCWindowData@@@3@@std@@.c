/*
 * XREFs of ??1?$set@PEAVCWindowData@@U?$less@PEAVCWindowData@@@std@@V?$allocator@PEAVCWindowData@@@3@@std@@QEAA@XZ @ 0x1800B452C
 * Callers:
 *     _CDisplayAnimatedVisual::CDisplayAnimatedVisual_::_1_::dtor$2 @ 0x1800661B9 (_CDisplayAnimatedVisual--CDisplayAnimatedVisual_--_1_--dtor$2.c)
 * Callees:
