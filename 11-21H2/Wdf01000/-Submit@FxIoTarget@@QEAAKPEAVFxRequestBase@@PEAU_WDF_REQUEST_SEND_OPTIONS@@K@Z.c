/*
 * XREFs of ?Submit@FxIoTarget@@QEAAKPEAVFxRequestBase@@PEAU_WDF_REQUEST_SEND_OPTIONS@@K@Z @ 0x1C007462C
 * Callers:
        ...
        int Flags)
{
  ...
  v8 = FxIoTarget::SubmitLocked(this, (unsigned __int64)Request, Options, Flags);
