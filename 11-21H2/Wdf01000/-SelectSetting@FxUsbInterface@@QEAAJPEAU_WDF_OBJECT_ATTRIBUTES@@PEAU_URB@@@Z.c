/*
 * XREFs of ?SelectSetting@FxUsbInterface@@QEAAJPEAU_WDF_OBJECT_ATTRIBUTES@@PEAU_URB@@@Z @ 0x1C007EA1C
 * Callers:
    ...
    if ( (_BYTE)v9 )
    {
      while ( 1 )
      {
        ...
        *(_QWORD *)pendHead = 64LL;
        ...
        v19 = FxObject::Commit(v18, (_FX_DRIVER_GLOBALS *)PipesAttributes, 0LL, this, 1u);
        v8 = v19;
        if ( v19 < 0 )
        {
          v20 = 20;
