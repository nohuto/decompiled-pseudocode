/*
 * XREFs of VfEvtIoDeviceControl @ 0x1C00C64E0
 * Callers:
 *     <none>
 * Callees:
        ...
        unsigned int IoControlCode)
{
  ...
  v11 = (void (__fastcall *)(WDFQUEUE__ *, unsigned __int64, unsigned __int64, unsigned __int64, unsigned int))*((_QWORD *)TypedContext + 6);
  if ( v11 )
  {
    PPObject = 0LL;
