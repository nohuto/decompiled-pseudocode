/*
 * XREFs of imp_WdfUsbTargetPipeConfigContinuousReader @ 0x1C0075F20
 * Callers:
 *     <none>
 * Callees:
 ...
 *     ?IsType@FxUsbPipe@@QEAAEW4_WDF_USB_PIPE_TYPE@@@Z @ 0x1C0038FD8 (-IsType@FxUsbPipe@@QEAAEW4_WDF_USB_PIPE_TYPE@@@Z.c)
