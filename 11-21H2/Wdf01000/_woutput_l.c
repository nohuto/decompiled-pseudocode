/*
 * XREFs of _woutput_l @ 0x1C00359CC
 * Callers:
 ...
 *     _get_printf_count_output @ 0x1C003643C (_get_printf_count_output.c)
              ...
              if ( v10 != 83 )
              {
                if ( v10 != 88 )
                {
                  if ( v10 == 90 )
                  {
                    ...
                    v59 = (char *)(v8 + 4);
                    if ( v18 && (p_buffer = ($B4FF2100EA110D8CD0B9C89F852FB035 *)*((_QWORD *)v18 + 1)) != 0LL )
                    {
                      v19 = *v18;
...
LABEL_116:
                        v35 = v57 - v12 - v34;
                        if ( (v5 & 0xC) == 0 )
                          write_multi_char(0x20u, v35, v9, &charsout);
                        ...
                        write_string((wchar_t *)p_buffer, v12, v36, &charsout);
LABEL_130:
                        v11 = charsout;
LABEL_131:
                        if ( v11 < 0 || (v5 & 4) == 0 )
...
LABEL_44:
                  ...
                  if ( (v5 & 0x20) != 0 )
                  {
                    tempchar[0] = v20;
                    tempchar[1] = 0;
                    v21 = mbtowc((wchar_t *)&buffer, tempchar, _mb_cur_max);
                    v9 = f;
                    if ( v21 < 0 )
                      v60 = 1;
                  }
...
LABEL_74:
              ...
              if ( (v5 & 0x830) == 0 )
                v5 |= 0x20u;
LABEL_56:
              p_buffer = *($B4FF2100EA110D8CD0B9C89F852FB035 **)v8;
              v23 = v6;
              if ( v6 == -1 )
                v23 = 0x7FFFFFFF;
              v59 = (char *)(v8 + 4);
...
LABEL_87:
            ...
            v51 = v6;
            p_buffer = ($B4FF2100EA110D8CD0B9C89F852FB035 *)(v28 + 1);
            if ( (v5 & 0x200) != 0 )
            {
              if ( !(_DWORD)v12 || (v59 = v16, v50 = v29, p_buffer->sz[0] != 48) )
              {
                p_buffer = ($B4FF2100EA110D8CD0B9C89F852FB035 *)((char *)p_buffer - 1);
                v59 = v16;
                LODWORD(v12) = v12 + 1;
                v50 = v29;
                p_buffer->sz[0] = 48;
