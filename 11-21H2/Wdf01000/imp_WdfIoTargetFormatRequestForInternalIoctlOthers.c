/*
 * XREFs of imp_WdfIoTargetFormatRequestForInternalIoctlOthers @ 0x1C001ADA0
 * Callers:
 *     <none>
 * Callees:
  ...
  do
  {
    ...
    if ( v19 )
    {
      ...
      if ( v26 )
      {
        ...
        v36 = BufferLength + v26->BufferOffset;
        if ( v36 < BufferLength || (v29 = v27->GetBufferSize(v27), v36 > v29) )
        {
          id = -1073741675;
      ...
      FxRequestBuffer::SetMemory(&args[(unsigned int)v17], v27, v26);
    }
