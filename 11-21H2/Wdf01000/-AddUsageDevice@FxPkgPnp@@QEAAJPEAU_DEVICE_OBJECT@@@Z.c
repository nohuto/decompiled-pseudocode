/*
 * XREFs of ?AddUsageDevice@FxPkgPnp@@QEAAJPEAU_DEVICE_OBJECT@@@Z @ 0x1C0087DCC
 * Callers:
...
LABEL_7:
  ...
  WPP_IFR_SF_qL(this->m_Globals, 2u, 0xCu, 0x48u, (const _GUID *)&WPP_FxPkgPnp_cpp_Traceguids, _a1, 0xC000009A);
LABEL_8:
