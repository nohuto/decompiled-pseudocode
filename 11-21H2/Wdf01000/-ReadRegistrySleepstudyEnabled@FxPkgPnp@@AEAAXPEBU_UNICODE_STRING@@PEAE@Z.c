/*
 * XREFs of ?ReadRegistrySleepstudyEnabled@FxPkgPnp@@AEAAXPEBU_UNICODE_STRING@@PEAE@Z @ 0x1C002008C
 * Callers:
...
void __fastcall FxPkgPnp::ReadRegistrySleepstudyEnabled(FxPkgPnp *this, _UNICODE_STRING *ValueName, bool *Enabled)
{
