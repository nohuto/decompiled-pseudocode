/*
 * XREFs of WppInitGlobalLoggerWdf @ 0x1C00335A0
 * Callers:
 *     WppTraceCallbackWdf @ 0x1C00334D0 (WppTraceCallbackWdf.c)
 * Callees:
 *     __security_check_cookie @ 0x1C0035840 (__security_check_cookie.c)
 *     wcscmp_0 @ 0x1C0036B76 (wcscmp_0.c)
    ...
    if ( Pool2 )
    {
      ...
      else
      {
        ...
        *((_WORD *)Pool2 + 14) = aWmiAutologger[14];
        ...
        do
          ++v14;
        while ( LoggerName[v14] );
        v15 = (unsigned int)(2 * v14);
        v16 = -1LL;
        do
          ++v16;
        while ( *((_WORD *)Pool2 + v16) );
        memmove((char *)Pool2 + 2 * v16, LoggerName, v15);
        v17 = -1LL;
        do
          ++v17;
        while ( *((_WORD *)Pool2 + v17) );
        *((_WORD *)Pool2 + v17) = 92;
      }
