/*
 * XREFs of RaidUnitPendingDpcRoutine @ 0x1C0013A80
 * Callers:
 *     <none>
 * Callees:
        ...
        PVOID SystemArgument2)
{
  ...
  if ( *(int *)(v4 + 1776) <= 0 )
  {
    ...
    {
      if ( (*(char *)(v4 + 449) < 0 || *(_QWORD *)(*(_QWORD *)(v4 + 24) + 4832LL)) && (*(_DWORD *)(v4 + 456) & 4) == 0 )
      ...
      if ( v14 != -1 )
      {
        ...
        if ( !v14 || v14 < (unsigned int)v13 )
        {
          ...
          *(_BYTE *)(v4 + 450) |= 2u;
          ...
          {
            WPP_SF_q(WPP_GLOBAL_Control->AttachedDevice, 60LL, &WPP_568007271afc3cdc120e483208e8f443_Traceguids, v4);
          }
        }
      }
    }
