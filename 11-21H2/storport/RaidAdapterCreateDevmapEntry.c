/*
 * XREFs of RaidAdapterCreateDevmapEntry @ 0x1C0034178
 * Callers:
 ...
 *     PortMapBuildAdapterEntry @ 0x1C006898C (PortMapBuildAdapterEntry.c)
 *     PortMapBuildBusEntry @ 0x1C0068AA0 (PortMapBuildBusEntry.c)
 *     PortMapOpenKey @ 0x1C0068C2C (PortMapOpenKey.c)
 */
                ...
                (__int64)&Handle) >= 0 )
    {
      ...
      if ( *(_BYTE *)(a1 + 416) )
      {
        do
        {
          ...
          PortMapBuildBusEntry(Handle, v2, v5, a1 + 8 * (v2 + 244LL));
          ++v2;
        }
        while ( v2 < v4 );
      }
