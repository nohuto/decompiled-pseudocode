/*
 * XREFs of PortGetIoLatencyCapValue @ 0x1C0092C90
 * Callers:
 *     RaidInitializeAdapter @ 0x1C008D1D8 (RaidInitializeAdapter.c)
 * Callees:
 *     __security_check_cookie @ 0x1C0022BF0 (__security_check_cookie.c)
 *     _wcsnicmp_0 @ 0x1C0022CEA (_wcsnicmp_0.c)
  ...
  if ( a2 )
  {
    ...
    if ( v3 )
    {
      ...
      if ( ZwQueryValueKey(v3, &DestinationString, KeyValueFullInformation, KeyValueInformation, 0x200u, &ResultLength) >= 0
        ...
        && !wcsnicmp_0(Str1, L"IoLatencyCap", (unsigned __int64)KeyValueInformation[4] >> 1) )
      {
