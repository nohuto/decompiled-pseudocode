/*
 * XREFs of McTemplateK0pqquuu_EtwWriteTransfer @ 0x1C0041290
 * Callers:
...
NTSTATUS McTemplateK0pqquuu_EtwWriteTransfer(__int64 a1, __int64 a2, __int64 a3, ...)
{
  ...
  v14 = 1LL;
  v16 = 1LL;
  return McGenEventWrite_EtwWriteTransfer(a1, &EventPortPauseDevice, 0LL, 7u, &v4);
}
