/*
 * XREFs of RaidpAdapterRedirectDpcRoutine @ 0x1C001D420
 * Callers:
 *     <none>
 * Callees:
        ...
        PVOID SystemArgument2)
{
  ...
  for ( i = ExpInterlockedFlushSList(v5); i; ++v6 )
  {
    ...
    if ( !v10 )
    {
      RaidAdapterPoFxIdleComponentFromMiniport(*((_QWORD *)&v11[13].Next + 1), *((unsigned int *)&v11[46].Next + 3));
      BYTE1(v11[1].Next) &= ~1u;
    }
    ((void (__fastcall *)(PSLIST_ENTRY))v11[41].Next)(v11);
  }
  if ( (unsigned int)(MEMORY[0xFFFFF78000000320] - v21) > v8[1146] )
  {
    v8[1146] = MEMORY[0xFFFFF78000000320] - v21;
    v8[1147] = v6;
  }
  if ( v6 > v8[1145] )
    v8[1145] = v6;
