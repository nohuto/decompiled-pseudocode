/*
 * XREFs of StorLogMFNDSetChildPFCommandPermission @ 0x1C0067880
 * Callers:
...
void __fastcall StorLogMFNDSetChildPFCommandPermission(__int64 a1, __int64 a2, unsigned __int16 a3, char a4)
{
  __int128 v7; // xmm1
