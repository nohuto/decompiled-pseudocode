/*
 * XREFs of StorpTelemetryLogUnitPerfDataMeasures @ 0x1C001319C
 * Callers:
...
void __fastcall StorpTelemetryLogUnitPerfDataMeasures(__int64 a1)
{
  ...
  if ( (unsigned int)dword_1C0079058 > 5 )
  {
    if ( (unsigned __int8)tlgKeywordOn(a1, 0x400000000000LL) )
    {
      ...
      v42 = 1LL;
      v44 = 1LL;
      tlgCreate1Sz_wchar_t(v45, *(_QWORD *)(v2 + 4592));
      ...
      v80 = &v20;
      v12 = v10[40];
      v20 = 3 * qword_1C00797D0;
      v82 = v12;
      v83 = 8 * (unsigned __int16)(3 * qword_1C00797D0);
      tlgWriteTransfer_EtwWriteTransfer(3 * qword_1C00797D0, (int)&dword_1C006DE20, v13, v14, 0x1Fu, &v32);
    }
  }
}
