/*
 * XREFs of RaAdapterUpdateAssociatedUnitsIdentity @ 0x1C00330A4
 * Callers:
...
char __fastcall RaAdapterUpdateAssociatedUnitsIdentity(__int64 a1, struct _IO_WORKITEM *a2)
{
  ...
  v4 = 0;
  _InterlockedAdd((volatile signed __int32 *)(a1 + 5632), 1u);
...
LABEL_10:
    ...
    Pool[1] = a2;
    _InterlockedIncrement((volatile signed __int32 *)(a1 + 5632));
  ...
  if ( v4 )
  {
    if ( _InterlockedCompareExchange((volatile signed __int32 *)(a1 + 5632), 0, 1) == 1 )
      return 0;
    else
      return _InterlockedExchangeAdd((volatile signed __int32 *)(a1 + 5632), 0xFFFFFFFF) != 1 ? v4 : 0;
  }
  return v4;
}
