/*
 * XREFs of StorPortUnitPowerNotRequiredStep2 @ 0x1C004BA78
 * Callers:
 *     StorPortUnitPowerNotRequiredStep1 @ 0x1C004B990 (StorPortUnitPowerNotRequiredStep1.c)
 *     StorPortUnitPowerNotRequiredStep2Passive @ 0x1C004BD10 (StorPortUnitPowerNotRequiredStep2Passive.c)
 * Callees:
...
void __fastcall StorPortUnitPowerNotRequiredStep2(char *Context)
{
  ...
  if ( (v3 & 4) != 0 && (*(_DWORD *)(*(_QWORD *)(v2 + 8) + 12LL) & 2) != 0 )
  {
    ...
    Context[449] |= 0x20u;
    v5 = 0;
    if ( *(_QWORD *)(v4 + 4832) && _InterlockedCompareExchange((volatile signed __int32 *)Context + 858, 0, 1) == 1 )
