/*
 * XREFs of StorpTelemetryMiniportEventAdapter @ 0x1C0062430
 * Callers:
...
void __fastcall StorpTelemetryMiniportEventAdapter(__int64 a1)
{
  ...
  {
    if ( tlgKeywordOn(a1, 0x200000000000LL) )
    {
      v2 = *(_WORD **)(v1 + 4592);
      v35 = &v20;
      v37 = v1 + 4936;
      ...
      v33 = v17;
      v78 = 8LL;
      tlgWriteTransfer_EtwWriteTransfer(v17, (unsigned __int8 *)dword_1C006DC83, v18, v19, 0x1Du, &v34);
    }
  }
}
