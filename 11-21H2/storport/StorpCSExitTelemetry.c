/*
 * XREFs of StorpCSExitTelemetry @ 0x1C005E3EC
 * Callers:
...
void __fastcall StorpCSExitTelemetry(__int64 a1)
{
  ...
  if ( a1 )
  {
    ...
    v3 = *(_QWORD *)(a1 + 5096);
    if ( v3 )
      *(_QWORD *)(a1 + 5104) += (MEMORY[0xFFFFF78000000008] - v3) / 0x2710uLL;
    if ( *(_QWORD *)(a1 + 4832) )
    {
      v4 = *(_QWORD *)(a1 + 5120);
      if ( v4 )
        *(_QWORD *)(a1 + 5128) += (v2 - v4) / 0x2710uLL;
      v5 = *(_QWORD *)(a1 + 5200);
      if ( v5 )
        *(_QWORD *)(a1 + 5208) += (v2 - v5) / 0x2710uLL;
      v6 = *(_QWORD *)(a1 + 5136);
      if ( v6 )
        *(_QWORD *)(a1 + 5144) += (v2 - v6) / 0x2710uLL;
      v7 = *(_QWORD *)(a1 + 5112);
      if ( v7 )
        v7 -= *(_QWORD *)(a1 + 5088);
      if ( (unsigned int)dword_1C0079058 > 5 && tlgKeywordOn(v7, 0x400000000000LL) )
      {
        v47 = 16LL;
        v46 = a1 + 4936;
        v29 = *(_DWORD *)(a1 + 56);
        ...
        v73 = 8LL;
        v75 = 4LL;
        tlgWriteTransfer_EtwWriteTransfer(v13, (unsigned __int8 *)dword_1C006EB66, v8, v9, 0x11u, &v45);
      }
    }
      ...
      if ( RaidUnitCheckAndAcquirePoFx((__int64)(i - 7)) )
      {
        ...
        if ( (unsigned int)dword_1C0079058 > 5 )
        {
          if ( tlgKeywordOn(v18, 0x400000000000LL) )
          {
            ...
            v85 = 8LL;
            v87 = 4LL;
            tlgWriteTransfer_EtwWriteTransfer(v24, (unsigned __int8 *)dword_1C006E903, v19, v20, 0x17u, &v45);
          }
        }
