/*
 * XREFs of StorpLogPerAdapterStatistics @ 0x1C0003300
 * Callers:
...
void __fastcall StorpLogPerAdapterStatistics(__int64 a1)
{
  ...
  v2 = *(unsigned int *)(a1 + 4964);
  if ( ((_DWORD)v2
     || *(_DWORD *)(a1 + 4976)
     || *(_DWORD *)(a1 + 4988)
     || *(_DWORD *)(a1 + 5000)
     || *(_DWORD *)(a1 + 5012))
    && (unsigned int)dword_1C0079058 > 5
    && (unsigned __int8)tlgKeywordOn(v2, 0x400000000000LL) )
  {
    v29 = 16LL;
    v28 = a1 + 4936;
    v16 = *(_DWORD *)(a1 + 56);
    ...
    v59 = 4LL;
    v61 = 1LL;
    tlgWriteTransfer_EtwWriteTransfer(v5, (int)&dword_1C006E50E, v6, v7, 0x13u, &v27);
  }
  v3 = *(unsigned int *)(a1 + 5024);
  if ( ((_DWORD)v3
     || *(_DWORD *)(a1 + 5036)
     || *(_DWORD *)(a1 + 5048)
     || *(_DWORD *)(a1 + 5060)
     || *(_DWORD *)(a1 + 5072))
    && (unsigned int)dword_1C0079058 > 5
    && (unsigned __int8)tlgKeywordOn(v3, 0x400000000000LL) )
  {
    v29 = 16LL;
    v28 = a1 + 4936;
    v26[0] = *(_DWORD *)(a1 + 56);
    ...
    v59 = 4LL;
    v61 = 1LL;
    tlgWriteTransfer_EtwWriteTransfer(v8, (int)&dword_1C006F251, v9, v10, 0x13u, &v27);
  }
  StorpInitializeHierarchicalResetBuckets(a1);
  if ( !*(_BYTE *)(a1 + 5216) && (int)RaidAcquireAdapterRemoveLock(a1) >= 0 )
  {
