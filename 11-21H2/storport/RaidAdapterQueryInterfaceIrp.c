/*
 * XREFs of RaidAdapterQueryInterfaceIrp @ 0x1C0035D90
 * Callers:
 ...
 *     PortQueryInterfaceFdoInfo @ 0x1C0093A40 (PortQueryInterfaceFdoInfo.c)
...
LABEL_14:
  ...
  {
    InterfaceFdoInfo = PortQueryInterfaceFdoQdr(v6, a2, *(_QWORD *)(a1 + 4248));
    goto LABEL_14;
  }
