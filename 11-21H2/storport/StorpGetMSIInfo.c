/*
 * XREFs of StorpGetMSIInfo @ 0x1C0045CD8
 * Callers:
...
__int64 __fastcall StorpGetMSIInfo(__int64 a1, __int64 a2, __int64 a3)
{
  ...
  if ( !a3 )
  {
    ...
    v4 = 58;
LABEL_6:
    WPP_SF_((__int64)v3->AttachedDevice, v4, (__int64)&WPP_27c524ad26413fc7d405974726332488_Traceguids);
    return (unsigned int)-1056964602;
  }
  Adapter = RaidpPortGetAdapter(a1);
  if ( Adapter )
  {
    if ( *((_BYTE *)Adapter + 4241) == (_BYTE)v5 )
      return (unsigned int)-1056964601;
    v9 = (unsigned __int8 *)*((_QWORD *)Adapter + 528);
