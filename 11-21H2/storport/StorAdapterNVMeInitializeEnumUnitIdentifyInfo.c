/*
 * XREFs of StorAdapterNVMeInitializeEnumUnitIdentifyInfo @ 0x1C0084424
 * Callers:
...
LABEL_13:
  ...
  if ( *v7 )
  {
    ...
    while ( v21 < 0x1000 )
    {
      if ( v19 == 4 && v20[4] == 2 )
      {
        *(_DWORD *)(*(_QWORD *)(a3 + 8) + 1824LL) |= 0x20u;
        break;
      }
      v22 = v20[1];
      v21 += v22 + 4;
...
LABEL_15:
  ...
  else
  {
    ...
    *(_QWORD *)(*(_QWORD *)(a3 + 8) + 3416LL) = v5;
    *(_QWORD *)(*(_QWORD *)(a3 + 8) + 3424LL) = v8;
  }
