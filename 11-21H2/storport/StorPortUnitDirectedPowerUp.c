/*
 * XREFs of StorPortUnitDirectedPowerUp @ 0x1C004B300
 * Callers:
 *     <none>
 * Callees:
 ...
 *     RaidNotifyPoAboutAdaptiveD3Engagement @ 0x1C006573C (RaidNotifyPoAboutAdaptiveD3Engagement.c)
 */
...
void __fastcall StorPortUnitDirectedPowerUp(__int64 Context)
{
  ...
  if ( RaidUnitCheckAndAcquirePoFx(Context) )
  {
    ...
    else
    {
      ...
      {
        if ( (v4 & 0x80u) != 0 || (*(_BYTE *)(*(_QWORD *)(Context + 24) + 108LL) & 1) != 0 )
        {
          ...
          *(_QWORD *)(Context + 2096) += v5 / 0x2710;
          ...
          if ( !*(_QWORD *)(Context + 2080) )
            *(_QWORD *)(Context + 2080) = *(_QWORD *)(*(_QWORD *)(Context + 24) + 5088LL);
        }
