/*
 * XREFs of McTemplateK0quuuqqq_EtwWriteTransfer @ 0x1C0048058
 * Callers:
...
NTSTATUS __fastcall McTemplateK0quuuqqq_EtwWriteTransfer(
        __int64 a1,
        __int64 a2,
        __int64 a3,
        int a4,
        ...
        char a10)
{
  ...
  v23 = 4LL;
  v25 = 4LL;
  return McGenEventWrite_EtwWriteTransfer(a1, &EventUnitPowerCycleCount, 0LL, 8u, &v11);
}
