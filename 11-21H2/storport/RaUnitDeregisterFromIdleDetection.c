/*
 * XREFs of RaUnitDeregisterFromIdleDetection @ 0x1C001ED90
 * Callers:
...
void __fastcall RaUnitDeregisterFromIdleDetection(__int64 a1)
{
  ...
  if ( *(char *)(a1 + 449) < 0 )
  {
    ...
    KeAcquireInStackQueuedSpinLock((PKSPIN_LOCK)(*(_QWORD *)(a1 + 1744) + 96LL), &LockHandle);
    ...
    if ( v9 )
    {
      ...
      *(_QWORD *)(*(_QWORD *)(a1 + 1744) + 128LL) = 0LL;
      if ( v10 )
      {
        if ( (*(_DWORD *)(*(_QWORD *)(a1 + 1744) + 148LL) & 1) != 0 )
