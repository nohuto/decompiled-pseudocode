/*
 * XREFs of StorpLogRegisterAdapterPerfStates @ 0x1C005F7A0
 * Callers:
...
char __fastcall StorpLogRegisterAdapterPerfStates(__int64 a1, __int64 a2)
{
  ...
  if ( (unsigned int)dword_1C0079058 > 5 )
  {
    ...
    if ( (_BYTE)v2 )
    {
      ...
      v23 = v12;
      v47 = 8;
      LOBYTE(v2) = tlgWriteTransfer_EtwWriteTransfer(8LL, (unsigned __int8 *)dword_1C006E78D, v10, v11, 0xAu, &v24);
    }
  }
  return (char)v2;
}
