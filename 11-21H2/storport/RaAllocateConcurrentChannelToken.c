/*
 * XREFs of RaAllocateConcurrentChannelToken @ 0x1C001D548
 * Callers:
...
PSLIST_ENTRY __fastcall RaAllocateConcurrentChannelToken(__int64 a1)
{
  ...
  result = ExpInterlockedPopEntrySList((PSLIST_HEADER)(*(_QWORD *)(a1 + 4544)
...
LABEL_4:
    ...
    while ( 1 )
    {
      result = ExpInterlockedPopEntrySList((PSLIST_HEADER)(*(_QWORD *)(a1 + 4544) + ((unsigned __int64)v3 << 6)));
      if ( result )
        break;
      _mm_pause();
      if ( ++v3 >= v5 )
