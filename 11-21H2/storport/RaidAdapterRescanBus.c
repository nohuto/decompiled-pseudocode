/*
 * XREFs of RaidAdapterRescanBus @ 0x1C001A8B0
 * Callers:
...
__int64 __fastcall RaidAdapterRescanBus(__int64 a1, int *a2, _BYTE *a3)
{
  ...
  if ( v3 )
  {
    ...
    *(_QWORD *)(a1 + 4136) = MEMORY[0xFFFFF78000000014];
    ...
    v4 = 1;
    v5 = v13 != *(_DWORD *)(a1 + 4696);
  }
  if ( (*(_BYTE *)(a1 + 104) & 0x40) != 0 )
  {
    if ( v5 )
    {
      if ( (*(_DWORD *)(a1 + 4700) & 4) != 0 && (*(_DWORD *)(a1 + 4704) & 1) != 0 && *(_QWORD *)(a1 + 4752) )
        RtlSetBit((PRTL_BITMAP)(a1 + 4736), *(unsigned __int8 *)(*(_QWORD *)(a1 + 4712) + 8LL));
    }
    else
    {
      LOBYTE(v10) = v4;
