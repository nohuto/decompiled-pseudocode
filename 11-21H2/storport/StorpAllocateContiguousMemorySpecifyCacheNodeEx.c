/*
 * XREFs of StorpAllocateContiguousMemorySpecifyCacheNodeEx @ 0x1C000CD68
 * Callers:
...
__int64 StorpAllocateContiguousMemorySpecifyCacheNodeEx(__int64 a1, unsigned __int64 a2, ...)
{
  ...
  {
    v11 = (*(__int64 (__fastcall **)(_QWORD, __int64 *, __int64 *, _QWORD, _DWORD, _QWORD, _DWORD, PHYSICAL_ADDRESS *))(*(_QWORD *)(*(_QWORD *)(Adapter + 752) + 8LL) + 272LL))(
            *(_QWORD *)(Adapter + 752),
            (__int64 *)va,
            (__int64 *)va1,
            (unsigned int)a2,
  ...
  {
    if ( (*(_DWORD *)(*(_QWORD *)(Adapter + 568) + 184LL) & 0x2000) != 0 && a2 <= 0x1000 )
      Pool = (void *)RaidAllocatePool(72LL, 4096LL, 1161912658LL, *(_QWORD *)(Adapter + 8));
    else
