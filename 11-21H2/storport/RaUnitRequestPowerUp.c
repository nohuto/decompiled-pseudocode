/*
 * XREFs of RaUnitRequestPowerUp @ 0x1C0017888
 * Callers:
...
__int64 __fastcall RaUnitRequestPowerUp(__int64 a1)
{
  ...
  else
  {
    ...
    if ( v2 == 259 )
    {
      ...
      {
        WPP_SF_(WPP_GLOBAL_Control->AttachedDevice, 64LL, &WPP_da8695fb3edb33e33ecd2adca73d6fb8_Traceguids);
      }
      *(_BYTE *)(a1 + 448) |= 0x80u;
      KeReleaseInStackQueuedSpinLock(&LockHandle);
      v3 = 0;
    ...
    else
    {
      ...
      {
        WPP_SF_(WPP_GLOBAL_Control->AttachedDevice, 63LL, &WPP_da8695fb3edb33e33ecd2adca73d6fb8_Traceguids);
      }
