/*
 * XREFs of RaidAdapterProgramCryptoKeyRoutine @ 0x1C00359B0
 * Callers:
 *     <none>
 * Callees:
...
void __fastcall RaidAdapterProgramCryptoKeyRoutine(PVOID IoObject, _QWORD *Context, PIO_WORKITEM IoWorkItem)
{
  ...
  if ( Context )
  {
    ...
    v8 = *(_QWORD *)(*Context + 5496LL) + ((unsigned __int64)*((unsigned int *)Context + 2) << 6);
    ...
    if ( v3 >= 0 )
    {
      v10 = ExAcquireSpinLockExclusive((PEX_SPIN_LOCK)(*Context + 5504LL));
      *(_DWORD *)(v8 + 44) = 2;
      v11 = v10;
      EntrySList = FirstEntrySList((PSLIST_HEADER)(v8 + 48));
      InitializeSListHead((PSLIST_HEADER)(v8 + 48));
      ExReleaseSpinLockExclusive((PEX_SPIN_LOCK)(*Context + 5504LL), v11);
    }
  }
  v12 = 0LL;
  if ( EntrySList )
  ...
  if ( v3 >= 0 && v12 )
  {
    do
    {
      ...
      v17 = *Context;
      v12 = v14;
      if ( *(_BYTE *)(*Context + 4242LL) )
        v18 = RaidAdapterRaiseIrqlAndExecuteXrb(v17, (__int64)v16);
      else
        v18 = RaidAdapterExecuteXrb(v17, v16);
      if ( v18 < 0 )
      {
