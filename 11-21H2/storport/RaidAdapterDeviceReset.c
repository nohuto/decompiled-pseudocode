/*
 * XREFs of RaidAdapterDeviceReset @ 0x1C003463C
 * Callers:
...
__int64 __fastcall RaidAdapterDeviceReset(__int64 a1, __int64 a2)
{
  __int64 result; // rax
  int v5; // ebp
  unsigned int v6; // ebx
  ...
  v10 = StorReset(*(_QWORD *)(a1 + 576) + 16LL, *(unsigned int *)(a2 + 8));
  if ( *(int *)(a1 + 4536) > 1 )
  {
    v11 = 0;
    ...
    do
    {
      ...
      if ( v13 )
      {
        ExpInterlockedPushEntrySList(
          (PSLIST_HEADER)(*(_QWORD *)(a1 + 4544) + ((unsigned __int64)(HIDWORD(v13[1].Next) % v12) << 6)),
          v13);
        ++v11;
      }
    }
    while ( v11 < *(_DWORD *)(a1 + 4536) );
  }
  v14 = KfRaiseIrql(2u);
