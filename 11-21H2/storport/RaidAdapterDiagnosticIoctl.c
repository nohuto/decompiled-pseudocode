/*
 * XREFs of RaidAdapterDiagnosticIoctl @ 0x1C008BED4
 * Callers:
 ...
 *     RaidDiagnosticIoctlStatusToNtStatus @ 0x1C00399AC (RaidDiagnosticIoctlStatusToNtStatus.c)
  ...
  if ( MdlAddress_high == 1 )
  {
    ...
    *(GUID *)&MasterIrp->MdlAddress = GUID_DIAGNOSTIC_PROVIDER_STORPORT;
    if ( (unsigned int)Length >= 0x1200038 )
    {
      ...
      LODWORD(MasterIrp->ThreadListEntry.Blink) = *(_DWORD *)(a1 + 4804);
      HIDWORD(MasterIrp->ThreadListEntry.Blink) = *(_DWORD *)(a1 + 4800);
      memmove(&MasterIrp->IoStatus, *(const void **)(a1 + 4808), 48LL * *(unsigned int *)(a1 + 4804));
      LODWORD(MasterIrp[90742].UserEvent) = *(_DWORD *)(a1 + 5512);
      HIDWORD(MasterIrp[90742].UserEvent) = *(_DWORD *)(a1 + 5516);
    ...
    if ( Srb )
    {
      ...
      if ( ContiguousIoResources )
      {
        ...
        *(_QWORD *)(v15 + 168) = Srb;
        ...
        v19 = HIDWORD(MasterIrp->MdlAddress);
        if ( v19 == 2 )
        {
          *(_BYTE *)(v15 + 17) |= 8u;
          v19 = HIDWORD(MasterIrp->MdlAddress);
        }
        if ( v19 == 3 && *(_QWORD *)(a1 + 4832) )
        ...
        if ( *(_BYTE *)(a1 + 4242) )
          ...
          v20 = RaidAdapterExecuteXrb(a1, (_QWORD *)v15);
        v3 = v20;
        if ( v20 >= 0 )
        {
