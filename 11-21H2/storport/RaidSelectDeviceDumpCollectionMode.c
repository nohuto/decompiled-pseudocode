/*
 * XREFs of RaidSelectDeviceDumpCollectionMode @ 0x1C001C94C
 * Callers:
 ...
 *     RaidRegGetDeviceDumpSupportLevel @ 0x1C001CA70 (RaidRegGetDeviceDumpSupportLevel.c)
 *     RaidRegGetDeviceDumpMaxSize @ 0x1C001CAFC (RaidRegGetDeviceDumpMaxSize.c)
