/*
 * XREFs of FillBufferWithDriverTelemetryDump @ 0x1C00648C8
 * Callers:
 *     RaidStandardSecondaryDumpCallback @ 0x1C0064BD0 (RaidStandardSecondaryDumpCallback.c)
 * Callees:
 *     memset @ 0x1C0024340 (memset.c)
 *     RtlStringCopyWorkerA @ 0x1C0064C8C (RtlStringCopyWorkerA.c)
 */
...
LABEL_26:
    ...
    while ( 1 )
    {
      v18 = *(_QWORD *)(*(_QWORD *)(v3 + 24) + 4808LL) + 48LL * v16;
        ...
        if ( *(_DWORD *)v18 == 1 )
        {
          if ( (unsigned __int64)v8 + 60 < v7 )
          {
            *(_BYTE *)v12 = BYTE2(*(_DWORD *)(v18 + 32));
            ...
            v22 = (unsigned __int64)*(unsigned int *)(v18 + 32) >> 8;
            *((_QWORD *)v12 + 4) = 0LL;
            v12[12] = (unsigned __int8)v22;
