/*
 * XREFs of RaAttemptHighWaterMarkIncrease @ 0x1C00586F4
 * Callers:
 ...
 *     RaAttemptHighWaterMarkIncreasePassive @ 0x1C00253B0 (RaAttemptHighWaterMarkIncreasePassive.c)
 * Callees:
...
LABEL_13:
      ...
      if ( Pool )
      {
        ...
        *(_QWORD *)(Pool + 32) = Context;
        ...
        if ( v14 )
        {
          v16 = *(_DWORD *)(*(_QWORD *)(*((_QWORD *)Context + 19) + 64LL) + 848LL);
