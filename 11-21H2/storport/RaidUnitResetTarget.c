/*
 * XREFs of RaidUnitResetTarget @ 0x1C0055598
 * Callers:
 ...
 *     StorpAggregateHierarchicalResetTarget @ 0x1C005DF44 (StorpAggregateHierarchicalResetTarget.c)
 */
...
__int64 __fastcall RaidUnitResetTarget(__int64 a1)
{
  ...
  v5 = *(_QWORD *)(a1 + 8);
  v26 = v4;
  Srb = RaidAllocateSrb(v5, 0x13u, *(_BYTE *)(v3 + 442), 0);
  v8 = Srb;
  if ( Srb )
  {
    if ( *(_BYTE *)(v3 + 442) == 1 )
    ...
    if ( v13 )
    {
      ...
      if ( (unsigned int)dword_1C0079058 > 5 )
      {
        ...
        v28 = v18;
        v42 = 8LL;
        tlgWriteTransfer_EtwWriteTransfer(8LL, (unsigned __int8 *)dword_1C006CE6A, v18, v19, 8u, &v30);
      }
