/*
 * XREFs of RaidAdapterSurpriseRemovalIrp @ 0x1C008CE90
 * Callers:
...
NTSTATUS __fastcall RaidAdapterSurpriseRemovalIrp(__int64 a1, IRP *a2)
{
  ...
  *(_DWORD *)(a1 + 88) = 5;
  if ( (unsigned int)(v2 - 5) > 1 )
  {
    ...
    {
      v5 = RaCallMiniportAdapterControl(a1 + 336);
      v3 = 1;
    }
  ...
  if ( (unsigned int)dword_1C0079058 > 5 && tlgKeywordOn(a1, 0x400000000000LL) )
  {
    v9 = *(_WORD **)(a1 + 4592);
    v29 = 0;
    v32 = 0;
    ...
    v24 = v5;
    v45 = v14;
    tlgWriteTransfer_EtwWriteTransfer(v15, (unsigned __int8 *)dword_1C006C661, v16, v17, 0xAu, &v26);
  }
