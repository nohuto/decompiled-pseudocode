/*
 * XREFs of McTemplateK0qjzztqqquuhhhhhhhhqqqqqqqqqqqqu_EtwWriteTransfer @ 0x1C0032158
 * Callers:
        ...
        char a34)
{
  ...
  v105 = &a34;
  v106 = 1LL;
  return McGenEventWrite_EtwWriteTransfer(v34, &EventGetMFNDCapability, 0LL, 0x20u, &v42);
}
