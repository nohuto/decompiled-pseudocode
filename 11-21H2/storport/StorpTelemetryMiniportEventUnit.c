/*
 * XREFs of StorpTelemetryMiniportEventUnit @ 0x1C006274C
 * Callers:
...
char __fastcall StorpTelemetryMiniportEventUnit(__int64 a1, __int64 a2, __int64 a3, int *a4)
{
  ...
  {
    LOBYTE(v4) = tlgKeywordOn(a1, 0x200000000000LL);
    if ( (_BYTE)v4 )
    {
      v8 = *(_WORD **)(v7 + 4592);
      v56 = &v36;
      ...
      v57 = 1LL;
      v59 = 16LL;
      tlgCreate1Sz_wchar_t((__int64)v60, v8);
      v10 = -1LL;
      v61 = v5;
      v62 = 16LL;
      do
      ...
      v53 = v30;
      v116 = 8LL;
      LOBYTE(v4) = tlgWriteEx_EtwWriteEx(v30, (unsigned __int8 *)dword_1C006ED9F, v31, v32, v34, v35, 0x27u, &v55);
    }
  }
  return v4;
}
