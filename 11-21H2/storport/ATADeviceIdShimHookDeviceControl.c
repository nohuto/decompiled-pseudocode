/*
 * XREFs of ATADeviceIdShimHookDeviceControl @ 0x1C0064D80
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall ATADeviceIdShimHookDeviceControl(__int64 a1, __int64 a2)
{
        ...
        if ( v7 )
        {
          if ( !v7[1] && *v7 == 2 )
          {
            ...
            if ( (unsigned int)v8 >= 8 )
            {
              ...
              (*(void (__fastcall **)(__int64, __int64, __int64 (__fastcall *)(), __int64))(qword_1C0079308 + 8))(
                a1,
                a2,
  ...
  v9 = (*(__int64 (__fastcall **)(_QWORD))qword_1C0079308)(*(_QWORD *)(a1 + 8));
