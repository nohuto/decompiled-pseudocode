/*
 * XREFs of RaidAdapterScsiGetInquiryDataIoctl @ 0x1C0036DD4
 * Callers:
...
__int64 __fastcall RaidAdapterScsiGetInquiryDataIoctl(__int64 a1, IRP *a2)
{
  ...
  Pool = (_DWORD *)RaidAllocatePool(64LL, 4080LL, 842096978LL, v2);
  if ( Pool )
  {
    CurrentStackLocation = a2->Tail.Overlay.CurrentStackLocation;
    MasterIrp = a2->AssociatedIrp.MasterIrp;
    KeAcquireInStackQueuedSpinLock((PKSPIN_LOCK)(a1 + 136), &LockHandle);
    v9 = *(unsigned __int8 *)(a1 + 416);
    v10 = 8 * (v9 + 6 * *(_DWORD *)(a1 + 160)) + 4;
    if ( CurrentStackLocation->Parameters.Read.Length >= v10 )
    {
      v11 = (__int64 *)(a1 + 144);
      for ( i = *(__int64 **)(a1 + 144); i != v11; i = (__int64 *)*i )
      {
        if ( (i[49] & 8) == 0 )
        {
          v13 = *((_DWORD *)i + 10);
          if ( (_BYTE)v13 != 0xFF )
          {
            ...
            v15 = Pool[4 * (unsigned __int8)v13];
            if ( v15 >= 0xFF )
            {
      ...
      if ( (__int64 *)*v11 != v11 )
      {
        do
        {
          if ( (v20[49] & 8) == 0 )
          {
            ...
            if ( (_BYTE)v22 != 0xFF )
            {
              v24 = (unsigned int)Pool[4 * (unsigned __int8)v22 + 1];
              v21 = *(_QWORD *)&Pool[4 * (unsigned __int8)v22 + 2] + 48 * v24;
              Pool[4 * (unsigned __int8)v22 + 1] = v24 + 1;
              *(_BYTE *)v21 = v22;
        ...
        do
        {
          ...
          *((_BYTE *)p_MdlAddress - 4) = *(_BYTE *)v27;
          if ( (unsigned __int8)v26 < 8u )
            v30 = *(_BYTE *)((unsigned __int8)v26 + a1 + 417);
          else
            v30 = -1;
