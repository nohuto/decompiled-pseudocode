/*
 * XREFs of StorpTelemetryLogUnitQosDataMeasures @ 0x1C00618DC
 * Callers:
...
char __fastcall StorpTelemetryLogUnitQosDataMeasures(__int64 a1)
{
  ...
  if ( (unsigned int)dword_1C0079058 > 5 )
  {
    ...
    if ( (_BYTE)v1 )
    {
      ...
      v43 = 1LL;
      v45 = 1LL;
      tlgCreate1Sz_wchar_t((__int64)v46, *(_WORD **)(v3 + 4592));
      ...
      v77 = 4LL;
      v79 = 4LL;
      LOBYTE(v1) = tlgWriteTransfer_EtwWriteTransfer(v8, (unsigned __int8 *)dword_1C006F996, v11, v12, 0x1Bu, &v33);
    }
  }
  return (char)v1;
}
