/*
 * XREFs of StorpTelemetryLogUnitPerfDataCriticalData @ 0x1C0061570
 * Callers:
...
void __fastcall StorpTelemetryLogUnitPerfDataCriticalData(__int64 a1)
{
  ...
  if ( (unsigned int)dword_1C0079058 > 5 )
  {
    if ( tlgKeywordOn(a1, 0x800000000000LL) )
    {
      ...
      v40 = 1LL;
      v42 = 1LL;
      tlgCreate1Sz_wchar_t((__int64)v43, *(_WORD **)(v2 + 4592));
      ...
      v73 = &v18;
      v11 = v9[40];
      v18 = 3 * qword_1C00797D0;
      v75 = v11;
      v76 = 8 * (unsigned __int16)(3 * qword_1C00797D0);
      tlgWriteTransfer_EtwWriteTransfer(
        (3 * qword_1C00797D0) & 0x1FFFFFFFFFFFFFFFLL,
        (unsigned __int8 *)dword_1C006F094,
        v12,
        v13,
        0x1Du,
        &v30);
