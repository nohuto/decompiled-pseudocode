/*
 * XREFs of StorPortGetScatterGatherListVrfy @ 0x1C00952D0
 * Callers:
 *     <none>
 * Callees:
 *     RaidRemapScatterGatherList @ 0x1C0095008 (RaidRemapScatterGatherList.c)
 */
...
PVOID __fastcall StorPortGetScatterGatherListVrfy(__int64 a1, __int64 a2)
{
  ...
  if ( !*(_BYTE *)(v2 + 4242) || (*(_BYTE *)(v2 + 4243) & 4) == 0 || (v3 & 0xC0) == 0 )
    return *(PVOID *)(v4 + 112);
