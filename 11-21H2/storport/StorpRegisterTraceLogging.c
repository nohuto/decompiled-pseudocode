/*
 * XREFs of StorpRegisterTraceLogging @ 0x1C0090130
 * Callers:
...
char StorpRegisterTraceLogging()
{
  ...
  if ( (int)TraceLoggingRegisterEx_EtwRegister_EtwSetInformation(&dword_1C0079058) >= 0 )
    TelemetryProviderInitialized = 1;
  v0 = TraceLoggingRegisterEx_EtwRegister_EtwSetInformation(&dword_1C0079220);
  if ( v0 >= 0 )
