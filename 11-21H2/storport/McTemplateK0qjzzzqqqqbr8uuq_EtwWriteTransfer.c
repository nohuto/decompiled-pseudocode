/*
 * XREFs of McTemplateK0qjzzzqqqqbr8uuq_EtwWriteTransfer @ 0x1C0066D94
 * Callers:
        ...
        char a16)
{
  ...
  v55 = 1LL;
  v57 = 4LL;
  return McGenEventWrite_EtwWriteTransfer((__int64)v24, &EventMFNDQueryChildPFList, 0LL, 0xEu, &v27);
}
