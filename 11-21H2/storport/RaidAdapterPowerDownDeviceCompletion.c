/*
 * XREFs of RaidAdapterPowerDownDeviceCompletion @ 0x1C0015460
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall RaidAdapterPowerDownDeviceCompletion(__int64 a1, __int64 a2)
{
  ...
  {
    WPP_SF_qq(WPP_GLOBAL_Control->AttachedDevice, 25LL, &WPP_da8695fb3edb33e33ecd2adca73d6fb8_Traceguids, v2, a2);
  }
  if ( *(_BYTE *)(a2 + 65) )
