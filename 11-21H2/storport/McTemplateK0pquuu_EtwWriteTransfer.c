/*
 * XREFs of McTemplateK0pquuu_EtwWriteTransfer @ 0x1C0041438
 * Callers:
...
NTSTATUS McTemplateK0pquuu_EtwWriteTransfer(__int64 a1, __int64 a2, __int64 a3, ...)
{
  ...
  va_copy(v13, va4);
  v14 = 1LL;
  return McGenEventWrite_EtwWriteTransfer(a1, &EventPortResumeDevice, 0LL, 6u, &v4);
}
