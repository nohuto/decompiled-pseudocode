/*
 * XREFs of ATAShimGetMsftId @ 0x1C0064EF0
 * Callers:
 ...
 *     RaidCheckATADeviceIdMapping @ 0x1C003F0FC (RaidCheckATADeviceIdMapping.c)
 *     RaidSaveATADeviceIdMapping @ 0x1C003F68C (RaidSaveATADeviceIdMapping.c)
