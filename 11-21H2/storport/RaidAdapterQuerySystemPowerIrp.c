/*
 * XREFs of RaidAdapterQuerySystemPowerIrp @ 0x1C0017A14
 * Callers:
...
__int64 __fastcall RaidAdapterQuerySystemPowerIrp(__int64 a1, IRP *a2)
{
  ...
  {
    WPP_SF_qq(WPP_GLOBAL_Control->AttachedDevice, 33LL, &WPP_da8695fb3edb33e33ecd2adca73d6fb8_Traceguids, a1, a2);
  }
  ...
  *(_OWORD *)(&CurrentStackLocation[-1].Parameters.SetQuota + 6) = *(_OWORD *)(&CurrentStackLocation->Parameters.SetQuota
  ...
  if ( WPP_GLOBAL_Control != (PDEVICE_OBJECT)&WPP_GLOBAL_Control
    ...
    && BYTE1(WPP_GLOBAL_Control->Timer) >= 4u )
  {
    WPP_SF_qqD(WPP_GLOBAL_Control->AttachedDevice, 34LL, &WPP_da8695fb3edb33e33ecd2adca73d6fb8_Traceguids, a1, a2, 259);
  }
  return 259LL;
}
