/*
 * XREFs of StorLogMFNDSetChildPFQoS @ 0x1C0067B24
 * Callers:
...
void __fastcall StorLogMFNDSetChildPFQoS(__int64 a1, __int64 a2, unsigned __int16 a3, char a4)
{
  __int128 v7; // xmm1
  ...
  if ( StorEtwLoggingEnabled )
  {
    ...
    v25 = v7;
    v24 = 0LL;
    RaidDriverGetName(v9, (__int64)&v24);
