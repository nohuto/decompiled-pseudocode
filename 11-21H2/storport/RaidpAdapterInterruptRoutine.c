/*
 * XREFs of RaidpAdapterInterruptRoutine @ 0x1C0024C10
 * Callers:
 *     <none>
 * Callees:
...
char __fastcall RaidpAdapterInterruptRoutine(__int64 a1, __int64 a2)
{
  ...
  v2 = 0LL;
  v4.QuadPart = 0LL;
  if ( !a2 || *(_DWORD *)a2 || (*(_BYTE *)(a2 + 107) & 1) == 0 || *(int *)(a2 + 308) > 1 )
    return 0;
  if ( StorEtwLoggingEnabled && (byte_1C00799E3 & 8) != 0 )
  {
    if ( UseQPCTime )
