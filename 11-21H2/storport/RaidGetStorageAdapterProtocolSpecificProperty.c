/*
 * XREFs of RaidGetStorageAdapterProtocolSpecificProperty @ 0x1C0039B18
 * Callers:
...
__int64 __fastcall RaidGetStorageAdapterProtocolSpecificProperty(__int64 a1, IRP *a2, _QWORD *a3)
{
  ...
  int v19; // eax
  unsigned int v21; // [rsp+D8h] [rbp+10h] BYREF
  ...
  *a3 = 0LL;
    ...
    && ((v13 = _mm_cvtsi128_si32(v9)) == 0 || v13 >= 0x28 && v9.m128i_i32[1]) )
  {
    ...
    if ( Length < v13 + HIDWORD(v9.m128i_i64[0]) + 8 )
      return (unsigned int)-1073741585;
    v12 = RaBuildQueryProtocolSpecificPropertyBufferForMiniport(*(_QWORD *)(a1 + 8), a2, &P, &v21);
    if ( v12 < 0 )
    {
      v4 = (unsigned int *)P;
    }
    ...
    {
      v4 = (unsigned int *)P;
      v12 = RaidAdapterSendSrbIoControlSynchronously(a1, a2, (__int64)P, v21, 0LL, 0, 64);
      if ( v12 >= 0 )
      {
        memset(MasterIrp, 0, v14);
        *(_DWORD *)&MasterIrp->Type = 48;
