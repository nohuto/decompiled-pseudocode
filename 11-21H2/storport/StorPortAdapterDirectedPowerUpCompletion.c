/*
 * XREFs of StorPortAdapterDirectedPowerUpCompletion @ 0x1C004AAD0
 * Callers:
 *     <none>
 * Callees:
        ...
        char *Context)
{
  ...
  if ( StorEtwLoggingEnabled && (byte_1C00799E2 & 0x10) != 0 )
  {
    ...
    McTemplateK0pqq_EtwWriteTransfer(v7, &EventAdapterDirectedPowerUpStop, v8, **((_QWORD **)Context + 604), v9, v10);
  }
