/*
 * XREFs of RaGetProtocolCommandEffects @ 0x1C0033264
 * Callers:
...
LABEL_13:
    ...
    *(_QWORD *)(Pool + 4) = 0x4C4F434F544F5250LL;
    ...
    {
      v17 = *(void **)(v11 + 5256);
      v18 = (char *)v10 + (unsigned int)v10[13] + 36;
      if ( !v17 )
      {
        ...
        if ( !_InterlockedCompareExchange64((volatile signed __int64 *)(v11 + 5256), (signed __int64)v20, 0LL) )
          goto LABEL_26;
