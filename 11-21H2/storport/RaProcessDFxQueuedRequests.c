/*
 * XREFs of RaProcessDFxQueuedRequests @ 0x1C003D990
 * Callers:
 *     <none>
 * Callees:
...
void __fastcall RaProcessDFxQueuedRequests(__int64 DeviceObject, struct _IO_WORKITEM *Context)
{
  ...
  if ( *(_DWORD *)v2 )
  {
    if ( *(_DWORD *)v2 == 1 )
    {
      ...
      while ( (_QWORD *)*v8 != v8 )
      {
        KeAcquireInStackQueuedSpinLock(v2 + 422, &LockHandle);
        v9 = (_QWORD *)v2[420];
        if ( (_QWORD *)*v9 != v8 || (v10 = (_QWORD *)v9[1], (_QWORD *)*v10 != v9) )
LABEL_14:
          __fastfail(3u);
        v2[420] = (KSPIN_LOCK)v10;
        *v10 = v8;
        --*((_DWORD *)v2 + 842);
  ...
  else
  {
    ...
    while ( (_QWORD *)*v5 != v5 )
    {
      KeAcquireInStackQueuedSpinLock(v2 + 702, &LockHandle);
      v6 = (_QWORD *)v2[700];
      if ( (_QWORD *)*v6 != v5 )
        goto LABEL_14;
      v7 = (_QWORD *)v6[1];
