/*
 * XREFs of RaUnitTelemetryIdIoctl @ 0x1C0020000
 * Callers:
...
LABEL_13:
  ...
  *(_OWORD *)&MasterIrp->AssociatedIrp.MasterIrp = *(_OWORD *)(*(_QWORD *)(a1 + 24) + 4936LL);
  a2->IoStatus.Information = 40LL;
  if ( (unsigned int)dword_1C0079058 > 5 && tlgKeywordOn(Length, 0x400000000000LL) )
  {
    v10 = *(_QWORD *)(v8 + 24);
    v19 = 16LL;
    v20 = v9;
    ...
    v27 = 1LL;
    v29 = 1LL;
    tlgWriteTransfer_EtwWriteTransfer(v10, (int)&dword_1C006CE0B, v7, v8, 8u, &v17);
  }
  v11 = 0;
  return RaidCompleteRequestEx(a2, 0, v11);
}
