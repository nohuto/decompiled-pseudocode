/*
 * XREFs of RaidAdapterFilterResourceRequirementsIrp @ 0x1C008C490
 * Callers:
 ...
 *     RaidMachineRequireIoPortResource @ 0x1C00656F8 (RaidMachineRequireIoPortResource.c)
 */
...
__int64 __fastcall RaidAdapterFilterResourceRequirementsIrp(__int64 a1, IRP *a2)
{
  ...
  if ( v4 >= 0 )
  {
    ...
    if ( Information )
    {
      *(_DWORD *)(a1 + 808) = Information[2];
      *(_DWORD *)(a1 + 812) = Information[3];
