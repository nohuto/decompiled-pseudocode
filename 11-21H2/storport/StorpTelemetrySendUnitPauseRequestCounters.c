/*
 * XREFs of StorpTelemetrySendUnitPauseRequestCounters @ 0x1C0003728
 * Callers:
...
void __fastcall StorpTelemetrySendUnitPauseRequestCounters(__int64 a1)
{
  ...
  if ( *(_DWORD *)(a1 + 2144)
    || *(_DWORD *)(a1 + 2148)
    || *(_DWORD *)(a1 + 2152)
    || (v2 = *(_QWORD *)(a1 + 24), *(_DWORD *)(v2 + 5228))
    || *(_DWORD *)(v2 + 5224) )
  {
    if ( (unsigned int)dword_1C0079058 > 5 )
    {
      if ( (unsigned __int8)tlgKeywordOn(a1, 0x400000000000LL) )
      {
        ...
        v37 = &v15;
        v38 = 4LL;
        tlgWriteTransfer_EtwWriteTransfer((int)v6, (int)&dword_1C006FE31, v4, v5, 0xDu, &v16);
      }
    }
    *(_QWORD *)(a1 + 2144) = 0LL;
    *(_DWORD *)(a1 + 2152) = 0;
