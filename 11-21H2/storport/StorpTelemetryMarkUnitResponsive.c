/*
 * XREFs of StorpTelemetryMarkUnitResponsive @ 0x1C0062064
 * Callers:
...
void __fastcall StorpTelemetryMarkUnitResponsive(__int64 a1)
{
  ...
  if ( (*(_BYTE *)(a1 + 450) & 2) != 0 && (unsigned int)dword_1C0079058 > 5 )
  {
    if ( tlgKeywordOn(a1, 0x400000000000LL) )
    {
      ...
      v28 = 4LL;
      v30 = 4LL;
      tlgWriteTransfer_EtwWriteTransfer(v4, (unsigned __int8 *)dword_1C006D2D7, v2, v3, 0xBu, &v12);
    }
  }
}
