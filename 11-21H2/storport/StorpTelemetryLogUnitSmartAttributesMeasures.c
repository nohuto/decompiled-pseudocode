/*
 * XREFs of StorpTelemetryLogUnitSmartAttributesMeasures @ 0x1C0001E48
 * Callers:
...
void __fastcall StorpTelemetryLogUnitSmartAttributesMeasures(__int64 a1)
{
  ...
  if ( (unsigned int)dword_1C0079058 > 5 )
  {
    if ( (unsigned __int8)tlgKeywordOn(a1, 0x400000000000LL) )
    {
      ...
      v50 = 1LL;
      v52 = 1LL;
      tlgCreate1Sz_wchar_t(v53, *(_QWORD *)(v2 + 4592));
      ...
      v103 = v11;
      v104 = 512LL;
      tlgWriteTransfer_EtwWriteTransfer((int)v11, (int)&dword_1C006D778, v12, v13, 0x24u, &v40);
    }
  }
}
