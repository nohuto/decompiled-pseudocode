/*
 * XREFs of StorpTelemetryLogUnitDeviceStatisticsCriticalData @ 0x1C00608A8
 * Callers:
...
void __fastcall StorpTelemetryLogUnitDeviceStatisticsCriticalData(__int64 a1)
{
  ...
  if ( (unsigned int)dword_1C0079058 > 5 && tlgKeywordOn(a1, 0x800000000000LL) )
  {
    v2 = *(_QWORD *)(v1 + 24);
    v46 = 16LL;
    v48 = 16LL;
    ...
    v54 = 1LL;
    v56 = 1LL;
    tlgCreate1Sz_wchar_t((__int64)v57, *(_WORD **)(v2 + 4592));
    ...
    v111 = &v32;
    v112 = 1LL;
    tlgWriteTransfer_EtwWriteTransfer(v26, (unsigned __int8 *)dword_1C0070097, v6, v23, 0x26u, &v44);
  }
}
