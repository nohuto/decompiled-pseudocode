/*
 * XREFs of StorCompareScsiDeviceId @ 0x1C001769C
 * Callers:
 *     StorCompareScsiIdentity @ 0x1C001C444 (StorCompareScsiIdentity.c)
 *     RaidCheckEnclosureIdMapping @ 0x1C003F178 (RaidCheckEnclosureIdMapping.c)
 * Callees:
 *     StorGetNextVPDIdDescriptor @ 0x1C00177FC (StorGetNextVPDIdDescriptor.c)
 *     StorInitVPDIdEnumeration @ 0x1C0017848 (StorInitVPDIdEnumeration.c)
 *     __security_check_cookie @ 0x1C0022BF0 (__security_check_cookie.c)
 *     __report_rangecheckfailure @ 0x1C0022C30 (__report_rangecheckfailure.c)
...
__int64 __fastcall StorCompareScsiDeviceId(__int64 a1, __int64 a2)
{
  ...
  if ( v17[8] || v17[2] || v17[3] )
  {
    if ( v18[8] || v18[2] || v18[3] )
      return 0LL;
  }
  else
  {
