/*
 * XREFs of NtUserPeekMessage @ 0x1C00552B0
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall NtUserPeekMessage(_OWORD *a1, int a2, int a3, int a4, int a5, char a6)
{
  int v10; // ebx
  int MessageMPH; // eax
  ULONG64 v12; // rcx
  ...
  if ( (a6 & 1) != 0 )
  {
    ...
    v19.QuadPart = 0LL;
    if ( KeWaitForSingleObject(*(PVOID *)(v16 + 1416), WrUserRequest, 1, 0, &v19) == 258 )
      return 0LL;
    if ( (a6 & 2) != 0 )
  ...
  else
  {
    ...
    if ( *(int *)(*(_QWORD *)(gptiCurrent + 448LL) + 28LL) > 0 )
      MessageMPH = ClientGetMessageMPH((unsigned int)&v20, a2, a3, a4, a5, 0);
    else
