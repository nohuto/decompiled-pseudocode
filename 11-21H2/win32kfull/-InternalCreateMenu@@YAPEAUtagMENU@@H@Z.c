/*
 * XREFs of ?InternalCreateMenu@@YAPEAUtagMENU@@H@Z @ 0x1C00F5AF4
 * Callers:
 ...
 *     NtUserCreateMenu @ 0x1C0108B40 (NtUserCreateMenu.c)
 *     NtUserCreatePopupMenu @ 0x1C0119CE0 (NtUserCreatePopupMenu.c)
 * Callees:
 *     ??$InitLookAsideRef@UtagMENU@@@@YAEPEAUtagMENU@@@Z @ 0x1C00F5BAC (--$InitLookAsideRef@UtagMENU@@@@YAEPEAUtagMENU@@@Z.c)
