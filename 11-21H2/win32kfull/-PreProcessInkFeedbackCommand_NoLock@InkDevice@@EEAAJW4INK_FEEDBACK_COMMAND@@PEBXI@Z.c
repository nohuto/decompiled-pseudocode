/*
 * XREFs of ?PreProcessInkFeedbackCommand_NoLock@InkDevice@@EEAAJW4INK_FEEDBACK_COMMAND@@PEBXI@Z @ 0x1C02528D0
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall InkDevice::PreProcessInkFeedbackCommand_NoLock(__int64 a1, int a2, unsigned int *a3, __int64 a4)
{
  ...
  if ( a2 == 1 )
  {
    ...
    if ( (v5 & 0x80000000) == 0 || (unsigned int)dword_1C0326250 <= 2 )
      return v5;
LABEL_17:
    v11 = v5;
