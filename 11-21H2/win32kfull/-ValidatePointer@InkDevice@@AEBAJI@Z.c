/*
 * XREFs of ?ValidatePointer@InkDevice@@AEBAJI@Z @ 0x1C0253310
 * Callers:
...
LABEL_25:
    ...
    && *(unsigned __int16 *)(v11 + 110) == *((_DWORD *)this + 33) )
  {
    ...
    if ( !byte_1C033BCD0 )
    {
      if ( (unsigned int)dword_1C0326250 > 5 && tlgKeywordOn((__int64)&dword_1C0326250, 0x400000000000LL) )
        tlgWriteTransfer_EtwWriteTransfer(
          (__int64)&dword_1C0326250,
          (unsigned __int8 *)dword_1C02F1C9B,
          0LL,
          0LL,
          2u,
          &v17);
