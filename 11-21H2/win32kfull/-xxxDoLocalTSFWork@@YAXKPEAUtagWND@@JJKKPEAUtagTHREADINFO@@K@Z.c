/*
 * XREFs of ?xxxDoLocalTSFWork@@YAXKPEAUtagWND@@JJKKPEAUtagTHREADINFO@@K@Z @ 0x1C01E53CC
 * Callers:
        ...
        unsigned int a8)
{
  ...
  if ( (unsigned int)(a1 + 2147483646) > 3 || a7 == (struct tagTHREADINFO *)ThreadWin32Thread )
    v14 = a5;
  else
    v14 = a5 | 4;
  v15 = v14 & 0xFD;
  ...
  v17 = a6 & *(_DWORD *)(*((_QWORD *)a7 + 56) + 24LL);
  if ( (v17 & 0x1700) != 0 && v17 && (v17 & 0xFFFFE8FC) == 0 )
  {
    if ( (v15 & 2) != 0 )
    {
      Notify = CreateNotify(0LL, a1, a2, a3, a4, (PETHREAD *)a7, a8, 1u);
      if ( Notify )
        *((_QWORD *)Notify + 8) = a7;
    }
    else if ( v16 )
    {
      CreateAndPostTSFNotify(a1, a2, a3, a4, a7, (PETHREAD *)a7, a8);
    }
    else
    {
      ...
      LODWORD(v20[6]) = (unsigned int)PsGetThreadId(v19);
      HIDWORD(v20[6]) = a8;
