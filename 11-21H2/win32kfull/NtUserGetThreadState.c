/*
 * XREFs of NtUserGetThreadState @ 0x1C00EB1F0
 * Callers:
 *     <none>
 * Callees:
    ...
    if ( v15 )
    {
      ...
      if ( v16 )
      {
        ...
        if ( v17 )
        {
          ...
          {
            v7 = *(unsigned int *)(*(_QWORD *)(v5 + 424) + 776LL);
          }
        }
        else
        {
