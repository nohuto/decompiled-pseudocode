/*
 * XREFs of ?Feature_Servicing_MSRC86686AppCompatRegression__private_IsEnabled@@YAHXZ @ 0x1C015FEAC
 * Callers:
...
__int64 Feature_Servicing_MSRC86686AppCompatRegression__private_IsEnabled(void)
{
  ...
  CachedFeatureEnabledState = wil_details_FeatureStateCache_GetCachedFeatureEnabledState(
                                ...
                                (__int64)&Feature_Servicing_MSRC86686AppCompatRegression__private_descriptor);
  v1 = (CachedFeatureEnabledState >> 3) & 1;
  wil_details_FeatureReporting_ReportUsageToService(
    (__int64)&Feature_Servicing_MSRC86686AppCompatRegression__private_reporting,
    0x31510DDu,
