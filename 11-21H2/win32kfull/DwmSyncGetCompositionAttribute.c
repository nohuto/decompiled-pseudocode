/*
 * XREFs of DwmSyncGetCompositionAttribute @ 0x1C014E298
 * Callers:
...
__int64 __fastcall DwmSyncGetCompositionAttribute(PVOID Object, __int64 a2, int a3, _QWORD *a4)
{
  ...
  if ( Object )
  {
    if ( !gbInVideoPnpCallout )
    {
      ...
      *(_DWORD *)&v15[40] = 1073741867;
      *(_DWORD *)&v15[44] = 1;
      *(_QWORD *)&v15[48] = a2;
      *(_DWORD *)&v15[56] = v4;
      v11 = qword_1C02ED3A8[2 * v4];
      *(_OWORD *)&v15[64] = v9;
      *(_WORD *)v15 = v11 + 24;
      *(_DWORD *)&v15[60] = qword_1C02ED3A8[2 * v4];
      *(_QWORD *)&v15[80] = v10;
      v14 = 88LL;
      ...
      if ( v8 >= 0 )
        memmove(a4, &v15[64], qword_1C02ED3A8[2 * v4]);
    }
