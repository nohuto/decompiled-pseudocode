/*
 * XREFs of ?STROBJ_bEnumLinked@@YAHPEAVESTROBJ@@PEAKPEAPEAU_GLYPHPOS@@@Z @ 0x1C02A567C
 * Callers:
...
__int64 __fastcall STROBJ_bEnumLinked(struct ESTROBJ *a1, unsigned int *a2, struct _GLYPHPOS **a3)
{
  ...
  if ( v13 )
  {
    if ( (*(_DWORD *)(*(_QWORD *)v13 + 84LL) & 1) != 0
       ? (unsigned int)RFONTOBJ::bInsertGlyphbitsLookaside(
                         *((RFONTOBJ **)a1 + 7),
                         i,
                         *(_DWORD *)(*(_QWORD *)v13 + 88LL)) != 0
