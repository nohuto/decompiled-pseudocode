/*
 * XREFs of ?vIntersectVertical@@YAXPEAVDDA_CLIPLINE@@JPEAU_POINTL@@1PEAJ@Z @ 0x1C0143DEC
 * Callers:
 ...
 *     ?yCompute@DDA_CLIPLINE@@QEAAJJ@Z @ 0x1C0143F90 (-yCompute@DDA_CLIPLINE@@QEAAJJ@Z.c)
 */
