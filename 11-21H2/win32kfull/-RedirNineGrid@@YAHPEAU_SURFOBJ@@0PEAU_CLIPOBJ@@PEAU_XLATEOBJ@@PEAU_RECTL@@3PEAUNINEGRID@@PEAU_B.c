/*
 * XREFs of ?RedirNineGrid@@YAHPEAU_SURFOBJ@@0PEAU_CLIPOBJ@@PEAU_XLATEOBJ@@PEAU_RECTL@@3PEAUNINEGRID@@PEAU_BLENDOBJ@@PEAX@Z @ 0x1C029B0C0
 * Callers:
 *     <none>
 * Callees:
        ...
        void *a9)
{
            ...
            if ( v17 )
            {
              if ( (*(_DWORD *)(v17 + 1792) & 0x8000000) != 0 && (*(_DWORD *)(v17 + 2096) & 0x8000) != 0 )
              {
                if ( *(_QWORD *)(*(_QWORD *)(v17 + 1760) + 792LL) )
                {
                  ...
                  (*(void (__fastcall **)(struct _SURFOBJ *, struct _SURFOBJ *, struct _CLIPOBJ *, struct _XLATEOBJ *, struct _RECTL *, struct _RECTL *, struct NINEGRID *, struct _BLENDOBJ *, void *))(*(_QWORD *)(v20 + 1760) + 792LL))(
                    v19,
                    DevBitmap,
                    a3,
                    a4,
  ...
  v21 = EngNineGrid(a1, (__int64)a2, (__int64)a3, (__int64)a4, (__int64)a5, (__int64)a6, (__int64)a7, (__int64)a8);
  if ( v24 )
    bMakeOpaque(v24);
  if ( v25 )
    bMakeOpaque(v25);
