/*
 * XREFs of WPP_RECORDER_AND_TRACE_SF_qdddddddds @ 0x1C007B97C
 * Callers:
...
_UNKNOWN **__fastcall WPP_RECORDER_AND_TRACE_SF_qdddddddds(
        __int64 a1,
        char a2,
        char a3,
        __int64 a4,
        ...
        const char *a18)
{
  ...
  if ( a2 )
  {
    ...
    result = (_UNKNOWN **)((__int64 (__fastcall *)(__int64, __int64, void *, __int64, char *, __int64, char *, __int64, char *, __int64, char *, __int64, char *, __int64, char *, __int64, char *, __int64, char *, __int64, char *, __int64, const char *, __int64, _QWORD))pfnWppTraceMessage)(
                            a1,
                            43LL,
                            &WPP_5d8c16ef74033e1c3b6bd48607943c03_Traceguids,
                            13LL,
                            &a9,
                            8LL,
                            &a10,
