/*
 * XREFs of ?bRoundRect@@YAHAEAVEPATHOBJ@@AEAVEBOX@@JJ@Z @ 0x1C0015C48
 * Callers:
 ...
 *     ?bToPOINTL@EPOINTFL@@QEAAHAEAU_POINTL@@@Z @ 0x1C0016024 (-bToPOINTL@EPOINTFL@@QEAAHAEAU_POINTL@@@Z.c)
...
__int64 __fastcall bRoundRect(struct EPATHOBJ *a1, struct EBOX *a2)
{
  ...
  v7 = 0;
  if ( (unsigned int)EFLOAT::bIsZero((EFLOAT *)&v27) || (unsigned int)EFLOAT::bIsZero((EFLOAT *)&v26) )
  {
    v10 = FP_0_0;
    v11 = FP_0_0;
  }
