/*
 * XREFs of ?xxxDCEWindowHitTest@@YAPEAUHWND__@@PEAUtagWND@@I_K_JUtagPOINT@@PEAHK@Z @ 0x1C0064850
 * Callers:
        ...
        unsigned int a7)
{
  ...
  v16 = 0LL;
  v15 = 0LL;
  return xxxDCEWindowHitTestIndirect((ULONG_PTR)a1, a5, 0, (struct tagDCE_WINDOW_HIT_TEST_ARGS *)v8);
}
