/*
 * XREFs of ?QueryTrueTypeTable@PFFOBJ@@QEAAJ_KKKJKPEAEPEAPEAEPEAK@Z @ 0x1C0018854
 * Callers:
 ...
 * Callees:
 *     ?bCheckFntFileInfo@PFFOBJ@@QEAAHXZ @ 0x1C001880C (-bCheckFntFileInfo@PFFOBJ@@QEAAHXZ.c)
