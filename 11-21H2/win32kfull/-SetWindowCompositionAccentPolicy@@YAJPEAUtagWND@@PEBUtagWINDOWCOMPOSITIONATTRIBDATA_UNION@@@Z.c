/*
 * XREFs of ?SetWindowCompositionAccentPolicy@@YAJPEAUtagWND@@PEBUtagWINDOWCOMPOSITIONATTRIBDATA_UNION@@@Z @ 0x1C010F9D8
 * Callers:
        ...
        const struct tagWINDOWCOMPOSITIONATTRIBDATA_UNION *a2)
{
  ...
  {
    if ( v6[1] == *(_QWORD *)a2 && LODWORD(v6[2]) == *((_DWORD *)a2 + 2) )
    {
      return 0;
    }
    else
