/*
 * XREFs of ?CoalesceMessage@Delivery@InputTraceLogging@@SAXPEBUtagQMSG@@_K@Z @ 0x1C0116FD4
 * Callers:
...
void __fastcall InputTraceLogging::Delivery::CoalesceMessage(const struct tagQMSG *a1)
{
  ...
  {
    if ( (unsigned int)dword_1C032BE20 > 4 && tlgKeywordOn((__int64)&dword_1C032BE20, 16LL) )
    {
      ...
      tlgWriteTransfer_EtwWriteTransfer(
        ...
        (unsigned __int8 *)dword_1C02EEC91,
        0LL,
        0LL,
        v3 - 8,
        &v22);
  ...
  else if ( InputTraceLogging::IsMouseInputMessage(v1) && (unsigned int)dword_1C032BE20 > 4 )
  {
    if ( tlgKeywordOn((__int64)&dword_1C032BE20, 16LL) )
    {
      v19 = *(_QWORD *)(v14 + 136);
      v20 = v15;
      v16 = v13;
