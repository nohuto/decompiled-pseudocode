/*
 * XREFs of ?pvFileUMPD@RFONTOBJ@@QEAAPEAXPEAKPEAPEAX@Z @ 0x1C02A7140
 * Callers:
 ...
 * Callees:
 *     ?pchTranslateUMPD@RFONTOBJ@@QEAAPEADPEBDPEAPEAX@Z @ 0x1C02A6EA8 (-pchTranslateUMPD@RFONTOBJ@@QEAAPEADPEBDPEAPEAX@Z.c)
