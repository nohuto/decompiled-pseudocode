/*
 * XREFs of NtUserThreadMessageQueueAttached @ 0x1C00E4880
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall NtUserThreadMessageQueueAttached(unsigned int a1)
{
  ...
  if ( gptiCurrent )
  {
    *(_DWORD *)(gptiCurrent + 1256LL) &= ~0x200u;
    if ( a1 )
    {
    ...
    else
    {
      ...
      v5 = 0;
      v2 = *(_QWORD *)(v4 + 472);
      if ( v2 && (v5 = 1, *(_QWORD *)(v2 + 1488))
        || (v2 = *(_QWORD *)(v4 + 480)) != 0 && ((unsigned int)(v5 + 1) > 1 || *(_QWORD *)(v2 + 1496)) )
      {
        v3 = 1LL;
      }
    }
