/*
 * XREFs of ??$?DVCFixPred@Prediction@@$02@Prediction@@YA?AV?$SquareMatrix@VCFixPred@Prediction@@$02@0@AEBV10@AEBVCFixPred@0@@Z @ 0x1C016BCB8
 * Callers:
...
char *__fastcall Prediction::operator*<Prediction::CFixPred,3>(char *a1, __int64 a2, unsigned __int64 *a3)
{
  ...
  do
  {
    ...
    do
    {
      v10 = *(_QWORD *)&v7[v6];
      v11 = -v10;
      v12 = (__int64)(*a3 ^ v10) >> 63;
      if ( v10 >= 0 )
        v11 = *(_QWORD *)&v7[v6];
      v13 = -(__int64)*a3;
      if ( (*a3 & 0x8000000000000000uLL) == 0LL )
        v13 = *a3;
      v14 = (unsigned int)v13 * (unsigned __int64)(unsigned int)v11;
      v15 = HIDWORD(v13);
      v16 = HIDWORD(v14) + (unsigned int)v13 * HIDWORD(v11);
      v17 = v12 ^ ((unsigned int)(v16 + v11 * v15) | ((unsigned __int64)(unsigned int)((((unsigned int)v16
                                                                                       + (unsigned int)v11 * v15) >> 32)
                                                                                     + HIDWORD(v11) * v15
                                                                                     + HIDWORD(v16)) << 32));
      v18 = v17 - v12;
      if ( (_DWORD)v14 )
