/*
 * XREFs of ?ProcessInkFeedbackCommand@InkDevice@@EEAAJW4INK_FEEDBACK_COMMAND@@PEBXI@Z @ 0x1C0252AE0
 * Callers:
 *     <none>
 * Callees:
 ...
 *     ?IsSuperWetInkStartDataSupported@@YA_NW4InkFeedbackCapabilities@@PEBUIFC_SUPERWET_INK_START_DATA@@@Z @ 0x1C0250C3C (-IsSuperWetInkStartDataSupported@@YA_NW4InkFeedbackCapabilities@@PEBUIFC_SUPERWET_INK_START_DATA.c)
...
__int64 __fastcall InkDevice::ProcessInkFeedbackCommand(__int64 a1, unsigned int a2, __int64 a3, __int64 a4)
{
  ...
  __int64 v18; // r9
  __int64 v19; // rax
  struct InkFeedbackProviderBase::ActiveCommand *v20; // rsi
  __int64 v21; // r8
  __int64 v22; // r9
  ...
  if ( *(_BYTE *)(a1 - 20) )
  {
    if ( a2 == 1 )
    {
      if ( (_DWORD)a4 == 64 )
      {
        v13 = (unsigned int)dword_1C0326250;
        ...
        if ( *(_DWORD *)(a1 + 40) < *(_DWORD *)(a1 + 108) )
        {
          if ( !InkFeedbackProviderBase::FindActiveCommandByTargetPointerId(a1, 1, *(_DWORD *)a3) )
          {
            if ( IsSuperWetInkStartDataSupported(*(_DWORD *)(a1 + 116), a3) )
            {
              ...
              v20 = (struct InkFeedbackProviderBase::ActiveCommand *)v19;
              if ( v19 )
              {
                *(_QWORD *)(v19 + 16) = 0LL;
                *(_QWORD *)(v19 + 24) = 0LL;
                ...
                *(_QWORD *)(v19 + 24) = KeGetCurrentThread();
                ...
                if ( (v7 & 0x80000000) != 0 )
                  ...
                  InkFeedbackProviderBase::AddActiveCommand((InkFeedbackProviderBase *)a1, v20, v21, v22);
              }
              else
              {
                v7 = -1073741801;
        ...
        else
        {
          ...
          v15 = (unsigned __int8 *)&unk_1C02F1E74;
