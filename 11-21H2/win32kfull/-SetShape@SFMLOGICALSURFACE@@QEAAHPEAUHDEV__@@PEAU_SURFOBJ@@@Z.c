/*
 * XREFs of ?SetShape@SFMLOGICALSURFACE@@QEAAHPEAUHDEV__@@PEAU_SURFOBJ@@@Z @ 0x1C00807CC
 * Callers:
 ...
 *     vSpDwmMigrateLSurfShapeReferenceWrap @ 0x1C0121CB0 (vSpDwmMigrateLSurfShapeReferenceWrap.c)
 * Callees:
