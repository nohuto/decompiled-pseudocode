/*
 * XREFs of xxxSetDialogSystemMenu @ 0x1C0114B34
 * Callers:
 *     NtUserSetDialogSystemMenu @ 0x1C0114A80 (NtUserSetDialogSystemMenu.c)
 * Callees:
...
__int64 __fastcall xxxSetDialogSystemMenu(__int64 a1)
{
  ...
  v3 = 0;
  v7 = 0LL;
  SmartObjStackRefBase<tagMENU>::operator=((__int64)v6, *(_QWORD *)(v2 + 64));
