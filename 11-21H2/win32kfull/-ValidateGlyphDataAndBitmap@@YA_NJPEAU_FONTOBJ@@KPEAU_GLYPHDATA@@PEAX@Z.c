/*
 * XREFs of ?ValidateGlyphDataAndBitmap@@YA_NJPEAU_FONTOBJ@@KPEAU_GLYPHDATA@@PEAX@Z @ 0x1C015FF14
 * Callers:
...
char __fastcall ValidateGlyphDataAndBitmap(int a1, struct _FONTOBJ *a2, int a3, struct _GLYPHDATA *a4, int *a5)
{
  ...
  if ( a3 != 3 )
  {
    if ( !(unsigned int)Feature_Servicing_MSRC86686AppCompatRegression__private_IsEnabled() )
    {
