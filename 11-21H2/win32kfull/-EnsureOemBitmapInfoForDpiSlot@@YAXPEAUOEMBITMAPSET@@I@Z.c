/*
 * XREFs of ?EnsureOemBitmapInfoForDpiSlot@@YAXPEAUOEMBITMAPSET@@I@Z @ 0x1C00C3180
 * Callers:
 ...
 * Callees:
 *     ?ArrangeFrameControls@@YAFHHPEAUOEMBITMAPSET@@@Z @ 0x1C00C3490 (-ArrangeFrameControls@@YAFHHPEAUOEMBITMAPSET@@@Z.c)
