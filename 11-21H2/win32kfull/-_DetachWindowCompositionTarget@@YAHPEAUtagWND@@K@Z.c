/*
 * XREFs of ?_DetachWindowCompositionTarget@@YAHPEAUtagWND@@K@Z @ 0x1C00B36BC
 * Callers:
 *     ?DetachWindowCompositionTarget@@YAJPEAUHWND__@@K@Z @ 0x1C00B359C (-DetachWindowCompositionTarget@@YAJPEAUHWND__@@K@Z.c)
 * Callees:
