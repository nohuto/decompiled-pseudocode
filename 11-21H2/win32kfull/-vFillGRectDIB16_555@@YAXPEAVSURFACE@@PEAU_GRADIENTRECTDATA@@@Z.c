/*
 * XREFs of ?vFillGRectDIB16_555@@YAXPEAVSURFACE@@PEAU_GRADIENTRECTDATA@@@Z @ 0x1C02CF340
 * Callers:
 *     <none>
 * Callees:
 *     <none>
  ...
  if ( v3 < *((_DWORD *)v2 + 11) + v3 )
  {
    ...
    do
    {
      ...
      if ( v19 < &v19[*((int *)v2 + 10)] )
      {
        ...
        {
          v22 = v21++;
          v23 = *(_DWORD *)(0x1C0000000LL + 16LL * (v12 & 3) + 3348160 + 4LL * (v22 & 3));
          v24 = HIDWORD(v16);
          v16 += v30;
          v25 = Saturation16_5[(unsigned __int64)(v23 + ((unsigned int)v24 >> 3)) >> 16];
          v26 = HIDWORD(v15);
          v15 += v31;
          v27 = Saturation16_5[(unsigned __int64)(v23 + ((unsigned int)v26 >> 3)) >> 16] | (unsigned __int16)(32 * v25);
          v28 = HIDWORD(v17);
          v17 += v32;
          *v19++ = Saturation16_5[(unsigned __int64)(v23 + ((unsigned int)v28 >> 3)) >> 16] | (unsigned __int16)(32 * v27);
        }
        while ( v19 < v20 );
        v2 = a2;
        v6 = v41;
