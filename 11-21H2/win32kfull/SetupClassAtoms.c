/*
 * XREFs of SetupClassAtoms @ 0x1C0115660
 * Callers:
 *     <none>
 * Callees:
 *     <none>
...
__int64 SetupClassAtoms()
{
  ...
  *(_WORD *)(gpsi + 1378LL) = UserAddAtomEx(L"SysFrostedWindow", 1LL, 2LL);
  ...
  LOWORD(WPP_MAIN_CB.Dpc.TargetInfoAsUlong) = UserAddAtomEx(L"SysCP", 1LL, 2LL);
  v8 = LOWORD(WPP_MAIN_CB.Dpc.TargetInfoAsUlong) != 0 && v7;
  ...
  v16 = atomDWMProp != 0 ? v15 : 0;
  WORD2(WPP_MAIN_CB.Queue.Wcb.DeviceObject) = UserAddAtomEx(L"SysSwapChain", 1LL, 2LL);
  v17 = WORD2(WPP_MAIN_CB.Queue.Wcb.DeviceObject) != 0;
  CHwndTargetProp::s_atom = UserAddAtomEx(L"SysDCompHwndTargets", 1LL, 2LL);
  LOWORD(WPP_MAIN_CB.Queue.Wcb.DeviceObject) = UserAddAtomEx(L"SysVisRgnTracker", 1LL, 2LL);
  v18 = LOWORD(WPP_MAIN_CB.Queue.Wcb.DeviceObject) != 0 && CHwndTargetProp::s_atom != 0 && v16 & v17;
  ...
  *(_WORD *)(gpsi + 914LL) = gatomShadow;
  ...
  v32 = gatomFeedbackSettings != 0 ? v31 : 0;
  ...
  WORD2(WPP_MAIN_CB.Dpc.DpcListEntry.Next) = UserAddAtomEx(L"BrokeredForeground", 1LL, 2LL);
  v34 = WORD2(WPP_MAIN_CB.Dpc.DpcListEntry.Next) != 0 ? v33 : 0;
