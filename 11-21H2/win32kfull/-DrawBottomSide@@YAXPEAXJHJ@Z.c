/*
 * XREFs of ?DrawBottomSide@@YAXPEAXJHJ@Z @ 0x1C0239460
 * Callers:
...
void __fastcall DrawBottomSide(char *a1, int a2, int a3, int a4)
{
  ...
  if ( a3 )
  {
    ...
    while ( (__int64)v10 < (__int64)&unk_1C02F48FC );
  }
  else
  {
    v14 = a2 - v4;
    v15 = &xmmword_1C02F48E8;
    do
    {
      if ( v14 > 10 )
      {
    ...
    while ( (__int64)v15 < (__int64)&unk_1C02F48FC );
  }
}
