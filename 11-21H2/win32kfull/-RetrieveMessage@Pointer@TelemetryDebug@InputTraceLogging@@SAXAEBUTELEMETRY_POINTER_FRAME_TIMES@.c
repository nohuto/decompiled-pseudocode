/*
 * XREFs of ?RetrieveMessage@Pointer@TelemetryDebug@InputTraceLogging@@SAXAEBUTELEMETRY_POINTER_FRAME_TIMES@@@Z @ 0x1C016C39A
 * Callers:
        ...
        const struct TELEMETRY_POINTER_FRAME_TIMES *a1)
{
  ...
  {
    if ( (unsigned int)dword_1C032BE20 > 7 && tlgKeywordOn((__int64)&dword_1C032BE20, 0x10000LL) )
    {
      v21 = *((_QWORD *)a1 + 17);
      v22 = *((_QWORD *)a1 + 16);
      v23 = *((_QWORD *)a1 + 15);
  ...
  else if ( (unsigned int)dword_1C032BE20 > 7 )
  {
    if ( tlgKeywordOn((__int64)&dword_1C032BE20, 0x10000LL) )
    {
      v21 = *((_QWORD *)a1 + 7);
      v22 = *((_QWORD *)a1 + 6);
      v23 = *((_QWORD *)a1 + 5);
