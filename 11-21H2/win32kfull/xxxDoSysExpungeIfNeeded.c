/*
 * XREFs of xxxDoSysExpungeIfNeeded @ 0x1C015D208
 * Callers:
...
void __fastcall xxxDoSysExpungeIfNeeded(__int64 a1, __int64 a2, __int64 a3, __int64 a4)
{
  ...
  v9 = *(_QWORD *)(a1 + 424);
  v15 = 1;
  if ( *(_DWORD *)(v9 + 400) == gcSysExpunge )
    goto LABEL_11;
  *(_DWORD *)(v9 + 400) = gcSysExpunge;
  if ( (*(_DWORD *)(*(_QWORD *)(a1 + 424) + 404LL) & *(_DWORD *)&WPP_MAIN_CB.DeviceQueue.Busy) != 0 )
    xxxDoSysExpunge(a1);
  if ( v15 )
  {
LABEL_11:
