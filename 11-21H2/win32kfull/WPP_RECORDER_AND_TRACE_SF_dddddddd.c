/*
 * XREFs of WPP_RECORDER_AND_TRACE_SF_dddddddd @ 0x1C012036C
 * Callers:
...
_UNKNOWN **WPP_RECORDER_AND_TRACE_SF_dddddddd(
        __int64 a1,
        char a2,
        char a3,
        __int64 a4,
        ...
        ...)
{
  ...
  _UNKNOWN *retaddr; // [rsp+C0h] [rbp+Fh] BYREF
  __int64 v13; // [rsp+108h] [rbp+57h] BYREF
  ...
  __int64 v19; // [rsp+120h] [rbp+6Fh] BYREF
  va_list va3; // [rsp+120h] [rbp+6Fh]
  __int64 v21; // [rsp+128h] [rbp+77h] BYREF
  va_list va4; // [rsp+128h] [rbp+77h]
  __int64 v23; // [rsp+130h] [rbp+7Fh] BYREF
  va_list va5; // [rsp+130h] [rbp+7Fh]
  __int64 v25; // [rsp+138h] [rbp+87h] BYREF
  ...
  result = &retaddr;
  if ( a2 )
    result = (_UNKNOWN **)((__int64 (__fastcall *)(__int64, __int64, __int64, _QWORD, __int64 *, __int64, __int64 *, __int64, __int64 *, __int64, __int64 *, __int64, __int64 *, __int64, __int64 *, __int64, __int64 *, __int64, char *, __int64, _QWORD))pfnWppTraceMessage)(
                            a1,
                            43LL,
                            a8,
                            a7,
  ...
  {
    LOWORD(v11) = a7;
    return (_UNKNOWN **)WppAutoLogTrace(a4, 4LL, a6, a8, v11, (__int64 *)va, 4LL, (__int64 *)va1, 4LL, (__int64 *)va2);
  }
  return result;
}
