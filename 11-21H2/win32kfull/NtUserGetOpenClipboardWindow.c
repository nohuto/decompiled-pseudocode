/*
 * XREFs of NtUserGetOpenClipboardWindow @ 0x1C00CA5F0
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall NtUserGetOpenClipboardWindow(__int64 a1, __int64 a2, __int64 a3)
{
