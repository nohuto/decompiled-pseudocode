/*
 * XREFs of UmfdLoadFontFile @ 0x1C00E9FA0
 * Callers:
 *     <none>
 * Callees:
...
PVOID __fastcall UmfdLoadFontFile(__int64 a1, __int64 a2, __int64 a3, __int64 a4, __int64 a5, int a6, int a7)
{
  ...
  struct _SLIST_ENTRY v19[2]; // [rsp+48h] [rbp-C0h] BYREF
  ...
  FontDriverDdiRequest::FontDriverDdiRequest((__int64)v19, 4);
  v27 = 0LL;
  v28 = -1;
  pv = 0LL;
  v19[0].Next = (struct _SLIST_ENTRY *)&LoadFontFileRequest::`vftable';
  v26 = a5;
  LODWORD(v20) = v10;
  v12 = 0LL;
  v24 = a6;
  ...
  v22 = a3;
  v23 = a4;
  if ( (int)UmfdClientSendAndWaitForCompletion(2u, v19) >= 0 && (v12 = pv, (v15 = pv) != 0LL) )
  {
