/*
 * XREFs of ?SpStrokeAndFillPath@@YAHPEAU_SURFOBJ@@PEAU_PATHOBJ@@PEAU_CLIPOBJ@@PEAU_XFORMOBJ@@PEAU_BRUSHOBJ@@PEAU_LINEATTRS@@4PEAU_POINTL@@KK@Z @ 0x1C027D860
 * Callers:
 *     <none>
 * Callees:
        ...
        unsigned int a10)
{
  ...
  struct _POINTL v32; // [rsp+78h] [rbp-88h] BYREF
  ...
  while ( (unsigned int)ENUMUNDERLAYS::bEnum((ENUMUNDERLAYS *)v43, &v30, &v32, &v29) )
  {
    v13 = 0LL;
...
LABEL_38:
      v11 = v34;
      if ( !(unsigned int)OffStrokeAndFillPath(v27, &v32, v14, this, v24, v34, v38, v33, v37, v36, a9, a10) )
        v12 = -1;
      if ( !v13 )
        v13 = this;
      this = v13;
