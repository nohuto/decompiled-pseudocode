/*
 * XREFs of ?Feature_4093980987__private_IsEnabled@@YAHXZ @ 0x1C015D41C
 * Callers:
...
__int64 Feature_4093980987__private_IsEnabled(void)
{
  ...
  CachedFeatureEnabledState = wil_details_FeatureStateCache_GetCachedFeatureEnabledState(
                                (unsigned int *)&Feature_4093980987__private_featureState,
                                (__int64)&Feature_4093980987__private_descriptor);
  v1 = (CachedFeatureEnabledState >> 3) & 1;
  wil_details_FeatureReporting_ReportUsageToService(
    (__int64)&Feature_4093980987__private_reporting,
    0x3105FA3u,
