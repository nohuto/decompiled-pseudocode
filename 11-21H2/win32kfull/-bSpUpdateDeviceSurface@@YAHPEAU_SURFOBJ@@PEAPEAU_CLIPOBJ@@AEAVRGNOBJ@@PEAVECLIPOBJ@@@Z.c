/*
 * XREFs of ?bSpUpdateDeviceSurface@@YAHPEAU_SURFOBJ@@PEAPEAU_CLIPOBJ@@AEAVRGNOBJ@@PEAVECLIPOBJ@@@Z @ 0x1C01147B0
 * Callers:
      ...
      if ( *(_QWORD *)a3 != *(_QWORD *)v15 )
      {
        if ( RGNOBJ::bCopy(a3, (struct RGNOBJ *)&v19) )
        {
          ...
          if ( v24[0] )
          {
            ...
            {
              hdev = a1->hdev;
              v20.x = -*((_DWORD *)hdev + 640);
              v20.y = -*((_DWORD *)hdev + 641);
...
LABEL_33:
  wil::details::lambda_call<_lambda_d4ac050843a32da14874304f2689d2a8_>::~lambda_call<_lambda_d4ac050843a32da14874304f2689d2a8_>(v25);
  SPRITERANGELOCK::vUnlock((SPRITERANGELOCK *)v21);
  return v5;
}
