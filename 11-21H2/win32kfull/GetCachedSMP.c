/*
 * XREFs of GetCachedSMP @ 0x1C013D0AC
 * Callers:
...
__int64 __fastcall GetCachedSMP(__int64 a1, __m128i *a2)
{
  __m128i *v2; // rbx
  __int64 v3; // r15
  char v4; // dl
  ...
  if ( v2->m128i_u8[3] >= 0x12u )
    return (unsigned int)CreateStandardMonoPattern(v3, v2);
  if ( v4 != 8 )
    return (unsigned int)CreateStandardMonoPattern(v3, v2);
  if ( v5 != 15 )
    return (unsigned int)CreateStandardMonoPattern(v3, v2);
  CachedSMP = (__m128i *)FindCachedSMP(a1, v2->m128i_u8[3]);
  if ( !CachedSMP )
    return (unsigned int)CreateStandardMonoPattern(v3, v2);
  v7 = v2->m128i_u8[2];
  v8 = CachedSMP + 1;
  ...
  v2->m128i_i16[5] = v9.m128i_i16[2];
  v2->m128i_i16[4] = v9.m128i_i16[1];
  v10 = ComputeBytesPerScanLine(1LL, v7, v9.m128i_u16[1]);
  v13 = (char *)v2[1].m128i_i64[0];
  v14 = v13;
  v15 = v12 * v10;
  v16 = v10;
  v2->m128i_i16[3] = v10;
