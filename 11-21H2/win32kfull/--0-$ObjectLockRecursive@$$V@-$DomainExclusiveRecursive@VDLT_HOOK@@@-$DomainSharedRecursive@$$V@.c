/*
 * XREFs of ??0?$ObjectLockRecursive@$$V@?$DomainExclusiveRecursive@VDLT_HOOK@@@?$DomainSharedRecursive@$$V@@QEAA@XZ @ 0x1C0070274
 * Callers:
        ...
        __int64 a1)
{
  ...
  *(_BYTE *)(a1 + 40) = 0;
  do
  {
    ...
    if ( *(_BYTE *)(v4 + 8) )
    {
      if ( ExIsResourceAcquiredExclusiveLite(*(PERESOURCE *)v6) == 1 )
        goto LABEL_5;
