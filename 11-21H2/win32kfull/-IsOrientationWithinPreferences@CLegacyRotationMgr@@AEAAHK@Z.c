/*
 * XREFs of ?IsOrientationWithinPreferences@CLegacyRotationMgr@@AEAAHK@Z @ 0x1C01CD6C8
 * Callers:
...
__int64 __fastcall CLegacyRotationMgr::IsOrientationWithinPreferences(CLegacyRotationMgr *this, int a2)
{
  ...
  if ( ActivePpiPreference != 0x80000000 )
  {
    ...
    v6 = a2 - 1;
    if ( !v6 )
      return ActivePpiPreference & (dword_1C0331978 != 0 ? 4 : 2);
    v7 = v6 - 1;
    if ( v7 )
    {
      if ( v7 != 1 )
        return v3;
      v8 = dword_1C0331978 != 0 ? 1 : 8;
    }
    else
    {
      v8 = dword_1C0331978 != 0 ? 8 : 4;
    }
