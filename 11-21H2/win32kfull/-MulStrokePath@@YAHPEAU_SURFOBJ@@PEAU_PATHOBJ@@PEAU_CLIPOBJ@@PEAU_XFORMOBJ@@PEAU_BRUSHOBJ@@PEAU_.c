/*
 * XREFs of ?MulStrokePath@@YAHPEAU_SURFOBJ@@PEAU_PATHOBJ@@PEAU_CLIPOBJ@@PEAU_XFORMOBJ@@PEAU_BRUSHOBJ@@PEAU_POINTL@@PEAU_LINEATTRS@@K@Z @ 0x1C02A2C30
 * Callers:
 *     <none>
 * Callees:
        ...
        MIX mix)
{
  ...
  __int64 **v23[7]; // [rsp+A0h] [rbp-60h] BYREF
  ...
  if ( v22[0] )
  {
    ...
    for ( i = MSURF::bFindSurface(v23, a1, a3, &v31); i; i = MSURF::bNextSurface((MSURF *)v23) )
    {
      ...
      if ( ((__int64)v25[1].hsurf & 0x20) != 0 )
        v18 = *(BOOL (__stdcall **)(SURFOBJ *, PATHOBJ *, CLIPOBJ *, XFORMOBJ *, BRUSHOBJ *, POINTL *, LINEATTRS *, MIX))(*((_QWORD *)v24 + 7) + 2776LL);
      else
        v18 = EngStrokePath;
      v11 &= OffStrokePath(
