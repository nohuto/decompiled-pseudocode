/*
 * XREFs of ?vSrcOpaqCopyS8D16Unsafe@@YAXPEBEJJPEAEJJJJKKPEAVSURFACE@@@Z @ 0x1C0276BFC
 * Callers:
        ...
        struct SURFACE *a11)
{
  ...
  v15 = pvFillOpaqTableCT(2u, a9, a10, a11, (struct _BLENDINFO *)v21, 0);
  v16 = &a1[v13];
  v17 = &a4[2 * a5];
  while ( a8 )
  {
