/*
 * XREFs of ?bSetHTSrcSurfInfo@@YAHPEAU_SURFOBJ@@VXEPALOBJ@@PEAU_HTSURFACEINFO@@PEAU_XLATEOBJ@@@Z @ 0x1C009222C
 * Callers:
  ...
  else
  {
    ...
    *(_DWORD *)(v12 + 8) = v9;
    if ( v9 )
    {
      ...
      {
        XEPALOBJ::ulGetEntries((XEPALOBJ *)&v21, 0, v9, (struct tagPALETTEENTRY *)v13, v17);
      }
    }
  }
  result = 1LL;
