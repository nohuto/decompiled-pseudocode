/*
 * XREFs of ?Feature_1938628922__private_IsEnabled@@YAHXZ @ 0x1C015C598
 * Callers:
...
__int64 Feature_1938628922__private_IsEnabled(void)
{
  ...
  CachedFeatureEnabledState = wil_details_FeatureStateCache_GetCachedFeatureEnabledState(
                                (unsigned int *)&Feature_1938628922__private_featureState,
                                (__int64)&Feature_1938628922__private_descriptor);
  v1 = (CachedFeatureEnabledState >> 3) & 1;
  wil_details_FeatureReporting_ReportUsageToService(
    (__int64)&Feature_1938628922__private_reporting,
    0x314BDC2u,
