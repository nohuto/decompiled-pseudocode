/*
 * XREFs of ?bSrcCopySRLE4D8@@YAHPEAUBLTINFO@@@Z @ 0x1C02CD4C0
 * Callers:
 *     <none>
 * Callees:
 *     <none>
...
__int64 __fastcall bSrcCopySRLE4D8(struct BLTINFO *a1)
{
  ...
  unsigned int v43; // [rsp+4h] [rbp-64h]
      ...
      else
      {
        if ( v8 < v3 )
        {
          ...
          if ( (v19 & 1) != 0 )
          {
            ...
            v8 = v3 + 1;
            LODWORD(v16) = v16 - 1;
            *(_BYTE *)(v3 + v6) = *(_BYTE *)(v46 + 4LL * (v20 & 0xF));
          }
        }
        if ( (int)v16 + v8 <= v4 )
        {
        ...
        {
          v28 = v8++;
          *(_BYTE *)(v28 + v6) = *(_BYTE *)(v46 + 4 * ((unsigned __int64)(unsigned __int8)*v5 >> 4));
