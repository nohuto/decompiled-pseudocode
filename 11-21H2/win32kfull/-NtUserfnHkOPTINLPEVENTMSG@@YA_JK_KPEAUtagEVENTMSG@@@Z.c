/*
 * XREFs of ?NtUserfnHkOPTINLPEVENTMSG@@YA_JK_KPEAUtagEVENTMSG@@@Z @ 0x1C01F0F84
 * Callers:
...
__int64 __fastcall NtUserfnHkOPTINLPEVENTMSG(unsigned int a1, unsigned __int64 a2, struct tagEVENTMSG *a3)
{
