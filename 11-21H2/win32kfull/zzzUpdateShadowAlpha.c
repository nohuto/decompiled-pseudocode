/*
 * XREFs of zzzUpdateShadowAlpha @ 0x1C012E250
 * Callers:
...
struct tagSHADOW *__fastcall zzzUpdateShadowAlpha(struct tagWND *a1)
{
  ...
  char v16; // [rsp+B8h] [rbp+6Fh] BYREF
  ...
  if ( result )
  {
    ThreadLock(v3, (__int64 *)&v12);
    if ( (unsigned int)GetLayeredWindowAttributes(a1, v11, &v16, &v18) )
    {
      if ( (v18 & 2) != 0 )
      {
        BYTE2(v17) = v16;
        BYTE3(v17) = 1;
        ThreadLock(*((_QWORD *)v4 + 1), (__int64 *)&v14);
