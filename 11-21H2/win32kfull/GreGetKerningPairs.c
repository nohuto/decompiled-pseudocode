/*
 * XREFs of GreGetKerningPairs @ 0x1C01301E4
 * Callers:
 ...
 *     ?cKernPairs@PFEOBJ@@QEAAKPEAPEAU_FD_KERNINGPAIR@@@Z @ 0x1C01306B8 (-cKernPairs@PFEOBJ@@QEAAKPEAPEAU_FD_KERNINGPAIR@@@Z.c)
 */
...
__int64 __fastcall GreGetKerningPairs(HDC a1, unsigned int a2, unsigned __int64 a3)
{
  ...
  float v17; // [rsp+28h] [rbp-80h] BYREF
  int v18; // [rsp+2Ch] [rbp-7Ch]
  struct _FD_KERNINGPAIR *v19; // [rsp+30h] [rbp-78h] BYREF
  _QWORD v20[2]; // [rsp+38h] [rbp-70h] BYREF
  __int64 v21; // [rsp+48h] [rbp-60h]
  _QWORD v22[8]; // [rsp+50h] [rbp-58h] BYREF
