/*
 * XREFs of ?vMovePointer@@YAXPEAUHDEV__@@HHJ@Z @ 0x1C010A35C
 * Callers:
  ...
  if ( a1[16] != (_DWORD)a2 || a1[17] != (_DWORD)a3 || (a1[10] & 0x100000) != 0 )
  {
    ...
    if ( (v8 & 0x400) == 0 )
    {
      ...
      if ( v9 )
      {
        ...
        if ( (v8 & 2) != 0 )
        {
          v11 = (void (__fastcall *)(struct _SURFOBJ *))*((_QWORD *)a1 + 425);
          if ( v11 )
          {
            v11(v10);
          }
        ...
        if ( (a1[448] & 0x10000) != 0 && v5 != -1 && v6 < v10->sizlBitmap.cx )
        {
          ...
          if ( v5 < cy )
          {
            v13 = (void (__fastcall *)(struct _SURFOBJ *, _QWORD, _QWORD, _QWORD))*((_QWORD *)a1 + 363);
            if ( v13 )
