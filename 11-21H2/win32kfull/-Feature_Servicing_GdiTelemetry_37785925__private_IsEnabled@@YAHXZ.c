/*
 * XREFs of ?Feature_Servicing_GdiTelemetry_37785925__private_IsEnabled@@YAHXZ @ 0x1C015DDC8
 * Callers:
...
__int64 Feature_Servicing_GdiTelemetry_37785925__private_IsEnabled(void)
{
  ...
  CachedFeatureEnabledState = wil_details_FeatureStateCache_GetCachedFeatureEnabledState(
                                (unsigned int *)&Feature_Servicing_GdiTelemetry_37785925__private_featureState,
                                (__int64)&wil_details_featureDescriptors_a);
  v1 = (CachedFeatureEnabledState >> 3) & 1;
  wil_details_FeatureReporting_ReportUsageToService(
    (__int64)&Feature_Servicing_GdiTelemetry_37785925__private_reporting,
    0x2409145u,
