/*
 * XREFs of vSpDynamicModeChange @ 0x1C00B7500
 * Callers:
 *     <none>
 * Callees:
 ...
 *     ?vSpCorrectHdevReferences@@YAXPEAU_SPRITESTATE@@PEAUHDEV__@@@Z @ 0x1C00B7808 (-vSpCorrectHdevReferences@@YAXPEAU_SPRITESTATE@@PEAUHDEV__@@@Z.c)
...
void __fastcall vSpDynamicModeChange(HDEV a1, struct _POINTL *a2)
{
  HDEV v2; // rbx
  HDEV v4; // rax
  HDEV v5; // r15
  ...
  struct _POINTL *v36; // [rsp+5A0h] [rbp+4A0h] BYREF
  ...
  {
    vSpRemoveAllSpriteOverlapPresents(a1, a2);
    v4 = (HDEV)v36;
  }
  if ( ((_DWORD)v4[10] & 0x20000) == 0 )
  {
    vSpRemoveAllSpriteOverlapPresents(v4, a2);
    v4 = (HDEV)v36;
  }
  v5 = v37 + 20;
  v6 = v4 + 20;
...
LABEL_46:
  ...
  v26 = (HDEV)*((_QWORD *)v23 + 18);
  while ( *((HDEV *)v26 + v24) != v23 )
  {
  ...
  *((_QWORD *)v26 + v24) = v2;
  ...
  if ( v33 )
  {
    ...
    {
      v34 = *(_QWORD *)(v33 + 8);
      pSpMoveSpriteFromMeta(v26, v23, (struct _METASPRITE *)v33, v24);
      v33 = v34;
    }
    while ( v34 );
  }
