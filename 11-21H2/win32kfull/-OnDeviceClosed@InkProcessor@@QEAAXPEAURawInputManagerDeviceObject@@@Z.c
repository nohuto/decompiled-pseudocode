/*
 * XREFs of ?OnDeviceClosed@InkProcessor@@QEAAXPEAURawInputManagerDeviceObject@@@Z @ 0x1C024CA44
 * Callers:
 ...
 *     ?OnDeviceClosed@RimBackedDeviceBase@Rim@@UEAAXXZ @ 0x1C023F0D0 (-OnDeviceClosed@RimBackedDeviceBase@Rim@@UEAAXXZ.c)
