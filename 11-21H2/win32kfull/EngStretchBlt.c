/*
 * XREFs of EngStretchBlt @ 0x1C002FB50
 * Callers:
...
LABEL_12:
            ...
            if ( ((__int64)psoDest[1].hsurf & 0x400) != 0 )
              (*((void (__fastcall **)(SURFOBJ *, SURFOBJ *, _QWORD, XLATEOBJ *const, RECTL *, POINTL *))hdev + 352))(
                psoDest,
                v32,
                0LL,
                xloIdent,
            ...
            while ( (unsigned int)v35 < v29->cjBits )
            {
              if ( pvBits[v35] != v36[v35] )
              {
                ...
                if ( v37 == 1 )
                {
                  __debugbreak();
                  if ( ((__int64)psoDest[1].hsurf & 0x400) != 0 )
                    v38 = (BOOL (__stdcall *)(SURFOBJ *, SURFOBJ *, CLIPOBJ *, XLATEOBJ *, RECTL *, POINTL *))*((_QWORD *)hdev + 352);
                  else
                    v38 = EngCopyBits;
