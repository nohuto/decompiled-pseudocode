/*
 * XREFs of ??1CPhysicalMonitorHandle@@UEAA@XZ @ 0x1C026E5C4
 * Callers:
 *     ??_GCPhysicalMonitorHandle@@UEAAPEAXI@Z @ 0x1C026E610 (--_GCPhysicalMonitorHandle@@UEAAPEAXI@Z.c)
 * Callees:
 *     ?Destroy@CPhysicalMonitorHandle@@UEAAJXZ @ 0x1C026F810 (-Destroy@CPhysicalMonitorHandle@@UEAAJXZ.c)
 */
