/*
 * XREFs of xxxClientGetCharsetInfo @ 0x1C011B648
 * Callers:
 *     EditionInitSystemCharsetInfoForLayout @ 0x1C011B590 (EditionInitSystemCharsetInfoForLayout.c)
 * Callees:
...
__int64 __fastcall xxxClientGetCharsetInfo(int a1, _OWORD *a2)
{
  ...
  v5 = *v4;
  v12[1] = *v4;
  v6 = *(_QWORD *)(W32GetThreadWin32Thread((__int64)KeGetCurrentThread()) + 512);
  if ( v6 )
  {
