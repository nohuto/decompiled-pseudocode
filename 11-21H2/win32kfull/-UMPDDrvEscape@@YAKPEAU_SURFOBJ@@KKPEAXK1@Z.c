/*
 * XREFs of ?UMPDDrvEscape@@YAKPEAU_SURFOBJ@@KKPEAXK1@Z @ 0x1C0127650
 * Callers:
 *     <none>
 * Callees:
 ...
 *     ?bNeedThunk@UMPDOBJ@@QEBAHPEAX@Z @ 0x1C012A080 (-bNeedThunk@UMPDOBJ@@QEBAHPEAX@Z.c)
