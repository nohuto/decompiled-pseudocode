/*
 * XREFs of ?BmpDevDrawStream@@YAHPEAU_SURFOBJ@@0PEAU_CLIPOBJ@@PEAU_XLATEOBJ@@PEAU_RECTL@@PEAU_POINTL@@KPEAXPEAU_DSSTATE@@@Z @ 0x1C0298060
 * Callers:
 *     <none>
 * Callees:
        ...
        struct _DSSTATE *a9)
{
  ...
  if ( a1 )
  {
    ...
    if ( *((_QWORD *)hdev + 423) )
      v15 = (__int64 (__fastcall *)(struct _SURFOBJ *, struct _SURFOBJ *, struct _CLIPOBJ *))*((_QWORD *)hdev + 423);
        ...
        for ( i = **(struct _DISPSURF ***)(v16 + 1768); i; i = *(struct _DISPSURF **)i )
        {
          ...
          if ( v18 )
          {
            if ( (*(_DWORD *)(v18 + 1792) & 0x8000000) != 0 )
            {
              ...
              {
                if ( *(_QWORD *)(*(_QWORD *)(v18 + 1760) + 784LL) )
                {
                  ...
                  (*(void (__fastcall **)(struct _SURFOBJ *, struct _SURFOBJ *, struct _CLIPOBJ *, struct _XLATEOBJ *, struct _RECTL *, struct _POINTL *, unsigned int, void *, struct _DSSTATE *))(*(_QWORD *)(v22 + 1760) + 784LL))(
                    v21,
                    DevBitmap,
                    a3,
                    a4,
