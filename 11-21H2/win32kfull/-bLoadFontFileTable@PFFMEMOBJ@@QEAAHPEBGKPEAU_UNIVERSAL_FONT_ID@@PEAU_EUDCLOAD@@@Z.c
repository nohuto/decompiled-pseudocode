/*
 * XREFs of ?bLoadFontFileTable@PFFMEMOBJ@@QEAAHPEBGKPEAU_UNIVERSAL_FONT_ID@@PEAU_EUDCLOAD@@@Z @ 0x1C000D8E4
 * Callers:
 ...
 *     ?FindDefaultLinkedFontEntry@@YAHPEBG0@Z @ 0x1C02957D4 (-FindDefaultLinkedFontEntry@@YAHPEBG0@Z.c)
 */
        ...
        struct _EUDCLOAD *a5)
{
  ...
  if ( a3 )
  {
    ...
    while ( 1 )
    {
      ...
      {
        v16 = *(void (__fastcall **)(struct _IFIMETRICS *, unsigned __int64))(v8 + 3000);
        if ( v16 )
          v16(v14, v18);
        return 0;
      }
