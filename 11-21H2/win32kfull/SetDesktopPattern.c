/*
 * XREFs of SetDesktopPattern @ 0x1C00F2908
 * Callers:
 ...
 *     ?SetGlobalDesktopPattern@@YAHPEAUHBITMAP__@@@Z @ 0x1C021CEDC (-SetGlobalDesktopPattern@@YAHPEAUHBITMAP__@@@Z.c)
 */
...
__int64 __fastcall SetDesktopPattern(__int64 a1, const wchar_t *a2)
{
  ...
  if ( !a2 )
  {
    if ( !(unsigned int)FastGetProfileStringFromIDW(a1, 4LL, 2LL, &word_1C02E3794, v16, 260, 0) )
      return v4;
    a2 = v16;
  }
