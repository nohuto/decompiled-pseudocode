...
__int64 __fastcall RtlpAllocateHeapInternal(__int64 a1, unsigned __int64 a2, int a3, __int16 a4)
{
  ...
  unsigned int v93; // [rsp+30h] [rbp-69h] BYREF
  ...
  __int128 v108; // [rsp+A0h] [rbp+7h] BYREF
...
LABEL_22:
        ...
        v26 = (v22 | *(_DWORD *)(a1 + 20)) & 0x93000F0B;
        if ( !dword_180174238 )
        {
          v27 = *(_QWORD *)(a1 + 48);
          if ( (v27 || (v27 = qword_18017AC28) != 0) && v25 > v27 )
          {
            ...
            if ( v81 )
            {
              RtlpLogHeapFailure(20, a1, 0, v81, v25, *(_QWORD *)(a1 + 48));
              v24 = v94;
            }
            Heap = 0LL;
            v32 = 0LL;
...
LABEL_54:
            ...
            {
              RtlpLogHeapAllocateEvent(a1, Heap, v32, v42);
              v24 = v94;
            }
            if ( Heap )
            {
              ...
              if ( (dword_18017AE98 & 1) != 0 && (dword_18017AE98 & 2) != 0 )
              {
                if ( NtCurrentPeb()->ProcessHeap )
                {
                  ...
                  if ( a1 != *(_QWORD *)RtlpHpMetadataHeapCtxGet(&v107) )
                    goto LABEL_214;
                }
              }
              return Heap;
...
LABEL_154:
        ...
        if ( (v26 & 0x1000000) == 0 )
        {
          ...
          {
            v26 |= 8u;
            v82 = RtlpCallInterceptRoutine(v29, a1, 0, 1, (__int64)&v102);
            v24 = v94;
            if ( v82 < 0 )
            {
              Heap = 0LL;
        ...
        if ( v32 <= (unsigned int)(v33 - 16) )
        {
          ...
          v38 = *v37;
          v105 = v38;
          if ( (*(_QWORD *)(a1 + 896 + 8 * v38 + 128) & 1) == 0 )
            goto LABEL_47;
          v69 = *v37;
          v70 = (volatile signed __int64 *)(a1 + 1024 + 8 * v69);
          v71 = *v70;
          v103 = v70;
          if ( (v71 & 1) != 0 )
          {
            ...
            {
              RtlpHpLfhBucketActivate(a1 + 896, (unsigned int)v69);
              v70 = v103;
              v36 = a1 + 896;
            }
            v38 = v105;
...
LABEL_47:
            ...
            Heap = RtlpHpLfhSlotAllocate(
                     ...
                     *(_QWORD *)(*(unsigned __int8 *)(v36 + 56)
                               - (unsigned __int64)((*(_BYTE *)(v36 + 56) - 1) & 7)
                               + v40
                               + 7
                               + 8LL * v41
                               + v39),
        ...
        if ( v32 > 0x20000 )
        {
          if ( v32 > *(unsigned int *)(a1 + 528) )
          {
            v78 = RtlpHpLargeAlloc(a1, v25, v32, v34);
          }
          else
          {
            v77 = 512LL;
            if ( v32 <= *(unsigned int *)(a1 + 336) )
              v77 = 320LL;
            v78 = RtlpHpSegAlloc(a1 + v77, v25, v32, v32, v34);
          }
          Heap = v78;
        }
        else
        {
          ...
          v109 = 0LL;
          v108 = 0LL;
          Heap = (__int64)RtlpHpVsContextAllocateInternal(a1 + 704, v25, v32, v34, &v108, &v96);
          if ( v96 && (v97 & 1) == 0 )
          {
            RtlReleaseSRWLockExclusive(*((volatile signed __int64 **)&v108 + 1));
            *((_QWORD *)&v108 + 1) = 0LL;
          }
        }
        v42 = 3;
...
LABEL_80:
          ...
          if ( v98 )
          {
            *(_BYTE *)(v48 + 2) &= 0xF0u;
            *(_BYTE *)(v48 + 2) |= v59 & 0xF;
            if ( (int)RtlpCallInterceptRoutine(v59, a1, Heap, 2, v48 + 16) < 0 )
            {
              RtlpHpFreeHeap((_DWORD *)a1, Heap, v30, 0LL, 0LL);
              Heap = 0LL;
            }
          }
          v42 = v95;
        ...
        *(_BYTE *)(v48 + 3) = v46 >> 4;
        ...
        {
          v79 = RtlCSparseBitmapBitmaskRead(&unk_18017B720, 2 * ((unsigned __int64)(Heap - qword_18017B718) >> 20));
...
LABEL_79:
        ...
        {
          DescriptorValidateSafe = RtlpHpSegGetDescriptorValidateSafe(v50 + a1 + 320, Heap);
          v51 = (__int64)v103;
        ...
        if ( v53 )
        {
          ...
          if ( (v54 & 1) != 0 )
          {
            if ( (v54 & 2) != 0 )
            {
              if ( (v54 & 0xCu) >= 8 || (((1 << *(_BYTE *)(v51 + 8)) - 1) & (unsigned __int64)Heap) == 0 )
              {
LABEL_76:
  ...
  else
  {
    if ( (v7 & 0x1000000) == 0 && !dword_180174238 )
    {
      ...
      if ( (v10 || (v11 = qword_18017AC28) != 0) && a2 > v11 )
      {
        v84 = *(_QWORD *)(a1 + 400);
        if ( v84 )
          RtlpLogHeapFailure(20, a1, 0, v84, a2, v10);
        v93 = 5;
        goto LABEL_192;
      }
    }
    ...
    if ( (int)RtlpCallInterceptRoutine(v12, a1, 0, 1, (__int64)&v100) >= 0 )
    {
...
LABEL_14:
          ...
          LOWORD(v91) = v100;
          a2 -= v100;
          v86 = RtlpSetupExtendedBlock(a1, v8, Heap, v18, v91, v110);
          v92 = Heap;
          Heap = v86;
          if ( (int)RtlpCallInterceptRoutine(v110, a1, v86, 2, v92) >= 0 )
            goto LABEL_15;
...
LABEL_130:
      ...
      Heap = RtlpAllocateHeap(a1, v8 | 2, a2, v9, v67, (__int64)&v93);
      if ( !Heap )
        goto LABEL_112;
      goto LABEL_14;
    }
...
LABEL_15:
    ...
    && v93 != 5 )
  {
    ...
    if ( ((v88[10] ^ (unsigned __int8)(*(_BYTE *)(a1 + 138) & (*(_DWORD *)(a1 + 124) >> 17))) & 8) == 0 )
LABEL_208:
      RtlpLogHeapAllocateEvent(a1, Heap, a2, v93);
  }
  if ( (dword_18017AE98 & 1) != 0 && (dword_18017AE98 & 2) != 0 )
  {
    if ( NtCurrentPeb()->ProcessHeap )
    {
      v107 = RtlpHpEnvHandle;
      if ( a1 != *(_QWORD *)RtlpHpMetadataHeapCtxGet(&v107) && Heap && (v8 & 0x10000000) == 0 )
LABEL_214:
