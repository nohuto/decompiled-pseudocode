/*
 * XREFs of vDbgPrintExWithPrefixInternal @ 0x180006A08
 * Callers:
 *     DbgPrintEx @ 0x180005CC0 (DbgPrintEx.c)
 *     DbgPrint @ 0x1800069C0 (DbgPrint.c)
 *     LdrpLogDbgPrint @ 0x1800D96A8 (LdrpLogDbgPrint.c)
 *     DbgPrintReturnControlC @ 0x1800EBC10 (DbgPrintReturnControlC.c)
 *     vDbgPrintEx @ 0x1800EBCD0 (vDbgPrintEx.c)
 *     vDbgPrintExWithPrefix @ 0x1800EBD00 (vDbgPrintExWithPrefix.c)
 * Callees:
 *     RtlRaiseException @ 0x180032D00 (RtlRaiseException.c)
 *     __security_check_cookie @ 0x180093840 (__security_check_cookie.c)
 *     _vsnprintf @ 0x180095500 (_vsnprintf.c)
 *     ZwQueryDebugFilterState @ 0x1800A6960 (ZwQueryDebugFilterState.c)
 *     DbgBreakPointWithStatus @ 0x1800A7CD0 (DbgBreakPointWithStatus.c)
 *     DebugPrint @ 0x1800A7CE0 (DebugPrint.c)
