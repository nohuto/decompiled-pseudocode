/*
 * XREFs of RtlpRemoveHeapFromUnprotectedList @ 0x18003099C
 * Callers:
...
__int64 __fastcall RtlpRemoveHeapFromUnprotectedList(__int64 a1)
{
  ...
  if ( NumberOfHeaps && (_WORD)result && (unsigned __int16)result <= NumberOfHeaps )
  {
    ...
    {
      v8 = HIWORD(dword_180178CA8);
      v9 = HIWORD(dword_180178C98);
      v10 = word_180178C8A;
      do
      {
        v11 = (__int64)*v5++;
      ...
      NumberOfHeaps = v1->NumberOfHeaps;
      ProcessHeaps = v1->ProcessHeaps;
      HIWORD(dword_180178CA8) = v8;
      HIWORD(dword_180178C98) = v9;
      word_180178C8A = v10;
    }
