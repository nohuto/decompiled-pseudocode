/*
 * XREFs of LdrpFindMessageInAlternateModule @ 0x18006D5A8
 * Callers:
...
__int64 __fastcall LdrpFindMessageInAlternateModule(void *a1, ULONG *a2, unsigned __int64 a3, unsigned int a4, char a5)
{
  ULONG *v7; // rax
  __int64 result; // rax
  unsigned int *v9; // r8
