/*
 * XREFs of _winput_s @ 0x1800A2354
 * Callers:
...
LABEL_125:
      ...
      if ( v29 == 123 )
      {
        v35 = ReadStringDelimited_1(v34, &v73, (wint_t *)&v56, &v58, (void **)v71, v12, Stream, Src, v69);
        v4 = v73;
      }
      else
      {
        v35 = ReadString_1(v34, 0LL, (wint_t *)&v56, &v58, (void **)v71, v12, Stream, Src, v69);
      }
      v9 = v69[0];
      LOWORD(v5) = v56;
      v61 = v69[0];
