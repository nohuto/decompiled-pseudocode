/*
 * XREFs of LdrpCompleteMapModule @ 0x18004CFB8
 * Callers:
...
__int64 __fastcall LdrpCompleteMapModule(__int64 a1, __int64 a2, int a3)
{
  ...
  v3 = *(_QWORD *)(a1 + 56);
  v7 = 0;
  v8 = RtlpImageDirectoryEntryToDataEx(*(_QWORD *)(v3 + 48), 1, 0xEu, &v25, (__int64)&v26);
  v9 = v26;
  if ( v8 < 0 )
    v9 = 0LL;
  if ( !v9 )
    ...
    if ( (*(_WORD *)(a2 + 22) & 0x2000) != 0 )
    {
      if ( *(char *)(a1 + 32) >= 0 || *(char *)(a2 + 94) < 0 )
      {
        if ( (*(_DWORD *)(v3 + 104) & 0x1000000) == 0 && (a3 == 1073741827 || a3 == 1073741878) )
        {
          ...
          {
            v22 = (unsigned int)RtlGetCurrentServiceSessionId()
          ...
          if ( a3 == 1073741827
            && (v16 = LdrpRelocateImage(*(_QWORD *)(v3 + 48), *(_QWORD *)(a1 + 168), a2, v3 + 72), v7 = v16, v16 < 0) )
          {
