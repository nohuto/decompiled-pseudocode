/*
 * XREFs of __C_specific_handler @ 0x180094060
 * Callers:
 *     __GSHandlerCheck_SEH @ 0x1800A3B60 (__GSHandlerCheck_SEH.c)
 * Callees:
 *     RtlUnwindEx @ 0x180038900 (RtlUnwindEx.c)
 *     _NLG_Notify @ 0x180099FF0 (_NLG_Notify.c)
 *     __NLG_Return2 @ 0x18009A020 (__NLG_Return2.c)
 *     __except_validate_context_record @ 0x18009A028 (__except_validate_context_record.c)
 */
