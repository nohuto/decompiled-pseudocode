/*
 * XREFs of wil_details_FeatureReporting_IncrementUsageInCache @ 0x1800D78CC
 * Callers:
...
__int64 __fastcall wil_details_FeatureReporting_IncrementUsageInCache(__int64 a1, int a2, __int64 a3, _DWORD *a4)
{
  ...
  v4 = Feature_TreatDosDevicePathsAsNormalFiles__private_reporting;
  v6 = a2 == 4;
  while ( 1 )
  {
    a4[1] = 0;
    ...
    result = (unsigned int)_InterlockedCompareExchange(
                             ...
                             ((unsigned __int16)v7 ^ (unsigned __int16)(32 * v10)) & 0x3FE0 ^ v7,
                             v4);
    if ( v4 == (_DWORD)result )
      break;
    v4 = result;
