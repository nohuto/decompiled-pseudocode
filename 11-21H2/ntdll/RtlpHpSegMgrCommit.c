...
__int64 __fastcall RtlpHpSegMgrCommit(int *a1, unsigned __int64 a2, unsigned int a3, int a4, int a5, int a6, int a7)
{
  ...
  if ( (*((_BYTE *)a1 + 13) & 7) != 0 )
  {
    v29 = a2 & 0xFFFFFFFFFFE00000uLL;
    RtlpHpQueryVA(a2 & 0xFFFFFFFFFFE00000uLL, a2, &v34, 0LL);
    if ( (int)v9 <= 0 || (_DWORD)v11 || v10 >= 0x200000 || a2 <= v29 )
    {
      v14 = a7;
    }
    else
...
LABEL_7:
    ...
    v26 = RtlpHpSegMgrCommitInitiate((_DWORD)a1, (_DWORD)v15, v9, v14, (__int64)&v32, (__int64)&v37);
    if ( v26 == -1073741568 )
      break;
    if ( v26 != -1073741566 )
      goto LABEL_7;
    v29 &= 0xFFFFFFFFFFE00000uLL;
    v30 = 0x200000LL;
    if ( (int)v9 <= 0 )
    {
LABEL_12:
      v36 = *(_OWORD *)(a1 + 10);
      v24 = RtlpHpFreeVA(&v29, (unsigned __int64 *)&v30, v12, &v36);
      goto LABEL_10;
    }
...
LABEL_8:
    if ( v18 && (v12 & 0x20000000) == 0 )
      v12 |= 0x40000000u;
    v19 = *((_QWORD *)a1 + 7);
    v20 = (*(_DWORD *)(v19 + 20) & 0x40000000) != 0;
    v35 = *(_OWORD *)(a1 + 10);
    v21 = RtlpHpHeapValidateProtection(v19, v20 ? 64 : 4);
    v22 = RtlpHpAllocVA((__int64 *)&v29, &v30, 0LL, v12, v21, &v35);
    v24 = v22;
...
LABEL_10:
    ...
    RtlpHpSegMgrCommitComplete(v23, (_DWORD)v15, v9, v24 >= 0, (__int64)&v32, v28);
