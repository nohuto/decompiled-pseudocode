/*
 * XREFs of LdrpLogMapAndVerifyResourceFileFailure @ 0x1800DBE7C
 * Callers:
        ...
        unsigned __int16 *a5)
{
  ...
  v9 = RtlRunOnceExecuteOnce(&stru_18017B070, LdrpResReportResourceAccessInternalInitOnce, 0LL, 0LL);
  if ( v9 >= 0 && (unsigned int)dword_1801748F8 > 5 )
  {
    LOBYTE(v9) = tlgKeywordOn((__int64)&dword_1801748F8, 0x200000000000LL);
    if ( (_BYTE)v9 )
    {
      v18 = &v16;
      v16 = 0x1000000LL;
      ...
      LOBYTE(v9) = tlgWriteTransfer_EtwEventWriteTransfer(
                     (__int64)&dword_1801748F8,
                     (unsigned __int8 *)dword_1801419BD,
                     v10,
                     v11,
                     0xAu,
                     &v17);
