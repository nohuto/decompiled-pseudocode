/*
 * XREFs of RtlpHpSizeHeap @ 0x180027310
 * Callers:
...
__int64 __fastcall RtlpHpSizeHeap(__int64 a1, unsigned __int64 a2, int a3)
{
  ...
  {
    v32 = RtlCSparseBitmapBitmaskRead(&unk_18017B720, 2 * ((a2 - qword_18017B718) >> 20));
  ...
  else if ( (v12 ^ RtlpHpHeapGlobals ^ *(_QWORD *)v12 & a2 ^ *(_QWORD *)((*(_QWORD *)v12 & a2) + 0x10)) == 0xA2E64EADA2E64EADuLL )
  {
  ...
  else if ( (_BYTE)v13 == 8 )
  {
    v16 = *(_DWORD *)((*(_QWORD *)v12 & DescriptorValidateSafe)
                    + ((__int64)(DescriptorValidateSafe - (*(_QWORD *)v12 & DescriptorValidateSafe)) >> 5 << v14)
                    + 0x28);
    v17 = qword_18017AC08 ^ v16 ^ ((unsigned int)v15 >> 12);
    ...
    if ( v21 )
    {
      v23 = (v20 * (unsigned __int64)v21) >> v22;
      v24 = v20 - v23 * v18;
    }
    else
    {
    ...
    else
    {
      ...
      if ( (v25 & 1) != 0 )
      {
        ...
        v27 = (unsigned __int16)qword_18017AC08 ^ v26;
        if ( (v25 & 2) != 0 )
        {
          v28 = (unsigned __int16)qword_18017AC08 ^ (unsigned __int64)v26;
          v29 = *(_WORD *)(v28 + a2 - 2);
          if ( (v29 & 0x4000) != 0 )
          {
