/*
 * XREFs of LdrpLogEtwHotPatchStatus @ 0x1800DB68C
 * Callers:
...
char __fastcall LdrpLogEtwHotPatchStatus(unsigned __int16 *a1, __int64 a2, unsigned __int16 *a3, int a4, int a5)
{
  ...
  char v24[32]; // [rsp+68h] [rbp-A0h] BYREF
  ...
  result = RtlRunOnceExecuteOnce(
             ...
             (unsigned int (__fastcall *)(volatile signed __int64 *, __int64, __int64 *))LibLoaderTelemetryInitOnce,
             0LL,
             0LL);
  if ( a2 )
    v11 = (_QWORD *)(a2 + 88);
    ...
    v11 = v22;
  if ( (unsigned int)dword_1801748C0 > 5 )
  {
    result = tlgKeywordOn((__int64)&dword_1801748C0, 0x400000000001LL);
    if ( result )
    {
      v23 = v13;
      v25 = &v23;
