...
__int64 __fastcall RtlpFindEnvironmentHashEntry(__int64 a1, unsigned __int16 *a2, int a3)
{
  int v4; // r14d
...
LABEL_8:
    while ( 1 )
    {
      ...
      {
        if ( (unsigned int)RtlCompareUnicodeStrings(*(_QWORD *)(v14 + 16), *(_QWORD *)(v14 + 32), v4, a3, 1) )
          goto LABEL_5;
        return v14;
      }
    }
