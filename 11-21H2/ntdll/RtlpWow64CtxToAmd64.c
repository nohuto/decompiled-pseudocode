/*
 * XREFs of RtlpWow64CtxToAmd64 @ 0x180110328
 * Callers:
 *     RtlpWow64SetContextOnAmd64 @ 0x180075D20 (RtlpWow64SetContextOnAmd64.c)
 * Callees:
 *     RtlFnToFxFrame @ 0x180109668 (RtlFnToFxFrame.c)
 */
