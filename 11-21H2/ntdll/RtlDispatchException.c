/*
 * XREFs of RtlDispatchException @ 0x180035990
 * Callers:
 ...
 *     RtlpExecuteHandlerForException @ 0x1800A9060 (RtlpExecuteHandlerForException.c)
 *     RtlpLogExceptionDispatch @ 0x18010D908 (RtlpLogExceptionDispatch.c)
...
char __fastcall RtlDispatchException(__int64 a1, __int64 a2)
{
  ...
  void *v42; // [rsp+A0h] [rbp+40h] BYREF
        ...
        if ( v37 )
        {
          ...
          while ( 1 )
          {
            ...
            *(_DWORD *)(a1 + 4) = v5;
            ...
            if ( (((unsigned __int64)qword_18018F398 >> 12) & 3) == 1 )
            {
