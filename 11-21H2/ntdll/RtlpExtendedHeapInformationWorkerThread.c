/*
 * XREFs of RtlpExtendedHeapInformationWorkerThread @ 0x1800FF0F0
 * Callers:
 *     <none>
 * Callees:
...
void __fastcall __noreturn RtlpExtendedHeapInformationWorkerThread(__int64 a1)
{
  ...
  _QWORD v13[14]; // [rsp+98h] [rbp-19h] BYREF
  ...
  *(_QWORD *)(a1 + 64) = 0LL;
  ...
  if ( HeapInformation >= 0 )
  {
    ...
    *(_DWORD *)(a1 + 28) = 0;
    ...
    {
      (*v6)[1] = -1LL;
      Tags = RtlpHpTagQueryTags(*v6, *v5, (_QWORD *)(a1 + 32));
      goto LABEL_3;
    }
    if ( v7 == 0x20000000 )
    {
    ...
    else
    {
      ...
      v13[1] = *(_QWORD *)(a1 + 16);
      v13[0] = -1LL;
      v13[3] = RtlpExtendedHeapInformationWorkerCallback;
      LODWORD(v13[2]) = v7;
      v13[4] = a1;
