/*
 * XREFs of LdrProcessRelocationBlockLongLong @ 0x18008B70C
 * Callers:
 *     LdrRelocateImageWithBias @ 0x18008B610 (LdrRelocateImageWithBias.c)
 *     LdrProcessRelocationBlock @ 0x1800EEC80 (LdrProcessRelocationBlock.c)
 *     LdrProcessRelocationBlockEx @ 0x1800EECB0 (LdrProcessRelocationBlockEx.c)
 * Callees:
