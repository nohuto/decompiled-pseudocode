/*
 * XREFs of Xp10ReadMtfHeader @ 0x18011D58C
 * Callers:
  ...
  *(_OWORD *)a2 = 0LL;
  ...
  while ( 1 )
  {
    ...
    if ( v12 >= v10 )
      v14 = v10;
    v15 = v11 + 1;
    v16 = *(_DWORD *)&byte_18013CB40[4 * v14] & (v13 >> (v9 & 7));
    ...
    if ( (_DWORD)v17 )
      v16 |= (*v15 & *(_DWORD *)&byte_18013CB40[4 * v17]) << v12;
    v20 = v10 + v9;
    *((_DWORD *)a3 + 2) = v20;
    ...
    if ( v16 )
    {
      ...
      else
      {
        ...
        v29 = v22 + 1;
        v25 = *(_DWORD *)&byte_18013CB40[4 * v27] & (v26 >> (v20 & 7));
        ...
        if ( (_DWORD)v28 )
          v25 |= (*v29 & *(_DWORD *)&byte_18013CB40[4 * v28]) << v24;
        v7 = a1;
        *((_DWORD *)a3 + 2) = v20 + v23;
      }
      if ( v23 < v16 )
