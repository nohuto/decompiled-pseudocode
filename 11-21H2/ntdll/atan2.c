/*
 * XREFs of atan2 @ 0x180096000
 * Callers:
 *     <none>
 * Callees:
 *     _controlfp @ 0x18009BB74 (_controlfp.c)
...
LABEL_32:
    ...
    else
    {
      ...
      v27 = qword_180133EF0[v26];
      v28 = qword_180133760[v26];
    ...
    if ( v23 )
    {
      v28 = *(double *)&qword_180174A08 - v28;
      v25 = *(double *)&qword_180174A10 - v25;
    }
    if ( X < 0.0 )
    {
      v28 = *(double *)&qword_1801749F8 - v28;
      v25 = *(double *)&qword_180174A00 - v25;
    }
    v33 = v28 + v25;
    if ( v3 < 0.0 )
      *(_QWORD *)&v33 ^= _xmm;
