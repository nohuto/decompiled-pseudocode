/*
 * XREFs of LdrEnumResources @ 0x1800EBE50
 * Callers:
 *     <none>
 * Callees:
        ...
        PLDR_ENUM_RESOURCE_ENTRY Resources)
{
  ...
  __int64 OutHeaders; // [rsp+50h] [rbp-58h] BYREF
  ...
  if ( Resources )
    ...
    v42 = 0;
  *ResourceCount = 0;
  v10 = RtlpImageDirectoryEntryToDataEx((unsigned __int64)DllHandle, 1, 2u, &v50, (PIMAGE_NT_HEADERS)&OutHeaders);
  v11 = OutHeaders;
  if ( v10 < 0 )
    v11 = 0LL;
  if ( !v11 )
    ...
    if ( !v17 )
    {
      do
      {
        if ( v7 <= 1 || (v27 = LdrpCompareResourceNamesWithValidation(0LL, 0LL, v8[1], v11, v23, &v37), v26 = v39, !v27) )
        {
          ...
          v31 = (int *)(v28 + v11 + 16);
          LODWORD(OutHeaders) = *(unsigned __int16 *)(v28 + v11 + 12) + *(unsigned __int16 *)(v28 + v11 + 14);
          if ( (_DWORD)OutHeaders )
          {
            ...
            while ( v5 < (unsigned int)OutHeaders );
            v26 = v39;
          }
          v8 = (const wchar_t **)ResourceInfo;
          v5 = 0;
