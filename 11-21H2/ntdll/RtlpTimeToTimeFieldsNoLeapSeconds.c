/*
 * XREFs of RtlpTimeToTimeFieldsNoLeapSeconds @ 0x1800F0A58
 * Callers:
 *     RtlpTimeToTimeFields @ 0x18005E2A0 (RtlpTimeToTimeFields.c)
 * Callees:
 *     TimeToDaysAndFraction @ 0x1800820F0 (TimeToDaysAndFraction.c)
 */

__int64 __fastcall RtlpTimeToTimeFieldsNoLeapSeconds(_QWORD *a1, _WORD *a2)
{
  int v3; // r11d
