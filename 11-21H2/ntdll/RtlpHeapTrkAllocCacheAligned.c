...
char __fastcall RtlpHeapTrkAllocCacheAligned(__int64 *a1, unsigned __int64 *a2, int a3, unsigned __int64 a4)
{
  ...
  if ( !v18[0] )
    return 0;
  Heap = RtlAllocateHeap(qword_18017B6C8, 0, 8 * a4);
  *a1 = Heap;
  v10 = Heap;
  if ( !Heap )
    return 0;
  v11 = v18[0] * ((unsigned int)(a3 + v18[0] - 1) / v18[0]);
  v12 = v11 * a4;
  if ( !is_mul_ok(v11, a4) || v12 + v18[0] < v12 )
  {
LABEL_8:
    RtlFreeHeap(qword_18017B6C8, 0, v10);
    *a1 = 0LL;
    return 0;
  }
  v13 = RtlAllocateHeap(qword_18017B6C8, 8u, v12 + v18[0]);
  *a2 = v13;
  if ( !v13 )
  {
    v10 = *a1;
