...
LABEL_12:
    ...
    else
    {
      while ( 1 )
      {
        ...
        else if ( v5 && (v8 == 45 && v11 == v4 + 1 || !(unsigned __int8)ValidateStd3Range((unsigned __int16)v8, a2))
               || v8 < 0x20 )
        {
          return 0;
        }
