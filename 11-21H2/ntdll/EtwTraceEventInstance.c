/*
 * XREFs of EtwTraceEventInstance @ 0x180122090
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall EtwTraceEventInstance(int a1, __m128i *a2, __int64 *a3, __int64 *a4)
{
  ...
  NTSTATUS v15; // eax
  __m128i v17; // [rsp+20h] [rbp-E0h] BYREF
...
LABEL_16:
    if ( (a1 & 0x1000000) != 0 )
    {
      return (unsigned int)EtwpTraceUmEvent(a1, (unsigned __int16 *)&v17, 0x48u, -1072365568);
    }
    else
    {
      v15 = NtTraceEvent();
