/*
 * XREFs of RtlpConvertToAutoInheritSecurityObject @ 0x1800F2C98
 * Callers:
 *     RtlConvertToAutoInheritSecurityObject @ 0x1800E2EF0 (RtlConvertToAutoInheritSecurityObject.c)
 * Callees:
...
LABEL_76:
  v10 = RtlpConvertAclToAutoInherit(v26, v25, a4, a5, v24, v23, a6, &BaseAddress, &v44);
  if ( v10 >= 0 )
  {
    v50 = 1;
    v27 = v44 & 0x1408 | 4;
