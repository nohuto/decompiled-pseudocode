/*
 * XREFs of LdrResFallbackLangList @ 0x180066B4C
 * Callers:
...
LABEL_39:
        ...
        if ( (a4 & 0x100000) != 0 )
        {
          GetLCIDFromLangListNodeWithLICCheck(v30, (__int64)NtCurrentTeb()->MergedPrefLanguages, 0, v32, (bool *)&a5);
          if ( (_BYTE)a5 )
            CurrentLocale = -4370;
          else
            CurrentLocale = v32[0];
...
LABEL_26:
  ...
  if ( (v13 & 4) == 0 )
  {
    ...
    {
      *((_BYTE *)v9 + 516) = 1;
      if ( (int)LdrpGetParentLangId(CurrentLocale, &v35) < 0 )
        goto LABEL_15;
      v10 = v15;
      CurrentLocale = v35;
      if ( !v35 )
