/*
 * XREFs of RtlGetProductInfo @ 0x180080830
 * Callers:
 *     <none>
 * Callees:
 *     CompareVersions @ 0x180080970 (CompareVersions.c)
        ...
        PDWORD ReturnedProductType)
{
  ...
  *ReturnedProductType = 0;
  ...
  if ( ZwQueryLicenseValue((PUNICODE_STRING)&stru_18012C720, &Type, v18, 0xC8u, &ResultDataSize) < 0 )
    goto LABEL_7;
