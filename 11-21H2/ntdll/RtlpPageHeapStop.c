/*
 * XREFs of RtlpPageHeapStop @ 0x1800E76DC
 * Callers:
        ...
        const char *a10)
{
  ...
  v10 = xmmword_180179C10;
  AVrfpPageHeapPreviousStopData = AVrfpPageHeapStopData;
  *(_QWORD *)&AVrfpPageHeapStopData = a1;
  v11 = qword_180179C20;
  *((_QWORD *)&xmmword_180179C10 + 1) = a7;
  qword_180179C20 = (__int64)a9;
  qword_180179300 = v11;
  xmmword_1801792F0 = v10;
  *((_QWORD *)&AVrfpPageHeapStopData + 1) = a3;
  *(_QWORD *)&xmmword_180179C10 = a5;
  DbgPrint(
    "\n"
    "\n"
    "===========================================================\n"
