/*
 * XREFs of Normalization__Normalize @ 0x1800904D8
 * Callers:
 *     RtlpNormalizeStringWorker @ 0x180090450 (RtlpNormalizeStringWorker.c)
 * Callees:
 ...
 *     Normalization__GuessCharCountBySize @ 0x18010CF1C (Normalization__GuessCharCountBySize.c)
 */
...
LABEL_18:
  v12 = ((v18 - v6) >> 1) + 1;
  v13 = Normalization__GuessCharCountBySize(a1, v12);
  v16 = (int)(v12 * v14) / v15;
  if ( v16 <= v13 )
    v16 = v13;
