...
volatile signed __int64 *__fastcall RtlpHpHeapAllocate(__int64 a1, unsigned int a2, __int128 *a3)
{
  ...
  unsigned __int64 v25; // [rsp+C0h] [rbp+50h] BYREF
  void *v26; // [rsp+C8h] [rbp+58h] BYREF
    ...
    || v12 >= *(unsigned int *)(v13 + 528) )
  {
    ...
    v24 = v7;
    if ( (int)RtlpHpAllocVA((__int64 *)&v26, (__int64 *)&v25, 0LL, v5 | 0x2000u, v15, &v24) < 0 )
    {
LABEL_27:
      v17 = 0LL;
      goto LABEL_16;
...
LABEL_9:
    v22 = *a3;
    if ( (int)RtlpHpAllocVA((__int64 *)&v26, (__int64 *)&v21, 0LL, v5 | 0x1000u, v15, &v22) >= 0 )
    {
      ...
      {
        v4 = v21;
        RtlpLogHeapCommit(v26, v26, v21, 11LL);
      }
      else
      {
        v4 = v21;
      }
      v17 = (volatile signed __int64 *)v26;
      v8 = 0;
      v26 = 0LL;
      goto LABEL_15;
    }
  ...
  {
    v24 = *a3;
    RtlpHpMetadataCommit(v20, v20 + 4096, v25 - 4096, (unsigned int)&v24, 0);
LABEL_15:
...
LABEL_16:
  ...
  {
    v24 = *a3;
    RtlpHpFreeVA((unsigned __int64 *)&v26, &v25, v5 | 0x8000, &v24);
  }
  return v17;
}
