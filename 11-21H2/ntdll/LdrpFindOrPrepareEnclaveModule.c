        ...
        __int64 a7)
{
  ...
  *a6 = 0LL;
  if ( (a4 & 0x20) != 0 )
  {
    if ( RtlEqualUnicodeString((PUNICODE_STRING)&stru_18012D568, a2, 1u) )
    {
      if ( a5 == a1[15] || a5 == a1[16] )
        v9 = (_UNICODE_STRING *)&unk_18012D5A8;
    }
    else
    {
      v11 = RtlPrefixUnicodeString((PUNICODE_STRING)&stru_18012D578, v9, 1u);
      v12 = (_UNICODE_STRING *)&unk_18012D5A8;
      if ( !v11 )
        v12 = v9;
      v9 = v12;
    }
