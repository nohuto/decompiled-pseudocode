/*
 * XREFs of RtlUnicodeStringCopy @ 0x18006B630
 * Callers:
 ...
 * Callees:
 *     RtlWideCharArrayCopyWorker @ 0x18006B6B8 (RtlWideCharArrayCopyWorker.c)
 *     RtlUnicodeStringValidateSrcWorker @ 0x18006B710 (RtlUnicodeStringValidateSrcWorker.c)
