/*
 * XREFs of NormBuffer__ReplaceLastStartBasePair @ 0x18010C780
 * Callers:
...
char __fastcall NormBuffer__ReplaceLastStartBasePair(__int64 a1, int a2, char a3, char a4)
{
  ...
  v11 = *(unsigned __int16 *)(*(_QWORD *)(v4 + 80) + 2LL * (unsigned __int16)((v7 & 0x1FFF) + 2));
  ...
  *(_QWORD *)(a1 + 96) = 0LL;
  if ( (_DWORD)v11 )
    return NormBuffer__AppendAndSortDecomposed((_QWORD *)a1, v11);
  else
    return 1;
}
