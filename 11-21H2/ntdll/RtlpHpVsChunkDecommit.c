/*
 * XREFs of RtlpHpVsChunkDecommit @ 0x180120F54
 * Callers:
...
__int64 __fastcall RtlpHpVsChunkDecommit(unsigned __int64 a1, __int64 a2, __int64 a3, char a4, __int64 a5)
{
...
LABEL_8:
          ...
          *(_DWORD *)(a3 + 8) = (unsigned __int8)(RtlpHpHeapGlobals ^ a3 ^ ((unsigned int)(a3 - a2) >> 12)) | 0x200;
          ...
          RtlpHpVsSubsegmentCommitPages(a1, a2, v19[0], v10, 0);
          if ( !v12 )
          {
            *(_QWORD *)a5 = 0LL;
            *(_QWORD *)(a5 + 16) = 0LL;
