/*
 * XREFs of RtlpLookupCurDirSetting @ 0x180084E88
 * Callers:
...
__int64 __fastcall RtlpLookupCurDirSetting(__int64 a1, unsigned __int32 a2, volatile signed __int32 *a3)
{
  ...
  {
    Handle = (HANDLE)qword_18017AE18;
    v6 = (HANDLE)qword_18017AE18;
    if ( !qword_18017AE18 )
    {
      if ( (int)NtOpenKey(&Handle, 1LL, &unk_18012C870) < 0 )
      {
LABEL_7:
        v7 = a2;
        goto LABEL_8;
      }
      v6 = (HANDLE)_InterlockedCompareExchange64(&qword_18017AE18, (signed __int64)Handle, 0LL);
      if ( v6 )
      {
        NtClose(Handle);
        Handle = v6;
