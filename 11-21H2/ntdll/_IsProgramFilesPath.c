/*
 * XREFs of _IsProgramFilesPath @ 0x18000C0B8
 * Callers:
...
__int64 __fastcall IsProgramFilesPath(wchar_t *String1, size_t *a2)
{
  ...
  v11 = 702;
  *a2 = 0LL;
  result = RtlQueryEnvironmentVariable_U(0LL, &unk_18012C100, &v10);
  if ( (_DWORD)result == -1073741789 )
  {
    v11 = v10 + 2;
    Heap = (wchar_t *)RtlAllocateHeap(NtCurrentPeb()->ProcessHeap, 8LL, (unsigned __int16)(v10 + 2));
    String2 = Heap;
  }
  else
  {
  ...
  if ( !Heap )
    return 3221225659LL;
  v6 = RtlQueryEnvironmentVariable_U(0LL, &unk_18012C100, &v10);
  v7 = String2;
  v8 = v6;
  if ( v6 >= 0 )
  {
  ...
  if ( v7 != (wchar_t *)v13 )
    RtlFreeHeap(NtCurrentPeb()->ProcessHeap, 0LL, String2);
  return v8;
}
