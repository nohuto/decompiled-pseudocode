/*
 * XREFs of RtlpQueryInformationActivationContextDetailedInformation @ 0x18007F2C4
 * Callers:
        ...
        unsigned __int64 *a5)
{
  ...
  if ( a5 )
    *a5 = 0LL;
  v9 = 64LL;
  RtlpLocateActivationContextSectionForQuery(&v22, &v23, a3);
  if ( v22 == 2 )
    return (unsigned int)v23;
  result = RtlpCrackActivationContextStringSectionHeader(v21, (_DWORD)a5, v10, (unsigned int)&a5, (_DWORD)v5, 64);
  if ( (int)result >= 0 )
  {
...
LABEL_29:
    ...
    else
    {
      ...
      while ( (*v15 & 2) == 0 )
      {
        ...
        v15 += 24;
        if ( (unsigned int)v13 >= *((_DWORD *)v12 + 2) )
          goto LABEL_29;
      }
    }
