/*
 * XREFs of AlpcGetMessageFromCompletionList @ 0x18001E000
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall AlpcGetMessageFromCompletionList(__int64 a1, _QWORD *a2, unsigned __int64 a3, unsigned __int64 a4)
{
