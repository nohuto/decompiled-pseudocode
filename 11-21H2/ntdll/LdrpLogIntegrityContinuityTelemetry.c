/*
 * XREFs of LdrpLogIntegrityContinuityTelemetry @ 0x1800DBB80
 * Callers:
...
__int64 __fastcall LdrpLogIntegrityContinuityTelemetry(__int64 a1, int a2, int a3, int a4, char a5)
{
              ...
              0LL) >= 0 )
  {
    ...
    {
      v11 = (unsigned __int16 *)&unk_18012D5B8;
      v10 = -1;
    }
    LODWORD(SystemInformation) = 8;
    NtQuerySystemInformation(SystemCodeIntegrityInformation, &SystemInformation, 8u, 0LL);
    if ( (unsigned int)dword_1801748C0 > 5 && tlgKeywordOn((__int64)&dword_1801748C0, 0x800000000000LL) )
    {
      v13 = *(_QWORD *)(a1 + 56);
