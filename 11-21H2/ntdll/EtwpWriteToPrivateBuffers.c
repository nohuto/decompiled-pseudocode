        ...
        __int64 a10)
{
  ...
  unsigned int v74; // [rsp+830h] [rbp+20h]
  int v75; // [rsp+834h] [rbp+24h]
  _BYTE *v76; // [rsp+838h] [rbp+28h]
  int v77; // [rsp+840h] [rbp+30h]
  unsigned __int16 *v78; // [rsp+848h] [rbp+38h] BYREF
  unsigned int v79; // [rsp+850h] [rbp+40h] BYREF
  void *v80; // [rsp+858h] [rbp+48h] BYREF
  __int64 v81; // [rsp+860h] [rbp+50h]
  void *v82; // [rsp+868h] [rbp+58h]
  __int64 v83; // [rsp+870h] [rbp+60h]
  __int64 v84; // [rsp+878h] [rbp+68h]
  unsigned __int64 v85; // [rsp+880h] [rbp+70h] BYREF
  int v86; // [rsp+888h] [rbp+78h]
  unsigned int v87; // [rsp+88Ch] [rbp+7Ch]
  __int64 v88; // [rsp+890h] [rbp+80h]
  void *Src; // [rsp+8A0h] [rbp+90h]
  _OWORD *v90; // [rsp+8A8h] [rbp+98h]
  char v91[16]; // [rsp+8C0h] [rbp+B0h] BYREF
  char v92[80]; // [rsp+8D0h] [rbp+C0h] BYREF
  ...
  *(_DWORD *)(a10 + 128) = 0;
  ...
  if ( (a1[240] & 4) != 0 )
  {
    if ( (unsigned __int8)EtwpCheckForEnoughStackSpace(4LL, a2, a1, a2) )
    {
      v59 = alloca(2064LL);
      v80 = &v65;
      EtwpGetStackExtendedHeaderItem(&v80, &v70);
    }
    v11 = a2;
    v12 = v76;
  }
...
LABEL_15:
    ...
    v81 = *(_QWORD *)(EtwpLoggerArray + 8 * v23);
    if ( (v81 & 1) == 0 )
    {
      v14 = 0;
      v77 = 0;
...
LABEL_59:
  ...
  v24 = v13 != 0LL ? 104 : 80;
  v25 = v24;
  if ( (v76[8 * v19 + 144] & 1) != 0 && (int)NtQueryInformationToken(-6LL, 1LL, v91, 88LL, &Size) >= 0 )
  {
    v60 = Size - 16;
    LODWORD(Size) = v60;
  ...
  if ( (v26 & 2) == 0 )
    v27 = v25;
  v28 = v88 + 32LL * *(unsigned int *)(v88 + 128);
  v29 = 0;
  v30 = v76;
  if ( a8 )
  {
    v31 = *((_WORD *)v76 + 49) & 0x4000;
    while ( 1 )
    {
      v32 = v27;
      v33 = v31 ? *(_BYTE *)(v83 + 16LL * v29 + 12) : 0;
      if ( v33 )
      {
        if ( v33 == 1 )
        {
          v66 += *(_WORD *)(v83 + 16LL * v29 + 8);
          ++HIDWORD(Size);
        }
        else if ( v33 == 2 )
        {
          Src = *(void **)(v83 + 16LL * v29);
          v71 = *(_WORD *)(v83 + 16LL * v29 + 8);
          v27 += (v71 + 15) & 0xFFFFFFF8;
        }
      }
      else
      {
        v27 += *(_DWORD *)(v83 + 16LL * v29 + 8);
      }
      if ( v27 < v32 )
        break;
      if ( ++v29 >= a8 )
...
LABEL_30:
  ...
  *(_DWORD *)(v28 + 24) = v27;
    ...
    *(_GUID *)(v34 + 64) = ActivityId;
    ...
    if ( v68 == 1 )
    {
      ...
      *v61 = v75;
      ...
      v61[3] = Size;
      v61[2] = 0;
      memmove(v61 + 4, v92, (unsigned int)Size);
      *(_WORD *)(v35 + 4) |= 1u;
      v37 = v62 + v67;
      v67 = v37;
      if ( v18 )
      ...
      do
      {
        ...
        if ( v53 )
        {
          if ( v53 == 1 )
          {
            ...
            v58 = (char *)v82;
            memmove(v82, *(const void **)(v48 - 12), v57);
            v82 = &v58[v57];
          }
  ...
  if ( v27 > 0xFFF8 )
    ...
    v14 = *(_DWORD *)(v81 + 196) < v27 ? 234 : 8;
  _InterlockedDecrement((volatile signed __int32 *)(EtwpLoggerArray + 16LL * v87 + 8));
  return v14;
}
