/*
 * XREFs of RtlpHpSegSetExtraPresent @ 0x18002E978
 * Callers:
 ...
 *     RtlpHpVsChunkSetExtraPresent @ 0x18002F784 (RtlpHpVsChunkSetExtraPresent.c)
 */
...
__int64 __fastcall RtlpHpSegSetExtraPresent(__int64 a1, unsigned __int64 a2)
{
  ...
  else
  {
    ...
    if ( v5 == 8 )
    {
      v8 = (unsigned __int16)qword_18017AC08 ^ *(unsigned __int16 *)(v7 + 40) ^ (unsigned __int64)(unsigned __int16)((unsigned int)v7 >> 12);
      result = 0x4000LL;
