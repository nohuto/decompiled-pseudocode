/*
 * XREFs of AVrfpParseVerifierDllsString @ 0x1800E6638
 * Callers:
...
__int64 AVrfpParseVerifierDllsString()
{
  ...
  *(UNICODE_STRING *)(v2 + 16) = VerifierDllString;
  v3 = (__int64 *)qword_180179358;
  if ( *(__int64 **)qword_180179358 != &AVrfpVerifierProvidersList )
LABEL_19:
    __fastfail(3u);
  v4 = UseWOW64 == 0;
