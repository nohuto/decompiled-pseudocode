...
__int64 __fastcall LdrpGetDelayloadDescriptor(unsigned __int64 a1, const char *a2)
{
  ...
  v4 = RtlpImageDirectoryEntryToDataEx(a1, 1, 0xDu, &v10, (PIMAGE_NT_HEADERS)&v11);
  v5 = v11;
  v6 = 0LL;
  if ( v4 < 0 )
    v5 = 0LL;
