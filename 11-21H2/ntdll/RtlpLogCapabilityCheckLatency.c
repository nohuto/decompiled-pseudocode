/*
 * XREFs of RtlpLogCapabilityCheckLatency @ 0x180014B1C
 * Callers:
        ...
        if ( *a1 )
        {
          if ( *a2 )
          {
            if ( RtlpPerformanceCounterFrequency )
            {
              ...
              if ( !(_WORD)v6 )
              {
                if ( (unsigned int)dword_1801743F8 > 5 && tlgKeywordOn((__int64)&dword_1801743F8, 0x200000000000LL) )
                {
                  v14 = *a2 - *a1;
                  v24 = 0;
                  v27 = 0;
                  ...
                  v32 = 1;
                  v35 = 1;
                  tlgWriteTransfer_EtwEventWriteTransfer(v11, (unsigned __int8 *)dword_180141CAE, v12, v13, 7u, &v21);
                }
