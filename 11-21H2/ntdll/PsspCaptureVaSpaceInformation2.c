/*
 * XREFs of PsspCaptureVaSpaceInformation2 @ 0x18006413C
 * Callers:
        ...
        __int16 a5)
{
  ...
  do
  {
    ...
    if ( (a5 & 0x1000) != 0 && !v11 && (DWORD2(v38) == 0x1000000 || DWORD2(v38) == 0x40000) )
    {
      ...
      if ( v14 >= 0 || v14 == -2147483643 || v14 == -1073741820 || v14 == -1073741789 )
      {
        v15 = v35;
        if ( HIDWORD(v35) )
          v15 = 0LL;
      ...
      if ( (unsigned int)v15 > 0x10 && (v14 >= 0 || v14 == -2147483643 || v14 == -1073741820 || v14 == -1073741789) )
    ...
    if ( !v11 )
    {
      ...
      else
      {
        ...
        *((_QWORD *)v22 + 10) = v22 + 44;
        ...
        if ( (v31 >= 0 || v31 == -1073741820 || v31 == -1073741789 || v31 == -2147483643) && HIDWORD(v35) )
        {
          v27 = 0LL;
          v31 = -1073741675;
        }
