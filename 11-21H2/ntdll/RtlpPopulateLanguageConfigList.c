/*
 * XREFs of RtlpPopulateLanguageConfigList @ 0x180112B9C
 * Callers:
 ...
 *     RtlpMuiRegConfigListAddLanguage @ 0x180110C1C (RtlpMuiRegConfigListAddLanguage.c)
            ...
            if ( v21 )
            {
              ...
              do
              {
                            ...
                            (__int16 *)v3 + 6) >= 0 )
                {
                  ...
                  *(_WORD *)(((unsigned __int64)&v31 & 0xFFFFFFFFFFFFFFE0uLL) + 0x3A) = ((*(_BYTE *)(((unsigned __int64)&v31 & 0xFFFFFFFFFFFFFFE0uLL) + 1) & 3) << (2 * v23)) | v18 & ~(3 << (2 * v23));
                ...
                v10 = RtlStringCbLengthW(v20, v22, (_QWORD *)v3 + 5);
                if ( v10 < 0 )
                {
              ...
              while ( v20 );
              v5 = *(_QWORD *)(((unsigned __int64)&v31 & 0xFFFFFFFFFFFFFFE0uLL) + 0x18);
              v26 = RtlpMuiRegValidateConfigNode(v5, (__int64)(v3 + 56));
              v4 = 0;
              v10 = v26;
              if ( v26 < 0 )
                goto LABEL_29;
