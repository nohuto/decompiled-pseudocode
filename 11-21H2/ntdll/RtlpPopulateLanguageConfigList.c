            ...
            if ( v22 )
            {
              ...
              do
              {
                            ...
                            (__int16 *)v3 + 6) >= 0 )
                {
                  ...
                  *(_WORD *)(((unsigned __int64)&v32 & 0xFFFFFFFFFFFFFFE0uLL) + 0x3A) = ((*(_BYTE *)(((unsigned __int64)&v32 & 0xFFFFFFFFFFFFFFE0uLL) + 1) & 3) << (2 * v24)) | v19 & ~(3 << (2 * v24));
              ...
              while ( v21 );
              v5 = *(_QWORD *)(((unsigned __int64)&v32 & 0xFFFFFFFFFFFFFFE0uLL) + 0x18);
              v27 = RtlpMuiRegValidateConfigNode(v5, (__int64)(v3 + 56));
              v4 = 0;
              v11 = v27;
              if ( v27 < 0 )
                goto LABEL_29;
