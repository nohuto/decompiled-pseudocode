/*
 * XREFs of RtlpQueryTimeZoneInformationWorker @ 0x180009444
 * Callers:
 *     RtlQueryTimeZoneInformation @ 0x180006C70 (RtlQueryTimeZoneInformation.c)
 *     EtwpGetTimeZoneInformation @ 0x1800092D8 (EtwpGetTimeZoneInformation.c)
 *     RtlQueryDynamicTimeZoneInformation @ 0x1800F9AA0 (RtlQueryDynamicTimeZoneInformation.c)
 * Callees:
