/*
 * XREFs of RtlpFindUnicodeStringInSection @ 0x180045FD0
 * Callers:
...
LABEL_15:
  ...
  if ( v9 && (*(_BYTE *)(a1 + 16) & 2) != 0 )
  {
    ...
    Key[0] = *a6;
    v35 = (char *)bsearch(Key, v33, v32, 0x18uLL, RtlpCompareActivationContextDataTOCEntryById);
    if ( !v35 )
      return -1072365560;
    for ( ; v35 != v33; v35 -= 24 )
    {
    ...
    while ( *(_DWORD *)v30 == v36 );
    if ( v30 > v34 || *(_DWORD *)v30 != v36 )
      return -1072365560;
LABEL_43:
    if ( !*((_DWORD *)v30 + 3) )
      return -1072365560;
