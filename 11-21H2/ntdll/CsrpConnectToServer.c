...
__int64 __fastcall CsrpConnectToServer(_WORD *Src, int a2, __int64 *a3, int a4, _DWORD *a5)
{
  ...
  if ( v11 > 0xFFFF )
    return 3221225734LL;
  word_18017A8E2 = 2 * v9 + 28;
  Heap = (char *)RtlAllocateHeap(CsrHeap, NtdllBaseTag, v11);
  qword_18017A8E8 = (__int64)Heap;
  v13 = Heap;
  if ( !Heap )
    return 3221225495LL;
  ...
  *((_WORD *)v14 + 12) = aSharedsection[12];
  v36 = 48;
  CsrPortName = (_WORD)v14 - qword_18017A8E8 + 26;
  v38 = &CsrPortName;
  v37 = 0LL;
  v39 = 64;
  v40 = 0LL;
