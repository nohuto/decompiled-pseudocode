/*
 * XREFs of _RtlpMuiRegAddBaseLanguage @ 0x1801131A4
 * Callers:
  ...
  if ( a1 && a2 && a4 && a3 <= 3 )
  {
    ...
    *(_WORD *)(a4 + 2 * v9 + 20) = 0;
    ...
    if ( v8 )
    {
      ...
      v29 = 0;
      v36[0] ^= (LOBYTE(v36[0]) ^ (unsigned __int8)*v35) & 0x18;
      *(_WORD *)(a4 + 2 * v9 + 20) = v30;
      v13 = 0;
      if ( String2 && *String2 && RtlpLangNameInMultiSzString(v7, String2) )
      {
        LanguageSpec = RtlpMuiRegGetLanguageSpec(v31, String2, &v28, 0LL, (__int16 *)&v30);
        v15 = v28;
        v16 = v30;
        if ( LanguageSpec >= 0 )
        {
