/*
 * XREFs of RtlWow64GetProcessMachines @ 0x180082B40
 * Callers:
...
LABEL_4:
  ...
  v20 = 20;
  v9 = (unsigned int *)v22;
  v5 = NtQuerySystemInformationEx(230LL, &v21, 8LL, v22, 20, &v20);
  if ( v5 == -1073741789 )
  {
    v16 = v20 + 15LL;
    if ( v16 <= v20 )
    ...
    v19 = alloca(v17);
    v9 = &v20;
    v5 = NtQuerySystemInformationEx(230LL, &v21, 8LL, &v20, v20, &v20);
  }
  if ( v5 >= 0 )
  {
    v10 = *v9;
