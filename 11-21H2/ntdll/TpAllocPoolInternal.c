...
__int64 __fastcall TpAllocPoolInternal(__int64 *a1, char a2)
{
  ...
  *a1 = 0LL;
  ...
  while ( v9 < 3 )
  {
    *(_QWORD *)(v10 + 8LL * v9 + 16) = v34 + 24LL * v9 * (unsigned int)v11;
    ++v9;
  }
...
LABEL_35:
      ...
      *(_QWORD *)(Heap + 400) = retaddr;
      ...
      if ( updated >= 0 )
      {
        updated = 0;
        v33 = 0;
        RtlAcquireSRWLockExclusive((unsigned __int64)&TppPoolpListLock, v24, v25, v26);
        v27 = (_QWORD *)(Heap + 384);
        v28 = off_1801744A8;
        ...
        *(_QWORD *)(Heap + 392) = v28;
        *v28 = v27;
        off_1801744A8 = (_UNKNOWN **)(Heap + 384);
