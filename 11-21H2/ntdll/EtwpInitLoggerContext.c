...
__int64 __fastcall EtwpInitLoggerContext(__int64 a1, int a2, unsigned int a3, __int64 a4, unsigned int a5)
{
  ...
  *((_QWORD *)&v29 + 1) = v10;
  Heap = RtlAllocateHeap(NtCurrentPeb()->ProcessHeap, 8LL, 8 * a3 + 568);
  if ( !Heap )
    return 0LL;
  v12 = RtlAllocateHeap(NtCurrentPeb()->ProcessHeap, 8LL, 4 * a3);
  *(_QWORD *)(Heap + 536) = v12;
  if ( v12 )
  {
    if ( a4 )
    {
      if ( (unsigned int)EtwpFillProcessorStreamIndexMap(Heap, v7, a4, a5) )
        goto LABEL_44;
      v22 = RtlAllocateHeap(NtCurrentPeb()->ProcessHeap, 8LL, 12LL * v7);
      *(_QWORD *)(Heap + 496) = v22;
      if ( !v22 )
        goto LABEL_44;
    }
    ...
    *(_DWORD *)(Heap + 192) = v16;
    if ( (unsigned __int8)RtlCreateUnicodeString(Heap + 136, *(_QWORD *)(a1 + 152))
