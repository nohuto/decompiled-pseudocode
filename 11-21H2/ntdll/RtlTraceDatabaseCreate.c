/*
 * XREFs of RtlTraceDatabaseCreate @ 0x18010F1A0
 * Callers:
 *     <none>
 * Callees:
        ...
        __int64 (__fastcall *a5)(unsigned int a1, __int64 a2))
{
  ...
  __int64 v11; // rbx
  __int64 v12; // r9
  __int64 (__fastcall *v13)(unsigned int, __int64); // rcx
  size_t v14; // r8
  __int64 result; // rax
  ...
  *(_QWORD *)(v9 + 32) = 0x10000LL;
  ...
  RtlInitializeCriticalSectionEx(v10 + 48, 0LL, 0LL, v12);
