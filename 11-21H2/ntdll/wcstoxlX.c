/*
 * XREFs of wcstoxlX @ 0x180099BD0
 * Callers:
 *     wcstol @ 0x180099DF0 (wcstol.c)
 *     wcstolX @ 0x180099E20 (wcstolX.c)
 *     wcstoul @ 0x180099E50 (wcstoul.c)
 * Callees:
 *     _errno @ 0x18008D010 (_errno.c)
 *     _invalid_parameter @ 0x180093768 (_invalid_parameter.c)
 *     _iswctype_l @ 0x180097680 (_iswctype_l.c)
 *     _wchartodigit @ 0x18009B708 (_wchartodigit.c)
 */
