...
__int64 __fastcall SbSelectProcedure(__int64 a1, unsigned int a2, __int64 a3, unsigned int a4)
{
  ...
  _EVENT_DATA_DESCRIPTOR v40; // [rsp+50h] [rbp-B0h] BYREF
  __int16 *v41; // [rsp+60h] [rbp-A0h]
  ...
  _EVENT_DATA_DESCRIPTOR UserData[8]; // [rsp+D0h] [rbp-30h] BYREF
        ...
        if ( v19 )
        {
          ...
          if ( v20 )
          {
            if ( *((_DWORD *)v20 + 12) && *((_DWORD *)v20 + 3) )
            {
              ...
              v30 = *v18;
              v40.Ptr = (unsigned __int64)(v18 + 14);
              v31 = -1LL;
              *(_QWORD *)&v40.Size = 16LL;
              ...
              v49 = v37;
              v50 = 0;
              EtwEventWrite(v29, &AeSbImplEvent, 5u, &v40);
            }
          }
        }
      }
