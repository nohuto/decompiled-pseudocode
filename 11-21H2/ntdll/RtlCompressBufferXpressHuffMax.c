/*
 * XREFs of RtlCompressBufferXpressHuffMax @ 0x18011DA9C
 * Callers:
        ...
        unsigned __int8 *a6)
{
  ...
  unsigned __int8 *v59; // [rsp+50h] [rbp-68h]
  char *v60; // [rsp+58h] [rbp-60h]
  _QWORD v61[2]; // [rsp+60h] [rbp-58h] BYREF
  unsigned int v62; // [rsp+70h] [rbp-48h]
  unsigned __int8 *v63; // [rsp+C0h] [rbp+8h]
  int v64; // [rsp+D0h] [rbp+18h]
  unsigned __int64 v66; // [rsp+F0h] [rbp+38h]
  __int64 v68; // [rsp+F8h] [rbp+40h]
  ...
  if ( a4 >= 0x12C )
  {
    ...
    *((_QWORD *)a6 + 0x8000) = 0LL;
    ...
    while ( 1 )
    {
      ...
      v16 = v10 + 4;
      if ( (unsigned __int64)(v11 + 0x10000) <= v66 )
        v15 = v11 + 0x10000;
      v17 = 1;
      ...
      do
      {
        v23 = (unsigned __int16)XpressHashFunction[*v21] ^ (unsigned __int16)word_18014F810[v21[2]] ^ (unsigned __int64)(unsigned __int16)word_18014F610[v21[1]];
        v24 = *(_QWORD *)&a6[8 * v23];
        *(_QWORD *)&a6[8 * v23] = v21++;
...
LABEL_87:
      ...
      *(_DWORD *)v10 = 2 * v17 + 1;
      ...
      if ( &v12[4 * ((unsigned __int64)(XpressBuildHuffmanEncodings((_QWORD *)a6 + 163840) + v56 + 31) >> 5) + 258 + v57] >= v60 )
        return 3221225507LL;
      v10 = a6 + 1342240;
      v12 = XpressDoHuffmanPass((__int64)(a6 + 1310720), a6 + 1342240, (unsigned __int64)v16, v12, v53);
      v58 = v12;
      v54 = v53 == 0;
      v7 = a2;
      if ( !v54 )
    ...
    XpressCallback = RtlpMakeXpressCallback(v61, v19, v11);
    v19 = v68;
    v18 = XpressCallback;
    v13 = v66;
    v55 = XpressCallback;
