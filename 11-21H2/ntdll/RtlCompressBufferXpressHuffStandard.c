/*
 * XREFs of RtlCompressBufferXpressHuffStandard @ 0x18005C580
 * Callers:
 *     RtlCompressBufferXpressHuff @ 0x18005C510 (RtlCompressBufferXpressHuff.c)
 * Callees:
 *     XpressDoHuffmanPass @ 0x18005CD70 (XpressDoHuffmanPass.c)
        ...
        _DWORD *a6)
{
  ...
  unsigned __int64 v65; // [rsp+58h] [rbp-80h]
  ...
  _QWORD v70[2]; // [rsp+88h] [rbp-50h] BYREF
  unsigned int v71; // [rsp+98h] [rbp-40h]
...
LABEL_22:
          ...
          if ( v37 >= 0xF )
          {
            ...
            *v17 = v41;
            v42 = v17 + 2;
            if ( (unsigned __int64)(v9 - v20 - 18) >= 0xFF )
            {
              *v38 = -1;
              if ( v37 < 0x10000 )
              {
...
LABEL_27:
          ...
          *v42 = v39;
          ...
          if ( (unsigned __int64)v9 >= v77 )
          {
            ...
            v61 = v9;
LABEL_101:
            XpressCallback = RtlpMakeXpressCallback(v70, v44, v61);
            v77 = XpressCallback;
          }
        }
        v9 = v19;
...
LABEL_32:
    ...
    *(_DWORD *)v8 = 2 * v16 + 1;
    ...
    if ( v12 + 4 * ((unsigned __int64)(v11 + XpressBuildHuffmanEncodings(a6 + 15304) + 31) >> 5) + v66 + 258 < v68 )
    {
      v8 = (unsigned __int8 *)(a6 + 23184);
      v47 = XpressDoHuffmanPass((int)a6 + 61216, (int)a6 + 92736, (_DWORD)v17, v66, v46);
      v7 = v64;
      v10 = a6 + 22608;
      v48 = v46 == 0;
      v66 = v47;
