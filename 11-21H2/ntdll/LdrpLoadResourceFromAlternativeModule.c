...
LABEL_37:
          ...
          ParentLangId = LdrpGetParentLangId(v11, v39);
          v15 = v45;
          v6 = 0;
          v13 = v42;
          v5 = DllHandle;
...
LABEL_22:
  ...
  v43 = 1;
  *(_QWORD *)(v49 + 16) = v11;
  v28 = LdrpSearchResourceSection_U((__int64)ResourceDllBase, v27, 3LL, 0x2000030u, (unsigned __int64)v26);
  ...
  {
LABEL_43:
    v32 = LdrpCompareServiceChecksum(DllHandle, ResourceDllBase);
    v6 = 0;
    if ( v32 )
      return MessageInAlternateModule;
    goto LABEL_87;
...
LABEL_26:
  v29 = ResourceDllBase;
  if ( *(_QWORD *)v50 <= (unsigned __int64)ResourceDllBase
    || ResourceOffset && *(_QWORD *)v50 >= (unsigned __int64)ResourceDllBase + ResourceOffset )
  {
    *(_QWORD *)v50 = 0LL;
