/*
 * XREFs of LdrpCompareResourceNamesWithValidation @ 0x180041128
 * Callers:
  ...
  *a6 = 1;
  ...
  if ( ((unsigned __int64)a3 & 0xFFFFFFFFFFFF0000uLL) != 0 )
  {
    if ( v9 < 0 )
    {
      ...
      {
        v12 = (unsigned __int16 *)(a4 + (v9 & 0x7FFFFFFF));
        if ( !v8 || (v13 = v9 & 0x7FFFFFFF, v14 = v13 + 2 * *v12, (unsigned int)v14 >= v13) && a4 + v14 <= v11 + a2 )
        {
