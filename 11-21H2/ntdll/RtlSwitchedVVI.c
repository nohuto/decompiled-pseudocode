...
DWORD __cdecl RtlSwitchedVVI(PRTL_OSVERSIONINFOEXW VersionInfo, DWORD TypeMask, ULONGLONG ConditionMask)
{
  ...
  if ( !result )
  {
    ...
    if ( (v4 & 2) != 0 )
    {
      ...
      v11 = (unsigned __int8)RtlpVerCompare(v9, VersionInfo->dwMajorVersion, v19[1], (unsigned int)v18, 0) == 0;
      v8 = v18[0];
      if ( v11 )
      {
        if ( !v18[0] )
    ...
    v11 = (unsigned __int8)RtlpVerCompare(v9, VersionInfo->dwMinorVersion, v19[2], (unsigned int)v18, 1) == 0;
    v8 = v18[0];
    if ( v11 )
    {
      if ( !v18[0] )
...
LABEL_6:
    ...
    if ( (unsigned __int8)RtlpVerCompare(v9, VersionInfo->wServicePackMajor, LOWORD(v19[69]), (unsigned int)v18, 0) )
    {
      v8 = v18[0];
LABEL_8:
      if ( v8 )
...
LABEL_10:
      if ( (v4 & 4) != 0 )
      {
        ...
        if ( !(unsigned __int8)RtlpVerCompare(v16, VersionInfo->dwBuildNumber, v19[3], (unsigned int)v18, 0) )
          return -1073741735;
      }
      if ( (v4 & 8) != 0 )
      {
        v17 = (ConditionMask & 0x8000000000000000uLL) == 0LL ? 0 : RtlpVerGetConditionMask(ConditionMask, 8LL);
        if ( !(unsigned __int8)RtlpVerCompare(v17, VersionInfo->dwPlatformId, v19[4], (unsigned int)v18, 0) )
          return -1073741735;
      }
      if ( v4 < 0 )
      {
        v10 = (ConditionMask & 0x8000000000000000uLL) == 0LL ? 0 : RtlpVerGetConditionMask(ConditionMask, 128LL);
        if ( !(unsigned __int8)RtlpVerCompare(v10, VersionInfo->wProductType, BYTE2(v19[70]), (unsigned int)v18, 0) )
          return -1073741735;
      }
      return 0;
    }
