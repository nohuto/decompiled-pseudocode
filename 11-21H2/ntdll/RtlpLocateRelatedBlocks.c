/*
 * XREFs of RtlpLocateRelatedBlocks @ 0x180116748
 * Callers:
...
LABEL_73:
    ...
    if ( v16 )
    {
      qword_1801777C8 = *(unsigned __int16 *)(a1 + 140) ^ (unsigned __int64)*(unsigned __int16 *)(v16 + 12);
      v26 = *(_DWORD *)(a1 + 124);
    }
    if ( v17 )
    {
    ...
    if ( qword_1801777C8 == (unsigned __int16)result )
    {
      result = *(unsigned __int16 *)(a1 + 140);
      if ( qword_1801777D0 != (result ^ *(unsigned __int16 *)(v17 + 16LL * v27 + 12)) )
        dword_180177788 = 7;
    }
    else
    {
