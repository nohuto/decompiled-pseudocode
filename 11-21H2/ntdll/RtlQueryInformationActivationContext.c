...
LABEL_61:
  ...
  if ( (Flags & 7) != 2 )
  {
    if ( (Flags & 7) == 4 )
    {
      ...
      if ( (unsigned __int64)ActivationContext < *((_QWORD *)&xmmword_18018F510 + 1)
        || (unsigned __int64)ActivationContext >= *((_QWORD *)&xmmword_18018F510 + 1)
...
LABEL_28:
  ...
  LoadedDllByHandle = LdrpFindLoadedDllByHandle(v8, &BaseAddress, &v21);
...
LABEL_13:
  ...
  switch ( ActivationContextInformationClass )
  {
    case ActivationContextBasicInformation:
      ...
      v22 = v14;
      InformationActivationContextBasicInformation = RtlpQueryInformationActivationContextBasicInformation(v14, v8, v23);
LABEL_19:
