...
LABEL_19:
      if ( Length )
      {
        if ( *v8 + (unsigned int)Length <= v8[1] )
        {
          ...
          v23 = (unsigned __int16)(Length + *v8);
          v24 = v8[1];
          *v8 = v23;
          if ( v23 + 1 < v24 )
            *((_WORD *)v22 + ((unsigned __int64)Length >> 1)) = 0;
        }
      }
      v25 = v47;
      v26 = *v8;
      ...
      *(_WORD *)(*((_QWORD *)v8 + 1) + 2 * v33) = 0;
      if ( a6 )
      {
        v33 = *a6;
        if ( *a6 )
          *a6 = *((_QWORD *)v8 + 1) + v33 + v18->Length - v25 - (_QWORD)v32;
      }
      v34 = v51;
      if ( v51 )
      {
        ...
        if ( v35 )
        {
          ...
          if ( v38 )
          {
            if ( !RtlPrefixUnicodeString((PUNICODE_STRING)(v38 + 24), &String2, 1u) )
              goto LABEL_69;
            v40 = (_WORD *)(*((_QWORD *)v8 + 1) + *(unsigned __int16 *)(v39 + 24) + v18->Length - v47);
            *((_QWORD *)v34 + 1) = v40;
