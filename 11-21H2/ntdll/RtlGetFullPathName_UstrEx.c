/*
 * XREFs of RtlGetFullPathName_UstrEx @ 0x180043AB0
 * Callers:
...
LABEL_11:
    LODWORD(a8) = v15;
    FullPathName_Ustr = RtlGetFullPathName_Ustr(a1, v15, v16, &v29, a6, &a5);
...
LABEL_56:
        ...
        else
        {
          while ( 1 )
          {
            v21 = v18 + 2;
            v22 = v21;
            StringRoutine = NtdllpAllocateStringRoutine(v21);
            if ( !StringRoutine )
            {
              v19 = -1073741801;
              goto LABEL_18;
            }
            v23 = RtlGetFullPathName_Ustr(a1, (unsigned int)v21 - 2, StringRoutine, &v29, a6, &a5);
            v18 = v23;
            if ( !v23 )
              goto LABEL_47;
          ...
          {
            if ( v29 )
              v27 = (v29 - StringRoutine) >> 1;
            else
              v27 = 0LL;
            *v13 = v27;
          }
          *(_WORD *)(StringRoutine + 2 * ((unsigned __int64)(unsigned int)v18 >> 1)) = 0;
