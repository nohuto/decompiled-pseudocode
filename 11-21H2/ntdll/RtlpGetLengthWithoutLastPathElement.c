/*
 * XREFs of RtlpGetLengthWithoutLastPathElement @ 0x18007B6A4
 * Callers:
 *     RtlGetLengthWithoutLastFullDosOrNtPathElement @ 0x18007B690 (RtlGetLengthWithoutLastFullDosOrNtPathElement.c)
 * Callees:
