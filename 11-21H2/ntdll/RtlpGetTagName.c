/*
 * XREFs of RtlpGetTagName @ 0x1800FF464
 * Callers:
...
LABEL_16:
  ...
  {
    if ( v2 >= 0x80u )
      RtlStringCbPrintfW(word_18017B300, 0x30uLL, L"VirtualAlloc", 0LL);
    else
      RtlStringCbPrintfW(word_18017B300, 0x30uLL, L"Objects=%4u", 16 * (unsigned int)v2);
  }
  else
  {
    RtlStringCbPrintfW(word_18017B300, 0x30uLL, L"Objects>%4u", 2048LL);
  }
  return word_18017B300;
}
