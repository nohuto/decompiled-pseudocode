/*
 * XREFs of LdrResGetRCConfig @ 0x180067050
 * Callers:
 ...
 *     LdrpResSearchResourceMappedFile @ 0x180064E1C (LdrpResSearchResourceMappedFile.c)
 *     CheckOneBitValidFlag @ 0x180067558 (CheckOneBitValidFlag.c)
...
LABEL_16:
    ...
    v15 = v42;
    v16 = LdrpResSearchResourceMappedFile(v42, v43, v7 != 0 ? 8240 : 4144, (__int64)v50, 3, &v41, v45, 0LL, 0LL);
    if ( v16 < 0 )
    {
      if ( v16 != -1073741701 )
        v16 = -1073741686;
