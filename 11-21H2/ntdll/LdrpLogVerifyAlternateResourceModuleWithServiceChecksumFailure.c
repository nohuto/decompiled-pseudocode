/*
 * XREFs of LdrpLogVerifyAlternateResourceModuleWithServiceChecksumFailure @ 0x1800DBFF8
 * Callers:
        ...
        __int64 a3)
{
  ...
  v6 = RtlRunOnceExecuteOnce(&stru_18017B070, LdrpResReportResourceAccessInternalInitOnce, 0LL, 0LL);
  if ( v6 >= 0 && (unsigned int)dword_1801748F8 > 5 )
  {
    LOBYTE(v6) = tlgKeywordOn((__int64)&dword_1801748F8, 0x200000000000LL);
    if ( (_BYTE)v6 )
    {
      v13 = 0x1000000LL;
      v16 = 8LL;
      ...
      LOBYTE(v6) = tlgWriteTransfer_EtwEventWriteTransfer(
                     v7,
                     (unsigned __int8 *)dword_180141836,
                     (unsigned int)(v9 + 4),
                     v8,
                     9u,
                     &v14);
