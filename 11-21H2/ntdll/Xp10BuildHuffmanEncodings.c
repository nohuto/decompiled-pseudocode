/*
 * XREFs of Xp10BuildHuffmanEncodings @ 0x18011A84C
 * Callers:
  ...
  if ( v9 > (unsigned __int64)(a1 + 6) )
  {
    ...
    if ( (_DWORD)v18 )
    {
      ...
      do
      {
        ...
        v23 = *((_WORD *)v19 + 8);
        v19 += 24;
        v24 = *((unsigned __int16 *)a1 + v22 + 16908);
        *((_WORD *)a1 + v22 + 16908) = v24 + 1;
            ...
            if ( *((unsigned __int8 *)a1 + v53 + 38176) == v47 )
            {
              ...
              if ( v47 > 8 )
              {
                ...
                do
                {
                  ...
                  v54 -= 8;
                  v55 >>= 8;
                  v56 = byte_18013CB70[v57] | (v56 << 8);
                  --v48;
                }
                while ( v48 );
              }
              if ( v54 )
                v56 = (byte_18013CB70[(unsigned __int8)v55] | (v56 << 8)) >> (8 - v54);
