...
PIMAGE_NT_HEADERS __fastcall LdrpGetImportDescriptorForSnap(__int64 a1)
{
  ...
  v1 = *(_QWORD *)(a1 + 56);
  v3 = RtlpImageDirectoryEntryToDataEx(*(_QWORD *)(v1 + 48), 1, 1u, &v7, (PIMAGE_NT_HEADERS)&OutHeaders);
  v4 = OutHeaders;
  if ( v3 < 0 )
    v4 = 0LL;
  if ( v1 == LdrpImageEntry && ((LdrSystemDllInitBlock.MitigationOptionsMap.Map[1] >> 44) & 3) == 1 )
  {
    ...
    {
      v6 = RtlpImageDirectoryEntryToDataEx(*(_QWORD *)(a1 + 192), 1, 1u, &v7, (PIMAGE_NT_HEADERS)&OutHeaders);
      v4 = OutHeaders;
      if ( v6 < 0 )
        return 0LL;
    }
