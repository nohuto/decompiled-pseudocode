...
__int64 __fastcall RtlpHpSegMgrReserve(
        __int64 a1,
        unsigned __int64 a2,
        unsigned __int64 a3,
        unsigned int *a4,
        _DWORD *a5)
{
  ...
  int v24; // eax
  __int64 v25; // rdx
  __int64 v26[2]; // [rsp+30h] [rbp-20h] BYREF
  __int128 v27; // [rsp+40h] [rbp-10h] BYREF
  unsigned __int64 v28; // [rsp+90h] [rbp+40h] BYREF
  _QWORD *v29; // [rsp+A0h] [rbp+50h]
  ...
  if ( *(_QWORD *)(a1 + 120) || *v6 )
  {
    ...
    RtlAcquireSRWLockExclusive(a1 + 112, a2, a3, v8);
    v21 = *v6;
    if ( !*v6 )
    {
      if ( (v7 & 2) != 0 || (v21 = *v5, v6 = v5, !*v5) )
      {
...
LABEL_4:
  ...
  v12 = *(_QWORD *)(a1 + 56);
  v13 = (*(_DWORD *)(v12 + 20) & 0x40000000) != 0;
  v27 = *(_OWORD *)(a1 + 40);
  v14 = RtlpHpHeapValidateProtection(v12, v13 ? 64 : 4);
  v16 = RtlpHpAllocVA(v26, (__int64 *)&v28, v28, 0x2000, v14, &v27);
  if ( v16 >= 0 )
  {
    LODWORD(v11) = v28;
    if ( v8 < v28 )
    {
      RtlpHpSegMgrVaCtxInitialize(v15, v26[0], v8, v28);
      LODWORD(v11) = v28;
    }
    goto LABEL_8;
  }
...
LABEL_9:
  ...
  {
    v27 = *(_OWORD *)(a1 + 40);
    RtlpHpFreeVA((unsigned __int64 *)v26, &v28, 0x8000, &v27);
  }
