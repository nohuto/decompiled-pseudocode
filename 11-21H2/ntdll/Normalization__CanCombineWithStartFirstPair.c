/*
 * XREFs of Normalization__CanCombineWithStartFirstPair @ 0x18010CC1C
 * Callers:
 ...
 *     Normalization__GetSecondDecomposedCharPlane0 @ 0x18010CEA8 (Normalization__GetSecondDecomposedCharPlane0.c)
 */
