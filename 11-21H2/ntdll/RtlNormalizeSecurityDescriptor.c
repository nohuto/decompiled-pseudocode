...
LABEL_44:
            memmove((void *)(Heap + v10), v19, (unsigned __int16)v19[1]);
            v18 = v41;
LABEL_45:
            v17 = v40;
            v13 = v46;
...
LABEL_49:
      ...
      v29 = v28 - v14;
      if ( v28 - v14 == *(unsigned __int16 *)(v13 + v5 + 2) )
      {
        v30 = v45;
      }
      else
      ...
      {
        if ( v14 == v12
          && v29 == *(unsigned __int16 *)(v13 + v5 + 2)
          && !(unsigned __int8)RtlIsZeroMemory(v5 + v10, v28 - v10) )
        {
          v9 = 1;
          if ( a5 )
            goto LABEL_82;
        ...
        if ( !a5 )
          memset((void *)(Heap + v10), 0, v28 - v10);
...
LABEL_67:
  ...
  v33 = 4 * v32[1] + 8;
  if ( !a5 )
    memmove((void *)(Heap + *(unsigned int *)(Heap + 4)), v32, v33);
  v34 = *(_DWORD *)(v5 + 8);
  v35 = v33 + v10;
  if ( !v34 )
    goto LABEL_76;
