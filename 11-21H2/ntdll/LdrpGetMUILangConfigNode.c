/*
 * XREFs of LdrpGetMUILangConfigNode @ 0x1800F9FF8
 * Callers:
 *     RtlpTraverseParents @ 0x18006337C (RtlpTraverseParents.c)
 * Callees:
 *     RtlpCompareConfigNodeWithSpec @ 0x1800FB348 (RtlpCompareConfigNodeWithSpec.c)
 *     RtlpMuiRegGetLanginfoTypeNSpec @ 0x1800FBD3C (RtlpMuiRegGetLanginfoTypeNSpec.c)
 */
