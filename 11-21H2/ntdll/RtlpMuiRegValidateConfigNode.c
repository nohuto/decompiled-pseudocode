/*
 * XREFs of RtlpMuiRegValidateConfigNode @ 0x1801129D8
 * Callers:
...
__int64 __fastcall RtlpMuiRegValidateConfigNode(__int64 a1, __int64 a2)
{
  ...
  v3 = *(unsigned __int16 *)(a2 + 2) >> 14;
  v17 = -1;
  InstalledLanguageIndex = RtlpMuiRegGetInstalledLanguageIndex(a1, v3, *(_WORD *)a2, &i);
  if ( InstalledLanguageIndex >= 0 )
  {
    ...
    else
    {
      ...
      while ( 1 )
      {
        ...
        v10 = 0;
        v11 = 0;
        v12 = *(unsigned __int16 *)(a2 + 2LL * v7 + 6);
        for ( i = *(_WORD *)(a2 + 2LL * v7 + 6); ; v12 = i )
        {
          v13 = (v6[4] >> v11) & 3;
          v19 = 0LL;
        ...
        if ( v17 != 0xFFFF )
        {
          *(_WORD *)(a2 + 2) = (2 << (2 * v7)) | *(_WORD *)(a2 + 2) & ~(3 << (2 * v7));
          *(_WORD *)(a2 + 2LL * v7 + 6) = v14;
        }
        ++v7;
        v8 += 2;
        if ( v8 >= 6 )
