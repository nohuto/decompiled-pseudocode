...
LABEL_21:
  ...
  if ( v25 < 0x20 )
  {
    while ( 1 )
    {
      v26 = RtlpInterlockedPopEntrySList((PSLIST_HEADER)&v5[2 * v25 + 26]);
      if ( v26 )
        break;
      if ( ++v25 >= 0x20 )
      {
...
LABEL_78:
  ...
  if ( v27 )
  {
    ...
    if ( v48 > 0x1F )
      LOWORD(v48) = 31;
    *((_WORD *)&v27->Next + 4) &= 0x7FFu;
    *((_WORD *)&v27->Next + 4) |= (_WORD)v48 << 11;
    goto LABEL_49;
  }
LABEL_48:
  i = (unsigned __int64)v27;
...
LABEL_49:
  ...
  *((_WORD *)&v27->Next + 4) &= 0xF800u;
  v32 = 2LL * (BackTraceHash % *(_DWORD *)&v5[90].0);
  v27->Next = (_SLIST_ENTRY *)v5[2 * (BackTraceHash % *(_DWORD *)&v5[90].0) + 91];
  v5[v32 + 91].Value = (unsigned __int64)v27;
LABEL_50:
  v33 = *(_WORD *)(i + 8);
  if ( (v33 & 0x7FF) != 0x7FF )
...
LABEL_125:
        ...
        v5[19].Value = (unsigned __int64)v82;
      }
    }
...
LABEL_149:
  if ( !(_DWORD)v6 )
    RtlStdReleaseStackTrace(v5, i, v10);
LABEL_6:
  ...
  v8 = NtCreateSemaphore(&v87, 0x100003u, 0LL, 0, 0x7FFFFFFF);
  if ( v8 < 0 )
  {
  ...
  *(_QWORD *)&Resource->NumberOfWaitingExclusive = 0LL;
  ...
  RtlpAddDebugInfoToCriticalSection((__int64)Resource);
