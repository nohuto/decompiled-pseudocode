/*
 * XREFs of RtlpCombineAcls @ 0x180010F38
 * Callers:
...
LABEL_131:
  ...
  else
  {
    ...
    Heap = RtlAllocateHeap(NtCurrentPeb()->ProcessHeap, (unsigned int)(NtdllBaseTag + 1310720), v21);
    v15 = Heap;
    if ( Heap )
    {
      ...
      if ( Acl >= 0 )
      {
        if ( (unsigned __int8)RtlFirstFreeAce(v15, &v58) )
        {
