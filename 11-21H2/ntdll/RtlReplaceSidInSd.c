/*
 * XREFs of RtlReplaceSidInSd @ 0x1800F1C40
 * Callers:
 *     <none>
 * Callees:
 ...
 *     RtlGetSaclSecurityDescriptor @ 0x18007EFC0 (RtlGetSaclSecurityDescriptor.c)
 *     RtlGetGroupSecurityDescriptor @ 0x180082D10 (RtlGetGroupSecurityDescriptor.c)
  ...
  *a4 = 0;
  ...
  if ( (int)result >= 0 )
  {
    ...
    if ( (int)result >= 0 )
    {
      ...
      v30[0] = 0LL;
      result = RtlGetDaclSecurityDescriptor(v9, &v34, v30, &v32);
      if ( (int)result >= 0 )
      {
        if ( (_BYTE)v34 )
        {
...
LABEL_39:
        v30[0] = 0LL;
        result = RtlGetSaclSecurityDescriptor(v9, &v34, v30, &v32);
