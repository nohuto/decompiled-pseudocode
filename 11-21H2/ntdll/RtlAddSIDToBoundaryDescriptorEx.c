/*
 * XREFs of RtlAddSIDToBoundaryDescriptorEx @ 0x1800881D0
 * Callers:
 *     RtlAddSIDToBoundaryDescriptor @ 0x1800881C0 (RtlAddSIDToBoundaryDescriptor.c)
 *     RtlAddIntegrityLabelToBoundaryDescriptor @ 0x1800F5D70 (RtlAddIntegrityLabelToBoundaryDescriptor.c)
 * Callees:
