/*
 * XREFs of RtlpQueryExtendedInformationHeap @ 0x1800833B0
 * Callers:
 ...
 *     RtlpHpHeapReportCounters @ 0x1800835AC (RtlpHpHeapReportCounters.c)
 ...
 *     RtlpQueryMemoryUsageHeap @ 0x1800FFED0 (RtlpQueryMemoryUsageHeap.c)
 */
...
LABEL_99:
    ...
    else
    {
      ...
      v50[3] = *(_QWORD *)(v24 + 32);
      LODWORD(v50[4]) = 1;
      HIDWORD(v50[4]) = RtlpGetHeapProtection(a1, 0);
    }
    result = v40(v50, v42);
    if ( (int)result < 0 )
      return result;
