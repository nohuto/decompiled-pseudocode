/*
 * XREFs of RtlCSparseBitmapFindBitSetCapped @ 0x180057D04
 * Callers:
 ...
 * Callees:
 *     RtlLengthCurrentClearRunForwardEx @ 0x1800F8118 (RtlLengthCurrentClearRunForwardEx.c)
 */
    ...
    if ( _bittest64((const signed __int64 *)(a1 + 56), a2 >> 30) )
    {
      if ( _bittest64(*(const signed __int64 **)a1, a2 >> 15) )
      {
        ...
        else if ( v7 <= 0 )
        {
          ...
          v14 = a2 & 0x1F;
          v15 = *(_DWORD *)v13 & dword_180136CB0[v14];
