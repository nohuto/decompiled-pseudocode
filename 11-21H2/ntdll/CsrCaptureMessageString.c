/*
 * XREFs of CsrCaptureMessageString @ 0x180079DD0
 * Callers:
 *     CsrCaptureMessageMultiUnicodeStringsInPlace @ 0x180079CD0 (CsrCaptureMessageMultiUnicodeStringsInPlace.c)
 * Callees:
 *     CsrAllocateMessagePointer @ 0x180079E80 (CsrAllocateMessagePointer.c)
