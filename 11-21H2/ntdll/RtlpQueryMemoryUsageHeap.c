/*
 * XREFs of RtlpQueryMemoryUsageHeap @ 0x1800FFED0
 * Callers:
 *     RtlpQueryExtendedInformationHeap @ 0x1800833B0 (RtlpQueryExtendedInformationHeap.c)
 *     RtlpHeapQueryTotalReserveSize @ 0x1800FF760 (RtlpHeapQueryTotalReserveSize.c)
 * Callees:
 *     RtlpGetLowFragHeapMetadataSize @ 0x180118668 (RtlpGetLowFragHeapMetadataSize.c)
 */
