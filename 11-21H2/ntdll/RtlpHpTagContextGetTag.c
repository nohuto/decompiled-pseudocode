/*
 * XREFs of RtlpHpTagContextGetTag @ 0x1800A3794
 * Callers:
...
__int64 __fastcall RtlpHpTagContextGetTag(__int64 a1, unsigned __int64 a2)
{
  ...
  if ( SubProcessTag == (void *)RtlpHpNullGUID )
    v4 = *((_QWORD *)&v16 + 1) - qword_18017AF00;
  if ( !v4 )
    return 0LL;
  if ( word_180178B44 )
  {
    v6 = *(_QWORD *)(qword_180178B38 + 8LL * (unsigned __int16)word_180178B44 - 8);
