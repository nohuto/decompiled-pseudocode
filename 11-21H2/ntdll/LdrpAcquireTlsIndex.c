...
LABEL_6:
  ...
  ClearBitsAndSet = RtlFindClearBitsAndSet((__int64)&LdrpTlsBitmap, 1u, 0);
  ...
  Heap = (void *)RtlAllocateHeap(LdrpTlsHeap, NtdllBaseTag + 786432, 4 * (((unsigned __int64)(v2 + 8) + 31) >> 5));
  v8 = Heap;
  if ( Heap )
  {
    ...
    if ( Src != &LdrpStaticTlsBitmapVector )
      RtlFreeHeap(LdrpTlsHeap, 0, (__int64)Src);
    LdrpTlsBitmap = v2 + 8;
    Src = v8;
    goto LABEL_6;
  }
