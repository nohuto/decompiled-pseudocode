/*
 * XREFs of EvtIntReportEventWorker @ 0x180005D70
 * Callers:
 *     EvtIntReportEventAndSourceAsync @ 0x180005D00 (EvtIntReportEventAndSourceAsync.c)
 *     EvtIntReportAuthzEventAndSourceAsync @ 0x1801231D0 (EvtIntReportAuthzEventAndSourceAsync.c)
 * Callees:
        ...
        __int64 a11)
{
  ...
  *(_DWORD *)&EventDescriptor.Id = 0;
  ...
  if ( v13 )
  {
    ...
    {
      Win32Error = 87;
      local_unwind(v42, &loc_1800060C6);
      goto LABEL_29;
    }
    v35 = 4 * v13[1] + 8;
  }
