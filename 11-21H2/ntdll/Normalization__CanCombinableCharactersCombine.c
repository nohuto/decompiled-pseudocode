/*
 * XREFs of Normalization__CanCombinableCharactersCombine @ 0x18010CA6C
 * Callers:
 ...
 *     Normalization__CanCombineWithStartBase @ 0x18010CBD0 (Normalization__CanCombineWithStartBase.c)
 *     Normalization__CanCombineWithStartFirstPair @ 0x18010CC1C (Normalization__CanCombineWithStartFirstPair.c)
 *     Normalization__IsNormalized @ 0x18010CF44 (Normalization__IsNormalized.c)
 * Callees:
 *     <none>
 */
