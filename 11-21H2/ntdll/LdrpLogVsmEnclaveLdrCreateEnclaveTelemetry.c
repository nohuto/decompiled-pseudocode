/*
 * XREFs of LdrpLogVsmEnclaveLdrCreateEnclaveTelemetry @ 0x1800DC144
 * Callers:
...
char __fastcall LdrpLogVsmEnclaveLdrCreateEnclaveTelemetry(__int64 a1, int a2)
{
  ...
  if ( v2->ProcessHeap )
  {
    ...
    {
      LOBYTE(v2) = tlgKeywordOn((__int64)&dword_180174930, 0x400000000000LL);
      if ( (_BYTE)v2 )
      {
        v14 = 0;
        v17 = 0;
        ...
        v9 = a2;
        v19 = 4;
        LOBYTE(v2) = tlgWriteTransfer_EtwEventWriteTransfer(v5, byte_180141B0C, v6, v7, 5, (__int64)v11);
      }
    }
  }
  return (char)v2;
