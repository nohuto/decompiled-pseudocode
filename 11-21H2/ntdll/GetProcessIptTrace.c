/*
 * XREFs of GetProcessIptTrace @ 0x180126BDC
 * Callers:
 *     PsspCaptureIptTrace @ 0x180061040 (PsspCaptureIptTrace.c)
 * Callees:
 *     RtlReleasePrivilege @ 0x180086900 (RtlReleasePrivilege.c)
 *     NtDeviceIoControlFile @ 0x1800A4150 (NtDeviceIoControlFile.c)
 *     NtClose @ 0x1800A4250 (NtClose.c)
 *     ZwCreateFile @ 0x1800A4B10 (ZwCreateFile.c)
 *     AcquireDebugPrivilege @ 0x180126BA8 (AcquireDebugPrivilege.c)
 */
...
NTSTATUS __fastcall GetProcessIptTrace(__int64 a1, void *a2, ULONG a3)
{
  ...
  bool v7; // bl
  NTSTATUS v8; // edi
  struct _IO_STATUS_BLOCK IoStatusBlock; // [rsp+68h] [rbp-39h] BYREF
  ...
  struct _IO_STATUS_BLOCK v14; // [rsp+D8h] [rbp+37h] BYREF
