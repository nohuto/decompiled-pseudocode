/*
 * XREFs of ?WithinAngle@EdgyRecognizer@@AEAA_NUtagPOINT@@0UVector2@Numerics@Foundation@Windows@@M@Z @ 0x18014BD34
 * Callers:
 ...
 *     ?NormalizedDotProduct@MathHelper@@SANUVector2@Numerics@Foundation@Windows@@0@Z @ 0x18019D39C (-NormalizedDotProduct@MathHelper@@SANUVector2@Numerics@Foundation@Windows@@0@Z.c)
 */
