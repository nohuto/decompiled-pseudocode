/*
 * XREFs of ?Thunk_CheckProtocol_6@?$IBamoPeer_MPCManagerBamo_AutoBamos_Receive@VBamoPeerImpl@MPCManagerBamo_AutoBamos@BamoImpl@@@@SAJPEAXPEAPEAX@Z @ 0x18009B610
 * Callers:
 *     <none>
 * Callees:
