/*
 * XREFs of ??1?$deque@UPointerFrame@PointerInputMediator@@V?$allocator@UPointerFrame@PointerInputMediator@@@std@@@std@@QEAA@XZ @ 0x180049878
 * Callers:
 *     _dynamic_atexit_destructor_for__PointerInputMediator::s_frameQueue__ @ 0x180058C00 (_dynamic_atexit_destructor_for__PointerInputMediator--s_frameQueue__.c)
 * Callees:
