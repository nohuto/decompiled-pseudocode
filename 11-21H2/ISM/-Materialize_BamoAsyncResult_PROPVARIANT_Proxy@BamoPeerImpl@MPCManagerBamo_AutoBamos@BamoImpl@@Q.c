/*
 * XREFs of ?Materialize_BamoAsyncResult_PROPVARIANT_Proxy@BamoPeerImpl@MPCManagerBamo_AutoBamos@BamoImpl@@QEAAJI@Z @ 0x1800994F8
 * Callers:
 *     ?Thunk_Materialize_BamoAsyncResult_PROPVARIANT_Proxy_11@?$IBamoPeer_MPCManagerBamo_AutoBamos_Receive@VBamoPeerImpl@MPCManagerBamo_AutoBamos@BamoImpl@@@@SAJPEAXPEAPEAX@Z @ 0x18009B8D0 (-Thunk_Materialize_BamoAsyncResult_PROPVARIANT_Proxy_11@-$IBamoPeer_MPCManagerBamo_AutoBamos_Rec.c)
 * Callees:
        ...
        __int64 a3)
{
  ...
  *v15 = &BamoAsyncResult_PROPVARIANT_Proxy::`vftable'{for `Microsoft::Bamo::BamoProxy'};
  v15[1] = &BamoAsyncResult_PROPVARIANT_Proxy::`vftable'{for `IAsyncResult_PROPVARIANT_Proxy'};
  *((_DWORD *)v15 + 6) = 0;
  v15[4] = 0LL;
  *((_DWORD *)v15 + 10) = 0;
  *((_DWORD *)v15 + 11) = 0;
  v15[2] = &BamoImpl::BamoAsyncResult_PROPVARIANT_ProxyImpl::`vftable';
  Microsoft::BamoImpl::CalloutWrapper<Microsoft::BamoImpl::CalloutWrapperObject>::~CalloutWrapper<Microsoft::BamoImpl::CalloutWrapperObject>(
    v13,
    v5,
    v6,
