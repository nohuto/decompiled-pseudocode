/*
 * XREFs of ??0?$CalloutWrapper@VBamoCustomCursorControllerClient2ProxyImpl@BamoImpl@@@BamoImpl@Microsoft@@QEAA@PEAVBaseBamoConnectionImpl@12@PEAVBamoCustomCursorControllerClient2ProxyImpl@1@W4PrologEpilogConfig@12@@Z @ 0x180102A98
 * Callers:
