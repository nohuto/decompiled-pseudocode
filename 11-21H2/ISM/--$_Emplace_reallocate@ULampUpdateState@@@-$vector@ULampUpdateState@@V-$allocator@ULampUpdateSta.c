/*
 * XREFs of ??$_Emplace_reallocate@ULampUpdateState@@@?$vector@ULampUpdateState@@V?$allocator@ULampUpdateState@@@std@@@std@@QEAAPEAULampUpdateState@@QEAU2@$$QEAU2@@Z @ 0x1800D1794
 * Callers:
 ...
 *     ?_Change_array@?$vector@ULampUpdateState@@V?$allocator@ULampUpdateState@@@std@@@std@@AEAAXQEAULampUpdateState@@_K1@Z @ 0x1800D30BC (-_Change_array@-$vector@ULampUpdateState@@V-$allocator@ULampUpdateState@@@std@@@std@@AEAAXQEAULa.c)
 */
        ...
        _QWORD *a3)
{
  ...
  try
  {
    ...
    *(_QWORD *)v15 = *a3;
    ...
    std::vector<LampUpdateState>::_Change_array(a1, v14, v9, v8);
    result = v15;
  }
  catch ( ... )
  {
