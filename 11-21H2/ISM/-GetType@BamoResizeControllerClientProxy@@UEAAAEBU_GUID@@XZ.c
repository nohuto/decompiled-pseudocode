/*
 * XREFs of ?GetType@BamoResizeControllerClientProxy@@UEAAAEBU_GUID@@XZ @ 0x18010A7B0
 * Callers:
 *     <none>
 * Callees:
...
const struct _GUID *__fastcall BamoResizeControllerClientProxy::GetType(BamoResizeControllerClientProxy *this)
{
