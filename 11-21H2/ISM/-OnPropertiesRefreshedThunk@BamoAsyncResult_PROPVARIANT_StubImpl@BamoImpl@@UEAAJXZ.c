/*
 * XREFs of ?OnPropertiesRefreshedThunk@BamoAsyncResult_PROPVARIANT_StubImpl@BamoImpl@@UEAAJXZ @ 0x18016E980
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall BamoImpl::BamoAsyncResult_PROPVARIANT_StubImpl::OnPropertiesRefreshedThunk(
        ...
        __int64 a3)
{
  BamoImpl::BamoAsyncResult_PROPVARIANT_StubImpl *v3; // rbx
  __int64 v4; // rdi
  __int64 v5; // rdx
  __int64 v6; // r8
  const char *v7; // r9
