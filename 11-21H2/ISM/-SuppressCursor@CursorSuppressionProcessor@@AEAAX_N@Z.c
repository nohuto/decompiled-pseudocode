/*
 * XREFs of ?SuppressCursor@CursorSuppressionProcessor@@AEAAX_N@Z @ 0x1801388F8
 * Callers:
...
void __fastcall CursorSuppressionProcessor::SuppressCursor(CursorSuppressionProcessor *this, char a2)
{
  ...
  v3 = *(_QWORD *)(*((_QWORD *)this + 10) + 232LL) + 8LL;
  v4 = *(_QWORD *)((*(__int64 (__fastcall **)(__int64))(*(_QWORD *)v3 + 216LL))(v3) + 80);
  if ( v4 )
  {
    LOBYTE(v5) = a2;
