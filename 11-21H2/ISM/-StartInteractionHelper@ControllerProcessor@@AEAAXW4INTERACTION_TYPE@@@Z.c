/*
 * XREFs of ?StartInteractionHelper@ControllerProcessor@@AEAAXW4INTERACTION_TYPE@@@Z @ 0x180179220
 * Callers:
 ...
 * Callees:
 *     ?SetZoomIncreasingThresholds@ManipulationInjector@@QEAAXJJ@Z @ 0x18004DA04 (-SetZoomIncreasingThresholds@ManipulationInjector@@QEAAXJJ@Z.c)
 *     ?GetDisplaySizeScaleFactor@ControllerProcessor@@AEAAMXZ @ 0x18004E1F0 (-GetDisplaySizeScaleFactor@ControllerProcessor@@AEAAMXZ.c)
 ...
 *     ?StartZoom@ManipulationInjector@@QEAAXAEAUtagPOINT@@_NK@Z @ 0x180101B44 (-StartZoom@ManipulationInjector@@QEAAXAEAUtagPOINT@@_NK@Z.c)
