/*
 * XREFs of ?PushStateToPrincipalOnPropertiesRefresh@BamoSystemContextEndpointProxyImpl@BamoImpl@@UEAAXPEAUIMessageCallSendHost@@PEAVBaseBamoPeerImpl@2Microsoft@@@Z @ 0x180137A10
 * Callers:
 *     <none>
 * Callees:
