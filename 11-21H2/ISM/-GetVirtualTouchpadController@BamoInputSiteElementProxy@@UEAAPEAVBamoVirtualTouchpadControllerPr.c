/*
 * XREFs of ?GetVirtualTouchpadController@BamoInputSiteElementProxy@@UEAAPEAVBamoVirtualTouchpadControllerProxy@@XZ @ 0x18000D930
 * Callers:
 *     <none>
 * Callees:
        ...
        BamoInputSiteElementProxy *this)
{
  ...
  return (struct BamoVirtualTouchpadControllerProxy *)*((_QWORD *)this + 36);
}
