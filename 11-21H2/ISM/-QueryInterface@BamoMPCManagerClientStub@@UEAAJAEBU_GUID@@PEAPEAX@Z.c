/*
 * XREFs of ?QueryInterface@BamoMPCManagerClientStub@@UEAAJAEBU_GUID@@PEAPEAX@Z @ 0x180160650
 * Callers:
 *     ?QueryInterface@BamoMPCManagerClientStub@@W7EAAJAEBU_GUID@@PEAPEAX@Z @ 0x180051BC0 (-QueryInterface@BamoMPCManagerClientStub@@W7EAAJAEBU_GUID@@PEAPEAX@Z.c)
 * Callees:
