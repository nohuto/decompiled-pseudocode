/*
 * XREFs of ?OnReaderConnected@BamoDataProviderPrincipalImpl@BamoImpl@@QEAAJ_K@Z @ 0x1800F66C8
 * Callers:
 *     ?Thunk_OnReaderConnected_0@?$IDataProviderPrincipal_Receive@VBamoDataProviderPrincipalImpl@BamoImpl@@@@SAJPEAXPEAPEAX@Z @ 0x1800F8450 (-Thunk_OnReaderConnected_0@-$IDataProviderPrincipal_Receive@VBamoDataProviderPrincipalImpl@BamoI.c)
 * Callees:
        ...
        __int64 a2)
{
  ...
  Microsoft::BamoImpl::CalloutWrapper<Microsoft::BamoImpl::CalloutWrapperObject>::CalloutWrapper<Microsoft::BamoImpl::CalloutWrapperObject>(
    ...
    *(_QWORD *)(*(_QWORD *)(v4[5] + 24LL) + 32LL),
    v7,
    0);
  v8 = (*(__int64 (__fastcall **)(char *, __int64, __int64))(*((_QWORD *)this - 2) + 96LL))((char *)this - 16, v6, a2);
  v12 = v8;
