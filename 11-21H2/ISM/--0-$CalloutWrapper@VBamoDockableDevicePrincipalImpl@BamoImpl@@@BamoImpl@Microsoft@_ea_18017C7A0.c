/*
 * XREFs of ??0?$CalloutWrapper@VBamoDockableDevicePrincipalImpl@BamoImpl@@@BamoImpl@Microsoft@@QEAA@PEAVBaseBamoConnectionImpl@12@PEAVBamoDockableDevicePrincipalImpl@1@W4PrologEpilogConfig@12@@Z @ 0x18017C7A0
 * Callers:
