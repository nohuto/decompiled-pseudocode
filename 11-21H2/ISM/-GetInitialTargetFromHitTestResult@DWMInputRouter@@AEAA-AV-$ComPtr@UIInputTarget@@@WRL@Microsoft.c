/*
 * XREFs of ?GetInitialTargetFromHitTestResult@DWMInputRouter@@AEAA?AV?$ComPtr@UIInputTarget@@@WRL@Microsoft@@W4InputType@@AEBUHitTestResult@@PEAUIInputTarget@@@Z @ 0x18004E484
 * Callers:
        ...
        void (__fastcall ***a5)(_QWORD, GUID *, __int64 *))
{
  ...
  void (__fastcall ***v19)(_QWORD, GUID *, __int64 *); // [rsp+38h] [rbp-28h] BYREF
  ...
  if ( a5 )
  {
    ...
    Microsoft::WRL::ComPtr<IContainerInfoInputObjectProxy>::InternalRelease((__int64 *)&a5);
