/*
 * XREFs of ??0MPCButtonHoldHelper@@QEAA@M@Z @ 0x1800AF774
 * Callers:
 ...
 *     ??$make_shared@VMPCButtonHoldHelper@@AEAM@std@@YA?AV?$shared_ptr@VMPCButtonHoldHelper@@@0@AEAM@Z @ 0x1800AF4BC (--$make_shared@VMPCButtonHoldHelper@@AEAM@std@@YA-AV-$shared_ptr@VMPCButtonHoldHelper@@@0@AEAM@Z.c)
  ...
  *((_QWORD *)this + 4) = 0LL;
  if ( a2 < 0.0 )
    wil::details::in1diag3::_FailFast_Unexpected(
      ...
      a4);
  *((_QWORD *)this + 3) = (unsigned int)(int)((double)(int)qword_180242818 * a2);
  return this;
}
