/*
 * XREFs of ?CreatePenEventsClientProxy@@YAJPEAVBamoPeer@ISMBamos_AutoBamos@@PEAPEAVBamoPenEventsClientProxy@@@Z @ 0x180042C70
 * Callers:
        ...
        struct BamoPenEventsClientProxy **a2)
{
  ...
  {
    tlgWriteTransfer_EventWriteTransfer(v3, (int)&dword_18020629B, 0, 0, 2u, &v6);
  }
