/*
 * XREFs of ?OnConnectedThunk@BamoSystemCursorControllerStubImpl@BamoImpl@@UEAAJXZ @ 0x180010DA0
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall BamoImpl::BamoSystemCursorControllerStubImpl::OnConnectedThunk(
