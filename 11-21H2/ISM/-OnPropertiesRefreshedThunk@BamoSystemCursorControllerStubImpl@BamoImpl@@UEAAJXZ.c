/*
 * XREFs of ?OnPropertiesRefreshedThunk@BamoSystemCursorControllerStubImpl@BamoImpl@@UEAAJXZ @ 0x1800E98E0
 * Callers:
 *     <none>
 * Callees:
...
{
  BamoImpl::BamoSystemCursorControllerStubImpl *v1; // rbx
  __int64 v2; // r8
  __int64 v3; // rdi
  ...
  Microsoft::BamoImpl::CalloutWrapper<BamoImpl::BamoSystemCursorControllerPrincipalImpl>::~CalloutWrapper<BamoImpl::BamoSystemCursorControllerPrincipalImpl>((__int64)v5);
