/*
 * XREFs of ?OnInputDelegationInputObjectChanged@InputSiteElementProxy@@MEAAJXZ @ 0x18001A690
 * Callers:
 *     <none>
 * Callees:
 ...
 *     ??$find_if@V?$_Vector_iterator@V?$_Vector_val@U?$_Simple_types@UAttachedInputObjectEntry@InputSite@@@std@@@std@@@std@@V_lambda_d6de44a36166cac7bfd3df642eeedd3e_@@@std@@YA?AV?$_Vector_iterator@V?$_Vector_val@U?$_Simple_types@UAttachedInputObjectEntry@InputSite@@@std@@@std@@@0@V10@V10@V_lambda_d6de44a36166cac7bfd3df642eeedd3e_@@@Z @ 0x180019C80 (--$find_if@V-$_Vector_iterator@V-$_Vector_val@U-$_Simple_types@UAttachedInputObject_ea_180019C80.c)
        ...
        const char *a4)
{
  ...
  v20 = v22;
  v21 = &v19;
  std::find_if<std::_Vector_iterator<std::_Vector_val<std::_Simple_types<InputSite::AttachedInputObjectEntry>>>,_lambda_d6de44a36166cac7bfd3df642eeedd3e_>(
    &v18,
    *(__int64 **)(v5 + 488),
    *(__int64 **)(v5 + 496),
    &v20);
  ...
  v7 = *((_QWORD *)this + 39);
  v8 = (*(__int64 (__fastcall **)(char *))(*((_QWORD *)this + 1) + 168LL))((char *)this + 8);
  if ( v8 )
  {
    v10 = (__int64 *)(v8 + 8);
    v22[0] = v8 + 8;
