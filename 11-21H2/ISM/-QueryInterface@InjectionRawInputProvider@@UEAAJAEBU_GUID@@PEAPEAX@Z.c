/*
 * XREFs of ?QueryInterface@InjectionRawInputProvider@@UEAAJAEBU_GUID@@PEAPEAX@Z @ 0x1800CF2F0
 * Callers:
 *     ?QueryInterface@InjectionRawInputProvider@@W7EAAJAEBU_GUID@@PEAPEAX@Z @ 0x18004F4E0 (-QueryInterface@InjectionRawInputProvider@@W7EAAJAEBU_GUID@@PEAPEAX@Z.c)
 * Callees:
