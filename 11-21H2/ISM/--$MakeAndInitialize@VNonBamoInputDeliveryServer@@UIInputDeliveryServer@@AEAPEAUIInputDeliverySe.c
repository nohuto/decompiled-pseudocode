/*
 * XREFs of ??$MakeAndInitialize@VNonBamoInputDeliveryServer@@UIInputDeliveryServer@@AEAPEAUIInputDeliveryServerHost@@AEAPEBGAEAW4TestMode@1@@Details@WRL@Microsoft@@YAJPEAPEAUIInputDeliveryServer@@AEAPEAUIInputDeliveryServerHost@@AEAPEBGAEAW4TestMode@NonBamoInputDeliveryServer@@@Z @ 0x18003BE1C
 * Callers:
 ...
 * Callees:
 *     ??0NonBamoInputDeliveryServer@@QEAA@XZ @ 0x18003B4DC (--0NonBamoInputDeliveryServer@@QEAA@XZ.c)
