/*
 * XREFs of _std::vector_wil::com_ptr_t_AsyncHRESULTPrincipal_wil::err_exception_policy__std::allocator_wil::com_ptr_t_AsyncHRESULTPrincipal_wil::err_exception_policy_____::_Emplace_reallocate_AsyncHRESULTPrincipal____::_1_::catch$0 @ 0x18016298B
 * Callers:
 *     <none>
 * Callees:
...
void __fastcall __noreturn std::vector_wil::com_ptr_t_AsyncHRESULTPrincipal_wil::err_exception_policy__std::allocator_wil::com_ptr_t_AsyncHRESULTPrincipal_wil::err_exception_policy_____::_Emplace_reallocate_AsyncHRESULTPrincipal____::_1_::catch_0(
        __int64 a1,
        __int64 a2)
{
