/*
 * XREFs of wistd::__function::__func__lambda_8a62f5b69e88a23bdde8affb13e85828__void___cdecl(enum_wil::RegistryChangeKind)_::_scalar_deleting_destructor_ @ 0x1800B9160
 * Callers:
 *     <none>
 * Callees:
