/*
 * XREFs of ??0PenEventsDispatcherPrincipal@@QEAA@PEAVBamoConnection@ISMBamos_AutoBamos@@@Z @ 0x180031E30
 * Callers:
        ...
        struct ISMBamos_AutoBamos::BamoConnection *a2)
{
  ...
  *((_DWORD *)this + 16) = 1065353216;
  std::_Hash_vec<std::allocator<std::_List_unchecked_iterator<std::_List_val<std::_List_simple_types<std::pair<unsigned long const,std::unordered_map<unsigned long,Win32kInterop::TargetingInfo>>>>>>>::_Assign_grow(
    ...
    16LL,
    *((_QWORD *)this + 9));
  HIDWORD(pvParam[0]) = ((unsigned __int64)this + 128) >> 32;
  LODWORD(pvParam[0]) = 0;
  ...
  if ( IsEdition(0x224AuLL) )
  {
    ...
    if ( v4 < 0 )
      wil::details::in1diag3::FailFast_Hr(
        ...
        v16);
    hstringHeader.Reserved.Reserved1 = off_1801DACE0;
