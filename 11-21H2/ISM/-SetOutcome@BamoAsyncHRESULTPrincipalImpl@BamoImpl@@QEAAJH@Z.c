/*
 * XREFs of ?SetOutcome@BamoAsyncHRESULTPrincipalImpl@BamoImpl@@QEAAJH@Z @ 0x1801700E4
 * Callers:
 *     ?Thunk_SetOutcome_0@?$IAsyncHRESULTPrincipal_Receive@VBamoAsyncHRESULTPrincipalImpl@BamoImpl@@@@SAJPEAXPEAPEAX@Z @ 0x180170200 (-Thunk_SetOutcome_0@-$IAsyncHRESULTPrincipal_Receive@VBamoAsyncHRESULTPrincipalImpl@BamoImpl@@@@.c)
 * Callees:
        ...
        unsigned int a2)
{
  ...
  Microsoft::BamoImpl::CalloutWrapper<Microsoft::BamoImpl::CalloutWrapperObject>::CalloutWrapper<Microsoft::BamoImpl::CalloutWrapperObject>(
    ...
    *(_QWORD *)(*(_QWORD *)(v4[5] + 24LL) + 32LL),
    v7,
    0);
  v8 = (*(__int64 (__fastcall **)(char *, __int64, _QWORD))(*((_QWORD *)this - 2) + 80LL))((char *)this - 16, v6, a2);
  v12 = v8;
