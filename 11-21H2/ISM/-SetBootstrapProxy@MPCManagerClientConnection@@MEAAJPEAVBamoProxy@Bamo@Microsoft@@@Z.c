/*
 * XREFs of ?SetBootstrapProxy@MPCManagerClientConnection@@MEAAJPEAVBamoProxy@Bamo@Microsoft@@@Z @ 0x18016E370
 * Callers:
 *     <none>
 * Callees:
  ...
  *v5 = 0LL;
  ...
  if ( v7 < 0 )
    wil::details::in1diag3::FailFast_Hr(
      ...
      v9);
  MPCManagerClient::OnServerConnectionChanged(*((RTL_SRWLOCK **)this + 30));
  return 0LL;
}
