/*
 * XREFs of ?Set@Edge@@AEAAXPEBGPEAVEdgyControllerClientProxy@@@Z @ 0x1801AC0AC
 * Callers:
 *     ??0Edge@@QEAA@PEBGPEAVEdgyControllerClientProxy@@@Z @ 0x1801AAEC0 (--0Edge@@QEAA@PEBGPEAVEdgyControllerClientProxy@@@Z.c)
