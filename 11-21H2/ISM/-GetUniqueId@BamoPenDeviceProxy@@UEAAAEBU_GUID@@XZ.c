/*
 * XREFs of ?GetUniqueId@BamoPenDeviceProxy@@UEAAAEBU_GUID@@XZ @ 0x18010A810
 * Callers:
 *     <none>
 * Callees:
...
const struct _GUID *__fastcall BamoPenDeviceProxy::GetUniqueId(BamoPenDeviceProxy *this)
{
