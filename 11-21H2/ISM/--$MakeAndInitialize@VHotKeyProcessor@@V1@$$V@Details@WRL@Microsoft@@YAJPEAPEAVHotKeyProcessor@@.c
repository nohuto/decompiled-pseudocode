/*
 * XREFs of ??$MakeAndInitialize@VHotKeyProcessor@@V1@$$V@Details@WRL@Microsoft@@YAJPEAPEAVHotKeyProcessor@@@Z @ 0x1801B205C
 * Callers:
...
__int64 __fastcall Microsoft::WRL::Details::MakeAndInitialize<HotKeyProcessor,HotKeyProcessor,>(HotKeyProcessor **a1)
{
  ...
  int v3; // edi
  HotKeyProcessor *v4; // rsi
  HotKeyProcessor *v6; // [rsp+48h] [rbp+10h] BYREF
  HotKeyProcessor *v7; // [rsp+50h] [rbp+18h]

  *a1 = 0LL;
  v2 = (HotKeyProcessor *)operator new(0x188uLL, (const struct std::nothrow_t *)&std::nothrow);
  v6 = v2;
  if ( v2 )
  {
    v7 = v2;
