/*
 * XREFs of _lambda_41eee22a06de91399d417ae04e8a558f_::operator() @ 0x180087484
 * Callers:
 *     std::_Func_impl_no_alloc__lambda_41eee22a06de91399d417ae04e8a558f__void_Microsoft::WRL::ComPtr_BamoInputSystemInternalProxy__&_::_Do_call @ 0x180088E90 (std--_Func_impl_no_alloc__lambda_41eee22a06de91399d417ae04e8a558f__void_Microsoft--_ea_180088E90.c)
 * Callees:
...
__int64 __fastcall lambda_41eee22a06de91399d417ae04e8a558f_::operator()(_QWORD *a1, __int64 a2)
{
  ...
  if ( v5 < 0 )
    wil::details::in1diag3::FailFast_Hr(
      ...
      v7);
  return wil::com_ptr_t<BamoManualDragAreaClientProxy,wil::err_returncode_policy>::~com_ptr_t<BamoManualDragAreaClientProxy,wil::err_returncode_policy>((__int64 *)&v9);
}
