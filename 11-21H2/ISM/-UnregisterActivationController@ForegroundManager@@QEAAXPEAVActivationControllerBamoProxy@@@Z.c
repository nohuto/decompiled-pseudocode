/*
 * XREFs of ?UnregisterActivationController@ForegroundManager@@QEAAXPEAVActivationControllerBamoProxy@@@Z @ 0x18008C5F8
 * Callers:
 ...
 *     ?GetCookie@ActivationControllerBamoProxy@@QEAA_KXZ @ 0x18008EDF0 (-GetCookie@ActivationControllerBamoProxy@@QEAA_KXZ.c)
 */
