/*
 * XREFs of ?UpdatePrimaryUsageId@BamoDockableDeviceProxyImpl@BamoImpl@@QEAAJ_NG@Z @ 0x18011DB28
 * Callers:
 *     ?Thunk_UpdatePrimaryUsageId_75@?$IDockableDeviceProxy_Receive@VBamoDockableDeviceProxyImpl@BamoImpl@@@@SAJPEAXPEAPEAX@Z @ 0x180118C30 (-Thunk_UpdatePrimaryUsageId_75@-$IDockableDeviceProxy_Receive@VBamoDockableDeviceProxyImpl@BamoI.c)
