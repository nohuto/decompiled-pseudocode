/*
 * XREFs of ?UpdateVertex0@BamoEdgyControllerClientProxyImpl@BamoImpl@@QEAAJ_NPEBUD2D_VECTOR_2F@@@Z @ 0x18014D044
 * Callers:
 *     ?Thunk_UpdateVertex0_181@?$IEdgyControllerClientProxy_Receive@VBamoEdgyControllerClientProxyImpl@BamoImpl@@@@SAJPEAXPEAPEAX@Z @ 0x18014CAB0 (-Thunk_UpdateVertex0_181@-$IEdgyControllerClientProxy_Receive@VBamoEdgyControllerClientProxyImpl.c)
