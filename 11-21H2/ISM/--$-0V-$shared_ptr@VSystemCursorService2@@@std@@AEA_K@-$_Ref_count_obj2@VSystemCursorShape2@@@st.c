/*
 * XREFs of ??$?0V?$shared_ptr@VSystemCursorService2@@@std@@AEA_K@?$_Ref_count_obj2@VSystemCursorShape2@@@std@@QEAA@$$QEAV?$shared_ptr@VSystemCursorService2@@@1@AEA_K@Z @ 0x1800EA7DC
 * Callers:
