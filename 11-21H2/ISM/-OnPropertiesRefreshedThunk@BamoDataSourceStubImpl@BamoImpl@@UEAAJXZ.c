/*
 * XREFs of ?OnPropertiesRefreshedThunk@BamoDataSourceStubImpl@BamoImpl@@UEAAJXZ @ 0x1800F6650
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall BamoImpl::BamoDataSourceStubImpl::OnPropertiesRefreshedThunk(
        BamoImpl::BamoDataSourceStubImpl *this,
        __int64 a2,
        __int64 a3)
{
  BamoImpl::BamoDataSourceStubImpl *v3; // rbx
  __int64 v4; // rdi
  __int64 v5; // rdx
  __int64 v6; // r8
  const char *v7; // r9
