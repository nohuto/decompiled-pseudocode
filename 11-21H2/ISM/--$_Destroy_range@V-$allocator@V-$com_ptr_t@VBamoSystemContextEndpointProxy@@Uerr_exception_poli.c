 ...
 *     _std::vector_wil::com_ptr_t_BamoDeviceDockClientProxy_wil::err_returncode_policy__std::allocator_wil::com_ptr_t_BamoDeviceDockClientProxy_wil::err_returncode_policy_____::_Emplace_reallocate_wil::com_ptr_t_BamoDeviceDockClientProxy_wil::err_returncode_policy____::_1_::catch$3 @ 0x18017C102 (_std--vector_wil--com_ptr_t_BamoDeviceDockClientProxy_wil--err_returncode_policy__std--allocator.c)
 ...
 *     _std::vector_wil::com_ptr_t_PenEventsClientCustomProxy_wil::err_exception_policy__std::allocator_wil::com_ptr_t_PenEventsClientCustomProxy_wil::err_exception_policy_____::_Emplace_reallocate_wil::com_ptr_t_PenEventsClientCustomProxy_wil::err_exception_policy__const_&__::_1_::catch$1 @ 0x18018FAFB (_std--vector_wil--com_ptr_t_PenEventsClientCustomProxy_wil--err_exception_policy__std--allocator.c)
        ...
        __int64 *a2)
{
  ...
  if ( a1 != a2 )
  {
    v3 = a1;
    do
      result = wil::com_ptr_t<BamoManualDragAreaClientProxy,wil::err_returncode_policy>::~com_ptr_t<BamoManualDragAreaClientProxy,wil::err_returncode_policy>(v3++);
    while ( v3 != a2 );
  }
  return result;
}
