/*
 * XREFs of ?UpdateScaleOverrideRemoteCache@BamoSystemCursorControllerPrincipalImpl@BamoImpl@@AEAAXPEAVBamoStubImpl@2Microsoft@@@Z @ 0x1800EA3E8
 * Callers:
 *     ?PushStateToProxyOnOutboundMessagesResumed@BamoSystemCursorControllerPrincipalImpl@BamoImpl@@UEAAXPEAUIMessageCallSendHost@@PEAVBamoStubImpl@2Microsoft@@@Z @ 0x1800E9A90 (-PushStateToProxyOnOutboundMessagesResumed@BamoSystemCursorControllerPrincipalImpl@BamoImpl@@UEA.c)
        ...
        struct Microsoft::BamoImpl::BamoStubImpl *a2)
{
  ...
  if ( *(_QWORD *)(*(_QWORD *)(*((_QWORD *)this + 2) + 32LL) + 64LL) )
  {
    ...
    v4[1] = v7;
    LOWORD(v3) = 0;
    v2 = CoreUICallSend(v8, v4, 2LL, 85LL);
