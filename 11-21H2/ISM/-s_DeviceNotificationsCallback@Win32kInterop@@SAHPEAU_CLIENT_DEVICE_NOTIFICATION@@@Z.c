/*
 * XREFs of ?s_DeviceNotificationsCallback@Win32kInterop@@SAHPEAU_CLIENT_DEVICE_NOTIFICATION@@@Z @ 0x1800E25B0
 * Callers:
 *     <none>
 * Callees:
 ...
 *     ?IsTimestampNewest@CursorNotificationProcessor@@QEAA_N_J@Z @ 0x1800E4E0C (-IsTimestampNewest@CursorNotificationProcessor@@QEAA_N_J@Z.c)
 */
