/*
 * XREFs of ??0RotationWatcher@@AEAA@XZ @ 0x1800FAE88
 * Callers:
 ...
 *     ??$make_wnf_subscription@Uempty_wnf_state@details@wil@@@wil@@YA?AV?$unique_any_t@V?$unique_storage@U?$resource_policy@PEAUwnf_subscription_state_base@details@wil@@P6AXPEAU123@@Z$1?delete_wnf_subscription_state@23@YAX0@ZU?$integral_constant@_K$01@wistd@@PEAU123@PEAU123@$0A@$$T@details@wil@@@details@wil@@@0@AEBU_WNF_STATE_NAME@@$$QEAV?$function@$$A6AXXZ@wistd@@K@Z @ 0x1800FAC80 (--$make_wnf_subscription@Uempty_wnf_state@details@wil@@@wil@@YA-AV-$unique_any_t@V-$unique_stora.c)
 *     ?delete_wnf_subscription_state@details@wil@@YAXPEAUwnf_subscription_state_base@12@@Z @ 0x1800FB4B0 (-delete_wnf_subscription_state@details@wil@@YAXPEAUwnf_subscription_state_base@12@@Z.c)
 */
...
RotationWatcher *__fastcall RotationWatcher::RotationWatcher(RotationWatcher *this)
{
  ...
  v4 = (wil::details **)wil::make_wnf_subscription<wil::details::empty_wnf_state>(&v13, v3, (__int64)v15);
  v6 = v4;
  if ( &qword_180242D68 != v4 )
  {
    v7 = *v4;
    v8 = qword_180242D68;
    if ( qword_180242D68 )
  ...
  return (RotationWatcher *)&qword_180242D68;
}
