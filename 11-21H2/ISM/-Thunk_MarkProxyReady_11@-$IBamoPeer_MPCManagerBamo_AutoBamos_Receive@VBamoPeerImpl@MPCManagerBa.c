/*
 * XREFs of ?Thunk_MarkProxyReady_11@?$IBamoPeer_MPCManagerBamo_AutoBamos_Receive@VBamoPeerImpl@MPCManagerBamo_AutoBamos@BamoImpl@@@@SAJPEAXPEAPEAX@Z @ 0x180047E10
 * Callers:
 *     <none>
 * Callees:
