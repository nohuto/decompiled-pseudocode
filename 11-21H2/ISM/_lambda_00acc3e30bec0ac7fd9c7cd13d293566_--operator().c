/*
 * XREFs of _lambda_00acc3e30bec0ac7fd9c7cd13d293566_::operator() @ 0x1801BDF28
 * Callers:
...
char __fastcall lambda_00acc3e30bec0ac7fd9c7cd13d293566_::operator()(_QWORD *a1, float a2, float a3, const char *a4)
{
  ...
  *((_QWORD *)&v44[0] + 1) = 28LL;
  MPCConstantManager::GetConstant<float>((__int64)MPCConstantManager::s_instance, (v7 + 24) & -(__int64)(v7 != 0), v44);
  ...
  *((_QWORD *)&v44[0] + 1) = 28LL;
  MPCConstantManager::GetConstant<float>((__int64)MPCConstantManager::s_instance, (v9 + 24) & -(__int64)(v9 != 0), v44);
...
LABEL_48:
  ...
  if ( !*(_BYTE *)(v36 + 10801) )
    goto LABEL_60;
  LODWORD(v37) = *(_DWORD *)(v36 + 4356) & _xmm;
  if ( !MPCConstantManager::s_instance )
    wil::details::in1diag3::_FailFast_Unexpected(
      retaddr,
      41LL,
  ...
  *((_QWORD *)&v44[0] + 1) = 29LL;
  ...
  if ( v37 > COERCE_FLOAT(L"HomeMaximumWeightedDistance_X") )
    goto LABEL_59;
  v38 = a1[1];
  LODWORD(v39) = *(_DWORD *)(v38 + 4360) & _xmm;
  if ( !MPCConstantManager::s_instance )
    wil::details::in1diag3::_FailFast_Unexpected(
      retaddr,
      41LL,
  ...
  *(_QWORD *)&v44[0] = L"HomeMaximumWeightedDistance_Y";
  ...
  if ( v39 > COERCE_FLOAT(L"HomeMaximumWeightedDistance_Y") )
    goto LABEL_59;
  v40 = a1[1];
  LODWORD(v41) = *(_DWORD *)(v40 + 4364) & _xmm;
  if ( !MPCConstantManager::s_instance )
    wil::details::in1diag3::_FailFast_Unexpected(
      retaddr,
      41LL,
