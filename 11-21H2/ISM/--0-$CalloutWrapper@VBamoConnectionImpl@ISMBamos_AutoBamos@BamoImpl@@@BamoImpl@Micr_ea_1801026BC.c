/*
 * XREFs of ??0?$CalloutWrapper@VBamoConnectionImpl@ISMBamos_AutoBamos@BamoImpl@@@BamoImpl@Microsoft@@QEAA@PEAVBaseBamoConnectionImpl@12@PEAVBamoConnectionImpl@ISMBamos_AutoBamos@1@W4PrologEpilogConfig@12@@Z @ 0x1801026BC
 * Callers:
        ...
        int a4)
{
  ...
  *(_QWORD *)a1 = 0LL;
  ...
  if ( v7 )
  {
    if ( (*(_BYTE *)(a1 + 16) & 1) != 0 )
    {
      v8 = (*(__int64 (__fastcall **)(_QWORD))(**(_QWORD **)(v7 + 16) + 72LL))(*(_QWORD *)(v7 + 16));
      if ( v8 < 0 )
