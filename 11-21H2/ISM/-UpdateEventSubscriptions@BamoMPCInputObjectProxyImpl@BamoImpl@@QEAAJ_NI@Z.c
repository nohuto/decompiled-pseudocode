/*
 * XREFs of ?UpdateEventSubscriptions@BamoMPCInputObjectProxyImpl@BamoImpl@@QEAAJ_NI@Z @ 0x18011B110
 * Callers:
 *     ?Thunk_UpdateEventSubscriptions_8@?$IMPCInputObjectProxy_Receive@VBamoMPCInputObjectProxyImpl@BamoImpl@@@@SAJPEAXPEAPEAX@Z @ 0x180118890 (-Thunk_UpdateEventSubscriptions_8@-$IMPCInputObjectProxy_Receive@VBamoMPCInputObjectProxyImpl@Ba.c)
