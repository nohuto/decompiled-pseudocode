/*
 * XREFs of ??0RawUsageIndex@details_abi@wil@@QEAA@GGW4CountSize@12@G0@Z @ 0x18007B030
 * Callers:
 ...
 * Callees:
 *     ?GetSize@UsageIndexProperty@details_abi@wil@@QEBA_KXZ @ 0x18007C220 (-GetSize@UsageIndexProperty@details_abi@wil@@QEBA_KXZ.c)
 */
