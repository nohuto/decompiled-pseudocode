/*
 * XREFs of ?OnForegroundTransferFromHost@BamoCUIComponentInputObjectProxyImpl@BamoImpl@@QEAAJAEBUTransferForegroundInfo@@@Z @ 0x180126B3C
 * Callers:
        ...
        const char *a4)
{
  ...
  else
  {
    ...
    if ( v7 >= 0 )
    {
      ...
      v14 = v11;
      v15 = v12;
      return CoreUICallSend(v9, v13, 2LL, 10LL);
    }
    else
    {
      wil::details::in1diag3::Return_Hr(
