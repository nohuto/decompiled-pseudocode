...
__int64 *__fastcall std::vector<wil::com_ptr_t<BamoInputSpacePayloadPrincipal,wil::err_exception_policy>>::_Emplace_reallocate<BamoInputSpacePayloadPrincipal *>(
        __int64 **a1,
        __int64 *a2,
        _QWORD *a3)
{
