/*
 * XREFs of ?GetInputInjectionClient@BamoInputSiteElementProxy@@UEAAPEAVBamoInputInjectionClientProxy@@XZ @ 0x18000DD90
 * Callers:
 *     <none>
 * Callees:
        ...
        BamoInputSiteElementProxy *this)
{
  ...
  return (struct BamoInputInjectionClientProxy *)*((_QWORD *)this + 26);
}
