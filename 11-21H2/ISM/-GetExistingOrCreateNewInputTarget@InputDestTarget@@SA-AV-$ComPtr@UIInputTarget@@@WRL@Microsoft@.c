/*
 * XREFs of ?GetExistingOrCreateNewInputTarget@InputDestTarget@@SA?AV?$ComPtr@UIInputTarget@@@WRL@Microsoft@@AEBUtagINPUTDEST@@PEAUIInputTarget@@@Z @ 0x18004D778
 * Callers:
        ...
        int (__fastcall ***a3)(_QWORD, GUID *, InputDestTarget **))
{
  ...
  InputDestTarget *v10; // [rsp+40h] [rbp+18h] BYREF
