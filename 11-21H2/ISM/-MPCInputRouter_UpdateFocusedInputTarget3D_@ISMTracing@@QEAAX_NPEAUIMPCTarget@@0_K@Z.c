/*
 * XREFs of ?MPCInputRouter_UpdateFocusedInputTarget3D_@ISMTracing@@QEAAX_NPEAUIMPCTarget@@0_K@Z @ 0x1800F1530
 * Callers:
        ...
        unsigned __int64 a5)
{
  ...
  if ( ISMTracing::IsEnabled((__int64)this) )
  {
    ...
    if ( *(_DWORD *)v9 > 4u && (*(_BYTE *)(v9 + 16) & 1) != 0 && (*(_QWORD *)(v9 + 24) & 1LL) == *(_QWORD *)(v9 + 24) )
    {
      ...
      v23 = 1;
      v17 = 1;
      tlgWriteTransfer_EventWriteTransfer(v9, (unsigned __int8 *)dword_180203B49, 0LL, 0LL, 7u, &v15);
    }
  }
}
