/*
 * XREFs of ?OnConnectedThunk@BamoActivatableEntityStubImpl@BamoImpl@@UEAAJXZ @ 0x18000A660
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall BamoImpl::BamoActivatableEntityStubImpl::OnConnectedThunk(
