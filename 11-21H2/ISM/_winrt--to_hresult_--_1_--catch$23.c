/*
 * XREFs of _winrt::to_hresult_::_1_::catch$23 @ 0x180083BD1
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall winrt::to_hresult_::_1_::catch_23(__int64 a1, __int64 a2)
{
  ...
  *(_QWORD *)(a2 + 88) = *winrt::to_hstring<char const *,0>(
                            ...
                            (const CHAR **)(a2 + 152));
  v3 = winrt::hresult_error::hresult_error(a2 + 64, 2147500037LL, (_QWORD *)(a2 + 88));
  ...
  winrt::handle_type<winrt::impl::hstring_traits>::close((volatile signed __int32 **)(a2 + 160), v4, v5, v6);
  return 0LL;
}
