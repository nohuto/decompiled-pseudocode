/*
 * XREFs of ?Thunk_GetConstant_16@?$IMPCConstantManagerClientPrincipal_Receive@VBamoMPCConstantManagerClientPrincipalImpl@BamoImpl@@@@SAJPEAXPEAPEAX@Z @ 0x180096A70
 * Callers:
 *     <none>
 * Callees:
 *     <none>
