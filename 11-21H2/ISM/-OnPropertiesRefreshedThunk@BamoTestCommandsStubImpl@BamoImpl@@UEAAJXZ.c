/*
 * XREFs of ?OnPropertiesRefreshedThunk@BamoTestCommandsStubImpl@BamoImpl@@UEAAJXZ @ 0x18019F510
 * Callers:
 *     <none>
 * Callees:
...
{
  BamoImpl::BamoTestCommandsStubImpl *v1; // rbx
  __int64 v2; // r8
  __int64 v3; // rdi
  ...
  Microsoft::BamoImpl::CalloutWrapper<BamoImpl::BamoTestCommandsPrincipalImpl>::~CalloutWrapper<BamoImpl::BamoTestCommandsPrincipalImpl>((__int64)v5);
