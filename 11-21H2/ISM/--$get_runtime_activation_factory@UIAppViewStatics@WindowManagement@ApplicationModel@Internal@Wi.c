/*
 * XREFs of ??$get_runtime_activation_factory@UIAppViewStatics@WindowManagement@ApplicationModel@Internal@Windows@winrt@@@impl@winrt@@YA?AUhresult@1@AEBUhstring@param@1@PEAPEAX@Z @ 0x18003F638
 * Callers:
...
_DWORD *__fastcall winrt::impl::get_runtime_activation_factory<winrt::Windows::Internal::ApplicationModel::WindowManagement::IAppViewStatics>(
        _DWORD *a1,
        _QWORD *a2,
        __int64 a3)
{
  ...
  ProcAddress = (FARPROC)`winrt::impl::get_runtime_activation_factory<winrt::Windows::Internal::ApplicationModel::WindowManagement::IAppViewStatics>'::`2'::handler;
  if ( !`winrt::impl::get_runtime_activation_factory<winrt::Windows::Internal::ApplicationModel::WindowManagement::IAppViewStatics>'::`2'::handler )
  {
    ...
    `winrt::impl::get_runtime_activation_factory<winrt::Windows::Internal::ApplicationModel::WindowManagement::IAppViewStatics>'::`2'::handler = (__int64)ProcAddress;
  }
  ...
  if ( v8 == -2147221008 )
  {
    ...
    v8 = ((__int64 (__fastcall *)(_QWORD, void *, __int64))`winrt::impl::get_runtime_activation_factory<winrt::Windows::Internal::ApplicationModel::WindowManagement::IAppViewStatics>'::`2'::handler)(
           *a2,
           &winrt::impl::guid_v<winrt::Windows::Internal::ApplicationModel::WindowManagement::IAppViewStatics>,
           a3);
  }
