/*
 * XREFs of ??$_Emplace_reallocate@AEAI@?$vector@IV?$allocator@I@std@@@std@@QEAAPEAIQEAIAEAI@Z @ 0x1800E2BF8
 * Callers:
 ...
 *     ?_Change_array@?$vector@IV?$allocator@I@std@@@std@@AEAAXQEAI_K1@Z @ 0x180088CFC (-_Change_array@-$vector@IV-$allocator@I@std@@@std@@AEAAXQEAI_K1@Z.c)
 */
