/*
 * XREFs of ?ProcessResult@DragNDropProcessor@@QEAAJKAEBUDragOperationResult@Input@Internal@UI@Windows@@PEAVBamoDragManagerClientProxy@@@Z @ 0x180140E44
 * Callers:
 *     ?ProcessResult@DragManagerHost@@MEAAJPEAVBamoDragProcessorManagerStub@@IAEBUDragOperationResult@Input@Internal@UI@Windows@@PEAVBamoDragManagerClientProxy@@@Z @ 0x18013AA60 (-ProcessResult@DragManagerHost@@MEAAJPEAVBamoDragProcessorManagerStub@@IAEBUDragOperationResult@.c)
 * Callees:
