/*
 * XREFs of ?RuntimeClassInitialize@MPCGamepadProcessor@@QEAAJPEBUInputProcessorCreateParams@@@Z @ 0x1801C67F0
 * Callers:
        ...
        const struct InputProcessorCreateParams *a2)
{
  ...
  v10 = CreateChildInputProcessor(64, &v20, (__int64)this + 3672);
  if ( v10 < 0 )
    wil::details::in1diag3::FailFast_Hr(
      retaddr,
      (void *)0x28,
