/*
 * XREFs of ?Create@PenDeviceCollection@@SAJPEAUIRawInputClient@@PEAUIRawInputProvider@@PEAPEAXPEAPEAV1@@Z @ 0x18002AEA0
 * Callers:
        ...
        struct PenDeviceCollection **a4)
{
  _DWORD *v8; // rbx
  _DWORD *v9; // rax
  struct PenDeviceCollection *v10; // rbp
  ...
  if ( a1 && a3 && a4 )
  {
    ...
    if ( v9 )
    {
      ...
      *((_QWORD *)v8 + 343) = 0LL;
      v8[688] = 0;
      *(_QWORD *)v8 = &PenDeviceCollection::`vftable';
      *((_QWORD *)v8 + 3) = a2;
      v10 = (struct PenDeviceCollection *)v8;
      v21 = 852000;
...
LABEL_7:
  if ( v8 )
    std::default_delete<PenDeviceCollection>::operator()(v14, v8);
  return v15;
}
