/*
 * XREFs of ?Connected@InputProcessProxy@InputTraceLogging@@SAXXZ @ 0x180195358
 * Callers:
...
void __fastcall InputTraceLogging::InputProcessProxy::Connected(__int64 a1)
{
  __int64 v1; // rcx
  ...
  {
    tlgWriteTransfer_EventWriteTransfer(v1, (unsigned __int8 *)dword_180206334, 0LL, 0LL, 2u, &v2);
  }
}
