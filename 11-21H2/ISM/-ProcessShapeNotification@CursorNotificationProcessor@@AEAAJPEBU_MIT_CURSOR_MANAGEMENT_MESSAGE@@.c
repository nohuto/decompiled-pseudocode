/*
 * XREFs of ?ProcessShapeNotification@CursorNotificationProcessor@@AEAAJPEBU_MIT_CURSOR_MANAGEMENT_MESSAGE@@I@Z @ 0x1800E502C
 * Callers:
        ...
        unsigned int a3)
{
  ...
  v6 = (*(__int64 (__fastcall **)(__int64))(*(_QWORD *)(*((_QWORD *)BamoServerConnection + 29) + 8LL) + 216LL))(*((_QWORD *)BamoServerConnection + 29) + 8LL);
