/*
 * XREFs of ?AllocatePeerThunk@BamoConnectionImpl@ISMBamos_AutoBamos@BamoImpl@@MEAAJPEAPEAVBaseBamoPeer@Bamo@Microsoft@@@Z @ 0x18000A450
 * Callers:
 *     <none>
 * Callees:
        ...
        struct Microsoft::Bamo::BaseBamoPeer **a2)
{
  ...
  v8 = (*(__int64 (__fastcall **)(_QWORD))(**((_QWORD **)this + 2) + 72LL))(*((_QWORD *)this + 2));
  if ( v8 < 0 )
    wil::details::in1diag3::FailFast_Hr(
      ...
      v12);
  v9 = (*(__int64 (__fastcall **)(__int64, struct Microsoft::Bamo::BaseBamoPeer **))(*(_QWORD *)v4 + 88LL))(v4, &v14);
  *a2 = v14;
  v10 = (*(__int64 (__fastcall **)(_QWORD))(**((_QWORD **)this + 2) + 80LL))(*((_QWORD *)this + 2));
  if ( v10 < 0 )
    wil::details::in1diag3::FailFast_Hr(
      retaddr,
      (void *)0x87,
