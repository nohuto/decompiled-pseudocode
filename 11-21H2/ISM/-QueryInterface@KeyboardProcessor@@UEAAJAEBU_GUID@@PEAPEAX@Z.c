/*
 * XREFs of ?QueryInterface@KeyboardProcessor@@UEAAJAEBU_GUID@@PEAPEAX@Z @ 0x180019AA0
 * Callers:
 *     ?QueryInterface@KeyboardProcessor@@W7EAAJAEBU_GUID@@PEAPEAX@Z @ 0x180052C40 (-QueryInterface@KeyboardProcessor@@W7EAAJAEBU_GUID@@PEAPEAX@Z.c)
 * Callees:
