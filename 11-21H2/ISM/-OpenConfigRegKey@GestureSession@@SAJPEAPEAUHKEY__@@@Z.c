/*
 * XREFs of ?OpenConfigRegKey@GestureSession@@SAJPEAPEAUHKEY__@@@Z @ 0x1801B540C
 * Callers:
 *     ?StaticInitConfig@GestureRecognizer@@KAXXZ @ 0x1801B8018 (-StaticInitConfig@GestureRecognizer@@KAXXZ.c)
 * Callees:
 *     memset_0 @ 0x18004A918 (memset_0.c)
 *     __security_check_cookie @ 0x18004A930 (__security_check_cookie.c)
 *     ?RefreshScreenSize@GestureSession@@SAJXZ @ 0x1801B5830 (-RefreshScreenSize@GestureSession@@SAJXZ.c)
 */
