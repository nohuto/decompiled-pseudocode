/*
 * XREFs of ?RecognizeTwoFingerTap@Magnifier@InputTraceLogging@@SAXXZ @ 0x1801B0008
 * Callers:
...
void __fastcall InputTraceLogging::Magnifier::RecognizeTwoFingerTap(__int64 a1)
{
  ...
  {
    tlgWriteTransfer_EventWriteTransfer(v1, (unsigned __int8 *)dword_1802068F3, 0LL, 0LL, 2u, &v2);
  }
}
