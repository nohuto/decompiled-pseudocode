/*
 * XREFs of ?OnConnectedThunk@BamoDragProcessorManagerStubImpl@BamoImpl@@UEAAJXZ @ 0x180010920
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall BamoImpl::BamoDragProcessorManagerStubImpl::OnConnectedThunk(
