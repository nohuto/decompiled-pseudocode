/*
 * XREFs of ?ServerCreated@VirtualTouchpad@InputTraceLogging@@SAXPEBX@Z @ 0x18012B0E4
 * Callers:
...
void __fastcall InputTraceLogging::VirtualTouchpad::ServerCreated(__int64 a1)
{
    ...
    && (*(_QWORD *)(v2 + 24) & 0x200LL) == *(_QWORD *)(v2 + 24) )
  {
    ...
    v3 = a1;
    v6 = 8;
    tlgWriteTransfer_EventWriteTransfer(v2, (unsigned __int8 *)dword_18020403A, 0LL, 0LL, 3u, &v4);
  }
}
