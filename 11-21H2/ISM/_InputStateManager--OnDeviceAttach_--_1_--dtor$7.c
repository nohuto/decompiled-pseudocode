/*
 * XREFs of _InputStateManager::OnDeviceAttach_::_1_::dtor$7 @ 0x180054AD0
 * Callers:
 *     <none>
 * Callees:
 *     <none>
...
__int64 __fastcall InputStateManager::OnDeviceAttach_::_1_::dtor_7(__int64 a1, __int64 a2)
{
