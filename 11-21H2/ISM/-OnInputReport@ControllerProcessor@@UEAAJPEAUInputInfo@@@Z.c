/*
 * XREFs of ?OnInputReport@ControllerProcessor@@UEAAJPEAUInputInfo@@@Z @ 0x180177AE0
 * Callers:
 *     <none>
 * Callees:
 ...
 *     ?UpdatePointerTimer@ControllerProcessor@@AEAAJXZ @ 0x18017A37C (-UpdatePointerTimer@ControllerProcessor@@AEAAJXZ.c)
