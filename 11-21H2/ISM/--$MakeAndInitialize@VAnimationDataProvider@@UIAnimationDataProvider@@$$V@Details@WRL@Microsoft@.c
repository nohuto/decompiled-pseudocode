/*
 * XREFs of ??$MakeAndInitialize@VAnimationDataProvider@@UIAnimationDataProvider@@$$V@Details@WRL@Microsoft@@YAJPEAPEAUIAnimationDataProvider@@@Z @ 0x180035140
 * Callers:
 ...
 * Callees:
 *     ??0AnimationDataProvider@@QEAA@XZ @ 0x180037C3C (--0AnimationDataProvider@@QEAA@XZ.c)
