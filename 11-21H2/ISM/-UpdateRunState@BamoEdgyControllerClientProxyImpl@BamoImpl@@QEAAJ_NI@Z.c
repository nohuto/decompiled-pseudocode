/*
 * XREFs of ?UpdateRunState@BamoEdgyControllerClientProxyImpl@BamoImpl@@QEAAJ_NI@Z @ 0x18014CE8C
 * Callers:
 *     ?Thunk_UpdateRunState_8@?$IEdgyControllerClientProxy_Receive@VBamoEdgyControllerClientProxyImpl@BamoImpl@@@@SAJPEAXPEAPEAX@Z @ 0x18014CA90 (-Thunk_UpdateRunState_8@-$IEdgyControllerClientProxy_Receive@VBamoEdgyControllerClientProxyImpl@.c)
