/*
 * XREFs of ??$MakeAndInitialize@VHotkeyContextualProcessor@@V1@$$V@Details@WRL@Microsoft@@YAJPEAPEAVHotkeyContextualProcessor@@@Z @ 0x180199410
 * Callers:
 ...
 *     ??0HotkeyContextualProcessor@@QEAA@XZ @ 0x180199BD4 (--0HotkeyContextualProcessor@@QEAA@XZ.c)
        ...
        HotkeyContextualProcessor **a1)
{
  ...
  int v3; // ebx
  HotkeyContextualProcessor *v4; // rdi
  HotkeyContextualProcessor *v6; // [rsp+40h] [rbp+8h] BYREF
