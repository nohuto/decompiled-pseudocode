/*
 * XREFs of ?OnConnectedCallout@BamoActivationControllerProxy@@EEAAJXZ @ 0x18000B830
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall BamoActivationControllerProxy::OnConnectedCallout(BamoActivationControllerProxy *this)
{
  ...
  v8 = (*(__int64 (__fastcall **)(BamoActivationControllerProxy *))(*(_QWORD *)this + 32LL))(this);
  if ( v3 )
  {
    if ( (v4 & 2) != 0 )
    {
