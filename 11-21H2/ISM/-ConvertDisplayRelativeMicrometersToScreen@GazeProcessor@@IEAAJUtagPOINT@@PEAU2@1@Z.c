/*
 * XREFs of ?ConvertDisplayRelativeMicrometersToScreen@GazeProcessor@@IEAAJUtagPOINT@@PEAU2@1@Z @ 0x1801BAEB8
 * Callers:
 *     ?OnInputReport@GazeProcessor@@UEAAJPEAUInputInfo@@@Z @ 0x1801BB420 (-OnInputReport@GazeProcessor@@UEAAJPEAUInputInfo@@@Z.c)
 * Callees:
 *     ?GetClippedPointInRect@@YA?AUtagPOINT@@AEBU1@AEBUtagRECT@@PEA_N@Z @ 0x1801BB000 (-GetClippedPointInRect@@YA-AUtagPOINT@@AEBU1@AEBUtagRECT@@PEA_N@Z.c)
 */
