/*
 * XREFs of ?ProcessInputMessage@Win32kInterop@@AEAAXAEBUInputMessageContext@1@AEBU_InputMessageNotification@@_N@Z @ 0x1800E090C
 * Callers:
 ...
 *     ?IsIdentityTransform@CInputTransform@@SA_NAEBUtagINPUT_TRANSFORM@@@Z @ 0x1800E0350 (-IsIdentityTransform@CInputTransform@@SA_NAEBUtagINPUT_TRANSFORM@@@Z.c)
        ...
        char a4)
{
  ...
  KeyboardModifierState *v31; // [rsp+40h] [rbp-C0h] BYREF
  ...
  __int64 (__fastcall **v37)(); // [rsp+88h] [rbp-78h] BYREF
  __int128 v38; // [rsp+90h] [rbp-70h]
  __int64 *v39; // [rsp+A0h] [rbp-60h]
  __int64 (__fastcall ***v40)(); // [rsp+C0h] [rbp-40h]
  __int64 (__fastcall **v41)(); // [rsp+C8h] [rbp-38h] BYREF
  __int128 v42; // [rsp+D0h] [rbp-30h]
  __int64 (__fastcall ***v43)(); // [rsp+100h] [rbp+0h]
  ...
  if ( v8 != -1 && !Win32kInterop::IsDeviceAttached(this, v8, 1) )
  {
    ...
    v30[0] = 1;
    v30[1] = 0;
    NtMITPostMouseInputMessage(&v35, 1LL, 0LL, v30);
    return;
  }
  ...
  *((_DWORD *)v29 + 18) = *((_DWORD *)a3 + 4) & 1;
  ...
  if ( v14 < 0 )
    wil::details::in1diag3::FailFast_Hr(
      ...
      v28);
  v31 = 0LL;
  Microsoft::WRL::ComPtr<IContainerInfoInputObjectProxy>::InternalRelease((__int64 *)&v31);
  ...
  if ( v15 < 0 )
    wil::details::in1diag3::FailFast_Hr(
      ...
      v28);
  KeyboardModifierState::GetCurrentKeyboardModifierState(v31, (unsigned int *)v29 + 58);
  v12[81] = 1;
  v12[83] = 2;
  v16 = *((__int16 *)a3 + 64);
  v12[92] = v16;
...
LABEL_32:
  ...
  *((_QWORD *)&v33 + 1) = a3;
  ...
  v42 = v33;
  v43 = &v41;
  Win32kInterop::DeliverToContextualProcessing(this, (__int64)v29, *((_DWORD *)a3 + 59), (__int64)&v41, (__int64)&v37);
  Microsoft::WRL::ComPtr<HotkeyRegistrationForwarder>::InternalRelease(&v32);
  Microsoft::WRL::ComPtr<IContainerInfoInputObjectProxy>::InternalRelease((__int64 *)&v31);
  if ( v36 )
    operator delete[](v36);
}
