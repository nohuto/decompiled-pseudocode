/*
 * XREFs of ?OnPropertiesRefreshedCallout@BamoActivationControllerProxy@@EEAAJXZ @ 0x18008EEF0
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall BamoActivationControllerProxy::OnPropertiesRefreshedCallout(BamoActivationControllerProxy *this)
{
  ...
  Microsoft::BamoImpl::CalloutWrapper<BamoImpl::BamoActivationControllerProxyImpl>::CalloutWrapper<BamoImpl::BamoActivationControllerProxyImpl>(
    ...
    *(_QWORD *)(*(_QWORD *)(*((_QWORD *)this + 4) + 24LL) + 32LL),
    (__int64)this + 16);
  LODWORD(v1) = (*(__int64 (__fastcall **)(BamoActivationControllerProxy *))(*(_QWORD *)v1 + 48LL))(v1);
  Microsoft::BamoImpl::CalloutWrapper<BamoImpl::BamoActivationControllerProxyImpl>::~CalloutWrapper<BamoImpl::BamoActivationControllerProxyImpl>((__int64)v3);
