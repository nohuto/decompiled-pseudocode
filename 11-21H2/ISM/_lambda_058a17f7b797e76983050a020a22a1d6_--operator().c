/*
 * XREFs of _lambda_058a17f7b797e76983050a020a22a1d6_::operator() @ 0x1800D4D98
 * Callers:
...
__int64 lambda_058a17f7b797e76983050a020a22a1d6_::operator()()
{
  ...
  if ( v0 )
  {
    ...
    *v0 = &LampArrayTelemetry::`vftable';
    qword_180242D40 = (RefCountedObject *)v0;
    return 0LL;
  }
  else
  {
    wil::details::in1diag3::Return_Hr(
      retaddr,
      (void *)0x19,
      (int)"onecoreuap\\windows\\moderncore\\inputv2\\rawinputproviders\\lamparray\\lib\\lamparraytelemetry.cpp",
