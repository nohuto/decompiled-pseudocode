/*
 * XREFs of ?MPCManager_SendHomeGestureReadyChanged_@ISMTracing@@QEAAX_NKK_KII@Z @ 0x1800990FC
 * Callers:
        ...
        unsigned int a7)
{
  ...
  unsigned int v14; // [rsp+64h] [rbp-1Ch] BYREF
  ...
  ISMTracing *v19; // [rsp+90h] [rbp+10h] BYREF
