/*
 * XREFs of ?RegisterSystemContextEndpoint@BamoSystemContextManagerProxyImpl@BamoImpl@@QEAAJPEAVBamoSystemContextEndpointPrincipal@@@Z @ 0x1801160EC
 * Callers:
        ...
        const char *a4)
{
  ...
  else
  {
    ...
    if ( v7 >= 0 )
    {
      ...
      *(_QWORD *)&v17 = v20;
      *((_QWORD *)&v17 + 1) = v21;
      return CoreUICallSend(v10, &v17, 2LL, 83LL);
    }
    else
    {
      wil::details::in1diag3::Return_Hr(
