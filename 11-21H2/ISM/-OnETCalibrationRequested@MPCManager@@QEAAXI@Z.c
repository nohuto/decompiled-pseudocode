/*
 * XREFs of ?OnETCalibrationRequested@MPCManager@@QEAAXI@Z @ 0x180099D88
 * Callers:
 *     ?OnDeviceUpdate@MPCEyeGazeProcessor@@UEAAJPEAUDeviceInfo@@@Z @ 0x1801CA5E0 (-OnDeviceUpdate@MPCEyeGazeProcessor@@UEAAJPEAUDeviceInfo@@@Z.c)
 * Callees:
...
void __fastcall MPCManager::OnETCalibrationRequested(MPCManager *this, unsigned int a2)
{
  ...
  while ( !*(_BYTE *)(v3 + 25) )
  {
    v4 = (*(__int64 (__fastcall **)(_QWORD, _QWORD))(**(_QWORD **)(v3 + 40) + 88LL))(*(_QWORD *)(v3 + 40), a2);
    if ( v4 < 0 )
