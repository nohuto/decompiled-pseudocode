/*
 * XREFs of ??1CustomCursorApplication2@@QEAA@XZ @ 0x1800E8264
 * Callers:
 *     ?_Destroy@?$_Ref_count_obj2@VCustomCursorApplication2@@@std@@EEAAXXZ @ 0x1800EA4E0 (-_Destroy@-$_Ref_count_obj2@VCustomCursorApplication2@@@std@@EEAAXXZ.c)
 * Callees:
