/*
 * XREFs of ??$GetAllAttachedObjectsByType@UIActivationListenerInputObjectProxy@@@InputSite@@QEAA?AV?$vector@V?$ComPtr@UIActivationListenerInputObjectProxy@@@WRL@Microsoft@@V?$allocator@V?$ComPtr@UIActivationListenerInputObjectProxy@@@WRL@Microsoft@@@std@@@std@@XZ @ 0x18001A0E0
 * Callers:
...
_QWORD *__fastcall InputSite::GetAllAttachedObjectsByType<IActivationListenerInputObjectProxy>(__int64 a1, _QWORD *a2)
{
  ...
  int (__fastcall *v7)(_QWORD, GUID *, __int64 *); // rbp
  _QWORD *v9; // rdx
