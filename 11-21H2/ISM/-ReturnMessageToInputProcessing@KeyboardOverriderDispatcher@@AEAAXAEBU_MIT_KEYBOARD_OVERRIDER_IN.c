/*
 * XREFs of ?ReturnMessageToInputProcessing@KeyboardOverriderDispatcher@@AEAAXAEBU_MIT_KEYBOARD_OVERRIDER_INPUT_MESSAGE@@@Z @ 0x1800E5E68
 * Callers:
        ...
        const struct _MIT_KEYBOARD_OVERRIDER_INPUT_MESSAGE *a2)
{
  ...
  v10 = *(_QWORD *)a2;
  v11 = v2;
  NtMITSynthesizeKeyboardInput(4LL, &v5, (char *)this + 448);
}
