/*
 * XREFs of ?SetButtonRoutingPolicy@BamoPenEventsDispatcherProxyImpl@BamoImpl@@QEAAJW4RoutingPolicy@Input@Devices@Internal@Windows@@@Z @ 0x1801171BC
 * Callers:
        ...
        const char *a4)
{
  ...
  else
  {
    ...
    if ( v7 >= 0 )
    {
      ...
      v10[0] = v12;
      v10[1] = v13;
      return CoreUICallSend(v9, v10, 2LL, 72LL);
    }
    else
    {
      wil::details::in1diag3::Return_Hr(
