/*
 * XREFs of ?QueryInterface@BamoCUIHostInputObjectProxy@@UEAAJAEBU_GUID@@PEAPEAX@Z @ 0x180127DB0
 * Callers:
 *     ?QueryInterface@BamoCUIHostInputObjectProxy@@W7EAAJAEBU_GUID@@PEAPEAX@Z @ 0x1800509E0 (-QueryInterface@BamoCUIHostInputObjectProxy@@W7EAAJAEBU_GUID@@PEAPEAX@Z.c)
 * Callees:
