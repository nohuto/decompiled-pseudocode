/*
 * XREFs of ?UpdateActivationWatcher@BamoInputSystemProxyImpl@BamoImpl@@QEAAJ_NI@Z @ 0x1801195B4
 * Callers:
 *     ?Thunk_UpdateActivationWatcher_8@?$IInputSystemProxy_Receive@VBamoInputSystemProxyImpl@BamoImpl@@@@SAJPEAXPEAPEAX@Z @ 0x180118630 (-Thunk_UpdateActivationWatcher_8@-$IInputSystemProxy_Receive@VBamoInputSystemProxyImpl@BamoImpl@.c)
