/*
 * XREFs of ?OnDisconnectedThunk@BamoSystemContextEndpointStubImpl@BamoImpl@@UEAAJXZ @ 0x180087E30
 * Callers:
 *     <none>
 * Callees:
...
{
  BamoImpl::BamoSystemContextEndpointStubImpl *v1; // rbx
  __int64 v2; // r8
  __int64 v3; // rdi
  ...
  Microsoft::BamoImpl::CalloutWrapper<BamoImpl::BamoSystemContextEndpointPrincipalImpl>::CalloutWrapper<BamoImpl::BamoSystemContextEndpointPrincipalImpl>(
    ...
    *(_QWORD *)(*(_QWORD *)(*((_QWORD *)this + 5) + 24LL) + 32LL),
    v2);
  LODWORD(v1) = (*(__int64 (__fastcall **)(__int64, __int64))(*(_QWORD *)v3 + 112LL))(v3, (__int64)v1 - 16);
  Microsoft::BamoImpl::CalloutWrapper<BamoImpl::BamoSystemContextEndpointPrincipalImpl>::~CalloutWrapper<BamoImpl::BamoSystemContextEndpointPrincipalImpl>((__int64)v5);
