/*
 * XREFs of ?UpdateResumePosition@BamoControllerNavigationOverrideProxyImpl@BamoImpl@@QEAAJ_NPEBUtagPOINT@@@Z @ 0x180174DDC
 * Callers:
 *     ?Thunk_UpdateResumePosition_23@?$IControllerNavigationOverrideProxy_Receive@VBamoControllerNavigationOverrideProxyImpl@BamoImpl@@@@SAJPEAXPEAPEAX@Z @ 0x180174620 (-Thunk_UpdateResumePosition_23@-$IControllerNavigationOverrideProxy_Receive@VBamoControllerNavig.c)
