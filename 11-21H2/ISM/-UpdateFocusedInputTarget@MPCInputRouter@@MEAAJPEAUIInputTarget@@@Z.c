/*
 * XREFs of ?UpdateFocusedInputTarget@MPCInputRouter@@MEAAJPEAUIInputTarget@@@Z @ 0x180014600
 * Callers:
 *     <none>
 * Callees:
      ...
      if ( *v9 )
      {
          ...
          && (*(_QWORD *)(v10 + 24) & 1LL) == *(_QWORD *)(v10 + 24) )
        {
          ...
          if ( a2 )
          {
            ...
            v16 = 0LL;
            Context = a2;
            Microsoft::WRL::ComPtr<Windows::Foundation::IAsyncActionCompletedHandler>::InternalAddRef(&Context);
            v20 = 0LL;
