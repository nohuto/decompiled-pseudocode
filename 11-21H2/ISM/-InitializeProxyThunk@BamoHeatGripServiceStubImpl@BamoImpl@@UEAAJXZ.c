/*
 * XREFs of ?InitializeProxyThunk@BamoHeatGripServiceStubImpl@BamoImpl@@UEAAJXZ @ 0x1800102F0
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall BamoImpl::BamoHeatGripServiceStubImpl::InitializeProxyThunk(
