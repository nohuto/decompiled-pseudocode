/*
 * XREFs of ?QueryInterface@ResizeProcessor@@UEAAJAEBU_GUID@@PEAPEAX@Z @ 0x180146500
 * Callers:
 *     ?QueryInterface@ResizeProcessor@@W7EAAJAEBU_GUID@@PEAPEAX@Z @ 0x180050F20 (-QueryInterface@ResizeProcessor@@W7EAAJAEBU_GUID@@PEAPEAX@Z.c)
 * Callees:
