/*
 * XREFs of ?AttachApplication2@SystemCursorController2@@MEAAJPEAVBamoSystemCursorControllerStub@@PEAVBamoCustomCursorControllerClient2Proxy@@@Z @ 0x1800E8630
 * Callers:
 *     <none>
 * Callees:
...
{
  __int64 v4; // rcx
  volatile signed __int32 *v5; // kr00_8
  ...
  char v21[24]; // [rsp+50h] [rbp-18h] BYREF
  ...
  try
  {
    if ( this[10] )
    {
      ...
      v7 = (float *)(*(__int64 (__fastcall **)(volatile signed __int32 *))(*(_QWORD *)this[10] + 80LL))(this[10]);
