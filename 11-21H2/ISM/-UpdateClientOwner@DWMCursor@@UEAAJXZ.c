/*
 * XREFs of ?UpdateClientOwner@DWMCursor@@UEAAJXZ @ 0x1801CFE20
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall DWMCursor::UpdateClientOwner(DWMCursor *this)
{
  ...
  v2 = dword_1802437A4 + 1;
  if ( dword_1802437A4 == -1 )
    v2 = 1;
  *((_DWORD *)this + 11) = v2;
  dword_1802437A4 = v2;
  v3 = *(_QWORD *)(*((_QWORD *)this + 20) + 232LL) + 8LL;
  v4 = (*(__int64 (__fastcall **)(__int64))(*(_QWORD *)v3 + 216LL))(v3);
  if ( v4 )
  {
