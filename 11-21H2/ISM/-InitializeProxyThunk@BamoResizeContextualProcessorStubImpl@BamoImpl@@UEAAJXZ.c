/*
 * XREFs of ?InitializeProxyThunk@BamoResizeContextualProcessorStubImpl@BamoImpl@@UEAAJXZ @ 0x180010890
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall BamoImpl::BamoResizeContextualProcessorStubImpl::InitializeProxyThunk(
