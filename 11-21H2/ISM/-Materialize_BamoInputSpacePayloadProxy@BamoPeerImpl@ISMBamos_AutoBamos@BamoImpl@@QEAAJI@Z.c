/*
 * XREFs of ?Materialize_BamoInputSpacePayloadProxy@BamoPeerImpl@ISMBamos_AutoBamos@BamoImpl@@QEAAJI@Z @ 0x18010CA2C
 * Callers:
 *     ?Thunk_Materialize_BamoInputSpacePayloadProxy_5@?$IBamoPeer_ISMBamos_AutoBamos_Receive@VBamoPeerImpl@ISMBamos_AutoBamos@BamoImpl@@@@SAJPEAXPEAPEAX@Z @ 0x180118130 (-Thunk_Materialize_BamoInputSpacePayloadProxy_5@-$IBamoPeer_ISMBamos_AutoBamos_Receive@VBamoPeer.c)
 * Callees:
