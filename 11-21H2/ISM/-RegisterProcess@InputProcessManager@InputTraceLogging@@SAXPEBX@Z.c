/*
 * XREFs of ?RegisterProcess@InputProcessManager@InputTraceLogging@@SAXPEBX@Z @ 0x1801965F0
 * Callers:
...
void __fastcall InputTraceLogging::InputProcessManager::RegisterProcess(__int64 a1)
{
    ...
    && (*(_QWORD *)(v2 + 24) & 0x200LL) == *(_QWORD *)(v2 + 24) )
  {
    ...
    v3 = a1;
    v6 = 8;
    tlgWriteTransfer_EventWriteTransfer(v2, (unsigned __int8 *)dword_18020641F, 0LL, 0LL, 3u, &v4);
  }
}
