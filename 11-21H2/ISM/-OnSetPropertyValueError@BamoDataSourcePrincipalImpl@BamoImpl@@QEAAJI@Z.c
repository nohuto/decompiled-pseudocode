/*
 * XREFs of ?OnSetPropertyValueError@BamoDataSourcePrincipalImpl@BamoImpl@@QEAAJI@Z @ 0x1800F68E8
 * Callers:
 *     ?Thunk_OnSetPropertyValueError_5@?$IDataSourcePrincipal_Receive@VBamoDataSourcePrincipalImpl@BamoImpl@@@@SAJPEAXPEAPEAX@Z @ 0x1800F8510 (-Thunk_OnSetPropertyValueError_5@-$IDataSourcePrincipal_Receive@VBamoDataSourcePrincipalImpl@Bam.c)
 * Callees:
