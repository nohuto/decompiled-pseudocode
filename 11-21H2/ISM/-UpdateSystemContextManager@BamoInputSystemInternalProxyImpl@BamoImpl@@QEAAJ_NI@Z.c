/*
 * XREFs of ?UpdateSystemContextManager@BamoInputSystemInternalProxyImpl@BamoImpl@@QEAAJ_NI@Z @ 0x18011F274
 * Callers:
 *     ?Thunk_UpdateSystemContextManager_8@?$IInputSystemInternalProxy_Receive@VBamoInputSystemInternalProxyImpl@BamoImpl@@@@SAJPEAXPEAPEAX@Z @ 0x180118D90 (-Thunk_UpdateSystemContextManager_8@-$IInputSystemInternalProxy_Receive@VBamoInputSystemInternal.c)
  ...
  if ( *((_BYTE *)this + 28) )
  {
    Microsoft::BamoImpl::CalloutWrapper<BamoImpl::BamoInputSystemInternalProxyImpl>::CalloutWrapper<BamoImpl::BamoInputSystemInternalProxyImpl>(
      ...
      *(Microsoft::BamoImpl::BaseBamoConnectionImpl **)(*(_QWORD *)(*((_QWORD *)this + 2) + 24LL) + 32LL),
      (void (__fastcall ***)(_QWORD))this,
      2);
    v12 = (*(__int64 (__fastcall **)(char *))(*((_QWORD *)this - 2) + 128LL))((char *)this - 16);
    if ( v12 < 0 )
      wil::details::in1diag3::FailFast_Hr(
        retaddr,
        (void *)0xA471,
