/*
 * XREFs of ?QueryInterface@BamoPenDeviceManagerStub@@UEAAJAEBU_GUID@@PEAPEAX@Z @ 0x180187560
 * Callers:
 *     ?QueryInterface@BamoPenDeviceManagerStub@@W7EAAJAEBU_GUID@@PEAPEAX@Z @ 0x180052AE0 (-QueryInterface@BamoPenDeviceManagerStub@@W7EAAJAEBU_GUID@@PEAPEAX@Z.c)
 * Callees:
