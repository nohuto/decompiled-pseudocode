/*
 * XREFs of ?Initialize@?$KernelInputConnection@U_MIT_DEVICE_IDENTIFICATION_MESSAGE@@@@QEAAXAEBV?$ComPtr@UIMessageSession@@@WRL@Microsoft@@W4_MIT_ENDPOINT@@V?$function@$$A6AXPEBU_MIT_DEVICE_IDENTIFICATION_MESSAGE@@@Z@std@@@Z @ 0x180045068
 * Callers:
  ...
  *((_DWORD *)a1 + 34) = 0;
  ...
  if ( !*(_BYTE *)ISMTestMode::s_instance )
  {
    ...
    wil::unique_com_token<IMessageSession,unsigned __int64,void (IMessageSession *,unsigned __int64),&void wil::details::IMessageSessionCloseEndpointFunction(IMessageSession *,unsigned __int64),0>::reset(
      ...
      v19);
    v25 = (_DWORD)a1 + 16;
    v20 = v18(v17, KernelInputConnection<_MIT_DEVICE_IDENTIFICATION_MESSAGE>::s_OnKernelInputEventStatic, a1, *a1);
    if ( v20 < 0 )
      wil::details::in1diag3::FailFast_Hr(
        retaddr,
        (void *)0x43,
    ...
    if ( v21 < 0 )
      wil::details::in1diag3::FailFast_Hr(
        ...
        v25);
    v22 = NtMITCoreMsgKOpenConnectionTo(0LL, a1 + 3);
    if ( v22 < 0 )
