/*
 * XREFs of ?UpdateBounds@BamoControllerNavigationClientProxyImpl@BamoImpl@@QEAAJ_NPEBUtagRECT@@@Z @ 0x180174694
 * Callers:
 *     ?Thunk_UpdateBounds_52@?$IControllerNavigationClientProxy_Receive@VBamoControllerNavigationClientProxyImpl@BamoImpl@@@@SAJPEAXPEAPEAX@Z @ 0x180174560 (-Thunk_UpdateBounds_52@-$IControllerNavigationClientProxy_Receive@VBamoControllerNavigationClien.c)
