/*
 * XREFs of ?GetCachedFeatureEnabledState@?$FeatureImpl@U__WilFeatureTraits_Feature_DockInputProcessing@@@details@wil@@AEAA?ATwil_details_FeatureStateCache@@XZ @ 0x1800B4A98
 * Callers:
