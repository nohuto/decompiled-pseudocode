/*
 * XREFs of ?GetMagnifierController@BamoInputSiteElementProxy@@UEAAPEAVBamoMagnifierControllerProxy@@XZ @ 0x18000DD20
 * Callers:
 *     <none>
 * Callees:
        ...
        BamoInputSiteElementProxy *this)
{
  ...
  return (struct BamoMagnifierControllerProxy *)*((_QWORD *)this + 27);
}
