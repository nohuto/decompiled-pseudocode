/*
 * XREFs of ?UpdateDeviceDockServer@BamoInputSystemProxyImpl@BamoImpl@@QEAAJ_NI@Z @ 0x18011A1A4
 * Callers:
 *     ?Thunk_UpdateDeviceDockServer_8@?$IInputSystemProxy_Receive@VBamoInputSystemProxyImpl@BamoImpl@@@@SAJPEAXPEAPEAX@Z @ 0x180118730 (-Thunk_UpdateDeviceDockServer_8@-$IInputSystemProxy_Receive@VBamoInputSystemProxyImpl@BamoImpl@@.c)
