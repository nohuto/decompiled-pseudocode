/*
 * XREFs of ?OnRemoveDevice@InjectionRawInputProvider@@QEAAJPEAVInputInjectionClientProxy@@@Z @ 0x1800CEFE8
 * Callers:
 ...
 *     ?_Unchecked_erase@?$_Hash@V?$_Umap_traits@KV?$unique_ptr@VInputInfoValidator@@U?$default_delete@VInputInfoValidator@@@std@@@std@@V?$_Uhash_compare@KU?$hash@K@std@@U?$equal_to@K@2@@2@V?$allocator@U?$pair@$$CBKV?$unique_ptr@VInputInfoValidator@@U?$default_delete@VInputInfoValidator@@@std@@@std@@@std@@@2@$0A@@std@@@std@@AEAAPEAU?$_List_node@U?$pair@$$CBKV?$unique_ptr@VInputInfoValidator@@U?$default_delete@VInputInfoValidator@@@std@@@std@@@std@@PEAX@2@PEAU32@@Z @ 0x1800CF500 (-_Unchecked_erase@-$_Hash@V-$_Umap_traits@KV-$unique_ptr@VInputInfoValidator@@U-$default_delete@.c)
 */
        ...
        struct InputInjectionClientProxy *a2)
{
  ...
  {
    v5 = *(const unsigned __int8 **)(v11 + 24);
    ...
    if ( v10 != *((_QWORD *)this + 14) )
    {
      ...
      v5 = *(const unsigned __int8 **)(v4 + 24);
    }
    v6 = (*(__int64 (__fastcall **)(_QWORD, const unsigned __int8 *))(**((_QWORD **)this + 3) + 56LL))(
           *((_QWORD *)this + 3),
           v5);
    v7 = v6;
    if ( v6 < 0 )
