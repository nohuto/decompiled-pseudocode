/*
 * XREFs of ?UpdateGestureMinimumDistanceInHimetrics@BamoEdgyGestureRecognitionConfigurationProxyImpl@BamoImpl@@QEAAJ_NI@Z @ 0x18011B378
 * Callers:
 *     ?Thunk_UpdateGestureMinimumDistanceInHimetrics_8@?$IEdgyGestureRecognitionConfigurationProxy_Receive@VBamoEdgyGestureRecognitionConfigurationProxyImpl@BamoImpl@@@@SAJPEAXPEAPEAX@Z @ 0x1801188D0 (-Thunk_UpdateGestureMinimumDistanceInHimetrics_8@-$IEdgyGestureRecognitionConfigurationProxy_Rec.c)
