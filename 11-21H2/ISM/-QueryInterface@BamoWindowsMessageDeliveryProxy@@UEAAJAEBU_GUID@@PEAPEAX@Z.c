/*
 * XREFs of ?QueryInterface@BamoWindowsMessageDeliveryProxy@@UEAAJAEBU_GUID@@PEAPEAX@Z @ 0x180019620
 * Callers:
 *     ?QueryInterface@BamoWindowsMessageDeliveryProxy@@W7EAAJAEBU_GUID@@PEAPEAX@Z @ 0x180050BC0 (-QueryInterface@BamoWindowsMessageDeliveryProxy@@W7EAAJAEBU_GUID@@PEAPEAX@Z.c)
 * Callees:
