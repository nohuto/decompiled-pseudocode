/*
 * XREFs of ?QueryInterface@BamoInputDeliveryServerProxy@@UEAAJAEBU_GUID@@PEAPEAX@Z @ 0x180113DD0
 * Callers:
 *     ?QueryInterface@BamoInputDeliveryServerProxy@@W7EAAJAEBU_GUID@@PEAPEAX@Z @ 0x180050600 (-QueryInterface@BamoInputDeliveryServerProxy@@W7EAAJAEBU_GUID@@PEAPEAX@Z.c)
 * Callees:
