/*
 * XREFs of ?OnDockableDeviceAdded@BamoDeviceDockClientProxyImpl@BamoImpl@@QEAAJIPEAVBamoDockableDevicePrincipal@@@Z @ 0x180180ECC
 * Callers:
...
__int64 __fastcall BamoImpl::BamoDeviceDockClientProxyImpl::OnDockableDeviceAdded(
        ...
        const char *a4)
{
  ...
  char *v15; // rdi
  __int64 v16; // rdi
  struct IMessageCallSendHost *v17[2]; // [rsp+40h] [rbp-48h] BYREF
  ...
  else
  {
    if ( a3 )
      Microsoft::BamoImpl::BamoProxyImpl::PrepareForRemoteReference(
        ...
        a3);
    v7 = Microsoft::BamoImpl::BamoProxyImpl::PrepareForRemoteCall(this, v17, &v21, &v22);
    v8 = v7;
    if ( v7 >= 0 )
    {
      v9 = *((_BYTE *)this + 31) == 0;
      ...
      return CoreUICallSend(v10, v17, 2LL, 24LL);
    }
    else
    {
      wil::details::in1diag3::Return_Hr(
