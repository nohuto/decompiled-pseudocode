/*
 * XREFs of ?QueryInterface@BamoInputProcessStub@@UEAAJAEBU_GUID@@PEAPEAX@Z @ 0x1800B1FC0
 * Callers:
 *     ?QueryInterface@BamoInputProcessStub@@W7EAAJAEBU_GUID@@PEAPEAX@Z @ 0x18004F140 (-QueryInterface@BamoInputProcessStub@@W7EAAJAEBU_GUID@@PEAPEAX@Z.c)
 * Callees:
