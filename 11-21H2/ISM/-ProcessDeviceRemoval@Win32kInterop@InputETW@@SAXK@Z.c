/*
 * XREFs of ?ProcessDeviceRemoval@Win32kInterop@InputETW@@SAXK@Z @ 0x1800E07E0
 * Callers:
...
void __fastcall InputETW::Win32kInterop::ProcessDeviceRemoval(unsigned int a1)
{
  ...
  if ( InputETW::IsEnabled(a1) )
  {
    ...
    if ( *(_DWORD *)v2 > 5u && (*(_BYTE *)(v2 + 16) & 1) != 0 && (*(_QWORD *)(v2 + 24) & 1LL) == *(_QWORD *)(v2 + 24) )
    {
      ...
      v5 = v1;
      v9 = 8;
      tlgWriteTransfer_EventWriteTransfer(v2, (unsigned __int8 *)dword_18020330F, 0LL, 0LL, 3u, &v7);
    }
  }
}
