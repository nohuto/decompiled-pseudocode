...
void __fastcall ContextualProcessorBuffer::TryAddProcessorAndContact(__int64 a1, int a2, __int64 a3, int *a4)
{
  ...
  unsigned __int64 v64; // [rsp+150h] [rbp+50h] BYREF
...
LABEL_4:
    ...
    *((_QWORD *)&v60 + 1) = v16 + 16;
    ...
    {
      v64 = *((_QWORD *)a4 + 1);
      Microsoft::WRL::ComPtr<Windows::Foundation::IAsyncActionCompletedHandler>::InternalAddRef(&v64);
      v64 = v63;
      *(_QWORD *)&v63 = v19;
