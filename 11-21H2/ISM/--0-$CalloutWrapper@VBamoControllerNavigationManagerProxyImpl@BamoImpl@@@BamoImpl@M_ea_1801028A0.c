/*
 * XREFs of ??0?$CalloutWrapper@VBamoControllerNavigationManagerProxyImpl@BamoImpl@@@BamoImpl@Microsoft@@QEAA@PEAVBaseBamoConnectionImpl@12@PEAVBamoControllerNavigationManagerProxyImpl@1@W4PrologEpilogConfig@12@@Z @ 0x1801028A0
 * Callers:
