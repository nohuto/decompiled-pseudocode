/*
 * XREFs of ?GetEndpointId@BamoUIAHitTestInputObjectProxy@@UEAAAEBU_GUID@@XZ @ 0x180109C70
 * Callers:
 *     <none>
 * Callees:
...
const struct _GUID *__fastcall BamoUIAHitTestInputObjectProxy::GetEndpointId(BamoUIAHitTestInputObjectProxy *this)
{
