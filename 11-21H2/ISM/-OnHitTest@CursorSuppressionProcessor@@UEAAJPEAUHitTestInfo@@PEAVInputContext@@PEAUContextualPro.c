/*
 * XREFs of ?OnHitTest@CursorSuppressionProcessor@@UEAAJPEAUHitTestInfo@@PEAVInputContext@@PEAUContextualProcessorInitialState@@@Z @ 0x1801384B0
 * Callers:
 *     <none>
 * Callees:
        ...
        if ( *((_DWORD *)v6 + 20) != 3 )
        {
          ...
          *((_DWORD *)v6 + 20) = 3;
          v10 = (_DWORD *)wil::details::static_lazy<TestCursorTraceLogging>::get(
                            (__int64)this,
                            _lambda_f8a530405e8d431733881e929c3e0226_::_lambda_invoker_cdecl_)[1];
          if ( *v10 > 4u )
          {
