/*
 * XREFs of ?UpdateTailButtonClickedEventsRequired@BamoPenEventsClientProxyImpl@BamoImpl@@QEAAJ_N0@Z @ 0x180048E34
 * Callers:
 *     ?Thunk_UpdateTailButtonClickedEventsRequired_11@?$IPenEventsClientProxy_Receive@VBamoPenEventsClientProxyImpl@BamoImpl@@@@SAJPEAXPEAPEAX@Z @ 0x180049320 (-Thunk_UpdateTailButtonClickedEventsRequired_11@-$IPenEventsClientProxy_Receive@VBamoPenEventsCl.c)
