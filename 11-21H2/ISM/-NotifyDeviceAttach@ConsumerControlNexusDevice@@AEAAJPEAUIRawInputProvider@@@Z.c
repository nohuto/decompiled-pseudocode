/*
 * XREFs of ?NotifyDeviceAttach@ConsumerControlNexusDevice@@AEAAJPEAUIRawInputProvider@@@Z @ 0x1800D3BB8
 * Callers:
...
LABEL_11:
  ...
  *v7 = 0LL;
  ...
  else
  {
    ...
    Microsoft::WRL::ComPtr<IContainerInfoInputObjectProxy>::InternalRelease(v8 + 1);
