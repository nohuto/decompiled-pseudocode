/*
 * XREFs of ?SetConvertGraspToSystemGesture@MPCManager@@UEAAJPEAVBamoMPCManagerStub@@_NI@Z @ 0x18009B320
 * Callers:
 *     <none>
 * Callees:
 ...
 *     ?SetConvertGraspToSystemGesture@MPCHolographicInputManager@@QEAAX_NK@Z @ 0x1800A0B8C (-SetConvertGraspToSystemGesture@MPCHolographicInputManager@@QEAAX_NK@Z.c)
 */
