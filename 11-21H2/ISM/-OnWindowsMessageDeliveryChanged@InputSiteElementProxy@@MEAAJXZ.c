/*
 * XREFs of ?OnWindowsMessageDeliveryChanged@InputSiteElementProxy@@MEAAJXZ @ 0x18001A480
 * Callers:
 *     <none>
 * Callees:
 ...
 *     ??$find_if@V?$_Vector_iterator@V?$_Vector_val@U?$_Simple_types@UAttachedInputObjectEntry@InputSite@@@std@@@std@@@std@@V_lambda_9c87987138ffa5ecb6aee109509755f0_@@@std@@YA?AV?$_Vector_iterator@V?$_Vector_val@U?$_Simple_types@UAttachedInputObjectEntry@InputSite@@@std@@@std@@@0@V10@V10@V_lambda_9c87987138ffa5ecb6aee109509755f0_@@@Z @ 0x180019BA0 (--$find_if@V-$_Vector_iterator@V-$_Vector_val@U-$_Simple_types@UAttachedInputObjectEntry@InputSi.c)
        ...
        const char *a4)
{
  ...
  v20 = v22;
  v21 = &v19;
  std::find_if<std::_Vector_iterator<std::_Vector_val<std::_Simple_types<InputSite::AttachedInputObjectEntry>>>,_lambda_9c87987138ffa5ecb6aee109509755f0_>(
    &v18,
    *(__int64 **)(v5 + 488),
    *(__int64 **)(v5 + 496),
    &v20);
  ...
  Microsoft::WRL::ComPtr<IWindowsMessageDeliveryProxy>::InternalRelease(&v19);
  v7 = *((_QWORD *)this + 39);
  v8 = (*(__int64 (__fastcall **)(char *))(*((_QWORD *)this + 1) + 280LL))((char *)this + 8);
  if ( v8 )
  {
    v10 = (__int64 *)(v8 + 8);
    v22[0] = v8 + 8;
