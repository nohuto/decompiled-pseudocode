/*
 * XREFs of ?Thunk_Materialize_BamoWindowsMessageDeliveryProxy_5@?$IBamoPeer_ISMBamos_AutoBamos_Receive@VBamoPeerImpl@ISMBamos_AutoBamos@BamoImpl@@@@SAJPEAXPEAPEAX@Z @ 0x1800057B0
 * Callers:
 *     <none>
 * Callees:
 ...
 *     ?CreateWindowsMessageDeliveryProxy@@YAJPEAVBamoPeer@ISMBamos_AutoBamos@@PEAPEAVBamoWindowsMessageDeliveryProxy@@@Z @ 0x180005C24 (-CreateWindowsMessageDeliveryProxy@@YAJPEAVBamoPeer@ISMBamos_AutoBamos@@PEAPEAVBamoWindowsMessag.c)
...
__int64 __fastcall IBamoPeer_ISMBamos_AutoBamos_Receive<BamoImpl::ISMBamos_AutoBamos::BamoPeerImpl>::Thunk_Materialize_BamoWindowsMessageDeliveryProxy_5(
        __int64 a1,
        unsigned int **a2,
        __int64 a3)
{
  ...
  struct BamoWindowsMessageDeliveryProxy *v16; // [rsp+60h] [rbp+8h] BYREF

  v4 = **a2;
  v5 = *(struct ISMBamos_AutoBamos::BamoPeer **)(a1 + 16);
  Microsoft::BamoImpl::CalloutWrapper<Microsoft::BamoImpl::CalloutWrapperObject>::CalloutWrapper<Microsoft::BamoImpl::CalloutWrapperObject>(
    v14,
    *(_QWORD *)(*(_QWORD *)(a1 + 24) + 32LL),
    a3,
    0LL);
  v6 = CreateWindowsMessageDeliveryProxy(v5, &v16);
  if ( v6 < 0 )
  ...
  if ( !v16 )
    wil::details::in1diag3::_FailFast_Unexpected(
      ...
      (unsigned int)"onecoreuap\\Windows\\moderncore\\inputv2\\Bamos\\codegen\\system\\objfre\\amd64\\ISMBamos.ISMBamos_Shared.bamo.h",
      v7);
  v8 = (*(__int64 (__fastcall **)(struct BamoWindowsMessageDeliveryProxy *))(*(_QWORD *)v16 + 56LL))(v16);
  v9 = *(_QWORD *)(v8 + 16);
  *(_QWORD *)(v8 + 16) = a1;
