/*
 * XREFs of ?GetType@BamoInputForwardTargetInputObjectProxy@@UEAAAEBU_GUID@@XZ @ 0x18010A750
 * Callers:
 *     <none>
 * Callees:
...
const struct _GUID *__fastcall BamoInputForwardTargetInputObjectProxy::GetType(
