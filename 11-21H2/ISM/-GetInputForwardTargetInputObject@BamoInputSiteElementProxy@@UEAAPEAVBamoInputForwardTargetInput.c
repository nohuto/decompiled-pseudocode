/*
 * XREFs of ?GetInputForwardTargetInputObject@BamoInputSiteElementProxy@@UEAAPEAVBamoInputForwardTargetInputObjectProxy@@XZ @ 0x18000DE00
 * Callers:
 *     <none>
 * Callees:
        ...
        BamoInputSiteElementProxy *this)
{
  ...
  return (struct BamoInputForwardTargetInputObjectProxy *)*((_QWORD *)this + 25);
}
