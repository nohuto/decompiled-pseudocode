/*
 * XREFs of ?SetScaleOverride@BamoSystemCursorControllerPrincipal@@UEAAXM@Z @ 0x1800EA1B0
 * Callers:
 *     <none>
 * Callees:
...
LABEL_7:
  if ( v7 < 0 )
    wil::details::in1diag3::FailFast_Hr(
      ...
      v8);
  Microsoft::BamoImpl::InternalLock::~InternalLock((Microsoft::BamoImpl::InternalLock *)&v10, v3, v4);
}
