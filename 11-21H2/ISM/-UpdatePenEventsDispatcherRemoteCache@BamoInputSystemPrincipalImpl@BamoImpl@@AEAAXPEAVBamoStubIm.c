/*
 * XREFs of ?UpdatePenEventsDispatcherRemoteCache@BamoInputSystemPrincipalImpl@BamoImpl@@AEAAXPEAVBamoStubImpl@2Microsoft@@@Z @ 0x18001FFA0
 * Callers:
 ...
 *     ?UpdatePenEventsDispatcherRemoteCacheStatic@BamoInputSystemPrincipalImpl@BamoImpl@@CAJPEAVBamoStubImpl@2Microsoft@@PEAV12@@Z @ 0x180122388 (-UpdatePenEventsDispatcherRemoteCacheStatic@BamoInputSystemPrincipalImpl@BamoImpl@@CAJPEAVBamoSt.c)
 * Callees:
...
void __fastcall BamoImpl::BamoInputSystemPrincipalImpl::UpdatePenEventsDispatcherRemoteCache(
        ...
        struct Microsoft::BamoImpl::BamoStubImpl *a2)
{
  ...
  __int64 v10; // r15
  char *v11; // rbp
  void (__fastcall *v12)(_QWORD *, __int64, __int64); // r14
  __int64 v13; // rdx
  ...
  if ( *(_QWORD *)(*(_QWORD *)(*((_QWORD *)this + 2) + 32LL) + 64LL) )
  {
    ...
    if ( v3 )
    {
      ...
      do
      {
        if ( *(_DWORD *)(*(_QWORD *)(v8 + 40) + 36LL) == *(_DWORD *)(v6 + 36) )
          break;
        v8 = *(_QWORD *)(v8 + 48);
      }
      while ( v8 );
      ...
      {
LABEL_8:
        v9 = (*(__int64 (__fastcall **)(_QWORD *, __int64, char **))(*v5 + 72LL))(v5, v6, &v32);
        if ( v9 < 0 )
          wil::details::in1diag3::FailFast_Hr(
            retaddr,
            (void *)0x259,
            ...
            v29);
        v8 = (*(__int64 (__fastcall **)(char *))(*(_QWORD *)v32 + 32LL))(v32);
        *(_QWORD *)(v8 + 24) = v5;
        v10 = *(_QWORD *)(v8 + 40);
        *(_QWORD *)(v8 + 40) = v7;
    ...
    v30[1] = v22;
    LOWORD(v29) = 10;
    v23 = CoreUICallSend(v11, v30, 2LL, 58LL);
