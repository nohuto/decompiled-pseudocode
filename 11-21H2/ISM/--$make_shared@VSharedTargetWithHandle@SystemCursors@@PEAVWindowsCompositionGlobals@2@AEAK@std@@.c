/*
 * XREFs of ??$make_shared@VSharedTargetWithHandle@SystemCursors@@PEAVWindowsCompositionGlobals@2@AEAK@std@@YA?AV?$shared_ptr@VSharedTargetWithHandle@SystemCursors@@@0@$$QEAPEAVWindowsCompositionGlobals@SystemCursors@@AEAK@Z @ 0x1800EB110
 * Callers:
