/*
 * XREFs of ?GetDeviceState@MagnifierProcessor@@AEAA?AV?$ComPtr@UDeviceState@MagnifierProcessor@@@WRL@Microsoft@@PEBUHitTestInfo@@@Z @ 0x1801AF8C0
 * Callers:
...
__int64 *__fastcall MagnifierProcessor::GetDeviceState(__int64 a1, __int64 *a2, __int64 a3)
{
  ...
  v7 = *(_DWORD *)(a3 + 4);
  v17 = v7;
  appended = std::_Fnv1a_append_bytes(a1, (const unsigned __int8 *const)&v17, 8uLL);
  v9 = std::_Hash<std::_Umap_traits<unsigned __int64,std::vector<Microsoft::WRL::ComPtr<InputSite>>,std::_Uhash_compare<unsigned __int64,std::hash<unsigned __int64>,std::equal_to<unsigned __int64>>,std::allocator<std::pair<unsigned __int64 const,std::vector<Microsoft::WRL::ComPtr<InputSite>>>>,0>>::_Find_last<unsigned __int64>(
         v6,
         v15,
         &v17,
         appended)[1];
  ...
  if ( v9 == *(_QWORD *)(a1 + 24) )
  {
    ...
    v10 = Microsoft::WRL::Details::MakeAndInitialize<MagnifierProcessor::DeviceState,MagnifierProcessor::DeviceState,>(&v17);
    if ( v10 < 0 )
    ...
    v11 = std::_Hash<std::_Umap_traits<unsigned __int64,Microsoft::WRL::ComPtr<MagnifierProcessor::DeviceState>,std::_Uhash_compare<unsigned __int64,std::hash<unsigned __int64>,std::equal_to<unsigned __int64>>,std::allocator<std::pair<unsigned __int64 const,Microsoft::WRL::ComPtr<MagnifierProcessor::DeviceState>>>,0>>::_Try_emplace<unsigned __int64 const &,>(
            v6,
            (__int64)v15,
            (unsigned __int8 *)&v19);
    v12 = *(_QWORD *)v11;
    v13 = v17;
    if ( *(_QWORD *)(*(_QWORD *)v11 + 24LL) != v17 )
    {
      v18 = v17;
