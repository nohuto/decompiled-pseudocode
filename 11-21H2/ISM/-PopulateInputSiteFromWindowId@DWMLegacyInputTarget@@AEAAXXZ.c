/*
 * XREFs of ?PopulateInputSiteFromWindowId@DWMLegacyInputTarget@@AEAAXXZ @ 0x18019CF00
 * Callers:
...
void __fastcall DWMLegacyInputTarget::PopulateInputSiteFromWindowId(DWMLegacyInputTarget *this)
{
  ...
  InputSiteFromId = InputSiteManager::GetInputSiteFromId((__int64)InputSiteManager, &v9, 1, *((_QWORD *)this + 8));
  Microsoft::WRL::ComPtr<InputSite>::operator=((__int64 *)this + 9, (char *)InputSiteFromId);
  v4 = v9;
  if ( v9 )
  {
    v9 = 0LL;
