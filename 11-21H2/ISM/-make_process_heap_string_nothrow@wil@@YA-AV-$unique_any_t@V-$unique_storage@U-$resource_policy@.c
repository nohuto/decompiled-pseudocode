/*
 * XREFs of ?make_process_heap_string_nothrow@wil@@YA?AV?$unique_any_t@V?$unique_storage@U?$resource_policy@PEAGP6AXPEAX@Z$1?FreeProcessHeap@details@wil@@YAX0@ZU?$integral_constant@_K$0A@@wistd@@PEAGPEAG$0A@$$T@details@wil@@@details@wil@@@1@PEBG_K@Z @ 0x18004CFAC
 * Callers:
...
_QWORD *__fastcall wil::make_process_heap_string_nothrow(_QWORD *a1, char *a2, unsigned __int64 a3, const char *a4)
{
