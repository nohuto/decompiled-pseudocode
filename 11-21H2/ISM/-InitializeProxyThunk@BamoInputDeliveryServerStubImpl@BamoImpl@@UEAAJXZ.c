/*
 * XREFs of ?InitializeProxyThunk@BamoInputDeliveryServerStubImpl@BamoImpl@@UEAAJXZ @ 0x180010650
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall BamoImpl::BamoInputDeliveryServerStubImpl::InitializeProxyThunk(
