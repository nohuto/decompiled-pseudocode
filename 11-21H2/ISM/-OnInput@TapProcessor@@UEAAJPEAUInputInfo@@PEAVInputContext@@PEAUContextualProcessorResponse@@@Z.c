/*
 * XREFs of ?OnInput@TapProcessor@@UEAAJPEAUInputInfo@@PEAVInputContext@@PEAUContextualProcessorResponse@@@Z @ 0x1801B3DE0
 * Callers:
 *     <none>
 * Callees:
 ...
 *     ?ResetAndInitializeInteractionContext@TapProcessor@@AEAAJXZ @ 0x1801B3FB0 (-ResetAndInitializeInteractionContext@TapProcessor@@AEAAJXZ.c)
 */
