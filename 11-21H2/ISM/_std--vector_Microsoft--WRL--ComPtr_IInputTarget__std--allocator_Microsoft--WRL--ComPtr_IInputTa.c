/*
 * XREFs of _std::vector_Microsoft::WRL::ComPtr_IInputTarget__std::allocator_Microsoft::WRL::ComPtr_IInputTarget_____::_Emplace_reallocate_Microsoft::WRL::ComPtr_IInputTarget____::_1_::catch$0 @ 0x180054510
 * Callers:
 *     <none>
 * Callees:
...
void __fastcall __noreturn std::vector_Microsoft::WRL::ComPtr_IInputTarget__std::allocator_Microsoft::WRL::ComPtr_IInputTarget_____::_Emplace_reallocate_Microsoft::WRL::ComPtr_IInputTarget____::_1_::catch_0(
        ...
        __int64 a2)
{
  std::_Destroy_range<std::allocator<Microsoft::WRL::ComPtr<ICursor>>>(*(__int64 **)(a2 + 32), *(__int64 **)(a2 + 40));
  std::_Deallocate<16,0>(*(void **)(a2 + 136), 8LL * *(_QWORD *)(a2 + 112));
  throw;
}
