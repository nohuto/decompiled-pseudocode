/*
 * XREFs of ?MPCHandProcessor_UseGazeForTargetingChange_@ISMTracing@@QEAAXPEBULegacyInputInfo@@_N@Z @ 0x1800A7614
 * Callers:
        ...
        char a3)
{
  ...
  if ( *(_DWORD *)v5 > 4u && (*(_BYTE *)(v5 + 16) & 1) != 0 && (*(_QWORD *)(v5 + 24) & 1LL) == *(_QWORD *)(v5 + 24) )
  {
    ...
    v14 = 4LL;
    v9 = a3;
    tlgWriteTransfer_EventWriteTransfer(v5, (unsigned __int8 *)dword_1802006B3, 0LL, 0LL, 8u, &v12);
  }
}
