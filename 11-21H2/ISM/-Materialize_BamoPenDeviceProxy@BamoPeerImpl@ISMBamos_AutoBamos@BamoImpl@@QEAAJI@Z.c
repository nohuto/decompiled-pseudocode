/*
 * XREFs of ?Materialize_BamoPenDeviceProxy@BamoPeerImpl@ISMBamos_AutoBamos@BamoImpl@@QEAAJI@Z @ 0x18010D04C
 * Callers:
 *     ?Thunk_Materialize_BamoPenDeviceProxy_5@?$IBamoPeer_ISMBamos_AutoBamos_Receive@VBamoPeerImpl@ISMBamos_AutoBamos@BamoImpl@@@@SAJPEAXPEAPEAX@Z @ 0x180118250 (-Thunk_Materialize_BamoPenDeviceProxy_5@-$IBamoPeer_ISMBamos_AutoBamos_Receive@VBamoPeerImpl@ISM.c)
 * Callees:
