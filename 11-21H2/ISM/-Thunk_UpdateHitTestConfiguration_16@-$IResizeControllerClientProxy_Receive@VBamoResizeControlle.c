/*
 * XREFs of ?Thunk_UpdateHitTestConfiguration_16@?$IResizeControllerClientProxy_Receive@VBamoResizeControllerClientProxyImpl@BamoImpl@@@@SAJPEAXPEAPEAX@Z @ 0x1801189D0
 * Callers:
 *     <none>
 * Callees:
 *     <none>
