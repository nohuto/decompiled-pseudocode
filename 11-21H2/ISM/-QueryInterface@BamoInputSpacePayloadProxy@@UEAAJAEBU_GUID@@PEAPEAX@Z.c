/*
 * XREFs of ?QueryInterface@BamoInputSpacePayloadProxy@@UEAAJAEBU_GUID@@PEAPEAX@Z @ 0x180114130
 * Callers:
 *     ?QueryInterface@BamoInputSpacePayloadProxy@@W7EAAJAEBU_GUID@@PEAPEAX@Z @ 0x1800506C0 (-QueryInterface@BamoInputSpacePayloadProxy@@W7EAAJAEBU_GUID@@PEAPEAX@Z.c)
 * Callees:
