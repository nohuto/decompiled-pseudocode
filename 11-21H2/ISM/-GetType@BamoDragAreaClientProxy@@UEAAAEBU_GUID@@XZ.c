/*
 * XREFs of ?GetType@BamoDragAreaClientProxy@@UEAAAEBU_GUID@@XZ @ 0x18010A660
 * Callers:
 *     <none>
 * Callees:
...
const struct _GUID *__fastcall BamoDragAreaClientProxy::GetType(BamoDragAreaClientProxy *this)
{
