/*
 * XREFs of ?OnPropertiesRefreshedCallout@BamoSystemContextManagerProxy@@EEAAJXZ @ 0x180112DA0
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall BamoSystemContextManagerProxy::OnPropertiesRefreshedCallout(BamoSystemContextManagerProxy *this)
{
  ...
  Microsoft::BamoImpl::CalloutWrapper<BamoImpl::BamoSystemContextManagerProxyImpl>::CalloutWrapper<BamoImpl::BamoSystemContextManagerProxyImpl>(
    ...
    *(_QWORD *)(*(_QWORD *)(*((_QWORD *)this + 4) + 24LL) + 32LL),
    (__int64)this + 16);
  LODWORD(v1) = (*(__int64 (__fastcall **)(BamoSystemContextManagerProxy *))(*(_QWORD *)v1 + 48LL))(v1);
