/*
 * XREFs of ?OnConnectedThunk@BamoPenDeviceStubImpl@BamoImpl@@UEAAJXZ @ 0x180189DA0
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall BamoImpl::BamoPenDeviceStubImpl::OnConnectedThunk(BamoImpl::BamoPenDeviceStubImpl *this)
{
  __int64 v2; // rbx
  int v3; // eax
  unsigned int v4; // edi
