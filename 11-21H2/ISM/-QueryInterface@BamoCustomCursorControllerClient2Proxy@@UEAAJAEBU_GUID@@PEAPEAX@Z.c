/*
 * XREFs of ?QueryInterface@BamoCustomCursorControllerClient2Proxy@@UEAAJAEBU_GUID@@PEAPEAX@Z @ 0x180113710
 * Callers:
 *     ?QueryInterface@BamoCustomCursorControllerClient2Proxy@@W7EAAJAEBU_GUID@@PEAPEAX@Z @ 0x180050480 (-QueryInterface@BamoCustomCursorControllerClient2Proxy@@W7EAAJAEBU_GUID@@PEAPEAX@Z.c)
 * Callees:
