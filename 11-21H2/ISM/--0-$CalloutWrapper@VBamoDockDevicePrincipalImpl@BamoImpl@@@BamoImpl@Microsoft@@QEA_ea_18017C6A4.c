/*
 * XREFs of ??0?$CalloutWrapper@VBamoDockDevicePrincipalImpl@BamoImpl@@@BamoImpl@Microsoft@@QEAA@PEAVBaseBamoConnectionImpl@12@PEAVBamoDockDevicePrincipalImpl@1@W4PrologEpilogConfig@12@@Z @ 0x18017C6A4
 * Callers:
