/*
 * XREFs of ?OnWinKeyAcknowledged@WinKeyScenarioTelemetry@@SAXXZ @ 0x1800FB708
 * Callers:
 *     ?OnHotKeyAcknowledged@HotKeyProcessor@@UEAAJXZ @ 0x1801D3E30 (-OnHotKeyAcknowledged@HotKeyProcessor@@UEAAJXZ.c)
 * Callees:
