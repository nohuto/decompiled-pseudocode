/*
 * XREFs of ?GetManualDragAreaClient@BamoInputSiteElementProxy@@UEAAPEAVBamoManualDragAreaClientProxy@@XZ @ 0x18000DCB0
 * Callers:
 *     <none>
 * Callees:
        ...
        BamoInputSiteElementProxy *this)
{
  ...
  return (struct BamoManualDragAreaClientProxy *)*((_QWORD *)this + 28);
}
