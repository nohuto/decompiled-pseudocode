/*
 * XREFs of ?DragEnded@DragNDrop@InputETW@@SAXKPEAUtagPOINT@@00_KW4VirtualKeyModifiers@System@Windows@@1@Z @ 0x18013E1E4
 * Callers:
...
char __fastcall InputETW::DragNDrop::DragEnded(
        unsigned int a1,
        int *a2,
        int *a3,
        int *a4,
