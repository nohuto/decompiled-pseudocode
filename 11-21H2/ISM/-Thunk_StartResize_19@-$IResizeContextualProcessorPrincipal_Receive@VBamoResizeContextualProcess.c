/*
 * XREFs of ?Thunk_StartResize_19@?$IResizeContextualProcessorPrincipal_Receive@VBamoResizeContextualProcessorPrincipalImpl@BamoImpl@@@@SAJPEAXPEAPEAX@Z @ 0x180143C00
 * Callers:
 *     <none>
 * Callees:
 *     <none>
