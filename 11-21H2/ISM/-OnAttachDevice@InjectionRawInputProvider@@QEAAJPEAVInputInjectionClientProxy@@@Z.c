/*
 * XREFs of ?OnAttachDevice@InjectionRawInputProvider@@QEAAJPEAVInputInjectionClientProxy@@@Z @ 0x1800CECE4
 * Callers:
  ...
  if ( v13 == *((void **)this + 6) )
  {
    ...
    *((_DWORD *)v6 + 1) = 8;
    ...
    if ( v7 >= 0 )
    {
      ...
      v8 = 0;
      if ( v14 )
        (*(void (__fastcall **)(InputInfoValidator *, __int64))(*(_QWORD *)v14 + 24LL))(v14, 1LL);
      v6 = (unsigned __int8 *)v13;
    }
    else
    {
