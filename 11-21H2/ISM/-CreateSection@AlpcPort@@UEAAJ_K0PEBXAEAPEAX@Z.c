/*
 * XREFs of ?CreateSection@AlpcPort@@UEAAJ_K0PEBXAEAPEAX@Z @ 0x1800FD9B0
 * Callers:
 *     <none>
 * Callees:
 ...
 *     ?ComputeFromData@SipcSectionId@@QEAAJ_KPEBX@Z @ 0x1800FD800 (-ComputeFromData@SipcSectionId@@QEAAJ_KPEBX@Z.c)
