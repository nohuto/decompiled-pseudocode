/*
 * XREFs of ?InitializeProxyThunk@BamoDragProcessorManagerStubImpl@BamoImpl@@UEAAJXZ @ 0x1800109B0
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall BamoImpl::BamoDragProcessorManagerStubImpl::InitializeProxyThunk(
