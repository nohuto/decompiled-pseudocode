/*
 * XREFs of ?Thunk_Materialize_BamoInputSiteElementProxy_5@?$IBamoPeer_ISMBamos_AutoBamos_Receive@VBamoPeerImpl@ISMBamos_AutoBamos@BamoImpl@@@@SAJPEAXPEAPEAX@Z @ 0x1800058C0
 * Callers:
 *     <none>
 * Callees:
