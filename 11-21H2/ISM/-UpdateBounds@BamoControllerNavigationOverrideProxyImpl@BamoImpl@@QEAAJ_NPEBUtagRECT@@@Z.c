/*
 * XREFs of ?UpdateBounds@BamoControllerNavigationOverrideProxyImpl@BamoImpl@@QEAAJ_NPEBUtagRECT@@@Z @ 0x1801747D0
 * Callers:
 *     ?Thunk_UpdateBounds_52@?$IControllerNavigationOverrideProxy_Receive@VBamoControllerNavigationOverrideProxyImpl@BamoImpl@@@@SAJPEAXPEAPEAX@Z @ 0x180174580 (-Thunk_UpdateBounds_52@-$IControllerNavigationOverrideProxy_Receive@VBamoControllerNavigationOve.c)
