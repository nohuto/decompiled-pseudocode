/*
 * XREFs of ?RefreshCursorMagnetismRegistrySettings@ControllerProcessor@@AEAAXXZ @ 0x180177FE8
 * Callers:
 *     _lambda_828562b8234057b7c70d01bfff3fe312_::_lambda_invoker_cdecl_ @ 0x1801753B0 (_lambda_828562b8234057b7c70d01bfff3fe312_--_lambda_invoker_cdecl_.c)
 *     ?Initialize@ControllerProcessor@@IEAAJXZ @ 0x18017705C (-Initialize@ControllerProcessor@@IEAAJXZ.c)
 * Callees:
 *     _lambda_9421d204e635201636d0a16c341872b8_::operator() @ 0x180175C3C (_lambda_9421d204e635201636d0a16c341872b8_--operator().c)
 *     ?ConvertDIPSToPixels@ControllerProcessor@@AEAAKAEBK@Z @ 0x180176D0C (-ConvertDIPSToPixels@ControllerProcessor@@AEAAKAEBK@Z.c)
 */
