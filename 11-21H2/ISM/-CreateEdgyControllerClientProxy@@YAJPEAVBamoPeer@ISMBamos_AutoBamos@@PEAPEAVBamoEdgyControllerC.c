/*
 * XREFs of ?CreateEdgyControllerClientProxy@@YAJPEAVBamoPeer@ISMBamos_AutoBamos@@PEAPEAVBamoEdgyControllerClientProxy@@@Z @ 0x18014C15C
 * Callers:
        ...
        struct BamoEdgyControllerClientProxy **a2)
{
  ...
  if ( *(int *)(v3 + 8) <= 0 )
    ...
    v4 = *(_QWORD *)(v3 + 16);
  v5 = (*(__int64 (__fastcall **)(__int64))(*(_QWORD *)(*(_QWORD *)(v4 + 232) + 8LL) + 88LL))(*(_QWORD *)(v4 + 232) + 8LL);
