/*
 * XREFs of ?Materialize_BamoMPCConstantManagerClientCallbacksProxy@BamoPeerImpl@MPCManagerBamo_AutoBamos@BamoImpl@@QEAAJI@Z @ 0x180099720
 * Callers:
 *     ?Thunk_Materialize_BamoMPCConstantManagerClientCallbacksProxy_11@?$IBamoPeer_MPCManagerBamo_AutoBamos_Receive@VBamoPeerImpl@MPCManagerBamo_AutoBamos@BamoImpl@@@@SAJPEAXPEAPEAX@Z @ 0x18009B910 (-Thunk_Materialize_BamoMPCConstantManagerClientCallbacksProxy_11@-$IBamoPeer_MPCManagerBamo_Auto.c)
 * Callees:
