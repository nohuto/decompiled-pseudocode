/*
 * XREFs of ?GetPROPVARIANT@MPCConstantManager@@AEAA?AV?$optional@UtagPROPVARIANT@@@std@@W4InputType@@V?$basic_string_view@GU?$char_traits@G@std@@@3@@Z @ 0x18009586C
 * Callers:
 *     ?GetConstant@MPCConstantManager@@UEAAJPEAVBamoMPCConstantManagerClientStub@@W4InputType@@PEBGPEAVBamoAsyncResult_PROPVARIANT_Proxy@@@Z @ 0x180095270 (-GetConstant@MPCConstantManager@@UEAAJPEAVBamoMPCConstantManagerClientStub@@W4InputType@@PEBGPEA.c)
 * Callees:
...
__int64 __fastcall MPCConstantManager::GetPROPVARIANT(__int64 a1, __int64 a2, unsigned int a3, __m128i *a4)
{
  __int64 v7; // rax
  __int64 v8; // rcx
  __int64 *v9; // r14
