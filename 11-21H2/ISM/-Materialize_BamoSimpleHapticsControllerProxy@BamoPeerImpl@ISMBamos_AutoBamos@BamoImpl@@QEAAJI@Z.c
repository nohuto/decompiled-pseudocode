/*
 * XREFs of ?Materialize_BamoSimpleHapticsControllerProxy@BamoPeerImpl@ISMBamos_AutoBamos@BamoImpl@@QEAAJI@Z @ 0x18010D518
 * Callers:
 *     ?Thunk_Materialize_BamoSimpleHapticsControllerProxy_5@?$IBamoPeer_ISMBamos_AutoBamos_Receive@VBamoPeerImpl@ISMBamos_AutoBamos@BamoImpl@@@@SAJPEAXPEAPEAX@Z @ 0x180118330 (-Thunk_Materialize_BamoSimpleHapticsControllerProxy_5@-$IBamoPeer_ISMBamos_AutoBamos_Receive@VBa.c)
 * Callees:
        ...
        unsigned int a2)
{
  ...
  *v10 = &BamoSimpleHapticsControllerProxy::`vftable'{for `Microsoft::Bamo::BamoProxy'};
  v10[1] = &BamoSimpleHapticsControllerProxy::`vftable'{for `ISimpleHapticsControllerProxy'};
  *((_DWORD *)v10 + 6) = 0;
  v10[4] = 0LL;
  v10[2] = &BamoImpl::BamoSimpleHapticsControllerProxyImpl::`vftable';
  v10[5] = 0LL;
  v10[6] = 0LL;
  *((_DWORD *)v10 + 14) = 0;
