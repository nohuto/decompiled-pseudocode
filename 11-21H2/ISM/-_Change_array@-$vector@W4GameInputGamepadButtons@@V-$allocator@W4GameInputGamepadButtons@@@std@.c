/*
 * XREFs of ?_Change_array@?$vector@W4GameInputGamepadButtons@@V?$allocator@W4GameInputGamepadButtons@@@std@@@std@@AEAAXQEAW4GameInputGamepadButtons@@_K1@Z @ 0x18017B928
 * Callers:
...
__int64 __fastcall std::vector<enum GameInputGamepadButtons>::_Change_array(
        __int64 a1,
        __int64 a2,
        __int64 a3,
        __int64 a4)
