/*
 * XREFs of ??0MPCHeadMovementDetector@@QEAA@XZ @ 0x1800B7CB8
 * Callers:
 ...
 *     ?ScheduleNextTimerCallback@MPCHeadMovementDetector@@AEAAXXZ @ 0x1800B88B0 (-ScheduleNextTimerCallback@MPCHeadMovementDetector@@AEAAXXZ.c)
