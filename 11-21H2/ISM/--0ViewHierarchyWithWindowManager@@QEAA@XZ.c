/*
 * XREFs of ??0ViewHierarchyWithWindowManager@@QEAA@XZ @ 0x18003F0E0
 * Callers:
        ...
        ViewHierarchyWithWindowManager *this)
{
  ...
  *((_QWORD *)this + 23) = 0LL;
  ...
  {
    _InterlockedDecrement64(&qword_180242E18);
    v13 = (char *)&_lambda_bde3f744bf3d16209662d38da0fd875b_::_lambda_invoker_cdecl_;
