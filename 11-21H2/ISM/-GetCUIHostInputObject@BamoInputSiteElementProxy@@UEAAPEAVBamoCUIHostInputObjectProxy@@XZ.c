/*
 * XREFs of ?GetCUIHostInputObject@BamoInputSiteElementProxy@@UEAAPEAVBamoCUIHostInputObjectProxy@@XZ @ 0x18000E260
 * Callers:
 *     <none>
 * Callees:
        ...
        BamoInputSiteElementProxy *this)
{
  ...
  return (struct BamoCUIHostInputObjectProxy *)*((_QWORD *)this + 15);
}
