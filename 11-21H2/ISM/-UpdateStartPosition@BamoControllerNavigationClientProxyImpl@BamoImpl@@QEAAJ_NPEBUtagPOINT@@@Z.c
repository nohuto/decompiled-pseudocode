/*
 * XREFs of ?UpdateStartPosition@BamoControllerNavigationClientProxyImpl@BamoImpl@@QEAAJ_NPEBUtagPOINT@@@Z @ 0x180174F18
 * Callers:
 *     ?Thunk_UpdateStartPosition_23@?$IControllerNavigationClientProxy_Receive@VBamoControllerNavigationClientProxyImpl@BamoImpl@@@@SAJPEAXPEAPEAX@Z @ 0x180174640 (-Thunk_UpdateStartPosition_23@-$IControllerNavigationClientProxy_Receive@VBamoControllerNavigati.c)
