/*
 * XREFs of ?GetVisualReferenceId@BamoControllerNavigationClientProxy@@UEAA_KXZ @ 0x180173EE0
 * Callers:
 *     <none>
 * Callees:
...
unsigned __int64 __fastcall BamoControllerNavigationClientProxy::GetVisualReferenceId(
