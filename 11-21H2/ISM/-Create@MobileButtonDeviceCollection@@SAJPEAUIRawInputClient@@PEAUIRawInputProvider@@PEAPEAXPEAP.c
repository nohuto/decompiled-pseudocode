/*
 * XREFs of ?Create@MobileButtonDeviceCollection@@SAJPEAUIRawInputClient@@PEAUIRawInputProvider@@PEAPEAXPEAPEAV1@@Z @ 0x1800C4628
 * Callers:
...
LABEL_15:
  if ( v8 )
    std::default_delete<MobileButtonDeviceCollection>::operator()(v14, v8);
  return v11;
}
