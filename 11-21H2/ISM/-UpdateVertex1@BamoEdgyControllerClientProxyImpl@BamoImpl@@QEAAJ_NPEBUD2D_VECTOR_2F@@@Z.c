/*
 * XREFs of ?UpdateVertex1@BamoEdgyControllerClientProxyImpl@BamoImpl@@QEAAJ_NPEBUD2D_VECTOR_2F@@@Z @ 0x18014D17C
 * Callers:
 *     ?Thunk_UpdateVertex1_181@?$IEdgyControllerClientProxy_Receive@VBamoEdgyControllerClientProxyImpl@BamoImpl@@@@SAJPEAXPEAPEAX@Z @ 0x18014CAD0 (-Thunk_UpdateVertex1_181@-$IEdgyControllerClientProxy_Receive@VBamoEdgyControllerClientProxyImpl.c)
