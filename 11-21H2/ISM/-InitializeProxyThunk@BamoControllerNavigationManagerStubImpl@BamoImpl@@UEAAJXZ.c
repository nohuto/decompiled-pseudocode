/*
 * XREFs of ?InitializeProxyThunk@BamoControllerNavigationManagerStubImpl@BamoImpl@@UEAAJXZ @ 0x180010530
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall BamoImpl::BamoControllerNavigationManagerStubImpl::InitializeProxyThunk(
