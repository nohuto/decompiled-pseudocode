/*
 * XREFs of ?QueryInterface@BamoEdgyGestureRecognitionConfigurationProxy@@UEAAJAEBU_GUID@@PEAPEAX@Z @ 0x180113CB0
 * Callers:
 *     ?QueryInterface@BamoEdgyGestureRecognitionConfigurationProxy@@W7EAAJAEBU_GUID@@PEAPEAX@Z @ 0x1800505C0 (-QueryInterface@BamoEdgyGestureRecognitionConfigurationProxy@@W7EAAJAEBU_GUID@@PEAPEAX@Z.c)
 * Callees:
