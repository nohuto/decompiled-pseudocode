/*
 * XREFs of ?OnDisconnectedCallout@BamoDockableDeviceProxy@@EEAAJXZ @ 0x18010F990
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall BamoDockableDeviceProxy::OnDisconnectedCallout(BamoDockableDeviceProxy *this)
{
  ...
  Microsoft::BamoImpl::CalloutWrapper<BamoImpl::BamoDockableDeviceProxyImpl>::CalloutWrapper<BamoImpl::BamoDockableDeviceProxyImpl>(
    ...
    *(_QWORD *)(*(_QWORD *)(*((_QWORD *)this + 4) + 24LL) + 32LL),
    (__int64)this + 16);
  LODWORD(v1) = (*(__int64 (__fastcall **)(BamoDockableDeviceProxy *))(*(_QWORD *)v1 + 40LL))(v1);
