/*
 * XREFs of ?InitializeProxyThunk@BamoActivatableEntityStubImpl@BamoImpl@@UEAAJXZ @ 0x18000A6F0
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall BamoImpl::BamoActivatableEntityStubImpl::InitializeProxyThunk(
