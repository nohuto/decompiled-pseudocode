/*
 * XREFs of ?OnPeerConnectedThunk@BamoConnectionImpl@ISMBamos_AutoBamos@BamoImpl@@MEAAJPEAVBaseBamoPeerImpl@3Microsoft@@PEA_NPEAPEAVBamoPrincipal@Bamo@5@@Z @ 0x18000A110
 * Callers:
 *     <none>
 * Callees:
        ...
        struct Microsoft::Bamo::BamoPrincipal **a4)
{
  ...
  if ( v12 < 0 )
    wil::details::in1diag3::FailFast_Hr(
      ...
      v16);
  v13 = (*(__int64 (__fastcall **)(__int64, __int64, bool *, struct Microsoft::Bamo::BamoPrincipal **))(*(_QWORD *)v7 + 104LL))(
          v7,
          v8,
          a3,
          a4);
  v14 = (*(__int64 (__fastcall **)(_QWORD))(**((_QWORD **)this + 2) + 80LL))(*((_QWORD *)this + 2));
  if ( v14 < 0 )
    wil::details::in1diag3::FailFast_Hr(
      retaddr,
      (void *)0x87,
