/*
 * XREFs of ?GetCachedFeatureEnabledState@?$FeatureImpl@U__WilFeatureTraits_Feature_InputComponentUIHierarchy@@@details@wil@@AEAA?ATwil_details_FeatureStateCache@@XZ @ 0x18002E074
 * Callers:
...
signed __int32 *__fastcall wil::details::FeatureImpl<__WilFeatureTraits_Feature_InputComponentUIHierarchy>::GetCachedFeatureEnabledState(
        ...
        signed __int32 *a2)
{
  ...
  *a2 = *a1;
  if ( (v2 & 3) != 3 )
  {
    ...
    wil::details::FeatureImpl<__WilFeatureTraits_Feature_InputComponentUIHierarchy>::GetCurrentFeatureEnabledState(
      a1,
      &v13,
      &i);
    v7 = *a2;
