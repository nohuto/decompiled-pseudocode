/*
 * XREFs of __scrt_uninitialize_crt @ 0x18004A298
 * Callers:
 *     dllmain_crt_process_detach @ 0x180049BE0 (dllmain_crt_process_detach.c)
 * Callees:
 *     __scrt_stub_for_acrt_uninitialize_critical @ 0x18004C238 (__scrt_stub_for_acrt_uninitialize_critical.c)
 */
