/*
 * XREFs of ?CreateEndpointToReceiveMessages@TestCommandHost@@AEAAXXZ @ 0x180028290
 * Callers:
...
void __fastcall TestCommandHost::CreateEndpointToReceiveMessages(TestCommandHost *this, __int64 a2)
{
  int v3; // eax
  __int64 v4; // rdi
  __int64 (__fastcall *v5)(__int64, HLOCAL, const wchar_t *, char *); // rbx
  int v6; // eax
  int v7; // eax
  __int64 v8; // rdi
  ...
  if ( v3 < 0 )
    wil::details::in1diag3::_Throw_Hr(
      ...
      v12);
  v4 = *(_QWORD *)this;
  v5 = *(__int64 (__fastcall **)(__int64, HLOCAL, const wchar_t *, char *))(**(_QWORD **)this + 56LL);
  Microsoft::WRL::ComPtr<HotkeyRegistrationForwarder>::InternalRelease((__int64 *)this + 2);
  v6 = v5(v4, hMem, L"System\\Input\\TestCommandsPort", (char *)this + 16);
  if ( v6 < 0 )
    wil::details::in1diag3::_Throw_Hr(
      retaddr,
      (void *)0x6D,
