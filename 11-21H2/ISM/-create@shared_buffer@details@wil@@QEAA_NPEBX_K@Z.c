/*
 * XREFs of ?create@shared_buffer@details@wil@@QEAA_NPEBX_K@Z @ 0x18007EF08
 * Callers:
 ...
 *     ?assign@shared_buffer@details@wil@@AEAAXPEAJ_K@Z @ 0x18007EEC4 (-assign@shared_buffer@details@wil@@AEAAXPEAJ_K@Z.c)
