/*
 * XREFs of ?GetInfo@TwoFingerDragRecognizer@@UEAAJW4GestureDataType@@PEAUGestureData@@@Z @ 0x1801B8680
 * Callers:
 *     <none>
 * Callees:
 *     _guard_xfg_dispatch_icall_nop @ 0x18004E9E0 (_guard_xfg_dispatch_icall_nop.c)
 *     ?GetDragInfo@TwoFingerDragRecognizer@@QEAA_NPEAUGestureData@@@Z @ 0x1801B8630 (-GetDragInfo@TwoFingerDragRecognizer@@QEAA_NPEAUGestureData@@@Z.c)
 */
