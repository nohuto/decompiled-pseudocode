/*
 * XREFs of ??1ISMHeatFrameworkHost@@MEAA@XZ @ 0x180183E54
 * Callers:
...
void __fastcall ISMHeatFrameworkHost::~ISMHeatFrameworkHost(ISMHeatFrameworkHost *this)
{
  ...
  *((_QWORD *)this + 33) = 0LL;
  ...
  Microsoft::WRL::ComPtr<IContainerInfoInputObjectProxy>::InternalRelease((__int64 *)this + 27);
  ...
  *((_QWORD *)this + 21) = 0LL;
  ...
  Microsoft::WRL::ComPtr<IContainerInfoInputObjectProxy>::InternalRelease((__int64 *)this + 15);
  std::_Deallocate<16,0>(
    *((void **)this + 10),
