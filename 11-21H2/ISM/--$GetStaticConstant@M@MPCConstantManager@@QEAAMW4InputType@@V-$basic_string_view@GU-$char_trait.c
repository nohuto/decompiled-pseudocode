/*
 * XREFs of ??$GetStaticConstant@M@MPCConstantManager@@QEAAMW4InputType@@V?$basic_string_view@GU?$char_traits@G@std@@@std@@@Z @ 0x1800A5C4C
 * Callers:
...
float __fastcall MPCConstantManager::GetStaticConstant<float>(__int64 a1, __int64 a2, __m128i *a3)
{
  const char *v5; // r9
  __int64 v6; // rax
  __int64 v7; // rcx
