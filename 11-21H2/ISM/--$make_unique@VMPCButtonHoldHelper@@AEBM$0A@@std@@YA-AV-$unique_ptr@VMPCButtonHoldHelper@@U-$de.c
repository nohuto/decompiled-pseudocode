/*
 * XREFs of ??$make_unique@VMPCButtonHoldHelper@@AEBM$0A@@std@@YA?AV?$unique_ptr@VMPCButtonHoldHelper@@U?$default_delete@VMPCButtonHoldHelper@@@std@@@0@AEBM@Z @ 0x1801BDAA8
 * Callers:
        ...
        float *a2)
{
  __int64 v4; // r8
  const char *v5; // r9
  MPCButtonHoldHelper *v7; // [rsp+30h] [rbp+8h]
