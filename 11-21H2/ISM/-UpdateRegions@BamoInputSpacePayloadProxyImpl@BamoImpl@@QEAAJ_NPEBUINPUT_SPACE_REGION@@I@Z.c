/*
 * XREFs of ?UpdateRegions@BamoInputSpacePayloadProxyImpl@BamoImpl@@QEAAJ_NPEBUINPUT_SPACE_REGION@@I@Z @ 0x18011DECC
 * Callers:
 *     ?Thunk_UpdateRegions_238@?$IInputSpacePayloadProxy_Receive@VBamoInputSpacePayloadProxyImpl@BamoImpl@@@@SAJPEAXPEAPEAX@Z @ 0x180118C90 (-Thunk_UpdateRegions_238@-$IInputSpacePayloadProxy_Receive@VBamoInputSpacePayloadProxyImpl@BamoI.c)
