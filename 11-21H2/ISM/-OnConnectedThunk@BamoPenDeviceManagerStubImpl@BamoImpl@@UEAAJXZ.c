/*
 * XREFs of ?OnConnectedThunk@BamoPenDeviceManagerStubImpl@BamoImpl@@UEAAJXZ @ 0x180186F40
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall BamoImpl::BamoPenDeviceManagerStubImpl::OnConnectedThunk(
