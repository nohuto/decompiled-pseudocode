/*
 * XREFs of ?UpdateHaptics@BamoPenDeviceProxyImpl@BamoImpl@@QEAAJ_NI@Z @ 0x18011BA58
 * Callers:
 *     ?Thunk_UpdateHaptics_8@?$IPenDeviceProxy_Receive@VBamoPenDeviceProxyImpl@BamoImpl@@@@SAJPEAXPEAPEAX@Z @ 0x180118970 (-Thunk_UpdateHaptics_8@-$IPenDeviceProxy_Receive@VBamoPenDeviceProxyImpl@BamoImpl@@@@SAJPEAXPEAP.c)
  ...
  if ( *((_BYTE *)this + 28) )
  {
    ...
    if ( v10 < 0 )
      wil::details::in1diag3::FailFast_Hr(
        ...
        v13[0]);
    Microsoft::BamoImpl::CalloutWrapper<BamoImpl::BamoPenDeviceProxyImpl>::~CalloutWrapper<BamoImpl::BamoPenDeviceProxyImpl>((__int64)v13);
  }
  v11 = *((_QWORD *)this + 6);
  *((_QWORD *)this + 6) = v7;
  if ( v7 )
