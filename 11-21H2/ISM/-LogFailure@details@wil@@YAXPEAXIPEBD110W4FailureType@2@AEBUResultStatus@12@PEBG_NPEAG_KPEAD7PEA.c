/*
 * XREFs of ?LogFailure@details@wil@@YAXPEAXIPEBD110W4FailureType@2@AEBUResultStatus@12@PEBG_NPEAG_KPEAD7PEAUFailureInfo@2@@Z @ 0x180044E58
 * Callers:
 ...
 * Callees:
 *     ?RecordReturn@details@wil@@YAHJ@Z @ 0x180011FF0 (-RecordReturn@details@wil@@YAHJ@Z.c)
 *     ?RecordFailFast@details@wil@@YAHJ@Z @ 0x1800214F0 (-RecordFailFast@details@wil@@YAHJ@Z.c)
 ...
 *     ?RecordException@details@wil@@YAHJ@Z @ 0x18007CEA4 (-RecordException@details@wil@@YAHJ@Z.c)
 *     ?RecordLog@details@wil@@YAHJ@Z @ 0x18007D070 (-RecordLog@details@wil@@YAHJ@Z.c)
  ...
  *(_DWORD *)(a15 + 12) = *(_DWORD *)(a8 + 4);
  ...
  switch ( a7 )
  {
    case 0:
      ...
      goto LABEL_4;
    case 1:
      v19 = wil::details::RecordReturn((wil::details *)v17);
LABEL_4:
      v18 = v19;
      break;
    case 2:
  ...
  *(_QWORD *)(a15 + 128) = ModuleName;
  ...
  {
    if ( a7 != 3 )
      wil::details::in1diag3::FailFastImmediate_Unexpected(v23);
