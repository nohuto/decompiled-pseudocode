/*
 * XREFs of ??1?$unordered_map@KPEAVInputInfoValidator@@U?$hash@K@std@@U?$equal_to@K@3@V?$allocator@U?$pair@$$CBKPEAVInputInfoValidator@@@std@@@3@@std@@QEAA@XZ @ 0x1800DE2E0
 * Callers:
 *     _Win32kInterop::Win32kInterop_::_1_::dtor$5 @ 0x180056D17 (_Win32kInterop--Win32kInterop_--_1_--dtor$5.c)
 * Callees:
