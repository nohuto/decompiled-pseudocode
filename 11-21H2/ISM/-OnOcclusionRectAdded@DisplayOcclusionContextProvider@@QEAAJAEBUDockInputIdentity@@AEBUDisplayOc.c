/*
 * XREFs of ?OnOcclusionRectAdded@DisplayOcclusionContextProvider@@QEAAJAEBUDockInputIdentity@@AEBUDisplayOcclusionRect@@@Z @ 0x18019EAD4
 * Callers:
  ...
  *(_QWORD *)&v19 = *((_QWORD *)a2 + 2);
  ...
  if ( v10 >= 0 )
  {
    ...
    if ( !*(_DWORD *)ISMScenarios::s_instance )
    {
      ...
      v15 = (*(__int64 (__fastcall **)(__int64))(*(_QWORD *)(*((_QWORD *)InputSystemInternalServerConnection + 29) + 8LL)
