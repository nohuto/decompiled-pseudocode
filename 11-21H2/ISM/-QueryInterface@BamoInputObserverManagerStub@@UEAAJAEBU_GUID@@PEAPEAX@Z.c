/*
 * XREFs of ?QueryInterface@BamoInputObserverManagerStub@@UEAAJAEBU_GUID@@PEAPEAX@Z @ 0x18012D5F0
 * Callers:
 *     ?QueryInterface@BamoInputObserverManagerStub@@W7EAAJAEBU_GUID@@PEAPEAX@Z @ 0x180050C20 (-QueryInterface@BamoInputObserverManagerStub@@W7EAAJAEBU_GUID@@PEAPEAX@Z.c)
 * Callees:
