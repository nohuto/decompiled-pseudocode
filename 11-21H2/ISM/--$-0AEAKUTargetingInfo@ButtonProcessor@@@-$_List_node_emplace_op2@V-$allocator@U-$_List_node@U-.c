/*
 * XREFs of ??$?0AEAKUTargetingInfo@ButtonProcessor@@@?$_List_node_emplace_op2@V?$allocator@U?$_List_node@U?$pair@$$CBKUTargetingInfo@ButtonProcessor@@@std@@PEAX@std@@@std@@@std@@QEAA@AEAV?$allocator@U?$_List_node@U?$pair@$$CBKUTargetingInfo@ButtonProcessor@@@std@@PEAX@std@@@1@AEAK$$QEAUTargetingInfo@ButtonProcessor@@@Z @ 0x1801B99C0
 * Callers:
