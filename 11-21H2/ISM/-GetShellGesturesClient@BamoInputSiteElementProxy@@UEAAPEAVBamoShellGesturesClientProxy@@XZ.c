/*
 * XREFs of ?GetShellGesturesClient@BamoInputSiteElementProxy@@UEAAPEAVBamoShellGesturesClientProxy@@XZ @ 0x18000DA80
 * Callers:
 *     <none>
 * Callees:
        ...
        BamoInputSiteElementProxy *this)
{
  ...
  return (struct BamoShellGesturesClientProxy *)*((_QWORD *)this + 33);
}
