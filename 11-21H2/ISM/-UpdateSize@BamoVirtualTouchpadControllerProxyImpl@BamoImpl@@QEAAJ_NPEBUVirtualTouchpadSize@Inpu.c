/*
 * XREFs of ?UpdateSize@BamoVirtualTouchpadControllerProxyImpl@BamoImpl@@QEAAJ_NPEBUVirtualTouchpadSize@Input@Internal@UI@Windows@@@Z @ 0x18012BC04
 * Callers:
 *     ?Thunk_UpdateSize_362@?$IVirtualTouchpadControllerProxy_Receive@VBamoVirtualTouchpadControllerProxyImpl@BamoImpl@@@@SAJPEAXPEAPEAX@Z @ 0x18012B6C0 (-Thunk_UpdateSize_362@-$IVirtualTouchpadControllerProxy_Receive@VBamoVirtualTouchpadControllerPr.c)
