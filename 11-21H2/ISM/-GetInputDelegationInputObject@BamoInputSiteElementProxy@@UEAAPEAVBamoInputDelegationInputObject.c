/*
 * XREFs of ?GetInputDelegationInputObject@BamoInputSiteElementProxy@@UEAAPEAVBamoInputDelegationInputObjectProxy@@XZ @ 0x18000DEE0
 * Callers:
 *     <none>
 * Callees:
        ...
        BamoInputSiteElementProxy *this)
{
  ...
  return (struct BamoInputDelegationInputObjectProxy *)*((_QWORD *)this + 23);
}
