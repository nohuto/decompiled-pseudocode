/*
 * XREFs of ?BoundsCrossed@BamoControllerNavigationOverrideProxyImpl@BamoImpl@@QEAAJAEBUtagPOINT@@@Z @ 0x180173BBC
 * Callers:
        ...
        const char *a4)
{
  ...
  else
  {
    ...
    if ( v7 >= 0 )
    {
      ...
      v15 = (struct IMessageCallSendHost *)*a2;
      v11[0] = v13;
      v11[1] = v14;
      return CoreUICallSend(v9, v11, 2LL, 20LL);
    }
    else
    {
      wil::details::in1diag3::Return_Hr(
