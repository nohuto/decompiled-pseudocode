/*
 * XREFs of ?QueryInterface@EdgyLegacyProcessor@@UEAAJAEBU_GUID@@PEAPEAX@Z @ 0x1801AA4D0
 * Callers:
 *     ?QueryInterface@EdgyLegacyProcessor@@W7EAAJAEBU_GUID@@PEAPEAX@Z @ 0x180053860 (-QueryInterface@EdgyLegacyProcessor@@W7EAAJAEBU_GUID@@PEAPEAX@Z.c)
 * Callees:
...
LABEL_11:
  ...
  {
    (*(void (__fastcall **)(EdgyLegacyProcessor *))(*(_QWORD *)this + 8LL))(this);
    v4 = (EdgyLegacyProcessor *)((char *)v4 + 8);
    goto LABEL_11;
  }
  return 2147500034LL;
}
