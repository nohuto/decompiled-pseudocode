/*
 * XREFs of ?OnPropertiesRefreshedThunk@BamoMPCConstantManagerClientCallbacksStubImpl@BamoImpl@@UEAAJXZ @ 0x180170720
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall BamoImpl::BamoMPCConstantManagerClientCallbacksStubImpl::OnPropertiesRefreshedThunk(
