/*
 * XREFs of ?OnConnectedCallout@BamoControllerNavigationOverrideProxy@@EEAAJXZ @ 0x180173FD0
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall BamoControllerNavigationOverrideProxy::OnConnectedCallout(
        BamoControllerNavigationOverrideProxy *this)
{
  ...
  Microsoft::BamoImpl::CalloutWrapper<BamoImpl::BamoControllerNavigationOverrideProxyImpl>::CalloutWrapper<BamoImpl::BamoControllerNavigationOverrideProxyImpl>(
    ...
    *(_QWORD *)(*(_QWORD *)(*((_QWORD *)this + 4) + 24LL) + 32LL),
    (__int64)this + 16);
  LODWORD(v1) = (*(__int64 (__fastcall **)(BamoControllerNavigationOverrideProxy *))(*(_QWORD *)v1 + 32LL))(v1);
