/*
 * XREFs of ?Initialize@ResizeProcessor@@AEAAJXZ @ 0x180145BC8
 * Callers:
...
__int64 __fastcall ResizeProcessor::Initialize(ResizeProcessor *this)
{
  ...
  v6 = (*(__int64 (__fastcall **)(__int64))(*(_QWORD *)(*((_QWORD *)BamoServerConnection + 29) + 8LL) + 200LL))(*((_QWORD *)BamoServerConnection + 29) + 8LL);
