/*
 * XREFs of ?OnKeyboardKeyPress@MPCHolographicInputManager@@QEAAXK@Z @ 0x18009F31C
 * Callers:
  ...
  if ( *((_BYTE *)this + 3364) )
  {
    ...
    if ( !v5 )
    {
      ...
      if ( (*(unsigned int (__fastcall **)(_QWORD))(***((_QWORD ***)this + 450) + 48LL))(**((_QWORD **)this + 450)) == 512 )
      {
        ...
        Microsoft::WRL::ComPtr<IContainerInfoInputObjectProxy>::InternalRelease((__int64 *)&PerformanceCount);
      }
    }
