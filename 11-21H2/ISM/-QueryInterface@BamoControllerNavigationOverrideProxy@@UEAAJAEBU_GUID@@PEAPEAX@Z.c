/*
 * XREFs of ?QueryInterface@BamoControllerNavigationOverrideProxy@@UEAAJAEBU_GUID@@PEAPEAX@Z @ 0x1801744D0
 * Callers:
 *     ?QueryInterface@BamoControllerNavigationOverrideProxy@@W7EAAJAEBU_GUID@@PEAPEAX@Z @ 0x180052820 (-QueryInterface@BamoControllerNavigationOverrideProxy@@W7EAAJAEBU_GUID@@PEAPEAX@Z.c)
 * Callees:
