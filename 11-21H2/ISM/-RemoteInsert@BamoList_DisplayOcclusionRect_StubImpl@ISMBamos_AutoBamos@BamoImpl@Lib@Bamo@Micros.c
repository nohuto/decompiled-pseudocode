/*
 * XREFs of ?RemoteInsert@BamoList_DisplayOcclusionRect_StubImpl@ISMBamos_AutoBamos@BamoImpl@Lib@Bamo@Microsoft@@QEAAJIAEBUDisplayOcclusionRect@@@Z @ 0x18013571C
 * Callers:
        ...
        const char *a4)
{
  ...
  __int128 v15; // xmm0
  __int128 v16; // xmm1
  struct IMessageCallSendHost *v17; // [rsp+40h] [rbp-E8h] BYREF
  _QWORD v18[3]; // [rsp+48h] [rbp-E0h] BYREF
