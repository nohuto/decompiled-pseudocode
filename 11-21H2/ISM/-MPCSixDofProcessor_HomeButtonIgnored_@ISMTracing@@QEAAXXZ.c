/*
 * XREFs of ?MPCSixDofProcessor_HomeButtonIgnored_@ISMTracing@@QEAAXXZ @ 0x1801BFF30
 * Callers:
...
void __fastcall ISMTracing::MPCSixDofProcessor_HomeButtonIgnored_(ISMTracing *this)
{
    ...
    && (*(_QWORD *)(v1 + 24) & 0x400000000001LL) == *(_QWORD *)(v1 + 24) )
  {
    ...
    v2 = 50331648LL;
    v5 = 8;
    tlgWriteTransfer_EventWriteTransfer(v1, (unsigned __int8 *)dword_180206B2F, 0LL, 0LL, 3u, &v3);
  }
}
