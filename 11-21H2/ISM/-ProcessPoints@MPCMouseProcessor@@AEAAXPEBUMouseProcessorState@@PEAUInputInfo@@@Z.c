/*
 * XREFs of ?ProcessPoints@MPCMouseProcessor@@AEAAXPEBUMouseProcessorState@@PEAUInputInfo@@@Z @ 0x1801C9AE8
 * Callers:
        ...
        struct InputInfo *a3)
{
  ...
  *((_QWORD *)&v40 + 1) = L"MouseParams_PointScaleFactorWheel";
  ...
  v25 = (float)(v24 * v10) + *((float *)this + 1330);
  v26 = (float)(v24 * v11) + *((float *)this + 1331);
  *((float *)this + 1329) = (float)(v24 * v9) + *((float *)this + 1329);
  *((float *)this + 1330) = v25;
  *((float *)this + 1331) = v26;
