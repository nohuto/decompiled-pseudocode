/*
 * XREFs of ?OnDisconnectedThunk@BamoMPCManagerStubImpl@BamoImpl@@UEAAJXZ @ 0x180099D10
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall BamoImpl::BamoMPCManagerStubImpl::OnDisconnectedThunk(
        BamoImpl::BamoMPCManagerStubImpl *this,
        __int64 a2,
        __int64 a3)
{
  BamoImpl::BamoMPCManagerStubImpl *v3; // rbx
  __int64 v4; // rdi
  __int64 v5; // rdx
  __int64 v6; // r8
  const char *v7; // r9
