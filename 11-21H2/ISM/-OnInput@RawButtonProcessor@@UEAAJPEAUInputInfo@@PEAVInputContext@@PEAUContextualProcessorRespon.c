/*
 * XREFs of ?OnInput@RawButtonProcessor@@UEAAJPEAUInputInfo@@PEAVInputContext@@PEAUContextualProcessorResponse@@@Z @ 0x1801B4970
 * Callers:
 *     <none>
 * Callees:
        ...
        struct ContextualProcessorResponse *a4)
{
  ...
  else
  {
    *((_DWORD *)a4 + 2) = 3;
    ...
    InputETW::RawButtonProcessor::ButtonEvent(v12, v13, *((_DWORD *)this + 72));
  }
  return 0LL;
}
