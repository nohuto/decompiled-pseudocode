/*
 * XREFs of ??R?$default_delete@VConsumerControlDeviceCollection@@@std@@QEBAXPEAVConsumerControlDeviceCollection@@@Z @ 0x1800C5D64
 * Callers:
 *     ??1?$unique_ptr@VConsumerControlDeviceCollection@@U?$default_delete@VConsumerControlDeviceCollection@@@std@@@std@@QEAA@XZ @ 0x1800C5CC8 (--1-$unique_ptr@VConsumerControlDeviceCollection@@U-$default_delete@VConsumerControlDeviceCollec.c)
