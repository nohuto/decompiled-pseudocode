/*
 * XREFs of ?GetResizeControllerClient@BamoInputSiteElementProxy@@UEAAPEAVBamoResizeControllerClientProxy@@XZ @ 0x18000DAF0
 * Callers:
 *     <none>
 * Callees:
        ...
        BamoInputSiteElementProxy *this)
{
  ...
  return (struct BamoResizeControllerClientProxy *)*((_QWORD *)this + 32);
}
