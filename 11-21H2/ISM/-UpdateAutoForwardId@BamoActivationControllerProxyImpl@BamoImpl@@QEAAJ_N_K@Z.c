/*
 * XREFs of ?UpdateAutoForwardId@BamoActivationControllerProxyImpl@BamoImpl@@QEAAJ_N_K@Z @ 0x180011814
 * Callers:
 *     ?Thunk_UpdateAutoForwardId_0@?$IActivationControllerProxy_Receive@VBamoActivationControllerProxyImpl@BamoImpl@@@@SAJPEAXPEAPEAX@Z @ 0x180011F60 (-Thunk_UpdateAutoForwardId_0@-$IActivationControllerProxy_Receive@VBamoActivationControllerProxy.c)
  ...
  if ( v6 )
  {
    Microsoft::BamoImpl::CalloutWrapper<BamoImpl::BamoActivationControllerProxyImpl>::CalloutWrapper<BamoImpl::BamoActivationControllerProxyImpl>(
      ...
      *(_QWORD *)(*(_QWORD *)(*((_QWORD *)this + 2) + 24LL) + 32LL),
      this,
      1LL);
    v8 = (*(__int64 (__fastcall **)(char *, __int64))(*((_QWORD *)this - 2) + 136LL))((char *)this - 16, v3);
    if ( v8 < 0 )
