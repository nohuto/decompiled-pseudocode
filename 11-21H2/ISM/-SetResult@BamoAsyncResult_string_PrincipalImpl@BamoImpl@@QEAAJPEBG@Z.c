/*
 * XREFs of ?SetResult@BamoAsyncResult_string_PrincipalImpl@BamoImpl@@QEAAJPEBG@Z @ 0x18016F840
 * Callers:
 *     ?Thunk_SetResult_0@?$IAsyncResult_string_Principal_Receive@VBamoAsyncResult_string_PrincipalImpl@BamoImpl@@@@SAJPEAXPEAPEAX@Z @ 0x18016F980 (-Thunk_SetResult_0@-$IAsyncResult_string_Principal_Receive@VBamoAsyncResult_string_PrincipalImpl.c)
 * Callees:
        ...
        const unsigned __int16 *a2)
{
  ...
  Microsoft::BamoImpl::CalloutWrapper<Microsoft::BamoImpl::CalloutWrapperObject>::CalloutWrapper<Microsoft::BamoImpl::CalloutWrapperObject>(
    ...
    *(_QWORD *)(*(_QWORD *)(v4[5] + 24LL) + 32LL),
    v7,
    0);
  v8 = (*(__int64 (__fastcall **)(char *, __int64, const unsigned __int16 *))(*((_QWORD *)this - 2) + 80LL))(
         (char *)this - 16,
         v6,
         a2);
  v12 = v8;
