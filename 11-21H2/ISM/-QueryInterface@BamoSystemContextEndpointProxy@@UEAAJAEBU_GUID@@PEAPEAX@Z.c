/*
 * XREFs of ?QueryInterface@BamoSystemContextEndpointProxy@@UEAAJAEBU_GUID@@PEAPEAX@Z @ 0x180137B40
 * Callers:
 *     ?QueryInterface@BamoSystemContextEndpointProxy@@W7EAAJAEBU_GUID@@PEAPEAX@Z @ 0x180050D80 (-QueryInterface@BamoSystemContextEndpointProxy@@W7EAAJAEBU_GUID@@PEAPEAX@Z.c)
 * Callees:
