/*
 * XREFs of ?UpdateTouchEnabled@BamoShellGesturesClientProxyImpl@BamoImpl@@QEAAJ_N0@Z @ 0x180150018
 * Callers:
 *     ?Thunk_UpdateTouchEnabled_11@?$IShellGesturesClientProxy_Receive@VBamoShellGesturesClientProxyImpl@BamoImpl@@@@SAJPEAXPEAPEAX@Z @ 0x18014FE50 (-Thunk_UpdateTouchEnabled_11@-$IShellGesturesClientProxy_Receive@VBamoShellGesturesClientProxyIm.c)
  ...
  if ( v6 )
  {
    ...
    if ( v8 < 0 )
      wil::details::in1diag3::FailFast_Hr(
        ...
        v11[0]);
    Microsoft::BamoImpl::CalloutWrapper<BamoImpl::BamoShellGesturesClientProxyImpl>::~CalloutWrapper<BamoImpl::BamoShellGesturesClientProxyImpl>((__int64)v11);
    v6 = *((_BYTE *)this + 28);
  }
  *((_BYTE *)this + 33) = v3;
  if ( v6 )
