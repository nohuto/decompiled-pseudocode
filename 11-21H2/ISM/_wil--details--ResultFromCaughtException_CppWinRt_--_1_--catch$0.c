/*
 * XREFs of _wil::details::ResultFromCaughtException_CppWinRt_::_1_::catch$0 @ 0x1800CACF6
 * Callers:
 *     <none>
 * Callees:
 *     ?MaybeGetExceptionString@details@wil@@YAXAEBVResultException@2@PEAG_K@Z @ 0x18007C6E8 (-MaybeGetExceptionString@details@wil@@YAXAEBVResultException@2@PEAG_K@Z.c)
 */
