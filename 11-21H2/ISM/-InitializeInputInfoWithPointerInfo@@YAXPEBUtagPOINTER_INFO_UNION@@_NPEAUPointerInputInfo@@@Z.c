/*
 * XREFs of ?InitializeInputInfoWithPointerInfo@@YAXPEBUtagPOINTER_INFO_UNION@@_NPEAUPointerInputInfo@@@Z @ 0x1800E0138
 * Callers:
 ...
 *     ?PointerTypeToInputType@@YA?AW4InputType@@K_N@Z @ 0x180126064 (-PointerTypeToInputType@@YA-AW4InputType@@K_N@Z.c)
        ...
        struct PointerInputInfo *a3)
{
  ...
  *v5 = v4;
  v9 = 0LL;
  Microsoft::WRL::ComPtr<IContainerInfoInputObjectProxy>::InternalRelease((__int64 *)&v9);
