/*
 * XREFs of ?ShareSection@AlpcPort@@UEAAJPEAX@Z @ 0x1800FF740
 * Callers:
 *     <none>
 * Callees:
...
LABEL_3:
  ...
  v13 = *((_QWORD *)this + 7);
  v26 = v11;
  v14 = ((__int64 (__fastcall *)(__int64, __int64, _OWORD *, __int64 *, _QWORD, _QWORD, _QWORD, __int64 *))NtAlpcSendWaitReceivePort)(
          v13,
          0x10000LL,
          v20,
          &v22,
