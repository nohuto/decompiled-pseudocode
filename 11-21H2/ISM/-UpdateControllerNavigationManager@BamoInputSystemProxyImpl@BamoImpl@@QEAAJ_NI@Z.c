/*
 * XREFs of ?UpdateControllerNavigationManager@BamoInputSystemProxyImpl@BamoImpl@@QEAAJ_NI@Z @ 0x180119FC0
 * Callers:
 *     ?Thunk_UpdateControllerNavigationManager_8@?$IInputSystemProxy_Receive@VBamoInputSystemProxyImpl@BamoImpl@@@@SAJPEAXPEAPEAX@Z @ 0x180118710 (-Thunk_UpdateControllerNavigationManager_8@-$IInputSystemProxy_Receive@VBamoInputSystemProxyImpl.c)
