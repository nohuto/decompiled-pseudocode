/*
 * XREFs of ??0SystemCursorShape2@@QEAA@V?$shared_ptr@VSystemCursorService2@@@std@@_K@Z @ 0x1800EB5B0
 * Callers:
 *     ??$?0V?$shared_ptr@VSystemCursorService2@@@std@@AEA_K@?$_Ref_count_obj2@VSystemCursorShape2@@@std@@QEAA@$$QEAV?$shared_ptr@VSystemCursorService2@@@1@AEA_K@Z @ 0x1800EA7DC (--$-0V-$shared_ptr@VSystemCursorService2@@@std@@AEA_K@-$_Ref_count_obj2@VSystemCursorShape2@@@st.c)
 * Callees:
