/*
 * XREFs of ?AllocateStub@BamoAsyncHRESULTPrincipal@@MEAAJPEAVBamoPeer@MPCManagerBamo_AutoBamos@@PEAPEAVBamoAsyncHRESULTStub@@@Z @ 0x18016FB00
 * Callers:
 *     <none>
 * Callees:
        ...
        struct BamoAsyncHRESULTStub **a3)
{
  ...
  *((_DWORD *)v4 + 8) = 0;
  ...
  v4[8] = 0LL;
  v4[9] = 0LL;
  v4[2] = &BamoImpl::BamoAsyncHRESULTStubImpl::`vftable';
  result = 0LL;
  *((_DWORD *)v4 + 6) = 1;
  *((_WORD *)v4 + 24) = 256;
