/*
 * XREFs of ?GetEdgyControllerServer@BamoInputSystemProxy@@UEAAPEAVBamoEdgyControllerServerProxy@@XZ @ 0x180109BC0
 * Callers:
 *     <none>
 * Callees:
        ...
        BamoInputSystemProxy *this)
{
  ...
  return (struct BamoEdgyControllerServerProxy *)*((_QWORD *)this + 9);
}
