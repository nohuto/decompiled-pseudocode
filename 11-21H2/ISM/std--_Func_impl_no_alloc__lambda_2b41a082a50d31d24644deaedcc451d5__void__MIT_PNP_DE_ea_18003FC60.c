/*
 * XREFs of std::_Func_impl_no_alloc__lambda_2b41a082a50d31d24644deaedcc451d5__void__MIT_PNP_DEVICE_NOTIFICATION_MESSAGE_const___::_Do_call @ 0x18003FC60
 * Callers:
 *     <none>
 * Callees:
...
{
  const struct _MIT_PNP_DEVICE_NOTIFICATION_MESSAGE *v3; // rdi
  __int64 v4; // rcx
  __int64 v5; // rcx
  __int64 v6; // rcx
  ...
  v3 = *a2;
  v8 = "MITEP_PNP_DEVICE_NOTIFICATION";
  ActivityId = 0LL;
  v10 = 0LL;
  v11 = 0LL;
