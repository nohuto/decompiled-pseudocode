/*
 * XREFs of ?RuntimeClassInitialize@PTPProcessor@@QEAAJPEAUDeviceInfo@@PEAUIInputProcessorHost@@@Z @ 0x1801CC95C
 * Callers:
        ...
        struct IInputProcessorHost *a3)
{
  ...
  *((_DWORD *)a2 + 1) |= 6u;
  ...
  ChildInputProcessor = CreateChildInputProcessor(2, v7, (__int64)this + 16);
...
LABEL_3:
  ...
  ChildInputProcessor = CreateChildInputProcessor(4, v7, (__int64)this + 24);
  if ( ChildInputProcessor < 0 )
  {
    v5 = 60LL;
    goto LABEL_3;
