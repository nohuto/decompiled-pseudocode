/*
 * XREFs of ?GetEdgyDragSourceClient@BamoInputSiteElementProxy@@UEAAPEAVBamoEdgyDragSourceClientProxy@@XZ @ 0x18000DFC0
 * Callers:
 *     <none>
 * Callees:
        ...
        BamoInputSiteElementProxy *this)
{
  ...
  return (struct BamoEdgyDragSourceClientProxy *)*((_QWORD *)this + 21);
}
