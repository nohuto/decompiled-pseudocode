/*
 * XREFs of ?CreateCursorShape@BamoSystemCursorControllerProxyImpl@BamoImpl@@QEAAJ_K0PEBUCursorBitmapDataHeader@@IPEBEI@Z @ 0x180107908
 * Callers:
        ...
        const struct CursorBitmapDataHeader *a4)
{
  ...
  else
  {
    ...
    if ( v7 >= 0 )
    {
      ...
      return CoreUICallSend(v9, v11, 2LL, 84LL);
    }
    else
    {
      wil::details::in1diag3::Return_Hr(
