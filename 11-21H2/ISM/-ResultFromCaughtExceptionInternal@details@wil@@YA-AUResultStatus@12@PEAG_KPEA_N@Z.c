/*
 * XREFs of ?ResultFromCaughtExceptionInternal@details@wil@@YA?AUResultStatus@12@PEAG_KPEA_N@Z @ 0x18007DAD0
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall wil::details::ResultFromCaughtExceptionInternal(__int64 a1, _WORD *a2, __int64 a3, _BYTE *a4)
{
  ...
  wchar_t *v25; // [rsp+98h] [rbp+10h]
  const struct wil::ResultException *v26; // [rsp+98h] [rbp+10h]
  wchar_t *v27; // [rsp+98h] [rbp+10h]
  wchar_t *v28; // [rsp+98h] [rbp+10h]
