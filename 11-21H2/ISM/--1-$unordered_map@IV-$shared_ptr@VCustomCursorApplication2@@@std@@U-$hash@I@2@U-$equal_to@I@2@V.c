/*
 * XREFs of ??1?$unordered_map@IV?$shared_ptr@VCustomCursorApplication2@@@std@@U?$hash@I@2@U?$equal_to@I@2@V?$allocator@U?$pair@$$CBIV?$shared_ptr@VCustomCursorApplication2@@@std@@@std@@@2@@std@@QEAA@XZ @ 0x1800BEB84
 * Callers:
 *     _SpatialRimDeviceCollection::SpatialRimDeviceCollection_::_1_::dtor$7 @ 0x180055B4E (_SpatialRimDeviceCollection--SpatialRimDeviceCollection_--_1_--dtor$7.c)
 *     _SystemCursorService2::SystemCursorService2_::_1_::dtor$3 @ 0x1800EB58A (_SystemCursorService2--SystemCursorService2_--_1_--dtor$3.c)
 *     _SystemCursorService2::SystemCursorService2_::_1_::dtor$4 @ 0x1800EB59A (_SystemCursorService2--SystemCursorService2_--_1_--dtor$4.c)
 * Callees:
