/*
 * XREFs of ?ConfigureRecognizer@EdgyProcessorTarget@@AEAAJXZ @ 0x1801ACBD8
 * Callers:
 ...
 *     ?GetCandidateGestureParameters@EdgyImpl@@QEBA_NPEAIPEAW4OrientationBias@@@Z @ 0x1801AE404 (-GetCandidateGestureParameters@EdgyImpl@@QEBA_NPEAIPEAW4OrientationBias@@@Z.c)
 */
