/*
 * XREFs of ??1?$list@U?$pair@QEAXV?$vector@IV?$allocator@I@std@@@std@@@std@@V?$allocator@U?$pair@QEAXV?$vector@IV?$allocator@I@std@@@std@@@std@@@2@@std@@QEAA@XZ @ 0x1800DE2B4
 * Callers:
 *     _Win32kInterop::DeliverInputToAllTargets_::_1_::dtor$9 @ 0x1800DF528 (_Win32kInterop--DeliverInputToAllTargets_--_1_--dtor$9.c)
 * Callees:
