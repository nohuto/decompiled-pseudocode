/*
 * XREFs of ?TriggerHomeGesture@BamoMPCManagerProxyImpl@BamoImpl@@QEAAJW4InputType@@I@Z @ 0x18015ED7C
 * Callers:
...
__int64 __fastcall BamoImpl::BamoMPCManagerProxyImpl::TriggerHomeGesture(
        __int64 a1,
        __int64 a2,
        __int64 a3,
        const char *a4)
