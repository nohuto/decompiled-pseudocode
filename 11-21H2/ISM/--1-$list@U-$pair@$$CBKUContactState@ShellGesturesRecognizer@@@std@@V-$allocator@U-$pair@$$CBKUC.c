/*
 * XREFs of ??1?$list@U?$pair@$$CBKUContactState@ShellGesturesRecognizer@@@std@@V?$allocator@U?$pair@$$CBKUContactState@ShellGesturesRecognizer@@@std@@@2@@std@@QEAA@XZ @ 0x180150A30
 * Callers:
 *     _ShellGesturesRecognizer::ShellGesturesRecognizer_::_1_::dtor$17 @ 0x180150A0A (_ShellGesturesRecognizer--ShellGesturesRecognizer_--_1_--dtor$17.c)
 * Callees:
