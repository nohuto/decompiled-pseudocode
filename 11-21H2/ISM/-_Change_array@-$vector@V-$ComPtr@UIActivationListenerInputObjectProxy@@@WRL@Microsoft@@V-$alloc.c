/*
 * XREFs of ?_Change_array@?$vector@V?$ComPtr@UIActivationListenerInputObjectProxy@@@WRL@Microsoft@@V?$allocator@V?$ComPtr@UIActivationListenerInputObjectProxy@@@WRL@Microsoft@@@std@@@std@@AEAAXQEAV?$ComPtr@UIActivationListenerInputObjectProxy@@@WRL@Microsoft@@_K1@Z @ 0x1800E6CAC
 * Callers:
