/*
 * XREFs of ?TryGetDockInputReport@DockDevice@@QEAAJPEAUGetInputReportResult@@@Z @ 0x1800CDC58
 * Callers:
...
__int64 __fastcall DockDevice::TryGetDockInputReport(DockDevice *this, struct GetInputReportResult *a2)
{
  ...
  _BYTE *v16; // [rsp+58h] [rbp-80h] BYREF
  ...
  if ( SpecificButtonCaps >= 0 )
  {
    ...
    *v9 = ButtonCaps.ReportID;
    ...
    v15 = 0;
    v16 = v9;
    v12 = NtRIMDeviceIoControl(v11, v10, 721314LL, 0LL, 0, v9, v8, &v15, 0);
    v13 = v12;
    if ( v12 >= 0 )
    {
