/*
 * XREFs of ?OnTouch@ClickRecognizer@@AEAAXPEBVGestureSession@@KKPEBUTouchContactInfo@@@Z @ 0x1801B6C78
 * Callers:
 ...
 * Callees:
 *     ?CancelTapAndHold@ClickRecognizer@@AEAAXXZ @ 0x1801B6950 (-CancelTapAndHold@ClickRecognizer@@AEAAXXZ.c)
 *     ?ChangeTapAndHoldState@ClickRecognizer@@AEAAJPEAK@Z @ 0x1801B6994 (-ChangeTapAndHoldState@ClickRecognizer@@AEAAJPEAK@Z.c)
