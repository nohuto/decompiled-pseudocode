/*
 * XREFs of ?Initialize@?$KernelInputConnection@UMIT_INPUTSTREAM_ENDED_MESSAGE@@@@QEAAXAEBV?$ComPtr@UIMessageSession@@@WRL@Microsoft@@W4_MIT_ENDPOINT@@V?$function@$$A6AXPEBUMIT_INPUTSTREAM_ENDED_MESSAGE@@@Z@std@@@Z @ 0x180045F0C
 * Callers:
  ...
  if ( !*(_BYTE *)ISMTestMode::s_instance )
  {
    ...
    if ( v21 < 0 )
      wil::details::in1diag3::FailFast_Hr(
        ...
        v25);
    v22 = NtMITCoreMsgKOpenConnectionTo(20LL, a1 + 3);
    if ( v22 < 0 )
