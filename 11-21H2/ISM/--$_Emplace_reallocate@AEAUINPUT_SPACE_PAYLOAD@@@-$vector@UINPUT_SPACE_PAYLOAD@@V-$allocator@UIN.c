/*
 * XREFs of ??$_Emplace_reallocate@AEAUINPUT_SPACE_PAYLOAD@@@?$vector@UINPUT_SPACE_PAYLOAD@@V?$allocator@UINPUT_SPACE_PAYLOAD@@@std@@@std@@QEAAPEAUINPUT_SPACE_PAYLOAD@@QEAU2@AEAU2@@Z @ 0x180086D3C
 * Callers:
 ...
 *     ?_Change_array@?$vector@UINPUT_SPACE_PAYLOAD@@V?$allocator@UINPUT_SPACE_PAYLOAD@@@std@@@std@@AEAAXQEAUINPUT_SPACE_PAYLOAD@@_K1@Z @ 0x180088D64 (-_Change_array@-$vector@UINPUT_SPACE_PAYLOAD@@V-$allocator@UINPUT_SPACE_PAYLOAD@@@std@@@std@@AEA.c)
 */
        ...
        __int64 a3)
{
  ...
  try
  {
    ...
    *((_QWORD *)v13 + 2) = *(_QWORD *)(a3 + 16);
    ...
    std::vector<INPUT_SPACE_PAYLOAD>::_Change_array(a1, v12, v8, v9);
    result = v13;
  }
  catch ( ... )
  {
