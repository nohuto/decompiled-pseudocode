/*
 * XREFs of ?OnExclusiveModeStateChangedInputThread@MPCInputRouter@@AEAAXXZ @ 0x1800F172C
 * Callers:
 *     _lambda_ec705bf725d52d27b1686ede0253a48a_::_lambda_invoker_cdecl_ @ 0x1800EE860 (_lambda_ec705bf725d52d27b1686ede0253a48a_--_lambda_invoker_cdecl_.c)
    ...
    *((_QWORD *)this + 112) = *((_QWORD *)this + 110);
    ...
    if ( *((_BYTE *)this + 888) )
    {
      ...
      else
      {
        ...
        v12 = DWMInputRouter::CreateAndRegisterTarget(this, *((_DWORD *)this + 223), 0, ViewIdFromWindowId, v9, &v26);
        if ( v12 < 0 )
        ...
        Microsoft::WRL::ComPtr<IMPCFocusTarget>::Attach(v2, (v19 + 64) & -(__int64)(v19 != 0));
        if ( (v16 & 1) != 0 )
        {
          v20 = v27;
          if ( v27 )
