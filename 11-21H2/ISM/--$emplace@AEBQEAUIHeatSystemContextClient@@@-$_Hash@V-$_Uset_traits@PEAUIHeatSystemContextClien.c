        ...
        unsigned __int8 *a3)
{
  ...
  else
  {
    ...
    if ( (float)(v10 / v12) > *a1 )
    {
      ...
      v15 = *(_OWORD *)std::_Hash<std::_Uset_traits<IHeatSystemContextClient *,std::_Uhash_compare<IHeatSystemContextClient *,std::hash<IHeatSystemContextClient *>,std::equal_to<IHeatSystemContextClient *>>,std::allocator<IHeatSystemContextClient *>,0>>::_Find_last<IHeatSystemContextClient *>(
                         a1,
                         &v16,
                         v8 + 2,
                         appended);
