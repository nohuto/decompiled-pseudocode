/*
 * XREFs of ?SpatialInteractionDLL_Loaded_@RawInputProvidersTracing@@QEAAXXZ @ 0x1800C2ACC
 * Callers:
...
void __fastcall RawInputProvidersTracing::SpatialInteractionDLL_Loaded_(RawInputProvidersTracing *this)
{
    ...
    && (*(_QWORD *)(v1 + 24) & 0x400000000000LL) == *(_QWORD *)(v1 + 24) )
  {
    ...
    v2 = 0x1000000LL;
    v5 = 8;
    tlgWriteTransfer_EventWriteTransfer(v1, (unsigned __int8 *)dword_180202133, 0LL, 0LL, 3u, &v3);
  }
}
