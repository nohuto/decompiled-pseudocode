/*
 * XREFs of ?Thunk_RegisterInputProcess_8@?$IInputProcessManagerPrincipal_Receive@VBamoInputProcessManagerPrincipalImpl@BamoImpl@@@@SAJPEAXPEAPEAX@Z @ 0x180196C20
 * Callers:
 *     <none>
 * Callees:
 *     <none>
