/*
 * XREFs of _LampArrayDevice::Initialize_::_1_::catch$2 @ 0x1800D20B8
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall LampArrayDevice::Initialize_::_1_::catch_2(__int64 a1, __int64 a2, __int64 a3, const char *a4)
{
