/*
 * XREFs of ?EnsureBamoCallbacks@MPCConstantManagerClient@@AEAAJXZ @ 0x1801679A8
 * Callers:
 *     ?add_ConstantChanged@MPCConstantManagerClient@@UEAAJPEAU?$ITypedEventHandler@PEAVMPCConstantManagerClient@MPCManager@Input@Internal@Windows@@PEAVConstantChangedEventArgs@2345@@Foundation@Windows@@PEAUEventRegistrationToken@@@Z @ 0x18016DD90 (-add_ConstantChanged@MPCConstantManagerClient@@UEAAJPEAU-$ITypedEventHandler@PEAVMPCConstantMana.c)
 * Callees:
 *     ?Return_Hr@in1diag3@details@wil@@YAXPEAXIPEBDJ@Z @ 0x180044BD0 (-Return_Hr@in1diag3@details@wil@@YAXPEAXIPEBDJ@Z.c)
 *     ??2@YAPEAX_K@Z @ 0x18004AF08 (--2@YAPEAX_K@Z.c)
 *     _guard_xfg_dispatch_icall_nop @ 0x18004E9E0 (_guard_xfg_dispatch_icall_nop.c)
 *     ??0MPCConstantManagerClientPrincipal@@QEAA@PEAVMPCManagerClientConnection@@PEAVMPCConstantManagerClient@@@Z @ 0x180170210 (--0MPCConstantManagerClientPrincipal@@QEAA@PEAVMPCManagerClientConnection@@PEAVMPCConstantManage.c)
 */
...
__int64 __fastcall MPCConstantManagerClient::EnsureBamoCallbacks(struct MPCManagerClientConnection **this)
{
  ...
  if ( *((_QWORD *)this[4] + 29) )
  {
    if ( !this[5] )
    {
      ...
      v5 = (*(__int64 (__fastcall **)(_QWORD))(**((_QWORD **)this[4] + 29) + 88LL))(*((_QWORD *)this[4] + 29));
