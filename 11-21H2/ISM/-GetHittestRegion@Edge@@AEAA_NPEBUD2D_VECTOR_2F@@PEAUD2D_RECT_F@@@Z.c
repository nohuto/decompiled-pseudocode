/*
 * XREFs of ?GetHittestRegion@Edge@@AEAA_NPEBUD2D_VECTOR_2F@@PEAUD2D_RECT_F@@@Z @ 0x1801AB6EC
 * Callers:
 *     ?HitTest@Edge@@QEAA_NKKPEBUD2D_VECTOR_2F@@@Z @ 0x1801AB868 (-HitTest@Edge@@QEAA_NKKPEBUD2D_VECTOR_2F@@@Z.c)
 * Callees:
 *     <none>
 */
...
bool __fastcall Edge::GetHittestRegion(Edge *this, const struct D2D_VECTOR_2F *a2, struct D2D_RECT_F *a3)
{
  ...
  float v10; // xmm0_4
  float v11; // xmm3_4
  struct D2D_RECT_F v12; // [rsp+0h] [rbp-18h]
