/*
 * XREFs of ??$_Emplace_reallocate@AEAUINPUT_SPACE_REGION@@@?$vector@UINPUT_SPACE_REGION@@V?$allocator@UINPUT_SPACE_REGION@@@std@@@std@@QEAAPEAUINPUT_SPACE_REGION@@QEAU2@AEAU2@@Z @ 0x18018301C
 * Callers:
 ...
 *     ?_Change_array@?$vector@UINPUT_SPACE_REGION@@V?$allocator@UINPUT_SPACE_REGION@@@std@@@std@@AEAAXQEAUINPUT_SPACE_REGION@@_K1@Z @ 0x180184ED8 (-_Change_array@-$vector@UINPUT_SPACE_REGION@@V-$allocator@UINPUT_SPACE_REGION@@@std@@@std@@AEAAX.c)
 */
        ...
        _OWORD *a3)
{
  ...
  try
  {
    ...
    *((_QWORD *)v14 + 24) = *((_QWORD *)v15 + 8);
    ...
    std::vector<INPUT_SPACE_REGION>::_Change_array(a1, v13, v8, v10);
    result = v14;
  }
  catch ( ... )
  {
