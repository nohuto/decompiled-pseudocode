/*
 * XREFs of ??$_Emplace_reallocate@AEBUTouchInjectionContact@Input@Internal@UI@Windows@@@?$vector@UTouchInjectionContact@Input@Internal@UI@Windows@@V?$allocator@UTouchInjectionContact@Input@Internal@UI@Windows@@@std@@@std@@QEAAPEAUTouchInjectionContact@Input@Internal@UI@Windows@@QEAU23456@AEBU23456@@Z @ 0x180197664
 * Callers:
 ...
 *     ?_Change_array@?$vector@UTouchInjectionContact@Input@Internal@UI@Windows@@V?$allocator@UTouchInjectionContact@Input@Internal@UI@Windows@@@std@@@std@@AEAAXQEAUTouchInjectionContact@Input@Internal@UI@Windows@@_K1@Z @ 0x180198390 (-_Change_array@-$vector@UTouchInjectionContact@Input@Internal@UI@Windows@@V-$allocator@UTouchInj.c)
 */

char *__fastcall std::vector<Windows::UI::Internal::Input::TouchInjectionContact>::_Emplace_reallocate<Windows::UI::Internal::Input::TouchInjectionContact const &>(
        const void **a1,
        _BYTE *a2,
        _OWORD *a3)
{
  ...
  try
  {
    ...
    *(_OWORD *)v15 = *a3;
    ...
    std::vector<Windows::UI::Internal::Input::TouchInjectionContact>::_Change_array(a1, v14, v9, v8);
    result = v15;
  }
  catch ( ... )
  {
