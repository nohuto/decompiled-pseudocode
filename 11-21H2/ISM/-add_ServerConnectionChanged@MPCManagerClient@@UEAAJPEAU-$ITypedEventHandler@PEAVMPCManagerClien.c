/*
 * XREFs of ?add_ServerConnectionChanged@MPCManagerClient@@UEAAJPEAU?$ITypedEventHandler@PEAVMPCManagerClient@MPCManager@Input@Internal@Windows@@PEAVServerConnectionArgs@2345@@Foundation@Windows@@PEAUEventRegistrationToken@@@Z @ 0x18015F2B0
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall MPCManagerClient::add_ServerConnectionChanged(__int64 a1, struct IUnknown *a2, struct IUnknown **a3)
{
  ...
  if ( a2 )
  {
    ...
    if ( v5 >= 0 )
    {
      v11 = *(_QWORD *)(*(_QWORD *)(a1 + 1592) + 232LL) != 0LL;
