/*
 * XREFs of ?SetConstant@MPCConstantManager@@UEAAJPEAVBamoMPCConstantManagerClientStub@@W4InputType@@PEBGAEBUtagPROPVARIANT@@PEAVBamoAsyncHRESULTProxy@@@Z @ 0x1800964C0
 * Callers:
 *     <none>
 * Callees:
        ...
        __int64 a6)
{
  ...
  if ( *(_WORD *)propvarIn >= 4u )
  {
    if ( *(_WORD *)propvarIn <= 5u )
    {
      ...
      v17 = *(_QWORD *)(a6 + 8);
      v21.m128i_i64[0] = a4;
      v12 = *(__int64 (__fastcall **)(__int64, _QWORD))(v17 + 24);
      *(float *)&v18 = pdblRet[0];
      do
        ++v11;
    ...
    if ( *(_WORD *)propvarIn == 11 )
    {
      ...
      v21.m128i_i64[0] = a4;
      v11 = -1LL;
      v12 = *(__int64 (__fastcall **)(__int64, _QWORD))(*(_QWORD *)(a6 + 8) + 24LL);
      do
        ++v11;
      while ( *(_WORD *)(a4 + 2 * v11) );
      goto LABEL_9;
...
LABEL_9:
      v21.m128i_i64[1] = v11;
      v13 = MPCConstantManager::ChangeConstant(a1, a3, &v21, v18);
