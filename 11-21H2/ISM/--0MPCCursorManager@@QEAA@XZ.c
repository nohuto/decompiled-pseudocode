/*
 * XREFs of ??0MPCCursorManager@@QEAA@XZ @ 0x1800A4DCC
 * Callers:
 ...
 *     ?IsHyperVGuestOS@@YA_NXZ @ 0x1800A507C (-IsHyperVGuestOS@@YA_NXZ.c)
 *     ?reset@?$unique_storage@U?$resource_policy@PEAUHINSTANCE__@@P6AHPEAU1@@Z$1?FreeLibrary@@YAH0@ZU?$integral_constant@_K$0A@@wistd@@PEAU1@PEAU1@$0A@$$T@details@wil@@@details@wil@@QEAAXPEAUHINSTANCE__@@@Z @ 0x1800A5750 (-reset@-$unique_storage@U-$resource_policy@PEAUHINSTANCE__@@P6AHPEAU1@@Z$1-FreeLibrary@@YAH0@ZU-.c)
 */
