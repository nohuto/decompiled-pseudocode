/*
 * XREFs of ??$_Emplace_reallocate@AEBUDragInfoStruct@@@?$vector@UDragInfoStruct@@V?$allocator@UDragInfoStruct@@@std@@@std@@QEAAPEAUDragInfoStruct@@QEAU2@AEBU2@@Z @ 0x18013B970
 * Callers:
 ...
 *     ??$_Get_size_of_n@$0CA@@std@@YA_K_K@Z @ 0x18003BDC0 (--$_Get_size_of_n@$0CA@@std@@YA_K_K@Z.c)
 *     memmove_0 @ 0x18004E99F (memmove_0.c)
 *     ?_Change_array@?$vector@UDragInfoStruct@@V?$allocator@UDragInfoStruct@@@std@@@std@@AEAAXQEAUDragInfoStruct@@_K1@Z @ 0x180141F14 (-_Change_array@-$vector@UDragInfoStruct@@V-$allocator@UDragInfoStruct@@@std@@@std@@AEAAXQEAUDrag.c)
 */
