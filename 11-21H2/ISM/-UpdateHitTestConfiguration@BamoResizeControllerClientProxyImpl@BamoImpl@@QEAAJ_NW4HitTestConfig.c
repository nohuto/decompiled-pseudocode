/*
 * XREFs of ?UpdateHitTestConfiguration@BamoResizeControllerClientProxyImpl@BamoImpl@@QEAAJ_NW4HitTestConfiguration@Input@Internal@UI@Windows@@@Z @ 0x18011BF5C
 * Callers:
 *     ?Thunk_UpdateHitTestConfiguration_16@?$IResizeControllerClientProxy_Receive@VBamoResizeControllerClientProxyImpl@BamoImpl@@@@SAJPEAXPEAPEAX@Z @ 0x1801189D0 (-Thunk_UpdateHitTestConfiguration_16@-$IResizeControllerClientProxy_Receive@VBamoResizeControlle.c)
