/*
 * XREFs of ?SendHapticFeedbackForPlayCount@BamoSimpleHapticsControllerPrincipalImpl@BamoImpl@@QEAAJGMII@Z @ 0x18018E624
 * Callers:
 *     ?Thunk_SendHapticFeedbackForPlayCount_320@?$ISimpleHapticsControllerPrincipal_Receive@VBamoSimpleHapticsControllerPrincipalImpl@BamoImpl@@@@SAJPEAXPEAPEAX@Z @ 0x18018F170 (-Thunk_SendHapticFeedbackForPlayCount_320@-$ISimpleHapticsControllerPrincipal_Receive@VBamoSimpl.c)
 * Callees:
        ...
        int a4)
{
  ...
  Microsoft::BamoImpl::CalloutWrapper<BamoImpl::BamoSimpleHapticsControllerPrincipalImpl>::CalloutWrapper<BamoImpl::BamoSimpleHapticsControllerPrincipalImpl>(
    ...
    *(_QWORD *)(*(_QWORD *)(v7[5] + 24LL) + 32LL),
    (__int64)this);
  v10 = (*(__int64 (__fastcall **)(char *, __int64, _QWORD))(*((_QWORD *)this - 2) + 112LL))((char *)this - 16, v9, a2);
  v11 = v10;
