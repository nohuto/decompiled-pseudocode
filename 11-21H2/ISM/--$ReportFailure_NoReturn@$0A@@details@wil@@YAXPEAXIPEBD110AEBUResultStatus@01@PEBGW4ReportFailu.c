/*
 * XREFs of ??$ReportFailure_NoReturn@$0A@@details@wil@@YAXPEAXIPEBD110AEBUResultStatus@01@PEBGW4ReportFailureOptions@01@@Z @ 0x180090108
 * Callers:
 ...
 *     ?ThrowResultException@wil@@YAXAEBUFailureInfo@1@@Z @ 0x18007E850 (-ThrowResultException@wil@@YAXAEBUFailureInfo@1@@Z.c)
        ...
        int *a7)
{
  ...
  if ( v22 >= 0 )
    wil::details::in1diag3::FailFastImmediate_Unexpected(v17);
