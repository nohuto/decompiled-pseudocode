/*
 * XREFs of ??_EBamoDockDevicePrincipalImpl@BamoImpl@@UEAAPEAXI@Z @ 0x18017CD70
 * Callers:
 *     <none>
 * Callees:
...
wil::details **__fastcall BamoImpl::BamoDockDevicePrincipalImpl::`vector deleting destructor'(
        wil::details **this,
        void *a2)
{
  char v2; // di
