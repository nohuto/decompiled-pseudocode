/*
 * XREFs of ?StartAnimation@BamoDragProcessorManagerPrincipalImpl@BamoImpl@@QEAAJIIW4DragProcessorType@@@Z @ 0x18013ABAC
 * Callers:
 *     ?Thunk_StartAnimation_149@?$IDragProcessorManagerPrincipal_Receive@VBamoDragProcessorManagerPrincipalImpl@BamoImpl@@@@SAJPEAXPEAPEAX@Z @ 0x18013AFA0 (-Thunk_StartAnimation_149@-$IDragProcessorManagerPrincipal_Receive@VBamoDragProcessorManagerPrin.c)
 * Callees:
...
__int64 __fastcall BamoImpl::BamoDragProcessorManagerPrincipalImpl::StartAnimation(
        __int64 a1,
        unsigned int a2,
        unsigned int a3,
        int a4)
{
  ...
  Microsoft::BamoImpl::CalloutWrapper<BamoImpl::BamoDragProcessorManagerPrincipalImpl>::CalloutWrapper<BamoImpl::BamoDragProcessorManagerPrincipalImpl>(
    ...
    v13,
    a1);
  v18 = (*(__int64 (__fastcall **)(__int64, __int64, _QWORD, char *))(*(_QWORD *)(a1 - 16) + 112LL))(
          a1 - 16,
          v10,
          a2,
          v15);
