/*
 * XREFs of ?_Tidy@?$list@UCallbackData@CallOnThreadExit@@V?$allocator@UCallbackData@CallOnThreadExit@@@std@@@std@@AEAAXXZ @ 0x180049708
 * Callers:
 *     CallOnThreadExit::_dynamic_atexit_destructor_for__s_callbacks__ @ 0x180058CF0 (CallOnThreadExit--_dynamic_atexit_destructor_for__s_callbacks__.c)
 * Callees:
