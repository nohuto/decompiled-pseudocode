/*
 * XREFs of ?InitializeProxyThunk@BamoSimpleHapticsControllerStubImpl@BamoImpl@@UEAAJXZ @ 0x18018D470
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall BamoImpl::BamoSimpleHapticsControllerStubImpl::InitializeProxyThunk(
