/*
 * XREFs of ?UpdateSizeValid@BamoVirtualTouchpadControllerProxyImpl@BamoImpl@@QEAAJ_N0@Z @ 0x18012BD48
 * Callers:
 *     ?Thunk_UpdateSizeValid_11@?$IVirtualTouchpadControllerProxy_Receive@VBamoVirtualTouchpadControllerProxyImpl@BamoImpl@@@@SAJPEAXPEAPEAX@Z @ 0x18012B6A0 (-Thunk_UpdateSizeValid_11@-$IVirtualTouchpadControllerProxy_Receive@VBamoVirtualTouchpadControll.c)
