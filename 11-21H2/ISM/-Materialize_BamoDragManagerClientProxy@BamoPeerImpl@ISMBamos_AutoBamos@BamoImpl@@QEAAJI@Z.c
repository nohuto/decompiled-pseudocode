/*
 * XREFs of ?Materialize_BamoDragManagerClientProxy@BamoPeerImpl@ISMBamos_AutoBamos@BamoImpl@@QEAAJI@Z @ 0x18010B898
 * Callers:
 *     ?Thunk_Materialize_BamoDragManagerClientProxy_5@?$IBamoPeer_ISMBamos_AutoBamos_Receive@VBamoPeerImpl@ISMBamos_AutoBamos@BamoImpl@@@@SAJPEAXPEAPEAX@Z @ 0x180117E70 (-Thunk_Materialize_BamoDragManagerClientProxy_5@-$IBamoPeer_ISMBamos_AutoBamos_Receive@VBamoPeer.c)
 * Callees:
        ...
        unsigned int a2)
{
  ...
  *v10 = &BamoDragManagerClientProxy::`vftable'{for `Microsoft::Bamo::BamoProxy'};
  v10[1] = &BamoDragManagerClientProxy::`vftable'{for `IDragManagerClientProxy'};
  *((_DWORD *)v10 + 6) = 0;
  v10[4] = 0LL;
  *((_DWORD *)v10 + 10) = 0;
  *((_DWORD *)v10 + 11) = 0;
  v10[2] = &BamoImpl::BamoDragManagerClientProxyImpl::`vftable';
  *((_OWORD *)v10 + 3) = 0LL;
