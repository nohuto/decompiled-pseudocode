/*
 * XREFs of ?QueryInterface@TipToGlassProcessor@@UEAAJAEBU_GUID@@PEAPEAX@Z @ 0x180035960
 * Callers:
 *     ?QueryInterface@TipToGlassProcessor@@W7EAAJAEBU_GUID@@PEAPEAX@Z @ 0x180053B00 (-QueryInterface@TipToGlassProcessor@@W7EAAJAEBU_GUID@@PEAPEAX@Z.c)
 * Callees:
...
LABEL_6:
    ...
    {
      (*(void (__fastcall **)(TipToGlassProcessor *))(*(_QWORD *)this + 8LL))(this);
      v4 = (TipToGlassProcessor *)((char *)v4 + 8);
      goto LABEL_6;
    }
    return 2147500034LL;
  }
