/*
 * XREFs of ?OnGamepadIsSupportedForProcess@BamoMPCManagerClientPrincipalImpl@BamoImpl@@QEAAJI@Z @ 0x18015FC3C
 * Callers:
 *     ?Thunk_OnGamepadIsSupportedForProcess_25@?$IMPCManagerClientPrincipal_Receive@VBamoMPCManagerClientPrincipalImpl@BamoImpl@@@@SAJPEAXPEAPEAX@Z @ 0x1801608F0 (-Thunk_OnGamepadIsSupportedForProcess_25@-$IMPCManagerClientPrincipal_Receive@VBamoMPCManagerCli.c)
 * Callees:
        ...
        unsigned int a2)
{
  ...
  Microsoft::BamoImpl::CalloutWrapper<Microsoft::BamoImpl::CalloutWrapperObject>::CalloutWrapper<Microsoft::BamoImpl::CalloutWrapperObject>(
    ...
    *(_QWORD *)(*(_QWORD *)(v4[5] + 24LL) + 32LL),
    v7,
    0);
  v8 = (*(__int64 (__fastcall **)(char *, __int64, _QWORD))(*((_QWORD *)this - 2) + 104LL))((char *)this - 16, v6, a2);
  v12 = v8;
