        ...
        __int64 a14)
{
  ...
  unsigned __int16 *v20; // [rsp+50h] [rbp-A9h]
  ...
  v21 = v15;
  v22 = 0;
  return tlgWriteTransfer_EventWriteTransfer((__int64)&dword_180240410, a2, 0LL, 0LL, 0xCu, &v19);
}
