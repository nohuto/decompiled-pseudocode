/*
 * XREFs of ?QueryInterface@EdgyProcessor@@UEAAJAEBU_GUID@@PEAPEAX@Z @ 0x18014AF10
 * Callers:
 *     ?QueryInterface@EdgyProcessor@@W7EAAJAEBU_GUID@@PEAPEAX@Z @ 0x180050F60 (-QueryInterface@EdgyProcessor@@W7EAAJAEBU_GUID@@PEAPEAX@Z.c)
 * Callees:
