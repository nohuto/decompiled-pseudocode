/*
 * XREFs of ?OnDisconnectedThunk@BamoAsyncResult_string_StubImpl@BamoImpl@@UEAAJXZ @ 0x18016F270
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall BamoImpl::BamoAsyncResult_string_StubImpl::OnDisconnectedThunk(
        BamoImpl::BamoAsyncResult_string_StubImpl *this,
        __int64 a2,
        __int64 a3)
{
  BamoImpl::BamoAsyncResult_string_StubImpl *v3; // rbx
  __int64 v4; // rdi
  __int64 v5; // rdx
  __int64 v6; // r8
  const char *v7; // r9
