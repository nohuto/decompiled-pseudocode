/*
 * XREFs of ??$_Uninitialized_move@PEAV?$ComPtr@VInputSite@@@WRL@Microsoft@@V?$allocator@V?$ComPtr@VInputSite@@@WRL@Microsoft@@@std@@@std@@YAPEAV?$ComPtr@VInputSite@@@WRL@Microsoft@@QEAV123@0PEAV123@AEAV?$allocator@V?$ComPtr@VInputSite@@@WRL@Microsoft@@@0@@Z @ 0x180123478
 * Callers:
...
__int64 *__fastcall std::_Uninitialized_move<Microsoft::WRL::ComPtr<InputSite> *,std::allocator<Microsoft::WRL::ComPtr<InputSite>>>(
        __int64 *a1,
        __int64 *a2,
        __int64 *a3)
{
  ...
  std::_Destroy_range<std::allocator<Microsoft::WRL::ComPtr<InputSite>>>(a3, a3);
  return a3;
}
