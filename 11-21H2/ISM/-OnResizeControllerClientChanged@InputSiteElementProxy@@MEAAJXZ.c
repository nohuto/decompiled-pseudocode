/*
 * XREFs of ?OnResizeControllerClientChanged@InputSiteElementProxy@@MEAAJXZ @ 0x1800083D0
 * Callers:
 *     <none>
 * Callees:
        ...
        const char *a4)
{
  ...
  for ( i = *(_QWORD *)(v5 + 488); i != v6; i += 16LL )
  {
    ...
    v12 = v11(v10, &GUID_617b5d65_289b_4c69_246f_c27f8ae6d5de, &v23) >= 0;
    if ( v9 == this && v12 )
      break;
  }
  if ( i != *(_QWORD *)(v7 + 8) )
  ...
  Microsoft::WRL::ComPtr<IContainerInfoInputObjectProxy>::InternalRelease(&v23);
  v13 = *((_QWORD *)this + 39);
  v14 = (*(__int64 (__fastcall **)(char *))(*((_QWORD *)this + 1) + 240LL))((char *)this + 8);
  if ( v14 )
  {
    v16 = v14 + 8;
    v22 = v14 + 8;
