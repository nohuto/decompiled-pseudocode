/*
 * XREFs of ?SetConfigValue@DragRecognizer@@UEAA_NPEBUGestureRecognizerConfigValue@@@Z @ 0x1801B77B0
 * Callers:
 *     <none>
 * Callees:
 *     ?RecomputeOrientationBiasPixels@DragRecognizer@@AEAAXXZ @ 0x1801B7694 (-RecomputeOrientationBiasPixels@DragRecognizer@@AEAAXXZ.c)
 */
