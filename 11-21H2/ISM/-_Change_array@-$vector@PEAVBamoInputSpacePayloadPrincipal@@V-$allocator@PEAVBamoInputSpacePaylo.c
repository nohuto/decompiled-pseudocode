/*
 * XREFs of ?_Change_array@?$vector@PEAVBamoInputSpacePayloadPrincipal@@V?$allocator@PEAVBamoInputSpacePayloadPrincipal@@@std@@@std@@AEAAXQEAPEAVBamoInputSpacePayloadPrincipal@@_K1@Z @ 0x180136FFC
 * Callers:
