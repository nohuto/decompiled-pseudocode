/*
 * XREFs of ?UpdateTouchpadEnabled@BamoShellGesturesClientProxyImpl@BamoImpl@@QEAAJ_N0@Z @ 0x18015014C
 * Callers:
 *     ?Thunk_UpdateTouchpadEnabled_11@?$IShellGesturesClientProxy_Receive@VBamoShellGesturesClientProxyImpl@BamoImpl@@@@SAJPEAXPEAPEAX@Z @ 0x18014FE70 (-Thunk_UpdateTouchpadEnabled_11@-$IShellGesturesClientProxy_Receive@VBamoShellGesturesClientProx.c)
