/*
 * XREFs of ?OnPropertiesRefreshedThunk@BamoMPCConstantManagerClientStubImpl@BamoImpl@@UEAAJXZ @ 0x180095DF0
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall BamoImpl::BamoMPCConstantManagerClientStubImpl::OnPropertiesRefreshedThunk(
        ...
        __int64 a3)
{
  BamoImpl::BamoMPCConstantManagerClientStubImpl *v3; // rbx
  __int64 v4; // rdi
  __int64 v5; // rdx
  __int64 v6; // r8
  const char *v7; // r9
  ...
  Microsoft::BamoImpl::CalloutWrapper<Microsoft::BamoImpl::CalloutWrapperObject>::CalloutWrapper<Microsoft::BamoImpl::CalloutWrapperObject>(
    ...
    *(_QWORD *)(*(_QWORD *)(*((_QWORD *)this + 5) + 24LL) + 32LL),
    a3,
    0);
  LODWORD(v3) = (*(__int64 (__fastcall **)(__int64, __int64))(*(_QWORD *)(v4 - 16) + 88LL))(v4 - 16, (__int64)v3 - 16);
  Microsoft::BamoImpl::CalloutWrapper<Microsoft::BamoImpl::CalloutWrapperObject>::~CalloutWrapper<Microsoft::BamoImpl::CalloutWrapperObject>(
    v9,
    v5,
    v6,
