/*
 * XREFs of ??0?$CalloutWrapper@VBamoSystemContextManagerProxyImpl@BamoImpl@@@BamoImpl@Microsoft@@QEAA@PEAVBaseBamoConnectionImpl@12@PEAVBamoSystemContextManagerProxyImpl@1@W4PrologEpilogConfig@12@@Z @ 0x18010452C
 * Callers:
