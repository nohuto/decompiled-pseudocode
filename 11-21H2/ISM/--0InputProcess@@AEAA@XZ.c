/*
 * XREFs of ??0InputProcess@@AEAA@XZ @ 0x1800B1580
 * Callers:
...
InputProcess *__fastcall InputProcess::InputProcess(InputProcess *this)
{
  ...
  *((_QWORD *)this + 4) = 0LL;
  ...
  {
    tlgWriteTransfer_EventWriteTransfer(v2, (unsigned __int8 *)dword_180201588, 0LL, 0LL, 2u, &v13);
  }
  ...
  *((_QWORD *)this + 4) = v4;
  Microsoft::WRL::ComPtr<AnimationDataProviderConnection>::InternalRelease(&v10);
  Microsoft::WRL::ComPtr<AnimationDataProviderConnection>::InternalRelease(v11);
  if ( !*((_QWORD *)this + 4) )
