/*
 * XREFs of ?UpdateCoordinateSystemForTick@MPCSpatialGestureRecognizerHandler@@AEAAJ_J@Z @ 0x1800ABF10
 * Callers:
 ...
 *     ??4?$ComPtr@UISpatialCoordinateSystem@Spatial@Perception@Windows@@@WRL@Microsoft@@QEAAAEAV012@AEBV012@@Z @ 0x1800A9890 (--4-$ComPtr@UISpatialCoordinateSystem@Spatial@Perception@Windows@@@WRL@Microsoft@@QEAAAEAV012@AE.c)
 */
        ...
        __int64 a2)
{
  ...
  if ( !*((_QWORD *)this + 14) )
  {
    ...
    if ( !v22 )
      wil::details::in1diag3::_FailFast_Unexpected(
        ...
        v10);
    v12 = *(__int64 (__fastcall **)(__int64, __int64 *))(*(_QWORD *)v22 + 96LL);
  ...
  if ( v16 >= 0 )
  {
    ...
    if ( v20 >= 0 )
    {
      Microsoft::WRL::ComPtr<Windows::Perception::Spatial::ISpatialCoordinateSystem>::operator=(
        (__int64 *)this + 16,
        &v24);
      v17 = 0;
    }
