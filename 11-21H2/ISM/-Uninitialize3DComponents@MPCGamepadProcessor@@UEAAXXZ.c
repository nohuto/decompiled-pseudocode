/*
 * XREFs of ?Uninitialize3DComponents@MPCGamepadProcessor@@UEAAXXZ @ 0x1801C6D00
 * Callers:
 *     <none>
 * Callees:
...
void __fastcall MPCGamepadProcessor::Uninitialize3DComponents(MPCGamepadProcessor *this)
{
  ...
  v1 = (void (__fastcall ***)(_QWORD, __int64))*((_QWORD *)this + 530);
  *((_QWORD *)this + 530) = 0LL;
  if ( v1 )
    std::default_delete<MPCButtonHoldHelper>::operator()((__int64)this, v1);
  v3 = (void (__fastcall ***)(_QWORD, __int64))*((_QWORD *)this + 531);
  *((_QWORD *)this + 531) = 0LL;
  if ( v3 )
