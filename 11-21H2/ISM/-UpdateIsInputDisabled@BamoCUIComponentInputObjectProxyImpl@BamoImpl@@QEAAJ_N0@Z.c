/*
 * XREFs of ?UpdateIsInputDisabled@BamoCUIComponentInputObjectProxyImpl@BamoImpl@@QEAAJ_N0@Z @ 0x18012741C
 * Callers:
 *     ?Thunk_UpdateIsInputDisabled_11@?$ICUIComponentInputObjectProxy_Receive@VBamoCUIComponentInputObjectProxyImpl@BamoImpl@@@@SAJPEAXPEAPEAX@Z @ 0x180127120 (-Thunk_UpdateIsInputDisabled_11@-$ICUIComponentInputObjectProxy_Receive@VBamoCUIComponentInputOb.c)
