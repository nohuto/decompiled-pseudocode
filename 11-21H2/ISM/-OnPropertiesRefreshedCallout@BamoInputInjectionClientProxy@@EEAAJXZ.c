/*
 * XREFs of ?OnPropertiesRefreshedCallout@BamoInputInjectionClientProxy@@EEAAJXZ @ 0x180198A70
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall BamoInputInjectionClientProxy::OnPropertiesRefreshedCallout(BamoInputInjectionClientProxy *this)
{
  ...
  Microsoft::BamoImpl::CalloutWrapper<BamoImpl::BamoInputInjectionClientProxyImpl>::CalloutWrapper<BamoImpl::BamoInputInjectionClientProxyImpl>(
    ...
    *(_QWORD *)(*(_QWORD *)(*((_QWORD *)this + 4) + 24LL) + 32LL),
    (__int64)this + 16);
  LODWORD(v1) = (*(__int64 (__fastcall **)(BamoInputInjectionClientProxy *))(*(_QWORD *)v1 + 48LL))(v1);
