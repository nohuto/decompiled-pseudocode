/*
 * XREFs of ??1CallbackData@CallOnThreadExit@@QEAA@XZ @ 0x18012635C
 * Callers:
 *     ?_Tidy@?$list@UCallbackData@CallOnThreadExit@@V?$allocator@UCallbackData@CallOnThreadExit@@@std@@@std@@AEAAXXZ @ 0x180049708 (-_Tidy@-$list@UCallbackData@CallOnThreadExit@@V-$allocator@UCallbackData@CallOnThreadExit@@@std@.c)
...
void __fastcall CallOnThreadExit::CallbackData::~CallbackData(CallOnThreadExit::CallbackData *this)
{
  ...
  std::_Func_class<void,>::_Tidy((__int64)this, v2);
}
