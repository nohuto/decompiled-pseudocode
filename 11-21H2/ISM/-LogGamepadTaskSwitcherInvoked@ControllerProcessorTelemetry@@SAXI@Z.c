/*
 * XREFs of ?LogGamepadTaskSwitcherInvoked@ControllerProcessorTelemetry@@SAXI@Z @ 0x18017B664
 * Callers:
...
void __fastcall ControllerProcessorTelemetry::LogGamepadTaskSwitcherInvoked(__int64 a1)
{
    ...
    && (*(_QWORD *)(v2 + 24) & 0x400000000000LL) == *(_QWORD *)(v2 + 24) )
  {
    ...
    v3 = v1;
    v6 = 4;
    tlgWriteTransfer_EventWriteTransfer(v2, (unsigned __int8 *)dword_180205F4B, 0LL, 0LL, 3u, &v4);
  }
}
