/*
 * XREFs of ?OnInputProviderChanged@BamoMPCManagerClientPrincipalImpl@BamoImpl@@QEAAJPEBULegacyDeviceInfo@@W4MPCSourceKind@@@Z @ 0x180160050
 * Callers:
 *     ?Thunk_OnInputProviderChanged_47@?$IMPCManagerClientPrincipal_Receive@VBamoMPCManagerClientPrincipalImpl@BamoImpl@@@@SAJPEAXPEAPEAX@Z @ 0x1801609A0 (-Thunk_OnInputProviderChanged_47@-$IMPCManagerClientPrincipal_Receive@VBamoMPCManagerClientPrinc.c)
 * Callees:
        ...
        unsigned int a3)
{
  ...
  Microsoft::BamoImpl::CalloutWrapper<Microsoft::BamoImpl::CalloutWrapperObject>::CalloutWrapper<Microsoft::BamoImpl::CalloutWrapperObject>(
    ...
    *(_QWORD *)(*(_QWORD *)(v6[5] + 24LL) + 32LL),
    v9,
    0);
  v10 = (*(__int64 (__fastcall **)(__int64, __int64, __int64, _QWORD))(*(_QWORD *)(a1 - 16) + 88LL))(
          a1 - 16,
          v8,
          a2,
          a3);
