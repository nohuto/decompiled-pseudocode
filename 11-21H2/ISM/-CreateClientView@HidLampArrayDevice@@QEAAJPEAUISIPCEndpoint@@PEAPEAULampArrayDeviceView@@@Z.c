/*
 * XREFs of ?CreateClientView@HidLampArrayDevice@@QEAAJPEAUISIPCEndpoint@@PEAPEAULampArrayDeviceView@@@Z @ 0x1800D6ABC
 * Callers:
 ...
 *     ?Initialize@LampArrayDeviceView@@QEAAXPEAGPEAUHardwareAttributes@@PEAUDeviceAttributes@@PEAULampAttributes@@@Z @ 0x1800D7C0C (-Initialize@LampArrayDeviceView@@QEAAXPEAGPEAUHardwareAttributes@@PEAUDeviceAttributes@@PEAULamp.c)
 */
