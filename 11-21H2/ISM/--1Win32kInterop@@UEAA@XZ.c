/*
 * XREFs of ??1Win32kInterop@@UEAA@XZ @ 0x1800DE510
 * Callers:
...
void __fastcall Win32kInterop::~Win32kInterop(Win32kInterop *this, __int64 a2)
{
  ...
  KernelInputConnection<_MIT_INVALIDATE_INPUT_MESSAGE>::~KernelInputConnection<_MIT_INVALIDATE_INPUT_MESSAGE>(
    (__int64)this + 1424,
    v7);
  KernelInputConnection<_MIT_KEYBOARD_OVERRIDER_INPUT_MESSAGE>::~KernelInputConnection<_MIT_KEYBOARD_OVERRIDER_INPUT_MESSAGE>(
    (__int64)this + 1280,
    v8);
  KernelInputConnection<_MIT_INVALIDATE_INPUT_MESSAGE>::~KernelInputConnection<_MIT_INVALIDATE_INPUT_MESSAGE>(
    (__int64)this + 1136,
  ...
  *((_QWORD *)this + 41) = 0LL;
  ...
  Microsoft::WRL::ComPtr<IContainerInfoInputObjectProxy>::InternalRelease((__int64 *)this + 35);
  std::_Deallocate<16,0>(
    *((void **)this + 30),
