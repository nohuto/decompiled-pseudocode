/*
 * XREFs of ?CreateAndInitialize@HidLampArrayDevice@@SAJPEAVPnpDevice@@PEAPEAV1@@Z @ 0x1800D6A0C
 * Callers:
 ...
 *     ??0HidLampArrayDevice@@AEAA@XZ @ 0x1800D64D4 (--0HidLampArrayDevice@@AEAA@XZ.c)
