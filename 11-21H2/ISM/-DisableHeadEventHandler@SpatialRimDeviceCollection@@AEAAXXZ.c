/*
 * XREFs of ?DisableHeadEventHandler@SpatialRimDeviceCollection@@AEAAXXZ @ 0x1800BF630
 * Callers:
 ...
 *     ?HeadEventHandlerDisabled_@RawInputProvidersTracing@@QEAAXXZ @ 0x1800C029C (-HeadEventHandlerDisabled_@RawInputProvidersTracing@@QEAAXXZ.c)
