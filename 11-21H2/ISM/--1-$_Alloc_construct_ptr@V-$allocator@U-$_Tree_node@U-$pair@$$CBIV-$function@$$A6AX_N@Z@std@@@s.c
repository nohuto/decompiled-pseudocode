/*
 * XREFs of ??1?$_Alloc_construct_ptr@V?$allocator@U?$_Tree_node@U?$pair@$$CBIV?$function@$$A6AX_N@Z@std@@@std@@PEAX@std@@@std@@@std@@QEAA@XZ @ 0x180090834
 * Callers:
 *     _std::map_unsigned_int_std::function_void___cdecl(bool)__std::less_unsigned_int__std::allocator_std::pair_unsigned_int_const__std::function_void___cdecl(bool)_______::_Try_emplace_unsigned_int_const_&__::_1_::dtor$6 @ 0x1800582B1 (_std--map_unsigned_int_std--function_void___cdecl(bool)__std--less_unsigned_int__std--allocator_.c)
 *     _NonBamoInputDeliveryServer::OnAppThreadMessage_::_1_::dtor$0 @ 0x1800582C3 (_NonBamoInputDeliveryServer--OnAppThreadMessage_--_1_--dtor$0.c)
 * Callees:
