/*
 * XREFs of ?GetEdgyNotificationSourceClient@BamoInputSiteElementProxy@@UEAAPEAVBamoEdgyNotificationSourceClientProxy@@XZ @ 0x18000DF50
 * Callers:
 *     <none>
 * Callees:
        ...
        BamoInputSiteElementProxy *this)
{
  ...
  return (struct BamoEdgyNotificationSourceClientProxy *)*((_QWORD *)this + 22);
}
