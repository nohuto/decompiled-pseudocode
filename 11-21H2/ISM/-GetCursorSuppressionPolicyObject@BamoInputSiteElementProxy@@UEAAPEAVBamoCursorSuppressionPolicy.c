/*
 * XREFs of ?GetCursorSuppressionPolicyObject@BamoInputSiteElementProxy@@UEAAPEAVBamoCursorSuppressionPolicyObjectProxy@@XZ @ 0x18000E1F0
 * Callers:
 *     <none>
 * Callees:
        ...
        BamoInputSiteElementProxy *this)
{
  ...
  return (struct BamoCursorSuppressionPolicyObjectProxy *)*((_QWORD *)this + 16);
}
