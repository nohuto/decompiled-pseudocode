/*
 * XREFs of ?QueryInterface@BamoSystemContextEndpointStub@@UEAAJAEBU_GUID@@PEAPEAX@Z @ 0x180088580
 * Callers:
 *     ?QueryInterface@BamoSystemContextEndpointStub@@W7EAAJAEBU_GUID@@PEAPEAX@Z @ 0x18004EC20 (-QueryInterface@BamoSystemContextEndpointStub@@W7EAAJAEBU_GUID@@PEAPEAX@Z.c)
 * Callees:
