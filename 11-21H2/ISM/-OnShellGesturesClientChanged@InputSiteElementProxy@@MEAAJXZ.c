/*
 * XREFs of ?OnShellGesturesClientChanged@InputSiteElementProxy@@MEAAJXZ @ 0x180008290
 * Callers:
 *     <none>
 * Callees:
        ...
        const char *a4)
{
  ...
  for ( i = *(_QWORD *)(v5 + 488); i != v6; i += 16LL )
  {
    ...
    v12 = v11(v10, &GUID_ecefef40_65f3_7058_da13_a54425d68a4e, &v23) >= 0;
    if ( v9 == this && v12 )
      break;
  }
  if ( i != *(_QWORD *)(v7 + 8) )
  ...
  Microsoft::WRL::ComPtr<IContainerInfoInputObjectProxy>::InternalRelease(&v23);
  v13 = *((_QWORD *)this + 39);
  v14 = (*(__int64 (__fastcall **)(char *))(*((_QWORD *)this + 1) + 248LL))((char *)this + 8);
  if ( v14 )
  {
    v16 = v14 + 8;
    v22 = v14 + 8;
