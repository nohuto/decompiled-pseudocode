/*
 * XREFs of ??$MakeAndInitialize@VMPCManagerClientFactory@@V1@$$V@Details@WRL@Microsoft@@YAJPEAPEAVMPCManagerClientFactory@@@Z @ 0x1801582B8
 * Callers:
        ...
        MPCManagerClientFactory **a1)
{
  ...
  MPCManagerClientFactory *v4; // rdi
