/*
 * XREFs of ??$CreateServer@VInputSystemInternalServerConnection@@@BaseBamoConnection@Bamo@Microsoft@@SAJPEAUIMessageSession@@PEAUIMessagePort@@UMsgScopeID@@PEBGPEAPEAVInputSystemInternalServerConnection@@@Z @ 0x18002CC2C
 * Callers:
        ...
        _QWORD *a5)
{
  ...
  *v8 = &InputSystemServerConnection::`vftable';
  ...
  v10 = ((__int64 (__fastcall *)(_QWORD *))*(&InputSystemServerConnection::`vftable' + 6))(v8);
  v14 = *a3;
