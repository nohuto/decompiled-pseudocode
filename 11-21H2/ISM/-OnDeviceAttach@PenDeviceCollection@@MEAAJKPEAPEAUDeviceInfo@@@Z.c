/*
 * XREFs of ?OnDeviceAttach@PenDeviceCollection@@MEAAJKPEAPEAUDeviceInfo@@@Z @ 0x1800CB360
 * Callers:
 *     <none>
 * Callees:
 ...
 *     ??4?$com_ptr_t@VPenDeviceManager@@Uerr_returncode_policy@wil@@@wil@@QEAAAEAV01@PEAVPenDeviceManager@@@Z @ 0x1800CB240 (--4-$com_ptr_t@VPenDeviceManager@@Uerr_returncode_policy@wil@@@wil@@QEAAAEAV01@PEAVPenDeviceMana.c)
...
LABEL_3:
  ...
  if ( !v18 )
  {
    ...
    v11 = v18;
    (*(void (__fastcall **)(__int64, PenDeviceManager *))(*(_QWORD *)(*((_QWORD *)v14 + 29) + 8LL) + 176LL))(
      *((_QWORD *)v14 + 29) + 8LL,
      v18);
  }
