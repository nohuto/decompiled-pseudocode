/*
 * XREFs of ?UpdateInputTarget@EdgyProcessorTarget@@QEAAJUtagMsgRoutingInfo@@PEAXAEBUEdgyPointerInfo@@@Z @ 0x1801ADCB4
 * Callers:
...
LABEL_16:
    ...
    Microsoft::WRL::ComPtr<IInputTarget>::operator=(v9, &v28);
    if ( v16 )
      (*(void (__fastcall **)(__int64))(*(_QWORD *)v16 + 16LL))(v16);
    Microsoft::WRL::ComPtr<HotkeyRegistrationForwarder>::InternalRelease(&v28);
  }
