/*
 * XREFs of ?SetUniqueId@BamoDataProviderPrincipal@@UEAAXAEBU_LUID@@@Z @ 0x180047800
 * Callers:
 *     <none>
 * Callees:
        ...
        const struct _LUID *a2)
{
  ...
  Microsoft::BamoImpl::InternalLock::InternalLock(&v13, this[3]);
  v3[5] = *a2;
...
LABEL_4:
  ...
  if ( v9 )
    Microsoft::BamoImpl::BamoImplObject::Release(v9, v4, v5, v6);
}
