/*
 * XREFs of ?CreateInputObserverClientProxy@@YAJPEAVBamoPeer@ISMBamos_AutoBamos@@PEAPEAVBamoInputObserverClientProxy@@@Z @ 0x18012CD18
 * Callers:
 ...
 *     ??0InputObserverClientProxy@@QEAA@PEAVCInputObserverManager@@@Z @ 0x18012CBD8 (--0InputObserverClientProxy@@QEAA@PEAVCInputObserverManager@@@Z.c)
 */
        ...
        struct BamoInputObserverClientProxy **a2)
{
  ...
  if ( *(int *)(v3 + 8) <= 0 )
    ...
    v4 = *(_QWORD *)(v3 + 16);
  v5 = (struct CInputObserverManager *)(*(__int64 (__fastcall **)(__int64))(*(_QWORD *)(*(_QWORD *)(v4 + 232) + 8LL)
                                                                          + 136LL))(*(_QWORD *)(v4 + 232) + 8LL);
  ...
  *a2 = v6;
  ...
  wil::details::in1diag3::Return_Hr(
    retaddr,
    (void *)0x13,
    (int)"onecoreuap\\windows\\moderncore\\inputv2\\components\\inputobservers\\server\\inputobserverclientproxy.cpp",
