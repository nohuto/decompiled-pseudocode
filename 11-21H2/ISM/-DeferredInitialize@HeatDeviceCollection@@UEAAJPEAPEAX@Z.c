/*
 * XREFs of ?DeferredInitialize@HeatDeviceCollection@@UEAAJPEAPEAX@Z @ 0x1800C7500
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall HeatDeviceCollection::DeferredInitialize(HANDLE *this, void **a2, __int64 a3, __int64 a4)
{
  int v4; // eax
  unsigned int v5; // ebx
