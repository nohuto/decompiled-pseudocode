/*
 * XREFs of ?RegisterDeviceDockClient@DeviceDockServer@@UEAAJPEAVBamoDeviceDockServerStub@@PEAVBamoDeviceDockClientProxy@@W4DockWatcherRoutingPolicy@Input@Internal@UI@Windows@@@Z @ 0x18017ED20
 * Callers:
 *     <none>
 * Callees:
 ...
 *     ??$_Emplace_reallocate@V?$com_ptr_t@VBamoDeviceDockClientProxy@@Uerr_returncode_policy@wil@@@wil@@@?$vector@V?$com_ptr_t@VBamoDeviceDockClientProxy@@Uerr_returncode_policy@wil@@@wil@@V?$allocator@V?$com_ptr_t@VBamoDeviceDockClientProxy@@Uerr_returncode_policy@wil@@@wil@@@std@@@std@@QEAAPEAV?$com_ptr_t@VBamoDeviceDockClientProxy@@Uerr_returncode_policy@wil@@@wil@@QEAV23@$$QEAV23@@Z @ 0x18017BFF0 (--$_Emplace_reallocate@V-$com_ptr_t@VBamoDeviceDockClientProxy@@Uerr_returncode_policy@wil@@@wil.c)
 *     ??4?$com_ptr_t@VBamoDeviceDockClientProxy@@Uerr_returncode_policy@wil@@@wil@@QEAAAEAV01@PEAVBamoDeviceDockClientProxy@@@Z @ 0x18017CCA0 (--4-$com_ptr_t@VBamoDeviceDockClientProxy@@Uerr_returncode_policy@wil@@@wil@@QEAAAEAV01@PEAVBamo.c)
...
LABEL_6:
  ...
  wil::com_ptr_t<BamoManualDragAreaClientProxy,wil::err_returncode_policy>::~com_ptr_t<BamoManualDragAreaClientProxy,wil::err_returncode_policy>(&j);
  ...
  while ( !*(_BYTE *)(v11 + 25) )
  {
    v12 = (*(__int64 (__fastcall **)(__int64, _QWORD, _QWORD))(*(_QWORD *)(a3 + 8) + 48LL))(
            a3 + 8,
            *(unsigned int *)(v11 + 32),
            *(_QWORD *)(v11 + 40));
    if ( v12 < 0 )
  ...
  while ( !*(_BYTE *)(v13 + 25) )
  {
    v14 = (*(__int64 (__fastcall **)(__int64, _QWORD, _QWORD))(*(_QWORD *)(a3 + 8) + 24LL))(
            a3 + 8,
            *(unsigned int *)(v13 + 32),
            *(_QWORD *)(v13 + 40));
    if ( v14 < 0 )
