/*
 * XREFs of ?UpdateEnabled@BamoControllerNavigationManagerProxyImpl@BamoImpl@@QEAAJ_N0@Z @ 0x18011AEA4
 * Callers:
 *     ?Thunk_UpdateEnabled_11@?$IControllerNavigationManagerProxy_Receive@VBamoControllerNavigationManagerProxyImpl@BamoImpl@@@@SAJPEAXPEAPEAX@Z @ 0x180118850 (-Thunk_UpdateEnabled_11@-$IControllerNavigationManagerProxy_Receive@VBamoControllerNavigationMan.c)
