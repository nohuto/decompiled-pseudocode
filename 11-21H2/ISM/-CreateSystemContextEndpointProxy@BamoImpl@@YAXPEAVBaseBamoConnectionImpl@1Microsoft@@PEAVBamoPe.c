/*
 * XREFs of ?CreateSystemContextEndpointProxy@BamoImpl@@YAXPEAVBaseBamoConnectionImpl@1Microsoft@@PEAVBamoPeer@ISMBamos_AutoBamos@@PEAPEAVBamoProxy@Bamo@3@@Z @ 0x18010800C
 * Callers:
 ...
 *     ??0SystemContextEndpointProxy@@QEAA@PEAVSystemContextManager@@@Z @ 0x1801373AC (--0SystemContextEndpointProxy@@QEAA@PEAVSystemContextManager@@@Z.c)
 */
        ...
        struct Microsoft::Bamo::BamoProxy **a4)
{
  ...
  *(_QWORD *)a3 = 0LL;
  ...
  v8 = (struct SystemContextManager *)(*(__int64 (__fastcall **)(__int64))(*(_QWORD *)(*(_QWORD *)(v7 + 232) + 8LL)
                                                                         + 40LL))(*(_QWORD *)(v7 + 232) + 8LL);
