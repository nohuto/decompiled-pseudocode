/*
 * XREFs of ?AllocateStub@BamoResizeContextualProcessorPrincipal@@MEAAJPEAVBamoPeer@ISMBamos_AutoBamos@@PEAPEAVBamoResizeContextualProcessorStub@@@Z @ 0x18000F950
 * Callers:
 *     <none>
 * Callees:
