/*
 * XREFs of ??$_Integral_to_string@GH@std@@YA?AV?$basic_string@GU?$char_traits@G@std@@V?$allocator@G@2@@0@H@Z @ 0x180093F8C
 * Callers:
 ...
 *     ??$_UIntegral_to_buff@GI@std@@YAPEAGPEAGI@Z @ 0x180094384 (--$_UIntegral_to_buff@GI@std@@YAPEAGPEAGI@Z.c)
 */
