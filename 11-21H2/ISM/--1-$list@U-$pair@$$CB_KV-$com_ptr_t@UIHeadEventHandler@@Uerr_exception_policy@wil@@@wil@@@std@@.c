/*
 * XREFs of ??1?$list@U?$pair@$$CB_KV?$com_ptr_t@UIHeadEventHandler@@Uerr_exception_policy@wil@@@wil@@@std@@V?$allocator@U?$pair@$$CB_KV?$com_ptr_t@UIHeadEventHandler@@Uerr_exception_policy@wil@@@wil@@@std@@@2@@std@@QEAA@XZ @ 0x1800B9078
 * Callers:
 *     _MPCHeadUpdateListener::MPCHeadUpdateListener_::_1_::dtor$11 @ 0x1800B9013 (_MPCHeadUpdateListener--MPCHeadUpdateListener_--_1_--dtor$11.c)
 *     _PenDeviceManager::PenDeviceManager_::_1_::dtor$20 @ 0x180185C44 (_PenDeviceManager--PenDeviceManager_--_1_--dtor$20.c)
 * Callees:
