/*
 * XREFs of ?TailButtonEventsEnabledChanged@BamoPenEventsClientProxy@@UEAAJ_N@Z @ 0x18003F040
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall BamoPenEventsClientProxy::TailButtonEventsEnabledChanged(BamoPenEventsClientProxy *this, char a2)
{
  ...
  LOBYTE(v4) = a2;
  v8 = BamoImpl::BamoPenEventsClientProxyImpl::TailButtonEventsEnabledChanged(
