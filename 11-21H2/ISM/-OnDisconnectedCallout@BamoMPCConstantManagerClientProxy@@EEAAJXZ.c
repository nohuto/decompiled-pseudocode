/*
 * XREFs of ?OnDisconnectedCallout@BamoMPCConstantManagerClientProxy@@EEAAJXZ @ 0x1800F61C0
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall BamoMPCConstantManagerClientProxy::OnDisconnectedCallout(
        ...
        __int64 a3)
{
  ...
  Microsoft::BamoImpl::CalloutWrapper<Microsoft::BamoImpl::CalloutWrapperObject>::CalloutWrapper<Microsoft::BamoImpl::CalloutWrapperObject>(
    ...
    *(_QWORD *)(*(_QWORD *)(*((_QWORD *)this + 4) + 24LL) + 32LL),
    a3,
    0);
  LODWORD(v3) = (*(__int64 (__fastcall **)(BamoMPCConstantManagerClientProxy *))(*(_QWORD *)v3 + 40LL))(v3);
  Microsoft::BamoImpl::CalloutWrapper<Microsoft::BamoImpl::CalloutWrapperObject>::~CalloutWrapper<Microsoft::BamoImpl::CalloutWrapperObject>(
    v8,
    v4,
    v5,
