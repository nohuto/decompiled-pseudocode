/*
 * XREFs of ??1InputSinkDataCache@@QEAA@XZ @ 0x180049770
 * Callers:
 *     _InputSinkDataCache::GetInstance_::_2_::_dynamic_atexit_destructor_for__instance__ @ 0x180058B20 (_InputSinkDataCache--GetInstance_--_2_--_dynamic_atexit_destructor_for__instance__.c)
 * Callees:
