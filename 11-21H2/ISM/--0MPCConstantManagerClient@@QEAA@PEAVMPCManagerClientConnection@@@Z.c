/*
 * XREFs of ??0MPCConstantManagerClient@@QEAA@PEAVMPCManagerClientConnection@@@Z @ 0x180164570
 * Callers:
 *     ??$Make@VMPCConstantManagerClient@@PEAVMPCManagerClientConnection@@@Details@WRL@Microsoft@@YA?AV?$ComPtr@VMPCConstantManagerClient@@@12@$$QEAPEAVMPCManagerClientConnection@@@Z @ 0x180157F64 (--$Make@VMPCConstantManagerClient@@PEAVMPCManagerClientConnection@@@Details@WRL@Microsoft@@YA-AV.c)
 * Callees:
        ...
        struct MPCManagerClientConnection *a2)
{
  ...
  *((_QWORD *)this + 4) = a2;
  if ( a2 )
  {
    v4 = (Microsoft::BamoImpl::BaseBamoConnectionImpl *)(*(__int64 (__fastcall **)(struct MPCManagerClientConnection *))(*(_QWORD *)a2 + 48LL))(a2);
