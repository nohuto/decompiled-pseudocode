/*
 * XREFs of ?UnregisterDeviceDockClient@DeviceDockServer@@QEAAJPEAVBamoDeviceDockClientProxy@@@Z @ 0x18017FBDC
 * Callers:
 *     ?OnDisconnected@DeviceDockClientProxy@@MEAAJXZ @ 0x1801807A0 (-OnDisconnected@DeviceDockClientProxy@@MEAAJXZ.c)
 * Callees:
