/*
 * XREFs of ?UpdateZoom@MPCGamepadProcessor@@AEAAXPEAULegacyInputInfo@@@Z @ 0x1801C7028
 * Callers:
...
void __fastcall MPCGamepadProcessor::UpdateZoom(MPCGamepadProcessor *this, struct LegacyInputInfo *a2)
{
  ...
  *((_QWORD *)&v33 + 1) = L"ThumbstickDeadzone";
  ...
  MPCConstantManager::GetConstant<float>(
    ...
    ((unsigned __int64)this + 32) & -(__int64)(this != 0LL),
    (__int128 *)((char *)&v33 + 8));
  v23 = *v2 && v2[2] || *((_DWORD *)this + 1046) == 2;
  v24 = v20 && v21 <= COERCE_FLOAT(L"ThumbstickDeadzone") && !*((_DWORD *)this + 1046);
  v25 = *((_DWORD *)this + 1046);
  if ( v25 != 2 )
  {
LABEL_24:
    v19 = 0;
