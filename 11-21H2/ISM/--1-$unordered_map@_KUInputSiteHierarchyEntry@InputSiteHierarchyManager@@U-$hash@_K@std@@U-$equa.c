/*
 * XREFs of ??1?$unordered_map@_KUInputSiteHierarchyEntry@InputSiteHierarchyManager@@U?$hash@_K@std@@U?$equal_to@_K@4@V?$allocator@U?$pair@$$CB_KUInputSiteHierarchyEntry@InputSiteHierarchyManager@@@std@@@4@@std@@QEAA@XZ @ 0x180123640
 * Callers:
 *     _InputSiteHierarchyManager::InputSiteHierarchyManager_::_1_::dtor$1 @ 0x180056B01 (_InputSiteHierarchyManager--InputSiteHierarchyManager_--_1_--dtor$1.c)
 * Callees:
...
void __fastcall std::unordered_map<unsigned __int64,InputSiteHierarchyManager::InputSiteHierarchyEntry>::~unordered_map<unsigned __int64,InputSiteHierarchyManager::InputSiteHierarchyEntry>(
        __int64 a1)
{
  __int64 v2; // rcx
