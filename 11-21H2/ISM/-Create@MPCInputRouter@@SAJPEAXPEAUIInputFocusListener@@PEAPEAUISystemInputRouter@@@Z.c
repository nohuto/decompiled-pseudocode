/*
 * XREFs of ?Create@MPCInputRouter@@SAJPEAXPEAUIInputFocusListener@@PEAPEAUISystemInputRouter@@@Z @ 0x180028414
 * Callers:
        ...
        struct ISystemInputRouter **a3)
{
  ...
  if ( !a1 || !a3 )
    wil::details::in1diag3::FailFast_Hr(
      ...
      v11);
  v6 = (MPCInputRouter *)malloc(0x3D0uLL);
  v8 = v6;
  if ( v6 )
    memset_0(v6, 0, 0x3D0uLL);
  v13 = v8;
  if ( v8 )
    v8 = MPCInputRouter::MPCInputRouter(v8, a1, a2);
  if ( !v8 )
