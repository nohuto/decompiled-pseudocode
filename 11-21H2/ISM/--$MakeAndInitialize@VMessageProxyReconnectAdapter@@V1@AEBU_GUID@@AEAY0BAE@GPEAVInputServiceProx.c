/*
 * XREFs of ??$MakeAndInitialize@VMessageProxyReconnectAdapter@@V1@AEBU_GUID@@AEAY0BAE@GPEAVInputServiceProxy@@@Details@WRL@Microsoft@@YAJPEAPEAVMessageProxyReconnectAdapter@@AEBU_GUID@@AEAY0BAE@G$$QEAPEAVInputServiceProxy@@@Z @ 0x1800310CC
 * Callers:
        ...
        _QWORD *a4)
{
  ...
  *a1 = 0LL;
  ...
  if ( v8 )
  {
    ...
    v12 = v9;
    v10 = MessageProxyReconnectAdapter::RuntimeClassInitialize(
            v9,
            a2,
            a3,
