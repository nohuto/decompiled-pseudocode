/*
 * XREFs of ??$MakeAndInitialize@VMPCEyeGazeProcessor@@UIInputProcessor@@AEAPEAUInputProcessorCreateParams@@@Details@WRL@Microsoft@@YAJPEAPEAUIInputProcessor@@AEAPEAUInputProcessorCreateParams@@@Z @ 0x1801CA35C
 * Callers:
...
{
  MPCEyeGazeProcessor *v4; // rax
  MPCEyeGazeProcessor *v5; // rbx
  MPCEyeGazeProcessor *v6; // rdi
  int v7; // esi
  volatile int *v8; // rdx

  *a1 = 0LL;
  v4 = (MPCEyeGazeProcessor *)operator new(0xE58uLL, (const struct std::nothrow_t *)&std::nothrow);
  v5 = v4;
  v6 = v4;
  if ( v4 )
  {
    ...
    *((_QWORD *)v5 + 1) = &MPCEyeGazeProcessor::`vftable'{for `Microsoft::WRL::Details::ImplementsHelper<Microsoft::WRL::RuntimeClassFlags<2>,1,IInputProcessorDeviceUpdate,IInputFocusListener,IMPCInputProviderBase>'};
    *((_QWORD *)v5 + 2) = &MPCSixDofProcessor::`vftable'{for `IInputFocusListener'};
    *((_QWORD *)v5 + 3) = &MPCEyeGazeProcessor::`vftable'{for `Microsoft::WRL::Details::ImplementsHelper<Microsoft::WRL::RuntimeClassFlags<2>,1,IMPCInputProviderBase>'};
    *((_DWORD *)v5 + 916) = 0;
    v7 = MPCEyeGazeProcessor::RuntimeClassInitialize(v6, *a2);
    if ( v7 >= 0 )
