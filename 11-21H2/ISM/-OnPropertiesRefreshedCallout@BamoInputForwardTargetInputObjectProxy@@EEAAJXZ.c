/*
 * XREFs of ?OnPropertiesRefreshedCallout@BamoInputForwardTargetInputObjectProxy@@EEAAJXZ @ 0x1801127F0
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall BamoInputForwardTargetInputObjectProxy::OnPropertiesRefreshedCallout(
        BamoInputForwardTargetInputObjectProxy *this)
{
  ...
  Microsoft::BamoImpl::CalloutWrapper<BamoImpl::BamoInputForwardTargetInputObjectProxyImpl>::CalloutWrapper<BamoImpl::BamoInputForwardTargetInputObjectProxyImpl>(
    ...
    *(_QWORD *)(*(_QWORD *)(*((_QWORD *)this + 4) + 24LL) + 32LL),
    (__int64)this + 16);
  LODWORD(v1) = (*(__int64 (__fastcall **)(BamoInputForwardTargetInputObjectProxy *))(*(_QWORD *)v1 + 48LL))(v1);
