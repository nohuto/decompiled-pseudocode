/*
 * XREFs of ??1?$unordered_map@KV?$unique_ptr@ULegacyDeviceInfo@@U?$default_delete@ULegacyDeviceInfo@@@std@@@std@@U?$hash@K@2@U?$equal_to@K@2@V?$allocator@U?$pair@$$CBKV?$unique_ptr@ULegacyDeviceInfo@@U?$default_delete@ULegacyDeviceInfo@@@std@@@std@@@std@@@2@@std@@QEAA@XZ @ 0x1800CE6C0
 * Callers:
 *     _Win32kInterop::Win32kInterop_::_1_::dtor$4 @ 0x180056D01 (_Win32kInterop--Win32kInterop_--_1_--dtor$4.c)
 *     _InjectionRawInputProvider::InjectionRawInputProvider_::_1_::dtor$3 @ 0x1800CE552 (_InjectionRawInputProvider--InjectionRawInputProvider_--_1_--dtor$3.c)
 * Callees:
