/*
 * XREFs of ?SetInputDelegation@ForegroundManager@@QEAAXPEAVInputSite@@III@Z @ 0x18008BF88
 * Callers:
...
LABEL_28:
  ...
  if ( v11 )
  {
    ...
    v23 = v34;
    v6 = (struct InputSite *)*InputSiteManager::GetInputSiteFromId((__int64)InputSiteManager, &v33, 1, v34);
    v25 = v33;
    if ( v33 )
    {
      v33 = 0LL;
