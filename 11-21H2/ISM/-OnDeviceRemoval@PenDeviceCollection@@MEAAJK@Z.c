/*
 * XREFs of ?OnDeviceRemoval@PenDeviceCollection@@MEAAJK@Z @ 0x1800CB4F0
 * Callers:
 *     <none>
 * Callees:
...
LABEL_3:
  ...
  v9 = (*(__int64 (__fastcall **)(__int64))(*(_QWORD *)(*((_QWORD *)BamoServerConnection + 29) + 8LL) + 168LL))(*((_QWORD *)BamoServerConnection + 29) + 8LL);
