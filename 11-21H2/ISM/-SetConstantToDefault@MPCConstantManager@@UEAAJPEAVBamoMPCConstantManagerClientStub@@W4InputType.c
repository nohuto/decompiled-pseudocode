/*
 * XREFs of ?SetConstantToDefault@MPCConstantManager@@UEAAJPEAVBamoMPCConstantManagerClientStub@@W4InputType@@PEBGPEAVBamoAsyncHRESULTProxy@@@Z @ 0x180096930
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall MPCConstantManager::SetConstantToDefault(
        __int64 a1,
        __int64 a2,
        unsigned int a3,
        __int64 a4,
