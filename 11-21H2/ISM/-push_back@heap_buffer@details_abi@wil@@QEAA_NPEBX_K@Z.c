/*
 * XREFs of ?push_back@heap_buffer@details_abi@wil@@QEAA_NPEBX_K@Z @ 0x18007F070
 * Callers:
 ...
 *     ?ensure@heap_buffer@details_abi@wil@@QEAA_N_K@Z @ 0x18007EFA0 (-ensure@heap_buffer@details_abi@wil@@QEAA_N_K@Z.c)
 */
