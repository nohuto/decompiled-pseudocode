/*
 * XREFs of _std::vector_wil::com_ptr_t_AsyncStringPrincipal_wil::err_exception_policy__std::allocator_wil::com_ptr_t_AsyncStringPrincipal_wil::err_exception_policy_____::_Emplace_reallocate_AsyncStringPrincipal____::_1_::catch$0 @ 0x180162C33
 * Callers:
 *     <none>
 * Callees:
