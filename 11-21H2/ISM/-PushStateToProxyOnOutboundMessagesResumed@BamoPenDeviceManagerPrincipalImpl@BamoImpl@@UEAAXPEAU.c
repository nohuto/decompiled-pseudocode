/*
 * XREFs of ?PushStateToProxyOnOutboundMessagesResumed@BamoPenDeviceManagerPrincipalImpl@BamoImpl@@UEAAXPEAUIMessageCallSendHost@@PEAVBamoStubImpl@2Microsoft@@@Z @ 0x180187280
 * Callers:
 *     <none>
 * Callees:
