/*
 * XREFs of ?QueryInterface@BamoInputProcessPrincipal@@UEAAJAEBU_GUID@@PEAPEAX@Z @ 0x1800B1F30
 * Callers:
 *     ?QueryInterface@BamoInputProcessPrincipal@@W7EAAJAEBU_GUID@@PEAPEAX@Z @ 0x18004F120 (-QueryInterface@BamoInputProcessPrincipal@@W7EAAJAEBU_GUID@@PEAPEAX@Z.c)
 * Callees:
