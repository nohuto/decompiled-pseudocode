/*
 * XREFs of ?GetHapticsChannel@HapticInterface@@AEAA_NW4_HIDP_REPORT_TYPE@@GPEAU_HIDP_VALUE_CAPS@@@Z @ 0x18018B4E8
 * Callers:
...
char __fastcall HapticInterface::GetHapticsChannel(
