/*
 * XREFs of ??0?$CalloutWrapper@VBamoInputProcessPrincipalImpl@BamoImpl@@@BamoImpl@Microsoft@@QEAA@PEAVBaseBamoConnectionImpl@12@PEAVBamoInputProcessPrincipalImpl@1@W4PrologEpilogConfig@12@@Z @ 0x1800B1420
 * Callers:
        ...
        int a4)
{
  ...
  *(_QWORD *)a1 = 0LL;
  ...
  if ( v7 )
  {
    if ( (*(_BYTE *)(a1 + 16) & 1) != 0 )
    {
      v8 = (*(__int64 (__fastcall **)(_QWORD))(**(_QWORD **)(v7 - 16 + 56) + 48LL))(*(_QWORD *)(v7 - 16 + 56));
      if ( v8 < 0 )
