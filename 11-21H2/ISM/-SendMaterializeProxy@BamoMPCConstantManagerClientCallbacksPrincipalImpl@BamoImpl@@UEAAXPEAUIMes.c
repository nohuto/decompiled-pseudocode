/*
 * XREFs of ?SendMaterializeProxy@BamoMPCConstantManagerClientCallbacksPrincipalImpl@BamoImpl@@UEAAXPEAUIMessageCallSendHost@@PEAVBamoStubImpl@2Microsoft@@@Z @ 0x1801708C0
 * Callers:
 *     <none>
 * Callees:
