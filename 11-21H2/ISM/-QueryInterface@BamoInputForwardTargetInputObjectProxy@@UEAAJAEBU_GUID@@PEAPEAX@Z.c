/*
 * XREFs of ?QueryInterface@BamoInputForwardTargetInputObjectProxy@@UEAAJAEBU_GUID@@PEAPEAX@Z @ 0x180113EF0
 * Callers:
 *     ?QueryInterface@BamoInputForwardTargetInputObjectProxy@@W7EAAJAEBU_GUID@@PEAPEAX@Z @ 0x180050640 (-QueryInterface@BamoInputForwardTargetInputObjectProxy@@W7EAAJAEBU_GUID@@PEAPEAX@Z.c)
 * Callees:
