/*
 * XREFs of ?UpdateDoubleClickValues@MPCHolographicInputManager@@AEAAXXZ @ 0x180034E08
 * Callers:
    ...
    if ( v3 != *((_BYTE *)this + 3672) )
    {
      ...
      *((_BYTE *)this + 3672) = v3;
      if ( ISMTracing::IsEnabled(v8, v7) )
      {
        ...
        ISMTracing::MPCHolographicInputManager_UpdateDoubleClickValues_(v11, (const bool *)this + 3672, &v14, &v13);
      }
    }
  }
}
