/*
 * XREFs of ?MPCHolographicInputManager_UpdateDoubleClickValues_@ISMTracing@@QEAAXAEB_NAEBH1@Z @ 0x18009F1D8
 * Callers:
        ...
        int *a4)
{
  ...
  if ( *(_DWORD *)v7 > 4u && (*(_BYTE *)(v7 + 16) & 1) != 0 && (*(_QWORD *)(v7 + 24) & 1LL) == *(_QWORD *)(v7 + 24) )
  {
    ...
    v15 = 4LL;
    v13 = 1LL;
    tlgWriteTransfer_EventWriteTransfer(v7, (unsigned __int8 *)dword_1801FFAE9, 0LL, 0LL, 5u, &v11);
  }
}
