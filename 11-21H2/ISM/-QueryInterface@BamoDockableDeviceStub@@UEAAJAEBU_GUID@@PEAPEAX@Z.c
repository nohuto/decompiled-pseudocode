/*
 * XREFs of ?QueryInterface@BamoDockableDeviceStub@@UEAAJAEBU_GUID@@PEAPEAX@Z @ 0x18017EA70
 * Callers:
 *     ?QueryInterface@BamoDockableDeviceStub@@W7EAAJAEBU_GUID@@PEAPEAX@Z @ 0x1800529A0 (-QueryInterface@BamoDockableDeviceStub@@W7EAAJAEBU_GUID@@PEAPEAX@Z.c)
 * Callees:
