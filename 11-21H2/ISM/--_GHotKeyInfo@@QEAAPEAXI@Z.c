/*
 * XREFs of ??_GHotKeyInfo@@QEAAPEAXI@Z @ 0x1801D265C
 * Callers:
 ...
 *     ?_Destroy@?$_Ref_count_obj2@UHotKeyInfo@@@std@@EEAAXXZ @ 0x1801D5190 (-_Destroy@-$_Ref_count_obj2@UHotKeyInfo@@@std@@EEAAXXZ.c)
 * Callees:
