/*
 * XREFs of ?OnConnectedThunk@BamoDeviceDockServerStubImpl@BamoImpl@@UEAAJXZ @ 0x180010380
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall BamoImpl::BamoDeviceDockServerStubImpl::OnConnectedThunk(
