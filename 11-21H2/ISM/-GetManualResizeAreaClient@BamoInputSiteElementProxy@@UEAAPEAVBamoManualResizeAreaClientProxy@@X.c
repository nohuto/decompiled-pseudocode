/*
 * XREFs of ?GetManualResizeAreaClient@BamoInputSiteElementProxy@@UEAAPEAVBamoManualResizeAreaClientProxy@@XZ @ 0x18000DC40
 * Callers:
 *     <none>
 * Callees:
        ...
        BamoInputSiteElementProxy *this)
{
  ...
  return (struct BamoManualResizeAreaClientProxy *)*((_QWORD *)this + 29);
}
