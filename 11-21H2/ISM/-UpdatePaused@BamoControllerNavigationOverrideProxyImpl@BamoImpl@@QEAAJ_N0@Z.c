/*
 * XREFs of ?UpdatePaused@BamoControllerNavigationOverrideProxyImpl@BamoImpl@@QEAAJ_N0@Z @ 0x180174CA8
 * Callers:
 *     ?Thunk_UpdatePaused_11@?$IControllerNavigationOverrideProxy_Receive@VBamoControllerNavigationOverrideProxyImpl@BamoImpl@@@@SAJPEAXPEAPEAX@Z @ 0x180174600 (-Thunk_UpdatePaused_11@-$IControllerNavigationOverrideProxy_Receive@VBamoControllerNavigationOve.c)
