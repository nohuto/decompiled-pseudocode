/*
 * XREFs of ??1CUIHierarchy@@AEAA@XZ @ 0x18004991C
 * Callers:
 *     _CUIHierarchy::GetInstance_::_2_::_dynamic_atexit_destructor_for__instance__ @ 0x180058B40 (_CUIHierarchy--GetInstance_--_2_--_dynamic_atexit_destructor_for__instance__.c)
 * Callees:
