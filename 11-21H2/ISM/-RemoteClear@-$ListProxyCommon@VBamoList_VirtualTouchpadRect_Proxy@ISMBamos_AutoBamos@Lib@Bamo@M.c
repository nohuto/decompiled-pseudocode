/*
 * XREFs of ?RemoteClear@?$ListProxyCommon@VBamoList_VirtualTouchpadRect_Proxy@ISMBamos_AutoBamos@Lib@Bamo@Microsoft@@UVirtualTouchpadRect@@@Bamo@Microsoft@@MEAAJXZ @ 0x180130880
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall Microsoft::Bamo::ListProxyCommon<Microsoft::Bamo::Lib::ISMBamos_AutoBamos::BamoList_VirtualTouchpadRect_Proxy,VirtualTouchpadRect>::RemoteClear(
        _QWORD *a1)
{
  __int64 v2; // rax
