/*
 * XREFs of ?EdgyRecognized@BamoEdgyNotificationSourceClientProxyImpl@BamoImpl@@QEAAJAEBUPoint@Foundation@Windows@@@Z @ 0x18010945C
 * Callers:
        ...
        const char *a4)
{
  ...
  else
  {
    ...
    if ( v7 >= 0 )
    {
      ...
      v12[1] = v15;
      v16 = v11;
      return CoreUICallSend(v9, v12, 2LL, 39LL);
    }
    else
    {
      wil::details::in1diag3::Return_Hr(
