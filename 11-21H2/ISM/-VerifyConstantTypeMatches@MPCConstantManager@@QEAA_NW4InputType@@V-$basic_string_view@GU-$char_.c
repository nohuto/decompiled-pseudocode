/*
 * XREFs of ?VerifyConstantTypeMatches@MPCConstantManager@@QEAA_NW4InputType@@V?$basic_string_view@GU?$char_traits@G@std@@@std@@V?$variant@K_NM@4@@Z @ 0x180096D2C
 * Callers:
...
char __fastcall MPCConstantManager::VerifyConstantTypeMatches(__int64 a1, __int64 a2, __m128i *a3, __int64 a4)
{
  char v6; // di
  __int64 v7; // rax
  __int64 v8; // rcx
