/*
 * XREFs of ?TriggerHomeGesture@BamoMPCManagerPrincipalImpl@BamoImpl@@QEAAJW4InputType@@I@Z @ 0x18009BAC8
 * Callers:
 *     ?Thunk_TriggerHomeGesture_21@?$IMPCManagerPrincipal_Receive@VBamoMPCManagerPrincipalImpl@BamoImpl@@@@SAJPEAXPEAPEAX@Z @ 0x18009BAB0 (-Thunk_TriggerHomeGesture_21@-$IMPCManagerPrincipal_Receive@VBamoMPCManagerPrincipalImpl@BamoImp.c)
 * Callees:
        ...
        unsigned int a3)
{
  ...
  Microsoft::BamoImpl::CalloutWrapper<Microsoft::BamoImpl::CalloutWrapperObject>::CalloutWrapper<Microsoft::BamoImpl::CalloutWrapperObject>(
    ...
    *(_QWORD *)(*(_QWORD *)(v6[5] + 24LL) + 32LL),
    v9,
    0);
  v10 = (*(__int64 (__fastcall **)(__int64, __int64, _QWORD, _QWORD))(*(_QWORD *)(a1 - 16) + 136LL))(
          a1 - 16,
          v8,
          a2,
          a3);
