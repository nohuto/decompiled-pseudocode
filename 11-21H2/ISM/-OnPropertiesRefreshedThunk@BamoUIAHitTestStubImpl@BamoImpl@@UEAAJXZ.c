/*
 * XREFs of ?OnPropertiesRefreshedThunk@BamoUIAHitTestStubImpl@BamoImpl@@UEAAJXZ @ 0x1801B9520
 * Callers:
 *     <none>
 * Callees:
...
{
  BamoImpl::BamoUIAHitTestStubImpl *v1; // rbx
  __int64 v2; // r8
  __int64 v3; // rdi
  ...
  Microsoft::BamoImpl::CalloutWrapper<BamoImpl::BamoUIAHitTestPrincipalImpl>::~CalloutWrapper<BamoImpl::BamoUIAHitTestPrincipalImpl>((__int64)v5);
