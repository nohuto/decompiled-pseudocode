/*
 * XREFs of ?ManualDragEnded@BamoManualDragAreaClientProxyImpl@BamoImpl@@QEAAJI@Z @ 0x180139B6C
 * Callers:
...
__int64 __fastcall BamoImpl::BamoManualDragAreaClientProxyImpl::ManualDragEnded(
        ...
        const char *a4)
{
  ...
  else
  {
    ...
    if ( v7 >= 0 )
    {
      ...
      v10[0] = v12;
      v10[1] = v13;
      return CoreUICallSend(v9, v10, 2LL, 64LL);
    }
    else
    {
      wil::details::in1diag3::Return_Hr(
