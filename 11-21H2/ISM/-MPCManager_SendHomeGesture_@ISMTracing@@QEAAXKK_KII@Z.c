/*
 * XREFs of ?MPCManager_SendHomeGesture_@ISMTracing@@QEAAXKK_KII@Z @ 0x1800991EC
 * Callers:
        ...
        unsigned int a6)
{
    ...
    && (*(_QWORD *)(v9 + 24) & 0x400000000001LL) == *(_QWORD *)(v9 + 24) )
  {
    ...
    v13 = a2;
    v15 = 50331648LL;
    tlgWriteTransfer_EventWriteTransfer(v9, (unsigned __int8 *)dword_1801FF9B0, 0LL, 0LL, 8u, &v16);
  }
}
