/*
 * XREFs of ?QueryInterface@BamoSystemCursorControllerClientProxy@@UEAAJAEBU_GUID@@PEAPEAX@Z @ 0x1801146D0
 * Callers:
 *     ?QueryInterface@BamoSystemCursorControllerClientProxy@@W7EAAJAEBU_GUID@@PEAPEAX@Z @ 0x180050800 (-QueryInterface@BamoSystemCursorControllerClientProxy@@W7EAAJAEBU_GUID@@PEAPEAX@Z.c)
 * Callees:
