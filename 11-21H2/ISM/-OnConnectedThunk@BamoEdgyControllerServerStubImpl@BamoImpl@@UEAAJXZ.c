/*
 * XREFs of ?OnConnectedThunk@BamoEdgyControllerServerStubImpl@BamoImpl@@UEAAJXZ @ 0x1800106E0
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall BamoImpl::BamoEdgyControllerServerStubImpl::OnConnectedThunk(
