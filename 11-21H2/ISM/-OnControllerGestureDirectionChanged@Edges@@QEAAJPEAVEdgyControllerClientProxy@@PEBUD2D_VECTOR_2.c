/*
 * XREFs of ?OnControllerGestureDirectionChanged@Edges@@QEAAJPEAVEdgyControllerClientProxy@@PEBUD2D_VECTOR_2F@@@Z @ 0x1801ABB54
 * Callers:
 *     ?OnGestureDirectionChanged@EdgyControllerClientProxy@@MEAAJXZ @ 0x18014C720 (-OnGestureDirectionChanged@EdgyControllerClientProxy@@MEAAJXZ.c)
