/*
 * XREFs of ?GetDragAreaClient@BamoInputSiteElementProxy@@UEAAPEAVBamoDragAreaClientProxy@@XZ @ 0x18000E180
 * Callers:
 *     <none>
 * Callees:
        ...
        BamoInputSiteElementProxy *this)
{
  ...
  return (struct BamoDragAreaClientProxy *)*((_QWORD *)this + 17);
}
