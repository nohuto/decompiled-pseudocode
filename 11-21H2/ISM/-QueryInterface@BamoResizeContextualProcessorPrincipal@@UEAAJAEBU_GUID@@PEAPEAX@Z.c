/*
 * XREFs of ?QueryInterface@BamoResizeContextualProcessorPrincipal@@UEAAJAEBU_GUID@@PEAPEAX@Z @ 0x180143740
 * Callers:
 *     ?QueryInterface@BamoResizeContextualProcessorPrincipal@@W7EAAJAEBU_GUID@@PEAPEAX@Z @ 0x180050EC0 (-QueryInterface@BamoResizeContextualProcessorPrincipal@@W7EAAJAEBU_GUID@@PEAPEAX@Z.c)
 * Callees:
