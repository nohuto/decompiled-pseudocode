/*
 * XREFs of ?RemoveRIMDevice@PenDeviceManager@@QEAAXPEAX@Z @ 0x180187B44
 * Callers:
    ...
    if ( v16 )
    {
      ...
      for ( i = 0LL; (unsigned int)i < (unsigned int)v5; i = (unsigned int)(i + 1) )
      {
        ...
        if ( *(int *)(v7 + 8) <= 0 )
          ...
          v8 = *(_QWORD *)(v7 + 16);
        v9 = (Microsoft::BamoImpl::BaseBamoConnectionImpl *)(*(__int64 (__fastcall **)(__int64))(*(_QWORD *)v8 + 48LL))(v8);
