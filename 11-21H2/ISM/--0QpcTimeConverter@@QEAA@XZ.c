/*
 * XREFs of ??0QpcTimeConverter@@QEAA@XZ @ 0x180033384
 * Callers:
 *     _dynamic_initializer_for__GameControllerRawInputProvider::s_qpcTime__ @ 0x1800013B0 (_dynamic_initializer_for__GameControllerRawInputProvider--s_qpcTime__.c)
