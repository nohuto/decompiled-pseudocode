/*
 * XREFs of ?OnConnectedThunk@BamoSystemContextManagerStubImpl@BamoImpl@@UEAAJXZ @ 0x180133A70
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall BamoImpl::BamoSystemContextManagerStubImpl::OnConnectedThunk(
