/*
 * XREFs of ?QueryInterface@error_info_fallback@impl@winrt@@UEAAHAEBUguid@3@PEAPEAX@Z @ 0x1800823C0
 * Callers:
 *     ?QueryInterface@error_info_fallback@impl@winrt@@W7EAAHAEBUguid@3@PEAPEAX@Z @ 0x18004EB80 (-QueryInterface@error_info_fallback@impl@winrt@@W7EAAHAEBUguid@3@PEAPEAX@Z.c)
 * Callees:
 *     <none>
 */
