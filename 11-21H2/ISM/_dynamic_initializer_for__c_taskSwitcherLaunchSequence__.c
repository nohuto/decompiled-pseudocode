/*
 * XREFs of _dynamic_initializer_for__c_taskSwitcherLaunchSequence__ @ 0x1800016E0
 * Callers:
 *     <none>
 * Callees:
 *     ??0?$vector@U?$pair@G_N@std@@V?$allocator@U?$pair@G_N@std@@@2@@std@@QEAA@V?$initializer_list@U?$pair@G_N@std@@@1@AEBV?$allocator@U?$pair@G_N@std@@@1@@Z @ 0x180043BB4 (--0-$vector@U-$pair@G_N@std@@V-$allocator@U-$pair@G_N@std@@@2@@std@@QEAA@V-$initializer_list@U-$.c)
