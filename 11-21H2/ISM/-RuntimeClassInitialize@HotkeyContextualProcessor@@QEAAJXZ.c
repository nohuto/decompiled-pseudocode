/*
 * XREFs of ?RuntimeClassInitialize@HotkeyContextualProcessor@@QEAAJXZ @ 0x1801B2A04
 * Callers:
...
LABEL_11:
  ...
  LOBYTE(v8) = 1;
  v9 = (*(__int64 (__fastcall **)(_QWORD, __int64, __int64))(**((_QWORD **)this + 7) + 336LL))(
         *((_QWORD *)this + 7),
         31LL,
         v8);
  if ( v9 < 0 )
  ...
  InputServiceProxy = CreateInputServiceProxy((__int64)this + 16, (__int64 *)this + 4);
