/*
 * XREFs of ?SetTopLevelActivatedEntity@BamoActivationWatcherPrincipal@@UEAAXPEAVBamoActivatableEntityPrincipal@@@Z @ 0x18008E3C0
 * Callers:
 *     <none>
 * Callees:
 ...
 *     ??4?$com_ptr_t@VBamoActivatableEntityPrincipal@@Uerr_returncode_policy@wil@@@wil@@QEAAAEAV01@PEAVBamoActivatableEntityPrincipal@@@Z @ 0x18008D68C (--4-$com_ptr_t@VBamoActivatableEntityPrincipal@@Uerr_returncode_policy@wil@@@wil@@QEAAAEAV01@PEA.c)
