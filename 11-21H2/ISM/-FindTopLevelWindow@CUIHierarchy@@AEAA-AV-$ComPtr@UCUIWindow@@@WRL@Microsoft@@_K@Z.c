/*
 * XREFs of ?FindTopLevelWindow@CUIHierarchy@@AEAA?AV?$ComPtr@UCUIWindow@@@WRL@Microsoft@@_K@Z @ 0x180084D8C
 * Callers:
 *     ?AreWindowsInSameCompositeApp@CUIHierarchy@@AEAA_N_K0@Z @ 0x180084D0C (-AreWindowsInSameCompositeApp@CUIHierarchy@@AEAA_N_K0@Z.c)
