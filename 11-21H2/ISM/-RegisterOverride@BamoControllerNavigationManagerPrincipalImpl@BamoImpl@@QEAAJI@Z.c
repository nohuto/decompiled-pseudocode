/*
 * XREFs of ?RegisterOverride@BamoControllerNavigationManagerPrincipalImpl@BamoImpl@@QEAAJI@Z @ 0x180172ED0
 * Callers:
 *     ?Thunk_RegisterOverride_8@?$IControllerNavigationManagerPrincipal_Receive@VBamoControllerNavigationManagerPrincipalImpl@BamoImpl@@@@SAJPEAXPEAPEAX@Z @ 0x180173400 (-Thunk_RegisterOverride_8@-$IControllerNavigationManagerPrincipal_Receive@VBamoControllerNavigat.c)
 * Callees:
        ...
        unsigned int a2)
{
  ...
  Microsoft::BamoImpl::CalloutWrapper<BamoImpl::BamoControllerNavigationManagerPrincipalImpl>::CalloutWrapper<BamoImpl::BamoControllerNavigationManagerPrincipalImpl>(
    ...
    v9,
    (__int64)this);
  v14 = (*(__int64 (__fastcall **)(char *, __int64, char *))(*((_QWORD *)this - 2) + 104LL))((char *)this - 16, v6, v11);
  v15 = v14;
  if ( v14 != -2018375668 && v14 < 0 )
    wil::details::in1diag3::FailFast_Hr(
      ...
      v18[0]);
  Microsoft::BamoImpl::CalloutWrapper<BamoImpl::BamoControllerNavigationManagerPrincipalImpl>::~CalloutWrapper<BamoImpl::BamoControllerNavigationManagerPrincipalImpl>((__int64)v18);
  if ( v10 )
