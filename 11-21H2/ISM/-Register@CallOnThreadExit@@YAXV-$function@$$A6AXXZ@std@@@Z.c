/*
 * XREFs of ?Register@CallOnThreadExit@@YAXV?$function@$$A6AXXZ@std@@@Z @ 0x180126408
 * Callers:
...
__int64 __fastcall CallOnThreadExit::Register(__int64 a1)
{
  ...
  v2 = _Mtx_lock((_Mtx_t)&unk_180242C60);
  if ( v2 )
    std::_Throw_C_error(v2);
  std::list<CallOnThreadExit::CallbackData>::_Emplace<>(v3, xmmword_180242FC0);
  v5 = *(_QWORD *)(xmmword_180242FC0 + 8) + 16LL;
  if ( v5 != a1 )
  {
    std::_Func_class<void,>::_Tidy(*(_QWORD *)(xmmword_180242FC0 + 8) + 16LL, v4);
  ...
  return std::_Func_class<void,>::_Tidy(a1, v12);
}
