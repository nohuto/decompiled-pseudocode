/*
 * XREFs of ?QueryInterface@BamoDeviceDockClientProxy@@UEAAJAEBU_GUID@@PEAPEAX@Z @ 0x180181490
 * Callers:
 *     ?QueryInterface@BamoDeviceDockClientProxy@@W7EAAJAEBU_GUID@@PEAPEAX@Z @ 0x1800529C0 (-QueryInterface@BamoDeviceDockClientProxy@@W7EAAJAEBU_GUID@@PEAPEAX@Z.c)
 * Callees:
