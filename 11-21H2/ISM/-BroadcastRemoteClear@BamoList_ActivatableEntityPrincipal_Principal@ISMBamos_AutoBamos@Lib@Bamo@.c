/*
 * XREFs of ?BroadcastRemoteClear@BamoList_ActivatableEntityPrincipal_Principal@ISMBamos_AutoBamos@Lib@Bamo@Microsoft@@UEAAJXZ @ 0x18008A480
 * Callers:
 *     <none>
 * Callees:
 ...
 *     ?CallRemoteClearOnStub@BamoList_ActivatableEntityPrincipal_PrincipalImpl@ISMBamos_AutoBamos@BamoImpl@Lib@Bamo@Microsoft@@CAJPEAVBamoStubImpl@36@@Z @ 0x18008A748 (-CallRemoteClearOnStub@BamoList_ActivatableEntityPrincipal_PrincipalImpl@ISMBamos_AutoBamos@Bamo.c)
 */
        ...
        struct Microsoft::BamoImpl::ConnectionIndirector **this)
{
  ...
  if ( *(_QWORD *)(v3 + 64) )
  {
    for ( i = this[5]; ; i = (struct Microsoft::BamoImpl::ConnectionIndirector *)*((_QWORD *)i + 6) )
    {
      ...
      if ( *((_BYTE *)i + 32) )
      {
        v9 = Microsoft::Bamo::Lib::BamoImpl::ISMBamos_AutoBamos::BamoList_ActivatableEntityPrincipal_PrincipalImpl::CallRemoteClearOnStub(i);
        v4 = v9;
        if ( v9 < 0 )
          break;
      }
