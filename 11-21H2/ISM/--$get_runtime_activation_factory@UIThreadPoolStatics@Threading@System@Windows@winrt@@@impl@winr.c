/*
 * XREFs of ??$get_runtime_activation_factory@UIThreadPoolStatics@Threading@System@Windows@winrt@@@impl@winrt@@YA?AUhresult@1@AEBUhstring@param@1@PEAPEAX@Z @ 0x1800C957C
 * Callers:
...
_DWORD *__fastcall winrt::impl::get_runtime_activation_factory<winrt::Windows::System::Threading::IThreadPoolStatics>(
        _DWORD *a1,
        __int64 *a2,
        __int64 a3)
{
  ...
  {
    *a1 = winrt_activation_handler(*a2, &winrt::impl::guid_v<winrt::Windows::System::Threading::IThreadPoolStatics>);
    return a1;
  }
  ___load_runtime_function_P6AHPEAXAEBUguid_winrt__PEAPEAX__EP6AH012__E_impl_winrt__YAXPEBDAEAP6AHPEAXAEBUguid_1_PEAPEAX__EP6AH123__E_Z(
    (__int64)a1,
    (FARPROC *)&`winrt::impl::get_runtime_activation_factory<winrt::Windows::System::Threading::IThreadPoolStatics>'::`2'::handler);
  v6 = ((__int64 (__fastcall *)(__int64, void *, __int64))`winrt::impl::get_runtime_activation_factory<winrt::Windows::System::Threading::IThreadPoolStatics>'::`2'::handler)(
         *a2,
         &winrt::impl::guid_v<winrt::Windows::System::Threading::IThreadPoolStatics>,
         a3);
  if ( v6 == -2147221008 )
  {
