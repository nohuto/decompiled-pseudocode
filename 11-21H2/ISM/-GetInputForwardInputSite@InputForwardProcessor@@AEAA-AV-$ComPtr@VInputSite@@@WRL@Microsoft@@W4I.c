/*
 * XREFs of ?GetInputForwardInputSite@InputForwardProcessor@@AEAA?AV?$ComPtr@VInputSite@@@WRL@Microsoft@@W4InputType@@PEAUHitTestResult@@@Z @ 0x1801A8CCC
 * Callers:
 ...
 *     ?ConvertInputTypeToCompositionInputType@HitTestHelper@@SA?BW4CompositionInputType@@W4InputType@@@Z @ 0x180198E8C (-ConvertInputTypeToCompositionInputType@HitTestHelper@@SA-BW4CompositionInputType@@W4InputType@@.c)
...
LABEL_30:
  ...
  while ( !v6 )
  {
    ...
    if ( !v12 )
    {
      ...
      if ( *(_DWORD *)LegacyInputSinkData::GetCompositionInputQueue(v14 + 48, v13) )
        goto LABEL_30;
...
LABEL_29:
  ...
  if ( !*(_DWORD *)LegacyInputSinkData::GetCompositionInputQueue(v21 + 48, v20) )
    goto LABEL_26;
  *a2 = *v8;
