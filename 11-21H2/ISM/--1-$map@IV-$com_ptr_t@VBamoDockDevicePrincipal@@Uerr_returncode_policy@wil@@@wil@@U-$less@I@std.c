/*
 * XREFs of ??1?$map@IV?$com_ptr_t@VBamoDockDevicePrincipal@@Uerr_returncode_policy@wil@@@wil@@U?$less@I@std@@V?$allocator@U?$pair@$$CBIV?$com_ptr_t@VBamoDockDevicePrincipal@@Uerr_returncode_policy@wil@@@wil@@@std@@@4@@std@@QEAA@XZ @ 0x18017CAFC
 * Callers:
 *     _DeviceDockServer::DeviceDockServer_::_1_::dtor$3 @ 0x180058728 (_DeviceDockServer--DeviceDockServer_--_1_--dtor$3.c)
 *     _DeviceDockServer::DeviceDockServer_::_1_::dtor$4 @ 0x18005873E (_DeviceDockServer--DeviceDockServer_--_1_--dtor$4.c)
 * Callees:
