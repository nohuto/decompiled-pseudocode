/*
 * XREFs of ?UpdateIsInputDisabled@BamoCUIHostInputObjectProxyImpl@BamoImpl@@QEAAJ_N0@Z @ 0x180128164
 * Callers:
 *     ?Thunk_UpdateIsInputDisabled_11@?$ICUIHostInputObjectProxy_Receive@VBamoCUIHostInputObjectProxyImpl@BamoImpl@@@@SAJPEAXPEAPEAX@Z @ 0x180127EF0 (-Thunk_UpdateIsInputDisabled_11@-$ICUIHostInputObjectProxy_Receive@VBamoCUIHostInputObjectProxyI.c)
