/*
 * XREFs of ??1?$map@KV?$list@V?$shared_ptr@UHotKeyInfo@@@std@@V?$allocator@V?$shared_ptr@UHotKeyInfo@@@std@@@2@@std@@U?$less@K@2@V?$allocator@U?$pair@$$CBKV?$list@V?$shared_ptr@UHotKeyInfo@@@std@@V?$allocator@V?$shared_ptr@UHotKeyInfo@@@std@@@2@@std@@@std@@@2@@std@@QEAA@XZ @ 0x1801D1FD0
 * Callers:
 *     _HotKeyProcessor::HotKeyProcessor_::_1_::dtor$2 @ 0x1801D1C0B (_HotKeyProcessor--HotKeyProcessor_--_1_--dtor$2.c)
 * Callees:
