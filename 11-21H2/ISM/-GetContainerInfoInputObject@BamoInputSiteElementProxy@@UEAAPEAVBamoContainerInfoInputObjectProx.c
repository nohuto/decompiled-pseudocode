/*
 * XREFs of ?GetContainerInfoInputObject@BamoInputSiteElementProxy@@UEAAPEAVBamoContainerInfoInputObjectProxy@@XZ @ 0x18000E340
 * Callers:
 *     <none>
 * Callees:
        ...
        BamoInputSiteElementProxy *this)
{
  ...
  return (struct BamoContainerInfoInputObjectProxy *)*((_QWORD *)this + 13);
}
