/*
 * XREFs of ?NotifyRouterDeviceId@GameInputServerProxy@@UEAAXPEBGI@Z @ 0x18003C3D0
 * Callers:
 *     <none>
 * Callees:
        ...
        unsigned int a3)
{
  ...
  *((_QWORD *)v8 + 3) = v12;
  ...
  Ptr = (GameInputServerProxy **)this[26].Ptr;
  if ( *Ptr != (GameInputServerProxy *)&this[25] )
    __fastfail(3u);
  *(_QWORD *)v8 = this + 25;
  *((_QWORD *)v8 + 1) = Ptr;
  *Ptr = (GameInputServerProxy *)v8;
  this[26].Ptr = v8;
  ++this[27].Ptr;
  ReleaseSRWLockExclusive(this + 28);
