/*
 * XREFs of ?UpdateCUIComponentInputObject@BamoInputSiteElementProxyImpl@BamoImpl@@QEAAJ_NI@Z @ 0x18000D254
 * Callers:
 *     ?Thunk_UpdateCUIComponentInputObject_8@?$IInputSiteElementProxy_Receive@VBamoInputSiteElementProxyImpl@BamoImpl@@@@SAJPEAXPEAPEAX@Z @ 0x180011CE0 (-Thunk_UpdateCUIComponentInputObject_8@-$IInputSiteElementProxy_Receive@VBamoInputSiteElementPro.c)
  ...
  if ( *((_BYTE *)this + 28) )
  {
    Microsoft::BamoImpl::CalloutWrapper<BamoImpl::BamoInputSiteElementProxyImpl>::CalloutWrapper<BamoImpl::BamoInputSiteElementProxyImpl>(
      ...
      *(_QWORD *)(*(_QWORD *)(*((_QWORD *)this + 2) + 24LL) + 32LL),
      this,
      1LL);
    v11 = (*(__int64 (__fastcall **)(char *, void (__fastcall ***)(_QWORD)))(*((_QWORD *)this - 2) + 248LL))(
            (char *)this - 16,
            v7);
    if ( v11 < 0 )
