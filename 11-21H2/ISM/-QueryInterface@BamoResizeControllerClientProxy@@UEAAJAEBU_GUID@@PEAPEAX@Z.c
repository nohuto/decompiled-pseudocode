/*
 * XREFs of ?QueryInterface@BamoResizeControllerClientProxy@@UEAAJAEBU_GUID@@PEAPEAX@Z @ 0x180114520
 * Callers:
 *     ?QueryInterface@BamoResizeControllerClientProxy@@W7EAAJAEBU_GUID@@PEAPEAX@Z @ 0x1800507A0 (-QueryInterface@BamoResizeControllerClientProxy@@W7EAAJAEBU_GUID@@PEAPEAX@Z.c)
 * Callees:
