/*
 * XREFs of ?OnTimerCallback@MPCHeadMovementDetector@@AEAAXXZ @ 0x1800B8660
 * Callers:
 *     _lambda_aa0eaa0d8a3377c6799a200e781869ec_::_lambda_invoker_cdecl_ @ 0x1800B7AD0 (_lambda_aa0eaa0d8a3377c6799a200e781869ec_--_lambda_invoker_cdecl_.c)
 * Callees:
 ...
 *     ?IdleTelemetry@MPCHeadMovementDetector@@AEAAXXZ @ 0x1800B84C8 (-IdleTelemetry@MPCHeadMovementDetector@@AEAAXXZ.c)
 *     ?QueueIdleTimerKick@MPCHeadMovementDetector@@AEAAXXZ @ 0x1800B8854 (-QueueIdleTimerKick@MPCHeadMovementDetector@@AEAAXXZ.c)
 *     ?WasThereSufficientYawMovement@MPCHeadMovementDetector@@AEAA_NXZ @ 0x1800B88E0 (-WasThereSufficientYawMovement@MPCHeadMovementDetector@@AEAA_NXZ.c)
 */
