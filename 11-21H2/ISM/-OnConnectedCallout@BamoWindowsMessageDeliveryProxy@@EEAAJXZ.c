/*
 * XREFs of ?OnConnectedCallout@BamoWindowsMessageDeliveryProxy@@EEAAJXZ @ 0x18000B670
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall BamoWindowsMessageDeliveryProxy::OnConnectedCallout(BamoWindowsMessageDeliveryProxy *this)
{
  __int64 v2; // rbp
  char *v3; // rbx
  int v4; // esi
  ...
  v3 = (char *)this + 16;
  v4 = (BamoWindowsMessageDeliveryProxy *)((char *)this + 16) != 0LL ? 3 : 0;
  if ( this != (BamoWindowsMessageDeliveryProxy *)-16LL )
  ...
  v8 = (*(__int64 (__fastcall **)(BamoWindowsMessageDeliveryProxy *))(*(_QWORD *)this + 32LL))(this);
  if ( v3 )
  {
    if ( (v4 & 2) != 0 )
    {
