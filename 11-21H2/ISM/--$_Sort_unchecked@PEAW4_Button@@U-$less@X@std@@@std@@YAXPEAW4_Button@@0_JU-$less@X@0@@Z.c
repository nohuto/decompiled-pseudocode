/*
 * XREFs of ??$_Sort_unchecked@PEAW4_Button@@U?$less@X@std@@@std@@YAXPEAW4_Button@@0_JU?$less@X@0@@Z @ 0x1801A6BD4
 * Callers:
 ...
 *     ??$_Pop_heap_hole_by_index@PEAW4_Button@@W41@U?$less@X@std@@@std@@YAXPEAW4_Button@@_J1$$QEAW41@U?$less@X@0@@Z @ 0x1801A6B30 (--$_Pop_heap_hole_by_index@PEAW4_Button@@W41@U-$less@X@std@@@std@@YAXPEAW4_Button@@_J1$$QEAW41@U.c)
 *     ??$_Sort_unchecked@PEAW4_Button@@U?$less@X@std@@@std@@YAXPEAW4_Button@@0_JU?$less@X@0@@Z @ 0x1801A6BD4 (--$_Sort_unchecked@PEAW4_Button@@U-$less@X@std@@@std@@YAXPEAW4_Button@@0_JU-$less@X@0@@Z.c)
 */
...
__int64 __fastcall std::_Sort_unchecked<enum _Button *,std::less<void>>(char *a1, int *a2, __int64 a3, char a4)
{
    ...
    if ( result <= 128 )
    {
      if ( i != v7 )
      {
        for ( j = i + 1; j != v7; ++j )
        {
          ...
          if ( *j >= *i )
          {
            for ( result = (__int64)j; ; v17 = (_DWORD *)result )
            {
              result -= 4LL;
  ...
  for ( k = ((char *)v7 - (char *)i) >> 3;
        k > 0;
        result = std::_Pop_heap_hole_by_index<enum _Button *,enum _Button,std::less<void>>((__int64)i, k, v13, &v20) )
  {
    v20 = i[--k];
  }
  if ( v13 >= 2 )
  {
    ...
    do
    {
      v20 = *v15;
      *v15 = *i;
      std::_Pop_heap_hole_by_index<enum _Button *,enum _Button,std::less<void>>((__int64)i, 0LL, v15 - i, &v20);
      result = ((unsigned __int64)--v15 + 4LL - (_QWORD)i) & 0xFFFFFFFFFFFFFFFCuLL;
    }
    while ( result >= 8 );
  }
  return result;
