/*
 * XREFs of ?GetComponentWindowId@BamoCUIComponentInputObjectProxy@@UEAA_KXZ @ 0x180126750
 * Callers:
 *     <none>
 * Callees:
...
unsigned __int64 __fastcall BamoCUIComponentInputObjectProxy::GetComponentWindowId(
