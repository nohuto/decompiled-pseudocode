/*
 * XREFs of ?OnEdgyNotificationSourceClientChanged@InputSiteElementProxy@@MEAAJXZ @ 0x180009210
 * Callers:
 *     <none>
 * Callees:
        ...
        const char *a4)
{
  ...
  for ( i = *(_QWORD *)(v5 + 488); i != v6; i += 16LL )
  {
    ...
    v12 = v11(v10, &GUID_2066a149_dd02_cdd2_a948_2c520fd9e943, &v23) >= 0;
    if ( v9 == this && v12 )
      break;
  }
  if ( i != *(_QWORD *)(v7 + 8) )
  ...
  Microsoft::WRL::ComPtr<IContainerInfoInputObjectProxy>::InternalRelease(&v23);
  v13 = *((_QWORD *)this + 39);
  v14 = (*(__int64 (__fastcall **)(char *))(*((_QWORD *)this + 1) + 160LL))((char *)this + 8);
  if ( v14 )
  {
    v16 = v14 + 8;
    v22 = v14 + 8;
