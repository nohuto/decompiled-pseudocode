/*
 * XREFs of ?InitializeProxyThunk@BamoInputSpacePayloadStubImpl@BamoImpl@@UEAAJXZ @ 0x180133330
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall BamoImpl::BamoInputSpacePayloadStubImpl::InitializeProxyThunk(
