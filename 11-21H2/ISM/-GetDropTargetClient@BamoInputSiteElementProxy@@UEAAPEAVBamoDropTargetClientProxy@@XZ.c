/*
 * XREFs of ?GetDropTargetClient@BamoInputSiteElementProxy@@UEAAPEAVBamoDropTargetClientProxy@@XZ @ 0x18000E030
 * Callers:
 *     <none>
 * Callees:
        ...
        BamoInputSiteElementProxy *this)
{
  ...
  return (struct BamoDropTargetClientProxy *)*((_QWORD *)this + 20);
}
