/*
 * XREFs of ??$GetStaticConstant@K@MPCConstantManager@@QEAAKW4InputType@@V?$basic_string_view@GU?$char_traits@G@std@@@std@@@Z @ 0x1800A5B1C
 * Callers:
...
__int64 __fastcall MPCConstantManager::GetStaticConstant<unsigned long>(__int64 a1, __int64 a2, __m128i *a3)
{
  const char *v5; // r9
  __int64 v6; // rax
  __int64 v7; // rcx
