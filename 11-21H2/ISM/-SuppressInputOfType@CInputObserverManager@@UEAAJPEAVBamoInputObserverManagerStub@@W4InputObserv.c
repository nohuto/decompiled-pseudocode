/*
 * XREFs of ?SuppressInputOfType@CInputObserverManager@@UEAAJPEAVBamoInputObserverManagerStub@@W4InputObserverType@InputObservation@@PEAVBamoInputObserverClientProxy@@@Z @ 0x18012D9C0
 * Callers:
 *     <none>
 * Callees:
 *     <none>
