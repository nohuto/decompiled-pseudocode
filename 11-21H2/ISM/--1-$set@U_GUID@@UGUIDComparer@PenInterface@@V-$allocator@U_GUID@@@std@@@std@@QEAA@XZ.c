/*
 * XREFs of ??1?$set@U_GUID@@UGUIDComparer@PenInterface@@V?$allocator@U_GUID@@@std@@@std@@QEAA@XZ @ 0x18018887C
 * Callers:
 *     _PenInterface::PenInterface_::_1_::dtor$6 @ 0x18018884A (_PenInterface--PenInterface_--_1_--dtor$6.c)
 * Callees:
