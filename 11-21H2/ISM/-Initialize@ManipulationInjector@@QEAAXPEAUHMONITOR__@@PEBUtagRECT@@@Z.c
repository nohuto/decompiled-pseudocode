/*
 * XREFs of ?Initialize@ManipulationInjector@@QEAAXPEAUHMONITOR__@@PEBUtagRECT@@@Z @ 0x180100230
 * Callers:
  ...
  *((_DWORD *)this + 184) = v9;
  ...
  switch ( *(_DWORD *)this )
  {
    ...
    case 2:
      ...
      dword_180241D0C = (int)(float)((float)((float)((float)v13 * 100.0) / (float)*((int *)this + 194)) + 0.5);
      dword_180241D2C = (int)v14;
      v29.x = *((_DWORD *)this + 5);
