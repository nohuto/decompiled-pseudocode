/*
 * XREFs of ??$SpatialInteractionDLL_EntryPointNotFound@AEAJ@RawInputProvidersTracing@@SAXAEAJ@Z @ 0x1800BD220
 * Callers:
...
__int64 __fastcall RawInputProvidersTracing::SpatialInteractionDLL_EntryPointNotFound<long &>(int *a1)
{
  __int64 result; // rax
  int v3; // r8d
  int v4; // r9d
