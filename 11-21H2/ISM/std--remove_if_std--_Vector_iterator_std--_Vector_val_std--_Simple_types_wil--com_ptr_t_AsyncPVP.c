/*
 * XREFs of std::remove_if_std::_Vector_iterator_std::_Vector_val_std::_Simple_types_wil::com_ptr_t_AsyncPVPrincipal_wil::err_exception_policy_________lambda_c91dbc00eed29fc6671fbd913f651dd6___ @ 0x1801630FC
 * Callers:
