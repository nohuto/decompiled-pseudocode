/*
 * XREFs of _CUIHierarchy::OnWindowWatcherStopped_::_1_::dtor$1 @ 0x180085F38
 * Callers:
 *     <none>
 * Callees:
 *     <none>
...
void __fastcall CUIHierarchy::OnWindowWatcherStopped_::_1_::dtor_1(__int64 a1, __int64 a2)
{
