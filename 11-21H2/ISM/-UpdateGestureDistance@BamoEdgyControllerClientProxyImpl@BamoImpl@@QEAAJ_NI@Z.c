/*
 * XREFs of ?UpdateGestureDistance@BamoEdgyControllerClientProxyImpl@BamoImpl@@QEAAJ_NI@Z @ 0x18014CC1C
 * Callers:
 *     ?Thunk_UpdateGestureDistance_8@?$IEdgyControllerClientProxy_Receive@VBamoEdgyControllerClientProxyImpl@BamoImpl@@@@SAJPEAXPEAPEAX@Z @ 0x18014CA50 (-Thunk_UpdateGestureDistance_8@-$IEdgyControllerClientProxy_Receive@VBamoEdgyControllerClientPro.c)
