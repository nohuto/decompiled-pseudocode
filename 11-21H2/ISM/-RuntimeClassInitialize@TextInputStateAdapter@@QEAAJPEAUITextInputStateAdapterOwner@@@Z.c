/*
 * XREFs of ?RuntimeClassInitialize@TextInputStateAdapter@@QEAAJPEAUITextInputStateAdapterOwner@@@Z @ 0x1801D74FC
 * Callers:
...
LABEL_18:
      ...
      else
      {
        ...
        FailFastWithHR(v7, retaddr, 0x384uLL);
      }
    }
    else if ( (Microsoft_WindowsPhone_InputEnableBits & 1) != 0 )
    {
      McTemplateU0sqq_EventWriteTransfer(v16, v15, "TextInputStateAdapter::RuntimeClassInitialize", 888LL, v7);
    }
  }
  else if ( (Microsoft_WindowsPhone_InputEnableBits & 1) != 0 )
  {
    McTemplateU0sqq_EventWriteTransfer(v12, v11, "TextInputStateAdapter::RuntimeClassInitialize", 885LL, v7);
  }
LABEL_26:
  v18 = v20;
  v20 = 0LL;
