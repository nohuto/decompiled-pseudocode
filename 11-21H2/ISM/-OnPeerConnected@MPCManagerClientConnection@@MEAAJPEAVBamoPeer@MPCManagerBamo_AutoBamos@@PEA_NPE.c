/*
 * XREFs of ?OnPeerConnected@MPCManagerClientConnection@@MEAAJPEAVBamoPeer@MPCManagerBamo_AutoBamos@@PEA_NPEAPEAVBamoPrincipal@Bamo@Microsoft@@@Z @ 0x18016E310
 * Callers:
 *     <none>
 * Callees:
        ...
        struct Microsoft::Bamo::BamoPrincipal **a4)
{
  ...
  *a3 = 1;
  v4 = *(struct Microsoft::Bamo::BamoPrincipal **)(*((_QWORD *)this + 30) + 1616LL);
  *a4 = v4;
