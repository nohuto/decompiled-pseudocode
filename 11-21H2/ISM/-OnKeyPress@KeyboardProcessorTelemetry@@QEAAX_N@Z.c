/*
 * XREFs of ?OnKeyPress@KeyboardProcessorTelemetry@@QEAAX_N@Z @ 0x180193CF0
 * Callers:
...
void __fastcall KeyboardProcessorTelemetry::OnKeyPress(KeyboardProcessorTelemetry *this)
{
  ...
  if ( (unsigned int)dword_180240410 > 5
    && (qword_180240420 & 0x200000000000LL) != 0
    && (qword_180240428 & 0x200000000000LL) == qword_180240428 )
  {
    v2 = *(_DWORD *)this;
    v4 = &v2;
    v6 = 0;
    ...
    tlgWriteTransfer_EventWriteTransfer(
      ...
      (unsigned __int8 *)dword_1802062D0,
      0LL,
      0LL,
      3u,
      &v3);
