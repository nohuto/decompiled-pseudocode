/*
 * XREFs of ?Thunk_Materialize_BamoHeatGripServiceProxy_5@?$IBamoPeer_ISMBamos_AutoBamos_Receive@VBamoPeerImpl@ISMBamos_AutoBamos@BamoImpl@@@@SAJPEAXPEAPEAX@Z @ 0x180117FB0
 * Callers:
 *     <none>
 * Callees:
