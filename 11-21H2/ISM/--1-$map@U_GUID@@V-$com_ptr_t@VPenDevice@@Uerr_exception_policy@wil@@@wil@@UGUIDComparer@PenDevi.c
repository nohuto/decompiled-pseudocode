/*
 * XREFs of ??1?$map@U_GUID@@V?$com_ptr_t@VPenDevice@@Uerr_exception_policy@wil@@@wil@@UGUIDComparer@PenDeviceManager@@V?$allocator@U?$pair@$$CBU_GUID@@V?$com_ptr_t@VPenDevice@@Uerr_exception_policy@wil@@@wil@@@std@@@std@@@std@@QEAA@XZ @ 0x180185DCC
 * Callers:
 *     _PenDeviceManager::PenDeviceManager_::_1_::dtor$1 @ 0x180185C34 (_PenDeviceManager--PenDeviceManager_--_1_--dtor$1.c)
 * Callees:
