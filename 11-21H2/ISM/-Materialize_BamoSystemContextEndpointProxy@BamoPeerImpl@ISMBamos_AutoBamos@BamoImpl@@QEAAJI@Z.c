/*
 * XREFs of ?Materialize_BamoSystemContextEndpointProxy@BamoPeerImpl@ISMBamos_AutoBamos@BamoImpl@@QEAAJI@Z @ 0x18010D6C0
 * Callers:
 *     ?Thunk_Materialize_BamoSystemContextEndpointProxy_5@?$IBamoPeer_ISMBamos_AutoBamos_Receive@VBamoPeerImpl@ISMBamos_AutoBamos@BamoImpl@@@@SAJPEAXPEAPEAX@Z @ 0x180118370 (-Thunk_Materialize_BamoSystemContextEndpointProxy_5@-$IBamoPeer_ISMBamos_AutoBamos_Receive@VBamo.c)
 * Callees:
