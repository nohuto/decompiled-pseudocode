/*
 * XREFs of ?GetInterfaceProperty@DevicePropertyHelper@DevicePropertyHelpers@@QEBAJAEBU_DEVPROPKEY@@KPEAEPEAK@Z @ 0x1800C0020
 * Callers:
 ...
 *     DevicePropertyHelpers::MapCrToHResult @ 0x1800C08D0 (DevicePropertyHelpers--MapCrToHResult.c)
 */
