/*
 * XREFs of ?QueryInterface@MouseProcessor@@UEAAJAEBU_GUID@@PEAPEAX@Z @ 0x18003D390
 * Callers:
 *     ?QueryInterface@MouseProcessor@@W7EAAJAEBU_GUID@@PEAPEAX@Z @ 0x180052D00 (-QueryInterface@MouseProcessor@@W7EAAJAEBU_GUID@@PEAPEAX@Z.c)
 *     ?QueryInterface@MouseProcessor@@WBA@EAAJAEBU_GUID@@PEAPEAX@Z @ 0x180052D20 (-QueryInterface@MouseProcessor@@WBA@EAAJAEBU_GUID@@PEAPEAX@Z.c)
 *     ?QueryInterface@MouseProcessor@@WBI@EAAJAEBU_GUID@@PEAPEAX@Z @ 0x180052D40 (-QueryInterface@MouseProcessor@@WBI@EAAJAEBU_GUID@@PEAPEAX@Z.c)
 *     ?QueryInterface@MouseProcessor@@WCA@EAAJAEBU_GUID@@PEAPEAX@Z @ 0x180052D60 (-QueryInterface@MouseProcessor@@WCA@EAAJAEBU_GUID@@PEAPEAX@Z.c)
 * Callees:
