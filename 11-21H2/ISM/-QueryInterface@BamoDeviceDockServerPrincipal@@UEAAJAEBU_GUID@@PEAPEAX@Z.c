/*
 * XREFs of ?QueryInterface@BamoDeviceDockServerPrincipal@@UEAAJAEBU_GUID@@PEAPEAX@Z @ 0x18017E7A0
 * Callers:
 *     ?QueryInterface@BamoDeviceDockServerPrincipal@@W7EAAJAEBU_GUID@@PEAPEAX@Z @ 0x180052900 (-QueryInterface@BamoDeviceDockServerPrincipal@@W7EAAJAEBU_GUID@@PEAPEAX@Z.c)
 * Callees:
