/*
 * XREFs of ?SendMaterializeProxy@BamoDataSourcePrincipalImpl@BamoImpl@@UEAAXPEAUIMessageCallSendHost@@PEAVBamoStubImpl@2Microsoft@@@Z @ 0x1800F7090
 * Callers:
 *     <none>
 * Callees:
        ...
        struct Microsoft::BamoImpl::BamoStubImpl *a3)
{
  ...
  LOWORD(v12) = 3;
  v8 = CoreUICallSend(a2, &v13, 2LL, 6LL);
  if ( v8 < 0 )
  ...
  v14 = *(unsigned int *)(v3 + 40);
  LOWORD(v12) = 4;
  v11 = CoreUICallSend(a2, &v13, 2LL, 6LL);
  if ( v11 < 0 )
    wil::details::in1diag3::FailFast_Hr(
      retaddr,
      (void *)0x28B5,
