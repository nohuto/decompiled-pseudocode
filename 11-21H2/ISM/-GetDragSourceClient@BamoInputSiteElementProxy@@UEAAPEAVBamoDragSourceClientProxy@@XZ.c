/*
 * XREFs of ?GetDragSourceClient@BamoInputSiteElementProxy@@UEAAPEAVBamoDragSourceClientProxy@@XZ @ 0x18000E0A0
 * Callers:
 *     <none>
 * Callees:
        ...
        BamoInputSiteElementProxy *this)
{
  ...
  return (struct BamoDragSourceClientProxy *)*((_QWORD *)this + 19);
}
