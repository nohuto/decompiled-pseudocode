        ...
        __int64 a13)
{
  ...
  __int64 v17; // rax
  struct _EVENT_DATA_DESCRIPTOR v19; // [rsp+30h] [rbp-B1h] BYREF
  __int64 v20; // [rsp+50h] [rbp-91h]
  __int64 v21; // [rsp+58h] [rbp-89h]
  unsigned __int16 *v22; // [rsp+60h] [rbp-81h]
  ...
  v24 = 0;
  v21 = 4LL;
  return tlgWriteTransfer_EventWriteTransfer(a1, a2, 0LL, 0LL, 0xBu, &v19);
}
