/*
 * XREFs of ??0?$CBaseInputObserverServer@$0M@@@IEAA@W4InputObserverType@InputObservation@@@Z @ 0x180043434
 * Callers:
  ...
  *(_QWORD *)(a1 + 224) = 0LL;
  ...
  if ( v5 < 0 )
    wil::details::in1diag3::FailFast_Hr(
      ...
      v7[0]);
  v7[0] = &std::_Func_impl_no_alloc<_lambda_d6a52f33f18072da6f3a09c89335510b_,void,_MIT_BASE_INPUT_OBSERVER_PACKET const *>::`vftable';
  v7[1] = a1;
  v7[7] = v7;
