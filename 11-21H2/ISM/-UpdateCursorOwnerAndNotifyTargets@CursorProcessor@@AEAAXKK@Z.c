/*
 * XREFs of ?UpdateCursorOwnerAndNotifyTargets@CursorProcessor@@AEAAXKK@Z @ 0x1801395F8
 * Callers:
 ...
 *     ?GenerateCursorOwnerMessage@CursorProcessor@@AEAAXKUCursorId@@_N@Z @ 0x180138FAC (-GenerateCursorOwnerMessage@CursorProcessor@@AEAAXKUCursorId@@_N@Z.c)
 */
