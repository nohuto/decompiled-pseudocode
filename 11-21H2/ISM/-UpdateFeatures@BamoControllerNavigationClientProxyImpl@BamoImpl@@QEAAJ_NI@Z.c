/*
 * XREFs of ?UpdateFeatures@BamoControllerNavigationClientProxyImpl@BamoImpl@@QEAAJ_NI@Z @ 0x180174A40
 * Callers:
 *     ?Thunk_UpdateFeatures_8@?$IControllerNavigationClientProxy_Receive@VBamoControllerNavigationClientProxyImpl@BamoImpl@@@@SAJPEAXPEAPEAX@Z @ 0x1801745C0 (-Thunk_UpdateFeatures_8@-$IControllerNavigationClientProxy_Receive@VBamoControllerNavigationClie.c)
