/*
 * XREFs of ?IsTargetForRoutingInfoAndHwnd@InputRedirectionTarget@@QEAA_NUtagMsgRoutingInfo@@_K@Z @ 0x1801B1DD8
 * Callers:
...
bool __fastcall InputRedirectionTarget::IsTargetForRoutingInfoAndHwnd(__int64 a1, __int64 a2, __int64 a3)
{
  ...
  if ( (*(int (__fastcall **)(_QWORD, _QWORD, _DWORD *))(**(_QWORD **)(a1 + 32) + 136LL))(
         *(_QWORD *)(a1 + 32),
         *(_QWORD *)(a1 + 40),
         v8) < 0
    || *(_DWORD *)a2 != v8[0]
