/*
 * XREFs of ?GetCurrentInputTypesString@MPCConstantManager@@AEAA?AV?$basic_string@GU?$char_traits@G@std@@V?$allocator@G@2@@std@@XZ @ 0x1800956C0
 * Callers:
...
__int64 __fastcall MPCConstantManager::GetCurrentInputTypesString(__int64 a1, __int64 a2)
{
  ...
  __m128i v9; // xmm1
  __int128 *v10; // rdx
  __int64 v12[2]; // [rsp+28h] [rbp-58h] BYREF
  ...
  v12[1] = a2;
  std::wstring::wstring(a2, word_1801F8EB4);
  v4 = 1;
  v5 = **(_QWORD **)(a1 + 56);
  v12[0] = v5;
  while ( !*(_BYTE *)(v5 + 25) )
