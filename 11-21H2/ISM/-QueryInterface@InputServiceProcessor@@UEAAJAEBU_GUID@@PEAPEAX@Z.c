/*
 * XREFs of ?QueryInterface@InputServiceProcessor@@UEAAJAEBU_GUID@@PEAPEAX@Z @ 0x1800358F0
 * Callers:
 *     ?QueryInterface@InputServiceProcessor@@W7EAAJAEBU_GUID@@PEAPEAX@Z @ 0x180051160 (-QueryInterface@InputServiceProcessor@@W7EAAJAEBU_GUID@@PEAPEAX@Z.c)
 * Callees:
