/*
 * XREFs of ?SetCursorShellMagnification@BamoSystemCursorControllerProxyImpl@BamoImpl@@QEAAJ_KM@Z @ 0x18011734C
 * Callers:
        ...
        const char *a4)
{
  ...
  struct IMessageCallSendHost *v10[2]; // [rsp+40h] [rbp-38h] BYREF
