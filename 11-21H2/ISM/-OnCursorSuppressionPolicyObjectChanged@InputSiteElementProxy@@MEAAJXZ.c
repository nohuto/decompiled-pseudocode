/*
 * XREFs of ?OnCursorSuppressionPolicyObjectChanged@InputSiteElementProxy@@MEAAJXZ @ 0x180009990
 * Callers:
 *     <none>
 * Callees:
        ...
        const char *a4)
{
  ...
  for ( i = *(_QWORD *)(v5 + 488); i != v6; i += 16LL )
  {
    ...
    v12 = v11(v10, &GUID_c1d339b0_71a2_9a06_32b0_40ee403cfafd, &v23) >= 0;
    if ( v9 == this && v12 )
      break;
  }
  if ( i != *(_QWORD *)(v7 + 8) )
  ...
  Microsoft::WRL::ComPtr<IContainerInfoInputObjectProxy>::InternalRelease(&v23);
  v13 = *((_QWORD *)this + 39);
  v14 = (*(__int64 (__fastcall **)(char *))(*((_QWORD *)this + 1) + 112LL))((char *)this + 8);
  if ( v14 )
  {
    v16 = v14 + 8;
    v22 = v14 + 8;
