/*
 * XREFs of ??$StateChange@AEAY07$$CBG@TestCursorTraceLogging@@SAXAEAY07$$CBG@Z @ 0x180138034
 * Callers:
...
int __fastcall TestCursorTraceLogging::StateChange<unsigned short const (&)[8]>(__int64 a1)
{
  __int64 *v1; // rax
  __int64 v2; // r8
  __int64 v3; // r9
