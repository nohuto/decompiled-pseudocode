/*
 * XREFs of ?UpdateZoomContacts@ManipulationInjector@@AEAAXIM@Z @ 0x180101D84
 * Callers:
 *     ?InjectZoom@ManipulationInjector@@QEAAXMK@Z @ 0x180101468 (-InjectZoom@ManipulationInjector@@QEAAXMK@Z.c)
 * Callees:
 *     ?UpdateZoomPoints@ManipulationInjector@@AEAAXAEAUtagPOINT@@0M@Z @ 0x180101E7C (-UpdateZoomPoints@ManipulationInjector@@AEAAXAEAUtagPOINT@@0M@Z.c)
 */
