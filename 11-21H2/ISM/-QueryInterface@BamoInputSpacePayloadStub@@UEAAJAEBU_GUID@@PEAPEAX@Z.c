/*
 * XREFs of ?QueryInterface@BamoInputSpacePayloadStub@@UEAAJAEBU_GUID@@PEAPEAX@Z @ 0x180134C10
 * Callers:
 *     ?QueryInterface@BamoInputSpacePayloadStub@@W7EAAJAEBU_GUID@@PEAPEAX@Z @ 0x180050CA0 (-QueryInterface@BamoInputSpacePayloadStub@@W7EAAJAEBU_GUID@@PEAPEAX@Z.c)
 * Callees:
