/*
 * XREFs of ??1?$unordered_map@W4TestCommandMessageType@@U?$pair@PEAXP6A_NPEAXPEAUTestCommandMessageDataHeader@@@Z@std@@U?$hash@W4TestCommandMessageType@@@3@U?$equal_to@W4TestCommandMessageType@@@3@V?$allocator@U?$pair@$$CBW4TestCommandMessageType@@U?$pair@PEAXP6A_NPEAXPEAUTestCommandMessageDataHeader@@@Z@std@@@std@@@3@@std@@QEAA@XZ @ 0x1800C43B8
 * Callers:
 *     _TestCommandHost::TestCommandHost_::_1_::dtor$2 @ 0x180054F32 (_TestCommandHost--TestCommandHost_--_1_--dtor$2.c)
 *     _MobileButtonDeviceCollection::MobileButtonDeviceCollection_::_1_::dtor$1 @ 0x1800C4352 (_MobileButtonDeviceCollection--MobileButtonDeviceCollection_--_1_--dtor$1.c)
 *     _EdgyProcessor::EdgyProcessor_::_1_::dtor$1 @ 0x1801483A7 (_EdgyProcessor--EdgyProcessor_--_1_--dtor$1.c)
 * Callees:
