/*
 * XREFs of ?ReadFeatureReport@SpatialRimDevice@SpatialInteractions@Internal@Windows@@UEAAJEPEAEK@Z @ 0x1800CC520
 * Callers:
 *     <none>
 * Callees:
 ...
 *     ?ReadFeatureReport_@RawInputProvidersTracing@@QEAAXJKE@Z @ 0x1800CC5BC (-ReadFeatureReport_@RawInputProvidersTracing@@QEAAXJKE@Z.c)
 */
