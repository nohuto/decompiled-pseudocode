/*
 * XREFs of ??0?$CalloutWrapper@VBamoSystemContextEndpointProxyImpl@BamoImpl@@@BamoImpl@Microsoft@@QEAA@PEAVBaseBamoConnectionImpl@12@PEAVBamoSystemContextEndpointProxyImpl@1@W4PrologEpilogConfig@12@@Z @ 0x1801372DC
 * Callers:
