/*
 * XREFs of ?UpdateCursorSuppressionPolicyObject@BamoInputSiteElementProxyImpl@BamoImpl@@QEAAJ_NI@Z @ 0x18000D0DC
 * Callers:
 *     ?Thunk_UpdateCursorSuppressionPolicyObject_8@?$IInputSiteElementProxy_Receive@VBamoInputSiteElementProxyImpl@BamoImpl@@@@SAJPEAXPEAPEAX@Z @ 0x180011CA0 (-Thunk_UpdateCursorSuppressionPolicyObject_8@-$IInputSiteElementProxy_Receive@VBamoInputSiteElem.c)
  ...
  if ( *((_BYTE *)this + 28) )
  {
    Microsoft::BamoImpl::CalloutWrapper<BamoImpl::BamoInputSiteElementProxyImpl>::CalloutWrapper<BamoImpl::BamoInputSiteElementProxyImpl>(
      ...
      *(_QWORD *)(*(_QWORD *)(*((_QWORD *)this + 2) + 24LL) + 32LL),
      this,
      1LL);
    v11 = (*(__int64 (__fastcall **)(char *, void (__fastcall ***)(_QWORD)))(*((_QWORD *)this - 2) + 280LL))(
            (char *)this - 16,
            v7);
    if ( v11 < 0 )
