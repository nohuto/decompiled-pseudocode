/*
 * XREFs of ?SampleRandomPickStart@InputServiceProxy@@AEAAXIIGGG_K@Z @ 0x180155414
 * Callers:
        ...
        unsigned __int64 a7)
{
  ...
  if ( LatencySampleStartData::MeasureDurationinMS(*((LatencySampleStartData **)this + 7), v23.QuadPart) > 60000.0 )
  {
    if ( (unsigned int)dword_1802404C8 > 5
      && (qword_1802404D8 & 0x400000000001LL) != 0
      && (qword_1802404E0 & 0x400000000001LL) == qword_1802404E0 )
    {
      v17 = *((_QWORD *)this + 7);
      v24 = *(_QWORD *)(v17 + 40);
