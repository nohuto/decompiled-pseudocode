/*
 * XREFs of ?AddProcessor@ContextualProcessorBuffer@@UEAAXPEAUIContextualProcessor@@UContextualProcessorInitialState@@@Z @ 0x1801A2150
 * Callers:
 *     <none>
 * Callees:
 ...
 *     ??0?$unordered_map@KW4ContextualProcessorState@@U?$hash@K@std@@U?$equal_to@K@3@V?$allocator@U?$pair@$$CBKW4ContextualProcessorState@@@std@@@3@@std@@QEAA@XZ @ 0x1801A1958 (--0-$unordered_map@KW4ContextualProcessorState@@U-$hash@K@std@@U-$equal_to@K@3@V-$allocator@U-$p.c)
 ...
 *     ??4?$ComPtr@UIContextualProcessor@@@WRL@Microsoft@@QEAAAEAV012@PEAUIContextualProcessor@@@Z @ 0x1801A1FB4 (--4-$ComPtr@UIContextualProcessor@@@WRL@Microsoft@@QEAAAEAV012@PEAUIContextualProcessor@@@Z.c)
 */
...
__int64 __fastcall ContextualProcessorBuffer::AddProcessor(__int64 a1, __int64 a2, __int64 a3)
{
  ...
  float v9[16]; // [rsp+38h] [rbp-C8h] BYREF
  ...
  v15 = a3;
  v8 = 0LL;
  std::unordered_map<unsigned long,enum ContextualProcessorState>::unordered_map<unsigned long,enum ContextualProcessorState>((__int64)v9);
