/*
 * XREFs of ?OnInput@MagnifierProcessor@@UEAAJPEAUInputInfo@@PEAVInputContext@@PEAUContextualProcessorResponse@@@Z @ 0x1801AFD80
 * Callers:
 *     <none>
 * Callees:
 ...
 *     ?CheckForTwoFingerTap@MagnifierRecognizer@@AEAAXXZ @ 0x1801B040C (-CheckForTwoFingerTap@MagnifierRecognizer@@AEAAXXZ.c)
    ...
    if ( *(_BYTE *)(v7 + 18) && *(_BYTE *)(v7 + 16) )
    {
      ...
      if ( v9 < 0 )
        wil::details::in1diag3::FailFast_Hr(
          ...
          v13);
      Microsoft::WRL::ComPtr<IInputTarget>::operator=((__int64 *)a4 + 10, &v16);
      v8 = 2;
      Microsoft::WRL::ComPtr<HotkeyRegistrationForwarder>::InternalRelease(&v16);
    }
LABEL_12:
