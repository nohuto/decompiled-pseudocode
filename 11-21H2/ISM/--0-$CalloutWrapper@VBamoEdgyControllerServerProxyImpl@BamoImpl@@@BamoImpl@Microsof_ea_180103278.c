/*
 * XREFs of ??0?$CalloutWrapper@VBamoEdgyControllerServerProxyImpl@BamoImpl@@@BamoImpl@Microsoft@@QEAA@PEAVBaseBamoConnectionImpl@12@PEAVBamoEdgyControllerServerProxyImpl@1@W4PrologEpilogConfig@12@@Z @ 0x180103278
 * Callers:
