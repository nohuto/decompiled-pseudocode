/*
 * XREFs of ??$?4AEAUVirtualTouchpadContextMessage@@$0A@@?$variant@Umonostate@std@@UInputConfigContextMessage@@UDisplayOcclusionContextMessage@@UVirtualTouchpadContextMessage@@UMIT_WIN32K_INPUTDESKTOP_STATE_MESSAGE@@@std@@QEAAAEAV01@AEAUVirtualTouchpadContextMessage@@@Z @ 0x18019D8B4
 * Callers:
 ...
 *     ?_Buy_raw@?$vector@UVirtualTouchpadRect@@V?$allocator@UVirtualTouchpadRect@@@std@@@std@@AEAAX_K@Z @ 0x18019E2C8 (-_Buy_raw@-$vector@UVirtualTouchpadRect@@V-$allocator@UVirtualTouchpadRect@@@std@@@std@@AEAAX_K@.c)
        ...
        __int64 a2)
{
  ...
  if ( *(_BYTE *)(a1 + 24) == 3 )
  {
    if ( a1 != a2 )
    {
      ...
      if ( 0xAAAAAAAAAAAAAAABuLL * (v5 >> 3) > 0xAAAAAAAAAAAAAAABuLL
  ...
  else
  {
    ...
    *(_OWORD *)v13 = 0LL;
    ...
    {
      v11 = v8 - v6;
      std::vector<VirtualTouchpadRect>::_Buy_raw(v13, 0xAAAAAAAAAAAAAAABuLL * (v11 >> 3));
      v9 = (char *)v13[0];
