/*
 * XREFs of ?UpdateTouchpadRectsRemoteCache@BamoSystemContextEndpointProxyImpl@BamoImpl@@AEAAXXZ @ 0x180137E38
 * Callers:
 *     ?PushStateToPrincipal@BamoSystemContextEndpointProxyImpl@BamoImpl@@UEAAXXZ @ 0x1801379E0 (-PushStateToPrincipal@BamoSystemContextEndpointProxyImpl@BamoImpl@@UEAAXXZ.c)
...
void __fastcall BamoImpl::BamoSystemContextEndpointProxyImpl::UpdateTouchpadRectsRemoteCache(
        BamoImpl::BamoSystemContextEndpointProxyImpl *this)
{
  ...
  {
    v2 = (struct Microsoft::Bamo::BamoPrincipal *)*((_QWORD *)this + 5);
    if ( v2 )
    ...
    v11[1] = v6;
    LOWORD(v10) = 2;
    v9 = CoreUICallSend(v8, v11, 2LL, 82LL);
