/*
 * XREFs of ?SetError@BamoAsyncResult_PROPVARIANT_PrincipalImpl@BamoImpl@@QEAAJH@Z @ 0x18016ECD8
 * Callers:
 *     ?Thunk_SetError_5@?$IAsyncResult_PROPVARIANT_Principal_Receive@VBamoAsyncResult_PROPVARIANT_PrincipalImpl@BamoImpl@@@@SAJPEAXPEAPEAX@Z @ 0x18016EF50 (-Thunk_SetError_5@-$IAsyncResult_PROPVARIANT_Principal_Receive@VBamoAsyncResult_PROPVARIANT_Prin.c)
 * Callees:
...
__int64 __fastcall BamoImpl::BamoAsyncResult_PROPVARIANT_PrincipalImpl::SetError(
        ...
        unsigned int a2)
{
  ...
  Microsoft::BamoImpl::CalloutWrapper<Microsoft::BamoImpl::CalloutWrapperObject>::CalloutWrapper<Microsoft::BamoImpl::CalloutWrapperObject>(
    ...
    *(_QWORD *)(*(_QWORD *)(v4[5] + 24LL) + 32LL),
    v7,
    0);
  v8 = (*(__int64 (__fastcall **)(char *, __int64, _QWORD))(*((_QWORD *)this - 2) + 88LL))((char *)this - 16, v6, a2);
  v12 = v8;
