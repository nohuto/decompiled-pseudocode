/*
 * XREFs of ?GetWindowsMessageDelivery@BamoInputSiteElementProxy@@UEAAPEAVBamoWindowsMessageDeliveryProxy@@XZ @ 0x18000D8C0
 * Callers:
 *     <none>
 * Callees:
        ...
        BamoInputSiteElementProxy *this)
{
  ...
  return (struct BamoWindowsMessageDeliveryProxy *)*((_QWORD *)this + 37);
}
