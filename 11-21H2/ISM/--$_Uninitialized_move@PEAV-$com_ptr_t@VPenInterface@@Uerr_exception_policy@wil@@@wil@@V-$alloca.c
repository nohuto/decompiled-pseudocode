...
__int64 *__fastcall std::_Uninitialized_move<wil::com_ptr_t<PenInterface,wil::err_exception_policy> *,std::allocator<wil::com_ptr_t<PenInterface,wil::err_exception_policy>>>(
        __int64 *a1,
        __int64 *a2,
        __int64 *a3)
{
