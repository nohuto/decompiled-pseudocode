/*
 * XREFs of ??$ReportFailure_GetLastError@$02@details@wil@@YAKPEAXIPEBD110@Z @ 0x180079EFC
 * Callers:
 ...
 *     ?_FailFast_GetLastError@in1diag0@details@wil@@YAXXZ @ 0x1800FF8D4 (-_FailFast_GetLastError@in1diag0@details@wil@@YAXXZ.c)
 * Callees:
