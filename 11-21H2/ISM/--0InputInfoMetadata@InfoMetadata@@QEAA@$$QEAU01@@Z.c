/*
 * XREFs of ??0InputInfoMetadata@InfoMetadata@@QEAA@$$QEAU01@@Z @ 0x1801A4D0C
 * Callers:
...
_QWORD *__fastcall InfoMetadata::InputInfoMetadata::InputInfoMetadata(_QWORD *a1, _QWORD *a2)
{
  ...
  if ( v4 )
  {
    if ( v4 == a2 )
    {
      ...
      std::_Func_class<void,>::_Tidy((__int64)a2, v5);
    }
    else
    {
      a1[7] = v4;
  ...
  if ( v6 )
  {
    if ( v6 == a2 + 8 )
    {
      ...
      std::_Func_class<void,>::_Tidy((__int64)(a2 + 8), v7);
    }
    else
    {
      a1[15] = v6;
  ...
  if ( v8 )
  {
    if ( v8 == a2 + 16 )
    {
      ...
      std::_Func_class<void,>::_Tidy((__int64)(a2 + 16), v9);
    }
    else
    {
      a1[23] = v8;
  ...
  if ( v10 )
  {
    if ( v10 == a2 + 24 )
    {
      ...
      std::_Func_class<void,>::_Tidy((__int64)(a2 + 24), v11);
    }
    else
    {
      a1[31] = v10;
  ...
  if ( v12 )
  {
    if ( v12 == a2 + 32 )
    {
      ...
      std::_Func_class<void,>::_Tidy((__int64)(a2 + 32), v13);
    }
    else
    {
      a1[39] = v12;
  ...
  if ( v15 )
  {
    if ( v15 == v14 )
    {
      ...
      std::_Func_class<void,>::_Tidy(v14, v16);
    }
    else
    {
      a1[47] = v15;
