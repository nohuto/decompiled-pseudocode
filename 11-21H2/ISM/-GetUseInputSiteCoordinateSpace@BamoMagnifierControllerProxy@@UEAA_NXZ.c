/*
 * XREFs of ?GetUseInputSiteCoordinateSpace@BamoMagnifierControllerProxy@@UEAA_NXZ @ 0x18014DAF0
 * Callers:
...
bool __fastcall BamoMagnifierControllerProxy::GetUseInputSiteCoordinateSpace(BamoMagnifierControllerProxy *this)
{
