/*
 * XREFs of ?QueryInterface@?QIHotKeyClientOwner@Text@Internal@UI@Windows@@PenEventsDispatcherPrincipal@@UEAAJAEBU_GUID@@PEAPEAX@Z @ 0x180191670
 * Callers:
 *     <none>
 * Callees:
        ...
        __int64 *a3)
{
  ...
  v8 = *a2 - *(_QWORD *)&GUID_fb214524_2b48_53a4_b071_c4494c472f10.Data1;
  if ( *a2 == *(_QWORD *)&GUID_fb214524_2b48_53a4_b071_c4494c472f10.Data1 )
    v8 = a2[1] - *(_QWORD *)GUID_fb214524_2b48_53a4_b071_c4494c472f10.Data4;
  if ( !v8 )
  {
    (*v7[2])((__int64)(v7 + 2));
