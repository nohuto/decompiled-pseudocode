/*
 * XREFs of ??0?$CalloutWrapper@VBamoSystemContextManagerPrincipalImpl@BamoImpl@@@BamoImpl@Microsoft@@QEAA@PEAVBaseBamoConnectionImpl@12@PEAVBamoSystemContextManagerPrincipalImpl@1@@Z @ 0x18013182C
 * Callers:
 ...
 * Callees:
 *     ??0?$CalloutWrapper@VBamoSystemContextManagerPrincipalImpl@BamoImpl@@@BamoImpl@Microsoft@@QEAA@PEAVBaseBamoConnectionImpl@12@PEAVBamoSystemContextManagerPrincipalImpl@1@W4PrologEpilogConfig@12@@Z @ 0x180131858 (--0-$CalloutWrapper@VBamoSystemContextManagerPrincipalImpl@BamoImpl@@@BamoImpl@Micr_ea_180131858.c)
 */
