/*
 * XREFs of ?Materialize_BamoInputInjectionClientProxy@BamoPeerImpl@ISMBamos_AutoBamos@BamoImpl@@QEAAJI@Z @ 0x18010C428
 * Callers:
 *     ?Thunk_Materialize_BamoInputInjectionClientProxy_5@?$IBamoPeer_ISMBamos_AutoBamos_Receive@VBamoPeerImpl@ISMBamos_AutoBamos@BamoImpl@@@@SAJPEAXPEAPEAX@Z @ 0x180118070 (-Thunk_Materialize_BamoInputInjectionClientProxy_5@-$IBamoPeer_ISMBamos_AutoBamos_Receive@VBamoP.c)
 * Callees:
        ...
        __int64 a3)
{
  ...
  *((_QWORD *)v15 + 4) = 0LL;
  v15[10] = 0;
  v15[11] = 0;
  *((_QWORD *)v15 + 2) = &BamoImpl::BamoInputInjectionClientProxyImpl::`vftable';
  *((_QWORD *)v15 + 6) = 0LL;
  *(_QWORD *)v15 = &InputInjectionClientProxy::`vftable'{for `Microsoft::Bamo::BamoProxy'};
  *((_QWORD *)v15 + 1) = &InputInjectionClientProxy::`vftable'{for `IInputInjectionClientProxy'};
  *((_BYTE *)v15 + 56) = 0;
  Microsoft::BamoImpl::CalloutWrapper<Microsoft::BamoImpl::CalloutWrapperObject>::~CalloutWrapper<Microsoft::BamoImpl::CalloutWrapperObject>(
    v13,
    v5,
    v6,
    v7);
  v8 = (*(__int64 (__fastcall **)(_DWORD *))(*(_QWORD *)v15 + 56LL))(v15);
