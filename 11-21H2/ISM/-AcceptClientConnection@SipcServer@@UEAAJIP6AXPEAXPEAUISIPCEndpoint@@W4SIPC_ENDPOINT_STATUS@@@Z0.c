/*
 * XREFs of ?AcceptClientConnection@SipcServer@@UEAAJIP6AXPEAXPEAUISIPCEndpoint@@W4SIPC_ENDPOINT_STATUS@@@Z0PEAPEAU2@@Z @ 0x1800FD400
 * Callers:
 *     <none>
 * Callees:
        ...
        struct ISIPCEndpoint **a5)
{
  ...
  *a5 = 0LL;
  if ( !a3 )
  {
    v9 = -2147024809;
LABEL_3:
    wil::details::in1diag0::Return_Hr((wil::details::in1diag0 *)v9, a2, 0LL, (__int64)a4);
    return v9;
  }
  v11 = *((_QWORD *)this + 16);
  if ( !v11 )
