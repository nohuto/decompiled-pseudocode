/*
 * XREFs of ?WilApi_RecordFeatureUsage@details@wil@@YAXIIIPEBD@Z @ 0x18007EB28
 * Callers:
 ...
 *     ?RecordSRUMFeatureUsage@details@wil@@YAXIII@Z @ 0x18007D090 (-RecordSRUMFeatureUsage@details@wil@@YAXIII@Z.c)
 * Callees:
