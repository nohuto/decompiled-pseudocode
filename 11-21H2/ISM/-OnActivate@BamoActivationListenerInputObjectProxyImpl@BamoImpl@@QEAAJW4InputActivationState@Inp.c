/*
 * XREFs of ?OnActivate@BamoActivationListenerInputObjectProxyImpl@BamoImpl@@QEAAJW4InputActivationState@Input@UI@Windows@@@Z @ 0x18010DF4C
 * Callers:
        ...
        const char *a4)
{
  ...
  else
  {
    ...
    if ( v6 >= 0 )
    {
      ...
      v10[0] = v12;
      v10[1] = v13;
      return CoreUICallSend(v8, v10, 2LL, 4LL);
    }
    else
    {
      wil::details::in1diag3::Return_Hr(
