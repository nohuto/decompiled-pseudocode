/*
 * XREFs of ?StartAnimationCallBack@Edgy@InputETW@@SAX_K00@Z @ 0x18014B328
 * Callers:
...
void __fastcall InputETW::Edgy::StartAnimationCallBack(union _RTL_RUN_ONCE *a1, __int64 a2, __int64 a3)
{
  __int64 v6; // r8
  __int64 v7; // r9
  __int64 v8; // rcx
