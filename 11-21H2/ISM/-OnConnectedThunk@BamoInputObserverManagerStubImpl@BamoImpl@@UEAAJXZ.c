/*
 * XREFs of ?OnConnectedThunk@BamoInputObserverManagerStubImpl@BamoImpl@@UEAAJXZ @ 0x180010A40
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall BamoImpl::BamoInputObserverManagerStubImpl::OnConnectedThunk(
