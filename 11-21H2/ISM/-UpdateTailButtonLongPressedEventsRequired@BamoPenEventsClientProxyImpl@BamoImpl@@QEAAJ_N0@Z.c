/*
 * XREFs of ?UpdateTailButtonLongPressedEventsRequired@BamoPenEventsClientProxyImpl@BamoImpl@@QEAAJ_N0@Z @ 0x180048D84
 * Callers:
 *     ?Thunk_UpdateTailButtonLongPressedEventsRequired_11@?$IPenEventsClientProxy_Receive@VBamoPenEventsClientProxyImpl@BamoImpl@@@@SAJPEAXPEAPEAX@Z @ 0x1800492E0 (-Thunk_UpdateTailButtonLongPressedEventsRequired_11@-$IPenEventsClientProxy_Receive@VBamoPenEven.c)
