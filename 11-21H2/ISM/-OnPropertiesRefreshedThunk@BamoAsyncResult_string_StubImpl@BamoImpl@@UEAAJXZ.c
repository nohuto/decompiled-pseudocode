/*
 * XREFs of ?OnPropertiesRefreshedThunk@BamoAsyncResult_string_StubImpl@BamoImpl@@UEAAJXZ @ 0x18016F380
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall BamoImpl::BamoAsyncResult_string_StubImpl::OnPropertiesRefreshedThunk(
