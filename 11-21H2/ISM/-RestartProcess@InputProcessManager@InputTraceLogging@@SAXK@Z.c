/*
 * XREFs of ?RestartProcess@InputProcessManager@InputTraceLogging@@SAXK@Z @ 0x180196694
 * Callers:
...
void __fastcall InputTraceLogging::InputProcessManager::RestartProcess(__int64 a1)
{
  __int64 v1; // rbx
  __int64 v2; // rcx
    ...
    && (*(_QWORD *)(v2 + 24) & 0x200LL) == *(_QWORD *)(v2 + 24) )
  {
    ...
    v3 = v1;
    v6 = 8;
    tlgWriteTransfer_EventWriteTransfer(v2, (unsigned __int8 *)dword_180206360, 0LL, 0LL, 3u, &v4);
  }
}
