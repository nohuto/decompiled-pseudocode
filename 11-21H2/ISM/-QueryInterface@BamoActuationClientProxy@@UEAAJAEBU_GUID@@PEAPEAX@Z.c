/*
 * XREFs of ?QueryInterface@BamoActuationClientProxy@@UEAAJAEBU_GUID@@PEAPEAX@Z @ 0x1801133B0
 * Callers:
 *     ?QueryInterface@BamoActuationClientProxy@@W7EAAJAEBU_GUID@@PEAPEAX@Z @ 0x1800503C0 (-QueryInterface@BamoActuationClientProxy@@W7EAAJAEBU_GUID@@PEAPEAX@Z.c)
 * Callees:
