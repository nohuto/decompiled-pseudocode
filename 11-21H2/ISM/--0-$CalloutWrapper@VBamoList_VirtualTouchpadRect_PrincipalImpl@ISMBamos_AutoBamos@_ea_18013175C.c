/*
 * XREFs of ??0?$CalloutWrapper@VBamoList_VirtualTouchpadRect_PrincipalImpl@ISMBamos_AutoBamos@BamoImpl@Lib@Bamo@Microsoft@@@BamoImpl@Microsoft@@QEAA@PEAVBaseBamoConnectionImpl@12@PEAVBamoList_VirtualTouchpadRect_PrincipalImpl@ISMBamos_AutoBamos@1Lib@Bamo@2@W4PrologEpilogConfig@12@@Z @ 0x18013175C
 * Callers:
