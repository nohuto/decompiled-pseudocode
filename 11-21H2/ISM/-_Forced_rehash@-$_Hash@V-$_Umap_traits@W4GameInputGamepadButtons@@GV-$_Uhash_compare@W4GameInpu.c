/*
 * XREFs of ?_Forced_rehash@?$_Hash@V?$_Umap_traits@W4GameInputGamepadButtons@@GV?$_Uhash_compare@W4GameInputGamepadButtons@@U?$hash@W4GameInputGamepadButtons@@@std@@U?$equal_to@W4GameInputGamepadButtons@@@3@@std@@V?$allocator@U?$pair@$$CBW4GameInputGamepadButtons@@G@std@@@3@$0A@@std@@@std@@IEAAX_K@Z @ 0x18017A7C0
 * Callers:
...
__int64 __fastcall std::_Hash<std::_Umap_traits<enum GameInputGamepadButtons,unsigned short,std::_Uhash_compare<enum GameInputGamepadButtons,std::hash<enum GameInputGamepadButtons>,std::equal_to<enum GameInputGamepadButtons>>,std::allocator<std::pair<enum GameInputGamepadButtons const,unsigned short>>,0>>::_Forced_rehash(
        __int64 a1,
        unsigned __int64 a2)
{
  ...
  result = (__int64)std::_Hash_vec<std::allocator<std::_List_unchecked_iterator<std::_List_val<std::_List_simple_types<std::pair<unsigned long const,ResizeProcessor::MessageInfo>>>>>>::_Assign_grow(
                      (__int64)&qword_180243058,
                      2 * v5,
                      qword_180243048);
  v8 = v5 - 1;
  qword_180243078 = v5;
  qword_180243070 = v5 - 1;
  v9 = *(const unsigned __int8 **)qword_180243048;
  v10 = *(const unsigned __int8 **)qword_180243048;
  while ( v9 != (const unsigned __int8 *)v3 )
  {
    ...
    v13 = qword_180243058;
    v14 = 2 * (v8 & result);
    if ( *(_QWORD *)(qword_180243058 + 16 * (v8 & result)) == v3 )
    {
      *(_QWORD *)(qword_180243058 + 16 * (v8 & result)) = v12;
LABEL_7:
      *(_QWORD *)(v13 + 8 * v14 + 8) = v12;
      goto LABEL_15;
    }
    result = *(_QWORD *)(qword_180243058 + 16 * (v8 & result) + 8);
    v7 = *v11;
    ...
    while ( 1 )
    {
      ...
      if ( *(_QWORD *)(qword_180243058 + 8 * v14) == result )
        break;
      result = *v17;
