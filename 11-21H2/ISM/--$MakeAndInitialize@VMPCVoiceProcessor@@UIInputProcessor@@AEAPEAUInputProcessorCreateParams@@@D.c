/*
 * XREFs of ??$MakeAndInitialize@VMPCVoiceProcessor@@UIInputProcessor@@AEAPEAUInputProcessorCreateParams@@@Details@WRL@Microsoft@@YAJPEAPEAUIInputProcessor@@AEAPEAUInputProcessorCreateParams@@@Z @ 0x180194834
 * Callers:
 *     ?Create@MPCVoiceProcessor@@SAJPEAUInputProcessorCreateParams@@PEAPEAUIInputProcessor@@@Z @ 0x180194A00 (-Create@MPCVoiceProcessor@@SAJPEAUInputProcessorCreateParams@@PEAPEAUIInputProcessor@@@Z.c)
 * Callees:
...
{
  MPCVoiceProcessor *v4; // rax
  MPCVoiceProcessor *v5; // rbx
  MPCVoiceProcessor *v6; // rdi
  int v7; // esi
  volatile int *v8; // rdx

  *a1 = 0LL;
  v4 = (MPCVoiceProcessor *)operator new(0xE58uLL, (const struct std::nothrow_t *)&std::nothrow);
  v5 = v4;
  v6 = v4;
  if ( v4 )
  {
    ...
    *((_QWORD *)v5 + 3) = &MPCVoiceProcessor::`vftable'{for `Microsoft::WRL::Details::ImplementsHelper<Microsoft::WRL::RuntimeClassFlags<2>,1,IMPCInputProviderBase>'};
    *((_BYTE *)v5 + 3664) = 0;
    v7 = MPCVoiceProcessor::RuntimeClassInitialize(v6, *a2);
    if ( v7 >= 0 )
