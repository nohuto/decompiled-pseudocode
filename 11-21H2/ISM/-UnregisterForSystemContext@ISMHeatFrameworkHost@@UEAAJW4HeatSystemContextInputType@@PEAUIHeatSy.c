/*
 * XREFs of ?UnregisterForSystemContext@ISMHeatFrameworkHost@@UEAAJW4HeatSystemContextInputType@@PEAUIHeatSystemContextClient@@@Z @ 0x180184C80
 * Callers:
 *     <none>
 * Callees:
 ...
 *     ?erase@?$_Hash@V?$_Uset_traits@PEAUIHeatSystemContextClient@@V?$_Uhash_compare@PEAUIHeatSystemContextClient@@U?$hash@PEAUIHeatSystemContextClient@@@std@@U?$equal_to@PEAUIHeatSystemContextClient@@@3@@std@@V?$allocator@PEAUIHeatSystemContextClient@@@3@$0A@@std@@@std@@QEAA_KAEBQEAUIHeatSystemContextClient@@@Z @ 0x1801851AC (-erase@-$_Hash@V-$_Uset_traits@PEAUIHeatSystemContextClient@@V-$_Uhash_compare@PEAUIHeatSystemCo.c)
 */
...
__int64 __fastcall ISMHeatFrameworkHost::UnregisterForSystemContext(__int64 *a1, int a2, __int64 a3, const char *a4)
{
  ...
  if ( v5 )
  {
    ...
    if ( v6 )
    {
      ...
      if ( a1[30] )
        return 0LL;
      v9 = (*(__int64 (__fastcall **)(__int64, __int64 *))(*(_QWORD *)*v7 + 32LL))(*v7, a1 + 1);
      if ( v9 < 0 )
      {
        v10 = 288LL;
LABEL_26:
