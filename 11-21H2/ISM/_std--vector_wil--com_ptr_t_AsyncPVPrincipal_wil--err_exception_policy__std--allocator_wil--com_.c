/*
 * XREFs of _std::vector_wil::com_ptr_t_AsyncPVPrincipal_wil::err_exception_policy__std::allocator_wil::com_ptr_t_AsyncPVPrincipal_wil::err_exception_policy_____::_Emplace_reallocate_AsyncPVPrincipal____::_1_::catch$0 @ 0x180162ADF
 * Callers:
 *     <none>
 * Callees:
