/*
 * XREFs of ?FindRegisteredClient@HotKeyProcessor@@AEAAJAEBUMessageObjectID@@PEAPEAVHotkeyClientRegistration@@@Z @ 0x1801D3518
 * Callers:
 ...
 *     std::find_if_std::_List_const_iterator_std::_List_val_std::_List_simple_types_Microsoft::WRL::ComPtr_HotkeyClientRegistration_________lambda_b8c8c5ee32330bcac3385f4c759279f3___ @ 0x1801D14B0 (std--find_if_std--_List_const_iterator_std--_List_val_std--_List_simple_types_Microsoft--WRL--Co.c)
        ...
        struct HotkeyClientRegistration **a3)
{
  ...
  {
    v3 = -2147024809;
    FailFastWithHR(-2147024809, retaddr, 0x405uLL);
  }
  return v3;
}
