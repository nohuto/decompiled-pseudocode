/*
 * XREFs of ??1DWMInputRouter@@MEAA@XZ @ 0x180199D30
 * Callers:
 *     _MPCInputRouter::MPCInputRouter_::_1_::dtor$0 @ 0x1800569E0 (_MPCInputRouter--MPCInputRouter_--_1_--dtor$0.c)
...
void __fastcall DWMInputRouter::~DWMInputRouter(DWMInputRouter *this)
{
  ...
  *((_QWORD *)this + 93) = 0LL;
  ...
  Microsoft::WRL::ComPtr<IContainerInfoInputObjectProxy>::InternalRelease((__int64 *)this + 41);
