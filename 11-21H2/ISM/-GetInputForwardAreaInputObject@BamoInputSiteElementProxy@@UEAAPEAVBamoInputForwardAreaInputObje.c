/*
 * XREFs of ?GetInputForwardAreaInputObject@BamoInputSiteElementProxy@@UEAAPEAVBamoInputForwardAreaInputObjectProxy@@XZ @ 0x18000DE70
 * Callers:
 *     <none>
 * Callees:
        ...
        BamoInputSiteElementProxy *this)
{
  ...
  return (struct BamoInputForwardAreaInputObjectProxy *)*((_QWORD *)this + 24);
}
