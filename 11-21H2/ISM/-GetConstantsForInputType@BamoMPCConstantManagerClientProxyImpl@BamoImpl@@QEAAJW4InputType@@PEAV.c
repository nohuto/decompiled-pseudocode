/*
 * XREFs of ?GetConstantsForInputType@BamoMPCConstantManagerClientProxyImpl@BamoImpl@@QEAAJW4InputType@@PEAVBamoAsyncResult_string_Principal@@@Z @ 0x18015A37C
 * Callers:
        ...
        const char *a4)
{
  ...
  else
  {
    ...
    if ( v7 >= 0 )
    {
      ...
      return CoreUICallSend(v10, v17, 2LL, 1LL);
    }
    else
    {
      wil::details::in1diag3::Return_Hr(
