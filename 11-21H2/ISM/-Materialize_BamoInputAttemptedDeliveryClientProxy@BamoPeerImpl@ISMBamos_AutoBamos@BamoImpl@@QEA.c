/*
 * XREFs of ?Materialize_BamoInputAttemptedDeliveryClientProxy@BamoPeerImpl@ISMBamos_AutoBamos@BamoImpl@@QEAAJI@Z @ 0x18010C050
 * Callers:
 *     ?Thunk_Materialize_BamoInputAttemptedDeliveryClientProxy_5@?$IBamoPeer_ISMBamos_AutoBamos_Receive@VBamoPeerImpl@ISMBamos_AutoBamos@BamoImpl@@@@SAJPEAXPEAPEAX@Z @ 0x180117FF0 (-Thunk_Materialize_BamoInputAttemptedDeliveryClientProxy_5@-$IBamoPeer_ISMBamos_AutoBamos_Receiv.c)
 * Callees:
