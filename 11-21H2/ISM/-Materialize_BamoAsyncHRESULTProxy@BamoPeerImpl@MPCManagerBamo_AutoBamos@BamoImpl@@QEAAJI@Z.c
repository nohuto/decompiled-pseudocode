/*
 * XREFs of ?Materialize_BamoAsyncHRESULTProxy@BamoPeerImpl@MPCManagerBamo_AutoBamos@BamoImpl@@QEAAJI@Z @ 0x1800993E4
 * Callers:
 *     ?Thunk_Materialize_BamoAsyncHRESULTProxy_11@?$IBamoPeer_MPCManagerBamo_AutoBamos_Receive@VBamoPeerImpl@MPCManagerBamo_AutoBamos@BamoImpl@@@@SAJPEAXPEAPEAX@Z @ 0x18009B8B0 (-Thunk_Materialize_BamoAsyncHRESULTProxy_11@-$IBamoPeer_MPCManagerBamo_AutoBamos_Receive@VBamoPe.c)
 * Callees:
