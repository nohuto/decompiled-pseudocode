/*
 * XREFs of ??1DeviceDockServer@@UEAA@XZ @ 0x18017CBA4
 * Callers:
...
void __fastcall DeviceDockServer::~DeviceDockServer(DeviceDockServer *this)
{
  ...
  wil::com_ptr_t<BamoManualDragAreaClientProxy,wil::err_returncode_policy>::~com_ptr_t<BamoManualDragAreaClientProxy,wil::err_returncode_policy>((__int64 *)this + 10);
