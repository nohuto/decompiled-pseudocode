/*
 * XREFs of ?SetCursorClientOwner@SystemCursorService2@@UEAAJUCursorId@@@Z @ 0x1800ED630
 * Callers:
 *     <none>
 * Callees:
...
LABEL_3:
  ...
  v12 = v3;
  v7 = *(_QWORD *)std::_Hash<std::_Umap_traits<unsigned __int64,unsigned __int64,std::_Uhash_compare<unsigned __int64,std::hash<unsigned __int64>,std::equal_to<unsigned __int64>>,std::allocator<std::pair<unsigned __int64 const,unsigned __int64>>,0>>::_Try_emplace<unsigned __int64 const &,>(
                    a1 + 44,
                    (__int64)v10,
                    &v12);
  v8 = *(_QWORD *)a1;
