/*
 * XREFs of ??$ActivateInstance@UIInputPriv@Internal@Spatial@Input@UI@Windows@@@Foundation@Windows@@YAJPEAUHSTRING__@@PEAPEAUIInputPriv@Internal@Spatial@Input@UI@1@@Z @ 0x1800B6FE8
 * Callers:
