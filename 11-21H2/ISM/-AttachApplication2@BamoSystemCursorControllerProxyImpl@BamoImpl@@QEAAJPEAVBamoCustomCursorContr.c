/*
 * XREFs of ?AttachApplication2@BamoSystemCursorControllerProxyImpl@BamoImpl@@QEAAJPEAVBamoCustomCursorControllerClient2Principal@@@Z @ 0x180106D2C
 * Callers:
        ...
        const char *a4)
{
  ...
  struct IMessageCallSendHost *v22; // [rsp+98h] [rbp+20h] BYREF
  ...
  else
  {
    ...
    if ( v7 >= 0 )
    {
      ...
      *(_QWORD *)&v17 = v20;
      *((_QWORD *)&v17 + 1) = v21;
      return CoreUICallSend(v10, &v17, 2LL, 84LL);
    }
    else
    {
      wil::details::in1diag3::Return_Hr(
