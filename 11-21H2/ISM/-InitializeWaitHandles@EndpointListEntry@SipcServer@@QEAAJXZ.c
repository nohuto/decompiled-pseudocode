/*
 * XREFs of ?InitializeWaitHandles@EndpointListEntry@SipcServer@@QEAAJXZ @ 0x1800FED74
 * Callers:
 ...
 *     ?GetWaitHandles@SipcEndpoint@@QEBAXAEAPEAX00@Z @ 0x1800FEC7C (-GetWaitHandles@SipcEndpoint@@QEBAXAEAPEAX00@Z.c)
 */
