/*
 * XREFs of ?QueryInterface@BamoAsyncResult_string_Stub@@UEAAJAEBU_GUID@@PEAPEAX@Z @ 0x18016F490
 * Callers:
 *     ?QueryInterface@BamoAsyncResult_string_Stub@@W7EAAJAEBU_GUID@@PEAPEAX@Z @ 0x180052720 (-QueryInterface@BamoAsyncResult_string_Stub@@W7EAAJAEBU_GUID@@PEAPEAX@Z.c)
 * Callees:
