/*
 * XREFs of ?RegisterOverride@BamoControllerNavigationManagerProxyImpl@BamoImpl@@QEAAJPEAVBamoControllerNavigationOverridePrincipal@@@Z @ 0x180115E4C
 * Callers:
        ...
        const char *a4)
{
  ...
  else
  {
    ...
    if ( v7 >= 0 )
    {
      ...
      *(_QWORD *)&v17 = v20;
      *((_QWORD *)&v17 + 1) = v21;
      return CoreUICallSend(v10, &v17, 2LL, 18LL);
    }
    else
    {
      wil::details::in1diag3::Return_Hr(
