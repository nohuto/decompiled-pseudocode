/*
 * XREFs of ?DropTargetChanged@BamoDragManagerClientProxyImpl@BamoImpl@@QEAAJIAEBUtagPOINT@@00AEBUtagPOINTF@@_KW4VirtualKeyModifiers@System@Windows@@PEBUDragInfoStruct@@I2@Z @ 0x180109250
 * Callers:
        ...
        struct IMessageCallSendHost **a6)
{
  ...
  unsigned int v15; // [rsp+80h] [rbp-39h] BYREF
  struct IMessageCallSendHost *v16[4]; // [rsp+88h] [rbp-31h] BYREF
  _QWORD v17[3]; // [rsp+A8h] [rbp-11h] BYREF
  wil::details::in1diag3 *retaddr; // [rsp+E8h] [rbp+2Fh]
  unsigned int v19; // [rsp+F0h] [rbp+37h] BYREF
