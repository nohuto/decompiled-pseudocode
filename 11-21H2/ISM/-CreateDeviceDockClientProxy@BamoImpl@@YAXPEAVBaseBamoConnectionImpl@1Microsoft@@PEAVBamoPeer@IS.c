/*
 * XREFs of ?CreateDeviceDockClientProxy@BamoImpl@@YAXPEAVBaseBamoConnectionImpl@1Microsoft@@PEAVBamoPeer@ISMBamos_AutoBamos@@PEAPEAVBamoProxy@Bamo@3@@Z @ 0x180107A80
 * Callers:
 ...
 *     ??0DeviceDockClientProxy@@QEAA@PEAVDeviceDockServer@@@Z @ 0x1801805E4 (--0DeviceDockClientProxy@@QEAA@PEAVDeviceDockServer@@@Z.c)
 */
        ...
        struct Microsoft::Bamo::BamoProxy **a4)
{
  ...
  *(_QWORD *)a3 = 0LL;
  ...
  if ( *(int *)(v6 + 8) <= 0 )
    ...
    v7 = *(_QWORD *)(v6 + 16);
  v8 = (struct DeviceDockServer *)(*(__int64 (__fastcall **)(__int64))(*(_QWORD *)(*(_QWORD *)(v7 + 232) + 8LL) + 56LL))(*(_QWORD *)(v7 + 232) + 8LL);
