/*
 * XREFs of _DWMInputRouter::UpdateFocusedInputTarget_::_1_::dtor$7 @ 0x1800576B0
 * Callers:
 *     <none>
 * Callees:
 *     <none>
...
void __fastcall DWMInputRouter::UpdateFocusedInputTarget_::_1_::dtor_7(__int64 a1, __int64 a2)
{
