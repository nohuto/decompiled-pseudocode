/*
 * XREFs of ?CreateWindowsMessageDeliveryProxy@@YAJPEAVBamoPeer@ISMBamos_AutoBamos@@PEAPEAVBamoWindowsMessageDeliveryProxy@@@Z @ 0x180005C24
 * Callers:
        ...
        struct BamoWindowsMessageDeliveryProxy **a2)
{
  ...
  *(_QWORD *)v11 = 0LL;
  ...
  if ( *(int *)(v5 + 8) <= 0 )
    ...
    v6 = *(_QWORD *)(v5 + 16);
  v7 = *(_QWORD *)((*(__int64 (__fastcall **)(__int64))(*(_QWORD *)v6 + 48LL))(v6) + 48);
