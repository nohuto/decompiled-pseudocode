/*
 * XREFs of ?CreateKeyboardInputInfo@Win32kInterop@@SA?AUKeyboardInputInfo@@PEBU_MIT_KEYBOARD_INPUT_MESSAGE@@@Z @ 0x1800DF124
 * Callers:
...
unsigned __int16 *__fastcall Win32kInterop::CreateKeyboardInputInfo(unsigned __int16 *a1, __int64 a2)
{
  ...
  *((_BYTE *)a1 + 49) = 1;
  ...
  memcpy_s_0(a1 + 48, 0x100uLL, (const void *const)(a2 + 14), 0x100uLL);
  return a1;
}
