/*
 * XREFs of ?UnregisterSupportedInputUpdateObserver@DWMInputRouter@@UEAAJPEAUISupportedInputUpdateObserver@@@Z @ 0x18019BDB0
 * Callers:
 *     <none>
 * Callees:
        ...
        struct ISupportedInputUpdateObserver *a2)
{
  ...
  v2 = (struct ISupportedInputUpdateObserver **)*((_QWORD *)this + 72);
  for ( i = (struct ISupportedInputUpdateObserver **)*((_QWORD *)this + 71); i != v2 && *i != a2; ++i )
    ;
