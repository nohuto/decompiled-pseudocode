/*
 * XREFs of ?BroadcastRemoteClear@BamoList_VirtualTouchpadRect_Principal@ISMBamos_AutoBamos@Lib@Bamo@Microsoft@@UEAAJXZ @ 0x180132760
 * Callers:
 *     <none>
 * Callees:
        ...
        struct Microsoft::BamoImpl::ConnectionIndirector **this)
{
  ...
  if ( *(_QWORD *)(v3 + 64) )
  {
    for ( i = this[5]; ; i = (struct Microsoft::BamoImpl::ConnectionIndirector *)*((_QWORD *)i + 6) )
    {
      ...
      if ( *((_BYTE *)i + 32) )
      {
        v9 = Microsoft::Bamo::Lib::BamoImpl::ISMBamos_AutoBamos::BamoList_VirtualTouchpadRect_PrincipalImpl::CallRemoteClearOnStub(i);
        v4 = v9;
        if ( v9 < 0 )
          break;
      }
