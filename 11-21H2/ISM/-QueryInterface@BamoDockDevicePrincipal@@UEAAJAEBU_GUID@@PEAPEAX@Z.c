/*
 * XREFs of ?QueryInterface@BamoDockDevicePrincipal@@UEAAJAEBU_GUID@@PEAPEAX@Z @ 0x18017E8C0
 * Callers:
 *     ?QueryInterface@BamoDockDevicePrincipal@@W7EAAJAEBU_GUID@@PEAPEAX@Z @ 0x180052940 (-QueryInterface@BamoDockDevicePrincipal@@W7EAAJAEBU_GUID@@PEAPEAX@Z.c)
 * Callees:
