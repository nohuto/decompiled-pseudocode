/*
 * XREFs of ?CancelResize@BamoResizeContextualProcessorPrincipalImpl@BamoImpl@@QEAAJII@Z @ 0x1801433F0
 * Callers:
 *     ?Thunk_CancelResize_19@?$IResizeContextualProcessorPrincipal_Receive@VBamoResizeContextualProcessorPrincipalImpl@BamoImpl@@@@SAJPEAXPEAPEAX@Z @ 0x180143BC0 (-Thunk_CancelResize_19@-$IResizeContextualProcessorPrincipal_Receive@VBamoResizeContextualProces.c)
 * Callees:
        ...
        unsigned int a3)
{
  ...
  Microsoft::BamoImpl::CalloutWrapper<BamoImpl::BamoResizeContextualProcessorPrincipalImpl>::CalloutWrapper<BamoImpl::BamoResizeContextualProcessorPrincipalImpl>(
    ...
    v11,
    (__int64)this);
  v16 = (*(__int64 (__fastcall **)(char *, __int64, _QWORD, char *))(*((_QWORD *)this - 2) + 104LL))(
          (char *)this - 16,
          v8,
          a2,
          v13);
