/*
 * XREFs of ?ProcessResult@BamoDragProcessorManagerPrincipalImpl@BamoImpl@@QEAAJIPEBUDragOperationResult@Input@Internal@UI@Windows@@I@Z @ 0x18013A8C8
 * Callers:
 *     ?Thunk_ProcessResult_154@?$IDragProcessorManagerPrincipal_Receive@VBamoDragProcessorManagerPrincipalImpl@BamoImpl@@@@SAJPEAXPEAPEAX@Z @ 0x18013AF80 (-Thunk_ProcessResult_154@-$IDragProcessorManagerPrincipal_Receive@VBamoDragProcessorManagerPrinc.c)
 * Callees:
...
__int64 __fastcall BamoImpl::BamoDragProcessorManagerPrincipalImpl::ProcessResult(
        ...
        unsigned int a4)
{
  ...
  Microsoft::BamoImpl::CalloutWrapper<BamoImpl::BamoDragProcessorManagerPrincipalImpl>::CalloutWrapper<BamoImpl::BamoDragProcessorManagerPrincipalImpl>(
    ...
    (__int64)this);
  v22 = v15;
  v18 = (*(__int64 (__fastcall **)(char *, __int64, _QWORD, const struct Windows::UI::Internal::Input::DragOperationResult *))(*((_QWORD *)this - 2) + 120LL))(
          (char *)this - 16,
          v10,
          a2,
          a3);
