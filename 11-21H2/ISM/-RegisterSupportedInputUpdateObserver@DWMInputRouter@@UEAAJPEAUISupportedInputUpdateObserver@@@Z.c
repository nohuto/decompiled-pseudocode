/*
 * XREFs of ?RegisterSupportedInputUpdateObserver@DWMInputRouter@@UEAAJPEAUISupportedInputUpdateObserver@@@Z @ 0x18019B280
 * Callers:
 *     <none>
 * Callees:
 ...
 *     ??$_Emplace_reallocate@AEBQEAUISupportedInputUpdateObserver@@@?$vector@PEAUISupportedInputUpdateObserver@@V?$allocator@PEAUISupportedInputUpdateObserver@@@std@@@std@@QEAAPEAPEAUISupportedInputUpdateObserver@@QEAPEAU2@AEBQEAU2@@Z @ 0x1801994DC (--$_Emplace_reallocate@AEBQEAUISupportedInputUpdateObserver@@@-$vector@PEAUISupportedInputUpdate.c)
 */
