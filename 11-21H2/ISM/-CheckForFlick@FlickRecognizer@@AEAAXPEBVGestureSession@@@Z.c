/*
 * XREFs of ?CheckForFlick@FlickRecognizer@@AEAAXPEBVGestureSession@@@Z @ 0x1801B5FD4
 * Callers:
 *     ?Add@FlickRecognizer@@UEAAJPEBVGestureSession@@_KKKPEBUTouchContactInfo@@@Z @ 0x1801B5D50 (-Add@FlickRecognizer@@UEAAJPEBVGestureSession@@_KKKPEBUTouchContactInfo@@@Z.c)
 * Callees:
 *     ?FindFirstRelevantFlickData@FlickRecognizer@@AEAAHXZ @ 0x1801B6108 (-FindFirstRelevantFlickData@FlickRecognizer@@AEAAHXZ.c)
 */
