/*
 * XREFs of ?UnsuppressInputOfType@BamoInputObserverManagerProxyImpl@BamoImpl@@QEAAJW4InputObserverType@InputObservation@@PEAVBamoInputObserverClientPrincipal@@@Z @ 0x18011924C
 * Callers:
        ...
        const char *a4)
{
  ...
  else
  {
    ...
    if ( v7 >= 0 )
    {
      ...
      return CoreUICallSend(v10, v17, 2LL, 52LL);
    }
    else
    {
      wil::details::in1diag3::Return_Hr(
