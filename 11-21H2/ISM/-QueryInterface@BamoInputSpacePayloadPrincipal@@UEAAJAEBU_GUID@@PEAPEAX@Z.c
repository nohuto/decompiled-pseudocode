/*
 * XREFs of ?QueryInterface@BamoInputSpacePayloadPrincipal@@UEAAJAEBU_GUID@@PEAPEAX@Z @ 0x180134B80
 * Callers:
 *     ?QueryInterface@BamoInputSpacePayloadPrincipal@@W7EAAJAEBU_GUID@@PEAPEAX@Z @ 0x180050C80 (-QueryInterface@BamoInputSpacePayloadPrincipal@@W7EAAJAEBU_GUID@@PEAPEAX@Z.c)
 * Callees:
