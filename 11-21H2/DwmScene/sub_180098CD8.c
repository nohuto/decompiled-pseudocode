/*
 * XREFs of sub_180098CD8 @ 0x180098CD8
 * Callers:
 *     sub_18009A040 @ 0x18009A040 (sub_18009A040.c)
 * Callees:
...
_OWORD *__fastcall sub_180098CD8(__int64 a1, _OWORD *a2, __int64 a3, __int64 *a4)
{
  __int64 v7; // rbx
  __int64 *v8; // rax
