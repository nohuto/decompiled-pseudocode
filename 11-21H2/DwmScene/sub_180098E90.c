/*
 * XREFs of sub_180098E90 @ 0x180098E90
 * Callers:
 *     sub_18009A080 @ 0x18009A080 (sub_18009A080.c)
 * Callees:
...
_OWORD *__fastcall sub_180098E90(__int64 a1, _OWORD *a2, __int64 a3, __int64 *a4)
{
  __int64 v7; // rbx
  __int64 *v8; // rax
