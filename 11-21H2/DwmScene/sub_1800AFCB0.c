/*
 * XREFs of sub_1800AFCB0 @ 0x1800AFCB0
 * Callers:
...
char __fastcall sub_1800AFCB0(__int64 a1, __int64 a2)
{
  unsigned int v2; // edi
  __int64 v4; // r14
  int v6; // eax
      ...
      do
      {
        if ( *(_BYTE *)(a1 + 4620) || (LOBYTE(v6) = sub_1800122D0(v9, v9 - 192), (_BYTE)v6) )
        {
          ...
          *(_QWORD *)(a1 + 16 * (v4 + v8) + 1552) = v10;
          ...
          LOBYTE(v6) = (*(__int64 (__fastcall **)(__int64, _QWORD, _QWORD *, _QWORD))(*(_QWORD *)a2 + 128LL))(
                         a2,
                         v2,
                         v9,
                         v7);
