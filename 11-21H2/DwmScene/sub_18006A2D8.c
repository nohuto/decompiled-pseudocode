/*
 * XREFs of sub_18006A2D8 @ 0x18006A2D8
 * Callers:
...
_QWORD *__fastcall sub_18006A2D8(__int64 a1, _QWORD *a2)
{
  __int64 v4; // rbx
  __int64 v6; // rdx
  ...
  sub_1800436D4(a1);
  v4 = *(_QWORD *)sub_18006B0A4(a1, &v15);
...
LABEL_15:
    ...
    if ( v9 )
    {
      ...
      *(_DWORD *)(v9 + 8) = 1;
      *(_DWORD *)(v9 + 12) = 1;
      *(_QWORD *)v9 = &std::_Ref_count_obj2<Spectre::Engine::ViewerCamera>::`vftable';
      sub_18006B7D8(v9 + 16, &v14);
    }
    else
    {
      v10 = 0LL;
