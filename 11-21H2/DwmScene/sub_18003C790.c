/*
 * XREFs of sub_18003C790 @ 0x18003C790
 * Callers:
...
__int64 __fastcall sub_18003C790(__int64 **a1, __int64 a2)
{
  __int64 *v2; // rdi
  __int64 *m; // rbx
  __int64 *v5; // rsi
  ...
  {
    sub_180030D80((__int64)a1, (__int64)a1, (char *)v2[1]);
    v2[1] = (__int64)v2;
    *v2 = (__int64)v2;
    v2[2] = (__int64)v2;
    a1[1] = 0LL;
