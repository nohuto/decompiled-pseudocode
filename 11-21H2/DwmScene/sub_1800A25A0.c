/*
 * XREFs of sub_1800A25A0 @ 0x1800A25A0
 * Callers:
 *     <none>
 * Callees:
...
void __fastcall sub_1800A25A0(__int64 a1, __int64 a2, int a3, char a4, int a5, char a6, char a7, float a8)
{
  float v11; // xmm0_4
  bool v12; // zf
  float v13; // xmm0_4
...
LABEL_17:
  ...
  if ( a6 )
  {
    v19 = (float)((float)-(float)a3 * 0.0099999998) + *(float *)(a1 + 1888);
    *(float *)(a1 + 1888) = v19;
  }
  else
  {
