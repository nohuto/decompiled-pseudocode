/*
 * XREFs of sub_1800FE7A0 @ 0x1800FE7A0
 * Callers:
...
__int64 __fastcall sub_1800FE7A0(__m128 *a1, unsigned int a2, __int64 a3, unsigned __int64 *a4, __int64 a5, char a6)
{
  __int64 v6; // r8
  __int64 v7; // r10
  __int64 v8; // r11
  ...
  if ( a2 )
  {
    ...
    do
    {
      ...
      *a1 = _mm_or_ps(
              ...
              _mm_andnot_ps(v29, (__m128)xmmword_180128330));
      v30 = _mm_and_ps(
