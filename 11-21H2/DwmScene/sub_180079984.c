/*
 * XREFs of sub_180079984 @ 0x180079984
 * Callers:
...
__int64 __fastcall sub_180079984(float *a1, __int64 a2, __int64 a3)
{
  __int64 v6; // rcx
  __int64 v7; // r15
  __int64 *v8; // rbx
  ...
  if ( !*((_QWORD *)&v23 + 1) )
  {
    ...
    v21 = a1 + 2;
    v8 = (__int64 *)sub_180011088(0x30uLL);
    v22 = v8;
    ...
    v25 = *(_QWORD *)(v23 + 8);
    *((_QWORD *)a1 + 2) = v9 + 1;
    sub_180030740(v8, &v24);
    sub_180030740(v8 + 1, &v25);
    *v16 = v8;
    *(_QWORD *)(v15 + 8) = v8;
    v17 = *((_QWORD *)a1 + 3);
