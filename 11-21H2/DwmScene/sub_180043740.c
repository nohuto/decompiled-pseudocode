/*
 * XREFs of sub_180043740 @ 0x180043740
 * Callers:
...
char __fastcall sub_180043740(__int64 a1, _OWORD *a2, _OWORD *a3, double a4)
{
  __m128 v4; // xmm0
  __m128 v5; // xmm1
  __m128 v6; // xmm2
...
LABEL_14:
  if ( *(float *)(a1 + 4 * v22) < 0.000099999997 )
    *(_OWORD *)v61[v22] = *(_OWORD *)*((_QWORD *)&off_180122678 + v22);
  v25 = (__m128 *)v61[v22];
  ...
  *v25 = v31;
  if ( *(float *)(a1 + 4 * v24) < 0.000099999997 )
  {
    ...
    v36 = _mm_shuffle_ps(*(__m128 *)*((_QWORD *)&off_180122678 + v7), *(__m128 *)*((_QWORD *)&off_180122678 + v7), 210);
  ...
  *v37 = v43;
  ...
  v50 = _mm_sqrt_ps(v49);
  v51 = _mm_cmpneq_ps(v49, (__m128)xmmword_1801282E0);
  *v46 = _mm_or_ps(
           _mm_and_ps(_mm_and_ps(_mm_cmpneq_ps((__m128)0LL, v50), _mm_div_ps(*v46, v50)), v51),
           _mm_andnot_ps(v51, (__m128)xmmword_180128330));
  v52 = v58.m128_u64[1];
  v55 = sub_180043B44(v25, v12);
  if ( v55 < 0.0 )
  {
    v55 = -v55;
