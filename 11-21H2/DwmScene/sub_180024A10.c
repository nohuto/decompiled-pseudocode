/*
 * XREFs of sub_180024A10 @ 0x180024A10
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall sub_180024A10(__int64 a1, __int64 a2, void *a3)
{
  __int64 v6; // r8
  __int64 v7; // r9
    ...
    && (qword_1801EA1D8 & 0x400000000000LL) == qword_1801EA1D8 )
  {
    ...
    v15 = &v16;
    sub_180001410((__int64)v8, byte_1801CD248, v6, v7, (void **)&v15, (__int64)&v11, &v14, &v13, &v12);
  }
