/*
 * XREFs of sub_180024E00 @ 0x180024E00
 * Callers:
 *     <none>
 * Callees:
...
ULONG __fastcall sub_180024E00(__int64 a1, __int64 a2, void *a3)
{
  __int64 v6; // rsi
  ...
  *(_QWORD *)(a1 + 112) = v10;
  ...
  if ( (unsigned int)dword_1801EA1C0 > 5 && (qword_1801EA1D0 & 0x400000000000LL) != 0 )
  {
    ...
    if ( (qword_1801EA1D8 & 0x400000000000LL) == qword_1801EA1D8 )
    {
      ...
      v20 = &v21;
      return sub_180001410((__int64)v15, byte_1801CD524, v13, v14, (void **)&v20, (__int64)&v16, &v19, &v18, &v17);
    }
  }
  return result;
}
