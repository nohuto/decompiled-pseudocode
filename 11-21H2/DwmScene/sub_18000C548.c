/*
 * XREFs of sub_18000C548 @ 0x18000C548
 * Callers:
...
__int64 __fastcall sub_18000C548(_DWORD *a1)
{
  __int64 v2; // rdx
  ...
  *a1 = ++dword_1801F4B30;
  *(_DWORD *)(*((_QWORD *)NtCurrentTeb()->ThreadLocalStoragePointer + v2) + 16LL) = dword_1801F4B30;
