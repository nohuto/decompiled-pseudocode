/*
 * XREFs of sub_180014564 @ 0x180014564
 * Callers:
...
_QWORD *__fastcall sub_180014564(__int64 a1, _QWORD *a2)
{
  __int64 v4; // rbx
  __int64 v6; // rdx
  ...
  sub_1800436D4();
  v4 = *(_QWORD *)sub_18001483C(a1, &v15);
...
LABEL_15:
    ...
    if ( v9 )
    {
      ...
      *(_DWORD *)(v9 + 8) = 1;
      *(_DWORD *)(v9 + 12) = 1;
      *(_QWORD *)v9 = &std::_Ref_count_obj2<Spectre::Engine::Bounds>::`vftable';
      sub_1800149DC(v9 + 16, &v14);
    }
    else
    {
      v10 = 0LL;
