/*
 * XREFs of sub_180017078 @ 0x180017078
 * Callers:
...
_QWORD *__fastcall sub_180017078(__int64 *a1, _QWORD *a2)
{
  __int64 v4; // rax
  __int64 v5; // rbx
  __int64 v6; // rax
  ...
  if ( v4 )
  {
    ...
    *(_DWORD *)(v4 + 8) = 1;
    *(_DWORD *)(v4 + 12) = 1;
    *(_QWORD *)v4 = &std::_Ref_count_obj2<Spectre::Engine::Mesh>::`vftable';
    sub_180018080(v4 + 16);
  }
  else
  {
