/*
 * XREFs of sub_180093640 @ 0x180093640
 * Callers:
...
__int64 __fastcall sub_180093640(__int64 a1, unsigned __int16 a2, __int64 *a3)
{
  __int64 v4; // rcx
  ...
  if ( v7[12] == 2 )
  {
    sub_1800113D0(v26, "ShaderPropertyBlock::SetTextureSampler() -- Cannot set the value of an imported property");
    v14 = sub_1800113D0(
            v27,
            "onecoreuap\\windows\\dwm\\spectre\\engine\\products\\components\\nativerenderer\\cpp\\source\\engine\\shader"
            "propertyblock.cpp");
  ...
  *a3 = 0LL;
  a3[1] = 0LL;
  v25[0] = *(_QWORD *)(v10 + 8 * v9 + 16);
  *(_QWORD *)(v10 + 8 * v9 + 16) = v11;
  v25[1] = *(_QWORD *)(v10 + 8 * v9 + 24);
  *(_QWORD *)(v10 + 8 * v9 + 24) = v12;
