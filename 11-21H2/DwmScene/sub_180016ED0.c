/*
 * XREFs of sub_180016ED0 @ 0x180016ED0
 * Callers:
...
_QWORD *__fastcall sub_180016ED0(__int64 a1, _QWORD *a2)
{
  ...
  v6 = _std_type_info_hash(&qword_1801EAF08);
  v7 = *(__int64 **)(a1 + 496);
  v8 = (__int64 *)v7[1];
  v9 = v7;
  while ( !*((_BYTE *)v8 + 25) )
