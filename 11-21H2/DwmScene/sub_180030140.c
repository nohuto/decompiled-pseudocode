/*
 * XREFs of sub_180030140 @ 0x180030140
 * Callers:
...
__int64 __fastcall sub_180030140(__int64 a1)
{
  __int64 v1; // r14
  __int64 v2; // rdx
  __int64 v3; // rax
  ...
  v8 = (char *)&Spectre::Engine::Engine::EngineSceneData `RTTI Type Descriptor';
  v1 = a1 + 200;
  v2 = *(_QWORD *)(sub_1800312A0(a1 + 200, v10, &v8) + 16);
  ...
  v9[0] = v4 + 16;
  v9[1] = v4;
  v6 = (__int64 *)sub_180033C90(v1, &v8);
  if ( v4 )
  {
