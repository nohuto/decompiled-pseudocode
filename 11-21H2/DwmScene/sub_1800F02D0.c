/*
 * XREFs of sub_1800F02D0 @ 0x1800F02D0
 * Callers:
 *     <none>
 * Callees:
...
char __fastcall sub_1800F02D0(__int64 a1, __int64 a2)
{
  char v4; // cl
  __int64 v5; // rdx
  ...
  if ( v4 )
  {
    sub_1800113D0(v28, "HullShaderD3D11::Load() -- this function can only be called once per shader instance");
    v24 = sub_1800113D0(
            v27,
  ...
  if ( *(_QWORD *)a2 != *(_QWORD *)(a2 + 8) || *(_DWORD *)(a2 + 32) != *(_DWORD *)(a2 + 24) )
  {
    *(_OWORD *)v28 = 0LL;
    ...
    v8 = v26;
    v9 = *(__int64 (__fastcall **)(__int64, __int64, __int64, _QWORD, __int64))(*(_QWORD *)v26 + 128LL);
    v10 = (__int64 *)(a1 + 104);
    v11 = *(_QWORD *)(a1 + 104);
    if ( v11 )
    {
    ...
    if ( v16 < 0 )
    {
      sub_18001F2B4(&stru_1801EA5C8, 5, "ERROR: Failed to create Hull shader.\n");
    }
    else
    {
      *(_BYTE *)(a1 + 96) = 1;
