/*
 * XREFs of sub_1800A6A50 @ 0x1800A6A50
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall sub_1800A6A50(__int64 a1, __int64 a2, int a3, int a4, char a5, __int64 a6)
{
  __int64 v10; // rax
  ...
  *(_OWORD *)(a1 + 232) = v11;
  ...
  v15[3] = 15LL;
  LOBYTE(v15[0]) = 0;
  sub_180012190(v15, "ImageProcessingEffectBloom", 0x1AuLL);
  sub_18002BC44(v12, v15);
  return sub_18002A240(*(_QWORD *)(a1 + 232), a3, a4, a5, a6, a2);
}
