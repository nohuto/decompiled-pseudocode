/*
 * XREFs of sub_18004D93C @ 0x18004D93C
 * Callers:
...
__int64 __fastcall sub_18004D93C(__int64 *a1, int a2, int a3, unsigned int a4, int a5, __int64 *a6)
{
  __int64 v6; // rdi
  __int64 *v11; // rax
  __int64 v12; // rcx
  ...
  v15 = sub_18004E9D8(12LL, a4);
  return sub_180096C7C(v6, a2, a3, v15, a5, 12);
}
