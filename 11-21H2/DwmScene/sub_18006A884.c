/*
 * XREFs of sub_18006A884 @ 0x18006A884
 * Callers:
...
_QWORD *__fastcall sub_18006A884(__int64 a1, _QWORD *a2, _QWORD *a3, __int64 *a4)
{
  __int64 v8; // r8
  __int64 v9; // rdx
  ...
  __int64 v20[2]; // [rsp+60h] [rbp+7h] BYREF
