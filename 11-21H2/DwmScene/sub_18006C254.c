/*
 * XREFs of sub_18006C254 @ 0x18006C254
 * Callers:
...
void __fastcall sub_18006C254(__int64 *a1, __int64 *a2)
{
  __int64 v4; // rsi
  ...
  if ( v4 <= 32 )
  {
    sub_18003EBE0(a1, a2, (unsigned __int8 (__fastcall *)(__int128 *, __int64 *))sub_18006DF80);
    return;
  }
  v5 = v4 - v4 / 2;
...
LABEL_10:
  v10 = v7;
  v11 = v5;
  sub_18003F05C(a1, a2, v4, (__int64)v7, v5, (unsigned __int8 (__fastcall *)(__int64, __int64))sub_18006DF80);
  if ( v11 > 0x100 )
    sub_18003EF08(v10);
}
