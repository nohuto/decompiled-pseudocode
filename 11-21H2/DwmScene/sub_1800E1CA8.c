/*
 * XREFs of sub_1800E1CA8 @ 0x1800E1CA8
 * Callers:
...
_QWORD *__fastcall sub_1800E1CA8(__int64 ***a1, _QWORD *a2, __int64 *a3, __int64 a4)
{
  __int64 **v4; // rsi
  __int64 *j; // rbx
  char *v9; // rbx
  ...
  if ( a3 == **a1 && *(_BYTE *)(a4 + 25) )
  {
    ...
    while ( !v9[25] )
    {
      sub_180030FC8((__int64)a1, (__int64)a1, *((char **)v9 + 2));
      v10 = v9;
      v9 = *(char **)v9;
      sub_180010884(v10, 0x30uLL);
    }
    v4[1] = (__int64 *)v4;
    *v4 = (__int64 *)v4;
    v4[2] = (__int64 *)v4;
  ...
  else
  {
    while ( j != (__int64 *)a4 )
    {
      ...
      sub_180010884((char *)v20, 0x30uLL);
    }
  }
  result = a2;
  *a2 = a4;
