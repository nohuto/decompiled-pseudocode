...
_QWORD *__fastcall sub_18006A16C(__int64 a1, _QWORD *a2)
{
  __int64 v4; // rbx
  __int64 v6; // rdx
...
LABEL_15:
    ...
    if ( v9 )
    {
      ...
      *(_DWORD *)(v9 + 8) = 1;
      *(_DWORD *)(v9 + 12) = 1;
      *(_QWORD *)v9 = &std::_Ref_count_obj2<Spectre::Engine::LightProbe>::`vftable';
      sub_18006B7C0(v9 + 16, (__int64)&v14);
    }
    else
    {
      v10 = 0LL;
