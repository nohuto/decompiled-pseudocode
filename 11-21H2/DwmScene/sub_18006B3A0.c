/*
 * XREFs of sub_18006B3A0 @ 0x18006B3A0
 * Callers:
...
_QWORD *__fastcall sub_18006B3A0(__int64 a1, _QWORD *a2)
{
  char *v3; // r8
  __int64 v4; // rax
  int v5; // ebx
  ...
  v19 = &Spectre::Engine::ImageProcessingEffectBloom `RTTI Type Descriptor';
