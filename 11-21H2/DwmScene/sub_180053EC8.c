/*
 * XREFs of sub_180053EC8 @ 0x180053EC8
 * Callers:
...
__int64 *__fastcall sub_180053EC8(__int64 *a1, __int64 *a2)
{
  __int64 v4; // rax
  __int64 v5; // rbx
  __int64 v6; // rax
  ...
  if ( v4 )
  {
    ...
    *(_DWORD *)(v4 + 8) = 1;
    *(_DWORD *)(v4 + 12) = 1;
    *(_QWORD *)v4 = &std::_Ref_count_obj2<Spectre::Engine::HullShader>::`vftable';
    sub_1800544D8(v4 + 16);
  }
  else
  {
