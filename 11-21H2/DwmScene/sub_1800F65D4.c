/*
 * XREFs of sub_1800F65D4 @ 0x1800F65D4
 * Callers:
 *     sub_1800F99B0 @ 0x1800F99B0 (sub_1800F99B0.c)
...
__int64 __fastcall sub_1800F65D4(__int64 a1, _QWORD *a2, double a3, int a4)
{
  double v4; // xmm0_8
  ...
  __int64 *v23; // rax
  __int64 v24; // r8
  __int64 v26[5]; // [rsp+30h] [rbp-81h] BYREF
  __int64 v27[4]; // [rsp+58h] [rbp-59h] BYREF
  char *v28[3]; // [rsp+78h] [rbp-39h] BYREF
  unsigned __int64 v29; // [rsp+90h] [rbp-21h]
  char *v30[3]; // [rsp+98h] [rbp-19h] BYREF
    ...
    else
    {
      ...
      if ( (unsigned __int8)sub_1800FAC60(v15) )
      {
        ...
        if ( (unsigned __int8)sub_1800FAB78(v15, v17)
          && (v18 = sub_1800129F4(v26, (__int64)v28), sub_1800FA89C(v15, v18), (unsigned __int8)sub_1800F6190()) )
        {
          sub_1800F6144();
          if ( v4 != a3 )
          {
            v19 = sub_1800129F4(v26, (__int64)v28);
            sub_1800F6500(v15, (char *)v19, v20);
            v13 = 1;
          }
        }
        else
      ...
      else if ( (unsigned __int8)sub_1800F6190() )
      {
        sub_1800F6144();
        if ( v4 != a3 )
        {
          v21 = sub_1800129F4(v26, (__int64)a2);
          sub_1800F6500(v11, (char *)v21, v22);
          v13 = 1;
        }
      }
      else
  ...
  else if ( (unsigned int)(a4 - 1) <= 1 )
  {
    ...
    sub_1800F6500(v11, (char *)v23, v24);
    v13 = 0;
  }
  else
  {
