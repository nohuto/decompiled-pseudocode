/*
 * XREFs of sub_180010EC0 @ 0x180010EC0
 * Callers:
...
_QWORD *__fastcall sub_180010EC0(__int64 a1, _QWORD *a2)
{
  __int64 v4; // rax
  __int64 v5; // rbx
  __int64 v6; // rax
  ...
  if ( v4 )
  {
    ...
    *(_DWORD *)(v4 + 8) = 1;
    *(_DWORD *)(v4 + 12) = 1;
    *(_QWORD *)v4 = &std::_Ref_count_obj2<Spectre::Engine::FrameBuffer>::`vftable';
    sub_180011100(v4 + 16);
  }
  else
  {
  ...
  *a2 = v5 + 16;
  ...
  v15 = *(_QWORD **)(a1 + 872);
  if ( v15 == *(_QWORD **)(a1 + 880) )
  {
    sub_180011198(a1 + 864, v15, &v18);
    v16 = *((_QWORD *)&v18 + 1);
  }
  else
  {
  ...
  if ( v16 && _InterlockedExchangeAdd((volatile signed __int32 *)(v16 + 12), 0xFFFFFFFF) == 1 )
    (*(void (__fastcall **)(_QWORD, _QWORD *, __int64, __int64))(**((_QWORD **)&v18 + 1) + 8LL))(
      *((_QWORD *)&v18 + 1),
      v15,
      v14,
      v11);
  if ( v21 )
    j_LanguageEnumProc(v20, v15, v14, v11);
  sub_180035680(a1, *a2, 0LL, v11);
  return a2;
}
