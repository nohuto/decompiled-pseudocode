/*
 * XREFs of sub_18009F620 @ 0x18009F620
 * Callers:
 *     sub_1800A1080 @ 0x1800A1080 (sub_1800A1080.c)
 * Callees:
 *     __security_check_cookie @ 0x18000B300 (__security_check_cookie.c)
 *     _o_floorf @ 0x18000C03C (_o_floorf.c)
 *     sub_1800A0D04 @ 0x1800A0D04 (sub_1800A0D04.c)
 */

__m128 *__fastcall sub_18009F620(__int64 a1, __m128 *a2, __m128 *a3)
{
  __m128 v3; // xmm1
  int v4; // r15d
  char *v5; // rbx
  ...
  *(_QWORD *)v22 = 0LL;
  v25[2] = 2;
  *a3 = _mm_mul_ps(
          _mm_min_ps(_mm_max_ps(v3, (__m128)xmmword_1801284F0), (__m128)xmmword_1801284E0),
  ...
  *a2 = (__m128)xmmword_1801289A8;
  ...
  do
  {
    ...
    sub_1800A0D04(a1, &v27, (v15 & 1) + ((v15 & 2) != 0 ? v4 : 0) + v14 + ((v15 & 4) != 0 ? v4 * v4 : 0));
    v15 = v18 + 1;
