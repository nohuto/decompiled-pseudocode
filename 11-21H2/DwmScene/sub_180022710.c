/*
 * XREFs of sub_180022710 @ 0x180022710
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall sub_180022710(__int64 a1, void *a2, __int64 a3, __int64 a4, void *a5, void *a6, int a7)
{
  __int64 result; // rax
  ...
  if ( (unsigned int)dword_1801EA188 > 5 )
  {
    ...
    v11 = a4;
    v12 = a3;
    return sub_180001008(a1, (int)&unk_1801CC4A9, a3, a4, &v13, (__int64)&v12, (__int64)&v11, &v10, &v9, (__int64)&v8);
  }
  return result;
}
