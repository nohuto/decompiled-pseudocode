/*
 * XREFs of sub_180069F70 @ 0x180069F70
 * Callers:
...
__int64 __fastcall sub_180069F70(__int64 **a1, __int64 a2)
{
  __int64 *v2; // rdi
  __int64 *m; // rbx
  __int64 *v5; // rsi
  ...
  {
    sub_1800671C8((__int64)a1, (__int64)a1, (char *)v2[1]);
    v2[1] = (__int64)v2;
    *v2 = (__int64)v2;
    v2[2] = (__int64)v2;
    a1[1] = 0LL;
  ...
  else
  {
    while ( m != v5 )
    {
      ...
      sub_180010884((char *)v23, 0x30uLL);
    }
  }
  return v10;
}
