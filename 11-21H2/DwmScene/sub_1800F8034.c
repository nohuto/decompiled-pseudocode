/*
 * XREFs of sub_1800F8034 @ 0x1800F8034
 * Callers:
...
__int64 __fastcall sub_1800F8034(float *a1, __int64 a2, __int64 *a3)
{
  __int64 v6; // rcx
  __int64 v7; // r12
  __int64 v8; // rsi
  ...
  if ( !*((_QWORD *)&v24 + 1) )
  {
    ...
    *(_WORD *)a3 = 0;
    ...
    v26 = *(_QWORD *)(v24 + 8);
    *((_QWORD *)a1 + 2) = v9 + 1;
    sub_180030740((__int64 *)v8, &v25);
    sub_180030740((__int64 *)(v8 + 8), &v26);
    *v17 = v8;
    *(_QWORD *)(v16 + 8) = v8;
    v18 = *((_QWORD *)a1 + 3);
