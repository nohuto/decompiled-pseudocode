/*
 * XREFs of sub_1800A1F90 @ 0x1800A1F90
 * Callers:
 *     <none>
 * Callees:
...
_QWORD *__fastcall sub_1800A1F90(__int64 *a1, _QWORD *a2, __int64 a3, _QWORD *a4)
{
  __int64 v8; // rax
  __int64 v9; // rbx
  __int64 v10; // rax
