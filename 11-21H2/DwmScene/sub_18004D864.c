/*
 * XREFs of sub_18004D864 @ 0x18004D864
 * Callers:
...
__int64 __fastcall sub_18004D864(__int64 *a1, int a2, int a3, unsigned int a4, int a5, __int64 a6, __int64 a7)
{
  __int64 v7; // rdi
  __int64 *v12; // rax
  __int64 v13; // rcx
  ...
  v16 = sub_18004E9D8(17LL, a4);
  return sub_180096C7C(v7, a2, a3, v16, a5, 17);
}
