/*
 * XREFs of sub_1800D7B74 @ 0x1800D7B74
 * Callers:
...
_QWORD *__fastcall sub_1800D7B74(_QWORD *a1, _QWORD *a2, __int64 a3, __int64 a4, __int64 a5)
{
  __int64 v9; // rcx
  __int64 v10; // rax
  __int64 v11; // rax
  ...
  if ( v11 )
  {
    ...
    *(_DWORD *)(v11 + 8) = 1;
    *(_DWORD *)(v11 + 12) = 1;
    *(_QWORD *)v11 = &std::_Ref_count_obj2<Spectre::Engine::D3D11::RenderOutputD3D11Gdi>::`vftable';
    sub_1800D87AC(v11 + 16, a3, a4, a5, 0, v27);
  }
  else
  {
    v12 = 0LL;
