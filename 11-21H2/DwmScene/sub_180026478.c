/*
 * XREFs of sub_180026478 @ 0x180026478
 * Callers:
...
_QWORD *__fastcall sub_180026478(__int64 *a1, _QWORD *a2)
{
  __int64 v4; // rax
  __int64 v5; // rbx
  __int64 v6; // rax
  ...
  if ( v4 )
  {
    ...
    *(_DWORD *)(v4 + 8) = 1;
    *(_DWORD *)(v4 + 12) = 1;
    *(_QWORD *)v4 = &std::_Ref_count_obj2<Spectre::Engine::DepthBuffer>::`vftable';
    sub_180026A3C(v4 + 16);
  }
  else
  {
