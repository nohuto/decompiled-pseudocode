/*
 * XREFs of sub_180053CE0 @ 0x180053CE0
 * Callers:
...
__int64 *__fastcall sub_180053CE0(__int64 *a1, __int64 *a2)
{
  __int64 v4; // rax
  __int64 v5; // rbx
  __int64 v6; // rax
  ...
  if ( v4 )
  {
    ...
    *(_DWORD *)(v4 + 8) = 1;
    *(_DWORD *)(v4 + 12) = 1;
    *(_QWORD *)v4 = &std::_Ref_count_obj2<Spectre::Engine::GeometryShader>::`vftable';
    sub_1800544AC(v4 + 16);
  }
  else
  {
