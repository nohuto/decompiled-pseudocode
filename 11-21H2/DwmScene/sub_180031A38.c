...
__int64 __fastcall sub_180031A38(__int64 a1, __m128i *a2)
{
  __int64 v4; // r15
  __int64 v5; // rcx
  __int64 v6; // r14
  ...
  *(_QWORD *)a1 = v4;
  ...
  while ( v6 != v7 )
  {
    v8 = sub_180031024((__int64 **)a1, (__int64)v12, (__int64 *)v4, (_QWORD *)v6);
    v9 = *(_OWORD *)v8;
    v13 = *(_QWORD *)(v8 + 16);
    if ( !(_BYTE)v13 )
    {
      if ( *(_QWORD *)(a1 + 8) == 0x38E38E38E38E38ELL )
        sub_18001F56C();
      v14 = *(__int64 **)a1;
      v10 = sub_180011088(0x48uLL);
      sub_18001875C((__int64 *)(v10 + 32), v6);
      *(_DWORD *)(v10 + 64) = *(_DWORD *)(v6 + 32);
