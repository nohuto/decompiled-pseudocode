/*
 * XREFs of sub_180017260 @ 0x180017260
 * Callers:
...
_QWORD *__fastcall sub_180017260(__int64 *a1, _QWORD *a2)
{
  __int64 v4; // rax
  __int64 v5; // rbx
  __int64 v6; // rax
  ...
  if ( v4 )
  {
    ...
    *(_DWORD *)(v4 + 8) = 1;
    *(_DWORD *)(v4 + 12) = 1;
    *(_QWORD *)v4 = &std::_Ref_count_obj2<Spectre::Engine::Sampler>::`vftable';
    sub_180018150(v4 + 16);
  }
  else
  {
  ...
  *a2 = v5 + 16;
  ...
  if ( v16 && _InterlockedExchangeAdd((volatile signed __int32 *)(v16 + 12), 0xFFFFFFFF) == 1 )
    (*(void (__fastcall **)(_QWORD, _QWORD *, __int64, __int64 *, int, _QWORD))(**((_QWORD **)&v18 + 1) + 8LL))(
      *((_QWORD *)&v18 + 1),
      v15,
      v14,
      v11,
