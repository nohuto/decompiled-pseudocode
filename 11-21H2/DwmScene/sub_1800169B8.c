...
__int64 *__fastcall sub_1800169B8(__int64 a1, __int64 *a2, _QWORD *a3, __int64 a4)
{
  __int64 v8; // r10
  __int64 v9; // rcx
  __int64 v10; // rdi
  ...
  if ( v11 )
  {
    *(_DWORD *)(v11 + 8) = 1;
    *(_DWORD *)(v11 + 12) = 1;
    *(_QWORD *)v11 = &std::_Ref_count<Spectre::Engine::RenderDeviceGeneric>::`vftable';
    *(_QWORD *)(v11 + 16) = v10;
  }
  else
  {
  ...
  *((_QWORD *)&v25 + 1) = v12;
  ...
  sub_18002C3FC(v10 + 24, &v28);
  sub_180028B40(v10, a3, a4);
  v23 = 0LL;
  if ( v12 )
    _InterlockedIncrement((volatile signed __int32 *)(v12 + 8));
  *(_QWORD *)&v23 = v10;
