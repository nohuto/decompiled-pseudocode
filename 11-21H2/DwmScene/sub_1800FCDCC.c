/*
 * XREFs of sub_1800FCDCC @ 0x1800FCDCC
 * Callers:
...
__int64 __fastcall sub_1800FCDCC(
        int a1,
        unsigned int a2,
        __int64 a3,
        int a4,
        ...
        __int64 a10)
{
  ...
  unsigned int v25; // [rsp+44h] [rbp-D4h]
  ...
  if ( v19 )
  {
    do
    {
      ...
      v23 = v14 && (v16 & 1) != 0;
      sub_1800FE460(v12, a5, v20, v21, v22, v23, a9, a10);
      result = sub_1800FD3E8(a1, v25, v21, v24, v23, a8);
