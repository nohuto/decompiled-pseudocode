...
char __fastcall sub_1800EC130(__int64 a1, __int64 a2)
{
  char v4; // cl
  __int64 v5; // rdx
  ...
  if ( v4 )
  {
    sub_1800113D0(v29, "VertexShaderD3D11::Load() -- this function can only be called once per shader instance");
    v25 = sub_1800113D0(
            v30,
  ...
  if ( *(_QWORD *)a2 != *(_QWORD *)(a2 + 8) || *(_DWORD *)(a2 + 32) != *(_DWORD *)(a2 + 24) )
  {
    ...
    v8 = v27;
    v9 = *(__int64 (__fastcall **)(__int64, __int64, __int64, _QWORD, __int64))(*(_QWORD *)v27 + 96LL);
    v10 = (__int64 *)(a1 + 104);
    v11 = *(_QWORD *)(a1 + 104);
    if ( v11 )
    {
