/*
 * XREFs of std::_Func_impl_no_alloc__lambda_007927d61fe5ef62e72e663f02d1702b__bool_Microsoft::WRL::ComPtr_IProcessSubmixProxy__const_&_::_Do_call @ 0x1800FD470
 * Callers:
 *     <none>
 * Callees:
        ...
        _QWORD *a2)
{
  ...
  v5 = (const WCHAR *)(*(__int64 (__fastcall **)(_QWORD))(*(_QWORD *)*a2 + 168LL))(*a2);
  v6 = 1;
