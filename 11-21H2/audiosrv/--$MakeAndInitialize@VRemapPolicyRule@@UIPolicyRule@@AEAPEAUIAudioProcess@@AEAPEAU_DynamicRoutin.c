/*
 * XREFs of ??$MakeAndInitialize@VRemapPolicyRule@@UIPolicyRule@@AEAPEAUIAudioProcess@@AEAPEAU_DynamicRoutingRule@@@Details@WRL@Microsoft@@YAJPEAPEAUIPolicyRule@@AEAPEAUIAudioProcess@@AEAPEAU_DynamicRoutingRule@@@Z @ 0x180130B04
 * Callers:
  ...
  *a1 = 0LL;
  ...
  if ( v6 )
  {
    ...
    *(_QWORD *)v7 = &RemapPolicyRule::`vftable';
    v9 = RemapPolicyRule::RuntimeClassInitialize(v8, *a2, *a3);
    if ( v9 >= 0 )
      v9 = (**(__int64 (__fastcall ***)(RemapPolicyRule *, GUID *, _QWORD *))v8)(
             v8,
