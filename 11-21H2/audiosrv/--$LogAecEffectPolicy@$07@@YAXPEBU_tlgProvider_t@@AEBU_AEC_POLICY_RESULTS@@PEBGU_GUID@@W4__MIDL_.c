/*
 * XREFs of ??$LogAecEffectPolicy@$07@@YAXPEBU_tlgProvider_t@@AEBU_AEC_POLICY_RESULTS@@PEBGU_GUID@@W4__MIDL___MIDL_itf_audioengineendpoint_0000_0000_0001@@@Z @ 0x180142C94
 * Callers:
...
__int64 __fastcall LogAecEffectPolicy<8>(__int64 a1, int *a2, __int64 a3, __int64 a4, int a5)
{
  __int64 result; // rax
  ...
  if ( *(_DWORD *)a1 > 4u && (*(_BYTE *)(a1 + 16) & 8) != 0 )
  {
