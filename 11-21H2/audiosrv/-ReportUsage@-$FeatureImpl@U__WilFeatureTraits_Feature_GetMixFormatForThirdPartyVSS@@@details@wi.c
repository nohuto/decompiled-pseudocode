/*
 * XREFs of ?ReportUsage@?$FeatureImpl@U__WilFeatureTraits_Feature_GetMixFormatForThirdPartyVSS@@@details@wil@@QEAAX_NW4ReportingKind@3@_K@Z @ 0x1800EF8C0
 * Callers:
...
void __fastcall wil::details::FeatureImpl<__WilFeatureTraits_Feature_GetMixFormatForThirdPartyVSS>::ReportUsage(
