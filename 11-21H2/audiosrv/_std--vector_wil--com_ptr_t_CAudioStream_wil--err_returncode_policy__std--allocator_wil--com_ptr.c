/*
 * XREFs of _std::vector_wil::com_ptr_t_CAudioStream_wil::err_returncode_policy__std::allocator_wil::com_ptr_t_CAudioStream_wil::err_returncode_policy_____::_Emplace_reallocate_wil::com_ptr_t_CAudioStream_wil::err_returncode_policy____::_1_::catch$4 @ 0x18006D432
 * Callers:
 *     <none>
 * Callees:
...
void __fastcall __noreturn std::vector_wil::com_ptr_t_CAudioStream_wil::err_returncode_policy__std::allocator_wil::com_ptr_t_CAudioStream_wil::err_returncode_policy_____::_Emplace_reallocate_wil::com_ptr_t_CAudioStream_wil::err_returncode_policy____::_1_::catch_4(
        __int64 a1,
        __int64 a2)
{
