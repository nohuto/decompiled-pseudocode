/*
 * XREFs of ?RemoveAll@?$CAtlList@PEAVCVADServer@@V?$CElementTraits@PEAVCVADServer@@@ATL@@@ATL@@QEAAXXZ @ 0x18003ED24
 * Callers:
 ...
 *     _dynamic_atexit_destructor_for__g_VADServerList__ @ 0x180072A10 (_dynamic_atexit_destructor_for__g_VADServerList__.c)
