/*
 * XREFs of ?ClearPerProcessRouting@DynamicAudioEndpointManager@@AEAAJQEAY08_NK@Z @ 0x180131A14
 * Callers:
  ...
  if ( v5 >= 0 )
  {
    ...
    while ( 2 )
    {
      ...
      do
      {
        if ( *v10 )
        {
          v5 = PublishChangeNotification((unsigned int)v8, (unsigned int)v9, &unk_18017F160, a3);
          v6 = v5;
          if ( v5 < 0 )
          {
            v7 = 69LL;
