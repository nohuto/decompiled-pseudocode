...
__int64 __fastcall DeviceGraphStore::GetSubmixesForApplication(__int64 a1, int a2, __int64 a3)
{
  ...
  *((_QWORD *)&v7 + 1) = &v11;
  ...
  v9 = v7;
  v10 = &v8;
  SubmixHelper = DeviceGraphStore::GetSubmixHelper(a3, (unsigned __int64)&v8);
  if ( v10 )
  {
    v5 = &v8;
    LOBYTE(v5) = v10 != &v8;
