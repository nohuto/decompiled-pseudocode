/*
 * XREFs of ?GetSupportedCellularRoutingPairs@TelephonyController@@AEAAJXZ @ 0x1801607CC
 * Callers:
 ...
 *     ?NewNode@?$CAtlList@U_tagKSTOPOLOGY_ENDPOINTIDPAIR@@VRoutingPairsTraits@@@ATL@@AEAAPEAVCNode@12@AEBU_tagKSTOPOLOGY_ENDPOINTIDPAIR@@PEAV312@1@Z @ 0x1801616D4 (-NewNode@-$CAtlList@U_tagKSTOPOLOGY_ENDPOINTIDPAIR@@VRoutingPairsTraits@@@ATL@@AEAAPEAVCNode@12@.c)
 */
