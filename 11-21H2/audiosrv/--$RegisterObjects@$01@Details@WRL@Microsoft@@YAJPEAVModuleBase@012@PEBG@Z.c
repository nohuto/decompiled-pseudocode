/*
 * XREFs of ??$RegisterObjects@$01@Details@WRL@Microsoft@@YAJPEAVModuleBase@012@PEBG@Z @ 0x18005B6B4
 * Callers:
 *     ?ConnectCallback@ServiceModule@Internal@Windows@@UEAAJXZ @ 0x18005DEF0 (-ConnectCallback@ServiceModule@Internal@Windows@@UEAAJXZ.c)
 * Callees:
