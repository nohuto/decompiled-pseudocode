/*
 * XREFs of _CPolicyConfig::GetAudioSessionPropertyStore_::_1_::catch$52 @ 0x18006C6BA
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall CPolicyConfig::GetAudioSessionPropertyStore_::_1_::catch_52(
        __int64 a1,
        __int64 a2,
        __int64 a3,
        const char *a4)
