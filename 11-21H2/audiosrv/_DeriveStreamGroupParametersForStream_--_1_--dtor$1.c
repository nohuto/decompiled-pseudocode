/*
 * XREFs of _DeriveStreamGroupParametersForStream_::_1_::dtor$1 @ 0x18006FC60
 * Callers:
 *     <none>
 * Callees:
 *     <none>
...
void __fastcall DeriveStreamGroupParametersForStream_::_1_::dtor_1(__int64 a1, __int64 a2)
{
