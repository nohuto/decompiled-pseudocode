/*
 * XREFs of ?RuntimeClassInitialize@CExclusiveModeListener@@QEAAJXZ @ 0x18012D7CC
 * Callers:
...
__int64 __fastcall CExclusiveModeListener::RuntimeClassInitialize(LPVOID *this)
{
  ...
  __int64 v30; // r8
  __int64 v31; // r9
  unsigned int v32; // [rsp+40h] [rbp-19h] BYREF
  struct Windows::Graphics::Holographic::IHolographicDisplay *v33; // [rsp+48h] [rbp-11h] BYREF
  __int128 v34; // [rsp+50h] [rbp-9h]
  ...
  if ( v13 )
  {
    ...
    *(_QWORD *)&v34 = v16;
    ...
    if ( (*(int (__fastcall **)(__int64 *, struct Windows::Graphics::Holographic::IHolographicDisplay **))(v18 + 64))(
           ...
           &v33) >= 0
      && v33
      && (v19 = CExclusiveModeListener::OnHmdAdded((CExclusiveModeListener *)this, *v10, v33), updated = v19, v19 < 0) )
    {
