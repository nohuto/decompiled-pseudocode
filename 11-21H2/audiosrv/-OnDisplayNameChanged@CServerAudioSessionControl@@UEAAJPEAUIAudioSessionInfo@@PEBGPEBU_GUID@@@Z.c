/*
 * XREFs of ?OnDisplayNameChanged@CServerAudioSessionControl@@UEAAJPEAUIAudioSessionInfo@@PEBGPEBU_GUID@@@Z @ 0x1800DC1C0
 * Callers:
 *     <none>
 * Callees:
        ...
        struct _GUID *a4)
{
  ...
  struct _RTL_CRITICAL_SECTION *v23; // [rsp+60h] [rbp+8h] BYREF
  ...
  v8 = *((_QWORD *)this + 9);
  v23 = (struct _RTL_CRITICAL_SECTION *)((char *)this + 32);
  if ( v8 )
  {
