/*
 * XREFs of AudioVolumeGetStepInfo @ 0x1800D1850
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall AudioVolumeGetStepInfo(_QWORD *a1, __int64 a2, __int64 a3)
{
  ...
  CWatchdogTimer<1>::CWatchdogTimer<1>(
    ...
    v5,
    (struct _TP_TIMER *)L"AudioVolumeGetStepInfo",
    pftDueTime);
  LODWORD(pftDueTime) = (*(__int64 (__fastcall **)(_QWORD, __int64, __int64))(*(_QWORD *)*a1 + 120LL))(*a1, a2, a3);
