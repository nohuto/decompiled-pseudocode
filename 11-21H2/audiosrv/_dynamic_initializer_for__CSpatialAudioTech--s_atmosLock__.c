/*
 * XREFs of _dynamic_initializer_for__CSpatialAudioTech::s_atmosLock__ @ 0x180001B80
 * Callers:
 *     <none>
 * Callees:
 *     ??0CriticalSection@Wrappers@WRL@Microsoft@@QEAA@XZ @ 0x180042B6C (--0CriticalSection@Wrappers@WRL@Microsoft@@QEAA@XZ.c)
 */
