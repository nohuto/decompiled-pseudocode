/*
 * XREFs of ?_Do_call@?$_Func_impl_no_alloc@V_lambda_9ead50e0cd1551eeb76b97ff9d1b3ab3_@@X_N@std@@EEAAX$$QEA_N@Z @ 0x180064A80
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall std::_Func_impl_no_alloc<_lambda_9ead50e0cd1551eeb76b97ff9d1b3ab3_,void,bool>::_Do_call(
        __int64 a1,
        char *a2)
{
  char v3; // di
  ...
  v3 = *a2;
  wil::operation_guard::acquire(*(_QWORD *)(a1 + 16), &v5);
  if ( v5 )
