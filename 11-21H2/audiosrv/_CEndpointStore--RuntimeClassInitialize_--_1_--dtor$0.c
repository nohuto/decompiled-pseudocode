/*
 * XREFs of _CEndpointStore::RuntimeClassInitialize_::_1_::dtor$0 @ 0x18006CBD2
 * Callers:
 *     <none>
 * Callees:
 *     <none>
...
__int64 __fastcall CEndpointStore::RuntimeClassInitialize_::_1_::dtor_0(__int64 a1, __int64 a2)
{
