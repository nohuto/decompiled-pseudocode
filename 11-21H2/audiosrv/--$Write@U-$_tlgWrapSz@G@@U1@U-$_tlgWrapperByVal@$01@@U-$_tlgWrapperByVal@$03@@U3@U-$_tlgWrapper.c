        ...
        __int64 *a10)
{
  ...
  _WORD *v21; // [rsp+50h] [rbp-49h]
  int v22; // [rsp+58h] [rbp-41h]
  int v23; // [rsp+5Ch] [rbp-3Dh]
  _WORD *v24; // [rsp+60h] [rbp-39h]
  ...
  v22 = v13;
  v23 = 0;
  return tlgWriteTransfer_EtwEventWriteTransfer(a1, a2, 0LL, 0LL, 8, (__int64)v20);
}
