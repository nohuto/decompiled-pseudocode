/*
 * XREFs of ?RevokeApplicationResources@CSpatialAudioResourceManager@Sarm@@AEAAXK@Z @ 0x180128974
 * Callers:
...
void __fastcall Sarm::CSpatialAudioResourceManager::RevokeApplicationResources(
        ...
        int a2)
{
  ...
  if ( FirstStream )
  {
    do
    {
      ...
      FirstStream = Sarm::CSpatialAudioResourceManager::GetNextStream(this, a2);
    }
    while ( FirstStream );
    if ( v11 )
    {
      CWorkFifo::DelayWorkUntil((Sarm::CSpatialAudioResourceManager *)((char *)this + 344), v12 + v3);
      *(_QWORD *)&v15 = this;
      v16 = off_180177CF8;
      DWORD2(v15) = a2;
      v18 = &v16;
