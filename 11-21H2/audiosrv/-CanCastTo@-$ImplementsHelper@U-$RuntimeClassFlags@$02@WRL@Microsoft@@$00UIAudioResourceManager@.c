/*
 * XREFs of ?CanCastTo@?$ImplementsHelper@U?$RuntimeClassFlags@$02@WRL@Microsoft@@$00UIAudioResourceManager@@UIWeakReferenceSource@@UIAudioResourceControl@@@Details@WRL@Microsoft@@IEAAJAEBU_GUID@@PEAPEAXPEA_N@Z @ 0x180050268
 * Callers:
        ...
        const struct _GUID *a2)
{
  ...
  if ( InlineIsEqualGUID(a2, &GUID_10a6e9ab_b284_4dc3_acfe_a25387083f2c) )
  {
    *v3 = v4;
    return 0LL;
  }
