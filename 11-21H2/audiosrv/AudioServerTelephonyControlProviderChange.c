/*
 * XREFs of AudioServerTelephonyControlProviderChange @ 0x1800F4C60
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall AudioServerTelephonyControlProviderChange(__int64 a1, __int64 a2, unsigned int a3)
{
  ...
  CWatchdogTimer<1>::CWatchdogTimer<1>(
    ...
    v5,
    (struct _TP_TIMER *)L"AudioServerTelephonyControlProviderChange",
    pftDueTime);
  LODWORD(pftDueTime) = ((__int64 (__fastcall *)(struct IUnknown *, __int64, _QWORD))g_TelephonyControl->lpVtbl[3].AddRef)(
                          g_TelephonyControl,
                          a2,
                          a3);
