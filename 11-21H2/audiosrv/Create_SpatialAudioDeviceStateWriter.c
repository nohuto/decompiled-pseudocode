/*
 * XREFs of Create_SpatialAudioDeviceStateWriter @ 0x18004EBA0
 * Callers:
...
__int64 __fastcall Create_SpatialAudioDeviceStateWriter(__int64 a1, __int64 a2, _QWORD *a3, int a4)
{
  int v5; // eax
  int v6; // ebx
  void *v8; // rdx
