/*
 * XREFs of ?GetResourceGroupOrderByPriority@CConstraintModelResourceManager@@AEAAJPEAU_ResourceInfo@@KPEAKPEAPEAU2@@Z @ 0x18010B928
 * Callers:
    ...
    if ( v12 )
    {
      ...
      if ( v13 )
      {
        ...
        do
        {
          ...
          if ( v20 < v8 )
          {
            v23 = (_DWORD *)((char *)v13 + 540 * v20 + 536);
            do
            {
              v24 = v22;
            ...
            if ( v24 != v20 )
            {
              ...
              do
              {
                ...
                *((_OWORD *)v25 + 5) = v32;
                v34 = *((_OWORD *)v27 + 7);
                v27 = (struct _ResourceInfo *)((char *)v27 + 128);
                *((_OWORD *)v25 + 6) = v33;
                v25 += 128;
                *((_OWORD *)v25 - 1) = v34;
                --v26;
          ...
          ++v20;
          v19 = (struct _ResourceInfo *)((char *)v19 + 540);
        }
        while ( v20 < v8 );
        *a4 = v8;
        *a5 = v13;
