/*
 * XREFs of std::forward_list_Microsoft::WRL::WeakRef_std::allocator_Microsoft::WRL::WeakRef___::remove_if__lambda_18f5db6963bdb451b262a69b713c7ee0___ @ 0x1800D282C
 * Callers:
        ...
        __int64 **a1)
{
  ...
  while ( v1 )
  {
    ...
    Microsoft::WRL::ComPtr<AtmosCheck>::InternalRelease(&v9);
    if ( v3 )
    {
      v4 = *v2;
      v1 = (__int64 *)**v2;
