/*
 * XREFs of ?GetKsMidiDeviceInfo@@YAJPEBGPEAPEAGPEAI@Z @ 0x1800F5DE8
 * Callers:
    ...
    if ( Property && *(_DWORD *)(Property + 32) == 13 )
    {
      ...
      if ( v11 )
      {
        if ( *(_DWORD *)(v11 + 32) == 18 )
        {
          ...
          while ( v13[v14] );
          v15 = v14 + 1;
          if ( v14 + 1 < v14 || !is_mul_ok(v15, 2uLL) )
          {
            ObjectProperties = -2147024362;
            goto LABEL_23;
          }
          v16 = CTCoAllocPolicy::Alloc(v12, (v15 * (unsigned __int128)2uLL) >> 64, 2 * v15, (void **)&v25);
          v5 = v25;
