/*
 * XREFs of ?Initialize@CAudioSessionInstanceId@@QEAAJPEBG0@Z @ 0x1800E7008
 * Callers:
...
LABEL_29:
  ...
  if ( v5 < 0 )
    goto LABEL_29;
  v5 = CAppAudioSessionId::Initialize((CAudioSessionInstanceId *)((char *)v4 + 8), (char *)v24);
  if ( v5 < 0 )
    goto LABEL_29;
  v5 = CAppInstanceId::Initialize((CAudioSessionInstanceId *)((char *)v4 + 56), (char *)v23);
  if ( v5 < 0 )
    goto LABEL_29;
