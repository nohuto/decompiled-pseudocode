/*
 * XREFs of ?VerifyListIntegrityAndRefreshDependencies@DynamicAudioEndpointManager@@AEAA_NQEAY08_N@Z @ 0x180133B74
 * Callers:
        ...
        bool (*const a2)[9])
{
  ...
  do
  {
    ...
    do
    {
      ...
      while ( v21 )
      {
        v8 = *ATL::CAtlList<ATL::CComQIPtr<CMonitorManager::CaptureMonitor,&_GUID const IID_IUnknown>,ATL::CComQIPtrElementTraits<CMonitorManager::CaptureMonitor,&_GUID const IID_IUnknown>>::GetNext(
                (__int64)this,
                &v21);
        v14 = v8;
        if ( (*(unsigned int (__fastcall **)(__int64))(*(_QWORD *)v8 + 56LL))(v8) - 2 <= 1 )
        {
          ...
          if ( !DynamicAudioEndpointManager::VerifyListIntegrityAndRefreshDependencies(
                  ...
                  (__int64 *)&v15) )
            goto LABEL_13;
          ATL::CAtlList<IPolicyRule *,ATL::CElementTraits<IPolicyRule *>>::RemoveHead((__int64 *)&v15);
