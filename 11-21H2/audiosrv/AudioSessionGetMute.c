/*
 * XREFs of AudioSessionGetMute @ 0x180006150
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall AudioSessionGetMute(__int64 *a1, __int64 a2)
{
  ...
  v5 = (*(__int64 (__fastcall **)(__int64, __int64))(*(_QWORD *)v2 + 304LL))(v2, a2);
  v6 = v5;
  if ( v5 < 0 )
    AudSrvTraceLoggingErrorHelper("AudioSessionGetMute", 0x829u, v5);
