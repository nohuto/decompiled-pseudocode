/*
 * XREFs of ?ReportUsage@?$FeatureImpl@U__WilFeatureTraits_Feature_CAMNotification@@@details@wil@@QEAAX_NW4ReportingKind@3@_K@Z @ 0x1800EF83C
 * Callers:
...
void __fastcall wil::details::FeatureImpl<__WilFeatureTraits_Feature_CAMNotification>::ReportUsage(
        ...
        __int64 a4)
{
  ...
  if ( (*a1 & 2) == 0 )
  {
    v4 = *(_QWORD *)wil::details::FeatureImpl<__WilFeatureTraits_Feature_CAMNotification>::GetCachedFeatureEnabledState(
                      a1,
                      v7);
    v10 = v4;
  }
