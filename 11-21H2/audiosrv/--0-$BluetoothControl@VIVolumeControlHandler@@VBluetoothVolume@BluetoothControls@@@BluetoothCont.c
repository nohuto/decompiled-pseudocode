/*
 * XREFs of ??0?$BluetoothControl@VIVolumeControlHandler@@VBluetoothVolume@BluetoothControls@@@BluetoothControls@@QEAA@XZ @ 0x1800630BC
 * Callers:
 *     ??0BluetoothVolume@BluetoothControls@@QEAA@XZ @ 0x1800C68E8 (--0BluetoothVolume@BluetoothControls@@QEAA@XZ.c)
 * Callees:
 *     ??$make_shared@Voperation_guard@wil@@$$V@std@@YA?AV?$shared_ptr@Voperation_guard@wil@@@0@XZ @ 0x180062F94 (--$make_shared@Voperation_guard@wil@@$$V@std@@YA-AV-$shared_ptr@Voperation_guard@wil@@@0@XZ.c)
