        ...
        __int64 *a3)
{
  ...
  while ( !*((_BYTE *)v3 + 25) )
  {
    ...
    v7 = v6[11];
    if ( v7 >= 8 )
      std::_Deallocate<16,0>((void *)v6[8], 2 * v7 + 2);
    v6[10] = 0LL;
    v6[11] = 7LL;
    *((_WORD *)v6 + 32) = 0;
    v8 = v6[7];
    if ( v8 >= 8 )
      std::_Deallocate<16,0>((void *)v6[4], 2 * v8 + 2);
    v6[6] = 0LL;
    v6[7] = 7LL;
    *((_WORD *)v6 + 16) = 0;
