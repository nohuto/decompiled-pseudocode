/*
 * XREFs of ?Pause@CMonitorManager@@QEAAXXZ @ 0x18011DE38
 * Callers:
 *     ?PauseAllMonitors@CStreamConnectionManagerImpl@@UEAAXXZ @ 0x18011DF30 (-PauseAllMonitors@CStreamConnectionManagerImpl@@UEAAXXZ.c)
 * Callees:
