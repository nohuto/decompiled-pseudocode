/*
 * XREFs of ??$_Emplace_reallocate@AEBQEAVCVADServer@@@?$vector@PEAVCVADServer@@V?$allocator@PEAVCVADServer@@@std@@@std@@QEAAPEAPEAVCVADServer@@QEAPEAV2@AEBQEAV2@@Z @ 0x18002537C
 * Callers:
 ...
 *     ?_Change_array@?$vector@PEAVCVADServer@@V?$allocator@PEAVCVADServer@@@std@@@std@@AEAAXQEAPEAVCVADServer@@_K1@Z @ 0x1800254F0 (-_Change_array@-$vector@PEAVCVADServer@@V-$allocator@PEAVCVADServer@@@std@@@std@@AEAAXQEAPEAVCVA.c)
        ...
        _QWORD *a3)
{
  ...
  *(_QWORD *)v14 = *a3;
  ...
  std::vector<CVADServer *>::_Change_array(a1, v13, v9, v8);
  return v14;
}
