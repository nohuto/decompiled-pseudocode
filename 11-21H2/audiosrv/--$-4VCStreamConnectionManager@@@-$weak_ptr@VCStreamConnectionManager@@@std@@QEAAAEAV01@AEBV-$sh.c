/*
 * XREFs of ??$?4VCStreamConnectionManager@@@?$weak_ptr@VCStreamConnectionManager@@@std@@QEAAAEAV01@AEBV?$shared_ptr@VCStreamConnectionManager@@@1@@Z @ 0x18005D374
 * Callers:
...
__int64 *std::weak_ptr<CStreamConnectionManager>::operator=<CStreamConnectionManager>()
{
  ...
  if ( qword_1801C2E80 )
  {
    ...
    _InterlockedIncrement((volatile signed __int32 *)qword_1801C2E80 + 3);
    v2 = v0;
  }
