/*
 * XREFs of ?IsFixedFormatApo@@YA_NPEAUIAudioProcessingObject@@@Z @ 0x18014A7EC
 * Callers:
...
char __fastcall IsFixedFormatApo(struct IAudioProcessingObject *a1)
{
  ...
  wil::com_ptr_t<ISessionInternalEvents,wil::err_returncode_policy>::~com_ptr_t<ISessionInternalEvents,wil::err_returncode_policy>(&v6);
  return v2;
}
