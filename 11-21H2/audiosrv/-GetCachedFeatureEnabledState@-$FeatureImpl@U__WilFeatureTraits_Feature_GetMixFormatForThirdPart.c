/*
 * XREFs of ?GetCachedFeatureEnabledState@?$FeatureImpl@U__WilFeatureTraits_Feature_GetMixFormatForThirdPartyVSS@@@details@wil@@AEAA?ATwil_details_FeatureStateCache@@XZ @ 0x1800EE944
 * Callers:
...
signed __int32 *__fastcall wil::details::FeatureImpl<__WilFeatureTraits_Feature_GetMixFormatForThirdPartyVSS>::GetCachedFeatureEnabledState(
        ...
        signed __int32 *a2)
{
  ...
  *a2 = *a1;
  if ( (v2 & 3) != 3 )
  {
    ...
    wil::details::FeatureImpl<__WilFeatureTraits_Feature_GetMixFormatForThirdPartyVSS>::GetCurrentFeatureEnabledState(
      a1,
      &v13,
      &i);
    v6 = *a2;
