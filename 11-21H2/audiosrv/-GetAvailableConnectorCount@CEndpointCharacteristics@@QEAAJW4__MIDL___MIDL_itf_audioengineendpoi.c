/*
 * XREFs of ?GetAvailableConnectorCount@CEndpointCharacteristics@@QEAAJW4__MIDL___MIDL_itf_audioengineendpoint_0000_0000_0001@@PEAI@Z @ 0x180147AF4
 * Callers:
        ...
        unsigned int *a3)
{
  ...
  *(_OWORD *)pvar = 0LL;
  ...
  v16 = pvar;
  v17 = 1;
  v7 = (*(__int64 (__fastcall **)(_QWORD, _DWORD *, PROPVARIANT *))(**((_QWORD **)this + 5) + 40LL))(
         *((_QWORD *)this + 5),
         v18,
         pvar);
  v8 = v7;
