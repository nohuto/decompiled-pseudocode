/*
 * XREFs of ?OnDeviceDescriptionChanged@CMonitorManager@@AEAAXPEBGPEBU_tagpropertykey@@@Z @ 0x18011D3A0
 * Callers:
 *     <none>
 * Callees:
        ...
        const struct _tagpropertykey *a3)
{
  ...
  else
  {
    ...
    if ( v7.lpVtbl )
      CMonitor::OnDeviceDescriptionChanged((CMonitor *)v7.lpVtbl[8].AddRef, v9);
