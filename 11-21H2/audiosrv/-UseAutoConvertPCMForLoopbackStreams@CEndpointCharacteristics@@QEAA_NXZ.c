/*
 * XREFs of ?UseAutoConvertPCMForLoopbackStreams@CEndpointCharacteristics@@QEAA_NXZ @ 0x18014DA08
 * Callers:
...
char __fastcall CEndpointCharacteristics::UseAutoConvertPCMForLoopbackStreams(struct _RTL_CRITICAL_SECTION *this)
{
  char v1; // bl
  void *v2; // rcx
  void *v3; // rcx
