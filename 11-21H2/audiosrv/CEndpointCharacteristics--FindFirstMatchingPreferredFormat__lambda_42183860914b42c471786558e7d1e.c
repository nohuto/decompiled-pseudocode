/*
 * XREFs of CEndpointCharacteristics::FindFirstMatchingPreferredFormat__lambda_42183860914b42c471786558e7d1eac4___ @ 0x18013FCF8
 * Callers:
...
__int64 __fastcall CEndpointCharacteristics::FindFirstMatchingPreferredFormat__lambda_42183860914b42c471786558e7d1eac4___(
        __int64 a1,
        __int64 a2,
        __int64 a3)
{
...
LABEL_27:
  ...
  while ( 1 )
  {
    ...
    *(_WORD *)(v19 + 16) = 22;
    v23[0] = 0;
    result = lambda_42183860914b42c471786558e7d1eac4_::operator()(v27, v19, v23);
    if ( (int)result < 0 )
      return result;
    if ( v23[0] )
      return 0LL;
