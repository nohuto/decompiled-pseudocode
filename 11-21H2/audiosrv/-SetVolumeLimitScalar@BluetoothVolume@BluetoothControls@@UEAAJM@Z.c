/*
 * XREFs of ?SetVolumeLimitScalar@BluetoothVolume@BluetoothControls@@UEAAJM@Z @ 0x1800C7B90
 * Callers:
 *     <none>
 * Callees:
        ...
        float a2)
{
  ...
  TargetedControl = (_QWORD *)BluetoothControls::BluetoothControl<IVolumeControlHandler,BluetoothControls::BluetoothVolume>::GetTargetedControl(
                                (__int64)this,
                                (__int64)&v5);
  v3 = (*(__int64 (__fastcall **)(_QWORD))(*(_QWORD *)*TargetedControl + 200LL))(*TargetedControl);
