/*
 * XREFs of Create_SpatialAudioDeviceStateReader @ 0x180038A40
 * Callers:
...
__int64 __fastcall Create_SpatialAudioDeviceStateReader(__int64 a1, __int64 a2, _QWORD *a3, int a4)
{
  int v5; // eax
  int v6; // ebx
  __int64 v7; // rcx
