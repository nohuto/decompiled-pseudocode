/*
 * XREFs of _EndpointDevice::InitTopologyIdInfo_::_1_::dtor$2 @ 0x18006D8B0
 * Callers:
 *     <none>
 * Callees:
 *     <none>
...
__int64 __fastcall EndpointDevice::InitTopologyIdInfo_::_1_::dtor_2(__int64 a1, __int64 a2)
{
