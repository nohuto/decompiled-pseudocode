/*
 * XREFs of ?RuntimeClassInitialize@SpatialAudioMetadataDictionary@@QEAAJW4DictionaryLoadKind@@AEBU_GUID@@GPEBGPEAEI@Z @ 0x18013B3FC
 * Callers:
        ...
        size_t Size)
{
  ...
  {
    Dictionary = SpatialAudioMetadataDictionary::LoadDictionary(a1, a2, (__int64)a3, a4, a5);
    v11 = Dictionary;
    if ( Dictionary < 0 )
    {
      if ( (unsigned int)dword_1801C0258 <= 2 )
