/*
 * XREFs of _AtmosCheck::GetDefaultAudioEndpointId_::_1_::dtor$0 @ 0x180154337
 * Callers:
 *     <none>
 * Callees:
 *     <none>
...
__int64 __fastcall AtmosCheck::GetDefaultAudioEndpointId_::_1_::dtor_0(__int64 a1, __int64 a2)
{
