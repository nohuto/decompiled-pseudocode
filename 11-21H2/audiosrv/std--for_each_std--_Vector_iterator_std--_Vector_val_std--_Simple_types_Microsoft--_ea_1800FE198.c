/*
 * XREFs of std::for_each_std::_Vector_iterator_std::_Vector_val_std::_Simple_types_Microsoft::WRL::ComPtr_IStreamGroupProxy_________lambda_c5ba6885c59c7d44add3d2e24646e672___ @ 0x1800FE198
 * Callers:
        ...
        __int64 a4)
{
  ...
  __int64 v11; // rcx
  __int64 v12; // rdx
  _BYTE v14[64]; // [rsp+20h] [rbp-59h] BYREF
  _BYTE v15[56]; // [rsp+60h] [rbp-19h] BYREF
  _QWORD *v16; // [rsp+98h] [rbp+1Fh]

  for ( i = a2; i != a3; i += 8LL )
  {
    v8 = *(_QWORD *)i;
    v9 = *(void (__fastcall **)(__int64, _BYTE *))(**(_QWORD **)i + 352LL);
    std::function<bool (IAudioStreamInfo *)>::function<bool (IAudioStreamInfo *)>(v14, a4);
    v16 = 0LL;
