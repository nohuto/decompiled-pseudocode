        ...
        void **a19)
{
  ...
  _WORD *v57; // [rsp+120h] [rbp+20h]
  int v58; // [rsp+128h] [rbp+28h]
  int v59; // [rsp+12Ch] [rbp+2Ch]
  _WORD *v60; // [rsp+130h] [rbp+30h]
  ...
  v34 = 16LL;
  v32 = 4LL;
  return tlgWriteTransfer_EtwEventWriteTransfer(a1, a2, 0LL, 0LL, 17, (__int64)v30);
}
