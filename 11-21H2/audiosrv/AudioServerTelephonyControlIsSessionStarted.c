/*
 * XREFs of AudioServerTelephonyControlIsSessionStarted @ 0x1800F4BC0
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall AudioServerTelephonyControlIsSessionStarted(__int64 a1, __int64 a2)
{
  ...
  CWatchdogTimer<1>::CWatchdogTimer<1>(
    ...
    pftDueTime);
  LODWORD(pftDueTime) = ((__int64 (__fastcall *)(struct IUnknown *, __int64))g_TelephonyControl->lpVtbl[1].AddRef)(
                          g_TelephonyControl,
                          a2);
