/*
 * XREFs of _CAudioSessionInstanceId::CAudioSessionInstanceId_::_1_::dtor$0 @ 0x1800DF068
 * Callers:
 *     <none>
 * Callees:
 *     <none>
...
void __fastcall CAudioSessionInstanceId::CAudioSessionInstanceId_::_1_::dtor_0(__int64 a1, __int64 a2)
{
