/*
 * XREFs of ?ScheduleWorkItem@CWorkFifo@@QEAAJV?$function@$$A6AXXZ@std@@@Z @ 0x180128B00
 * Callers:
...
LABEL_28:
    ...
    v12 = std::function<void (void)>::function<void (void)>((__int64)v20, v2);
