/*
 * XREFs of ?ToString@CAudioEndpointId@@QEBAJAEAV?$CStringT@GV?$StrTraitATL@GV?$ChTraitsCRT@G@ATL@@@ATL@@@ATL@@@Z @ 0x18001EC10
 * Callers:
...
__int64 __fastcall CAudioEndpointId::ToString(void **a1, void **a2)
{
  void *v3; // r15
  ...
  if ( v4 != v5 )
  {
    ...
    {
      ATL::CSimpleStringT<unsigned short,0>::SetString(a2, (char *)v3, *((_DWORD *)v3 - 4));
    }
  }
  return 0LL;
}
