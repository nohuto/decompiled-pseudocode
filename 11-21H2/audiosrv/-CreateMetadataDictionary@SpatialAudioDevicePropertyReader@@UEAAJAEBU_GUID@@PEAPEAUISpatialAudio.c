/*
 * XREFs of ?CreateMetadataDictionary@SpatialAudioDevicePropertyReader@@UEAAJAEBU_GUID@@PEAPEAUISpatialAudioMetadataDictionaryData@@@Z @ 0x180136AE0
 * Callers:
 *     <none>
 * Callees:
  ...
  *(_OWORD *)pvar = 0LL;
  ...
  if ( a3 )
  {
    *a3 = 0LL;
    ...
    v16 = Create_SpatialAudioMetadataDictionaryFromData(v18[0], v14, v15, &v21);
    v10 = v16;
    if ( v16 < 0 )
    {
      if ( (unsigned int)dword_1801C0258 <= 2 )
