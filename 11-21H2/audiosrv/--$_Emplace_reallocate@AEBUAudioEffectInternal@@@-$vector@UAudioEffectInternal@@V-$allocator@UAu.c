/*
 * XREFs of ??$_Emplace_reallocate@AEBUAudioEffectInternal@@@?$vector@UAudioEffectInternal@@V?$allocator@UAudioEffectInternal@@@std@@@std@@QEAAPEAUAudioEffectInternal@@QEAU2@AEBU2@@Z @ 0x1800E320C
 * Callers:
 ...
 *     ?_Change_array@?$vector@UAudioEffectInternal@@V?$allocator@UAudioEffectInternal@@@std@@@std@@AEAAXQEAUAudioEffectInternal@@_K1@Z @ 0x1800E5DE4 (-_Change_array@-$vector@UAudioEffectInternal@@V-$allocator@UAudioEffectInternal@@@std@@@std@@AEA.c)
 */
        ...
        __int64 a3)
{
  ...
  try
  {
    ...
    *((_QWORD *)v15 + 2) = *(_QWORD *)(a3 + 16);
    ...
    std::vector<AudioEffectInternal>::_Change_array(a1, v14, v9, v8);
    result = v15;
  }
  catch ( ... )
  {
