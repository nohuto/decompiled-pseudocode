/*
 * XREFs of ?Dispose@CServerAudioSessionControl@@EEAAJXZ @ 0x18000C180
 * Callers:
 *     <none>
 * Callees:
 ...
 *     WPP_SF_qqS @ 0x1800DE044 (WPP_SF_qqS.c)
 */
...
__int64 __fastcall CServerAudioSessionControl::Dispose(CServerAudioSessionControl *this)
{
  ...
  if ( v4 )
  {
    (*(void (__fastcall **)(__int64, CServerAudioSessionControl *))(*(_QWORD *)v4 + 160LL))(v4, this);
    v2 = *((_QWORD *)this + 9);
    *((_QWORD *)this + 9) = 0LL;
  }
  ...
  if ( v2 )
  {
    ...
    (*(void (__fastcall **)(__int64, __int64))(*(_QWORD *)v2 + 248LL))(v2, v3);
    if ( WPP_GLOBAL_Control != (CEndpointStoreCache *)&WPP_GLOBAL_Control
      && (*((_BYTE *)WPP_GLOBAL_Control + 28) & 0x40) != 0
      && *((_BYTE *)WPP_GLOBAL_Control + 25) >= 4u )
    {
