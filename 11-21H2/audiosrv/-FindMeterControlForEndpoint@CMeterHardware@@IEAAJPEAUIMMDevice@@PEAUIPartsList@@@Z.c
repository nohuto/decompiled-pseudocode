/*
 * XREFs of ?FindMeterControlForEndpoint@CMeterHardware@@IEAAJPEAUIMMDevice@@PEAUIPartsList@@@Z @ 0x180045264
 * Callers:
        ...
        struct IPartsList *a3)
{
  ...
  if ( a2 )
  {
      ...
      if ( v6 >= 0 )
      {
        ...
        if ( WPP_GLOBAL_Control != (CEndpointStoreCache *)&WPP_GLOBAL_Control )
        {
          ...
          if ( v7 != (CEndpointStoreCache *)&WPP_GLOBAL_Control
            ...
            && *((_BYTE *)v7 + 25) >= 4u )
          {
            WPP_SF_q(*((_QWORD *)v7 + 2), 15LL, &WPP_b909e168dacd373727fcf23ad3479388_Traceguids, this);
          }
        }
        v8 = v13;
        if ( v13 != a2 )
    ...
    if ( v6 < 0 )
      AudSrvTraceLoggingErrorHelper("CMeterHardware::FindMeterControlForEndpoint", 0x149u, v6);
