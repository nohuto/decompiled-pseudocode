/*
 * XREFs of ?SetCellularVolume@TelephonyController@@UEAAJM@Z @ 0x180161E50
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall TelephonyController::SetCellularVolume(TelephonyController *this, float a2)
{
  ...
  if ( *v4 > 4u )
  {
    ...
    v11 = 4;
    v10 = &v8;
    tlgWriteTransfer_EventWriteTransfer((__int64)v4, (unsigned __int8 *)dword_18018FCC8, 0LL, 0LL, 3u, &v9);
  }
