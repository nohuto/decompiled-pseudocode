...
LABEL_14:
      ++*v5;
      ++v22;
      LogOutput((size_t *)L"Resource ID %s found with limit %d", v55, v54);
      continue;
    }
        ...
        if ( StartOrEndElement >= 0 )
        {
                  ...
                  &v34) )
          {
            ...
            *(_QWORD *)((char *)&v32 + 4) = 1LL;
            ...
            ++*v5;
            ++v22;
            LogOutput((size_t *)L"Resource group ID %s found with limit %d", v43, v42);
            v26 = 0;
            v25 = 1;
            while ( 1 )
            {
...
LABEL_39:
              ...
              ++v26;
              ++v22;
              LogOutput((size_t *)L"Resource ID %s in resource group ID %s found with limit %d", v49, v43, v48);
            }
          }
          v10 = v43;
LABEL_20:
