/*
 * XREFs of ?IsTechnologySupported@CSpatialAudioDolbyStereo@@UEBA_NPEAVCEndpointCharacteristics@@PEBUtWAVEFORMATEX@@1KPEAIPEA_NPEAUWAVEFORMATEXTENSIBLE@@@Z @ 0x1800530A0
 * Callers:
 *     <none>
 * Callees:
