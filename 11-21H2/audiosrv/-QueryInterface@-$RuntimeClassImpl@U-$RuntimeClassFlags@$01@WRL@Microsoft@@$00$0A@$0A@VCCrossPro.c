/*
 * XREFs of ?QueryInterface@?$RuntimeClassImpl@U?$RuntimeClassFlags@$01@WRL@Microsoft@@$00$0A@$0A@VCCrossProcessBaseMemory@@@Details@WRL@Microsoft@@UEAAJAEBU_GUID@@PEAPEAX@Z @ 0x18000CCB0
 * Callers:
        ...
        _QWORD *a3)
{
  ...
  *a3 = 0LL;
  if ( *a2 )
  {
    ...
    v4 = *(_DWORD *)&GUID_910f47db_d25f_4cf9_995e_f86c161b3eef.Data4[4];
  }
  else
  {
