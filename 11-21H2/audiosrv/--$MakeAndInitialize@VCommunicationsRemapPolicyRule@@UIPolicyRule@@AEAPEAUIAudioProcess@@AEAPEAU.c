/*
 * XREFs of ??$MakeAndInitialize@VCommunicationsRemapPolicyRule@@UIPolicyRule@@AEAPEAUIAudioProcess@@AEAPEAU_DynamicRoutingRule@@@Details@WRL@Microsoft@@YAJPEAPEAUIPolicyRule@@AEAPEAUIAudioProcess@@AEAPEAU_DynamicRoutingRule@@@Z @ 0x1801309FC
 * Callers:
        ...
        struct _DynamicRoutingRule **a3)
{
  PolicyRule *v6; // rax
  PolicyRule *v7; // rbx
  CommunicationsRemapPolicyRule *v8; // rdi
  int v9; // esi
  ...
  *a1 = 0LL;
  ...
  if ( v6 )
  {
    ...
    *((_BYTE *)v7 + 344) = 0;
    v9 = CommunicationsRemapPolicyRule::RuntimeClassInitialize(v8, *a2, *a3);
    if ( v9 >= 0 )
      v9 = (**(__int64 (__fastcall ***)(CommunicationsRemapPolicyRule *, GUID *, _QWORD *))v8)(
             v8,
             &GUID_950f62ca_d61d_43ce_893e_dbf6fe56fbf3,
             a1);
    (*(void (__fastcall **)(CommunicationsRemapPolicyRule *))(*(_QWORD *)v8 + 16LL))(v8);
  }
  else
  {
