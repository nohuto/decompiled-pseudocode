/*
 * XREFs of ?_Do_call@?$_Func_impl_no_alloc@V_lambda_aaa43ca83dfd3d10ea8db9a45d6dafd8_@@X_N@std@@EEAAX$$QEA_N@Z @ 0x180064B60
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall std::_Func_impl_no_alloc<_lambda_aaa43ca83dfd3d10ea8db9a45d6dafd8_,void,bool>::_Do_call(
        __int64 a1,
        char *a2)
{
  char v3; // di
