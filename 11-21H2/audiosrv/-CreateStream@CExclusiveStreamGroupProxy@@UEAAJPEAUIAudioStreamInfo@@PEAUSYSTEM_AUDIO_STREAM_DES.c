/*
 * XREFs of ?CreateStream@CExclusiveStreamGroupProxy@@UEAAJPEAUIAudioStreamInfo@@PEAUSYSTEM_AUDIO_STREAM_DESCRIPTOR@@PEAUIAudioGraphCallback@@KPEAUSystemAudioStream@@@Z @ 0x1800F8870
 * Callers:
 *     <none>
 * Callees:
...
LABEL_3:
  ...
  *(_QWORD *)(this + 400) = v16;
  ...
  v18 = *(_QWORD *)(this + 48);
  *(_DWORD *)(this + 392) = v17 + 18;
  *(_QWORD *)(this + 424) = v18;
  Microsoft::WRL::ComPtr<IAudioGraphCallback>::operator=((__int64 *)(this + 576), (__int64)a4);
