/*
 * XREFs of ?Clear@CSecurityDesc@ATL@@MEAAXXZ @ 0x18003F660
 * Callers:
 *     ?GetADGProcessSD@CAudioDGProcess@@CAJPEAPEAX@Z @ 0x18003DAEC (-GetADGProcessSD@CAudioDGProcess@@CAJPEAPEAX@Z.c)
 *     sub_1800790BC @ 0x1800790BC (sub_1800790BC.c)
 *     ??1CSecurityDesc@ATL@@UEAA@XZ @ 0x180117BC0 (--1CSecurityDesc@ATL@@UEAA@XZ.c)
