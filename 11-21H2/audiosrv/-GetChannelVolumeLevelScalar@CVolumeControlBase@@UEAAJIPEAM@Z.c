/*
 * XREFs of ?GetChannelVolumeLevelScalar@CVolumeControlBase@@UEAAJIPEAM@Z @ 0x1800CBDE0
 * Callers:
 *     <none>
 * Callees:
        ...
        float *a3)
{
  ...
  AudSrvTraceLoggingErrorHelper("CVolumeControlBase::GetChannelVolumeLevelScalar", 507, v7);
LABEL_7:
