        ...
        __int64 a3)
{
  ...
  if ( v6 != v4 )
    return 1;
  v7 = std::_WChar_traits<unsigned short>::compare(v5, v3, v6);
  v8 = 0;
  if ( v7 )
    return 1;
  return v8;
