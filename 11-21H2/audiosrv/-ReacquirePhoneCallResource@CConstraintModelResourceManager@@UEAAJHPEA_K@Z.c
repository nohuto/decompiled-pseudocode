/*
 * XREFs of ?ReacquirePhoneCallResource@CConstraintModelResourceManager@@UEAAJHPEA_K@Z @ 0x18010CF80
 * Callers:
 *     <none>
 * Callees:
 ...
 *     WPP_SF_dID @ 0x18010E8D4 (WPP_SF_dID.c)
        ...
        unsigned __int64 *a3)
{
  ...
  {
    WPP_SF_dI(*((_QWORD *)WPP_GLOBAL_Control + 2), 21LL, a3, (unsigned int)a2, *a3);
    v7 = WPP_GLOBAL_Control;
  }
  if ( *a3 )
  {
    ...
    if ( (int)CConstraintModel::GetPhoneCallResourceConsumption(v8, v5 != 0, v24, &v27) >= 0 && (v9 = v24[0]) != 0 )
    {
      ...
      *(_QWORD *)v24 = v13;
      while ( v13 )
      {
        ...
        wil::com_ptr_t<ISessionInternalEvents,wil::err_returncode_policy>::~com_ptr_t<ISessionInternalEvents,wil::err_returncode_policy>(&v39);
      }
      if ( v29 )
