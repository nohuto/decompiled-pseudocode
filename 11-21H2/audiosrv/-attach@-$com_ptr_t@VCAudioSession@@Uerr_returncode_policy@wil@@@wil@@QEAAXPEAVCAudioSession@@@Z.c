/*
 * XREFs of ?attach@?$com_ptr_t@VCAudioSession@@Uerr_returncode_policy@wil@@@wil@@QEAAXPEAVCAudioSession@@@Z @ 0x1800E1B8C
 * Callers:
...
__int64 __fastcall wil::com_ptr_t<CAudioSession,wil::err_returncode_policy>::attach(__int64 *a1, __int64 a2)
{
  __int64 v2; // r8
  __int64 result; // rax
