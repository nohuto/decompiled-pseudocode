/*
 * XREFs of ?Attach@?$ComPtr@VBluetoothMute@BluetoothControls@@@WRL@Microsoft@@QEAAXPEAVBluetoothMute@BluetoothControls@@@Z @ 0x1800C6D20
 * Callers:
...
__int64 __fastcall Microsoft::WRL::ComPtr<BluetoothControls::BluetoothMute>::Attach(__int64 *a1, __int64 a2)
{
  __int64 v4; // rcx
  __int64 result; // rax
