/*
 * XREFs of _CSleepStudyPowerReferenceManager::CreatePowerReferenceSubBlocker_::_1_::catch$37 @ 0x18006E610
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall CSleepStudyPowerReferenceManager::CreatePowerReferenceSubBlocker_::_1_::catch_37(
        __int64 a1,
        __int64 a2,
        __int64 a3,
        const char *a4)
