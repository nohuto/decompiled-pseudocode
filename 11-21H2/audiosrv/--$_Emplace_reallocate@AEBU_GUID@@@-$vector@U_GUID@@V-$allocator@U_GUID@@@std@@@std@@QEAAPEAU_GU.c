/*
 * XREFs of ??$_Emplace_reallocate@AEBU_GUID@@@?$vector@U_GUID@@V?$allocator@U_GUID@@@std@@@std@@QEAAPEAU_GUID@@QEAU2@AEBU2@@Z @ 0x1800E3388
 * Callers:
 ...
 *     ?_Change_array@?$vector@U_GUID@@V?$allocator@U_GUID@@@std@@@std@@AEAAXQEAU_GUID@@_K1@Z @ 0x1800E5E6C (-_Change_array@-$vector@U_GUID@@V-$allocator@U_GUID@@@std@@@std@@AEAAXQEAU_GUID@@_K1@Z.c)
 */
