        ...
        CAppSubmixClientContext **a3)
{
  ...
  SIZE_T size_of; // rax
  CAppSubmixClientContext **v12; // rax
  CAppSubmixClientContext **v13; // rdi
  CAppSubmixClientContext **v14; // r14
  CAppSubmixClientContext *v15; // rcx
  __int64 v16; // rdx
  CAppSubmixClientContext **v17; // r8
  __int64 v18; // rcx
  CAppSubmixClientContext **result; // rax
  CAppSubmixClientContext **v20; // [rsp+20h] [rbp-48h]
  void *v21; // [rsp+20h] [rbp-48h]
  CAppSubmixClientContext **v22; // [rsp+70h] [rbp+8h]
  ...
  v12 = (CAppSubmixClientContext **)std::_Allocate<16,std::_Default_allocate_traits,0>(size_of);
  v13 = v12;
  v20 = v12;
  v14 = &v12[v5];
  try
  {
    ...
    *v14 = v15;
    ...
    std::_Uninitialized_move<std::unique_ptr<CAppSubmixClientContext> *,std::allocator<std::unique_ptr<CAppSubmixClientContext>>>(
      ...
      v16,
      v17);
    std::vector<std::unique_ptr<CAppSubmixClientContext>>::_Change_array(a1, v13, v8, v7, v20);
    result = v14;
  }
  catch ( ... )
  {
    std::_Destroy_range<std::allocator<std::unique_ptr<CAppSubmixClientContext>>>(v22, v14 + 1);
