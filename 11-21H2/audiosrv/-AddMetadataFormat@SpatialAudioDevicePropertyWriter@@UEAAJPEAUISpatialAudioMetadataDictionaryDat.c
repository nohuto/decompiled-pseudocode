/*
 * XREFs of ?AddMetadataFormat@SpatialAudioDevicePropertyWriter@@UEAAJPEAUISpatialAudioMetadataDictionaryData@@@Z @ 0x180135760
 * Callers:
 *     <none>
 * Callees:
  ...
  if ( a2 )
  {
    ...
    if ( v10 < 0 )
    {
      if ( (unsigned int)dword_1801C0258 <= 2 )
        goto LABEL_38;
      v19 = 264;
      v14 = (unsigned __int8 *)&unk_18018C41C;
      goto LABEL_36;
    }
          ...
          if ( v10 >= 0 )
          {
            ...
            *(_OWORD *)&v23[1] = 0LL;
            ...
            if ( v10 >= 0 )
            {
              ...
              v10 = SpatialAudioDevicePropertyWriter::SetPropertyValue(this, &v24, (struct tagPROPVARIANT *)&v23[1]);
              v9 = v10;
              if ( v10 >= 0 || (unsigned int)dword_1801C0258 <= 2 )
                goto LABEL_38;
              v19 = 314;
              v14 = (unsigned __int8 *)&unk_18018C41C;
            }
