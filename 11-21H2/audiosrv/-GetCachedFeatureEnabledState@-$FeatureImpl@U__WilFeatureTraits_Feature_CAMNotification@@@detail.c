/*
 * XREFs of ?GetCachedFeatureEnabledState@?$FeatureImpl@U__WilFeatureTraits_Feature_CAMNotification@@@details@wil@@AEAA?ATwil_details_FeatureStateCache@@XZ @ 0x1800EE864
 * Callers:
...
signed __int32 *__fastcall wil::details::FeatureImpl<__WilFeatureTraits_Feature_CAMNotification>::GetCachedFeatureEnabledState(
        ...
        signed __int32 *a2)
{
  ...
  *a2 = *a1;
  if ( (v2 & 3) != 3 )
  {
    ...
    wil::details::FeatureImpl<__WilFeatureTraits_Feature_CAMNotification>::GetCurrentFeatureEnabledState(a1, &v13, &v12);
    v6 = *a2;
    do
    {
      v7 = v12 == 0;
