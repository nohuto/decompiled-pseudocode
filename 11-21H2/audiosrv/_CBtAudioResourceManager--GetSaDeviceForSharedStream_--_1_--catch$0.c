/*
 * XREFs of _CBtAudioResourceManager::GetSaDeviceForSharedStream_::_1_::catch$0 @ 0x180116923
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall CBtAudioResourceManager::GetSaDeviceForSharedStream_::_1_::catch_0(
        __int64 a1,
        __int64 a2,
        __int64 a3,
        const char *a4)
