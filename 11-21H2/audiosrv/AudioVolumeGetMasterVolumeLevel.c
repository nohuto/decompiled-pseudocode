/*
 * XREFs of AudioVolumeGetMasterVolumeLevel @ 0x1800D17B0
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall AudioVolumeGetMasterVolumeLevel(_QWORD *a1, __int64 a2)
{
  ...
  CWatchdogTimer<1>::CWatchdogTimer<1>(
    ...
    v4,
    (struct _TP_TIMER *)L"AudioVolumeGetMasterVolumeLevel",
    pftDueTime);
  LODWORD(pftDueTime) = (*(__int64 (__fastcall **)(_QWORD, __int64))(*(_QWORD *)*a1 + 72LL))(*a1, a2);
