/*
 * XREFs of DisableSpatialOnInternalSpeakers @ 0x18014EAD0
 * Callers:
...
__int64 __fastcall DisableSpatialOnInternalSpeakers(__int64 a1, __int64 a2)
{
  int v4; // eax
  unsigned int v5; // ebx
  unsigned int v7; // ebx
  ...
  if ( v4 >= 0 )
  {
    ...
    if ( v12 )
    {
      while ( 1 )
      {
        ...
        {
          v10 = EnableSpatialOnSpeakerEndpoint(a1, v13, (__int64)L"HP", 0);
          if ( v10 < 0 )
