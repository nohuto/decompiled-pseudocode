/*
 * XREFs of ?GetAECInsertionPolicy@EffectPolicy@@SAJPEAVCEndpointCharacteristics@@PEAUIPropertyStore@@PEAVSystemEffectDescriptor@@U_GUID@@PEAW4INBOX_AEC_INSERTION_POLICY@@AEAU_AEC_POLICY_RESULTS@@@Z @ 0x18014FFA0
 * Callers:
...
LABEL_12:
  ...
  *((_DWORD *)a6 + 2) = v13;
  ...
  {
    v19 = *a4;
    *((_DWORD *)a6 + 3) = CEndpointCharacteristics::IsConnectorModeSupported(this, *((unsigned int *)a3 + 12), &v19);
    v19 = *a4;
