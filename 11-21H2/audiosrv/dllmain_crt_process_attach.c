/*
 * XREFs of dllmain_crt_process_attach @ 0x18005E5B8
 * Callers:
 ...
 *     __scrt_initialize_crt @ 0x18005ED78 (__scrt_initialize_crt.c)
 *     __scrt_is_nonwritable_in_current_image @ 0x18005EE5C (__scrt_is_nonwritable_in_current_image.c)
 *     __scrt_release_startup_lock @ 0x18005EEFC (__scrt_release_startup_lock.c)
 *     ?__scrt_initialize_type_info@@YAXXZ @ 0x18005F424 (-__scrt_initialize_type_info@@YAXXZ.c)
 *     __scrt_initialize_default_local_stdio_options @ 0x18005F44C (__scrt_initialize_default_local_stdio_options.c)
 *     __scrt_get_dyn_tls_init_callback @ 0x18005F470 (__scrt_get_dyn_tls_init_callback.c)
 *     __scrt_fastfail @ 0x18005F490 (__scrt_fastfail.c)
 *     _RTC_Initialize @ 0x18005F5E4 (_RTC_Initialize.c)
 *     _initterm_0 @ 0x18005F856 (_initterm_0.c)
 *     _initterm_e_0 @ 0x18005F862 (_initterm_e_0.c)
