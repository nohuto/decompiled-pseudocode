/*
 * XREFs of ?DoCreateMonitorForCaptureDeviceIfAppropriate@CMonitorManager@@AEAAJPEAUIMMDevice@@@Z @ 0x18011A568
 * Callers:
...
LABEL_14:
  ...
  v19 = 0LL;
  v9 = (unsigned __int16 *)&unk_18017F160;
  if ( !v27 )
    v9 = v18;
  ...
  if ( v21 )
  {
    ...
    if ( WPP_GLOBAL_Control != (CEndpointStoreCache *)&WPP_GLOBAL_Control )
    {
      ...
      if ( v14 != (CEndpointStoreCache *)&WPP_GLOBAL_Control
