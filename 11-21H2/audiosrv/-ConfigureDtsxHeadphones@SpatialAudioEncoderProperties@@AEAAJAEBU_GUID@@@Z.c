/*
 * XREFs of ?ConfigureDtsxHeadphones@SpatialAudioEncoderProperties@@AEAAJAEBU_GUID@@@Z @ 0x180139240
 * Callers:
...
__int64 __fastcall SpatialAudioEncoderProperties::ConfigureDtsxHeadphones(
        ...
        const struct _GUID *a2)
{
  ...
  *((_DWORD *)this + 30) = 1;
  *(_OWORD *)((char *)this + 126) = xmmword_180197380;
  *(_OWORD *)((char *)this + 142) = xmmword_180197390;
  *(_OWORD *)((char *)this + 158) = xmmword_1801973A0;
  *(_OWORD *)((char *)this + 174) = xmmword_1801973B0;
  *(_OWORD *)((char *)this + 190) = xmmword_1801973C0;
  *(_OWORD *)((char *)this + 206) = xmmword_1801973D0;
  *(_OWORD *)((char *)this + 222) = xmmword_1801973E0;
  *(_DWORD *)((char *)this + 238) = 0;
  if ( IsGetDefaultSpatialRenderingModePresent() )
  {
    v14 = 0;
    v13 = 0;
    if ( (int)TryGetPlatformSpecificProcessingLimitsForSpatialFormat(&DTSX_HEADPHONES_SPATIAL_ENCODER, &v14, &v13) >= 0 )
    {
      *((_DWORD *)this + 29) = v14;
      *((_WORD *)this + 62) = v13;
    }
