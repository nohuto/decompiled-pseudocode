/*
 * XREFs of ?InitAdapterInformation@EndpointDevice@@AEAAJXZ @ 0x18004CBD8
 * Callers:
...
__int64 __fastcall EndpointDevice::InitAdapterInformation(GUID *this)
{
  ...
  for ( i = 0; i < 0xB; ++i )
  {
    v19 = *(_QWORD *)&v15->Data1 - *((_QWORD *)&unk_180169890 + 3 * (int)i);
    if ( *(_QWORD *)&v15->Data1 == *((_QWORD *)&unk_180169890 + 3 * (int)i) )
      v19 = *(_QWORD *)v15->Data4 - *((_QWORD *)&unk_180169890 + 3 * (int)i + 1);
    if ( !v19 )
    {
      v20 = (_WORD *)*((_QWORD *)&unk_180169890 + 3 * (int)i + 2);
      v21 = -1LL;
      do
        ++v21;
      while ( v20[v21] );
