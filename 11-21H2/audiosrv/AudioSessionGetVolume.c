/*
 * XREFs of AudioSessionGetVolume @ 0x1800060A0
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall AudioSessionGetVolume(__int64 *a1, __int64 a2)
{
  ...
  v5 = (*(__int64 (__fastcall **)(__int64, __int64))(*(_QWORD *)v2 + 288LL))(v2, a2);
  v6 = v5;
  if ( v5 < 0 )
    AudSrvTraceLoggingErrorHelper("AudioSessionGetVolume", 0x7F1u, v5);
