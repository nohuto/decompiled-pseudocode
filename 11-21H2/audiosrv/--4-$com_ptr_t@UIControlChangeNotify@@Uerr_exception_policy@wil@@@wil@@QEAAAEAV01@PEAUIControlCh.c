/*
 * XREFs of ??4?$com_ptr_t@UIControlChangeNotify@@Uerr_exception_policy@wil@@@wil@@QEAAAEAV01@PEAUIControlChangeNotify@@@Z @ 0x1800C6AF4
 * Callers:
...
__int64 *__fastcall wil::com_ptr_t<IControlChangeNotify,wil::err_exception_policy>::operator=(__int64 *a1, __int64 a2)
{
  __int64 v3; // rdi
