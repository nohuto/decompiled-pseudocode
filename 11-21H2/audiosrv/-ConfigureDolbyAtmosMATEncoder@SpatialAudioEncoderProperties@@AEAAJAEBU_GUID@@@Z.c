/*
 * XREFs of ?ConfigureDolbyAtmosMATEncoder@SpatialAudioEncoderProperties@@AEAAJAEBU_GUID@@@Z @ 0x180138D3C
 * Callers:
        ...
        const struct _GUID *a2)
{
  ...
  *(_DWORD *)((char *)this + 238) = 0;
  if ( IsGetDefaultSpatialRenderingModePresent() )
  {
    v14 = 0;
    v13 = 0;
    if ( (int)TryGetPlatformSpecificProcessingLimitsForSpatialFormat(&DOLBY_ATMOS_MAT_SPATIAL_ENCODER, &v14, &v13) >= 0 )
    {
      *((_DWORD *)this + 29) = v14;
      *((_WORD *)this + 62) = v13;
    }
