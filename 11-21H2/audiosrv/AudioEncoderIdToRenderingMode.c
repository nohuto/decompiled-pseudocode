/*
 * XREFs of AudioEncoderIdToRenderingMode @ 0x180136760
 * Callers:
 ...
 *     ?GetUserSelectedSpatialAudioRenderingMode@SpatialAudioDevicePropertyReader@@UEAAJPEAI@Z @ 0x180137BE0 (-GetUserSelectedSpatialAudioRenderingMode@SpatialAudioDevicePropertyReader@@UEAAJPEAI@Z.c)
 * Callees:
            ...
            if ( v10 )
            {
              ...
              if ( v11 )
              {
                ...
                if ( v12 )
                {
                  ...
                  if ( v13 && (unsigned int)dword_1801C0258 > 2 )
                  {
                    v15 = -2147418113;
