/*
 * XREFs of ?IsTechnologySupported@CSpatialAudioMSHRTF@@UEBA_NPEAVCEndpointCharacteristics@@PEBUtWAVEFORMATEX@@1KPEAIPEA_NPEAUWAVEFORMATEXTENSIBLE@@@Z @ 0x1800533D0
 * Callers:
 *     <none>
 * Callees:
        ...
        struct WAVEFORMATEXTENSIBLE *a8)
{
  ...
  if ( !byte_1801C26E8 )
  {
    ...
    byte_1801C26E8 = 1;
    byte_1801C26E9 = v16 != 0;
  }
  v17[0] = CSpatialAudioTechHRTF::IsTechnologySupported(this, a2, a3, a4, a5, a6, a7, a8);
  if ( !v17[0] )
    return 0;
  v13 = CEndpointCharacteristics::FormFactor((CEndpointCharacteristics *)a2);
