/*
 * XREFs of ?GetEndpointExtendedSpatialLicenseInfo@CSpatialAudioTech@@SAJPEBGKPEAUExtendedSpatialAudioEncoderInfo@@@Z @ 0x18013E28C
 * Callers:
        ...
        struct ExtendedSpatialAudioEncoderInfo *a3)
{
  ...
  if ( v7 < 0 )
  {
    wil::details::in1diag3::Return_Hr(
      retaddr,
      (void *)0x6F,
      (__int64)"avcore\\audiocore\\server\\lib\\audioserviceutil\\SpatialProviders.h",
