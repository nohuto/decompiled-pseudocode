/*
 * XREFs of ?ProcessDynamicObjectCountChange@CStreamResource@Sarm@@QEAAJIIAEA_J@Z @ 0x18012BC18
 * Callers:
  ...
  *a4 = 0LL;
  ...
  if ( v8 >= 0 )
  {
    ...
    *((_DWORD *)this + 18) = v11;
    ...
    v13 = 0LL;
    v14 = 0LL;
    v18 = Sarm::CStreamResource::CalculateDynamicObjectGrantCount(this, v7);
