/*
 * XREFs of ?AddUnsupportedFormat@CUnsupportedConnectorFormats@@QEAAXU_GUID@@PEAUtWAVEFORMATEX@@J@Z @ 0x180144D24
 * Callers:
...
LABEL_28:
  ...
  if ( v19 )
  {
    v21 = *((_DWORD *)this + 1083);
    if ( v21 + 1 < 0x1000 )
    {
      *(_WORD *)((char *)this + v21 + 236) = -1;
      v21 = *((_DWORD *)this + 1083);
    }
    v22 = v21 + 2;
    *((_DWORD *)this + 1083) = v22;
    ...
    v23 = *a2;
    v20 = v22 + 16;
    *((_DWORD *)this + 1083) = v22 + 16;
    *((struct _GUID *)this + 271) = v23;
  }
  else
  {
    v20 = *((_DWORD *)this + 1083);
  }
  if ( (unsigned __int64)v20 + 2 < 0x1000 )
  {
    *(_WORD *)((char *)this + v20 + 236) = v18;
    *((_DWORD *)this + 1083) += 2;
  }
}
