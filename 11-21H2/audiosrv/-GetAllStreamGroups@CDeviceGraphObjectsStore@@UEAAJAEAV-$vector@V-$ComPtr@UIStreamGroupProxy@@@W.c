/*
 * XREFs of ?GetAllStreamGroups@CDeviceGraphObjectsStore@@UEAAJAEAV?$vector@V?$ComPtr@UIStreamGroupProxy@@@WRL@Microsoft@@V?$allocator@V?$ComPtr@UIStreamGroupProxy@@@WRL@Microsoft@@@std@@@std@@@Z @ 0x1800FC5C0
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall CDeviceGraphObjectsStore::GetAllStreamGroups(__int64 a1, __int64 *a2)
{
  ...
  __int64 (__fastcall ***v12)(_QWORD, GUID *, __int64 *); // [rsp+50h] [rbp+8h] BYREF
  ...
  while ( v5 != *(__int64 **)(a1 + 72) )
  {
    try
    {
      ...
      v12 = 0LL;
      if ( (int)Microsoft::WRL::WeakRef::As<IInspectable>(&v14, &v12) >= 0 && v12 )
      {
        v13 = 0LL;
