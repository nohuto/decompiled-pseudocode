/*
 * XREFs of AudioServerResetEndpoint @ 0x1800F3B20
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall AudioServerResetEndpoint(char *a1, __int64 a2)
{
  ...
  CWatchdogTimer<1>::CWatchdogTimer<1>(
    ...
    pftDueTime);
  v8 = (*(__int64 (__fastcall **)(char *, __int64))(*(_QWORD *)a1 + 80LL))(a1, a2);
  v12 = v8;
  if ( v8 < 0 )
    AudSrvTraceLoggingErrorHelper("AudioServerResetEndpoint", 3201, v8);
