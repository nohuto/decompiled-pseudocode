/*
 * XREFs of ?IsInterleavedLoopbackSupported@CEndpointCharacteristics@@QEAAHXZ @ 0x18014B05C
 * Callers:
...
__int64 __fastcall CEndpointCharacteristics::IsInterleavedLoopbackSupported(CEndpointCharacteristics *this)
{
  ...
  *(_OWORD *)pvar = 0LL;
  ...
  if ( v4 )
  {
    ...
    if ( LOWORD(pvar[0]) != 31
      || (*(int (__fastcall **)(LPVOID, PROPVARIANT, __int64 *))(*(_QWORD *)g_DeviceEnumerator + 40LL))(
           g_DeviceEnumerator,
           pvar[1],
           &v9) < 0
