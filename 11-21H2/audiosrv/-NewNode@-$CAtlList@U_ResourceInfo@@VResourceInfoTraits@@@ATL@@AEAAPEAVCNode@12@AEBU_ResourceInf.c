/*
 * XREFs of ?NewNode@?$CAtlList@U_ResourceInfo@@VResourceInfoTraits@@@ATL@@AEAAPEAVCNode@12@AEBU_ResourceInfo@@PEAV312@1@Z @ 0x180158E74
 * Callers:
...
__int64 *__fastcall ATL::CAtlList<_ResourceInfo,ResourceInfoTraits>::NewNode(__int64 a1, __int64 a2, __int64 a3)
{
  ...
  if ( !*(_QWORD *)(a1 + 32) )
  {
    ...
    v7 = *(_DWORD *)(a1 + 40);
    for ( i = (_QWORD *)((char *)v6 + 560 * (unsigned int)(v7 - 1) + 8); --v7 >= 0; i -= 70 )
    {
      *i = *(_QWORD *)(a1 + 32);
      *(_QWORD *)(a1 + 32) = i;
    }
