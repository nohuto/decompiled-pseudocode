/*
 * XREFs of AudioServerGetChannelVolume @ 0x1800F1810
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall AudioServerGetChannelVolume(char *a1, unsigned int a2, __int64 a3)
{
  ...
  CWatchdogTimer<1>::CWatchdogTimer<1>(
    ...
    pftDueTime);
  v10 = (*(__int64 (__fastcall **)(char *, _QWORD, __int64))(*(_QWORD *)a1 + 184LL))(a1, a2, a3);
  v14 = v10;
  if ( v10 < 0 )
    AudSrvTraceLoggingErrorHelper("AudioServerGetChannelVolume", 3368, v10);
