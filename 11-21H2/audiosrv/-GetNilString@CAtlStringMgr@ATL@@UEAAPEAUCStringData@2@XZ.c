/*
 * XREFs of ?GetNilString@CAtlStringMgr@ATL@@UEAAPEAUCStringData@2@XZ @ 0x18003C790
 * Callers:
 *     <none>
 * Callees:
 *     ?AddRef@CStringData@ATL@@QEAAXXZ @ 0x1800D6784 (-AddRef@CStringData@ATL@@QEAAXXZ.c)
 */
