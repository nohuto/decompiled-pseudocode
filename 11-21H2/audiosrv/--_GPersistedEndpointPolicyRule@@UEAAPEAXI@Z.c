/*
 * XREFs of ??_GPersistedEndpointPolicyRule@@UEAAPEAXI@Z @ 0x180131078
 * Callers:
 *     ??_EPersistedEndpointPolicyRule@@W7EAAPEAXI@Z @ 0x18006BE60 (--_EPersistedEndpointPolicyRule@@W7EAAPEAXI@Z.c)
 * Callees:
