/*
 * XREFs of ?GetStreamEffect@CEndpointCharacteristics@@QEAAJU_GUID@@HW4__MIDL___MIDL_itf_audioengineendpoint_0000_0000_0001@@PEAPEAUICompositeSystemEffect@@PEAPEAUIAudioProcessingObject@@PEAPEAUIAudioSystemEffects2@@@Z @ 0x180149B64
 * Callers:
    ...
    if ( a3
      || (v14 = *a2,
          CEndpointCharacteristics::IsSFXModeSupported(
            ...
            &v14)) )
    {
      v12 = gsl::span<SystemEffectDescriptor,-1>::operator[]((unsigned __int64 *)this + 224, v8);
      v14 = *a2;
