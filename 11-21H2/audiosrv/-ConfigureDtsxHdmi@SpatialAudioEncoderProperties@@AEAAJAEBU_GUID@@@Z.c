/*
 * XREFs of ?ConfigureDtsxHdmi@SpatialAudioEncoderProperties@@AEAAJAEBU_GUID@@@Z @ 0x1801390DC
 * Callers:
        ...
        const struct _GUID *a2)
{
  ...
  *(_DWORD *)((char *)this + 238) = 0;
  if ( IsGetDefaultSpatialRenderingModePresent() )
  {
    v14 = 0;
    v13 = 0;
    if ( (int)TryGetPlatformSpecificProcessingLimitsForSpatialFormat(&DTSX_HDMI_SPATIAL_ENCODER, &v14, &v13) >= 0 )
    {
      *((_DWORD *)this + 29) = v14;
      *((_WORD *)this + 62) = v13;
    }
