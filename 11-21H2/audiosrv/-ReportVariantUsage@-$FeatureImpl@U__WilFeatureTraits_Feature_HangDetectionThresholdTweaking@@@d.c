/*
 * XREFs of ?ReportVariantUsage@?$FeatureImpl@U__WilFeatureTraits_Feature_HangDetectionThresholdTweaking@@@details@wil@@QEAAX_NW4Variant_HangDetectionThresholdTweaking@@W4VariantReportingKind@3@_K@Z @ 0x18005BCC8
 * Callers:
        ...
        unsigned __int64 a5)
{
  ...
  v14 = 0;
  v15 = 3;
  return wil::details::ReportVariantUsageToService(a1 + 2, a2, (v7 >> 8) & 1, (v7 >> 9) & 1, &v14, v6, a3, v11, a4);
}
