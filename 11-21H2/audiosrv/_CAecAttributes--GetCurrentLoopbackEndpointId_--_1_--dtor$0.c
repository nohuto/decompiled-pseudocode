/*
 * XREFs of _CAecAttributes::GetCurrentLoopbackEndpointId_::_1_::dtor$0 @ 0x1801059A0
 * Callers:
 *     <none>
 * Callees:
 *     <none>
...
__int64 __fastcall CAecAttributes::GetCurrentLoopbackEndpointId_::_1_::dtor_0(__int64 a1, __int64 a2)
{
