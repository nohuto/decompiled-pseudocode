/*
 * XREFs of __tailMerge_api_ms_win_appmodel_runtime_l1_1_1_dll @ 0x180062541
 * Callers:
 *     __imp_load_GetStagedPackageOrigin @ 0x180062535 (__imp_load_GetStagedPackageOrigin.c)
 * Callees:
