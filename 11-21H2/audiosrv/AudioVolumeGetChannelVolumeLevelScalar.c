/*
 * XREFs of AudioVolumeGetChannelVolumeLevelScalar @ 0x1800D1700
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall AudioVolumeGetChannelVolumeLevelScalar(_QWORD *a1, unsigned int a2, __int64 a3)
{
  ...
  CWatchdogTimer<1>::CWatchdogTimer<1>(
    ...
    v5,
    (struct _TP_TIMER *)L"AudioVolumeGetChannelVolumeLevelScalar",
    pftDueTime);
  LODWORD(pftDueTime) = (*(__int64 (__fastcall **)(_QWORD, _QWORD, __int64))(*(_QWORD *)*a1 + 112LL))(*a1, a2, a3);
