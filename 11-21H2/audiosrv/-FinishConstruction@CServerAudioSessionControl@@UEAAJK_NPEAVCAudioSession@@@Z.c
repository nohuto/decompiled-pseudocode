/*
 * XREFs of ?FinishConstruction@CServerAudioSessionControl@@UEAAJK_NPEAVCAudioSession@@@Z @ 0x18000E4A0
 * Callers:
 *     <none>
 * Callees:
        ...
        struct CAudioSession *a4)
{
  ...
  *((_QWORD *)this + 9) = a4;
  ...
  v10 = (*(__int64 (__fastcall **)(_QWORD, CServerAudioSessionControl *))(**((_QWORD **)this + 9) + 152LL))(
          *((_QWORD *)this + 9),
          this);
  if ( v10 )
  {
  ...
  else
  {
    ...
    *((_BYTE *)this + 84) = a3;
    LOBYTE(v9) = a3;
    (*(void (__fastcall **)(__int64, __int64))(*(_QWORD *)v11 + 240LL))(v11, v9);
  }
