/*
 * XREFs of ?IsDriverVolumeLimitTrackingSupported@CEndpointCharacteristics@@UEAAHXZ @ 0x18014A4E0
 * Callers:
 *     <none>
 * Callees:
    ...
    *(_OWORD *)&v12[4] = 0LL;
    ...
    else
    {
      if ( (*(int (__fastcall **)(__int64, LPVOID *))(*(_QWORD *)v9 + 64LL))(v9, &pv) >= 0
        && (*(int (__fastcall **)(LPVOID, LPVOID, __int64 *))(*(_QWORD *)g_DeviceEnumerator + 40LL))(
             g_DeviceEnumerator,
             pv,
             &v11) >= 0 )
      {
