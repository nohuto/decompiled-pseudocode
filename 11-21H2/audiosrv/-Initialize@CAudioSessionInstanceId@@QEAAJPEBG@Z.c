/*
 * XREFs of ?Initialize@CAudioSessionInstanceId@@QEAAJPEBG@Z @ 0x1800E73A4
 * Callers:
...
LABEL_36:
  ...
  if ( v4 < 0 )
    goto LABEL_36;
  v4 = CAppAudioSessionId::Initialize((CAudioSessionInstanceId *)((char *)v3 + 8), (char *)v28);
  if ( v4 < 0 )
    goto LABEL_36;
  v4 = CAppInstanceId::Initialize((CAudioSessionInstanceId *)((char *)v3 + 56), (char *)v27);
  if ( v4 < 0 )
    goto LABEL_36;
