/*
 * XREFs of s_apmUnregisterAudioStateMonitor @ 0x180002910
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall s_apmUnregisterAudioStateMonitor(__int64 a1, __int64 a2)
{
  ...
  pftDueTime.dwLowDateTime = (*(__int64 (__fastcall **)(struct IAudioPolicyManager *, __int64, __int64))(*(_QWORD *)g_PolicyManager + 304LL))(
                               g_PolicyManager,
                               a1,
                               a2);
