/*
 * XREFs of ?IsTechnologySupported@CSpatialAudioDolbyAtmosMAT@@UEBA_NPEAVCEndpointCharacteristics@@PEBUtWAVEFORMATEX@@1KPEAIPEA_NPEAUWAVEFORMATEXTENSIBLE@@@Z @ 0x1800531B0
 * Callers:
 *     <none>
 * Callees:
  ...
  *a7 = 0;
  ...
  if ( *((_QWORD *)this + 1) || !byte_1801C1A70 )
  {
    ...
    *(_DWORD *)&v20.Data4[4] = 1905997824;
    ...
    {
      v19 = IsDolbyMatSupportedByAudioDriver();
      v17 = 1LL;
      if ( v19 )
        v16 = 1;
    }
