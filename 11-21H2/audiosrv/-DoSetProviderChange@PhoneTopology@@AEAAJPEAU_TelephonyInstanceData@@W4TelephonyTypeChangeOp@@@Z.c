/*
 * XREFs of ?DoSetProviderChange@PhoneTopology@@AEAAJPEAU_TelephonyInstanceData@@W4TelephonyTypeChangeOp@@@Z @ 0x18015E610
 * Callers:
 *     ?Process@CallProviderChangeWorkItem@@UEAAXPEAVPhoneTopology@@@Z @ 0x18015F460 (-Process@CallProviderChangeWorkItem@@UEAAXPEAVPhoneTopology@@@Z.c)
 * Callees:
