/*
 * XREFs of ??_GCCaptureReference@@QEAAPEAXI@Z @ 0x180104064
 * Callers:
 *     ?_Destroy@?$_Ref_count_obj2@VCCaptureReference@@@std@@EEAAXXZ @ 0x180104A90 (-_Destroy@-$_Ref_count_obj2@VCCaptureReference@@@std@@EEAAXXZ.c)
 * Callees:
