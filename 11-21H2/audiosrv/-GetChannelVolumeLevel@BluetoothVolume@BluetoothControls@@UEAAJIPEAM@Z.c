/*
 * XREFs of ?GetChannelVolumeLevel@BluetoothVolume@BluetoothControls@@UEAAJIPEAM@Z @ 0x1800C6ED0
 * Callers:
 *     <none>
 * Callees:
        ...
        float *a3)
{
  ...
  TargetedControl = (_QWORD *)BluetoothControls::BluetoothControl<IVolumeControlHandler,BluetoothControls::BluetoothVolume>::GetTargetedControl(
                                (__int64)this,
                                (__int64)&v7);
  LODWORD(a3) = (*(__int64 (__fastcall **)(_QWORD, _QWORD, float *))(*(_QWORD *)*TargetedControl + 136LL))(
                  *TargetedControl,
                  a2,
                  a3);
