/*
 * XREFs of ?Initialize@CMonitorManager@@QEAAJK_KPEBK@Z @ 0x1800443EC
 * Callers:
 ...
 *     ?RemoveAll@?$CAtlList@V?$CComQIPtr@VCaptureMonitor@CMonitorManager@@$1?IID_IUnknown@@3U_GUID@@B@ATL@@V?$CComQIPtrElementTraits@VCaptureMonitor@CMonitorManager@@$1?IID_IUnknown@@3U_GUID@@B@2@@ATL@@QEAAXXZ @ 0x1800443B0 (-RemoveAll@-$CAtlList@V-$CComQIPtr@VCaptureMonitor@CMonitorManager@@$1-IID_IUnknown@@3U_GUID@@B@.c)
...
__int64 __fastcall CMonitorManager::Initialize(CMonitorManager *this, int a2, __int64 a3, const unsigned int *a4)
{
  ...
  void *v34; // [rsp+40h] [rbp-C8h] BYREF
  ...
  CMonitorManager::CaptureMonitor *v47; // [rsp+110h] [rbp+8h] BYREF
  int v48; // [rsp+118h] [rbp+10h] BYREF
  __int64 v49; // [rsp+120h] [rbp+18h]
  const unsigned int *v50; // [rsp+128h] [rbp+20h] BYREF
  ...
  if ( !*((_DWORD *)this + 14) || *((_DWORD *)this + 14) == 3 )
  {
    ...
    for ( i = 0; ; ++i )
    {
      ...
      {
        *((_DWORD *)this + 14) = 1;
        v50 = (const unsigned int *)((char *)this + 72);
...
LABEL_22:
    ...
    if ( v37 == 1 )
    {
      if ( CMonitor::IsCaptureMonitorEnabled(v32, (unsigned __int16 **)&pv, (bool *)&v48) )
        goto LABEL_43;
      v12 = v37;
    }
...
LABEL_43:
    ...
    wil::details::unique_storage<wil::details::resource_policy<unsigned short *,void (*)(void *),&void CoTaskMemFree(void *),wistd::integral_constant<unsigned __int64,0>,unsigned short *,unsigned short *,0,std::nullptr_t>>::reset(
      &v34,
      0LL);
    v21 = ((__int64 (__fastcall *)(struct IMMDevice *, void **))GetId)(v19, &v34);
    if ( v21 >= 0 )
    {
      if ( WPP_GLOBAL_Control != (CEndpointStoreCache *)&WPP_GLOBAL_Control
        && (*((_DWORD *)WPP_GLOBAL_Control + 7) & 0x800000) != 0
...
LABEL_33:
  ...
  if ( v16 )
  {
    ...
    ATL::CComPtrBase<IPart>::Release((char *)this + 64);
  }
  while ( v44 )
  {
    v17 = (_QWORD *)ATL::CAtlList<ATL::CComQIPtr<CMonitorManager::CaptureMonitor,&_GUID const IID_IUnknown>,ATL::CComQIPtrElementTraits<CMonitorManager::CaptureMonitor,&_GUID const IID_IUnknown>>::RemoveHead(
                      &v43,
                      &v50);
    ATL::CComPtrBase<CMonitorManager::CaptureMonitor>::CComPtrBase<CMonitorManager::CaptureMonitor>(&v47, *v17);
    ...
    v18 = v47;
    CMonitor::StopIfRunning(*((CMonitor **)v47 + 25));
...
LABEL_26:
  ...
  ATL::CAtlList<ATL::CComQIPtr<CMonitorManager::CaptureMonitor,&_GUID const IID_IUnknown>,ATL::CComQIPtrElementTraits<CMonitorManager::CaptureMonitor,&_GUID const IID_IUnknown>>::RemoveAll((__int64)&v43);
