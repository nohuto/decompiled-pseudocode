/*
 * XREFs of _CDeviceGraphObjectsStore::GetExclusiveSaDevices_::_1_::catch$12 @ 0x1800FCAAA
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall CDeviceGraphObjectsStore::GetExclusiveSaDevices_::_1_::catch_12(
        __int64 a1,
        __int64 a2,
        __int64 a3,
        const char *a4)
