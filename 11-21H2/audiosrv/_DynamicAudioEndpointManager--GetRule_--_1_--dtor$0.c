/*
 * XREFs of _DynamicAudioEndpointManager::GetRule_::_1_::dtor$0 @ 0x180132126
 * Callers:
 *     <none>
 * Callees:
 *     <none>
...
__int64 __fastcall DynamicAudioEndpointManager::GetRule_::_1_::dtor_0(__int64 a1, __int64 a2)
{
