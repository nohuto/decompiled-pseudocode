/*
 * XREFs of ??$?RVCAudioSessionInstanceId@@V0@@?$_Uhash_compare@VCAudioSessionInstanceId@@U?$hash@VCAudioSessionInstanceId@@@std@@U?$equal_to@VCAudioSessionInstanceId@@@3@@std@@QEBA_NAEBVCAudioSessionInstanceId@@0@Z @ 0x18003CC80
 * Callers:
        ...
        __int64 a3)
{
  ...
  if ( v6 != *(_DWORD *)(a3 + 64) || !v6 && *(_DWORD *)(a2 + 56) != *(_DWORD *)(a3 + 56) )
    return 1;
  v8 = *(_DWORD *)(a2 + 48);
  if ( v8 != *(_DWORD *)(a3 + 48) || !v8 && (unsigned int)_o__wcsicmp(*(_QWORD *)(a2 + 8), *(_QWORD *)(a3 + 8)) )
    return 1;
