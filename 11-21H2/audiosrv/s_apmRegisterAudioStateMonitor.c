/*
 * XREFs of s_apmRegisterAudioStateMonitor @ 0x180002710
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall s_apmRegisterAudioStateMonitor(__int64 a1, __int64 a2, __int64 a3, __int64 a4, __int64 a5)
{
  ...
  pftDueTime.dwLowDateTime = (*(__int64 (__fastcall **)(struct IAudioPolicyManager *, __int64, __int64, __int64, __int64, __int64))(*(_QWORD *)g_PolicyManager + 296LL))(
                               g_PolicyManager,
                               a1,
                               a2,
                               a3,
