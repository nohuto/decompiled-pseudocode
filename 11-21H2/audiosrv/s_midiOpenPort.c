/*
 * XREFs of s_midiOpenPort @ 0x1800F6090
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall s_midiOpenPort(RPC_BINDING_HANDLE BindingHandle, unsigned __int16 *a2, HANDLE *a3)
{
  ...
  GUID v33; // [rsp+B8h] [rbp-48h]
  GUID v34; // [rsp+C8h] [rbp-38h]
  GUID v35; // [rsp+D8h] [rbp-28h]
  struct _TP_TIMER *pv[14]; // [rsp+F0h] [rbp-10h] BYREF
  unsigned int v37; // [rsp+180h] [rbp+80h] BYREF
  ...
  if ( a3 )
  {
    KsMidiDeviceInfo = GetKsMidiDeviceInfo(a2, &v25, &v37);
    v7 = v25;
    v11 = KsMidiDeviceInfo;
    if ( KsMidiDeviceInfo >= 0 )
    {
      v14 = FilterInstantiate2(v25, v13, &FilterHandle);
      ...
      if ( v14 >= 0 )
      {
        ...
        *(&Connect.Medium.Alignment + 2) = 0LL;
        v33 = GUID_e725d360_62cc_11cf_a5d6_28db04c10000;
        Connect.PinToHandle = 0LL;
        Connect.Priority.PriorityClass = 0x40000000;
        Connect.Priority.PrioritySubClass = 0x40000000;
        v35 = GUID_0f6417d6_c318_11d0_a43f_00a0c9223196;
        v30 = 64;
        v34 = GUID_1d262760_e957_11cf_a5d6_28db04c10000;
  ...
  CWatchdogTimer<1>::~CWatchdogTimer<1>((__int64)pv, v21, v22, v23);
