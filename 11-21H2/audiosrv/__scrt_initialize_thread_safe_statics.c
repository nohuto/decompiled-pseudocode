/*
 * XREFs of __scrt_initialize_thread_safe_statics @ 0x18005F0C0
 * Callers:
 *     <none>
 * Callees:
...
__int64 _scrt_initialize_thread_safe_statics()
{
  ...
  InitializeCriticalSectionAndSpinCount(&stru_1801C2158, 0xFA0u);
  ...
  if ( ProcAddress && v2 )
  {
    qword_1801C2180 = (__int64)ProcAddress;
    qword_1801C2188 = (__int64)v2;
    goto LABEL_7;
  }
