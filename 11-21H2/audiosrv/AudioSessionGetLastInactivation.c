/*
 * XREFs of AudioSessionGetLastInactivation @ 0x1800DD1A0
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall AudioSessionGetLastInactivation(__int64 *a1, __int64 a2)
{
  ...
  CWatchdogTimer<1>::CWatchdogTimer<1>(
    ...
    pftDueTime);
  v7 = (*(__int64 (__fastcall **)(__int64, __int64))(*(_QWORD *)v2 + 160LL))(v2, a2);
  v11 = v7;
  if ( v7 < 0 )
    AudSrvTraceLoggingErrorHelper("AudioSessionGetLastInactivation", 1725, v7);
