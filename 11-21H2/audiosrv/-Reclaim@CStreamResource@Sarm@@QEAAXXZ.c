/*
 * XREFs of ?Reclaim@CStreamResource@Sarm@@QEAAXXZ @ 0x18012BDE4
 * Callers:
 ...
 *     ?FailFast_IfMsg@in1diag3@details@wil@@YA_NPEAXIPEBD_N1ZZ @ 0x18012B464 (-FailFast_IfMsg@in1diag3@details@wil@@YA_NPEAXIPEBD_N1ZZ.c)
 */

// Hidden C++ exception states: #wind=1
void __fastcall Sarm::CStreamResource::Reclaim(Sarm::CStreamResource *this, __int64 a2, __int64 a3, __int64 a4)
{
  Sarm::CEndpointResourcePool *v5; // rdi
  unsigned int v6; // edx
  __int64 v7; // rcx
  ...
  if ( v5 )
  {
    ...
    if ( v6 )
    {
      Sarm::CEndpointResourcePool::AddToDynamicPool(v5, v6, a3, a4);
      *((_QWORD *)this + 10) = 0LL;
      *((_DWORD *)this + 19) = 0;
      v5 = (Sarm::CEndpointResourcePool *)*((_QWORD *)this + 1);
    }
