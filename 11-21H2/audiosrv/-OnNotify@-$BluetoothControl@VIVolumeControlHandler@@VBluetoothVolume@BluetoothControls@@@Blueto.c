/*
 * XREFs of ?OnNotify@?$BluetoothControl@VIVolumeControlHandler@@VBluetoothVolume@BluetoothControls@@@BluetoothControls@@UEAAJKPEBU_GUID@@@Z @ 0x180063B10
 * Callers:
 *     <none>
 * Callees:
        ...
        _QWORD *a3)
{
  ...
  {
    (*(void (__fastcall **)(_QWORD *))(*a1 + 216LL))(a1);
    v6 = a1[16];
    if ( v6 )
