/*
 * XREFs of ?OnActiveRenderEndpointChanged@CAecAttributes@@QEAAXXZ @ 0x180105A78
 * Callers:
 *     wistd::__function::__func__lambda_61a4c140e08ca27b41804207f9559399__void___cdecl(unsigned_short_const___unsigned___int64)_::operator() @ 0x1801052E0 (wistd--__function--__func__lambda_61a4c140e08ca27b41804207f9559399__void___cdecl(unsigned_short_.c)
 * Callees:
...
void __fastcall CAecAttributes::OnActiveRenderEndpointChanged(CAecAttributes *this)
{
  __int64 v1; // rbx
  __int64 v2; // rdi
  int v3; // eax
