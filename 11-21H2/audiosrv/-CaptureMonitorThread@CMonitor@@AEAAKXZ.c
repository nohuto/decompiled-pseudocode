/*
 * XREFs of ?CaptureMonitorThread@CMonitor@@AEAAKXZ @ 0x18011FF70
 * Callers:
 *     ?CaptureMonitorThreadWrapper@CMonitor@@CAKPEAX@Z @ 0x180120080 (-CaptureMonitorThreadWrapper@CMonitor@@CAKPEAX@Z.c)
 * Callees:
 ...
 *     ?ResetEngineThreadPriority@@YAJPEAPEAX@Z @ 0x180124E20 (-ResetEngineThreadPriority@@YAJPEAPEAX@Z.c)
 *     ?SetEngineThreadPriority@@YAJW4AudioThreadPriorityLevel@@PEAPEAX@Z @ 0x180124E80 (-SetEngineThreadPriority@@YAJW4AudioThreadPriorityLevel@@PEAPEAX@Z.c)
 */
...
__int64 __fastcall CMonitor::CaptureMonitorThread(HANDLE *this)
{
  ...
  {
    WPP_SF_d(*((_QWORD *)WPP_GLOBAL_Control + 2), 0x22u, (__int64)&WPP_a37dfcc815523b32eaec5cff52282599_Traceguids, v2);
  }
  Handles[0] = this[38];
  Handles[1] = this[16];
  Handles[2] = this[31];
