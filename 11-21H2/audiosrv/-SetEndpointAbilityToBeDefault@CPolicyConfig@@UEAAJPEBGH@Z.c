/*
 * XREFs of ?SetEndpointAbilityToBeDefault@CPolicyConfig@@UEAAJPEBGH@Z @ 0x1800EA730
 * Callers:
 *     <none>
 * Callees:
        ...
        int a3)
{
  ...
  if ( !a2 )
  {
    v5 = -2147467261;
LABEL_16:
    AudSrvTraceLoggingErrorHelper("CPolicyConfig::SetEndpointAbilityToBeDefault", 1664, v5);
    goto LABEL_17;
  }
  v5 = CoCreateInstance(
  ...
  if ( v5 < 0 )
    goto LABEL_16;
  v5 = (*(__int64 (__fastcall **)(LPVOID, const unsigned __int16 *, struct IMMDevice **))(*(_QWORD *)g_DeviceEnumerator
                                                                                        + 40LL))(
         g_DeviceEnumerator,
         a2,
         &v7);
