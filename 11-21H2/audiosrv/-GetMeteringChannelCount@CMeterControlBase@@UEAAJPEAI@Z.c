/*
 * XREFs of ?GetMeteringChannelCount@CMeterControlBase@@UEAAJPEAI@Z @ 0x1800C96A0
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall CMeterControlBase::GetMeteringChannelCount(CMeterControlBase *this, unsigned int *a2)
{
  ...
  if ( a2 )
  {
    ...
    *a2 = v3;
    ...
    {
      WPP_SF_qd(*((_QWORD *)WPP_GLOBAL_Control + 2), 12LL, &WPP_b909e168dacd373727fcf23ad3479388_Traceguids, this, v3);
    }
  }
  else
  {
