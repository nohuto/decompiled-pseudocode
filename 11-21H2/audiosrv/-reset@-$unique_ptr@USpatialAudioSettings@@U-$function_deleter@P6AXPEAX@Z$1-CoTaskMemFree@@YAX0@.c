/*
 * XREFs of ?reset@?$unique_ptr@USpatialAudioSettings@@U?$function_deleter@P6AXPEAX@Z$1?CoTaskMemFree@@YAX0@Z@wil@@@wistd@@QEAAXPEAUSpatialAudioSettings@@@Z @ 0x1800EB228
 * Callers:
...
void __fastcall wistd::unique_ptr<SpatialAudioSettings,wil::function_deleter<void (*)(void *),&void CoTaskMemFree(void *)>>::reset(
        void **a1,
        void *a2)
{
  void *v2; // rax
