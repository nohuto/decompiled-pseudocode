/*
 * XREFs of _CEndpointStore::RuntimeClassInitialize_::_1_::dtor$1 @ 0x18006EF22
 * Callers:
 *     <none>
 * Callees:
 *     <none>
...
__int64 __fastcall CEndpointStore::RuntimeClassInitialize_::_1_::dtor_1(__int64 a1, __int64 a2)
{
