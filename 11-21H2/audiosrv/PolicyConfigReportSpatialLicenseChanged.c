/*
 * XREFs of PolicyConfigReportSpatialLicenseChanged @ 0x1800EBCD0
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall PolicyConfigReportSpatialLicenseChanged(__int64 a1, __int64 a2)
{
  ...
  CWatchdogTimer<1>::CWatchdogTimer<1>(
    ...
    v4,
    (struct _TP_TIMER *)L"PolicyConfigReportSpatialLicenseChanged",
    pftDueTime);
  LODWORD(pftDueTime) = (*(__int64 (__fastcall **)(CPolicyConfig *, __int64))(*(_QWORD *)g_PolicyConfig + 256LL))(
                          g_PolicyConfig,
                          a2);
