/*
 * XREFs of _CPolicyConfig::HasThirdPartySystemEffects_::_1_::dtor$0 @ 0x1800E9CFD
 * Callers:
 *     <none>
 * Callees:
 *     <none>
...
__int64 __fastcall CPolicyConfig::HasThirdPartySystemEffects_::_1_::dtor_0(__int64 a1, __int64 a2)
{
