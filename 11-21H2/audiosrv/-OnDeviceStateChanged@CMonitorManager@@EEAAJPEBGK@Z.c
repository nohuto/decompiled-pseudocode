/*
 * XREFs of ?OnDeviceStateChanged@CMonitorManager@@EEAAJPEBGK@Z @ 0x18011D6D0
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall CMonitorManager::OnDeviceStateChanged(PVOID pv, const unsigned __int16 *a2, unsigned int a3)
{
  ...
  {
    WPP_SF_Sd(*((_QWORD *)WPP_GLOBAL_Control + 2), 0x18u, (__int64)&WPP_b5388cf61bd131ee0088e27738ffac5a_Traceguids, a2);
  }
