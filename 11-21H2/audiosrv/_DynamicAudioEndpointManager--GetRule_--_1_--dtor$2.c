/*
 * XREFs of _DynamicAudioEndpointManager::GetRule_::_1_::dtor$2 @ 0x18013213E
 * Callers:
 *     <none>
 * Callees:
 *     <none>
...
__int64 __fastcall DynamicAudioEndpointManager::GetRule_::_1_::dtor_2(__int64 a1, __int64 a2)
{
