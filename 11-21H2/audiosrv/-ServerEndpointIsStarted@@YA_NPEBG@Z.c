/*
 * XREFs of ?ServerEndpointIsStarted@@YA_NPEBG@Z @ 0x180050F10
 * Callers:
...
char __fastcall ServerEndpointIsStarted(const unsigned __int16 *a1)
{
        ...
        if ( !RpcStringBindingParseW(StringBinding, 0LL, &Protseq, 0LL, String, 0LL) )
        {
          if ( !(unsigned int)_o__wcsicmp(Protseq, L"ncalrpc") )
          {
            if ( WPP_GLOBAL_Control != (CEndpointStoreCache *)&WPP_GLOBAL_Control
              ...
              && *((_BYTE *)WPP_GLOBAL_Control + 25) >= 4u )
            {
              WPP_SF_(*((_QWORD *)WPP_GLOBAL_Control + 2), 11LL, &WPP_5393df242fd9363f39d10bcd7fa9895f_Traceguids);
            }
  ...
  if ( v3 == 1718 )
  {
    if ( WPP_GLOBAL_Control != (CEndpointStoreCache *)&WPP_GLOBAL_Control
      ...
      && *((_BYTE *)WPP_GLOBAL_Control + 25) >= 4u )
    {
      WPP_SF_S(*((_QWORD *)WPP_GLOBAL_Control + 2), 13LL, &WPP_5393df242fd9363f39d10bcd7fa9895f_Traceguids, a1);
    }
LABEL_14:
    if ( BindingVector )
