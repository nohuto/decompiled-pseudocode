/*
 * XREFs of asm_GetApplicationSubmixes$catch$16 @ 0x1801093C9
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall asm_GetApplicationSubmixes_catch_16(__int64 a1, __int64 a2, __int64 a3, const char *a4)
{
