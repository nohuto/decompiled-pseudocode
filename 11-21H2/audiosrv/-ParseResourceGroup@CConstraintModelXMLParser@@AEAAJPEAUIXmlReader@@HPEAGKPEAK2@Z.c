/*
 * XREFs of ?ParseResourceGroup@CConstraintModelXMLParser@@AEAAJPEAUIXmlReader@@HPEAGKPEAK2@Z @ 0x18015B558
 * Callers:
        ...
        unsigned int *a7)
{
  ...
  if ( v14 < 0 || v14 == 1 )
  {
    if ( !a3 )
    {
      v16 = (wchar_t *)L"Resource group should have priority attribute when referenced in resource consumptions";
      goto LABEL_16;
    }
    goto LABEL_18;
  }
