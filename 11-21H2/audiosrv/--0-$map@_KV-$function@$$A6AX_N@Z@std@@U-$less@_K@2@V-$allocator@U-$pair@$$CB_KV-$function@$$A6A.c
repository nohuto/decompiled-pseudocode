/*
 * XREFs of ??0?$map@_KV?$function@$$A6AX_N@Z@std@@U?$less@_K@2@V?$allocator@U?$pair@$$CB_KV?$function@$$A6AX_N@Z@std@@@std@@@2@@std@@QEAA@XZ @ 0x180066728
 * Callers:
...
_QWORD *__fastcall std::map<unsigned __int64,std::function<void (bool)>>::map<unsigned __int64,std::function<void (bool)>>(
        _QWORD *a1)
{
  _QWORD *v2; // rax
