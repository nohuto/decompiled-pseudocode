/*
 * XREFs of ?FindAudioSession@CAudioSessionManager@@IEAAJAEAVCAudioSessionInstanceId@@PEAPEAVCAudioSession@@@Z @ 0x1800E069C
 * Callers:
        ...
        struct CAudioSession **a3)
{
  ...
  *a3 = 0LL;
  ...
  {
    v7 = wil::com_ptr_t<CAudioSession,wil::err_returncode_policy>::copy_to<CAudioSession>((__int64 *)(v11 + 96), a3);
    v8 = v7;
    if ( v7 >= 0 )
    {
