/*
 * XREFs of _CMonitor::UpdateMonitorOutputEndpointId_::_1_::dtor$6 @ 0x180124A02
 * Callers:
 *     <none>
 * Callees:
 *     <none>
...
__int64 __fastcall CMonitor::UpdateMonitorOutputEndpointId_::_1_::dtor_6(__int64 a1, __int64 a2)
{
