/*
 * XREFs of ?StartRpcServer@@YAJPEAG0PEAX1@Z @ 0x180050E1C
 * Callers:
...
__int64 __fastcall StartRpcServer(unsigned __int16 *a1, unsigned __int16 *a2, void *a3, void *a4)
{
  ...
  {
    WPP_SF_S(*((_QWORD *)WPP_GLOBAL_Control + 2), 22LL, &WPP_5393df242fd9363f39d10bcd7fa9895f_Traceguids, a2);
  }
  if ( ServerEndpointIsStarted(a2) )
  {
    if ( WPP_GLOBAL_Control != (CEndpointStoreCache *)&WPP_GLOBAL_Control
      ...
      && *((_BYTE *)WPP_GLOBAL_Control + 25) >= 4u )
    {
      WPP_SF_(*((_QWORD *)WPP_GLOBAL_Control + 2), 24LL, &WPP_5393df242fd9363f39d10bcd7fa9895f_Traceguids);
    }
    goto LABEL_7;
  }
  ...
  if ( WPP_GLOBAL_Control != (CEndpointStoreCache *)&WPP_GLOBAL_Control
    ...
    && *((_BYTE *)WPP_GLOBAL_Control + 25) >= 4u )
  {
    WPP_SF_d(*((_QWORD *)WPP_GLOBAL_Control + 2), 23LL, &WPP_5393df242fd9363f39d10bcd7fa9895f_Traceguids, v7);
  }
  if ( !v8 )
  {
LABEL_7:
    ...
    if ( WPP_GLOBAL_Control != (CEndpointStoreCache *)&WPP_GLOBAL_Control
      ...
      && *((_BYTE *)WPP_GLOBAL_Control + 25) >= 4u )
    {
      WPP_SF_d(*((_QWORD *)WPP_GLOBAL_Control + 2), 25LL, &WPP_5393df242fd9363f39d10bcd7fa9895f_Traceguids, v9);
    }
  }
  return v8;
}
