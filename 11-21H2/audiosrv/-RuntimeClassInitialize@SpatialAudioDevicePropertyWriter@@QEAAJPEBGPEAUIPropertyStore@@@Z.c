/*
 * XREFs of ?RuntimeClassInitialize@SpatialAudioDevicePropertyWriter@@QEAAJPEBGPEAUIPropertyStore@@@Z @ 0x180135DB0
 * Callers:
    ...
    if ( Instance >= 0 )
    {
      ...
      if ( Instance >= 0 )
      {
        ...
        Instance = CoCreateInstance(
                     ...
                     (LPVOID *)this + 13);
        v6 = Instance;
        if ( Instance >= 0 || (unsigned int)dword_1801C0258 <= 2 )
          goto LABEL_28;
        v28 = 151;
        goto LABEL_27;
      }
