/*
 * XREFs of AudioSessionGetGroupingParam @ 0x180006D30
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall AudioSessionGetGroupingParam(__int64 *a1, __int64 a2)
{
  ...
  v5 = (*(__int64 (__fastcall **)(__int64, __int64))(*(_QWORD *)v2 + 216LL))(v2, a2);
  v6 = v5;
  if ( v5 < 0 )
    AudSrvTraceLoggingErrorHelper("AudioSessionGetGroupingParam", 0x7A6u, v5);
