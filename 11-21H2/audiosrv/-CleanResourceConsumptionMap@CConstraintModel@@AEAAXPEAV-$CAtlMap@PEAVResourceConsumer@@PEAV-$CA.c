/*
 * XREFs of ?CleanResourceConsumptionMap@CConstraintModel@@AEAAXPEAV?$CAtlMap@PEAVResourceConsumer@@PEAV?$CAtlList@U_ResourceInfo@@VResourceInfoTraits@@@ATL@@VResourceConsumerTraits@@V?$CElementTraits@PEAV?$CAtlList@U_ResourceInfo@@VResourceInfoTraits@@@ATL@@@3@@ATL@@@Z @ 0x180158530
 * Callers:
...
LABEL_2:
    ...
    {
      LODWORD(v6) = *(_DWORD *)(StartPosition + 24) % *(_DWORD *)(a2 + 16);
      while ( 1 )
      {
        ...
        if ( (unsigned int)v6 >= *(_DWORD *)(a2 + 16) )
          break;
        StartPosition = *(_QWORD *)(*(_QWORD *)a2 + 8 * v6);
        if ( StartPosition )
          goto LABEL_2;
      }
    }
