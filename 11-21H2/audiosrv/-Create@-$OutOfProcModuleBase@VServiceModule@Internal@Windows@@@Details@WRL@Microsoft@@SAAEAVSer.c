/*
 * XREFs of ?Create@?$OutOfProcModuleBase@VServiceModule@Internal@Windows@@@Details@WRL@Microsoft@@SAAEAVServiceModule@Internal@Windows@@XZ @ 0x180042B2C
 * Callers:
 *     _dynamic_initializer_for__Microsoft::WRL::Module_1_Windows::Internal::ServiceModule_::isInitialized__ @ 0x180001820 (_dynamic_initializer_for__Microsoft--WRL--Module_1_Windows--Internal--ServiceModule_--isInitiali.c)
 * Callees:
 *     <none>
 */
