/*
 * XREFs of HUBHTX_Get30PortChangeEvent @ 0x1C0005218
 * Callers:
 *     HUBPSM30_EnablingInterruptsAndGettingPortEvent @ 0x1C0012900 (HUBPSM30_EnablingInterruptsAndGettingPortEvent.c)
 *     HUBPSM30_EnablingInterruptsAndGettingPortEventInNoChange @ 0x1C0012940 (HUBPSM30_EnablingInterruptsAndGettingPortEventInNoChange.c)
...
LABEL_92:
            LODWORD(v30) = v26;
            WPP_RECORDER_SF_d(v3[179], v27, 4u, v25, (__int64)&WPP_65667e477e4f3bda131abce8e5de791a_Traceguids, v30);
            return v5;
          }
          if ( (_WORD)a1 != 160 )
          {
...
LABEL_116:
          v5 = 3053;
          ++*((_DWORD *)v3 + 361);
          if ( *((_DWORD *)v3 + 361) != 100 * (*((_DWORD *)v3 + 361) / 0x64u) )
            goto LABEL_85;
          if ( WPP_RECORDER_INITIALIZED != (_UNKNOWN *)&WPP_RECORDER_INITIALIZED )
          {
            LODWORD(v31) = *((_DWORD *)v3 + 361);
            WPP_RECORDER_SF_qd(
              v3[179],
              2u,
              4u,
      ...
      case 0xC0:
        ...
        if ( WPP_RECORDER_INITIALIZED != (_UNKNOWN *)&WPP_RECORDER_INITIALIZED )
        {
          LODWORD(v30) = (v6 >> 5) & 0xF;
          WPP_RECORDER_SF_d(v3[179], 2u, 4u, 0x60u, (__int64)&WPP_65667e477e4f3bda131abce8e5de791a_Traceguids, v30);
        }
        if ( *((_DWORD *)v3 + 2) == 3053 )
        {
          if ( WPP_RECORDER_INITIALIZED == (_UNKNOWN *)&WPP_RECORDER_INITIALIZED )
    ...
    LODWORD(v31) = v6 & 1;
    LODWORD(v30) = v23 & 0xF;
    WPP_RECORDER_SF_DD(v3[179], 2u, 4u, v22, (__int64)&WPP_65667e477e4f3bda131abce8e5de791a_Traceguids, v30, v31);
    goto LABEL_116;
  }
  if ( (v6 & 2) != 0 )
  {
...
LABEL_78:
  ...
  if ( (BYTE2(WPP_MAIN_CB.Queue.Wcb.DmaWaitEntry.Blink) & 1) == 0 )
    goto LABEL_85;
  McTemplateK0qhhhqhhh_EtwWriteTransfer(a1, 1LL, 0LL, *((unsigned __int16 *)v3 + 100), v7, v6, v8, 201, v36, v35, v34);
LABEL_84:
  if ( v5 != 3061 )
    goto LABEL_85;
  return v5;
