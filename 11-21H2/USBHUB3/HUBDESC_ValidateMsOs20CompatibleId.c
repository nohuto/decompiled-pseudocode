/*
 * XREFs of HUBDESC_ValidateMsOs20CompatibleId @ 0x1C003B460
 * Callers:
 *     <none>
 * Callees:
...
char __fastcall HUBDESC_ValidateMsOs20CompatibleId(__int64 a1, __int64 a2, _WORD *a3)
{
  ...
  if ( (*(_BYTE *)a2 & 0x20) != 0 )
  {
    if ( WPP_RECORDER_INITIALIZED != (_UNKNOWN *)&WPP_RECORDER_INITIALIZED )
      WPP_RECORDER_SF_(*(_QWORD *)(a2 + 96), 2u, 5u, 0x143u, (__int64)&WPP_4c38247a76be3626caea66f1aba69131_Traceguids);
...
LABEL_21:
  v20 = v15;
LABEL_8:
  WPP_RECORDER_SF_d(*(_QWORD *)(a2 + 96), 2u, 5u, v8, (__int64)&WPP_4c38247a76be3626caea66f1aba69131_Traceguids, v20);
LABEL_9:
  v9 = 167LL;
LABEL_10:
...
LABEL_11:
  if ( WPP_RECORDER_INITIALIZED != (_UNKNOWN *)&WPP_RECORDER_INITIALIZED )
    WPP_RECORDER_SF_(*(_QWORD *)(a2 + 96), 2u, 5u, 0x149u, (__int64)&WPP_4c38247a76be3626caea66f1aba69131_Traceguids);
  return v4;
}
