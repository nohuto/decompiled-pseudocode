/*
 * XREFs of HUBREG_QueryUsbflagsValuesForDevice @ 0x1C007F038
 * Callers:
...
LABEL_28:
  ...
  if ( v26 )
  {
    ...
    if ( v11 >= 0 )
    {
      if ( v25 )
        _InterlockedOr((volatile signed __int32 *)(a1 + 1644), 1u);
      v15 = (volatile signed __int32 *)(a1 + 1644);
      goto LABEL_38;
    }
    if ( v11 != -1073741772 )
    {
...
LABEL_63:
  ...
  if ( v25 )
    goto LABEL_65;
LABEL_64:
  _InterlockedAnd(v15, 0xFFFFFFF7);
LABEL_65:
  v25 = 0;
  if ( v26 )
  {
...
LABEL_72:
  ...
  if ( v26 )
  {
    ...
    {
      if ( v25 )
        _InterlockedOr(v15, 0x800000u);
      v18 = (volatile signed __int32 *)(a1 + 1644);
      goto LABEL_85;
    }
    if ( v11 != -1073741772 )
    {
...
LABEL_85:
  ...
  if ( v11 < 0 )
  {
    ...
    if ( (v13 & 0x20) != 0 )
      _InterlockedOr(v15, 0x20u);
  }
  else if ( v25 )
  {
    _InterlockedOr(v18, 0x20u);
  }
  v25 = 0;
  if ( v26 )
  {
...
LABEL_98:
  if ( !v19 )
    _InterlockedOr(v15, 0x80u);
  if ( (v13 & 0x400) != 0 )
    _InterlockedOr(v15, 0x40u);
  if ( (v13 & 0x4000) != 0 )
  {
    _InterlockedOr(v15, 0x100u);
    v18 = v15;
  }
  if ( (v13 & 0x10000) != 0 && *(_BYTE *)(*(_QWORD *)a1 + 240LL) )
    _InterlockedOr(v15, 0x80u);
  if ( (v13 & 0x80000) != 0 )
    _InterlockedOr(v15, 0x400u);
  if ( (v13 & 0x200000) != 0 )
    _InterlockedOr(v18, 0x800u);
  if ( (v13 & 0x800000) != 0 )
    _InterlockedOr(v18, 0x1000u);
  if ( (v13 & 0x1000000) != 0 )
    _InterlockedOr(v18, 0x2000u);
  v25 = 0;
  if ( !v26 )
  {
LABEL_121:
...
LABEL_122:
  if ( !v20 )
    _InterlockedOr(v18, 0x8000u);
  if ( (v13 & 0x2000) != 0 )
    _InterlockedOr(v18, 0x20000u);
  if ( (v13 & 0x20000) != 0 )
    _InterlockedOr(v18, 0x40000u);
  if ( (v13 & 0x40000000) != 0 )
    _InterlockedOr(v18, 0x100000u);
  if ( ((v13 & 0x400000) != 0 || (v13 & 0x4000000000LL) != 0 && v9) && (*(_DWORD *)(a1 + 1632) & 2) == 0 )
    _InterlockedOr(v18, 0x80000u);
  if ( (v13 & 0x100000000LL) != 0 )
    _InterlockedOr(v18, 0x400000u);
  if ( (v13 & 0x2000000000LL) != 0 )
    _InterlockedOr(v18, 0x1000000u);
  if ( (v13 & 0x80000000000LL) != 0 )
    _InterlockedOr(v18, 0x4000000u);
  if ( (v13 & 0x800000000000LL) != 0 )
    _InterlockedOr(v18, 0x8000000u);
