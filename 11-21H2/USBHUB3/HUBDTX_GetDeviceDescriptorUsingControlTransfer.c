/*
 * XREFs of HUBDTX_GetDeviceDescriptorUsingControlTransfer @ 0x1C0028280
 * Callers:
 *     HUBDSM_GettingAlternateDeviceDescriptor @ 0x1C001EEE0 (HUBDSM_GettingAlternateDeviceDescriptor.c)
 * Callees:
