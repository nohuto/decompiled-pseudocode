/*
 * XREFs of wil_details_FeatureReporting_RecordUsageInCache @ 0x1C0014118
 * Callers:
...
LABEL_17:
  ...
  if ( v9 < 0x40 )
  {
    ...
    do
    {
      ...
      *(_DWORD *)(a1 + 16) = v11;
      v12 = v10;
      v10 = _InterlockedCompareExchange(&dword_1C006A96C, (32 * (v9 & 0x3F)) | v10 & 0xFFFFF81F | 0x10, v10);
    }
    while ( v12 != v10 );
  }
  *(_DWORD *)(a1 + 8) = a3;
