/*
 * XREFs of HUBFDO_CleanupDeviceInterfaceForBillboard @ 0x1C000E8E4
 * Callers:
...
__int64 __fastcall HUBFDO_CleanupDeviceInterfaceForBillboard(__int64 a1, unsigned __int16 a2, __int64 a3, char a4)
{
  ...
  if ( !a4 )
  {
    ...
    if ( WPP_RECORDER_INITIALIZED != (_UNKNOWN *)&WPP_RECORDER_INITIALIZED )
      WPP_RECORDER_SF_(*(_QWORD *)(a1 + 2520), 4u, 3u, 0x4Au, (__int64)&WPP_cbf4a43b0f133f2c4fe58f6ee8af390c_Traceguids);
    goto LABEL_7;
  }
