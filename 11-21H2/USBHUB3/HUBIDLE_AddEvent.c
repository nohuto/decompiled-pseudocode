/*
 * XREFs of HUBIDLE_AddEvent @ 0x1C003C168
 * Callers:
 ...
 *     HUBIDLE_CancelIdle @ 0x1C003C660 (HUBIDLE_CancelIdle.c)
...
__int64 __fastcall HUBIDLE_AddEvent(__int64 a1, int a2, IRP *a3)
{
  ...
  v9 = 259;
  v10 = a2;
  v36 = KeAcquireSpinLockRaiseToDpc((PKSPIN_LOCK)(a1 + 136));
  v11 = v36;
  if ( v10 != 1000 )
  {
    while ( 1 )
