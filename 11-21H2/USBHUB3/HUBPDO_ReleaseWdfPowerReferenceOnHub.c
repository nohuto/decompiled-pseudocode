/*
 * XREFs of HUBPDO_ReleaseWdfPowerReferenceOnHub @ 0x1C0019CA8
 * Callers:
 *     HUBDSM_ReleasingPowerReferenceOnHubOnEnumerationFailure @ 0x1C001D770 (HUBDSM_ReleasingPowerReferenceOnHubOnEnumerationFailure.c)
 * Callees:
