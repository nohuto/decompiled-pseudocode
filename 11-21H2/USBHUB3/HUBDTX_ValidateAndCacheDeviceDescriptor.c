/*
 * XREFs of HUBDTX_ValidateAndCacheDeviceDescriptor @ 0x1C0029668
 * Callers:
 *     HUBDSM_ValidatingAlternateDeviceDescriptor @ 0x1C001F050 (HUBDSM_ValidatingAlternateDeviceDescriptor.c)
 * Callees:
