/*
 * XREFs of HUBFDO_EvtDeviceAdd @ 0x1C0074380
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall HUBFDO_EvtDeviceAdd(__int64 a1, __int64 a2)
{
  ...
  _OWORD v55[2]; // [rsp+238h] [rbp+130h] BYREF
  __int128 v56; // [rsp+258h] [rbp+150h]
  GUID v57; // [rsp+268h] [rbp+160h] BYREF
  __int64 v58; // [rsp+278h] [rbp+170h]
...
LABEL_6:
  ...
  *((_QWORD *)&v47 + 1) = 0LL;
  ...
  if ( DeviceCapabilities >= 0 )
  {
    ...
    *(_QWORD *)((char *)&v55[1] + 4) = 0x200000002LL;
    *(_QWORD *)&v56 = 0x200000002LL;
    HIDWORD(v55[1]) = 1;
            ...
            v23 >= 0) )
      {
        ...
        *(_QWORD *)((char *)v50 + 4) = 1LL;
        ...
        if ( v23 >= 0 )
        {
          ...
          {
            LODWORD(v33) = v26;
            WPP_RECORDER_SF_d(*v14, 2u, 3u, 0x15u, (__int64)&WPP_cbf4a43b0f133f2c4fe58f6ee8af390c_Traceguids, v33);
          }
          v41 = 0LL;
          v39 = 0LL;
          v40[0] = 0x100000001LL;
          ...
          if ( v23 >= 0 )
          {
            ...
            *(_OWORD *)&v40[1] = (unsigned __int64)v36;
            ...
            else
            {
              ...
              {
                LODWORD(v33) = v27;
                WPP_RECORDER_SF_d(*v14, 2u, 3u, 0x17u, (__int64)&WPP_cbf4a43b0f133f2c4fe58f6ee8af390c_Traceguids, v33);
              }
...
LABEL_26:
    ...
    v21 = 3;
LABEL_21:
    WPP_RECORDER_SF_d(v22, 2u, v21, v20, (__int64)&WPP_cbf4a43b0f133f2c4fe58f6ee8af390c_Traceguids, v33);
    goto LABEL_54;
  }
  if ( WPP_RECORDER_INITIALIZED != (_UNKNOWN *)&WPP_RECORDER_INITIALIZED )
  {
