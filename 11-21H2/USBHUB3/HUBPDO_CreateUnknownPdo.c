/*
 * XREFs of HUBPDO_CreateUnknownPdo @ 0x1C007BF4C
 * Callers:
 *     HUBDSM_CreatingUnknownChildPDOAndReportingToPnp @ 0x1C00211B0 (HUBDSM_CreatingUnknownChildPDOAndReportingToPnp.c)
 * Callees:
