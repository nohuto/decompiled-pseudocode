/*
 * XREFs of HUBMUX_AcquireDevicePowerReference @ 0x1C0010774
 * Callers:
 *     HUBDSM_AcquiringPowerReferenceOnHubResume @ 0x1C001CB30 (HUBDSM_AcquiringPowerReferenceOnHubResume.c)
 * Callees:
