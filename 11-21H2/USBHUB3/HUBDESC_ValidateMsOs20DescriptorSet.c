/*
 * XREFs of HUBDESC_ValidateMsOs20DescriptorSet @ 0x1C003BE50
 * Callers:
...
LABEL_38:
  *(_DWORD *)a2 = 0;
  if ( WPP_RECORDER_INITIALIZED != (_UNKNOWN *)&WPP_RECORDER_INITIALIZED )
    WPP_RECORDER_SF_(*(_QWORD *)(a2 + 96), 2u, 5u, 0x169u, (__int64)&WPP_4c38247a76be3626caea66f1aba69131_Traceguids);
  return v5;
}
