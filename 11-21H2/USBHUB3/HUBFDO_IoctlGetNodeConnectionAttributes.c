/*
 * XREFs of HUBFDO_IoctlGetNodeConnectionAttributes @ 0x1C00765AC
 * Callers:
...
LABEL_9:
  ...
  {
    v19 = v10;
    WPP_RECORDER_SF_d(v9[315], 2u, 3u, 0x2Eu, (__int64)&WPP_cbf4a43b0f133f2c4fe58f6ee8af390c_Traceguids, v19);
  }
LABEL_10:
