/*
 * XREFs of HUBDTX_ValidateAndCacheConfigDescriptor @ 0x1C00290AC
 * Callers:
 *     HUBDSM_ValidatingAlternateConfigurationDescriptor @ 0x1C001F030 (HUBDSM_ValidatingAlternateConfigurationDescriptor.c)
 * Callees:
...
__int64 __fastcall HUBDTX_ValidateAndCacheConfigDescriptor(__int64 a1)
{
  ...
  *(_WORD *)((char *)&v29 + 5) = (v6 & 0x20) != 0;
  ...
  if ( v14 > 1u && *(_BYTE *)(v1 + 4) > 1u )
  {
    v15 = *(_BYTE *)(a1 + 1992);
    if ( !v15 || v15 == -17 && *(_BYTE *)(a1 + 1993) == 2 && *(_BYTE *)(a1 + 1994) == 1 )
    {
      v16 = (unsigned __int8 *)(v1 + 9);
      while ( (unsigned __int64)v16 < v1 + (unsigned __int64)*(unsigned __int16 *)(v1 + 2) )
      {
        v17 = *v16;
        v18 = v16;
        if ( !(_BYTE)v17 )
        ...
        v16 += v17;
        v19 = v18[1];
        if ( v19 == 11 && v18[4] == 1 || v19 == 4 && v18[5] == 1 )
        {
  ...
  v22 = HUBDESC_ParseConfigurationDescriptor(v1, v1, -1, -1, -1, -1, -1, 0LL, *(_QWORD *)(*(_QWORD *)(a1 + 8) + 1432LL));
  *(_QWORD *)(a1 + 2008) = v22;
  if ( v22 )
  {
    if ( *(_BYTE *)(v22 + 5) == 9 )
    ...
    {
      if ( (v23 = *(_DWORD *)(a1 + 172), v23 == 3) && (v11 = *(unsigned int *)(*(_QWORD *)a1 + 760LL), (v11 & 1) != 0)
        || v23 == 2 )
      {
