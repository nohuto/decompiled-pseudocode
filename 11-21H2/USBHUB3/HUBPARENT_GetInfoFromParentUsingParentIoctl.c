/*
 * XREFs of HUBPARENT_GetInfoFromParentUsingParentIoctl @ 0x1C0007D1C
 * Callers:
 *     HUBHSM_GettingAdditionalInfoFromParent @ 0x1C0009820 (HUBHSM_GettingAdditionalInfoFromParent.c)
 * Callees:
