/*
 * XREFs of WPP_RECORDER_SF_qqq @ 0x1C003F0A0
 * Callers:
...
__int64 WPP_RECORDER_SF_qqq(__int64 a1, __int64 a2, __int64 a3, unsigned __int16 a4, int a5, ...)
{
  ...
  if ( (HIDWORD(WPP_GLOBAL_Control->Timer) & 4) != 0 && BYTE1(WPP_GLOBAL_Control->Timer) >= 4u )
    ((void (__fastcall *)(_DEVICE_OBJECT *, __int64, void *, _QWORD, __int64 *, __int64, __int64 *, __int64, char *, __int64, _QWORD))pfnWppTraceMessage)(
      ...
      43LL,
      &WPP_37c4b7d9305837c1312f85d744ccd03f_Traceguids,
      a4,
      (__int64 *)va,
      8LL,
      (__int64 *)va1,
      ...
      0LL);
  LOWORD(v8) = a4;
  return WppAutoLogTrace(a1, 4LL, 3LL, &WPP_37c4b7d9305837c1312f85d744ccd03f_Traceguids, v8, (__int64 *)va);
}
