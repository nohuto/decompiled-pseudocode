/*
 * XREFs of HUBUCX_DeleteEndpointsAndFreeResourcesForConfiguration @ 0x1C0025F40
 * Callers:
 *     HUBDSM_CleaningUpAnyExistingConfigurationOnStart @ 0x1C001CCD0 (HUBDSM_CleaningUpAnyExistingConfigurationOnStart.c)
 *     HUBDSM_CompletingClientUnconfigureRequest @ 0x1C001CE00 (HUBDSM_CompletingClientUnconfigureRequest.c)
 *     HUBDSM_CompletingClientUnconfigureRequestWithFailure @ 0x1C001CE40 (HUBDSM_CompletingClientUnconfigureRequestWithFailure.c)
 ...
 *     HUBDSM_DeletingEndpointsForOldConfiguration @ 0x1C0021810 (HUBDSM_DeletingEndpointsForOldConfiguration.c)
 * Callees:
