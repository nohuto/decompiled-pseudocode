/*
 * XREFs of PropertyGetSetChannelConfiguration @ 0x1C002FA70
 * Callers:
 *     <none>
 * Callees:
    ...
    else if ( (*(_DWORD *)(a2 + 20) & 3) == 2 )
    {
      ...
      if ( *(_DWORD *)(v11 + 20) )
      {
        while ( 1 )
        {
          ...
          {
            LOBYTE(v7) = 1;
            v8 = (*(__int64 (__fastcall **)(__int64, __int64, __int64, __int64, unsigned int *, int))(v10 + 136))(
                   Context,
                   v10,
                   v7,
                   2LL,
        ...
        v17 = v18;
        *(_DWORD *)(v11 + 24) = v18;
        *(_DWORD *)(v10 + 88) = *(_DWORD *)(*(_QWORD *)(v11 + 32) + 4LL * (v17 - 1));
      }
    }
    return v8;
  }
