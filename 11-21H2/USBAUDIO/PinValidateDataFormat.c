/*
 * XREFs of PinValidateDataFormat @ 0x1C002BBF0
 * Callers:
 ...
 *     PinMIDIDataFormatIntersection @ 0x1C002B740 (PinMIDIDataFormatIntersection.c)
 *     PinSetDataFormat @ 0x1C002B9E0 (PinSetDataFormat.c)
 * Callees:
 *     IsSampleRateInRange @ 0x1C002A44C (IsSampleRateInRange.c)
...
__int64 __fastcall PinValidateDataFormat(__int64 a1, __int64 a2, __int64 a3)
{
    ...
    && (v9 = *(_QWORD *)(a3 + 56), v9 == *(_QWORD *)KSDATAFORMAT_SPECIFIER_WAVEFORMATEX.Data4) )
  {
    if ( v3 < 0x52 )
      return v8;
    v8 = *(_WORD *)(a3 + 64) == 0xFFFE ? (v3 < 0x68 ? 0xC000000D : 0) : 0;
    if ( (v8 & 0x80000000) != 0 )
      return v8;
  }
  else
