/*
 * XREFs of USBParseExtensionUnit @ 0x1C00367C0
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall USBParseExtensionUnit(__int64 a1, __int64 a2)
{
  ...
  if ( UnitString >= 0 )
  {
    v12 = (int *)USBParseBuildSourceIdArray(*(unsigned __int8 *)(a2 + 6), (unsigned __int8 *)(a2 + 7));
    if ( v12 )
    {
      ...
      v16 = USBParseCountOutputChannelsForUnit(*(_QWORD *)(v8 + 40), *(_QWORD *)(v8 + 48));
