/*
 * XREFs of WPP_RECORDER_AND_TRACE_SF_qddd @ 0x1C0002328
 * Callers:
...
__int64 WPP_RECORDER_AND_TRACE_SF_qddd(__int64 a1, char a2, char a3, __int64 a4, int a5, int a6, int a7, int a8, ...)
{
  __int64 result; // rax
  ...
  if ( a2 )
    result = ((__int64 (__fastcall *)(__int64, __int64, void *, __int64, __int64 *, __int64, __int64 *, __int64, __int64 *, __int64, char *, __int64, _QWORD))pfnWppTraceMessage)(
               a1,
               43LL,
               &WPP_8cf403cd479d3afc9ed08bafed0b0283_Traceguids,
               21LL,
               (__int64 *)va,
               8LL,
               (__int64 *)va1,
  ...
  {
    LOWORD(v11) = 21;
    return WppAutoLogTrace(a4, 0LL, 8LL, &WPP_8cf403cd479d3afc9ed08bafed0b0283_Traceguids, v11, (__int64 *)va);
  }
  return result;
}
