/*
 * XREFs of USBHwSyncGetStringDescriptor @ 0x1C0035C2C
 * Callers:
 *     USBHwGetDeviceIDString @ 0x1C00338CC (USBHwGetDeviceIDString.c)
 *     USBParseGetUnitString @ 0x1C0037D04 (USBParseGetUnitString.c)
 *     USBCntrlGetDescriptor @ 0x1C0038980 (USBCntrlGetDescriptor.c)
 * Callees:
 *     USBHwGetDescriptor @ 0x1C00337F0 (USBHwGetDescriptor.c)
 */

__int64 __fastcall USBHwSyncGetStringDescriptor(__int64 a1, UCHAR a2, USHORT a3, _BYTE *a4, __int64 a5, _DWORD *a6)
{
  int Descriptor; // ecx
