/*
 * XREFs of WPP_RECORDER_AND_TRACE_SF_ddddd @ 0x1C0016634
 * Callers:
...
__int64 WPP_RECORDER_AND_TRACE_SF_ddddd(
        __int64 a1,
        char a2,
        char a3,
        __int64 a4,
        ...
        ...)
{
  ...
  if ( a2 )
    result = ((__int64 (__fastcall *)(__int64, __int64, void *, _QWORD, __int64 *, __int64, __int64 *, __int64, __int64 *, __int64, __int64 *, __int64, char *, __int64, _QWORD))pfnWppTraceMessage)(
               a1,
               43LL,
