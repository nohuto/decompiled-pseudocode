/*
 * XREFs of _scope_exit__lambda_d367a348401780af63acf916821343f4____::_2_::scope_exit::_scope_exit @ 0x1C0011594
 * Callers:
...
ULONG *__fastcall scope_exit__lambda_d367a348401780af63acf916821343f4____::_2_::scope_exit::_scope_exit(PIRP **a1)
{
  char v1; // r8
  char v2; // dl
  ULONG *result; // rax
