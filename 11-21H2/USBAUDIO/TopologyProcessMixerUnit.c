/*
 * XREFs of TopologyProcessMixerUnit @ 0x1C002D960
 * Callers:
 *     <none>
 * Callees:
  ...
  if ( v12 )
  {
    ...
    if ( Pool2 )
    {
      ...
      *(_DWORD *)(v9 + 88) = *(_DWORD *)(a2 + 28);
      for ( i = v22; v20 < *(_DWORD *)(a2 + 32); v37 = ++v20 )
      {
        if ( v19 < 0 )
          break;
        v23 = 3LL * v20;
          ...
          do
          {
            ...
            if ( *(_DWORD *)(a2 + 24) )
            {
              do
              {
                ...
                *(_DWORD *)(v27 + 4) = v24 + 1;
                *(_DWORD *)(v27 + 8) = ++v29;
                *(_BYTE *)(v27 + 1) = (*(_BYTE *)(v26 + v40) & (unsigned __int8)(1 << v28)) != 0;
                v30 = PropertyInitializeMixerControlRange(a1, v39, v27);
                v31 = v28--;
                v19 = v30;
                if ( !v31 )
                  v28 = 7;
