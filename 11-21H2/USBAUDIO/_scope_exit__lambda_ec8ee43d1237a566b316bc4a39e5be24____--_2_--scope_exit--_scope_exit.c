/*
 * XREFs of _scope_exit__lambda_ec8ee43d1237a566b316bc4a39e5be24____::_2_::scope_exit::_scope_exit @ 0x1C0011660
 * Callers:
...
ULONG *__fastcall scope_exit__lambda_ec8ee43d1237a566b316bc4a39e5be24____::_2_::scope_exit::_scope_exit(PIRP **a1)
{
  char v1; // r8
  char v2; // dl
  ULONG *result; // rax
