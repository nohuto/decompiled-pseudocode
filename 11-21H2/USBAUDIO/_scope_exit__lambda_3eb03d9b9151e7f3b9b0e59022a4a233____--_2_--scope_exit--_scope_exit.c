/*
 * XREFs of _scope_exit__lambda_3eb03d9b9151e7f3b9b0e59022a4a233____::_2_::scope_exit::_scope_exit @ 0x1C00113FC
 * Callers:
...
ULONG *__fastcall scope_exit__lambda_3eb03d9b9151e7f3b9b0e59022a4a233____::_2_::scope_exit::_scope_exit(PIRP **a1)
{
  char v1; // r8
  char v2; // dl
  ULONG *result; // rax
