/*
 * XREFs of _scope_exit__lambda_fc82696842b1c5fb4863225c0fb75a15____::_2_::scope_exit::_scope_exit @ 0x1C00117F8
 * Callers:
...
ULONG *__fastcall scope_exit__lambda_fc82696842b1c5fb4863225c0fb75a15____::_2_::scope_exit::_scope_exit(PIRP **a1)
{
  char v1; // r8
  char v2; // dl
  ULONG *result; // rax
