/*
 * XREFs of PropertyGetProcessControlRange @ 0x1C002F98C
 * Callers:
 *     TopologyPU3DExtender @ 0x1C002C8D0 (TopologyPU3DExtender.c)
 *     TopologyPUChorus @ 0x1C002C9C0 (TopologyPUChorus.c)
 *     TopologyPUDynRangeCompressor @ 0x1C002CB30 (TopologyPUDynRangeCompressor.c)
 *     TopologyPUReverb @ 0x1C002CEA0 (TopologyPUReverb.c)
 * Callees:
