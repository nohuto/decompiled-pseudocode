/*
 * XREFs of _scope_exit__lambda_0afe05fec85482081db6025312a59336____::_2_::scope_exit::_scope_exit @ 0x1C0011264
 * Callers:
...
ULONG *__fastcall scope_exit__lambda_0afe05fec85482081db6025312a59336____::_2_::scope_exit::_scope_exit(PIRP **a1)
{
  char v1; // r8
  char v2; // dl
  ULONG *result; // rax
