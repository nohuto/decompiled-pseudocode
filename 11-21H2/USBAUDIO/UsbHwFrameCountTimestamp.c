/*
 * XREFs of UsbHwFrameCountTimestamp @ 0x1C0003148
 * Callers:
...
__int64 __fastcall UsbHwFrameCountTimestamp(__int64 a1, _DWORD *a2, unsigned __int64 *a3)
{
  ...
  if ( CurrentFrame >= 0 )
  {
    ...
    do
    {
      ...
      if ( v20 == v11 )
      {
        if ( (unsigned __int64)(v13 - v8) > 0x5208 )
          CurrentFrame = -1073741275;
      }
      else
      {
        CurrentFrame = -1073741275;
        if ( v20 == v11 + 1 && (unsigned __int64)(v13 - v8) < 0x2904 && (unsigned __int64)(v13 - v12) < 0x7D0 )
        {
          CurrentFrame = 0;
          v14 = v19;
          v4 = 1;
          *v18 = v20;
          *v14 = (unsigned __int64)(v13 + v12) >> 1;
        }
      }
      v6 = v16;
