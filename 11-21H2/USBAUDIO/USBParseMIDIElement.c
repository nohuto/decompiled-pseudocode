/*
 * XREFs of USBParseMIDIElement @ 0x1C0037E60
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall USBParseMIDIElement(__int64 a1, __int64 a2, unsigned __int8 *a3)
{
  ...
  if ( UnitString >= 0 )
  {
    ...
    if ( Pool2 )
    {
      ...
      v16 = a3[3];
      v19 = 0LL;
      UnitString = BusApiBuildFunctionUnit(a1, v11 | v16, 8, 0, 0, (unsigned __int8)v14, Pool2, SourceString, 0, &v19);
      if ( UnitString >= 0 && v19 )
        *(_DWORD *)(v19 + 64) = v4;
      ExFreePool(v13);
    }
