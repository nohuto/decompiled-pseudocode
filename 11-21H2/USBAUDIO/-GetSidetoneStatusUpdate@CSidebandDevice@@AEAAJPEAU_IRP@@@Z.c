/*
 * XREFs of ?GetSidetoneStatusUpdate@CSidebandDevice@@AEAAJPEAU_IRP@@@Z @ 0x1C0012800
 * Callers:
...
__int64 __fastcall CSidebandDevice::GetSidetoneStatusUpdate(CSidebandDevice *this, struct _IRP *a2)
{
...
LABEL_24:
  ...
  if ( p_NamedPipeType[1] )
    ...
    SidetoneImmediate = IoCsqInsertIrpEx((PIO_CSQ)(*((_QWORD *)this + 6) + 160LL), a2, 0LL, (char *)this + 120);
  v5 = SidetoneImmediate;
