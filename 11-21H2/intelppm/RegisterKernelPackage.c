/*
 * XREFs of RegisterKernelPackage @ 0x1C002D960
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall RegisterKernelPackage(__int64 a1)
{
  ...
  if ( *(_DWORD *)(a1 + 80) )
    ...
    v2 = ((__int64 (__fastcall *)(_QWORD))qword_1C001E0C0)(*(unsigned int *)(a1 + 56));
  v3 = v2;
  v4 = qword_1C001DD58;
  ...
  while ( (__int64 *)v4 != &qword_1C001DD58 );
  if ( !v5 )
  {
LABEL_8:
