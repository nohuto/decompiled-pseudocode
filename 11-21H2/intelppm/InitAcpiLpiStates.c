/*
 * XREFs of InitAcpiLpiStates @ 0x1C0028464
 * Callers:
 ...
 *     ValidateProcessorLpiStates @ 0x1C0037EB4 (ValidateProcessorLpiStates.c)
...
__int64 __fastcall InitAcpiLpiStates(__int64 a1)
{
  ...
  v2 = AcpiEvaluateMethod(a1, 1229999199, 0LL, (unsigned int **)&P, &v11);
  if ( v2 >= 0 )
  {
    v5 = *(_QWORD *)(a1 + 64);
