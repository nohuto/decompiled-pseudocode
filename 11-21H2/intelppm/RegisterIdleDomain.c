/*
 * XREFs of RegisterIdleDomain @ 0x1C003E000
 * Callers:
...
bool __fastcall RegisterIdleDomain(__int64 a1, unsigned int a2)
{
  ...
  if ( *(_DWORD *)(v2 + 24LL * a2 + 24) >= **(_DWORD **)(a1 + 728) )
    return v3;
  v6 = qword_1C001DD68;
  if ( (__int64 *)qword_1C001DD68 == &qword_1C001DD68 )
    goto LABEL_6;
  do
  {
    v7 = v6;
  ...
  while ( (__int64 *)v6 != &qword_1C001DD68 );
  if ( !v7 )
  {
LABEL_6:
    ...
    v9[1] = v9;
    *v9 = v9;
    v10 = (__int64 *)qword_1C001DD70;
    if ( *(__int64 **)qword_1C001DD70 != &qword_1C001DD68 )
LABEL_14:
      __fastfail(3u);
    *(_QWORD *)v7 = &qword_1C001DD68;
    *(_QWORD *)(v7 + 8) = v10;
    *v10 = v7;
    qword_1C001DD70 = v7;
