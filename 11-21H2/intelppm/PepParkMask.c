/*
 * XREFs of PepParkMask @ 0x1C000D660
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall PepParkMask(__int64 a1, __int64 a2)
{
  ...
  {
    result = (unsigned int)dword_1C001E318;
    if ( dword_1C001E318 >= (unsigned int)dword_1C001DCF4 )
    {
      memset(&PepParkLists, 0, (unsigned int)(16 * dword_1C001DCF4));
      v5 = 0;
      KeInitializeEnumerationContext(&v11, &unk_1C001E0E0);
      ...
      if ( !(_DWORD)result )
      {
        ...
        if ( v5 )
        {
          ...
          v8[0] = v5;
          v10 = &PepParkLists;
          result = ((__int64 (__fastcall *)(_QWORD, _DWORD *))qword_1C001E058)(*(_QWORD *)(v7 + 1120), v8);
          if ( (int)result < 0 )
          {
