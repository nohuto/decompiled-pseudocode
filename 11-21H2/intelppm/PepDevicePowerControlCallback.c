/*
 * XREFs of PepDevicePowerControlCallback @ 0x1C000D500
 * Callers:
 *     <none>
 * Callees:
 ...
 *     PepUpdatePerformanceConstraint @ 0x1C000D44C (PepUpdatePerformanceConstraint.c)
  ...
  *a7 = 0LL;
  ...
  if ( v9 )
  {
    ...
    if ( v10 )
    {
      ...
      {
        return PepPlatformIdleVeto(a1, (int *)a3);
      }
    }
    else if ( a4 >= 0xC )
    {
