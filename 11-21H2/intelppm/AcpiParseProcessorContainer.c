/*
 * XREFs of AcpiParseProcessorContainer @ 0x1C003B9D0
 * Callers:
 *     AcpiGetCoordinatedLpiStates @ 0x1C003AD8C (AcpiGetCoordinatedLpiStates.c)
 * Callees:
 *     GetDevExtByAcpiId @ 0x1C0007184 (GetDevExtByAcpiId.c)
 *     RtlUnicodeStringCopyString @ 0x1C0009C08 (RtlUnicodeStringCopyString.c)
    ...
    if ( v15 )
    {
      ...
      *(_QWORD *)(a3 + 32) = v16;
      ...
      for ( j = (char *)a1 + (unsigned int)a1[2 * v5 + 7]; v17 < a1[2 * v5 + 6]; v17 = v20 + 1 )
      {
        ...
        {
          if ( dword_1C001E5AC <= (unsigned int)dword_1C001DCF4 )
            return -1073741275;
