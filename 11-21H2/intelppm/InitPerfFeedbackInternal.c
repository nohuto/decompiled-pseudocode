/*
 * XREFs of InitPerfFeedbackInternal @ 0x1C003D464
 * Callers:
 *     RegisterHvPerfFeedbackCounters @ 0x1C0039470 (RegisterHvPerfFeedbackCounters.c)
 *     RegisterKernelPerfFeedback @ 0x1C003F230 (RegisterKernelPerfFeedback.c)
 * Callees:
...
__int64 __fastcall InitPerfFeedbackInternal(_QWORD *a1, __int64 (__fastcall *a2)(_QWORD *))
{
  ...
  *((_WORD *)inited + 3) = 1;
  *((_BYTE *)inited + 52) = 1;
  *((_BYTE *)inited + 14) = byte_1C001E240;
