/*
 * XREFs of CpcConnectNativeInterrupt @ 0x1C0029150
 * Callers:
...
void __fastcall CpcConnectNativeInterrupt(struct _DEVICE_OBJECT **DeferredContext)
{
  ...
  if ( WorkItem )
  {
    ...
    if ( (int)((__int64 (__fastcall *)(struct _DEVICE_OBJECT **))qword_1C001DF30)(DeferredContext) >= 0 )
    {
      LOBYTE(v1->Queue.Wcb.CurrentIrp) = 1;
      ((void (*)(void))qword_1C001DF48)();
    }
  }
