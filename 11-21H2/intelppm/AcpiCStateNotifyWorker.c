/*
 * XREFs of AcpiCStateNotifyWorker @ 0x1C002E060
 * Callers:
 *     <none>
 * Callees:
 ...
 *     PepNotifyReportCStates @ 0x1C00415C0 (PepNotifyReportCStates.c)
 */
...
void __fastcall AcpiCStateNotifyWorker(__int64 a1, struct _IO_WORKITEM *a2)
{
  ...
  if ( (*(_DWORD *)(v8 + 280) & 0x7F070) != 0 )
  {
    ...
    {
      v3 = v13;
      inited = InitAcpiIdleDomain(v8, &v14, (__int64)v13);
      v4 = v14;
      if ( inited < 0 )
        v4 = 0LL;
    }
    ...
    *(_QWORD *)(v8 + 536) = v4;
    ...
    ((void (__fastcall *)(__int64))qword_1C001E1E8)(v8);
