/*
 * XREFs of ProcLibTraceCoordinatedIdleStates @ 0x1C0033E98
 * Callers:
...
void __fastcall ProcLibTraceCoordinatedIdleStates(char a1)
{
  ...
  v1 = (unsigned int *)qword_1C001E348;
  v28 = 0;
  v26 = 0;
  Pool2 = 0LL;
  v29 = 0;
            ...
            if ( v1[v16 + 87] )
            {
              ...
              do
              {
                ...
                *(_QWORD *)&UserData.Size = 4LL;
                ...
                v43 = 0;
                v42 = v25;
                EtwWrite((REGHANDLE)WPP_MAIN_CB.Queue.ListEntry.Blink, v10, 0LL, (ULONG)7, &UserData);
                v17 = v28 + 1;
                v28 = v17;
              }
              while ( v17 < v1[v16 + 87] );
