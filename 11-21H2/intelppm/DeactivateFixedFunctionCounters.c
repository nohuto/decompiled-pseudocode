/*
 * XREFs of DeactivateFixedFunctionCounters @ 0x1C0005BCC
 * Callers:
 *     SnapEnergyCounters @ 0x1C0005C40 (SnapEnergyCounters.c)
 *     UnInitEnergyCounters @ 0x1C0033150 (UnInitEnergyCounters.c)
 * Callees:
 *     <none>
 */
