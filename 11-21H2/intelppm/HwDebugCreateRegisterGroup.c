/*
 * XREFs of HwDebugCreateRegisterGroup @ 0x1C002945C
 * Callers:
 ...
 *     HwDebugInitializeRegister @ 0x1C002979C (HwDebugInitializeRegister.c)
...
__int64 __fastcall HwDebugCreateRegisterGroup(__int64 a1, int a2, __int64 a3, unsigned __int8 *a4, _QWORD *a5, int a6)
{
  ...
  *a5 = 0LL;
  ...
  v18 = (_QWORD **)((char *)&unk_1C001DD18 + 16 * a6);
  v32 = v18;
    ...
    if ( PackageAffinity >= 0 )
    {
      ...
      do
      {
        for ( j = 0LL; (unsigned int)j < *a4; j = (unsigned int)(j + 1) )
        {
          ...
          {
            v29 = (__int64 *)&v21[24 * (unsigned __int8)v21[308] + 312];
            *v29 = v24;
