/*
 * XREFs of InitEnergyCountersMsrEx @ 0x1C0032F90
 * Callers:
 ...
 *     ActivateFixedFunctionCounters @ 0x1C0005480 (ActivateFixedFunctionCounters.c)
 */
...
_DWORD *InitEnergyCountersMsrEx()
{
  ...
  if ( !v1 )
  {
    ...
    *(_DWORD *)&WPP_MAIN_CB.DeviceQueue.Type |= 0x40u;
    qword_1C001E488[0] = (__int64)SnapEnergyCounters;
    result = ComputeProcessorEnergyMsrEx;
    qword_1C001E480[0] = (__int64)ComputeProcessorEnergyMsrEx;
  }
  return result;
}
