/*
 * XREFs of wil_details_UpdateFeatureConfiguredStates @ 0x1C00242A0
 * Callers:
 *     wil_details_OnFeatureConfigurationChange @ 0x1C0024220 (wil_details_OnFeatureConfigurationChange.c)
 * Callees:
 *     __security_check_cookie @ 0x1C0003340 (__security_check_cookie.c)
 *     wil_details_FeatureDescriptors_SkipPadding @ 0x1C000356C (wil_details_FeatureDescriptors_SkipPadding.c)
 *     wil_details_BuildFeatureStateCacheFromQueryResults @ 0x1C0024008 (wil_details_BuildFeatureStateCacheFromQueryResults.c)
 */
...
volatile signed __int32 **wil_details_UpdateFeatureConfiguredStates()
{
  ...
  for ( i = wil_details_featureDescriptors_a; ; i = v4 + 6 )
  {
