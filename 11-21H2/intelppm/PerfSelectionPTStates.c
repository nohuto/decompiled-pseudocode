/*
 * XREFs of PerfSelectionPTStates @ 0x1C0001010
 * Callers:
 *     <none>
 * Callees:
...
LABEL_7:
  ...
  else
  {
    ...
    do
      v14 = v12 + 32LL * --v13;
    while ( *(unsigned __int8 *)(v14 + 24) < a2 && v13 );
  }
  for ( ; *(unsigned __int8 *)(v14 + 24) < a3; v14 = v12 + 32LL * --v13 )
  {
    if ( !v13 )
      break;
  }
  for ( ; *(unsigned __int8 *)(v14 + 24) > a4; v14 = v12 + 32LL * ++v13 )
  {
