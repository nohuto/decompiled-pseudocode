/*
 * XREFs of ProcLibTraceSummary2 @ 0x1C00299AC
 * Callers:
    ...
    if ( (_BYTE)EventDescriptorAndProcessorId )
    {
      ...
      else
      {
        if ( (v9 & 0x8000000) == 0 )
        {
          ...
          {
            v29 = 2;
            v14 = *(_DWORD *)(qword_1C001E290 + 28);
            v26 = v14;
            v27 = 100 * *(_DWORD *)(qword_1C001E290 + 36) / v14;
            v28 = 100 * *(_DWORD *)(qword_1C001E290 + 32) / v14;
          }
          else
          {
            if ( (v9 & 0x73300000) == 0 )
