/*
 * XREFs of ProcLibTracePepPerfCapabilities @ 0x1C0034B70
 * Callers:
    ...
    if ( v5 )
    {
      if ( *(_QWORD *)(a1 + 1208) )
      {
        ...
        if ( Pool2 )
        {
          ...
          v11 = (unsigned __int8 *)(v5 + 33);
          v12 = *(unsigned __int8 *)(v5 + 33);
          if ( (_BYTE)v12 )
          {
...
LABEL_15:
          ...
          if ( ProcLibGetProcessorNumber(a1, &v18) >= 0 )
          {
            *(_QWORD *)&UserData.Size = 2LL;
            ...
            v45 = &v19;
            v46 = 4LL;
            EtwWrite((REGHANDLE)WPP_MAIN_CB.Queue.ListEntry.Blink, v3, 0LL, (ULONG)13, &UserData);
          }
          goto LABEL_15;
        }
      }
