/*
 * XREFs of FxDriverEntryWorker @ 0x1C0002E54
 * Callers:
...
NTSTATUS __fastcall FxDriverEntryWorker(_DRIVER_OBJECT *DriverObject, PUNICODE_STRING RegistryPath)
{
  ...
  *(_DWORD *)&DestinationString.Length = 34078720;
  DestinationString.Buffer = (wchar_t *)&unk_1C001E650;
    ...
    if ( inited >= 0 )
    {
      ...
      if ( inited >= 0 )
      {
        ...
        if ( v7 >= 0 )
        {
          ...
          {
            DriverUnload = (void (__fastcall *)(_DRIVER_OBJECT *))qword_1C001E620;
            if ( DriverObject->DriverUnload )
              DriverUnload = DriverObject->DriverUnload;
            qword_1C001E620 = (__int64)DriverUnload;
