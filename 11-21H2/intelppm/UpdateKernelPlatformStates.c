/*
 * XREFs of UpdateKernelPlatformStates @ 0x1C003F824
 * Callers:
...
__int64 __fastcall UpdateKernelPlatformStates(__int64 a1, char a2)
{
  ...
  if ( Src )
  {
    ...
    Pool2 = (unsigned int *)ExAllocatePool2(256LL, v8 + 8 * v6 * dword_1C001DCF4, 1919119952LL);
    v3 = Pool2;
    if ( Pool2 )
    {
...
LABEL_29:
    *((_BYTE *)v3 + 48) = 1;
    (*(void (__fastcall **)(PWDF_DRIVER_GLOBALS, __int64, _QWORD))(WdfFunctions_01015 + 2504))(
      ...
      qword_1C001DCF8,
      0LL);
    ProcessorNumberFromIndex = ((__int64 (__fastcall *)(unsigned int *))qword_1C001E008)(v3);
  ...
  if ( v4 )
  {
    ...
    if ( v6 )
    {
      ...
      do
      {
        ...
        *v4 = v20;
        v4[8] = v5;
        if ( (int)((__int64 (__fastcall *)(_QWORD, unsigned int *, __int64))qword_1C001E068)(
                    *(_QWORD *)(a1 + 1120),
                    v4,
                    v22) >= 0 )
        {
