/*
 * XREFs of InitPkgThermalStats @ 0x1C002D480
 * Callers:
 *     <none>
 * Callees:
 *     _guard_dispatch_icall_nop @ 0x1C0003700 (_guard_dispatch_icall_nop.c)
 *     GetPkgThermalRegisterDefinition @ 0x1C002D70C (GetPkgThermalRegisterDefinition.c)
 */
...
__int64 InitPkgThermalStats()
{
  ...
  P = 0LL;
  if ( (qword_1C001E5D8 & 0x200000000LL) != 0 )
          ...
          *(_QWORD *)(v5 + 40) = v24;
          if ( v24 )
          {
            ...
            *(_QWORD *)(v3 + 40) = QueryPkgThermalMSRValues;
            v28 = (__int64 *)qword_1C001E5E8;
            if ( *(__int64 **)qword_1C001E5E8 != &qword_1C001E5E0 )
              __fastfail(3u);
            *(_QWORD *)v3 = &qword_1C001E5E0;
            *(_QWORD *)(v3 + 8) = v28;
            *v28 = v3;
            HIDWORD(qword_1C001E5D8) |= 1u;
            PkgThermalRegisterDefinition = 0;
            qword_1C001E5E8 = v3;
            goto LABEL_28;
          }
