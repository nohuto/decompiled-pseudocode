/*
 * XREFs of AcpiEval_CPC @ 0x1C0025EF8
 * Callers:
    ...
    else
    {
      ...
      if ( v8 )
      {
        ...
        if ( v9 )
        {
          v10 = 31;
          v11 = v9 != 1;
          v12 = (unsigned int *)&Cpc3RegisterTable;
        }
        else
        {
          v10 = 27;
      ...
      v5 = AcpiParseCore((unsigned int)v18, v10, (int)v6 + 12, v6[1] - 12, (__int64)Pool2, 512, (__int64)"_CPC", v11);
      if ( v5 >= 0 )
      {
        do
        {
          AcpiTranslateAccessSize((char *)Pool2 + *v12);
          v12 += 6;
          --v3;
        }
        while ( v3 );
