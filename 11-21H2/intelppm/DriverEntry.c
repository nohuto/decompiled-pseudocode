/*
 * XREFs of DriverEntry @ 0x1C0047770
 * Callers:
 ...
 *     EvtDriverUnload @ 0x1C0035F30 (EvtDriverUnload.c)
...
NTSTATUS __stdcall DriverEntry(_DRIVER_OBJECT *DriverObject, PUNICODE_STRING RegistryPath)
{
  ...
  *(_QWORD *)&WPP_MAIN_CB.Type = 0LL;
  ...
  if ( v4 >= 0 )
  {
    KeInitializeAffinityEx2(&unk_1C001DD88, 32LL);
    dword_1C001DCF4 = KeQueryActiveProcessorAffinity2(&unk_1C001DD88);
    KeInitializeAffinityEx2(&unk_1C001E0E0, 32LL);
