/*
 * XREFs of ConnectHwpInterrupt @ 0x1C002B540
 * Callers:
 *     <none>
 * Callees:
 *     WPP_RECORDER_SF_D @ 0x1C0002630 (WPP_RECORDER_SF_D.c)
 *     WPP_RECORDER_SF_ @ 0x1C00026F0 (WPP_RECORDER_SF_.c)
 *     IsHwpNativeInterruptEnabled @ 0x1C0002D0C (IsHwpNativeInterruptEnabled.c)
  ...
  if ( IsHwpNativeInterruptEnabled(a1) )
  {
    ...
    else
    {
      if ( HIBYTE(WPP_MAIN_CB.Queue.Wcb.CurrentIrp) )
      {
        v7 = __readmsr(0x1B1u);
        if ( (v7 & 0x4000000) != 0 )
          ((void (__fastcall *)(__int64))qword_1C001E098)(433LL);
      }
      return 0;
    }
  }
