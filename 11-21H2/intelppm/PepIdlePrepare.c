/*
 * XREFs of PepIdlePrepare @ 0x1C000C140
 * Callers:
 *     <none>
 * Callees:
 ...
 *     PepIdleCancel @ 0x1C000BEF0 (PepIdleCancel.c)
 */
  ...
  *(_OWORD *)v17 = 0LL;
  ...
  if ( dword_1C001E318 >= (unsigned int)dword_1C001DCF4 )
  {
    ...
    *(_QWORD *)&v19 = a1[3];
    ...
    v17[1] = v6;
    HIDWORD(v19) = !v7;
    if ( (int)((__int64 (__fastcall *)(_QWORD, ULONG_PTR *))qword_1C001E060)(
    ...
    if ( !LOBYTE(BugCheckParameter3[1]) )
    {
      ...
      if ( (_DWORD)v18 != -1 && (unsigned int)v18 >= dword_1C001E33C )
