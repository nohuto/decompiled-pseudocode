/*
 * XREFs of ProcLibTraceGetProcessorIdleStatesV2 @ 0x1C0034694
 * Callers:
...
void __fastcall ProcLibTraceGetProcessorIdleStatesV2(__int64 a1, char a2)
{
  ...
  if ( EtwEventEnabled((REGHANDLE)WPP_MAIN_CB.Queue.ListEntry.Blink, v2) )
  {
    v4 = *(_DWORD **)(a1 + 1152);
    if ( v4 )
    {
      if ( ProcLibGetProcessorNumber(a1, &v11) >= 0 )
      {
        ...
        if ( Pool2 )
        {
          ...
          v16 = v4;
          v17 = 4;
          EtwWrite((REGHANDLE)WPP_MAIN_CB.Queue.ListEntry.Blink, v2, 0LL, (ULONG)4, &UserData);
