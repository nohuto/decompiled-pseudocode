/*
 * XREFs of wil_details_FeatureReporting_ReportUsageToService @ 0x1C000FFE4
 * Callers:
 ...
 *     wil_details_MapReportingKind @ 0x1C00103AC (wil_details_MapReportingKind.c)
        ...
        unsigned int a6))(_QWORD, _QWORD, _QWORD, _QWORD, _QWORD, _QWORD, _DWORD, _QWORD)
{
  ...
  if ( (_DWORD)result )
  {
    ...
    {
      v12 = 0;
      return (__int64 (__fastcall *)(_QWORD, _QWORD, _QWORD, _QWORD, _QWORD, _QWORD, _DWORD, _QWORD))g_wil_details_pfnFeatureLoggingHook(40765348LL, &Feature_Servicing_ProtocolCommandTransferLength_logged_traits, 0LL, a6, &v13, 0LL, v12, 1LL);
    }
  }
  return result;
}
