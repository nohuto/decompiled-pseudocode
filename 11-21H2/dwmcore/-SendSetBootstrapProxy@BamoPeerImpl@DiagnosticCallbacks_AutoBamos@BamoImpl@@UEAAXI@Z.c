/*
 * XREFs of ?SendSetBootstrapProxy@BamoPeerImpl@DiagnosticCallbacks_AutoBamos@BamoImpl@@UEAAXI@Z @ 0x180197FD0
 * Callers:
 *     <none>
 * Callees:
        ...
        BamoImpl::DiagnosticCallbacks_AutoBamos::BamoPeerImpl *this)
{
  ...
  v3 = CoreUICallSend(v2, v5, 2LL, 1LL, 7, &unk_18034586A);
  if ( v3 < 0 )
