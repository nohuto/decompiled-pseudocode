/*
 * XREFs of ??$PropertyUpdated@UD2DVector3@@@CPropertySet@@AEAAJIIPEBUD2DVector3@@@Z @ 0x1800E1AAC
 * Callers:
...
__int64 __fastcall CPropertySet::PropertyUpdated<D2DVector3>(CResource *this, __int64 a2, int a3, __int64 a4)
{
  __int64 v4; // rdi
  __int64 v8; // rcx
  unsigned int v9; // ebx
