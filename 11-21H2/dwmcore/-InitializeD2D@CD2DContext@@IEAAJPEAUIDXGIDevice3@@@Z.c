/*
 * XREFs of ?InitializeD2D@CD2DContext@@IEAAJPEAUIDXGIDevice3@@@Z @ 0x1800222A8
 * Callers:
...
__int64 __fastcall CD2DContext::InitializeD2D(struct CD2DResourceManager **this, struct IDXGIDevice3 *a2)
{
  ...
  {
    D2DDevice = CD2DResourceManager::Create((struct CD2DContext *)v3, v3 + 21);
    v6 = D2DDevice;
    if ( D2DDevice < 0 )
    {
      v13 = 35;
    ...
    {
      v8 = v3 + 23;
      D2DDevice = CD2DFactory::CreateD2DDevice((CD2DFactory *)this, a2, v3 + 23);
      v6 = D2DDevice;
      if ( D2DDevice < 0 )
      {
        v13 = 38;
