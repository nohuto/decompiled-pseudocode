/*
 * XREFs of ?SendReportToE3@CEnergyReporter@@AEAAXXZ @ 0x18007878C
 * Callers:
...
void __fastcall CEnergyReporter::SendReportToE3(RTL_SRWLOCK *this)
{
  ...
  if ( LODWORD(this[5].Ptr) )
  {
    ...
    if ( LOBYTE(this[10].Ptr) )
    {
      ...
      {
        if ( (unsigned int)dword_1803D1694 < MEMORY[0x7FFE037C] && !(unsigned __int8)EtwCheckCoverage(&off_1803D1688) )
          NtSetInformationProcess((HANDLE)0xFFFFFFFFFFFFFFFFLL, ProcessAffinityMask|0x40, &off_1803D1688, 0x18u);
      }
    ...
    if ( v4 < 0
      && (unsigned int)dword_1803D167C < MEMORY[0x7FFE037C]
      && !(unsigned __int8)EtwCheckCoverage(&off_1803D1670) )
    {
      NtSetInformationProcess((HANDLE)0xFFFFFFFFFFFFFFFFLL, ProcessAffinityMask|0x40, &off_1803D1670, 0x18u);
    }
