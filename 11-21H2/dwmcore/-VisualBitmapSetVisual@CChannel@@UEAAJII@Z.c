/*
 * XREFs of ?VisualBitmapSetVisual@CChannel@@UEAAJII@Z @ 0x1801ACD10
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall CChannel::VisualBitmapSetVisual(CDataStreamWriter **this, unsigned int a2, int a3)
{
  unsigned int v6; // ebx
