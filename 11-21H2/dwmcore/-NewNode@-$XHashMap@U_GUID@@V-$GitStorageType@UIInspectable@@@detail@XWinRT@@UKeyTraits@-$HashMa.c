        ...
        _QWORD *a5)
{
  ...
  if ( !*(_QWORD *)(a1 + 72) )
  {
    ...
    *(_QWORD *)(a1 + 64) = v10;
    v11 = *(_DWORD *)(a1 + 60);
    for ( i = (__int64)&v10[6 * (unsigned int)(v11 - 1) + 1]; --v11 >= 0; i -= 48LL )
    {
