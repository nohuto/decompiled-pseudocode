/*
 * XREFs of ?ResetBitmapCache@CRenderTargetBitmap@@IEAAXXZ @ 0x180068170
 * Callers:
 ...
 *     ?SetProtected@CRenderTargetBitmap@@UEAAX_N@Z @ 0x1800E72C0 (-SetProtected@CRenderTargetBitmap@@UEAAX_N@Z.c)
