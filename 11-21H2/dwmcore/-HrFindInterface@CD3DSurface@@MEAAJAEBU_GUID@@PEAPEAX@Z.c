/*
 * XREFs of ?HrFindInterface@CD3DSurface@@MEAAJAEBU_GUID@@PEAPEAX@Z @ 0x18028C680
 * Callers:
 *     <none>
 * Callees:
 *     ?HrFindInterface@CD3DResource@@MEAAJAEBU_GUID@@PEAPEAX@Z @ 0x180279750 (-HrFindInterface@CD3DResource@@MEAAJAEBU_GUID@@PEAPEAX@Z.c)
 */
