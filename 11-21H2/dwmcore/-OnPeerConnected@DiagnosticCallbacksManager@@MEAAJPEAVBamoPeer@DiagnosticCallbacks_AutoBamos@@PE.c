/*
 * XREFs of ?OnPeerConnected@DiagnosticCallbacksManager@@MEAAJPEAVBamoPeer@DiagnosticCallbacks_AutoBamos@@PEA_NPEAPEAVBamoPrincipal@Bamo@Microsoft@@@Z @ 0x1800F9980
 * Callers:
 *     <none>
 * Callees:
 *     <none>
