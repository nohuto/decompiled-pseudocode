/*
 * XREFs of ?_Change_array@?$vector@PEAVCCompositionGlyphRun@@V?$allocator@PEAVCCompositionGlyphRun@@@std@@@std@@AEAAXQEAPEAVCCompositionGlyphRun@@_K1@Z @ 0x1801A628C
 * Callers:
