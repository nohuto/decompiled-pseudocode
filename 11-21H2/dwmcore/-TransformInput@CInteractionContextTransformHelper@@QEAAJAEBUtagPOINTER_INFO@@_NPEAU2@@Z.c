/*
 * XREFs of ?TransformInput@CInteractionContextTransformHelper@@QEAAJAEBUtagPOINTER_INFO@@_NPEAU2@@Z @ 0x1802AE3B8
 * Callers:
 ...
 *     s_TransformPointByMatrix @ 0x1802AED80 (s_TransformPointByMatrix.c)
 */
