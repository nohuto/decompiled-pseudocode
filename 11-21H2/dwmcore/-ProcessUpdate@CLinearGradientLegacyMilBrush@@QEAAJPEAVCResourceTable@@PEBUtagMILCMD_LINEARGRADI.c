/*
 * XREFs of ?ProcessUpdate@CLinearGradientLegacyMilBrush@@QEAAJPEAVCResourceTable@@PEBUtagMILCMD_LINEARGRADIENTLEGACYMILBRUSH@@PEBXI@Z @ 0x180206690
 * Callers:
  ...
  *((_DWORD *)this + 20) = *((_DWORD *)a3 + 2);
  ...
  if ( v10 )
  {
    ...
    *((_QWORD *)this + 11) = Resource;
    ...
    {
      v12 = -2003303421;
      MilInstrumentationCheckHR_MaybeFailFast(v9, 0LL, 0LL, -2003303421, 0x38Cu);
LABEL_21:
      CLinearGradientLegacyMilBrush::UnRegisterNotifiers(this);
      goto LABEL_22;
    }
  ...
  if ( v13 )
  {
    ...
    *((_QWORD *)this + 12) = v14;
    ...
    {
      v12 = -2003303421;
      MilInstrumentationCheckHR_MaybeFailFast(v9, 0LL, 0LL, -2003303421, 0x39Fu);
      goto LABEL_21;
    }
  }
  else
  ...
  if ( (_DWORD)v15 )
  {
    ...
    *((_QWORD *)this + 13) = v16;
    ...
    {
      v12 = -2003303421;
      MilInstrumentationCheckHR_MaybeFailFast(v9, 0LL, 0LL, -2003303421, 0x3B1u);
      goto LABEL_21;
    }
  }
  else
  ...
  *(_OWORD *)((char *)this + 136) = *(_OWORD *)((char *)a3 + 40);
  *(_OWORD *)((char *)this + 152) = *(_OWORD *)((char *)a3 + 56);
  v17 = *((_DWORD *)a3 + 9);
  if ( v17 )
  {
    ...
    {
      v12 = -2003303421;
      MilInstrumentationCheckHR_MaybeFailFast(v9, 0LL, 0LL, -2003303421, 0x3C8u);
      goto LABEL_21;
    }
    v18 = HrAlloc(v17, (void **)this + 16);
    v12 = v18;
    if ( v18 < 0 )
    {
      v21 = 973;
    ...
    memcpy_0(*((void **)this + 16), a4, *((unsigned int *)a3 + 9));
    *((_DWORD *)this + 31) = *((_DWORD *)a3 + 9);
  }
  v18 = CLinearGradientLegacyMilBrush::RegisterNotifiers(this, v15);
  v12 = v18;
  if ( v18 < 0 )
  {
    v21 = 985;
LABEL_20:
    MilInstrumentationCheckHR_MaybeFailFast(v19, 0LL, 0LL, v18, v21);
    goto LABEL_21;
  }
LABEL_22:
