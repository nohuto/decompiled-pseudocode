/*
 * XREFs of ?ProcessExclusiveSurfaceUpdate@CHolographicExclusiveView@@AEAA_NIPEAUEXCLUSIVE_SURFACE_UPDATE@@@Z @ 0x1802992E8
 * Callers:
 ...
 *     ?CloseSurfaceHandles@CHolographicExclusiveView@@AEAAXXZ @ 0x180298EB4 (-CloseSurfaceHandles@CHolographicExclusiveView@@AEAAXXZ.c)
        ...
        struct EXCLUSIVE_SURFACE_UPDATE *a3)
{
  ...
  {
    MilInstrumentationCheckHR_MaybeFailFast(v8, 0LL, 0LL, AnalogExclusiveSurfaceUpdates | 0x10000000, 0x1CFu);
  }
  return v3;
}
