/*
 * XREFs of ?Present@CDummyRemotingSwapChain@@UEAAJPEBVCRegion@@@Z @ 0x180289D50
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall CDummyRemotingSwapChain::Present(CDummyRemotingSwapChain *this, const struct CRegion *a2)
{
  ...
  if ( v4 < 0 )
  {
    MilInstrumentationCheckHR_MaybeFailFast((__int64)this, 0LL, 0LL, v4, 0xC7u);
  }
  else
  {
    v5 = 0;
    ...
    {
      v4 = -2003304309;
      MilInstrumentationCheckHR_MaybeFailFast(v9, 0LL, 0LL, -2003304309, 0xD3u);
    }
    else
    {
      v10 = ++*((_DWORD *)this + 46);
      ...
      *(_QWORD *)((char *)this + v11 + 112) = 0LL;
      v12 = *(void **)((char *)this + v11 + 72);
      *((_BYTE *)this + v11 + 120) = 0;
      *(_DWORD *)((char *)this + v11 + 80) = v10;
      ...
      if ( v13 < 0 )
      {
        MilInstrumentationCheckHR_MaybeFailFast(v14, 0LL, 0LL, v13, 0x112u);
        MilInstrumentationCheckHR_MaybeFailFast(v15, 0LL, 0LL, v4, 0xCFu);
      }
    }
  }
