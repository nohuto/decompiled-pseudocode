/*
 * XREFs of ??$_Emplace_reallocate@AEBQEAVCResource@@@?$vector@PEAVCResource@@V?$allocator@PEAVCResource@@@std@@@std@@QEAAPEAPEAVCResource@@QEAPEAV2@AEBQEAV2@@Z @ 0x1800EFA1C
 * Callers:
...
char *__fastcall std::vector<CResource *>::_Emplace_reallocate<CResource * const &>(__int64 a1, _BYTE *a2, _QWORD *a3)
{
