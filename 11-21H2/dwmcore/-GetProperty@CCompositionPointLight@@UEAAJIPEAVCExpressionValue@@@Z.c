/*
 * XREFs of ?GetProperty@CCompositionPointLight@@UEAAJIPEAVCExpressionValue@@@Z @ 0x18020DBA0
 * Callers:
 *     <none>
 * Callees:
        ...
        struct CExpressionValue *a3)
{
  ...
  v10[0] = 8LL;
  v10[1] = &CCompositionPointLight::k_rgAnimDef;
  v4 = 0;
  ...
  {
    v4 = -2147024809;
    MilInstrumentationCheckHR_MaybeFailFast(v6, 0LL, v7, -2147024809, 0x81u);
  }
  return v4;
}
