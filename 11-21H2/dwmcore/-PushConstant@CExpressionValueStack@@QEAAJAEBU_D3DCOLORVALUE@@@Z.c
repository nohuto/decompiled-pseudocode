/*
 * XREFs of ?PushConstant@CExpressionValueStack@@QEAAJAEBU_D3DCOLORVALUE@@@Z @ 0x18024F664
 * Callers:
...
__int64 __fastcall CExpressionValueStack::PushConstant(CExpressionValueStack *this, const struct _D3DCOLORVALUE *a2)
{
  ...
  if ( v4 < 0 )
  {
    MilInstrumentationCheckHR_MaybeFailFast(v5, &CExpressionValueStack::MILINSTRUMENTATIONHRESULTLIST, 1LL, v4, 0x215u);
  }
  else
  {
