/*
 * XREFs of ??$Transform2DAndFillPosXYUVs@U?$Vertex_UVxN@UVertexXYW_ColorDW@@@@@@YAXAEBU?$Vertex_UVxN@UVertexXYW_ColorDW@@@@AEBUVertexAAFixup_UVxN@@IAEBVCMILMatrix@@PEAU0@PEAUD2D_POINT_2F@@@Z @ 0x1800D7164
 * Callers:
        ...
        float *a6)
{
  ...
  if ( v14 != 0.0 || v15 != 0.0 )
    v11 = a2[2] / o_sqrtf_0((float)(v15 * v15) + (float)(v14 * v14));
  result = a6;
  *a6 = v12;
  a6[1] = v13;
