/*
 * XREFs of ?GetBrushParameters@CWindowBackdropBrush@@UEBAJPEAVCBrushDrawListGenerator@@@Z @ 0x180243EF0
 * Callers:
 *     <none>
 * Callees:
        ...
        struct CBrushDrawListGenerator *a2)
{
  ...
  {
    MilInstrumentationCheckHR_MaybeFailFast(v4, 0LL, 0LL, WindowBackgroundTreatmentEffectInput, 0x30u);
LABEL_15:
    CBrushDrawListGenerator::Reset(a2);
    goto LABEL_16;
  }
  ...
  if ( v6 < 0 )
  {
    MilInstrumentationCheckHR_MaybeFailFast(v5, 0LL, 0LL, v6, 0x3Au);
    if ( v13 )
  ...
  v13 = 0LL;
  v14 = v8;
  CBrushDrawListGenerator::AttachInput((__int64)a2, 0, &v14);
  if ( v14 )
...
LABEL_16:
  ...
  wil::com_ptr_t<ID2DBitmap,wil::err_returncode_policy>::~com_ptr_t<ID2DBitmap,wil::err_returncode_policy>((__int64)&v18);
  return 0LL;
}
