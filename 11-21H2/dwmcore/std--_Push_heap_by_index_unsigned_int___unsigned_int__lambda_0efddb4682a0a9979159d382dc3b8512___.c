/*
 * XREFs of std::_Push_heap_by_index_unsigned_int___unsigned_int__lambda_0efddb4682a0a9979159d382dc3b8512___ @ 0x18022C7F4
 * Callers:
        ...
        __int64 a5)
{
  ...
  if ( a3 < a2 )
  {
    do
    {
      ...
      if ( *(float *)(*(_QWORD *)(a5 + 1088) + 4LL * *a4) <= *(float *)(*(_QWORD *)(a5 + 1088) + 4 * v7) )
        break;
      *(_DWORD *)(a1 + 4 * v5) = v7;
      v5 = (v5 - 1) >> 1;
    }
