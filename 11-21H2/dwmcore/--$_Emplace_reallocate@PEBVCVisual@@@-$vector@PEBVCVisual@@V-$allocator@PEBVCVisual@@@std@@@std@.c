/*
 * XREFs of ??$_Emplace_reallocate@PEBVCVisual@@@?$vector@PEBVCVisual@@V?$allocator@PEBVCVisual@@@std@@@std@@QEAAPEAPEBVCVisual@@QEAPEBV2@$$QEAPEBV2@@Z @ 0x1801B7990
 * Callers:
 ...
 *     ?_Change_array@?$vector@PEBVCVisual@@V?$allocator@PEBVCVisual@@@std@@@std@@AEAAXQEAPEBVCVisual@@_K1@Z @ 0x180012CB0 (-_Change_array@-$vector@PEBVCVisual@@V-$allocator@PEBVCVisual@@@std@@@std@@AEAAXQEAPEBVCVisual@@.c)
 *     ??$_Allocate@$0BA@U_Default_allocate_traits@std@@$0A@@std@@YAPEAX_K@Z @ 0x1800B6F20 (--$_Allocate@$0BA@U_Default_allocate_traits@std@@$0A@@std@@YAPEAX_K@Z.c)
 *     ??$_Get_size_of_n@$07@std@@YA_K_K@Z @ 0x1800B7030 (--$_Get_size_of_n@$07@std@@YA_K_K@Z.c)
 *     memmove_0 @ 0x18010518B (memmove_0.c)
 */

char *__fastcall std::vector<CVisual const *>::_Emplace_reallocate<CVisual const *>(__int64 *a1, _BYTE *a2, _QWORD *a3)
{
  _BYTE *v3; // rbp
  __int64 v6; // rax
  __int64 v8; // r15
  ...
  *(_QWORD *)v12 = *a3;
  ...
  std::vector<CVisual const *>::_Change_array(a1, (__int64)v11, v8, v9);
