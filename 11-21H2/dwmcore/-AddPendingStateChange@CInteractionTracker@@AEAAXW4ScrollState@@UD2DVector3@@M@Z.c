/*
 * XREFs of ?AddPendingStateChange@CInteractionTracker@@AEAAXW4ScrollState@@UD2DVector3@@M@Z @ 0x180218F78
 * Callers:
 ...
 *     ?ProcessDwmRestartCompleted@CInteractionTracker@@QEAAJPEAVCResourceTable@@PEBUtagMILCMD_INTERACTIONTRACKER_DWMRESTARTCOMPLETED@@@Z @ 0x18021BB0C (-ProcessDwmRestartCompleted@CInteractionTracker@@QEAAJPEAVCResourceTable@@PEBUtagMILCMD_INTERACT.c)
...
void __fastcall CInteractionTracker::AddPendingStateChange(__int64 a1, int a2, __int64 *a3, float a4)
{
  ...
  v4 = a1;
  if ( !*(_DWORD *)(a1 + 504)
    || (a1 = 3LL * (unsigned int)(*(_DWORD *)(a1 + 504) - 1), *(_DWORD *)(*(_QWORD *)(v4 + 480) + 8 * a1) != a2) )
  {
    v5 = *a3;
    HIDWORD(v12) = *((_DWORD *)a3 + 2);
    v6 = *(unsigned int *)(v4 + 504);
    LODWORD(v12) = a2;
    *(float *)&v13 = a4;
    *(_QWORD *)((char *)&v12 + 4) = v5;
    ...
    else if ( v7 > *(_DWORD *)(v4 + 500) )
    {
      v10 = DynArrayImpl<0>::AddMultipleAndSet(v4 + 480, 0x18u, 1, &v12);
      if ( v10 < 0 )
