/*
 * XREFs of ?UpdateMmcssPartners@CComposition@@QEAAJXZ @ 0x18003D4B4
 * Callers:
...
__int64 __fastcall CComposition::UpdateMmcssPartners(CRenderTargetManager **this)
{
  ...
  if ( *((_DWORD *)this + 276) == 6 )
  {
    ...
    if ( v19 )
    {
      v13 = (*(__int64 (__fastcall **)(__int64))(*(_QWORD *)v19 + 152LL))(v19);
  ...
  v4 = v2;
  if ( v2 < 0 )
    MilInstrumentationCheckHR_MaybeFailFast(v3, 0LL, 0, v2, 0x2C4u, 0LL);
  ...
  if ( !v4 || v4 >= 0 && v7 < 0 )
    v4 = v7;
  v8 = (*(__int64 (__fastcall **)(CRenderTargetManager *))(*(_QWORD *)this[28] + 32LL))(this[28]);
  v10 = v8;
  if ( v8 < 0 )
