/*
 * XREFs of ?Push@?$CWatermarkStack@UD2D_VECTOR_2F@@$01$01$09@@QEAAJAEBUD2D_VECTOR_2F@@@Z @ 0x1800CFD50
 * Callers:
...
__int64 __fastcall CWatermarkStack<D2D_VECTOR_2F,2,2,10>::Push(unsigned int *a1, _QWORD *a2)
{
  ...
  if ( (unsigned int)v9 <= 2 )
    LODWORD(v9) = 2;
  v10 = HrMalloc(8uLL, (unsigned int)v9, &v14);
  v7 = v10;
  if ( v10 < 0 )
  {
