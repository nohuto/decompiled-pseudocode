/*
 * XREFs of ?TryGetShape@CCursorState@@AEAA?AV?$shared_ptr@UShapeData@CCursorState@@@std@@IW4DXGI_MODE_ROTATION@@_N@Z @ 0x18026B2D4
 * Callers:
        ...
        char a5)
{
  ...
  *(_OWORD *)v19 = 0LL;
  ...
  if ( *((_BYTE *)v19[0] + 17) != a5 )
  {
    ...
    v13 = *std::shared_ptr<CCursorState::ShapeData>::operator=(v19, v12);
    if ( v21 )
  ...
  if ( *((_DWORD *)v11 + 2) != a4 )
  {
    ...
    v15 = *std::shared_ptr<CCursorState::ShapeData>::operator=(v19, v14);
    if ( v21 )
      std::_Ref_count_base::_Decref(v21);
    if ( !v15 )
      goto LABEL_19;
...
LABEL_23:
  ...
  v17 = *std::shared_ptr<CCursorState::ShapeData>::operator=(v19, v16);
  if ( v21 )
    std::_Ref_count_base::_Decref(v21);
  if ( v17 )
  {
