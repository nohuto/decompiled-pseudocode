/*
 * XREFs of ?UpdateParticles@CParticleEmitterVisual@@IEAAXM@Z @ 0x180230B08
 * Callers:
...
void __fastcall CParticleEmitterVisual::UpdateParticles(CParticleEmitterVisual *this, float a2)
{
  ...
  v8 = *((_QWORD *)this + 118);
  v9 = a2 * *((float *)this + 198);
  v10 = 0;
  v11 = a2 * *((float *)this + 199);
  v12 = a2 * *((float *)this + 200);
  v13 = 0xAAAAAAAAAAAAAAABuLL * ((*((_QWORD *)this + 119) - v8) >> 2);
  if ( v13 )
  {
    v14 = 0LL;
    do
    {
      ...
      *(float *)(v8 + 4 * v15 + 8) = v17;
      v37 = *(_QWORD *)((char *)this + 772);
      v18 = *((_QWORD *)this + 118);
      v19 = (float)(1.0 - (float)(*((float *)&v37 + 1) * a2)) * *(float *)(v18 + 12 * v14 + 4);
      v20 = (float)(1.0 - (float)(*((float *)this + 195) * a2)) * *(float *)(v18 + 12 * v14 + 8);
      *(float *)(v18 + 4 * v15) = (float)(1.0 - (float)(*(float *)&v37 * a2)) * *(float *)(v18 + 12 * v14);
      *(float *)(v18 + 4 * v15 + 4) = v19;
      *(float *)(v18 + 4 * v15 + 8) = v20;
      v8 = *((_QWORD *)this + 118);
      ++v10;
      *(float *)(*((_QWORD *)this + 124) + 4 * v14) = o_sqrtf_0(
  ...
  v21 = 0;
  v22 = 0xAAAAAAAAAAAAAAABuLL * ((*((_QWORD *)this + 119) - v8) >> 2);
  if ( v22 )
  {
    v23 = 0LL;
    do
    ...
    {
      v33 = *((_QWORD *)this + 121);
      v34 = (float)(a2 * *((float *)this + 197)) + *(float *)(v33 + 4 * v4);
      *(float *)(v33 + 4 * v4) = v34;
      v35 = (float)(1.0 - (float)(a2 * *((float *)this + 196))) * v34;
      *(float *)(v33 + 4 * v4) = v35;
      v36 = 2 * v4;
      *(float *)(*((_QWORD *)this + 115) + 8 * v36 + 12) = (float)(v35 * a2)
                                                         + *(float *)(*((_QWORD *)this + 115) + 8 * v36 + 12);
      ++i;
      *(float *)(*((_QWORD *)this + 115) + 8 * v36 + 12) = _o_remainderf();
    }
  }
}
