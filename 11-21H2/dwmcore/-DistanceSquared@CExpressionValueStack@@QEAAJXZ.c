/*
 * XREFs of ?DistanceSquared@CExpressionValueStack@@QEAAJXZ @ 0x18024ABC4
 * Callers:
...
__int64 __fastcall CExpressionValueStack::DistanceSquared(__int64 this)
{
  ...
  if ( *(_DWORD *)(this + 16) >= 2u )
  {
    ...
    if ( v11 == v4[4].m128i_i32[2] )
    {
      ...
      {
        case 18:
          v18 = (float)(*(float *)v7->m128i_i32 - *(float *)v4->m128i_i32)
              * (float)(*(float *)v7->m128i_i32 - *(float *)v4->m128i_i32);
          break;
        case 35:
          v18 = (float)((float)(*(float *)&v7->m128i_i32[1] - *(float *)&v4->m128i_i32[1])
                      * (float)(*(float *)&v7->m128i_i32[1] - *(float *)&v4->m128i_i32[1]))
              + (float)((float)(*(float *)v7->m128i_i32 - *(float *)v4->m128i_i32)
                      * (float)(*(float *)v7->m128i_i32 - *(float *)v4->m128i_i32));
          break;
        case 52:
          v18 = (float)((float)((float)(COERCE_FLOAT(HIDWORD(v7->m128i_i64[0])) - COERCE_FLOAT(HIDWORD(v4->m128i_i64[0])))
              ...
              + (float)((float)(*(float *)&v7->m128i_i32[2] - *(float *)&v4->m128i_i32[2])
                      * (float)(*(float *)&v7->m128i_i32[2] - *(float *)&v4->m128i_i32[2]));
          break;
        case 69:
          ...
          v16 = _mm_shuffle_ps(v12, v12, 85).m128_f32[0] - _mm_shuffle_ps(v13, v13, 85).m128_f32[0];
          ...
          v18 = (float)((float)((float)(v16 * v16) + (float)(v14 * v14))
