/*
 * XREFs of ?GdiSpriteBitmapSetSurface@CChannel@@UEAAJIPEAUHLSURF__@@@Z @ 0x1800EC830
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall CChannel::GdiSpriteBitmapSetSurface(CDataStreamWriter **this, unsigned int a2, HLSURF a3)
{
  unsigned int v6; // ebx
  _DWORD v8[2]; // [rsp+20h] [rbp-18h] BYREF
  HLSURF v9; // [rsp+28h] [rbp-10h]
