/*
 * XREFs of ?EnsureInteropRenderTarget@CHolographicManager@@AEAAJXZ @ 0x180295D68
 * Callers:
...
__int64 __fastcall CHolographicManager::EnsureInteropRenderTarget(struct CComposition **this)
{
  ...
  {
    v2 = -2147467259;
    MilInstrumentationCheckHR_MaybeFailFast((__int64)this, 0LL, 0LL, -2147467259, 0x3DCu);
  }
  else
  {
    v4 = this + 4;
    if ( !this[4] )
    {
      ...
      if ( v5 < 0 )
      {
        MilInstrumentationCheckHR_MaybeFailFast(v6, 0LL, 0LL, v5, 0x3E1u);
      }
      else
      {
