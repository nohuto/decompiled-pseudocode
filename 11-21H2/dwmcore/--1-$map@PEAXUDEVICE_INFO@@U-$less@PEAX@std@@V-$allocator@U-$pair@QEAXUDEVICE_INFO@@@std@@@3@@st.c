/*
 * XREFs of ??1?$map@PEAXUDEVICE_INFO@@U?$less@PEAX@std@@V?$allocator@U?$pair@QEAXUDEVICE_INFO@@@std@@@3@@std@@QEAA@XZ @ 0x180100298
 * Callers:
 *     _dynamic_atexit_destructor_for__CPointerDeviceCache::s_deviceCache__ @ 0x18010D7B0 (_dynamic_atexit_destructor_for__CPointerDeviceCache--s_deviceCache__.c)
 * Callees:
