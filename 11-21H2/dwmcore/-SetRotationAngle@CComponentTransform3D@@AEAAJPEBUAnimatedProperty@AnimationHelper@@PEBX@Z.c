/*
 * XREFs of ?SetRotationAngle@CComponentTransform3D@@AEAAJPEBUAnimatedProperty@AnimationHelper@@PEBX@Z @ 0x1800EC6B0
 * Callers:
 *     <none>
 * Callees:
        ...
        _DWORD *a3)
{
  ...
  if ( *((float *)this + 58) != *(float *)a3 )
  {
    *((_DWORD *)this + 58) = *a3;
    ...
    v3 = v6;
    if ( v6 < 0 )
      MilInstrumentationCheckHR_MaybeFailFast(v7, 0LL, 0LL, v6, 0x166u);
  }
  return v3;
}
