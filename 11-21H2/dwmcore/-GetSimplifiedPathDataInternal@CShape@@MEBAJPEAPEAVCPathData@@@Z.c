/*
 * XREFs of ?GetSimplifiedPathDataInternal@CShape@@MEBAJPEAPEAVCPathData@@@Z @ 0x1801909C0
 * Callers:
 *     <none>
 * Callees:
...
LABEL_15:
    MilInstrumentationCheckHR_MaybeFailFast(v7, 0LL, 0LL, v6, v18);
    goto LABEL_16;
  }
  v8 = -2147024882;
  MilInstrumentationCheckHR_MaybeFailFast(v13, 0LL, 0LL, -2147024882, 0x471u);
LABEL_16:
  Microsoft::WRL::ComPtr<IUnknown>::InternalRelease((__int64 *)&v22);
