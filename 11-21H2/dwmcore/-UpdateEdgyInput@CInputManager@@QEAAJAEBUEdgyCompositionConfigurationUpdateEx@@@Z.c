/*
 * XREFs of ?UpdateEdgyInput@CInputManager@@QEAAJAEBUEdgyCompositionConfigurationUpdateEx@@@Z @ 0x180181064
 * Callers:
        ...
        unsigned __int64 a3)
{
  ...
  {
    MilInstrumentationCheckHR_MaybeFailFast(v6, 0LL, 0LL, CanSendInputThreadMessages, 0xCAu);
  }
  else
  {
    ...
    v7 = v8;
    if ( v8 < 0 )
      MilInstrumentationCheckHR_MaybeFailFast(v9, 0LL, 0LL, v8, 0xD0u);
  }
  return v7;
}
