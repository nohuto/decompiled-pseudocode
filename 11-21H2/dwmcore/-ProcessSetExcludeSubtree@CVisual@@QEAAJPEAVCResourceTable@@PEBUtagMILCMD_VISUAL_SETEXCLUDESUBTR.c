/*
 * XREFs of ?ProcessSetExcludeSubtree@CVisual@@QEAAJPEAVCResourceTable@@PEBUtagMILCMD_VISUAL_SETEXCLUDESUBTREE@@@Z @ 0x1800EE3D0
 * Callers:
        ...
        const struct tagMILCMD_VISUAL_SETEXCLUDESUBTREE *a3)
{
  ...
  v3 = *((_BYTE *)a3 + 8) != 0;
  v4 = (*((_BYTE *)this + 102) & 4) != 0;
  *((_BYTE *)this + 102) = *((_BYTE *)this + 102) & 0xFB | (4 * v3);
  if ( v4 != v3 )
