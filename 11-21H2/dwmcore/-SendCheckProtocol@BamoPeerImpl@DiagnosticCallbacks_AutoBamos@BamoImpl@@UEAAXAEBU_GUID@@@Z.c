/*
 * XREFs of ?SendCheckProtocol@BamoPeerImpl@DiagnosticCallbacks_AutoBamos@BamoImpl@@UEAAXAEBU_GUID@@@Z @ 0x180197CC0
 * Callers:
 *     <none>
 * Callees:
        ...
        const struct _GUID *a2)
{
  ...
  v8 = v2;
  v5 = CoreUICallSend(v4, v7, 2LL, 1LL, 0, &unk_180345865);
  if ( v5 < 0 )
