/*
 * XREFs of ?UpdateFrameStatistics@CTelemetryFrameStatistics@@QEAAX_K00II_N@Z @ 0x18007B808
 * Callers:
        ...
        bool a7)
{
  ...
  {
    if ( !*((_QWORD *)this + 1)
      || ((v10 = a2 - *((_QWORD *)this + 1), (__int64)(a2 - *((_QWORD *)this + 1)) < 0)
        ? (v12 = v10 & 1 | ((a2 - *((_QWORD *)this + 1)) >> 1), v11 = (double)(int)v12 + (double)(int)v12)
        : (v11 = (double)(int)v10),
          v11 / ((double)(int)g_qpcFrequency.LowPart / 1000.0) > 600000.0) )
    {
