/*
 * XREFs of ?ProcessStartPointUpdate@CInk@@QEAAJPEAVCResourceTable@@PEBUtagMILCMD_INK_STARTPOINTUPDATE@@@Z @ 0x1802182BC
 * Callers:
        ...
        const struct tagMILCMD_INK_STARTPOINTUPDATE *a3)
{
  ...
  *((_DWORD *)this + 41) = *((_DWORD *)a3 + 3);
  ...
  if ( (_DWORD)v9 )
  {
    ...
    MilInstrumentationCheckHR_MaybeFailFast(v11, 0LL, 0LL, ID2D1InkAndInkStyle, 0x6Au);
    v3 = v14;
    v5 = v13;
  }
  else
