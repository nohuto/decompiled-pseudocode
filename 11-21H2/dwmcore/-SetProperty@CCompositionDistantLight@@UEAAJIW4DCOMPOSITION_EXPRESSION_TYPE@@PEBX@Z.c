/*
 * XREFs of ?SetProperty@CCompositionDistantLight@@UEAAJIW4DCOMPOSITION_EXPRESSION_TYPE@@PEBX@Z @ 0x18020C950
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall CCompositionDistantLight::SetProperty(__int64 a1, int a2, int a3)
{
  ...
  if ( AnimatablePropertyInfo )
  {
    ...
    v9 = v7;
    if ( v7 < 0 )
      MilInstrumentationCheckHR_MaybeFailFast(v8, 0LL, 0LL, v7, 0x8Bu);
  }
  else
  {
    v9 = -2147024809;
    MilInstrumentationCheckHR_MaybeFailFast(v5, 0LL, 0LL, -2147024809, 0x8Fu);
  }
  return v9;
}
