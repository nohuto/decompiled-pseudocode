/*
 * XREFs of ?CreateNewGenerator@CPrimitiveGroup@@AEAAJPEAPEAVCPrimitiveGroupDrawListGenerator@@@Z @ 0x18000C41C
 * Callers:
        ...
        struct CPrimitiveGroupDrawListGenerator **a2)
{
  ...
  *a2 = 0LL;
  ...
  if ( v9 < 0 )
  {
    MilInstrumentationCheckHR_MaybeFailFast(v10, 0LL, 0, v9, 0x2A1u, 0LL);
    goto LABEL_23;
  }
  ...
  if ( v13 < 0 )
  {
    MilInstrumentationCheckHR_MaybeFailFast(v14, 0LL, 0, v13, 0x2A7u, 0LL);
    goto LABEL_45;
  }
  v15 = *((_DWORD *)this + 40);
  ...
  *((_DWORD *)this + 104) = v21;
  ...
  if ( v22 < 0 )
  {
    MilInstrumentationCheckHR_MaybeFailFast(v23, 0LL, 0, v22, 0x2AEu, 0LL);
    goto LABEL_45;
  }
  ...
  *((_DWORD *)this + 72) = *((_DWORD *)this + 102) + *((_DWORD *)this + 103);
  ...
  if ( v25 < 0 )
  {
    MilInstrumentationCheckHR_MaybeFailFast(v26, 0LL, 0, v25, 0x2B1u, 0LL);
LABEL_45:
    v2 = v44;
    goto LABEL_23;
  }
  ...
  if ( v36 < 0 )
  {
    MilInstrumentationCheckHR_MaybeFailFast(v37, 0LL, 0, v36, 0x2E0u, 0LL);
    v7 = v45;
  }
  else
  {
