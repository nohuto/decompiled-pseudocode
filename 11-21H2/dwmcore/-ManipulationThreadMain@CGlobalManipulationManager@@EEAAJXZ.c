/*
 * XREFs of ?ManipulationThreadMain@CGlobalManipulationManager@@EEAAJXZ @ 0x18002E280
 * Callers:
 *     <none>
 * Callees:
 ...
 *     IsRegisterManipulationThreadPresent @ 0x180101F04 (IsRegisterManipulationThreadPresent.c)
