/*
 * XREFs of ?RequestDisposeProxy@BamoPrincipalImpl@BamoImpl@Microsoft@@AEAAXPEAVBaseBamoPeerImpl@23@PEAVBamoStubImpl@23@@Z @ 0x180197A4C
 * Callers:
        ...
        struct Microsoft::BamoImpl::BamoStubImpl *a3)
{
  ...
  if ( *((int *)a3 + 4) <= 0 )
  {
    ...
    v4 = *(_QWORD *)a3;
    *((_BYTE *)a3 + 32) = 0;
    (*(void (__fastcall **)(struct Microsoft::BamoImpl::BamoStubImpl *))(v4 + 56))(a3);
  }
}
