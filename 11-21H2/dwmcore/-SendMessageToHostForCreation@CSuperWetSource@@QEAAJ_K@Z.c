/*
 * XREFs of ?SendMessageToHostForCreation@CSuperWetSource@@QEAAJ_K@Z @ 0x180216AC0
 * Callers:
...
LABEL_3:
  ...
  *((_QWORD *)&v11 + 1) = a2;
  ...
  v8 = v7[3];
  v14[1] = *(_OWORD *)(v7[2] + 88LL);
  v12.m256i_i32[2] = *(_DWORD *)(v8 + 8);
  v12.m256i_i32[7] = *((_DWORD *)this + 32);
  *(_OWORD *)((char *)&v12.m256i_u64[1] + 4) = *(_OWORD *)(*((_QWORD *)this + 13) + 88LL);
  ...
  if ( (Microsoft_Windows_Dwm_CoreEnableBits & 0x200000) != 0 )
    McTemplateU0px_EventWriteTransfer(v10, &EVTDESC_REGISTER_VAIL_STROKE_ON_HOST, this, a2);
  return 0LL;
}
