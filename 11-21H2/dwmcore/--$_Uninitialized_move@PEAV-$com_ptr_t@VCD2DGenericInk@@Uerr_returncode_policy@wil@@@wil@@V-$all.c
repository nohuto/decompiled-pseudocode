...
volatile signed __int32 **__fastcall std::_Uninitialized_move<wil::com_ptr_t<CD2DGenericInk,wil::err_returncode_policy> *,std::allocator<wil::com_ptr_t<CD2DGenericInk,wil::err_returncode_policy>>>(
        ...
        volatile signed __int32 **a3)
{
  ...
  std::_Destroy_range<std::allocator<wil::com_ptr_t<CD2DGenericInk,wil::err_returncode_policy>>>(a3, a3);
  return a3;
}
