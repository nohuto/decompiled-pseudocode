/*
 * XREFs of ?VisualSetTransform@CChannel@@UEAAJII@Z @ 0x1800FFC20
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall CChannel::VisualSetTransform(CDataStreamWriter **this, unsigned int a2, int a3)
{
  unsigned int v6; // ebx
