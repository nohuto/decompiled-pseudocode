/*
 * XREFs of ?Create@CRedirectedGDISurface@@SAHPEAUHLSURF__@@PEAVCGdiSpriteBitmap@@PEAVCLegacySurfaceManager@@PEAPEAV1@@Z @ 0x1800E59F0
 * Callers:
        ...
        struct CRedirectedGDISurface **a4)
{
  ...
  *((_QWORD *)v8 + 4) = a2;
  ...
  if ( NewElement < 0 )
  {
    MilInstrumentationCheckHR_MaybeFailFast(v14, 0LL, 0LL, NewElement, 0x1Au);
