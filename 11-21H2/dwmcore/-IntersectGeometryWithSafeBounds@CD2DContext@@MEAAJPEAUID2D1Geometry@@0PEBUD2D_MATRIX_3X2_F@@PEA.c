/*
 * XREFs of ?IntersectGeometryWithSafeBounds@CD2DContext@@MEAAJPEAUID2D1Geometry@@0PEBUD2D_MATRIX_3X2_F@@PEAV?$TMilRect_@MUMilRectF@@UMil3DRectF@@UMilPointAndSizeF@@UNotNeeded@RectUniqueness@@@@PEAPEAU2@@Z @ 0x180278DC0
 * Callers:
 *     <none>
 * Callees:
        ...
        _QWORD *a6)
{
  ...
  *a6 = 0LL;
  ...
  if ( v10 < 0 )
  {
    MilInstrumentationCheckHR_MaybeFailFast(v11, 0LL, 0LL, v10, 0x558u);
  }
  else
  {
    ...
    if ( v13 < 0 )
    {
      MilInstrumentationCheckHR_MaybeFailFast(v14, 0LL, 0LL, v13, 0x559u);
    }
    else
    {
      ...
      if ( v15 < 0 )
      {
        MilInstrumentationCheckHR_MaybeFailFast(v16, 0LL, 0LL, v15, 0x55Au);
      }
      else
      {
        ...
        if ( v17 < 0 )
        {
          MilInstrumentationCheckHR_MaybeFailFast(v18, 0LL, 0LL, v17, 0x55Bu);
        }
        else
        {
          ...
          if ( v19 < 0 )
          {
            MilInstrumentationCheckHR_MaybeFailFast(v20, 0LL, 0LL, v19, 0x563u);
          }
          else
          {
            ...
            if ( v21 < 0 )
            {
              MilInstrumentationCheckHR_MaybeFailFast(v22, 0LL, 0LL, v21, 0x565u);
            }
            else
            {
              ...
              if ( v23 < 0 )
              {
                MilInstrumentationCheckHR_MaybeFailFast(v24, 0LL, 0LL, v23, 0x56Au);
              }
              else
              {
                ...
                if ( X <= *(float *)&v43 )
                {
                  if ( COERCE_FLOAT(LODWORD(X) & _xmm) < 8388608.0 )
                    v25 = (__m128)COERCE_UNSIGNED_INT((float)(int)floorf(X));
                  v27 = (__m128)LODWORD(v42);
                  if ( COERCE_FLOAT(LODWORD(v42) & _xmm) < 8388608.0 )
                    v27 = (__m128)COERCE_UNSIGNED_INT((float)(int)floorf(v42));
                  if ( COERCE_FLOAT(LODWORD(v26) & _xmm) < 8388608.0 )
                    v26 = (float)(int)o_ceilf_0(v26);
                  v28 = v44;
                  if ( COERCE_FLOAT(LODWORD(v44) & _xmm) < 8388608.0 )
                    v28 = (float)(int)o_ceilf_0(v44);
                  if ( a5 )
                  {
                  ...
                  *(float *)&v43 = v26 + 1.0;
                  ...
                  if ( v29 < 0 )
                  {
                    MilInstrumentationCheckHR_MaybeFailFast(v30, 0LL, 0LL, v29, 0x598u);
                  }
                  else
                  {
                    v40[0] = v36;
                    ...
                    if ( v31 < 0 )
                    {
                      MilInstrumentationCheckHR_MaybeFailFast(v32, 0LL, 0LL, v31, 0x5A2u);
                    }
                    else
                    {
                      v33 = v39;
