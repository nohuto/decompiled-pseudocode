/*
 * XREFs of ?ProcessSetDesktopTree@CRemoteRenderTarget@@QEAAJPEAVCResourceTable@@PEBUtagMILCMD_REMOTERENDERTARGET_SETDESKTOPTREE@@@Z @ 0x1800FFD50
 * Callers:
        ...
        const struct tagMILCMD_REMOTERENDERTARGET_SETDESKTOPTREE *a3)
{
  ...
  {
    v4 = -2003303421;
    MilInstrumentationCheckHR_MaybeFailFast(v8, 0LL, 0LL, -2003303421, 0x28u);
  }
  else
  {
