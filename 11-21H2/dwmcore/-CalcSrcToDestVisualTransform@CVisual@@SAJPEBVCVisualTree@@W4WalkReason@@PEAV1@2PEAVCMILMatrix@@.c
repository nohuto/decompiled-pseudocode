/*
 * XREFs of ?CalcSrcToDestVisualTransform@CVisual@@SAJPEBVCVisualTree@@W4WalkReason@@PEAV1@2PEAVCMILMatrix@@@Z @ 0x18023610C
 * Callers:
...
__int64 __fastcall CVisual::CalcSrcToDestVisualTransform(
        ...
        __int64 a5)
{
  unsigned __int64 v6[2]; // [rsp+30h] [rbp-28h] BYREF
  unsigned __int64 v7[3]; // [rsp+40h] [rbp-18h] BYREF
  __int64 v8; // [rsp+70h] [rbp+18h] BYREF

  v8 = a3;
  v6[1] = (unsigned __int64)&a5;
  v6[0] = 1LL;
  v7[1] = (unsigned __int64)&v8;
  v7[0] = 1LL;
  return CVisual::CalcSrcToDestVisualTransform(a1, 1LL, v7, a4, v6);
}
