/*
 * XREFs of ?SetOrientation@?$CParticleBehaviorsGeneratedT@VCParticleBehaviors@@VCPropertyChangeResource@@@@QEAAJPEAVCParticleVector4Behavior@@@Z @ 0x1801A4234
 * Callers:
        ...
        struct CResource *a2)
{
  ...
  if ( a2 != this[14] )
  {
    ...
    if ( v5 < 0 )
    {
      MilInstrumentationCheckHR_MaybeFailFast(v6, 0LL, 0LL, v5, 0x322u);
    }
    else
    {
