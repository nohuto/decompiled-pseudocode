/*
 * XREFs of ?QueueMidManipulationUpdate@CManipulationManager@@IEAAJW4MidManipulationUpdateType@@PEAVCVisual@@@Z @ 0x18017E7E8
 * Callers:
...
__int64 __fastcall CManipulationManager::QueueMidManipulationUpdate(__int64 a1, unsigned int a2, __int64 a3)
{
  ...
  {
    v7 = -2147024809;
    MilInstrumentationCheckHR_MaybeFailFast(a1, 0LL, 0LL, -2147024809, 0x1FFu);
    return v7;
  }
  switch ( a2 )
  {
...
LABEL_35:
      ...
      if ( v21 )
      {
        ...
        *(_QWORD *)(v23 + 32) = 0LL;
        ...
        if ( v26 < 0 )
        {
          MilInstrumentationCheckHR_MaybeFailFast(v27, 0LL, 0LL, v26, 0x273u);
      ...
      {
        v7 = -2147024882;
        MilInstrumentationCheckHR_MaybeFailFast(v22, 0LL, 0LL, -2147024882, 0x25Fu);
      }
      return v7;
  }
  v8 = a2 - 3;
  if ( a2 != 3 )
  {
    if ( a2 == 4 && (Microsoft_Windows_Dwm_CoreEnableBits & 0x8000) != 0 )
    {
