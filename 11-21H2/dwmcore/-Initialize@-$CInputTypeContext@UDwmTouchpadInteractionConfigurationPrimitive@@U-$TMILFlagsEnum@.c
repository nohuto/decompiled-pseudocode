/*
 * XREFs of ?Initialize@?$CInputTypeContext@UDwmTouchpadInteractionConfigurationPrimitive@@U?$TMILFlagsEnum@W4FlagsEnum@DwmInteractionTypeTouchpadPrimitiveType@@@@W4FlagsEnum@DwmInteractionTypeTouchpadPrimitiveType@@@@QEAAJPEAUIInteractionContextWrapper@@_N@Z @ 0x18002C4AC
 * Callers:
        ...
        char a3)
{
  ...
  *(_BYTE *)(a1 + 149) |= a3;
  ...
  v7[1] = 0;
  v7[2] = 0;
  v5 = DynArray<DwmTouchpadInteractionConfigurationPrimitive,0>::AddMultipleAndSet(a1 + 88, v7, 1LL);
  if ( v5 < 0 )
