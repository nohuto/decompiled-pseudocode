/*
 * XREFs of ?MagnifierRenderTargetSetColorTransform@CChannel@@UEAAJII@Z @ 0x1801AB180
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall CChannel::MagnifierRenderTargetSetColorTransform(CDataStreamWriter **this, unsigned int a2, int a3)
{
  unsigned int v6; // ebx
