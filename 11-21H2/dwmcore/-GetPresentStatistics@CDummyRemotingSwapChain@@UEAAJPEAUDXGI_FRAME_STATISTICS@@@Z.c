/*
 * XREFs of ?GetPresentStatistics@CDummyRemotingSwapChain@@UEAAJPEAUDXGI_FRAME_STATISTICS@@@Z @ 0x180289820
 * Callers:
 *     <none>
 * Callees:
        ...
        struct DXGI_FRAME_STATISTICS *a2)
{
  ...
  {
    MilInstrumentationCheckHR_MaybeFailFast(v4, 0LL, 0LL, PresentStatisticsDWM, 0x9Du);
  }
  else
  {
    v6 = v8[0];
