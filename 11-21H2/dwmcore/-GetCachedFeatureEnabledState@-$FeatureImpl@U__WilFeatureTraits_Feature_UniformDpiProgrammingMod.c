/*
 * XREFs of ?GetCachedFeatureEnabledState@?$FeatureImpl@U__WilFeatureTraits_Feature_UniformDpiProgrammingModel@@@details@wil@@AEAA?ATwil_details_FeatureStateCache@@XZ @ 0x18001EBE8
 * Callers:
 ...
 *     ?GetCurrentFeatureEnabledState@?$FeatureImpl@U__WilFeatureTraits_Feature_UniformDpiProgrammingModel@@@details@wil@@AEAA?ATwil_details_FeatureStateCache@@PEAH@Z @ 0x18002A168 (-GetCurrentFeatureEnabledState@-$FeatureImpl@U__WilFeatureTraits_Feature_UniformDpiProgrammingMo.c)
 */
      ...
      if ( !v6
        ...
        || (v12 = 0,
            ...
            !wil::details_abi::heap_buffer::push_back(
               (wil::details_abi::heap_buffer *)&xmmword_1803D3578,
               &v12,
               0x10uLL)) )
      {
