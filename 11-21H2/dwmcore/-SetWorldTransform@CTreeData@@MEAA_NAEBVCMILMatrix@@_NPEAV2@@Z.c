/*
 * XREFs of ?SetWorldTransform@CTreeData@@MEAA_NAEBVCMILMatrix@@_NPEAV2@@Z @ 0x18008EA70
 * Callers:
 *     <none>
 * Callees:
        ...
        struct CMILMatrix *a4)
{
  ...
  v6 = 0;
  v7 = *(_QWORD *)(*(_QWORD *)(*((_QWORD *)this + 36) + 16LL) + 496LL);
  if ( !(unsigned __int8)CMILMatrix::IsEqualTo<0>((char *)this + 312, a2) )
  {
    v6 = 1;
    *(_OWORD *)v9 = *(_OWORD *)v8;
  ...
  *((_BYTE *)this + 11) = v10;
  if ( a4 )
  {
    ...
    else
    {
      ...
      if ( _InterlockedCompareExchange64((volatile signed __int64 *)this + 37, (signed __int64)v16, 0LL) )
        operator delete(v16, 0x44uLL);
    }
  }
  if ( v6 || (v12 = *((_QWORD *)this + 34)) == 0 )
  {
    *((_QWORD *)this + 34) = v7;
    v12 = v7;
  }
