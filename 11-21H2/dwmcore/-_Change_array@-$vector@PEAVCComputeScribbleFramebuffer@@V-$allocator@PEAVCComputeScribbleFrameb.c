/*
 * XREFs of ?_Change_array@?$vector@PEAVCComputeScribbleFramebuffer@@V?$allocator@PEAVCComputeScribbleFramebuffer@@@std@@@std@@AEAAXQEAPEAVCComputeScribbleFramebuffer@@_K1@Z @ 0x1801EACA4
 * Callers:
