/*
 * XREFs of ?PartitionSetCursor@CChannel@@UEAAJI_N@Z @ 0x1800FFCC0
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall CChannel::PartitionSetCursor(CDataStreamWriter **this, unsigned int a2, unsigned __int8 a3)
{
  unsigned int v6; // ebx
