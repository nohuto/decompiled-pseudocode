/*
 * XREFs of ?CaptureControllerSetTransform@CChannel@@UEAAJII@Z @ 0x1801AA420
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall CChannel::CaptureControllerSetTransform(CDataStreamWriter **this, unsigned int a2, int a3)
{
  unsigned int v6; // ebx
