/*
 * XREFs of ?Update@BulkAnimator@Particles@@SAXPEBVITwoInputAnimator@2@UParticleStreamInfo@2@11I@Z @ 0x18022B038
 * Callers:
...
__int64 __fastcall Particles::BulkAnimator::Update(__int64 a1, __int64 a2, __int64 *a3, __int64 *a4, unsigned int a5)
{
  ...
  if ( a5 )
  {
    ...
    do
    {
      ...
      if ( v19[0] == -1LL
        || !v15 && v19[0]
        || (v17 = *(_QWORD *)a2 + 4 * (*(unsigned int *)(a2 + 8) + (unsigned __int64)(v12 * *(_DWORD *)(a2 + 12))),
