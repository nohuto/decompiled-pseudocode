/*
 * XREFs of ?MeshGeometry2DSetConstantOpacity@CChannel@@UEAAJIH@Z @ 0x1801AB5D0
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall CChannel::MeshGeometry2DSetConstantOpacity(CDataStreamWriter **this, unsigned int a2, int a3)
{
  unsigned int v6; // ebx
