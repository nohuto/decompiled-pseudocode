/*
 * XREFs of ??$_Emplace_reallocate@AEBQEAVIDeviceResourceNotify@@@?$vector@PEAVIDeviceResourceNotify@@V?$allocator@PEAVIDeviceResourceNotify@@@std@@@std@@QEAAPEAPEAVIDeviceResourceNotify@@QEAPEAV2@AEBQEAV2@@Z @ 0x1800D5CA8
 * Callers:
 ...
 *     ?AddResourceNotifier@CDeviceResource@@UEAAXPEAVIDeviceResourceNotify@@@Z @ 0x1800D5C6C (-AddResourceNotifier@CDeviceResource@@UEAAXPEAVIDeviceResourceNotify@@@Z.c)
 *     ?AddResourceNotifier@CRenderTargetBitmap@@UEAAXPEAVIDeviceResourceNotify@@@Z @ 0x1800E2724 (-AddResourceNotifier@CRenderTargetBitmap@@UEAAXPEAVIDeviceResourceNotify@@@Z.c)
 *     ?AddResourceNotifier@CD2DResource@@UEAAXPEAVIDeviceResourceNotify@@@Z @ 0x1800ECCF0 (-AddResourceNotifier@CD2DResource@@UEAAXPEAVIDeviceResourceNotify@@@Z.c)
 ...
 *     ?AddResourceNotifier@CD3DResource@@UEAAXPEAVIDeviceResourceNotify@@@Z @ 0x1802798C0 (-AddResourceNotifier@CD3DResource@@UEAAXPEAVIDeviceResourceNotify@@@Z.c)
 ...
 *     ?_Change_array@?$vector@PEAVIDeviceResourceNotify@@V?$allocator@PEAVIDeviceResourceNotify@@@std@@@std@@AEAAXQEAPEAVIDeviceResourceNotify@@_K1@Z @ 0x1800D5D94 (-_Change_array@-$vector@PEAVIDeviceResourceNotify@@V-$allocator@PEAVIDeviceResourceNotify@@@std@.c)
