/*
 * XREFs of ?Create@CRenderTargetBitmap@@SAJPEAVIDeviceTarget@@PEAPEAVIRenderTargetBitmap@@@Z @ 0x18006590C
 * Callers:
...
__int64 __fastcall CRenderTargetBitmap::Create(struct IDeviceTarget *a1, struct IRenderTargetBitmap **a2)
{
  ...
  *a2 = 0LL;
  ...
  if ( v5 && (v7 = CRenderTargetBitmap::CRenderTargetBitmap(v5, 0), (v8 = v7) != 0LL) )
  {
