/*
 * XREFs of ?ExpressionValueLerp@KeyframeInterpolation@@KAXW4DCOMPOSITION_EXPRESSION_TYPE@@MPEAVCExpressionValue@@11@Z @ 0x1800D6B1C
 * Callers:
    ...
    if ( v8 )
    {
      ...
      if ( v12 )
      {
        ...
        if ( v13 )
        {
          ...
          {
            v15 = (float)((float)(*(float *)a4 - *(float *)a3) * a2) + *(float *)a3;
            v16 = (float)((float)(*(float *)(a4 + 4) - *(float *)(a3 + 4)) * a2) + *(float *)(a3 + 4);
            v17 = (float)((float)(*(float *)(a4 + 8) - *(float *)(a3 + 8)) * a2) + *(float *)(a3 + 8);
            *(_DWORD *)(a5 + 72) = 52;
            *(float *)a5 = v15;
            *(float *)(a5 + 4) = v16;
            *(float *)(a5 + 8) = v17;
      ...
      v18 = (float)((float)(*(float *)(a4 + 4) - *(float *)(a3 + 4)) * a2) + *(float *)(a3 + 4);
...
LABEL_7:
  ...
  *(_BYTE *)(a5 + 76) = 1;
  ...
  Microsoft::WRL::ComPtr<ID2D1PathGeometry>::InternalRelease((__int64 *)&v50);
}
