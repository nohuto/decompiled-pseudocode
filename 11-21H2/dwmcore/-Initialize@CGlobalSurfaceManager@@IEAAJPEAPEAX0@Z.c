/*
 * XREFs of ?Initialize@CGlobalSurfaceManager@@IEAAJPEAPEAX0@Z @ 0x18002D910
 * Callers:
...
__int64 __fastcall CGlobalSurfaceManager::Initialize(CGlobalSurfaceManager *this, void **a2, void **a3)
{
  ...
  v20 = 0LL;
  v21 = 1;
  v10 = NtTokenManagerOpenSectionAndEvents(&v20, (char *)this + 112, &v23, &v26);
  if ( v21 )
...
LABEL_22:
  ...
  *((_QWORD *)this + 13) = v11;
  ...
  wil::details::unique_storage<wil::details::handle_null_resource_policy<int (*)(void *),&int CloseHandle(void *)>>::reset(
    (char *)this + 448,
    EventW);
  if ( ((*((_QWORD *)this + 56) + 1LL) & 0xFFFFFFFFFFFFFFFEuLL) == 0 )
  {
    v14 = -2147024882;
    dwNumberOfBytesToMap = 110;
    goto LABEL_15;
  }
