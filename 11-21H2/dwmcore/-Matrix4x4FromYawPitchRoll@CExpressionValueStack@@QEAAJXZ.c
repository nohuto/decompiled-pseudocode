/*
 * XREFs of ?Matrix4x4FromYawPitchRoll@CExpressionValueStack@@QEAAJXZ @ 0x18024E3F4
 * Callers:
...
__int64 __fastcall CExpressionValueStack::Matrix4x4FromYawPitchRoll(CExpressionValueStack *this)
{
  ...
  _BYTE v21[16]; // [rsp+38h] [rbp-19h] BYREF
  _OWORD v22[5]; // [rsp+48h] [rbp-9h] BYREF
  ...
  if ( *((_DWORD *)this + 4) >= 3u )
  {
    ...
    {
      v10 = CExpressionValue::CExpressionValue((CExpressionValue *)v22);
    ...
    if ( *((_DWORD *)v7 + 18) == 18 )
    {
      if ( *((_DWORD *)v11 + 18) == 18 )
      {
        if ( *((_DWORD *)v4 + 18) == 18 )
        {
          D3DXQuaternionRotationYawPitchRoll((struct D2DQuaternion *)v21, *v7, *v11, *v4);
          D2DMatrixRotationQuaternion((struct D2DMatrix *)v22, (const struct D2DQuaternion *)v21);
          v15 = v22[0];
          v16 = v22[1];
          *((_DWORD *)v7 + 18) = 265;
          *(_OWORD *)v7 = v15;
