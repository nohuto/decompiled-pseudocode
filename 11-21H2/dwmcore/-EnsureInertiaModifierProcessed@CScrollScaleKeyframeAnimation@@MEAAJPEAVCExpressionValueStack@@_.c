/*
 * XREFs of ?EnsureInertiaModifierProcessed@CScrollScaleKeyframeAnimation@@MEAAJPEAVCExpressionValueStack@@_K@Z @ 0x180255850
 * Callers:
 *     <none>
 * Callees:
...
LABEL_21:
    ...
    {
      if ( v18 == 18 )
        *((_DWORD *)this + 189) = v16[0] ^ _xmm;
    }
  }
  *(_QWORD *)(*((_QWORD *)this + 72) + 148LL) = *((_QWORD *)this + 94);
  Microsoft::WRL::ComPtr<ID2D1PathGeometry>::InternalRelease(&v17);
  Microsoft::WRL::ComPtr<ID2D1PathGeometry>::InternalRelease(&v21);
  Microsoft::WRL::ComPtr<ID2D1PathGeometry>::InternalRelease(&v25);
  return 0LL;
