/*
 * XREFs of ?ContainEffectInChainInputs@CFilterEffect@@QEAAJW4MIL_RESOURCE_TYPE@@@Z @ 0x1802043CC
 * Callers:
...
__int64 __fastcall CFilterEffect::ContainEffectInChainInputs(__int64 a1, unsigned int a2)
{
  ...
  *(_DWORD *)(a1 + 32) = v2 ^ ((unsigned __int8)v2 ^ (unsigned __int8)(v2 + 2)) & 6;
  if ( (((unsigned __int8)v2 ^ ((unsigned __int8)v2 ^ (unsigned __int8)(v2 + 2)) & 6) & 6) == 2 )
  {
    ...
    else
    {
      ...
      if ( *(int *)(a1 + 136) > 0 )
      {
        ...
        do
        {
          v8 = *(_QWORD *)(*(_QWORD *)(a1 + 128) + 8 * v7);
          v9 = *(_QWORD *)(v8 + 24);
          if ( v9 )
          {
            if ( (*(unsigned __int8 (__fastcall **)(__int64, __int64))(*(_QWORD *)v9 + 56LL))(v9, 59LL) )
            {
              v10 = *(_QWORD *)(v8 + 24);
              if ( v10 )
              {
  ...
  {
    v5 = -2147467259;
    MilInstrumentationCheckHR_MaybeFailFast(a1, 0LL, 0LL, -2147467259, 0x269u);
  }
