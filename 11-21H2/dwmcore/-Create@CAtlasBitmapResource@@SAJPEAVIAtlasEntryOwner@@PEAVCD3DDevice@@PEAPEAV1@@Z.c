/*
 * XREFs of ?Create@CAtlasBitmapResource@@SAJPEAVIAtlasEntryOwner@@PEAVCD3DDevice@@PEAPEAV1@@Z @ 0x18004005C
 * Callers:
 ...
 * Callees:
 *     ??0CAtlasBitmapResource@@IEAA@PEAVIAtlasEntryOwner@@@Z @ 0x18003FF4C (--0CAtlasBitmapResource@@IEAA@PEAVIAtlasEntryOwner@@@Z.c)
        ...
        struct CAtlasBitmapResource **a3)
{
  ...
  *a3 = 0LL;
  ...
  wil::com_ptr_t<CAtlasBitmapResource,wil::err_returncode_policy>::operator=(&v13, (__int64)v6);
