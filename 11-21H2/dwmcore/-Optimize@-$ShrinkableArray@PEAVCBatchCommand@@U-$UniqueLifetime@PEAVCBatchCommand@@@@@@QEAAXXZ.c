/*
 * XREFs of ?Optimize@?$ShrinkableArray@PEAVCBatchCommand@@U?$UniqueLifetime@PEAVCBatchCommand@@@@@@QEAAXXZ @ 0x180020A78
 * Callers:
...
void __fastcall ShrinkableArray<CBatchCommand *,UniqueLifetime<CBatchCommand *>>::Optimize(__int64 a1)
{
  ...
  if ( v1 > 0x10 && *(_DWORD *)(a1 + 36) < v1 / 3 )
  {
    ...
    v4 = v1 >> 1;
    *(_OWORD *)v13 = 0LL;
    if ( (int)DynArrayImpl<0>::Grow((unsigned int)v13, 8, v4, 1, 0LL) >= 0 )
    {
      v6 = 0LL;
      if ( v3 > v4 )
      {
