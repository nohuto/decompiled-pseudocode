/*
 * XREFs of ?InternalQueryInterface@?$CMILCOMBaseT@VICompositionSwapChain@@@@IEAAJAEBU_GUID@@PEAPEAX@Z @ 0x18028F144
 * Callers:
 *     ?QueryInterface@CCompSwapChain@@UEAAJAEBU_GUID@@PEAPEAX@Z @ 0x18028F604 (-QueryInterface@CCompSwapChain@@UEAAJAEBU_GUID@@PEAPEAX@Z.c)
 * Callees:
