/*
 * XREFs of ?QpcToMicroSec@QpcTimeConverter@@QEBAH_KPEA_K@Z @ 0x18017E48C
 * Callers:
 ...
 *     ?GetCurrentMicroSecTime@QpcTimeConverter@@QEBA_KXZ @ 0x1802735B0 (-GetCurrentMicroSecTime@QpcTimeConverter@@QEBA_KXZ.c)
