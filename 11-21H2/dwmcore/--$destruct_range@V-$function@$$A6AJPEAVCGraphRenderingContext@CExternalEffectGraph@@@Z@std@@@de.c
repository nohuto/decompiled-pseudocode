/*
 * XREFs of ??$destruct_range@V?$function@$$A6AJPEAVCGraphRenderingContext@CExternalEffectGraph@@@Z@std@@@detail@@YAXPEAV?$function@$$A6AJPEAVCGraphRenderingContext@CExternalEffectGraph@@@Z@std@@0@Z @ 0x1800328B8
 * Callers:
        ...
        __int64 a2)
{
  ...
  if ( a1 != a2 )
  {
    ...
    do
    {
      result = std::_Func_class<long,CExternalEffectGraph::CGraphRenderingContext *>::_Tidy(v3, a2);
      v3 += 64LL;
    }
    while ( v3 != a2 );
  }
