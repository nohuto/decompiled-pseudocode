/*
 * XREFs of ?Create@CChannelContext@@SAJIK_KPEAVCConnection@@PEAPEAV1@@Z @ 0x180061360
 * Callers:
        ...
        struct CChannelContext **a5)
{
  ...
  v7 = 0;
  v18[0] = 0LL;
  ProcessAttribution = CProcessAttributionManager::GetProcessAttribution(qword_1803D33D8, a2, a3, v18);
