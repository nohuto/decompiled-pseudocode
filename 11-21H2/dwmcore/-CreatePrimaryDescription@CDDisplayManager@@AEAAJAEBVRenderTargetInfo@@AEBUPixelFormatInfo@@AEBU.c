/*
 * XREFs of ?CreatePrimaryDescription@CDDisplayManager@@AEAAJAEBVRenderTargetInfo@@AEBUPixelFormatInfo@@AEBUD2D_SIZE_U@@PEAPEAUIDisplayPrimaryDescription@Core@Display@Devices@Windows@@@Z @ 0x180284664
 * Callers:
        ...
        struct Windows::Devices::Display::Core::IDisplayPrimaryDescription **a5)
{
  ...
  {
LABEL_14:
    v24 = *(&g_DDisplayManager + 1);
    v25 = *(__int64 (__fastcall **)(__int64, __int64, _QWORD, _QWORD, int, int, char, __int64, struct Windows::Devices::Display::Core::IDisplayPrimaryDescription **))(**(&g_DDisplayManager + 1) + 48LL);
    ...
    if ( v28 < 0 )
    {
      MilInstrumentationCheckHR_MaybeFailFast(v29, 0LL, 0LL, v28, 0x1FDu);
    }
    else
    {
      v30 = v34;
  ...
  if ( v12 < 0 )
  {
    ...
    v15 = v12;
LABEL_23:
    MilInstrumentationCheckHR_MaybeFailFast(v8, 0LL, 0LL, v15, 0x1EBu);
  ...
  if ( v16 < 0 )
  {
    MilInstrumentationCheckHR_MaybeFailFast(v17, 0LL, 0LL, v16, 0x1EEu);
  }
  else
  {
    ...
    if ( v18 < 0 )
    {
      MilInstrumentationCheckHR_MaybeFailFast(v19, 0LL, 0LL, v18, 0x1EFu);
    }
    else
    {
      ...
      if ( View < 0 )
      {
        MilInstrumentationCheckHR_MaybeFailFast(v21, 0LL, 0LL, View, 0x1F0u);
      }
      else
      {
        ...
        MilInstrumentationCheckHR_MaybeFailFast(v23, 0LL, 0LL, v22, 0x1F1u);
      }
    }
  }
  wil::com_ptr_t<ID3D11Resource,wil::err_returncode_policy>::~com_ptr_t<ID3D11Resource,wil::err_returncode_policy>(&v33);
