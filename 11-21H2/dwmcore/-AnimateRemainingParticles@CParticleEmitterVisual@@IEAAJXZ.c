/*
 * XREFs of ?AnimateRemainingParticles@CParticleEmitterVisual@@IEAAJXZ @ 0x18022DBD8
 * Callers:
...
__int64 __fastcall CParticleEmitterVisual::AnimateRemainingParticles(CParticleEmitterVisual *this)
{
  ...
  if ( v3 )
  {
    v5 = (float *)*((_QWORD *)this + 139);
    v6 = v3;
    v7 = *((_QWORD *)this + 136) - (_QWORD)v5;
    do
    {
      v8 = *v5;
    ...
    if ( v4 > 0.0 )
    {
      ...
      if ( v11 < 0 )
      {
        MilInstrumentationCheckHR_MaybeFailFast(v12, 0LL, 0LL, v11, 0x3Bu);
        goto LABEL_11;
      }
      v13 = *((float *)this + 1608);
      v14 = *((_QWORD *)this + 103);
      ...
      *(float *)&v26[20] = v13 + v4;
      ...
      if ( v15 < 0 )
      {
        MilInstrumentationCheckHR_MaybeFailFast(v16, 0LL, 0LL, v15, 0x55u);
LABEL_11:
