/*
 * XREFs of ?SetTemporaryConfiguration@CInteraction@@UEAAJW4TemporaryConfigurationAxis@@W4Enum@InteractionConfigurationUpdateType@@_NU?$TMILFlagsEnum@W4FlagsEnum@DwmInteractionTypeTouchPrimitiveType@@@@@Z @ 0x1801F2FB0
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall CInteraction::SetTemporaryConfiguration(__int64 a1, int a2, int a3, unsigned __int8 a4, int a5)
{
  ...
  {
    MilInstrumentationCheckHR_MaybeFailFast(v11, 0LL, 0LL, ManipulationManager, 0x29Bu);
  }
  else
  {
    v13 = a5;
    ...
    if ( updated < 0 )
    {
      MilInstrumentationCheckHR_MaybeFailFast(v16, 0LL, 0LL, updated, 0x2A2u);
    }
    else
    {
