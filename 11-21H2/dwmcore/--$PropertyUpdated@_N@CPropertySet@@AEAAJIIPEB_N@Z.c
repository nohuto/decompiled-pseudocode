/*
 * XREFs of ??$PropertyUpdated@_N@CPropertySet@@AEAAJIIPEB_N@Z @ 0x180239308
 * Callers:
...
__int64 __fastcall CPropertySet::PropertyUpdated<bool>(CResource *this, unsigned int a2, unsigned int a3, int *a4)
{
  __int64 v4; // rdi
  __int64 v8; // rcx
  unsigned int v9; // ebx
  ...
  if ( PropertySetStorage<DynArrayNoZero,PropertySetUserModeAllocator>::IsValidPropertyId((__int64)this + 88, a2) )
  {
    ...
    else
    {
      ...
      CPropertySet::LogValueUpdate<bool>((__int64)this, (unsigned int)v4, v13, a3, a4);
