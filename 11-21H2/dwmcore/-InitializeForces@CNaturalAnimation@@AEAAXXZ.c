/*
 * XREFs of ?InitializeForces@CNaturalAnimation@@AEAAXXZ @ 0x180226998
 * Callers:
 ...
 *     ??$Write@U?$_tlgWrapperByVal@$03@@U1@U1@U1@U1@U1@U1@U1@U1@U1@U1@U1@U1@U1@U1@U1@U1@U1@U1@U1@U1@U1@U1@U1@U1@U1@U1@U1@U1@U1@U1@U1@@?$_tlgWriteTemplate@$$A6AJPEBU_tlgProvider_t@@PEBXPEBU_GUID@@2IPEAU_EVENT_DATA_DESCRIPTOR@@@Z$1?_tlgWriteTransfer_EventWriteTransfer@@YAJ0122I3@ZPEBU2@PEBU2@@@SAJPEBU_tlgProvider_t@@PEBXPEBU_GUID@@2AEBU?$_tlgWrapperByVal@$03@@3333333333333333333333333333333@Z @ 0x180225434 (--$Write@U-$_tlgWrapperByVal@$03@@U1@U1@U1@U1@U1@U1@U1@U1@U1@U1@U1@U1@U1@U1@U1@U1@U_ea_180225434.c)
 *     ??0CVector3Force@@QEAA@PEAUIAccelerator@@00@Z @ 0x180225840 (--0CVector3Force@@QEAA@PEAUIAccelerator@@00@Z.c)
 *     ??4?$ComPtr@VCVector3Force@@@WRL@Microsoft@@QEAAAEAV012@PEAVCVector3Force@@@Z @ 0x1802259EC (--4-$ComPtr@VCVector3Force@@@WRL@Microsoft@@QEAAAEAV012@PEAVCVector3Force@@@Z.c)
...
LABEL_8:
  ...
  *(_DWORD *)(v25 + 348) = v22;
  if ( (*(_DWORD *)(*((_QWORD *)this + 41) + 4LL) & 0x20000000) != 0
    ...
    && tlgKeywordOn((__int64)&dword_1803D0EF0, 4LL) )
  {
    v31 = *((_DWORD *)this + 130);
    v32 = *((_DWORD *)this + 129);
    v33 = *((_DWORD *)this + 128);
