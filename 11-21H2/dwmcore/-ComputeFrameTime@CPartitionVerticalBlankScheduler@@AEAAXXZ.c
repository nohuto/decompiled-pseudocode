/*
 * XREFs of ?ComputeFrameTime@CPartitionVerticalBlankScheduler@@AEAAXXZ @ 0x18007AEF8
 * Callers:
...
void __fastcall CPartitionVerticalBlankScheduler::ComputeFrameTime(CPartitionVerticalBlankScheduler *this)
{
  ...
  v1 = (_QWORD *)*((_QWORD *)this + 564);
  v3 = v1[29];
  v1[1] = v1[2] + 1LL;
  **((_QWORD **)this + 564) = *(_QWORD *)(*((_QWORD *)this + 564) + 8LL);
  *(_QWORD *)(*((_QWORD *)this + 564) + 232LL) = *(_QWORD *)(*((_QWORD *)this + 564) + 56LL)
                                               + *(_QWORD *)(*((_QWORD *)this + 564) + 256LL);
  CPartitionVerticalBlankScheduler::CalculatePresentAndGlitchDeadlines(this);
  v4 = *(_QWORD *)(*((_QWORD *)this + 564) + 232LL);
  v5 = *(_QWORD *)(*((_QWORD *)this + 565) + 232LL);
  if ( v4 >= v3 && v4 >= v5 )
    goto LABEL_3;
  if ( v4 >= v3 )
  {
...
LABEL_6:
  v6 = *(_QWORD *)(*((_QWORD *)this + 565) + 232LL);
  if ( v6 <= v3 )
    v6 = v3;
  *(_QWORD *)(*((_QWORD *)this + 564) + 232LL) = v6;
LABEL_3:
