/*
 * XREFs of ?CaptureDxgkRingBuffer@CFailFastInScope@@AEAAXXZ @ 0x180192F9C
 * Callers:
...
void __fastcall CFailFastInScope::CaptureDxgkRingBuffer(CFailFastInScope *this)
{
  ...
  if ( v2 < 0 )
  {
    ...
    *((_QWORD *)this + 1) = v5;
    if ( !v5 )
    {
      MilInstrumentationCheckHR_MaybeFailFast(0LL, 0LL, 0LL, -2147024882, 0xF30u);
LABEL_9:
...
LABEL_8:
      v6 = v4 | 0x10000000;
      MilInstrumentationCheckHR_MaybeFailFast(v3, 0LL, 0LL, v6, v10);
      if ( v6 >= 0 )
        return;
      goto LABEL_9;
    }
    ...
    MilWerRegisterMemoryBlock(v8, v9);
  }
}
