/*
 * XREFs of ?NotifyCurrentPropertyValuesInternal@CPropertySet@@IEAAJI@Z @ 0x1800EFD6C
 * Callers:
 *     ?NotifyCurrentPropertyValues@CPropertySet@@MEBAJI@Z @ 0x1800EFD60 (-NotifyCurrentPropertyValues@CPropertySet@@MEBAJI@Z.c)
 * Callees:
...
__int64 __fastcall CPropertySet::NotifyCurrentPropertyValuesInternal(CPropertySet *this, unsigned int a2)
{
  ...
  for ( i = a2 == 0; !i; i = v3 == 0 )
  {
    if ( (v3 & 1) != 0 && (unsigned int)v2 < *((_DWORD *)this + 28) )
    {
      ...
      if ( v7 < 0 )
      {
        MilInstrumentationCheckHR_MaybeFailFast(v8, 0LL, 0LL, v7, 0x20Cu);
        return 0LL;
      }
    }
