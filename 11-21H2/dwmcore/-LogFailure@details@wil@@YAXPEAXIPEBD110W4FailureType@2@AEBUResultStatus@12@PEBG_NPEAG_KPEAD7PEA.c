/*
 * XREFs of ?LogFailure@details@wil@@YAXPEAXIPEBD110W4FailureType@2@AEBUResultStatus@12@PEBG_NPEAG_KPEAD7PEAUFailureInfo@2@@Z @ 0x1800242E0
 * Callers:
 ...
 *     ?HrToNtStatus@details@wil@@YAJJ@Z @ 0x1800F8904 (-HrToNtStatus@details@wil@@YAJJ@Z.c)
 *     ?RecordFailFast@details@wil@@YAHJ@Z @ 0x1800F9280 (-RecordFailFast@details@wil@@YAHJ@Z.c)
 ...
 *     ?RecordException@details@wil@@YAHJ@Z @ 0x18017854C (-RecordException@details@wil@@YAHJ@Z.c)
 *     ?RecordLog@details@wil@@YAHJ@Z @ 0x18017856C (-RecordLog@details@wil@@YAHJ@Z.c)
        ...
        unsigned __int64 a15)
{
  ...
  __int64 v29; // rcx
  int v30; // edx
  wil::details *v31; // [rsp+30h] [rbp-48h]
...
LABEL_4:
    ...
    case 2:
      ...
      {
        v18 = -2147024228;
        LODWORD(v31) = -2147024228;
        wil::details::ReportFailure_Hr<2>(a1, a2, a3, a4, a5, a6, v31);
        *(_DWORD *)(a15 + 8) = -2147024228;
        *(_DWORD *)(a15 + 12) = wil::details::HrToNtStatus((wil::details *)0x8007029CLL, v30);
      }
  ...
  *(_QWORD *)(a15 + 128) = v27;
  ...
  if ( wil::g_fBreakOnFailure )
  {
    if ( wil::details::g_pfnDebugBreak )
      wil::details::g_pfnDebugBreak(v29);
  }
}
