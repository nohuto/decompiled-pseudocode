/*
 * XREFs of ?HitTestContent@CVisual@@UEAAJ_NAEBUD2D_POINT_2F@@PEA_N@Z @ 0x1800632F0
 * Callers:
  ...
  *a4 = 0;
  if ( (*(unsigned __int8 (__fastcall **)(CVisual *))(*(_QWORD *)this + 272LL))(this) )
  {
    ...
    if ( !v9 )
    {
      ...
      if ( v10 )
      {
        v12 = v10 + 64 + *(int *)(*(_QWORD *)(v10 + 64) + 8LL);
        ...
        v4 = v13;
        if ( v13 < 0 )
          MilInstrumentationCheckHR_MaybeFailFast(v14, 0LL, 0, v13, 0x1364u, 0LL);
      }
    }
  }
  return v4;
