/*
 * XREFs of ?ProcessUpdateTransform@CDDisplayRenderTarget@@QEAAJPEAVCResourceTable@@PEBUtagMILCMD_DDISPLAYRENDERTARGET_UPDATETRANSFORM@@@Z @ 0x1801C8B90
 * Callers:
        ...
        const struct tagMILCMD_DDISPLAYRENDERTARGET_UPDATETRANSFORM *a3)
{
  ...
  v10 = *((_DWORD *)a3 + 13);
  v12 = v6;
  CMonitorTransform::Initialize((__int64)this + 18152, (unsigned int *)this + 26, (__int64)&v12, v7, v10, v11);
  *((_BYTE *)this + 141) = 1;
