/*
 * XREFs of ??$_Insert_range@PEAPEAVCCompositionTextLine@@@?$vector@PEAVCCompositionTextLine@@V?$allocator@PEAVCCompositionTextLine@@@std@@@std@@AEAAXV?$_Vector_const_iterator@V?$_Vector_val@U?$_Simple_types@PEAVCCompositionTextLine@@@std@@@std@@@1@PEAPEAVCCompositionTextLine@@1Uforward_iterator_tag@1@@Z @ 0x18019B028
 * Callers:
 ...
 *     ?_Change_array@?$vector@PEAVCCompositionTextLine@@V?$allocator@PEAVCCompositionTextLine@@@std@@@std@@AEAAXQEAPEAVCCompositionTextLine@@_K1@Z @ 0x1801A62F4 (-_Change_array@-$vector@PEAVCCompositionTextLine@@V-$allocator@PEAVCCompositionTextLine@@@std@@@.c)
 */
        ...
        __int64 a4)
{
  ...
  if ( v7 )
  {
    ...
    else
    {
      ...
      std::vector<CCompositionTextLine *>::_Change_array(a1, v17, v24, v11);
    }
  }
}
