/*
 * XREFs of ?DrawSolidRectangle@CDrawingContext@@UEAAJAEBV?$TMilRect_@MUMilRectF@@UMil3DRectF@@UMilPointAndSizeF@@UNotNeeded@RectUniqueness@@@@AEBU_D3DCOLORVALUE@@@Z @ 0x1801B1BD0
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall CDrawingContext::DrawSolidRectangle(__int64 a1, float *a2, __int128 *a3)
{
  ...
  v32 = *a3;
  if ( v3 )
    v7 = *(float *)(*(_QWORD *)(a1 + 3104) + 4LL * (unsigned int)(v3 - 1));
  else
    v7 = *(float *)&FLOAT_1_0;
  v8 = *((float *)&v32 + 3) * v7;
    ...
    && !TMilRect<float,MilRectF,Mil3DRectF,RectUniqueness::NotNeeded>::IsEmpty(a2) )
  {
    ...
    *(_DWORD *)(a1 + 292) = *(_DWORD *)(a1 + 312);
    ...
    if ( v13 )
    {
      ...
      if ( v15 < 0 )
      {
        MilInstrumentationCheckHR_MaybeFailFast(v16, 0LL, 0LL, v15, 0x26Eu);
      }
      else
      {
        ...
        if ( v18 )
        {
          ...
          *(unsigned __int64 *)((char *)v30 + 4) = *(_QWORD *)((char *)&v32 + 4);
          ...
          v22 = CDrawingContext::FillRectanglesWithSolidColor(v10, (__int64)v30, (__int64)&v32);
          v4 = v22;
          if ( v22 < 0 )
            MilInstrumentationCheckHR_MaybeFailFast(v23, 0LL, 0LL, v22, 0x27Du);
          DefaultHeap::Free(v20);
        }
        else
        {
          v4 = -2147024882;
          MilInstrumentationCheckHR_MaybeFailFast(v19, 0LL, 0LL, -2147024882, 0x278u);
        }
    ...
    else
    {
      ...
      *(unsigned __int64 *)((char *)v30 + 4) = *(_QWORD *)((char *)&v32 + 4);
      ...
      v26 = CDrawingContext::FillRectanglesWithSolidColor(
              (struct CDrawingContext *)(a1 - 16),
              (__int64)v30,
              (__int64)&v32);
      v4 = v26;
      if ( v26 < 0 )
        MilInstrumentationCheckHR_MaybeFailFast(v24, 0LL, 0LL, v26, 0x282u);
    }
    if ( v28 )
      std::default_delete<CShape>::operator()(v24, v28);
    CRectanglesShape::~CRectanglesShape((CRectanglesShape *)v36);
    gsl::final_action__lambda_f4147c70b2756a3d994ea7e0ab72763c___::_final_action__lambda_f4147c70b2756a3d994ea7e0ab72763c___(v34);
  }
  return v4;
}
