/*
 * XREFs of ?SyncLegacyVisualCaptureRenderTargetCaptureBits@CChannel@@UEAAJIIMHHHH_KPEAW4DXGI_FORMAT@@PEAPEAX@Z @ 0x1801AC580
 * Callers:
 *     <none>
 * Callees:
        ...
        void **a11)
{
  ...
  *(float *)&v24[3] = a4;
  ...
  if ( v15 < 0 )
  {
    MilInstrumentationCheckHR_MaybeFailFast(v16, 0LL, 0LL, v15, 0x4C0u);
  }
  else
  {
    v17 = v23;
    if ( v23 < 0 )
    {
      MilInstrumentationCheckHR_MaybeFailFast(v16, 0LL, 0LL, v23, 0x4C2u);
    }
    else
    {
      v18 = a11;
