/*
 * XREFs of ?InteractionSetInputSink@CChannel@@UEAAJIPEAX@Z @ 0x1800F0850
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall CChannel::InteractionSetInputSink(CDataStreamWriter **this, unsigned int a2, void *a3)
{
  unsigned int v6; // ebx
