/*
 * XREFs of ?PushTransformForChildVisual@CBspPreComputeHelper@@AEAAJPEBVCVisualTree@@PEAVCVisual@@@Z @ 0x1801B5CB4
 * Callers:
...
LABEL_12:
  ...
  CVisual::CalcTransform((CVisual *)a3, (CVisual **)a2, v13, &v23, (struct CMILMatrix *)v21, (struct CMILMatrix *)v19);
  v15 = CMatrixStack::Push((CBspPreComputeHelper *)((char *)this + 96), (const struct CMILMatrix *)v19, 0);
  v17 = v15;
  if ( v15 < 0 )
    MilInstrumentationCheckHR_MaybeFailFast(v16, 0LL, 0LL, v15, 0xF4u);
  return v17;
}
