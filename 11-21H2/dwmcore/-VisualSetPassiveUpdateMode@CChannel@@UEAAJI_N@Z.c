/*
 * XREFs of ?VisualSetPassiveUpdateMode@CChannel@@UEAAJI_N@Z @ 0x1801AD1E0
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall CChannel::VisualSetPassiveUpdateMode(CDataStreamWriter **this, unsigned int a2, unsigned __int8 a3)
{
  unsigned int v6; // ebx
