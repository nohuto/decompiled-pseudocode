/*
 * XREFs of ?GetSize@CCachedVisualImage@@UEBA?AUD2D_SIZE_U@@XZ @ 0x18009A800
 * Callers:
 *     <none>
 * Callees:
...
struct D2D_SIZE_U __fastcall CCachedVisualImage::GetSize(CCachedVisualImage *this, __int64 a2)
{
  ...
  _DWORD v15[4]; // [rsp+28h] [rbp-20h] BYREF
  ...
  *(_QWORD *)a2 = 0LL;
  ...
  else if ( *((_BYTE *)this + 1706) )
  {
    if ( *((_QWORD *)this + 14) )
    {
      ...
      v13 = (__int128 *)(v12 + 72);
      if ( !*(_QWORD *)(v12 + 64) )
        v13 = &TMil3DRect<float,TMilRect_<float,MilRectF,Mil3DRectF,MilPointAndSizeF,RectUniqueness::NotNeeded>,Mil3DRectF,RectUniqueness::NotNeeded>::sc_rcEmpty;
      PixelAlign(v15, (__int64)v13);
