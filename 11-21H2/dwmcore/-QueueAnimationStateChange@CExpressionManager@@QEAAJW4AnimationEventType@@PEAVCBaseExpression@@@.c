/*
 * XREFs of ?QueueAnimationStateChange@CExpressionManager@@QEAAJW4AnimationEventType@@PEAVCBaseExpression@@@Z @ 0x180042224
 * Callers:
...
__int64 __fastcall CExpressionManager::QueueAnimationStateChange(__int64 a1, int a2, int *a3)
{
  ...
  *((_QWORD *)&v12 + 1) = a3;
  ...
  if ( v5 > *(_DWORD *)(a1 + 252) )
  {
    v8 = DynArrayImpl<1>::AddMultipleAndSet(a1 + 232, 16LL, a3, &v12);
    v10 = v8;
    v6 = v8;
    if ( v8 >= 0 )
      goto LABEL_5;
...
LABEL_11:
    MilInstrumentationCheckHR_MaybeFailFast(v11, 0LL, 0, v10, 0x27Cu, 0LL);
    return v6;
  }
