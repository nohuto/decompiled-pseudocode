/*
 * XREFs of ?GetCachedFeatureEnabledState@?$FeatureImpl@U__WilFeatureTraits_Feature_ClampPositionAfterExpressionProcessing@@@details@wil@@AEAA?ATwil_details_FeatureStateCache@@XZ @ 0x18021AA2C
 * Callers:
 ...
 *     ?GetCurrentFeatureEnabledState@?$FeatureImpl@U__WilFeatureTraits_Feature_ClampPositionAfterExpressionProcessing@@@details@wil@@AEAA?ATwil_details_FeatureStateCache@@PEAH@Z @ 0x18021AB60 (-GetCurrentFeatureEnabledState@-$FeatureImpl@U__WilFeatureTraits_Feature_ClampPositionAfterExpre.c)
 */
