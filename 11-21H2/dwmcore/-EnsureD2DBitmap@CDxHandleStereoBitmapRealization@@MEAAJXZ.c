/*
 * XREFs of ?EnsureD2DBitmap@CDxHandleStereoBitmapRealization@@MEAAJXZ @ 0x1802A4920
 * Callers:
...
__int64 __fastcall CDxHandleStereoBitmapRealization::EnsureD2DBitmap(struct CD2DBitmap **this)
{
  ...
  if ( v2 < 0 )
  {
    MilInstrumentationCheckHR_MaybeFailFast(v4, 0LL, 0LL, v2, 0xB4u);
    goto LABEL_7;
  }
  v6 = this + 50;
  if ( !this[50] )
  {
    ...
    *v6 = 0LL;
    ...
    MilInstrumentationCheckHR_MaybeFailFast(v9, 0LL, 0LL, SubResourceBitmap, 0xBEu);
LABEL_7:
