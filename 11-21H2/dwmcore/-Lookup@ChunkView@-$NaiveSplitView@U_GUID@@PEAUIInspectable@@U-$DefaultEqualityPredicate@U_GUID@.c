        ...
        _QWORD *a3)
{
  ...
  while ( (unsigned int)v8 < v9 )
  {
    ...
    if ( v11 >= 0 )
    {
      ...
      if ( !v12 )
      {
        LODWORD(v3) = (*(__int64 (__fastcall **)(__int64, _QWORD *, _QWORD *, __int64))(*(_QWORD *)v10 + 56LL))(
                        v10,
                        a3,
                        a3,
                        v3);
