/*
 * XREFs of ?UpdatePlaybackState@CKeyframeAnimation@@AEAAJW4Enum@KeyframeAnimationPlaybackState@@_N_K@Z @ 0x1800D8C0C
 * Callers:
...
__int64 __fastcall CKeyframeAnimation::UpdatePlaybackState(__int64 a1, unsigned int a2, char a3, __int64 a4)
{
  ...
  if ( *(_QWORD *)(a1 + 384) )
  {
    ...
    {
      v4 = -2147024809;
      MilInstrumentationCheckHR_MaybeFailFast(a1, 0LL, 0LL, -2147024809, 0x2CEu);
    }
    else
    {
      *(_DWORD *)(a1 + 556) = a2;
  ...
  {
    v4 = -2147467259;
    MilInstrumentationCheckHR_MaybeFailFast(a1, 0LL, 0LL, -2147467259, 0x2C7u);
  }
  return v4;
}
