/*
 * XREFs of ?_Change_array@?$vector@PEAVCProjectedShadowReceiver@@V?$allocator@PEAVCProjectedShadowReceiver@@@std@@@std@@AEAAXQEAPEAVCProjectedShadowReceiver@@_K1@Z @ 0x1801F8834
 * Callers:
...
__int64 __fastcall std::vector<CProjectedShadowReceiver *>::_Change_array(
        __int64 a1,
        __int64 a2,
        __int64 a3,
        __int64 a4)
