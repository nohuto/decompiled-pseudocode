/*
 * XREFs of std::_Pop_heap_hole_by_index_unsigned_int___unsigned_int__lambda_6619143c50c0dbd69fd5d8cfbdd2e280___ @ 0x18022C738
 * Callers:
        ...
        __int64 a5)
{
  ...
  {
    i = 2 * i
      + (*(float *)(*(_QWORD *)(a5 + 1088) + 4LL * *(unsigned int *)(a1 + 8 * i + 8)) <= *(float *)(*(_QWORD *)(a5 + 1088)
