/*
 * XREFs of ?ProcessRoutingInfo@CGenericInk@@QEAAJPEAVCResourceTable@@PEBUtagMILCMD_GENERICINK_ROUTINGINFO@@@Z @ 0x180216040
 * Callers:
        ...
        const struct tagMILCMD_GENERICINK_ROUTINGINFO *a3)
{
  ...
  v3 = 0;
  *((_OWORD *)this + 22) = *(_OWORD *)((char *)a3 + 8);
  *((_OWORD *)this + 23) = *(_OWORD *)((char *)a3 + 24);
  *((_QWORD *)this + 48) = *((_QWORD *)a3 + 5);
  *((_BYTE *)this + 344) = 1;
  ...
  for ( i = 0LL; ; i += 8LL )
  {
    v7 = *(_QWORD *)(*(_QWORD *)(*(_QWORD *)(*((_QWORD *)this + 21) + i) + 24LL) + 24LL);
