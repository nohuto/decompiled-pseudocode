/*
 * XREFs of ??$_Insert_range@PEAPEAVCTransform3D@@@?$vector@PEAVCTransform3D@@V?$allocator@PEAVCTransform3D@@@std@@@std@@AEAAXV?$_Vector_const_iterator@V?$_Vector_val@U?$_Simple_types@PEAVCTransform3D@@@std@@@std@@@1@PEAPEAVCTransform3D@@1Uforward_iterator_tag@1@@Z @ 0x18019B7A8
 * Callers:
 ...
 *     ?_Change_array@?$vector@PEAVCTransform3D@@V?$allocator@PEAVCTransform3D@@@std@@@std@@AEAAXQEAPEAVCTransform3D@@_K1@Z @ 0x1801A6494 (-_Change_array@-$vector@PEAVCTransform3D@@V-$allocator@PEAVCTransform3D@@@std@@@std@@AEAAXQEAPEA.c)
 */
        ...
        __int64 a4)
{
  ...
  if ( v7 )
  {
    ...
    else
    {
      ...
      std::vector<CTransform3D *>::_Change_array(a1, v17, v24, v11);
    }
  }
}
