/*
 * XREFs of ?Create@CStereoRenderTargetBitmap@@SAJPEAVIDeviceTextureTarget@@PEAPEAVIStereoRenderTargetBitmap@@@Z @ 0x1802A772C
 * Callers:
        ...
        struct IStereoRenderTargetBitmap **a2)
{
  ...
  *a2 = 0LL;
  ...
  if ( v7 < 0 )
  {
    v15 = 26;
LABEL_15:
    MilInstrumentationCheckHR_MaybeFailFast(v8, 0LL, 0LL, v7, v15);
    goto LABEL_16;
  }
  ...
  {
    v9 = -2147024882;
    MilInstrumentationCheckHR_MaybeFailFast(v12, 0LL, 0LL, -2147024882, 0x1Du);
  }
LABEL_16:
