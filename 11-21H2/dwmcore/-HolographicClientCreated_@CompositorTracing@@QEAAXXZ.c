/*
 * XREFs of ?HolographicClientCreated_@CompositorTracing@@QEAAXXZ @ 0x1802960A0
 * Callers:
...
void __fastcall CompositorTracing::HolographicClientCreated_(CompositorTracing *this)
{
  ...
  if ( *v1 > 4u )
  {
    if ( tlgKeywordOn((__int64)v1, 0x400000000000LL) )
      tlgWriteTransfer_EventWriteTransfer(v2, (unsigned __int8 *)dword_1803739B8, 0LL, 0LL, 2u, &v3);
  }
}
