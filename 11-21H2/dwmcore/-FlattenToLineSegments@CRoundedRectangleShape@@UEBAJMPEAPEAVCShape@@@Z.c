/*
 * XREFs of ?FlattenToLineSegments@CRoundedRectangleShape@@UEBAJMPEAPEAVCShape@@@Z @ 0x1800DEDB0
 * Callers:
 *     <none>
 * Callees:
        ...
        struct CShape **a3)
{
  ...
  if ( *(float *)(v3 + 64) <= 0.0 )
  {
    ...
    v4 = -2147024882;
    MilInstrumentationCheckHR_MaybeFailFast(v11, 0LL, 0LL, -2147024882, 0x2E1u);
    return v4;
  }
  v14 = CShape::CopyShape(this, 0LL, a3);
  v4 = v14;
  if ( v14 < 0 )
    MilInstrumentationCheckHR_MaybeFailFast(v15, 0LL, 0LL, v14, 0x2D8u);
  return v4;
}
