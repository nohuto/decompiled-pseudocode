/*
 * XREFs of ??$_Emplace_reallocate@UFragmentStackEntry@CFragmentIterator@@@?$vector@UFragmentStackEntry@CFragmentIterator@@V?$allocator@UFragmentStackEntry@CFragmentIterator@@@std@@@std@@QEAAPEAUFragmentStackEntry@CFragmentIterator@@QEAU23@$$QEAU23@@Z @ 0x18003A2B8
 * Callers:
 ...
 * Callees:
 *     ?_Change_array@?$vector@UFragmentStackEntry@CFragmentIterator@@V?$allocator@UFragmentStackEntry@CFragmentIterator@@@std@@@std@@AEAAXQEAUFragmentStackEntry@CFragmentIterator@@_K1@Z @ 0x18003A3AC (-_Change_array@-$vector@UFragmentStackEntry@CFragmentIterator@@V-$allocator@UFragmentStackEntry@.c)
        ...
        _OWORD *a3)
{
  ...
  *(_OWORD *)v15 = *a3;
  ...
  std::vector<CFragmentIterator::FragmentStackEntry>::_Change_array(a1, v14, v9, v3);
  return v15;
}
