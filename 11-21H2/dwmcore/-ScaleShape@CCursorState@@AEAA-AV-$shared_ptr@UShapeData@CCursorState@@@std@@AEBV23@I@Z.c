/*
 * XREFs of ?ScaleShape@CCursorState@@AEAA?AV?$shared_ptr@UShapeData@CCursorState@@@std@@AEBV23@I@Z @ 0x18026A7DC
 * Callers:
             ...
             &v30) >= 0 )
      {
        ...
        if ( (int)HrCreateBitmapFromWICBitmapSource(v30, &v31) >= 0 )
        {
          ...
          if ( (int)CSystemMemoryBitmap::HrInit(v32, v31, v17, v18) >= 0 )
          {
            ...
            v19 = v33[0];
            HIDWORD(v20) = 0;
            *(_DWORD *)v33[0] = (unsigned int)(v10 + a4 * *(_DWORD *)*a3) / *(_DWORD *)(*a3 + 12);
            LODWORD(v20) = (unsigned int)(v10 + a4 * *(_DWORD *)(*a3 + 4)) % *(_DWORD *)(*a3 + 12);
            *(_DWORD *)(v19 + 4) = (unsigned int)(v10 + a4 * *(_DWORD *)(*a3 + 4)) / *(_DWORD *)(*a3 + 12);
