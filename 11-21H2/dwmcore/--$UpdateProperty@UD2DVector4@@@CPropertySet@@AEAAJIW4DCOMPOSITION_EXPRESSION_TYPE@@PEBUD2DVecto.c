/*
 * XREFs of ??$UpdateProperty@UD2DVector4@@@CPropertySet@@AEAAJIW4DCOMPOSITION_EXPRESSION_TYPE@@PEBUD2DVector4@@@Z @ 0x180239628
 * Callers:
...
__int64 __fastcall CPropertySet::UpdateProperty<D2DVector4>(CResource *this, unsigned int a2, __int64 a3, int *a4)
{
  unsigned int v6; // edx
  __int64 v7; // rcx
  unsigned int v8; // edx
