/*
 * XREFs of ??$SetProperty@UD2DMatrix@@@DataSourcePropertySet@@QEAAJIPEBUD2DMatrix@@W4DCOMPOSITION_EXPRESSION_TYPE@@@Z @ 0x1801BB558
 * Callers:
...
__int64 __fastcall DataSourcePropertySet::SetProperty<D2DMatrix>(__int64 a1, int a2, __int128 *a3)
{
  ...
  unsigned int v27; // [rsp+58h] [rbp+20h] BYREF
  ...
  if ( v25 == *(_QWORD *)(a1 + 8) )
  {
    v6 = PropertySetStorage<DynArrayNoZero,PropertySetUserModeAllocator>::AddProperty<D2DMatrix>(v5, 265, a3, &v27);
    v7 = v6;
    if ( v6 < 0 )
    {
  ...
  else
  {
    ...
    if ( !(unsigned __int8)PropertySetStorage<DynArrayNoZero,PropertySetUserModeAllocator>::IsValidPropertyId(v10, v9) )
      ModuleFailFastForHRESULT(2147942487LL, retaddr);
    if ( !(unsigned __int8)PropertySetStorage<DynArrayNoZero,PropertySetUserModeAllocator>::IsValidPropertyId(v17, v16) )
      ModuleFailFastForHRESULT(2147942487LL, retaddr);
    v21 = *(_QWORD *)(v20 + 32);
    v22 = *(_DWORD *)(v19 + 8 * v18 + 4) & 0x1FFFFFFF;
    *(_OWORD *)(v22 + v21) = v12;
    *(_OWORD *)(v22 + v21 + 16) = v13;
    *(_OWORD *)(v22 + v21 + 32) = v14;
    *(_OWORD *)(v22 + v21 + 48) = v15;
  }
  return 0LL;
}
