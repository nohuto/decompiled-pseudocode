/*
 * XREFs of ?CreateD3D12Resource@CLegacySwapChain@@QEBAJIPEAPEAUID3D12Resource@@@Z @ 0x18028B190
 * Callers:
...
__int64 __fastcall CLegacySwapChain::CreateD3D12Resource(CLegacySwapChain *this, int a2, struct ID3D12Resource **a3)
{
  ...
  v16 = 0LL;
  if ( v6 >= *((_DWORD *)this + 51) )
  {
    v10 = -2147024809;
    MilInstrumentationCheckHR_MaybeFailFast(v7, 0LL, 0LL, -2147024809, 0x59Du);
    goto LABEL_9;
  }
  ...
  if ( v8 < 0 )
  {
    MilInstrumentationCheckHR_MaybeFailFast(v9, 0LL, 0LL, v8, 0x599u);
LABEL_9:
