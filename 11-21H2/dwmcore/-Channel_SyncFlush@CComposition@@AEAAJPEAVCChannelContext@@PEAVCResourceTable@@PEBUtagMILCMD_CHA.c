/*
 * XREFs of ?Channel_SyncFlush@CComposition@@AEAAJPEAVCChannelContext@@PEAVCResourceTable@@PEBUtagMILCMD_CHANNEL_SYNCFLUSH@@@Z @ 0x1800F68E0
 * Callers:
...
LABEL_9:
    MilInstrumentationCheckHR_MaybeFailFast(v11, 0LL, 0LL, v7, 0x68Fu);
    return v7;
  }
  v7 = 0;
