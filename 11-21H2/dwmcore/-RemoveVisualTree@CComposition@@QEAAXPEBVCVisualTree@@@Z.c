/*
 * XREFs of ?RemoveVisualTree@CComposition@@QEAAXPEBVCVisualTree@@@Z @ 0x1800C7104
 * Callers:
 *     ??1CVisual@@MEAA@XZ @ 0x18004A90C (--1CVisual@@MEAA@XZ.c)
 *     ?FinalRelease@CVisualTree@@MEAAXXZ @ 0x1800C70F0 (-FinalRelease@CVisualTree@@MEAAXXZ.c)
 * Callees:
