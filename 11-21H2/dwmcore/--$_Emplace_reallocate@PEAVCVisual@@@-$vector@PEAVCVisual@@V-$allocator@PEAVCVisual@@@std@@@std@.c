/*
 * XREFs of ??$_Emplace_reallocate@PEAVCVisual@@@?$vector@PEAVCVisual@@V?$allocator@PEAVCVisual@@@std@@@std@@QEAAPEAPEAVCVisual@@QEAPEAV2@$$QEAPEAV2@@Z @ 0x18025D104
 * Callers:
...
char *__fastcall std::vector<CVisual *>::_Emplace_reallocate<CVisual *>(_QWORD *a1, _BYTE *a2, _QWORD *a3)
{
  _BYTE *v3; // rbp
  __int64 v6; // rax
  __int64 v8; // r15
  ...
  *(_QWORD *)v12 = *a3;
  ...
  std::vector<CVisual *>::_Change_array((__int64)a1, (__int64)v11, v8, v9);
