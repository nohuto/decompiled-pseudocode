/*
 * XREFs of ??$_Insert_range@PEAPEAVCBaseExpression@@@?$vector@PEAVCBaseExpression@@V?$allocator@PEAVCBaseExpression@@@std@@@std@@AEAAXV?$_Vector_const_iterator@V?$_Vector_val@U?$_Simple_types@PEAVCBaseExpression@@@std@@@std@@@1@PEAPEAVCBaseExpression@@1Uforward_iterator_tag@1@@Z @ 0x18019AC58
 * Callers:
 ...
 *     ?_Change_array@?$vector@PEAVCBaseExpression@@V?$allocator@PEAVCBaseExpression@@@std@@@std@@AEAAXQEAPEAVCBaseExpression@@_K1@Z @ 0x1801A6224 (-_Change_array@-$vector@PEAVCBaseExpression@@V-$allocator@PEAVCBaseExpression@@@std@@@std@@AEAAX.c)
 */

void __fastcall std::vector<CBaseExpression *>::_Insert_range<CBaseExpression * *>(
        __int64 a1,
        _BYTE *a2,
        const void *a3,
        __int64 a4)
{
  ...
  if ( v7 )
  {
    ...
    else
    {
      ...
      std::vector<CBaseExpression *>::_Change_array(a1, v17, v24, v11);
    }
  }
}
