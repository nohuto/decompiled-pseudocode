/*
 * XREFs of ?StartAsTriggeredAnimation@CBaseExpression@@UEAAJXZ @ 0x1802292E0
 * Callers:
...
__int64 __fastcall CBaseExpression::StartAsTriggeredAnimation(CBaseExpression *this)
{
  ...
  if ( (v1 & 1) != 0 )
  {
    if ( (unsigned int)dword_1803D0EF0 > 4 && tlgKeywordOn((__int64)&dword_1803D0EF0, 4LL) )
    {
      ...
      v13 = (unsigned __int8 *)&unk_180371CE7;
      goto LABEL_17;
    }
  }
  else
  {
    ...
    if ( (unsigned int)dword_1803D0EF0 > 4 && tlgKeywordOn((__int64)&dword_1803D0EF0, 4LL) )
    {
      v16 = this;
      TracingCookie = CBaseExpression::GetTracingCookie(this);
      v13 = (unsigned __int8 *)&unk_180371CB0;
LABEL_17:
