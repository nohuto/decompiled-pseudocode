/*
 * XREFs of ??$_Emplace_reallocate@AEBQEAVIDDisplayEventListener@@@?$vector@PEAVIDDisplayEventListener@@V?$allocator@PEAVIDDisplayEventListener@@@std@@@std@@QEAAPEAPEAVIDDisplayEventListener@@QEAPEAV2@AEBQEAV2@@Z @ 0x18028139C
 * Callers:
 ...
 *     ?_Change_array@?$vector@PEAVIDDisplayEventListener@@V?$allocator@PEAVIDDisplayEventListener@@@std@@@std@@AEAAXQEAPEAVIDDisplayEventListener@@_K1@Z @ 0x180288B04 (-_Change_array@-$vector@PEAVIDDisplayEventListener@@V-$allocator@PEAVIDDisplayEventListener@@@st.c)
 */
