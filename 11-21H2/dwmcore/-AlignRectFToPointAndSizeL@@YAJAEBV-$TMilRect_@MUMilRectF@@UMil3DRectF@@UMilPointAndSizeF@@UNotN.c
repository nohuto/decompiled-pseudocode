/*
 * XREFs of ?AlignRectFToPointAndSizeL@@YAJAEBV?$TMilRect_@MUMilRectF@@UMil3DRectF@@UMilPointAndSizeF@@UNotNeeded@RectUniqueness@@@@PEAUMilPointAndSizeL@@@Z @ 0x1802631E4
 * Callers:
...
__int64 __fastcall AlignRectFToPointAndSizeL(float *a1, _DWORD *a2)
{
  ...
  {
    v4 = -2003304438;
    MilInstrumentationCheckHR_MaybeFailFast((__int64)v5, 0LL, 0LL, -2003304438, 0xE2u);
  }
  return v4;
}
