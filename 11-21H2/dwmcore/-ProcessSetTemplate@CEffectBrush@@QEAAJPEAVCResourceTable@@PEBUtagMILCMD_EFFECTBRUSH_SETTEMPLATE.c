/*
 * XREFs of ?ProcessSetTemplate@CEffectBrush@@QEAAJPEAVCResourceTable@@PEBUtagMILCMD_EFFECTBRUSH_SETTEMPLATE@@@Z @ 0x180035D28
 * Callers:
...
LABEL_19:
  MilInstrumentationCheckHR_MaybeFailFast(v18, 0LL, 0, v17, 0x9Eu, 0LL);
  return v9;
}
