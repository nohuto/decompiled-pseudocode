/*
 * XREFs of ?SwizzleNode@CShaderLinkingGraphBuilder@@QEAAJW4ShaderLinkingArgument@@PEBD@Z @ 0x180032E04
 * Callers:
...
__int64 __fastcall CShaderLinkingGraphBuilder::SwizzleNode(unsigned __int64 a1, __int16 a2)
{
