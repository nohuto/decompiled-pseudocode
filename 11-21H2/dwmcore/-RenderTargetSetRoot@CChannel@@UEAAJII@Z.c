/*
 * XREFs of ?RenderTargetSetRoot@CChannel@@UEAAJII@Z @ 0x1801AC250
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall CChannel::RenderTargetSetRoot(CDataStreamWriter **this, unsigned int a2, int a3)
{
  unsigned int v6; // ebx
