/*
 * XREFs of ?Initialize@?$CInputTypeContext@UDwmTouchInteractionConfigurationPrimitive@@U?$TMILFlagsEnum@W4FlagsEnum@DwmInteractionTypeTouchPrimitiveType@@@@W4FlagsEnum@DwmInteractionTypeTouchPrimitiveType@@@@QEAAJPEAUIInteractionContextWrapper@@_N@Z @ 0x18002C418
 * Callers:
        ...
        char a3)
{
  ...
  *(_BYTE *)(a1 + 149) |= a3;
  ...
  v7[1] = 0;
  v7[2] = 0;
  v5 = DynArray<DwmTouchInteractionConfigurationPrimitive,0>::AddMultipleAndSet(a1 + 88, v7, 1LL);
  if ( v5 < 0 )
