/*
 * XREFs of ?CaptureControllerSetRootVisual@CChannel@@UEAAJII@Z @ 0x1801AA380
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall CChannel::CaptureControllerSetRootVisual(CDataStreamWriter **this, unsigned int a2, int a3)
{
  unsigned int v6; // ebx
