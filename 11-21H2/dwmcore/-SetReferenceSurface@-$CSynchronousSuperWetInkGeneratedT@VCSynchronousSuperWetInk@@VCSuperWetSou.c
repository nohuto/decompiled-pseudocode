/*
 * XREFs of ?SetReferenceSurface@?$CSynchronousSuperWetInkGeneratedT@VCSynchronousSuperWetInk@@VCSuperWetSource@@@@QEAAJPEAVCCompositionSurfaceBitmap@@@Z @ 0x1801A54A0
 * Callers:
        ...
        struct CResource *a2)
{
  ...
  {
    if ( v4 )
      (*(void (__fastcall **)(_QWORD *, _QWORD))(**((_QWORD **)v4 + 13) + 376LL))(*((_QWORD **)v4 + 13), 0LL);
    v6 = CResource::RegisterNotifier(this, a2);
    v3 = v6;
    if ( v6 < 0 )
    {
      MilInstrumentationCheckHR_MaybeFailFast(v7, 0LL, 0LL, v6, 0x1002u);
    }
    else
    {
