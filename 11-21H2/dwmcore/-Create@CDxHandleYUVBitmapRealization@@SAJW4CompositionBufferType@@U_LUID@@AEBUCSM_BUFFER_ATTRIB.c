/*
 * XREFs of ?Create@CDxHandleYUVBitmapRealization@@SAJW4CompositionBufferType@@U_LUID@@AEBUCSM_BUFFER_ATTRIBUTES@@AEBUCSM_REALIZATION_INFO@@PEAVCDecodeBitmap@@PEAPEAVISwapChainRealization@@@Z @ 0x1802A52AC
 * Callers:
        ...
        _QWORD *a6)
{
  ...
  v19 = 0LL;
  v10 = (volatile signed __int32 *)operator new(0x210uLL);
  if ( v10 )
  ...
  {
    v13 = -2147024882;
    MilInstrumentationCheckHR_MaybeFailFast(v11, 0LL, 0LL, -2147024882, 0x1Eu);
LABEL_7:
    v16 = 0LL;
    goto LABEL_10;
  }
  ...
  if ( v14 < 0 )
  {
    MilInstrumentationCheckHR_MaybeFailFast(v15, 0LL, 0LL, v14, 0x1Fu);
    *((_QWORD *)v12 + 31) = 0LL;
    goto LABEL_7;
  }
  v17 = v12;
