/*
 * XREFs of ?NotifyVector4PropertyChanged@CPropertyChangeResource@@IEBAJIAEBUD2DVector4@@@Z @ 0x180203498
 * Callers:
        ...
        const struct D2DVector4 *a3)
{
  ...
  if ( CPropertyChangeResource::ShouldNotify(this, a2) )
  {
    ...
    v14[1] = v6;
    v15 = v10;
    v11 = CoreUICallSend(v8, v14, 2LL, 15LL, 4, &unk_18032C431);
    v3 = v11;
    if ( v11 == -2018375675 )
    {
      return 0;
    ...
    {
      MilInstrumentationCheckHR_MaybeFailFast(v12, 0LL, 0LL, v11, 0x177u);
    }
  }
  return v3;
}
