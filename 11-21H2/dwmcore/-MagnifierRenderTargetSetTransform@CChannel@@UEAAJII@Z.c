/*
 * XREFs of ?MagnifierRenderTargetSetTransform@CChannel@@UEAAJII@Z @ 0x1801AB350
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall CChannel::MagnifierRenderTargetSetTransform(CDataStreamWriter **this, unsigned int a2, int a3)
{
  unsigned int v6; // ebx
