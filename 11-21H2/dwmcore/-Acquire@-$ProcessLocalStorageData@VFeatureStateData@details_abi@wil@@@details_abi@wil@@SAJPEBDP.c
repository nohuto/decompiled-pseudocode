/*
 * XREFs of ?Acquire@?$ProcessLocalStorageData@VFeatureStateData@details_abi@wil@@@details_abi@wil@@SAJPEBDPEAPEAV123@@Z @ 0x1800261C4
 * Callers:
        ...
        void **a2)
{
  ...
  wil::details *v17[2]; // [rsp+40h] [rbp-C0h] BYREF
  ...
  *a2 = 0LL;
  ...
  if ( Pointer >= 0 )
  {
    ...
    else
    {
      ...
      if ( v12 < 0 )
      {
        wil::details::in1diag3::Return_Hr(retaddr, (void *)0x12E, (int)"wil", (const char *)(unsigned int)v12);
        goto LABEL_6;
      }
    }
    v10 = 0;
