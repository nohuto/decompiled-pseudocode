/*
 * XREFs of ?OnMarginsChanged@CGdiSpriteBitmap@@QEAAXXZ @ 0x1800606A0
 * Callers:
...
void __fastcall CGdiSpriteBitmap::OnMarginsChanged(CGdiSpriteBitmap *this)
{
  ...
  v2 = (void (__fastcall ***)(_QWORD, __int128 *))*((_QWORD *)this + 53);
  if ( v2 )
  {
    v3 = *v2;
    v12 = *((_OWORD *)this + 5);
    ...
    while ( v4 != v5 )
    {
      ...
      v7 = *v6;
      *(_QWORD *)&v12 = 0LL;
      if ( (*(int (__fastcall **)(__int64 *, __int128 *))(v7 + 56))(v6, &v12) >= 0 )
      {
