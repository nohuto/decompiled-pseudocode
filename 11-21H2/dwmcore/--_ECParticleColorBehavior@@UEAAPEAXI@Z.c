/*
 * XREFs of ??_ECParticleColorBehavior@@UEAAPEAXI@Z @ 0x18019F150
 * Callers:
 *     ??_ECParticleVector3Behavior@@WHA@EAAPEAXI@Z @ 0x1801054D0 (--_ECParticleVector3Behavior@@WHA@EAAPEAXI@Z.c)
 * Callees:
