/*
 * XREFs of ?_SendUpdateToRenderThread@CManipulation@@AEAAJ_NPEBUD2DVector3@@1@Z @ 0x1801F5400
 * Callers:
        ...
        const struct D2DVector3 *a4)
{
  ...
  if ( a2 )
  {
    ...
    D2DMatrixMultiply((struct D2DMatrix *)v82, (CManipulation *)((char *)this + 144), (const struct D2DMatrix *)v83);
    v5 = v82[1];
    v6 = v82[2];
    *v7 = v82[0];
    v7[1] = v5;
  ...
  if ( v18 )
  {
    ...
    v80 = v27;
    v81 = v28;
    ManipulationManager = CoreUICallSend(v32, &v66, 1LL, 12LL, 0, &unk_18032C3EC);
    v16 = ManipulationManager;
    if ( ManipulationManager >= 0 )
    {
    ...
    v30 = 325;
LABEL_15:
    MilInstrumentationCheckHR_MaybeFailFast(v15, 0LL, 0LL, ManipulationManager, v30);
    goto LABEL_16;
  }
  v16 = -2147467259;
  MilInstrumentationCheckHR_MaybeFailFast(v15, 0LL, 0LL, -2147467259, 0x13Cu);
LABEL_16:
  Microsoft::WRL::ComPtr<IUnknown>::InternalRelease((__int64 *)&v32);
  Microsoft::WRL::ComPtr<IUnknown>::InternalRelease((__int64 *)&v31);
  return v16;
