/*
 * XREFs of ??$PropertyUpdated@UD2DMatrix@@@CPropertySet@@AEAAJIIPEBUD2DMatrix@@@Z @ 0x1800E763C
 * Callers:
...
__int64 __fastcall CPropertySet::PropertyUpdated<D2DMatrix>(CResource *this, __int64 a2, int a3, __int64 a4)
{
  __int64 v4; // rdi
  __int64 v8; // rcx
  unsigned int v9; // ebx
                          ...
                          a2) )
  {
    ...
    else
    {
      ...
      CPropertySet::LogValueUpdate<D2DMatrix>((_DWORD)this, v4, v13, a3, a4);
      v14 = CPropertySet::NotifyPropertyValue((__int64)this, v4, v13);
      v9 = v14;
      if ( v14 >= 0 )
        return 0;
      v17 = 475;
  ...
  v9 = -2147024809;
  MilInstrumentationCheckHR_MaybeFailFast(v8, 0LL, 0LL, -2147024809, 0x1BCu);
  return v9;
}
