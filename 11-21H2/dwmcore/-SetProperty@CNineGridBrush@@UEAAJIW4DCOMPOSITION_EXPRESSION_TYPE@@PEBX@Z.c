/*
 * XREFs of ?SetProperty@CNineGridBrush@@UEAAJIW4DCOMPOSITION_EXPRESSION_TYPE@@PEBX@Z @ 0x180229800
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall CNineGridBrush::SetProperty(CResource *a1, int a2, int a3)
{
  ...
  {
    v7 = -2147024809;
    MilInstrumentationCheckHR_MaybeFailFast((__int64)a1, 0LL, 0LL, -2147024809, 0x107u);
  }
  return v7;
}
