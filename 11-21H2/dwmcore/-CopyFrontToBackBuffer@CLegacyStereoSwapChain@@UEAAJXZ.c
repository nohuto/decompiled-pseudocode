/*
 * XREFs of ?CopyFrontToBackBuffer@CLegacyStereoSwapChain@@UEAAJXZ @ 0x18029075C
 * Callers:
 *     ?CopyFrontToBackBuffer@CLegacyStereoSwapChain@@$4PPPPPPPM@A@EAAJXZ @ 0x180109D90 (-CopyFrontToBackBuffer@CLegacyStereoSwapChain@@$4PPPPPPPM@A@EAAJXZ.c)
 * Callees:
...
__int64 __fastcall CLegacyStereoSwapChain::CopyFrontToBackBuffer(CLegacyStereoSwapChain *this, __int64 a2, __int64 a3)
{
  ...
  v4 = *(_QWORD *)(*((_QWORD *)this - 40) + 8LL * *((unsigned int *)this - 74));
  ...
  if ( *(_DWORD *)v5 )
  {
    ...
    while ( (unsigned __int64)v19 < v18 )
    {
      ...
      v10 = *((_QWORD *)this - 45);
      v13 = v8;
      CD3DDevice::CopySubresourceRegion(v10, *((_QWORD *)this - 41), 1, (int *)&v13, v9, 1u, v8, v14, 0);
