/*
 * XREFs of ?VisualSetResampleMode@CChannel@@UEAAJIW4Enum@CompositionResampleMode@@@Z @ 0x1800F6950
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall CChannel::VisualSetResampleMode(__int64 a1, unsigned int a2, int a3)
{
  ...
  CChannel::CheckHandle(a1, a2, 195);
  v8[0] = 405;
  v8[1] = a2;
  v8[2] = a3;
  v6 = CChannel::SendCommand((CDataStreamWriter **)a1, v8, 0xCu);
