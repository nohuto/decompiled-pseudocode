/*
 * XREFs of ?Create@CGDISubSectionBitmapRealization@@SAJPEAEAEBV?$TMilRect@IUMilRectU@@UMil3DRectU@@UNotNeeded@RectUniqueness@@@@1IW4DXGI_FORMAT@@W4DXGI_ALPHA_MODE@@PEAPEAVIGDIBitmapRealization@@@Z @ 0x1802A24E0
 * Callers:
        ...
        _QWORD *a7)
{
  ...
  __int64 v13; // rcx
  __int64 v14; // rax
  CGDISubSectionBitmapRealization *v15; // rdi
  int v16; // eax
  __int64 v17; // rcx
  ...
  *a7 = 0LL;
        ...
        (v15 = (CGDISubSectionBitmapRealization *)v14) != 0LL) )
  {
    ...
    if ( v16 < 0 )
    {
      MilInstrumentationCheckHR_MaybeFailFast(v17, 0LL, 0LL, v16, 0x38u);
  ...
  {
    v18 = -2147024882;
    MilInstrumentationCheckHR_MaybeFailFast(v13, 0LL, 0LL, -2147024882, 0x36u);
  }
  return v18;
}
