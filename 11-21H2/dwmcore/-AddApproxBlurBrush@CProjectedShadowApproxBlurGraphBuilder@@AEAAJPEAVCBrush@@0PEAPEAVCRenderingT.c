/*
 * XREFs of ?AddApproxBlurBrush@CProjectedShadowApproxBlurGraphBuilder@@AEAAJPEAVCBrush@@0PEAPEAVCRenderingTechniqueFragment@@@Z @ 0x180259EB0
 * Callers:
 ...
 *     ??0CProjectedShadowApproxBlurEffect@@QEAA@XZ @ 0x1802AD038 (--0CProjectedShadowApproxBlurEffect@@QEAA@XZ.c)
        ...
        struct CRenderingTechniqueFragment **a4)
{
  ...
  v8 = (CProjectedShadowApproxBlurEffect *)operator new(0xA0uLL);
  if ( v8 )
  {
  ...
  {
    v18 = -2147024882;
    MilInstrumentationCheckHR_MaybeFailFast((__int64)v11, 0LL, 0LL, -2147024882, 0x5Du);
  }
  if ( v10 )
