/*
 * XREFs of ?Init@CVisualDepthGeometry@@AEAAXAEBUfloat2@Numerics@Foundation@Windows@@AEBVCMILMatrix@@@Z @ 0x18025AAF4
 * Callers:
        ...
        const struct CMILMatrix *a3)
{
  ...
  __int64 v14; // r11
  float *v15; // r8
  struct D2D_VECTOR_4F *v16; // r10
  float v17; // xmm2_4
  int v18; // edx
  FLOAT v19; // xmm1_4
  struct D2D_VECTOR_4F *v20; // rax
  float *v21; // rcx
  __int64 v22; // rdx
  __m128 v23; // xmm2
  __m128 v24; // xmm3
  ...
  __m128 v30; // xmm2
  FLOAT v31; // xmm0_4
  struct D2D_VECTOR_4F v32; // [rsp+20h] [rbp-69h] BYREF
  ...
  struct D2D_VECTOR_4F v47; // [rsp+80h] [rbp-9h] BYREF
  ...
  v16 = (struct D2D_VECTOR_4F *)((char *)this + 84);
  do
  {
    v17 = *v15;
    v18 = v13 % 4;
    ...
    v32.z = *((float *)this + 3 * v18 + 9) - v32.x;
    v32.w = v19;
    *v16++ = v32;
    --v14;
  }
  while ( v14 );
  v20 = D2DVectorHelper::CalculatePlane(&v32, &v47, &v48, &v49);
  v21 = (float *)((char *)this + 56);
  v22 = 3LL;
  v23 = (__m128)_mm_loadu_si128((const __m128i *)v20);
  LODWORD(v32.x) = v23.m128_i32[0];
  LODWORD(v32.y) = _mm_shuffle_ps(v23, v23, 85).m128_u32[0];
  LODWORD(v32.w) = _mm_shuffle_ps(v23, v23, 255).m128_u32[0];
  LODWORD(v32.z) = _mm_shuffle_ps(v23, v23, 170).m128_u32[0];
  *((struct D2D_VECTOR_4F *)this + 10) = v32;
