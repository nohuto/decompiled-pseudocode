/*
 * XREFs of ?GetPresentStatistics@CDDisplaySwapChain@@UEAAJPEAUDXGI_FRAME_STATISTICS@@@Z @ 0x18027B600
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall CDDisplaySwapChain::GetPresentStatistics(CDDisplaySwapChain *this, struct DXGI_FRAME_STATISTICS *a2)
{
  ...
  {
    MilInstrumentationCheckHR_MaybeFailFast(v4, 0LL, 0LL, PresentStatisticsDWM, 0x2F3u);
  }
  else
  {
    v6 = v8;
