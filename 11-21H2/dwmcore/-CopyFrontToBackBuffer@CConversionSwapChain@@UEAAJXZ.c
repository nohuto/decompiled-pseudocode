/*
 * XREFs of ?CopyFrontToBackBuffer@CConversionSwapChain@@UEAAJXZ @ 0x18029245C
 * Callers:
 *     ?CopyFrontToBackBuffer@CConversionSwapChain@@$4PPPPPPPM@A@EAAJXZ @ 0x18010A3D0 (-CopyFrontToBackBuffer@CConversionSwapChain@@$4PPPPPPPM@A@EAAJXZ.c)
 * Callees:
...
__int64 __fastcall CConversionSwapChain::CopyFrontToBackBuffer(CConversionSwapChain *this, __int64 a2, __int64 a3)
{
  ...
  int v17[4]; // [rsp+60h] [rbp-28h] BYREF
  ...
  {
    v5 = (CConversionSwapChain *)((char *)this - 424);
    CLegacySwapChain::NotifyRenderedRect((__int64)this - 424, (int *)this - 24);
  }
  v8 = CLegacySwapChain::CopyFrontToBackBuffer(v5, a2, a3);
  v10 = v8;
  if ( v8 < 0 )
    MilInstrumentationCheckHR_MaybeFailFast(v9, 0LL, 0LL, v8, 0x9Eu);
  return v10;
}
