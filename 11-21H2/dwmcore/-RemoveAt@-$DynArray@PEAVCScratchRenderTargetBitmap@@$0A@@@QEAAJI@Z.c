/*
 * XREFs of ?RemoveAt@?$DynArray@PEAVCScratchRenderTargetBitmap@@$0A@@@QEAAJI@Z @ 0x1800402F0
 * Callers:
...
__int64 __fastcall DynArray<CScratchRenderTargetBitmap *,0>::RemoveAt(__int64 *a1, unsigned int a2)
{
  ...
  {
    v3 = -2147024809;
    MilInstrumentationCheckHR_MaybeFailFast((unsigned int)a1, 0LL, 0, -2147024809, 0x19Cu, 0LL);
  }
  else
  {
    v6 = *a1;
