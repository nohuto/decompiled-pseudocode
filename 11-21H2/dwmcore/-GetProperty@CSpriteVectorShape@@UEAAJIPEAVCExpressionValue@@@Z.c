/*
 * XREFs of ?GetProperty@CSpriteVectorShape@@UEAAJIPEAVCExpressionValue@@@Z @ 0x180114EB0
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall CSpriteVectorShape::GetProperty(CSpriteVectorShape *this, int a2, struct CExpressionValue *a3)
{
  ...
  v10[0] = 3LL;
  v10[1] = &CSpriteVectorShape::k_rgAnimDef;
  v4 = 0;
  ...
  {
    v4 = -2147024809;
    MilInstrumentationCheckHR_MaybeFailFast(v6, 0LL, v7, -2147024809, 0x46u);
  }
  return v4;
}
