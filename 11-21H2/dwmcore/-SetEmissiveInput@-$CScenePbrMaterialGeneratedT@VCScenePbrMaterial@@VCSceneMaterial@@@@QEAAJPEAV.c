/*
 * XREFs of ?SetEmissiveInput@?$CScenePbrMaterialGeneratedT@VCScenePbrMaterial@@VCSceneMaterial@@@@QEAAJPEAVCSceneMaterialInput@@@Z @ 0x1801A29D8
 * Callers:
        ...
        struct CResource *a2)
{
  ...
  if ( a2 != this[15] )
  {
    ...
    if ( v5 < 0 )
    {
      MilInstrumentationCheckHR_MaybeFailFast(v6, 0LL, 0LL, v5, 0xD56u);
    }
    else
    {
