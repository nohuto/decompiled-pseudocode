...
CRegion **__fastcall std::_Uninitialized_move<std::unique_ptr<CRegion> *,std::allocator<std::unique_ptr<CRegion>>>(
        CRegion **a1,
        CRegion **a2,
        CRegion **a3)
{
