/*
 * XREFs of ?HrFindInterface@CPathEmitterEdge@EmitterShapes@@MEAAJAEBU_GUID@@PEAPEAX@Z @ 0x180259C40
 * Callers:
 *     <none>
 * Callees:
        ...
        void **a3)
{
  ...
  {
    v4 = -2147467262;
    MilInstrumentationCheckHR_MaybeFailFast((__int64)this, 0LL, 0LL, -2147467262, 0x60u);
  }
  else
  {
    *a3 = this;
