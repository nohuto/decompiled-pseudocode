/*
 * XREFs of ?CalcEyePointOrVector@CCompositionLight@@IEBA?AUfloat4@Numerics@Foundation@Windows@@PEAVCVisual@@@Z @ 0x1801FFDCC
 * Callers:
...
LABEL_6:
  ...
  v46 = v37;
  v47 = v38;
  v23 = o_sqrtf_0((float)(v22 + (float)(v11 * v11)) + (float)(v20 * v20));
  v24 = (float)(v23 + o_sqrtf_0((float)((float)(v13 * v13) + (float)(v12 * v12)) + (float)(v14 * v14))) * 0.5;
  v25 = o_sqrtf_0((float)((float)(v18 * v18) + (float)(v17 * v17)) + (float)(v19 * v19));
  v26 = o_sqrtf_0((float)((float)(v16 * v16) + (float)(v15 * v15)) + (float)(v21 * v21));
