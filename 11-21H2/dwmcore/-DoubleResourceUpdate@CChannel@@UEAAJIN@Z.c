/*
 * XREFs of ?DoubleResourceUpdate@CChannel@@UEAAJIN@Z @ 0x1801AA7A0
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall CChannel::DoubleResourceUpdate(CDataStreamWriter **this, unsigned int a2, double a3)
{
  float v5; // xmm0_4
  unsigned int v6; // ebx
