/*
 * XREFs of ?GetContentOffset@CRemoteAppRenderTarget@@IEBA?AUD2D_POINT_2F@@XZ @ 0x1801C2538
 * Callers:
...
struct D2D_POINT_2F __fastcall CRemoteAppRenderTarget::GetContentOffset(CRemoteAppRenderTarget *this, float *a2)
{
  ...
  CVisual::GetRootTransform(*(CVisual **)(*((_QWORD *)this + 12) + 64LL), (struct CMILMatrix *)v9, 0, 0);
