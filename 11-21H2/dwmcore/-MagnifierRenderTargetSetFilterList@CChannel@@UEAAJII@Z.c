/*
 * XREFs of ?MagnifierRenderTargetSetFilterList@CChannel@@UEAAJII@Z @ 0x1801AB220
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall CChannel::MagnifierRenderTargetSetFilterList(CDataStreamWriter **this, unsigned int a2, int a3)
{
  unsigned int v6; // ebx
