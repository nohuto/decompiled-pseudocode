/*
 * XREFs of ?Initialize@CMesh2DEffect@@UEAAJPEAUID2D1EffectContext@@PEAUID2D1TransformGraph@@@Z @ 0x1802B2470
 * Callers:
 *     <none>
 * Callees:
        ...
        struct ID2D1TransformGraph *a3)
{
  ...
  *((_QWORD *)this + 17) = a2;
  ...
  if ( v5 < 0 )
  {
    MilInstrumentationCheckHR_MaybeFailFast(v6, 0LL, 0LL, v5, 0x8Bu);
  }
  else
  {
    v8 = (*(__int64 (__fastcall **)(struct ID2D1TransformGraph *, char *))(*(_QWORD *)a3 + 40LL))(a3, (char *)this + 8);
    v7 = v8;
    if ( v8 < 0 )
    {
      MilInstrumentationCheckHR_MaybeFailFast(v9, 0LL, 0LL, v8, 0x8Du);
    }
    else
    {
      ...
      if ( v10 < 0 )
      {
        MilInstrumentationCheckHR_MaybeFailFast(v11, 0LL, 0LL, v10, 0x8Eu);
      }
      else
      {
        ...
        else
        {
          ...
          else
          {
            ...
            if ( v16 < 0 )
            {
              MilInstrumentationCheckHR_MaybeFailFast(v17, 0LL, 0LL, v16, 0x91u);
            }
            else
            {
              ...
              if ( v18 < 0 )
              {
                MilInstrumentationCheckHR_MaybeFailFast(v19, 0LL, 0LL, v18, 0x98u);
              }
              else
              {
                ...
                if ( v20 < 0 )
                {
                  MilInstrumentationCheckHR_MaybeFailFast(v21, 0LL, 0LL, v20, 0x9Eu);
                }
                else
                {
                  ...
                  if ( v22 < 0 )
                  {
                    MilInstrumentationCheckHR_MaybeFailFast(v23, 0LL, 0LL, v22, 0xA1u);
                  }
                  else
                  {
                    ...
                    v7 = v25;
                    if ( v25 < 0 )
                      MilInstrumentationCheckHR_MaybeFailFast(v26, 0LL, 0LL, v25, 0xAFu);
                  }
                }
              }
            }
