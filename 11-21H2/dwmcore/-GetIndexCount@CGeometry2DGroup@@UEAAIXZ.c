/*
 * XREFs of ?GetIndexCount@CGeometry2DGroup@@UEAAIXZ @ 0x180207AE0
 * Callers:
 *     <none>
 * Callees:
  ...
  if ( (v3 & 6) == 2 )
  {
    ...
    if ( (v4 & 4) != 0 )
    {
      ...
      if ( *((_DWORD *)this + 26) )
      {
        do
        {
          v7 = *(_QWORD *)(*((_QWORD *)this + 14) + 8LL * v6);
          if ( v7 )
            v5 += (*(__int64 (__fastcall **)(__int64))(*(_QWORD *)v7 + 192LL))(v7);
          ++v6;
        }
