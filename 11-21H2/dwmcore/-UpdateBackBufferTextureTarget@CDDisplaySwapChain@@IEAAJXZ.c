/*
 * XREFs of ?UpdateBackBufferTextureTarget@CDDisplaySwapChain@@IEAAJXZ @ 0x18027C3D0
 * Callers:
...
__int64 __fastcall CDDisplaySwapChain::UpdateBackBufferTextureTarget(CDDisplaySwapChain *this)
{
  ...
  v1 = (unsigned __int64 *)((char *)this + 296);
  v3 = *((_QWORD *)this + 37);
  if ( v3 )
  {
  ...
  if ( v7 )
  {
    ...
    *v1 = 0LL;
    ...
    DeviceTextureTarget = CD3DDevice::CreateDeviceTextureTarget(
                            v7,
                            *(_QWORD *)(32LL * *((unsigned int *)this + 76) + *((_QWORD *)this + 34) + 16),
                            *((_DWORD *)this + 79),
                            *((_DWORD *)this + 80),
                            *((_DWORD *)this + 83),
                            *((_DWORD *)this + 85),
    ...
    {
      MilInstrumentationCheckHR_MaybeFailFast(v11, &dword_180377E10, 2LL, DeviceTextureTarget, 0xB5u);
    }
    else
    {
      v13 = *(int *)(*(_QWORD *)(*v1 + 8) + 8LL) + *v1 + 8;
      (*(void (__fastcall **)(__int64, char *))(*(_QWORD *)v13 + 40LL))(v13, (char *)this + 64);
    }
  }
  else
  {
    v12 = -2003304307;
    MilInstrumentationCheckHR_MaybeFailFast(v3, &dword_180377E10, 2LL, -2003304307, 0xBBu);
  }
  return v12;
}
