/*
 * XREFs of ?SampleInitialValueAndFinalValueIfNecessary@CNaturalAnimation@@AEAAJXZ @ 0x180227558
 * Callers:
...
__int64 __fastcall CNaturalAnimation::SampleInitialValueAndFinalValueIfNecessary(CNaturalAnimation *this)
{
  ...
  __int64 v4; // rcx
  unsigned int v5; // edi
  struct SubchannelMaskInfo *v6; // rdx
  char v7; // cl
  int v8; // eax
  char v9; // al
  int v10; // xmm0_4
  ...
  v6 = (struct SubchannelMaskInfo *)*((_QWORD *)this + 25);
  if ( !v6
    || !*((_BYTE *)v6 + 4)
    || (v3 = CExpressionValue::ApplyMaskToValue((CExpressionValue *)&v16, v6), v5 = v3, v3 >= 0) )
  {
  ...
  v15 = 702;
LABEL_7:
  MilInstrumentationCheckHR_MaybeFailFast(v4, 0LL, 0LL, v3, v15);
LABEL_8:
  Microsoft::WRL::ComPtr<ID2D1PathGeometry>::InternalRelease(&v18);
  return v5;
}
