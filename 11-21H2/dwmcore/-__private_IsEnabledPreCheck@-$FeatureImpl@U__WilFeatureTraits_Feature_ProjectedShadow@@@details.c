/*
 * XREFs of ?__private_IsEnabledPreCheck@?$FeatureImpl@U__WilFeatureTraits_Feature_ProjectedShadow@@@details@wil@@QEAA_NW4ReportingKind@3@@Z @ 0x18010004C
 * Callers:
 *     _dynamic_initializer_for__CPreComputeContext::s_projectedShadowsEnabled__ @ 0x180001380 (_dynamic_initializer_for__CPreComputeContext--s_projectedShadowsEnabled__.c)
 * Callees:
