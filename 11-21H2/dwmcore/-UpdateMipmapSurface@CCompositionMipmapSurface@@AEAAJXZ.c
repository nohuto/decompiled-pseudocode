/*
 * XREFs of ?UpdateMipmapSurface@CCompositionMipmapSurface@@AEAAJXZ @ 0x18020D720
 * Callers:
...
__int64 __fastcall CCompositionMipmapSurface::UpdateMipmapSurface(CCompositionMipmapSurface *this)
{
  ...
  *((_BYTE *)this + 160) = 0;
  ...
  if ( ExistingDevice < 0 )
  {
    MilInstrumentationCheckHR_MaybeFailFast(v5, 0LL, 0LL, ExistingDevice, 0x175u);
    goto LABEL_16;
  }
  v6 = 0;
  if ( !*((_DWORD *)this + 34) )
...
LABEL_11:
  ...
  while ( 1 )
  {
    ...
    if ( v14 < 0 )
    {
      MilInstrumentationCheckHR_MaybeFailFast(v15, 0LL, 0LL, v14, 0x183u);
      Microsoft::WRL::ComPtr<CD3DSurface>::InternalRelease((__int64 *)&v26);
      goto LABEL_13;
    }
    v16 = *((_QWORD *)this + 12);
...
LABEL_10:
  ...
  MilInstrumentationCheckHR_MaybeFailFast(v11, 0LL, 0LL, CurrentRenderingRealization, 0x17Cu);
LABEL_13:
  Microsoft::WRL::ComPtr<CD3DSurface>::InternalRelease((__int64 *)&v25);
LABEL_16:
  Microsoft::WRL::ComPtr<CD3DDevice>::InternalRelease(&v24);
