/*
 * XREFs of ?ProcessCreate@CMagnifierRenderTarget@@QEAAJPEAVCResourceTable@@PEBUtagMILCMD_MAGNIFIERRENDERTARGET_CREATE@@@Z @ 0x1801C7D84
 * Callers:
        ...
        const struct tagMILCMD_MAGNIFIERRENDERTARGET_CREATE *a3)
{
  ...
  *((_QWORD *)this + 230) = *((_QWORD *)a3 + 1);
  ...
  if ( updated < 0 )
  {
    MilInstrumentationCheckHR_MaybeFailFast(v6, 0LL, 0LL, updated, 0x52u);
  }
  else
  {
    ...
    *((_DWORD *)this + 27) = *((_DWORD *)a3 + 7);
    ...
    {
      v7 = -2147024809;
      MilInstrumentationCheckHR_MaybeFailFast((__int64)v8, 0LL, 0LL, -2147024809, 0x59u);
    }
  }
  return v7;
}
