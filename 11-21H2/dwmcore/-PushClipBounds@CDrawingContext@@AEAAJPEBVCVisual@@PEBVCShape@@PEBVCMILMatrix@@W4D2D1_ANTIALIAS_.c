/*
 * XREFs of ?PushClipBounds@CDrawingContext@@AEAAJPEBVCVisual@@PEBVCShape@@PEBVCMILMatrix@@W4D2D1_ANTIALIAS_MODE@@@Z @ 0x1800104B4
 * Callers:
        ...
        enum D2D1_ANTIALIAS_MODE a5)
{
  ...
  *((_QWORD *)&v18 + 1) = a2;
  LODWORD(v18) = 3;
  v9 = CWatermarkStack<CDrawingContext::StackStateEntry,64,2,10>::Push((char *)this + 336, &v18);
  v11 = v9;
  if ( v9 < 0 )
  {
    MilInstrumentationCheckHR_MaybeFailFast(v10, 0LL, 0, v9, 0xC51u, 0LL);
    return v11;
  }
  v12 = *(_QWORD *)a3;
  v18 = 0LL;
  ...
  if ( v13 < 0 )
  {
    MilInstrumentationCheckHR_MaybeFailFast(v14, 0LL, 0, v13, 0xC57u, 0LL);
    goto LABEL_7;
  }
  v15 = CScopedClipStack::PushClipBoundsToScope((char *)this + 864, &v18, (unsigned int)a5);
  v11 = v15;
  if ( v15 < 0 )
  {
    MilInstrumentationCheckHR_MaybeFailFast(v16, 0LL, 0, v15, 0xC59u, 0LL);
LABEL_7:
