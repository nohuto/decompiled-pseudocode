/*
 * XREFs of ?GetFailureLogString@wil@@YAJPEAG_KAEBUFailureInfo@1@@Z @ 0x180177C60
 * Callers:
 ...
 *     ?LogStringPrintf@details@wil@@YAPEAGPEAGPEBG1ZZ @ 0x1801780C8 (-LogStringPrintf@details@wil@@YAPEAGPEAGPEBG1ZZ.c)
 */
