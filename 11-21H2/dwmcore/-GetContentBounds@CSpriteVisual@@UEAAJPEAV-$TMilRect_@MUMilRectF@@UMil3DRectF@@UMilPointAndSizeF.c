/*
 * XREFs of ?GetContentBounds@CSpriteVisual@@UEAAJPEAV?$TMilRect_@MUMilRectF@@UMil3DRectF@@UMilPointAndSizeF@@UNotNeeded@RectUniqueness@@@@@Z @ 0x180062D40
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall CSpriteVisual::GetContentBounds(CSpriteVisual *this, __int64 a2)
{
  ...
  else if ( (**((_DWORD **)this + 29) & 0x10000) != 0 )
  {
    ...
    if ( v10 < 0 )
      ...
      TMilRect<float,MilRectF,Mil3DRectF,RectUniqueness::NotNeeded>::UnionUnsafe(a2, &v12);
  }
  return v6;
}
