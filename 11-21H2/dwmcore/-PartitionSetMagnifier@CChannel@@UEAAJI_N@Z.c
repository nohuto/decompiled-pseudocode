/*
 * XREFs of ?PartitionSetMagnifier@CChannel@@UEAAJI_N@Z @ 0x1801ABB10
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall CChannel::PartitionSetMagnifier(CDataStreamWriter **this, int a2, unsigned __int8 a3)
{
  unsigned int v6; // ebx
