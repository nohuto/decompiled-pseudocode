/*
 * XREFs of ?GetCachedFeatureEnabledState@?$FeatureImpl@U__WilFeatureTraits_Feature_VTest@@@details@wil@@AEAA?ATwil_details_FeatureStateCache@@XZ @ 0x1801B288C
 * Callers:
 ...
 *     ?GetCurrentFeatureEnabledState@?$FeatureImpl@U__WilFeatureTraits_Feature_VTest@@@details@wil@@AEAA?ATwil_details_FeatureStateCache@@PEAH@Z @ 0x1801B2A04 (-GetCurrentFeatureEnabledState@-$FeatureImpl@U__WilFeatureTraits_Feature_VTest@@@details@wil@@AE.c)
 */
        ...
        signed __int32 *a2)
{
  ...
  RTL_SRWLOCK *v16; // [rsp+60h] [rbp+18h] BYREF
  ...
  *a2 = *a1;
  if ( (v2 & 3) != 3 )
  {
    ...
    wil::details::FeatureImpl<__WilFeatureTraits_Feature_VTest>::GetCurrentFeatureEnabledState(a1, &v15, &v14);
    v6 = *a2;
    do
    {
      v7 = v14 == 0;
    ...
    if ( !v10 && wil::details::g_enabledStateManager )
    {
      ...
      if ( !v5
        || v5 != dword_1803D3544
        || (v12 = 3, v13 = a1, !wil::details_abi::heap_buffer::push_back((void **)&xmmword_1803D3578, &v12, 0x10uLL)) )
      {
