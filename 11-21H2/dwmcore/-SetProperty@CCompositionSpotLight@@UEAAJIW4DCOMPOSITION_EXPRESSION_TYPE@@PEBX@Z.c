/*
 * XREFs of ?SetProperty@CCompositionSpotLight@@UEAAJIW4DCOMPOSITION_EXPRESSION_TYPE@@PEBX@Z @ 0x1800C5050
 * Callers:
 *     <none>
 * Callees:
...
LABEL_2:
  ...
  {
    v10 = -2147024809;
    MilInstrumentationCheckHR_MaybeFailFast(v6, 0LL, 0LL, -2147024809, 0xD1u);
    return v10;
  }
LABEL_3:
  ...
  v10 = v8;
  if ( v8 < 0 )
    MilInstrumentationCheckHR_MaybeFailFast(v9, 0LL, 0LL, v8, 0xCDu);
  return v10;
}
