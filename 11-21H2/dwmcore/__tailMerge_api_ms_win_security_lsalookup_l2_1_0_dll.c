/*
 * XREFs of __tailMerge_api_ms_win_security_lsalookup_l2_1_0_dll @ 0x180102D00
 * Callers:
 *     __imp_load_LookupPrivilegeValueW @ 0x180102CF4 (__imp_load_LookupPrivilegeValueW.c)
 * Callees:
