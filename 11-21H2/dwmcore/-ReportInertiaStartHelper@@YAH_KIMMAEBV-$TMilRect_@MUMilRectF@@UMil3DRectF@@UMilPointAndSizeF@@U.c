/*
 * XREFs of ?ReportInertiaStartHelper@@YAH_KIMMAEBV?$TMilRect_@MUMilRectF@@UMil3DRectF@@UMilPointAndSizeF@@UNotNeeded@RectUniqueness@@@@AEBU_D3DMATRIX@@@Z @ 0x18017921C
 * Callers:
 ...
 *     InputTypeToInertiaSourceType @ 0x1801791E0 (InputTypeToInertiaSourceType.c)
 */
...
__int64 __fastcall ReportInertiaStartHelper(__int64 a1, int a2, float a3, float a4, float *a5, _DWORD *a6)
{
  ...
  *(float *)&v21[1] = a4;
  ...
  v10 = a5[1];
  v22[0] = v9;
  v11 = (int)o_ceilf_0(v10);
  v12 = a5[2];
  v22[1] = v11;
  v13 = (int)o_ceilf_0(v12);
  v14 = a5[3];
  v22[2] = v13;
  v22[3] = (int)o_ceilf_0(v14);
  v15 = a6[1];
  v22[4] = *a6;
  v16 = a6[4];
  v22[5] = v15;
