/*
 * XREFs of ?Update@BulkAnimator@Particles@@SAXPEBVIThreeInputAnimator@2@UParticleStreamInfo@2@111I@Z @ 0x18022AE4C
 * Callers:
  ...
  if ( a6 )
  {
    ...
    while ( 1 )
    {
      ...
      if ( v23[0] == -1LL || !v18 && v23[0] )
        goto LABEL_17;
      v20 = *(_QWORD *)a2 + 4 * (*(unsigned int *)(a2 + 8) + (unsigned __int64)(v13 * *(_DWORD *)(a2 + 12)));
