/*
 * XREFs of ?ProcessTrigger@CLegacyAnimationTrigger@@QEAAJPEAVCResourceTable@@PEBUtagMILCMD_LEGACYANIMATIONTRIGGER_TRIGGER@@@Z @ 0x180244A18
 * Callers:
...
LABEL_8:
  ...
  MilInstrumentationCheckHR_MaybeFailFast(v9, 0LL, 0LL, v8, 0x21u);
  return (unsigned int)v4;
}
