/*
 * XREFs of ?Update@CDrawListCache@@QEAAXPEAVCDrawingContext@@PEAVCDrawListEntryBuilder@@@Z @ 0x180087148
 * Callers:
        ...
        struct CDrawListEntryBuilder *a3)
{
  ...
  v5 = *((_DWORD *)a2 + 76) != 0;
  if ( *((_BYTE *)a2 + 7920) )
    v6 = *(_QWORD *)(*((_QWORD *)a2 + 991) + 4704LL);
  else
    v6 = 0LL;
  CDrawListCache::Update(
    ...
    *((struct CDrawListEntry ***)a3 + 5),
    (__int64)(*((_QWORD *)a3 + 6) - *((_QWORD *)a3 + 5)) >> 3,
    v5,
    *((_BYTE *)a3 + 4424));
  if ( (*((_BYTE *)this + 88) & 0x40) != 0 )
  {
    v8 = 0;
    CMatrixStack::Top((struct CDrawingContext *)((char *)a2 + 368), (struct CMILMatrix *)v7);
    if ( !CMILMatrix::Get2DScaleDimensionsWithPerspective((CMILMatrix *)v7, (float *)this + 20, (float *)this + 21, 0LL) )
      *((_DWORD *)this + 22) |= 0x100u;
  }
  if ( *(_BYTE *)(*((_QWORD *)a2 + 5) + 1509LL) )
    *((_BYTE *)this + 101) = 1;
}
