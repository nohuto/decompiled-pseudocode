/*
 * XREFs of ?Is2DAxisAlignedIntegerPreserving@CMILMatrix@@QEBA_NXZ @ 0x18026062C
 * Callers:
...
char __fastcall CMILMatrix::Is2DAxisAlignedIntegerPreserving(CMILMatrix *this, __int64 a2, __int64 a3, __int64 a4)
{
  char v5; // al
  char v6; // cl
  float v7; // xmm3_4
  ...
  float v29; // [rsp+58h] [rbp+10h]
  float v30; // [rsp+58h] [rbp+10h]
  float v31; // [rsp+58h] [rbp+10h]

  v5 = CMILMatrix::Is2DAxisAlignedPreserving(this, a2, a3, a4);
  v6 = 0;
  if ( v5 )
  {
    v7 = *(float *)this;
    ...
    if ( COERCE_FLOAT(COERCE_UNSIGNED_INT(v7 - (float)v8) & _xmm) <= 0.000081380211 )
    {
      ...
      if ( COERCE_FLOAT(COERCE_UNSIGNED_INT(v10 - (float)v11) & _xmm) <= 0.000081380211 )
      {
        ...
        if ( COERCE_FLOAT(COERCE_UNSIGNED_INT(v13 - (float)v14) & _xmm) <= 0.000081380211 )
        {
          ...
          {
            v29 = v16 + 6291456.25;
            v17 = (int)(LODWORD(v29) << 10) >> 11;
          }
          if ( COERCE_FLOAT(COERCE_UNSIGNED_INT(v16 - (float)v17) & _xmm) <= 0.000081380211 )
          {
            v19 = *((float *)this + 12);
            ...
            if ( COERCE_FLOAT(COERCE_UNSIGNED_INT(v19 - (float)v20) & _xmm) <= 0.00390625 )
            {
              ...
              if ( (LODWORD(v22) & 0x7FFFFFFFu) > 0x497FFFF0 )
              {
                ...
                v23 = (int)v22 - _mm_cmple_ss(v24, (__m128)LODWORD(FLOAT_N0_5)).m128_u32[0];
              }
              else
              {
                v31 = v22 + 6291456.25;
              ...
              if ( COERCE_FLOAT(COERCE_UNSIGNED_INT(v22 - (float)v23) & _xmm) <= 0.00390625 )
                return 1;
            }
          }
        }
