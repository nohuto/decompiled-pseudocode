/*
 * XREFs of ?CopyFrom@CAtlasTexture@@QEAAXPEBV1@PEAI@Z @ 0x18028CDC4
 * Callers:
 ...
 *     ?IsFreeEntryInRow@CAtlasTexture@@QEBA_NI@Z @ 0x18028D074 (-IsFreeEntryInRow@CAtlasTexture@@QEBA_NI@Z.c)
 *     ?IsInUseEntryInRow@CAtlasTexture@@QEBA_NI@Z @ 0x18028D0A4 (-IsInUseEntryInRow@CAtlasTexture@@QEBA_NI@Z.c)
 */
...
void __fastcall CAtlasTexture::CopyFrom(CAtlasTexture *this, const struct CAtlasTexture *a2, unsigned int *a3)
{
  ...
  void *v37[10]; // [rsp+A0h] [rbp-39h] BYREF
...
LABEL_6:
        ...
        CD3DDevice::CopySubresourceRegion(v16, v18, 0, (int *)&v31, v17, 0, 0, v7, 1);
