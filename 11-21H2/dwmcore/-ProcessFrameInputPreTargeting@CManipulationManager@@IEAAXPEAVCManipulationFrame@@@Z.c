/*
 * XREFs of ?ProcessFrameInputPreTargeting@CManipulationManager@@IEAAXPEAVCManipulationFrame@@@Z @ 0x18017D980
 * Callers:
        ...
        struct CManipulationFrame *a2)
{
  ...
  char v39; // r10
  __int64 v40; // rdx
  CManipulationContext *v41; // rcx
  void *v42; // [rsp+30h] [rbp-E8h]
  __int64 v43; // [rsp+40h] [rbp-D8h] BYREF
  __int128 v44; // [rsp+50h] [rbp-C8h]
  ...
  __int128 v51; // [rsp+C0h] [rbp-58h]
  __int128 v52; // [rsp+D0h] [rbp-48h]
  bool IsMousewheelFrame; // [rsp+128h] [rbp+10h]
  unsigned __int64 v54; // [rsp+130h] [rbp+18h] BYREF
  struct CInteraction *v55; // [rsp+138h] [rbp+20h] BYREF
...
LABEL_15:
      if ( (unsigned int)QpcTimeConverter::QpcToMicroSec(v10, *(_QWORD *)((char *)a2 + v11 + 448), &v54) )
      {
        v15 = v54;
      }
      else
      ...
      *((_QWORD *)this + 40) = v15;
      ...
      if ( (((v16 & 0x20006) - 0x20000) & 0xFFFFFFFD) == 0 || (v16 & 0x810000) != 0 || v8 )
      {
        ...
        v43 = v44;
        CInteraction::ResolveInteractionHandle(v28, v20, &v55);
        v29 = v55;
        if ( v55 )
        {
          ...
          if ( (v30 & 0x10000) != 0 || v8 )
          {
            ...
            {
              v40 = *(unsigned int *)((char *)a2 + v11 + 372);
              CManipulationManager::s_needsStopAndEndInertia = 0;
              StopAndEndInertia(0LL, v40);
            }
            if ( (*((_BYTE *)a2 + v11 + 380) & 1) == 0 )
            {
              v41 = (CManipulationContext *)*((_QWORD *)this + 33);
              if ( v41 )
                CManipulationContext::OnContactHoverDepart(v41, *(_DWORD *)((char *)a2 + v11 + 372));
            }
          }
          ...
          {
            v33 = (CManipulationContext **)((char *)this + 264);
            if ( *((_QWORD *)this + 33) )
              goto LABEL_35;
...
LABEL_35:
                ...
                CManipulationContext::OnHoverContact(v36, v29, *(unsigned int *)((char *)a2 + v11 + 372), v35);
              }
            }
            v8 = IsMousewheelFrame;
          }
