/*
 * XREFs of ?ProcessAddExclusiveView@CHolographicClient@@AEAAXPEAUIUnknown@@@Z @ 0x18029DFA4
 * Callers:
...
void __fastcall CHolographicClient::ProcessAddExclusiveView(CHolographicClient *this, struct IUnknown *a2)
{
         ...
         &v8) >= 0 )
  {
    ...
    v6 = DynArrayImpl<0>::AddMultipleAndSet((unsigned __int64)this + 72, 8u, 1, &v8);
    if ( v6 < 0 )
    {
