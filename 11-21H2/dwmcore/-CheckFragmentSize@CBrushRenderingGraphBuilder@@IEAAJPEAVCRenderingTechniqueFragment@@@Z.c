/*
 * XREFs of ?CheckFragmentSize@CBrushRenderingGraphBuilder@@IEAAJPEAVCRenderingTechniqueFragment@@@Z @ 0x180037300
 * Callers:
        ...
        struct CRenderingTechniqueFragment *a2)
{
  ...
  while ( CRenderingTechniqueFragment::NeedsToBeBrokenUp(a2, *this) )
  {
    ...
    v8 = CBrushRenderingGraphBuilder::CreateTechniqueForFragment(this, &v11, &v10);
    v5 = v8;
    if ( v8 < 0 )
    {
