/*
 * XREFs of ?SetProperty@CNaturalAnimation@@UEAAJIW4DCOMPOSITION_EXPRESSION_TYPE@@PEBX@Z @ 0x1802277E0
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall CNaturalAnimation::SetProperty(CNaturalAnimation *a1, unsigned int a2, int a3, float *a4)
{
  ...
  switch ( a3 )
  {
    ...
    case 52:
      ...
      v8 = 567;
LABEL_14:
      MilInstrumentationCheckHR_MaybeFailFast(v6, 0LL, 0LL, v5, v8);
      return v4;
  }
  v4 = -2147024809;
  MilInstrumentationCheckHR_MaybeFailFast((__int64)a1, 0LL, 0LL, -2147024809, 0x23Fu);
  return v4;
}
