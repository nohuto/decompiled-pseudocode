/*
 * XREFs of ?CompactSingleAtlas@CAtlasManager@@AEAAJPEA_N@Z @ 0x1800E5708
 * Callers:
 *     ?CompactAtlases@CAtlasManager@@QEAAXXZ @ 0x1800808F0 (-CompactAtlases@CAtlasManager@@QEAAXXZ.c)
 * Callees:
 *     ?MilInstrumentationCheckHR_MaybeFailFast@@YAXKQEBJIJIPEAX@Z @ 0x1800734B4 (-MilInstrumentationCheckHR_MaybeFailFast@@YAXKQEBJIJIPEAX@Z.c)
 *     ?DetermineIdealAtlasSize@CAtlasManager@@CAII@Z @ 0x1800E5770 (-DetermineIdealAtlasSize@CAtlasManager@@CAII@Z.c)
...
__int64 __fastcall CAtlasManager::CompactSingleAtlas(const struct CAtlasTexture ***this, bool *a2)
{
  ...
  if ( v6 < v8 )
  {
    ...
    if ( v4 < 0 )
    {
      MilInstrumentationCheckHR_MaybeFailFast(v10, 0LL, 0LL, v4, 0x7Bu);
    }
    else
    {
      v12 = *v2;
