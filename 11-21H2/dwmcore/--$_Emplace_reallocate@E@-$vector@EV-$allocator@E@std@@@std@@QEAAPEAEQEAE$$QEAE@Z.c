/*
 * XREFs of ??$_Emplace_reallocate@E@?$vector@EV?$allocator@E@std@@@std@@QEAAPEAEQEAE$$QEAE@Z @ 0x1800CEAFC
 * Callers:
...
char *__fastcall std::vector<unsigned char>::_Emplace_reallocate<unsigned char>(_QWORD *a1, char *a2, char *a3)
{
  _BYTE *v3; // rbp
  __int64 v6; // rax
  __int64 v8; // r15
