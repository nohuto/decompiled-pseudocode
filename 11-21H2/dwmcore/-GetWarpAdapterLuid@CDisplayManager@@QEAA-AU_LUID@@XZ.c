/*
 * XREFs of ?GetWarpAdapterLuid@CDisplayManager@@QEAA?AU_LUID@@XZ @ 0x180277568
 * Callers:
...
struct _LUID __fastcall CDisplayManager::GetWarpAdapterLuid(_RTL_CRITICAL_SECTION *this, struct _LUID *a2)
{
