/*
 * XREFs of ?RenderMask@CTreeEffectLayer@@AEAAJAEBUD2D_SIZE_F@@PEAVCDrawingContext@@PEAVIRenderTargetBitmap@@@Z @ 0x1801DB040
 * Callers:
        ...
        struct IRenderTargetBitmap *a4)
{
  ...
  float v19[4]; // [rsp+50h] [rbp-38h] BYREF
  ...
  v17 = v15;
  if ( v15 < 0 )
    MilInstrumentationCheckHR_MaybeFailFast(v16, 0LL, 0LL, v15, 0x34Au);
  return v17;
}
