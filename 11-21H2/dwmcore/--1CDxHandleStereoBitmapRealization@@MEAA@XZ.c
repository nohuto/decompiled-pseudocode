/*
 * XREFs of ??1CDxHandleStereoBitmapRealization@@MEAA@XZ @ 0x1802A468C
 * Callers:
        ...
        CDxHandleStereoBitmapRealization *this)
{
  ...
  *(_DWORD *)((char *)this + (_QWORD)v6 + 12) = (_DWORD)v6 - 576;
  ...
  wil::com_ptr_t<CVisual,wil::err_returncode_policy>::~com_ptr_t<CVisual,wil::err_returncode_policy>((__int64 *)this + 50);
