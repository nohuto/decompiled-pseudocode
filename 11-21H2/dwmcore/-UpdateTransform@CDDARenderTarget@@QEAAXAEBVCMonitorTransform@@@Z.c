/*
 * XREFs of ?UpdateTransform@CDDARenderTarget@@QEAAXAEBVCMonitorTransform@@@Z @ 0x1801E16EC
 * Callers:
...
void __fastcall CDDARenderTarget::UpdateTransform(CDDARenderTarget *this, const struct CMonitorTransform *a2)
{
  ...
  v6 = *(float *)a2;
  v11 = 0LL;
  CMonitorTransform::Initialize((__int64)this + 200, (unsigned int *)&v11, (__int64)a2 + 4, v6, v5, 0LL);
