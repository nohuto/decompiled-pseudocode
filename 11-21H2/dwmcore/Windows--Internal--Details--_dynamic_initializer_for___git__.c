/*
 * XREFs of Windows::Internal::Details::_dynamic_initializer_for___git__ @ 0x180003E60
 * Callers:
 *     <none>
 * Callees:
 *     ??0Git@Details@Internal@Windows@@QEAA@XZ @ 0x18010008C (--0Git@Details@Internal@Windows@@QEAA@XZ.c)
 */
