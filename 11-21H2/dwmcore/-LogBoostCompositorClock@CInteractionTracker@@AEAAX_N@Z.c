/*
 * XREFs of ?LogBoostCompositorClock@CInteractionTracker@@AEAAX_N@Z @ 0x18021B694
 * Callers:
...
void __fastcall CInteractionTracker::LogBoostCompositorClock(CInteractionTracker *this)
{
  ...
  if ( (unsigned int)dword_1803D0EF0 > 5 )
  {
    if ( tlgKeywordOn((__int64)&dword_1803D0EF0, 2LL) )
    {
      ...
      v3 = v2;
      v6 = 4;
      tlgWriteTransfer_EventWriteTransfer(v1, (unsigned __int8 *)dword_18037134B, 0LL, 0LL, 3u, &v4);
    }
  }
}
