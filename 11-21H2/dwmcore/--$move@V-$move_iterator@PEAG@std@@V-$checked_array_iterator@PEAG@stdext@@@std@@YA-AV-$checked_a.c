/*
 * XREFs of ??$move@V?$move_iterator@PEAG@std@@V?$checked_array_iterator@PEAG@stdext@@@std@@YA?AV?$checked_array_iterator@PEAG@stdext@@V?$move_iterator@PEAG@0@0V12@@Z @ 0x1801E2700
 * Callers:
...
LABEL_7:
  ...
  memmove_0(v10, a2, v5);
  result = a1;
  a4[2] = (__int64)((__int64)v10 + v5 - v9) >> 1;
  v12 = a4[2];
  *(_OWORD *)a1 = *(_OWORD *)a4;
  *(_QWORD *)(a1 + 16) = v12;
  return result;
