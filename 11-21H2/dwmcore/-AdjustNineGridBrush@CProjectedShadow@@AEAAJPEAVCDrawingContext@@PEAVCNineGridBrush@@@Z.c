/*
 * XREFs of ?AdjustNineGridBrush@CProjectedShadow@@AEAAJPEAVCDrawingContext@@PEAVCNineGridBrush@@@Z @ 0x180232ADC
 * Callers:
        ...
        CSurfaceBrush **a3)
{
  ...
  CProjectedShadow::CalculateBounds(this, &v22, a3, *((_QWORD *)a2 + 991));
  v5 = FLOAT_161_0;
  m11 = v22.m11;
  v7 = FLOAT_161_0;
  v8 = v22.m21 - v22.m11;
  ...
  *(_QWORD *)&v22.m11 = 0xC2800000C2800000uLL;
  ...
  {
    v14 = -2147024882;
    MilInstrumentationCheckHR_MaybeFailFast(v12, 0LL, 0LL, -2147024882, 0x481u);
LABEL_16:
    wil::com_ptr_t<ID3D11Resource,wil::err_returncode_policy>::~com_ptr_t<ID3D11Resource,wil::err_returncode_policy>((__int64 *)&v20);
    return v14;
  }
  v15 = ((__int64 (__fastcall *)(char *, void *, float *))xmmword_1803D0088)(
          (char *)v20 + SDWORD2(xmmword_1803D0088),
  ...
  v15 = ((__int64 (__fastcall *)(char *, void *, struct D2D_MATRIX_3X2_F *))xmmword_1803D00C0)(
          (char *)v13 + SDWORD2(xmmword_1803D00C0),
  ...
  if ( v15 < 0 )
  {
    v19 = 1159;
LABEL_15:
    MilInstrumentationCheckHR_MaybeFailFast(v16, 0LL, 0LL, v15, v19);
    goto LABEL_16;
  }
  wil::com_ptr_t<ID3D11Resource,wil::err_returncode_policy>::~com_ptr_t<ID3D11Resource,wil::err_returncode_policy>((__int64 *)&v20);
  v22.m21 = 0.0;
