/*
 * XREFs of ??$_Emplace_reallocate@D@?$vector@DV?$allocator@D@std@@@std@@QEAAPEADQEAD$$QEAD@Z @ 0x1800E82C0
 * Callers:
...
char *__fastcall std::vector<char>::_Emplace_reallocate<char>(__int64 *a1, char *a2, char *a3)
{
  _BYTE *v3; // rbp
  __int64 v6; // rax
  __int64 v8; // r15
