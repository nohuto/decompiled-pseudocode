/*
 * XREFs of std::_Insertion_sort_unchecked_std::shared_ptr_CCursorState::ShapeData____std::_Ref_fn__lambda_4f96f9abf6f4efc73c76f9e3716c5312_____ @ 0x180268098
 * Callers:
...
_QWORD *__fastcall std::_Insertion_sort_unchecked_std::shared_ptr_CCursorState::ShapeData____std::_Ref_fn__lambda_4f96f9abf6f4efc73c76f9e3716c5312_____(
        _QWORD *a1,
        _QWORD *a2,
        __int64 a3)
{
      ...
      else
      {
        while ( 1 )
        {
          ...
          if ( !(unsigned __int8)std::_Ref_fn__lambda_4f96f9abf6f4efc73c76f9e3716c5312___::operator()_std::shared_ptr_CCursorState::ShapeData____std::shared_ptr_CCursorState::ShapeData____(
                                   ...
                                   v9) )
            break;
          std::shared_ptr<CCursorState::ShapeData>::operator=(v8, v9);
          v8 = v9;
        }
      }
      std::shared_ptr<CCursorState::ShapeData>::operator=(v8, &v12);
      if ( v13 )
