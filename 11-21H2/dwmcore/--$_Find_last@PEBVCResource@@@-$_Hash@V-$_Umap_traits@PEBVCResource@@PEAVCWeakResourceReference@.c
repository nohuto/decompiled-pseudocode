        ...
        __int64 a4)
{
  ...
  v4 = *(_QWORD **)(qword_1803D37C8 + 16 * (a4 & xmmword_1803D37E0) + 8);
  if ( v4 == (_QWORD *)qword_1803D37B8 )
  {
    *a2 = qword_1803D37B8;
  }
  else
  {
    while ( 1 )
    {
      ...
      if ( v4 == *(_QWORD **)(qword_1803D37C8 + 16 * (a4 & xmmword_1803D37E0)) )
        break;
      v4 = (_QWORD *)v4[1];
    }
    *a2 = v4;
