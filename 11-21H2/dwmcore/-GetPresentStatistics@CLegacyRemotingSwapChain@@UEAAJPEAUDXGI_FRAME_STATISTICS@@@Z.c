/*
 * XREFs of ?GetPresentStatistics@CLegacyRemotingSwapChain@@UEAAJPEAUDXGI_FRAME_STATISTICS@@@Z @ 0x180294100
 * Callers:
 *     <none>
 * Callees:
        ...
        struct DXGI_FRAME_STATISTICS *a2)
{
  ...
  {
    MilInstrumentationCheckHR_MaybeFailFast(v4, 0LL, 0LL, PresentStatisticsDWM, 0xB5u);
  }
  else
  {
    v6 = v8[0];
