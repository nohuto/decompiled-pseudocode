/*
 * XREFs of ?EnqueueComputeScribbleOnHost@CGenericInk@@UEAAJ_KPEAVCComputeScribble@@@Z @ 0x180215820
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall CGenericInk::EnqueueComputeScribbleOnHost(void **this, __int64 a2, struct CComputeScribble *a3)
{
  ...
  __int64 v9; // r14
  char *v10; // rbx
  __int64 (__fastcall *v11)(struct CComputeScribble *, _QWORD *); // r12
  gsl::details *v12; // rcx
  int v13; // eax
