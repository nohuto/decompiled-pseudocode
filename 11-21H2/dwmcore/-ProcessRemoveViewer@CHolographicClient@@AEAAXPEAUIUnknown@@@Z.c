/*
 * XREFs of ?ProcessRemoveViewer@CHolographicClient@@AEAAXPEAUIUnknown@@@Z @ 0x18029EBC0
 * Callers:
 ...
 *     ?Remove@?$DynArray@PEAUIHolographicViewer@@$0A@@@QEAAHAEBQEAUIHolographicViewer@@@Z @ 0x18029F070 (-Remove@-$DynArray@PEAUIHolographicViewer@@$0A@@@QEAAHAEBQEAUIHolographicViewer@@@Z.c)
 */
