/*
 * XREFs of ??$SetProperty@U_D3DCOLORVALUE@@@DataSourcePropertySet@@QEAAJIPEBU_D3DCOLORVALUE@@W4DCOMPOSITION_EXPRESSION_TYPE@@@Z @ 0x1801BBCF4
 * Callers:
...
__int64 __fastcall DataSourcePropertySet::SetProperty<_D3DCOLORVALUE>(__int64 a1, int a2, __int128 *a3)
{
  ...
  if ( v20 == *(_QWORD *)(a1 + 8) )
  {
    v6 = PropertySetStorage<DynArrayNoZero,PropertySetUserModeAllocator>::AddProperty<_D3DCOLORVALUE>(v5, 70, a3, &v22);
    v7 = v6;
    if ( v6 < 0 )
    {
