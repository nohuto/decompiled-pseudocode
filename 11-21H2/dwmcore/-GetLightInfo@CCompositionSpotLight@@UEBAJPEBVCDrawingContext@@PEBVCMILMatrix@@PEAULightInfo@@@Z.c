/*
 * XREFs of ?GetLightInfo@CCompositionSpotLight@@UEBAJPEBVCDrawingContext@@PEBVCMILMatrix@@PEAULightInfo@@@Z @ 0x18020F720
 * Callers:
 *     <none>
 * Callees:
  ...
  else
  {
    ...
    *((_DWORD *)a4 + 14) = *((_DWORD *)this + 94);
    ...
    if ( v16 >= 0.0 )
      ...
      v18 = 0.0;
    *((float *)a4 + 18) = cosf(v18);
    v19 = *((float *)this + 96);
    if ( v19 >= 0.0 )
      v17 = fminf(1.5707964, v19);
    *((float *)a4 + 19) = cosf(v17);
  }
  return v14;
}
