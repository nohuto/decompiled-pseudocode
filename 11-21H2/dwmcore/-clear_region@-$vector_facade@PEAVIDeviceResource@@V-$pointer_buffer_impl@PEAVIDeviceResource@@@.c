/*
 * XREFs of ?clear_region@?$vector_facade@PEAVIDeviceResource@@V?$pointer_buffer_impl@PEAVIDeviceResource@@@detail@@@detail@@IEAAX_K0@Z @ 0x1800AF17C
 * Callers:
        ...
        unsigned __int64 a3)
{
  ...
  v6 = detail::pointer_buffer_impl<IDeviceResource *>::first(a1) + 8 * v5;
  v7 = (v6 - detail::pointer_buffer_impl<IDeviceResource *>::first(a1)) >> 3;
  if ( a3 > v7 )
  {
...
LABEL_5:
  ...
  return detail::pointer_buffer_impl<IDeviceResource *>::consume(a1, -(__int64)a3, v9);
}
