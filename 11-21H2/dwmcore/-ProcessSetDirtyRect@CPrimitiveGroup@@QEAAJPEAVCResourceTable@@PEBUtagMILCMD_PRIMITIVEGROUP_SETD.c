/*
 * XREFs of ?ProcessSetDirtyRect@CPrimitiveGroup@@QEAAJPEAVCResourceTable@@PEBUtagMILCMD_PRIMITIVEGROUP_SETDIRTYRECT@@PEBXI@Z @ 0x1800E3D90
 * Callers:
        ...
        unsigned int a5)
{
  ...
  _DWORD v24[4]; // [rsp+88h] [rbp+Fh] BYREF
        ...
        (const struct FastRegion::Internal::CRgnData **)a5 == this) )
  {
    ...
    while ( 1 )
    {
      ...
      v20[0] = 0;
      v19 = v20;
      v13 = PixelAlign(v24, (__int64)v12);
      v14 = v13[2];
      v15 = *v13;
      v16 = v13[3];
  ...
  {
    MilInstrumentationCheckHR_MaybeFailFast((__int64)this, 0LL, 0LL, -2003303421, 0x217u);
  }
  *(_DWORD *)v8[69] = 0;
  if ( v9 )
