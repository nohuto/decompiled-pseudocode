/*
 * XREFs of ?SetParticleGenerator@?$CParticleEmitterVisualGeneratedT@VCParticleEmitterVisual@@VCVisual@@@@QEAAJPEAVCParticleGenerator@@@Z @ 0x1801A435C
 * Callers:
        ...
        struct CResource *a2)
{
  ...
  if ( a2 != this[107] )
  {
    ...
    if ( v5 < 0 )
    {
      MilInstrumentationCheckHR_MaybeFailFast(v6, 0LL, 0LL, v5, 0x1E70u);
    }
    else
    {
