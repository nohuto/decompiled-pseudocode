/*
 * XREFs of ?CalculateValueWorker@CScrollAnimation@@UEAAJPEAVCExpressionValueStack@@_KPEA_N@Z @ 0x180254250
 * Callers:
 *     <none>
 * Callees:
...
LABEL_4:
    *((_DWORD *)this + 106) = 0;
    DynArrayImpl<0>::ShrinkToSize((__int64)this + 400, 4u);
    InteractionTracker = CScrollAnimation::GetInteractionTracker(this);
    v14 = CScrollAnimation::CalculateValueForState(this, a2, a3, *((_DWORD *)InteractionTracker + 44), &v19);
    v12 = v14;
    if ( v14 < 0 )
    {
      MilInstrumentationCheckHR_MaybeFailFast(v15, 0LL, 0LL, v14, 0x102u);
    }
    else
    {
      ...
      v12 = v16;
      if ( v16 < 0 )
        MilInstrumentationCheckHR_MaybeFailFast(v17, 0LL, 0LL, v16, 0x10Eu);
    }
  }
  else
  {
    while ( 1 )
    {
      v10 = CScrollAnimation::CalculateValueForState(this, a2, a3, *(_DWORD *)(*((_QWORD *)this + 50) + 4 * v4), &v20);
      v12 = v10;
      if ( v10 < 0 )
        break;
      v4 = (unsigned int)(v4 + 1);
      if ( (int)v4 >= *((_DWORD *)this + 106) - 1 )
        goto LABEL_4;
    }
    MilInstrumentationCheckHR_MaybeFailFast(v11, 0LL, 0LL, v10, 0xF9u);
  }
  *a4 = *((_BYTE *)this + 368) & 1;
  return v12;
}
