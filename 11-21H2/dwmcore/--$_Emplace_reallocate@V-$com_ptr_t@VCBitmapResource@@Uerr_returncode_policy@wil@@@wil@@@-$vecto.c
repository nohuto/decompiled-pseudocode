...
_QWORD *__fastcall std::vector<wil::com_ptr_t<CBitmapResource,wil::err_returncode_policy>>::_Emplace_reallocate<wil::com_ptr_t<CBitmapResource,wil::err_returncode_policy>>(
        __int64 *a1,
        __int64 a2,
        __int64 *a3)
{
  ...
  *v17 = v14;
  ...
  if ( a2 != v18 )
  {
    std::_Uninitialized_move<wil::com_ptr_t<CBitmapResource,wil::err_returncode_policy> *,std::allocator<wil::com_ptr_t<CBitmapResource,wil::err_returncode_policy>>>(
      v19,
      a2,
      v13);
    v18 = a1[1];
