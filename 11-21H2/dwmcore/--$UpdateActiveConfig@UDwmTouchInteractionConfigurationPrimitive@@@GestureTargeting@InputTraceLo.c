/*
 * XREFs of ??$UpdateActiveConfig@UDwmTouchInteractionConfigurationPrimitive@@@GestureTargeting@InputTraceLogging@@SAXAEBUDwmTouchInteractionConfigurationPrimitive@@@Z @ 0x1801885C8
 * Callers:
...
char __fastcall InputTraceLogging::GestureTargeting::UpdateActiveConfig<DwmTouchInteractionConfigurationPrimitive>(
        _DWORD *a1)
{
  __int64 *v2; // rax
  int v3; // r9d
