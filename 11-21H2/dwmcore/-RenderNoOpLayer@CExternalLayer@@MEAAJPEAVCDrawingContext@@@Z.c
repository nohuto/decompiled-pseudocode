/*
 * XREFs of ?RenderNoOpLayer@CExternalLayer@@MEAAJPEAVCDrawingContext@@@Z @ 0x1801D8290
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall CExternalLayer::RenderNoOpLayer(CExternalLayer *this, struct CDrawingContext *a2)
{
  ...
  float v24[4]; // [rsp+90h] [rbp+27h] BYREF
  ...
  v24[1] = 0.0;
  v23 = v6;
  LODWORD(v24[2]) = _mm_cvtepi32_ps(v2).m128_u32[0];
  v7 = *((_OWORD *)this + 3);
  LODWORD(v24[3]) = _mm_cvtepi32_ps(v4).m128_u32[0];
  v8 = *((_OWORD *)this + 4);
  v22[0] = v7;
  v9 = *((_OWORD *)this + 5);
  v22[1] = v8;
  ...
  v22[2] = v9;
  v22[3] = v10;
  if ( CMILMatrix::IsIdentity<1>((__int64)v22) || CMILMatrix::Invert((CMILMatrix *)v22, v11, v12) )
  {
    v15 = CDrawingContext::PushTransformInternal(a2, 0LL, (const struct CMILMatrix *)v22, 0, 1);
    v14 = v15;
    if ( v15 < 0 )
    {
      MilInstrumentationCheckHR_MaybeFailFast(v16, 0LL, 0LL, v15, 0x11Cu);
    }
    else
    {
      ...
      v19 = CDrawingContext::DrawBitmapRealization((__int64)a2, v18, v24, v24, 0, v17, (int)FLOAT_1_0);
      v14 = v19;
      if ( v19 < 0 )
        MilInstrumentationCheckHR_MaybeFailFast(v20, 0LL, 0LL, v19, 0x123u);
  ...
  {
    v14 = -2147418113;
    MilInstrumentationCheckHR_MaybeFailFast(v13, 0LL, 0LL, -2147418113, 0x11Au);
  }
  return v14;
}
