/*
 * XREFs of ??$SetProperty@UD2DQuaternion@@@DataSourcePropertySet@@QEAAJIPEBUD2DQuaternion@@W4DCOMPOSITION_EXPRESSION_TYPE@@@Z @ 0x1801BB6B0
 * Callers:
...
__int64 __fastcall DataSourcePropertySet::SetProperty<D2DQuaternion>(__int64 a1, int a2, __int128 *a3)
{
  ...
  if ( v20 == *(_QWORD *)(a1 + 8) )
  {
    v6 = PropertySetStorage<DynArrayNoZero,PropertySetUserModeAllocator>::AddProperty<D2DQuaternion>(v5, 71, a3, &v22);
    v7 = v6;
    if ( v6 < 0 )
    {
