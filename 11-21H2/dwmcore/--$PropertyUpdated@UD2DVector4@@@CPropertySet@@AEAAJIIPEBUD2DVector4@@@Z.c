/*
 * XREFs of ??$PropertyUpdated@UD2DVector4@@@CPropertySet@@AEAAJIIPEBUD2DVector4@@@Z @ 0x1802391E8
 * Callers:
        ...
        int *a4)
{
  ...
  if ( PropertySetStorage<DynArrayNoZero,PropertySetUserModeAllocator>::IsValidPropertyId((__int64)this + 88, a2) )
  {
    ...
    else
    {
      ...
      CPropertySet::LogValueUpdate<D2DVector4>((__int64)this, (unsigned int)v4, v13, a3, a4);
