/*
 * XREFs of _dynamic_initializer_for__CCommonRegistryData::MousewheelAnimationDurationMs__ @ 0x1800038A0
 * Callers:
 *     <none>
 * Callees:
...
__int64 dynamic_initializer_for__CCommonRegistryData::MousewheelAnimationDurationMs__()
{
  ...
  result = RegGetDwmDwordHelper(L"MousewheelAnimationDurationMs", &v2, 0LL);
  v1 = 250;
  if ( (_BYTE)result )
    v1 = v2;
