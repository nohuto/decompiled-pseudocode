/*
 * XREFs of ?SaveOffOverdraw@CDxHandleAdvancedDirectFlipBitmapRealization@@IEAAJXZ @ 0x1802A3B70
 * Callers:
        ...
        CDxHandleAdvancedDirectFlipBitmapRealization *this)
{
  ...
  if ( v10 < 0 )
  {
    MilInstrumentationCheckHR_MaybeFailFast(v11, 0LL, 0LL, v10, 0xF2u);
  }
  else
  {
    v13 = *((_QWORD *)this + 47);
    ...
    v15 = *(_DWORD *)(v13 + 240);
    v16 = (__int64 (__fastcall ***)(_QWORD))(*(int *)(*(_QWORD *)(v13 + 16) + 20LL) + v13 + 16);
    v17 = (struct ID3D11Texture2D *)(**v16)(v16);
    v18 = CDecodeBitmap::CopyRegion(v14, *((const struct CRegion **)this + 53), v17, v15);
    v12 = v18;
    if ( v18 < 0 )
    {
      MilInstrumentationCheckHR_MaybeFailFast(v19, 0LL, 0LL, v18, 0xF7u);
    }
    else
    {
      *((_BYTE *)this + 440) = 1;
