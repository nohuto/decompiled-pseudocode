/*
 * XREFs of ?UpdateVisualProperty@CProjectedShadowCaster@@QEAAXPEBVCVisualTree@@@Z @ 0x1802020F4
 * Callers:
        ...
        const struct CVisualTree *a2)
{
  ...
  bool v8; // cl
  __int128 v9; // xmm0
  char v10[8]; // [rsp+20h] [rbp-50h] BYREF
  ...
  if ( *(struct CComposition **)(v3 + 48) != CurrentFrameId )
  {
    *(_QWORD *)(v3 + 48) = CurrentFrameId;
    v5 = CProjectedShadowCaster::ComputeEffectiveAlpha(this, (CVisual **)v11, (bool *)v10);
    v6 = CVisualTree::_IsInTree((__int64)v11, *((_QWORD *)this + 8), 1);
    v7 = 0;
    v8 = v10[0];
    ...
    CProjectedShadowCaster::CalculateCasterBounds((__int64)this, (__int64)&v13, v11, v10);
    ...
    else
    {
      ...
      *(_BYTE *)(v3 + 76) = v10[0];
      *(_OWORD *)(v3 + 60) = v9;
      Microsoft::WRL::ComPtr<IRenderTargetBitmap>::InternalRelease((__int64 *)(v3 + 80));
    }
