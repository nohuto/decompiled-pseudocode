/*
 * XREFs of ?CreateFromHeap@CD2DSharedBuffer@@SAJIPEAPEAUID2D1PrivateCompositorBuffer@@@Z @ 0x18028CA98
 * Callers:
...
__int64 __fastcall CD2DSharedBuffer::CreateFromHeap(unsigned int a1, struct ID2D1PrivateCompositorBuffer **a2)
{
  ...
  v3 = -2147024882;
  MilInstrumentationCheckHR_MaybeFailFast(v5, 0LL, 0LL, -2147024882, v10);
LABEL_7:
