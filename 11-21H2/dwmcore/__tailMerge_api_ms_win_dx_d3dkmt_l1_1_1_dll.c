/*
 * XREFs of __tailMerge_api_ms_win_dx_d3dkmt_l1_1_1_dll @ 0x180102F79
 * Callers:
 *     __imp_load_D3DKMTOpenAdapterFromLuid @ 0x180102F6D (__imp_load_D3DKMTOpenAdapterFromLuid.c)
 * Callees:
