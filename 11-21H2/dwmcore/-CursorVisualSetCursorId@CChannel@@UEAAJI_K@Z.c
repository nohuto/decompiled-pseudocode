/*
 * XREFs of ?CursorVisualSetCursorId@CChannel@@UEAAJI_K@Z @ 0x1801AA620
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall CChannel::CursorVisualSetCursorId(CDataStreamWriter **this, unsigned int a2, __int64 a3)
{
  unsigned int v6; // ebx
