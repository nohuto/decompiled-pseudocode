/*
 * XREFs of ??$_Emplace_reallocate@AEBQEAVCRenderTarget@@@?$vector@PEAVCRenderTarget@@V?$allocator@PEAVCRenderTarget@@@std@@@std@@QEAAPEAPEAVCRenderTarget@@QEAPEAV2@AEBQEAV2@@Z @ 0x1800F539C
 * Callers:
...
char *__fastcall std::vector<CRenderTarget *>::_Emplace_reallocate<CRenderTarget * const &>(
        __int64 a1,
        _BYTE *a2,
        _QWORD *a3)
{
