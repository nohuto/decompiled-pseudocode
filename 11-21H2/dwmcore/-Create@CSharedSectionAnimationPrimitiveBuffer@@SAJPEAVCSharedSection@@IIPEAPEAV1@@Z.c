/*
 * XREFs of ?Create@CSharedSectionAnimationPrimitiveBuffer@@SAJPEAVCSharedSection@@IIPEAPEAV1@@Z @ 0x1800E6744
 * Callers:
        ...
        struct CSharedSectionAnimationPrimitiveBuffer **a4)
{
  ...
  {
    v5 = -2147024882;
    MilInstrumentationCheckHR_MaybeFailFast(v10, 0LL, 0LL, -2147024882, 0xDu);
  }
  return v5;
}
