/*
 * XREFs of _anonymous_namespace_::AddToResourceCount @ 0x1800D8D48
 * Callers:
...
void __fastcall anonymous_namespace_::AddToResourceCount(unsigned int a1, int a2)
{
  ...
  if ( a1 > 0x2C )
  {
    ...
    {
LABEL_9:
      LODWORD(xmmword_1803D3310) = a2 + xmmword_1803D3310;
      return;
    }
    v4 = v3 - 85;
    if ( v4 )
...
LABEL_19:
  ...
  if ( v7 && (v8 = v7 - 2) != 0 && (v9 = v8 - 2) != 0 && (v10 = v9 - 2) != 0 && (v11 = v10 - 3) != 0 )
  {
    ...
    {
LABEL_8:
      HIDWORD(xmmword_1803D3300) += a2;
      return;
    }
    HIDWORD(xmmword_1803D3310) += a2;
  }
  else
  {
    DWORD2(xmmword_1803D3310) += a2;
  }
}
