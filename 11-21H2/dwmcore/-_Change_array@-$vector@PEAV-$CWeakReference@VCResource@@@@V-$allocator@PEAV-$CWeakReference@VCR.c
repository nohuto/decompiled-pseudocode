/*
 * XREFs of ?_Change_array@?$vector@PEAV?$CWeakReference@VCResource@@@@V?$allocator@PEAV?$CWeakReference@VCResource@@@@@std@@@std@@AEAAXQEAPEAV?$CWeakReference@VCResource@@@@_K1@Z @ 0x1801BD460
 * Callers:
