/*
 * XREFs of ?CleanTreeState@CManipulationContext@@SAXPEAVCInteraction@@PEAV1@PEAVCComposition@@_NW4InputType@@@Z @ 0x1801826E0
 * Callers:
 ...
 * Callees:
 *     ?LockComposition@CManipulationManager@@SAXPEAVCComposition@@_N@Z @ 0x18002B8C4 (-LockComposition@CManipulationManager@@SAXPEAVCComposition@@_N@Z.c)
  ...
  if ( a1 )
  {
          ...
          VisualEffectiveParentImpl = CManipulationContext::GetVisualEffectiveParentImpl(VisualEffectiveParentImpl, v10) )
    {
      if ( v11 )
      {
        ...
        {
          *((_BYTE *)VisualEffectiveParentImpl + 101) = v18 & 0x7F;
        }
      }
    }
  }
