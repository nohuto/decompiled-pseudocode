/*
 * XREFs of ?VisualSetInteraction@CChannel@@UEAAJII@Z @ 0x1800F1A80
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall CChannel::VisualSetInteraction(CDataStreamWriter **this, unsigned int a2, int a3)
{
  unsigned int v6; // ebx
