/*
 * XREFs of ?GetCachedFeatureEnabledState@?$FeatureImpl@U__WilFeatureTraits_Feature_PresentationAPIDisableScanoutProtection@@@details@wil@@AEAA?ATwil_details_FeatureStateCache@@XZ @ 0x1802487B8
 * Callers:
 ...
 *     ?GetCurrentFeatureEnabledState@?$FeatureImpl@U__WilFeatureTraits_Feature_PresentationAPIDisableScanoutProtection@@@details@wil@@AEAA?ATwil_details_FeatureStateCache@@PEAH@Z @ 0x180248B90 (-GetCurrentFeatureEnabledState@-$FeatureImpl@U__WilFeatureTraits_Feature_PresentationAPIDisableS.c)
 */

signed __int32 *__fastcall wil::details::FeatureImpl<__WilFeatureTraits_Feature_PresentationAPIDisableScanoutProtection>::GetCachedFeatureEnabledState(
        ...
        signed __int32 *a2)
{
  ...
  *a2 = *a1;
  if ( (v2 & 3) != 3 )
  {
    ...
    wil::details::FeatureImpl<__WilFeatureTraits_Feature_PresentationAPIDisableScanoutProtection>::GetCurrentFeatureEnabledState(
      a1,
      &v15,
      &i);
    v6 = *a2;
