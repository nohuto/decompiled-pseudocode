/*
 * XREFs of ??$_Uninitialized_move@PEAVCVisualDepthGeometry@@V?$allocator@VCVisualDepthGeometry@@@std@@@std@@YAPEAVCVisualDepthGeometry@@QEAV1@0PEAV1@AEAV?$allocator@VCVisualDepthGeometry@@@0@@Z @ 0x1802474F8
 * Callers:
