/*
 * XREFs of ?SetNormalInput@?$CScenePbrMaterialGeneratedT@VCScenePbrMaterial@@VCSceneMaterial@@@@QEAAJPEAVCSceneMaterialInput@@@Z @ 0x1801A3834
 * Callers:
        ...
        struct CResource *a2)
{
  ...
  if ( a2 != this[16] )
  {
    ...
    if ( v5 < 0 )
    {
      MilInstrumentationCheckHR_MaybeFailFast(v6, 0LL, 0LL, v5, 0xDBFu);
    }
    else
    {
