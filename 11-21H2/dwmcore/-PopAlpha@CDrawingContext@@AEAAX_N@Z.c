/*
 * XREFs of ?PopAlpha@CDrawingContext@@AEAAX_N@Z @ 0x1801B2D58
 * Callers:
...
void __fastcall CDrawingContext::PopAlpha(CDrawingContext *this, char a2)
{
  ...
  v2 = this;
  if ( a2 )
    CWatermarkStack<CDrawingContext::StackStateEntry,64,2,10>::Pop((int *)this + 84, &v3);
  CWatermarkStack<float,2,2,10>::Pop((_DWORD *)v2 + 776);
}
