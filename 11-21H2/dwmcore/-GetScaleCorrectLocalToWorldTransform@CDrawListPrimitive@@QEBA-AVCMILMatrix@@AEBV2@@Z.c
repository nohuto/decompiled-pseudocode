/*
 * XREFs of ?GetScaleCorrectLocalToWorldTransform@CDrawListPrimitive@@QEBA?AVCMILMatrix@@AEBV2@@Z @ 0x18000DF08
 * Callers:
...
__int64 __fastcall CDrawListPrimitive::GetScaleCorrectLocalToWorldTransform(__int64 a1, __int64 a2, __int64 a3)
{
  __int64 result; // rax
  __int128 v4; // xmm11
  __int128 v5; // xmm6
