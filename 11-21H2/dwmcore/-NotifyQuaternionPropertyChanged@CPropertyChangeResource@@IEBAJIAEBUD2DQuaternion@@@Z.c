/*
 * XREFs of ?NotifyQuaternionPropertyChanged@CPropertyChangeResource@@IEBAJIAEBUD2DQuaternion@@@Z @ 0x1802033C8
 * Callers:
        ...
        const struct D2DQuaternion *a3)
{
  ...
  if ( CPropertyChangeResource::ShouldNotify(this, a2) )
  {
    ...
    v14[1] = v6;
    v15 = v10;
    v11 = CoreUICallSend(v8, v14, 2LL, 15LL, 6, &unk_18032C43D);
    v3 = v11;
    if ( v11 == -2018375675 )
    {
      return 0;
    ...
    {
      MilInstrumentationCheckHR_MaybeFailFast(v12, 0LL, 0LL, v11, 0x1CEu);
    }
  }
  return v3;
}
