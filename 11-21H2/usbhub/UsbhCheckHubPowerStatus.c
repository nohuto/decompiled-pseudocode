/*
 * XREFs of UsbhCheckHubPowerStatus @ 0x1C000D988
 * Callers:
...
__int64 __fastcall UsbhCheckHubPowerStatus(__int64 a1)
{
  ...
  v4 = UsbhSyncSendInternalIoctl(a1, 0x220013u, (unsigned __int64)&v13, 0LL);
  Log(a1, 8, 1970303827, v13, v4);
  if ( (int)v4 >= 0 && (v2[1054] & 0xFFFFFFFD) == 0 )
  {
    v12 = v4;
    v5 = 810571602;
    v6 = a1;
LABEL_6:
    Log(v6, 16, v5, 0LL, v12);
    goto LABEL_19;
  }
