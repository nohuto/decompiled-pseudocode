/*
 * XREFs of UsbhBusIfAddDevice @ 0x1C004B330
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall UsbhBusIfAddDevice(__int64 a1)
{
  ...
  for ( i = 328; ; i = 312 )
  {
    ...
    LODWORD(BusInterface) = UsbhGetBusInterface(a1, v3 + 1056, v2);
  ...
  for ( j = 3; ; j = 2 )
  {
    ...
    BusInterface = (int)UsbhGetBusInterface(a1, v3 + 1138, j);
