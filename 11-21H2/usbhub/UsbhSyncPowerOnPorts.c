/*
 * XREFs of UsbhSyncPowerOnPorts @ 0x1C001A270
 * Callers:
...
__int64 __fastcall UsbhSyncPowerOnPorts(__int64 a1)
{
  ...
  for ( i = 1; ; ++i )
  {
    ...
    LOBYTE(v18) = 3;
    WORD2(v16) = i;
    v2 = (int)UsbhSyncSendCommand(a1, (__int64)&v16, 0LL, &v17[1], v14, &v15);
    if ( (UsbhLogMask & 8) != 0 )
    {
      v6 = *(_QWORD *)(a1 + 64);
      if ( v6 )
    ...
    if ( (unsigned int)v2 >> 30 == 3 && !(unsigned __int8)Usb_Disconnected((unsigned int)v2) )
      UsbhException(a1, i, 12, (int)v17, 10, v2, v13, usbfile_hub_c, 3524, 0);
    if ( (UsbhLogMask & 8) != 0 )
    {
      v9 = *(_QWORD *)(a1 + 64);
      if ( v9 )
