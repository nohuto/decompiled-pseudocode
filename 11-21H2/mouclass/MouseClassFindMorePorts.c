/*
 * XREFs of MouseClassFindMorePorts @ 0x1C000C3B0
 * Callers:
 *     <none>
 * Callees:
...
void __fastcall MouseClassFindMorePorts(struct _DRIVER_OBJECT *DriverObject, PVOID Context, ULONG Count)
{
  ...
  *(_QWORD *)&DestinationString.Length = 0x2000000LL;
  ...
  RtlCopyUnicodeString(&DestinationString, &stru_1C0009310);
  ...
  if ( Destination.Buffer )
  {
    ...
    MouDeterminePortsServiced(&DestinationString, &v15);
