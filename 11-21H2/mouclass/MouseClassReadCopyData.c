/*
 * XREFs of MouseClassReadCopyData @ 0x1C0004F58
 * Callers:
 ...
 *     WPP_RECORDER_SF_qqLL @ 0x1C0006234 (WPP_RECORDER_SF_qqLL.c)
 *     WPP_RECORDER_SF_qqLqq @ 0x1C00065D4 (WPP_RECORDER_SF_qqLqq.c)
 *     WPP_RECORDER_SF_qqqql @ 0x1C0006B80 (WPP_RECORDER_SF_qqqql.c)
 */
...
__int64 __fastcall MouseClassReadCopyData(__int64 a1, _QWORD *a2, int a3, int a4)
{
  ...
  if ( v8 < v9 )
    v10 = v8;
  if ( WPP_RECORDER_INITIALIZED != (_UNKNOWN *)&WPP_RECORDER_INITIALIZED && LOWORD(WPP_GLOBAL_Control->DeviceType) )
    WPP_RECORDER_SF_qqL((__int64)WPP_GLOBAL_Control->DeviceExtension, 5u, 3u, 0x29u, v20);
  v11 = (char *)a2[3];
  if ( WPP_RECORDER_INITIALIZED != (_UNKNOWN *)&WPP_RECORDER_INITIALIZED && LOWORD(WPP_GLOBAL_Control->DeviceType) )
  ...
  *(_DWORD *)(a1 + 84) -= v8 / 0x18;
  if ( v18 )
  {
    ...
    {
      LOBYTE(v17) = 3;
      WPP_RECORDER_SF_qq(WPP_GLOBAL_Control->DeviceExtension, v17, 3, 44, v20, *(_QWORD *)a1, (char)a2);
    }
    *(_BYTE *)(a1 + 66) = 1;
  }
  if ( WPP_RECORDER_INITIALIZED != (_UNKNOWN *)&WPP_RECORDER_INITIALIZED && LOWORD(WPP_GLOBAL_Control->DeviceType) )
