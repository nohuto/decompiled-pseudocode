/*
 * XREFs of Endpoint_EndpointStaticStreamsEnableCompletion @ 0x1C00386E0
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall Endpoint_EndpointStaticStreamsEnableCompletion(__int64 a1, int a2)
{
  ...
  __int64 v7; // rbx
  unsigned int i; // esi
  _OWORD v10[2]; // [rsp+50h] [rbp-58h] BYREF
  ...
  {
    TR_Disable_Internal(*(_QWORD *)(v7 + 88), 1);
    XilEndpoint_FreeStreamContextArray(*(_QWORD **)(v7 + 128));
    ...
    *(_QWORD *)(v7 + 128) = 0LL;
    if ( WPP_RECORDER_INITIALIZED != (_UNKNOWN *)&WPP_RECORDER_INITIALIZED )
      WPP_RECORDER_SF_ddd(
        ...
        *((_DWORD *)v6 + 2));
    *(_DWORD *)(v4 + 4) = 0;
    ESM_AddEvent((KSPIN_LOCK *)(v7 + 288), 146);
  }
