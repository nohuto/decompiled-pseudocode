/*
 * XREFs of Controller_CreateWdfDevice @ 0x1C006C580
 * Callers:
...
LABEL_46:
      LOBYTE(v10) = 2;
      WPP_RECORDER_SF_d(a2, v10, 4, v29, (__int64)&WPP_ff2e52b0a40430e0f7756a6ff2f45ac0_Traceguids, v32);
      goto LABEL_47;
    }
...
LABEL_29:
    ...
    *((_QWORD *)&v52 + 1) = 0x100000001LL;
    ...
    {
      LOBYTE(v10) = 3;
      WPP_RECORDER_SF_d(a2, v10, 4, 39, (__int64)&WPP_ff2e52b0a40430e0f7756a6ff2f45ac0_Traceguids, v7);
    }
    ++v7;
  }
  if ( v14 < 0 )
...
LABEL_32:
    LOBYTE(v21) = 2;
    WPP_RECORDER_SF_d(a2, v21, 4, v30, (__int64)&WPP_ff2e52b0a40430e0f7756a6ff2f45ac0_Traceguids, v20);
    goto LABEL_18;
  }
  ...
  if ( WPP_RECORDER_INITIALIZED != (_UNKNOWN *)&WPP_RECORDER_INITIALIZED )
    WPP_RECORDER_SF_S(a2, 4u, v22, 0x2Bu, (int)v31, v36.Buffer);
  v23 = *a3;
  ...
  *(_QWORD *)((char *)&v59 + 4) = 0xFFFFFFFF00000002uLL;
  ...
  if ( v26 < 0 )
  {
    ...
    {
      LOBYTE(v27) = 2;
      WPP_RECORDER_SF_d(a2, v27, 4, 45, (__int64)&WPP_ff2e52b0a40430e0f7756a6ff2f45ac0_Traceguids, v26);
    }
    v12 = 0;
  }
LABEL_18:
