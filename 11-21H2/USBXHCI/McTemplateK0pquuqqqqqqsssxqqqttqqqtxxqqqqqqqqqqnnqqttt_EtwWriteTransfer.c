/*
 * XREFs of McTemplateK0pquuqqqqqqsssxqqqttqqqtxxqqqqqqqqqqnnqqttt_EtwWriteTransfer @ 0x1C0049750
 * Callers:
...
NTSTATUS __fastcall McTemplateK0pquuqqqqqqsssxqqqttqqqtxxqqqqqqqqqqnnqqttt_EtwWriteTransfer(
        __int64 a1,
        __int64 a2,
        __int64 a3,
        __int64 a4,
        ...
        char a47)
{
  ...
  v142 = 4LL;
  v144 = 4LL;
  return McGenEventWrite_EtwWriteTransfer((__int64)v54, &USBXHCI_ETW_EVENT_CONTROLLER_HEALTH_V3, 0LL, 0x2Bu, &v57);
}
