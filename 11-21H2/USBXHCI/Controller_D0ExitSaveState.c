/*
 * XREFs of Controller_D0ExitSaveState @ 0x1C00310D8
 * Callers:
...
__int64 __fastcall Controller_D0ExitSaveState(__int64 a1, __int64 a2, __int64 a3)
{
  ...
  if ( WPP_RECORDER_INITIALIZED != (_UNKNOWN *)&WPP_RECORDER_INITIALIZED )
    WPP_RECORDER_SF_(*(_QWORD *)(a1 + 72), 4, 4, 124, (__int64)&WPP_ff2e52b0a40430e0f7756a6ff2f45ac0_Traceguids);
  ...
  if ( (Ulong & 1) != 0 )
  {
    ...
    if ( WPP_RECORDER_INITIALIZED != (_UNKNOWN *)&WPP_RECORDER_INITIALIZED )
      WPP_RECORDER_SF_(*(_QWORD *)(a1 + 72), 4, 4, 128, (__int64)&WPP_ff2e52b0a40430e0f7756a6ff2f45ac0_Traceguids);
    ...
    for ( i = 20; ; --i )
    {
      ...
      if ( (v17 & 0x100) == 0 )
      {
        ...
        if ( WPP_RECORDER_INITIALIZED != (_UNKNOWN *)&WPP_RECORDER_INITIALIZED )
        {
          ...
          LOBYTE(v21) = 4;
          WPP_RECORDER_SF_I(*(_QWORD *)(a1 + 72), v21, v12, 130, v26, (v20 - UnbiasedInterruptTime) / 0xA);
        }
        goto LABEL_36;
      }
      if ( !i )
      {
        ...
        if ( WPP_RECORDER_INITIALIZED != (_UNKNOWN *)&WPP_RECORDER_INITIALIZED )
        {
          ...
          LOBYTE(v19) = 2;
          WPP_RECORDER_SF_I(*(_QWORD *)(a1 + 72), v19, v12, 131, v26, (v18 - UnbiasedInterruptTime) / 0x2710);
        }
        goto LABEL_35;
      }
    ...
    if ( WPP_RECORDER_INITIALIZED != (_UNKNOWN *)&WPP_RECORDER_INITIALIZED )
    {
      ...
      LOBYTE(v24) = 2;
      WPP_RECORDER_SF_I(*(_QWORD *)(a1 + 72), v24, v23, 129, v26, (v22 - UnbiasedInterruptTime) / 0x2710);
    }
  ...
  else if ( WPP_RECORDER_INITIALIZED != (_UNKNOWN *)&WPP_RECORDER_INITIALIZED )
  {
    v13 = 125;
LABEL_14:
    WPP_RECORDER_SF_(*(_QWORD *)(a1 + 72), 2, 4, v13, (__int64)&WPP_ff2e52b0a40430e0f7756a6ff2f45ac0_Traceguids);
  }
LABEL_35:
  v3 = -1073741630;
LABEL_36:
