/*
 * XREFs of Controller_D0EntryRestoreState @ 0x1C0030DA4
 * Callers:
...
__int64 __fastcall Controller_D0EntryRestoreState(__int64 a1, __int64 a2, __int64 a3)
{
  ...
  if ( WPP_RECORDER_INITIALIZED != (_UNKNOWN *)&WPP_RECORDER_INITIALIZED )
    WPP_RECORDER_SF_(*(_QWORD *)(a1 + 72), 4, 4, 108, (__int64)&WPP_ff2e52b0a40430e0f7756a6ff2f45ac0_Traceguids);
  ...
  if ( (Ulong & 1) != 0 )
  {
    ...
    if ( WPP_RECORDER_INITIALIZED != (_UNKNOWN *)&WPP_RECORDER_INITIALIZED )
      WPP_RECORDER_SF_(*(_QWORD *)(a1 + 72), 4, 4, 112, (__int64)&WPP_ff2e52b0a40430e0f7756a6ff2f45ac0_Traceguids);
    ...
    while ( 1 )
    {
      ...
      if ( (v16 & 0x200) == 0 )
      {
        ...
        if ( WPP_RECORDER_INITIALIZED != (_UNKNOWN *)&WPP_RECORDER_INITIALIZED )
        {
          ...
          LOBYTE(v20) = 4;
          WPP_RECORDER_SF_I(*(_QWORD *)(a1 + 72), v20, v11, 114, v26, (v19 - UnbiasedInterruptTime) / 0xA);
        }
        v21 = 0;
        goto LABEL_37;
      }
      if ( !v13 )
      {
        ...
        if ( WPP_RECORDER_INITIALIZED != (_UNKNOWN *)&WPP_RECORDER_INITIALIZED )
        {
          ...
          LOBYTE(v18) = 2;
          WPP_RECORDER_SF_I(*(_QWORD *)(a1 + 72), v18, v11, 115, v26, (v17 - UnbiasedInterruptTime) / 0x2710);
        }
        goto LABEL_36;
      }
    ...
    if ( WPP_RECORDER_INITIALIZED != (_UNKNOWN *)&WPP_RECORDER_INITIALIZED )
    {
      ...
      LOBYTE(v24) = 2;
      WPP_RECORDER_SF_I(*(_QWORD *)(a1 + 72), v24, v23, 113, v26, (v22 - UnbiasedInterruptTime) / 0x2710);
    }
  ...
  else if ( WPP_RECORDER_INITIALIZED != (_UNKNOWN *)&WPP_RECORDER_INITIALIZED )
  {
    v12 = 109;
LABEL_14:
    WPP_RECORDER_SF_(*(_QWORD *)(a1 + 72), 2, 4, v12, (__int64)&WPP_ff2e52b0a40430e0f7756a6ff2f45ac0_Traceguids);
  }
LABEL_36:
  v21 = -1073741630;
LABEL_37:
