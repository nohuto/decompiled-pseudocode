/*
 * XREFs of Controller_ConfigureSxWakeSettings @ 0x1C006E458
 * Callers:
...
__int64 __fastcall Controller_ConfigureSxWakeSettings(__int64 *a1)
{
  ...
  {
    LOBYTE(v4) = 2;
    return WPP_RECORDER_SF_d(a1[9], v4, 4, 32, (__int64)&WPP_ff2e52b0a40430e0f7756a6ff2f45ac0_Traceguids, result);
  }
  return result;
}
