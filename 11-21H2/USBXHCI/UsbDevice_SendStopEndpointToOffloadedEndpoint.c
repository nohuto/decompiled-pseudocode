/*
 * XREFs of UsbDevice_SendStopEndpointToOffloadedEndpoint @ 0x1C0047378
 * Callers:
...
__int64 __fastcall UsbDevice_SendStopEndpointToOffloadedEndpoint(__int64 a1, __int64 a2)
{
  __int64 v2; // rdi
  __int64 v5; // rbp
  int v6; // r8d
