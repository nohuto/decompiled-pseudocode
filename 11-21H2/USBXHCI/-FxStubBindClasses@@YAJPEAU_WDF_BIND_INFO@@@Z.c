/*
 * XREFs of ?FxStubBindClasses@@YAJPEAU_WDF_BIND_INFO@@@Z @ 0x1C001801C
 * Callers:
 *     FxDriverEntryWorker @ 0x1C0017C04 (FxDriverEntryWorker.c)
 * Callees:
 *     FxGetNextClassBindInfo @ 0x1C00180C4 (FxGetNextClassBindInfo.c)
  ...
  else
  {
    for ( i = (char *)&Ucx_BIND_INFO; ; i = (char *)v4 + *v4 )
    {
      ...
      if ( NextClassBindInfo >= (unsigned __int64)&__KMDF_CLASS_BIND_END )
        return v1;
      off_1C0062748 = (_UNKNOWN *)NextClassBindInfo;
