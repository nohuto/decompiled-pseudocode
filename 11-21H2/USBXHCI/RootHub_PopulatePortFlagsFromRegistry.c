/*
 * XREFs of RootHub_PopulatePortFlagsFromRegistry @ 0x1C0072764
 * Callers:
  ...
  else
  {
    ...
    if ( *(_BYTE *)(g_WdfDriverUsbXhciContext + 28) )
    {
      ...
      if ( (int)result >= 0 )
      {
        ...
        if ( v10 <= *(_DWORD *)(a1 + 16)
          && v10
          && (result = *(_QWORD *)(a1 + 48), *(_BYTE *)(112LL * (v10 - 1) + result + 13) == 3) )
        {
          ...
          {
            result = *(_QWORD *)(a1 + 48);
            _InterlockedOr((volatile signed __int32 *)(112LL * (v5 - 1) + result + 64), 2u);
