/*
 * XREFs of XilDeviceSlot_InitializeSecureResources @ 0x1C00368A8
 * Callers:
...
__int64 __fastcall XilDeviceSlot_InitializeSecureResources(__int64 *a1)
{
  ...
  {
    LOBYTE(v5) = 2;
    WPP_RECORDER_SF_d(*(_QWORD *)(v1 + 72), v5, 10, 19, (__int64)&WPP_d32df481b5d7314fe4e9c81d9c040203_Traceguids, v4);
  }
  return v6;
}
