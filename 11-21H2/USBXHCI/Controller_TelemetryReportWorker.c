/*
 * XREFs of Controller_TelemetryReportWorker @ 0x1C00334B0
 * Callers:
 *     <none>
 * Callees:
...
LONG __fastcall Controller_TelemetryReportWorker(__int64 a1)
{
  ...
  ULONG v24; // [rsp+90h] [rbp+50h] BYREF
  ...
  {
    LOBYTE(v5) = 4;
    WPP_RECORDER_SF_(v4[9], v5, 4, 225, (__int64)&WPP_ff2e52b0a40430e0f7756a6ff2f45ac0_Traceguids);
  }
  ...
  *(_DWORD *)(v6 + 80) = 0;
  ...
  if ( v10 == -1073741789 )
  {
    ...
    if ( Pool2 )
    {
      ...
      {
        LOBYTE(v16) = 2;
        WPP_RECORDER_SF_d(v4[9], v16, 4, 228, (__int64)&WPP_ff2e52b0a40430e0f7756a6ff2f45ac0_Traceguids, v15);
      }
      v18 = v14;
      goto LABEL_21;
    }
    ...
    {
      LOBYTE(v13) = 2;
      WPP_RECORDER_SF_(v4[9], v13, 4, 227, (__int64)&WPP_ff2e52b0a40430e0f7756a6ff2f45ac0_Traceguids);
    }
  }
  else if ( WPP_RECORDER_INITIALIZED != (_UNKNOWN *)&WPP_RECORDER_INITIALIZED )
  {
    LOBYTE(v11) = 2;
    WPP_RECORDER_SF_d(v4[9], v11, 4, 226, (__int64)&WPP_ff2e52b0a40430e0f7756a6ff2f45ac0_Traceguids, v10);
  }
  while ( 1 )
  {
