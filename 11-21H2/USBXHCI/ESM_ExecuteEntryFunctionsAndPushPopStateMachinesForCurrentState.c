/*
 * XREFs of ESM_ExecuteEntryFunctionsAndPushPopStateMachinesForCurrentState @ 0x1C00057C8
 * Callers:
...
__int64 __fastcall ESM_ExecuteEntryFunctionsAndPushPopStateMachinesForCurrentState(unsigned int *Context)
{
  ...
  if ( v7 )
  {
    while ( 1 )
    {
      ...
      v21 = 0LL;
      v22 = v7;
      while ( ((unsigned int)v20 & *v22) != (_DWORD)v20 )
      {
...
LABEL_19:
      ...
      if ( v24 && WPP_RECORDER_INITIALIZED != (_UNKNOWN *)&WPP_RECORDER_INITIALIZED )
        WPP_RECORDER_SF_qLLL((__int64)WPP_GLOBAL_Control->DeviceExtension, v21, v19, v20, v29);
      ...
      *((_BYTE *)Context + 832) = (*((_BYTE *)Context + 832) + 1) & 0x3F;
      ...
      if ( (unsigned __int8)ESM_ShouldQueueWorkItem(Context, v21) )
        break;
...
LABEL_2:
    ...
    while ( 1 )
    {
      ...
      if ( Context[244] == 2000 && WPP_RECORDER_INITIALIZED != (_UNKNOWN *)&WPP_RECORDER_INITIALIZED )
        WPP_RECORDER_SF_qLLL((__int64)WPP_GLOBAL_Control->DeviceExtension, v8, v9, v10, v29);
