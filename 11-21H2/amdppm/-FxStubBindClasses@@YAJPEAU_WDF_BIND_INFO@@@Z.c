/*
 * XREFs of ?FxStubBindClasses@@YAJPEAU_WDF_BIND_INFO@@@Z @ 0x1C0003564
 * Callers:
 *     FxDriverEntryWorker @ 0x1C0003404 (FxDriverEntryWorker.c)
 * Callees:
 *     FxGetNextClassBindInfo @ 0x1C0003784 (FxGetNextClassBindInfo.c)
...
__int64 __fastcall FxStubBindClasses(struct _WDF_BIND_INFO *a1)
{
  ...
  {
    for ( i = (char *)&__KMDF_CLASS_BIND_END; ; i = (char *)v4 + *v4 )
    {
