/*
 * XREFs of WPP_RECORDER_SF_ddd @ 0x1C0007368
 * Callers:
 *     ValidateAcpiCStates @ 0x1C002DB68 (ValidateAcpiCStates.c)
 *     ValidateAcpiIdleDomain @ 0x1C002DD04 (ValidateAcpiIdleDomain.c)
 *     ValidateAcpiThrottleStates @ 0x1C002DEB0 (ValidateAcpiThrottleStates.c)
 *     ValidateCoordinatedDependencyOptionsPlatform @ 0x1C002E38C (ValidateCoordinatedDependencyOptionsPlatform.c)
 *     ValidateCoordinatedDependencyOptionsProcessor @ 0x1C002E4E4 (ValidateCoordinatedDependencyOptionsProcessor.c)
...
__int64 WPP_RECORDER_SF_ddd(__int64 a1, __int64 a2, __int64 a3, unsigned __int16 a4, int a5, ...)
{
  ...
  if ( (HIDWORD(WPP_GLOBAL_Control->Timer) & 1) != 0 && BYTE1(WPP_GLOBAL_Control->Timer) >= 2u )
    ((void (__fastcall *)(_DEVICE_OBJECT *, __int64, void *, _QWORD, __int64 *, __int64, __int64 *, __int64, char *, __int64, _QWORD))pfnWppTraceMessage)(
      ...
      0LL);
  LOWORD(v8) = a4;
  return WppAutoLogTrace(a1, 2LL, 1LL, &WPP_a6b065e9623e3dbf1cba1de742264dc6_Traceguids, v8, (__int64 *)va);
}
