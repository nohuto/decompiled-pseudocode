/*
 * XREFs of InitAcpi1CStates @ 0x1C0035884
 * Callers:
...
__int64 __fastcall InitAcpi1CStates(__int64 a1)
{
  ...
  *(_QWORD *)(a1 + 272) |= v1 & 7;
  ...
  if ( (v1 & 2) != 0
    ...
    && IsValidAcpiGenericAddress((unsigned __int8 *)&dword_1C0011D6C)
  ...
  if ( (v7 & 4) != 0
    && (unsigned __int16)word_1C0011D52 <= 0x3E8u
    && IsValidAcpiGenericAddress((unsigned __int8 *)&dword_1C0011D84)
    && IsValidAcpiGenericAddress((unsigned __int8 *)&dword_1C0011D54)
    && IsValidAcpiGenericAddress((unsigned __int8 *)&dword_1C0011D6C)
    && IsValidAcpiGenericAddress((unsigned __int8 *)(a1 + 184))
    && dword_1C0011454 == 1 )
  {
  ...
  if ( Pool2 )
  {
    ...
    *v9 = v10;
    ...
    {
      LOBYTE(v9[5 * v10 + 4]) = 3;
      HIWORD(v9[5 * *v9 + 4]) = word_1C0011D52;
      v9[5 * *v9 + 5] = 0;
      if ( *(_DWORD *)(a1 + 188) != -5 )
      {
        LOBYTE(v9[5 * *v9 + 1]) = 1;
