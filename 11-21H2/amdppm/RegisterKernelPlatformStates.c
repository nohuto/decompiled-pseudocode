/*
 * XREFs of RegisterKernelPlatformStates @ 0x1C0034324
 * Callers:
...
__int64 __fastcall RegisterKernelPlatformStates(__int64 a1)
{
  ...
  v1 = a1;
  v2 = dword_1C0011454;
  if ( byte_1C0011D10 && dword_1C0011D0C > (unsigned int)dword_1C0011454 )
    v2 = dword_1C0011D0C;
  v3 = (unsigned int)dword_1C0011A9C;
  if ( !dword_1C0011A9C )
    return 0;
  v5 = (48 * dword_1C0011A9C + 59) & 0xFFFFFFFC;
  Pool2 = (char *)ExAllocatePool2(256LL, v5 + 8 * dword_1C0011A9C * v2, 1919119952LL);
  if ( !Pool2 )
  {
  ...
  if ( v7 )
  {
    ...
    if ( (_DWORD)v3 )
    {
      ...
      while ( 1 )
      {
        ...
        *v7 = v8;
        v7[8] = v2;
        ProcessorNumberFromIndex = ((__int64 (__fastcall *)(_QWORD, unsigned int *, _QWORD))qword_1C00117C8)(
                                     *(_QWORD *)(v1 + 1120),
                                     v7,
                                     0LL);
...
LABEL_24:
      *(_DWORD *)Pool2 = 69;
      *((_DWORD *)Pool2 + 1) = dword_1C0011A9C;
      *((_DWORD *)Pool2 + 2) = dword_1C0011A9C;
      ...
      *((_QWORD *)Pool2 + 4) = PepIdleComplete;
      ProcessorNumberFromIndex = ((__int64 (__fastcall *)(char *))qword_1C0011768)(Pool2);
      if ( ProcessorNumberFromIndex < 0 )
      {
        if ( WPP_RECORDER_INITIALIZED == (_UNKNOWN *)&WPP_RECORDER_INITIALIZED )
          goto LABEL_33;
