/*
 * XREFs of RegisterKernelCoordinatedLpiStates @ 0x1C003279C
 * Callers:
...
__int64 __fastcall RegisterKernelCoordinatedLpiStates(__int64 a1)
{
  ...
  v10 = 0LL;
  v11 = 0LL;
  CoordinatedLpiStates = AcpiGetCoordinatedLpiStates(a1, &qword_1C0011AC8);
  if ( CoordinatedLpiStates >= 0 )
  {
    ...
    *(_QWORD *)(v5 + 24) = v6;
    ...
    qword_1C0011AB0 = v5;
    qword_1C0011AB8 = v7;
    CoordinatedLpiStates = ((__int64 (__fastcall *)(__int64))qword_1C0011770)(v5);
    if ( CoordinatedLpiStates >= 0 )
      return 0;
