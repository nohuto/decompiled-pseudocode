/*
 * XREFs of RegisterKernelPepPerf @ 0x1C0033D20
 * Callers:
 *     <none>
 * Callees:
 ...
 *     PepTranslateLimitReason @ 0x1C003A0C4 (PepTranslateLimitReason.c)
 */
...
__int64 __fastcall RegisterKernelPepPerf(__int64 a1)
{
  ...
  v46 = 0;
  memset(v44, 0, 32);
  v2(WdfDriverGlobals, qword_1C0011458, 0LL);
  v3 = *(_QWORD *)(a1 + 1192);
  v4 = 0LL;
  Pool2 = 0LL;
  v43 = v3;
  ...
  if ( v41 )
  {
    v47 = *(_DWORD *)(v3 + 52);
    v7 = v47 != -1;
    PerfDomain = GetPerfDomain(a1, (__int64)v44, &v46);
    v9 = *(_BYTE **)(a1 + 560);
    v48 = PerfDomain;
    if ( !v9 || !v9[48] )
      v9 = 0LL;
    ...
    v15 = v48;
    inited = AllocateAndInitKernelPerfStatesRegistration(a1, v48, v7 + 1);
    v4 = inited;
    if ( inited )
    {
      v17 = v46;
      ...
      *((_DWORD *)v4 + 9) = v27;
      ...
      v6 = ((__int64 (__fastcall *)(_QWORD *))qword_1C0011738)(v4);
      if ( v6 >= 0 )
      {
        ResetEnumerationContext((__int64 *)v44);
        if ( !(unsigned int)EnumerateNextDevice((__int64 *)v44, &v42) )
