/*
 * XREFs of ProcLibTracePlatformIdleStates @ 0x1C001F084
 * Callers:
          ...
          do
          {
            *(_QWORD *)&UserData.Size = 4LL;
            ...
            if ( *(_DWORD *)(v8 + 16) )
            {
              ...
              {
                v12 = v11;
                KeGetProcessorNumberFromIndex(*(ULONG *)(*(_QWORD *)(v8 + 40) + 8LL * v11), &ProcNumber);
                v13 = 3LL * v11;
                Pool2[2 * v13] = ProcNumber.Group;
                ++v11;
                LOBYTE(Pool2[2 * v13 + 1]) = ProcNumber.Number;
                HIBYTE(Pool2[2 * v13 + 1]) = *(_BYTE *)(*(_QWORD *)(v8 + 40) + 8 * v12 + 4);
                *(_DWORD *)&Pool2[2 * v13 + 2] = *(unsigned __int8 *)(*(_QWORD *)(v8 + 40) + 8 * v12 + 5);
                *(_DWORD *)&Pool2[2 * v13 + 4] = *(unsigned __int8 *)(*(_QWORD *)(v8 + 40) + 8 * v12 + 6);
                v14 = *v10;
              }
              while ( v11 < *v10 );
              v31 = Pool2;
            ...
            EtwWrite((REGHANDLE)WPP_MAIN_CB.Queue.ListEntry.Flink, v3, 0LL, v9, &UserData);
            v7 = (unsigned int)(v15 + 1);
            v15 = v7;
          }
          while ( (unsigned int)v7 < v1[2] );
        }
        if ( Pool2 )
