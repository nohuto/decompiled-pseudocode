/*
 * XREFs of WriteGenAddr @ 0x1C0001BF8
 * Callers:
 *     PerfControlCpc @ 0x1C0001910 (PerfControlCpc.c)
 *     WriteGenAddrEx @ 0x1C0001CA8 (WriteGenAddrEx.c)
 *     SetPerfStateIO @ 0x1C0008FE0 (SetPerfStateIO.c)
 *     C2Idle @ 0x1C0009260 (C2Idle.c)
 *     C3Idle @ 0x1C0009320 (C3Idle.c)
 *     C3IdleCheck @ 0x1C0009400 (C3IdleCheck.c)
 * Callees:
 *     ReadIoMemRaw @ 0x1C0003ACC (ReadIoMemRaw.c)
