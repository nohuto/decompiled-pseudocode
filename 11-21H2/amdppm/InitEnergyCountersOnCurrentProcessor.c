    ...
    && (unsigned __int8)IsEnergyMsrSupported() )
  {
    ...
    if ( inited >= 0 )
    {
      ...
      if ( !Number )
      {
        ...
        if ( v4 )
        {
          qword_1C0011BE8[0] = (__int64)SnapEnergyCountersAndTimestamp;
          v8 = ComputeHyperThreadedProcessorEnergyUsingMsr;
        }
        else
        {
          qword_1C0011BE8[0] = (__int64)SnapEnergyCounters;
          v8 = ComputeProcessorEnergyUsingMsr;
        }
        qword_1C0011BE0[0] = (__int64)v8;
      }
    }
  }
  else
