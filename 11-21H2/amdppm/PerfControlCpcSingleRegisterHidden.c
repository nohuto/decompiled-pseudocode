/*
 * XREFs of PerfControlCpcSingleRegisterHidden @ 0x1C0004DA0
 * Callers:
 *     <none>
 * Callees:
 *     PerformanceFromPercentage @ 0x1C0001DC0 (PerformanceFromPercentage.c)
  ...
  if ( a3 || a4 )
  {
    ...
    *(_QWORD *)(a1 + 80) = *(_QWORD *)a2;
    ...
    if ( *(_BYTE *)(a1 + 130) )
    {
      ...
      {
        v19 = PerformanceFromPercentage(a1, *(_DWORD *)(a2 + 24));
        v6 = v22 & ~v21 | v21 & (v19 << v20);
      }
      else
      {
        LODWORD(v6) = PerformanceFromPercentage(a1, *(_DWORD *)(a2 + 24));
      }
    }
    if ( *(_BYTE *)(a1 + 128) )
    {
      v23 = v9[417];
      if ( v23 < 0x40u || v9[418] )
        LODWORD(v6) = v6 & ~(unsigned int)(((1LL << v23) - 1) << v9[418]) | (((1LL << v23) - 1) << v9[418]) & ((255 * *(_DWORD *)(a2 + 28) / 0x64u) << v9[418]);
      else
