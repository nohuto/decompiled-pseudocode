/*
 * XREFs of InitAcpi1ThrottleStates @ 0x1C0034D88
 * Callers:
...
__int64 __fastcall InitAcpi1ThrottleStates(__int64 a1)
{
  ...
  v1 = 0;
  if ( ((unsigned int)dword_1C0011454 <= 1 || (*(_DWORD *)(a1 + 280) & 0x200000) != 0)
    && (*(_DWORD *)(a1 + 280) & 0x100000) != 0
    && (v3 = a1 + 184, IsValidAcpiGenericAddress((unsigned __int8 *)(a1 + 184)))
    && (unsigned __int8)(byte_1C0011D96 - 1) <= 3u
    && (unsigned __int8)byte_1C0011D96 + (unsigned int)(unsigned __int8)byte_1C0011D97 <= 0x20 )
  {
    _InterlockedOr((volatile signed __int32 *)(a1 + 1104), 4u);
    _InterlockedOr((volatile signed __int32 *)(a1 + 1108), 4u);
    v4 = 1 << byte_1C0011D96;
    Pool2 = (unsigned int *)ExAllocatePool2(64LL, (unsigned int)(20 * ((1 << byte_1C0011D96) - 1) + 24), 1919119952LL);
    *(_QWORD *)(a1 + 504) = Pool2;
    if ( Pool2 )
    {
      v6 = 1;
      *Pool2 = v4;
      if ( v4 > 1 )
      {
        ...
        do
        {
          ...
          *(_DWORD *)(v8 + v7 - 4) = (v9 << byte_1C0011D97) | 0x10;
        }
        while ( v6 < v4 );
      }
