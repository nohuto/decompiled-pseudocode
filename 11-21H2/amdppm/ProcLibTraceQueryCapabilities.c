/*
 * XREFs of ProcLibTraceQueryCapabilities @ 0x1C001EB6C
 * Callers:
 ...
 * Callees:
 *     ProcLibGetProcessorNumber @ 0x1C0002C38 (ProcLibGetProcessorNumber.c)
  ...
  if ( (_BYTE)ProcessorNumber )
  {
    if ( *(_QWORD *)(a1 + 1120) )
    {
      ...
      if ( ProcessorNumber >= 0 )
      {
        ...
        v29 = 1;
        UserData.Size = 2;
        LOBYTE(ProcessorNumber) = EtwWrite((REGHANDLE)WPP_MAIN_CB.Queue.ListEntry.Flink, v2, 0LL, (ULONG)7, &UserData);
      }
    }
  }
