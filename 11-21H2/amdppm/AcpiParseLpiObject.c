/*
 * XREFs of AcpiParseLpiObject @ 0x1C002885C
 * Callers:
 *     AcpiEval_LPI @ 0x1C0026710 (AcpiEval_LPI.c)
 *     AcpiParseProcessorContainer @ 0x1C0029044 (AcpiParseProcessorContainer.c)
 * Callees:
...
LABEL_62:
    ...
    {
      if ( WPP_RECORDER_INITIALIZED != (_UNKNOWN *)&WPP_RECORDER_INITIALIZED )
        WPP_RECORDER_SF_SD((__int64)WPP_GLOBAL_Control->DeviceExtension, 4LL, v18, v19, v35, a2);
      goto LABEL_69;
    }
...
LABEL_70:
  ...
  {
    v33 = 20LL * j;
    if ( *(_QWORD *)&v20[v33 + 24] )
      RtlFreeUnicodeString((PUNICODE_STRING)&v20[v33 + 22]);
  }
  ExFreePoolWithTag(v20, (ULONG)0);
  return v6;
}
