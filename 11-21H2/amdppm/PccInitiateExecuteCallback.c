/*
 * XREFs of PccInitiateExecuteCallback @ 0x1C000B4F0
 * Callers:
 *     <none>
 * Callees:
...
void __fastcall PccInitiateExecuteCallback(int a1, void (*a2)(void))
{
  ...
  if ( a1 >= 0 )
  {
    ...
    v3 = qword_1C00114D8;
    v4 = 0;
    while ( (__int64 *)v3 != &qword_1C00114D8 )
    {
    ...
    if ( v4 )
    {
      LOBYTE(word_1C0011A7C) = 1;
      if ( !HIBYTE(word_1C0011A7C) )
      {
        HIBYTE(word_1C0011A7C) = 1;
        v11 = 1;
      }
    }
    (*(void (__fastcall **)(PWDF_DRIVER_GLOBALS, __int64))(WdfFunctions_01015 + 2536))(
      ...
      qword_1C0011A68);
    if ( v11 )
      IoQueueWorkItem(qword_1C0011A70, (PIO_WORKITEM_ROUTINE)PccCapWorker, CriticalWorkQueue, 0LL);
  }
  if ( a2 )
    a2();
}
