/*
 * XREFs of RegisterHvPackage @ 0x1C0024A40
 * Callers:
 *     <none>
 * Callees:
 *     _guard_dispatch_icall_nop @ 0x1C000BB10 (_guard_dispatch_icall_nop.c)
 *     GetHvPackage @ 0x1C0023CAC (GetHvPackage.c)
 */
...
__int64 __fastcall RegisterHvPackage(__int64 a1)
{
  ...
  if ( v2 >= 0 )
  {
    ...
    while ( (__int64 *)v3 != &qword_1C00114B8 );
    if ( !v4 )
    {
LABEL_6:
...
LABEL_13:
      ...
      v6 = (__int64 *)qword_1C00114C0;
      if ( *(__int64 **)qword_1C00114C0 != &qword_1C00114B8 )
LABEL_15:
        __fastfail(3u);
      *(_QWORD *)v4 = &qword_1C00114B8;
      *(_QWORD *)(v4 + 8) = v6;
      *v6 = v4;
      qword_1C00114C0 = v4;
    }
