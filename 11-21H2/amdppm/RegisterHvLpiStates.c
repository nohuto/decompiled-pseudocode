/*
 * XREFs of RegisterHvLpiStates @ 0x1C002484C
 * Callers:
    ...
    for ( i = Pool2; (unsigned int)v5 < *(_DWORD *)(v1 + 16); v5 = (unsigned int)(v5 + 1) )
    {
      ...
      if ( (*(_DWORD *)(80 * v5 + v1 + 32) & 1) != 0 )
      {
        ...
        if ( (unsigned int)v5 >= 3 )
          v9 = 3;
        *(_DWORD *)(v7 + 8) = v9;
        *(_QWORD *)(v7 + 12) = *(unsigned int *)(v8 + v1 + 28);
        if ( (int)DecodeAcpiIdleState(a1, (int)v8 + (int)v1 + 48, -1, *(_DWORD *)(v8 + v1 + 36), v7, 0LL, 0LL, 0LL) < 0 )
