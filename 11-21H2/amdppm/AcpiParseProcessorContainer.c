/*
 * XREFs of AcpiParseProcessorContainer @ 0x1C0029044
 * Callers:
 *     AcpiGetCoordinatedLpiStates @ 0x1C00280F4 (AcpiGetCoordinatedLpiStates.c)
 * Callees:
 *     GetDevExtByAcpiId @ 0x1C00038A4 (GetDevExtByAcpiId.c)
 *     RtlUnicodeStringCopyString @ 0x1C0005DC8 (RtlUnicodeStringCopyString.c)
    ...
    if ( v15 )
    {
      ...
      *(_QWORD *)(a3 + 32) = v16;
      ...
      for ( j = (char *)a1 + (unsigned int)a1[2 * v5 + 7]; v17 < a1[2 * v5 + 6]; v17 = v20 + 1 )
      {
        ...
        {
          if ( dword_1C0011D0C <= (unsigned int)dword_1C0011454 )
            return -1073741275;
