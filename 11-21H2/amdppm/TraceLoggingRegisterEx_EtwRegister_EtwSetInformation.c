/*
 * XREFs of TraceLoggingRegisterEx_EtwRegister_EtwSetInformation @ 0x1C0021EE8
 * Callers:
...
__int64 TraceLoggingRegisterEx_EtwRegister_EtwSetInformation()
{
  ...
  if ( RegHandle )
    __fastfail(5u);
  xmmword_1C0011090 = 0LL;
  v0 = EtwRegister(&ProviderId, tlgEnableCallback, &dword_1C0011068, &RegHandle);
  if ( !v0 )
