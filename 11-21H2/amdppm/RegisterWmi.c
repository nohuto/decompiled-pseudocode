/*
 * XREFs of RegisterWmi @ 0x1C00252FC
 * Callers:
...
__int64 __fastcall RegisterWmi(_DWORD *a1)
{
  ...
  _OWORD v15[4]; // [rsp+40h] [rbp-89h] BYREF
  ...
  {
    *(_DWORD *)&v16[20] = 0;
    v6 = (__int128 *)*(&off_1C000C000 + 3 * i);
    *(_QWORD *)&v16[28] = 0LL;
    *(_DWORD *)&v16[36] = 0;
    *(_DWORD *)v16 = 40;
    v7 = *v6;
    *(_DWORD *)&v16[24] = *((_DWORD *)&off_1C000C000 + 6 * i + 4);
    *(_OWORD *)&v16[4] = v7;
    memset(v15, 0, sizeof(v15));
    *(_QWORD *)&v15[1] = v16;
    LODWORD(v15[0]) = 64;
    *(_QWORD *)&v15[2] = *(&off_1C000C000 + 3 * i + 1);
    BYTE9(v15[1]) = 1;
  ...
  for ( j = 0; ; ++j )
  {
    ...
    *(_QWORD *)&v15[1] = v16;
    LODWORD(v15[0]) = 64;
    BYTE9(v15[1]) = 1;
    v8 = (*(__int64 (__fastcall **)(PWDF_DRIVER_GLOBALS, __int64, _OWORD *, _QWORD, __int64))(WdfFunctions_01015 + 2984))(
           WdfDriverGlobals,
           v3,
           v15,
           0LL,
