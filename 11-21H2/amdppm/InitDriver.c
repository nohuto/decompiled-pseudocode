/*
 * XREFs of InitDriver @ 0x1C00200A8
 * Callers:
...
__int64 __fastcall InitDriver(__int64 a1, _QWORD *a2)
{
  ...
  *(_QWORD *)(a1 + 40) = AmdPpmDeviceStart;
  ...
  if ( v6[0] || (GetHvPpmCapabilities(0LL, v6), v6[0]) )
  {
  ...
  if ( qword_1C0011800 && qword_1C0011808 && qword_1C0011810 && qword_1C0011818 )
