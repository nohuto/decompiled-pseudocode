/*
 * XREFs of InitializeEnergyEstimationForEfficiencyClass @ 0x1C00391D4
 * Callers:
...
__int64 __fastcall InitializeEnergyEstimationForEfficiencyClass(unsigned int a1)
{
  ...
  InitializeEnumerationContext((__int64)&qword_1C0011498, 32, (__int64)v12);
  ...
  *(__int64 *)((char *)&Globals[244] + v1) = 0LL;
  ...
  {
    result = (__int64)memset((char *)&unk_1C0011B1C + 12 * v5 + v1, 0, 12LL * (unsigned int)(result - v5));
  ...
  if ( v9 < 0 || !*(__int64 *)((char *)&Globals[244] + v1) )
  {
    InitializeEnumerationContext((__int64)&qword_1C0011498, 32, (__int64)v12);
    ResetEnumerationContext((__int64 *)v12);
    while ( 1 )
