/*
 * XREFs of sub_14057E68C @ 0x14057E68C
 * Callers:
 *     sub_14057DFA0 @ 0x14057DFA0 (sub_14057DFA0.c)
 * Callees:
...
char __fastcall sub_14057E68C(unsigned __int16 *a1, __int64 a2, int a3, int a4, char a5)
{
  _UNKNOWN **v5; // rax
  REGHANDLE v6; // rbx
  ULONGLONG v8; // rax
  ...
  if ( qword_140D00B58 )
  {
    LOBYTE(v5) = EtwEventEnabled(qword_140D00B58, &stru_140038830);
    if ( (_BYTE)v5 )
    {
      v8 = *((_QWORD *)a1 + 1);
      UserData.Reserved = 0;
      ...
      v21 = 4;
      v12 = 8;
      LOBYTE(v5) = EtwWriteEx(v6, &stru_140038830, 0LL, 0, 0LL, 0LL, 5u, &UserData);
    }
  }
  return (char)v5;
}
