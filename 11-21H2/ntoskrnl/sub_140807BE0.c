/*
 * XREFs of sub_140807BE0 @ 0x140807BE0
 * Callers:
...
__int64 __fastcall sub_140807BE0(int a1, int a2, int a3, int a4, char a5, __int64 a6)
{
  __int64 v6; // rbx
  ...
  if ( byte_140C5AE14 )
  {
    ...
    *(_QWORD *)&UserData.Size = 4LL;
    ...
    v18 = 4LL;
    v20 = 4LL;
    EtwWrite(RegHandle, &stru_14000FAF0, 0LL, 5u, &UserData);
    a1 = v10;
    a2 = v11;
  }
  return sub_140807CCC(a1, a2, a3, *(_DWORD *)(v6 + 12), *(_DWORD *)(v6 + 8));
}
