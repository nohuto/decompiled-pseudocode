/*
 * XREFs of sub_140654FBC @ 0x140654FBC
 * Callers:
...
__int64 __fastcall sub_140654FBC(__int64 a1, unsigned __int16 *a2)
{
  unsigned int v3; // edx
  __int64 v5; // r8
  int v6; // eax
  ...
  v5 = *a2;
  v23 = -1;
  v6 = sub_140A35494(a1, v3 >> 14, v5, &v22);
  v7 = 0;
  v8 = v6;
  if ( v6 >= 0 )
  {
    ...
    else
    {
      ...
      while ( 1 )
      {
        ...
        for ( i = a2[v10 + 3]; ; v15 = i )
        {
          ...
          LOBYTE(v7) = v16 & 3;
          LOBYTE(v16) = v12;
          v17 = sub_140A35084(v21, v16, v15, v7, v9[v13 + 6], (__int64)&v20, (__int64)&v23);
          v7 = 0;
          if ( v17 )
          {
