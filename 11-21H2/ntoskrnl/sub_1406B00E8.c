/*
 * XREFs of sub_1406B00E8 @ 0x1406B00E8
 * Callers:
...
__int64 __fastcall sub_1406B00E8(
        _QWORD **a1,
        __int64 a2,
        unsigned __int64 a3,
        unsigned __int64 a4,
        ...
        _QWORD *a7)
{
  ...
  if ( a4 >> 12 )
    v13 = sub_140238F98(v13, (unsigned __int64)(a2 + 4095) >> 12, v10, 0);
  v14 = a6 >> 12;
  ...
  while ( 1 )
  {
    ...
    if ( v10 )
      v23 = sub_140238F98(v23, v8, v10, 0);
    if ( v23 > v14 )
      return (unsigned int)-1073741801;
...
LABEL_21:
  ...
  if ( v26 >= v13 )
    v13 = v26;
  if ( v10 )
    v13 = sub_140238F98(v13, v8, v10, 0);
