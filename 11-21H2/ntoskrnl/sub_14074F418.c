/*
 * XREFs of sub_14074F418 @ 0x14074F418
 * Callers:
...
BOOLEAN __fastcall sub_14074F418(char a1, unsigned __int16 *a2, unsigned __int16 *a3)
{
  REGHANDLE v3; // rsi
  ...
  v3 = qword_140C15E00;
  v5 = (const EVENT_DESCRIPTOR *)qword_14000FEF8;
  if ( !a1 )
    v5 = &stru_14000FF08;
  result = EtwEventEnabled(qword_140C15E00, v5);
  if ( result )
  {
