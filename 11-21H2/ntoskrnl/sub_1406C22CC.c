/*
 * XREFs of sub_1406C22CC @ 0x1406C22CC
 * Callers:
...
__int64 __fastcall sub_1406C22CC(int a1, int *a2, unsigned int a3, unsigned int *a4, const void **a5, unsigned int a6)
{
  unsigned int v6; // esi
  unsigned int *v7; // rbx
  unsigned int *v8; // r11
...
LABEL_29:
      ...
      if ( a1 == 1 )
      {
        ...
        if ( (int)sub_1402E1260(*v8, v26, (int *)v8) < 0 )
...
LABEL_18:
      ...
      if ( a3 >= *v8 )
      {
        ...
        v19 = *v7;
        v33 = 0;
        if ( (int)sub_1402E1260(v19, v18, (int *)&v33) >= 0 && v33 <= a3 )
        {
          v22 = (*(unsigned __int16 *)v14 + 31) & 0xFFFFFFF8;
          memmove((char *)a2 + v22, (char *)a2 + v20, v21);
          memset((char *)a2 + v22 + (unsigned int)*v30, 0, a3 - *v30 - (unsigned int)v22);
          *v31 = v22;
LABEL_25:
