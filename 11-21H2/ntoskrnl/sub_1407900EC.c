/*
 * XREFs of sub_1407900EC @ 0x1407900EC
 * Callers:
...
LABEL_14:
    ...
    *(_OWORD *)&Source2[40] = v16;
    v17 = sub_140796390(v14, v15);
    if ( v17 )
      *(_DWORD *)&Source2[4] = v17 + 136;
    sub_14079809C(a1, &Source2[72]);
    if ( v11 )
    {
    ...
    if ( (int)sub_1406F2158(*(_QWORD *)(a1 + 32), Source2, *(_BYTE *)(a1 + 100), a8) >= 0 )
      return 1;
  }
  return 0;
}
