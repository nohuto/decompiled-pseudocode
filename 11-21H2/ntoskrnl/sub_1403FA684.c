/*
 * XREFs of sub_1403FA684 @ 0x1403FA684
 * Callers:
...
unsigned __int64 __fastcall sub_1403FA684(__int64 a1, int *a2, __int64 a3)
{
    ...
    if ( v27 != a2[5] )
    {
      ...
      if ( a2[4] && (*(_DWORD *)(v4 + 2396) & 0x40) != 0 )
      {
        ...
        while ( 1 )
        {
          while ( 1 )
          {
            v35 = (*(__int64 (__fastcall **)(unsigned __int64, _QWORD, __int64, unsigned __int64))(v4 + 1112))(
                    v34,
                    0LL,
                    CurrentIrql,
                    v29);
...
LABEL_45:
      ...
      if ( !*(_DWORD *)(v4 + 2240) )
      {
        ...
        result = *(_QWORD *)(v4 + 1384);
        *(_QWORD *)(result + 24) = v36;
        v37 = *((_QWORD *)a2 + 1);
        if ( !*(_DWORD *)(v4 + 2240) )
        {
          *(_QWORD *)(v4 + 2248) = v4 - 0x5C5FC0A76E374B18LL;
          *(_QWORD *)(v4 + 2256) = (char *)a2 - 0x4C48B4211BBACBEBLL;
          *(_QWORD *)(v4 + 2264) = *a2;
          *(_QWORD *)(v4 + 2272) = v37;
          *(_DWORD *)(v4 + 2240) = 1;
          result = sub_140AD049C(v4, 0LL, 0xA3A03F5891C8B4E8uLL, 0xB3B74BDEE4453415uLL);
        }
      }
    }
LABEL_48:
    ...
    if ( !(_DWORD)v38 )
      return result;
    sub_1403F966C(v4, *((_QWORD *)a2 + 1), v38, (__int64)v51);
    v39 = 16LL;
...
LABEL_56:
      ...
      if ( (result & 0x40) != 0 )
      {
        ...
        while ( 1 )
        {
          while ( 1 )
          {
            result = (*(__int64 (__fastcall **)(unsigned __int64, _QWORD, __int64, unsigned __int64 *))(v4 + 1112))(
                       v48,
                       0LL,
                       v39,
                       v40);
...
LABEL_66:
      ...
      if ( !*(_DWORD *)(v4 + 2240) )
      {
        ...
        *(_QWORD *)(v4 + 2272) = v50;
        *(_DWORD *)(v4 + 2240) = 1;
        result = sub_140AD049C(v4, 0LL, v39, v40);
      }
    }
LABEL_68:
    *(_DWORD *)(v4 + 2032) += 16 * v38;
    return result;
  }
  if ( !*(_QWORD *)(a1 + 2376) )
    goto LABEL_13;
...
LABEL_6:
  ...
  {
    --j;
    result = (*(__int64 (__fastcall **)(unsigned __int64, __int64, __int64))(v4 + 672))(v7, v6, a3);
    if ( (_BYTE)result )
    {
      if ( !*(_DWORD *)(v4 + 2240) )
      {
        ...
        *(_QWORD *)(v4 + 2272) = v7;
        *(_DWORD *)(v4 + 2240) = 1;
        result = sub_140AD049C(v4, 0LL, a3, v9);
      }
    }
    *(_DWORD *)(v4 + 2032) += 256;
  }
