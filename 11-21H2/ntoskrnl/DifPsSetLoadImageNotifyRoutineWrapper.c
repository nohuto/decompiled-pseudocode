/*
 * XREFs of DifPsSetLoadImageNotifyRoutineWrapper @ 0x14061A990
 * Callers:
 *     <none>
 * Callees:
...
NTSTATUS __fastcall DifPsSetLoadImageNotifyRoutineWrapper(PLOAD_IMAGE_NOTIFY_ROUTINE NotifyRoutine)
{
  __int64 v2; // rdx
  __int64 v3; // rcx
...
LABEL_18:
  result = PsSetLoadImageNotifyRoutine(NotifyRoutine);
  LODWORD(v14) = result;
  if ( APIThunkContextById )
  {
