/*
 * XREFs of sub_1403BD330 @ 0x1403BD330
 * Callers:
...
__int64 __fastcall sub_1403BD330(_DWORD *a1)
{
  int v1; // eax
  __int64 result; // rax
  int v4; // eax
  ...
  v8 = -6;
  v7 = v1;
  result = sub_1403BD66C(&v7);
  if ( (int)result >= 0 )
  {
    if ( !a1[8]
      || (v4 = a1[2], v12 = -1, v7 = v4, v10 = 3, v8 = -7, v9 = -6, result = sub_1403BD66C(&v7), (int)result >= 0) )
    {
      if ( !a1[9]
        || (v6 = a1[2], v12 = -1, v7 = v6, v10 = 3, v8 = -8, v9 = -7, result = sub_1403BD66C(&v7), (int)result >= 0) )
      {
        v5 = a1[2];
        v12 = -1;
        v7 = v5;
