/*
 * XREFs of sub_1407FD930 @ 0x1407FD930
 * Callers:
...
__int64 __fastcall sub_1407FD930(int a1, int a2)
{
  __int64 result; // rax
  ...
  if ( byte_140C5AE14 )
  {
    ...
    *(_QWORD *)&v5.Size = 4LL;
    v7 = 4LL;
    v9 = 8LL;
    return EtwWriteStartScenario(RegHandle, &stru_14000EFD8, &OutputBuffer, 3u, &v5);
  }
  return result;
}
