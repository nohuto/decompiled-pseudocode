/*
 * XREFs of sub_1406C800C @ 0x1406C800C
 * Callers:
...
__int64 __fastcall sub_1406C800C(__int64 a1, __int64 a2, USHORT a3, _DWORD *a4)
{
  unsigned int v4; // ebx
  ...
  else
  {
    if ( (_DWORD)v9 )
    {
      ...
      {
        v12 = sub_140348800(v22);
        *(_DWORD *)(a1 + 24LL * v11) = *(unsigned __int8 *)(v12 + 209);
        sub_140248720(v12, a1 + 8 + 24LL * v11, (_DWORD *)(a1 + 12 + 24LL * v11), 0LL, 0LL, 0LL);
        v13 = *(_QWORD *)(v12 + 33968);
        if ( v13 )
          v14 = *(_DWORD *)(v13 + 440);
        else
          v14 = *(_DWORD *)(v12 + 68);
        *(_DWORD *)(a1 + 24LL * v11 + 4) = v14;
        v15 = *(_QWORD *)(v12 + 33600);
        if ( v15 )
        {
