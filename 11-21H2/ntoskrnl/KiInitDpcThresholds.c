/*
 * XREFs of KiInitDpcThresholds @ 0x140B2CB08
 * Callers:
 *     KeInitSystem @ 0x140B03800 (KeInitSystem.c)
 * Callees:
 *     KiInitializeLegacyWatchdogProfileThresholds @ 0x140B2CC08 (KiInitializeLegacyWatchdogProfileThresholds.c)
 */
...
__int64 KiInitDpcThresholds()
{
  ...
  v6 = (unsigned int)KeDpcWatchdogProfileBufferSizeBytes;
  if ( (_DWORD)KeDpcWatchdogProfileBufferSizeBytes != -1 )
  {
    result = (unsigned int)((_DWORD)KeDpcWatchdogProfileBufferSizeBytes - 1);
    if ( (unsigned int)result > 0x1FFE )
      goto LABEL_25;
    v6 = 0x2000;
LABEL_38:
    LODWORD(KeDpcWatchdogProfileBufferSizeBytes) = v6;
    goto LABEL_25;
  }
  v6 = 0;
  LODWORD(KeDpcWatchdogProfileBufferSizeBytes) = 0;
  if ( (_DWORD)result || v5 )
  {
    v6 = 266240;
    goto LABEL_38;
