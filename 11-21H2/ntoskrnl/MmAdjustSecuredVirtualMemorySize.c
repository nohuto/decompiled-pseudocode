/*
 * XREFs of MmAdjustSecuredVirtualMemorySize @ 0x14096D7DC
 * Callers:
...
__int64 __fastcall MmAdjustSecuredVirtualMemorySize(__int64 a1, unsigned __int64 a2, __int64 a3)
{
  ...
  v4 = 0;
  v11 = 0;
  v6 = a1 ^ qword_140C50680 ^ (__int64)KeGetCurrentThread()->ApcState.Process;
  v7 = (char *)MiObtainReferencedSecureVad(v6, (int *)&v11);
  if ( !v7 )
    return v11;
  v9 = *(_QWORD *)(v6 + 8);
