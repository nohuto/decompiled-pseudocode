/*
 * XREFs of sub_1409AF200 @ 0x1409AF200
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall sub_1409AF200(HANDLE *a1, int a2, int a3, ULONG_PTR a4, int a5)
{
  char v8; // r14
  __int64 v9; // rcx
  int v10; // edi
  ...
  {
    v10 = sub_140732D40(a4, 32, (__int64)PsThreadType, v8, 0x63547350u, &Object, 0LL, 0LL);
    if ( v10 >= 0 )
    {
      v10 = sub_14072B3B0(v8, (_DWORD *)qword_140D06E10, a3, v8, Tag, 24, 0, 0, v16, 0LL);
      if ( v10 >= 0 )
      {
        v11 = (PVOID *)v16[0];
        *(_OWORD *)v16[0] = 0LL;
