/*
 * XREFs of MiInitializeWorkingSetManagerParameters @ 0x1403DADE0
 * Callers:
...
__int64 __fastcall MiInitializeWorkingSetManagerParameters(__int64 a1)
{
  ...
  *(_BYTE *)(a1 + 12) = 0;
  ...
  __writecr8(v8);
  if ( (ULONG_PTR *)a1 == &MiSystemPartition && (v9 = 135168LL, v7 < 0x21000) )
  {
    v7 = 135168LL;
  }
  else
...
LABEL_28:
  ...
  v24[0] = v16;
  if ( (ULONG_PTR *)a1 != &MiSystemPartition || !qword_140D05208 || (v17 = qword_140D05208 << 8) == 0 )
  {
    v17 = v16;
    if ( v16 <= v9 )
    {
  ...
  v24[1] = v17;
  v24[2] = a1;
  KeGenericCallDpc((__int64)MiUpdatePageThresholdsDpc, (__int64)v24);
  return 1LL;
}
