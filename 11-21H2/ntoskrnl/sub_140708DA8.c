/*
 * XREFs of sub_140708DA8 @ 0x140708DA8
 * Callers:
...
__int64 __fastcall sub_140708DA8(__int64 a1, __int64 a2, __int64 a3, __int64 a4)
{
  __int16 v6; // cx
  int v7; // r8d
  unsigned int v8; // eax
