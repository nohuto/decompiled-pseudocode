/*
 * XREFs of MiOutSwapWorkingSetPte @ 0x140315EE0
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall MiOutSwapWorkingSetPte(__int64 a1, ULONG_PTR a2, int a3)
{
  ...
  if ( !a3 )
  {
    ...
    do
    {
      ...
      if ( (v10 & 1) != 0 )
      {
        v31 = ((unsigned __int64)MI_READ_PTE_LOCK_FREE(&v46) >> 12) & 0xFFFFFFFFFFLL;
        ...
        if ( *(__int64 *)(v8 + 40) >= 0 )
        {
          ...
          {
            do
              KeYieldProcessorEx(&v45, v32, v33, v34);
          ...
          {
            v44 = *(_QWORD *)(v8 + 16);
            MiSetNonResidentPteHeat(&v44, 0LL);
            v18 = v44;
            if ( (v19 & 0x400) == 0 )
            {
            ...
            {
              if ( v18 )
                updated = MiUpdatePageFileHighInPte(v18, 0xFFFFFFFFLL);
              else
                updated = MiSwizzleInvalidPte(0xFFFFFFFF00000000uLL);
              v18 = updated ^ (unsigned __int16)(updated ^ (v21 << 12)) & 0xF000;
              v44 = v18;
            }
            v46 = v18;
            *(_QWORD *)(v8 + 16) = v18;
          ...
          if ( (_DWORD)v22 != -1 )
          {
            ...
            if ( (unsigned int)v22 >= 5 || !*(_DWORD *)(16 * v22 + v3 + 40 + 8) )
              goto LABEL_38;
            MiReservePageFileSpaceForPage(v42, a2, 128LL);
            v38 = *v43;
            if ( qword_140C50780 && (v38 & 0x10) == 0 )
              v38 &= ~qword_140C50780;
            v39 = MiUpdatePageFileHighInPte(*v43, HIDWORD(v38) + 1);
            *(_QWORD *)v40 = v39;
            if ( (*(_DWORD *)(v40 + 8))-- == 1 )
              ++*(_DWORD *)(v3 + 32);
            v9 |= 0x10u;
...
LABEL_61:
      ...
      v35 = MiLockTransitionLeafPageEx(a2, 0LL, 0);
      v8 = v35;
    }
    while ( !v35 );
    v36 = *(_BYTE *)(v35 + 34);
...
LABEL_39:
    if ( v6 )
    {
      if ( (v6 & 4) != 0 )
        v6 &= ~4uLL;
      v29 = v42;
      MiReleasePageFileInfo(v42, v6, 0);
    }
    else
    {
      v29 = v42;
    ...
    if ( v7 )
      MiReleasePageFileInfo(v29, v7, 0);
  }
  return 0LL;
}
