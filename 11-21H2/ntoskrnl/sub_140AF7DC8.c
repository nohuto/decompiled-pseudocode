/*
 * XREFs of sub_140AF7DC8 @ 0x140AF7DC8
 * Callers:
...
void __fastcall sub_140AF7DC8(__int64 a1)
{
  __int64 v1; // rbx
...
LABEL_33:
        ...
        LOBYTE(v33) = 1;
        v34 = 1;
        v5 = (unsigned int *)sub_140AF740C(v1, (__int64)v32);
        if ( !v5 )
          goto LABEL_25;
      }
      else
    ...
    else
    {
      ...
      RtlInitUnicodeString(&v28, L".Translated");
      v5 = (unsigned int *)qword_140D06950;
    }
    if ( !*v5 )
    {
      if ( v2 )
...
LABEL_18:
    ...
    v10 = v25;
LABEL_20:
    if ( (int)sub_14067A8B0(&Handle, 0LL, &stru_140D3CF68, 0x2001Fu, 1u, 0LL) >= 0 )
    {
      sub_140821F5C(Handle, &DestinationString, &v29, &v28, v12, v10);
      ZwClose(Handle);
    }
