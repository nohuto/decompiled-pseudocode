/*
 * XREFs of sub_14057D2A8 @ 0x14057D2A8
 * Callers:
...
__int64 __fastcall sub_14057D2A8(unsigned int *a1, _DWORD *a2, unsigned int *a3, unsigned int *a4, _DWORD *a5)
{
  unsigned int *v5; // r14
  __int64 v10; // rbx
  _WORD *v11; // rax
  ...
  v5 = a4;
  if ( (*(_BYTE *)(*((_QWORD *)KeGetCurrentThread() + 23) + 643LL) & 4) != 0 )
    return 0LL;
  v10 = *a1;
  v23 = (unsigned int)*a2;
  v22 = 0;
  v11 = (_WORD *)&KeGetPcr()->NtTib.Self[218].SubSystemTib + 1;
  if ( (*v11 & 1) != 0 )
  {
    v12 = 1;
    v21 = 1;
  ...
  if ( *(_DWORD *)v10 == 69485767 && *(_BYTE *)(v10 + 8) == 0xE9 )
  {
    ...
    LOBYTE(a4) = 1;
    if ( !(unsigned __int8)sub_140977FF8(v10, v23, v13, a4, v21) || !v12 )
      return v22;
    v14 = v23 + 4;
  ...
  if ( *(_BYTE *)v10 == 0xB9 && *(_BYTE *)(v10 + 5) == 0xE9 )
  {
    ...
    LOBYTE(a4) = 1;
    if ( !(unsigned __int8)sub_140977FF8(v10, v23, v16, a4, v21) || !v12 )
      return v22;
    *v5 = *(_DWORD *)(v10 + 1);
    goto LABEL_31;
  }
  ...
  {
    v17 = *(_DWORD *)(v10 + 6);
    if ( (unsigned __int8)sub_140977FF8(v10, v23, v17, 0LL, v21) )
    {
      *a5 = *(_DWORD *)(v10 + 1);
      *v5 = v17;
      *a1 = v17;
  ...
  else
  {
    if ( v15 != -71 || *(_BYTE *)(v10 + 5) != 0xB8 || *(_WORD *)(v10 + 10) != 0xE0FF )
    {
        ...
        && *(_BYTE *)(v10 + 5) == 4 )
      {
        ...
        if ( (unsigned __int8)sub_140977FF8(v10, v23, v20, 0LL, v21) )
        {
          *v5 = *(_DWORD *)v23;
          *a3 = *v18;
          *v18 = *v5;
