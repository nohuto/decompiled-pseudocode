/*
 * XREFs of PiCMDeviceAction @ 0x14065F3BC
 * Callers:
    ...
    if ( inited >= 0 )
    {
      ...
      if ( v13 )
      {
        ...
        if ( (unsigned __int8)PiAuDoesClientHaveAccess(32LL) && (unsigned __int8)PiAuDoesClientHavePrivilege(10LL) )
        {
          ...
          if ( inited < 0 )
            goto LABEL_24;
          v16 = PiQueueDeviceRequest((unsigned int)&DestinationString, 9, v18, v9 != 2, 0LL);
          goto LABEL_23;
        }
        goto LABEL_38;
      }
...
LABEL_38:
      ...
      if ( inited >= 0 )
      {
        ...
        inited = PiQueueDeviceRequest((unsigned int)&DestinationString, v23, v19, 1, (__int64)&DeviceStatus);
        if ( inited >= 0 )
          inited = DeviceStatus;
      }
    }
LABEL_24:
    inited = PiCMReturnBasicResultData((unsigned int)inited, (unsigned int)v31, a3, a4, a6);
  }
