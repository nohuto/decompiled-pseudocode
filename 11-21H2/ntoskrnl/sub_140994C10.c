/*
 * XREFs of sub_140994C10 @ 0x140994C10
 * Callers:
...
NTSTATUS __fastcall sub_140994C10(__int64 a1)
{
  unsigned int v1; // eax
  IRP *v3; // rcx
  NTSTATUS result; // eax
  ...
  v13.m256i_i64[0] = v1;
  sub_140850D98(v3, 0x294044u, 0, (struct _IRP *)&v13, 0xCu, 0x24u);
  ...
  if ( result >= 0 )
  {
    ...
    *(_DWORD *)(a1 + 104) = 3;
    v9 = (_QWORD *)(a1 + 64);
    v10 = (_QWORD *)qword_140C229D8;
    if ( *(__int64 **)qword_140C229D8 != &qword_140C229D0 )
      __fastfail(3u);
    v9[1] = qword_140C229D8;
    *v9 = &qword_140C229D0;
    *v10 = v9;
    ++dword_140C229B4;
    ++dword_140C22A18;
    result = 0;
    qword_140C229D8 = (__int64)v9;
    byte_140C229B8 = 1;
  }
  return result;
}
