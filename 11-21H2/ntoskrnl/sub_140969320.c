/*
 * XREFs of sub_140969320 @ 0x140969320
 * Callers:
...
__int64 __fastcall sub_140969320(_QWORD *a1, unsigned int *a2, _QWORD *a3)
{
  __int64 v3; // r9
  char v4; // bl
  unsigned int *v7; // rdi
...
LABEL_15:
  ...
  if ( v7 )
    v15 += 8 * (v12 + v3);
  v16 = sub_1402828F0(64, v15, 0x20206D4Du);
  if ( !v16 )
    return 3221225626LL;
  v16[1] = 1LL;
  v18 = (char *)(v16 + 2);
