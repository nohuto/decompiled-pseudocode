/*
 * XREFs of HalSocRequestApi @ 0x1403B38C8
 * Callers:
 ...
 *     HalpHvCounterUpdateCallback @ 0x140521D90 (HalpHvCounterUpdateCallback.c)
  ...
  if ( !v12 )
  {
    if ( HalpIsMicrosoftCompatibleHvLoaded() )
    {
      ...
      if ( (_RAX & 2) != 0 )
      {
        ...
        HalpTimerHypervisorReferenceTime = qword_140C4C488;
