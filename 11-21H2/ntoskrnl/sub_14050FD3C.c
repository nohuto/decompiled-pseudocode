/*
 * XREFs of sub_14050FD3C @ 0x14050FD3C
 * Callers:
...
__int64 __fastcall sub_14050FD3C(PLARGE_INTEGER SystemTime)
{
  __int64 v3; // r8
  int v4; // r14d
  char *v5; // rbx
  ...
  v16 = 0LL;
  if ( !off_140E00010 || !*off_140E00010 )
    return 3221225474LL;
  if ( !SystemTime )
    return 3221225485LL;
  sub_140456C50(&dword_140C4C188);
  sub_140456C76(1u);
  ((void (__fastcall *)(__int128 *, _QWORD))*off_140E00010)(&v16, 0LL);
  ...
  {
    if ( sub_14022D554(v14, &LocalTime) )
    {
      v7 = LocalTime;
      goto LABEL_25;
    }
  ...
  v6 = *((_DWORD *)qword_140C15B58 + 1);
  _InterlockedOr(v12, 0);
  if ( !sub_14022D554(v14, &v15) )
    return (unsigned int)-1073741823;
  v7 = v15;
  v8 = 0;
  if ( !v6 )
