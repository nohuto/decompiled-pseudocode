/*
 * XREFs of sub_1409A556C @ 0x1409A556C
 * Callers:
 ...
 * Callees:
 *     sub_1409A5A54 @ 0x1409A5A54 (sub_1409A5A54.c)
 *     sub_1409A8628 @ 0x1409A8628 (sub_1409A8628.c)
 */

bool __fastcall sub_1409A556C(__int64 a1, int a2, __int64 *a3)
{
  __int64 v3; // rdi
  __int64 v4; // rbp
  __int64 v5; // rbx
...
LABEL_5:
    while ( 1 )
    {
      ...
      if ( v9 == (v8 & *(_QWORD *)(v5 + 8)) )
      {
        if ( !v5 )
          break;
        if ( (unsigned int)sub_1409A5A54(v5, v4) )
        {
          v3 = v5;
          goto LABEL_11;
        }
  ...
  sub_1409A8628("TtmpFindPowerRequestEntryById", 401LL, 3221226021LL, 0xFFFFFFFFLL);
LABEL_11:
  if ( a3 )
    *a3 = v3;
  return v3 != 0;
