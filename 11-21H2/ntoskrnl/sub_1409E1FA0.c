/*
 * XREFs of sub_1409E1FA0 @ 0x1409E1FA0
 * Callers:
...
void __fastcall sub_1409E1FA0(__int64 a1, __int64 a2, __int64 a3, int a4, int a5, __int64 a6)
{
  unsigned int v6; // edi
  unsigned int v7; // esi
  bool v8; // zf
    ...
    do
    {
      ...
      if ( v11 )
      {
        if ( (*(_DWORD *)(v11 + 16) & 0x40) != 0 )
        {
          ...
          if ( *v13 )
          {
            while ( !(unsigned int)sub_14063A59C(v10, *(_DWORD *)&v13[2 * v12 + 2]) )
            {
...
LABEL_9:
    ...
    if ( v6 )
    {
      ...
      v24[0] = &v15;
      v24[1] = 26LL;
      sub_14062FC2C((__int64)v24, 1u, v6, 0x1122u, 0x10501903u);
    }
  }
}
