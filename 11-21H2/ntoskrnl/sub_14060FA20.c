/*
 * XREFs of sub_14060FA20 @ 0x14060FA20
 * Callers:
 *     <none>
 * Callees:
...
NTSTATUS __fastcall sub_14060FA20(PDEVICE_OBJECT DeviceObject, PIO_TIMER_ROUTINE TimerRoutine, PVOID Context)
{
  __int64 v6; // rdx
  __int64 v7; // rcx
  __int64 *v8; // rdi
...
LABEL_18:
  result = IoInitializeTimer(DeviceObject, TimerRoutine, Context);
  LODWORD(v20) = result;
  if ( v8 )
  {
    v16 = (_QWORD **)(v8 + 6);
