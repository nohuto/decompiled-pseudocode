/*
 * XREFs of MiMarkHugeRangeTransition @ 0x140591C4C
 * Callers:
...
__int64 __fastcall MiMarkHugeRangeTransition(__int64 a1, unsigned __int64 a2)
{
  unsigned int v2; // ebx
  int v5; // ebp
  int v6; // esi
...
LABEL_23:
  ...
  {
    if ( v6 )
      MiDangleHugeRange(a1, a2, v6);
    v7 = 2;
  }
  MiUnlockIoPfnTree(v8, v7);
  LOBYTE(v2) = v6 != 0;
  return v2;
}
