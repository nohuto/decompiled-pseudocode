/*
 * XREFs of sub_1405287F0 @ 0x1405287F0
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall sub_1405287F0(__int64 a1, __int64 a2, int a3, int a4, _QWORD *a5)
{
  unsigned int v8; // ecx
  ...
  if ( _InterlockedAdd((volatile signed __int32 *)(a1 + 24), 1u) > 0 )
  {
    ...
    else if ( (int)sub_14052936C(a4, (unsigned int)&v15, (unsigned int)&v18, (unsigned int)&v16, (__int64)&v17) < 0
    ...
    else
    {
      ...
      v14 = a2 + *(_QWORD *)a1;
      if ( v18 )
        v11 = sub_14051AC2C(v10, a3, v17, v15, v14);
      else
        v11 = sub_14051ABD8(v10, a3, v16, v15 >> 12, v14);
      v8 = v11;
      if ( v11 >= 0 )
      {
        v12 = a5;
