/*
 * XREFs of sub_14064ED90 @ 0x14064ED90
 * Callers:
...
__int64 __fastcall sub_14064ED90(
        __int64 a1,
        int a2,
        _WORD *a3,
        _WORD *a4,
        ...
        __int64 *a8)
{
  ...
  *a3 = 0;
  ...
  sub_1403A9A4C(v11, (unsigned int)(v9 + a2), &v29);
  if ( (v29 & 0x8000u) == 0 )
    return 3221225485LL;
  v12 = a7;
  v13 = v10 + 10;
...
LABEL_31:
    ...
    *v17 = v16;
    v12[1] = v16;
    sub_1403A9A4C(v11, v13, &v30);
    v18 = v30;
    v19 = v13 + 2;
    *(_WORD *)(v16 + 24) = v30;
    sub_1403A9A4C(v11, v19, v28);
    *(_WORD *)(v16 + 26) = v28[0];
    sub_1403A9A4C(v11, v19 + 2, v27);
    if ( (v18 & 1) != 0 )
    {
      *(_WORD *)(v16 + 28) = v27[0];
      sub_1403A9A4C(v11, v19 + 4, v27);
      v13 = v19 + 6;
      *(_WORD *)(v16 + 30) = v27[0];
    }
    else
    ...
    if ( (v18 & 8) == 0 )
    {
      if ( (v18 & 0x40) != 0 )
      {
        sub_1403A9A4C(v11, v13, &v33);
        *(_WORD *)(v16 + 32) = v33;
        sub_1403A9A4C(v11, v13 + 2, &v33);
        *(_WORD *)(v16 + 34) = v33;
      }
      else
      {
    ...
    *(_WORD *)(v16 + 32) = v33;
LABEL_18:
    v21 = sub_1403A99B0(a1, v28[0], &v31);
    if ( v21 < 0 )
      break;
    v21 = sub_1403AA550(a1, v31, (int)v28, (__int64 *)&v32, a8);
    if ( v21 < 0 )
      break;
    v22 = v34;
    *(_QWORD *)(v16 + 16) = v32;
...
LABEL_27:
  while ( 1 )
  {
    ...
    *v12 = v26;
    *(_QWORD *)(v26 + 8) = v12;
    sub_1403A8C98(v25[2], v14);
    sub_1403A8C98((__int64)v25, v14);
  }
}
