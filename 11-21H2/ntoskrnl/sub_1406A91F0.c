/*
 * XREFs of sub_1406A91F0 @ 0x1406A91F0
 * Callers:
 *     <none>
 * Callees:
...
NTSTATUS __fastcall sub_1406A91F0(
        HANDLE Handle,
        unsigned int a2,
        __int64 a3,
        unsigned int a4,
        ...
        size_t Size)
{
  ...
  if ( (unsigned int)Size > 0x100 )
    return -1073741580;
  Object = 0LL;
  result = ObReferenceObjectByHandle(Handle, 2u, qword_140D06BB0, v12, &Object, 0LL);
  v27 = result;
  if ( result < 0 )
    return result;
  v14 = Object;
...
LABEL_8:
  ...
  *((_QWORD *)&Argument1[3] + 1) = v14;
  ...
  ExNotifyCallback(CallbackObject, Argument1, 0LL);
