/*
 * XREFs of KiInterruptDispatchNoEOI @ 0x1404222A0
 * Callers:
 *     <none>
 * Callees:
...
/*
 * Hex-Rays decompilation failed for KiInterruptDispatchNoEOI @ 0x1404222A0
 ...
 * 00000001404222BD: cmp     cs:KiBugCheckActive, 0
 ...
 * 00000001404222D2: call    KiInterruptSubDispatchNoLock
 ...
 * 0000000140422318: call    KiBeginThreadAccountingPeriod
 ...
 * 0000000140422344: call    KiDpcInterruptBypass
 * 0000000140422349: jmp     short loc_140422368
 * 000000014042234B: mov     ecx, 2
 * 0000000140422350: call    cs:__imp_HalRequestSoftwareInterrupt
 ...
 * 000000014042236C: cmp     cs:KiIrqlFlags, 0
 * 0000000140422373: jz      short loc_14042237C
 * 0000000140422375: call    KzSetIrqlUnsafe
 ...
 * 0000000140422394: test    byte ptr cs:KeSmapEnabled, 0FFh
 ...
 * 00000001404223BC: call    KiInitiateUserApc
 ...
 * 000000014042240C: call    KiCopyCounters
 ...
 * 0000000140422428: call    KiRestoreDebugRegisterState
 ...
 * 0000000140422657: test    cs:KiKvaShadow, 1
 * 000000014042265E: jz      short loc_140422665
 * 0000000140422660: jmp     KiKernelExit
