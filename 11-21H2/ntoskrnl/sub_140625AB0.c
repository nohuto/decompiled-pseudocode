/*
 * XREFs of sub_140625AB0 @ 0x140625AB0
 * Callers:
 *     <none>
 * Callees:
...
NTSTATUS __fastcall sub_140625AB0(HANDLE LinkHandle, PUNICODE_STRING LinkTarget, PULONG ReturnedLength)
{
  __int64 v6; // rdx
  __int64 v7; // rcx
  __int64 *v8; // rdi
