/*
 * XREFs of I_MinCryptFindIssuerCertificateByName @ 0x140A31EE0
 * Callers:
...
__int64 __fastcall I_MinCryptFindIssuerCertificateByName(unsigned int *a1, unsigned int a2, __int64 a3)
{
  SIZE_T v3; // r14
  unsigned int v4; // edi
  const void *v5; // r12
