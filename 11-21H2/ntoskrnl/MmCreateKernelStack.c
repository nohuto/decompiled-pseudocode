/*
 * XREFs of MmCreateKernelStack @ 0x1402F4B70
 * Callers:
      ...
      || (v11 = _InterlockedExchange64((volatile __int64 *)&v10->CachedStack, 0LL)) == 0 )
    {
      ...
      while ( 1 )
      {
        ...
        if ( FirstEntrySList((PSLIST_HEADER)v18) )
        {
          ...
          v48 = RtlpInterlockedPopEntrySList((PSLIST_HEADER)v18);
          if ( v48 )
          {
            ...
            if ( v8 != 1 )
            {
              ...
              do
              {
                v46 = MI_READ_PTE_LOCK_FREE(v20);
                v23 = 48 * (((unsigned __int64)MI_READ_PTE_LOCK_FREE(&v46) >> 12) & 0xFFFFFFFFFFLL) - 0x220000000000LL;
                v51 = 0;
                while ( _interlockedbittestandset64((volatile signed __int32 *)(v23 + 24), 0x3FuLL) )
                {
                  do
                    KeYieldProcessorEx(&v51, v22, v24, v25);
                  while ( *(__int64 *)(v23 + 24) < 0 );
                }
                v26 = MI_READ_PTE_LOCK_FREE(v20);
                if ( v46 == v26 )
                {
                  MiSetPfnKernelStack(v23, v6);
                  v20 -= 8LL;
                }
...
LABEL_36:
  if ( !(unsigned int)MiChargeCommit(v5, v7, (v4 >> 1) & 1) )
    return 0LL;
  v28 = MiReservePtes(&unk_140C52F98, v7 + 1);
  v49 = v28;
  if ( !v28 )
  {
LABEL_86:
  ...
  if ( !(unsigned int)MiChargeResident(v5, v9, 0LL) )
    goto LABEL_85;
  if ( !(unsigned int)MiAllocateKernelStackPages((_DWORD)v5, v45 + 8, v9, v6, v3, v4, 0LL) )
  {
    if ( v5 == &MiSystemPartition )
    {
      v40 = KeGetCurrentPrcb();
      CachedResidentAvailable = (int)v40->CachedResidentAvailable;
      if ( (_DWORD)CachedResidentAvailable != -1 )
      {
        if ( CachedResidentAvailable + v9 <= 0x100 )
        {
          do
          {
            ...
            v35 = (_DWORD)CachedResidentAvailable == v42;
...
LABEL_85:
    MiReleasePtes((__int64)&unk_140C52F98, (_QWORD *)v49, v7 + 1);
    goto LABEL_86;
  }
  if ( v5 == &MiSystemPartition )
