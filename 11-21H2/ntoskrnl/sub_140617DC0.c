/*
 * XREFs of sub_140617DC0 @ 0x140617DC0
 * Callers:
 *     <none>
 * Callees:
...
NTSTATUS __fastcall sub_140617DC0(POBJECT_ATTRIBUTES ObjectAttributes)
{
  __int64 v2; // rdx
  __int64 v3; // rcx
  __int64 *v4; // rdi
...
LABEL_18:
  result = NtDeleteFile(ObjectAttributes);
  LODWORD(v15) = result;
  if ( v4 )
  {
    v12 = (_QWORD **)(v4 + 6);
