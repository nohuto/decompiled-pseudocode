/*
 * XREFs of MiStoreWriteModifiedPages @ 0x14037B44C
 * Callers:
...
__int64 __fastcall MiStoreWriteModifiedPages(__int64 a1)
{
  ...
  struct _SLIST_ENTRY *ListEntry; // [rsp+50h] [rbp-79h]
...
LABEL_5:
  if ( v14 < v12 )
  {
    ...
    if ( v100 != *(_QWORD *)(v7 + 112) )
    {
      if ( v100 )
      {
        v58 = (void *)MiDerefPageFileSpaceBitmaps(v7, &v100, 1LL);
        if ( v58 )
...
LABEL_18:
        ...
        v8 = (unsigned __int8)MiLockPageInline(v10);
        if ( (*(_QWORD *)(v10 + 24) & 0x4000000000000000LL) == 0 )
        {
          v92 = 0LL;
          v25 = MiStoreCheckCandidatePage(v10, (__int64)&v92);
          if ( v25 >= 0 )
          {
            ...
            LOBYTE(v8) = 17;
            if ( ListEntry
              || (ListEntry = RtlpInterlockedPopEntrySList((PSLIST_HEADER)(v5 + 1248))) != 0LL
              || (ListEntry = (struct _SLIST_ENTRY *)MiAllocatePool(64, 0x78uLL, 0x57536D4Du)) != 0LL )
            {
              ...
              if ( v104 )
              {
                ...
                {
                  v104 &= -((unsigned __int64)(KiQueryUnbiasedInterruptTime() - v97) < 0x2FAF080);
                }
                else
                {
                  v104 = 0;
              ...
              v27 = MiStoreWriteIssue(ListEntry, v10, &v94, &v96, ListEntry, v92, a1, v104);
              if ( v27 >= 0 )
              {
                ListEntry = 0LL;
                ...
                *(_DWORD *)(v91 + 120) = v24 + 1;
                ...
                __writecr8(v28);
                v29 = (unsigned __int8)MiLockPageInline(v10);
                v30 = MiCapturePageFileInfoInline((unsigned __int64 *)(v10 + 16), 1, 1);
                *(_QWORD *)(v10 + 16) &= ~2uLL;
                v31 = v24;
                v7 = v91;
                v32 = v30;
                MiUpdatePfnBackingStore(v10, v91, v31, 1LL);
                _InterlockedAnd64((volatile signed __int64 *)(v10 + 24), 0x7FFFFFFFFFFFFFFFuLL);
                if ( KiIrqlFlags )
                {
                  if ( (KiIrqlFlags & 1) != 0 )
                ...
                __writecr8(v29);
                LOBYTE(v8) = 17;
                MiReleasePageFileInfo(v5, v32, 2);
                v33 = v87;
LABEL_33:
                v14 = v33 + 1;
                v4 = a1;
              ...
              if ( v27 == -1073740682 )
              {
                ...
                if ( v105 < v26 )
                {
                  MiStoreLogWriteIssueRetry((unsigned int)&v96, v24, v105, v104, *(_DWORD *)(v5 + 1192));
                  v12 = v89;
                  v7 = v91;
                  v14 = v87;
                  v13 = v93;
              ...
              MiStoreLogWriteIssueFailure(v27, (unsigned int)&v96, v24, v105, v104, ++*(_DWORD *)(v5 + 1192));
            }
            else
            {
              v88 = 1;
...
LABEL_45:
  ...
  updated = MiTransferSoftwarePte(ZeroPte, *(_QWORD *)(v4 + 144), v40);
  while ( 2 )
  {
...
LABEL_56:
    if ( v39 != -1 )
    {
      ...
      else
      {
        ...
        v82 = (unsigned __int8)MiLockPageInline(v81);
        *(_BYTE *)(v81 + 34) |= 0x10u;
  ...
  MiStoreUpdatePagefileHash(v51, v50, v99, v89);
  v54 = CurrentThread;
  *(_DWORD *)(a1 + 40) |= 0x20u;
  --v54->SpecialApcDisable;
  ++*(_DWORD *)(v5 + 1196);
  j = v54->SpecialApcDisable++ == -1;
  if ( j && ($CEA84C04E3712D858E5667A507841A2A *)v54->ApcState.ApcListHead[0].Flink != &v54->152 )
...
LABEL_61:
  ...
  if ( v100 )
  {
    v56 = (void *)MiDerefPageFileSpaceBitmaps(v7, &v100, 0LL);
    if ( v56 )
