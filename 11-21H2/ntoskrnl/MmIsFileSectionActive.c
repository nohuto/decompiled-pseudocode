 ...
 *     <none>
 * Callees:
 *     MiIsSectionActive @ 0x140258F14 (MiIsSectionActive.c)
...
__int64 __fastcall MmIsFileSectionActive(__int64 a1, int a2, _DWORD *a3)
{
  ...
  if ( (a2 & 1) == 0 )
    goto LABEL_31;
  v7 = MiLockSectionControlArea(a1, 0LL, &v23);
  if ( !v7 )
    goto LABEL_31;
...
LABEL_31:
    if ( (v4 & 2) != 0 )
    {
      v8 = MiLockSectionControlArea(a1, 1LL, &v23);
      if ( v8 )
      {
        IsSectionActive = MiIsSectionActive(v8);
        ExReleaseSpinLockExclusiveFromDpcLevel((PEX_SPIN_LOCK)(v10 + 72));
        if ( KiIrqlFlags && (KiIrqlFlags & 1) != 0 && (v19 = KeGetCurrentIrql(), v19 <= 0xFu) )
        {
          v11 = v23;
          if ( v23 <= 0xFu && v19 >= 2u )
          {
