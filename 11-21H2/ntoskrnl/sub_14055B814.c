/*
 * XREFs of sub_14055B814 @ 0x14055B814
 * Callers:
...
char __fastcall sub_14055B814(const GUID *a1, __int64 a2)
{
  int v3; // eax
  _DWORD *v4; // rcx
  ...
  if ( (_BYTE)v3 )
  {
    if ( !v4[104] )
    {
      ...
      if ( (v3 & 1) != 0 )
      {
        ...
        v5 = (const EVENT_DESCRIPTOR *)qword_140038528;
        if ( (v4[20] & 1) == 0 )
          v5 = &stru_140037EE0;
        UserData.Size = 8;
        ...
        if ( (unsigned int)dword_140C064E0 > 5 )
        {
          ...
          if ( (_BYTE)v3 )
          {
            ...
            LOBYTE(v3) = sub_14020A9C4(
                           ...
                           (unsigned __int8 *)byte_14002B388,
                           a1 + 60,
                           a1 + 59,
                           4u,
                           &v10);
