/*
 * XREFs of Feature_1729178936__private_IsEnabled @ 0x14041A0D4
 * Callers:
...
__int64 Feature_1729178936__private_IsEnabled()
{
  ...
  CachedFeatureEnabledState = wil_details_FeatureStateCache_GetCachedFeatureEnabledState(
                                (unsigned int *)&Feature_1729178936__private_featureState,
                                (__int64)&Feature_1729178936__private_descriptor);
  v1 = (CachedFeatureEnabledState >> 3) & 1;
  wil_details_FeatureReporting_ReportUsageToService(
    (__int64)&Feature_1729178936__private_reporting,
    0x3179A47u,
