/*
 * XREFs of sub_1409A8E90 @ 0x1409A8E90
 * Callers:
...
char __fastcall sub_1409A8E90(char a1, __int64 a2, int a3, int a4, int a5)
{
  _UNKNOWN **v5; // rax
  ...
  if ( (unsigned int)dword_140D3B908 > 5 )
  {
    ...
    if ( (_BYTE)v5 )
    {
      ...
      v14 = a3;
      v15 = a4;
      LOBYTE(v5) = sub_14020A9C4((__int64)&dword_140D3B908, (unsigned __int8 *)&dword_140032D34, 0LL, 0LL, 8u, &v18);
    }
  }
  return (char)v5;
}
