/*
 * XREFs of sub_1403A8390 @ 0x1403A8390
 * Callers:
...
__int64 __fastcall sub_1403A8390(
        __m128i *a1,
        __int64 a2,
        __int16 a3,
        unsigned int a4,
        ...
        __int128 *a9)
{
  ...
  *a7 = 0;
  ...
  if ( (unsigned __int16)v46 >= 0x20u )
  {
    v15 = *(_DWORD *)(v48 + 16);
    v49 = *(_DWORD **)(v48 + 8);
    sub_1403AA764((unsigned int)&qword_140C0DE60, (unsigned __int16)v46, v15, v49[10], (__int64)v49, (__int64)&v51);
    v18 = (_BYTE *)v51;
    if ( v51 )
    {
      v22 = v48;
    ...
    v24 = *((__int16 *)v21 + 43);
    v25 = *((_DWORD *)v18 + 11);
    v49 = (_DWORD *)*((_QWORD *)v18 + 2);
    v26 = *(_QWORD *)(v22 + 8);
    v47 = *v49 / *((_DWORD *)v18 + 14);
    v45 = v25;
...
LABEL_21:
        sub_1403A8700((_DWORD)v49, (_DWORD)v12, *((_DWORD *)v18 + 13), *((_DWORD *)v18 + 14), v29);
        if ( !v61[0] )
        {
          v49 = 0LL;
          v51 = __PAIR64__(v46, v50);
          sub_140AB16FC(v55, v12, &v51, &v49);
        }
        *v56 = v45;
        if ( v13 )
          sub_140AAE4B0(&qword_140C0DE60, v18);
        if ( v9 >= 0 )
        {
          if ( v13 )
            goto LABEL_30;
...
LABEL_43:
      ...
      v54[0] = v30;
      v54[2] = v30;
      v44 = sub_1403A96CC(v54, 32LL, &v53, v10);
      v12 = v53;
      v9 = v44;
      if ( v44 >= 0 )
      {
