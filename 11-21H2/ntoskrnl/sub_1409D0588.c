/*
 * XREFs of sub_1409D0588 @ 0x1409D0588
 * Callers:
...
__int64 __fastcall sub_1409D0588(wchar_t *Str1, __int64 *a2, unsigned int *a3)
{
  ...
  {
    while ( (unsigned __int8)sub_1409D1CA0(v5[v7]) && v8 )
      ++v7;
  }
LABEL_10:
...
LABEL_31:
  ...
  *a3 = v7;
  ...
  {
    v6 = sub_1409D01AC((__int64)v5, v13, &v21);
    if ( !v6 )
    {
      v17 = *a2;
      v18 = -1LL;
