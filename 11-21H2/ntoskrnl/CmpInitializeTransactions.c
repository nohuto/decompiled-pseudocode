/*
 * XREFs of CmpInitializeTransactions @ 0x140B2C7E0
 * Callers:
...
__int64 *CmpInitializeTransactions()
{
  ...
  qword_140C48F08 = (__int64)&CmpRmListHead;
  ...
  qword_140C491C8 = (__int64)&CmpLazyCommitListHead;
  ...
  _mm_lfence();
  if ( (void *)qword_140C4EEA0 == CmpRmListLock.Owner )
  {
    v0 = __rdtsc();
    ...
    qword_140C4EEB8 = v1;
    qword_140C4EEB0 = KiQueryUnbiasedInterruptTime() + 41929663 * (__rdtsc() >> 4) % 0x12A05F2000LL + 288000000000LL;
  }
  CmpLazyCommitTimer = 8LL;
  qword_140C491F8 = (__int64)CmpLazyCommitDpcRoutine;
  qword_140C49190 = (__int64)&qword_140C49188;
  qword_140C49188 = (__int64)&qword_140C49188;
  qword_140C48F18 = (__int64)&CmpDelayFreeRMListHead;
  ...
  qword_140C49018 = (__int64)CmpDelayFreeRMDpcRoutine;
  ...
  dword_140C48FFC = 0;
  word_140C48FF8 = 0;
  qword_140C49148 = (__int64)&CmpLightTransactionList;
