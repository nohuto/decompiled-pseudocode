/*
 * XREFs of sub_140B0183C @ 0x140B0183C
 * Callers:
...
char sub_140B0183C()
{
  ...
  sub_140827FE8(&dword_140C063C0);
  result = qword_140D068D0;
  if ( (unsigned int)dword_140C063C0 > 5 )
  {
    result = sub_1402A2000((__int64)&dword_140C063C0, 0x400000000000LL);
    if ( result )
    {
      v2 = *v1;
      v13 = 1LL;
      ...
      v10 = 0x1000000LL;
      v29 = 8LL;
      return sub_14020A9C4((__int64)&dword_140C063C0, (unsigned __int8 *)&dword_140028D5C, 0LL, 0LL, 0xBu, &v11);
    }
  }
  return result;
}
