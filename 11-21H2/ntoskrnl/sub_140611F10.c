/*
 * XREFs of sub_140611F10 @ 0x140611F10
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall sub_140611F10(volatile __int64 *a1, _QWORD *a2)
{
  __int64 v4; // rdx
  __int64 v5; // rcx
  __int64 *v6; // rdi
...
LABEL_18:
  *a2 = 0LL;
  a2[1] = a1;
  result = sub_1403119F0((__int64)a2, a1);
  if ( v6 )
  {
    v14 = (_QWORD **)(v6 + 6);
