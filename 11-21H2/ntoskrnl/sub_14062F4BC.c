/*
 * XREFs of sub_14062F4BC @ 0x14062F4BC
 * Callers:
...
NTSTATUS __fastcall sub_14062F4BC(__int64 a1, int a2, int a3, int a4)
{
  int v4; // edx
  int v5; // edx
  int v6; // edx
  ...
  *(_QWORD *)&UserData.Size = 4LL;
  ...
  v15 = 1LL;
  v17 = 1LL;
  return EtwWriteEx(qword_140C15FF8, (PCEVENT_DESCRIPTOR)v7, 0LL, 1u, 0LL, 0LL, 4u, &UserData);
}
