/*
 * XREFs of SymCryptFixedWindowRecoding @ 0x140411408
 * Callers:
 *     SymCryptEcpointScalarMulFixedWindow @ 0x140406130 (SymCryptEcpointScalarMulFixedWindow.c)
 * Callees:
 *     SymCryptIntAddUint32 @ 0x140400B14 (SymCryptIntAddUint32.c)
...
__int64 __fastcall SymCryptFixedWindowRecoding(char a1, __int64 a2, __int64 a3, __int64 a4, _DWORD *a5, int a6)
{
  ...
  if ( !v10 )
  {
    ...
    do
    {
      ValueLsbits32 = SymCryptIntGetValueLsbits32(v15);
      v17 = v8 & ValueLsbits32 & v12;
      v18 = (unsigned __int64)-(__int64)(v8 & ValueLsbits32 & v9) >> 32;
      v19 = v9 - (v8 & ValueLsbits32);
      v20 = ~((unsigned __int64)-(__int64)(v8 & ValueLsbits32 & v9) >> 32);
      *v14 = v20;
  ...
  *(_DWORD *)(v6 + 4LL * (unsigned int)v11) = 0;
  result = (v8 >> 1) & (v12 >> 1) & ((unsigned int)SymCryptIntGetValueLsbits32(a2) >> 1);
