/*
 * XREFs of sub_140845880 @ 0x140845880
 * Callers:
 *     <none>
 * Callees:
...
void __fastcall __noreturn sub_140845880(volatile __int64 *StartContext)
{
  __int64 v2; // rdi
  REGHANDLE v3; // rsi
  int v4; // ecx
...
LABEL_1:
  ...
  {
    v3 = RegHandle;
    if ( EtwEventEnabled(RegHandle, &stru_1400128F8) )
    {
      v11 = qword_140C21FA8;
      *(_QWORD *)&UserData.Size = 1LL;
      ...
      v21 = 8LL;
      v20 = &qword_140C21FA8;
      EtwWrite(v3, &stru_1400128F8, 0LL, 3u, &UserData);
    }
  }
  while ( 1 )
  {
    while ( 1 )
    {
      ...
      if ( v6 != v7 )
      {
        ...
        {
          v9 = RegHandle;
          if ( EtwEventEnabled(RegHandle, &stru_140012908) )
          {
            v12 = v8 & (v8 ^ v6);
            v13[0] = v6 & (v8 ^ v6);
            *(_QWORD *)&v22.Size = 4LL;
            ...
            v26 = 4LL;
            v28 = 4LL;
            EtwWrite(v9, &stru_140012908, 0LL, 4u, &v22);
          }
        }
        *((_DWORD *)StartContext + 32) = v8;
        if ( *((_BYTE *)StartContext + 144) )
        {
          if ( v6 )
          {
            if ( !v8 )
LABEL_26:
              sub_14098C45C(StartContext);
          }
          else
          {
            sub_14098C2AC(StartContext, 0LL);
          }
        }
      }
    }
    ...
    {
      case 0x400LL:
        sub_14098BC1C(StartContext);
        break;
      case 0x800LL:
        if ( *((_BYTE *)StartContext + 144) )
        {
          LOBYTE(v5) = 1;
          sub_14098C2AC(StartContext, v5);
          goto LABEL_26;
        }
        break;
      case 0x800000000LL:
