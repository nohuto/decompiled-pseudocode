/*
 * XREFs of PspSetEffectiveJobLimits @ 0x1406CC024
 * Callers:
 ...
 *     PspSetEffectiveLimit @ 0x1406CC2A0 (PspSetEffectiveLimit.c)
 */
...
LABEL_2:
  if ( (unsigned __int8)PspSetEffectiveLimit(v8, a2) )
  {
    ...
    if ( ((unsigned __int8)*(_DWORD *)(a1 + 256) & (unsigned __int8)v8) != 0
      && *((_BYTE *)&PspPriorityClassRank + v16) >= *((_BYTE *)&PspPriorityClassRank + *(unsigned __int8 *)(a1 + 1065)) )
    {
      v16 = *(_BYTE *)(a1 + 1065);
    }
    *(_BYTE *)(a1 + 1064) = v16;
