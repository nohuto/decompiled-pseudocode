/*
 * XREFs of sub_140225CB4 @ 0x140225CB4
 * Callers:
...
char __fastcall sub_140225CB4(__int64 a1)
{
  _UNKNOWN **v1; // rax
  __int64 v3; // rax
  __int64 v4; // rcx
  ...
  if ( !*(_DWORD *)(a1 + 304) )
  {
    ...
    if ( dword_140CE207C )
    {
      ...
      v30 = v27;
      v29[1] = 0;
      LOBYTE(v1) = sub_1405D868C(v4 - 136, &qword_140026490, 24LL, v29);
    }
    if ( byte_140C5AE30 )
    {
      LOBYTE(v1) = EtwEventEnabled(qword_140C1F580, &stru_14000E970);
      if ( (_BYTE)v1 )
      {
        v5 = 0;
        v6 = 0;
        ...
        {
          v7 = &v37[v5];
          v8 = v6 < (unsigned __int16)dword_140D06E40;
          *v7 = 0LL;
          *((_WORD *)v7 + 4) = v6;
          if ( v8 )
        ...
        *((_QWORD *)&UserData.Size + v22) = 4LL;
        LOBYTE(v1) = EtwWriteEx(v23, &stru_14000E970, 0LL, 0, 0LL, 0LL, v18 + 1, &UserData);
      }
    }
  }
  return (char)v1;
