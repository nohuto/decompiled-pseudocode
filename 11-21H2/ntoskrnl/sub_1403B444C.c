/*
 * XREFs of sub_1403B444C @ 0x1403B444C
 * Callers:
...
void __fastcall sub_1403B444C(__int64 a1, char a2, int a3, __int64 a4, __int64 a5, __int64 a6)
{
  int v6; // eax
  ...
  v13 = &v7;
  v14 = 40;
  sub_14035EDE4((__int64)&v13, 1u, 0x80020000, 0x160Du, 0x401902u);
}
