/*
 * XREFs of sub_140521F54 @ 0x140521F54
 * Callers:
...
__int64 __fastcall sub_140521F54(char a1, __int64 a2, __int64 a3, __int64 a4, __int64 a5)
{
  int v8; // edx
  int v9; // r8d
