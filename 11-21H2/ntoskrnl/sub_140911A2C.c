/*
 * XREFs of sub_140911A2C @ 0x140911A2C
 * Callers:
...
NTSTATUS __fastcall sub_140911A2C(unsigned __int16 *a1, int a2, int a3)
{
  ...
  if ( qword_140C16478 )
  {
    ...
    *(_QWORD *)&UserData.Size = 2LL;
    ...
    v11 = 4LL;
    v13 = 4LL;
    return EtwWrite(qword_140C16478, &stru_140038EB0, 0LL, 4u, &UserData);
  }
  return result;
}
