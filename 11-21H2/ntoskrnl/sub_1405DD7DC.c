/*
 * XREFs of sub_1405DD7DC @ 0x1405DD7DC
 * Callers:
...
char __fastcall sub_1405DD7DC(__int64 a1)
{
  _UNKNOWN **v1; // rax
  REGHANDLE v3; // rdi
  __int64 v4; // r9
  ...
  {
    v3 = RegHandle;
    LOBYTE(v1) = EtwEventEnabled(RegHandle, &stru_140038A58);
    if ( (_BYTE)v1 )
    {
      v4 = *(_QWORD *)(a1 + 48);
      ...
      v17 = v6;
      v18 = v7;
      LOBYTE(v1) = EtwWriteEx(v3, &stru_140038A58, 0LL, 0, 0LL, 0LL, 4u, &UserData);
    }
  }
  return (char)v1;
}
