/*
 * XREFs of sub_1405F6054 @ 0x1405F6054
 * Callers:
...
__int64 __fastcall sub_1405F6054(_DWORD **a1, __int64 a2)
{
  __int64 v2; // rbx
  unsigned int v4; // edi
  ...
  v20 = v4;
  v17 = (__int64)&v17;
  sub_140380C38((__int64)a1, v9, (__int64)&v17);
  v11 = *(&v17 + 2 * v4 - 3);
  v12 = *(&v17 + 2 * v4 - 4);
  v13 = v11 - 8;
  v14 = v12 + 16;
  ...
  if ( v11 <= v14 )
    v13 = v15;
  v2 = sub_1403836FC((__int64)a1, (__int64)&v17, 3u);
  if ( v13 && *a1[2] != -1 )
