/*
 * XREFs of PpmParkCalculateCoreParkingMask @ 0x1402396F0
 * Callers:
 *     <none>
 * Callees:
...
char PpmParkCalculateCoreParkingMask()
{
  ...
  if ( PpmIsParkingEnabled )
  {
    v1 = 0;
    v50 = 0;
    v2 = &PpmCurrentProfile[534 * dword_140C232CC + 5];
    v65 = v2;
    v3 = 100 * *((unsigned __int8 *)v2 + 124);
    for ( i = v3; v1 < PpmParkNumNodes; v50 = v1 )
    {
      v4 = PpmParkNodes + 336LL * v1;
      v62 = v4;
      if ( (*(_BYTE *)(v4 + 146) & 1) == 0 )
      {
        v5 = 0LL;
        ...
        *(_QWORD *)(v4 + 272) = v9;
        ...
        do
        {
          ...
          else
          {
            ...
            *(_QWORD *)&v53 = 0LL;
            while ( !(unsigned int)KeEnumerateNextProcessor(&v70, &v53) )
              v14 |= *(_QWORD *)(KeGetPrcb(v70) + 34912);
          }
          v15 = v12 & v14;
          v64 = v15;
          if ( v15 )
          ...
          v24 = KeCpuSetQueryUnparkRecommendation(*(unsigned __int16 *)(v4 + 4), v12, &v51);
          v25 = v51;
          LODWORD(v26) = v24;
          if ( v24 )
          {
            if ( (unsigned __int8)PpmParkGranularity > 1u )
            {
              ...
              *((_QWORD *)&v53 + 1) = v51;
              while ( !(unsigned int)KeEnumerateNextProcessor(&v70, &v53) )
                v25 |= *(_QWORD *)(KeGetPrcb(v70) + 34912);
              v51 = v25;
          ...
          else
          {
            ...
            if ( (unsigned __int8)v36 >= (unsigned __int8)v35 )
              v36 = *v58;
            if ( PpmCheckLatencyBoostActive && (v35 * (unsigned int)v58[(_QWORD)v63 - 49] + 50) / 0x64 > v36 )
            {
              v13 |= 0x40u;
            ...
            if ( (unsigned __int8)PpmParkGranularity > 1u )
              v36 = (unsigned __int8)PpmParkGranularity
                  - 1
                  + v36
                  - ((unsigned __int8)PpmParkGranularity - 1 + v36) % (unsigned __int8)PpmParkGranularity;
          }
          v37 = v36 + v26;
          v58[10] = v36;
          v38 = v18;
          ...
          if ( v37 > (unsigned int)v18 )
            v38 = v37;
          v72 -= v34;
          v39 = PpmParkSoftParkingEnabled == 0;
          v31[15] = v38;
          if ( v39 )
          {
            v34 = v38;
          ...
          *(_QWORD *)(v4 + 48) = v57 | v46 & *(_QWORD *)(v4 + 48);
          v49 = v44;
          LODWORD(v44) = v73;
          PpmEventTraceSoftCoreParkingSelection(v4, v73, v47, v45, v18, v43, v52, v49, v25, v71);
          v11 = (__int64 *)(v61 + 8);
          v6 = v72;
          v10 = v58 + 1;
          v73 = v44 + 1;
