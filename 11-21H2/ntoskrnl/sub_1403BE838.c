/*
 * XREFs of sub_1403BE838 @ 0x1403BE838
 * Callers:
...
__int64 __fastcall sub_1403BE838(__int64 a1, __int64 a2, __int64 a3)
{
  unsigned int v3; // r9d
  __int64 v4; // rax
  __int64 v6; // rax
