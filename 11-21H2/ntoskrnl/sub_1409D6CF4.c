/*
 * XREFs of sub_1409D6CF4 @ 0x1409D6CF4
 * Callers:
...
__int64 __fastcall sub_1409D6CF4(
        HANDLE FileHandle,
        __int64 a2,
        _QWORD *a3,
        unsigned int a4,
  ...
  if ( *v18 )
  {
    while ( 1 )
    {
      ...
      if ( v21 >= (__int64)v14 )
      {
        ...
        if ( (_DWORD)v28 )
        {
          v29 = sub_140383620(v22, v27, &v34, (const void **)&v36);
          v11 = v36;
          if ( !v29 )
          {
            Status = -1073741670;
