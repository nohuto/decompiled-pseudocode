/*
 * XREFs of sub_140611020 @ 0x140611020
 * Callers:
 *     <none>
 * Callees:
...
NTSTATUS __fastcall sub_140611020(
...
LABEL_13:
  *((_QWORD *)&v21 + 1) = DeviceObject;
  LODWORD(v21) = SectorSize;
  *((_QWORD *)&v20 + 1) = __PAIR64__(PartitionNumber, PartitionType);
...
LABEL_18:
  result = IoSetPartitionInformation(DeviceObject, SectorSize, PartitionNumber, PartitionType);
  LODWORD(v22) = result;
  if ( v10 )
  {
    v18 = (_QWORD **)(v10 + 6);
