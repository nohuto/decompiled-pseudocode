/*
 * XREFs of sub_140A2EE50 @ 0x140A2EE50
 * Callers:
...
__int64 __fastcall sub_140A2EE50(__int64 *a1, unsigned int a2, __int64 a3, void *a4, unsigned int a5, unsigned int *a6)
{
  int v7; // ebx
  __int64 v8; // rdx
  unsigned int v9; // ecx
  ...
  *a6 = 0;
  v12 = 0;
  v11 = 1;
  v7 = sub_1407827F0(a1, 0LL, a2, a3, v11, v12, Handle, 0LL, &v13);
  if ( v7 >= 0 )
  {
    v8 = v13;
