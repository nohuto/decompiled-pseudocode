/*
 * XREFs of sub_1405CE3A0 @ 0x1405CE3A0
 * Callers:
...
_BYTE *__fastcall sub_1405CE3A0(__int64 a1, int a2, char a3, int a4)
{
  int v7; // edi
  _BYTE *result; // rax
  unsigned int v9; // esi
  ...
  if ( *(_DWORD *)(v11 + 144) )
  {
    do
    {
      result = sub_1405CD4FC(a1, v10, v9, 1, &v15, &v16);
      if ( v16 )
      {
        result = v15;
        ++v7;
    ...
    if ( v7 )
    {
      ...
      *(_QWORD *)(v11 + 64) = MEMORY[0xFFFFF78000000008];
      ...
      v14 = *(_QWORD *)(v11 + 48);
      *(_BYTE *)(v11 + 72) = 1;
      return (_BYTE *)sub_1405D28BC(v11, v13, a4, v7, v14);
    }
  }
  return result;
}
