/*
 * XREFs of LocalConvertSDToStringSD_Rev1 @ 0x140676314
 * Callers:
        ...
        unsigned int *a7)
{
  ...
  unsigned __int16 v61; // [rsp+118h] [rbp+67h] BYREF
  ...
  OwnerSecurityDescriptor = RtlGetControlSecurityDescriptor(a4, &v61, &OwnerDefaulted);
  if ( OwnerSecurityDescriptor >= 0 )
  {
    if ( v10 )
    {
      StringForSid = LocalGetStringForSid(v10, v45, 1);
      if ( StringForSid )
        goto LABEL_74;
    }
    if ( v11 )
    ...
    if ( v61 )
    {
      StringForSid = LocalGetStringForControl(v61, 1LL, &v49);
      if ( StringForSid )
        goto LABEL_74;
      StringForSid = LocalGetStringForControl(v20, 2LL, &v48);
      if ( StringForSid )
        goto LABEL_74;
    }
    v21 = SaclPresent;
    if ( (_BYTE)SaclPresent )
    {
      ...
      StringForSid = LocalConvertAclToString((_DWORD)v12, v18, 0, (unsigned int)&v53, (__int64)&Size, 0LL, 0LL, 0, 1);
      if ( StringForSid )
        goto LABEL_74;
      v9 = Size;
    }
