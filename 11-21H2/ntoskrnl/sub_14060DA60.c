/*
 * XREFs of sub_14060DA60 @ 0x14060DA60
 * Callers:
 *     <none>
 * Callees:
...
NTSTATUS __fastcall sub_14060DA60(
...
LABEL_12:
  v23[0] = v17;
LABEL_13:
  HIDWORD(v23[2]) = DeviceCharacteristics;
  LOBYTE(v23[2]) = Exclusive;
  v23[1] = DeviceObject;
  v23[6] = DriverObject;
  LODWORD(v23[5]) = DeviceExtensionSize;
  v23[4] = DeviceName;
  LODWORD(v23[3]) = DeviceType;
