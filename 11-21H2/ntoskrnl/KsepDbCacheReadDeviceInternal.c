/*
 * XREFs of KsepDbCacheReadDeviceInternal @ 0x1407ED53C
 * Callers:
...
__int64 __fastcall KsepDbCacheReadDeviceInternal(__int64 a1, __int64 a2, const wchar_t *a3, __int64 a4)
{
  ...
  if ( !DatabaseMatch || !(unsigned int)SdbTagRefToTagID(a1, DatabaseMatch, &v14, &v13) )
    return 3221226021LL;
  v8 = v14;
  for ( i = SdbFindFirstTag(v14, v13, 28691); ; i = SdbFindNextTag(v8, v13, v10) )
  {
    v10 = i;
    if ( !i )
      break;
  ...
  for ( j = SdbFindFirstTag(v8, v13, 28712); ; j = SdbFindNextTag(v8, v13, v12) )
  {
    v12 = j;
    if ( !j )
      break;
