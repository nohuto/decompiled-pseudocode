/*
 * XREFs of sub_140299C18 @ 0x140299C18
 * Callers:
...
__int64 __fastcall sub_140299C18(__int64 a1, char a2, char *a3)
{
  unsigned int v3; // r9d
  char v6; // bl
  int v7; // r11d
  ...
  else
  {
    ...
    v11 = *((_DWORD *)qword_140015E70 + 3 * v8 + 1);
    v7 = *((_DWORD *)&qword_140015E70[1] + 3 * v8);
    if ( !v11 )
      goto LABEL_6;
  }
  v12 = *(_DWORD *)(a1 + 48);
