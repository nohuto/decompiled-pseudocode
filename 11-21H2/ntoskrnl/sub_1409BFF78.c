/*
 * XREFs of sub_1409BFF78 @ 0x1409BFF78
 * Callers:
...
__int64 __fastcall sub_1409BFF78(unsigned __int64 a1, int a2, __int64 a3)
{
  __int64 result; // rax
  ...
  v16 = 0LL;
  Key = 0;
  result = sub_1405EEB40(a1, &v16, (__int64 *)&v17);
  if ( (int)result >= 0 )
  {
    v7 = v17;
    if ( a3 )
    ...
    if ( v16 )
    {
      ...
      if ( v13 )
      {
        ...
        if ( v14 && ((unsigned __int64)&v12[v14] > 0x7FFFFFFF0000LL || &v12[v14] < v12) )
          MEMORY[0x7FFFFFFF0000] = 0;
        if ( bsearch_s(&Key, v12, v13, v15, (int (__cdecl *)(void *, const void *, const void *))sub_1403730F0, 0LL) )
          return 0LL;
      }
    }
    if ( a2 || !(unsigned __int8)sub_1409C019C(a1) )
      return 3221227018LL;
    else
      return 0LL;
  }
