/*
 * XREFs of sub_14061E850 @ 0x14061E850
 * Callers:
 *     <none>
 * Callees:
...
NTSTATUS __fastcall sub_14061E850(PHANDLE JobHandle, ACCESS_MASK DesiredAccess, POBJECT_ATTRIBUTES ObjectAttributes)
{
  __int64 v6; // rdx
  __int64 v7; // rcx
  __int64 *v8; // rdi
