/*
 * XREFs of MiSetProbePagesAhead @ 0x14031C5D0
 * Callers:
...
char __fastcall MiSetProbePagesAhead(__int64 a1)
{
  ...
  if ( (_BYTE)CurrentThread == 1 )
  {
    v3 = *(_QWORD *)(a1 + 48);
    v25 = v3;
    CurrentThread = ((unsigned __int64)MI_READ_PTE_LOCK_FREE((unsigned __int64)&v25) >> 12) & 0xFFFFFFFFFFLL;
    ...
    if ( v6 != 3 )
    {
      ...
      for ( i = *(_QWORD *)(a1 + 24) + 8LL; (i & 0xFFF) != 0 && i <= *(_QWORD *)(a1 + 32); i += 8LL )
      {
        ...
        if ( i >= 0xFFFFF6FB7DBED000uLL )
        {
          ...
          if ( i <= 0xFFFFF6FB7DBED7F8uLL && (MiFlags & 0xC00000) != 0 )
          {
        ...
        if ( (v9 & 0xF0F0000000000FFFuLL) != v25 )
          break;
        CurrentThread = ((unsigned __int64)MI_READ_PTE_LOCK_FREE((unsigned __int64)&v23) >> 12) & 0xFFFFFFFFFFLL;
        if ( CurrentThread <= qword_140C50840
              ...
              (*(_QWORD *)(v10 - 0x21FFFFFFFFD8LL) & 0x40000000000000LL) != 0) )
        {
          ...
          if ( v13 >= 0 )
          {
            if ( (v13 & 0x10000000000LL) != 0 )
            {
              LODWORD(v23) = 0;
              v24 = 0;
              LODWORD(CurrentThread) = MiGetPfnPageSizeIndexUnsynchronized(v12, (int *)&v23, &v24);
