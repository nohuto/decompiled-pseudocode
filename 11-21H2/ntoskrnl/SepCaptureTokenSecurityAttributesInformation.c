/*
 * XREFs of SepCaptureTokenSecurityAttributesInformation @ 0x140754108
 * Callers:
  ...
  while ( v20 < *(_DWORD *)(Pool2 + 4) )
  {
    ...
    if ( v21 )
    {
      ...
      switch ( v22 )
      {
        case 3u:
          LOBYTE(v16) = 1;
          v23 = SepCaptureUnicodeStringArray(*(_QWORD *)&v8[20 * v20 + 16], v21, v16, &P);
          goto LABEL_42;
        case 4u:
          v23 = SepCaptureFqbnArray(*(void **)&v8[20 * v20 + 16]);
          goto LABEL_42;
        case 5u:
LABEL_65:
          v23 = SepCaptureOctetStringArray(*(void **)&v8[20 * v20 + 16]);
          goto LABEL_42;
        case 6u:
LABEL_41:
          v23 = SepCaptureInt64Array(*(char **)&v8[20 * v20 + 16], v21, v16, &P);
LABEL_42:
          v9 = v23;
          if ( v23 >= 0 )
    ...
    if ( v26 || ((a2[v25] - 2) & 0xFFFFFFFD) == 0 )
    {
      for ( j = 0LL; ; j = (unsigned int)(v46 + 1) )
      {
        ...
        if ( !RtlCompareUnicodeString(
                (PCUNICODE_STRING)&v8[20 * v25],
                (PCUNICODE_STRING)&SepValidAttributesTypes[3 * j],
                1u) )
        {
          if ( v8[20 * v25 + 8] != LODWORD(SepValidAttributesTypes[3 * v40 + 2]) )
            v9 = -1073741811;
          if ( *(_DWORD *)&v8[20 * v25 + 12] < HIDWORD(SepValidAttributesTypes[3 * v40 + 2]) )
            v9 = -1073741811;
          break;
        }
      }
