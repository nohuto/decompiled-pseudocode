/*
 * XREFs of sub_14057EC0C @ 0x14057EC0C
 * Callers:
 *     sub_14057DF70 @ 0x14057DF70 (sub_14057DF70.c)
 * Callees:
...
char __fastcall sub_14057EC0C(__int64 a1, __int64 a2, __int64 a3, int a4)
{
  _UNKNOWN **v4; // rax
  REGHANDLE v5; // rbx
  ...
  if ( qword_140D00B58 )
  {
    LOBYTE(v4) = EtwEventEnabled(qword_140D00B58, &stru_1400379D8);
    if ( (_BYTE)v4 )
    {
      UserData.Reserved = 0;
      v10 = 0;
      ...
      v14 = &v21;
      v15 = 4;
      LOBYTE(v4) = EtwWriteEx(v5, &stru_1400379D8, 0LL, 0, 0LL, 0LL, 4u, &UserData);
    }
  }
  return (char)v4;
}
