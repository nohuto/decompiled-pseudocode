/*
 * XREFs of HvlSetHpetConfig @ 0x1405481F0
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall HvlSetHpetConfig(__int64 a1, int a2, __int64 a3, char a4, _OWORD *a5)
{
  ...
  while ( 1 )
  {
    v10 = HvlpAcquireHypercallPage((PHYSICAL_ADDRESS *)&v18.m256i_i64[1], 1, (__int64)v21, 40LL);
    *(_DWORD *)v10 = 6;
    v10[1] = a1;
    *((_DWORD *)v10 + 4) = a2;
    v10[3] = a3;
    *((_BYTE *)v10 + 32) = a4;
    ...
    HvlpReleaseHypercallPage((__int64)&v18.m256i_i64[1]);
    if ( !HvlpHvStatusIsInsufficientMemory(v11) )
      break;
    result = HvlpHandleInsufficientMemory(v13, v12, v14);
    if ( (int)result < 0 )
      return result;
  }
  if ( v11 )
    return 3221225473LL;
  v16 = HvlpAcquireHypercallPage((PHYSICAL_ADDRESS *)&v18.m256i_i64[1], 1, (__int64)v21, 8LL);
  v17 = HvlpAcquireHypercallPage((PHYSICAL_ADDRESS *)&v19.m256i_i64[1], 2, (__int64)&v21[16], 1032LL);
  *(_DWORD *)v16 = 7;
  if ( (unsigned __int16)HvcallInitiateHypercall(123) )
    v9 = -1073741823;
  else
    *a5 = *(_OWORD *)v17;
  HvlpReleaseHypercallPage((__int64)&v19.m256i_i64[1]);
  HvlpReleaseHypercallPage((__int64)&v18.m256i_i64[1]);
  return v9;
}
