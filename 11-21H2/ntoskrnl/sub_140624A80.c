/*
 * XREFs of sub_140624A80 @ 0x140624A80
 * Callers:
 *     <none>
 * Callees:
...
NTSTATUS __fastcall sub_140624A80(
...
LABEL_13:
  ...
  *((_QWORD *)&v23 + 1) = ProcessHandle;
  LODWORD(v23) = ProcessInformationClass;
  *((_QWORD *)&v22 + 1) = ProcessInformation;
  LODWORD(v22) = ProcessInformationLength;
