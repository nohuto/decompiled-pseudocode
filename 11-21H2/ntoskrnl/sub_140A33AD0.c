/*
 * XREFs of sub_140A33AD0 @ 0x140A33AD0
 * Callers:
 ...
 *     sub_140A33524 @ 0x140A33524 (sub_140A33524.c)
 *     sub_140A33580 @ 0x140A33580 (sub_140A33580.c)
 */

char __fastcall sub_140A33AD0(__int64 a1, LARGE_INTEGER *a2)
{
  unsigned int v2; // edi
  char *v3; // rbx
  CSHORT v5; // r13
  ...
  __int16 v17; // r11
  __int16 v18; // ax
  CSHORT v20; // [rsp+20h] [rbp-20h]
  CSHORT v21; // [rsp+24h] [rbp-1Ch]
  CSHORT v22; // [rsp+28h] [rbp-18h]
  CSHORT v23; // [rsp+2Ch] [rbp-14h]
...
LABEL_6:
  ...
  {
    v12 = v10 - 1 - sub_140A33580(v9 + 1, v10 - 1, &v28, &v29);
    v14 = (int)sub_140A33524(1, v28, v29 - 4) % 100;
    v6 = 60 * sub_140A33524(1, v28, v13 - 2) + v14;
  }
  else
  {
    if ( v11 != 45 )
      return 0;
    v12 = v10 - 1 - sub_140A33580(v9 + 1, v10 - 1, &v28, &v29);
    sub_140A33524(1, v28, v29 - 4);
    v16 = sub_140A33524(1, v28, v15 - 2);
    v6 = -60 * v16 - v17;
  }
  if ( !v12 )
  {
    *(_DWORD *)&TimeFields.Milliseconds = 0;
    ...
    {
      if ( sub_140A33434((__int64 *)a2, v6, v7) )
        return 1;
    }
  }
  return 0;
