/*
 * XREFs of sub_1403A8700 @ 0x1403A8700
 * Callers:
...
__int64 __fastcall sub_1403A8700(__int64 a1, unsigned int *a2, unsigned int a3, unsigned int a4, unsigned int *a5)
{
  __int64 v5; // rsi
  __int64 v8; // rbx
  ...
  if ( *a2 )
  {
    ...
    {
      v12 = 0;
      v13 = (_BYTE *)(*((_QWORD *)v11 + 3) + 4 * v9 * v11[1]);
      if ( (_DWORD)result )
      {
        do
        {
          ...
          v19 = sub_1403A8868(*a5, a5[1], 255 * v14 / v21);
          *v13 = v19;
          v13[2] = BYTE2(v19);
          ++v12;
          v13[3] = -1;
