/*
 * XREFs of sub_1406177B0 @ 0x1406177B0
 * Callers:
 *     <none>
 * Callees:
...
HANDLE __fastcall sub_1406177B0(PVOID Address, SIZE_T Size, ULONG ProbeMode)
{
  __int64 v6; // rdx
  __int64 v7; // rcx
  __int64 *v8; // rdi
  ...
  HANDLE v20; // [rsp+40h] [rbp-10h]
  __int64 retaddr; // [rsp+68h] [rbp+18h]

  v20 = 0LL;
  v18 = 0LL;
  v19 = 0LL;
  v8 = sub_140604844(343);
  if ( !v8 )
    goto LABEL_18;
  if ( dword_140C1B2A0
...
LABEL_12:
  *(_QWORD *)&v18 = v12;
LABEL_13:
  *((_QWORD *)&v19 + 1) = Address;
  *(_QWORD *)&v19 = Size;
  DWORD2(v18) = ProbeMode;
...
LABEL_18:
  result = MmSecureVirtualMemory(Address, Size, ProbeMode);
  v20 = result;
  if ( v8 )
  {
    v16 = (_QWORD **)(v8 + 6);
