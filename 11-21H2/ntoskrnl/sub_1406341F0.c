/*
 * XREFs of sub_1406341F0 @ 0x1406341F0
 * Callers:
...
void __fastcall sub_1406341F0(__int64 a1, unsigned int a2, unsigned __int16 a3, __int64 a4)
{
  ...
  if ( a3 == 6180 )
    v9 = 4194306;
  sub_1402AB170((__int64)&v10, a1, a2, v4, a3, v9);
}
