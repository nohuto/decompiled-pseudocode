/*
 * XREFs of RtlpGenericRandomPatternWorker @ 0x1405F0224
 * Callers:
 *     RtlScrubMemory @ 0x1405EFB90 (RtlScrubMemory.c)
 * Callees:
 *     RtlpFillMemoryRandomUp @ 0x1405EFCC4 (RtlpFillMemoryRandomUp.c)
 *     RtlpTestMemoryRandomUp @ 0x1405F06D8 (RtlpTestMemoryRandomUp.c)
 */
...
LABEL_2:
  ...
  if ( CurrentPrcb->CFlushSize )
  {
    ...
    for ( i = (char *)((unsigned __int64)a1 & ~(CFlushSize - 1)); i < (char *)v3; i += CFlushSize )
      _mm_clflush(i);
  }
  v15 = a1;
  v16 = v11;
...
LABEL_12:
    ...
    if ( (unsigned __int8)RtlpTestMemoryRandomUp(a1, v18, v11, v5) )
    {
      v22 = a1;
      ...
      RtlpFillMemoryRandomUp(a1, v25, v21, v20);
      ...
      if ( (unsigned __int8)RtlpTestMemoryRandomUp(a1, v29, v27, v5) )
      {
        v32 = v3;
        v33 = v31;
        do
