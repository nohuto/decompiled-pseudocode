/*
 * XREFs of sub_140B1D10C @ 0x140B1D10C
 * Callers:
...
LABEL_7:
  LODWORD(v38) = v5;
  v6 = sub_14071FAA0((__int64)v0, (unsigned __int64)&DestinationString_8, 0, 1u, v39.Buffer, v38);
  if ( v6 < 0 )
  ...
  LODWORD(v38) = 760 - v1;
  result = sub_14071FAA0((__int64)v0, (unsigned __int64)&DestinationString_8, 0, 7u, v41, v38);
  if ( (int)result < 0 )
