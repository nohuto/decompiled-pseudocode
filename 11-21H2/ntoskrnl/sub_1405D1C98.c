/*
 * XREFs of sub_1405D1C98 @ 0x1405D1C98
 * Callers:
...
char __fastcall sub_1405D1C98(__int64 a1, unsigned __int64 a2, __int64 a3, __int64 a4, _QWORD *a5)
{
  ...
  if ( (unsigned __int16)(*((_QWORD *)&v6 + 1) >> 29) )
  {
    *(_QWORD *)&v6 = 100 * a3 / a2;
    ...
    if ( (_BYTE)v6 )
    {
      ...
      {
        LOBYTE(v6) = sub_1402A2000((__int64)&dword_140C03A00, 0x400000000000LL);
        if ( (_BYTE)v6 )
        {
          v23 = a1;
          v35 = &v23;
          ...
          v46 = 1LL;
          v48 = 1LL;
          LOBYTE(v6) = sub_14020A9C4((__int64)&dword_140C03A00, (unsigned __int8 *)&byte_14002FFEF, 0LL, 0LL, 9u, &v34);
        }
      }
    }
  }
