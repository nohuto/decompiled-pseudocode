/*
 * XREFs of sub_14025CB88 @ 0x14025CB88
 * Callers:
...
__int64 __fastcall sub_14025CB88(__int64 a1, void *a2, KPROCESSOR_MODE a3)
{
  PVOID v5; // rdi
  __int64 v6; // r14
  NTSTATUS v8; // eax
  ...
  *(_QWORD *)&v18 = 0LL;
  ...
  v16 = 0LL;
  v17 = 0LL;
  if ( !SeSinglePrivilegeCheck(stru_140D3CB28, a3) )
  {
    v9 = -1073741727;
    goto LABEL_20;
  }
...
LABEL_26:
  ...
  *(_QWORD *)&v17 = 0LL;
  v18 = 0LL;
  v9 = sub_1407CDED0(a1, (unsigned int)&v16, 0, 1, 0, 0, 0, (__int64)&v19);
  if ( v9 < 0 )
    goto LABEL_20;
  v9 = sub_1407CDED0((_DWORD)v5, (unsigned int)&v16, 0, 1, 0, 0, 0, (__int64)&v13);
  if ( v9 < 0 )
    goto LABEL_20;
  v9 = sub_14066B8C8((char *)v19 + 24, &v15);
  if ( v9 < 0 )
    goto LABEL_18;
  ...
  *(_DWORD *)(*((_QWORD *)v13 + 27) + 32LL) |= 4u;
  ...
  v9 = sub_1407556D4(v13);
  if ( v9 < 0 || (v9 = sub_1407556D4(v19), v9 < 0) )
  {
LABEL_18:
    v6 = v15;
    goto LABEL_20;
