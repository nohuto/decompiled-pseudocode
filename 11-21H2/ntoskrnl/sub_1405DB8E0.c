/*
 * XREFs of sub_1405DB8E0 @ 0x1405DB8E0
 * Callers:
...
BOOLEAN __fastcall sub_1405DB8E0(__int64 a1)
{
  BOOLEAN result; // al
  ...
  v4 = 100;
  v3 = 0;
  if ( byte_140C5AE30 || (result = EtwEventEnabled(qword_140C1F580, &stru_14000E9C0)) != 0 )
  {
    ...
    *(_QWORD *)&UserData.Size = 4LL;
    ...
    v28 = 4LL;
    v30 = 4LL;
    return EtwWriteEx(qword_140C1F580, &stru_14000E9C0, 0LL, 0, 0LL, 0LL, 0xDu, &UserData);
  }
  return result;
}
