/*
 * XREFs of DifZwLoadDriverWrapper @ 0x140620EC0
 * Callers:
 *     <none>
 * Callees:
...
NTSTATUS __fastcall DifZwLoadDriverWrapper(PUNICODE_STRING DriverServiceName)
{
  __int64 v2; // rdx
  __int64 v3; // rcx
...
LABEL_18:
  result = ZwLoadDriver(DriverServiceName);
  LODWORD(v14) = result;
  if ( APIThunkContextById )
  {
