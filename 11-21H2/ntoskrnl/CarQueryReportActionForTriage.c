 ...
 * Callees:
 *     CarFindRuleOverrideEntryByGlobalRuleId @ 0x14060392C (CarFindRuleOverrideEntryByGlobalRuleId.c)
 *     CarOverrideReportAction @ 0x140603B80 (CarOverrideReportAction.c)
 */
...
__int64 __fastcall CarQueryReportActionForTriage(int a1, unsigned int a2, _DWORD *a3)
{
  ...
  if ( a3 )
  {
    ...
    {
      v5 = CarTriageContext;
      *(_QWORD *)a3 = qword_140041D30[CarTriageContext];
