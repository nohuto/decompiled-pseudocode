/*
 * XREFs of sub_140615930 @ 0x140615930
 * Callers:
 *     <none>
 * Callees:
...
char __fastcall sub_140615930(unsigned __int64 a1, __int64 a2, __int64 a3)
{
  __int64 v6; // rdx
  __int64 v7; // rcx
  __int64 *v8; // rsi
...
LABEL_18:
  result = sub_1402E2D20(a1, a2, 0, 0, a3);
  LOBYTE(v19) = result;
  if ( v8 )
  {
    v16 = (__int64 *)v8[6];
