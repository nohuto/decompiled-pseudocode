/*
 * XREFs of sub_140537C28 @ 0x140537C28
 * Callers:
...
unsigned __int64 __fastcall sub_140537C28(__int64 a1)
{
  ...
  v13 = 0;
  v5 = 0;
  for ( i = 0; i < (unsigned __int8)byte_140C54B6D; ++i )
  {
    v7 = 0;
    v8 = i;
    while ( 2 )
