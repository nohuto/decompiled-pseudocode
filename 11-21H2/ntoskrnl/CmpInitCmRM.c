/*
 * XREFs of CmpInitCmRM @ 0x140742E3C
 * Callers:
...
LABEL_69:
  ...
  *((_DWORD *)v10 + 17) = 0;
  ...
  while ( 1 )
  {
    ...
    v18 = *(void **)(v5 + 1544);
    LOBYTE(v13) = 1;
    v20 = RtlStringFromGUIDEx(*(_QWORD *)(v5 + 64) + 148LL, &UnicodeString, v13);
    if ( v20 < 0 )
    {
      *(_DWORD *)(v5 + 4160) = 3;
      goto LABEL_103;
    ...
    if ( a1 )
    {
      v20 = CmpQueryNameString(*(void **)(a1 + 1544), &Source);
      if ( v20 < 0 )
      {
        *(_DWORD *)(v5 + 4160) = 4;
        goto LABEL_103;
...
LABEL_103:
    ...
    RtlFreeUnicodeString(&Destination);
    CmpLogTxrInitEvent(v46, v5, (unsigned int)v20);
LABEL_87:
    v4 = 1;
    v51 = 1;
...
LABEL_51:
  ...
  if ( *(__int64 **)qword_140C48F08 != &CmpRmListHead )
    __fastfail(3u);
  *v10 = &CmpRmListHead;
  v10[1] = v35;
  *v35 = v10;
