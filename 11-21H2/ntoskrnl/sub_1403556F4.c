/*
 * XREFs of sub_1403556F4 @ 0x1403556F4
 * Callers:
...
char __fastcall sub_1403556F4(__int64 a1, int a2, unsigned __int8 a3)
{
  _UNKNOWN **v3; // rax
  int v4; // edi
  REGHANDLE v5; // rbx
  ...
  {
    v5 = RegHandle;
    LOBYTE(v3) = EtwEventEnabled(RegHandle, &stru_140010E68);
    if ( (_BYTE)v3 )
    {
      UserData.Reserved = 0;
      v11 = 0;
      ...
      v7 = v4;
      UserData.Size = 8;
      LOBYTE(v3) = EtwWriteEx(v5, &stru_140010E68, 0LL, 1u, 0LL, 0LL, 3u, &UserData);
    }
  }
  return (char)v3;
}
