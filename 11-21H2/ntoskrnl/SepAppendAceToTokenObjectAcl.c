/*
 * XREFs of SepAppendAceToTokenObjectAcl @ 0x140724550
 * Callers:
...
__int64 __fastcall SepAppendAceToTokenObjectAcl(__int64 a1, int a2, _WORD *a3)
{
  ...
  __int64 v36; // [rsp+78h] [rbp-50h] BYREF
  ...
  result = ObpGetObjectSecurity(a1, &P, v29, 0LL);
  v6 = (char *)P;
  Acl = result;
  if ( (int)result >= 0 )
  {
...
LABEL_7:
        if ( v10 )
        {
          ...
          {
            Acl = RtlQueryInformationAcl(v10, &v36, 12LL, 2LL);
            if ( Acl >= 0 )
            {
              ...
              if ( Acl >= 0 )
              {
                v16 = RtlLengthSid(a3);
                v17 = HIDWORD(v36);
                v18 = (v16 + HIDWORD(v36) + 11) & 0xFFFFFFFC;
                ...
                if ( Pool2 )
                {
                  ...
                  if ( Acl >= 0 )
                  {
                    ...
                    if ( Acl >= 0 )
                    {
                      ...
                      if ( Acl >= 0 )
                      {
                        Acl = RtlpAddKnownAce((int)v20, v21, 0, v31, a3, 0);
                        if ( Acl >= 0 )
                        {
...
LABEL_26:
        ...
        v23 = (volatile signed __int64 *)((char *)&ObsSecurityDescriptorCache
                                        + 16 * (unsigned __int8)*((_DWORD *)v11 + 4));
