/*
 * XREFs of sub_140ACCDF0 @ 0x140ACCDF0
 * Callers:
 *     sub_140AD2320 @ 0x140AD2320 (sub_140AD2320.c)
 * Callees:
 *     <none>
 */

__int64 __fastcall sub_140ACCDF0(_QWORD *a1, unsigned int a2)
{
  __m128i *IdtBase; // r8
  ...
  if ( LockArray_high == v10 )
  {
    if ( (*(_DWORD *)(v7 + 2396) & 0x20000) == 0 )
    {
      **(_QWORD **)(v7 + 1176) = 0xA3A03F5891C8B4E8uLL;
      **(_QWORD **)(v7 + 1184) = 0LL;
      **(_QWORD **)(v7 + 1192) = 0LL;
      **(_QWORD **)(v7 + 1200) = 0LL;
    }
    ...
    while ( 1 )
    {
      ...
      if ( *v13 )
      {
        ...
        {
          v18 = *(_QWORD *)(v14 + 8);
          if ( v16 <= v18 && v16 > v18 - (unsigned int)(*(_DWORD *)(v7 + 2172) - 32) )
            break;
        }
      }
      ++v12;
    ...
    v20 = 4;
    *(_QWORD *)(v7 + 2150) = 0xC3C3C3C3C3C3C3C3uLL;
    v21 = (_BYTE *)(v7 + 2158);
    do
    {
      *v21++ = -61;
