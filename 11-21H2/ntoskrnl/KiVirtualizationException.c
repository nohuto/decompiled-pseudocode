/*
 * XREFs of KiVirtualizationException @ 0x140432080
 * Callers:
 *     KiVirtualizationExceptionShadow @ 0x140AB5B40 (KiVirtualizationExceptionShadow.c)
 * Callees:
 *     KiUpdateStibpPairing @ 0x14020D230 (KiUpdateStibpPairing.c)
 *     KzRaiseIrql @ 0x1402AD500 (KzRaiseIrql.c)
...
/*
 * Hex-Rays decompilation failed for KiVirtualizationException @ 0x140432080
 ...
 * 00000001404320F7: test    cs:KiKvaShadow, 1
 ...
 * 0000000140432319: call    KiFlushBhbDuringTrapEntryOrExit
 ...
 * 000000014043233A: call    KiSaveDebugRegisterState
 ...
 * 0000000140432365: test    byte ptr cs:KeSmapEnabled, 0FFh
 ...
 * 00000001404323BB: call    KzRaiseIrql
 ...
 * 0000000140432419: call    KiInitiateUserApc
 ...
 * 0000000140432469: call    KiCopyCounters
 ...
 * 0000000140432485: call    KiRestoreDebugRegisterState
 ...
 * 00000001404326B4: test    cs:KiKvaShadow, 1
 * 00000001404326BB: jz      short loc_1404326C2
 * 00000001404326BD: jmp     KiKernelExit
 ...
 * 0000000140432743: call    KiBugCheckDispatch
 */
