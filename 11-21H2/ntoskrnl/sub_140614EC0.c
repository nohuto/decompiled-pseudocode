/*
 * XREFs of sub_140614EC0 @ 0x140614EC0
 * Callers:
 *     <none>
 * Callees:
...
PKDEVICE_QUEUE_ENTRY __fastcall sub_140614EC0(PKDEVICE_QUEUE DeviceQueue, ULONG SortKey)
{
  __int64 v4; // rdx
  __int64 v5; // rcx
  __int64 *v6; // rdi
...
LABEL_18:
  result = KeRemoveByKeyDeviceQueue(DeviceQueue, SortKey);
  *((_QWORD *)&v17 + 1) = result;
  if ( v6 )
  {
    v14 = (_QWORD **)(v6 + 6);
    ...
    if ( *v14 != v14 )
    {
      ...
      while ( v15 != v14 );
      return (PKDEVICE_QUEUE_ENTRY)*((_QWORD *)&v17 + 1);
    }
  }
  return result;
}
