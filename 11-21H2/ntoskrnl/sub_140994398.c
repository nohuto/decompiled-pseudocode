/*
 * XREFs of sub_140994398 @ 0x140994398
 * Callers:
...
int __fastcall sub_140994398(__int64 a1)
{
  _UNKNOWN **v1; // rax
  __int64 v2; // rsi
  bool v3; // zf
  ...
  unsigned int v58; // [rsp+58h] [rbp-B0h] BYREF
  unsigned int v59; // [rsp+5Ch] [rbp-ACh] BYREF
  __int128 v60; // [rsp+60h] [rbp-A8h] BYREF
  __int64 v61; // [rsp+70h] [rbp-98h] BYREF
  struct _EVENT_DATA_DESCRIPTOR v62; // [rsp+78h] [rbp-90h] BYREF
  _DWORD *v63; // [rsp+98h] [rbp-70h]
  ...
  char v69[16]; // [rsp+C8h] [rbp-40h] BYREF
  char v70[16]; // [rsp+D8h] [rbp-30h] BYREF
  char v71[16]; // [rsp+E8h] [rbp-20h] BYREF
  char v72[16]; // [rsp+F8h] [rbp-10h] BYREF
  ...
  char v83[16]; // [rsp+158h] [rbp+50h] BYREF
  char v84[16]; // [rsp+168h] [rbp+60h] BYREF
  char v85[16]; // [rsp+178h] [rbp+70h] BYREF
  char v86[16]; // [rsp+188h] [rbp+80h] BYREF
  char v87[16]; // [rsp+198h] [rbp+90h] BYREF
  char v88[16]; // [rsp+1A8h] [rbp+A0h] BYREF
  char v89[16]; // [rsp+1B8h] [rbp+B0h] BYREF
  char v90[16]; // [rsp+1C8h] [rbp+C0h] BYREF
  unsigned int *v91; // [rsp+1D8h] [rbp+D0h]
  __int64 v92; // [rsp+1E0h] [rbp+D8h]
  int *v93; // [rsp+1E8h] [rbp+E0h]
  __int64 v94; // [rsp+1F0h] [rbp+E8h]
  unsigned int *v95; // [rsp+1F8h] [rbp+F0h]
  __int64 v96; // [rsp+200h] [rbp+F8h]
  int *v97; // [rsp+208h] [rbp+100h]
  __int64 v98; // [rsp+210h] [rbp+108h]
  unsigned int *v99; // [rsp+218h] [rbp+110h]
  __int64 v100; // [rsp+220h] [rbp+118h]
  unsigned int *v101; // [rsp+228h] [rbp+120h]
  ...
  *(_DWORD *)(a1 + 192) = 0;
  ...
  if ( v10 != (_DWORD)v60 || (LODWORD(v1) = DWORD2(v60), *(_QWORD *)(a1 + 200) != *((_QWORD *)&v60 + 1)) )
  {
    if ( (unsigned int)dword_140C03A00 > 5 )
    {
      ...
      v65 = *(_QWORD *)(a1 + 40);
      v66[0] = *(unsigned __int16 *)(a1 + 32);
      if ( (v10 & 1) == 0 )
        v11 = (const CHAR *)qword_14086D650;
      v61 = *(_QWORD *)(a1 + 200);
      v67 = &v61;
      v66[1] = 0;
      v68 = 8LL;
      sub_1403699D0((__int64)v69, v11);
      v14 = "Relative Capacity Unit";
      if ( (*(_DWORD *)(v13 + 192) & 2) == 0 )
        v14 = v12;
      sub_1403699D0((__int64)v70, v14);
      v17 = "FCC Unavailable";
      if ( (*(_DWORD *)(v16 + 192) & 4) == 0 )
        v17 = v15;
      sub_1403699D0((__int64)v71, v17);
      ...
      *(_QWORD *)&v60 = v6;
      ...
      v92 = 4LL;
      if ( (_DWORD)v45 )
        v48 = 100000 * (unsigned __int64)v46 / v45;
      else
        LODWORD(v48) = 0;
      v55 = v48;
      v56 = v46;
      ...
      v100 = 4LL;
      v102 = 4LL;
      LODWORD(v1) = sub_14020A9C4((__int64)&dword_140C03A00, (unsigned __int8 *)byte_14003091B, 0LL, 0LL, 0x1Cu, &v62);
    }
  }
  return (int)v1;
}
