/*
 * XREFs of sub_140515200 @ 0x140515200
 * Callers:
...
__int64 __fastcall sub_140515200(__int64 a1, char *a2)
{
  __int64 v2; // rbx
  unsigned int v3; // edi
  char v5; // al
  ...
  if ( !a1 )
    goto LABEL_5;
  if ( (int)sub_14051B2B8(a1, &v16, &v17) < 0 )
    return v2;
  v3 = v16;
  if ( v16 )
    v5 = 1;
...
LABEL_5:
    v5 = 0;
  *a2 = v5;
  v6 = v3 + dword_140C4BD58;
  if ( v3 + dword_140C4BD58 )
  {
    v2 = sub_1403B1F04(a1, 32 * v6);
    if ( v2 )
    {
      v7 = qword_140C4BD50;
      v8 = 0;
