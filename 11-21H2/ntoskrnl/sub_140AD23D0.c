/*
 * XREFs of sub_140AD23D0 @ 0x140AD23D0
 * Callers:
 *     <none>
 * Callees:
 *     <none>
...
__int64 __fastcall sub_140AD23D0(__int64 a1, __int64 a2)
{
  unsigned int v2; // esi
  __int64 v3; // r11
  ...
  v3 = a2 ^ *(_QWORD *)(a1 + 64);
  v4 = &v19;
  v19 = 0xCBC0C5CAC4C9CFCCuLL;
  v5 = v3 | 0xFFFF800000000000uLL;
  v20 = 0xCEC7C3CDC8C2C6C1uLL;
  v6 = (_QWORD *)v5;
  ...
  for ( i = 0; i < v11; ++i )
  {
    ...
    *v6 = v5 + (v7 ^ *v6) + i;
    ...
    {
      v16 = __ROL8__(*v6, 4);
      *v6 = *((unsigned __int8 *)&v19 + (v16 & 0xF)) | v16 & 0xFFFFFFFFFFFFFFF0uLL;
      --v15;
    }
    while ( v15 );
    ++v6;
  ...
  v17 = *(_QWORD *)v5 ^ 0x85131481131482ELL;
  *(_DWORD *)v5 = 288442414;
