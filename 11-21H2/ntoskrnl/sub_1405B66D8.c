/*
 * XREFs of sub_1405B66D8 @ 0x1405B66D8
 * Callers:
...
void __fastcall sub_1405B66D8(int a1, __int64 a2, int a3, __int64 a4, int a5, int a6)
{
  __int64 v8; // r8
  int v9; // r9d
  __int64 v10; // r10
  ...
  if ( *(_QWORD *)&qword_140C53448 && **(_DWORD **)&qword_140C53448 > 5u )
  {
    if ( sub_1402A2000(*(__int64 *)&qword_140C53448, 2LL) )
    {
      ...
      v14 = a1;
      v15 = a3;
      sub_14024A9B0(v10, (unsigned __int8 *)&word_14002DE0E, v8, 1u, v12, v13, 9u, &v21);
    }
  }
}
