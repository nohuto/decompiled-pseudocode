/*
 * XREFs of sub_140518C60 @ 0x140518C60
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall sub_140518C60(__int64 a1)
{
  __int64 v1; // rdi
  ...
  else
  {
    ...
    v8 = (KSPIN_LOCK *)(v1 + 168);
    KeAcquireSpinLockAtDpcLevel((PKSPIN_LOCK)(v1 + 168));
    v5 = 1;
  }
  v9 = sub_14042A5E0(*(_QWORD *)(v1 + 64), *(unsigned int *)(a1 + 372));
  if ( v5 )
  {
