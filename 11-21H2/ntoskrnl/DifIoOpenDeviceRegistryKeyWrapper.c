/*
 * XREFs of DifIoOpenDeviceRegistryKeyWrapper @ 0x14060FEF0
 * Callers:
 *     <none>
 * Callees:
        ...
        PHANDLE DeviceRegKey)
{
  ...
  v19 = 0LL;
  v20 = 0LL;
  APIThunkContextById = DifGetAPIThunkContextById(185);
...
LABEL_13:
  ...
  *(_QWORD *)&v20 = __PAIR64__(DevInstKeyType, DesiredAccess);
  *((_QWORD *)&v19 + 1) = DeviceRegKey;
