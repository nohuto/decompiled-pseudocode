/*
 * XREFs of sub_140A35084 @ 0x140A35084
 * Callers:
...
LABEL_3:
  ...
  if ( a4 != 2 )
  {
    ...
    {
      v22 = (wchar_t *)sub_1403C5DE0(a1, 0x55u);
      v11 = v22;
      if ( v22 )
      {
...
LABEL_45:
  ...
  v13 = sub_140A35814(a1, v11, a3, v18);
  if ( v13 && v11 && v14 )
    *v14 = v16;
  v7 = 0LL;
LABEL_22:
  ...
  if ( a6 )
  {
    if ( v13 )
    {
      ...
      {
        *a6 = 0LL;
        if ( (int)sub_140A35494(a1, v8, (unsigned __int16)v9, &v28) >= 0 && v28 >= 0 )
        {
          v25 = *(_QWORD *)(a1 + 24);
