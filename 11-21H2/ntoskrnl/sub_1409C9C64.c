/*
 * XREFs of sub_1409C9C64 @ 0x1409C9C64
 * Callers:
        ...
        __int64 a12)
{
  ...
  v44 = 0LL;
  v40 = 0;
  if ( !v15 || !*(_BYTE *)(v15 + 216) || a1 != 116 && a1 != 128 && RtlCompareUnicodeString(a4, &stru_14000A968, 0) )
    return 1;
  CurrentThreadProcess = PsGetCurrentThreadProcess();
  v17 = sub_1407B66E0(CurrentThreadProcess, &P);
  if ( v17 >= 0 )
  {
    if ( a6 )
    {
    ...
    v49[10] = &qword_140001B08;
    v49[11] = 0x800000005LL;
    v49[12] = v12;
    HIDWORD(v49[3]) = 4 * v22 + 8;
    if ( !a6 )
      v49[12] = v19;
    v49[18] = &qword_140001B08;
    ...
    if ( v47 )
    {
      ...
      LODWORD(v49[35]) = 2;
      v17 = sub_1405F4CC8(v29, &Src, (ULONG *)&Size + 1, &v40);
      if ( v17 < 0 )
      {
        v13 = Src;
      }
      ...
      {
        v30 = sub_1405F4CC8(*(__int16 **)(v15 + 64), &v44, (ULONG *)&Size, (_BYTE *)&v40 + 1);
        v14 = v44;
        v17 = v30;
        v13 = Src;
        if ( v30 >= 0 )
