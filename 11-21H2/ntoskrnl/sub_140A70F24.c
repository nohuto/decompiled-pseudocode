/*
 * XREFs of sub_140A70F24 @ 0x140A70F24
 * Callers:
 *     sub_140A70D60 @ 0x140A70D60 (sub_140A70D60.c)
 *     sub_140A70DE0 @ 0x140A70DE0 (sub_140A70DE0.c)
 *     sub_140A72900 @ 0x140A72900 (sub_140A72900.c)
 * Callees:
 *     wcsncmp @ 0x1403E33F0 (wcsncmp.c)
 */

__int64 *__fastcall sub_140A70F24(__int64 a1)
{
  __int64 *v1; // rsi
  __int64 v2; // rbx
  __int64 *v4; // r14
  ...
  v1 = (__int64 *)qword_140C4A188;
  v2 = 0LL;
  v4 = 0LL;
  v5 = 0;
  while ( v1 != &qword_140C4A188 )
  {
    v7 = v1[2];
    v4 = v1;
    v8 = *(_DWORD *)(a1 + 220);
