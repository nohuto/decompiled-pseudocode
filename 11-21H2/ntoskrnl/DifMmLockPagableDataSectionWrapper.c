/*
 * XREFs of DifMmLockPagableDataSectionWrapper @ 0x1406170D0
 * Callers:
 *     <none>
 * Callees:
...
PVOID __fastcall DifMmLockPagableDataSectionWrapper(PVOID AddressWithinSection)
{
  __int64 v2; // rdx
  __int64 v3; // rcx
  ...
  v13 = 0LL;
  v14 = 0LL;
  APIThunkContextById = DifGetAPIThunkContextById(331);
...
LABEL_13:
  *((_QWORD *)&v13 + 1) = AddressWithinSection;
...
LABEL_18:
  result = MmLockPagableDataSection(AddressWithinSection);
  v14 = result;
  if ( APIThunkContextById )
  {
