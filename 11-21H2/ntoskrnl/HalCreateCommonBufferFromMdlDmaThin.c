/*
 * XREFs of HalCreateCommonBufferFromMdlDmaThin @ 0x1405158A0
 * Callers:
 *     <none>
 * Callees:
...
LABEL_37:
            if ( v6 )
              ((void (__fastcall *)(_QWORD, unsigned __int64, unsigned __int64, unsigned __int64 *))qword_140C4BDB0)(
                *(_QWORD *)(v5 + 40),
                v28,
                v14 >> 12,
                v23);
          ...
          *((_QWORD *)&v33 + 1) = v16;
          v34 = v14 >> 12;
          CommonBufferEntry = ((__int64 (__fastcall *)(_QWORD, __int64, __int128 *, _QWORD, unsigned __int64 *, unsigned __int64 *, unsigned __int64 *))qword_140C4BDA8)(
                                *(_QWORD *)(v5 + 40),
                                v24,
                                &v33,
                                0LL,
...
LABEL_35:
          ...
          CommonBufferEntry = HalpAllocateCommonBufferEntry(v12, (unsigned __int64)MappedSystemVa + v31, v5, 0);
          if ( CommonBufferEntry >= 0 )
          {
            *v32 = v28;
            return (unsigned int)CommonBufferEntry;
