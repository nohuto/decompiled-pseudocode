/*
 * XREFs of MiCombineIdenticalPages @ 0x1407F8CF0
 * Callers:
...
LABEL_18:
      ...
      KiStackAttachProcess((_KPROCESS *)v25, 0LL, (__int64)v34, v23);
    }
    CurrentThread = KeGetCurrentThread();
    v14 = v27 + 16200;
    if ( (a3 & 1) == 0 || (ULONG_PTR *)v27 == &MiSystemPartition )
    {
      --CurrentThread->KernelApcDisable;
      MiCombiningInProgress((__int64 *)v14, v30, 1);
      v26[0] = 0;
      v26[1] = -1;
      ...
      if ( (unsigned int)MiCreateUltraThreadContext((__int64)&v31[14], NextPageColor, 8) )
      {
        ...
        {
          v31[4] = v9 + 1664;
          v19 = MiCombineWorkingSet((__int64)v31);
        }
        else
        {
          v31[4] = 0LL;
          v19 = MiCombineAllPhysicalMemory(v31);
        }
        v12 = v19;
      ...
      MiCombiningInProgress((__int64 *)v14, v30, 0);
