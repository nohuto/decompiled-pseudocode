/*
 * XREFs of sub_14076520C @ 0x14076520C
 * Callers:
...
void __fastcall sub_14076520C(__int64 a1, __int64 a2, int a3, int a4, int a5, int a6, int a7)
{
  int v7; // r9d
  ...
  if ( a4 != 1 && (a4 != 24 || a3 != 790) && (unsigned int)dword_140C039C8 > 5 )
  {
    if ( sub_1402A2000((__int64)&dword_140C039C8, 0x800000000000LL) )
    {
      v10 = v7;
      v16 = &v14;
      v14 = 1LL;
      ...
      v31 = 4LL;
      v33 = 4LL;
      sub_1402A1A20((__int64)&dword_140C039C8, (unsigned __int8 *)&byte_14002C26B, 0LL, 0xBu, &v15);
    }
  }
}
