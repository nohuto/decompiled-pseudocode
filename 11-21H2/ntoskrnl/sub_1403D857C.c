/*
 * XREFs of sub_1403D857C @ 0x1403D857C
 * Callers:
...
char sub_1403D857C(unsigned __int16 *a1, unsigned __int16 *a2, int a3, ...)
{
  _UNKNOWN **v3; // rax
  REGHANDLE v4; // rbx
  ULONGLONG v7; // rax
  ...
  if ( qword_140D00B58 )
  {
    LOBYTE(v3) = EtwEventEnabled(qword_140D00B58, &stru_140012EE0);
    if ( (_BYTE)v3 )
    {
      if ( a1 && a2 )
      {
        ...
        v13 = &v20;
        va_copy(v16, va);
        LOBYTE(v3) = EtwWriteEx(v4, &stru_140012EE0, 0LL, 0, 0LL, 0LL, 4u, &UserData);
      }
    }
  }
  return (char)v3;
