/*
 * XREFs of sub_14063499C @ 0x14063499C
 * Callers:
...
__int64 __fastcall sub_14063499C(__int64 a1, __int64 a2)
{
...
LABEL_27:
    v5 = v4 - v6;
    sub_140635600(a1, v8, v7, CompressedBufferSize);
  }
  while ( 1 )
  {
    v15 = v6 + (v5 >> v14);
    for ( i = 0; ; i += v24 )
    {
      v17 = sub_1403B3D20((unsigned int *)a2, v6 + i, &v24);
      if ( !v17 )
        break;
      v8 = v24;
      if ( v24 + v6 + i > v15 )
