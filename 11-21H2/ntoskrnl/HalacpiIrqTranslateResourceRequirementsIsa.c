/*
 * XREFs of HalacpiIrqTranslateResourceRequirementsIsa @ 0x14084F290
 * Callers:
 *     <none>
 * Callees:
      ...
      if ( v9 )
      {
        ...
        do
        {
          ...
          do
          {
            ...
            if ( v24 < v25 )
            {
              v37 = (_DWORD *)HalpPicVectorRedirect + v24;
              do
              {
                v38 = v24 + 1;
                if ( *v37 + 1 != *((_DWORD *)HalpPicVectorRedirect + v38) )
                  break;
                ++v37;
                ++v24;
              }
            ...
            *(_OWORD *)&v21[v27 + 16] = *(_OWORD *)(a2 + 16);
            if ( v10 )
              v21[v27] = 8;
            ++v10;
            *(_DWORD *)&v21[v27 + 8] = *((_DWORD *)HalpPicVectorRedirect + v26);
            v28 = v24++;
            *(_DWORD *)&v21[v27 + 12] = *((_DWORD *)HalpPicVectorRedirect + v28);
          }
          while ( v24 <= v25 );
          v22 += 8;
          --v23;
