/*
 * XREFs of sub_140387B78 @ 0x140387B78
 * Callers:
...
NTSTATUS __fastcall sub_140387B78(
        __int64 a1,
        __int64 a2,
        __int64 a3,
        __int64 a4,
        ...
        char a63)
{
  ...
  v211 = 8LL;
  v213 = 8LL;
  return sub_1402D1760(qword_140C03820, (const EVENT_DESCRIPTOR *)qword_14000EDD8, 0LL, 0x4Bu, &v65);
}
