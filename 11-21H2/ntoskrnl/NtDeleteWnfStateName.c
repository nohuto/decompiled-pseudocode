/*
 * XREFs of NtDeleteWnfStateName @ 0x1407920F0
 * Callers:
 *     <none>
 * Callees:
  ...
  *(_QWORD *)v16 = 0LL;
  ...
  if ( v5 >= 0 )
  {
    ...
    if ( (_DWORD)v10 != 3 )
    {
      if ( v6 )
      {
        v5 = ExpWnfLookupPermanentName(v17, (PSECURITY_DESCRIPTOR **)&P);
        if ( v5 < 0 )
          goto LABEL_19;
    ...
    {
      v5 = 0;
      v4 = ExpWnfEnumerateScopeInstances(v9, 0LL);
    }
    if ( v4 )
    {
      v13 = v8 & 3;
      while ( 1 )
      {
        ...
        if ( v5 >= 0 )
        {
          ...
          ExpWnfNotifyNameSubscribers(v15, 16LL, 1LL, v20 != 0);
        ...
        if ( v13 != 3LL )
        {
          ...
          v4 = ExpWnfEnumerateScopeInstances(v19, v4);
          if ( v4 )
            continue;
        }
        break;
