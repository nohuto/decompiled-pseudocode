/*
 * XREFs of sub_140AD3B00 @ 0x140AD3B00
 * Callers:
 *     <none>
 * Callees:
...
void __fastcall __noreturn sub_140AD3B00(__int64 a1, __int64 a2, __int64 a3, __int64 a4)
{
  __int64 v4; // rax
  __int64 v5; // r10
  __int64 v6; // r11
  ...
  sub_140AD30B0(0x17u, (unsigned __int64)v14);
}
