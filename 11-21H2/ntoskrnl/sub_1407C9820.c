/*
 * XREFs of sub_1407C9820 @ 0x1407C9820
 * Callers:
...
__int64 __fastcall sub_1407C9820(ULONG_PTR BugCheckParameter3, unsigned int a2, unsigned int *a3)
{
  __int64 v6; // rdi
  _QWORD *v7; // rbx
  __int64 v8; // rdx
  ...
  v7 = (_QWORD *)(*(_QWORD *)(*(_QWORD *)(632LL * (a2 >> 31) + BugCheckParameter3 + 288) + 8LL * ((a2 >> 21) & 0x3FF))
                + 24LL * ((a2 >> 12) & 0x1FF));
  v8 = sub_140AB451C(BugCheckParameter3, v7, a3 + 1) + *v7;
  *a3 = a2;
  return v8 + v6 + 4;
}
