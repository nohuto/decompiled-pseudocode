/*
 * XREFs of sub_14082071C @ 0x14082071C
 * Callers:
...
int __fastcall sub_14082071C(__int64 a1, int a2)
{
  __int64 v2; // r12
  _DWORD *v3; // rbx
  __int64 v4; // rdi
...
LABEL_19:
    ...
    {
      v27 = *(char **)v4;
      LODWORD(v7) = sub_14067A8B0(&Handle, 0LL, &stru_140D3CF68, 0x2001Fu, 1u, 0LL);
      if ( (int)v7 >= 0 )
      {
        v36 = 0;
        v40[1] = L"PnP Manager";
        ...
        *(_OWORD *)&Destination[1] = 0LL;
        v28 = sub_1407103B0(v27, (__int64)&v44, 0x200u, &v36);
        v29 = Handle;
        if ( v28 >= 0 )
        {
          WORD1(v44) = 496;
          ...
          *(_OWORD *)&Destination[1] = v44;
          ...
          v31 = v39;
          if ( (int)sub_140821F5C(v29, v40, v41, &Destination[1], v12, v39) >= 0 )
          {
            *(_OWORD *)&Destination[1] = v44;
            RtlAppendUnicodeToString((PUNICODE_STRING)&Destination[1], L".Translated");
            sub_140821F5C(v29, v40, v41, &Destination[1], v10, v31);
          }
        }
...
LABEL_33:
    ...
    *(_OWORD *)v16 = *(_OWORD *)v19;
    ...
    if ( v20 )
      ...
      LODWORD(v21) = 0;
    v35 = sub_140820B7C(v21, *(_DWORD *)v17, *(_DWORD *)(v17 + 4), *(_DWORD *)(v17 + 80), v17 + 136, (__int64)&P);
    if ( v35 < 0 )
      break;
    v22 = P;
    *(_OWORD *)v14 = *(_OWORD *)P;
