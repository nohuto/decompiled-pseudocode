/*
 * XREFs of sub_1402516A0 @ 0x1402516A0
 * Callers:
...
__int64 __fastcall sub_1402516A0(__int64 a1, unsigned __int16 *a2, __int64 a3, char *a4, __int64 a5)
{
  char v6; // bl
  __int64 v9; // rcx
  _QWORD *v10; // rdx
  ...
  *(_OWORD *)a5 = 0LL;
  ...
  if ( (unsigned int)v9 >= 8 )
  {
    ...
    if ( v11 == 0x2D004900500041LL || v11 == 0x2D005400580045LL )
    {
      ...
      if ( v15 )
      {
        v16 = sub_14025179C(a1, v10, v15);
        if ( v16 )
        {
          if ( a3 && *(_DWORD *)(v16 + 20) > 1u )
          {
            v17 = sub_1406470A8(v16, *(_QWORD *)(a3 + 8), *(_WORD *)a3 >> 1, a1);
            goto LABEL_14;
          }
          if ( *(_DWORD *)(v16 + 20) )
          {
