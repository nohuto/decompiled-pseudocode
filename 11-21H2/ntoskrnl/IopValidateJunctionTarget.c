/*
 * XREFs of IopValidateJunctionTarget @ 0x14066119C
 * Callers:
        ...
        unsigned int *a6)
{
  ...
  *(_QWORD *)&String1.Length = 1441812LL;
  ...
  if ( a1 == 590860 )
  {
    v11 = v6 - 32;
    v34 = v6 - 32;
    Pool2 = (struct _REPARSE_DATA_BUFFER *)ExAllocatePool2(97LL, (unsigned int)(v6 - 32), 538996553LL);
    v13 = a2 + 2;
  ...
  else
  {
    v11 = v6;
    v34 = v6;
    Pool2 = (struct _REPARSE_DATA_BUFFER *)ExAllocatePool2(97LL, v6, 538996553LL);
    v14 = v6;
    v13 = a2;
  }
  v15 = Pool2;
...
LABEL_5:
        ...
        if ( XxxInformation >= 0 )
        {
          ...
          while ( 1 )
          {
            ...
            if ( !v10 )
              goto LABEL_46;
            XxxInformation = IopQueryXxxInformation(Object, (__int64)v10, (__int64)&v30, 1);
