/*
 * XREFs of MiLargePageFreeToZero @ 0x1402E86F0
 * Callers:
...
void __fastcall MiLargePageFreeToZero(ULONG_PTR BugCheckParameter2, unsigned int a2, int a3, char a4)
{
  ...
  unsigned int PfnChannel; // [rsp+78h] [rbp+20h]

  v7 = 48 * BugCheckParameter2 - 0x220000000000LL;
  v35 = a2;
  v37 = (unsigned __int64 *)(0x140000000LL + 8LL * a2 + 116608);
  v8 = *v37;
  v9 = *((unsigned int *)MiSearchNumaNodeTable(0xAAAAAAAAAAAAAAABuLL * ((__int64)(48 * BugCheckParameter2) >> 4)) + 2);
...
LABEL_27:
  ...
  *(_QWORD *)(v13 + 8) = v14;
  ...
  v20 = v19 + 134 * v15 + 4 * (PfnChannel + v18);
...
LABEL_10:
  *(_BYTE *)(v7 + 34) &= 0xF8u;
  v22 = v36 + v19 + 4 * (PfnChannel + (unsigned __int64)(BugCheckParameter2 < 0x100000 ? 8 : 0));
