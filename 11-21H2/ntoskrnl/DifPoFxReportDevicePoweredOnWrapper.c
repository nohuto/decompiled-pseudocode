/*
 * XREFs of DifPoFxReportDevicePoweredOnWrapper @ 0x1406198E0
 * Callers:
 *     <none>
 * Callees:
...
char __fastcall DifPoFxReportDevicePoweredOnWrapper(ULONG_PTR BugCheckParameter2)
{
  __int64 v2; // rdx
  __int64 v3; // rcx
  ...
  v14 = 0LL;
  APIThunkContextById = DifGetAPIThunkContextById(376);
...
LABEL_18:
  LOBYTE(v10) = PopFxHandleReportDevicePoweredOn(BugCheckParameter2);
  if ( APIThunkContextById )
  {
    ...
    for ( j = (__int64 *)APIThunkContextById[6]; j != v11; j = (__int64 *)*j )
    {
      v10 = j - 2;
      if ( j != (__int64 *)16 )
        LOBYTE(v10) = ((__int64 (__fastcall *)(__int128 *))v10[1])(&v14);
    }
  }
  return (char)v10;
}
