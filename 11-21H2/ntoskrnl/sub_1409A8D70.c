/*
 * XREFs of sub_1409A8D70 @ 0x1409A8D70
 * Callers:
...
char __fastcall sub_1409A8D70(char a1, int a2, int a3)
{
  _UNKNOWN **v3; // rax
  ...
  if ( (unsigned int)dword_140D3B908 > 5 )
  {
    ...
    if ( (_BYTE)v3 )
    {
      ...
      v10 = a2;
      v22 = 2;
      LOBYTE(v3) = sub_14020A9C4((__int64)&dword_140D3B908, (unsigned __int8 *)&dword_1400339F4, 0LL, 0LL, 7u, &v11);
    }
  }
  return (char)v3;
}
