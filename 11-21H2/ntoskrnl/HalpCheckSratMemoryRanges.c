/*
 * XREFs of HalpCheckSratMemoryRanges @ 0x14051E1B8
 * Callers:
    ...
    while ( a1 <= v1 || a1 >= *(v3 - 1) )
    {
      ...
      if ( v2 >= (unsigned int)HalpNumaSratMemoryRangeCount )
      {
        if ( (_DWORD)HalpNumaSratMemoryRangeCount
          ...
          && tlgKeywordOn((__int64)&dword_140C04538, 0x400000000000LL) )
        {
          v13 = v5;
          v16 = &v13;
          v19 = &v12;
...
LABEL_11:
          ...
          v21 = 0;
          v24 = 0;
          tlgWriteTransfer_EtwWriteTransfer((__int64)&dword_140C04538, (unsigned __int8 *)v6, 0LL, 0LL, v10, &v15);
          return;
        }
        return;
      }
