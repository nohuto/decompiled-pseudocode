/*
 * XREFs of MinAsn1ParseOIDSequence @ 0x140A32D28
 * Callers:
 *     I_MinCryptGetCertificateEKUs @ 0x140A31F7C (I_MinCryptGetCertificateEKUs.c)
 * Callees:
  ...
  if ( (_DWORD)v6 )
  {
    if ( (int)MinAsn1ExtractContent(v3, v6, &v14, &v15) > 0 )
    {
      ...
      if ( v14 )
      {
        ...
        {
          v14 = 1;
          Values = MinAsn1ExtractValues(v11, v10, (unsigned int)&v14, (unsigned int)&qword_14000B2D0, 1, a3 + 16LL * v8);
          if ( Values <= 0 )
          {
            if ( !Values )
              Values = -1;
