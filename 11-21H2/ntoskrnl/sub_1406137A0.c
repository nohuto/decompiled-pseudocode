/*
 * XREFs of sub_1406137A0 @ 0x1406137A0
 * Callers:
 *     <none>
 * Callees:
...
BOOLEAN __fastcall sub_1406137A0(PKDEVICE_QUEUE DeviceQueue, PKDEVICE_QUEUE_ENTRY DeviceQueueEntry)
{
  __int64 v4; // rdx
  __int64 v5; // rcx
  __int64 *v6; // rdi
...
LABEL_18:
  result = KeInsertDeviceQueue(DeviceQueue, DeviceQueueEntry);
  BYTE8(v17) = result;
  if ( v6 )
  {
    v14 = (_QWORD **)(v6 + 6);
