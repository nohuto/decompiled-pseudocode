/*
 * XREFs of sub_14061D460 @ 0x14061D460
 * Callers:
 *     <none>
 * Callees:
...
NTSTATUS __fastcall sub_14061D460(HANDLE PortHandle, ULONG Flags, PALPC_DATA_VIEW_ATTR ViewAttributes)
{
  __int64 v6; // rdx
  __int64 v7; // rcx
  __int64 *v8; // rdi
...
LABEL_18:
  result = ZwAlpcCreateSectionView(PortHandle, Flags, ViewAttributes);
  LODWORD(v20) = result;
  if ( v8 )
  {
    v16 = (_QWORD **)(v8 + 6);
