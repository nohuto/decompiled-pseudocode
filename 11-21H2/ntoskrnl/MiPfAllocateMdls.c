/*
 * XREFs of MiPfAllocateMdls @ 0x1406F4A80
 * Callers:
...
LABEL_18:
  ...
  *(_QWORD *)(v20 + 248) = 0LL;
  MiSetInPagePriority(v20, v41, v40);
  v23 = v19 << 12;
  if ( v19 <= 0x10 )
  {
    Mdl = (PMDL)(v21 + 272);
...
LABEL_21:
    ...
    while ( 1 )
    {
      ...
      if ( (*(_BYTE *)(v24 + 34) & 2) != 0 && (*(_DWORD *)(v45 + 56) & 0x8000000) != 0 )
      {
        if ( *(_QWORD *)(v24 + 24) )
        {
          SharedProtos = MiGetSharedProtos(v45, a2, v24);
          if ( SharedProtos )
          {
      ...
      if ( (*(_DWORD *)(v45 + 56) & 0x20) != 0 )
      {
        ...
        {
          v36 = *(_QWORD *)(SubsectionDriverProtos + 72);
    ...
    v42 = v25;
    v37 = v24;
    v28 = MiStartingOffset(v24, v18, a2);
    v9 = v38;
    v12 = v39;
    v10 = v47;
    v8 = v48;
