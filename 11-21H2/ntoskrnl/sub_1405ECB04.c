...
NTSTATUS __fastcall sub_1405ECB04(
        int a1,
        WCHAR *a2,
        __int64 a3,
        void *a4,
...
LABEL_11:
            ...
            LOBYTE(a3) = v17;
            LOBYTE(a4) = v18;
            v19 = sub_1409BBDD8(a2, (unsigned int)v12, a3, a4);
            v20 = 0;
            if ( v19 )
            {
              if ( !v12 )
...
LABEL_24:
            ...
            if ( !DestinationStringLength )
              goto LABEL_31;
            v27 = sub_1405EC744((__int64)a2, v12);
            LODWORD(v38) = v27;
            if ( !v27 )
              goto LABEL_48;
            DestinationStringLength = 511;
            result = RtlNormalizeString(1u, a2, v27, v28, &DestinationStringLength);
...
LABEL_35:
                  ...
                  result = sub_1409BC59C((wchar_t *)Src, a10, v37);
...
LABEL_49:
          ...
          v38 = 0LL;
          if ( (int)sub_1402E0AC4(a2, 0x7FFFFFFFuLL, &v38) >= 0 )
          {
            v17 = a10;
            v12 = v38 + 1;
            goto LABEL_11;
