/*
 * XREFs of sub_1405507F0 @ 0x1405507F0
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall sub_1405507F0(__int64 a1, struct _MDL *a2, __int64 a3, __int64 a4)
{
  __int64 result; // rax
  unsigned int v9; // ebx
  ...
  if ( ((((unsigned __int16)a2 & 0xFFF) + a3 + 4095) & 0xFFFFFFFFFFFFF000uLL) > 0x1FA000 )
    return 3221225485LL;
  result = sub_1403A0F08((__int64)v10, a2, a3, 0, 0);
  if ( (int)result >= 0 )
  {
    v11[2] = v10[0];
    v11[3] = v10[7];
    v11[1] = a1;
    v11[4] = a4;
    v9 = sub_140358A20(2u, 32, 0, (__int64)v11);
    sub_1403A0EB4(v10);
    return v9;
  }
  return result;
