/*
 * XREFs of sub_140688318 @ 0x140688318
 * Callers:
...
__int64 __fastcall sub_140688318(ULONG_PTR BugCheckParameter2, PVOID **a2, _DWORD *a3, unsigned int *a4)
{
  int v4; // edi
  char v6; // r13
  ULONG v7; // eax
  ...
  v27 = 0;
  v29 = 0;
  sub_1406881CC((PRTL_BITMAP)(BugCheckParameter2 + 88), 0LL, (unsigned int *)&v26 + 1);
  v7 = RtlNumberOfSetBits((PRTL_BITMAP)(BugCheckParameter2 + 88));
  v8 = HIDWORD(v26);
  sub_140688290(BugCheckParameter2, 1, SHIDWORD(v26), v7);
  ...
  if ( PoolWithTag )
  {
    ...
    else
    {
      v25 = v8;
      v16 = v28;
      sub_14020A48C(BugCheckParameter2, (__int64)v28, v13, (__int64)&v29, (unsigned int *)&v26, v10, v25, v6);
      sub_14020A41C(
        BugCheckParameter2,
        (int)v16,
        v17,
