/*
 * XREFs of sub_14057EFCC @ 0x14057EFCC
 * Callers:
...
char __fastcall sub_14057EFCC(__int64 a1, __int64 a2, __int64 a3, int a4, char a5, char a6, char a7)
{
  _UNKNOWN **v7; // rax
  REGHANDLE v8; // rbx
  ...
  if ( qword_140D00B58 )
  {
    LOBYTE(v7) = EtwEventEnabled(qword_140D00B58, &stru_1400396E0);
    if ( (_BYTE)v7 )
    {
      UserData.Reserved = 0;
      v13 = 0;
      ...
      v24 = 4;
      v27 = 4;
      LOBYTE(v7) = EtwWriteEx(v8, &stru_1400396E0, 0LL, 0, 0LL, 0LL, 7u, &UserData);
    }
  }
  return (char)v7;
}
