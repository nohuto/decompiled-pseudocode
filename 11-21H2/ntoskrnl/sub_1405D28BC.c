/*
 * XREFs of sub_1405D28BC @ 0x1405D28BC
 * Callers:
...
char __fastcall sub_1405D28BC(__int64 *a1, unsigned __int8 a2, int a3, unsigned int a4, __int64 a5)
{
  _UNKNOWN **v5; // rax
  int v8; // esi
  REGHANDLE v9; // rbx
  ...
  {
    v9 = RegHandle;
    LOBYTE(v5) = EtwEventEnabled(RegHandle, &stru_1400384E8);
    if ( (_BYTE)v5 )
    {
      v10 = *a1;
      v5 = *(_UNKNOWN ***)(*a1 + 80);
      ...
      if ( 16 * (unsigned __int64)a4 <= 0xFFFFFFFF )
      {
        ...
        v26 = a5;
        v27 = 16 * a4;
        LOBYTE(v5) = EtwWriteEx(v9, &stru_1400384E8, 0LL, 0, 0LL, 0LL, 6u, &UserData);
      }
    }
  }
  return (char)v5;
