/*
 * XREFs of MmAccessFault @ 0x14031C860
 * Callers:
        ...
        ULONG_PTR BugCheckParameter4)
{
  ...
  if ( BugCheckParameter1 >> 47 != -1 && BugCheckParameter1 >> 47 != 0 )
  {
    ...
    else if ( KeInvalidAccessAllowed(BugCheckParameter4, 0) )
    {
      return 3221225477LL;
    }
  ...
  *(_OWORD *)ListEntry = 0LL;
  ...
  if ( KeGetCurrentIrql() > 1u )
    return MiRaisedIrqlFault(v38);
  while ( 1 )
  {
    v9 = 4096;
    if ( v6 < 0xFFFF800000000000uLL || (v17 = MiSystemFault(v38), FileExtents = v17, v17 == 192) )
    {
      FileExtents = MiUserFault(v38);
    ...
    FileExtents = MiDispatchFault(v38, &v36);
    if ( FileExtents == -1073741802 )
    {
        ...
        && (!qword_140C50670 || P[1] != (PVOID)qword_140C50670) )
      {
        ...
        {
          MiLockVadTree(1);
          P[0] = MiLocateAddress(v38[0]);
        }
        MiUnlockVadTree(1, 0x11u);
        v21 = 4;
        if ( (WORD4(v45) & 0x100) != 0 )
          v21 = 2;
        ProtoPteAddress = (PVOID)MiGetProtoPteAddress((__int64)P[0], v38[0] >> 12, v21, (__int64 *)ListEntry);
        if ( !ProtoPteAddress )
        {
          MiReleaseFaultSynchronization(v38);
          P[1] = 0LL;
        ...
        if ( P[1] != ProtoPteAddress )
          P[1] = ProtoPteAddress;
        MiRetainSubsection((__int64 *)ListEntry[0]);
      }
      DWORD2(v45) &= ~0x100u;
      FileExtents = 0;
    }
    else
    {
      ...
      if ( v36 )
      {
        ...
        {
          FileExtents = MiFaultGetFileExtents(v38);
          P[1] = 0LL;
          goto LABEL_19;
        }
        FileExtents = MiIssueHardFault((__int64)v38, v11);
      }
      P[1] = 0LL;
    }
    if ( (BYTE8(v45) & 0x10) != 0 )
    ...
    else
    {
      ...
      if ( (_QWORD)v45 )
      {
        if ( WORD5(v44) )
        {
          MiEmptyDeferredWorkingSetEntries((__int64 *)&v44);
          v12 = v45;
        }
      ...
      if ( (v14 & 1) != 0 )
        MiUnlockWorkingSetExclusive(v13, BYTE12(v44));
      else
        MiUnlockWorkingSetShared(v13, BYTE12(v44));
    }
LABEL_19:
    if ( (BYTE8(v45) & 1) != 0 )
      MiDeprioritizeVad((unsigned int *)P[0], v38[0]);
    if ( ListEntry[1] )
    {
    ...
    else if ( (v39 & 1) != 0 && *(_BYTE *)(v39 & 0xFFFFFFFFFFFFFFFEuLL) == 5 )
    {
      ...
      if ( v25 )
        MiReplenishSlabAllocator(v25, *(_QWORD *)(qword_140C51F48 + 8LL * *(unsigned __int16 *)(v44 + 174)), 1LL, 0LL);
    }
    ...
    if ( v19 && !(unsigned int)MiSufficientAvailablePages(v19, 0x420uLL) )
...
LABEL_29:
      if ( !P[1] && (PerfGlobalGroupMask & 0x1000) != 0 )
      {
        ...
        EtwTracePageFault((unsigned int)FileExtents, v38[0], v33, v32);
      }
      goto LABEL_31;
    }
LABEL_55:
    ...
    if ( ((__int64)v26[1].Queue & 4) != 0 || (*((_DWORD *)&v26[1].SwapListEntry + 3) & 0xC) != 0 )
    {
    ...
    else
    {
      ...
      if ( SBYTE8(v45) < 0
        || !(unsigned int)MiSufficientAvailablePages(*(_QWORD *)(qword_140C51F48 + 8 * v27), 0x420uLL)
      ...
      if ( v30 < 0x9F )
      {
        v31 = *((_DWORD *)&KeGetCurrentThread()[1].SwapListEntry + 3);
        if ( (v31 & 0xC) != 8
          && (v30 < 0x20 && (ULONG_PTR *)v28 == &MiSystemPartition
           || ((v31 & 2) == 0 || v30 < 0x21) && (*(_DWORD *)(v28 + 4) & 0x20) == 0) )
        {
          MiWaitForFreePage(v28);
        }
      }
      FileExtents = 0;
    }
LABEL_31:
    if ( (BYTE8(v45) & 2) != 0 )
      MiCopyOnWriteCheckConditions(v44, 3221225495LL);
    if ( (BYTE8(v45) & 4) != 0 )
      MiCopyOnWriteCheckConditions(v44, 3221226548LL);
    if ( !P[1] )
      break;
...
LABEL_77:
    v24 = ListEntry[0];
    MiInitializePageFaultPacket(2LL, (__int64)P[1], 0, v5, (__int64)v38);
    DWORD2(v45) |= 8u;
    v6 = v38[0];
    ListEntry[0] = v24;
  }
  if ( ListEntry[0] )
    MiReleaseFaultCharges((__int64 *)ListEntry[0]);
