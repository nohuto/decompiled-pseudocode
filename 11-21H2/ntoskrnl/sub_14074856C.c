/*
 * XREFs of sub_14074856C @ 0x14074856C
 * Callers:
...
__int64 __fastcall sub_14074856C(__int64 a1)
{
  PVOID v1; // rbx
  int v3; // esi
  int v4; // eax
  ...
  if ( !*(_QWORD *)(a1 + 544) )
  {
    v3 = sub_140748758(*(_QWORD *)(a1 + 32), 0LL, &Data, &DataSize);
    if ( v3 < 0 )
    {
      Data = 0LL;
      DataSize = 0;
  ...
  {
    v4 = sub_14077F2EC(qword_140D00AC0, *(_QWORD *)(a1 + 48), 20, 0, 983103, v1 != 0LL, (__int64)&KeyHandle, 0LL);
    v5 = KeyHandle;
    if ( v4 < 0 )
      v5 = 0LL;
    KeyHandle = v5;
    if ( v5 )
    {
      if ( !*(_QWORD *)(a1 + 544) )
      {
        *(_DWORD *)&ValueName.Length = 1441812;
        ...
        if ( !v1 )
          goto LABEL_10;
        v3 = sub_14042A5E0(4LL, *(_QWORD *)(a1 + 32));
        if ( v3 >= 0 )
