/*
 * XREFs of sub_140A2A168 @ 0x140A2A168
 * Callers:
...
__int64 __fastcall sub_140A2A168(__int64 a1, __int64 a2, __int64 a3)
{
  int v4; // r11d
  unsigned int v5; // r9d
  __int64 **v7; // r8
  ...
  v12 = sub_14077F2EC(a1, a2, 18, 0, 2, 0, (__int64)&KeyHandle, 0LL);
  v11 = v12;
  if ( v12 == -1073741772 )
  {
    v11 = 0;
...
LABEL_18:
      if ( *(_DWORD *)(a3 + 16) == 2 )
      {
        v16 = *(_QWORD *)a3 - 0x40942E3DA8B865DDLL;
        if ( *(_QWORD *)a3 == 0x40942E3DA8B865DDLL )
          v16 = *(_QWORD *)(a3 + 8) + 0x298AF3586C1A6853LL;
        if ( !v16 )
        {
          DestinationString = 0LL;
