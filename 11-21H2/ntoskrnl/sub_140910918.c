/*
 * XREFs of sub_140910918 @ 0x140910918
 * Callers:
...
void __fastcall sub_140910918(__int64 a1, int a2, unsigned __int16 *a3, int a4)
{
  __int64 v4; // rax
  unsigned int v5; // edx
  __int64 v6; // rax
  ...
  v10[v6 - 1] = &v7;
  v10[v6] = 2LL;
  sub_14035EDE4((__int64)&v9, v5 + 1, 0x41000000u, 0x924u, 0x501902u);
}
