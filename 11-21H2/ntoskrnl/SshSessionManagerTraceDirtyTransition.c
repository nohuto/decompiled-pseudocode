/*
 * XREFs of SshSessionManagerTraceDirtyTransition @ 0x1409A0DC4
 * Callers:
...
__int64 SshSessionManagerTraceDirtyTransition(int a1, __int64 a2, unsigned __int8 a3, ...)
{
  ...
  v7[25] = 1LL;
  v7[27] = 4LL;
  return SshpSessionManagerSendControlEvent((__int64)SLEEPSTUDY_EVT_DIRTY_TRANSITION_CONTROL_EVENT, 0xEu, (__int64)v7);
}
