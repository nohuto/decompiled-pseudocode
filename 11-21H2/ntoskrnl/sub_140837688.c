/*
 * XREFs of sub_140837688 @ 0x140837688
 * Callers:
...
__int64 __fastcall sub_140837688(__int64 a1, int a2, int a3)
{
  char v6; // al
  const char *v7; // r8
  __int64 v8; // rax
  ...
  while ( DstBuf[v8] );
  HIDWORD(v35[6]) = v8 + 1;
  result = sub_140837AD4((unsigned int)v35, a3, (unsigned int)&KeyHandle, -1, -1, (__int64)&unk_140C49060);
  if ( (int)result >= 0 )
  {
    memset(v35, 0, sizeof(v35));
    v10 = *(_BYTE *)(a1 + 64) == 3;
    ...
    while ( DstBuf[v11] );
    HIDWORD(v35[6]) = v11 + 1;
    v12 = sub_140837AD4((unsigned int)v35, a3, (unsigned int)&Handle, -1, -1, (__int64)&unk_140C49060);
    v13 = KeyHandle;
    v14 = v12;
    if ( v12 >= 0 )
    {
