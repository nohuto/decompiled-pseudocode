/*
 * XREFs of Feature_Servicing_Cc_InsufVA__private_IsEnabled @ 0x1404170F8
 * Callers:
...
__int64 Feature_Servicing_Cc_InsufVA__private_IsEnabled()
{
  ...
  CachedFeatureEnabledState = wil_details_FeatureStateCache_GetCachedFeatureEnabledState(
                                ...
                                (__int64)&Feature_Servicing_Cc_InsufVA__private_descriptor);
  v1 = (CachedFeatureEnabledState >> 3) & 1;
  wil_details_FeatureReporting_ReportUsageToService(
    (__int64)&Feature_Servicing_Cc_InsufVA__private_reporting,
    0x2E1B7DFu,
