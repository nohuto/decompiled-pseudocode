/*
 * XREFs of sub_140672284 @ 0x140672284
 * Callers:
...
__int64 __fastcall sub_140672284(const UNICODE_STRING *a1)
{
  char v1; // bl
  __int64 v3; // rdx
  ...
  v1 = 0;
  v10 = 0LL;
  _InterlockedExchange64(&v10, qword_140D010A8);
  v3 = v10;
  v4 = 0LL;
  if ( v10 )
  {
