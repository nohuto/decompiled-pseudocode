/*
 * XREFs of sub_1409876B8 @ 0x1409876B8
 * Callers:
...
__int64 __fastcall sub_1409876B8(__int64 a1, char a2, _DWORD *a3)
{
  void *Pool2; // r14
  _DWORD *v6; // r12
  ULONG_PTR v7; // rsi
  ...
  if ( inited >= 0 )
  {
    *((_WORD *)Pool2 + v14) = 0;
    ...
    if ( inited >= 0 )
    {
      ...
      inited = sub_1407DFC68((__int64)&FileHandle, v7, (__int64)&DestinationString, 0LL, 1048960, 0x20u, 0, 0LL);
      if ( inited >= 0 )
      {
        *((_WORD *)Pool2 + v14) = 92;
        inited = RtlInitUnicodeStringEx(&DestinationString, (PCWSTR)Pool2);
        if ( inited >= 0 )
        {
          ...
          if ( inited >= 0 )
          {
            ...
            inited = v17;
            if ( v17 == 259 )
              KeBugCheckEx(0x191u, 0xF66uLL, 0LL, 0LL, 0LL);
            if ( (v17 & 0xC0000000) != 0xC0000000 )
            {
              ...
              while ( 1 )
              {
                ...
                inited = v20;
                if ( v20 == 259 )
                  KeBugCheckEx(0x191u, 0xFA4uLL, 0LL, 0LL, 0LL);
                if ( v20 >= 0 )
                  break;
                if ( v20 == -1073741807 )
                  goto LABEL_43;
...
LABEL_43:
              ...
              inited = v21;
              if ( v21 == 259 )
                KeBugCheckEx(0x191u, 0xFDFuLL, 0LL, 0LL, 0LL);
              if ( v21 >= 0 )
              {
...
LABEL_58:
  ...
  if ( (v39 & 0x400000000LL) != 0 )
    sub_1407DFFD8(&v37, v7);
  if ( (v42 & 0x400000000LL) != 0 )
    sub_1407DFFD8(&FileHandle, v7);
  if ( v7 )
  {
    sub_1406AE49C(v7);
    sub_1406AE46C((volatile signed __int64 *)v7);
  }
  if ( Pool2 )
