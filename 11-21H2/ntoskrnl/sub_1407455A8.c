/*
 * XREFs of sub_1407455A8 @ 0x1407455A8
 * Callers:
...
__int64 __fastcall sub_1407455A8(__int64 a1)
{
  __int64 v1; // r13
  int v2; // ebx
  _QWORD *v4; // rcx
  ...
  v2 = sub_140561CC4((__int64)&v30, a1);
  if ( v2 < 0 )
    goto LABEL_3;
  do
  {
      ...
      *v10 = 0;
      ...
      if ( v15 )
      {
        *v15 = 0;
        ...
        v21 = sub_14094CFE8(v34, v14, v12, v17, &v33);
        v2 = v21;
        if ( v21 < 0 )
        {
          *(_DWORD *)(v1 + 412) = v21;
        ...
        *v25 = v22;
        *(_QWORD *)(v23 + 8) = v22;
        v2 = sub_140744E30((__int64)v22);
        if ( v2 < 0 )
          break;
        if ( v22[37] && !*(_QWORD *)(v1 + 296) && !sub_1402D1DA4(v1 + 288, (__int64)(v22 + 36)) )
        {
          v2 = -1073741670;
          break;
        }
        if ( v22[39] )
        {
          v2 = sub_14094A7D4((PUNICODE_STRING)(v1 + 304));
          if ( v2 < 0 )
            break;
        }
        if ( v22[41] )
        {
          v2 = sub_14094A7D4((PUNICODE_STRING)(v1 + 320));
          if ( v2 < 0 )
            break;
        }
        v2 = sub_140561CC4((__int64)&v30, (__int64)v22);
        if ( v2 < 0 )
          break;
      }
    }
