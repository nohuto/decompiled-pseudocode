/*
 * XREFs of DifIoGetInitialStackWrapper @ 0x14060F7E0
 * Callers:
 *     <none>
 * Callees:
 ...
 *     IoGetInitialStack @ 0x140936440 (IoGetInitialStack.c)
 */

PVOID DifIoGetInitialStackWrapper()
{
  __int64 v0; // rdx
  __int64 v1; // rcx
