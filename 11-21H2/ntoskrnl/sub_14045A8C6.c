/*
 * XREFs of sub_14045A8C6 @ 0x14045A8C6
 * Callers:
...
__int64 __fastcall sub_14045A8C6(__int64 a1, __int64 a2)
{
  __int64 v2; // rax
  __int16 v4; // ax
  __int16 v5; // ax
  ...
  v2 = *(_QWORD *)(a1 + 1752);
  v9 = xmmword_140D06920;
  if ( !v2 || v2 == *(_QWORD *)(a2 + 2528) || (xmmword_140D06920 & 0x400) != 0 )
  {
...
LABEL_8:
  ...
  *(_WORD *)(a1 + 1770) = 1;
  ...
  if ( (*(_DWORD *)(a2 + 2172) & 0x400000) == 0 )
    v7 = 1LL;
  if ( (v9 & 0x4000000000LL) != 0 && dword_140C09828 == 72 )
  {
    *(_WORD *)(a1 + 1766) |= 4u;
    *(_WORD *)(a1 + 1770) |= 4u;
    *(_WORD *)(a1 + 1744) |= 4u;
