/*
 * XREFs of ViMiscCheckResourceRelease @ 0x140AA579C
 * Callers:
 *     VfMiscExReleaseResourceLite_Entry @ 0x140AA3DE0 (VfMiscExReleaseResourceLite_Entry.c)
 *     VfMiscExReleaseResourceForThreadLite_Entry @ 0x140AA3E00 (VfMiscExReleaseResourceForThreadLite_Entry.c)
 * Callees:
