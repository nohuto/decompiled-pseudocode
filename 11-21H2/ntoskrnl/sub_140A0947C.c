/*
 * XREFs of sub_140A0947C @ 0x140A0947C
 * Callers:
...
NTSTATUS __fastcall sub_140A0947C(__int64 a1, char a2, char a3, char a4, char a5)
{
  ...
  *(_QWORD *)&UserData.Size = 8LL;
  ...
  v20 = &v12;
  v12 = a4 != 0;
  return EtwWrite((REGHANDLE)stru_140C0E9A8.Queue.Wcb.DeviceRoutine, &stru_1400420E0, 0LL, 5u, &UserData);
}
