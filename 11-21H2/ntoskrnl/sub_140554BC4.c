/*
 * XREFs of sub_140554BC4 @ 0x140554BC4
 * Callers:
...
__int64 __fastcall sub_140554BC4(__int64 a1, char *a2)
{
  int v4; // ebx
  char v6; // r15
  __int64 v7; // r8
  ...
  v15[1] = v11 + 56;
  *(_QWORD *)&v17 = v15;
  v12 = sub_140552800((__int64)&v16, (char *)v8, v7, v10);
  if ( v12 >= 0 && a2 )
    *a2 = v6;
  if ( qword_140C54E80 )
  {
      ...
      do
      {
        if ( sub_14028FBF0(v8) )
        {
          ...
          if ( v14.QuadPart < v15[0] )
            ((void (__fastcall *)(_QWORD, _QWORD))sub_14055CDB4)((PHYSICAL_ADDRESS)v14.QuadPart, 1LL);
        }
        v8 += 4096LL;
        --v13;
      }
