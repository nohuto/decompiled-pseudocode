/*
 * XREFs of MinAsn1ExtractValues @ 0x140A33E74
 * Callers:
 *     MincryptValidateBasicConstraints @ 0x14065A018 (MincryptValidateBasicConstraints.c)
 *     MinAsn1ParseAlgorithmIdentifier @ 0x140A32B54 (MinAsn1ParseAlgorithmIdentifier.c)
 *     MinAsn1ParseAndDecodeRDNComponent @ 0x140A32B9C (MinAsn1ParseAndDecodeRDNComponent.c)
 *     MinAsn1ParseCertificate @ 0x140A32CB0 (MinAsn1ParseCertificate.c)
...
LABEL_32:
        v23 = MinAsn1ExtractContent(v11, a2, &v34, &v38);
        if ( v23 <= 0 )
          goto LABEL_47;
        v24 = v34;
        v25 = v38;
