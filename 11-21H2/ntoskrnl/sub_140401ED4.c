/*
 * XREFs of sub_140401ED4 @ 0x140401ED4
 * Callers:
...
__int64 __fastcall sub_140401ED4(unsigned int *a1, char *a2, size_t a3)
{
  size_t v3; // rdi
  char *v4; // rbp
  __int64 v6; // rsi
  ...
  *((_QWORD *)a1 + 2) += a3;
  ...
  if ( (_DWORD)v6 )
  {
    ...
    if ( a3 >= v7 )
    {
      ...
      v4 += v7;
      v3 -= v7;
      result = sub_140401FB0(a1 + 40, a1 + 8, 128LL, &v10);
      LODWORD(v6) = 0;
    }
  }
  if ( v3 >= 0x80 )
  {
    sub_140401FB0(a1 + 40, v4, v3, &v10);
    v9 = v3;
    v3 = v10;
    result = v9 - v10;
    v4 += result;
