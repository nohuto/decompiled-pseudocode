/*
 * XREFs of sub_1405DA274 @ 0x1405DA274
 * Callers:
...
char __fastcall sub_1405DA274(__int16 a1, __int64 a2, char a3, char a4, char a5, __int64 a6, char a7)
{
  _UNKNOWN **v7; // rax
  REGHANDLE v8; // rbx
  ...
  {
    v8 = qword_140C1F580;
    LOBYTE(v7) = EtwEventEnabled(qword_140C1F580, &stru_140038518);
    if ( (_BYTE)v7 )
    {
      UserData.Reserved = 0;
      v13 = 0;
      ...
      UserData.Size = 2;
      v21 = 4;
      LOBYTE(v7) = EtwWriteEx(v8, &stru_140038518, 0LL, 0, 0LL, 0LL, 8u, &UserData);
    }
  }
  return (char)v7;
}
