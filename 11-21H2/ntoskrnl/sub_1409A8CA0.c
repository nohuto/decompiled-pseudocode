/*
 * XREFs of sub_1409A8CA0 @ 0x1409A8CA0
 * Callers:
...
void __fastcall sub_1409A8CA0(int a1)
{
  ...
  if ( (unsigned int)dword_140D3B908 > 5 )
  {
    if ( sub_1402A2000((__int64)&dword_140D3B908, 1LL) )
    {
      ...
      v9 = &v4;
      v4 = a1;
      sub_14020A9C4((__int64)&dword_140D3B908, (unsigned __int8 *)byte_140033A41, 0LL, 0LL, 4u, &v5);
    }
  }
}
