/*
 * XREFs of IaLpssSetPowerD3 @ 0x140655B30
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall IaLpssSetPowerD3(__int64 *a1)
{
  ...
  if ( a1 && (v2 = *a1) != 0 )
  {
    v3 = ((__int64 (__fastcall *)(__int64))off_140C06A50[0])(v2 + 128);
    v4 = *a1;
    IaLpssClockParams = v3;
    if ( (((__int64 (__fastcall *)(__int64))off_140C06A30[0])(v4 + 129) & 7) == 7 )
    {
      LOBYTE(v5) = 4;
      ...
      ((void (__fastcall *)(__int64, _QWORD))off_140C06A38[0])(*a1 + 129, 0LL);
