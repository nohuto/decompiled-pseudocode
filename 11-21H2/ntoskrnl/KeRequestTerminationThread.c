/*
 * XREFs of KeRequestTerminationThread @ 0x1402ECD10
 * Callers:
...
char __fastcall KeRequestTerminationThread(__int64 a1)
{
  ...
  if ( (*(_BYTE *)(v1 + 992) & 1) != 0 )
  {
    ...
    v16[2] = a1;
    LOBYTE(v11) = 2;
    LOBYTE(v1) = VslpEnterIumSecureMode(v11, 9LL, 0LL, v16);
  }
  if ( !_interlockedbittestandset((volatile signed __int32 *)(a1 + 120), 0xFu) )
  {
    ...
    LOBYTE(v1) = KiExitDispatcher((__int64)v7, 0, 1, 0, CurrentIrql);
    if ( v3 )
    {
      KeAlertThread(a1, 0);
