/*
 * XREFs of sub_1405DB5F4 @ 0x1405DB5F4
 * Callers:
        ...
        char a10)
{
  ...
  {
    v13 = qword_140C1F580;
    LOBYTE(v10) = EtwEventEnabled(qword_140C1F580, &stru_1400395F8);
    if ( (_BYTE)v10 )
    {
      v14 = a1[5];
      v15 = &a1[v11 + 2];
      *(_QWORD *)&UserData.Size = 2LL;
      ...
      v47 = 1LL;
      v49 = 4LL;
      LOBYTE(v10) = EtwWriteEx(v13, &stru_1400395F8, 0LL, 0, 0LL, 0LL, 0xEu, &UserData);
    }
  }
  return (char)v10;
}
