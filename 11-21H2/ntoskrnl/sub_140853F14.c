/*
 * XREFs of sub_140853F14 @ 0x140853F14
 * Callers:
...
__int64 __fastcall sub_140853F14(PDEVICE_OBJECT DeviceObject, ULONG a2, unsigned int **a3)
{
  ...
  if ( v13 >= v11 )
  {
    ...
    if ( v15 >= v14 )
    {
      Pool2 = (unsigned int *)ExAllocatePool2(256LL, v12, a2);
      v17 = Pool2;
      if ( !Pool2 )
