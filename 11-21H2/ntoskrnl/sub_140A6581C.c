/*
 * XREFs of sub_140A6581C @ 0x140A6581C
 * Callers:
...
void __fastcall sub_140A6581C(__int64 *a1, unsigned int *a2)
{
  __int64 v2; // rcx
  unsigned int v3; // eax
  __int64 v4; // r13
  ...
  if ( *a2 < *(_DWORD *)(v2 + 880) && v3 < *(_DWORD *)(v2 + 1104) )
  {
    ...
    while ( 1 )
    {
      KeAcquireSpinLockAtDpcLevel((PKSPIN_LOCK)(v4 + 32));
      sub_140A66CEC(BitMapHeader, (__int64)&v22, (__int64)&v23);
      KeReleaseSpinLockFromDpcLevel((PKSPIN_LOCK)(v4 + 32));
      v8 = v22;
      if ( !(_DWORD)v22 )
        break;
      v9 = 0;
