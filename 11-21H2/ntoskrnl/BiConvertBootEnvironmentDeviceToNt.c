/*
 * XREFs of BiConvertBootEnvironmentDeviceToNt @ 0x140802A64
 * Callers:
...
__int64 __fastcall BiConvertBootEnvironmentDeviceToNt(_DWORD *a1, int a2, char a3, size_t *a4, _DWORD *a5)
{
  int v6; // ecx
  ...
  if ( v6 )
  {
    ...
    {
LABEL_5:
      NtPartitionPath = BiVerifyBootPartition((_DWORD)a1, 0, 0, 0, 0LL, (__int64)&v53);
...
LABEL_63:
        if ( !v14 )
          goto LABEL_73;
        NtPartitionPath = BiConvertBootEnvironmentDeviceToNt((int)a1 + v14, v59, 0, (unsigned int)&v54, (__int64)&Size);
        if ( NtPartitionPath < 0 )
          goto LABEL_74;
        LODWORD(v9) = Size + 34;
...
LABEL_77:
      v41 = BiConvertBootEnvironmentDeviceToUnknown(a1);
...
LABEL_21:
    ...
    if ( (a3 & 0x20) == 0 )
    {
      v32 = BiGetNtPartitionPath(a1, &Src);
      P = Src;
      if ( v32 >= 0 )
      {
        v58 = 1;
...
LABEL_75:
  ...
  NtPartitionPath = BiConvertBootEnvironmentDeviceToNt((_DWORD)v47, a2, 0, (unsigned int)&v54, (__int64)&Size);
  if ( NtPartitionPath < 0 )
  {
LABEL_74:
