/*
 * XREFs of sub_140747D68 @ 0x140747D68
 * Callers:
...
BOOLEAN __fastcall sub_140747D68(unsigned __int16 *a1)
{
  REGHANDLE v1; // rdi
  BOOLEAN result; // al
  ...
  v1 = qword_140C15E00;
  v9 = 0;
  result = EtwEventEnabled(qword_140C15E00, &stru_14000FE58);
  if ( result )
  {
    ...
    if ( result )
    {
      ...
      *(_QWORD *)&UserData.Size = 2LL;
      ...
      v15 = &v9;
      v9 = v8;
      return EtwWrite(qword_140C15E00, &stru_14000FE58, 0LL, 3u, &UserData);
    }
  }
  return result;
}
