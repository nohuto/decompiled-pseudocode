/*
 * XREFs of HalpCmosRangeHandler @ 0x14052331C
 * Callers:
 *     HalpcGetCmosDataByType @ 0x140523610 (HalpcGetCmosDataByType.c)
 *     HalpcSetCmosDataByType @ 0x140523640 (HalpcSetCmosDataByType.c)
 * Callees:
...
LABEL_13:
      ...
      {
        v16 = ((__int64 (__fastcall *)(_QWORD, __int64, _QWORD))funcs_1405233A4[v12])(a3, a4 + v10, v15);
      }
      a4 = v17;
      goto LABEL_13;
    }
