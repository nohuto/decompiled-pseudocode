/*
 * XREFs of CmpThreadInfoLogStack @ 0x14053E958
 * Callers:
...
char CmpThreadInfoLogStack()
{
  ...
  {
    LOBYTE(v2) = tlgKeywordOn((__int64)&dword_140C03868, 0x400000000000LL);
    if ( (_BYTE)v2 )
    {
      v20 = v5;
      v26 = &v20;
      ...
      *(_DWORD *)&EventDescriptor.Id = 184549376;
      ...
      if ( (void (__fastcall *)(const struct _GUID *, unsigned int, unsigned __int8, unsigned __int64, unsigned __int64, struct _EVENT_FILTER_DESCRIPTOR *, void *))qword_140C03890 == TlgAggregateInternalRegisteredProviderEtwCallback )
      {
...
LABEL_25:
          LOBYTE(v2) = EtwWriteEx(RegHandle, &EventDescriptor, 0LL, 0, ActivityId, ActivityId, 5u, &UserData);
      }
    }
  }
  return (char)v2;
