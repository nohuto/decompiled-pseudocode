/*
 * XREFs of sub_1403E85A8 @ 0x1403E85A8
 * Callers:
 ...
 *     sub_1403E8ED8 @ 0x1403E8ED8 (sub_1403E8ED8.c)
 *     memset @ 0x140435E00 (memset.c)
 */

__int64 __fastcall sub_1403E85A8(__int64 a1, unsigned __int16 *a2, int *a3)
{
  int v5; // r15d
  int v6; // r14d
  wchar_t *v7; // rbx
  ...
  wchar_t v63[2]; // [rsp+40h] [rbp-C0h] BYREF
  ...
  do
  {
    ...
    if ( (unsigned __int16)(v10 - v14) > 0x5Au )
      ...
      v15 = *((_BYTE *)&qword_140013F30[-4] + v10) & 0xF;
    v13 = *((unsigned __int8 *)qword_140013F30 + (unsigned int)(v15 + v13 + 8 * v15)) >> 4;
    v62 = v13;
    switch ( v13 )
    {
      case 8:
...
LABEL_117:
                ...
                if ( v64 == (_DWORD)v9 && (int)v12 > 0 )
                {
                  ...
                  {
                    --v45;
                    v46 = mbtowc(v63, v44, dword_140C094C4);
                    if ( v46 == 2 )
                    {
                      --v45;
                    }
...
LABEL_55:
              ...
              if ( ((unsigned __int8)v5 & (unsigned __int8)v14) != 0 )
              {
                SrcCh[0] = v22;
                SrcCh[1] = v9;
                v23 = mbtowc(DstCh, SrcCh, dword_140C094C4);
                LODWORD(v9) = 0;
                if ( v23 < 0 )
                  v69 = 1;
              }
