/*
 * XREFs of sub_140540BD0 @ 0x140540BD0
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall sub_140540BD0(__int64 a1, _QWORD *a2, unsigned int a3, int a4, _QWORD *a5, _QWORD *a6)
{
  _QWORD *v8; // r14
  __int64 v10; // rbx
  size_t v11; // r15
  ...
  v13 = *(_QWORD *)(a1 + 32);
  if ( v13 && sub_140540B48(a1, (unsigned __int64)a2, a3, &v24) )
  {
    if ( !v8 )
      return 0LL;
...
LABEL_14:
  ...
  if ( v15 + 16 >= v15
    && (int)sub_14024F418(*(_DWORD *)(v10 + 8312), *(_DWORD *)(a1 + 24), (int *)&v23) >= 0
    && v17 <= v23 )
  {
