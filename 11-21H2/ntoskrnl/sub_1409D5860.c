/*
 * XREFs of sub_1409D5860 @ 0x1409D5860
 * Callers:
...
__int64 __fastcall sub_1409D5860(_OWORD *a1, __int64 a2)
{
  NTSTATUS v4; // ebx
  void *v5; // rcx
  SIZE_T v6; // rbx
  ...
  v4 = ObOpenObjectByPointer(qword_140D019A0, 0x200u, 0LL, 0, 0LL, 0, &TargetProcessHandle);
  if ( v4 >= 0 )
  {
    if ( !*(_QWORD *)a2
          ...
          v4 >= 0) )
    {
      ...
      v7 = sub_140260C2C(v6, 0x74586D73u);
      TargetHandle[6] = v7;
      if ( v7 )
      {
  ...
  sub_1409D57BC((__int64)TargetHandle);
