/*
 * XREFs of sub_14092A938 @ 0x14092A938
 * Callers:
...
struct _KTHREAD *__fastcall sub_14092A938(int a1)
{
  _QWORD *v2; // rcx
  ...
  {
    v2[264] = MEMORY[0xFFFFF78000000014];
    v5[12] = a1;
    v5[0] = 3407884;
    v5[1] = 8;
    v5[10] = 4;
    return (struct _KTHREAD *)sub_14092A070(v2, 0, (__int64)v5);
  }
  return result;
}
