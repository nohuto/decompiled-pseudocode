/*
 * XREFs of sub_14098D650 @ 0x14098D650
 * Callers:
...
__int64 __fastcall sub_14098D650(__int64 a1, int a2, int a3)
{
  int v3; // ebx
  int v4; // r14d
  __int64 v5; // rax
    ...
    if ( *(_DWORD *)(v5 + 20) )
    {
      do
      {
        ...
        if ( (_DWORD)v9 )
        {
          ...
          v15 = (_DWORD *)ExAllocatePool2(256LL, (int)(8 * v11 + 32), 1297630800LL);
          v17 = v15;
          if ( v15 )
          {
            *v15 = v3;
            ...
            *((_QWORD *)v17 + 2) = v8 + v6 + 40;
            ...
            if ( (unsigned __int8)sub_14098E79C(v16, *(unsigned int *)(v8 + v6 + 60), v17) )
            {
              for ( j = 0; j < v41; ++j )
              {
                v21 = &Pool2[296 * j];
                if ( *((_DWORD *)v21 + 40) != -1430541637 )
                  sub_1405CAE6C(0x706uLL, 0x28uLL, 0x4B657920uLL, *((unsigned __int16 *)v21 + 1));
                if ( *((_DWORD *)v21 + 73) != -1430541637 )
                  sub_1405CAE6C(0x706uLL, 0x28uLL, 0x56616C75uLL, *((unsigned __int16 *)v21 + 9));
              }
              ...
              if ( v22 )
              {
                ...
                *(_QWORD *)&v22->Size = 1LL;
                ...
                v36 = v24;
                v37 = byte_140C5AE16 == 0;
                UserData[v36].Ptr = (ULONGLONG)&v40;
                *(_QWORD *)&UserData[v36].Size = 8LL;
                if ( !v37 )
                {
                  v38 = CallbackContext;
                  if ( EtwEventEnabled(CallbackContext, &stru_14003C138) )
                    EtwWrite(v38, &stru_14003C138, 0LL, UserDataCount, UserData);
                }
