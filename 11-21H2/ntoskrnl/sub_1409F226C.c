/*
 * XREFs of sub_1409F226C @ 0x1409F226C
 * Callers:
 ...
 *     sub_1409F24A8 @ 0x1409F24A8 (sub_1409F24A8.c)
 */

__int64 __fastcall sub_1409F226C(__int64 a1, __int64 a2, unsigned __int8 *a3, __int64 a4)
{
  unsigned int *v7; // rsi
  unsigned int v8; // ebp
  unsigned int *v9; // rdi
...
LABEL_23:
  if ( (unsigned int)sub_1409F24A8(v7, (unsigned int)v10, &v23) )
  {
    return 1;
  }
  else
  {
    ...
    if ( *v7 <= v20 )
    {
      ...
      if ( v21 < (7 * v7[1]) >> 3 )
      {
        ...
        if ( (unsigned int)sub_1409F24A8(v9, (unsigned int)v10, &v23) )
          v8 = 1;
      }
LABEL_32:
      if ( v22 )
