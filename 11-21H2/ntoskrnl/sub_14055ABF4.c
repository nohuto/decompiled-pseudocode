/*
 * XREFs of sub_14055ABF4 @ 0x14055ABF4
 * Callers:
...
char __fastcall sub_14055ABF4(const GUID *a1)
{
  int v2; // eax
  __int64 v3; // rcx
  __int64 *v4; // rdi
  ...
  if ( (_BYTE)v2 )
  {
    if ( !*(_DWORD *)(v3 + 416) )
    {
      ...
      if ( (v2 & 1) != 0 )
      {
        ...
        UserData.Ptr = v3 + 536;
        UserData.Size = 8;
        LOBYTE(v2) = EtwWriteEx(qword_140D00A98, &stru_140039668, 0LL, 0, 0LL, 0LL, 1u, &UserData);
