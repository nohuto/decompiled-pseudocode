/*
 * XREFs of KiHvEnlightenedGuestPriorityKick @ 0x1403457BC
 * Callers:
        ...
        if ( a1 != a2 )
        {
          ...
          if ( (v5 & 0x100000) != 0 || (_DWORD)result && (result = (unsigned __int8)v5, (unsigned __int8)v5 < a3) )
          {
            ...
            *(_DWORD *)(v7 + 12) = 2;
            ...
            if ( v6 )
              LODWORD(v8) = (unsigned __int8)HvlpVirtualProcessorMapping[2 * (unsigned int)v8 + 1] | ((unsigned __int8)HvlpVirtualProcessorMapping[2 * v8] << 6);
            *(_DWORD *)(v7 + 8) = v8;
            if ( (BYTE4(xmmword_140D06910) & 0x20) != 0 )
              EtwTraceXSchedulerPriorityKickSend(*(unsigned int *)(a2 + 36), 2LL);
