/*
 * XREFs of sub_14061AF50 @ 0x14061AF50
 * Callers:
 *     <none>
 * Callees:
...
NTSTATUS __fastcall sub_14061AF50(PCUNICODE_STRING VolumeRootPath)
{
  __int64 v2; // rdx
  __int64 v3; // rcx
  __int64 *v4; // rdi
...
LABEL_18:
  result = RtlCreateSystemVolumeInformationFolder(VolumeRootPath);
  LODWORD(v15) = result;
  if ( v4 )
  {
    v12 = (_QWORD **)(v4 + 6);
