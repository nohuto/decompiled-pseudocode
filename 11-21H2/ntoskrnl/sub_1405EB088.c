/*
 * XREFs of sub_1405EB088 @ 0x1405EB088
 * Callers:
...
__int64 __fastcall sub_1405EB088(__int64 a1, __int64 a2, __int64 a3)
{
  int v3; // esi
  __int64 v5; // rbp
  __int64 v6; // r9
  ...
  {
    v5 = sub_1405F39B4(a1 + 64, a3, a3, 0LL);
    if ( v5 == -1 )
      sub_1405F1BBC(9, a1, v3, v6, v6 & v20, v6 & v21);
    return v5;
  }
  if ( (*(_DWORD *)(a1 + 120) & 1) != 0 )
  {
    v8 = sub_1405EADE8(a1, a3);
  }
  else
  {
    if ( (a3 & 0xF) != 0 )
    ...
    sub_1405F1BBC(v9, a1, a3, 0, 0LL, 0LL);
    v8 = 0LL;
  }
LABEL_14:
  if ( !v8 )
