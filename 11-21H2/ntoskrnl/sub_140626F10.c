/*
 * XREFs of sub_140626F10 @ 0x140626F10
 * Callers:
 *     <none>
 * Callees:
...
NTSTATUS __fastcall sub_140626F10(HANDLE EventHandle, PLONG PreviousState)
{
  __int64 v4; // rdx
  __int64 v5; // rcx
  __int64 *v6; // rdi
...
LABEL_18:
  result = ZwSetEvent(EventHandle, PreviousState);
  DWORD2(v17) = result;
  if ( v6 )
  {
    v14 = (_QWORD **)(v6 + 6);
