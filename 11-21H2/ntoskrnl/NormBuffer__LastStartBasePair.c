/*
 * XREFs of NormBuffer__LastStartBasePair @ 0x1405ED40C
 * Callers:
 ...
 *     Normalization__GetSecondDecomposedCharPlane0 @ 0x1409BD268 (Normalization__GetSecondDecomposedCharPlane0.c)
 */
