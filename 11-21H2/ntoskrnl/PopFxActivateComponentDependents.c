/*
 * XREFs of PopFxActivateComponentDependents @ 0x140355A50
 * Callers:
...
void __fastcall PopFxActivateComponentDependents(__int64 a1)
{
  __int64 v1; // rdi
  __int64 i; // r15
  __int64 v4; // rax
  ...
  for ( i = *(_QWORD *)(a1 + 80); (unsigned int)v1 < *(_DWORD *)(a1 + 188); v1 = (unsigned int)(v1 + 1) )
  {
    ...
    {
      LOBYTE(v11) = 1;
      PopPluginComponentActive(i, NewIrql, v11, 0LL);
    }
  }
  ...
  v39 = &v38;
  v38 = (__int64)&v38;
  for ( j = PopFxNextComponentChildRelationSafe(a1, 0LL, &v42); j; j = PopFxNextComponentChildRelationSafe(
                                                                         a1,
                                                                         0LL,
                                                                         &v42) )
  {
    ...
    *(_DWORD *)(v16 + 16) = v22;
    ...
    KxReleaseSpinLock((PKSPIN_LOCK)(v16 + 8));
    if ( v23 )
    {
      ...
      else
      {
        ...
        *(_DWORD *)v26 = v31;
        ...
        {
          LOBYTE(v32) = 1;
          PopPluginComponentActive(*(_QWORD *)v44, *(unsigned int *)v43, v32, 0LL);
        }
      }
      v12 = (KSPIN_LOCK *)(a1 + 128);
      v13 = KeAcquireSpinLockRaiseToDpc((PKSPIN_LOCK)(a1 + 128));
