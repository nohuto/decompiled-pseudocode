/*
 * XREFs of HalpPowerInitDiscard @ 0x140B236AC
 * Callers:
...
__int64 __fastcall HalpPowerInitDiscard(__int64 a1)
{
  ...
  off_140C01BF8[0] = (__int64 (__fastcall *)())HaliLocateHiberRanges;
  HalpLowMemoryMapStack.SizeOfBitMap = 256;
  off_140C01C28 = HaliHaltSystem;
  off_140C01E88[0] = (__int64 (__fastcall *)())HalpPowerEarlyRestore;
  off_140C01EF8[0] = (__int64 (__fastcall *)())HalpPowerSetRebootHandler;
