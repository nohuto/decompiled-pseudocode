/*
 * XREFs of CcPostVolumeTelemetry @ 0x1402541A8
 * Callers:
 ...
 *     CcAggregateCumulativeVolumeTelemetry @ 0x140387858 (CcAggregateCumulativeVolumeTelemetry.c)
 ...
 *     CcHasVolumeCumulativeTelemetryChanged @ 0x14053E4A8 (CcHasVolumeCumulativeTelemetryChanged.c)
 *     CcResetGlobalTelemetry @ 0x1406DBEDC (CcResetGlobalTelemetry.c)
 *     CcAggregateCumulativeGlobalTelemetry @ 0x1406DBF58 (CcAggregateCumulativeGlobalTelemetry.c)
 *     ExFreePoolWithTag @ 0x140A6E010 (ExFreePoolWithTag.c)
 *     ExAllocatePoolWithTag @ 0x140A6E910 (ExAllocatePoolWithTag.c)
 */

/*
 * Hex-Rays decompilation failed for CcPostVolumeTelemetry @ 0x1402541A8
 ...
 * 0000000140254220: cmp     rbx, qword ptr cs:unk_140C498A8
 ...
 * 000000014025423D: xor     rcx, rsp; StackCookie
 ...
 * 00000001402542C3: lea     rcx, CcMasterLock; SpinLock
 * 00000001402542CA: call    KeAcquireInStackQueuedSpinLock
 * 00000001402542CF: mov     r15, cs:CcVolumeCacheMapList
 * 00000001402542D6: mov     [rsp+7F8h+var_4A0], r15
 * 00000001402542DE: mov     r12d, [rsp+7F8h+var_550]
 * 00000001402542E6: lea     rax, CcVolumeCacheMapList
 ...
 * 000000014025433B: call    CcAggregateCumulativeVolumeTelemetry
 ...
 * 0000000140254409: call    CcHasVolumeCumulativeTelemetryChanged
 ...
 * 000000014025442D: mov     eax, cs:KiIrqlFlags
 ...
 * 0000000140254443: call    CcAggregateCumulativeGlobalTelemetry
 * 0000000140254448: mov     ecx, cs:Microsoft_Windows_Kernel_CacheEnableBits
 ...
 * 0000000140254541: call    McTemplateK0xxxxxxxxxxxxxxxxxq_EtwWriteTransfer
 * 0000000140254546: call    CcResetGlobalTelemetry
 ...
 * 0000000140254571: call    _tlgKeywordOn
 ...
 * 0000000140254648: mov     eax, cs:Microsoft_Windows_Kernel_CacheEnableBits
 ...
 * 00000001402547C0: call    McTemplateK0jxxxxxxxxxxxxxxxxxxxxxxxxxxxxx_EtwWriteTransfer
 * 00000001402547C5: mov     eax, cs:Microsoft_Windows_Kernel_CacheEnableBits
 ...
 * 0000000140254C06: call    McTemplateK0jxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxx_EtwWriteTransfer
 * 0000000140254C0B: mov     eax, cs:Microsoft_Windows_Kernel_CacheEnableBits
 ...
 * 0000000140254EE4: call    McTemplateK0jxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxx_EtwWriteTransfer
 ...
 * 0000000140254F0B: call    _tlgKeywordOn
 ...
 * 000000014043E901: mov     eax, cs:KiIrqlFlags
 ...
 * 000000014043E960: call    KiRemoveSystemWorkPriorityKick
 ...
 * 00000001404805DB: call    KiRemoveSystemWorkPriorityKick
 ...
 * 000000014048066F: mov     eax, cs:CcNumberNumaNodes
 ...
 * 000000014048096D: call    _tlgWriteTransfer_EtwWriteTransfer
 ...
 * 0000000140480EE3: call    _tlgCreate1Sz_wchar_t
 ...
 * 000000014048118C: call    _tlgWriteTransfer_EtwWriteTransfer
