/*
 * XREFs of sub_1409BD8B4 @ 0x1409BD8B4
 * Callers:
 *     sub_1409C5570 @ 0x1409C5570 (sub_1409C5570.c)
 * Callees:
 *     memset @ 0x140435E00 (memset.c)
 *     sub_1409BD860 @ 0x1409BD860 (sub_1409BD860.c)
 */

__int64 __fastcall sub_1409BD8B4(__int64 a1, unsigned __int16 *a2, unsigned __int64 a3, _DWORD *a4)
{
  char v4; // ch
  char v7; // si^1
