/*
 * XREFs of sub_14096CF40 @ 0x14096CF40
 * Callers:
...
__int64 __fastcall sub_14096CF40(unsigned __int64 a1, __int64 a2, char a3)
{
  unsigned int v3; // edi
  char v5; // bl
  __int64 v7; // rax
  ...
  while ( 1 )
  {
    result = sub_140256548(
               *((_QWORD *)KeGetCurrentThread() + 23) + 1664LL,
               v5,
