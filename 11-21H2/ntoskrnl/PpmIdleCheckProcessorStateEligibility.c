/*
 * XREFs of PpmIdleCheckProcessorStateEligibility @ 0x1405C7C38
 * Callers:
        ...
        char a6)
{
  ...
  if ( a6 )
    goto LABEL_19;
  v11 = PpmCheckIdleVeto(v10 + v6 + 1400);
  if ( v11 )
...
LABEL_19:
  ...
  if ( result )
    return ((unsigned int (__fastcall *)(_QWORD, _QWORD))result)(*(_QWORD *)(v6 + 680), v9);
  return result;
}
