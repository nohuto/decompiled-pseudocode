/*
 * XREFs of sub_14095C804 @ 0x14095C804
 * Callers:
...
__int64 __fastcall sub_14095C804(__int64 a1, const wchar_t *a2, __int64 a3)
{
  __int64 v6; // rdi
  int v7; // r8d
  int v8; // ebx
...
LABEL_3:
    ...
    if ( (v7 & 0xC0) != 0 )
    {
      v12 = sub_14077FFEC(0LL, a3, (__int64)L"ControlSet001\\Services", 0, 0x20019u, (__int64)&KeyHandle);
      v8 = v12;
      if ( v12 == -1073741772 )
      {
        KeyHandle = 0LL;
  ...
  else
  {
    if ( v15 < 0 )
      goto LABEL_48;
    v16 = sub_14077FFEC(0LL, (__int64)v32, (__int64)a2, 0, 0x20019u, (__int64)&v31);
    v8 = v16;
    if ( v16 == -1073741772 )
    {
      v31 = 0LL;
  ...
  v8 = sub_14077FFEC(0LL, 2147483650LL, (__int64)a2, 0, 0x2001Fu, (__int64)&v34);
  if ( v8 >= 0 )
  {
    v8 = sub_14095C264(a3, 0LL, (__int64)v34, 0LL, v24, (__int64)v35, v14, (__int64)v31);
    if ( v8 >= 0 )
    {
      if ( KeyHandle )
      {
        ...
        {
          LODWORD(v26) = 260;
          v19 = sub_1406CB3B4(KeyHandle, i, Pool2, (unsigned int *)&v26);
          if ( v19 == -2147483622 )
          {
LABEL_47:
          ...
          if ( v19 < 0 || (int)sub_14077FFEC(0LL, (__int64)KeyHandle, (__int64)Pool2, 0, 0x20019u, (__int64)&Handle) < 0 )
            continue;
          LODWORD(v26) = 4;
          if ( (int)sub_14077FC64(Handle, L"Type", (_DWORD *)&v26 + 1, &v27, (unsigned int *)&v26) < 0
            || v26 != 0x400000004LL )
          {
            break;
          }
          LODWORD(v26) = 4;
          if ( (int)sub_14077FC64(Handle, L"Start", (_DWORD *)&v26 + 1, &v28, (unsigned int *)&v26) < 0
            || v26 != 0x400000004LL )
          {
            v20 = v27;
LABEL_35:
...
LABEL_36:
          ...
          v8 = sub_14095C264((__int64)KeyHandle, (__int64)Pool2, (__int64)v22, (__int64)Pool2, v25, 0LL, 0, 0LL);
          if ( v8 < 0 )
            goto LABEL_47;
        }
        v20 = 0;
