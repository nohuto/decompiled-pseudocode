/*
 * XREFs of NtCreateWorkerFactory @ 0x1407D5050
 * Callers:
 *     <none>
 * Callees:
 ...
 *     ExpInitializeThreadHistory @ 0x140358868 (ExpInitializeThreadHistory.c)
 *     KeInitializeTimer2 @ 0x1403588D0 (KeInitializeTimer2.c)
 *     KeDisableQueueingPriorityIncrement @ 0x14035B5F8 (KeDisableQueueingPriorityIncrement.c)
...
LABEL_23:
  ...
  *((_DWORD *)v22 + 152) = 1;
  ...
  KeRegisterObjectNotification((__int64)(v22 + 53), (__int64)&ExpWorkerFactoryManagerQueue, (__int64)(v22 + 70));
  v34[0] = 0LL;
  v34[1] = -1LL;
  KeSetTimer2((__int64)(v22 + 53), v22[14], -v22[14], (__int64)v34);
  result = ObInsertObjectEx((char *)v22, 0LL, a2, 0, 0, 0LL, &v33);
  if ( (int)result >= 0 )
    *a1 = v33;
  return result;
}
