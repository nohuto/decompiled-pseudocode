/*
 * XREFs of sub_140617430 @ 0x140617430
 * Callers:
 *     <none>
 * Callees:
...
PVOID __fastcall sub_140617430(
...
LABEL_12:
  *(_QWORD *)&v22 = v16;
LABEL_13:
  *((_QWORD *)&v22 + 1) = __PAIR64__(BugCheckOnFailure, Priority);
  *(_QWORD *)&v24 = MemoryDescriptorList;
  BYTE12(v23) = a2;
  DWORD2(v23) = a3;
  *(_QWORD *)&v23 = a4;
...
LABEL_18:
  result = MmMapLockedPagesSpecifyCache(MemoryDescriptorList, a2, a3, a4, BugCheckOnFailure, Priority);
  *((_QWORD *)&v24 + 1) = result;
  if ( v12 )
  {
    v20 = (_QWORD **)(v12 + 6);
