/*
 * XREFs of sub_1409A9644 @ 0x1409A9644
 * Callers:
...
void __fastcall sub_1409A9644(char a1)
{
  ...
  if ( (unsigned int)dword_140D3B908 > 5 )
  {
    if ( sub_1402A2000((__int64)&dword_140D3B908, 1LL) )
    {
      ...
      v9 = &v3;
      v10 = 1;
      sub_14020A9C4((__int64)&dword_140D3B908, (unsigned __int8 *)byte_140033345, 0LL, 0LL, 4u, &v5);
    }
  }
}
