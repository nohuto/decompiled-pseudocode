/*
 * XREFs of sub_140AF502C @ 0x140AF502C
 * Callers:
...
__int64 __fastcall sub_140AF502C(__int64 a1)
{
  __int64 result; // rax
  unsigned int *v2; // rdx
  unsigned int i; // ebx
  ...
  if ( v2 )
  {
    ...
    v11 = (unsigned __int16)word_140D05000;
    ...
    for ( i = 0; i < v11; ++i )
    {
      ...
      *v13 = 0LL;
      qsort(&Base, v18, 0x10uLL, sub_140B50EB0);
      v10 = (unsigned __int16)word_140D05000;
      result = 0LL;
      if ( word_140D05000 )
      {
        p_Base = &Base;
        v20 = i * (unsigned __int16)word_140D05000;
        do
        {
          v21 = *p_Base;
          ...
          *(_DWORD *)(qword_140C506D8 + 4 * v22) = v21;
        }
...
LABEL_3:
  ...
  while ( i < v4 )
  {
    for ( k = i; k < v4 + i; *(_DWORD *)(qword_140C506D8 + 4 * v6) = v8 & 0x3F )
    {
      v6 = i * (v4 - 1) + k;
      v7 = k++;
      v8 = v7 % v4;
      result = qword_140C506D8;
    }
    ++i;
  }
  return result;
