/*
 * XREFs of sub_1409BABB4 @ 0x1409BABB4
 * Callers:
...
__int64 __fastcall sub_1409BABB4(HANDLE FileHandle)
{
  ...
  *(_WORD *)&Buffer[9] = 286;
  ...
  sub_1406D6A74(0, (__int64)Buffer, 0LL, 192LL);
  ...
  if ( v9 >= 0 )
  {
    if ( byte_140C1BC29 )
    {
      if ( ::FileHandle == FileHandle )
      {
        ...
        if ( qword_140C1BC38 )
        {
          *(_OWORD *)qword_140C1BC38 = *(_OWORD *)Buffer;
