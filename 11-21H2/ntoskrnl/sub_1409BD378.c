/*
 * XREFs of sub_1409BD378 @ 0x1409BD378
 * Callers:
 ...
 *     sub_1409BD0C0 @ 0x1409BD0C0 (sub_1409BD0C0.c)
 */

__int64 __fastcall sub_1409BD378(__int64 a1, unsigned __int16 *a2, int a3, _BYTE *a4)
{
  int v4; // r15d
...
LABEL_90:
              ...
              case 191:
                goto LABEL_31;
              case 192:
                sub_1409BD0C0(a1, (__int64)v5, &v37, (unsigned int *)&v32, &v29, &v38);
                if ( (v29 | v38) == 0x80 && (unsigned int)sub_1409BCDDC(a1, v32, v9) )
                  goto LABEL_31;
                goto LABEL_89;
              case 255:
                if ( !v9 && v4 <= 1 )
...
LABEL_41:
          if ( (v18 & 0x80) != 0 )
          {
            ...
            if ( !v29 || v29 == 63 )
            {
              ...
              v31 = v29;
              v30 = v38;
              if ( ((v38 - 64) & 0xBF) == 0 && v19 == 0xC0 && (unsigned int)sub_1409BCDDC(a1, v32, v9) )
                goto LABEL_31;
              goto LABEL_64;
            }
            v22 = v38;
            if ( (v38 & 0xBF) != 0 )
            {
              ...
              {
                v25 = v34;
                if ( (unsigned int)sub_1409BCDDC(a1, v34, v9) )
                  goto LABEL_31;
                v23 = v30;
              }
...
LABEL_64:
              ...
              {
LABEL_61:
                v26 = sub_1409BCF8C(a1, &v36, &v33, v25, v9);
                goto LABEL_62;
              }
              v26 = sub_1409BCF40(a1, &v33, v25, v9);
LABEL_62:
              if ( !v26 )
                goto LABEL_63;
LABEL_31:
            ...
            if ( v38 == 64 )
            {
              if ( (unsigned int)sub_1409BCDDC(a1, v32, v9) )
                goto LABEL_31;
              v27 = v34;
            }
            if ( v21 <= v20 )
...
LABEL_81:
            ...
            {
LABEL_76:
              v28 = sub_1409BCF8C(a1, &v36, &v33, v27, v9);
              goto LABEL_80;
            }
            v28 = sub_1409BCF40(a1, &v33, v27, v9);
LABEL_80:
            if ( v28 )
              goto LABEL_31;
            goto LABEL_81;
...
LABEL_89:
        ...
        if ( v9 >= 44032 )
          break;
        if ( v4 > 1 && sub_1405ECF9C((unsigned int)v9, v5[1]) )
          goto LABEL_31;
...
LABEL_24:
    ...
    if ( *(_BYTE *)(a1 + 112) == 1 || v4 > 1 && sub_1405ECF9C((unsigned int)v9, v5[1]) )
      goto LABEL_31;
LABEL_91:
    v29 = 0;
    v38 = 0;
