/*
 * XREFs of RtlpFlsSetValueSlot @ 0x14069437C
 * Callers:
 *     RtlpFlsSetValue @ 0x1406942E8 (RtlpFlsSetValue.c)
 * Callees:
 *     ?SetValue@?$RTL_BINARY_ARRAY@URTLP_FLS_SLOT@@$03$03@@SAJPEAU1@KURTLP_FLS_SLOT@@K@Z @ 0x14021BB70 (-SetValue@-$RTL_BINARY_ARRAY@URTLP_FLS_SLOT@@$03$03@@SAJPEAU1@KURTLP_FLS_SLOT@@K@Z.c)
...
__int64 __fastcall RtlpFlsSetValueSlot(__int64 a1, __int64 a2, unsigned int a3, __int64 a4)
{
  ...
  *(_QWORD *)&v20[16] = &v20[8];
  *(_QWORD *)&v20[8] = &v20[8];
  v8 = *(&PspTlsContext + (unsigned int)(v7 - 4) + 1);
  if ( v8 )
  ...
  *(_OWORD *)&v20[8] = 0LL;
  ...
  result = RTL_BINARY_ARRAY<RTLP_FLS_SLOT,4,4>::SetValue(v5, v4, (__int64)&v21);
  if ( (int)result >= 0 )
  {
