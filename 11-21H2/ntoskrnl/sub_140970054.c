/*
 * XREFs of sub_140970054 @ 0x140970054
 * Callers:
...
_QWORD *__fastcall sub_140970054(__int64 a1, __int64 a2, _QWORD *a3, unsigned int *a4)
{
  unsigned int v4; // eax
  __int64 v5; // r11
  ...
  *a4 = v6;
  *a3 = v5;
  result = sub_1402828F0(64, 8 * v5, 0x3146694Du);
  v19 = result;
  if ( result )
  {
    v20 = 0LL;
