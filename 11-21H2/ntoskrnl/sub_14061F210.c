/*
 * XREFs of sub_14061F210 @ 0x14061F210
 * Callers:
 *     <none>
 * Callees:
...
NTSTATUS __fastcall sub_14061F210(
        PHANDLE TmHandle,
...
LABEL_12:
  *(_QWORD *)&v22 = v16;
LABEL_13:
  *((_QWORD *)&v22 + 1) = __PAIR64__(CreateOptions, CommitStrength);
  *((_QWORD *)&v24 + 1) = TmHandle;
  LODWORD(v24) = DesiredAccess;
  *((_QWORD *)&v23 + 1) = ObjectAttributes;
  *(_QWORD *)&v23 = LogFileName;
...
LABEL_18:
  result = ZwCreateTransactionManager(
             TmHandle,
             DesiredAccess,
             ObjectAttributes,
             LogFileName,
