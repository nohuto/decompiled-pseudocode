/*
 * XREFs of sub_1405FDAE4 @ 0x1405FDAE4
 * Callers:
...
NTSTATUS sub_1405FDAE4()
{
  ...
  *(&ObjectAttributes.Length + 1) = 0;
  ...
  if ( (dword_140C1AA7C & 0x20) != 0 )
  {
    v0 = dword_140C1AA7C & 0xFFFFFFCF;
  }
  else if ( (dword_140C1AA7C & 0x400) != 0 )
  {
    v0 = dword_140C1AA7C & 0xFFFFFBC7;
  }
  else
  {
    v0 = dword_140C1AA7C & 0xFFFFFFE7;
  }
  Data = v0;
  v1 = (UNICODE_STRING *)&unk_140C03658;
  ...
  *(_OWORD *)&ObjectAttributes.SecurityDescriptor = 0LL;
  ...
  else
  {
    ...
    if ( (int)(v4 + 0x80000000) >= 0 && v4 != -1073741772 )
      sub_1405FDF9C("Driver Verifier: Failed to delete VerifyDriverLevel key value with status: 0x%x\n", v4);
    ...
    if ( ((v5 + 0x80000000) & 0x80000000) == 0 && v5 != -1073741772 )
      sub_1405FDF9C("Driver Verifier: Failed to delete RuleClasses key value with status: 0x%x\n", v5);
    ...
    if ( ((v6 + 0x80000000) & 0x80000000) == 0 && v6 != -1073741772 )
      sub_1405FDF9C("Driver Verifier: Failed to delete VerifyDrivers key value with status: 0x%x\n", v6);
    ...
    if ( ((v7 + 0x80000000) & 0x80000000) == 0 && v7 != -1073741772 )
      sub_1405FDF9C("Driver Verifier: Failed to delete VerifierRandomTargets key value with status: 0x%x\n", v7);
    if ( dword_140C1AA88 )
    {
      ...
      if ( ((v8 + 0x80000000) & 0x80000000) == 0 && v8 != -1073741772 )
        sub_1405FDF9C("Driver Verifier: Failed to delete XdvVerifierOptions key value with status: 0x%x\n", v8);
    }
    ...
    if ( ((v9 + 0x80000000) & 0x80000000) == 0 && v9 != -1073741772 )
      sub_1405FDF9C("Driver Verifier: Failed to delete VrfPersistThroughUpgrade key value with status: 0x%x\n", v9);
    ...
    if ( ((v10 + 0x80000000) & 0x80000000) == 0 && v10 != -1073741772 )
      sub_1405FDF9C("Driver Verifier: Failed to delete VerifierTriageContext key value with status: 0x%x\n", v10);
    if ( dword_140D68154 != -1 )
    {
      ...
      if ( ((v11 + 0x80000000) & 0x80000000) == 0 && v11 != -1073741772 )
        sub_1405FDF9C("Driver Verifier: Failed to delete VerifyDriversSuppress key value with status: 0x%x\n", v11);
    }
    ...
    if ( ((v12 + 0x80000000) & 0x80000000) == 0 && v12 != -1073741772 )
      sub_1405FDF9C("Driver Verifier: Failed to delete VerifierTipLimitNumerator key value with status: 0x%x\n", v12);
    ...
    if ( ((v13 + 0x80000000) & 0x80000000) == 0 && v13 != -1073741772 )
      sub_1405FDF9C("Driver Verifier: Failed to delete VerifierTipLimitDenominator key value with status: 0x%x\n", v13);
    ...
    if ( ((v14 + 0x80000000) & 0x80000000) == 0 && v14 != -1073741772 )
      sub_1405FDF9C("Driver Verifier: Failed to delete VerifierTipSparseness key value with status: 0x%x\n", v14);
    ...
    if ( ((v15 + 0x80000000) & 0x80000000) == 0 && v15 != -1073741772 )
      sub_1405FDF9C("Driver Verifier: Failed to delete VerifierLwspPoolTags key value with status: 0x%x\n", v15);
    ZwFlushKey(KeyHandle);
    if ( dword_140C1AA78 )
      sub_1405FDF9C("Driver Verifier: Clearing Verifier options from Registry for preventing recursive crash.\n");
  }
