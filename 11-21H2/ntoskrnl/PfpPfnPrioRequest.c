/*
 * XREFs of PfpPfnPrioRequest @ 0x140739F40
 * Callers:
      ...
      if ( v10 < v11 )
      {
        while ( 1 )
        {
          ...
          if ( !(unsigned int)MiIsPfn(v13) )
            break;
          MiIdentifyPfnWrapper(48 * v13 - 0x220000000000LL, (__int64)v10);
          v10 += 24;
          if ( v10 >= v11 )
            goto LABEL_7;
        }
...
LABEL_7:
  ...
  v9 = PfpCopyUserPfnPrioRequest(*(_QWORD *)(a1 + 16), v19, v7, &Src, a2, 0);
  if ( v9 >= 0 )
  {
    v20 = *(_DWORD *)(a1 + 8);
    if ( v20 == 7 )
    ...
    v6 = Src;
    v22 = MmSetPfnListInfo(*((_QWORD *)Src + 1), (unsigned __int64)Src + 192, v21);
LABEL_31:
    v9 = v22;
