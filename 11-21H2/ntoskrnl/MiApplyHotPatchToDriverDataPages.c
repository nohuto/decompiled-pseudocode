/*
 * XREFs of MiApplyHotPatchToDriverDataPages @ 0x140971708
 * Callers:
 ...
 *     RtlFindNextForwardRunSetEx @ 0x1405E5C54 (RtlFindNextForwardRunSetEx.c)
...
__int64 __fastcall MiApplyHotPatchToDriverDataPages(__int64 a1)
{
  ...
  for ( i = 0LL; ; i = v6 )
  {
    NextForwardRunSet = RtlFindNextForwardRunSetEx(*(_QWORD *)(a1 + 8) + 64LL, i, &v19);
