/*
 * XREFs of sub_140AA03C0 @ 0x140AA03C0
 * Callers:
 *     <none>
 * Callees:
...
char __fastcall sub_140AA03C0(ULONG_PTR BugCheckParameter2, __int64 a2)
{
  ...
  if ( CurrentIrql > 2u && (dword_140C29FC0 & 1) != 0 )
    sub_140A8C924(0xC4u, 0x71uLL, CurrentIrql, BugCheckParameter2, a2);
  v5 = 2071;
