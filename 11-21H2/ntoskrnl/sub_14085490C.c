/*
 * XREFs of sub_14085490C @ 0x14085490C
 * Callers:
...
char __fastcall sub_14085490C(char a1, __int64 a2, __int64 a3, char a4, __int64 a5, int a6, int a7, char a8)
{
  _UNKNOWN **v8; // rax
  ...
  if ( byte_140C5AE30 )
  {
    ...
    if ( a8 )
      v11 = &stru_140037C28;
    LOBYTE(v8) = EtwEventEnabled(qword_140C1F580, v11);
    if ( (_BYTE)v8 )
    {
      v17 = a2;
      UserData.Size = 1;
      ...
      if ( !a8 )
        v13 = &stru_140012E88;
      LOBYTE(v8) = EtwWrite(qword_140C1F580, v13, 0LL, 7u, &UserData);
    }
  }
  return (char)v8;
}
