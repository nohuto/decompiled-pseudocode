/*
 * XREFs of sub_1408545B0 @ 0x1408545B0
 * Callers:
 *     <none>
 * Callees:
...
void __fastcall sub_1408545B0(__int64 a1, __int64 a2)
{
  size_t v2; // rsi
  const void *v3; // r12
  char v5; // r15
  ...
  v17 = 0;
  P = 0LL;
  v6 = sub_14085464C(v14, &v17, &P);
  if ( v6 >= 0 )
  {
    CurrentThread = KeGetCurrentThread();
    --*((_WORD *)CurrentThread + 242);
    v5 = 1;
    ExAcquireResourceExclusiveLite(&stru_140CF6650, 1u);
    v6 = sub_140882B96(&v19, &v20, v14, 0LL);
    if ( v6 < 0 )
    {
      if ( !v17 )
        goto LABEL_2;
      ...
      if ( Pool2 )
      {
        ...
        if ( v13 )
        {
          ...
          *((_WORD *)Pool2 + 4) = v2;
          memmove(v13, v3, v2);
          Pool2[3] = P;
          *Pool2 = qword_140D04998;
          P = 0LL;
          qword_140D04998 = (__int64)Pool2;
          goto LABEL_2;
        }
