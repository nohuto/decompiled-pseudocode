/*
 * XREFs of sub_1405F1474 @ 0x1405F1474
 * Callers:
...
__int64 __fastcall sub_1405F1474(
        _DWORD *a1,
        unsigned int a2,
        unsigned __int8 *a3,
        int a4,
...
LABEL_7:
  ...
  if ( (unsigned int)sub_14021B6C0(v11, (__int64)v9) )
    return 3221226050LL;
  v13 = (_DWORD *)v51;
  v15 = 16LL;
  v16 = (_DWORD *)v51;
  ...
  if ( v12 < v16 - 47 )
  {
    v22 = (unsigned __int64)v12 + v8;
    if ( v21 < v22 )
      v22 = (unsigned __int64)(v16 - 47);
    while ( 1 )
    {
...
LABEL_76:
          ...
          v22 = sub_14038CF50((__int64)v53, v21, (__int64)v12);
        }
        if ( (unsigned __int64)(v9 + 1) >= v14 )
          return 3221226050LL;
