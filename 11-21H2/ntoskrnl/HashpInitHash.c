/*
 * XREFs of HashpInitHash @ 0x140A3792C
 * Callers:
 *     HashpHashMemory @ 0x140A3731C (HashpHashMemory.c)
 * Callees:
 *     SymCryptSha256Init @ 0x1403FCBE0 (SymCryptSha256Init.c)
 *     SymCryptSha384Init @ 0x140401DF0 (SymCryptSha384Init.c)
 *     SymCryptSha512Init @ 0x1404035E0 (SymCryptSha512Init.c)
 *     SymCryptSha1Init @ 0x140404950 (SymCryptSha1Init.c)
 *     SymCryptMd5Init @ 0x140405370 (SymCryptMd5Init.c)
 */
