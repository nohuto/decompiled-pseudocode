/*
 * XREFs of sub_140503808 @ 0x140503808
 * Callers:
...
__int64 __fastcall sub_140503808(__int64 a1, __int64 a2, unsigned int a3, unsigned int *a4)
{
  int v4; // r14d
  ULONG v5; // ebx
  unsigned int v6; // esi
  ...
  do
  {
    ...
    if ( v4 == -1 )
      v4 = ClearBitsAndSet;
    v13 = sub_14045764A(a2, ClearBitsAndSet, 0LL);
