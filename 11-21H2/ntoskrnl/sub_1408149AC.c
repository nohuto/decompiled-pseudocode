/*
 * XREFs of sub_1408149AC @ 0x1408149AC
 * Callers:
...
__int64 __fastcall sub_1408149AC(__int64 a1, __int64 a2, __int16 a3, __int64 a4)
{
  char v8; // r8
  ...
  __int64 v20[52]; // [rsp+C0h] [rbp-40h] BYREF
  ...
  *(_OWORD *)v17 = 0LL;
  ...
  sub_14070B610(
    ...
    v12,
    &P);
  sub_1402AB170((__int64)v21, *(_QWORD *)(a2 + 1096), *(_DWORD *)a2, v10, a3, 5249029 - (a3 != 807));
  if ( v14 != *(PVOID *)(a4 + 16) )
