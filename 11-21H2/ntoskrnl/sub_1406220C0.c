/*
 * XREFs of sub_1406220C0 @ 0x1406220C0
 * Callers:
 *     <none>
 * Callees:
...
NTSTATUS __fastcall sub_1406220C0(PHANDLE KeyHandle, ACCESS_MASK DesiredAccess, POBJECT_ATTRIBUTES ObjectAttributes)
{
  __int64 v6; // rdx
  __int64 v7; // rcx
  __int64 *v8; // rdi
