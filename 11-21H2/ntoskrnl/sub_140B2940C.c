/*
 * XREFs of sub_140B2940C @ 0x140B2940C
 * Callers:
...
__int64 sub_140B2940C()
{
  ...
  *(_DWORD *)IdentifierAuthority.Value = 0;
  ...
  Pool2 = (_DWORD *)ExAllocatePool2(256LL, v1, 0x20206F49u);
  v3 = Pool2;
  if ( Pool2 )
  {
    ...
    if ( Acl >= 0 )
    {
      ...
      v6 = (ACL *)ExAllocatePool2(256LL, v5, 0x20206F49u);
      v7 = v6;
      if ( v6 )
      {
            ...
            if ( Acl >= 0 )
            {
              ...
              if ( Acl >= 0 )
              {
                ...
                if ( Acl >= 0 )
                {
                  ...
                  v16 = 528;
                  Acl = sub_1406C2A50((__int64)&Handle);
                  if ( Acl >= 0 )
