/*
 * XREFs of SaveNodeDistanceInformation @ 0x140B063D4
 * Callers:
...
LABEL_85:
          ...
          while ( 1 )
          {
            if ( *(_WORD *)KeNodeBlock[v57] == *(_WORD *)(KeNodeBlock[v57] + 2) && v55 != v57 )
            {
          ...
          do
          {
            ...
            if ( *(_WORD *)*v63 != (_WORD)v66 )
              v65 = (unsigned __int16 *)KeNodeBlock[v66];
            v67 = v64;
            v68 = v61 * v62;
            v69 = KeNodeBlock;
            do
            {
              ...
              if ( v70 != (_WORD)v71 )
                v70 = *(_WORD *)KeNodeBlock[v71];
              v72 = *v65;
              if ( (_WORD)v72 == v70 )
                *((_DWORD *)KeNodeDistance + v68) = 0;
              else
                *((_DWORD *)KeNodeDistance + v68) = v10[(unsigned int)v70 + (_DWORD)v0 * v72];
