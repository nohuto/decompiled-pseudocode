/*
 * XREFs of HalpReportResourceUsage @ 0x140AF77F8
 * Callers:
 ...
 *     HalpClaimDebugResource @ 0x14050BC6C (HalpClaimDebugResource.c)
 *     ExFreePoolWithTag @ 0x140A6E010 (ExFreePoolWithTag.c)
 *     ExAllocatePool2 @ 0x140A6E430 (ExAllocatePool2.c)
 *     IoReportHalResourceUsage @ 0x140AF7620 (IoReportHalResourceUsage.c)
 *     HalpGetResourceSortValue @ 0x140AF7D88 (HalpGetResourceSortValue.c)
 */

void __fastcall HalpReportResourceUsage(UNICODE_STRING *a1)
{
  __int64 v1; // r11
  unsigned int *v2; // rsi
  char *v3; // rax
...
LABEL_12:
    ...
    while ( 1 )
    {
      while ( v12 <= 0xFF )
      {
        if ( ((unsigned __int8)v14 & (unsigned __int8)HalpIDTUsageFlags[v12]) == 0 )
        {
          ++v12;
          goto LABEL_12;
        }
        ...
        KiCopyAffinityEx((__int64)v66, 0x20u, (unsigned __int16 *)KeActiveProcessors);
        *(_DWORD *)&Descriptor_8.Type = 66050;
        if ( (HalpIDTUsageFlags[v48] & 2) == 0 )
          Descriptor_8.Flags = 0;
        Descriptor_8.u.Generic.Start.HighPart = *(_DWORD *)&HalpIDTUsage[5 * v48 + 1];
        ...
        v16 = (unsigned __int8)HalpIDTUsage[5 * v48];
        v17 = HIDWORD(v66[1]);
        v18 = HIDWORD(v66[1]);
...
LABEL_41:
    ...
    while ( 1 )
    {
      HalpGetResourceSortValue(v28, &Descriptor_4, &v55);
      v30 = HIDWORD(v55);
      v31 = v29;
      v32 = Descriptor_4;
      v34 = v31 - v33;
      ...
      do
      {
        HalpGetResourceSortValue(v36, &v53, &v56);
        if ( v53 >= v32 )
        {
          if ( v53 != v32 )
            goto LABEL_49;
...
LABEL_48:
        ...
        *(_OWORD *)v37 = v44;
        *((_DWORD *)v37 + 4) = v43;
        HalpGetResourceSortValue(v38, &Descriptor_4, &v55);
        v30 = HIDWORD(v55);
        v32 = Descriptor_4;
LABEL_49:
