/*
 * XREFs of sub_140616FD0 @ 0x140616FD0
 * Callers:
 *     <none>
 * Callees:
...
__int64 *__fastcall sub_140616FD0(ULONG_PTR BugCheckParameter2)
{
  __int64 v2; // rdx
  __int64 v3; // rcx
  __int64 *v4; // rbx
...
LABEL_18:
  result = (__int64 *)sub_140221A30(BugCheckParameter2, 0);
  if ( v4 )
  {
    v12 = v4 + 6;
    for ( j = (__int64 *)v4[6]; j != v12; j = (__int64 *)*j )
    {
      result = j - 2;
      if ( j != (__int64 *)16 )
        result = (__int64 *)sub_14042A5E0(&v14, v11);
    }
  }
  return result;
}
