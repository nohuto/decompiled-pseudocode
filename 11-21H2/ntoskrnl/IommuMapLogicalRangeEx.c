/*
 * XREFs of IommuMapLogicalRangeEx @ 0x1405286D0
 * Callers:
 *     <none>
 * Callees:
 ...
 *     HalpIommuDomainMapLogical @ 0x14051ABD8 (HalpIommuDomainMapLogical.c)
...
__int64 __fastcall IommuMapLogicalRangeEx(ULONG_PTR a1, int a2, int a3, _QWORD *a4, __int64 a5, __int64 a6, _QWORD *a7)
{
  bool v10; // zf
