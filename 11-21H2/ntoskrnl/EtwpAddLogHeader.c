/*
 * XREFs of EtwpAddLogHeader @ 0x1406F120C
 * Callers:
 ...
 *     EtwpIsWow64Logger @ 0x1406F175C (EtwpIsWow64Logger.c)
...
unsigned __int64 __fastcall EtwpAddLogHeader(__int64 a1, unsigned int *a2)
{
  ...
  {
    if ( ((int (__fastcall *)(__int64, __int64, __int64 *, int *))off_140C020D8[0])(25LL, 12LL, &v35, &v33) < 0 )
    {
      v35 = 0LL;
      v36 = 0;
    }
    ...
    *((_BYTE *)a2 + 111) = v11;
    ...
    v19 = &a2[v18];
    RtlpQueryTimeZoneInformationWorker(&a2[v18 + 18], 0xACuLL);
    v20 = *(_QWORD *)(v19 + 35);
