/*
 * XREFs of MinAsn1ParseAndDecodeRDNComponent @ 0x140A32B9C
 * Callers:
...
char __fastcall MinAsn1ParseAndDecodeRDNComponent(unsigned int *a1, __int64 a2, _BYTE *a3, __int64 a4)
{
  ...
  if ( (int)MinAsn1ExtractContent(v6, v4, &v13, &v14) > 0 )
  {
    ...
    {
      v9 = v14;
      while ( (int)MinAsn1ExtractValues(v9, v8, (unsigned int)&v15, (unsigned int)&qword_14000AF30, 4, (__int64)v16) > 0 )
      {
        if ( v18 == 3 )
        {
          v10 = *v19 - 1109;
