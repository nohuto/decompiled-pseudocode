/*
 * XREFs of sub_1402419DC @ 0x1402419DC
 * Callers:
 *     sub_1402A1AEC @ 0x1402A1AEC (sub_1402A1AEC.c)
 * Callees:
 *     sub_140241C0C @ 0x140241C0C (sub_140241C0C.c)
 *     memmove @ 0x140435B40 (memmove.c)
 *     memset @ 0x140435E00 (memset.c)
 *     ExAllocatePoolWithTag @ 0x140A6E910 (ExAllocatePoolWithTag.c)
 */

__int64 __fastcall sub_1402419DC(
        char a1,
        __int128 *a2,
        unsigned __int8 a3,
        __int64 a4,
        ...
        __int64 *a7)
{
  ...
  *a7 = 0LL;
  ...
  if ( a5 != -2 )
  {
    do
    {
      if ( v7 < 2u )
      {
        *(_OWORD *)(v20 + 16LL * v7) = *(_OWORD *)(a4 + 16LL * v7);
      }
      else
      {
        v22 = (void *)sub_140241C0C(v35, *(unsigned int *)(a4 + 16LL * v7 + 8));
        memmove(v22, *(const void **)(a4 + 16LL * v7), v21);
        *(_QWORD *)(v20 + 16LL * v7) = v22;
        *(_DWORD *)(v20 + 16LL * v7 + 12) = *(_DWORD *)(a4 + 16LL * v7 + 12);
        *(_DWORD *)(v20 + 16LL * v7 + 8) = *(_DWORD *)(a4 + 16LL * v7 + 8);
      }
      ++v7;
    }
    while ( v7 < (unsigned int)a5 + 2 );
  }
  v24 = sub_140241C0C(v35, 46LL);
  *(_QWORD *)(v24 + 16) = v20;
  v25 = *a2;
  *(_BYTE *)(v24 + 45) = a5;
  v26 = a5 + 2;
  ...
  *(_OWORD *)v24 = v25;
  if ( (unsigned __int8)(a5 + 2) < (unsigned __int8)v8 )
  {
    ...
    do
    {
      v31 = (void *)sub_140241C0C(v35, *(unsigned int *)v27);
