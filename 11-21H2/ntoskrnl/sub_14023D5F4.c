/*
 * XREFs of sub_14023D5F4 @ 0x14023D5F4
 * Callers:
...
unsigned __int64 __fastcall sub_14023D5F4(__int64 a1, unsigned __int16 a2, unsigned __int16 a3, unsigned __int64 *a4)
{
...
LABEL_15:
  if ( i )
  {
    if ( (unsigned __int16)v6 > 1u )
    {
      ...
      *a4 = sub_140362978(v13 + 16, v16 + v14 - (v15 & (v16 + v14 - 1)) - 1);
    }
    else
    {
      *a4 = i;
