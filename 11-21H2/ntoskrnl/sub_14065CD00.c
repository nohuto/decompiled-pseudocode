/*
 * XREFs of sub_14065CD00 @ 0x14065CD00
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall sub_14065CD00(HANDLE Handle, int a2)
{
  NTSTATUS v4; // eax
  PVOID v5; // rdi
  int v6; // ebx
  ...
  if ( (unsigned __int8)sub_140AB46D0() )
  {
    ...
    {
      Object = 0LL;
      v4 = ObReferenceObjectByHandle(Handle, 8u, qword_140C490F0, *((_BYTE *)KeGetCurrentThread() + 562), &Object, 0LL);
      v5 = Object;
      v6 = v4;
      if ( v4 >= 0 )
      {
