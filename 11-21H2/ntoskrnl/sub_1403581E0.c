/*
 * XREFs of sub_1403581E0 @ 0x1403581E0
 * Callers:
...
__int64 __fastcall sub_1403581E0(__int64 a1)
{
...
LABEL_14:
          ...
          v4 = v12 + 1;
          v19 = 512LL;
          v20 = (_BYTE *)(*(_QWORD *)(a1 + 15856) + (v12 << 9));
          do
          {
            if ( *v20 == 32 )
              sub_140358400(a1, v16, 2LL);
            v16 += 512LL;
            ++v20;
            --v19;
          }
  ...
  result = (unsigned int)_InterlockedExchange((volatile __int32 *)(a1 + 15888), 0);
  if ( (_DWORD)result )
  {
    v22 = *(_WORD **)(a1 + 15880);
    for ( i = v2 >> 18; i; --i )
    {
      if ( *v22 == 512 )
        result = sub_140358400(a1, v3, 1LL);
      ++v22;
      v3 += 0x40000LL;
    }
  }
