/*
 * XREFs of MiZeroLargePages @ 0x1402C41D0
 * Callers:
...
struct _KTHREAD *__fastcall MiZeroLargePages(unsigned __int64 a1)
{
  __int64 v2; // rsi
  __int64 v3; // r14
  int v4; // eax
  ...
  *((_DWORD *)&CurrentThread[1].SwapListEntry + 3) |= 0x400u;
  ...
  v3 = *(_QWORD *)(v2 + 72);
  v78 = v3;
  v4 = MiSetZeroPageThreadPriority(a1);
  ...
  if ( !(unsigned int)MiReadyToZeroNextLargePage(a1, &v81) )
  {
LABEL_148:
    ++dword_140C29708;
    goto LABEL_149;
  ...
  while ( 2 )
  {
    ...
    if ( !v6 )
    {
      HugePageToZero = MiGetHugePageToZero(v3, a1);
      goto LABEL_9;
    }
    ...
    *(_BYTE *)(a1 + 70) = 0;
    if ( v6 < 3 )
    {
      v11 = MiUnlinkNodeLargePages(v3, 0, v6, 1, v10, 4, 1, 256, a1);
      if ( v11 )
        goto LABEL_8;
      break;
    }
...
LABEL_23:
    ...
    *(_WORD *)(a1 + 70) = 0;
    ...
    {
      LOBYTE(v34) = -1;
      ExpAcquireSpinLockExclusiveAtDpcLevelInstrumented(v33, v34);
    }
    else
    {
      ...
      if ( _interlockedbittestandset(v33, 0x1Fu) )
      {
        ...
        v82 = ExpWaitForSpinLockExclusiveAndAcquire(v33, 0xFFu);
      }
    ...
    *(_QWORD *)(a1 + 16) = v42;
    if ( v42 )
    {
      ...
      *(_QWORD *)(v42 + 8LL * v43) = a1;
      ...
      {
        v56 = RtlpTreeDoubleRotateNodes(&qword_140C51DF8, v42, v44, v43);
        *(_BYTE *)(v57 + 16) &= 0xFCu;
...
LABEL_131:
    ...
    v3 = v78;
LABEL_8:
    HugePageToZero = MiMapPagesToZero(a1, v11, v6);
    v7 = v76;
LABEL_9:
    if ( HugePageToZero )
    {
      ...
      if ( *v7 >= 0x1000u )
      {
        ...
        MiReassessZeroThreads(a1, v69.QuadPart - PerformanceCounter.QuadPart);
        _InterlockedExchange(v7, 0);
        PerformanceCounter = KeQueryPerformanceCounter(0LL);
        _InterlockedOr(v71, 0);
      }
...
LABEL_149:
  MiSetZeroPageThreadPriority(a1);
