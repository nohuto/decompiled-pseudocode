/*
 * XREFs of MiReplenishBitMap @ 0x1402697F0
 * Callers:
    ...
    do
    {
      ...
      else
      {
          ...
          && ((v17 & 0x20) == 0 || (v17 & 0x42) == 0) )
        {
          ...
          if ( v19 )
          {
            v20 = *((_QWORD *)&v19->Flink + ((v18 >> 3) & 0x1FF));
            v21 = v17 | 0x20;
            if ( (v20 & 0x20) == 0 )
              v21 = v17;
            v17 = v21;
...
LABEL_79:
        ...
        if ( !v6 )
        {
          MiInsertTbFlushEntry(v68, (__int64)(v12 << 25) >> 16, v9, 0LL);
          if ( (unsigned int)MiFlushTbListEarly(v68, 1LL) )
          {
            _InterlockedOr(v61, 0);
...
LABEL_125:
                      if ( v58 && (unsigned int)RtlInterlockedSetClearRunEx(v5, v50 + v51, v47) )
                        MiReturnSystemPtes(v5, v50 + v51, v47, 0LL);
                      goto LABEL_128;
                    }
                    if ( (v55 & (-1LL << v53)) == 0 )
                    {
