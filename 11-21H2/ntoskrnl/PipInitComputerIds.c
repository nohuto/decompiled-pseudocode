/*
 * XREFs of PipInitComputerIds @ 0x140B0F20C
 * Callers:
 ...
 *     PipSmBiosFindStruct @ 0x140B1041C (PipSmBiosFindStruct.c)
 */
...
LABEL_155:
        ...
        v19 = (unsigned __int8 *)Struct;
        if ( Struct )
        {
          v20 = (_BYTE *)(Struct + 5);
          if ( Struct + 5 <= Struct + (unsigned __int64)*(unsigned __int8 *)(Struct + 1) )
          {
            LOBYTE(v17) = *(_BYTE *)(Struct + 4);
            String = PipSmBiosGetString(Struct, v17, v15, v12, UnicodeString);
            v7 = String;
          ...
          {
            LOBYTE(v17) = v19[26];
            v22 = PipSmBiosGetString(v19, v17, v15, v12, &UnicodeString[1]);
            v7 = v22;
            if ( v22 == -1073741275 )
            {
              v7 = 0;
          ...
          {
            LOBYTE(v17) = *v20;
            v23 = PipSmBiosGetString(v19, v17, v15, v12, &UnicodeString[2]);
            v9 = 0;
            v7 = v23;
            if ( v23 == -1073741275 )
            {
          ...
          {
            LOBYTE(v17) = v19[25];
            v24 = PipSmBiosGetString(v19, v17, v15, v12, &UnicodeString[3]);
            v7 = v24;
            if ( v24 == -1073741275 )
            {
              v7 = 0;
          ...
          {
            LOBYTE(v17) = v19[6];
            v25 = PipSmBiosGetString(v19, v17, v15, v12, &UnicodeString[9]);
            v7 = v25;
            if ( v25 == -1073741275 )
            {
              v7 = 0;
        ...
        LOBYTE(v17) = 10;
        LOBYTE(v18) = 2;
        v26 = PipSmBiosFindStruct(v18, v17, v15, v12);
        v28 = v26;
        if ( v26 )
        {
          v29 = (_BYTE *)(v26 + 5);
          if ( v26 + 5 <= v26 + (unsigned __int64)*(unsigned __int8 *)(v26 + 1) )
          {
            ...
            v30 = PipSmBiosGetString(v26, v27, v15, v12, &UnicodeString[6]);
            v7 = v30;
            if ( v30 == -1073741275 )
            {
              v7 = 0;
          ...
          {
            LOBYTE(v27) = *v29;
            v31 = PipSmBiosGetString(v28, v27, v15, v12, &UnicodeString[7]);
            v9 = 0;
            v7 = v31;
            if ( v31 == -1073741275 )
            {
        ...
        v32 = PipSmBiosFindStruct(0LL, 0LL, v15, v12);
        ...
        if ( v32 + 5 <= v32 + (unsigned __int64)*(unsigned __int8 *)(v32 + 1) )
        {
          ...
          v37 = PipSmBiosGetString(v32, v33, v15, v12, &UnicodeString[4]);
          v7 = v37;
          if ( v37 == -1073741275 )
          {
            v7 = 0;
        ...
        LOBYTE(v33) = *v36;
        v38 = PipSmBiosGetString(v35, v33, v15, v12, &UnicodeString[5]);
        v9 = 0;
        v7 = v38;
        if ( v38 == -1073741275 )
        {
...
LABEL_37:
          if ( v35 + 9 > &v35[v35[1]] )
            goto LABEL_40;
          LOBYTE(v33) = v35[8];
          v39 = PipSmBiosGetString(v35, v33, v15, v12, &UnicodeString[8]);
          v7 = v39;
          if ( v39 == -1073741275 )
          {
            v7 = 0;
...
LABEL_44:
            LOBYTE(v34) = 3;
            v41 = PipSmBiosFindStruct(v34, 0LL, v15, v12);
            ...
            do
            {
              ...
              if ( v45->Length )
              {
                if ( (int)PnpUnicodeStringToWstr((__int16 **)&v112, 0LL, &UnicodeString[v44].Length) >= 0 )
                {
                  v47 = v112;
                  v48 = -1LL;
                  do
              ...
              if ( Pool2 )
              {
                ...
                if ( v51 )
                {
                  while ( 1 )
                  {
                    ...
                    if ( v7 < 0 )
                      goto LABEL_138;
                    v7 = RtlStringFromGUIDEx(&v122[4 * v88], (__int64)&ValueName_8, 0);
                    if ( v7 < 0 )
                      goto LABEL_138;
...
LABEL_138:
            ...
            if ( UnicodeString[2].Buffer && UnicodeString[4].Buffer && UnicodeString[5].Buffer )
            {
              ...
              if ( UnicodeString[3].Buffer )
              {
                ...
                *((_QWORD *)&v117 + 1) = &UnicodeString[1];
                ...
                v7 = PipCreateComputerId(v50, v52, &v117, 7LL, v122);
                v51 = 1;
                if ( v7 < 0 )
                  goto LABEL_139;
              }
              ...
              *((_QWORD *)&v119 + 1) = &DestinationString;
              v56 = PipCreateComputerId(v50, v52, &v117, 6LL, &v122[4 * v51]);
              v57 = v51 + 1;
              v7 = v56;
              if ( v56 < 0 )
                goto LABEL_139;
              ...
              *(_QWORD *)&v119 = &DestinationString;
              v58 = PipCreateComputerId(v50, v52, &v117, 5LL, &v122[4 * v57]);
              v51 = v57 + 1;
              v7 = v58;
              if ( v58 < 0 )
                goto LABEL_139;
            ...
            if ( UnicodeString[2].Buffer )
            {
              if ( UnicodeString[3].Buffer )
              {
                if ( UnicodeString[6].Buffer )
                {
                  if ( UnicodeString[7].Buffer )
                  {
                    ...
                    *((_QWORD *)&v117 + 1) = &UnicodeString[1];
                    ...
                    while ( v63 );
                    v65 = PipCreateComputerId(v50, v52, &v117, 6LL, &v122[4 * v51++]);
                    v7 = v65;
                    if ( v65 < 0 )
                      goto LABEL_139;
                  }
                ...
                *((_QWORD *)&v117 + 1) = &UnicodeString[1];
                ...
                while ( v66 );
                v69 = PipCreateComputerId(v50, v52, &v117, 4LL, &v122[4 * v51++]);
                v7 = v69;
                if ( v69 < 0 )
                  goto LABEL_139;
              }
              ...
              *((_QWORD *)&v117 + 1) = &UnicodeString[1];
              *(_QWORD *)&v118 = &UnicodeString[2];
              v70 = PipCreateComputerId(v50, v52, &v117, 3LL, &v122[4 * v51++]);
              v7 = v70;
              if ( v70 < 0 )
                goto LABEL_139;
              Buffer = UnicodeString[0].Buffer;
            ...
            if ( UnicodeString[3].Buffer )
            {
              if ( UnicodeString[6].Buffer )
              {
                if ( UnicodeString[7].Buffer )
                {
                  ...
                  *((_QWORD *)&v117 + 1) = &UnicodeString[3];
                  ...
                  while ( v71 );
                  v74 = PipCreateComputerId(v50, v52, &v117, 4LL, &v122[4 * v51++]);
                  v7 = v74;
                  if ( v74 < 0 )
                    goto LABEL_139;
                }
              ...
              *(_QWORD *)&v117 = UnicodeString;
              *((_QWORD *)&v117 + 1) = &UnicodeString[3];
              v75 = PipCreateComputerId(v50, v52, &v117, 2LL, &v122[4 * v51++]);
              v7 = v75;
              if ( v75 < 0 )
                goto LABEL_139;
              Buffer = UnicodeString[0].Buffer;
            ...
            if ( UnicodeString[2].Buffer )
            {
              if ( UnicodeString[6].Buffer )
              {
                if ( UnicodeString[7].Buffer )
                {
                  ...
                  *((_QWORD *)&v118 + 1) = &UnicodeString[7];
                  v76 = PipCreateComputerId(v50, v52, &v117, 4LL, &v122[4 * v51++]);
                  v7 = v76;
                  if ( v76 < 0 )
                    goto LABEL_139;
                }
              ...
              *(_QWORD *)&v117 = UnicodeString;
              *((_QWORD *)&v117 + 1) = &UnicodeString[2];
              v77 = PipCreateComputerId(v50, v52, &v117, 2LL, &v122[4 * v51++]);
              v7 = v77;
              if ( v77 < 0 )
                goto LABEL_139;
              Buffer = UnicodeString[0].Buffer;
            ...
            if ( UnicodeString[1].Buffer )
            {
              if ( UnicodeString[7].Buffer )
              {
                if ( UnicodeString[6].Buffer )
                {
                  ...
                  *((_QWORD *)&v117 + 1) = &UnicodeString[1];
                  ...
                  while ( v99 );
                  v102 = PipCreateComputerId(v50, v52, &v117, 4LL, &v122[4 * v51++]);
                  v7 = v102;
                  if ( v102 < 0 )
                    goto LABEL_139;
                }
              ...
              *(_QWORD *)&v117 = UnicodeString;
              *((_QWORD *)&v117 + 1) = &UnicodeString[1];
              v103 = PipCreateComputerId(v50, v52, &v117, 2LL, &v122[4 * v51++]);
              v7 = v103;
              if ( v103 < 0 )
                goto LABEL_139;
              Buffer = UnicodeString[0].Buffer;
            ...
            if ( v109 )
            {
              ...
              if ( v7 < 0 )
                goto LABEL_139;
              RtlInitUnicodeString(&v116, &SourceString);
              *(_QWORD *)&v117 = UnicodeString;
              *((_QWORD *)&v117 + 1) = &v116;
              v78 = PipCreateComputerId(v50, 0LL, &v117, 2LL, &v122[4 * v51++]);
              v7 = v78;
              if ( v78 < 0 )
                goto LABEL_139;
              Buffer = UnicodeString[0].Buffer;
            ...
            *(_QWORD *)&v117 = UnicodeString;
            ...
            while ( v79 );
            v82 = PipCreateComputerId(v50, 0LL, &v117, 3LL, &v122[4 * v51++]);
            v7 = v82;
            if ( v82 >= 0 )
            {
LABEL_188:
              *(_QWORD *)&v117 = UnicodeString;
              v83 = PipCreateComputerId(v50, 0LL, &v117, 1LL, &v122[4 * v51++]);
              v7 = v83;
              if ( v83 >= 0 )
                goto LABEL_118;
            }
...
LABEL_140:
  ...
  if ( v97 )
    ZwClose(v97);
  if ( KeyHandle[0] )
    PnpCtxRegCloseKey(v96, KeyHandle[0]);
