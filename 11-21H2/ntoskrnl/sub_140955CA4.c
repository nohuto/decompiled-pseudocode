/*
 * XREFs of sub_140955CA4 @ 0x140955CA4
 * Callers:
...
__int64 __fastcall sub_140955CA4(unsigned __int64 a1, unsigned int a2, _DWORD *a3, unsigned int a4, int a5, _DWORD *a6)
{
  _DWORD *v6; // r13
  void *Pool2; // rdi
  int v10; // ebx
  ...
  *v6 = 0;
  ...
  Pool2 = 0LL;
  v21 = 0LL;
  v10 = sub_14078A1A8(a1, a2, a5, (__int64)&v20);
  if ( v10 < 0 )
    goto LABEL_43;
...
LABEL_39:
  ...
  LODWORD(a6) = v15;
  v16 = sub_14069726C(*(__int64 *)&qword_140D00AC0, v21, v11, 0LL, v19, 0, (__int64)Pool2, v15, (__int64)&a6);
  v14 = v16;
  if ( v16 >= 0 )
  {
    v17 = sub_14077C780(v16, 20 * (int)a6, 0, Pool2, 20 * (int)a6, v22, a3, a4, v6);
    goto LABEL_41;
  }
LABEL_40:
  v17 = sub_14077C780(v14, 20 * (int)a6, 0, 0LL, 0, v22, a3, a4, v6);
LABEL_41:
  v10 = v17;
  if ( Pool2 )
