/*
 * XREFs of sub_14072E5D0 @ 0x14072E5D0
 * Callers:
 ...
 * Callees:
 *     sub_1402A7BE0 @ 0x1402A7BE0 (sub_1402A7BE0.c)
 *     ExAllocatePoolWithTag @ 0x140A6E910 (ExAllocatePoolWithTag.c)
 */

__int64 __fastcall sub_14072E5D0(int *a1, char a2, __int64 a3, _WORD *a4, int a5, _QWORD *a6, _BYTE *a7)
{
  int v8; // ebp
  char v11; // r8
  int v12; // r10d
  ...
  v8 = *a1 & 0x20;
  v40 = 16;
  if ( sub_1402A7BE0((POBJECT_TYPE *)a3) )
  {
    v13 = 16;
    v11 |= 0x20u;
  }
  ...
  if ( *((PEPROCESS *)KeGetCurrentThread() + 23) == PsInitialSystemProcess
    || *((PVOID *)KeGetCurrentThread() + 23) == qword_140D06940
...
LABEL_16:
  ...
  if ( !v20 )
    v23 = 48;
  v24 = v40 + v14 + v15 + v13 + v12 + (v18 != 0 ? 0x10 : 0) + v23;
  v25 = v24 + v19 + v22;
  if ( v25 + a5 < v25 )
    return 3221225485LL;
  ...
  if ( v19 )
  {
    v35 = -(char)(v24 + (_BYTE)PoolWithTag) & 0x3F;
    if ( v35 )
    {
      PoolWithTag += v35;
      v27 = v38 | 0x80;
      *((_DWORD *)PoolWithTag - 1) = v35;
    }
  }
  if ( v40 )
  {
  ...
  if ( v20 )
  {
    ...
    *((_QWORD *)PoolWithTag + 2) = *(_QWORD *)(*((_QWORD *)KeGetCurrentThread() + 23) + 1088LL);
  ...
  *((_QWORD *)PoolWithTag + 2) = 0LL;
  PoolWithTag[24] = dword_140D06C0C ^ *(_BYTE *)(a3 + 40) ^ BYTE1(PoolWithTag);
  if ( !a2 )
  {
    v30 |= 2u;
    PoolWithTag[27] = v30;
  ...
  *((_QWORD *)PoolWithTag + 5) = 0LL;
  v32 = _InterlockedIncrement((volatile signed __int32 *)(a3 + 44));
  if ( v32 > *(_DWORD *)(a3 + 52) )
    *(_DWORD *)(a3 + 52) = v32;
  *a6 = PoolWithTag;
  return 0LL;
