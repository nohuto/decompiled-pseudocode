/*
 * XREFs of sub_140617ED0 @ 0x140617ED0
 * Callers:
 *     <none>
 * Callees:
...
NTSTATUS __fastcall sub_140617ED0(
        PHANDLE FileHandle,
...
LABEL_12:
  *(_QWORD *)&v22 = v16;
LABEL_13:
  *((_QWORD *)&v22 + 1) = __PAIR64__(ShareAccess, OpenOptions);
  *((_QWORD *)&v24 + 1) = FileHandle;
  LODWORD(v24) = DesiredAccess;
  *((_QWORD *)&v23 + 1) = ObjectAttributes;
  *(_QWORD *)&v23 = IoStatusBlock;
...
LABEL_18:
  result = NtOpenFile(FileHandle, DesiredAccess, ObjectAttributes, IoStatusBlock, ShareAccess, OpenOptions);
  LODWORD(v25) = result;
  if ( v12 )
  {
    v20 = (_QWORD **)(v12 + 6);
