/*
 * XREFs of EtwTimLogRedirectionTrustPolicy @ 0x1409E7AD4
 * Callers:
...
LABEL_32:
            RtlStringCbCopyW(p_Length, 0x40uLL, (NTSTRSAFE_PCWSTR)(v20[1] + 2LL * v23));
...
LABEL_34:
      ...
      if ( v26 )
        v25 = v26;
      EtwpQueryProcessCommandLine((__int64)v14, (__int64)&v83);
      Length = v83.Length;
      if ( v83.Length )
      {
        v69 = 1;
      ...
      v159 = v30;
      v160 = 0;
      v32 = EtwpTiFillProcessIdentity(v161, (__int64)v14, &v84);
      v36 = v32 + 4;
      ...
      *(&UserData.Ptr + v50) = (ULONGLONG)&v79;
      ...
      while ( v51 < 0x10u );
      EtwWrite(EtwSecurityMitigationsRegHandle, EventDescriptor, 0LL, v47, &UserData);
      if ( v9 )
      {
        if ( (unsigned int)dword_140C043E0 > 5 && tlgKeywordOn((__int64)&dword_140C043E0, 0x400000000000LL) )
        {
          ...
          tlgWriteTransfer_EtwWriteTransfer(
            ...
            (unsigned __int8 *)&byte_14003564F,
            0LL,
            0LL,
            0x18u,
            &v93);
      ...
      else if ( (unsigned int)dword_140C043E0 > 5 && tlgKeywordOn((__int64)&dword_140C043E0, 0x400000000000LL) )
      {
        v81 = 0x2000000LL;
        v139 = &v81;
        v75 = v162;
        ...
        tlgWriteTransfer_EtwWriteTransfer(
          (__int64)&dword_140C043E0,
          (unsigned __int8 *)word_1400355F2,
          0LL,
          0LL,
          8u,
          &v138);
