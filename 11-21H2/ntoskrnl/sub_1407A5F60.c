/*
 * XREFs of sub_1407A5F60 @ 0x1407A5F60
 * Callers:
 ...
 *     sub_1407A6130 @ 0x1407A6130 (sub_1407A6130.c)
 */

__int64 __fastcall sub_1407A5F60(__int64 a1, __int64 a2, __int64 a3, int a4)
{
  __int64 result; // rax
  _DWORD *v9; // rbx
  int v10; // eax
  ...
  v16 = 0;
  result = sub_1407A6130(a2 + 48, a3, v18, &v16);
  if ( !v16 )
  {
    sub_1407A50BC(a1, (_OWORD *)(a2 + 16), (__int64 *)&v17);
    v9 = v17;
    sub_1402F5120((__int64)(v17 + 12), (__int64)v18);
    v10 = *(_DWORD *)(a2 + 484);
    if ( v10 >= 0 )
    {
    ...
    *(_DWORD *)(a2 + 484) = v11;
    ...
    v14 = v12 / 0x2710;
    v15 = v12 / 0x2710 - v13;
    if ( (unsigned int)(v12 / 0x2710) - *(_DWORD *)(a2 + 488) <= v15 )
      v13 = *(_DWORD *)(a2 + 488);
