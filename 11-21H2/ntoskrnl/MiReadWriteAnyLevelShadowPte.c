/*
 * XREFs of MiReadWriteAnyLevelShadowPte @ 0x1403853B0
 * Callers:
  ...
  *(_OWORD *)BugCheckParameter2 = 0LL;
  ...
  while ( 1 )
  {
    ...
    else
    {
      ...
      v14 = MI_READ_PTE_LOCK_FREE((unsigned __int64)&v19);
      v15 = MiMapPageInHyperSpaceWorker((v14 >> 12) & 0xFFFFFFFFFFLL, &v23, 0x80000000);
      v9 = v23;
      Flink = v15;
      v7 = v20;
  ...
  else
  {
    v18 = 0;
    if ( MiPteInShadowRange((unsigned __int64)v12) )
      v18 = MiPteHasShadow() != 0;
  }
  *v12 = a4;
  if ( v18 )
    MiWritePteShadow((__int64)v12, a4);
LABEL_14:
  if ( v9 != 17 )
    MiUnmapPageInHyperSpaceWorker(Flink, v9);
  return v11;
