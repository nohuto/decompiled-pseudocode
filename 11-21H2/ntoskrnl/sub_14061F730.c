/*
 * XREFs of sub_14061F730 @ 0x14061F730
 * Callers:
 *     <none>
 * Callees:
...
NTSTATUS __fastcall sub_14061F730(HANDLE KeyHandle)
{
  __int64 v2; // rdx
  __int64 v3; // rcx
  __int64 *v4; // rdi
