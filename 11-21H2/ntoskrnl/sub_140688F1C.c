/*
 * XREFs of sub_140688F1C @ 0x140688F1C
 * Callers:
...
NTSTATUS __fastcall sub_140688F1C(__int64 a1, char a2, int a3)
{
  NTSTATUS result; // eax
  ...
  if ( (unsigned int)dword_140C03868 > 4 )
  {
    ...
    v5 = a3;
    v11 = 4;
    return sub_14020A9C4((__int64)&dword_140C03868, (unsigned __int8 *)&word_14002971E, 0LL, 0LL, 4u, &v6);
  }
  return result;
}
