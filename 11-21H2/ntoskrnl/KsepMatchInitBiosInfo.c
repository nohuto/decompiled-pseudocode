/*
 * XREFs of KsepMatchInitBiosInfo @ 0x140B001A8
 * Callers:
 ...
 *     KsepRegistryQueryMULTISZ @ 0x140826BE0 (KsepRegistryQueryMULTISZ.c)
...
__int64 KsepMatchInitBiosInfo()
{
  ...
  if ( v1 >= 0 )
  {
    ...
    if ( MULTISZ >= 0 )
    {
      ...
      MULTISZ = KsepRegistryQueryMULTISZ(KeyHandle, L"SystemBiosVersion", (__int64)&unk_140C5A930, 520LL, (__int64)&v12);
      word_140C5AB36 = 0;
      v4 = 0LL;
      v5 = &unk_140C5A930;
      while ( *v5 != 32 )
