/*
 * XREFs of KdpSearchPhysicalPageRange @ 0x140A73A64
 * Callers:
 *     KdpSendWaitContinue @ 0x140A6FB80 (KdpSendWaitContinue.c)
 *     KdpSysCheckLowMemory @ 0x140A73C60 (KdpSysCheckLowMemory.c)
 * Callees:
 *     KdpSearchPhysicalPage @ 0x140A73844 (KdpSearchPhysicalPage.c)
 */
