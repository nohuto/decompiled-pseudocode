/*
 * XREFs of sub_140A014F0 @ 0x140A014F0
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall sub_140A014F0(unsigned __int64 a1, unsigned int a2)
{
  __int64 v2; // rsi
  ...
  v12 = sub_14093E830(L"DriverOrder", (__int64)&qword_140042080, (__int64)PoolWithTag, 2 * (int)v2, 1);
