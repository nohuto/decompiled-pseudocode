/*
 * XREFs of sub_140993DA0 @ 0x140993DA0
 * Callers:
...
void __fastcall sub_140993DA0(__int64 a1, __int64 a2, __int64 a3, __int64 a4, char a5, int a6, int a7)
{
  char v7; // r9
  char v8; // r10
  char v9; // r11
  ...
  if ( (unsigned int)dword_140C03A00 > 5 )
  {
    if ( sub_1402A2000((__int64)&dword_140C03A00, 0x400000000000LL) )
    {
      ...
      v32 = 4LL;
      v34 = 8LL;
      sub_14020A9C4((__int64)&dword_140C03A00, (unsigned __int8 *)&word_14002EBF6, 0LL, 0LL, 0xAu, &v18);
    }
  }
}
