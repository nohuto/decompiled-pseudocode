/*
 * XREFs of sub_140622350 @ 0x140622350
 * Callers:
 *     <none>
 * Callees:
...
NTSTATUS __fastcall sub_140622350(HANDLE ProcessHandle, ACCESS_MASK DesiredAccess, PHANDLE TokenHandle)
{
  __int64 v6; // rdx
  __int64 v7; // rcx
  __int64 *v8; // rdi
