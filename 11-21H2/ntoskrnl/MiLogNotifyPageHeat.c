/*
 * XREFs of MiLogNotifyPageHeat @ 0x1405B77AC
 * Callers:
...
char MiLogNotifyPageHeat()
{
  ...
  if ( !**(_DWORD **)&qword_140C53448 )
    return (char)v0;
  LOBYTE(v0) = tlgKeywordOn(*(__int64 *)&qword_140C53448, 64LL);
  if ( !(_BYTE)v0 )
    return (char)v0;
  ...
  if ( *v2 )
  {
    if ( **(_DWORD **)&qword_140C53448 <= 5u || !tlgKeywordOn(*(__int64 *)&qword_140C53448, v1) )
      goto LABEL_21;
    v17 = *v3;
  ...
  tlgWriteEx_EtwWriteEx(v11, v14, 0LL, 1u, 0, 0, 9u, v15);
LABEL_21:
  if ( KiIrqlFlags )
  {
    if ( (KiIrqlFlags & 1) != 0 )
