/*
 * XREFs of sub_140974B60 @ 0x140974B60
 * Callers:
...
char __fastcall sub_140974B60(__int64 a1, int a2, int a3, int a4, int *a5, unsigned __int16 *a6, int a7, int a8)
{
  _UNKNOWN **v8; // rax
  __int64 v13; // rbx
  ...
  {
    LOBYTE(v8) = sub_1403747BC(*((_QWORD *)KeGetCurrentThread() + 23) + 1664LL, v38, &v36);
    v13 = *(_QWORD *)&qword_140C53448;
    if ( a8 )
    {
      if ( **(_DWORD **)&qword_140C53448 > 5u )
      {
        LOBYTE(v8) = sub_1402A2000(*(__int64 *)&qword_140C53448, 0x400000000020LL);
        if ( (_BYTE)v8 )
        {
          ProcessId = (unsigned int)PsGetProcessId(v19);
          p_ProcessId = &ProcessId;
          v41 = 4LL;
          sub_1403699D0((__int64)v42, v36);
          v43 = &v34;
          v16 = (unsigned __int8 *)&word_14002D6A6;
          v34 = a7;
          v45 = &v33;
          v47 = &v32;
          v31 = *(_DWORD *)(a1 + 56);
    ...
    else if ( **(_DWORD **)&qword_140C53448 > 5u )
    {
      LOBYTE(v8) = sub_1402A2000(*(__int64 *)&qword_140C53448, 0x400000000020LL);
      if ( (_BYTE)v8 )
      {
        ...
        sub_1403699D0((__int64)v42, v36);
        v43 = &v25;
        v16 = (unsigned __int8 *)byte_14002D979;
        v25 = a7;
        v45 = &v26;
        v47 = &v27;
        v28 = *(_DWORD *)(a1 + 56);
...
LABEL_9:
        ...
        v73 = 4LL;
        v75 = 8LL;
        LOBYTE(v8) = sub_14024A9B0(v13, v16, v15, 1u, v22, v23, 0x14u, &v39);
      }
    }
  }
  return (char)v8;
