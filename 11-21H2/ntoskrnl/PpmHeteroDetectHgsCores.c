/*
 * XREFs of PpmHeteroDetectHgsCores @ 0x1403CF218
 * Callers:
...
char __fastcall PpmHeteroDetectHgsCores(__int64 a1)
{
  ...
  {
    if ( PpmHeteroHgsHeteroCoreTypes )
    {
      v3 = 0;
      v33 = qword_140C0B8E8[0];
      v4 = 0;
      v32 = (unsigned __int16 *)PpmCheckRegistered;
      v5 = -1;
      LOBYTE(v31) = 0;
      v34 = 0;
      while ( !(unsigned int)KeEnumerateNextProcessor(&v30, &v32) )
      {
        v6 = *(_BYTE *)(KeGetPrcb(v30) + 34125);
        v7 = v6;
        if ( v6 <= v4 )
          v7 = v4;
        v4 = v7;
        ...
        for ( i = 0; i < *(_DWORD *)(a1 + 4); ++i )
        {
          ...
          while ( 1 )
          {
            ...
            if ( (unsigned int)KeEnumerateNextProcessor(&v30, &v32) )
              break;
            v20 = *(_QWORD *)(KeGetPrcb(v30) + 34128);
