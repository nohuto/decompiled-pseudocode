/*
 * XREFs of sub_1409F7D30 @ 0x1409F7D30
 * Callers:
...
int sub_1409F7D30()
{
  ...
  if ( (unsigned int)dword_140C06820 > 5 )
  {
    ...
    v32 = 1LL;
    v34 = 8LL;
    sub_1402A2094((__int64)v35, (const WCHAR *)(v4 + 172));
    v7 = *((_BYTE *)v6 + 428);
    v36 = &v12;
    v16 = *v6;
    v12 = v7;
    ...
    v41 = 4LL;
    v43 = 4LL;
    LODWORD(v0) = sub_14020A9C4((__int64)&dword_140C06820, (unsigned __int8 *)byte_140036359, 0LL, 0LL, 0x10u, &v20);
  }
  return (int)v0;
}
