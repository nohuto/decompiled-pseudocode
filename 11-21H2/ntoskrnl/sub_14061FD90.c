/*
 * XREFs of sub_14061FD90 @ 0x14061FD90
 * Callers:
 *     <none>
 * Callees:
...
NTSTATUS __fastcall sub_14061FD90(
...
LABEL_12:
  *(_QWORD *)&v22 = v16;
LABEL_13:
  LODWORD(v23) = TokenType;
  *((_QWORD *)&v22 + 1) = NewTokenHandle;
  *((_QWORD *)&v24 + 1) = ExistingTokenHandle;
  LODWORD(v24) = DesiredAccess;
  *((_QWORD *)&v23 + 1) = ObjectAttributes;
  BYTE4(v23) = EffectiveOnly;
