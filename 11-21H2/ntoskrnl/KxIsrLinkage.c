/*
 * XREFs of KxIsrLinkage @ 0x140423360
 * Callers:
 *     KxIsrLinkageShadow @ 0x140AB6B00 (KxIsrLinkageShadow.c)
 * Callees:
...
/*
 * Hex-Rays decompilation failed for KxIsrLinkage @ 0x140423360
 ...
 * 00000001404233D4: test    cs:KiKvaShadow, 1
 ...
 * 00000001404235F6: call    KiFlushBhbDuringTrapEntryOrExit
 ...
 * 0000000140423617: call    KiSaveDebugRegisterState
 ...
 * 000000014042369B: test    byte ptr cs:KeSmapEnabled, 0FFh
 ...
 * 00000001404236B0: jmp     _guard_dispatch_icall
 * 00000001404236B5: mov     ecx, eax
 * 00000001404236B7: shr     ecx, 4
 * 00000001404236BA: cmp     cs:KiIrqlFlags, 0
 * 00000001404236C1: jz      short loc_1404236CA
 * 00000001404236C3: call    KzSetIrqlUnsafe
 ...
 * 0000000140423732: call    KiEndThreadAccountingPeriod
 * 0000000140423737: sti
 * 0000000140423738: test    dword ptr cs:PerfGlobalGroupMask+4, 4000h
 * 0000000140423742: jz      short loc_140423750
 * 0000000140423744: movzx   ecx, byte ptr [rbp+0E0h]
 * 000000014042374B: call    PerfInfoLogUnexpectedInterrupt
 * 0000000140423750: cmp     cs:KiBugCheckUnexpectedInterrupts, 0
 ...
 * 0000000140423773: call    KiBugCheckDispatch
 ...
 * 00000001404237BD: call    KiBeginThreadAccountingPeriod
 ...
 * 00000001404237E9: call    KiDpcInterruptBypass
 * 00000001404237EE: jmp     short loc_14042380D
 * 00000001404237F0: mov     ecx, 2
 * 00000001404237F5: call    cs:__imp_HalRequestSoftwareInterrupt
 ...
 * 0000000140423811: cmp     cs:KiIrqlFlags, 0
 * 0000000140423818: jz      short loc_140423821
 * 000000014042381A: call    KzSetIrqlUnsafe
 ...
 * 000000014042383A: test    byte ptr cs:KeSmapEnabled, 0FFh
 ...
 * 0000000140423862: call    KiInitiateUserApc
 ...
 * 00000001404238B2: call    KiCopyCounters
 ...
 * 00000001404238CE: call    KiRestoreDebugRegisterState
 ...
 * 0000000140423AFD: test    cs:KiKvaShadow, 1
 * 0000000140423B04: jz      short loc_140423B0B
 * 0000000140423B06: jmp     KiKernelExit
