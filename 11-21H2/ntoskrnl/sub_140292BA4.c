/*
 * XREFs of sub_140292BA4 @ 0x140292BA4
 * Callers:
 *     sub_140292884 @ 0x140292884 (sub_140292884.c)
 * Callees:
 *     sub_140292F10 @ 0x140292F10 (sub_140292F10.c)
 *     KeIsEmptyAffinityEx @ 0x140292F90 (KeIsEmptyAffinityEx.c)
 *     sub_140293004 @ 0x140293004 (sub_140293004.c)
...
__int64 __fastcall sub_140292BA4(__int64 a1, unsigned __int16 *a2)
{
  ...
  *a2 = 1;
  ...
  sub_140293004(v18, v4, 0LL);
  if ( ((*(_DWORD *)(a1 + 1380) >> 11) & 1) != 0 )
  {
    sub_140293004(a2, v4, (*(_DWORD *)(a1 + 1380) >> 11) & 1);
    sub_1402FEC10(v18, a2, v18, HIWORD(v18[0]));
  }
  sub_140292F10(a2, v6, v4);
  if ( (*(_DWORD *)(v5 + 1120) & 0x8000000) == 0 || (unsigned int)KeIsEmptyAffinityEx(a2) )
  {
    v8 = 1;
    sub_140300030(v19, HIWORD(v19[0]), v18);
    sub_1402FEC10(v18, a2, v18, HIWORD(v18[0]));
  }
  else
  {
    v8 = 0;
    sub_140300030(v18, HIWORD(v18[0]), a2);
    sub_140300030(v19, HIWORD(v19[0]), a2);
  }
...
LABEL_14:
    ...
    sub_140300030(v17, HIWORD(v17[0]), v11);
  }
  if ( !(unsigned int)sub_1402FF140(v17, v18, v17, HIWORD(v17[0])) )
    sub_140300030(v17, HIWORD(v17[0]), v18);
  sub_140292F10(a2, qword_140D07D30, v4);
  if ( (unsigned int)sub_1402FF140(v17, a2, a2, a2[1]) )
    sub_140300030(v17, HIWORD(v17[0]), a2);
      ...
      *(_QWORD *)&a2[4 * v13 + 4] = 0LL;
      if ( v14 )
      {
        ...
        do
        {
          ...
          v15 |= *((_QWORD *)qword_140D06BD8 + 64 * v13 + (int)v16);
          v14 &= ~(1LL << v16);
