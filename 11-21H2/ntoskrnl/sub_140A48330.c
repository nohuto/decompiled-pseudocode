/*
 * XREFs of sub_140A48330 @ 0x140A48330
 * Callers:
...
struct _KTHREAD *__fastcall sub_140A48330()
{
  ...
  ExAcquireResourceExclusiveLite(&stru_140C230A0, 1u);
  result = KeGetCurrentThread();
  qword_140C223A0 = (__int64)result;
  return result;
}
