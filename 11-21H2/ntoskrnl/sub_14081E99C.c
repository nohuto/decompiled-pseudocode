/*
 * XREFs of sub_14081E99C @ 0x14081E99C
 * Callers:
...
char *__fastcall sub_14081E99C(__int64 a1, int a2, int a3, _QWORD *a4)
{
  unsigned int *v4; // r15
  int v7; // r9d
  __int64 v8; // rbp
  ...
  v4 = (unsigned int *)qword_140D68680;
  v7 = a3;
  v8 = 4LL;
  v9 = 0LL;
  v10 = (char *)qword_140D68680 + 4;
  v11 = (char *)qword_140D68680 + 4;
  if ( !*(_DWORD *)qword_140D68680 )
    goto LABEL_12;
  v12 = *(unsigned int *)qword_140D68680;
  do
  {
    v13 = v11[3];
    v14 = v11 + 4;
