/*
 * XREFs of sub_14068BEAC @ 0x14068BEAC
 * Callers:
...
NTSTATUS __fastcall sub_14068BEAC(HANDLE FileHandle, int *a2)
{
  ...
  v24 = 6;
  IoStatusBlock = 0LL;
  v4 = *(struct _OBJECT_TYPE **)qword_140C49878;
  v26 = 0LL;
  result = ObReferenceObjectByHandle(FileHandle, 0, v4, 0, &Object, 0LL);
  if ( result < 0 )
    return result;
  v6 = sub_14071489C(NotificationEvent);
  v7 = Object;
  v8 = v6;
  if ( v6 >= 0 )
  {
    ...
    v16[-1].CompletionRoutine = (PIO_COMPLETION_ROUTINE)&sub_1406E19B0;
    v16[-1].Context = v10;
    v16[-1].Control = -32;
