/*
 * XREFs of sub_14061FC20 @ 0x14061FC20
 * Callers:
 *     <none>
 * Callees:
...
NTSTATUS __fastcall sub_14061FC20(
...
LABEL_12:
  v23[0] = v17;
LABEL_13:
  LODWORD(v23[2]) = DesiredAccess;
  v23[1] = __PAIR64__(HandleAttributes, Options);
  v23[6] = SourceProcessHandle;
  v23[5] = SourceHandle;
  v23[4] = TargetProcessHandle;
  v23[3] = TargetHandle;
