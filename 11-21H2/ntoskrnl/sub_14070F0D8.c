/*
 * XREFs of sub_14070F0D8 @ 0x14070F0D8
 * Callers:
...
__int64 __fastcall sub_14070F0D8(
        __int64 a1,
        __int64 a2,
        __int64 a3,
        int a4,
        ...
        _DWORD *a14)
{
  ...
  *v17 = 0;
  ...
  if ( a1 )
  {
    ...
    v29 = a13;
    v28 = a1;
    v21 = sub_140300B40(a2);
    v15 = sub_140671BE0(a2, v23, &v26, v22 != 0 ? 1 : 3, v21, (__int64)v27, a8, a9, a10, a11, (char *)&v30);
    if ( v15 >= 0 )
    {
      sub_14070F2D8(a2 + 1208, v26);
      if ( a4 || (_BYTE)v30 )
        *v14 = 1;
      if ( HIBYTE(v30) )
      {
      ...
      {
        v20 = (void *)sub_140347920(a1, 0x746C6644u);
        v15 = sub_1406E91DC(v20, v26, v17);
      }
    }
    if ( *v14 || *(int *)(a1 + 2512) < 0 || (*(_DWORD *)(a2 + 2172) & 0x800000) != 0 && !*(_QWORD *)(a1 + 2528) )
      v24 = _InterlockedIncrement64(&qword_140C0BAF8);
    else
      v24 = *(_QWORD *)(a1 + 2528);
    *(_QWORD *)(a2 + 2528) = v24;
    *(_QWORD *)(a2 + 2536) = v24;
    if ( v20 )
      sub_1402F89B0((signed __int64 *)(a1 + 1208), (unsigned __int64)v20, 0x746C6644u);
  }
  else
  {
    *(_QWORD *)(a2 + 1208) = 0LL;
