/*
 * XREFs of sub_140698128 @ 0x140698128
 * Callers:
...
__int64 __fastcall sub_140698128(__int64 a1, void *a2, __int64 a3)
{
  NTSTATUS v5; // eax
  int v6; // ebx
  NTSTATUS v7; // eax
...
LABEL_3:
  ...
  if ( *(_QWORD *)&qword_140D00AC0 && (v13 = *(_QWORD *)(*(_QWORD *)&qword_140D00AC0 + 224LL)) != 0 )
    v14 = *(_QWORD *)(v13 + 8);
  else
    v14 = 0LL;
  sub_1406CB238(KeyHandle, 0LL, v14, 0LL);
LABEL_4:
  if ( KeyHandle )
    ZwClose(KeyHandle);
  if ( v6 < 0 )
