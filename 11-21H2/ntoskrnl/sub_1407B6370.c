/*
 * XREFs of sub_1407B6370 @ 0x1407B6370
 * Callers:
...
signed __int64 __fastcall sub_1407B6370(unsigned int *a1, _DWORD *a2, _DWORD *a3)
{
  unsigned int *v3; // rax
  ...
  v3 = a1 + 16;
  v4 = 0LL;
  v5 = (unsigned __int64)&a1[16 * (unsigned __int64)(unsigned int)dword_140D3CA8C + 16];
  v6 = 0LL;
