/*
 * XREFs of sub_140853230 @ 0x140853230
 * Callers:
...
void __fastcall sub_140853230(__int64 a1, __int64 a2, __int64 a3, PVOID *a4, _DWORD *a5)
{
  __int64 v6; // rbx
  __int64 v7; // rax
  WCHAR *v10; // rdi
  ...
  *(_QWORD *)UTF8StringActualByteCount = a1;
  ...
  if ( Pool2 )
  {
    v15 = sub_1402E1280(Pool2, (unsigned int)v12, L"%ws\\%ws", *(_QWORD *)UTF8StringActualByteCount, a3);
    if ( v15 )
      goto LABEL_12;
    ...
    *(_OWORD *)&ObjectAttributes.SecurityDescriptor = 0LL;
    ...
    if ( v39 )
    {
      ...
      if ( !v21 )
        goto LABEL_13;
      v15 = sub_1402E1280(v21, (unsigned int)v20, L"%ws\\%ws", v17, a3);
      if ( v15 )
        goto LABEL_12;
...
LABEL_12:
    ...
    *a4 = (PVOID)v23;
    ...
    if ( v23 )
    {
      ...
      v52[37] = L"Names";
      v52[40] = &v32;
      v52[14] = sub_1408166C0;
      LODWORD(v52[18]) = 4;
      v44 = 4;
      v52[21] = sub_1408166C0;
      LODWORD(v52[25]) = 4;
      v46 = 4;
      v52[28] = sub_1408166C0;
      LODWORD(v52[32]) = 4;
      v48 = 4;
      v52[35] = sub_1408166C0;
      p_UnicodeString = &UnicodeString;
      LODWORD(v52[39]) = 1;
      v50 = 1;
      if ( (int)sub_140781F40(0x40000000, (const WCHAR *)KeyHandle, (__int64)v52, 0LL) >= 0 )
      {
        ...
        if ( Handle )
        {
          ...
          sub_140781F40(0x40000000, v25, (__int64)v52, 0LL);
        }
