/*
 * XREFs of sub_14097FB60 @ 0x14097FB60
 * Callers:
 *     sub_1407BF2E0 @ 0x1407BF2E0 (sub_1407BF2E0.c)
 * Callees:
 *     KeBugCheckEx @ 0x14041F3D0 (KeBugCheckEx.c)
 *     sub_14097FCE4 @ 0x14097FCE4 (sub_14097FCE4.c)
 */

__int64 __fastcall sub_14097FB60(ULONG_PTR BugCheckParameter2, ULONG_PTR a2, __int64 a3, __int64 a4)
{
  _DWORD *v4; // r8
  ULONG_PTR v6; // r9
  _WORD *v8; // r10
  ...
  if ( (unsigned int)(v4[1] - 8) >> 1 )
  {
    ...
    do
    {
      result = sub_14097FCE4(v6 + v10 + (*v8 & 0xFFF), *v8 >> 12, a4);
      if ( !(_DWORD)result )
