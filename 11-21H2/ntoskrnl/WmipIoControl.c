/*
 * XREFs of WmipIoControl @ 0x1406C3540
 * Callers:
 *     <none>
 * Callees:
...
LABEL_7:
            ...
            SetExecuteSI = WmipQuerySetExecuteSI(0LL, (__int64)MasterIrp, Length, (__int64)DesiredAccess);
LABEL_8:
...
LABEL_69:
      ...
      DesiredAccess[0] = Options;
      SetExecuteSI = WmipQuerySetExecuteSI(0LL, (__int64)MasterIrp, Options, (__int64)DesiredAccess);
      Length = 0;
      goto LABEL_9;
    }
    goto LABEL_77;
    ...
    case 0x224000u:
      if ( Length >= 0x48 )
      {
        if ( (unsigned int)Options >= 0x30 )
        {
          ...
          {
            SetExecuteSI = WmipQueryAllData(0LL, Length, (__int64)DesiredAccess);
            goto LABEL_8;
          }
        }
        goto LABEL_72;
...
LABEL_24:
      ...
      *(_OWORD *)Object_8 = 0LL;
      ...
      {
        LOBYTE(v12) = 1;
        v9 = WmipOpenBlock(LowPart, v12, (unsigned int)v21, DesiredAccess[0], (__int64)&Object);
        if ( v9 >= 0 )
        {
