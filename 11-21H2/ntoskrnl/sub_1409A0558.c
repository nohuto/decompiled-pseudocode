/*
 * XREFs of sub_1409A0558 @ 0x1409A0558
 * Callers:
        ...
        int a12)
{
  ...
  {
    LOBYTE(v12) = sub_1402A2000((__int64)&dword_140C03A00, 0x400000000000LL);
    if ( (_BYTE)v12 )
    {
      sub_1402A2094((__int64)v29, *(const WCHAR **)(v14 + 8));
      v32 = 0;
      v35 = 0;
      v38 = 0;
      v41 = 0;
      ...
      v52 = 4;
      v55 = 4;
      sub_1402A2094((__int64)v57, v16);
      v60 = 0;
      v58 = &v27;
      v27 = a12;
      v59 = 4;
      LOBYTE(v12) = sub_14020A9C4((__int64)&dword_140C03A00, (unsigned __int8 *)word_14003285A, 0LL, 0LL, 0xEu, &v28);
    }
  }
  return v12;
}
