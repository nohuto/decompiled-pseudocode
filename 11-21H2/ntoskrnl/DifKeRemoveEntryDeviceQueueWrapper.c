/*
 * XREFs of DifKeRemoveEntryDeviceQueueWrapper @ 0x140615110
 * Callers:
 *     <none>
 * Callees:
        ...
        PKDEVICE_QUEUE_ENTRY DeviceQueueEntry)
{
  ...
  v15 = 0LL;
  v16 = 0LL;
  APIThunkContextById = DifGetAPIThunkContextById(291);
...
LABEL_18:
  result = KeRemoveEntryDeviceQueue(DeviceQueue, DeviceQueueEntry);
  BYTE8(v16) = result;
  if ( APIThunkContextById )
  {
