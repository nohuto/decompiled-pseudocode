/*
 * XREFs of sub_1408100A4 @ 0x1408100A4
 * Callers:
...
__int64 __fastcall sub_1408100A4(
        __int64 a1,
        __int64 a2,
        unsigned int a3,
        __int64 a4,
        ...
        __int64 a8)
{
  ...
  *((_QWORD *)&v39[24] + 1) = qword_140D05008;
  *(_OWORD *)((char *)&v39[2] + 8) = xmmword_140024E90;
  WORD3(v39[8]) = v8;
  LODWORD(v39[8]) = 1;
  BYTE4(v39[8]) = -1;
  v39[9] = _mm_load_si128((const __m128i *)&xmmword_140024E80);
  DWORD2(v39[8]) = 64;
  result = sub_140300E50(
             (__int64)v39,
             1u,
             0,
             0,
