/*
 * XREFs of IopLiveDumpTraceInterfaceEnd @ 0x14055B654
 * Callers:
...
char IopLiveDumpTraceInterfaceEnd(__int64 a1, __int64 a2, int a3, ...)
{
  ...
  if ( result )
  {
    if ( v4 )
    {
      v8 = (const EVENT_DESCRIPTOR *)LIVEDUMP_EVENT_WRITE_DEFERRED_DATA_API_END;
      if ( v6 != 1 )
        v8 = &LIVEDUMP_EVENT_DISCARD_DEFERRED_DATA_API_END;
    }
    else
    {
      v8 = (const EVENT_DESCRIPTOR *)LIVEDUMP_EVENT_CAPTURE_API_END;
    }
    if ( v5 )
    {
      v9 = *v5;
    ...
    *(_QWORD *)&UserData.Size = 4LL;
    ...
    v17 = 4LL;
    v27 = 4LL;
    return EtwWriteEx(IopLiveDumpEtwRegHandle, v8, 0LL, (ULONG)ActivityId, ActivityId, ActivityId, 8u, &UserData);
  }
  return result;
}
