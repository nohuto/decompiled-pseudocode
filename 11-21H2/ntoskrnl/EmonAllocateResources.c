/*
 * XREFs of EmonAllocateResources @ 0x14051FFF8
 * Callers:
 *     EmonReserveProfileResources @ 0x140521800 (EmonReserveProfileResources.c)
 * Callees:
...
__int64 __fastcall EmonAllocateResources(__int64 a1, __int64 a2, __int64 a3, __int64 a4, unsigned int a5, _QWORD *a6)
{
  int v9; // ebx
  __int32 v10; // ebp
  int v11; // eax
  ...
  *a6 = -1LL;
  ...
  if ( v14 )
  {
    ...
    {
      v9 = EmonMarkCountersReserved(v37, a1, v17);
      if ( v9 < 0 )
        goto LABEL_23;
      v18 = v37;
      v15[v37 + 4] = a1;
      if ( a4 )
      {
        v19 = EmonDsManagementAreas + 160 * v18;
        if ( EmonPebs64Bit )
        {
          v20 = *(_QWORD *)(v19 + 32);
          v21 = *(_QWORD *)(v19 + 48);
        ...
        v22 = v20 + (unsigned int)(EmonPebsEntrySizeInUse * *(_DWORD *)(a4 + 12));
        if ( v22 >= v21 )
        {
          v9 = -1073741811;
LABEL_23:
          EmonReleaseProfileResourcesInternal(v15);
          HalpMmAllocCtxFree(v23, (__int64)v15);
          goto LABEL_24;
        }
        if ( !EmonPebs64Bit )
    ...
    v24 = KeAcquireSpinLockRaiseToDpc(&EmonReservedResourcesLock);
    v25 = (_QWORD *)qword_140C4A438;
    if ( *(__int64 **)qword_140C4A438 != &EmonReservedResourcesList )
      __fastfail(3u);
