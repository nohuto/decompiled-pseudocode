/*
 * XREFs of sub_140A031C4 @ 0x140A031C4
 * Callers:
...
bool __fastcall sub_140A031C4(__int64 a1, __int64 a2, int a3, const UNICODE_STRING *a4, void *Source1)
{
  char v6; // bl
  int v7; // r8d
  ...
  *(_QWORD *)&String2.Length = 0LL;
  ...
  if ( v7 == 1 )
  {
    if ( (int)sub_140A03B84(a2, a1, &String2) < 0 || RtlCompareUnicodeString(a4, &String2, 1u) )
    {
LABEL_7:
      if ( String2.Buffer )
