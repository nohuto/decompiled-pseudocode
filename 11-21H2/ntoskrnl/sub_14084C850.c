/*
 * XREFs of sub_14084C850 @ 0x14084C850
 * Callers:
 *     sub_140659040 @ 0x140659040 (sub_140659040.c)
 *     sub_14084C784 @ 0x14084C784 (sub_14084C784.c)
 * Callees:
 *     KeBugCheckEx @ 0x14041F3D0 (KeBugCheckEx.c)
 *     sub_14084C8D8 @ 0x14084C8D8 (sub_14084C8D8.c)
 */

__int64 __fastcall sub_14084C850(ULONG_PTR a1, ULONG_PTR a2, __int64 a3)
{
  ULONG_PTR v3; // r10
  ULONG_PTR v4; // r11
  __int64 result; // rax
