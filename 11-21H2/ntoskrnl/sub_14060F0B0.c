/*
 * XREFs of sub_14060F0B0 @ 0x14060F0B0
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall sub_14060F0B0(__int64 a1, unsigned int a2, unsigned int a3, __int64 a4, __int64 a5)
{
  __int64 v9; // rdx
  __int64 v10; // rcx
  __int64 *v11; // rdi
