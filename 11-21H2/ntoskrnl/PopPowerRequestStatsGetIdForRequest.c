/*
 * XREFs of PopPowerRequestStatsGetIdForRequest @ 0x1407F0C38
 * Callers:
...
LABEL_4:
      ...
      if ( *(_DWORD *)v2 )
      {
        ...
        if ( v10 )
        {
          ...
          v12 = PopAnsiStringToUnicodeString(v11, &DestinationString);
          if ( v12 < 0 )
            goto LABEL_34;
          *(_DWORD *)v9 |= 2u;
LABEL_9:
          ...
          if ( (v13 & 2) == 0 )
          {
            v12 = PopUnicodeStringDeepCopy(&SourceString, v11);
            if ( v12 < 0 )
              goto LABEL_34;
            v16 = SourceString;
            *(_DWORD *)v9 |= 2u;
          ...
          if ( !v5
            ...
            || (RtlInitUnicodeString(&SourceString, (PCWSTR)(v5 + *(_QWORD *)(v5 + 8))),
                v12 = PopPowerRequestStatsIdConcat(v11, &SourceString),
                v12 >= 0) )
          {
LABEL_14:
            *a2 = v9;
