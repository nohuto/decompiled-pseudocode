/*
 * XREFs of sub_14070AFEC @ 0x14070AFEC
 * Callers:
...
unsigned int __fastcall sub_14070AFEC(__int64 a1, char a2, unsigned int *a3, int *a4, __int16 a5)
{
  ...
  WCHAR SourceString[16]; // [rsp+238h] [rbp+130h] BYREF
  ...
  switch ( a5 )
  {
    case 769:
      ...
      goto LABEL_3;
    case 770:
      v10 = (const EVENT_DESCRIPTOR *)qword_14000DF10;
      goto LABEL_3;
    case 771:
      v10 = (const EVENT_DESCRIPTOR *)qword_140038800;
LABEL_3:
      v39 = *(_DWORD *)(a1 + 1088);
      v11 = 3;
      *(_QWORD *)&UserData.Size = 4LL;
      ...
      {
        if ( a5 != 770 )
          return EtwWrite(qword_140C15FF8, v10, 0LL, v11, &UserData);
        v28 = 0LL;
        sub_1407B81B0(a1, v46);
        v53 = 8LL;
        v52 = (int *)(a1 + 2112);
        v54 = (__int64 *)(a1 + 2004);
        v55 = 4LL;
        v19 = (void *)sub_140347920(a1, 0x746C6644u);
        ...
        sub_1402F89B0((signed __int64 *)(a1 + 1208), (unsigned __int64)v19, 0x746C6644u);
        if ( v28 )
          ExFreePoolWithTag(v28, 0);
        v57 = 4LL;
        v56 = &v27;
        v29 = sub_14066C174((struct _EX_RUNDOWN_REF *)a1, 0LL);
        v59 = 4LL;
        v58 = (char *)&v29;
        v37 = *(_QWORD *)(a1 + 1608);
        v37 <<= 12;
      ...
      else
      {
        ...
        {
          v41 = *((_QWORD *)Process + 287);
          ObfDereferenceObject(Process);
        }
        v55 = 8LL;
        v54 = &v41;
        LODWORD(v35) = sub_140300B40(a1);
        v13 = 1;
        v57 = 4LL;
        v56 = &v35;
        if ( (a2 & 1) == 0 )
        ...
        v58 = (char *)&v27 + 4;
        HIDWORD(v27) = v13;
        v14 = (void *)sub_140347920(a1, 0x746C6644u);
        ...
        sub_1402585D0();
        v15 = *(unsigned __int8 *)(v44 + 1);
        v64 = (_QWORD *)v44;
        v65 = (unsigned int)(4 * v15 + 8);
        sub_1402F89B0((signed __int64 *)(a1 + 1208), (unsigned __int64)v14, 0x746C6644u);
        p_DestinationString = *(UNICODE_STRING **)(a1 + 1472);
        if ( !p_DestinationString || !p_DestinationString->Length )
        {
          sub_1402E0198(SourceString, 15LL, L"%S", a1 + 1448);
