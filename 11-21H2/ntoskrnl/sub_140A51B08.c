/*
 * XREFs of sub_140A51B08 @ 0x140A51B08
 * Callers:
...
int __fastcall sub_140A51B08(int a1, int a2, int a3, __int64 a4, __int64 a5, char a6, char a7)
{
  _UNKNOWN **v7; // rax
  __int64 v8; // rcx
  __int64 v9; // rcx
  ...
  if ( byte_140C5AE14 )
  {
    ...
    *(_QWORD *)&UserData.Size = 4LL;
    ...
    v23 = 4LL;
    v25 = 4LL;
    LODWORD(v7) = EtwWrite(RegHandle, &stru_14000F940, 0LL, 7u, &UserData);
  }
  return (int)v7;
}
