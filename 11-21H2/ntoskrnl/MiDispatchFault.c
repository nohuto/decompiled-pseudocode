/*
 * XREFs of MiDispatchFault @ 0x14031E200
 * Callers:
 ...
 *     MiAdjustFaultList @ 0x14023C9A4 (MiAdjustFaultList.c)
...
__int64 __fastcall MiDispatchFault(__int64 a1, _QWORD *a2)
{
  ...
  *(__m128i *)&v48[1] = v7;
  ...
  v15 = 0LL;
  v16 = MiComputeMaximumFaultCluster((char *)&v47 + 8, 0LL);
  v17 = v16;
  if ( v16 > 1 )
  {
    v50.m256i_i8[21] |= 4u;
...
LABEL_22:
  ...
  while ( 1 )
  {
    if ( (v50.m256i_i8[21] & 8) != 0 )
    {
      ...
      if ( (*v33 & 0x40000000) != 0
        || (v50.m256i_i8[21] & 1) != 0
        || (unsigned int)MiPageTableLockIsContended(v11, ((v12 >> 9) & 0x7FFFFFFFF8LL) - 0x98000000000LL)
    ...
    if ( (v19 & 0x400) != 0 )
    {
      if ( (_QWORD)v52 )
        goto LABEL_12;
      v36 = MiCheckProtoAccess(v12, &v42);
      v18 = v48[1];
      if ( !v36 )
      {
        v21 = -1073741819;
    ...
    v37 = MiAccessCheck((unsigned __int64 *)v12, v43, (v51 & 0x40) != 0, v26, v18, 0);
    v18 = v48[1];
    v21 = v37;
    if ( !v37 )
    {
LABEL_12:
      ...
      {
        MiAdjustFaultList((_QWORD *)&v47 + 1);
        v18 = v48[1];
      }
      if ( (v19 & 0x400) != 0 )
      {
        v20 = MiResolveProtoPteFault((char *)&v47 + 8, v43, &v44);
        v18 = v48[1];
        v21 = v20;
        goto LABEL_15;
      }
      if ( (v19 & 0x800) != 0 )
      {
        v35 = MiResolveTransitionFault((char *)&v47 + 8, v12, 0LL, v43, &v44);
        v18 = v48[1];
        v21 = v35;
        goto LABEL_15;
      }
      if ( (v19 & 4) != 0 )
      {
        ...
        {
          v38 = MiResolvePageFileFault((char *)&v47 + 8, v12, 0LL, &v44);
          v18 = v48[1];
          v21 = v38;
        }
        goto LABEL_15;
      ...
      if ( (v18 & 1) != 0 )
      {
        ...
        {
LABEL_39:
          v31 = MiResolveDemandZeroFault((char *)&v47 + 8, v12, 0LL, v43);
          v18 = v48[1];
          v21 = v31;
          goto LABEL_15;
        }
      ...
      else
      {
        ...
        if ( v28 == 16 )
        {
          if ( (*(_DWORD *)(v18 + 376) & 0x200) == 0
            && (KiRspInIstStack(3u, *(_QWORD *)(v18 + 384)) || KiRspInIstStack(2u, v41)) )
          {
            goto LABEL_39;
          }
          v30 = &ExpInterlockedPopEntrySListFault;
          v34 = *(_QWORD *)(v18 + 360);
          v29 = KiDynamicTraceEnabled && v34 >= qword_140D070E8 && v34 < qword_140D070F0 && KeGetCurrentIrql() == 15;
        }
        else
        {
          if ( v28 != 51 )
...
LABEL_15:
    ...
    *((_QWORD *)&v47 + 1) += 4096LL;
    ...
    if ( (v22 & 2) != 0 )
    {
      ...
      if ( v15 == v17 )
        goto LABEL_22;
      v17 = MiComputeMaximumFaultCluster((char *)&v47 + 8, v17 - v15);
