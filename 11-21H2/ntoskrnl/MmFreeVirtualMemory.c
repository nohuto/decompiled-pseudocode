/*
 * XREFs of MmFreeVirtualMemory @ 0x1407B99C0
 * Callers:
...
LABEL_8:
  ...
  else
  {
    ...
    {
      v13 = 1;
      KiStackAttachProcess((_KPROCESS *)BugCheckParameter1a, 0LL, (__int64)&v57, v33);
      p_Lock = (_QWORD *)BugCheckParameter1a;
    }
    v12 = v45;
  }
  v42 = 0;
  if ( (v6 & 0xFFFF3FFF) != 0 && (!p_Lock[280] || (v6 & 0x10000) == 0 || (v6 & 0x4000) != 0) )
  {
    v25 = -1073741582;
    goto LABEL_125;
  }
  ...
  v16 = MiObtainReferencedVadEx(v15, (_DWORD)BugCheckParameter1a != 0, (int *)&v41);
  if ( !v16 )
  {
    v25 = v41;
    goto LABEL_124;
...
LABEL_119:
    ...
    if ( v44 )
    {
      VadEvent = MiLocateVadEvent(v16, 128LL);
...
LABEL_23:
    ...
    if ( (v41 & 8) != 0 && (v45 & 0x40000000) == 0 )
    {
      ...
      else
      {
        ...
        v34 = v17 << 12;
LABEL_69:
        v36 = MiCheckSecuredVad(v16, v34, (v35 + 1) << 12, 0x55u, a5);
    ...
    v31 = MiFreeVadRange(v16, (int)&v42, v20, v19, (__int64)Object, v23 != 0);
    v41 = v31;
    if ( v31 >= 0 )
    {
      if ( v13 )
...
LABEL_71:
  ...
  if ( (*(_DWORD *)(v16 + 48) & 0x6200000) != 0x4200000
    || (v24 = MiDecommitEnclavePages((_DWORD)Object, v16, v15, v10, v45), v41 = v24, v24 == -1073741802) )
  {
    v26 = *(_DWORD *)(v16 + 48);
    if ( (*(_BYTE *)(v16 + 48) & 0x70) == 0x30
      || (v26 & 0x200000) != 0
      && ((v26 & 0x800000) != 0 || (v26 & 0x180000u) >= 0x100000)
      && ((v26 & 0xA00000) != 0xA00000 || v10 && (((MiGetVadPageSize(v16) << 12) - 1) & (v15 | (v14 + 1))) != 0)
...
LABEL_118:
    ...
    v28 = MiDecommitRegion(v16, v15, v14);
    MiUnlockAndDereferenceVad((char *)v16);
    if ( v28 )
      MiDeleteEmptyPageTables(v15, v14, 0);
    v8 = v55;
    goto LABEL_41;
  }
  v25 = v24;
...
LABEL_41:
    ...
    if ( (WORD2(PerfGlobalGroupMask[0]) & 0x8000) != 0 )
      PerfInfoLogVirtualFree(v15, v10, Object, v6);
    if ( v13 )
      KiUnstackDetachProcess((__int64)&v57, 0LL);
    if ( v47 != -1LL )
