/*
 * XREFs of Feature_3907421502__private_IsEnabled @ 0x14041AC58
 * Callers:
...
__int64 Feature_3907421502__private_IsEnabled()
{
  ...
  CachedFeatureEnabledState = wil_details_FeatureStateCache_GetCachedFeatureEnabledState(
                                (unsigned int *)&Feature_3907421502__private_featureState,
                                (__int64)&Feature_3907421502__private_descriptor);
  v1 = (CachedFeatureEnabledState >> 3) & 1;
  wil_details_FeatureReporting_ReportUsageToService(
    (__int64)&Feature_3907421502__private_reporting,
    0x2FD67E4u,
