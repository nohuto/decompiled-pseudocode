/*
 * XREFs of sub_140B1EFA0 @ 0x140B1EFA0
 * Callers:
...
LABEL_6:
  v4 = qword_140D3CA60;
  v31.Sid = qword_140C5AFA8;
  v32 = Sid;
  v22.Sid = qword_140D3CA60;
  v22.Attributes = 0;
  v31.Attributes = 7;
  v33 = 96;
  v5 = ((4 * *((unsigned __int8 *)qword_140C5AFA8 + 1) + 11) & 0xFFFFFFFC)
     + 16
     + ((4 * *((unsigned __int8 *)Sid + 1) + 11) & 0xFFFFFFFC);
