/*
 * XREFs of sub_140A30DE4 @ 0x140A30DE4
 * Callers:
...
__int64 __fastcall sub_140A30DE4(__int64 a1, unsigned int a2, _WORD *a3, unsigned int *a4)
{
  ...
  unsigned __int64 v54; // [rsp+98h] [rbp-9h] BYREF
  _WORD *v55; // [rsp+A0h] [rbp-1h] BYREF
  ...
  v54 = a2;
  v7 = a2;
  v8 = sub_140A30CA8(a1, a3, a2, (unsigned int *)&v59);
...
LABEL_70:
  ...
  {
    v8 = sub_1402E04F4(v5, v7, v15, &v55, &v54, 1024);
    if ( v8 < 0 )
      return (unsigned int)v8;
    v5 = v55;
    v7 = v54;
...
LABEL_116:
    ...
    else if ( v34 == 8210 )
    {
      while ( *(_WORD *)v33 )
      {
        ...
        if ( v32 <= (unsigned int)v4 )
        {
          v8 = sub_140204630(v5, v7, &v55, &v54, 0x400u, L"[%s]", v33);
          if ( v8 < 0 )
            return (unsigned int)v8;
          v5 = v55;
        }
...
LABEL_105:
  ...
  switch ( v34 )
  {
    ...
    case 3u:
      ...
      if ( v32 > (unsigned int)v4 )
        goto LABEL_121;
      v35 = sub_140204630(v5, v7, &v55, &v54, 0x400u, L"(0x%.2x)", *v33);
      break;
    case 4u:
    case 5u:
      v32 += 16;
      if ( v32 > (unsigned int)v4 )
        goto LABEL_121;
      v35 = sub_140204630(v5, v7, &v55, &v54, 0x400u, L"(0x%.4x)", *(__int16 *)v33);
      break;
    case 6u:
    case 7u:
    case 0x16u:
    ...
    case 0x18u:
      ...
      if ( v32 > (unsigned int)v4 )
        goto LABEL_121;
      v35 = sub_140204630(v5, v7, &v55, &v54, 0x400u, L"(0x%.8x)", *(_DWORD *)v33);
      break;
    case 8u:
    case 9u:
      v32 += 40;
      if ( v32 > (unsigned int)v4 )
        goto LABEL_121;
      v35 = sub_140204630(v5, v7, &v55, &v54, 0x400u, L"(0x%.16I64x)", *(_QWORD *)v33);
      break;
    case 0xAu:
    case 0xBu:
      v32 += 32;
      ...
      if ( v34 == 10 )
        ...
        v36 = *(double *)v33;
      v35 = sub_140204630(v5, v7, &v55, &v54, 0x400u, L"(%.6e)", v36);
      break;
    case 0xCu:
    case 0xEu:
    case 0xFu:
    ...
    case 0x11u:
      ...
      if ( v32 > (unsigned int)v4 )
        goto LABEL_121;
      v35 = sub_1402E04F4(v5, v7, v37, &v55, &v54, 1024);
      break;
    case 0x12u:
    case 0x14u:
    case 0x19u:
      ...
      if ( v32 > (unsigned int)v4 )
        goto LABEL_121;
      v35 = sub_140204630(v5, v7, &v55, &v54, 0x400u, L"(%s)", *(_QWORD *)(v6 + 40));
      break;
    default:
      goto LABEL_105;
  }
