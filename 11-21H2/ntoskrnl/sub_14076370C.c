/*
 * XREFs of sub_14076370C @ 0x14076370C
 * Callers:
...
char __fastcall sub_14076370C(unsigned int *a1, unsigned int a2)
{
  __int64 v4; // rcx
  int v5; // r11d
  unsigned int v6; // edx
    ...
    if ( a2 >= 0x14 && !*((_WORD *)a1 + 3) && (a1[2] & 0xFFC0) == 0 )
    {
      if ( a1[3] )
      {
        ...
        if ( a2 >= (unsigned int)v4
          ...
          && (int)sub_1402DCD64((unsigned int *)((char *)a1 + v4), a2 - (unsigned int)v4, &v22) >= 0 )
        {
          v6 = a1[3];
          v7 = 4LL * v6;
                  ...
                  if ( v6 )
                  {
                    while ( 1 )
                    {
                      ...
                      if ( a2 < (unsigned int)v21
                        ...
                        || (int)sub_1402DCD64((unsigned int *)((char *)a1 + v21), a2 - (unsigned int)v21, &v22) < 0 )
                      {
                        break;
                      }
                      if ( ++v20 >= a1[3] )
