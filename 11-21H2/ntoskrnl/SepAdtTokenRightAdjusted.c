/*
 * XREFs of SepAdtTokenRightAdjusted @ 0x14079D470
 * Callers:
 ...
 *     SepAdtAuditablePrivilege @ 0x1405F4C6C (SepAdtAuditablePrivilege.c)
...
void __fastcall SepAdtTokenRightAdjusted(__int64 a1, char *a2, unsigned int a3, char *a4, unsigned int a5, char a6)
{
  ...
  if ( (unsigned __int8)SeAuditingWithTokenForSubcategory(138LL)
