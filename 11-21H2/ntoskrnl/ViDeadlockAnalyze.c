/*
 * XREFs of ViDeadlockAnalyze @ 0x140A98E28
 * Callers:
 ...
 *     ViDeadlockAddParticipant @ 0x140A98A98 (ViDeadlockAddParticipant.c)
 *     ViDeadlockAnalyze @ 0x140A98E28 (ViDeadlockAnalyze.c)
 *     ViDeadlockCertify @ 0x140A99098 (ViDeadlockCertify.c)
        ...
        if ( (unsigned int)ViDeadlockCertify(a5, a2) )
        {
          *((_QWORD *)ViDeadlockGlobals + 4107) = a1;
          ViDeadlockPreprocessOptions(
            ...
            a2,
            0LL);
          VfReportIssueWithOptions(0xC4u, 0x1001uLL, a1, a2, 0LL, byte_140C0D9EC);
          return 0LL;
        }
        v8 = 0;
        goto LABEL_30;
