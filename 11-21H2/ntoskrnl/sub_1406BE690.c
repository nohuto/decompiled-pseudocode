/*
 * XREFs of sub_1406BE690 @ 0x1406BE690
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall sub_1406BE690(
        void *a1,
        volatile void *a2,
        volatile void *a3,
        volatile void *a4,
        ...
        volatile void *a6)
{
  ...
  if ( a1 && a2 && a3 )
  {
    ...
    Object = 0LL;
    v12 = ObReferenceObjectByHandle(Handle, 1u, (POBJECT_TYPE)IoFileObjectType, v11, &Object, 0LL);
    v10 = Object;
    Handle = Object;
    if ( v12 >= 0 )
    {
