/*
 * XREFs of sub_1405D9E58 @ 0x1405D9E58
 * Callers:
...
char __fastcall sub_1405D9E58(__int64 a1, int a2, int a3)
{
  _UNKNOWN **v3; // rax
  REGHANDLE v5; // rbx
  __int16 v6; // ax
  ...
  {
    v5 = qword_140C1F580;
    LOBYTE(v3) = EtwEventEnabled(qword_140C1F580, &stru_140038E38);
    if ( (_BYTE)v3 )
    {
      ...
      UserData.Size = 2;
      v11 = 1;
      LOBYTE(v3) = EtwWriteEx(v5, &stru_140038E38, 0LL, 0, 0LL, 0LL, 4u, &UserData);
    }
  }
  return (char)v3;
}
