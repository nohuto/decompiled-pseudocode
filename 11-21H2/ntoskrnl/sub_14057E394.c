/*
 * XREFs of sub_14057E394 @ 0x14057E394
 * Callers:
...
char __fastcall sub_14057E394(__int64 a1, __int64 a2, __int64 a3, int a4, char a5)
{
  _UNKNOWN **v5; // rax
  REGHANDLE v6; // rbx
  ...
  if ( qword_140D00B58 )
  {
    LOBYTE(v5) = EtwEventEnabled(qword_140D00B58, &stru_1400380F8);
    if ( (_BYTE)v5 )
    {
      UserData.Reserved = 0;
      v11 = 0;
      ...
      v16 = 4;
      v19 = 4;
      LOBYTE(v5) = EtwWriteEx(v6, &stru_1400380F8, 0LL, 0, 0LL, 0LL, 5u, &UserData);
    }
  }
  return (char)v5;
}
