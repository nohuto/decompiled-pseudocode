/*
 * XREFs of sub_1407C5730 @ 0x1407C5730
 * Callers:
...
__int64 __fastcall sub_1407C5730(
        __int64 a1,
        unsigned int a2,
        __int64 a3,
        int a4,
        ...
        unsigned int *a7)
{
    ...
    else
    {
      *v11 = 0;
      ...
      if ( v14 )
      {
        ...
        else if ( !sub_1407C46A0(*(_QWORD *)(v9 + 32), v8, a3, (unsigned int *)&Size, (__int64)&Src, (__int64)&v43, v38) )
        {
          v15 = -1073741670;
        }
        if ( Src )
      ...
      else
      {
        *v11 = 0;
        ...
        if ( v21 )
        {
          ...
          {
            if ( !sub_1407C46A0(*(_QWORD *)(v9 + 32), v8, a3, (unsigned int *)&Size, (__int64)&Src, (__int64)&v43, v38) )
              v15 = -1073741670;
    ...
    *a7 = v12 + 12;
    ...
    else
    {
      *v11 = 0;
      ...
      if ( (*(_BYTE *)(a3 + 16) & 1) != 0 )
        sub_140718AE8((_WORD *)v11 + 6, v28, (unsigned __int8 *)(a3 + 20), *(unsigned __int16 *)(a3 + 2));
      else
  ...
  if ( Src && Src != (void *)(a3 + 8) )
  {
    ...
    {
      sub_1406BF450(v39, v38);
    }
    else
    {
      sub_1407C97C0(v39, v38);
    }
  }
  return v15;
}
