/*
 * XREFs of SymCryptTwistedEdwardsFillScratchSpaces @ 0x1404079EC
 * Callers:
...
__int64 __fastcall SymCryptTwistedEdwardsFillScratchSpaces(_DWORD *a1)
{
  ...
  v7 = a1[2] & 0xF;
  a1[11] = v6 + 64;
  v8 = SymCryptSizeofEcpointEx(v3, v7);
  v9 = SymCryptSizeofIntFromDigits();
  v10 = a1[9];
  v11 = 2 * (v8 + v9) + 64;
  v12 = a1[2];
  if ( v6 + 64 <= (unsigned int)(v5 + 64) )
    v6 = v5;
  a1[12] = v10 + v6 + v11;
  a1[13] = SymCryptSizeofEcpointEx(v10, v12 & 0xF) * a1[23] + ((8 * a1[24] + 31) & 0xFFFFFFE0);
  v13 = (unsigned int)((v4 << 8) + 64);
  v14 = SymCryptSizeofEcpointEx(v3, 4u);
  v15 = 704 * v4 + 256;
  if ( v13 > v13 + (unsigned int)(v4 << 6) + 64LL + 2 * ((unsigned int)(v4 << 6) + 64LL) + (unsigned int)(v4 << 8) )
    v15 = v13;
  v16 = v15 + v14 + 2 * v3;
  a1[14] = v16;
  if ( v16 <= (unsigned int)SymCryptSizeofIntFromDigits() )
    v16 = SymCryptSizeofIntFromDigits();
  v17 = a1[9];
  a1[14] = v16;
  SymCryptEcurveDigitsofScalarMultiplier((__int64)a1);
  v18 = v17 + SymCryptSizeofIntFromDigits();
  if ( v18 <= (unsigned int)SymCryptSizeofEcpointEx(v17, a1[2] & 0xF) )
  {
