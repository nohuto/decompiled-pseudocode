...
__int64 __fastcall sub_1406DA264(
        __int64 a1,
        __int64 a2,
        __int64 a3,
        char a4,
        ...
        unsigned int *a7)
{
  ...
  *a7 = 0;
  ...
  while ( 1 )
  {
    ...
    {
      if ( a4
        || (result = sub_140785B98(a1, a2, a3, (_DWORD)v12, (__int64)v29, 0LL, 0, (__int64)&a7, 0),
        ...
        || !(_DWORD)result )
      {
        if ( a5 )
        {
          ...
          if ( (unsigned int)v14 < a6 )
          {
            ...
            *(_DWORD *)(a5 + 4 * v15 + 16) = *((_DWORD *)v12 + 4);
          }
        }
        v16 = *v7 + 1;
        if ( v16 < *v7 )
...
LABEL_35:
  ...
  while ( 1 )
  {
    ...
    {
      if ( a4
        || (result = sub_1406DA4DC(a1, v31, a3, v19, v29, 0LL, 0, &a7), (_DWORD)result == -1073741789)
        || !(_DWORD)result )
      {
        if ( a5 )
        {
          ...
          {
            v27 = 5 * v26;
            *(_OWORD *)(a5 + 4 * v27) = *(_OWORD *)v19;
            *(_DWORD *)(a5 + 4 * v27 + 16) = *((_DWORD *)v19 + 4);
          }
        }
        v28 = *v7 + 1;
        if ( v28 < *v7 )
  ...
  do
  {
    v22 = *v21;
    if ( a4
      || (result = sub_14078600C(v30, v31, a3, *v21, v29, 0LL, 0, &a7, 0), (_DWORD)result == -1073741789)
      || !(_DWORD)result )
    {
      if ( a5 )
      {
        ...
        if ( (unsigned int)v23 < a6 )
        {
          ...
          *(_DWORD *)(a5 + 4 * v24 + 16) = *((_DWORD *)v22 + 4);
        }
      }
      v25 = *v7 + 1;
      if ( v25 < *v7 )
