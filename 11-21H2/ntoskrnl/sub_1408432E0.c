/*
 * XREFs of sub_1408432E0 @ 0x1408432E0
 * Callers:
...
__int64 __fastcall sub_1408432E0(__int64 a1, __int64 a2, __int64 a3)
{
  unsigned int v5; // ebx
  unsigned int v6; // eax
  unsigned int v7; // esi
  ...
  if ( v6 )
  {
    ...
    {
      LOWORD(v9) = 16439;
      return (unsigned int)sub_140A12BF8(a1, *(_DWORD *)(a3 + 40), v7, v9, 16440, 16441) != 0;
    }
  }
  else
  {
