/*
 * XREFs of PiDmaGuardProcessUpdateConsoleLockStateAction @ 0x140956608
 * Callers:
...
__int64 __fastcall PiDmaGuardProcessUpdateConsoleLockStateAction(__int64 a1)
{
  ...
  if ( !v3 || (*(_DWORD *)(v3 + 396) & 0x20000) != 0 )
  {
    ...
    if ( v20 )
    {
      ...
      IoAddTriageDumpDataBlock(v20, (PVOID)0x310);
      if ( *v21 )
      {
        IoAddTriageDumpDataBlock((ULONG)v21, (PVOID)2);
        IoAddTriageDumpDataBlock(*((_QWORD *)v21 + 1), (PVOID)*v21);
      }
      v22 = *(_QWORD *)(v1 + 312);
      ...
      if ( v24 )
      {
        ...
        if ( *v25 )
        {
          ...
          IoAddTriageDumpDataBlock(*(_QWORD *)(v26 + 64), (PVOID)*(unsigned __int16 *)(v26 + 56));
        }
      }
    }
LABEL_31:
  ...
  if ( v13 )
  {
    LOBYTE(v15) = (unsigned __int8)PiIommuIsDeviceSafeWhileConsoleLocked(v13, 3221225473LL) == 0;
    return (unsigned int)PipDmgSetIommuDomainPolicyAndNotifyHal(v16, *(unsigned int *)(v14 + 32), v15);
  }
  return v2;
}
