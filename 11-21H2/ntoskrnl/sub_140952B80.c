/*
 * XREFs of sub_140952B80 @ 0x140952B80
 * Callers:
...
NTSTATUS __fastcall sub_140952B80(__int64 a1, __int64 a2)
{
  __int64 v2; // rax
  ULONG v3; // ecx
  __int64 v4; // rax
  ...
  v13 = 0;
  v15 = 2LL;
  return EtwWrite(qword_140C54EA8, &stru_14003B1F0, 0LL, 4u, &UserData);
}
