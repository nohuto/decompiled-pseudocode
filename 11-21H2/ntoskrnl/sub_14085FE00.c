/*
 * XREFs of sub_14085FE00 @ 0x14085FE00
 * Callers:
 *     <none>
 * Callees:
...
NTSTATUS __fastcall sub_14085FE00(__int64 a1, __int64 a2, __int64 a3, __int64 a4, int a5, int a6, _DWORD *a7)
{
  NTSTATUS result; // eax
  ...
  if ( (_DWORD)a2 == 1 )
  {
    ...
    if ( *a7 > 5u )
    {
      ...
      v44 = 4LL;
      v46 = 4LL;
      return sub_14020A9C4((__int64)a7, (unsigned __int8 *)byte_14002C489, 0LL, 0LL, 0xFu, &v20);
    }
  }
  return result;
}
