/*
 * XREFs of _woutput_l @ 0x1403E3D1C
 * Callers:
...
LABEL_116:
                        ...
                        if ( !v54 && (int)v12 > 0 )
                        {
                          ...
                          {
                            --v38;
                            v39 = safecrt_mbtowc(v53, v37, _mb_cur_max);
                            v40 = v39;
                            if ( v39 == 2 )
                            {
                              --v38;
                        ...
                        write_string(v7, (unsigned int)v12, v36, &v49);
LABEL_130:
                        v11 = v49;
LABEL_131:
                        if ( v11 < 0 || (v5 & 4) == 0 )
...
LABEL_44:
                  ...
                  if ( (v5 & 0x20) != 0 )
                  {
                    SrcCh[0] = v20;
                    SrcCh[1] = 0;
                    v21 = safecrt_mbtowc(DstCh, SrcCh, _mb_cur_max);
                    v9 = v58;
                    if ( v21 < 0 )
                      v60 = 1;
                  }
