/*
 * XREFs of DifKeTryToAcquireGuardedMutexWrapper @ 0x140615BB0
 * Callers:
 *     <none>
 * Callees:
...
BOOLEAN __fastcall DifKeTryToAcquireGuardedMutexWrapper(PFAST_MUTEX FastMutex)
{
  __int64 v2; // rdx
  __int64 v3; // rcx
...
LABEL_18:
  result = ExTryToAcquireFastMutex(FastMutex);
  LOBYTE(v14) = result;
  if ( APIThunkContextById )
  {
