/*
 * XREFs of sub_14057EB28 @ 0x14057EB28
 * Callers:
 *     sub_14057DF40 @ 0x14057DF40 (sub_14057DF40.c)
 * Callees:
...
char __fastcall sub_14057EB28(__int64 a1, __int64 a2, __int64 a3, int a4)
{
  _UNKNOWN **v4; // rax
  REGHANDLE v5; // rbx
  ...
  if ( qword_140D00B58 )
  {
    LOBYTE(v4) = EtwEventEnabled(qword_140D00B58, &stru_140038840);
    if ( (_BYTE)v4 )
    {
      UserData.Reserved = 0;
      v10 = 0;
      ...
      v14 = &v21;
      v15 = 4;
      LOBYTE(v4) = EtwWriteEx(v5, &stru_140038840, 0LL, 0, 0LL, 0LL, 4u, &UserData);
    }
  }
  return (char)v4;
}
