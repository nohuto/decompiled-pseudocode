/*
 * XREFs of sub_140381960 @ 0x140381960
 * Callers:
...
_DWORD *__fastcall sub_140381960(__int64 *a1, __int64 *a2)
{
  _QWORD *v3; // rsi
  _DWORD *result; // rax
  __int64 v5; // rdx
  ...
  if ( *(_DWORD *)*v3 != -1 )
  {
    ...
    if ( *a1 )
    {
      ...
      if ( v5 != *a2 )
      {
        ...
        v20 = v6;
        v17 = (__int64)&v17;
        sub_140381130((__int64)a2, v11, (__int64)&v17);
        v13 = 2LL * (v6 - 2);
        v14 = *(&v17 + 2 * v6 - 3);
        v15 = *(&v17 + v13);
        sub_140237F80(a2, (__int64)&v17);
        v16 = v14 - 8;
        if ( v14 <= v15 + 16 )
          v16 = v15 + 8;
        result = (_DWORD *)*v3;
