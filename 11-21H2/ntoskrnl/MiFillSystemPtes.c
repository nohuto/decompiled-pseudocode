/*
 * XREFs of MiFillSystemPtes @ 0x140308F00
 * Callers:
 ...
 *     MiIoPagesInRun @ 0x14024FFE4 (MiIoPagesInRun.c)
        ...
        _DWORD *a6)
{
  ...
  __int64 IsConstant; // [rsp+50h] [rbp-58h]
  ...
  *a6 = 0;
  ...
  v10 = a4 | 0xA0000000;
  v11 = a4 & 0x1F;
  v12 = MmProtectToPteMask[v11] & 0xFFF0000000000E5EuLL | 0x21;
  ...
  if ( a1 >= 0xFFFFF6FB40000000uLL && a1 <= 0xFFFFF6FB7FFFFFFFuLL )
  {
    ...
    {
      v12 = MmProtectToPteMask[v11] & 0x7FF0000000000E5ELL | 0x8000000000000021uLL;
    }
    else if ( (v10 & 0x4000000) == 0 )
    {
      v12 = MmProtectToPteMask[v11] & 0x7FF0000000000E5ELL | 0x21;
    }
    v45 = MiUserPdeOrAbove(a1);
    v6 = a2;
    v14 = 0xFFFF800000000000uLL;
    v13 = 0xFFFFF6FFFFFFFFFFuLL;
    if ( v45 )
  ...
  {
    if ( byte_140C53F50[((LeafVa >> 39) & 0x1FF) - 256] == 1 || LeafVa >= 0xFFFFF68000000000uLL && LeafVa <= v13 )
      goto LABEL_18;
    v16 = LeafVa < qword_140C540C0 || LeafVa > qword_140C51BF0
...
LABEL_47:
  ...
  {
    if ( v20 || (IsConstant = MiIoSpaceRunIsConstant(v27, v29, v22), (v20 = IsConstant) != 0) )
    {
      if ( v20 > 1 )
      {
        v41 = *(_DWORD *)(v20 + 40);
LABEL_75:
        ...
        {
          v46 = a3;
          ValidPte = v9 ^ (v9 ^ (v27 << 12)) & 0xFFFFFFFFFF000LL;
          v9 = ValidPte;
        }
        else
        {
          ValidPte = MiMakeValidPte(v8, v27, (unsigned int)a3 | 0xA0000000);
          v9 = ValidPte;
          v46 = a3;
        }
        goto LABEL_46;
    ...
    else
    {
      ...
      {
        v38 = MiIoPagesInRun(v27, v22);
        v49 = v38;
      }
      v39 = MiReferenceIoPages(1, v27, v38, v53, 0LL, &v50);
      if ( v39 < 0 )
        goto LABEL_122;
      v40 = v50;
      v21 = v49;
  ...
  v55 = 0;
  v47 = 0;
  if ( (unsigned int)MiGetPfnPageSizeIndexUnsynchronized(48 * v27 - 0x220000000000LL, &v55, &v47) != 3 && v55 == 6 )
  {
LABEL_42:
    v33 = *(_BYTE *)(v30 + 34);
    if ( (v33 & 0xC0) == 0xC0 )
    {
      MiAssignInitialPageAttribute(48 * v27 - 0x220000000000LL, v53);
      v33 = *(_BYTE *)(v30 + 34);
    }
    if ( v53 == v33 >> 6 )
    {
      v21 = v49;
      ValidPte = v19 | ((v27 & 0xFFFFFFFFFFLL | 0xA00000000000LL) << 12);
    }
    else
    {
      ProtectionPfnCompatible = MiMakeProtectionPfnCompatible(a3, 48 * v27 - 0x220000000000LL);
      LOBYTE(a3) = ProtectionPfnCompatible;
      ValidPte = MiMakeValidPte(v8, v27, ProtectionPfnCompatible | 0xA0000000);
      v21 = v49;
    }
LABEL_46:
    *(_QWORD *)v8 = ValidPte;
...
LABEL_122:
  if ( (*a6 & 1) != 0 )
    MiZeroAndFlushPtes((__int64)((v8 << 25) + ((v22 - a2) << 28)) >> 16, a2 - v22, 1);
