/*
 * XREFs of sub_140678698 @ 0x140678698
 * Callers:
...
int __fastcall sub_140678698(PSECURITY_DESCRIPTOR SecurityDescriptor, PSECURITY_DESCRIPTOR a2, _BYTE *a3, _BYTE *a4)
{
  __int64 AclSize; // rax
  PACL v9; // r14
  PACL v10; // rdi
...
LABEL_11:
            ...
            *a3 = 1;
            if ( a4 && Control[0] && v20 && DaclDefaulted )
              *a4 = 1;
          }
        }
      }
