/*
 * XREFs of sub_140B1D5F4 @ 0x140B1D5F4
 * Callers:
...
unsigned __int64 __fastcall sub_140B1D5F4(
        unsigned __int64 *a1,
        unsigned __int64 a2,
        unsigned __int64 a3,
        __int64 a4,
    ...
    do
    {
      ...
      if ( (result & 1) != 0 )
      {
        ...
        if ( a5 == 1 )
        {
          ...
          {
            sub_140246420(12, (unsigned __int64)v12 + (v13 >> 3), (v13 & 7) + 1);
            result = sub_140424F10((_OWORD *)(v14 & 0xFFFFFFFFFFFFF000uLL));
            v12 = (signed __int64 *)a1[1];
          }
          if ( *a1 <= v13 )
          {
        ...
        {
          result = sub_140B1D5F4((_DWORD)a1, v11, (int)v11 + 4088, v8, a5 - 1);
        }
      }
      v6 += 8LL;
    }
