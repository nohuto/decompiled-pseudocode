/*
 * XREFs of sub_1406E9A30 @ 0x1406E9A30
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall sub_1406E9A30(
        __int64 a1,
        __int64 a2,
        int a3,
        __int64 a4,
        ...
        int a8)
{
  ...
  return sub_14067CE4C(a1, a2, a3 | 0x8000u, v11, v19, DesiredAccess, a7, a8, 0LL, 0, v18, PreviousMode);
}
