/*
 * XREFs of sub_140643BBC @ 0x140643BBC
 * Callers:
...
char __fastcall sub_140643BBC(__int64 a1)
{
  int v2; // eax
  __int64 v3; // rax
  ...
  if ( (_DWORD)v6 && DesiredTime * (MEMORY[0xFFFFF78000000320] - *(_QWORD *)(a1 + 72)) / 10000000LL > v6 )
  {
    *(_DWORD *)(a1 + 80) = 1;
    *(_QWORD *)(a1 + 72) = v7;
    return 0;
