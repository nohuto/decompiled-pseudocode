/*
 * XREFs of sub_1409AE3D8 @ 0x1409AE3D8
 * Callers:
...
__int64 __fastcall sub_1409AE3D8(ULONG_PTR BugCheckParameter1, __int64 a2, int a3, _DWORD *a4, char a5)
{
  __int64 result; // rax
  PVOID *v10; // rdx
  PVOID v11; // r8
  ...
  if ( a3 != 72 )
    return 3221225476LL;
  result = sub_140732D40(BugCheckParameter1, 4096, (__int64)PsProcessType, a5, 0x79517350u, Object, 0LL, 0LL);
  if ( (int)result >= 0 )
  {
