/*
 * XREFs of sub_140B0E310 @ 0x140B0E310
 * Callers:
...
__int64 __fastcall sub_140B0E310(__int64 a1)
{
  WCHAR **v1; // rdi
  int v2; // r13d
  ...
  _STRING DestinationString; // [rsp+A0h] [rbp-68h] BYREF
  ...
  _STRING v42; // [rsp+F0h] [rbp-18h] BYREF
  LARGE_INTEGER v43; // [rsp+100h] [rbp-8h] BYREF
  int v44; // [rsp+108h] [rbp+0h]
  CHAR SourceString[128]; // [rsp+118h] [rbp+10h] BYREF
  ...
  v43.QuadPart = 0LL;
  v44 = 0;
  *(_OWORD *)&StartingOffset[0].LowPart = xmmword_140025778;
  v5 = sub_140B0E478(P, (GUID *)StartingOffset);
  v6 = P[0];
  v7 = P[0];
  v8 = v5 < 0;
  v9 = *v1;
  ...
  while ( 1 )
  {
    if ( v7 && *v7 )
    {
      ...
      if ( DeviceObjectPointer < 0 )
        goto LABEL_40;
      v22 = DeviceObject;
      v23 = sub_1403428E0(2953344, (__int64)DeviceObject, 0LL, 0, &v43, 0xCu, 0, &Object_8, &IoStatusBlock);
      if ( !v23 )
        goto LABEL_52;
      ...
      if ( DeviceObjectPointer < 0
        || (sub_1403C5514(SourceString, 128LL, "\\Device\\CdRom%d", v43.HighPart),
...
LABEL_40:
    ...
    {
      sub_1403C5514(SourceString, 128LL, "\\Device\\CdRom%d", v18);
      Object = v18 + 1;
      RtlInitAnsiString(&DestinationString, SourceString);
...
LABEL_43:
  ...
  sub_1403C5514(v46, 128LL, "\\ArcName\\%s", *(const char **)(v40 + 184));
