/*
 * XREFs of sub_14057E268 @ 0x14057E268
 * Callers:
...
char sub_14057E268(__int64 a1, int a2, ...)
{
  _UNKNOWN **v2; // rax
  REGHANDLE v3; // rbx
  ...
  if ( qword_140D00B58 )
  {
    LOBYTE(v2) = EtwEventEnabled(qword_140D00B58, &stru_140037B08);
    if ( (_BYTE)v2 )
    {
      UserData.Reserved = 0;
      v8 = 0;
      ...
      v21 = *((_QWORD *)v34 + 1);
      v22 = *v34 + 2;
      LOBYTE(v2) = EtwWriteEx(v3, &stru_140037B08, 0LL, 0, 0LL, 0LL, 7u, &UserData);
    }
  }
  return (char)v2;
}
