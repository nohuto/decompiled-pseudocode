/*
 * XREFs of sub_14091B960 @ 0x14091B960
 * Callers:
...
NTSTATUS __fastcall sub_14091B960(__int64 a1, __int64 a2, int a3)
{
  const wchar_t *v3; // r8
  NTSTATUS result; // eax
  ...
  if ( qword_140C16478 )
  {
    ...
    *(_QWORD *)&UserData.Size = 2LL;
    ...
    v20 = 4LL;
    v22 = 4LL;
    return EtwWrite(qword_140C16478, &stru_1400149B8, 0LL, 6u, &UserData);
  }
  return result;
}
