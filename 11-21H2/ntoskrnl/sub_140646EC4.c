/*
 * XREFs of sub_140646EC4 @ 0x140646EC4
 * Callers:
...
__int64 __fastcall sub_140646EC4(_DWORD *a1, unsigned int a2)
{
  unsigned int v4; // r8d
  __int64 v5; // rax
  unsigned int v6; // ecx
      ...
      if ( v4 <= a2 )
      {
        ...
        if ( v7 <= v4 )
        {
          for ( i = 0LL; (unsigned int)i < (unsigned int)v5; i = (unsigned int)(i + 1) )
          {
            ...
            if ( v12 > v4 )
              return (unsigned int)-1073741596;
            if ( (unsigned int *)sub_14025179C(a1, (const WCHAR *)((char *)a1 + v11), *((_WORD *)v9 + 6) >> 1) != v9 )
              return (unsigned int)-1073741596;
            v13 = v9[4];
            if ( v13 )
            {
