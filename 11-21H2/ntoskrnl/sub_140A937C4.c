/*
 * XREFs of sub_140A937C4 @ 0x140A937C4
 * Callers:
...
__int64 __fastcall sub_140A937C4(__int64 a1)
{
  int v2; // edi
  void *i; // rcx
  ULONG_PTR v5; // rax
  ...
  v2 = 0;
  _InterlockedExchange(&dword_140D575BC, 1);
  _InterlockedExchange(&dword_140D57570, 1);
  if ( !sub_140359DE0(*(_QWORD *)(a1 + 48)) )
    return sub_140A93A60(a1);
  for ( i = 0LL; ; i = v6 )
  {
    v5 = sub_1402A1770(i);
    v6 = (void *)v5;
