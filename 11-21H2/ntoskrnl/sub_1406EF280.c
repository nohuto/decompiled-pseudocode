/*
 * XREFs of sub_1406EF280 @ 0x1406EF280
 * Callers:
...
__int64 __fastcall sub_1406EF280(__int64 a1, __int64 a2)
{
  unsigned int v4; // ecx
  __int64 v5; // rcx
  __int16 v6; // ax
  ...
  if ( (*(_DWORD *)(a2 + 12) & 0x2000000) != 0 )
  {
    ...
    v15 = *(_QWORD *)(a2 + 1096);
    v16[0] = *(_OWORD *)(v14 + v15 + 4284);
    v16[1] = *(_OWORD *)(v14 + v15 + 4300);
    sub_1406E1024((__int64)v16, 0);
    *(_DWORD *)(a1 + 72) = v16[0];
  }
  else
  {
  ...
  *(_DWORD *)(a1 + 40) = *(_DWORD *)(a2 + 200);
  ...
  if ( (v10 & 2) != 0 && (v10 & 4) == 0 )
    ExfTryToWakePushLock(a2 + 688);
  sub_1402AFC00(a2 + 688);
