/*
 * XREFs of sub_14085C290 @ 0x14085C290
 * Callers:
                ...
                if ( RtlValidSid(Owner) )
                {
                  ...
                  if ( Pool2 )
                  {
                    if ( RtlCreateAcl(Pool2, v3, 2u) >= 0
                      && (int)sub_1407B4900(v5, 2u, 2, 983103, Sid, 0) >= 0
                      && (int)sub_1407B4900(v5, 2u, 2, 0x20000, Src, 0) >= 0
                      && (int)sub_1407B4900(v5, 2u, 2, 131097, v17, 0) >= 0
