/*
 * XREFs of HalPutScatterGatherListV2 @ 0x140230618
 * Callers:
...
void __fastcall HalPutScatterGatherListV2(PDMA_ADAPTER DmaAdapter, _QWORD *P, char a3)
{
  _DWORD *v3; // rbx
  PVOID v5; // rcx
  __int64 *v6; // rdi
  ...
  _DMA_OPERATIONS *DmaOperations; // [rsp+98h] [rbp+20h]
      ...
      do
      {
        if ( v10 )
        {
          ...
          do
          {
            ...
            v21 = ContiguousPiece + v17;
            if ( (unsigned __int64)DmaOperations < v21 - 1
              || !a3
              && !*((_BYTE *)&DmaAdapter[27].Size + 3)
              && ((v22 = (unsigned int)HalpDmaGetAdapterCacheAlignment(DmaAdapter, v15, v16, v21) - 1, (v22 & v17) != 0)
               || (v21 & v22) != 0) )
            {
