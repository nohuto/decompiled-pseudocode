/*
 * XREFs of sub_14070A9C0 @ 0x14070A9C0
 * Callers:
...
__int64 __fastcall sub_14070A9C0(__int64 a1, __int64 a2, __int64 a3, _QWORD *a4)
{
  _QWORD *v4; // rax
  ...
  *a4 = 0LL;
  ...
  v4[1] = v4;
  *v4 = v4;
  if ( !(unsigned int)sub_14024DA70() && (*(_DWORD *)(v10 + 2172) & 1) == 0 )
  {
    result = sub_1407BE280(v10, 4LL);
    if ( (int)result < 0 )
      return result;
    sub_1405B85A8(a1 + 1664);
  }
  if ( !a2 && a3 && (*(_DWORD *)(a3 + 56) & 0x20) != 0 && (*(_DWORD *)(a1 + 1124) & 0x20000) == 0 )
  {
    if ( (*(_BYTE *)(*(_QWORD *)(*(_QWORD *)sub_140287970(a3) + 56LL) + 44LL) & 0x20) != 0 )
    {
      if ( *(_QWORD *)(a1 + 1408) )
      {
        v12 = *(_WORD *)(a1 + 2412);
