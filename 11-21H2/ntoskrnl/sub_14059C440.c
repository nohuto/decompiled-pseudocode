/*
 * XREFs of sub_14059C440 @ 0x14059C440
 * Callers:
...
__int64 __fastcall sub_14059C440(__int64 a1, unsigned int *a2, __int64 a3, char a4)
{
  ...
  while ( 1 )
  {
    v10 = sub_14025EFDC(v16, v4, a3, 0xFFFFFFFF, &v22);
    a3 = v10;
    if ( !v10 )
      break;
    v4 = v22 + v10;
    if ( v10 >= v5 && (v10 >= v8 || a4 >= 0) )
    {
      v11 = v22 & 0x1F;
      v12 = v22 - v11;
      v13 = v8;
      ...
      while ( 1 )
      {
        v14 = sub_14025EFDC((unsigned int *)&v18, v11, a3, v13, &v22);
        if ( !v14 )
          break;
        v13 = v20;
        v11 = v22 + v14;
