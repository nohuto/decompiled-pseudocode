/*
 * XREFs of sub_140A9CDF4 @ 0x140A9CDF4
 * Callers:
...
char *__fastcall sub_140A9CDF4(__int64 a1, __int64 *a2, int a3)
{
  __int64 v4; // rbp
  int v5; // ecx
  size_t v6; // rsi
  ...
  if ( !a3 && !(unsigned int)sub_140A921E0(a1) )
    return 0LL;
  v4 = *a2;
  v5 = *(char *)(*a2 + 66);
  v6 = (unsigned int)(120 * v5 + 200);
  if ( *(char *)(*a2 + 66) <= 20 && dword_140D57610 )
  {
    v7 = 1;
    Pool2 = (char *)sub_140202234((__int64)&unk_140D591C0);
  }
  else
  {
    v7 = 0;
