/*
 * XREFs of sub_14084205C @ 0x14084205C
 * Callers:
...
__int64 __fastcall sub_14084205C(unsigned __int16 *a1, _WORD *a2, unsigned __int16 **a3, _QWORD *a4)
{
  ...
  else
  {
    ...
    else
    {
      ...
      else
      {
        ...
        *((_WORD *)v11 - 1) = 0;
LABEL_6:
        v14 = sub_1403CB368(v10, v7, &v20);
        if ( v14 )
        {
          v15 = (_DWORD)v11 - (_DWORD)i;
          if ( (unsigned int)((_DWORD)v11 - (_DWORD)i) >= 8
            && *i <= v15
            && (int)sub_1403CB454(&v22, (__int64)i, v15) >= 0 )
          {
            v16 = *i;
