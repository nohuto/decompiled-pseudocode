/*
 * XREFs of sub_140936A54 @ 0x140936A54
 * Callers:
...
char __fastcall sub_140936A54(__int64 a1, ACCESS_MASK a2, char a3, int a4, __int64 a5, __int64 a6)
{
  int v10; // ebx
  ...
  *(_QWORD *)&v13[12] = PsGetCurrentSilo();
  ...
  if ( *((_QWORD *)&v13[10] + 1) )
    sub_14066EE14(*((__int64 *)&v13[10] + 1));
