/*
 * XREFs of sub_14094CBE0 @ 0x14094CBE0
 * Callers:
...
__int64 __fastcall sub_14094CBE0(__int64 a1, const WCHAR *a2, __int64 *a3)
{
  ...
  *(_QWORD *)&GuidString.Length = 0LL;
  ...
  if ( *(_QWORD *)&qword_140D00AC0 )
    ...
    v6 = 0LL;
  v7 = sub_14077FFEC(v6, v5, (__int64)a2, 0, 0x20019u, (__int64)&Handle);
  if ( v7 >= 0 )
  {
    ...
    *(_QWORD *)(Pool2 + 184) = -1LL;
    if ( !RtlCreateUnicodeString((PUNICODE_STRING)(Pool2 + 24), a2) )
    {
      v7 = -1073741670;
LABEL_31:
      sub_14094C238((char *)v9);
      goto LABEL_32;
    }
    *(_QWORD *)(v9 + 40) = Handle;
    Handle = 0LL;
    memset(v23, 0, sizeof(v23));
    v11 = _mm_loadu_si128((const __m128i *)off_140A38428);
    si128 = _mm_load_si128((const __m128i *)&xmmword_140047E00);
    v13 = _mm_load_si128((const __m128i *)&xmmword_140047DF0);
    ...
    LODWORD(v23[43]) = 304;
    v23[52] = v9 + 160;
    v7 = sub_140781F40(-1073741824, v15, (__int64)v23, 0LL);
    if ( v7 < 0 )
      goto LABEL_31;
    ...
    v17 = *(_WORD **)(v9 + 144);
    if ( v17 && !sub_1402D19FC(v17, *(unsigned __int16 *)(v9 + 136)) )
