/*
 * XREFs of sub_14098F634 @ 0x14098F634
 * Callers:
 ...
 *     sub_1405D0114 @ 0x1405D0114 (sub_1405D0114.c)
 *     ExFreePoolWithTag @ 0x140A6E010 (ExFreePoolWithTag.c)
 *     ExAllocatePool2 @ 0x140A6E430 (ExAllocatePool2.c)
 */

__int64 __fastcall sub_14098F634(unsigned int a1, unsigned int a2, PVOID *a3)
{
  struct _MDL *v4; // rsi
  char v5; // r15
  ...
  if ( !BYTE8(xmmword_140C23400)
    || (unsigned __int64)(*(_QWORD *)&MaxDataSize - 1LL) > 0xFFFFFFFFFFFFFFFDuLL
...
LABEL_14:
    if ( Status >= 0 )
    {
      Status = sub_1405D0114(v10, v7, (unsigned __int64 *)&v16);
      if ( Status >= 0 )
      {
