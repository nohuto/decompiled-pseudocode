/*
 * XREFs of HvlpSelectLpSet @ 0x140544A9C
 * Callers:
...
__int64 __fastcall HvlpSelectLpSet(unsigned int a1, __int64 a2)
{
  ...
  HviGetImplementationLimits(&v45);
  v4 = 64;
  ...
  v39 = HalEnumerateProcessors(KeRegisteredProcessors);
  v6 = v39;
  v7 = 0;
  if ( !a1 )
  {
    ...
    while ( 1 )
    {
      ...
      if ( a1 )
      {
        ...
        do
        {
          ...
          {
            if ( *(_BYTE *)(v18 + 1)
              || (v19 = *(unsigned __int16 *)(v18 + 8), (unsigned __int16)v19 >= (unsigned __int16)KeNumberNodes)
              || (*(_BYTE *)(KeNodeBlock[v19] + 10) & 2) == 0
              || v15 == 1024
              || v15 == v6
              || KeMaximumProcessors && v15 == KeMaximumProcessors
              || KeBootprocSpecified && v15 == KeBootprocSpecified
              || KeNumprocSpecified && v17 >= KeNumprocSpecified
...
LABEL_63:
      ...
      if ( a1 )
      {
        ...
        {
          if ( *v26 )
            HvlpComputeLpComparisonMetrics(a1, a2, v25);
          ++v25;
          v26 += 40;
        }
        while ( v25 < a1 );
...
LABEL_74:
        ...
        do
        {
          if ( *v31 && (unsigned int)HvlpLpComparison(v30, a2, v29, v28) == -1 )
...
LABEL_93:
  ...
  {
    *((_BYTE *)v8 - 10) = 1;
    ApicIdAndNumaNode = HvlpQueryApicIdAndNumaNode(v7, v8 - 3, v37);
...
LABEL_24:
  ...
  if ( ApicIdAndNumaNode >= 0 )
  {
    ...
    *(v8 - 1) = v37[0];
    if ( v11 )
    {
      if ( v11(v12, &v44, &v43) >= 0 && HvlpQueryProximityNode && (int)HvlpQueryProximityNode(v43, &v38) >= 0 )
      {
        *v8 = v38;
LABEL_23:
        v8[1] = *v8;
