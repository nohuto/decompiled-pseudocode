/*
 * XREFs of sub_140B1C78C @ 0x140B1C78C
 * Callers:
...
void __fastcall sub_140B1C78C(__int64 a1)
{
  __int64 v1; // rdi
  WCHAR *v2; // rbx
  void *v3; // rax
  ...
  if ( (_DWORD)a1 )
  {
    ...
    if ( Pool2 )
    {
      ...
      *(_OWORD *)&ObjectAttributes.SecurityDescriptor = 0LL;
      ...
      {
        ZwWriteFile(FileHandle, 0LL, 0LL, 0LL, &IoStatusBlock, qword_140C15B68, dword_140C15B70, 0LL, 0LL);
        ZwClose(FileHandle);
        FileHandle = 0LL;
        v22 = sub_140A1CA9C(&DestinationString.Length, &v24);
        v1 = v24;
        if ( v22 >= 0 )
          sub_140A1CAC4(v24);
      }
  ...
  if ( (unsigned int)sub_140B1C6B0(a1, &v28, 0, 0LL, &dword_140C15B70) != -1073741789 )
  {
LABEL_3:
    if ( qword_140C15B68 )
    {
      ExFreePoolWithTag(qword_140C15B68, 0);
      qword_140C15B68 = 0LL;
      dword_140C15B70 = 0;
    }
    if ( v1 )
  ...
  v3 = (void *)ExAllocatePool2(256LL, dword_140C15B70, 0x64506142u);
  qword_140C15B68 = v3;
  if ( v3 )
    sub_140B1C6B0(v4, &v28, 0, v3, &dword_140C15B70);
}
