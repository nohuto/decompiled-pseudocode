/*
 * XREFs of PiDmObjectUpdateCachedObjectProperty @ 0x14077B6F4
 * Callers:
        ...
        unsigned int a8)
{
  ...
  DEVPROPKEY **v26; // [rsp+78h] [rbp-9h] BYREF
  ...
  if ( !a4 )
  {
    PiDmGetCacheKeys(a1, &v26, &v31);
    if ( v31 )
    {
      v11 = a5;
      CachedKeyIndex = PiDmGetCachedKeyIndex((__int64)v26, v31, a5);
      v13 = CachedKeyIndex;
      if ( CachedKeyIndex < v14 && (int)PiDmGetObject(a1, a2, (__int64 *)&BugCheckParameter2) >= 0 )
      {
        ...
        if ( v19 <= 1 )
        {
          PiDmCacheDataEncode(a6, Buf2, a8, (int)v26[v17 + 1], HIDWORD(v26[v17 + 1]), (__int64)&v16[2 * v17 + 28]);
          v10 = v31 == 0;
        }
