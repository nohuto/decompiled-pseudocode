/*
 * XREFs of sub_1407F2558 @ 0x1407F2558
 * Callers:
...
char __fastcall sub_1407F2558(int a1, int a2, int a3, _DWORD *a4, _DWORD *a5, int a6)
{
  _DWORD *v6; // rbx
  char result; // al
  int v9; // r9d
  ...
  *(_QWORD *)&UserData.Size = 4LL;
  ...
  v17 = 0LL;
  v31 = 8LL;
  result = sub_1407F274C(&stru_140014A38, 7u, &UserData);
  if ( *a4 != *v6 && a6 >= 0 && (unsigned int)dword_140C03A00 > 5 )
  {
    ...
    if ( result )
    {
      ...
      v18 = 0x1000000LL;
      v44 = 8LL;
      return sub_14020A9C4((__int64)&dword_140C03A00, (unsigned __int8 *)&byte_140032967, 0LL, 0LL, 8u, &v32);
    }
  }
  return result;
}
