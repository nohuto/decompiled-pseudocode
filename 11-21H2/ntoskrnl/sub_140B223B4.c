/*
 * XREFs of sub_140B223B4 @ 0x140B223B4
 * Callers:
...
__int64 __fastcall sub_140B223B4(PVOID *a1)
{
  int v2; // ebx
  PSID *v3; // rsi
  PSID *v4; // rsi
  ...
  if ( v2 >= 0 )
  {
    ...
    *((_DWORD *)*v7 + 2) = 19;
    if ( !RtlValidSid(*v7) )
      return (unsigned int)-1073741595;
    v8 = a1 + 6;
    v2 = sub_14084DAD4(a1 + 6, &v12, 1u);
    if ( v2 < 0 )
      return (unsigned int)v2;
    *((_DWORD *)*v8 + 2) = 20;
    if ( !RtlValidSid(*v8) )
      return (unsigned int)-1073741595;
    v2 = sub_14084DAD4(a1 + 7, &v14, 2u);
    if ( v2 >= 0 )
    {
      *((_DWORD *)a1[7] + 2) = 2;
      *((_DWORD *)a1[7] + 3) = 1;
