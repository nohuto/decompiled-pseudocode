/*
 * XREFs of sub_1409D3004 @ 0x1409D3004
 * Callers:
...
__int64 __fastcall sub_1409D3004(
        unsigned int *a1,
        unsigned int a2,
        __int64 a3,
        __int64 a4,
        ...
        __int64 a7)
{
  ...
  PVOID v95; // [rsp+40h] [rbp-C0h] BYREF
  ...
  if ( a2 < (unsigned int)v12
    ...
    || (int)sub_1402DCD64((unsigned int *)((char *)a1 + v12), a2 - (unsigned int)v12, &v95) < 0
    || !(_DWORD)v95 )
  {
    return 1336;
  }
  v9 = sub_1409D0420(v13, (unsigned int)v95, (__int64 *)&Src);
  if ( !v9 )
  {
    v14 = -1LL;
    do
        ...
        case 3:
          ...
          while ( 1 )
          {
            ...
            if ( a2 < (unsigned int)v36
              ...
              || (int)sub_1402DCD64((unsigned int *)((char *)a1 + v36), a2 - (unsigned int)v36, &v95) < 0 )
            {
              goto LABEL_28;
            }
            if ( v19 + (_DWORD)v95 + 4 < v19 )
              goto LABEL_131;
            ++v34;
        ...
        case 5:
          ...
          while ( 1 )
          {
            ...
            if ( !v31[1] || v30 - 8 < 4 * (unsigned __int64)(unsigned __int8)v31[1] )
              goto LABEL_28;
            v9 = sub_140676AC0(v31, (wchar_t **)&P, v98, 0LL, v92, a6);
            if ( v9 )
              goto LABEL_133;
            v32 = -1LL;
            do
...
LABEL_63:
          ...
          while ( 1 )
          {
            ...
            if ( a2 < (unsigned int)v40 || a2 - (unsigned int)v40 < 8 )
              break;
            ui64tow_s(*(_QWORD *)((char *)a1 + v40), v100, 0x46uLL, 10);
            v41 = -1LL;
            do
              ++v41;
            while ( v100[v41] );
            if ( v19 + 2 * (_DWORD)v41 < v19 )
              goto LABEL_131;
            ++v38;
            ++v39;
            v19 += 2 * v41;
...
LABEL_28:
    ...
    do
    {
      ...
      if ( a2 < (unsigned int)v44 || a2 - (unsigned int)v44 < 8 )
        goto LABEL_28;
      i64tow_s(*(_QWORD *)((char *)a1 + v44), v100, 0x46uLL, 10);
      v45 = -1LL;
      do
        ++v45;
      while ( v100[v45] );
      if ( v19 + 2 * (_DWORD)v45 < v19 )
        goto LABEL_131;
      ++v42;
      ++v43;
      v19 += 2 * v45;
    }
    while ( v42 < (unsigned int)v10 );
LABEL_52:
    v11 = v93;
    LODWORD(v15) = v96;
LABEL_53:
...
LABEL_131:
    ...
    v33 = sub_14067757C((v19 + 3) & 0xFFFFFFFC);
    v95 = v33;
    if ( !v33 )
    {
      v9 = 8;
    ...
    *v33 = 40;
    v33[1] = 34;
    v47 = v33 + 2;
    memmove(v33 + 2, v46, (unsigned int)v15);
    ...
    if ( v54 )
    {
      ...
      if ( !v57 )
      {
        ...
        while ( 1 )
        {
          ...
          *(_WORD *)v53 = 44;
          v69 = v53 + 2;
          v9 = sub_140676AC0((char *)a1 + (unsigned int)(*v67 + 4), (wchar_t **)&P, v68, v52, v92, a6);
          if ( v9 )
            goto LABEL_86;
          v70 = -1LL;
          do
      ...
      do
      {
        *(_WORD *)v53 = 44;
        ...
        if ( v62 )
        {
          ...
          {
            v65 = *v63++;
            *(_WORD *)v53 = a0123456789abcd_0[(unsigned __int64)v65 >> 4];
            *((_WORD *)v53 + 1) = a0123456789abcd_0[v65 & 0xF];
            v53 += 4;
            --v64;
          }
          while ( v64 );
