/*
 * XREFs of sub_1405DF088 @ 0x1405DF088
 * Callers:
...
NTSTATUS __fastcall sub_1405DF088(__int64 a1, __int64 a2, __int64 a3, __int64 a4)
{
  NTSTATUS result; // eax
  ...
  if ( byte_140C5AE14 && a4 )
  {
    *(_QWORD *)&UserData.Size = 4LL;
    ...
    while ( v7 < 4 );
    return EtwWriteEx(RegHandle, &stru_140037EF0, 0LL, 0, 0LL, 0LL, 0x1Fu, &UserData);
  }
  return result;
}
