/*
 * XREFs of sub_140399184 @ 0x140399184
 * Callers:
...
__int64 __fastcall sub_140399184(__int64 a1, unsigned int a2)
{
  __int64 result; // rax
  __int64 v3; // rdi
  KIRQL v4; // al
  ...
  {
    v4 = KeAcquireSpinLockRaiseToDpc(&qword_140C23008);
    v5 = qword_140D068A8;
    v6 = 0;
    for ( i = v4; v6 < *(_DWORD *)qword_140D068A8; ++v6 )
    {
      v8 = 448LL * v6;
      v9 = v8 + v5 + 80;
      LOBYTE(v8) = 4;
      sub_1405C7F88(v9, v8, 0LL);
      v5 = qword_140D068A8;
    }
    if ( (_DWORD)v3 != -1 )
    {
      ...
      if ( *(_DWORD *)(v11 + 108) )
      {
        do
        {
          ...
          if ( *(_QWORD *)(v12 + 56) )
          {
            ...
            v18 = *((unsigned __int16 *)qword_140D01518 + 12 * v10 + 8) >> 1;
            v21[4] = &v18;
            v21[5] = 4LL;
            v13 = *((unsigned __int16 *)qword_140D01518 + 12 * v10 + 8);
            v21[6] = *((_QWORD *)qword_140D01518 + 3 * v10 + 3);
            v28 = &v19;
            v22 = v13;
            v23 = 0;
            v26 = v12 + 56;
