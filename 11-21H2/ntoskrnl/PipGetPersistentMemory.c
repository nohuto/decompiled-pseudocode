/*
 * XREFs of PipGetPersistentMemory @ 0x140941654
 * Callers:
 ...
 *     PipUnpackMetadata @ 0x14055F7CC (PipUnpackMetadata.c)
        ...
        int a8)
{
  ...
  v23 = 0LL;
  v24 = 0;
  DriverKsrGuid = PipGetDriverKsrGuid(a1, (__int64)&v68);
  if ( DriverKsrGuid >= 0 )
  {
    v61 = 0LL;
    DriverKsrGuid = KsrEnumeratePersistedMemory(&v68, PipEnumeratePersistedMemory, &v61);
    if ( DriverKsrGuid >= 0 )
    {
      if ( !DWORD2(v61) )
      ...
      *(_QWORD *)&v61 = ExAllocatePool2(64LL, 8LL * DWORD2(v61), 1634758224LL);
      ...
      if ( DWORD2(v61) )
      {
        ...
        while ( 1 )
        {
          ...
          if ( !Pool2 )
            goto LABEL_84;
          DriverKsrGuid = KsrQueryMetadata(&v68, v27, Pool2, BugCheckOnFailure, &BugCheckOnFailure);
          if ( DriverKsrGuid < 0 )
            goto LABEL_74;
...
LABEL_83:
          ...
          if ( *Pool2 == 2 )
          {
            DriverKsrGuid = PipMatchPersistentMemory(v10, v65, v64, (_DWORD)Pool2, 0, (__int64)&v53);
            if ( DriverKsrGuid < 0 )
              goto LABEL_74;
            v54 = v53;
            if ( !v53 )
              goto LABEL_60;
            PipUnpackMetadata((__int64)Pool2, 0LL, v66);
            v28 = v54;
          }
          else
          {
            if ( *Pool2 != 1 )
              goto LABEL_83;
            DriverKsrGuid = PipMatchPersistentMemoryV1(v10, Pool2, 0LL, &v53);
            if ( DriverKsrGuid < 0 )
              goto LABEL_74;
            v28 = v53;
            v54 = v53;
...
LABEL_84:
          ...
          DriverKsrGuid = KsrClaimPersistedMemory(&v68, v29, v31, v55, 0, &v55);
          if ( DriverKsrGuid < 0 )
            goto LABEL_74;
          v32 = 0LL;
          if ( v55 )
