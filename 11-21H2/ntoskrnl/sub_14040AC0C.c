/*
 * XREFs of sub_14040AC0C @ 0x14040AC0C
 * Callers:
...
unsigned __int64 __fastcall sub_14040AC0C(__int64 a1, unsigned __int64 a2, __int64 a3)
{
  ...
  v6 = a2 >> 5;
  if ( a2 >> 5 >= result )
    return sub_1403FDDE8(a3 + 32, 4 * result);
  v8 = 0LL;
  if ( result != v6 )
  {
    v9 = a3 - (4 * v6 + 4) - a1;
