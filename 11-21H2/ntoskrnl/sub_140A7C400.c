/*
 * XREFs of sub_140A7C400 @ 0x140A7C400
 * Callers:
...
__int64 __fastcall sub_140A7C400(_QWORD *TableContext, __int64 a2, int a3, char a4, PRTL_AVL_FREE_ROUTINE FreeRoutine)
{
  int v7; // r8d
  __int64 v8; // rax
  __int64 Pool2; // rax
  ...
  *((_BYTE *)TableContext + 28) = a4;
  if ( a3 || (a4 ? (v14 = 0) : (v14 = dword_140C1B258), a3 = a4 != 0 ? 24 : 16, !v14) )
    v7 = a3 + 32;
  else
    v7 = 1;
  *((_DWORD *)TableContext + 8) = v7;
  ...
  {
    v11 = (RTL_GENERIC_COMPARE_RESULTS (__cdecl *)(_RTL_AVL_TABLE *, PVOID, PVOID))sub_140251260;
    if ( !a4 )
      v11 = (RTL_GENERIC_COMPARE_RESULTS (__cdecl *)(_RTL_AVL_TABLE *, PVOID, PVOID))sub_1402512B0;
    v12 = 0LL;
    do
    {
      ...
      *(_QWORD *)(TableContext[2] + v12 + 112) = 0LL;
      RtlInitializeGenericTableAvl(
        ...
        v11,
        (PRTL_AVL_ALLOCATE_ROUTINE)sub_140373130,
        FreeRoutine,
        TableContext);
      ++v10;
      v12 += 192LL;
