/*
 * XREFs of CmpCommitPreparedLightWeightTransaction @ 0x14065D410
 * Callers:
...
void __fastcall CmpCommitPreparedLightWeightTransaction(__int64 a1, __int64 a2)
{
  ...
  if ( a1 )
  {
    ...
    if ( (unsigned int)dword_140C03868 > 5 && tlgKeywordOn((__int64)&dword_140C03868, 1LL) )
      tlgWriteTransfer_EtwWriteTransfer((__int64)&dword_140C03868, (unsigned __int8 *)byte_140029811, 0LL, 0LL, 2u, v9);
    ...
    if ( (unsigned int)dword_140C03868 > 5 )
    {
      if ( tlgKeywordOn((__int64)&dword_140C03868, 1LL) )
      {
        ...
        tlgWriteTransfer_EtwWriteTransfer(
          ...
          (unsigned __int8 *)byte_140029849,
          0LL,
          0LL,
          3u,
          v9);
