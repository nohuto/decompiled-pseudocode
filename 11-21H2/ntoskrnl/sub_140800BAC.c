/*
 * XREFs of sub_140800BAC @ 0x140800BAC
 * Callers:
...
__int64 sub_140800BAC(__int64 a1, __int64 a2, ...)
{
  wchar_t *v4; // rsi
  char *Pool2; // r14
  int v6; // ebx
  ...
  Pool2 = 0LL;
  v27 = 0;
  v6 = sub_140800E64(a2, 285212673LL, &P, &v28);
  if ( v6 >= 0 )
  {
    v6 = sub_140800E64(a2, 301989890LL, &Str, &v27);
    if ( v6 < 0 )
    {
      v4 = Str;
    }
    ...
    {
      v27 = 8;
      v31 = sub_140812D44(a2, 352321618, v7, (unsigned int)v34, (__int64)&v27);
      v26 = 2;
      v32 = sub_140812D44(a2, 369098836, v8, (unsigned int)va, (__int64)&v26);
      v26 = 2;
      v10 = sub_140812D44(a2, 369098822, v9, (unsigned int)v25, (__int64)&v26);
      v4 = Str;
      v33 = v10;
      ...
      if ( v11 )
      {
        ...
        if ( Pool2 )
        {
          ...
          v17 = v28;
          v6 = sub_140803250(a1, 285212673LL, v18, P, v28);
          if ( v6 >= 0 )
          {
            if ( !sub_1402201F8() || (v6 = sub_140803250(a1, 553648133LL, v19, P, v17), v6 >= 0) )
            {
              v6 = sub_140803250(a1, 301989890LL, v19, Pool2, (_DWORD)Str);
              if ( v6 >= 0 )
              {
                if ( v31 >= 0 )
                  sub_140803250(a1, 352321618LL, v20, v34, v27);
                v21 = v26;
                if ( v32 >= 0 )
                  sub_140803250(a1, 369098836LL, v20, (__int64 *)va, v26);
                if ( v33 >= 0 )
                  sub_140803250(a1, 369098822LL, v20, v25, v21);
                v6 = sub_140800F20(a1);
                if ( v6 >= 0 )
                {
                  v23 = v37;
                  if ( (_BYTE)KdDebuggerEnabled )
                    v23 = 1;
                  LOBYTE(v37) = v23;
                  v6 = sub_140803250(a1, 637534214LL, v22, (__int64 *)va1, 2);
                  if ( v6 >= 0 )
                    v6 = 0;
                }
              }
