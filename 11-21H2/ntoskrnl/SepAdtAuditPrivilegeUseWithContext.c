/*
 * XREFs of SepAdtAuditPrivilegeUseWithContext @ 0x14072427C
 * Callers:
 ...
 * Callees:
 *     SepAdtCheckPrivilegeForSensitivity @ 0x1405F4E30 (SepAdtCheckPrivilegeForSensitivity.c)
...
char __fastcall SepAdtAuditPrivilegeUseWithContext(unsigned int *a1, __int64 a2, __int64 a3, __int64 a4, _WORD *a5)
{
  ...
  v15 = v14;
  if ( (v13 || v14) && SepFilterPrivilegeAudits(0, a1) )
  {
