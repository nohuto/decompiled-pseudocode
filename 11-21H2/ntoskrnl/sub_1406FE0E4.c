/*
 * XREFs of sub_1406FE0E4 @ 0x1406FE0E4
 * Callers:
...
__int64 __fastcall sub_1406FE0E4(int *a1)
{
  ...
  result = sub_1406FE210(v2, (unsigned int)a1[7], 0LL, (unsigned int)a1[4], &v11, &v12);
  v4 = result;
  if ( (int)result >= 0 )
  {
    v5 = v11;
