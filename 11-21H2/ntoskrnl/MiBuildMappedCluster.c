/*
 * XREFs of MiBuildMappedCluster @ 0x14028B8B0
 * Callers:
...
char *__fastcall MiBuildMappedCluster(_QWORD *a1, char *a2, int a3)
{
  ...
  v76 = MiMapPageInHyperSpaceWorker(v7 & 0xFFFFFFFFFFLL, &v96, 0x80000000LL);
  LODWORD(v88) = v9;
  v13 = v76;
  v14 = v76 + (v9 & 0xFFF);
  v15 = v9;
...
LABEL_20:
    ...
    if ( v18 != 3 || (v35 = (unsigned __int64)v81, (__int64)(((char *)v81 - v5 - 48) & 0xFFFFFFFFFFFFFFF8uLL) < 128) )
    {
      ...
      if ( (*v20 & 0xC01) == 0x800 )
      {
        ...
        if ( v27 != MI_READ_PTE_LOCK_FREE(v93) )
        {
...
LABEL_41:
          ...
          {
            LOBYTE(v30) = 2;
            MiUnmapPageInHyperSpaceWorker(v76, v30, 0x80000000LL);
            LODWORD(v97) = MiReferencePageForModifiedWrite(v78);
            v32 = MiMapPageInHyperSpaceWorker(v87, 0LL, 0x80000000LL);
            v33 = v97;
            v13 = v32;
            v76 = v32;
            v93 = v32 + (v93 & 0xFFF);
          ...
          {
            v55 = MiReferencePageForModifiedWrite(v78);
            v13 = 0LL;
            v33 = v55;
            LODWORD(v97) = v55;
          }
    ...
    if ( v13 )
      MiUnmapPageInHyperSpaceWorker(v13, v96, 0x80000000LL);
    v36 = v80;
    if ( v19 >= v80 )
      goto LABEL_23;
    ...
    if ( v56 )
    {
      if ( v35 > (unsigned __int64)(v5 + 48) )
      {
        ...
        do
        {
          ...
          v95 = MiLockPageInline(v59);
          MiWriteCompletePfn(v59);
      ...
      MiReleaseWriteInProgressCharges(v83, v56, 1LL);
      v36 = v80;
    }
    if ( v17 == v15 + 8 )
    {
    ...
    v15 = v36;
    v13 = MiMapPageInHyperSpaceWorker(v87, &v96, 0x80000000LL);
    v76 = v13;
    v21 = v80;
...
LABEL_23:
  ...
  {
    Pool = (char *)MiAllocatePool(64, 8 * ((__int64)(v19 - v9) >> 3) + 48, 0x65576D4Du);
    v77 = Pool;
    if ( Pool )
    {
      v42 = a1;
      ...
      v44 = 1;
      v94 = 1;
      v97 = MiMapPageInHyperSpaceWorker(a1[5] & 0xFFFFFFFFFFLL, &v96, 0x80000000LL);
      v45 = v97;
      for ( i = (unsigned __int64 *)(v97 + (v9 & 0xFFF)); v9 < v19; v44 = v94 )
      {
          ...
          || (v54 = (unsigned __int64 *)v77, (__int64)(((char *)v43 - v77 - 48) & 0xFFFFFFFFFFFFFFF8uLL) < 128) )
        {
          ...
          if ( (*i & 0xC01) == 0x800 )
          {
            ...
            if ( v47 != MI_READ_PTE_LOCK_FREE(i) )
            {
...
LABEL_127:
              ...
              && v83 == *(_QWORD *)(qword_140C51F48 + 8 * ((*(_QWORD *)(v79 + 40) >> 43) & 0x3FFLL)) )
            {
              ...
              {
                LOBYTE(v50) = 2;
                MiUnmapPageInHyperSpaceWorker(v97, v50, 0x80000000LL);
                v94 = MiReferencePageForModifiedWrite(v79);
                v97 = MiMapPageInHyperSpaceWorker(v87, 0LL, 0x80000000LL);
              ...
              {
                v51 = MiReferencePageForModifiedWrite(v79);
                v45 = v97;
                v94 = v51;
              }
              if ( v51 )
...
LABEL_73:
        ...
        if ( v45 )
          MiUnmapPageInHyperSpaceWorker(v45, v96, 0x80000000LL);
        if ( v9 >= v15 )
          goto LABEL_77;
        ...
        if ( v67 )
        {
          if ( v43 > v54 + 6 )
          {
            ...
            do
            {
              ...
              v71 = (unsigned __int8)MiLockPageInline(v70);
              MiWriteCompletePfn(v70);
          ...
          MiReleaseWriteInProgressCharges(v83, v67, 1LL);
        }
        v82 = v90;
        v9 = v15;
        v97 = MiMapPageInHyperSpaceWorker(v42[5] & 0xFFFFFFFFFFLL, &v96, 0x80000000LL);
        v45 = v97;
