/*
 * XREFs of sub_140399A14 @ 0x140399A14
 * Callers:
...
unsigned __int64 __fastcall sub_140399A14(unsigned int a1, char a2, __int64 a3, unsigned int a4, char a5)
{
  __int64 v6; // rdi
  char v7; // r10
  unsigned int v8; // r8d
  ...
  {
    v14 = a1 - dword_140C4A418;
    v15 = __readmsr(0x38Fu);
    v16 = ~(15LL << (4 * ((unsigned __int8)a1 - (unsigned __int8)dword_140C4A418))) & __readmsr(0x38Du);
    if ( a2 )
    {
      v16 |= v6;
      if ( a5 )
