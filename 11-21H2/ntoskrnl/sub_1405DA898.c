/*
 * XREFs of sub_1405DA898 @ 0x1405DA898
 * Callers:
...
char __fastcall sub_1405DA898(__int64 a1, int a2, int a3, char a4)
{
  ...
  v21 = a2;
  v4 = &stru_140037978;
  v5 = (const EVENT_DESCRIPTOR *)qword_140037D88;
  if ( a4 )
    v5 = &stru_140037978;
  if ( byte_140C5AE30 )
  {
    v7 = qword_140C1F580;
    LOBYTE(v4) = EtwEventEnabled(qword_140C1F580, v5);
    if ( (_BYTE)v4 )
    {
