/*
 * XREFs of DifPsSetCreateProcessNotifyRoutineWrapper @ 0x14061A750
 * Callers:
 *     <none>
 * Callees:
...
NTSTATUS __fastcall DifPsSetCreateProcessNotifyRoutineWrapper(PCREATE_PROCESS_NOTIFY_ROUTINE NotifyRoutine, BOOLEAN a2)
{
  __int64 v4; // rdx
  __int64 v5; // rcx
...
LABEL_18:
  result = PsSetCreateProcessNotifyRoutine(NotifyRoutine, a2);
  DWORD2(v16) = result;
  if ( APIThunkContextById )
  {
