/*
 * XREFs of AstLogDeviceSDDLUpdated @ 0x140675814
 * Callers:
...
void __fastcall AstLogDeviceSDDLUpdated(__int64 a1)
{
  ...
  if ( dword_140C03958 )
  {
    ...
    SourceString = 0LL;
    Pool3 = 0LL;
    if ( (unsigned int)ObQuerySecurityObject(a1, -1, 0LL, 0, &v5) == -1073741789 )
    {
      v10 = 0;
      v9 = 0;
      v8 = 1LL;
      ...
      if ( Pool3 )
      {
        if ( (int)ObQuerySecurityObject(a1, -1, (__int64)Pool3, v5, &v5) < 0 )
        {
          v4 = L"Query failed";
        }
        else
