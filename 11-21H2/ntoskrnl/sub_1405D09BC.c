/*
 * XREFs of sub_1405D09BC @ 0x1405D09BC
 * Callers:
...
char __fastcall sub_1405D09BC(int a1, __int16 a2, const WCHAR *a3)
{
  _UNKNOWN **v3; // rax
  ...
  if ( byte_140C5AE14 )
  {
    LOBYTE(v3) = EtwEventEnabled(RegHandle, &stru_140038AD0);
    if ( (_BYTE)v3 )
    {
      ...
      UserData.Size = 4;
      v9 = 2;
      LOBYTE(v3) = EtwWriteEx(RegHandle, &stru_140038AD0, 0LL, 0, 0LL, 0LL, 3u, &UserData);
    }
  }
  return (char)v3;
}
