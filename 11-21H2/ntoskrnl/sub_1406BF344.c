/*
 * XREFs of sub_1406BF344 @ 0x1406BF344
 * Callers:
...
NTSTATUS __fastcall sub_1406BF344(unsigned __int16 *a1, int a2, int a3)
{
  ...
  if ( qword_140C16478 )
  {
    ...
    *(_QWORD *)&UserData.Size = 2LL;
    ...
    v11 = 4LL;
    v13 = 4LL;
    return EtwWrite(qword_140C16478, &stru_14000EAD0, 0LL, 4u, &UserData);
  }
  return result;
}
