/*
 * XREFs of sub_140B19FB4 @ 0x140B19FB4
 * Callers:
...
unsigned __int64 __fastcall sub_140B19FB4(ULONG_PTR BugCheckParameter2)
{
  ...
  {
    result = (unsigned __int64)sub_140297AE0(BugCheckParameter2, (__int64)&v7);
