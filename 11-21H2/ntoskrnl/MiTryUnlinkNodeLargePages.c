/*
 * XREFs of MiTryUnlinkNodeLargePages @ 0x1403872A4
 * Callers:
...
__int64 __fastcall MiTryUnlinkNodeLargePages(__int64 a1, ULONG_PTR a2, unsigned int a3, __int64 a4, char a5, int *a6)
{
  __int64 v7; // r12
  __int64 v8; // r14
  __int64 v9; // rdi
  ...
  _DWORD *v41; // r9
  int v42; // edx
  unsigned int PfnChannel; // [rsp+38h] [rbp-69h]
  ...
  v7 = 0LL;
  v49 = 0LL;
  v52 = MiLargePageSizes[a3];
  v8 = 48 * a2;
  v9 = *((unsigned int *)MiSearchNumaNodeTable(a2) + 2);
  v10 = v8 - 0x220000000000LL;
  PfnChannel = MiGetPfnChannel(v8 - 0x220000000000LL);
  v11 = 0;
  v56 = 24512 * v9;
  v44 = 0;
  ...
  while ( 1 )
  {
    if ( v11 )
    {
      ...
      if ( (*v23 & 0x40000000000000LL) == 0 )
        goto LABEL_25;
      if ( *((_DWORD *)MiSearchNumaNodeTable(v22) + 2) != (_DWORD)v9 )
        goto LABEL_25;
      v24 = v10 + v51;
      if ( (unsigned int)MiGetPfnChannel(v10 + v51) != PfnChannel
    ...
    else
    {
      if ( BugCheckParameter2 > qword_140C50840
        ...
        || *((_DWORD *)MiSearchNumaNodeTable(BugCheckParameter2) + 2) != (_DWORD)v9
        || (unsigned int)MiGetPfnChannel(v10) != PfnChannel )
      {
        goto LABEL_26;
      }
      v47 = 0;
      ...
      {
        do
          KeYieldProcessorEx(&v47, v16, v17, v18);
    ...
    if ( (unsigned int)MiGetPfnPageSizeIndex(v10) == a3 )
    {
      v19 = *(_BYTE *)(v10 + 34) & 7;
      if ( v19 <= 1u )
      {
        if ( !(unsigned int)MiUnlinkNodeLargePageHelper((_QWORD *)v46, v10, a3, PfnChannel, a5) )
        {
          if ( !v7 )
            *a6 = 0;
          goto LABEL_24;
    ...
    *a6 = v25;
    ...
    if ( (a5 & 0x40) != 0 )
    {
      ...
      *(_QWORD *)(v46 + 22792) = &v53;
      ...
      KeWaitForGate((__int64)v54, 0x12u);
    }
    else
    {
      ExReleaseSpinLockExclusiveFromDpcLevel(v26);
      ...
      if ( KiIrqlFlags )
      {
        if ( (KiIrqlFlags & 1) != 0 )
        {
          ...
          if ( v37 <= 0xFu && CurrentIrql <= 0xFu && v37 >= 2u )
          {
            ...
            v36 = (__int64)v38->SchedulerAssist;
      ...
      while ( *(_DWORD *)(v46 + 22788) )
        KeYieldProcessorEx(&v48, v34, v35, v36);
    }
    v11 = 0;
    v44 = 0;
