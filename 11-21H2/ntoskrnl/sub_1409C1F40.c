/*
 * XREFs of sub_1409C1F40 @ 0x1409C1F40
 * Callers:
...
__int64 __fastcall sub_1409C1F40(
        __int64 a1,
        __int64 a2,
        _WORD *a3,
        int a4,
            ...
            do
            {
              ...
              if ( v22 > 8 )
              {
                ...
                do
                {
                  ...
                  v32 -= 8;
                  v31 >>= 8;
                  v30 = *((unsigned __int8 *)qword_14001BBA0 + v34) | (v30 << 8);
                  --v33;
                }
                while ( v33 );
                v22 = v41;
              ...
              if ( v32 )
                v30 = (*((unsigned __int8 *)qword_14001BBA0 + (unsigned __int8)v31) | (v30 << 8)) >> (8 - v32);
