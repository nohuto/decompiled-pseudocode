/*
 * XREFs of sub_140999610 @ 0x140999610
 * Callers:
...
unsigned __int8 __fastcall sub_140999610(__int64 a1, unsigned int a2)
{
...
LABEL_24:
    if ( (unsigned int)dword_140C03A00 > 5 )
    {
      ...
      v35 = 1LL;
      v37 = 4LL;
      sub_14020A9C4((__int64)&dword_140C03A00, (unsigned __int8 *)&word_14003141E, 0LL, 0LL, 7u, &v27);
    }
    return v4;
  }
  *(_DWORD *)(a1 + 84) = a2;
  if ( dword_140C22308 == 1 )
  {
    if ( a2 )
    {
      v6 = 0LL;
...
LABEL_13:
    if ( dword_140C2230C != v5 )
    {
      if ( (unsigned int)dword_140C03A00 > 5 )
      {
        ...
        v13 = v5;
        v26 = 4LL;
        sub_14020A9C4((__int64)&dword_140C03A00, (unsigned __int8 *)&word_1400316C6, 0LL, 0LL, 5u, v20);
      }
      sub_140863B40(v5);
      dword_140C2230C = v5;
    }
  }
  else if ( (unsigned int)dword_140C03A00 > 2 )
  {
    v17 = a1;
    v21 = &v17;
    v13 = dword_140C22308;
    ...
    v23 = &v13;
    v24 = 4LL;
    sub_14020A9C4((__int64)&dword_140C03A00, (unsigned __int8 *)&dword_1400313C4, 0LL, 0LL, 4u, v20);
  }
  sub_140999154(a1, a2, &v16, &v15);
  v8 = v16;
  v9 = v15;
  ...
  if ( (unsigned int)dword_140C03A00 > 5 )
  {
    ...
    v42 = 4LL;
    v44 = 4LL;
    sub_14020A9C4((__int64)&dword_140C03A00, (unsigned __int8 *)byte_140031493, 0LL, 0LL, 5u, &v38);
    goto LABEL_24;
  }
  return v4;
}
