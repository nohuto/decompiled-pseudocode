/*
 * XREFs of sub_14081F9F4 @ 0x14081F9F4
 * Callers:
...
__int64 __fastcall sub_14081F9F4(__int64 a1, __int64 a2, __int64 *a3)
{
  _DWORD *v3; // r14
  int v4; // ebx
  unsigned int v5; // eax
  ...
  *a3 = 0LL;
  ...
  if ( !Pool2 )
    return 3221225626LL;
  P = (char *)ExAllocatePool2(256LL, 4LL * (unsigned int)*v3, 538996816LL);
  v10 = P;
  if ( !P )
  {
  ...
  for ( i = 0; (unsigned int)v12 < *v3; i = v12 )
  {
    v27 = (int *)&P[4 * v12];
    v30 = &Pool2[8 * v12];
    v8 = sub_14042A5E0(*(_QWORD *)(v29 + 8), v11);
    if ( v8 >= 0 && (v13 = *v27) != 0 )
    {
      v32 = 1;
    }
