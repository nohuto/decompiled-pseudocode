/*
 * XREFs of sub_14061CD10 @ 0x14061CD10
 * Callers:
 *     <none>
 * Callees:
...
NTSTATUS __fastcall sub_14061CD10(
        PHANDLE PortHandle,
...
LABEL_12:
  v25[0] = v19;
LABEL_13:
  v25[5] = PortAttributes;
  v25[4] = PortContext;
  v25[3] = ConnectionRequest;
  v25[2] = ConnectionMessageAttributes;
  LOBYTE(v25[1]) = AcceptConnection;
  v25[9] = PortHandle;
  v25[8] = ConnectionPortHandle;
  LODWORD(v25[7]) = Flags;
  v25[6] = ObjectAttributes;
