/*
 * XREFs of sub_140A996AC @ 0x140A996AC
 * Callers:
...
PVOID __fastcall sub_140A996AC(__int64 a1, __int64 a2, __int64 a3, _QWORD *a4)
{
  int v4; // ebp
  int v7; // r12d
  PVOID result; // rax
  ...
  while ( v10 != v9 )
  {
    ...
    {
LABEL_8:
      sub_140A99B3C(v12, 0LL);
      ++v7;
      *v12 = *a4;
      *a4 = v12;
    }
  }
  *((_DWORD *)qword_140D57500 + 8197) += v7;
  result = (PVOID)*(unsigned int *)(a1 + 4);
  if ( (unsigned __int16)result >= 0x100u )
  {
    v14 = *v9;
    while ( v14 != v9 && (unsigned __int16)*(_DWORD *)(a1 + 4) >= 0x100u )
    {
      v15 = v14 - 5;
      v14 = (_QWORD *)*v14;
      sub_140A99B3C(v15, 0LL);
      ++v4;
      *v15 = *a4;
      *a4 = v15;
    }
    result = qword_140D57500;
    *((_DWORD *)qword_140D57500 + 8198) += v4;
  }
  return result;
}
