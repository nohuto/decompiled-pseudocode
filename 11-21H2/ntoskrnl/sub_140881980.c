/*
 * XREFs of sub_140881980 @ 0x140881980
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall sub_140881980(void *a1, int a2, int a3)
{
  ...
  else
  {
    ...
    {
      v6 = Object;
      v7 = sub_1407A7EB0((_QWORD *)(*((_QWORD *)Object + 2) + 40LL), a3 & 0x7FFFFFFF, qword_140001580);
      v8 = v7;
      if ( v7 )
      {
        if ( sub_1407A59D8(v7) )
