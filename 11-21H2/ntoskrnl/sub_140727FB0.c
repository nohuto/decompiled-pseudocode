/*
 * XREFs of sub_140727FB0 @ 0x140727FB0
 * Callers:
...
__int64 __fastcall sub_140727FB0(
        UCHAR *a1,
        unsigned __int8 *a2,
        __int16 a3,
        unsigned __int8 a4,
...
LABEL_42:
  ...
  if ( a2 )
  {
    ...
    result = sub_140728450((int)a2, (int)a11, v23, v30, v31, a7, a8, a9, a10, v24, 0, a12, (__int64)&v40 + 4, Acl);
    v18 = HIDWORD(v40);
    v19 = HIDWORD(v40);
...
LABEL_22:
  ...
  if ( HIDWORD(v39) <= v37 )
    v35 = *a1;
  result = sub_140728DA0((int)a1, a4, a5, a7, a8, a9, a10, a11, a13, a14, a12, v33, (__int64)&v40, Acl, (__int64)&v39);
  if ( (_DWORD)result == -1073741789 )
  {
    v33 = 1;
LABEL_39:
