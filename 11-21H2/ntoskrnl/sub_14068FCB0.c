/*
 * XREFs of sub_14068FCB0 @ 0x14068FCB0
 * Callers:
...
__int64 __fastcall sub_14068FCB0(unsigned __int64 a1, unsigned int a2, int a3, _QWORD *a4, char a5, int a6)
{
  ...
  v12 = *(_QWORD *)(a1 + 8);
  if ( v12 <= 0xFFFFFFFF && 24 * (v12 + 8) <= 0xFFFFFFFF && v12 && v12 <= sub_14020DB30(0) + 1 && v13 <= v14 )
  {
