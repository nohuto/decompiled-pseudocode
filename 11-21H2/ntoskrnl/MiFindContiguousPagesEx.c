/*
 * XREFs of MiFindContiguousPagesEx @ 0x140277D10
 * Callers:
        ...
        __int64 *a13)
{
  ...
  {
    if ( !*(_QWORD *)(24512LL * a8 + *(_QWORD *)(v15 + 16) + 22608) && (_DWORD)InitializationPhase )
      return 3221225495LL;
    v20 = v92;
  }
  ...
  if ( (v16 & 0x20000000) == 0 )
  {
    if ( (int)MiAcquireNonPagedResources(v15, a6, 0LL, 2u) < 0 )
      return 3221225626LL;
    v20 = v92;
    v21 = a7;
    v18 = v91;
  ...
  if ( (v16 & 0x40) != 0 )
  {
    ...
    {
      v57 = v55;
      if ( a6 == MiLargePageSizes[v55] )
        break;
      v56 = v55 + 1;
      v97 = ++v55;
    }
    while ( (unsigned int)(v57 + 1) < 3 );
    LargeNodePage = MiFindLargeNodePage(v15, a8, (unsigned int)&v97, v56, v16, v18, v21);
    if ( LargeNodePage )
    {
      v59 = 0xAAAAAAAAAAAAAAABuLL * ((LargeNodePage + 0x220000000000LL) >> 4);
  ...
  else if ( (*(_DWORD *)(v15 + 4) & 0x20) != 0 || (unsigned int)MiSufficientAvailablePages(v15, a6 + 160) )
  {
    v103 = v16 & 0x10000000;
    if ( (v16 & 0x10000000) != 0 )
      goto LABEL_17;
    ...
    if ( a6 >= 2 )
      v23 = a6;
    MiCreatePteCopyList(2uLL, v23, (__int64)&v121);
    if ( DWORD1(v121) )
    {
LABEL_17:
      v87 = 0;
      if ( (v16 & 0xB800008) == 0x8000000 )
        v87 = InitializationPhase != 0;
      if ( a8 >= (unsigned __int16)KeNumberNodes )
        v86 = a8 | 0x80000000;
      v95 = (unsigned int *)MiReferencePageRuns(v15, 1u);
      v24 = v95;
      v118 = 0LL;
      v25 = -1;
      v106 = 0LL;
        ...
        if ( (unsigned int)MmNumberOfChannels > 1 )
        {
          ...
          else
          {
            if ( v25 == -1 )
            {
              ...
              if ( v28 <= v65 )
                v65 = v28;
              v66 = MiSearchNumaNodeTable(v65);
              v30 = 0LL;
              v24 = v95;
              v25 = *(_DWORD *)(v66 + 8);
              v106 = qword_140C506D8 + 4LL * v25 * (unsigned __int16)KeNumberNodes;
              v26 = v94;
              v31 = v86;
              v118 = (unsigned int *)(v106 + 4LL * (unsigned __int16)KeNumberNodes);
            }
            v67 = 24512LL * v25;
          }
          v68 = v27 + v67;
          ...
          if ( (_DWORD)v33 )
          {
            while ( 1 )
            {
              ...
              if ( ((int)v31 < 0 || (_DWORD)v34 == (_DWORD)v31) && (!v30 || (_DWORD)v35 == *v30) )
              {
                while ( 1 )
                {
                  if ( !(unsigned int)MiCollapseRunTopDown(&v107, v35)
                    || !*(_QWORD *)(*(_QWORD *)(v15 + 16) + 24512 * v34 + 22608) && (_DWORD)InitializationPhase )
                  {
                    v30 = v93;
                    LODWORD(v33) = v99;
                    v24 = v95;
                  ...
                  if ( !v114 )
                  {
                    v42 = MiPfnsWorthTrying(v15, 48 * (int)v40, v112, v88, (__int64)&v89);
                    if ( v42 )
                      goto LABEL_36;
                    v15 = v96;
                    if ( v89 )
                    {
                      ++dword_140C29E98;
                      MiEmptyKernelStackCache(v96, 0LL);
                    }
                  }
                  v42 = MiClaimPhysicalRun(v15, v40, v104, v110, (__int64)&v121, v88, -1, v92, a7, 0LL);
                  if ( v92 )
                  {
...
LABEL_51:
                    v46 = 1;
                    MiDereferencePageRunsEx((__int64)v95, 1);
                    MiReleasePteCopyList((__int64)&v121);
                    v47 = v102;
                    if ( v100 )
                    {
                      v50 = a7;
                    ...
                    else
                    {
                      ...
                      if ( v48 < v49 )
                        MiUpdateLargePageBitMap(v96, v48, v49 - v48, 1, 1);
                      v50 = a7;
                      MiConvertContiguousPages((unsigned __int64 *)(48 * v40 - 0x220000000000LL), v47, a7);
                    }
                    if ( (v88 & 0x40000000) == 0 )
                    {
                      v52 = 3 * v47;
                      ...
                      do
                      {
                        MiSetPfnOwnedAndActive(v41, v53, -8LL, v50, v46);
                        v41 += 48LL;
                      }
                      while ( v41 != v54 );
                    }
                  ...
                  if ( *(_QWORD *)(qword_140C51F48 + 8 * ((*(_QWORD *)(v41 + 40) >> 43) & 0x3FFLL)) == v96 )
                  {
                    ...
                    {
                      v70 = (unsigned __int8)MiLockPageInline(v45);
                      if ( MiIsPageOnBadList(48 * v40 - 0x220000000000LL) )
                      {
                        if ( v103 )
                        {
...
LABEL_142:
        ...
        if ( v76 && v90 )
        {
          ...
          {
            v123[1] = 16LL;
            v82 = *(_QWORD *)&KeGetCurrentThread()[1].CurrentRunTime;
            v124[1] = v102 << 12;
            v124[0] = v82;
            v123[0] = v124;
            EtwTraceKernelEvent((unsigned int)v123, 1, 537919488, 625, 4200962);
          }
          ++dword_140C29F7C;
          MiTrimNoStealPagesFromWorkingSets(v15, v26, v31, v24);
          v26 = v94;
          v25 = -1;
          v24 = v95;
          v27 = v119;
      ...
      v61 = -1073741801;
      MiDereferencePageRunsEx((__int64)v24, 1);
      v16 = v88;
      v14 = v102;
    }
    else
  ...
  if ( (v16 & 0x20000000) == 0 )
  {
    ...
    if ( (ULONG_PTR *)v15 == &MiSystemPartition )
    {
      ...
      {
        if ( CachedResidentAvailable + v14 <= 0x100 )
        {
          do
          {
            if ( v14 >= 0x80000 )
            ...
            v75 = (_DWORD)CachedResidentAvailable == v85;
        ...
        if ( (int)CachedResidentAvailable > 192
          && (_DWORD)CachedResidentAvailable == _InterlockedCompareExchange(
                                                  ...
                                                  CachedResidentAvailable) )
        {
          v14 += (int)CachedResidentAvailable - 192;
        }
      }
    }
    if ( v14 )
