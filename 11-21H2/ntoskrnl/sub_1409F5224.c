/*
 * XREFs of sub_1409F5224 @ 0x1409F5224
 * Callers:
...
__int64 __fastcall sub_1409F5224(unsigned int a1, __int64 a2, unsigned int a3, __int64 a4)
{
      ...
      if ( a1 )
      {
        ...
        while ( 1 )
        {
          ...
          else
          {
            ...
            *(_QWORD *)&v17 = v13 + a2;
            result = sub_1406CEEB0(v14, (__int64 *)&v17, v5, 0LL);
            if ( (int)result < 0 )
              return result;
            v5 = a4;
          }
