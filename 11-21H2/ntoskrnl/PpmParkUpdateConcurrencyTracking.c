/*
 * XREFs of PpmParkUpdateConcurrencyTracking @ 0x14081A4FC
 * Callers:
...
LABEL_12:
    ...
    v14[v9 + 1] |= v10;
LABEL_11:
    PopExecuteOnTargetProcessors((__int64)v14, (__int64)PpmIdleInstallConcurrency, *(_QWORD *)(v4 + 72), *v7);
    goto LABEL_12;
  }
  return result;
}
