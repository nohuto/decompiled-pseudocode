/*
 * XREFs of EtwpLogContextSwapEvent @ 0x1403ABB10
 * Callers:
...
LABEL_57:
    ...
    if ( (*(_DWORD *)(v11 + a1 + 4288) & 0x100) != 0 )
    {
      ...
      if ( (~v5 & v13) != 0 )
      {
        ...
        v37 = LoggerTimeStamp;
        LOBYTE(v4) = EtwpCCSwapTrace(a2, a3, v15, &v37);
        v5 |= v13;
      }
      v16 = v12;
LABEL_36:
      if ( a3 )
      {
        ...
        if ( (v29 & 0x80u) != 0 )
        {
          ...
          {
            LOBYTE(v4) = EtwpStackTraceDispatcher(v16, &v37, a3, 4217348LL);
            v29 = *(_DWORD *)(v16 + 816);
          }
        }
        if ( (v29 & 0x8000) != 0 )
        {
          ...
          if ( *(_DWORD *)(v4 + 8) )
          {
            ...
            LOBYTE(v4) = EtwpTraceLastBranchRecord(v16, &v37, a3, 4217348LL);
          }
        }
LABEL_46:
        if ( (*(_DWORD *)(v16 + 816) & 0x4000000) != 0 )
        {
          ...
          if ( *(_DWORD *)(v4 + 24) )
          {
            ...
            LOBYTE(v4) = EtwpTraceProcessorTrace(v16, &v37, a3, 4217348LL);
          }
        }
      }
      goto LABEL_57;
    ...
    if ( (v17 & 0x400) != 0 )
    {
      v18 = EtwpReserveWithPebsIndex(v12, 1316, 24, (unsigned int)&v35, (__int64)&v37, 4217348);
      goto LABEL_19;
    }
    if ( (v17 & 0x800) != 0 && (v22 = 0LL, *(_DWORD *)(*(_QWORD *)(v12 + 1016) + 8LL)) )
    {
      ...
      v18 = EtwpReserveWithPmcCounters(v12, 1316, 24, (unsigned int)&v35, (__int64)&v37, 4217348);
    }
    else
    {
LABEL_17:
      v24 = EtwpReserveTraceBuffer(v12, 0x28u, (__int64)&v35, (__int64 *)&v37, 4217348);
      if ( !v24 )
      {
LABEL_52:
        if ( (unsigned int)((__int64 (__fastcall *)(_QWORD, _QWORD, _QWORD, _QWORD))Feature_Servicing_PropagateFlagsThroughLostSystemEvent__private_IsEnabled)(
...
LABEL_32:
      ...
      LOBYTE(v4) = EtwpReleaseTraceBuffer((signed __int64 *)&v35);
      goto LABEL_36;
    }
    goto LABEL_52;
  }
