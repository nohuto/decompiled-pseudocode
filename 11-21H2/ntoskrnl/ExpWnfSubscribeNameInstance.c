/*
 * XREFs of ExpWnfSubscribeNameInstance @ 0x14079A254
 * Callers:
        ...
        _DWORD *a11)
{
  ...
  *a11 = 0;
  ...
  if ( a7 == 1 )
  {
    v15 = KeAbPreAcquire(v11 + 80, 0LL);
    if ( _InterlockedCompareExchange64((volatile signed __int64 *)(v11 + 80), 17LL, 0LL) )
      ExfAcquirePushLockSharedEx((signed __int64 *)(v11 + 80), 0, v15, v11 + 80);
    if ( v15 )
      *(_BYTE *)(v15 + 18) = 1;
