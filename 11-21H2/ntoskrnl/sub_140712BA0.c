/*
 * XREFs of sub_140712BA0 @ 0x140712BA0
 * Callers:
...
char __fastcall sub_140712BA0(__int64 a1, char *a2, unsigned int *a3, __int64 a4, int *a5, unsigned __int16 *a6)
{
  __int64 v10; // rcx
  __int64 v11; // rdx
  ...
  memset(v72, 0, 29);
  if ( dword_140C043A8 && sub_1402A2000((__int64)&dword_140C043A8, 0x200000000000LL) )
  {
    v10 = 1LL;
    v11 = 257LL;
  }
...
LABEL_9:
  ...
  {
    LOBYTE(v15) = sub_1402A2000((__int64)&dword_140C043A8, 0x400000000000LL);
    if ( (_BYTE)v15 )
    {
      v18 = *a2;
      v19 = v17;
      ...
      v125[0] = *v16;
      v125[1] = v17;
      sub_1402A2094((__int64)v126, (const WCHAR *)(a4 + 16));
      sub_1402A2094((__int64)v127, (const WCHAR *)(a4 + 272));
      v129 = 4LL;
      v131 = 4LL;
      v133 = 2LL;
      v45 = *a5;
      ...
      v71 = 50331648LL;
      v139 = 8LL;
      LOBYTE(v15) = sub_1402A1A20((__int64)&dword_140C043A8, (unsigned __int8 *)&byte_140034A4F, v43, 0x24u, &v73);
    }
  }
  return v15;
}
