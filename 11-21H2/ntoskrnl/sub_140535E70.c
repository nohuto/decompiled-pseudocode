/*
 * XREFs of sub_140535E70 @ 0x140535E70
 * Callers:
 *     <none>
 * Callees:
...
_WORD *__fastcall sub_140535E70(__int64 a1)
{
  ...
  if ( v1 )
  {
    ...
    *(_DWORD *)(a1 + 16) = v5 & 1 | *(_DWORD *)(a1 + 16) & 0xFFFFFF3A | (v4 == 0 ? 0x40 : 0) | (4
                                                                                              * ((32 * v6) | (((*((_BYTE *)qword_140037250 + (v4 & 0xF)) + *((_BYTE *)qword_140037250 + ((unsigned __int8)v4 >> 4))) & 1) == 0)));
  }
