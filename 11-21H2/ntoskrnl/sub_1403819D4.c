/*
 * XREFs of sub_1403819D4 @ 0x1403819D4
 * Callers:
...
__int64 __fastcall sub_1403819D4(__int64 *a1, __int64 a2, __int64 a3)
{
  int v4; // edx
  __int64 v6; // r8
  __int64 result; // rax
    ...
    if ( *(_QWORD *)a2 )
    {
      ...
      if ( *(_QWORD *)a2 != *a1 )
      {
        if ( v4 == -1 )
        {
          ...
          v27 = v14;
          v24 = (__int64)&v24;
          sub_140381130((__int64)a1, v19, (__int64)&v24);
          v21 = 2LL * (v14 - 2);
          v22 = *(&v24 + 2 * v14 - 3);
          v23 = *(&v24 + v21);
          sub_140237F80(a1, (__int64)&v24);
          v12 = v22 <= v23 + 16;
          v11 = v23 + 8;
          v13 = v22 - 8;
        }
