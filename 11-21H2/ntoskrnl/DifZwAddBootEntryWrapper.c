/*
 * XREFs of DifZwAddBootEntryWrapper @ 0x14061C7E0
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall DifZwAddBootEntryWrapper(__int64 a1, __int64 a2)
{
  __int64 v4; // rdx
  __int64 v5; // rcx
  ...
  v15 = 0LL;
  v16 = 0LL;
  APIThunkContextById = DifGetAPIThunkContextById(481);
