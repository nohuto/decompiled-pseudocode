/*
 * XREFs of MiPatchDataPagesCallback @ 0x1409766B0
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall MiPatchDataPagesCallback(__int64 *a1, unsigned int a2, unsigned int a3, _BYTE *a4)
{
  unsigned int v6; // ebp
  unsigned int v7; // esi
  ...
  *a4 = 0;
  ...
  if ( RtlAreBitsSetEx((__int64)(a1 + 6), a2 >> 12, (unsigned int)v8) )
  {
    *a4 = 1;
    ...
    {
      MiSetImageProtection(*a1, *(_QWORD *)(*a1 + 48) + (v6 << 12), (_DWORD)v8 << 12, 4LL);
