/*
 * XREFs of sub_140626420 @ 0x140626420
 * Callers:
 *     <none>
 * Callees:
...
NTSTATUS __fastcall sub_140626420(POBJECT_ATTRIBUTES NewFile, HANDLE TargetHandle, POBJECT_ATTRIBUTES OldFile)
{
  __int64 v6; // rdx
  __int64 v7; // rcx
  __int64 *v8; // rdi
