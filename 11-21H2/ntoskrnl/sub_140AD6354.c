/*
 * XREFs of sub_140AD6354 @ 0x140AD6354
 * Callers:
 ...
 *     sub_140B50F4C @ 0x140B50F4C (sub_140B50F4C.c)
 */
...
char sub_140AD6354()
{
  ...
  {
    v84 = 1392508928;
    SubStr[0] = __ROR4__(1392508928, 184);
    v85 = 8537017;
    SubStr[1] = __ROR4__(8519680, 49);
    v86 = 4480;
    SubStr[2] = __ROL4__(4480, 186);
    v73 = 671088642;
    SubStr[3] = __ROR4__(671088642, 187);
    v74 = 134235069;
    SubStr[4] = __ROR4__(134217729, 58);
    v75 = 632;
    SubStr[5] = __ROL4__(632, 189);
    v76 = -1073741805;
    SubStr[6] = __ROR4__(-1073741805, 190);
    v77 = 16671;
    SubStr[7] = __ROR4__(672, 67);
    v78 = 58;
    SubStr[8] = __ROL4__(58, 192);
    SubStr[9] = 0;
    v1 = (const char *)sub_140B50F4C();
    Pool2 = (unsigned __int64)strstr(v1, SubStr);
    if ( !Pool2 )
    {
      ...
      *((_QWORD *)&v5 + 1) = (((unsigned __int64)v5 ^ *((_QWORD *)&v5 + 1)) * (unsigned __int128)0x47AE147AE147AE15uLL) >> 64;
      ...
      v80 = v7;
      if ( v7 >= 0x32 )
        LODWORD(v4) = (unsigned int)sub_140657010;
      LOBYTE(v8) = v7 >= 0x32;
      v79 = v8;
      v9 = (_DWORD *)sub_1402D6F40((unsigned __int64)v2, 0x140000000LL, (unsigned int)v4 - 0x40000000);
      v10 = (unsigned int *)sub_140419FB8((unsigned __int64)v9, v82, &v83);
      if ( !v10 || v83 < 0xC )
      {
        v18 = -1073741701LL;
LABEL_65:
        KeBugCheckEx(__ROR4__(664797184, 149), 6uLL, (ULONG_PTR)v9, v18, 0LL);
      }
      v11 = 0LL;
      v12 = 0;
      v13 = v9[3];
      ...
      if ( v21 - Pool2 < 5 )
      {
        ...
        if ( Pool2 )
        {
          ...
          *(_QWORD *)(Dpc + 152) = v61;
          *(_DWORD *)(Dpc + 144) = v48;
          *(_DWORD *)(Dpc + 176) = sub_140B50F00(v43, v62, v61, v49) != 0;
          if ( v7 >= 0x32 )
          {
            *(_QWORD *)(Dpc + 184) = 0LL;
            *(_QWORD *)(Dpc + 200) = sub_140657010;
            *(_QWORD *)(Dpc + 208) = Dpc;
          }
          v66 = __rdtsc();
          v67 = __ROR8__(v66, 3);
