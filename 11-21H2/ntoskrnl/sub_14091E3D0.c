/*
 * XREFs of sub_14091E3D0 @ 0x14091E3D0
 * Callers:
...
__int64 __fastcall sub_14091E3D0(void *a1, char a2, unsigned int a3, UNICODE_STRING *a4)
{
  unsigned int v8; // edi
  const WCHAR *v9; // rdx
...
LABEL_10:
    ...
    if ( sub_140566F64(v8, (__int64)&SourceString)
