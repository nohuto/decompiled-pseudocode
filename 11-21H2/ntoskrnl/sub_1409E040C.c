/*
 * XREFs of sub_1409E040C @ 0x1409E040C
 * Callers:
...
NTSTATUS __fastcall sub_1409E040C(__int64 a1, __int64 a2, unsigned __int8 a3)
{
  __int64 v3; // rcx
  ...
  *(_QWORD *)&UserData.Size = 16LL;
  ...
  v16 = v3 + a2 + 136;
  v17 = 4LL;
  return EtwWrite(qword_140C15FA8, &stru_1400388A8, 0LL, 7u, &UserData);
}
