/*
 * XREFs of AlpcpReplyLegacySynchronousRequest @ 0x1406652DC
 * Callers:
...
__int64 __fastcall AlpcpReplyLegacySynchronousRequest(__int64 a1, __int128 *a2, char a3)
{
  ...
  if ( a3 )
  {
    ...
    LOBYTE(v5) = 1;
    v6 = AlpcpValidateMessage(&v32, v5);
    v30 = v6;
    if ( v6 < 0 )
      return (unsigned int)v6;
    if ( WORD3(v32) )
    {
      v6 = AlpcpValidateDataInformation(v3, &v32);
      v30 = v6;
      if ( v6 < 0 )
        return (unsigned int)v6;
    }
  ...
  else
  {
    ...
    LODWORD(v34) = 0;
    LOBYTE(a2) = 1;
    v6 = AlpcpValidateMessage(&v32, a2);
    if ( v6 < 0 )
      return (unsigned int)v6;
  }
  v6 = AlpcpLookupMessage(v4, DWORD2(v33), v34, v7, (__int64)&v36);
  v30 = v6;
  if ( v6 < 0 )
    return (unsigned int)v6;
  v8 = v36;
  ...
  if ( (v9 & 0x80u) != 0 )
  {
    AlpcpCancelMessage(v4, v36, 0x10000);
...
LABEL_33:
  if ( !v15 )
    goto LABEL_27;
  v18 = AlpcpAvailableBufferSize(v8, (__int16)v32);
  if ( v19 > v18 )
  {
    v6 = AlpcpCaptureMessageData(v8, v19, (char *)v3 + 40);
    v30 = v6;
  }
  else
  {
  ...
  if ( v6 >= 0 )
  {
    *(_DWORD *)(v8 + 40) |= 0x8000u;
    ...
    v21 = v36;
    v22 = *(_QWORD *)(v36 + 24);
    AlpcpRemoveMessageFromPendingQueue(v36, v20);
    *(_DWORD *)(v21 + 240) = v32;
    *(_WORD *)(v21 + 244) = 2;
    v23 = v36;
    *(_OWORD *)(v36 + 248) = *(_OWORD *)&KeGetCurrentThread()[1].CycleTime;
    *(_DWORD *)(v8 + 40) |= 0x200u;
    ...
    *(_DWORD *)(v8 + 40) = *(_DWORD *)(v8 + 40) & 0xFFFF7EF8 | 0x105;
    ...
    if ( (*(_DWORD *)(a1 + 48) & 4) != 0 )
      *(_QWORD *)(a1 + 24) = v27;
      ...
      KeReleaseSemaphoreEx((volatile signed __int32 *)(v27 + 1240), 1LL, 1LL, v28, 2);
    return v30;
  }
  else
  {
