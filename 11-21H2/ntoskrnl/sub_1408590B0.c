/*
 * XREFs of sub_1408590B0 @ 0x1408590B0
 * Callers:
...
__int64 __fastcall sub_1408590B0(
        _QWORD *a1,
        ULONG_PTR a2,
        ...
        __int128 *a11)
{
  ...
  v20 = 0LL;
  if ( !a3 || !sub_1402585E8((__int64)a11, 0) )
    return 3221225485LL;
  v15 = a8;
  if ( a8 )
  {
...
LABEL_5:
  ...
  HIDWORD(v21[0]) = a6;
  v21[2] = v16;
  result = HalGetVectorInput(a6, (__int64)&v21[2]);
  if ( (int)result >= 0 )
  {
    ...
    *a1 = 0LL;
    ...
    if ( (BYTE4(v21[4]) & 1) == 0 )
      v17 = a10;
    DWORD1(v21[1]) = 0;
    result = sub_140817258(&v20, a2, a3, 0LL, a4, 0, a5, v15, v17, v19, (__int64)v21);
    if ( (int)result >= 0 )
      *a1 = v20 + 112;
  }
  return result;
