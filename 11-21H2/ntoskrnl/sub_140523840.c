/*
 * XREFs of sub_140523840 @ 0x140523840
 * Callers:
 *     <none>
 * Callees:
...
unsigned __int64 __fastcall sub_140523840(_WORD *Src, __int128 *a2, _DWORD *a3, size_t *a4, void *a5)
{
  __int64 v10; // rax
  size_t v11; // rbx
