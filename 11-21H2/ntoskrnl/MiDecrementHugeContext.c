/*
 * XREFs of MiDecrementHugeContext @ 0x14025E544
 * Callers:
...
void __fastcall MiDecrementHugeContext(__int64 a1, __int64 a2, __int64 a3)
{
  bool v3; // zf
  __int64 *v7; // rdx
  __int64 v8; // rax
    ...
    *(_QWORD *)(v8 + 8) = v9;
    if ( *(_DWORD *)(a2 + 328) != 512 )
    {
      ...
      else
      {
        ...
        if ( !v17 )
          goto LABEL_31;
        v11 = (unsigned __int8)MiLockPageInline(*(_QWORD *)(a2 + 24));
        MiStopPageAccessor(v17, 0LL);
...
LABEL_31:
          if ( a3 )
            MiReleaseLargeZeroingVa(a3, 1LL);
          goto LABEL_7;
        }
        v16 = v19;
      }
