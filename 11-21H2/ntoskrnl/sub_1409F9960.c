/*
 * XREFs of sub_1409F9960 @ 0x1409F9960
 * Callers:
 *     <none>
 * Callees:
...
int __fastcall sub_1409F9960(__int64 a1, _DWORD *a2, void *a3, unsigned int a4, _DWORD *a5, _BYTE *a6)
{
  int result; // eax
  ...
  result = sub_14085E124(a1, (UNICODE_STRING *)L"\"$", a2, a3, a4, a5, a6);
