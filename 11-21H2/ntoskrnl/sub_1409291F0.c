/*
 * XREFs of sub_1409291F0 @ 0x1409291F0
 * Callers:
 *     <none>
 * Callees:
...
NTSTATUS __fastcall sub_1409291F0(HANDLE Handle, int a2, int *a3, unsigned int a4, unsigned __int64 a5)
{
  KPROCESSOR_MODE v7; // r11
...
LABEL_16:
  ...
  if ( a4 == 4 )
  {
    ...
    {
      Object = 0LL;
      result = ObReferenceObjectByHandle(Handle, 4u, qword_140D05120, v7, &Object, 0LL);
      if ( result >= 0 )
      {
        v13 = (char *)Object;
