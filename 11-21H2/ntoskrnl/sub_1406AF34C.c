/*
 * XREFs of sub_1406AF34C @ 0x1406AF34C
 * Callers:
 ...
 *     sub_1406AF66C @ 0x1406AF66C (sub_1406AF66C.c)
 */

__int64 __fastcall sub_1406AF34C(unsigned __int64 a1, __int64 a2)
{
  __int64 v3; // rax
  __int64 result; // rax
  __int64 v5; // r14
  ...
  if ( *(_BYTE *)(a1 + 81) >= 6u )
    return 3600LL;
  result = sub_1406AF66C(a1, a2, &v18);
  if ( !(_DWORD)result )
  {
    if ( (unsigned __int8)sub_1406AF62C((unsigned int)&v18, *(_DWORD *)(a1 + 32), 40 * *(_DWORD *)(a1 + 8), 8, 1) )
    {
      _mm_lfence();
      v5 = 0LL;
      ...
      if ( *(_DWORD *)(a1 + 8) )
      {
        while ( 1 )
        {
          ...
          result = sub_1406AF5A0(a1, &v18, &v17);
          if ( (_DWORD)result )
            break;
          ...
          if ( !(unsigned __int8)sub_1406AF62C((unsigned int)&v18 + 12, *(_DWORD *)(v6 + 40 * v5 + 16), 48 * v7, 8, 1) )
            return 15000LL;
          v10 = 0LL;
          v11 = a1 + v8;
          if ( v9 )
          {
            do
            {
              ...
              if ( v12[8] || v12[10] )
              {
                result = sub_1406AF5A0(a1, &v18, v12 + 8);
                if ( (_DWORD)result )
                  return result;
              }
              result = sub_1406AF268(a1, (__int64)&v18, v12 + 4, (*v12 & 1) != 0 ? 512 : 4096);
              if ( (_DWORD)result )
                return result;
...
LABEL_22:
        ...
        if ( (unsigned __int8)sub_1406AF62C(
                                (unsigned int)&v20 + 4,
                                *(_DWORD *)(a1 + 56),
                                40 * *(_DWORD *)(a1 + 20),
                                8,
