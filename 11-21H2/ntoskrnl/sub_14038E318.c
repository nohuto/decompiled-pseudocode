/*
 * XREFs of sub_14038E318 @ 0x14038E318
 * Callers:
...
__int64 __fastcall sub_14038E318(
        __int64 a1,
        __int64 a2,
        unsigned int a3,
        int a4,
        ...
        int a7)
{
  ...
  while ( 1 )
  {
    ...
    if ( _interlockedbittestandset64(v14 + 6, 0x3FuLL) )
      break;
    v16 = 0xAAAAAAAAAAAAAAABuLL * ((__int64)(v14 + 0x88000000000LL) >> 4);
    *((_BYTE *)v14 + 34) = *((_BYTE *)v14 + 34) & 0xF8 | 1;
    ...
    if ( *(volatile signed __int32 **)(*(_QWORD *)v14 + 8LL) != v14
      ...
      || (*v18 = (volatile signed __int32 *)v17,
          v17[1] = (volatile signed __int32 *)v18,
          v19 = *(volatile signed __int32 ***)(v13 + 8),
    ...
    *(_QWORD *)(v13 + 8) = v14;
    v20 = 1072 * v7;
    ++*(_QWORD *)(v20 + a2 + 8);
    v21 = 1072 * v7 + (v16 < 0x100000 ? 40LL : 24LL);
    ++*(_QWORD *)(v21 + a2);
    --*(_QWORD *)(v20 + a2);
    v22 = 1072 * v7 + (v16 < 0x100000 ? 32LL : 16LL);
    --*(_QWORD *)(v22 + a2);
    ++*(_QWORD *)(v13 + 16);
    v12[2] = (volatile signed __int32 *)((char *)v12[2] - 1);
    ++*(_QWORD *)(a2 + 8 * v11 + 176);
    --*(_QWORD *)(a2 + 8 * v11 + 48);
    _InterlockedExchangeAdd64((volatile signed __int64 *)(a1 + 2496), -(__int64)v10);
    _InterlockedExchangeAdd64((volatile signed __int64 *)(a1 + 2624), v10);
