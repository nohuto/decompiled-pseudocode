/*
 * XREFs of sub_140937CC0 @ 0x140937CC0
 * Callers:
...
__int64 __fastcall sub_140937CC0(__int64 a1, __int64 a2, unsigned __int16 *a3, IRP *a4, PVOID P, __int16 a6)
{
  void *v6; // r13
  void *Pool2; // r14
  ...
  *(_WORD *)(a1 + 90) = v15;
  ...
  if ( v16 < 0 )
    ...
    return (unsigned int)sub_1406B9A14(
                           a4,
                           (UNICODE_STRING *)a2,
                           0,
                           v13,
