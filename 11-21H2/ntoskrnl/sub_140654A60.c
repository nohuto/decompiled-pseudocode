/*
 * XREFs of sub_140654A60 @ 0x140654A60
 * Callers:
 *     sub_140A04C34 @ 0x140A04C34 (sub_140A04C34.c)
 * Callees:
 *     sub_140654BD8 @ 0x140654BD8 (sub_140654BD8.c)
 */

__int64 __fastcall sub_140654A60(__int64 a1, __int64 a2, int a3, int a4, __int64 a5, int a6)
{
  __int64 v8; // r8
  __int64 v9; // rcx
