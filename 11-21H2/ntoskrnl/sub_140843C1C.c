/*
 * XREFs of sub_140843C1C @ 0x140843C1C
 * Callers:
...
__int64 __fastcall sub_140843C1C(wchar_t *a1, unsigned int a2, unsigned int *a3)
{
  int v3; // ebx
  ...
  v3 = sub_1402E0198(
         ...
         *a3,
         ...
         v14);
  if ( v3 < 0 )
    sub_1406E0C3C(1LL, (__int64)"AslGuidToString");
  else
    return 0;
