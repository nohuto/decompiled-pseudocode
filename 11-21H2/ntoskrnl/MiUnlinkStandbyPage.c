/*
 * XREFs of MiUnlinkStandbyPage @ 0x14038EB20
 * Callers:
...
__int64 __fastcall MiUnlinkStandbyPage(__int64 a1, __int64 a2, ULONG_PTR a3, unsigned __int64 a4, unsigned int a5)
{
  ULONG_PTR v9; // rdi
  __int64 v10; // rdx
  __int64 v11; // r9
...
LABEL_3:
  if ( (*(_BYTE *)(v9 + 35) & 8) != 0 )
  {
    MiUnlinkProtectedStandbyPfn(v9);
    v12 = 1;
  }
  else
  {
    ...
    if ( v10 == 0x3FFFFFFFFFLL )
      *(_QWORD *)(a3 + 24) = v11;
      ...
      MiSetPfnBlink(48 * v10 - 0x220000000000LL, v11, 0);
  }
  MiUnlinkNumaStandbyPage(v9);
  if ( v12 )
    *(_BYTE *)(v9 + 35) &= ~8u;
  MiReleasePageListLock(a3, a2);
  v13 = MiDecreaseAvailablePages(a1, 1LL, 0xFFFFFFFFFFFFFFFFuLL, a5);
