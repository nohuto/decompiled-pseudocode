/*
 * XREFs of sub_140929380 @ 0x140929380
 * Callers:
 *     <none>
 * Callees:
 ...
 *     sub_1409277F4 @ 0x1409277F4 (sub_1409277F4.c)
 *     sub_140927AE4 @ 0x140927AE4 (sub_140927AE4.c)
 */

NTSTATUS __fastcall sub_140929380(HANDLE Handle, BOOLEAN a2, LARGE_INTEGER *a3, _OWORD *a4)
{
  ...
  Object = 0LL;
  result = ObReferenceObjectByHandle(Handle, 1u, qword_140D05120, v7, &Object, 0LL);
  if ( result >= 0 )
  {
    v10 = 0LL;
    v27 = 0LL;
    ...
    while ( 1 )
    {
      v19 = KeWaitForSingleObject(v12, Executive, v7, v11, Timeout);
...
LABEL_24:
      ...
      if ( v13 )
      {
        sub_140927AE4((__int64)v28, v10, v27);
