/*
 * XREFs of sub_140AD52B0 @ 0x140AD52B0
 * Callers:
...
volatile signed __int32 *__fastcall sub_140AD52B0(unsigned __int64 a1, char a2)
{
  ...
  v7 = *(_QWORD *)(a1 + 360);
  if ( v7 >= (unsigned __int64)&loc_140AD43B6 && v7 < (unsigned __int64)&loc_140AD43BB )
  {
    v4 |= 4u;
    _InterlockedIncrement((volatile signed __int32 *)&KeGetPcr()->NtTib.ExceptionList[152]);
  }
  if ( v7 >= (unsigned __int64)&loc_140AD43E0 && v7 < (unsigned __int64)algn_140AD43E5 )
  {
    v4 |= 4u;
    _InterlockedIncrement((volatile signed __int32 *)&KeGetPcr()->NtTib.ExceptionList[152]);
  }
...
LABEL_23:
  if ( (v4 & 4) != 0 )
  {
    ...
    *(_QWORD *)(a1 + 48) = *(PEXCEPTION_ROUTINE *)((char *)&ExceptionList[2].Handler + v10);
    *(_QWORD *)(a1 + 56) = *(_EXCEPTION_REGISTRATION_RECORD **)((char *)&ExceptionList[3].Next + v10);
    *(_QWORD *)(a1 + 64) = *(PEXCEPTION_ROUTINE *)((char *)&ExceptionList[3].Handler + v10);
    result = (volatile signed __int32 *)KeGetPcr()->NtTib.ExceptionList;
  ...
  if ( !a2 )
  {
    ...
    *(PEXCEPTION_ROUTINE *)((char *)&ExceptionList[2].Handler + v10) = *(PEXCEPTION_ROUTINE *)(a1 + 48);
    ...
    *(PEXCEPTION_ROUTINE *)((char *)&ExceptionList[3].Handler + v10) = (PEXCEPTION_ROUTINE)result;
  }
  return result;
}
