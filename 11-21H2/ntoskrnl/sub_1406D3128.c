/*
 * XREFs of sub_1406D3128 @ 0x1406D3128
 * Callers:
 *     NtSetInformationFile @ 0x1402F72B0 (NtSetInformationFile.c)
 *     sub_1406D3128 @ 0x1406D3128 (sub_1406D3128.c)
 * Callees:
 *     IoGetTransactionParameterBlock @ 0x14021D040 (IoGetTransactionParameterBlock.c)
...
__int64 __fastcall sub_1406D3128(
        ...
        KPROCESSOR_MODE AccessMode)
{
  ...
  NTSTATUS v24; // eax
  int v25; // eax
  PVOID v27; // [rsp+48h] [rbp-2C0h] BYREF
  PVOID P; // [rsp+50h] [rbp-2B8h]
  __int64 v29; // [rsp+58h] [rbp-2B0h]
  PVOID v30; // [rsp+60h] [rbp-2A8h]
  ...
  if ( AccessMode )
  {
    Pool2 = (unsigned int *)ExAllocatePool2(289LL, a4, 538996553LL);
    P = Pool2;
    memmove(Pool2, a3, a4);
  }
  else
...
LABEL_88:
  ...
  v11 = sub_14024F418(a4, 0xCu, (int *)&v27);
  v13 = 0;
  if ( v11 < 0 )
  {
    if ( AccessMode )
      ...
      if ( (Object->DeviceObject->Characteristics & 0x10) != 0 )
      {
        ...
        if ( *(_QWORD *)Pool2 )
        {
          ...
          if ( *(_QWORD *)Pool2 )
          {
            ...
            {
              v15 = sub_1406D3ACC(v9);
              if ( v15 < 0 )
                goto LABEL_14;
              v15 = sub_1406D3ACC(v9);
              if ( v15 < 0 )
                goto LABEL_14;
              sub_140934B20(Src, v36, v38, Pool2);
              v17 = a5;
              v23 = sub_1406D3128(Object, (__int64)a5, 0);
              goto LABEL_53;
            }
            v22 = sub_14093449C(v9);
LABEL_49:
            v15 = v22;
            if ( v22 < 0 )
              goto LABEL_14;
            ...
            sub_140934B20(Src, v36, v38, Pool2);
            v17 = a5;
            v15 = sub_1406D3128(Object, (__int64)a5, 0);
            if ( v15 < 0 )
              goto LABEL_80;
            v23 = sub_1406D3ACC(Object);
LABEL_53:
            v15 = v23;
            if ( v23 >= 0 )
            {
...
LABEL_15:
            ...
            if ( !IoGetTransactionParameterBlock(Object) && (!*(_QWORD *)Pool2 || !IoGetTransactionParameterBlock(v9)) )
            {
              v15 = sub_14093449C(v9);
              if ( v15 >= 0 )
              {
                v15 = sub_14093449C(Object);
                if ( v15 >= 0 )
                {
                  v15 = sub_1406D3ACC(Object);
                  if ( v15 >= 0 )
                  {
                    v38[0] = v36[2];
                    v38[1] = v36[3];
...
LABEL_79:
          ...
          if ( (int)sub_1406D3ACC(Object) >= 0 && RtlCompareMemoryUlong(&v36[4], 0x10uLL, 0) != 16 )
          {
            if ( IoGetTransactionParameterBlock(Object) || *(_QWORD *)Pool2 && IoGetTransactionParameterBlock(v9) )
              goto LABEL_79;
            v22 = sub_1406D3ACC(v9);
            goto LABEL_49;
          }
LABEL_47:
          v15 = 0;
        ...
        v35 = v36[5];
        LOBYTE(v33) = _mm_cvtsi128_si32((__m128i)v36[3]) & 0xFE;
        v24 = sub_140935044(v37, &v32, Pool2);
      }
      v15 = v24;
      goto LABEL_14;
    }
