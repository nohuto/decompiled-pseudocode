/*
 * XREFs of sub_1409A9BF0 @ 0x1409A9BF0
 * Callers:
...
void __fastcall sub_1409A9BF0(int a1, __int64 a2, __int64 a3, __int64 a4, __int64 a5, __int64 a6, char a7, char a8)
{
  __int64 v9; // rdx
  __int64 v10; // r9
  int v11; // r10d
  ...
  if ( (unsigned int)dword_140D3B908 > 5 )
  {
    if ( sub_1402A2000((__int64)&dword_140D3B908, 1LL) )
    {
      ...
      v18 = 0;
      v33 = 4LL;
      sub_14020A9C4((__int64)&dword_140D3B908, (unsigned __int8 *)&byte_14003381F, 0LL, 0LL, 0xAu, &v21);
    }
  }
}
