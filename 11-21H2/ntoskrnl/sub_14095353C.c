/*
 * XREFs of sub_14095353C @ 0x14095353C
 * Callers:
...
char __fastcall sub_14095353C(__int64 a1, __int64 a2)
{
  _QWORD *v4; // rdx
  char v5; // bl
  _QWORD *v6; // r8
  ...
  if ( v13 != v14 && (!v13 || !v14 || !(unsigned __int8)sub_140957E34(v13, v14, 1u)) )
    return 1;
  v15 = *(const WCHAR **)(a1 + 32);
  v16 = *(const WCHAR **)(a2 + 48);
  if ( v15 != v16 && (!v15 || !v16 || !(unsigned __int8)sub_140957E34(v15, v16, 1u)) )
    return 1;
  return v5;
}
