/*
 * XREFs of HsaIommuSendCommand @ 0x140532A28
 * Callers:
 *     HsaDismissPageFault @ 0x1405316B0 (HsaDismissPageFault.c)
 *     HsaFlushDeviceTbOnly @ 0x140531930 (HsaFlushDeviceTbOnly.c)
  ...
  *(_QWORD *)(v8 + 8200) = ((unsigned int)v9 ^ (16 * (_DWORD)v15)) & 0x7FFF0 ^ v9;
  ...
  if ( (_BYTE)result == 1 )
  {
    ...
    while ( 1 )
    {
      ...
      if ( !result )
        break;
      if ( (++v18 & dword_140C4C47C) != 0 || !qword_140C4C480 )
        _mm_pause();
      else
        qword_140C4C480(v18, v11, v14);
    }
  }
  if ( !a3 )
  {
