/*
 * XREFs of sub_1405D9F60 @ 0x1405D9F60
 * Callers:
...
void __fastcall sub_1405D9F60(unsigned __int16 *a1)
{
  ...
  if ( byte_140C5AE30 && EtwEventEnabled(qword_140C1F580, &stru_140038050) )
  {
    v2 = *a1;
    v3 = 0;
    v4 = 0;
    ...
    *(_QWORD *)&UserData[0].Size = 2LL;
    ...
    EtwWriteEx(qword_140C1F580, &stru_140038050, 0LL, 0, 0LL, 0LL, UserDataCount, UserData);
  }
}
