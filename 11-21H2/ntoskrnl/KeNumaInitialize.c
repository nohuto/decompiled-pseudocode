/*
 * XREFs of KeNumaInitialize @ 0x140B303B4
 * Callers:
...
__int64 (*KeNumaInitialize())()
{
  ...
  v2 = 0LL;
  v3 = 0LL;
  result = (__int64 (*)())((__int64 (__fastcall *)(__int64, __int64, __int128 *, int *))off_140C020D8[0])(
                            11LL,
                            64LL,
                            &v1,
                            &v6);
  if ( (int)result >= 0 )
  {
    ...
    KiNumaQueryProximityId = (__int64 (__fastcall *)(_QWORD, _QWORD, _QWORD))*((_QWORD *)&v3 + 1);
