/*
 * XREFs of sub_140623F40 @ 0x140623F40
 * Callers:
 *     <none>
 * Callees:
...
NTSTATUS __fastcall sub_140623F40(
        HANDLE FileHandle,
        HANDLE Event,
...
LABEL_13:
  v27[6] = IoStatusBlock;
  v27[5] = FileInformation;
  LODWORD(v27[4]) = Length;
  HIDWORD(v27[3]) = FileInformationClass;
  LOBYTE(v27[3]) = ReturnSingleEntry;
  v27[2] = FileName;
  LOBYTE(v27[1]) = RestartScan;
  v27[10] = FileHandle;
  v27[9] = Event;
  v27[8] = ApcRoutine;
  v27[7] = ApcContext;
