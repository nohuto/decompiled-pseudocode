/*
 * XREFs of sub_1409E0328 @ 0x1409E0328
 * Callers:
...
NTSTATUS __fastcall sub_1409E0328(__int64 a1, __int64 a2, __int64 a3, __int64 a4, __int64 a5, char a6)
{
  bool v6; // zf
  __int64 v7; // rax
  ...
  *(_QWORD *)&UserData.Size = 16LL;
  ...
  v17 = 4LL;
  v19 = 4LL;
  return EtwWrite(qword_140C15FA8, &stru_1400389C0, 0LL, 5u, &UserData);
}
