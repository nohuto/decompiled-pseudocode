/*
 * XREFs of sub_1405D2CE8 @ 0x1405D2CE8
 * Callers:
...
char __fastcall sub_1405D2CE8(__int64 a1, int a2, int a3)
{
  _UNKNOWN **v3; // rax
  REGHANDLE v4; // rbx
  ...
  {
    v4 = RegHandle;
    LOBYTE(v3) = EtwEventEnabled(RegHandle, &stru_1400388B8);
    if ( (_BYTE)v3 )
    {
      v7 = 0;
      *(_QWORD *)&UserData.Size = 4LL;
      ...
      v20 = 4LL;
      v22 = 4LL;
      LOBYTE(v3) = EtwWriteEx(v4, &stru_1400388B8, 0LL, 0, 0LL, 0LL, 7u, &UserData);
    }
  }
  return (char)v3;
}
