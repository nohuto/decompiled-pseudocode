/*
 * XREFs of PfpVolumePrefetchMetadata @ 0x1406AE644
 * Callers:
 ...
 *     PfpFileSetupObjectAttributes @ 0x1407E08F4 (PfpFileSetupObjectAttributes.c)
 */
...
__int64 __fastcall PfpVolumePrefetchMetadata(_QWORD *a1, unsigned int a2)
{
  ...
  *((_QWORD *)Src + 1) = (8 * (v7 & 7u)) | (unsigned __int64)(*(_DWORD *)(*a1 + 28LL) & 7);
  if ( (*(_DWORD *)(*a1 + 80LL) & 4) != 0 )
    MmQueryMemoryListInformation((ULONG_PTR **)0xFFFFFFFFFFFFFFFFLL, (_OWORD *)a1 + 3, 0xB0u, a2, &v45);
  v8 = 0LL;
...
LABEL_56:
      ...
      v15 = IopXxxControlFile(*(_QWORD *)((v32 << 6) + a1[2]), (__int64)v38, 590112, Src, Size, 0LL, v34, 0);
      if ( (*(_DWORD *)(*a1 + 80LL) & 4) != 0 )
...
LABEL_34:
          ...
          v15 = IopXxxControlFile(*(_QWORD *)((v36 << 6) + a1[2]), (__int64)v38, 590112, Src, Size, 0LL, v34, 0);
          if ( (*(_DWORD *)(*a1 + 80LL) & 4) != 0 )
            PfpUpdateRepurposedByPrefetch(a1 + 6, Src[1]);
          if ( v15 < 0 )
            goto LABEL_16;
  ...
  if ( (*(_DWORD *)(v6 + 8 * v3 + 12) & 0xFFFFFFFE) != 0 )
  {
    do
    {
      ...
      if ( (*v14 & 2) != 0 )
      {
        PfpFileSetupObjectAttributes((_DWORD)a1, (_DWORD)v14, a2, (unsigned int)&v39, (__int64)v40, (__int64)&v44);
        v18 = PfpPrefetchDirectoryStream(
                (_DWORD)a1,
