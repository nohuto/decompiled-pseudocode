/*
 * XREFs of sub_1409A8428 @ 0x1409A8428
 * Callers:
...
char __fastcall sub_1409A8428(int a1, int a2, int a3, int a4)
{
  _UNKNOWN **v4; // rax
  ...
  {
    LOBYTE(v4) = sub_1402A2000((__int64)&dword_140D3B908, 1LL);
    if ( (_BYTE)v4 )
    {
      ...
      v14 = a3;
      v15 = a4;
      LOBYTE(v4) = sub_14020A9C4((__int64)&dword_140D3B908, (unsigned __int8 *)&word_140033F46, 0LL, 0LL, 7u, &v16);
    }
  }
  return (char)v4;
}
