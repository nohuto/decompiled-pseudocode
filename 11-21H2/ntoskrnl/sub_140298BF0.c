/*
 * XREFs of sub_140298BF0 @ 0x140298BF0
 * Callers:
...
unsigned __int64 __fastcall sub_140298BF0(__int64 a1, __int64 a2, __int64 a3)
{
...
LABEL_28:
  ...
  if ( !CurrentIrql )
  {
    if ( dword_140D06B08 && (dword_140D06B08 & 1) != 0 && (unsigned __int8)(KeGetCurrentIrql() - 2) <= 0xDu )
    {
      ...
      v18 = (*(_DWORD *)(v17 + 20) & 0xFFFF0001) == 0;
      *(_DWORD *)(v17 + 20) &= 0xFFFF0001;
      if ( v18 )
