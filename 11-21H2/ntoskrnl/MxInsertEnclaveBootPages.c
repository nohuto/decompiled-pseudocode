/*
 * XREFs of MxInsertEnclaveBootPages @ 0x140B5273C
 * Callers:
...
unsigned __int64 __fastcall MxInsertEnclaveBootPages(unsigned __int64 a1, unsigned __int64 a2, int a3)
{
  ...
  v30.m128i_i64[0] = MiSwizzleInvalidPte(128LL);
  v31.m128i_i64[1] = 0x40003FFFFFFFFELL;
  MiSetPageTablePfnBuddy((__int64)&v29, (__int64)KeGetCurrentThread()->ApcState.Process, 1);
  MiSetPfnIdentity((__int64)&v29, 1);
  if ( a3 == 33 )
  {
    v29.m128i_i64[1] = -8LL;
