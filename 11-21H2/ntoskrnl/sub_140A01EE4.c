/*
 * XREFs of sub_140A01EE4 @ 0x140A01EE4
 * Callers:
...
__int64 __fastcall sub_140A01EE4(__int64 a1, unsigned __int16 *a2, int a3)
{
  __int64 v5; // rax
  __int64 v6; // rdx
  char *v7; // rcx
  ...
  if ( (v9 & 1) != 0 )
    v9 = 0LL;
  return sub_1408520BC(a1, (2 * *(_DWORD *)(v9 + 716)) >> 1, *(_DWORD *)(v9 + 720), a2, a3);
}
