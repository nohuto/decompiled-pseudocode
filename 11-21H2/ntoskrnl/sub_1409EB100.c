/*
 * XREFs of sub_1409EB100 @ 0x1409EB100
 * Callers:
...
void __fastcall sub_1409EB100(__int64 a1)
{
  ...
  {
    Pool2 = (_PROCESSOR_NUMBER *)ExAllocatePool2(256LL, 4LL * ActiveProcessorCount, 1953985605LL);
    if ( !Pool2 )
      goto LABEL_8;
  ...
  v25 = 4;
  v27 = Pool2;
  sub_1402AB170((__int64)&v24, v6, v5, 2u, 0xB1Bu, 0x401802u);
...
LABEL_8:
  ...
  v28 = 8 * v8;
  v25 = 4;
  sub_1402AB170((__int64)&v24, v13, v12, 2u, 0xB1Au, 0x401802u);
  ...
  v27 = (_PROCESSOR_NUMBER *)P;
  v25 = 4;
  sub_1402AB170((__int64)&v24, v19, v18, 2u, 0xB18u, 0x401802u);
}
