/*
 * XREFs of sub_1409AA7A8 @ 0x1409AA7A8
 * Callers:
...
void __fastcall sub_1409AA7A8(int a1)
{
  __int64 v2; // r9
  __int64 v3; // r10
  int v4; // r11d
  ...
  if ( (unsigned int)dword_140D3B908 > 5 )
  {
    if ( sub_1402A2000((__int64)&dword_140D3B908, 1LL) )
    {
      ...
      v15 = 8LL;
      v17 = 8LL;
      sub_14020A9C4((__int64)&dword_140D3B908, (unsigned __int8 *)&dword_140033B49, 0LL, 0LL, 6u, &v9);
    }
  }
}
