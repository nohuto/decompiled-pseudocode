/*
 * XREFs of sub_1409DB15C @ 0x1409DB15C
 * Callers:
...
NTSTATUS __fastcall sub_1409DB15C(const EVENT_DESCRIPTOR *a1, ULONGLONG a2, __int16 a3)
{
  ...
  v4.Size = 16;
  v6 = 2;
  return sub_14081549C((__int64)a1, a1, 0LL, 2u, &v4);
}
