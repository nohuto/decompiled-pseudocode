/*
 * XREFs of sub_1407059D8 @ 0x1407059D8
 * Callers:
 *     sub_140705578 @ 0x140705578 (sub_140705578.c)
 * Callees:
 *     sub_140705BC0 @ 0x140705BC0 (sub_140705BC0.c)
 */

__int64 __fastcall sub_1407059D8(__int64 a1, __int64 a2, int *a3, _BYTE *a4)
{
  __int64 v6; // r8
  unsigned int v8; // ebp
  __int16 v9; // bx
