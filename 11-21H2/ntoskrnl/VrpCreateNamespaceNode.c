/*
 * XREFs of VrpCreateNamespaceNode @ 0x140692514
 * Callers:
 ...
 *     VrpFindBestMatchNamespaceNode @ 0x14069295C (VrpFindBestMatchNamespaceNode.c)
        ...
        _QWORD *a7)
{
  ...
  VrpStripTrailingCharacters(v12);
  ...
  *((_QWORD *)v14 + 1) = v17;
        ...
        (v21 = v20) != 0LL) )
  {
    ...
    *((_WORD *)v14 + 32) = VrpCountPathComponents(v14);
    *((_WORD *)v14 + 33) = VrpCountPathComponents(v14 + 24);
    VrpGetNextToken(a2, &v38, &String1);
    if ( !String1.Length )
    {
LABEL_16:
    ...
    BestMatchNamespaceNode = VrpFindBestMatchNamespaceNode(a1, v14, &v35);
    v24 = BestMatchNamespaceNode;
    if ( !BestMatchNamespaceNode || (v25 = *(_DWORD *)(BestMatchNamespaceNode + 56), (v25 & 4) != 0) )
    {
      v29 = -1073741811;
    }
    else
    {
      ...
      *((_DWORD *)v14 + 14) |= v25 & 2;
      ...
      if ( v26 )
      {
        do
        {
          VrpGetNextToken(v14, &v38, &String1);
          --v26;
        }
        while ( v26 );
        v27 = v38;
      ...
      v29 = VrpBuildKeyPath((PCUNICODE_STRING)(v24 + 24), &Source, (PUNICODE_STRING)(v14 + 40));
      if ( v29 >= 0 )
        goto LABEL_16;
    }
  }
