/*
 * XREFs of sub_14022B568 @ 0x14022B568
 * Callers:
 ...
 *     sub_140418E30 @ 0x140418E30 (sub_140418E30.c)
...
__int64 __fastcall sub_14022B568(ULONG_PTR BugCheckParameter1, __int64 a2, int a3)
{
  __int64 result; // rax
  ...
  {
    if ( (a3 & 0x40000000) != 0 )
      result = sub_14022B940(BugCheckParameter1, 0LL);
    if ( a3 < 0 )
    {
    ...
    if ( (a3 & 0x3FFFFFFF) != 0 )
      result = sub_14022B5D8(BugCheckParameter1);
    if ( (WORD2(xmmword_140D06900) & 0x200) != 0 )
      return sub_14062D430(BugCheckParameter1, a2, (unsigned int)a3);
  }
  return result;
}
