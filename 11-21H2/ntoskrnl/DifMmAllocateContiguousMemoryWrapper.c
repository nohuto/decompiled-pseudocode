/*
 * XREFs of DifMmAllocateContiguousMemoryWrapper @ 0x1406167A0
 * Callers:
 *     <none>
 * Callees:
...
LABEL_18:
  result = MmAllocateContiguousMemory(NumberOfBytes, HighestAcceptableAddress);
  *((_QWORD *)&v16 + 1) = result;
  if ( APIThunkContextById )
  {
