/*
 * XREFs of sub_140621BA0 @ 0x140621BA0
 * Callers:
 *     <none>
 * Callees:
...
NTSTATUS __fastcall sub_140621BA0(PHANDLE JobHandle, ACCESS_MASK DesiredAccess, POBJECT_ATTRIBUTES ObjectAttributes)
{
  __int64 v6; // rdx
  __int64 v7; // rcx
  __int64 *v8; // rdi
