/*
 * XREFs of PopFanWorker @ 0x140999A80
 * Callers:
 *     <none>
 * Callees:
...
LABEL_3:
  ...
  if ( Status >= 0 )
  {
    if ( (unsigned int)dword_140C03A00 > 5 )
    {
      ...
      v26 = 8;
      v29 = 4;
      tlgWriteTransfer_EtwWriteTransfer((__int64)&dword_140C03A00, (unsigned __int8 *)byte_14003190D, 0LL, 0LL, 4u, v24);
    }
    if ( !*(_BYTE *)(a1 + 64) )
    {
...
LABEL_32:
          ...
          v25 = v10;
          v26 = 8;
          tlgWriteTransfer_EtwWriteTransfer((__int64)&dword_140C03A00, (unsigned __int8 *)v11, 0LL, 0LL, 3u, v24);
          goto LABEL_46;
        }
        if ( (unsigned int)dword_140C03A00 > 5 )
        {
          ...
          tlgWriteTransfer_EtwWriteTransfer(
            ...
            (unsigned __int8 *)byte_14003174D,
            0LL,
            0LL,
            5u,
            v24);
      ...
      if ( (unsigned int)dword_140C03A00 > 5 )
      {
        ...
        tlgWriteTransfer_EtwWriteTransfer(
          (__int64)&dword_140C03A00,
          (unsigned __int8 *)byte_1400318D1,
          0LL,
          0LL,
          5u,
          v24);
...
LABEL_43:
  ...
  else
  {
    if ( (unsigned int)dword_140C03A00 > 5 )
    {
      ...
      v26 = 8;
      v29 = 4;
      tlgWriteTransfer_EtwWriteTransfer((__int64)&dword_140C03A00, (unsigned __int8 *)byte_140031820, 0LL, 0LL, 4u, v24);
    }
    switch ( *(_BYTE *)(a1 + 64) )
    {
      case 1:
      ...
      case 3:
        if ( (unsigned int)dword_140C03A00 > 2 )
        {
          ...
          tlgWriteTransfer_EtwWriteTransfer(
            (__int64)&dword_140C03A00,
            (unsigned __int8 *)byte_1400317ED,
            0LL,
            0LL,
            3u,
            v24);
...
LABEL_46:
  if ( (unsigned int)dword_140C03A00 > 5 )
  {
    ...
    v26 = 8;
    v29 = 4;
    tlgWriteTransfer_EtwWriteTransfer((__int64)&dword_140C03A00, (unsigned __int8 *)byte_14003189B, 0LL, 0LL, 4u, v24);
  }
  switch ( v5 )
  {
    case 1u:
    ...
    case 3u:
      ...
      v15 = 92LL;
LABEL_56:
      PopPrepareIoctl(*(IRP **)(a1 + 56), v14, 1, (struct _IRP *)(v15 + a1), v9, v13);
      v16 = Irp;
  ...
  if ( (unsigned int)dword_140C03A00 > 2 )
  {
    ...
    v26 = 8;
    v29 = 4;
    tlgWriteTransfer_EtwWriteTransfer((__int64)&dword_140C03A00, (unsigned __int8 *)byte_14003185B, 0LL, 0LL, 4u, v24);
  }
LABEL_57:
  if ( v7 )
