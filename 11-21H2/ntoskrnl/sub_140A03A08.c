/*
 * XREFs of sub_140A03A08 @ 0x140A03A08
 * Callers:
...
__int64 __fastcall sub_140A03A08(__int64 a1, char a2, unsigned int a3, __int64 a4, unsigned int *a5, unsigned int *a6)
{
  __int64 v6; // rsi
  __int64 v7; // r15
  int v11; // edi
  ...
  *(_QWORD *)&UnicodeString.Length = 0LL;
  ...
  v11 = sub_140A03B84(v6, a1 + 72, &UnicodeString);
  if ( v11 < 0 )
    goto LABEL_16;
  v12 = *(_DWORD *)(a1 + 124);
  if ( !a2 )
