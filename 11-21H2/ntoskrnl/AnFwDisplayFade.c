/*
 * XREFs of AnFwDisplayFade @ 0x140AAC1BC
 * Callers:
...
__int64 __fastcall AnFwDisplayFade(__int64 a1)
{
  ...
  if ( (dword_140C0DF90 & 0x200000) != 0 )
    goto LABEL_68;
  RegionContext = BgpTxtGetRegionContext(qword_140C0E050);
  v8 = BgpTxtGetRegionContext(qword_140C0E058);
  v9 = v8;
  if ( !RegionContext || !v8 )
    goto LABEL_37;
  xmmword_140C0B260 = *(_OWORD *)RegionContext;
  xmmword_140C0B270 = *(_OWORD *)(RegionContext + 16);
  dword_140C0B280 = *(_DWORD *)(RegionContext + 32);
  ...
  {
    v38 = 0;
    v11 = BgpGxParseBitmap((__int64)qword_140C0DFD8, &v46);
    v2 = v46;
    SubRectangle = v11;
    if ( v11 >= 0 )
    {
      ...
      {
LABEL_8:
        v13 = BgpGxRectangleSize(*v2, v2[1], BitsPerPixel);
...
LABEL_49:
      ...
      v32 = BgpGxRectangleSize(*v46, v46[1], v12);
      v46 = 0LL;
      v6 = ((v32 + 15) & 0xFFFFFFF0) + 32;
      SubRectangle = BgpGxConvertRectangleEx((__int64)v2, BitsPerPixel, &v46, 0);
      if ( SubRectangle >= 0 )
      {
        *(_QWORD *)&v53[0] = v2;
        v2 = v46;
...
LABEL_68:
  ...
  v38 = 1;
LABEL_11:
  v20 = BgpGxReadRectangle(&v42, (__int64)&xmmword_140C0B260);
  v1 = (__int64)v42;
  SubRectangle = v20;
  if ( v20 < 0 )
    goto LABEL_32;
...
LABEL_13:
  if ( !v37 )
  {
    v24 = BgpGxReadRectangle(&v52, (__int64)&xmmword_140C0B2A0);
    v3 = v52;
    SubRectangle = v24;
    if ( v24 < 0 )
      goto LABEL_32;
    v25 = BgpGxRectangleSize(*v52, v52[1], BitsPerPixel);
  ...
  if ( !v36 )
  {
    SubRectangle = BgpGxFindSubRectangle((_DWORD)v43, v27, (unsigned int)&v45, (unsigned int)&v41, (__int64)&v35);
    if ( SubRectangle >= 0 )
    {
      v34 = v39;
      *((_QWORD *)v53 + v39) = v43;
  ...
  if ( !v37 )
  {
    SubRectangle = BgpGxFindSubRectangle((_DWORD)v3, v27, (unsigned int)&v45, (unsigned int)&v41, (__int64)&v35);
    if ( SubRectangle >= 0 )
    {
      v28 = v39;
      *((_QWORD *)v53 + v39) = v3;
  ...
  if ( !v38 )
  {
    v47 = v2[1];
    v48 = *v2;
    SubRectangle = BgpGxRectangleCreate(&v47, BitsPerPixel, &v51);
    if ( SubRectangle < 0 )
    {
      v1 = (__int64)v43;
      goto LABEL_32;
  ...
  if ( !v36 )
  {
    v47 = v43[1];
    v48 = *v43;
    SubRectangle = BgpGxRectangleCreate(&v47, BitsPerPixel, &v50);
    if ( SubRectangle < 0 )
      goto LABEL_32;
  ...
  v47 = v3[1];
  v48 = *v3;
  SubRectangle = BgpGxRectangleCreate(&v47, BitsPerPixel, &v44);
  if ( SubRectangle >= 0 )
  {
...
LABEL_31:
    ...
    KeInitializeDpc(&stru_140D00940, AnFwpFadeAnimationTimer, 0LL);
    byte_140CE1AE1 = 1;
