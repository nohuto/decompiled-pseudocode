/*
 * XREFs of sub_1409496C0 @ 0x1409496C0
 * Callers:
...
__int64 __fastcall sub_1409496C0(__int64 a1, const wchar_t *a2)
{
  int v3; // edi
  PVOID *v4; // rbx
  int v5; // eax
  ...
  {
    sub_140A25F18(qword_140D00AC0, (_DWORD)a2, 0, (unsigned int)sub_140949470, (__int64)v11);
    v4 = (PVOID *)P[0];
    if ( P[0] == P )
      goto LABEL_14;
    do
    {
      ...
      v5 = sub_14077CD90(
             *(__int64 *)&qword_140D00AC0,
             ...
             0);
      v3 = v5;
      if ( v5 == -1073741275 || v10 != 1 || v9 != 78 )
        goto LABEL_11;
      if ( v5 < 0 )
        break;
      v3 = sub_140A26854(*(_QWORD *)&qword_140D00AC0, a2, v13, v4 + 2);
      if ( v3 < 0 )
        break;
      v6 = sub_14076FE20(*(__int64 *)&qword_140D00AC0, (__int64)(v4 + 2), 0LL, 0x25u, 1u, 0LL, 0, 0);
      v3 = v6;
      if ( v6 == -1073741275 )
      {
LABEL_11:
