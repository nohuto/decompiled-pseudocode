/*
 * XREFs of sub_140620160 @ 0x140620160
 * Callers:
 *     <none>
 * Callees:
...
NTSTATUS __fastcall sub_140620160(
        HANDLE KeyHandle,
        ULONG Index,
...
LABEL_13:
  ...
  *(_QWORD *)&v24 = __PAIR64__(Index, KeyInformationClass);
  *((_QWORD *)&v23 + 1) = KeyInformation;
