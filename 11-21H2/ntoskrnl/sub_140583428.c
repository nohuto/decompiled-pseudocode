/*
 * XREFs of sub_140583428 @ 0x140583428
 * Callers:
...
char __fastcall sub_140583428(unsigned __int16 *a1, __int64 *a2, __int64 *a3, __int64 a4, __int64 a5)
{
  _UNKNOWN **v5; // rax
  int v9; // r9d
  __int64 v10; // r10
  ...
  if ( *(_QWORD *)&qword_140C53448 )
  {
    if ( a5 )
    {
      ...
      {
        LOBYTE(v5) = sub_1402A2000(*(__int64 *)&qword_140C53448, 256LL);
        if ( (_BYTE)v5 )
        {
          v11 = (unsigned __int8 *)&word_14002C9EE;
          v17 = *a1;
          v22 = &v17;
          v19 = *a2;
          v24 = &v19;
    ...
    else if ( **(_DWORD **)&qword_140C53448 > 5u )
    {
      ...
      if ( (_BYTE)v5 )
      {
        v11 = (unsigned __int8 *)&word_14002CA4E;
        v16 = *a1;
        v22 = &v16;
        v18 = *a2;
        v24 = &v18;
...
LABEL_9:
        ...
        v27 = 8LL;
        v29 = 4LL;
        LOBYTE(v5) = sub_14024A9B0(v10, v11, 0LL, 1u, 0, 0, v15, &v21);
      }
    }
  }
  return (char)v5;
