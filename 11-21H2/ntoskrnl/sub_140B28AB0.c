/*
 * XREFs of sub_140B28AB0 @ 0x140B28AB0
 * Callers:
...
__int64 __fastcall sub_140B28AB0(GUID *Guid)
{
  HANDLE v2; // r15
  int v3; // eax
  void *v4; // rsi
  ...
  *(_QWORD *)&ValueName.Length = 4063292LL;
  ...
  v3 = sub_14067A8B0(&v21, 0LL, &ValueName, 0xF003Fu, 0, 0LL);
  v4 = v21;
  if ( v3 < 0 )
    v4 = 0LL;
  if ( v4 )
  ...
  v5 = sub_14078014C(*(__int64 *)&qword_140D00AC0, 15, (__int64)&KeyHandle);
  if ( v5 >= 0 )
  {
    ...
    if ( v5 >= 0 )
    {
      ...
      *(_DWORD *)&v19.Length = 1441812;
      ...
      if ( v5 >= 0 )
      {
        v7 = sub_14067A8B0(&Handle, v6, &GuidString, 0xF003Fu, 0, (ULONG *)&v22);
        v8 = Handle;
        v5 = v7;
        if ( v7 >= 0 )
        {
          v9 = sub_14067B838(Handle, L"Id", 0, &v18);
          v5 = -1073741823;
          if ( v9 >= 0 )
          {
            if ( v18[1] == 4 && v18[3] == 4 )
          ...
          LODWORD(v17) = 0;
          if ( sub_14067B838(v6, L"LastId", 0, &v18) >= 0 )
          {
            if ( v18[1] == 4 && v18[3] == 4 )
          ...
          if ( (_DWORD)v17 != (_DWORD)v17 - 1 )
          {
            do
            {
              v15 = (unsigned __int8)sub_140B4F8C4(v6, v13) == 0;
              v13 = v17;
              if ( v15 )
                break;
              v13 = v17 + 1;
            ...
            if ( v13 != v14 )
            {
              ...
              *(_DWORD *)&v19.Length = 393220;
              v5 = ZwSetValueKey(v8, &v19, 0, 4u, &v17, 4u);
              if ( v5 >= 0 )
              {
LABEL_14:
                dword_140C54E94 = v17;
                sub_140243A18(&Handle, &Data, &v27);
                Data.QuadPart -= v27;
                ...
                *(_DWORD *)&v19.Length = 1048590;
                v5 = sub_14067A8B0(&v24, v6, &v19, 0xF003Fu, 3u, 0LL);
                if ( v5 < 0
                  || (LODWORD(v21) = 260, v5 = sub_14085C144(v10, (__int64)v8, (__int64)v28, (__int64)&v21), v5 < 0) )
                {
                  v2 = v24;
                }
                else
                {
                  v2 = v24;
                  v5 = ZwSetValueKey(v24, &stru_140D3CB80, 0, 6u, v28, 2 * (_DWORD)v21 - 2);
                  if ( v5 >= 0 )
                  {
                    if ( (_DWORD)InitSafeBootMode
                      || sub_14067B838(v8, L"Reset", 0, &v18) >= 0
                      && (v18[1] != 4 || v18[3] != 4
                        ? (v16 = 0)
                        : (v16 = *(_DWORD *)((char *)v18 + (unsigned int)v18[2])),
                          ...
                          v16) )
                    {
                      if ( (int)sub_14094017C((unsigned int)v17) >= 0 )
                      {
                    ...
                    if ( v4 )
                    {
                      if ( (_DWORD)v22 == 1 )
                        goto LABEL_59;
                      v11 = 0;
                      if ( sub_14067B838(v4, L"RespecializeStarted", 0, &v18) >= 0 )
                      {
                        if ( v18[1] == 4 && v18[3] == 4 )
                      ...
                      if ( sub_14067B838(v8, L"Respecialize", 0, &v18) >= 0 )
                      {
                        if ( v18[1] == 4 && v18[3] == 4 )
                          v11 = *(_DWORD *)((char *)v18 + (unsigned int)v18[2]) == 1;
                        ExFreePoolWithTag(v18, 0);
