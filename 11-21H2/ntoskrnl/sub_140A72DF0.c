/*
 * XREFs of sub_140A72DF0 @ 0x140A72DF0
 * Callers:
...
__int64 __fastcall sub_140A72DF0(__int64 a1, __int64 a2)
{
  __int64 v2; // r13
  int v3; // eax
  int v4; // r14d
  ...
  if ( (_WORD)v6 && *(_WORD *)a2 >= (unsigned __int16)v6 )
  {
    if ( v3 >= 0 )
    {
      ...
      if ( v4 )
      {
        ...
        {
          --v4;
          v3 = sub_140A6F124(v13, v12, 1u, 0, v10, &v18);
          if ( v3 < 0 )
            break;
          v14 = v12 + 1;
          ++v13;
  ...
  *(_DWORD *)(v5 + 24) = v8;
  LOWORD(v16) = 56;
  *((_QWORD *)&v16 + 1) = v5;
  return KdSendPacket(2LL, &v16, 0LL, &xmmword_140C31E60);
}
