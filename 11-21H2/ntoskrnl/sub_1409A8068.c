/*
 * XREFs of sub_1409A8068 @ 0x1409A8068
 * Callers:
...
char __fastcall sub_1409A8068(int a1, int a2, int a3)
{
  _UNKNOWN **v3; // rax
  ...
  if ( (unsigned int)dword_140D3B908 > 5 )
  {
    ...
    if ( (_BYTE)v3 )
    {
      ...
      v11 = a2;
      v12 = a3;
      LOBYTE(v3) = sub_14020A9C4((__int64)&dword_140D3B908, (unsigned __int8 *)byte_140032DF7, 0LL, 0LL, 6u, &v13);
    }
  }
  return (char)v3;
}
