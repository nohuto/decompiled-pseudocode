/*
 * XREFs of sub_140823318 @ 0x140823318
 * Callers:
...
void __fastcall sub_140823318(char *P)
{
  unsigned int v2; // edi
  __int64 v3; // rax
  int v4; // ecx
  ...
  v2 = 0;
  sub_140356454((__int64)P, 0LL, 6u, 5u, (__int64)Timeout, 0LL);
  KeWaitForSingleObject(P + 40, Executive, 0, 0, 0LL);
  sub_1403B954C((__int64)P);
  sub_1403B9378((__int64 *)P);
  v3 = *((int *)P + 42);
  v4 = 0;
  if ( (_DWORD)v3 != 4 )
    v4 = *(_DWORD *)&P[4 * v3 + 140];
  sub_1403B92D0(v4, 0, 0, (volatile signed __int32 *)P + 46);
  if ( *((_DWORD *)P + 45) )
  {
    do
    {
