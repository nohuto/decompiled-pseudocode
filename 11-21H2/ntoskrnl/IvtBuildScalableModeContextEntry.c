/*
 * XREFs of IvtBuildScalableModeContextEntry @ 0x14052E208
 * Callers:
...
__int64 __fastcall IvtBuildScalableModeContextEntry(__int64 a1, __int64 a2, char a3, __int64 a4, int a5, __int64 *a6)
{
  __int64 result; // rax
  void *v9; // rcx
