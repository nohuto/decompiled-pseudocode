/*
 * XREFs of KeInitThread @ 0x140A48020
 * Callers:
 ...
 *     KeAbInitializeThreadState @ 0x1402F476C (KeAbInitializeThreadState.c)
...
__int64 __fastcall KeInitThread(unsigned __int64 a1, __int64 *a2)
{
  unsigned int v4; // r15d
  unsigned __int64 KernelStack; // r12
  ...
  *(_BYTE *)a1 = 6;
  ...
  if ( *((_DWORD *)a2 + 14) )
    ...
    v13 = *(_WORD *)(a2[6] + 2 * AffinityPrimaryGroup + 772);
  v14 = 0;
  v15 = *a2;
  v16 = v13;
  v28 = v13;
...
LABEL_13:
    *(_QWORD *)(a1 + 40) = v15;
    *(_QWORD *)(a1 + 56) = v15;
    *(_QWORD *)(a1 + 48) = v15 - (unsigned int)KeKernelStackSize;
    if ( (_BYTE)KiKernelCetEnabled )
    {
      ...
      *(_DWORD *)(a1 + 116) = v23;
      ...
      {
        v4 = (v23 >> 10) & 1;
        v20 = KiCreateKernelShadowStack(a1, v4, 0LL, v16, &v30, &v29);
        if ( v20 < 0 )
        {
          v21 = 0;
          goto LABEL_18;
    ...
    if ( _bittest64(&KeFeatureBits, 0x37u) )
    {
      *(_QWORD *)(a1 + 1064) = MEMORY[0xFFFFF780000003D8] & ~(unsigned int)a2[8] & 0x40000;
      if ( (*(_DWORD *)(a1 + 116) & 0x400) == 0 )
        KeCopyXfdMaskToTeb((_QWORD *)a1, v17, v18, v19);
      if ( a2[8] )
      {
        KernelStack = MmCreateKernelStack(0x20u, v28, a1);
        v31 = KernelStack;
        if ( !KernelStack )
        {
          v20 = -1073741670;
...
LABEL_18:
  ...
  v15 = MmCreateKernelStack(8u, v13, a1);
  if ( v15 )
  {
    v14 = 1;
    goto LABEL_13;
...
LABEL_23:
  if ( v14 )
  {
    MmDeleteKernelStackEx(*(_QWORD *)(a1 + 56), 2u, a1);
    *(_QWORD *)(a1 + 40) = 0LL;
  }
  if ( v21 )
  {
