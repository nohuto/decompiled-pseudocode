/*
 * XREFs of sub_140752BB4 @ 0x140752BB4
 * Callers:
...
bool __fastcall sub_140752BB4(__int64 a1, unsigned int a2, unsigned __int64 *a3, __int64 a4)
{
  int v4; // edi
  ...
  for ( i = 0; i < 4; ++i )
  {
    if ( (unsigned int)sub_140752CB8(a1, a2, &v16) )
      v4 |= 1 << i;
    if ( v5 >= v16 )
      v5 = v16;
    a1 += 56LL;
  ...
  *(_BYTE *)(a4 + 16) = v4 == 0;
  ...
  {
    v14 = RegHandle;
    if ( EtwEventEnabled(RegHandle, &stru_14000FF98) )
    {
      ...
      *(_QWORD *)&UserData.Size = 4LL;
      ...
      v21 = 4LL;
      v23 = 4LL;
      EtwWrite(v14, &stru_14000FF98, 0LL, 3u, &UserData);
    }
  }
  return v11;
}
