/*
 * XREFs of KiOpComputeLinearAddress @ 0x14057B5C0
 * Callers:
 *     KiOpRetrieveRegMemAddress @ 0x14057BA34 (KiOpRetrieveRegMemAddress.c)
 * Callees:
 *     <none>
 */
...
__int64 __fastcall KiOpComputeLinearAddress(__int64 a1, __int64 *a2)
{
  ...
  Pcr = 0LL;
  v8 = *(_WORD *)(*((unsigned int *)KiOpSegmentOffsetTable + a1) + *(_QWORD *)(v3 + 24));
  if ( 1 << a1 == 32 )
  {
    if ( !v6 )
    {
