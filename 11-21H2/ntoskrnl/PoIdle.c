...
__int64 __fastcall PoIdle(ULONG_PTR BugCheckParameter4)
{
  ...
  if ( BYTE5(PpmCurrentProfile[534 * dword_140C232CC + 23]) )
    return result;
...
LABEL_24:
  ...
  if ( v14 != v15 )
  {
    *(_DWORD *)(v4 + 24) = v15;
    *(_DWORD *)(v4 + 16) = v14;
    PpmEventIdleStateChange(v14, v15);
  }
  if ( (*(_DWORD *)(v5 + 4))++ == -1 )
    PpmResetProcessorIdleAccounting(v5, v37);
...
LABEL_31:
    ...
    && !v19 )
  {
    ...
    v38 = 0;
    v23 = (unsigned __int16 *)KeNodeBlock[CurrentPrcb->SchedulerSubNode->Affinity.Reserved[0]];
    v24 = &KiProcessorIndexToNumberMappingTable[CurrentPrcb->Number];
    v25 = *v23;
    while ( 1 )
    {
      v26 = *((_DWORD *)v23 + 4);
      while ( v26 )
      {
        ...
        v26 &= ~(1 << v27);
        v28 = *(_KSCHEDULER_SUBNODE **)&v23[4 * v27 + 12];
        DeepIdleSet = v28->DeepIdleSet;
        Mask = v28->Affinity.Mask;
        if ( v28 == CurrentPrcb->SchedulerSubNode )
        {
          DeepIdleSet &= ~(1LL << CurrentPrcb->GroupIndex);
          _bittestandreset64((__int64 *)&Mask, *v24 & 0x3F);
        }
        if ( DeepIdleSet != Mask )
          goto LABEL_42;
      }
      NextNode = MmGetNextNode(v25, &v38);
      if ( NextNode == -1 )
        break;
      v23 = (unsigned __int16 *)KeNodeBlock[NextNode];
    }
...
LABEL_42:
  ...
  if ( v20 )
  {
    ...
    {
      if ( ++v1 >= v20 )
        return PpmIdleExecuteTransition(BugCheckParameter4, v34[0], v37, v40, v33);
    }
