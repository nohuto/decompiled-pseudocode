/*
 * XREFs of sub_1406138D0 @ 0x1406138D0
 * Callers:
 *     <none>
 * Callees:
...
char __fastcall sub_1406138D0(ULONG_PTR BugCheckParameter2, __int64 a2, __int64 a3)
{
  __int64 v6; // rdx
  __int64 v7; // rcx
  __int64 *v8; // rdi
...
LABEL_18:
  result = sub_140345190(BugCheckParameter2, a2, a3, 0LL, 0);
  LOBYTE(v20) = result;
  if ( v8 )
  {
    v16 = (_QWORD **)(v8 + 6);
