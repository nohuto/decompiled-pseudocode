/*
 * XREFs of sub_1409A7718 @ 0x1409A7718
 * Callers:
...
char __fastcall sub_1409A7718(int a1, int a2, int a3, int a4, const WCHAR *a5)
{
  _UNKNOWN **v5; // rax
  ...
  if ( (unsigned int)dword_140D3B908 > 5 )
  {
    ...
    if ( (_BYTE)v5 )
    {
      ...
      LOBYTE(v5) = sub_14020A9C4((__int64)&dword_140D3B908, (unsigned __int8 *)word_14003369A, 0LL, 0LL, 8u, &v17);
    }
  }
  return (char)v5;
}
