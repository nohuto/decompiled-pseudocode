/*
 * XREFs of CmpStartRMLog @ 0x14080C884
 * Callers:
  ...
  *((_QWORD *)a1 + 15) = CLFS_LSN_INVALID_EXT;
  if ( v7 )
  {
    ...
    LogFileInformation = RtlStringFromGUIDEx(
                           (unsigned int *)(*(_QWORD *)(qword_140C02770 + 64) + 128LL),
                           (__int64)&v30,
                           1);
    if ( LogFileInformation >= 0 )
    {
      ...
      *((_QWORD *)a1 + 9) = 5242880LL;
      v9 = qword_140C02770;
LABEL_9:
      LogFileInformation = CmpQueryFileSecurityDescriptor(*(HANDLE *)(v9 + 1544), &pcbInfoBuffer);
      if ( LogFileInformation < 0 )
      {
        v11 = 0LL;
      }
