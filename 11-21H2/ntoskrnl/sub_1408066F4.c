/*
 * XREFs of sub_1408066F4 @ 0x1408066F4
 * Callers:
...
void sub_1408066F4()
{
  ...
  while ( 1 )
  {
    v0 = (char *)qword_140C1CB60;
    if ( qword_140C1CB60 == &qword_140C1CB60 )
      break;
    v1 = *(_QWORD *)qword_140C1CB60;
    if ( *((PVOID **)qword_140C1CB60 + 1) != &qword_140C1CB60 || *(PVOID *)(v1 + 8) != qword_140C1CB60 )
      __fastfail(3u);
    qword_140C1CB60 = *(PVOID *)qword_140C1CB60;
    *(_QWORD *)(v1 + 8) = &qword_140C1CB60;
    if ( (unsigned int)dword_140D3B940 > 5 && sub_1402A2000((__int64)&dword_140D3B940, 0x400000000000LL) )
    {
      ...
      v22 = 0x1000000LL;
      v46 = 8LL;
      sub_14020A9C4((__int64)&dword_140D3B940, (unsigned __int8 *)&dword_140031D3C, 0LL, 0LL, 0xDu, v24);
    }
    while ( 1 )
    {
      ...
      if ( (unsigned int)dword_140D3B940 > 5 && sub_1402A2000((__int64)&dword_140D3B940, 0x400000000000LL) )
      {
        ...
        v23 = 0x1000000LL;
        v40 = 8LL;
        sub_14020A9C4((__int64)&dword_140D3B940, (unsigned __int8 *)byte_140031F31, 0LL, 0LL, 0xAu, v24);
      }
      if ( byte_140C5AE14 )
      {
        v6 = RegHandle;
        if ( EtwEventEnabled(RegHandle, &stru_140038990) )
        {
          *(_QWORD *)&UserData.Size = 8LL;
          ...
          v53 = 4LL;
          v55 = 4LL;
          EtwWrite(v6, &stru_140038990, 0LL, 5u, &UserData);
        }
      }
      *((_QWORD *)v0 + 3) = *v9;
