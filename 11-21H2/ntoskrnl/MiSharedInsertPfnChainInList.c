/*
 * XREFs of MiSharedInsertPfnChainInList @ 0x140338DB0
 * Callers:
 *     MiInsertPagesInList @ 0x140338660 (MiInsertPagesInList.c)
 * Callees:
 *     MiMarkLockedChainAsProtected @ 0x14022DE40 (MiMarkLockedChainAsProtected.c)
...
__int64 __fastcall MiSharedInsertPfnChainInList(__int64 a1, _QWORD *a2)
{
  ...
  if ( v4 )
  {
    ...
    *(_QWORD *)(v7 + 24) = v15 | *(_QWORD *)(v7 + 24) & 0xFFFFFF0000000000uLL;
    ...
    {
      result = MiMakeTransitionPte(*(_QWORD *)(a1 + 16), 4);
      *(_QWORD *)(v4 + 16) = result;
    }
    else
    {
  ...
  else
  {
    if ( v8 == 0x3FFFFFFFFFLL )
    {
      ...
      *(_QWORD *)(88LL * PfnPriority + *(_QWORD *)(qword_140C51F48 + 8 * ((*(_QWORD *)(v7 + 40) >> 43) & 0x3FFLL)) + 2896) = v33;
    }
    else
    {
    ...
    if ( v10 == v11 )
    {
      v31 = 88 * ((unsigned int)MiGetPfnPriority(v7) + 33LL);
      result = *(_QWORD *)(a1 + 24);
  ...
  if ( *(_DWORD *)(a1 + 8) == 2 )
  {
    ...
    v37 = 0LL;
    MiPfnToStandbyLookaside(v17, v4, v36);
    v18 = a2[7];
    v19 = a2[10];
    v20 = *(_QWORD *)(a1 + 16);
    v21 = v37;
    if ( v18 == 0x3FFFFFFFFFLL )
      *((_QWORD *)v37 + 2) = v20;
      ...
      MiSetNextStandbyPageSameNodeNoLockAsserts(48 * v18 - 0x220000000000LL, v20);
    v22 = *(_QWORD *)(a1 + 24);
    ...
    MiSetNextStandbyPageSameNodeNoLockAsserts((__int64)v9, v19);
    v28 = *(_QWORD *)(v7 + 24);
    v29 = (v27 & 0x7FFFF) << 40;
