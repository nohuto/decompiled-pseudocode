/*
 * XREFs of KiIntSteerCalculateFallbackDistribution @ 0x1405781D0
 * Callers:
...
void __fastcall KiIntSteerCalculateFallbackDistribution(__int128 **a1)
{
  __int128 *v2; // rbx
  __int128 *v3; // rax
  unsigned int v4; // edx
  ...
  while ( 1 )
  {
    ...
    *a1 = v3;
    *((_QWORD *)v3 + 1) = a1;
    v4 = KiProcessorIndexToNumberMappingTable[(unsigned int)KiIntPartGetLowestClassProcessorInMask(v2 - 9)];
    *(_DWORD *)((char *)v2 - 22) = 0;
    *((_WORD *)v2 - 9) = 0;
    *((_WORD *)v2 - 12) = v4 >> 6;
