/*
 * XREFs of sub_1409E9D54 @ 0x1409E9D54
 * Callers:
...
__int64 __fastcall sub_1409E9D54(__int64 a1, __int64 a2, unsigned int a3, __int64 *a4)
{
  __int64 v6; // rax
  __int64 *v7; // rbx
  ...
  *a4 = v6;
  ...
  for ( i = 8; v8; v8 -= *v7 )
  {
    ...
    *v7 = v11;
    v19 = 32 * v11;
    sub_1402AB170((__int64)&v12, a2, a3, 3u, 0x284u, 0x401802u);
    result = 32 * *v7;
