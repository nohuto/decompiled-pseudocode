/*
 * XREFs of sub_1407051BC @ 0x1407051BC
 * Callers:
 *     sub_140704EF8 @ 0x140704EF8 (sub_140704EF8.c)
 * Callees:
 *     sub_140705390 @ 0x140705390 (sub_140705390.c)
 */

__int64 __fastcall sub_1407051BC(__int64 a1, __int64 a2, int *a3)
{
  unsigned int v3; // esi
  __int64 result; // rax
