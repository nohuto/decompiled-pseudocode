/*
 * XREFs of sub_1406E4980 @ 0x1406E4980
 * Callers:
...
void __fastcall sub_1406E4980(__int64 a1, ULONG_PTR a2, __int64 a3, ULONG_PTR a4)
{
  ULONG_PTR v5; // rdi
  __int64 v6; // rax
  ULONG_PTR v7; // r9
  ...
  v5 = a2;
  v6 = sub_14077B33C(*(unsigned int *)(a2 + 28));
  ...
  for ( i = *v10; i != v10; i = (_QWORD *)*i )
  {
    ...
    sub_14076A1F0(2LL, v9, v5, i - 8, 0LL);
