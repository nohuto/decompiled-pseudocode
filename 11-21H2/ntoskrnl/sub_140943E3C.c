/*
 * XREFs of sub_140943E3C @ 0x140943E3C
 * Callers:
...
__int64 __fastcall sub_140943E3C(UNICODE_STRING *SourceString, __int64 a2, void *a3, HANDLE *a4)
{
  NTSTATUS v7; // eax
  NTSTATUS v8; // ebx
  wchar_t *Buffer; // rcx
  ...
  if ( SourceString && a4 && SourceString->Length >= 4u && RtlPrefixUnicodeString(&stru_140D3CD28, SourceString, 1u) )
  {
...
LABEL_7:
    ...
    if ( v7 == -1073741772 )
    {
      v8 = sub_1407690BC(&DestinationString, SourceString);
      if ( v8 >= 0 )
      {
        Buffer = DestinationString.Buffer;
        Length = DestinationString.Length;
        v11 = DestinationString.Length >> 1;
        v12 = &DestinationString.Buffer[((unsigned __int64)stru_140D3CD28.Length >> 1) + 1];
        if ( (unsigned __int16)((__int64)(2 * (((unsigned __int64)stru_140D3CD28.Length >> 1) + 1)) >> 1) < (unsigned __int16)(DestinationString.Length >> 1) )
        {
          do
          {
            if ( !*v12 )
