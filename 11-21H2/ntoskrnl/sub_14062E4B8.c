/*
 * XREFs of sub_14062E4B8 @ 0x14062E4B8
 * Callers:
...
NTSTATUS __fastcall sub_14062E4B8(__int64 a1, __int64 a2, __int64 a3, int a4, char a5, unsigned __int16 *a6)
{
  ...
  if ( qword_140C15FD0 )
  {
    ...
    *(_QWORD *)&UserData.Size = 8LL;
    ...
    v21 = 2LL;
    v24 = 0;
    return EtwWriteEx(qword_140C15FD0, &stru_140037F00, 0LL, 0, 0LL, 0LL, 7u, &UserData);
  }
  return result;
}
