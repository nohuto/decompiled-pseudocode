/*
 * XREFs of CarEtwWriteLiveDumpEvent @ 0x140602AEC
 * Callers:
...
void __fastcall CarEtwWriteLiveDumpEvent(int *a1, int a2, int a3)
{
  ...
  if ( a1 )
  {
    ...
    if ( (unsigned int)dword_140C090C0 > 5 && tlgKeywordOn((__int64)&dword_140C090C0, 0x800000000000LL) )
    {
      ...
      v17 = &v9;
      v18 = 4LL;
      tlgCreate1Sz_wchar_t((__int64)v19, (const WCHAR *)a1 + 2);
      v6 = a1[17];
      v20 = &v10;
      v10 = v6;
      v21 = 4LL;
      tlgWriteTransfer_EtwWriteTransfer(
        ...
        (unsigned __int8 *)&word_1400344EE,
        0LL,
        0LL,
        8u,
        &v11);
