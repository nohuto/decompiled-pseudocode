/*
 * XREFs of sub_140B26600 @ 0x140B26600
 * Callers:
...
__int64 __fastcall sub_140B26600(unsigned __int16 *a1, __int64 a2, char a3, __int64 a4, __int64 a5, _DWORD *a6)
{
  unsigned int v9; // ecx
  __int64 v10; // rax
  int v11; // eax
  ...
  *a6 = 104;
  ...
  v24 = 32LL * v9 + 8;
  return ntoskrnl_2((__int64)(a6 + 2), (__int64)(a6 + 4));
}
