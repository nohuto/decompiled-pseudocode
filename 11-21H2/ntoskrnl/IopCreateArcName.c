/*
 * XREFs of IopCreateArcName @ 0x14080F068
 * Callers:
...
LABEL_30:
          ...
          while ( 1 )
          {
            ...
            if ( !*((_BYTE *)v15 + 72) && !v15[8] )
            {
              ...
              {
                if ( !(unsigned __int8)IopVerifyDiskSignature(Pool2, v15, &v37) )
                  goto LABEL_34;
                if ( v15[7] )
                {
...
LABEL_46:
                ...
                RtlStringCchPrintfW(pszDest, 0x40uLL, v19, HIDWORD(v41));
                RtlInitUnicodeString(&DestinationString, pszDest);
                v20 = (const char *)v15[3];
                RtlStringCchPrintfA(v43, 0x40uLL, "\\ArcName\\%s", v20);
                  ...
                  else if ( Pool2[1] )
                  {
                    ...
                    do
                    {
                      ...
                      RtlStringCchPrintfW(
                        ...
                        OutputBuffer);
                      RtlInitUnicodeString(&DestinationString, pszDest);
                      RtlStringCchPrintfA(v43, 0x40uLL, "\\ArcName\\%spartition(%d)", v20, v21);
...
LABEL_34:
        ...
        if ( v23 )
        {
          v24 = IopBuildSynchronousFsdRequest(
                  3u,
