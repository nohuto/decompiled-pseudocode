/*
 * XREFs of sub_140A7FF00 @ 0x140A7FF00
 * Callers:
 *     <none>
 * Callees:
...
PMDL __fastcall sub_140A7FF00(unsigned __int64 a1, ULONG a2, BOOLEAN a3, BOOLEAN a4, IRP *a5, __int64 a6)
{
  PMDL result; // rax
  __int16 v10; // r14
  ...
  result = (PMDL)sub_140A90660(NonPagedPool, LowPoolPriority, (__int64)&v14, 1, a6);
  if ( result )
  {
    result->Next = 0LL;
    result->Size = 8 * (v11 + 6);
