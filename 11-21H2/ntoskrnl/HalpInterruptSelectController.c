/*
 * XREFs of HalpInterruptSelectController @ 0x1403B8DA0
 * Callers:
 ...
 *     HalpFindInterruptController @ 0x1403B8E24 (HalpFindInterruptController.c)
...
__int64 __fastcall HalpInterruptSelectController(ULONG_PTR *a1)
{
  ...
  {
    HalpInterruptSetProblemEx(0, 2, 0, (unsigned int)"minkernel\\hals\\lib\\interrupts\\common\\intsup.c", 372);
  }
