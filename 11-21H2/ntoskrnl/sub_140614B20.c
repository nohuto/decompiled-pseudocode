/*
 * XREFs of sub_140614B20 @ 0x140614B20
 * Callers:
 *     <none>
 * Callees:
...
void __fastcall sub_140614B20(KSPIN_LOCK_QUEUE_NUMBER Number, KIRQL a2)
{
  __int64 v4; // rdx
  __int64 v5; // rcx
  __int64 *v6; // rdi
  ...
  KSPIN_LOCK_QUEUE_NUMBER v16; // [rsp+30h] [rbp-18h]
  __int64 retaddr; // [rsp+48h] [rbp+0h]

  v15 = 0LL;
  v16 = 0LL;
  v6 = sub_140604844(284);
  if ( !v6 )
    goto LABEL_18;
  if ( dword_140C1B2A0
