/*
 * XREFs of PopDirectedDripsDiagRundownDevices @ 0x140806630
 * Callers:
...
__int64 PopDirectedDripsDiagRundownDevices()
{
  __int64 result; // rax
  ...
  v1 = &PopDirectedDripsDiagEmptyString;
  ...
  while ( 1 )
  {
    ...
    *(_QWORD *)(v3 + 8) = &qword_140C1CB70;
    ...
    if ( (_DWORD)v6 )
    {
      PopDirectedDripsDiagCreateBlockerEntryULong(v89, L"DFX Transition Count", v6, 0LL);
    ...
    if ( (_DWORD)v7 )
    {
      PopDirectedDripsDiagCreateBlockerEntryULong(&v89[7 * v5], L"PS4 Transition Count", v7, v4);
      v4 = (unsigned int)(v34 + 1);
      v34 = v4;
      v5 = v4;
    }
    ...
    if ( (_WORD)v9 )
    {
      PopDirectedDripsDiagCreateBlockerEntryBoolean(&v89[7 * v5], L"Problem Device", v7, v4);
      v4 = (unsigned int)(v34 + 1);
      v34 = v4;
      v5 = v4;
      v9 = *v8;
    ...
    if ( (v9 & 0x10000) != 0 )
    {
      PopDirectedDripsDiagCreateBlockerEntryBoolean(&v89[7 * v5], L"Initiated PS4 Transition", v7, v4);
      v4 = (unsigned int)++v34;
      v9 = *v8;
    }
    if ( (v9 & 0x40000) != 0 )
    {
      ...
      if ( *((_QWORD *)v2 + 15) )
        ...
        v40 = &PopDirectedDripsDiagEmptyString;
      if ( *((_QWORD *)v2 + 17) )
        v1 = (UNICODE_STRING *)(v2 + 32);
      PopDirectedDripsDiagSanitizeHardwareId(v2 + 16, v9, v7, v4);
      if ( (unsigned int)dword_140D3B940 > 5 && tlgKeywordOn((__int64)&dword_140D3B940, 0x400000000000LL) )
      {
        v49 = &v35;
        v51 = v54;
        Buffer = v10->Buffer;
        ...
        tlgWriteTransfer_EtwWriteTransfer(
          ...
          (unsigned __int8 *)&dword_140031E44,
          0LL,
          0LL,
          0x16u,
          &v48);
    ...
    if ( PopDiagSleepStudyHandleRegistered && (_DWORD)v4 )
    {
      v20 = 0;
      v21 = v89;
      do
      {
        ...
        *(&PopDirectedDripsDiagEventData.Ptr + v24) = (ULONGLONG)(v2 + 8);
        *((_QWORD *)&PopDirectedDripsDiagEventData.Size + v24) = 16LL;
        v26 = v21[1];
        *(&PopDirectedDripsDiagEventData.Ptr + v25) = (ULONGLONG)v21;
        *((_QWORD *)&PopDirectedDripsDiagEventData.Size + v25) = 4LL;
        v27 = 2LL * (unsigned int)(v22 + 4);
        *(&PopDirectedDripsDiagEventData.Ptr + v27) = v26;
        LODWORD(v26) = *(_DWORD *)v21;
        *(&PopDirectedDripsDiagEventData.Reserved + 2 * v27) = 0;
        *(&PopDirectedDripsDiagEventData.Size + 2 * v27) = 2 * v26;
        v28 = (ULONGLONG)v21 + 20;
        v21 += 7;
        v29 = 2LL * (unsigned int)(v22 + 5);
        *(&PopDirectedDripsDiagEventData.Ptr + v29) = (ULONGLONG)v23;
        *((_QWORD *)&PopDirectedDripsDiagEventData.Size + v29) = 4LL;
        v30 = 2LL * (unsigned int)(v22 + 6);
        *(&PopDirectedDripsDiagEventData.Ptr + v30) = v28;
        *((_QWORD *)&PopDirectedDripsDiagEventData.Size + v30) = (unsigned int)(2 * *v23);
      }
      ...
      *(&PopDirectedDripsDiagEventData.Ptr + v31) = (ULONGLONG)&v45;
      *((_QWORD *)&PopDirectedDripsDiagEventData.Size + v31) = 8LL;
      EtwWrite(
    ...
    result = PopDirectedDripsDiagFreeDeviceDiagnostic(v2);
  }
  return result;
}
