/*
 * XREFs of EtwpTraceIo @ 0x14020A0D0
 * Callers:
 *     <none>
 * Callees:
...
LABEL_20:
  v40 = v18;
  v20 = *(_DWORD *)(EtwpHostSiloState + 4248);
  for ( i = !_BitScanForward(&v22, v20); !i; i = !_BitScanForward(&v22, v20) )
  {
    v20 &= v20 - 1;
    v23 = v22;
    v24 = (_DWORD *)(32LL * v22 + EtwpHostSiloState + 4284);
    if ( v24 && (*v24 & 0x100) != 0 )
      EtwpLogKernelEvent(
        (unsigned int)&v40,
        EtwpHostSiloState,
        *(unsigned __int8 *)(EtwpHostSiloState + 2 * v23 + 4232),
        1,
        v19,
        4200451);
  }
  if ( EffectiveServerSilo )
  {
    ...
    if ( v28 )
    {
      ...
      for ( i = !_BitScanForward(&v30, v29); !i; i = !_BitScanForward(&v30, v29) )
      {
        ...
        if ( v32 && (*v32 & 0x100) != 0 )
          EtwpLogKernelEvent((unsigned int)&v40, v28, *(unsigned __int8 *)(v28 + 2 * v31 + 4232), 1, v19, 4200451);
      }
    }
  }
  ...
  if ( EtwpHostSiloState != -4540 )
  {
    ...
    if ( (result & 0x100) != 0 )
    {
      ...
      if ( (unsigned int)IoGetActivityIdIrp(a3, &v42) )
        ...
        v33 = &v42;
      return EtwpDiskProvTraceDisk(v19, &v40, v3, v33);
    }
  }
  return result;
}
