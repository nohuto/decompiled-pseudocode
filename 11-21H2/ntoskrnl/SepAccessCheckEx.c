/*
 * XREFs of SepAccessCheckEx @ 0x1403841DC
 * Callers:
        ...
        bool *a20)
{
  ...
  LUID v66; // [rsp+C8h] [rbp-38h] BYREF
  ...
  if ( (a5 & 0x1000000) != 0 )
  {
    v66 = SeSecurityPrivilege;
    v67 = 0;
    v45 = SepPrivilegeCheck(a4, (__int64)&v66, 1u, 1, a10);
    v46 = (int)a6;
    v56 = v30;
    v47 = 0x1000000;
    v48 = 8;
...
LABEL_54:
      v33 = 0;
      AuthzBasepSetTypeListAccessReasons(v47, v49, v48, v46, v56, 0);
      goto LABEL_28;
    }
    v33 = a9 | 0x1000000;
...
LABEL_15:
  if ( !(_WORD)v35 || !v20 )
  {
    ...
    if ( (v28 & 0x2000000) != 0 )
    {
      ...
      AuthzBasepSetTypeListAccessReasons(v33, 5242880, 0, (_DWORD)a6, v30, 0);
      LODWORD(v24) = *(_DWORD *)(v63 + 200);
      if ( (v24 & 0x4000) == 0 )
      {
LABEL_104:
        v37 = v61;
...
LABEL_101:
        v33 = 0;
        AuthzBasepSetTypeListAccessReasons(0, v35, 0, (_DWORD)a6, v30, v57);
        *(_BYTE *)(a18 + 21) = 0;
        *(_DWORD *)(a18 + 4) = 0;
        goto LABEL_102;
      }
    ...
    {
      AuthzBasepSetTypeListAccessReasons(v28, 5242880, 0, (_DWORD)a6, v30, 0);
      LODWORD(v24) = *(_DWORD *)(v63 + 200);
      if ( (v24 & 0x4000) == 0 )
        goto LABEL_104;
      if ( (v24 & 0x400000) == 0 )
  ...
  v68 = SeTakeOwnershipPrivilege;
  v69 = 0;
  if ( SepPrivilegeCheck(a4, (__int64)&v68, 1u, 1, a10) )
  {
    v33 |= 0x80000u;
...
LABEL_102:
  ...
  {
    v68 = SeRelabelPrivilege;
    v69 = 0;
    if ( SepPrivilegeCheck(v63, (__int64)&v68, v50, 1, a10) )
    {
      v33 |= 0x80000u;
...
LABEL_19:
  if ( *(_WORD *)(v20 + 4) )
  {
    if ( (a5 & 0x2000000) != 0 )
    {
      SepMaximumAccessCheckEx(v63, v65, v20, v66.LowPart, a19, 0, v30, (__int64)a6, a7, 0, 0, a16, a17, a18);
      ...
      if ( (v24 & 0x10) != 0 )
      {
        if ( (v24 & 8) != 0 )
          ...
          v54 = a8[3] | 0x1FFFFF;
        LOBYTE(v58) = 1;
        SepMaximumAccessCheckEx(v63, v65, v20, v66.LowPart, a19, 0, v30, (__int64)a6, a7, v54, v58, a16, a17, a18);
        LODWORD(v24) = *(_DWORD *)(v63 + 200);
      }
...
LABEL_23:
    ...
    SepNormalAccessCheckEx(v29, v63, v65, v20, *(_QWORD *)&v66, a19, 0, v30, (__int64)a6, a7, 0, a16, a17, a18);
...
LABEL_26:
  ...
  if ( KeGetCurrentIrql() < 2u )
  {
    if ( v37 )
    {
      ...
      LOBYTE(v24) = v35;
      LOBYTE(v35) = v62;
      SepAssemblePrivileges(v37, v35, v24, (_DWORD)v26, (__int64)a12);
      if ( a12 )
      {
        if ( !*a12 )
        {
