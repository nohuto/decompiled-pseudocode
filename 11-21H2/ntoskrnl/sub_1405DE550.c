/*
 * XREFs of sub_1405DE550 @ 0x1405DE550
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall sub_1405DE550(__int64 a1, int *a2)
{
  __int64 v2; // rbx
    ...
    if ( !*((_QWORD *)v5 + 3) )
    {
      ...
      *((_DWORD *)v5 + 8) = v6;
      if ( (unsigned int)dword_140C03A00 > 5 )
      {
        ...
        v21 = v9;
        v41 = 4;
        sub_14024A9B0((__int64)&dword_140C03A00, (unsigned __int8 *)&byte_14003240F, v6, 1u, v15, v16, 9u, &v22);
      }
    }
  }
  sub_1405DE728(v2, i);
