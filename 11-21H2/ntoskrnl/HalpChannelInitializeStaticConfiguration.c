/*
 * XREFs of HalpChannelInitializeStaticConfiguration @ 0x140AFA5EC
 * Callers:
 ...
 *     HalpValidateMpns @ 0x14090AFC8 (HalpValidateMpns.c)
 *     HalpSelectFeasibleLowPowerState @ 0x140B4D5C8 (HalpSelectFeasibleLowPowerState.c)
 */
