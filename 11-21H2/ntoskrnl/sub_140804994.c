/*
 * XREFs of sub_140804994 @ 0x140804994
 * Callers:
...
char __fastcall sub_140804994(__int64 a1, __int64 a2)
{
  __int64 v2; // rsi
  __int64 v5; // rcx
  ...
  *(_QWORD *)&UserData.Size = 8LL;
  ...
  {
    v12 = RegHandle;
    LOBYTE(v11) = EtwEventEnabled(RegHandle, &stru_14000F900);
    if ( (_BYTE)v11 )
    {
      if ( !a2 )
        LOBYTE(v11) = EtwWrite(v12, &stru_14000F900, &OutputBuffer, 0xEu, &UserData);
    }
  }
  if ( byte_140C5AE16 )
  {
    LOBYTE(v11) = EtwEventEnabled(RegHandle, &stru_14000F8F0);
    if ( (_BYTE)v11 )
    {
      if ( a2 )
      {
        v56 = a2;
        v57 = 8LL;
        LOBYTE(v11) = EtwWrite(CallbackContext, &stru_14000F8F0, &OutputBuffer, 0xFu, &UserData);
      }
    }
  }
  return (char)v11;
