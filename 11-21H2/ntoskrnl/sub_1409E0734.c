/*
 * XREFs of sub_1409E0734 @ 0x1409E0734
 * Callers:
...
NTSTATUS __fastcall sub_1409E0734(__int64 a1, __int64 a2)
{
  bool v2; // zf
  __int64 v3; // rax
  ULONGLONG v4; // rax
  ...
  *(_QWORD *)&UserData.Size = 16LL;
  ...
  v18 = 1LL;
  v20 = 4LL;
  return EtwWrite(qword_140C15FA8, &stru_1400382C8, 0LL, 6u, &UserData);
}
