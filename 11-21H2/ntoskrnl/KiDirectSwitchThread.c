/*
 * XREFs of KiDirectSwitchThread @ 0x14020F360
 * Callers:
 *     KiExitDispatcher @ 0x1402B0820 (KiExitDispatcher.c)
 * Callees:
 *     KiCanThreadBeReadiedImmediately @ 0x140210110 (KiCanThreadBeReadiedImmediately.c)
 *     KiIsNextScheduledScbThread @ 0x140210130 (KiIsNextScheduledScbThread.c)
...
bool __fastcall KiDirectSwitchThread(__int64 a1, unsigned __int8 a2, char a3)
{
  ...
  int ThreadEffectiveRankNonZero; // [rsp+34h] [rbp-44h] BYREF
  ...
  if ( (WORD2(PerfGlobalGroupMask) & 0x200) != 0 )
    EtwTraceReadyThread(v3 - 27, 1LL, a2);
  v5 = *(v3 - 14);
  v6 = *(_QWORD *)(a1 + 8);
  v141 = 0;
...
LABEL_213:
        ...
        if ( v109 )
        {
          ...
          if ( v110 )
          {
            ThreadEffectiveRankNonZero = KiGetThreadEffectiveRankNonZero(v6, v110, v95, 1, 0LL);
            if ( ThreadEffectiveRankNonZero )
              KiGetComparisonRanks(v94, v110, &v141, &ThreadEffectiveRankNonZero);
          }
        }
      }
    }
...
LABEL_24:
      ...
      if ( *(_BYTE *)(v6 + 125) )
      {
        ...
        if ( v116 < 6 )
        {
          ...
          if ( v118 <= *(_DWORD *)(v6 + 84) )
            v118 = *(_DWORD *)(v6 + 84);
          LOBYTE(v117) = v118 >= KiDynamicHeteroCpuPolicyExpectedCycles;
          v13 = *(unsigned __int8 *)(v6 + 516) + (unsigned int)KiHgsPlusConfiguration * (v117 + 2 * v116);
  ...
  *(_QWORD *)(a1 + 33152) = v38;
  if ( (*(_BYTE *)(v6 + 2) & 2) != 0 )
    KiBeginCounterAccumulation(v6, 0LL);
  *(_BYTE *)(a1 + 32) = 0;
  if ( *(_BYTE *)(a1 + 6) )
  {
    LOBYTE(v13) = 2;
  ...
  if ( SchedulerAssist )
  {
    ...
    {
      v121 = SchedulerAssist[6];
      SchedulerAssist[6] = v121 + 1;
      if ( v121 == -1 )
LABEL_252:
  ...
  {
    v113 = CurrentPrcb->SchedulerAssist;
    if ( v113 )
    {
      if ( CurrentPrcb->NestingLevel <= 1u )
      {
    ...
    while ( *(v3 - 19) );
    v114 = CurrentPrcb->SchedulerAssist;
    if ( v114 )
    {
      if ( CurrentPrcb->NestingLevel <= 1u )
      {
  ...
  else
  {
    ...
    v124 = KiReadGuestSchedulerAssistPriority(v3 - 27, &v149);
    v125 = *((_DWORD *)v3 + 202);
    v126 = v124;
    if ( v124 != v125 )
    {
    ...
    v132 = *((char *)v3 - 21);
    v133 = (char)KiComputePriorityFloor(v3 - 27, (unsigned __int8)v126);
    if ( v133 != v132 )
    {
      KiSetBasePriorityAndClearDecrement(v3 - 27, 0LL, 0LL);
      KiUpdateThreadPriority(0LL, v3 - 27, v133, 0LL);
    }
    ...
    if ( v132 != v133 && (BYTE4(xmmword_140D06910) & 0x20) != 0 )
      EtwTraceXSchedulerPriorityUpdate((_DWORD)v3 - 216, v132, v126, v133, (__int64)&v149);
    v49 = 1;
  }
  if ( *((char *)v3 - 21) >= 16 )
  {
  ...
  if ( !v49 )
  {
    ...
    if ( v52 > *((char *)v3 - 21) )
    {
      if ( *((_BYTE *)v3 + 577) )
      {
        ...
        if ( v3[74] == 1LL )
        {
          p_AbPropagateBoostsList = &v56->AbPropagateBoostsList;
          if ( v56 != (struct _KPRCB *)-35704LL )
          {
            *(_SINGLE_LIST_ENTRY *)v39 = (_SINGLE_LIST_ENTRY)p_AbPropagateBoostsList->Next;
            p_AbPropagateBoostsList->Next = (struct _SINGLE_LIST_ENTRY *)v39;
            _InterlockedIncrement16((volatile signed __int16 *)v3 + 326);
            KiAbQueueAutoBoostDpc(v56);
          }
        }
      }
    }
    ...
    *((_BYTE *)v3 - 21) = v52;
    ...
    {
      LOBYTE(v39) = 1;
      KiSetSchedulerAssistPriority(v3[94], (unsigned int)v52, v39);
    }
  }
LABEL_77:
...
LABEL_91:
    if ( (KiVelocityFlags & 0x8000) == 0 && (v51 & 6) == 6 && (v45 & 8) == 0 && *((char *)v3 - 21) > 0 )
...
LABEL_195:
  ...
  if ( v60 > *((char *)v3 - 21) )
  {
    ...
    *((_BYTE *)v3 + 348) = v57 ^ (v57 ^ v61) & 0xF;
    KiAbProcessThreadPriorityModification(v3 - 27, (unsigned __int8)v60, 1LL);
    v48 = (*(_DWORD *)(v3 - 12) & 0x400000) == 0;
    *((_BYTE *)v3 - 21) = v60;
    if ( !v48 )
    {
      LOBYTE(v62) = 1;
      KiSetSchedulerAssistPriority(v3[94], (unsigned int)(char)v60, v62);
    }
  }
LABEL_92:
  v63 = v51 >> 3;
LABEL_93:
  v64 = 32 * (v63 & 1);
  if ( v3[44] != KiCpuSetSequence && (*((_DWORD *)v3 - 25) & 8) == 0 )
    KiComputeThreadAffinity(v3 - 27);
  v65 = KeGetCurrentPrcb();
  v147 = 0;
  while ( 1 )
  {
    LOBYTE(v45) = 1;
    KiSetVpThreadSpinLockCount(v65, v45);
  ...
  v70 = v67 & 0xFFFFFFFA;
  v71 = *(char *)(v6 + 195);
  if ( v151 + (unsigned int)KiDirectQuantumTarget <= v155 )
    v70 = v67;
  v72 = v70 & 0xFFFFFFF3;
  if ( a3 )
    v72 = v70;
...
LABEL_104:
      ...
      LOBYTE(v66) = 1;
      v97 = KiComputeNewPriority(v6, v66, 0LL);
      v68 = v155;
      v71 = v97;
    }
    if ( v71 < 16 )
...
LABEL_107:
  ...
  if ( (v74 & 1) == 0 )
  {
    ...
    v74 = v98;
    if ( v141
      && (v76 > 1 || !(unsigned __int8)KiIsNextScheduledScbThread(
                                         a1,
                                         *(unsigned int *)(*(_QWORD *)(v150 + 416) + 116LL))) )
    {
      v74 = v98 & 0xFFFFFFFD;
    }
  }
  ...
  if ( (v74 & 1) != 0 )
  {
    ...
    {
      v81 = (unsigned int)KiDirectQuantumTarget + v143;
      v80 = v68 - (unsigned int)KiDirectQuantumTarget;
    }
    if ( (v74 & 2) == 0 )
      *((_BYTE *)v3 + 349) = 1;
    v74 &= ~0x20u;
  ...
  if ( v74 >= 0x20 )
  {
    v99 = v143 + KiCyclesPerClockQuantum * (unsigned int)*((unsigned __int8 *)v3 + 435);
  ...
  if ( v71 != v69 )
  {
    KiAbProcessThreadPriorityModification(v3 - 27, (unsigned __int8)v71, 1LL);
    v48 = (*(_DWORD *)(v3 - 12) & 0x400000) == 0;
    *((_BYTE *)v3 - 21) = v71;
    if ( !v48 )
    {
      LOBYTE(v75) = 1;
      KiSetSchedulerAssistPriority(v3[94], (unsigned int)(char)v71, v75);
    }
  ...
  if ( (v74 & 2) != 0 )
  {
    ...
    *((_BYTE *)v3 + 349) = 0;
    ...
    if ( !v48
      ...
      && (unsigned int)KiGetThreadEffectiveRankNonZero((int)v3 - 216, v104, v75, 0, 0LL) )
    {
      v83 = 1;
    }
    else
    ...
    *v82 = v84;
    ...
    if ( v85 )
    {
      if ( v3 - 27 == *(_QWORD **)(a1 + 24) )
        ...
        v135 = v84 & 0x7F;
      KiSetSchedulerAssistPriority(v85, v135, 0LL);
    }
    v86 = *(_QWORD *)(a1 + 56);
    if ( KeHeteroSystem )
    {
      ...
      if ( v136 <= *((_DWORD *)v3 - 33) )
        v136 = *((_DWORD *)v3 - 33);
      v139 = 64;
      if ( v136 < KiDynamicHeteroCpuPolicyExpectedCycles )
        v139 = 0;
  ...
  *(v3 - 19) = 0LL;
  ...
  if ( (v74 & 0x10) == 0 )
  {
    if ( (unsigned __int8)KiCanThreadBeReadiedImmediately(v3 - 27) )
    {
      *v3 = 0LL;
      v148 = 0LL;
      do
      {
        KiDeferredReadySingleThread(a1, v3 - 27, &v148);
        v3 = v148;
        ++v87;
        if ( v148 )
          v148 = (_QWORD *)*v148;
    ...
    {
      KiInswapAndReadyThread(a1, v105);
    }
  }
