/*
 * XREFs of HalCreateCommonBufferFromMdl @ 0x140514560
 * Callers:
 *     <none>
 * Callees:
 ...
 *     HalpCreateCommonBufferFromMdlVerifyParams @ 0x140512334 (HalpCreateCommonBufferFromMdlVerifyParams.c)
        ...
        unsigned __int64 *a5)
{
  ...
  unsigned __int64 v32; // [rsp+60h] [rbp-61h] BYREF
  ...
  *(_QWORD *)v33 = 0LL;
  ...
  CacheAttribute = HalpDmaReferenceDomainObject(v7);
  if ( CacheAttribute >= 0 )
  {
    v12 = *(_QWORD *)(v7 + 56);
    if ( v12 )
    ...
    *((_QWORD *)&v36 + 1) = v35;
    if ( *(int *)(v7 + 48) > 2 )
    {
      v21 = *(unsigned __int64 **)v30;
LABEL_49:
      v24 = 0;
      CacheAttribute = ((__int64 (__fastcall *)(_QWORD, _QWORD, __int128 *, _QWORD, unsigned __int64 *, _QWORD, unsigned __int64 *))qword_140C4BDA8)(
                         *(_QWORD *)(v7 + 40),
...
LABEL_51:
      ...
      CacheAttribute = HalpAllocateCommonBufferEntry(v15, (unsigned __int64)MappedSystemVa + v38, v7, 0);
      if ( CacheAttribute >= 0 )
      {
        *v39 = v32;
        return (unsigned int)CacheAttribute;
...
LABEL_57:
        if ( v24 )
        {
          ((void (__fastcall *)(_QWORD, __int128 *))qword_140C4BDC0)(*(_QWORD *)(v7 + 40), &v36);
        }
        else if ( v25 )
        {
...
LABEL_37:
    ...
    if ( v23 )
    {
      if ( *(_DWORD *)(v7 + 48) == 1 )
      {
        CacheAttribute = ((__int64 (__fastcall *)(_QWORD, _QWORD, __int128 *))qword_140C4BDB8)(
                           *(_QWORD *)(v7 + 40),
                           (unsigned int)MemoryDescriptorList,
                           &v36);
        if ( CacheAttribute < 0 )
