/*
 * XREFs of sub_14061E990 @ 0x14061E990
 * Callers:
 *     <none>
 * Callees:
...
NTSTATUS __fastcall sub_14061E990(
        PHANDLE KeyHandle,
...
LABEL_13:
  v24[4] = Class;
  LODWORD(v24[3]) = CreateOptions;
  v24[2] = TransactionHandle;
  v24[1] = Disposition;
  v24[8] = KeyHandle;
  LODWORD(v24[7]) = DesiredAccess;
  v24[6] = ObjectAttributes;
  LODWORD(v24[5]) = TitleIndex;
