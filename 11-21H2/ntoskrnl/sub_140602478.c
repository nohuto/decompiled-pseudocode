/*
 * XREFs of sub_140602478 @ 0x140602478
 * Callers:
...
char sub_140602478()
{
  ...
  result = dword_140C1A8D0;
  if ( dword_140C1A8D0 )
  {
    if ( dword_140C090C0 )
    {
      result = sub_1402A2000((__int64)&dword_140C090C0, 0x800000000000LL);
      if ( result )
      {
        if ( v2 > 5 )
        {
          result = sub_1402A2000((__int64)&dword_140C090C0, v1);
          if ( result )
          {
            v8 = 0;
            v16 = 0;
            ...
            v7 = 0;
            v24 = 1;
            sub_1402A2094((__int64)v26, L"POSTMORTEM");
            sub_1403699D0((__int64)v27, v4);
            v6 = *v5;
            v30 = 0;
            v33 = 0;
            v36 = 0;
            ...
            v32 = 4;
            v35 = 8;
            return sub_14020A9C4((__int64)&dword_140C090C0, (unsigned __int8 *)byte_140034378, 0LL, 0LL, 0xBu, &v13);
          }
        }
      }
    }
