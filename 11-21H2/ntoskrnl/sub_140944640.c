/*
 * XREFs of sub_140944640 @ 0x140944640
 * Callers:
...
__int64 __fastcall sub_140944640(unsigned __int16 *a1)
{
      ...
      if ( v7 != -1073741789 )
      {
        if ( v7 >= 0 )
        {
          while ( *v6 )
          {
            ...
            if ( inited >= 0 )
              sub_140A237D0(*(_QWORD *)&qword_140D00AC0, DestinationString.Buffer, 0LL);
