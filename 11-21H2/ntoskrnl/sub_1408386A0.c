/*
 * XREFs of sub_1408386A0 @ 0x1408386A0
 * Callers:
...
__int64 __fastcall sub_1408386A0(void *a1, __int64 a2, __int64 a3, __int64 a4, unsigned __int16 *KeyValueInformation)
{
  ULONG v5; // esi
  NTSTATUS v9; // ebx
      ...
      && *((_DWORD *)KeyValueInformation + 1) == 1 )
    {
      ...
      *((_QWORD *)&v42 + 1) = v13;
      if ( !v13 )
        goto LABEL_60;
      v15 = v14;
      v16 = (__int128 *)((char *)KeyValueInformation + *((unsigned int *)KeyValueInformation + 2));
    }
    else
    {
      v45 = xmmword_140866370;
