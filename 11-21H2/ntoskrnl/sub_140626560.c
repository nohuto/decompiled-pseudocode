/*
 * XREFs of sub_140626560 @ 0x140626560
 * Callers:
 *     <none>
 * Callees:
...
NTSTATUS __fastcall sub_140626560(HANDLE PortHandle, PPORT_MESSAGE RequestMessage, PPORT_MESSAGE ReplyMessage)
{
  __int64 v6; // rdx
  __int64 v7; // rcx
  __int64 *v8; // rdi
