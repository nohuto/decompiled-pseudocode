/*
 * XREFs of sub_14099E860 @ 0x14099E860
 * Callers:
...
const UNICODE_STRING *__fastcall sub_14099E860(unsigned __int16 *a1)
{
  ...
  if ( (v3 & 0xFFFFFFFE) != 0 )
  {
    while ( 1 )
    {
      ...
      if ( RtlPrefixUnicodeString(&stru_140A383D8, &String2, 1u) )
        break;
      v2 = v4 + 1;
      LOWORD(v3) = *v1;
