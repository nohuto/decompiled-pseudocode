/*
 * XREFs of sub_1409E2C3C @ 0x1409E2C3C
 * Callers:
...
char __fastcall sub_1409E2C3C(int a1, int a2)
{
  _UNKNOWN **v2; // rax
  int v3; // r9d
  int v4; // r10d
  ...
  if ( (unsigned int)dword_140C043E0 > 5 )
  {
    ...
    if ( (_BYTE)v2 )
    {
      ...
      v14 = 4;
      v17 = 4;
      LOBYTE(v2) = sub_14020A9C4((__int64)&dword_140C043E0, (unsigned __int8 *)byte_140035203, 0LL, 0LL, 4u, &v12);
    }
  }
  if ( qword_140C16478 )
  {
    ...
    v9 = &v21;
    v10 = 4;
    LOBYTE(v2) = EtwWrite(qword_140C16478, &stru_140039538, 0LL, 2u, &UserData);
  }
  return (char)v2;
}
