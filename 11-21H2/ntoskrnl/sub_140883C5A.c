/*
 * XREFs of sub_140883C5A @ 0x140883C5A
 * Callers:
...
__int64 __fastcall sub_140883C5A(__int64 a1, const void **a2, __int64 a3)
{
  ...
  {
LABEL_7:
    Pool2 = ExAllocatePool2(256LL, (unsigned __int16)v7 + 50LL, 1651995717LL);
    v13 = Pool2;
    if ( !Pool2 )
      goto LABEL_22;
    *(_DWORD *)(Pool2 + 20) = 1;
  ...
  while ( 1 )
  {
    if ( *((_DWORD *)v9 + 4) == v10 + 2 )
    {
      v11 = RtlCompareMemory((char *)&v9[2 * *((unsigned int *)v9 + 5) + 3] + 4, a2[1], v10);
