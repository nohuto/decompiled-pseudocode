/*
 * XREFs of sub_140558960 @ 0x140558960
 * Callers:
...
__int64 __fastcall sub_140558960(__int64 a1, void *a2)
{
  __int64 v5; // rdi
  unsigned int v6; // esi
  _DWORD *v7; // rax
  ...
  v14 = 0;
  v10[1] = 0;
  if ( !(unsigned __int8)sub_1406C9928(a2) )
    return 0LL;
  v5 = sub_14066B3D8(a2);
  if ( !v5 )
    return 3221225485LL;
  ...
  *(_QWORD *)&v16[12] = PsGetCurrentSilo();
  ...
  if ( LODWORD(v16[2]) == -1096154543 )
  {
    ...
    if ( SLODWORD(v16[1]) >= 0 )
    {
      ...
      Object[1] = a2;
      ExEnumHandleTable(v5, sub_140558D40, Object, 0LL);
      v7 = sub_1402A4000((__int64)Object[0]);
      v8 = v7;
      if ( v7 )
      {
        sub_1405610D0(v7, a2);
  ...
  PsReleaseProcessExitSynchronization(a2);
  return v6;
}
