/*
 * XREFs of sub_140A355F4 @ 0x140A355F4
 * Callers:
...
__int64 __fastcall sub_140A355F4(__int64 a1, _WORD *a2, __int64 a3, _WORD *a4)
{
  char v5; // bl
  __int64 v6; // rdi
  int v7; // ecx
  ...
  if ( !a1 || !a2 )
    return 3221225485LL;
  v6 = *(_QWORD *)(a1 + 24);
  if ( (int)sub_140830CF4(a1, a2, 0LL, &v12) < 0 )
    return 3221225524LL;
  v7 = 0;
  if ( !*(_WORD *)(v6 + 6) )
    return 3221225524LL;
