/*
 * XREFs of MiAppendWsleCluster @ 0x1402CF100
 * Callers:
...
__int64 __fastcall MiAppendWsleCluster(__int64 a1, __int64 a2, unsigned __int64 a3)
{
    ...
    && ((v7 & 0x20) == 0 || (v7 & 0x42) == 0) )
  {
    ...
    if ( Flink )
    {
      v17 = *((_QWORD *)&Flink->Flink + ((v6 >> 3) & 0x1FF));
      v18 = v7 | 0x20;
      if ( (v17 & 0x20) == 0 )
        v18 = v7;
      v7 = v18;
  ...
  v22 = v9;
  v10 = *(_QWORD *)(48 * (((unsigned __int64)MI_READ_PTE_LOCK_FREE(&v22) >> 12) & 0xFFFFFFFFFFLL) - 0x21FFFFFFFFD8LL);
  v11 = *(_QWORD *)(a1 + 8);
  v12 = v10 >= 0;
  if ( !v11 )
    goto LABEL_12;
