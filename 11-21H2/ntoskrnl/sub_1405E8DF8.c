/*
 * XREFs of sub_1405E8DF8 @ 0x1405E8DF8
 * Callers:
...
char __fastcall sub_1405E8DF8(__int64 a1, __int64 a2, __int64 a3, char a4, char a5, __int16 a6, __int64 a7)
{
  int v7; // r14d
  __int64 v10; // rcx
  ...
  *(_WORD *)(a3 + 12) = *(_WORD *)(a1 + 140) ^ a6;
  ...
  else
  {
    ...
    if ( v11 >= 0xFE )
      sub_1405F1BBC(3, v10, a3, a2, 0LL, 0LL);
  }
  *(_BYTE *)(a3 + 14) = v11;
  v12 = a3 + 16 * a7;
  *(_BYTE *)(a3 + 11) = 0;
    ...
    if ( *v13 == v16 && v15 == v12 + 16 )
    {
      *(_QWORD *)(a1 + 192) -= *(unsigned __int16 *)(v12 + 8);
      ...
      if ( v17 )
      {
        ...
        v21 = *((_DWORD *)v17 + 2) - 1;
LABEL_20:
        sub_1405F26CC(a1, (_DWORD)v17, v18, v12 + 16, v21, *(unsigned __int16 *)(v12 + 8));
      }
      *v13 = v14;
      *(_QWORD *)(v14 + 8) = v13;
      if ( a5 )
      ...
      *(_BYTE *)(a3 + 15) = 0;
      if ( a5 )
      {
        *(_BYTE *)(a3 + 10) &= 0xF0u;
        ...
        v40 = (_QWORD *)(a1 + 336);
        if ( *(_QWORD *)(a1 + 312) )
          v41 = (_QWORD *)sub_1405F22DC(a1, (unsigned __int16)v25);
        else
          v41 = (_QWORD *)*v40;
        if ( v40 != v41 )
        {
        ...
        {
          sub_1405F1BBC(13, 0, (_DWORD)v41, 0, *v45, 0LL);
        }
      ...
      else
      {
        *(_BYTE *)(a3 + 10) = 0;
        v26 = (_QWORD *)(a1 + 336);
        if ( *(_QWORD *)(a1 + 312) )
          v27 = (_QWORD *)sub_1405F22DC(a1, (unsigned __int16)v25);
        else
          v27 = (_QWORD *)*v26;
        if ( v26 != v27 )
        {
        ...
        {
          sub_1405F1BBC(13, 0, (_DWORD)v27, 0, *v31, 0LL);
        }
        *(_QWORD *)(a1 + 192) += *(unsigned __int16 *)(a3 + 8);
        v33 = *(__int64 **)(a1 + 312);
        if ( v33 )
    ...
    sub_1405F1BBC(13, a1, v12 + 16, v16, v15, 0LL);
    if ( v7 )
      return 0;
    v7 = 1;
  }
  ...
  *(_BYTE *)(a3 + 15) = 0;
  if ( !a5 )
  {
    *(_BYTE *)(a3 + 10) = 0;
    v49 = (_QWORD *)(a1 + 336);
    if ( *(_QWORD *)(a1 + 312) )
      v50 = (_QWORD *)sub_1405F22DC(a1, (unsigned __int16)a7);
    else
      v50 = (_QWORD *)*v49;
    if ( v49 != v50 )
    {
    ...
    {
      sub_1405F1BBC(13, 0, (_DWORD)v50, 0, *v54, 0LL);
    }
    *(_QWORD *)(a1 + 192) += *(unsigned __int16 *)(a3 + 8);
    v33 = *(__int64 **)(a1 + 312);
    if ( v33 )
...
LABEL_52:
      v37 = v34;
LABEL_53:
      sub_1405F2400(a1, (_DWORD)v33, v37, (_DWORD)v32, v37, v34);
    }
LABEL_54:
    if ( *(_DWORD *)(a1 + 124) )
    {
  ...
  *(_BYTE *)(a3 + 10) &= 0xF0u;
  ...
  v59 = (_QWORD *)(a1 + 336);
  if ( *(_QWORD *)(a1 + 312) )
    v60 = (_QWORD *)sub_1405F22DC(a1, (unsigned __int16)a7);
  else
    v60 = (_QWORD *)*v59;
  if ( v59 != v60 )
  {
  ...
  {
    sub_1405F1BBC(13, 0, (_DWORD)v60, 0, *v64, 0LL);
  }
  *(_QWORD *)(a1 + 192) += *(unsigned __int16 *)(a3 + 8);
  v66 = *(__int64 **)(a1 + 312);
  if ( v66 )
  {
    ...
    v69 = *((_DWORD *)v66 + 2) - 1;
LABEL_137:
    sub_1405F2400(a1, (_DWORD)v66, v69, a3 + 16, v69, *(unsigned __int16 *)(a3 + 8));
  }
  if ( *(_DWORD *)(a1 + 124) )
  {
    *(_BYTE *)(a3 + 11) = *(_BYTE *)(a3 + 8) ^ *(_BYTE *)(a3 + 9) ^ *(_BYTE *)(a3 + 10);
