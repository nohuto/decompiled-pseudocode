/*
 * XREFs of EmpParseRuleExpression @ 0x140B0C394
 * Callers:
 ...
 *     EmpInfParseSearchDependencyList @ 0x140B0D634 (EmpInfParseSearchDependencyList.c)
 */
...
LABEL_61:
    ...
    v4 = EmpParseRuleTerm(a1, (__int64)ValueFromSectionAndKeyName, &v45, &v44, &v41);
    if ( v4 < 0 )
      goto LABEL_29;
...
LABEL_17:
    ...
    EmpRuleParserStackPush((_DWORD)v9, v20, (_DWORD)v11, v44, v41);
LABEL_25:
    ValueFromSectionAndKeyName = (_BYTE *)CmpGetSectionLineIndex(a1, "Rule", v43, (unsigned int)++v42);
  }
...
LABEL_29:
  ...
  {
    while ( v9[1] )
      EmpRuleParserStackPop((_DWORD)v9, (unsigned int)&v43, (unsigned int)&v44, (unsigned int)&v45, (__int64)&v47);
