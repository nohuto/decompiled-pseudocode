/*
 * XREFs of sub_14021F514 @ 0x14021F514
 * Callers:
...
void __fastcall sub_14021F514(__int64 a1, _RTL_SPLAY_LINKS *a2, unsigned __int64 *a3, _RTL_SPLAY_LINKS **a4)
{
  ...
  if ( a2->Parent )
  {
    ...
    do
    {
      ...
      {
        v15 = sub_140202234((__int64)&stru_140CE2600);
        v16 = (_RTL_SPLAY_LINKS *)v15;
        if ( v15 )
        {
          v17 = (_RTL_SPLAY_LINKS *)(&v15[1].Next + 1);
          *((_BYTE *)&v15->Next + 8) = 0;
