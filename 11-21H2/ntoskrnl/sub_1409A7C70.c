/*
 * XREFs of sub_1409A7C70 @ 0x1409A7C70
 * Callers:
...
char __fastcall sub_1409A7C70(int a1, int a2, __int64 a3, int a4)
{
  _UNKNOWN **v4; // rax
  ...
  if ( (unsigned int)dword_140D3B908 > 5 )
  {
    ...
    if ( (_BYTE)v4 )
    {
      ...
      v27 = 8;
      v14 = a4;
      LOBYTE(v4) = sub_14020A9C4((__int64)&dword_140D3B908, (unsigned __int8 *)byte_1400334A3, 0LL, 0LL, 7u, &v16);
    }
  }
  return (char)v4;
}
