/*
 * XREFs of PsSyscallProviderDispatch @ 0x1406593C0
 * Callers:
...
__int64 __fastcall PsSyscallProviderDispatch(__int64 a1)
{
  ...
  if ( (unsigned int)v7 >= 0x20 )
    KeBugCheckEx(0x1E0u, 1uLL, v7, *(_QWORD *)&v4[2].IdealProcessor[14], 0LL);
  ...
  {
    v12 = PspEnsureGuiThreadAndBatchFlush(CurrentThread);
    v13 = v12;
    if ( v12 < 0 )
    {
      if ( v12 == -1073741823 )
...
LABEL_20:
  ...
  LOBYTE(v5) = v11 & 0xF;
  result = PspSyscallProviderServiceDispatchGeneric(a1, (_DWORD)v15, v5, v6, (__int64)&v16);
  if ( !(_DWORD)result )
  {
    v14 = v16;
LABEL_21:
