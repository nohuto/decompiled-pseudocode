/*
 * XREFs of sub_14052314C @ 0x14052314C
 * Callers:
...
__int64 __fastcall sub_14052314C(int *a1, int a2, char a3)
{
  unsigned int v3; // edi
  __int64 v4; // r13
  __int64 v6; // r15
  ...
  v17 = v7;
  v9 = 10;
  v10 = (unsigned int *)(qword_140C4A1C8 + 32 * (*a1 + 8LL));
  v11 = 0;
  do
  {
    v12 = v7 + a2;
    ...
    *(_DWORD *)(v6 + v4 + 264) = v12;
    ...
    a2 = *(_DWORD *)(qword_140C4A1C8 + 240);
    if ( v12 - a2 <= v7 && v12 - a2 >= (unsigned int)dword_140C4A1BC && *(_DWORD *)(v6 + v4 + 264) != 2 * v12 )
      break;
    v7 = 1 << v9++;
    v17 = v7;
  }
  ...
  if ( v9 != 10 )
  {
    if ( v9 == 31 )
    {
      sub_140522930((__int64)a1, 6, 0);
      v3 = -1073741823;
    }
    ++dword_140C4A1E0[v9 - 10];
  }
  result = v3;
  a1[5] = v12;
  return result;
