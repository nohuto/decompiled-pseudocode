/*
 * XREFs of sub_1405EA9DC @ 0x1405EA9DC
 * Callers:
...
void __fastcall sub_1405EA9DC(unsigned __int64 a1, unsigned __int64 a2, unsigned __int64 a3)
{
    ...
    while ( 1 )
    {
      ...
      *(_WORD *)(v3 + 12) = v5 ^ *(_WORD *)(a1 + 140);
      ...
      else
      {
        v14 = ((v3 - v8) >> 16) + 1;
        if ( v14 >= 0xFE )
          sub_1405F1BBC(3, v13, v3, v8, 0LL, 0LL);
      }
      *(_BYTE *)(v3 + 10) &= 0xF0u;
      *(_BYTE *)(v3 + 14) = v14;
      *(_WORD *)(v3 + 8) = v11;
      ...
      *(_BYTE *)(v3 + 15) = 0;
      ...
      if ( *(_QWORD *)(a1 + 312) )
        v17 = (_QWORD *)sub_1405F22DC(a1, v11);
      else
        v17 = (_QWORD *)*v10;
      if ( v10 != v17 )
      {
      ...
      *(_QWORD *)(a1 + 192) += *(unsigned __int16 *)(v3 + 8);
      ...
      if ( v23 )
      {
        ...
        v26 = *((_DWORD *)v23 + 2) - 1;
LABEL_50:
        sub_1405F2400(a1, (_DWORD)v23, (_DWORD)v17, v3 + 16, v26, *(unsigned __int16 *)(v3 + 8));
      }
      if ( *(_DWORD *)(a1 + 124) )
      {
