/*
 * XREFs of sub_1405D209C @ 0x1405D209C
 * Callers:
...
void __fastcall sub_1405D209C(__int64 a1, int a2, __int64 a3)
{
  REGHANDLE v3; // rbx
  ...
  v12 = a2;
  v4 = a1;
  sub_140355058(a1, a2, 10, a3);
  if ( byte_140C5AE14 )
  {
    v3 = RegHandle;
    if ( EtwEventEnabled(RegHandle, &stru_140037AF8) )
    {
      UserData.Reserved = 0;
      v8 = 0;
      v11 = 0;
      ...
      v10 = 8;
      v7 = 4;
      EtwWriteEx(v3, &stru_140037AF8, 0LL, 1u, 0LL, 0LL, 3u, &UserData);
    }
  }
}
