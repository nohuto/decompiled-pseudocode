/*
 * XREFs of CmQueryLayeredKey @ 0x140226200
 * Callers:
...
__int64 __fastcall CmQueryLayeredKey(__int64 a1, int a2, unsigned int *a3, unsigned int a4, unsigned int *a5)
{
  ...
  if ( a2 == 6 )
  {
    ...
    v18 = KCBNeedsVirtualImage_0(v9, &SubjectContext);
    v19 = (v18 != 0) | v32 & 0xFFFFFFFE;
    v20 = KCBNeedsVirtualImage_0(v9, &SubjectContext);
    v21 = *(_DWORD *)(v9 + 184);
    if ( !v20 || (v22 = 2, (v21 & 0x20) != 0) )
      v22 = 0;
    v23 = v22 | v19 & 0xFFFFFFFD;
    if ( !CmpVEEnabled || (v24 = 4, (v21 & 0x1000000) == 0) )
      v24 = 0;
...
LABEL_22:
  ...
  else
  {
    while ( 1 )
    {
      KcbAtLayerHeight = CmpGetKcbAtLayerHeight(v31, v15);
  ...
  if ( a2 == 5 )
  {
    LODWORD(v32) = CmGetKeyFlags(v17, 0LL);
...
LABEL_41:
  ...
  if ( started >= 0 )
  {
    started = CmpQueryKeyDataFromKeyNodeStack(v34, a2, (__int64)a3, a4, (__int64)a5);
    if ( started >= 0 )
      started = 0;
  }
LABEL_11:
