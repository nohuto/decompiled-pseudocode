/*
 * XREFs of sub_140AB4C18 @ 0x140AB4C18
 * Callers:
...
__int64 __fastcall sub_140AB4C18(__int64 a1, __int64 a2, __int64 a3)
{
  unsigned int v3; // ebx
  unsigned int v4; // edi
  const void *v5; // r11
  ...
  if ( v3 )
  {
    while ( 1 )
    {
      v9 = sub_140AB44C0(a1, v8);
      if ( *(_DWORD *)(*(_QWORD *)(v9 + 8) & 0xFFFFFFFFFFFFFFF0uLL) != 1852400232 )
        break;
      if ( *(_DWORD *)((*(_QWORD *)(v9 + 8) & 0xFFFFFFFFFFFFFFF0uLL) + 4) != v10 )
        break;
      v11 = *(_DWORD *)((*(_QWORD *)(v9 + 8) & 0xFFFFFFFFFFFFFFF0uLL) + 8);
      v8 = v11 + v10;
