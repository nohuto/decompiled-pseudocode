/*
 * XREFs of sub_140A305C4 @ 0x140A305C4
 * Callers:
                        ...
                        if ( RtlValidSid(v8) )
                        {
                          ...
                          if ( v12 )
                          {
                            if ( RtlCreateAcl(v12, v11, 2u) >= 0
                              && (int)sub_1407B4900(v13, 2u, 2, 983103, (unsigned __int8 *)Src, 0) >= 0
                              && (int)sub_1407B4900(v13, 2u, 2, 0x20000, (unsigned __int8 *)v4, 0) >= 0
                              && (int)sub_1407B4900(v13, 2u, 2, 131097, (unsigned __int8 *)v6, 0) >= 0
