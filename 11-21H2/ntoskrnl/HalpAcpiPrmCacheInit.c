/*
 * XREFs of HalpAcpiPrmCacheInit @ 0x140AF8ACC
 * Callers:
...
__int64 HalpAcpiPrmCacheInit()
{
  ...
  {
    qword_140CE2208 = (__int64)&HalpAcpiPrmUpdateList;
    ...
    while ( v2 != (_OWORD *)v1 )
    {
      ...
      *(_QWORD *)(Pool2 + 80) = Pool2 + 80;
      ...
      if ( *(__int64 **)qword_140CE2208 != &HalpAcpiPrmUpdateList )
LABEL_24:
        __fastfail(3u);
    ...
    qword_140CE2228 = (__int64)&HalpAcpiPrmFirmwareList;
    ...
    while ( v4 != (_OWORD *)v3 )
    {
      ...
      *(_QWORD *)(v13 + 80) = v13 + 80;
      ...
      if ( *(__int64 **)qword_140CE2228 != &HalpAcpiPrmFirmwareList )
        goto LABEL_24;
