/*
 * XREFs of PfpFlushBuffers @ 0x1407D9F00
 * Callers:
...
char PfpFlushBuffers()
{
  ...
  while ( 1 )
  {
    ...
    Src = 163851LL;
    PfpCopyEvent(&Src, v4, MEMORY[0xFFFFF78000000004]);
    if ( *((int *)&v7->Next + 2) > 1 )
      break;
    *((_QWORD *)&v29 + 1) = *((unsigned int *)&v7->Next + 3);
    *(_QWORD *)&v29 = 94215LL;
    PfpCopyEvent((unsigned __int64 *)&v29, v11, v12);
    if ( *((int *)&v7->Next + 2) > 1 )
      break;
    ...
    else if ( v13 && !PfpIsProcessInfoPresent(*((_QWORD *)&v7[3].Next + 1)) )
    {
      v15 = v27;
      goto LABEL_14;
    }
    ...
    {
      while ( PfpLogPageAccess(v13, (_DWORD)v1, (unsigned int)&v28, (_DWORD)Next, 0) )
      {
...
LABEL_13:
    ...
    *((_QWORD *)&v30 + 1) = (unsigned int)v19;
    PfpCopyEvent((unsigned __int64 *)&v30, v18, v19);
LABEL_14:
  ...
  while ( 1 )
  {
    ...
    v27 = 0;
    v24 = PfTAcquireLogEntry(&unk_140C4E978, &v27, 1LL);
    if ( !v24 )
      break;
