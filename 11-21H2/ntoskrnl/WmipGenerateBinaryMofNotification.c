/*
 * XREFs of WmipGenerateBinaryMofNotification @ 0x1409DE4C4
 * Callers:
    ...
    do
    {
      ...
      if ( PoolWithTag )
      {
        ...
        *((_WORD *)v12 + 36) = 0;
        ...
        {
          *((_WORD *)v12 + 37) = v14;
          RtlStringCbCopyW((NTSTRSAFE_PWSTR)v12 + 38, v14, *(NTSTRSAFE_PCWSTR *)(*v5 + 8 * v8));
        }
        else if ( (v15 & 1) != 0 )
        {
          LODWORD(v16) = v4 + *(_DWORD *)*v5;
          RtlStringCbPrintfExW((NTSTRSAFE_PWSTR)v12 + 38, v14, 0LL, 0LL, 0x200u, L"%ws%d", *v5 + 4LL, v16);
          *((_WORD *)v12 + 37) = v14;
        }
        LOBYTE(v13) = 1;
        WmipProcessEvent(v12, v13, 0);
