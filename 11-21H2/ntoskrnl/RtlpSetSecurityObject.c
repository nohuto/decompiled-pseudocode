/*
 * XREFs of RtlpSetSecurityObject @ 0x140726700
 * Callers:
        ...
        __int64 *a8)
{
  ...
  struct _SID_IDENTIFIER_AUTHORITY PoolType; // [rsp+B0h] [rbp-58h] BYREF
  ...
  __int64 v132; // [rsp+110h] [rbp+8h] BYREF
  unsigned __int8 *v133; // [rsp+118h] [rbp+10h]
...
LABEL_192:
  ...
  if ( (a2 & 0x10) != 0 )
  {
    ...
    do
    {
      AceByType = RtlFindAceByType((__int64)Src, 17, (unsigned int *)&v97);
      v54 = AceByType;
      if ( AceByType )
      {
        v75 = AceByType[1];
...
LABEL_193:
      ...
      if ( !(unsigned __int8)SepValidLabelSubjectContext(v127, v55, v99) )
        goto LABEL_193;
      ++v97;
    }
    while ( v54 );
  }
  TokenTrustLevel = SepLocateTokenTrustLevel(v127);
  v137 = TokenTrustLevel;
...
LABEL_66:
          ...
          if ( v100 )
          {
            ...
            SepGetDefaultsSubjectContext(
              ...
              (__int64)&v132,
              (__int64)&v137);
            valid = RtlpCreateServerAcl((__int64)v30, v101, (unsigned __int8 *)P, (ACL **)&v136, &v111);
            if ( valid < 0 )
              goto LABEL_59;
        ...
        if ( PoolWithTag )
        {
          ...
          *((_WORD *)v37 + 1) = v41;
          ...
          if ( Src )
          {
            ...
            RtlpApplyAclToObject(v37 + 5, v121);
          ...
          *(_WORD *)&PoolType.Value[4] = 768;
          ...
          if ( valid >= 0 )
          {
            ...
            while ( 1 )
            {
              ...
              AceBySid = RtlFindAceBySid(v73, &Sid, (unsigned int *)&v97);
              if ( !AceBySid )
                break;
...
LABEL_59:
      ...
      valid = RtlpValidFilterAclSubjectContext(v19, v137);
      if ( valid < 0 )
        goto LABEL_77;
      v57 = v97;
    }
  ...
  if ( TokenTrustLevel )
  {
    ...
    while ( 1 )
    {
      v82 = RtlFindAceByType((__int64)Src, 20, (unsigned int *)&v97);
      v113 = (__int64)v82;
      if ( v82 )
      {
        if ( (*((_DWORD *)v82 + 1) & 0xFF000000) != 0 )
          goto LABEL_193;
        if ( !RtlpValidTrustSubjectContext(TokenTrustLevel, (__int64)(v82 + 8), v83, &v115) )
          break;
        v82 = (unsigned __int8 *)v113;
      }
      ++v97;
      if ( !v82 )
        goto LABEL_87;
