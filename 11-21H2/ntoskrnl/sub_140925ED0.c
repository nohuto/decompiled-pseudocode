/*
 * XREFs of sub_140925ED0 @ 0x140925ED0
 * Callers:
...
__int64 __fastcall sub_140925ED0(__int64 a1, __int128 *a2, int a3, _QWORD *a4)
{
  __int128 v4; // xmm1
  char v8; // r14
  int v9; // esi
  ...
  v8 = 0;
  v9 = -1073741762;
  v10 = ExIsResourceAcquiredSharedLite((PERESOURCE)&stru_140D31980) != 0;
  if ( !(_WORD)v4 )
  ...
  while ( 1 )
  {
    ...
    *(_QWORD *)&v38[9] = &v38[9];
    ...
    LOBYTE(v12) = v10;
    v9 = v11;
    sub_14067FE98(v38, v12);
    if ( v9 >= 0 )
      break;
    sub_140AB4080(a2, &v29, &v37);
    if ( !(_WORD)v29 )
    {
      v13 = Handle;
      goto LABEL_14;
