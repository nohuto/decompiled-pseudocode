/*
 * XREFs of ExpWatchLicenseInfoWork @ 0x1409F8680
 * Callers:
 *     <none>
 * Callees:
...
NTSTATUS __fastcall ExpWatchLicenseInfoWork(__int64 a1)
{
  ...
  struct _SLIST_ENTRY v37; // [rsp+B8h] [rbp-1h] BYREF
  ...
  if ( !ExpSetupModeDetected )
  {
    ...
    v5 = NtQueryKey(*(HANDLE *)a1, 2u, &v37, 0x30u, &v26);
    if ( v5 < 0 )
...
LABEL_19:
    ...
    LODWORD(Size) = 4;
    v14 = NtSetValueKey(*(_QWORD *)a1, (unsigned __int64)&v36, 0, 4u, (void *)(a1 + 8), Size);
    if ( v14 < 0 )
    ...
    for ( i = 0; ; i = v15 )
    {
      ...
      v20 = NtEnumerateKey(*(HANDLE *)a1, i, 0, (unsigned __int64)PoolWithTag, BugCheckParameter4, &v26);
      if ( v20 == -2147483622 )
        break;
      if ( v20 >= 0 )
      {
        *((_WORD *)PoolWithTag + ((unsigned __int64)PoolWithTag[3] >> 1) + 8) = 0;
        ...
        LODWORD(Sizea) = 4;
        v19 = NtSetValueKey((__int64)Handle, (unsigned __int64)&v36, 0, 4u, (void *)(a1 + 8), Sizea);
        if ( v19 < 0 )
