/*
 * XREFs of sub_14068A3DC @ 0x14068A3DC
 * Callers:
...
void sub_14068A3DC()
{
  ...
  {
    if ( sub_1402A2000((__int64)&dword_140C043A8, 0x200000000003LL) )
    {
      v2 = *(_DWORD *)(v0 + 1088);
      v21 = 0;
      v24 = 0;
      ...
      v44 = 44;
      v47 = v6;
      sub_14020A9C4((__int64)&dword_140C043A8, (unsigned __int8 *)qword_140034E80, 0LL, 0LL, 0xDu, &v18);
    }
  }
}
