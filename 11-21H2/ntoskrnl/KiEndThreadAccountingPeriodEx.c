/*
 * XREFs of KiEndThreadAccountingPeriodEx @ 0x1402B9680
 * Callers:
  ...
  if ( v14 )
  {
    if ( *(_BYTE *)(a2 + 125) )
    {
      ...
      if ( v33 < 6 )
      {
        ...
        if ( v34 <= *(_DWORD *)(a2 + 84) )
          v34 = *(_DWORD *)(a2 + 84);
        LOBYTE(v8) = v34 >= KiDynamicHeteroCpuPolicyExpectedCycles;
        v35 = *(unsigned __int8 *)(a2 + 516) + (unsigned int)KiHgsPlusConfiguration * (v8 + 2 * v33);
        *(_QWORD *)(v14 + 8 * v35) += a3;
      }
    }
  }
