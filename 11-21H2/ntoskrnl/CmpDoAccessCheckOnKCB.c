/*
 * XREFs of CmpDoAccessCheckOnKCB @ 0x140916788
 * Callers:
...
BOOLEAN __fastcall CmpDoAccessCheckOnKCB(__int64 a1, __int64 a2, int a3, char a4)
{
  BOOLEAN v7; // si
  _QWORD *v9; // r14
  ...
  v7 = 0;
  Object = 0LL;
  if ( (int)ObCreateObjectEx(a4, CmKeyObjectType, 0, a4, v15, 112, 0, 0, &Object, 0LL) < 0 )
    return 0;
  v9 = Object;
  *((_QWORD *)Object + 7) = 0LL;
  v9[8] = 0LL;
  ...
  *((_DWORD *)v9 + 12) = 0;
  ...
  if ( (int)v16 >= 0 )
  {
    v13 = Object;
    v9[1] = a1;
    v14 = CmpCheckKeyBodyAccess(v13, a2, &AccessState, a4, (NTSTATUS *)&v16);
