/*
 * XREFs of sub_14051F6C4 @ 0x14051F6C4
 * Callers:
...
char sub_14051F6C4()
{
  ...
  if ( (dword_140C0C60C & 4) != 0 )
  {
    if ( HIBYTE(word_140C4A7A0) )
    {
      ...
      if ( (_BYTE)v0 )
      {
        v1 = (char *)qword_140C15B58;
        v21 = 0LL;
        if ( !qword_140C15B58 || !*(_BYTE *)qword_140C15B58 )
        {
          sub_14022D554((__int16 *)&v18, &v20);
          goto LABEL_21;
        }
        v2 = *((_DWORD *)qword_140C15B58 + 1);
        _InterlockedOr(v16, 0);
        if ( sub_14022D554((__int16 *)&v18, &v21) )
        {
          v3 = v21;
          v4 = 0;
          if ( !v2 )
...
LABEL_21:
        v8 = (char *)qword_140C15B58;
        v22 = 0LL;
        if ( !qword_140C15B58 || !*(_BYTE *)qword_140C15B58 )
        {
          sub_14022D554((__int16 *)&xmmword_140C4A7A2, &v17);
          goto LABEL_38;
        }
        v9 = *((_DWORD *)qword_140C15B58 + 1);
        _InterlockedOr(v16, 0);
        if ( !sub_14022D554((__int16 *)&xmmword_140C4A7A2, &v22) )
          goto LABEL_38;
        v0 = v22;
        v10 = 0LL;
        if ( v9 )
...
LABEL_38:
        ...
        {
          v20 += 300000000LL;
          sub_1402D1A48(&v20, &v18, v10);
          xmmword_140C4A7A2 = v18;
          sub_140396AF4(v14, (unsigned __int8 *)&v18);
          LOBYTE(v0) = 0;
          v19 = 1024;
          if ( byte_140C4A4A0[0] )
            LOBYTE(v0) = sub_1403B2B00(0, 0, (__int64)&v19, 2u, 0LL);
          if ( byte_140C4A530 )
            LOBYTE(v0) = sub_1403B2B00(3, 0, (__int64)&v19, 2u, 0LL);
        }
      }
    }
  }
