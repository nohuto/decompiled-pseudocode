/*
 * XREFs of sub_14061B410 @ 0x14061B410
 * Callers:
 *     <none>
 * Callees:
...
NTSTATUS __fastcall sub_14061B410(ULONG Flags, PCUNICODE_STRING StringIn, PUNICODE_STRING StringOut)
{
  __int64 v6; // rdx
  __int64 v7; // rcx
  __int64 *v8; // rdi
