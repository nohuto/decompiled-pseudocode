/*
 * XREFs of sub_140948260 @ 0x140948260
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall sub_140948260(__int64 a1, __int64 a2)
{
  __int64 result; // rax
  NTSTATUS v4; // r11d
  unsigned int *v5; // rdx
  ...
  v13 = 0;
  result = sub_14090B4C0(a1, a2);
  if ( (int)result < 0 )
    return result;
  v4 = sub_140948150(*(PDEVICE_OBJECT *)a2, &v13);
  if ( v4 < 0 || !v13 )
    return 0LL;
  ...
  do
  {
    ...
    if ( qword_140C54C50 )
    {
      for ( i = qword_140C54C50 + 8;
            i < 32 * (unsigned __int64)*(unsigned int *)(qword_140C54C50 + 4) + qword_140C54C50 + 8;
            i += 32LL )
      {
