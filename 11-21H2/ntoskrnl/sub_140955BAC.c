/*
 * XREFs of sub_140955BAC @ 0x140955BAC
 * Callers:
...
__int64 __fastcall sub_140955BAC(unsigned __int64 a1, unsigned int a2, __int64 a3, unsigned int a4, int a5, _DWORD *a6)
{
  _DWORD *v6; // r15
  unsigned int v9; // ebx
  __int64 v10; // rcx
  ...
  *(_OWORD *)SourceString = 0LL;
  v11 = sub_14078A1A8(a1, a2, a5, (__int64)&v16);
  if ( v11 >= 0 )
  {
    v12 = SourceString[0];
    if ( SourceString[0]
      ...
      && a4 >= 0xC )
    {
      ...
      if ( inited >= 0 )
      {
        ...
        if ( inited >= 0 )
        {
          inited = sub_140773B10((__int64)&DestinationString, &a6);
          v9 = (unsigned int)a6;
        }
      }
    }
