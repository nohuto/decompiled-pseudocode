/*
 * XREFs of sub_1409C3F20 @ 0x1409C3F20
 * Callers:
...
__int64 __fastcall sub_1409C3F20(
        _DWORD *a1,
        unsigned __int8 *a2,
        unsigned __int64 a3,
        _WORD *a4,
        ...
        _DWORD *a6)
{
  ...
  unsigned __int16 *v69; // [rsp+10h] [rbp-88h]
...
LABEL_93:
          ...
          {
            _BitScanReverse((unsigned int *)&v60, v50 - 250);
            v61 = v60 - 24;
            *v59 = v60 - 24;
            if ( v50 - 250 > 1 )
            {
