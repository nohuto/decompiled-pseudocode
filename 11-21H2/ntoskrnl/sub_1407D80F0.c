/*
 * XREFs of sub_1407D80F0 @ 0x1407D80F0
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall sub_1407D80F0(
        char *a1,
        unsigned int a2,
        unsigned __int64 a3,
        unsigned int a4,
...
LABEL_32:
    ...
    if ( v17 )
    {
      v11 = sub_14035D158((__int64)&Event, (unsigned __int64)v9, (__int64)v25, v8 + 2, v16 + v8, v17);
      if ( v11 < 0 )
        goto LABEL_35;
      LODWORD(Size) = v17;
    }
    ...
    {
      v11 = sub_14042ABE0(v9, v25, (_BYTE *)(v8 + 2), v16 + v8, &Size);
      if ( v11 < 0 )
      {
LABEL_35:
        v24 = Size;
...
LABEL_17:
  ...
  v11 = sub_14042ABE0(a8, a8 + 4096, (_BYTE *)(v8 + 2), v16 + v8, &v30);
  if ( v11 >= 0 )
  {
    v22 = &a8[v13];
