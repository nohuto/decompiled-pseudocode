/*
 * XREFs of sub_140A35494 @ 0x140A35494
 * Callers:
...
__int64 __fastcall sub_140A35494(__int64 a1, int a2, __int16 a3, _WORD *a4)
{
  unsigned int v4; // ebx
  __int64 v5; // r10
  __int64 v9; // rax
    ...
    if ( *(_WORD *)(v9 + 6) )
    {
      ...
      while ( 1 )
      {
        ...
        if ( (*(_WORD *)(v12 + v11) & 0x1020) == 0x20 && *(_WORD *)(v12 + v11 + 6) == (_WORD)v5 && a4 )
          break;
        if ( (int)++v10 >= *(unsigned __int16 *)(v9 + 6) )
          goto LABEL_10;
      }
      *a4 = v10;
      return v4;
      ...
      if ( (v5 & 0x8000u) == 0LL && (unsigned int)v5 < *(unsigned __int16 *)(v13 + 6) )
      {
        ...
        if ( v14 )
        {
          ...
          if ( RtlCultureNameToLCID(&DestinationString, &Lcid) )
          {
            LOWORD(v5) = Lcid;
            v15 = 0;
            return (unsigned int)sub_140830B1C(a1, v5, v15, a4);
          }
        }
      }
    }
