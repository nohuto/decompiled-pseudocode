/*
 * XREFs of KiAssignProcessorNumberToPrcb @ 0x1403C2378
 * Callers:
 ...
 *     KiFindSubNodeForProcessorNumber @ 0x1403C24A0 (KiFindSubNodeForProcessorNumber.c)
 */

__int64 __fastcall KiAssignProcessorNumberToPrcb(__int64 a1, unsigned __int8 *a2, int a3)
{
  __int64 v6; // rsi
  ...
  v21 = 0LL;
  KiFindSubNodeForProcessorNumber(a2, 0LL, 0LL, &v21);
  v6 = v21;
  *(_QWORD *)(a1 + 192) = v21;
  v7 = *a2;
  *(_BYTE *)(a1 + 208) = *a2;
  ...
  *(_QWORD *)(a1 + 200) = 1LL << a2[2];
  ...
  result = v8;
  v12 = v8 + (v7 << 6);
  KiProcessorIndexToNumberMappingTable[v10] = v12;
  KiProcessorNumberToIndexMappingTable[v12] = v10;
  for ( i = 0; i < 5; ++i )
  {
