/*
 * XREFs of sub_1405C7D34 @ 0x1405C7D34
 * Callers:
...
__int64 sub_1405C7D34(__int64 a1, int a2, char a3, ...)
{
  __int64 v3; // rbx
  ...
  v3 = a1;
  if ( a2 < 0 )
    return sub_1403DA6C0(a1);
  if ( a3 && (v4 = *(_QWORD *)(*(_QWORD *)(a1 + 33600) + 56LL), v7 > v4) )
    v5 = sub_14029394C(v7 - v4, qword_140D069F8, 0x989680uLL);
  else
    v5 = v9;
  if ( !(unsigned __int8)sub_1405C8ECC((unsigned int)va, v11, v12, v10, v5, (__int64)va) )
  {
    a1 = v3;
    return sub_1403DA6C0(a1);
  }
