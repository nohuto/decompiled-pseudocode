/*
 * XREFs of sub_140629910 @ 0x140629910
 * Callers:
...
_UNKNOWN **__fastcall sub_140629910(__int64 a1, unsigned __int64 *a2, __int64 a3, __int64 *a4, __int64 a5, __int64 *a6)
{
  _UNKNOWN **result; // rax
  bool v7; // zf
  __int64 v12; // r8
  ...
  if ( !v7 )
  {
    while ( 1 )
    {
      result = (_UNKNOWN **)sub_140629368(a1, a2, 0xFFFFFFFFFFFFFFFFuLL, a6, &v16, 0);
      v12 = *((_QWORD *)&v16 + 1);
      if ( !*((_QWORD *)&v16 + 1) )
        return result;
      v13 = *a4;
