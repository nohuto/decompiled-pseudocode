/*
 * XREFs of sub_14040D7E0 @ 0x14040D7E0
 * Callers:
 *     sub_14040D114 @ 0x14040D114 (sub_14040D114.c)
 *     sub_14040D2E8 @ 0x14040D2E8 (sub_14040D2E8.c)
 *     sub_14040D3B0 @ 0x14040D3B0 (sub_14040D3B0.c)
 * Callees:
 *     <none>
 */

void __fastcall sub_14040D7E0(const __m128i *a1, __m128i *a2, int a3, unsigned int a4)
{
  int v4; // r8d
  __m128i v5; // xmm0
  __m128i v6; // xmm1
