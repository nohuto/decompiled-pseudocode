/*
 * XREFs of sub_1407650B0 @ 0x1407650B0
 * Callers:
...
void __fastcall sub_1407650B0(unsigned __int16 *a1, __int64 a2, int a3)
{
  int v4; // r9d
  int v5; // r10d
  ...
  if ( a3 != 1 && (unsigned int)dword_140C039C8 > 5 )
  {
    if ( sub_1402A2000((__int64)&dword_140C039C8, 0x800000000000LL) )
    {
      ...
      v22 = 4LL;
      v24 = 4LL;
      sub_1402A1A20((__int64)&dword_140C039C8, (unsigned __int8 *)&word_14002C1F2, 0LL, 9u, &v10);
    }
  }
}
