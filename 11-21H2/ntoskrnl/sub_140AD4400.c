/*
 * XREFs of sub_140AD4400 @ 0x140AD4400
 * Callers:
 *     <none>
 * Callees:
...
void __fastcall sub_140AD4400(__int64 a1, __int64 a2, __int64 a3, __int64 a4)
{
  __int64 v4; // rax
  __int64 v5; // r10
  __int64 v6; // r11
  ...
  v28 = v11;
  v29 = v12;
  sub_140AD52B0(v15, 1LL);
  v13 = _bittestandset(MK_FP(__GS__, 2468LL), 0);
  if ( v13 && (unsigned __int64)sub_140AD4400 <= (unsigned __int64)retaddr && algn_140AD44FC > (char *)retaddr )
    sub_140AD30B0(0x12u, (unsigned __int64)v15);
