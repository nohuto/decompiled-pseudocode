/*
 * XREFs of IntPartCreate @ 0x140B01BE0
 * Callers:
...
__int64 __fastcall IntPartCreate(__int64 a1, char a2, __int64 a3)
{
  ...
  v5 = 0LL;
  v6 = 0;
  v7 = IntpAllocateProcessorContext(a1, &v40);
  P = (PVOID)v7;
  if ( !v7 )
  {
    v6 = -1073741670;
LABEL_37:
  ...
  inited = (unsigned __int8 *)IntpInitClassContext(v7, v8, &v42);
  if ( !inited )
    goto LABEL_35;
  v11 = v42;
  if ( v42 != 1 )
...
LABEL_57:
      ...
      if ( v28 )
      {
        for ( i = v28 - 1; !inited[24 * i + 1]; i = (unsigned int)(i - 1) )
        {
          if ( !(_DWORD)i )
            goto LABEL_64;
        }
...
LABEL_64:
      ...
      {
        if ( (_DWORD)i != -1 && inited[24 * (unsigned int)i + 1] <= inited[24 * (unsigned int)v34 + 1] )
          LODWORD(v34) = i;
        LODWORD(i) = v34;
      }
      v37 = 3LL * (unsigned int)i;
      *(_QWORD *)&inited[8 * v37 + 8] |= *(_QWORD *)&inited[8 * v33 + 8];
      inited[8 * v37 + 1] += inited[8 * v33 + 1];
      *(_QWORD *)&inited[8 * v33 + 8] = 0LL;
      inited[8 * v33 + 1] = 0;
    }
  }
  v12 = 0;
    ...
    do
    {
      ...
      if ( (_BYTE)v21 )
      {
        ...
        do
        {
          ...
          {
            do
              IntpAddNextProcessorToPartition(v23);
        ...
        v11 = v42;
        if ( v24 )
          IntPartCriticalFailure(0x1004uLL, v24);
        v20 = inited[24 * v3 + 16] + v40;
        v40 = v20;
      }
      ++v3;
    }
...
LABEL_33:
  ...
  KiInterruptPartitions = (__int64)v5;
  return result;
}
