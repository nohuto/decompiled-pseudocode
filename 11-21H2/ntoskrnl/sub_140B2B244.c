/*
 * XREFs of sub_140B2B244 @ 0x140B2B244
 * Callers:
...
char __fastcall sub_140B2B244(__int64 a1)
{
  ...
  do
  {
    LOBYTE(v1) = (_BYTE)qword_140C50708;
    v6 = *(_QWORD *)v3;
    v9 = *(_RTL_BALANCED_NODE **)((char *)qword_140C50708 + v4);
    ...
    while ( v6 )
    {
      ...
      if ( (unsigned __int64)v9 < v7 )
        goto LABEL_8;
      if ( (unsigned __int64)v9 < *(_QWORD *)(v6 + 40) + v7 )
      {
        v8 = (_QWORD *)v6;
LABEL_8:
        v1 = *(_QWORD *)v6;
...
LABEL_9:
    ...
    if ( v8 )
    {
      ...
      if ( ((_DWORD)v1 == 2 || (_DWORD)v1 == 24) && (_RTL_BALANCED_NODE *)v8[4] != v9 )
      {
        v10 = 6 * v2;
        v2 = (unsigned int)(v2 + 1);
        v11 = &qword_140D6EBC0[v10];
        ...
        *((_OWORD *)v11 + 2) = *((_OWORD *)v8 + 2);
        ...
        if ( v12 )
        {
          while ( 1 )
          {
            if ( (unsigned __int64)v9 >= *(_QWORD *)(v12 + 32) )
            {
              v14 = *(_QWORD *)(v12 + 8);
              if ( (*(_BYTE *)(v3 + 8) & 1) != 0 )
              {
