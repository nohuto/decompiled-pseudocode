/*
 * XREFs of sub_140A04204 @ 0x140A04204
 * Callers:
...
__int64 __fastcall sub_140A04204(PVOID *a1, GENERIC_MAPPING *a2)
{
          ...
          *RtlSubAuthoritySid(v3, 1u) = 544;
          ...
          if ( (Acl & 0xC0000000) != 0xC0000000 )
          {
            ...
            *(_DWORD *)IdentifierAuthority.Value = 0x10000000;
            ...
            Acl = sub_1407B4900(v18, 2u, 3, v20, Src, 0);
            if ( (Acl & 0xC0000000) != 0xC0000000 )
            {
              *(_DWORD *)IdentifierAuthority.Value = 0x10000000;
              if ( a2 )
              ...
              Acl = sub_1407B4900(v18, 2u, 3, v19, v3, 0);
              if ( (Acl & 0xC0000000) != 0xC0000000 )
              {
                v21 = 0x80000000;
                *(_DWORD *)IdentifierAuthority.Value = 0x80000000;
                ...
                Acl = sub_1407B4900(v18, 2u, 3, v22, (unsigned __int8 *)v27, 0);
                if ( (Acl & 0xC0000000) != 0xC0000000 )
                {
                  *(_DWORD *)IdentifierAuthority.Value = 0x80000000;
                  v23 = 0x80000000;
                  ...
                  Acl = sub_1407B4900(v18, 2u, 3, v23, (unsigned __int8 *)v28, 0);
                  if ( (Acl & 0xC0000000) != 0xC0000000 )
                  {
                    *(_DWORD *)IdentifierAuthority.Value = 0x80000000;
                    if ( a2 )
                    ...
                    Acl = sub_1407B4900(v18, 2u, 3, v21, v6, 0);
                    if ( (Acl & 0xC0000000) != 0xC0000000 )
                    {
                      if ( RtlValidAcl(v18) )
                      {
