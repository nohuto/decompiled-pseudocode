/*
 * XREFs of MiStoreEvictPageFile @ 0x14024FDF0
 * Callers:
...
void __fastcall MiStoreEvictPageFile(__int64 a1)
{
  ...
  union _MM_STORE_KEY v21; // [rsp+98h] [rbp+48h] BYREF
...
LABEL_28:
      ...
      if ( v7 != v6 && (*v7 | *((_DWORD *)qword_140015FA0 + (v5 & 0x1F))) == -1 )
      {
        v5 = v5 - (v5 & 0x1F) + 32;
      ...
      if ( v7 == v6 )
        goto LABEL_17;
      v9 = v5 & 0x1F;
      if ( (*v7 & ~*((_DWORD *)qword_140015FA0 + (v5 & 0x1F))) != 0 )
        goto LABEL_16;
      v8 = 32 - v9;
      if ( v9 != 33 )
        break;
