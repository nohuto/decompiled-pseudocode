/*
 * XREFs of RtlCompressBufferXpressHuffStandard @ 0x140377590
 * Callers:
...
LABEL_43:
            ...
            *v45 = v42;
            ...
            if ( (unsigned __int64)v10 >= v62 )
            {
              if ( (unsigned __int64)v10 >= v66 )
                goto LABEL_47;
              XpressCallback = RtlpMakeXpressCallback(v71, v66, v10);
              v62 = XpressCallback;
            }
          }
          v10 = v23;
      ...
      if ( (unsigned __int64)v23 >= v66 )
        break;
      XpressCallback = RtlpMakeXpressCallback(v71, v66, v23);
      v62 = XpressCallback;
    }
    v15 = v63;
LABEL_47:
...
LABEL_48:
    ...
    *(_DWORD *)v12 = 2 * v21 + 1;
    ...
    if ( v16 + 4 * ((unsigned __int64)(v15 + XpressBuildHuffmanEncodings(a6 + 15304) + 31) >> 5) + v68 + 258 < v69 )
    {
      v12 = (unsigned __int8 *)(a6 + 23184);
      v48 = XpressDoHuffmanPass((int)a6 + 61216, (int)a6 + 92736, (_DWORD)v20, v68, v47);
      v9 = v65;
      v13 = a6 + 22608;
      v49 = v47 == 0;
      v68 = v48;
