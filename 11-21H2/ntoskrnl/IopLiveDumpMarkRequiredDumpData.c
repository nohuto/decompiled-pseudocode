/*
 * XREFs of IopLiveDumpMarkRequiredDumpData @ 0x140A67248
 * Callers:
...
__int64 __fastcall IopLiveDumpMarkRequiredDumpData(__int64 a1, __int64 (__fastcall *a2)(_QWORD, _QWORD, __int64))
{
  ...
  v15[1] = 0LL;
  result = MmAddRangeToCrashDump((__int64)v15, (__int64)&KdDebuggerDataBlock, 896LL);
  if ( (int)result >= 0 )
  {
    result = MmAddRangeToCrashDump((__int64)v15, (__int64)KiProcessorBlock, 8LL * (unsigned int)KeNumberProcessors_0);
    if ( (int)result >= 0 )
    {
      ...
      if ( (int)result >= 0 )
      {
        ...
        if ( (int)result >= 0 )
        {
          result = MmAddRangeToCrashDump((__int64)v15, 0xFFFFF78000000000uLL, 1840LL);
          if ( (int)result >= 0 )
          {
