/*
 * XREFs of sub_140851878 @ 0x140851878
 * Callers:
...
__int64 __fastcall sub_140851878(__int64 a1)
{
  ...
  _QWORD *v10; // r9
  __int64 v11; // rcx
  _PRIVILEGE_SET *v12; // rcx
  unsigned int v13; // edi
  __int64 v15; // [rsp+48h] [rbp+10h]

  v2 = (unsigned __int64)sub_1403D4990(0x10uLL);
  if ( !v2 )
    return (unsigned int)-1073741801;
  v3 = (struct _KDPC *)sub_1403D4990(0x40uLL);
  v4 = v3;
  if ( v3 )
  {
    KeInitializeDpc(v3, (PKDEFERRED_ROUTINE)sub_14023C750, 0LL);
    if ( !v4->DpcData )
      v4->Number = *(_DWORD *)(a1 + 36) + 2048;
    *(_DWORD *)v2 = 0;
    *(_QWORD *)(v2 + 8) = 0LL;
    *(_DWORD *)(v2 + 4) = 0;
    v5 = (char *)sub_1403D4990(0x200uLL);
    if ( v5 )
    {
      ...
      v12 = *(_PRIVILEGE_SET **)(v2 + 8);
      *(_QWORD *)(v2 + 8) = v5;
      *(_DWORD *)(v2 + 4) = v6 & 0x1F | 0x800;
      if ( v12 )
        SeFreePrivileges(v12);
      goto LABEL_15;
    }
