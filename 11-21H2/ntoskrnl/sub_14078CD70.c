/*
 * XREFs of sub_14078CD70 @ 0x14078CD70
 * Callers:
...
__int64 __fastcall sub_14078CD70(PVOID Object, IRP *a2, KPROCESSOR_MODE a3, __int64 a4, unsigned int a5, _DWORD *a6)
{
  PVOID v7; // rdi
  void *v9; // rcx
  NTSTATUS v10; // eax
  ...
  *(_OWORD *)&v47[1] = 0LL;
  if ( v7 )
  {
    v10 = ObReferenceObjectByPointer(v7, 1u, qword_140D06B20, a3);
  }
  else
  {
    v9 = *(void **)(a4 + 16);
    P = 0LL;
    v10 = ObReferenceObjectByHandle(v9, 1u, qword_140D06B20, a3, &P, 0LL);
    v7 = P;
    v44 = P;
  }
  v11 = v10;
  ...
  v40 = 16;
  P = v51;
  v11 = sub_1406D2BE8((__int64)v7, &v47[1], (int *)&v40, (__int64 *)&P, &v39);
  if ( (v11 & 0x80000000) != 0 )
    goto LABEL_33;
  v11 = 0;
  v12 = *(_DWORD *)(a4 + 44);
...
LABEL_60:
  ...
  do
  {
    ...
    *((_DWORD *)v13 + 1) = v25;
    if ( v26 )
      v27 = sub_140783A9C(v26, 0, v25, (UNICODE_STRING *)(v13 + 24), v14, (__int64)v13);
    else
      v27 = sub_1407839B4(0LL, v25, (__int64)(v13 + 24), v14, (__int64)v13, &v47[1]);
    v28 = v27;
    *((_DWORD *)v13 + 1) = 0;
    if ( v27 < 0 )
      goto LABEL_59;
...
LABEL_41:
      ...
      if ( v23 )
      {
        sub_1402E09E0(4, (int *)&v40);
        v30 = v41;
        v37 = sub_14078CCE4(v41);
        v40 += v37;
      }
      else
      {
...
LABEL_46:
    v13 = v42;
LABEL_26:
    sub_1407838E0((__int64 *)&off_140C037A0, v30);
    v17 = v39;
    v19 = (__int64 *)(v45 + 8);
    v29 = v46-- == 1;
    v45 += 8;
