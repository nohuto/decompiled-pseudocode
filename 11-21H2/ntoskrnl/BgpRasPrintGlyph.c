/*
 * XREFs of BgpRasPrintGlyph @ 0x1403A8390
 * Callers:
        ...
        __int128 *a9)
{
  ...
  _DWORD *v49; // [rsp+68h] [rbp-98h] BYREF
  ...
  *a7 = 0;
  ...
  if ( (unsigned __int16)v46 >= 0x20u )
  {
    v15 = *(_DWORD *)(v48 + 16);
    v49 = *(_DWORD **)(v48 + 8);
    RaspGetCacheEntry((unsigned int)&RaspBitmapCache, (unsigned __int16)v46, v15, v49[10], (__int64)v49, (__int64)&v51);
    Memory = (_BYTE *)v51;
    if ( v51 )
    {
      v22 = v48;
    ...
    {
      LOBYTE(v14) = (dword_140C0DF90 & 4) != 0;
      if ( (dword_140C0DF90 & 4) == 0 && !*(_QWORD *)v10 )
    ...
    if ( v55->m128i_i32[0] < v31 + v34 || v55->m128i_i32[1] < v30 + v50 )
    {
      v9 = -2147483643;
    }
    else
...
LABEL_21:
        RaspAntiAlias((_DWORD)v49, (_DWORD)v12, *((_DWORD *)Memory + 13), *((_DWORD *)Memory + 14), v29);
        if ( !v61[0] )
        {
          v49 = 0LL;
          v51 = __PAIR64__(v46, v50);
