/*
 * XREFs of sub_140AFA63C @ 0x140AFA63C
 * Callers:
...
__int64 __fastcall sub_140AFA63C(int a1, unsigned int a2, unsigned int a3, int a4)
{
  __int64 v4; // r13
  __int64 v5; // r12
  unsigned int v7; // esi
  ...
  if ( result )
  {
    ...
    *(_DWORD *)(v12 + 68) = a2;
    ...
    {
      result = 16LL * v7;
      Base = (void *)((unsigned __int64)(v20 + 7) & 0xFFFFFFFFFFFFFFF8uLL);
      v20 = (char *)Base + result;
    }
    if ( v9 )
    {
      dword_140C4A0D8 = v9;
      result = (unsigned __int64)(v20 + 7) & 0xFFFFFFFFFFFFFFF8uLL;
      qword_140C4A0D0 = (void *)result;
    }
  }
  return result;
}
