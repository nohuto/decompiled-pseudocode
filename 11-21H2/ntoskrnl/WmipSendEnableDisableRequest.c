/*
 * XREFs of WmipSendEnableDisableRequest @ 0x1406D8994
 * Callers:
  ...
  if ( (_DWORD)v9 )
  {
    ...
    *(_OWORD *)((char *)&v27[1] + 8) = v19;
    ...
    do
    {
      v22 = *(_QWORD *)v21;
      LOBYTE(v18) = a1;
      WmipSendWmiIrp(v18, *(unsigned int *)(*(_QWORD *)v21 + 56LL), (char *)&v27[1] + 8, 48LL, v27, v26);
      WmipUnreferenceEntry(&WmipDSChunkInfo, v22);
      v21 += 8;
      --v20;
    }
    while ( v20 );
