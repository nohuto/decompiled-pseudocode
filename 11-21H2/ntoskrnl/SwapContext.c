/*
 * XREFs of SwapContext @ 0x140428D90
 * Callers:
 ...
 *     KiRestoreThreadIptState @ 0x140570220 (KiRestoreThreadIptState.c)
 *     KiSaveThreadIptState @ 0x140570350 (KiSaveThreadIptState.c)
 *     KiCheckAndApplyCacheIsolation @ 0x140573A00 (KiCheckAndApplyCacheIsolation.c)
 */

/*
 * Hex-Rays decompilation failed for SwapContext @ 0x140428D90
 ...
 * 0000000140428DAC: mov     eax, cs:KiHresetMask
 ...
 * 0000000140428DF3: call    cs:__imp_HalRequestSoftwareInterrupt
 ...
 * 0000000140428E13: mov     rbp, cs:KeFeatureBits
 * 0000000140428E1A: cmp     cs:KiCacheIsoBitmap, 0
 ...
 * 0000000140428E30: call    KiCheckAndApplyCacheIsolation
 ...
 * 0000000140428E56: call    KeCheckAndApplyBamQos
 ...
 * 0000000140428F52: call    KiUpdateSpeculationControl
 ...
 * 0000000140429142: test    cs:KiKvaShadow, 1
 ...
 * 0000000140429184: test    cs:HvlEnlightenments, 1
 * 000000014042918E: jz      short loc_140429197
 * 0000000140429190: call    HvlSwitchVirtualAddressSpace
 * 0000000140429195: jmp     short loc_1404291BE
 * 0000000140429197: mov     cr3, rcx
 * 000000014042919A: test    cs:KiKvaShadow, 1
 ...
 * 00000001404291E1: test    cs:KiKvaShadow, 1
 ...
 * 000000014042920B: cmp     cs:KiCpuTracingFlags, 0
 ...
 * 000000014042924F: and     rdx, cs:KeEnabledSupervisorXStateFeatures
 ...
 * 00000001404292A6: cmp     cs:KiIptMsrMask, 0
 * 00000001404292AD: jz      short loc_1404292B7
 * 00000001404292AF: mov     rcx, rsi
 * 00000001404292B2: call    KiRestoreThreadIptState
 ...
 * 0000000140429395: call    cs:__imp_HalRequestSoftwareInterrupt
 ...
 * 00000001404293B6: call    KiBeginThreadAccountingPeriod
 * 00000001404293BB: jmp     loc_140428E0D
 * 00000001404293C0: test    dword ptr cs:PerfGlobalGroupMask+4, 4
 * 00000001404293CA: jz      short loc_1404293D7
 * 00000001404293CC: mov     rcx, rdi
 * 00000001404293CF: mov     rdx, rsi
 * 00000001404293D2: call    EtwTraceContextSwap
 * 00000001404293D7: test    cs:KiCpuTracingFlags, 2
 * 00000001404293E1: jz      short loc_1404293E8
 * 00000001404293E3: call    KiClearLastBranchRecordStack
 * 00000001404293E8: test    cs:KiCpuTracingFlags, 4
 * 00000001404293F2: jz      short loc_1404293F9
 * 00000001404293F4: call    KiResetProcessorTraceBuffer
 ...
 * 0000000140429433: test    cs:HvlLongSpinCountMask, ebp
 * 0000000140429439: jnz     short loc_140429457
 * 000000014042943B: test    cs:HvlEnlightenments, 40h
 * 0000000140429445: jz      short loc_140429457
 * 0000000140429447: call    KiCheckVpBackingLongSpinWaitHypercall
 * 000000014042944C: test    al, al
 * 000000014042944E: jz      short loc_140429457
 * 0000000140429450: mov     ecx, ebp
 * 0000000140429452: call    HvlNotifyLongSpinWait
