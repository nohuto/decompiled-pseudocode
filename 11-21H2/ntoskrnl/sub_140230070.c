/*
 * XREFs of sub_140230070 @ 0x140230070
 * Callers:
...
int __fastcall sub_140230070(volatile signed __int64 *a1, unsigned __int64 a2)
{
...
LABEL_11:
    ...
    {
      v8 = __rdtsc();
      v9 = v8 + (unsigned int)dword_140C5B130;
      while ( 1 )
      {
    ...
    {
      LODWORD(v5) = dword_140C5B130 / (unsigned int)MEMORY[0xFFFFF780000002D6];
      v6 = 0;
      while ( (v16[0] & 1) != 0 )
      {
        if ( v6 == (_DWORD)v5 )
