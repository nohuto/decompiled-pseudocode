/*
 * XREFs of VfMiscMmUnmapLockedPages_Entry @ 0x140AA4550
 * Callers:
 *     <none>
 * Callees:
...
char __fastcall VfMiscMmUnmapLockedPages_Entry(__int64 a1)
{
...
LABEL_7:
  ...
  if ( (MmVerifierData & 0x1000) != 0 )
    LOBYTE(v8) = ViTargetAddToCounter(*(_QWORD *)a1, 200LL, 0xD0u, -(__int64)*(unsigned int *)(v8 + 40));
  return v8;
}
