/*
 * XREFs of sub_140563DCC @ 0x140563DCC
 * Callers:
...
NTSTATUS __fastcall sub_140563DCC(
        __int64 a1,
        __int64 a2,
        __int64 a3,
        const wchar_t *a4,
        ...
        char a10)
{
  ...
  v43 = 0;
  v45 = 4LL;
  return sub_1402D1760(qword_140C03910, (const EVENT_DESCRIPTOR *)qword_14003B170, 0LL, 8u, &v26);
}
