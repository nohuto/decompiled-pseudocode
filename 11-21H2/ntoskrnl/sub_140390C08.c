/*
 * XREFs of sub_140390C08 @ 0x140390C08
 * Callers:
...
__int64 __fastcall sub_140390C08(__int64 a1, __int64 a2, __int64 a3, __int64 a4, unsigned int *a5, char a6, char a7)
{
  ...
  if ( a3 )
  {
    if ( (unsigned int)sub_14023A8D0(a1) == 2 )
      return sub_140458184(v19, a2, v17, v18, (__int64)a5, a6);
    else
      return sub_140517AD4(v19, a2, v17, v18, (__int64)a5, a6, a7);
  }
  else
  {
    v10 = 4096 - (a4 & 0xFFF);
    ...
    if ( !*(_BYTE *)(a1 + 437) )
      sub_140513310(v13, a2, a4, v14, a6, a7);
    return v15;
  }
}
