/*
 * XREFs of KiIpiInterrupt @ 0x140428220
 * Callers:
 *     KiIpiInterruptShadow @ 0x140AB6240 (KiIpiInterruptShadow.c)
 * Callees:
...
/*
 * Hex-Rays decompilation failed for KiIpiInterrupt @ 0x140428220
 ...
 * 0000000140428298: test    cs:KiKvaShadow, 1
 ...
 * 00000001404284BA: call    KiFlushBhbDuringTrapEntryOrExit
 ...
 * 00000001404284DB: call    KiSaveDebugRegisterState
 ...
 * 0000000140428511: call    KeWakeProcessor
 * 0000000140428516: lea     rax, ExpInterlockedPopEntrySListResume
 * 000000014042851D: cmp     rax, [rbp+0E8h]
 * 0000000140428524: jnb     short loc_14042853F
 * 0000000140428526: lea     rax, ExpInterlockedPopEntrySListEnd
 * 000000014042852D: cmp     rax, [rbp+0E8h]
 * 0000000140428534: jb      short loc_14042853F
 * 0000000140428536: lea     rcx, [rbp+0E8h+var_168]
 * 000000014042853A: call    KiCheckForSListAddress
 ...
 * 0000000140428566: cmp     cs:KiBugCheckActive, 0
 ...
 * 000000014042857B: call    KiIpiInterruptSubDispatch
 ...
 * 00000001404285C9: call    KiBeginThreadAccountingPeriod
 ...
 * 00000001404285F5: call    KiDpcInterruptBypass
 * 00000001404285FA: jmp     short loc_140428619
 * 00000001404285FC: mov     ecx, 2
 * 0000000140428601: call    cs:__imp_HalRequestSoftwareInterrupt
 ...
 * 000000014042861D: cmp     cs:KiIrqlFlags, 0
 * 0000000140428624: jz      short loc_14042862D
 * 0000000140428626: call    KzSetIrqlUnsafe
 ...
 * 0000000140428645: test    byte ptr cs:KeSmapEnabled, 0FFh
 ...
 * 000000014042866D: call    KiInitiateUserApc
 ...
 * 00000001404286BD: call    KiCopyCounters
 ...
 * 00000001404286D9: call    KiRestoreDebugRegisterState
 ...
 * 0000000140428908: test    cs:KiKvaShadow, 1
 * 000000014042890F: jz      short loc_140428916
 * 0000000140428911: jmp     KiKernelExit
