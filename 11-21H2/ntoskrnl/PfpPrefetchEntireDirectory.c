/*
 * XREFs of PfpPrefetchEntireDirectory @ 0x1407DE480
 * Callers:
...
__int64 __fastcall PfpPrefetchEntireDirectory(__int64 a1, __int64 a2, __int64 a3, __int64 a4, __int64 a5, __int64 a6)
{
  ...
  *(_OWORD *)v20 = 0LL;
  *(_OWORD *)Object = 0LL;
  v11 = PfpOpenHandleCreate((unsigned int)v21, a1, v10, v9, 1048577, 16417, 0, a2);
  v12 = v23;
  v13 = v11;
  if ( v11 >= 0 )
  {
    ...
    {
      v14 = Object[0];
      if ( (int)IopQueryXxxInformation((struct _FILE_OBJECT *)Object[0], 6, 8u, 0, (struct _IRP *)&v19, &a6, 1) >= 0 )
      {
        *(_QWORD *)(a4 + 12) = v19;
        *(_QWORD *)a4 = v14[3];
        *(_DWORD *)(a4 + 8) = v12;
