/*
 * XREFs of PnpTraceWatchdogViolation @ 0x140957CB8
 * Callers:
...
void __fastcall PnpTraceWatchdogViolation(int a1)
{
  ...
  if ( (unsigned int)dword_140C06550 > 5 )
  {
    if ( tlgKeywordOn((__int64)&dword_140C06550, 0x400000000000LL) )
    {
      ...
      v20 = 2LL;
      v22[1] = 0;
      tlgWriteTransfer_EtwWriteTransfer((__int64)&dword_140C06550, (unsigned __int8 *)byte_14002BDB1, 0LL, 0LL, 9u, &v8);
    }
  }
}
