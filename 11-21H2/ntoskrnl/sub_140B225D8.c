/*
 * XREFs of sub_140B225D8 @ 0x140B225D8
 * Callers:
...
__int64 __fastcall sub_140B225D8(PSID *a1)
{
  ACL *v2; // rdi
  void *v3; // r14
  ...
  v5 = v26;
  v6 = (unsigned int *)qword_140025B60;
  do
  {
    Acl = sub_14084DAD4(&v26[v4], (_SID_IDENTIFIER_AUTHORITY *)BufferLength, *v6);
    if ( Acl < 0 )
      goto LABEL_42;
    ...
    if ( *v6 )
    {
      ...
      do
      {
        v10[v9 + 2] = *((_DWORD *)qword_140025B60 + v8 + v9 + 1);
