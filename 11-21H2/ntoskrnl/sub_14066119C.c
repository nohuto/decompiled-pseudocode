/*
 * XREFs of sub_14066119C @ 0x14066119C
 * Callers:
...
__int64 __fastcall sub_14066119C(int a1, _OWORD *a2, unsigned int a3, unsigned int a4, _QWORD *a5, unsigned int *a6)
{
  size_t v6; // rbx
  void *v9; // r13
  wchar_t *v10; // r14
  ...
  *(_QWORD *)&String1.Length = 1441812LL;
  ...
  if ( a1 == 590860 )
  {
    v11 = v6 - 32;
    v34 = v6 - 32;
    Pool2 = (_REPARSE_DATA_BUFFER *)ExAllocatePool2(97LL, (unsigned int)(v6 - 32), 538996553LL);
    v13 = a2 + 2;
  ...
  else
  {
    v11 = v6;
    v34 = v6;
    Pool2 = (_REPARSE_DATA_BUFFER *)ExAllocatePool2(97LL, v6, 538996553LL);
    v14 = v6;
    v13 = a2;
  }
  v15 = Pool2;
  ...
  if ( appended >= 0 )
  {
    ...
    *(_OWORD *)&ObjectAttributes.SecurityDescriptor = 0LL;
    ...
    if ( appended >= 0 )
    {
      appended = sub_1402AC790(FileHandle, 0, 0, &Object, 0LL);
      if ( appended >= 0 )
      {
        v17 = (PVOID *)Object;
...
LABEL_5:
        ...
        if ( RtlPrefixUnicodeString(&String1, &String2, 1u)
          ...
          || (appended = RtlVolumeDeviceToDosName(v17[1], &DestinationString), appended < 0) )
        {
          v18 = 1;
          v28 = 1;
        }
        if ( v18 )
          appended = IoVolumeDeviceToGuidPath((PDEVICE_OBJECT)v17[1]);
        if ( appended >= 0 )
        {
          v19 = String2.Length + 8;
          while ( 1 )
          {
            v10 = (wchar_t *)ExAllocatePool2(64LL, v19, 1700032329LL);
            if ( !v10 )
              goto LABEL_46;
            appended = sub_14071E6BC(Object, (__int64)v10, (__int64)&v30, 1);
          ...
          v24 = (_OWORD *)ExAllocatePool2(65LL, v23, 538996553LL);
          v9 = v24;
          if ( !v24 )
          {
LABEL_46:
