/*
 * XREFs of sub_140627E00 @ 0x140627E00
 * Callers:
 *     <none>
 * Callees:
...
NTSTATUS __fastcall sub_140627E00(
        HANDLE TimerHandle,
...
LABEL_12:
  v23[0] = v17;
LABEL_13:
  BYTE4(v23[2]) = ResumeTimer;
  LODWORD(v23[2]) = Period;
  v23[1] = PreviousState;
  v23[6] = TimerHandle;
  v23[5] = DueTime;
  v23[4] = TimerApcRoutine;
  v23[3] = TimerContext;
