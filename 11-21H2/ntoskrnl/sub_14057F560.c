/*
 * XREFs of sub_14057F560 @ 0x14057F560
 * Callers:
...
__int64 __fastcall sub_14057F560(unsigned __int16 **a1, __int64 a2, unsigned int a3, _BYTE *a4, _DWORD *a5)
{
  unsigned int v5; // edi
  unsigned int v7; // eax
  ...
  v8 = *a1;
  v9 = a3 <= (unsigned __int16)word_140D05000;
  *a4 = 0;
  if ( !v9 )
    v5 = v7;
  v10 = 0;
