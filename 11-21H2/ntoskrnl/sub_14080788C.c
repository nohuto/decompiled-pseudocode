/*
 * XREFs of sub_14080788C @ 0x14080788C
 * Callers:
...
__int64 __fastcall sub_14080788C(__int64 a1, __int64 a2, _DWORD *a3)
{
  int v4; // eax
  ...
  v18[30] = &v16;
  v18[31] = 8LL;
  return sub_140811238(qword_14000FAE0, 16LL, v18);
}
