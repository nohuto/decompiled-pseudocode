/*
 * XREFs of Xp10BuildAndWriteHuffmanEncodings @ 0x1409C1150
 * Callers:
        ...
        unsigned int *a7)
{
  ...
  if ( v25 + 2 <= v27 || (v24 = v27 - v25, v27 != v25) )
  {
    ...
    if ( v28 >= v24 )
      v29 = v24;
    *v26 |= (byte_14001BB70[4 * v29] & 2) << (v25 & 7);
    ...
    if ( (_DWORD)v30 )
      *v31 |= (unsigned __int8)v32 & byte_14001BB70[4 * v30];
    *(_DWORD *)(a6 + 8) = v25 + v24;
  }
    ...
    else
    {
        ...
        do
        {
          ...
          if ( v60 > 8 )
          {
            ...
            do
            {
              ...
              v40 -= 8;
              v41 >>= 8;
              v39 = *((unsigned __int8 *)qword_14001BBA0 + v43) | (v39 << 8);
              --v42;
            }
            while ( v42 );
          }
          if ( v40 )
            v39 = (*((unsigned __int8 *)qword_14001BBA0 + (unsigned __int8)v41) | (v39 << 8)) >> (8 - v40);
        ...
        do
        {
          ...
          if ( v58 > 8 )
          {
            ...
            do
            {
              ...
              v47 -= 8;
              v46 >>= 8;
              v45 = *((unsigned __int8 *)qword_14001BBA0 + v49) | (v45 << 8);
              --v48;
            }
            while ( v48 );
          }
          if ( v47 )
            v45 = (*((unsigned __int8 *)qword_14001BBA0 + (unsigned __int8)v46) | (v45 << 8)) >> (8 - v47);
          LODWORD(v37) = v37 + 1;
          *v44++ = v58 & 0x1F | (32 * v45);
        }
      ...
      *(_DWORD *)(v21 + 8) = v25;
      if ( v25 + 2 <= v52 || (v23 = v52 - v25, v52 != v25) )
      {
        ...
        if ( (_DWORD)v55 )
          *v56 |= (unsigned __int8)v54 & byte_14001BB70[4 * v55];
