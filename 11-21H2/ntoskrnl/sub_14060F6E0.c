/*
 * XREFs of sub_14060F6E0 @ 0x14060F6E0
 * Callers:
 *     <none>
 * Callees:
...
PGENERIC_MAPPING sub_14060F6E0()
{
  __int64 v0; // rdx
  __int64 v1; // rcx
  __int64 *v2; // rbx
...
LABEL_18:
  result = IoGetFileObjectGenericMapping();
  *((_QWORD *)&v12 + 1) = result;
  if ( v2 )
  {
    v10 = v2 + 6;
    ...
    if ( v11 != v10 )
    {
      ...
      while ( v11 != v10 );
      return (PGENERIC_MAPPING)*((_QWORD *)&v12 + 1);
    }
  }
  return result;
}
