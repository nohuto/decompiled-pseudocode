/*
 * XREFs of DifZwSetInformationThreadWrapper @ 0x1406277D0
 * Callers:
 *     <none>
 * Callees:
        ...
        ULONG ThreadInformationLength)
{
  ...
  v20 = 0LL;
  v21 = 0LL;
  APIThunkContextById = DifGetAPIThunkContextById(629);
...
LABEL_13:
  *(_QWORD *)&v21 = ThreadHandle;
  DWORD2(v20) = ThreadInformationClass;
  *(_QWORD *)&v20 = ThreadInformation;
  DWORD2(v19) = ThreadInformationLength;
...
LABEL_18:
  result = ZwSetInformationThread(ThreadHandle, ThreadInformationClass, ThreadInformation, ThreadInformationLength);
  DWORD2(v21) = result;
  if ( APIThunkContextById )
  {
