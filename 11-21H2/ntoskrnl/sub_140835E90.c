/*
 * XREFs of sub_140835E90 @ 0x140835E90
 * Callers:
...
char __fastcall sub_140835E90(int a1, int a2, int a3, char a4, char a5)
{
  int v5; // r8d
  char result; // al
  ...
  if ( (unsigned int)dword_140C043E0 > 5 )
  {
    ...
    v34 = 1;
    v37 = 1;
    result = sub_14020A9C4((__int64)&dword_140C043E0, (unsigned __int8 *)byte_1400349C9, 0LL, 0LL, 7u, &v23);
  }
  if ( qword_140C16478 )
  {
    UserData.Reserved = 0;
    ...
    v18 = 1;
    v21 = 1;
    return EtwWrite(qword_140C16478, &stru_140012658, 0LL, 5u, &UserData);
  }
  return result;
}
