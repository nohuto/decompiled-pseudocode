/*
 * XREFs of sub_140644EEC @ 0x140644EEC
 * Callers:
...
__int64 __fastcall sub_140644EEC(__int64 a1)
{
  NTSTATUS v2; // ebx
  NTSTATUS v3; // eax
  char *Pool2; // rdi
  ...
  *(_OWORD *)&ObjectAttributes.SecurityDescriptor = 0LL;
  ...
  if ( v2 >= 0 )
  {
    if ( *((_DWORD *)Pool2 + 1) == 3 )
    {
      ...
      v5 = &Pool2[v10];
LABEL_12:
      if ( v6 + 1 <= dword_140C0DA88 )
      {
        if ( (unsigned __int8)sub_1406452F0(v5, a1, &v12) )
      ...
      {
        if ( !_InterlockedCompareExchange(&dword_140D04C6C, 1, 0) )
        {
