/*
 * XREFs of sub_1409909A4 @ 0x1409909A4
 * Callers:
 *     sub_140990BB0 @ 0x140990BB0 (sub_140990BB0.c)
 * Callees:
 *     EtwWrite @ 0x140300BC0 (EtwWrite.c)
 *     __security_check_cookie @ 0x1403DF760 (__security_check_cookie.c)
 */

NTSTATUS __fastcall sub_1409909A4(__int64 a1, unsigned __int16 *a2, unsigned __int16 *a3, char a4)
{
  int v4; // ecx
  ...
  *(_QWORD *)&UserData.Size = 8LL;
  ...
  return EtwWrite(RegHandle, &stru_1400378D8, 0LL, v7, &UserData);
}
