/*
 * XREFs of sub_140966EA8 @ 0x140966EA8
 * Callers:
...
__int64 __fastcall sub_140966EA8(char *a1, _QWORD *a2, unsigned int *a3)
{
  unsigned int v3; // edi
  int v7; // ebx
  __int64 Pool2; // rax
  ...
  if ( v7 == -1073741820 )
  {
    if ( v11 <= v3 )
    {
      ...
      if ( Pool2 )
      {
        v7 = sub_1407103B0(a1, Pool2, v11, &v11);
        if ( v7 < 0 )
