/*
 * XREFs of sub_14057EEC4 @ 0x14057EEC4
 * Callers:
...
char __fastcall sub_14057EEC4(__int64 a1, __int64 a2, __int64 a3, int a4, char a5, char a6)
{
  _UNKNOWN **v6; // rax
  REGHANDLE v7; // rbx
  ...
  if ( qword_140D00B58 )
  {
    LOBYTE(v6) = EtwEventEnabled(qword_140D00B58, &stru_1400382A8);
    if ( (_BYTE)v6 )
    {
      UserData.Reserved = 0;
      v12 = 0;
      ...
      v20 = 4;
      v23 = 4;
      LOBYTE(v6) = EtwWriteEx(v7, &stru_1400382A8, 0LL, 0, 0LL, 0LL, 6u, &UserData);
    }
  }
  return (char)v6;
}
