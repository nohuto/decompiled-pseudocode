/*
 * XREFs of RtlFormatMessageEx @ 0x1409B6A58
 * Callers:
        ...
        __int64 a9)
{
  ...
  NTSTRSAFE_PWSTR v82; // [rsp+98h] [rbp-70h]
  __int64 v83; // [rsp+A0h] [rbp-68h]
  NTSTRSAFE_PWSTR v84; // [rsp+A8h] [rbp-60h]
...
LABEL_73:
      ...
      v37 = RtlStringCchPrintfExW(v16, v17, &v78, 0LL, 0, &pszDest, v52, v53, v54);
      goto LABEL_75;
    }
    if ( v32 == 1 )
    {
    ...
    {
      v36 = pszDest - 37;
      if ( pszDest == 37 && (v36 = v88[0] - 115, v88[0] == 115) )
      {
        v10 = 0;
        v36 = v88[1];
      }
      ...
      {
        LODWORD(v69) = v28;
        v37 = RtlStringCchPrintfExW(v16, v17, &v78, 0LL, 0, L"%%%u!%s!", v69, v88);
        goto LABEL_75;
      }
    }
    LODWORD(v69) = v28;
    v37 = RtlStringCchPrintfExW(v16, v17, &v78, 0LL, 0, L"%%%u", v69);
LABEL_75:
    if ( v37 < 0 )
      return 2147483653LL;
    v58 = v78 - v16;
