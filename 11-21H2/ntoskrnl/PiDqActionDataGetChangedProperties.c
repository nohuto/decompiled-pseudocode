/*
 * XREFs of PiDqActionDataGetChangedProperties @ 0x140699E6C
 * Callers:
        ...
        unsigned int *a10)
{
  ...
  *(_OWORD *)Str1 = 0LL;
  ...
  while ( 1 )
  {
    ...
    if ( !Handle )
    {
      v11 = PiDqOpenObjectRegKey(1, v45, a2, 1, 0, v49, &Handle);
      if ( v11 == -1073741772 )
      {
        Handle = (HANDLE)-1LL;
        v11 = 0;
...
LABEL_15:
  ...
  v11 = PiDqPnPGetObjectPropertyInBestLocale(v45, v17, v14, (int)v15 + 80, *(_DWORD *)(v15 + 100), v47, (__int64)&v50);
  if ( v11 >= 0 )
  {
    v24 = v47;
    v25 = Str1[1];
