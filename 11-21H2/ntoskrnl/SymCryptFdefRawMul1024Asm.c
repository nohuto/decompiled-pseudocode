/*
 * XREFs of SymCryptFdefRawMul1024Asm @ 0x14040F0D0
 * Callers:
 *     SymCryptFdefModMulMontgomery1024 @ 0x14040C440 (SymCryptFdefModMulMontgomery1024.c)
 * Callees:
 *     <none>
 */

unsigned __int64 __fastcall SymCryptFdefRawMul1024Asm(
        unsigned __int64 *a1,
        unsigned __int64 *a2,
        __int64 a3,
        unsigned __int64 *a4)
