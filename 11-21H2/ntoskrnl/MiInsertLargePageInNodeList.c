/*
 * XREFs of MiInsertLargePageInNodeList @ 0x1402BEEA0
 * Callers:
 ...
 *     MiAnyPagesRemovalPending @ 0x1405AEA2C (MiAnyPagesRemovalPending.c)
...
unsigned __int64 __fastcall MiInsertLargePageInNodeList(__int64 a1)
{
  ...
  *(_QWORD *)(v4 + 40) = v5 & 0x7FFFFFFFFFFFFFFFLL;
  if ( v1 != 1 && (MiFlags & 0x80u) != 0 && (++dword_140C52AE0 & MmPageValidationFrequency) == 0 )
    MiArePageContentsZero(v2);
  v9 = *(unsigned int *)(MiSearchNumaNodeTable(v2) + 8);
  if ( qword_140C50710 )
    v74 = *(unsigned __int16 *)(MiSearchChannelTable(v2) + 12);
  else
    v74 = 0LL;
  v10 = v82;
  v11 = MiLargePageSizes[v82];
  ...
  if ( (v71 & 2) == 0 )
  {
    ...
    if ( (BYTE6(PerfGlobalGroupMask) & 0x21) != 0 )
      ExpAcquireSpinLockExclusiveAtDpcLevelInstrumented(v38, v16);
    else
      ExpAcquireSpinLockExclusive(v38, v16);
    v12 = v77;
    v10 = v82;
    v15 = v1;
  }
  if ( *(_QWORD *)(v72 + 22904) && (unsigned int)MiAnyPagesRemovalPending(v2, v10) )
  {
    ExReleaseSpinLockExclusiveFromDpcLevel((PEX_SPIN_LOCK)(v72 + 22848));
    _InterlockedAnd64((volatile signed __int64 *)(v4 + 24), 0x7FFFFFFFFFFFFFFFuLL);
    v32 = v82;
    MiConvertEntireLargePageToSmall(v4, v82, 1, v1, 0LL, (__int64)&v73, v3 + 24);
    if ( (v71 & 4) != 0 )
    {
...
LABEL_33:
    ...
    if ( v26 )
    {
      ...
      v76.LockQueue.Lock = (unsigned __int64 *volatile)(v6 + 15680);
      KxAcquireQueuedSpinLock(&v76);
      v50 = 0;
...
LABEL_70:
  ...
  if ( v83 && (v71 & 1) == 0 && (MiFlags & 0x30) != 0 && (v32 != 1 || _bittest64(&KeFeatureBits, 0x25u)) )
