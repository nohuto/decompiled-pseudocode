/*
 * XREFs of TtmiLogSessionPowerRequestDeleted @ 0x1409A9E00
 * Callers:
...
void TtmiLogSessionPowerRequestDeleted()
{
  ...
  if ( (unsigned int)dword_140D3B908 > 5 )
  {
    if ( tlgKeywordOn((__int64)&dword_140D3B908, 1LL) )
    {
      ...
      v6 = v2;
      v11 = 4LL;
      tlgWriteTransfer_EtwWriteTransfer((__int64)&dword_140D3B908, (unsigned __int8 *)byte_140033503, 0LL, 0LL, 5u, &v7);
    }
  }
}
