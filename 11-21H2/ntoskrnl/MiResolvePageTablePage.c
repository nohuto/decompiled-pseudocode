/*
 * XREFs of MiResolvePageTablePage @ 0x14031D740
 * Callers:
...
__int64 __fastcall MiResolvePageTablePage(__int64 a1)
{
  ...
  do
  {
    v9 = *v7;
    v10 = *(_QWORD *)*v7;
    if ( *v7 >= 0xFFFFF6FB7DBED000uLL && v9 <= 0xFFFFF6FB7DBED7F8uLL && (MiFlags & 0xC00000) != 0 )
    {
        ...
        && ((v10 & 0x20) == 0 || (v10 & 0x42) == 0) )
      {
        ...
        if ( Flink )
        {
          v18 = *((_QWORD *)&Flink->Flink + ((v9 >> 3) & 0x1FF));
          v19 = v10 | 0x20;
          if ( (v18 & 0x20) == 0 )
            v19 = *(_QWORD *)*v7;
          v10 = v19;
    ...
    {
      if ( !MiIsPdeOrAboveAccessible(v9) )
        goto LABEL_47;
      if ( !v10 )
      {
        v14 = *(_QWORD *)(a1 + 16);
...
LABEL_36:
  ...
  if ( (v13 & 1) != 0 )
  {
    ...
    if ( *v15 == 8 && !MI_READ_PTE_LOCK_FREE(*(_QWORD *)(a1 + 24)) )
    {
      v15[44] = 1;
      v12 = -1073741819;
      goto LABEL_36;
