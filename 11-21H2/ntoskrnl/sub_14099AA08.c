/*
 * XREFs of sub_14099AA08 @ 0x14099AA08
 * Callers:
...
void __fastcall sub_14099AA08(__int64 a1)
{
  _QWORD *v2; // rcx
  __int64 v3; // rdx
  __int64 v4; // rax
  ...
  if ( byte_140C5AE30 && EtwEventEnabled(qword_140C1F580, &stru_1400394A8) )
  {
    UserData.Reserved = 0;
    v9 = 0;
    v2 = (_QWORD *)(a1 + 56);
    ...
    v20 = 8;
    v23 = 8;
    EtwWrite(qword_140C1F580, &stru_1400394A8, 0LL, 7u, &UserData);
  }
}
