/*
 * XREFs of sub_140976D80 @ 0x140976D80
 * Callers:
 *     <none>
 * Callees:
...
char __fastcall sub_140976D80(_DWORD *a1, int *a2, int a3, unsigned __int8 a4)
{
  int v4; // edx
  __int64 v5; // rbx
...
LABEL_5:
    v5 = *(_QWORD *)a1;
    sub_1409C03F8(a3, v4, *(unsigned __int16 *)(*(_QWORD *)a1 + 136LL), (unsigned int)&StartingIndex, (__int64)&v8);
