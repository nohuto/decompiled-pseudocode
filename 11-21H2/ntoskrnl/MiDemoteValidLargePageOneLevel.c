/*
 * XREFs of MiDemoteValidLargePageOneLevel @ 0x1403C9590
 * Callers:
...
__int64 __fastcall MiDemoteValidLargePageOneLevel(unsigned __int64 a1)
{
  ...
  *(_DWORD *)&v47[8] = 0;
  ...
  LODWORD(v56[1]) = 20;
  v56[3] = 0LL;
  *(_QWORD *)v47 = (unsigned int)MI_IS_PHYSICAL_ADDRESS(a1);
  v2 = *(_DWORD *)v47;
  ...
  v49 = MI_READ_PTE_LOCK_FREE(v3);
  v6 = v49;
  v7 = ((unsigned __int64)MI_READ_PTE_LOCK_FREE((unsigned __int64)&v49) >> 12) & 0xFFFFFFFFFFLL;
  v51 = v7;
  MiInitializeLargePfnList(v55);
  LODWORD(v55[15]) = 4;
  v55[12] = &MiSystemPartition;
  v8 = MiSearchNumaNodeTable(v7);
  MiInitializeColorBase(a1, (unsigned int)(*((_DWORD *)v8 + 2) + 1), (__int64)&v55[42], v9);
  if ( (int)MiGetPageTablePages((__int64)v55, 1uLL, 0, &v47[4]) < 0 )
    return 0LL;
  v11 = *(_QWORD *)&v47[4];
  **(_QWORD **)&v47[4] = 0LL;
  v12 = 0xAAAAAAAAAAAAAAABuLL * ((v11 + 0x220000000000LL) >> 4);
  v50 = v12;
  v45 = MI_READ_PTE_LOCK_FREE(((v3 >> 9) & 0x7FFFFFFFF8LL) - 0x98000000000LL);
  v13 = MI_READ_PTE_LOCK_FREE((unsigned __int64)&v45);
  v14 = -2147483644;
  v53 = (v13 >> 12) & 0xFFFFFFFFFFLL;
  if ( (v6 & 0x100) != 0 && v2 == 1 )
    v14 = -1610612732;
  v54 = v3 << 25;
  ValidPte = MiMakeValidPte((__int64)(v3 << 25) >> 16, v7, v14);
  v45 = ValidPte;
  v16 = ValidPte;
  v17 = ValidPte;
  if ( ((unsigned __int8)(1 << (v2 - 1)) & (unsigned __int8)byte_140C506CE) != 0 )
  {
    v16 = ValidPte & 0xFFFFFFFFFFFFFFDFuLL;
    v45 = ValidPte & 0xFFFFFFFFFFFFFFDFuLL;
    v17 = ValidPte & 0xFFFFFFFFFFFFFFDFuLL;
  }
  v52 = MiMapPageInHyperSpaceWorker(v12, (unsigned __int8 *)&v44, 0x80000000);
  v18 = v52;
  do
  {
    v46 = 0;
...
LABEL_22:
  ...
  while ( (v18 & 0xFFF) != 0 );
  MiUnmapPageInHyperSpaceWorker(v52, v44);
  v22 = *(_DWORD *)v47;
  v23 = -2080374780;
  v24 = v51;
  if ( *(_DWORD *)v47 == 1 )
  ...
  if ( (v49 & 0x100) == 0 )
    v25 = v23;
  v26 = MiMakeValidPte(v3, v51, v25 | 0x8000000u);
  v27 = v50;
  v45 = v26;
  MiInitializePfnForOtherProcess(v50, v3, v53, 2560);
  v31 = *(_QWORD *)&v47[4];
  *(_DWORD *)v47 = 0;
  ...
  *(_QWORD *)(v31 + 24) ^= (*(_QWORD *)(v31 + 24) ^ (*(_QWORD *)(v31 + 24) + 512LL)) & 0x3FFFFFFFFFFFFFFFLL;
  ...
  MiTransformValidPteInPlace((volatile signed __int64 *)v3, v3, v45, v22);
  v36 = 3LL;
  if ( v22 == 3 )
  ...
  for ( i = v37 + 24576; ; i = *(_QWORD *)&v47[4] )
  {
    ...
    *(_QWORD *)&v47[4] = v42;
    ...
    {
      do
        KeYieldProcessorEx(&v48, v36, v34, v35);
    ...
    if ( (*(_BYTE *)(*(_QWORD *)&v47[4] + 35LL) & 0x10) == 0 )
    {
      if ( _bittest64((const signed __int64 *)(*(_QWORD *)&v47[4] + 40LL), 0x28u) )
        MiConvertLargePfnToSmall(v37, *(_QWORD *)&v47[4], v34, 0LL);
      *(_QWORD *)(v43 + 8) = v39;
      MiSetPfnPteFrame(v43, v38);
    }
  ...
  if ( v22 == 1 )
    MiUpdateLargePageBitMap((__int64)&MiSystemPartition, v51, v33 >> 12, 0, 1);
  MiFlushTbList((__int64)v56);
  return 1LL;
}
