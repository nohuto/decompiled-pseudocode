/*
 * XREFs of ExpStampPoolWithQuotaProcess @ 0x140367B44
 * Callers:
 ...
 *     ExpStampPoolEntryWithQuotaProcess @ 0x140367C0C (ExpStampPoolEntryWithQuotaProcess.c)
        ...
        _DWORD *a6)
{
  ...
  {
    result = (_BYTE *)ExpStampBigPoolEntry(BugCheckParameter2, a2, a3, a5, a6);
  }
  if ( !a4
