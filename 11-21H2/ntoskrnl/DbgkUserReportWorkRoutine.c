/*
 * XREFs of DbgkUserReportWorkRoutine @ 0x140929C60
 * Callers:
 *     <none>
 * Callees:
...
LONG_PTR __fastcall DbgkUserReportWorkRoutine(char *P)
{
  ...
  *(_QWORD *)&v14 = 0LL;
  ...
  KiStackAttachProcess(v3, 0LL, (__int64)v15, v4);
  ...
  {
    ZwSetInformationThread(ThreadHandle, ThreadDynamicCodePolicyInfo|ThreadAffinityMask, &dword_14003AC4C, 4u);
