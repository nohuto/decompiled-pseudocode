/*
 * XREFs of sub_14076A9A0 @ 0x14076A9A0
 * Callers:
...
__int64 __fastcall sub_14076A9A0(__int64 a1, __int64 a2, int a3, HANDLE *a4, _BYTE *a5, int a6)
{
  __int64 v10; // rsi
  int v11; // eax
  int v12; // eax
  ...
  v12 = sub_14076AB18(a1, a2, v16[2], (unsigned int)&v16[3], (__int64)&v16[4], SWORD2(v16[4]));
  v13 = v12;
  if ( v10 )
  {
    LODWORD(v16[0]) = v12;
