/*
 * XREFs of sub_14061A750 @ 0x14061A750
 * Callers:
 *     <none>
 * Callees:
...
NTSTATUS __fastcall sub_14061A750(PCREATE_PROCESS_NOTIFY_ROUTINE NotifyRoutine, BOOLEAN a2)
{
  __int64 v4; // rdx
  __int64 v5; // rcx
  __int64 *v6; // rdi
