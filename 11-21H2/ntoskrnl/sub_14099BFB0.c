/*
 * XREFs of sub_14099BFB0 @ 0x14099BFB0
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall sub_14099BFB0(__int64 a1, unsigned __int64 *a2)
{
  _DWORD *v2; // r12
  unsigned int v3; // r8d
  unsigned int v4; // esi
  ...
  do
  {
    ...
    if ( v7 >= v8 && v7 < v8 + *(unsigned int *)(a1 + 64) )
    {
      ...
      *((_WORD *)v9 + 4) = 0;
      *((_WORD *)v9 + 5) = v11;
      v3 = sub_1402D17BC((_WORD *)v9 + 4, L"%s+0x%08X", *(_QWORD *)(a1 + 96), (unsigned int)v10);
    }
    ++v4;
    ++v5;
  }
