/*
 * XREFs of sub_140561484 @ 0x140561484
 * Callers:
...
NTSTATUS sub_140561484(__int64 a1, __int64 a2, const GUID *a3, ...)
{
  ...
  if ( !v62 )
    v23 = L"NULL";
  v49 = v23;
  return sub_1402D1760(qword_140C03910, (const EVENT_DESCRIPTOR *)qword_14003B1A0, a3, 0xAu, &v26);
}
