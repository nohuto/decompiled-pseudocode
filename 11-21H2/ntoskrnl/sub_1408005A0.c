/*
 * XREFs of sub_1408005A0 @ 0x1408005A0
 * Callers:
...
void sub_1408005A0()
{
  ...
  v0 = 0LL;
  if ( (dword_140C2227C & 0x200) == 0 && FileObject )
  {
    v1[0] = 0;
    v1[1] = 1;
    v2 = 4096LL;
    v3 = -4097LL;
    if ( ZwFsControlFile(*(HANDLE *)&MaxDataSize, 0LL, 0LL, 0LL, &v0, 0x98208u, v1, 0x18u, 0LL, 0) == 259 )
