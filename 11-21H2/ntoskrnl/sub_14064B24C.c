/*
 * XREFs of sub_14064B24C @ 0x14064B24C
 * Callers:
...
__int64 __fastcall sub_14064B24C(__int64 a1, _BYTE *a2)
{
  unsigned int v4; // ebx
  int v5; // edi
  __int16 v6; // r15
...
LABEL_17:
  ...
  v6 = *(_WORD *)(a1 + 22);
  v5 = sub_1403CC5E8(0LL, a1, 2, (__int64)v22, (__int64)v18, (__int64)&v19, v14, (__int64)v21);
  if ( v5 < 0 )
    goto LABEL_17;
  if ( *(_WORD *)(a1 + 20)
    && (v7 = *(unsigned __int16 *)(a1 + 20), v15 = 0, v16 = 0, (int)sub_140844FB8(v7, &v15, &v16) >= 0) )
  {
