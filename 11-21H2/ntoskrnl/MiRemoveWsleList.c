/*
 * XREFs of MiRemoveWsleList @ 0x140218310
 * Callers:
  ...
  if ( a4 )
  {
    ...
    do
    {
      ...
      if ( (v18 & 1) != 0 )
      {
        ...
        {
          if ( PsNtosImageBase
            && (v19 < PsNtosImageEnd && v19 >= PsNtosImageBase || v19 < PsHalImageEnd && v19 >= PsHalImageBase) )
          {
            ++v16;
          }
          else if ( (unsigned int)MiGetSystemRegionType(v19, v9, v12, 0xFFFFF6FB40000000uLL) == 12 )
          {
            IsDriverPage = MiIsDriverPage(((v19 >> 9) & 0x7FFFFFFFF8LL) - 0x98000000000LL, 1LL);
            v9 = v58;
            v12 = v59;
            v11 = v56;
            if ( IsDriverPage )
...
LABEL_39:
          ...
          do
          {
            if ( (v15[(_QWORD)v22 - 23] & 1) != 0 )
            {
              ...
              if ( v21 == 2 )
              {
                ...
                {
                  LOBYTE(v43) = 10;
                  MiWriteWsle(v45, *v22, v43);
                }
              }
              if ( (DWORD1(PerfGlobalGroupMask) & 0x8000000) != 0 )
                MiLogRemoveWsleEvent(v44, *(_BYTE *)(a1 + 184) & 7);
            }
            ++v22;
            --v24;
          }
      ...
      if ( v28 < 0xFFFFF68000000000uLL || v28 > 0xFFFFF6FFFFFFFFFFuLL )
      {
          ...
          && ((v33 & 0x20) == 0 || (v33 & 0x42) == 0) )
        {
          ...
          if ( Flink )
          {
            v52 = *((_QWORD *)&Flink->Flink + ((v34 >> 3) & 0x1FF));
            v53 = v33 | 0x20;
            if ( (v52 & 0x20) == 0 )
        ...
        v70 = v33;
        v35 = (__int64 *)(48 * (((unsigned __int64)MI_READ_PTE_LOCK_FREE(&v70) >> 12) & 0xFFFFFFFFFFLL)
                        - 0x220000000000LL);
        v36 = *v35;
