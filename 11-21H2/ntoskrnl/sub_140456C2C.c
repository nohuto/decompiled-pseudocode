/*
 * XREFs of sub_140456C2C @ 0x140456C2C
 * Callers:
...
__int64 __fastcall sub_140456C2C(volatile signed __int32 *a1)
{
  __int64 result; // rax

  result = (unsigned int)_InterlockedDecrement(&dword_140C4C190);
  if ( a1 )
