/*
 * XREFs of sub_14057C2F0 @ 0x14057C2F0
 * Callers:
...
NTSTATUS __fastcall sub_14057C2F0(PPROCESSOR_NUMBER ProcNumber)
{
  int Number; // edi
  NTSTATUS result; // eax
  ...
  v4[1] = (unsigned __int16 *)qword_140D06E48[0];
  v4[0] = (unsigned __int16 *)dword_140D06E40;
  v5 = 0;
  while ( 1 )
  {
