/*
 * XREFs of sub_140645708 @ 0x140645708
 * Callers:
 *     sub_140644750 @ 0x140644750 (sub_140644750.c)
 *     sub_140645A60 @ 0x140645A60 (sub_140645A60.c)
 * Callees:
...
__int64 __fastcall sub_140645708(__int64 a1, __int64 a2, __int64 a3, unsigned int a4)
{
  size_t v5; // r12
  unsigned int v7; // ecx
  _DWORD *v8; // rbx
...
LABEL_48:
    sub_14024F6E4(&Src[8], 32LL, (__int64)v10);
    v29 = -1073741811;
LABEL_49:
    Src[3] = 0;
    Src[0] = 1733060695;
  ...
  *(_DWORD *)(a3 + 104) = v16 ^ v17 & 4;
  ...
  if ( v33 )
  {
    while ( v9 + 64 >= v9 )
    {
      ...
      LODWORD(Size) = v21;
      v32 = v24;
      v15 = sub_14064558C(a1, a3, v5, v18, Size, 1);
      if ( v15 >= 0
        || (sub_14024F6E4(&Src[8], 32LL, (__int64)"Failed_Add_Section"), *(_DWORD *)(a3 + 104) |= 0x40u, v32 != 1) )
      {
        ++Src[16];
        if ( --v33 )
          continue;
...
LABEL_31:
  ...
  if ( (_DWORD)v25 && (v26 = v8[2]) != 0 )
  {
    ...
    v28 = (_DWORD *)a1;
    LODWORD(Size) = v26;
    v15 = sub_14064558C(a1, a3, v5, v27, Size, 0);
    if ( v15 < 0 )
    {
      sub_14024F6E4(&Src[8], 32LL, (__int64)"Failed_Add_Unstructured");
      *(_DWORD *)(a3 + 104) |= 0x40u;
    }
  }
  else
