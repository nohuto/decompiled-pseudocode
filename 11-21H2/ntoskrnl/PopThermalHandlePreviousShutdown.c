/*
 * XREFs of PopThermalHandlePreviousShutdown @ 0x1408604BC
 * Callers:
  ...
  if ( (int)PopOpenThermalLoggingKey(0, &KeyHandle) >= 0 )
  {
      ...
      && *(_QWORD *)((char *)&KeyValueInformation + 4) == 0x400000004LL )
    {
      ...
      if ( ZwDeleteValueKey(v0, &DestinationString) >= 0 )
      {
        ...
        if ( (unsigned int)dword_140C067B0 > 5 && tlgKeywordOn((__int64)&dword_140C067B0, 0x800000000000LL) )
        {
          tlgCreate1Sz_wchar_t((__int64)v17, v3);
          v20 = 0;
          v23 = 0;
          ...
          tlgWriteTransfer_EtwWriteTransfer(
            (__int64)&dword_140C067B0,
            (unsigned __int8 *)byte_14002E3CB,
            0LL,
            0LL,
            5u,
            &v16);
