/*
 * XREFs of sub_14029D2AC @ 0x14029D2AC
 * Callers:
...
unsigned __int64 __fastcall sub_14029D2AC(__int64 a1, __int64 a2, __int64 a3, int a4, struct _KTHREAD *a5)
{
  ...
  if ( a4 > 0 )
  {
    ...
    if ( v7 )
    {
      ...
      result = *((_QWORD *)CurrentThread + 68);
