/*
 * XREFs of ExLogTimeZoneInformation @ 0x1403DB94C
 * Callers:
...
int ExLogTimeZoneInformation()
{
  ...
  if ( ThreadServerSilo )
    v1 = *(_QWORD **)(ThreadServerSilo + 1464);
  if ( (unsigned int)dword_140C06820 > 5 )
  {
    ...
    v28 = 1;
    v31 = 8;
    tlgCreate1Sz_wchar_t((__int64)v33, (const WCHAR *)(v2 + 172));
    v5 = *((_BYTE *)v4 + 428);
    v36 = 0;
    v39 = 0;
    v42 = 0;
    ...
    v41 = 4;
    v44 = 4;
    LODWORD(ThreadServerSilo) = tlgWriteTransfer_EtwWriteTransfer(
                                  (__int64)&dword_140C06820,
                                  (unsigned __int8 *)&byte_140035E6F,
                                  0LL,
                                  0LL,
                                  0xEu,
                                  &v17);
  }
  return ThreadServerSilo;
}
