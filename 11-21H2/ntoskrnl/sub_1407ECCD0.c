/*
 * XREFs of sub_1407ECCD0 @ 0x1407ECCD0
 * Callers:
...
__int64 __fastcall sub_1407ECCD0(PCWSTR SourceString, __int64 a2)
{
  PVOID v3; // rsi
  NTSTATUS v4; // eax
  int v5; // edi
  ...
  *(_OWORD *)&ObjectAttributes.SecurityDescriptor = 0LL;
  ...
  if ( v4 >= 0 )
  {
    ...
    *(_OWORD *)&ObjectAttributes.SecurityDescriptor = 0LL;
    ...
    if ( v5 < 0 )
    {
      ...
      dword_140C2A220[2 * v12 + 1] = v5;
      dword_140C2A220[2 * v12] = 590528;
    }
    else
    {
      Object = 0LL;
      ...
      if ( v9 < 0 )
      {
        ...
        dword_140C2A220[2 * v13 + 1] = v5;
        dword_140C2A220[2 * v13] = 590542;
      }
      else
      {
        v18 = 0LL;
        v20 = 0LL;
        v5 = sub_1406F3FDC((__int64)Object, &BugCheckParameter1, &v18, &v20, 0LL, 0LL);
        if ( v5 < 0 )
        {
          v14 = ((unsigned __int8)_InterlockedExchangeAdd(&dword_140C2A200, 1u) + 1) & 0x3F;
          v7 = "KSE: Unable to map view of section!\n";
          dword_140C2A220[2 * v14 + 1] = v5;
          dword_140C2A220[2 * v14] = 590555;
        }
        else
        {
          v10 = BugCheckParameter1;
          v11 = sub_1407ECFCC(BugCheckParameter1, (unsigned int)v18);
          if ( v11 )
          {
            v5 = 0;
  ...
  else
  {
    ...
    dword_140C2A220[2 * v6 + 1] = v4;
    dword_140C2A220[2 * v6] = 590506;
  }
  if ( (dword_140D04880 & 2) != 0 )
    sub_14057D738(0LL, v7);
  sub_140368C88(0LL, (__int64)v7);
