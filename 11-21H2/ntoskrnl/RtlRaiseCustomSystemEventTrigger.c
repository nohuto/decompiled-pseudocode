...
DWORD __cdecl RtlRaiseCustomSystemEventTrigger(PCUSTOM_SYSTEM_EVENT_TRIGGER_CONFIG TriggerConfig)
{
  ...
  if ( TriggerConfig )
  {
    ...
    if ( updated < 0 )
      return updated;
    if ( _InterlockedExchange(&dword_140C1BBF0, 1) )
      return -1073741823;
    BufferSize = 4096;
    Buffer = (_DWORD *)sub_1409BE958(0x1000uLL);
    if ( Buffer )
    {
