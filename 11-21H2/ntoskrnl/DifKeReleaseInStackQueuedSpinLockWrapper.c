/*
 * XREFs of DifKeReleaseInStackQueuedSpinLockWrapper @ 0x140614750
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall DifKeReleaseInStackQueuedSpinLockWrapper(PKLOCK_QUEUE_HANDLE LockHandle)
{
  __int64 v2; // rdx
  __int64 v3; // rcx
