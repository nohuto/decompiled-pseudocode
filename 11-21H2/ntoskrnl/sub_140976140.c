/*
 * XREFs of sub_140976140 @ 0x140976140
 * Callers:
...
__int64 __fastcall sub_140976140(_QWORD *a1)
{
  unsigned int v2; // ebx
  void *v3; // rcx
  __int64 v4; // rdi
  ...
  if ( Mdl )
  {
    ...
    if ( (unsigned __int64)&Mdl[1] < v10 )
    {
      do
      {
        v9->Next = (struct _MDL *)qword_140C53288;
    ...
    v17 = sub_1403095B0((__int64)&qword_140C534C0, v4);
    if ( v17 )
    {
      sub_140308F00(v17, v8, v7, 4u, 2, &v19);
      v6->MdlFlags |= 1u;
