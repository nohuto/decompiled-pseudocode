/*
 * XREFs of MiCreateSparsePfnDatabase @ 0x140AF5D1C
 * Callers:
...
_BOOL8 __fastcall MiCreateSparsePfnDatabase(__int64 a1)
{
  __int64 v1; // rax
  __int64 v2; // r15
  int v3; // edi
  ...
  {
    if ( v1 == 1 )
      return (unsigned int)MxMapPfnRange(qword_140C50840 + 1)
          && (qword_140C52CE0 == qword_140C50840 + 1 || (unsigned int)MxMapPfnRange(qword_140C52CE0));
    v14 = v1 ^ ((a1 + 352) | 1);
  }
  else
  {
...
LABEL_31:
      ...
      if ( !v14 )
      {
        if ( v4 == -1LL || (unsigned int)MxMapPfnRange(v4) )
          return (unsigned int)MxMapPfnRange(qword_140C50840 + 1)
              && (qword_140C52CE0 == qword_140C50840 + 1 || (unsigned int)MxMapPfnRange(qword_140C52CE0));
        return 0LL;
      }
...
LABEL_30:
    ...
    {
LABEL_34:
      if ( !(unsigned int)MxMapPfnRange(v4) )
        return 0LL;
