/*
 * XREFs of WbAllocateMemoryBlock @ 0x1406E0214
 * Callers:
...
__int64 __fastcall WbAllocateMemoryBlock(__int64 a1, PVOID **a2)
{
  ...
  BaseAddress = 0LL;
  VirtualMemory = WbAlloc(1088LL, &BaseAddress);
  if ( VirtualMemory < 0 )
  {
    v9 = BaseAddress;
  }
  else
  {
    ...
    *BaseAddress = 0LL;
    ...
    VirtualMemory = MmAllocateVirtualMemory(-1, (int)v9, (int)v5, 4096, 32, 0LL, 0, 0, 0x20000000, 2, (__int64)v8);
    if ( VirtualMemory >= 0 )
    {
      if ( *v8 )
      {
        VirtualMemory = WbMakeUserExecutablePagesKernelWritable(*v9, *v5, v6, v7);
