/*
 * XREFs of sub_1407FE3D8 @ 0x1407FE3D8
 * Callers:
...
char __fastcall sub_1407FE3D8(int a1, int a2, int a3)
{
  ...
  if ( a1 >= 0 )
  {
    sub_14038B58C(&v41, &v13, &v12, &v11);
    v5 = v41;
    v3 = v13;
    v4 = v12;
  }
  result = swprintf_s(Dst, 9uLL, L"%08X", (unsigned int)a1);
  if ( byte_140C1C941 && (unsigned int)dword_140C045A8 > 5 )
  {
    result = sub_1402A2000((__int64)&dword_140C045A8, 0x400000000000LL);
    if ( result )
    {
      v20 = 4LL;
      v19 = &v14;
      ...
      v17 = 0x1000000LL;
      v39 = 8LL;
      return sub_14020A9C4((__int64)&dword_140C045A8, (unsigned __int8 *)byte_140032668, 0LL, 0LL, 0xDu, &v18);
    }
  }
  return result;
}
