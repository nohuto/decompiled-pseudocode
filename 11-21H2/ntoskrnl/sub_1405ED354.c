/*
 * XREFs of sub_1405ED354 @ 0x1405ED354
 * Callers:
...
bool __fastcall sub_1405ED354(_QWORD *a1, unsigned __int8 a2)
{
  __int64 v2; // rax
  __int64 v5; // rcx
  __int64 v6; // rdi
  ...
  while ( 1 )
  {
    v7 = sub_1405ED1A0(v5, &v16);
    LOBYTE(v8) = sub_1409BE43C(v6, v7);
    v11 = sub_1409BE454(v10, v9, v8) & 0x3F;
    if ( v11 <= a2 )
      break;
    v14 = v16;
    *(_QWORD *)(v12 + 104) = v16;
