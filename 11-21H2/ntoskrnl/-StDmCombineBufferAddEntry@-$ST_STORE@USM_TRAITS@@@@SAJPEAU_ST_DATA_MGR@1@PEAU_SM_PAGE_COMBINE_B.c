/*
 * XREFs of ?StDmCombineBufferAddEntry@?$ST_STORE@USM_TRAITS@@@@SAJPEAU_ST_DATA_MGR@1@PEAU_SM_PAGE_COMBINE_BUFFER@@PEAU_STDM_COMBINE_ENTRY_CACHE@1@PEAU_ST_PAGE_RECORD@1@@Z @ 0x14037F4B4
 * Callers:
...
LABEL_51:
    ...
    {
      v17 = LeafSibling + 16;
      *(_QWORD *)&v51 = LeafSibling;
      *((_QWORD *)&v51 + 1) = LeafSibling + 16;
      v14 = LeafSibling;
    }
    else
    {
    ...
    if ( v14 )
    {
      ...
      if ( v14 != *(_QWORD *)v26 )
      {
        ...
        if ( v47 <= v48 + 16 )
          v49 = (void **)(v48 + 8);
        if ( **(_DWORD **)(v26 + 16) != -1 )
          NP_CONTEXT::NpLeafDerefInternal((struct NP_CONTEXT::NP_CTX *)(v26 + 16), v49);
      }
    }
  }
  return v25;
