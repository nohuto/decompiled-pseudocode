/*
 * XREFs of MiCreateUserPhysicalView @ 0x14097CD04
 * Callers:
...
int __fastcall MiCreateUserPhysicalView(__int64 a1, int a2, __int64 a3, _WORD *a4)
{
  ...
  if ( v6 )
  {
    ...
    if ( result >= 0 )
    {
      ...
      v16 = *(_QWORD *)(v7 + 8);
      AwePageSize = MiGetAwePageSize(v16);
      v18 = AwePageSize;
      if ( (v8 & 2) != 0 )
      {
        v19 = 16LL;
...
LABEL_23:
      ...
      if ( v19 <= AwePageSize || v19 % AwePageSize || ((v19 - 1) & v19) != 0 || v19 != 512 || AwePageSize != 16 )
      {
LABEL_20:
  ...
  else
  {
    ...
    if ( a2 != 4 )
      return -1073741755;
    result = MiCreateProcessDefaultAweInfo(*(_BYTE *)(a3 + 57), &v27);
    if ( result >= 0 )
    {
      v16 = v27;
      v18 = 1LL;
