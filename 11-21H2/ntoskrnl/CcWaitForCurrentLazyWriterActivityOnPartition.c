/*
 * XREFs of CcWaitForCurrentLazyWriterActivityOnPartition @ 0x1403895EC
 * Callers:
 *     CcWaitForCurrentLazyWriterActivityHelper @ 0x1403895C0 (CcWaitForCurrentLazyWriterActivityHelper.c)
