/*
 * XREFs of sub_1407DEE78 @ 0x1407DEE78
 * Callers:
...
__int64 __fastcall sub_1407DEE78(_QWORD *a1, _DWORD *a2, int a3, char a4, __int64 a5)
{
  void *v5; // r15
  __int64 v8; // rcx
  __int64 v11; // rdx
  ...
  {
    sub_1407E08F4((_DWORD)a1, (_DWORD)a2, a3, (unsigned int)&v30, (__int64)&ObjectAttributes, (__int64)&v35);
    v16 = sub_1407DFC68(
            (unsigned int)&v31,
            a1[5],
    ...
    v16 = sub_140360A28((void *)v31.m256i_i64[0], 21248);
    if ( v16 < 0 )
    {
      v19 = v31.m256i_u64[3];
      goto LABEL_20;
  ...
  *(_OWORD *)&ObjectAttributes.SecurityDescriptor = 0LL;
  ...
  {
    LOBYTE(v21) = a4;
    v16 = sub_1407E098C(a1, a2, v21, &v29);
    if ( v16 < 0 )
    {
      v5 = v29;
    }
