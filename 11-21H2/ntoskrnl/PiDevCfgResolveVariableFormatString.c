/*
 * XREFs of PiDevCfgResolveVariableFormatString @ 0x14094DE60
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall PiDevCfgResolveVariableFormatString(__int64 a1, void *a2, __int64 a3)
{
  ...
  v51 = v7;
  v8 = IopGetRegistryValue(a2, L"Variables", 0, &v50);
  v9 = (unsigned int *)v50;
  v10 = 0;
  v49 = v8;
  RegistryValue = v8;
  if ( v8 >= 0 )
  {
    if ( !PnpValidateRegistryMultiSz(v50) )
    {
      RegistryValue = -1073741823;
      goto LABEL_100;
    }
    ...
    if ( *v11 != (_WORD)v10 )
    {
      ...
      if ( v5 )
      {
        ...
        if ( *v11 )
        {
          while ( v16 < v47 )
          {
            v17 = PiDevCfgResolveVariable(a1, v11, &v15[v16]);
            v10 = 0;
            v49 = v17;
            RegistryValue = v17;
            if ( v17 < 0 )
          ...
          if ( v37 < v47 )
          {
            ...
            if ( v39 )
            {
              ...
              if ( v40 )
              {
                ...
                if ( v40 == 4 )
                {
                  if ( RtlStringCchPrintfW(pszDest, 0xBuLL, L"%u", **(unsigned int **)(v39 + 40)) >= 0 )
                  {
                    v41 = pszDest;
                    v44 = -1LL;
                    do
