/*
 * XREFs of sub_1405A645C @ 0x1405A645C
 * Callers:
...
__int64 __fastcall sub_1405A645C(__int64 a1, unsigned __int64 a2, int a3, char a4)
{
  __int64 v4; // rdi
  ...
  while ( 1 )
  {
    ...
    v15 = sub_14028F080(v5, v13, 0LL, v38, 1, &v29);
    if ( !v15 )
      break;
    v16 = v29;
    v7 = ((v15 >> 9) & 0x7FFFFFFFF8LL) - 0x98000000000LL;
    if ( v29 )
    {
    ...
    if ( v29 )
    {
      v19 = ((unsigned __int64)sub_140317A10(v17) >> 12) & 0xFFFFFFFFFFLL;
...
LABEL_19:
    ...
    {
      if ( (v24 & 0xC00) != 0x800 || (a4 & 2) != 0 || (v25 = sub_140315D60(v5, 0LL, 0)) == 0 )
      {
        v9 = 1;
LABEL_43:
        v4 = a1;
    ...
    if ( !(unsigned int)sub_1405A5F5C(v25) )
      v11 = 1;
    if ( v30 )
...
LABEL_29:
    ...
    v4 = a1;
    v34 = v27;
    if ( (v5 & 0x78) == 0 && sub_1403531F0(a1) || KeShouldYieldProcessor() )
    {
      if ( v7 )
      {
        sub_14020D8D0(a1, v7);
