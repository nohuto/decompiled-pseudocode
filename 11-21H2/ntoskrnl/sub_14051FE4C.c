/*
 * XREFs of sub_14051FE4C @ 0x14051FE4C
 * Callers:
...
__int64 __fastcall sub_14051FE4C(int a1, __int64 a2, int a3, int *a4)
{
  __int64 v8; // rdx
  ...
  if ( !a2 || !*(_BYTE *)(v8 + 316) )
  {
    v12 = dword_140C4A418 - 1;
    v15 = dword_140C4A418 - 1;
    if ( dword_140C4A418 - 1 >= 0 )
    {
  ...
  v12 = v11 + dword_140C4A418;
  if ( *(_DWORD *)(*(_QWORD *)(v10 + 8LL * (v11 + dword_140C4A418)) + 24LL) != 3
