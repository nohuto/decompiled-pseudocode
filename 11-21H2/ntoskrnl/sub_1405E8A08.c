/*
 * XREFs of sub_1405E8A08 @ 0x1405E8A08
 * Callers:
...
__int64 __fastcall sub_1405E8A08(__int64 a1, __int64 a2, _QWORD *a3)
{
  __int64 v4; // rbp
...
LABEL_14:
          LOBYTE(v10) = 1;
          sub_1405F26CC(a1, (_DWORD)v14, v10, v7 + 16, v17, *(unsigned __int16 *)(v7 + 8));
        }
        *v9 = v11;
        *(_QWORD *)(v11 + 8) = v9;
        v18 = *(_BYTE *)(v7 + 10);
      ...
      {
        sub_1405F1BBC(13, a1, v10, v13, v12, 0LL);
      }
    }
  }
  v22 = v4 + 16LL * *a3;
  if ( *(_DWORD *)(a1 + 124) )
  {
    ...
    if ( HIBYTE(v23) != ((unsigned __int8)v23 ^ (unsigned __int8)(BYTE1(v23) ^ BYTE2(v23))) )
      sub_1405F1BBC(3, a1, v22, 0, 0LL, 0LL);
  }
...
LABEL_41:
        v36 = v31;
        LOBYTE(v31) = 1;
        sub_1405F26CC(a1, (_DWORD)v28, v31, v22 + 16, v36, *(unsigned __int16 *)(v22 + 8));
      }
      *v24 = v25;
      *(_QWORD *)(v25 + 8) = v24;
      v32 = *(_BYTE *)(v22 + 10);
    ...
    sub_1405F1BBC(13, a1, v22 + 16, v27, v26, 0LL);
  }
  return v4;
}
