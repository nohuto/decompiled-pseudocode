/*
 * XREFs of MiSynchronizeFastPageInsert @ 0x1402C0900
 * Callers:
...
LABEL_19:
  ...
  while ( v12 == -1LL || v15 )
  {
    v32 = *(_QWORD *)(StandbyLookaside + 8LL * v27);
    if ( v32 != -1LL )
    {
...
LABEL_34:
  ...
  *(_QWORD *)(v38 + 16) = v33;
  if ( !v95 )
  {
    ...
    {
      LOBYTE(StandbyLookaside) = -1;
      ExpAcquireSpinLockSharedAtDpcLevelInstrumented(a2 + 32, StandbyLookaside);
      v30 = v98;
      StandbyLookaside = v96;
      v34 = (_BYTE *)a5;
      v15 = v89;
      v5 = a4;
    }
    else
    {
      ...
      if ( SchedulerAssist )
      {
        ...
        {
          v87 = SchedulerAssist[6];
          SchedulerAssist[6] = v87 + 1;
          if ( v87 == -1 )
          {
      ...
      if ( v41 != _InterlockedCompareExchange((volatile signed __int32 *)(a2 + 32), v41 + 1, v41) )
      {
        ...
        LOBYTE(StandbyLookaside) = -1;
        ExpWaitForSpinLockSharedAndAcquire(a2 + 32, StandbyLookaside);
        v30 = v98;
        StandbyLookaside = v96;
        v34 = (_BYTE *)a5;
        v15 = v89;
...
LABEL_117:
  ...
  if ( *(_QWORD *)(StandbyLookaside + 8LL * v27) != v32 )
  {
    if ( *(_BYTE *)(v38 + 24) )
    {
      _InterlockedAnd64((volatile signed __int64 *)(v33 + 24), 0x7FFFFFFFFFFFFFFFuLL);
...
LABEL_45:
  ...
  *(_QWORD *)&v34[8 * v45 + 40] = v43;
  ...
  if ( !v15 && !v94 )
  {
    ...
    v12 = v91;
    LOBYTE(v27) = Number - 1;
    StandbyLookaside = MiGetStandbyLookaside(&v101, 2LL);
    v96 = StandbyLookaside;
    v46 = 64;
    v16 = 0;
    v90 = 64;
    v26 = -1;
...
LABEL_196:
          ...
          LODWORD(v113) = v65;
          if ( qword_140C50710 )
            v66 = MiPageToChannel(0xAAAAAAAAAAAAAAABuLL * ((__int64)(48 * v54) >> 4));
          else
            v66 = 0;
          v67 = 24512 * v64;
          v51 = v97;
...
LABEL_92:
        ...
        if ( v51 == 1 && (v94 || (unsigned int)MiIsDecayPfn(v74, a1, v50, v49)) )
          break;
      }
      ++v51;
