/*
 * XREFs of _CmSetInstallerClassRegPropWorker @ 0x140A255C0
 * Callers:
...
LABEL_31:
    ...
    if ( v21 )
    {
      if ( SecurityDescriptorLength )
      {
        v23 = RegRtlSetValue(v20, v21, a5, v12, SecurityDescriptorLength);
        if ( v23 == -1073741444 )
        {
          inited = -1073741772;
          goto LABEL_56;
      ...
      if ( a3 )
        v22 = a3;
      CmRaisePropertyChangeEvent(a1, a2, 2u, (__int64)v22, a4);
      goto LABEL_56;
    }
LABEL_55:
    inited = -1073741264;
