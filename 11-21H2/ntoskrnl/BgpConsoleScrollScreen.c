/*
 * XREFs of BgpConsoleScrollScreen @ 0x140AB10C0
 * Callers:
...
__int64 BgpConsoleScrollScreen()
{
  ...
  v1 = 0;
  v2 = 0LL;
  v3 = (_DWORD *)(qword_140CE1AD8 + 60);
  v4 = (_DWORD *)(qword_140CE1AD8 + 48);
  v25 = qword_140CE1AD8 + 60;
  v26 = qword_140CE1AD8 + 48;
  do
  {
    v5 = 0;
    if ( *(_DWORD *)(v0 + 4) != 1 )
...
LABEL_7:
      ...
      if ( v12 >= 0 )
      {
        *(_WORD *)(qword_140CE1AD8 + 12 * v7 + 88) = v9;
