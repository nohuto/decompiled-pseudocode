/*
 * XREFs of sub_140626DD0 @ 0x140626DD0
 * Callers:
 *     <none>
 * Callees:
...
NTSTATUS __fastcall sub_140626DD0(HANDLE FileHandle, PIO_STATUS_BLOCK IoStatusBlock, PVOID Buffer, ULONG Length)
{
  __int64 v8; // rdx
  __int64 v9; // rcx
  __int64 *v10; // rdi
