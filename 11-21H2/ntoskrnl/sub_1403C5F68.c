/*
 * XREFs of sub_1403C5F68 @ 0x1403C5F68
 * Callers:
...
__int64 __fastcall sub_1403C5F68(__int64 a1, __int16 a2)
{
  __int16 *v2; // rbp
  __int64 v5; // r8
  ULONG v7; // ebx
  ...
  *((_OWORD *)v2 + 1) = 0LL;
  ...
  if ( (int)sub_14083071C(v2 + 8, 0LL, v5, v2 + 4) >= 0 )
  {
    v7 = 0;
    do
    {
      ...
      if ( v8 >= 0 )
      {
        ...
        if ( v10 + 24 < 0x1FE )
        {
          *(_WORD *)(((unsigned __int64)v13 & 0xFFFFFFFFFFFFFFE0uLL) + 0x30 + 2 * (v10 >> 1)) = 0;
          if ( (int)sub_140A355F4(a1, v2 + 24, v9, (unsigned __int64)v13 & 0xFFFFFFFFFFFFFFE0uLL) >= 0 )
          {
            v11 = *v2;
