/*
 * XREFs of sub_1406C12F4 @ 0x1406C12F4
 * Callers:
...
__int64 *__fastcall sub_1406C12F4(__int64 a1, __int64 a2)
{
  __int64 **v3; // rdi
  __int64 *i; // rbx
  int v6; // eax
  ...
  for ( i = *v3; ; i = (__int64 *)*i )
  {
    ...
    if ( i[3] == *(_QWORD *)(a2 + 24) )
    {
      ...
      if ( *((_DWORD *)i + 13) == v6 )
      {
        ...
        *(_QWORD *)&v7 = i;
        *((_QWORD *)&v7 + 1) = a2;
        if ( (int)sub_1406C1068((_DWORD *)i + 12, (__int64)sub_1406C1010, (__int64)&v7) >= 0
          && (int)v9 >= 0
