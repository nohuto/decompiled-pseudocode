/*
 * XREFs of sub_14050DA84 @ 0x14050DA84
 * Callers:
...
char __fastcall sub_14050DA84(__int64 a1)
{
  __int16 v1; // r11
  int v2; // r11d
  int v3; // eax
  ...
  __writecr2(v4);
  v5 = __rdtsc();
  while ( *(_DWORD *)(a1 + 4) != *((_DWORD *)KeGetCurrentPrcb() + 9) )
    _mm_pause();
  if ( !*(_BYTE *)(a1 + 34) || *(_DWORD *)(a1 + 36) != *((_DWORD *)KeGetCurrentPrcb() + 9) )
  {
    if ( v5 < *(_QWORD *)(a1 + 16) )
      *(_QWORD *)(a1 + 16) = v5;
    if ( v5 > *(_QWORD *)(a1 + 24) )
