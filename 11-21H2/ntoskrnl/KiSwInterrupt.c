/*
 * XREFs of KiSwInterrupt @ 0x140427360
 * Callers:
 *     KiSwInterruptShadow @ 0x140AB5CC0 (KiSwInterruptShadow.c)
 * Callees:
...
/*
 * Hex-Rays decompilation failed for KiSwInterrupt @ 0x140427360
 ...
 * 000000014042761B: call    KiSaveDebugRegisterState
 ...
 * 0000000140427712: call    KiEndThreadAccountingPeriod
 * 0000000140427717: sti
 * 0000000140427718: lea     rcx, [rbp+0E8h+var_168]
 * 000000014042771C: call    KiSwInterruptDispatch
 ...
 * 0000000140427766: call    KiBeginThreadAccountingPeriod
 ...
 * 0000000140427792: call    KiDpcInterruptBypass
 * 0000000140427797: jmp     short loc_1404277B6
 * 0000000140427799: mov     ecx, 2
 * 000000014042779E: call    cs:__imp_HalRequestSoftwareInterrupt
 ...
 * 00000001404277BA: cmp     cs:KiIrqlFlags, 0
 * 00000001404277C1: jz      short loc_1404277CA
 * 00000001404277C3: call    KzSetIrqlUnsafe
 ...
 * 00000001404277E3: test    byte ptr cs:KeSmapEnabled, 0FFh
 ...
 * 000000014042780B: call    KiInitiateUserApc
 ...
 * 000000014042785B: call    KiCopyCounters
 ...
 * 0000000140427877: call    KiRestoreDebugRegisterState
 ...
 * 0000000140427AA6: test    cs:KiKvaShadow, 1
 * 0000000140427AAD: jz      short loc_140427AB4
 * 0000000140427AAF: jmp     KiKernelExit
