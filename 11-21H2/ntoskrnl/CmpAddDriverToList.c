/*
 * XREFs of CmpAddDriverToList @ 0x140B13B7C
 * Callers:
        ...
        char a7)
{
  ...
  *((_WORD *)v11 + 61) = v18;
  ...
  if ( ValueByName != -1 )
  {
    ...
    v23 = CmpValueToData(BugCheckParameter3, v21, CellFlat, (unsigned int *)&Size, &v55);
    if ( (*(_BYTE *)(BugCheckParameter3 + 140) & 1) != 0 )
        ...
        && RtlAppendUnicodeStringToString(&Destination, (PCUNICODE_STRING)(v11 + 120)) >= 0 )
      {
        ...
        *v29 = v11;
        ...
        else
        {
          ...
          if ( !v33 )
            goto LABEL_81;
          v34 = CmpValueToData(BugCheckParameter3, v32, v33, (unsigned int *)&Size, &v59);
          if ( (*(_BYTE *)(BugCheckParameter3 + 140) & 1) != 0 )
            HvpReleaseCellFlat(BugCheckParameter3, &v53);
          else
            HvpReleaseCellPaged(BugCheckParameter3, (unsigned int *)&v53);
        ...
        if ( v37 )
        {
          *((_QWORD *)v11 + 14) = CmpValueToData(BugCheckParameter3, v36, v37, (unsigned int *)&Size, &v60);
          if ( (*(_BYTE *)(BugCheckParameter3 + 140) & 1) != 0 )
            HvpReleaseCellFlat(BugCheckParameter3, &v53);
          else
            HvpReleaseCellPaged(BugCheckParameter3, (unsigned int *)&v53);
...
LABEL_50:
              ...
              if ( v47 )
              {
                *((_QWORD *)v11 + 12) = CmpValueToData(BugCheckParameter3, v41, v47, (unsigned int *)&Size, &v61);
                if ( (*(_BYTE *)(BugCheckParameter3 + 140) & 1) != 0 )
                  HvpReleaseCellFlat(BugCheckParameter3, &v53);
                else
                  HvpReleaseCellPaged(BugCheckParameter3, (unsigned int *)&v53);
