/*
 * XREFs of sub_14067AFB0 @ 0x14067AFB0
 * Callers:
...
__int64 __fastcall sub_14067AFB0(HANDLE Handle, PUNICODE_STRING DestinationString)
{
  ...
  *(_QWORD *)&v15.Length = 2621478LL;
  ...
  appended = sub_14070FD80(Handle, (__int64)&v18);
  if ( appended >= 0 )
  {
    v6 = stru_140D3CD28.Length + 2;
    if ( Pool2->Length < (unsigned __int16)(stru_140D3CD28.Length + 2)
      || !RtlPrefixUnicodeString(&stru_140D3CD28, Pool2, 1u)
