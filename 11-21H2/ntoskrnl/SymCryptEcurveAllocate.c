/*
 * XREFs of SymCryptEcurveAllocate @ 0x1403FF93C
 * Callers:
...
__int64 __fastcall SymCryptEcurveAllocate(_DWORD *a1)
{
  ...
  if ( v2 <= 0x80 && a1[4] <= 0x81u && a1[5] <= 2u && a1[6] <= 0x100u )
  {
    ...
    v62 = v5;
    v66 = SymCryptDigitsFromBits((unsigned int)(8 * a1[5]));
    v72 = SymCryptSizeofModulusFromDigits(v4);
    v63 = SymCryptSizeofModulusFromDigits(v5);
    v64 = SymCryptSizeofIntFromDigits(v66, v6);
    ...
    if ( v3 )
    {
      ...
      *(_DWORD *)(v3 + 36) = v7;
      *(_DWORD *)(v3 + 40) = v65;
      v21 = SymCryptModulusCreate(v3 + 672, v72, v4);
      *(_QWORD *)(v3 + 616) = v21;
      if ( !v21 )
        goto LABEL_71;
      ...
      *(_DWORD *)(v3 + 12) = v24;
      ...
      if ( (SymCryptIntGetValueLsbits32(v23) & 1) == 0 )
        goto LABEL_71;
      SymCryptIntToModulus(v23, *(_QWORD *)(v3 + 616), 800 * a1[3], 9, v20, v68);
      v25 = v72 + v3 + 672;
      ...
      *(_QWORD *)(v3 + 632) = v27;
      if ( !v27 )
        goto LABEL_71;
      if ( (unsigned int)SymCryptModElementSetValue(v26, a1[3], 2, *(_QWORD *)(v3 + 616), v27, v20, v68) )
        goto LABEL_71;
      ...
      *(_QWORD *)(v3 + 640) = v30;
      if ( !v30 )
        goto LABEL_71;
      if ( (unsigned int)SymCryptModElementSetValue(v29, a1[3], 2, *(_QWORD *)(v3 + 616), v30, v20, v68) )
        goto LABEL_71;
      v31 = (unsigned int)a1[3];
      v32 = (unsigned int)v7 + v28;
      v73 = v31 + v29;
      v33 = (unsigned int)(2 * v31) + v31 + v29;
      v34 = SymCryptModulusCreate(v32, v63, v62);
      *(_QWORD *)(v3 + 624) = v34;
      if ( !v34 )
        goto LABEL_71;
      ...
      *(_DWORD *)(v3 + 24) = v37;
      ...
      if ( (SymCryptIntGetValueLsbits32(v36) & 1) == 0 )
        goto LABEL_71;
      SymCryptIntToModulus(v36, *(_QWORD *)(v3 + 624), 1, 9, v20, v68);
      v38 = v63 + v32;
      v39 = (unsigned int)a1[4] + v33;
      v40 = SymCryptIntCreate(v38, v64, v66);
      *(_QWORD *)(v3 + 656) = v40;
      if ( !v40 )
        goto LABEL_71;
      ...
      *(_DWORD *)(v3 + 64) = v41;
      ...
      v48 = SymCryptEcpointCreate(v42, v67, v3);
      *(_QWORD *)(v3 + 648) = v48;
      if ( !v48 )
        goto LABEL_71;
      LODWORD(v61) = 2;
      if ( (unsigned int)SymCryptEcpointSetValue(v3, v73, 2 * a1[3], 2, v61, v48, 1, v20, v68) )
        goto LABEL_71;
      v49 = a1[1];
      v50 = v67 + v42;
      if ( v49 == 1 || v49 == 2 )
      {
        *(_QWORD *)(v3 + 104) = *(_QWORD *)(v3 + 648);
        if ( *(_DWORD *)(v3 + 92) > 1u )
        {
          while ( 1 )
          {
            v51 = SymCryptEcpointCreate(v50, v67, v3);
...
LABEL_56:
        SymCryptOfflinePrecomputation(v3, v20, v68);
        v49 = a1[1];
      }
      if ( v49 == 3 )
      {
        v52 = SymCryptModElementCreate(v20, (unsigned int)v7, *(_QWORD *)(v3 + 616));
        v53 = v71 - (unsigned int)v7;
        v54 = v20 + v7;
        v55 = v52;
        SymCryptModElementSetValueUint32(2, *(_QWORD *)(v3 + 616), v52, v54, v53);
        SymCryptModAdd(*(_QWORD *)(v3 + 616), *(_QWORD *)(v3 + 632), v55, *(_QWORD *)(v3 + 632), v54, v53);
        SymCryptModDivPow2(*(_QWORD *)(v3 + 616), *(_QWORD *)(v3 + 632), 2, *(_QWORD *)(v3 + 632), v54, v53);
      }
      if ( *a1 == 2 )
      {
      ...
      else
      {
        ...
        if ( v57 == 1 )
        {
          v56 = (__int64 *)SymCryptEcurveParamsV2ExtensionShortWeierstrass;
        }
        else if ( v57 == 2 )
        {
          v56 = (__int64 *)SymCryptEcurveParamsV2ExtensionTwistedEdwards[0];
        }
        else
        {
          v56 = 0LL;
          if ( v57 == 3 )
            v56 = (__int64 *)SymCryptEcurveParamsV2ExtensionMontgomery;
        }
      }
