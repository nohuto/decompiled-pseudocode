/*
 * XREFs of sub_140850E08 @ 0x140850E08
 * Callers:
...
char __fastcall sub_140850E08(__int64 a1, __int64 a2, char *a3, _DWORD *a4)
{
  void *v8; // rax
  void *v9; // rdi
  __int64 v10; // rax
  ...
  v8 = sub_14036B86C(*(_QWORD *)(a1 + 48), 0x6D546F50u);
  v9 = v8;
  if ( v8 && (v10 = *(_QWORD *)(*((_QWORD *)v8 + 39) + 40LL)) != 0 )
  ...
  *(_DWORD *)(a1 + 220) = i;
  ...
  else
  {
    ...
    if ( *(_DWORD *)(a1 + 80) != 100 || (v21 = *(_DWORD *)(a1 + 132)) != 0 && v20 >= v21 )
    {
      ...
      v25 = *(_DWORD *)(a1 + 76);
      v26 = *(_DWORD *)(a1 + 120) * (v20 - *(_DWORD *)(a1 + 132)) + (v20 - v24) * *(_DWORD *)(a1 + 116);
      if ( v20 == v24 || (((v20 - v24) ^ v26) & 0x80000000) == 0 )
        v25 -= v26;
      if ( v25 > 1000 )
        v25 = 1000;
      v27 = *(_DWORD *)(a1 + 192);
