/*
 * XREFs of sub_1409D91B0 @ 0x1409D91B0
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall sub_1409D91B0(struct _KPROCESS *Process, __int64 a2, void *a3, int a4, PVOID a5, _QWORD *a6)
{
  char v9; // r9
  NTSTATUS v10; // edi
  int v11; // edx
  ...
  else
  {
    ...
    if ( (a4 & 0x10) == 0 )
      v13 = v12;
    v14 = sub_140831810(Process, a2, 0LL, v9, a3, v13, (a4 & 0x20 | 0x40u) >> 3, 0LL, a5, &ProcessHandle);
    v15 = ProcessHandle;
    v10 = v14;
    if ( v14 >= 0 )
    {
