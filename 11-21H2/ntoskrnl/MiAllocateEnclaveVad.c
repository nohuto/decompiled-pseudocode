/*
 * XREFs of MiAllocateEnclaveVad @ 0x140978F40
 * Callers:
...
__int64 __fastcall MiAllocateEnclaveVad(int a1, unsigned __int64 a2, unsigned __int64 a3, __int64 a4, __int64 *a5)
{
  ...
  {
    Pool[16] |= 1u;
    v17 = MiReservePtes((__int64)&qword_140C534C0, 1u);
    *(_QWORD *)(v15 + 80) = v17;
    if ( !v17
      || a1 == 2
      && (*(_DWORD *)(v15 + 72) |= 1u,
...
LABEL_25:
      if ( (*(_DWORD *)(v15 + 64) & 1) != 0 )
      {
        ...
        v22 = *(_QWORD **)(v15 + 80);
        if ( v22 )
          MiReleasePtes((__int64)&qword_140C534C0, v22, 1u);
      }
...
LABEL_24:
  ...
  {
    v24 = (v5 + a2 - 1) | 0xFFF;
    if ( !MiIsVaRangeAvailable(Process, v5, v24 - v5 + 1, 0LL, UserReservationHighestAddress) )
    {
      inserted = -1073741800;
      goto LABEL_24;
    }
