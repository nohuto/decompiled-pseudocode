/*
 * XREFs of sub_1409870AC @ 0x1409870AC
 * Callers:
...
__int64 __fastcall sub_1409870AC(__int64 *a1, char a2)
{
  __int64 v2; // rdi
  signed int v3; // r14d
  unsigned int v4; // esi
          ...
          if ( (*(_DWORD *)(v17 + 40 * v16 + 12) & 0xFFFFFFFE) != 0 )
          {
            do
            {
              ...
              if ( (*v19 & 0xA) == 0 && v19[4] && (!v5 || (*v19 & 1) != 0) )
              {
                ...
                sub_140360E0C(v20);
                if ( (int)sub_1407DEE78(a1, v19, v16, a2, v20) < 0 )
                {
                  sub_1407E08A0(a1[5], v20);
                  sub_140360E0C(v20);
                }
                else
                {
