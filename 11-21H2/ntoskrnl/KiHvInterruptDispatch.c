/*
 * XREFs of KiHvInterruptDispatch @ 0x140426820
 * Callers:
...
/*
 * Hex-Rays decompilation failed for KiHvInterruptDispatch @ 0x140426820
 ...
 * 000000014042683D: cmp     cs:KiBugCheckActive, 0
 ...
 * 0000000140426852: call    KiHvInterruptSubDispatch
 * 0000000140426857: mov     rsp, [rsp+20h+var_10]
 * 000000014042685C: test    cs:HvlEnlightenments, 1000h
 ...
 * 00000001404268AD: call    KiBeginThreadAccountingPeriod
 ...
 * 00000001404268D9: call    KiDpcInterruptBypass
 * 00000001404268DE: jmp     short loc_1404268FD
 * 00000001404268E0: mov     ecx, 2
 * 00000001404268E5: call    cs:__imp_HalRequestSoftwareInterrupt
 ...
 * 0000000140426901: cmp     cs:KiIrqlFlags, 0
 * 0000000140426908: jz      short loc_140426911
 * 000000014042690A: call    KzSetIrqlUnsafe
 ...
 * 000000014042692A: test    byte ptr cs:KeSmapEnabled, 0FFh
 ...
 * 0000000140426952: call    KiInitiateUserApc
 ...
 * 00000001404269A2: call    KiCopyCounters
 ...
 * 00000001404269BE: call    KiRestoreDebugRegisterState
 ...
 * 0000000140426BED: test    cs:KiKvaShadow, 1
 * 0000000140426BF4: jz      short loc_140426BFB
 * 0000000140426BF6: jmp     KiKernelExit
