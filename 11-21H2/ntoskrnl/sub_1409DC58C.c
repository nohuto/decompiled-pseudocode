/*
 * XREFs of sub_1409DC58C @ 0x1409DC58C
 * Callers:
...
__int64 __fastcall sub_1409DC58C(__int64 a1, unsigned int *a2)
{
  __int64 result; // rax
  __int64 v5; // r8
  int v6; // r11d
  ...
  result = sub_1409DC350(15, &v18, &BaseAddress, &NumberOfBytes);
  if ( (int)result < 0 )
    return result;
  v5 = v18;
  ...
  else
  {
    ...
    {
      if ( BaseAddress )
        MmUnmapVideoDisplay(BaseAddress, (unsigned int)NumberOfBytes);
