/*
 * XREFs of sub_1405F4040 @ 0x1405F4040
 * Callers:
...
unsigned __int64 __fastcall sub_1405F4040(__int64 a1, int a2, __int64 a3, _DWORD *a4)
{
    ...
    if ( (_WORD)result )
    {
      ...
      do
      {
        ...
        if ( (v10 & 8) == 0 && (*(_BYTE *)v8 == 2 || *(_BYTE *)v8 == 13) )
        {
          v11 = a2 & *(_DWORD *)(v8 + 4);
          if ( ((v10 >> 6) & (v11 != 0)) != 0
            && sub_1402FD65C((PSID_AND_ATTRIBUTES_HASH)(a3 + 232), 0LL, (void *)(v8 + 8), 1, 0, 0) )
          {
            *a4 |= v11;
          }
        }
