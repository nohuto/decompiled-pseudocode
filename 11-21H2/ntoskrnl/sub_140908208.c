/*
 * XREFs of sub_140908208 @ 0x140908208
 * Callers:
...
__int64 __fastcall sub_140908208(PVOID InputBuffer)
{
  ...
  if ( v2 )
  {
    ...
    v4 = IoBuildDeviceIoControlRequest(0x298214u, v2, InputBuffer, 0x10u, 0LL, 0, 0, &Event, &IoStatusBlock);
    if ( v4 )
    {
