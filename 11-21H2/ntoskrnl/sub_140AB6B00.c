/*
 * XREFs of sub_140AB6B00 @ 0x140AB6B00
 * Callers:
 *     sub_140AB62C0 @ 0x140AB62C0 (sub_140AB62C0.c)
 * Callees:
 *     <none>
 */

// positive sp value has been detected, the output may be wrong!
__int64 __fastcall sub_140AB6B00(int a1, int a2, int a3, int a4, __int16 a5)
{
  ...
  if ( (v11 & 1) != 0 )
  {
    ...
    return sub_140423360(a1, a2, a3, a4, a5);
  }
  else
  {
    _mm_lfence();
