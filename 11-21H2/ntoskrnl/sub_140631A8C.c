/*
 * XREFs of sub_140631A8C @ 0x140631A8C
 * Callers:
...
void __fastcall sub_140631A8C(__int64 a1, unsigned int a2, __int64 a3, _QWORD *a4)
{
  int v6; // ecx
  int v7; // r13d
  PSLIST_ENTRY v8; // rdi
  ...
  v32 = 0LL;
  v31 = 0LL;
  if ( (unsigned __int8)sub_140294D90((__int64)&v26, (__int64)&v27, (__int64)&v28) )
  {
    if ( v26 > 9 || (v6 = 929, !_bittest(&v6, v26)) )
    {
      ...
      if ( !v8 )
      {
        if ( (unsigned __int64)&sub_14041FAB0()[-v27] <= 0x1438 )
          return;
        v10 = alloca(1536LL);
        v8 = (PSLIST_ENTRY)&v25;
        v7 = 192;
      ...
      {
        v11 = 1;
        v8->Next = (_SLIST_ENTRY *)qword_140D068F0;
        a2 &= ~0x800u;
      }
      if ( (a2 & 0x800) != 0 )
      {
        ...
        if ( (a2 & 0x2000000) == 0 )
          v14 = ((a2 >> 20) & 0xF) << 8;
        v15 = RtlWalkFrameChain((PVOID *)&v8->Next, v13 + v7, v14);
        if ( v15 > v13 )
          v11 = v15 - v13;
        else
          v11 = 0;
      ...
      {
        v16 = v7 - v11;
        v17 = (PVOID *)(&v8->Next + v11);
        if ( *(_QWORD *)(*((_QWORD *)KeGetCurrentThread() + 23) + 2240LL) )
        {
          v12 = sub_1409B205C(v17, v16);
        }
        else
        {
          v18 = HIWORD(a2) & 0xF;
        ...
        *(_QWORD *)&v31 = *v30;
        ...
        if ( v22
          ...
          || (LOWORD(v9) = 6182 - (v11 != 0),
              !(unsigned __int8)sub_1406342C8(a1, v21, v9, (unsigned int)v33, (__int64)v8, v20)) )
        {
          v23 = *(_DWORD *)a1;
          v24 = *(_QWORD *)(a1 + 1096);
          v34 = 8 * v20;
          v33[2] = v8;
          v35 = 0;
          sub_1402AB170((__int64)v33, v24, v23, 2u, 0x1820u, v21);
        }
      }
      if ( v7 == 256 )
        ExpInterlockedPushEntrySList(&stru_140C5A6B0, v8 - 1);
    }
  }
}
