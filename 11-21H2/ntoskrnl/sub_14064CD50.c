/*
 * XREFs of sub_14064CD50 @ 0x14064CD50
 * Callers:
 ...
 *     sub_1407F4E30 @ 0x1407F4E30 (sub_1407F4E30.c)
 *     sub_1408138F0 @ 0x1408138F0 (sub_1408138F0.c)
 *     ExFreePoolWithTag @ 0x140A6E010 (ExFreePoolWithTag.c)
 *     ExAllocatePoolWithTag @ 0x140A6E910 (ExAllocatePoolWithTag.c)
 */

void __fastcall sub_14064CD50(__int64 a1, __int64 a2, __int64 a3)
{
  unsigned int *v3; // rsi
  _QWORD *v4; // rdi
  __int64 v5; // rcx
  ...
  *(&ObjectAttributes.Attributes + 1) = 0;
  ...
  ProcessHandle = 0LL;
  FileHandle = 0LL;
  if ( (unsigned __int8)sub_1407F4E30(a1, a2, a3, a1) )
  {
    sub_1408138F0(2LL, L"Attempting to determine owner of file %ws.", *(_QWORD *)(v5 + 8));
    ...
    if ( v7 >= 0 )
    {
      ...
      if ( PoolWithTag )
      {
        ...
        if ( v9 >= 0 )
        {
          if ( *v3 )
          {
            sub_1408138F0(2LL, L"Found %d processes using this file.");
            v10 = 0;
            if ( !*v3 )
            {
LABEL_34:
...
LABEL_35:
            ...
            while ( 1 )
            {
              ...
              *(_OWORD *)&v17.SecurityDescriptor = 0LL;
              ...
              {
                sub_1408138F0(4LL, L"Failed to query process information for size. Status: %x", v12);
                goto LABEL_28;
              }
              v4 = ExAllocatePoolWithTag(PagedPool, Length, 0x4B444342u);
              if ( !v4 )
              {
                sub_1408138F0(4LL, L"Failed to allocate memory for space for process name.");
                goto LABEL_29;
              }
              v13 = ZwQueryInformationProcess(ProcessHandle, ProcessImageFileName, v4, Length, &Length);
              if ( v13 < 0 )
              {
                sub_1408138F0(4LL, L"Failed to query process info. Status: %x", (unsigned int)v13);
                goto LABEL_29;
              }
              if ( *(_WORD *)v4 )
                ...
                v14 = L"System";
              sub_1408138F0(4LL, L"Process Name [%d]: %ws", v10, v14);
            ...
            sub_1408138F0(4LL, L"Failed to open process. Status: %x", (unsigned int)v11);
LABEL_28:
            v4 = 0LL;
          }
          else
          {
            sub_1408138F0(4LL, L"No processes are using this file.");
          }
        }
        else
        {
          sub_1408138F0(4LL, L"Failed to query processes. Status: %x", (unsigned int)v9);
        }
      }
      else
      {
        sub_1408138F0(4LL, L"Failed to allocate process ID buffer.");
      }
    }
    else
    {
      sub_1408138F0(4LL, L"Failed to open file attributes. Status: %x", (unsigned int)v7);
    }
LABEL_29:
    if ( ProcessHandle )
      ZwClose(ProcessHandle);
