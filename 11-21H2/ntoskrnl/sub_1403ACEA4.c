/*
 * XREFs of sub_1403ACEA4 @ 0x1403ACEA4
 * Callers:
...
char sub_1403ACEA4(int a1, int a2, ...)
{
  _UNKNOWN **v2; // rax
  REGHANDLE v3; // rbx
  ...
  {
    v3 = qword_140C4C680;
    LOBYTE(v2) = EtwEventEnabled(qword_140C4C680, &stru_1400390A0);
    if ( (_BYTE)v2 )
    {
      UserData.Reserved = 0;
      v8 = 0;
      ...
      v13 = 8;
      v16 = 4;
      LOBYTE(v2) = EtwWriteEx(v3, &stru_1400390A0, 0LL, 0, 0LL, 0LL, 5u, &UserData);
    }
  }
  return (char)v2;
}
