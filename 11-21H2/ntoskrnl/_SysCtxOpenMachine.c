/*
 * XREFs of _SysCtxOpenMachine @ 0x140827BDC
 * Callers:
        ...
        _QWORD *a7)
{
  ...
  *(_DWORD *)Pool2 = v12;
  ...
  if ( a2 != -1 )
  {
    ...
    v14 = a2;
LABEL_6:
    Version = RegRtlOpenKeyTransacted((char *)v14, v13, 0, 0x2000000u, &Handle, (__int64)TargetHandle);
    if ( Version )
      goto LABEL_25;
  }
  if ( !Handle || (Version = SysCtxOpenControlSet(v10, Handle, TargetHandle, &v21)) == 0 )
  {
    if ( a4 )
    {
      if ( a4 == -1 )
    ...
    Version = RegRtlOpenKeyTransacted((char *)v15, 0LL, 0, 0x2000000u, &v20, (__int64)TargetHandle);
    if ( !Version )
    {
LABEL_12:
      Pool2[16] = 1;
