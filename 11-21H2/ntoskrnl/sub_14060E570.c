/*
 * XREFs of sub_14060E570 @ 0x14060E570
 * Callers:
 *     <none>
 * Callees:
...
NTSTATUS __fastcall sub_14060E570(PUNICODE_STRING SymbolicLinkName, PUNICODE_STRING DeviceName)
{
  __int64 v4; // rdx
  __int64 v5; // rcx
  __int64 *v6; // rdi
...
LABEL_18:
  result = IoCreateUnprotectedSymbolicLink(SymbolicLinkName, DeviceName);
  DWORD2(v17) = result;
  if ( v6 )
  {
    v14 = (_QWORD **)(v6 + 6);
