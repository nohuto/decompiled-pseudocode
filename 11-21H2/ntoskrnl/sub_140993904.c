/*
 * XREFs of sub_140993904 @ 0x140993904
 * Callers:
...
void __fastcall sub_140993904(__int64 a1, __int64 a2)
{
  REGHANDLE v4; // rbx
  void *v5; // rax
  void *v6; // rbx
      ...
      if ( v5 )
      {
        ...
        if ( v7 )
        {
          sub_14099351C(
            ...
            *(_QWORD *)(v7 + 136),
            *(_DWORD *)(a1 + 76) / 0xAu,
            (const EVENT_DESCRIPTOR *)qword_140039298);
          sub_14099351C(
            *(_WORD *)(v7 + 128) >> 1,
            *(_QWORD *)(v7 + 136),
            *(_DWORD *)(a1 + 76) / 0xAu,
            (const EVENT_DESCRIPTOR *)qword_1400390C0);
        }
