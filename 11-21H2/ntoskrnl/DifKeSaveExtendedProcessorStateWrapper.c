/*
 * XREFs of DifKeSaveExtendedProcessorStateWrapper @ 0x140615570
 * Callers:
 *     <none>
 * Callees:
...
NTSTATUS __fastcall DifKeSaveExtendedProcessorStateWrapper(ULONG64 Mask, PXSTATE_SAVE XStateSave)
{
  __int64 v4; // rdx
  __int64 v5; // rcx
...
LABEL_18:
  result = KeSaveExtendedProcessorState(Mask, XStateSave);
  DWORD2(v16) = result;
  if ( APIThunkContextById )
  {
