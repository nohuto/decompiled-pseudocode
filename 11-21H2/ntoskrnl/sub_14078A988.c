/*
 * XREFs of sub_14078A988 @ 0x14078A988
 * Callers:
...
__int64 __fastcall sub_14078A988(_WORD *Src, __int64 a2, __int64 a3, __int64 a4)
{
  _WORD *v5; // rsi
  __int64 v6; // rbx
  __int64 v7; // rax
  ...
  if ( *Src )
  {
    ...
    if ( Pool2 )
    {
      ...
      *((_QWORD *)&v20 + 1) = v10;
      LOWORD(v20) = 2 * v8;
      WORD1(v20) = 2 * v8;
      sub_1406C94F8((__int64)&v20, (__int16 *)&v20);
      v11 = v10;
      for ( i = -1073741772; *v11; v11 += v17 + 1 )
      {
        ...
        if ( v13 < 0 )
          v14 = 0;
        HashValue = v14;
        v15 = (const UNICODE_STRING **)(qword_140C54E88 + 16LL * (v14 % dword_140C54E90));
        for ( j = *v15; j != (const UNICODE_STRING *)v15; j = *(const UNICODE_STRING **)&j->Length )
        {
          if ( RtlEqualUnicodeString(&DestinationString, j + 1, 1u) )
          {
            ...
            *(_OWORD *)&ObjectAttributes.SecurityDescriptor = 0LL;
            ...
            if ( i >= 0 )
            {
              if ( (unsigned __int8)sub_14093FE38(KeyHandle, a3) )
              {
                ZwClose(KeyHandle);
                goto LABEL_15;
              }
