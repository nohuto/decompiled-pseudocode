/*
 * XREFs of sub_140A2FC40 @ 0x140A2FC40
 * Callers:
...
__int64 __fastcall sub_140A2FC40(__int64 *a1, __int64 a2, HANDLE a3, __int64 a4, int a5, int *a6, ULONG a7)
{
  int v8; // ebx
  __int64 v11; // rax
  int v12; // ebx
  ...
  if ( !a3 )
  {
    v12 = sub_140789AA4(a1, a2, 2, 0, (__int64)&Handle, 0LL);
    if ( v12 < 0 )
      goto LABEL_22;
    a3 = Handle;
  }
