/*
 * XREFs of sub_1407FF0A8 @ 0x1407FF0A8
 * Callers:
        ...
        ...)
{
  ...
  v96 = a1;
  v23 = a12 != 0;
  ProcessImageFileName = PsGetProcessImageFileName(*((_QWORD *)KeGetCurrentThread() + 23));
  ...
  {
    v16 = RegHandle;
    LOBYTE(ProcessImageFileName) = EtwEventEnabled(RegHandle, &stru_14000F108);
    if ( (_BYTE)ProcessImageFileName )
    {
      *(_QWORD *)&UserData.Size = 4LL;
      ...
      v64 = v15;
      v65 = 0;
      LOBYTE(ProcessImageFileName) = EtwWrite(v16, &stru_14000F108, 0LL, 0xEu, &UserData);
      v15 = v22;
    }
  }
  if ( dword_140C03A00 )
  {
    LOBYTE(ProcessImageFileName) = sub_1402A2000((__int64)&dword_140C03A00, 0x800000000000LL);
    if ( (_BYTE)ProcessImageFileName )
    {
      if ( v18 > 5 )
      {
        LOBYTE(ProcessImageFileName) = sub_1402A2000(v19, v17);
        if ( (_BYTE)ProcessImageFileName )
        {
          v24 = v96;
          v68 = 4LL;
          ...
          LODWORD(v36) = v15;
          v92 = 4LL;
          sub_1403699D0((__int64)v93, v13);
          v37 = 0x1000000LL;
          v94 = &v37;
          v95 = 8LL;
          LOBYTE(ProcessImageFileName) = sub_14020A9C4(v20, (unsigned __int8 *)word_14002EF72, 0LL, 0LL, 0x11u, &v66);
        }
      }
    }
  }
