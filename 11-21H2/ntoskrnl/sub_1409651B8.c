/*
 * XREFs of sub_1409651B8 @ 0x1409651B8
 * Callers:
...
__int64 __fastcall sub_1409651B8(_WORD *a1, _WORD *a2, HANDLE *a3)
{
  __int64 v6; // rax
  __int64 v7; // rax
  __int64 v8; // rax
  ...
  *(_OWORD *)&ObjectAttributes.SecurityDescriptor = 0LL;
  ...
  if ( v9 >= 0 )
  {
    v9 = sub_14075C924((__int64)v12, a2);
    if ( v9 >= 0 )
    {
