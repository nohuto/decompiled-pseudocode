/*
 * XREFs of CmpDoWritethroughReparse @ 0x140680100
 * Callers:
 ...
 *     CmpUnicodeStringAppendCharacter @ 0x140657950 (CmpUnicodeStringAppendCharacter.c)
        ...
        UNICODE_STRING *a7)
{
  ...
  *(_OWORD *)Privileges = 0LL;
  ...
  KcbAtLayerHeight = CmpGetKcbAtLayerHeight(a3, (unsigned __int16)(*(_WORD *)(a1 + 66) - 1));
...
LABEL_12:
    v18 = CmpGetKcbAtLayerHeight(a2, (unsigned __int16)(*(_WORD *)(a1 + 66) - 1));
