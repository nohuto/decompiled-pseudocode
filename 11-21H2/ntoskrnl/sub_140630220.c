/*
 * XREFs of sub_140630220 @ 0x140630220
 * Callers:
...
void __fastcall sub_140630220(__int64 a1, int a2, __int64 a3, int a4, unsigned __int16 *a5)
{
  int v6; // edx
  unsigned int v7; // ebx
  __int64 v8; // r8
  ...
  while ( _BitScanForward(&v12, v7) )
  {
    v7 &= v7 - 1;
    v8 = v12;
    v9 = 32LL * v12 + qword_140D05008 + 4284;
    if ( v9 )
    {
      if ( (*(_DWORD *)(v9 + 8) & 0x400000) != 0 )
      {
        v10 = *(unsigned __int8 *)(qword_140D05008 + 2 * v8 + 4233);
        v19 = 0;
        v18 = 8;
        v17 = a1 + 8 * (v10 - 1);
        sub_1402AB170(
          (__int64)&v17,
          qword_140D05008,
          *(unsigned __int8 *)(qword_140D05008 + 2 * v8 + 4232),
          3u,
          0xF70u,
          0x401A02u);
      }
