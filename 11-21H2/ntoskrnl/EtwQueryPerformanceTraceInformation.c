/*
 * XREFs of EtwQueryPerformanceTraceInformation @ 0x14081C05C
 * Callers:
...
__int64 __fastcall EtwQueryPerformanceTraceInformation(__int64 a1, unsigned int a2, __int64 a3, unsigned int *a4)
{
  ...
  ULONG v46; // r14d
  _DWORD *i; // r12
  ULONG SecurityInformation[2]; // [rsp+30h] [rbp-58h] BYREF
...
LABEL_17:
            ...
            EtwpReleaseLoggerContext((unsigned int *)v16, 1);
            KiLeaveCriticalRegionUnsafe((__int64)KeGetCurrentThread());
            return 3221225485LL;
          }
LABEL_83:
      ...
      case 4:
        *v12 = 24;
        if ( a2 >= 0x18 )
        {
          ...
          if ( v24 )
          {
            v26 = (void *)EtwpReferenceLoggerSecurityDescriptor(v24);
  ...
  if ( v51 == 6 )
  {
    ...
    if ( a2 >= 0x10 )
    {
      ...
      v42 = EtwpAcquireLoggerContextByLoggerId(v13, v40, 1);
      v43 = (RTL_BITMAP *)v42;
      v53 = v42;
      if ( v42 )
      {
        v8 = EtwpCheckLoggerControlAccess(1u, v42);
        if ( (v8 & 0x80000000) == 0 )
        {
  ...
  if ( v51 <= 9 )
  {
    ...
    if ( !PsIsCurrentThreadInServerSilo() )
    {
      ...
      for ( j = 0LL; ; j = v37 )
      {
        ...
        v37 = (struct _KPROCESS *)NextProcess;
        Object = NextProcess;
        if ( !NextProcess )
          break;
  ...
  if ( v51 == 10 )
  {
    ...
    if ( !PsIsCurrentThreadInServerSilo() )
    {
      ...
      v30 = (unsigned int *)EtwpAcquireLoggerContextByLoggerId(v13, v28, 1);
      v17 = v30;
      ...
      if ( v30 )
      {
        ...
        v8 = EtwpCheckSystemTraceAccess(v30, 1LL);
        if ( (v8 & 0x80000000) == 0 )
        {
          v31 = 5LL * *((unsigned __int8 *)v17 + 818);
          v32 = 4 * (unsigned __int16)EtwpPoolTagFilter[10 * *((unsigned __int8 *)v17 + 818)] + 16;
          *a4 = v32;
          if ( v32 > a2 )
            v8 = -1073741789;
          else
            memmove(
              (void *)(a1 + 16),
              &EtwpPoolTagFilter[2 * v31 + 2],
              4LL * (unsigned __int16)EtwpPoolTagFilter[2 * v31]);
        }
        goto LABEL_14;
      }
      goto LABEL_83;
  ...
  *(_QWORD *)SecurityInformation = 0LL;
  ...
  if ( a2 < 0x28 )
    return 3221225476LL;
  v27 = a2 - 8;
  result = ExLockUserBuffer(a1 + 8, v27, v11, IoWriteAccess, &Object, (struct _MDL **)SecurityInformation);
  if ( (int)result >= 0 )
  {
    v8 = ((__int64 (__fastcall *)(__int64, _QWORD, PVOID, unsigned int *))off_140C020D8[0])(20LL, v27, Object, a4);
    if ( Object )
      ExUnlockUserBuffer(*(struct _MDL **)SecurityInformation);
    return v8;
  }
  return result;
}
