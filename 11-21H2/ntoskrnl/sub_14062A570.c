/*
 * XREFs of sub_14062A570 @ 0x14062A570
 * Callers:
...
void __fastcall sub_14062A570(__int64 a1, __int64 a2, __int64 a3, __int64 a4, int a5, int a6, int a7, int a8)
{
  __int64 v9; // r8
  __int64 v10; // r9
  __int64 v11; // r10
  ...
  {
    if ( sub_1402A2000(qword_140C18EA0, 16LL) )
    {
      ...
      v37 = 4LL;
      v39 = 4LL;
      sub_14024A9B0(v11, (unsigned __int8 *)&byte_1400347D3, v9, 0, v13, v14, 0xAu, &v23);
    }
  }
}
