/*
 * XREFs of DrvDbGetDriverPackageMappedPropertyKeys @ 0x140A2EAB8
 * Callers:
        ...
        unsigned int *a6)
{
  ...
  *v6 = 0;
  ...
  if ( CompositeMappedPropertyKeys >= 0 )
  {
    ...
    if ( a3
      || (CompositeMappedPropertyKeys = DrvDbOpenDriverPackageRegKey(a1, (__int64)a2, 1, 0, (__int64)Handle, 0LL),
