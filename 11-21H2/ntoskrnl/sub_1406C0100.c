/*
 * XREFs of sub_1406C0100 @ 0x1406C0100
 * Callers:
 *     <none>
 * Callees:
...
bool __fastcall sub_1406C0100(__int64 a1, int *a2, __int64 a3, char a4)
{
  int v5; // ebx
  ...
  v10[2] = a3;
  v11 = a4;
  v7 = (POBJECT_TYPE *)qword_140D07490[(unsigned __int8)dword_140D06C0C ^ v6];
  ...
  if ( v7 == (POBJECT_TYPE *)ExWindowStationObjectType )
  {
    v8 = 12LL;
LABEL_9:
    v5 = sub_1406F83A0(v8, v10, 1LL, &v15);
  }
  return v5 >= 0;
}
