/*
 * XREFs of sub_140674264 @ 0x140674264
 * Callers:
...
__int64 __fastcall sub_140674264(__int64 a1, __int64 a2, __int64 a3, __int64 a4)
{
...
LABEL_5:
    while ( 1 )
    {
      ...
      if ( v11 == (v9 & *(_QWORD *)(v10 + 8)) )
      {
        if ( !v10 )
          return v6;
        if ( (unsigned __int8)sub_14067474C(v10, a2, a4) )
        {
