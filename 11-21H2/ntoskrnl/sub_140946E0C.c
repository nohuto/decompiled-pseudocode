/*
 * XREFs of sub_140946E0C @ 0x140946E0C
 * Callers:
...
__int64 __fastcall sub_140946E0C(__int64 a1, unsigned int a2, _WORD *a3, unsigned int a4, unsigned int *a5)
{
  unsigned int v5; // edi
  _WORD *v6; // r14
  ...
  if ( a2 )
  {
    while ( 1 )
    {
      result = sub_140A30CA8(a1 + 32LL * v11, v6, v5, &v13);
