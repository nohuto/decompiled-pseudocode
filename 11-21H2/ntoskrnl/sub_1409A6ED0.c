/*
 * XREFs of sub_1409A6ED0 @ 0x1409A6ED0
 * Callers:
...
char __fastcall sub_1409A6ED0(int a1, __int64 a2, int a3, int a4)
{
  _UNKNOWN **v4; // rax
  ...
  if ( (unsigned int)dword_140D3B908 > 5 )
  {
    ...
    if ( (_BYTE)v4 )
    {
      ...
      v25 = 2;
      v12 = a4;
      LOBYTE(v4) = sub_14020A9C4((__int64)&dword_140D3B908, (unsigned __int8 *)&dword_140032CE1 + 3, 0LL, 0LL, 8u, &v14);
    }
  }
  return (char)v4;
}
