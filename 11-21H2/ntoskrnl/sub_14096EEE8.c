/*
 * XREFs of sub_14096EEE8 @ 0x14096EEE8
 * Callers:
...
unsigned __int64 __fastcall sub_14096EEE8(__int64 a1, __int64 a2, unsigned __int64 a3)
{
  __int64 v3; // r15
  __int64 v5; // rax
  ...
  *(_OWORD *)v19 = 0LL;
  if ( *(_QWORD *)a2 != v5
    && (int)sub_14071E6BC(*(struct _FILE_OBJECT **)(a2 + 56), 3, 0x18u, 0, (struct _IRP *)v19, &v18, 0) >= 0 )
  {
