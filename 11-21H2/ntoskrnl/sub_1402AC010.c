/*
 * XREFs of sub_1402AC010 @ 0x1402AC010
 * Callers:
...
__int64 __fastcall sub_1402AC010(__int64 a1, __int64 a2, int a3, unsigned __int64 a4)
{
  __int64 v4; // r15
...
LABEL_3:
    for ( i = v10; ; v10 = i )
    {
      v11 = v9 + a4;
      if ( v9 + a4 < v9 )
        return *(unsigned int *)&byte_140D07030[8 * v4 + 4];
      if ( v11 <= v10 )
        break;
      if ( (v8 & 1) == 0 || !v7[10] )
        return *(unsigned int *)&byte_140D07030[8 * v4 + 4];
      ...
      if ( !sub_1402436C8(v4, (__int64)v7, v9, a4, &i) )
        return *(unsigned int *)&byte_140D07030[8 * v4 + 4];
    }
