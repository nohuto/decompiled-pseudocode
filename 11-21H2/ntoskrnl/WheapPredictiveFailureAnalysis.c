/*
 * XREFs of WheapPredictiveFailureAnalysis @ 0x140A0A2E8
 * Callers:
...
LABEL_13:
    ...
    if ( v4 )
      v8 = v7;
    result = *((_QWORD *)v8 + 2) - *(_QWORD *)&MEMORY_ERROR_SECTION_GUID.Data1;
    if ( !result )
      result = *((_QWORD *)v8 + 3) - *(_QWORD *)MEMORY_ERROR_SECTION_GUID.Data4;
    if ( !result )
    {
