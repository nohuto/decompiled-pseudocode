/*
 * XREFs of sub_140540B48 @ 0x140540B48
 * Callers:
 *     sub_140540BD0 @ 0x140540BD0 (sub_140540BD0.c)
 *     sub_14092C610 @ 0x14092C610 (sub_14092C610.c)
 * Callees:
 *     <none>
 */

char __fastcall sub_140540B48(__int64 a1, unsigned __int64 a2, int a3, __int64 *a4)
{
  __int64 v4; // rcx
  __int64 i; // r10
  __int64 v6; // rax
