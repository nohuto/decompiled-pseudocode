/*
 * XREFs of sub_1409A023C @ 0x1409A023C
 * Callers:
...
void *__fastcall sub_1409A023C(__int64 a1, unsigned int a2, int a3)
{
  void *result; // rax
  void *v7; // rdi
  __int64 v8; // r9
  ...
  if ( result )
  {
    if ( *(_QWORD *)(*((_QWORD *)result + 39) + 40LL) && (unsigned int)dword_140C03A00 > 5 )
    {
      if ( sub_1402A2000((__int64)&dword_140C03A00, 0x800000000000LL) )
      {
        ...
        v19 = v9;
        v20 = a2;
        sub_1402A2094((__int64)v43, v12);
        sub_1402A2094((__int64)v44, v13);
        sub_14020A9C4((__int64)&dword_140C03A00, (unsigned __int8 *)byte_14003279B, 0LL, 0LL, 0xBu, &v21);
      }
    }
