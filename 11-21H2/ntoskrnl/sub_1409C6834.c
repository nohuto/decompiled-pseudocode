/*
 * XREFs of sub_1409C6834 @ 0x1409C6834
 * Callers:
 ...
 *     RxpGetUnalignedPointer @ 0x1405F43C4 (RxpGetUnalignedPointer.c)
 *     sub_1405F4B60 @ 0x1405F4B60 (sub_1405F4B60.c)
 *     sub_1409C67B8 @ 0x1409C67B8 (sub_1409C67B8.c)
 *     ExFreePoolWithTag @ 0x140A6E010 (ExFreePoolWithTag.c)
 */

void __fastcall sub_1409C6834(int a1, __int64 a2, __int64 a3, __int64 a4)
{
  int v6; // r10d
  __int64 v7; // r9
  _DWORD *v8; // r9
  ...
  __int64 UnalignedPointer; // [rsp+50h] [rbp-B0h] BYREF
  ...
  __int64 *p_UnalignedPointer; // [rsp+B0h] [rbp-50h]
  ...
  v35 = 0;
  v36 = 0;
  if ( qword_140C16478 && byte_140C5AEB3 )
  {
    if ( a4 )
    {
      UnalignedPointer = RxpGetUnalignedPointer(a4 + 16);
      v40 = RxpGetUnalignedPointer(v7 + 24);
      v32 = v8[48];
      v33 = v8[49];
      v34 = v8[50];
    }
    ...
    {
      UnalignedPointer = 0LL;
      v40 = 0LL;
      v32 = 0;
      v33 = 0;
      v34 = 0;
    }
    UserData.Ptr = (ULONGLONG)sub_1409C67B8(v6, &v31);
    v10 = 2;
    UserData.Size = v31;
    UserData.Reserved = 0;
    v11 = *(_QWORD *)(*((_QWORD *)KeGetCurrentThread() + 23) + 1472LL);
    v12 = &unk_140D04968;
    if ( v11 && *(_WORD *)v11 )
    {
      v13 = *(void **)(v11 + 8);
    ...
    v50 = v12;
    p_UnalignedPointer = &UnalignedPointer;
    v55 = &v40;
    v57 = &v32;
    v59 = &v33;
    v61 = &v34;
    ...
    if ( a2 && v18 )
    {
      v20 = (void *)sub_1405F4B60((_DWORD *)a2, &v35);
      v68 = v35;
      v19 = 12;
      v67 = v20;
      v69 = 0;
    ...
    *((_QWORD *)&UserData.Size + v25) = 4LL;
    if ( a3 && v24 )
    {
      v28 = sub_1405F4B60((_DWORD *)a3, &v36);
      v29 = v36;
      v27 = (void *)v28;
      v30 = 2LL * v26++;
    ...
    EtwWrite(qword_140C16478, &stru_140039BB8, 0LL, v26, &UserData);
    if ( v20 )
