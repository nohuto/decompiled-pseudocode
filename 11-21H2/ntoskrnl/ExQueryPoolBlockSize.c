...
SIZE_T __stdcall ExQueryPoolBlockSize(PVOID PoolBlock, PBOOLEAN QuotaCharged)
{
  ...
  else if ( ((unsigned __int16)PoolBlock & 0xFFF) != 0 )
  {
    ...
    if ( (v9 & 8) != 0 )
    {
      ...
      if ( (v8 ^ ExpPoolQuotaCookie ^ *(_QWORD *)(v8 + 8)) - 1 <= 0xFFFFFFFFFFFFFFFDuLL )
        v2 = 1;
    }
    *QuotaCharged = v2;
    return v10 - 16;
  ...
  {
    MiDeterminePoolType((unsigned __int64)PoolBlock);
    ExpRemoveTagForBigPages((ULONG_PTR)PoolBlock, (__int64)&v13, (__int64)&v12, (__int64)&v11);
