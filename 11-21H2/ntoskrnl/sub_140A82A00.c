/*
 * XREFs of sub_140A82A00 @ 0x140A82A00
 * Callers:
 *     <none>
 * Callees:
...
void __fastcall sub_140A82A00(__int64 a1, __int64 a2, __int64 a3, __int64 a4, const void *a5)
{
  __int64 v7; // rcx
  int v8; // eax
  int v9; // edx
  _QWORD *v10; // rcx
  __int64 v11; // rdi
  char v12[96]; // [rsp+30h] [rbp-78h] BYREF
...
LABEL_8:
      ...
      if ( (_BYTE)v11 )
      {
        ...
        if ( (int)sub_1403BF7F4(
                    v12,
                    91LL,
                    (__int64)"CulpritAddress = %p, Irp = %p, IRQL = %u.\n",
                    a5,
                    (const void *)a2,
                    v11) >= 0 )
          sub_1405FDF9C(v12);
        sub_140A92D34(770LL, a5, a2, v11);
      }
    }
    else
    {
