/*
 * XREFs of EtwpReserveTraceBuffer @ 0x1402ABBF0
 * Callers:
...
__int64 __fastcall EtwpReserveTraceBuffer(__int64 a1, unsigned int a2, __int64 a3, __int64 *a4, int a5)
{
  __int64 v7; // r8
  unsigned int v8; // edi
  unsigned int v9; // ebx
...
LABEL_44:
    v36 = EtwpSwitchBuffer(a1, v19, (_DWORD)v15, v87, a5);
  ...
  while ( (*(_DWORD *)(a1 + 816) & 0x8000000) != 0 )
  {
    ...
    if ( v20 == v48 )
    {
      ...
      v37 = v47 == _InterlockedCompareExchange64((volatile signed __int64 *)(v14[2] + v46), v85, v47);
...
LABEL_51:
  ...
  if ( (_DWORD)v21 == 1 )
  {
    ...
    {
      v37 = *(_DWORD *)(HalpPerformanceCounter + 220) == 64;
      v22 = *(_QWORD *)(HalpPerformanceCounter + 192);
      v88 = v22;
      if ( v37 )
      {
        v38 = HalpTimerGetInternalData(HalpPerformanceCounter);
        *(_QWORD *)&v27 = (*(__int64 (__fastcall **)(__int64))(v39 + 112))(v38);
        v25 = v82;
        *((_QWORD *)&v27 + 1) = v27;
        v26 = *(_QWORD *)(v82 + 208);
      }
...
LABEL_28:
  ...
  {
    v89 = 0LL;
    ((void (__fastcall *)(__int64 *, _QWORD, __int64, signed __int64 *))off_140C02030[0])(&v89, 0LL, v7, v10);
