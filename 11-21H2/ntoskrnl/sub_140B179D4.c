/*
 * XREFs of sub_140B179D4 @ 0x140B179D4
 * Callers:
...
void __fastcall sub_140B179D4(HANDLE SectionHandle, HANDLE KeyHandle)
{
         ...
         4u) >= 0 )
  {
    ...
    if ( (unsigned __int8)sub_140B18084(BaseAddress, 0x8000LL, SourceString, 0LL) )
    {
    ...
    if ( PoolWithTag && (unsigned __int8)sub_140B17EC4(BaseAddress, 0x8000LL, SourceString) )
    {
      v8 = PoolWithTag;
      do
      {
      ...
      while ( (unsigned __int8)sub_140B17EC4(0LL, 0LL, SourceString) );
      if ( v4 - 1 <= 0xFFD )
      {
        *v8 = 0;
