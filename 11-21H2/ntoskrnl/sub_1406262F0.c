/*
 * XREFs of sub_1406262F0 @ 0x1406262F0
 * Callers:
 *     <none>
 * Callees:
...
NTSTATUS __fastcall sub_1406262F0(HANDLE KeyHandle, PUNICODE_STRING NewName)
{
  __int64 v4; // rdx
  __int64 v5; // rcx
  __int64 *v6; // rdi
...
LABEL_12:
  *(_QWORD *)&v16 = v10;
LABEL_13:
  *(_QWORD *)&v17 = KeyHandle;
  *((_QWORD *)&v16 + 1) = NewName;
...
LABEL_18:
  result = ZwRenameKey(KeyHandle, NewName);
  DWORD2(v17) = result;
  if ( v6 )
  {
    v14 = (_QWORD **)(v6 + 6);
