/*
 * XREFs of sub_14061C4B0 @ 0x14061C4B0
 * Callers:
 *     <none>
 * Callees:
...
NTSTATUS __fastcall sub_14061C4B0(
        ULONG RelativeTo,
        PCWSTR Path,
        PCWSTR ValueName,
        ULONG ValueType,
...
LABEL_12:
  *(_QWORD *)&v22 = v16;
LABEL_13:
  *(_QWORD *)&v23 = ValueData;
  DWORD2(v22) = ValueLength;
  LODWORD(v25) = RelativeTo;
  *((_QWORD *)&v24 + 1) = Path;
  *(_QWORD *)&v24 = ValueName;
  DWORD2(v23) = ValueType;
