/*
 * XREFs of sub_140618180 @ 0x140618180
 * Callers:
 *     <none>
 * Callees:
...
NTSTATUS __fastcall sub_140618180(
        HANDLE FileHandle,
        HANDLE Event,
...
LABEL_18:
  result = NtWriteFile(FileHandle, Event, ApcRoutine, ApcContext, IoStatusBlock, Buffer, Length, ByteOffset, Key);
