/*
 * XREFs of sub_140705390 @ 0x140705390
 * Callers:
 *     sub_1407051BC @ 0x1407051BC (sub_1407051BC.c)
 * Callees:
 *     sub_14029A780 @ 0x14029A780 (sub_14029A780.c)
 */

__int64 __fastcall sub_140705390(int a1, _DWORD *a2, int *a3)
{
  int v3; // edi
