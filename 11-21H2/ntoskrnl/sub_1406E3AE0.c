/*
 * XREFs of sub_1406E3AE0 @ 0x1406E3AE0
 * Callers:
 ...
 *     sub_1405E509C @ 0x1405E509C (sub_1405E509C.c)
 *     sub_1406734EC @ 0x1406734EC (sub_1406734EC.c)
 */

NTSTATUS __fastcall sub_1406E3AE0(void *a1, ULONG64 a2, _QWORD *a3, int a4, char a5)
{
  int v8; // edi
  _DWORD *v9; // rax
  __int64 v10; // r13
  ...
  v9 = sub_1402D72FC((__int64)a1, 0, 0LL, 8);
  v37 = v9;
  v10 = -1LL;
  if ( v9 == (_DWORD *)-1LL )
    return -1073741686;
  ...
  a1 = v39;
LABEL_13:
  if ( a2 || v8 || (result = sub_1406734EC((unsigned __int64)a1, &v38, a4), result >= 0) )
  {
    v13 = (__int64)v39;
    v14 = sub_140206200(v39, v38, v8 != 0 ? 8240 : 4144, (__int64)v41, 3, &v37, v40, 0LL, 0LL);
    if ( v14 < 0 )
    {
      if ( v14 != -1073741701 )
        v14 = -1073741686;
...
LABEL_58:
        if ( a5 )
        {
          if ( v15 )
            v10 = (__int64)v15;
          sub_1403D525C(v13, 0LL, 0LL, v10, 0, 2, v11, 0LL);
        }
        return v11;
      }
      v11 = -1073020925;
      ...
      if ( v33 )
      {
        if ( !sub_1405E509C(v33, 7) )
          goto LABEL_57;
      }
      if ( !sub_1405E509C(v15[4] & 0xFFFFFFCF, 3) )
        goto LABEL_57;
      if ( !sub_1405E509C(v34 & 0xFFFFFFFC, 48) )
        goto LABEL_57;
      if ( (v35 & 1) != 0 )
      {
        if ( !sub_1405E509C(v15[6], 3) )
          goto LABEL_57;
        v36 = v15[5];
        if ( v36 )
        {
          if ( !sub_1405E509C(v36, 256) )
            goto LABEL_57;
        }
      }
    }
