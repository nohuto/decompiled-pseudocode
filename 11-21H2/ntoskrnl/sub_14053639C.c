/*
 * XREFs of sub_14053639C @ 0x14053639C
 * Callers:
...
__int64 __fastcall sub_14053639C(__int64 a1)
{
  int v1; // eax
  int v2; // r9d
  int v4; // esi
...
LABEL_7:
  ...
  result = *((unsigned __int8 *)qword_140037250 + (v7 & 0xF));
  *(_DWORD *)(a1 + 16) = (4
                        * ((v5 << 9) | ((((_BYTE)result + *((_BYTE *)qword_140037250 + ((unsigned __int8)v7 >> 4))) & 1) == 0))) | v4 & 0xFFFFF72B | *(_DWORD *)(a1 + 16) & 0xFFFFF72A | (((2 * v6) | v2 & 0xFFFFFFFD) << 6) & 0xFFFFF7FF | ((*(_BYTE *)(a1 + 104) & 0xF) + (*(_BYTE *)(a1 + 108) & 0xF)) & 0xFFFFF730;
  return result;
}
