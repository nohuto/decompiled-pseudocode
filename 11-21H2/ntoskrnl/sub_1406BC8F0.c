/*
 * XREFs of sub_1406BC8F0 @ 0x1406BC8F0
 * Callers:
...
__int64 __fastcall sub_1406BC8F0(__int64 a1, char a2, int *a3, __int64 a4, __int64 a5, __int64 a6)
{
  int v9; // r8d
  __int64 v10; // rcx
  int v11; // esi
  ...
  v9 = *a3;
  v10 = qword_140D07490[(unsigned __int8)dword_140D06C0C ^ *(unsigned __int8 *)(a1 - 24) ^ (unsigned __int64)(unsigned __int8)((unsigned __int16)(a1 - 48) >> 8)];
  v11 = *(_DWORD *)(v10 + 96);
  v20 = 0LL;
  v12 = v9 & v11;
  v21 = v14;
  ...
  v15 = a4;
  v16 = a5;
  result = sub_1407BC580(v10, v17, a6);
  if ( (int)result >= 0 && !a2 )
    *a3 &= v12 | v14[0];
  return result;
}
