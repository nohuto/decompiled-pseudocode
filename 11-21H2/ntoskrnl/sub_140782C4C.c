/*
 * XREFs of sub_140782C4C @ 0x140782C4C
 * Callers:
...
__int64 __fastcall sub_140782C4C(__int64 a1, PVOID *a2)
{
  ...
  v6 = sub_140781F40(2, L"WMI\\Security", (__int64)v13, 0LL);
  *a2 = 0LL;
  if ( v6 < 0 )
    goto LABEL_14;
  while ( 1 )
  ...
  if ( !PersistedStateLocation )
  {
    ...
    sub_140781F40(0, TargetPath, (__int64)v13, 0LL);
  }
  if ( SecurityDescriptor[0] )
  {
    v8 = P;
