/*
 * XREFs of EtwTraceEvent @ 0x140460192
 * Callers:
...
LABEL_37:
    ...
    if ( v20 )
    {
      ...
      *((_DWORD *)v21 + 3) = CurrentThread[1].CycleTime;
      ...
      {
        EtwpSendTraceEvent(v11, (__int64)&v44);
      }
      if ( *(_QWORD *)(v11 + 1288) )
      {
        LOBYTE(v22) = a5;
        EtwpInvokeEventCallback(v11, &v44, v21 + 24, v22);
      }
      EtwpReleaseTraceBuffer((signed __int64 *)&v44);
      result = v31;
    }
    else
    {
