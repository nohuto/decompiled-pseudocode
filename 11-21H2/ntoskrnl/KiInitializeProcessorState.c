/*
 * XREFs of KiInitializeProcessorState @ 0x14082A324
 * Callers:
...
__int64 __fastcall KiInitializeProcessorState(unsigned __int64 *a1, _QWORD *a2, __int64 a3, __int64 a4)
{
  KPCR *Pcr; // rbx
  unsigned int v8; // edi
  ...
  *(_QWORD *)(v14 + 52) = *(_QWORD *)(a4 + 64);
  v16 = *(_QWORD *)(a4 + 56);
  *(_QWORD *)(v16 - 40) = &KiExceptionDispatchOnExceptionStackContinue;
  ...
  *(_QWORD *)(v15 + 552) = v15 + 2568;
  ...
  if ( (_OWORD *)KeNodeBlock[v17] == v18 )
  {
    ...
    while ( v28 );
    v30 = *v18;
    KeNodeBlock[v17] = v15 + 2880;
    *v27 = v30;
    *((_QWORD *)v27 + 2) = *((_QWORD *)v18 + 2);
  }
  if ( !(unsigned int)KiEnableKvaShadowing(a3 + 384, v11 - 12208) )
    return 0LL;
  KiAssignProcessorNumberToPrcb(a3 + 384, (unsigned __int8 *)(a4 + 20), *(_DWORD *)a4);
