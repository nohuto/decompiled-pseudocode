/*
 * XREFs of sub_14050B2E4 @ 0x14050B2E4
 * Callers:
 *     sub_1407FCE14 @ 0x1407FCE14 (sub_1407FCE14.c)
 * Callees:
 *     KeQueryPerformanceCounter @ 0x1403027F0 (KeQueryPerformanceCounter.c)
 *     sub_14050B508 @ 0x14050B508 (sub_14050B508.c)
 */

__int64 __fastcall sub_14050B2E4(unsigned int **a1, __int64 a2, unsigned int *a3)
{
  ...
  v7 = *a1;
  if ( *a1 == (unsigned int *)&unk_140C4D060 )
    return sub_14050B508(a1, a2, a3);
  v8 = v7[5];
  v9 = v7[4];
  v10 = 16 * v7[5] + 24;
  *a3 = v10;
  ...
  *((_DWORD *)a1 + 2) = v9;
  if ( off_140C02520 == &off_1400032A0 )
    ...
    v11 = qword_140C4D0A8 + 8LL * dword_140C4D044 * v9;
  if ( (_DWORD)v8 )
  {
    v12 = v7 + 10;
    v13 = a1 + 4;
