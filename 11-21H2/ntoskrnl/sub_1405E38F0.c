/*
 * XREFs of sub_1405E38F0 @ 0x1405E38F0
 * Callers:
...
__int64 __fastcall sub_1405E38F0(__int64 a1, _OWORD *a2, __int64 a3, __int64 a4)
{
  __int64 v8; // rdx
  unsigned int v9; // r8d
  bool i; // zf
  ...
  v9 = dword_140C1BC9C;
  v12 = dword_140C1BC9C;
  v11 = _InterlockedCompareExchange(&dword_140C1BC9C, (dword_140C1BC9C + 1) % 0x32u, dword_140C1BC9C);
  for ( i = v12 == v11; ; i = v11 == v13 )
  {
    ...
    if ( i )
      break;
    v9 = v11;
    v11 = _InterlockedCompareExchange(&dword_140C1BC9C, (v11 + 1) % 0x32u, v11);
  }
  v14 = 1424LL * v9;
  i = qword_140D01188 + v14 == 0;
  v8 = qword_140D01188 + v14;
