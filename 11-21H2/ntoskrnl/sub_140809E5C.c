/*
 * XREFs of sub_140809E5C @ 0x140809E5C
 * Callers:
...
__int64 __fastcall sub_140809E5C(__int64 a1, unsigned int *a2)
{
  unsigned int *v4; // rdi
  __int64 v5; // rax
  _QWORD *v6; // rsi
  ...
  unsigned int *v12; // [rsp+50h] [rbp-B0h]
  ...
  unsigned int *v34; // [rsp+100h] [rbp+0h]
  ...
  *(_QWORD *)&UserData.Size = 4LL;
  ...
  v35 = 4LL;
  if ( byte_140C5AE14 )
    EtwWrite(RegHandle, &stru_140011C78, 0LL, 0xDu, &UserData);
  if ( byte_140C5AE16 )
    EtwWrite(CallbackContext, &stru_140011C68, 0LL, 0xDu, &UserData);
  return sub_140811C98(*v6, *a2, *v4);
}
