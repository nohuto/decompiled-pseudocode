/*
 * XREFs of sub_1406F1AC4 @ 0x1406F1AC4
 * Callers:
...
NTSTATUS __fastcall sub_1406F1AC4(__int64 a1, char a2)
{
  _QWORD *v2; // r13
  char v4; // r12
  NTSTATUS result; // eax
  ...
  if ( result >= 0 )
  {
    ...
    if ( !a2 )
    {
      ...
      *(_DWORD *)(Buffer + 116) = sub_1402E1C80(a1);
...
LABEL_26:
    ...
    if ( v4 && v12 < v7 && v12 >= 0x178 )
    {
      *(_DWORD *)(Buffer + 48) = v12;
      if ( *(_QWORD *)(a1 + 1304) )
        sub_140632F6C(a1, Buffer, v7);
      if ( (_QWORD *)*v2 != v2 || *(_DWORD *)(a1 + 120) )
        sub_1406F1DF8(a1, Buffer, v7, Buffer + 88, 3);
      if ( *(_QWORD *)(a1 + 1040) != a1 + 1040 )
        sub_1409E959C(a1, Buffer, v7, 2LL);
    }
    goto LABEL_23;
  }
  return result;
