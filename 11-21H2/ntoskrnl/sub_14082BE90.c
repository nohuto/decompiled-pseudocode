/*
 * XREFs of sub_14082BE90 @ 0x14082BE90
 * Callers:
...
__int64 __fastcall sub_14082BE90(UNICODE_STRING *a1, int a2, void *a3, void *a4, int a5, _QWORD *a6, HANDLE *a7)
{
...
LABEL_8:
      ...
      v18[0] = 1LL;
      v18[2] = v8;
      v12 = sub_1406C505C(&Handle, 983041, (__int64)&ObjectAttributes, (__int64)v18, 0);
      if ( v12 >= 0 )
      {
