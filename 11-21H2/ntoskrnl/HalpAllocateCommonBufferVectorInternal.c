/*
 * XREFs of HalpAllocateCommonBufferVectorInternal @ 0x140511BD0
 * Callers:
 *     HalAllocateCommonBufferVector @ 0x1405110E0 (HalAllocateCommonBufferVector.c)
 * Callees:
...
LABEL_41:
  ...
  *(_QWORD *)(v18 + 48) = v31;
  ...
  {
    *((_QWORD *)&v57 + 1) = v11;
    v16 = ((__int64 (__fastcall *)(_QWORD, __int64, __int128 *))qword_140C4BDA8)(
