/*
 * XREFs of sub_140A318B0 @ 0x140A318B0
 * Callers:
...
__int64 __fastcall sub_140A318B0(unsigned int a1, __int64 a2, unsigned int a3, _WORD *a4, unsigned int *a5)
{
  _WORD *v5; // r14
  unsigned int v6; // edi
  ...
  if ( a1 )
  {
    while ( 1 )
    {
      result = sub_140A314B0((_DWORD *)(a2 + 56LL * v11), v6, v5, &v13);
