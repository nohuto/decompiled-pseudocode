/*
 * XREFs of sub_140A6F708 @ 0x140A6F708
 * Callers:
...
__int64 __fastcall sub_140A6F708(char *a1, int a2, _BYTE *a3)
{
  char *v3; // r10
  int v4; // r9d
  _BYTE *v5; // rcx
  ...
  *((_DWORD *)v3 + 12) = v4;
  if ( (v4 & 0x100040) == 0x100040 )
  {
    ...
    if ( v10 <= (unsigned int)v11 )
      v11 = v10;
    sub_140A70244(&v3[*((int *)v3 + 312) + 1232], &v6[*((int *)v6 + 312) + 1232], v11);
  }
  result = 1048704LL;
  if ( (v4 & 0x100080) == 0x100080 )
  {
    ...
    if ( v12 <= (unsigned int)v13 )
      v13 = v12;
    return sub_140A70244(&v3[*((int *)v3 + 314) + 1232], &v6[*((int *)v6 + 314) + 1232], v13);
  }
  return result;
}
