/*
 * XREFs of AuthzBasepGetClaimAttributeValueCopyoutBufferSize @ 0x140A1AAAC
 * Callers:
 *     AuthzBasepGetClaimAttributesCopyoutBufferSize @ 0x140A1AC54 (AuthzBasepGetClaimAttributesCopyoutBufferSize.c)
 * Callees:
 *     <none>
 */
