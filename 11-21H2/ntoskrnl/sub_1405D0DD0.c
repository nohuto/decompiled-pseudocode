/*
 * XREFs of sub_1405D0DD0 @ 0x1405D0DD0
 * Callers:
...
char __fastcall sub_1405D0DD0(int a1, int a2, int a3, unsigned __int8 a4, char a5, unsigned __int8 a6)
{
  _UNKNOWN **v6; // rax
  int v7; // edi
  REGHANDLE v8; // rbx
  ...
  {
    v8 = RegHandle;
    LOBYTE(v6) = EtwEventEnabled(RegHandle, &stru_1400389D0);
    if ( (_BYTE)v6 )
    {
      UserData.Reserved = 0;
      v15 = 0;
      ...
      v26 = 4;
      v10 = v7;
      LOBYTE(v6) = EtwWriteEx(v8, &stru_1400389D0, 0LL, 0, 0LL, 0LL, 6u, &UserData);
    }
  }
  return (char)v6;
}
