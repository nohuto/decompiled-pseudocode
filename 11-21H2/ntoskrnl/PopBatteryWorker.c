/*
 * XREFs of PopBatteryWorker @ 0x1407EDFC0
 * Callers:
 *     <none>
 * Callees:
...
void PopBatteryWorker()
{
  ...
  int v139; // [rsp+D0h] [rbp-38h] BYREF
  __int64 v140; // [rsp+D8h] [rbp-30h] BYREF
  int v141; // [rsp+E0h] [rbp-28h]
  BOOL v142; // [rsp+E4h] [rbp-24h] BYREF
  int v143; // [rsp+E8h] [rbp-20h] BYREF
  ...
  while ( 1 )
  {
    ...
    if ( (v9 & 0x40) != 0 )
    {
      ...
      Timeout = 0LL;
      ZwUpdateWnfStateData((__int64)&WNF_PO_RECONCILED_WEAK_CHARGER, (__int64)v119);
    ...
    if ( (__int64 *)qword_140C229D0 != &qword_140C229D0 )
    {
      do
      {
        ...
        if ( (int)PopBatteryQueryStatus(v13 - 8, v3) >= 0 )
        {
          PopAccountBatteryEnergyChange(v13 - 8);
          v61 = *((_DWORD *)v60 + 37);
          ...
          if ( (v61 & 2) != 0 )
          {
            EstimatedTime = PopBatteryQueryEstimatedTime(v13 - 8, 0LL);
            v61 = *((_DWORD *)v60 + 37);
          }
          v63 = 0;
          *((_DWORD *)v60 + 41) = EstimatedTime;
          if ( EstimatedTime != -1 )
            v63 = EstimatedTime;
          v64 = *((_DWORD *)v60 + 40);
          LODWORD(v116) = v63;
          LODWORD(v115) = v64;
          LODWORD(v114) = *((_DWORD *)v60 + 39);
          LODWORD(v113) = *((_DWORD *)v60 + 38);
          LODWORD(Timeout) = v61;
          DbgPrintEx(
            0x92u,
            3u,
    ...
    if ( (v9 & 4) != 0 || v15 )
    {
      ...
      else
      {
        ...
        KiSetTimerEx((unsigned __int64)&stru_140C21DE0, -300000000LL, 0, 0, (__int64)&PopPostSpoilingRefresh);
      }
      v14 = 0LL;
    }
    v16 = 0xFFFFFFFFLL;
    ...
    if ( !dword_140C229B4 )
    {
      LOBYTE(v22) = 1;
      v136 = 1;
      if ( v5 == 3 && (unsigned __int64)KiQueryUnbiasedInterruptTime() >= 0x11E1A300 )
      {
        v5 = 1;
        v125 = 1;
      }
    ...
    {
      if ( (v22 & 4) != 0 )
        v145 = PopEstimateChargeTime(v16, v3, v18);
      goto LABEL_147;
    }
    v75 = qword_140C229D0;
    v14 = 0LL;
    ...
    if ( (__int64 *)qword_140C229D0 != &qword_140C229D0 )
    {
      ...
      if ( v76 )
      {
        ...
        do
        {
          v78 = PopBatteryQueryEstimatedTime(v77 - 8, v76);
          if ( v78 != -1 )
          {
            v79 = 0;
            if ( v21 != -1 )
...
LABEL_27:
    ...
    {
      LODWORD(v114) = (_DWORD)v14;
      LODWORD(v113) = (_DWORD)v14;
      Timeout = v14;
      v118[0] = v24 != 0;
      v142 = v24 != 0;
      updated = ZwUpdateWnfStateData((__int64)&WNF_PO_BATTERY_CHARGE_LIMITING_MODE, (__int64)v118);
      PopSetPowerSettingValueAcDc(&GUID_BATTERY_CHARGE_LIMITING_MODE, 4u, &v142);
      if ( (unsigned int)dword_140C03A00 > 5 )
      {
        if ( tlgKeywordOn((__int64)&dword_140C03A00, 0x400000000000LL) )
        {
          ...
          v226 = 4LL;
          v228 = 4LL;
          tlgCreate1Sz_char((__int64)v229, v82);
          v84 = "AC + BCL";
          if ( (v20 & 2) == 0 )
            v84 = v83;
          tlgCreate1Sz_char((__int64)v230, v84);
          v87 = "DC + !BCL";
          if ( (v20 & v86) == 0 )
            v87 = v85;
          tlgCreate1Sz_char((__int64)v231, v87);
          v89 = "AC + !BCL";
          if ( (v20 & 8) == 0 )
            v89 = v88;
          tlgCreate1Sz_char((__int64)v232, v89);
          v150 = 0x1000000LL;
          v233 = &v150;
          v234 = 8LL;
          tlgWriteTransfer_EtwWriteTransfer(
            (__int64)&dword_140C03A00,
            (unsigned __int8 *)byte_140030E55,
            0LL,
            0LL,
            0xAu,
            &v222);
...
LABEL_176:
      ...
      LODWORD(v113) = 0;
      Timeout = 0LL;
      ZwUpdateWnfStateData((__int64)&WNF_PO_RECONCILED_WEAK_CHARGER, (__int64)v90);
      goto LABEL_177;
    }
LABEL_33:
    PopBatteryApplyCompositeState(&v136, v21, v18);
  ...
  if ( !PopUserBatteryChargingEstimator )
  {
    ...
    LODWORD(v113) = 0;
    Timeout = 0LL;
    ZwUpdateWnfStateData((__int64)&WNF_PO_CHARGE_ESTIMATE, (__int64)&v145);
  }
  ...
  if ( !PopDisableBatteryDischargeEstimator )
  {
    ...
    v147 = v0;
    Timeout = 0LL;
    ZwUpdateWnfStateData((__int64)&WNF_PO_DISCHARGE_ESTIMATE, (__int64)&v147);
  }
  v29 = "AC Power";
  ...
  if ( (unsigned int)dword_140C03A00 > 5 && tlgKeywordOn((__int64)&dword_140C03A00, 0x400000000000LL) )
  {
    ...
    if ( (xmmword_140C229E0 & 1) == 0 )
      v32 = "DC Power";
    tlgCreate1Sz_char((__int64)v160, v32);
    v34 = "Battery Discharging";
    if ( (v33 & 2) == 0 )
      v34 = "-";
    tlgCreate1Sz_char((__int64)v161, v34);
    v37 = "Battery Charging";
    if ( (v35 & v36) == 0 )
      v37 = "-";
    tlgCreate1Sz_char((__int64)v162, v37);
    v39 = "Battery Critical";
    if ( (v38 & 8) == 0 )
      v39 = "-";
    tlgCreate1Sz_char((__int64)v163, v39);
    v41 = "Battery charge limiting mode";
    if ( (v40 & 0x10) == 0 )
      v41 = "-";
    tlgCreate1Sz_char((__int64)v164, v41);
    v43 = "Battery charging state power supply present";
    if ( (v42 & 0x20) == 0 )
      v43 = "-";
    tlgCreate1Sz_char((__int64)v165, v43);
    v45 = "Battery charging state adequate";
    if ( (v44 & 0x40) == 0 )
      v45 = "-";
    tlgCreate1Sz_char((__int64)v166, v45);
    v47 = "Platform BCL Enabled";
    if ( (byte_140C22BB0 & 1) == 0 )
      v47 = v46;
    tlgCreate1Sz_char((__int64)v167, v47);
    ...
    v176 = &v127;
    v178 = (char *)&v127 + 4;
    v128 = PopDisableBatteryDischargeEstimator;
    v180 = &v128;
    v140 = v21;
    v182 = &v140;
    v184 = &v129;
    ...
    tlgWriteTransfer_EtwWriteTransfer(
      (__int64)&dword_140C03A00,
      (unsigned __int8 *)&dword_140031134,
      0LL,
      0LL,
      0x16u,
      &v157);
  ...
  if ( (_BYTE)v126 )
  {
    ...
    *(_DWORD *)&v155[20] = dword_140C229B4;
    ...
    Timeout = 0LL;
    ZwUpdateWnfStateData((__int64)&WNF_PO_COMPOSITE_BATTERY, (__int64)&v153);
    if ( (unsigned int)dword_140C03A00 > 5 && tlgKeywordOn((__int64)&dword_140C03A00, 0x400000000000LL) )
    {
      v191 = &v130;
      ...
      if ( (xmmword_140C229E0 & 1) == 0 )
        v29 = "DC Power";
      v192 = 4LL;
      tlgCreate1Sz_char((__int64)v193, v29);
      if ( (v91 & 2) == 0 )
        v30 = "-";
      tlgCreate1Sz_char((__int64)v194, v30);
      if ( (v92 & v93) == 0 )
        v31 = "-";
      tlgCreate1Sz_char((__int64)v195, v31);
      v95 = "Battery Critical";
      if ( (v94 & 8) == 0 )
        v95 = "-";
      tlgCreate1Sz_char((__int64)v196, v95);
      v97 = "Battery charge limiting mode";
      if ( (v96 & 0x10) == 0 )
        v97 = "-";
      tlgCreate1Sz_char((__int64)v197, v97);
      ...
      if ( (v100 & 0x40) == 0 )
        v101 = "-";
      tlgCreate1Sz_char((__int64)v199, v101);
      v102 = "Platform BCL Enabled";
      if ( (byte_140C22BB0 & 1) == 0 )
        v102 = "-";
      tlgCreate1Sz_char((__int64)v200, v102);
      if ( (_DWORD)xmmword_140C22A04 )
      ...
      v132 = v103;
      v216 = v104;
      tlgCreate1Sz_char((__int64)v217, v107);
      v218 = &v131;
      ...
      tlgWriteTransfer_EtwWriteTransfer(
        (__int64)&dword_140C03A00,
        (unsigned __int8 *)&dword_140030F04,
        0LL,
        0LL,
        0x16u,
        &v190);
    ...
    if ( v5 == 1 )
    {
      ...
      LODWORD(v113) = 0;
      Timeout = 0LL;
      ZwUpdateWnfStateData((__int64)&WNF_PO_DISCHARGE_START_FILETIME, (__int64)&v148);
    }
    if ( v53 )
    {
      HIDWORD(v149) = -1;
      ...
      LODWORD(v113) = 0;
      Timeout = 0LL;
      v110 = ZwUpdateWnfStateData((__int64)&WNF_PO_POWER_STATE_CHANGE, (__int64)&v149);
      if ( (unsigned int)dword_140C03A00 > 5 )
      {
        LODWORD(v140) = v110;
        v237 = 4LL;
        ...
        tlgWriteTransfer_EtwWriteTransfer(
          (__int64)&dword_140C03A00,
          (unsigned __int8 *)byte_140031100,
          0LL,
          0LL,
          3u,
          &v235);
