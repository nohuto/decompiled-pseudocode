/*
 * XREFs of sub_1403A693C @ 0x1403A693C
 * Callers:
...
void __fastcall sub_1403A693C(__int64 a1, int a2, int a3)
{
  __int64 v3; // r9
  int v4; // r10d
  int v5; // r11d
  ...
  if ( (a3 < 0 || a2) && (unsigned int)dword_140C03A00 > 5 )
  {
    if ( sub_1402A2000((__int64)&dword_140C03A00, 0x200000000000LL) )
    {
      v13 = 0;
      v16 = 0;
      v19 = 0;
      ...
      v7 = v4;
      v9 = 0x1000000LL;
      sub_14020A9C4((__int64)&dword_140C03A00, (unsigned __int8 *)byte_14002E428, 0LL, 0LL, 6u, &v10);
    }
  }
}
