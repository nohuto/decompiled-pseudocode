/*
 * XREFs of ?ReadHeader@SC_GPT@@AEAAJKPEAVGPT_HEADER@@@Z @ 0x14064FC7C
 * Callers:
...
__int64 __fastcall SC_GPT::ReadHeader(SC_DISK **this, int a2, struct GPT_HEADER *a3)
{
  ...
  if ( a2 )
    ...
    v6 = 1LL;
  Sectors = SC_DISK::ReadSectors(v4, 1u, v6, a3);
  if ( Sectors >= 0 )
  {
    Sectors = -1073741774;
      ...
      && *((_DWORD *)a3 + 21) == 128 )
    {
      ...
      if ( (unsigned int)(v8 - 1) <= 0x3FF && *((_QWORD *)a3 + 3) == v6 )
      {
        ...
        *((_DWORD *)a3 + 4) = v9;
        if ( v10 == v9 )
          return *((_QWORD *)a3 + 5) < (unsigned __int64)(((((v8 << 7) + *((_DWORD *)*this + 59) - 1) & (unsigned int)-*((_DWORD *)*this + 59)) >> *((_DWORD *)*this + 60))
                                                        + 2)
               ? 0xC0000032
               : 0;
      }
