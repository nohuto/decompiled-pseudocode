...
LABEL_37:
  ...
  while ( v7 )
  {
    ...
    LOBYTE(Size) = 0;
    v21 = sub_14024A520(v19, v11, Type, v12, v15, &Size);
    v19 = v40;
    if ( !v21 )
      break;
LABEL_35:
      ...
      do
      {
        if ( v7 <= 1
          || (Name = (const wchar_t *)v8->Name,
              LOBYTE(Size) = 0,
              v29 = sub_14024A520(v19, v11, Name, v12, v25, &Size),
              v11 = v39,
              !v29) )
        {
          v30 = v25[1];
          ...
          if ( !v18 )
          {
            do
            {
              if ( Level <= 2
                || (LOBYTE(Size) = 0,
                    !(unsigned int)sub_14024A520(v19, v11, (const wchar_t *)ResourceInfo->Language, v12, v33, &Size)) )
              {
                v36 = v33[1];
                if ( (int)v36 < 0 )
                  return -1073741701;
