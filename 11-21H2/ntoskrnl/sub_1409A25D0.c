/*
 * XREFs of sub_1409A25D0 @ 0x1409A25D0
 * Callers:
...
void __fastcall sub_1409A25D0(__int64 a1, int a2)
{
  __int64 v2; // r12
  void **v4; // r15
  char v5; // r14
  ...
  if ( *v4 != v4 )
  {
    while ( 1 )
    {
      if ( !(unsigned __int8)sub_1409A2774(a1, *((unsigned int *)v6 + 8), &v12) )
      {
        sub_1409A8628("TtmpCommitTerminalDisplayStateUpdateWorker", 2986LL, 3221226021LL, 0xFFFFFFFFLL);
        goto LABEL_12;
      }
      v7 = v13[7];
      v8 = v12;
      ...
      if ( v5 )
        goto LABEL_8;
LABEL_11:
      sub_1409A2AF4(a1, v8, (unsigned int)v2);
LABEL_12:
      v10 = (_QWORD *)*v6;
      v11 = (void **)v6[1];
      ...
      *v11 = v10;
      ...
      {
        if ( v5 )
          sub_1409A2AF4(a1, v13, (unsigned int)v2);
        return;
      }
    }
    v5 = 1;
