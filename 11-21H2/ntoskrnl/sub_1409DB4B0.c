/*
 * XREFs of sub_1409DB4B0 @ 0x1409DB4B0
 * Callers:
...
NTSTATUS __fastcall sub_1409DB4B0(_DWORD *a1, unsigned int a2, ULONGLONG a3)
{
  ...
  v3 = 0;
  v21 = 0;
  v12.Ptr = (ULONGLONG)qword_140041D78;
  v13 = &v22;
  v16 = &v8;
  v19 = (int *)&v9;
  v12.Size = 16;
  ...
  return sub_14081549C((__int64)a1, &stru_140038BE8, 0LL, 3 * a2 + 4, &v12);
}
