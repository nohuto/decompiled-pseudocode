/*
 * XREFs of sub_1409CF5C8 @ 0x1409CF5C8
 * Callers:
...
__int64 __fastcall sub_1409CF5C8(HANDLE KeyHandle, int a2, unsigned int a3, __int64 a4, __int64 *a5)
{
  ULONG Length; // ebp
  ...
  if ( Pool2 )
  {
    v8 = ZwQueryValueKey(KeyHandle, &stru_140D3B628, KeyValuePartialInformation, Pool2, Length, &ResultLength);
    if ( v8 < 0 )
      goto LABEL_24;
    v9 = Pool2[2] != 0 ? Pool2[2] >> 2 : 0;
    v8 = ZwQueryValueKey(KeyHandle, &stru_140D3B2D0, KeyValuePartialInformation, Pool2, Length, &ResultLength);
    if ( v8 < 0 )
      goto LABEL_24;
    v10 = Pool2[2] + ((8 * v9 + 73) & 0xFFFFFFFE);
    v8 = ZwQueryValueKey(KeyHandle, &stru_140D3B678, KeyValuePartialInformation, Pool2, Length, &ResultLength);
    if ( v8 < 0 )
      goto LABEL_24;
    v11 = Pool2[2] + v10;
    ...
    {
      v24 = v11 + v12;
      v8 = ZwQueryValueKey(KeyHandle, &stru_140D3B638, KeyValuePartialInformation, Pool2, Length, &ResultLength);
      if ( v8 >= 0 )
      {
        if ( Pool2[2] == 4 )
        {
