/*
 * XREFs of sub_14051E1B8 @ 0x14051E1B8
 * Callers:
...
void __fastcall sub_14051E1B8(unsigned __int64 a1)
{
  ...
  v1 = 0LL;
  v2 = 0;
  if ( (_DWORD)dword_140C4AD10 )
  {
    v3 = (unsigned __int64 *)((char *)qword_140C4ACD8 + 16);
    while ( a1 <= v1 || a1 >= *(v3 - 1) )
    {
      v1 = *v3;
      ++v2;
      v3 += 3;
      if ( v2 >= (unsigned int)dword_140C4AD10 )
      {
        if ( (_DWORD)dword_140C4AD10
          && a1 > v1
          && (unsigned int)dword_140C04538 > 5
          && sub_1402A2000((__int64)&dword_140C04538, 0x400000000000LL) )
        {
          v13 = v5;
          v16 = &v13;
          v19 = &v12;
...
LABEL_11:
          ...
          v21 = 0;
          v24 = 0;
          sub_14020A9C4((__int64)&dword_140C04538, (unsigned __int8 *)v6, 0LL, 0LL, v10, &v15);
          return;
        }
        return;
      }
