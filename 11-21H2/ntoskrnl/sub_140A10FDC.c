/*
 * XREFs of sub_140A10FDC @ 0x140A10FDC
 * Callers:
...
__int64 __fastcall sub_140A10FDC(
        __int64 a1,
        wchar_t *a2,
        __int64 a3,
        __int64 a4,
        ...
        _DWORD *a9)
{
  ...
  *a9 = 0;
  ...
  if ( (int)sub_1402E0198(SourceString, 260LL, L"\\REGISTRY\\MACHINE\\%s", a1) < 0 )
  {
    sub_1406E0C3C(1LL, (__int64)"SdbpCheckMatchingRegistryEntry");
    goto LABEL_10;
  }
...
LABEL_9:
    v10 = sub_140A111BC(KeyHandle, a2, a5, a6, Buf1, Size, (__int64)a9);
  else
    v10 = 1;
LABEL_10:
  if ( KeyHandle )
