/*
 * XREFs of KiProcessNMI @ 0x14029B9A0
 * Callers:
...
/*
 * Hex-Rays decompilation failed for KiProcessNMI @ 0x14029B9A0
 ...
 * 000000014029B9CC: call    _guard_dispatch_icall
 * 000000014029B9D1: mov     rax, qword ptr cs:KiSpeculationFeatures
 ...
 * 000000014029B9E8: call    KiCheckForFreezeExecution
 ...
 * 000000014029BA18: call    KiFlushCurrentRsb
 * 000000014029BA1D: jmp     short loc_14029B9DF
 * 00000001404A3E50: mov     rax, gs:20h
 * 00000001404A3E59: lea     rcx, KiNmiInProgress; "  "
 ...
 * 00000001404A3E82: call    _guard_dispatch_icall
 * 00000001404A3E87: mov     rbx, cs:KiNmiCallbackListHead
 ...
 * 00000001404A3EA1: call    _guard_dispatch_icall
 ...
 * 00000001404A3EB6: lea     rcx, KiNMILock
 * 00000001404A3EBD: call    KxTryToAcquireSpinLock
 * 00000001404A3EC2: test    al, al
 * 00000001404A3EC4: jz      short loc_1404A3F04
 * 00000001404A3EC6: xor     eax, eax
 * 00000001404A3EC8: lock cmpxchg cs:KiBugCheckActive, r12d
 * 00000001404A3ED1: xor     ecx, ecx
 * 00000001404A3ED3: call    HalHandleNMI
 * 00000001404A3ED8: mov     eax, r12d
 * 00000001404A3EDB: lock cmpxchg cs:KiBugCheckActive, r15d
 * 00000001404A3EE4: lea     rcx, KiNMILock; SpinLock
 * 00000001404A3EEB: call    KxReleaseSpinLock
 * 00000001404A3EF0: mov     edx, esi
 * 00000001404A3EF2: lea     rcx, KiNmiInProgress; "  "
 ...
 * 00000001404A3F0A: call    KiCheckForFreezeExecution
 * 00000001404A3F0F: mov     rax, cs:KiNMILock
