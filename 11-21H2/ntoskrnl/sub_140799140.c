/*
 * XREFs of sub_140799140 @ 0x140799140
 * Callers:
 *     sub_140798F44 @ 0x140798F44 (sub_140798F44.c)
 * Callees:
 *     sub_1402E1E70 @ 0x1402E1E70 (sub_1402E1E70.c)
...
__int64 __fastcall sub_140799140(__int64 a1, __int64 a2, int a3, PVOID *a4)
{
  unsigned int v6; // ebx
  unsigned int v7; // esi
  unsigned int v8; // eax
  ...
  *a4 = 0LL;
  ...
  v8 = sub_1402E1E70((int *)(a2 + 96), a2, (unsigned int)RegionSize >> 12);
  v9 = v8;
  if ( v8 != -1 && (unsigned int)RtlInterlockedSetClearRun(a2 + 96, v8, v7) )
