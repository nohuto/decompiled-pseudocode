/*
 * XREFs of sub_14062B664 @ 0x14062B664
 * Callers:
...
__int64 __fastcall sub_14062B664(__int64 a1, unsigned __int64 a2, unsigned int a3, __int64 a4, int a5)
{
  __int64 v6; // rax
  char *v7; // rdi
  int v8; // ebp
    ...
    do
    {
      ...
      if ( (*v11 & 0x80000000000000LL) == 0 )
      {
        ...
        if ( v10 != v16 || (_DWORD)v9 == v8 )
        {
          if ( (_DWORD)v9 )
          {
            sub_140629A00(a1, v10, v9, v7, v19);
            v13 = *v11;
            LODWORD(v9) = 0;
          }
          v10 = v16;
