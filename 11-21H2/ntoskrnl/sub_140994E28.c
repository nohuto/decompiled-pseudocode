/*
 * XREFs of sub_140994E28 @ 0x140994E28
 * Callers:
...
NTSTATUS __fastcall sub_140994E28(__int64 a1, char a2)
{
  struct _IRP *v2; // rdi
  unsigned int v5; // r9d
  unsigned int v6; // r8d
...
LABEL_16:
  ...
  sub_140850D98(*(IRP **)(a1 + 56), 0x294064u, 0, v2, 0x14u, 0x10u);
  v15 = *(IRP **)(a1 + 56);
  if ( a2 )
  {
  ...
  else
  {
    ...
    CurrentStackLocation[-1].CompletionRoutine = (PIO_COMPLETION_ROUTINE)sub_1405D47C0;
