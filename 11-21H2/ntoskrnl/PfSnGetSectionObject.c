/*
 * XREFs of PfSnGetSectionObject @ 0x1407DF794
 * Callers:
 ...
 *     PfSnIsSectionPrefetchedAfterPhase @ 0x1407DFBA4 (PfSnIsSectionPrefetchedAfterPhase.c)
  ...
  if ( !_bittest64((const signed __int64 *)(v18 + 24), 0x22u) )
  {
    if ( (*(_DWORD *)(a2 + 108) & 1) == 0 )
    {
      ...
      *(_OWORD *)&v35.CancelRoutine = 0x100000003uLL;
      if ( !v19 )
        PfSnPrefetchFileMetadata(a1, *(_QWORD *)(a2 + 32), &v35.CancelRoutine, 0LL, 1, a8);
    }
    v20 = PfpOpenHandleCreate(
            ...
            *(_QWORD *)(a2 + 64),
            ...
            a2 + 32);
    if ( v20 < 0
      || (v20 = PfpFileCheckAttributesForPrefetch(v35.MdlAddress, (((dword_140C544F0 & 0x10) == 0) << 14) + 4864),
          v20 < 0) )
    {
    ...
    if ( *((_DWORD *)a1 + 30) < *((_DWORD *)a1 + 31)
      && (int)IopQueryXxxInformation(*(struct _FILE_OBJECT **)&v35.Flags, 6, 8u, 0, &v35, &v35.ThreadListEntry.Blink, 1) >= 0 )
    {
...
LABEL_36:
  if ( (Flink & 0x400000000LL) != 0 )
    PfpOpenHandleClose(&v35.MdlAddress, *((_QWORD *)a1 + 1));
