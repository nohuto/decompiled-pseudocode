/*
 * XREFs of MiRemovePendingBadPagesFromDump @ 0x14058E8F4
 * Callers:
        ...
        for ( i = 0; i < v10; ++i )
        {
          ...
          if ( v13 )
          {
            ...
            while ( 1 )
            {
              ...
              {
                if ( *v14 < 0 )
                  (*(void (__fastcall **)(__int64, __int64, __int64))(a1 + 8))(a1, v12, 1LL);
...
LABEL_28:
    ...
    else
    {
      ...
      while ( j )
      {
        v5 = j[3];
        if ( *(char *)(v5 + 35) < 0 )
          (*(void (__fastcall **)(__int64, unsigned __int64, __int64))(a1 + 8))(
            a1,
