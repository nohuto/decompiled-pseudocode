/*
 * XREFs of sub_1403886FC @ 0x1403886FC
 * Callers:
...
NTSTATUS __fastcall sub_1403886FC(
        __int64 a1,
        __int64 a2,
        __int64 a3,
        __int64 a4,
        ...
        char a53)
{
  ...
  v152 = 8LL;
  v154 = 8LL;
  return sub_1402D1760(qword_140C03820, (const EVENT_DESCRIPTOR *)qword_14000EDE8, 0LL, 0x33u, &v54);
}
