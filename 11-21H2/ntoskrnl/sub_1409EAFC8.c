/*
 * XREFs of sub_1409EAFC8 @ 0x1409EAFC8
 * Callers:
...
void __fastcall sub_1409EAFC8(__int64 a1, __int64 a2)
{
  __int64 v4; // rax
  unsigned int v5; // r8d
  __int64 v6; // rdx
  ...
  v7[3] = 0;
  v7[0] = *(_DWORD *)(a1 + 1088);
  v7[2] = sub_14066C174((struct _EX_RUNDOWN_REF *)a1, 0LL);
  v7[1] = *(_DWORD *)(a1 + 1668);
  v13 = *(_QWORD *)(a1 + 1176);
  v8 = *(_QWORD *)(a1 + 1168);
  ...
  v19 = v7;
  v20 = 104;
  sub_1402AB170((__int64)&v19, v6, v5, 1u, 0x321u, 0x401802u);
}
