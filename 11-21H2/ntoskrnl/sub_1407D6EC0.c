/*
 * XREFs of sub_1407D6EC0 @ 0x1407D6EC0
 * Callers:
...
char __fastcall sub_1407D6EC0(char a1, __int64 a2)
{
  int v4; // eax
  char v5; // r8
  REGHANDLE v6; // rbx
  ...
  {
    v6 = RegHandle;
    LOBYTE(v4) = EtwEventEnabled(RegHandle, &stru_140038690);
    if ( (_BYTE)v4 || (LOBYTE(v4) = EtwEventEnabled(v6, &stru_140037EA8), v5 = 0, (_BYTE)v4) )
      v5 = 1;
  }
  else
  {
    LOBYTE(v4) = EtwEventEnabled(RegHandle, &stru_140010E88);
    v5 = v4;
  }
  if ( byte_140C5AE14 && v5 )
  {
    ...
    *(_QWORD *)&UserData.Size = 4LL;
    ...
    if ( a1 )
    {
      if ( (*(_DWORD *)(a2 + 1124) & 0x1000) != 0 )
      {
        v33 = &v21;
        v34 = 4LL;
        LOBYTE(v4) = EtwWrite(RegHandle, &stru_140038690, 0LL, 5u, &UserData);
      }
      v17 = *(int **)(a2 + 2096);
      if ( !v17 || !*v17 )
        return v4;
    ...
    v34 = 4LL;
    LOBYTE(v4) = EtwWrite(RegHandle, v16, 0LL, 6u, &UserData);
  }
  return v4;
}
