/*
 * XREFs of PfpPrefetchFilesTrickle @ 0x1407E0408
 * Callers:
...
LABEL_9:
      ...
      if ( (int)PfpFileBuildReadSupport(a1, v7, v4, v9, (__int64)&v31) >= 0 )
      {
        ...
        *(_QWORD *)v31 = v32;
        v23 = *(_DWORD *)(v11 + 8);
        v36 = 0;
        MmQueryMemoryListInformation((ULONG_PTR **)0xFFFFFFFFFFFFFFFFLL, (_OWORD *)a1 + 3, 0xB0u, v10, &v25);
        if ( v23 )
        {
               ...
               && (unsigned __int64)(a1[6] + a1[7] + PfpGetPageListCount(a1 + 11, 0LL)) >= 0x80 )
          {
            ...
            *v16 |= (8 * (v38 & 7u)) | (unsigned __int64)(*(_DWORD *)(*a1 + 28LL) & 7);
            LODWORD(v16) = MmPrefetchPagesEx(1u, (__int64)&v29, 0LL);
