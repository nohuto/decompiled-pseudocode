/*
 * XREFs of ExpHpCompactionRoutine @ 0x140363EF0
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall ExpHpCompactionRoutine(int a1)
{
        ...
        do
        {
          ...
          if ( v8 )
          {
            ...
            while ( v10 )
            {
              ...
              v10 ^= 1LL << v18;
              v19 = RtlpInterlockedFlushSList((PSLIST_HEADER)&v8[8 * (unsigned int)v18 + 8]);
              if ( v9 )
              {
                while ( 1 )
                {
            ...
            while ( 1 )
            {
              ...
              if ( !v9 )
                break;
              v9 = (_QWORD *)*v9;
              HeapFromVA = ExGetHeapFromVA(v20);
              RtlpHpFreeHeap(HeapFromVA, v20, 0LL, v22, v23);
            }
            v5 = v3;
          }
          v11 = *(__int16 *)(v7 + 342);
  ...
  while ( v14 <= (int)v3 )
  {
    ...
    if ( *(_QWORD *)(result + v15 + 336) + *(_QWORD *)(result + v15 + 344) > v16 )
      result = RtlpHpHeapCompact(qword_140CE1A40[v14]);
    ++v14;
  }
  if ( !v2 )
  {
