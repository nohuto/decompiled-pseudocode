/*
 * XREFs of sub_140A36858 @ 0x140A36858
 * Callers:
 *     sub_1408303C0 @ 0x1408303C0 (sub_1408303C0.c)
 * Callees:
 *     sub_140A35350 @ 0x140A35350 (sub_140A35350.c)
 */

__int64 __fastcall sub_140A36858(__int64 a1, int a2)
{
  __int64 v3; // r10
  int v4; // ebp
  int v5; // r12d
  ...
  while ( 1 )
  {
    ...
    v15 = *(_QWORD *)(v3 + 24);
    v21 = -1;
    if ( (int)sub_140A35350(v15, v9, v10, &v21) < 0
      || (v16 = v21, v21 < 0)
