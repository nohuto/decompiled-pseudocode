/*
 * XREFs of sub_1409F352C @ 0x1409F352C
 * Callers:
...
__int64 __fastcall sub_1409F352C(ULONG_PTR BugCheckParameter2, __int64 a2, KPROCESSOR_MODE a3)
{
  PVOID v3; // r14
  int v6; // ebx
  void *v7; // r10
  ...
  if ( v9 >= 0 )
  {
    ...
    v17 = 0LL;
    v20 = v10;
    v6 = sub_1406F3FDC((__int64)Object, &BugCheckParameter1, &v20, &v17, 0LL, 0LL);
    if ( v6 < 0 )
      goto LABEL_19;
