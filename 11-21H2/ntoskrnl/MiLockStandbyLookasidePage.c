/*
 * XREFs of MiLockStandbyLookasidePage @ 0x14038E94C
 * Callers:
 ...
 *     MiPickStandbyLookasideIndex @ 0x14038EA8C (MiPickStandbyLookasideIndex.c)
 */
...
__int64 __fastcall MiLockStandbyLookasidePage(__int64 a1, unsigned __int8 *a2, unsigned int a3)
{
  ...
  v5 = 0;
  v6 = 0;
  v8 = MiPickStandbyLookasideIndex();
  while ( 1 )
  {
...
LABEL_12:
  ...
  if ( _interlockedbittestandset64((volatile signed __int32 *)(v13 + 24), 0x3FuLL) )
  {
    ...
    {
      do
        KeYieldProcessorEx(&v16, v7, v9, v10);
...
LABEL_11:
  ...
  if ( !(unsigned int)MiAcquirePageListLock(v11, 48 * v12 - 0x220000000000LL, v4, (__int64)a2) )
  {
    v10 = v15;
    if ( ++v5 == 8 )
      v4 = 1;
  ...
  MiReplaceStandbyLookaside(v12, -1LL, *a2);
  return v12;
}
