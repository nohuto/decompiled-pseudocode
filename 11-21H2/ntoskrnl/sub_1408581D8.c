/*
 * XREFs of sub_1408581D8 @ 0x1408581D8
 * Callers:
...
char __fastcall sub_1408581D8(int a1, int a2, int a3, int a4)
{
  _UNKNOWN **v4; // rax
  int v6; // r9d
  int v7; // r10d
  ...
  {
    LOBYTE(v4) = sub_1402A2000((__int64)&dword_140C043E0, 0x400000000000LL);
    if ( (_BYTE)v4 )
    {
      v27 = 0;
      v30 = 0;
      ...
      v32 = 4;
      v35 = 4;
      LOBYTE(v4) = sub_14020A9C4((__int64)&dword_140C043E0, (unsigned __int8 *)byte_140035271, 0LL, 0LL, 6u, &v24);
    }
  }
  if ( qword_140C16478 )
  {
    ...
    v19 = 4;
    v22 = 4;
    LOBYTE(v4) = EtwWrite(qword_140C16478, &stru_140012F60, 0LL, 4u, &UserData);
  }
  return (char)v4;
}
