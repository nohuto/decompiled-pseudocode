...
__int64 __fastcall sub_140A55DCC(__int64 a1, __int64 *a2)
{
  ...
  if ( *a2 )
  {
    result = sub_140A55FBC(a1, &v16, &v17);
    ...
    {
      sub_1403BF694(&v19, (_DWORD *)&v19 + 3, &v15, &v14);
      CurrentPrcb = KeGetCurrentPrcb();
      v7 = a2[67];
      v8 = *a2;
      v9 = *a2 | v7;
      v18 = v7;
      result = *((_QWORD *)CurrentPrcb + 4405);
      v20 = result;
      if ( v9 )
      {
        v10 = v16;
            ...
            if ( _bittest64(&result, v4) )
            {
              ...
              if ( (_DWORD)result )
              {
                ...
                do
                {
                  if ( *(_DWORD *)result == v4 )
                  {
                    v13 = sub_140A55F2C(v10, v11, CurrentPrcb, &v19);
                    v12 = v14;
                    if ( v13 )
