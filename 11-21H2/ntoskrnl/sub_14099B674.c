/*
 * XREFs of sub_14099B674 @ 0x14099B674
 * Callers:
...
char __fastcall sub_14099B674(__int64 *a1)
{
  _UNKNOWN **v1; // rax
  REGHANDLE v3; // rbx
  __int64 v4; // r8
  ...
  {
    v3 = qword_140C1F580;
    LOBYTE(v1) = EtwEventEnabled(qword_140C1F580, &stru_140037ED0);
    if ( (_BYTE)v1 )
    {
      v4 = a1[1];
      v5 = *a1;
      *(_QWORD *)&UserData.Size = 4LL;
      ...
      LOBYTE(v1) = EtwWrite(v3, &stru_140037ED0, 0LL, 0xFu, &UserData);
    }
  }
  return (char)v1;
}
