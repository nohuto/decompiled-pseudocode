...
void __fastcall sub_140914E64(_QWORD *a1, _DWORD *a2, __int64 a3)
{
  unsigned int v3; // ebx
  __int64 v4; // rbp
...
LABEL_7:
    ...
    {
      v14 = 0LL;
      sub_1407C0690((__int64)a1, &v14, a3);
      if ( v14 )
      {
        for ( i = *v10; i != v10; i = (_QWORD *)*i )
        {
          sub_140914F9C(v11, i - 4, v14, v4);
          ++*a2;
        }
        do
        {
