/*
 * XREFs of IopLiveDumpWriteDumpFile @ 0x14093D590
 * Callers:
 ...
 *     IopLiveDumpCheckTermination @ 0x14093C238 (IopLiveDumpCheckTermination.c)
...
__int64 __fastcall IopLiveDumpWriteDumpFile(__int64 a1)
{
  ...
  for ( i = CurrentThread; v7 < *(_QWORD *)(a1 + 736); ++v7 )
  {
    ...
    if ( SecureDumpHeader < 0 )
      goto LABEL_52;
    v10 = v7 >= *(_QWORD *)(a1 + 736) - 1LL ? *(_DWORD *)(a1 + 720) << 12 : BufferChunkSizeInBytes;
    SecureDumpHeader = IopLiveDumpWriteBuffer(
                         v3,
                         *(PVOID *)(*(_QWORD *)(a1 + 752) + 8 * v7),
                         v10,
                         &ByteOffset,
                         a1,
                         v2.QuadPart);
    ...
    else
    {
      ...
      if ( v13 )
      {
        ...
        if ( v7 >= v14 )
        {
          if ( v7 - v14 + 1 == v13 )
          {
            ...
            IopLiveDumpFreeIoSpaceRanges((PVOID *)(a1 + 824), *(_DWORD *)(a1 + 832));
      ...
      if ( v16 )
      {
        ...
        if ( v7 >= v17 )
        {
          if ( v7 - v17 + 1 == v16 )
          {
            ...
            IopLiveDumpFreeIoSpaceRanges((PVOID *)(a1 + 864), *(_DWORD *)(a1 + 872));
      ...
      MmFreeIndependentPages(*(_QWORD *)(*(_QWORD *)(a1 + 752) + 8 * v7), (unsigned int)BufferChunkSizeInBytes);
      v12 = *(_QWORD *)(a1 + 752);
    }
  ...
  if ( SecureDumpHeader >= 0 )
  {
    ...
    *(_QWORD *)(v1 + 8232) = v21;
    ...
    else
    {
      ...
      SecureDumpHeader = SecureDump_Get_SecureDumpHeader(v1, Pool2, *(_DWORD *)(a1 + 984));
      if ( SecureDumpHeader < 0 )
      {
LABEL_51:
    ...
    SecureDumpHeader = IopLiveDumpWriteBuffer(v3, (PVOID)v1, *(_DWORD *)(v1 + 8224), &ByteOffset, a1, v2.QuadPart);
    if ( *(_BYTE *)(a1 + 976) != LOBYTE(v2.LowPart) )
    {
      v29 = *(_DWORD *)(a1 + 984);
      ByteOffset = v2;
      SecureDumpHeader = IopLiveDumpWriteBuffer(v3, v5, v29, &ByteOffset, a1, 1);
    }
    if ( v5 )
      goto LABEL_51;
  }
