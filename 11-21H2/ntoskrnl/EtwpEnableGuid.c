/*
 * XREFs of EtwpEnableGuid @ 0x14079028C
 * Callers:
...
__int64 __fastcall EtwpEnableGuid(__int64 a1, __int64 a2, char a3)
{
  ...
  *(_WORD *)v78 = 0;
  ...
  v8 = 0LL;
  v93 = 0LL;
  updated = EtwpValidateEnableNotification(a1, a2, a3, (__int64)&v93, &v81, (__int64)v97);
  if ( updated < 0 )
    goto LABEL_125;
  ...
  if ( !*(_DWORD *)&v78[5] )
  {
    ...
    if ( !v75 )
    {
      v74 = v10;
      v13 = v81;
      updated = EtwpEnableMetaProviderGuid(v81, a2 + 40, v11, *(_QWORD *)(a2 + 88), (__int64)v100, v74);
...
LABEL_8:
  ...
  v15 = BYTE2(v94);
  v16 = &PrivateLoggerNotificationGuid;
  v17 = v76;
  v18 = BYTE2(v94) == 0;
  *(_DWORD *)(a2 + 36) = CurrentThreadProcessId;
  if ( v18 )
    v16 = (__int128 *)(a2 + 40);
  GuidEntryByGuid = EtwpFindGuidEntryByGuid(a1, v16, v17);
  if ( GuidEntryByGuid )
  {
    if ( v11 == 1 || (v7 = GuidEntryByGuid, !v11) )
    {
      v7 = GuidEntryByGuid;
      if ( v13 )
      {
        v27 = *(_QWORD *)&EventTracingProvGuid.Data1 - *(_QWORD *)(a2 + 40);
        if ( *(_QWORD *)&EventTracingProvGuid.Data1 == *(_QWORD *)(a2 + 40) )
          v27 = *(_QWORD *)EventTracingProvGuid.Data4 - *(_QWORD *)(a2 + 48);
        if ( !v27 )
        {
          v61 = (const EVENT_DESCRIPTOR *)ETW_EVENT_TRACING_PROVIDER_ENABLE_CHANGING;
          if ( v11 != 1 )
            v61 = &ETW_EVENT_TRACING_PROVIDER_DISABLING;
          if ( EtwEventEnabled(EtwpEventTracingProvRegHandle, v61) )
          {
            if ( v11 == 1 )
              ...
              EtwpEventWriteTemplateSessAndProv(&EventTracingProvGuid, v61, v62, 2LL, v13 + 136, &EventTracingProvGuid);
          }
        }
      }
    }
  ...
  else
  {
    ...
    v7 = EtwpAddGuidEntry(a1, a2 + 40, v17);
    if ( !v7 )
    {
      updated = -1073741801;
      goto LABEL_35;
  ...
  *(_QWORD *)(v7 + 416) = KeGetCurrentThread();
  ...
  if ( v22 )
  {
    updated = EtwpAcquireTokenAccessInformation(v81);
    if ( updated )
      goto LABEL_34;
  }
  v23 = BYTE2(v94);
  ...
  *(_DWORD *)(a2 + 108) = *(_DWORD *)(a2 + 88);
  ...
  if ( v11 != 2 && !v23 )
  {
    updated = EtwpUpdateGuidEnableInfo(v7, a2, v25, v97, v78);
    if ( updated < 0 )
    {
LABEL_34:
      *(_QWORD *)(v7 + 416) = 0LL;
    ...
    *(_OWORD *)(a2 + 88) = *(_OWORD *)(v7 + 112);
    if ( (*(_DWORD *)(a2 + 80) & 4) != 0 )
    {
      ...
      while ( v65 != v63 );
      if ( (v63 & 0x2000) == 0 )
        EtwpReferenceStackLookasideList(v64, 0x2000LL);
      v13 = v81;
    }
  }
  ...
  v30 = EtwpAllocDataBlock(v29, Src, &v79);
  v8 = v79;
  if ( v30 < 0 )
  {
    updated = -1073741801;
...
LABEL_85:
    ...
    if ( !v89 )
    {
      ...
      *(_DWORD *)(a2 + 20) = v45;
      ...
      {
        v46 = v87;
        v47 = (const EVENT_DESCRIPTOR *)ETW_EVENT_PROVIDER_ENABLED;
        if ( v87 != 1 )
          v47 = &ETW_EVENT_PROVIDER_DISABLED;
        if ( EtwEventEnabled(EtwpEventTracingProvRegHandle, v47) )
        {
          if ( v46 == 1 )
            EtwpEventWriteProviderEnabled(
              v48,
            ...
            EtwpEventWriteTemplateSessAndProv(a2 + 40, v47, v49, 2LL, v13 + 136, a2 + 40);
        }
      }
      goto LABEL_93;
    }
  ...
  while ( 1 )
  {
    ...
    v88 = (_QWORD *)*v37;
    if ( !(unsigned __int8)EtwpIsRegEntryAllowed(v38, v13, (unsigned int)&v93, a2, (__int64)v97, v75, v76) )
      goto LABEL_81;
    v82 = v28;
    if ( BYTE2(v94) )
      break;
    ...
    EtwpUpdateRegEntryEnableMask(v38, v13, v78[0], v76, v75, v34);
    v41 = EtwpCalculateUpdateNotification(v38, v78[0], v40, v83, v76, v39, v34, &v79);
    v8 = v79;
    if ( v41 )
    {
      if ( v79 )
...
LABEL_74:
        ...
        if ( (v42 & 8) != 0 || (v42 & 0x20) != 0 || (*(_DWORD *)(v13 + 816) & 0x2000000) != 0 )
        {
          if ( (v42 & 1) != 0 )
          {
            ...
            if ( (v42 & 0x10) == 0 )
              goto LABEL_123;
            SessionById = MmGetSessionById(*(_DWORD *)(v38 + 56));
            ...
            {
LABEL_123:
              EtwpProviderArrivalCallback(v13, 0, v38);
              if ( !v60 )
                goto LABEL_77;
              MmDetachSession((__int64)v60, (__int64)v98);
            }
            ObfDereferenceObject(v60);
          }
          else if ( ExAcquireRundownProtection((PEX_RUNDOWN_REF)(*(_QWORD *)(v38 + 80) + 1112LL)) )
          {
            v51 = *(_QWORD *)(v38 + 80);
            memset(v99, 0, sizeof(v99));
            ProcessServerSilo = (struct _LIST_ENTRY *)PsGetProcessServerSilo(v51);
            v53 = PsAttachSiloToCurrentThread(ProcessServerSilo);
            KiStackAttachProcess(*(_KPROCESS **)(v38 + 80), 0LL, (__int64)v99, v54);
            EtwpProviderArrivalCallback(v13, 1, v38);
            KiUnstackDetachProcess((__int64)v99, 0LL);
            PsDetachSiloFromCurrentThread(v53);
            ExReleaseRundownProtection((PEX_RUNDOWN_REF)(*(_QWORD *)(v38 + 80) + 1112LL));
          }
        }
      }
LABEL_77:
      v43 = v82;
LABEL_78:
      if ( (int)EtwpSendDataBlock(v38, v43) >= 0 && (*(_BYTE *)(v38 + 98) & 2) != 0 )
        ++v84;
      goto LABEL_81;
    }
    if ( !v79 )
...
LABEL_81:
  ...
  if ( (unsigned int)EtwpDemuxPrivateTraceHandle(ProcessId, *(_WORD *)(a2 + 78) & 0x7FFF, &v80) )
    goto LABEL_81;
  v69 = v80;
  if ( v80 == *((_WORD *)v8 + 39) )
  {
LABEL_156:
  ...
  if ( (int)EtwpAllocDataBlock(*v95, Src, &v79) >= 0 )
  {
    EtwpUnreferenceDataBlock(v85);
    v8 = v79;
    v85 = v79;
...
LABEL_35:
  if ( v13 )
    EtwpReleaseLoggerContext(v13, 0LL);
  if ( Object )
    ObfDereferenceObject(Object);
  if ( v7 )
    EtwpUnreferenceGuidEntry((PVOID)v7);
  EtwpFreeFilterInfo((__int64)v97);
