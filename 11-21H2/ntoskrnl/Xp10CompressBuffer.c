/*
 * XREFs of Xp10CompressBuffer @ 0x1409C2624
 * Callers:
 *     RtlCompressBufferXp10 @ 0x1409C0E20 (RtlCompressBufferXp10.c)
 * Callees:
 *     memset @ 0x140435E00 (memset.c)
 *     Xp10ComputeAndWriteCrc @ 0x1409C29AC (Xp10ComputeAndWriteCrc.c)
 *     Xp10ExecuteHuffmanEncode @ 0x1409C3320 (Xp10ExecuteHuffmanEncode.c)
 *     Xp10ExecuteLz77PassMinMatchLen3 @ 0x1409C37DC (Xp10ExecuteLz77PassMinMatchLen3.c)
 *     Xp10ExecuteLz77PassMinMatchLen4 @ 0x1409C3F20 (Xp10ExecuteLz77PassMinMatchLen4.c)
 *     Xp10ValidateParametersAndFillFrameHeader @ 0x1409C5400 (Xp10ValidateParametersAndFillFrameHeader.c)
 */
...
LABEL_12:
    ...
    *(_QWORD *)&v49 = a2;
    HIDWORD(v49) = v13;
    result = Xp10ComputeAndWriteCrc(a1, &v49, &v48, v36);
    if ( (int)result >= 0 )
    {
      *a6 = DWORD2(v48) >> 3;
