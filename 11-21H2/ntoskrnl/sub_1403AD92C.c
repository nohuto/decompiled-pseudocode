/*
 * XREFs of sub_1403AD92C @ 0x1403AD92C
 * Callers:
...
char __fastcall sub_1403AD92C(__int64 a1)
{
  __int64 v1; // r13
  __int64 v2; // r10
  _QWORD *v3; // rdi
    ...
    if ( i )
    {
      ...
      do
      {
        ...
        if ( v15 != *(_BYTE *)v2 && (v15 || (*((_BYTE *)v12 + 105) & 2) == 0) )
        {
          ...
          if ( v18 >= 0 )
          {
            if ( (unsigned int)sub_140354968(v17, v18, v16) )
              *v24 = 0LL;
            v25 = v12[7];
            if ( v25 != -1LL && (unsigned int)sub_140354968(v25, *(_QWORD *)(v2 + 24), v12 + 7) )
              *v26 = 0LL;
          }
          else
          {
...
LABEL_5:
  ...
  while ( v4 < (__int64)&qword_140C2B938 );
  v7 = 0;
  if ( v3 != v27 )
  {
    do
    {
      v8 = (__int64)(v3 - 3);
      v3 = (_QWORD *)*v3;
      sub_1402F332C(v8, 1, (__int64)&v29);
      if ( v29 )
        v7 = 1;
    }
    while ( v3 != v27 );
