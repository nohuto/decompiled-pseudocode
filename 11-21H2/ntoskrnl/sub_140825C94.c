/*
 * XREFs of sub_140825C94 @ 0x140825C94
 * Callers:
 *     KseRegisterShimEx @ 0x140825A70 (KseRegisterShimEx.c)
 * Callees:
 *     sub_140825D48 @ 0x140825D48 (sub_140825D48.c)
 */

__int64 __fastcall sub_140825C94(__int64 a1, __int64 a2, __int64 a3)
{
  __int64 v4; // r10
  __int64 v5; // rax
  __int64 v6; // r9
  ...
  if ( !a3 )
    return 0LL;
  if ( (int)sub_140825D48(a1, a2, &v13, &v12) < 0 )
    return 0LL;
  v4 = *(_QWORD *)(a3 + 48);
  v5 = v4;
  if ( !v4 )
