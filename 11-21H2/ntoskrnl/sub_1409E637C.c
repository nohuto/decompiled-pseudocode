/*
 * XREFs of sub_1409E637C @ 0x1409E637C
 * Callers:
...
BOOLEAN sub_1409E637C(__int64 a1, char a2, ...)
{
  BOOLEAN result; // al
  __int64 v5; // rcx
  __int64 v6; // rsi
  ...
  result = EtwProviderEnabled(qword_140C15E00, 0, 0xF00uLL);
  if ( result )
  {
    v5 = 0LL;
    ...
    if ( v6 == a1 )
      v5 = 8LL;
    v7 = *(const EVENT_DESCRIPTOR **)((char *)off_14000AC28 + (a2 != 0 ? 0 : 0x10) + v5);
    result = EtwEventEnabled(qword_140C15E00, v7);
    if ( result )
    {
      v8 = sub_1402EDEB4(UserData, v6, &v19);
      v9 = sub_1402EDFB0((__int64)&UserData[v8], (__int64)KeGetCurrentThread());
      v11 = sub_1402EDEB4(&UserData[v9 + v10].Ptr, a1, &v20);
      v13 = v11 + v12;
      v14 = v13;
