/*
 * XREFs of sub_14096BC08 @ 0x14096BC08
 * Callers:
 *     sub_140708DA8 @ 0x140708DA8 (sub_140708DA8.c)
 * Callees:
 *     memcmp @ 0x1403E1D90 (memcmp.c)
 *     sub_14096BB54 @ 0x14096BB54 (sub_14096BB54.c)
 */

__int64 __fastcall sub_14096BC08(__int64 a1, __int64 a2, unsigned __int64 a3)
{
  char v6; // al
  char v8; // cl
  int v9; // ecx
  ...
  if ( !(unsigned int)sub_14096BB54((unsigned __int16 *)a1, a3) )
  {
    v6 = *(_BYTE *)(a1 + 54);
