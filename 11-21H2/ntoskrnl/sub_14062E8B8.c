/*
 * XREFs of sub_14062E8B8 @ 0x14062E8B8
 * Callers:
...
void __fastcall sub_14062E8B8(__int64 a1, char a2, char a3, char a4, char *a5)
{
  int v5; // r10d
  char v6; // al
  char v7; // al
  ...
  v15 = &v8;
  v16 = 16;
  sub_14035EDE4((__int64)&v15, 1u, 0xA0000020, 0xF73u, 0x400A02u);
}
