/*
 * XREFs of sub_1405CD4FC @ 0x1405CD4FC
 * Callers:
...
_BYTE *__fastcall sub_1405CD4FC(__int64 a1, __int64 a2, unsigned int a3, char a4, _QWORD *a5, _BYTE *a6)
{
  __int64 v7; // rax
  __int64 v8; // rbx
  __int64 v9; // rax
  ...
  *(_QWORD *)v12 = 0LL;
  ...
  {
    sub_1405CEBEC(a1, *(unsigned int *)(a2 + 16), &v11);
