/*
 * XREFs of sub_140836228 @ 0x140836228
 * Callers:
...
char __fastcall sub_140836228(__int16 a1)
{
  ULONG v2; // edi
  char v3; // bl
  ULONG i; // edx
  ...
  v12[2] = L"TZI";
  v12[3] = &Buf2;
  if ( (int)sub_14077FDA0(3, L"Time Zones", 0, &KeyHandle) < 0 )
    return 0;
  v2 = 0;
  v3 = 1;
    ...
    if ( ZwOpenKey(&Handle, 0x2000000u, &ObjectAttributes_8) >= 0 )
    {
      ...
      *(_OWORD *)&ObjectAttributes_8.SecurityDescriptor = 0LL;
      if ( ZwOpenKey((PHANDLE)&DestinationString, 0x20019u, &ObjectAttributes_8) >= 0 )
      {
        ...
        v15 = 0LL;
        v16 = 0;
        if ( (int)sub_140781F40(0x40000000, (const WCHAR *)Handle, (__int64)v12, 0LL) >= 0
          && (int)sub_1403C7B58(Buf1, DestinationString, a1) >= 0 )
        {
