/*
 * XREFs of sub_1409A7B30 @ 0x1409A7B30
 * Callers:
...
char __fastcall sub_1409A7B30(int a1, int a2, int a3, int a4, const WCHAR *a5)
{
  _UNKNOWN **v5; // rax
  ...
  if ( (unsigned int)dword_140D3B908 > 5 )
  {
    ...
    if ( (_BYTE)v5 )
    {
      ...
      v15 = a3;
      v16 = a4;
      sub_1402A2094((__int64)v33, a5);
      LOBYTE(v5) = sub_14020A9C4((__int64)&dword_140D3B908, (unsigned __int8 *)&word_140033396, 0LL, 0LL, 8u, &v17);
    }
  }
  return (char)v5;
}
