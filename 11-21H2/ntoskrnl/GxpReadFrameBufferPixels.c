/*
 * XREFs of GxpReadFrameBufferPixels @ 0x140AABFF8
 * Callers:
...
__int64 __fastcall GxpReadFrameBufferPixels(__int64 a1, unsigned int *a2)
{
  ...
  if ( (dword_140C0DF90 & 2) == 0 )
    return 3221225473LL;
  result = GxpAdjustRectangleToFrameBuffer((unsigned int *)a1, v3, (__int64)&v21, (unsigned int *)&v23, &v19, 0);
  if ( (int)result >= 0 )
  {
...
LABEL_31:
      ...
      {
        v16 = (char *)qword_140C0DF40 + v5 * (*v3 + v22 * v3[1]);
        if ( v15 )
        {
          v17 = v5 * *(_DWORD *)(a1 + 4);
          v18 = v5 * v22;
    ...
    else
    {
      ...
      v29[1] = *(_DWORD *)(a1 + 4);
      v29[3] = *(_DWORD *)(a1 + 12);
      v29[2] = xmmword_140C0DF30;
      v30 = *(_QWORD *)(a1 + 24);
      if ( qword_140C0DF40 )
      {
        LOBYTE(v12) = 1;
        RotatedPixelOffset = ((__int64 (__fastcall *)(_DWORD *, unsigned int *, __int64))qword_140C0DF40)(v29, v3, v12);
      }
      else
      {
