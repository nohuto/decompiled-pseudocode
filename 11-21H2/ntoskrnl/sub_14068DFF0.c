/*
 * XREFs of sub_14068DFF0 @ 0x14068DFF0
 * Callers:
...
__int64 __fastcall sub_14068DFF0(ULONG_PTR a1, _QWORD *a2, __int64 a3, __int64 a4)
{
  __int64 v4; // rbx
  ULONG_PTR v8; // rcx
  __int64 v9; // r8
  ...
  LODWORD(v18) = 0;
  v4 = a3;
  v10 = sub_14020B57C(a1, *(void ***)(a1 + 24), (void *)(a2[7] + a3 - a2[3]), a4 - a3, 8u, (ULONG *)&v18);
  if ( v10 >= 0 )
  {
    v11 = v4;
    if ( v4 >= a4 )
    ...
    else
    {
      while ( 1 )
      {
        ...
        {
          LOBYTE(v9) = 1;
          v10 = sub_14068E100(a2[7] + v11 - v12, 4096LL, v9);
          if ( v10 < 0 )
            break;
        }
        v11 += 4096LL;
        if ( v11 >= a4 )
        {
          while ( v4 < a4 )
          {
            ...
            *((_BYTE *)a2 + v14 + 72) = v13;
            if ( (v13 & 0x10) != 0 )
            {
              sub_14020B600(v8, *(void ***)(a1 + 24), v15, 0x1000uLL);
      ...
      do
      {
        ...
        if ( (*((_BYTE *)a2 + ((v4 - v17) >> 12) + 72) & 6) == 0 )
          sub_14020B57C(v17, *(void ***)(a1 + 24), (void *)(a2[7] + v4 - v17), 0x1000uLL, 0x80000002, (ULONG *)&v18);
        v4 += 4096LL;
      }
      while ( v4 < a4 );
    }
