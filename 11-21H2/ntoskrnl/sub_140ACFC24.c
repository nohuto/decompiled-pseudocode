  ...
  if ( a3 != 3 )
  {
    ...
    if ( v6 )
    {
      ...
      v10 += ((((unsigned int)(((v14 ^ v13) * (unsigned __int128)0x7010008004002001uLL) >> 64) ^ (67117057
           ...
           + 4096;
      v114 = v10 + a2;
      v15 = (_QWORD *)(*((__int64 (__fastcall **)(__int64, __int64))v4 + 66))(v114 + 8, 0xFFFFFFFFLL);
      if ( !v15 )
        goto LABEL_11;
      if ( !(*((unsigned __int8 (__fastcall **)(_QWORD *, _QWORD, __int64))v4 + 68))(
              ...
              64LL) )
      {
        (*((void (__fastcall **)(_QWORD *, __int64))v4 + 67))(v15, v114);
        goto LABEL_11;
      }
      *v15 = v114 + 8;
      v16 = (__int64)(v15 + 1);
    ...
    {
      v16 = (*((__int64 (__fastcall **)(unsigned __int64, _QWORD, _QWORD))v4 + 29))(
    ...
    if ( v16 )
    {
      ...
      if ( v34 )
      {
        ...
        *(_QWORD *)(v34 + 1936) = v16;
        if ( (v39 & 0x10000000) == 0 )
          *(_DWORD *)(v34 + 2392) = v39 | 0x20000000;
...
LABEL_11:
  ...
  *(_QWORD *)&v45 = __rdtsc();
  ...
  v51 = (*((__int64 (__fastcall **)(__int64, _QWORD, __int64))v4 + 29))(66LL, (unsigned int)(v49 + 32), v47);
  v102 = v51;
  if ( !v51 )
  {
    ++v4[632];
LABEL_85:
  ...
  *(_QWORD *)(v108 + 24) = v102;
  ...
  if ( (v73 & 0x1000000) != 0 )
    ...
    v4[598] = v73 | 0x1000000;
  v109 = a2 + v115;
  v74 = (*((__int64 (__fastcall **)(_QWORD, __int64, _QWORD, __int64, int, int))v4 + 103))(0LL, -1LL, 0LL, v109, 1, v72);
  v103 = v74;
  if ( !v74
    || (*v68 = v74, (v75 = (*((__int64 (__fastcall **)(__int64, _QWORD))v4 + 104))(v109, v112)) == 0)
    || (v68[1] = v75,
        v104 = (*((__int64 (__fastcall **)(__int64, _QWORD, __int64, __int64))v4 + 105))(v75, v112, v103, 1LL),
  ...
  if ( v104 + v106 )
  {
    ...
    v100 = *(_DWORD *)(v95 + 2392);
    *(_DWORD *)(v95 + 1964) = v87;
    *(_QWORD *)(v95 + 1936) = v68;
    *(_DWORD *)(v95 + 2284) = 3;
    if ( (v100 & 0x10000000) == 0 )
      *(_DWORD *)(v95 + 2392) = v100 | 0x20000000;
    return v95;
  }
  return 0LL;
}
