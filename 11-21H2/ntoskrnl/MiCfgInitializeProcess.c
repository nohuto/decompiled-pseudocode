/*
 * XREFs of MiCfgInitializeProcess @ 0x140755A24
 * Callers:
...
__int64 __fastcall MiCfgInitializeProcess(__int64 a1)
{
  ...
  v10 = 0x20000000000LL;
  result = MiMapSecurePureReserveView(a1, qword_140C4F3D8, (int)&v9, &v10);
  v3 = result;
  if ( (int)result >= 0 )
  {
    CurrentThread = KeGetCurrentThread();
    MiReferenceCfgVad(CurrentThread, v9, 0LL);
    if ( !*(_QWORD *)(a1 + 1408) )
      return v3;
    v6 = *(_WORD *)(a1 + 2412);
    if ( v6 != 332 && v6 != 452 )
    ...
    v7 = *(_QWORD *)(a1 + 1496);
    v8 = 0LL;
    if ( v6 == MiWowSubsystems6432 )
      v8 = qword_140C4F370[0];
    v9 = 0LL;
    v10 = (2 * (v7 >> 4)) >> 3;
    result = MiMapSecurePureReserveView(a1, v8, (int)&v9, &v10);
    v3 = result;
    if ( (int)result >= 0 )
    {
      MiReferenceCfgVad(CurrentThread, v9, 1LL);
      return v3;
    }
  }
  return result;
