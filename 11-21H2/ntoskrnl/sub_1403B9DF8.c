/*
 * XREFs of sub_1403B9DF8 @ 0x1403B9DF8
 * Callers:
 ...
 *     sub_1405DE430 @ 0x1405DE430 (sub_1405DE430.c)
 */

void __fastcall sub_1403B9DF8(__int64 a1)
{
  __int64 v1; // rdx
  bool v2; // zf
  __int64 v3; // rax
  ...
  if ( (unsigned int)dword_140C03A00 > 5 )
  {
    ...
    v30[0] = v4;
    v27 = 2;
    sub_14024A9B0((__int64)&dword_140C03A00, (unsigned __int8 *)&byte_140032521, 2LL, 1u, v8, v9, 8u, &v13);
  }
}
