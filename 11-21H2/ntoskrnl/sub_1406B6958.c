/*
 * XREFs of sub_1406B6958 @ 0x1406B6958
 * Callers:
...
__int64 __fastcall sub_1406B6958(_QWORD *a1, __int64 *a2)
{
  void *v2; // rax
  ...
  if ( v35 >= 0 )
  {
    ...
    if ( !v15 )
      v16 = v14 + 920;
    v17 = v16;
    v18 = (char *)Allocate(PagedPool, v16, 0x20204D43u, v3);
    v19 = v18;
    if ( v18 )
    {
      memset(v18, 0, v17);
