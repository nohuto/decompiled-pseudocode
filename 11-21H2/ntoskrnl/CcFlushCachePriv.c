/*
 * XREFs of CcFlushCachePriv @ 0x140283030
 * Callers:
 ...
 *     CcUpdateLazyWriterPerf @ 0x140539D54 (CcUpdateLazyWriterPerf.c)
...
void __fastcall CcFlushCachePriv(__int64 a1, void *a2, unsigned int a3, signed __int64 *a4, char a5, int *a6)
{
  char v6; // si
  char v7; // r12
  int v8; // r15d
  ...
  *((_QWORD *)v10 + 1) = 0LL;
  ...
  v94.LockQueue.Lock = (unsigned __int64 *volatile)(v87 + 704);
  KxAcquireQueuedSpinLock(&v94);
  v15 = *(_DWORD *)(v13 + 152);
  v6 = 1;
  v88 = (signed __int64 *)v12;
  if ( (v15 & 0x2000) != 0 )
...
LABEL_33:
  ...
  if ( v13 )
  {
    if ( v110 == &CcFlushForImageSection
      && (*(_DWORD *)(v13 + 516) >= 2u || !(unsigned __int8)CcSerializeWithLazyWriter(v87, v13, v16, v17)) )
    {
      --*(_DWORD *)(v13 + 516);
      KeReleaseInStackQueuedSpinLockFromDpcLevel(&v94);
      KeReleaseInStackQueuedSpinLock(&LockHandle);
  ...
  if ( (xmmword_140D06910 & 0x20000) != 0 )
    CcPerfLogFlushCache(v93, v13, (_DWORD)v88, a3, v80, v86, v8 == 1);
  if ( !v80 )
  {
    if ( !v13 )
      goto LABEL_66;
    if ( (*(_DWORD *)(v13 + 152) & 0x20) != 0 )
      CcBoostLowPriorityWorkerThread(v87, v13);
LABEL_59:
...
LABEL_66:
  if ( (xmmword_140D06910 & 0x20000) != 0 )
    CcPerfLogFlushSection(v93, v13, (_DWORD)v88, a3, v81);
  if ( v13 )
    CcUnmapVacbArray(v13, (_DWORD)v88, a3, 0, 0, 0);
  v20 = v92;
  v24 = MmFlushSection(a1, (_DWORD)v88, a3, v22, (__int64)v92, v81);
  if ( v24 < 0 )
  {
    v25 = *v92;
    if ( v80 )
...
LABEL_217:
  ...
  if ( CcEnablePerVolumeLazyWriter == 1 && v23 && !v7 && (*(_DWORD *)(v13 + 152) & 0x40000200) == 0 )
  ...
  while ( 1 )
  {
    ...
    if ( !v77 )
      v34 = 0LL;
    if ( v32 && CcAmILowPriorityWriter(v13) )
    {
      v36 = 1;
    }
    else
...
LABEL_123:
    ...
    while ( 1 )
    {
      VirtualAddressIfMapped = CcGetVirtualAddressIfMapped(v13, v39 + v40 - v42, &v104, &v84);
      if ( VirtualAddressIfMapped )
      {
        ...
        if ( v84 > v42 )
          v45 = v42;
        v84 = v45;
        if ( !(unsigned __int8)MmSetAddressRangeModifiedEx(VirtualAddressIfMapped, v45) && !v35
    ...
    if ( (xmmword_140D06910 & 0x20000) != 0 )
      CcPerfLogFlushSection(v93, v13, (unsigned int)&v89, v78, v81);
    v50 = v92;
    v51 = v78;
    v75 = v81;
    ...
    *v92 = v52;
    v53 = MmFlushSection(a1, (unsigned int)&v89, v51, v44, (__int64)BugCheckParameter4a, v75);
    if ( v53 < 0 )
    {
      v54 = *v50;
      if ( !v32 )
...
LABEL_159:
    ...
    if ( *v50 < 0 )
    {
      ...
      v58 = v78;
      v98 = v89;
      if ( !CcIsFatalWriteError(v13, v55) )
      {
        v85 = 1;
        goto LABEL_191;
      }
      ...
      {
        if ( (xmmword_140D06910 & 0x20000) != 0 )
          CcPerfLogFlushSection(v93, v13, (unsigned int)&v98, 4096, v81);
        v76 = v81;
        *v50 = v52;
        v61 = MmFlushSection(a1, (unsigned int)&v98, 4096, v59, (__int64)v50, v76);
        if ( v61 < 0 )
        {
          v62 = *v50;
          if ( !v32 )
...
LABEL_176:
        if ( *v50 < 0 )
        {
          if ( !CcIsFatalWriteError(v13, *v50) )
          {
            v63 = 1;
            v85 = 1;
            if ( !v60 )
...
LABEL_192:
    ...
    CcReleaseByteRangeFromWrite(v13, &v89, v78, v105, BugCheckParameter4);
    v30 = v102;
    v66 = v78 + v100;
    v28 = v87;
    v91 += v78;
    ...
    {
      CcPostDeferredWrites(v87, v90);
      v66 = v100;
      v91 = 0;
    }
    if ( v32 && !v86 )
    {
      v67 = (_QWORD *)*v30 == v30 ? CcIdleDelayTick / 0xAu : (unsigned int)CcIdleDelayTick;
...
LABEL_209:
  ...
  if ( v91 && (_QWORD *)*v30 != v30 )
    CcPostDeferredWrites(v28, v90);
  v20 = v92;
  v23 = v80;
LABEL_219:
  if ( v96.QuadPart )
    CcUpdateLazyWriterPerf(v70, &PerformanceCounter, &v96, v27);
  if ( v13 )
  {
    KeAcquireInStackQueuedSpinLock((PKSPIN_LOCK)(v87 + 704), &v94);
    CcDecrementOpenCount(v13, v71, v72);
    if ( !v23 )
      --*(_DWORD *)(v13 + 516);
    if ( v110 == &CcFlushForImageSection && *v20 >= 0 && v83 >= 0 && (*(_DWORD *)(v13 + 112) || *(_DWORD *)(v13 + 516)) )
      v83 = -1073741740;
    KeReleaseInStackQueuedSpinLock(&v94);
  }
  v21 = v83;
