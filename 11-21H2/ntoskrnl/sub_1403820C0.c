/*
 * XREFs of sub_1403820C0 @ 0x1403820C0
 * Callers:
...
_DWORD *__fastcall sub_1403820C0(__int64 a1, __int64 a2)
{
  unsigned int v2; // edi
  _DWORD *v3; // r14
  __int64 v6; // rdx
  ...
  while ( 1 )
  {
    ...
    if ( *v8 != -1 )
      break;
    v2 = v8[1];
    sub_1403812B0(a1, (__int64)v8);
    sub_14037EC9C(v3, (unsigned __int64)v8);
    --*(_DWORD *)(a1 + 1896);
  }
  if ( *(_DWORD *)(a2 + 4) != v2 )
    *(_DWORD *)(a2 + 4) = v2;
