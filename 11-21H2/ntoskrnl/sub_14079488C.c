/*
 * XREFs of sub_14079488C @ 0x14079488C
 * Callers:
...
void __fastcall sub_14079488C(__int64 a1, char a2, char a3, char a4, _BYTE *a5)
{
  _DWORD *v5; // rbx
  unsigned int i; // ebp
  __int64 v10; // rdx
  ...
  for ( i = 0; i < 8; ++i )
  {
    if ( *(v5 - 2) && (!a3 || (*v5 & 0x400) != 0) )
    {
      ...
      {
        v12 = sub_140797594(*(_QWORD *)(a1 + 392), v10, 0LL);
