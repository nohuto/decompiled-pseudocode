/*
 * XREFs of _RegRtlCopyTreeInternal @ 0x140A2D248
 * Callers:
        ...
        char a7)
{
  ...
  v14 = RegRtlOpenKeyTransacted(a1, a2, 8u, 0x20019u, &KeyHandle, v33);
  if ( v14 >= 0 )
  {
    ...
    if ( v14 >= 0 )
    {
      ...
      if ( (unsigned int)RegRtlQueryInfoKey(KeyHandle, 0LL, &Index, 0LL, &i, &v26) )
      {
        LODWORD(v16) = 0;
        LODWORD(v17) = 0;
        goto LABEL_34;
...
LABEL_35:
        for ( i = v18; ; v18 = i )
        {
          ...
          v20 = RegRtlEnumKey(KeyHandle, v18, (char *)v10, &Index);
          if ( v20 == -2147483622 )
            break;
          if ( v20 != -1073741789 )
          {
            if ( !v20 )
            {
              *((_WORD *)v10 + ((unsigned __int64)(unsigned int)v16 >> 1) - 1) = 0;
              v20 = RegRtlCopyTreeInternal((_DWORD)KeyHandle, (_DWORD)v10, (_DWORD)Handle, (_DWORD)v10, a5, v33, a7);
...
LABEL_68:
        ...
        if ( v14 >= 0 )
        {
          ...
          while ( 1 )
          {
            i = v19;
            v26 = v17;
            v23 = RegRtlEnumValue(KeyHandle, v21, v10, &i, &v30, v11, &v26);
            if ( v23 == -2147483622 )
              break;
            if ( v23 == -1073741789 )
            {
            ...
            else
            {
              if ( v23
                || (v22 = v30,
                    *((_WORD *)v10 + ((unsigned __int64)(unsigned int)v16 >> 1) - 1) = 0,
                    (v23 = RegRtlSetValue(Handle, (const WCHAR *)v10, v22, v11, v26)) != 0) )
              {
                v14 = v23;
                break;
              }
