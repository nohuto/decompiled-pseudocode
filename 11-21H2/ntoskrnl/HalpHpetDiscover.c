/*
 * XREFs of HalpHpetDiscover @ 0x1403BD8C8
 * Callers:
...
__int64 HalpHpetDiscover()
{
  ...
  unsigned int *v27; // [rsp+D0h] [rbp-38h]
  ...
  if ( AcpiTable )
  {
    if ( !*(_BYTE *)(AcpiTable + 40) && (int)HalSocRequestConfigurationData(1, v1, (char *)&v23 + 1) >= 0 )
    {
      HalpHpetPhysicalAddress = *(LARGE_INTEGER *)(v2 + 44);
      if ( !HalpHpetPhysicalAddress.HighPart || BYTE1(v23) )
      {
        v27 = (unsigned int *)HalMapIoSpace(HalpHpetPhysicalAddress, 0x400uLL, MmNonCached);
        v3 = v27;
        if ( v27 )
        {
              ...
              if ( v5 != 0xFFFF )
              {
                ...
                if ( v5 != 4318 )
                {
                  ...
                  while ( 1 )
                  {
                    ...
                    v25[1] = HalpHpetInitialize;
                    v25[3] = HalpHpetAcknowledgeInterrupt;
                    v25[4] = HalpHpetArmTimer;
                    v25[5] = HalpHpetStop;
                    memset((char *)v29 + 4, 0, 20);
                    HIDWORD(v25[17]) = (v11 + 1) | (*(unsigned __int8 *)(v2 + 52) << 16);
                    *((LARGE_INTEGER *)&v29[1] + 1) = HalpHpetPhysicalAddress;
                    v25[13] = v12;
                    ...
                    *v13 = v15;
                    ...
                    {
                      v17 = HalSocRequestConfigurationData(2, v14, (char *)&v23);
                      v18 = v23;
                      if ( v17 < 0 )
                        v18 = 0;
                      LOBYTE(v23) = v18;
...
LABEL_25:
                    ...
                    else
                    {
                      ...
                      if ( v20 )
                      {
                        ...
                        HIDWORD(v25[15]) = v21 + (unsigned __int16)HalpHpetGsiOffset;
                        v7 |= 1 << v21;
                        BYTE4(v29[0]) = v21;
                        goto LABEL_33;
                      }
