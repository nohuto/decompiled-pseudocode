/*
 * XREFs of sub_14066C850 @ 0x14066C850
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall sub_14066C850(HANDLE Handle, unsigned int a2, volatile void *a3, SIZE_T a4, unsigned __int64 *a5)
{
  ...
  if ( a4 < v11 )
    return 3221225476LL;
  Object = 0LL;
  SectionInformation = ObReferenceObjectByHandle(Handle, 1u, MmSectionObjectType, v9, &Object, 0LL);
