/*
 * XREFs of sub_1406AF268 @ 0x1406AF268
 * Callers:
...
__int64 __fastcall sub_1406AF268(__int64 a1, __int64 a2, unsigned int *a3, int a4)
{
  unsigned int v6; // r8d
  unsigned int v9; // edx
  ...
  if ( v6 > *(_DWORD *)(a2 + 32) )
    return 22000LL;
  if ( !(unsigned __int8)sub_1406AF62C((int)a2 + 24, v9, 16 * v6, 8, 0) )
    return 23000LL;
  v11 = v10[2];
  v12 = 0;
  v13 = *v10;
