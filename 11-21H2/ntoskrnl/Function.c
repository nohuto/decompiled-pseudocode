...
__int64 __fastcall Function(PVOID CallbackContext, PVOID Argument1, int *Argument2)
{
  char v4; // si
  _DWORD *v5; // r13
  ...
  if ( (int)Argument1 > 22 )
  {
    ...
    if ( !v28 )
    {
      ...
      v4 = 113;
      v37 = *(PVOID *)Argument2;
      *(_OWORD *)&ObjectName[1] = xmmword_140038A18;
      v8 = *(unsigned __int16 **)(v36 + 8);
      Object = v37;
      LODWORD(v68) = *(_DWORD *)(v36 + 16);
      v20 = **(_DWORD **)(v36 + 40);
      LODWORD(v66) = v20;
      if ( (qword_140D3B0B0 & 2) == 0 || Argument2[2] < 0 )
        goto LABEL_53;
      v22 = *(const void **)(v36 + 24);
LABEL_52:
      LOWORD(v64) = sub_1409E5B58(&P, v22, v20);
      v9 = v64;
      goto LABEL_53;
    }
    v29 = v28 - 1;
    if ( !v29 )
    {
      ...
      *(_OWORD *)&ObjectName[1] = xmmword_140037A08;
    ...
    if ( v30 )
    {
      ...
      if ( v31 )
      {
        ...
        if ( v32 )
        {
          ...
          if ( v33 )
          {
            if ( v33 != 2 )
              return 0LL;
            v27 = xmmword_140039070;
          }
          else
          {
            v27 = xmmword_140038D60;
          }
        }
        else
        {
          v27 = xmmword_140038A78;
        }
        v21 = (__int64)Argument2;
        goto LABEL_41;
      }
      ...
      *(_OWORD *)&ObjectName[1] = xmmword_140037CE0;
      Object = v34[1];
      if ( Argument2[2] >= 0 )
        goto LABEL_46;
    }
    else
    {
      v21 = (__int64)Argument2;
      v34 = (unsigned __int16 **)*((_QWORD *)Argument2 + 2);
      *(_OWORD *)&ObjectName[1] = xmmword_140038328;
      Object = v34[1];
      if ( Argument2[2] >= 0 )
      {
        v70 = *(_DWORD *)v34[8];
LABEL_46:
  ...
  if ( (_DWORD)Argument1 == 22 )
  {
    ...
    Object = *(PVOID *)Argument2;
    *(_OWORD *)&ObjectName[1] = xmmword_140038338;
  ...
  if ( v10 )
  {
    ...
    if ( v11 )
    {
      ...
      if ( !v12 )
      {
        ...
        v21 = (__int64)Argument2;
        *(_OWORD *)&ObjectName[1] = xmmword_140039778;
        Object = *v26;
        goto LABEL_53;
      }
      v13 = v12 - 1;
      if ( !v13 )
      {
        ...
        *(_OWORD *)&ObjectName[1] = xmmword_140038638;
        ...
        if ( (qword_140D3B0B0 & 2) != 0 && Argument2[2] >= 0 )
        {
          v9 = sub_1409E5B58(&P, *(const void **)(v24 + 24), v25);
          LOWORD(v64) = v9;
        }
      ...
      if ( v14 )
      {
        ...
        if ( v15 )
        {
          ...
          if ( v16 )
          {
            if ( v16 != 1 )
              return 0LL;
            v17 = xmmword_140037E08;
          }
          else
          {
            v17 = xmmword_1400387F0;
          }
          v18 = *((_QWORD *)Argument2 + 2);
          v4 = 120;
          v19 = *(PVOID *)Argument2;
        ...
        v18 = *((_QWORD *)Argument2 + 2);
        Object = *(PVOID *)Argument2;
        *(_OWORD *)&ObjectName[1] = xmmword_140038CD0;
        LODWORD(v68) = *(_DWORD *)(v18 + 8);
        v20 = *(_DWORD *)(v18 + 24);
LABEL_18:
        v4 = 112;
LABEL_13:
      ...
      v21 = (__int64)Argument2;
      v4 = 1;
      *(_OWORD *)&ObjectName[1] = xmmword_1400380D8;
      v8 = *(unsigned __int16 **)(v23 + 8);
LABEL_20:
      Object = *(PVOID *)Argument2;
LABEL_53:
      if ( (qword_140D3B0B0 & 1) != 0 )
      {
        v38 = 1;
        if ( Object )
        {
          CmCallbackGetKeyObjectID(&stru_140D3B230, Object, 0LL, ObjectName);
          v9 = v64;
          v6 = ObjectName[0];
        }
      }
      ...
      *v39 = v40;
      ...
      v48 = 2LL * v7;
      v49 = v7 + 1;
      *(&UserData.Ptr + v48) = (ULONGLONG)&qword_14000EF90;
      *((_QWORD *)&UserData.Size + v48) = 2LL;
      if ( (v4 & 1) != 0 )
      {
        ...
        v53 = 2LL * v49++;
        *(&UserData.Ptr + v53) = (ULONGLONG)&qword_14000EF90;
      ...
      EtwWrite(qword_140D3B010, (PCEVENT_DESCRIPTOR)&ObjectName[1], 0LL, v49, &UserData);
      if ( P )
    ...
    v27 = xmmword_140038720;
    v21 = 1LL;
LABEL_41:
    *(_OWORD *)&ObjectName[1] = v27;
    goto LABEL_20;
  }
  if ( (qword_140D3B0B0 & 4) != 0 )
    sub_1409E5A54((__int64)Argument2);
  return 0LL;
}
