/*
 * XREFs of PspCaptureUserProcessParameters @ 0x14069D480
 * Callers:
 ...
 *     PspCaptureAndValidateUnicodeString @ 0x14069DC24 (PspCaptureAndValidateUnicodeString.c)
 *     PspValidateEnvironmentBlock @ 0x14069DCA0 (PspValidateEnvironmentBlock.c)
...
__int64 __fastcall PspCaptureUserProcessParameters(_QWORD *a1, __int64 a2, __int64 a3, char a4, __int64 a5)
{
  ...
  *(_OWORD *)v25 = 0LL;
  ...
  if ( (a4 & 1) != 0 )
  {
    ...
    v32 = *(_OWORD *)(ServerSiloGlobals + 1000);
    *(_OWORD *)v25 = PspProtectedRuntimeData;
    if ( (v21 & 2) == 0 )
    {
  ...
  {
    result = PspCaptureAndValidateUnicodeString(a2 + 56, &v32);
    if ( (int)result < 0 )
      return result;
  ...
  result = PspCaptureAndValidateUnicodeString(v6 + 5, &v34);
  if ( (int)result < 0 )
    return result;
  result = PspCaptureAndValidateUnicodeString(v6 + 6, &v35);
  if ( (int)result < 0 )
    return result;
  result = PspCaptureAndValidateUnicodeString(v6 + 7, &v36);
  if ( (int)result < 0 )
    return result;
  result = PspCaptureAndValidateUnicodeString(v6 + 11, &v37);
  if ( (int)result < 0 )
    return result;
  result = PspCaptureAndValidateUnicodeString(v6 + 12, &v38);
  if ( (int)result < 0 )
    return result;
  result = PspCaptureAndValidateUnicodeString(v6 + 13, &v39);
  if ( (int)result < 0 )
    return result;
  ...
  {
    result = PspCaptureAndValidateUnicodeString(v6 + 65, &v33);
    if ( (int)result < 0 )
      return result;
  }
...
LABEL_31:
  ...
  *v15 = v11;
  ...
  v13 = PspCopyUnicodeString(&v32, v15 + 14, &v24);
  if ( v13 < 0 )
    goto LABEL_84;
  v13 = PspCopyUnicodeString(&v34, v15 + 20, &v24);
  if ( v13 < 0 )
    goto LABEL_84;
  v13 = PspCopyUnicodeString(&v35, v15 + 24, &v24);
  if ( v13 < 0 )
    goto LABEL_84;
  v13 = PspCopyUnicodeString(&v36, v15 + 28, &v24);
  if ( v13 < 0 )
    goto LABEL_84;
  v13 = PspCopyUnicodeString(&v37, v15 + 44, &v24);
  if ( v13 < 0 )
    goto LABEL_84;
  v13 = PspCopyUnicodeString(&v38, v15 + 48, &v24);
  if ( v13 < 0 )
    goto LABEL_84;
  v13 = PspCopyUnicodeString(&v39, v15 + 52, &v24);
  if ( v13 < 0 )
    goto LABEL_84;
  PspCopyUnicodeString(&v33, v15 + 260, &v24);
  if ( a3 && (*(_DWORD *)(a3 + 4) & 4) != 0 )
    PspCopyUnicodeString(&v40, v15 + 264, &v24);
  else
    *((_OWORD *)v15 + 66) = 0LL;
