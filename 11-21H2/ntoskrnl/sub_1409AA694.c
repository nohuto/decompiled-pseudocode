/*
 * XREFs of sub_1409AA694 @ 0x1409AA694
 * Callers:
...
void __fastcall sub_1409AA694(int a1, __int64 a2, __int64 a3, __int64 a4, __int64 a5, __int64 a6)
{
  int v7; // r9d
  int v8; // r10d
  int v9; // r11d
  ...
  if ( (unsigned int)dword_140D3B908 > 5 )
  {
    if ( sub_1402A2000((__int64)&dword_140D3B908, 1LL) )
    {
      ...
      v22 = 4LL;
      v24 = 4LL;
      sub_14020A9C4((__int64)&dword_140D3B908, (unsigned __int8 *)byte_140032AB3, 0LL, 0LL, 8u, &v16);
    }
  }
}
