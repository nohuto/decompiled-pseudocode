/*
 * XREFs of MiNoPagesLastChance @ 0x1405B379C
 * Callers:
...
LABEL_13:
  ...
  if ( !*(_QWORD *)(v16 + 1296)
    || (PsGetJobLastThrottledIoTime(*(_QWORD *)(v16 + 1296), v12, v3, v6),
        UnbiasedInterruptTime = KiQueryUnbiasedInterruptTime(),
        (unsigned __int64)(UnbiasedInterruptTime - v18) >= -MiNoPagesTimeout.QuadPart) )
  {
          ...
          while ( 1 )
          {
              ...
              && !_interlockedbittestandset64((volatile signed __int32 *)(v26 + 24), 0x3FuLL) )
            {
              ...
              if ( (*(_DWORD *)(v28 + 56) & 8) == 0 )
              {
                ...
                MiUnlinkPageFromListEx(v26, 1);
                v21 = v40;
                ExReleaseSpinLockExclusiveFromDpcLevel(v40);
                *(_QWORD *)(v26 + 24) &= 0xC000000000000000uLL;
                *(_BYTE *)(v26 + 34) &= ~0x10u;
                MiPfnReferenceCountIsZero(v26, 0xAAAAAAAAAAAAAAABuLL * (v47 >> 4));
...
LABEL_47:
      ...
      if ( v20 )
      {
        ...
        *(_DWORD *)(a1 + 15640) = -1073741566;
        v34->List.Flink = 0LL;
        *(_QWORD *)(a1 + 15616) = MiLdwPopupWorker;
