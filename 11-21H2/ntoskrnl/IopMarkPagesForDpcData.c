/*
 * XREFs of IopMarkPagesForDpcData @ 0x14055D868
 * Callers:
...
LABEL_35:
    ...
    v5 = v4[4373];
    if ( v5 )
      MmAddRangeToCrashDump(a1, v5, (unsigned int)KeDpcWatchdogProfileBufferSizeBytes);
    v6 = 0;
    v7 = v4 + 1644;
    while ( 1 )
    {
...
LABEL_61:
    if ( v18 != &KiIntTrackRootList && MmIsAddressValidEx((__int64)v18) && (++v19, v19 <= KiIntTrackRootCount) )
    {
      ...
      if ( (int)result >= 0 )
      {
        ...
        {
          if ( (ULONG_PTR *)j == v18 + 2 || !MmIsAddressValidEx(j) )
          {
            v18 = (ULONG_PTR *)*v18;
            goto LABEL_61;
          }
