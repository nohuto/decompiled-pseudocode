/*
 * XREFs of sub_14078FCF8 @ 0x14078FCF8
 * Callers:
...
__int64 __fastcall sub_14078FCF8(
        __int64 a1,
        __int64 *a2,
        unsigned __int16 a3,
        int a4,
...
LABEL_41:
        ...
        v32 = v30;
        LOBYTE(v30) = v17;
        return sub_1409E4318(
                 a1,
                 v30,
                 (unsigned __int16)v10,
                 a5,
                 *((unsigned __int8 *)&off_140A39080 + 16 * v18 + 8),
                 v16,
                 v32);
      }
      ++v18;
    ...
    while ( v18 < 0xA );
    v22 = 0x422034803B9C9951LL - v20;
    if ( v20 == 0x422034803B9C9951LL )
    ...
    if ( v17 )
    {
      ...
      else
      {
        ...
        if ( a5 != 4 )
        {
          ...
          if ( a5 == 16 )
            return (unsigned int)sub_1409EA280(a1, v10);
LABEL_33:
          LOBYTE(v26) = v16;
          return (unsigned int)sub_1409E9F80(a1, v15, v10, v26);
        }
      }
      LOBYTE(v16) = 1;
      goto LABEL_33;
  ...
  v24 = 0x11D232049E814AADLL - *a2;
  if ( *a2 == 0x11D232049E814AADLL )
    v24 = 0x3969A8086000829ALL - a2[1];
  v25 = 0;
  if ( v24 || a1 != qword_140D05008 )
  {
LABEL_12:
    *a8 = 0;
    return v14;
...
LABEL_24:
    LOBYTE(v11) = v8;
    return (unsigned int)sub_1409E9E48(a1, 2, v10, v11, a6, a7);
  }
  return v25;
}
