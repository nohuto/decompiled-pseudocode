/*
 * XREFs of IvtAllocateScalableModePasidTables @ 0x14052DC38
 * Callers:
...
__int64 __fastcall IvtAllocateScalableModePasidTables(__int64 a1, unsigned int a2, __int64 a3, int a4, _QWORD *a5)
{
  unsigned int v5; // r9d
  ...
  LARGE_INTEGER v33; // [rsp+40h] [rbp-20h] BYREF
  ...
  *(_QWORD *)&LockHandle.OldIrql = 0LL;
  ...
  v9 = (v8 >> 6) & 0x3FFF;
  v11 = ExtEnvAllocateMemory(a1, 8 * v9 + 56, &v31);
  if ( v11 < 0 )
  {
LABEL_36:
    *a5 = 0LL;
  ...
  *((_DWORD *)v12 + 8) = 0;
  v32 = v12 + 1;
  *((_DWORD *)v12 + 9) = v8;
  v11 = ExtEnvAllocatePhysicalMemory(
          v10,
          v13,
          0x1000u,
  ...
  if ( v11 >= 0 )
  {
    ...
    v11 = IvtExtendScalableModePasidTables(a1, v12);
  }
  ...
  if ( a2 <= 0xFFFFFFFD )
  {
    ...
    {
      v15 = v12;
      if ( v8 <= *(_DWORD *)(ScalableModePasidTables + 36) && *(_DWORD *)(ScalableModePasidTables + 32) )
      {
        v12 = (_QWORD *)ScalableModePasidTables;
        v31 = (_QWORD *)ScalableModePasidTables;
        v11 = 0;
      }
      else
      {
