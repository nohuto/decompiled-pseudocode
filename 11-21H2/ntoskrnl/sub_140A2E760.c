/*
 * XREFs of sub_140A2E760 @ 0x140A2E760
 * Callers:
...
__int64 __fastcall sub_140A2E760(__int64 a1, int a2, unsigned int *a3, __int64 a4, __int64 a5, unsigned int *Handle)
{
  unsigned int *v6; // rdi
  ...
  *v6 = 0;
  v10 = a1;
  v11 = v8;
  v12 = sub_140A2E04C(a1, (_OWORD **)off_140C093D0, 1u, a4, v8, v6);
  if ( v12 < 0 )
  ...
  if ( !a3 )
  {
    v12 = sub_140A2F588(v10, a2, v13, 0, (__int64)&Handle, 0LL);
    if ( v12 < 0 )
      goto LABEL_25;
    v16 = Handle;
    a3 = Handle;
