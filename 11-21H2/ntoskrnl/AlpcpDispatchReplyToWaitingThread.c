/*
 * XREFs of AlpcpDispatchReplyToWaitingThread @ 0x1407A9A80
 * Callers:
    ...
    else
    {
      ...
      *(_QWORD *)(v1 + 32) = v13;
      ...
      if ( (v26 & 4) != 0 )
        ...
        KeReleaseSemaphoreEx((volatile signed __int32 *)(v28 + 1240), 1LL, 1LL, v24, 2);
    }
    if ( (v27 & 0x1000) != 0 )
