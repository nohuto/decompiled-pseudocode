/*
 * XREFs of sub_140A6B1E0 @ 0x140A6B1E0
 * Callers:
...
__int64 __fastcall sub_140A6B1E0(struct _DEVICE_OBJECT *a1, __int64 *a2, _QWORD *a3)
{
  _QWORD *v3; // rbp
  ...
  v9 = qword_140C23740 + 24;
  v10 = *(_QWORD **)(qword_140C23740 + 24);
  while ( 1 )
  {
    if ( v10 == (_QWORD *)v9 )
      goto LABEL_15;
    ...
    if ( *((_DWORD *)v11 + 18) <= v8 )
      break;
    if ( sub_14098F540((unsigned __int16 *)DeviceNode, (__int64)(v11 + 3)) )
    {
      v12 = -1073741823;
LABEL_19:
      v14 = 0LL;
...
LABEL_11:
  ...
  if ( *((_DWORD *)v11 + 18) >= v8 || !sub_14098F4D4(DeviceNode, (__int64)(v11 + 3)) )
    goto LABEL_11;
  v3 = v11;
LABEL_15:
  v13 = sub_14098F388(0);
...
LABEL_20:
  ...
  *(_QWORD *)(v14 + 32) = Pool2;
  ...
  {
    v12 = -1073741670;
    sub_14098F2F8((_DWORD *)v14);
    goto LABEL_19;
  }
  *(_WORD *)(v14 + 26) = *(_WORD *)(DeviceNode + 40);
  RtlCopyUnicodeString((PUNICODE_STRING)(v14 + 24), (PCUNICODE_STRING)(DeviceNode + 40));
  sub_14098F40C(v14 + 40, DevicePropertyFriendlyName, a1);
  sub_14098F40C(v14 + 56, DevicePropertyDeviceDescription, a1);
  sub_14098F40C(v14 + 96, DevicePropertyClassName, a1);
  sub_14098F40C((__int64)&GuidString, DevicePropertyClassGuid, a1);
