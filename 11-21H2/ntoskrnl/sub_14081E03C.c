/*
 * XREFs of sub_14081E03C @ 0x14081E03C
 * Callers:
...
char *__fastcall sub_14081E03C(__int64 a1, __int64 a2)
{
  int v2; // edi
  _QWORD *v5; // r9
  _QWORD *v6; // r8
  ...
  result = (char *)sub_1402828F0(64, 16 * ((unsigned int)(v2 - 1) + 3LL), 0x6C4D6D4Du);
  if ( result )
  {
    v12 = result + 16;
    *((_QWORD *)result + 1) = 1LL;
