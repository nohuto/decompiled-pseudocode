/*
 * XREFs of sub_14099510C @ 0x14099510C
 * Callers:
...
char __fastcall sub_14099510C(int a1, int a2, int a3, int a4)
{
  _UNKNOWN **v4; // rax
  int v5; // edi
  int v6; // esi
  ...
  {
    v9 = qword_140C21D58;
    LOBYTE(v4) = EtwEventEnabled(qword_140C21D58, &stru_14003C158);
    if ( (_BYTE)v4 )
    {
      UserData.Reserved = 0;
      v19 = 0;
      ...
      v21 = 4;
      v24 = 4;
      LOBYTE(v4) = EtwWrite(v9, &stru_14003C158, 0LL, 4u, &UserData);
      v5 = v42;
      v6 = v41;
      v7 = v40;
      v8 = v11;
  ...
  if ( (unsigned int)dword_140C03A00 > 5 )
  {
    ...
    if ( (_BYTE)v4 )
    {
      ...
      v15 = v5;
      v37 = 4;
      LOBYTE(v4) = sub_14020A9C4((__int64)&dword_140C03A00, (unsigned __int8 *)&word_140030B7E, 0LL, 0LL, 6u, &v26);
    }
  }
  return (char)v4;
}
