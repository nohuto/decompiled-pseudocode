/*
 * XREFs of SepAccessCheckAndAuditAlarm @ 0x140722B40
 * Callers:
 *     NtAccessCheckByTypeAndAuditAlarm @ 0x1406C0050 (NtAccessCheckByTypeAndAuditAlarm.c)
 *     NtAccessCheckAndAuditAlarm @ 0x14071F1F0 (NtAccessCheckAndAuditAlarm.c)
 *     NtAccessCheckByTypeResultListAndAuditAlarm @ 0x1409CAAA0 (NtAccessCheckByTypeResultListAndAuditAlarm.c)
 *     NtAccessCheckByTypeResultListAndAuditAlarmByHandle @ 0x1409CAB50 (NtAccessCheckByTypeResultListAndAuditAlarmByHandle.c)
 * Callees:
 ...
 *     SeIsPermissiveLearningModeEnabled @ 0x1402443C4 (SeIsPermissiveLearningModeEnabled.c)
 *     SepLpacCausedAccessFailure @ 0x14024F43C (SepLpacCausedAccessFailure.c)
 *     SepFilterToDiscretionary @ 0x1402A458C (SepFilterToDiscretionary.c)
 *     SepMandatoryToDiscretionary @ 0x1402A45A8 (SepMandatoryToDiscretionary.c)
        ...
        char a17)
{
  ...
  int Cap; // eax
  struct _RTL_DYNAMIC_HASH_TABLE_ENTRY *v98; // rdx
  char *v99; // rax
...
LABEL_24:
      ...
      v25 = SeCaptureSecurityDescriptor(a6, PreviousMode, 1, 0, (__int64)&v170);
      v161 = v25;
      if ( v25 < 0 )
      {
        v26 = 0LL;
      ...
      if ( v170 )
      {
        ...
        if ( v29 )
        {
          ...
          if ( v31 )
          {
            ...
            *(_BYTE *)v32 = *(_BYTE *)v32;
            v25 = SepProbeAndCaptureString_U(v217, &P);
            v161 = v25;
            if ( v25 >= 0 )
            {
              v25 = SepProbeAndCaptureString_U(v218, &v195);
              v161 = v25;
              if ( v25 >= 0 )
              {
                v25 = SepProbeAndCaptureString_U(v219, &v205);
                v161 = v25;
              }
            }
            LOBYTE(v35) = v185;
            if ( v25 >= 0 )
            {
              if ( Src )
              {
                v25 = SeCaptureSid((char *)Src, PreviousMode, v33, v34, Object, 1, (PSID *)&v200);
                if ( v25 < 0 )
                {
                  v200 = 0LL;
                  v20 = (char *)v163;
              ...
              v25 = SeCaptureObjectTypeList(v225, v162, PreviousMode, &v193);
              if ( v25 >= 0 )
              {
                v26 = (unsigned int *)v170;
                v25 = SepTrustLevelCheck(v36, (__int64)v170, &SubjectContext, 0LL, 0LL, 1, &v197);
                if ( v25 < 0 )
                {
LABEL_191:
                  v20 = (char *)v163;
...
LABEL_48:
                  if ( v25 < 0 )
                    goto LABEL_54;
                  v25 = SepMandatoryIntegrityCheck(
                          (int *)&v231,
                          (__int64)v26,
                          0LL,
                          (__int64)ClientToken,
                  ...
                  if ( v25 >= 0 )
                  {
                    v38 = SepMandatoryToDiscretionary(&v221, v37);
                    v25 = v38;
                    v161 = v38;
                    ...
                    if ( v38 >= 0 || (_BYTE)v35 )
                    {
                      v25 = SePrivilegePolicyCheck(&a8, &v173, (__int64 *)&SubjectContext, 0LL, (__int64)&v202, v153);
                      v161 = v25;
                      v37 = a8;
                      if ( !a8 )
                      {
...
LABEL_57:
                        ...
                        if ( v95 )
                        {
                          ScopedPolicySid = SepGetScopedPolicySid((__int64)v95);
                          if ( ScopedPolicySid )
                          {
                            Cap = SepRmReferenceFindCap(ScopedPolicySid, &v203);
                            v98 = v203;
                            if ( Cap < 0 )
                              v98 = (struct _RTL_DYNAMIC_HASH_TABLE_ENTRY *)SepRmDefaultCap;
                            v203 = v98;
                            v25 = 0;
                            v161 = 0;
                            v41 = 1;
...
LABEL_58:
                            ...
                            if ( (a8 & 0x2060000) != 0
                              ...
                              && ((v71 = *((_WORD *)v26 + 1), (v71 & 4) == 0)
                                ...
                                ? (v73 = 0LL)
                                : (v73 = (__int64)v26 + v72),
                                  !(unsigned __int8)RtlOwnerAcesPresent(v73)) )
                            {
                              if ( (v37 & 0x2000000) != 0 )
                              {
                                v74 = 393216;
...
LABEL_161:
                                ...
                                if ( v25 >= 0
                                  ...
                                  && SepLpacCausedAccessFailure((__int64)&v228, v37) )
                                {
...
LABEL_78:
                                ...
                                if ( v204 == 2 )
                                {
                                  if ( v154 )
                                  {
                                    ...
                                    v160 = SepAdtAuditObjectAccessWithContext(
                                             0LL,
                                             v195,
                                             v154,
                                             0LL,
...
LABEL_83:
                                  ...
                                  LOBYTE(HandleInformation) = 0;
                                  v50 = SepAdtAuditObjectAccessWithContext(
                                          0LL,
                                          v195,
                                          0LL,
                                          v156,
                                ...
                                else
                                {
                                  ...
                                  {
                                    v172[0] = 151;
                                    v160 = SepAdtAuditThisEventWithContext(151LL, v154, 0LL, &SubjectContext);
                                  }
                                  if ( !v156 )
                                    goto LABEL_83;
                                  v172[0] = 151;
                                  v50 = SepAdtAuditThisEventWithContext(151LL, 0LL, v156, &SubjectContext);
                                  v157 = v50;
                                }
LABEL_84:
                                v51 = v160;
                                  ...
                                  if ( v54 )
                                  {
                                    ...
                                    if ( v44 )
                                    {
                                      ...
                                      while ( v59 < v162 )
                                      {
                                        ...
                                        if ( SepRmEnforceCap && v158 && v44[v68] >= 0 )
                                        {
                                          v66[v59] = v194[v59];
                                          v67[v59] &= v58[v59];
                                        }
...
LABEL_249:
                              ...
                              if ( v162 )
                              {
                                v25 = SepCopyObjectTypeList(v193, v162, (__int64 *)&v213);
                                v161 = v25;
                                if ( v25 < 0 )
                                {
                                  PreviousMode = v153;
                              ...
                              while ( 1 )
                              {
                                ...
                                if ( !v196 )
                                {
                                  ...
                                  if ( (int)AuthzBasepInitializeResourceClaimsFromSacl((__int64)v198, (__int64 *)&v196) < 0 )
                                    LODWORD(v44) = 1;
                                  v189 = (int)v44;
                                  v107 = v196;
                                }
...
LABEL_295:
                                  ...
                                  v46 = v162;
                                  if ( v122 )
                                    SepMergeObjectTypeListAccesses(v193, (__int64)v122, v162);
                                  v158 = 1;
                                  LOBYTE(v44) = v189;
                                }
                                else
                            ...
                            if ( (v37 & 0x2000000) != 0 )
                            {
                                ...
                                && !SeIsPermissiveLearningModeEnabled((__int64)ClientToken) )
                              {
                                if ( a17 )
                                  ...
                                  v75 = 0;
                                SepConstrainByMandatory((__int64)&v221, v37, (char *)v163, (char *)v44, 0LL, v75);
                              }
                            }
                            else if ( (_BYTE)v185 && !*(_WORD *)((char *)&v229 + 5) )
                            {
                              if ( !SeIsPermissiveLearningModeEnabled((__int64)ClientToken) || HIDWORD(v228) )
                              {
                                v154 = 0;
                                v156 = 1;
                                v126 = 0;
...
LABEL_69:
                                if ( (v37 & 0x2000000) != 0 )
                                {
                                  ...
                                  if ( v47 )
                                    ...
                                    v77 = 0;
                                  SepConstrainByConstraintMask(v197, v37, v48, (char *)v44, 0LL, v77, &v167);
                                  if ( a17 )
                                    v78 = v76;
                                  else
                                    v78 = 0;
                                  SepConstrainByConstraintMask(v208[0], v37, (char *)v163, (char *)v44, 0LL, v78, &v168);
                                }
                                v26 = (unsigned int *)v170;
                                goto LABEL_71;
                              }
...
LABEL_54:
                ...
                v25 = SepFilterCheck((__int64)v26, (__int64 *)&v196, ClientToken, 1, v208);
                if ( v25 >= 0 )
                {
                  v25 = SepFilterToDiscretionary(v208, v37);
                  v161 = v25;
                  if ( v25 < 0 )
                    v168 = 1;
                  goto LABEL_48;
...
LABEL_373:
  ...
  v86 = *a3;
  v216 = 0LL;
  v25 = ObReferenceObjectByHandle(v86, 8u, (POBJECT_TYPE)SeTokenObjectType, PreviousMode, &v216, 0LL);
  v212 = v216;
  if ( v25 >= 0 )
  {
    v220 = ClientToken;
...
LABEL_117:
  ...
  SeReleaseSubjectContext(&SubjectContext);
  SeReleaseSecurityDescriptor(v26, PreviousMode, 0LL, v69);
  if ( P )
  ...
  if ( v200 )
    SeReleaseSid((void *)v200, PreviousMode, 1);
  if ( v193 )
    SeFreeCapturedObjectTypeList((void *)v193);
  if ( v165 )
  {
    if ( v20 )
