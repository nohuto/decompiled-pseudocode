/*
 * XREFs of sub_140910AA4 @ 0x140910AA4
 * Callers:
...
void __fastcall sub_140910AA4(__int64 a1, __int64 a2, unsigned int a3)
{
  __int64 v4; // r9
  __int64 v6; // r8
  unsigned int v7; // edx
  ...
  v15[v12 - 1] = v13;
  v15[v12] = 2LL;
  sub_14062E480((__int64)&v14, v9 + 1, a2, a3, 0x927u, 0x401802u);
}
