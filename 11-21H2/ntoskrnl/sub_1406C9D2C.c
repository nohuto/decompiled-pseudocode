/*
 * XREFs of sub_1406C9D2C @ 0x1406C9D2C
 * Callers:
...
NTSTATUS __fastcall sub_1406C9D2C(unsigned __int64 a1, unsigned __int64 a2, __int64 a3, int a4, __int64 a5)
{
  ULONG_PTR v7; // r14
  ...
  _DWORD ProcessInformation[4]; // [rsp+60h] [rbp-58h] BYREF
  unsigned __int64 v28; // [rsp+70h] [rbp-48h]
  __int64 v29; // [rsp+78h] [rbp-40h]
  __int64 v30; // [rsp+80h] [rbp-38h]
  ULONG_PTR v31; // [rsp+88h] [rbp-30h]
  unsigned __int64 v32; // [rsp+C0h] [rbp+8h]

  v32 = a1;
  v24 = 0LL;
  v30 = 0LL;
  v7 = *(_QWORD *)(*((_QWORD *)KeGetCurrentThread() + 23) + 1360LL);
  v23 = v7;
  if ( !a1 || (v8 = a2) == 0 )
  {
    v16 = 0;
    v17 = RtlImageNtHeader(*(PVOID *)(*((_QWORD *)KeGetCurrentThread() + 23) + 1312LL));
    v18 = v17;
    if ( v17 )
    {
