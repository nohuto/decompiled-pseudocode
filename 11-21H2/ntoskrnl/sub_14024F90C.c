/*
 * XREFs of sub_14024F90C @ 0x14024F90C
 * Callers:
...
__int64 __fastcall sub_14024F90C(__int64 a1, int a2, __int64 a3, __int64 a4, __int64 a5)
{
  ...
  if ( (v5 & 8) == 0 )
    v9 = v8;
  return sub_14024FA14((unsigned int)v12, v8, v9, a2, a3, a4, a5);
}
