/*
 * XREFs of sub_140697B34 @ 0x140697B34
 * Callers:
...
__int64 __fastcall sub_140697B34(void *a1, void *a2)
{
  NTSTATUS v3; // eax
  NTSTATUS v4; // ebx
  int v6; // eax
  ...
  *(_QWORD *)&ObjectAttributes.Attributes = 576LL;
  ...
  else if ( v3 >= 0 )
  {
    *(_DWORD *)&v14.Length = 1048590;
    v14.Buffer = L"Devices";
    v6 = sub_14067A8B0(&Handle, a1, &v14, 0xF003Fu, 0, 0LL);
    v7 = Handle;
    v4 = v6;
    if ( v6 >= 0 )
    {
          ...
          while ( 1 )
          {
            *((_WORD *)Pool2 + ((unsigned __int64)Pool2[3] >> 1) + 8) = 0;
            if ( *(_QWORD *)&qword_140D00AC0 && (v10 = *(_QWORD *)(*(_QWORD *)&qword_140D00AC0 + 224LL)) != 0 )
              ...
              v11 = 0LL;
            sub_1406CB238(v7, Pool2 + 4, v11, 0LL);
            if ( *(_QWORD *)&qword_140D00AC0 && (v12 = *(_QWORD *)(*(_QWORD *)&qword_140D00AC0 + 224LL)) != 0 )
              v13 = *(_QWORD *)(v12 + 8);
            else
              v13 = 0LL;
            v4 = sub_140A2D248((_DWORD)KeyHandle, (int)Pool2 + 16, (_DWORD)v7, (int)Pool2 + 16, 0, v13, 0);
            if ( v4 < 0 )
              break;
