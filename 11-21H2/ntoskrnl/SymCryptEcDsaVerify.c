/*
 * XREFs of SymCryptEcDsaVerify @ 0x140401470
 * Callers:
 ...
 *     SymCryptModInv @ 0x140401198 (SymCryptModInv.c)
 ...
 *     SymCryptEcpointMultiScalarMul @ 0x14040A67C (SymCryptEcpointMultiScalarMul.c)
    ...
    if ( v21 )
    {
      ...
      *((_QWORD *)&v41 + 1) = SymCryptIntCreate();
      ...
      if ( (unsigned int)SymCryptModElementIsZero()
        ...
        || (unsigned int)SymCryptEcpointIsZero(v7, v42)
