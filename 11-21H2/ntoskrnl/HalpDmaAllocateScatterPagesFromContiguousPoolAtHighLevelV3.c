/*
 * XREFs of HalpDmaAllocateScatterPagesFromContiguousPoolAtHighLevelV3 @ 0x140503808
 * Callers:
 ...
 *     HalpDmaIndexToTranslationEntry @ 0x14045764A (HalpDmaIndexToTranslationEntry.c)
 */
