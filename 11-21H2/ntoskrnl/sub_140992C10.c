/*
 * XREFs of sub_140992C10 @ 0x140992C10
 * Callers:
...
void __fastcall sub_140992C10(int a1)
{
  int *v1; // rdx
  int v2; // r9d
...
LABEL_9:
      ...
      v47 = 4LL;
      v49 = 4LL;
      sub_14020A9C4((__int64)&dword_140C03A00, (unsigned __int8 *)v1, 0LL, 0LL, v3, &v19);
    }
  }
  else if ( a1 == 15000
         && (unsigned int)dword_140C03A00 > 5
         && sub_1402A2000((__int64)&dword_140C03A00, 0x800000000000LL) )
  {
    v15 = v2;
    v20 = &v15;
    v1 = &dword_1400300DC;
