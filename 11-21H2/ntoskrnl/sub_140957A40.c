/*
 * XREFs of sub_140957A40 @ 0x140957A40
 * Callers:
...
void __fastcall sub_140957A40(__int64 a1, int a2, int a3)
{
  ...
  if ( (unsigned int)dword_140C06550 > 5 )
  {
    if ( sub_1402A2000((__int64)&dword_140C06550, 0x400000000000LL) )
    {
      ...
      v9 = a2;
      v10 = a3;
      sub_14020A9C4((__int64)&dword_140C06550, (unsigned __int8 *)byte_14002C02D, 0LL, 0LL, 0xAu, &v12);
    }
  }
}
