/*
 * XREFs of sub_1407DC44C @ 0x1407DC44C
 * Callers:
...
void __fastcall sub_1407DC44C(__int64 a1, int a2, char a3)
{
  ...
  if ( a1 )
  {
    ...
    if ( !a3 )
      v3 = &stru_140010EF8;
    if ( qword_140C54788 && EtwEventEnabled(qword_140C54788, v3) )
    {
      v5 = -1LL;
      do
        ++v5;
      ...
      *(_QWORD *)&UserData.Size = 2LL;
      ...
      v14 = 4LL;
      v16 = 4LL;
      EtwWrite(qword_140C54788, v3, 0LL, 5u, &UserData);
    }
  }
}
