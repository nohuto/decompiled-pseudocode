/*
 * XREFs of sub_140260EFC @ 0x140260EFC
 * Callers:
...
unsigned __int64 __fastcall sub_140260EFC(__int64 a1, __int64 a2)
{
  __int64 v4; // rcx
  __int64 v5; // rax
  _DWORD *v6; // rax
  ...
  *(_OWORD *)(a1 + 168) = 0LL;
  *(_QWORD *)(a1 + 184) = 0LL;
  sub_1402611C4(a1 + 192, &v10);
  memset((void *)(a1 + 1376), 0, 0x60uLL);
  *(_QWORD *)(a1 + 1448) = a1 + 1440;
  *(_QWORD *)(a1 + 1440) = 0LL;
  *(_DWORD *)(a1 + 1428) = (__int64)(DesiredTime
  ...
  *(_QWORD *)(a1 + 1576) = 0LL;
  *(_DWORD *)(a1 + 1564) = (__int64)(DesiredTime
                                   * (unsigned __int64)(unsigned int)((__int64)MEMORY[0xFFFFF78000000320] >> 12)) >> 17;
  *(_DWORD *)(a1 + 1608) = 1;
  *(_QWORD *)(a1 + 1640) = a2;
  ...
  *(_QWORD *)(a1 + 1712) = 0LL;
  *(_DWORD *)(a1 + 1700) = (__int64)(DesiredTime
                                   * (unsigned __int64)(unsigned int)((__int64)MEMORY[0xFFFFF78000000320] >> 12)) >> 17;
  *(_DWORD *)(a1 + 1608) = 2;
  *(_QWORD *)(a1 + 1760) = 0LL;
  *(_QWORD *)(a1 + 1768) = 0LL;
