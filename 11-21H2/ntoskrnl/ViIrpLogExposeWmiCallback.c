/*
 * XREFs of ViIrpLogExposeWmiCallback @ 0x140A9BF20
 * Callers:
 *     <none>
 * Callees:
...
void __fastcall ViIrpLogExposeWmiCallback(PVOID P)
{
  ...
  RtlInitUnicodeString(&ViDdiWmiMofKey, &word_140A7CB00);
  RtlInitUnicodeString(&ViDdiWmiMofResourceName, &word_140A7CB00);
