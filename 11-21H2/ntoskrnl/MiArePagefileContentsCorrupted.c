/*
 * XREFs of MiArePagefileContentsCorrupted @ 0x1405BC2C4
 * Callers:
...
__int64 __fastcall MiArePagefileContentsCorrupted(__int64 a1, __int64 *a2, _QWORD *a3)
{
  ...
  v7 = *(_QWORD *)(*(_QWORD *)(qword_140C51F48 + 8 * ((v5[5] >> 43) & 0x3FF))
                 ...
                 + 16736);
  PagingFileOffset = MiGetPagingFileOffset((__int64)(v5 + 2));
  v9 = 0;
  v10 = (v6 >> 5) & 0x1F;
  v11 = PagingFileOffset;
  if ( !a2 )
  {
    MiObtainPagefileHashes(v7, PagingFileOffset, 1u, (__int64)&v17);
    a2 = &v17;
  }
  ...
  v13 = 0;
  MiComputePageHash((__int64)&v15, (__int64)v5, v5[1], a3);
  v14 = *(_DWORD *)a2;
  if ( *(_DWORD *)a2 != 1 )
  {
    if ( *(_DWORD *)a2 )
    ...
    v13 = MiLateWritePageHash(v7, v11, a2, &v15);
    if ( !v13 )
      return 0LL;
    v14 = *(_DWORD *)a2;
  }
...
LABEL_24:
  ...
  qword_140C52AD8 = a1;
  if ( !dword_140C52AC0 )
    MiPageHashBugCheck(v13, v11, (int)&v15);
