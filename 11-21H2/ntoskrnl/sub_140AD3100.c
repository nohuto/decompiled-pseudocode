/*
 * XREFs of sub_140AD3100 @ 0x140AD3100
 * Callers:
 *     <none>
 * Callees:
...
void __fastcall __noreturn sub_140AD3100(__int64 a1, __int64 a2, __int64 a3, __int64 a4)
{
  __int64 v4; // rax
  __int64 v5; // r10
  __int64 v6; // r11
  ...
  v27 = v11;
  v28 = v12;
  _InterlockedIncrement64(MK_FP(__GS__, 168LL));
  sub_140AD30B0(0, (unsigned __int64)v14);
}
