/*
 * XREFs of PspFreezeJobTree @ 0x140679034
 * Callers:
...
LABEL_3:
  if ( (v6 & 2) != 0 )
  {
    ...
    {
      LOBYTE(v5) = 1;
      PspComputeReportWakeFilter(Object, &v15, a2 + 8, v5);
      if ( v15 )
      {
  ...
  PspEnumJobsAndProcessesInJobHierarchy(Object, (__int64)v16, v7);
LABEL_9:
  ExReleaseResourceLite((PERESOURCE)(Object + 56));
  if ( v7 )
  {
    PspEnumJobsAndProcessesInJobHierarchy(Object, (__int64)&v14, 0);
    if ( (int)v14 < 0 )
    {
      *(_DWORD *)a2 &= ~4u;
      LODWORD(v17) = 4;
