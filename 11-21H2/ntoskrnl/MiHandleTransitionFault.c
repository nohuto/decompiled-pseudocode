/*
 * XREFs of MiHandleTransitionFault @ 0x1403265B0
 * Callers:
        ...
        __int64 **Address)
{
  ...
  *v9 = 0LL;
  ...
  {
LABEL_15:
    if ( (MiUnlinkPageFromListEx((ULONG_PTR)BugCheckParameter4) & 3) == 0 )
    {
...
LABEL_23:
      ...
      if ( v17 || (MiLockVadTree(1), v17 = MiLocateAddress(v27), MiUnlockVadTree(1, 0x11u), v17) )
      {
        if ( MiVadPageSizes[(*((_DWORD *)v17 + 12) >> 19) & 3] == 16 )
        {
          if ( *((__int64 *)BugCheckParameter4 + 5) < 0 )
          {
            if ( ((_DWORD)v17[6] & 0x200000) != 0 )
              goto LABEL_70;
LABEL_65:
            v35 = MiIdealClusterPage((int)a1, (int)v17, v38, a6, BugCheckParameter4, v8, (__int64)&v40);
            v19 = v35;
            if ( v35 )
            {
...
LABEL_13:
    ...
    MiLockVadTree(1);
    v21 = MiLocateAddress(a5);
    MiUnlockVadTree(1, 0x11u);
  }
  else if ( (MiFlags & 0x8000) == 0 || (v22 & 0x40) == 0 )
  {
    goto LABEL_13;
  }
  if ( v21 )
