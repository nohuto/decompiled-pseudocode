/*
 * XREFs of sub_140B0DEB0 @ 0x140B0DEB0
 * Callers:
...
char *__fastcall sub_140B0DEB0(__int64 a1, char *a2, int *a3)
{
  _QWORD *v3; // r14
  _QWORD *v4; // rdi
  int v6; // ebp
  ...
  while ( 1 )
  {
    ...
    if ( v9 )
    {
      ...
      do
      {
        ...
        Size = v15;
        v16 = v29;
        v17 = (char *)(&v8[*(unsigned int *)&v11[4 * v15]] - v29);
        while ( 1 )
        {
          v18 = *v16;
...
LABEL_9:
      ...
      {
        v20 = v10[5];
        v21 = *(unsigned __int16 *)&v12[2 * Size];
