/*
 * XREFs of sub_1403ADB38 @ 0x1403ADB38
 * Callers:
...
void __fastcall sub_1403ADB38(__int64 a1, _QWORD *a2, _QWORD *a3, unsigned int a4, unsigned int a5, char a6, int a7)
{
  __int64 v10; // rbx
  __int64 v12; // rdi
  ...
  v15 = 72;
  v14 = v17;
  sub_14035EDE4((__int64)&v14, 1u, 0x80020000, 0x160Cu, 0x401902u);
}
