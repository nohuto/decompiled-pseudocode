/*
 * XREFs of sub_1409DAF78 @ 0x1409DAF78
 * Callers:
...
NTSTATUS __fastcall sub_1409DAF78(ULONGLONG a1, __int16 a2, const GUID *a3, __int64 *a4)
{
  char *v6; // rcx
  unsigned int v7; // eax
  ULONG v8; // r10d
  ...
  *(_QWORD *)&v11.Size = 16LL;
  ...
  return sub_14081549C((__int64)v6, &stru_1400383B8, a3, v8, &v11);
}
