/*
 * XREFs of sub_140251458 @ 0x140251458
 * Callers:
...
__int64 __fastcall sub_140251458(__int64 a1, unsigned __int16 *a2, char *a3, bool *a4)
{
  unsigned int v4; // ebx
  char v7; // si
  bool v10; // bp
  ...
  if ( !v11 )
  {
    ...
    *(_DWORD *)&String2.Length = 1310740;
    ...
    {
      if ( sub_14025179C(a1, *((_QWORD *)a2 + 1), *a2 >> 1) )
        v7 = 1;
      v10 = v7;
      goto LABEL_23;
    }
