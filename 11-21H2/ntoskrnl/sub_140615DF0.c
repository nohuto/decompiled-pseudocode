/*
 * XREFs of sub_140615DF0 @ 0x140615DF0
 * Callers:
 *     <none>
 * Callees:
...
LOGICAL __fastcall sub_140615DF0(KSPIN_LOCK_QUEUE_NUMBER Number, PKIRQL OldIrql)
{
  __int64 v4; // rdx
  __int64 v5; // rcx
  __int64 *v6; // rdi
...
LABEL_18:
  result = KeTryToAcquireQueuedSpinLock(Number, OldIrql);
  DWORD2(v17) = result;
  if ( v6 )
  {
    v14 = (_QWORD **)(v6 + 6);
