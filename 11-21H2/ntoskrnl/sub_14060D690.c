/*
 * XREFs of sub_14060D690 @ 0x14060D690
 * Callers:
 *     <none>
 * Callees:
...
NTSTATUS __fastcall sub_14060D690(PIO_CONNECT_INTERRUPT_PARAMETERS Parameters)
{
  __int64 v2; // rdx
  __int64 v3; // rcx
  __int64 *v4; // rdi
