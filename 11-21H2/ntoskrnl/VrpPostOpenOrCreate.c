/*
 * XREFs of VrpPostOpenOrCreate @ 0x1407806B0
 * Callers:
 ...
 *     CmRetrieveExtraParameter @ 0x140782774 (CmRetrieveExtraParameter.c)
...
LABEL_28:
  ...
  else
  {
    ...
    {
      v27 = (__int64)&v29[1];
      v12 = VrpBuildKeyPath(0LL, (PCUNICODE_STRING)(v10 + 48), v29 + 1);
      if ( v12 < 0 )
        goto LABEL_29;
...
LABEL_29:
  if ( (unsigned int)dword_140C038A0 > 2 )
  {
    ...
    tlgWriteTransfer_EtwWriteTransfer(
      (__int64)&dword_140C038A0,
      (unsigned __int8 *)&dword_14002A93C,
      &ActivityId,
      0LL,
      5u,
      v45);
