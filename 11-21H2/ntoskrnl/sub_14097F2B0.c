/*
 * XREFs of sub_14097F2B0 @ 0x14097F2B0
 * Callers:
 ...
 *     sub_1409AFCD0 @ 0x1409AFCD0 (sub_1409AFCD0.c)
 */

char __fastcall sub_14097F2B0(__int64 a1, __int64 a2, int a3)
{
  ...
  if ( *(_QWORD *)&qword_140C53448 )
  {
    ...
    if ( (v3 & 0x400) == 0 )
    {
      ...
      v11 = *(_QWORD *)(v8 + 320);
      v12 = *(_QWORD *)(v8 + 256);
      sub_1409AFCD0(a1, (unsigned int)&v17, (unsigned int)&v18, (unsigned int)&v19, (__int64)&v20);
      LOBYTE(v3) = sub_14032A72C(a1);
      if ( **(_DWORD **)&qword_140C53448 > 5u )
      {
        LOBYTE(v3) = sub_1402A2000(*(__int64 *)&qword_140C53448, 0x400000000000LL);
        if ( (_BYTE)v3 )
        {
          v27 = v13;
          v34 = &v29;
          ...
          v28 = v15;
          v59 = 8LL;
          LOBYTE(v3) = sub_14024A9B0(v14, (unsigned __int8 *)&byte_14002DAAF, 0LL, 1u, 0, 0, 0xFu, &v33);
        }
      }
    }
  }
