/*
 * XREFs of RtlFindNextForwardRunSetEx @ 0x1405E5C54
 * Callers:
...
unsigned __int64 __fastcall RtlFindNextForwardRunSetEx(__int64 a1, unsigned __int64 a2, unsigned __int64 *a3)
{
