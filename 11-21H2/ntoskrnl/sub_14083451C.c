/*
 * XREFs of sub_14083451C @ 0x14083451C
 * Callers:
...
__int64 __fastcall sub_14083451C(__int64 a1, const WCHAR *a2, struct _OBJECT_HANDLE_INFORMATION a3)
{
