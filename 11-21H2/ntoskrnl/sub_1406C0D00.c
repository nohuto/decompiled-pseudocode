/*
 * XREFs of sub_1406C0D00 @ 0x1406C0D00
 * Callers:
...
__int64 __fastcall sub_1406C0D00(__m128i *Src, __int64 *a2)
{
  __m128i *v4; // rax
  unsigned int v5; // edi
  char *v6; // rcx
...
LABEL_38:
  ...
  *(_DWORD *)(Pool2 + 52) = v23.m128i_i32[1];
  v13 = sub_1406C1068(Pool2 + 48, 0LL, 0LL);
  if ( v13 >= 0 && !(unsigned int)sub_1406C11D0(Pool2) )
    goto LABEL_38;
  *(_BYTE *)(Pool2 + 40) = 0;
  sub_1406C1068(Pool2 + 48, sub_1406C78A0, Pool2);
