/*
 * XREFs of sub_140987E44 @ 0x140987E44
 * Callers:
...
__int64 __fastcall sub_140987E44(int *a1, __int64 a2)
{
  PVOID v2; // rsi
  HANDLE v3; // rdi
  ...
  WCHAR SourceString[40]; // [rsp+A0h] [rbp-29h] BYREF
...
LABEL_19:
    ...
    v3 = ProcessHandle;
    v11 = sub_140732D40((ULONG_PTR)ProcessHandle, 0x1FFFFF, (__int64)PsProcessType, 0, 0x73576650u, &Object, 0LL, 0LL);
    v2 = Object;
    v9 = v11;
    if ( v11 < 0 )
    {
...
LABEL_16:
  ...
  sub_1402E1280(SourceString, 0x50uLL, L"\\KernelObjects\\Session%d", (unsigned int)a1[1]);
  ...
  ObjectAttributes.Attributes = 512;
  *(_OWORD *)&ObjectAttributes.SecurityDescriptor = 0LL;
  v9 = sub_1406E4870(&ClientId, 983043, (__int64)&ObjectAttributes);
  if ( v9 >= 0 )
  {
