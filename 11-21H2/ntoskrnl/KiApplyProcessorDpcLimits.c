/*
 * XREFs of KiApplyProcessorDpcLimits @ 0x140A59518
 * Callers:
 *     KiUpdateProcessorDpcWatchdogConfiguration @ 0x140568AA0 (KiUpdateProcessorDpcWatchdogConfiguration.c)
...
__int64 __fastcall KiApplyProcessorDpcLimits(__int64 a1, LARGE_INTEGER *a2)
{
  ...
  v7 = KiSetProcessorDpcLimits(a1, a2, Pool2, &P);
  if ( v7 >= 0 )
  {
    if ( P )
