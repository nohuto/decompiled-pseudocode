/*
 * XREFs of sub_140A1C148 @ 0x140A1C148
 * Callers:
...
__int64 __fastcall sub_140A1C148(
...
LABEL_15:
  ...
  if ( (v9 & 0x1F0000) != 0 )
  {
    ...
    do
    {
      if ( (v9 & *(_DWORD *)v23) != 0 )
      {
        ...
        RtlAppendUnicodeStringToString(&Destination, (PCUNICODE_STRING)&unk_140C0E140 + v22);
  ...
  do
  {
    ...
    {
      RtlAppendUnicodeToString(&Destination, L"%%");
      RtlAppendUnicodeStringToString(&Destination, (PCUNICODE_STRING)&unk_140C0E140 + v21);
      appended = RtlAppendUnicodeToString(&Destination, v16);
    }
    ++v21;
    ++v24;
  ...
  if ( (_WORD)v9 )
  {
    ...
    ExAcquireResourceExclusiveLite(&stru_140C0E400, 1u);
    v27 = 0;
    v28 = &qword_140C0E3E8;
    if ( qword_140C0E3E8 )
    {
    ...
    ExReleaseResourceLite(&stru_140C0E400);
