/*
 * XREFs of sub_140705BC0 @ 0x140705BC0
 * Callers:
 *     sub_1407059D8 @ 0x1407059D8 (sub_1407059D8.c)
 * Callees:
 *     sub_14029AE40 @ 0x14029AE40 (sub_14029AE40.c)
 */

__int64 __fastcall sub_140705BC0(unsigned int a1, _DWORD *a2, __int64 a3)
{
  unsigned int v4; // edi
  __int64 v5; // r9
  _OWORD *v6; // rdx
  ...
  if ( (v4 & 0x10008) == 0x10008 )
    sub_14029AE40(a3 + 256, (__int64)(a2 + 7));
