/*
 * XREFs of sub_140836EAC @ 0x140836EAC
 * Callers:
...
NTSTATUS __fastcall sub_140836EAC(_DWORD *a1, void *a2, UNICODE_STRING *a3, int a4)
{
  int v4; // ebx
  int v7; // esi
  int v9; // r12d
  ...
  *(_OWORD *)&ObjectAttributes.SecurityDescriptor = 0LL;
  ...
  if ( result >= 0 )
  {
    ...
    *((_QWORD *)a1 + 3) = a1 + 28;
    ...
    if ( (int)sub_14083735C(a1, L"MajorVersion", KeyHandle) < 0 || (v11 = 8, !*a1) )
      v11 = 0;
    v12 = v11 | a1[200] & 0xFFFFFFF7;
    a1[200] = v12;
    if ( (((unsigned __int8)v7 | (unsigned __int8)v12) & 8) == 0 )
      return -2147483614;
    v13 = (int)sub_14083735C(a1 + 1, L"MinorVersion", KeyHandle) < 0;
    v14 = 0;
    if ( !v13 )
      v14 = 16;
    ...
    if ( (((unsigned __int8)v7 | (unsigned __int8)v15) & 0x10) == 0 )
      return -2147483614;
    if ( (int)sub_14083735C(a1 + 2, L"BuildNumber", KeyHandle) < 0 || (v16 = 32, !a1[2]) )
      v16 = 0;
    v17 = v16 | a1[200] & 0xFFFFFFDF;
    a1[200] = v17;
    if ( (((unsigned __int8)v7 | (unsigned __int8)v17) & 0x20) == 0 )
      return -2147483614;
    v13 = (int)sub_14083735C(a1 + 3, L"BuildQfe", KeyHandle) < 0;
    v18 = 0;
    if ( !v13 )
      v18 = 64;
    ...
    if ( (((unsigned __int8)v7 | (unsigned __int8)v19) & 0x40) == 0 )
      return -2147483614;
    if ( (int)sub_140837444((PUNICODE_STRING)a1 + 2, (PCWSTR)a1 + 120, KeyHandle) < 0
      || (v20 = 128, !*((_WORD *)a1 + 16)) )
    {
      v20 = 0;
    }
    ...
    if ( (((unsigned __int8)v7 | (unsigned __int8)v21) & 0x80) == 0 )
      return -2147483614;
    if ( (int)sub_140837444((PUNICODE_STRING)a1 + 3, (PCWSTR)a1 + 133, KeyHandle) < 0
      || (v22 = 256, !*((_WORD *)a1 + 24)) )
    {
      v22 = 0;
    }
    ...
    if ( (((unsigned __int16)v7 | (unsigned __int16)v23) & 0x100) == 0 )
      return -2147483614;
    if ( (int)sub_140837444((PUNICODE_STRING)a1 + 4, (PCWSTR)a1 + 141, KeyHandle) < 0
      || (v24 = 512, !*((_WORD *)a1 + 32)) )
    {
      v24 = 0;
    }
    ...
    if ( (((unsigned __int16)v7 | (unsigned __int16)v25) & 0x200) == 0 )
      return -2147483614;
    v26 = a1 + 20;
    if ( (int)sub_140837444((PUNICODE_STRING)a1 + 5, (PCWSTR)a1 + 205, KeyHandle) < 0 || (v27 = 1024, !*v26) )
      v27 = 0;
    ...
    if ( (int)sub_140837444((PUNICODE_STRING)a1 + 6, (PCWSTR)a1 + 269, KeyHandle) < 0 || (v30 = 2048, !v29->Length) )
      v30 = 0;
...
LABEL_42:
        *((_BYTE *)a1 + 666) = 0;
LABEL_33:
        if ( (int)sub_14083735C(&v40, L"IsTopLevel", KeyHandle) < 0 || !v40 )
          v9 = 0;
        v32 = KeyHandle;
        a1[200] = v9 | a1[200] & 0xFFFFFFFE;
        if ( (int)sub_14083735C(&v40, L"IsChecked", v32) < 0 || (v33 = 2, !v40) )
          v33 = 0;
        v34 = KeyHandle;
        a1[200] = v33 | a1[200] & 0xFFFFFFFD;
        v35 = sub_14083735C(&v40, L"OrderNumber", v34);
        v36 = KeyHandle;
        if ( v35 >= 0 )
          v4 = v40;
        a1[199] = v4;
