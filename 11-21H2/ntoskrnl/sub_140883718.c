/*
 * XREFs of sub_140883718 @ 0x140883718
 * Callers:
...
__int64 __fastcall sub_140883718(__int64 a1, unsigned int a2, unsigned int a3, char a4)
{
  unsigned int v4; // ebx
  unsigned int v7; // edi
  ...
  *(_QWORD *)Pool2 = a1;
  ...
  {
    v11[1].Alignment = 0LL;
    v11->Region = (ULONGLONG)v11;
    v11->Alignment = (ULONGLONG)v11;
  ...
  if ( v14 )
  {
    while ( 1 )
    {
      ...
      if ( !v15 )
        break;
      *(_DWORD *)(v15 + 24) = 0;
      ExpInterlockedPushEntrySList(v10 + 1, (PSLIST_ENTRY)v15);
      if ( ++v13 >= v14 )
        goto LABEL_19;
    }
    sub_140883876(v10);
