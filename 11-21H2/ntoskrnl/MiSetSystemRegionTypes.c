/*
 * XREFs of MiSetSystemRegionTypes @ 0x140B077D4
 * Callers:
 *     MiInitializeSystemVa @ 0x140B071D0 (MiInitializeSystemVa.c)
 * Callees:
 *     MiConvertAssignedRegionToVaType @ 0x140B07854 (MiConvertAssignedRegionToVaType.c)
 */
...
unsigned __int64 MiSetSystemRegionTypes()
{
  ...
  do
  {
    v2 = MiConvertAssignedRegionToVaType((unsigned int)v0, v0, (((unsigned __int64)*(v1 - 1) >> 39) & 0x1FF) - 256);
    for ( i = *v5 >> 39; i; --i )
    {
