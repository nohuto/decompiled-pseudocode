/*
 * XREFs of sub_1406AA3A0 @ 0x1406AA3A0
 * Callers:
...
__int64 __fastcall sub_1406AA3A0(unsigned __int16 *a1, unsigned int *a2, char a3, char a4)
{
  ...
  while ( v4 < v5 >> 1 )
  {
    ...
    *a2 = v4 + 1;
    ...
    if ( v6 != 46 )
    {
      ...
      {
LABEL_7:
        v11 = *((_DWORD *)qword_140A38378 + ((unsigned __int64)v6 >> 5));
