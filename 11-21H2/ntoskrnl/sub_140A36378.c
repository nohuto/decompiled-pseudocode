/*
 * XREFs of sub_140A36378 @ 0x140A36378
 * Callers:
...
__int64 __fastcall sub_140A36378(__int64 a1, __int64 a2, _WORD *a3, __int64 a4)
{
  ...
  *(_DWORD *)(((unsigned __int64)v21 & 0xFFFFFFFFFFFFFFE0uLL) + 0x10) = 0;
  ...
  {
    result = sub_1407F4A10((_WORD *)((unsigned __int64)v21 & 0xFFFFFFFFFFFFFFE0uLL));
    if ( (int)result < 0 )
      return result;
    if ( (int)sub_14082EFE4(a1, (_WORD *)(v4 + 8), (_WORD *)(v4 + 12)) >= 0 )
    {
      ...
      if ( RtlLCIDToCultureName(v13, (PUNICODE_STRING)(v4 + 24)) )
      {
        if ( ZwQueryValueKey(
               *(HANDLE *)(((unsigned __int64)v21 & 0xFFFFFFFFFFFFFFE0uLL) + 0x30),
               ...
               0x200u,
               (PULONG)(v4 + 4)) >= 0
          && (int)sub_140A367B0(a1, v4 + 256, v14, v4 + 944) >= 0
          && (int)sub_140A35D9C((__int64 *)a1, a3, 0, v4 + 256, (wchar_t *)(v4 + 944)) >= 0 )
        {
          v11 = 1;
          v9 = -1LL;
          do
  ...
  *(_DWORD *)(((unsigned __int64)v21 & 0xFFFFFFFFFFFFFFE0uLL) + 4) = 170;
  if ( (int)sub_140830280(v16, (PUNICODE_STRING)(v4 + 24), (_DWORD *)(v4 + 12), (void *)(v4 + 64), (ULONG *)(v4 + 4)) >= 0
    && *(_DWORD *)(((unsigned __int64)v21 & 0xFFFFFFFFFFFFFFE0uLL) + 0xC) == 1
    && (!(_DWORD)v9
          ...
          1u)) )
  {
    ...
    *(_DWORD *)(((unsigned __int64)v21 & 0xFFFFFFFFFFFFFFE0uLL) + 4) = 512;
    if ( ZwQueryValueKey(
      ...
      && (int)sub_140A35D9C((__int64 *)a1, a3, v11, v4 + 256, 0LL) >= 0 )
    {
      ++v11;
      do
        ++v15;
...
LABEL_42:
        if ( (int)sub_140A35D9C((__int64 *)a1, a3, v11, v4 + 256, 0LL) >= 0 )
          ++v11;
      }
    }
    v16 = *(void **)(((unsigned __int64)v21 & 0xFFFFFFFFFFFFFFE0uLL) + 0x30);
