/*
 * XREFs of sub_14061C0F0 @ 0x14061C0F0
 * Callers:
 *     <none>
 * Callees:
...
NTSTATUS __fastcall sub_14061C0F0(
...
LABEL_18:
  result = RtlUpcaseUnicodeStringToCountedOemString(DestinationString, SourceString, AllocateDestinationString);
  LODWORD(v20) = result;
  if ( v8 )
  {
    v16 = (_QWORD **)(v8 + 6);
