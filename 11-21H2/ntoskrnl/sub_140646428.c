/*
 * XREFs of sub_140646428 @ 0x140646428
 * Callers:
...
__int64 __fastcall sub_140646428(int a1, unsigned int a2, unsigned int *a3, unsigned int a4, unsigned int *a5)
{
  int v6; // ecx
  int v7; // ecx
  int v8; // ecx
      ...
      if ( v8 )
      {
        ...
        if ( v9 )
        {
          ...
          if ( a4 >= 4 )
          {
            ...
            if ( a2 >= 4 )
            {
              v12 = sub_140643F2C((__int64)&unk_140CE1A98, *a3);
              if ( v12 )
              {
                if ( *((_DWORD *)v12 + 27) != 1 )
                {
                  v13 = PshedDisableErrorSource(v12 + 12);
LABEL_17:
                  v11 = v13;
                  goto LABEL_18;
                }
        ...
        else
        {
          ...
          if ( a4 >= 4 )
          {
            ...
            if ( a2 >= 4 )
            {
              v14 = sub_140643F2C((__int64)&unk_140CE1A98, *a3);
              if ( v14 )
              {
                if ( *((_DWORD *)v14 + 27) != 2 )
                {
...
LABEL_28:
    ...
    else
    {
      ...
      if ( a2 < 0x3D4 )
        goto LABEL_37;
      v29 = sub_140643F2C((__int64)&unk_140CE1A98, *a3);
      if ( !v29 )
        goto LABEL_35;
      *a3 = v11;
      v30 = v29 + 12;
