/*
 * XREFs of MmMapViewInSystemCache @ 0x140285D90
 * Callers:
...
__int64 __fastcall MmMapViewInSystemCache(__int64 a1, __int64 *a2, _QWORD *a3)
{
  ...
  v12 = MiOffsetToProtos(v6, *a3, &v33);
  result = MiAddViewsForSection(v12);
  if ( (int)result < 0 )
  {
    ++dword_140C53DA0;
    return result;
  ...
  {
    v17 = MiObtainSystemCacheView(*(_QWORD *)(qword_140C51F48 + 8 * v14));
    v15 = v17;
    if ( !v17 )
    {
      ++dword_140C53DA0;
      MiRemoveSystemCacheReferences(v12);
      return 3221225495LL;
    }
    *a2 = v17;
  }
  v19 = ((v15 >> 9) & 0x7FFFFFFFF8LL) - 0x98000000000LL + 8 * v11;
  SystemCacheReverseMap = (_QWORD *)MiGetSystemCacheReverseMap(v15, v18);
  v24 = *a3 >> 2;
  v25 = (unsigned __int64)(*v16 & 0x3FF) << 6;
  SystemCacheReverseMap[2] &= 0xFFFFFFFFFFFFFFFCuLL;
  SystemCacheReverseMap[3] = v12;
  for ( SystemCacheReverseMap[4] = v11 & 0x3F | SystemCacheReverseMap[4] & 0xC000000000000000uLL | v24 & 0x3FFFFFFFFFFF0000LL | v25;
  ...
  v32 = SystemCacheReverseMap[4] | 0xC000000000000000uLL;
  v30 = 0LL;
  v31 = 0LL;
  SystemCacheReverseMap[4] = v32;
