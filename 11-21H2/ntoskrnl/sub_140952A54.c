/*
 * XREFs of sub_140952A54 @ 0x140952A54
 * Callers:
...
NTSTATUS __fastcall sub_140952A54(__int64 a1, __int64 a2, int a3)
{
  __int64 v3; // rax
  ULONG v4; // ecx
  __int64 v5; // rax
  ...
  v24 = 4LL;
  v26 = 4LL;
  return EtwWrite(qword_140C54EA8, &stru_14003B210, 0LL, 7u, &UserData);
}
