/*
 * XREFs of sub_1403865C4 @ 0x1403865C4
 * Callers:
...
__int64 __fastcall sub_1403865C4(__int64 a1, int a2, __int64 a3, unsigned int *a4)
{
  ...
  else
  {
    ...
    *(_DWORD *)(a3 + 120) = *(_DWORD *)(a1 + 2856) - v18;
    ...
    if ( !a2 )
      goto LABEL_10;
    sub_1405F836C(a3 + 188, a1 + 4280);
    sub_1405FAF84(a3 + 1472, v25, *(_QWORD *)(a1 + 5600), *(unsigned int *)(a1 + 5592));
    if ( a2 == 1 )
      goto LABEL_10;
    v26 = *(_WORD **)(a1 + 56);
    ...
    *(_DWORD *)(v30 + 8) = v31;
    v32 = v31 >> 4;
    result = sub_1405F9270(a1 + 80, v32, v30 + 12, &v33);
    if ( (int)result >= 0 )
    {
      *(_QWORD *)v30 = v33;
      result = sub_1405F9270(a1 + 2016, v32, v30 + 12, &v33);
      if ( (int)result >= 0 )
      {
LABEL_10:
        *v34 = v8;
