/*
 * XREFs of sub_140389ADC @ 0x140389ADC
 * Callers:
...
NTSTATUS sub_140389ADC(__int64 a1, __int64 a2, __int64 a3, ...)
{
  ...
  v39 = 8LL;
  v41 = 4LL;
  return sub_1402D1760(qword_140C03820, (const EVENT_DESCRIPTOR *)qword_14000EE08, 0LL, 0x13u, &v5);
}
