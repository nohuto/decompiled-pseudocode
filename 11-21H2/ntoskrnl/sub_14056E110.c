/*
 * XREFs of sub_14056E110 @ 0x14056E110
 * Callers:
...
__int64 __fastcall sub_14056E110(__int64 a1, __int64 a2, int *a3, char a4, unsigned __int64 *a5)
{
  __int64 v8; // rsi
  __int64 i; // rcx
  ...
  {
    if ( v11 == 2 )
      return sub_1409BFF78(v8, 2LL, 0LL);
    if ( v11 != 3 )
      return 3221225485LL;
  }
  if ( !v10 )
  ...
  if ( !v11 )
  {
    result = sub_1409BFF78(v8, 0LL, &v15);
    if ( (int)result >= 0 )
      return result;
  }
  if ( a4 && *a3 != 1 )
  {
    if ( (_BYTE)v16 )
      goto LABEL_25;
    v13 = sub_1405EEB40(v8, &v15, (char *)&v15 + 8);
    v14 = v16;
    if ( v13 >= 0 )
      v14 = 1;
    LOBYTE(v16) = v14;
