/*
 * XREFs of sub_140613660 @ 0x140613660
 * Callers:
 *     <none>
 * Callees:
...
BOOLEAN __fastcall sub_140613660(PKDEVICE_QUEUE DeviceQueue, PKDEVICE_QUEUE_ENTRY DeviceQueueEntry, ULONG SortKey)
{
  __int64 v6; // rdx
  __int64 v7; // rcx
  __int64 *v8; // rdi
...
LABEL_12:
  *(_QWORD *)&v18 = v12;
LABEL_13:
  *((_QWORD *)&v19 + 1) = DeviceQueue;
  *(_QWORD *)&v19 = DeviceQueueEntry;
  DWORD2(v18) = SortKey;
...
LABEL_18:
  result = KeInsertByKeyDeviceQueue(DeviceQueue, DeviceQueueEntry, SortKey);
  LOBYTE(v20) = result;
  if ( v8 )
  {
    v16 = (_QWORD **)(v8 + 6);
