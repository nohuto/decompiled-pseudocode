/*
 * XREFs of KiInvokeBugCheckAddTriageDumpDataCallbacks @ 0x140567DA0
 * Callers:
  ...
  if ( KeBugCheckReasonCallbackListHead && qword_140C2B818 )
  {
    ...
    while ( 1 )
    {
      ...
      if ( (_BYTE)v0 )
      {
        ...
        *((_QWORD *)&v6 + 1) = qword_140C2BD88;
        v7 = xmmword_140C2BD90;
        v8 = qword_140C2BDA0;
          ...
          && (LOBYTE(v0) = KiValidateComponentName((STRSAFE_PCNZCH)v1[3]), (_BYTE)v0) )
        {
          ...
          *(_DWORD *)(v5 + 32) = 1;
          v0 = v5;
          v3 = (__int64 *)qword_140C2B828;
          if ( *(__int64 **)qword_140C2B828 != &KeBugCheckTriageDumpDataArrayListHead )
            __fastfail(3u);
