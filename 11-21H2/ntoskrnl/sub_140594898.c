/*
 * XREFs of sub_140594898 @ 0x140594898
 * Callers:
...
char *__fastcall sub_140594898(signed __int16 **a1, unsigned int a2)
{
  __int64 v2; // rbx
  __int64 v3; // rdi
  char *result; // rax
  ...
  v3 = a2;
  v18 = 0LL;
  result = (char *)sub_1402828F0(64, 8 * (a2 >> 12) + 320, 0x7343694Du);
  v6 = result;
  if ( result )
  {
    sub_14033C4D0((__int64)result, 0);
    ...
    *((_WORD *)v6 + 141) |= 0x4042u;
      ...
      if ( v8 )
      {
        if ( v2 != *((_QWORD *)v9 + 12) )
        {
          *((_WORD *)v6 + 141) &= ~0x4000u;
          ...
          memset64(v7, qword_140C53288, v14);
          v7 += 8 * v14;
          v2 += v13;
          v8 += v13;
        }
    ...
    v17 = sub_140342C50(FileObject, (__int64)(v6 + 272), &v18, (__int64)(v6 + 32), (__int64)(v6 + 80), 6, 0LL);
    if ( v17 < 0 )
    {
      *((_QWORD *)v6 + 11) = 0LL;
      *((_DWORD *)v6 + 20) = v17;
