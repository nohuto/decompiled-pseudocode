/*
 * XREFs of ?RtlStringCbCopyUnicodeString@@YAJPEAG_KPEBU_UNICODE_STRING@@@Z @ 0x1405FB148
 * Callers:
 *     SmKmKeyGenStart @ 0x1409D618C (SmKmKeyGenStart.c)
 * Callees:
 *     RtlUnicodeStringValidateSrcWorker @ 0x1405FB1F8 (RtlUnicodeStringValidateSrcWorker.c)
 */
