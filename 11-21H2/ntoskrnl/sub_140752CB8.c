/*
 * XREFs of sub_140752CB8 @ 0x140752CB8
 * Callers:
...
__int64 __fastcall sub_140752CB8(int *a1, unsigned int a2, unsigned __int64 *a3)
{
  ...
  *((_QWORD *)a1 + 5) = v3;
  ...
  {
    v11 = RegHandle;
    if ( EtwEventEnabled(RegHandle, &stru_14000FF88) )
    {
      UserData.Reserved = 0;
      v21 = 0;
      v24 = 0;
      ...
      v29 = 4;
      v16 = v9;
      EtwWrite(v11, &stru_14000FF88, 0LL, 5u, &UserData);
    }
  }
  return v5;
}
