/*
 * XREFs of PpmParkDistributeUtility @ 0x140293CD0
 * Callers:
 *     PpmParkDistributeAllUtility @ 0x140293C40 (PpmParkDistributeAllUtility.c)
 *     PpmHeteroDistributeUtility @ 0x1405D7FF0 (PpmHeteroDistributeUtility.c)
 * Callees:
 *     KeEnumerateNextProcessor @ 0x140294050 (KeEnumerateNextProcessor.c)
 *     KeGetPrcb @ 0x140348800 (KeGetPrcb.c)
 *     PpmHeteroNormalizedUtilityToUtility @ 0x1405D837C (PpmHeteroNormalizedUtilityToUtility.c)
 */
...
LABEL_3:
    ...
    v60 = v15 & ~(1LL << v16);
    v67 = KiProcessorNumberToIndexMappingTable[64 * v61 + (unsigned __int8)v16];
    if ( v67 >= (unsigned int)KeNumberProcessors_0 )
      v17 = 0LL;
    else
      v17 = KiProcessorBlock[v67];
    if ( *(_BYTE *)(v17 + 34056) )
    {
      ++v12;
      v13 |= *(_QWORD *)(v17 + 200);
  ...
  {
    Prcb = (_DWORD *)KeGetPrcb(v67);
    v44 = Prcb[8502] - Prcb[8503];
    if ( PpmHeteroImplementationGeneration )
    {
      v45 = Prcb[8507];
      if ( v45 )
  ...
  if ( !v25 )
  {
    ...
    while ( !(unsigned int)KeEnumerateNextProcessor(&v67, &v59) )
    {
      v46 = KeGetPrcb(v67);
      v14 ^= *(_QWORD *)(v46 + 200);
      v47 = PpmHeteroNormalizedUtilityToUtility(v46 + 33968, v24);
...
LABEL_24:
    ...
    v60 = v28 & ~(1LL << v30);
    v67 = KiProcessorNumberToIndexMappingTable[64 * v61 + (unsigned __int8)v30];
    if ( v67 >= (unsigned int)KeNumberProcessors_0 )
      v31 = 0LL;
    else
      v31 = KiProcessorBlock[v67];
...
LABEL_38:
    ...
    v60 = v14 & ~(1LL << v37);
    v67 = KiProcessorNumberToIndexMappingTable[64 * v61 + (unsigned __int8)v37];
    if ( v67 >= (unsigned int)KeNumberProcessors_0 )
      v38 = 0LL;
    else
      v38 = KiProcessorBlock[v67];
