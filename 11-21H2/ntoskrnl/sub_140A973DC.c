/*
 * XREFs of sub_140A973DC @ 0x140A973DC
 * Callers:
...
__int64 sub_140A973DC()
{
  ...
  dword_140C1ACDC = 0;
  qword_140C1ACE8 = (__int64)&qword_140C1ACE0;
  qword_140C1ACE0 = &qword_140C1ACE0;
  ...
  __writecr8(v1);
  if ( dword_140C0C830 != -1 && (unsigned int)(dword_140C0C830 - 2) <= 0xFE )
    return (unsigned int)sub_140A96F60(word_140C1ABA0, ((unsigned __int64)(unsigned int)dword_140C0C830 - 2) >> 1);
  return v0;
}
