/*
 * XREFs of IopAddMiniDumpPagesToPartialKernelDump @ 0x14055D2EC
 * Callers:
        ...
        unsigned int a8)
{
  ...
  v15[3] = v10;
  IopUpdateMinidumpContext(a1, a2, a3, a4, a5, a6, a7, v12, 0);
    ...
    if ( (int)result >= 0 )
    {
        ...
        || (result = IopMarkPagesForRunTimeTriageDataBlocks(v15, a6, v13, v13 + a8), (int)result >= 0) )
      {
        ...
        if ( (int)result >= 0 )
        {
          ...
          if ( (int)result >= 0 )
          {
            result = MmAddRangeToCrashDump(v15, a7, 2288LL);
            if ( (int)result >= 0 )
            {
