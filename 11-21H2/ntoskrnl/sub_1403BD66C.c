/*
 * XREFs of sub_1403BD66C @ 0x1403BD66C
 * Callers:
...
__int64 __fastcall sub_1403BD66C(__int64 a1)
{
  unsigned int v1; // edi
  int v3; // ebx
  int v4; // r15d
  ...
  v1 = 0;
  if ( !byte_140C097A4 || HIDWORD(KeGetPcr()[1].LockArray) )
  {
  ...
  else
  {
    ...
    if ( v3 < v4 && (v5 = *(_DWORD *)(a1 + 12)) != 0 )
    {
      ...
      if ( v7 )
      {
        ...
        v11 = *(_DWORD *)(a1 + 24);
        if ( v11 == -1 || !sub_1402523CC(v11, v4 + v11 - v3) )
        {
          v12 = v4 - v3;
          if ( *((_DWORD *)v8 + 56) == 2 && v11 != -1 )
          {
            ...
            if ( dword_140C4AD5C )
            {
              while ( *(_DWORD *)(qword_140C4AD50 + 16LL * v26) != v6
                   || v12 <= *(_DWORD *)(qword_140C4AD50 + 16LL * v26 + 12) )
              {
                if ( ++v26 >= dword_140C4AD5C )
                  goto LABEL_12;
              }
              v12 = *(_DWORD *)(qword_140C4AD50 + 16LL * v26 + 12);
            }
...
LABEL_12:
          if ( v5 == 7 )
            ...
            v13 = 0;
          v14 = (_DWORD *)sub_1403BF104(v13 + 8 * (v12 + 8 * v12 + 11), 1LL);
          v15 = v14;
          if ( v14 )
          {
            memset(v14, 0, v13 + 8 * (v12 + 8 * v12 + 11));
            if ( v13 )
            {
              v15[18] = v12;
