/*
 * XREFs of sub_1406BE584 @ 0x1406BE584
 * Callers:
...
__int64 __fastcall sub_1406BE584(__int64 a1, _OWORD *a2)
{
  _OWORD *v2; // rbx
  __int64 result; // rax
  _QWORD *v5; // rcx
  ...
  v9[1] = (unsigned __int16 *)qword_140D06E48[0];
  v9[0] = (unsigned __int16 *)dword_140D06E40;
  v10 = 0;
  while ( 1 )
  {
    ...
    if ( (_DWORD)result )
      break;
    sub_140242E98(qword_140D088C0[v8], v13);
    v5 = a2;
    v6 = 4LL;
    do
    {
