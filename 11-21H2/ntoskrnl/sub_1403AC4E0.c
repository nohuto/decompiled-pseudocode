/*
 * XREFs of sub_1403AC4E0 @ 0x1403AC4E0
 * Callers:
...
signed __int64 __fastcall sub_1403AC4E0(__int64 a1)
{
  __int64 v2; // rax
  ...
  v9 = 0LL;
  v10 = 0LL;
  sub_140339140(0xAAAAAAAAAAAAAAABuLL * ((a1 + 0x220000000000LL) >> 4), 0LL, (__int64 *)&v8);
  ...
  result = v8;
  v6 = *(_QWORD *)(v8 + 16) + 24512LL * DWORD2(v8) + 88 * (DWORD2(v9) + 8LL * HIDWORD(v9) + 37);
  ...
  if ( v3 == 0x3FFFFFFFFFLL )
    *(_QWORD *)(v6 + 16) = v4;
    ...
    result = sub_1403385E0(48 * v3 - 0x220000000000LL, v4);
