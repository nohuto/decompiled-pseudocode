/*
 * XREFs of sub_1409303C0 @ 0x1409303C0
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall sub_1409303C0(__int64 a1, LARGE_INTEGER a2, ULONG a3, void *a4)
{
  PIRP v5; // rax
  IRP *v6; // rbx
  unsigned int v7; // edi
  ...
  v9 = a2;
  v5 = IoBuildAsynchronousFsdRequest(3u, *(PDEVICE_OBJECT *)(a1 + 376), a4, a3, &v9, 0LL);
  v6 = v5;
  if ( v5 )
  {
