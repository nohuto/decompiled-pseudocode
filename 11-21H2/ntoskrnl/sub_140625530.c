/*
 * XREFs of sub_140625530 @ 0x140625530
 * Callers:
 *     <none>
 * Callees:
...
NTSTATUS __fastcall sub_140625530(
...
LABEL_12:
  *(_QWORD *)&v21 = v15;
LABEL_13:
  *((_QWORD *)&v21 + 1) = ResultDataSize;
  *((_QWORD *)&v23 + 1) = ValueName;
  *(_QWORD *)&v23 = Type;
  *((_QWORD *)&v22 + 1) = Data;
  LODWORD(v22) = DataSize;
...
LABEL_18:
  result = ZwQueryLicenseValue(ValueName, Type, Data, DataSize, ResultDataSize);
  LODWORD(v24) = result;
  if ( v11 )
  {
    v19 = (_QWORD **)(v11 + 6);
