/*
 * XREFs of sub_140953D38 @ 0x140953D38
 * Callers:
...
__int64 __fastcall sub_140953D38(unsigned __int64 a1, unsigned int a2, int a3, __int64 a4)
{
  char v5; // r13
  int v6; // esi
  ...
  if ( v6 >= 0 )
  {
    ...
    *(_QWORD *)(a4 + 8) = 0LL;
    if ( v10 )
    {
      ...
      if ( v11 >= 2 )
      {
        v6 = sub_14077C610((void **)(a4 + 8), v10, v11, 2u, v5, 1);
        if ( v6 < 0 )
        {
          *v9 = 0LL;
          *(_DWORD *)(a4 + 16) = 0;
...
LABEL_27:
        ...
        *(_QWORD *)(a4 + 24) = 0LL;
        if ( v13 )
        {
          ...
          if ( v14 >= 2 )
          {
            v6 = sub_14077C610((void **)(a4 + 24), v13, v14, 2u, v5, 1);
            if ( v6 < 0 )
            {
              *v12 = 0LL;
              *(_DWORD *)(a4 + 32) = 0;
