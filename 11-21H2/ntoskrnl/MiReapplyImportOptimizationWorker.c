/*
 * XREFs of MiReapplyImportOptimizationWorker @ 0x1405A2710
 * Callers:
 *     <none>
 * Callees:
...
ULONG_PTR __fastcall MiReapplyImportOptimizationWorker(
        ULONG_PTR Argument,
        __int64 a2,
        __int64 a3,
        _DWORD *SchedulerAssist)
{
  ...
  else
  {
    *(_DWORD *)Argument = v10 | *(_DWORD *)(Argument + 4);
    ...
    v39 = *(_QWORD *)(v7 + 24);
    v38 = v12;
    IsVerifierApplicableToImage = MmIsVerifierApplicableToImage(v11);
...
LABEL_16:
      ...
      if ( v24 )
      {
        ...
        do
        {
          ...
          {
            MiApplyRetpolineFixups((v23 << 12) + v25, v27, (__int64)v28, v23 << 12, v27, v28, 0);
          }
          ++v23;
          v26 += 8LL;
        }
