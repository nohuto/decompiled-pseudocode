/*
 * XREFs of sub_1405B6828 @ 0x1405B6828
 * Callers:
...
void __fastcall sub_1405B6828(__int64 a1, int a2, int a3, __int64 a4, int a5)
{
  __int64 v7; // r8
  int v8; // r9d
  __int64 v9; // r10
  ...
  if ( *(_QWORD *)&qword_140C53448 && **(_DWORD **)&qword_140C53448 > 5u )
  {
    if ( sub_1402A2000(*(__int64 *)&qword_140C53448, 2LL) )
    {
      ...
      v14 = a2;
      v15 = a3;
      sub_14024A9B0(v9, (unsigned __int8 *)&byte_14002DE9D, v7, 1u, v12, v13, 8u, &v20);
    }
  }
}
