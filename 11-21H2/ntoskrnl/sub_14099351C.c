/*
 * XREFs of sub_14099351C @ 0x14099351C
 * Callers:
...
char __fastcall sub_14099351C(unsigned __int16 a1, __int64 a2, int a3, const EVENT_DESCRIPTOR *a4)
{
  _UNKNOWN **v4; // rax
  int v7; // edi
  ...
  if ( byte_140C5AE14 )
  {
    LOBYTE(v4) = EtwEventEnabled(RegHandle, a4);
    if ( (_BYTE)v4 )
    {
      UserData.Reserved = 0;
      v13 = 0;
      ...
      v15 = 8;
      v18 = 4;
      LOBYTE(v4) = EtwWrite(RegHandle, a4, 0LL, 4u, &UserData);
    }
  }
  return (char)v4;
}
