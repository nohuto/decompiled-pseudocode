/*
 * XREFs of PpDevCfgProcessDeviceExtensions @ 0x14094ED84
 * Callers:
...
__int64 __fastcall PpDevCfgProcessDeviceExtensions(__int64 a1)
{
  ...
  *(_QWORD *)&UnicodeString.Length = 0LL;
  ...
  v44 = 0LL;
  v43 = 6;
  inited = PiDevCfgQueryObjectProperties(1LL, v8, 1, v49[2], (__int64)&v39, 1u);
  if ( inited < 0 )
    goto LABEL_64;
  if ( (int)v44 < 0 )
  ...
  do
  {
    ...
    inited = PiDevCfgAppendMultiSz(v12, (const void **)v9 + 49, 0LL, v11);
    if ( inited < 0 )
      goto LABEL_64;
LABEL_27:
    v9 = (_QWORD *)*v9;
  ...
  *((_QWORD *)&v51 + 1) = &v48;
  do
  {
    ...
    {
      v17 = *(_QWORD *)(a1 + 48);
      v18 = *(__int64 **)((char *)&off_140D3B698 + v13);
      v42 = 0;
      v44 = 0LL;
      v39 = v18;
      ...
      v40 = 8210LL;
      v43 = 6;
      inited = PiDevCfgQueryObjectProperties((__int64)Buffer, v17, 1, v7, (__int64)&v39, 1u);
      if ( inited < 0 )
        goto LABEL_64;
      if ( (int)v44 < 0 )
