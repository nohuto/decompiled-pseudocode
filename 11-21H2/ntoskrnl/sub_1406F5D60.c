/*
 * XREFs of sub_1406F5D60 @ 0x1406F5D60
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall sub_1406F5D60(int a1, __int64 a2, __int64 a3, _DWORD *a4, int *a5, int a6)
{
  ...
  v14 = a3;
  v15 = a4;
  v9 = (POBJECT_TYPE *)qword_140D07490[(unsigned __int8)dword_140D06C0C ^ v8];
  v10 = *a5;
  v17 = a6;
  v16 = v10;
  ...
  {
    v11 = 37LL;
    return (unsigned int)sub_1406F83A0(v11, v13, 1LL, &v18);
  }
