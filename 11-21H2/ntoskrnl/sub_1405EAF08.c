/*
 * XREFs of sub_1405EAF08 @ 0x1405EAF08
 * Callers:
...
__int64 __fastcall sub_1405EAF08(__int64 a1, unsigned __int8 a2, __int64 a3, __int64 a4, unsigned __int16 a5, int a6)
{
  char v7; // cl
  char v8; // r15
  __int64 v10; // rsi
