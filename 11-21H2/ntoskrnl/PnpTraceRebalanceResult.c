/*
 * XREFs of PnpTraceRebalanceResult @ 0x1409576F0
 * Callers:
...
char __fastcall PnpTraceRebalanceResult(unsigned int a1, int a2, int *a3)
{
  __int64 v3; // r14
  __int64 v5; // rdi
  __int64 v6; // r13
  ...
  if ( v9 )
    ...
    v12 = &PnpEmptyUnicodeString;
  if ( a2 < 0 )
  {
    result = byte_140C0DD4B;
    if ( byte_140C0DD4B < 0 )
      result = McTemplateK0zzqqzttquqqzx_EtwWriteTransfer(
  ...
  {
    result = McTemplateK0zzqqzttqux_EtwWriteTransfer(
               *((unsigned __int8 *)a3 + 48),
               *((unsigned __int8 *)a3 + 32),
               (__int64)v12,
               *(const wchar_t **)(v5 + 48),
  ...
  {
    result = tlgKeywordOn((__int64)&dword_140C06550, 0x400000000000LL);
    if ( result )
    {
      v20 = 0x1000000LL;
      v24 = &v20;
      ...
      return tlgWriteTransfer_EtwWriteTransfer(
               ...
               (unsigned __int8 *)&word_14002C116,
               0LL,
               0LL,
               0x11u,
               &v23);
