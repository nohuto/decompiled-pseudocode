/*
 * XREFs of sub_1409E0CE8 @ 0x1409E0CE8
 * Callers:
...
NTSTATUS sub_1409E0CE8(_DWORD a1, _DWORD a2, _DWORD a3, unsigned __int16 *a4, unsigned __int16 *a5, char a6, ...)
{
  ...
  v18 = 4LL;
  v20 = 4LL;
  return EtwWrite(qword_140C15FA8, &stru_1400396D0, 0LL, 7u, &UserData);
}
