/*
 * XREFs of sub_14074CC34 @ 0x14074CC34
 * Callers:
...
__int64 __fastcall sub_14074CC34(int *a1, unsigned int a2, int a3, unsigned int a4, __int64 a5)
{
...
LABEL_27:
            v17 = v14;
            sub_140947068(v13, v16, 3221487672LL, v9, v15);
            return 0LL;
          }
          if ( v11 == 92 )
          {
