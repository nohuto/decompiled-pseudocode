/*
 * XREFs of _woutput_s @ 0x1403E85A8
 * Callers:
 ...
 *     write_char_1 @ 0x1403E8ED8 (write_char_1.c)
...
__int64 __fastcall woutput_s(__int64 a1, unsigned __int16 *a2, int *a3)
{
  ...
  do
  {
    ...
    v13 = *((unsigned __int8 *)_lookuptable_s + (unsigned int)(v15 + v13 + 8 * v15)) >> 4;
    v62 = v13;
    switch ( v13 )
    {
      case 8:
