/*
 * XREFs of sub_14076651C @ 0x14076651C
 * Callers:
...
__int64 __fastcall sub_14076651C(__int64 a1, __int64 a2, int a3, char a4, int a5, int a6, ULONG_PTR a7, __int64 a8)
{
  int v8; // edi
  __int64 v12; // rsi
  ULONG_PTR v13; // rbx
  ...
  if ( *(_BYTE *)(a2 + 8) )
  {
    v18 = 0;
    v17 = (a3 == 1) + 1;
    while ( (unsigned __int8)sub_1407667B0(a2, (unsigned int)&v17, (unsigned int)&v19, (unsigned int)&v20, 0LL) )
    {
      if ( v20 || a4 )
      {
        v12 = v19;
        ...
        if ( (unsigned int)(a3 - 2) <= 1 )
          sub_140749ECC(v13, 0LL);
        v8 = sub_140766834(v13, a7, a8);
        if ( v8 < 0 )
        {
          if ( (*(_DWORD *)(v13 + 704) & 4) == 0 )
            KeBugCheckEx(0xCAu, 0xDuLL, v13, 4uLL, 0LL);
          sub_1402D25CC(*(_QWORD *)(v13 + 32));
          *(_DWORD *)(v13 + 704) &= ~4u;
          if ( v17 == 1 && v18 )
          {
            v15 = *(_DWORD **)a2;
          ...
          while ( (unsigned __int8)sub_1407667B0(a2, (unsigned int)&v17, (unsigned int)&v19, 0, 0LL) )
          {
            if ( v12 != v19 )
            {
              if ( v19 )
