/*
 * XREFs of sub_140247B20 @ 0x140247B20
 * Callers:
...
__int64 __fastcall sub_140247B20(__int64 a1, unsigned int a2, unsigned int *a3)
{
  ...
  v10 = 0;
  if ( v9 != v8 && (~*((_DWORD *)qword_140015FA0 + (v5 & 0x1F)) & *v9) == 0 )
  {
    v5 = v5 - (v5 & 0x1F) + 32;
    for ( ++v9; v9 < v8 && !*v9; ++v9 )
      v5 += 32;
  ...
  if ( v9 == v8 )
    goto LABEL_9;
  v11 = v5 & 0x1F;
  if ( (*v9 | *((_DWORD *)qword_140015FA0 + (v5 & 0x1F))) != -1 )
    goto LABEL_9;
  v10 = 32 - v11;
  if ( v11 != 33 )
  {
