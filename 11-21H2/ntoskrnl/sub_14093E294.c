/*
 * XREFs of sub_14093E294 @ 0x14093E294
 * Callers:
...
__int64 __fastcall sub_14093E294(HANDLE FileHandle, __int64 a2, LARGE_INTEGER *a3, _QWORD *a4, __int64 a5)
{
  __int128 *v5; // rbx
  __int64 v6; // rdi
  int v10; // ecx
  ...
  if ( v5 )
  {
    ...
    v16 = NtBuildNumber;
    v10 = sub_14093D4CC(FileHandle, Buffer, 0x10u, a3, a5, 0);
    if ( v10 >= 0 )
    {
      v20 = 0;
      v11 = 32;
      ...
      for ( i = 32; ; v11 = i )
      {
        v18 = *v5;
        v19 = *((_DWORD *)v5 + 6);
        v10 = sub_14093D4CC(FileHandle, &i, v11, a3, a5, 0);
        if ( v10 < 0 )
          break;
        v6 += i;
        v10 = sub_14093D4CC(FileHandle, *((PVOID *)v5 + 2), *((_DWORD *)v5 + 6), a3, a5, 0);
        if ( v10 < 0 )
          break;
