/*
 * XREFs of sub_14093F260 @ 0x14093F260
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall sub_14093F260(__int64 a1, __int64 a2, _WORD *a3, _OWORD *a4, void *a5, _DWORD *a6, _DWORD *a7)
{
  __int64 v9; // rax
  ...
  if ( Pool2 )
  {
    ...
    *v15 = *a4;
    ...
    if ( v18 )
    {
      v16 = sub_14055C25C(0, a1, a2, (__int64)v15, v13, v18, v17, 0x18u, v21);
      if ( v16 >= 0 )
      {
        if ( *(_QWORD *)v18 )
        {
