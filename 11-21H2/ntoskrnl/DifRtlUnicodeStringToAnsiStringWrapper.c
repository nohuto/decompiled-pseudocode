/*
 * XREFs of DifRtlUnicodeStringToAnsiStringWrapper @ 0x14061BBF0
 * Callers:
 *     <none>
 * Callees:
...
NTSTATUS __fastcall DifRtlUnicodeStringToAnsiStringWrapper(
        ...
        BOOLEAN AllocateDestinationString)
{
  ...
  v17 = 0LL;
  v18 = 0LL;
  APIThunkContextById = DifGetAPIThunkContextById(425);
...
LABEL_18:
  result = RtlUnicodeStringToAnsiString(DestinationString, SourceString, AllocateDestinationString);
  LODWORD(v19) = result;
  if ( APIThunkContextById )
  {
