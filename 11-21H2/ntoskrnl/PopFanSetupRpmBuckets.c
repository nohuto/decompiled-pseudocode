/*
 * XREFs of PopFanSetupRpmBuckets @ 0x140999230
 * Callers:
...
LABEL_23:
          v22 = 8LL;
          return tlgWriteTransfer_EtwWriteTransfer((__int64)&dword_140C03A00, v16, 0LL, 0LL, v17, v20);
        }
        ...
        *(_DWORD *)(a1 + 128) = v5;
        if ( (unsigned int)dword_140C03A00 > 4 )
        {
          ...
          result = tlgWriteTransfer_EtwWriteTransfer(
                     ...
                     (unsigned __int8 *)byte_140031621,
                     0LL,
                     0LL,
                     6u,
                     v20);
