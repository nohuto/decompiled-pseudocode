/*
 * XREFs of KiInitDynamicTraceSupport @ 0x140B30F84
 * Callers:
...
__int64 KiInitDynamicTraceSupport()
{
  ...
  if ( !(_BYTE)KdDebuggerNotPresent )
    v0 = 5;
  v1 = v0 | 2;
  result = TraceInitSystem(&v5, KiDynamicTraceCallouts, &qword_140D070E8);
  if ( (int)result >= 0 )
  {
    v3 = RtlLookupFunctionEntry(qword_140D070E8, &v4, 0LL);
    if ( v3 )
    {
      qword_140D070E8 = v4 + *v3;
      qword_140D070F0 = v4 + v3[1];
    }
    result = (__int64)v5;
