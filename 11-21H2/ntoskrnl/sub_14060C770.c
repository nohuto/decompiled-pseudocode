/*
 * XREFs of sub_14060C770 @ 0x14060C770
 * Callers:
 *     <none>
 * Callees:
...
NTSTATUS __fastcall sub_14060C770(PIO_REMOVE_LOCK RemoveLock, PVOID Tag, PCSTR File, ULONG Line, ULONG RemlockSize)
{
  __int64 v9; // rdx
  __int64 v10; // rcx
  __int64 *v11; // rdi
