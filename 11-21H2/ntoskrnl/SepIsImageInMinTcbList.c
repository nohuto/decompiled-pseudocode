/*
 * XREFs of SepIsImageInMinTcbList @ 0x1406C2FDC
 * Callers:
...
LABEL_10:
    ...
    *a7 = *((_BYTE *)&SeProtectedMapping + 2 * v20);
    v25 = *((_BYTE *)&SeProtectedMapping + 2 * v20 + 1);
    goto LABEL_11;
  }
  v24 = a7;
...
LABEL_11:
  *a8 = v25;
  if ( !qword_140C1B8E0 || (LOBYTE(v20) = *v24, LOBYTE(v17) = a6, !(unsigned int)qword_140C1B8E0(v20, v17)) )
    *v24 = a6;
  if ( !qword_140C1B8E0 || (LOBYTE(v20) = *a8, LOBYTE(v17) = a6, !(unsigned int)qword_140C1B8E0(v20, v17)) )
    *a8 = a6;
  ...
  *a9 = v23;
  Handle = 0LL;
  if ( !v23 && !*a8 && (int)RtlpOpenImageFileOptionsKeyEx(&a3->Length, (__int64)v17, v18, &Handle) >= 0 )
  {
