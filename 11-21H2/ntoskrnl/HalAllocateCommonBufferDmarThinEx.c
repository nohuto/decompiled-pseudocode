/*
 * XREFs of HalAllocateCommonBufferDmarThinEx @ 0x140515D20
 * Callers:
 *     HalAllocateCommonBufferDmarThin @ 0x140515CF0 (HalAllocateCommonBufferDmarThin.c)
 * Callees:
...
__int64 __fastcall HalAllocateCommonBufferDmarThinEx(__int64 a1, __int64 a2, __int64 a3, _QWORD *a4, char a5, int a6)
{
  ...
  if ( (int)HalpAllocateCommonBufferDmarThin(*(_QWORD *)(a1 + 504), 0, (__int64)v8, a6, (__int64)a4, (__int64)v10) >= 0 )
    return v10[0];
  *a4 = 0LL;
  return v6;
}
