/*
 * XREFs of sub_1405EF160 @ 0x1405EF160
 * Callers:
...
_BYTE *__fastcall sub_1405EF160(unsigned __int64 a1, int a2, int a3, int a4, _WORD *a5, int a6, int a7)
{
  int v9; // ebx
  ...
  if ( !a7 )
    v9 = a2 + (*a5 & 0xFFF);
  sub_1405EF7C8(v9, a3, a4, (_DWORD)a5, a6, (__int64)&v11);
