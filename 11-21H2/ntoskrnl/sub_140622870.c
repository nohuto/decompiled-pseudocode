/*
 * XREFs of sub_140622870 @ 0x140622870
 * Callers:
 *     <none>
 * Callees:
...
NTSTATUS __fastcall sub_140622870(PHANDLE LinkHandle, ACCESS_MASK DesiredAccess, POBJECT_ATTRIBUTES ObjectAttributes)
{
  __int64 v6; // rdx
  __int64 v7; // rcx
  __int64 *v8; // rdi
...
LABEL_18:
  result = ZwOpenSymbolicLinkObject(LinkHandle, DesiredAccess, ObjectAttributes);
  LODWORD(v20) = result;
  if ( v8 )
  {
    v16 = (_QWORD **)(v8 + 6);
