/*
 * XREFs of sub_14051B8BC @ 0x14051B8BC
 * Callers:
...
char sub_14051B8BC(__int64 a1, void *a2, int a3, ...)
{
  _UNKNOWN **v3; // rax
  _UNKNOWN **v4; // rdx
  REGHANDLE v5; // rbx
  ...
  {
    v5 = qword_140C4C680;
    LOBYTE(v3) = EtwEventEnabled(qword_140C4C680, &stru_140011960);
    if ( (_BYTE)v3 )
    {
      UserData.Reserved = 0;
      v10 = 0;
      ...
      v12 = 4;
      v15 = 8;
      LOBYTE(v3) = EtwWriteEx(v5, &stru_140011960, 0LL, 0, 0LL, 0LL, 4u, &UserData);
    }
  }
  else if ( !qword_140D014D8 )
  {
    v3 = (_UNKNOWN **)sub_1403B1F04(a1, 32LL);
    qword_140D014D8 = (__int64)v3;
    v4 = v3;
    if ( v3 )
    {
      *(_OWORD *)v3 = 0LL;
