/*
 * XREFs of sub_14050B160 @ 0x14050B160
 * Callers:
 *     <none>
 * Callees:
 *     <none>
...
__int64 __fastcall sub_14050B160(__int64 a1, __int64 a2)
{
  __int64 v2; // rax
  __int64 result; // rax
  __int64 v6; // r11
  ...
  if ( !a1 )
  {
    ...
    v16 = 3 * v2;
    result = qword_140C4D0B8;
    v17 = (__int64 **)(qword_140C4D0B8 + 8 * v16);
    _disable();
    v18 = *v17;
    v7 = v28 & 0x200;
    while ( 1 )
...
LABEL_27:
  ...
  result = (__int64)&unk_140C4D060;
  if ( (_UNKNOWN *)a1 == &unk_140C4D060 )
    return result;
  _disable();
  v6 = 0LL;
  v7 = v28 & 0x200;
