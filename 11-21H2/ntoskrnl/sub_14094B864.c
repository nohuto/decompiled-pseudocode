/*
 * XREFs of sub_14094B864 @ 0x14094B864
 * Callers:
 ...
 *     sub_1405619DC @ 0x1405619DC (sub_1405619DC.c)
...
__int64 __fastcall sub_14094B864(__int64 *a1, __int64 a2, void *a3, int a4, PVOID **a5)
{
  ULONG v5; // r13d
  int v7; // r14d
  PVOID *v8; // rsi
  ...
  *(_QWORD *)&v74.Length = 0LL;
  ...
  Data = 0;
  ResultLength = 0;
  v9 = sub_1407333B0(a3, 4u, (unsigned __int64)&v83, 0x28u, &ResultLength);
  if ( v9 >= 0 )
  {
    if ( !DWORD1(v84) )
      goto LABEL_146;
...
LABEL_4:
    ...
    if ( !v12 || (v9 = RtlGUIDFromString(v12, &Guid), v9 >= 0) )
    {
      ...
      {
        v68 = v5;
        v58 = ZwEnumerateValueKey(KeyHandle, i, KeyValueFullInformation, (PVOID)v11, Length, &ResultLength);
        v9 = v58;
        if ( v58 == -2147483622 )
        {
          v9 = 0;
...
LABEL_118:
          ...
          while ( 2 )
          {
            ...
            if ( v50 != (PVOID)-1LL )
            {
              ...
              if ( v8[23] != v50 )
                goto LABEL_129;
              if ( (_BYTE)word_140C54E98 && *((_DWORD *)v49 + 44) && !*((_DWORD *)v8 + 44) )
              {
LABEL_128:
                v8 = v49;
              }
...
LABEL_129:
            ...
            if ( v49 == &P )
            {
              if ( v8 )
              {
                ...
                else if ( sub_14067B838(v8[5], L"Duplicate", 0, &Pool2) >= 0 )
                {
                  if ( sub_1402088DC(Pool2) && *(unsigned int *)((char *)v52 + v52[2]) )
                    *((_DWORD *)v8 + 4) |= 2u;
...
LABEL_146:
        ...
        if ( v58 < 0 )
          goto LABEL_118;
        if ( sub_1402088DC(v11) )
          v7 = *(_DWORD *)(*(unsigned int *)(v11 + 8) + v11);
        *(_WORD *)(v11 + 2 * ((unsigned __int64)*(unsigned int *)(v11 + 16) >> 1) + 20) = v14;
        if ( sub_140778D60((PCWSTR)(v11 + 20)) )
          goto LABEL_17;
        v15 = sub_14094CBE0(v70, v11 + 20, &v71);
        v58 = v15;
        v9 = v15;
        if ( v15 == -1073741772 )
        {
          v71 = 0LL;
          sub_14094B144(v70, (const WCHAR *)(v11 + 20));
LABEL_17:
          v7 = a4;
          goto LABEL_18;
        }
        ...
        *v17 = v16;
        ...
        do
        {
          v26 = sub_1405619DC(*v21, *(wchar_t **)((char *)v21 + v22 - 24));
          *(_WORD *)v25 = v26;
          if ( v26 != -1 )
            v20 |= *(_DWORD *)v24;
          v21 += 2;
...
LABEL_37:
        ...
        if ( v30 && *(_QWORD *)(v75 + 64) )
        {
          while ( 1 )
          {
            if ( !*v30 )
              goto LABEL_47;
            if ( sub_14039F184(*(PCWSTR *)(v31 + 64), v30) )
              break;
            v32 = -1LL;
            do
              ++v32;
...
LABEL_47:
        ...
        if ( *(_QWORD *)(v27 + 128) )
        {
          if ( (v59 & 0x100) == 0 )
          {
            ...
            v34 = *(_QWORD *)(v31 + 16);
            v35 = *(_QWORD *)(v31 + 8);
            v80[0] = qword_1400182A0;
            v80[2] = &DestinationString;
            LODWORD(v80[1]) = 18;
            HIDWORD(v80[3]) = 6;
            v58 = sub_140746CCC(v36, v35, 1, v34, (__int64)v80, 1u);
            v9 = v58;
            if ( v58 < 0 )
              goto LABEL_117;
            if ( SLODWORD(v80[4]) < 0 )
        ...
        if ( (v33 & 0x30) == 0 )
        {
          ...
          v37 = *(_QWORD *)(v31 + 16);
          v38 = *(_QWORD *)(v31 + 8);
          v80[0] = &stru_14000E0D8;
          v80[2] = &v65;
          v80[5] = qword_140010978;
          v80[7] = &String2;
          LODWORD(v80[1]) = 7;
          LODWORD(v80[3]) = 4;
          LODWORD(v80[6]) = 18;
          HIDWORD(v80[8]) = 6;
          v58 = sub_140746CCC(v39, v38, 1, v37, (__int64)v80, 2u);
          v9 = v58;
          if ( v58 < 0 )
            goto LABEL_117;
          if ( SLODWORD(v80[9]) < 0 )
        ...
        if ( *(_QWORD *)(v27 + 168) )
        {
          if ( (v33 & 2) == 0 )
          {
            ...
            if ( v42 )
            {
              ...
              if ( v43 )
              {
                if ( (int)sub_140745620(v43, (__int64)&UnicodeString) >= 0 )
                {
                  memset(v80, 0, sizeof(v80));
                  v80[0] = &qword_14000FD30;
                  v80[2] = &v74;
                  LODWORD(v80[1]) = 18;
                  HIDWORD(v80[3]) = 6;
                  v58 = sub_140746CCC(v44, (int)UnicodeString.Buffer, 8, 0LL, (__int64)v80, 1u);
                  v9 = v58;
                  if ( v58 < 0 )
                  {
LABEL_117:
