/*
 * XREFs of sub_14075E74C @ 0x14075E74C
 * Callers:
...
_QWORD *__fastcall sub_14075E74C(__int64 a1, void *a2, __int64 a3, int a4, __int128 *a5)
{
  _QWORD *result; // rax
  _QWORD *v8; // r14
  wchar_t *v9; // rax
  ...
  *((_QWORD *)&v24 + 1) = v10;
  ...
  LOWORD(v24) = 2 * v12;
  WORD1(v24) = 2 * v12;
  v13 = RtlLookupElementGenericTableAvl(&Table, &Buffer);
  if ( v13 )
  {
    v20 = *v13;
  ...
  if ( RtlNumberGenericTableElementsAvl(&Table) >= 0x100 )
  {
    v13 = ::Buffer;
    v19 = *(_QWORD *)::Buffer;
    if ( *((PVOID **)::Buffer + 1) != &::Buffer || *(PVOID *)(v19 + 8) != ::Buffer )
      goto LABEL_26;
    ::Buffer = *(PVOID *)::Buffer;
    *(_QWORD *)(v19 + 8) = &::Buffer;
    if ( v13 )
...
LABEL_24:
  ...
  *((_QWORD *)&v24 + 1) = result;
  if ( result )
  {
    ...
    result = RtlInsertElementGenericTableAvl(&Table, &Buffer, 0x38u, 0LL);
    if ( result )
    {
      v18 = (_QWORD *)qword_140D3CF50;
      if ( *(PVOID **)qword_140D3CF50 == &::Buffer )
      {
        *result = &::Buffer;
        result[1] = v18;
        *v18 = result;
        qword_140D3CF50 = (__int64)result;
        return result;
      }
LABEL_26:
      __fastfail(3u);
