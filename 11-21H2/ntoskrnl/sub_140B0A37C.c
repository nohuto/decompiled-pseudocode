/*
 * XREFs of sub_140B0A37C @ 0x140B0A37C
 * Callers:
...
PIMAGE_NT_HEADERS __fastcall sub_140B0A37C(__int64 a1)
{
  char *v1; // rbx
  ...
  if ( result->FileHeader.NumberOfSections )
  {
    do
    {
      ...
      else if ( (_DWORD)result == 1280266064 )
      {
        ...
        if ( v4[1] == 1162104643 )
        {
          qword_140C29888 = (__int64)&v1[v4[3]];
          if ( v5 < v6 )
            v5 = v6;
          result = (PIMAGE_NT_HEADERS)v5;
          qword_140C29880 = ((unsigned __int64)&v7[v5 + 4095] & 0xFFFFFFFFFFFFF000uLL) - 1;
        }
      }
      --NumberOfSections;
      v4 += 10;
