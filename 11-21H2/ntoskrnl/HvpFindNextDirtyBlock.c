/*
 * XREFs of HvpFindNextDirtyBlock @ 0x14079AE04
 * Callers:
 ...
 * Callees:
 *     HvpFindNextDirtyRun @ 0x1402E2A74 (HvpFindNextDirtyRun.c)
        ...
        char a7)
{
  ...
  if ( !a7 || (PoolWithTag = (char *)ExAllocatePoolWithTag(PagedPool, v14, 0x33354D43u)) != 0LL )
  {
    ...
    *a6 = v13 + 4096;
    ...
    if ( a7 )
    {
      memmove(PoolWithTag, (const void *)(BlockAddress + (unsigned int)((_DWORD)v19 << 9)), v22);
      v20 = v36;
      PoolWithTag += v22;
    }
    if ( v20 > v21 )
