/*
 * XREFs of FsRtlpOplockBreakByCacheFlags @ 0x1402A4E10
 * Callers:
 ...
 *     FsRtlpCheckSharingAgainstOplockOwner @ 0x1407F7D6C (FsRtlpCheckSharingAgainstOplockOwner.c)
 */
...
LABEL_55:
          if ( (a6 & 0x1000) != 0 )
          {
            ...
            while ( v40 != (_QWORD *)(a1 + 40) )
            {
              ...
              {
                if ( (_DWORD)v23
                  || !(unsigned __int8)FsRtlpOplockKeysEqual(*(_QWORD *)(v18 + 48), *(_QWORD *)(v41 + 48), a4) )
                {
                  if ( (a4 & 0x10010000) != 0 )
                    return (unsigned int)-1073739511;
                  v42 = (_QWORD *)v40[1];
                  FsRtlpRemoveAndCompleteReadOnlyIrp(*v42, 0LL, 0LL);
                  v40 = (_QWORD *)*v42;
                  v23 = a4 & 8;
                  v18 = a2;
                }
...
LABEL_67:
          if ( a6 == 0x2000 )
          {
            ...
            while ( v44 != v43 )
            {
              if ( ((_DWORD)v23 || !(unsigned __int8)FsRtlpOplockKeysEqual(*(_QWORD *)(v18 + 48), v44[3], v23))
                && ((a4 & 0x40000080) != 0x40000080
                 || (int)FsRtlpCheckSharingAgainstOplockOwner(a3, v44[3], *a7, *a8) < 0) )
              {
                if ( (a4 & 0x10010000) != 0 )
                  return (unsigned int)-1073739511;
                if ( v44[7] )
                ...
                else
                {
                  ...
                  if ( (unsigned __int8)FsRtlpRemoveAndCompleteRHIrp(*v44, v45, v46, v47) )
                  {
                    v67 = 0;
                    v21 = 1;
                    v68 = v73 != 0;
          ...
          else
          {
            ...
            {
              if ( (_DWORD)v23 || !(unsigned __int8)FsRtlpOplockKeysEqual(*(_QWORD *)(v18 + 48), v48[3], a4) )
              {
                if ( (a4 & 0x10010000) != 0 )
                  return (unsigned int)-1073739511;
            ...
            {
              if ( (_DWORD)v23 || !(unsigned __int8)FsRtlpOplockKeysEqual(*(_QWORD *)(v18 + 48), v49[3], a4) )
              {
                if ( (a4 & 0x10010000) != 0 )
                  return (unsigned int)-1073739511;
                if ( v49[7] )
                ...
                {
                  v51 = (PVOID *)v49[1];
                  if ( (unsigned __int8)FsRtlpRemoveAndCompleteRHIrp(*v51, 1, 0, 0) )
                  {
                    v67 = 0;
                    v52 = v21;
                    if ( (a6 & 0x2000) != 0 )
...
LABEL_118:
              ...
              else
              {
                ...
                {
                  if ( !(unsigned __int8)FsRtlpOplockKeysEqual(v53[3], *(_QWORD *)(a2 + 48), 0LL) )
                    goto LABEL_118;
                  v53 = (_QWORD *)*v53;
                }
              }
...
LABEL_132:
        ...
        *(_DWORD *)(a1 + 144) = *(_DWORD *)(a1 + 144) & 0x20 | 1;
        while ( 1 )
        {
          ...
          if ( v61 == (_QWORD *)(a1 + 88) )
            break;
          FsRtlpRemoveAndCompleteWaitingIrp(v61);
        }
        v68 = 0;
        v67 = 1;
        v20 = 0;
        ...
        if ( v27 != 45056 )
        {
          if ( v27 == 1060864 )
          {
            ...
            if ( (a6 & 0x1000) != 0 )
            {
              ...
              {
                if ( (_DWORD)v23 || !(unsigned __int8)FsRtlpOplockKeysEqual(*(_QWORD *)(v18 + 48), v38[3], a4) )
                {
                  v35 = 1;
                  if ( (a4 & 0x10010000) != 0 )
                    return (unsigned int)-1073739511;
            ...
            if ( (a6 & 0x2000) != 0 )
            {
              ...
              else if ( !v36 )
              {
                ...
                {
                  if ( (a4 & 8) != 0 || !(unsigned __int8)FsRtlpOplockKeysEqual(*(_QWORD *)(a2 + 48), v39[3], 0LL) )
                  {
                    if ( (a4 & 0x40000080) != 0x40000080
                      || (int)FsRtlpCheckSharingAgainstOplockOwner(a3, v39[3], *a7, *a8) < 0 )
                    {
                      goto LABEL_179;
                    }
                    v39 = (_QWORD *)*v39;
...
LABEL_185:
      if ( v21 )
      {
        ...
        else
        {
          ...
          {
            LOBYTE(v23) = 1;
            FsRtlpModifyThreadPriorities(a1, 0LL, v23);
            FsRtlpOplockSendModernAppTermination(a1, 0LL);
          }
          *a15 = 0;
          return (unsigned int)FsRtlpWaitOnIrp(a1, a3, a9, a10, a11, (char *)&v69, v68, a12, a13, a14, a16);
        }
      }
      return v20;
    }
      ...
      if ( v27 == 8400896 )
      {
        if ( (a6 & 0x3000) != 0 )
        {
          ...
          if ( (a6 & 0x2000) != 0 )
          {
            ...
            {
              if ( (_DWORD)v23 || !(unsigned __int8)FsRtlpOplockKeysEqual(*(_QWORD *)(v18 + 48), v64[3], v23) )
              {
                if ( (a4 & 0x40000080) != 0x40000080
                  || (int)FsRtlpCheckSharingAgainstOplockOwner(a3, v64[3], *a7, *a8) < 0 )
                {
                  if ( (a4 & 0x10010000) != 0 )
                    return (unsigned int)-1073739511;
                  goto LABEL_179;
...
LABEL_160:
    if ( (a4 & 0x40000080) == 0x40000080 )
    {
      if ( (int)FsRtlpCheckSharingAgainstOplockOwner(v17, *(_QWORD *)(a1 + 8), *a7, *a8) < 0 )
        v21 = 1;
    }
    else
    {
