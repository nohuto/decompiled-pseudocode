/*
 * XREFs of sub_140381A7C @ 0x140381A7C
 * Callers:
...
__int64 __fastcall sub_140381A7C(__int64 a1, __int64 a2)
{
  unsigned int v3; // ebx
  ...
  else
  {
    ...
    {
      v18 = sub_140382BC0(a1, a2);
      if ( !v18 )
        return (unsigned int)-1073741818;
      v19 = (unsigned __int16)*(_DWORD *)v6;
      if ( v19 < v11 )
      {
        sub_140395F60(a1, a2, v18);
        v4 = (unsigned __int64 *)(*(_QWORD *)a2 + 16LL * (unsigned int)(*(_DWORD *)(a2 + 24) - 1));
        if ( (v18 & 1) != 0 )
        {
      ...
      else
      {
        ...
        if ( *(_BYTE *)(v6 + 3) )
        {
          ...
          v25 = v24 <= v23 + 16 ? v23 + 8 : v24 - 8;
          if ( **(_DWORD **)(a1 + 16) != -1 )
            sub_1405F6710(a1 + 16, v25);
        }
      }
    }
    v15 = *v4;
    v16 = (_DWORD *)v4[1];
    if ( v16 == (_DWORD *)(v15 + 16) && *(_BYTE *)(v15 + 3) && (unsigned int)sub_140397B5C(a2, 0LL, &v30, v10) )
      **((_DWORD **)&v30 + 1) = *v16;
  }
  return v3;
}
