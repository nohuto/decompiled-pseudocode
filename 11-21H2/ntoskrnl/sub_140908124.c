/*
 * XREFs of sub_140908124 @ 0x140908124
 * Callers:
...
__int64 __fastcall sub_140908124(PLARGE_INTEGER Timeout)
{
  ...
  if ( v2 )
  {
    ...
    v4 = IoBuildDeviceIoControlRequest(0x294210u, v2, 0LL, 0, Timeout, 0x10u, 0, &Event, &IoStatusBlock);
    if ( v4 )
    {
