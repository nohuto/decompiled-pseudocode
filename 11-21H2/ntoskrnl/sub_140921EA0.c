/*
 * XREFs of sub_140921EA0 @ 0x140921EA0
 * Callers:
...
LONG __fastcall sub_140921EA0(_QWORD *a1, __int64 *a2)
{
  _WORD *v2; // rax
  __int64 v3; // r9
  ...
  *(_DWORD *)(&String2.MaximumLength + 1) = 0;
  ...
  {
    if ( (*(_BYTE *)(v3 + 16) & 1) != 0 )
      return sub_14065C57C((unsigned __int8 *)v2 + 20, v4, (unsigned __int8 *)(v3 + 20), v5);
  }
  else if ( (*(_BYTE *)(v3 + 16) & 1) != 0 )
  {
    return sub_1407C45A0((__int64)&String1, (unsigned __int8 *)(v3 + 20), v5, 0);
  }
  if ( v7 )
    return -(int)sub_1407C45A0((__int64)&String2, (unsigned __int8 *)v2 + 20, v4, 0);
  else
