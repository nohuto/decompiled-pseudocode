/*
 * XREFs of AuthzBasepGetInternalSecurityAttributesCopyoutBufferSize @ 0x1406A2ECC
 * Callers:
 *     AuthzBasepQueryInternalSecurityAttributesToken @ 0x1406A2E40 (AuthzBasepQueryInternalSecurityAttributesToken.c)
 * Callees:
 *     AuthzBasepGetInternalSecurityAttributeValueCopyoutBufferSize @ 0x14022B144 (AuthzBasepGetInternalSecurityAttributeValueCopyoutBufferSize.c)
 */
