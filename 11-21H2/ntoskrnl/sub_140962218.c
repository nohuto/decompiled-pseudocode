/*
 * XREFs of sub_140962218 @ 0x140962218
 * Callers:
...
__int64 __fastcall sub_140962218(__int64 a1, __int64 a2)
{
  __int64 v4; // rbx
  unsigned int v5; // r9d
  __int64 v6; // r11
  ...
  *(_QWORD *)(v4 + 48) = *((_QWORD *)KeGetCurrentPrcb() + 4144);
  v5 = 0;
  if ( (*(_DWORD *)(a2 + 16) & 1) != 0 )
  {
  ...
  {
    v7 = 1LL;
    while ( v5 < dword_140D01954 )
    {
      if ( (v6 & v7) != 0 )
      {
        v8 = 3LL * v5;
        *(_DWORD *)(v4 + 8 * v8 + 68) = dword_140C2AEC0[v5];
