/*
 * XREFs of sub_140A0E378 @ 0x140A0E378
 * Callers:
...
__int64 __fastcall sub_140A0E378(__int64 a1, __int64 a2, __int64 a3, __int64 a4)
{
  unsigned int v4; // ebx
  unsigned int *v8; // rcx
  unsigned int *v9; // rax
          ...
          if ( *(_DWORD *)a1 > 4u )
          {
            ...
            while ( 1 )
            {
              ...
              if ( (unsigned int)++v17 >= 4 )
              {
                ...
                if ( (_DWORD)v20 )
                  v22 = v21;
                v23 = qword_140D3B368 ? sub_14042A5E0(v22, v20) : -1073741637;
