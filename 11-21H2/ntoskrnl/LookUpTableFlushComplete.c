/*
 * XREFs of LookUpTableFlushComplete @ 0x14085D380
 * Callers:
 ...
 *     UpdateInternalStatsOnFlush @ 0x1407FAB50 (UpdateInternalStatsOnFlush.c)
 */
...
void __fastcall LookUpTableFlushComplete(__int64 a1)
{
  ...
  if ( v1 )
  {
    ...
    if ( *(_QWORD *)(v4 + 288) )
    {
      if ( (unsigned int)dword_140C06890 > 5 && tlgKeywordOn((__int64)&dword_140C06890, 0x200000000000LL) )
      {
