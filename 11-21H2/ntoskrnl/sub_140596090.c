/*
 * XREFs of sub_140596090 @ 0x140596090
 * Callers:
...
__int64 __fastcall sub_140596090(unsigned __int64 a1)
{
  BOOL v2; // esi
  __int64 v3; // rdi
  __int64 result; // rax
  ...
  *(_QWORD *)a1 = 0LL;
  ...
  std::time_get<wchar_t,std::istreambuf_iterator<wchar_t>>::_Getint((__int64)(a1 << 25) >> 16, 0, 1u);
  v3 = (__int64)(a1 - qword_140C53248) >> 3;
  KeAcquireInStackQueuedSpinLock(&qword_140C53250, &LockHandle);
  _bittestandreset(&dword_140C53258, v3);
