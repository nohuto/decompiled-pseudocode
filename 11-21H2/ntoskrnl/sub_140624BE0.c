/*
 * XREFs of sub_140624BE0 @ 0x140624BE0
 * Callers:
 *     <none>
 * Callees:
...
NTSTATUS __fastcall sub_140624BE0(
...
LABEL_13:
  ...
  *((_QWORD *)&v23 + 1) = ResourceManagerHandle;
  LODWORD(v23) = ResourceManagerInformationClass;
  *((_QWORD *)&v22 + 1) = ResourceManagerInformation;
  LODWORD(v22) = ResourceManagerInformationLength;
...
LABEL_18:
  result = ZwQueryInformationResourceManager(
