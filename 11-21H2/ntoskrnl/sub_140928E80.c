/*
 * XREFs of sub_140928E80 @ 0x140928E80
 * Callers:
 *     <none>
 * Callees:
...
NTSTATUS __fastcall sub_140928E80(void *a1, __int128 *a2, int a3)
{
  ...
  if ( a3 != -2147418111 && (a3 <= 0x10000 || a3 > 65538 && a3 != 1073807361 && (a3 <= 1073807362 || a3 > 1073807364)) )
    return -1073741811;
  Object = 0LL;
  result = ObReferenceObjectByHandle(a1, 1u, qword_140D05120, v4, &Object, 0LL);
  v6 = result;
  if ( result >= 0 )
  {
    v7 = 0;
...
LABEL_21:
          ...
          if ( (xmmword_140D06900[0] & 0x400000) != 0 )
            sub_14062D734(v8[7], v8[8], 2);
          *((_DWORD *)v8 + 33) = a3;
          *((_DWORD *)v8 + 18) = 0;
          sub_1409289DC((char *)v8);
          return v6;
        }
