/*
 * XREFs of sub_140550130 @ 0x140550130
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall sub_140550130(__int64 a1, __int64 a2, unsigned __int64 a3, struct _MDL *a4)
{
  int i; // ebx
  ULONG v9; // r14d
  ...
  for ( i = 0; a3; a3 -= v9 )
  {
    ...
    i = sub_1403A0F08((__int64)v11, a4, v9, 0, 0);
    if ( i < 0 )
      break;
    v12[3] = v11[0];
    v12[4] = v11[7];
    v12[1] = a1;
    v12[2] = a2;
    i = sub_140358A20(2u, 23, 0, (__int64)v12);
    sub_1403A0EB4(v11);
    if ( i < 0 )
      break;
