/*
 * XREFs of sub_1402294F0 @ 0x1402294F0
 * Callers:
...
char __fastcall sub_1402294F0(__int64 a1, __int64 a2)
{
  ...
  LODWORD(CurrentThread) = sub_140229550(a1, a2);
  if ( (_DWORD)CurrentThread )
  {
    CurrentThread = KeGetCurrentThread();
    v5 = *(_QWORD *)(*((_QWORD *)CurrentThread + 23) + 1928LL);
    if ( v5 )
    {
