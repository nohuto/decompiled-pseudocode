/*
 * XREFs of sub_1405FB648 @ 0x1405FB648
 * Callers:
...
__int64 __fastcall sub_1405FB648(__int64 a1, unsigned __int64 a2)
{
  unsigned int v2; // eax
  ...
  ReturnLength = 0;
  v6 = *(_QWORD *)(a1 + 8) + v2;
  Src[0] = xmmword_140439C30;
  Src[1] = xmmword_140439C40;
  v7 = (void *)(v6 + 2);
  ...
  *(_QWORD *)&v8->Name.Length = 0LL;
  ...
  if ( (a2 & 1) != 0 )
  {
    a2 = (unsigned __int64)sub_14036B86C(a2 & 0xFFFFFFFFFFFFFFFEuLL, 0x746C6644u);
    v10 = (void *)a2;
  }
  else
  {
  ...
  v12 = ObQueryNameString((PVOID)a2, v8, v9, &ReturnLength);
  if ( v10 )
