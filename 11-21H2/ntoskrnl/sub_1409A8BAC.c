/*
 * XREFs of sub_1409A8BAC @ 0x1409A8BAC
 * Callers:
...
void __fastcall sub_1409A8BAC(char a1, int a2)
{
  ...
  if ( (unsigned int)dword_140D3B908 > 5 )
  {
    if ( sub_1402A2000((__int64)&dword_140D3B908, 1LL) )
    {
      ...
      v13 = 1;
      v7 = a2;
      sub_14020A9C4((__int64)&dword_140D3B908, (unsigned __int8 *)byte_140033291, 0LL, 0LL, 5u, &v8);
    }
  }
}
