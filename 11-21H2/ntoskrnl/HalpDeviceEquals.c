/*
 * XREFs of HalpDeviceEquals @ 0x140A71270
 * Callers:
...
LABEL_4:
    if ( (v5 & 0xFFFFFFFD) == 0 )
    {
      ...
      if ( v6 == -1 || v7 == v6 || v7 == -1 )
      {
        ...
        if ( v8 == -1 || v9 == v8 || v9 == -1 )
        {
          v10 = *(_DWORD *)KdDebugDevice;
          if ( *(_DWORD *)a2 == -1 || v10 == *(_DWORD *)a2 || v10 == -1 )
          {
            v11 = *(_DWORD *)(a2 + 4);
            v12 = *(_DWORD *)(KdDebugDevice + 4);
    ...
    if ( v4 == 1 || v5 == 2 )
    {
      ...
      {
        v17 = *(_WORD *)(KdDebugDevice + 206);
        v18 = *(_WORD *)(a2 + 206);
        if ( v17 == v18 || v17 == -1 || v18 == -1 )
        {
          v19 = *(_DWORD *)(KdDebugDevice + 232);
          if ( v19 == -1 )
            return 1;
          v20 = *(_DWORD *)(a2 + 232);
          if ( v20 == -1
            || v19 == v20 && !wcsncmp(*(const wchar_t **)(KdDebugDevice + 224), *(const wchar_t **)(a2 + 224), v19) )
          {
            return 1;
          }
        }
