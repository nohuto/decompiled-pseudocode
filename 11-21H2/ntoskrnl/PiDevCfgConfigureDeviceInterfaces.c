/*
 * XREFs of PiDevCfgConfigureDeviceInterfaces @ 0x140697BE0
 * Callers:
...
LABEL_24:
      ...
      *(_QWORD *)&ObjectAttributes.Attributes = 576LL;
      ...
      if ( MatchingFilteredDeviceInterfaceList < 0 )
        goto LABEL_27;
      LODWORD(v24) = 0;
      if ( a3 && *(_QWORD *)(a3 + 16) && PiDevCfgParseVariableName(DestinationString.Buffer, &v31, &v24) )
      {
        v24 = 0LL;
        v13 = PiDevCfgResolveVariable(a3, v31.Buffer, &v24);
          ...
          if ( v3 )
          {
            if ( *v3 )
            {
              while ( 1 )
              {
                ...
                if ( PiDevCfgParseInterfaceKeyName((__int64)&v23, &v32, &v25) )
                {
                  LOBYTE(v16) = 1;
...
LABEL_3:
      ...
      v3 = 0LL;
      if ( PiDevCfgParseInterfaceKeyName((__int64)&v27, &v32, &v25) )
      {
        LOBYTE(v18) = 1;
        MatchingFilteredDeviceInterfaceList = IopRegisterDeviceInterface(
                                                a1,
