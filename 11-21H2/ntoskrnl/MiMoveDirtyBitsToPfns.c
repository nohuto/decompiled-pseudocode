/*
 * XREFs of MiMoveDirtyBitsToPfns @ 0x14028E8E0
 * Callers:
...
__int64 __fastcall MiMoveDirtyBitsToPfns(unsigned __int64 a1, unsigned __int64 a2, __int64 a3, char a4)
{
  ...
  unsigned __int64 v52; // [rsp+58h] [rbp-110h]
  ...
  v52 = Process[1].ActiveProcessors.StaticBitmap[28];
  v48 = a4 & 1;
  if ( (a4 & 1) != 0 )
    v50 = (unsigned __int64 *)(MiLocateLockedVadEvent(v4, 4LL) + 8);
  else
    v50 = 0LL;
  v56 = 20LL;
  v53 = 1;
  ...
  v57 = 0LL;
  v58 = 0LL;
  v45 = MiLockWorkingSetShared(v13);
  v14 = v45;
  if ( v10 <= v11 )
  {
    v15 = a4 & 2;
    ...
    while ( 1 )
    {
      if ( v8 )
      {
        ...
        {
          MiUnlockWorkingSetShared(v13, v14);
          MiLockWorkingSetShared(v13);
        }
      }
      if ( v15 )
        _InterlockedIncrement64((volatile signed __int64 *)(v52 + 600));
      NextPageTable = MiGetNextPageTable(v10, v11, 0, v14, 1, (__int64)&v47);
      v19 = NextPageTable;
      v20 = NextPageTable;
      if ( NextPageTable )
      {
      ...
      do
      {
          ...
          && (v34 & 1) != 0 )
        {
          ...
          if ( Flink )
          {
            v42 = *(_QWORD *)(Flink + 8 * ((v20 >> 3) & 0x1FF));
            Flink = v34 | 0x20;
            if ( (v42 & 0x20) == 0 )
              Flink = v34;
            v34 = Flink;
...
LABEL_21:
        if ( !v35 && (v34 & 1) != 0 )
        {
          if ( v33 || (!v32 || v34 >= 0) && (v43 = MiGetLeafVa(v20), (MiGetWsleContents(v44, v43) & 0xF) != 9) )
            MiMakePteClean(v20, &v53);
        }
        v20 += 8LL;
      }
      while ( v20 <= v21 );
...
LABEL_29:
  ...
  if ( v8 )
    MiUnlockPageTableInternal(v13, v8);
  return MiUnlockWorkingSetShared(v13, v14);
}
