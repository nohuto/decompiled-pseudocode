/*
 * XREFs of IopLiveDumpAllocateFromIOSpace @ 0x14093B898
 * Callers:
 ...
 *     IopLiveDumpUnpackMemoryRun @ 0x14093D300 (IopLiveDumpUnpackMemoryRun.c)
...
_UNKNOWN **__fastcall IopLiveDumpAllocateFromIOSpace(__int64 a1, __int64 a2, __int64 a3, __int64 *a4)
{
  ...
  if ( a1 != -680 )
  {
    ...
    if ( (int)IopLiveDumpQueryIOSpaceRanges(a2, 0LL, &v37) >= 0 )
    {
      ...
      IoSpaceRanges = IopLiveDumpAllocateIoSpaceRanges(v5, v12, v13, (unsigned int)&v39, (__int64)&v35, (__int64)&v38);
      v8 = v35;
      if ( IoSpaceRanges >= 0 )
      {
              ...
              if ( (int)IopLiveDumpUnpackMemoryRun(v39[v15], &v41, &v36) >= 0 )
              {
                ...
                while ( v17 )
                {
                  ...
                  *(_DWORD *)(Pool2 + 40) = (_DWORD)v19 << 12;
                  ...
                  v27 = 0LL;
                  v35 = 0LL;
                  for ( i = (unsigned int)BufferChunkSizeInPages;
                        v27 < v19 / (unsigned int)BufferChunkSizeInPages;
                        v35 = v27 )
                  {
                    v29 = v10[9];
                    ...
                    ++v40;
                    v31 = *a4;
                    *(_QWORD *)(v29 + 8 * v31) = &v38[v27 * (unsigned int)BufferChunkSizeInBytes];
                    ++v10[8];
                    *v10 += i;
                    *(_QWORD *)(v10[10] + 8 * v27) = 0LL;
                    ...
                    if ( v32 == a3 )
                      goto LABEL_32;
                    v27 = v35 + 1;
                    i = (unsigned int)BufferChunkSizeInPages;
                  }
                  v16 = 786432;
                }
