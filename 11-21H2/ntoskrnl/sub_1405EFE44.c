/*
 * XREFs of sub_1405EFE44 @ 0x1405EFE44
 * Callers:
 *     sub_1405EFB90 @ 0x1405EFB90 (sub_1405EFB90.c)
 * Callees:
 *     sub_1405F068C @ 0x1405F068C (sub_1405F068C.c)
 *     sub_1405F06B4 @ 0x1405F06B4 (sub_1405F06B4.c)
 */

char __fastcall sub_1405EFE44(unsigned int a1, unsigned int a2, unsigned __int64 a3)
{
  _DWORD *v3; // r11
  __int64 v4; // rsi
  ...
  if ( *((_DWORD *)CurrentPrcb + 58) )
  {
    ...
    for ( i = (char *)(a3 & ~(v13 - 1)); (unsigned __int64)i < a3 + 4096; i += v13 )
      _mm_clflush(i);
  }
  if ( !(unsigned __int8)sub_1405F068C(a1, a1, a3) )
    return 0;
  ...
  if ( !(unsigned __int8)sub_1405F06B4(v16, v15) )
    return 0;
  v22 = (char *)v20;
  if ( v10 )
  {
  ...
  if ( !(unsigned __int8)sub_1405F06B4((unsigned int)v4, v20) )
    return 0;
  v37 = (void *)v35;
  if ( v10 )
  {
  ...
  return sub_1405F06B4((unsigned int)v4, v35);
}
