/*
 * XREFs of sub_1406179F0 @ 0x1406179F0
 * Callers:
 *     <none>
 * Callees:
...
void __fastcall sub_1406179F0(PVOID BaseAddress, PMDL MemoryDescriptorList)
{
  __int64 v4; // rdx
  __int64 v5; // rcx
  __int64 *v6; // rdi
...
LABEL_13:
  v16 = BaseAddress;
  *((_QWORD *)&v15 + 1) = MemoryDescriptorList;
