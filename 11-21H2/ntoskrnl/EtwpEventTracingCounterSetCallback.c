/*
 * XREFs of EtwpEventTracingCounterSetCallback @ 0x140A36BE0
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall EtwpEventTracingCounterSetCallback(int a1, __int64 a2)
{
  ...
  *(_QWORD *)&Name.Length = 3014700LL;
  ...
  if ( (unsigned int)(a1 - 2) <= 1 )
  {
    ...
    v4 = (_DWORD *)*((_QWORD *)PsGetCurrentServerSiloGlobals() + 108);
    if ( v5 == 1 )
    {
      v18 = 0LL;
      v19 = 0;
      for ( i = 0LL; ; i = (signed __int64 **)NextGuidEntry )
      {
        NextGuidEntry = EtwpGetNextGuidEntry((__int64)v4, i, 0);
        if ( !NextGuidEntry )
          break;
    ...
    else
    {
      ...
      {
        v10 = EtwpAcquireLoggerContextByLoggerId((__int64)v4, j, 0);
        if ( v10 )
        {
          v20 = 0LL;
          v21 = 0LL;
