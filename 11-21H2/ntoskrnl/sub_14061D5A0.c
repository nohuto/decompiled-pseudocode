/*
 * XREFs of sub_14061D5A0 @ 0x14061D5A0
 * Callers:
 *     <none>
 * Callees:
...
NTSTATUS __fastcall sub_14061D5A0(HANDLE PortHandle, ULONG Flags, PALPC_SECURITY_ATTR SecurityAttribute)
{
  __int64 v6; // rdx
  __int64 v7; // rcx
  __int64 *v8; // rdi
...
LABEL_13:
  *((_QWORD *)&v19 + 1) = PortHandle;
  LODWORD(v19) = Flags;
  *((_QWORD *)&v18 + 1) = SecurityAttribute;
...
LABEL_18:
  result = ZwAlpcCreateSecurityContext(PortHandle, Flags, SecurityAttribute);
  LODWORD(v20) = result;
  if ( v8 )
  {
    v16 = (_QWORD **)(v8 + 6);
