/*
 * XREFs of sub_140B53A30 @ 0x140B53A30
 * Callers:
...
__int64 __fastcall sub_140B53A30(__int64 a1, __int64 a2)
{
  __int64 **v5; // rsi
  __int64 *i; // rbx
  unsigned int v7; // edi
...
LABEL_9:
      ...
      while ( 1 )
      {
        v8 = sub_1406546AC(a2, v7);
        if ( v8 )
        {
          if ( *((_DWORD *)i + 30) == *(_DWORD *)(v8 + 120) )
            break;
        }
        if ( ++v7 >= v9 )
          goto LABEL_9;
