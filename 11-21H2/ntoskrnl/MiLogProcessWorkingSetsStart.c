/*
 * XREFs of MiLogProcessWorkingSetsStart @ 0x1402A19AC
 * Callers:
...
void __fastcall MiLogProcessWorkingSetsStart(__int64 a1, __int64 a2, __int64 a3)
{
  ...
  {
    if ( (unsigned __int8)tlgKeywordOn(*(_QWORD *)&qword_140C53448, 1LL, a3, a2) )
    {
      v9 = *(_BYTE *)(v6 + 2);
      v25 = 0;
      v28 = 0;
      ...
      v45 = 8;
      v30 = 4;
      tlgWriteEx_EtwWriteEx(v7, (unsigned __int8 *)&word_14002CED6, v5, v4, v12, v13, 0xAu, &v22);
    }
  }
}
