/*
 * XREFs of HvlpGetVpIndexFromApicId @ 0x140544670
 * Callers:
 *     HvlpEnableNextLogicalProcessor @ 0x14054445C (HvlpEnableNextLogicalProcessor.c)
 *     HvlHalGetVpIndexFromApicId @ 0x140546FB0 (HvlHalGetVpIndexFromApicId.c)
 * Callees:
...
__int64 __fastcall HvlpGetVpIndexFromApicId(int a1, _DWORD *a2)
{
  ...
  v13 = 0LL;
  v10 = 0LL;
  v4 = HvlpAcquireHypercallPage((PHYSICAL_ADDRESS *)&v13, 1, 0LL, 16LL);
  v5 = 0;
