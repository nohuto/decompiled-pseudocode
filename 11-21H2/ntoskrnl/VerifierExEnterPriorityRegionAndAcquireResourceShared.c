/*
 * XREFs of VerifierExEnterPriorityRegionAndAcquireResourceShared @ 0x140AA1370
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall VerifierExEnterPriorityRegionAndAcquireResourceShared(LONG *a1)
{
  __int64 v2; // rbx
