/*
 * XREFs of MiComputePxeWalkAction @ 0x14031B1C0
 * Callers:
...
__int64 __fastcall MiComputePxeWalkAction(int *a1, unsigned __int64 a2, int a3)
{
  ...
  if ( (v9 = *a1 & 0x4000) != 0 )
  {
    ...
    if ( v15 == MiState[v5 + 2131] || v15 == MiState[v5 + 2127] || (v3 & 0x800) == 0 && (v3 & 0x42) == 0 )
      return (*a1 & 1) != 0;
  }
  if ( !(_DWORD)v5 )
    return 1LL;
  ...
  if ( (v3 & 0x80u) != 0LL )
  {
    if ( (v8 & 1) == 0 )
    {
      if ( (*(_BYTE *)(*((_QWORD *)a1 + 3) + 184LL) & 7) == 0 )
      {
        ...
        v20 = ((MiAdvanceToLastUntrimmableVa(LeafVa) >> 18) & 0x3FFFFFF8) - 0x904C0000000LL;
        if ( (int)v5 > 1 )
        {
  ...
  if ( a2 == 0xFFFFF6FB7DBEDF68uLL
    ...
    && ((v3 >> 12) & 0xFFFFFFFFFFLL) == MiState[v5 + 2131] )
  {
    return 0LL;
  }
  if ( (v8 & 1) == 0 )
  {
    ...
    {
      SystemCacheReverseMap = MiGetSystemCacheReverseMap((__int64)(a2 << 25) >> 16 << 25 >> 16, MiState);
