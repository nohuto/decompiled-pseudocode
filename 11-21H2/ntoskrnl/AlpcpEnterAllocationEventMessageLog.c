/*
 * XREFs of AlpcpEnterAllocationEventMessageLog @ 0x140966950
 * Callers:
 ...
 *     AlpcpAllocateMessageLog @ 0x14096675C (AlpcpAllocateMessageLog.c)
 */
...
__int64 __fastcall AlpcpEnterAllocationEventMessageLog(__int64 a1)
{
  ...
  if ( MessageLog )
  {
    ...
    *(_DWORD *)(MessageLog + 44) = 1;
    ...
    if ( *(__int64 **)qword_140C2A128 != &AlpcpMessageLogListHead
      || (*(_QWORD *)(MessageLog + 8) = qword_140C2A128,
          *(_QWORD *)MessageLog = &AlpcpMessageLogListHead,
          v4 = (char *)(MessageLog + 16),
          *v3 = MessageLog,
          qword_140C2A128 = MessageLog,
