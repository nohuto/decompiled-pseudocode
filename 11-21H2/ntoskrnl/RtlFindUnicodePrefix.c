/*
 * XREFs of RtlFindUnicodePrefix @ 0x140694880
 * Callers:
 *     <none>
 * Callees:
...
LABEL_16:
      ...
      v11 = sub_14069498C(i[1].Parent, FullName, 0LL);
      if ( v11 != 3 )
        break;
      i = i->LeftChild;
    }
  ...
  if ( CaseInsensitiveIndex )
  {
    ...
    while ( (unsigned int)sub_14069498C(v13->Prefix, FullName, CaseInsensitiveIndex) - 1 > 1 )
    {
      v13 = v13->CaseMatch;
      if ( v13 == v10 )
        goto LABEL_16;
