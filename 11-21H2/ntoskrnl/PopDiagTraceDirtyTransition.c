/*
 * XREFs of PopDiagTraceDirtyTransition @ 0x140B52D94
 * Callers:
...
char __fastcall PopDiagTraceDirtyTransition(
        __int64 a1,
        unsigned int a2,
        int a3,
        char a4,
        ...
        char a10)
{
    ...
    || (v35 = *(_DWORD *)(v14 + 56), v44 = *(_OWORD *)(v14 + 64), v45 = *(_OWORD *)(v14 + 80), !v35) )
  {
    ...
    v71 = v21;
    v72 = *(_DWORD *)L"p";
    if ( (int)PopReadRegKeyValue((PCWSTR)SourceString, L"Info", 0x30uLL, 0, &v41) >= 0 )
    {
      *(_QWORD *)&v44 = v42;
      v37 = 1;
      v35 = DWORD2(v41);
  ...
  v38 = a2;
  PopPotsLogDirtyPowerTransition(a2, v36);
  v31 = v73;
  v30 = a4;
  UserData = v33;
  UserDataCount = v32;
  ...
  if ( PopDiagHandleRegistered )
  {
    ...
    if ( result )
    {
      ...
      *(_QWORD *)&v46.Size = 4LL;
      ...
      v61 = 1LL;
      v65 = 1LL;
      return EtwWriteEx(PopDiagHandle, &POP_ETW_EVENT_DIRTY_TRANSITION, 0LL, 0, 0LL, 0LL, 0x10u, &v46);
    }
  }
  return result;
}
