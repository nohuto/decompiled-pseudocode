/*
 * XREFs of sub_140944390 @ 0x140944390
 * Callers:
...
__int64 __fastcall sub_140944390(UNICODE_STRING *SourceString, UNICODE_STRING *a2, char a3, char a4, _QWORD *a5)
{
  PVOID v9; // rdi
  _QWORD *v10; // r14
  int v11; // ebx
...
LABEL_16:
    ...
    if ( !a3 )
      goto LABEL_20;
    v13 = sub_140949D40(0LL, &P);
    v9 = P;
    v11 = v13;
    if ( v13 < 0 )
      goto LABEL_20;
    v11 = sub_140943B34(SourceString, P, &Handle);
    if ( v11 >= 0 )
    {
      if ( !a4
        || (ExFreePoolWithTag(v9, 0), P = 0LL,
                                      LOBYTE(v14) = 1,
                                      v15 = sub_140949D40(v14, &P),
                                      v9 = P,
                                      v11 = v15,
                                      v15 >= 0) )
      {
        v11 = sub_140943B34(a2, v9, &FileHandle);
        if ( v11 >= 0 )
          goto LABEL_16;
      }
    }
