/*
 * XREFs of MiLogHotPatchManagement @ 0x14097471C
 * Callers:
  ...
  if ( *(_QWORD *)&qword_140C53448 )
  {
    if ( a1 )
    {
      if ( a1 != 3 )
      {
        if ( a1 == 1 )
        {
          if ( **(_DWORD **)&qword_140C53448 <= 5u )
            return (char)v4;
          LOBYTE(v4) = tlgKeywordOn(*(__int64 *)&qword_140C53448, 32LL);
          if ( !(_BYTE)v4 )
            return (char)v4;
      ...
      if ( **(_DWORD **)&qword_140C53448 > 5u )
      {
        ...
        if ( (_BYTE)v4 )
        {
          ...
          v36 = 0;
          v39 = 0;
          LOBYTE(v4) = tlgWriteEx_EtwWriteEx(v5, (unsigned __int8 *)&word_14002D55E, v11, 1u, v15, v16, 9u, v23);
        }
      }
    }
    else if ( **(_DWORD **)&qword_140C53448 > 5u )
    {
      ...
      if ( (_BYTE)v4 )
      {
        ...
        v33 = 2LL;
        v36 = 0;
        LOBYTE(v4) = tlgWriteEx_EtwWriteEx(v5, (unsigned __int8 *)byte_14002D3AD, v9, 1u, v15, v16, 8u, v23);
      }
    }
  }
  return (char)v4;
