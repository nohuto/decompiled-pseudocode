/*
 * XREFs of VrpPreOpenOrCreate @ 0x14077E168
 * Callers:
 ...
 *     CmpFindExtraParameterInBlock @ 0x1407827B8 (CmpFindExtraParameterInBlock.c)
...
__int64 __fastcall VrpPreOpenOrCreate(__int64 a1, void *a2)
{
  ...
  *(_OWORD *)v45 = 0LL;
  ...
  v11 = VrpBuildKeyPath(v10, *v2, (PUNICODE_STRING)v41);
  if ( v11 >= 0 )
  {
    v38 = 0LL;
    String1 = 0LL;
    VrpGetNextToken(v41, &v38, &String1);
    ...
    LODWORD(v38) = 0;
    v18 = VrpTranslatePath(a2, (__int64)P, (__int64)&Object, (__int64)v45, (__int64)&v39, (__int64)&v38);
    v11 = v18;
    if ( v18 == -1073741772 )
      return 0;
    if ( v18 >= 0 )
    {
      ...
      ExtraParameter = CmAllocateExtraParameter(v20, v19, v21, v22);
      if ( !ExtraParameter )
      {
LABEL_36:
        v11 = -1073741670;
      ...
      v24 = *(_OWORD *)v41;
      *ExtraParameter = a2;
      *((_DWORD *)ExtraParameter + 2) = v23 & 0xFFFFFFFB;
      *((_OWORD *)ExtraParameter + 1) = v24;
      RtlInitUnicodeString((PUNICODE_STRING)v41, 0LL);
      ExtraParameterInBlock = CmpFindExtraParameterInBlock(*(_QWORD *)(a1 + 16), ExtraParameter - 4, &v42);
