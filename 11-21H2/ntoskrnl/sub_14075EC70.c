/*
 * XREFs of sub_14075EC70 @ 0x14075EC70
 * Callers:
...
__int64 __fastcall sub_14075EC70(__int64 a1, _QWORD *a2)
{
  unsigned int v2; // ebx
  __int64 v6; // rax
  unsigned int v7; // ecx
  ...
  if ( !a2 )
  {
    ...
    dword_140C2A224[2 * v6] = -1073740768;
    dword_140C2A220[2 * v6] = 459523;
    if ( (dword_140D04880 & 4) != 0 )
      RtlAssert("IoCallbacks != NULL", "minkernel\\ntos\\kshim\\kseloader.c", 0x303u, 0LL);
  }
  memset(a2, 0, 0x100uLL);
  if ( !(unsigned int)sub_14075CE94((__int64)&dword_140C54EF0, a1, &v26) )
      ...
      switch ( *(_DWORD *)(v18 + v19 + 8) )
      {
        case 1:
          if ( *a2 )
          {
            ...
            dword_140C2A220[2 * (unsigned int)v21] = 459604;
            goto LABEL_40;
          }
        ...
        case 2:
          ...
          {
            v21 = ((unsigned __int8)_InterlockedExchangeAdd(&dword_140C2A200, 1u) + 1) & 0x3F;
            dword_140C2A220[2 * (unsigned int)v21] = 459619;
            goto LABEL_40;
          }
        ...
        case 3:
          ...
          {
            v21 = ((unsigned __int8)_InterlockedExchangeAdd(&dword_140C2A200, 1u) + 1) & 0x3F;
            dword_140C2A220[2 * (unsigned int)v21] = 459634;
            goto LABEL_40;
          }
        ...
        case 4:
          ...
          {
            v21 = ((unsigned __int8)_InterlockedExchangeAdd(&dword_140C2A200, 1u) + 1) & 0x3F;
            dword_140C2A220[2 * (unsigned int)v21] = 459649;
            goto LABEL_40;
          }
        ...
        default:
          ...
          if ( (unsigned int)v20 > 0x1B )
          {
            ...
            dword_140C2A224[2 * v22] = -1073741811;
            dword_140C2A220[2 * v22] = 459680;
            if ( (dword_140D04880 & 2) != 0 )
              sub_14057D738(9LL, "KSE: Invalid callback code encountered: %u\n", *(_DWORD *)(v18 + v19 + 8));
            sub_140368C88(9LL, (__int64)"KSE: Invalid callback code encountered: %u\n", *(_DWORD *)(v18 + v19 + 8));
            break;
          }
          if ( a2[v20 + 4] )
          {
            v21 = ((unsigned __int8)_InterlockedExchangeAdd(&dword_140C2A200, 1u) + 1) & 0x3F;
            dword_140C2A220[2 * (unsigned int)v21] = 459667;
LABEL_40:
            dword_140C2A224[2 * v21] = -1073741823;
            if ( (dword_140D04880 & 2) != 0 )
              sub_14057D738(9LL, "KSE: Two shims are hooking same callback! \n", v14);
            sub_140368C88(9LL, (__int64)"KSE: Two shims are hooking same callback! \n", v14);
            break;
          }
...
LABEL_49:
  qword_140C2A440[((unsigned __int8)_InterlockedExchangeAdd(&dword_140C2A420, 1u) + 1) & 0x3F] = 459700LL;
  if ( (dword_140D04880 & 1) != 0 )
    sub_14057D738(9LL, "KSE: GetShimCallbacks succeeded\n");
  sub_1403C09C8(9);
  return v2;
}
