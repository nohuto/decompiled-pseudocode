/*
 * XREFs of sub_1405B6C18 @ 0x1405B6C18
 * Callers:
...
__int64 __fastcall sub_1405B6C18(__int64 a1, int a2, char a3, char a4)
{
  PSLIST_ENTRY v8; // rdi
  __int64 result; // rax
  ...
  {
    v10 = ExpInterlockedFlushSList(&stru_140C52F00);
    v8 = v10;
    if ( v10 )
    {
      Next = v10->Next;
  ...
  {
    v8 = ExpInterlockedPopEntrySList(&stru_140C52F00);
    if ( v8 )
      goto LABEL_8;
  }
  result = (__int64)sub_1402828F0(64, 0x80uLL, 0x79536D4Du);
  ...
  if ( dword_140D06B08 )
  {
    if ( (dword_140D06B08 & 1) != 0 )
    {
      ...
      if ( (unsigned __int8)result <= 0xFu && LockHandle.OldIrql <= 0xFu && (unsigned __int8)result >= 2u )
      {
        ...
        v28 = ((unsigned int)result & *(_DWORD *)(v27 + 20)) == 0;
