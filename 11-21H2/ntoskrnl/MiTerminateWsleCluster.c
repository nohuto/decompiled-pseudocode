/*
 * XREFs of MiTerminateWsleCluster @ 0x14032F750
 * Callers:
      ...
      while ( 1 )
      {
        ...
        else
        {
            ...
            && ((v12 & 0x20) == 0 || (v12 & 0x42) == 0) )
          {
            ...
            if ( Flink )
            {
              v15 = *((_QWORD *)&Flink->Flink + ((v13 >> 3) & 0x1FF));
              v16 = v12 | 0x20;
              if ( (v15 & 0x20) == 0 )
                v16 = *(_QWORD *)(v1 + 8 * v9);
              v12 = v16;
        ...
        {
LABEL_51:
          if ( v13 >= 0xFFFFF6FB7DBED000uLL && v13 <= 0xFFFFF6FB7DBED7F8uLL && (unsigned int)MiPteHasShadow() )
          {
            *(_QWORD *)v13 = v18;
            MiWritePteShadow(v13, v18);
          }
          else
          {
            *(_QWORD *)v13 = v18;
          ...
          else
          {
            while ( 1 )
            {
              ...
              *(&Base + v24) = v30;
              ...
              {
                qsort(&Base, v24, 8uLL, (int (__cdecl *)(const void *, const void *))MiTbFlushSort);
                MiCompressTbFlushList((__int64)&v58);
                v24 = HIDWORD(v61);
...
LABEL_72:
    ...
    if ( (*(_BYTE *)(a1 + 28) & 0xF) == 8 )
    {
      ...
      if ( *(_QWORD *)(a1 + 16) )
      {
        ...
        do
        {
          v34 = MI_READ_PTE_LOCK_FREE(v33);
          MiUnlockWsle(v4, v32, 48 * ((v34 >> 12) & 0xFFFFFFFFFFLL) - 0x220000000000LL);
          ++v31;
          v33 += 8LL;
          v32 += 4096LL;
        }
    ...
    if ( (*(_DWORD *)(a1 + 24) & 4) == 0 )
      MiInsertTbFlushEntry((__int64)&v58, v5, *(_QWORD *)(a1 + 16), 0);
LABEL_81:
    MiRemoveWsle(v4, v5, *(_QWORD *)(a1 + 16), *(unsigned __int8 *)(a1 + 28), 10, *(_DWORD *)(a1 + 24) & 1);
    ...
    {
      MiCountWslesInPageTable(Process, v5, v74);
      v46 = 8;
      while ( 1 )
      {
...
LABEL_109:
    if ( (*(_BYTE *)(v4 + 184) & 7) != 0 )
    {
      ...
      if ( *(_QWORD *)(a1 + 16) )
      {
        while ( 1 )
        {
          MiDeleteValidSystemPage(v4, v1, v48, v56);
          if ( (*(_DWORD *)(a1 + 24) & 4) != 0 )
            break;
LABEL_129:
          ++v49;
        ...
        v53 = 0LL;
        MiInitializeTbFlushStamps((unsigned __int64)&v53);
        v50 = v53;
...
LABEL_124:
        ...
        if ( (v51 & 0xFFFFFFFF00000000uLL) == 0 )
          MiInsertTbFlushEntry((__int64)&v58, v5, 1LL, 0);
        goto LABEL_129;
      }
    }
LABEL_130:
