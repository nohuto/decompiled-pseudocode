/*
 * XREFs of sub_1405E966C @ 0x1405E966C
 * Callers:
...
unsigned __int64 __fastcall sub_1405E966C(__int64 a1, __int64 a2, unsigned __int64 a3, char a4)
{
  char v4; // di
  __int64 v5; // rsi
  __int64 v6; // rbx
  ...
  v49 = a3;
  v4 = 0;
  v26 = qword_140C5AE40 == *(_QWORD *)(a1 + 360);
  v5 = a2;
  v6 = a1;
  v47 = 0LL;
  v44 = 0LL;
...
LABEL_79:
  ...
  v11 = (_WORD *)sub_1405E8A08(a1, a2, &v49);
  if ( *(_BYTE *)(v5 + 14) )
  {
  ...
  if ( *((_BYTE *)v14 + 15) == 3 )
  {
    sub_1405EAE78(v9, v14 + 8, v10, 1LL);
    v15 = *((_QWORD *)v14 + 7);
    v44 = *((_QWORD *)v14 + 6);
    v45 = v15;
    --*(_DWORD *)(v12 + 84);
        ...
        else
        {
          ...
          *((_WORD *)v40 + 4) = v41;
          ...
          if ( v42 != v12 )
          {
            ...
            {
              sub_1405F1BBC(3, v42, (_DWORD)v40, v12, 0LL, 0LL);
              LOWORD(v41) = *((_WORD *)v40 + 4);
            }
            v4 = ((unsigned int)((_DWORD)v40 - v12) >> 16) + 1;
          }
          v40[14] = v4;
          sub_1405EA9DC(v6, v40, (unsigned __int16)v41);
        }
      }
      sub_1405E952C(v6, v12, (__int64)BaseAddress - 48, RegionSize, (unsigned __int64)v11, (__int64 *)&v47);
      a3 = (unsigned __int64)v47;
      goto LABEL_30;
    }
    sub_1405EB250(v6, 3LL);
    v26 = v50 == 0;
LABEL_33:
    if ( !v26 )
    {
      sub_1405E952C(v25, v12, v44 - 48, v45, (unsigned __int64)v11, &v49);
      v13 = v49;
    }
    goto LABEL_29;
  }
...
LABEL_19:
  ...
  if ( v28 >= 0xFF000 )
    *(_QWORD *)(v6 + 584) -= v28;
  sub_1405EAE78(v22, v27, v23, v24);
  v27[5] += RegionSize;
  sub_1405EAD20(v6, v27);
    ...
    if ( v47 != (char *)BaseAddress + RegionSize )
    {
      ...
      *((_WORD *)v31 + 4) = v32;
      ...
      if ( v34 != v12 )
      {
        ...
        {
          sub_1405F1BBC(3, v34, (_DWORD)v31, v12, 0LL, 0LL);
