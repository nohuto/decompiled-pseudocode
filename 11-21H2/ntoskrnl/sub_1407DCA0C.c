/*
 * XREFs of sub_1407DCA0C @ 0x1407DCA0C
 * Callers:
...
__int64 __fastcall sub_1407DCA0C(int *a1, _DWORD *a2, WCHAR *a3, ULONG_PTR *a4)
{
  int v8; // ebp
  __int64 v9; // r14
  void *v10; // r15
  ...
  v10 = (void *)sub_140347920(v9, 0x746C6644u);
  AppIdSize[0] = 130LL;
...
LABEL_3:
  ...
  sub_1402F89B0((signed __int64 *)(v9 + 1208), (unsigned __int64)v10, 0x746C6644u);
  return v12;
}
