/*
 * XREFs of MmUnmapViewInSystemCache @ 0x140335870
 * Callers:
...
void __fastcall MmUnmapViewInSystemCache(ULONG_PTR BugCheckParameter3, ULONG_PTR BugCheckParameter4, char a3)
{
  ...
  v114 = (_QWORD *)v5;
  v109 = v5 + 512;
  v112 = 48 * MiGetContainingPageTable(v5) - 0x220000000000LL;
  v105 = MiSectionControlArea(BugCheckParameter4);
  ...
  v110 = MiLockWorkingSetOptimal(v10, v5, &v128);
      ...
      else
      {
        while ( 1 )
        {
          ...
          *(_QWORD *)(v22 + 16) += v32;
          ...
          {
            qsort((void *)(v22 + 24), v34, 8uLL, (int (__cdecl *)(const void *, const void *))MiTbFlushSort);
    ...
    *(_QWORD *)(BugCheckParameter2 + 8 * v99) = v36;
    if ( (v36 & 1) != 0 )
    {
      ...
      if ( v21 >= 0xFFFFF6FB7DBED000uLL && v21 <= 0xFFFFF6FB7DBED7F8uLL && (MiFlags & 0xC00000) != 0 )
      {
        ...
        if ( *(_BYTE *)(Process + 912) != 1 && (v40 & 1) != 0 && ((v40 & 0x20) == 0 || (v40 & 0x42) == 0) )
        {
          Process = (__int64)KeGetCurrentThread()->ApcState.Process;
          if ( *(_QWORD *)(Process + 1928) )
            v21 = (v21 >> 3) & 0x1FF;
        }
      }
      if ( (HIBYTE(v40) & 0xF) == 7 )
...
LABEL_50:
      ...
      if ( HIDWORD(v97) )
      {
        if ( (*(_QWORD *)(v38 + 24) & 0x3FFFFFFFFFFFFFFFLL) == 1 )
        {
          ...
          if ( (v42 & 8) != 0 || (v42 & 7u) > 2 && (v42 & 7u) <= 5 )
          {
            ...
            {
              do
                KeYieldProcessorEx(&v100, Process, v21, v27);
        ...
        && ((v44 & 0x20) == 0 || (v44 & 0x42) == 0) )
      {
        ...
        if ( Flink )
        {
          v46 = *((_QWORD *)&Flink->Flink + ((v43 >> 3) & 0x1FF));
          if ( (v46 & 0x20) != 0 )
            v44 |= 0x20uLL;
          if ( (v46 & 0x42) != 0 )
            v44 |= 0x42uLL;
      ...
      WsleContents = HIBYTE(v44) & 0xF | (16 * ((v44 >> 60) & 7));
      if ( (HIBYTE(v44) & 0xF) == 8 )
      {
        MiUnlockWsle(v41, v23, v38);
        WsleContents = MiGetWsleContents(v48, v23);
      }
      v49 = *(_QWORD *)v5;
      v21 = ZeroPte;
      v50 = ((unsigned int)MiFlags >> 27) & 3;
      if ( v50 > 1 )
      {
      ...
      if ( (v49 & 0x20) == 0 )
      {
        MI_INTERLOCKED_EXCHANGE_PTE((volatile __int64 *)v5, ZeroPte);
LABEL_87:
        v51 = v103 == 0;
        v52 = v99;
        v53 = v107;
        v107[8 * v99] = WsleContents;
        v53[8 * v52 + 1] = 1;
        if ( !v51 )
...
LABEL_97:
  ...
  if ( v9 )
  {
    v56 = MiRemoveWsleList(v98, v22, v107, v9);
    if ( v56 )
      MiRebuildPageTableLeafAges(0LL, v56 << 25 >> 16 << 25 >> 16);
  }
  v57 = (_QWORD *)v108;
  v58 = v110;
  v122 = 0LL;
  ...
  v123 = 0LL;
  *(_QWORD *)(v108 + 32) = v124;
  MiUnlockPageTableInternal(v55, v58);
  MiUnlockWorkingSetShared(v55, 2u);
...
LABEL_107:
        ...
        {
          do
            KeYieldProcessorEx((_DWORD *)&v97 + 1, v66, v59, v60);
      ...
      if ( v63 )
      {
        if ( v63 == 2 )
        {
          CanBatchHardFaultPages = MiCanBatchHardFaultPages(&v97, 48 * v67 - 0x220000000000LL);
        ...
        if ( !v51 )
        {
          if ( v63 == 1 )
            MiReleaseWriteInProgressCharges(
              *(_QWORD *)(qword_140C51F48 + 8 * ((*(_QWORD *)(v68 + 40) >> 43) & 0x3FFLL)),
              1uLL,
              1);
LABEL_147:
...
LABEL_138:
          ...
          {
            MiInsertPagesInList(&v115, 1LL);
            if ( v63 )
            {
              if ( v63 == 2 )
              {
                MiHardFaultPageRelease(&v97, 48 * v67 - 0x220000000000LL);
              }
              else
              {
                MiReleaseWriteInProgressCharges(
                  *(_QWORD *)(qword_140C51F48 + 8 * ((*(_QWORD *)(v68 + 40) >> 43) & 0x3FFLL)),
                  1uLL,
                  1);
                MiPfnReferenceCountIsZero(48 * v67 - 0x220000000000LL, v67);
              }
            }
            else
            {
              MiDecrementShareCount(48 * v67 - 0x220000000000LL, v77, v78, v79);
            }
            goto LABEL_147;
          }
          MiEnqueuePageList(&v115, v67);
LABEL_148:
          v63 = v121;
          ++v62;
          goto LABEL_149;
      ...
      {
        if ( (_BYTE)v97 )
          MiCaptureDirtyBitToPfn(48 * v67 - 0x220000000000LL);
...
LABEL_151:
  ...
  v85 = v57;
  v86 = v111;
  MiManageSubsectionView((__int64 *)v111, v85, v101);
  if ( v62 )
  {
    v87 = v112;
    MiLockPageInline(v112);
  ...
  else
  {
    ...
    if ( KiIrqlFlags && (KiIrqlFlags & 1) != 0 && v88 <= 0xFu )
    {
      ...
      v89[5] |= ~((unsigned __int8)(1LL << (v88 + 1)) - 1) & 4;
    }
    v128 = v88;
  }
  ...
  if ( v103 )
  {
    ...
    if ( v86 )
    {
      ...
      while ( 1 )
      {
        v94 = MiRemoveViewsFromSection(v86, *(unsigned int *)(v86 + 44), 4);
        v95 = *(_QWORD *)(v86 + 8);
        v92 += v94;
  ...
  --*(_QWORD *)(v105 + 40);
  --*(_DWORD *)(v96 + 88);
  MiCheckControlArea(v96, v88, v91);
  if ( v92 )
    MiReturnCrossPartitionSectionCharges(v113, 1LL, v92);
  if ( (a3 & 2) != 0 )
  {
    v106 = 0LL;
    MiInitializeTbFlushStamps((unsigned __int64)&v106);
    *v114 = v106;
  }
  else
  {
