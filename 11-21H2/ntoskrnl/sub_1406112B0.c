/*
 * XREFs of sub_1406112B0 @ 0x1406112B0
 * Callers:
 *     <none>
 * Callees:
...
void __fastcall sub_1406112B0(PDEVICE_OBJECT DeviceObject, BOOLEAN a2)
{
  __int64 v4; // rdx
  __int64 v5; // rcx
  __int64 *v6; // rdi
  ...
  PDEVICE_OBJECT v16; // [rsp+30h] [rbp-18h]
  __int64 retaddr; // [rsp+48h] [rbp+0h]

  v15 = 0LL;
  v16 = 0LL;
  v6 = sub_140604844(215);
  if ( !v6 )
    goto LABEL_18;
  if ( dword_140C1B2A0
...
LABEL_18:
  IoStartNextPacket(DeviceObject, a2);
  if ( v6 )
  {
    v13 = (_QWORD **)(v6 + 6);
