/*
 * XREFs of sub_1405491B0 @ 0x1405491B0
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall sub_1405491B0(unsigned __int64 a1)
{
  __int64 v2; // rax
  ...
  v3[0] = -1LL;
  v3[1] = a1;
  v2 = HvlInvokeFastExtendedHypercall(65667LL, (__int64)v3, 0x10u, 0LL, 0);
