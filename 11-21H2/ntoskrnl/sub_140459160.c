/*
 * XREFs of sub_140459160 @ 0x140459160
 * Callers:
...
__int64 __fastcall sub_140459160(__int64 a1, __int64 a2, __int64 a3, __int64 a4, char a5, unsigned int a6)
{
  __int64 v8; // r10
  __int64 v9; // r11
  int v10; // r15d
...
LABEL_4:
  ...
  v17 = (__int64 *)(v16 + 48);
  if ( *(_QWORD *)(v16 + 48) > v11 || v13 && ((v10 - 1) & (unsigned int)a4) != 0 )
  {
    v15 = 0;
  }
  else
...
LABEL_15:
  ...
  if ( v13 && v14 < 0x1000 && v19 < v14 << 12 && ((v19 - v14) & (v10 - 1)) != 0 )
    v14 = v19;
  if ( v14 <= v19 )
    return v14;
  return v19;
