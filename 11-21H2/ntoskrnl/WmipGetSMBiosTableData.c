/*
 * XREFs of WmipGetSMBiosTableData @ 0x140693800
 * Callers:
 *     WmipRawSMBiosTableHandler @ 0x140213CF0 (WmipRawSMBiosTableHandler.c)
 ...
 *     WmipSMBiosHideMachine @ 0x1409DCDD0 (WmipSMBiosHideMachine.c)
 */
