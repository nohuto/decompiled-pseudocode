/*
 * XREFs of sub_1405346EC @ 0x1405346EC
 * Callers:
...
__int64 __fastcall sub_1405346EC(__int64 a1, __int64 a2)
{
  unsigned int v2; // ebx
  int v4; // ebp
  __int64 v5; // rcx
  ...
  *(_QWORD *)a2 = 0LL;
  ...
  v6 = sub_1403B1F04(a1, 128LL);
  if ( !v6 )
    return (unsigned int)-1073741670;
  v8 = sub_1403B1F04(v5, 80LL);
  if ( !v8 )
  {
LABEL_13:
    sub_1403B1B5C(v7, v6);
  ...
  v10 = sub_1403B1F04(v7, 16 * v9);
  if ( !v10 )
  {
    sub_1403B1B5C(v11, v8);
    goto LABEL_13;
  }
  *(_QWORD *)(v6 + 24) = 4096LL;
  *(_QWORD *)(v6 + 72) = 0LL;
