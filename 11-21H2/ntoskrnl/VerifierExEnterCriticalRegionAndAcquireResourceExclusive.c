/*
 * XREFs of VerifierExEnterCriticalRegionAndAcquireResourceExclusive @ 0x140AA1250
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall VerifierExEnterCriticalRegionAndAcquireResourceExclusive(LONG *a1)
{
  __int64 v2; // rbx
