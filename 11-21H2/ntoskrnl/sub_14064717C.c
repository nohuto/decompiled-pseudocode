/*
 * XREFs of sub_14064717C @ 0x14064717C
 * Callers:
...
__int64 __fastcall sub_14064717C(unsigned int **a1, unsigned int *a2, _DWORD *a3, int a4)
{
  unsigned int *v4; // r13
  ...
  v61 = 0;
  v7 = 0;
  v8 = sub_140646EC4(*a1, v4[1]);
  if ( v8 < 0 )
    return (unsigned int)v8;
  v8 = sub_140646EC4(a3, a3[1]);
  if ( v8 < 0 )
    return (unsigned int)v8;
  v9 = 0LL;
  if ( !a3[3] )
...
LABEL_83:
          ...
          *(_DWORD *)&v45[8 * v47 + 12] = v43;
          v8 = sub_140647860(Pool2, &v86, (char *)a3 + v44, v43);
          if ( v8 < 0 )
            goto LABEL_80;
          v62 = v86;
LABEL_75:
        ...
        else
        {
          ...
          if ( *(_DWORD *)&v42[8 * v41 + 20] )
          {
            while ( 1 )
            {
              ...
              v54 = sub_14025179C(Pool2, v52, (unsigned __int16)v51 >> 1);
              if ( v54 )
              {
                v56 = v62;
              }
              else
              {
                ...
                *(_DWORD *)(v54 + 12) = v51;
                v8 = sub_140647860(Pool2, &v86, v75, *(unsigned int *)&v74[4 * v73 + 16]);
                if ( v8 < 0 )
                  goto LABEL_80;
                *(_DWORD *)(v54 + 20) = 1;
                v83 = 0;
                *(_DWORD *)(v54 + 16) = v86;
                v82 = 0LL;
                v8 = sub_140647860(Pool2, &v86, &v82, 20LL);
                if ( v8 < 0 )
                  goto LABEL_80;
                v56 = v86;
                v62 = v86;
              ...
              if ( (*(_DWORD *)v54 & 1) == 0 )
              {
                ...
                {
                  v67 = v56;
                  v8 = sub_140647860(Pool2, &v86, v76, v68);
                  if ( v8 < 0 )
                    goto LABEL_80;
                  v57 = v67;
                  v62 = v86;
                ...
                if ( v58[4] && v72 )
                {
                  v58[1] = v57;
                  v58[2] = v68;
                  v8 = sub_140647860(Pool2, &v86, v58, (unsigned int)(20 * *(_DWORD *)(v54 + 20)));
                  if ( v8 < 0 )
                    goto LABEL_80;
                  v78 = 0LL;
                  v79 = 0;
                  *(_DWORD *)(v54 + 16) = v62;
                  v80 = v67;
                  v81 = v68;
                  v8 = sub_140647860(Pool2, &v86, &v78, 20LL);
                  if ( v8 < 0 )
                    goto LABEL_80;
                  ++*(_DWORD *)(v54 + 20);
                  sub_140647A40(Pool2, v54);
                  v62 = v86;
                }
                else
                {
      ...
      if ( v61 && !(unsigned int)sub_1406478F8(Pool2) )
      {
        v8 = -1073741823;
        goto LABEL_80;
      }
      v8 = sub_140646EC4(Pool2, v30);
      if ( v8 < 0 )
      {
LABEL_80:
        v59 = (ULONG_PTR)Pool2;
...
LABEL_27:
  ...
  while ( 1 )
  {
    ...
    v20 = (_DWORD *)sub_14025179C(v4, v17, v19);
    if ( v20 )
    {
      if ( (*v20 & 1) == 0 )
      {
