/*
 * XREFs of sub_140A1B468 @ 0x140A1B468
 * Callers:
...
__int64 __fastcall sub_140A1B468(int a1, unsigned int a2, unsigned int *a3, UNICODE_STRING *a4, char *a5)
{
  size_t v5; // rbx
  unsigned int *v7; // r14
  int v8; // edi
  ...
  switch ( a1 )
  {
    case 4:
      if ( a2 >= 4 )
      {
        v12 = *a3;
LABEL_7:
        v13 = sub_140A1BE50(v12, (_DWORD)a4, 0, 0, 0LL, (__int64)a5);
LABEL_11:
        v8 = v13;
        goto LABEL_38;
      }
...
LABEL_43:
    ...
    case 11:
      if ( a2 >= 8 )
      {
        v13 = sub_140A1AE24(a3, (__int64)a4, (__int64)a3, 0LL, v34, a5);
        goto LABEL_11;
      }
      goto LABEL_36;
  }
