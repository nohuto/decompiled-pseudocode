/*
 * XREFs of GetPrintableOperandValue @ 0x1409D1418
 * Callers:
        ...
        char a8)
{
  ...
  wchar_t pszFormat[12]; // [rsp+78h] [rbp-79h] BYREF
          ...
          *a4 = 5;
          ...
          if ( v37 <= 0xFFFFFFFF && (int)v37 + 2 >= (unsigned int)v37 )
          {
            ...
            if ( v38 <= 0xFFFFFFFF )
            {
              ...
              v40 = SddlpAlloc((unsigned int)v38);
              v41 = 0;
              *(_QWORD *)a3 = v40;
              if ( v40 )
              {
                ...
                *v23 = 123;
                ...
                while ( 1 )
                {
                  ...
                  if ( PrintableOperandValue )
                    goto LABEL_90;
                  v66 += *a4;
                  if ( (int)ULongAddStringSize(v22, P, &v65) < 0 )
                    goto LABEL_22;
                  v29 = v65 + 4;
                  v68 = v65 + 4;
                  if ( v65 + 4 < v65 )
                  ...
                  do
                    ++v32;
                  while ( v30[v32] != v28 );
                  v33 = (wchar_t *)SddlpReAlloc(2 * v32, v31, v30);
                  *(_QWORD *)a3 = v33;
                  if ( !v33 )
                    goto LABEL_58;
          ...
          if ( (unsigned int)(a2 - 1) >= 4 )
          {
            ...
            *a4 = 5;
            if ( v14 <= 0x44 && a2 - 5 >= v14 )
            {
              ...
              PrintableOperandValue = LocalGetStringForSid(Sid, (wchar_t **)&P, a5, v15, v63, a8);
              if ( PrintableOperandValue )
                goto LABEL_90;
              *a4 += v14;
              v16 = -1LL;
...
LABEL_58:
    ...
    v50 = a1[9];
    v51 = a1[10];
    v52 = (wchar_t *)SddlpAlloc(0x40uLL);
    *(_QWORD *)a3 = v52;
    v53 = v52;
    if ( !v52 )
      goto LABEL_58;
...
LABEL_64:
        ...
        if ( v51 == 1 )
        {
          *v53++ = 48;
          do
          {
            if ( v56 == -2147483638 )
              break;
            v57 = *(wchar_t *)((char *)v55 + (char *)L"%I64o" - (char *)pszFormat);
            if ( !v57 )
              break;
            *v55++ = v57;
            --v56;
        ...
        else if ( v51 == 3 )
        {
          *(_DWORD *)v53 = 7864368;
          ...
          do
          {
            if ( v56 == -2147483638 )
              break;
            v59 = *(wchar_t *)((char *)v55 + (char *)L"%I64x" - (char *)pszFormat);
            if ( !v59 )
              break;
            *v55++ = v59;
            --v56;
        ...
        else
        {
          do
          {
            if ( v56 == -2147483638 )
              break;
            v60 = *(wchar_t *)((char *)v55 + (char *)L"%I64u" - (char *)pszFormat);
            if ( !v60 )
              break;
            *v55++ = v60;
            --v56;
        ...
        *v58 = 0;
        ...
        if ( v49 || v51 != 1 )
        {
          ...
          if ( v50 != 2 )
            v61 = v49;
          if ( RtlStringCchPrintfW(v53, 32 - (((__int64)v53 - *(_QWORD *)a3) >> 1), pszFormat, v61) < 0 )
          {
LABEL_72:
