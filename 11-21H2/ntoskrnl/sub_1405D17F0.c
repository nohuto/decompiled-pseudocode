/*
 * XREFs of sub_1405D17F0 @ 0x1405D17F0
 * Callers:
...
void __fastcall sub_1405D17F0(__int64 a1, __int64 a2, int a3)
{
  REGHANDLE v5; // rdi
  ...
  {
    v5 = RegHandle;
    if ( EtwEventEnabled(RegHandle, &stru_140038070) )
    {
      UserData.Reserved = 0;
      v9 = 0;
      v12 = 0;
      ...
      v10 = a2;
      v11 = a3;
      EtwWriteEx(v5, &stru_140038070, 0LL, 0, 0LL, 0LL, 3u, &UserData);
    }
  }
}
