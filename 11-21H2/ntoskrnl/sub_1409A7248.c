/*
 * XREFs of sub_1409A7248 @ 0x1409A7248
 * Callers:
...
char __fastcall sub_1409A7248(int a1, int a2, __int64 a3, __int64 a4, __int64 a5, __int64 a6)
{
  _UNKNOWN **v6; // rax
  ...
  if ( (unsigned int)dword_140D3B8D0 > 5 )
  {
    ...
    if ( (_BYTE)v6 )
    {
      ...
      v16 = a3;
      v17 = a4;
      LOBYTE(v6) = sub_14020A9C4((__int64)&dword_140D3B8D0, (unsigned __int8 *)&unk_140033088, 0LL, 0LL, 9u, &v20);
    }
  }
  return (char)v6;
}
