/*
 * XREFs of PipDmgEnforceEnumerationPolicy @ 0x1409569F4
 * Callers:
 ...
 *     PiIommuIsPassthroughAllowedWhileConsoleLocked @ 0x14095A528 (PiIommuIsPassthroughAllowedWhileConsoleLocked.c)
