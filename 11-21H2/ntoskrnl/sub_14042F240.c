/*
 * XREFs of sub_14042F240 @ 0x14042F240
 * Callers:
 *     sub_140AB5640 @ 0x140AB5640 (sub_140AB5640.c)
 * Callees:
...
void __noreturn sub_14042F240()
{
  ...
  if ( (_BYTE)dword_140D069F0 && (v10 & 1) != 0 )
    __asm { stac }
  if ( (v11 & 0x200) != 0 )
    _enable();
  v7 = (unsigned int)retaddr;
  v8 = __readcr0();
  sub_140434DC0(127LL, 10LL, v8, v7);
}
