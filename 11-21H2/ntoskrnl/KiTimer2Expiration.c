/*
 * XREFs of KiTimer2Expiration @ 0x1402F27B0
 * Callers:
...
__int64 __fastcall KiTimer2Expiration(__int64 a1, unsigned __int64 a2, char a3, char a4)
{
  __int64 result; // rax
  __int64 v9; // r12
  __int64 v10; // r14
  ...
  v11 = (unsigned __int64)&KiTimer2Collections + 24 * v10;
  do
  {
    v12 = *(_QWORD *)(v11 + 8);
    if ( (v12 & 1) != 0 )
...
LABEL_11:
  ...
  while ( 2 )
  {
    ...
    if ( (v19 & 8) != 0 )
    {
      inserted = KiInsertTimer2(v18, 0LL, v29);
      v25 = v18;
      if ( inserted )
      {
        v27 = 0;
      ...
      if ( (*((_BYTE *)v18 + 129) & 2) != 0 )
        v17 = 1;
LABEL_17:
      KiExpireTimer2((PVOID)v18);
    }
    else
    {
      v27 = 4;
LABEL_44:
      KiUpdateTimer2Flags(v25, v24, v27);
    }
    if ( v16 != &v31 )
      continue;
    break;
...
LABEL_21:
  ...
  result = KiShouldActivateHRTimerClock(MEMORY[0xFFFFF78000000008], qword_140C2B8E8);
  if ( (_BYTE)result )
