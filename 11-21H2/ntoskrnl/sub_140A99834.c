/*
 * XREFs of sub_140A99834 @ 0x140A99834
 * Callers:
...
__int64 __fastcall sub_140A99834(__int64 a1, __int64 a2, __int64 *a3)
{
  __int64 v3; // rax
  _QWORD *v5; // r9
  _QWORD *v6; // rdi
  ...
  while ( v7 != v6 )
  {
    ...
    *v11 = v8;
    *(_QWORD *)(v8 + 8) = v11;
    sub_140A9A13C(v5, (unsigned int)~*((_DWORD *)v9 + 19));
    *v9 = v12;
    v13 = *(_QWORD **)(v12 + 16);
    if ( *v13 != v12 + 8 )
      goto LABEL_18;
    ...
    *v13 = v10;
    *(_QWORD *)(v12 + 16) = v10;
    sub_140A9A13C(v12, (unsigned int)(*((_DWORD *)v9 + 19) + 1));
  }
  if ( *v5 )
  {
    v14 = v5[3];
