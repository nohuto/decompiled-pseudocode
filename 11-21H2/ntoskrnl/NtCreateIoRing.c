/*
 * XREFs of NtCreateIoRing @ 0x140938B40
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall NtCreateIoRing(__int64 *a1, unsigned int a2, unsigned __int64 a3, unsigned int a4, _OWORD *Address)
{
...
LABEL_16:
  ...
  *(_QWORD *)&v33 = 0LL;
  v34 = 0LL;
  inserted = ObCreateObjectEx(0, IoRingObjectType, (int)&v32, PreviousMode, v21, 208, 0, 0, &Object, 0LL);
  if ( inserted < 0 )
    goto LABEL_43;
  v17 = (char *)Object;
  ...
  *((_QWORD *)v17 + 13) = 0LL;
  ...
  v23 = (__int64 *)(v17 + 56);
  inserted = MmCreateSection((int)v17 + 56, 6LL, 0, &v26, 4, 0x8000000, 0LL, 0LL);
  if ( inserted >= 0 )
  {
    v19 = *((_QWORD *)v17 + 7);
    v31 = 0LL;
    inserted = MiMapViewInSystemSpace(v19, (_QWORD *)v17 + 8, (unsigned __int64 *)v17 + 11, &v31, 0LL, 0LL);
    if ( inserted >= 0 )
    {
...
LABEL_40:
          v30 = 0LL;
          inserted = ObInsertObjectEx(v17, 0LL, 0, 1, 0, (__int64)&Object, &v30);
          if ( inserted >= 0 )
          {
            *a1 = v30;
            v17 = (char *)Object;
