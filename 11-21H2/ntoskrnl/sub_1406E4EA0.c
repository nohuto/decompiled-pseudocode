/*
 * XREFs of sub_1406E4EA0 @ 0x1406E4EA0
 * Callers:
...
__int64 __fastcall sub_1406E4EA0(__int64 a1, __int64 a2, const wchar_t *a3)
{
  int v5; // esi
  NTSTATUS v6; // eax
  unsigned int v7; // ebx
...
LABEL_3:
  ...
  *(_OWORD *)&ObjectAttributes.SecurityDescriptor = 0LL;
  ...
  v48 = 0;
  v10 = 1;
  if ( (int)sub_14094D458(Handle, L"AllowDenyLayered", &v64) >= 0 )
    v51 = v64 != 0;
  if ( (int)sub_14094D458(Handle, L"DenyRemovableDevices", &v64) >= 0 && v64 && (*(_BYTE *)(a1 + 560) & 0x10) != 0 )
    v9 = 1;
  v11 = sub_14094D4C8(Handle, L"AllowDeviceClasses", &P);
  v12 = P;
  if ( v11 < 0 )
    v12 = 0LL;
  P = v12;
  v13 = sub_14094D4C8(Handle, L"DenyDeviceClasses", &Str1);
  v14 = Str1;
  if ( v13 < 0 )
    v14 = 0LL;
  v61 = v14;
...
LABEL_41:
  v19 = sub_14094D4C8(Handle, L"AllowDeviceIDs", &v56);
  v20 = (wchar_t *)v56;
  if ( v19 < 0 )
    v20 = 0LL;
  Str1 = v20;
  v21 = sub_14094D4C8(Handle, L"DenyDeviceIDs", &v57);
  v22 = (wchar_t *)v57;
  if ( v21 < 0 )
    v22 = 0LL;
  if ( v20 || v22 )
...
LABEL_69:
  ...
  v33 = sub_14094D4C8(Handle, L"AllowInstanceIDs", &v59);
  v34 = v59;
  if ( v33 < 0 )
    v34 = 0LL;
  v35 = sub_14094D4C8(Handle, L"DenyInstanceIDs", &v60);
  v36 = v60;
  if ( v35 < 0 )
    v36 = 0LL;
  if ( v34 )
...
LABEL_117:
  ...
  if ( v44 || v51 || (int)sub_14094D458(Handle, L"DenyUnspecified", &v64) < 0 || !v64 )
  {
    v7 = 0;
    goto LABEL_117;
  }
  v42 = P;
  if ( (a3 || !P) && (!byte_140C54E98 || !byte_140D01908) )
    goto LABEL_119;
  v7 = 0;
LABEL_120:
  if ( v42 )
