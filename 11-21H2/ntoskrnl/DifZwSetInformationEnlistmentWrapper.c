/*
 * XREFs of DifZwSetInformationEnlistmentWrapper @ 0x140627040
 * Callers:
 *     <none>
 * Callees:
...
NTSTATUS __fastcall DifZwSetInformationEnlistmentWrapper(
        ...
        ULONG EnlistmentInformationLength)
{
  ...
  v20 = 0LL;
  v21 = 0LL;
  APIThunkContextById = DifGetAPIThunkContextById(622);
...
LABEL_13:
  *(_QWORD *)&v21 = EnlistmentHandle;
  DWORD2(v20) = EnlistmentInformationClass;
  *(_QWORD *)&v20 = EnlistmentInformation;
  DWORD2(v19) = EnlistmentInformationLength;
...
LABEL_18:
  result = ZwSetInformationEnlistment(
             EnlistmentHandle,
