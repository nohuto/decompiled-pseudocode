/*
 * XREFs of sub_140A35D9C @ 0x140A35D9C
 * Callers:
...
__int64 __fastcall sub_140A35D9C(__int64 *a1, _WORD *a2, unsigned int a3, __int64 a4, wchar_t *Str2)
{
  char v6; // r15
  wchar_t *v7; // rbx
  char v8; // di
  ...
  if ( a1 && a2 && a4 && a3 <= 3 )
  {
    ...
    *(_WORD *)(a4 + 2 * v9 + 20) = 0;
    ...
    if ( v8 )
    {
      ...
      v34 = sub_140830BF0((__int64)v33, (__int64)&v38, Buffer, 1026);
      v13 = v34;
      if ( v34 < 0 )
        return (unsigned int)v13;
      v14 = v31;
      v15 = ((unsigned __int8)v38 ^ (unsigned __int8)*v36) & 0x18;
      LOBYTE(v31) = 0;
      LOWORD(v38) = v15 ^ v38;
      *(_WORD *)(a4 + 2 * v9 + 20) = v14;
      v16 = 0;
      if ( Str2 && *Str2 && sub_1408307E0(v7, Str2) )
      {
        v17 = v33;
        if ( (int)sub_140A356D0((__int64)v33, Str2, v29, 0LL, &v32) >= 0 )
        {
          LOBYTE(v31) = 1;
          v16 = 1;
          WORD6(v38) = v32;
      ...
      if ( v7 )
      {
        ...
        do
        {
          if ( !*v7 || v19 >= 8 )
            break;
          if ( (int)sub_140A356D0((__int64)v17, v7, &v28, 0LL, v30) >= 0 && (!(_BYTE)v31 || v18 != v28 || v32 != v30[0]) )
          {
            ++v16;
            v20 = (v28 & 3) << v19;
            v21 = WORD4(v38) & ~(3 << v19);
...
LABEL_40:
      ...
      v13 = sub_14085EE64(v17 + 3, (__int64)&v38, v30);
      if ( v13 < 0 )
        return (unsigned int)v13;
      v6 = 2;
    }
    ...
    {
      v13 = sub_140A356D0((__int64)v33, DestinationString.Buffer, &v28, v11, v30);
      if ( v13 < 0 )
        return (unsigned int)v13;
      v6 = v28;
    }
