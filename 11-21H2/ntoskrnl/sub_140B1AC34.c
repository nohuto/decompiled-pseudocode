/*
 * XREFs of sub_140B1AC34 @ 0x140B1AC34
 * Callers:
...
__int64 __fastcall sub_140B1AC34(unsigned __int64 a1, int a2)
{
  __int64 v3; // rbp
  __int64 v4; // rcx
  const void **v5; // rdi
  ...
  v4 = (__int64)(a1 << 25) >> 16;
  if ( (PVOID)v4 != qword_140D06988 && (PVOID)v4 != qword_140D068F0 )
  ...
  result = (__int64)sub_1402828F0(64, ((unsigned __int64)v10 >> 3) + 40, 0x70446D4Du);
