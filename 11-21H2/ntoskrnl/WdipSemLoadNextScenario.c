/*
 * XREFs of WdipSemLoadNextScenario @ 0x14084028C
 * Callers:
...
LABEL_69:
        ...
        if ( v8 >= 0 )
        {
          ...
          if ( v8 >= 0 )
          {
            v17 = WdipSemQueryValueFromRegistry(Handle, &v34, (__int64)&ResultLength);
            v8 = v17;
            if ( v17 < 0 )
            {
              if ( v17 != -1073741772 )
            ...
            v19 = WdipSemQueryValueFromRegistry(Handle, &v38, (__int64)&ResultLength);
            v8 = v19;
            if ( v19 >= 0 )
            {
              v20 = v38;
...
LABEL_29:
              v21 = WdipSemQueryValueFromRegistry(Handle, &v35, (__int64)&ResultLength);
              v8 = v21;
              if ( v21 >= 0 )
              {
...
LABEL_33:
              ...
              while ( 1 )
              {
                v24 = WdipSemFastAllocate(0, 0x30u);
                v6 = v24;
                if ( !v24 )
                  goto LABEL_76;
                *v24 = 0LL;
                v24[1] = 0LL;
                v24[2] = 0LL;
                NextEndEvent = WdipSemLoadNextEndEvent(KeyHandlea, v23++, (GUID *)v24);
                v8 = NextEndEvent;
                ...
                if ( (unsigned int)v29 >= 0x10 )
                {
                  ...
                  {
                    v30 = &WDI_SEM_EVENT_INIT_SCENARIO_END_EVENT_MAX;
LABEL_68:
                    WdipSemWriteScenarioLimitExceededEvent(v30, Guid, LOWORD(Guid[1].Data1));
                  }
                  goto LABEL_69;
                }
              ...
              if ( !v7 )
              {
                ...
                while ( 1 )
                {
                  ...
                  *v6 = 0LL;
                  v6[1] = 0LL;
                  v6[2] = 0LL;
                  NextContextProvider = WdipSemLoadNextContextProvider(v36, v26++, (GUID *)v6);
                  ...
                  if ( (unsigned int)Data1 >= 0x7C )
                  {
                    if ( !EtwEventEnabled(WdipSemRegHandle, &WDI_SEM_EVENT_INIT_SCENARIO_CONTEXT_PROVIDER_MAX) )
                      goto LABEL_69;
                    v30 = &WDI_SEM_EVENT_INIT_SCENARIO_CONTEXT_PROVIDER_MAX;
                    goto LABEL_68;
                  }
