/*
 * XREFs of sub_1405DAD64 @ 0x1405DAD64
 * Callers:
...
char __fastcall sub_1405DAD64(__int64 a1, char a2, char a3)
{
  _UNKNOWN **v3; // rax
  REGHANDLE v5; // rbx
  ...
  {
    v5 = qword_140C1F580;
    LOBYTE(v3) = EtwEventEnabled(qword_140C1F580, &stru_140038710);
    if ( (_BYTE)v3 )
    {
      UserData.Reserved = 0;
      v10 = 0;
      ...
      UserData.Size = 2;
      v9 = 8;
      LOBYTE(v3) = EtwWriteEx(v5, &stru_140038710, 0LL, 0, 0LL, 0LL, 4u, &UserData);
    }
  }
  return (char)v3;
}
