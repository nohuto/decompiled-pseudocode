/*
 * XREFs of sub_14081E700 @ 0x14081E700
 * Callers:
...
int sub_14081E700()
{
  ...
  *(_QWORD *)&v7.Length = 1703960LL;
  KeWaitForSingleObject(&stru_140C4A480, Executive, 0, 0, 0LL);
  ...
  if ( result >= 0 )
  {
    ...
    *(_OWORD *)&ObjectAttributes.SecurityDescriptor = 0LL;
    ...
    if ( v1 >= 0 )
    {
      Data = (unsigned __int8)byte_140C4BFF8;
      ZwSetValueKey(Handle, &ValueName, 0, 4u, &Data, 4u);
      Data = (unsigned __int8)byte_140C4BFE0;
      ZwSetValueKey(Handle, &v5, 0, 4u, &Data, 4u);
      Data = SlotNumber | (BusNumber << 16);
      ZwSetValueKey(Handle, &v6, 0, 4u, &Data, 4u);
      Data = dword_140C4BFF4;
