/*
 * XREFs of CarEtwWriteBugCheckEvent @ 0x140602808
 * Callers:
 ...
 *     CarIncrementEtwEventCount @ 0x140602DD4 (CarIncrementEtwEventCount.c)
      ...
      if ( v9 < 0xA || v9 == 100 || v9 == 1000 || v9 == 10000 )
      {
        ...
        if ( Pool2 )
        {
          ...
          if ( v15 )
          {
            ...
            else if ( tlgKeywordOn((__int64)&dword_140C090C0, 0x800000000000LL) )
            {
              v25 = v11;
              v30 = &v25;
              v26 = CarTipTag;
              ...
              v23 = a4;
              v35 = 1LL;
              tlgCreate1Sz_wchar_t((__int64)v36, (const WCHAR *)(a1 + 4));
              v21 = v24;
              ...
              tlgWriteTransfer_EtwWriteTransfer(
                (__int64)&dword_140C090C0,
                (unsigned __int8 *)&word_1400345C6,
                0LL,
                0LL,
                0xCu,
                &v29);
