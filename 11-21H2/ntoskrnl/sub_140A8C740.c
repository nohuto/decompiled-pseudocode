/*
 * XREFs of sub_140A8C740 @ 0x140A8C740
 * Callers:
  ...
  if ( v10 )
  {
    ...
    if ( v15 )
    {
      ...
      if ( *(_OWORD *)(a6 + 28) == *(_OWORD *)(v9 + 28) && *((_BYTE *)a6 + 3) == *((_BYTE *)v9 + 3) )
      {
        if ( v17 )
        {
          if ( !(unsigned int)sub_140A922F8(*((_QWORD *)v9 + 5)) )
          {
            sub_1405FFB44(0x207u, a5, (const void *)a4);
            *((_QWORD *)a6 + 7) = 0LL;
            *((_BYTE *)a6 + 3) = 0;
          }
          goto LABEL_16;
