/*
 * XREFs of sub_14058CF54 @ 0x14058CF54
 * Callers:
...
__int64 __fastcall sub_14058CF54(__int64 a1, __int64 a2, __int64 a3)
{
  int v3; // r9d
  ...
  do
  {
    ...
    {
      v12 = sub_1405AF110(v5, 0xFFFFDE0000000000uLL, 0xFFFFF68000000000uLL);
      v20 = *(_BYTE *)(v12 + 34) & 7;
      v13 = *(_QWORD *)(v12 + 8);
      ...
      v15 = sub_140235E10(v12);
      v11 = qword_14001C780[v15]
          + ((0xAAAAAAAAAAAAAAABuLL * ((__int64)(v5 + 0x220000000000LL) >> 4)) & ~(qword_14001C780[v15] - 1))
      ...
      if ( (v20 & 0xFFFFFFFA) == 0 && v20 != 4
        || v21 == 1
        || (v19 & 0x40) != 0 && v14 && sub_1402CFEB0(v14) <= 0xFFFF800000000000uLL )
      {
        goto LABEL_13;
      }
    }
    else
    {
      ...
      if ( (v3 & 0x40) != 0 )
      {
        ...
        if ( v17 >= 0xFFFFF68000000000uLL && v17 <= 0xFFFFF6FFFFFFFFFFuLL )
        {
          ...
          if ( (v18 < 0xFFFFF68000000000uLL || v18 > 0xFFFFF6FFFFFFFFFFuLL) && v18 <= 0xFFFF800000000000uLL )
          {
LABEL_13:
            if ( !v8 )
