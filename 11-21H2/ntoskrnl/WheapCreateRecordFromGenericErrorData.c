/*
 * XREFs of WheapCreateRecordFromGenericErrorData @ 0x140645708
 * Callers:
 *     WheapDeviceDriverCreateRecord @ 0x140644750 (WheapDeviceDriverCreateRecord.c)
 *     WheapDefaultErrSrcCreateRecord @ 0x140645A60 (WheapDefaultErrSrcCreateRecord.c)
 * Callees:
...
__int64 __fastcall WheapCreateRecordFromGenericErrorData(__int64 a1, __int64 a2, __int64 a3, unsigned int a4)
{
  ...
  char v32; // [rsp+30h] [rbp-61h]
  int v33; // [rsp+34h] [rbp-5Dh]
...
LABEL_49:
  ...
  *(_DWORD *)(a3 + 104) ^= (*(_DWORD *)(a3 + 104) ^ (2 * *(_DWORD *)(a2 + 12))) & 2;
  v16 = *(_DWORD *)(a3 + 104);
  v17 = v16 ^ (*(_DWORD *)(a2 + 12) >> 1);
  *(_DWORD *)(a3 + 20) = v5;
  *(_DWORD *)(a3 + 104) = v16 ^ v17 & 4;
  v33 = (*v8 >> 4) & 0x3FF;
  if ( v33 )
  {
    while ( v9 + 64 >= v9 )
    {
      ...
      LODWORD(Size) = v21;
      v32 = v24;
      v15 = WheapAddSectionFromGenericErrorData(a1, a3, v5, v18, Size, 1);
      if ( v15 >= 0
...
LABEL_31:
  ...
  if ( (_DWORD)v25 && (v26 = v8[2]) != 0 )
  {
    ...
    v28 = (_DWORD *)a1;
    LODWORD(Size) = v26;
    v15 = WheapAddSectionFromGenericErrorData(a1, a3, v5, v27, Size, 0);
    if ( v15 < 0 )
    {
  ...
  if ( !*(_DWORD *)(a2 + 20) )
    WheapAddRecoveryPacketToErrorRecord(v28, a3, v5);
  v29 = 0;
  if ( v15 < 0 )
    goto LABEL_49;
  return v29;
