/*
 * XREFs of sub_14036A410 @ 0x14036A410
 * Callers:
...
char __fastcall sub_14036A410(__int64 a1)
{
  _UNKNOWN **v1; // rax
  REGHANDLE v3; // rdi
  ...
  {
    v3 = RegHandle;
    LOBYTE(v1) = EtwEventEnabled(RegHandle, &stru_140011138);
    if ( (_BYTE)v1 )
    {
      UserData.Reserved = 0;
      v8 = 0;
      ...
      v22 = 4;
      UserData.Size = 8;
      LOBYTE(v1) = EtwWriteEx(v3, &stru_140011138, 0LL, 0, 0LL, 0LL, 7u, &UserData);
    }
  }
  return (char)v1;
}
