/*
 * XREFs of sub_140B4C8B8 @ 0x140B4C8B8
 * Callers:
        ...
        __int64 a8)
{
  ...
  v10 = *(unsigned int *)(qword_140C4AD20 + 4);
  if ( (unsigned int)v10 >= 0x38 )
  {
    v11 = *(unsigned int *)(qword_140C4AD20 + 36);
    if ( (unsigned int)v10 >= (unsigned int)v11
      && (unsigned int)v11 >= 0x38
      && (!a5 || (unsigned int)(*(_DWORD *)(qword_140C4AD20 + 44) + 1) >= *a5) )
    {
      v12 = *(_DWORD *)(qword_140C4AD20 + 40) + 1;
      if ( v12 <= a2 )
      {
        v13 = *a1;
        if ( *a1 <= a2 && (!a4 || *a3 <= a4) )
        {
          LODWORD(v14) = 0;
          v15 = qword_140C4AD20 + v11;
          v34 = 0;
          v16 = (unsigned int *)(qword_140C4AD20 + v11 + 2);
          v17 = 0;
          v18 = qword_140C4AD20 + v11;
          v19 = qword_140C4AD20 + v10;
          v20 = v16;
          v35 = v19;
LABEL_29:
...
LABEL_41:
              ...
              if ( a5 )
                *a5 = *(_DWORD *)(qword_140C4AD20 + 44) + 1;
            }
          }
          else
          {
