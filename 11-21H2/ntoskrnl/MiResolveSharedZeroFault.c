/*
 * XREFs of MiResolveSharedZeroFault @ 0x140317AB0
 * Callers:
...
unsigned __int64 __fastcall MiResolveSharedZeroFault(unsigned int *a1)
{
    ...
    && ((v12 & 0x20) == 0 || (v12 & 0x42) == 0) )
  {
    ...
    if ( Flink )
    {
      v68 = *((_QWORD *)&Flink->Flink + ((v11 >> 3) & 0x1FF));
      v69 = v12 | 0x20;
      if ( (v68 & 0x20) == 0 )
        v69 = v12;
      v12 = v69;
  ...
  v95 = v12;
  v13 = MI_READ_PTE_LOCK_FREE((unsigned __int64)&v95);
  v2 = 0LL;
  ...
  if ( _interlockedbittestandset64((volatile signed __int32 *)(v17 + 24), 0x3FuLL) )
  {
    ...
    {
      do
        KeYieldProcessorEx(&v107, v14, v15, v16);
    ...
    do
    {
        ...
        && KeGetCurrentThread()->ApcState.Process->AddressPolicy != 1 )
      {
        ...
        if ( (v21 & 0x20) == 0 || (v21 & 0x42) == 0 )
        {
          ...
          if ( v70 )
          {
            v71 = *((_QWORD *)&v70->Flink + ((v20 >> 3) & 0x1FF));
            v72 = v21 | 0x20;
            if ( (v71 & 0x20) == 0 )
              v72 = v21;
            LOBYTE(v21) = v72;
...
LABEL_12:
  ...
  {
    result = MiSwizzleInvalidPte(32 * (v6 & 0x1F | 0xFFFFFFFFF8000020uLL));
  }
  *v7 = result;
  v24 = *((_QWORD *)v3 + 8);
  if ( v24 )
...
LABEL_68:
            ...
            if ( v42 >= 0xFFFFF6FB7DBED000uLL && v42 <= 0xFFFFF6FB7DBED7F8uLL && (MiFlags & 0xC00000) != 0 )
            {
                ...
                && ((v43 & 0x20) == 0 || (v43 & 0x42) == 0) )
              {
                ...
                if ( v75 )
                {
                  v76 = *((_QWORD *)&v75->Flink + ((v42 >> 3) & 0x1FF));
                  v77 = v43 | 0x20;
                  if ( (v76 & 0x20) == 0 )
                    v77 = *(_QWORD *)v42;
                  v43 = v77;
            ...
            if ( !v43 )
            {
              ProtoPteAddress = MiGetProtoPteAddress(v24, v41 >> 12, 4LL, &v96);
              if ( !ProtoPteAddress )
                goto LABEL_68;
              v45 = *(_QWORD **)(v24 + 120);
                ...
                && ((v50 & 0x20) == 0 || (v50 & 0x42) == 0) )
              {
                ...
                if ( v78 )
                {
                  v79 = *((_QWORD *)&v78->Flink + ((v49 >> 3) & 0x1FF));
                  v80 = v50 | 0x20;
                  if ( (v79 & 0x20) == 0 )
                    v80 = v50;
                  v50 = v80;
              ...
              v98 = v50;
              v54 = 48 * (((unsigned __int64)MI_READ_PTE_LOCK_FREE((unsigned __int64)&v98) >> 12) & 0xFFFFFFFFFFLL)
                  - 0x220000000000LL;
              v86 = 0;
              while ( _interlockedbittestandset64((volatile signed __int32 *)(v54 + 24), 0x3FuLL) )
              {
                do
                  KeYieldProcessorEx(&v86, v51, v52, v53);
                ...
                do
                {
                    ...
                    && KeGetCurrentThread()->ApcState.Process->AddressPolicy != 1 )
                  {
                    ...
                    if ( (v58 & 0x20) == 0 || (v58 & 0x42) == 0 )
                    {
                      ...
                      if ( v81 )
                      {
                        v82 = *((_QWORD *)&v81->Flink + ((v57 >> 3) & 0x1FF));
                        v83 = v58 | 0x20;
                        if ( (v82 & 0x20) == 0 )
                          v83 = v58;
                        LOBYTE(v58) = v83;
...
LABEL_59:
              if ( v37 == 256 )
              {
                v59 = MiSwizzleInvalidPte((ProtoPteAddress << 16) | 0x400);
              }
              else
              {
