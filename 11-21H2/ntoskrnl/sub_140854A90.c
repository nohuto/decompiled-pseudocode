/*
 * XREFs of sub_140854A90 @ 0x140854A90
 * Callers:
...
__int64 __fastcall sub_140854A90(__int64 *a1, int *a2)
{
  __int64 result; // rax
  int v3; // ecx
  bool v4; // zf
  ...
  if ( (result & 0x4000000000LL) != 0 && byte_140D069CF )
    *a2 |= 2u;
  if ( (result & 0xCC54000000EC0LL) != 0 )
    *a2 |= 2u;
  if ( (result & 0x20180000000000LL) != 0 )
    *a2 |= 0x1000u;
