/*
 * XREFs of HvStoreModifiedData @ 0x140689424
 * Callers:
...
__int64 __fastcall HvStoreModifiedData(ULONG_PTR BugCheckParameter2, char a2, char a3)
{
  ...
  *(_DWORD *)(BugCheckParameter2 + 1728) = (unsigned __int8)HvpTruncateBins(BugCheckParameter2);
  ...
  if ( *(_DWORD *)(BugCheckParameter2 + 104) )
  {
    ...
    LODWORD(v47) = v40;
    *((_QWORD *)&v47 + 1) = v5;
    v12 = HvpGenerateLogEntry(BugCheckParameter2, (PVOID **)&P, &Size_4, &v41);
    v6 = (PVOID *)P;
    if ( v12 < 0 )
    {
      v16 = 2;
    ...
    if ( v23 )
    {
      ...
      if ( v24 )
      {
        ...
        if ( v48 )
        {
          ...
          do
          {
            if ( !(unsigned __int8)HvpFindNextDirtyBlock(BugCheckParameter2, (__int64)&v38, (__int64)&v51, 1) )
              break;
            v26 = v46;
            if ( !v46 )
              goto LABEL_49;
