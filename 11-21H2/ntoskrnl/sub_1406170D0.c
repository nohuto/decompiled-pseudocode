/*
 * XREFs of sub_1406170D0 @ 0x1406170D0
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall sub_1406170D0(ULONG_PTR BugCheckParameter2)
{
  __int64 v2; // rdx
  __int64 v3; // rcx
  __int64 *v4; // rdi
...
LABEL_18:
  result = MmLockPagableImageSection(BugCheckParameter2);
  v15 = result;
  if ( v4 )
  {
    v12 = (_QWORD **)(v4 + 6);
