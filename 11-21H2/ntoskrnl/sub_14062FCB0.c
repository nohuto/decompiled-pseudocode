/*
 * XREFs of sub_14062FCB0 @ 0x14062FCB0
 * Callers:
 *     <none>
 * Callees:
...
void __fastcall sub_14062FCB0(int a1, int a2, __int64 a3, __int64 a4)
{
  char *v5; // r10
  char v8; // r8
  __int64 v9; // rax
...
LABEL_3:
  ...
  if ( v8 == 14 )
  {
    v13 = sub_14062EE14((IRP *)a3);
    if ( v13 )
    {
      v14 = *(_BYTE *)v13;
      v15 = (*((unsigned __int8 *)v13 + 5) | (unsigned __int64)((*((unsigned __int8 *)v13 + 4) | ((*((unsigned __int8 *)v13 + 3) | (*((unsigned __int8 *)v13 + 2) << 8)) << 8)) << 8)) << 11;
      if ( ((v14 - 40) & 0x7F) != 0 )
      {
        if ( ((v14 - 42) & 0x7F) != 0 )
        {
...
LABEL_41:
      v49 = 0;
      v47 = v12;
      sub_14035EDE4((__int64)&v47, 1u, 0x80000001, v11, 0x401803u);
    }
  }
}
