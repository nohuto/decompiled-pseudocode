/*
 * XREFs of sub_140614220 @ 0x140614220
 * Callers:
 *     <none>
 * Callees:
...
PVOID __fastcall sub_140614220(PNMI_CALLBACK CallbackRoutine, PVOID Context)
{
  __int64 v4; // rdx
  __int64 v5; // rcx
  __int64 *v6; // rdi
