/*
 * XREFs of sub_1404294D0 @ 0x1404294D0
 * Callers:
...
__int64 __fastcall sub_1404294D0(__int16 a1, const char *a2, unsigned int a3)
{
  char v3; // r11
  const char *v5; // r10
  unsigned int v6; // ecx
...
LABEL_9:
          if ( (unsigned int)v8 >> 2 )
          {
            ...
            v10 = 0;
            if ( v11 )
              return ((__int64 (__fastcall *)(__int64, __int64, _QWORD))((char *)&loc_14042957A + 4 * (16LL - v11)))(
                       v8,
                       16LL - v11,
                       v9 + 1);
            do
