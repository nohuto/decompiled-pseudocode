/*
 * XREFs of sub_140B13790 @ 0x140B13790
 * Callers:
 *     sub_140B13578 @ 0x140B13578 (sub_140B13578.c)
 * Callees:
 *     RtlEqualUnicodeString @ 0x1407CD6A0 (RtlEqualUnicodeString.c)
 *     sub_140B138C4 @ 0x140B138C4 (sub_140B138C4.c)
 */

char __fastcall sub_140B13790(__int64 **a1, unsigned __int16 *a2)
{
  __int16 v4; // bp
  wchar_t *v5; // rcx
  __int64 *v6; // r15
  ...
  String1 = 0LL;
  if ( !(unsigned __int8)sub_140B138C4(a1, a2) )
    return 0;
  v4 = 0;
