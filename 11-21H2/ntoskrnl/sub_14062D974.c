/*
 * XREFs of sub_14062D974 @ 0x14062D974
 * Callers:
...
NTSTATUS __fastcall sub_14062D974(__int64 a1, int a2, int a3, char a4)
{
  int v4; // ecx
  NTSTATUS result; // eax
  ...
  if ( qword_140C15FD0 )
  {
    ...
    *(_QWORD *)&UserData.Size = 4LL;
    ...
    v15 = 4LL;
    v17 = 1LL;
    return EtwWriteEx(qword_140C15FD0, &stru_1400381A0, 0LL, 0, 0LL, 0LL, 5u, &UserData);
  }
  return result;
}
