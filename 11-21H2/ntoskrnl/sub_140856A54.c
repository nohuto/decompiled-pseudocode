/*
 * XREFs of sub_140856A54 @ 0x140856A54
 * Callers:
...
void __fastcall sub_140856A54(__int64 a1, __int64 a2, PVOID *a3)
{
  __int64 v4; // rsi
  __int64 v5; // rax
  WCHAR *v8; // rbx
  ...
  if ( !Pool2 )
    goto LABEL_11;
  v12 = sub_1402E1280(Pool2, (unsigned int)v9, L"%ws\\StackLevelKwFilter", a1);
  if ( v12 )
    goto LABEL_10;
  ...
  *(_OWORD *)&ObjectAttributes.SecurityDescriptor = 0LL;
  ...
  if ( a2 )
  {
    ...
    if ( !v15 )
      goto LABEL_11;
    v12 = sub_1402E1280(v15, v14, L"%ws\\StackLevelKwFilter", a2);
    if ( v12 )
      goto LABEL_10;
...
LABEL_10:
  ...
  *a3 = (PVOID)v17;
  ...
  v31[23] = L"FilterIn";
  v31[7] = sub_1408166C0;
  v31[14] = sub_1408166C0;
  LODWORD(v31[18]) = 4;
  v27 = 4;
  v31[21] = sub_1408166C0;
  LODWORD(v31[25]) = 4;
  v29 = 4;
  v30 = v18 + 17;
  if ( (int)sub_140781F40(0x40000000, (const WCHAR *)KeyHandle, (__int64)v31, 0LL) < 0 )
  {
LABEL_11:
    if ( *a3 )
    {
  ...
  if ( Handle )
  {
    ...
    v31[19] = v31[5] + 16LL;
    v31[26] = v31[5] + 17LL;
    sub_140781F40(0x40000000, (const WCHAR *)Handle, (__int64)v31, 0LL);
  }
LABEL_13:
  if ( KeyHandle )
    ZwClose(KeyHandle);
