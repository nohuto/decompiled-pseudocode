/*
 * XREFs of sub_1403BA410 @ 0x1403BA410
 * Callers:
...
__int64 __fastcall sub_1403BA410(__int64 a1, __int64 a2, __int64 a3, int a4, __int64 *a5)
{
  int v6; // edi
  __int64 Pool2; // rax
  __int64 v8; // rbx
  ...
  *(_OWORD *)P = 0LL;
  ...
  if ( v6 >= 0 )
  {
    ...
    if ( Pool2 )
    {
      ...
      *(_DWORD *)(v8 + 428) = 0;
      *(_WORD *)(v8 + 424) = 0;
      *(_QWORD *)(v8 + 456) = sub_1403B5F40;
      *(_DWORD *)(v8 + 432) = 275;
      *(_QWORD *)(v8 + 464) = v8;
      *(_QWORD *)(v8 + 488) = 0LL;
      *(_QWORD *)(v8 + 448) = 0LL;
      *(_QWORD *)(v8 + 320) = sub_1405CC080;
      *(_QWORD *)(v8 + 328) = v8;
      *(_QWORD *)(v8 + 304) = 0LL;
      *(_QWORD *)(v8 + 1224) = sub_1403B1020;
      *(_QWORD *)(v8 + 1232) = v8;
      *(_QWORD *)(v8 + 1208) = 0LL;
      *(_QWORD *)(v8 + 1152) = 0LL;
      *(_QWORD *)(v8 + 936) = sub_1405CC160;
      *(_QWORD *)(v8 + 944) = v8;
      *(_QWORD *)(v8 + 920) = 0LL;
