/*
 * XREFs of sub_14023E074 @ 0x14023E074
 * Callers:
...
bool __fastcall sub_14023E074(__int64 a1)
{
  __int64 v2; // rdi

  v2 = qword_140C5AE80;
  return *(_BYTE *)(a1 + 1) >= 2u
      && *(_BYTE *)a1 == *(_BYTE *)qword_140C5AE80
      && RtlCompareMemory((const void *)(a1 + 2), (const void *)(qword_140C5AE80 + 2), 6uLL) == 6
