/*
 * XREFs of sub_140A10EB0 @ 0x140A10EB0
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall sub_140A10EB0(_DWORD *a1, __int64 a2, int a3, __int64 a4, int a5, __int64 a6)
{
  int v6; // edx
  unsigned int v7; // ebx
  ...
  *a1 = 0;
  ...
  if ( (unsigned int)sub_140A126D0(
                       ...
                       (__int64)&v13,
                       (__int64)&v12)
    && (unsigned int)sub_140A10FDC(v17, v16, v10, v15, v18, v14, v13, v12, &v11) )
  {
    v7 = 1;
    *(_DWORD *)(a6 + 80) = 1;
    *a1 = v11;
  ...
  {
    sub_1406E0C3C(1LL, (__int64)"SdbpCheckMatchingRegistry");
  }
  return v7;
}
