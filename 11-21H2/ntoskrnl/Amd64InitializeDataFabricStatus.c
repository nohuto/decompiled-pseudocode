/*
 * XREFs of Amd64InitializeDataFabricStatus @ 0x14052BE78
 * Callers:
...
__int64 Amd64InitializeDataFabricStatus()
{
  ...
  if ( result )
  {
    ...
    v8 = Amd64CounterStatus + 24LL * Number * Amd64NumberCounters;
    v9 = HalpProfileInterface == &DefaultProfileInterface
       ? HalpCounterStatus
       : HalpCounterStatus + 8LL * Number * HalpNumberOfCounters;
