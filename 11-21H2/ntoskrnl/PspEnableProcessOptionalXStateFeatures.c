/*
 * XREFs of PspEnableProcessOptionalXStateFeatures @ 0x1409AD99C
 * Callers:
...
LABEL_20:
  ...
  ProcessorNodeNumberByIndex = KeGetProcessorNodeNumberByIndex(v17[147]);
  KernelStack = MmCreateKernelStack(0x20u, ProcessorNodeNumberByIndex, (__int64)(v15 - 167));
  if ( KernelStack )
  {
