/*
 * XREFs of sub_1409BBDD8 @ 0x1409BBDD8
 * Callers:
...
bool __fastcall sub_1409BBDD8(unsigned __int64 a1, int a2, char a3, char a4)
{
  ...
  if ( a3 )
    v10 = a1 + 2LL * (int)sub_1405EC744(a1, a2);
  else
    v10 = a1 - 2;
  ...
  for ( i = (unsigned __int16 *)a1; i != v9; ++i )
  {
    ...
    else if ( a4 && (v8 == 45 && i == v4 + 1 || !sub_1405ECE60((unsigned __int16)v8)) || v8 < 0x20 )
    {
      return 0;
    }
  }
