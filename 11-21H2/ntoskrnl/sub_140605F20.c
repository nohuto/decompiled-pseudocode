/*
 * XREFs of sub_140605F20 @ 0x140605F20
 * Callers:
 *     <none>
 * Callees:
...
NTSTATUS __fastcall sub_140605F20(PEX_CALLBACK_FUNCTION Function, PVOID Context, PLARGE_INTEGER Cookie)
{
  __int64 v6; // rdx
  __int64 v7; // rcx
  __int64 *v8; // rdi
