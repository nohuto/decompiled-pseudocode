/*
 * XREFs of sub_140396640 @ 0x140396640
 * Callers:
...
char __fastcall sub_140396640(__int64 a1, int a2, int a3, int a4, int a5, int a6, __int64 a7)
{
  char result; // al
  int v8; // r9d
  __int64 v9; // r10
  ...
  v27 = 0LL;
  v28 = 0LL;
  v13 = ((unsigned int)dword_140C23798 >> 3) & 1;
  v15 = ((unsigned int)dword_140C23798 >> 2) & 1;
  v14 = ((unsigned int)dword_140C23798 >> 4) & 1;
  sub_140A51C68(qword_140C22830, &v26);
  sub_140A51C68(qword_140C22848, &v27);
  sub_140A51C68(qword_140C22808, &v28);
  result = sub_140A51C68(a7, v29);
  v25 = dword_140C223B4 != 0;
  if ( (unsigned int)dword_140C03A00 > 5 )
  {
    ...
    if ( result )
    {
      ...
      v83 = 8LL;
      v85 = 4LL;
      result = sub_14020A9C4((__int64)&dword_140C03A00, (unsigned __int8 *)byte_14002EE90, 0LL, 0LL, 0x10u, &v57);
    }
  }
  if ( byte_140C5AE14 )
  {
    v10 = RegHandle;
    result = EtwEventEnabled(RegHandle, &stru_14000F950);
    if ( result )
    {
      *(_QWORD *)&UserData.Size = 4LL;
      ...
      v54 = 8LL;
      v56 = 4LL;
      return EtwWriteEx(v10, &stru_14000F950, 0LL, 0, 0LL, 0LL, 0xEu, &UserData);
    }
  }
  return result;
}
