/*
 * XREFs of sub_140991530 @ 0x140991530
 * Callers:
...
char __fastcall sub_140991530(__int64 a1, __int64 a2, int *a3)
{
  _UNKNOWN **v3; // rax
  int v4; // ebx
  int v5; // r9d
  ...
  if ( (unsigned int)*a3 <= 1 )
  {
    ...
    v14 = !v13;
    v29 = v4;
    LOBYTE(v3) = -45 * (dword_140C22B2C - 12);
    v30 = v11;
    v31 = v12;
    v15 = (dword_140C22B2C + 500) / 0x3E8u;
    v32 = v14;
    v23 = v6;
    v33 = v6;
    v24 = v7;
    ...
    {
      v16 = RegHandle;
      LOBYTE(v3) = EtwEventEnabled(RegHandle, &stru_140039178);
      if ( (_BYTE)v3 )
      {
        *(_QWORD *)&UserData.Size = 4LL;
        ...
        v62 = 4LL;
        v64 = 4LL;
        EtwWrite(v16, &stru_140039178, 0LL, 0xBu, &UserData);
        LOBYTE(v3) = v36;
        v10 = v27;
        v4 = v29;
        v11 = v30;
    ...
    if ( (unsigned int)dword_140C03A00 > 5 )
    {
      ...
      if ( (_BYTE)v3 )
      {
        ...
        v87 = 4LL;
        v89 = 4LL;
        LOBYTE(v3) = sub_14020A9C4((__int64)&dword_140C03A00, (unsigned __int8 *)byte_14002E8E9, 0LL, 0LL, 0xEu, &v65);
      }
    }
  }
  return (char)v3;
