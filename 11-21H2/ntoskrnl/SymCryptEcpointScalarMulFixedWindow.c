/*
 * XREFs of SymCryptEcpointScalarMulFixedWindow @ 0x140406130
 * Callers:
 *     <none>
 * Callees:
 ...
 *     SymCryptEcpointAddDiffNonZero @ 0x14040A580 (SymCryptEcpointAddDiffNonZero.c)
        ...
        __int64 a7)
{
  ...
  int IsEqualUint32; // [rsp+54h] [rbp-2A4h]
  ...
  else
  {
    ...
    if ( (_DWORD)v7 )
    {
      ...
      do
      {
        if ( v15 )
        {
          v18 = SymCryptSizeofEcpointFromCurve(a1);
          v17 = SymCryptEcpointCreate(v13, v18, a1);
          v19 = (unsigned int)SymCryptSizeofEcpointFromCurve(a1);
          v15 = a3;
          v13 += v19;
        }
        else
    ...
    v20 = SymCryptSizeofEcpointFromCurve(a1);
    v65 = SymCryptEcpointCreate(v13, v20, a1);
    v21 = v65;
    v22 = (unsigned int)SymCryptSizeofEcpointFromCurve(a1) + v13;
    v23 = SymCryptSizeofEcpointFromCurve(a1);
    v58 = SymCryptEcpointCreate(v22, v23, a1);
    v24 = (unsigned int)SymCryptSizeofEcpointFromCurve(a1) + v22;
    SymCryptSizeofIntFromDigits();
    v25 = SymCryptIntCreate();
    v26 = (unsigned int)SymCryptSizeofIntFromDigits() + v24;
    SymCryptSizeofIntFromDigits();
    v27 = SymCryptIntCreate();
    v28 = SymCryptSizeofIntFromDigits();
    v29 = 4LL * v11;
    v59 = (char *)(v28 + v26);
    v30 = &v59[v29];
    ...
    v63 = v31;
    v32 = 2 * SymCryptSizeofIntFromDigits();
    v33 = a7
        - (v32
         + (unsigned int)SymCryptSizeofEcpointFromCurve(a1) * (v49 + 2)
         + *(_DWORD *)(a1 + 36)
         + ((8LL * v52 + 31) & 0xFFFFFFFFFFFFFFE0uLL));
    SymCryptIntCopy();
    IsEqualUint32 = SymCryptIntIsEqualUint32();
    v55 = SymCryptEcpointIsZero(a1, v56) | IsEqualUint32;
    v60 = ~((unsigned __int64)-(__int64)(unsigned int)SymCryptIntGetBit() >> 32);
    SymCryptIntFromModulus();
    SymCryptIntSubSameSize();
    SymCryptIntMaskedCopy();
    SymCryptFixedWindowRecoding(v51, v25, v27, (_DWORD)v59, (__int64)v30, v52);
    if ( a3 )
    {
      SymCryptEcpointCopy(a1, v56, v66[0]);
      v34 = v49;
      SymCryptPrecomputation(a1, v49, (unsigned int)v66, v65, v31, v33);
    }
    else
    {
      v34 = v49;
    ...
    if ( v52 != 2 )
    {
      ...
      do
      {
        if ( v39 )
        {
          ...
          do
          {
            SymCryptEcpointDouble(a1, v21, v21, 0, v31, v33);
            --v40;
          }
          while ( v40 );
          v37 = v58;
        ...
        SymCryptEcpointNegate(a1, v37, *(_DWORD *)v53, v31, v33);
        SymCryptEcpointAddDiffNonZero(a1, v21, v37, v21, v31, v33);
        v53 -= 4;
        --v50;
      }
      while ( v50 );
    ...
    SymCryptEcpointNegate(a1, v37, *(_DWORD *)v30, v31, v33);
    SymCryptEcpointAdd(a1, v21, v37, v21, 0, v31, v33);
    SymCryptEcpointNegate(a1, v21, v60, v31, v33);
    ...
    v47 = SymCryptEcpointIsZero(a1, v21) | v55;
    SymCryptEcpointSetZero(a1, v37, v31, v33);
    SymCryptEcpointMaskedCopy(a1, v37, v21, v47);
    SymCryptEcpointCopy(a1, v21, a5);
  }
  return v12;
}
