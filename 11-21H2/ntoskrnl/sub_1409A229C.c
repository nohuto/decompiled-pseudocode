/*
 * XREFs of sub_1409A229C @ 0x1409A229C
 * Callers:
...
void __fastcall sub_1409A229C(int a1, __int64 a2, unsigned int a3)
{
  __int64 v3; // rdi
  int v6; // ebx
  ...
  if ( v3 )
  {
    ...
    v8 = 0LL;
    sub_1409A2D68((unsigned int)v7, a1, a2, 3, v3, a3);
    v6 = sub_14042A5E0(*(_QWORD *)(a2 + 24), a3);
    sub_1409A2E54(v7, (unsigned int)v6);
    if ( v6 < 0 )
      sub_1409A8628("TtmpCallSetInputMode", 2503LL, (unsigned int)v6, 0xFFFFFFFFLL);
  }
}
