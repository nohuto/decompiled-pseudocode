/*
 * XREFs of sub_140B56C04 @ 0x140B56C04
 * Callers:
...
__int64 __fastcall sub_140B56C04(__int64 a1, unsigned int a2, int a3, unsigned __int32 *a4, unsigned __int32 *a5)
{
  int v9; // r8d
  ...
  v18 = 0;
  v19 = 0LL;
  v9 = sub_1403A9E4C(a1, a2, 0xCu, &v17);
  if ( v9 >= 0 )
  {
    if ( _byteswap_ulong(v17) == 0x10000 )
    {
      ...
      if ( v11 )
      {
        while ( 1 )
        {
          v9 = sub_1403A9E4C(a1, v12, 0x10u, &v19);
          if ( v9 < 0 )
            break;
          v9 = 0;
