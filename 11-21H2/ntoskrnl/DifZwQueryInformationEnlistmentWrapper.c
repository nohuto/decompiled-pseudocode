/*
 * XREFs of DifZwQueryInformationEnlistmentWrapper @ 0x140624670
 * Callers:
 *     <none>
 * Callees:
...
LABEL_13:
  ...
  *((_QWORD *)&v22 + 1) = EnlistmentHandle;
  LODWORD(v22) = EnlistmentInformationClass;
  *((_QWORD *)&v21 + 1) = EnlistmentInformation;
  LODWORD(v21) = EnlistmentInformationLength;
