/*
 * XREFs of DrvDbGetDriverDatabaseMappedProperty @ 0x1406C1FDC
 * Callers:
...
LABEL_18:
  if ( a3 && (!v12 || (*(_DWORD *)(v12 + 64) & 0x10) == 0)
    || (!v12 || (*(_DWORD *)(v12 + 64) & 0x10) == 0
      ? (v31 = DrvDbOpenDriverDatabaseRegKey(v26, a2, 1LL, 0LL, &Handle, 0LL))
      : (v31 = DrvDbOpenObjectRegKey(v26, *(_QWORD *)(v26 + 40), 1, (_DWORD)a2, 1, 0, (__int64)&Handle, 0LL, 0LL)),
        RegValueMappedProperty = v31,
        v31 >= 0) )
  {
    v27 = a3;
    if ( Handle )
