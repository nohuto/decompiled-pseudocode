/*
 * XREFs of MiValidateInPage @ 0x140338080
 * Callers:
...
__int64 __fastcall MiValidateInPage(__int64 a1, __int64 a2)
{
  ...
  *(_DWORD *)(a2 + 188) += ((v14 & 0xFFF) != 0) + (v14 >> 12);
  ...
  {
    v18 = v13;
    if ( (MiFlags & 0x20000) != 0 && ((*(_DWORD *)(48 * v16 - 0x21FFFFFFFFF0LL) >> 5) & 2) != 0 )
      v43 = 3;
  }
  if ( (*(_DWORD *)(a2 + 192) & 0x10000) != 0 )
  {
    v18 |= 4u;
    if ( (MiFlags & 0x2000) != 0 && (v18 & 1) != 0 )
      v18 &= ~4u;
  }
  v19 = (*(_DWORD *)(48 * v16 - 0x21FFFFFFFFF0LL) >> 5) & 2;
  if ( ((*(_DWORD *)(48 * v16 - 0x21FFFFFFFFF0LL) >> 5) & 2) != 0 && (MiFlags & 0x20000) != 0 )
  {
    if ( (*(_BYTE *)(v2 + 10) & 1) != 0 )
        ...
        v4) )
  {
    ...
    {
      result = MiGetSectionStrongImageReference(v7, v13, v17, v7);
      if ( (int)result < 0 )
        return result;
    }
    v31 = v19 != 0;
  ...
  for ( i = 0LL; ; i += 8LL )
  {
    ...
    if ( v4 )
    {
      MiMarkPfnVerified(v23, v43);
      goto LABEL_19;
    }
    if ( (v18 & 2) != 0 )
    {
      v28 = MiValidateImagePfn(v21, *(_QWORD *)(a2 + 96), v20, -1, BugCheckOnFailure, v42, *v9, 0);
      if ( v28 < 0 )
        break;
    }
LABEL_19:
      ...
      && (v26 & 1) != 0 )
    {
      ...
      if ( Flink )
      {
        v35 = *((_QWORD *)&Flink->Flink + ((v25 >> 3) & 0x1FF));
        v36 = v26 | 0x20;
        if ( (v35 & 0x20) == 0 )
          v36 = *(_QWORD *)v25;
        v26 = v36;
...
LABEL_23:
    v4 = v45;
LABEL_24:
    if ( (int)MiRelocateImagePfn(v39, 0LL, Priority, 33) < 0 )
      goto LABEL_87;
    v21 = v39;
LABEL_26:
    *(_QWORD *)(a2 + 96) += 4096LL;
  ...
  {
    v44 = -1073740748;
    if ( (v18 & 1) != 0 && (MiFlags & 0x2000) != 0 && (*(_DWORD *)(a2 + 192) & 0x10000) != 0 )
      v18 |= 8u;
    goto LABEL_19;
  }
LABEL_87:
