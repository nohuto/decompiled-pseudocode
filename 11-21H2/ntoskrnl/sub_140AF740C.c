/*
 * XREFs of sub_140AF740C @ 0x140AF740C
 * Callers:
...
_QWORD *__fastcall sub_140AF740C(__int64 a1, __int64 a2)
{
  __int64 v2; // rbx
  unsigned int v3; // ebp
  __int64 v4; // rax
  ...
  if ( i )
  {
    ...
    if ( v3 )
    {
      v11 = sub_1402828F0(64, 16 * (v9 + 2), 0x6C4D6D4Du);
      v12 = v11;
      if ( v11 )
      {
        *v11 = v3;
        ...
        if ( j )
        {
          do
          {
            ...
            if ( (unsigned int)v18 < 0x2B && *(_BYTE *)(v18 + a2) )
            {
              v25 = *(_QWORD *)(j + 40);
              v26 = *(_QWORD *)(j + 32);
              v15 += v25;
          ...
          if ( v13 )
          {
            if ( v3 > v13 )
            {
              v22 = (char *)sub_1402828F0(64, 16 * (v13 - 1 + 2LL), 0x6C4D6D4Du);
              v23 = v22;
              if ( v22 )
              {
