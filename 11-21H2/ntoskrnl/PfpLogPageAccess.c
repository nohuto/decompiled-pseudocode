/*
 * XREFs of PfpLogPageAccess @ 0x1407DA200
 * Callers:
...
unsigned __int64 __fastcall PfpLogPageAccess(__int64 a1, _DWORD *a2, unsigned __int64 a3, unsigned __int64 a4, int a5)
{
  __int64 v5; // r12
  __int16 v6; // si
  _BYTE *v7; // r14
...
LABEL_57:
    ...
    if ( v47 < 3 * (*(_DWORD *)(a3 + 32) >> 2) )
      break;
    if ( (unsigned int)PfTReplaceCurrentBuffer(&unk_140C4E9A0, v14, a3, a4) == -1073741823 )
      return 0LL;
  }
  v13 = 1;
  *(_DWORD *)(a3 + 28) = v47 + 1;
...
LABEL_19:
      ...
      {
        while ( (unsigned int)PfTReplaceCurrentBuffer(&unk_140C4E978, v23, a3, a4) != -1073741823 )
        {
          v23 = qword_140C4E990;
          if ( (unsigned int)(v24 + *(_DWORD *)(qword_140C4E990 + 16)) <= *(_DWORD *)(qword_140C4E990 + 20) )
            goto LABEL_20;
...
LABEL_66:
    ...
    {
      if ( (unsigned int)PfTReplaceCurrentBuffer(&unk_140C4E9A0, v44, a3, a4) == -1073741823 )
        return 0LL;
      continue;
    }
    break;
