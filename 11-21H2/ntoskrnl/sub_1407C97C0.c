/*
 * XREFs of sub_1407C97C0 @ 0x1407C97C0
 * Callers:
...
__int64 __fastcall sub_1407C97C0(__int64 a1, unsigned int *a2)
{
  __int64 v2; // rdx
  __int64 v3; // rcx
  ULONG_PTR v4; // r8
  ...
  if ( !sub_140AB44C0(a1, *a2) )
    KeBugCheckEx(0x51u, 1uLL, v4, v6, 0x267uLL);
  sub_140AB44A4(v3, v2, v5 + 4);
  return sub_1407C97FC(v7);
}
