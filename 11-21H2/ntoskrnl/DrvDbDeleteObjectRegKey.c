/*
 * XREFs of DrvDbDeleteObjectRegKey @ 0x140A2DA0C
 * Callers:
...
__int64 __fastcall DrvDbDeleteObjectRegKey(__int64 *a1, int a2, wchar_t *a3, unsigned int a4)
{
  ...
  if ( ObjectDatabaseNode >= 0 )
  {
    if ( v19 )
    {
      v12 = DrvDbAcquireDatabaseNodeBaseKey(a1, (__int64)v19, v5, &v18);
      v11 = v12;
      if ( v12 >= 0 )
      {
...
LABEL_22:
  if ( v18 )
    DrvDbReleaseDatabaseNodeBaseKey((__int64)a1, (__int64)v10, v9, v18);
  return v11;
}
