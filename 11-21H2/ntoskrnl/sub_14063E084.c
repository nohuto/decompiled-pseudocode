/*
 * XREFs of sub_14063E084 @ 0x14063E084
 * Callers:
...
char __fastcall sub_14063E084(PKTIMER Timer, unsigned int a2, __int64 a3, __int64 a4, __int64 a5)
{
  ULONG v6; // esi
  char v9; // r12
  __int64 v10; // rdi
  ...
  v19[0] = 0LL;
  v20 = 0;
  KeAcquireSpinLockAtDpcLevel((PKSPIN_LOCK)&Timer[1]);
  v9 = sub_140252A60((__int64)Timer, v19, &v20, (unsigned int *)&Timer[5]);
  if ( v9 )
  {
    v10 = 0LL;
    if ( v20 == 1 )
  ...
  KeReleaseSpinLockFromDpcLevel((PKSPIN_LOCK)&Timer[1]);
  return v9;
}
