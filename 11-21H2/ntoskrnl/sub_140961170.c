/*
 * XREFs of sub_140961170 @ 0x140961170
 * Callers:
...
void __fastcall sub_140961170(unsigned __int64 a1)
{
  __int64 v2; // rdi
  int v3; // esi
  int v4; // r14d
  ...
  v4 = 0;
  v5 = 0;
  if ( (a1 < (unsigned __int64)qword_140D068F0 || a1 >= qword_140D06AD8)
    ...
    if ( (unsigned int)dword_140C02FD0 > 5 )
    {
      if ( sub_1402A2000((__int64)&dword_140C02FD0, 0x400000000000LL) )
      {
        ...
        *(_QWORD *)&DestinationString_8.Length = 0x1000000LL;
        sub_14020A9C4((__int64)&dword_140C02FD0, (unsigned __int8 *)byte_14002C63D, 0LL, 0LL, 0xAu, &v14);
      }
    }
