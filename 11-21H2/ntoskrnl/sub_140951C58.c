/*
 * XREFs of sub_140951C58 @ 0x140951C58
 * Callers:
...
__int64 __fastcall sub_140951C58(_QWORD *a1, _QWORD *a2, unsigned int a3)
{
  __int64 v5; // rbx
  _QWORD *Pool2; // rsi
  int v7; // ebx
  ...
  if ( v8 )
  {
    ...
    if ( a3 )
    {
      while ( 1 )
      {
        v7 = sub_1409525B4(2LL, &Pool2[3 * v9]);
        if ( v7 < 0 )
          break;
        v7 = sub_1409525B4(2050LL, &v8[3 * v9]);
        if ( v7 < 0 )
        {
          sub_14095212C(&Pool2[3 * v9]);
          break;
        }
