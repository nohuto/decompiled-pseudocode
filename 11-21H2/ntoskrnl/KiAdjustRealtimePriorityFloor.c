/*
 * XREFs of KiAdjustRealtimePriorityFloor @ 0x140291174
 * Callers:
...
void __fastcall KiAdjustRealtimePriorityFloor(ULONG_PTR BugCheckParameter1, int a2)
{
  ...
  if ( a2 >= 16 )
  {
    v4 = *(_BYTE *)((char)a2 + BugCheckParameter1 + 824);
    if ( v4 == -1 )
      KeBugCheckEx(0x157u, BugCheckParameter1, (char)a2, 1uLL, 0LL);
    *(_BYTE *)((char)a2 + BugCheckParameter1 + 824) = v4 + 1;
  ...
  *(_DWORD *)(BugCheckParameter1 + 1028) = a2;
  if ( v2 != 32 )
  {
    v5 = *(_BYTE *)((char)v2 + BugCheckParameter1 + 824);
    if ( !v5 )
      KeBugCheckEx(0x157u, BugCheckParameter1, (char)v2, 2uLL, 0LL);
    v6 = v5 - 1;
    *(_BYTE *)((char)v2 + BugCheckParameter1 + 824) = v6;
    if ( !v6 )
