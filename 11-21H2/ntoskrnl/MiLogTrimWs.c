/*
 * XREFs of MiLogTrimWs @ 0x140374708
 * Callers:
...
void __fastcall MiLogTrimWs(__int64 a1, __int64 a2, __int64 a3, int a4, int a5)
{
  ...
  {
    MiFillLogProcessInfo(a1, &v15, &v16, *(_QWORD *)(qword_140C51F48 + 8LL * *(unsigned __int16 *)(a1 + 174)));
    if ( *v8 > 5u )
    {
      if ( tlgKeywordOn((__int64)v8, 1LL) )
      {
        v11 = *(_BYTE *)(v10 + 184) & 7;
        v26 = v9;
        v14 = v11;
        v25 = &v14;
        tlgCreate1Sz_char((__int64)v27, v16);
        v28 = &v17;
        v17 = v15;
        v30 = &v19;
        v29 = 4LL;
        ...
        v41 = 4LL;
        v43 = 4LL;
        tlgWriteEx_EtwWriteEx(v13, (unsigned __int8 *)&byte_14002CDD7, 0LL, 1u, 0, 0, 0xCu, &v24);
      }
    }
  }
}
