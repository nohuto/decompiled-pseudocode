/*
 * XREFs of LdrpArmProcessRelocation @ 0x1405ED7A0
 * Callers:
 *     LdrpThumbProcessRelocation @ 0x1405ED928 (LdrpThumbProcessRelocation.c)
 *     LdrProcessRelocationBlockLongLong @ 0x1409BE7A8 (LdrProcessRelocationBlockLongLong.c)
 * Callees:
 *     <none>
 */
