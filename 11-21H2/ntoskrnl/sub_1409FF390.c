/*
 * XREFs of sub_1409FF390 @ 0x1409FF390
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall sub_1409FF390(unsigned int a1)
{
  ...
  v6 = 0;
  v5 = sub_14093E520(Dst, (__int64)&qword_140042090, 0LL, &v6, 0LL);
  if ( v5 != -1073741568 )
    goto LABEL_11;
...
LABEL_11:
    if ( !v5 || v5 == -1073741789 )
      v5 = sub_14093E830(Dst, (__int64)&qword_140042090, 0LL, 0, 1);
  }
