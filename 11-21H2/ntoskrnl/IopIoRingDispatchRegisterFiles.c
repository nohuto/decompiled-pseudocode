/*
 * XREFs of IopIoRingDispatchRegisterFiles @ 0x1409386B8
 * Callers:
...
LONG_PTR __fastcall IopIoRingDispatchRegisterFiles(__int64 a1, __int64 a2)
{
  ...
  *(_DWORD *)(a1 + 192) = 0;
  *(_QWORD *)(a1 + 200) = 0LL;
  LODWORD(v17) = IopIoRingGetBuffer(a1, a2, PreviousMode, (unsigned int)&v19, (__int64)&v18);
  if ( (int)v17 >= 0 )
  {
...
LABEL_23:
  ...
  *((_QWORD *)&v17 + 1) = i;
  return IopCompleteIoRingEntry(a1, *(_QWORD *)(a2 + 48), &v17, 0);
}
