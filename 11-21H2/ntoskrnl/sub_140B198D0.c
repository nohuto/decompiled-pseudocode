/*
 * XREFs of sub_140B198D0 @ 0x140B198D0
 * Callers:
 *     <none>
 * Callees:
...
__int64 sub_140B198D0()
{
  ...
  do
  {
    ...
    while ( (__int64)v1 < (__int64)&qword_140D68148 );
    --v0;
  }
  while ( v0 );
...
LABEL_10:
  ...
  sub_140B19FB4((ULONG_PTR)qword_140D068F0);
  return sub_140B19FB4((ULONG_PTR)qword_140D06988);
}
