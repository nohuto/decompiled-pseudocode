/*
 * XREFs of sub_14099A418 @ 0x14099A418
 * Callers:
...
char __fastcall sub_14099A418(__int64 a1, int a2, int a3, int a4)
{
  _UNKNOWN **v4; // rax
  REGHANDLE v6; // rbx
  __int16 v7; // ax
  ...
  {
    v6 = qword_140C1F580;
    LOBYTE(v4) = EtwEventEnabled(qword_140C1F580, &stru_140039140);
    if ( (_BYTE)v4 )
    {
      ...
      UserData.Size = 2;
      v12 = 1;
      LOBYTE(v4) = EtwWrite(v6, &stru_140039140, 0LL, 5u, &UserData);
    }
  }
  return (char)v4;
}
