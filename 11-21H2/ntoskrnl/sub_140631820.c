/*
 * XREFs of sub_140631820 @ 0x140631820
 * Callers:
 *     <none>
 * Callees:
...
void __fastcall sub_140631820(__int64 a1, _QWORD *a2, __int64 *a3)
{
  ...
  *a2 = 0LL;
  ...
  if ( !*(_DWORD *)(v7 + 320) )
  {
    ...
    KeReleaseSpinLockFromDpcLevel((PKSPIN_LOCK)(v7 + 912));
    if ( dword_140D06B08 )
    {
  ...
  if ( (*((_DWORD *)CurrentThread + 344) & 1) == 0 )
  {
    ...
    {
      sub_140631A8C(v7, 4096LL, CurrentThread, v14);
    }
  }
  sub_14063129C((unsigned int *)v7, a1);
}
