/*
 * XREFs of sub_14071C4C0 @ 0x14071C4C0
 * Callers:
...
__int64 __fastcall sub_14071C4C0(unsigned int **a1, __int64 a2, char a3, const UNICODE_STRING *a4)
{
  unsigned int *v4; // rsi
  ...
  if ( !_bittest64(&v9, v8) )
    return 3221225485LL;
  if ( sub_1402A2260((__int64)v4, *(_QWORD *)(a2 + 176), 1) )
  {
  ...
  {
    EcpContext = 0LL;
    if ( FsRtlFindExtraCreateParameter(v11, &stru_14000E3B8, &EcpContext, 0LL) >= 0 )
    {
      v12 = (char *)EcpContext;
