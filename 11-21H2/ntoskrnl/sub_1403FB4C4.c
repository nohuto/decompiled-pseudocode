/*
 * XREFs of sub_1403FB4C4 @ 0x1403FB4C4
 * Callers:
...
__int64 __fastcall sub_1403FB4C4(__m128i *a1, const __m128i *a2, unsigned __int64 a3, unsigned __int64 *a4)
{
  __int64 result; // rax
  __m128i v6; // xmm2
  __m128i v7; // xmm1
  ...
  if ( a3 >= 0x40 )
  {
    ...
    do
    {
      _XMM1 = _mm_shuffle_epi8(_mm_loadu_si128(a2), (__m128i)xmmword_140014100);
      _XMM2 = _mm_shuffle_epi8(_mm_loadu_si128(a2 + 1), (__m128i)xmmword_140014100);
      v13 = _mm_loadu_si128(a2 + 2);
      v14 = _mm_loadu_si128(a2 + 3);
      a2 += 4;
      _XMM3 = _mm_shuffle_epi8(v13, (__m128i)xmmword_140014100);
      _XMM4 = _mm_shuffle_epi8(v14, (__m128i)xmmword_140014100);
      v17 = _XMM10;
