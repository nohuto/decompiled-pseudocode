/*
 * XREFs of sub_14097471C @ 0x14097471C
 * Callers:
...
char __fastcall sub_14097471C(int a1, __int64 a2, unsigned __int16 *a3, int a4)
{
  _UNKNOWN **v4; // rax
  __int64 v5; // rbx
  __int64 v9; // r8
  ...
  if ( *(_QWORD *)&qword_140C53448 )
  {
      ...
      if ( a1 != 3 )
      {
        if ( a1 == 1 )
        {
          if ( **(_DWORD **)&qword_140C53448 <= 5u )
            return (char)v4;
          LOBYTE(v4) = sub_1402A2000(*(__int64 *)&qword_140C53448, 32LL);
          if ( !(_BYTE)v4 )
            return (char)v4;
        ...
        v19 = a4;
        LOBYTE(v4) = sub_14024A9B0(v5, (unsigned __int8 *)v13, v12, 1u, v15, v16, v17, v23);
        return (char)v4;
      }
      if ( **(_DWORD **)&qword_140C53448 > 5u )
      {
        ...
        if ( (_BYTE)v4 )
        {
          ...
          v36 = 0;
          v39 = 0;
          LOBYTE(v4) = sub_14024A9B0(v5, (unsigned __int8 *)&word_14002D55E, v11, 1u, v15, v16, 9u, v23);
        }
      }
    }
    else if ( **(_DWORD **)&qword_140C53448 > 5u )
    {
      ...
      if ( (_BYTE)v4 )
      {
        LODWORD(v21) = (unsigned int)PsGetProcessId(*((PEPROCESS *)KeGetCurrentThread() + 23));
        v25 = 4LL;
        ...
        v33 = 2LL;
        v36 = 0;
        LOBYTE(v4) = sub_14024A9B0(v5, (unsigned __int8 *)byte_14002D3AD, v9, 1u, v15, v16, 8u, v23);
      }
    }
  }
  return (char)v4;
