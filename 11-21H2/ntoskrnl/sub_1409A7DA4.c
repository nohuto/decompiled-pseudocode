/*
 * XREFs of sub_1409A7DA4 @ 0x1409A7DA4
 * Callers:
...
char __fastcall sub_1409A7DA4(int a1, __int64 a2, int a3, char a4, char a5, char a6)
{
  _UNKNOWN **v6; // rax
  ...
  if ( (unsigned int)dword_140D3B908 > 5 )
  {
    ...
    if ( (_BYTE)v6 )
    {
      ...
      v37 = 1;
      v40 = 1;
      LOBYTE(v6) = sub_14020A9C4((__int64)&dword_140D3B908, (unsigned __int8 *)&dword_140033C6C, 0LL, 0LL, 9u, &v20);
    }
  }
  return (char)v6;
}
