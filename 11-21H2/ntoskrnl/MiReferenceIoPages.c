/*
 * XREFs of MiReferenceIoPages @ 0x140215E54
 * Callers:
...
__int64 __fastcall MiReferenceIoPages(int a1, __int64 a2, __int64 a3, int a4, _DWORD *a5, __int64 *a6)
{
  __int64 v6; // r15
  __int64 v8; // rsi
  _QWORD *v9; // rbp
  ...
  if ( (_DWORD)v8 == 1 )
  {
    IsConstant = MiIoSpaceIsConstant(v10, v6);
    v56 = IsConstant;
  }
  MiLockIoPfnTree(5LL);
  if ( v6 )
...
LABEL_16:
      ...
      else
      {
        ...
        v18 = *(unsigned int *)(MiSearchNumaNodeTable(v10) + 8);
        LODWORD(v18) = v18 | 0x80000000;
        PoolMm = ExAllocatePoolMm(64LL, 1152LL, 1867082061LL, v18);
        v57 = (_QWORD *)PoolMm;
        v9 = (_QWORD *)PoolMm;
        if ( !PoolMm )
        {
          MiDereferenceIoPages(a1, v65, v10 - v65);
          return 3221225626LL;
        }
        *(_DWORD *)(PoolMm + 68) = 1;
        for ( j = (_WORD *)(PoolMm + 80); (unsigned __int64)j < PoolMm + 1104; ++j )
          *j |= 0xC000u;
        ...
        v58 = v35;
        if ( a1 == 1 && !IsConstant )
          v56 = MiIoSpaceIsConstant(v10, v6);
      }
      ...
      v36 = MiState;
      _InterlockedAdd64(&MiState[v66 + 2081], 1uLL);
      v57 = 0LL;
      v54 = 1;
LABEL_103:
      MiConvertIoPfnTreeLockExclusiveToShared(v36, v37, v38);
LABEL_21:
      if ( a6 && !*a6 )
        *a6 = v8;
      v21 = *(_QWORD *)(v8 + 24);
      ...
      if ( (unsigned __int64)v22 < v23 )
      {
        ...
        while ( 1 )
        {
          ...
          if ( v56 && v10 >= *(_QWORD *)(v56 + 24) && v10 <= *(_QWORD *)(v56 + 32) )
          {
            ...
            {
              v49 = MiIoSpaceIsConstant(v10 + 1, v26 - 1);
              v25 = v54;
              v56 = v49;
            }
          }
          ...
          {
            if ( v62 )
              MiFlushCachedIoPfnRange(v62, ((char *)v12 - v62 - 48) >> 3, v25, v24);
...
LABEL_47:
      ...
      {
        v55 = 0;
        _InterlockedDecrement64(&MiState[v66 + 2074]);
      }
      ExReleaseSpinLockExclusiveFromDpcLevel((PEX_SPIN_LOCK)(v8 + 64));
      v6 = v63;
      if ( !v63 )
      ...
      if ( (unsigned int)MiIoPfnTreeLockContended(0LL) || (v9 = v57, IsConstant = v56, KeShouldYieldProcessor()) )
      {
        LOBYTE(v15) = v58;
        MiUnlockIoPfnTree(v15, 1LL);
        v41 = KeGetCurrentIrql();
        __writecr8(2uLL);
        if ( KiIrqlFlags && (KiIrqlFlags & 1) != 0 && v41 <= 0xFu )
        {
          v51 = KeGetCurrentPrcb()->SchedulerAssist;
          v51[5] |= ~((unsigned __int8)(1LL << (v41 + 1)) - 1) & 4;
        }
        CurrentIrql = v41;
        IsConstant = v56;
        v58 = v41;
        if ( a1 == 1 && !v56 )
        {
          IsConstant = MiIoSpaceIsConstant(v10, v63);
          v56 = IsConstant;
        }
        MiLockIoPfnTree(5LL);
        v9 = v57;
...
LABEL_53:
  ...
  {
    v31 = -1073741670;
    MiDereferenceIoPages(v8, v11, v67 - v11);
  }
  if ( v9 )
