/*
 * XREFs of sub_14067368C @ 0x14067368C
 * Callers:
...
NTSTATUS __fastcall sub_14067368C(
        ...
        PIMAGE_NT_HEADERS *a5)
{
  ...
  int v21; // eax
  int v22; // ecx
  unsigned __int64 v23; // [rsp+40h] [rbp-138h] BYREF
  unsigned __int64 v24; // [rsp+48h] [rbp-130h]
  ...
  unsigned __int64 *v42; // [rsp+198h] [rbp+20h]
  ...
  if ( result >= 0 )
  {
    ...
    if ( Magic == 267 )
    {
      ...
      v32 = *(_OWORD *)&OutHeaders->OptionalHeader.DataDirectory[0].VirtualAddress;
    ...
    {
      if ( (int)sub_140354360(v5, v16, &v23) < 0 )
        return -1073741701;
      v17 = v23;
      v24 = v23;
      v18 = v41;
    ...
    {
      v18 = v41;
      v19 = (unsigned int *)sub_140675C38(v5, v41, (_DWORD)OutHeaders, v11, v16, v9 != 0);
      if ( !v19 )
        return -1073741701;
      if ( !v19[4] )
        return -1073741687;
