/*
 * XREFs of HvApplyLogFiles @ 0x140924C14
 * Callers:
        ...
        __int64 a9)
{
  ...
  if ( *(_DWORD *)(a4 + 60) )
  {
    while ( 1 )
    {
      ...
      v15 = v11 + v13;
      result = (*v14 & 2) != 0
             ? HvpApplyLegacyLogFile((_DWORD)a1, v15, (_DWORD)v14, BugCheckParameter2, a7, a8, a9)
             : HvpApplyIncrementalLogFile((int)a1, v15, (int)v14, a4, BugCheckParameter2, a9);
      if ( (int)result < 0 )
        break;
