/*
 * XREFs of sub_1406202D0 @ 0x1406202D0
 * Callers:
 *     <none>
 * Callees:
...
NTSTATUS __fastcall sub_1406202D0(
        HANDLE KeyHandle,
        ULONG Index,
...
LABEL_13:
  ...
  *(_QWORD *)&v24 = __PAIR64__(Index, KeyValueInformationClass);
  *((_QWORD *)&v23 + 1) = KeyValueInformation;
