/*
 * XREFs of AdtpWriteToEtw @ 0x140844C0C
 * Callers:
 ...
 *     AdtpNormalizeAuditInfoHelper @ 0x1403D48DC (AdtpNormalizeAuditInfoHelper.c)
 ...
 *     AdtpGetCategoryAndSubCategoryId @ 0x140844FB8 (AdtpGetCategoryAndSubCategoryId.c)
 */
...
LABEL_55:
  ...
  v6 = *(_WORD *)(a1 + 18);
  v7 = 2;
  v5 = AdtpPackageParameters(a1, 0LL, 2, (__int64)v30, (__int64)v26, (__int64)&v27, v22, (__int64)v29);
  if ( v5 < 0 )
    goto LABEL_55;
  if ( *(_WORD *)(a1 + 16)
    && (v8 = *(unsigned __int16 *)(a1 + 16), v23 = 0, v24 = 0, (int)AdtpGetCategoryAndSubCategoryId(v8, &v23, &v24) >= 0) )
  {
...
LABEL_51:
  ...
  if ( v10 > 0x1501 )
  {
    ...
    if ( v10 == 5712 )
    {
      v7 = (unsigned int)Feature_Servicing_Opnum_Filter__private_IsEnabled() != 0;
    }
    else
    {
      if ( v10 <= 0x187F )
...
LABEL_53:
  ...
  *a2 = 1;
  v5 = -2147483643;
LABEL_56:
  AdtpCleanupParameterAllocations(v29, &v27, v18);
