/*
 * XREFs of DifIoWMIRegistrationControlWrapper @ 0x140611730
 * Callers:
 *     <none>
 * Callees:
...
NTSTATUS __fastcall DifIoWMIRegistrationControlWrapper(PDEVICE_OBJECT DeviceObject, ULONG Action)
{
  __int64 v4; // rdx
  __int64 v5; // rcx
  ...
  v15 = 0LL;
  v16 = 0LL;
  APIThunkContextById = DifGetAPIThunkContextById(222);
...
LABEL_18:
  result = IoWMIRegistrationControl(DeviceObject, Action);
  DWORD2(v16) = result;
  if ( APIThunkContextById )
  {
