/*
 * XREFs of DifZwQueryInformationTokenWrapper @ 0x140624EA0
 * Callers:
 *     <none>
 * Callees:
...
LABEL_13:
  ...
  *((_QWORD *)&v22 + 1) = TokenHandle;
  LODWORD(v22) = TokenInformationClass;
  *((_QWORD *)&v21 + 1) = TokenInformation;
  LODWORD(v21) = TokenInformationLength;
