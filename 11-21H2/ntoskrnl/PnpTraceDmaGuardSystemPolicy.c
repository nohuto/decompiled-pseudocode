/*
 * XREFs of PnpTraceDmaGuardSystemPolicy @ 0x140826E28
 * Callers:
...
void PnpTraceDmaGuardSystemPolicy()
{
  ...
  if ( (unsigned int)dword_140C06550 > 5 )
  {
    if ( tlgKeywordOn((__int64)&dword_140C06550, 0x400000000000LL) )
    {
      ...
      v1 = 2048LL;
      v4 = 8;
      tlgWriteTransfer_EtwWriteTransfer((__int64)&dword_140C06550, (unsigned __int8 *)byte_14002BF25, 0LL, 0LL, 4u, &v2);
    }
  }
}
