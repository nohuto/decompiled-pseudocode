/*
 * XREFs of sub_14080F6C8 @ 0x14080F6C8
 * Callers:
...
__int64 __fastcall sub_14080F6C8(__int64 a1)
{
  int v1; // edi
  ...
  if ( (v1 & 0xC) != 0 )
    return 0LL;
  v3 = *(_QWORD *)(a1 + 48);
  if ( (unsigned int)sub_14027B080(v3) == 1 )
    return 3221225793LL;
  v4 = v1;
  if ( *(_QWORD *)(a1 + 112) && (v1 & 2) == 0 && !(unsigned int)sub_1402FDD20(v3) )
  {
    sub_14080F7F4(a1);
    v4 = *(_DWORD *)(a1 + 196);
  }
