/*
 * XREFs of sub_140819F40 @ 0x140819F40
 * Callers:
...
char __fastcall sub_140819F40(int a1, int a2, int a3, int a4, char a5)
{
  _UNKNOWN **v5; // rax
  REGHANDLE v6; // rbx
  ...
  {
    v6 = RegHandle;
    LOBYTE(v5) = EtwEventEnabled(RegHandle, &stru_140010440);
    if ( (_BYTE)v5 )
    {
      UserData.Reserved = 0;
      v11 = 0;
      ...
      v16 = 4;
      v19 = 4;
      LOBYTE(v5) = EtwWrite(v6, &stru_140010440, 0LL, 5u, &UserData);
    }
  }
  return (char)v5;
}
