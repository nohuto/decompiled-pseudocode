/*
 * XREFs of sub_140614FF0 @ 0x140614FF0
 * Callers:
 *     <none>
 * Callees:
...
PKDEVICE_QUEUE_ENTRY __fastcall sub_140614FF0(PKDEVICE_QUEUE DeviceQueue)
{
  __int64 v2; // rdx
  __int64 v3; // rcx
  __int64 *v4; // rdi
  ...
  PKDEVICE_QUEUE_ENTRY v15; // [rsp+30h] [rbp-18h]
  __int64 retaddr; // [rsp+48h] [rbp+0h]

  v14 = 0LL;
  v15 = 0LL;
  v4 = sub_140604844(290);
  if ( !v4 )
    goto LABEL_18;
  if ( dword_140C1B2A0
