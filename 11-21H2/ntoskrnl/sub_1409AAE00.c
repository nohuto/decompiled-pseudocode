/*
 * XREFs of sub_1409AAE00 @ 0x1409AAE00
 * Callers:
...
char __fastcall sub_1409AAE00(int a1, int *a2, int *a3)
{
  _UNKNOWN **v3; // rax
  ...
  if ( (unsigned int)dword_140D3B908 > 5 )
  {
    ...
    if ( (_BYTE)v3 )
    {
      ...
      v54 = 8LL;
      v56 = 8LL;
      LOBYTE(v3) = sub_14020A9C4((__int64)&dword_140D3B908, (unsigned __int8 *)byte_14003355D, 0LL, 0LL, 0x12u, &v24);
    }
  }
  return (char)v3;
}
