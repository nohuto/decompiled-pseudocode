/*
 * XREFs of HvHiveStartMemoryBacked @ 0x14068F7C4
 * Callers:
  ...
  *(_BYTE *)(BugCheckParameter2 + 194) = 1;
  switch ( (_DWORD)a2 )
  {
    case 0:
      ...
      v18 = (_DWORD *)(*(__int64 (__fastcall **)(_QWORD, __int64, __int64))(BugCheckParameter2 + 24))(
...
LABEL_19:
          ...
          *v18 = 1718052210;
          ...
          v18[8] = 1;
          v18[11] = 1;
          HvpFillFileName((__int64)v18, a8);
          v18[36] = 0;
          v19 = a3 & 0x80000;
          if ( v19 )
            v18[36] = 2;
        ...
        (*(void (__fastcall **)(_DWORD *, _QWORD))(BugCheckParameter2 + 32))(
          ...
          *(unsigned int *)(BugCheckParameter2 + 132));
        LOBYTE(v35) = 1;
        v18 = (_DWORD *)(*(__int64 (__fastcall **)(__int64, __int64, __int64))(BugCheckParameter2 + 24))(
                          4096LL,
                          v35,
                          842091843LL);
        if ( v18 )
    ...
    case 3:
      if ( (unsigned __int8)HvIsInPlaceBaseBlockValid(a5, a2, 2LL, a4) )
      {
        ...
        *(_DWORD *)(BugCheckParameter2 + 176) = v40;
        v30 = HvpAdjustHiveFreeDisplay(BugCheckParameter2, a5[10], 0);
        if ( v30 >= 0 )
        {
          v30 = HvpBuildMapForMemoryBackedHive(BugCheckParameter2);
          if ( v30 >= 0 )
          {
            if ( a13 )
              *a13 = 0;
          ...
          SetFailureLocation(a14, 0, 25, v30, 0xA0u);
        }
        else
        {
          SetFailureLocation(a14, 0, 25, v30, 0x90u);
        }
...
LABEL_66:
  ...
  v24 = 858869059;
  LOBYTE(v22) = v23;
  v25 = (*(__int64 (__fastcall **)(_QWORD, __int64, __int64))(BugCheckParameter2 + 24))(
          *(unsigned int *)(BugCheckParameter2 + 132),
          v22,
          858869059LL);
...
LABEL_54:
    v30 = -1073741670;
LABEL_56:
    SetFailureLocation(a14, 0, 25, v30, v43);
    return (unsigned int)v30;
  }
LABEL_39:
  if ( a13 )
  ...
  *(_DWORD *)(BugCheckParameter2 + 220) = *(_DWORD *)(*(_QWORD *)(BugCheckParameter2 + 64) + 24LL)
  ...
  v30 = -1073741492;
  SetFailureLocation(a14, 0, 25, 0xC000014C, 0xF0u);
  (*(void (__fastcall **)(_QWORD, _QWORD))(BugCheckParameter2 + 32))(
    *(_QWORD *)(BugCheckParameter2 + 64),
    *(unsigned int *)(BugCheckParameter2 + 132));
  *(_QWORD *)(BugCheckParameter2 + 64) = 0LL;
