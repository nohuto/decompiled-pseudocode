/*
 * XREFs of sub_140B55478 @ 0x140B55478
 * Callers:
...
__int64 sub_140B55478()
{
  ...
  v0 = 0LL;
  v11 = 0LL;
  DeviceObjectPointer = IoGetDeviceObjectPointer((PUNICODE_STRING)&ObjectName, 0x10000000u, &FileObject, &DeviceObject);
  v2 = FileObject;
  ...
  if ( DeviceObjectPointer >= 0 )
  {
    ...
    *(_OWORD *)(Pool2 + 188) = *(_OWORD *)L"70}-0000";
    ...
    v6 = sub_1403428E0(1311152, (__int64)v5, Pool2, 0xD0u, 0LL, 0, 0, &Object, &v11);
    v7 = v6;
    if ( v6 )
    {
