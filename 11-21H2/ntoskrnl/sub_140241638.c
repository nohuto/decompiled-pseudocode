/*
 * XREFs of sub_140241638 @ 0x140241638
 * Callers:
...
__int64 __fastcall sub_140241638(ULONG_PTR BugCheckParameter2, __int64 a2, unsigned int a3)
{
  __int64 **v3; // r10
  __int64 *v7; // rdx
  __int64 result; // rax
  ...
  do
  {
    ...
    v9 = *v7;
    if ( !*v7 )
      KeBugCheckEx(0x96u, (ULONG_PTR)v7, BugCheckParameter2, qword_140C11650, v7[2]);
