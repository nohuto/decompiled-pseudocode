/*
 * XREFs of EtwQueryProcessTelemetryInfo @ 0x140711F48
 * Callers:
        ...
        ULONG *a5)
{
  ...
  unsigned __int64 v30; // [rsp+50h] [rbp-278h]
  ...
  *(_OWORD *)P = 0LL;
  ...
  v30 = v10;
  v26 = 0;
  EtwpQueryTokenPackageInfo(v10, (__int64)v32, &v26);
  ...
  if ( v11 >= 0 )
  {
    ...
    {
      KiStackAttachProcess((_KPROCESS *)BugCheckParameter1, 0LL, (__int64)v33, v12);
    ...
    v13 = Size + 100 + LODWORD(v32[0]) + LODWORD(v32[1]) + *(unsigned __int16 *)v28 + LOWORD(P[0]);
    if ( a5 )
      *a5 = v13;
    if ( a4 )
    ...
    else
    {
      ...
      *((_QWORD *)Address + 6) = MmGetSessionCreateTime(v15);
