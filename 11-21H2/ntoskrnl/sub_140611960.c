/*
 * XREFs of sub_140611960 @ 0x140611960
 * Callers:
 *     <none>
 * Callees:
...
NTSTATUS __fastcall sub_140611960(
...
LABEL_12:
  *(_QWORD *)&v21 = v15;
LABEL_13:
  *((_QWORD *)&v21 + 1) = PartitionBuffer;
  *(_QWORD *)&v23 = DeviceObject;
  *(_QWORD *)((char *)&v22 + 4) = __PAIR64__(SectorSize, SectorsPerTrack);
  LODWORD(v22) = NumberOfHeads;
