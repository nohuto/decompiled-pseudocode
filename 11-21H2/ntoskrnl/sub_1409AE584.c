/*
 * XREFs of sub_1409AE584 @ 0x1409AE584
 * Callers:
...
__int64 __fastcall sub_1409AE584(
        ...
        char a6)
{
  ...
  if ( sub_1406C5900(a6) )
    return 3221225506LL;
  result = sub_140732D40(BugCheckParameter1, 1024, (__int64)PsProcessType, a6, 0x79517350u, &Object, 0LL, 0LL);
  if ( (int)result >= 0 )
  {
    v9 = Object;
