/*
 * XREFs of sub_1403A89B4 @ 0x1403A89B4
 * Callers:
...
__int64 __fastcall sub_1403A89B4(__int64 a1, __int64 a2, _QWORD *a3, char a4)
{
  _QWORD *v4; // r15
  unsigned int v5; // esi
  __int64 v6; // rdi
  ...
  else
  {
    ...
    v31[0] = *(_DWORD *)(a1 + 4);
    v32[0] = 0LL;
    result = sub_140AAD404(v31, a2, v32);
    if ( (int)result < 0 )
      return result;
    v10 = v32[0];
  }
      ...
      if ( *(_DWORD *)v10 )
      {
        do
        {
          ...
          if ( *(_DWORD *)(v10 + 4) )
          {
            ...
            {
              v31[0] = -1;
              v20 = (char *)qword_1400473D0 - (char *)&v30;
              v29 = 0;
              v30 = *(_DWORD *)v13;
              do
              {
