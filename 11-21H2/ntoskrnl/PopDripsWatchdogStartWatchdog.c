/*
 * XREFs of PopDripsWatchdogStartWatchdog @ 0x140996854
 * Callers:
  ...
  if ( (dword_140C20808 & 2) != 0 )
  {
    ...
    if ( !v1 )
    {
      ...
      if ( (dword_140C208C4 & 1) != 0 )
      {
        ...
        PopDripsWatchdogScheduleNextTimer((__int64)&unk_140C20810);
      }
      if ( (dword_140C209CC & 1) != 0 )
      {
        ...
        PopDripsWatchdogScheduleNextTimer((__int64)&unk_140C20918);
      }
      dword_140C20808 |= 4u;
      qword_140C20A28 = v4;
    }
