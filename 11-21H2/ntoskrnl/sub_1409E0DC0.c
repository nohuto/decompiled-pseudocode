/*
 * XREFs of sub_1409E0DC0 @ 0x1409E0DC0
 * Callers:
...
__int64 __fastcall sub_1409E0DC0(__int64 a1, int a2, __int64 a3, unsigned int a4, wchar_t *SourceString)
{
    ...
    while ( 1 )
    {
      ...
      if ( KeyInformation[3] < 0xFFu )
      {
        ...
        *(_OWORD *)&ObjectAttributes.SecurityDescriptor = 0LL;
        ...
        {
          sub_1409E10D8(KeyHandle, ResultLength, &v19);
          ZwClose(KeyHandle);
