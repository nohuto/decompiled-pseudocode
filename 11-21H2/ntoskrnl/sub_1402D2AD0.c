/*
 * XREFs of sub_1402D2AD0 @ 0x1402D2AD0
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall sub_1402D2AD0(__int64 a1, __int64 a2, __int64 a3)
{
  __int64 v3; // rdi
  __int64 v6; // rcx
  ...
  sub_1402D2B6C(a3, *(_QWORD *)(v3 + 48));
  if ( *(_BYTE *)v3 == 27 )
  {
    ExAcquireFastMutex((PFAST_MUTEX)(a3 + 232));
    --*(_DWORD *)(a3 + 120);
    if ( *(_DWORD *)(a3 + 116) || !(unsigned __int8)sub_1402D2BD8((PFSRTL_ADVANCED_FCB_HEADER)a3) )
