/*
 * XREFs of sub_140AF3E9C @ 0x140AF3E9C
 * Callers:
...
__int64 __fastcall sub_140AF3E9C(__int64 a1, __int64 a2, char a3, __int64 a4, int a5, int a6)
{
  __int64 v9; // rdi
  __int64 v10; // rax
  char v11; // dl
  ...
  sub_14033C3E0(48 * a1 - 0x220000000000LL, a4);
  v10 = *(_QWORD *)(v9 + 24);
  *(_QWORD *)(v9 + 8) = a2;
  v11 = 1;
  ...
  *(_BYTE *)(v9 + 34) = (v11 << 6) | v13 & 0x3F;
  v14 = sub_1402CCC50(128LL);
  if ( v15 == v16 )
  {
    v14 |= 0x300uLL;
  }
