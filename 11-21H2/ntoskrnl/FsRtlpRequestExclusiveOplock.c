/*
 * XREFs of FsRtlpRequestExclusiveOplock @ 0x1403857EC
 * Callers:
      ...
      if ( MmDoesFileHaveUserWritableReferences(v22) )
      {
        ...
        *(_DWORD *)(v23 + 12) |= 4u;
        if ( (unsigned int)dword_140C038D8 > 5 && tlgKeywordOn((__int64)&dword_140C038D8, 0x400000000000LL) )
        {
          ...
          v51 = &v41;
          v52 = v25;
          LODWORD(v42) = *(_DWORD *)(Oplock + 144);
          v53 = &v42;
          v54 = v25;
          v45 = 0x1000000LL;
          v55 = &v45;
          v56 = 8LL;
          tlgWriteAgg((__int64)&dword_140C038D8, (unsigned __int8 *)&word_14002A9F2, v24, 6u, &v48);
        }
        goto LABEL_14;
      }
    }
...
LABEL_102:
    ...
    if ( v29 == 4096 )
    {
      ...
      {
        v45 = j[2];
        if ( !FsRtlpOplockKeysEqual(*(_QWORD *)(a2 + 48), *(_QWORD *)(v45 + 48), 0) )
        {
LABEL_90:
          v11 = -1073741598;
          goto LABEL_102;
