/*
 * XREFs of NtLoadEnclaveData @ 0x14097B500
 * Callers:
 *     <none>
 * Callees:
...
LABEL_31:
    v20 = Object;
    KiStackAttachProcess((_KPROCESS *)Object, 0LL, (__int64)v47, v11);
    v30 = 1;
    v21 = MiObtainReferencedVadEx(*(unsigned __int64 *)v35, 0, &v29);
    v13 = (char *)v21;
    ...
    if ( (*(_DWORD *)(v21 + 64) & 1) == 0 )
    {
      ...
      else
      {
        ...
        v17 = MiLoadSectionIntoVsmEnclave(
                (__int64)v20,
                (ULONG_PTR)v13,
                v28,
                (__int64)v22,
