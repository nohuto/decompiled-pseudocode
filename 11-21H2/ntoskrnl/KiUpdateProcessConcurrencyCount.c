/*
 * XREFs of KiUpdateProcessConcurrencyCount @ 0x140302650
 * Callers:
  ...
  if ( (result & 1) == 0 )
  {
    ...
    *(_DWORD *)(BugCheckParameter1 + 2560) = v8;
    if ( *(_DWORD *)(BugCheckParameter1 + 2564) > v8 || *(_DWORD *)(BugCheckParameter1 + 2568) < v8 )
    {
      ...
      KiSelectIdealProcessorSetsForProcess(BugCheckParameter1, &v25, (__int64)v29, &v27);
      v16 = ExGenRandom(1LL, v15);
      ...
      *(_QWORD *)(BugCheckParameter1 + 2564) = v27;
      ...
      if ( v18 )
      {
        ...
        if ( (KiCacheAwareScheduling & 0x10) != 0 )
        {
          ...
          MmAdjustWorkingSetSizeEx(-1, -1, 0, 0, 0, (__int64)v24);
          return KiUnstackDetachProcess((__int64)v28, 0LL);
        }
      }
    }
    else
