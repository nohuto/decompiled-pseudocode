/*
 * XREFs of BcpDisplayCriticalString @ 0x14064DC1C
 * Callers:
 ...
 *     BgpFoGetStringAdvanceWidth @ 0x14064D8A0 (BgpFoGetStringAdvanceWidth.c)
 *     BcpPrintSpaces @ 0x14064E5D0 (BcpPrintSpaces.c)
...
__int64 __fastcall BcpDisplayCriticalString(unsigned __int16 *a1, int a2, __int64 a3, __int64 a4)
{
  ...
  *(_DWORD *)(qword_140C5A830 + 8) = a2;
  v31 = (int *)(v11 + 40);
  StringAdvanceWidth = BgpFoGetStringAdvanceWidth((int)v11 + 40, (__int64)a1, &v35, a4);
      ...
      if ( v29 && v17 <= (unsigned int)v19 )
      {
        ...
        if ( *(_WORD *)(v20 + 2 * v19) != 32 )
        {
          while ( 1 )
          {
            ...
            StringAdvanceWidth = BgpRasGetGlyphAdvanceWidth(v13, v22, (unsigned int)&v33, v13, (__int64)&BcpWorkspace);
            if ( StringAdvanceWidth < 0 )
              goto LABEL_40;
            ...
            if ( v7 < v30 + v8 && v16 )
            {
              if ( v8 < v7 )
              {
                StringAdvanceWidth = BcpPrintSpaces(qword_140C5A830, v8, v7, v9, v28, (__int64)&v34);
                if ( StringAdvanceWidth < 0 )
                  goto LABEL_40;
                if ( v16 < v34 )
                  v16 = v34;
