/*
 * XREFs of sub_1409E9E48 @ 0x1409E9E48
 * Callers:
...
__int64 __fastcall sub_1409E9E48(
        __int64 a1,
        __int64 a2,
        unsigned int a3,
        char a4,
...
LABEL_10:
        ...
        sub_1409EA2D4(a1, a3, (unsigned int)v19, v18, v17, v16);
        return v11;
      }
      return 3221225485LL;
    }
    if ( v12 == -2147483646 )
    {
      if ( *((_DWORD *)a5 + 2) != 8 )
        return 3221225485LL;
      LOBYTE(v10) = a4;
      return (unsigned int)sub_1409E9F80(a1, **a5, a3, v10);
    }
    else
    {
