/*
 * XREFs of sub_1409EDA14 @ 0x1409EDA14
 * Callers:
...
BOOLEAN __fastcall sub_1409EDA14(unsigned __int16 *a1, int a2, int a3, int a4, char a5, int a6)
{
  REGHANDLE v6; // rdi
  ...
  v30 = a2;
  v6 = qword_140C15FA8;
  v7 = (const EVENT_DESCRIPTOR *)qword_140038CA8;
  if ( a6 < 0 )
    v7 = &stru_140039C30;
  result = EtwEventEnabled(qword_140C15FA8, v7);
  if ( result )
  {
    v10 = *((_QWORD *)a1 + 1);
    UserData.Reserved = 0;
