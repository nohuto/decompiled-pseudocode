/*
 * XREFs of sub_1405DA184 @ 0x1405DA184
 * Callers:
...
char __fastcall sub_1405DA184(__int16 a1, __int64 a2, char a3, char a4)
{
  _UNKNOWN **v4; // rax
  REGHANDLE v5; // rbx
  ...
  {
    v5 = qword_140C1F580;
    LOBYTE(v4) = EtwEventEnabled(qword_140C1F580, &stru_140037DF8);
    if ( (_BYTE)v4 )
    {
      UserData.Reserved = 0;
      v10 = 0;
      ...
      UserData.Size = 2;
      v9 = 8;
      LOBYTE(v4) = EtwWriteEx(v5, &stru_140037DF8, 0LL, 0, 0LL, 0LL, 4u, &UserData);
    }
  }
  return (char)v4;
}
