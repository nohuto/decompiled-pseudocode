/*
 * XREFs of sub_14085D4CC @ 0x14085D4CC
 * Callers:
 *     sub_14085D4A0 @ 0x14085D4A0 (sub_14085D4A0.c)
 * Callees:
...
__int64 __fastcall sub_14085D4CC(PCWSTR SourceString)
{
  __int32 v1; // ebx
  NTSTATUS v2; // esi
  ...
  v2 = sub_1406DE960(&KeyHandle, 0LL, &DestinationString, 0x20019u, 0);
  if ( v2 >= 0 )
  {
    ...
    while ( 1 )
    {
      ...
      if ( ++v3 >= 4u )
      {
        _InterlockedExchange(&dword_140D00A8C, v1);
        break;
      }
    }
  }
