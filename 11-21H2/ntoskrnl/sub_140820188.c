/*
 * XREFs of sub_140820188 @ 0x140820188
 * Callers:
...
__int64 __fastcall sub_140820188(__int64 a1, unsigned int a2, __int64 a3, char a4, __int64 *a5, unsigned int *a6)
{
  unsigned int v6; // ebx
  ...
  if ( v13 )
  {
    ...
    if ( v10 )
    {
      Pool2 = ExAllocatePool2(256LL, 20LL * v10, 538996816LL);
      if ( !Pool2 )
        return 3221225626LL;
      *a6 = v10;
      *a5 = Pool2;
