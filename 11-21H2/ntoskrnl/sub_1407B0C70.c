/*
 * XREFs of sub_1407B0C70 @ 0x1407B0C70
 * Callers:
...
__int64 __fastcall sub_1407B0C70(__int64 a1, __int64 a2, int a3, int a4, SECURITY_IMPERSONATION_LEVEL a5)
{
  int v8; // r15d
  void *v9; // r14
    ...
    if ( v13 )
    {
      if ( (v13[64] & 0x10000) != 0 )
      {
        ...
        if ( v14 )
        {
          ...
          if ( a3 )
            ClientSecurity = SeCreateClientSecurityEx((__int64)v14, (__int64)v15, 0, (__int64)&ClientContext);
          else
...
LABEL_22:
      if ( v8 )
        SeDeleteClientSecurity((__int64)p_ClientContext);
      return v17;
    }
    return (unsigned int)-1073741790;
  }
