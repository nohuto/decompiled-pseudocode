/*
 * XREFs of sub_14060D540 @ 0x14060D540
 * Callers:
 *     <none>
 * Callees:
...
NTSTATUS __fastcall sub_14060D540(
...
LABEL_13:
  BYTE8(v21) = Update;
  *(_QWORD *)&v23 = __PAIR64__(DesiredAccess, DesiredShareAccess);
  *((_QWORD *)&v22 + 1) = FileObject;
  *(_QWORD *)&v22 = ShareAccess;
...
LABEL_18:
  result = IoCheckShareAccess(DesiredAccess, DesiredShareAccess, FileObject, ShareAccess, Update);
  DWORD2(v23) = result;
  if ( v11 )
  {
    v19 = (_QWORD **)(v11 + 6);
