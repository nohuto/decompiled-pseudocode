/*
 * XREFs of sub_140A33600 @ 0x140A33600
 * Callers:
...
char __fastcall sub_140A33600(__int64 a1, LARGE_INTEGER *a2)
{
  unsigned int v2; // edi
  char *v3; // rbx
  CSHORT v4; // r12
  ...
  if ( (((_BYTE)v11 - 44) & 0xFD) == 0 )
  {
    v18 = v9 + 1;
    v19 = v10 - 1;
    v20 = sub_140A33580(v18, v19, &v35, &v36);
    v10 = v19 - v20;
    v9 = &v18[v20];
    v4 = sub_140A33524(60, v35, v36);
    v23 = sub_140A33524(3600, v21, v22);
    v6 = sub_140A33524(3600000, v24, v25) - 1000 * v23;
    v5 = -60 * v4 + v23;
LABEL_15:
    if ( !v10 )
      return 0;
  ...
  if ( ((*v9 - 44) & 0xFD) == 0 )
  {
    v15 = v9 + 1;
    v16 = v10 - 1;
    v17 = sub_140A33580(v15, v16, &v35, &v36);
    v10 = v16 - v17;
    v9 = &v15[v17];
    v5 = sub_140A33524(60, v35, v36);
    v6 = sub_140A33524(60000, v35, v36) - 1000 * v5;
    goto LABEL_15;
  }
  if ( isdigit(*v9) )
  {
    ...
    if ( ((*v9 - 44) & 0xFD) == 0 )
    {
      v12 = v9 + 1;
      v13 = v10 - 1;
      v14 = sub_140A33580(v12, v13, &v35, &v36);
      v10 = v13 - v14;
      v9 = &v12[v14];
      v6 = sub_140A33524(1000, v35, v36);
      goto LABEL_15;
    }
  }
LABEL_16:
  ...
  {
    v27 = v10 - 1 - sub_140A33580(v9 + 1, v10 - 1, &v35, &v36);
    v29 = (int)sub_140A33524(1, v35, v36 - 4) % 100;
    v7 = 60 * sub_140A33524(1, v35, v28 - 2) + v29;
  }
  else
  {
    if ( v26 != 45 )
      return 0;
    v27 = v10 - 1 - sub_140A33580(v9 + 1, v10 - 1, &v35, &v36);
    sub_140A33524(1, v35, v36 - 4);
    v31 = sub_140A33524(1, v35, v30 - 2);
    v7 = -60 * v31 - v32;
  }
  if ( !v27 )
  {
    ...
    {
      if ( sub_140A33434((__int64 *)v33, v7, v8) )
        return 1;
    }
  }
  return 0;
