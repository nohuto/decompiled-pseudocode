/*
 * XREFs of sub_140636208 @ 0x140636208
 * Callers:
...
__int64 __fastcall sub_140636208(__int64 a1, unsigned int a2)
{
  unsigned int v2; // ebx
  int v5; // ecx
  __int64 v6; // rcx
  ...
  v14[0] = 0LL;
  v15 = 0;
  if ( !(unsigned __int8)sub_140294D90((__int64)&v15, (__int64)v14, (__int64)&v16) )
