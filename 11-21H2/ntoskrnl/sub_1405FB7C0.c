/*
 * XREFs of sub_1405FB7C0 @ 0x1405FB7C0
 * Callers:
...
LONG_PTR __fastcall sub_1405FB7C0(__int64 *a1, __int64 a2)
{
  __int64 v3; // rcx
  void *v4; // rbp
  __int64 v5; // rdx
  ...
  if ( !v3 )
  {
    sub_1409D71F0(*(_QWORD *)(a2 + 8), &v23, &v22);
    v3 = v22;
    v4 = v23;
  }
  ...
  if ( v7 < 0x100 )
    v8 = v7;
  if ( (int)sub_1409D75C0(v3, v9, v8) < 0 )
LABEL_7:
    *v6 = 0;
  v10 = -1LL;
  v11 = -1LL;
  ...
  if ( (int)sub_1405FACB4(v6, v12, v7 - 2 * v11 - 2) < 0 )
  {
    LODWORD(v10) = 0;
  }
  else
