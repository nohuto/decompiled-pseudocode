/*
 * XREFs of sub_1409A6E24 @ 0x1409A6E24
 * Callers:
...
__int64 __fastcall sub_1409A6E24(__int64 a1)
{
  int v2; // eax
  unsigned int v3; // ebx
  ...
  v3 = v2;
  if ( v2 >= 0 )
    v3 = sub_1409A200C(v6, (__int64)Object, *(_DWORD *)(a1 + 16), *(_DWORD *)(a1 + 20));
  else
    sub_1409A8628("TtmpDispatchSetInputWakeCapability", 938LL, (unsigned int)v2, (unsigned int)v2);
  if ( v6 )
  {
