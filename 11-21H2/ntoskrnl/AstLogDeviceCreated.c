/*
 * XREFs of AstLogDeviceCreated @ 0x1407112A4
 * Callers:
...
void __fastcall AstLogDeviceCreated(char *a1, int a2, int a3)
{
  ...
  if ( !dword_140C03958 )
    return;
  v6 = ObQueryNameStringMode(a1, 0LL, 0, &v10, 0);
  ...
  if ( Pool3 )
  {
    if ( (int)ObQueryNameStringMode(a1, Pool3, v10, &v10, 0) >= 0 )
    {
...
LABEL_8:
  if ( (unsigned int)dword_140C03958 > 5 && tlgKeywordOn((__int64)&dword_140C03958, 0x200000000000LL) )
  {
    v19 = 2LL;
    v17 = 8LL;
    v14[0] = 0x80000000LL;
    ...
    *(_QWORD *)&DestinationString.Length = a1;
    tlgWriteTransfer_EtwWriteTransfer((__int64)&dword_140C03958, (unsigned __int8 *)byte_14002BA90, 0LL, 0LL, 8u, &v15);
  }
  if ( v8 )
