/*
 * XREFs of sub_1405DC0A0 @ 0x1405DC0A0
 * Callers:
...
__int64 __fastcall sub_1405DC0A0(__int64 a1, int a2)
{
  int v2; // ebx
  ...
  v5 = 0;
  v11 = 0LL;
  ((void (__fastcall *)(__int64, int *, __int64, int *))sub_1407F2AD0)(5LL, &v4, 1LL, &v13);
