/*
 * XREFs of sub_1403B9F08 @ 0x1403B9F08
 * Callers:
...
bool __fastcall sub_1403B9F08(__int64 a1, __int64 a2, __int64 a3)
{
  bool v5; // zf
  __int64 v6; // rax
  ...
  if ( qword_140C1C948 )
  {
    v6 = sub_1405DE484(qword_140C1C948, a1 + 216);
    if ( v6 )
    {
      *(_QWORD *)(v6 + 24) = a1;
      *(_QWORD *)(a1 + 1184) = v6;
  ...
  if ( (unsigned int)dword_140C03A00 > 5 )
  {
    ...
    v25 = 4;
    v9 = 1;
    sub_14024A9B0((__int64)&dword_140C03A00, (unsigned __int8 *)&word_140032596, a3, 1u, v7, v8, 7u, &v12);
  }
