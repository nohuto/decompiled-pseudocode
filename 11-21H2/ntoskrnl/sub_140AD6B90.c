/*
 * XREFs of sub_140AD6B90 @ 0x140AD6B90
 * Callers:
...
_BOOL8 __fastcall sub_140AD6B90(__int64 a1)
{
  ...
  if ( !*(_QWORD *)&qword_140D06848 && !a1 && !dword_140D06840 )
  {
    if ( dword_140D68198 )
    {
      ...
      *(_OWORD *)&ObjectAttributes.SecurityDescriptor = 0LL;
      ...
      {
        ExNotifyCallback(CallbackObject, sub_1403ED150, &qword_140D68630);
        ObfDereferenceObject(CallbackObject);
        if ( qword_140D68630 )
          dword_140D06840 = 1;
        ExInitializeNPagedLookasideList(
          (PNPAGED_LOOKASIDE_LIST)&stru_140C0DC00,
          0LL,
          0LL,
          0x200u,
          0xAB8uLL,
...
LABEL_21:
      ...
      if ( a1 )
        goto LABEL_38;
      if ( (int)sub_140B1D468() < 0 && !dword_140D06840 )
      {
LABEL_31:
        if ( qword_140D68650 )
