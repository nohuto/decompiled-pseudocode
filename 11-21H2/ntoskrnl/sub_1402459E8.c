/*
 * XREFs of sub_1402459E8 @ 0x1402459E8
 * Callers:
...
__int64 __fastcall sub_1402459E8(__int64 a1, _QWORD *a2, unsigned int a3, unsigned int a4)
{
  __int64 v5; // r15
  PMDL Mdl; // rbx
  __int64 v7; // rdi
  ...
  while ( 1 )
  {
    ...
    v32 = 0LL;
    v26 = 6;
    v20 = sub_140340130(v33, (_DWORD)Mdl, (_DWORD)v30, (unsigned int)&Object, 0, 0LL, (__int64)v31);
    if ( v20 >= 0 )
    {
...
LABEL_26:
  ...
  v23 = 8;
  if ( (unsigned int)sub_14028D2D8((unsigned int)v20, v16, 0LL) && (_DWORD)v13 != 1 )
  {
