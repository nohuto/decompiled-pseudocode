/*
 * XREFs of sub_140542E48 @ 0x140542E48
 * Callers:
...
NTSTATUS sub_140542E48(__int64 a1, __int64 a2, const GUID *a3, ...)
{
  ...
  v16 = 4LL;
  v18 = 4LL;
  return sub_1402D1760(qword_140C08E10, (const EVENT_DESCRIPTOR *)qword_14003ACB8, a3, 8u, &v4);
}
