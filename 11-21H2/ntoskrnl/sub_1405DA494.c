/*
 * XREFs of sub_1405DA494 @ 0x1405DA494
 * Callers:
...
char sub_1405DA494(__int16 a1, __int64 a2, char a3, ...)
{
  _UNKNOWN **v3; // rax
  REGHANDLE v4; // rbx
  ...
  {
    v4 = qword_140C1F580;
    LOBYTE(v3) = EtwEventEnabled(qword_140C1F580, &stru_1400383A8);
    if ( (_BYTE)v3 )
    {
      UserData.Reserved = 0;
      v9 = 0;
      ...
      UserData.Size = 2;
      v11 = 1;
      LOBYTE(v3) = EtwWriteEx(v4, &stru_1400383A8, 0LL, 0, 0LL, 0LL, 7u, &UserData);
    }
  }
  return (char)v3;
}
