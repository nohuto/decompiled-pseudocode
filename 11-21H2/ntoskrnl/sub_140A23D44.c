/*
 * XREFs of sub_140A23D44 @ 0x140A23D44
 * Callers:
...
__int64 __fastcall sub_140A23D44(__int64 a1, __int64 a2, __int16 a3, __int64 a4)
{
  int v4; // ebx
  int *v7; // r14
  unsigned int v8; // edi
  ...
  else
  {
    ...
    {
      v9 = *v7;
      v10 = sub_140A238FC(a1, a2, *v7 | 0x30u, a4, 1);
      if ( v10 )
      {
        if ( v10 != -1073741772 && v10 != -1073741811 && v10 != -1073741637 )
          break;
      }
      v10 = sub_140A238FC(a1, a2, v9 | 0x31u, a4, 0);
      if ( v10 )
      {
...
LABEL_16:
    ...
    {
      LOBYTE(a4) = 1;
      v13 = sub_140A2B08C(a1, a2, 0, a4, (__int64)Pool2, v12, (__int64)&v21);
      if ( v13 != -1073741789 )
        break;
      v12 = v21;
      v15 = 20LL * v21;
...
LABEL_26:
    ...
    if ( v21 )
    {
      while ( 1 )
      {
        v18 = sub_1406CE8B8(a1, a2, 0LL, 0LL, (__int64)Pool2 + 20 * v17, 0, 0LL, 0);
        if ( v18 )
        {
...
LABEL_36:
    if ( v4 >= 0 )
    {
      v13 = sub_140A238FC(a1, a2, 48, v14, 1);
      if ( v13 && v13 != -1073741772 && v13 != -1073741811 )
        goto LABEL_26;
      v13 = sub_140A238FC(a1, a2, 49, v19, 0);
      if ( v13 )
      {
        if ( v13 != -1073741772 && v13 != -1073741811 && v13 != -1073741535 )
          goto LABEL_26;
      }
      sub_140A27790(a1, a2, 3LL);
    }
LABEL_45:
    if ( Pool2 )
      ExFreePoolWithTag(Pool2, 0);
