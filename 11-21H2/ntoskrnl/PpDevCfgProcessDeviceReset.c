/*
 * XREFs of PpDevCfgProcessDeviceReset @ 0x14094F4CC
 * Callers:
...
__int64 __fastcall PpDevCfgProcessDeviceReset(__int64 a1)
{
  ...
  *(_QWORD *)&UnicodeString.Length = 0LL;
  ...
  if ( inited >= 0 )
  {
    ...
    v26 = 0;
    v24 = 16;
    inited = PiDevCfgQueryObjectProperties(v4, v6, 1, v27[2], (__int64)v23, 1u);
    if ( inited >= 0 )
    {
      if ( v25 >= 0 )
      {
...
LABEL_12:
      ...
      if ( *(_QWORD *)&PiPnpRtlCtx && (v9 = *(_QWORD *)(*(_QWORD *)&PiPnpRtlCtx + 224LL)) != 0 )
        ...
        v10 = 0LL;
      RegRtlDeleteTreeInternal(v5, (__int64)L"Devices", v10, 0);
      if ( *(_QWORD *)&PiPnpRtlCtx && (v11 = *(_QWORD *)(*(_QWORD *)&PiPnpRtlCtx + 224LL)) != 0 )
        v12 = *(_QWORD *)(v11 + 8);
      else
        v12 = 0LL;
      RegRtlDeleteTreeInternal(v5, (__int64)L"Filters", v12, 0);
      if ( v8 )
      {
        v13 = *(_QWORD *)(a1 + 48);
        v18 = 4;
