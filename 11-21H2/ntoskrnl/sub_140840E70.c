/*
 * XREFs of sub_140840E70 @ 0x140840E70
 * Callers:
...
__int64 __fastcall sub_140840E70(__int64 a1, __int64 a2)
{
  unsigned int v2; // ebx
  unsigned int v5; // edx
  unsigned int v6; // ecx
  ...
  if ( a1 && a2 )
  {
    ...
    if ( v5 )
    {
      ...
      sub_140840FC4(*(_QWORD *)(a1 + 8LL * v6 + 56), a2, 0LL, v7);
    }
    else
    {
LABEL_8:
