/*
 * XREFs of SymCryptFdefMontgomeryReduceMulx1024 @ 0x1404158D0
 * Callers:
 *     SymCryptFdefModMulMontgomeryMulx1024 @ 0x14040C540 (SymCryptFdefModMulMontgomeryMulx1024.c)
 *     SymCryptFdefModSquareMontgomeryMulx1024 @ 0x14040CB20 (SymCryptFdefModSquareMontgomeryMulx1024.c)
 * Callees:
 *     <none>
 */

__int64 __fastcall SymCryptFdefMontgomeryReduceMulx1024(_QWORD *a1, __m128i *a2, __m128i *a3)
{
  __m128i *v3; // r8
  __int64 v12; // rdi
  __int64 v13; // rdx
