/*
 * XREFs of sub_140B1131C @ 0x140B1131C
 * Callers:
...
__int64 __fastcall sub_140B1131C(HANDLE KeyHandle)
{
  ...
  *(_DWORD *)&v15.Length = 8650882;
  if ( sub_14082EF44(&Handle, 0LL, &v15, 0x20019u) < 0 )
    return i;
  if ( sub_14067B838(KeyHandle, L"Group", 0, &P) < 0 )
  {
LABEL_8:
    ZwClose(Handle);
    return i;
  ...
  if ( *((_DWORD *)P + 1) == 1 )
  {
    ...
    if ( v4 )
    {
      v5 = *((unsigned int *)P + 2);
      LODWORD(P) = 0;
      sub_14067AB94((_WORD *)((char *)v3 + v5), v4, (int *)&P);
  ...
  v6 = 0;
  v7 = sub_14067B838(KeyHandle, L"Tag", 80, &v18);
  if ( v7 < 0
  ...
  v9 = sub_14067B838(Handle, v15.Buffer, 80, &v14);
  ExFreePoolWithTag(v3, 0);
  ZwClose(Handle);
  if ( v9 >= 0 )
  {
