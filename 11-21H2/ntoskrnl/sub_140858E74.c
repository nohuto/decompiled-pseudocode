/*
 * XREFs of sub_140858E74 @ 0x140858E74
 * Callers:
...
PDEVICE_OBJECT __fastcall sub_140858E74(UNICODE_STRING *a1, PFILE_OBJECT *a2)
{
  ...
  *(_OWORD *)&ObjectAttributes.SecurityDescriptor = 0LL;
  ...
  {
    if ( (int)sub_140732D40((ULONG_PTR)FileHandle, 0, (__int64)IoFileObjectType, 0, 0x64506F50u, &FileObject, 0LL, 0LL) >= 0 )
    {
      v4 = FileObject;
