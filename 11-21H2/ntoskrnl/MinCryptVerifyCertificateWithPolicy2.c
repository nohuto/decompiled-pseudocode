/*
 * XREFs of MinCryptVerifyCertificateWithPolicy2 @ 0x140A32064
 * Callers:
 ...
 *     I_MinCryptGetCommonName @ 0x140A32018 (I_MinCryptGetCommonName.c)
        ...
        __int64 a5)
{
  ...
  __int64 IssuerCertificateByName; // [rsp+D0h] [rbp-68h]
  ...
  v51 = Pool2 + 800;
  Src = (void *)(Pool2 + 1776);
  CertificateEKUs = I_MinCryptGetCertificateEKUs((_DWORD *)(v5 + 224), &v42, Pool2);
  v35 = CertificateEKUs;
  if ( CertificateEKUs >= 0 )
  {
    ...
    if ( !(unsigned __int8)MinAsn1DecodeTime(v5 + 128, &v49, 1LL)
      || !(unsigned __int8)MinAsn1DecodeTime(v5 + 144, &v50, v12) )
    {
      v49 = 0LL;
      v50 = 0LL;
    }
    v40 = I_MinCryptCheckEKU((const void **)&qword_140A38A00, v42, (__int64)v9);
    if ( v40 && g_FlightSignedNotBefore > 0 && v49 < g_FlightSignedNotBefore )
    {
      v34 |= 0x600000u;
    ...
    if ( !g_IgnoreLifetimeSigningEKU && I_MinCryptCheckEKU((const void **)&qword_140A389E0, v42, (__int64)v9) )
    {
      v13 = 0;
      v39 = 0;
...
LABEL_82:
    ...
    while ( 1 )
    {
      ...
      v15 = (char *)Src;
      v63 = (char *)Src + v14 + 8;
      v47 = MinCryptDecodeHashAlgorithmIdentifier(v5 + 48);
      ...
      *(_OWORD *)&v15[v14 + 88] = 0LL;
      if ( a5 )
      {
        if ( (unsigned __int8)I_MinCryptGetCommonName(v5 + 160, (__int64)v17) )
        {
          v16 += (*(unsigned __int16 *)&v15[v14 + 80] + 3) & 0xFFFFFFFC;
          v38 = v16;
        }
        if ( (unsigned __int8)I_MinCryptGetCommonName(v5 + 112, (__int64)&v15[v14 + 88]) )
        {
      ...
      v7 = v16 + 120;
      v38 = v7;
      if ( I_MinCryptIsCertificateHashRevokedV2(v47, &v15[v14 + 8], v44, &v59) )
      {
        v35 = -1073740285;
        v46 = 1;
        v34 |= 0x200000u;
      ...
      v22 = v37;
      CertificateEKUs = MincryptValidateBasicConstraints((_DWORD *)(v5 + 224), v48, v37, &v34);
      v35 = CertificateEKUs;
      if ( CertificateEKUs < 0 )
        goto LABEL_82;
      if ( v22 )
      {
        ...
        for ( j = 0LL; ; j = (unsigned int)(j + 1) )
        {
          ...
          if ( v24 == LODWORD(RootTable[5 * j + 2])
            && RtlCompareMemory(*(const void **)(v5 + 184), (const void *)RootTable[5 * j + 3], v24) == *(_DWORD *)(v5 + 176) )
          {
            v25 = &RootTable[5 * j];
            goto LABEL_50;
          }
...
LABEL_50:
      ...
      else
      {
        ...
        for ( k = 0LL; ; k = (unsigned int)(k + 1) )
        {
          ...
          v31 = *(_DWORD *)(v5 + 112);
          if ( v31 == *(_DWORD *)v30
            && RtlCompareMemory(*(const void **)(v5 + 120), (const void *)RootTable[5 * k + 1], v31) == *(_DWORD *)(v5 + 112) )
          {
            goto LABEL_67;
          }
        }
...
LABEL_67:
        ...
        {
          IssuerCertificateByName = I_MinCryptFindIssuerCertificateByName((unsigned int *)(v5 + 112), v58, v62);
          if ( !IssuerCertificateByName )
          {
            v41 = 1;
            goto LABEL_72;
          }
          v26 = (_OWORD *)(IssuerCertificateByName + 176);
        }
      }
      CertificateEKUs = MinCryptVerifySignedHash2(v47, (int)v63, v44, (unsigned int *)(v5 + 64), (__int64)v26);
      v35 = CertificateEKUs;
      if ( CertificateEKUs < 0 )
      {
LABEL_27:
...
LABEL_52:
        ...
        v5 = IssuerCertificateByName;
        v61 = IssuerCertificateByName;
      }
    }
  }
LABEL_83:
  if ( a5 )
  {
    ...
    *(_QWORD *)(a5 + 40) = v50;
    if ( v46 )
      *(_QWORD *)(a5 + 24) = v55;
    if ( CertificateEKUs >= 0 )
      CertificateEKUs = I_MincryptAddChainInfo(a5, v7, v42, v6, v43, v41, (__int64)v9, v51, Src, v33);
  }
  if ( v9 )
    ExFreePoolWithTag(v9, 0x72634943u);
  if ( CertificateEKUs >= 0 && v46 )
