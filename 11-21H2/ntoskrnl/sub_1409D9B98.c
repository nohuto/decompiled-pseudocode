/*
 * XREFs of sub_1409D9B98 @ 0x1409D9B98
 * Callers:
...
__int64 __fastcall sub_1409D9B98(_QWORD *a1, unsigned int a2, __int64 a3, char a4, char a5, int a6)
{
  char v6; // r14
  __int64 v8; // r9
  char *v9; // rbp
  ...
  while ( a1 < v16 )
  {
    ...
    if ( !v17 )
    {
      ...
      if ( (v6 & 0x40) != 0 && v17 == 512 && !sub_14057F740(i, a6 - 1) )
        sub_14097F59C(v21, a6 - 1);
    }
    v31 = v17 << 12;
    v22 = 8LL * v17;
    memset(v9, 0, v22);
    result = sub_140881C00(&v30, (__int64)v9, v25);
    if ( (int)result >= 0 )
    {
