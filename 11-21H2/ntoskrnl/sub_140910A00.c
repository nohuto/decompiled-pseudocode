/*
 * XREFs of sub_140910A00 @ 0x140910A00
 * Callers:
...
void __fastcall sub_140910A00(__int64 a1, unsigned __int16 *a2)
{
  unsigned int v3; // edx
  __int64 v4; // rcx
  __int64 v5; // rax
  ...
  v8[v5 - 1] = &v6;
  v8[v5] = 2LL;
  sub_14035EDE4((__int64)&v7, v3 + 1, 0x41000000u, 0x926u, 0x501902u);
}
