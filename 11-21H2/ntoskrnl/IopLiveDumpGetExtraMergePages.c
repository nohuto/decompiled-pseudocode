/*
 * XREFs of IopLiveDumpGetExtraMergePages @ 0x14093C6D4
 * Callers:
...
LABEL_34:
  ...
  v11 = 0LL;
  v12 = a1[25] - a1[34];
  v27 = v8 % (unsigned int)BufferChunkSizeInBytes;
  v13 = a1[32] % (unsigned __int64)(unsigned int)BufferChunkSizeInBytes;
  v25 = v10 + v8 / (unsigned int)BufferChunkSizeInBytes;
  v26 = v10 + a1[32] / (unsigned __int64)(unsigned int)BufferChunkSizeInBytes;
  v14 = (unsigned int)BufferChunkSizeInBytes;
  v15 = 0;
  if ( ((unsigned int)BufferChunkSizeInBytes - v27) >> 12 <= v9 )
    v9 = ((unsigned int)BufferChunkSizeInBytes - v27) >> 12;
  if ( ((unsigned int)BufferChunkSizeInBytes - v13) >> 12 <= v12 )
    v12 = ((unsigned int)BufferChunkSizeInBytes - v13) >> 12;
  v16 = 1;
  while ( 1 )
  {
    v17 = 0LL;
