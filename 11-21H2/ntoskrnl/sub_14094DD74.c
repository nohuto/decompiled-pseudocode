/*
 * XREFs of sub_14094DD74 @ 0x14094DD74
 * Callers:
...
__int64 __fastcall sub_14094DD74(__int64 a1, __int64 a2, void *a3)
{
  NTSTATUS v5; // eax
  unsigned int v6; // ebx
  ...
  *(_QWORD *)&ObjectAttributes.Length = 48LL;
  ...
  {
    v6 = sub_140697EF0(a1, a2, KeyHandle, -1, 0, (__int64)sub_14094DD00, 0LL);
  }
  if ( KeyHandle )
    ZwClose(KeyHandle);
  return v6;
