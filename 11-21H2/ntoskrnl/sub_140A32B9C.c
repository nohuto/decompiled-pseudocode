/*
 * XREFs of sub_140A32B9C @ 0x140A32B9C
 * Callers:
...
char __fastcall sub_140A32B9C(unsigned int *a1, __int64 a2, _BYTE *a3, __int64 a4)
{
  __int64 v4; // rdx
  __int64 v6; // rcx
  int v8; // ebx
  ...
  v13 = 0;
  v15 = 4;
  if ( (int)sub_140A33D28(v6, v4, &v13, &v14) > 0 )
  {
    v8 = v13;
    if ( v13 )
    {
      v9 = v14;
      while ( (int)sub_140A33E74(v9, v8, (unsigned int)&v15, (unsigned int)&qword_14000AF30, 4, (__int64)v16) > 0 )
      {
        if ( v18 == 3 )
        {
          v10 = *v19 - 1109;
          if ( *v19 == 1109 )
            v10 = *((unsigned __int8 *)v19 + 2) - BYTE2(dword_140A37DF4);
          if ( !v10 )
          {
            v12 = v21;
            if ( (int)sub_140A33D28(v21, v20, &v13, &v14) <= 0 )
              return 0;
            *a3 = *v12;
            *(_QWORD *)(a4 + 8) = v14;
            *(_DWORD *)a4 = v13;
