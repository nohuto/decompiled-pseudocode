/*
 * XREFs of sub_1409F7390 @ 0x1409F7390
 * Callers:
...
__int64 __fastcall sub_1409F7390(bool *a1, int a2, _DWORD *a3)
{
  unsigned int *v5; // rsi
  ULONG *v6; // rdi
  NTSTATUS v7; // ebx
...
LABEL_14:
    ...
    for ( i = v5; ; i = (unsigned int *)((char *)i + v17) )
    {
      if ( i[7] == 16 )
      {
        v16 = *((_QWORD *)i + 4) - 0x47E440260DF5AFDCLL;
        if ( *((_QWORD *)i + 4) == 0x47E440260DF5AFDCLL )
