/*
 * XREFs of DifZwQueryInformationResourceManagerWrapper @ 0x140624BE0
 * Callers:
 *     <none>
 * Callees:
...
LABEL_13:
  ...
  *((_QWORD *)&v22 + 1) = ResourceManagerHandle;
  LODWORD(v22) = ResourceManagerInformationClass;
  *((_QWORD *)&v21 + 1) = ResourceManagerInformation;
  LODWORD(v21) = ResourceManagerInformationLength;
