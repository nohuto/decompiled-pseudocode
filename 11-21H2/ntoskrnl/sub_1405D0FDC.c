/*
 * XREFs of sub_1405D0FDC @ 0x1405D0FDC
 * Callers:
        ...
        char a11)
{
  ...
  {
    v13 = RegHandle;
    LOBYTE(v11) = EtwEventEnabled(RegHandle, &stru_140038B40);
    if ( (_BYTE)v11 )
    {
      v22 = a6;
      ...
      *(_QWORD *)&UserData.Size = 4LL;
      ...
      v46 = &a11;
      v47 = 4LL;
      LOBYTE(v11) = EtwWriteEx(v13, &stru_140038B40, 0LL, 0, 0LL, 0LL, 0xDu, &UserData);
    }
  }
  return (char)v11;
}
