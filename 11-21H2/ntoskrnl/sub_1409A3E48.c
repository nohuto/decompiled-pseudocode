/*
 * XREFs of sub_1409A3E48 @ 0x1409A3E48
 * Callers:
...
char __fastcall sub_1409A3E48(__int64 a1, __int64 a2, char *a3, char *a4)
{
  __int64 v7; // rsi
  int v8; // eax
  unsigned int v9; // edi
  ...
  _DWORD v23[2]; // [rsp+40h] [rbp-40h] BYREF
  ...
  *(_QWORD *)(a2 + 52) = 0LL;
  v31 = v10;
  sub_1409A3D5C((__int64)v23, (__int64)&v21);
  sub_1409AAE00(*(unsigned int *)(a2 + 28), v23, &v21);
  v11 = v22;
  *(_QWORD *)(a2 + 80) = v22;
  if ( v11 == v7 )
    sub_1409A332C(v9);
  ...
  *a4 = v19;
  ...
  return sub_1409A3B04((char *)a2, *((__int64 *)&v22 + 1));
}
