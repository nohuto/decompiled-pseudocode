/*
 * XREFs of MiReduceZeroingThreads @ 0x140266CA8
 * Callers:
...
__int64 __fastcall MiReduceZeroingThreads(__int64 a1, unsigned int a2, int a3)
{
  ...
  if ( v3 )
  {
    ...
    do
    {
      ...
      *(_DWORD *)(v10 + 296) = 0;
      ...
      for ( i = 0; i < v5; ++i )
      {
        v16 = KiProcessorBlock[FirstSetRightGroupAffinity];
        if ( !v16 )
          break;
        v17 = *(_QWORD *)(v16 + 8);
