/*
 * XREFs of sub_14057B504 @ 0x14057B504
 * Callers:
...
void __fastcall sub_14057B504(__int64 a1, __int64 a2)
{
  __int64 v3; // rcx
  ...
  v7 = 0;
  if ( v3 != -1
    && (int)sub_14057B6FC(v3, (unsigned int)&v7, (unsigned int)&v9, (unsigned int)&v10, (__int64)&v11, (__int64)v8) >= 0 )
  {
