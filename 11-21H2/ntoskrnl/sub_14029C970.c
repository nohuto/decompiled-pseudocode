/*
 * XREFs of sub_14029C970 @ 0x14029C970
 * Callers:
...
char __fastcall sub_14029C970(__int64 a1)
{
  __int64 v1; // rbx
  _QWORD *v2; // rsi
  __int64 v3; // rdi
  ...
  *v4 = 0LL;
  ...
  if ( v14 < *(_QWORD *)(v1 + 8) )
  {
    *((_QWORD *)KeGetCurrentThread() + 162) = 7LL;
  ...
  if ( v10 )
    sub_14029CB9C(v2, &v14, (unsigned int)v3);
  return 1;
}
