/*
 * XREFs of sub_1405BD580 @ 0x1405BD580
 * Callers:
...
__int64 __fastcall sub_1405BD580(__int64 a1, __int64 a2, char a3)
{
...
LABEL_4:
      if ( v10 )
      {
        if ( !(unsigned int)sub_1405BD66C(v9, v6, v5, v4) )
        {
          LODWORD(v8) = -1;
          v3 = v11 - v5;
          v5 = 0LL;
