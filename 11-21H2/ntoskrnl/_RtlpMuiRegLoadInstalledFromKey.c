/*
 * XREFs of _RtlpMuiRegLoadInstalledFromKey @ 0x1403C6028
 * Callers:
 ...
 *     ValidateRegistrLangType @ 0x140830168 (ValidateRegistrLangType.c)
...
__int64 __fastcall RtlpMuiRegLoadInstalledFromKey(int a1)
{
  ...
  *(_OWORD *)(v1 + 10) = 0LL;
  ...
  if ( (int)LdrpOpenKey(v1 + 10, 0LL, v4, v1 + 4) < 0 )
    return 0LL;
  do
  {
    v5 = ZwEnumerateKey(
    ...
    else
    {
      ...
      if ( v6 + 24 <= 0x200 )
      {
        *(_WORD *)(((unsigned __int64)&v16 & 0xFFFFFFFFFFFFFFE0uLL) + 0x50 + 2 * (v6 >> 1)) = 0;
        ...
        if ( (int)LdrpOpenKey(v1 + 10, *(_QWORD *)(((unsigned __int64)&v16 & 0xFFFFFFFFFFFFFFE0uLL) + 0x10), v7, v1 + 2) >= 0 )
        {
          ...
          *(_DWORD *)(((unsigned __int64)&v16 & 0xFFFFFFFFFFFFFFE0uLL) + 0x1C) = 4;
          if ( (int)LdrpQueryValueKey(v8, (PUNICODE_STRING)(v1 + 10), (__int64)(v1 + 7)) >= 0
