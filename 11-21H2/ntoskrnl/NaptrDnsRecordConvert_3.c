/*
 * XREFs of NaptrDnsRecordConvert_3 @ 0x140B0BC60
 * Callers:
 ...
 *     sub_1403C485C @ 0x1403C485C (sub_1403C485C.c)
...
__int64 __fastcall NaptrDnsRecordConvert_3(unsigned int **a1)
{
  int v2; // esi
  int v3; // edx
  _QWORD *v4; // r9
  ...
  _STRING v25; // [rsp+68h] [rbp-98h] BYREF
  ...
  _STRING v30; // [rsp+130h] [rbp+30h] BYREF
  _STRING v31; // [rsp+140h] [rbp+40h] BYREF
  ...
  v24 = 0LL;
  v18[0] = 0;
  RtlInitAnsiString(&DestinationString, *(PCSZ *)(qword_140D068D0 + 184));
  RtlInitAnsiString(&v30, *(PCSZ *)(qword_140D068D0 + 192));
  RtlInitAnsiString(&v31, *(PCSZ *)(qword_140D068D0 + 336));
  v3 = 3;
  v4 = *(_QWORD **)(qword_140D068D0 + 232);
  v5 = (_QWORD *)*v4;
  while ( v5 != v4 )
  {
    v12 = v5[7] == 0LL;
  ...
  if ( Pool2 )
  {
    ...
    if ( (_QWORD *)*v7 != v7 )
    {
      do
      {
        ...
        do
        {
          if ( !*(_BYTE *)v10 && sub_1403C4550(&v25, &DestinationString + v9, &v21) )
          {
            v12 = *((_BYTE *)v8 + 38) == 0;
            *(_DWORD *)&v22[4] = v21;
            v23 = *v11;
            *(_BYTE *)v10 = 1;
            ...
            sub_1403C485C(Pool2, (__int64)v22);
          }
          ++v9;
        ...
        if ( v14 )
        {
          v2 = sub_140B54490(v14, v27, &v24, v18, v26);
          if ( v2 >= 0 )
          {
            if ( !v18[0] )
            {
      ...
      while ( v8 != *(_QWORD **)(qword_140D068D0 + 232) );
    }
    *a1 = Pool2;
  }
  else
