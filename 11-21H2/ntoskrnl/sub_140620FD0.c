/*
 * XREFs of sub_140620FD0 @ 0x140620FD0
 * Callers:
 *     <none>
 * Callees:
...
NTSTATUS __fastcall sub_140620FD0(POBJECT_ATTRIBUTES TargetKey, POBJECT_ATTRIBUTES SourceFile)
{
  __int64 v4; // rdx
  __int64 v5; // rcx
  __int64 *v6; // rdi
...
LABEL_12:
  *(_QWORD *)&v16 = v10;
LABEL_13:
  *(_QWORD *)&v17 = TargetKey;
  *((_QWORD *)&v16 + 1) = SourceFile;
...
LABEL_18:
  result = ZwLoadKey(TargetKey, SourceFile);
  DWORD2(v17) = result;
  if ( v6 )
  {
    v14 = (_QWORD **)(v6 + 6);
