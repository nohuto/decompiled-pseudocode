/*
 * XREFs of DifZwQueryInformationTransactionWrapper @ 0x140625160
 * Callers:
 *     <none>
 * Callees:
...
NTSTATUS __fastcall DifZwQueryInformationTransactionWrapper(
        ...
        PULONG ReturnLength)
{
  ...
  v21 = 0LL;
  v22 = 0LL;
  APIThunkContextById = DifGetAPIThunkContextById(591);
...
LABEL_13:
  ...
  *((_QWORD *)&v22 + 1) = TransactionHandle;
  LODWORD(v22) = TransactionInformationClass;
  *((_QWORD *)&v21 + 1) = TransactionInformation;
  LODWORD(v21) = TransactionInformationLength;
...
LABEL_18:
  result = ZwQueryInformationTransaction(
             TransactionHandle,
