/*
 * XREFs of sub_14057B8F4 @ 0x14057B8F4
 * Callers:
 *     sub_140247A40 @ 0x140247A40 (sub_140247A40.c)
 * Callees:
 *     sub_14054DA20 @ 0x14054DA20 (sub_14054DA20.c)
 *     sub_14057B6FC @ 0x14057B6FC (sub_14057B6FC.c)
 */

__int64 __fastcall sub_14057B8F4(char a1, __int64 a2, unsigned int a3, char *a4)
{
  __int64 v4; // r14
  __int64 v6; // rcx
  __int64 result; // rax
  ...
  if ( v6 == -1 )
    return 3221225473LL;
  result = sub_14057B6FC(v6, (__int64)&v18, (__int64)v17, (__int64)&v16, (__int64)&v20, &v19);
  if ( (int)result >= 0 )
  {
    ...
    LODWORD(Size) = v4;
    result = sub_14054DA20(a1, v18, v17[0], v16, v20, v19, Size, a4);
    if ( (int)result >= 0 )
    {
      if ( !a1 && (_DWORD)v4 )
      {
