/*
 * XREFs of sub_1405DE840 @ 0x1405DE840
 * Callers:
 *     <none>
 * Callees:
...
char __fastcall sub_1405DE840(__int64 a1, _DWORD *a2, __int64 a3)
{
  __int64 v3; // rbx
  ...
  v3 = *(_QWORD *)(a1 + 32);
  if ( sub_1403B9F08(v3, (__int64)a2, a3) )
  {
    for ( i = 0LL; i < *(unsigned int *)(v3 + 828); sub_1403B9DF8(*(_QWORD *)(*(_QWORD *)(v3 + 832) + 8 * i++)) )
      ;
    v15 = 0;
    v6 = *(_QWORD *)(v3 + 1184);
    v16 = 1;
    v7 = sub_1405DE2E4(v3, &v16, &v15, 0LL);
    *(_DWORD *)(v6 + 32) = v7;
    v9 = v7;
    if ( (unsigned int)dword_140C03A00 > 5 )
    {
      ...
      v39 = 4;
      v38 = &v19;
      sub_14024A9B0((__int64)&dword_140C03A00, (unsigned __int8 *)&word_14003249E, v8, 1u, v13, v14, 9u, &v20);
    }
    *a2 += *(_DWORD *)(v6 + 32);
  }
  return 1;
