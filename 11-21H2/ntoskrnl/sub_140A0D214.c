/*
 * XREFs of sub_140A0D214 @ 0x140A0D214
 * Callers:
...
__int64 __fastcall sub_140A0D214(__int64 a1, __int64 a2, __int64 a3, __int64 a4)
{
  unsigned int *v4; // r8
  unsigned int *v8; // rax
  unsigned int i; // ecx
...
LABEL_75:
    ...
    if ( *(_DWORD *)(a2 + 16) >= 0xFFFFEFC0
      || *(_DWORD *)(a2 + 16) + 4164 < (unsigned int)(*(_DWORD *)(a2 + 16) + 4160)
      || *(_DWORD *)(a2 + 16) + 4164 + *(_DWORD *)(a2 + 32) < (unsigned int)(*(_DWORD *)(a2 + 16) + 4164) )
    {
      goto LABEL_56;
    }
    if ( !a4 )
