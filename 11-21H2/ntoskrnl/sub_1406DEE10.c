/*
 * XREFs of sub_1406DEE10 @ 0x1406DEE10
 * Callers:
...
__int64 __fastcall sub_1406DEE10(__int64 a1, __int64 a2, unsigned int a3, int a4, int a5, _WORD *a6, _QWORD *a7)
{
  ...
  v13 = sub_1402828F0(256, 0x20uLL, 0x72466D4Du);
  v14 = v13;
  if ( !v13 )
    return 3221225626LL;
  v13[8] = v10;
