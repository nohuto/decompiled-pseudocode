/*
 * XREFs of sub_14064A834 @ 0x14064A834
 * Callers:
...
__int64 __fastcall sub_14064A834(__int64 a1, unsigned int a2, int a3, int a4, int a5)
{
  __int64 v6; // rsi
  __int64 result; // rax
  int v10; // edi
...
LABEL_18:
        if ( !v20 )
        {
          v18 = 0x10000;
LABEL_20:
          sub_14022D300(v17, v18, a4, *(_QWORD *)(a1 + 48 * v6 + 40), 0);
        }
        break;
      case 2:
