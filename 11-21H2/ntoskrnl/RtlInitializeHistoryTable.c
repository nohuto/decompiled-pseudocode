/*
 * XREFs of RtlInitializeHistoryTable @ 0x140B09C28
 * Callers:
 *     MiInitSystem @ 0x140B07C00 (MiInitSystem.c)
 * Callees:
 *     RtlLookupFunctionEntry @ 0x140298010 (RtlLookupFunctionEntry.c)
 *     RtlpFunctionAddressTableEntry @ 0x140B09CF8 (RtlpFunctionAddressTableEntry.c)
...
__int64 RtlInitializeHistoryTable()
{
  ...
  return RtlpInitMachineFrameEntries(&RtlpSafeMachineFrameEntries, 3LL);
}
