/*
 * XREFs of sub_14057ECF0 @ 0x14057ECF0
 * Callers:
...
char sub_14057ECF0(__int64 a1, __int64 a2, int a3, ...)
{
  _UNKNOWN **v3; // rax
  REGHANDLE v4; // rbx
  ...
  if ( qword_140D00B58 )
  {
    LOBYTE(v3) = EtwEventEnabled(qword_140D00B58, &stru_140038750);
    if ( (_BYTE)v3 )
    {
      UserData.Reserved = 0;
      v9 = 0;
      ...
      v14 = 8;
      v17 = 4;
      LOBYTE(v3) = EtwWriteEx(v4, &stru_140038750, 0LL, 0, 0LL, 0LL, 5u, &UserData);
    }
  }
  return (char)v3;
}
