/*
 * XREFs of sub_140AA9A28 @ 0x140AA9A28
 * Callers:
...
__int64 __fastcall sub_140AA9A28(unsigned int a1, unsigned __int16 *a2)
{
...
LABEL_44:
  ...
  do
    ++v5;
  while ( Dst[v5] );
  return sub_140AA8ED0((KSPIN_LOCK *)0x11, (int *)Dst, 2 * v5 + 2, 0LL, 0LL);
}
