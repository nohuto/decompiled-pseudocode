/*
 * XREFs of sub_1407E0048 @ 0x1407E0048
 * Callers:
...
__int64 __fastcall sub_1407E0048(__int64 a1, void *a2, __int64 a3, unsigned int a4, unsigned int a5, HANDLE Handle)
{
        ...
        *(_QWORD *)(v13 + 8) = v11;
        ...
        do
        {
          ...
          *(_DWORD *)(v13 + 4) = v16;
          ...
          sub_1407E0340(Handle);
          LOBYTE(v20) = 0;
          LODWORD(Length) = 0;
          LODWORD(Size) = v17;
          v6 = sub_1407308F0(a2, Handle, 0LL, 0LL, (unsigned __int64)&v21, 590112, (char *)v13, Size, 0LL, Length, v20);
          if ( v6 == 259 )
          {
