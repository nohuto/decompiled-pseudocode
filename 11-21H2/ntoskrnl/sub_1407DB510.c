/*
 * XREFs of sub_1407DB510 @ 0x1407DB510
 * Callers:
...
__int64 __fastcall sub_1407DB510(__int64 a1, unsigned __int64 a2)
{
  _QWORD *v2; // rdi
  int v4; // r14d
  int v5; // eax
  ...
  v5 = sub_1407DB6A4(a1, &DestinationString);
