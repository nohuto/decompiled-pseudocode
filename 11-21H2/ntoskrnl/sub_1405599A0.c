/*
 * XREFs of sub_1405599A0 @ 0x1405599A0
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall sub_1405599A0(__int64 a1, __int64 a2, __int64 *a3)
{
  __int64 v3; // rbx
  char v6; // r15
  char v7; // r14
  ...
  *(_QWORD *)(v3 + 64) = a3[1];
  if ( v8 )
  {
    ...
    v16 = 20;
    v15 = v13;
    sub_14035EDE4((__int64)&v15, 1u, 0x20000010u, 0x125u, 0x401802u);
    if ( v9 == -1073741802 )
      return v9;
  }
  else
