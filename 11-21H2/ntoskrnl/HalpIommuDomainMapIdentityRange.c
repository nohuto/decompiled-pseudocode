/*
 * XREFs of HalpIommuDomainMapIdentityRange @ 0x14051AA64
 * Callers:
...
__int64 __fastcall HalpIommuDomainMapIdentityRange(ULONG_PTR a1, int a2, __int64 a3, unsigned __int64 a4)
{
  ...
  if ( HalpHvIommu )
  {
    if ( !HalpHvIommuDeviceDomain )
      return 3221225659LL;
    return (unsigned int)IommupHvMapDeviceIdentityRange(a1);
  }
  else
  {
    v11 = 0LL;
    if ( a4 )
    {
      ...
      if ( v11 )
      {
        do
        {
          ...
          v19 = (v14 - v4) << 12;
          HalpIommuUnmapLogicalRange(v16, &v19, v17);
          HalpIommuFlushDomainTbs(a1, v17, (v14 - v4) << 12);
          v4 = v14;
        }
        while ( v14 < v11 );
