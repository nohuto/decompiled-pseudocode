/*
 * XREFs of sub_140AAC700 @ 0x140AAC700
 * Callers:
...
__int64 __fastcall sub_140AAC700(unsigned int *a1, int a2, __int64 a3, unsigned int *a4, _BYTE *a5)
{
  unsigned int *v5; // r13
  __int64 v6; // r11
  unsigned int *v7; // rsi
...
LABEL_27:
  ...
  if ( !v15 && !v16 && v19 == v10 && (_DWORD)v20 == v9 )
    return 3221226021LL;
  result = sub_140AAD404(&v39, v8, v6);
  if ( (int)result >= 0 )
  {
    v33 = v14 * v7[1];
    v34 = v14 * v19;
    v35 = (char *)(*((_QWORD *)v7 + 3) + v33 * v15 + v16 * v14);
    v36 = *(char **)(*(_QWORD *)a3 + 24LL);
    if ( (_DWORD)v20 )
    {
      v37 = v33;
      do
