/*
 * XREFs of HvlpWithdrawPages @ 0x14054599C
 * Callers:
...
char HvlpWithdrawPages()
{
  ...
  v0 = HvlpAcquireHypercallPage((PHYSICAL_ADDRESS *)&v14.m256i_i64[1], 1, 0LL, 0LL);
  v12 = HvlpAcquireHypercallPage((PHYSICAL_ADDRESS *)&v13.m256i_i64[1], 2, 0LL, 0LL);
  v0[1] = 0LL;
  v1 = v12;
  *v0 = -1LL;
