/*
 * XREFs of sub_1405D9510 @ 0x1405D9510
 * Callers:
...
char __fastcall sub_1405D9510(__int64 a1, char a2)
{
  _UNKNOWN **v2; // rax
  REGHANDLE v5; // rbx
  ...
  {
    v5 = qword_140C1F580;
    LOBYTE(v2) = EtwEventEnabled(qword_140C1F580, &stru_140039010);
    if ( (_BYTE)v2 )
    {
      UserData.Reserved = 0;
      v12 = 0;
      ...
      v14 = 1;
      v16 = &v8;
      LOBYTE(v2) = EtwWriteEx(v5, &stru_140039010, 0LL, 0, 0LL, 0LL, 4u, &UserData);
    }
  }
  return (char)v2;
}
