/*
 * XREFs of sub_1409AA3FC @ 0x1409AA3FC
 * Callers:
...
void __fastcall sub_1409AA3FC(__int64 a1, int a2)
{
  ...
  if ( (unsigned int)dword_140D3B908 > 5 )
  {
    if ( sub_1402A2000((__int64)&dword_140D3B908, 1LL) )
    {
      ...
      v7 = a1;
      v16 = 8;
      sub_14020A9C4((__int64)&dword_140D3B908, (unsigned __int8 *)&word_140033ABE, 0LL, 0LL, 5u, &v8);
    }
  }
}
