/*
 * XREFs of sub_14055E880 @ 0x14055E880
 * Callers:
...
__int64 __fastcall sub_14055E880(UNICODE_STRING *a1, _QWORD *a2, int *a3, _QWORD *a4, __int64 a5)
{
  void *v5; // rdi
  __int64 v6; // rsi
  void *v7; // r14
...
LABEL_35:
  ...
  if ( Pool2 )
  {
    ...
    if ( IoStatusBlock.Information == v12 )
    {
      ...
      if ( v14 )
      {
        v9 = sub_14055EF20(Pool2, Length, &v18, v14);
        if ( v9 < 0 )
        {
          sub_14055EBC8(6LL);
          v5 = v18;
        ...
        *v23 = v15;
        ...
        if ( v16 )
        {
          v9 = sub_14055E050((char *)(v6 + 5), *(unsigned __int8 *)(v6 + 4), v16, &v18);
          if ( v9 >= 0 )
          {
            v17 = (_DWORD *)v25;
            *v24 = v7;
