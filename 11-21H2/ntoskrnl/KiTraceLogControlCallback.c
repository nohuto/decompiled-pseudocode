/*
 * XREFs of KiTraceLogControlCallback @ 0x14085FE00
 * Callers:
 *     <none>
 * Callees:
        ...
        _DWORD *a7)
{
  ...
  if ( (_DWORD)a2 == 1 )
  {
    result = KiTraceLogHeteroRundown(a7, a2, a3);
    if ( *a7 > 5u )
    {
      ...
      v44 = 4LL;
      v46 = 4LL;
      return tlgWriteTransfer_EtwWriteTransfer((__int64)a7, (unsigned __int8 *)byte_14002C489, 0LL, 0LL, 0xFu, &v20);
    }
  }
  return result;
}
