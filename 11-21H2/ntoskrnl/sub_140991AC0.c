/*
 * XREFs of sub_140991AC0 @ 0x140991AC0
 * Callers:
...
char __fastcall sub_140991AC0(__int64 a1)
{
  _UNKNOWN **v1; // rax
  int v2; // ebx
  __int64 v3; // rdi
  ...
  if ( (unsigned int)dword_140C03A00 > 5 )
  {
    ...
    if ( (_BYTE)v1 )
    {
      ...
      v74 = 4LL;
      v76 = 88LL;
      LOBYTE(v1) = sub_14020A9C4((__int64)&dword_140C03A00, (unsigned __int8 *)byte_14002E490, 0LL, 0LL, 0x19u, &v30);
    }
  }
  return (char)v1;
}
