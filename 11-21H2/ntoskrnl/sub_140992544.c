/*
 * XREFs of sub_140992544 @ 0x140992544
 * Callers:
...
NTSTATUS __fastcall sub_140992544(PCEVENT_DESCRIPTOR EventDescriptor, __int64 a2, int a3, int a4)
{
  ...
  *(_QWORD *)&v5.Size = 8LL;
  ...
  v8 = &v12;
  v9 = 4LL;
  return EtwWrite(RegHandle, EventDescriptor, 0LL, 3u, &v5);
}
