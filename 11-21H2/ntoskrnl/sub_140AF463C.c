/*
 * XREFs of sub_140AF463C @ 0x140AF463C
 * Callers:
...
void __fastcall sub_140AF463C(__int64 a1)
{
  unsigned int v2; // esi
  __int64 v3; // rbp
  __int64 v4; // rcx
  ...
  if ( *(_DWORD *)qword_140D06950 )
  {
    ...
    while ( 1 )
    {
      v3 -= 16LL;
      --v2;
      v4 = *(_QWORD *)((char *)qword_140D06950 + v3 + 16);
      v5 = (v4 + *(_QWORD *)((char *)qword_140D06950 + v3 + 24)) & 0xFFFFFFFFFFFFFE00uLL;
...
LABEL_6:
      ...
      if ( v8 >= 0x200 )
      {
        ...
        sub_1402C38D0((__int64)&StartContext, v7, v8, 1, 1);
      }
      else if ( !v8 )
      {
...
LABEL_14:
        ...
        {
          if ( v8 >= 0x200 )
            sub_1402C38D0((__int64)&StartContext, v7, v8 & 0xFFFFFFFFFFFFFE00uLL, 1, 1);
          goto LABEL_17;
        }
        goto LABEL_6;
      }
