/*
 * XREFs of sub_14081E4C0 @ 0x14081E4C0
 * Callers:
  ...
  *(_QWORD *)&v5.Length = 2359330LL;
  ...
  if ( v0 >= 0 )
  {
    ...
    *(_OWORD *)&ObjectAttributes.SecurityDescriptor = 0LL;
    ...
    {
      v0 = ZwSetValueKey(Handle, &ValueName, 0, 4u, &dword_140C4B06C, 4u);
      if ( v0 >= 0 )
        v0 = ZwSetValueKey(Handle, &v5, 0, 4u, &dword_140C4B0F8, 4u);
    }
  }
  if ( Handle )
    ZwClose(Handle);
