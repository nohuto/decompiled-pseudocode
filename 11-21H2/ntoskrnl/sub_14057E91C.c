/*
 * XREFs of sub_14057E91C @ 0x14057E91C
 * Callers:
...
BOOLEAN __fastcall sub_14057E91C(__int64 a1, __int64 a2, int a3, int a4, unsigned __int8 a5, char a6)
{
  REGHANDLE v6; // rbx
  BOOLEAN result; // al
  ...
  if ( qword_140D00B58 )
  {
    result = EtwEventEnabled(qword_140D00B58, &stru_140039CE0);
    if ( result )
    {
      UserData.Reserved = 0;
      v12 = 0;
      ...
      v20 = 4;
      v23 = 4;
      return EtwWriteEx(v6, &stru_140039CE0, 0LL, 0, 0LL, 0LL, 6u, &UserData);
    }
  }
  return result;
}
