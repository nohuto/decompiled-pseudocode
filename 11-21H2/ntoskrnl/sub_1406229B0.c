/*
 * XREFs of sub_1406229B0 @ 0x1406229B0
 * Callers:
 *     <none>
 * Callees:
...
NTSTATUS __fastcall sub_1406229B0(
        HANDLE ThreadHandle,
...
LABEL_12:
  *(_QWORD *)&v21 = v15;
LABEL_13:
  *((_QWORD *)&v21 + 1) = TokenHandle;
  *(_QWORD *)&v23 = ThreadHandle;
  DWORD2(v22) = DesiredAccess;
  BYTE4(v22) = OpenAsSelf;
  LODWORD(v22) = HandleAttributes;
...
LABEL_18:
  result = ZwOpenThreadTokenEx(ThreadHandle, DesiredAccess, OpenAsSelf, HandleAttributes, TokenHandle);
  DWORD2(v23) = result;
  if ( v11 )
  {
    v19 = (_QWORD **)(v11 + 6);
