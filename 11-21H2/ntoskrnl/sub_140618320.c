/*
 * XREFs of sub_140618320 @ 0x140618320
 * Callers:
 *     <none>
 * Callees:
...
NTSTATUS __fastcall sub_140618320(PVOID Object, PSECURITY_DESCRIPTOR *SecurityDescriptor, PBOOLEAN MemoryAllocated)
{
  __int64 v6; // rdx
  __int64 v7; // rcx
  __int64 *v8; // rdi
