/*
 * XREFs of DifKeRestoreExtendedProcessorStateWrapper @ 0x140615470
 * Callers:
 *     <none>
 * Callees:
...
char __fastcall DifKeRestoreExtendedProcessorStateWrapper(__int64 a1)
{
  __int64 v2; // rdx
  __int64 v3; // rcx
...
LABEL_18:
  LOBYTE(v10) = KeRestoreExtendedAndSupervisorState(a1);
  if ( APIThunkContextById )
  {
