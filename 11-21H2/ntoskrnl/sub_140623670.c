/*
 * XREFs of sub_140623670 @ 0x140623670
 * Callers:
 *     <none>
 * Callees:
...
NTSTATUS __fastcall sub_140623670(
...
LABEL_12:
  *(_QWORD *)&v21 = v15;
LABEL_13:
  *((_QWORD *)&v21 + 1) = OldProtect;
  *((_QWORD *)&v23 + 1) = ProcessHandle;
  *(_QWORD *)&v23 = BaseAddress;
  *((_QWORD *)&v22 + 1) = RegionSize;
  LODWORD(v22) = NewProtect;
...
LABEL_18:
  result = ZwProtectVirtualMemory(ProcessHandle, BaseAddress, RegionSize, NewProtect, OldProtect);
  LODWORD(v24) = result;
  if ( v11 )
  {
    v19 = (_QWORD **)(v11 + 6);
