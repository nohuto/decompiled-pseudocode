/*
 * XREFs of MiRebuildLargePage @ 0x14045CDD6
 * Callers:
  ...
  if ( v9 != &v9[v6] )
  {
    while ( (*(_DWORD *)(&CurrentThread[1].SwapListEntry + 1) & 1) == 0 )
    {
                  ...
                  &RebuildCandidate) >= 0 )
      {
        ...
        v22 = 48 * RebuildCandidate - 0x220000000000LL;
        ...
        {
          do
            KeYieldProcessorEx(&v51, v19, v20, (__int64)SchedulerAssist);
        ...
        *((_QWORD *)&v54 + 1) = 1LL;
        ...
        if ( inserted )
          _InterlockedExchangeAdd64((volatile signed __int64 *)(a1 + 16960), inserted);
LABEL_41:
        v5 += v13;
        v49 = v5;
        if ( v5 >= a4 )
