/*
 * XREFs of sub_1405CE584 @ 0x1405CE584
 * Callers:
 ...
 *     sub_1405CAD68 @ 0x1405CAD68 (sub_1405CAD68.c)
 */

__int64 __fastcall sub_1405CE584(char a1)
{
  ...
  if ( byte_140C224F8 )
  {
    ...
    if ( a1 )
      ...
      sub_1405CAD68(PerformanceCounter.QuadPart);
  }
