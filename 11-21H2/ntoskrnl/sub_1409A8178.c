/*
 * XREFs of sub_1409A8178 @ 0x1409A8178
 * Callers:
...
void __fastcall sub_1409A8178(int a1, int a2)
{
  ...
  if ( (unsigned int)dword_140D3B908 > 5 )
  {
    if ( sub_1402A2000((__int64)&dword_140D3B908, 1LL) )
    {
      ...
      v6 = a1;
      v7 = a2;
      sub_14020A9C4((__int64)&dword_140D3B908, (unsigned __int8 *)&dword_1400331F4, 0LL, 0LL, 5u, &v8);
    }
  }
}
