/*
 * XREFs of sub_140A34B94 @ 0x140A34B94
 * Callers:
...
__int64 __fastcall sub_140A34B94(__int64 a1, unsigned int a2, __int64 a3, __int64 a4)
{
  unsigned int v4; // edi
  ...
  *(_DWORD *)(a4 + 4) = 0;
  ...
  if ( a2 )
  {
    ...
    while ( 1 )
    {
      ...
      v17[3] = v10[1];
      v18 = 3866683LL;
      if ( !sub_14022D554(v17, &v15) )
        break;
      if ( v15 <= v7 )
        return 5;
      v7 = v15;
      if ( (int)sub_1405D0114(v15, 10000000LL * v20, (unsigned __int64 *)&v15) < 0 )
        return 7;
      v12 = v15;
      v13 = v10 + 2;
      if ( (v10[2] & 1) != 0 )
