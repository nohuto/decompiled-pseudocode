/*
 * XREFs of VidSchEscape @ 0x1C003D0F0
 * Callers:
 *     <none>
 * Callees:
...
LABEL_13:
              ...
              DxgCoreInterface[85](0LL, 0x40000LL, 0xFFFFFFFFLL, L"Invalid VidPnSourceId:%u", v7, 0LL, 0LL, 0LL, 0LL);
              return v4;
            }
            v16 = 0;
            v15[0] = a1 + 1728;
            AcquireSpinLock::Acquire((Acquire *)v15);
            *(_DWORD *)(*(_QWORD *)(a1 + 8 * v7 + 3200) + 82728LL) = *(_DWORD *)(a2 + 28);
LABEL_18:
            v4 = 0;
          ...
          if ( v5 == 1 )
          {
            ...
            v15[0] = a1 + 1728;
            AcquireSpinLock::Acquire((Acquire *)v15);
            *(_DWORD *)(*(_QWORD *)(a1 + 8 * v7 + 3200) + 82724LL) = *(_DWORD *)(a2 + 24);
            goto LABEL_18;
          }
          if ( v5 != 2 )
            return v4;
          *(_BYTE *)(*(_QWORD *)(((__int64 (*)(void))DxgCoreInterface[6])() + 64) + 130LL) = *(_BYTE *)(a2 + 20);
          return 0;
      }
      return v4;
    }
