/*
 * XREFs of VidSchiProcessDpcSystemRequest @ 0x1C000FA04
 * Callers:
...
__int64 __fastcall VidSchiProcessDpcSystemRequest(__int64 a1)
{
  ...
  *(_DWORD *)(a1 + 72) = 13;
  ...
  if ( v1 != _InterlockedCompareExchange64((volatile signed __int64 *)(v3 + 8 * v7 + 1568), 0LL, v1) )
  {
    ...
    DxgCoreInterface[85](0LL, 0x40000LL, 0xFFFFFFFFLL, L"Context running queue is inconsistant", v5, v1, 0LL, 0LL, 0LL);
  }
  if ( *(_DWORD *)(a1 + 88) != 3 )
    *(_QWORD *)(v3 + 224) = v1;
  *(_DWORD *)(v3 + 1560) = ((_BYTE)v7 + 1) & 0xF;
  ...
  if ( v9 )
    VidSchiStartExecutionTimeAtThisPriority((struct _VIDSCH_NODE *)v3, *(_DWORD *)(v9 + 404), v8.QuadPart);
  if ( *(int *)(v3 + 2880) > 0 )
  ...
  if ( _InterlockedExchangeAdd((volatile signed __int32 *)(v1 + 788), 0xFFFFFFFF) == 1 )
  {
    if ( (*(_DWORD *)(v1 + 184) & 1) != 0 )
      *(_DWORD *)(v1 + 184) &= ~2u;
      ...
      VidSchiUpdateContextStatus(v1, 0LL, 12574LL);
  ...
  if ( *(_DWORD *)(a1 + 88) == 3 )
  {
    _InterlockedAdd((volatile signed __int32 *)(v3 + 2908), 0xFFFFFFFF);
    _InterlockedAdd((volatile signed __int32 *)(v3 + 2904), 0xFFFFFFFF);
