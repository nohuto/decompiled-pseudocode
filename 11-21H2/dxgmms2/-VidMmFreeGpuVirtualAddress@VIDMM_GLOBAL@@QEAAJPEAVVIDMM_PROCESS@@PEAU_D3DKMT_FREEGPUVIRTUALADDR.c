/*
 * XREFs of ?VidMmFreeGpuVirtualAddress@VIDMM_GLOBAL@@QEAAJPEAVVIDMM_PROCESS@@PEAU_D3DKMT_FREEGPUVIRTUALADDRESS@@E@Z @ 0x1C009BA10
 * Callers:
 *     VidMmFreeGpuVirtualAddress @ 0x1C001A820 (VidMmFreeGpuVirtualAddress.c)
