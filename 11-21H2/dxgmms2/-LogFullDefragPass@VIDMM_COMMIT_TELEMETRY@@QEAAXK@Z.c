/*
 * XREFs of ?LogFullDefragPass@VIDMM_COMMIT_TELEMETRY@@QEAAXK@Z @ 0x1C00E5878
 * Callers:
...
void __fastcall VIDMM_COMMIT_TELEMETRY::LogFullDefragPass(struct VIDMM_ALLOC **this, int a2)
{
  ...
  if ( *((_BYTE *)this + 24) && (unsigned int)_InterlockedIncrement((volatile signed __int32 *)this[1] + 68) <= 5 )
  {
    ...
    if ( (unsigned int)dword_1C006E048 > 5 && tlgKeywordOn((__int64)&dword_1C006E048, 0x200000000000LL) )
    {
      v5 = *this;
      v7 = a2;
      v6 = *((_QWORD *)v5 + 3);
      v9 = *(unsigned __int16 **)(v6 + 1616);
      v8 = 1;
