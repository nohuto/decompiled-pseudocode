/*
 * XREFs of ?InitializePagingQueue@VIDMM_PAGING_QUEUE@@QEAAJPEAVVIDMM_DEVICE@@IPEAVVIDMM_GLOBAL@@W4VIDMM_PAGING_QUEUE_TYPE@@@Z @ 0x1C0099E2C
 * Callers:
...
__int64 __fastcall VIDMM_PAGING_QUEUE::InitializePagingQueue(__int64 a1, __int64 a2, int a3, __int64 a4, int a5)
{
  ...
  *(_DWORD *)(a1 + 132) = dword_1C006E4AC;
  *(_DWORD *)(a1 + 116) = a5;
  v7 = *(_QWORD *)(a4 + 24);
  if ( *(int *)(v7 + 2424) >= 0x2000 && *(_DWORD *)(v7 + 288) > 1u )
    *(_DWORD *)(a1 + 144) = a3;
    ...
    while ( 1 )
    {
      ...
      *(_QWORD *)(a1 + 24) = v10;
      if ( v9 >= 2 )
      {
        v12 = *(_QWORD *)(a1 + 136);
        v13 = *(_QWORD *)(v12 + 24);
        if ( (*(_DWORD *)(*(_QWORD *)(v12 + 8) + 96LL) & 2) == 0 || v13 && (*(_BYTE *)(v13 + 1869) & 0x10) != 0 )
          v6 = 0;
        *(_BYTE *)(a1 + 128) = v6;
        *(_BYTE *)(a1 + 129) = 0;
