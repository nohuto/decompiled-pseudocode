/*
 * XREFs of ?AllocateStoragePageGpuData@VIDMM_FENCE_STORAGE_PAGE@@QEAAPEAUVIDMM_FENCE_STORAGE_PAGE_GPU_DATA@@PEAVVIDMM_GLOBAL@@@Z @ 0x1C009B3B4
 * Callers:
        ...
        struct VIDMM_GLOBAL *a2)
{
  ...
  if ( !Pool2 )
  {
    _InterlockedIncrement(&dword_1C006E888);
    WdLogSingleEntry1(6LL, 686LL);
