/*
 * XREFs of ?FreeDriverUpdateAddress@VIDMM_PAGE_TABLE_BASE@@QEAAXPEAVCVirtualAddressAllocator@@I_KPEAX@Z @ 0x1C00A1C58
 * Callers:
        ...
        void *a5)
{
                                                ...
                                                + 40416) != a2 )
  {
    ...
    if ( *(_QWORD *)(*(_QWORD *)v7 + 8LL) != v7
      ...
      || (*(_QWORD *)v7 = v9,
          *(_QWORD *)(v9 + 8) = v7,
          v8[2] = *(_QWORD *)(v5 + 8LL * ((*(_DWORD *)this >> 7) & 0x1F) + 4968),
          v10 = 1584LL * ((*(_DWORD *)this >> 7) & 0x1F) + *(_QWORD *)(v5 + 40224) + 464LL,
          v11 = *(__int64 ***)(v10 + 8),
          *v11 != (__int64 *)v10) )
    {
      __fastfail(3u);
