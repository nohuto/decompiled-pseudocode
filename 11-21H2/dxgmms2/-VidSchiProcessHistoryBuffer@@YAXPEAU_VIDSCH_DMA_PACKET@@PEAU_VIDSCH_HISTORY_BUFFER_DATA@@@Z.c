/*
 * XREFs of ?VidSchiProcessHistoryBuffer@@YAXPEAU_VIDSCH_DMA_PACKET@@PEAU_VIDSCH_HISTORY_BUFFER_DATA@@@Z @ 0x1C0034FF8
 * Callers:
...
void __fastcall VidSchiProcessHistoryBuffer(struct _VIDSCH_DMA_PACKET *a1, __m128i **a2)
{
  ...
  v2 = a1;
  if ( (qword_1C006E010 & 0x461C8ED7) != 0
    && (qword_1C006E018 & 0xFFFFFFFFB9E37128uLL) == 0
    && (qword_1C006E010 & 0x4000) != 0 )
  {
    ...
    {
      v13 = *(_QWORD *)(v6 + 8);
      v14 = *(_DWORD *)(*(_QWORD *)(*(_QWORD *)(*(_QWORD *)(v13 + 16) + 2680LL)
      ...
      if ( v14 )
      {
        ...
        ((void (__fastcall **)(_QWORD, __int64, __int64, const wchar_t *, __int64, __int8 *, unsigned __int64, _QWORD, _QWORD))DxgCoreInterface)[85](
          0LL,
          0x40000LL,
          0xFFFFFFFFLL,
      ...
      else
      {
        ...
        KeAcquireInStackQueuedSpinLockAtDpcLevel((PKSPIN_LOCK)(v13 + 1144), &LockHandle);
        v22 = *(_QWORD *)(*(_QWORD *)(v6 + 8) + 1136LL);
        if ( v22 )
        {
          v36 = 0;
          v40 = 0;
