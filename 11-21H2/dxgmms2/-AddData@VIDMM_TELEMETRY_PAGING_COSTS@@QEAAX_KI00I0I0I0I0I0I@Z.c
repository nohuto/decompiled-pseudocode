/*
 * XREFs of ?AddData@VIDMM_TELEMETRY_PAGING_COSTS@@QEAAX_KI00I0I0I0I0I0I@Z @ 0x1C00E4BD8
 * Callers:
        ...
        unsigned int a16)
{
  ...
  BucketIdForAllocationSizePow2 = (unsigned int)GetBucketIdForAllocationSizePow2(a2);
  ...
  *((_DWORD *)this + BucketIdForAllocationSizePow2 + 770) += a3;
