/*
 * XREFs of VidSchiDeferredVisibilityThread @ 0x1C001C3A0
 * Callers:
 *     <none>
 * Callees:
...
char __fastcall VidSchiDeferredVisibilityThread(__int64 a1)
{
  ...
  ((void (__fastcall *)(int *, __int64))DxgCoreInterface[78])(&v12, 4024LL);
  ...
  if ( *(_DWORD *)(a1 + 200) == 1 )
  {
    ...
    v4 = *(_DWORD *)(a1 + 2692);
    v5 = 0;
    v6 = *(_QWORD *)(*(_QWORD *)(a1 + 2800) + 632LL);
    _InterlockedExchange((volatile __int32 *)(v6 + 2456), 0);
    if ( *(_DWORD *)(v6 + 40) )
    {
      do
      {
        if ( _InterlockedCompareExchange((volatile signed __int32 *)(*(_QWORD *)(v6 + 8LL * v5 + 3200) + 78576LL), 0, 3) == 3 )
        {
          if ( v4 >= 3000 && !v3 )
          {
  ...
  result = ((__int64 (__fastcall *)(int *))DxgCoreInterface[79])(&v12);
  if ( v14 )
  {
    result = byte_1C006E941;
    if ( byte_1C006E941 < 0 )
