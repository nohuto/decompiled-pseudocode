/*
 * XREFs of ?BuildMdlFromRange@VIDMM_CPU_HOST_APERTURE@@QEBAPEAU_MDL@@PEAXPEBUVIDMM_CPU_HOST_APERTURE_RANGE@@_K2@Z @ 0x1C0019230
 * Callers:
        ...
        unsigned __int64 a5)
{
  ...
  if ( Mdl )
  {
    ...
    if ( v9 == 4096 )
    {
      ...
      {
        Mdl[1].Next = *(struct _MDL **)(v20 + 8 * v11 + 48);
        if ( (_DWORD)v11 != v12 )
        {
          do
          {
