/*
 * XREFs of ?ValidateMemoryRanges@VIDMM_SEGMENT@@QEAAJIPEAU_DXGK_MEMORYRANGE@@AEA_K@Z @ 0x1C00EDA68
 * Callers:
        ...
        unsigned __int64 *a4)
{
  ...
  for ( i = &a3->SizeInBytes; ; i += 2 )
  {
    ...
    if ( v9 < v13 )
    {
      ...
      {
        v15 = v4;
        WdLogSingleEntry3(1LL, a3[v4].SizeInBytes, -1073741811LL, 635LL);
  ...
  WdLogSingleEntry4(1LL, v9, a3[v4].SizeInBytes, -1073741811LL, 612LL);
LABEL_15:
