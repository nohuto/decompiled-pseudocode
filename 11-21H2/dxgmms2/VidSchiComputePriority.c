/*
 * XREFs of VidSchiComputePriority @ 0x1C0097D80
 * Callers:
...
__int64 __fastcall VidSchiComputePriority(__int64 a1, int a2, int a3, char a4, _DWORD *a5)
{
  ...
  v11 = dword_1C00501EC[15 * *(int *)(v10 + 24) + v9];
  *a5 = v11;
  if ( v11 < 0x10 || a3 || (*(_DWORD *)(*(_QWORD *)(v10 + 8) + 424LL) & 2) != 0 || SeSinglePrivilegeCheck((LUID)14LL, 1) )
  {
