/*
 * XREFs of VidSchiProcessHwQueuePageFaultedDpc @ 0x1C0042D28
 * Callers:
...
void __fastcall VidSchiProcessHwQueuePageFaultedDpc(PSLIST_ENTRY ListEntry)
{
  ...
  v39 = v47;
  ExpInterlockedPushEntrySList((PSLIST_HEADER)&Next[390], ListEntry);
  v4 = (int)v47;
