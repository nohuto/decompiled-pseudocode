/*
 * XREFs of ?VerifyAllocationForSubmissionPhysical@VIDMM_GLOBAL@@QEAAJPEAUVIDMM_ALLOC@@@Z @ 0x1C00DBBE4
 * Callers:
...
__int64 __fastcall VIDMM_GLOBAL::VerifyAllocationForSubmissionPhysical(VIDMM_GLOBAL *this, struct VIDMM_ALLOC *a2)
{
  ...
  {
    if ( (unsigned __int16)(*(_WORD *)(*(_QWORD *)(v2 + 528) + 4LL) - 2) > 1u && (*((_BYTE *)a2 + 28) & 3) == 2 )
      return 0LL;
