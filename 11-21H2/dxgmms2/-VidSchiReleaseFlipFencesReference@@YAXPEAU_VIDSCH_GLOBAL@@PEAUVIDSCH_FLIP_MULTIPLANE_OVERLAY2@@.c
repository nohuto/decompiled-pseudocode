/*
 * XREFs of ?VidSchiReleaseFlipFencesReference@@YAXPEAU_VIDSCH_GLOBAL@@PEAUVIDSCH_FLIP_MULTIPLANE_OVERLAY2@@@Z @ 0x1C0035580
 * Callers:
        ...
        struct VIDSCH_FLIP_MULTIPLANE_OVERLAY2 *a2)
{
  ...
  while ( v4 || v7 )
  {
    ...
    if ( v17 )
    {
      VidSchiReleaseSyncObjectReference(v17, v8);
    ...
    if ( v18 )
    {
      if ( v12 < v13 )
      {
        VidSchiReleaseSyncObjectReference(v18, v8);
