/*
 * XREFs of ?Feature_Servicing_DeferPageTableDestruction__private_IsEnabled@@YAHXZ @ 0x1C001D470
 * Callers:
...
__int64 Feature_Servicing_DeferPageTableDestruction__private_IsEnabled(void)
{
  ...
  CachedFeatureEnabledState = wil_details_FeatureStateCache_GetCachedFeatureEnabledState(
                                (unsigned int *)&Feature_Servicing_DeferPageTableDestruction__private_featureState,
                                (__int64)&Feature_Servicing_DeferPageTableDestruction__private_descriptor);
  v1 = (CachedFeatureEnabledState >> 3) & 1;
  wil_details_FeatureReporting_ReportUsageToService(
    (__int64)&Feature_Servicing_DeferPageTableDestruction__private_reporting,
    0x2A8171Eu,
