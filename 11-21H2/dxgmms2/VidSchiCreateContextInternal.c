/*
 * XREFs of VidSchiCreateContextInternal @ 0x1C001270C
 * Callers:
...
__int64 __fastcall VidSchiCreateContextInternal(__int64 a1, int *a2, __int64 a3)
{
  ...
  KSPIN_LOCK *v57; // [rsp+88h] [rbp-78h]
      ...
      *(_QWORD *)(v8 + 480) = v23;
      ...
      if ( (*a2 & 0x604) != 0 )
      {
        if ( (v24 & 1) != 0 )
        {
          ...
          v49 = *(_QWORD *)(a1 + 16);
          LODWORD(v61[1]) = v61[1] & 0xFFFFFFE2 | ((v24 & 4 | ((v24 & 0x200 | (v24 >> 1) & 0x400) >> 4)) >> 2) | (4 * (*(_BYTE *)(344LL * *(unsigned __int16 *)(v56 + 6) + *(_QWORD *)(*(_QWORD *)(v48 + 16) + 2680LL) + 48) & 1));
        ...
        if ( v40 )
        {
          ...
          while ( 1 )
          {
            ...
            if ( !v42 )
              break;
            *(_DWORD *)(v42 + 64) |= 0x40u;
            VidSchiInterlockedInsertTailList(v57, v16, (_QWORD *)(v42 + 8), (_DWORD *)(v8 + 776));
