/*
 * XREFs of ?MapVideoApertureSegmentInternal@VIDMM_GLOBAL@@IEAAXKPEAU_VIDMM_GLOBAL_ALLOC@@I_K1PEAU_MDL@@KHH@Z @ 0x1C00ABBFC
 * Callers:
        ...
        int a10)
{
  ...
  do
  {
    ...
    v15 = 0LL;
    if ( a3 && *((_QWORD *)a3 + 11) && (**((_DWORD **)a3 + 66) & 0x10000000) == 0 && (*((_DWORD *)a3 + 19) & 4) == 0 )
    {
      DXGFASTMUTEX::Acquire((struct _VIDMM_GLOBAL_ALLOC *)((char *)a3 + 296));
      v15 = *(_QWORD *)(*(_QWORD *)(*(_QWORD *)(*(_QWORD *)(*((_QWORD *)a3 + 11) + 40LL) - 32LL) + 24LL) + 584LL);
      DXGFASTMUTEX::Release((struct _KTHREAD **)a3 + 37);
    }
    if ( (*((_BYTE *)this + 40937) & 0x20) != 0 )
    {
      LogicalAddress = SysMmGetLogicalAddress(*((void *const *)a3 + 65));
      v20 = *((_QWORD *)a3 + 66);
      v21 = LogicalAddress;
    ...
    v17 = ADAPTER_RENDER::DdiBuildPagingBuffer(this[2], &v24);
