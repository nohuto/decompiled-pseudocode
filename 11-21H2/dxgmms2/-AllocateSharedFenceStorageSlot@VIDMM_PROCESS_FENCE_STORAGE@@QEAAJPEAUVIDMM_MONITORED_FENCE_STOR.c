/*
 * XREFs of ?AllocateSharedFenceStorageSlot@VIDMM_PROCESS_FENCE_STORAGE@@QEAAJPEAUVIDMM_MONITORED_FENCE_STORAGE@@PEAVVIDMM_PROCESS@@@Z @ 0x1C0001100
 * Callers:
        ...
        struct VIDMM_PROCESS *a3)
{
  ...
  v6 = (VIDMM_FENCE_STORAGE_PAGE *)operator new(176LL, 875850070LL, 64LL);
  if ( !v6 )
    return 3221225495LL;
