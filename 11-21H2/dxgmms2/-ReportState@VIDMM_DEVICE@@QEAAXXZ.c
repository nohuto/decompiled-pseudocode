/*
 * XREFs of ?ReportState@VIDMM_DEVICE@@QEAAXXZ @ 0x1C00DDB14
 * Callers:
 *     VidMmReportVidMmDeviceState @ 0x1C002D4B0 (VidMmReportVidMmDeviceState.c)
...
void __fastcall VIDMM_DEVICE::ReportState(VIDMM_DEVICE *this)
{
  ...
  if ( v1 )
  {
    ...
    {
      if ( *((int *)i + 10) > 0 && (byte_1C006E941 & 0x10) != 0 )
