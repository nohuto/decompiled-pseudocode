/*
 * XREFs of ?DestroyDisconnectedPageTables@VIDMM_PAGE_DIRECTORY@@QEAAXPEAVCVirtualAddressAllocator@@II_K1PEAUVIDMM_ALLOC@@@Z @ 0x1C00A3178
 * Callers:
  ...
  if ( a3 < a4 )
  {
    ...
    while ( 1 )
    {
      ...
      if ( (v15 & 0x400) != 0 )
      {
        ...
        if ( v17 )
        {
          v18 = *(struct _KEVENT ***)(v17 + 24);
          if ( v18 )
          {
            VIDMM_PAGE_TABLE::DestroyPageTable(v18, a2, a5);
            *(_QWORD *)(*(_QWORD *)(*((_QWORD *)this + 6) + v10) + 24LL) = 0LL;
          }
        }
        goto LABEL_10;
      }
      if ( (v15 & 3) != 1 )
      {
        ...
        if ( v16 )
        {
          if ( *(struct VIDMM_ALLOC **)(v16 + 24) != a7 )
          {
            VIDMM_PAGE_TABLE::DestroyPageTable((struct _KEVENT **)v16, a2, a5);
LABEL_9:
