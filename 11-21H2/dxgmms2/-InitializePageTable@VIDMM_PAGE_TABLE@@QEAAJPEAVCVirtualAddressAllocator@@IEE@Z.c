/*
 * XREFs of ?InitializePageTable@VIDMM_PAGE_TABLE@@QEAAJPEAVCVirtualAddressAllocator@@IEE@Z @ 0x1C00A136C
 * Callers:
        ...
        char a5)
{
  ...
  v9 = *(_QWORD *)(*((_QWORD *)a2 + 11) + 40224LL) + 1584 * v7;
  ...
  *((_QWORD *)this + 4) = v13;
  if ( v13 )
  {
    if ( a4 )
    {
      v14 = *(_DWORD *)(*(_QWORD *)(v9 + 440) + 12LL);
    }
    else
    {
      v14 = *(_DWORD *)(v9 + 32);
      if ( a5 && *(_DWORD *)(*(_QWORD *)(v9 + 440) + 12LL) > v14 )
        v14 = *(_DWORD *)(*(_QWORD *)(v9 + 440) + 12LL);
    }
  ...
  {
    _InterlockedIncrement(&dword_1C006E85C);
    WdLogSingleEntry1(6LL, 4156LL);
