/*
 * XREFs of ?MapToIommu@VIDMM_SEGMENT@@QEAAJXZ @ 0x1C00EB11C
 * Callers:
...
__int64 __fastcall VIDMM_SEGMENT::MapToIommu(VIDMM_SEGMENT *this)
{
  ...
  else if ( (v1 & 0x1001) != 0 )
  {
    ...
    {
      v10 = i - 400;
      v11 = VIDMM_GLOBAL::IoMmuMapAllocation(*((VIDMM_GLOBAL **)this + 1), (struct _VIDMM_GLOBAL_ALLOC *)(i - 400));
      v12 = v11;
      if ( v11 < 0 )
      {
LABEL_10:
    ...
    {
      v10 = (char *)j - 400;
      v15 = VIDMM_GLOBAL::IoMmuMapAllocation(*((VIDMM_GLOBAL **)this + 1), (VIDMM_SEGMENT *)((char *)j - 400));
      v12 = v15;
      if ( v15 < 0 )
        goto LABEL_10;
    }
