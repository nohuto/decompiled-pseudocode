/*
 * XREFs of ?InitGlobals@VIDMM_DMA_POOL@@SAJXZ @ 0x1C00B4058
 * Callers:
...
__int64 VIDMM_DMA_POOL::InitGlobals(void)
{
  ...
  qword_1C006E8D0 = (__int64)&VIDMM_DMA_POOL::_DmaPoolsListHead;
  VIDMM_DMA_POOL::_DmaPoolsListHead.Flink = &VIDMM_DMA_POOL::_DmaPoolsListHead;
  VIDMM_DMA_POOL::_MaxNbDmaBuffers = dword_1C006E378;
  VIDMM_DMA_POOL::_MaxNbCddDmaBuffers = dword_1C006E37C;
  VIDMM_DMA_POOL::_MaxDmaBufferBytes = (unsigned int)dword_1C006E380;
  VIDMM_DMA_POOL::_MaxAllocationListBytes = (unsigned int)dword_1C006E384;
  VIDMM_DMA_POOL::_MaxPatchLocationListBytes = (unsigned int)dword_1C006E384;
  v0 = (unsigned int)dword_1C006E380 / 0x64uLL;
  ...
  v1 = (unsigned int)dword_1C006E384 / 0x64uLL;
  ...
  if ( v2 )
  {
    ...
    {
      VIDMM_DMA_POOL::_NbDmaBufferLimitCompareWatermark = dword_1C006E388;
      return 0LL;
    }
  }
  else
