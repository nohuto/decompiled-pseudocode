/*
 * XREFs of ?FreeMemoryBlocks@VIDMM_LINEAR_POOL@@QEAAJW4_VIDMM_POOL_BLOCK_STATE@@IPEAU_DXGK_MEMORYRANGE@@@Z @ 0x1C00EF524
 * Callers:
...
__int64 __fastcall VIDMM_LINEAR_POOL::FreeMemoryBlocks(VIDMM_LINEAR_POOL *a1, char a2, __int64 a3, _QWORD *a4)
{
  ...
  VIDMM_LINEAR_POOL::Free(a1, (struct _VIDMM_POOL_BLOCK *)v7, a3, (__int64)a4);
  return 0LL;
}
