/*
 * XREFs of ?Evict@VIDMM_GLOBAL@@QEAAXPEAVVIDMM_DEVICE@@PEAPEAU_VIDMM_MULTI_ALLOC@@IKPEA_K@Z @ 0x1C00A4510
 * Callers:
 *     ?VidMmEvict@@YAXPEAVVIDMM_GLOBAL@@PEAVVIDMM_DEVICE@@PEAPEAU_VIDMM_MULTI_ALLOC@@IKPEA_K@Z @ 0x1C0017080 (-VidMmEvict@@YAXPEAVVIDMM_GLOBAL@@PEAVVIDMM_DEVICE@@PEAPEAU_VIDMM_MULTI_ALLOC@@IKPEA_K@Z.c)
        ...
        unsigned __int64 *a6)
{
  ...
  for ( i = &v6[v7]; v6 != i; ++v6 )
  {
    ...
    if ( !((unsigned int)v13 | *((_DWORD *)v11 + 38)) && !*((_DWORD *)v11 + 39) )
    {
      ...
      v14 = (_QWORD *)*((_QWORD *)v11 + 1);
      LODWORD(v17[0]) = 207;
      v17[2] = v11;
      LODWORD(v17[4]) = a5;
      v15 = dword_1C006E4F8 || (*(_DWORD *)(v14[1] + 112LL) & 1) != 0;
