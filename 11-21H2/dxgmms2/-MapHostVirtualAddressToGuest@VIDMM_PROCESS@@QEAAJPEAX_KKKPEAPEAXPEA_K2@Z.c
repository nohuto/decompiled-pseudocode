/*
 * XREFs of ?MapHostVirtualAddressToGuest@VIDMM_PROCESS@@QEAAJPEAX_KKKPEAPEAXPEA_K2@Z @ 0x1C00DFED4
 * Callers:
        ...
        void **a8)
{
  ...
  if ( v15 >= 0 )
  {
    ...
    v20 = (struct _RTL_BALANCED_NODE *)v23;
    v21 = v23 + *(_QWORD *)(*(_QWORD *)(v19 + 608) + 256LL);
    ...
    {
      WdLogSingleEntry2(1LL, a3, 2280LL);
