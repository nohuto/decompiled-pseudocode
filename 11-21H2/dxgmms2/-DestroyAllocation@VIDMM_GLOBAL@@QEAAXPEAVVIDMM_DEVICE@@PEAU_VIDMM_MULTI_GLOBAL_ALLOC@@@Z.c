/*
 * XREFs of ?DestroyAllocation@VIDMM_GLOBAL@@QEAAXPEAVVIDMM_DEVICE@@PEAU_VIDMM_MULTI_GLOBAL_ALLOC@@@Z @ 0x1C00A540C
 * Callers:
 *     VidMmDestroyAllocation @ 0x1C0017B00 (VidMmDestroyAllocation.c)
 * Callees:
