/*
 * XREFs of ?VidSchiSetNextFlipEarliestIdealTime@@YAXPEAU_VIDSCH_GLOBAL@@IPEAUVIDSCH_FLIP_QUEUE@@PEAU_VIDSCH_FLIP_QUEUE_ENTRY@@@Z @ 0x1C0046144
 * Callers:
        ...
        struct _VIDSCH_FLIP_QUEUE_ENTRY *a4)
{
  ...
  if ( *(_DWORD *)(v7 + 2944) == -1 )
  {
    if ( *((_DWORD *)a4 + 285) == -1 )
      ...
      CurrentVSyncPeriodQpc = *(_DWORD *)(v7 + 82744);
  }
  else
  {
