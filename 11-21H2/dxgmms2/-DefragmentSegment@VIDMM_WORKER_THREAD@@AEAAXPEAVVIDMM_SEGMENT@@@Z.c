/*
 * XREFs of ?DefragmentSegment@VIDMM_WORKER_THREAD@@AEAAXPEAVVIDMM_SEGMENT@@@Z @ 0x1C00DDEDC
 * Callers:
 ...
 *     ?VidMmiTickCountTo100ns@@YA_K_K@Z @ 0x1C00E1FBC (-VidMmiTickCountTo100ns@@YA_K_K@Z.c)
