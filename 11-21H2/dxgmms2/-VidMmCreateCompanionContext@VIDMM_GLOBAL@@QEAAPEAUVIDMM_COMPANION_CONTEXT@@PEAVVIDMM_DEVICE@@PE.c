/*
 * XREFs of ?VidMmCreateCompanionContext@VIDMM_GLOBAL@@QEAAPEAUVIDMM_COMPANION_CONTEXT@@PEAVVIDMM_DEVICE@@PEAU_VIDSCH_CONTEXT@@@Z @ 0x1C00DBD84
 * Callers:
 *     VidMmCreateCompanionContext @ 0x1C002D280 (VidMmCreateCompanionContext.c)
 * Callees:
