/*
 * XREFs of ?RegisterSchLog@VIDMM_GLOBAL@@QEAAJPEAVVIDMM_SCH_LOG@@@Z @ 0x1C0047874
 * Callers:
...
__int64 __fastcall VIDMM_GLOBAL::RegisterSchLog(VIDMM_GLOBAL *this, struct VIDMM_SCH_LOG *a2)
{
  ...
  if ( *((_BYTE *)this + 40181)
    && (v4 = (struct _MDL *)*((_QWORD *)a2 + 8),
        LogicalAddress = VidMmiGetLogicalAddress(*((void **)a2 + 9), 0LL),
