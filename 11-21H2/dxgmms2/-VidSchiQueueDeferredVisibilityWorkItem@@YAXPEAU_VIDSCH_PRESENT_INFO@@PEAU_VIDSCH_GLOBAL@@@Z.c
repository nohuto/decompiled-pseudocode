/*
 * XREFs of ?VidSchiQueueDeferredVisibilityWorkItem@@YAXPEAU_VIDSCH_PRESENT_INFO@@PEAU_VIDSCH_GLOBAL@@@Z @ 0x1C0035528
 * Callers:
...
{
  if ( _InterlockedCompareExchange((volatile signed __int32 *)a1 + 19644, 3, 2) == 2
