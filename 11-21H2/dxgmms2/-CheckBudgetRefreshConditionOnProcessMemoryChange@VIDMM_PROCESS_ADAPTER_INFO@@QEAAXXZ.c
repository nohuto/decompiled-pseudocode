/*
 * XREFs of ?CheckBudgetRefreshConditionOnProcessMemoryChange@VIDMM_PROCESS_ADAPTER_INFO@@QEAAXXZ @ 0x1C00DF91C
 * Callers:
        ...
        VIDMM_PROCESS_ADAPTER_INFO *this)
{
  ...
  if ( *(_DWORD *)(*(_QWORD *)this + 7016LL) )
  {
    do
    {
      ...
      v15 = 1;
      v7 = 0;
      v8 = (unsigned int *)(1584LL * v2 + *(_QWORD *)(v5 + 40224) + 496LL);
      while ( 1 )
      {
        v9 = *(v6 - 6);
        if ( v7 == 1 )
