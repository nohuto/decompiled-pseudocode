/*
 * XREFs of ?InvalidateAllVirtualAddresses@VIDMM_GLOBAL@@QEAAXXZ @ 0x1C00D7764
 * Callers:
 *     VidMmInvalidateAllVirtualAddresses @ 0x1C002D300 (VidMmInvalidateAllVirtualAddresses.c)
 * Callees:
