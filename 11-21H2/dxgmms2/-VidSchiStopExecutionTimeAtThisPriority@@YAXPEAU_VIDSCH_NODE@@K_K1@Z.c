/*
 * XREFs of ?VidSchiStopExecutionTimeAtThisPriority@@YAXPEAU_VIDSCH_NODE@@K_K1@Z @ 0x1C00111C4
 * Callers:
        ...
        *v9 = v11;
        if ( (byte_1C006E941 & 1) != 0 )
        {
          if ( is_mul_ok(v11, 0x989680uLL) )
          {
            ...
            v11 = v11 * (unsigned __int128)0x989680uLL / a4;
          }
          else
          {
            v5 = v11 / a4;
            v12 = 10000000 * (v11 % a4) % a4;
            LODWORD(v11) = 10000000 * (v11 / a4) + 10000000 * (v11 % a4) / a4;
          }
