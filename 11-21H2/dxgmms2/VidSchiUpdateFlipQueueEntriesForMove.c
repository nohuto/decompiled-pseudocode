/*
 * XREFs of VidSchiUpdateFlipQueueEntriesForMove @ 0x1C003B00C
 * Callers:
...
void __fastcall VidSchiUpdateFlipQueueEntriesForMove(__int64 a1, _QWORD *a2)
{
  ...
  for ( i = 0; i < *(_DWORD *)(a1 + 40); ++i )
  {
    ...
    if ( v6 )
    {
      LOWORD(v7) = *(_WORD *)(v6 + 44048);
      while ( (_WORD)v7 )
      {
        v8 = *(unsigned __int16 *)(v6 + 44050);
        v9 = -1;
        v10 = 0;
        ...
        if ( v8 )
        {
          ...
          HIDWORD(v25[1]) = *(unsigned __int16 *)(v13 + v6 + 3120);
          v25[3] = *(_QWORD *)(v13 + v6 + 3088);
          v25[0] = a1;
          LODWORD(v25[1]) = i;
          if ( v10 )
            v15 = (__int64 *)(v6 + v13 + 3112);
          else
            v15 = &v29;
          v16 = v26;
          v17 = 0;
          ...
          do
          {
            if ( v17 )
            {
              v18 = 3LL * (v17 - 1);
              v19 = (v17 + (v16 << 6)) << 6;
              v25[v18 + 71] = *(_QWORD *)(v19 + v6 + 3088);
              LOWORD(v25[v18 + 72]) = *(_WORD *)(v19 + v6 + 3120);
              if ( v10 == v17 )
                v20 = &v23;
              else
                v20 = (__int64 *)(v19 + v6 + 3112);
              v25[3 * v17 + 70] = *v20;
              v8 = v25[4];
            }
            ++v17;
