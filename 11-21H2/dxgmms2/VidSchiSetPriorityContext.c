/*
 * XREFs of VidSchiSetPriorityContext @ 0x1C0012DF0
 * Callers:
 ...
 * Callees:
 *     ?VidSchiUpdateReadyBitsInNewPriority@@YAXPEAU_VIDSCH_NODE@@PEAU_VIDSCH_CONTEXT@@@Z @ 0x1C0001054 (-VidSchiUpdateReadyBitsInNewPriority@@YAXPEAU_VIDSCH_NODE@@PEAU_VIDSCH_CONTEXT@@@Z.c)
 *     ?VidSchiStartExecutionTimeAtThisPriority@@YAXPEAU_VIDSCH_NODE@@K_K@Z @ 0x1C00010C0 (-VidSchiStartExecutionTimeAtThisPriority@@YAXPEAU_VIDSCH_NODE@@K_K@Z.c)
    ...
    *((_QWORD *)a1 + 60) = *(_QWORD *)(v6 + 8 * v9 + 2680);
    ...
    if ( (_DWORD)v8 != *((_DWORD *)a1 + 101) )
    {
        ...
        if ( *(struct _VIDSCH_CONTEXT **)(v12 + 8) != (struct _VIDSCH_CONTEXT *)((char *)a1 + 8)
          ...
          || (*v13 = (__int64 *)v12,
              *(_QWORD *)(v12 + 8) = v13,
              ...
              v14 = 16LL * *((unsigned int *)a1 + 101) + v2 + 2056,
              v15 = *(__int64 ***)(v14 + 8),
              *v15 != (__int64 *)v14) )
        {
          __fastfail(3u);
      ...
      if ( (*((_DWORD *)a1 + 46) & 2) != 0 )
      {
        ...
        v16 = *((unsigned int *)a1 + 101);
        if ( *(_DWORD *)(v2 + 4 * v16 + 1776) == 1 )
          *(_DWORD *)(v2 + 1772) |= 1 << v16;
        if ( (*(_DWORD *)(v2 + 4 * v8 + 1776))-- == 1 )
          *(_DWORD *)(v2 + 1772) &= ~(1 << v8);
