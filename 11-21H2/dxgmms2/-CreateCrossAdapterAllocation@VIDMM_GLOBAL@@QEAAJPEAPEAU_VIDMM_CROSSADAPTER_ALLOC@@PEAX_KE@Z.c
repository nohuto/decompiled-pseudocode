/*
 * XREFs of ?CreateCrossAdapterAllocation@VIDMM_GLOBAL@@QEAAJPEAPEAU_VIDMM_CROSSADAPTER_ALLOC@@PEAX_KE@Z @ 0x1C00D58E0
 * Callers:
 *     VidMmCreateCrossAdapterAllocation @ 0x1C002D2A0 (VidMmCreateCrossAdapterAllocation.c)
 * Callees:
        ...
        unsigned __int8 a5)
{
  ...
  if ( !a3 || a5 || (v6 = MmSecureVirtualMemory(a3, a4, 4u)) != 0LL )
  {
    ...
    {
      *a2 = 0LL;
      _InterlockedIncrement(&dword_1C006E87C);
      WdLogSingleEntry1(6LL, 2029LL);
