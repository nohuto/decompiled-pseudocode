/*
 * XREFs of VidSchFlushContext @ 0x1C009A2F0
 * Callers:
 *     VidSchTerminateContext @ 0x1C0098F20 (VidSchTerminateContext.c)
 * Callees:
 *     VidSchiCancelDelayTimerContext @ 0x1C001440C (VidSchiCancelDelayTimerContext.c)
...
__int64 __fastcall VidSchFlushContext(__int64 a1, int *a2, __int64 a3, __int64 a4)
{
  ...
  if ( a1 && a2 )
  {
    v5 = *(KSPIN_LOCK **)(*(_QWORD *)(a1 + 104) + 32LL);
    VidSchRundownUnorderedWaiter<_VIDSCH_CONTEXT>(a1, (__int64)v5, *a2, a4, v9);
    ...
    VidSchiInterlockedReadUlong(v5 + 216, (_DWORD *)(a1 + 784));
    if ( *(_DWORD *)(a1 + 792) )
    {
      memset(v10, 0, sizeof(v10));
      LODWORD(v10[4]) |= 0x10u;
