/*
 * XREFs of ?FlushDeferredEvictions@VIDMM_WORKER_THREAD@@AEAA_NPEAVVIDMM_DEVICE@@@Z @ 0x1C00DE83C
 * Callers:
...
char __fastcall VIDMM_WORKER_THREAD::FlushDeferredEvictions(union _LARGE_INTEGER *this, struct VIDMM_DEVICE *a2)
{
  ...
  KeWaitForSingleObject((PVOID)(this->QuadPart + 41152), Executive, 0, 0, 0LL);
  v5 = *this;
  ...
  while ( 1 )
  {
    ...
    *v7 = v9;
    ...
    if ( v8 == v7 )
      break;
    (*(void (__fastcall **)(_QWORD *, _QWORD, _QWORD *, _QWORD *))(*v8[2] + 24LL))(v8[2], 0LL, v8[3], v8[4]);
    operator delete(v8);
  }
  *((_QWORD *)v6 + 1) = 0LL;
