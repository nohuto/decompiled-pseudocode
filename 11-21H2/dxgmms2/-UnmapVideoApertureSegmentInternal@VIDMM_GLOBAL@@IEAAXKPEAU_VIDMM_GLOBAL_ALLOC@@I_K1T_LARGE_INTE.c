/*
 * XREFs of ?UnmapVideoApertureSegmentInternal@VIDMM_GLOBAL@@IEAAXKPEAU_VIDMM_GLOBAL_ALLOC@@I_K1T_LARGE_INTEGER@@H@Z @ 0x1C00AAF1C
 * Callers:
        ...
        int a8)
{
  ...
  struct _DXGKARG_BUILDPAGINGBUFFER v18; // [rsp+58h] [rbp-B0h] BYREF
  ...
  do
  {
    ...
    v16 = ADAPTER_RENDER::DdiBuildPagingBuffer(*((ADAPTER_RENDER **)this + 2), &v18);
