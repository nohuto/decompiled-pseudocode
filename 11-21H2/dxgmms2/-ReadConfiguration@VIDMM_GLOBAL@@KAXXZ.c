/*
 * XREFs of ?ReadConfiguration@VIDMM_GLOBAL@@KAXXZ @ 0x1C00B41D8
 * Callers:
...
void VIDMM_GLOBAL::ReadConfiguration(void)
{
  ...
  {
    _InterlockedAdd(&dword_1C006E830, 1u);
  ...
  *(_OWORD *)((char *)&v100[124] + 8) = 0LL;
  ...
  v9 = dword_1C006E278;
  memset(dword_1C006E278, 0, sizeof(dword_1C006E278));
  ...
  dword_1C006E388 = v29;
  dword_1C006E38C = v30;
  qword_1C006E390 = (unsigned int)(v34 << 20);
  dword_1C006E398 = v35;
  dword_1C006E39C = v36;
  dword_1C006E3A8 = v38;
  dword_1C006E3AC = v39;
  dword_1C006E3D0 = v44;
  qword_1C006E3A0 = (unsigned int)(10000000 * v37);
  qword_1C006E3B0 = (unsigned int)(10000000 * v40);
  qword_1C006E3B8 = (unsigned int)(10000000 * v41);
  qword_1C006E3C0 = (unsigned int)(10000000 * v42);
  qword_1C006E3C8 = (unsigned int)(10000000 * v43);
  VIDMM_GLOBAL::_Config = (v45 != 0 ? 0x10 : 0) | (v31 != 0 ? 2 : 0) | (VIDMM_GLOBAL::_Config ^ (v24 ^ VIDMM_GLOBAL::_Config) & 1) & 0xFFFFFFE1 | (4 * (v33 & 1 | (unsigned __int8)(2 * (v32 & 1)))) & 0xEF;
  dword_1C006E234 = v46 != 0;
  qword_1C006E240 = (unsigned __int64)v47 << 20;
  LOBYTE(v0) = v48 != 0;
  qword_1C006E400 = (unsigned int)(v49 << 10);
  dword_1C006E408 = v50;
  NumberOfBytes = v95;
  LowestAcceptableAddress = v97;
  HighestAcceptableAddress = v99;
  qword_1C006E410 = (unsigned int)(10000 * v51);
  dword_1C006E238 = v0;
  qword_1C006E5C0 = 10000000LL * v52;
