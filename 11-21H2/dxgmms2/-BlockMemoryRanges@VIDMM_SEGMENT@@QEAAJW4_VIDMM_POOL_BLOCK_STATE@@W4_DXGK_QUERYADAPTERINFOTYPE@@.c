/*
 * XREFs of ?BlockMemoryRanges@VIDMM_SEGMENT@@QEAAJW4_VIDMM_POOL_BLOCK_STATE@@W4_DXGK_QUERYADAPTERINFOTYPE@@IAEA_K@Z @ 0x1C00E9FCC
 * Callers:
        ...
        unsigned __int64 *a5)
{
  ...
  *(_QWORD *)&v23.Type = 0LL;
  ...
  if ( v15 < 0 )
  {
    WdLogSingleEntry3(1LL, v7, v15, 502LL);
LABEL_12:
  ...
  if ( v17 < 0 )
  {
    WdLogSingleEntry3(1LL, v9, v17, 512LL);
    goto LABEL_12;
  }
  LOBYTE(v18) = v9;
  ...
  if ( v19 < 0 )
  {
    WdLogSingleEntry3(1LL, v9, v19, 522LL);
    goto LABEL_12;
  }
LABEL_13:
  operator delete(v11);
