/*
 * XREFs of ?GetLargestGap@VIDMM_SEGMENT@@QEAA_KPEAU_VIDMM_GLOBAL_ALLOC@@W4_VIDMM_PLACEMENT_RESTRICTION@@E@Z @ 0x1C00EAAEC
 * Callers:
...
unsigned __int64 __fastcall VIDMM_SEGMENT::GetLargestGap(__int64 a1, __int64 a2, int a3, __int64 a4)
{
  int v4; // esi
...
LABEL_39:
  ...
  {
    WdLogNewEntry5_WdTrace(v18, v17, v10, a4);
    v17 = *(_QWORD *)(a1 + 416);
    v18 = *(_QWORD *)(a1 + 384);
  }
  return v17 - v18;
