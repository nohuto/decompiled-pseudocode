/*
 * XREFs of ?VidMmTerminateCompanionContext@VIDMM_GLOBAL@@SAXPEAUVIDMM_COMPANION_CONTEXT@@@Z @ 0x1C00DC3E8
 * Callers:
 *     VidMmTerminateCompanionContext @ 0x1C002D5B0 (VidMmTerminateCompanionContext.c)
 * Callees:
