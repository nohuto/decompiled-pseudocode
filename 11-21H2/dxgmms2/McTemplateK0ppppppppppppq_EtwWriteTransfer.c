/*
 * XREFs of McTemplateK0ppppppppppppq_EtwWriteTransfer @ 0x1C002E424
 * Callers:
 ...
 *     VidMmReportContextAllocList @ 0x1C00E1FE0 (VidMmReportContextAllocList.c)
 *     VidMmReportMultiAlloc @ 0x1C00E2100 (VidMmReportMultiAlloc.c)
 *     ?ReportState@VIDMM_PAGE_TABLE_BASE@@QEAAXPEAVCVirtualAddressAllocator@@@Z @ 0x1C00E44CC (-ReportState@VIDMM_PAGE_TABLE_BASE@@QEAAXPEAVCVirtualAddressAllocator@@@Z.c)
 * Callees:
