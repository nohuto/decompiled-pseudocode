/*
 * XREFs of VidSchiCheckNodeTimeout @ 0x1C0097B40
 * Callers:
 ...
 *     VidSchiSkipXboxNodeTimeout @ 0x1C003A8C4 (VidSchiSkipXboxNodeTimeout.c)
...
__int64 __fastcall VidSchiCheckNodeTimeout(struct _VIDSCH_NODE *a1, _QWORD *a2)
{
  ...
  __int64 v15; // rcx
  __int64 v16; // rcx
  _DXGKARG_QUERYENGINESTATUS v17; // [rsp+20h] [rbp-38h] BYREF
  ...
  if ( !VidSchiSkipXboxNodeTimeout((__int64)a1) )
  {
    if ( !*(_BYTE *)(*((_QWORD *)a1 + 3) + 44LL)
      ...
      || (v12 = *((unsigned __int16 *)a1 + 2),
          v13 = *((_QWORD *)a1 + 3),
          v17.EngineStatus.Value = 0,
          v17.EngineOrdinal = VidSchiSchedulerNodeToDriverEngine(v13, v12),
          v17.NodeOrdinal = VidSchiSchedulerNodeToDriverNode(v15, v14),
          (unsigned int)ADAPTER_RENDER::DdiQueryEngineStatus(*(ADAPTER_RENDER **)(v16 + 8), &v17))
      || (*(_BYTE *)&v17.EngineStatus.0 & 1) == 0 )
    {
