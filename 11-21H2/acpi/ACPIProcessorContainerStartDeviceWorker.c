/*
 * XREFs of ACPIProcessorContainerStartDeviceWorker @ 0x1C005E530
 * Callers:
 *     <none>
 * Callees:
...
_UNKNOWN **__fastcall ACPIProcessorContainerStartDeviceWorker(__int64 a1)
{
  ...
  if ( !AcpiProcessorContainerHierarchyLocked )
  {
    ...
    if ( v8 )
    {
      while ( !_bittest64((const signed __int64 *)(v8 + 1000), 0x27u) )
      {
        v8 = *(_QWORD *)(v8 + 792);
        if ( !v8 )
        {
...
LABEL_13:
    ...
    {
LABEL_6:
      v10 = (_QWORD *)qword_1C0080CC8;
      if ( *(__int64 **)qword_1C0080CC8 == &AcpiProcessorContainerRootList )
      {
        *v9 = &AcpiProcessorContainerRootList;
        v9[1] = v10;
        *v10 = v9;
        qword_1C0080CC8 = (__int64)v9;
        goto LABEL_13;
      }
    }
    __fastfail(3u);
