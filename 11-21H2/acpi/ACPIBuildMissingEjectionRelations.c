/*
 * XREFs of ACPIBuildMissingEjectionRelations @ 0x1C004A4D4
 * Callers:
...
__int64 ACPIBuildMissingEjectionRelations()
{
  ...
  volatile signed __int32 *v18; // [rsp+A0h] [rbp+30h] BYREF
...
LABEL_20:
        ...
        v7 = v18;
        if ( v10 < 0
          || (dword_1C0081AC8 = 0, byte_1C0081ACC = 0, FreeDataBuffs((__int64)v16, 1u), !v7)
