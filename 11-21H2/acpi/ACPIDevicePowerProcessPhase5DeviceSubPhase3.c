/*
 * XREFs of ACPIDevicePowerProcessPhase5DeviceSubPhase3 @ 0x1C00088C0
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall ACPIDevicePowerProcessPhase5DeviceSubPhase3(__int64 a1)
{
  ...
  *(_DWORD *)(a1 + 212) = v11;
  ...
  if ( !v4 )
  {
    if ( (v10 & 4) != 0 )
    {
      _InterlockedOr64((volatile signed __int64 *)(*(_QWORD *)(a1 + 40) + 1000LL), 0x80uLL);
    }
    else if ( (v10 & 8) != 0 )
    {
      _InterlockedAnd64((volatile signed __int64 *)(*(_QWORD *)(a1 + 40) + 1000LL), 0xFFFFFFFFFFFFFF7FuLL);
    }
    goto LABEL_12;
  }
  WORD1(v18) = 1;
...
LABEL_12:
  ...
  *(_QWORD *)&v19 = v13;
  if ( v13 == 1 )
    _InterlockedOr64((volatile signed __int64 *)(v14 + 1000), 0x80uLL);
  else
    _InterlockedAnd64((volatile signed __int64 *)(v14 + 1000), 0xFFFFFFFFFFFFFF7FuLL);
  *(_DWORD *)(a1 + 56) |= 0x1000000u;
  v3 = AMLIAsyncEvalObject(v4, 0, 1, (unsigned int)&v18, (__int64)ACPIDeviceCompleteGenericPhase, a1);
