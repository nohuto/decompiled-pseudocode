/*
 * XREFs of ACPIBuildWakeEventDeviceContext @ 0x1C004B2C8
 * Callers:
...
__int64 __fastcall ACPIBuildWakeEventDeviceContext(ULONG_PTR BugCheckParameter2, ULONG_PTR BugCheckParameter3)
{
  ...
  if ( *(_DWORD *)v2 >= 2u )
  {
    ...
    *(_DWORD *)(BugCheckParameter2 + 976) = *(_DWORD *)(v19 + 64);
    _InterlockedOr64((volatile signed __int64 *)(BugCheckParameter2 + 1000), 0x4000000000uLL);
    return v13;
  }
  else
  {
    ...
    if ( BugCheckParameter2 )
    {
      ...
      {
        v6 = *(void **)(BugCheckParameter2 + 608);
        if ( (v8 & 0x400000000000LL) != 0 )
          v7 = *(void **)(BugCheckParameter2 + 616);
      }
    }
    if ( WPP_RECORDER_INITIALIZED != (_UNKNOWN *)&WPP_RECORDER_INITIALIZED )
