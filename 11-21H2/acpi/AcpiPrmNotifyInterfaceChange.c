/*
 * XREFs of AcpiPrmNotifyInterfaceChange @ 0x1C00B1630
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall AcpiPrmNotifyInterfaceChange(char *NotificationStructure, PVOID Context)
{
  ...
  if ( v2 )
  {
    ...
    if ( !v4 )
    {
      ...
      {
        ExFreePoolWithTag(stru_1C0081CC0.Buffer, 0x46706341u);
  ...
  {
    v3 = AcpiAcquirePrmInterface(*((UNICODE_STRING **)NotificationStructure + 5), 1, (__int64)&unk_1C0081C88);
    if ( v3 >= 0 )
    {
