/*
 * XREFs of ACPIDevicePowerProcessPhase1DeviceSubPhase3 @ 0x1C0026570
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall ACPIDevicePowerProcessPhase1DeviceSubPhase3(__int64 a1)
{
  ...
  *(_QWORD *)(a1 + 248) = 0LL;
  if ( _bittest64((const signed __int64 *)(v1 + 8), 0x39u) )
    v4 = *(__int64 **)(*(_QWORD *)(v1 + 184) + 760LL);
  else
    v4 = *(__int64 **)(v1 + 760);
  ...
  if ( WPP_RECORDER_INITIALIZED != (_UNKNOWN *)&WPP_RECORDER_INITIALIZED )
    WPP_RECORDER_SF_qLdqss(WPP_GLOBAL_Control->DeviceExtension, (unsigned int)&WPP_RECORDER_INITIALIZED, v6, 59);
  if ( v7 != 259 )
