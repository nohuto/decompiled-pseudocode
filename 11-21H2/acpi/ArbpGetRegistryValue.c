/*
 * XREFs of ArbpGetRegistryValue @ 0x1C009E908
 * Callers:
 ...
 * Callees:
 *     RtlInitUnicodeString_0 @ 0x1C002F17D (RtlInitUnicodeString_0.c)
 *     ZwQueryValueKey_0 @ 0x1C002F243 (ZwQueryValueKey_0.c)
 */
...
__int64 __fastcall ArbpGetRegistryValue(HANDLE KeyHandle, const WCHAR *a2, _QWORD *a3)
{
  ...
  if ( !Pool2 )
    return 3221225626LL;
  v8 = ZwQueryValueKey_0(KeyHandle, &ValueName, KeyValueFullInformationAlign64, Pool2, ResultLength, &ResultLength);
  if ( v8 < 0 )
  {
