 ...
 *     ACPIWakeDeferredRestoreEnables @ 0x1C006276C (ACPIWakeDeferredRestoreEnables.c)
...
LABEL_8:
  ...
  else
  {
    ...
    {
      v26 = CurrentStackLocation->Parameters.Read.ByteOffset.LowPart;
      if ( *(_DWORD *)(v6 + 548) != v26 )
      {
        v27 = *(_DWORD *)(v6 + 368) == 3;
        *(_DWORD *)(v6 + 548) = v26;
        if ( v27 && (*(_DWORD *)(v6 + 668) & 0x300) != 0 )
        {
          LOBYTE(v8) = v26 == 1;
  ...
  {
    v25 = v24(BugCheckParameter3, Irp);
  }
  else
  {
    v25 = -1073741822;
