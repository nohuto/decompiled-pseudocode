/*
 * XREFs of ?SetBufferProperty@CLegacyRenderTargetMarshaler@DirectComposition@@UEAAJPEAVCApplicationChannel@2@IPEBX_KPEA_N@Z @ 0x1C00BE2C0
 * Callers:
 *     <none>
 * Callees:
 *     <none>
        ...
        bool *a6)
{
  ...
  *a6 = 0;
  ...
  if ( a3 == 2 )
  {
    if ( a5 == 8 && !*((_DWORD *)this + 16) && !*((_DWORD *)this + 17) )
    {
      v11 = a4->m128i_i64[0];
      *((_DWORD *)this + 4) |= 0x20u;
      *((_QWORD *)this + 8) = v11;
