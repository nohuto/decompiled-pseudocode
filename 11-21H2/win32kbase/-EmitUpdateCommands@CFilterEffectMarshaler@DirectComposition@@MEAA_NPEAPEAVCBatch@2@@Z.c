/*
 * XREFs of ?EmitUpdateCommands@CFilterEffectMarshaler@DirectComposition@@MEAA_NPEAPEAVCBatch@2@@Z @ 0x1C0215C50
 * Callers:
 *     <none>
 * Callees:
...
{
  return DirectComposition::CEffectInputSet::EmitUpdateCommands((char *)this + 80, a2, *((unsigned int *)this + 8), a2);
}
