/*
 * XREFs of ?Initialize@?$CSectionBitmapAllocator@$0CMAAA@$0CMA@@NSInstrumentation@@AEAA_NPEAE@Z @ 0x1C008D9B0
 * Callers:
...
char __fastcall NSInstrumentation::CSectionBitmapAllocator<180224,704>::Initialize(_QWORD *a1, __int64 a2)
{
  ...
  *a1 = Pool2;
  if ( !Pool2 )
    return 0;
  *Pool2 = 0LL;
  v10 = _lambda_31498f3d16e1daf3a969a045e22f9fd8_::operator()(v9, 0xDCu);
  if ( !v10 )
    return 0;
