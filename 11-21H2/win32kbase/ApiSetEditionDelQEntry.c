/*
 * XREFs of ApiSetEditionDelQEntry @ 0x1C0001AA0
 * Callers:
...
__int64 (__fastcall *__fastcall ApiSetEditionDelQEntry(__int64 a1, __int64 a2, __int64 a3))(_QWORD, _QWORD, _QWORD)
{
  ...
  result = (__int64 (__fastcall *)(_QWORD, _QWORD, _QWORD))qword_1C029D480;
  if ( qword_1C029D480 )
  {
    result = (__int64 (__fastcall *)(_QWORD, _QWORD, _QWORD))qword_1C029D480(v5, a2, a3, v7);
    if ( (int)result >= 0 )
    {
      result = qword_1C029D488;
      if ( qword_1C029D488 )
        result = (__int64 (__fastcall *)(_QWORD, _QWORD, _QWORD))qword_1C029D488(a1, v3, 1LL);
    }
  }
  if ( WPP_GLOBAL_Control == (PDEVICE_OBJECT)&WPP_GLOBAL_Control
    || (HIDWORD(WPP_GLOBAL_Control->Timer) & 0x200) == 0
