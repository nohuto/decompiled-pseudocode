/*
 * XREFs of ?xxxMKMoveAccelCursorTimer@@YAXPEAUtagWND@@I_K_J@Z @ 0x1C01BA120
 * Callers:
 *     <none>
 * Callees:
...
void __fastcall xxxMKMoveAccelCursorTimer(__int64 a1, unsigned __int8 *a2, __int64 a3, __int64 a4)
{
  ...
  if ( (v4 & 3) == 0 )
  {
    if ( (v4 & 0xC) != 0 )
    {
      v5 = 4 * (unsigned __int8)byte_1C0295962;
      goto LABEL_10;
    }
LABEL_6:
    if ( giMouseMoveTable >= (unsigned int)(unsigned __int8)gMouseCursor[0] )
    {
      v5 = (unsigned __int8)byte_1C0295962;
      giMouseMoveTable = 1;
    ...
    {
      a2 = byte_1C02958E1;
      v5 = byte_1C02958E1[giMouseMoveTable];
