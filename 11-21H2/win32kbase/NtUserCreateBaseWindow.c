/*
 * XREFs of NtUserCreateBaseWindow @ 0x1C0156F90
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall NtUserCreateBaseWindow(__int64 a1, __int64 a2, __int64 a3)
{
  ...
  BaseWindowHandle = UserCreateBaseWindowHandle(a1, v4, v3);
