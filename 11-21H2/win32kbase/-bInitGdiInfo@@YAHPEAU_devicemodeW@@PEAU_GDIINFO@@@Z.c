/*
 * XREFs of ?bInitGdiInfo@@YAHPEAU_devicemodeW@@PEAU_GDIINFO@@@Z @ 0x1C0088958
 * Callers:
...
__int64 __fastcall bInitGdiInfo(struct _devicemodeW *a1, struct _GDIINFO *a2)
{
  ...
  {
    v4 = 0LL;
    v5 = (__int16 *)&unk_1C0253522;
    while ( a1->dmPelsWidth != *(v5 - 1)
         || a1->dmPelsHeight != *v5
         || a1->dmBitsPerPel != 32
  ...
  a2->ulNumColors = -1;
  v6 = *((__int16 *)&unk_1C0253520 + 2 * v4);
  a2->ulPanningHorzRes = v6;
  a2->ulHorzRes = v6;
  v7 = *((__int16 *)&unk_1C0253520 + 2 * v4 + 1);
