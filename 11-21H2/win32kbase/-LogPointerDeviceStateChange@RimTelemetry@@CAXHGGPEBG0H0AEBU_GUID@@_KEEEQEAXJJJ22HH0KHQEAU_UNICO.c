/*
 * XREFs of ?LogPointerDeviceStateChange@RimTelemetry@@CAXHGGPEBG0H0AEBU_GUID@@_KEEEQEAXJJJ22HH0KHQEAU_UNICODE_STRING@@400AEBUtagRECT@@5@Z @ 0x1C017C284
 * Callers:
        ...
        const struct tagRECT *a29)
{
  ...
  if ( a1 )
  {
    if ( (unsigned int)dword_1C028D610 > 5 && tlgKeywordOn((__int64)&dword_1C028D610, 0x800000000000LL) )
    {
      v50 = 2048LL;
      v63 = (__int64)v30;
      v37 = v29;
  ...
  else if ( (unsigned int)dword_1C028D610 > 5 && tlgKeywordOn((__int64)&dword_1C028D610, 0x800000000000LL) )
  {
    v63 = 2048LL;
    v50 = (__int64)v33;
    v38[0] = v32;
