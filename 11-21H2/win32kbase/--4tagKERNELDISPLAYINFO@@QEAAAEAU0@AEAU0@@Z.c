/*
 * XREFs of ??4tagKERNELDISPLAYINFO@@QEAAAEAU0@AEAU0@@Z @ 0x1C01521EC
 * Callers:
...
__int64 __fastcall tagKERNELDISPLAYINFO::operator=(__int64 a1)
{
  ...
  *(_DWORD *)(v5 + 132) ^= (*((_DWORD *)v4 + 33) ^ v6) & 1;
  *(_DWORD *)(v5 + 132) ^= ((unsigned __int8)*(_DWORD *)(v5 + 132) ^ (unsigned __int8)*((_DWORD *)v4 + 33)) & 2;
