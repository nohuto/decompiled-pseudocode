/*
 * XREFs of ?Allocate@?$CTypeIsolation@$0BFAAA@$0BFA@@NSInstrumentation@@IEAAPEAXXZ @ 0x1C008C910
 * Callers:
 *     ?HMAllocateIsolatedType@@YAPEAXE@Z @ 0x1C0030E00 (-HMAllocateIsolatedType@@YAPEAXE@Z.c)
 * Callees:
 *     ?Allocate@?$CSectionBitmapAllocator@$0BFAAA@$0BFA@@NSInstrumentation@@QEAAPEAXXZ @ 0x1C008CA60 (-Allocate@-$CSectionBitmapAllocator@$0BFAAA@$0BFA@@NSInstrumentation@@QEAAPEAXXZ.c)
 *     ?Create@?$CSectionEntry@$0BFAAA@$0BFA@@NSInstrumentation@@SAPEAV12@XZ @ 0x1C008D040 (-Create@-$CSectionEntry@$0BFAAA@$0BFA@@NSInstrumentation@@SAPEAV12@XZ.c)
...
PSLIST_ENTRY __fastcall NSInstrumentation::CTypeIsolation<86016,336>::Allocate(__int64 a1)
{
  ...
  else
  {
    ...
    ExReleasePushLockSharedEx(v2, 0LL);
    KeLeaveCriticalRegion();
    v7 = NSInstrumentation::CSectionEntry<86016,336>::Create();
    v8 = (_QWORD *)v7;
    if ( v7 )
    {
      v3 = NSInstrumentation::CSectionBitmapAllocator<86016,336>::Allocate(*(_QWORD *)(v7 + 32));
      if ( v3 )
      {
        v9 = *(_QWORD *)(a1 + 16);
        KeEnterCriticalRegion();
