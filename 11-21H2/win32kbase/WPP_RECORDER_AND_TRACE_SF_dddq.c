/*
 * XREFs of WPP_RECORDER_AND_TRACE_SF_dddq @ 0x1C01B2E94
 * Callers:
...
__int64 WPP_RECORDER_AND_TRACE_SF_dddq(__int64 a1, char a2, char a3, __int64 a4, int a5, int a6, int a7, int a8, ...)
{
  ...
  if ( a2 )
    result = ((__int64 (__fastcall *)(__int64, __int64, void *, __int64, __int64 *, __int64, __int64 *, __int64, __int64 *, __int64, char *, __int64, _QWORD))pfnWppTraceMessage)(
               a1,
               43LL,
               &WPP_43d878ddf4c53d03f90242c2d3f0d36e_Traceguids,
               41LL,
               (__int64 *)va,
               4LL,
               (__int64 *)va1,
