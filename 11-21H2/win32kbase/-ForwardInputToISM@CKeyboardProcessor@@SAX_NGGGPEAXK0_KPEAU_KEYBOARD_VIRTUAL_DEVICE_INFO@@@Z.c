/*
 * XREFs of ?ForwardInputToISM@CKeyboardProcessor@@SAX_NGGGPEAXK0_KPEAU_KEYBOARD_VIRTUAL_DEVICE_INFO@@@Z @ 0x1C003ED50
 * Callers:
 *     <none>
 * Callees:
        ...
        struct _KEYBOARD_VIRTUAL_DEVICE_INFO *a9)
{
  ...
  InputExtensibilityCallout::CoreMsgSendMessage(v13, 9);
}
