/*
 * XREFs of McTemplateK0pxxttq_EtwWriteTransfer @ 0x1C01508F8
 * Callers:
 *     EtwTraceFlipManagerContentRebind @ 0x1C014D100 (EtwTraceFlipManagerContentRebind.c)
 * Callees:
 *     McGenEventWrite_EtwWriteTransfer @ 0x1C0047300 (McGenEventWrite_EtwWriteTransfer.c)
 *     __security_check_cookie @ 0x1C00D59D0 (__security_check_cookie.c)
 */

NTSTATUS McTemplateK0pxxttq_EtwWriteTransfer(__int64 a1, __int64 a2, __int64 a3, ...)
{
  ...
  v14 = 4LL;
  v16 = 4LL;
  return McGenEventWrite_EtwWriteTransfer(a1, &FlipManagerContentRebind, &W32kControlGuid, 7u, &v4);
}
