/*
 * XREFs of ApiSetEditionHandleMoveSizeDataOnDestroyMonitor @ 0x1C0050738
 * Callers:
...
__int64 (*__fastcall ApiSetEditionHandleMoveSizeDataOnDestroyMonitor(__int64 a1))(void)
{
  ...
  result = qword_1C029CE48;
  if ( qword_1C029CE48 )
  {
    result = (__int64 (*)(void))qword_1C029CE48();
    if ( (int)result >= 0 )
    {
      result = (__int64 (*)(void))qword_1C029CE50;
      if ( qword_1C029CE50 )
        result = (__int64 (*)(void))qword_1C029CE50(a1);
    }
  }
  if ( WPP_GLOBAL_Control == (PDEVICE_OBJECT)&WPP_GLOBAL_Control
    || (HIDWORD(WPP_GLOBAL_Control->Timer) & 0x200) == 0
