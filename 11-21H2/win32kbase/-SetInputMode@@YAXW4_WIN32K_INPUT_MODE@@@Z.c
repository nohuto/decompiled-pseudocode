/*
 * XREFs of ?SetInputMode@@YAXW4_WIN32K_INPUT_MODE@@@Z @ 0x1C0146EB0
 * Callers:
...
void __fastcall SetInputMode(__int64 a1, __int64 a2, __int64 a3)
{
  ...
  __int64 v20; // r8
  __int64 v21; // r9
  BOOL v22; // [rsp+30h] [rbp-89h] BYREF
  __int64 v23; // [rsp+38h] [rbp-81h] BYREF
  int v24; // [rsp+40h] [rbp-79h]
  GUID ActivityId; // [rsp+44h] [rbp-75h] BYREF
  struct _EVENT_DATA_DESCRIPTOR v26; // [rsp+58h] [rbp-61h] BYREF
  BOOL *v27; // [rsp+78h] [rbp-41h]
  __int64 v28; // [rsp+80h] [rbp-39h]
  struct _EVENT_DATA_DESCRIPTOR v29; // [rsp+88h] [rbp-31h] BYREF
  BOOL *v30; // [rsp+A8h] [rbp-11h]
  __int64 v31; // [rsp+B0h] [rbp-9h]
  struct _EVENT_DATA_DESCRIPTOR v32; // [rsp+B8h] [rbp-1h] BYREF
  BOOL *v33; // [rsp+D8h] [rbp+1Fh]
  ...
  if ( v8 )
  {
    ...
    if ( v23 )
    {
      v10 = *(unsigned int *)(v23 + 24);
      if ( *(_DWORD *)(v23 + 48) || (int)v10 > 0 )
      {
        *(_DWORD *)(v23 + 44) = 1;
