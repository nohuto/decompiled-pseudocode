/*
 * XREFs of Win32AllocPoolNonPagedZInit @ 0x1C005F140
 * Callers:
...
__int64 __fastcall Win32AllocPoolNonPagedZInit(unsigned __int64 a1, int a2)
{
  PVOID v2; // rsi
  __int64 v3; // rbx
  __int64 v5; // rax
  ...
  if ( (a2 & *((_DWORD *)gpLeakTrackingAllocator + 10)) != a2 )
    return ExAllocatePool2(68LL, a1);
  v3 = 0LL;
  v5 = 0LL;
