/*
 * XREFs of ApiSetPointerPromotionOnPointerInputRetrieval @ 0x1C020E9E4
 * Callers:
        ...
        unsigned int a4)
{
  ...
  if ( qword_1C029D340 && (int)qword_1C029D340(v8, a2, a3, v10) >= 0 && qword_1C029D348 )
    qword_1C029D348(a1, v6, v5, a4);
