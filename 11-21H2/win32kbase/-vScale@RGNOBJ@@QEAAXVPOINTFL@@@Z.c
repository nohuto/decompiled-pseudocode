/*
 * XREFs of ?vScale@RGNOBJ@@QEAAXVPOINTFL@@@Z @ 0x1C016B330
 * Callers:
  ...
  if ( v4 > 1 )
  {
    ...
    do
    {
      for ( i = 0LL; (unsigned int)i < *v5; i = (unsigned int)(i + 1) )
        bFToL((float)(int)v5[i + 3] * *(float *)&v10, &v5[i + 3], v6);
      v8 = v5[1];
      if ( v8 != 0x80000000 )
        bFToL((float)v8 * *((float *)&v10 + 1), v5 + 1, v6);
      v9 = v5[2];
      if ( v9 != 0x7FFFFFFF )
        bFToL((float)v9 * *((float *)&v10 + 1), v5 + 2, v6);
      v5 = (_DWORD *)((char *)v5 + (unsigned int)(4 * *v5 + 16));
      --v4;
    }
    while ( v4 );
    v11 = *(_OWORD *)(*a1 + 96);
    ERECTL::vScale((ERECTL *)&v11, (const struct POINTFL *)&v10);
    *(_OWORD *)(*a1 + 96) = v11;
  }
}
