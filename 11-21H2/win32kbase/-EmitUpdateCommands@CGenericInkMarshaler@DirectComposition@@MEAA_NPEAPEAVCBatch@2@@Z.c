/*
 * XREFs of ?EmitUpdateCommands@CGenericInkMarshaler@DirectComposition@@MEAA_NPEAPEAVCBatch@2@@Z @ 0x1C02190E0
 * Callers:
 *     <none>
 * Callees:
 *     ?EnsureBatchBuffer@CBatch@DirectComposition@@SA_NPEAPEAV12@_KPEAPEAX@Z @ 0x1C0011E08 (-EnsureBatchBuffer@CBatch@DirectComposition@@SA_NPEAPEAV12@_KPEAPEAX@Z.c)
 *     memmove @ 0x1C00DE8C0 (memmove.c)
 *     DirectComposition::CResourceMarshaler::EmitUpdateCommand__lambda_04ae90407365c29ae4b2e1045aef8826___ @ 0x1C0218CB0 (DirectComposition--CResourceMarshaler--EmitUpdateCommand__lambda_04ae90407365c29ae4b2e1045aef882.c)
 ...
 *     DirectComposition::CResourceMarshaler::EmitUpdateCommand__lambda_e21701afca32d27cc571de8dc6065791___ @ 0x1C0218DBC (DirectComposition--CResourceMarshaler--EmitUpdateCommand__lambda_e21701afca32d27cc571de8dc606579.c)
        ...
        struct DirectComposition::CBatch ***a2)
{
  ...
  if ( (*((_DWORD *)this + 4) & 0x20) == 0 )
  {
    ...
    *(_QWORD *)(v6 + 1) = 0LL;
    v6[1] = 148;
    v6[2] = *((_DWORD *)this + 8);
    memmove(v6 + 3, *((const void **)this + 8), *((_QWORD *)this + 11) * *((_QWORD *)this + 12));
    *((_DWORD *)this + 4) |= 0x20u;
  }
