/*
 * XREFs of ?SetResourceFloatProperty@CApplicationChannel@DirectComposition@@QEAAJIIM@Z @ 0x1C0085AF0
 * Callers:
        ...
        float a4)
{
  ...
  if ( a2
    && v5 < *((_QWORD *)this + 10)
    && (_mm_lfence(),
        (v7 = *(struct DirectComposition::CResourceMarshaler **)(v5 * *((_QWORD *)this + 11) + *((_QWORD *)this + 7))) != 0LL) )
  {
