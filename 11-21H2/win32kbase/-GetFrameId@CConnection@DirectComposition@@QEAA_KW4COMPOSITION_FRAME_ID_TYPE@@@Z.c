/*
 * XREFs of ?GetFrameId@CConnection@DirectComposition@@QEAA_KW4COMPOSITION_FRAME_ID_TYPE@@@Z @ 0x1C0080AF4
 * Callers:
...
__int64 __fastcall DirectComposition::CConnection::GetFrameId(_QWORD *a1, int a2)
{
  ...
  v2 = (DirectComposition::CPushLockCriticalSection *)(a1 + 41);
  v5 = 0LL;
  ExAcquirePushLockSharedEx(a1 + 41, 0LL);
  *((_BYTE *)v2 + 8) = 0;
  if ( a2 )
  {
    v6 = a2 - 1;
