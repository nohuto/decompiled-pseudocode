/*
 * XREFs of ?DrvCollectColorProfileForUser@@YAJPEAU_D3DKMT_ESCAPE_WIN32K_COLOR_PROFILE@@I@Z @ 0x1C00B69D8
 * Callers:
...
NTSTATUS __fastcall DrvCollectColorProfileForUser(char *Sid, int a2)
{
  ...
  if ( (!qword_1C029AF38 || !(unsigned int)qword_1C029AF38(Sid)) && !gbOSTestSigningEnabled )
    return -1073741790;
