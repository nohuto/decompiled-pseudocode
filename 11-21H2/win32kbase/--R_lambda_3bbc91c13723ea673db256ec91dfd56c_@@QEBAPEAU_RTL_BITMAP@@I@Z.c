/*
 * XREFs of ??R_lambda_3bbc91c13723ea673db256ec91dfd56c_@@QEBAPEAU_RTL_BITMAP@@I@Z @ 0x1C00D98F0
 * Callers:
...
struct _RTL_BITMAP *__fastcall _lambda_3bbc91c13723ea673db256ec91dfd56c_::operator()(__int64 a1, unsigned int a2)
{
  __int64 v2; // rax
  ULONG v3; // edi
