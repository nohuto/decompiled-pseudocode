/*
 * XREFs of ?EmitInjections@CManipulationMarshaler@DirectComposition@@IEAA_NPEAPEAVCBatch@2@@Z @ 0x1C021A5E8
 * Callers:
    ...
    *(_OWORD *)(v4 + 124) = v5[7];
    ...
    if ( !v7 )
    {
      do
      {
        ...
        *(_QWORD *)(*((_QWORD *)this + 17) + 8 * v8) = *(_QWORD *)(*((_QWORD *)this + 17) + 8 * v9);
        v8 = v9;
      }
      while ( (unsigned int)v9 < *((_DWORD *)this + 36) );
    }
    if ( !*((_DWORD *)this + 36) )
      return 1;
  }
