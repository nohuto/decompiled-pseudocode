/*
 * XREFs of ?EmitSetSources@CExpressionMarshaler@DirectComposition@@AEAA_NPEAPEAVCBatch@2@@Z @ 0x1C000FA74
 * Callers:
        ...
        struct DirectComposition::CBatch ***a2)
{
  ...
  for ( ; *((_DWORD *)this + 53) < *((_DWORD *)this + 52); *((_DWORD *)this + 53) += v5 )
  {
    ...
    if ( (unsigned __int64)v4 < 0x18 )
    {
      if ( !DirectComposition::CBatch::AllocateNewFragment(a2, (unsigned __int64 *)&v12) )
        return *((_DWORD *)this + 53) == *((_DWORD *)this + 52);
      v4 = v12;
    }
    v5 = (unsigned int)(*((_DWORD *)this + 52) - *((_DWORD *)this + 53));
    ...
    *((_DWORD *)v6 + 3) = v5;
    for ( *((_DWORD *)v6 + 4) = *((_DWORD *)this + 52); v7 < (unsigned int)v5; ++v8 )
    {
      v9 = 0;
      v10 = *(_QWORD *)(*(_QWORD *)(*((_QWORD *)this + 25) + 8LL * (v7 + *((_DWORD *)this + 53))) + 16LL);
      if ( v10 )
        v9 = *(_DWORD *)(v10 + 32);
      *v8 = v9;
      ++v7;
