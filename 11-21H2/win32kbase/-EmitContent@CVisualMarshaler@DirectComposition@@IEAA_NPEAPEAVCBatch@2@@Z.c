/*
 * XREFs of ?EmitContent@CVisualMarshaler@DirectComposition@@IEAA_NPEAPEAVCBatch@2@@Z @ 0x1C001164C
 * Callers:
...
char __fastcall DirectComposition::CVisualMarshaler::EmitContent(
