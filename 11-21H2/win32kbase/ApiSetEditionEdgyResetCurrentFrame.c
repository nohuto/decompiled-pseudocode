/*
 * XREFs of ApiSetEditionEdgyResetCurrentFrame @ 0x1C020731C
 * Callers:
...
__int64 (*ApiSetEditionEdgyResetCurrentFrame())(void)
{
  char v0; // bl
  char v1; // dl
  char v2; // r8
  ...
  result = qword_1C029D4C0;
  if ( qword_1C029D4C0 )
  {
    result = (__int64 (*)(void))qword_1C029D4C0();
    if ( (int)result >= 0 )
    {
      result = qword_1C029D4C8;
      if ( qword_1C029D4C8 )
        result = (__int64 (*)(void))qword_1C029D4C8();
    }
  }
  if ( WPP_GLOBAL_Control == (PDEVICE_OBJECT)&WPP_GLOBAL_Control
    || (HIDWORD(WPP_GLOBAL_Control->Timer) & 0x200) == 0
