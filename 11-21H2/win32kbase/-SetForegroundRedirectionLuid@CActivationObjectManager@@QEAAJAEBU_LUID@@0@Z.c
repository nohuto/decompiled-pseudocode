/*
 * XREFs of ?SetForegroundRedirectionLuid@CActivationObjectManager@@QEAAJAEBU_LUID@@0@Z @ 0x1C0142DB0
 * Callers:
...
{
  CActivationObjectManager *v3; // r13
  unsigned int v6; // esi
  __int64 v7; // rcx
  ...
  if ( ActivationObjectFromLuid )
  {
    ...
    if ( *a3 )
    {
      v10 = CActivationObjectManager::GetActivationObjectFromLuid(v3, a3);
      if ( v10 )
      {
        memset(v12, 0, 20);
        ...
        *(struct _LUID *)((char *)ActivationObjectFromLuid + 60) = *a3;
        ...
        if ( (*((_DWORD *)ActivationObjectFromLuid + 14) & 4) != 0 && (*((_BYTE *)v10 + 56) & 1) != 0 )
          CActivationObjectManager::SetForeground(v3, (__int64)v10, 0, 0, (__int64)v16);
      }
      else
      {
        v6 = -1073741811;
