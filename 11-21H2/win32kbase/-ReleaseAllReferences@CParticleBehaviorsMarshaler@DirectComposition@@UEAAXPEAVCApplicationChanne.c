/*
 * XREFs of ?ReleaseAllReferences@CParticleBehaviorsMarshaler@DirectComposition@@UEAAXPEAVCApplicationChannel@2@@Z @ 0x1C0225AB0
 * Callers:
 *     <none>
 * Callees:
        ...
        struct DirectComposition::CApplicationChannel *a2)
{
  ...
  v13 = (struct DirectComposition::CResourceMarshaler *)*((_QWORD *)this + 17);
  if ( v13 )
  {
    DirectComposition::CApplicationChannel::ReleaseResource(a2, v13);
    *((_QWORD *)this + 17) = 0LL;
  }
  v14 = (struct DirectComposition::CResourceMarshaler *)*((_QWORD *)this + 18);
  if ( v14 )
  {
