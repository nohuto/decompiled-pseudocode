/*
 * XREFs of ApiSetEditionEndDeferWinEventNotify @ 0x1C00996B0
 * Callers:
...
__int64 (*ApiSetEditionEndDeferWinEventNotify())(void)
{
  ...
  result = qword_1C029CE70;
  if ( qword_1C029CE70 )
  {
    result = (__int64 (*)(void))qword_1C029CE70();
    if ( (int)result >= 0 )
    {
      result = qword_1C029CE78;
      if ( qword_1C029CE78 )
        result = (__int64 (*)(void))qword_1C029CE78();
    }
  }
  if ( WPP_GLOBAL_Control == (PDEVICE_OBJECT)&WPP_GLOBAL_Control
    || (HIDWORD(WPP_GLOBAL_Control->Timer) & 0x200) == 0
