/*
 * XREFs of ??$UpdateProperty@U_D3DCOLORVALUE@@@CPropertySetMarshaler@DirectComposition@@AEAAJAEBUPropertySetValue@@PEBU_D3DCOLORVALUE@@@Z @ 0x1C000E72C
 * Callers:
        ...
        _OWORD *a3)
{
  ...
  v4 = 0;
  v5 = *a2;
  if ( (unsigned int)v5 < *(_DWORD *)(a1 + 88)
    && (v7 = a1 + 80,
