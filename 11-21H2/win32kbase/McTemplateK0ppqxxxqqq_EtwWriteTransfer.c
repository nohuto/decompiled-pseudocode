/*
 * XREFs of McTemplateK0ppqxxxqqq_EtwWriteTransfer @ 0x1C00E59DA
 * Callers:
 *     EtwTraceTokenCompositionSurfaceObjectEvent @ 0x1C00AF730 (EtwTraceTokenCompositionSurfaceObjectEvent.c)
 * Callees:
