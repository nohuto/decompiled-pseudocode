/*
 * XREFs of ApiSetEditionInitSystemCharsetInfoForLayout @ 0x1C005139C
 * Callers:
...
__int64 __fastcall ApiSetEditionInitSystemCharsetInfoForLayout(__int64 a1, __int64 a2, __int64 a3)
{
  ...
  if ( qword_1C029D050 && (int)qword_1C029D050(v6, a2, a3, v8) >= 0 && qword_1C029D058 )
    v4 = qword_1C029D058(a1, v3);
  if ( WPP_GLOBAL_Control == (PDEVICE_OBJECT)&WPP_GLOBAL_Control
    || (HIDWORD(WPP_GLOBAL_Control->Timer) & 0x200) == 0
    || (LOBYTE(a2) = 1, BYTE1(WPP_GLOBAL_Control->Timer) < 5u) )
  {
