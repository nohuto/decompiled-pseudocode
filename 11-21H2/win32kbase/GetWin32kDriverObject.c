/*
 * XREFs of GetWin32kDriverObject @ 0x1C005C0C0
 * Callers:
...
__int64 GetWin32kDriverObject()
{
  ...
  dword_1C02957D0 = (MEMORY[0xFFFFF78000000320] * (unsigned __int64)MEMORY[0xFFFFF78000000004]) >> 24;
  result = ObReferenceObjectByName(&DestinationString, 64LL, 0LL);
  dword_1C02957D4 = (MEMORY[0xFFFFF78000000320] * (unsigned __int64)MEMORY[0xFFFFF78000000004]) >> 24;
  if ( (int)result < 0 )
    return 0LL;
  return result;
}
