/*
 * XREFs of ?Uninitialize@?$CSharedStorage@VCBackTraceBucket@NSInstrumentation@@$$CCJVCBackTraceStorageUnit@2@VCBackTrace@2@@NSInstrumentation@@QEAAXXZ @ 0x1C017BB94
 * Callers:
 ...
 * Callees:
 *     ??1CBackTraceBucket@NSInstrumentation@@QEAA@XZ @ 0x1C017B42C (--1CBackTraceBucket@NSInstrumentation@@QEAA@XZ.c)
 */
