/*
 * XREFs of ?CitpInteractionSummaryGetOutstanding@@YAPEAU_CIT_INTERACTION_SUMMARY@@PEAU_CIT_PROCESS@@G@Z @ 0x1C023FC5C
 * Callers:
...
struct _CIT_INTERACTION_SUMMARY *__fastcall CitpInteractionSummaryGetOutstanding(struct _CIT_PROCESS *a1)
{
  ...
  if ( (xmmword_1C029A214 & 2) != 0 )
  {
    ...
    if ( (unsigned int)v3 >= *((_DWORD *)xmmword_1C029A230 + 14) )
      return 0LL;
    v4 = *(_QWORD *)xmmword_1C029A230 + 96 * v3;
    if ( *(_WORD *)(v4 + 32) != v2 || *(_QWORD *)(v4 + 56) != *((_QWORD *)a1 + 8) )
      return 0LL;
