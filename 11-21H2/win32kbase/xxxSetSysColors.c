/*
 * XREFs of xxxSetSysColors @ 0x1C0062954
 * Callers:
...
__int64 __fastcall xxxSetSysColors(__int64 a1, unsigned int a2, char *a3, char *a4, unsigned int a5)
{
  ...
  if ( (a5 & 1) != 0
    && qword_1C029C7E8
    && (int)qword_1C029C7E8() >= 0
    && (!qword_1C029C7F0 || !(unsigned int)qword_1C029C7F0(16LL)) )
  {
    return 0LL;
  }
  ...
  if ( (v5 & 1) != 0 )
  {
    if ( qword_1C029C7F8 && (int)qword_1C029C7F8() >= 0 && qword_1C029C800 )
      qword_1C029C800();
    if ( (int)IsCreateBitmapStripSupported() >= 0 && qword_1C029C8A0 )
      qword_1C029C8A0();
    if ( qword_1C029C808 && (int)qword_1C029C808() >= 0 && qword_1C029C810 )
      qword_1C029C810(-1LL, 21LL, 0LL);
    if ( qword_1C029C818 && (int)qword_1C029C818() >= 0 )
    {
      ...
      if ( v17 )
        ...
        v18 = 0LL;
      if ( qword_1C029C820 )
        qword_1C029C820(v18, 1LL, 66693LL);
      if ( *((struct tagDESKTOP **)gptiCurrent + 57) != grpdeskRitInput )
      {
        ...
        if ( (*(_DWORD *)(*v19 + 64LL) & 1) == 0 )
        {
          ...
          {
            if ( qword_1C029C820 )
              qword_1C029C820(v20, 1LL, 66693LL);
          }
        }
      }
    }
