/*
 * XREFs of ?TPAAPSetCurtainState@CPTPEngine@@AEAAXH@Z @ 0x1C0204350
 * Callers:
 ...
 *     ?ProcessInitialization@CPTPEngine@@MEAAJXZ @ 0x1C0202310 (-ProcessInitialization@CPTPEngine@@MEAAJXZ.c)
