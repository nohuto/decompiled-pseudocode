/*
 * XREFs of ApiSetEditionIsCompositeAppOrSelfDisabled @ 0x1C0208830
 * Callers:
...
__int64 __fastcall ApiSetEditionIsCompositeAppOrSelfDisabled(__int64 a1, __int64 a2, __int64 a3)
{
  ...
  if ( qword_1C029CE08 && (int)qword_1C029CE08(v5, a2, a3, v7) >= 0 && qword_1C029CE10 )
    v4 = qword_1C029CE10(a1);
  if ( WPP_GLOBAL_Control == (PDEVICE_OBJECT)&WPP_GLOBAL_Control
    || (HIDWORD(WPP_GLOBAL_Control->Timer) & 0x200) == 0
    || (LOBYTE(a2) = 1, BYTE1(WPP_GLOBAL_Control->Timer) < 5u) )
  {
