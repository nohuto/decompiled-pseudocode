/*
 * XREFs of ?SetResourceCallbackId@CApplicationChannel@DirectComposition@@QEAAJII@Z @ 0x1C0085B98
 * Callers:
        ...
        unsigned int a3)
{
  ...
  if ( a2
    && v4 < *((_QWORD *)this + 10)
    && (_mm_lfence(),
        (v5 = *(struct DirectComposition::CResourceMarshaler **)(v4 * *((_QWORD *)this + 11) + *((_QWORD *)this + 7))) != 0LL) )
  {
