/*
 * XREFs of ?IVPopulateDeviceUIPIInfo@@YAXAEBURawInputManagerDeviceObject@@PEAU_IV_UIPI_INFO_INT@@@Z @ 0x1C01ECAAC
 * Callers:
...
void __fastcall IVPopulateDeviceUIPIInfo(const struct RawInputManagerDeviceObject *a1, struct _IV_UIPI_INFO_INT *a2)
{
  ...
  *((_DWORD *)a2 + 1) = *((_DWORD *)a1 + 121);
  *((_DWORD *)a2 + 2) = *((_DWORD *)a1 + 122);
  if ( (*((_DWORD *)a1 + 68) & 0x2000) != 0 && (*((_DWORD *)a1 + 72) & 4) == 0 )
  {
    v3 = 0;
