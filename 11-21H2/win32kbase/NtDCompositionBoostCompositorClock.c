/*
 * XREFs of NtDCompositionBoostCompositorClock @ 0x1C02111C0
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall NtDCompositionBoostCompositorClock(__int64 a1, __int64 a2, __int64 a3, __int64 a4)
{
  int v4; // r14d
  unsigned int v5; // edi
  __int64 v6; // rdx
...
LABEL_8:
      *((_DWORD *)v11 + 13) = v15;
      if ( v14 )
        v5 = DirectComposition::CConnection::BoostCompositorClock(DefaultConnection, v4);
      goto LABEL_11;
    }
    v5 = -1073741823;
LABEL_11:
