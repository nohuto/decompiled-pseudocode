/*
 * XREFs of ApiSetEditionGetCompositionInputWindowUIOwner @ 0x1C0207CD0
 * Callers:
...
__int64 __fastcall ApiSetEditionGetCompositionInputWindowUIOwner(__int64 a1, __int64 a2, __int64 a3)
{
  ...
  if ( qword_1C029CF70 && (int)qword_1C029CF70(v5, a2, a3, v7) >= 0 && qword_1C029CF78 )
    v4 = qword_1C029CF78(a1);
  if ( WPP_GLOBAL_Control == (PDEVICE_OBJECT)&WPP_GLOBAL_Control
    || (HIDWORD(WPP_GLOBAL_Control->Timer) & 0x200) == 0
    || (LOBYTE(a2) = 1, BYTE1(WPP_GLOBAL_Control->Timer) < 5u) )
  {
