/*
 * XREFs of _woutput_l @ 0x1C00D6EA0
 * Callers:
 ...
 *     write_multi_char_0 @ 0x1C00D7844 (write_multi_char_0.c)
 *     write_string_0 @ 0x1C00D789C (write_string_0.c)
 *     _get_printf_count_output @ 0x1C00D79B4 (_get_printf_count_output.c)
...
LABEL_116:
                        v35 = v57 - v12 - v34;
                        if ( (v5 & 0xC) == 0 )
                          write_multi_char_0(32LL, v35, v9, &v49);
                        write_string_0(v56, v34, v58, &v49);
                        v36 = v58;
                        if ( (v5 & 0xC) == 8 )
                          write_multi_char_0(48LL, v35, v58, &v49);
                        if ( !v54 && (int)v12 > 0 )
                        {
                          v37 = (const char *)v7;
                          v38 = v12;
                          ...
                          {
                            --v38;
                            v39 = mbtowc(v53, v37, _mb_cur_max);
                            v40 = v39;
                            if ( v39 == 2 )
                            {
                              --v38;
                        ...
                        write_string_0(v7, (unsigned int)v12, v36, &v49);
LABEL_130:
                        v11 = v49;
LABEL_131:
                        if ( v11 < 0 || (v5 & 4) == 0 )
...
LABEL_142:
                        ...
                        write_multi_char_0(32LL, v35, v36, &v49);
                        v6 = v51;
                        goto LABEL_134;
                      }
                      if ( (v5 & 2) != 0 )
...
LABEL_44:
                  ...
                  if ( (v5 & 0x20) != 0 )
                  {
                    SrcCh[0] = v20;
                    SrcCh[1] = 0;
                    v21 = mbtowc(DstCh, SrcCh, _mb_cur_max);
                    v9 = v58;
                    if ( v21 < 0 )
                      v60 = 1;
                  }
