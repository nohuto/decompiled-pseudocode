/*
 * XREFs of ApiSetValidateDeviceSignature @ 0x1C020FF00
 * Callers:
        ...
        int a7)
{
  ...
  v14 = -1073741637;
  if ( qword_1C029CBD8 && (int)qword_1C029CBD8(v11, a2, a3, v13) >= 0 )
  {
    v15 = *a6;
    v18 = *((_DWORD *)a6 + 2);
    v17 = v15;
    v14 = ValidateDeviceSignature(a1, v9, v8, a4, a5, (__int64)&v17, a7);
  }
  if ( WPP_GLOBAL_Control == (PDEVICE_OBJECT)&WPP_GLOBAL_Control
    || (HIDWORD(WPP_GLOBAL_Control->Timer) & 0x200) == 0
    || (LOBYTE(a2) = 1, BYTE1(WPP_GLOBAL_Control->Timer) < 5u) )
