/*
 * XREFs of ?CopyMouseInputToHoldingBuffer@MouseRateLimitHoldingFrame@CMouseSensor@@QEAA_NPEAU_MOUSE_INPUT_DATA@@K_J@Z @ 0x1C00E91E6
 * Callers:
        ...
        __int64 a4)
{
  ...
  if ( (unsigned int)v8 > 0x10 )
    MicrosoftTelemetryAssertTriggeredNoArgsKM(this, v8, a3);
  v9 = *((_WORD *)this + 204);
  v10 = 0;
  if ( a2 )
  {
