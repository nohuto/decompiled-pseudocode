/*
 * XREFs of ApiSetEditionIsPointerInputRedirected @ 0x1C0208C3C
 * Callers:
...
__int64 __fastcall ApiSetEditionIsPointerInputRedirected(__int64 a1, __int64 a2, __int64 a3)
{
  ...
  if ( qword_1C029D2C0 && (int)qword_1C029D2C0(v7, a2, a3, v9) >= 0 && qword_1C029D2C8 )
    v4 = qword_1C029D2C8(a1, v5, v3);
  if ( WPP_GLOBAL_Control == (PDEVICE_OBJECT)&WPP_GLOBAL_Control
    || (HIDWORD(WPP_GLOBAL_Control->Timer) & 0x200) == 0
    || (LOBYTE(a2) = 1, BYTE1(WPP_GLOBAL_Control->Timer) < 5u) )
  {
