/*
 * XREFs of ApiSetEditionInitializeMoveSizeList @ 0x1C005B424
 * Callers:
...
__int64 (*ApiSetEditionInitializeMoveSizeList())(void)
{
  ...
  result = qword_1C029CE38;
  if ( qword_1C029CE38 )
  {
    result = (__int64 (*)(void))qword_1C029CE38();
    if ( (int)result >= 0 )
    {
      result = qword_1C029CE40;
      if ( qword_1C029CE40 )
        result = (__int64 (*)(void))qword_1C029CE40();
    }
  }
  if ( WPP_GLOBAL_Control == (PDEVICE_OBJECT)&WPP_GLOBAL_Control
    || (HIDWORD(WPP_GLOBAL_Control->Timer) & 0x200) == 0
