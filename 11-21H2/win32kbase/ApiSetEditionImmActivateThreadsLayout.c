/*
 * XREFs of ApiSetEditionImmActivateThreadsLayout @ 0x1C0208408
 * Callers:
...
__int64 __fastcall ApiSetEditionImmActivateThreadsLayout(__int64 a1, __int64 a2, __int64 a3)
{
  ...
  if ( qword_1C029D080 && (int)qword_1C029D080(v6, a2, a3, v8) >= 0 && qword_1C029D088 )
    v4 = qword_1C029D088(a1, 0LL, v3);
  if ( WPP_GLOBAL_Control == (PDEVICE_OBJECT)&WPP_GLOBAL_Control
    || (HIDWORD(WPP_GLOBAL_Control->Timer) & 0x200) == 0
    || (LOBYTE(a2) = 1, BYTE1(WPP_GLOBAL_Control->Timer) < 5u) )
  {
