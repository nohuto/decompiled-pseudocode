        ...
        __int64 a9)
{
  ...
  *(_DWORD *)&EventDescriptor.Level = *(unsigned __int16 *)(a2 + 1);
  ...
  UserData.Ptr = (ULONGLONG)off_1C028D688;
  v27 = a4;
  v28 = 8LL;
  UserData.Size = *(unsigned __int16 *)off_1C028D688;
  ...
  result = -1073741811;
  if ( (void (__fastcall *)(const struct _GUID *, unsigned int, unsigned __int8, unsigned __int64, unsigned __int64, struct _EVENT_FILTER_DESCRIPTOR *, void *))qword_1C028D6A8 == TlgAggregateInternalRegisteredProviderEtwCallback )
  {
    ...
    if ( AggregateFieldTypes )
      ...
      return EtwWriteTransfer(qword_1C028D6A0, &EventDescriptor, 0LL, 0LL, 8u, &UserData);
  }
  return result;
}
