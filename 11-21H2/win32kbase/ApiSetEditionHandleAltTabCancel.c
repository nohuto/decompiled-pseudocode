/*
 * XREFs of ApiSetEditionHandleAltTabCancel @ 0x1C003E380
 * Callers:
        ...
        int a7)
{
  ...
  v14 = 0;
  if ( (int)IsEditionHandleAltTabCancelSupported(v11, a2, a3, v13) >= 0 && qword_1C029D148 )
  {
    LOBYTE(v18) = a5;
    v14 = qword_1C029D148(a1, v9, v8, a4, v18, a6, a7);
  }
  if ( WPP_GLOBAL_Control == (PDEVICE_OBJECT)&WPP_GLOBAL_Control
    || (HIDWORD(WPP_GLOBAL_Control->Timer) & 0x200) == 0
