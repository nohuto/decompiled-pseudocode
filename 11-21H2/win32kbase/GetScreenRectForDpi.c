/*
 * XREFs of GetScreenRectForDpi @ 0x1C006ED5C
 * Callers:
...
__m128i *__fastcall GetScreenRectForDpi(__m128i *a1, unsigned __int16 a2)
{
  ...
  if ( a2 )
  {
    if ( *(_DWORD *)v4 == 1 )
    {
      *a1 = *(__m128i *)GetMonitorRectForDpi((__int64)&v17, *((_QWORD *)gpDispInfo + 12), a2);
    }
    else
    {
      ...
      if ( v6 )
      {
        ...
        do
        {
          ...
          {
            MonitorRectForDpi = (__m128i *)GetMonitorRectForDpi((__int64)v18, v6, a2);
