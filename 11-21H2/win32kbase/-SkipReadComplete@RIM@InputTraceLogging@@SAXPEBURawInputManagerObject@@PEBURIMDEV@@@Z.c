/*
 * XREFs of ?SkipReadComplete@RIM@InputTraceLogging@@SAXPEBURawInputManagerObject@@PEBURIMDEV@@@Z @ 0x1C0004674
 * Callers:
        ...
        const struct RIMDEV *a2)
{
  ...
  if ( v2 )
  {
    ...
    else if ( (unsigned int)dword_1C028EE70 > 4 && v2 == 1 && (unsigned __int8)tlgKeywordOn(&dword_1C028EE70, 256LL) )
    {
      v16 = v13;
      v4 = &v16;
      v5 = &dword_1C025F065;
  ...
  else if ( (unsigned int)dword_1C028EE70 > 4 && (unsigned __int8)tlgKeywordOn(&dword_1C028EE70, 256LL) )
  {
    v15 = v3;
    v4 = &v15;
    v5 = (const int *)&unk_1C025EF69;
LABEL_18:
    v23 = 0;
    v21 = v4;
    v22 = 8;
    tlgWriteTransfer_EtwWriteTransfer((int)&dword_1C028EE70, (int)v5, 0, 0, 3u, &v20);
  }
}
