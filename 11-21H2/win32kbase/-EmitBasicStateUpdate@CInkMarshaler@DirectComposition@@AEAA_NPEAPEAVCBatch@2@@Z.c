/*
 * XREFs of ?EmitBasicStateUpdate@CInkMarshaler@DirectComposition@@AEAA_NPEAPEAVCBatch@2@@Z @ 0x1C02185F0
 * Callers:
        ...
        struct DirectComposition::CBatch ***a2)
{
  ...
  if ( DirectComposition::CBatch::EnsureBatchBuffer(a2, 0x38uLL, &v5) )
  {
    ...
    *((_DWORD *)v3 + 7) = *((_DWORD *)this + 20);
    *((_OWORD *)v3 + 2) = *(_OWORD *)((char *)this + 84);
    *((_QWORD *)v3 + 6) = *(_QWORD *)((char *)this + 100);
    *((_DWORD *)this + 4) |= 0x20u;
    return 1;
  }
  return 0;
