/*
 * XREFs of rimFreeAllUserMem @ 0x1C00490E4
 * Callers:
...
_QWORD *__fastcall rimFreeAllUserMem(__int64 a1, __int64 a2, __int64 a3, __int64 a4)
{
  _QWORD *result; // rax
  ...
  {
    for ( i = (struct _RTL_AVL_TABLE *)(a1 + 968); ; RtlDeleteElementGenericTableAvl(i, v7) )
    {
