/*
 * XREFs of _lambda_adea4d0abd8eda5f6785acddb97df7f7_::operator() @ 0x1C00DD51C
 * Callers:
...
char __fastcall lambda_adea4d0abd8eda5f6785acddb97df7f7_::operator()(__int64 *a1, __int64 a2)
{
  ...
  *(_DWORD *)(a2 + 12) = *(_DWORD *)(v2 + 124);
  if ( !*(_BYTE *)(v2 + 153) )
  {
    *(_DWORD *)(a2 + 16) = *(_DWORD *)(v2 + 128);
    *(_DWORD *)(a2 + 20) = *(_DWORD *)(v2 + 132);
    *(_DWORD *)(a2 + 24) = *(_DWORD *)(v2 + 136);
    *(_DWORD *)(a2 + 28) = *(_DWORD *)(v2 + 140);
    *(_DWORD *)(a2 + 32) = *(_DWORD *)(v2 + 144);
    *(_DWORD *)(a2 + 36) = *(_DWORD *)(v2 + 148);
  }
  *(_BYTE *)(a2 + 40) = *(_BYTE *)(v2 + 152);
  *(_BYTE *)(a2 + 41) = *(_BYTE *)(v2 + 153);
  result = *(_BYTE *)(v2 + 154);
  *(_BYTE *)(a2 + 42) = result;
  return result;
}
