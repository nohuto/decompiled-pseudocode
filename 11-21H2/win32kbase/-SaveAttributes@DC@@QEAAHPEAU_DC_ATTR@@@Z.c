/*
 * XREFs of ?SaveAttributes@DC@@QEAAHPEAU_DC_ATTR@@@Z @ 0x1C0022E30
 * Callers:
...
__int64 __fastcall DC::SaveAttributes(DC *this, struct _DC_ATTR *a2)
{
  ...
  __int128 v12; // [rsp+70h] [rbp-68h]
  __int128 v13; // [rsp+80h] [rbp-58h]
  __int128 v14; // [rsp+90h] [rbp-48h]
  __int128 v15; // [rsp+A0h] [rbp-38h]
  __int128 v16; // [rsp+B0h] [rbp-28h]
