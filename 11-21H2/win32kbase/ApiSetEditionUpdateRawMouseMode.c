/*
 * XREFs of ApiSetEditionUpdateRawMouseMode @ 0x1C003A804
 * Callers:
...
__int64 (*__fastcall ApiSetEditionUpdateRawMouseMode(__int64 a1))(void)
{
  ...
  result = qword_1C029D5A0;
  if ( qword_1C029D5A0 )
  {
    result = (__int64 (*)(void))qword_1C029D5A0();
    if ( (int)result >= 0 )
    {
      result = (__int64 (*)(void))qword_1C029D5A8;
      if ( qword_1C029D5A8 )
        result = (__int64 (*)(void))qword_1C029D5A8(a1);
    }
  }
  if ( WPP_GLOBAL_Control == (PDEVICE_OBJECT)&WPP_GLOBAL_Control
    || (HIDWORD(WPP_GLOBAL_Control->Timer) & 0x200) == 0
