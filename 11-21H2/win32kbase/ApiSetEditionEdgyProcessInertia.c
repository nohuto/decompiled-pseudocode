/*
 * XREFs of ApiSetEditionEdgyProcessInertia @ 0x1C020704C
 * Callers:
...
__int64 (*__fastcall ApiSetEditionEdgyProcessInertia(__int64 a1))(void)
{
  ...
  result = qword_1C029D4E0;
  if ( qword_1C029D4E0 )
  {
    result = (__int64 (*)(void))qword_1C029D4E0();
    if ( (int)result >= 0 )
    {
      result = (__int64 (*)(void))qword_1C029D4E8;
      if ( qword_1C029D4E8 )
        result = (__int64 (*)(void))qword_1C029D4E8(a1);
    }
  }
  if ( WPP_GLOBAL_Control == (PDEVICE_OBJECT)&WPP_GLOBAL_Control
    || (HIDWORD(WPP_GLOBAL_Control->Timer) & 0x200) == 0
