/*
 * XREFs of ApiSetSend4FingerTapHotkey @ 0x1C020F638
 * Callers:
...
__int64 (*ApiSetSend4FingerTapHotkey())(void)
{
  ...
  result = qword_1C029D6A0;
  if ( qword_1C029D6A0 )
  {
    result = (__int64 (*)(void))qword_1C029D6A0();
    if ( (int)result >= 0 )
    {
      result = qword_1C029D6A8;
      if ( qword_1C029D6A8 )
        result = (__int64 (*)(void))qword_1C029D6A8();
    }
  }
  if ( WPP_GLOBAL_Control == (PDEVICE_OBJECT)&WPP_GLOBAL_Control
    || (HIDWORD(WPP_GLOBAL_Control->Timer) & 0x200) == 0
