/*
 * XREFs of HmgPentryFromPobj @ 0x1C0021920
 * Callers:
...
__int64 __fastcall HmgPentryFromPobj(_DWORD *a1)
{
  ...
  else
  {
    if ( v3 >= v7 )
    {
      v8 = *(_QWORD *)(v4 + 8LL * (((v3 - v7) >> 16) + 1) + 8);
      v3 += -65536 * ((v3 - v7) >> 16) - v7;
    }
    else
    {
      v8 = *(_QWORD *)(v4 + 8);
  ...
  v11 = v10;
  if ( v10 >= v7 + (((unsigned __int16)v6 + 0xFFFF) << 16)
    || (v10 >= v7
      ? (v12 = *(_QWORD *)(v4 + 8LL * (((v10 - v7) >> 16) + 1) + 8),
         v11 = -65536 * (((unsigned int)v11 - v7) >> 16) - v7 + (unsigned int)v11)
      : (v12 = *(_QWORD *)(v4 + 8)),
