/*
 * XREFs of ?sHeaderCallback@CIVChannel@@CAJPEAU_IVSRContext@@@Z @ 0x1C01F7750
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall CIVChannel::sHeaderCallback(struct _IVSRContext *a1)
{
  ...
  if ( !isChildPartition() )
  {
    ...
    {
      v8 = &WPP_e36f0bd77e21300be1523eb9b2f96338_Traceguids;
      LOBYTE(v8) = v5;
...
LABEL_18:
  ...
  if ( v12 < 0 )
  {
    ...
    if ( v5 || WPP_RECORDER_INITIALIZED != (_UNKNOWN *)&WPP_RECORDER_INITIALIZED )
    {
      v14 = &WPP_e36f0bd77e21300be1523eb9b2f96338_Traceguids;
      LOBYTE(v14) = v5;
