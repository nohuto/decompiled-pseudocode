/*
 * XREFs of ?GetCOPPCompatibleInformation@COPMProtectedOutput@@QEAAJQEAU_DXGKMDT_OPM_COPP_COMPATIBLE_GET_INFO_PARAMETERS@@PEAU_DXGKMDT_OPM_REQUESTED_INFORMATION@@@Z @ 0x1C016CD44
 * Callers:
        ...
        struct _DXGKMDT_OPM_REQUESTED_INFORMATION *a3)
{
  ...
  {
    Pool2 = (OPM *)ExAllocatePool2(258LL, 4104LL);
    v9 = Pool2;
    if ( Pool2 )
    {
