/*
 * XREFs of ?EmitUpdateCommands@CVisualCaptureMarshaler@DirectComposition@@MEAA_NPEAPEAVCBatch@2@@Z @ 0x1C0233750
 * Callers:
 *     <none>
 * Callees:
        ...
        struct DirectComposition::CBatch **a2)
{
  ...
  *((_DWORD *)v5 + 4) = v9;
  ...
  if ( v10 )
    v2 = *(_DWORD *)(v10 + 32);
  *((_DWORD *)v5 + 5) = v2;
  *((_DWORD *)v5 + 6) = *((_DWORD *)this + 26);
  *((_DWORD *)v5 + 7) = *((_DWORD *)this + 27);
  *((_DWORD *)v5 + 8) = *((_DWORD *)this + 28);
  v5[36] = *((_BYTE *)this + 116);
  return 1;
}
