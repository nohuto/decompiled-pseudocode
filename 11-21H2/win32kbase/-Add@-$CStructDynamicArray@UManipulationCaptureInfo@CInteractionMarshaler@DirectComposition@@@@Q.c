/*
 * XREFs of ?Add@?$CStructDynamicArray@UManipulationCaptureInfo@CInteractionMarshaler@DirectComposition@@@@QEAAJAEBUManipulationCaptureInfo@CInteractionMarshaler@DirectComposition@@@Z @ 0x1C022C108
 * Callers:
...
LABEL_19:
    ...
    {
LABEL_9:
      Pool2 = ExAllocatePool2(260LL, 16LL);
    }
    if ( Pool2 )
    {
LABEL_15:
