/*
 * XREFs of NtGdiConfigureOPMProtectedOutput @ 0x1C016CF30
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall NtGdiConfigureOPMProtectedOutput(unsigned __int64 a1, char *a2, unsigned int a3, char *a4)
{
  ...
  v6 = 0;
  v7 = 0LL;
  Pool2 = (struct _DXGKMDT_OPM_CONFIGURE_PARAMETERS *)ExAllocatePool2(258LL, 4096LL);
  if ( Pool2 && (!(_DWORD)v4 || (v7 = (void *)ExAllocatePool2(258LL, v4)) != 0LL) )
  {
    ...
    if ( v9 >= 0 )
    {
      ...
      v9 = COPM::ConfigureProtectedOutput(v10, a1, Pool2, v4, (unsigned __int8 *)v7);
    }
  }
  else
  {
