/*
 * XREFs of ApiSetEditionEdgyResetDataFrames @ 0x1C0207468
 * Callers:
...
__int64 (*__fastcall ApiSetEditionEdgyResetDataFrames(__int64 a1))(void)
{
  ...
  result = qword_1C029D4D0;
  if ( qword_1C029D4D0 )
  {
    result = (__int64 (*)(void))qword_1C029D4D0();
    if ( (int)result >= 0 )
    {
      result = (__int64 (*)(void))qword_1C029D4D8;
      if ( qword_1C029D4D8 )
        result = (__int64 (*)(void))qword_1C029D4D8(a1);
    }
  }
  if ( WPP_GLOBAL_Control == (PDEVICE_OBJECT)&WPP_GLOBAL_Control
    || (HIDWORD(WPP_GLOBAL_Control->Timer) & 0x200) == 0
