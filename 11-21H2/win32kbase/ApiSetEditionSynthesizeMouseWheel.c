/*
 * XREFs of ApiSetEditionSynthesizeMouseWheel @ 0x1C020BE4C
 * Callers:
...
PDEVICE_OBJECT *__fastcall ApiSetEditionSynthesizeMouseWheel(__int64 a1, __int64 a2, __int64 a3, __int64 a4, int a5)
{
  ...
  if ( qword_1C029D650 && (int)qword_1C029D650(v9, a2, a3, v11) >= 0 && qword_1C029D658 )
    qword_1C029D658(a1, v7, v6, a4, a5);
