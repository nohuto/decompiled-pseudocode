/*
 * XREFs of DirectComposition::CResourceMarshaler::EmitUpdateCommand__lambda_ac1c59748b96fb69b3ab1183eeae36ef___ @ 0x1C0233E74
 * Callers:
        ...
        __int64 a3)
{
  ...
  *((_DWORD *)v5 + 4) = *(_DWORD *)(*(_QWORD *)a3 + 204LL);
  *((_DWORD *)v5 + 5) = *(_DWORD *)(*(_QWORD *)a3 + 208LL);
  *(_QWORD *)(v5 + 28) = *(_QWORD *)(*(_QWORD *)a3 + 184LL);
  result = 1;
