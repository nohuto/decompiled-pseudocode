/*
 * XREFs of NSInstrumentation::CLeakTrackingAllocator::AllocateCommon__lambda_70f2a9c1e788ab7a3937d193d982bb8e___lambda_4aaddf2c61b427945b131cdbed9eec78___ @ 0x1C0179BA8
 * Callers:
 *     Win32AllocPoolWithPriorityZInit @ 0x1C0167240 (Win32AllocPoolWithPriorityZInit.c)
 * Callees:
...
__int64 __fastcall NSInstrumentation::CLeakTrackingAllocator::AllocateCommon__lambda_70f2a9c1e788ab7a3937d193d982bb8e___lambda_4aaddf2c61b427945b131cdbed9eec78___(
        ...
        int a3)
{
  ...
  if ( !NSInstrumentation::CLeakTrackingAllocator::IsTagTracked(a1, a3) )
  {
    ...
    v10 = *v9;
    v18 = **(_DWORD **)(v6 + 16);
    return ExAllocatePool3(v10 & 0xFFFFFFFFFFFFFFFDuLL, v5, v8, &v17, 1);
  }
  v12 = 0;
  ...
  v17 = 1LL;
  v14 = *v13;
  v15 = **(_QWORD **)v6 & 0xFFFFFFFFFFFFFFFDuLL;
  v18 = **(_DWORD **)(v6 + 16);
