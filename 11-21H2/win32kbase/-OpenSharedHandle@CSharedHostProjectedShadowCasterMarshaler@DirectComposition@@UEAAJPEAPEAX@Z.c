/*
 * XREFs of ?OpenSharedHandle@CSharedHostProjectedShadowCasterMarshaler@DirectComposition@@UEAAJPEAPEAX@Z @ 0x1C023A5C0
 * Callers:
 *     <none>
 * Callees:
...
NTSTATUS __fastcall DirectComposition::CSharedHostProjectedShadowCasterMarshaler::OpenSharedHandle(
