/*
 * XREFs of ??$Write@U?$_tlgWrapperByVal@$03@@U1@U?$_tlgWrapperByVal@$07@@@?$_tlgWriteTemplate@$$A6AJPEBU_tlgProvider_t@@PEBX1IPEAU_EVENT_DATA_DESCRIPTOR@@@Z$1?_tlgWriteAgg@@YAJ011I2@ZPEBX@@SAJPEBU_tlgProvider_t@@PEBX1AEBU?$_tlgWrapperByVal@$03@@2AEBU?$_tlgWrapperByVal@$07@@@Z @ 0x1C0071E9C
 * Callers:
        ...
        __int64 a6)
{
  ...
  *(_DWORD *)&EventDescriptor.Level = *(unsigned __int16 *)(a2 + 1);
  ...
  UserData.Ptr = (ULONGLONG)off_1C028D6F8;
  v22 = 8;
  v15 = a4;
  UserData.Size = *(unsigned __int16 *)off_1C028D6F8;
  ...
  result = -1073741811;
  if ( (void (__fastcall *)(const struct _GUID *, unsigned int, unsigned __int8, unsigned __int64, unsigned __int64, struct _EVENT_FILTER_DESCRIPTOR *, void *))qword_1C028D718 == TlgAggregateInternalRegisteredProviderEtwCallback )
  {
    ...
    {
      return EtwWriteTransfer(qword_1C028D710, &EventDescriptor, 0LL, 0LL, 5u, &UserData);
    }
  }
  return result;
}
