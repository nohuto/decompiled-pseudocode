/*
 * XREFs of ?SetBlurredWallpaperSurface@CConnection@DirectComposition@@QEAAJPEAXPEBUtagRECT@@@Z @ 0x1C02135BC
 * Callers:
        ...
        const struct tagRECT *a3)
{
  ...
  v3 = (DirectComposition::CConnection *)((char *)this + 296);
  ExAcquirePushLockExclusiveEx((char *)this + 296, 0LL);
  *((_BYTE *)v3 + 8) = 1;
  if ( !*((_QWORD *)this + 33) || *((_QWORD *)this + 33) == PsGetCurrentProcess(v8, v7, v9, v10) )
