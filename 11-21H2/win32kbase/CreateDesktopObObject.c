/*
 * XREFs of CreateDesktopObObject @ 0x1C00BBC00
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall CreateDesktopObObject(__int64 a1, void *a2, __int64 a3, void **a4)
{
  ...
  *a4 = 0LL;
  ...
  {
    v8 = *a4;
    memset(*a4, 0, 0x150uLL);
    *v8 = gSessionId;
    ObjectSecurity = ObGetObjectSecurity(a2, &SecurityDescriptor, &MemoryAllocated);
    if ( ObjectSecurity < 0
      || (ObjectSecurity = ObAssignSecurity(a3, SecurityDescriptor, v8, ExDesktopObjectType, 0LL, 336, 0, 0, a4),
