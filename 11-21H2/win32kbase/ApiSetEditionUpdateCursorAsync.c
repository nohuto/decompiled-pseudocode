/*
 * XREFs of ApiSetEditionUpdateCursorAsync @ 0x1C003B50C
 * Callers:
...
__int64 (*ApiSetEditionUpdateCursorAsync())(void)
{
  ...
  result = qword_1C029D670;
  if ( qword_1C029D670 )
  {
    result = (__int64 (*)(void))qword_1C029D670();
    if ( (int)result >= 0 )
    {
      result = qword_1C029D678;
      if ( qword_1C029D678 )
        result = (__int64 (*)(void))qword_1C029D678();
    }
  }
  if ( WPP_GLOBAL_Control == (PDEVICE_OBJECT)&WPP_GLOBAL_Control
    || (HIDWORD(WPP_GLOBAL_Control->Timer) & 0x200) == 0
