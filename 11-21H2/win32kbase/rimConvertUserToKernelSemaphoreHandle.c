/*
 * XREFs of rimConvertUserToKernelSemaphoreHandle @ 0x1C005EDD8
 * Callers:
...
__int64 __fastcall rimConvertUserToKernelSemaphoreHandle(void *a1, void **a2)
{
  ...
  *a2 = 0LL;
  ...
  {
    v8 = ObOpenObjectByPointer(Object, 0x200u, 0LL, 0x1F0003u, (POBJECT_TYPE)ExSemaphoreObjectType, 0, a2);
    if ( v8 < 0 )
