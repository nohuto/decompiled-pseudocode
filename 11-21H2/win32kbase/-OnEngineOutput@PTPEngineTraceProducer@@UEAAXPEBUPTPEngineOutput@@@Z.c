/*
 * XREFs of ?OnEngineOutput@PTPEngineTraceProducer@@UEAAXPEBUPTPEngineOutput@@@Z @ 0x1C00E9E20
 * Callers:
 *     <none>
 * Callees:
...
void __fastcall PTPEngineTraceProducer::OnEngineOutput(PTPEngineTraceProducer *this, const struct PTPEngineOutput *a2)
{
  ...
  v2 = dword_1C028D610;
  if ( (unsigned int)dword_1C028D610 > 5 && tlgKeywordOn((__int64)&dword_1C028D610, 5LL) )
  {
    v12 = a2;
    v13 = v5 + 15;
    v15 = *((_QWORD *)this + 73);
  ...
  if ( *((_DWORD *)a2 + 4) && v2 > 5 && tlgKeywordOn((__int64)&dword_1C028D610, 5LL) )
  {
    v10 = *((_WORD *)a2 + 8);
