/*
 * XREFs of ?ProcessEnvironment@CPTPEngine@@MEAAJXZ @ 0x1C0201DE0
 * Callers:
 *     <none>
 * Callees:
 *     ?IsRectEmptyInl@@YAHPEBUtagRECT@@@Z @ 0x1C001E924 (-IsRectEmptyInl@@YAHPEBUtagRECT@@@Z.c)
 *     _guard_dispatch_icall_nop @ 0x1C00DE650 (_guard_dispatch_icall_nop.c)
 *     ?UpdatePTPRightClickZone@CPTPEngine@@AEAAXXZ @ 0x1C02049D0 (-UpdatePTPRightClickZone@CPTPEngine@@AEAAXXZ.c)
 */
