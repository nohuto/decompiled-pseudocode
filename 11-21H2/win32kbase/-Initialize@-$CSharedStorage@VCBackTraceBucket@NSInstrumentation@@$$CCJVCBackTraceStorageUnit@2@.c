/*
 * XREFs of ?Initialize@?$CSharedStorage@VCBackTraceBucket@NSInstrumentation@@$$CCJVCBackTraceStorageUnit@2@VCBackTrace@2@@NSInstrumentation@@QEAA_NI@Z @ 0x1C017B628
 * Callers:
        ...
        __int64 a1)
{
  ...
  *(_QWORD *)a1 = 0LL;
  *(_DWORD *)(a1 + 16) = 0;
  Pool2 = (_DWORD *)ExAllocatePool2(262LL, 4LL);
  if ( Pool2 )
    *Pool2 = 0;
  *(_QWORD *)(a1 + 40) = Pool2;
  *(_QWORD *)(a1 + 32) = 256LL;
  *(_QWORD *)(a1 + 48) = 0LL;
  v4 = ExAllocatePool2(262LL, 4096LL);
  *(_QWORD *)(a1 + 48) = v4;
  if ( v4 )
  {
