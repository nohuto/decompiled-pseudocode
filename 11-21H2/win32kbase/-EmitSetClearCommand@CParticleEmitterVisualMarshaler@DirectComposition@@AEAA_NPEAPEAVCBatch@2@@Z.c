/*
 * XREFs of ?EmitSetClearCommand@CParticleEmitterVisualMarshaler@DirectComposition@@AEAA_NPEAPEAVCBatch@2@@Z @ 0x1C0220D9C
 * Callers:
        ...
        struct DirectComposition::CBatch ***a2)
{
  ...
  if ( (*((_DWORD *)this + 139) & 0x2000000) == 0 )
    return 1;
  v5 = 0LL;
