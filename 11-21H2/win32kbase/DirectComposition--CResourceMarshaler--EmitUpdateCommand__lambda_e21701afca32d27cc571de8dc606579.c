/*
 * XREFs of DirectComposition::CResourceMarshaler::EmitUpdateCommand__lambda_e21701afca32d27cc571de8dc6065791___ @ 0x1C0218DBC
 * Callers:
        ...
        __int64 a3)
{
  ...
  *(_OWORD *)(v6 + 1) = 0LL;
  ...
  v6[1] = 152;
  v6[2] = *(_DWORD *)(a1 + 32);
  v7 = *(_QWORD *)(*(_QWORD *)a3 + 232LL);
  if ( v7 )
    v3 = *(_DWORD *)(v7 + 32);
  v6[3] = v3;
  v6[4] = *(_DWORD *)(*(_QWORD *)a3 + 240LL);
  result = 1;
  v6[5] = *(_DWORD *)(*(_QWORD *)a3 + 244LL);
  return result;
}
