/*
 * XREFs of ?OnInput@PTPEngineTraceProducer@@QEAAJPEAUPTPInput@@PEAUtagTPAAPSTATE@@@Z @ 0x1C00E9F46
 * Callers:
 *     ?OnInput@PTPEngineTraceProducer@@UEAAJPEAUPTPInput@@@Z @ 0x1C00EA090 (-OnInput@PTPEngineTraceProducer@@UEAAJPEAUPTPInput@@@Z.c)
...
__int64 __fastcall PTPEngineTraceProducer::OnInput(PTPEngineTraceProducer *this, struct PTPInput *a2, __int64 a3)
{
  ...
  if ( *((_DWORD *)a2 + 12) && v3 > 5 && tlgKeywordOn((__int64)&dword_1C028D610, 3LL) )
  {
    v11 = *((_WORD *)a2 + 24);
