/*
 * XREFs of ?MapToDisplayPath@CInputSpaceRegion@@QEAAXAEBUDISPLAYCONFIG_PATH_INFO_INTERNAL@@@Z @ 0x1C00A0DFC
 * Callers:
        ...
        const struct DISPLAYCONFIG_PATH_INFO_INTERNAL *a2)
{
  ...
  *((_DWORD *)this + 41) = *((_DWORD *)a2 + 26);
  ...
  v8 = *v4;
  if ( *((_DWORD *)this + 48) == (_DWORD)v8 || (v8 = *((unsigned int *)this + 47), *((_DWORD *)this + 49) == (_DWORD)v8) )
  {
