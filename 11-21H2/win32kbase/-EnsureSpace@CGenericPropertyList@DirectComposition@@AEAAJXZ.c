/*
 * XREFs of ?EnsureSpace@CGenericPropertyList@DirectComposition@@AEAAJXZ @ 0x1C0214978
 * Callers:
...
__int64 __fastcall DirectComposition::CGenericPropertyList::EnsureSpace(DirectComposition::CGenericPropertyList *this)
{
  ...
  if ( *((_QWORD *)this + 1) == v1 )
  {
    ...
    if ( v1 )
      v3 = 2 * v1;
    Quota = (void *)NSInstrumentation::CLeakTrackingAllocator::AllocateQuota(this, 260LL, 8 * v3, 1885815620);
    v5 = Quota;
    if ( !Quota )
      return 3221225495LL;
    if ( *(_QWORD *)this )
