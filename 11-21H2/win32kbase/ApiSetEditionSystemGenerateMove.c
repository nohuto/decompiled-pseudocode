/*
 * XREFs of ApiSetEditionSystemGenerateMove @ 0x1C00B4EDC
 * Callers:
...
__int64 (*__fastcall ApiSetEditionSystemGenerateMove(unsigned int a1))(void)
{
  ...
  result = qword_1C029D660;
  if ( qword_1C029D660 )
  {
    result = (__int64 (*)(void))qword_1C029D660();
    if ( (int)result >= 0 )
    {
      result = (__int64 (*)(void))qword_1C029D668;
      if ( qword_1C029D668 )
        result = (__int64 (*)(void))qword_1C029D668(a1);
    }
  }
  if ( WPP_GLOBAL_Control == (PDEVICE_OBJECT)&WPP_GLOBAL_Control
    || (HIDWORD(WPP_GLOBAL_Control->Timer) & 0x200) == 0
