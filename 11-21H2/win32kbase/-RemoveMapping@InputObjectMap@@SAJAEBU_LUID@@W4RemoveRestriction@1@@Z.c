/*
 * XREFs of ?RemoveMapping@InputObjectMap@@SAJAEBU_LUID@@W4RemoveRestriction@1@@Z @ 0x1C023D5F0
 * Callers:
...
LABEL_12:
  ...
  v14 = *((_QWORD *)v9 + 1) & (-1LL << (dword_1C029A1F4 & 0x1F));
  for ( i = (struct InputObjectMapEntry *)((char *)Buffer
                                         ...
                                         * ((37
                                           * (BYTE6(v14)
                                           ...
                                           + HIBYTE(v14)) & (((unsigned int)dword_1C029A1F4 >> 5) - 1)));
        (*(_QWORD *)i & 1) == 0;
