/*
 * XREFs of ApiSetEditionUpdateRemoteLights @ 0x1C00B3E4C
 * Callers:
...
__int64 (*ApiSetEditionUpdateRemoteLights())(void)
{
  ...
  result = qword_1C029D1D0;
  if ( qword_1C029D1D0 )
  {
    result = (__int64 (*)(void))qword_1C029D1D0();
    if ( (int)result >= 0 )
    {
      result = qword_1C029D1D8;
      if ( qword_1C029D1D8 )
        result = (__int64 (*)(void))qword_1C029D1D8();
    }
  }
  if ( WPP_GLOBAL_Control == (PDEVICE_OBJECT)&WPP_GLOBAL_Control
    || (HIDWORD(WPP_GLOBAL_Control->Timer) & 0x200) == 0
