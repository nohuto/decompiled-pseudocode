/*
 * XREFs of ?OpenDwmHandle@CompositionInputObject@@QEBAJPEAPEAX@Z @ 0x1C0090700
 * Callers:
...
__int64 __fastcall CompositionInputObject::OpenDwmHandle(CompositionInputObject *this, void **a2)
{
  ...
  if ( v4 >= 0 && (unsigned int)dword_1C028EE70 > 5 && tlgKeywordOn((__int64)&dword_1C028EE70, 4LL) )
  {
    v9 = *a2;
    v20 = v6;
    v19 = &v8;
    ...
    v16 = 8LL;
    v14 = 8LL;
    tlgWriteTransfer_EtwWriteTransfer((__int64)&dword_1C028EE70, (unsigned __int8 *)dword_1C0264AA4, v7, 0LL, 6u, &v12);
  }
