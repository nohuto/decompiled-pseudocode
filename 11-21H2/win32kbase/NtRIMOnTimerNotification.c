/*
 * XREFs of NtRIMOnTimerNotification @ 0x1C0180930
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall NtRIMOnTimerNotification(__int64 a1, __int64 a2, __int64 a3)
{
