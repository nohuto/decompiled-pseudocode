/*
 * XREFs of ??$WriteData@K@MonitorDataStore@DxgMonitor@@AEAAXPEAXPEBGK@Z @ 0x1C021B234
 * Callers:
 ...
 *     ?WriteBool@MonitorDataStore@DxgMonitor@@UEAAXPEAXPEBG_N@Z @ 0x1C03B9810 (-WriteBool@MonitorDataStore@DxgMonitor@@UEAAXPEAXPEBG_N@Z.c)
 *     ?WriteDWord@MonitorDataStore@DxgMonitor@@UEAAXPEAXPEBGK@Z @ 0x1C03B9830 (-WriteDWord@MonitorDataStore@DxgMonitor@@UEAAXPEAXPEBGK@Z.c)
