/*
 * XREFs of DxgkReleaseKeyedMutex2 @ 0x1C0343590
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall DxgkReleaseKeyedMutex2(__int64 a1, __int64 a2, __int64 a3)
{
  ...
  struct DXGKEYEDMUTEX *v26; // [rsp+B8h] [rbp+10h] BYREF
  DXGKEYEDMUTEX *v27; // [rsp+C0h] [rbp+18h] BYREF
  ...
  DXGETWPROFILER_BASE::PushProfilerEntry((__int64)&v20, 2069);
...
LABEL_15:
  ...
  *(_OWORD *)Src = *(_OWORD *)(v3 + 16);
  ...
  v26 = 0LL;
  v12 = v23[0];
  DXGKEYEDMUTEXBYHANDLE::DXGKEYEDMUTEXBYHANDLE((DXGKEYEDMUTEXBYHANDLE *)&v27, v23[0], Current, &v26);
  v13 = v26;
  if ( !v26 )
  {
