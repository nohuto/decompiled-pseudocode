/*
 * XREFs of ?SetSchedulerCrossAdapterData@DXGGLOBAL@@QEAAXPEAU_KEVENT@@@Z @ 0x1C0054060
 * Callers:
...
void __fastcall DXGGLOBAL::SetSchedulerCrossAdapterData(KSPIN_LOCK *this, struct _KEVENT *a2)
{
  ...
  KeAcquireInStackQueuedSpinLock(this + 170, &LockHandle);
  this[171] = (KSPIN_LOCK)a2;
