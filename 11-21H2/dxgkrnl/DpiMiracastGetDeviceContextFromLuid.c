/*
 * XREFs of DpiMiracastGetDeviceContextFromLuid @ 0x1C006111C
 * Callers:
...
__int64 *__fastcall DpiMiracastGetDeviceContextFromLuid(__int64 a1, char a2)
{
  ...
  v4 = (__int64 *)qword_1C01308A0;
  if ( (__int64 *)qword_1C01308A0 == &qword_1C01308A0 )
    goto LABEL_8;
  do
  {
    v5 = v4;
  ...
  while ( v4 != &qword_1C01308A0 );
  if ( v4 == &qword_1C01308A0 )
  {
LABEL_8:
    v5 = 0LL;
  }
