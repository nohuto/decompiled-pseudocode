/*
 * XREFs of ?ReportState@DXGCONTEXT@@QEAAXXZ @ 0x1C02E22B0
 * Callers:
...
void __fastcall DXGCONTEXT::ReportState(DXGCONTEXT *this, __int64 a2, __int64 a3)
{
  ...
  if ( *((_QWORD *)this + 29) )
    (*(void (**)(void))(*(_QWORD *)(*(_QWORD *)(*(_QWORD *)(*((_QWORD *)this + 2) + 16LL) + 648LL) + 8LL) + 472LL))();
  if ( (*((_DWORD *)this + 101) & 0x10) != 0 )
  {
    ...
    if ( *((_QWORD *)this + 36) )
      (*(void (**)(void))(*(_QWORD *)(*(_QWORD *)(*(_QWORD *)(*((_QWORD *)this + 2) + 16LL) + 624LL) + 8LL) + 288LL))();
  ...
  {
    (*(void (**)(void))(*(_QWORD *)(*(_QWORD *)(*(_QWORD *)(*((_QWORD *)this + 2) + 16LL) + 624LL) + 8LL) + 280LL))();
    if ( (Microsoft_Windows_DxgKrnlEnableBits & 0x400) != 0 )
