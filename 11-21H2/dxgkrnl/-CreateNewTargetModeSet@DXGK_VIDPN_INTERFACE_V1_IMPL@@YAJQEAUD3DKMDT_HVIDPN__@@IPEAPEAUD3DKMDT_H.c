/*
 * XREFs of ?CreateNewTargetModeSet@DXGK_VIDPN_INTERFACE_V1_IMPL@@YAJQEAUD3DKMDT_HVIDPN__@@IPEAPEAUD3DKMDT_HVIDPNTARGETMODESET__@@PEAPEBU_DXGK_VIDPNTARGETMODESET_INTERFACE@@@Z @ 0x1C01A9F70
 * Callers:
 *     <none>
 * Callees:
...
{
  return DXGK_VIDPN_INTERFACE_V1_IMPL::CreateNewTargetModeSetImpl(this, a2, 1LL, a3, a4);
}
