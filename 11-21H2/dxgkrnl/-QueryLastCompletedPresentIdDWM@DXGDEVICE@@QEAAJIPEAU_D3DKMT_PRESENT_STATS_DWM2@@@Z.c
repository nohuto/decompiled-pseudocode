/*
 * XREFs of ?QueryLastCompletedPresentIdDWM@DXGDEVICE@@QEAAJIPEAU_D3DKMT_PRESENT_STATS_DWM2@@@Z @ 0x1C02230AA
 * Callers:
        ...
        struct _D3DKMT_PRESENT_STATS_DWM2 *a3)
{
  ...
  if ( v5 == *(struct DXGADAPTER **)(v3 + 16) )
    return (*(__int64 (__fastcall **)(_QWORD, _QWORD))(*(_QWORD *)(*(_QWORD *)(v3 + 624) + 8LL) + 488LL))(
             *((_QWORD *)this + 96),
             a2);
  if ( !v5 )
    return 3221225485LL;
