/*
 * XREFs of ?DdiGetResourceForBar@ADAPTER_RENDER@@QEAAJPEAU_DXGKARG_GETRESOURCEFORBAR@@@Z @ 0x1C035B694
 * Callers:
 *     ?GetResourceForBar@DXGK_VIRTUAL_GPU_GPUP@@UEAAJPEAU_DXGKARG_GETRESOURCEFORBAR@@@Z @ 0x1C03608F0 (-GetResourceForBar@DXGK_VIRTUAL_GPU_GPUP@@UEAAJPEAU_DXGKARG_GETRESOURCEFORBAR@@@Z.c)
 * Callees:
