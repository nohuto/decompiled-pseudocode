/*
 * XREFs of ?GetSwapChainRealizationInfo@CCompositionSurface@@QEBAJ_KPEAIPEAUCSM_REALIZATION_INFO@@@Z @ 0x1C0004F80
 * Callers:
        ...
        struct CSM_REALIZATION_INFO *a4)
{
  ...
  if ( (int)result >= 0 )
  {
    ...
    if ( (*(unsigned __int8 (__fastcall **)(struct CCompositionBuffer *))(*(_QWORD *)v8 + 80LL))(v8) )
      return (*(__int64 (__fastcall **)(struct CCompositionBuffer *, _QWORD, unsigned int *, struct CSM_REALIZATION_INFO *))(*(_QWORD *)v7 + 72LL))(
               v7,
               0LL,
               a3,
               a4);
