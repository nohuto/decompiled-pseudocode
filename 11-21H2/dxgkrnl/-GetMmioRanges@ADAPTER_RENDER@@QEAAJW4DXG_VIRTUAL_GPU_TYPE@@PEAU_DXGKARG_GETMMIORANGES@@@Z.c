/*
 * XREFs of ?GetMmioRanges@ADAPTER_RENDER@@QEAAJW4DXG_VIRTUAL_GPU_TYPE@@PEAU_DXGKARG_GETMMIORANGES@@@Z @ 0x1C0357B84
 * Callers:
...
__int64 __fastcall ADAPTER_RENDER::GetMmioRanges(__int64 a1, int a2, unsigned int *a3)
{
  ...
  {
    v10 = (*(__int64 (__fastcall **)(__int64, unsigned int *))(*(_QWORD *)v9 + 168LL))(v9, a3);
  }
  else
  {
