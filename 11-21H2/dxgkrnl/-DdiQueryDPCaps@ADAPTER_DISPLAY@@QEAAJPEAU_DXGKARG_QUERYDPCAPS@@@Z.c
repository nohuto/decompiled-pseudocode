/*
 * XREFs of ?DdiQueryDPCaps@ADAPTER_DISPLAY@@QEAAJPEAU_DXGKARG_QUERYDPCAPS@@@Z @ 0x1C02CAAAC
 * Callers:
...
__int64 __fastcall ADAPTER_DISPLAY::DdiQueryDPCaps(ADAPTER_DISPLAY *this, struct _DXGKARG_QUERYDPCAPS *a2, __int64 a3)
{
  ...
  int v9; // r14d
  __int64 v10; // rcx
  __int64 (__fastcall *v11)(_QWORD, struct _DXGKARG_QUERYDPCAPS *); // rax
  int v12; // edi
  KIRQL v13; // al
  __int64 v14; // rcx
  __int64 v15; // r8
  ...
  if ( (qword_1C012F870 & 2) != 0 )
  {
    ...
    if ( (Microsoft_Windows_DxgKrnlEnableBits & 0x8000) != 0 )
      McTemplateK0q_EtwWriteTransfer((__int64)this, &EventProfilerEnter, a3, 5149);
  }
  else
  {
    v19 = 0;
  }
  DXGETWPROFILER_BASE::PushProfilerEntry((__int64)&v17, 5149);
  ...
  if ( v10 && (v11 = *(__int64 (__fastcall **)(_QWORD, struct _DXGKARG_QUERYDPCAPS *))(v10 + 32)) != 0LL )
        ...
        v12 < 0) )
  {
    ...
    DxgkLogInternalTriageEvent(
      ...
      0x40000,
      -1,
      (__int64)L"The driver failed DxgkDdiQueryDPCaps. Status: 0x%I64x",
      v12,
      0LL,
      0LL,
      0LL,
