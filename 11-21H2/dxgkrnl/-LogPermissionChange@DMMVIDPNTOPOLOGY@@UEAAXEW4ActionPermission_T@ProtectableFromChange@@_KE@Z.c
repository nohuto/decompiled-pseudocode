/*
 * XREFs of ?LogPermissionChange@DMMVIDPNTOPOLOGY@@UEAAXEW4ActionPermission_T@ProtectableFromChange@@_KE@Z @ 0x1C01DB7B0
 * Callers:
 *     <none>
 * Callees:
 *     <none>
...
LABEL_7:
  ...
  if ( (unsigned __int8)a2 == 2 )
  {
    result = (_QWORD *)WdLogNewEntry5_WdTrace(v10, a2);
    v11 = result;
    result[3] = a1 - 56;
    if ( v9 < *(_QWORD *)(a1 + 80) )
      goto LABEL_26;
