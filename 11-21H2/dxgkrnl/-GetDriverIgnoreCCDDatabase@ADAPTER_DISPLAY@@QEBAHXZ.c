/*
 * XREFs of ?GetDriverIgnoreCCDDatabase@ADAPTER_DISPLAY@@QEBAHXZ @ 0x1C0019DB4
 * Callers:
 ...
 *     ?IsCcdDatabaseIgnored@MONITOR_MGR@@UEBA_NXZ @ 0x1C03B34A0 (-IsCcdDatabaseIgnored@MONITOR_MGR@@UEBA_NXZ.c)
 * Callees:
...
__int64 __fastcall ADAPTER_DISPLAY::GetDriverIgnoreCCDDatabase(ADAPTER_DISPLAY *this)
{
  ...
  if ( !*(_QWORD *)(*((_QWORD *)this + 2) + 2792LL) )
  {
