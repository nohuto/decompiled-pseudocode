/*
 * XREFs of ?AdjustFullscreenGammaRamp@ADAPTER_DISPLAY@@QEAAJPEBUDXGK_GAMMA_RAMP@@PEAU2@PEAUDXGK_GAMMA_ADJUSTMENT@@@Z @ 0x1C02BF124
 * Callers:
 ...
 * Callees:
 *     ?ScaleAndOffset@@YAGGMM@Z @ 0x1C02C28C4 (-ScaleAndOffset@@YAGGMM@Z.c)
 */
