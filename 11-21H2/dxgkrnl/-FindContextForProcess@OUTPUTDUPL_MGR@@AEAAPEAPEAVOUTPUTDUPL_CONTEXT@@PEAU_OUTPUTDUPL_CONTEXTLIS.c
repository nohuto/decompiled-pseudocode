/*
 * XREFs of ?FindContextForProcess@OUTPUTDUPL_MGR@@AEAAPEAPEAVOUTPUTDUPL_CONTEXT@@PEAU_OUTPUTDUPL_CONTEXTLIST@@PEAU_EPROCESS@@PEAI@Z @ 0x1C02247CE
 * Callers:
        ...
        unsigned int *a4)
{
  ...
  {
    WdLogSingleEntry1(1LL, 1691LL);
    DxgkLogInternalTriageEvent(0LL, 262146, -1, (__int64)L"pContextList->Mutex.IsOwner()", 1691LL, 0LL, 0LL, 0LL, 0LL);
  }
  if ( a4 )
    *a4 = -1;
  v8 = a2[6];
  ...
  while ( 1 )
  {
    if ( *(_QWORD *)v8 )
    {
      this = (OUTPUTDUPL_MGR *)PsGetCurrentProcess(this, a2, a3, a4);
