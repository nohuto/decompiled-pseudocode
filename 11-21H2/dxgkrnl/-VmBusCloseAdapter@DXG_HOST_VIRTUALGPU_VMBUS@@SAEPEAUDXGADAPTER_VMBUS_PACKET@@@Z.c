/*
 * XREFs of ?VmBusCloseAdapter@DXG_HOST_VIRTUALGPU_VMBUS@@SAEPEAUDXGADAPTER_VMBUS_PACKET@@@Z @ 0x1C0368810
 * Callers:
 *     <none>
 * Callees:
...
unsigned __int8 __fastcall DXG_HOST_VIRTUALGPU_VMBUS::VmBusCloseAdapter(struct DXGADAPTER_VMBUS_PACKET *a1)
{
  ...
  if ( v2 )
  {
    if ( *(_DWORD *)(v2 + 24) )
    {
      ...
      v5 = *(_DWORD *)(v3 + 24);
      v9 = 2;
      DXGADAPTER::DestroyHandle(*(struct _KTHREAD ***)(v4 + 96), v5);
      *(_BYTE *)(*((_QWORD *)a1 + 10) + 173LL) = 0;
      DXGAUTOPUSHLOCK::Release((DXGAUTOPUSHLOCK *)v7);
    }
    else
    {
      WdLogSingleEntry1(2LL, 5535LL);
      DxgkLogInternalTriageEvent(0LL, 0x40000, -1, (__int64)L"Invalid adapter handle", 5535LL, 0LL, 0LL, 0LL, 0LL);
    }
  }
  return 0;
}
