/*
 * XREFs of McTemplateK0qpqqqqpp_EtwWriteTransfer @ 0x1C005439C
 * Callers:
...
NTSTATUS __fastcall McTemplateK0qpqqqqpp_EtwWriteTransfer(
        REGHANDLE *a1,
        __int64 a2,
        __int64 a3,
        int a4,
        ...
        char a11)
{
  ...
  v26 = 8LL;
  v28 = 8LL;
  return McGenEventWrite_EtwWriteTransfer(a1, &Present, a3, 9u, &v12);
}
