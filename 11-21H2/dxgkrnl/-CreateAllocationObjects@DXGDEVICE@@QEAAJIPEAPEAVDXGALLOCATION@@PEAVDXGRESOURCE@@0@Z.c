/*
 * XREFs of ?CreateAllocationObjects@DXGDEVICE@@QEAAJIPEAPEAVDXGALLOCATION@@PEAVDXGRESOURCE@@0@Z @ 0x1C0195680
 * Callers:
 ...
 *     ??0DXGALLOCATION@@QEAA@PEAVDXGDEVICE@@@Z @ 0x1C02D58E8 (--0DXGALLOCATION@@QEAA@PEAVDXGDEVICE@@@Z.c)
 */
  ...
  *a5 = 0LL;
  ...
  if ( v8 - 1 >= 0 )
  {
    while ( 1 )
    {
      ...
      {
        v25 = (DXGALLOCATION *)DXGQUOTAALLOCATOR<256,1265072196>::operator new(136LL, a2, (__int64)a3, (__int64)a4);
        v14 = (__int64)v25;
        if ( !v25 )
          goto LABEL_43;
      ...
      *(_QWORD *)(v15 + 256) = 0LL;
      ...
      if ( *(_DWORD *)(v14 + 16) )
      {
        ...
        *a3 = (struct DXGALLOCATION *)v14;
        ...
        {
          v26 = (DXGADAPTERALLOCATION_VGPU *)operator new[](0x78uLL, 0x4B677844u, 256LL, (__int64)a4);
          if ( v26 )
          {
        ...
        {
          v20 = operator new[](0x40uLL, 0x4B677844u, 256LL, (__int64)a4);
