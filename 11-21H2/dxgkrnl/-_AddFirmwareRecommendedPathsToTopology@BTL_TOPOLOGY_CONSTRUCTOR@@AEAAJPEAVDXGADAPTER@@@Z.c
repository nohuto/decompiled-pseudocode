/*
 * XREFs of ?_AddFirmwareRecommendedPathsToTopology@BTL_TOPOLOGY_CONSTRUCTOR@@AEAAJPEAVDXGADAPTER@@@Z @ 0x1C03ADAC4
 * Callers:
        ...
        struct DXGADAPTER *a2)
{
  ...
  auto_rc<DMMVIDPN>::reset((__int64 *)&v25, v5);
  v6 = v25;
  if ( v25 )
  {
    v24 = 0LL;
