/*
 * XREFs of ?DestroyOverlay@DXGDEVICE@@QEAAXPEAVDXGOVERLAY@@@Z @ 0x1C02E4564
 * Callers:
...
{
  struct DXGOVERLAY **v3; // rax
  struct DXGOVERLAY **v4; // rcx

  if ( !*((_BYTE *)this + 72) && !ExIsResourceAcquiredExclusiveLite(*((PERESOURCE *)this + 17)) )
  {
    WdLogSingleEntry1(1LL, 4027LL);
    DxgkLogInternalTriageEvent(0LL, 262146, -1, (__int64)L"IsDeviceLockExclusiveOwner()", 4027LL, 0LL, 0LL, 0LL, 0LL);
  }
  v3 = *a2;
