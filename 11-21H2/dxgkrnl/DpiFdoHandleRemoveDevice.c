/*
 * XREFs of DpiFdoHandleRemoveDevice @ 0x1C0389720
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall DpiFdoHandleRemoveDevice(PDEVICE_OBJECT DeviceObject, PIRP Irp)
{
  ...
  PVOID v20; // rsi
  struct SYSMM_ADAPTER *v21; // rcx

  DeviceExtension = (char *)DeviceObject->DeviceExtension;
  v5 = *((_QWORD *)DeviceExtension + 5);
  AcquireMiniportListMutex();
  if ( (PDEVICE_OBJECT)qword_1C0130748 == DeviceObject )
  {
  ...
  if ( *((_DWORD *)DeviceExtension + 4) == 1953656900 )
  {
    if ( (unsigned int)(*((_DWORD *)DeviceExtension + 5) - 2) > 1
      ...
      || (DpiFdoHandleStopDevice(DeviceObject, Irp), *((_DWORD *)DeviceExtension + 4) == 1953656900) )
    {
...
LABEL_48:
  ...
  if ( *((_DWORD *)DeviceExtension + 4) == 1953656900 && *((_DWORD *)DeviceExtension + 5) == 2 )
  {
    ...
    v21 = (struct SYSMM_ADAPTER *)*((_QWORD *)v20 + 709);
    if ( v21 )
    {
      SysMmDestroyAdapter(v21);
      *((_QWORD *)v20 + 709) = 0LL;
    }
  }
