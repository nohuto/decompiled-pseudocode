/*
 * XREFs of ?DdiGetDPAddress@ADAPTER_DISPLAY@@QEAAJPEAU_DXGKARG_GETDPADDRESS@@@Z @ 0x1C02C9AB4
 * Callers:
 *     NtDxgkDisplayPortOperation @ 0x1C004E190 (NtDxgkDisplayPortOperation.c)
 *     ?GetDisplayPortAddress@KernelDriver@@UEBAJPEAU_DXGKARG_GETDPADDRESS@@@Z @ 0x1C03B94F0 (-GetDisplayPortAddress@KernelDriver@@UEBAJPEAU_DXGKARG_GETDPADDRESS@@@Z.c)
 * Callees:
