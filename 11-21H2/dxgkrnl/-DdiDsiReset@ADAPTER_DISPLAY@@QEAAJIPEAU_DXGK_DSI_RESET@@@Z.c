/*
 * XREFs of ?DdiDsiReset@ADAPTER_DISPLAY@@QEAAJIPEAU_DXGK_DSI_RESET@@@Z @ 0x1C02C8DD4
 * Callers:
 *     ?DdiDsiReset@KernelDriver@@UEAAJPEAU_DXGK_DSI_RESET@@@Z @ 0x1C03B9450 (-DdiDsiReset@KernelDriver@@UEAAJPEAU_DXGK_DSI_RESET@@@Z.c)
 * Callees:
