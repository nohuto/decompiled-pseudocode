/*
 * XREFs of ?HandleAdapterTeardownEvent@@YAXPEAU_DEVICE_OBJECT@@PEAXPEAU_IO_WORKITEM@@@Z @ 0x1C02BBC00
 * Callers:
...
void __fastcall HandleAdapterTeardownEvent(PVOID IoObject, _DWORD *Context, PIO_WORKITEM IoWorkItem)
{
  ...
  _InterlockedIncrement((volatile signed __int32 *)DXGGLOBAL_GetGlobal() + 380);
