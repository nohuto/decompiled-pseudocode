/*
 * XREFs of ?SetGivenPathDataFromActivePath@CCD_TOPOLOGY@@QEAAXPEAUD3DKMT_PATHMODALITY_DESCRIPTOR@@PEBV1@@Z @ 0x1C03A9EFC
 * Callers:
        ...
        if ( (v8 & 0x1000000) != 0 )
        {
          if ( (v9 & 0x800000000LL) != 0 )
          {
            ...
            if ( v11 * (unsigned __int64)*(unsigned int *)(v7 + v5 + 288) > v12
              ...
              || v11 * (unsigned __int64)(unsigned int)v10 < v12
