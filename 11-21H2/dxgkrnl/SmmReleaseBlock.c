/*
 * XREFs of SmmReleaseBlock @ 0x1C006FEF4
 * Callers:
 ...
 * Callees:
 *     SmmCoalesceBlocks @ 0x1C006FA98 (SmmCoalesceBlocks.c)
 */
...
_QWORD *__fastcall SmmReleaseBlock(__int64 a1, _QWORD *a2)
{
  ...
  if ( (((unsigned __int8)v2 ^ (unsigned __int8)(v5[4] >> 53)) & 0x3F) == 0 && (v5[4] & 0x10000000000000LL) == 0 )
