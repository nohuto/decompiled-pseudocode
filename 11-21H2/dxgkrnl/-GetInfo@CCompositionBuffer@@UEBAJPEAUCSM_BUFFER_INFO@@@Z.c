/*
 * XREFs of ?GetInfo@CCompositionBuffer@@UEBAJPEAUCSM_BUFFER_INFO@@@Z @ 0x1C00787E0
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall CCompositionBuffer::GetInfo(CCompositionBuffer *this, struct CSM_BUFFER_INFO *a2)
{
  ...
  *((_OWORD *)a2 + 9) = *((_OWORD *)this + 11);
  result = (*(__int64 (__fastcall **)(CCompositionBuffer *, __int64 *))(*(_QWORD *)this + 224LL))(this, &v5);
  if ( (int)result >= 0 )
  {
    v4 = v5;
