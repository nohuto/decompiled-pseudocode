/*
 * XREFs of ?EnqueueConsumerUpdate@CFlipManager@@QEAAXPEAVCFlipPresentUpdate@@@Z @ 0x1C007D5B8
 * Callers:
...
void __fastcall CFlipManager::EnqueueConsumerUpdate(PRKEVENT *this, struct CFlipPresentUpdate *a2)
{
  ...
  *v6 = v5;
  v2[1] = v5;
  v7 = *(void (__fastcall **)(_QWORD, PRKEVENT))(*((_QWORD *)DXGGLOBAL_GetGlobal() + 38073) + 136LL);
  this[21] = (PRKEVENT)((char *)this[21] + 1);
  v7(*((unsigned int *)this + 82), this[21]);
