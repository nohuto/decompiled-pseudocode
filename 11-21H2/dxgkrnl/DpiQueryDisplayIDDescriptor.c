/*
 * XREFs of DpiQueryDisplayIDDescriptor @ 0x1C021B2C4
 * Callers:
 *     ?GetDisplayIdDescriptor@KernelDriver@@UEBAJPEAIPEAE@Z @ 0x1C021B2A0 (-GetDisplayIdDescriptor@KernelDriver@@UEBAJPEAIPEAE@Z.c)
 * Callees:
...
LABEL_3:
    ...
    *(_QWORD *)&v17.Flags.0 = 0LL;
    ...
    v10 = DXGADAPTER::DdiQueryAdapterInfo(*(DXGADAPTER **)(v5 + 3896), &v17, v9);
  ...
  if ( a3 )
  {
    ...
    memmove(a3, *(const void **)(v7 + 120), v14);
    return 0LL;
  }
  else
  {
