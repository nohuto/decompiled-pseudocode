/*
 * XREFs of ?GetUsageParams@EdidMonitorDescriptor@DxgMonitor@@UEBAJAEAW4DISPLAY_USE_CASE@@AEA_N1@Z @ 0x1C0219150
 * Callers:
 *     <none>
 * Callees:
        ...
        bool *a4)
{
  ...
  v14 = 0;
  DxgMonitor::EdidMonitorDescriptor::GetRawDescriptor(this, &v15, &v14, (__int64)a4);
  v7 = a2;
  v8 = v15;
