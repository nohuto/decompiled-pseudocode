/*
 * XREFs of ?_EnableDisableMonitorInternal@MONITOR_MGR@@QEAAJIEW4MONITOR_EVENT@@_KPEAU_DXGK_DISPLAY_SCENARIO_CONTEXT@@PEAE@Z @ 0x1C01F252C
 * Callers:
 ...
 *     ?_ChangePowerStatus@DXGMONITOR@@QEAAX_N@Z @ 0x1C01F26F4 (-_ChangePowerStatus@DXGMONITOR@@QEAAX_N@Z.c)
        ...
        _BYTE *a7)
{
  ...
  __int64 v18; // rdx
  DXGMONITOR *v19; // rcx
  struct _KTHREAD **v20; // [rsp+30h] [rbp-48h] BYREF
  struct DXGFASTMUTEX *v21; // [rsp+38h] [rbp-40h] BYREF
  struct _KTHREAD **v22[2]; // [rsp+40h] [rbp-38h] BYREF
      ...
      if ( (_DWORD)v7 == -1 || *(_DWORD *)(v14 + 180) == (_DWORD)v7 )
      {
        ...
        if ( *(_DWORD *)(v14 + 312) != 1 )
        {
          ...
          if ( v18 )
          {
            ...
            RESOURCE_LOCK<DXGMONITOR>::RESOURCE_LOCK<DXGMONITOR>(&v20, v18, 1);
            ...
            if ( v20 )
            {
              ExReleaseResourceLite((PERESOURCE)(v20 + 3));
              KeLeaveCriticalRegion();
            }
          }
        }
