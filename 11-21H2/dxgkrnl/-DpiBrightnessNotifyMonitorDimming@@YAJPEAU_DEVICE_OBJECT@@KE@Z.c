/*
 * XREFs of ?DpiBrightnessNotifyMonitorDimming@@YAJPEAU_DEVICE_OBJECT@@KE@Z @ 0x1C0390148
 * Callers:
...
__int64 __fastcall DpiBrightnessNotifyMonitorDimming(struct _DEVICE_OBJECT *a1, int a2)
{
  ...
  if ( a2 == -1 )
  {
    v4 = *((_DWORD *)DeviceExtension + 871);
    if ( v4 == -1 )
      return (unsigned int)-1073741637;
  }
  KeEnterCriticalRegion();
  v6 = (struct _ERESOURCE *)(DeviceExtension + 3304);
  ExAcquireResourceSharedLite((PERESOURCE)(DeviceExtension + 3304), 1u);
  v7 = (_QWORD **)(DeviceExtension + 3464);
  v8 = *v7;
  while ( v8 != v7 )
  {
    v9 = v8 - 4;
