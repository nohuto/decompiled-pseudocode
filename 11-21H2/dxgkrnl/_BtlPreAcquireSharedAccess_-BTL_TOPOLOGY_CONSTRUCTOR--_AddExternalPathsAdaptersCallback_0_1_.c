/*
 * XREFs of _BtlPreAcquireSharedAccess_&BTL_TOPOLOGY_CONSTRUCTOR::_AddExternalPathsAdaptersCallback_0_1_ @ 0x1C03ACE10
 * Callers:
 *     <none>
 * Callees:
...
LABEL_7:
  ...
  v7 = BTL_TOPOLOGY_CONSTRUCTOR::_AddExternalPathsAdaptersCallback(v9, a2);
LABEL_9:
