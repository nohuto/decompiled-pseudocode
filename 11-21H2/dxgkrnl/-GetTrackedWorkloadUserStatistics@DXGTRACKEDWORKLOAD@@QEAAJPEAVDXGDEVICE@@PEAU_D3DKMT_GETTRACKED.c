/*
 * XREFs of ?GetTrackedWorkloadUserStatistics@DXGTRACKEDWORKLOAD@@QEAAJPEAVDXGDEVICE@@PEAU_D3DKMT_GETTRACKEDWORKLOADSTATISTICS@@@Z @ 0x1C0345098
 * Callers:
 *     NtDxgkGetTrackedWorkloadStatistics @ 0x1C0346A50 (NtDxgkGetTrackedWorkloadStatistics.c)
 * Callees:
 *     memset @ 0x1C002CFC0 (memset.c)
 *     ?GetStats@CumulativeStats@@QEAAXPEAN000PEA_K@Z @ 0x1C0081CD4 (-GetStats@CumulativeStats@@QEAAXPEAN000PEA_K@Z.c)
 *     ?IsSaturated@TrackedWorkloadMonitor@@QEAA_NXZ @ 0x1C0081F30 (-IsSaturated@TrackedWorkloadMonitor@@QEAA_NXZ.c)
 */
