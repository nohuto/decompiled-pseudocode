/*
 * XREFs of ?_GetColorPrimariesType@MonitorColorState@DxgMonitor@@AEBA?AW4ColorPrimaryType@12@XZ @ 0x1C0209C74
 * Callers:
 ...
 * Callees:
 *     ?_GetDeltaBetweenPoints@MonitorColorState@DxgMonitor@@CANNNNN@Z @ 0x1C0209ED4 (-_GetDeltaBetweenPoints@MonitorColorState@DxgMonitor@@CANNNNN@Z.c)
 *     ?_GetColorGamutTriangleArea@MonitorColorState@DxgMonitor@@CANNNNNNN@Z @ 0x1C0209F90 (-_GetColorGamutTriangleArea@MonitorColorState@DxgMonitor@@CANNNNNNN@Z.c)
 */
...
__int64 __fastcall DxgMonitor::MonitorColorState::_GetColorPrimariesType(_DWORD *a1)
{
  ...
  v12 = (float)((float)((float)v6 * 0.0009765625) + 0.00050000002);
