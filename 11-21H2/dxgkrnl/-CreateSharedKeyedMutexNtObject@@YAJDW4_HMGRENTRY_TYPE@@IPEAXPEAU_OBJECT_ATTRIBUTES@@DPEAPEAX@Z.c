/*
 * XREFs of ?CreateSharedKeyedMutexNtObject@@YAJDW4_HMGRENTRY_TYPE@@IPEAXPEAU_OBJECT_ATTRIBUTES@@DPEAPEAX@Z @ 0x1C031B3B0
 * Callers:
        ...
        _QWORD *a7)
{
  ...
  if ( (((unsigned int)v7 >> 25) & 0x60) != (*(_BYTE *)(v12 + 16 * v11 + 8) & 0x60)
    || (v13 & 0x2000) != 0
    || (v13 & 0x1F) == 0 )
  {
    goto LABEL_9;
...
LABEL_10:
  ...
  v17 = *(DXGKEYEDMUTEX **)(v12 + 16LL * (unsigned int)v11);
  if ( !v17 )
    goto LABEL_9;
