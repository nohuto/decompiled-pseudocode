/*
 * XREFs of ?SysMmCreateSectionPhysicalObject@@YAJPEAUSYSMM_ADAPTER@@_KKPEAU_OBJECT_ATTRIBUTES@@KPEAXW4_MEMORY_CACHING_TYPE@@QEAXW4SYSMM_PHYSICAL_OBJECT_OWNER@@PEAPEAUSYSMM_PHYSICAL_OBJECT@@PEAPEAUSYSMM_ADAPTER_OBJECT@@@Z @ 0x1C03C0B1C
 * Callers:
 *     DxgkCreatePhysicalMemoryObjectCB @ 0x1C0054840 (DxgkCreatePhysicalMemoryObjectCB.c)
 *     SysMmTestCreateSectionPhysicalObject @ 0x1C0071290 (SysMmTestCreateSectionPhysicalObject.c)
 * Callees:
        ...
        __int64 a11)
{
  ...
  {
    _InterlockedIncrement(&dword_1C0130B44);
