/*
 * XREFs of ?FindOutputDuplManager@@YAJPEAVDXGADAPTER@@IPEAPEAV1@PEA_K12PEAPEAVOUTPUTDUPL_MGR@@@Z @ 0x1C01A5388
 * Callers:
        ...
        struct OUTPUTDUPL_MGR **a7)
{
  ...
  else
  {
    ...
    *a7 = *(struct OUTPUTDUPL_MGR **)(*((_QWORD *)*a5 + 349) + 120LL);
    return 0LL;
  }
}
