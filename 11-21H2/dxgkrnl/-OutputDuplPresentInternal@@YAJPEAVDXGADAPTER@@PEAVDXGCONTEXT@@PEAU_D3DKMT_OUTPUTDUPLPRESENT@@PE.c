/*
 * XREFs of ?OutputDuplPresentInternal@@YAJPEAVDXGADAPTER@@PEAVDXGCONTEXT@@PEAU_D3DKMT_OUTPUTDUPLPRESENT@@PEAPEAV2@@Z @ 0x1C0322F58
 * Callers:
...
{
  int IsRemoteSessionUsingXddmMonitors; // r15d
  ...
  {
    v9 = (struct DXGADAPTER **)DXGADAPTER_REFERENCE::operator&(&v19);
    v10 = (struct DXGADAPTER **)DXGADAPTER_REFERENCE::operator&(&v21);
    OutputDuplManager = FindOutputDuplManager(a1, a3->VidPnSourceId, v10, &v22, v9, &v20, &v18);
  ...
  if ( VidPnSourceId >= *((_DWORD *)RemoteOutputDuplMgr + 19) )
  {
  ...
  if ( OutputDuplManager >= 0 )
  {
    ...
    if ( ADAPTER_DISPLAY::IsVidPnSourceOwner(v16, *((const struct DXGDEVICE **)a2 + 2), a3->VidPnSourceId) )
    {
LABEL_16:
    ...
    {
      WdLogSingleEntry2(3LL, a2, a3->VidPnSourceId);
