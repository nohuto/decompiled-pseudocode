/*
 * XREFs of ?Reset@DISPLAY_SOURCE@@AEAAJPEAU_TDR_RECOVERY_CONTEXT@@@Z @ 0x1C02C2744
 * Callers:
...
__int64 __fastcall DISPLAY_SOURCE::Reset(DISPLAY_SOURCE *this, struct _TDR_RECOVERY_CONTEXT *a2)
{
  ...
  *(_QWORD *)((char *)this + 1124) = 0LL;
  ...
  if ( v5 )
    memset(v5, 0, 4 * *(unsigned int *)(v3 + 2112) * (unsigned __int64)*(unsigned int *)(v3 + 2116));
  v6 = (void *)*((_QWORD *)this + 111);
  if ( v6 )
    memset(v6, 0, 4 * *(unsigned int *)(v3 + 2116) * (unsigned __int64)*(unsigned int *)(v3 + 2112));
  v7 = *(_QWORD *)(*(_QWORD *)(*((_QWORD *)this + 1) + 16LL) + 2800LL);
  if ( v7 )
    (*(void (__fastcall **)(_QWORD, _QWORD, _QWORD, char *, _QWORD))(*(_QWORD *)(*(_QWORD *)(v7 + 624) + 8LL) + 520LL))(
      *(_QWORD *)(v7 + 632),
      *((unsigned int *)this + 4),
      0LL,
      (char *)this + 1008,
