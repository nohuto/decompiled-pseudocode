/*
 * XREFs of ?WaitForPnPTransitionDone@DXGSESSIONMGR@@QEAAJW4_KWAIT_REASON@@DIW4_PNP_TRANSITION_WAITER@@@Z @ 0x1C01C010C
 * Callers:
        ...
        unsigned int a5)
{
  ...
  if ( (unsigned int)v6 >= *(_DWORD *)(a1 + 80) || (v10 = (unsigned int)v6, !*(_QWORD *)(*(_QWORD *)(a1 + 48) + 8 * v6)) )
  {
    v10 = v6;
    v19 = -1073741583LL;
    WdLogSingleEntry2(2LL, v10, -1073741583LL);
  ...
  {
    v16 = -1073741811;
    WdLogSingleEntry2(2LL, (unsigned int)v6, -1073741811LL);
