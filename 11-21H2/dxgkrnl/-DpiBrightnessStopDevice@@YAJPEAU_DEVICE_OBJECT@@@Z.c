/*
 * XREFs of ?DpiBrightnessStopDevice@@YAJPEAU_DEVICE_OBJECT@@@Z @ 0x1C0390508
 * Callers:
...
__int64 __fastcall DpiBrightnessStopDevice(struct _DEVICE_OBJECT *a1)
{
  ...
  if ( *((_WORD *)DeviceExtension + 2332) )
  {
    ...
    {
      v4 = *((_WORD *)DeviceExtension + 2333);
      if ( v4 == 2 || v4 == 3 )
      {
        v5 = (void (__fastcall *)(_QWORD))*((_QWORD *)DeviceExtension + 586);
        if ( v5 )
          v5(*((_QWORD *)DeviceExtension + 584));
      }
    }
    memset(DeviceExtension + 4664, 0, 0x58uLL);
    if ( v3 >= 0 )
