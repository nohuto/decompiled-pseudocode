/*
 * XREFs of ?wil_details_OnFeatureConfigurationChange@@YAXPEAX@Z @ 0x1C0301930
 * Callers:
 *     <none>
 * Callees:
...
void __fastcall wil_details_OnFeatureConfigurationChange(void *a1)
{
  ...
  v9 = 0;
  for ( i = &wil_details_featureDescriptors_a; ; i = (const unsigned __int64 *)(v5 + 6) )
  {
  ...
  for ( j = &wil_details_featureDescriptors_a; ; j = (const unsigned __int64 *)(v8 + 6) )
  {
