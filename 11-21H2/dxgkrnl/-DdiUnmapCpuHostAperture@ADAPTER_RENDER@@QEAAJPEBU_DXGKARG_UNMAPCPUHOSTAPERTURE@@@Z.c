/*
 * XREFs of ?DdiUnmapCpuHostAperture@ADAPTER_RENDER@@QEAAJPEBU_DXGKARG_UNMAPCPUHOSTAPERTURE@@@Z @ 0x1C01EE490
 * Callers:
 *     ?ADAPTER_RENDER_DdiUnmapCpuHostAperture@@YAJPEAVADAPTER_RENDER@@PEBU_DXGKARG_UNMAPCPUHOSTAPERTURE@@@Z @ 0x1C0021A70 (-ADAPTER_RENDER_DdiUnmapCpuHostAperture@@YAJPEAVADAPTER_RENDER@@PEBU_DXGKARG_UNMAPCPUHOSTAPERTUR.c)
 * Callees:
        ...
        __int64 a3)
{
  ...
  DXGETWPROFILER_BASE::PushProfilerEntry((__int64)&v16, 5062);
  ...
  v10 = (*(int (__fastcall **)(_QWORD, const struct _DXGKARG_UNMAPCPUHOSTAPERTURE *))(*((_QWORD *)this + 2) + 960LL))(
