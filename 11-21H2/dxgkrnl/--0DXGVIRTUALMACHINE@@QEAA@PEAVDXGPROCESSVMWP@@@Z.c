/*
 * XREFs of ??0DXGVIRTUALMACHINE@@QEAA@PEAVDXGPROCESSVMWP@@@Z @ 0x1C03349D8
 * Callers:
...
DXGVIRTUALMACHINE *__fastcall DXGVIRTUALMACHINE::DXGVIRTUALMACHINE(DXGVIRTUALMACHINE *this, struct DXGPROCESSVMWP *a2)
{
  ...
  *((_QWORD *)this + 35) = 0LL;
  ...
  v9 = (struct DXGGLOBAL **)*((_QWORD *)Global + 220);
  if ( *v9 != (struct DXGGLOBAL *)((char *)Global + 1752) )
    __fastfail(3u);
  *((_QWORD *)this + 2) = v9;
  *(_QWORD *)v8 = (char *)Global + 1752;
  *v9 = v8;
  *((_QWORD *)Global + 220) = v8;
  ++*((_DWORD *)Global + 442);
