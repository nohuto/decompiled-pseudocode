/*
 * XREFs of ?_ProcessVidPn@CCD_BTL_ACTIVE_PATHS_COLLECTOR@@AEAAJPEAVDMMVIDPN@@_N@Z @ 0x1C01AB8B4
 * Callers:
        ...
        bool a3)
{
  ...
  while ( 1 )
  {
    ...
    result = CCD_BTL_ACTIVE_PATHS_COLLECTOR::_ProcessVidPnPath(this, *(struct DXGADAPTER **)(v10 + 16), v8, 1, a3);
    v6 = result;
    if ( result < 0 )
      break;
