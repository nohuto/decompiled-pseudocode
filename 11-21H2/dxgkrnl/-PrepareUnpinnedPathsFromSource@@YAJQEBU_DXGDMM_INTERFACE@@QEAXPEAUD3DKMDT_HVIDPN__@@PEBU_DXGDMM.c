/*
 * XREFs of ?PrepareUnpinnedPathsFromSource@@YAJQEBU_DXGDMM_INTERFACE@@QEAXPEAUD3DKMDT_HVIDPN__@@PEBU_DXGDMM_VIDPN_INTERFACE@@PEAUD3DKMDT_HVIDPNTOPOLOGY__@@QEBU_DXGDMM_VIDPNTOPOLOGY_INTERFACE@@IEEEQEA_KPEAY0BA@IPEAE@Z @ 0x1C01D35DC
 * Callers:
        ...
        unsigned __int8 *a13)
{
  ...
  if ( !a1 )
  {
    WdLogSingleEntry1(1LL, 4463LL);
    DxgkLogInternalTriageEvent(0LL, 262146, -1, (__int64)L"i_pDxgDmmInterface != NULL", 4463LL, 0LL, 0LL, 0LL, 0LL);
  }
  if ( !a2 )
  {
    WdLogSingleEntry1(1LL, 4464LL);
    DxgkLogInternalTriageEvent(0LL, 262146, -1, (__int64)L"i_hDxgAdapter != NULL", 4464LL, 0LL, 0LL, 0LL, 0LL);
  }
  if ( !a3 )
  {
    WdLogSingleEntry1(1LL, 4465LL);
    DxgkLogInternalTriageEvent(0LL, 262146, -1, (__int64)L"i_hVidPn != NULL", 4465LL, 0LL, 0LL, 0LL, 0LL);
  }
  if ( !a4 )
  {
    WdLogSingleEntry1(1LL, 4466LL);
    DxgkLogInternalTriageEvent(0LL, 262146, -1, (__int64)L"i_pDmmVidPnInterface != NULL", 4466LL, 0LL, 0LL, 0LL, 0LL);
  }
  if ( !a5 )
  {
    WdLogSingleEntry1(1LL, 4467LL);
    DxgkLogInternalTriageEvent(0LL, 262146, -1, (__int64)L"i_hVidPnTopology != NULL", 4467LL, 0LL, 0LL, 0LL, 0LL);
  }
  if ( !a6 )
  {
    WdLogSingleEntry1(1LL, 4468LL);
  ...
  *a11 = 0LL;
  ...
  if ( v20 == -1071774919 )
  {
    if ( v41 )
    {
      WdLogSingleEntry1(1LL, 4501LL);
      DxgkLogInternalTriageEvent(0LL, 262146, -1, (__int64)L"sztNumPathsFromSource == 0", 4501LL, 0LL, 0LL, 0LL, 0LL);
    }
    v19 = 1;
    v39 = 1;
    v27 = a7;
...
LABEL_31:
  if ( !v28 )
  {
    WdLogSingleEntry1(1LL, 4667LL);
    DxgkLogInternalTriageEvent(0LL, 262146, -1, (__int64)L"sztNumPathsFromSource > 0", 4667LL, 0LL, 0LL, 0LL, 0LL);
    v28 = v41;
  }
  if ( a9 )
  {
