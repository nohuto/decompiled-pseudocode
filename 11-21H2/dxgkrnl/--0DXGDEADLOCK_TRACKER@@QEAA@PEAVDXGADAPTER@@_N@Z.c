/*
 * XREFs of ??0DXGDEADLOCK_TRACKER@@QEAA@PEAVDXGADAPTER@@_N@Z @ 0x1C01E07D0
 * Callers:
        ...
        char a3)
{
  ...
  *((_QWORD *)this + 24) = this;
  ...
  ExAcquirePushLockExclusiveEx(v5 + 4600, 0LL);
  *(_QWORD *)(v5 + 4608) = KeGetCurrentThread();
  v6 = (__int64 *)((char *)this + 224);
  v7 = *((_QWORD *)this + 3) + 4624LL;
  v8 = *(__int64 ***)(*((_QWORD *)this + 3) + 4632LL);
  if ( *v8 != (__int64 *)v7 )
    __fastfail(3u);
  *v6 = v7;
  *((_QWORD *)this + 29) = v8;
  *v8 = v6;
  *(_QWORD *)(v7 + 8) = v6;
  v9 = *((_QWORD *)this + 3) + 4600LL;
  *(_QWORD *)(v9 + 8) = 0LL;
  ExReleasePushLockExclusiveEx(v9, 0LL);
  KeLeaveCriticalRegion();
  if ( *(_DWORD *)(*((_QWORD *)this + 3) + 4596LL) == 1 )
