/*
 * XREFs of ?AddUsb4HRPowerRef@Usb4HostRouterPoFxRef@DxgMonitor@@QEAAJPEAUUSB4_POFXREF_CONTEXT@@@Z @ 0x1C0157F9C
 * Callers:
        ...
        __int64 a3)
{
  ...
  if ( !*((_BYTE *)this + 24) || (WdLogSingleEntry0(1LL), !*((_BYTE *)this + 24)) )
  {
    if ( a2 )
    {
