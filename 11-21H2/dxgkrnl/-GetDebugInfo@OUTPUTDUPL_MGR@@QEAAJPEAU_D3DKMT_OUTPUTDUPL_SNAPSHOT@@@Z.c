/*
 * XREFs of ?GetDebugInfo@OUTPUTDUPL_MGR@@QEAAJPEAU_D3DKMT_OUTPUTDUPL_SNAPSHOT@@@Z @ 0x1C0320F7C
 * Callers:
 ...
 *     ?GetDebugInfo@OUTPUTDUPL_CONTEXT@@QEAAXPEAU_OUTPUTDUPL_CONTEXT_DEBUG_INFO@@@Z @ 0x1C0326668 (-GetDebugInfo@OUTPUTDUPL_CONTEXT@@QEAAXPEAU_OUTPUTDUPL_CONTEXT_DEBUG_INFO@@@Z.c)
 */
...
__int64 __fastcall OUTPUTDUPL_MGR::GetDebugInfo(UINT *this, struct _D3DKMT_OUTPUTDUPL_SNAPSHOT *a2)
{
  ...
  if ( !(unsigned int)OUTPUTDUPL_MGR::IsDiagRegKeyEnabled((OUTPUTDUPL_MGR *)this) )
    return 3221225506LL;
  v5 = this[19];
  if ( a2->Size < (unsigned __int64)(56 * v5 * this[2]) + 24 )
  {
        ...
        (SessionDataForSpecifiedSession = DXGSESSIONMGR::GetSessionDataForSpecifiedSession(v13, CurrentProcessSessionId)) != 0LL) )
  {
    ...
    v17 = 2193LL;
    WdLogSingleEntry1(2LL, 2193LL);
    v18 = L"OUTPUTDUPL_SESSION_MGR is NULL";
  }
  else
  {
    v17 = 2186LL;
    WdLogSingleEntry1(2LL, 2186LL);
