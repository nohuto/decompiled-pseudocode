/*
 * XREFs of ?NotifySharedPowerGraphicsPowerTransition@DXGGLOBAL@@QEAAXQEAXW4_DEVICE_POWER_STATE@@E@Z @ 0x1C030AC28
 * Callers:
        ...
        char a4)
{
  ...
  for ( i = (__int64 **)*((_QWORD *)this + 232); i != (__int64 **)((char *)this + 1856) && i; i = (__int64 **)*i )
  {
    if ( i[4] == a2 && i[5] )
    {
