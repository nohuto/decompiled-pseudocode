/*
 * XREFs of ?RegisterTtmDevice@CTTMDEVICE@@QEAAJPEAVDXGSESSIONDATA@@@Z @ 0x1C03480AC
 * Callers:
...
__int64 __fastcall CTTMDEVICE::RegisterTtmDevice(CTTMDEVICE *this, struct DXGSESSIONDATA *a2)
{
  ...
  v12[1] = 0LL;
  v12[3] = 0LL;
  if ( *(struct _KTHREAD **)(*((_QWORD *)DXGGLOBAL_GetGlobal() + 122) + 344LL) != KeGetCurrentThread() )
  {
    WdLogSingleEntry1(1LL, 5921LL);
