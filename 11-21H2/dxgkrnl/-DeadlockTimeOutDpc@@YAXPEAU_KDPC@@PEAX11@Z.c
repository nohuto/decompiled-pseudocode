/*
 * XREFs of ?DeadlockTimeOutDpc@@YAXPEAU_KDPC@@PEAX11@Z @ 0x1C0043990
 * Callers:
 *     <none>
 * Callees:
        ...
        PVOID SystemArgument2)
{
  ...
  v28 = *(_QWORD *)(v4 + 404);
  if ( !_InterlockedCompareExchange64((volatile signed __int64 *)(v4 + 4560), UnbiasedInterruptTime, 0LL) )
  {
    ...
    if ( (unsigned int)dword_1C012F918 > 5 )
    {
      if ( tlgKeywordOn((__int64)&dword_1C012F918, 0x400000004000LL) )
      {
        ...
        v15 = *(_DWORD *)(v4 + 2888);
        v16 = *(unsigned __int8 *)(v4 + 2742);
        v17 = *(_DWORD *)(v4 + 4592);
        v18 = *(_DWORD *)(v4 + 4588);
        v19 = *(unsigned __int8 *)(v4 + 209);
        v8 = UnbiasedInterruptTime - *(_QWORD *)DeferredContext;
        v20 = *(unsigned __int8 *)(v4 + 2636);
        v21 = *(unsigned __int8 *)(v4 + 2631);
        v22 = *(_DWORD *)(v4 + 288);
        v35 = *(_WORD *)(v4 + 2692);
        v30 = *(_QWORD *)(v4 + 1696);
        v31 = *(void **)(v4 + 1688);
