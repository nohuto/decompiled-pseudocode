/*
 * XREFs of ?DisplayID_GetNativeLuminance@@YAJPEBUDisplayIDObj@@PEAK11PEAI@Z @ 0x1C00724C0
 * Callers:
 ...
 *     ?GetHdrLuminance@DisplayIdMonitorDescriptor@DxgMonitor@@UEBAJAEAK00@Z @ 0x1C03BB0E0 (-GetHdrLuminance@DisplayIdMonitorDescriptor@DxgMonitor@@UEBAJAEAK00@Z.c)
 * Callees:
 *     ?ConvertHalfToFloat@@YAMG@Z @ 0x1C0072238 (-ConvertHalfToFloat@@YAMG@Z.c)
 *     ?IsValidBlock@DisplayID_DisplayParameters_Parser@@QEBA_NXZ @ 0x1C0072608 (-IsValidBlock@DisplayID_DisplayParameters_Parser@@QEBA_NXZ.c)
