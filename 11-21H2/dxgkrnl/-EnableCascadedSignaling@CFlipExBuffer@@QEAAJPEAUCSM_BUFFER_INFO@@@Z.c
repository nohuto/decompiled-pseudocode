/*
 * XREFs of ?EnableCascadedSignaling@CFlipExBuffer@@QEAAJPEAUCSM_BUFFER_INFO@@@Z @ 0x1C0078BA8
 * Callers:
...
__int64 __fastcall CFlipExBuffer::EnableCascadedSignaling(CFlipExBuffer *this, struct CSM_BUFFER_INFO *a2)
{
  ...
  *((_QWORD *)a2 + 147) = *((_QWORD *)this + 80);
  ...
  LODWORD(v18) = 31;
  LOBYTE(v10) = 1;
  v6 = (*(__int64 (__fastcall **)(CFlipExBuffer *, __int64, void (__fastcall ****)(_QWORD), _BYTE *))(v11 + 72))(
         this,
         v10,
         &v18,
         v20);
