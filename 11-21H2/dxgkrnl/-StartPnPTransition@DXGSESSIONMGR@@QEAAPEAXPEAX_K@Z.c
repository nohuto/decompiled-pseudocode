/*
 * XREFs of ?StartPnPTransition@DXGSESSIONMGR@@QEAAPEAXPEAX_K@Z @ 0x1C01FD198
 * Callers:
...
_QWORD *__fastcall DXGSESSIONMGR::StartPnPTransition(DXGSESSIONMGR *this, _QWORD *a2, __int64 a3)
{
  ...
  if ( !a2 )
  {
    v11 = ExAllocateFromNPagedLookasideList((PNPAGED_LOOKASIDE_LIST)((char *)this + 192));
    a2 = v11;
    if ( !v11 )
    {
      WdLogSingleEntry1(6LL, 5293LL);
