/*
 * XREFs of ?DxgkrnlLogBuildPagingBufferInformation@ADAPTER_RENDER@@AEAAXJPEAU_DXGKARG_BUILDPAGINGBUFFER@@@Z @ 0x1C017AE90
 * Callers:
  ...
  else
  {
    ...
    switch ( Operation )
    {
      ...
      case DXGK_OPERATION_UNMAP_APERTURE_SEGMENT:
        ...
        v14[5] = a3->Fill.FillSize;
        v14[6] = a3->Fill.FillPattern;
        break;
