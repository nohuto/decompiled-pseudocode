/*
 * XREFs of ?ConfigureSharedResource@DXGDEVICE@@QEAAJEPEAXIE@Z @ 0x1C0169E90
 * Callers:
        ...
        unsigned __int8 a5)
{
  ...
  {
    WdLogSingleEntry1(1LL, 5435LL);
    DxgkLogInternalTriageEvent(0LL, 262146, -1, (__int64)L"IsDeviceLockExclusiveOwner()", 5435LL, 0LL, 0LL, 0LL, 0LL);
  }
  if ( !(_DWORD)v6 )
  {
    v15 = -1073741811;
