/*
 * XREFs of ?DxgkCddQueryInterface@@YAJPEAU_DXGKCDD_INTERFACE@@PEAK@Z @ 0x1C01E0C3C
 * Callers:
...
__int64 __fastcall DxgkCddQueryInterface(struct _DXGKCDD_INTERFACE *a1, unsigned int *a2)
{
  ...
  DXGADAPTER *v11; // rdi
  _QWORD *v13; // rax
  DXGADAPTER *v14; // [rsp+70h] [rbp+8h] BYREF
  ...
  if ( __PAIR32__(*((_WORD *)a1 + 1), v3) == 590352 )
  {
    ...
    if ( v5 )
    {
      v6 = *((_DWORD *)a1 + 4);
      v14 = 0LL;
      PairingAdapters = DxgkpGetPairingAdapters(v5, v6, 0LL, 0LL, &v14, &v15, 0);
      v10 = PairingAdapters;
      ...
      if ( v11 && !*((_QWORD *)v11 + 349) )
      {
        WdLogSingleEntry1(1LL, 4440LL);
