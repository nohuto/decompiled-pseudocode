/*
 * XREFs of ?_IsWireFormatMatch@MonitorGammaState@DxgMonitor@@AEAA_NAEBU_OUTPUT_WIRE_FORMAT@@@Z @ 0x1C01B4E78
 * Callers:
        ...
        const struct _OUTPUT_WIRE_FORMAT *a2)
{
  ...
  (*(void (__fastcall **)(_QWORD, unsigned int *))(**(_QWORD **)this + 96LL))(*(_QWORD *)this, &v11);
