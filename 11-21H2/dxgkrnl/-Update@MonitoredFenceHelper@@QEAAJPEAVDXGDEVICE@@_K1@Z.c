/*
 * XREFs of ?Update@MonitoredFenceHelper@@QEAAJPEAVDXGDEVICE@@_K1@Z @ 0x1C0345CC0
 * Callers:
        ...
        __int64 a4)
{
  ...
  if ( VidSchSyncObject )
  {
    ...
    v10 = (*(__int64 (__fastcall **)(__int64, struct _VIDSCH_SYNC_OBJECT **, __int64 *, char *, char, char, struct ADAPTER_RENDER *, _QWORD))(*(_QWORD *)(*((_QWORD *)a2[2] + 78) + 8LL) + 664LL))(
            1LL,
            &VidSchSyncObject,
            &v13,
            v11,
