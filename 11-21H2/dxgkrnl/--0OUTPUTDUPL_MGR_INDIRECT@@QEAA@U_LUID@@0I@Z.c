/*
 * XREFs of ??0OUTPUTDUPL_MGR_INDIRECT@@QEAA@U_LUID@@0I@Z @ 0x1C00559BC
 * Callers:
 ...
 *     ??0OUTPUTDUPL_MGR@@QEAA@PEAVADAPTER_DISPLAY@@I@Z @ 0x1C0210B9C (--0OUTPUTDUPL_MGR@@QEAA@PEAVADAPTER_DISPLAY@@I@Z.c)
 */
        ...
        unsigned int a4)
{
  ...
  *((_QWORD *)this + 2) = DXGGLOBAL_GetGlobal();
  *(_OWORD *)this = 0LL;
