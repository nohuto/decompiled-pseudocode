/*
 * XREFs of ?VmBusSendDestroyAllocation@DXG_GUEST_VIRTUALGPU_VMBUS@@QEAAXIIIIPEAPEAVDXGALLOCATION@@U_D3DDDICB_DESTROYALLOCATION2FLAGS@@@Z @ 0x1C0376620
 * Callers:
        ...
        struct _D3DDDICB_DESTROYALLOCATION2FLAGS a7)
{
  ...
  {
    WdLogSingleEntry1(2LL, 10029LL);
    DxgkLogInternalTriageEvent(0LL, 0x40000, -1, (__int64)L"NumAllocations is invalid", 10029LL, 0LL, 0LL, 0LL, 0LL);
  }
}
