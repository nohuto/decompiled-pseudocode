/*
 * XREFs of ?DxgkEtwEnableCallback@@YAXKK_K@Z @ 0x1C0029028
 * Callers:
...
void __fastcall DxgkEtwEnableCallback(int a1, char a2, __int64 a3, int a4)
{
  ...
  {
    if ( qword_1C012F870 == g_OldAnyKeywords )
      goto LABEL_11;
    v6 = 4096LL;
    v7 = (qword_1C012F870 & 0x1000) != 0 && (qword_1C012F870 & 0x2000) == 0;
    if ( (g_OldAnyKeywords & 0x1000) != 0 )
    {
      if ( (qword_1C012F870 & 0x1000) == 0 )
        DxgkDisableStablePowerState();
    }
    else if ( (qword_1C012F870 & 0x1000) != 0 && v7 )
    {
    ...
    LOBYTE(v6) = a2;
    DpiControlEtwLogging(v8, qword_1C012F870 & 0x3000, v6);
LABEL_9:
    if ( _bittest64((const signed __int64 *)&g_OldAnyKeywords, 0xEu) )
    {
      if ( _bittest64(&qword_1C012F870, 0xEu) )
        goto LABEL_11;
  ...
  else
  {
    if ( (Microsoft_Windows_DxgKrnlEnableBits & 0x100) != 0 )
      McTemplateK0qxq_EtwWriteTransfer(2, a2, a3, a4, qword_1C012F870, a2);
    DxgkReportGlobalState();
  }
LABEL_11:
  if ( (qword_1C012F870 & 0x461C8ED7) == 0 || (qword_1C012F878 & 0xFFFFFFFFB9E37128uLL) != 0 )
    v5 = 0;
  bTracingEnabled = v5;
  g_OldAnyKeywords = qword_1C012F870;
}
