/*
 * XREFs of ?DodSetIndirectSwapchain@ADAPTER_DISPLAY@@QEAAJIPEAX@Z @ 0x1C02C0820
 * Callers:
 ...
 *     ?SwapChainOpenInternal@@YAPEAUDXGSWAPCHAIN_CONTAINER@@PEAX@Z @ 0x1C034CD78 (-SwapChainOpenInternal@@YAPEAUDXGSWAPCHAIN_CONTAINER@@PEAX@Z.c)
...
int __fastcall ADAPTER_DISPLAY::DodSetIndirectSwapchain(ADAPTER_DISPLAY *this, __int64 a2, void *a3)
{
  ...
  struct _LUID v7; // rbx
  OUTPUTDUPL_MGR_INDIRECT *v9; // r14
  int updated; // r15d
  __int64 v11; // rdx
...
LABEL_4:
  ...
  if ( v7 )
  {
    ...
    {
      v11 = *((_QWORD *)this + 2);
      v12 = *(__int64 (__fastcall **)(_QWORD, _QWORD, void *, struct _LUID))(v11 + 2008);
      if ( v12 )
      {
  ...
  {
    WdLogSingleEntry1((unsigned int)(v7.HighPart + 2), 8446LL);
    DxgkLogInternalTriageEvent(
      0LL,
      0x40000,
      -1,
