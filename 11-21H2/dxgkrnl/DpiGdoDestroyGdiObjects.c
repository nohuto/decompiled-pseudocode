/*
 * XREFs of DpiGdoDestroyGdiObjects @ 0x1C039834C
 * Callers:
    ...
    *(_QWORD *)(v6 + 8) = v7;
    ...
    if ( !v8 )
    {
      ...
      *(_OWORD *)ValueName = 0LL;
      v10 = *(_QWORD *)(v9 + 64);
      if ( !*(_BYTE *)(*(_QWORD *)(*(_QWORD *)(v10 + 32) + 64LL) + 2743LL)
        && (int)DpiAppendNumberToString(L"\\Device\\Video", *(_DWORD *)(v10 + 152), (PUNICODE_STRING)ValueName) >= 0 )
      {
    ...
    DxgkReleaseGdiViewId(v8, *(_QWORD *)(v1 + 5728), *((_DWORD *)v3 + 38), 0);
