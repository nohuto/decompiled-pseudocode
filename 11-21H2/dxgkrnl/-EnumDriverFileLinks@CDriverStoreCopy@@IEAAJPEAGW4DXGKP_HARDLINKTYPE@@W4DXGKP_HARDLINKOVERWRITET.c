/*
 * XREFs of ?EnumDriverFileLinks@CDriverStoreCopy@@IEAAJPEAGW4DXGKP_HARDLINKTYPE@@W4DXGKP_HARDLINKOVERWRITETYPE@@@Z @ 0x1C0303450
 * Callers:
  ...
  *(_OWORD *)&ObjectAttributes.SecurityDescriptor = 0LL;
  ...
  if ( v5 >= 0 && (_DWORD)v30 )
  {
    ...
    if ( v8 )
    {
      ...
      while ( 1 )
      {
        v5 = ZwEnumerateValueKey(KeyHandle, v9, KeyValueFullInformation, v8, v7, &ResultLength);
        if ( v5 < 0 )
          goto LABEL_30;
        v11 = v8[1];
        if ( v11 != 7 && v11 != 1 )
