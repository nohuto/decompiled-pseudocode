/*
 * XREFs of ?DpiBrightness3GetNitRanges@@YAJPEAXKPEAU_DXGK_BRIGHTNESS_GET_NIT_RANGES_OUT@@@Z @ 0x1C038EB40
 * Callers:
 *     <none>
 * Callees:
        ...
        struct _DXGK_BRIGHTNESS_GET_NIT_RANGES_OUT *a3)
{
  ...
  v3 = a1[8];
  KeWaitForSingleObject((PVOID)(v3 + 4392), Executive, 0, 0, 0LL);
  ...
  KeReleaseMutex((PRKMUTEX)(v3 + 4392), 0);
  return v8;
}
