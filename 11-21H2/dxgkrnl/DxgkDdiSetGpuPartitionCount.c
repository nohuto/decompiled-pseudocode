/*
 * XREFs of DxgkDdiSetGpuPartitionCount @ 0x1C035A3A0
 * Callers:
...
__int64 __fastcall DxgkDdiSetGpuPartitionCount(ADAPTER_RENDER **a1, __int64 a2, unsigned int *a3)
{
  __int64 v5; // rbx
  int v7; // [rsp+28h] [rbp-30h]

  v5 = (int)ADAPTER_RENDER::SetGpuPartitionCount(a1[350], a2, (__int64)a3, 0LL);
  if ( bTracingEnabled )
  {
    v7 = *a3;
