/*
 * XREFs of ?RfxVgpuResetCallback@@YAJPEAVDXGADAPTER@@PEAX@Z @ 0x1C0050320
 * Callers:
 *     <none>
 * Callees:
 ...
 *     DpiIsRfxVgpuDevice @ 0x1C0387500 (DpiIsRfxVgpuDevice.c)
 */
  ...
  if ( *((_DWORD *)a1 + 50) == 1 && (unsigned __int8)DpiIsRfxVgpuDevice(*((_QWORD *)a1 + 27)) )
  {
    ...
    if ( v5 < 0
      || (v6 = *((_QWORD *)a1 + 350),
          ...
          LODWORD(v13[0]) = 6,
          v8 = (*(__int64 (__fastcall **)(__int64, _OWORD *))(*(_QWORD *)(*(_QWORD *)(v6 + 624) + 8LL) + 64LL))(v7, v13),
          v3 = v8,
          v8 < 0) )
    {
