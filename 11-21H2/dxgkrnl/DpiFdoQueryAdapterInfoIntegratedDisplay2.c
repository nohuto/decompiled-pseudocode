/*
 * XREFs of DpiFdoQueryAdapterInfoIntegratedDisplay2 @ 0x1C038AC68
 * Callers:
...
__int64 __fastcall DpiFdoQueryAdapterInfoIntegratedDisplay2(__int64 a1, __int64 a2)
{
  ...
  *(_OWORD *)&v22.OutputDataSize = 0LL;
  ...
  v7 = (int)DXGADAPTER::DdiQueryAdapterInfo(*(DXGADAPTER **)(v3 + 3896), &v22, v6);
  ...
  if ( v10 != 1 )
  {
    ...
    *(_QWORD *)&v21.Flags.0 = 0LL;
    ...
    if ( v15 < 0 )
      goto LABEL_2;
    v7 = (int)DXGADAPTER::DdiQueryAdapterInfo(*(DXGADAPTER **)(v3 + 3896), &v21, v16);
    DpiReleaseCoreSyncAccessSafe(a1, 0);
LABEL_8:
    if ( (int)v7 >= 0 )
      return (unsigned int)v7;
  ...
  *(_WORD *)(a2 + 96) = 0;
  if ( (unsigned __int16)v11 >= 0x80u )
  {
    ...
    v7 = (int)DpiDxgkDdiQueryDeviceDescriptor(
                ...
                *(unsigned int *)(a2 + 24),
                &v18);
    DxgkReleaseAdapterDdiSync(*(DXGADAPTER **)(v3 + 3896));
    goto LABEL_8;
  }
  v7 = -1073741811LL;
LABEL_2:
