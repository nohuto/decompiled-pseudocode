/*
 * XREFs of ??1DXGDEVICE@@QEAA@XZ @ 0x1C016E6F4
 * Callers:
...
void __fastcall DXGDEVICE::~DXGDEVICE(DXGDEVICE *this)
{
  ...
  if ( *((_BYTE *)this + 72) != 1 )
  {
    ...
    DxgkLogInternalTriageEvent(0LL, 262146, -1, (__int64)L"m_InDestructor == TRUE", 685LL, 0LL, 0LL, 0LL, 0LL);
  }
  operator delete(*((void **)this + 235));
  v3 = (void **)((char *)this + 1272);
  v4 = 16LL;
  v5 = (_DWORD *)((char *)this + 1400);
  do
  {
    if ( *(v5 - 112) )
  ...
  v6 = (void *)*((_QWORD *)this + 239);
  if ( v6 )
    operator delete(v6);
  v7 = (struct _SLIST_ENTRY *)*((_QWORD *)this + 56);
