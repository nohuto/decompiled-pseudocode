/*
 * XREFs of ?_CreateAndInsertMonitorEventHandler@MONITOR_MGR@@QEAAJP6AJPEAXI0W4MONITOR_EVENT@@_KW4_DMM_VIDPN_MONITOR_TYPE@@PEAU_DXGK_DISPLAY_SCENARIO_CONTEXT@@@Z0PEAPEAUHDXGMONITOREVENT__@@@Z @ 0x1C02123DC
 * Callers:
        ...
        struct HDXGMONITOREVENT__ **a4)
{
  ...
  MONITOR_MGR *v7; // rbx
  MONITOR_MGR **v8; // rcx
  struct _KTHREAD **v10; // [rsp+40h] [rbp+18h] BYREF
