/*
 * XREFs of ?DdiCreateCpuEvent@ADAPTER_RENDER@@QEAAJPEAU_DXGKARG_CREATECPUEVENT@@@Z @ 0x1C02C6B44
 * Callers:
        ...
        __int64 a3)
{
  ...
  DXGETWPROFILER_BASE::PushProfilerEntry((__int64)&v17, 5158);
  v5 = *((_QWORD *)this + 2);
  if ( *(_QWORD *)(v5 + 1464) )
  {
    ...
    v6 = (*(int (__fastcall **)(_QWORD, struct _DXGKARG_CREATECPUEVENT *))(*((_QWORD *)this + 2) + 1464LL))(
    ...
    if ( (_DWORD)v6 != -1073741801 && (_DWORD)v6 )
    {
