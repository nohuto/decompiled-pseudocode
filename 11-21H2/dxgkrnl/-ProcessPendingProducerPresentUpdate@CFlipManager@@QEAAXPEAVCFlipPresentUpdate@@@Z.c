/*
 * XREFs of ?ProcessPendingProducerPresentUpdate@CFlipManager@@QEAAXPEAVCFlipPresentUpdate@@@Z @ 0x1C007E630
 * Callers:
...
void __fastcall CFlipManager::ProcessPendingProducerPresentUpdate(CFlipManager *this, struct CFlipPresentUpdate *a2)
{
  ...
  (*(void (__fastcall **)(_QWORD, _QWORD, _QWORD))(*((_QWORD *)Global + 38073) + 128LL))(
