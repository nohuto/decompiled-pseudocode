/*
 * XREFs of ?AllocateDefaultSecurityDescriptor@DXGVAILOBJECT@@SAJKPEAPEAX@Z @ 0x1C03500A4
 * Callers:
    ...
    *RtlSubAuthoritySid(Sid, 1u) = 0;
    ...
    if ( v8 )
    {
      ...
      if ( SecurityDescriptor >= 0
        && (Acl = RtlCreateAcl(v9 + 5, v6 + 20, 4u), v5 = Acl, Acl >= 0)
        && (v12 = RtlAddAccessAllowedAce(v9 + 5, 4u, AccessMask, Sid), v5 = v12, v12 >= 0)
        && (v13 = RtlSetDaclSecurityDescriptor(v9, 1u, v9 + 5, 0), v5 = v13, v13 >= 0) )
      {
        *a2 = v9;
      }
      else
