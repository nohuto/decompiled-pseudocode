/*
 * XREFs of DpiKsrRestoreAdapterDriverState @ 0x1C039431C
 * Callers:
 ...
 *     ??1DXGK_ENUMERATE_KSR_MEMORY_CONTEXT@@QEAA@XZ @ 0x1C03930BC (--1DXGK_ENUMERATE_KSR_MEMORY_CONTEXT@@QEAA@XZ.c)
...
__int64 __fastcall DpiKsrRestoreAdapterDriverState(struct _FDO_CONTEXT *a1)
{
  ...
  KsrEnumeratePersistedMemory((char *)a1 + 4784, DpiKsrEnumeratePersistedMemoryCallback, &v11);
  v3 = 0;
  v4 = 0LL;
  if ( (_DWORD)v11 )
  {
    while ( 1 )
    {
      v3 = DpiClaimPersistedMemoryBlock(a1, *(_QWORD *)&v13[8 * v4], (const struct _GUID *)a1 + 299);
      if ( v3 < 0 )
        break;
...
LABEL_6:
  v5 = (char *)a1 + 4800;
  KsrEnumeratePersistedMemory((char *)a1 + 4800, DpiKsrEnumeratePersistedMemoryCallback, &v8);
  v6 = 0LL;
  if ( (_DWORD)v8 )
  {
    while ( 1 )
    {
      v3 = DpiClaimPersistedMemoryBlock(a1, *(_QWORD *)&v10[8 * v6], (const struct _GUID *)a1 + 300);
      if ( v3 < 0 )
        break;
...
LABEL_12:
    LOBYTE(v7) = 1;
    KsrFreePersistedMemory((char *)a1 + 4784, v7);
