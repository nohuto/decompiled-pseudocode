/*
 * XREFs of ?VmBusDestroyAllocation@DXG_HOST_VIRTUALGPU_VMBUS@@SAEPEAUDXGADAPTER_VMBUS_PACKET@@@Z @ 0x1C036BB80
 * Callers:
 *     <none>
 * Callees:
...
char __fastcall DXG_HOST_VIRTUALGPU_VMBUS::VmBusDestroyAllocation(struct DXGADAPTER_VMBUS_PACKET *a1)
{
  ...
  if ( *(_BYTE *)(v2 + 173) )
  {
    ...
    v4 = 1558LL;
    WdLogSingleEntry1(2LL, 1558LL);
    v5 = L"Invalid packet size";
  }
  else
  {
    v4 = 1551LL;
    WdLogSingleEntry1(2LL, 1551LL);
