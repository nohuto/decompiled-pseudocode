/*
 * XREFs of ?GetVSyncTimeCounters@DXGADAPTER@@QEAAXIW4VSYNC_TIME_STATS_TYPE@@PEAUVSYNC_TIME_COUNTERS@@@Z @ 0x1C00259B8
 * Callers:
...
char __fastcall DXGADAPTER::GetVSyncTimeCounters(__int64 a1, unsigned int a2, int a3, __int64 a4)
{
  ...
  {
    v10 = a2;
    LOBYTE(v4) = WdLogSingleEntry2(2LL, a2, *(unsigned int *)(a1 + 1544));
    if ( bTracingEnabled )
    {
