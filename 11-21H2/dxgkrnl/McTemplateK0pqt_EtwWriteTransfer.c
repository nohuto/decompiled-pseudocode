/*
 * XREFs of McTemplateK0pqt_EtwWriteTransfer @ 0x1C0049434
 * Callers:
...
NTSTATUS McTemplateK0pqt_EtwWriteTransfer(__int64 a1, __int64 a2, __int64 a3, ...)
{
  ...
  va_copy(v7, va1);
  va_copy(v9, va2);
  return McGenEventWrite_EtwWriteTransfer((REGHANDLE *)&DxgkControlGuid_Context, &SetVidPnSourceVisibility, a3, 4u, &v4);
}
