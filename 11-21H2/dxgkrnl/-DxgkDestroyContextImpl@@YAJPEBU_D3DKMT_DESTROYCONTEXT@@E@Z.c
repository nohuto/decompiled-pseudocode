/*
 * XREFs of ?DxgkDestroyContextImpl@@YAJPEBU_D3DKMT_DESTROYCONTEXT@@E@Z @ 0x1C0166C98
 * Callers:
 *     DxgkDestroyContext @ 0x1C0166C80 (DxgkDestroyContext.c)
...
__int64 __fastcall DxgkDestroyContextImpl(const struct _D3DKMT_DESTROYCONTEXT *a1, char a2, __int64 a3)
{
  ...
  if ( v7 < *((_DWORD *)Current + 74) )
  {
    ...
    if ( ((hContext >> 25) & 0x60) == (*(_BYTE *)(v8 + 16LL * v7 + 8) & 0x60) && (v9 & 0x2000) == 0 && (v9 & 0x1F) != 0 )
    {
      if ( (v9 & 0x1F) == 7 )
      {
