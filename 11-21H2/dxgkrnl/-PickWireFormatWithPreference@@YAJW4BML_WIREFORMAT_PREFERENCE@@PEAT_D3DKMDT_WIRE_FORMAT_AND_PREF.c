/*
 * XREFs of ?PickWireFormatWithPreference@@YAJW4BML_WIREFORMAT_PREFERENCE@@PEAT_D3DKMDT_WIRE_FORMAT_AND_PREFERENCE@@11@Z @ 0x1C01BE8EC
 * Callers:
...
__int64 __fastcall PickWireFormatWithPreference(int a1, _DWORD *a2, _DWORD *a3, int *a4)
{
  ...
  if ( *a4 )
  {
    WdLogSingleEntry1(1LL, 5498LL);
    DxgkLogInternalTriageEvent(0LL, 262146, -1, (__int64)L"pPickedWireFormat->Value == 0", 5498LL, 0LL, 0LL, 0LL, 0LL);
  }
  v13 = 0;
  v26 = 0x20000;
  v62 = 0x20000;
