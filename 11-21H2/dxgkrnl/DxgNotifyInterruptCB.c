/*
 * XREFs of DxgNotifyInterruptCB @ 0x1C0015280
 * Callers:
 *     <none>
 * Callees:
...
void __fastcall DxgNotifyInterruptCB(__int64 a1, struct _DXGKARGCB_NOTIFY_INTERRUPT_DATA *a2)
{
  ...
  else if ( (_InterlockedCompareExchange((volatile signed __int32 *)(*(_QWORD *)(a1 + 64) + 3920LL), 0, 0) & 2) != 0 )
  {
    v4 = *(_QWORD *)(a1 + 64);
    if ( v4 && *(_DWORD *)(v4 + 16) == 1953656900 && *(_DWORD *)(v4 + 20) == 2 )
    {
      v5 = *(struct DXGADAPTER **)(v4 + 3896);
      if ( v5 )
      {
        v6 = *((_QWORD *)v5 + 350);
        if ( v6 )
        {
          (*(void (__fastcall **)(__int64, struct _DXGKARGCB_NOTIFY_INTERRUPT_DATA *))(*(_QWORD *)(*(_QWORD *)(v6 + 624)
                                                                                                 + 8LL)
                                                                                     + 8LL))(
            a1,
            a2);
        ...
        {
          v10 = *(DXGDODPRESENT **)(*((_QWORD *)v5 + 349) + 448LL);
          if ( v10 )
