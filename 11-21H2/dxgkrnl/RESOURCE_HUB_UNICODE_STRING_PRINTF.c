/*
 * XREFs of RESOURCE_HUB_UNICODE_STRING_PRINTF @ 0x1C0066410
 * Callers:
 *     DpOpenSpbResource @ 0x1C03955F0 (DpOpenSpbResource.c)
 * Callees:
 *     ?RtlStringCbVPrintfExW@@YAJPEAG_KPEAPEAGPEA_KKPEBGPEAD@Z @ 0x1C006628C (-RtlStringCbVPrintfExW@@YAJPEAG_KPEAPEAGPEA_KKPEBGPEAD@Z.c)
 */
