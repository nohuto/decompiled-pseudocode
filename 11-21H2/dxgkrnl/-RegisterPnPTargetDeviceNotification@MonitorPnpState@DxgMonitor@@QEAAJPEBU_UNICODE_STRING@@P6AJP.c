/*
 * XREFs of ?RegisterPnPTargetDeviceNotification@MonitorPnpState@DxgMonitor@@QEAAJPEBU_UNICODE_STRING@@P6AJPEAX1@Z@Z @ 0x1C020C65C
 * Callers:
        ...
        struct _DEVICE_OBJECT *a3)
{
  ...
  *((_WORD *)this + 33) = v7;
  v8 = operator new[](v7, 0x4D677844u, 256LL, v5);
  *((_QWORD *)this + 9) = v8;
  if ( v8 )
  {
