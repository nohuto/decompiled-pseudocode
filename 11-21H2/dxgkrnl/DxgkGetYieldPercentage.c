/*
 * XREFs of DxgkGetYieldPercentage @ 0x1C0218880
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall DxgkGetYieldPercentage(ULONG64 a1, __int64 a2, __int64 a3)
{
  ...
  DXGETWPROFILER_BASE::PushProfilerEntry((__int64)&v27, 2142);
  if ( CheckTokenForResourceManagerAccess() )
  {
    ...
    if ( v30 >= 0x10 )
    {
      ...
      else
      {
        ...
        v16 = (BYTE8(v32) ^ (unsigned __int8)*((_DWORD *)v15 + 76125)) & 1 ^ DWORD2(v32);
        DWORD2(v32) = v16;
        v17 = *((_DWORD *)v15 + 76122);
        HIDWORD(v32) = v17;
