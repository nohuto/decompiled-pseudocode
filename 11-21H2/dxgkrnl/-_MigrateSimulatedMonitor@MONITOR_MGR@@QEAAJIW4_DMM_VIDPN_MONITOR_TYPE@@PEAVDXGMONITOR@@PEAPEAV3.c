/*
 * XREFs of ?_MigrateSimulatedMonitor@MONITOR_MGR@@QEAAJIW4_DMM_VIDPN_MONITOR_TYPE@@PEAVDXGMONITOR@@PEAPEAV3@@Z @ 0x1C03B452C
 * Callers:
        ...
        struct DXGMONITOR **a5)
{
  ...
  int v11; // eax
  struct DXGMONITOR *v13; // [rsp+20h] [rbp-28h] BYREF
  ...
  v13 = 0LL;
  MonitorInstance = MONITOR_MGR::_GetMonitorInstance(a1, v7, 0, &v13);
