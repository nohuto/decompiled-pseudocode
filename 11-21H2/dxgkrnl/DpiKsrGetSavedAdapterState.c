/*
 * XREFs of DpiKsrGetSavedAdapterState @ 0x1C03940D8
 * Callers:
...
__int64 __fastcall DpiKsrGetSavedAdapterState(__int64 a1)
{
  ...
  *v2 = 0;
  ...
  if ( v9 )
  {
    while ( 1 )
    {
      v11 = *(_QWORD *)v10 - v1[598];
      if ( *(_QWORD *)v10 == v1[598] )
        v11 = *(_QWORD *)(v10 + 8) - v1[599];
      if ( !v11 )
        break;
      ++v8;
    ...
    if ( !*(_BYTE *)(v10 + 24) )
    {
      ...
      v12 = *(_DWORD *)(qword_1C01309A0 + 8);
      if ( v12 >= *(_DWORD *)(qword_1C01309A0 + 4) )
      {
        WdLogSingleEntry1(2LL, -1073741823LL);
        return 3221225473LL;
      }
      *(_DWORD *)(qword_1C01309A0 + 8) = v12 + 1;
      *(_BYTE *)(v10 + 24) = 1;
    }
    *v4 = v10 + 32;
    *v5 = *(_DWORD *)(v10 + 28);
