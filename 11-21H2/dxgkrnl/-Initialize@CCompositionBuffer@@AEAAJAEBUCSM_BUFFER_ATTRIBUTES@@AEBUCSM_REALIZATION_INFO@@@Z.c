/*
 * XREFs of ?Initialize@CCompositionBuffer@@AEAAJAEBUCSM_BUFFER_ATTRIBUTES@@AEBUCSM_REALIZATION_INFO@@@Z @ 0x1C00788A4
 * Callers:
        ...
        const struct CSM_REALIZATION_INFO *a3)
{
  ...
  v8 = (*(__int64 (__fastcall **)(char *))(*((_QWORD *)Global + 38073) + 16LL))((char *)this + 280);
  if ( v8 >= 0 )
  {
    v9 = *(_OWORD *)a2;
    DWORD1(v12[0]) = 0;
    ...
    *((_OWORD *)this + 11) = *((_OWORD *)a2 + 8);
    ...
    {
      v10 = v14;
      v8 = (*(__int64 (__fastcall **)(CCompositionBuffer *, struct CBufferRealization *))(*(_QWORD *)this + 208LL))(
             this,
             v14);
      if ( v8 < 0 )
      {
