/*
 * XREFs of ?DxgkpQueryRegistry@@YAJPEAVDXGADAPTER@@PEAXI@Z @ 0x1C01DCF70
 * Callers:
...
__int64 __fastcall DxgkpQueryRegistry(struct DXGADAPTER *a1, unsigned int *a2, unsigned int a3)
{
  ...
  if ( a3 >= 0x228 )
  {
    ...
    if ( v6 >= 4 )
    {
      WdLogSingleEntry2(3LL, -1073741811LL, 2830LL);
      goto LABEL_21;
    }
    ...
    {
      WdLogSingleEntry2(3LL, -1073741811LL, 2837LL);
      goto LABEL_21;
    }
    v10 = a3 - 544;
    v11 = *a2;
    v12 = a2 + 134;
    a2[134] = v10;
    v13 = *(_QWORD *)(344 * v9 + *((_QWORD *)a1 + 335) + 8);
    if ( v11 <= 1 )
    {
      v14 = a2 + 2;
      v15 = v61;
...
LABEL_17:
    ...
    if ( v11 - 2 > 1 )
    {
      WdLogSingleEntry2(3LL, -1073741811LL, 2972LL);
      goto LABEL_21;
    }
    if ( a2[132] || (v6 & 1) != 0 )
    {
      WdLogSingleEntry2(3LL, -1073741811LL, 2940LL);
      goto LABEL_21;
    }
    if ( v11 == 2 )
    {
...
LABEL_39:
  ...
  WdLogSingleEntry3(3LL, a3, -1073741811LL, 2822LL);
  return 3221225485LL;
}
