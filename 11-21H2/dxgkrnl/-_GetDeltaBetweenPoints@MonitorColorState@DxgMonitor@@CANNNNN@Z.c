/*
 * XREFs of ?_GetDeltaBetweenPoints@MonitorColorState@DxgMonitor@@CANNNNN@Z @ 0x1C0209ED4
 * Callers:
 ...
 * Callees:
 *     ?_GetSqrt@MonitorColorState@DxgMonitor@@CANN@Z @ 0x1C0209F20 (-_GetSqrt@MonitorColorState@DxgMonitor@@CANN@Z.c)
 */
