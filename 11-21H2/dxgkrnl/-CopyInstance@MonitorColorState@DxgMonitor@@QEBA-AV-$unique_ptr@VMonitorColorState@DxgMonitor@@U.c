/*
 * XREFs of ?CopyInstance@MonitorColorState@DxgMonitor@@QEBA?AV?$unique_ptr@VMonitorColorState@DxgMonitor@@U?$default_delete@VMonitorColorState@DxgMonitor@@@wistd@@@wistd@@AEAVIMonitorComponentParent@2@AEAVIMonitorRegistry@2@@Z @ 0x1C03B8710
 * Callers:
        ...
        struct DxgMonitor::IMonitorRegistry *a4)
{
  ...
  v8 = (DxgMonitor::MonitorColorState *)operator new[](0x1B0uLL, 0x4D677844u, 256LL, (__int64)a4);
