/*
 * XREFs of DpiSriovDetach @ 0x1C038C560
 * Callers:
  ...
  if ( *(_BYTE *)(v6 + v2 + 28) || *(_QWORD *)(v6 + v2) )
  {
    ...
    if ( v16 >= 0 )
    {
      ...
      *(_BYTE *)(v6 + v2 + 28) = 0;
      if ( v7 )
      {
        v8 = IoCsqRemoveNextIrp((PIO_CSQ)(v2 + 5256), v7);
        *(_QWORD *)(v6 + v2) = 0LL;
        if ( v8 )
        {
      ...
      if ( v9 )
      {
        v10 = IoCsqRemoveNextIrp((PIO_CSQ)(v2 + 5256), v9);
        *(_QWORD *)(v6 + v2 + 8) = 0LL;
        if ( v10 )
        {
      ...
      if ( v11 )
      {
        v12 = IoCsqRemoveNextIrp((PIO_CSQ)(v2 + 5256), v11);
        *(_QWORD *)(v6 + v2 + 16) = 0LL;
        if ( v12 )
        {
      ...
      v13 = _InterlockedDecrement(&dword_1C01309A8);
      if ( HIBYTE(word_1C0130998) && !v13 )
        DpiKsrDoKsrSave();
    }
    v5 = v16;
