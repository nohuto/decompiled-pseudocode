/*
 * XREFs of ?DdiQueryDiagnosticTypesSupport@DXGADAPTER@@QEAAJPEAU_DXGKARG_QUERYDIAGNOSTICTYPESSUPPORT@@@Z @ 0x1C02CAD60
 * Callers:
        ...
        __int64 a3)
{
  ...
  DXGETWPROFILER_BASE::PushProfilerEntry((__int64)&v23, 5128);
  ...
  v15 = (*((int (__fastcall **)(_QWORD, struct _DXGKARG_QUERYDIAGNOSTICTYPESSUPPORT *))this + 165))(
          *((_QWORD *)this + 35),
          a2);
  if ( v27[0] )
  ...
  v19[6] = a2->NoninvasiveTypes.Notifications.Value;
  v19[7] = a2->InvasiveTypes.Notifications.Value;
