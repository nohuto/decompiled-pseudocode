/*
 * XREFs of ?IsUsingDefaultMonitorProfile@DXGDMM_INTERFACE_V1_IMPL@@YAJQEAXIPEAE@Z @ 0x1C03A2850
 * Callers:
 *     <none>
 * Callees:
...
LABEL_13:
  ...
  v9 = *(VIDPN_MGR **)(v8 + 104);
  EXCLUSIVEACCESS<VIDPN_MGR>::EXCLUSIVEACCESS<VIDPN_MGR>(&v19, (__int64)v9);
  v18 = 0LL;
