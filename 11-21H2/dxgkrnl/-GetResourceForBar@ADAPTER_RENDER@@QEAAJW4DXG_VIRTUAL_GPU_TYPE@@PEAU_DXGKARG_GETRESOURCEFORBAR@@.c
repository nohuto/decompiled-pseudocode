/*
 * XREFs of ?GetResourceForBar@ADAPTER_RENDER@@QEAAJW4DXG_VIRTUAL_GPU_TYPE@@PEAU_DXGKARG_GETRESOURCEFORBAR@@@Z @ 0x1C0357C9C
 * Callers:
...
__int64 __fastcall ADAPTER_RENDER::GetResourceForBar(__int64 a1, int a2, unsigned int *a3)
{
  ...
  {
    v10 = (*(__int64 (__fastcall **)(__int64, unsigned int *))(*(_QWORD *)v9 + 104LL))(v9, a3);
  }
  else
  {
