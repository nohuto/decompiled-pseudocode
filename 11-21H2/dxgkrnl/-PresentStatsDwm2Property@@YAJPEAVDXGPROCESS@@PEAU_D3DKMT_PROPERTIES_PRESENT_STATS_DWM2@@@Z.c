/*
 * XREFs of ?PresentStatsDwm2Property@@YAJPEAVDXGPROCESS@@PEAU_D3DKMT_PROPERTIES_PRESENT_STATS_DWM2@@@Z @ 0x1C02231C8
 * Callers:
...
__int64 __fastcall PresentStatsDwm2Property(struct _KTHREAD **a1, struct _D3DKMT_PROPERTIES_PRESENT_STATS_DWM2 *a2)
{
  ...
  if ( v12 )
  {
    ...
    {
      v6 = *((_QWORD *)v12 + 231);
      if ( v6 && (v7 = *((unsigned int *)a2 + 1), (unsigned int)v7 >= *(_DWORD *)(*(_QWORD *)(v6 + 2792) + 96LL)) )
      {
