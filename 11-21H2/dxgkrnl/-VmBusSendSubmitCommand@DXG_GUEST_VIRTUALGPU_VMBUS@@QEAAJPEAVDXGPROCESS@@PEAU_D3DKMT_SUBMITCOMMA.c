/*
 * XREFs of ?VmBusSendSubmitCommand@DXG_GUEST_VIRTUALGPU_VMBUS@@QEAAJPEAVDXGPROCESS@@PEAU_D3DKMT_SUBMITCOMMAND@@@Z @ 0x1C037D73C
 * Callers:
...
LABEL_39:
              ...
              while ( 1 )
              {
                ...
                if ( (unsigned int)v25 >= *((_DWORD *)a2 + 74) )
                  break;
                v26 = *((_QWORD *)a2 + 35);
                v27 = *(_DWORD *)(v26 + 16 * v25 + 8);
                if ( ((*(_DWORD *)(v10 + 4LL * v24 + 52) >> 25) & 0x60) != (*(_BYTE *)(v26 + 16 * v25 + 8) & 0x60)
                  || (v27 & 0x2000) != 0
                  || (v27 & 0x1F) == 0 )
                {
                  break;
...
LABEL_47:
            ...
            WdLogSingleEntry1(3LL, 11765LL);
          }
          v30 = -1073741811;
          DXGALLOCATIONREFERENCE::~DXGALLOCATIONREFERENCE(&v31);
          goto LABEL_43;
        }
        WdLogSingleEntry1(3LL, 11705LL);
      }
    }
    if ( v34 )
      DXGADAPTERSTOPRESETLOCKSHARED::Release((DXGADAPTERSTOPRESETLOCKSHARED *)v32);
