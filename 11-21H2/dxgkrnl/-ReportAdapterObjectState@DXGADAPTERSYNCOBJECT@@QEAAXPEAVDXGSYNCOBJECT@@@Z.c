/*
 * XREFs of ?ReportAdapterObjectState@DXGADAPTERSYNCOBJECT@@QEAAXPEAVDXGSYNCOBJECT@@@Z @ 0x1C0340DD8
 * Callers:
      ...
      if ( *((_DWORD *)a2 + 50) != 4 )
      {
        ...
        if ( *((_DWORD *)a2 + 50) != 5 )
        {
          ...
          else
          {
            ...
            DxgkLogInternalTriageEvent(0LL, 262146, -1, (__int64)L"FALSE", 1032LL, 0LL, 0LL, 0LL, 0LL);
          }
          goto LABEL_22;
        }
        if ( (Microsoft_Windows_DxgKrnlEnableBits & 0x100) == 0 )
