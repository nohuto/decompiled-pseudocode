/*
 * XREFs of ?ReleaseTargetModeSet@DXGK_VIDPN_INTERFACE_V1_IMPL@@YAJQEAUD3DKMDT_HVIDPN__@@QEAUD3DKMDT_HVIDPNTARGETMODESET__@@@Z @ 0x1C01D18D0
 * Callers:
 *     <none>
 * Callees:
        ...
        struct D3DKMDT_HVIDPNTARGETMODESET__ *const a3)
{
  ...
  DXGETWPROFILER_BASE::PushProfilerEntry((__int64)&v24, 7049);
  ...
  if ( this && *((_DWORD *)this + 16) == 1833172997 )
  {
    if ( a2 && *((_DWORD *)a2 + 32) == 1833173005 )
    {
      ...
      if ( v10 == this )
      {
        ...
        if ( v11 == v8 )
        {
          if ( a2 == *(struct D3DKMDT_HVIDPN__ *const *)(v8 + 112) )
          {
            WdLogSingleEntry2(7LL, a2, *(unsigned int *)(v8 + 24));
            auto_rc<DMMVIDPNTARGETMODESET>::reset((__int64 *)(v8 + 112), 0LL);
            if ( *((_DWORD *)a2 + 24) != 1 )
              WdLogSingleEntry0(1LL);
          }
          if ( *((_DWORD *)a2 + 24) == 1
