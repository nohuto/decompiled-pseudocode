/*
 * XREFs of ?WriteDxgDiagnosticsEvent_FUNCTIONALIZE_PACKET@@YAXPEAU_DXGK_DIAG_HEADER@@@Z @ 0x1C0012F7C
 * Callers:
...
void __fastcall WriteDxgDiagnosticsEvent_FUNCTIONALIZE_PACKET(struct _DXGK_DIAG_HEADER *a1)
{
  ...
  if ( (unsigned int)dword_1C012F8E0 > 4 && tlgKeywordOn((__int64)&dword_1C012F8E0, 0x200000000800LL) )
  {
