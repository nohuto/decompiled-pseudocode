/*
 * XREFs of ?DdiResetHwEngine@ADAPTER_RENDER@@QEAAJPEAU_DXGKARG_RESETHWENGINE@@@Z @ 0x1C00485E8
 * Callers:
 *     ?ADAPTER_RENDER_DdiResetHwEngine@@YAJPEAVADAPTER_RENDER@@PEAU_DXGKARG_RESETHWENGINE@@@Z @ 0x1C004B850 (-ADAPTER_RENDER_DdiResetHwEngine@@YAJPEAVADAPTER_RENDER@@PEAU_DXGKARG_RESETHWENGINE@@@Z.c)
 * Callees:
        ...
        __int64 a3)
{
  ...
  DXGETWPROFILER_BASE::PushProfilerEntry((__int64)&v18, 5132);
  ...
  v10 = (*(int (__fastcall **)(_QWORD, struct _DXGKARG_RESETHWENGINE *))(*((_QWORD *)this + 2) + 1120LL))(
