/*
 * XREFs of ?FindByValue@?$Set@VDXGTARGETENTRY@@@@QEBAPEAVDXGTARGETENTRY@@QEBV2@@Z @ 0x1C004EFD4
 * Callers:
 ...
 * Callees:
 *     ??9DXGTARGETENTRY@@QEBA_NAEBV0@@Z @ 0x1C02F3778 (--9DXGTARGETENTRY@@QEBA_NAEBV0@@Z.c)
 */
