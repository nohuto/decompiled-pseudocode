/*
 * XREFs of ?GetAllocationPhysicalAddress@DXGDEVICE@@QEAAJPEBVDXGADAPTERALLOCATION@@PEAT_LARGE_INTEGER@@@Z @ 0x1C02E5544
 * Callers:
        ...
        union _LARGE_INTEGER *a3)
{
  ...
  {
    WdLogSingleEntry1(1LL, 11519LL);
    DxgkLogInternalTriageEvent(0LL, 262146, -1, (__int64)L"IsDeviceLockSharedOwner()", 11519LL, 0LL, 0LL, 0LL, 0LL);
  }
  ...
  v8 = VIDMM_EXPORT::VidMmInvalidateCache(
         *(VIDMM_EXPORT **)(*((_QWORD *)this + 2) + 648LL),
         *(struct VIDMM_GLOBAL **)(*((_QWORD *)this + 2) + 656LL),
