/*
 * XREFs of ?PinPathContentRotation@VIDPN_MGR@@QEBAJQEAVDMMVIDPNPRESENTPATH@@W4_D3DKMDT_VIDPN_PRESENT_PATH_ROTATION@@_N@Z @ 0x1C039D9F8
 * Callers:
...
LABEL_34:
  ...
  *((_DWORD *)&v37.EnumPivot + 2) = 0;
  ...
  v37.EnumPivotType = D3DKMDT_EPT_ROTATION;
  v37.EnumPivot = v39;
  if ( !v27 )
  {
    WdLogSingleEntry0(1LL);
