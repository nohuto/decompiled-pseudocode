/*
 * XREFs of ?UpdateGdiInfoForVidPnSource@Win81@@YAJPEBU_DXGDMM_INTERFACE@@QEAXIIHPEAU_DPI_INFORMATION@@@Z @ 0x1C0316668
 * Callers:
...
LABEL_33:
    ...
    v38 = v69;
    v67 = v37;
    if ( (v33 & 1) != 0 && (_DWORD)v74 && v34 )
    {
      v39 = HIDWORD(v69);
      if ( v65[0] )
        v39 = HIDWORD(v69) >> 1;
      if ( (unsigned int)v69 >= 2 * (int)v74 || v39 >= (unsigned int)(2 * HIDWORD(v74)) )
        v40 = 2;
      else
        v40 = 0;
      v33 ^= (v33 ^ (v33 | v40)) & 2;
