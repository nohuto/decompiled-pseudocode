/*
 * XREFs of ?LogDisplayTelemetryAdapterInfo@DISPLAYSTATECHECKER@@AEAAXPEAU_DXGK_DISPLAY_SCENARIO_CONTEXT@@PEAVDISPLAYDIAGNOSTICADAPTERDATA@@@Z @ 0x1C02EFB50
 * Callers:
        ...
        struct DISPLAYDIAGNOSTICADAPTERDATA *a3)
{
  ...
  {
    WdLogSingleEntry1(1LL, 346LL);
    DxgkLogInternalTriageEvent(0LL, 262146, -1, (__int64)L"Invalid parameters not expected", 346LL, 0LL, 0LL, 0LL, 0LL);
  }
}
