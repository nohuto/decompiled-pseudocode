/*
 * XREFs of ?UpdateOneCddPrimaryPrivateDriverData@ADAPTER_DISPLAY@@QEAAXIPEAVDXGADAPTER@@@Z @ 0x1C01E9EEC
 * Callers:
...
LABEL_13:
  ...
  if ( (*(_DWORD *)(v9 + 12) & 4) == 0 )
  {
    ...
    if ( (int)ADAPTER_RENDER::DdiDescribeAllocation(*((ADAPTER_RENDER **)a3 + 350), &v18, (__int64)a3) < 0 )
    {
    ...
    else
    {
      ...
      *(_DWORD *)&v19[20] = a2;
      ...
      v14 = *(_DWORD *)(v13 + 40);
      v15 = (ADAPTER_RENDER *)*((_QWORD *)a3 + 350);
