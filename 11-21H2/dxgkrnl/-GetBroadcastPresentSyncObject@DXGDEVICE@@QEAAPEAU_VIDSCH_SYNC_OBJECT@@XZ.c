/*
 * XREFs of ?GetBroadcastPresentSyncObject@DXGDEVICE@@QEAAPEAU_VIDSCH_SYNC_OBJECT@@XZ @ 0x1C02E5670
 * Callers:
...
struct _VIDSCH_SYNC_OBJECT *__fastcall DXGDEVICE::GetBroadcastPresentSyncObject(DXGDEVICE *this)
{
  ...
  if ( !*((_QWORD *)this + 236) )
  {
    ...
    v4 = 3;
    if ( *(int *)(v3[2] + 2692LL) >= 2400 )
      v4 = 5;
    v6[0] = v4;
    if ( (*(int (__fastcall **)(_QWORD, _QWORD, _DWORD *, __int64, _QWORD, _QWORD, char *, _QWORD))(*(_QWORD *)(v3[78] + 8LL)
                                                                                                  + 608LL))(
           v3[79],
           0LL,
           v6,
