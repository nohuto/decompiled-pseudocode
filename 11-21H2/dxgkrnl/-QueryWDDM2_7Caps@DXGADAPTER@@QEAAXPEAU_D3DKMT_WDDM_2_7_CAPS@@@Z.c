/*
 * XREFs of ?QueryWDDM2_7Caps@DXGADAPTER@@QEAAXPEAU_D3DKMT_WDDM_2_7_CAPS@@@Z @ 0x1C02BD4D0
 * Callers:
...
void __fastcall DXGADAPTER::QueryWDDM2_7Caps(DXGADAPTER *this, struct _D3DKMT_WDDM_2_7_CAPS *a2)
{
  ...
  *(_DWORD *)a2 = 0;
  if ( *((_QWORD *)this + 350) )
  {
    LOBYTE(v2) = (**((_DWORD **)this + 337) & 0x18000) != 0;
    *(_DWORD *)a2 = v2;
    v4 = v2 | (*(_BYTE *)(*((_QWORD *)this + 350) + 1744LL) != 0 ? 2 : 0);
    *(_DWORD *)a2 = v4;
    *(_DWORD *)a2 = v4 | (*((_DWORD *)this + 666) >> 1) & 8;
  }
}
