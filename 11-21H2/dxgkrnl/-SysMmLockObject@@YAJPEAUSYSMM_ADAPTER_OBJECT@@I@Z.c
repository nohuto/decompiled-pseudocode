/*
 * XREFs of ?SysMmLockObject@@YAJPEAUSYSMM_ADAPTER_OBJECT@@I@Z @ 0x1C0070F10
 * Callers:
 *     DxgkAllocateAdlCB @ 0x1C00546B0 (DxgkAllocateAdlCB.c)
 *     SysMmTestLockObject @ 0x1C0071390 (SysMmTestLockObject.c)
 * Callees:
 *     ?SmmValidateParameters@@YA_NPEBUSYSMM_PHYSICAL_OBJECT@@@Z @ 0x1C0070EC8 (-SmmValidateParameters@@YA_NPEBUSYSMM_PHYSICAL_OBJECT@@@Z.c)
