/*
 * XREFs of NtSetCompositionSurfaceBufferUsage @ 0x1C0003D20
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall NtSetCompositionSurfaceBufferUsage(void *a1, unsigned __int64 *a2, unsigned int a3, int a4, int a5)
{
  int v8; // edi
  int v9; // ebx
  ...
  if ( v9 >= 0 )
  {
    ...
    if ( (*(unsigned int (**)(void))(*((_QWORD *)Global + 38073) + 528LL))() )
    {
      ...
      {
        v18 = 0LL;
        v9 = CompositionSurfaceObject::LockForWrite(Object, &v18);
        if ( v9 >= 0 )
        {
          v17 = 0LL;
