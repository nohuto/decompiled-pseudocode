/*
 * XREFs of ?SetQueuedPresentLimit@BLTQUEUE@@QEAAXI@Z @ 0x1C03BE934
 * Callers:
...
void __fastcall BLTQUEUE::SetQueuedPresentLimit(BLTQUEUE *this, unsigned int a2)
{
  ...
  *((_QWORD *)this + 29) = (char *)this + 232;
  v7 = CCachedData<BLTENTRY,3>::Get((__int64)this + 968, v2, v5, v6);
  if ( v7 )
  {
    if ( (_DWORD)v2 )
    {
      do
      {
        BLTQUEUE::InsertQueueTail((__int64)this, (__int64)this + 232, (__int64)v7);
