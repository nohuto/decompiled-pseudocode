/*
 * XREFs of ?GetBackingResource@ADAPTER_RENDER@@QEAAJW4DXG_VIRTUAL_GPU_TYPE@@PEAU_DXGKARG_GETBACKINGRESOURCE@@@Z @ 0x1C035770C
 * Callers:
...
__int64 __fastcall ADAPTER_RENDER::GetBackingResource(__int64 a1, int a2, unsigned int *a3)
{
  ...
  {
    v10 = (*(__int64 (__fastcall **)(__int64, unsigned int *))(*(_QWORD *)v9 + 152LL))(v9, a3);
  }
  else
  {
