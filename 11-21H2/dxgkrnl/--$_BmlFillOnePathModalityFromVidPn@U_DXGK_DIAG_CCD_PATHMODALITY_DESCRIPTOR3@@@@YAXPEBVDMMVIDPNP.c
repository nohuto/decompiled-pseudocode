/*
 * XREFs of ??$_BmlFillOnePathModalityFromVidPn@U_DXGK_DIAG_CCD_PATHMODALITY_DESCRIPTOR3@@@@YAXPEBVDMMVIDPNPRESENTPATH@@PEAU_DXGK_DIAG_CCD_PATHMODALITY_DESCRIPTOR3@@@Z @ 0x1C01C0E00
 * Callers:
...
__int64 __fastcall _BmlFillOnePathModalityFromVidPn<_DXGK_DIAG_CCD_PATHMODALITY_DESCRIPTOR3>(__int64 a1, __int64 a2)
{
  ...
  if ( v13 )
  {
    ...
    *(_QWORD *)(a2 + 140) = *(_QWORD *)(v13 + 152);
    *(_QWORD *)(a2 + 148) = *(_QWORD *)(v13 + 144);
    *(_DWORD *)(a2 + 156) = *(_DWORD *)(v13 + 160);
