/*
 * XREFs of DpReadDeviceSpace @ 0x1C0025680
 * Callers:
...
__int64 __fastcall DpReadDeviceSpace(__int64 a1, __int64 a2, void *a3, ULONG Offset, ULONG Length, ULONG *a6)
{
  ...
  *a6 = 0;
  ...
  if ( (_DWORD)a2 && (_DWORD)a2 != 1382638416 )
  {
    ...
    {
      if ( (*(_DWORD *)(v8 + 3988) & 4) == 0 )
      {
        v13 = -1071774661LL;
        goto LABEL_19;
      }
      v15 = *(__int64 (__fastcall **)(_QWORD, void *, _QWORD, _QWORD))(v8 + 2952);
      if ( v15 )
      {
        BusDataByOffset = v15(*(_QWORD *)(v8 + 2928), a3, Offset, Length);
        goto LABEL_10;
      }
LABEL_22:
      v13 = -1073741823LL;
