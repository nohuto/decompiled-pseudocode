/*
 * XREFs of ?CreateOutputDuplManager@@YAJIPEAVADAPTER_DISPLAY@@PEAU_LUID@@1PEAPEAVOUTPUTDUPL_MGR@@@Z @ 0x1C02108A8
 * Callers:
        ...
        struct OUTPUTDUPL_MGR **a5)
{
  ...
  *a5 = 0LL;
  if ( a4 && a3 )
  {
    v14 = (OUTPUTDUPL_MGR_INDIRECT *)operator new[](0x88uLL, 0x674D444Fu, 256LL, (__int64)a4);
    if ( v14 )
  ...
  {
    v9 = operator new[](0x60uLL, 0x674D444Fu, 256LL, (__int64)a4);
