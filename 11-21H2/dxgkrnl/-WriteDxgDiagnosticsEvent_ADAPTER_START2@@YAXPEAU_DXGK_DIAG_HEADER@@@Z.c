/*
 * XREFs of ?WriteDxgDiagnosticsEvent_ADAPTER_START2@@YAXPEAU_DXGK_DIAG_HEADER@@@Z @ 0x1C002A918
 * Callers:
...
void __fastcall WriteDxgDiagnosticsEvent_ADAPTER_START2(struct _DXGK_DIAG_HEADER *a1)
{
  ...
  {
    if ( tlgKeywordOn((__int64)&dword_1C012F8E0, 0x200000001000LL) && tlgKeywordOn((__int64)&dword_1C012F8E0, v2) )
    {
      v14 = *((_WORD *)a1 + 2);
      v15 = *((_DWORD *)a1 + 10);
      v13 = a1;
      ...
      _tlgWriteTemplate<long (_tlgProvider_t const *,void const *,_GUID const *,_GUID const *,unsigned int,_EVENT_DATA_DESCRIPTOR *),&long _tlgWriteTransfer_EtwWriteTransfer(_tlgProvider_t const *,void const *,_GUID const *,_GUID const *,unsigned int,_EVENT_DATA_DESCRIPTOR *),_GUID const *,_GUID const *>::Write<_tlgWrapperByVal<4>,_tlgWrapperByVal<4>,_tlgWrapperBinary>(
        ...
        (__int64)&v15,
        (__int64 *)&v13);
      LODWORD(v3) = dword_1C012F8E0;
    }
    if ( (unsigned int)v3 > 4 && tlgKeywordOn((__int64)&dword_1C012F8E0, 0x400000001000LL) && *((int *)a1 + 12) < 0 )
    {
      if ( tlgKeywordOn((__int64)&dword_1C012F8E0, v6) )
      {
        v15 = *((_DWORD *)a1 + 18);
        v16 = *((_DWORD *)a1 + 16);
        v17 = *((_DWORD *)a1 + 13);
