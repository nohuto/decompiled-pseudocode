/*
 * XREFs of ?InitializeMessage@DXGVMBUSMESSAGE@@QEAAXPEAUDXG_VMBUS_CHANNEL_BASE@@IPEAI11@Z @ 0x1C0364EA8
 * Callers:
        ...
        unsigned int *a6)
{
  ...
  v11 = *((_DWORD *)DXGGLOBAL_GetGlobal() + 451);
  *((_DWORD *)this + 4) = a3;
  if ( v11 >= 0x28 )
  {
    a3 += 16;
  ...
  if ( v13 )
  {
    ...
    else
    {
      ...
      *v13 = 16;
      if ( !*((_DWORD *)a2 + 12) )
        *(_QWORD *)(*((_QWORD *)this + 1) + 8LL) = *(_QWORD *)(*((_QWORD *)a2 + 9) + 4452LL);
    }
  }
  else
  {
