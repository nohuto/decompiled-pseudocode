/*
 * XREFs of DxgkDdiSetVirtualGpuVmBus @ 0x1C035A528
 * Callers:
...
__int64 __fastcall DxgkDdiSetVirtualGpuVmBus(_QWORD *a1, int a2, struct _LUID *a3, int *a4)
{
  ...
  {
    WdLogSingleEntry1(2LL, 1729LL);
    DxgkLogInternalTriageEvent(0LL, 0x40000, -1, (__int64)L"Failed to find vGPU by LUID", 1729LL, 0LL, 0LL, 0LL, 0LL);
    v7 = -1073741811;
  }
  if ( bTracingEnabled )
  {
