/*
 * XREFs of DpiCreateSecurityDescriptorForGpuVirtualization @ 0x1C021957C
 * Callers:
...
__int64 __fastcall DpiCreateSecurityDescriptorForGpuVirtualization(_QWORD *a1)
{
  ...
  *(_DWORD *)IdentifierAuthority.Value = 0;
  ...
  v6 = RtlInitializeSid(PoolWithTag, &IdentifierAuthority, 2u);
  LODWORD(v7) = v6;
  if ( v6 < 0 )
  {
  ...
  else
  {
    ...
    *RtlSubAuthoritySid(v5, 1u) = 0;
    ...
    v11 = (struct _ACL *)ExAllocatePoolWithTag(PagedPool, v10, 0x74727044u);
    v12 = v11;
    if ( v11 )
    {
                ...
                if ( v18 >= 0 )
                {
                  ...
                  if ( v19 >= 0 )
                  {
                    ...
                    if ( v20 >= 0 )
                    {
                      ...
                      {
                        v22 = ExAllocatePoolWithTag(PagedPool, v21, 0x74727044u);
                        v2 = v22;
                        if ( !v22 )
                        {
                          LODWORD(v7) = -1073741670;
