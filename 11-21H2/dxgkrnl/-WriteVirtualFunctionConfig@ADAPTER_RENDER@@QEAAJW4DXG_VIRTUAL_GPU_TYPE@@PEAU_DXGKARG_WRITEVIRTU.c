/*
 * XREFs of ?WriteVirtualFunctionConfig@ADAPTER_RENDER@@QEAAJW4DXG_VIRTUAL_GPU_TYPE@@PEAU_DXGKARG_WRITEVIRTUALFUNCTIONCONFIG@@@Z @ 0x1C0359098
 * Callers:
...
__int64 __fastcall ADAPTER_RENDER::WriteVirtualFunctionConfig(__int64 a1, int a2, __int64 a3)
{
  ...
  {
    v10 = (*(__int64 (__fastcall **)(__int64, __int64))(*(_QWORD *)v9 + 56LL))(v9, a3);
  }
  else
  {
