/*
 * XREFs of ?Cancel@DXGDEADLOCK_TRACKER@@QEAAXXZ @ 0x1C01E1AEC
 * Callers:
...
void __fastcall DXGDEADLOCK_TRACKER::Cancel(DXGDEADLOCK_TRACKER *this)
{
  ...
  if ( _InterlockedCompareExchange((volatile signed __int32 *)this + 9, 0, 1) == 1 )
  {
    ...
    if ( (*((_BYTE *)this + 32) || *((_BYTE *)this + 33)) && (unsigned int)dword_1C012F918 > 5 )
    {
      if ( tlgKeywordOn((__int64)&dword_1C012F918, 0x400000004000LL) )
      {
        ...
        v10 = *(_DWORD *)(v6 + 2888);
        v11 = *(unsigned __int8 *)(v6 + 2742);
        v12 = *((unsigned __int8 *)this + 33);
        v13 = *(_DWORD *)(v6 + 4592);
        v14 = *(_DWORD *)(v6 + 4588);
        v25 = v7;
        v15 = *(unsigned __int8 *)(v6 + 209);
        v16 = *(unsigned __int8 *)(v6 + 2636);
        v17 = *(unsigned __int8 *)(v6 + 2631);
        v18 = *(_DWORD *)(v6 + 288);
        v31 = *(_WORD *)(v6 + 2692);
        v26 = *(_QWORD *)(v6 + 1696);
        v27 = *(void **)(v6 + 1688);
