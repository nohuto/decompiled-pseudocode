/*
 * XREFs of ?DxgEscapeSuspendResumeProcess@@YAJPEAU_D3DKMT_ESCAPE@@PEAXPEAVDXGADAPTER@@1_N3@Z @ 0x1C03081F8
 * Callers:
        ...
        bool a6)
{
  ...
  {
    Process = DXGPROCESS::GetCurrent((__int64)a1, (__int64)a2, (__int64)a3, 0LL);
  }
  v13 = Process;
  ...
  if ( v14 )
  {
    if ( *((_BYTE *)a3 + 209) )
    {
      ...
      v10 = DXG_GUEST_VIRTUALGPU_VMBUS::VmBusSendEscape(
              (struct DXGADAPTER *)((char *)a3 + 4344),
              HostProcess,
              v18,
              0,
              0,
