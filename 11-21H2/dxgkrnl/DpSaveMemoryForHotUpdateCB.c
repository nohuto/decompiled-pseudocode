/*
 * XREFs of DpSaveMemoryForHotUpdateCB @ 0x1C0393B60
 * Callers:
...
LABEL_9:
      ...
      PoolWithTag = ExAllocatePoolWithTag(PagedPool, 8LL * v19, 0x74727044u);
      v3 = PoolWithTag;
      if ( !PoolWithTag )
      {
      ...
      v21 = KsrMdlToMemoryRuns(v12, PoolWithTag, v19, &v26);
      v5 = v21;
      if ( v21 < 0 )
        goto LABEL_29;
      v4 = v26;
