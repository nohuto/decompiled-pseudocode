/*
 * XREFs of ?CreatePeriodicFrameNotification@DXGSYNCOBJECT@@QEAAJPEAVDXGADAPTER@@00_KI@Z @ 0x1C033EFBC
 * Callers:
        ...
        unsigned int a6)
{
  ...
  if ( (*((_DWORD *)a4 + 109) & 0x100) != 0 )
  {
    if ( !a2 )
    {
      WdLogSingleEntry1(1LL, 1939LL);
      DxgkLogInternalTriageEvent(0LL, 262146, -1, (__int64)L"pSyncAdapter != nullptr", 1939LL, 0LL, 0LL, 0LL, 0LL);
    }
    VidSchSyncObject = DXGSYNCOBJECT::GetVidSchSyncObject(this, a2[350]);
  ...
  {
    v13 = DXGSYNCOBJECT::GetVidSchSyncObject(this, a3[350]);
    PeriodicFrameNotification = (*(__int64 (__fastcall **)(_QWORD, struct _VIDSCH_SYNC_OBJECT *, unsigned __int64, _QWORD, char *, char *))(*(_QWORD *)(*(_QWORD *)(v14 + 624) + 8LL) + 936LL))(
                                  *(_QWORD *)(v14 + 632),
                                  v13,
                                  a5,
                                  a6,
