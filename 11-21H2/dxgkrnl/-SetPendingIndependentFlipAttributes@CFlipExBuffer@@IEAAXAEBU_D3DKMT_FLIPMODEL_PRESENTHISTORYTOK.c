/*
 * XREFs of ?SetPendingIndependentFlipAttributes@CFlipExBuffer@@IEAAXAEBU_D3DKMT_FLIPMODEL_PRESENTHISTORYTOKEN@@@Z @ 0x1C00182C8
 * Callers:
        ...
        const struct _D3DKMT_FLIPMODEL_PRESENTHISTORYTOKEN *a2)
{
  ...
  *((_DWORD *)this + 132) ^= (*((_DWORD *)this + 132) ^ (a2->Flags.Value >> 1)) & 1;
  v8 = *((_DWORD *)this + 132);
