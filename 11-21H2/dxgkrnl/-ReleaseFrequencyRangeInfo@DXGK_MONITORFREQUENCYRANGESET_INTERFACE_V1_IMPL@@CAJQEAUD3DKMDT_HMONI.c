/*
 * XREFs of ?ReleaseFrequencyRangeInfo@DXGK_MONITORFREQUENCYRANGESET_INTERFACE_V1_IMPL@@CAJQEAUD3DKMDT_HMONITORFREQUENCYRANGESET__@@QEBU_D3DKMDT_MONITOR_FREQUENCY_RANGE@@@Z @ 0x1C03B2E30
 * Callers:
 *     <none>
 * Callees:
        ...
        __int64 a3)
{
  ...
  DXGETWPROFILER_BASE::PushProfilerEntry((__int64)&v15, 7026);
    ...
    else
    {
      ...
      RESOURCE_LOCK<DxgMonitor::MonitorDescriptorState>::RESOURCE_LOCK<DxgMonitor::MonitorDescriptorState>(
        ...
        *(struct _ERESOURCE **)&v10[2].ActiveCount,
        1);
      v11 = Resource;
      v8 = DxgMonitor::MonitorModes::_ReleaseMonitorFreqRangeEnumerator((DxgMonitor::MonitorModes *)Resource, a2);
      if ( v11 )
      {
