/*
 * XREFs of ?MockDriverStateCreateDurationLiveDump@@YAXPEAX@Z @ 0x1C0318220
 * Callers:
 *     <none>
 * Callees:
...
void __fastcall MockDriverStateCreateDurationLiveDump(__int64 *a1)
{
  ...
  __int16 v21; // [rsp+120h] [rbp+67h] BYREF
  ...
  DxgCreateLiveDumpWithWdLogs(0x193u, 2067LL, 2LL, 0LL, 0LL, 1);
}
