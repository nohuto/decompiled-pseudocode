/*
 * XREFs of ?RemoveSurface@DXGSWAPCHAIN@@QEAAJPEAU_D3DKMT_REMOVESURFACEFROMSWAPCHAIN@@@Z @ 0x1C034C654
 * Callers:
...
__int64 __fastcall DXGSWAPCHAIN::RemoveSurface(struct _KTHREAD **this, struct _D3DKMT_REMOVESURFACEFROMSWAPCHAIN *a2)
{
  ...
  if ( this[3] != KeGetCurrentThread() )
  {
    ...
    DxgkLogInternalTriageEvent(0LL, 262146, -1, (__int64)L"m_SwapChainLock.IsOwner()", 2463LL, 0LL, 0LL, 0LL, 0LL);
  }
  if ( !*((_DWORD *)this + 58) )
  {
    WdLogSingleEntry1(2LL, 2469LL);
...
LABEL_8:
  ...
  DXGSWAPCHAIN::DestroySurfacesResourcesLocal((__int64)this, 0LL, (__int64)v11 + 112 * BufferIdx, BufferIdx);
  if ( v12[80] )
  {
    *((_DWORD *)v12 + 2) = 2;
  }
