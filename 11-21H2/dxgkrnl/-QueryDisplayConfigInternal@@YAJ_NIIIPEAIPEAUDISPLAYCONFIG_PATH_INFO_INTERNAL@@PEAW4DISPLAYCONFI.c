/*
 * XREFs of ?QueryDisplayConfigInternal@@YAJ_NIIIPEAIPEAUDISPLAYCONFIG_PATH_INFO_INTERNAL@@PEAW4DISPLAYCONFIG_TOPOLOGY_ID@@@Z @ 0x1C01B2C60
 * Callers:
...
{
  __int64 v7; // rdi
  enum DISPLAYCONFIG_TOPOLOGY_ID *v8; // rsi
  __int64 v9; // rbx
...
LABEL_17:
  ...
  if ( RequestedPathsModality >= 0 )
  {
    ...
    v26 = QDC_CACHE::AddToCache(*((QDC_CACHE **)Global + 191), v35, v24, v7, *v13, v12, v11);
    if ( v26 )
