/*
 * XREFs of ?WriteDxgDiagnosticsEvent_COMMIT_VIDPN_FAILED@@YAXPEAU_DXGK_DIAG_HEADER@@@Z @ 0x1C0052FF0
 * Callers:
...
void __fastcall WriteDxgDiagnosticsEvent_COMMIT_VIDPN_FAILED(struct _DXGK_DIAG_HEADER *a1)
{
  ...
  {
    if ( tlgKeywordOn((__int64)&dword_1C012F8E0, 0x200000000100LL) && tlgKeywordOn((__int64)&dword_1C012F8E0, v2) )
    {
      v14 = *((_WORD *)a1 + 2);
      v15 = *((_DWORD *)a1 + 10);
      v13 = a1;
    ...
    if ( (unsigned int)v3 > 4 && tlgKeywordOn((__int64)&dword_1C012F8E0, 0x400000000100LL) )
    {
