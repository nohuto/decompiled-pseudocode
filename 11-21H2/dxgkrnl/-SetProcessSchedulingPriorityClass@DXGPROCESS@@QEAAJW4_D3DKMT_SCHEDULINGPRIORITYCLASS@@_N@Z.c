/*
 * XREFs of ?SetProcessSchedulingPriorityClass@DXGPROCESS@@QEAAJW4_D3DKMT_SCHEDULINGPRIORITYCLASS@@_N@Z @ 0x1C01DF438
 * Callers:
        ...
        unsigned __int8 a3)
{
  ...
  {
    WdLogSingleEntry1(1LL, 3495LL);
    DxgkLogInternalTriageEvent(0LL, 262146, -1, (__int64)L"IsMutexOwner()", 3495LL, 0LL, 0LL, 0LL, 0LL);
  }
  ...
  if ( (int)result >= 0 )
  {
    *((_DWORD *)this + 78) = a2;
    ...
    while ( 1 )
    {
      ...
      if ( (int)COREADAPTERACCESS::AcquireShared((COREADAPTERACCESS *)v15, 0LL) >= 0 && (*((_BYTE *)v9 + 1869) & 1) == 0 )
      {
        LOBYTE(v11) = v5;
        (*(void (__fastcall **)(_QWORD, _QWORD, __int64))(*(_QWORD *)(*(_QWORD *)(*((_QWORD *)v9 + 2) + 624LL) + 8LL)
                                                        + 160LL))(
          *((_QWORD *)v9 + 96),
