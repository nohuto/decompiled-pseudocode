/*
 * XREFs of ?VmBusOpenKeyedMutex@DXG_HOST_GLOBAL_VMBUS@@SAEPEAUDXGADAPTER_VMBUS_PACKET@@@Z @ 0x1C0370F90
 * Callers:
 *     <none>
 * Callees:
...
unsigned __int8 __fastcall DXG_HOST_GLOBAL_VMBUS::VmBusOpenKeyedMutex(struct DXGADAPTER_VMBUS_PACKET *a1)
{
  ...
  if ( v8 )
  {
    HIDWORD(v10) = DXGKEYEDMUTEX::Open(v8, (unsigned int *)&v10, (char *)(v3 + 32), *(unsigned int *)(v3 + 28), 0);
    if ( v10 < 0 )
    {
