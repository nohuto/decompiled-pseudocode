/*
 * XREFs of AddBGRMapCache @ 0x1C025DE34
 * Callers:
...
__int64 __fastcall AddBGRMapCache(__int64 a1, int a2)
{
  ...
  if ( dword_1C032C6C8 > 5 && HIDWORD(qword_1C032C6CC) )
    TrimBGRMapCache();
  if ( dword_1C032C6C8 >= (int)qword_1C032C6CC )
  {
    v5 = qword_1C032C6CC + 10;
    if ( (int)qword_1C032C6CC + 10 >= (unsigned int)qword_1C032C6CC )
    {
      v6 = 16LL * v5;
      if ( v6 <= 0xFFFFFFFF )
      {
        ...
        if ( v7 )
        {
          ...
          if ( Src )
          {
            memmove(v7, Src, 16LL * dword_1C032C6C8);
            EngFreeMem(v9);
          }
          Src = v8;
          LODWORD(qword_1C032C6CC) = v5;
        }
      }
    }
  }
  v10 = Src;
  if ( Src && dword_1C032C6C8 < (int)qword_1C032C6CC )
  {
    v11 = 2LL * dword_1C032C6C8++;
    *((_QWORD *)Src + v11) = a1;
    v10[2 * v11 + 3] = a2;
    v10[2 * v11 + 2] = 1;
  }
