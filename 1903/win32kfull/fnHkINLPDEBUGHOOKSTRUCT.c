/*
 * XREFs of fnHkINLPDEBUGHOOKSTRUCT @ 0x1C021D470
 * Callers:
 ...
 *     ?CopyDebugHookLParam@@YAH_KPEAT_DEBUGLPARAM@@PEAUtagDEBUGHOOKINFO@@@Z @ 0x1C01643F4 (-CopyDebugHookLParam@@YAH_KPEAT_DEBUGLPARAM@@PEAUtagDEBUGHOOKINFO@@@Z.c)
...
__int64 __fastcall fnHkINLPDEBUGHOOKSTRUCT(int a1, unsigned __int64 a2, __int64 a3, __int64 a4, __int64 a5)
{
  ...
  _QWORD v20[3]; // [rsp+38h] [rbp-B0h] BYREF
