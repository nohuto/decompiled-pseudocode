/*
 * XREFs of EngLineTo @ 0x1C0102EC0
 * Callers:
 *     OffLineTo @ 0x1C003FEB8 (OffLineTo.c)
 *     W32kCddLineTo @ 0x1C015D6C0 (W32kCddLineTo.c)
        ...
        MIX mix)
{
  ...
  struct REGION *v26[2]; // [rsp+68h] [rbp-98h] BYREF
  struct _SURFOBJ *v27; // [rsp+78h] [rbp-88h]
  struct _LINEATTRS v28; // [rsp+80h] [rbp-80h] BYREF
  ...
  {
    v23 = *(_QWORD *)(v12 + 48);
    PDEVOBJ::vSync((PDEVOBJ *)&v23, v27, 0LL, 0);
    ...
    if ( PATHOBJ_bMoveTo(Path, ptfx) )
    {
      if ( PATHOBJ_bPolyLineTo(v16, &pptfx, 1u) )
        v13 = bStrokeCosmetic((struct SURFACE *)v12, v16, pco, pbo, &v28, mix);
    }
LABEL_30:
    EngDeletePath(v16);
    return v13;
...
LABEL_25:
  ...
  if ( !bUMPDSecurityGateEx(v18, v17, v19, v20) || prclBounds )
  {
    RGNOBJ::vSet((RGNOBJ *)v26, prclBounds);
    XCLIPOBJ::vSetup((XCLIPOBJ *)v31, v26[0], (struct ERECTL *)prclBounds, 0);
    pco = (CLIPOBJ *)v31;
LABEL_19:
    PRECOMPUTE::vInit(v29, v12, &v23, v16, pco, 0LL, &v28, mix, 0, 0);
    if ( v30 )
    {
      if ( (*(_DWORD *)(v12 + 112) & 0x20) != 0 )
        v21 = (*(__int64 (__fastcall **)(struct _SURFOBJ *, PATHOBJ *, CLIPOBJ *, _QWORD, BRUSHOBJ *, _QWORD, struct _LINEATTRS *, MIX))(v23 + 2800))(
                v27,
                v16,
                pco,
                0LL,
        ...
        v21 = ((__int64 (__fastcall *)(struct _SURFOBJ *, PATHOBJ *, CLIPOBJ *, _QWORD, BRUSHOBJ *, _QWORD, struct _LINEATTRS *, MIX))EngStrokePath)(
                v27,
                v16,
                pco,
                0LL,
