/*
 * XREFs of NtUserQueryWindow @ 0x1C00B1580
 * Callers:
 *     <none>
 * Callees:
...
LABEL_5:
  ...
  switch ( a2 )
  {
    case 1:
      goto LABEL_9;
    case 3:
      v10 = *(_QWORD *)(*(_QWORD *)(v7 + 424) + 128LL);
      if ( !v10 )
        goto LABEL_24;
      goto LABEL_16;
    case 4:
      ...
      else
      {
        ...
        if ( v13 )
        {
          ...
          if ( v14 )
          {
            ...
            EnterCrit(0LL, 1LL);
            v16 = HMValidateHandleNoSecure(v15, 1LL);
            if ( v16 )
