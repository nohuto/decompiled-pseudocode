...
LABEL_9:
        ...
        v29 = dword_1C02E442C[2 * v26];
        v30 = dword_1C02E4430[2 * v26];
        v31 = *(int *)(v238 + 4);
        v32 = *(int *)v238;
        v33 = (v25 - 1) * dword_1C02E4428[2 * v26];
        v241 = dword_1C02E4424[2 * v26];
        v237 = v29;
        v239 = v28;
        v244 = v30;
        v34 = dword_1C02E4434[2 * v26];
        v249 = v241 * v31 + v28 * v32 + v33;
        v35 = SLODWORD((&aiPlgSort)[v27]);
        v36 = v29 * v32 + (v24 - 1) * v34;
        v37 = dword_1C02E43A4[2 * v27];
        v242 = v30 * v31 + v36;
        v38 = *((int *)&v258 + 2 * v35);
        v39 = *((int *)&v258 + 2 * v35 + 1);
        v40 = dword_1C02E43A8[2 * v27];
