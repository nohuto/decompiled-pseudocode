/*
 * XREFs of xxxRemotePassthruEnable @ 0x1C0213A60
 * Callers:
 *     <none>
 * Callees:
...
__int64 xxxRemotePassthruEnable()
{
  ...
  if ( PsGetCurrentProcess(v1, v0, v3, v4) != gpepCSRSS )
    return 3221225506LL;
  dword_1C0332EC4 = gapulCvt_VK != gapulCvt_VK_84;
  ZwDeviceIoControlFile(ghRemoteKeyboardChannel, 0LL, 0LL, 0LL, &IoStatusBlock, 0x38080Fu, &dword_1C0332EC4, 4u, 0LL, 0);
  v7 = guKbdTblSize;
  if ( guKbdTblSize )
