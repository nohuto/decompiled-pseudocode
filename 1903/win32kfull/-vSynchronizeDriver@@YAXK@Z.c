/*
 * XREFs of ?vSynchronizeDriver@@YAXK@Z @ 0x1C0034584
 * Callers:
 *     GreFlush @ 0x1C00340C0 (GreFlush.c)
 *     ?GreSynchronizeTimer@@YAXPEAXI_K_J@Z @ 0x1C0299000 (-GreSynchronizeTimer@@YAXPEAXI_K_J@Z.c)
 * Callees:
 *     <none>
 */
