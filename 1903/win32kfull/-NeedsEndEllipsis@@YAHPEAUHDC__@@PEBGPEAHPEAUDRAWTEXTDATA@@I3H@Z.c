/*
 * XREFs of ?NeedsEndEllipsis@@YAHPEAUHDC__@@PEBGPEAHPEAUDRAWTEXTDATA@@I3H@Z @ 0x1C025B018
 * Callers:
 ...
 *     ?DT_AdjustBreakForSurrogatesAndVariationSelectors@@YAHPEBGHH@Z @ 0x1C025A9DC (-DT_AdjustBreakForSurrogatesAndVariationSelectors@@YAHPEBGHH@Z.c)
        ...
        struct DRAWTEXTDATA *a6)
{
  ...
  v11 = *((_DWORD *)a4 + 8);
  v12 = *((_DWORD *)a4 + 14);
  if ( (int)DT_GetExtentMinusPrefixes(a1, a2, (unsigned int)v6, a5, v17, a6, -1) <= v11
  ...
  if ( v13 > 0 )
  {
    ...
    if ( v6 > 0 )
    {
      do
      {
        ExtentMinusPrefixes = DT_GetExtentMinusPrefixes(a1, a2, (unsigned int)((v7 + v14 + 1) / 2), a5, v18, a6, -1);
