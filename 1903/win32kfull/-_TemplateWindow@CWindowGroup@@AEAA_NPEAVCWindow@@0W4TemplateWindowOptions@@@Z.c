/*
 * XREFs of ?_TemplateWindow@CWindowGroup@@AEAA_NPEAVCWindow@@0W4TemplateWindowOptions@@@Z @ 0x1C023E480
 * Callers:
...
char __fastcall CWindowGroup::_TemplateWindow(__int64 a1, __int64 a2, __int64 a3, __int64 a4)
{
  unsigned int v4; // ebp
  char v6; // bl
  ...
  if ( v8 )
  {
    ...
    v6 = CWindow::TemplateWindow(a3, v8, v4, v9);
    UserAtomicCheck::~UserAtomicCheck((UserAtomicCheck *)&v11);
  }
  return v6;
}
