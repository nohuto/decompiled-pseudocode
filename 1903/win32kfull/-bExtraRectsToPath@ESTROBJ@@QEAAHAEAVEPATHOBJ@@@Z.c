/*
 * XREFs of ?bExtraRectsToPath@ESTROBJ@@QEAAHAEAVEPATHOBJ@@@Z @ 0x1C02B6230
 * Callers:
 ...
 *     ??0CFixPred@Prediction@@QEAA@XZ @ 0x1C0142180 (--0CFixPred@Prediction@@QEAA@XZ.c)
 *     ?bLinkedGlyphs@ESTROBJ@@QEBAHXZ @ 0x1C0292AFC (-bLinkedGlyphs@ESTROBJ@@QEBAHXZ.c)
 *     ?cGetGlyphData@RFONTOBJ@@QEAAKKPEAU_GLYPHPOS@@@Z @ 0x1C02A09F4 (-cGetGlyphData@RFONTOBJ@@QEAAKKPEAU_GLYPHPOS@@@Z.c)
 *     ?GetLinkedRfontOnIndex@ESTROBJ@@QEAAPEAVRFONT@@JAEAVRFONTOBJ@@@Z @ 0x1C02B5FAC (-GetLinkedRfontOnIndex@ESTROBJ@@QEAAPEAVRFONT@@JAEAVRFONTOBJ@@@Z.c)
