/*
 * XREFs of ?UpdateISODState@Delivery@InputTraceLogging@@SAXPEBUtagQMSG@@@Z @ 0x1C0011FBC
 * Callers:
...
void __fastcall InputTraceLogging::Delivery::UpdateISODState(const struct tagQMSG *a1)
{
  ...
  v1 = *((_DWORD *)a1 + 6);
  if ( (v1 - 256 <= 9 || InputTraceLogging::IsMouseInputMessage(v1)) && dword_1C03222C0 > 4u )
  {
    if ( TlgKeywordOn((TraceLoggingHProvider)&dword_1C03222C0, 0x10uLL) )
    {
      ...
      v11 = -__CFSHR__(v6, 19);
      v25 = 4LL;
      TlgWrite((TraceLoggingHProvider)&dword_1C03222C0, &unk_1C02E7E7E, 0LL, 0LL, cData, &pData);
    }
  }
}
