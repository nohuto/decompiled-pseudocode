/*
 * XREFs of ?hCreateHatchBrushInternal@@YAPEAUHBRUSH__@@KKH@Z @ 0x1C02B002C
 * Callers:
 *     GreExtCreatePen @ 0x1C0108B9C (GreExtCreatePen.c)
 *     NtGdiCreateHatchBrushInternal @ 0x1C02B00F0 (NtGdiCreateHatchBrushInternal.c)
 * Callees:
 *     ??1BRUSHMEMOBJ@@QEAA@XZ @ 0x1C015AE9C (--1BRUSHMEMOBJ@@QEAA@XZ.c)
 */
