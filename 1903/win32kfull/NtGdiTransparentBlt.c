/*
 * XREFs of NtGdiTransparentBlt @ 0x1C0147950
 * Callers:
 ...
 *     ?bRotationOrMirroring@EXFORMOBJ@@QEBAHXZ @ 0x1C0147FC8 (-bRotationOrMirroring@EXFORMOBJ@@QEBAHXZ.c)
      ...
      else
      {
        ...
        if ( !ERECTL::bEmpty((ERECTL *)&v96) )
        {
          ...
          *(_QWORD *)&v75 = 0LL;
          BYTE8(v75) = 0;
          HIDWORD(v75) = 0;
          if ( (GetAppCompatFlags2(1024LL, (__int64)v16, (__int64)v17, v18) & 0x8000000) != 0 )
          {
