/*
 * XREFs of ?vDIBSolidBlt@@YAXPEAVSURFACE@@PEAU_RECTL@@PEAU_CLIPOBJ@@KH@Z @ 0x1C0056AC0
 * Callers:
...
void __fastcall vDIBSolidBlt(struct SURFACE *a1, struct _RECTL *a2, struct _CLIPOBJ *a3, int a4, int a5)
{
  ...
  void (__fastcall *v11)(struct _RECTL *, unsigned int, unsigned __int8 *, int, unsigned int, unsigned int); // r14
  ...
  if ( v8 )
  {
    ...
    while ( 1 )
    {
      ...
      if ( !v28 )
        break;
LABEL_31:
      v28 = XCLIPOBJ::bEnum((XCLIPOBJ *)a3, 0x144u, v30, 0LL);
    }
  }
  else
  {
