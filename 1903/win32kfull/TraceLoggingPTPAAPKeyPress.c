/*
 * XREFs of TraceLoggingPTPAAPKeyPress @ 0x1C01CFA90
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall TraceLoggingPTPAAPKeyPress(int a1)
{
  ...
  if ( a1 && v3 > 0 && result > v3 )
  {
    ...
    if ( v6 < 500 || result < 500 )
    {
      ...
      TraceLoggingPTPKeyToGestureTiming(gAapState[12], v3, gTPTelemTimings, v2.QuadPart, PerformanceFrequency.QuadPart);
