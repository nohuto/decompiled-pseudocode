/*
 * XREFs of NtUserCloseClipboard @ 0x1C00B75E0
 * Callers:
 *     <none>
 * Callees:
...
__int64 NtUserCloseClipboard()
{
  ...
  if ( dword_1C0321230 > 5u && TlgKeywordOn((TraceLoggingHProvider)&dword_1C0321230, 0x400000000000uLL) )
  {
    ...
    *(_DWORD *)&EventDescriptor.Id = 184549376;
    ...
    {
      v5 = 0;
      v6 = (char *)&unk_1C02E882A;
      do
        v7 = *v6++;
      while ( v7 < 0 );
      while ( *v6++ )
        ;
      if ( v6 >= (char *)&unk_1C02E8866 )
        goto LABEL_32;
      do
      {
        while ( *v6++ )
...
LABEL_32:
  ...
  if ( !(_DWORD)v2 )
  {
    ...
    if ( v17 && hProvider > 5u && TlgKeywordOn((TraceLoggingHProvider)&hProvider, 1uLL) )
    {
      ...
      TlgWrite((TraceLoggingHProvider)&hProvider, &unk_1C02E87DF, 0LL, 0LL, 5u, &pData);
    }
  }
