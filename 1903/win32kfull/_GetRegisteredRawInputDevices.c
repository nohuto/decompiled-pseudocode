/*
 * XREFs of _GetRegisteredRawInputDevices @ 0x1C01D8404
 * Callers:
 *     NtUserGetRegisteredRawInputDevices @ 0x1C022EF10 (NtUserGetRegisteredRawInputDevices.c)
 * Callees:
 *     UserSetLastError @ 0x1C008B3AC (UserSetLastError.c)
 *     ?SortRegisteredDevices@@YAXPEAUtagRAWINPUTDEVICE@@H@Z @ 0x1C01D7D84 (-SortRegisteredDevices@@YAXPEAUtagRAWINPUTDEVICE@@H@Z.c)
 */
