/*
 * XREFs of xInsertGlyphbitsRFONTOBJ @ 0x1C0109FA8
 * Callers:
 ...
 *     ?vFlushCache@RFONTOBJ@@QEAAXXZ @ 0x1C02CDF8C (-vFlushCache@RFONTOBJ@@QEAAXXZ.c)
 */
...
__int64 __fastcall xInsertGlyphbitsRFONTOBJ(RFONTOBJ *this, struct _GLYPHDATA *a2, unsigned int a3)
{
  ...
  if ( (*(_DWORD *)(*(_QWORD *)this + 84LL) & 1) == 0 )
  {
    ...
    if ( v7 )
    {
      ...
      v17[0] = *(_QWORD *)(v3 + 128);
      if ( *(struct PDEV **)(v17[0] + 88LL) == qword_1C0332E90 )
      {
        v16 = 0LL;
        v15 = *(_DWORD *)(v3 + 636);
