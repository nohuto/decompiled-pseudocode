/*
 * XREFs of NtUserSetClipboardData @ 0x1C00B89D0
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall NtUserSetClipboardData(unsigned int a1, __int64 a2, __int64 *a3)
{
  ...
  if ( v11 )
  {
    ...
    if ( hProvider > 5u && TlgKeywordOn((TraceLoggingHProvider)&hProvider, 1uLL) )
    {
      ...
      TlgWrite((TraceLoggingHProvider)&hProvider, &unk_1C02E8753, 0LL, 0LL, 5u, &pData);
    }
LABEL_14:
    v17 = 0;
  ...
  if ( *(_DWORD *)(PsGetCurrentProcessWin32Process(v10, v9) + 876) )
  {
    ...
    if ( (!gpqForeground || !(unsigned int)ForegroundInputOwnerMatch(gptiCurrent, 1)) && v19 != *(_QWORD *)(v20 + 48) )
    {
      ...
      if ( !v21 || *(_QWORD *)(v21 + 16) != v19 )
      {
        if ( dword_1C0321230 > 5u )
        {
          if ( TlgKeywordOn((TraceLoggingHProvider)&dword_1C0321230, 0x400000000000uLL) )
          {
            ...
            *(_DWORD *)&v44.Level = 5;
            ...
            v64.Ptr = (ULONGLONG)off_1C0321238;
            v64.Size = *(unsigned __int16 *)off_1C0321238;
            v64.Reserved = 2;
            v65 = &unk_1C02E879E;
            v66 = 64;
            v67 = 1;
        ...
        if ( hProvider > 5u && TlgKeywordOn((TraceLoggingHProvider)&hProvider, 1uLL) )
        {
          ...
          TlgWrite((TraceLoggingHProvider)&hProvider, &unk_1C02E8753, 0LL, 0LL, 5u, &v103);
        }
        goto LABEL_14;
      }
    }
    if ( a1 != 1 && a1 != 13 )
    {
      if ( dword_1C0321230 > 5u )
      {
        if ( TlgKeywordOn((TraceLoggingHProvider)&dword_1C0321230, 0x400000000000uLL) )
        {
          ...
          *(_DWORD *)&v45.Level = 5;
          ...
          v75.Ptr = (ULONGLONG)off_1C0321238;
          v75.Size = *(unsigned __int16 *)off_1C0321238;
          v75.Reserved = 2;
          v76 = &unk_1C02E879E;
          v77 = 64;
          v78 = 1;
      ...
      if ( hProvider > 5u && TlgKeywordOn((TraceLoggingHProvider)&hProvider, 1uLL) )
      {
        ...
        TlgWrite((TraceLoggingHProvider)&hProvider, &unk_1C02E8753, 0LL, 0LL, 5u, &v109);
      }
      goto LABEL_14;
    }
  }
  ...
  v51 = *a3;
  v17 = SetClipboardData(a1, a2, (_DWORD)v51 != 0, HIDWORD(v51) != 0);
  if ( dword_1C0321230 > 5u && TlgKeywordOn((TraceLoggingHProvider)&dword_1C0321230, 0x400000000000uLL) )
  {
    ...
    *(_DWORD *)&v46.Level = 5;
    ...
    v86.Ptr = (ULONGLONG)off_1C0321238;
    v86.Size = *(unsigned __int16 *)off_1C0321238;
    v86.Reserved = 2;
    v87 = &unk_1C02E879E;
    v88 = 64;
    v89 = 1;
  ...
  if ( !v17 )
  {
    ...
    if ( v30 && hProvider > 5u && TlgKeywordOn((TraceLoggingHProvider)&hProvider, 1uLL) )
    {
      ...
      TlgWrite((TraceLoggingHProvider)&hProvider, &unk_1C02E8753, 0LL, 0LL, 5u, &v115);
    }
  }
LABEL_63:
