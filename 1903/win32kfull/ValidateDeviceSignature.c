/*
 * XREFs of ValidateDeviceSignature @ 0x1C01F0050
 * Callers:
 *     <none>
 * Callees:
 *     ?CheckForSegmentedSignatureBlob@@YAJPEAXGPEAU_HIDP_VALUE_CAPS@@PEAG@Z @ 0x1C01ECEB0 (-CheckForSegmentedSignatureBlob@@YAJPEAXGPEAU_HIDP_VALUE_CAPS@@PEAG@Z.c)
