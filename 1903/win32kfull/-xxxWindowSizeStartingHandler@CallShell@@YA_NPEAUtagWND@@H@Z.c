/*
 * XREFs of ?xxxWindowSizeStartingHandler@CallShell@@YA_NPEAUtagWND@@H@Z @ 0x1C023A9DC
 * Callers:
...
bool __fastcall CallShell::xxxWindowSizeStartingHandler(CallShell *this, struct tagWND *a2)
{
  ...
  v8 = *((_QWORD *)this + 5);
  LODWORD(v10[4]) = v7;
  TransformRectBetweenCoordinateSpaces((char *)&v10[1] + 4, v8 + 88, *(_QWORD *)(*(_QWORD *)(v2 + 448) + 328LL), this);
  return (unsigned int)anonymous_namespace_::xxxCallIAMWindowManagementHandler() != 0;
}
