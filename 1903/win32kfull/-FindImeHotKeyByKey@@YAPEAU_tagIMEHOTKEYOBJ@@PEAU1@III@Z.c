/*
 * XREFs of ?FindImeHotKeyByKey@@YAPEAU_tagIMEHOTKEYOBJ@@PEAU1@III@Z @ 0x1C00B45E8
 * Callers:
 *     CheckImeHotKey @ 0x1C00B1A10 (CheckImeHotKey.c)
 * Callees:
 *     GetActiveHKL @ 0x1C00B4694 (GetActiveHKL.c)
 *     ?GetHotKeyLangID@@YAGK@Z @ 0x1C0120AB8 (-GetHotKeyLangID@@YAGK@Z.c)
 *     ?GetLangIdMatchLevel@@YAHPEAUHKL__@@G@Z @ 0x1C020C4F8 (-GetLangIdMatchLevel@@YAHPEAUHKL__@@G@Z.c)
 */
