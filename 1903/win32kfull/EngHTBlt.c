 ...
 *     ?bSetHTSurfInfo@@YAHPEAU_SURFOBJ@@PEAU_HTSURFACEINFO@@J@Z @ 0x1C0036304 (-bSetHTSurfInfo@@YAHPEAU_SURFOBJ@@PEAU_HTSURFACEINFO@@J@Z.c)
 ...
 *     ?ppalGetFromXlate@@YAPEAVPALETTE@@PEAVSURFACE@@0PEAVXLATE@@IH@Z @ 0x1C0036E40 (-ppalGetFromXlate@@YAPEAVPALETTE@@PEAVSURFACE@@0PEAVXLATE@@IH@Z.c)
...
LABEL_156:
            ...
            {
              v123 = *((_QWORD *)v34 + 14);
              WORD1(v122) = *((_WORD *)v34 + 14);
              v88 = *((_DWORD *)v34 + 6);
              if ( (v88 & 8) != 0
                || (v88 & 2) != 0
                && (v89 = (_DWORD *)*((_QWORD *)v34 + 14), *v89 == 16711680)
                && v89[1] == 65280
                && v89[2] == 255 )
              {
                LOBYTE(v122) = v87 | 2;
...
LABEL_27:
            ...
            *(_QWORD *)&prclDest[5] = *(_QWORD *)&v125->left;
            prclDest[1] = v37;
            ...
            if ( !psoDest->iType && psoDest->lDelta == v18 && ((_DWORD)v109 || v104 == 3) && iDComplexity != 3 )
            {
              if ( psoDest != *(SURFOBJ **)&prclTrg.left
                || (p_left = (int *)v108, v90 = bIntersect(v115, v108, v36), !v90) )
              {
LABEL_57:
                v55 = xloIdent;
                v108 = xloIdent;
