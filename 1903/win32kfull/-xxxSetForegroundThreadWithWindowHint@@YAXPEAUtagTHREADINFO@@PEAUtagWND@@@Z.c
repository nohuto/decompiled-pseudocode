/*
 * XREFs of ?xxxSetForegroundThreadWithWindowHint@@YAXPEAUtagTHREADINFO@@PEAUtagWND@@@Z @ 0x1C0014388
 * Callers:
 ...
 *     xxxSetForegroundThread @ 0x1C01D6790 (xxxSetForegroundThread.c)
 * Callees:
...
void __fastcall xxxSetForegroundThreadWithWindowHint(struct tagTHREADINFO *this, struct tagWND *a2, struct tagWND *a3)
{
  ...
  _QWORD v19[2]; // [rsp+38h] [rbp-41h] BYREF
  __int128 v20; // [rsp+48h] [rbp-31h]
  ...
  if ( this != (struct tagTHREADINFO *)gptiForeground )
  {
    if ( !this || !gptiForeground || *((_QWORD *)this + 52) != *(_QWORD *)(gptiForeground + 416LL) )
    {
      ...
      v23 = 0uLL;
      v24 = 0LL;
      if ( (unsigned int)CitProcessForegroundChange(this, a2, gptiForeground, &v23) )
      {
        if ( this && (v5 = *((_QWORD *)this + 56)) != 0 && *(_QWORD *)(v5 + 288) )
          DWORD1(v23) = *(_DWORD *)(*((_QWORD *)this + 52) + 56LL);
        else
          DWORD1(v23) = 0;
        if ( gptiForeground && (v6 = *(_QWORD *)(gptiForeground + 448LL)) != 0 && *(_QWORD *)(v6 + 288) )
          LODWORD(v23) = *(_DWORD *)(*(_QWORD *)(gptiForeground + 416LL) + 56LL);
        else
          LODWORD(v23) = 0;
        v19[1] = 9LL;
        v22 = 0LL;
        ...
        v19[0] = 0LL;
        v21 = v24;
        anonymous_namespace_::NotifyIAMWindowManagementEvent(v19);
      }
      if ( this )
    ...
    if ( gSessionId != gServiceSessionId && !gProtocolType )
    {
      ...
      if ( this )
      {
        LODWORD(v25[0]) = *(_DWORD *)(*((_QWORD *)this + 52) + 56LL);
        HIDWORD(v25[0]) = (unsigned int)PsGetThreadId(*(PETHREAD *)this);
        if ( a2 )
          v25[2] = *(_QWORD *)a2;
        else
          v25[2] = 0LL;
      }
      SendMessageTo(3LL, v25);
    }
    if ( gptiForeground )
    {
