/*
 * XREFs of GreEnsureDpiDepDefaultGuiFontForPlateau @ 0x1C028DC20
 * Callers:
 *     NtGdiEnsureDpiDepDefaultGuiFontForPlateau @ 0x1C02A7720 (NtGdiEnsureDpiDepDefaultGuiFontForPlateau.c)
 * Callees:
