/*
 * XREFs of ??0PANSURFLOCK@@QEAA@PEAU_PANDEV@@PEAPEAU_SURFOBJ@@PEAU_RECTL@@PEAHPEAU_CLIPOBJ@@@Z @ 0x1C028ED44
 * Callers:
 ...
 * Callees:
 *     ?vLockBmpAndPrepareForPunt@PANSURFLOCK@@QEAAXXZ @ 0x1C0291130 (-vLockBmpAndPrepareForPunt@PANSURFLOCK@@QEAAXXZ.c)
