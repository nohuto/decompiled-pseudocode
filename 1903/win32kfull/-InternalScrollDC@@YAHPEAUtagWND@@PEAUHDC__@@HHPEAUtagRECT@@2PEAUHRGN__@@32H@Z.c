/*
 * XREFs of ?InternalScrollDC@@YAHPEAUtagWND@@PEAUHDC__@@HHPEAUtagRECT@@2PEAUHRGN__@@32H@Z @ 0x1C00C65E0
 * Callers:
 ...
 *     ?GetTrueClipRgn@@YAHPEAUHDC__@@PEAUHRGN__@@@Z @ 0x1C015A898 (-GetTrueClipRgn@@YAHPEAUHDC__@@PEAUHRGN__@@@Z.c)
          ...
          if ( (unsigned int)GreCombineRgn(v54, v54, EmptyRgn, 1LL) )
          {
            ...
            if ( (unsigned int)GreCombineRgn(v47, v53, 0LL, 5LL) )
            {
              ...
              if ( (unsigned __int64)v48 > 1 )
              {
                ...
                {
                  v51 = 0LL;
                  GetDCOrgOnScreen((__int64)a2, &v51);
...
LABEL_42:
          ...
          if ( (int)v62 < (int)v63 )
          {
            ...
            if ( SHIDWORD(v62) < SHIDWORD(v63) )
            {
              ...
              NtGdiBitBltInternal(a2, v29, v31, v30 - v29, v32 - v31, a2, v29 - (_DWORD)v56, v31 - v55, 13369376, 0, 0);
            }
          }
          goto LABEL_47;
        }
