/*
 * XREFs of ?SetDeviceFocus@InteractiveControlManager@@QEAAJKW4tagINTERACTIVECTRL_PROMOTION_TYPE@@PEAUtagWND@@@Z @ 0x1C024F2D4
 * Callers:
...
__int64 __fastcall InteractiveControlManager::SetDeviceFocus(__int64 a1, int a2, unsigned int a3, __int64 a4)
{
  ...
  if ( dword_1C0321308 > 4u )
  {
    ...
    v15[0] = a4;
    v27 = 8;
    TlgWrite((TraceLoggingHProvider)&dword_1C0321308, &unk_1C02E9013, 0LL, 0LL, 6u, &pData);
  }
  v8 = (__int64 *)(a1 + 40);
  v9 = 5LL;
  do
