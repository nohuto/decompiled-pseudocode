/*
 * XREFs of ?vOrClearTypeGlyph@@YAXPEAU_GLYPHBITS@@IPEAEI@Z @ 0x1C0276054
 * Callers:
 *     draw_clrt_f_ntb_o_to_temp_start @ 0x1C0276390 (draw_clrt_f_ntb_o_to_temp_start.c)
 * Callees:
 *     <none>
 */
...
void __fastcall vOrClearTypeGlyph(struct _GLYPHBITS *a1, unsigned int a2, unsigned __int8 *a3, unsigned int a4)
{
  ...
  if ( a3 < v6 )
  {
    ...
    do
    {
      ...
      if ( v9 )
      {
        v11 = (unsigned __int8 *)off_1C03210F0;
        do
        {
          v12 = aj[v10 - v5];
          if ( *v10 )
