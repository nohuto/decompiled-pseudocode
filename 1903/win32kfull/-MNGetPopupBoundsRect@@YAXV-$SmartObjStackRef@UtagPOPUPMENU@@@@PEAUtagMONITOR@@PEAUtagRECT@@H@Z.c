/*
 * XREFs of ?MNGetPopupBoundsRect@@YAXV?$SmartObjStackRef@UtagPOPUPMENU@@@@PEAUtagMONITOR@@PEAUtagRECT@@H@Z @ 0x1C0221AC4
 * Callers:
...
_QWORD *__fastcall MNGetPopupBoundsRect(int ***a1, __int64 a2, _OWORD *a3, int a4)
{
  ...
  v11 = *GetMonitorRectForWindow(&v24, a2, *((const struct tagWND **)**a1 + 2));
  v12 = *a1;
  v27 = v11;
  if ( **v12 >= 0 )
  {
  ...
  v16 = *a1;
  *(_OWORD *)v26 = v15;
  if ( (*(_DWORD *)(*(_QWORD *)(*((_QWORD *)*v16 + 2) + 40LL) + 288LL) & 0xF) != 2 )
  {
    v17 = ValidateHmonitorNoRip(*(_QWORD *)(*(_QWORD *)(*((_QWORD *)**a1 + 2) + 40LL) + 256LL));
    v23 = v17;
    if ( v17 )
    {
      if ( v17 != a2 )
