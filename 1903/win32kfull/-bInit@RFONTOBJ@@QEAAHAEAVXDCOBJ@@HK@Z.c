/*
 * XREFs of ?bInit@RFONTOBJ@@QEAAHAEAVXDCOBJ@@HK@Z @ 0x1C00676B0
 * Callers:
...
LABEL_82:
      v46 = *(_QWORD *)a2;
      if ( *(float *)(*(_QWORD *)a2 + 452LL) == 0.0 || (unsigned int)EFLOAT::bIsZero((EFLOAT *)(v46 + 456)) )
      {
...
LABEL_56:
  ...
  if ( *(_QWORD *)this && *(_DWORD *)(v37 + 660) )
  {
    ...
    {
      v39 = (struct RFONT **)PALLOCMEM2(8 * v38 + 32);
      if ( !v39 )
        goto LABEL_96;
      v40 = 1;
    }
...
LABEL_158:
  ...
  {
    RFONTOBJ::vRemove(v76, &v125, 1LL);
    RFONTOBJ::vInsert(v76, &v125, 1LL);
