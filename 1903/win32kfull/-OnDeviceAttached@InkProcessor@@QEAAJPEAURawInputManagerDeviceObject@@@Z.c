/*
 * XREFs of ?OnDeviceAttached@InkProcessor@@QEAAJPEAURawInputManagerDeviceObject@@@Z @ 0x1C024540C
 * Callers:
 ...
 *     ??_EInkDevice@@UEAAPEAXI@Z @ 0x1C02453A0 (--_EInkDevice@@UEAAPEAXI@Z.c)
  ...
  if ( *((_BYTE *)this + 8) )
  {
    ...
    if ( v6 )
    {
      ...
      else if ( dword_1C0321298 > 2u )
      {
        ...
        v12 = a2;
        v21 = 8LL;
        TlgWrite((TraceLoggingHProvider)&dword_1C0321298, &unk_1C02E8D6B, 0LL, 0LL, 5u, &pData);
      }
      if ( v4 < 0 )
