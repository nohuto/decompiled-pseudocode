/*
 * XREFs of ?MulBitBlt@@YAHPEAU_SURFOBJ@@00PEAU_CLIPOBJ@@PEAU_XLATEOBJ@@PEAU_RECTL@@PEAU_POINTL@@4PEAU_BRUSHOBJ@@4K@Z @ 0x1C029AB30
 * Callers:
 ...
 *     ?vRestore@MSURF@@QEAAXXZ @ 0x1C02A03C4 (-vRestore@MSURF@@QEAAXXZ.c)
