/*
 * XREFs of ?CreateHLSURFClone@SFMLOGICALSURFACE@@SAPEAUHLSURF__@@PEAUHDEV__@@PEAV1@HHH@Z @ 0x1C0045EF4
 * Callers:
 ...
 *     SFMLOGICALSURFACE_CreateHLSURFCloneWrap @ 0x1C013DD40 (SFMLOGICALSURFACE_CreateHLSURFCloneWrap.c)
 * Callees:
 ...
 *     ?Initialize@SFMLOGICALSURFACE@@QEAAHPEAUHWND__@@IIU_LUID@@W4_HLSURF_DISPOSITION@@@Z @ 0x1C00495BC (-Initialize@SFMLOGICALSURFACE@@QEAAHPEAUHWND__@@IIU_LUID@@W4_HLSURF_DISPOSITION@@@Z.c)
