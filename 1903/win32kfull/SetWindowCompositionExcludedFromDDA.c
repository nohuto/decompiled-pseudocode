/*
 * XREFs of SetWindowCompositionExcludedFromDDA @ 0x1C0161084
 * Callers:
...
__int64 __fastcall SetWindowCompositionExcludedFromDDA(__int64 *a1, __int128 *a2)
{
  ...
  {
    v6 = *(_DWORD *)a2 != 0;
    if ( -__CFSHR__(v12[0], 15) == v6 )
      return 0;
    v12[0] = (v6 << 14) | v12[0] & 0xFFFFBFFF;
    ...
    else
    {
      ...
      return (unsigned int)DwmAsyncSetCompositionAttribute(v10, *a1, 24, a2);
    }
  }
  return v4;
}
