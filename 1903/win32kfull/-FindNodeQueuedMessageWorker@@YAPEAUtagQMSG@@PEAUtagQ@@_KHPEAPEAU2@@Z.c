/*
 * XREFs of ?FindNodeQueuedMessageWorker@@YAPEAUtagQMSG@@PEAUtagQ@@_KHPEAPEAU2@@Z @ 0x1C01CD5A8
 * Callers:
 *     EditionFindNodeQueuedMessage @ 0x1C01CD700 (EditionFindNodeQueuedMessage.c)
 * Callees:
