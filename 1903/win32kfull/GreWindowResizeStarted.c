/*
 * XREFs of GreWindowResizeStarted @ 0x1C026DD6C
 * Callers:
 ...
 *     UserDCompositionCreateSynchronizationObject @ 0x1C020F344 (UserDCompositionCreateSynchronizationObject.c)
...
__int64 __fastcall GreWindowResizeStarted(__int64 a1, HWND a2, int a3, unsigned int *a4, unsigned int *a5)
{
  ...
  if ( g_pDwmState )
  {
    DWMSPRITELOCK::DWMSPRITELOCK((DWMSPRITELOCK *)&v33, v10, 0LL, 0LL);
          ...
          if ( (unsigned int)UserDCompositionCreateSynchronizationObject(&Object) )
          {
            ...
            else
            {
              ...
              *((_DWORD *)v12 + 31) = 1;
              ...
              DwmAsyncUpdateSprite(v25, v24, v23, 256, 0LL, 0LL, 0, 0, 0, 0, 0LL);
            }
          }
