/*
 * XREFs of ?TraceLoggingRimHidDeviceArrivedEvent@@YAXGIIKKHPEAU_UNICODE_STRING@@0HHIIIKK@Z @ 0x1C01CEC60
 * Callers:
        ...
        char a15)
{
  ...
  if ( hProvider > 5u )
  {
    if ( TlgKeywordOn((TraceLoggingHProvider)&hProvider, 0x800000000000uLL) )
    {
      ...
      v52 = 4LL;
      v54 = 4LL;
      TlgWrite((TraceLoggingHProvider)&hProvider, &unk_1C02E5DDB, 0LL, 0LL, 0x14u, &pData);
    }
  }
}
