/*
 * XREFs of ?TPAAPShouldAllowNow@@YAHKHH@Z @ 0x1C0202ACC
 * Callers:
 *     EditionLegacyTouchPadMouseAllowTap @ 0x1C0203010 (EditionLegacyTouchPadMouseAllowTap.c)
 * Callees:
 *     ?TPAAPSqmBlockedCount@@YAXH@Z @ 0x1C0202C04 (-TPAAPSqmBlockedCount@@YAXH@Z.c)
 */
