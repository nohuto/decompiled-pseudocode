/*
 * XREFs of NtGdiCreateSessionMappedDIBSection @ 0x1C0117AF0
 * Callers:
 *     <none>
 * Callees:
        ...
        unsigned __int64 a8)
{
  ...
  int v17; // edx
  ULONG v19; // ecx
  struct tagBITMAPINFO *v20; // [rsp+70h] [rbp-58h] BYREF
...
LABEL_21:
  ...
  bCaptureBitmapInfo(a4, a5, Size, (const struct tagBITMAPINFO **)&v20);
  v12 = v20;
  if ( v20 )
  {
