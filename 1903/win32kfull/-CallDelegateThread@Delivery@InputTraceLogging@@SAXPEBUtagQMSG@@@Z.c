/*
 * XREFs of ?CallDelegateThread@Delivery@InputTraceLogging@@SAXPEBUtagQMSG@@@Z @ 0x1C01E1560
 * Callers:
...
void __fastcall InputTraceLogging::Delivery::CallDelegateThread(const struct tagQMSG *a1)
{
  ...
  if ( IsPointerInputMessage(*((_DWORD *)a1 + 6)) )
  {
    if ( dword_1C03222C0 > 4u )
    {
      if ( TlgKeywordOn((TraceLoggingHProvider)&dword_1C03222C0, 0x10uLL) )
      {
        ...
        v11 = v3;
        v28 = v2;
        TlgWrite((TraceLoggingHProvider)&dword_1C03222C0, &unk_1C02E7DCB, 0LL, 0LL, 7u, &pData);
      }
    }
  }
         ...
         && TlgKeywordOn((TraceLoggingHProvider)&dword_1C03222C0, 0x10uLL) )
  {
    ...
    v11 = v7;
    v19 = cData;
    TlgWrite((TraceLoggingHProvider)&dword_1C03222C0, &unk_1C02E7E39, 0LL, 0LL, cData, &pData);
  }
}
