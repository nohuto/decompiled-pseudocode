/*
 * XREFs of ?Cleanup@CWindowGroupManager@@QEAAXW4CleanupType@1@@Z @ 0x1C023D704
 * Callers:
 *     ?CleanupShellWindowManagement@@YAXPEAUtagDESKTOP@@@Z @ 0x1C000C2AC (-CleanupShellWindowManagement@@YAXPEAUtagDESKTOP@@@Z.c)
 *     ?Uninitialize@CWindowGroupManager@@SAXXZ @ 0x1C023E290 (-Uninitialize@CWindowGroupManager@@SAXXZ.c)
 * Callees:
 *     ??_GCWindowGroup@@QEAAPEAXI@Z @ 0x1C023D3D0 (--_GCWindowGroup@@QEAAPEAXI@Z.c)
