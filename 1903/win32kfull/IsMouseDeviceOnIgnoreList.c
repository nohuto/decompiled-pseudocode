/*
 * XREFs of IsMouseDeviceOnIgnoreList @ 0x1C012A710
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall IsMouseDeviceOnIgnoreList(int a1, __int64 a2, int a3)
{
  unsigned int v3; // esi
  ...
  *(_QWORD *)&DestinationString.Length = 0LL;
  ...
  if ( (int)GetDeviceObjectPointer(a1 + 208, 0, a3, (unsigned int)Handle, (__int64)v11, (__int64)Object) < 0 )
    return 0LL;
  ObfReferenceObject(Object[0]);
  v5 = IsHIDMouse(v4, (struct _DEVICE_OBJECT *)Object[0]);
