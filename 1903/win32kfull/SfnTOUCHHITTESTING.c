/*
 * XREFs of SfnTOUCHHITTESTING @ 0x1C021D010
 * Callers:
 *     <none>
 * Callees:
        ...
        __int64 a6)
{
  ...
  if ( a1 )
    ...
    v15 = 0LL;
  result = AllocCallbackMessage(88, 1u, 48LL, v56, 1, 0x200uLL);
  v20 = result;
  v45 = result;
  if ( result )
  {
    ...
    *((_DWORD *)v20 + 12) = a2;
    *((_QWORD *)v20 + 7) = a3;
    if ( (int)CaptureCallbackData((struct _CAPTUREBUF *)v20, a4, 0x30u, (void **)v20 + 8) < 0 )
      goto LABEL_26;
    *((_QWORD *)v20 + 9) = a5;
    *((_QWORD *)v20 + 10) = a6;
    ...
    *((_QWORD *)v20 + 2) = 0LL;
    v31 = KeUserModeCallback(115LL, v20, *(unsigned int *)v20, &v46, v44);
