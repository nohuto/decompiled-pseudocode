/*
 * XREFs of ?DT_DrawStr@@YAHPEAUHDC__@@HHPEBGHHIPEAUDRAWTEXTDATA@@H@Z @ 0x1C025AB4C
 * Callers:
        ...
        int a9)
{
  ...
  if ( *((_DWORD *)a8 + 15) )
  {
    ...
    if ( (_DWORD)result )
      return xxxClientLpkDrawTextEx(a1, v16, a3, a4, a5, a6, a7, (__int64)a8, 1, a9);
  }
  else
  {
    if ( a6 )
    {
      v19 = a5;
      (*((void (__fastcall **)(HDC, _QWORD, _QWORD, const unsigned __int16 *))a8 + 6))(a1, v16, a3, a4);
    }
    return (unsigned int)DT_GetExtentMinusPrefixes(a1, a4, a5, a7, v19, a8, a9) - *((_DWORD *)a8 + 14);
  }
  return result;
}
