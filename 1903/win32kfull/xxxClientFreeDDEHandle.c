/*
 * XREFs of xxxClientFreeDDEHandle @ 0x1C021EF8C
 * Callers:
...
__int64 __fastcall xxxClientFreeDDEHandle(__int64 a1, int a2, __int64 a3, __int64 a4)
{
  int v4; // ebx
  __int64 v5; // rdx
  __int64 v6; // r8
  ...
  v4 = KeUserModeCallback(67LL, &v10, 16LL, &v16, &v15);
