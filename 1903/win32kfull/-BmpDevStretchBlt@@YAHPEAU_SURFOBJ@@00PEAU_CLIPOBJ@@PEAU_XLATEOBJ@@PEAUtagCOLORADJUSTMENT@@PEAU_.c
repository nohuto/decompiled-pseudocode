/*
 * XREFs of ?BmpDevStretchBlt@@YAHPEAU_SURFOBJ@@00PEAU_CLIPOBJ@@PEAU_XLATEOBJ@@PEAUtagCOLORADJUSTMENT@@PEAU_POINTL@@PEAU_RECTL@@54K@Z @ 0x1C02946F0
 * Callers:
 *     <none>
 * Callees:
          ...
          do
          {
            ...
            if ( v20 )
            {
              if ( (*(_DWORD *)(v20 + 1824) & 0x8000000) != 0 )
              {
                ...
                {
                  if ( *(_QWORD *)(*(_QWORD *)(v20 + 1792) + 224LL) )
                  {
