/*
 * XREFs of xxxDesktopThread @ 0x1C000DE70
 * Callers:
 *     <none>
 * Callees:
...
LONG __fastcall xxxDesktopThread(PRKEVENT *a1)
{
  ...
  *(_QWORD *)&DestinationString.Length = 0LL;
  ...
  if ( !v4 )
  {
    ...
    qword_1C032C630 = (PRKEVENT)CreateKernelEvent(1LL, 0LL);
  }
  v6 = L"IO_DT";
  if ( v4 )
    v6 = L"NOIO_DT";
  ...
  if ( (int)InitSystemThread(&DestinationString) < 0 || !v4 && !qword_1C032C630 )
  {
    *(_DWORD *)a1 |= 8u;
...
LABEL_70:
  ...
  *(_DWORD *)a1 |= 4u;
  ...
  else
  {
    ...
    *((_DWORD *)v34 + 15) = v36;
    if ( v4 )
      qword_1C032E068 = (__int64)v34;
    else
      qword_1C032C638 = (__int64)v34;
    do
    {
      do
        LOBYTE(v20) = 1;
