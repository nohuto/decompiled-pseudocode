/*
 * XREFs of SetupAAHeader @ 0x1C00381C0
 * Callers:
 *     AAHalftoneBitmap @ 0x1C00371B0 (AAHalftoneBitmap.c)
 * Callees:
 *     _ALIGN_MEM @ 0x1C0038A60 (_ALIGN_MEM.c)
 *     ComputeByteOffset @ 0x1C0038A8C (ComputeByteOffset.c)
 *     ComputeInputColorInfo @ 0x1C0038AE0 (ComputeInputColorInfo.c)
 *     ComputeAABBP @ 0x1C0038C24 (ComputeAABBP.c)
...
LABEL_26:
  *(_QWORD *)(a3 + 384) = v23 + 28;
  ...
  if ( (v22 & 0x200) != 0 )
  {
    if ( BYTE4(v160[0]) == 1 )
    {
      v143 = (__int64 (__fastcall *)(__int128 *))BltDIB_CY;
    }
    else
    {
      if ( BYTE4(v160[0]) <= 1u )
...
LABEL_213:
    ...
    case 1:
LABEL_110:
      v143 = (__int64 (__fastcall *)(__int128 *))v29;
      goto LABEL_51;
    case 2:
      if ( v11 == 1 )
      {
