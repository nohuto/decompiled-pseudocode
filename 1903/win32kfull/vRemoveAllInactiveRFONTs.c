/*
 * XREFs of vRemoveAllInactiveRFONTs @ 0x1C02A1DD0
 * Callers:
...
void __fastcall vRemoveAllInactiveRFONTs(__int64 a1)
{
  ...
  _QWORD v16[130]; // [rsp+78h] [rbp-90h] BYREF
  ...
  if ( (_DWORD)v2 )
  {
    v8 = (struct _FONTOBJ **)v16;
    v9 = v16;
    do
    {
      v10 = *v8;
      memset(v15, 0, 0x20uLL);
      PushThreadGuardedObject(v15, v9, vRestartRemoveAllInactiveRFONTs);
