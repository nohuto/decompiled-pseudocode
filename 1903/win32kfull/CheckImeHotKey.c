/*
 * XREFs of CheckImeHotKey @ 0x1C00B1A10
 * Callers:
...
struct _tagIMEHOTKEYOBJ *__fastcall CheckImeHotKey(__int64 a1, unsigned int a2, int a3)
{
  ...
  v6 = *(_BYTE *)(a1 + 276);
  v7 = ((v6 & 0x10) != 0 ? 0x8002 : 0) | ((v6 & 0x40) != 0 ? 0x4002 : 0) | ((*(_BYTE *)(a1 + 277) & 1) != 0 ? 0x8001 : 0) | ((*(_BYTE *)(a1 + 277) & 4) != 0 ? 0x4001 : 0);
  ...
  if ( v4 )
  {
    ...
    else if ( dword_1C032C7F4 != (*((_DWORD *)result + 4) & 7) )
    {
      return 0LL;
    }
    dword_1C032C7F4 = 0;
