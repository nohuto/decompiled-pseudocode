/*
 * XREFs of ?DT_InitDrawTextInfo@@YAHPEAUHDC__@@PEAUtagRECT@@IPEAUDRAWTEXTDATA@@PEAUtagDRAWTEXTPARAMS@@@Z @ 0x1C025AE34
 * Callers:
  ...
  if ( (_DWORD)result )
  {
    ...
    *((_DWORD *)a4 + 4) = 8 * v14;
    if ( gptiCurrent == gptiRit )
      ...
      v19 = *(_DWORD *)(PsGetCurrentProcessWin32Process(gptiRit, v13) + 752) & 4;
    *((_DWORD *)a4 + 15) = v19;
    if ( !v19 )
