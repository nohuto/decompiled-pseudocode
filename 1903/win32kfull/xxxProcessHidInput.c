/*
 * XREFs of xxxProcessHidInput @ 0x1C01D8BF0
 * Callers:
 ...
 *     ?HidIsRequestedByThisProcess@@YAPEAUtagPROCESS_HID_REQUEST@@PEAUDEVICEINFO@@PEAUtagPROCESS_HID_TABLE@@@Z @ 0x1C01D7A04 (-HidIsRequestedByThisProcess@@YAPEAUtagPROCESS_HID_REQUEST@@PEAUDEVICEINFO@@PEAUtagPROCESS_HID_T.c)
...
__int64 __fastcall xxxProcessHidInput(struct DEVICEINFO *a1)
{
  ...
  if ( gpqForeground )
  {
    ...
    v8 = HidIsRequestedByThisProcess(a1, *(struct tagPROCESS_HID_TABLE **)(v1 + 824));
    if ( v8 )
    {
        ...
        || (v11 = *(struct tagQ **)(*(_QWORD *)(v12 + 16) + 424LL), *(char *)(*(_QWORD *)(v12 + 40) + 20LL) >= 0) )
      {
        if ( (*((_DWORD *)a1 + 46) & 0x20) == 0
          ...
          || (!(unsigned __int8)IsInputThread(v13, v9, v10)
            ? (v14 = *(_QWORD *)(gptiCurrent + 416LL) + 872LL)
            : (v14 = *((_QWORD *)a1 + 60) + 896LL),
              v6 = 1LL,
              (unsigned __int8)CheckAccess(v14, (char *)v11 + 436)) )
        {
          v6 = 1LL;
...
LABEL_37:
    ...
    if ( gpqForeground )
    {
      if ( !(unsigned __int8)CheckAccess(*(_QWORD *)(v18 + 424) + 436LL, gpqForeground + 436LL) )
      {
        v25 = *(_QWORD *)(v17 + 16);
        if ( *(int *)(*(_QWORD *)(v25 + 416) + 12LL) >= 0 )
        {
          EtwTraceUIPIInputError(v25, 0LL, gpqForeground, *(_QWORD *)(gpqForeground + 436LL), 5);
          goto LABEL_49;
        }
      }
    }
    if ( (*((_DWORD *)a1 + 46) & 0x2000) == 0
      ...
      || (!(unsigned __int8)IsInputThread(v26, v24, v18)
        ? (v27 = *(_QWORD *)(gptiCurrent + 416LL) + 872LL)
        : (v27 = *((_QWORD *)a1 + 60) + 896LL),
          (unsigned __int8)CheckAccess(v27, *(_QWORD *)(*(_QWORD *)(v17 + 16) + 424LL) + 436LL)) )
    {
LABEL_47:
