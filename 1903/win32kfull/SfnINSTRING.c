/*
 * XREFs of SfnINSTRING @ 0x1C01288C0
 * Callers:
...
LABEL_8:
  if ( v19 )
  {
    result = AllocCallbackMessage(88, v19, (unsigned int)v18, v64, 1, 0x200uLL);
    v9 = result;
    v51 = result;
    if ( !result )
      return result;
...
LABEL_15:
  ...
  *((_QWORD *)v9 + 2) = 0LL;
  v31 = KeUserModeCallback(26LL, v9, *(unsigned int *)v9, &v55, v53);
