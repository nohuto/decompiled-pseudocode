/*
 * XREFs of SetGestureConfigSettings @ 0x1C0136E40
 * Callers:
 ...
 *     ?SortGestureConfigArray@@YAHPEAUtagGESTURECONFIG@@H@Z @ 0x1C0136FB0 (-SortGestureConfigArray@@YAHPEAUtagGESTURECONFIG@@H@Z.c)
...
__int64 __fastcall SetGestureConfigSettings(struct tagWND *a1, __int64 a2, unsigned int a3, __int64 a4)
{
  ...
  if ( !GetGCData(a1) )
  {
    ...
    *v12 = 0;
    v11[2] = 0LL;
    VWPLAddBase((struct tagVWPL **)(*(_QWORD *)(*((_QWORD *)a1 + 2) + 416LL) + 864LL), (__int64)v11, a1, 5u);
  }
  GCData = GetGCData(a1);
  if ( *(_DWORD *)a4 )
