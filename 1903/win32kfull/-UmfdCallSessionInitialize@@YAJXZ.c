/*
 * XREFs of ?UmfdCallSessionInitialize@@YAJXZ @ 0x1C01044E4
 * Callers:
 *     UmfdSessionInitialize @ 0x1C0104400 (UmfdSessionInitialize.c)
 * Callees:
 *     ?Create@CEventPool@@SAQEAV1@XZ @ 0x1C01045F8 (-Create@CEventPool@@SAQEAV1@XZ.c)
 *     ?Create@CManualResetEvent@@SAQEAV1@XZ @ 0x1C01046A8 (-Create@CManualResetEvent@@SAQEAV1@XZ.c)
 *     ?Destroy@CMultipleConsumerWorkQueue@@SAXQEAV1@@Z @ 0x1C013A104 (-Destroy@CMultipleConsumerWorkQueue@@SAXQEAV1@@Z.c)
...
__int64 UmfdCallSessionInitialize(void)
{
  ...
  while ( v0 >= 0 )
  {
    v3 = EngAllocMem(0, 0x10u, 0x676D6466u);
    if ( !v3 )
      goto LABEL_15;
