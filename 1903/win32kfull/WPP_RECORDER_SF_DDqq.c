/*
 * XREFs of WPP_RECORDER_SF_DDqq @ 0x1C01EBC70
 * Callers:
...
__int64 WPP_RECORDER_SF_DDqq(__int64 a1, __int64 a2, __int64 a3, __int64 a4, int a5, ...)
{
  ...
  if ( (HIDWORD(WPP_GLOBAL_Control->Timer) & 0x10000) != 0 && BYTE1(WPP_GLOBAL_Control->Timer) >= 4u )
    ((void (__fastcall *)(struct _DEVICE_OBJECT *, __int64, void *, __int64, __int64 *, __int64, __int64 *, __int64, __int64 *, __int64, char *, __int64, _QWORD))pfnWppTraceMessage)(
      ...
      43LL,
      &WPP_82730dd3e19a3c976911a4b85ae33baa_Traceguids,
      10LL,
      (__int64 *)va,
      4LL,
      (__int64 *)va1,
