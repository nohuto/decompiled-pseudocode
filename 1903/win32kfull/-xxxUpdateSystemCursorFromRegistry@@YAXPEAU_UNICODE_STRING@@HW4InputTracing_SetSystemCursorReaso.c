/*
 * XREFs of ?xxxUpdateSystemCursorFromRegistry@@YAXPEAU_UNICODE_STRING@@HW4InputTracing_SetSystemCursorReason@@@Z @ 0x1C00B6714
 * Callers:
...
unsigned __int8 *__fastcall xxxUpdateSystemCursorFromRegistry(__int64 a1, unsigned int a2, unsigned int a3)
{
  ...
  *(_QWORD *)&DestinationString.Length = 0LL;
  ...
  v5 = 576;
  FastGetProfileStringFromIDW(a1, 1LL, WORD1(gasyscur[69 * (int)a2]), &word_1C02DAB68, SourceString, 260, 0);
  if ( SourceString[0] )
  {
    v6 = 4LL;
    v5 = 592;
