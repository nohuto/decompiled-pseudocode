 ...
 * Callees:
 *     I_PlaySoundkPostMessage @ 0x1C01091C8 (I_PlaySoundkPostMessage.c)
 *     PlaySndClient_midl_user_allocate @ 0x1C0109220 (PlaySndClient_midl_user_allocate.c)
 *     ?PlatformFree@NSInstrumentation@@YAXPEAX@Z @ 0x1C0114810 (-PlatformFree@NSInstrumentation@@YAXPEAX@Z.c)
 */
