/*
 * XREFs of ?vInitStrDDA@@YAXPEAU_STRDDA@@PEAU_RECTL@@11@Z @ 0x1C00FD2A4
 * Callers:
...
void __fastcall vInitStrDDA(struct _STRDDA *a1, struct _RECTL *a2, struct _RECTL *a3, struct _RECTL *a4)
{
  ...
  {
    top = a3->top;
    v7 = (struct _RECTL *)&v50;
    LODWORD(v48) = a2->left - left;
    HIDWORD(v48) = a2->top - top;
    LODWORD(v49) = a2->right - left;
    HIDWORD(v49) = a2->bottom - top;
    LODWORD(v51) = a3->right - left;
    HIDWORD(v51) = a3->bottom - top;
  }
  *((_QWORD *)a1 + 3) = (char *)a1 + 4 * v7->right + 32;
  ...
  if ( *v13 > 0 )
  {
    ...
    {
      v17 = v15;
      v39 = v15 + LODWORD(v46[0]);
      v15 += LODWORD(v46[0]) + 1;
      v40 = v16 + HIDWORD(v46[0]);
      v38 = v40;
      if ( v40 < right )
        v15 = v39;
      v16 = v40 - right;
  ...
  *((_DWORD *)a1 + 1) = v25 + v32;
  while ( (signed int)v33 < *(_DWORD *)(v27 + 12) )
  {
    v34 = v30 - v32;
    ++v33;
    v32 = v30;
