/*
 * XREFs of ?CreateUsermodeParameters@QueryFontDataRequest@@UEAAJPEAVUmfdTls@@PEAPEAX@Z @ 0x1C007BE30
 * Callers:
 *     <none>
 * Callees:
        ...
        void **a3)
{
  ...
  if ( !UmfdTls::TryComputeAlignedFieldSizes(
    ...
    return 3221225495LL;
  v12 = v22[0];
  UmfdTls::CommitUMBuffer<_QUERYFONTDATAPARAMETERS>((_DWORD)a2, (unsigned int)v22, v24, v23, v22[0], v21);
  v13 = *(_QWORD **)v22;
  if ( !*(_QWORD *)v22 )
    return 3221225495LL;
  v14 = v23;
