/*
 * XREFs of ?OnInputReport@InteractiveControlManager@@QEAAJPEAURawInputManagerDeviceObject@@PEAXK@Z @ 0x1C024ED80
 * Callers:
        ...
        unsigned int a4)
{
  ...
  if ( Device >= 0 )
  {
    ...
    if ( Device < 0 && dword_1C0321308 > 2u )
    {
      v13 = 0;
      v16 = 0;
      v11 = "Function failed.";
  ...
  else if ( dword_1C0321308 > 2u )
  {
    ...
    v12 = 17;
    LODWORD(v9[0]) = Device;
    TlgWrite((TraceLoggingHProvider)&dword_1C0321308, &unk_1C02E8E2D, 0LL, 0LL, v6 + 4, &pData);
  }
