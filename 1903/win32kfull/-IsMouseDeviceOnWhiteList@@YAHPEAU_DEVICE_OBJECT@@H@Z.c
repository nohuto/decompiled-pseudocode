/*
 * XREFs of ?IsMouseDeviceOnWhiteList@@YAHPEAU_DEVICE_OBJECT@@H@Z @ 0x1C020F5FC
 * Callers:
 *     IsLegacyTouchPadDevice @ 0x1C012A240 (IsLegacyTouchPadDevice.c)
 * Callees:
 *     ?IsDeviceOnRegistryList@@YAHU_UNICODE_STRING@@0H@Z @ 0x1C012A86C (-IsDeviceOnRegistryList@@YAHU_UNICODE_STRING@@0H@Z.c)
...
__int64 __fastcall IsMouseDeviceOnWhiteList(struct _DEVICE_OBJECT *a1, int a2)
{
  ...
  *(_QWORD *)&Destination.Length = 13107200LL;
