/*
 * XREFs of ?_TTWindowPenalty@@YAIPEAUtagWND@@PEAUtagPNTRWINDOWHITTTESTARGS@@I@Z @ 0x1C02046CC
 * Callers:
 ...
 *     TouchTargetingBigTargetWindow @ 0x1C025BC84 (TouchTargetingBigTargetWindow.c)
 *     TouchTargetingDownrank @ 0x1C025C180 (TouchTargetingDownrank.c)
 */
