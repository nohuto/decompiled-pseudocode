/*
 * XREFs of ?bTriangleMesh@@YAHPEAVSURFACE@@PEAU_XLATEOBJ@@PEAU_TRIVERTEX@@KPEAU_GRADIENT_TRIANGLE@@KKPEAU_RECTL@@4PEAU_POINTL@@@Z @ 0x1C01449EC
 * Callers:
 ...
 *     ?bIsTriangleInBounds@@YAHPEAU_TRIVERTEX@@00PEAU_TRIANGLEDATA@@@Z @ 0x1C0145508 (-bIsTriangleInBounds@@YAHPEAU_TRIVERTEX@@00PEAU_TRIANGLEDATA@@@Z.c)
        ...
        struct _POINTL *a10)
{
  ...
  unsigned __int8 *v43; // [rsp+48h] [rbp-38h]
  void (*v44)(struct SURFACE *, struct _TRIANGLEDATA *); // [rsp+50h] [rbp-30h] BYREF
    ...
    if ( (_DWORD)Size )
    {
      ...
      do
      {
        ...
        if ( (unsigned int)bIsTriangleInBounds(v23, v24, v25, (struct _TRIANGLEDATA *)v17) )
          v15 = bCalculateAndDrawTriangle(a1, v23, v24, v25, (struct _TRIANGLEDATA *)v17, v44);
        v11 = a3;
        p_Vertex3 += 3;
        --v21;
      }
    ...
    if ( (unsigned int)Size < 0xFFFFFFC6 )
    {
      ...
      if ( v29 <= 0xFFFFFFFF )
      {
        ...
        if ( v30 )
        {
          ...
          v32 = v12 + 28;
          v43 = (unsigned __int8 *)&v30[v28] + 12 * (_QWORD)a8;
...
LABEL_34:
            ...
            if ( !(unsigned int)bIsTriangleInBounds(v47, v46, v45, (struct _TRIANGLEDATA *)v17) )
              goto LABEL_28;
            if ( !(unsigned int)bSplitTriangle(v31, (unsigned int *)&a8, v42, &v39, v43) )
              break;
...
LABEL_33:
          ...
          v37 = bCalculateAndDrawTriangle(a1, v47, v46, v45, (struct _TRIANGLEDATA *)v17, v44);
          LODWORD(v12) = (_DWORD)a8;
          v15 = v37;
          LODWORD(v27) = v39;
          do
