/*
 * XREFs of ?Disconnect@CUserPlaySound@@AEAAJXZ @ 0x1C01393F4
 * Callers:
 *     NtUserDoSoundConnect @ 0x1C013FFF0 (NtUserDoSoundConnect.c)
 *     NtUserDoSoundDisconnect @ 0x1C0141D10 (NtUserDoSoundDisconnect.c)
 * Callees:
