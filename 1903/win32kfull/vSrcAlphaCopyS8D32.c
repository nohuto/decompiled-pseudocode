/*
 * XREFs of vSrcAlphaCopyS8D32 @ 0x1C00F6240
 * Callers:
 *     <none>
 * Callees:
 *     <none>
    ...
    if ( v12 )
    {
      do
      {
        ...
        if ( *result )
        {
          ...
          {
            _mm_lfence();
            *v13 = alAlpha_255[*((unsigned __int8 *)off_1C03210F0 + 4 * v14 + 2)] | ((alAlpha_255[*((unsigned __int8 *)off_1C03210F0
                                                                                                  + 4 * v14
                                                                                                  + 1)] | (alAlpha_255[*((unsigned __int8 *)off_1C03210F0 + 4 * v14)] << 8)) << 8);
          }
        }
        ++result;
        ++v13;
