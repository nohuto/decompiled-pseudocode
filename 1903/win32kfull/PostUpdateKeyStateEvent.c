/*
 * XREFs of PostUpdateKeyStateEvent @ 0x1C0082ADC
 * Callers:
 ...
 *     EditionPostUpdateKeyStateEvent @ 0x1C0082A30 (EditionPostUpdateKeyStateEvent.c)
 ...
 *     ??0?$CLockDomainSharedLeaf@VDLT_ASYNCKEYSTATE@@@@QEAA@XZ @ 0x1C0082C70 (--0-$CLockDomainSharedLeaf@VDLT_ASYNCKEYSTATE@@@@QEAA@XZ.c)
        ...
        if ( !v8 || (*(_BYTE *)(*(_QWORD *)(v8 + 440) + 6LL) & 4) == 0 )
        {
          while ( 1 )
          {
            ...
            if ( WPP_RECORDER_INITIALIZED != (_UNKNOWN *)&WPP_RECORDER_INITIALIZED )
            {
              v12 = 20;
LABEL_22:
              WPP_RECORDER_SF_q(v9, a2, 0xFu, v12, (__int64)&WPP_db4c9b3ed78a39e6374fde78dedf6449_Traceguids, a1);
            }
LABEL_13:
            v5 = (__int64 *)*v5;
            if ( !v5 )
