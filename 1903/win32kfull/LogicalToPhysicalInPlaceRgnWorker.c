/*
 * XREFs of LogicalToPhysicalInPlaceRgnWorker @ 0x1C011E0B0
 * Callers:
 ...
 *     ?TransformRgn@@YAPEAUHRGN__@@PEAU1@PEAUtagXFORM@@@Z @ 0x1C01E5BDC (-TransformRgn@@YAPEAUHRGN__@@PEAU1@PEAUtagXFORM@@@Z.c)
 */
