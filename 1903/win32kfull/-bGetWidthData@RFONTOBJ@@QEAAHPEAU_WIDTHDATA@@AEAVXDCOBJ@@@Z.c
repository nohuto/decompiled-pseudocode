/*
 * XREFs of ?bGetWidthData@RFONTOBJ@@QEAAHPEAU_WIDTHDATA@@AEAVXDCOBJ@@@Z @ 0x1C0053DB0
 * Callers:
...
__int64 __fastcall RFONTOBJ::bGetWidthData(RFONTOBJ *this, struct _WIDTHDATA *a2, struct XDCOBJ *a3)
{
  ...
  if ( v14 )
  {
    if ( (*(_DWORD *)(v12 + 48) & 0x10000000) != 0 )
    {
      ...
      v23 = 12288;
      while ( (unsigned int)RFONTOBJ::bGetGlyphMetrics(this, (struct RFONTOBJ *)1, &v22, &v23, a3, 0LL)
           && v22.hg != *(_DWORD *)(*(_QWORD *)this + 460LL) )
      {
        v7 = (unsigned int)(v7 + 1);
        v23 = word_1C02F1128[v7];
        if ( !v23 )
        {
          LODWORD(v18) = 0;
          v19 = WORD2(v22.pgdf[1].ppo);
          v23 = 12450;
          while ( (unsigned int)RFONTOBJ::bGetGlyphMetrics(this, (struct RFONTOBJ *)1, &v22, &v23, 0LL, 0LL) )
          {
