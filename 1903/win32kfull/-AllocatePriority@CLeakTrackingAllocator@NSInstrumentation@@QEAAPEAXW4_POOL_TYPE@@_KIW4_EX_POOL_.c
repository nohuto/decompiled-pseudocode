/*
 * XREFs of ?AllocatePriority@CLeakTrackingAllocator@NSInstrumentation@@QEAAPEAXW4_POOL_TYPE@@_KIW4_EX_POOL_PRIORITY@@@Z @ 0x1C02D2ED0
 * Callers:
 *     Win32AllocPoolWithPriorityImpl @ 0x1C020EB50 (Win32AllocPoolWithPriorityImpl.c)
