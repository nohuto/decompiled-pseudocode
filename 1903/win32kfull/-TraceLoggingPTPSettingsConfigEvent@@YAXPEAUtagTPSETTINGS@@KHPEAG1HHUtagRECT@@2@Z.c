/*
 * XREFs of ?TraceLoggingPTPSettingsConfigEvent@@YAXPEAUtagTPSETTINGS@@KHPEAG1HHUtagRECT@@2@Z @ 0x1C01CE774
 * Callers:
        ...
        struct tagRECT *a9)
{
  ...
  if ( hProvider > 5u )
  {
    if ( TlgKeywordOn((TraceLoggingHProvider)&hProvider, 0x800000000000uLL) )
    {
      ...
      v53 = 4LL;
      v55 = 4LL;
      TlgWrite((TraceLoggingHProvider)&hProvider, &unk_1C02E6624, 0LL, 0LL, 0x14u, &pData);
    }
  }
}
