/*
 * XREFs of BRUSHOBJ_pvAllocRbrush @ 0x1C026AEF0
 * Callers:
 *     VerifierBRUSHOBJ_pvAllocRbrush @ 0x1C02984E0 (VerifierBRUSHOBJ_pvAllocRbrush.c)
 *     ?MulRealizeBrush@@YAHPEAU_BRUSHOBJ@@PEAU_SURFOBJ@@11PEAU_XLATEOBJ@@K@Z @ 0x1C029CED0 (-MulRealizeBrush@@YAHPEAU_BRUSHOBJ@@PEAU_SURFOBJ@@11PEAU_XLATEOBJ@@K@Z.c)
 * Callees:
