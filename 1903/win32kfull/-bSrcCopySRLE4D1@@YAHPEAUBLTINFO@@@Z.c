/*
 * XREFs of ?bSrcCopySRLE4D1@@YAHPEAUBLTINFO@@@Z @ 0x1C02C5CB0
 * Callers:
 *     <none>
 * Callees:
  ...
  for ( i = v21 <= v11; ; i = v21 <= v66 )
  {
    ...
    if ( v23 )
    {
      ...
      else
      {
        ...
        v57 = v51;
        v50 = byte_1C02F1BC8[2 * v51 + 12 + v58];
        LOBYTE(v51) = v9 & 7;
        v61 = v50;
        v77 = v9 & 7;
...
LABEL_73:
    ...
    else
    {
      if ( v9 >= v60 )
      {
        v30 = byte_1C02F1BC8[(unsigned __int8)(7 - (v9 & 7))];
      }
      else
      {
        v29 = v60 - v9;
        ...
        v25 = (unsigned int)(v60 >> 3);
        v9 = v60;
        v30 = byte_1C02F1BC8[(unsigned __int8)(7 - (v60 & 7))];
        if ( (v29 & 1) != 0 )
        {
          v31 = v15 | v30;
          v30 >>= 1;
