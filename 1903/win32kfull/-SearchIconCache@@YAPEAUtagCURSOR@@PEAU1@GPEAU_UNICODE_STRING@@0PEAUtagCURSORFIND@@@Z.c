/*
 * XREFs of ?SearchIconCache@@YAPEAUtagCURSOR@@PEAU1@GPEAU_UNICODE_STRING@@0PEAUtagCURSORFIND@@@Z @ 0x1C00319D0
 * Callers:
 ...
 * Callees:
 *     ?ResStrCmp@@YAHPEAU_UNICODE_STRING@@0@Z @ 0x1C0031AAC (-ResStrCmp@@YAHPEAU_UNICODE_STRING@@0@Z.c)
 */
