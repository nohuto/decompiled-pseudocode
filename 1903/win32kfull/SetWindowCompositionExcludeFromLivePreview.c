/*
 * XREFs of SetWindowCompositionExcludeFromLivePreview @ 0x1C0133E28
 * Callers:
...
__int64 __fastcall SetWindowCompositionExcludeFromLivePreview(__int64 *a1, __int128 *a2)
{
  ...
  {
    if ( -__CFSHR__(v12[0], 5) == v5 )
      return 0;
    v12[0] = v12[0] & 0xFFFFFFEF | (16 * v5);
    ...
    else
    {
      ...
      return (unsigned int)DwmAsyncSetCompositionAttribute(v10, *a1, 13, a2);
    }
  }
  return v4;
}
