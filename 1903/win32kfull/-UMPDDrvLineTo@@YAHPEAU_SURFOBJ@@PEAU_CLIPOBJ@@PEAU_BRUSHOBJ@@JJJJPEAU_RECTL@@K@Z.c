/*
 * XREFs of ?UMPDDrvLineTo@@YAHPEAU_SURFOBJ@@PEAU_CLIPOBJ@@PEAU_BRUSHOBJ@@JJJJPEAU_RECTL@@K@Z @ 0x1C02A3DE0
 * Callers:
 *     <none>
 * Callees:
        ...
        unsigned int a9)
{
  ...
  if ( v25 )
  {
          ...
          (v19 = v15) != 0) )
    {
      ...
      v27[4] = a2;
      v27[5] = a3;
      if ( !(unsigned int)UMPDOBJ::pso(v14, (UMPDOBJ *)((char *)v14 + 64), (struct _SURFOBJ **)&v27[3], v11)
        ...
        || (LODWORD(Size) = 4, (unsigned int)UMPDOBJ::Thunk(v14, v27, 80LL, &v19, Size) == -1)
        || (v16 = 1, !v19) )
      {
        v16 = 0;
      }
