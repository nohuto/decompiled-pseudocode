/*
 * XREFs of GetGestureConfigSettings @ 0x1C0213E90
 * Callers:
 *     NtUserGetGestureConfig @ 0x1C022C530 (NtUserGetGestureConfig.c)
 * Callees:
 *     UserSetLastError @ 0x1C008B3AC (UserSetLastError.c)
 *     _IsTopLevelWindow @ 0x1C00C75CC (_IsTopLevelWindow.c)
 *     ?GetGCData@@YAPEAUtagVWPLGESTUREDATA@@PEAUtagWND@@@Z @ 0x1C0136F78 (-GetGCData@@YAPEAUtagVWPLGESTUREDATA@@PEAUtagWND@@@Z.c)
 *     ?IsBitSet@@YAHPEAEI@Z @ 0x1C0137060 (-IsBitSet@@YAHPEAEI@Z.c)
 *     ?GetWindowGCList@@YAPEAPEAXPEAUtagWND@@@Z @ 0x1C013708C (-GetWindowGCList@@YAPEAPEAXPEAUtagWND@@@Z.c)
 *     ?FindGID@@YAHPEAPEAUtagGESTURECONFIGLIST@@I0@Z @ 0x1C0213CB4 (-FindGID@@YAHPEAPEAUtagGESTURECONFIGLIST@@I0@Z.c)
 */
...
LABEL_16:
          ...
          else
          {
            ...
            *(_DWORD *)((char *)v13 + v18 - v6 - 8) = *((_DWORD *)GCData + 3);
          }
LABEL_18:
          v13 += 3;
          if ( !--v14 )
    ...
    if ( !v7 || (unsigned int)IsTopLevelWindow((__int64)v9) || !v9 )
      return 1LL;
    while ( 1 )
    {
...
LABEL_37:
      ...
      else
      {
        if ( !*((_DWORD *)v26 + 2) )
        {
          ...
          v37 = ~*(v30 - 1) & dword_1C02E0930[v31];
          goto LABEL_37;
        }
        *(v30 - 1) = ~*v30 & dword_1C02E0930[v31];
      }
LABEL_39:
      ++v29;
      v30 += 3;
...
LABEL_40:
  ...
  UserSetLastError(87LL, v8, a3, (__int64)a4);
  return 0LL;
}
