/*
 * XREFs of InitializeClientPfnArrays @ 0x1C013BBAC
 * Callers:
 *     NtUserInitializeClientPfnArrays @ 0x1C013BAA0 (NtUserInitializeClientPfnArrays.c)
 * Callees:
 *     <none>
 */
...
__int64 __fastcall InitializeClientPfnArrays(__int128 *a1, _OWORD *a2, __int64 a3, __int64 a4)
{
  ...
  if ( PsGetCurrentProcess(a1, a2, a3, a4) == gpepCSRSS )
  {
    ...
    *(_QWORD *)&WPP_MAIN_CB.DeviceLock.Header.Lock = *(_QWORD *)(gpsi + 616LL);
    ...
    qword_1C032B680 = *(_QWORD *)(gpsi + 664LL);
    qword_1C032B698 = *(_QWORD *)(gpsi + 592LL);
