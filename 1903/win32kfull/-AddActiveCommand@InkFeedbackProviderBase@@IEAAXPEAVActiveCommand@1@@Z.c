/*
 * XREFs of ?AddActiveCommand@InkFeedbackProviderBase@@IEAAXPEAVActiveCommand@1@@Z @ 0x1C024F864
 * Callers:
        ...
        struct InkFeedbackProviderBase::ActiveCommand *a2)
{
  ...
  *((_QWORD *)v3 + 1) = a2;
  if ( dword_1C0321298 > 4u )
  {
    ...
    v24 = v9;
    v25 = 4LL;
    TlgWrite((TraceLoggingHProvider)&dword_1C0321298, &unk_1C02E9417, 0LL, 0LL, 9u, &pData);
  }
}
