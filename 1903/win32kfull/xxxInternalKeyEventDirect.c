/*
 * XREFs of xxxInternalKeyEventDirect @ 0x1C001D6E4
 * Callers:
...
__int64 __fastcall xxxInternalKeyEventDirect(unsigned __int8 a1, __int16 a2, char a3, int a4, __int64 a5)
{
     ...
     || RtlAreAllAccessesGranted(*(_DWORD *)(gptiCurrent + 888LL), 0x20u)) )
  {
    ...
    if ( dword_1C03222C0 > 4u && TlgKeywordOn((TraceLoggingHProvider)&dword_1C03222C0, 0x4000uLL) )
    {
      TlgCreateSz(&pDesc, "SendInput");
      TlgWrite((TraceLoggingHProvider)&dword_1C03222C0, &unk_1C02E5654, 0LL, 0LL, 3u, &pData);
    }
    LOBYTE(v20[0]) = a2;
    v20[1] = 0LL;
    if ( (a3 & 8) != 0 )
