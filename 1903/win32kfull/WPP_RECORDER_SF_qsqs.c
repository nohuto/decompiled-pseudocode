/*
 * XREFs of WPP_RECORDER_SF_qsqs @ 0x1C001946C
 * Callers:
        ...
        __int64 a9)
{
  ...
  if ( (HIDWORD(WPP_GLOBAL_Control->Timer) & 2) != 0 && BYTE1(WPP_GLOBAL_Control->Timer) >= 4u )
  {
    ...
    pfnWppTraceMessage(
      ...
      43LL,
      &WPP_828df51e9e903732b0178dfabaca8ced_Traceguids,
      10LL,
      &a6,
      8LL,
      v19,
  ...
  if ( !v12 )
    v12 = "NULL";
  LOWORD(v20) = 10;
  return WppAutoLogTrace(v9, 4LL, 2LL, &WPP_828df51e9e903732b0178dfabaca8ced_Traceguids, v20, &a6, 8LL, v12, v14);
}
