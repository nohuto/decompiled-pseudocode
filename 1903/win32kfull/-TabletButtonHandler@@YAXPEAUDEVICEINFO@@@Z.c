/*
 * XREFs of ?TabletButtonHandler@@YAXPEAUDEVICEINFO@@@Z @ 0x1C01DBBC0
 * Callers:
 *     <none>
 * Callees:
    ...
    if ( v5 )
    {
      Usages = HidP_GetUsages(
                 ...
                 *(PCHAR *)(*((_QWORD *)a1 + 58) + 24LL),
                 ReportLength);
      if ( dword_1C032597C != 10 )
      {
        if ( Usages >= 0 && (v12 = 0LL, UsageLength[0]) )
        {
          while ( v5[v12] - 1 != dword_1C032597C )
          {
