/*
 * XREFs of zzzUpdateCursorImage @ 0x1C00ABDB0
 * Callers:
...
LABEL_31:
      ...
      InputTraceLogging::Cursor::SetCursorImage((__int64)i, v0, CurrentCursorSize, v1, v15, BufferChainingDpc);
      goto LABEL_31;
    }
