/*
 * XREFs of ?_StoreGestureConfig@@YAHPEAUtagWND@@IPEAUtagGESTURECONFIG@@@Z @ 0x1C0136CE0
 * Callers:
 *     SetGestureConfigSettings @ 0x1C0136E40 (SetGestureConfigSettings.c)
 * Callees:
 *     UserSetLastError @ 0x1C008B3AC (UserSetLastError.c)
 *     ?SetBitMask@@YAXPEAUtagWND@@IH@Z @ 0x1C0136AC4 (-SetBitMask@@YAXPEAUtagWND@@IH@Z.c)
 ...
 *     ?GCRemoveHashElement@@YAXPEAPEAUtagGESTURECONFIGLIST@@I@Z @ 0x1C0213CFC (-GCRemoveHashElement@@YAXPEAPEAUtagGESTURECONFIGLIST@@I@Z.c)
 */
...
LABEL_24:
  ...
  for ( i = (int *)((char *)a3 + 4); ; i += 3 )
  {
    ...
    if ( (unsigned int)(v9 - 1) > 6 )
      break;
    v7 = (unsigned int)~dword_1C02E0930[v9];
    ...
    if ( v15 || v14 || *((_DWORD *)GCData + 2) || *((_DWORD *)GCData + 3) )
    {
      ...
      {
        if ( (unsigned int)FindGID(WindowGCList, v16, &v24) )
        {
          v22 = v24;
          *((_DWORD *)v24 + 4) = v14;
          *((_DWORD *)v22 + 3) = *i;
