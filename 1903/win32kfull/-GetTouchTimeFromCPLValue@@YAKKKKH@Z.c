/*
 * XREFs of ?GetTouchTimeFromCPLValue@@YAKKKKH@Z @ 0x1C01F8A34
 * Callers:
 ...
 *     GetTouchHoldTime @ 0x1C01F9030 (GetTouchHoldTime.c)
 * Callees:
...
__int64 __fastcall GetTouchTimeFromCPLValue(unsigned int a1, unsigned int a2, unsigned int a3, int a4)
{
  ...
  if ( !gTouchMonitor && !(unsigned int)LoadPointerDeviceTouchSettings() )
    return a1;
  v8 = *((_DWORD *)off_1C0321058 + 4 * v5 + 3);
  if ( v8 == -1 )
    v8 = *((_DWORD *)off_1C0321058 + 4 * v5 + 2);
  if ( v8 > 0x64 || v8 == 50 )
    return a1;
  v9 = 100 - v8;
  if ( !a4 )
