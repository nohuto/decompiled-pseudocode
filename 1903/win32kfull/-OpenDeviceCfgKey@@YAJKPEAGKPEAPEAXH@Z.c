/*
 * XREFs of ?OpenDeviceCfgKey@@YAJKPEAGKPEAPEAXH@Z @ 0x1C00B9BAC
 * Callers:
 *     ?GetFlickMap@@YAHPEAUtagFLICK_MAP@@@Z @ 0x1C00B982C (-GetFlickMap@@YAHPEAUtagFLICK_MAP@@@Z.c)
 *     EditionGetPointerDeviceConfigurationKey @ 0x1C00B9AF0 (EditionGetPointerDeviceConfigurationKey.c)
 ...
 *     ?IsTouchpadQuery@@YAHKPEAG@Z @ 0x1C00BA15C (-IsTouchpadQuery@@YAHKPEAG@Z.c)
