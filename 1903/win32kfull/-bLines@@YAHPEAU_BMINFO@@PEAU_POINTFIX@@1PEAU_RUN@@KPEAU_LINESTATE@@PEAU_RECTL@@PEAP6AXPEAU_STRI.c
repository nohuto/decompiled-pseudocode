/*
 * XREFs of ?bLines@@YAHPEAU_BMINFO@@PEAU_POINTFIX@@1PEAU_RUN@@KPEAU_LINESTATE@@PEAU_RECTL@@PEAP6AXPEAU_STRIP@@03@ZKPEAKJPEAU_W32KCDD_ENG_CALLBACKS@@@Z @ 0x1C014C6E8
 * Callers:
        ...
        struct _W32KCDD_ENG_CALLBACKS *a12)
{
  ...
  struct _RUN *v90; // [rsp+78h] [rbp-290h]
  ...
  v91 = a3;
  v13 = a2;
  if ( a1 <= (struct _BMINFO *)&off_1C03215E0
