/*
 * XREFs of ?RescaleNonClientMetrics@@YAXPEAUtagNONCLIENTMETRICSW@@@Z @ 0x1C01D9204
 * Callers:
...
void __fastcall RescaleNonClientMetrics(struct tagNONCLIENTMETRICSW *a1, __int64 a2)
{
  ...
  {
    v5 = v3;
    *((_DWORD *)a1 + 4) = EngMulDiv(*((_DWORD *)a1 + 4), v4, v3);
