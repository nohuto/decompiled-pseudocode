/*
 * XREFs of ?UMPDDrvPaint@@YAHPEAU_SURFOBJ@@PEAU_CLIPOBJ@@PEAU_BRUSHOBJ@@PEAU_POINTL@@K@Z @ 0x1C02A4010
 * Callers:
 *     <none>
 * Callees:
  ...
  if ( v20 )
  {
          ...
          (v15 = v11) != 0) )
    {
      ...
      if ( !(unsigned int)UMPDOBJ::pso(v10, (UMPDOBJ *)((char *)v10 + 64), (struct _SURFOBJ **)&v22[3], v7)
        ...
        || (LODWORD(Size) = 4, (unsigned int)UMPDOBJ::Thunk(v10, v22, 96LL, &v15, Size) == -1)
        || (v12 = 1, !v15) )
      {
        v12 = 0;
      }
