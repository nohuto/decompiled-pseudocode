/*
 * XREFs of _GetGUIThreadInfo @ 0x1C00FF9F0
 * Callers:
...
LABEL_3:
  ...
  if ( *(_QWORD *)(v8 + 304) )
  {
    v13 = W32GetThreadWin32Thread((__int64)KeGetCurrentThread(), a2, a3, a4);
    a1 = *(_QWORD **)(v8 + 304);
    a2 = a1[2];
...
LABEL_34:
  ...
  *(_QWORD *)(v4 + 24) = v24;
  ...
  if ( v25 )
  {
    *(_QWORD *)(v4 + 48) = *v25;
    v26 = *(_QWORD *)(v8 + 304);
    if ( *(_QWORD *)(v26 + 16) == W32GetThreadWin32Thread((__int64)KeGetCurrentThread(), a2, a3, a4)
