/*
 * XREFs of ?xxxExecute@@YAKPEAKPEA_JPEAUtagDDECONV@@@Z @ 0x1C020A9F0
 * Callers:
...
__int64 __fastcall xxxExecute(unsigned int *a1, void **a2, struct tagDDECONV *a3)
{
  ...
  {
    LOBYTE(a2) = 4;
    WPP_RECORDER_SF_((_DWORD)a1, (_DWORD)a2, 14, 46, (__int64)&WPP_750226f5e6783e90d756865f46aaf029_Traceguids);
  }
  v6 = *((_QWORD *)a3 + 5);
  v7 = 2048;
  v17 = 2048;
