/*
 * XREFs of _GetAltTabInfo @ 0x1C01F4DB4
 * Callers:
    ...
    *(_QWORD *)(a2 + 32) = *(_QWORD *)((char *)v9 + 84);
    if ( v5 && (int)v8 >= 0 )
    {
      if ( (int)v8 < *((_DWORD *)v9 + 10)
        && (_mm_lfence(),
            LOBYTE(v10) = 1,
            (v11 = HMValidateHandleNoSecure(*(_QWORD *)(*((_QWORD *)v9 + 2) + 8 * v8 + 32), v10, (__int64)a3, a4)) != 0) )
      {
        if ( a5 )
        {
        ...
        else
        {
          ...
          StrName = tagWND::ProtectedLargeUnicodeStringWNDstrName::getStrName(
                      (tagWND::ProtectedLargeUnicodeStringWNDstrName *)(v11 + 184),
