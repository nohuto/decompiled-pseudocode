/*
 * XREFs of ?TraceLoggingPTPUsageDetailsEvent@@YAXPEBUtagTPTELEMSTATE@@_J@Z @ 0x1C01CE9A8
 * Callers:
...
void __fastcall TraceLoggingPTPUsageDetailsEvent(const struct tagTPTELEMSTATE *a1)
{
  ...
  if ( hProvider > 5u )
  {
    if ( TlgKeywordOn((TraceLoggingHProvider)&hProvider, 0x200000000000uLL) )
    {
      ...
      v39 = &v16;
      v40 = 4LL;
      TlgWrite((TraceLoggingHProvider)&hProvider, &unk_1C02E634D, 0LL, 0LL, 0xDu, &pData);
    }
  }
}
