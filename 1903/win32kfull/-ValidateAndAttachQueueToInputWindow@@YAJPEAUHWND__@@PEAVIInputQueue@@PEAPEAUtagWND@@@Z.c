/*
 * XREFs of ?ValidateAndAttachQueueToInputWindow@@YAJPEAUHWND__@@PEAVIInputQueue@@PEAPEAUtagWND@@@Z @ 0x1C0019684
 * Callers:
 *     UserValidateAndAttachQueueToInputWindowApiExt @ 0x1C0019670 (UserValidateAndAttachQueueToInputWindowApiExt.c)
 * Callees:
