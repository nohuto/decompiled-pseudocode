/*
 * XREFs of ?vFlushCache@RFONTOBJ@@QEAAXXZ @ 0x1C02CDF8C
 * Callers:
 ...
 *     ?bEnsureGlyphCacheBuffer@RFONTOBJ@@QEAAHKPEAPEAU_GLYPHDATA@@PEA_KPEAPEAU_GLYPHBITS@@@Z @ 0x1C0165E1C (-bEnsureGlyphCacheBuffer@RFONTOBJ@@QEAAHKPEAPEAU_GLYPHDATA@@PEA_KPEAPEAU_GLYPHBITS@@@Z.c)
 * Callees:
 *     <none>
 */
