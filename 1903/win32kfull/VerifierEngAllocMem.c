/*
 * XREFs of VerifierEngAllocMem @ 0x1C0298550
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall VerifierEngAllocMem(char a1, unsigned int a2, unsigned int a3)
{
  ...
  if ( v9 )
  {
    ...
    if ( (gvs & 8) != 0 )
    {
      *(_QWORD *)(v10 + 16) = v6;
      *(_DWORD *)(v10 + 24) = a3;
      GreAcquireSemaphore(qword_1C0322460);
      v11 = (__int64 *)qword_1C0322470;
      if ( *(_UNKNOWN **)qword_1C0322470 != &unk_1C0322468 )
        __fastfail(3u);
      *(_QWORD *)v10 = &unk_1C0322468;
      *(_QWORD *)(v10 + 8) = v11;
      *v11 = v10;
      qword_1C0322470 = v10;
      EtwTraceGreLockReleaseSemaphore(L"gvs.hsemPoolTracker", qword_1C0322460);
      GreReleaseSemaphoreInternal(qword_1C0322460);
      v10 += 32LL;
    }
  }
  return v10;
