/*
 * XREFs of ?bCreateSectionFromHandle@@YAHPEAXPEBGPEAU_FILEVIEW@@HPEAHE@Z @ 0x1C007DF1C
 * Callers:
 ...
 *     ?TryGetFileDeviceRemoteBit@@YAJPEAXPEA_N@Z @ 0x1C007E560 (-TryGetFileDeviceRemoteBit@@YAJPEAXPEA_N@Z.c)
