        ...
        _OWORD *a8)
{
  ...
  v20.Buffer = a1;
  v8 = 0;
  *(_QWORD *)&v20.Length = 0x100000LL;
  v9 = 0;
  *(_QWORD *)&v19.Length = 0x100000LL;
  v19.Buffer = a2;
  ...
  if ( DeviceList )
  {
    ...
    while ( 1 )
    {
      ...
      {
        if ( *((_WORD *)DeviceList + 442) == (_WORD)v13 )
        {
          *a3 = v12;
        }
