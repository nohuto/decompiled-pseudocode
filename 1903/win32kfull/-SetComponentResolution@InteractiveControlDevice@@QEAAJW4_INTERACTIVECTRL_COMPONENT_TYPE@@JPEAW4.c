/*
 * XREFs of ?SetComponentResolution@InteractiveControlDevice@@QEAAJW4_INTERACTIVECTRL_COMPONENT_TYPE@@JPEAW4tagINTERACTIVECTRL_HAPTICS_MODE@@@Z @ 0x1C0254690
 * Callers:
...
LABEL_57:
  ...
  if ( dword_1C0321308 > 2u )
  {
    ...
    *(_QWORD *)&v32.Range.UsageMin = 4LL;
    v33 = 4;
    TlgWrite((TraceLoggingHProvider)&dword_1C0321308, &unk_1C02E972F, 0LL, 0LL, 5u, (EVENT_DATA_DESCRIPTOR *)&v32);
  }
LABEL_63:
  if ( v9 )
    Win32FreePool(v9);
