/*
 * XREFs of ?SendHapticFeedbackOutput@SimpleHapticsController@@QEAAJAEBU_SIMPLEHAPTICCTRL_FEEDBACK_DATA@@@Z @ 0x1C0257B2C
 * Callers:
        ...
        const struct _SIMPLEHAPTICCTRL_FEEDBACK_DATA *a2)
{
  ...
  if ( (unsigned int)dword_1C03212D0 > 4 )
  {
    ...
    v29 = 4LL;
    v31 = 4LL;
    TlgWrite((TraceLoggingHProvider)&dword_1C03212D0, &unk_1C02E992D, 0LL, 0LL, 7u, &v21);
  }
...
LABEL_22:
  if ( (unsigned int)dword_1C03212D0 > 4 )
  {
    ...
    v25 = 4LL;
    TlgWrite((TraceLoggingHProvider)&dword_1C03212D0, &unk_1C02E9886, 0LL, 0LL, 4u, &v21);
    return v17;
  }
  return result;
}
