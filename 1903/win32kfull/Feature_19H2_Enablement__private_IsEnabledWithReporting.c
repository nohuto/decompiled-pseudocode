/*
 * XREFs of Feature_19H2_Enablement__private_IsEnabledWithReporting @ 0x1C0163B14
 * Callers:
 *     ?Feature_PenTailDockEvents__private_areDependenciesEnabled@@YAHXZ @ 0x1C0163C60 (-Feature_PenTailDockEvents__private_areDependenciesEnabled@@YAHXZ.c)
 * Callees:
...
_BOOL8 Feature_19H2_Enablement__private_IsEnabledWithReporting()
{
  BOOL v0; // ebx

  v0 = wil_details_FeaturePropertyCache_GetCachedFeatureEnabledState(
         &Feature_19H2_Enablement__private_propertyCache,
         20455539LL,
         0LL) == 2;
  wil_details_FeaturePropertyCache_ReportUsageToService(
    (__int64)&Feature_19H2_Enablement__private_propertyCache,
    20455539LL,
    (const struct FEATURE_LOGGED_TRAITS *)&unk_1C02DD770,
    v0,
    0);
  return v0;
}
