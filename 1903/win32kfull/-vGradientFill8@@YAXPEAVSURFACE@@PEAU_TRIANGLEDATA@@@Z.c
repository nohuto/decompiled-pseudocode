/*
 * XREFs of ?vGradientFill8@@YAXPEAVSURFACE@@PEAU_TRIANGLEDATA@@@Z @ 0x1C02CBB30
 * Callers:
 *     <none>
 * Callees:
        ...
        if ( *((_QWORD *)a1 + 9) <= (unsigned __int64)v21 && v16 < v17 )
        {
          ...
          if ( v24 )
          {
            ...
            do
            {
              ...
              v30 = v42[v29 + HIBYTE(v27)];
              v31 = v19;
              v19 += v37;
              v32 = v42[v29 + HIBYTE(v31)] & 0xF8 | (32LL * (v30 & 0xF8));
              v33 = v20;
              v20 += v38;
              *v21++ = v13[Xlate555[((unsigned __int64)v42[v29 + HIBYTE(v33)] >> 3) | (4 * v32)]];
            }
            while ( v25 < v24 );
            v5 = a2;
            v15 = v35;
