/*
 * XREFs of NtUserGetMenuBarInfo @ 0x1C0020DD0
 * Callers:
 *     <none>
 * Callees:
  ...
  if ( v8 )
  {
    ...
    *v10 = *v10;
    ...
    if ( (*(_BYTE *)(*(_QWORD *)(v12 + 472) + 224LL) & 1) == 0 )
    {
      ...
      {
        v25 = *(_DWORD *)(*(_QWORD *)(v8 + 40) + 288LL);
        if ( (((unsigned __int16)(v25 >> 8) ^ (unsigned __int16)((unsigned int)W32GetCurrentThreadDpiAwarenessContext() >> 8)) & 0x1FF) != 0 )
          goto LABEL_24;
        v26 = (*(_DWORD *)(*(_QWORD *)(v8 + 40) + 288LL) & 0xF) == 2
           && (*(_DWORD *)(*(_QWORD *)(v8 + 40) + 288LL) & 0x20000000) != 0;
