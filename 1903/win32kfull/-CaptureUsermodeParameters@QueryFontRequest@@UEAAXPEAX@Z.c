/*
 * XREFs of ?CaptureUsermodeParameters@QueryFontRequest@@UEAAXPEAX@Z @ 0x1C00F0380
 * Callers:
 *     <none>
 * Callees:
 ...
 *     ?ValidateIFIMETRICS@@YA_NPEAU_IFIMETRICS@@@Z @ 0x1C00F0C94 (-ValidateIFIMETRICS@@YA_NPEAU_IFIMETRICS@@@Z.c)
