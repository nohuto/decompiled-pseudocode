/*
 * XREFs of ?HitTargetAndMonitorFromPoint@@YAHUtagPOINT@@QEBU_MOVESIZEDATA@@PEAPEAUtagMONITOR@@PEAW4eTHRESHOLD_MARGIN_DIRECTION@@@Z @ 0x1C01FA7A0
 * Callers:
 ...
 *     ?PtInRectSpace@@YAHPEBUtagRECT@@UtagPOINT@@W4eTHRESHOLD_MARGIN_DIRECTION@@@Z @ 0x1C01FB3BC (-PtInRectSpace@@YAHPEBUtagRECT@@UtagPOINT@@W4eTHRESHOLD_MARGIN_DIRECTION@@@Z.c)
        ...
        enum eTHRESHOLD_MARGIN_DIRECTION *a4)
{
  ...
  *(_QWORD *)&v25.right = 0LL;
  ...
  {
    if ( !v10 )
      v10 = gWinArrGlobal[dword_1C02E1D54[4 * (unsigned int)v9]];
    if ( !v11 )
      v11 = gWinArrGlobal[dword_1C02E1D58[4 * v9]];
    if ( !v12 )
      v12 = gWinArrGlobal[dword_1C02E1D5C[4 * v9]];
  }
  v13 = v25;
  v14 = v25.left + v10;
