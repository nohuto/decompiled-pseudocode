/*
 * XREFs of RtlWCSMessageWParamCharToMB @ 0x1C01396B0
 * Callers:
...
LABEL_10:
    ...
    if ( (*gpsi & 2) != 0 )
    {
      if ( (MultiByteString & 0xFF00) != 0 )
        v6 = ((unsigned __int64)(unsigned __int16)MultiByteString >> 8) | (((unsigned __int8)MultiByteString | ((unsigned __int64)*(unsigned __int16 *)(a2 + 2) << 8)) << 8);
      else
