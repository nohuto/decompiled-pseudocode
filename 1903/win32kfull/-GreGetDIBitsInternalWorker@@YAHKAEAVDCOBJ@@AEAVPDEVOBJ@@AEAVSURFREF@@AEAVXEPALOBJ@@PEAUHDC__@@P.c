/*
 * XREFs of ?GreGetDIBitsInternalWorker@@YAHKAEAVDCOBJ@@AEAVPDEVOBJ@@AEAVSURFREF@@AEAVXEPALOBJ@@PEAUHDC__@@PEAUHBITMAP__@@IIPEAEPEAUtagBITMAPINFO@@III@Z @ 0x1C00346F0
 * Callers:
 ...
 *     ?bIdenticalFormat@@YAHVXEPALOBJ@@H@Z @ 0x1C0035F54 (-bIdenticalFormat@@YAHVXEPALOBJ@@H@Z.c)
 ...
 *     ?vFill_triples@XEPALOBJ@@QEAAXPEAUtagRGBTRIPLE@@KK@Z @ 0x1C02B5D60 (-vFill_triples@XEPALOBJ@@QEAAXPEAUtagRGBTRIPLE@@KK@Z.c)
        ...
        unsigned int a14)
{
  ...
  struct PDEVOBJ *v67; // [rsp+80h] [rbp-128h] BYREF
  unsigned int v68; // [rsp+88h] [rbp-120h]
  unsigned int v69; // [rsp+8Ch] [rbp-11Ch]
  struct PDEVOBJ *v70; // [rsp+90h] [rbp-118h] BYREF
  ...
  struct SURFREF *v76; // [rsp+C0h] [rbp-E8h]
  struct XEPALOBJ *v77; // [rsp+C8h] [rbp-E0h] BYREF
  int v78; // [rsp+D0h] [rbp-D8h]
  int v79; // [rsp+D4h] [rbp-D4h]
  __int64 v80; // [rsp+D8h] [rbp-D0h] BYREF
  char v81; // [rsp+E0h] [rbp-C8h]
  int v82; // [rsp+E4h] [rbp-C4h]
  unsigned __int8 *v83; // [rsp+E8h] [rbp-C0h]
  DC **v84; // [rsp+F0h] [rbp-B8h]
  struct tagBITMAPINFO *v85; // [rsp+F8h] [rbp-B0h]
  struct PDEVOBJ *v86; // [rsp+100h] [rbp-A8h]
  _QWORD v87[4]; // [rsp+108h] [rbp-A0h] BYREF
  ...
  v89[2] = a11;
  v16 = 1;
  if ( !(unsigned int)bIsCompatible(v89, *(_QWORD *)(*(_QWORD *)a4 + 128LL), *(_QWORD *)a4, *((_QWORD *)*a2 + 6), 1) )
    return 0LL;
  v17 = (struct PDEVOBJ *)v89[0];
  v89[3] = v89[0];
...
LABEL_34:
      ...
      if ( v27 == 1 )
      {
        if ( a14 >= v75 + 2 * (unsigned __int64)v22 )
        {
          ...
          if ( !v17 && LODWORD(v87[0]) == 3 && *(_QWORD *)(*(_QWORD *)v77 + 72LL) )
          {
            v31 = 0LL;
            v67 = 0LL;
            v45 = pxlo;
...
LABEL_121:
          ...
          else
          {
            ...
            v55 = *(struct PDEVOBJ **)(*(_QWORD *)v86 + 1808LL);
            v86 = v55;
            if ( v17 )
              v55 = v17;
            XEPALOBJ::vGetEntriesFrom(&v67, *(_QWORD *)v77, v55, v53, v22);
          }
          SEMOBJ::vUnlock((SEMOBJ *)&v72);
          goto LABEL_51;
        }
      ...
      else
      {
        ...
        {
          v30 = 0;
          if ( *(_DWORD *)(v29 + 96) == (_DWORD)v28 && v17 )
          {
            v30 = 1;
            if ( biCompression == 3 || (((_DWORD)v28 - 4) & 0xFFFFFFFD) != 0 )
            {
              if ( (_DWORD)v28 == 5 && (*((_BYTE *)v17 + 24) & 4) != 0 )
                v30 = 0;
            }
            else
            {
              v30 = bIdenticalFormat(v17, v28, 1LL);
            }
          }
          if ( v30 )
          {
          ...
          if ( PALMEMOBJ::bCreatePalette((PALMEMOBJ *)&v70, v41, v22, 0LL, 0x7C00u, 0x3E0u, 0x1Fu, 0x200u, 1) )
          {
            v31 = v70;
            v67 = v70;
            if ( *(_DWORD *)(*(_QWORD *)v76 + 96LL) == LODWORD(v87[0]) && LODWORD(v87[0]) == 3 )
            {
              v56 = 0;
              v57 = pxlo;
              if ( v22 )
              ...
              v90 = *(_QWORD *)(*(_QWORD *)v86 + 1808LL);
              XEPALOBJ::vGetEntriesFrom(&v67, *(_QWORD *)v77, v90, v57, v22);
              XEPALOBJ::vInit256Default((XEPALOBJ *)&v67);
            }
            else
            {
              switch ( LODWORD(v87[0]) )
              {
                case 1:
                  **((_DWORD **)v70 + 14) = 0;
                ...
                case 2:
                  ...
                  do
                  {
                    *(_DWORD *)(v59 + *((_QWORD *)v31 + 14)) = *(_DWORD *)((char *)&aPalVGA + v59);
                    v59 += 4LL;
                    --v60;
                  }
                  while ( v60 );
            ...
            if ( (_DWORD)v72 )
            {
              if ( a14 >= (unsigned __int64)(3 * v22) + 12 )
              {
                if ( ((v69 - 16) & 0xFFFFFFE7) != 0 || v69 == 40 )
                  XEPALOBJ::vFill_triples((XEPALOBJ *)&v67, (struct tagRGBTRIPLE *)pxlo, v30, v22);
LABEL_51:
                pxlo = 0LL;
...
LABEL_75:
                ...
                v81 = 0;
                v82 = 0;
                SURFMEM::bCreateDIB((SURFMEM *)&v80, (struct _DEVBITMAPINFO *)v87, v34, 0LL, 0, 0LL, 0LL, 0, 1, 0, 0);
                if ( !v80 )
                  goto LABEL_156;
                v35 = *(struct tagBITMAPINFO **)(v80 + 72);
                v85 = v35;
                *(_QWORD *)(v80 + 48) = *((_QWORD *)*v84 + 6);
                v75 = *(_DWORD *)(v80 + 64);
                v84 = *(DC ***)(v80 + 72);
                memset(v84, 0, v75);
                *(_QWORD *)&prclDest.left = 0LL;
                prclDest.right = HIDWORD(v87[0]);
                prclDest.bottom = v87[1];
                pptlSrc.x = 0;
                pptlSrc.y = v64 - v63 - v66;
                LODWORD(v77) = 0;
                HIDWORD(v77) = v66 - (v64 - v63);
                v36 = *(_QWORD *)v76;
                v78 = *(_DWORD *)(*(_QWORD *)v76 + 56LL);
                v79 = *(_DWORD *)(v36 + 60) + HIDWORD(v77);
                ERECTL::operator*=(&prclDest, &v77);
...
LABEL_61:
        ...
        else if ( (_DWORD)v28 == *(_DWORD *)(v29 + 96) )
        {
          v31 = v17;
          v67 = v17;
          goto LABEL_51;
