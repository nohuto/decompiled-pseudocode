/*
 * XREFs of SfnINLPHLPSTRUCT @ 0x1C0217EC0
 * Callers:
 *     <none>
 * Callees:
...
unsigned __int8 *__fastcall SfnINLPHLPSTRUCT(_QWORD *a1, unsigned int a2, __int64 a3, char *a4, __int64 a5, __int64 a6)
{
  ...
  if ( a1 )
    ...
    v15 = 0LL;
  result = AllocCallbackMessage(88, 1u, *(unsigned __int16 *)a4, v56, 1, 0x200uLL);
  v20 = result;
  v45 = result;
  if ( result )
  {
    ...
    *((_DWORD *)v20 + 12) = a2;
    *((_QWORD *)v20 + 7) = a3;
    if ( (int)CaptureCallbackData((struct _CAPTUREBUF *)v20, a4, *(unsigned __int16 *)a4, (void **)v20 + 8) < 0 )
      goto LABEL_26;
    *((_QWORD *)v20 + 9) = a5;
    *((_QWORD *)v20 + 10) = a6;
    ...
    *((_QWORD *)v20 + 2) = 0LL;
    v31 = KeUserModeCallback(14LL, v20, *(unsigned int *)v20, &v46, v44);
