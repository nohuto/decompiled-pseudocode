/*
 * XREFs of ?FindEntryByTime@@YAPEAUtagINPUTTRANSFORMENTRY@@PEAUtagINPUTTRANSFORMLIST@@PEAU1@_K@Z @ 0x1C01F6588
 * Callers:
...
LABEL_9:
  ...
  if ( WPP_RECORDER_INITIALIZED != (_UNKNOWN *)&WPP_RECORDER_INITIALIZED )
    WPP_RECORDER_SF_ii(v7, 4u, 0xAu, 0xAu, (__int64)&WPP_8438351599043bf8e2667f448536d6b5_Traceguids, v10, a3);
