/*
 * XREFs of ?bNearMatch@MAPPER@@QEAAHAEAVPFEOBJ@@PEAEH@Z @ 0x1C00A7780
 * Callers:
 ...
 * Callees:
 *     ?bCheckFamilyName@PFEOBJ@@QEAAHPEBGHPEAH@Z @ 0x1C0048734 (-bCheckFamilyName@PFEOBJ@@QEAAHPEBGHPEAH@Z.c)
 ...
 *     ?bNoMatch@MAPPER@@QEBAHPEAVPFE@@@Z @ 0x1C00AA0CC (-bNoMatch@MAPPER@@QEBAHPEAVPFE@@@Z.c)
 ...
 *     ?bCalcOrientation@MAPPER@@QEAAHXZ @ 0x1C01064E8 (-bCalcOrientation@MAPPER@@QEAAHXZ.c)
 *     ?lfOutPrecision@IFIOBJ@@QEBAEXZ @ 0x1C012465C (-lfOutPrecision@IFIOBJ@@QEBAEXZ.c)
