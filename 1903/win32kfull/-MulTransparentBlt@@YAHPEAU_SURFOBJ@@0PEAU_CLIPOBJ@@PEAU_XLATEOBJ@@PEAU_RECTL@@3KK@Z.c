/*
 * XREFs of ?MulTransparentBlt@@YAHPEAU_SURFOBJ@@0PEAU_CLIPOBJ@@PEAU_XLATEOBJ@@PEAU_RECTL@@3KK@Z @ 0x1C029E590
 * Callers:
 *     <none>
 * Callees:
...
LABEL_51:
      ...
      if ( !v19 )
      {
        ...
        v18 = OffTransparentBlt(
                (__int64 (__fastcall *)(__int64, __int64, struct _CLIPOBJ *, __int64, __int64 *, __int64 *, int, int))v36,
                *(int **)v56,
                *(__int64 *)v54,
                (int *)&gptlZero,
                (__int64)psoSrc,
