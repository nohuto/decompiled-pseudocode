/*
 * XREFs of ?pxrlStrRead04@@YAPEAU_XRUNLEN@@PEAU_STRDDA@@PEAU_STRRUN@@PEAE2PEAU_XLATEOBJ@@JJJ@Z @ 0x1C011E500
 * Callers:
 *     <none>
 * Callees:
 *     <none>
        ...
        int a8)
{
  ...
  if ( a4 )
  {
    ...
    if ( v8 < a7 )
    {
      ...
      while ( 1 )
      {
        v45 = (v40 & (unsigned int)dword_1C02E4238[v43]) >> dword_1C02E4218[v56];
        if ( a5 )
          LODWORD(v45) = a5->pulXlate[v45];
        if ( (dword_1C02E4E80[v44] & v62) != 0 )
        {
          v46 = *v41;
          if ( *v41 )
          {
    ...
    if ( a6 < a7 )
    {
      ...
      if ( a5 )
      {
        while ( 1 )
        {
          ...
          {
            v21 = v20;
            v22 = v15->pulXlate[(unsigned __int64)(v17 & (unsigned int)dword_1C02E4238[v19]) >> LOBYTE(dword_1C02E4218[v19])];
            v23 = &v9[v18 + 2];
      ...
      else
      {
        while ( 1 )
        {
          v30 = (v17 & (unsigned int)dword_1C02E4238[v19]) >> dword_1C02E4218[v19];
          v31 = *v16++;
          if ( (_DWORD)v31 )
          {
            v14 += v31;
