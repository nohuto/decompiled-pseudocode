/*
 * XREFs of xxxSetDeskWallpaper @ 0x1C013A660
 * Callers:
 ...
 *     ?SetGlobalWallpaperSettings@@YAHPEBUtagWALLPAPERSETTINGS@@@Z @ 0x1C013A914 (-SetGlobalWallpaperSettings@@YAHPEBUtagWALLPAPERSETTINGS@@@Z.c)
...
__int64 __fastcall xxxSetDeskWallpaper(__int64 a1, char *a2)
{
    ...
    && v9 )
  {
    ...
    *(_QWORD *)(ThreadWin32Thread + 408) = &v24;
    v25 = v9;
    HMLockObject(v9);
    v14 = xxxSendNotifyMessage(v9, 0x34u, 5uLL, 0LL, 1);
