/*
 * XREFs of ?xxxAdvise@@YAKPEAKPEA_JPEAUtagDDECONV@@@Z @ 0x1C0209E9C
 * Callers:
...
__int64 __fastcall xxxAdvise(unsigned int *a1, void **a2, struct tagDDECONV **a3)
{
  ...
  {
    LOBYTE(a2) = 4;
    WPP_RECORDER_SF_((_DWORD)a1, (_DWORD)a2, 14, 25, (__int64)&WPP_750226f5e6783e90d756865f46aaf029_Traceguids);
  }
  v6 = *v4;
  v14 = 129;
