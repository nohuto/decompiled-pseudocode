/*
 * XREFs of ?lfOrientation@IFIOBJ@@QEAAJXZ @ 0x1C004ECC8
 * Callers:
 ...
 *     ?vIFIMetricsToEnumLogFontW@@YAXPEAUtagENUMLOGFONTW@@PEAU_IFIMETRICS@@@Z @ 0x1C00E7378 (-vIFIMetricsToEnumLogFontW@@YAXPEAUtagENUMLOGFONTW@@PEAU_IFIMETRICS@@@Z.c)
 *     vIFIMetricsToLogFontW @ 0x1C02A0848 (vIFIMetricsToLogFontW.c)
 * Callees:
