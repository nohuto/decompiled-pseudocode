/*
 * XREFs of ?HidRequestValidityCheck@@YAHQEAUtagRAWINPUTDEVICE@@PEBUtagPROCESS_HID_TABLE@@W4_REGISTER_RAW_INPUT_INTERNAL@@@Z @ 0x1C010D444
 * Callers:
...
__int64 __fastcall HidRequestValidityCheck(__int64 a1, __int64 a2, __int64 a3)
{
  ...
  if ( a2 && *(_WORD *)a1 == 1 && *(_WORD *)(a1 + 2) == 6 )
  {
    if ( (*(_DWORD *)(a1 + 4) & 1) != 0 )
    {
      if ( __CFSHR__(*(_DWORD *)(a2 + 100), 12) != (_DWORD)v6 )
        goto LABEL_38;
    }
  ...
  if ( (v8 & 0x200) != 0 )
  {
    ...
    if ( *(_WORD *)(a1 + 2) == 2 )
    {
      ...
      if ( (_BYTE)v12 != 48
        || !v5
        || *(_QWORD *)(*(_QWORD *)(v5 + 16) + 416LL) != PsGetCurrentProcessWin32Process(v12, a2) )
      {
        goto LABEL_40;
      }
    }
...
LABEL_14:
  ...
  if ( *(_QWORD *)(*(_QWORD *)(v5 + 16) + 416LL) == PsGetCurrentProcessWin32Process(v9, a2) )
  {
LABEL_20:
