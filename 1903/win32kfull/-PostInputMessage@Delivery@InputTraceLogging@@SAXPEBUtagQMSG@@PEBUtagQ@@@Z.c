/*
 * XREFs of ?PostInputMessage@Delivery@InputTraceLogging@@SAXPEBUtagQMSG@@PEBUtagQ@@@Z @ 0x1C002435C
 * Callers:
...
void __fastcall InputTraceLogging::Delivery::PostInputMessage(const struct tagQMSG *a1, const struct tagQ *a2)
{
  ...
  if ( (unsigned int)IsPointerInputMessage(*((unsigned int *)a1 + 6)) )
  {
    if ( dword_1C03222C0 > 4u && TlgKeywordOn((TraceLoggingHProvider)&dword_1C03222C0, 0x10uLL) )
    {
      ...
      v40 = 8LL;
      v42 = v5;
      TlgWrite((TraceLoggingHProvider)&dword_1C03222C0, &unk_1C02E75AA, 0LL, 0LL, 0xAu, &pData);
    }
  }
  else if ( InputTraceLogging::IsMouseInputMessage(v3) )
  {
    if ( dword_1C03222C0 > 4u )
    {
      if ( TlgKeywordOn((TraceLoggingHProvider)&dword_1C03222C0, 0x10uLL) )
      {
        ...
        v34 = 8LL;
        v36 = v9;
        TlgWrite((TraceLoggingHProvider)&dword_1C03222C0, &unk_1C02E7636, 0LL, 0LL, 7u, &pData);
      }
    }
  }
  else if ( (unsigned int)(v4 - 256) > 9 )
  {
    if ( v4 == 255 && dword_1C03222C0 > 4u )
    {
      if ( TlgKeywordOn((TraceLoggingHProvider)&dword_1C03222C0, 0x10uLL) )
      {
        v24 = *(_QWORD *)(v18 + 136);
        ...
        v32 = v17;
        v34 = 8LL;
        TlgWrite((TraceLoggingHProvider)&dword_1C03222C0, &unk_1C02E76F4, 0LL, 0LL, 6u, &pData);
      }
    }
  }
  else if ( dword_1C03222C0 > 4u )
  {
    if ( TlgKeywordOn((TraceLoggingHProvider)&dword_1C03222C0, 0x10uLL) )
    {
      ...
      v32 = v13;
      v34 = 8LL;
      TlgWrite((TraceLoggingHProvider)&dword_1C03222C0, &unk_1C02E7699, 0LL, 0LL, 6u, &pData);
    }
  }
}
