/*
 * XREFs of UmfdSessionUninitialize @ 0x1C013D960
 * Callers:
 *     <none>
 * Callees:
 *     ?Destroy@CMultipleConsumerWorkQueue@@SAXQEAV1@@Z @ 0x1C013A104 (-Destroy@CMultipleConsumerWorkQueue@@SAXQEAV1@@Z.c)
 *     ?SessionUninitialize@UmfdHostLifeTimeManager@@CAXXZ @ 0x1C013DA0C (-SessionUninitialize@UmfdHostLifeTimeManager@@CAXXZ.c)
