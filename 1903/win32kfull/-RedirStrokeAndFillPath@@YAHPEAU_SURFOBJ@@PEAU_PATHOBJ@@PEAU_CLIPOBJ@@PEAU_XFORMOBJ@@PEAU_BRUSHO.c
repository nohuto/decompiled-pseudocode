/*
 * XREFs of ?RedirStrokeAndFillPath@@YAHPEAU_SURFOBJ@@PEAU_PATHOBJ@@PEAU_CLIPOBJ@@PEAU_XFORMOBJ@@PEAU_BRUSHOBJ@@PEAU_LINEATTRS@@4PEAU_POINTL@@KK@Z @ 0x1C02976C0
 * Callers:
 *     <none>
 * Callees:
 ...
 *     ??0REDIROPEN@@QEAA@PEAU_SURFOBJ@@@Z @ 0x1C0295A74 (--0REDIROPEN@@QEAA@PEAU_SURFOBJ@@@Z.c)
        ...
        FLONG a10)
{
        ...
        if ( (v18 & 0x20000) != 0 )
        {
          for ( i = **(_QWORD ***)(v17 + 1800); i; i = (_QWORD *)*i )
          {
            ...
            if ( v20 )
            {
              ...
              {
                if ( *(_QWORD *)(*(_QWORD *)(v20 + 1792) + 192LL) )
                {
                  MARK_ACCDRV_NOTIFICATION::MARK_ACCDRV_NOTIFICATION(
                    (MARK_ACCDRV_NOTIFICATION *)&v24,
                    (struct PDEVOBJ *)&v35,
                    a1);
                  (*(void (__fastcall **)(struct _SURFOBJ *, PATHOBJ *, CLIPOBJ *, XFORMOBJ *, BRUSHOBJ *, LINEATTRS *, BRUSHOBJ *, POINTL *, MIX, FLONG))(*(_QWORD *)(v21 + 1792) + 192LL))(
                    a1,
                    ppo,
                    pco,
                    pxo,
  ...
  v22 = EngStrokeAndFillPath(a1, ppo, pco, pxo, pboStroke, plineattrs, pboFill, pptlBrushOrg, mixFill, flOptions);
  if ( v25 )
    bMakeOpaque(v25);
  return v22;
}
