/*
 * XREFs of ?vNextPoint@LINER@@AEAAXXZ @ 0x1C01193A4
 * Callers:
 *     ?vNextEvent@LINER@@QEAAXXZ @ 0x1C0119234 (-vNextEvent@LINER@@QEAAXXZ.c)
 * Callees:
 ...
 *     ?vInit@BEZIER@@QEAAXPEAU_POINTFIX@@PEAU_RECTFX@@PEB_J@Z @ 0x1C0159AAC (-vInit@BEZIER@@QEAAXPEAU_POINTFIX@@PEAU_RECTFX@@PEB_J@Z.c)
...
void __fastcall LINER::vNextPoint(LINER *this)
{
  ...
  __int64 v23; // rax
  __int64 v24; // xmm1_8
  struct _POINTFIX v25; // [rsp+20h] [rbp-30h] BYREF
  __int64 v26; // [rsp+28h] [rbp-28h]
  struct _POINTFIX v27; // [rsp+30h] [rbp-20h] BYREF
  struct _POINTFIX v28; // [rsp+38h] [rbp-18h] BYREF
...
LABEL_9:
      ...
      v25 = *(struct _POINTFIX *)((char *)this + 692);
      v26 = *v6;
      READER::bNextPoint(this, &v27);
      READER::bNextPoint(this, &v28);
      BEZIER::vInit((LINER *)((char *)this + 48), &v25, v17, gpeqErrorLow);
      ...
      *(_QWORD *)(v21 + 48) = *(_QWORD *)(v21 + 40);
      if ( v20 )
      {
        ...
        *((_QWORD *)this + 85) = v24;
        *((_DWORD *)this + 163) = v23;
        *((_DWORD *)this + 162) = v26 - v25.x;
        *((_DWORD *)this + 163) -= v25.y;
        *((_DWORD *)this + 128) = 0;
        *((_DWORD *)this + 139) = v28.y;
        *((_DWORD *)this + 138) = v28.x - v27.x;
        *((_DWORD *)this + 139) -= v27.y;
