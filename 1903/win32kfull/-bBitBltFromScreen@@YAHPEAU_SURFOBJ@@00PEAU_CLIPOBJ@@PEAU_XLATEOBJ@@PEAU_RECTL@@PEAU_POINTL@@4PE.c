/*
 * XREFs of ?bBitBltFromScreen@@YAHPEAU_SURFOBJ@@00PEAU_CLIPOBJ@@PEAU_XLATEOBJ@@PEAU_RECTL@@PEAU_POINTL@@4PEAU_BRUSHOBJ@@4K@Z @ 0x1C029EC60
 * Callers:
        ...
        unsigned int a11)
{
  ...
  {
    v20 = v53;
    if ( (*(_DWORD *)(*(_QWORD *)(v53 + 24) + 1824LL) & 0x8000000) == 0 )
    {
...
LABEL_39:
          ...
          if ( a11 == 52428 )
          {
            if ( (*((_DWORD *)v34 + 28) & 0x400) != 0 )
              v35 = *(BOOL (__stdcall **)(SURFOBJ *, SURFOBJ *, CLIPOBJ *, XLATEOBJ *, RECTL *, POINTL *))(*((_QWORD *)v52 + 7) + 2840LL);
            else
              v35 = EngCopyBits;
            v13 &= OffCopyBits(
                     (int)v35,
          ...
          else
          {
            ...
            if ( (*(_DWORD *)(SURFOBJ_TO_SURFACE_NOT_NULL(v53) + 112) & 1) != 0 )
              v36 = *(BOOL (__stdcall **)(SURFOBJ *, SURFOBJ *, SURFOBJ *, CLIPOBJ *, XLATEOBJ *, RECTL *, POINTL *, POINTL *, BRUSHOBJ *, POINTL *, ROP4))(*((_QWORD *)v52 + 7) + 2832LL);
            else
              v36 = EngBitBlt;
            v13 &= OffBitBlt(
                     (__int64 (__fastcall *)(__int64, __int64, __int64, struct _CLIPOBJ *, __int64, _DWORD *, __int64 *, __int64, __int64, __int64 *, int))v36,
                     (int *)&gptlZero,
                     (__int64)v22,
                     *(_DWORD **)v55,
                     v53,
