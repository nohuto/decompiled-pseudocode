/*
 * XREFs of ?CoalesceMousePromotionEntry@@YAHAEBUtagPOINTER_INFO@@G@Z @ 0x1C02074EC
 * Callers:
...
__int64 __fastcall CoalesceMousePromotionEntry(const struct tagPOINTER_INFO *a1, char a2)
{
  ...
  if ( !qword_1C032C238 )
    return 0LL;
  if ( *((_DWORD *)qword_1C032C238 + 5) != *((_DWORD *)a1 + 3) )
    return 0LL;
  v4 = *((_DWORD *)a1 + 2);
  if ( v4 <= *((_DWORD *)qword_1C032C238 + 9) || qword_1C032C318 != *((_QWORD *)a1 + 3) )
    return 0LL;
  *((_QWORD *)qword_1C032C238 + 1) = *((_QWORD *)a1 + 6);
  *((_DWORD *)v2 + 9) = v4;
  v5 = *((_DWORD *)v2 + 11);
