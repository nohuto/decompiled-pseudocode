/*
 * XREFs of ?VWPLAddBase@@YAHPEAPEAUtagVWPL@@_KPEAUtagWND@@KH@Z @ 0x1C0116710
 * Callers:
...
__int64 __fastcall VWPLAddBase(struct tagVWPL **a1, __int64 a2, struct tagWND *a3, unsigned int a4)
{
  ...
  if ( WPP_RECORDER_INITIALIZED != (_UNKNOWN *)&WPP_RECORDER_INITIALIZED )
    WPP_RECORDER_SF_qq((__int64)a1, a2, 0xBu, 0xBu, (__int64)&WPP_96a4b716de4d340ab0b6048e502c48be_Traceguids, *a1, a3);
  v8 = (unsigned int *)*a1;
  if ( *a1 )
  {
    if ( !v8[3] )
