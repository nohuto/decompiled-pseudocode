/*
 * XREFs of EngCreateWnd @ 0x1C02840C0
 * Callers:
...
LABEL_9:
    if ( v10 )
    {
      for ( i = *((_QWORD *)v10 + 3); ; i = *(_QWORD *)(i + 160) )
      {
        if ( !i )
        {
      ...
      if ( *((WNDOBJCHANGEPROC *)v10 + 5) == pfn && *(_DWORD *)(i + 188) == iPixelFormat )
        v5 = -1LL;
      goto LABEL_45;
    }
    v12 = gpto;
    ...
    do
    {
      if ( *((_QWORD *)v12 + 4) == v9 && *((WNDOBJCHANGEPROC *)v12 + 5) == pfn )
        break;
