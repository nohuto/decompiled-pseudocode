/*
 * XREFs of GreGetDIBColorTable @ 0x1C007EF80
 * Callers:
 *     <none>
 * Callees:
 *     ?vFill_rgbquads@XEPALOBJ@@QEAAXPEAUtagRGBQUAD@@KK@Z @ 0x1C0032378 (-vFill_rgbquads@XEPALOBJ@@QEAAXPEAUtagRGBQUAD@@KK@Z.c)
 ...
 *     ?bDIBSection@SURFACE@@QEAAHXZ @ 0x1C007F0C4 (-bDIBSection@SURFACE@@QEAAHXZ.c)
