/*
 * XREFs of ?vFillGRectDIB1@@YAXPEAVSURFACE@@PEAU_GRADIENTRECTDATA@@@Z @ 0x1C02C9220
 * Callers:
 *     <none>
 * Callees:
      ...
      do
      {
        ...
        if ( v13 < (int)(v13 + v12) )
        {
          ...
          do
          {
            ...
            v23 = (v22 + (unsigned int)BYTE6(v14) >= 0xFF ? 0x7C00 : 0) | (unsigned __int64)(v22
                                                                                           + (unsigned int)BYTE6(v16) >= 0xFF
                                                                                           ? 0x1F
                                                                                           : 0);
            v24 = -(__int64)(v22 + (unsigned int)BYTE6(v15) < 0xFF);
            v15 += v34;
            v16 += v35;
            v14 += v33;
            ++v20;
            v25 = v18 + 1;
            *v19 = *v19 & ~(1 << (7 - v18)) | (vTranslateIdentity[Xlate555[~(_WORD)v24 & 0x3E0 | v23]] << (7 - v18));
            v26 = v19 + 1;
            if ( v18 != 7 )
              v26 = v19;
            v19 = v26;
