/*
 * XREFs of ?ProcessInkFeedbackCommand@InkFeedbackServer@@QEAAJW4INK_FEEDBACK_COMMAND@@PEBXI@Z @ 0x1C02504D8
 * Callers:
        ...
        unsigned int a4)
{
  ...
  if ( dword_1C0321298 > 4u )
  {
    ...
    v10[0] = a2;
    v20 = 1;
    TlgWrite((TraceLoggingHProvider)&dword_1C0321298, &unk_1C02E91CD, 0LL, 0LL, 5u, &pData);
  }
  ...
  if ( dword_1C0321298 > 2u )
  {
    ...
    v19 = v10;
    v20 = 1;
    TlgWrite((TraceLoggingHProvider)&dword_1C0321298, &unk_1C02E9192, 0LL, 0LL, 5u, &pData);
  }
  return 3221225473LL;
}
