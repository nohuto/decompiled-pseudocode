/*
 * XREFs of ?DoSuperWetInkStop@InkDevice@@AEAAJPEBUIFC_SUPERWET_INK_STOP_DATA@@@Z @ 0x1C0251064
 * Callers:
...
__int64 __fastcall InkDevice::DoSuperWetInkStop(InkDevice *this, const struct IFC_SUPERWET_INK_STOP_DATA *a2)
{
  ...
  if ( v4 >= 0 )
  {
    if ( dword_1C0321298 > 4u )
    {
      ...
      v19 = a2;
      v20 = 4LL;
      TlgWrite((TraceLoggingHProvider)&dword_1C0321298, &unk_1C02E93A9, 0LL, v7, 7u, &v11);
    }
  }
