/*
 * XREFs of ?CloneWindowPosAndArrangementAsync@@YA_NPEAUtagWND@@PEBU1@1W4CloneWindowPosOptions@@@Z @ 0x1C01D31F4
 * Callers:
 ...
 *     ?GetWindowFrameBounds@@YA?AUtagRECT@@PEBUtagWND@@@Z @ 0x1C023CA04 (-GetWindowFrameBounds@@YA-AUtagRECT@@PEBUtagWND@@@Z.c)
    ...
    *(_QWORD *)(v9 + 16) = *(_QWORD *)(*(_QWORD *)(a2 + 40) + 256LL);
    ...
    if ( Prop )
    {
      ...
      *(_BYTE *)(v9 + 92) = 1;
      ...
      if ( (v18 & 0x40) != 0 )
      {
        v19 = *(_QWORD *)GetMonitorMaxArea(&v21, a2, v10);
        *(_DWORD *)(v9 + 80) += v19;
