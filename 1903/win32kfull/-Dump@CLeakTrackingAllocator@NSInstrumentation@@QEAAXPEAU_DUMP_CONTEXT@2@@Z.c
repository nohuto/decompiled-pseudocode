/*
 * XREFs of ?Dump@CLeakTrackingAllocator@NSInstrumentation@@QEAAXPEAU_DUMP_CONTEXT@2@@Z @ 0x1C02D2FF8
 * Callers:
 ...
 *     ??$Enumerate@P6AXPEAX00@Z@?$CSharedStorage@VCBackTraceBucket@NSInstrumentation@@$$CCJVCBackTraceStorageUnit@2@VCBackTrace@2@@NSInstrumentation@@QEAAXP6AXPEAX00@Z0@Z @ 0x1C02D3678 (--$Enumerate@P6AXPEAX00@Z@-$CSharedStorage@VCBackTraceBucket@NSInstrumentation@@$$CCJVCBackTrace.c)
 */
        ...
        struct NSInstrumentation::_DUMP_CONTEXT *a2)
{
  ...
  if ( v2 )
  {
    ...
    if ( v4 )
    {
      ...
      if ( !v6 )
      {
        v7 = *(_QWORD *)(*(_QWORD *)&WPP_MAIN_CB.Queue.Wcb.NumberOfChannels + 56LL);
        if ( v7 )
    ...
    {
      v5 = *(NSInstrumentation::CPointerHashTable **)(*(_QWORD *)&WPP_MAIN_CB.Queue.Wcb.NumberOfChannels + 48LL);
      if ( v5 )
  ...
  {
    v3 = *(NSInstrumentation::CPrioritizedWriterLock **)(*(_QWORD *)&WPP_MAIN_CB.Queue.Wcb.NumberOfChannels + 64LL);
    if ( v3 )
