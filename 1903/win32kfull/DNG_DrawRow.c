/*
 * XREFs of DNG_DrawRow @ 0x1C00EB570
 * Callers:
 *     DNG_StretchCol @ 0x1C00E9E18 (DNG_StretchCol.c)
 *     RenderNineGridInternal @ 0x1C00EA7E0 (RenderNineGridInternal.c)
 * Callees:
 *     DNG_StretchRow @ 0x1C00EB9EC (DNG_StretchRow.c)
    ...
    if ( *(_DWORD *)(a1 + 100) )
    {
      ...
      if ( v19 < v20 )
      {
        if ( *(_DWORD *)(a1 + 176) )
        {
          ...
          v40 = v20 - v19;
          v41 = (v19 - (int)v14) % v39;
          v42 = (_DWORD *)(v18 + 4LL * (v19 - (int)v14));
          v43 = v14;
          v44 = v39;
          v45 = v14 + v41;
          v46 = v39 - v41;
          ...
          v47 = (_DWORD *)(v4 + 4 * v45);
          v48 = v4 + 4 * v43;
          if ( v40 > 0 && (unsigned int)v40 < 0x3FFFFFFF && v44 < 0x3FFFFFFF )
          {
            v49 = &v42[v40];
            if ( v42 < v49
              && *(_QWORD *)(a1 + 216) <= (unsigned __int64)v42
              && (unsigned __int64)v49 <= *(_QWORD *)(a1 + 224) )
            {
              v50 = v48 + 4LL * (int)v44;
              if ( v48 < v50 && *(_QWORD *)(a1 + 232) <= v48 && v50 <= *(_QWORD *)(a1 + 240) && v39 >= 0 && v19 < v20 )
              {
                v51 = v40;
                do
                {
