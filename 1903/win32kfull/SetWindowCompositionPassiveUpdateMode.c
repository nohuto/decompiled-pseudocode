/*
 * XREFs of SetWindowCompositionPassiveUpdateMode @ 0x1C0160FBC
 * Callers:
...
__int64 __fastcall SetWindowCompositionPassiveUpdateMode(__int64 *a1, __int128 *a2)
{
  ...
  {
    v6 = *(_DWORD *)a2 != 0;
    if ( -__CFSHR__(v12[0], 16) == v6 )
      return 0;
    v12[0] = v12[0] & 0xFFFF7FFF | (v6 << 15);
    ...
    else
    {
      ...
      return (unsigned int)DwmAsyncSetCompositionAttribute(v10, *a1, 25, a2);
    }
  }
  return v4;
}
