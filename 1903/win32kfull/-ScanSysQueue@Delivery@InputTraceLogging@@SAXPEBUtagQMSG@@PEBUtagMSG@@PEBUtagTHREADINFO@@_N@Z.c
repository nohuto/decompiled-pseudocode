/*
 * XREFs of ?ScanSysQueue@Delivery@InputTraceLogging@@SAXPEBUtagQMSG@@PEBUtagMSG@@PEBUtagTHREADINFO@@_N@Z @ 0x1C00244D0
 * Callers:
  ...
  if ( (unsigned int)IsPointerInputMessage(*((unsigned int *)a2 + 2)) )
  {
    ...
    if ( v10 == 1 )
    {
      if ( dword_1C03222C0 > 4u && TlgKeywordOn((TraceLoggingHProvider)&dword_1C03222C0, 0x10uLL) )
      {
        ...
        v40 = (v14 >> 28) & 1;
        v72 = v11;
        TlgWrite((TraceLoggingHProvider)&dword_1C03222C0, &unk_1C02E6FF2, 0LL, 0LL, 0xEu, &pData);
      }
    }
    else if ( dword_1C03222C0 > 4u && TlgKeywordOn((TraceLoggingHProvider)&dword_1C03222C0, 0x10uLL) )
    {
      ...
      v76 = v16;
      TlgWrite((TraceLoggingHProvider)&dword_1C03222C0, &unk_1C02E70BE, 0LL, 0LL, cData, &pData);
    }
  }
  else if ( InputTraceLogging::IsMouseInputMessage(v8) )
  {
    if ( dword_1C03222C0 > 4u )
    {
      if ( TlgKeywordOn((TraceLoggingHProvider)&dword_1C03222C0, 0x10uLL) )
      {
        ...
        v36 = (v20 - 15) & (v24 >> 28);
        v70 = v21;
        TlgWrite((TraceLoggingHProvider)&dword_1C03222C0, &unk_1C02E71A7, 0LL, 0LL, 0xDu, &pData);
      }
    }
  }
  else if ( (unsigned int)(v9 - 256) > 9 )
  {
    if ( v9 == 255 && dword_1C03222C0 > 4u )
    {
      if ( TlgKeywordOn((TraceLoggingHProvider)&dword_1C03222C0, 0x10uLL) )
      {
        v34 = v33[2];
        ...
        v68 = v32;
        v70 = v32;
        TlgWrite((TraceLoggingHProvider)&dword_1C03222C0, &unk_1C02E731A, 0LL, 0LL, 0xDu, &pData);
      }
    }
  }
  else if ( dword_1C03222C0 > 4u )
  {
    if ( TlgKeywordOn((TraceLoggingHProvider)&dword_1C03222C0, 0x10uLL) )
    {
      v30 = *((_DWORD *)a3 + 306);
      ...
      v36 = (v26 - 15) & (v30 >> 28);
      v66 = v27;
      TlgWrite((TraceLoggingHProvider)&dword_1C03222C0, &unk_1C02E7267, 0LL, 0LL, 0xBu, &pData);
    }
  }
}
