/*
 * XREFs of ?zzzInternalSetSystemCursor@@YAXPEAUtagCURSOR@@IPEAU_UNICODE_STRING@@W4InputTracing_SetSystemCursorReason@@@Z @ 0x1C00B834C
 * Callers:
...
char __fastcall zzzInternalSetSystemCursor(__int64 a1, unsigned int a2, const struct _UNICODE_STRING *a3, int a4)
{
  ...
  if ( dword_1C03222C0 > 5u && TlgKeywordOn((TraceLoggingHProvider)&dword_1C03222C0, 8uLL) )
  {
    ...
    TlgWrite((TraceLoggingHProvider)&dword_1C03222C0, &unk_1C02E53ED, 0LL, 0LL, 0x12u, &pData);
  }
  ...
  if ( result && v16 )
  {
    while ( 1 )
    {
      ...
      {
        result = TlgKeywordOn((TraceLoggingHProvider)&dword_1C03222C0, 8uLL);
        if ( result )
        {
          v42 = *(_DWORD *)(v16 + 80) & 8;
          if ( v42 )
          ...
          *(_QWORD *)&v70.Size = 8LL;
          ...
          v56 = v55;
          v90 = 4LL;
          result = TlgWrite((TraceLoggingHProvider)&dword_1C03222C0, &unk_1C02E549F, 0LL, 0LL, 0xEu, &pData);
        }
      }
    }
  }
