/*
 * XREFs of xxxReceiveMessage @ 0x1C009E8D0
 * Callers:
...
int __fastcall xxxReceiveMessage(__int64 a1)
{
  ...
  __int64 *v100; // rax
  _DWORD *v101; // rax
  __int64 v103; // [rsp+50h] [rbp-1A8h]
  int v104; // [rsp+58h] [rbp-1A0h]
  __int64 v105; // [rsp+60h] [rbp-198h] BYREF
  __int64 v106; // [rsp+68h] [rbp-190h] BYREF
  unsigned int v107; // [rsp+70h] [rbp-188h]
  __int64 v108; // [rsp+78h] [rbp-180h] BYREF
  ULONG_PTR BugCheckParameter3; // [rsp+80h] [rbp-178h]
  __int64 v110; // [rsp+88h] [rbp-170h] BYREF
  __int64 v111; // [rsp+90h] [rbp-168h]
  __int64 v112; // [rsp+98h] [rbp-160h]
  int v113[2]; // [rsp+A0h] [rbp-158h] BYREF
  __int64 v114; // [rsp+A8h] [rbp-150h]
  __int64 v115; // [rsp+B0h] [rbp-148h] BYREF
  _QWORD *v116; // [rsp+B8h] [rbp-140h]
  __int64 v117; // [rsp+C0h] [rbp-138h]
  __int64 v118; // [rsp+C8h] [rbp-130h] BYREF
  _QWORD *v119; // [rsp+D0h] [rbp-128h]
  __int64 v120; // [rsp+D8h] [rbp-120h]
  __int64 v121; // [rsp+E0h] [rbp-118h] BYREF
  __int64 v122; // [rsp+E8h] [rbp-110h]
  __int64 v123; // [rsp+F0h] [rbp-108h]
  __int64 v124[3]; // [rsp+F8h] [rbp-100h] BYREF
  __int64 v125[2]; // [rsp+110h] [rbp-E8h] BYREF
  int v126; // [rsp+120h] [rbp-D8h]
  __int64 v127; // [rsp+128h] [rbp-D0h]
  _QWORD *v128; // [rsp+130h] [rbp-C8h]
  __int64 v129[3]; // [rsp+138h] [rbp-C0h] BYREF
  int v130; // [rsp+150h] [rbp-A8h]
  __int64 v131; // [rsp+158h] [rbp-A0h]
  _QWORD *v132; // [rsp+160h] [rbp-98h]
  _DWORD v133[2]; // [rsp+168h] [rbp-90h] BYREF
  __int64 v134; // [rsp+170h] [rbp-88h]
  __int64 v135; // [rsp+178h] [rbp-80h]
  __int64 v136; // [rsp+180h] [rbp-78h]
  __int128 v137; // [rsp+188h] [rbp-70h]
  __m128i v138; // [rsp+1A0h] [rbp-58h] BYREF
  __m128i v139; // [rsp+1B0h] [rbp-48h]
  __int64 v140; // [rsp+1C0h] [rbp-38h]
  ...
  *((_DWORD *)v6 + 21) |= 0x4010u;
  ...
  if ( (v14 & 0x200) != 0 )
  {
    if ( !v12 )
    {
      ...
      v110 = *(_QWORD *)(ThreadWin32Thread + 408);
      *(_QWORD *)(ThreadWin32Thread + 408) = &v110;
      v111 = v15;
      if ( v15 )
        HMLockObject(v15);
    }
  ...
  if ( (v14 & 7) == 0 )
  {
    ...
    **(_DWORD **)(a1 + 440) |= 8u;
    ...
    {
      v28 = v6[14];
      v29 = W32GetThreadWin32Thread((__int64)KeGetCurrentThread(), v9, v10, v11);
      v9 = *(_QWORD *)(v29 + 408);
      v110 = v9;
      *(_QWORD *)(v29 + 408) = &v110;
      v111 = v28;
      ...
      switch ( (int)v34 )
      {
        ...
        case 1:
          if ( !v33 )
            goto LABEL_72;
          v138 = *v33;
          v139.m128i_i64[0] = v33[1].m128i_i64[0];
          if ( (unsigned int)(_mm_cvtsi128_si32(v138) - 512) > 0xE )
            goto LABEL_49;
          ...
          {
LABEL_47:
            v105 = *(__int64 *)((char *)v138.m128i_i64 + 4);
            LogicalToPhysicalDPIPoint(&v105, &v105, v36, 0LL);
            v44 = PsGetCurrentProcessWin32Process(v43, v42);
            PhysicalToLogicalDPIPoint(&v105, &v105, *(unsigned int *)(v44 + 280), 0LL);
            *(__int64 *)((char *)v138.m128i_i64 + 4) = v105;
          }
          goto LABEL_48;
        case 2:
        case 10:
        ...
        case 7:
          ...
          {
LABEL_60:
            LogicalToPhysicalDPIPoint(&v138, &v138, v47, 0LL);
            v55 = PsGetCurrentProcessWin32Process(v54, v53);
            PhysicalToLogicalDPIPoint(&v138, &v138, *(unsigned int *)(v55 + 280), 0LL);
          }
LABEL_48:
          v32 = v103;
          goto LABEL_49;
        ...
        case 14:
          ...
          if ( v33 )
          {
            ...
            if ( *(_DWORD *)(v103 + 24) != -1 )
            {
              v57 = CheckAccess(v103 + 24, *(_QWORD *)(a1 + 416) + 872LL);
              v32 = v103;
              if ( !v57 )
                v138.m128i_i32[3] |= 2u;
            }
...
LABEL_72:
      ...
      v108 = xxxCallHook2(*(struct tagHOOK **)v32, *(_DWORD *)(v32 + 8), v6[11], (__int64)v45, v113, 0);
      v58 = v107;
      if ( v107 - 13 <= 1 )
      {
        *(_QWORD *)(a1 + 1360) = v30;
      ...
      if ( (int)v58 <= 1 )
      {
        if ( (unsigned int)(v138.m128i_i32[0] - 512) <= 0xE )
        {
          ...
          {
LABEL_114:
            v106 = *(__int64 *)((char *)v138.m128i_i64 + 4);
            v80 = PsGetCurrentProcessWin32Process(v75, v9);
            LogicalToPhysicalDPIPoint(&v106, &v106, *(unsigned int *)(v80 + 280), 0LL);
            PhysicalToLogicalDPIPoint(&v106, &v106, *((unsigned int *)v6 + 33), 0LL);
            *(__int64 *)((char *)v138.m128i_i64 + 4) = v106;
          }
        }
      }
      else
...
LABEL_103:
            ...
            LogicalToPhysicalDPIPoint(&v138, &v138, *(unsigned int *)(v74 + 280), 0LL);
            PhysicalToLogicalDPIPoint(&v138, &v138, *((unsigned int *)v6 + 33), 0LL);
          }
          *v33 = v138;
          v33[1] = v139;
          v33[2].m128i_i64[0] = v140;
          goto LABEL_83;
        }
        if ( (_DWORD)v58 != 13 )
        {
      ...
      *v33 = v138;
      v33[1].m128i_i64[0] = v139.m128i_i64[0];
    }
    else
    {
      v107 = *(_DWORD *)(gptiCurrent + 1412LL);
      *(_DWORD *)(gptiCurrent + 1412LL) = *((_DWORD *)v6 + 32);
      ...
      if ( (*(_BYTE *)(v82[5] + 18LL) & 4) != 0 )
      {
        ...
        v86 = 0;
        v87 = W32GetThreadWin32Thread((__int64)KeGetCurrentThread(), v85, v84, v83);
        v115 = *(_QWORD *)(v87 + 408);
        *(_QWORD *)(v87 + 408) = &v115;
        v116 = v82;
        HMLockObject(v82);
        v91 = *((unsigned int *)v6 + 26);
        if ( (unsigned int)v91 < 0x400 )
        {
          v88 = 512LL;
          if ( (MessageTable[v91] & 0x200) != 0 || (_DWORD)v91 == 537 && (v6[11] & 0x8000LL) != 0 )
          {
            *((_DWORD *)v6 + 21) |= 0x20u;
            if ( v12 )
            {
              v86 = 1;
              v92 = *(void **)v12;
              PushW32ThreadLock(*(_QWORD *)v12, v124, (__int64)DereferenceKernelStack, v90);
              ObfReferenceObject(v92);
              PsReferenceKernelStack(v92);
            }
          }
        }
        v93 = v6[14];
        v94 = *(_QWORD *)(*(_QWORD *)(v93 + 40) + 120LL);
        if ( v94 < 7 )
          v108 = ((__int64 (__fastcall *)(__int64, _QWORD, _QWORD, _QWORD))(&gServerHandlers)[v94])(
                   v93,
                   *((unsigned int *)v6 + 26),
                   v6[11],
                   v6[12]);
      ...
      else
      {
        ...
        v95 = 0LL;
        if ( !(unsigned int)IsThreadCrossSessionAttached(gpKernelHandleTable, v85, v84, v83) )
        {
          v96 = (__int64 *)PsGetThreadWin32Thread(BugCheckParameter3);
          if ( v96 )
            v95 = *v96;
        }
        v118 = *(_QWORD *)(v95 + 408);
        ...
        *v97 |= 0x10u;
        xxxSendMessageToClient(
          ...
          *((_DWORD *)v6 + 26),
          ...
          &v108);
        v93 = gptiCurrent;
        v88 = *(_QWORD *)(gptiCurrent + 440LL);
        *(_DWORD *)v88 ^= ((unsigned __int8)*(_DWORD *)v88 ^ (unsigned __int8)v98) & 0x10;
      }
      ThreadUnlock1(v93, v88, v89);
        ...
        && (*((_DWORD *)v6 + 21) & 4) == 0 )
      {
        ...
        if ( (unsigned int)v9 >= 0x400
          ...
          || (v99 = v6[14]) != 0 && (*(_BYTE *)(*(_QWORD *)(v99 + 40) + 18LL) & 4) == 0 )
        {
          v100 = (__int64 *)v6[14];
          if ( v100 )
            v131 = *v100;
          ...
          v129[0] = v108;
          v132 = v6;
          xxxCallHook(0, 1uLL, (__int64)v129, 12);
        }
      }
      *(_DWORD *)(gptiCurrent + 1412LL) = v107;
    }
LABEL_83:
    v27 = v104;
LABEL_84:
    ...
    if ( (*((_DWORD *)v6 + 21) & 0x101) == 0x100 )
    {
      ...
      *((_DWORD *)v6 + 21) = v59;
      if ( (v59 & 4) == 0 )
      {
        ...
        v136 = v108;
        v61 = v6[14];
        v62 = W32GetThreadWin32Thread((__int64)KeGetCurrentThread(), v9, v10, v11);
        v121 = *(_QWORD *)(v62 + 408);
        *(_QWORD *)(v62 + 408) = &v121;
        v122 = v61;
        if ( v61 )
