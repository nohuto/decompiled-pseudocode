/*
 * XREFs of ?SPISetIconMetrics@@YAHPEAU_UNICODE_STRING@@PEAUtagICONMETRICSW@@H@Z @ 0x1C01D957C
 * Callers:
 ...
 *     ?RescaleIconMetrics@@YAXPEAUtagICONMETRICSW@@@Z @ 0x1C01D9128 (-RescaleIconMetrics@@YAXPEAUtagICONMETRICSW@@@Z.c)
