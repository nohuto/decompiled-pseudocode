/*
 * XREFs of ?SetDeviceComponentResolution@InteractiveControlManager@@QEAAJKW4_INTERACTIVECTRL_COMPONENT_TYPE@@JPEAW4tagINTERACTIVECTRL_HAPTICS_MODE@@@Z @ 0x1C024F0DC
 * Callers:
        ...
        __int64 a5)
{
  ...
  if ( dword_1C0321308 > 4u )
  {
    ...
    v14 = a4;
    v28 = 4;
    TlgWrite((TraceLoggingHProvider)&dword_1C0321308, &unk_1C02E8F0E, 0LL, 0LL, 6u, &pData);
    result = v13;
  }
  v10 = (__int64 *)(a1 + 40);
  v11 = 5LL;
