/*
 * XREFs of ?_InternalGetIconInfo@@YA_NPEAUtagCURSOR@@PEAU_ICONINFO@@PEAU_UNICODE_STRING@@2PEAK_N@Z @ 0x1C002FB20
 * Callers:
        ...
        bool a6)
{
  ...
  *(_QWORD *)v22 = GreCreateBitmap(v8, v10, 1LL, 1LL, 0LL);
  ...
  v24 = GreSelectBitmap(ghdcMem2);
  v25 = GreSelectBitmap(ghdcMem);
  if ( b )
  {
    v18 = *((_QWORD *)v7 + 12);
    if ( !v18 || a6 )
