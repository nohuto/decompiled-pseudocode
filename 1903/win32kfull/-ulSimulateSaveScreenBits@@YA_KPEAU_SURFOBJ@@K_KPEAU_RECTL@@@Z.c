/*
 * XREFs of ?ulSimulateSaveScreenBits@@YA_KPEAU_SURFOBJ@@K_KPEAU_RECTL@@@Z @ 0x1C02A0120
 * Callers:
  ...
  else
  {
    ...
    if ( v12 )
    {
      ...
      if ( (*(_DWORD *)(SURFOBJ_TO_SURFACE(v12) + 112) & 0x400) != 0 )
        (*((void (__fastcall **)(__int64, struct _SURFOBJ *, _QWORD, _QWORD, __int64 *, struct _RECTL *))hdev + 355))(
          v13,
          a1,
          0LL,
          0LL,
        ...
        ((void (__fastcall *)(__int64, struct _SURFOBJ *, _QWORD, _QWORD, __int64 *, struct _RECTL *))EngCopyBits)(
          v13,
          a1,
          0LL,
          0LL,
