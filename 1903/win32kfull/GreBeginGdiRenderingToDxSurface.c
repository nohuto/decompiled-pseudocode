/*
 * XREFs of GreBeginGdiRenderingToDxSurface @ 0x1C011D7B4
 * Callers:
 *     NtGdiBeginGdiRendering @ 0x1C011D7A0 (NtGdiBeginGdiRendering.c)
 * Callees:
 ...
 *     ?bReset@DC@@QEAAHXZ @ 0x1C011D8B4 (-bReset@DC@@QEAAHXZ.c)
