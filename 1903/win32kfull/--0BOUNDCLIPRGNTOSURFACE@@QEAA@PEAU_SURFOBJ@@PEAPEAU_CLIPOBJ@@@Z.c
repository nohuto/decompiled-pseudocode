/*
 * XREFs of ??0BOUNDCLIPRGNTOSURFACE@@QEAA@PEAU_SURFOBJ@@PEAPEAU_CLIPOBJ@@@Z @ 0x1C014C120
 * Callers:
 ...
 *     ?bContain@ERECTL@@QEBAHAEBU_RECTL@@@Z @ 0x1C014C1E8 (-bContain@ERECTL@@QEBAHAEBU_RECTL@@@Z.c)
