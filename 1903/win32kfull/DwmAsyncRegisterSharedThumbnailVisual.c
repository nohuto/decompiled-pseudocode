/*
 * XREFs of DwmAsyncRegisterSharedThumbnailVisual @ 0x1C000A32C
 * Callers:
 *     DwmAsyncRegisterSharedThumbnailVisualApiExt @ 0x1C000A2F0 (DwmAsyncRegisterSharedThumbnailVisualApiExt.c)
 * Callees:
