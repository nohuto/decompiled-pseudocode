 ...
 * Callees:
 *     FD6DivL @ 0x1C003A224 (FD6DivL.c)
 *     FractionToMantissa @ 0x1C003A390 (FractionToMantissa.c)
 */
...
__int64 __fastcall Log(__int64 a1)
{
  ...
  if ( (_DWORD)v4 )
    v3 += FractionToMantissa(v4, (unsigned int)dword_1C02E2ED0[v2]);
