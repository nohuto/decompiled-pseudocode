/*
 * XREFs of OffGradientFill @ 0x1C015386C
 * Callers:
...
__int64 __fastcall OffGradientFill(
        __int64 (__fastcall *a1)(__int64, struct _CLIPOBJ *, __int64, _DWORD *, unsigned int, __int64, int, __int64 *, __int64 *, int),
        LONG *a2,
        __int64 a3,
        struct _CLIPOBJ *a4,
        __int64 a5,
        ...
        int a12)
{
  ...
  __int64 (__fastcall *v28)(__int64, struct _CLIPOBJ *, __int64, _DWORD *, unsigned int, __int64, int, __int64 *, __int64 *, int); // [rsp+80h] [rbp-21h]
  ...
  if ( a10 )
  {
    ...
    LODWORD(v30) = v14 + *((_DWORD *)a10 + 2);
    HIDWORD(v29) = v12 + *((_DWORD *)a10 + 1);
    v17 = &v29;
    HIDWORD(v30) = v12 + *((_DWORD *)a10 + 3);
  }
  v24 = 0LL;
  if ( a11 )
  {
