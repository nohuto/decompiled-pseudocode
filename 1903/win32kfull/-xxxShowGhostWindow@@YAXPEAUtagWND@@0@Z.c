/*
 * XREFs of ?xxxShowGhostWindow@@YAXPEAUtagWND@@0@Z @ 0x1C0150CA4
 * Callers:
...
void __fastcall xxxShowGhostWindow(struct tagWND *a1, struct tagWND *a2)
{
  ...
  if ( (v7 & 0x20) != 0 )
    ...
    v2 = (v7 & 1) != 0;
  v8 = *((_QWORD *)a2 + 2);
  if ( v8 && (v9 = *(_QWORD *)(v8 + 424), v9 == gpqForeground) && *(struct tagWND **)(v9 + 128) == a2 )
  {
    v10 = 96;
...
LABEL_16:
  ...
  if ( !gdwDeferWinEvent )
    v12 = 1;
  xxxWindowEvent(0x8003u, a2, 0LL, 0LL, v12);
