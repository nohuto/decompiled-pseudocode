/*
 * XREFs of ?InvalidateInputQueues@CInputQueueProp@@IEAAXXZ @ 0x1C01303AC
 * Callers:
 *     ?Delete@CInputQueueProp@@UEAAXXZ @ 0x1C0130380 (-Delete@CInputQueueProp@@UEAAXXZ.c)
 * Callees:
 *     ?Reset@?$CDynamicArray@PEAVIInputQueue@@$0HHHAHDFF@@@QEAAX_N@Z @ 0x1C0130434 (-Reset@-$CDynamicArray@PEAVIInputQueue@@$0HHHAHDFF@@@QEAAX_N@Z.c)
