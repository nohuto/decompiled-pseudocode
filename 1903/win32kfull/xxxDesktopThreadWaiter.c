/*
 * XREFs of xxxDesktopThreadWaiter @ 0x1C000E508
 * Callers:
 ...
 *     SleepInputIdle @ 0x1C000E6E0 (SleepInputIdle.c)
 *     xxxRemoveQueueCompletion @ 0x1C000E76C (xxxRemoveQueueCompletion.c)
 *     zzzWakeInputIdle @ 0x1C000E874 (zzzWakeInputIdle.c)
...
__int64 __fastcall xxxDesktopThreadWaiter(char a1, char a2)
{
  ...
  v4 = (LegacyInputDispatcher *)qword_1C032E068;
  if ( gptiCurrent == gTermIO[2] )
    v4 = (LegacyInputDispatcher *)qword_1C032C638;
  v5 = *((_DWORD *)v4 + 15);
  v6 = 0;
  if ( a1 )
  {
