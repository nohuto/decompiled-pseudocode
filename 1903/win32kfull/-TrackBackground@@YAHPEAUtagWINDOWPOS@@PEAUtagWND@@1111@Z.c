/*
 * XREFs of ?TrackBackground@@YAHPEAUtagWINDOWPOS@@PEAUtagWND@@1111@Z @ 0x1C0089D9C
 * Callers:
 *     ?TrackZorder@@YAPEAUtagWND@@PEAUtagWINDOWPOS@@PEAU1@11PEAPEAUHWND__@@2@Z @ 0x1C0089CB8 (-TrackZorder@@YAPEAUtagWND@@PEAUtagWINDOWPOS@@PEAU1@11PEAPEAUHWND__@@2@Z.c)
 * Callees:
 ...
 *     ?IsLastTopMostWindow@@YAHPEBUtagWND@@@Z @ 0x1C013C9C0 (-IsLastTopMostWindow@@YAHPEBUtagWND@@@Z.c)
 */
        ...
        struct tagWND *a6)
{
  ...
  {
    if ( !a6 || *(_QWORD *)(*((_QWORD *)a2 + 2) + 424LL) != gpqForeground || !(unsigned int)IsLastTopMostWindow(v7) )
    {
      if ( !(unsigned int)IsLastTopMostWindow(v7) && a5 == GetRootOwner(a2) )
      {
        ...
        if ( *(_QWORD *)(v12 + 1392) )
        {
          if ( *(_QWORD *)(v12 + 424) == gpqForeground && a5 == *(struct tagWND **)(gpqForeground + 128LL) )
