/*
 * XREFs of ?TraceLoggingPTPKeyToGestureTiming@@YAX_J0PEBUtagTPTELEMTIMINGS@@00@Z @ 0x1C01CE578
 * Callers:
        ...
        __int64 a5)
{
  ...
  if ( hProvider > 5u )
  {
    if ( TlgKeywordOn((TraceLoggingHProvider)&hProvider, 0x200000000000uLL) )
    {
      ...
      v58 = 0;
      v57 = 4;
      TlgWrite((TraceLoggingHProvider)&hProvider, &unk_1C02E6278, 0LL, 0LL, 0xDu, &pData);
    }
  }
}
