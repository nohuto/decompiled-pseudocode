/*
 * XREFs of ?MulGradientFill@@YAHPEAU_SURFOBJ@@PEAU_CLIPOBJ@@PEAU_XLATEOBJ@@PEAU_TRIVERTEX@@KPEAXKPEAU_RECTL@@PEAU_POINTL@@K@Z @ 0x1C029C990
 * Callers:
 *     <none>
 * Callees:
        ...
        ULONG ulMode)
{
  ...
  for ( i = MSURF::bFindSurface((MSURF *)v33, a1, a2, a8); i; i = MSURF::bNextSurface((MSURF *)v33) )
  {
    ...
    if ( (*(_DWORD *)(SURFOBJ_TO_SURFACE_NOT_NULL(v35) + 112) & 0x20000) != 0 )
      ...
      v28 = EngGradientFill;
    v15 &= OffGradientFill(
             (__int64 (__fastcall *)(__int64, struct _CLIPOBJ *, __int64, _DWORD *, unsigned int, __int64, int, __int64 *, __int64 *, int))v28,
             v37,
             v35,
             v36,
             (__int64)v19,
