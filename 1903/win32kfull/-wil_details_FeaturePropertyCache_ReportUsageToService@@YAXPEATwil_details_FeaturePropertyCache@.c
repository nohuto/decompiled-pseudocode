/*
 * XREFs of ?wil_details_FeaturePropertyCache_ReportUsageToService@@YAXPEATwil_details_FeaturePropertyCache@@IPEBUFEATURE_LOGGED_TRAITS@@HW4wil_ReportingKind@@_K@Z @ 0x1C00E413C
 * Callers:
 *     InitModuleAllocations @ 0x1C00E0C00 (InitModuleAllocations.c)
 *     InitRotationManager @ 0x1C00E0CD0 (InitRotationManager.c)
 *     ??0InkProcessor@@AEAA@XZ @ 0x1C00E0DB0 (--0InkProcessor@@AEAA@XZ.c)
 *     DispBrokerGetCurrentModeImpl @ 0x1C00E3D80 (DispBrokerGetCurrentModeImpl.c)
 ...
 *     DCompSessionInitialize @ 0x1C03821E0 (DCompSessionInitialize.c)
 * Callees:
