/*
 * XREFs of ?CreateW32Job@@YAPEAUtagW32JOB@@PEAU_EJOB@@@Z @ 0x1C013645C
 * Callers:
...
struct tagW32JOB *__fastcall CreateW32Job(struct _EJOB *a1, int a2)
{
  ...
  if ( WPP_RECORDER_INITIALIZED != (_UNKNOWN *)&WPP_RECORDER_INITIALIZED )
    WPP_RECORDER_SF_q((_DWORD)a1, a2, 0xDu, 0xFu, (__int64)&WPP_f3f8cf549e503a6a86e4761750732b2d_Traceguids, a1);
