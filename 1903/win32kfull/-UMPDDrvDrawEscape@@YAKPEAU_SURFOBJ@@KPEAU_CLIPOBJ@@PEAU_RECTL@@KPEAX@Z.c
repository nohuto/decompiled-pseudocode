/*
 * XREFs of ?UMPDDrvDrawEscape@@YAKPEAU_SURFOBJ@@KPEAU_CLIPOBJ@@PEAU_RECTL@@KPEAX@Z @ 0x1C02A2F50
 * Callers:
 *     <none>
 * Callees:
...
LABEL_6:
      ...
      {
        if ( (unsigned int)UMPDOBJ::pso(v10, (UMPDOBJ *)((char *)v10 + 64), (struct _SURFOBJ **)&v24[3], v9) )
        {
                               ...
                               0LL) )
          {
            ...
            {
              LODWORD(Size) = 4;
              if ( (unsigned int)UMPDOBJ::Thunk(v10, v24, 72LL, &v16, Size) != -1 )
                v7 = v16;
            }
          }
        }
