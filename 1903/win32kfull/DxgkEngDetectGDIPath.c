/*
 * XREFs of DxgkEngDetectGDIPath @ 0x1C0274B80
 * Callers:
 *     <none>
 * Callees:
 ...
 *     ?OverlapCheck@@YAHPEAUHDEV__@@PEAUHRGN__@@@Z @ 0x1C0273BAC (-OverlapCheck@@YAHPEAUHDEV__@@PEAUHRGN__@@@Z.c)
 *     ?StateFlags@PDEVOBJ@@QEBAKXZ @ 0x1C0273C84 (-StateFlags@PDEVOBJ@@QEBAKXZ.c)
 */
