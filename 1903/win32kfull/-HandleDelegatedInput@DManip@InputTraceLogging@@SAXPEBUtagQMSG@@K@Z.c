/*
 * XREFs of ?HandleDelegatedInput@DManip@InputTraceLogging@@SAXPEBUtagQMSG@@K@Z @ 0x1C01E2318
 * Callers:
 ...
 *     ?DelegationResponseToString@InputTraceLogging@@CAPEBDK@Z @ 0x1C01E1A38 (-DelegationResponseToString@InputTraceLogging@@CAPEBDK@Z.c)
 */
...
void __fastcall InputTraceLogging::DManip::HandleDelegatedInput(const struct tagQMSG *a1, int a2)
{
  ...
  if ( IsPointerInputMessage(*((_DWORD *)a1 + 6)) )
  {
    if ( dword_1C03222C0 > 4u )
    {
      if ( TlgKeywordOn((TraceLoggingHProvider)&dword_1C03222C0, 0x1000uLL) )
      {
        ...
        TlgWrite((TraceLoggingHProvider)&dword_1C03222C0, &unk_1C02E7EF2, 0LL, 0LL, 8u, &pData);
      }
    }
  }
         ...
         && TlgKeywordOn((TraceLoggingHProvider)&dword_1C03222C0, 0x1000uLL) )
  {
    ...
    TlgCreateSz(&v25, v13);
    TlgWrite((TraceLoggingHProvider)&dword_1C03222C0, &unk_1C02E7F6A, 0LL, 0LL, 5u, &pData);
  }
}
