/*
 * XREFs of ?BuildDeviceAttributes@InteractiveControlParser@@CAJPEAU_INTERACTIVECTRL_CAPABILITIES@@PEAVInteractiveControlDevice@@@Z @ 0x1C02589BC
 * Callers:
  ...
  if ( *((_DWORD *)a1 + 18) )
  {
    ...
    if ( (int)result < 0 )
    {
      if ( dword_1C0321308 > 3u )
      {
        ...
        TlgWrite((TraceLoggingHProvider)&dword_1C0321308, &unk_1C02E9A16, 0LL, 0LL, 3u, &pData);
      }
      return 0LL;
    }
  }
