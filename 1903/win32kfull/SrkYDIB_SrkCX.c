/*
 * XREFs of SrkYDIB_SrkCX @ 0x1C00019C0
 * Callers:
  ...
  if ( *v10 )
  {
    ...
    do
    {
      ...
      if ( (v12 & 0x4000) != 0 )
      {
        ...
        v19[1] = (unsigned int)(v17 + v7 + 4096) >> 13;
        *v19 = (unsigned int)(v16 + v8 + 4096) >> 13;
        *(v19 - 1) = (unsigned int)(v18 + v9 + 4096) >> 13;
        v8 = *(_DWORD *)&result[4 * HIBYTE(v13)] - v16;
        v19 += 3;
        v7 = *(_DWORD *)&result[4 * v14] - v17;
