/*
 * XREFs of ?SecondaryHitTest@Mouse@InputTraceLogging@@SAXPEBUtagQMSG@@AEBUtagPOINT@@PEAUtagWND@@@Z @ 0x1C001E4D8
 * Callers:
    ...
    *(_OWORD *)pwsz_8 = *(_OWORD *)(WindowDetails + 16);
    ...
    if ( dword_1C03222C0 > 4u )
    {
      if ( TlgKeywordOn((TraceLoggingHProvider)&dword_1C03222C0, 0x40uLL) )
      {
        ...
        v58 = v13;
        v61 = v13;
        TlgWrite((TraceLoggingHProvider)&dword_1C03222C0, &unk_1C02E749E, 0LL, 0LL, 0x10u, &pData);
      }
    }
  }
}
