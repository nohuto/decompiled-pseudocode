/*
 * XREFs of UmfdQueryTrueTypeTable @ 0x1C0072F10
 * Callers:
 *     <none>
 * Callees:
        ...
        _DWORD *a8)
{
  ...
  if ( a8 )
    *a8 = 0;
  FontDriverDdiRequest::FontDriverDdiRequest(v15, 10LL);
  v25 = 0LL;
  ...
  v21 = a7;
  v23 = -1;
  v12 = UmfdClientSendAndWaitForCompletion(*(_DWORD *)(a1 + 8), (__int64)v15);
  v13 = v23;
  if ( v12 < 0 )
