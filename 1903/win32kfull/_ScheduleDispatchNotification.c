/*
 * XREFs of _ScheduleDispatchNotification @ 0x1C00FF110
 * Callers:
 *     <none>
 * Callees:
 ...
 *     ??1?$CLockExclusiveInUserCrit@VDLT_QUEUE@@@@QEAA@XZ @ 0x1C01E150C (--1-$CLockExclusiveInUserCrit@VDLT_QUEUE@@@@QEAA@XZ.c)
