/*
 * XREFs of TransformVectorWithInputTargetPrecedence @ 0x1C00ED6B8
 * Callers:
 *     EditionMouseSpeedHitTest @ 0x1C0026590 (EditionMouseSpeedHitTest.c)
 *     EditionPhysicalToLogicalDPIPointWithInputDestHint @ 0x1C00ECDE0 (EditionPhysicalToLogicalDPIPointWithInputDestHint.c)
 *     EditionGetLogicalPointForMouseCaptureButtonEvent @ 0x1C00ED640 (EditionGetLogicalPointForMouseCaptureButtonEvent.c)
 * Callees:
