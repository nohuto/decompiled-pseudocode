/*
 * XREFs of ?ProcessRangeInCache@@YAXPEAUtagMOUSE_PROMOTION_CACHE@@PEAUtagMOUSE_PROMOTION_ENTRY@@1HHH@Z @ 0x1C0207B28
 * Callers:
        ...
        int a6)
{
  ...
  *(_OWORD *)v15 = 0LL;
  ...
  if ( v11 )
    AppendMousePromotionQueue((struct tagMOUSE_PROMOTION_QUEUE *)&qword_1C032C2A0, v11, v10);
}
