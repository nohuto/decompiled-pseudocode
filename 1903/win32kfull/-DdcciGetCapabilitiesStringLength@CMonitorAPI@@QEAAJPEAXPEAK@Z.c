/*
 * XREFs of ?DdcciGetCapabilitiesStringLength@CMonitorAPI@@QEAAJPEAXPEAK@Z @ 0x1C026EB24
 * Callers:
 *     NtGdiDDCCIGetCapabilitiesStringLength @ 0x1C026F800 (NtGdiDDCCIGetCapabilitiesStringLength.c)
 * Callees:
