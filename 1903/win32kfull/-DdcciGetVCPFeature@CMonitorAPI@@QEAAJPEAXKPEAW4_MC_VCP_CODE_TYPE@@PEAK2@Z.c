/*
 * XREFs of ?DdcciGetVCPFeature@CMonitorAPI@@QEAAJPEAXKPEAW4_MC_VCP_CODE_TYPE@@PEAK2@Z @ 0x1C026ED98
 * Callers:
 *     NtGdiDDCCIGetVCPFeature @ 0x1C026F8E0 (NtGdiDDCCIGetVCPFeature.c)
 * Callees:
        ...
        unsigned int *a6)
{
  ...
  v13 = this;
  v6 = (char *)qword_1C032C788;
  OPM::CAutoMutex::CAutoMutex((OPM::CAutoMutex *)v12, (struct OPM::CMutex *)qword_1C032C788);
