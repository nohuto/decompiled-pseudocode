/*
 * XREFs of ??_GInteractiveControlInput@@QEAAPEAXI@Z @ 0x1C025326C
 * Callers:
 *     ?CleanQueue@InteractiveControlDevice@@QEAAXK@Z @ 0x1C02532F0 (-CleanQueue@InteractiveControlDevice@@QEAAXK@Z.c)
