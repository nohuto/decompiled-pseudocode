/*
 * XREFs of ?EndActiveCommandsByOwnerThread@InkFeedbackProviderBase@@UEAAXPEBX@Z @ 0x1C011EB20
 * Callers:
 *     <none>
 * Callees:
  ...
  while ( v4 != v2 )
  {
    ...
    if ( *((const void **)v6 + 3) == a2 )
    {
      if ( dword_1C0321298 > 4u )
      {
        ...
        v27 = v9;
        v28 = 8;
        TlgWrite((TraceLoggingHProvider)&dword_1C0321298, &unk_1C02E949D, 0LL, 0LL, 8u, &pData);
      }
