/*
 * XREFs of ?UnlinkAndFreeThreadPointerData@@YAXPEAUtagTHREADINPUTPOINTERLIST@@PEAUtagTHREADPOINTERDATA@@@Z @ 0x1C01F24F4
 * Callers:
 *     xxxCleanupThreadPointerInputInfo @ 0x1C010F290 (xxxCleanupThreadPointerInputInfo.c)
 *     EditionUnlinkAndFreeThreadPointerData @ 0x1C01F3140 (EditionUnlinkAndFreeThreadPointerData.c)
 * Callees:
 *     <none>
 */
