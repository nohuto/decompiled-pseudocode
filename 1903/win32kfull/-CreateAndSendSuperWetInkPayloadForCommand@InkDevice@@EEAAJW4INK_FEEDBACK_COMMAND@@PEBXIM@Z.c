/*
 * XREFs of ?CreateAndSendSuperWetInkPayloadForCommand@InkDevice@@EEAAJW4INK_FEEDBACK_COMMAND@@PEBXIM@Z @ 0x1C0250A40
 * Callers:
    ...
    if ( v11 >= 0 )
    {
      ...
      if ( v11 >= 0 )
      {
        if ( dword_1C0321298 > 4u )
        {
          ...
          v34 = 2LL;
          v36 = 72LL;
          TlgWrite((TraceLoggingHProvider)&dword_1C0321298, &unk_1C02E9680, 0LL, 0LL, 9u, &v23);
        }
      }
