/*
 * XREFs of xxxWaitForInputIdle @ 0x1C0132FA0
 * Callers:
 *     NtUserWaitForInputIdle @ 0x1C0132F40 (NtUserWaitForInputIdle.c)
 * Callees:
 ...
 *     WaitOnPseudoEvent @ 0x1C0133370 (WaitOnPseudoEvent.c)
 */
...
unsigned int __fastcall xxxWaitForInputIdle(HANDLE a1, unsigned int a2, int a3)
{
        ...
        if ( ProcessWin32Process )
        {
          ...
          if ( (v12 & 0x21) == 0x20 )
          {
            *(_DWORD *)(v11 + 12) = v12 | 0x20000;
            ...
            PushW32ThreadLock(v11, v21, (__int64)DereferenceW32Process, v10);
            ...
            *(_DWORD *)(v11 + 12) &= ~0x20000u;
            ...
            PopAndFreeW32ThreadLock((__int64)v21, v14, v16, v17);
            return v15;
          }
        }
  ...
  v20 = (__int64 *)gpwtiFirst;
  if ( !gpwtiFirst )
    return -1;
  do
  {
    if ( *((_DWORD *)v20 + 6) == (unsigned int)PsGetThreadProcessId((PETHREAD)*gptiCurrent) && (HANDLE)v20[2] == a1 )
      break;
    v20 = (__int64 *)*v20;
  }
  while ( v20 );
  if ( !v20 )
    return -1;
  result = WaitOnPseudoEvent(v20 + 4, a2);
  if ( result == 128 )
    return xxxPollAndWaitForSingleObject((PVOID)v20[4], 0LL, a2);
  return result;
}
