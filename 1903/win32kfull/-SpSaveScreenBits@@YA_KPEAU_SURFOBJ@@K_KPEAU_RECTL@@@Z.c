/*
 * XREFs of ?SpSaveScreenBits@@YA_KPEAU_SURFOBJ@@K_KPEAU_RECTL@@@Z @ 0x1C027CEE0
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall SpSaveScreenBits(struct _SURFOBJ *a1, unsigned int a2, __int64 a3, struct _RECTL *a4)
{
  ...
  HDEV v24; // [rsp+60h] [rbp-19h]
  struct _RECTL v25; // [rsp+68h] [rbp-11h]
      ...
      do
      {
        ...
        for ( i = *((_QWORD *)v12 + 3); i; i = *(_QWORD *)(i + 160) )
        {
          ...
          if ( (*(_DWORD *)(i + 184) & 0x1000000) != 0
            && (unsigned int)bIntersect(i + 4, a4, v15)
...
LABEL_18:
      ...
      v25 = v16;
      v24 = v17;
      v23 = GreTearDownSprites(v17, a4);
      v11 = (__int64 (__fastcall *)(struct _SURFOBJ *, _QWORD, __int64, struct _RECTL *))*((_QWORD *)hdev + 173);
LABEL_19:
      v5 = v11(v6, a2, v8, a4);
    }
  }
  DEVEXCLUDERECT::~DEVEXCLUDERECT((DEVEXCLUDERECT *)&v23);
  return v5;
}
