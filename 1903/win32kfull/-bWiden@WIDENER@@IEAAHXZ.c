/*
 * XREFs of ?bWiden@WIDENER@@IEAAHXZ @ 0x1C0119040
 * Callers:
 ...
 *     ?vPrependBeforeFigure@WIDEPATHOBJ@@QEAAXXZ @ 0x1C015C430 (-vPrependBeforeFigure@WIDEPATHOBJ@@QEAAXXZ.c)
 *     ?efNextStyleLength@STYLER@@IEAA?AVEFLOAT@@XZ @ 0x1C02C768C (-efNextStyleLength@STYLER@@IEAA-AVEFLOAT@@XZ.c)
 ...
 *     ?vPrependBeforeSubpath@WIDEPATHOBJ@@QEAAXXZ @ 0x1C02C7ACC (-vPrependBeforeSubpath@WIDEPATHOBJ@@QEAAXXZ.c)
 */
