/*
 * XREFs of ?GreHidePointerInternal@@YAXPEAUHDEV__@@@Z @ 0x1C014049C
 * Callers:
...
void __fastcall GreHidePointerInternal(_QWORD *a1)
{
  ...
  if ( (a1[5] & 0x20000) != 0 )
  {
    ...
    do
    {
      v6 = (_DWORD *)v4[6];
      if ( (v6[532] & 0x2000) == 0 )
        vMovePointer(v6, 0xFFFFFFFFLL, 0xFFFFFFFFLL, dword_1C032E030);
      v4 = (_QWORD *)*v4;
      --v5;
    }
    while ( v5 );
  ...
  {
    vMovePointer(a1, 0xFFFFFFFFLL, 0xFFFFFFFFLL, dword_1C032E030);
  }
  v2 = a1[8];
  *((_DWORD *)a1 + 18) = -1;
  *((_DWORD *)a1 + 19) = -1;
