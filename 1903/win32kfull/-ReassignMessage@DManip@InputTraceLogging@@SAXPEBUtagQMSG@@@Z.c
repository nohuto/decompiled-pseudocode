/*
 * XREFs of ?ReassignMessage@DManip@InputTraceLogging@@SAXPEBUtagQMSG@@@Z @ 0x1C01E2970
 * Callers:
...
void __fastcall InputTraceLogging::DManip::ReassignMessage(const struct tagQMSG *a1)
{
  ...
  if ( IsPointerInputMessage(*((_DWORD *)a1 + 6)) )
  {
    ...
    {
      if ( TlgKeywordOn((TraceLoggingHProvider)&dword_1C03222C0, 0x1000uLL) )
      {
        v5 = *(_QWORD *)(v4 + 136);
        v17 = 0;
        v20 = 0;
        ...
        v11 = v3;
        v28 = v2;
        TlgWrite((TraceLoggingHProvider)&dword_1C03222C0, &unk_1C02E7FB9, 0LL, 0LL, 7u, &pData);
      }
    }
  }
  else if ( InputTraceLogging::IsMouseInputMessage(v1)
         && dword_1C03222C0 > 4u
         && TlgKeywordOn((TraceLoggingHProvider)&dword_1C03222C0, 0x1000uLL) )
  {
    v9 = *(_QWORD *)(v8 + 136);
    v17 = 0;
    v20 = 0;
    ...
    v11 = v7;
    v19 = cData;
    TlgWrite((TraceLoggingHProvider)&dword_1C03222C0, &unk_1C02E8022, 0LL, 0LL, cData, &pData);
  }
}
