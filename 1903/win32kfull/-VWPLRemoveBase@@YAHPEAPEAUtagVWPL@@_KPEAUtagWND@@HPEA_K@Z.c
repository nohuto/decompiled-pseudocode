/*
 * XREFs of ?VWPLRemoveBase@@YAHPEAPEAUtagVWPL@@_KPEAUtagWND@@HPEA_K@Z @ 0x1C00CF914
 * Callers:
...
__int64 __fastcall VWPLRemoveBase(struct tagVWPL **a1, int a2, struct tagWND *a3, __int64 a4, unsigned __int64 *a5)
{
  unsigned int *v5; // rbx
  unsigned int v9; // ecx
