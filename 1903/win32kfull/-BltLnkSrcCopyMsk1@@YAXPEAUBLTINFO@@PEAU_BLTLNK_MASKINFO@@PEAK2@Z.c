/*
 * XREFs of ?BltLnkSrcCopyMsk1@@YAXPEAUBLTINFO@@PEAU_BLTLNK_MASKINFO@@PEAK2@Z @ 0x1C02D1E30
 * Callers:
 *     <none>
 * Callees:
 *     ?BltLnkReadPat1@@YAXPEAEKPEBEKKKK@Z @ 0x1C02D1900 (-BltLnkReadPat1@@YAXPEAEKPEBEKKKK@Z.c)
 */
        ...
        unsigned __int8 *a4)
{
  ...
  while ( v8 )
  {
    ...
    v30 = *((_DWORD *)a2 + 7);
    v16 = (unsigned __int8 *)(v4 + ((__int64)v12 >> 3));
    v31 = v12 & 7;
    if ( v14 != v31 )
    {
    ...
    BltLnkReadPat1(a3, v12, v11, *((_DWORD *)a2 + 6), v30, v13);
    if ( *((_BYTE *)a2 + 36) )
    {
      *a3 |= -1 << (8 - v31);
      a3[(unsigned __int64)(unsigned int)(v13 + v31) >> 3] |= 255 >> ((v13 + v12) & 7);
      if ( v13 > 0 )
      {
        v23 = a3 - v16;
        do
