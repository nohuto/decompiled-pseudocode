/*
 * XREFs of ?SendDeviceIOControl@SimpleHapticsController@@QEAAJKPEAXK0KPEAK@Z @ 0x1C0257888
 * Callers:
 ...
 *     ??0LeaveEnterUserCritIfAcquired@@QEAA@XZ @ 0x1C0256384 (--0LeaveEnterUserCritIfAcquired@@QEAA@XZ.c)
 */
...
LABEL_17:
  ...
  if ( (unsigned int)dword_1C03212D0 > 4 )
  {
    ...
    v18 = a2;
    v27 = 4;
    TlgWrite((TraceLoggingHProvider)&dword_1C03212D0, &unk_1C02E98BE, 0LL, 0LL, 4u, &pData);
  }
