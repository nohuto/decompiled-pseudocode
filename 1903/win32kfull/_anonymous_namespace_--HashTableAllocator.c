/*
 * XREFs of _anonymous_namespace_::HashTableAllocator @ 0x1C023DD10
 * Callers:
...
__int64 __fastcall anonymous_namespace_::HashTableAllocator(__int64 a1)
{
  return Win32AllocPool(a1, 1836541781LL);
}
