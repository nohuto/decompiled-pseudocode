/*
 * XREFs of ?JobCalloutTerminate@@YAHPEAUtagW32JOB@@@Z @ 0x1C013757C
 * Callers:
...
__int64 __fastcall JobCalloutTerminate(struct tagW32JOB *a1, int a2)
{
  ...
  if ( WPP_RECORDER_INITIALIZED != (_UNKNOWN *)&WPP_RECORDER_INITIALIZED )
    WPP_RECORDER_SF_q((_DWORD)a1, a2, 0xDu, 0x18u, (__int64)&WPP_f3f8cf549e503a6a86e4761750732b2d_Traceguids, a1);
  v3 = *((_QWORD *)a1 + 7);
  if ( v3 )
  {
    Win32FreePool(v3);
