/*
 * XREFs of ?vAddRoundEndCap@WIDEPENOBJ@@QEAAXAEAVWIDENER@@AEAVLINEDATA@@HH@Z @ 0x1C015A5EC
 * Callers:
 *     ?vAddEndCap@WIDENER@@IEAAXXZ @ 0x1C015A314 (-vAddEndCap@WIDENER@@IEAAXXZ.c)
 *     ?vAddStartCap@WIDENER@@IEAAXXZ @ 0x1C015A488 (-vAddStartCap@WIDENER@@IEAAXXZ.c)
 * Callees:
 *     ?vAddNice@@YAXAEAVWIDEPATHOBJ@@PEAU_POINTFIX@@PEAVEVECTORFX@@H@Z @ 0x1C015C8F0 (-vAddNice@@YAXAEAVWIDEPATHOBJ@@PEAU_POINTFIX@@PEAVEVECTORFX@@H@Z.c)
 */
...
void __fastcall WIDEPENOBJ::vAddRoundEndCap(WIDEPENOBJ *this, struct WIDENER *a2, struct LINEDATA *a3, int a4, int a5)
{
  ...
  for ( i = (struct EVECTORFX *)(v7 + 8); ; i = (struct EVECTORFX *)(v6 + 4) )
  {
    ...
    if ( i < v13 )
    {
      do
      {
        vAddNice((struct WIDENER *)((char *)a2 + 1136), (struct _POINTFIX *)((char *)a2 + 692), i, v8);
