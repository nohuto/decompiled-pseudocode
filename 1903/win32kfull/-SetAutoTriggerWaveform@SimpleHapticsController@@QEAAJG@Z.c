/*
 * XREFs of ?SetAutoTriggerWaveform@SimpleHapticsController@@QEAAJG@Z @ 0x1C0257E60
 * Callers:
...
__int64 __fastcall SimpleHapticsController::SetAutoTriggerWaveform(PHIDP_PREPARSED_DATA *this, unsigned __int16 a2)
{
  ...
  if ( (unsigned int)dword_1C03212D0 > 4 )
  {
    ...
    v20 = 2LL;
    TlgWrite((TraceLoggingHProvider)&dword_1C03212D0, &unk_1C02E98F5, 0LL, 0LL, 4u, &pData);
  }
