/*
 * XREFs of ?pSpReverseFindInZForPidLock@@YAPEAVSPRITE@@PEAV1@PEAU_RECTL@@@Z @ 0x1C01626FC
 * Callers:
 ...
 * Callees:
 *     ?bIsCursorSprite@@YAHPEAVSPRITE@@@Z @ 0x1C016275C (-bIsCursorSprite@@YAHPEAVSPRITE@@@Z.c)
 */
