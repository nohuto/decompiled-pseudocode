/*
 * XREFs of ?EnsureOemBitmapInfoForDpiSlot@@YAXPEAUOEMBITMAPSET@@I@Z @ 0x1C000BB28
 * Callers:
 ...
 * Callees:
 *     ?ArrangeFrameControls@@YAFHHPEAUOEMBITMAPSET@@@Z @ 0x1C000BCA4 (-ArrangeFrameControls@@YAFHHPEAUOEMBITMAPSET@@@Z.c)
