/*
 * XREFs of ?xxxUnadviseAck@@YAKPEAKPEA_JPEAUtagDDECONV@@@Z @ 0x1C020B3F0
 * Callers:
 *     <none>
 * Callees:
...
unsigned int __fastcall xxxUnadviseAck(unsigned int *a1, void **a2, struct tagDDECONV *a3)
{
  ...
  __int64 v9; // r8
  __int64 v10; // r9
  struct tagINTDDEINFO *v11; // [rsp+40h] [rbp+8h] BYREF
  ...
  v7 = xxxCopyAckIn(a1, v4, a3, &v11);
  if ( (*(_BYTE *)(_HMPheFromObject(a3) + 25) & 1) != 0 )
    v7 = 0;
  if ( v7 != 2 )
    return v7;
  PopState(a3, v8, v9, v10);
  return 2;
}
