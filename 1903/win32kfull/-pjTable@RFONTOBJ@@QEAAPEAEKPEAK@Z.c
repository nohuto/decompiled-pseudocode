/*
 * XREFs of ?pjTable@RFONTOBJ@@QEAAPEAEKPEAK@Z @ 0x1C02A18E0
 * Callers:
 *     FONTOBJ_pjOpenTypeTablePointer @ 0x1C028DAD0 (FONTOBJ_pjOpenTypeTablePointer.c)
 * Callees:
 ...
 *     ?pchTranslate@RFONTOBJ@@QEAAPEADPEBD@Z @ 0x1C02A1620 (-pchTranslate@RFONTOBJ@@QEAAPEADPEBD@Z.c)
 */
