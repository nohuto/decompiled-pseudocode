/*
 * XREFs of ?vPatXorRow8@@YAXPEAU_PATBLTFRAME@@JH@Z @ 0x1C02C0570
 * Callers:
 *     <none>
 * Callees:
 *     vFetchAndMerge @ 0x1C014DE0C (vFetchAndMerge.c)
 *     memset @ 0x1C0166840 (memset.c)
 *     vFetchShiftAndMerge @ 0x1C02D1160 (vFetchShiftAndMerge.c)
 */
