/*
 * XREFs of ??1SPRITEDDIACCESS@@QEAA@XZ @ 0x1C0043194
 * Callers:
...
void __fastcall SPRITEDDIACCESS::~SPRITEDDIACCESS(__int64 **this, __int64 a2, __int64 a3, __int64 a4)
{
  ...
  int v60; // ebx
  _OWORD *v61; // rcx
  __int128 v62; // [rsp+20h] [rbp-C8h]
  __int128 v63; // [rsp+30h] [rbp-B8h]
  __int128 v64; // [rsp+40h] [rbp-A8h]
  __int128 v65; // [rsp+50h] [rbp-98h]
  __int128 v66; // [rsp+60h] [rbp-88h]
  __int128 v67; // [rsp+70h] [rbp-78h]
  __int128 v68; // [rsp+80h] [rbp-68h]
  __int128 v69; // [rsp+90h] [rbp-58h]
  __int128 v70; // [rsp+A0h] [rbp-48h]
  __int128 v71; // [rsp+B0h] [rbp-38h]
  __int64 *v72; // [rsp+C0h] [rbp-28h]
  __int64 v73; // [rsp+F0h] [rbp+8h] BYREF
  ...
  if ( !*((_DWORD *)this + 2) )
  {
    ...
    if ( !(unsigned int)IsThreadCrossSessionAttached(this, a2, a3, a4)
      ...
      && (v8 = *v7) != 0
      && PDEVOBJ::bAllowShareAccess((PDEVOBJ *)&v73)
      && (*(_DWORD *)(v8 + 104) || *(_DWORD *)(v8 + 108)) )
    {
      ...
      *(_DWORD *)(*(_QWORD *)(v50 + 280) + 24LL) = *(_DWORD *)(*(_QWORD *)(v41 + 280) + 16LL);
      vSpTlSpriteStateDirectDriverAccess((struct _SPRITESTATE *)v5, 0);
    ...
    else
    {
      PDEVOBJ::bAllowShareAccess((PDEVOBJ *)&v73);
      v59 = *((_DWORD *)v5 + 25);
      *(_DWORD *)(SURFOBJ_TO_SURFACE_NOT_NULL(v5[4]) + 112) = v59;
      v60 = *((_DWORD *)v5 + 26);
      *(_WORD *)(SURFOBJ_TO_SURFACE_NOT_NULL(v5[4]) + 100) = v60;
      *((_DWORD *)v5 + 22) = 0;
    }
  }
  if ( *((_DWORD *)this + 3) == 1 )
  {
    ...
    v71 = *((_OWORD *)this + 10);
    v72 = this[22];
    v61 = *(_OWORD **)(W32GetThreadWin32Thread(KeGetCurrentThread()) + 280);
    *v61 = v62;
    v61[1] = v63;
    v61[2] = v64;
    v61[3] = v65;
