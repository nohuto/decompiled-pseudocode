/*
 * XREFs of ?FindLinkedGlyphDataPlus@RFONTOBJ@@QEAAPEAU_GLYPHDATA@@PEAVXDCOBJ@@PEAVESTROBJ@@GKKPEAHHH@Z @ 0x1C011F9B4
 * Callers:
        ...
        int a9)
{
  ...
  if ( !*(_DWORD *)(*(_QWORD *)a2 + 304LL) )
  {
    if ( a8 )
    {
      ...
      {
        if ( a4 >= gqlTTSystem && a4 <= (unsigned __int16)word_1C032E042 )
        {
          a3 = (struct ESTROBJ *)(0x80000000 >> ((a4 - gqlTTSystem) % 32));
          if ( ((unsigned int)a3 & *(_DWORD *)(qword_1C032E048 + 4LL * ((a4 - gqlTTSystem) / 32))) != 0 )
          {
