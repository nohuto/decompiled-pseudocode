/*
 * XREFs of HMValidateHandleNoRipNoIL @ 0x1C0259ED4
 * Callers:
...
__int64 __fastcall HMValidateHandleNoRipNoIL(__int64 a1, __int64 a2, __int64 a3, __int64 a4)
{
  ...
  if ( (*(_DWORD *)(W32GetThreadWin32Thread((__int64)KeGetCurrentThread(), v8, v7, v6) + 480) & 0x20000000) != 0 )
