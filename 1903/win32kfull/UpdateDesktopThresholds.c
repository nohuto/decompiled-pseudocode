/*
 * XREFs of UpdateDesktopThresholds @ 0x1C00E64F0
 * Callers:
...
__int64 UpdateDesktopThresholds()
{
  ...
  do
  {
    ...
    if ( v17 )
    {
      v6 = (unsigned int)dword_1C02E1D50[v5];
      v7 = (__int64 *)((char *)v2 + 16);
      v8 = (unsigned int)dword_1C02E1D60[v5];
      v9 = v5;
      v10 = (unsigned int)dword_1C02E1D70[v5];
      v11 = v17;
      v12 = (unsigned int)dword_1C02E1D80[v9];
      v13 = (unsigned int)dword_1C02E1D90[v9];
      v14 = (unsigned int)dword_1C02E1DA0[v9];
      do
      {
        v15 = *v7;
        v7 += 3;
