/*
 * XREFs of ?_TTUpdateRankWithSegment@@YAXJJJJPEAUtagPOINT@@PEAGUtagRECT@@PEBUtagTOUCHTARGETINGCONTACT@@@Z @ 0x1C025BA78
 * Callers:
 *     TouchTargetingRankForRect @ 0x1C025C430 (TouchTargetingRankForRect.c)
 * Callees:
 *     TouchTargetingIntersectSegment @ 0x1C025C214 (TouchTargetingIntersectSegment.c)
