/*
 * XREFs of ?MakePointerMessage@@YAH_KIPEAXPEA_KPEA_JPEAGPEAKPEAHPEAPEAUHWND__@@@Z @ 0x1C01F1FB0
 * Callers:
 *     PrepareSentPointerMessageForClient @ 0x1C01F095C (PrepareSentPointerMessageForClient.c)
 *     TranslateSentPointerMessageForClient @ 0x1C01F0AF4 (TranslateSentPointerMessageForClient.c)
 * Callees:
