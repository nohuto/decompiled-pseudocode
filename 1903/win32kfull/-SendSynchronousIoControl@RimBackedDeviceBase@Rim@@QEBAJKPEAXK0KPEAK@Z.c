/*
 * XREFs of ?SendSynchronousIoControl@RimBackedDeviceBase@Rim@@QEBAJKPEAXK0KPEAK@Z @ 0x1C023A390
 * Callers:
 ...
 *     SendSynchronousIoControl @ 0x1C023A49C (SendSynchronousIoControl.c)
 */
