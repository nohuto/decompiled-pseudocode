/*
 * XREFs of ?RedirTextOut@@YAHPEAU_SURFOBJ@@PEAU_STROBJ@@PEAU_FONTOBJ@@PEAU_CLIPOBJ@@PEAU_RECTL@@4PEAU_BRUSHOBJ@@5PEAU_POINTL@@K@Z @ 0x1C0297B50
 * Callers:
 *     <none>
 * Callees:
        ...
        if ( (v18 & 0x20000) != 0 )
        {
          for ( i = **(_QWORD ***)(v17 + 1800); i; i = (_QWORD *)*i )
          {
            ...
            if ( v20 )
            {
              ...
              {
                if ( *(_QWORD *)(*(_QWORD *)(v20 + 1792) + 248LL) )
                {
                  MARK_ACCDRV_NOTIFICATION::MARK_ACCDRV_NOTIFICATION(
                    (MARK_ACCDRV_NOTIFICATION *)&v24,
                    (struct PDEVOBJ *)&v35,
                    a1);
                  (*(void (__fastcall **)(struct _SURFOBJ *, STROBJ *, FONTOBJ *, CLIPOBJ *, RECTL *, RECTL *, BRUSHOBJ *, BRUSHOBJ *, POINTL *, MIX))(*(_QWORD *)(v21 + 1792) + 248LL))(
                    a1,
                    pstro,
                    pfo,
                    pco,
