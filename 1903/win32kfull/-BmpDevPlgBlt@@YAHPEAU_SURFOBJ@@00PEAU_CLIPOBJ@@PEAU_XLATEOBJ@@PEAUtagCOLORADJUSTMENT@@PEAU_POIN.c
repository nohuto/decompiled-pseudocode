/*
 * XREFs of ?BmpDevPlgBlt@@YAHPEAU_SURFOBJ@@00PEAU_CLIPOBJ@@PEAU_XLATEOBJ@@PEAUtagCOLORADJUSTMENT@@PEAU_POINTL@@PEAU_POINTFIX@@PEAU_RECTL@@4K@Z @ 0x1C0294430
 * Callers:
 *     <none>
 * Callees:
          ...
          do
          {
            ...
            if ( v20 )
            {
              if ( (*(_DWORD *)(v20 + 1824) & 0x8000000) != 0 )
              {
                ...
                {
                  if ( *(_QWORD *)(*(_QWORD *)(v20 + 1792) + 624LL) )
                  {
