/*
 * XREFs of ?UMPDDrvCopyBits@@YAHPEAU_SURFOBJ@@0PEAU_CLIPOBJ@@PEAU_XLATEOBJ@@PEAU_RECTL@@PEAU_POINTL@@@Z @ 0x1C0158D90
 * Callers:
 *     <none>
 * Callees:
...
LABEL_3:
    ...
    v32[4] = v9;
    v32[6] = a4;
    if ( !(unsigned int)UMPDOBJ::pso(v12, (UMPDOBJ *)((char *)v12 + 64), (struct _SURFOBJ **)&v32[3], v10)
      || !(unsigned int)UMPDOBJ::pso(v12, (UMPDOBJ *)((char *)v12 + 80), (struct _SURFOBJ **)&v32[4], v11)
      ...
      || (LODWORD(Size) = 4, (unsigned int)UMPDOBJ::Thunk(v12, v32, 72LL, &v18, Size) == -1)
      || (v13 = 1, !v18) )
    {
      v13 = 0;
    }
