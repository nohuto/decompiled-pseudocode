/*
 * XREFs of ?UpdateWaveformInfoList@SimpleHapticsController@@IEAAJGG@Z @ 0x1C0258528
 * Callers:
...
LABEL_5:
    if ( (unsigned int)dword_1C03212D0 > 4 )
    {
      ...
      v12 = 2LL;
      v14 = 2LL;
      TlgWrite((TraceLoggingHProvider)&dword_1C03212D0, &unk_1C02E9844, 0LL, 0LL, 5u, &pData);
    }
    return 3221226021LL;
  }
}
