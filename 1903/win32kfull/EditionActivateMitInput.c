/*
 * XREFs of EditionActivateMitInput @ 0x1C0111CE0
 * Callers:
 *     <none>
 * Callees:
 *     WaitForRitToCompleteLastCommand @ 0x1C0111DF0 (WaitForRitToCompleteLastCommand.c)
 *     WakeRIT @ 0x1C0111FF0 (WakeRIT.c)
 *     DitTakeOver @ 0x1C0112050 (DitTakeOver.c)
 */
