/*
 * XREFs of ?AddInkFeedbackProvider@InkFeedbackServer@@QEAAJPEAVInkFeedbackProviderBase@@@Z @ 0x1C00E0D48
 * Callers:
        ...
        struct InkFeedbackProviderBase *a2)
{
  ...
  *((_QWORD *)this + 1) = v3;
  if ( dword_1C0321298 > 4u )
  {
    ...
    v15 = &v8;
    v16 = 8LL;
    TlgWrite((TraceLoggingHProvider)&dword_1C0321298, &unk_1C02E9208, 0LL, 0LL, 6u, &pData);
  }
  return 0LL;
}
