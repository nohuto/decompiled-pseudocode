/*
 * XREFs of ?DeliverRawInput@RIM@InputTraceLogging@@SAXPEBURIMDEV@@_N@Z @ 0x1C01D78C4
 * Callers:
...
void __fastcall InputTraceLogging::RIM::DeliverRawInput(const struct RIMDEV *a1)
{
  ...
  {
    if ( TlgKeywordOn((TraceLoggingHProvider)&dword_1C03222C0, 0x100uLL) )
    {
      v9 = 0;
      v12 = 0;
      v7 = &v5;
      ...
      v8 = 8;
      v11 = cData;
      TlgWrite((TraceLoggingHProvider)&dword_1C03222C0, &unk_1C02E6DA8, 0LL, 0LL, cData, &pData);
    }
  }
}
