/*
 * XREFs of UmfdLoadFontFileView @ 0x1C007C3D4
 * Callers:
 ...
 *     ?LookUpFNTCacheTable@@YAHKPEAGPEAK1PEAPEAVPDEV@@1HPEAH3PEAPEAU_FONTFILEVIEW@@KPEAUtagDESIGNVECTOR@@K@Z @ 0x1C007C9AC (-LookUpFNTCacheTable@@YAHKPEAGPEAK1PEAPEAVPDEV@@1HPEAH3PEAPEAU_FONTFILEVIEW@@KPEAUtagDESIGNVECTO.c)
 *     ?EnsureUmfdHost@UmfdHostLifeTimeManager@@SA_NXZ @ 0x1C007CB9C (-EnsureUmfdHost@UmfdHostLifeTimeManager@@SA_NXZ.c)
 *     ?bIsPathInSystemFontsDir@@YAHPEBG@Z @ 0x1C007F674 (-bIsPathInSystemFontsDir@@YAHPEBG@Z.c)
 *     ?FNTCacheValidateFntFileInfo@@YA?AW4FntFileInfoValidationResult@@PEAPEAU_FONTFILEVIEW@@K@Z @ 0x1C0285888 (-FNTCacheValidateFntFileInfo@@YA-AW4FntFileInfoValidationResult@@PEAPEAU_FONTFILEVIEW@@K@Z.c)
        ...
        int *a13)
{
  ...
  int v40; // [rsp+78h] [rbp-49h] BYREF
  int v41; // [rsp+7Ch] [rbp-45h] BYREF
  unsigned int v42; // [rsp+80h] [rbp-41h] BYREF
  struct PDEV *i; // [rsp+88h] [rbp-39h] BYREF
  struct PDEV *v44; // [rsp+90h] [rbp-31h] BYREF
  ...
  *v15 = 0LL;
  if ( (_BYTE)result )
  {
    ...
    v41 = 0;
    v40 = 0;
    result = LookUpFNTCacheTable(a2, a1, a11, a11 + 1, &v44, &v42, a12, &v40, &v41, v46, v47, a7, a8);
    v18 = result;
    v19 = v40;
    if ( a13 )
      *a13 = v40;
    if ( !v41 )
    {
      ...
      v21 = v47;
      v22 = 1;
      for ( i = qword_1C0332E90; v20 < v47; v21 = v47 )
      {
        v23 = v20++;
        *((_DWORD *)v46[v23] + 16) = 0;
      }
      ...
      else
      {
        ...
        PutFntCacheDrvAndFileInfo(*v17, qword_1C0332E90, v39, v46, v47);
      }
      if ( v30 )
      {
        *v15 = qword_1C0332E90;
