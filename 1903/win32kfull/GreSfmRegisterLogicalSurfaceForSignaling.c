/*
 * XREFs of GreSfmRegisterLogicalSurfaceForSignaling @ 0x1C00442C4
 * Callers:
 ...
 *     ?SignalOnDirty@SFMLOGICALSURFACE@@QEAAJH@Z @ 0x1C00443A8 (-SignalOnDirty@SFMLOGICALSURFACE@@QEAAJH@Z.c)
 */
