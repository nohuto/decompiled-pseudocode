/*
 * XREFs of ?xxxGetNextSysMsg@@YAPEAUtagQMSG@@PEAUtagTHREADINFO@@PEAU1@1PEAVCMultiPerObjectLockExclusivePpiPtiQ@@@Z @ 0x1C00D0ADC
 * Callers:
...
LABEL_2:
  ...
  if ( v14 )
  {
    ...
    *(_DWORD *)(*(_QWORD *)(gptiCurrent + 424LL) + 408LL) = *((_DWORD *)a3 + 6);
    qword_1C032C648 = InternalSetTimer(0LL, qword_1C032C648, v14, (__int64)JournalTimer, 32, 276);
    return 0LL;
  }
