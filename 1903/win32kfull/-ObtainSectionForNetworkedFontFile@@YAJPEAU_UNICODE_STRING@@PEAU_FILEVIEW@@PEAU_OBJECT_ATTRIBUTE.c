/*
 * XREFs of ?ObtainSectionForNetworkedFontFile@@YAJPEAU_UNICODE_STRING@@PEAU_FILEVIEW@@PEAU_OBJECT_ATTRIBUTES@@PEAT_LARGE_INTEGER@@_N@Z @ 0x1C028653C
 * Callers:
 ...
 *     ZwWin32CreateSection @ 0x1C007E36C (ZwWin32CreateSection.c)
 *     ZwWin32CreateSectionRetainHandle @ 0x1C007E3C0 (ZwWin32CreateSectionRetainHandle.c)
