/*
 * XREFs of ?SpDdNotifyFullscreenSpriteUpdate@@YAJPEAUHDC__@@PEAX@Z @ 0x1C026BCF4
 * Callers:
 *     NtGdiDdNotifyFullscreenSpriteUpdate @ 0x1C0275550 (NtGdiDdNotifyFullscreenSpriteUpdate.c)
 * Callees:
