/*
 * XREFs of SfnINLPCOMPAREITEMSTRUCT @ 0x1C02173A0
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall SfnINLPCOMPAREITEMSTRUCT(_QWORD *a1, __int64 a2, __int64 a3, __int64 a4, __int64 a5, __int64 a6)
{
  int v8; // r12d
  ...
  __int64 v39; // [rsp+B0h] [rbp-98h] BYREF
  int v40; // [rsp+B8h] [rbp-90h]
  int v41; // [rsp+BCh] [rbp-8Ch]
  __int64 v42; // [rsp+C0h] [rbp-88h]
  __int128 v43; // [rsp+C8h] [rbp-80h]
  __int128 v44; // [rsp+D8h] [rbp-70h]
  __int128 v45; // [rsp+E8h] [rbp-60h]
  __int64 v46; // [rsp+F8h] [rbp-50h]
  __int64 v47; // [rsp+100h] [rbp-48h]
  __int64 v48; // [rsp+108h] [rbp-40h]
  char v49; // [rsp+150h] [rbp+8h] BYREF
  char v50; // [rsp+158h] [rbp+10h] BYREF
  int v51; // [rsp+160h] [rbp+18h] BYREF
  unsigned __int64 v52; // [rsp+168h] [rbp+20h] BYREF
  ...
  *(_QWORD *)(*(_QWORD *)(v14 + 472) + 80LL) = v21;
  ...
  v22 = KeUserModeCallback(9LL, &v39, 96LL, &v52, &v51);
