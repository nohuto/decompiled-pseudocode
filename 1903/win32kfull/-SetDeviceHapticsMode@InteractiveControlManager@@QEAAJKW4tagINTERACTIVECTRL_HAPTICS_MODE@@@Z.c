/*
 * XREFs of ?SetDeviceHapticsMode@InteractiveControlManager@@QEAAJKW4tagINTERACTIVECTRL_HAPTICS_MODE@@@Z @ 0x1C024F470
 * Callers:
...
__int64 __fastcall InteractiveControlManager::SetDeviceHapticsMode(__int64 a1, __int64 a2, unsigned int a3)
{
  ...
  if ( dword_1C0321308 > 4u )
  {
    ...
    v9 = a3;
    v19 = 4;
    TlgWrite((TraceLoggingHProvider)&dword_1C0321308, &unk_1C02E8F6C, 0LL, 0LL, 5u, &pData);
    result = v8;
  }
  v7 = (_QWORD *)(a1 + 40);
  do
