/*
 * XREFs of ?MakePointerMessageWorker@@YAHPEBUtagPOINTER_INFO@@UtagPOINT@@HHHIPEAXPEA_KPEA_JPEAGPEAKPEAHPEAPEAUHWND__@@@Z @ 0x1C01F2090
 * Callers:
        ...
        HWND *a13)
{
  ...
  unsigned __int64 v29; // [rsp+60h] [rbp+30h] BYREF
  ...
  if ( v23 && (*(_DWORD *)(*(_QWORD *)(v23 + 40) + 288LL) & 0xF) != 2 )
  {
  ...
  if ( a6 <= 0x24B )
  {
    if ( a6 != 587 )
    {
      if ( a6 == 528 )
      {
        v25 = ((unsigned __int64)v19 << 16) | 0x246;
        goto LABEL_18;
      }
      if ( a6 > 0x240 )
      {
        if ( a6 <= 0x243 )
        {
          v24 = a3;
LABEL_17:
          v25 = v19 | (unsigned __int64)(v24 << 16);
LABEL_18:
          *a8 = v25;
