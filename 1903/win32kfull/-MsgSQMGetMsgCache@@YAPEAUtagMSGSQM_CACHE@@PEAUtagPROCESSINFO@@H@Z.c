/*
 * XREFs of ?MsgSQMGetMsgCache@@YAPEAUtagMSGSQM_CACHE@@PEAUtagPROCESSINFO@@H@Z @ 0x1C020C930
 * Callers:
 *     ?MsgSQMAddTargetNode@@YAHPEAUtagPROCESSINFO@@PEAUtagMSGSQM_PROCESSPAIR@@@Z @ 0x1C020C680 (-MsgSQMAddTargetNode@@YAHPEAUtagPROCESSINFO@@PEAUtagMSGSQM_PROCESSPAIR@@@Z.c)
    ...
    if ( !*((_QWORD *)a1 + 107) )
    {
      ...
      *((_QWORD *)a1 + 107) = v3;
      if ( v3 )
      {
        ...
        v4 = (_QWORD *)(*((_QWORD *)a1 + 107) + 48LL);
        v4[1] = v4;
        *v4 = v4;
        v5 = (_QWORD *)(*((_QWORD *)a1 + 107) + 64LL);
        v5[1] = v5;
        *v5 = v5;
      }
    }
  }
  return (struct tagMSGSQM_CACHE *)*((_QWORD *)a1 + 107);
}
