/*
 * XREFs of ?CreateEdgePalmRejectionZones@PalmRejection@@YAHPEAX@Z @ 0x1C01F6A84
 * Callers:
 *     EditionCreateEdgePalmRejectionZones @ 0x1C01F6C70 (EditionCreateEdgePalmRejectionZones.c)
 * Callees:
