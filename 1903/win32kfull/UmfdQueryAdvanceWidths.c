/*
 * XREFs of UmfdQueryAdvanceWidths @ 0x1C0072CC0
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall UmfdQueryAdvanceWidths(__int64 a1, __int64 a2, int a3, __int64 a4, __int64 a5, int a6)
{
  ...
  _QWORD ThreadInformation[2]; // [rsp+A8h] [rbp+17h] BYREF
  ...
  v19 = a3;
  v20 = a4;
  UmfdClientSendAndWaitForCompletion(*(_DWORD *)(*(_QWORD *)(a2 + 24) + 8LL), (__int64)&v12);
