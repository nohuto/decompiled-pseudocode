/*
 * XREFs of ?Reset@InteractiveControlDefaultScroller@@AEAAXPEAUtagWND@@@Z @ 0x1C0255E74
 * Callers:
...
void __fastcall InteractiveControlDefaultScroller::Reset(InteractiveControlDefaultScroller *this, struct tagWND *a2)
{
  ...
  dword_1C0332E38 = 0;
  dword_1C0332E28 = v4;
  dword_1C0332E24 = *((_DWORD *)InteractiveControlManager::Instance() + 59);
  dword_1C0332E2C = *((_DWORD *)InteractiveControlManager::Instance() + 61);
  dword_1C0332E34 = *((_DWORD *)InteractiveControlManager::Instance() + 63);
  dword_1C0332E3C = *((_DWORD *)InteractiveControlManager::Instance() + 65);
