/*
 * XREFs of NtGdiEngGradientFill @ 0x1C02ABBA0
 * Callers:
 *     <none>
 * Callees:
 ...
 *     ?bValidVertexMeshData@@YAHPEAU_TRIVERTEX@@PEAXKKK@Z @ 0x1C02AAC60 (-bValidVertexMeshData@@YAHPEAU_TRIVERTEX@@PEAXKKK@Z.c)
 */
