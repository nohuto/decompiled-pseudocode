/*
 * XREFs of SetManifestWinVer @ 0x1C01039B0
 * Callers:
 *     <none>
 * Callees:
 *     SbGetProcessSwitchContext @ 0x1C0103A78 (SbGetProcessSwitchContext.c)
 *     SbGetContextDetailsByGuid @ 0x1C0103ACC (SbGetContextDetailsByGuid.c)
 */
