/*
 * XREFs of AssociateInputContextEx @ 0x1C011F7B0
 * Callers:
...
LABEL_35:
  ...
  if ( (v3 & 1) != 0 )
  {
    ...
    if ( v14 )
    {
      ...
      v19 = (struct tagBWL *)v15;
      if ( v15 )
      {
        v20 = (unsigned __int64 *)(v15 + 32);
        v21 = *(_QWORD *)(v15 + 32);
        if ( v21 != 1 )
        {
          do
          {
            ...
            if ( v22 )
            {
              ...
              if ( v7 )
                v23 = *v7;
              v16 = *(_QWORD *)(*(_QWORD *)(v22 + 40) + 208LL);
              if ( v16 != v23 && (v16 || !v6) )
              {
                AssociateInputContext(v22, v7);
                if ( (_QWORD *)v18 == v10 )
                  v9 = 1;
              }
            }
