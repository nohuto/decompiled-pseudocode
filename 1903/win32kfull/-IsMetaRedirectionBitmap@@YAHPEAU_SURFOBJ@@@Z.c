/*
 * XREFs of ?IsMetaRedirectionBitmap@@YAHPEAU_SURFOBJ@@@Z @ 0x1C029A268
 * Callers:
 ...
 *     MulProcessChildRedirectionDfbSurfaces2 @ 0x1C02A0650 (MulProcessChildRedirectionDfbSurfaces2.c)
 * Callees:
 *     <none>
 */
