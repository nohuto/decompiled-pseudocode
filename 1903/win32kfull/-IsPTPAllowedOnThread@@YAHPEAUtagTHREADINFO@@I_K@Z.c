/*
 * XREFs of ?IsPTPAllowedOnThread@@YAHPEAUtagTHREADINFO@@I_K@Z @ 0x1C01F1F00
 * Callers:
 ...
 * Callees:
 *     IsTouchpadPointerInputMessage @ 0x1C01E3814 (IsTouchpadPointerInputMessage.c)
...
__int64 __fastcall IsPTPAllowedOnThread(struct tagTHREADINFO *a1, int a2, __int16 a3)
{
  ...
  {
    ThreadPointerData = FindThreadPointerData((struct _LIST_ENTRY *)((char *)a1 + 1080), a3);
    v6 = 0;
