/*
 * XREFs of NtUserGetPointerDevices @ 0x1C011B450
 * Callers:
 *     <none>
 * Callees:
 ...
 *     _GetPointerDeviceInfoProperties @ 0x1C01F0380 (_GetPointerDeviceInfoProperties.c)
 */
  ...
  if ( a1 )
  {
    ...
    if ( a2 )
    {
      ...
      if ( v16 < v5 )
      {
        ...
        *a1 = v5;
        UserSetLastError(122LL, v9, v11, v12);
      }
      else if ( v16 && v5 )
      {
        ...
        for ( j = CBaseInput::TmpGetDeviceList(gpHidInput); j && v17 >= 0; j = (struct DEVICEINFO *)*((_QWORD *)j + 7) )
        {
          if ( (*((_DWORD *)j + 50) & 0x80u) != 0 && (unsigned int)IsPointerDeviceAccessible(*((_QWORD *)j + 60)) )
            GetPointerDeviceInfoProperties(&a2[1080 * v17--], *((_QWORD *)j + 60));
        }
        v4 = 1;
        if ( (unsigned __int64)a1 >= MmUserProbeAddress )
          a1 = (unsigned int *)MmUserProbeAddress;
      ...
      {
        UserSetLastError(15299LL, v9, v11, v12);
      }
    }
    else
    {
