/*
 * XREFs of ?OnPointerInputRetrieval@PointerPromotion@@YAXGKUtagPOINT@@H@Z @ 0x1C0207910
 * Callers:
 *     PointerPromotionOnPointerInputRetrieval @ 0x1C0208A50 (PointerPromotionOnPointerInputRetrieval.c)
 * Callees:
 ...
 *     ?FindMousePromotionEntry@@YAPEAUtagMOUSE_PROMOTION_ENTRY@@AEBUtagMOUSE_PROMOTION_QUEUE@@K@Z @ 0x1C020777C (-FindMousePromotionEntry@@YAPEAUtagMOUSE_PROMOTION_ENTRY@@AEBUtagMOUSE_PROMOTION_QUEUE@@K@Z.c)
 */
  ...
  if ( CacheById )
  {
    ...
    if ( MousePromotionEntry )
    {
      *((_QWORD *)MousePromotionEntry + 1) = v9;
      if ( !v10 && word_1C032C300 == v8 )
      {
        v12 = v15[0] + 1;
        if ( (unsigned int)v12 < 5 )
        {
          v13 = (unsigned int)(5 - v12);
          v14 = (struct tagMOUSE_PROMOTION_QUEUE *)((char *)&unk_1C032C230 + 24 * v12);
          do
          {
