/*
 * XREFs of EdgyUnregisterListener @ 0x1C01F80E4
 * Callers:
 *     NtUserRegisterEdgy @ 0x1C0233580 (NtUserRegisterEdgy.c)
 * Callees:
 *     ?_FindListener@Edgy@@YAPEAUtagEDGY_LISTENER@@AEAUtagEDGY_DATA@@PEAXW4tagEDGY_LOCATION@@@Z @ 0x1C01F7104 (-_FindListener@Edgy@@YAPEAUtagEDGY_LISTENER@@AEAUtagEDGY_DATA@@PEAXW4tagEDGY_LOCATION@@@Z.c)
