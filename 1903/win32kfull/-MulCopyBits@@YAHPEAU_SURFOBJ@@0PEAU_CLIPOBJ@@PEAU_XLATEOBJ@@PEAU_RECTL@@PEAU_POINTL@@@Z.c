/*
 * XREFs of ?MulCopyBits@@YAHPEAU_SURFOBJ@@0PEAU_CLIPOBJ@@PEAU_XLATEOBJ@@PEAU_RECTL@@PEAU_POINTL@@@Z @ 0x1C029B1A0
 * Callers:
 *     <none>
 * Callees:
 ...
 *     ?IsMetaRedirectionBitmap@@YAHPEAU_SURFOBJ@@@Z @ 0x1C029A268 (-IsMetaRedirectionBitmap@@YAHPEAU_SURFOBJ@@@Z.c)
        ...
        struct _POINTL *a6)
{
  ...
  _BYTE v21[56]; // [rsp+80h] [rbp-80h] BYREF
  __int64 v22; // [rsp+B8h] [rbp-48h]
  struct _SURFOBJ *v23; // [rsp+C0h] [rbp-40h]
  __int64 v24; // [rsp+C8h] [rbp-38h]
  _BYTE v25[88]; // [rsp+E0h] [rbp-20h] BYREF
      ...
      if ( ((_DWORD)hdev[532] & 0x8000) == 0 )
      {
        ...
        if ( (unsigned int)IsMetaDevBitmapForMirroring(a1) )
        {
          ...
          if ( (*(_DWORD *)(SURFOBJ_TO_SURFACE_NOT_NULL(v23) + 112) & 0x400) != 0 )
            v13 = (*(__int64 (__fastcall **)(__int64, struct _SURFOBJ *, __int64, struct _XLATEOBJ *, struct _RECTL *, struct _POINTL *))(*(_QWORD *)(v22 + 56) + 2840LL))(
                    v26,
                    v23,
                    v24,
                    a4,
...
LABEL_16:
        if ( (*(_DWORD *)(SURFOBJ_TO_SURFACE_NOT_NULL(v23) + 112) & 0x400) != 0 )
          v15 = (*(__int64 (__fastcall **)(_QWORD, struct _SURFOBJ *, __int64, struct _XLATEOBJ *, struct _RECTL *, struct _POINTL *))(*(_QWORD *)(v22 + 56) + 2840LL))(
      ...
      if ( ((_DWORD)hdev[532] & 0x8000) == 0 || *(_WORD *)(SURFOBJ_TO_SURFACE_NOT_NULL(v23) + 100) )
      {
        ...
        v16 = (*(_DWORD *)(SURFOBJ_TO_SURFACE_NOT_NULL(v23) + 112) & 0x400) != 0
            ? (*(__int64 (__fastcall **)(struct _SURFOBJ *, struct _SURFOBJ *, __int64, struct _XLATEOBJ *, struct _RECTL *, struct _POINTL *))(*(_QWORD *)(v22 + 56) + 2840LL))(
                a1,
                v23,
                v24,
                a4,
