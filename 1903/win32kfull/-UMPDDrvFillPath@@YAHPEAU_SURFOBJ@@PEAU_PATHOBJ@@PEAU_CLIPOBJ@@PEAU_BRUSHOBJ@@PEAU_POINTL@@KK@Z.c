/*
 * XREFs of ?UMPDDrvFillPath@@YAHPEAU_SURFOBJ@@PEAU_PATHOBJ@@PEAU_CLIPOBJ@@PEAU_BRUSHOBJ@@PEAU_POINTL@@KK@Z @ 0x1C02A3170
 * Callers:
 *     <none>
 * Callees:
  ...
  if ( v22 )
  {
          ...
          (v17 = v13) != 0) )
    {
      ...
      if ( !(unsigned int)UMPDOBJ::pso(v12, (UMPDOBJ *)((char *)v12 + 64), (struct _SURFOBJ **)&v25[3], v9)
        ...
        || (LODWORD(Size) = 4, (unsigned int)UMPDOBJ::Thunk(v12, v25, 96LL, &v17, Size) == -1)
        || (v14 = 1, !v17) )
      {
        v14 = 0;
      }
