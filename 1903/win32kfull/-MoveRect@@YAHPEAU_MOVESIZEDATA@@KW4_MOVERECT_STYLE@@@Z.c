/*
 * XREFs of ?MoveRect@@YAHPEAU_MOVESIZEDATA@@KW4_MOVERECT_STYLE@@@Z @ 0x1C01FB160
 * Callers:
...
__int64 __fastcall MoveRect(__int64 a1, int a2, int a3)
{
  ...
  if ( !v8 )
  {
    ...
    v13 = (__int16)a2 - (*(_DWORD *)(a1 + 48) - *v5) / 2 - *v5;
LABEL_10:
    LODWORD(v20) = v13 + v20;
    DWORD2(v20) += v13;
    HIDWORD(v20) += v12;
  ...
  if ( !v9 )
  {
    v11 = EngMulDiv(*(_DWORD *)(a1 + 48) - *v5, *(_DWORD *)(a1 + 284), *(_DWORD *)(a1 + 32) - *(_DWORD *)(a1 + 24));
    v12 = v7
        - *(_DWORD *)(a1 + 44)
        - EngMulDiv(
...
LABEL_11:
  ...
  v17 = *(_QWORD *)(v16 + 40);
  if ( !*(_QWORD *)(v17 + 168) )
    return IntersectRect(v21, v5, (int *)(a1 + 88));
  v22 = *(_QWORD *)(v17 + 168);
  v18 = TransformRegionBetweenCoordinateSpaces(v15, v16, &v22);
  v19 = GreRectInRegion(v22, v5);
  if ( v18 )
    GreDeleteObject(v22);
  return v19;
}
