/*
 * XREFs of Generate_HTSC_WORD @ 0x1C013C6B8
 * Callers:
 *     CachedHalftonePattern @ 0x1C0037900 (CachedHalftonePattern.c)
 * Callees:
...
__int64 __fastcall Generate_HTSC_WORD(__m128i *a1)
{
  ...
  {
    EngAcquireSemaphore(qword_1C032C698);
    v2 = 0;
    ...
    {
LABEL_3:
      EngReleaseSemaphore(qword_1C032C698);
    ...
    v10 = (v9 << 24) + 808539208;
    v11 = *(__int64 *)((char *)&off_1C02D6008 + v20);
      ...
      if ( v14 )
      {
        if ( v5.m128i_i8[1] <= 0xFu )
        {
          ...
          RotateHTPat45(
            ...
            v5.m128i_u16[2],
            v5.m128i_u16[5],
            *(unsigned __int16 *)((char *)&unk_1C02D6002 + v20),
            v18);
