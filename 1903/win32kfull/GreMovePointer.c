/*
 * XREFs of GreMovePointer @ 0x1C00467C0
 * Callers:
 ...
 *     ApplyGatheredDeviceInfoSummaryInformation @ 0x1C013B0C0 (ApplyGatheredDeviceInfoSummaryInformation.c)
 *     HideMouseTrails @ 0x1C01D7500 (HideMouseTrails.c)
