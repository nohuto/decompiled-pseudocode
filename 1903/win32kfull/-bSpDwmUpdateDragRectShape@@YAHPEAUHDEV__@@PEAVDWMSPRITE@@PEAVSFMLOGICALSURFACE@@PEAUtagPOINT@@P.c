/*
 * XREFs of ?bSpDwmUpdateDragRectShape@@YAHPEAUHDEV__@@PEAVDWMSPRITE@@PEAVSFMLOGICALSURFACE@@PEAUtagPOINT@@PEAUtagSIZE@@PEAKPEAPEAV3@@Z @ 0x1C026BFF0
 * Callers:
        ...
        struct SFMLOGICALSURFACE **a7)
{
  ...
  {
    v10 = *a7;
    v11 = (struct _SURFOBJ *)*((_QWORD *)*a7 + 23);
    v19[0] = 0LL;
    SURFREFVIEW::bMap((SURFREFVIEW *)v19, v11);
    if ( v19[0] )
    {
      *((_DWORD *)a2 + 41) |= 4u;
      ...
      {
        v12 = (BOOL (__stdcall *)(SURFOBJ *, SURFOBJ *, SURFOBJ *, CLIPOBJ *, XLATEOBJ *, COLORADJUSTMENT *, POINTL *, RECTL *, RECTL *, POINTL *, ULONG))*((_QWORD *)a1 + 356);
      }
      else
      {
        v12 = EngStretchBlt;
