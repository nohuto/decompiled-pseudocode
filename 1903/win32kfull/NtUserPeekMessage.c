/*
 * XREFs of NtUserPeekMessage @ 0x1C009BB20
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall NtUserPeekMessage(_OWORD *a1, __int64 a2, __int64 a3, __int64 a4, unsigned int a5, char a6)
{
  ...
  else
  {
    ...
    if ( *(int *)(*(_QWORD *)(gptiCurrent + 440LL) + 20LL) <= 0 )
      Message = xxxRealInternalGetMessage((unsigned int)&v22, a2, v7, v6, (unsigned __int64)Timeout, 0);
    else
      Message = ClientGetMessageMPH(&v22, a2, v7, v6, a5, 0);
    v10 = Message;
    if ( Message )
    {
      HIDWORD(v22) = 0;
