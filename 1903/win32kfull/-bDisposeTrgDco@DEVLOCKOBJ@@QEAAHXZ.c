/*
 * XREFs of ?bDisposeTrgDco@DEVLOCKOBJ@@QEAAHXZ @ 0x1C0101658
 * Callers:
 ...
 *     ?bUnMapTrgSurfaceView@DEVLOCKOBJ@@QEAAHXZ @ 0x1C01016DC (-bUnMapTrgSurfaceView@DEVLOCKOBJ@@QEAAHXZ.c)
...
__int64 __fastcall DEVLOCKOBJ::bDisposeTrgDco(DEVLOCKOBJ *this)
{
  ...
  if ( v3 && *((_BYTE *)this + 49) )
  {
    ...
    if ( (*((_DWORD *)this + 6) & 0x1000) != 0 )
    {
      ...
      {
        *((_DWORD *)*v1 + 9) &= ~0x4000u;
        DC::pSurface(*v1, *(struct SURFACE **)(v5 + 2552));
      }
