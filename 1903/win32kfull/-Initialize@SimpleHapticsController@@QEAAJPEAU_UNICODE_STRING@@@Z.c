/*
 * XREFs of ?Initialize@SimpleHapticsController@@QEAAJPEAU_UNICODE_STRING@@@Z @ 0x1C0256A70
 * Callers:
...
__int64 __fastcall SimpleHapticsController::Initialize(SimpleHapticsController *this, struct _UNICODE_STRING *a2)
{
  ...
  if ( (unsigned int)dword_1C03212D0 > 4 )
  {
    ...
    TlgWrite((TraceLoggingHProvider)&dword_1C03212D0, &unk_1C02E9815, 0LL, 0LL, 3u, &pData);
  }
  if ( !a2 )
  {
...
LABEL_22:
  if ( (unsigned int)dword_1C03212D0 > 4 )
  {
    ...
    v22 = 4LL;
    v24 = 4LL;
    TlgWrite((TraceLoggingHProvider)&dword_1C03212D0, &unk_1C02E9990, 0LL, 0LL, 5u, &pData);
  }
