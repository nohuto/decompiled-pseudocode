/*
 * XREFs of zzzSetWindowsHookEx @ 0x1C00B32E4
 * Callers:
 *     NtUserSetWindowsHookEx @ 0x1C00B31A0 (NtUserSetWindowsHookEx.c)
 *     NtUserSetWindowsHookAW @ 0x1C0236180 (NtUserSetWindowsHookAW.c)
 * Callees:
...
LABEL_74:
  ...
  if ( v7 )
  {
    LOBYTE(a1) = *((_BYTE *)&unk_1C02E0698 + v6 + 1);
    if ( (a1 & 2) == 0 )
    {
      v9 = 1429LL;
      goto LABEL_74;
    ...
    if ( *(_QWORD *)(gptiCurrent + 416LL) != *(_QWORD *)(v7 + 416) )
    {
      ...
      if ( (*(_DWORD *)(v7 + 480) & 0xC) != 0 && (*((_BYTE *)&unk_1C02E0698 + v6 + 1) & 0x10) == 0 )
      {
        v9 = 1458LL;
        goto LABEL_74;
      }
  ...
  else if ( !v8 && (*((_BYTE *)&unk_1C02E0698 + v6 + 1) & 0x24) == 0 )
  {
LABEL_13:
    v9 = 1428LL;
    goto LABEL_74;
  ...
  v38 = v6;
  if ( (*((_BYTE *)&unk_1C02E0698 + v6 + 1) & 4) != 0
...
LABEL_17:
  ...
  *v22 = v16;
  ...
  if ( (*(_DWORD *)(v16 + 64) & 1) != 0 && (*((_BYTE *)&unk_1C02E0698 + v6 + 1) & 0x10) != 0 )
  {
