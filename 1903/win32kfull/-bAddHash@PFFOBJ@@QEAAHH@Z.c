/*
 * XREFs of ?bAddHash@PFFOBJ@@QEAAHH@Z @ 0x1C00782DC
 * Callers:
...
__int64 __fastcall PFFOBJ::bAddHash(PFFOBJ *this, int a2)
{
  ...
  if ( v6 )
  {
    ...
    v8 = v7 + 1;
    v9 = (__int64 *)(v7 + 2);
    if ( *(struct PDEV **)(v5 + 88) == qword_1C0332E90 && !*(_DWORD *)(v6 + 8) )
      ++gcTrueTypeFonts;
  }
  else
  {
  ...
  v15[0] = v7;
  v14[0] = v9;
  if ( FHOBJ::bValid((FHOBJ *)v14) && FHOBJ::bValid((FHOBJ *)v15) && FHOBJ::bValid((FHOBJ *)v16) )
  {
    v11 = *(_QWORD *)this;
    v12 = 0;
