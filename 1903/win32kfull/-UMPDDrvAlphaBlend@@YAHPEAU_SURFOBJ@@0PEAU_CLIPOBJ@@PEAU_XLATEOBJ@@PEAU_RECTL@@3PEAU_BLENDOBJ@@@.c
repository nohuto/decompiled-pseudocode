/*
 * XREFs of ?UMPDDrvAlphaBlend@@YAHPEAU_SURFOBJ@@0PEAU_CLIPOBJ@@PEAU_XLATEOBJ@@PEAU_RECTL@@3PEAU_BLENDOBJ@@@Z @ 0x1C02A29B0
 * Callers:
 *     <none>
 * Callees:
...
LABEL_8:
    ...
    if ( !(unsigned int)UMPDOBJ::pso(v13, (UMPDOBJ *)((char *)v13 + 64), (struct _SURFOBJ **)&v34[3], v11)
      ...
      || (LODWORD(Size) = 4, (unsigned int)UMPDOBJ::Thunk(v13, v34, 80LL, &v19, Size) == -1)
      || (v16 = 1, !v19) )
    {
      v16 = 0;
    }
