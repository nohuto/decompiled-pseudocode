/*
 * XREFs of NtUserGetWindowCompositionAttribute @ 0x1C008AB90
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall NtUserGetWindowCompositionAttribute(__int64 a1, __m128i *a2)
{
  ...
  *(__m128i *)Address = v49;
  ...
  {
    Size = qword_1C02E0428[2 * v49.m128i_i32[0]];
...
LABEL_74:
    ...
    if ( LODWORD(Address[0]) == 20 && (unsigned int)IsTopLevelOrLayeredChildWindow(v13, v10, v12) )
    {
LABEL_49:
