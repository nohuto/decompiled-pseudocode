/*
 * XREFs of ?DestroyPhysicalMonitor@CMonitorAPI@@QEAAJPEAX@Z @ 0x1C026F39C
 * Callers:
 *     NtGdiDestroyPhysicalMonitor @ 0x1C026F7B0 (NtGdiDestroyPhysicalMonitor.c)
 * Callees:
...
__int64 __fastcall CMonitorAPI::DestroyPhysicalMonitor(CMonitorAPI *this, void *a2)
{
  ...
  v7 = this;
  v2 = (struct OPM::CMutex *)qword_1C032C788;
  OPM::CAutoMutex::CAutoMutex((OPM::CAutoMutex *)&v8, (struct OPM::CMutex *)((char *)qword_1C032C788 + 32));
