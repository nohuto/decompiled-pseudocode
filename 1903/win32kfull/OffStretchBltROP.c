/*
 * XREFs of OffStretchBltROP @ 0x1C015543C
 * Callers:
...
__int64 __fastcall OffStretchBltROP(
        __int64 (__fastcall *a1)(__int64, __int64, __int64, struct _CLIPOBJ *, __int64, __int64, __int64 *, __int64 *, __int64 *, __int64, int, __int64, int),
        LONG *a2,
        __int64 a3,
        __int64 a4,
        __int64 a5,
        ...
        int a16)
{
  ...
  __int64 v26; // [rsp+70h] [rbp-79h] BYREF
  ...
  __int64 (__fastcall *v35)(__int64, __int64, __int64, struct _CLIPOBJ *, __int64, __int64, __int64 *, __int64 *, __int64 *, __int64, int, __int64, int); // [rsp+B8h] [rbp-31h]
  __int64 v36; // [rsp+C0h] [rbp-29h] BYREF
  __int64 v37; // [rsp+C8h] [rbp-21h]
  __int64 v38; // [rsp+D0h] [rbp-19h] BYREF
  ...
  if ( a11 )
  {
    ...
    LODWORD(v37) = v17 + *((_DWORD *)a11 + 2);
    HIDWORD(v36) = v16 + *((_DWORD *)a11 + 1);
    v20 = &v36;
    HIDWORD(v37) = v16 + *((_DWORD *)a11 + 3);
  }
  v38 = 0LL;
  v39 = 0LL;
  if ( a12 )
  {
    LODWORD(v38) = x + *(_DWORD *)a12;
    LODWORD(v39) = x + *((_DWORD *)a12 + 2);
    HIDWORD(v38) = y + *((_DWORD *)a12 + 1);
    v21 = &v38;
    HIDWORD(v39) = y + *((_DWORD *)a12 + 3);
  }
  v26 = 0LL;
  if ( a10 )
  {
