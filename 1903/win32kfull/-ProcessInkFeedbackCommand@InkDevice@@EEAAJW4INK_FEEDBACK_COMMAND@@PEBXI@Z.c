/*
 * XREFs of ?ProcessInkFeedbackCommand@InkDevice@@EEAAJW4INK_FEEDBACK_COMMAND@@PEBXI@Z @ 0x1C0251CD0
 * Callers:
 *     <none>
 * Callees:
 ...
 *     ?FindActiveCommandByTargetPointerId@InkFeedbackProviderBase@@IEBAPEAVActiveCommand@1@W4INK_FEEDBACK_COMMAND@@I@Z @ 0x1C024FCD0 (-FindActiveCommandByTargetPointerId@InkFeedbackProviderBase@@IEBAPEAVActiveCommand@1@W4INK_FEEDB.c)
 *     ?IsSuperWetInkStartDataSupported@@YA_NW4InkFeedbackCapabilities@@PEBUIFC_SUPERWET_INK_START_DATA@@@Z @ 0x1C024FCF8 (-IsSuperWetInkStartDataSupported@@YA_NW4InkFeedbackCapabilities@@PEBUIFC_SUPERWET_INK_START_DATA.c)
 *     ?RemoveAndReleaseActiveCommand@InkFeedbackProviderBase@@IEAAXPEAPEAVActiveCommand@1@@Z @ 0x1C0250780 (-RemoveAndReleaseActiveCommand@InkFeedbackProviderBase@@IEAAXPEAPEAVActiveCommand@1@@Z.c)
  ...
  if ( *(_BYTE *)(a1 - 20) )
  {
    if ( a2 == 1 )
    {
      if ( a4 == 64 )
      {
        ...
        if ( dword_1C0321298 > 4u )
        {
          ...
          v38 = -__CFSHR__(v17, 3);
          v98 = 4LL;
          TlgWrite((TraceLoggingHProvider)&dword_1C0321298, &unk_1C02E954E, 0LL, 0LL, 0x1Bu, &v49);
          v15 = dword_1C0321298;
        }
        v18 = *(_DWORD *)(a1 + 40);
        if ( v18 < *(_DWORD *)(a1 + 108) )
        {
          if ( InkFeedbackProviderBase::FindActiveCommandByTargetPointerId(a1, 1, *(_DWORD *)a3) )
          {
            ...
            if ( v20 > 2 )
            {
              ...
              v118 = a3;
              v119 = 4LL;
              TlgWrite((TraceLoggingHProvider)&dword_1C0321298, &unk_1C02E936C, 0LL, 0LL, 5u, &v113);
            }
          }
          else
          {
            ...
            if ( v21 >= 0 )
            {
              if ( IsSuperWetInkStartDataSupported(*(_DWORD *)(a1 + 116), a3) )
              {
                ...
                else
                {
                  ...
                  if ( dword_1C0321298 > 2u )
                  {
                    ...
                    v167 = &v44;
                    v168 = 4LL;
                    TlgWrite((TraceLoggingHProvider)&dword_1C0321298, &unk_1C02E8371, 0LL, 0LL, 3u, &v166);
                  }
                }
              }
              else
              {
                ...
                if ( dword_1C0321298 > 2u )
                {
                  ...
                  v154 = 4LL;
                  v156 = 65LL;
                  TlgWrite((TraceLoggingHProvider)&dword_1C0321298, &unk_1C02E8C70, 0LL, 0LL, 4u, &v152);
                }
              }
            }
            else if ( dword_1C0321298 > 2u )
            {
              ...
              v149 = 4LL;
              v151 = 23LL;
              TlgWrite((TraceLoggingHProvider)&dword_1C0321298, &unk_1C02E8C70, 0LL, 0LL, 4u, &v147);
            }
          }
        }
        else
        {
          ...
          if ( v15 > 2 )
          {
            ...
            v40 = v18;
            v112 = 4LL;
            TlgWrite((TraceLoggingHProvider)&dword_1C0321298, &unk_1C02E96E7, 0LL, 0LL, 5u, &v106);
          }
        }
      }
      else
      {
        ...
        if ( dword_1C0321298 > 2u )
        {
          ...
          v164 = &v34;
          v165 = 4LL;
          TlgWrite((TraceLoggingHProvider)&dword_1C0321298, &unk_1C02E8371, 0LL, 0LL, 3u, &v163);
        }
      }
    }
    else if ( a2 == 2 )
    {
      if ( a4 == 4 )
      {
        if ( dword_1C0321298 > 4u )
        {
          ...
          v136 = &v46;
          TlgWrite((TraceLoggingHProvider)&dword_1C0321298, &unk_1C02E93A9, 0LL, 0LL, 7u, &v130);
        }
        ...
        if ( ActiveCommandByTargetPointerId )
        {
          ...
          else if ( dword_1C0321298 > 2u )
          {
            ...
            v142 = 4;
            v145 = 23;
            TlgWrite((TraceLoggingHProvider)&dword_1C0321298, &unk_1C02E8C70, 0LL, 0LL, 4u, &v140);
          }
        }
        else
        {
          ...
          if ( (unsigned int)v12 > 2 )
          {
            ...
            v104 = a3;
            v105 = 4LL;
            TlgWrite((TraceLoggingHProvider)&dword_1C0321298, &unk_1C02E936C, 0LL, 0LL, 5u, &v99);
          }
        }
      }
      else
      {
        ...
        if ( dword_1C0321298 > 2u )
        {
          ...
          v161 = &v30;
          v162 = 4LL;
          TlgWrite((TraceLoggingHProvider)&dword_1C0321298, &unk_1C02E8371, 0LL, 0LL, 3u, &v160);
        }
      }
    }
    else
    {
      ...
      if ( dword_1C0321298 > 2u )
      {
        ...
        v126 = &v45;
        v128 = &v25;
        TlgWrite((TraceLoggingHProvider)&dword_1C0321298, &unk_1C02E930E, 0LL, 0LL, 7u, &v120);
      }
    }
  }
  else
