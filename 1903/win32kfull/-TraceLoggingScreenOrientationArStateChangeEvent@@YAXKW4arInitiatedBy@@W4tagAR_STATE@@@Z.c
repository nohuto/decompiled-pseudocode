/*
 * XREFs of ?TraceLoggingScreenOrientationArStateChangeEvent@@YAXKW4arInitiatedBy@@W4tagAR_STATE@@@Z @ 0x1C01CF2F0
 * Callers:
...
void TraceLoggingScreenOrientationArStateChangeEvent()
{
  ...
  if ( hProvider > 5u )
  {
    if ( TlgKeywordOn((TraceLoggingHProvider)&hProvider, 0x400000000000uLL) )
    {
      ...
      v5 = v0;
      v17 = 4LL;
      TlgWrite((TraceLoggingHProvider)&hProvider, &unk_1C02E6746, 0LL, 0LL, 7u, &pData);
    }
  }
}
