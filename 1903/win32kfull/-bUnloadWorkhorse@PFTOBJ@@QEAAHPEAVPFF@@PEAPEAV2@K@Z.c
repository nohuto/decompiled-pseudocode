/*
 * XREFs of ?bUnloadWorkhorse@PFTOBJ@@QEAAHPEAVPFF@@PEAPEAV2@K@Z @ 0x1C0049F60
 * Callers:
 ...
 *     PFTOBJ_bUnloadWorkhorseWrap @ 0x1C0270B30 (PFTOBJ_bUnloadWorkhorseWrap.c)
 *     GreRemoveFontMemResourceEx @ 0x1C02880F0 (GreRemoveFontMemResourceEx.c)
 *     GreRemoveFontResourceW @ 0x1C02881C4 (GreRemoveFontResourceW.c)
 ...
 * Callees:
 *     ?bDeleteLoadRef@PFFOBJ@@QEAAHKPEAUtagPvtData@@PEAH@Z @ 0x1C004A12C (-bDeleteLoadRef@PFFOBJ@@QEAAHKPEAUtagPvtData@@PEAH@Z.c)
 ...
 *     bKillPFFOBJ @ 0x1C007B23C (bKillPFFOBJ.c)
 *     vKillRFONTList @ 0x1C02709EC (vKillRFONTList.c)
 *     ?pPvtDataMatch@PFFOBJ@@QEAAPEAUtagPvtData@@XZ @ 0x1C02B4368 (-pPvtDataMatch@PFFOBJ@@QEAAPEAUtagPvtData@@XZ.c)
 */
