/*
 * XREFs of xxxResolveDesktopForWOW @ 0x1C01EB1BC
 * Callers:
...
__int64 __fastcall xxxResolveDesktopForWOW(PUNICODE_STRING Destination)
{
  ...
  struct _UNICODE_STRING DestinationString; // [rsp+50h] [rbp-288h] BYREF
  ULONG_PTR RegionSize[2]; // [rsp+60h] [rbp-278h] BYREF
