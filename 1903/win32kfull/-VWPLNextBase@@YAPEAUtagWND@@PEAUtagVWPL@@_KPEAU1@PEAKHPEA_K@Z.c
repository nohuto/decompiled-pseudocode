/*
 * XREFs of ?VWPLNextBase@@YAPEAUtagWND@@PEAUtagVWPL@@_KPEAU1@PEAKHPEA_K@Z @ 0x1C00CFA70
 * Callers:
...
struct tagWND *__fastcall VWPLNextBase(struct tagVWPL *a1, int a2, struct tagWND *a3, unsigned int *a4)
{
  ...
  if ( !a1 )
  {
    if ( WPP_RECORDER_INITIALIZED != (_UNKNOWN *)&WPP_RECORDER_INITIALIZED )
      WPP_RECORDER_SF_q(0, a2, 0xBu, 0xDu, (__int64)&WPP_96a4b716de4d340ab0b6048e502c48be_Traceguids, 0LL);
    return 0LL;
  }
  if ( *((_DWORD *)a1 + 3) )
    return 0LL;
...
LABEL_10:
    if ( WPP_RECORDER_INITIALIZED != (_UNKNOWN *)&WPP_RECORDER_INITIALIZED )
      WPP_RECORDER_SF_q(v6, v7, 0xBu, 0xFu, (__int64)&WPP_96a4b716de4d340ab0b6048e502c48be_Traceguids, a1);
    *a4 = 0;
    return 0LL;
  }
  if ( WPP_RECORDER_INITIALIZED != (_UNKNOWN *)&WPP_RECORDER_INITIALIZED )
