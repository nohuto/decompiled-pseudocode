/*
 * XREFs of ?LookUpFNTCacheTable@@YAHKPEAGPEAK1PEAPEAVPDEV@@1HPEAH3PEAPEAU_FONTFILEVIEW@@KPEAUtagDESIGNVECTOR@@K@Z @ 0x1C007C9AC
 * Callers:
 *     UmfdLoadFontFileView @ 0x1C007C3D4 (UmfdLoadFontFileView.c)
 * Callees:
 *     SearchFNTCacheHlink @ 0x1C007CB48 (SearchFNTCacheHlink.c)
 *     ReadFileInfo @ 0x1C007F3E0 (ReadFileInfo.c)
 */
