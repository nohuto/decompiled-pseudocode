/*
 * XREFs of GetHidTelemetryData @ 0x1C01EF628
 * Callers:
 ...
 *     GetHidVidPidStrings @ 0x1C020F6C0 (GetHidVidPidStrings.c)
 */
...
void __fastcall GetHidTelemetryData(__int64 a1)
{
  ...
  int v8; // ecx
  int v9; // edx
  _QWORD v10[2]; // [rsp+48h] [rbp-39h] BYREF
  _QWORD v11[2]; // [rsp+58h] [rbp-29h] BYREF
