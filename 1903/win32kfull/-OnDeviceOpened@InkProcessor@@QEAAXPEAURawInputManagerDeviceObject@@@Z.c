/*
 * XREFs of ?OnDeviceOpened@InkProcessor@@QEAAXPEAURawInputManagerDeviceObject@@@Z @ 0x1C02458B4
 * Callers:
 ...
 *     ?OnDeviceOpened@RimBackedDeviceBase@Rim@@UEAAXXZ @ 0x1C023A340 (-OnDeviceOpened@RimBackedDeviceBase@Rim@@UEAAXXZ.c)
...
void __fastcall InkProcessor::OnDeviceOpened(InkProcessor *this, struct RawInputManagerDeviceObject *a2)
{
  ...
  Rim::RimBackedDeviceBase *v5; // rdi
  int v6; // [rsp+30h] [rbp-49h] BYREF
  Rim::RimBackedDeviceBase *v7; // [rsp+38h] [rbp-41h] BYREF
  ...
  Rim::RimBackedDeviceBase **v16; // [rsp+90h] [rbp+17h]
