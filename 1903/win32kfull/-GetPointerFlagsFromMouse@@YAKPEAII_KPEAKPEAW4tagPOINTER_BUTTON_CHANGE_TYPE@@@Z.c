/*
 * XREFs of ?GetPointerFlagsFromMouse@@YAKPEAII_KPEAKPEAW4tagPOINTER_BUTTON_CHANGE_TYPE@@@Z @ 0x1C01E1E38
 * Callers:
...
LABEL_27:
  v16 = 0;
  v17 = (unsigned __int16 *)&unk_1C02EB640;
  do
  {
    if ( *v17 == v10 )
      break;
  ...
  if ( v16 >= 0x1C )
    return 0LL;
  v18 = 3LL * v16;
  v19 = *((_DWORD *)&unk_1C02EB640 + 6 * v16 + 2);
  if ( (v19 & 0x10000) == 0 || (MouseKeyFlags & 0x73) != 0 )
  {
    v19 = *((_DWORD *)&unk_1C02EB640 + 6 * v16 + 3);
    v20 = *((_WORD *)&unk_1C02EB640 + 12 * v16 + 2);
  }
  else
  {
    v20 = *((_WORD *)&unk_1C02EB640 + 12 * v16 + 1);
  }
  v21 = v20;
  *a4 = MouseKeyFlags;
  v22 = *((_BYTE *)&unk_1C02EB640 + 24 * v16 + 16);
  if ( v22 )
  {
    if ( v22 != 5 )
    {
LABEL_40:
      ...
      if ( (*((_DWORD *)&unk_1C02EB640 + 2 * v18 + 2) & 0x10000) != 0 )
        MouseKeyFlags |= v23;
      else
        MouseKeyFlags &= ~v23;
      *a4 = MouseKeyFlags;
...
LABEL_55:
  ...
  {
    v21 = *((unsigned __int16 *)&unk_1C02EB640 + 4 * v18 + 1);
    v24 = *((_DWORD *)&unk_1C02EB640 + 2 * v18 + 2) | v19 & ~*((_DWORD *)&unk_1C02EB640 + 2 * v18 + 3);
  }
  *(_DWORD *)a5 = 0;
  if ( v10 > 0x200 )
  {
...
LABEL_105:
  ...
  **(_DWORD **)(gptiCurrent + 1280LL) ^= (**(_DWORD **)(gptiCurrent + 1280LL) ^ (32
                                                                               * *((_DWORD *)&unk_1C02EB640 + 2 * v18 + 5))) & 0x20;
  if ( a1 )
    *a1 = v21;
  return v45;
}
