/*
 * XREFs of ?GenerateWindowShadow@@YAPEAUHBITMAP__@@PEAUtagWND@@PEAUHDC__@@@Z @ 0x1C0146358
 * Callers:
 ...
 *     ?DrawRoundedRectangularShadow@@YAXPEAXJJHJ@Z @ 0x1C014809C (-DrawRoundedRectangularShadow@@YAXPEAXJJHJ@Z.c)
 *     ?DrawRegionalShadow@@YAXPEAXJJ@Z @ 0x1C0148338 (-DrawRegionalShadow@@YAXPEAXJJ@Z.c)
...
__int64 __fastcall GenerateWindowShadow(struct tagWND *a1, HDC a2)
{
  ...
  HBITMAP ScaledWindowShadowFromDIB; // rdi
  ...
  if ( W32GetThreadWin32Thread((__int64)KeGetCurrentThread(), v9, v10, v11)
    && *(_QWORD *)(W32GetThreadWin32Thread((__int64)KeGetCurrentThread(), v12, v13, v14) + 448)
    && (*(_DWORD *)(**(_QWORD **)(*(_QWORD *)(W32GetThreadWin32Thread((__int64)KeGetCurrentThread(), v12, v15, v16) + 448)
                                + 8LL)
                  + 64LL) & 1) != 0
    && (v17 = *((_QWORD *)a1 + 5), v18 = *(_DWORD *)(v17 + 288), (v18 & 0xF) == 0)
    && (v18 & 0x40000000) != 0
    && (v25 = *(unsigned __int16 *)(v17 + 284), (_WORD)v25 != 96) )
  {
  ...
  v34[2] = bottom;
  v35 = 2097153LL;
  v21 = GreCreateDIBitmapReal(a2, v12, 0LL, v34, 0, 0x2Cu, 0, 0LL, 0, 0LL, 0, 0LL, &v31);
  if ( !v21 )
    return 0LL;
  v33 = GreSelectBitmap(a2);
  ...
  if ( v8 > 1 )
  {
    ...
    if ( ScaledWindowShadowFromDIB )
    {
      GreSelectBitmap(a2);
      GreDeleteObject(v21);
      v21 = (__int64)ScaledWindowShadowFromDIB;
    }
    else
    {
      v5 = 0;
