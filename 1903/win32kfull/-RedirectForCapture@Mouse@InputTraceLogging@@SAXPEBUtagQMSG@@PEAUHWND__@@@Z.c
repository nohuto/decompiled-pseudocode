/*
 * XREFs of ?RedirectForCapture@Mouse@InputTraceLogging@@SAXPEBUtagQMSG@@PEAUHWND__@@@Z @ 0x1C012D240
 * Callers:
...
void __fastcall InputTraceLogging::Mouse::RedirectForCapture(const struct tagQMSG *a1, HWND a2)
{
  ...
  if ( dword_1C03222C0 > 4u )
  {
    if ( TlgKeywordOn((TraceLoggingHProvider)&dword_1C03222C0, 0x40uLL) )
    {
      ...
      v6 = v3;
      v13 = 8LL;
      TlgWrite((TraceLoggingHProvider)&dword_1C03222C0, &unk_1C02E7454, 0LL, 0LL, 5u, &pData);
    }
  }
}
