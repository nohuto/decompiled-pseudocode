/*
 * XREFs of ?PostRawKeyboardInputToSinks@@YAXKPEAXPEAU_KEYBOARD_INPUT_DATA@@IGH@Z @ 0x1C0002A5C
 * Callers:
        ...
        i = (__int64 *)*i )
  {
    if ( (*((_DWORD *)i + 25) & 0x40) != 0 )
    {
      ...
      if ( v11 )
      {
        ...
        {
          if ( !v6
            || (unsigned __int8)CheckAccess(*(_QWORD *)(v11[2] + 416LL) + 872LL, v40)
            || (v38 = *(_QWORD *)(i[9] + 16), *(int *)(*(_QWORD *)(v38 + 416) + 12LL) < 0) )
          {
            if ( *(_QWORD *)(*(_QWORD *)(i[9] + 16) + 416LL) != v6 && ((*((_DWORD *)i + 25) & 0x80u) == 0 || !a6) )
            {
