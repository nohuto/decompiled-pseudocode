/*
 * XREFs of ?vSrcTranCopyS8D16New@@YAXPEAEJJ0JJJJKKPEAVSURFACE@@P6AXPEBE00JPEAPEAG@Z0@Z @ 0x1C0276184
 * Callers:
 ...
 *     ulBlendPixelCT @ 0x1C0275E58 (ulBlendPixelCT.c)
 *     ?vCopyAlphaBuffer16bpp@@YAXPEBEPEAE1JPEAPEAG@Z @ 0x1C0275FC4 (-vCopyAlphaBuffer16bpp@@YAXPEBEPEAE1JPEAPEAG@Z.c)
 */
      ...
      if ( *v20 )
      {
        ...
        else
        {
          if ( v23 == 114 )
            ...
            v25 = ulBlendPixelCT((__int64)v28, v24, (unsigned __int8 *)off_1C03210F0 + 4 * v23);
          *(_WORD *)v21 = v25;
        }
      }
      --v22;
