/*
 * XREFs of ExpandDIB_CY @ 0x1C0264650
 * Callers:
 *     <none>
 * Callees:
  ...
  *(_QWORD *)&v81[32] = v20;
  ...
  while ( v40 )
  {
    ...
    if ( v41 )
    {
      ...
      v19 = *(_QWORD *)&v81[24];
      v57 = v18 - *(_QWORD *)&v81[24];
      v58 = &v16[-*(_QWORD *)&v81[24]];
      v59 = *(_QWORD *)&v81[8] - *(_QWORD *)&v81[24];
      v60 = (unsigned __int8 *)(*(_QWORD *)&v81[24] + 2LL);
      do
      {
        v61 = *(_DWORD *)(v15 + 4LL * v60[(_QWORD)v58])
            + *(_DWORD *)(v15 + 4LL * v60[v57] + 2048)
            + *(_DWORD *)(v15 + 4LL * v60[v59] + 1024);
        v62 = *v60;
        v60 += 3;
        v51[2] = (*(_DWORD *)(v15 + 4 * v62 + 3072) + v61) >> 13;
        v51[1] = (*(_DWORD *)(v15 + 4LL * *(v60 - 4) + 3072)
                + *(_DWORD *)(v15 + 4LL * v60[(_QWORD)v58 - 4])
                + *(_DWORD *)(v15 + 4LL * v60[v57 - 4] + 2048)
                + *(_DWORD *)(v15 + 4LL * v60[v59 - 4] + 1024)) >> 13;
        *v51 = (*(_DWORD *)(v15 + 4LL * *(v60 - 5) + 3072)
              + *(_DWORD *)(v15 + 4LL * v60[(_QWORD)v58 - 5])
              + *(_DWORD *)(v15 + 4LL * v60[v59 - 5] + 1024)
              + *(_DWORD *)(v15 + 4LL * v60[v57 - 5] + 2048)) >> 13;
        v51 += v116;
      }
      while ( v51 != v115 );
    }
    else if ( WORD1(v80) )
    {
      ...
      v64 = (unsigned __int8 *)(v19 + 2);
      v65 = *(_QWORD *)&v81[8] - v19;
      v66 = v18 - v19;
      do
      {
        v67 = *(_DWORD *)(v15 + 4LL * v64[v66] + 2048) + *(_DWORD *)(v15 + 4LL * v64[v65] + 1024);
        v68 = *v64;
        v64 += 3;
        v51[2] = (*(_DWORD *)(v15 + 4 * v68 + 3072) + v67) >> 13;
        v51[1] = (*(_DWORD *)(v15 + 4LL * *(v64 - 4) + 3072)
                + *(_DWORD *)(v15 + 4LL * v64[v66 - 4] + 2048)
                + *(_DWORD *)(v15 + 4LL * v64[v65 - 4] + 1024)) >> 13;
        *v51 = (*(_DWORD *)(v15 + 4LL * *(v64 - 5) + 3072)
              + *(_DWORD *)(v15 + 4LL * v64[v66 - 5] + 2048)
              + *(_DWORD *)(v15 + 4LL * v64[v65 - 5] + 1024)) >> 13;
        v51 += v116;
      }
      while ( v51 != v115 );
    }
    else if ( WORD2(v80) )
    {
      ...
      v70 = (unsigned __int8 *)(v18 + 1);
      v71 = v19 - v18;
      do
      {
        v51[2] = (*(_DWORD *)(v15 + 4LL * v70[1] + 2048) + *(_DWORD *)(v15 + 4LL * v70[v71 + 1] + 3072)) >> 13;
        v72 = v70[v71];
        v73 = *v70;
        v70 += 3;
        v51[1] = (*(_DWORD *)(v15 + 4 * v73 + 2048) + *(_DWORD *)(v15 + 4 * v72 + 3072)) >> 13;
        *v51 = (*(_DWORD *)(v15 + 4LL * *(v70 - 4) + 2048) + *(_DWORD *)(v15 + 4LL * v70[v71 - 4] + 3072)) >> 13;
        v51 += v116;
      }
      while ( v51 != v115 );
    }
