/*
 * XREFs of ?vComputeUncoveredSpriteRegion@RGNOBJ@@QEAAXAEAVPDEVOBJ@@@Z @ 0x1C003EC64
 * Callers:
 ...
 *     ?bEnum@ENUMUNCOVERED@@QEAAHPEAU_RECTL@@@Z @ 0x1C003EDE0 (-bEnum@ENUMUNCOVERED@@QEAAHPEAU_RECTL@@@Z.c)
 */
...
void __fastcall RGNOBJ::vComputeUncoveredSpriteRegion(RGNOBJ *this, struct PDEVOBJ *a2)
{
  ...
  v2 = *(_QWORD *)a2;
  v3 = (_DWORD *)(*(_QWORD *)this + 104LL);
  *(_QWORD *)&v12.left = 0LL;
  *(_QWORD *)&v12.right = 0LL;
  RGNOBJ::vSet(this);
  if ( !*(_DWORD *)(v2 + 204) )
    vSpComputeSpriteRanges((struct _SPRITESTATE *)(v2 + 88));
  v5 = *(_QWORD *)(v2 + 224);
  v13 = *(_DWORD *)(v2 + 140);
  v14 = v5;
  v16 = v5 + 8;
  ...
  if ( (unsigned int)ENUMUNCOVERED::bEnum((ENUMUNCOVERED *)&v13, &v12) )
  {
    ...
    while ( 1 )
    {
      ...
      v3[v8 + 3] = v12.left;
      v3[(unsigned int)(v8 + 1) + 3] = v12.right;
      if ( !(unsigned int)ENUMUNCOVERED::bEnum((ENUMUNCOVERED *)&v13, &v12) )
        break;
      top = v12.top;
    }
    *v3 = v8;
    ...
    v3[2] = bottom;
    v3[v8 + 3] = v8;
    v11 = (_DWORD *)((char *)v3 + (unsigned int)(4 * *v3 + 16));
    *v11 = 0;
    v11[1] = bottom;
    v11[2] = 0x7FFFFFFF;
    v11[3] = 0;
