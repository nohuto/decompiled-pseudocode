/*
 * XREFs of FreeDdeXact @ 0x1C020B630
 * Callers:
 ...
 * Callees:
 *     GreDeleteServerMetaFile @ 0x1C015DD0C (GreDeleteServerMetaFile.c)
 *     ?RemovePublicObject@@YAHIPEAX@Z @ 0x1C0209B84 (-RemovePublicObject@@YAHIPEAX@Z.c)
 */
