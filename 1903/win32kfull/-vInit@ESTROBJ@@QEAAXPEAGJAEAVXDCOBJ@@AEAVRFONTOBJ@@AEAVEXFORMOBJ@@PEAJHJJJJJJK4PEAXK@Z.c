/*
 * XREFs of ?vInit@ESTROBJ@@QEAAXPEAGJAEAVXDCOBJ@@AEAVRFONTOBJ@@AEAVEXFORMOBJ@@PEAJHJJJJJJK4PEAXK@Z @ 0x1C0068D50
 * Callers:
        ...
        unsigned int a18)
{
  ...
  *((_QWORD *)this + 8) = v30;
    ...
    else
    {
      ...
      if ( v137 )
      {
        if ( v137 >= 0x10 )
        {
          ...
          {
            v134 += 16LL;
            *v133 = _mm_add_epi32(_mm_loadu_si128(v133), v24);
            v133[1] = _mm_add_epi32(_mm_loadu_si128(v133 + 1), v24);
            v133[2] = _mm_add_epi32(_mm_loadu_si128(v133 + 2), v24);
            v133[3] = _mm_add_epi32(_mm_loadu_si128(v133 + 3), v24);
            v133 += 4;
          }
  ...
  if ( a7 )
  {
    if ( !v20 )
    {
      ESTROBJ::vCharPos_H1(this, v22, a5, v34, v33, a7, LODWORD(v25));
      goto LABEL_48;
    }
    if ( (a15 & 0xA0) != 0 )
    {
    ...
    ESTROBJ::vCharPos_H4(this, v22, a5, v34, v33, a7, LODWORD(v25), *((_DWORD *)v37 + 3));
    goto LABEL_48;
  }
  if ( !*(_DWORD *)(v35 + 312) || a11 | a10 )
  {
    ESTROBJ::vCharPos_H3((__int64)this, v22, a5, v34, v33, a10, a11, a12, LODWORD(v25), 0LL);
    goto LABEL_48;
  }
...
LABEL_33:
    if ( !LinkMetricsPlus->gdf.pgb
      ...
      && !(unsigned int)RFONTOBJ::bInsertGlyphbits(v18, LinkMetricsPlus, v41 == v163) )
    {
      v158 = 0;
    }
    ++v41;
...
LABEL_69:
  if ( (v63 & 0xA0) != 0 )
  {
    *((_DWORD *)this + 58) |= v63 & 0xA0;
    v145 = *(_QWORD *)v18;
    if ( !(v36 | a8 | *(_DWORD *)(*(_QWORD *)v18 + 392LL)) && ((_DWORD)(*a6)[8] & 1) != 0 )
    {
      v146 = v84 + 8;
