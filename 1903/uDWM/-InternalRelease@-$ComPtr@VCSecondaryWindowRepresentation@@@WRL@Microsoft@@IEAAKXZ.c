/*
 * XREFs of ?InternalRelease@?$ComPtr@VCSecondaryWindowRepresentation@@@WRL@Microsoft@@IEAAKXZ @ 0x180002AC4
 * Callers:
 ...
 *     ??0CGlobalLightSet@@AEAA@_K@Z @ 0x18003D618 (--0CGlobalLightSet@@AEAA@_K@Z.c)
...
unsigned int __fastcall Microsoft::WRL::ComPtr<CSecondaryWindowRepresentation>::InternalRelease(CBaseObject **a1)
{
  CBaseObject *v1; // rdx
