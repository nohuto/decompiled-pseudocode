/*
 * XREFs of ?IsBaseThumbnailDestinationReachable@CWindowList@@AEAA_NPEAVCWindowData@@@Z @ 0x18002A05C
 * Callers:
 ...
 *     ?IsBaseThumbnailDestinationReachable@CWindowList@@AEAA_NPEAVCWindowData@@@Z @ 0x18002A05C (-IsBaseThumbnailDestinationReachable@CWindowList@@AEAA_NPEAVCWindowData@@@Z.c)
...
char __fastcall CWindowList::IsBaseThumbnailDestinationReachable(struct CWindowData **this, struct CWindowData *a2)
{
  ...
  for ( i = 0LL; (unsigned int)i < *((_DWORD *)a2 + 128); i = (unsigned int)(i + 1) )
  {
    if ( IsBaseThumbnailDestinationReachable )
      break;
    v7 = *(_QWORD *)(*((_QWORD *)a2 + 61) + 8 * i);
    if ( (*(_DWORD *)(v7 + 44) & 0x900000) == 0 )
    {
