/*
 * XREFs of ?UpdateProperties@CThumbnailVisual@@QEAAJK@Z @ 0x180025680
 * Callers:
 ...
 * Callees:
 *     ?Remove@?$DynArray@PEAVCThumbnailData@@$0A@@@QEAAHAEBQEAVCThumbnailData@@@Z @ 0x1800058C8 (-Remove@-$DynArray@PEAVCThumbnailData@@$0A@@@QEAAHAEBQEAVCThumbnailData@@@Z.c)
 ...
 *     ?AreAllMarginsZero@@YA_NAEBU_MARGINS@@@Z @ 0x180028014 (-AreAllMarginsZero@@YA_NAEBU_MARGINS@@@Z.c)
...
__int64 __fastcall CThumbnailVisual::UpdateProperties(CSecondaryWindowRepresentation **this, unsigned int a2)
{
  ...
  if ( updated < 0 && (v2 & 1) != 0 && this[46] )
  {
    ...
    else
    {
      ...
      CVisual::SetOffset((struct tagPOINT *)this, &v52);
    }
    v6 = this[46];
...
LABEL_57:
    ...
    if ( BrushForCVI >= 0 )
    {
      DynArray<CThumbnailData *,0>::Remove((__int64 *)(*(_QWORD *)&(*v17)[3] + 520LL), this + 46);
      v20 = (__m128i *)v52;
...
LABEL_55:
        ...
        v27 = DynArrayImpl<0>::AddMultipleAndSet(v21, 8, 1, this + 46);
        v3 = v27;
        if ( v27 < 0 )
