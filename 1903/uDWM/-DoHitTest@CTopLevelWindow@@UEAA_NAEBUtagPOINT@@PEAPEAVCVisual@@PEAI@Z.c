/*
 * XREFs of ?DoHitTest@CTopLevelWindow@@UEAA_NAEBUtagPOINT@@PEAPEAVCVisual@@PEAI@Z @ 0x1800067B0
 * Callers:
    ...
    *(_QWORD *)&rc.left = 0LL;
    ...
    if ( (v18 & 0x20) != 0 )
    {
      if ( (v18 & 0x20000) != 0 )
        ...
        v35.left = left;
      v27 = 5LL;
      v37[0] = *((_QWORD *)this + 65);
      v37[1] = *((_QWORD *)this + 60);
      v37[2] = *((_QWORD *)this + 61);
      ...
      do
      {
        ...
        {
          v34.left = v30[28];
          v34.top = *((_DWORD *)this + 161);
          v34.right = v30[28] + v30[30];
          v34.bottom = v30[29] + v30[31];
          if ( v30 == *((LONG **)this + 65) )
          {
            v34.left = *((_DWORD *)this + 159);
          }
          else if ( v30 == *((LONG **)this + 63) )
          {
            v34.right = *((_DWORD *)this + 30) - *((_DWORD *)this + 160);
          }
    ...
    else if ( *((_QWORD *)this + 65) )
    {
      ...
      v20 = GetSystemMetricsForDpi(50LL, *(unsigned int *)(*((_QWORD *)this + 90) + 324LL));
      v21 = (SystemMetricsForDpi - v20 - GetSystemMetrics(46)) / 2;
      if ( v21 >= 1 )
      {
        v22 = (LONG *)*((_QWORD *)this + 65);
        v35.left = v22[28];
        v35.top = v22[29] - v21;
