/*
 * XREFs of ?HrCalcRequiredBufferSizeWorker@@YAJIIIIPEAI@Z @ 0x1800470E8
 * Callers:
        ...
        unsigned int *a5)
{
  ...
  {
    v5 = -2147024809;
    MilInstrumentationCheckHR_MaybeFailFast(0x14u, 0LL, 0, -2147024809, 0x371u, v14);
    return v5;
  }
  v11 = v6 * v8;
  if ( v11 > 0xFFFFFFFF )
...
LABEL_14:
    v5 = -2147024362;
    MilInstrumentationCheckHR_MaybeFailFast(0x14u, 0LL, 0, -2147024362, v13, v14);
    return v5;
  }
LABEL_7:
  *a5 = v7;
