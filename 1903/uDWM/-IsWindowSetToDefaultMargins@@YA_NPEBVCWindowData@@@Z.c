/*
 * XREFs of ?IsWindowSetToDefaultMargins@@YA_NPEBVCWindowData@@@Z @ 0x180027F10
 * Callers:
 ...
 *     ?GetDefaultWindowMarginsForWindowStyle@@YA?AU_MARGINS@@KKKN@Z @ 0x180028034 (-GetDefaultWindowMarginsForWindowStyle@@YA-AU_MARGINS@@KKKN@Z.c)
...
char __fastcall IsWindowSetToDefaultMargins(const struct CWindowData *a1)
{
  ...
  if ( !AreAllMarginsZero((const struct _MARGINS *)a1 + 5) || !operator==(&v11, &v10) )
    return 0;
  return v5;
}
