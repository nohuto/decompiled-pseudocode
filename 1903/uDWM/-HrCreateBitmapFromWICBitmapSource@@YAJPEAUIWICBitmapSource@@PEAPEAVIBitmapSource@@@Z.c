/*
 * XREFs of ?HrCreateBitmapFromWICBitmapSource@@YAJPEAUIWICBitmapSource@@PEAPEAVIBitmapSource@@@Z @ 0x180047668
 * Callers:
 ...
 *     ??0CWICBitmapWrapper@@QEAA@XZ @ 0x180047960 (--0CWICBitmapWrapper@@QEAA@XZ.c)
