/*
 * XREFs of ?SendTopLevelWindowCommand@CTopLevelWindow@@QEAAJPEAUHWND__@@PEAVCWindowData@@_N@Z @ 0x1800269C4
 * Callers:
...
__int64 __fastcall CTopLevelWindow::SendTopLevelWindowCommand(CTopLevelWindow *this, HWND a2, struct CWindowData *a3)
{
  ...
  if ( a2
    && (v8 = *(_QWORD *)(*((_QWORD *)this + 2) + 16LL),
        ...
        v11 < 0) )
  {
    MilInstrumentationCheckHR_MaybeFailFast(0x14u, 0LL, 0, v11, 0x1D2u, v20);
  }
      ...
      if ( v16 >= 0 )
      {
        ...
        if ( v17 >= 0 )
        {
          ...
          if ( v18 >= 0 )
          {
            ...
            v3 = v19;
            if ( v19 < 0 )
              MilInstrumentationCheckHR_MaybeFailFast(0x14u, 0LL, 0, v19, 0x1E9u, v20);
          }
          else
          {
            MilInstrumentationCheckHR_MaybeFailFast(0x14u, 0LL, 0, v18, 0x1E7u, v20);
            v4 = v22;
          }
        }
        else
        {
          MilInstrumentationCheckHR_MaybeFailFast(0x14u, 0LL, 0, v17, 0x1E5u, v20);
        }
      }
      else
      {
        MilInstrumentationCheckHR_MaybeFailFast(0x14u, 0LL, 0, v16, 0x1E2u, v20);
      }
    }
    else
    {
      MilInstrumentationCheckHR_MaybeFailFast(0x14u, 0LL, 0, v13, 0x1DBu, v20);
    }
  }
  if ( hObject )
  {
