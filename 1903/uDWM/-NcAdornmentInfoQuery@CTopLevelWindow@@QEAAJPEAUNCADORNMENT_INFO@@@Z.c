/*
 * XREFs of ?NcAdornmentInfoQuery@CTopLevelWindow@@QEAAJPEAUNCADORNMENT_INFO@@@Z @ 0x180004624
 * Callers:
 ...
 *     ?GetRootVisualNoAddRef@CTopLevelWindow@@QEAAPEAVCVisual@@_N@Z @ 0x180031928 (-GetRootVisualNoAddRef@CTopLevelWindow@@QEAAPEAVCVisual@@_N@Z.c)
