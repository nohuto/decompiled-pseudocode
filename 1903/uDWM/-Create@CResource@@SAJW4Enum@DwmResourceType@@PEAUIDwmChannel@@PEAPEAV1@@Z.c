/*
 * XREFs of ?Create@CResource@@SAJW4Enum@DwmResourceType@@PEAUIDwmChannel@@PEAPEAV1@@Z @ 0x1800179E4
 * Callers:
...
__int64 __fastcall CResource::Create(unsigned int a1, __int64 a2, __int64 *a3)
{
  __int64 v6; // rax
  __int64 v7; // rbx
  int v8; // eax
  ...
  *a3 = 0LL;
  ...
  {
    v9 = -2147024882;
    MilInstrumentationCheckHR_MaybeFailFast(0x14u, 0LL, 0, -2147024882, 0x27u, v11);
    return (unsigned int)v9;
  }
  *(_QWORD *)(v7 + 16) = a2;
  v8 = (*(__int64 (__fastcall **)(__int64, _QWORD, __int64))(*(_QWORD *)a2 + 96LL))(a2, a1, v7 + 24);
  v9 = v8;
  if ( v8 < 0 )
  {
    MilInstrumentationCheckHR_MaybeFailFast(0x14u, 0LL, 0, v8, 0x44u, v11);
  }
  else if ( !*(_DWORD *)(v7 + 24) )
  {
    v9 = -2147024882;
    MilInstrumentationCheckHR_MaybeFailFast(0x14u, 0LL, 0, -2147024882, 0x45u, v11);
    goto LABEL_15;
  }
  if ( v9 >= 0 )
  {
...
LABEL_15:
  MilInstrumentationCheckHR_MaybeFailFast(0x14u, 0LL, 0, v9, 0x29u, v11);
LABEL_8:
  if ( v7 )
