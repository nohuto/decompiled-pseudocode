/*
 * XREFs of ?RegisterIconicAnimatedVisual@CImmersiveIconicBitmapRegistry@@QEAAJPEAVCIconicAnimatedVisual@@@Z @ 0x180082774
 * Callers:
...
LABEL_9:
  ...
  {
    v6 = DynArrayImpl<0>::AddMultipleAndSet((__int64)this + 48, 8, 1, &v7);
    v4 = v6;
    if ( v6 < 0 )
    {
