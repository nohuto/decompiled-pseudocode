/*
 * XREFs of ?HrgnFromRects@@YAJPEBUtagRECT@@IPEAPEAUHRGN__@@@Z @ 0x1800201A0
 * Callers:
...
__int64 __fastcall HrgnFromRects(const struct tagRECT *Src, unsigned int a2, HRGN *a3)
{
  ...
  if ( v3 > 0xFFFFFFFF )
  {
    MilInstrumentationCheckHR_MaybeFailFast(0x14u, 0LL, 0, -2147024362, 0xC5u, v20);
    return 2147942934LL;
  }
  else
  {
    ...
    {
      MilInstrumentationCheckHR_MaybeFailFast(0x14u, 0LL, 0, -2147024362, 0xC6u, v20);
      return 2147942934LL;
    }
    else
    {
      ...
      if ( v9 )
      {
        ...
        if ( a2 > 1 )
        {
          ...
          while ( v14 );
          *((_QWORD *)&v21 + 1) = __PAIR64__(v11, v13);
          *(_QWORD *)&v21 = __PAIR64__(v15, v16);
          v10 = v21;
        }
        *(_DWORD *)v9 = 32;
        *(_DWORD *)(v9 + 4) = 1;
        ...
        *(_OWORD *)(v9 + 16) = v10;
        ...
        else
        {
          ...
          if ( v8 >= 0 )
            v8 = -2003304445;
          MilInstrumentationCheckHR_MaybeFailFast(0x14u, 0LL, 0, v8, 0xEAu, v20);
        }
      ...
      {
        MilInstrumentationCheckHR_MaybeFailFast(0x14u, 0LL, 0, -2147024882, 0xCFu, v20);
        return 2147942414LL;
      }
    }
  }
