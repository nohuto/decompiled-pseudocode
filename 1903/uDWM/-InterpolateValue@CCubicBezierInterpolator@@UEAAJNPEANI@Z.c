/*
 * XREFs of ?InterpolateValue@CCubicBezierInterpolator@@UEAAJNPEANI@Z @ 0x1800A4E70
 * Callers:
 *     <none>
 * Callees:
 *     ?GetFinalValue@CCubicBezierInterpolator@@UEAAJPEANI@Z @ 0x1800A4BB0 (-GetFinalValue@CCubicBezierInterpolator@@UEAAJPEANI@Z.c)
 */
