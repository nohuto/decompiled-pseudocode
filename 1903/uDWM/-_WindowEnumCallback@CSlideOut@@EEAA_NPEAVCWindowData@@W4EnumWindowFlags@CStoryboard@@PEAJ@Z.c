/*
 * XREFs of ?_WindowEnumCallback@CSlideOut@@EEAA_NPEAVCWindowData@@W4EnumWindowFlags@CStoryboard@@PEAJ@Z @ 0x18002F840
 * Callers:
 *     <none>
 * Callees:
...
LABEL_9:
      ...
      else
      {
        ...
        if ( v40 )
        {
          ...
          v30 = *(_OWORD *)(v28 + 872);
          v31 = (CAnimatedTransitionVisual *)*((_QWORD *)v40 + 5);
          v41 = v29;
