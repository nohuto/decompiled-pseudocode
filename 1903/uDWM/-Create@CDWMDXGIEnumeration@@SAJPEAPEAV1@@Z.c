/*
 * XREFs of ?Create@CDWMDXGIEnumeration@@SAJPEAPEAV1@@Z @ 0x18002DD44
 * Callers:
...
__int64 __fastcall CDWMDXGIEnumeration::Create(struct CDWMDXGIEnumeration **a1)
{
  ...
  if ( v3 )
  {
    ...
    if ( inited < 0 )
    {
      MilInstrumentationCheckHR_MaybeFailFast(0x14u, &dword_1800C3DE8, 1u, inited, 0x3Cu, v7);
    }
    else
    {
      *a1 = v3;
  ...
  {
    v5 = -2147024882;
    MilInstrumentationCheckHR_MaybeFailFast(0x14u, &dword_1800C3DE8, 1u, -2147024882, 0x38u, v7);
  }
  return v5;
}
