/*
 * XREFs of ??$CreateProxyFromHandle@VCWindowNodeProxy@@@CCompositor@@IEAAJIPEAPEAVCWindowNodeProxy@@@Z @ 0x1800251DC
 * Callers:
...
__int64 __fastcall CCompositor::CreateProxyFromHandle<CWindowNodeProxy>(__int64 a1, unsigned int a2, CBaseObject **a3)
{
  __int64 v6; // rax
  __int64 v7; // rdx
  CBaseObject *v8; // rbx
  ...
  *a3 = 0LL;
  ...
  if ( v6 )
  {
    ...
    *(_DWORD *)(v6 + 8) = 1;
    *(_QWORD *)(v6 + 16) = 0LL;
    *(_QWORD *)v6 = &CWindowNodeProxy::`vftable';
  }
  wil::com_ptr_t<CBitmapSourceProxy,wil::err_returncode_policy>::operator=(&v13, (volatile signed __int32 *)v6);
  v8 = v13;
  if ( v13 )
  {
    v9 = CResource::WrapExistingResource(*(_QWORD *)(a1 + 16), v7, a2, (__int64 *)v13 + 2);
    v10 = v9;
    if ( v9 < 0 )
