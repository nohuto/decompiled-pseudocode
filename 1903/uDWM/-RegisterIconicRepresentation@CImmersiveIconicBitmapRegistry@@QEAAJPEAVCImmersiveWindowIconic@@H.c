/*
 * XREFs of ?RegisterIconicRepresentation@CImmersiveIconicBitmapRegistry@@QEAAJPEAVCImmersiveWindowIconic@@HW4DEVICE_SCALE_FACTOR@@_NPEAW4IconicRepresentationType@@3@Z @ 0x180082824
 * Callers:
...
LABEL_21:
    ...
    {
      v19 = DynArrayImpl<0>::AddMultipleAndSet((__int64)this + 16, 8, 1, &IconicResourceNoRef);
      v11 = v19;
      if ( v19 < 0 )
