/*
 * XREFs of ?GetSurfaceFromExistingAnimationComponent@CTransitionVisualController@@QEAAJPEAVCAnimationComponent@@PEBUtagRECT@@_NPEAPEAVCImageLegacyMilBrushProxy@@PEAPEAVCCachedVisualImageProxy@@PEA_NPEAUMilPoint3F@@@Z @ 0x1800331FC
 * Callers:
        ...
        struct MilPoint3F *a8)
{
  ...
  if ( v8 )
  {
    ...
    v17 = *(_QWORD *)(v15 + 40);
    if ( v17 && !*(_BYTE *)(v17 + 975) && !*(_BYTE *)(v15 + 74) )
    {
      v18 = 0;
      if ( a3->right - a3->left >= 0 )
        v18 = a3->right - a3->left;
      if ( v18 == *(_DWORD *)(v17 + 952) )
      {
        v19 = 0;
        if ( a3->bottom - a3->top >= 0 )
          v19 = a3->bottom - a3->top;
        if ( v19 == HIDWORD(*(_QWORD *)(v17 + 952)) )
        {
          v20 = *(volatile signed __int32 **)(v17 + 584);
          if ( v20 )
            _InterlockedIncrement(v20 + 2);
          v21 = *(volatile signed __int32 **)(v17 + 608);
          v22 = v21;
          if ( v21 )
          {
            v23 = *(volatile signed __int32 **)(v17 + 608);
          }
          else
          {
            v22 = *(volatile signed __int32 **)(v17 + 592);
            v23 = v22;
          }
          if ( v23 )
          {
            if ( !v21 )
              v21 = *(volatile signed __int32 **)(v17 + 592);
