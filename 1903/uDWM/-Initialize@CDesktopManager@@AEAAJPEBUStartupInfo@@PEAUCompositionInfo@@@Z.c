/*
 * XREFs of ?Initialize@CDesktopManager@@AEAAJPEBUStartupInfo@@PEAUCompositionInfo@@@Z @ 0x180049940
 * Callers:
 ...
 *     ?_InitializeWnf@CDesktopManager@@AEAAJXZ @ 0x180049FE8 (-_InitializeWnf@CDesktopManager@@AEAAJXZ.c)
 ...
 *     ??0CProjectionBorderManager@@QEAA@XZ @ 0x18004A3E8 (--0CProjectionBorderManager@@QEAA@XZ.c)
 *     ?Create@CLivePreview@@SAJPEAPEAV1@@Z @ 0x18004A480 (-Create@CLivePreview@@SAJPEAPEAV1@@Z.c)
 *     ?SetupDPIValues@CDesktopManager@@QEAAXXZ @ 0x18004A7C4 (-SetupDPIValues@CDesktopManager@@QEAAXXZ.c)
 ...
 *     ??0CTransitionVisualController@@QEAA@XZ @ 0x18004AB24 (--0CTransitionVisualController@@QEAA@XZ.c)
 *     ??0CContactManager@@QEAA@XZ @ 0x18004ABB0 (--0CContactManager@@QEAA@XZ.c)
...
LABEL_64:
    v20 = -2147024882;
    MilInstrumentationCheckHR_MaybeFailFast(0x14u, &dword_1800C3EF4, 1u, -2147024882, dwCreationFlagsa, lpThreadId);
...
LABEL_76:
    v34 = v19;
LABEL_113:
    MilInstrumentationCheckHR_MaybeFailFast(0x14u, &dword_1800C3EF4, 1u, v34, dwCreationFlagsb, lpThreadId);
    goto LABEL_57;
  }
  pvParam = 8;
...
LABEL_83:
    v20 = -2147024882;
    MilInstrumentationCheckHR_MaybeFailFast(0x14u, &dword_1800C3EF4, 1u, -2147024882, dwCreationFlagsc, lpThreadId);
LABEL_115:
