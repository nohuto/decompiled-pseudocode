/*
 * XREFs of ?CloneVisualTreeForLivePreview@CTopLevelWindow@@QEAAJ_N00PEAPEAV1@@Z @ 0x180009654
 * Callers:
        ...
        struct CTopLevelWindow **a5)
{
    ...
    if ( *(_QWORD *)v14 )
    {
      ...
      *(_BYTE *)(v15 + 84) |= v9;
      if ( !a2 )
      {
        ...
        if ( v18 < 0 )
        {
          MilInstrumentationCheckHR_MaybeFailFast(0x14u, 0LL, 0, v18, 0x154Bu, v27);
          goto LABEL_26;
        }
      }
    }
  ...
  if ( v17 < 0 )
  {
    MilInstrumentationCheckHR_MaybeFailFast(0x14u, 0LL, 0, v17, 0x1557u, v27);
  }
  else
  {
    v19 = *((_QWORD *)this + 35);
