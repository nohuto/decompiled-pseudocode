/*
 * XREFs of CTransitionVisualController::ForEachOwnedWindow__lambda_c41abd0b3c99427b9cbe9a707708bfad___ @ 0x18000C0D0
 * Callers:
  ...
  if ( !a3 || (*(_DWORD *)(a1 + 612) & 0x10000000) != 0 )
  {
    ...
    if ( !v7 || (*(_BYTE *)(v7 + 240) & 0x18) == 0 )
    {
      for ( i = 0LL; (unsigned int)i < *(_DWORD *)(a1 + 584); i = (unsigned int)(i + 1) )
      {
        ...
        {
          CTransitionVisualController::RestoreWindow(*a2, *(struct CWindowData **)(*(_QWORD *)(a1 + 560) + 8 * i), 0);
