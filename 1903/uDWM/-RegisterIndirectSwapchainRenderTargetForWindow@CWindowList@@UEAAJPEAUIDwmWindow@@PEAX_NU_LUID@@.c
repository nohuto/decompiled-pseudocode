/*
 * XREFs of ?RegisterIndirectSwapchainRenderTargetForWindow@CWindowList@@UEAAJPEAUIDwmWindow@@PEAX_NU_LUID@@@Z @ 0x180091D00
 * Callers:
 *     <none>
 * Callees:
        ...
        struct _LUID a5)
{
  ...
  {
    MilInstrumentationCheckHR_MaybeFailFast(0x14u, 0LL, 0LL, SyncedWindowData, 0x1568u);
    goto LABEL_8;
  }
  if ( !v15 || (v11 = (CTopLevelWindow *)*((_QWORD *)v15 + 50)) == 0LL )
  {
    v10 = -2147024890;
    MilInstrumentationCheckHR_MaybeFailFast(0x14u, 0LL, 0LL, -2147024890, 0x156Bu);
LABEL_8:
    if ( hObject )
      CloseHandle(hObject);
    goto LABEL_10;
  ...
  v10 = v12;
  if ( v12 < 0 )
    MilInstrumentationCheckHR_MaybeFailFast(0x14u, 0LL, 0LL, v12, 0x1572u);
LABEL_10:
