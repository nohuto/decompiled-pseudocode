/*
 * XREFs of ?ApplyMaximizedClip@CTopLevelWindow@@AEAAJPEAUHRGN__@@@Z @ 0x180020304
 * Callers:
 *     ?UpdateNCAreaGeometry@CTopLevelWindow@@AEAAJXZ @ 0x18001FA40 (-UpdateNCAreaGeometry@CTopLevelWindow@@AEAAJXZ.c)
 * Callees:
 *     ?CreateRectRgnCoerceInvalid@@YAPEAUHRGN__@@PEBUtagRECT@@@Z @ 0x180038914 (-CreateRectRgnCoerceInvalid@@YAPEAUHRGN__@@PEBUtagRECT@@@Z.c)
  ...
  if ( (*((_BYTE *)this + 240) & 4) != 0 )
  {
    ...
    if ( v8 )
    {
      ...
      if ( !CombineRgn(a2, a2, v8, 1) )
      {
        ...
        if ( v2 >= 0 )
          v2 = -2003304445;
        MilInstrumentationCheckHR_MaybeFailFast(0x14u, &dword_1800C3FD0, 0xBu, v2, 0x1270u, v14);
      }
      DeleteObject(v8);
    }
    else
    {
      ...
      MilInstrumentationCheckHR_MaybeFailFast(0x14u, &dword_1800C3FD0, 0xBu, v2, 0x126Eu, v14);
    }
  }
