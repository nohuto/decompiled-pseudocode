/*
 * XREFs of ?UpdateDestinationRect@CIconicAnimatedVisual@@AEAAJXZ @ 0x1800B218C
 * Callers:
...
__int64 __fastcall CIconicAnimatedVisual::UpdateDestinationRect(const struct tagRECT *this)
{
  ...
  RectangleGeometry = ResourceHelper::CreateRectangleGeometry(
                        this + 22,
                        (struct CRectangleGeometryProxy **)&this[21].right);
      ...
      if ( v6 )
      {
        if ( *(_QWORD *)&this[20].right )
        {
          ...
          *(float *)&v32[3] = (float)v21 + v19;
          v23 = (*(__int64 (__fastcall **)(_QWORD, _QWORD, _DWORD *))(**(_QWORD **)(v6 + 16) + 320LL))(
                  *(_QWORD *)(v6 + 16),
                  *(unsigned int *)(v6 + 24),
                  v32);
          v5 = v23;
          if ( v23 >= 0 )
          {
            ...
            v33[1] = (double)v27;
            v30 = (*(__int64 (__fastcall **)(_QWORD, _QWORD, double *))(**(_QWORD **)(v29 + 16) + 328LL))(
                    *(_QWORD *)(v29 + 16),
                    *(unsigned int *)(v29 + 24),
                    v33);
            v5 = v30;
