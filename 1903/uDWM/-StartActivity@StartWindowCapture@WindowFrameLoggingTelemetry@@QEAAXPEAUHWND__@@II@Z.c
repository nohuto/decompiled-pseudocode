/*
 * XREFs of ?StartActivity@StartWindowCapture@WindowFrameLoggingTelemetry@@QEAAXPEAUHWND__@@II@Z @ 0x180086C98
 * Callers:
        ...
        int a4)
{
    ...
    && (*((_QWORD *)v8 + 3) & 0x200000000000LL) == *((_QWORD *)v8 + 3) )
  {
    ...
    TlgWrite(v8, &unk_1800C80B9, (LPCGUID)(*((_QWORD *)this + 6) + 8LL), v10, 7u, &pData);
  }
  if ( !*((_DWORD *)this + 8) )
