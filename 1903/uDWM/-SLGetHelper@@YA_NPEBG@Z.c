/*
 * XREFs of ?SLGetHelper@@YA_NPEBG@Z @ 0x180043C5C
 * Callers:
 ...
 *     RtlULongLongAdd @ 0x180043D38 (RtlULongLongAdd.c)
 *     RtlUIntAdd @ 0x180043D58 (RtlUIntAdd.c)
 *     ?Attach@?$SP@EV?$SP_HLOCAL@E@@@@QEAAXPEAE@Z @ 0x18004C6E4 (-Attach@-$SP@EV-$SP_HLOCAL@E@@@@QEAAXPEAE@Z.c)
 *     ?Reset@?$SP@EV?$SP_HLOCAL@E@@@@QEAAXXZ @ 0x18004C710 (-Reset@-$SP@EV-$SP_HLOCAL@E@@@@QEAAXXZ.c)
 *     ?MemoryAlloc@@YAPEAX_K@Z @ 0x18004D9E8 (-MemoryAlloc@@YAPEAX_K@Z.c)
...
LABEL_719:
                  ...
                  *(_QWORD *)(pcchLength + v499) = v548;
                  ...
                  v896 = v790;
                  v854 = v549;
                  v897 = &qword_1800DB5E0;
                  v898 = 8LL;
                  v900 = 160LL;
                  v899 = xmmword_1800DB540;
                  v551 = GetProcessHeap();
                  ...
                  if ( v552 )
                  {
                    ...
                    *((_QWORD *)v553 + 1) = v555;
                    ...
                    if ( !v557 )
                      goto LABEL_729;
                    *((_QWORD *)v553 + 3) = v557;
                    *v557 = xmmword_1800DB540[0];
                    v557[1] = xmmword_1800DB540[1];
                    v557[2] = xmmword_1800DB540[2];
                    v557[3] = xmmword_1800DB540[3];
                    v557[4] = xmmword_1800DB540[4];
                    v557[5] = xmmword_1800DB540[5];
                    v557[6] = xmmword_1800DB540[6];
                    v557[7] = xmmword_1800DB540[7];
                    v557[8] = xmmword_1800DB540[8];
                    v557[9] = xmmword_1800DB540[9];
                    v553[8] = 8;
                    v558 = GetProcessHeap();
              ...
              if ( v123 )
              {
                ...
                if ( v121 && (v785 = MemoryAlloc(v121 + 8LL), (v135 = (char *)v785) != 0LL) )
                {
                  ...
                  *(_QWORD *)&v135[v134] = v137;
                  ...
                  v876 = (char *)(v134 + 8);
                  v878 = 8LL;
                  v895 = &qword_1800DB5E0;
                  v880 = 160LL;
                  v879 = xmmword_1800DB540;
                  v186 = GetProcessHeap();
                  ...
                  if ( v187 )
                  {
                    ...
                    *((_QWORD *)v188 + 1) = v190;
                    ...
                    if ( !v192 )
                      goto LABEL_233;
                    *((_QWORD *)v188 + 3) = v192;
                    *v192 = xmmword_1800DB540[0];
                    v192[1] = xmmword_1800DB540[1];
                    v192[2] = xmmword_1800DB540[2];
                    v192[3] = xmmword_1800DB540[3];
                    v192[4] = xmmword_1800DB540[4];
                    v192[5] = xmmword_1800DB540[5];
                    v192[6] = xmmword_1800DB540[6];
                    v192[7] = xmmword_1800DB540[7];
                    v192[8] = xmmword_1800DB540[8];
                    v192[9] = xmmword_1800DB540[9];
                    v188[8] = 8;
                    v193 = GetProcessHeap();
