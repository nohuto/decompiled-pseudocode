/*
 * XREFs of ?_AddBorderInstructions@CThumbnailVisual@@AEAAJXZ @ 0x18008CC9C
 * Callers:
...
LABEL_14:
  ...
  if ( ThemeColor >= 0 )
  {
    ...
    if ( ThemeInt >= 0 )
    {
      ...
      {
        MilInstrumentationCheckHR_MaybeFailFast(0x14u, 0LL, 0LL, v8, 0x530u);
      }
    }
    else
    {
      MilInstrumentationCheckHR_MaybeFailFast(0x14u, 0LL, 0LL, ThemeInt, 0x52Eu);
    }
  }
  else
  {
    MilInstrumentationCheckHR_MaybeFailFast(0x14u, 0LL, 0LL, ThemeColor, 0x52Du);
  }
  return v4;
}
