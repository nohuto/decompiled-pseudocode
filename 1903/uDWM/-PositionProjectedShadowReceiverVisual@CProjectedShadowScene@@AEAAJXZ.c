/*
 * XREFs of ?PositionProjectedShadowReceiverVisual@CProjectedShadowScene@@AEAAJXZ @ 0x1800B4F54
 * Callers:
...
__int64 __fastcall CProjectedShadowScene::PositionProjectedShadowReceiverVisual(CProjectedShadowScene *this)
{
  ...
  int v6; // edi
  int v7; // esi
  __int64 (__fastcall *v8)(__int64, int *); // rax
  unsigned int v9; // eax
  __m128i v10; // xmm0
  int v11; // eax
  __m128 v12; // xmm0
...
LABEL_12:
    ...
    v15 = 0;
    v8 = *(__int64 (__fastcall **)(__int64, int *))(*(_QWORD *)v18 + 168LL);
    *(_QWORD *)v14 = _mm_unpacklo_ps(_mm_cvtepi32_ps(v4), _mm_cvtepi32_ps(v5)).m128_u64[0];
    v1 = v8(v18, v14);
    v2 = v1;
    if ( v1 < 0 )
    {
