/*
 * XREFs of ?AdjustWindowColorization@CGlassColorizationParameters@@QEAAXPEBTGpCC@@MU?$TMILFlagsEnum@W4FlagsEnum@ColorizationFlags@@@@@Z @ 0x18001D0D0
 * Callers:
 ...
 *     ??$max@M@@YAMMM@Z @ 0x18001D780 (--$max@M@@YAMMM@Z.c)
 *     ??$min@M@@YAMMM@Z @ 0x18001D790 (--$min@M@@YAMMM@Z.c)
