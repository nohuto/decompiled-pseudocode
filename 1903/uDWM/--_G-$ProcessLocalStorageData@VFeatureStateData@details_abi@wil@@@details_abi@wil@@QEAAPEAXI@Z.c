/*
 * XREFs of ??_G?$ProcessLocalStorageData@VFeatureStateData@details_abi@wil@@@details_abi@wil@@QEAAPEAXI@Z @ 0x180076350
 * Callers:
 ...
 *     ?ProcessShutdown@FeatureStateData@details_abi@wil@@QEAAXXZ @ 0x180077940 (-ProcessShutdown@FeatureStateData@details_abi@wil@@QEAAXXZ.c)
 */
