/*
 * XREFs of ?CreateDesktopAnimationComponent@CTransitionVisualController@@QEAAJPEAVCWindowData@@HAEBUtagRECT@@_N2PEAVCStoryboard@@PEAPEAVCAnimationComponent@@@Z @ 0x1800A32E8
 * Callers:
...
LABEL_25:
    ...
    *(_QWORD *)(v21 + 48) = v52;
    ...
    if ( (*((_DWORD *)a2 + 153) & 0x1000000) != 0 && EqualRect((const RECT *)((char *)a2 + 616), &rc2)
      || (*((_DWORD *)a2 + 153) & 0x800000) != 0 && EqualRect((const RECT *)((char *)a2 + 648), &rc2) )
    {
      v32 = rc2;
      v54 = rc2;
    }
    ...
    *((_QWORD *)v42 + 119) = v49;
    if ( v55 )
    {
      *(_OWORD *)((char *)v42 + 888) = *(_OWORD *)((char *)a2 + 616);
      *(_OWORD *)((char *)v42 + 824) = *(_OWORD *)((char *)a2 + 616);
      CVisual::SetDirtyFlags((CAnimatedTransitionVisual *)((char *)v42 + 8), 4096);
      *(_OWORD *)((char *)v42 + 904) = *(_OWORD *)((char *)a2 + 648);
      CVisual::SetDirtyFlags((CAnimatedTransitionVisual *)((char *)v42 + 8), 4096);
      *((_BYTE *)v42 + 986) = 1;
    }
    if ( !IsRectEmpty((const RECT *)((char *)a2 + 680)) )
    {
      v45 = *(_OWORD *)((char *)a2 + 680);
      *(_DWORD *)(v21 + 68) = 2;
      *(_OWORD *)(v21 + 104) = v45;
    }
