/*
 * XREFs of ?SetVisualStates@CButton@@QEAAJAEBVCBitmapSourceArray@@0PEAVCBitmapSource@@M@Z @ 0x180014C98
 * Callers:
        ...
        float a5)
{
  ...
  if ( v30 < 0 )
  {
    MilInstrumentationCheckHR_MaybeFailFast(0x14u, 0LL, 0, v30, 0x4Cu, v31);
    return v6;
  }
  v8 = 1;
LABEL_9:
...
LABEL_22:
    ...
    if ( v28 < 0 )
    {
      MilInstrumentationCheckHR_MaybeFailFast(0x14u, 0LL, 0, v28, 0x52u, v31);
      return v6;
    }
    v8 = 1;
    goto LABEL_17;
