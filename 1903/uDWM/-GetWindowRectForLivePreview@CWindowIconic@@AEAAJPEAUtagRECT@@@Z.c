/*
 * XREFs of ?GetWindowRectForLivePreview@CWindowIconic@@AEAAJPEAUtagRECT@@@Z @ 0x18009374C
 * Callers:
...
__int64 __fastcall CWindowIconic::GetWindowRectForLivePreview(CWindowIconic *this, struct tagRECT *a2, __int64 a3)
{
  ...
  v4 = 0;
  v5 = *((_QWORD *)this + 9);
  if ( (*(_BYTE *)(v5 + 606) & 1) == 0 || (MDIOwner = CWindowData::GetMDIOwner((HWND *)v5)) == 0LL )
  {
