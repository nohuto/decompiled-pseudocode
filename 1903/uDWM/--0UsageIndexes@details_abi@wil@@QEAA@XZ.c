/*
 * XREFs of ??0UsageIndexes@details_abi@wil@@QEAA@XZ @ 0x1800344F8
 * Callers:
 *     ?RecordUsage@FeatureStateData@details_abi@wil@@QEAAXXZ @ 0x180034498 (-RecordUsage@FeatureStateData@details_abi@wil@@QEAAXXZ.c)
