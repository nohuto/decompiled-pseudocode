/*
 * XREFs of ?MoveTransitionAndTouchVisualToFront@CWindowList@@QEAAJXZ @ 0x180018538
 * Callers:
...
__int64 __fastcall CWindowList::MoveTransitionAndTouchVisualToFront(CWindowList *this)
{
  ...
  v2 = 0;
  v4 = *((_QWORD *)CDesktopManager::s_pDesktopManagerInstance + 25);
  v5 = 1;
  if ( v4 )
  {
  ...
  if ( v6 )
  {
    ...
    if ( _InterlockedExchangeAdd((volatile signed __int32 *)(v6 + 116), 0xFFFFFFFF) == 1 )
    {
      *(_QWORD *)v6 = &CAnimationEngine::`vftable';
      DynArrayImpl<0>::~DynArrayImpl<0>((_QWORD *)(v6 + 72));
      DynArrayImpl<0>::~DynArrayImpl<0>((_QWORD *)(v6 + 40));
