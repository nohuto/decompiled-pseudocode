/*
 * XREFs of ?SetBitmapSource@CImage@@QEAAJPEAVCBitmapSource@@@Z @ 0x18000C9F4
 * Callers:
 ...
 *     ?UpdateTransition@CPenPressHoldVisual@@MEAAJXZ @ 0x18009F590 (-UpdateTransition@CPenPressHoldVisual@@MEAAJXZ.c)
