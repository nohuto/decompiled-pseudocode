/*
 * XREFs of ?DoStackCapture@@YAXJIPEAX@Z @ 0x1800B764C
 * Callers:
 *     ?DoStackCaptureDirect@@YAXJI@Z @ 0x18004FBB4 (-DoStackCaptureDirect@@YAXJI@Z.c)
...
void __fastcall DoStackCapture(int a1, int a2, PVOID a3)
{
  ...
  if ( !_InterlockedCompareExchange(&dword_1800DC1A4, 1, 0) )
  {
