/*
 * XREFs of ?StopActivity@StopDisplayCapture@WindowFrameLoggingTelemetry@@MEAAXXZ @ 0x180087EE0
 * Callers:
 *     <none>
 * Callees:
        ...
        WindowFrameLoggingTelemetry::StopDisplayCapture *this)
{
  ...
  if ( v4 )
  {
      ...
      && (*(_QWORD *)(v7 + 24) & 0x200000000000LL) == *(_QWORD *)(v7 + 24) )
    {
      ...
      TlgWrite(v14, &unk_1800C81EA, (LPCGUID)(*((_QWORD *)this + 6) + 8LL), 0LL, 0x12u, &pData);
    }
  }
  else
  {
      ...
      && (*((_QWORD *)v15 + 3) & 0x200000000000LL) == *((_QWORD *)v15 + 3) )
    {
      ...
      v18 = CurrentThreadId;
      v29 = &v18;
      TlgWrite(v15, &unk_1800C8314, (LPCGUID)(*((_QWORD *)this + 6) + 8LL), 0LL, 5u, &v24);
    }
  }
  if ( *((_DWORD *)this + 8) )
