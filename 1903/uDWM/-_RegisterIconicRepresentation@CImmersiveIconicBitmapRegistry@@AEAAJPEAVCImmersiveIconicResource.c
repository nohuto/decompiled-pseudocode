/*
 * XREFs of ?_RegisterIconicRepresentation@CImmersiveIconicBitmapRegistry@@AEAAJPEAVCImmersiveIconicResource@1@PEAUHWND__@@HW4DEVICE_SCALE_FACTOR@@_NPEAW4IconicRepresentationType@@4@Z @ 0x180082CFC
 * Callers:
  ...
  else
  {
    *((_BYTE *)a2 + 40) = 1;
    ...
    if ( (Microsoft_Windows_Dwm_UdwmEnableBits & 1) != 0 )
      McTemplateU0qp((__int64)v18, (int)&UdwmManageIconicThumbnail_Info, 3, *(_QWORD *)a2);
    v11 = 1;
  }
  *(_DWORD *)a7 = v11;
  ++*((_DWORD *)a2 + 11);
  ...
  if ( (Microsoft_Windows_Dwm_UdwmEnableBits & 1) != 0 )
    McTemplateU0qp((__int64)a7, (int)&UdwmSelectIconicRepresentation_Info, v19, a3);
  return 0LL;
}
