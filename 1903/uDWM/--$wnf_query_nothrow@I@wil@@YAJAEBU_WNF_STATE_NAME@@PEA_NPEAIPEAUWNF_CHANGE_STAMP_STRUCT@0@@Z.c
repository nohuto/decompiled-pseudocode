/*
 * XREFs of ??$wnf_query_nothrow@I@wil@@YAJAEBU_WNF_STATE_NAME@@PEA_NPEAIPEAUWNF_CHANGE_STAMP_STRUCT@0@@Z @ 0x18008442C
 * Callers:
 ...
 *     ?Log_HrIfMsg@in1diag3@details@wil@@YA_NPEAXIPEBDJ_N1ZZ @ 0x1800846FC (-Log_HrIfMsg@in1diag3@details@wil@@YA_NPEAXIPEBDJ_N1ZZ.c)
 */
...
__int64 __fastcall wil::wnf_query_nothrow<unsigned int>(__int64 a1, char *a2, __int64 a3, __int64 a4)
{
  ...
  v5 = 0;
  *a2 = 0;
  v6 = NtQueryWnfStateData(&WNF_EOA_MAGNIFIER_RENDERING_INPUT, 0LL, 0LL, &v11) | 0x10000000;
