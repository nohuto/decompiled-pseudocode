/*
 * XREFs of ?Create@CCompressedSourceBitmap@@SAJPEAUIWICImagingFactory@@PEBXKNNW4DXGI_FORMAT@@W4DXGI_ALPHA_MODE@@PEAPEAVIBitmapSource@@@Z @ 0x1800480E8
 * Callers:
 ...
 *     ?InternalAddRef@CMILCOMBase@@QEAAKXZ @ 0x18004BCEC (-InternalAddRef@CMILCOMBase@@QEAAKXZ.c)
        ...
        struct IBitmapSource **a8)
{
  ...
  *a8 = 0LL;
  ...
  if ( v14 )
  {
    ...
    if ( v15 < 0 )
    {
      MilInstrumentationCheckHR_MaybeFailFast(0x14u, 0LL, 0, v15, 0x25u, v20);
    }
    else
    {
      ...
      if ( v17 < 0 )
      {
        MilInstrumentationCheckHR_MaybeFailFast(0x14u, 0LL, 0, v17, 0x27u, v20);
      }
      else
      {
  ...
  {
    v16 = -2147024882;
    MilInstrumentationCheckHR_MaybeFailFast(0x14u, 0LL, 0, -2147024882, 0x22u, v20);
  }
  return v16;
}
