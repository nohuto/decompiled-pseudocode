/*
 * XREFs of ?QueryInterface@GaussianBlurEffect@Effects@Composition@UI@Microsoft@@UEAAJAEBU_GUID@@PEAPEAX@Z @ 0x18003E2B0
 * Callers:
 *     ?QueryInterface@GaussianBlurEffect@Effects@Composition@UI@Microsoft@@W7EAAJAEBU_GUID@@PEAPEAX@Z @ 0x1800502C0 (-QueryInterface@GaussianBlurEffect@Effects@Composition@UI@Microsoft@@W7EAAJAEBU_GUID@@PEAPEAX@Z.c)
 *     ?QueryInterface@GaussianBlurEffect@Effects@Composition@UI@Microsoft@@WBA@EAAJAEBU_GUID@@PEAPEAX@Z @ 0x1800502D0 (-QueryInterface@GaussianBlurEffect@Effects@Composition@UI@Microsoft@@WBA@EAAJAEBU_GUID@@PEAPEAX@.c)
 *     ?QueryInterface@GaussianBlurEffect@Effects@Composition@UI@Microsoft@@WBI@EAAJAEBU_GUID@@PEAPEAX@Z @ 0x1800502E0 (-QueryInterface@GaussianBlurEffect@Effects@Composition@UI@Microsoft@@WBI@EAAJAEBU_GUID@@PEAPEAX@.c)
 *     ?QueryInterface@GaussianBlurEffect@Effects@Composition@UI@Microsoft@@WCA@EAAJAEBU_GUID@@PEAPEAX@Z @ 0x1800502F0 (-QueryInterface@GaussianBlurEffect@Effects@Composition@UI@Microsoft@@WCA@EAAJAEBU_GUID@@PEAPEAX@.c)
 * Callees:
