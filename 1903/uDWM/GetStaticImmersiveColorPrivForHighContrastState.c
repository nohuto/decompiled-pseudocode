/*
 * XREFs of GetStaticImmersiveColorPrivForHighContrastState @ 0x18004FC6C
 * Callers:
 ...
 *     ?GetPillarBoxColor@CImmersiveState@@SAXPEAU_D3DCOLORVALUE@@@Z @ 0x1800B1B20 (-GetPillarBoxColor@CImmersiveState@@SAXPEAU_D3DCOLORVALUE@@@Z.c)
 * Callees:
 *     <none>
 */
...
__int64 __fastcall GetStaticImmersiveColorPrivForHighContrastState(int a1, char a2)
{
  ...
  if ( (unsigned int)(a1 - 210) <= 0x3F8 )
  {
    ...
    {
      return *(unsigned int *)&aIptipMainWindo[2 * a1 + 4];
    }
  }
  return v2;
}
