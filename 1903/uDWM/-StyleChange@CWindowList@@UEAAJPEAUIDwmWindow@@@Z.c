/*
 * XREFs of ?StyleChange@CWindowList@@UEAAJPEAUIDwmWindow@@@Z @ 0x180026D90
 * Callers:
 *     <none>
 * Callees:
...
LABEL_23:
  v27 = RtlIsGenericTableEmpty(v23) == 0;
  if ( v24 != v27 )
  {
  ...
  wil::Feature<__WilFeatureTraits_Feature_TabShell>::ReportUsageToService((__int64)v26, 3u, v28);
LABEL_27:
