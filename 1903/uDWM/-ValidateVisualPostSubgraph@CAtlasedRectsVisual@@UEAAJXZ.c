/*
 * XREFs of ?ValidateVisualPostSubgraph@CAtlasedRectsVisual@@UEAAJXZ @ 0x180033D70
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall CAtlasedRectsVisual::ValidateVisualPostSubgraph(CAtlasedRectsVisual *this, __int64 a2, __int64 a3)
{
  ...
  if ( (v3 & 0x100) != 0 )
  {
    ...
    if ( v20 < 0 )
    {
      MilInstrumentationCheckHR_MaybeFailFast(0x14u, 0LL, 0, v20, 0x3B8u, v25);
...
LABEL_9:
    ...
    else
    {
      ...
      if ( v10 == 0x7FFFFFFF )
      {
        HIDWORD(v27) = v14 - v12 - v9;
        goto LABEL_13;
      }
      HIDWORD(v28) = v14 - v10 - v9;
    }
...
LABEL_13:
    ...
    if ( SHIDWORD(v28) <= 0 )
      HIDWORD(v28) = 0;
    if ( __PAIR64__(HIDWORD(v27), v11) != *(_QWORD *)(v6 + 16) )
    {
      *(_DWORD *)(v6 + 96) |= 1u;
      v17 = *(_QWORD *)(v6 + 80);
      *(_QWORD *)(v6 + 16) = v27;
