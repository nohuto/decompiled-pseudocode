/*
 * XREFs of ?StopActivity@TriggerClock@AnimationClockLoggingTelemetry@@MEAAXXZ @ 0x180008D80
 * Callers:
 *     <none>
 * Callees:
 ...
 *     ?zInternalStop@?$ActivityBase@VWindowFrameLogging@@$00$0A@$04$0A@U_TlgReflectorTag_Param0IsProviderType@@@wil@@QEAAXXZ @ 0x18000A50C (-zInternalStop@-$ActivityBase@VWindowFrameLogging@@$00$0A@$04$0A@U_TlgReflectorTag_Param0IsProvi.c)
        ...
        AnimationClockLoggingTelemetry::TriggerClock *this)
{
  ...
  if ( v4 )
  {
    if ( **(_DWORD **)(v6 + 8) > 4u )
    {
      ...
      v35 = &`AnimationClockLoggingTelemetry::TriggerClock::StopActivity'::`19'::_TlgActivityPrivacyTag;
      v36 = 8LL;
      v37 = &v26;
      v21 = v4[1];
      v39 = &v21;
      ...
      v62 = 4LL;
      TlgCreateSz(&v63, v17);
      TlgWrite(v18, &unk_1800C9C2E, (LPCGUID)(*((_QWORD *)this + 6) + 8LL), 0LL, 0x15u, &v34);
    }
  }
  else
  {
    ...
    {
      v29 = 8LL;
      v28 = &`AnimationClockLoggingTelemetry::TriggerClock::StopActivity'::`28'::_TlgActivityPrivacyTag;
      ...
      v19 = CurrentThreadId;
      v32 = &v19;
      TlgWrite(v7, &unk_1800C9D75, (LPCGUID)(*((_QWORD *)this + 6) + 8LL), 0LL, 5u, &pData);
    }
  }
  if ( *((_DWORD *)this + 8) )
