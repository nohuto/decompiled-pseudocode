/*
 * XREFs of ?GetPillarBoxColor@CImmersiveState@@SAXPEAU_D3DCOLORVALUE@@@Z @ 0x1800B1B20
 * Callers:
 *     ?SetupInstructions@CIconicAnimatedVisual@@AEAAJXZ @ 0x1800B1FF0 (-SetupInstructions@CIconicAnimatedVisual@@AEAAJXZ.c)
 * Callees:
 *     GetStaticImmersiveColorPrivForHighContrastState @ 0x18004FC6C (GetStaticImmersiveColorPrivForHighContrastState.c)
 */
