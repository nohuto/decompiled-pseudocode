/*
 * XREFs of ?_TriggerAnimation@CAnimationClock@@AEAAJXZ @ 0x18000920C
 * Callers:
...
__int64 __fastcall CAnimationClock::_TriggerAnimation(CAnimationClock *this)
{
  ...
  *(_OWORD *)&hObject[1] = v2;
  ...
  wil::ActivityBase<AnimationClockLogging,0,0,4,0,_TlgReflectorTag_Param0IsProviderType>::Stop(v11, (unsigned int)v3);
LABEL_4:
