/*
 * XREFs of ?CloneVisualTree@CAtlasedRectsVisual@@UEAAJPEAPEAVCVisual@@_N11@Z @ 0x1800165A0
 * Callers:
 *     <none>
 * Callees:
 ...
 *     ?SetMarginClip@CAtlasedImage@@QEAAXPEAUtagRECT@@@Z @ 0x180002E74 (-SetMarginClip@CAtlasedImage@@QEAAXPEAUtagRECT@@@Z.c)
...
LABEL_47:
  ...
  while ( 1 )
  {
    ...
    {
      *((RECT *)v18 + 3) = v28[3];
      CAtlasedImage::SetDirtyFlags(v18, 1u, 0x2000u);
    }
    v29 = this[30];
    ...
    {
      CAtlasedImage::SetDirtyFlags(v18, 2u, 0x2000u);
      *((_DWORD *)v18 + 17) = v31;
      v29 = this[30];
    }
