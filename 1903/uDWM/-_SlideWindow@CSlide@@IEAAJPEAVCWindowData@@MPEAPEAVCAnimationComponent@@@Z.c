/*
 * XREFs of ?_SlideWindow@CSlide@@IEAAJPEAVCWindowData@@MPEAPEAVCAnimationComponent@@@Z @ 0x1800AAE6C
 * Callers:
 ...
 *     ?GetWindowBeginPosition@CWindowPropertyTracker@@QEAAJPEAUHWND__@@PEAUtagPOINT@@@Z @ 0x1800AE318 (-GetWindowBeginPosition@CWindowPropertyTracker@@QEAAJPEAUHWND__@@PEAUtagPOINT@@@Z.c)
 */
        ...
        struct CAnimationComponent **a4)
{
  ...
  if ( v10 >= 0 )
  {
    ...
    if ( (v15 & 0x800000) != 0 )
      v23 = *(struct tagRECT *)((char *)a2 + 664);
  ...
  {
    MilInstrumentationCheckHR_MaybeFailFast(0x14u, &CStoryboard::MILINSTRUMENTATIONHRESULTLIST, 1LL, v10, 0xDDu);
  }
  if ( v12 < 0 && v11 )
