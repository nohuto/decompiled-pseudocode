/*
 * XREFs of ?UnregisterThumbnail@CWindowList@@AEAAJPEAVCThumbnailData@@@Z @ 0x1800057C8
 * Callers:
        ...
        if ( v16 )
        {
          ...
          if ( v17 >= 0 )
          {
            if ( *(_DWORD *)(*(_QWORD *)(v14 + 528) + 72LL) == (*(_QWORD *)(v14 + 472) != 0LL) )
            {
              ...
              v2 = v18;
              if ( v18 < 0 )
                MilInstrumentationCheckHR_MaybeFailFast(0x14u, 0LL, 0, v18, 0x6A7u, v19);
            }
          }
          else
          {
            MilInstrumentationCheckHR_MaybeFailFast(0x14u, 0LL, 0, v17, 0x6A0u, v19);
          }
        }
        if ( v2 < 0 )
        {
