/*
 * XREFs of ??0WindowFrame@CTopLevelWindow@@QEAA@XZ @ 0x180046B48
 * Callers:
 *     ?EnsureWindowFrames@CTopLevelWindow@@CAJXZ @ 0x18002C9F0 (-EnsureWindowFrames@CTopLevelWindow@@CAJXZ.c)
 * Callees:
 *     ??0DPIImages@WindowFrame@CTopLevelWindow@@QEAA@XZ @ 0x180046810 (--0DPIImages@WindowFrame@CTopLevelWindow@@QEAA@XZ.c)
 */
