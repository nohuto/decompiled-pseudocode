/*
 * XREFs of ?_UpdateCaptureControllerProperty@CProjectionBorderManager@@AEAAJP81@EAAJPEAUHWND__@@I@Z0@Z @ 0x18008A59C
 * Callers:
 ...
 *     ?UpdateCaptureControllerSourceOffset@CProjectionBorderManager@@UEAAJPEAUHWND__@@@Z @ 0x180088CB0 (-UpdateCaptureControllerSourceOffset@CProjectionBorderManager@@UEAAJPEAUHWND__@@@Z.c)
 *     ?UpdateCaptureControllerTransform@CProjectionBorderManager@@UEAAJPEAUHWND__@@@Z @ 0x180088CD0 (-UpdateCaptureControllerTransform@CProjectionBorderManager@@UEAAJPEAUHWND__@@@Z.c)
 * Callees:
