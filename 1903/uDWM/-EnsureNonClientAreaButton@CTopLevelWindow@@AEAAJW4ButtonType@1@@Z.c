/*
 * XREFs of ?EnsureNonClientAreaButton@CTopLevelWindow@@AEAAJW4ButtonType@1@@Z @ 0x180014BB4
 * Callers:
...
__int64 __fastcall CTopLevelWindow::EnsureNonClientAreaButton(__int64 a1, int a2)
{
  ...
  if ( (v4 & dword_1800C4880[3 * a2]) != 0 )
  {
    if ( !v7 )
    {
      ...
      if ( v10 < 0 )
      {
        MilInstrumentationCheckHR_MaybeFailFast(0x14u, 0LL, 0, v10, 0x9FDu, v13);
        return v3;
      }
      ...
      if ( inserted < 0 )
      {
        MilInstrumentationCheckHR_MaybeFailFast(0x14u, 0LL, 0, inserted, 0x9FFu, v13);
        return v3;
      }
      *((_DWORD *)*v6 + 48) = dword_1800C4880[v5 + 2];
      v4 = *(_DWORD *)(a1 + 584);
      v7 = *v6;
    }
    v9 = (v4 & dword_1800C4880[v5 + 1]) != 0;
  ...
  else if ( v7 )
  {
    ...
    if ( v12 < 0 )
    {
      MilInstrumentationCheckHR_MaybeFailFast(0x14u, 0LL, 0, v12, 0xA0Au, v13);
    }
    else if ( *v6 )
    {
