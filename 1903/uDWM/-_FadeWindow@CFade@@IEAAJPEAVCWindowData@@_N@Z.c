/*
 * XREFs of ?_FadeWindow@CFade@@IEAAJPEAVCWindowData@@_N@Z @ 0x18004CC04
 * Callers:
...
LABEL_10:
  if ( (*((_DWORD *)a2 + 153) & 0x20000) != 0 )
  {
    ...
    v27 = CStoryboard::_CreateAndAddAnimationComponentControlReuse(this, a2, 1, v26, &rc, 0LL, -1, 1, &v31);
    if ( v27 >= 0 )
    {
  ...
  else
  {
    ...
    v14 = CStoryboard::_CreateAndAddAnimationComponentControlReuse(this, a2, 1, v13, 0LL, 0LL, -1, 1, &v31);
    if ( v14 >= 0 )
    {
      v15 = (struct tagPOINT **)v31;
