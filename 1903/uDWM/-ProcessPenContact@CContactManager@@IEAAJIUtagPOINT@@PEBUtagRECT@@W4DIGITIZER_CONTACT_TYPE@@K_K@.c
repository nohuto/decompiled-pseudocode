/*
 * XREFs of ?ProcessPenContact@CContactManager@@IEAAJIUtagPOINT@@PEBUtagRECT@@W4DIGITIZER_CONTACT_TYPE@@K_K@Z @ 0x180098CEC
 * Callers:
 ...
 *     ?PlaceVisuals@CPenBarrelKeyVisual@@IEAAJXZ @ 0x18009E63C (-PlaceVisuals@CPenBarrelKeyVisual@@IEAAJXZ.c)
