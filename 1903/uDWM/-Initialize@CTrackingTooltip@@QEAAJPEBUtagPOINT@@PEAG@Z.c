/*
 * XREFs of ?Initialize@CTrackingTooltip@@QEAAJPEBUtagPOINT@@PEAG@Z @ 0x18009E918
 * Callers:
 ...
 * Callees:
 *     ?CreateTrackingTooltip@CTrackingTooltip@@IEAAPEAUHWND__@@PEAG@Z @ 0x18009E840 (-CreateTrackingTooltip@CTrackingTooltip@@IEAAPEAUHWND__@@PEAG@Z.c)
