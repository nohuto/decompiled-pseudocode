/*
 * XREFs of ??_ECAnimatedTransitionVisual@@MEAAPEAXI@Z @ 0x180032EA8
 * Callers:
 *     ??_ECAnimatedTransitionVisual@@O7EAAPEAXI@Z @ 0x18004FE80 (--_ECAnimatedTransitionVisual@@O7EAAPEAXI@Z.c)
 * Callees:
