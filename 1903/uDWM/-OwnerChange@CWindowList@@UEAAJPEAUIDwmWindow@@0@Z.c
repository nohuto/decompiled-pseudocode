/*
 * XREFs of ?OwnerChange@CWindowList@@UEAAJPEAUIDwmWindow@@0@Z @ 0x180022E60
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall CWindowList::OwnerChange(CWindowList *this, struct IDwmWindow *a2, struct IDwmWindow *a3)
{
  ...
  struct CWindowData *v19; // [rsp+68h] [rbp+10h] BYREF
  ...
  {
    v8 = -2147024882;
    MilInstrumentationCheckHR_MaybeFailFast(0x14u, 0LL, 0, -2147024882, 0x891u, v18);
    v11 = -2147024882;
    goto LABEL_18;
  }
  *((_QWORD *)v15 + 3) = a2;
  ...
  *((_QWORD *)v10 + 5) = (*(__int64 (__fastcall **)(struct IDwmWindow *))(*(_QWORD *)a2 + 24LL))(a2);
  ...
  v8 = v16;
  if ( v16 < 0 )
    MilInstrumentationCheckHR_MaybeFailFast(0x14u, 0LL, 0, v16, 0x895u, v18);
  else
LABEL_4:
    v7 = v10;
  v11 = v8;
  ...
  {
LABEL_18:
    MilInstrumentationCheckHR_MaybeFailFast(0x14u, 0LL, 0, v8, 0xE34u, v18);
    goto LABEL_7;
  }
  if ( v7 )
  {
    ...
    if ( a3 )
    {
      SyncedWindowData = CWindowList::GetSyncedWindowData(this, a3, 0, &v19);
    ...
    v17 = 3648;
LABEL_20:
    MilInstrumentationCheckHR_MaybeFailFast(0x14u, 0LL, 0, SyncedWindowData, v17, v18);
  }
LABEL_7:
