/*
 * XREFs of ?RestoreWindow@CTransitionVisualController@@QEAAXPEAVCWindowData@@_N@Z @ 0x18000C4EC
 * Callers:
 ...
 *     CTransitionVisualController::ForEachOwnedWindow__lambda_c41abd0b3c99427b9cbe9a707708bfad___ @ 0x18000C0D0 (CTransitionVisualController--ForEachOwnedWindow__lambda_c41abd0b3c99427b9cbe9a707708bfad___.c)
        ...
        char a3)
{
  ...
  if ( *((_QWORD *)a2 + 3) )
  {
    ...
    if ( v7 >= 0 )
    {
      ...
      *((_DWORD *)a2 + 153) = v8 & 0xFFEFFFFF;
      if ( v9 && (*((_BYTE *)v9 + 241) & 1) != 0 )
      {
        v10 = *((_DWORD *)this + 34);
        v11 = 0LL;
        v12 = 1;
...
LABEL_11:
    ...
    {
      v18 = this;
      CTransitionVisualController::ForEachOwnedWindow__lambda_c41abd0b3c99427b9cbe9a707708bfad___((__int64)a2, &v18, 1);
    }
  }
}
