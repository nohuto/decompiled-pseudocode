/*
 * XREFs of ?Initialize@CDesktopThumbnailBase@@MEAAJXZ @ 0x1800AF510
 * Callers:
 *     <none>
 * Callees:
...
LABEL_13:
  ...
  {
    v8 = DynArrayImpl<0>::AddMultipleAndSet((__int64)CDesktopManager::s_pDesktopManagerInstance + 752, 8, 1, &v9);
    v3 = v8;
    if ( v8 < 0 )
  ...
  else
  {
    ...
    *(_QWORD *)(*((_QWORD *)CDesktopManager::s_pDesktopManagerInstance + 94)
              + 8LL * *((unsigned int *)CDesktopManager::s_pDesktopManagerInstance + 194)) = v9;
    *((_DWORD *)v4 + 194) = v6;
  }
  *((_BYTE *)this + 84) |= 8u;
  return v3;
