/*
 * XREFs of ?_Update3DResources@CAnimatedTransitionVisual@@IEAAJXZ @ 0x1800A1384
 * Callers:
 ...
 *     ?PerspectiveProjection@Matrix4x4F@D2D1@@SA?AV12@M@Z @ 0x1800A0404 (-PerspectiveProjection@Matrix4x4F@D2D1@@SA-AV12@M@Z.c)
 *     ?SetProduct@Matrix4x4F@D2D1@@QEAAXAEBV12@0@Z @ 0x1800A080C (-SetProduct@Matrix4x4F@D2D1@@QEAAXAEBV12@0@Z.c)
...
__int64 __fastcall CAnimatedTransitionVisual::_Update3DResources(CAnimatedTransitionVisual *this)
{
  ...
  CTransitionVisualController::GetMonitorRectFromRectImpl((const struct tagRECT *)((char *)this + 856), &v20);
  v26 = 0;
  v27 = 1065353216;
  *(_OWORD *)&v19._21 = _xmm;
  *(_OWORD *)&v19._41 = _xmm;
  ...
  if ( v9 >= 0 )
  {
    ...
    if ( v13 >= 0 )
    {
      ...
      if ( v15 >= 0 )
      {
        ...
        v11 = v16;
        if ( v16 < 0 )
          MilInstrumentationCheckHR_MaybeFailFast(0x14u, 0LL, 0LL, v16, 0x70Eu);
      }
      else
      {
        MilInstrumentationCheckHR_MaybeFailFast(0x14u, 0LL, 0LL, v15, 0x70Cu);
      }
    }
    else
    {
      MilInstrumentationCheckHR_MaybeFailFast(0x14u, 0LL, 0LL, v13, 0x708u);
    }
  }
  else
  {
    MilInstrumentationCheckHR_MaybeFailFast(0x14u, 0LL, 0LL, v9, 0x6FFu);
  }
  return v11;
}
