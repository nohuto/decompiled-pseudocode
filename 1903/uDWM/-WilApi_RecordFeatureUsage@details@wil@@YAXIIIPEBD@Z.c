/*
 * XREFs of ?WilApi_RecordFeatureUsage@details@wil@@YAXIIIPEBD@Z @ 0x1800357F4
 * Callers:
 ...
 *     ?RecordSRUMFeatureUsage@details@wil@@YAXIII@Z @ 0x180077D20 (-RecordSRUMFeatureUsage@details@wil@@YAXIII@Z.c)
 * Callees:
