/*
 * XREFs of ?GetSize@CCompoundBitmapLock@@UEAAJPEAI0@Z @ 0x1800B96D0
 * Callers:
 *     ?GetSize@CCompoundBitmapLock@@W7EAAJPEAI0@Z @ 0x1800500A0 (-GetSize@CCompoundBitmapLock@@W7EAAJPEAI0@Z.c)
 * Callees:
 *     <none>
 */
