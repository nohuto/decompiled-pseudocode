/*
 * XREFs of ?EnumerateMonitors@CDesktopManager@@AEAAJPEAPEAVCDWMDisplaySet@@@Z @ 0x18002DA34
 * Callers:
 ...
 *     ?ComputeDisplayBounds@CDWMDisplaySet@@AEAAXXZ @ 0x18002DC04 (-ComputeDisplayBounds@CDWMDisplaySet@@AEAAXXZ.c)
...
LABEL_34:
  ...
  *((_QWORD *)v10 + 1) = *v4;
  ...
  if ( v13 < 0 )
  {
    MilInstrumentationCheckHR_MaybeFailFast(0x14u, &dword_1800C3DE8, 1u, v13, 0x76u, v23);
  }
  else
  {
    ...
    v8 = v14;
    if ( v14 < 0 )
      MilInstrumentationCheckHR_MaybeFailFast(0x14u, &dword_1800C3DE8, 1u, v14, 0x78u, v23);
    else
