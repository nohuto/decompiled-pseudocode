/*
 * XREFs of ?_AcceptBitmap@CImmersiveIconicBitmapRegistry@@AEAAXPEAVCWindowData@@PEAVCBitmapSource@@@Z @ 0x180082BE4
 * Callers:
...
LABEL_8:
  ...
  if ( IconicResourceNoRef )
  {
    *((_BYTE *)IconicResourceNoRef + 40) = 0;
    ...
    {
      v10 = *(_QWORD *)(*((_QWORD *)a2[65] + i) + 96LL);
      if ( v10 )
  ...
  if ( (Microsoft_Windows_Dwm_UdwmEnableBits & 1) != 0 )
    McTemplateU0qp(v10, (int)&UdwmManageIconicThumbnail_Info, 0, a2[5]);
}
