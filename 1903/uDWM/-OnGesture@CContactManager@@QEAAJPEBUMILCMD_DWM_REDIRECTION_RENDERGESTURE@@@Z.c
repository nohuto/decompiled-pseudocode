/*
 * XREFs of ?OnGesture@CContactManager@@QEAAJPEBUMILCMD_DWM_REDIRECTION_RENDERGESTURE@@@Z @ 0x1800973A8
 * Callers:
 ...
 *     ?IsCurrentSessionRemotable@CDesktopManager@@SA_NXZ @ 0x180096E2C (-IsCurrentSessionRemotable@CDesktopManager@@SA_NXZ.c)
