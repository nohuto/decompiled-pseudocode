/*
 * XREFs of ??$CreateProxy@VCRectangleGeometryProxy@@@CCompositor@@IEAAJPEAPEAVCRectangleGeometryProxy@@@Z @ 0x1800380E0
 * Callers:
...
__int64 __fastcall CCompositor::CreateProxy<CRectangleGeometryProxy>(__int64 a1, __int64 *a2)
{
  ...
  *a2 = 0LL;
  ...
  if ( v5 )
  {
    ...
    v6 = CResource::Create(0x1Bu, *(_QWORD *)(a1 + 16), (__int64 *)(v5 + 16));
    v7 = v6;
    if ( v6 < 0 )
