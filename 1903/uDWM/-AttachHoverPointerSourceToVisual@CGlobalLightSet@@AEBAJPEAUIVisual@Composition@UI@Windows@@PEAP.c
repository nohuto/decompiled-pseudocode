/*
 * XREFs of ?AttachHoverPointerSourceToVisual@CGlobalLightSet@@AEBAJPEAUIVisual@Composition@UI@Windows@@PEAPEAUIHoverPointerSourcePartner@345@@Z @ 0x180048880
 * Callers:
...
LABEL_10:
  ...
  v8 = (**v18)(v18, &GUID_4ba72ec1_8968_4103_9111_0d70575add0f, &v17);
  v6 = v8;
  if ( v8 < 0 )
  {
    v13 = 122LL;
LABEL_13:
  ...
  v8 = (*(__int64 (__fastcall **)(__int64, struct Windows::UI::Composition::IVisual *, CGlobalLightSet **))(*(_QWORD *)v9 + 72LL))(
         v9,
         a2,
         &v16);
  v6 = v8;
