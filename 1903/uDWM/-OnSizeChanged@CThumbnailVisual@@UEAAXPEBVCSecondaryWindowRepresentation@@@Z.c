/*
 * XREFs of ?OnSizeChanged@CThumbnailVisual@@UEAAXPEBVCSecondaryWindowRepresentation@@@Z @ 0x18003BF60
 * Callers:
 *     <none>
 * Callees:
        ...
        const struct CSecondaryWindowRepresentation *a2)
{
  ...
  CThumbnailVisual::SetDirtyFlags((CThumbnailVisual *)((char *)this - 360), 0x4000);
  v3 = *((_QWORD *)this + 1);
  if ( v3 && *(_BYTE *)(v3 + 41) && *((_QWORD *)this + 2) )
  {
    v4 = *(_QWORD *)(v3 + 16);
    if ( v4 )
