/*
 * XREFs of ?AddToStoryboard@CAnimationEngine@@AEAAJPEAUIUIAnimationStoryboard2@@IIW4TransformAttribute@1@NNPEAN2IPEAUTA_TIMINGFUNCTION@@W4TransformMode@@22I@Z @ 0x18000C190
 * Callers:
        ...
        unsigned int a15)
{
  ...
  struct __MIDL___MIDL_itf_UIAnimation_0000_0002_0003 *v30; // [rsp+80h] [rbp-31h]
  char v31; // [rsp+88h] [rbp-29h]
  struct IUIAnimationTransition2 *v32; // [rsp+90h] [rbp-21h] BYREF
  __int64 v33; // [rsp+98h] [rbp-19h] BYREF
  _QWORD v34[3]; // [rsp+A0h] [rbp-11h] BYREF
...
LABEL_35:
      wil::details::in1diag3::Return_Hr(
        retaddr,
        (void *)v28,
        (unsigned int)"windows\\dwm\\udwm\\animationengine.cpp",
...
LABEL_9:
  ...
  else
  {
    ...
    v25 = a7;
    v22 = CAnimationEngine::CreateAnimationTransition((CAnimationEngine *)a1, a3, a11, a7, a9, a10, &v32);
    v23 = v22;
    if ( v22 < 0 )
    {
      v28 = 1240LL;
