/*
 * XREFs of ?Update@CMeshGeometry2dProxy@@QEAAJPEBUMilPoint3F@@IPEBUMilPoint2D@@IPEBKIPEBII@Z @ 0x1800B67B0
 * Callers:
...
__int64 __fastcall CMeshGeometry2dProxy::Update(
        ...
        unsigned int a9)
{
  return (*(__int64 (__fastcall **)(_QWORD, _QWORD, const struct MilPoint3F *, _QWORD, const struct MilPoint2D *, unsigned int, const unsigned int *, unsigned int, const unsigned int *, unsigned int))(**(_QWORD **)(*((_QWORD *)this + 2) + 16LL) + 984LL))(
