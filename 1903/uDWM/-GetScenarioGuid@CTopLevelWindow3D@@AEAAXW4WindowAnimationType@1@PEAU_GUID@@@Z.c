/*
 * XREFs of ?GetScenarioGuid@CTopLevelWindow3D@@AEAAXW4WindowAnimationType@1@PEAU_GUID@@@Z @ 0x18000D504
 * Callers:
    ...
    if ( v4 )
    {
      ...
      if ( v5 )
      {
        ...
        if ( v6 )
        {
          ...
          {
            if ( v7 == 1 )
              v8 = (GUID)xmmword_1800C4830;
            else
              v8 = GUID_NULL;
          }
          else
          {
            v8 = (GUID)xmmword_1800C4840;
          }
        }
        else
        {
      ...
      {
        v8 = (GUID)xmmword_1800C4850;
      }
    }
    else
    {
      v8 = (GUID)xmmword_1800C5208;
    }
  }
  else
  {
    v8 = (GUID)xmmword_1800C4860;
  }
  *a3 = v8;
}
