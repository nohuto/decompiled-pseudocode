/*
 * XREFs of ?UpdateLayout@CButton@@UEAAJ_N@Z @ 0x180028800
 * Callers:
 *     <none>
 * Callees:
 *     ?DoCanvasLayout@CVisual@@SA_NAEBUtagSIZE@@AEBU_MARGINS@@0PEAUtagPOINT@@PEAU2@@Z @ 0x180028AA0 (-DoCanvasLayout@CVisual@@SA_NAEBUtagSIZE@@AEBU_MARGINS@@0PEAUtagPOINT@@PEAU2@@Z.c)
...
__int64 __fastcall CButton::UpdateLayout(CButton *this)
{
  ...
  tagSIZE v14; // [rsp+60h] [rbp+18h] BYREF
  ...
  if ( v3
    && CVisual::DoCanvasLayout(
         ...
         &v14) )
  {
    v4 = (*(__int64 (__fastcall **)(CButton *, tagSIZE *))(*(_QWORD *)this + 96LL))(this, &v14);
    v2 = v4;
    if ( v4 < 0 )
    {
      MilInstrumentationCheckHR_MaybeFailFast(0x14u, 0LL, 0, v4, 0x115u, v12);
      goto LABEL_10;
    }
    if ( v13.x != *((_DWORD *)this + 28) || v13.y != *((_DWORD *)this + 29) )
    {
      *((struct tagPOINT *)this + 14) = v13;
...
LABEL_10:
  if ( v2 < 0 )
    MilInstrumentationCheckHR_MaybeFailFast(0x14u, 0LL, 0, v2, 0x88u, v12);
  else
    (*(void (__fastcall **)(CButton *, __int64))(*(_QWORD *)this + 24LL))(this, 4096LL);
  if ( v2 < 0 )
  {
    MilInstrumentationCheckHR_MaybeFailFast(0x14u, 0LL, 0, v2, 0xBFu, v12);
  }
  else
  {
    v7 = *((_QWORD *)this + 36);
    ...
    {
      v13 = 0LL;
      CAtlasedImage::SetOffset((CAtlasedImage *)v7, &v13);
    }
