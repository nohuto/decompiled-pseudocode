/*
 * XREFs of ?CreateNCButtons@CTopLevelWindow@@CAJQEAXPEAUWindowFrame@1@1@Z @ 0x1800462A4
 * Callers:
        ...
        struct CTopLevelWindow::WindowFrame *a3)
{
  ...
  while ( 1 )
  {
    ...
    if ( ThemeMargins < 0 )
    {
      MilInstrumentationCheckHR_MaybeFailFast(0x14u, 0LL, 0, ThemeMargins, 0x3ECu, v15);
      return v3;
    }
    if ( *((_DWORD *)v9 + 6) )
    {
...
LABEL_9:
  ...
  MilInstrumentationCheckHR_MaybeFailFast(0x14u, 0LL, 0, v10, 0x3EBu, v15);
  return v3;
}
