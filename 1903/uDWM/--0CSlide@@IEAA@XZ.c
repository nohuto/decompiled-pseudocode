/*
 * XREFs of ??0CSlide@@IEAA@XZ @ 0x180005728
 * Callers:
 *     ??0CSlideIn@@QEAA@XZ @ 0x1800056C8 (--0CSlideIn@@QEAA@XZ.c)
 *     ??0CSlideOut@@QEAA@XZ @ 0x1800056F4 (--0CSlideOut@@QEAA@XZ.c)
 ...
 *     ??0CPanelAnimation@@QEAA@XZ @ 0x1800A72E8 (--0CPanelAnimation@@QEAA@XZ.c)
 * Callees:
