/*
 * XREFs of ?WrapExistingResource@UdwmBottomVisual@@SAJIPEAPEAV1@@Z @ 0x18000F714
 * Callers:
...
__int64 __fastcall UdwmBottomVisual::WrapExistingResource(unsigned int a1, struct UdwmBottomVisual **a2)
{
  __int64 v4; // rax
  CVisual *v5; // rsi
  CBaseObject *v6; // rbx
