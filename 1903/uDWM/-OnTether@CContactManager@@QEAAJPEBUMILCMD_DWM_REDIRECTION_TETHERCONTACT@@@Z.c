/*
 * XREFs of ?OnTether@CContactManager@@QEAAJPEBUMILCMD_DWM_REDIRECTION_TETHERCONTACT@@@Z @ 0x180098340
 * Callers:
 ...
 *     ?Stop@CTetherVisual@@UEAAXXZ @ 0x18009DFB0 (-Stop@CTetherVisual@@UEAAXXZ.c)
