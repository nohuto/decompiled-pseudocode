/*
 * XREFs of ?DesktopThumbnailChange@CWindowList@@UEAAJPEAUIDwmWindow@@UtagRECT@@1EK@Z @ 0x180090270
 * Callers:
 *     <none>
 * Callees:
        ...
        unsigned int a6)
{
  ...
  {
    MilInstrumentationCheckHR_MaybeFailFast(0x14u, 0LL, 0LL, SyncedWindowData, 0x11EDu);
    goto LABEL_35;
  }
  v12 = v32;
  if ( !v32 )
    goto LABEL_35;
  v13 = (CTopLevelWindow *)*((_QWORD *)v32 + 50);
  if ( !v13 || *((_DWORD *)v32 + 28) == 1 )
  {
    v9 = -2147024809;
    MilInstrumentationCheckHR_MaybeFailFast(0x14u, 0LL, 0LL, -2147024809, 0x11F7u);
    goto LABEL_35;
  }
  ...
  {
    MilInstrumentationCheckHR_MaybeFailFast(0x14u, 0LL, 0LL, DesktopThumbnail, 0x11FBu);
LABEL_27:
    v15 = v29;
    goto LABEL_28;
  }
  ...
  *((_QWORD *)v29 + 34) = *((_QWORD *)v12 + 15);
  ...
  if ( updated < 0 )
  {
    MilInstrumentationCheckHR_MaybeFailFast(0x14u, 0LL, 0LL, updated, 0x11FCu);
    goto LABEL_28;
  }
  v35 = *a4;
  ...
  if ( PerMonitorDesktopThumbnail >= 0 )
  {
    ...
    if ( v19 )
    {
      if ( v20 )
      {
        VisualCollection::Remove((VisualCollection *)(*(_QWORD *)(v19 + 24) + 32LL), *((struct CVisual **)v12 + 74));
        v21 = (CBaseObject *)*((_QWORD *)v12 + 74);
        if ( v21 )
        {
      ...
      else
      {
        v22 = v33;
        *(_DWORD *)(v19 + 340) = a6;
        CDesktopThumbnailCVIVisual::Update(*((CDesktopThumbnailCVIVisual **)v12 + 74), v22, (double)a5 / 255.0);
      }
      goto LABEL_28;
    }
    if ( !v20 )
      ...
      if ( v23 >= 0 )
      {
        ...
        *((_BYTE *)v25 + 337) = 0;
        ...
        if ( v26 >= 0 )
        {
          ...
          MilInstrumentationCheckHR_MaybeFailFast(0x14u, 0LL, 0LL, v27, 0x121Du);
        }
        else
        {
          MilInstrumentationCheckHR_MaybeFailFast(0x14u, 0LL, 0LL, v26, 0x121Au);
        }
      }
      else
      {
        MilInstrumentationCheckHR_MaybeFailFast(0x14u, 0LL, 0LL, v23, 0x1214u);
        v10 = (volatile signed __int32 *)v30;
      }
    }
  }
  ...
  {
    MilInstrumentationCheckHR_MaybeFailFast(0x14u, 0LL, 0LL, PerMonitorDesktopThumbnail, 0x11FDu);
  }
LABEL_28:
  if ( v15 )
