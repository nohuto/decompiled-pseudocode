/*
 * XREFs of ?GetCaptionButtonBounds@CWindowList@@AEAAJPEAUHWND__@@PEAUtagRECT@@@Z @ 0x180090918
 * Callers:
...
__int64 __fastcall CWindowList::GetCaptionButtonBounds(CWindowList *this, HWND a2, struct tagRECT *a3)
{
  ...
  if ( SyncedWindowDataByHwnd >= 0 )
  {
    v7 = v23;
    if ( v23
      && (CurrentStyle = CTopLevelWindow::GetCurrentStyle((__int64)v23),
          CTopLevelWindow::HasRenderedBorder(CurrentStyle, v9)) )
    {
      v10 = *((_DWORD *)v7 + 24);
      v11 = 0;
      v12 = v10 + 1;
      ...
      if ( (CurrentStyle & 2) == 0 )
        v13 = 31LL;
      SystemMetricsForDpi = GetSystemMetricsForDpi(v13, *((unsigned int *)v7 + 81));
