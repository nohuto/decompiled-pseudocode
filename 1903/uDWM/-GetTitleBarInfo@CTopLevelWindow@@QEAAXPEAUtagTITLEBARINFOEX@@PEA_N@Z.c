/*
 * XREFs of ?GetTitleBarInfo@CTopLevelWindow@@QEAAXPEAUtagTITLEBARINFOEX@@PEA_N@Z @ 0x180002F58
 * Callers:
...
void __fastcall CTopLevelWindow::GetTitleBarInfo(CTopLevelWindow *this, struct tagTITLEBARINFOEX *a2, bool *a3)
{
  ...
  if ( CTopLevelWindow::HasRenderedBorder(*((_DWORD *)this + 146)) )
  {
    ...
    *(_QWORD *)&a2->rgstate[4] = 0LL;
    ...
    {
      wil::Feature<__WilFeatureTraits_Feature_NormalizeTitlebarHeight>::ReportUsageToService();
      ...
      v8 = *((_DWORD *)this + 30) - *((_DWORD *)this + 148);
      a2->rcTitleBar.right = v8;
      a2->rcTitleBar.bottom = *((_DWORD *)this + 149);
      v9 = *((_DWORD *)this + 146);
      if ( (v9 & 0x10000) != 0 )
      {
        v10 = *(_DWORD *)(*((_QWORD *)this + 65) + 120LL);
        if ( (v9 & 0x20000) != 0 )
      ...
      for ( i = 2; i <= 5; ++i )
      {
        ...
        v15 = *((_DWORD *)this + 146);
        if ( (v15 & dword_1800C4660[2 * v14]) != 0 )
        {
          if ( (v15 & dword_1800C4660[2 * v14 + 1]) != 0 )
          {
        ...
        if ( (*v12 & 0x8000) == 0 )
        {
          ...
          {
            v17.top = *((_DWORD *)this + 161);
            if ( i == 5 )
              v17.right = *((_DWORD *)this + 30) - *((_DWORD *)this + 160);
          }
          *v11 = v17;
        }
        ++v12;
