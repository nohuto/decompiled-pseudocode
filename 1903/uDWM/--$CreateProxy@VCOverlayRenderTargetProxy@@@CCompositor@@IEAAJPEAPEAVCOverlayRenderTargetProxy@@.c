/*
 * XREFs of ??$CreateProxy@VCOverlayRenderTargetProxy@@@CCompositor@@IEAAJPEAPEAVCOverlayRenderTargetProxy@@@Z @ 0x1800B60E0
 * Callers:
...
__int64 __fastcall CCompositor::CreateProxy<COverlayRenderTargetProxy>(__int64 a1, __int64 *a2)
{
  __int64 v4; // rax
  __int64 v5; // rbx
  int v6; // eax
  ...
  *a2 = 0LL;
  ...
  if ( v4 )
  {
    ...
    *(_DWORD *)(v4 + 8) = 1;
    *(_QWORD *)(v4 + 16) = 0LL;
    *(_QWORD *)v4 = &COverlayRenderTargetProxy::`vftable';
  }
  else
  {
    v5 = 0LL;
  ...
  if ( v5 )
  {
    ...
    v6 = CResource::Create(0x1Au, *(_QWORD *)(a1 + 16), (__int64 *)(v5 + 16));
    v7 = v6;
    if ( v6 >= 0 )
      v7 = 0;
    else
