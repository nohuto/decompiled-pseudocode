/*
 * XREFs of ?UpdateAcrylicBlurBehind@CAccentAcrylicBlurBehind@@QEAAJAEBUACCENT_POLICY@@@Z @ 0x180042ABC
 * Callers:
 ...
 *     ??1?$ComPtr@UIVisual@Composition@UI@Windows@@@WRL@Microsoft@@QEAA@XZ @ 0x18008B580 (--1-$ComPtr@UIVisual@Composition@UI@Windows@@@WRL@Microsoft@@QEAA@XZ.c)
 */
