/*
 * XREFs of ?GetStride@CCompoundBitmapLock@@UEAAJPEAI@Z @ 0x18004DEC0
 * Callers:
 *     ?GetStride@CCompoundBitmapLock@@W7EAAJPEAI@Z @ 0x1800500B0 (-GetStride@CCompoundBitmapLock@@W7EAAJPEAI@Z.c)
 * Callees:
 *     <none>
 */
