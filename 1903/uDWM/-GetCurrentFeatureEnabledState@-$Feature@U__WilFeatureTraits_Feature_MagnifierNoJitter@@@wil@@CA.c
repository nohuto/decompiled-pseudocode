/*
 * XREFs of ?GetCurrentFeatureEnabledState@?$Feature@U__WilFeatureTraits_Feature_MagnifierNoJitter@@@wil@@CA?AW4wil_details_CachedFeatureEnabledState@@_NPEAW4wil_details_CachedHasNotificationState@@PEAH@Z @ 0x18004D79C
 * Callers:
...
__int64 __fastcall wil::Feature<__WilFeatureTraits_Feature_MagnifierNoJitter>::GetCurrentFeatureEnabledState(
        __int64 a1,
        _DWORD *a2,
        int *a3)
{
  ...
  if ( g_wil_details_internalGetFeatureEnabledState || (v3 = g_wil_details_apiGetFeatureEnabledState) != 0LL )
    v4 = ((__int64 (__fastcall *)(__int64, _QWORD, int *, _QWORD))v3)(17799489LL, 0LL, a3, 0LL);
  *a3 = (v4 >> 6) & 1;
  *a2 = ((v4 & 0x80u) != 0) + 1;
  v7 = v4 & 0xFFFFFF3F;
  if ( v7 )
