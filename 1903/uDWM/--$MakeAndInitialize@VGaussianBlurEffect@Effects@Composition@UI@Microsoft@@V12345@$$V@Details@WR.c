/*
 * XREFs of ??$MakeAndInitialize@VGaussianBlurEffect@Effects@Composition@UI@Microsoft@@V12345@$$V@Details@WRL@Microsoft@@YAJPEAPEAVGaussianBlurEffect@Effects@Composition@UI@2@@Z @ 0x18003E018
 * Callers:
        ...
        __int64 *a1)
{
  ...
  volatile signed __int64 *v9; // [rsp+30h] [rbp+8h] BYREF
