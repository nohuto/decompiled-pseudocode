/*
 * XREFs of WPP_RECORDER_SF_qiD @ 0x1C0003F4C
 * Callers:
...
__int64 WPP_RECORDER_SF_qiD(__int64 a1, __int64 a2, __int64 a3, unsigned __int16 a4, int a5, ...)
{
  ...
  if ( (HIDWORD(WPP_GLOBAL_Control->Timer) & 0x2000) != 0 && BYTE1(WPP_GLOBAL_Control->Timer) >= 5u )
    pfnWppTraceMessage(
      ...
      43LL,
      &WPP_36bc79e2af6f37d6aa20da6265b51b29_Traceguids,
      a4,
      (__int64 *)va,
      8LL,
      (__int64 *)va1,
      ...
      0LL);
  LOWORD(v8) = a4;
  return WppAutoLogTrace(a1, 5LL, 14LL, &WPP_36bc79e2af6f37d6aa20da6265b51b29_Traceguids, v8, (__int64 *)va);
}
