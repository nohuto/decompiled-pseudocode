/*
 * XREFs of McTemplateK0ppb16u @ 0x1C0006CC8
 * Callers:
...
ULONG McTemplateK0ppb16u(struct _MCGEN_TRACE_CONTEXT *a1, __int64 a2, __int64 a3, ...)
{
  ...
  v10 = 16LL;
  v12 = 1LL;
  return McGenEventWrite(a1, &USBXHCI_ETW_EVENT_COMMAND_WAITLISTED, 0LL, 5u, &EventData);
}
