/*
 * XREFs of Controller_TelemetryReportWorker @ 0x1C0010DF0
 * Callers:
 *     <none>
 * Callees:
...
LONG __fastcall Controller_TelemetryReportWorker(__int64 a1)
{
  ...
  if ( WPP_RECORDER_INITIALIZED != (_UNKNOWN *)&WPP_RECORDER_INITIALIZED )
    WPP_RECORDER_SF_(v4[4].m128i_i64[1], 4u, 4u, 0xDEu, (__int64)&Context.Logger + 4);
  ...
  *(_DWORD *)(v5 + 80) = 0;
  ...
  if ( v9 == -1073741789 )
  {
    ...
    if ( PoolWithTag )
    {
      ...
      {
        WPP_RECORDER_SF_d(v4[4].m128i_i64[1], 2u, 4u, 0xE1u, (__int64)&Context.Logger + 4, v12);
      }
      v14 = v11;
      goto LABEL_21;
    }
    if ( WPP_RECORDER_INITIALIZED != (_UNKNOWN *)&WPP_RECORDER_INITIALIZED )
      WPP_RECORDER_SF_(v4[4].m128i_i64[1], 2u, 4u, 0xE0u, (__int64)&Context.Logger + 4);
  }
  else if ( WPP_RECORDER_INITIALIZED != (_UNKNOWN *)&WPP_RECORDER_INITIALIZED )
  {
    WPP_RECORDER_SF_d(v4[4].m128i_i64[1], 2u, 4u, 0xDFu, (__int64)&Context.Logger + 4, v9);
  }
  while ( 1 )
  {
