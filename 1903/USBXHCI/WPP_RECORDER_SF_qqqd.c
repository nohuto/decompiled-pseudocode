/*
 * XREFs of WPP_RECORDER_SF_qqqd @ 0x1C00155BC
 * Callers:
...
__int64 WPP_RECORDER_SF_qqqd(__int64 a1, __int64 a2, __int64 a3, __int64 a4, int a5, ...)
{
  ...
  if ( (HIDWORD(WPP_GLOBAL_Control->Timer) & 8) != 0 && BYTE1(WPP_GLOBAL_Control->Timer) >= 5u )
    ((void (__fastcall *)(_DEVICE_OBJECT *, __int64, char *, __int64, __int64 *, __int64, __int64 *, __int64, __int64 *, __int64, char *, __int64, _QWORD))pfnWppTraceMessage)(
      ...
      0LL);
  LOWORD(v7) = 299;
  return WppAutoLogTrace(a1, 5LL, 4LL, (char *)&Context.Logger + 4, v7, (__int64 *)va);
}
