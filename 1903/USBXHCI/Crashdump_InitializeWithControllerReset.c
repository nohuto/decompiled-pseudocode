/*
 * XREFs of Crashdump_InitializeWithControllerReset @ 0x1C00404BC
 * Callers:
 *     Crashdump_Initialize @ 0x1C003FF60 (Crashdump_Initialize.c)
 * Callees:
 *     Crashdump_Register_LogRHPortInfo @ 0x1C0041538 (Crashdump_Register_LogRHPortInfo.c)
 *     Crashdump_Register_ResetController @ 0x1C004170C (Crashdump_Register_ResetController.c)
 *     Crashdump_Register_ResetPort @ 0x1C00417D8 (Crashdump_Register_ResetPort.c)
 *     Crashdump_Register_StartController @ 0x1C0041BAC (Crashdump_Register_StartController.c)
 *     Crashdump_Register_UpdateDeviceSlotInfo @ 0x1C0041D38 (Crashdump_Register_UpdateDeviceSlotInfo.c)
 ...
 *     Crashdump_Command_TestCommandRingOperation @ 0x1C0042B44 (Crashdump_Command_TestCommandRingOperation.c)
 *     Crashdump_UsbDevice_GetPortType @ 0x1C00441DC (Crashdump_UsbDevice_GetPortType.c)
 *     Crashdump_UsbDevice_ReConfigureOnControllerReset @ 0x1C0044444 (Crashdump_UsbDevice_ReConfigureOnControllerReset.c)
 *     Crashdump_UsbDevice_ResetPort @ 0x1C0044694 (Crashdump_UsbDevice_ResetPort.c)
 *     Crashdump_UsbDevice_SetPortPower @ 0x1C0044CB8 (Crashdump_UsbDevice_SetPortPower.c)
 */
