/*
 * XREFs of McTemplateK0pjqq @ 0x1C0014068
 * Callers:
...
ULONG McTemplateK0pjqq(struct _MCGEN_TRACE_CONTEXT *a1, __int64 a2, __int64 a3, ...)
{
  ...
  v10 = 4LL;
  v12 = 4LL;
  return McGenEventWrite(a1, &USBXHCI_ETW_EVENT_CONTROLLER_QUERY_USB_CAPABILITY, 0LL, 5u, &EventData);
}
