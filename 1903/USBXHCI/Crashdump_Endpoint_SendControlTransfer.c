/*
 * XREFs of Crashdump_Endpoint_SendControlTransfer @ 0x1C0043164
 * Callers:
 *     Crashdump_SendUrb @ 0x1C0040B20 (Crashdump_SendUrb.c)
 *     Crashdump_SendUrbAsync @ 0x1C0040C10 (Crashdump_SendUrbAsync.c)
 *     Crashdump_UsbDevice_ChangePortFeature @ 0x1C00436C4 (Crashdump_UsbDevice_ChangePortFeature.c)
 *     Crashdump_UsbDevice_Configure @ 0x1C004388C (Crashdump_UsbDevice_Configure.c)
