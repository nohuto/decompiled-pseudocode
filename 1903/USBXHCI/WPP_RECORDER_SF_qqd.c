/*
 * XREFs of WPP_RECORDER_SF_qqd @ 0x1C000D1C0
 * Callers:
...
__int64 WPP_RECORDER_SF_qqd(__int64 a1, __int64 a2, __int64 a3, __int64 a4, int a5, ...)
{
  ...
  if ( (HIDWORD(WPP_GLOBAL_Control->Timer) & 0x80u) != 0 && BYTE1(WPP_GLOBAL_Control->Timer) >= 5u )
    pfnWppTraceMessage(
      ...
      43LL,
      &WPP_69dd49c7a64d37eeaa5b7723d8723313_Traceguids,
      14LL,
      (__int64 *)va,
      8LL,
      (__int64 *)va1,
      ...
      0LL);
  LOWORD(v7) = 14;
  return WppAutoLogTrace(a1, 5LL, 8LL, &WPP_69dd49c7a64d37eeaa5b7723d8723313_Traceguids, v7, (__int64 *)va);
}
