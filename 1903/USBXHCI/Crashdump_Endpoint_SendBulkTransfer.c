/*
 * XREFs of Crashdump_Endpoint_SendBulkTransfer @ 0x1C0042E64
 * Callers:
 *     Crashdump_DoBulkTransfer @ 0x1C003FE1C (Crashdump_DoBulkTransfer.c)
 * Callees:
 *     Crashdump_Endpoint_CalculateTDSize @ 0x1C0007BD8 (Crashdump_Endpoint_CalculateTDSize.c)
 *     Crashdump_Endpoint_GetPacketCount @ 0x1C0007C18 (Crashdump_Endpoint_GetPacketCount.c)
 *     Crashdump_Endpoint_SendTransferAndPollForCompletion @ 0x1C0043364 (Crashdump_Endpoint_SendTransferAndPollForCompletion.c)
 */
...
__int64 __fastcall Crashdump_Endpoint_SendBulkTransfer(__int64 a1, __int64 a2, _QWORD *a3, char a4)
{
  ...
  unsigned __int64 v35; // [rsp+90h] [rbp+18h]
  ...
  v9 = *(_DWORD *)(a2 + 36);
  *(_QWORD *)(a1 + 176) = a2;
  v10 = (-(__int64)(v7 != 0) & 0xFFFFFFFFFFFFFFE8uLL) + 104;
  v35 = v10;
