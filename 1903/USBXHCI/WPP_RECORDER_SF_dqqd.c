/*
 * XREFs of WPP_RECORDER_SF_dqqd @ 0x1C003E090
 * Callers:
...
__int64 WPP_RECORDER_SF_dqqd(__int64 a1, _DWORD a2, _DWORD a3, _DWORD a4, __int64 a5, ...)
{
  ...
  if ( (HIDWORD(WPP_GLOBAL_Control->Timer) & 0x800) != 0 && BYTE1(WPP_GLOBAL_Control->Timer) >= 4u )
    ((void (__fastcall *)(_DEVICE_OBJECT *, __int64, void *, __int64, __int64 *, __int64, __int64 *, __int64, __int64 *, __int64, char *, __int64, _QWORD))pfnWppTraceMessage)(
      ...
      0LL);
  LOWORD(v7) = 32;
  return WppAutoLogTrace(a1, 4LL, 12LL, &WPP_711f1ef54f4a3f1517afb509b5ec1830_Traceguids, v7, (__int64 *)va);
}
