/*
 * XREFs of DynamicLock_Release @ 0x1C00471B4
 * Callers:
...
{
  if ( *(_DWORD *)a1 != 1 )
    return (*(__int64 (__fastcall **)(unsigned __int64, _QWORD))(WdfFunctions_01023 + 2536))(
  ...
  if ( KeGetCurrentIrql() )
    Debug_FreAssertMsg(
      ...
      107);
  return (*(__int64 (__fastcall **)(unsigned __int64, _QWORD))(WdfFunctions_01023 + 2512))(
           WPP_MAIN_CB.Dpc.ProcessorHistory,
           *(_QWORD *)(a1 + 8));
}
