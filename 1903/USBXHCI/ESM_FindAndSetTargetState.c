/*
 * XREFs of ESM_FindAndSetTargetState @ 0x1C00453A0
 * Callers:
 *     ESM_RunStateMachine @ 0x1C004588C (ESM_RunStateMachine.c)
 * Callees:
 *     ESM_LogUnhandledEvent @ 0x1C0045758 (ESM_LogUnhandledEvent.c)
