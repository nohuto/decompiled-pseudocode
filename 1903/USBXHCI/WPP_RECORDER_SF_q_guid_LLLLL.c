/*
 * XREFs of WPP_RECORDER_SF_q_guid_LLLLL @ 0x1C00151EC
 * Callers:
...
__int64 WPP_RECORDER_SF_q_guid_LLLLL(__int64 a1, __int64 a2, __int64 a3, __int64 a4, int a5, ...)
{
  ...
  __int64 v10; // [rsp+E8h] [rbp+57h]
  __int64 v11; // [rsp+F0h] [rbp+5Fh] BYREF
  va_list va1; // [rsp+F0h] [rbp+5Fh]
  __int64 v13; // [rsp+F8h] [rbp+67h] BYREF
  va_list va2; // [rsp+F8h] [rbp+67h]
  __int64 v15; // [rsp+100h] [rbp+6Fh] BYREF
  ...
  if ( (HIDWORD(WPP_GLOBAL_Control->Timer) & 8) != 0 && BYTE1(WPP_GLOBAL_Control->Timer) >= 4u )
    ((void (__fastcall *)(_DEVICE_OBJECT *, __int64, char *, __int64, __int64 *, __int64, __int64, __int64, __int64 *, __int64, __int64 *, __int64, __int64 *, __int64, __int64 *, __int64, char *, __int64, _QWORD))pfnWppTraceMessage)(
