/*
 * XREFs of WerKernelSubmitReport @ 0x1C0049380
 * Callers:
 *     TelemetryData_SubmitReport @ 0x1C006B68C (TelemetryData_SubmitReport.c)
 * Callees:
 *     __security_check_cookie @ 0x1C00021E0 (__security_check_cookie.c)
 *     memset @ 0x1C0008D80 (memset.c)
 *     StringCchCopyNW @ 0x1C0049024 (StringCchCopyNW.c)
 *     WerStartSystemErrorHandler @ 0x1C0049974 (WerStartSystemErrorHandler.c)
 *     WerWaitForSystemErrorHandler @ 0x1C0049AA8 (WerWaitForSystemErrorHandler.c)
 ...
 *     WerpParseKeyName @ 0x1C0049F34 (WerpParseKeyName.c)
 */
...
__int64 __fastcall WerKernelSubmitReport(HANDLE KeyHandle)
{
  ...
  STRSAFE_PCNZWCH v34; // [rsp+A0h] [rbp-60h] BYREF
  ...
  _QWORD v39[10]; // [rsp+100h] [rbp+0h] BYREF
  _DWORD v40[352]; // [rsp+150h] [rbp+50h] BYREF
  _DWORD v41[352]; // [rsp+6D0h] [rbp+5D0h] BYREF

  Handle = 0LL;
  memset(v40, 0, 0x578uLL);
            ...
            if ( started >= 0 )
            {
              ...
              else
              {
                ...
                *(_QWORD *)&v37[1] = 0LL;
                ...
                {
                  v8 = 0;
                  v32 = -10000LL * SHIDWORD(SystemInformation);
                }
                v13 = &v32;
                if ( v8 )
                  v13 = 0LL;
                started = ZwAlpcConnectPort(&Handle, &DestinationString, v37, v39, 0x20000, P, 0LL, 0LL, 0LL, 0LL, v13);
                v6 = started;
                if ( started >= 0 )
                {
                  if ( started != 258 )
                  {
                    ...
                    v15 = StringCchCopyNW((STRSAFE_LPWSTR)&v40[14], 0x10uLL, pszSrc, v14);
                    if ( v15 >= 0 )
                    {
                      v18 = 31LL;
                      if ( HIDWORD(cchToCopy) <= 0x1F )
                        v18 = HIDWORD(cchToCopy);
                      v15 = StringCchCopyNW((STRSAFE_LPWSTR)&v40[22], 0x20uLL, v34, v18);
                      if ( v15 >= 0 )
                      {
                        memset(&v41[1], 0, 0x574uLL);
                        v41[0] = 91751760;
                        v35 = 1400LL;
                        v19 = ZwAlpcSendWaitReceivePort(Handle, 0LL, v40, 0LL, v41, &v35, 0LL, v13);
                        v6 = v19;
                        if ( v19 < 0 || v19 == 258 )
                        {
                          DbgPrintEx(
