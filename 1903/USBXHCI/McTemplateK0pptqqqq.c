/*
 * XREFs of McTemplateK0pptqqqq @ 0x1C0014104
 * Callers:
...
ULONG McTemplateK0pptqqqq(struct _MCGEN_TRACE_CONTEXT *a1, __int64 a2, __int64 a3, ...)
{
  ...
  v16 = 4LL;
  v18 = 4LL;
  return McGenEventWrite(a1, &USBXHCI_ETW_EVENT_STOP_TRACKING_FOR_TIME_SYNC, 0LL, 8u, &EventData);
}
