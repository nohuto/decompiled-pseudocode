/*
 * XREFs of McTemplateK0ppqqqq @ 0x1C0006FA8
 * Callers:
...
ULONG McTemplateK0ppqqqq(struct _MCGEN_TRACE_CONTEXT *a1, __int64 a2, __int64 a3, ...)
{
  ...
  v14 = 4LL;
  v16 = 4LL;
  return McGenEventWrite(a1, &USBXHCI_ETW_EVENT_CONFIGURE_ENDPOINT, 0LL, 7u, &EventData);
}
