/*
 * XREFs of __scrt_initialize_thread_safe_statics @ 0x140003310
 * Callers:
 *     <none>
 * Callees:
...
LABEL_13:
  ...
  {
    hHandle = 0LL;
    ((void (__fastcall *)(void *))ProcAddress)(&unk_140010330);
    qword_140010340 = __ROR8__(v2, 64 - ((unsigned __int8)_security_cookie & 0x3Fu)) ^ _security_cookie;
    qword_140010348 = __ROR8__(v4, 64 - ((unsigned __int8)_security_cookie & 0x3Fu)) ^ _security_cookie;
  }
  else
  {
