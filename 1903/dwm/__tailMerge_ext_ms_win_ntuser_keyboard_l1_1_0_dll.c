/*
 * XREFs of __tailMerge_ext_ms_win_ntuser_keyboard_l1_1_0_dll @ 0x1400043D8
 * Callers:
 *     __imp_load_RegisterHotKey @ 0x1400043CC (__imp_load_RegisterHotKey.c)
 *     __imp_load_UnregisterHotKey @ 0x140004457 (__imp_load_UnregisterHotKey.c)
 * Callees:
