/*
 * XREFs of MouseClassReadCopyData @ 0x1C00047B8
 * Callers:
 *     MouseClassRead @ 0x1C0001AD0 (MouseClassRead.c)
 *     MouseClassServiceCallback @ 0x1C0004BD0 (MouseClassServiceCallback.c)
 * Callees:
 *     WPP_RECORDER_SF_qqL @ 0x1C00020C0 (WPP_RECORDER_SF_qqL.c)
 *     memmove @ 0x1C0002A00 (memmove.c)
 *     WPP_RECORDER_SF_qq @ 0x1C0005E50 (WPP_RECORDER_SF_qq.c)
 *     WPP_RECORDER_SF_qqLL @ 0x1C00060B4 (WPP_RECORDER_SF_qqLL.c)
 *     WPP_RECORDER_SF_qqLqq @ 0x1C0006450 (WPP_RECORDER_SF_qqLqq.c)
 *     WPP_RECORDER_SF_qqqql @ 0x1C00069B0 (WPP_RECORDER_SF_qqqql.c)
 */
...
__int64 __fastcall MouseClassReadCopyData(__int64 a1, _QWORD *a2, int a3, int a4)
{
  ...
  if ( WPP_RECORDER_INITIALIZED != (_UNKNOWN *)&WPP_RECORDER_INITIALIZED && LOWORD(WPP_GLOBAL_Control->DeviceType) )
    WPP_RECORDER_SF_qqL((__int64)WPP_GLOBAL_Control->DeviceExtension, 5u, 3u, 0x29u, v19);
  v11 = (char *)a2[3];
  if ( WPP_RECORDER_INITIALIZED != (_UNKNOWN *)&WPP_RECORDER_INITIALIZED && LOWORD(WPP_GLOBAL_Control->DeviceType) )
  ...
  *(_DWORD *)(a1 + 84) -= v8 / 0x18;
  if ( v17 )
  {
    ...
    {
      LOBYTE(v16) = 3;
      WPP_RECORDER_SF_qq(WPP_GLOBAL_Control->DeviceExtension, v16, 3, 44, v19, *(_QWORD *)a1, (char)a2);
    }
    *(_BYTE *)(a1 + 66) = 1;
  }
  if ( WPP_RECORDER_INITIALIZED != (_UNKNOWN *)&WPP_RECORDER_INITIALIZED && LOWORD(WPP_GLOBAL_Control->DeviceType) )
