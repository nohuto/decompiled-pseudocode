/*
 * XREFs of MouseClassWaitWakeComplete @ 0x1C0005230
 * Callers:
 *     <none>
 * Callees:
 *     MouseToggleWaitWake @ 0x1C0005438 (MouseToggleWaitWake.c)
 *     WPP_RECORDER_SF_qd @ 0x1C0005C3C (WPP_RECORDER_SF_qd.c)
 *     WPP_RECORDER_SF_qqd @ 0x1C000658C (WPP_RECORDER_SF_qqd.c)
 */
...
LABEL_8:
    ...
    && Status != -1072431071 )
  {
    if ( Status )
    {
      ...
      {
        LOBYTE(v9) = 2;
        WPP_RECORDER_SF_qqd(WPP_GLOBAL_Control->DeviceExtension, v9, v10, 89);
      }
