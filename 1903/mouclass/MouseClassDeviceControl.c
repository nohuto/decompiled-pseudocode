    ...
    if ( v12 == 983040 )
    {
      ...
      if ( *(_QWORD *)v4 == *(_QWORD *)(v4 + 8) )
      {
        if ( v4 == *(_QWORD *)&WPP_MAIN_CB.Queue.Wcb.NumberOfChannels )
        {
          ...
          if ( LODWORD(WPP_MAIN_CB.Queue.Wcb.DeviceContext) <= v17 )
            goto LABEL_43;
          if ( LODWORD(WPP_MAIN_CB.Queue.Wcb.DeviceContext) )
          {
            if ( !*((_BYTE *)WPP_MAIN_CB.Queue.Wcb.DeviceRoutine + 24 * v17 + 16)
              || *((_BYTE *)WPP_MAIN_CB.Queue.Wcb.DeviceRoutine + 24 * v17 + 19) )
            {
              v17 = 0;
            }
            while ( !*((_BYTE *)WPP_MAIN_CB.Queue.Wcb.DeviceRoutine + 24 * v17 + 16)
                 || *((_BYTE *)WPP_MAIN_CB.Queue.Wcb.DeviceRoutine + 24 * v17 + 19) )
            {
              if ( LODWORD(WPP_MAIN_CB.Queue.Wcb.DeviceContext) <= v17 )
                goto LABEL_43;
...
LABEL_43:
          ...
          _mm_lfence();
          v4 = *((_QWORD *)WPP_MAIN_CB.Queue.Wcb.DeviceRoutine + 3 * v17 + 1);
          *(_QWORD *)(v5 + 48) = *((_QWORD *)WPP_MAIN_CB.Queue.Wcb.DeviceRoutine + 3 * v17);
          ExReleaseFastMutex((PFAST_MUTEX)&WPP_MAIN_CB.Queue.Wcb.DeviceObject);
        }
        v18 = *(_QWORD *)(v2 + 184);
        *(_OWORD *)(v18 - 72) = *(_OWORD *)v18;
        *(_OWORD *)(v18 - 56) = *(_OWORD *)(v18 + 16);
        *(_OWORD *)(v18 - 40) = *(_OWORD *)(v18 + 32);
        *(_QWORD *)(v18 - 24) = *(_QWORD *)(v18 + 48);
        *(_BYTE *)(v18 - 69) = 0;
