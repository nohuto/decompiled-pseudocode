/*
 * XREFs of MouseClassServiceCallback @ 0x1C0004BD0
 * Callers:
 *     <none>
 * Callees:
 *     memmove @ 0x1C0002A00 (memmove.c)
 *     MouseClassDequeueRead @ 0x1C000449C (MouseClassDequeueRead.c)
 *     MouseClassReadCopyData @ 0x1C00047B8 (MouseClassReadCopyData.c)
 *     WPP_RECORDER_SF_ @ 0x1C0005728 (WPP_RECORDER_SF_.c)
 *     WPP_RECORDER_SF_qL @ 0x1C0005958 (WPP_RECORDER_SF_qL.c)
 *     WPP_RECORDER_SF_qLL @ 0x1C0005A2C (WPP_RECORDER_SF_qLL.c)
 *     WPP_RECORDER_SF_qLqq @ 0x1C0005B24 (WPP_RECORDER_SF_qLqq.c)
 *     WPP_RECORDER_SF_qlqqd @ 0x1C0005D10 (WPP_RECORDER_SF_qlqqd.c)
 *     WPP_RECORDER_SF_qqLLqq @ 0x1C00061D0 (WPP_RECORDER_SF_qqLLqq.c)
 *     WPP_RECORDER_SF_qqiL @ 0x1C00067A8 (WPP_RECORDER_SF_qqiL.c)
 */
...
__int64 **__fastcall MouseClassServiceCallback(__int64 a1, char *a2, int a3, _DWORD *a4)
{
  ...
  *v4 = 0;
  ...
  if ( v12 )
  {
    ...
    *a4 += v10 / 0x18;
    if ( WPP_RECORDER_INITIALIZED != (_UNKNOWN *)&WPP_RECORDER_INITIALIZED && LOWORD(WPP_GLOBAL_Control->DeviceType) )
      WPP_RECORDER_SF_qqLLqq(WPP_GLOBAL_Control->DeviceExtension, v10 / 0x18, v16, 0);
...
LABEL_50:
  ...
  if ( v20 )
  {
    ...
    *(_QWORD *)(v8 + 112) += v24;
    ...
    v28 = *(char **)(v8 + 104);
    v29 = *(char **)(v8 + 112);
    if ( v29 >= &v28[*(unsigned int *)(v8 + 136)] )
    {
      *(_QWORD *)(v8 + 112) = v28;
      v29 = v28;
    }
    ...
    *v4 += v22 / 0x18;
    if ( WPP_RECORDER_INITIALIZED != (_UNKNOWN *)&WPP_RECORDER_INITIALIZED && LOWORD(WPP_GLOBAL_Control->DeviceType) )
      WPP_RECORDER_SF_qlqqd(WPP_GLOBAL_Control->DeviceExtension, v22 / 0x18, v25, v26);
  }
  while ( *(_DWORD *)(v8 + 84) )
  {
    v31 = MouseClassDequeueRead(v8);
    v34 = v31;
    if ( !v31 )
      break;
    *((_DWORD *)v31 + 12) = MouseClassReadCopyData(v8, v31, v32, v33);
    v35 = v42;
    v36 = (__int64 ***)(v34 + 21);
    if ( *v42 != (__int64 *)&v41 )
      goto LABEL_50;
