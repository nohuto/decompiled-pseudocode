/*
 * XREFs of ?RegisterFenceGpuData@VIDMM_GLOBAL@@QEAAJPEAUVIDMM_FENCE_STORAGE_PAGE_GPU_DATA@@@Z @ 0x1C005F8B4
 * Callers:
 ...
 * Callees:
 *     ??0DXGAUTOPUSHLOCKFASTEXCLUSIVE@@QEAA@AEAVDXGPUSHLOCKFAST@@_N@Z @ 0x1C000162C (--0DXGAUTOPUSHLOCKFASTEXCLUSIVE@@QEAA@AEAVDXGPUSHLOCKFAST@@_N@Z.c)
 */
...
__int64 __fastcall VIDMM_GLOBAL::RegisterFenceGpuData(VIDMM_GLOBAL *this, struct VIDMM_FENCE_STORAGE_PAGE_GPU_DATA *a2)
{
  ...
  if ( *((_BYTE *)this + 40140)
    && (v9 = DpiMapIommuIdentityRange(*(_QWORD *)(*((_QWORD *)this + 3) + 192LL), *((_QWORD *)a2 + 7), 0LL, 3LL, a2),
        v12 = v9,
        v9 < 0) )
  {
