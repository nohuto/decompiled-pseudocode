/*
 * XREFs of ?UnmapPagingBuffer@VIDMM_APERTURE_SEGMENT@@UEAAXPEAU_VIDMM_GLOBAL_ALLOC@@@Z @ 0x1C00BCFB0
 * Callers:
 *     <none>
 * Callees:
...
void __fastcall VIDMM_APERTURE_SEGMENT::UnmapPagingBuffer(VIDMM_APERTURE_SEGMENT *this, struct _VIDMM_GLOBAL_ALLOC *a2)
{
  ...
  (*(void (__fastcall **)(VIDMM_APERTURE_SEGMENT *, struct _VIDMM_GLOBAL_ALLOC *, _QWORD, __int64, __int64, struct _MDL *, _DWORD))(v3 + 224))(
    this,
    a2,
    *((_QWORD *)a2 + 1) >> 12,
    v5 / 4096,
