/*
 * XREFs of ?InvalidateAllocation@VIDMM_GLOBAL@@QEAAXPEAU_VIDMM_MULTI_GLOBAL_ALLOC@@@Z @ 0x1C00ACDBC
 * Callers:
 *     VidMmInvalidateAllocation @ 0x1C0024A40 (VidMmInvalidateAllocation.c)
 * Callees:
