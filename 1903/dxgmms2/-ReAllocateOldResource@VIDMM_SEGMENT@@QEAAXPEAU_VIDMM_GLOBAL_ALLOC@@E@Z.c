/*
 * XREFs of ?ReAllocateOldResource@VIDMM_SEGMENT@@QEAAXPEAU_VIDMM_GLOBAL_ALLOC@@E@Z @ 0x1C00C13E8
 * Callers:
 *     ?CancelAllReclaimedAllocationsInList@VIDMM_GLOBAL@@IEAAXPEAU_LIST_ENTRY@@@Z @ 0x1C00AAA18 (-CancelAllReclaimedAllocationsInList@VIDMM_GLOBAL@@IEAAXPEAU_LIST_ENTRY@@@Z.c)
 * Callees:
 ...
 *     ?AllocateAt@VIDMM_LINEAR_POOL@@QEAAJT_LARGE_INTEGER@@_KPEAXPEAPEAX@Z @ 0x1C00C8050 (-AllocateAt@VIDMM_LINEAR_POOL@@QEAAJT_LARGE_INTEGER@@_KPEAXPEAPEAX@Z.c)
 */
...
void __fastcall VIDMM_SEGMENT::ReAllocateOldResource(VIDMM_SEGMENT *this, struct _VIDMM_GLOBAL_ALLOC *a2)
{
  ...
  *((_QWORD *)this + 28) += *((_QWORD *)a2 + 2);
  if ( *((_DWORD *)this + 92) != -1 && (*((_DWORD *)a2 + 19) & 0x200) == 0 )
  {
    ...
    v13 = v12 + *((_QWORD *)a2 + 2);
    *((_QWORD *)this + 29) = v13;
    if ( v12 <= qword_1C004E408 && v13 > qword_1C004E408 )
      (*(void (__fastcall **)(_QWORD))(*((_QWORD *)this + 1) + 40048LL))(*(_QWORD *)(*((_QWORD *)this + 1) + 40112LL));
    if ( !v12 )
  ...
  if ( (v14 & 0x1001) != 0 )
  {
    ...
    if ( v15 )
    {
      if ( _InterlockedIncrement((volatile signed __int32 *)(v15 + 44)) == 1 )
        _InterlockedExchangeAdd64((volatile signed __int64 *)(**((_QWORD **)a2 + 61) + 56LL), *((_QWORD *)a2 + 2));
      if ( _InterlockedIncrement((volatile signed __int32 *)(*((_QWORD *)a2 + 62) + 40LL)) != 1 )
        goto LABEL_21;
    }
    else
    {
    ...
    _InterlockedExchangeAdd64((volatile signed __int64 *)(**((_QWORD **)a2 + 61) + 64LL), *((_QWORD *)a2 + 2));
LABEL_21:
    *(_QWORD *)(*((_QWORD *)this + 1) + 40168LL) += *((_QWORD *)a2 + 2);
    v14 = *((_DWORD *)this + 20);
  }
  if ( (v14 & 0x20) != 0 )
    v16 = *((_QWORD *)a2 + 3);
  ...
  v18 = (struct _VIDMM_GLOBAL_ALLOC *)((char *)a2 + 384);
  v19 = (struct _VIDMM_GLOBAL_ALLOC **)*((_QWORD *)a2 + 48);
  if ( v19[1] != (struct _VIDMM_GLOBAL_ALLOC *)((char *)a2 + 384)
    || (v20 = (VIDMM_SEGMENT **)*((_QWORD *)a2 + 49), *v20 != v18)
