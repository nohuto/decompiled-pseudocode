/*
 * XREFs of VidSchiSwitchFromSuspendedDevices @ 0x1C00107A0
 * Callers:
 *     <none>
 * Callees:
  ...
  if ( !*(_DWORD *)(a1 + 2404) )
  {
    if ( (*(_DWORD *)(a1 + 1936) & 1) != 0 )
    {
      ...
      for ( i = 0; i < v3; ++i )
      {
        ...
        if ( v8 )
        {
          _InterlockedIncrement((volatile signed __int32 *)(v2 + 716));
          if ( _InterlockedIncrement((volatile signed __int32 *)(v7 + 2864)) == 1 )
          {
            *(_QWORD *)(v7 + 232) = 0LL;
          ...
          {
            _InterlockedDecrement((volatile signed __int32 *)(v7 + 2864));
            _bittestandset64(&v4, i);
            _InterlockedDecrement((volatile signed __int32 *)(v2 + 716));
          }
        }
        v3 = *(_DWORD *)(v2 + 68);
      }
