...
bool __fastcall VidSchiResetHwEngine(__int64 a1, __int64 a2)
{
  ...
  *(_DWORD *)(a1 + 484) = v16;
    ...
    && (qword_1C004E060 & 0x400000000010LL) == qword_1C004E060 )
  {
    ...
    v38 = v16;
    v73 = 4LL;
    TlgWrite((TraceLoggingHProvider)&hProvider, &unk_1C0040F62, 0LL, v8, 0xBu, &pData);
  }
  *(_QWORD *)(a1 + 1744) = v9;
  *(_QWORD *)(a1 + 1736) = v5 + 4;
  ...
  *((_BYTE *)v5 + 49) = 1;
    ...
    && (qword_1C004E060 & 0x400000000010LL) == qword_1C004E060 )
  {
    ...
    v86 = 4LL;
    v88 = 4LL;
    TlgWrite((TraceLoggingHProvider)&hProvider, &unk_1C0040EE8, 0LL, v22, 9u, &v74);
  }
  if ( v9 )
  {
    *((_DWORD *)v9 + 704) = v23;
      ...
      && (qword_1C004E060 & 0x400000000010LL) == qword_1C004E060 )
    {
      ...
      TlgWrite((TraceLoggingHProvider)&hProvider, &unk_1C0040E71, 0LL, v30, 9u, &v89);
    }
