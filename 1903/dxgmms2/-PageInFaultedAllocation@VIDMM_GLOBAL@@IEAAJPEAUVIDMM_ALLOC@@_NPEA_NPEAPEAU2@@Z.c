/*
 * XREFs of ?PageInFaultedAllocation@VIDMM_GLOBAL@@IEAAJPEAUVIDMM_ALLOC@@_NPEA_NPEAPEAU2@@Z @ 0x1C005D220
 * Callers:
 ...
 *     ?ReferenceAllocationForSubmission@VIDMM_GLOBAL@@QEAAXPEAUVIDMM_ALLOC@@E@Z @ 0x1C005D328 (-ReferenceAllocationForSubmission@VIDMM_GLOBAL@@QEAAXPEAUVIDMM_ALLOC@@E@Z.c)
        ...
        struct VIDMM_ALLOC **a5)
{
  ...
  *((_DWORD *)a2 + 7) &= 0xFFFFFFFC;
  ...
  if ( *((_WORD *)v14 + 2) < 3u )
  {
    ...
    {
      v6 = VIDMM_GLOBAL::PageInOneAllocation(this, a2, (**(_DWORD **)(v9 + 504) & 0x20000) != 0 ? 5 : 0, a4, v7);
      if ( v6 != -1071775466 )
        goto LABEL_6;
    }
    if ( (*(_DWORD *)(v9 + 76) & 0x8000000) == 0 )
      goto LABEL_12;
    inited = VIDMM_GLOBAL::InitContextAllocation(this, a2, 0, v7, a5);
