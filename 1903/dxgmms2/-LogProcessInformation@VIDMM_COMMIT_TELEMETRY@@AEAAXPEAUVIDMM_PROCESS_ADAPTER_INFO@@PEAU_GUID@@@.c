/*
 * XREFs of ?LogProcessInformation@VIDMM_COMMIT_TELEMETRY@@AEAAXPEAUVIDMM_PROCESS_ADAPTER_INFO@@PEAU_GUID@@@Z @ 0x1C00C5078
 * Callers:
        ...
        do
        {
          ...
          if ( (unsigned int)hProvider > 5 )
          {
            ...
            if ( v11 )
            {
              ...
              v52 = 8LL;
              v54 = 8LL;
              TlgWrite((TraceLoggingHProvider)&hProvider, &unk_1C0040BD0, a3, v22, 0x11u, &pData);
              v9 = *(_QWORD *)this;
              v8 = qword_1C004E060;
            }
          }
