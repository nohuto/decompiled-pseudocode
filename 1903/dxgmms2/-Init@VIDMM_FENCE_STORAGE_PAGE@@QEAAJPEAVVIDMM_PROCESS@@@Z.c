/*
 * XREFs of ?Init@VIDMM_FENCE_STORAGE_PAGE@@QEAAJPEAVVIDMM_PROCESS@@@Z @ 0x1C0080FF0
 * Callers:
 ...
 *     ?VidMmiAllocateMdl@@YAPEAU_MDL@@PEAX_K@Z @ 0x1C006A660 (-VidMmiAllocateMdl@@YAPEAU_MDL@@PEAX_K@Z.c)
...
__int64 __fastcall VIDMM_FENCE_STORAGE_PAGE::Init(VIDMM_FENCE_STORAGE_PAGE *this, struct VIDMM_PROCESS *a2)
{
  ...
  v7 = MmCreateSection((char *)this + 96, 0LL, 0LL, &v27, 4, v4, CurrentHandle, 0LL);
  if ( v7 < 0 )
  {
    *v6 = 0LL;
  }
  else
  {
    ...
    if ( v7 >= 0 )
    {
      Mdl = VidMmiAllocateMdl(*((_QWORD *)this + 13), 0x1000uLL);
      *((_QWORD *)this + 14) = Mdl;
      if ( Mdl )
      {
  ...
  VIDMM_FENCE_STORAGE_PAGE::FreeStorage((PMDL *)this);
