/*
 * XREFs of McTemplateK0pqtt @ 0x1C00263DC
 * Callers:
...
ULONG McTemplateK0pqtt(__int64 a1, __int64 a2, const GUID *a3, ...)
{
  ...
  v12 = 4LL;
  va_copy(v11, va3);
  return McGenEventWrite((PMCGEN_TRACE_CONTEXT)&DxgkControlGuid_Context, &EventResetBackingStore, a3, 5u, &EventData);
}
