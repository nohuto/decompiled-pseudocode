/*
 * XREFs of VidSchiProcessDpcCompletedPacket @ 0x1C0006A10
 * Callers:
 ...
 *     VidSchiMonitorRefreshPeriodFromNode @ 0x1C0014AE4 (VidSchiMonitorRefreshPeriodFromNode.c)
...
void __fastcall VidSchiProcessDpcCompletedPacket(struct _VIDSCH_DMA_PACKET *a1)
{
  ...
  union _LARGE_INTEGER PerformanceFrequency; // [rsp+60h] [rbp-A0h] BYREF
