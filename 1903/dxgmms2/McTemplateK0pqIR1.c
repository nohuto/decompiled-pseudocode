/*
 * XREFs of McTemplateK0pqIR1 @ 0x1C002C5D4
 * Callers:
...
ULONG McTemplateK0pqIR1(__int64 a1, __int64 a2, const GUID *a3, ...)
{
  ...
  v10 = 8 * v14;
  v8 = 4LL;
  return McGenEventWrite((PMCGEN_TRACE_CONTEXT)&DxgkControlGuid_Context, &EventRecordGpuWork, a3, 4u, &EventData);
}
