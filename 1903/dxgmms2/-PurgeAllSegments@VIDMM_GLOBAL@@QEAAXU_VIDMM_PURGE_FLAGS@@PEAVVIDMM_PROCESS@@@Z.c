/*
 * XREFs of ?PurgeAllSegments@VIDMM_GLOBAL@@QEAAXU_VIDMM_PURGE_FLAGS@@PEAVVIDMM_PROCESS@@@Z @ 0x1C00AE5A4
 * Callers:
 *     VidMmPurgeAllSegments @ 0x1C0024AF0 (VidMmPurgeAllSegments.c)
 * Callees:
