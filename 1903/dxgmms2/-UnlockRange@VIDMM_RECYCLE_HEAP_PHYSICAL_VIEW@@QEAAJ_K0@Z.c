/*
 * XREFs of ?UnlockRange@VIDMM_RECYCLE_HEAP_PHYSICAL_VIEW@@QEAAJ_K0@Z @ 0x1C0066594
 * Callers:
 ...
 *     ?Unlock@VIDMM_MDL_RANGE@@QEAAXXZ @ 0x1C00669D8 (-Unlock@VIDMM_MDL_RANGE@@QEAAXXZ.c)
 *     ?InsertBetween@VIDMM_MDL_RANGE@@QEAAXPEAV1@0@Z @ 0x1C0069FCC (-InsertBetween@VIDMM_MDL_RANGE@@QEAAXPEAV1@0@Z.c)
  ...
  if ( v6 != (VIDMM_RECYCLE_HEAP_PHYSICAL_VIEW *)((char *)this + 8) )
  {
    ...
    if ( v11 )
    {
      ...
      else
      {
        ...
        if ( v53 < 0 )
        {
          _InterlockedAdd(&dword_1C004E694, 1u);
