/*
 * XREFs of ?VidMmReserveGpuVirtualAddress@VIDMM_GLOBAL@@QEAAJPEAVVIDMM_PROCESS@@PEAVVIDMM_PAGING_QUEUE@@PEAUD3DDDI_RESERVEGPUVIRTUALADDRESS@@@Z @ 0x1C0084BD4
 * Callers:
 *     VidMmReserveGpuVirtualAddress @ 0x1C0017720 (VidMmReserveGpuVirtualAddress.c)
 * Callees:
