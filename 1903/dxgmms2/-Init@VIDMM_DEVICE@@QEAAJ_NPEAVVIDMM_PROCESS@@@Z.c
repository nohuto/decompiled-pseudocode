/*
 * XREFs of ?Init@VIDMM_DEVICE@@QEAAJ_NPEAVVIDMM_PROCESS@@@Z @ 0x1C0061AE0
 * Callers:
 *     VidMmInitDevice @ 0x1C0001820 (VidMmInitDevice.c)
...
__int64 __fastcall VIDMM_DEVICE::Init(VIDMM_DEVICE *this, __int64 a2, struct VIDMM_PROCESS *a3)
{
  ...
  {
    if ( DXGPROCESS::GetCurrent() && (v6 = *((_QWORD *)DXGPROCESS::GetCurrent() + 9)) != 0 )
  ...
  {
    v7 = *(VIDMM_PROCESS **)(*(_QWORD *)this + 40320LL);
  }
  *((_QWORD *)this + 1) = v7;
  if ( !v7 )
  {
  ...
  if ( *((_QWORD *)this + 3) )
  {
    ...
    if ( v9 < 0 )
    {
      _InterlockedAdd(&dword_1C004E5A8, 1u);
      v46 = WdLogNewEntry5_WdLowResource(v8);
      *(_QWORD *)(v46 + 24) = 384LL;
    ...
    *((_QWORD *)this + 2) = *(_QWORD *)(*(_QWORD *)(*((_QWORD *)this + 1) + 16LL)
                                      + 8LL * *(unsigned int *)(*(_QWORD *)(*(_QWORD *)this + 24LL) + 208LL));
  }
  ...
  *((_QWORD *)this + 5) = v11;
  if ( !v11 )
  {
    _InterlockedAdd(&dword_1C004E5AC, 1u);
...
LABEL_60:
  ...
  if ( *((_DWORD *)this + 15) )
  {
    while ( 1 )
    {
      v33 = 176LL * v32;
      LOBYTE(v49) = v4;
      result = VIDMM_DEVICE_PAGING_QUEUE::Initialize(v33 + *((_QWORD *)this + 9), this, v32, 1LL, v49);
      if ( (int)result < 0 )
        break;
      LOBYTE(v50) = v4;
      result = VIDMM_DEVICE_PAGING_QUEUE::Initialize(v33 + *((_QWORD *)this + 10), this, v32, 2LL, v50);
      if ( (int)result < 0 )
        break;
      v35 = *((_QWORD *)this + 11);
      if ( v35 )
      {
        LOBYTE(v49) = v4;
        result = VIDMM_DEVICE_PAGING_QUEUE::Initialize(v33 + v35, this, v32, 3LL, v49);
        if ( (int)result < 0 )
          break;
      }
...
LABEL_38:
    ...
    *((_QWORD *)this + 27) = qword_1C004E3C8 + v36 * KeQueryTimeIncrement();
    return 0LL;
  }
  return result;
}
