/*
 * XREFs of ?Escape@VIDMM_GLOBAL@@QEAAJPEAVVIDMM_DEVICE@@PEAU_D3DKMT_VIDMM_ESCAPE@@H@Z @ 0x1C00ABAD0
 * Callers:
 *     VidMmEscape @ 0x1C00249A0 (VidMmEscape.c)
 * Callees:
 ...
 *     ?Flush@VIDMM_WORKER_THREAD@@QEAAXXZ @ 0x1C00B4294 (-Flush@VIDMM_WORKER_THREAD@@QEAAXXZ.c)
  ...
  if ( Type != D3DKMT_VIDMMESCAPETYPE_SUSPEND_CPU_ACCESS_TEST )
  {
    switch ( Type )
    {
      case D3DKMT_VIDMMESCAPETYPE_SET_TRIM_INTERVALS:
        ...
        v10 = dword_1C004E394;
        v11 = dword_1C004E38C;
        dword_1C004E398 = a3->Wake.bFlush;
        dword_1C004E394 = a3->Evict.AllocationHandle;
        dword_1C004E38C = a3->SuspendProcess.bAllowWakeOnSubmission;
