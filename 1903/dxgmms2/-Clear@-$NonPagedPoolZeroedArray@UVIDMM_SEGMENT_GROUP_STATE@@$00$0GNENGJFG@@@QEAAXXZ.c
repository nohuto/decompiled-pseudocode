/*
 * XREFs of ?Clear@?$NonPagedPoolZeroedArray@UVIDMM_SEGMENT_GROUP_STATE@@$00$0GNENGJFG@@@QEAAXXZ @ 0x1C0027AD8
 * Callers:
 *     ??1VIDMM_PARTITION_ADAPTER_INFO@@QEAA@XZ @ 0x1C0027A30 (--1VIDMM_PARTITION_ADAPTER_INFO@@QEAA@XZ.c)
