/*
 * XREFs of ?ReportProcessAdapterBudget@VIDMM_GLOBAL@@QEAAXPEAUVIDMM_PROCESS_ADAPTER_INFO@@@Z @ 0x1C0080EA0
 * Callers:
...
void __fastcall VIDMM_GLOBAL::ReportProcessAdapterBudget(VIDMM_GLOBAL *this, struct _KTHREAD **a2)
{
  ...
  for ( i = 0; i < *((_DWORD *)this + 1748); ++i )
  {
    ...
    do
    {
      LOBYTE(v5) = *(_BYTE *)(v10 + *((_QWORD *)this + 5023) + 512);
      if ( (v5 & 2) != 0 )
      {
        v12 = *v11;
        ...
        if ( (Microsoft_Windows_DxgKrnlEnableBits & 0x400) != 0 )
        {
          ...
          McTemplateK0xxpqhuuuuu(v5, v4, v6);
          if ( (Microsoft_Windows_DxgKrnlEnableBits & 0x400) != 0 )
          {
            LOBYTE(v17) = v8;
            LOWORD(v16) = i;
            LODWORD(v15) = *((_DWORD *)a2[5] + 2);
            McTemplateK0xxpqhu(v5, &EventVidMmProcessUsageChange, v6, v12, v12, *((_QWORD *)this + 3), v15, v16, v17);
            if ( (Microsoft_Windows_DxgKrnlEnableBits & 0x400) != 0 )
            {
              LOBYTE(v17) = v8;
              LOWORD(v16) = i;
    ...
    if ( *(_QWORD *)(v9 + 152) && (Microsoft_Windows_DxgKrnlEnableBits & 0x400) != 0 )
      McTemplateK0xxpqhu(v5, &EventVidMmProcessUsageChange, v6);
    v13 = 0;
    v14 = (_QWORD *)(v9 + 256);
    do
    {
      if ( *v14 && (Microsoft_Windows_DxgKrnlEnableBits & 0x400) != 0 )
        McTemplateK0xxpqhu(v5, &EventVidMmProcessDemotedCommitmentChange, v6);
      ++v13;
      ++v14;
    }
    while ( v13 < 5u );
