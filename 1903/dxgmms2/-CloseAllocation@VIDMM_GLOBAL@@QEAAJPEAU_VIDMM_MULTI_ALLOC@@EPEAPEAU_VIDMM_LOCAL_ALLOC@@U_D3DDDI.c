/*
 * XREFs of ?CloseAllocation@VIDMM_GLOBAL@@QEAAJPEAU_VIDMM_MULTI_ALLOC@@EPEAPEAU_VIDMM_LOCAL_ALLOC@@U_D3DDDICB_DESTROYALLOCATION2FLAGS@@PEAPEAU_KEVENT@@@Z @ 0x1C00711F4
 * Callers:
 *     VidMmCloseAllocation @ 0x1C00029B0 (VidMmCloseAllocation.c)
 *     VidMmTryCloseAllocation @ 0x1C0014940 (VidMmTryCloseAllocation.c)
 * Callees:
