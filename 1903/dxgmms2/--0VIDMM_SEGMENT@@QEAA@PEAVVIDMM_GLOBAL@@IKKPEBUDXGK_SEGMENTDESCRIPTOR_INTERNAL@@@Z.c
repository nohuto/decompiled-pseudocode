/*
 * XREFs of ??0VIDMM_SEGMENT@@QEAA@PEAVVIDMM_GLOBAL@@IKKPEBUDXGK_SEGMENTDESCRIPTOR_INTERNAL@@@Z @ 0x1C008F720
 * Callers:
        ...
        const struct DXGK_SEGMENTDESCRIPTOR_INTERNAL *a6)
{
  ...
  *((_QWORD *)this + 15) = 0LL;
  memset((char *)this + 312, 0, 0x38uLL);
  memset((char *)this + 416, 0, 0x20uLL);
  v8 = *((_QWORD *)a6 + 2);
  v9 = dword_1C004E188[a5];
  if ( (_DWORD)v9 && v8 >= v9 )
    v8 = dword_1C004E188[a5];
  *((_QWORD *)this + 8) = v8;
  *((_QWORD *)this + 7) = v8;
  v10 = *(_DWORD *)a6;
  ...
  *((_DWORD *)this + 94) = (v10 & 0x800) != 0 ? 0x10000 : 4096;
