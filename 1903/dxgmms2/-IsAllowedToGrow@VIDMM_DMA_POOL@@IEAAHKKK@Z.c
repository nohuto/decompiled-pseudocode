/*
 * XREFs of ?IsAllowedToGrow@VIDMM_DMA_POOL@@IEAAHKKK@Z @ 0x1C005A318
 * Callers:
        ...
        unsigned int a4)
{
  ...
  v9 = (const GUID *)(a4 + *((_DWORD *)this + 34));
  v10 = VIDMM_DMA_POOL::_TotalPatchLocationListBytes + a4;
  if ( (*((_BYTE *)this + 32) & 1) != 0 )
    return 0LL;
  v12 = *((_QWORD *)this + 2);
  v13 = VIDMM_DMA_POOL::_MaxNbDmaBuffers;
  if ( *(_DWORD *)(*(_QWORD *)(v12 + 24) + 328LL) == 2 )
    v13 = VIDMM_DMA_POOL::_MaxNbCddDmaBuffers;
  if ( *((_DWORD *)this + 23) >= (unsigned int)v13 )
  {
    if ( !bTracingEnabled || (Microsoft_Windows_DxgKrnlEnableBits & 0x40) == 0 )
      return 0LL;
LABEL_30:
    McTemplateK0pq(v13, &EventDmaPoolTrimmingPolicy, v9);
    return 0LL;
  }
