/*
 * XREFs of McTemplateK0xxpqhu @ 0x1C00274B4
 * Callers:
...
ULONG McTemplateK0xxpqhu(__int64 a1, const EVENT_DESCRIPTOR *a2, const GUID *a3, ...)
{
  ...
  v14 = 2LL;
  v16 = 1LL;
  return McGenEventWrite((PMCGEN_TRACE_CONTEXT)&DxgkControlGuid_Context, a2, a3, 7u, &EventData);
}
