/*
 * XREFs of ?DestroyContextAllocation@VIDMM_GLOBAL@@QEAAJPEAU_VIDMM_CONTEXT_ALLOC@@@Z @ 0x1C0080ACC
 * Callers:
 *     VidMmDestroyContextAllocation @ 0x1C00147C0 (VidMmDestroyContextAllocation.c)
 * Callees:
