/*
 * XREFs of ?VidMmUpdateContextAllocationCb@VIDMM_GLOBAL@@QEAAJPEBU_DXGKARGCB_UPDATECONTEXTALLOCATION@@E@Z @ 0x1C00B2180
 * Callers:
 *     ?VidMmUpdateContextAllocationCb@@YAJPEAVVIDMM_GLOBAL@@PEBU_DXGKARGCB_UPDATECONTEXTALLOCATION@@@Z @ 0x1C00247F0 (-VidMmUpdateContextAllocationCb@@YAJPEAVVIDMM_GLOBAL@@PEBU_DXGKARGCB_UPDATECONTEXTALLOCATION@@@Z.c)
        ...
        char a3)
{
  ...
  int v19; // eax
  unsigned __int8 MustFlushTlbOnValidTransition; // al
  char v21; // dl
  ...
  if ( a3 )
  {
    ...
    if ( (*(_DWORD *)(v6 + 28) & 3) == 2 )
    {
      ...
      if ( v13 )
      {
        ...
        if ( (v19 & 0x1001) != 0 )
        {
          VidMmGetFullMDL((struct _VIDMM_GLOBAL_ALLOC *)v9, 0LL);
          v19 = *(_DWORD *)(v10 + 80);
        }
        if ( (v19 & 0x1001) == 0 && (v19 & 0x1000) == 0 )
          v3 = *(_DWORD *)(v10 + 16) + 1;
        MustFlushTlbOnValidTransition = VIDMM_GLOBAL::MustFlushTlbOnValidTransition(this, *(_DWORD *)(v9 + 76) & 0x3F);
  ...
  else
  {
    ...
    LODWORD(v24[0]) = 117;
    v24[5] = a2;
    HIDWORD(v24[0]) = *(_DWORD *)(*v7 + 76) & 0x3F;
