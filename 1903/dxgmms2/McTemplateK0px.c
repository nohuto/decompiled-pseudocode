/*
 * XREFs of McTemplateK0px @ 0x1C002D798
 * Callers:
...
ULONG McTemplateK0px(__int64 a1, __int64 a2, const GUID *a3, ...)
{
  ...
  v10 = 0;
  v9 = 8;
  return McGenEventWrite((PMCGEN_TRACE_CONTEXT)&DxgkControlGuid_Context, &EventRetireSyncPoint, a3, 3u, &v4);
}
