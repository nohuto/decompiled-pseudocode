/*
 * XREFs of ?RequestNewBudget@VIDMM_GLOBAL@@QEAAX_N@Z @ 0x1C005DAC4
 * Callers:
 ...
 *     ?NotifyProcessStatusChange@VIDMM_GLOBAL@@QEAAXXZ @ 0x1C005DAAC (-NotifyProcessStatusChange@VIDMM_GLOBAL@@QEAAXXZ.c)
