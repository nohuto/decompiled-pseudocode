/*
 * XREFs of ?VidMmiInit@@YAPEAVVIDMM_GLOBAL@@PEAVADAPTER_RENDER@@@Z @ 0x1C008E620
 * Callers:
 *     VidMmInitializeAdapter @ 0x1C0017BE0 (VidMmInitializeAdapter.c)
 * Callees:
...
struct VIDMM_GLOBAL *__fastcall VidMmiInit(struct ADAPTER_RENDER *a1)
{
  ...
  if ( ZwQuerySystemInformation(SystemBasicInformation, SystemInformation, 0x40u, 0LL) < 0
    || *(_QWORD *)(v2 + 1848) < (unsigned __int64)SystemInformation[5] << 12 )
  {
  ...
  v6 = 40LL * *(unsigned int *)(v2 + 256);
  if ( !is_mul_ok(*(unsigned int *)(v2 + 256), 0x28uLL) )
    v6 = -1LL;
  ...
  memset(v8, 0, 40LL * *(unsigned int *)(v2 + 256));
...
LABEL_11:
  v14 = (VIDMM_GLOBAL *)operator new(0xA240uLL, 0x35316956u, v9, (POOL_TYPE)512);
  if ( v14 )
