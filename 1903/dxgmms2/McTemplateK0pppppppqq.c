/*
 * XREFs of McTemplateK0pppppppqq @ 0x1C0028C34
 * Callers:
...
ULONG McTemplateK0pppppppqq(__int64 a1, __int64 a2, const GUID *a3, ...)
{
  ...
  v20 = 4LL;
  v22 = 4LL;
  return McGenEventWrite((PMCGEN_TRACE_CONTEXT)&DxgkControlGuid_Context, &EventRecycleRangeCreate, a3, 0xAu, &EventData);
}
