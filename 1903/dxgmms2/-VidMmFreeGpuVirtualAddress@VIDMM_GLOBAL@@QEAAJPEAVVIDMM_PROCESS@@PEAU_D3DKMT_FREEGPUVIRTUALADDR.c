/*
 * XREFs of ?VidMmFreeGpuVirtualAddress@VIDMM_GLOBAL@@QEAAJPEAVVIDMM_PROCESS@@PEAU_D3DKMT_FREEGPUVIRTUALADDRESS@@E@Z @ 0x1C0063338
 * Callers:
 *     VidMmFreeGpuVirtualAddress @ 0x1C0016C30 (VidMmFreeGpuVirtualAddress.c)
