/*
 * XREFs of ?Init@VIDMM_SEGMENT@@UEAAJP6AXPEAX@ZPEAT_LARGE_INTEGER@@@Z @ 0x1C008A5E0
 * Callers:
 *     ?Init@VIDMM_SYSMEM_SEGMENT@@UEAAJP6AXPEAX@ZPEAT_LARGE_INTEGER@@@Z @ 0x1C008A3C0 (-Init@VIDMM_SYSMEM_SEGMENT@@UEAAJP6AXPEAX@ZPEAT_LARGE_INTEGER@@@Z.c)
...
__int64 __fastcall VIDMM_SEGMENT::Init(PHYSICAL_ADDRESS *this, void (*a2)(void *), union _LARGE_INTEGER *a3)
{
  ...
  else
  {
    ...
    if ( !v6 )
    {
      _InterlockedIncrement(&dword_1C004E5A0);
    ...
    if ( v8 < 0 )
    {
      _InterlockedIncrement(&dword_1C004E5A4);
      ...
      if ( (int)v10 >= 0 )
      {
        ...
        if ( PagesForMdl )
        {
          ...
          if ( (_DWORD)v15 )
          {
            ...
            {
              this[30].LowPart = 0;
              _InterlockedIncrement(dword_1C004E674);
        ...
        _InterlockedIncrement(&dword_1C004E638);
