/*
 * XREFs of McTemplateK0pqxqt @ 0x1C002D628
 * Callers:
...
ULONG McTemplateK0pqxqt(__int64 a1, __int64 a2, const GUID *a3, ...)
{
  ...
  va_copy(v13, va4);
  v14 = 4LL;
  return McGenEventWrite((PMCGEN_TRACE_CONTEXT)&DxgkControlGuid_Context, &EventDmaDpcComplete, a3, 6u, &EventData);
}
