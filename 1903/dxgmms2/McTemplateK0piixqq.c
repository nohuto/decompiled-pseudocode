/*
 * XREFs of McTemplateK0piixqq @ 0x1C002C198
 * Callers:
 ...
 *     VidSchiResetContextQuantumAtISR @ 0x1C0013470 (VidSchiResetContextQuantumAtISR.c)
 *     VidSchiStartContextRunningTimeAtISR @ 0x1C00134F0 (VidSchiStartContextRunningTimeAtISR.c)
 * Callees:
 *     __security_check_cookie @ 0x1C0018060 (__security_check_cookie.c)
 *     McGenEventWrite @ 0x1C0025A44 (McGenEventWrite.c)
 */

ULONG McTemplateK0piixqq(__int64 a1, __int64 a2, const GUID *a3, ...)
{
