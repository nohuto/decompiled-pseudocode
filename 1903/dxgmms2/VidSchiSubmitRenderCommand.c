/*
 * XREFs of VidSchiSubmitRenderCommand @ 0x1C00CA3F4
 * Callers:
 ...
 *     ?UpdateHistoryBuffer@_VIDSCH_QUEUE_PACKET@@QEAAXXZ @ 0x1C000454C (-UpdateHistoryBuffer@_VIDSCH_QUEUE_PACKET@@QEAAXXZ.c)
 ...
 *     VidSchGetNewSubmissionFenceId @ 0x1C007C108 (VidSchGetNewSubmissionFenceId.c)
