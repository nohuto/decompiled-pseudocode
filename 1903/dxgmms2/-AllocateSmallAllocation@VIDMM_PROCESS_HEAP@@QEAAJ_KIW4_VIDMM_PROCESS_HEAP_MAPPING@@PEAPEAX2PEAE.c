/*
 * XREFs of ?AllocateSmallAllocation@VIDMM_PROCESS_HEAP@@QEAAJ_KIW4_VIDMM_PROCESS_HEAP_MAPPING@@PEAPEAX2PEAEE@Z @ 0x1C00C62F0
 * Callers:
...
LABEL_8:
    ...
    v25 = a8;
    v16 = VIDMM_PROCESS_HEAP::AllocateBlock(a1, RegionSize, v9, a4, &v39, a8);
    if ( v16 < 0 )
      goto LABEL_24;
    LOBYTE(v26) = 1;
    v43 = 1;
  ...
  if ( !*((_QWORD *)v23 + 7) && !*((_QWORD *)v23 + 11) )
  {
    ...
    {
      BaseAddress = 0LL;
      _InterlockedIncrement(&dword_1C004E670);
