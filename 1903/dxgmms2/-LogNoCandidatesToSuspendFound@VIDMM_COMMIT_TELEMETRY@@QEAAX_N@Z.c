/*
 * XREFs of ?LogNoCandidatesToSuspendFound@VIDMM_COMMIT_TELEMETRY@@QEAAX_N@Z @ 0x1C00C4ED8
 * Callers:
    ...
    && (unsigned int)_InterlockedIncrement((volatile signed __int32 *)(*((_QWORD *)this + 1) + 264LL)) <= 5 )
  {
    ...
    *(_QWORD *)ActivityId.Data4 = 0LL;
      ...
      && (qword_1C004E060 & 0x10000) == qword_1C004E060 )
    {
      ...
      v11 = v9;
      v21 = 8;
      TlgWrite((TraceLoggingHProvider)&hProvider, &unk_1C00408B0, &ActivityId, v10, 6u, &pData);
    }
