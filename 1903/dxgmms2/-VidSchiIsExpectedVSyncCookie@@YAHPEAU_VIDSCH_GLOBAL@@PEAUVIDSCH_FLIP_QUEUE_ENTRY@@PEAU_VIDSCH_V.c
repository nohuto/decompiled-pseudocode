/*
 * XREFs of ?VidSchiIsExpectedVSyncCookie@@YAHPEAU_VIDSCH_GLOBAL@@PEAUVIDSCH_FLIP_QUEUE_ENTRY@@PEAU_VIDSCH_VSYNC_COOKIE@@@Z @ 0x1C000D710
 * Callers:
 *     VidSchiProcessDpcVSyncCookie @ 0x1C000C010 (VidSchiProcessDpcVSyncCookie.c)
 * Callees:
 *     ?VidSchiIsExpectedVSyncCookie2@@YAHPEAU_VIDSCH_GLOBAL@@PEAUVIDSCH_FLIP_QUEUE_ENTRY@@PEAU_VIDSCH_VSYNC_COOKIE@@@Z @ 0x1C002AB0C (-VidSchiIsExpectedVSyncCookie2@@YAHPEAU_VIDSCH_GLOBAL@@PEAUVIDSCH_FLIP_QUEUE_ENTRY@@PEAU_VIDSCH_.c)
 */
        ...
        struct _VIDSCH_VSYNC_COOKIE *a3)
{
  ...
  if ( v7 == 3 )
  {
    if ( !v8 )
    {
      LOBYTE(v4) = *((_QWORD *)a3 + 14) == *(_QWORD *)(*(_DWORD *)(*((_QWORD *)a2 + 148) + 4LL)
                                                     * ((8 * *(_DWORD *)(*((_QWORD *)a2 + 148) + 8LL) + 191) & 0xFFFFFFF8)
                                                     + *((_QWORD *)a2 + 148)
                                                     + 40LL);
      return v4;
    }
  ...
  if ( v8 )
  {
    ...
    if ( (v10 & (v11 >> 10) & 0x3FF) == 0 && (v11 & v10 & 0x3FF) == (v11 & 0x3FF) )
    {
      ...
      if ( (v11 & 0x3FF) != 0 )
      {
        ...
        while ( v13 )
        {
          v19 = (_DWORD *)*((_QWORD *)a2 + 148);
          v20 = 1 << v16;
          if ( (*v19 & (1 << v16) & 0x3FF) != 0 )
          {
            v21 = 5LL * v18;
            if ( *((_QWORD *)a3 + 5 * v18 + 14) != *(_QWORD *)((char *)&v19[16 * (unsigned __int64)(unsigned int)v17
                                                                          + 10]
                                                             + ((8 * v19[2] + 191) & 0xFFFFFFF8) * v19[1]) )
              return 0LL;
            v25 = (_DWORD *)((char *)v19 + ((8 * v19[2] + 191) & 0xFFFFFFF8) * v17 + 160);
            if ( RtlCompareMemory(v25, (char *)a3 + 40 * v18 + 120, 8uLL) != 8 )
              return 0LL;
  ...
  if ( (*((_DWORD *)a3 + 25) & 0x3FF) != 1
    || *((_QWORD *)a3 + 14) != *(_QWORD *)(*(_DWORD *)(*((_QWORD *)a2 + 148) + 4LL)
                                         * ((8 * *(_DWORD *)(*((_QWORD *)a2 + 148) + 8LL) + 191) & 0xFFFFFFF8)
                                         + *((_QWORD *)a2 + 148)
                                         + 40LL) )
  {
