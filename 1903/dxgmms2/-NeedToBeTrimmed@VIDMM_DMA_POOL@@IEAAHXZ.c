/*
 * XREFs of ?NeedToBeTrimmed@VIDMM_DMA_POOL@@IEAAHXZ @ 0x1C00B5F80
 * Callers:
 *     ?GetNextBuffersContractedSize@VIDMM_DMA_POOL@@QEAAXPEA_KPEAI1@Z @ 0x1C00B5F08 (-GetNextBuffersContractedSize@VIDMM_DMA_POOL@@QEAAXPEA_KPEAI1@Z.c)
...
__int64 __fastcall VIDMM_DMA_POOL::NeedToBeTrimmed(VIDMM_DMA_POOL *this, __int64 a2, const GUID *a3)
{
  __int64 v3; // rax
  __int64 v4; // rax
  __int64 v5; // rax
