/*
 * XREFs of McTemplateK0pqqpxp @ 0x1C002CC24
 * Callers:
...
ULONG McTemplateK0pqqpxp(__int64 a1, __int64 a2, const GUID *a3, ...)
{
  ...
  v14 = 8LL;
  v16 = 8LL;
  return McGenEventWrite((PMCGEN_TRACE_CONTEXT)&DxgkControlGuid_Context, &EventWaitQueueSubmit, a3, 7u, &EventData);
}
