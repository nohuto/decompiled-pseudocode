/*
 * XREFs of ?Run@VIDMM_WORKER_THREAD@@QEAAXXZ @ 0x1C0087740
 * Callers:
 *     ?VidMmWorkerThreadProc@@YAXPEAX@Z @ 0x1C0087720 (-VidMmWorkerThreadProc@@YAXPEAX@Z.c)
 * Callees:
 *     VidSchMarkDeviceAsError @ 0x1C0001010 (VidSchMarkDeviceAsError.c)
 *     ?GetNextPendingTermination@VIDMM_GLOBAL@@QEAAPEAUVIDMM_ALLOC@@PEA_N@Z @ 0x1C000130C (-GetNextPendingTermination@VIDMM_GLOBAL@@QEAAPEAUVIDMM_ALLOC@@PEA_N@Z.c)
 ...
 *     ?DriverId@VIDMM_SEGMENT@@QEAAKXZ @ 0x1C0002564 (-DriverId@VIDMM_SEGMENT@@QEAAKXZ.c)
 ...
 *     ?IsPenaltyBoxEmptyWithoutLock@VIDMM_GLOBAL@@QEAA_NW4VIDMM_PENALTY_BOX_BAND@@@Z @ 0x1C001810C (-IsPenaltyBoxEmptyWithoutLock@VIDMM_GLOBAL@@QEAA_NW4VIDMM_PENALTY_BOX_BAND@@@Z.c)
 ...
 *     ?TotalDemotedCommitment@VIDMM_PROCESS_BUDGET_STATE@@QEBA_KXZ @ 0x1C005C958 (-TotalDemotedCommitment@VIDMM_PROCESS_BUDGET_STATE@@QEBA_KXZ.c)
 ...
 *     ?CleanupMarkedForEvictionAllocationsWorker@VIDMM_GLOBAL@@QEAAEXZ @ 0x1C005DE5C (-CleanupMarkedForEvictionAllocationsWorker@VIDMM_GLOBAL@@QEAAEXZ.c)
 ...
 *     ?UnderCleanupLimit@VIDMM_GLOBAL@@QEAA_NXZ @ 0x1C005EB80 (-UnderCleanupLimit@VIDMM_GLOBAL@@QEAA_NXZ.c)
 ...
 *     ?ResetCleanupCounters@VIDMM_GLOBAL@@QEAAX_N@Z @ 0x1C00816F4 (-ResetCleanupCounters@VIDMM_GLOBAL@@QEAAX_N@Z.c)
 ...
 *     ?IsBetterYieldCandidate@VIDMM_DEVICE@@QEAA_NPEAV1@@Z @ 0x1C00B35D4 (-IsBetterYieldCandidate@VIDMM_DEVICE@@QEAA_NPEAV1@@Z.c)
 ...
 *     ?ReclaimPacket@VIDMM_PAGING_QUEUE@@QEAAXPEAUVIDMM_PAGING_QUEUE_PACKET@@@Z @ 0x1C00B6F18 (-ReclaimPacket@VIDMM_PAGING_QUEUE@@QEAAXPEAUVIDMM_PAGING_QUEUE_PACKET@@@Z.c)
 *     ?RewindPacket@VIDMM_PAGING_QUEUE@@QEAAXPEAUVIDMM_PAGING_QUEUE_PACKET@@@Z @ 0x1C00B7030 (-RewindPacket@VIDMM_PAGING_QUEUE@@QEAAXPEAUVIDMM_PAGING_QUEUE_PACKET@@@Z.c)
 ...
 *     ?AssignBudgets@VIDMM_GLOBAL@@IEAAXPEAUVIDMM_BUDGET_STATE@@W4_D3DKMT_MEMORY_SEGMENT_GROUP@@@Z @ 0x1C00C3510 (-AssignBudgets@VIDMM_GLOBAL@@IEAAXPEAUVIDMM_BUDGET_STATE@@W4_D3DKMT_MEMORY_SEGMENT_GROUP@@@Z.c)
 ...
 *     ?Init@VIDMM_COMMIT_TELEMETRY@@QEAAXPEAVVIDMM_GLOBAL@@PEAVVIDMM_DEVICE@@PEAUVIDMM_ALLOC@@@Z @ 0x1C00C4274 (-Init@VIDMM_COMMIT_TELEMETRY@@QEAAXPEAVVIDMM_GLOBAL@@PEAVVIDMM_DEVICE@@PEAUVIDMM_ALLOC@@@Z.c)
...
void __fastcall VIDMM_WORKER_THREAD::Run(VIDMM_WORKER_THREAD *this)
{
  ...
  bool v290; // [rsp+90h] [rbp-70h] BYREF
  int v291; // [rsp+94h] [rbp-6Ch] BYREF
  bool *v292; // [rsp+98h] [rbp-68h]
  VIDMM_COMMIT_TELEMETRY *v293; // [rsp+A0h] [rbp-60h]
  char *v294; // [rsp+A8h] [rbp-58h]
  int *v295; // [rsp+B0h] [rbp-50h]
  int ThreadInformation; // [rsp+B8h] [rbp-48h] BYREF
  struct VIDMM_DEVICE *v297; // [rsp+C0h] [rbp-40h]
  int v298; // [rsp+C8h] [rbp-38h] BYREF
  __int64 v299; // [rsp+D0h] [rbp-30h]
  int v300; // [rsp+D8h] [rbp-28h]
  union _LARGE_INTEGER v301; // [rsp+E0h] [rbp-20h] BYREF
  __int64 *v302; // [rsp+E8h] [rbp-18h]
  union _LARGE_INTEGER PerformanceFrequency; // [rsp+F8h] [rbp-8h] BYREF
  PVOID Object; // [rsp+100h] [rbp+0h] BYREF
  __int64 v305; // [rsp+108h] [rbp+8h]
  char v306[8]; // [rsp+110h] [rbp+10h] BYREF
  __int64 v307; // [rsp+118h] [rbp+18h]
  int v308; // [rsp+120h] [rbp+20h]
  struct VIDMM_ALLOC *v309; // [rsp+128h] [rbp+28h] BYREF
  int v310; // [rsp+130h] [rbp+30h] BYREF
  __int64 v311; // [rsp+134h] [rbp+34h]
  int v312; // [rsp+13Ch] [rbp+3Ch]
  struct VIDMM_ALLOC *v313; // [rsp+140h] [rbp+40h]
  __int64 v314; // [rsp+148h] [rbp+48h]
  __int128 v315; // [rsp+150h] [rbp+50h]
  __int128 v316; // [rsp+160h] [rbp+60h]
  __int128 v317; // [rsp+170h] [rbp+70h]
  _BYTE v318[24]; // [rsp+180h] [rbp+80h] BYREF
  _BYTE v319[88]; // [rsp+198h] [rbp+98h] BYREF
  char v321; // [rsp+208h] [rbp+108h]
  char v322; // [rsp+210h] [rbp+110h]
  bool v323; // [rsp+218h] [rbp+118h] BYREF
...
LABEL_68:
    ...
    if ( ((*((_DWORD *)this + 7) - 1) & 0xFFFFFFFD) == 0 )
    {
      ...
      {
LABEL_106:
        DXGAUTOPUSHLOCKEXCLUSIVE::~DXGAUTOPUSHLOCKEXCLUSIVE((DXGAUTOPUSHLOCKEXCLUSIVE *)v318);
...
LABEL_75:
    ...
    *((_QWORD *)v35 + 1) = 0LL;
    ...
    v293 = (VIDMM_WORKER_THREAD *)((char *)v50 + 184);
LABEL_162:
    while ( 2 )
    {
      while ( 2 )
...
LABEL_172:
          ...
          if ( v93 != 2 )
            v97 = 12LL;
          v99 = v97 + 8 * v98;
          v100 = (char *)&unk_1C00420C0 + v99;
          v294 = (char *)&unk_1C00420C0 + v99;
          if ( !v49 )
          {
            if ( !v36 )
            {
            ...
            if ( g_IsInternalReleaseOrDbg )
              WdLogNewEntry5_WdTrace(12LL);
            v101 = (bool *)&unk_1C00420C0 + v99 + 8;
            v292 = v101;
            v110 = VIDMM_DEVICE::Resume(v36, *v101, &v323, &v289);
            if ( v322 || *((_DWORD *)this + 36) )
            {
              v321 = 1;
              v292 = v101;
            }
...
LABEL_232:
          ...
          v9 = v142;
          if ( v142 && (!v323 || *((_BYTE *)v51 + 120)) && *((_QWORD *)v51 + 9) )
          {
            v286 = 0;
LABEL_245:
            if ( v142 )
            {
              if ( *v103 == 206 )
              {
                ...
                *((_QWORD *)v51 + 19) = v144;
                ...
                {
                  v145 = v293;
                  VIDMM_COMMIT_TELEMETRY::Init(v293, *(struct VIDMM_GLOBAL **)this, v36, 0LL);
...
LABEL_263:
        if ( v36 && (Microsoft_Windows_DxgKrnlEnableBits & 0x100000) != 0 )
          McTemplateK0qqtqttp(v323, *v101, (const GUID *)v278, v110, v285, v278, v93, *v101, v323, (char)v289);
        if ( v110 >= 0 )
          goto LABEL_345;
        if ( v281 )
        {
...
LABEL_270:
          ...
          if ( g_IsInternalReleaseOrDbg )
            WdLogNewEntry5_WdTrace(v9);
          v91 = v293;
          VIDMM_COMMIT_TELEMETRY::Init(v293, *(struct VIDMM_GLOBAL **)this, v36, v289);
          if ( !v278 )
          {
          ...
          if ( v165 == -1071775484 )
          {
            ...
            v186 = v282;
            v187 = v297;
            if ( (*((_DWORD *)v282 + 13) & 7) == 0 && VIDMM_DEVICE::IsBetterYieldCandidate(v282, v297) )
            {
              v185 = v36;
              v186 = v187;
            }
          ...
          if ( *(_BYTE *)(v170 + 473) )
          {
            ...
            if ( *(_QWORD *)(v170 + 480) != v9 )
            {
              ...
              *(_QWORD *)(v174 + 24) = v170;
              ...
              v91 = v293;
              v179 = v178 - v176;
              VIDMM_COMMIT_TELEMETRY::LogFullDefragPass(v293, v179);
      ...
      if ( dword_1C004E380 )
      {
        ...
        else
        {
          ...
          for ( jj = 0; jj < *(_DWORD *)(v225 + 6992); ++jj )
          {
            ...
            if ( v308 == 1 )
            {
              ExReleasePushLockSharedEx(v307, 0LL);
            }
            else if ( v308 == 2 )
            {
              ExReleasePushLockExclusiveEx(v307, 0LL);
            }
            DXGAUTOPUSHLOCK::Release((DXGAUTOPUSHLOCK *)v319);
          }
          *(_QWORD *)(v225 + 41352) = v226;
          VIDMM_GLOBAL::SendBudgetChangeNotifications((VIDMM_GLOBAL *)v225);
          v227 = 1;
          DXGETWPROFILER_BASE::PopProfilerEntry((DXGETWPROFILER_BASE *)&v298);
          if ( (Microsoft_Windows_DxgKrnlEnableBits & 0x100000) != 0 )
            McTemplateK0q(v229, &EventVidMmProfilerExit, v230, v298);
        }
...
LABEL_489:
      ...
      v6 = v321;
      v259 = v250;
      if ( !v321 && !VIDMM_GLOBAL::UnderCleanupLimit(v250) )
      {
      ...
      if ( NextPendingTermination )
      {
        ...
        v317 = 0LL;
        v310 = 200;
        VIDMM_GLOBAL::ProcessDeferredCommand(v262, (__int64)&v310, &v290, 0, 0LL, 0LL, 0, &v309);
      }
