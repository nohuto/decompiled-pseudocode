/*
 * XREFs of ?ExpandLargePagePte@VIDMM_PAGE_DIRECTORY@@QEAAJPEAVCVirtualAddressAllocator@@PEBUVIDMM_PAGE_TABLE_LEVEL_DESC@@E_KIPEAPEAUVIDMM_ALLOC@@@Z @ 0x1C00B7D88
 * Callers:
        ...
        struct VIDMM_ALLOC **a7)
{
  ...
  else
  {
    ...
    VIDMM_PAGE_TABLE::DestroyPageTable(v24, a2, a5);
