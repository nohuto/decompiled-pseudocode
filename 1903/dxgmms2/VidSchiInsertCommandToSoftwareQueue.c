/*
 * XREFs of VidSchiInsertCommandToSoftwareQueue @ 0x1C0005BE0
 * Callers:
 ...
 *     VidSchiUpdatePriorityTables @ 0x1C0031618 (VidSchiUpdatePriorityTables.c)
 * Callees:
...
__int64 __fastcall VidSchiInsertCommandToSoftwareQueue(__int64 a1, _DWORD *a2)
{
  ...
  v6 = *(_QWORD *)(v2 + 104);
  v7 = *(_QWORD *)(v5 + 24);
  _InterlockedIncrement((volatile signed __int32 *)(v7 + 708));
  _InterlockedIncrement((volatile signed __int32 *)(v5 + 2852));
  _InterlockedIncrement((volatile signed __int32 *)(v6 + 1280));
  v8 = *(_DWORD *)(a1 + 48);
  if ( (unsigned int)(v8 - 4) > 1 )
  {
    _InterlockedIncrement((volatile signed __int32 *)(v6 + 1284));
    v8 = *(_DWORD *)(a1 + 48);
  }
  if ( !v8 && (*(_DWORD *)(a1 + 72) & 4) != 0 )
    _InterlockedExchangeAdd(
      (volatile signed __int32 *)(*(_QWORD *)(v7 + 8LL * *(unsigned int *)(a1 + 160) + 2576) + 2340LL),
      1u);
              ...
              if ( (result & 0x80u) == 0LL )
              {
                ...
                if ( (result & 0x100) == 0 )
                {
                  ...
                  if ( (result & 0x20) == 0 )
                  {
                    ...
                    result = VidSchiUpdateContextStatus(v2, 5LL, 14703LL);
                    *a2 = result;
                  }
                }
              }
