/*
 * XREFs of ?CopyPfnArray@VIDMM_RECYCLE_HEAP_PHYSICAL_VIEW@@QEAAXPEA_K_K1@Z @ 0x1C0064C84
 * Callers:
 ...
 *     ?GetNextRange@VIDMM_MDL_RANGE@@QEAAPEAV1@XZ @ 0x1C0064DAC (-GetNextRange@VIDMM_MDL_RANGE@@QEAAPEAV1@XZ.c)
 */
