/*
 * XREFs of ?AsyncUnpinAllocation@VIDMM_GLOBAL@@QEAAJPEAVDXGALLOCATION@@@Z @ 0x1C00848BC
 * Callers:
 *     VidMmAsyncUnpinAllocation @ 0x1C0017290 (VidMmAsyncUnpinAllocation.c)
 * Callees:
 ...
 *     ?AcquireInverseSemaphore@DXGINVERSESEMAPHORE@@QEAAXXZ @ 0x1C00172A4 (-AcquireInverseSemaphore@DXGINVERSESEMAPHORE@@QEAAXXZ.c)
