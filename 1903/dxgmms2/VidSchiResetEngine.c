...
char __fastcall VidSchiResetEngine(__int64 a1, __int64 a2)
{
  ...
  *(_DWORD *)(a1 + 484) = v20;
    ...
    && (qword_1C004E060 & 0x400000000010LL) == qword_1C004E060 )
  {
    ...
    *(_DWORD *)&v57[3] = v20;
    v90 = 4LL;
    TlgWrite((TraceLoggingHProvider)&hProvider, &unk_1C0040F62, 0LL, v9, 0xBu, &pData);
  }
  ...
  *((_BYTE *)v6 + 61) = 1;
  ...
  if ( hProvider > 5u )
  {
    ...
    if ( (qword_1C004E058 & 0x400000000010LL) != 0 && (qword_1C004E060 & 0x400000000010LL) == qword_1C004E060 )
    {
      ...
      v103 = 4LL;
      v105 = 4LL;
      TlgWrite((TraceLoggingHProvider)&hProvider, &unk_1C0040EE8, 0LL, v29, 9u, &v91);
    }
  }
  v32 = v71;
  *((_QWORD *)v6 + 5) = v71;
...
LABEL_37:
  ...
  if ( v10 )
  {
      ...
      && (qword_1C004E060 & 0x400000000010LL) == qword_1C004E060 )
    {
      ...
      TlgWrite((TraceLoggingHProvider)&hProvider, &unk_1C0040E71, 0LL, v51, 9u, &v106);
    }
