/*
 * XREFs of VidSchiProcessIsrCompletedPacket @ 0x1C000B8A0
 * Callers:
 ...
 *     VidSchiUpdateContextRunningTimeAtISR @ 0x1C000BB40 (VidSchiUpdateContextRunningTimeAtISR.c)
...
__int64 __fastcall VidSchiProcessIsrCompletedPacket(__int64 a1, __int64 a2, __int64 a3, _DWORD *a4)
{
  ...
  while ( 1 )
  {
    ...
    *(_DWORD *)(v10 + 16) = 1;
    ...
    if ( v16 && v16 != v21 )
      *(_QWORD *)(v16 + 456) = *(_QWORD *)(v21 + 456);
    if ( (*(_DWORD *)(v10 + 92) & 0x200) != 0 )
    {
      VidSchiUpdateCurrentIsrFrameTime(
        v4,
        *(_QWORD *)(v4 + 8LL * *(unsigned int *)(*(_QWORD *)(v10 + 56) + 160LL) + 2576),
        0LL);
    ...
    ExpInterlockedPushEntrySList((PSLIST_HEADER)(v4 + 1696), (PSLIST_ENTRY)(v10 + 32));
  ...
  if ( !*(_BYTE *)(v4 + 53) )
  {
    v18 = (_QWORD *)WdLogNewEntry5_WdCriticalError(v9, a2);
    v18[3] = 281LL;
    v18[4] = 1LL;
    v18[5] = v6;
