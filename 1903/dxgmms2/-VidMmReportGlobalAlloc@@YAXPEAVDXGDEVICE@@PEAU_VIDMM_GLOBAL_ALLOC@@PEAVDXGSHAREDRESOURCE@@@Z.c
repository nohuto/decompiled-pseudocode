/*
 * XREFs of ?VidMmReportGlobalAlloc@@YAXPEAVDXGDEVICE@@PEAU_VIDMM_GLOBAL_ALLOC@@PEAVDXGSHAREDRESOURCE@@@Z @ 0x1C00B71A4
 * Callers:
 *     VidMmReportContextAllocList @ 0x1C00B76D0 (VidMmReportContextAllocList.c)
 *     VidMmReportMultiGlobalAlloc @ 0x1C00B7900 (VidMmReportMultiGlobalAlloc.c)
 * Callees:
