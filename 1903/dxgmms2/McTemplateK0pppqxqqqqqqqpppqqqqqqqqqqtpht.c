/*
 * XREFs of McTemplateK0pppqxqqqqqqqpppqqqqqqqqqqtpht @ 0x1C001812C
 * Callers:
...
ULONG __fastcall McTemplateK0pppqxqqqqqqqpppqqqqqqqqqqtpht(
        __int64 a1,
        ...
        char a32)
{
  ...
  v93 = 4LL;
  v92 = &a32;
  return McGenEventWrite((PMCGEN_TRACE_CONTEXT)&DxgkControlGuid_Context, a2, a3, 0x1Eu, &EventData);
}
