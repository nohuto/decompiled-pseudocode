/*
 * XREFs of VidSchiRestartQueuedFlip @ 0x1C0030520
 * Callers:
  ...
  if ( v6 != a5 )
  {
    ...
    if ( v10 )
    {
      v11 = *(_QWORD *)(*(_QWORD *)(*(_QWORD *)(*(_QWORD *)(a2 + 40) + 24LL)
                      ...
                      + 8 * v9
                      + 88);
      _InterlockedExchangeAdd((volatile signed __int32 *)(*(_QWORD *)(v8 + 8 * v9 + 5792) + 8LL), -v10);
      *(_DWORD *)(*(_QWORD *)(v8 + 8 * v9 + 5792) + 4LL) += v10;
