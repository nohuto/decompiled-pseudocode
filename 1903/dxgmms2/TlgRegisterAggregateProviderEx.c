/*
 * XREFs of TlgRegisterAggregateProviderEx @ 0x1C008A9FC
 * Callers:
 ...
 *     DestroyAggregateSession @ 0x1C00CE4F0 (DestroyAggregateSession.c)
 */
...
TLG_STATUS __fastcall TlgRegisterAggregateProviderEx(__int64 a1, __int64 a2)
{
  ...
  *(_DWORD *)(TlgAggregateSession + 368) = ComputeFlushPeriod(TlgAggregateSession);
  ...
  {
    ExAcquirePushLockExclusiveEx(&unk_1C004E710, 0LL);
    v5 = qword_1C004E780;
    if ( !qword_1C004E780 )
    {
