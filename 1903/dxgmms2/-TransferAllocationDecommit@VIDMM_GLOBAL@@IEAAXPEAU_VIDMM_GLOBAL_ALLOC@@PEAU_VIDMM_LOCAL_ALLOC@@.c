/*
 * XREFs of ?TransferAllocationDecommit@VIDMM_GLOBAL@@IEAAXPEAU_VIDMM_GLOBAL_ALLOC@@PEAU_VIDMM_LOCAL_ALLOC@@1@Z @ 0x1C00AFE60
 * Callers:
        ...
        struct _VIDMM_LOCAL_ALLOC *a4)
{
  if ( a3 )
    _InterlockedExchangeAdd64(
      (volatile signed __int64 *)(*(_QWORD *)(*((_QWORD *)a3 + 1) + 32LL) + 328LL),
      -*((_QWORD *)a2 + 1));
  if ( a4 )
  {
    _InterlockedExchangeAdd64(
      (volatile signed __int64 *)(*(_QWORD *)(*((_QWORD *)a4 + 1) + 32LL) + 328LL),
      *((_QWORD *)a2 + 1));
    _InterlockedIncrement64((volatile signed __int64 *)(*(_QWORD *)(*((_QWORD *)a4 + 1) + 32LL) + 320LL));
  }
}
