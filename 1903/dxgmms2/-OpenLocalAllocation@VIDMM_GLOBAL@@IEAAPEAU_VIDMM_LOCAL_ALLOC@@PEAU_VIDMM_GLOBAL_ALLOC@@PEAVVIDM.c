/*
 * XREFs of ?OpenLocalAllocation@VIDMM_GLOBAL@@IEAAPEAU_VIDMM_LOCAL_ALLOC@@PEAU_VIDMM_GLOBAL_ALLOC@@PEAVVIDMM_PROCESS@@PEAXPEAE@Z @ 0x1C00754F0
 * Callers:
...
LABEL_41:
  ...
  while ( 1 )
  {
    if ( v11 == v10 )
    {
      ...
      if ( !v12 )
      {
        _InterlockedIncrement(&dword_1C004E590);
        v29 = WdLogNewEntry5_WdLowResource(v13);
        *(_QWORD *)(v29 + 24) = 12381LL;
