/*
 * XREFs of ?LogDeviceInPenaltyBoxEvent@VIDMM_COMMIT_TELEMETRY@@QEAAXPEAVVIDMM_DEVICE@@_N@Z @ 0x1C00C447C
 * Callers:
        ...
        char a3)
{
    ...
    && (unsigned int)_InterlockedIncrement((volatile signed __int32 *)(*((_QWORD *)this + 1) + 260LL)) <= 6 )
  {
    ...
    *(_QWORD *)ActivityId.Data4 = 0LL;
    ...
    {
      v6 = *(unsigned __int16 **)(*(_QWORD *)(*(_QWORD *)this + 24LL) + 1408LL);
      v38 = 0;
      v36 = v40;
      v37 = 2;
      v7 = *v6;
      ...
      TlgCreateSz(&v45, v11);
      TlgWrite((TraceLoggingHProvider)&hProvider, &unk_1C004095E, &ActivityId, v13, 7u, &pData);
    }
    if ( a3 )
    {
      ...
      if ( (unsigned int)hProvider > 5
        ...
        && (qword_1C004E060 & 0x10000) == qword_1C004E060 )
      {
        v14 = *(unsigned __int16 **)(*(_QWORD *)(*(_QWORD *)this + 24LL) + 1408LL);
        v28 = 0;
        v26 = v30;
        v27 = 2;
        v15 = *v14;
        ...
        v23 = v19;
        v33 = 8;
        TlgWrite((TraceLoggingHProvider)&hProvider, &unk_1C0040905, &ActivityId, v20, 6u, &v25);
      }
