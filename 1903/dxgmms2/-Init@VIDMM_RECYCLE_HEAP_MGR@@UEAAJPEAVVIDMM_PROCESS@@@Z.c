/*
 * XREFs of ?Init@VIDMM_RECYCLE_HEAP_MGR@@UEAAJPEAVVIDMM_PROCESS@@@Z @ 0x1C00652F0
 * Callers:
 *     <none>
 * Callees:
...
LABEL_22:
  ...
  else
  {
    ...
    *((_DWORD *)this + 403) = 4;
    DXGAUTOPUSHLOCKEXCLUSIVE::DXGAUTOPUSHLOCKEXCLUSIVE((DXGAUTOPUSHLOCKEXCLUSIVE *)v29, v23);
    v24 = (_QWORD *)qword_1C004E748;
    v25 = (_QWORD *)((char *)this + 1592);
    if ( *(struct _LIST_ENTRY **)qword_1C004E748 != &VIDMM_RECYCLE_HEAP_MGR::_GlobalHeapManagerListHead )
      __fastfail(3u);
    *v25 = &VIDMM_RECYCLE_HEAP_MGR::_GlobalHeapManagerListHead;
    v25[1] = v24;
    *v24 = v25;
    qword_1C004E748 = (__int64)v25;
