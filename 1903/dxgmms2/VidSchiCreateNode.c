/*
 * XREFs of VidSchiCreateNode @ 0x1C0086534
 * Callers:
...
unsigned int *__fastcall VidSchiCreateNode(__int64 a1, __int64 a2, unsigned int a3, unsigned int a4)
{
  ...
  *((_QWORD *)v14 + 216) = 0LL;
  ...
  {
    v15 = *(_DWORD *)(a1 + 68) == 1
       || *(_WORD *)(352LL * (unsigned __int16)v8 + *(_QWORD *)(*(_QWORD *)(a1 + 16) + 2440LL) + 2) == (unsigned __int16)v7;
    v16 = 352 * v8;
    v17 = v15 | v14[3] & 0xFFFFFFFE;
    v14[3] = v17;
    v18 = *(_QWORD *)(*(_QWORD *)(*(_QWORD *)(a1 + 16) + 2440LL) + 352 * v8 + 24);
    if ( v18 )
    ...
    if ( (v20 & 2) != 0 )
    {
      v31 = *(_QWORD *)(*(_QWORD *)(*(_QWORD *)(a1 + 16) + 2440LL) + v16 + 24);
      v32 = v31 ? 2 * (*(_BYTE *)(74 * v7 + v31 + 68) & 2) : 0;
      v20 = v32 | (unsigned int)v20 & 0xFFFFFFFB;
      v14[3] = v20;
      if ( (v20 & 2) != 0 )
      {
        v33 = *(_QWORD *)(*(_QWORD *)(*(_QWORD *)(a1 + 16) + 2440LL) + v16 + 24);
        if ( v33 )
