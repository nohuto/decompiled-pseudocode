/*
 * XREFs of VidSchDdiNotifyInterruptWorker @ 0x1C000B460
 * Callers:
 ...
 *     ?VidSchiVerifyDriverReportedFenceId@@YAHPEAU_VIDSCH_NODE@@KHPEAK@Z @ 0x1C000E71C (-VidSchiVerifyDriverReportedFenceId@@YAHPEAU_VIDSCH_NODE@@KHPEAK@Z.c)
