/*
 * XREFs of ?RecordVaPagingHistoryUpdateGpuVaOp@VIDMM_GLOBAL@@QEAAXPEAVVIDMM_PROCESS@@PEAU_VIDSCH_CONTEXT@@PEAUVIDMM_ALLOC@@PEAU_D3DDDI_UPDATEGPUVIRTUALADDRESS_OPERATION@@@Z @ 0x1C00B98FC
 * Callers:
  ...
  if ( *((_QWORD *)this + 5115) )
  {
    ...
    if ( v9 )
    {
      ...
      *((_QWORD *)this + 5118) = KeGetCurrentThread();
      v10 = *((_DWORD *)this + 10232);
      if ( v10 == dword_1C004E32C )
      {
        *((_DWORD *)this + 10232) = 0;
        v10 = 0;
      }
      v11 = *(void **)(*((_QWORD *)this + 5115) + 24LL * v10 + 16);
      if ( v11 )
        operator delete(v11);
      *v9 = *(_QWORD *)a2;
      v9[1] = *((_QWORD *)a2 + 4);
