/*
 * XREFs of ?InitializePageTable@VIDMM_PAGE_TABLE@@QEAAJPEAVCVirtualAddressAllocator@@IEE@Z @ 0x1C0061134
 * Callers:
        ...
        char a5)
{
  ...
  *((_QWORD *)this + 3) = v13;
  ...
  {
    _InterlockedIncrement(&dword_1C004E6BC);
    v20 = WdLogNewEntry5_WdLowResource(v14);
    *(_QWORD *)(v20 + 24) = 3967LL;
