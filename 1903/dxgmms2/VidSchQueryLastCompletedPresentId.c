/*
 * XREFs of VidSchQueryLastCompletedPresentId @ 0x1C0033160
 * Callers:
 *     <none>
 * Callees:
 *     <none>
...
__int64 __fastcall VidSchQueryLastCompletedPresentId(__int64 a1, __int64 a2, __int64 a3)
{
  ...
  if ( a1 && a3 )
  {
    ...
    {
      KeAcquireInStackQueuedSpinLock((PKSPIN_LOCK)(v5 + 1656), &LockHandle);
      *(_DWORD *)a3 = *(_DWORD *)(a1 + 4 * v6 + 508);
      v8 = *(_DWORD *)(a1 + 8 * v6 + 576);
      *(_DWORD *)(a3 + 8) = v8;
      *(_DWORD *)(a3 + 4) = v8;
    ...
    v7 = WdLogNewEntry5_WdWarning(v5, a2);
    *(_QWORD *)(v7 + 24) = v6;
