/*
 * XREFs of McTemplateK0pqxqqipqx @ 0x1C002D448
 * Callers:
...
ULONG McTemplateK0pqxqqipqx(__int64 a1, __int64 a2, const GUID *a3, ...)
{
  ...
  v20 = 4LL;
  v22 = 8LL;
  return McGenEventWrite((PMCGEN_TRACE_CONTEXT)&DxgkControlGuid_Context, &EventVSyncDPC, a3, 0xAu, &EventData);
}
