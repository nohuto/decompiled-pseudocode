/*
 * XREFs of VidSchQueryDmaData @ 0x1C00CDFA8
 * Callers:
...
__int64 __fastcall VidSchQueryDmaData(__int64 a1, unsigned int a2, __int64 a3, __int64 a4)
{
  ...
  if ( !v9 )
    return 3221225485LL;
  for ( i = v8 + 11324; *(_DWORD *)(i - 20) == 3 || *(_QWORD *)(i - 4) != __PAIR64__(v18, v6); i += 224LL )
  {
    if ( ++v10 >= v9 )
      return 3221225485LL;
  }
  v13 = 224LL * v10;
  result = 0LL;
  v14 = *(_OWORD *)(v13 + v8 + 11344);
  *(_OWORD *)a4 = *(_OWORD *)(v13 + v8 + 11328);
  v15 = *(_OWORD *)(v13 + v8 + 11360);
  *(_OWORD *)(a4 + 16) = v14;
  v16 = *(_OWORD *)(v13 + v8 + 11376);
  *(_OWORD *)(a4 + 32) = v15;
  v17 = *(_OWORD *)(v13 + v8 + 11392);
  *(_OWORD *)(a4 + 48) = v16;
  *(_QWORD *)&v16 = *(_QWORD *)(v13 + v8 + 11408);
  *(_OWORD *)(a4 + 64) = v17;
  *(_QWORD *)(a4 + 80) = v16;
  return result;
}
