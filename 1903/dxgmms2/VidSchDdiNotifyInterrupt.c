/*
 * XREFs of VidSchDdiNotifyInterrupt @ 0x1C000B350
 * Callers:
 *     <none>
 * Callees:
...
LABEL_11:
  ...
  if ( *a2 > 0xA || (v9 = 1160, !_bittest(&v9, *a2)) || *(_QWORD *)(v6 + 2552) )
  {
    VidSchDdiNotifyInterruptWorker(*(_QWORD *)(v6 + 2560), a2, 1LL);
    goto LABEL_11;
  }
...
LABEL_17:
  if ( (Microsoft_Windows_DxgKrnlEnableBits & 0x2000) != 0 )
    return McTemplateK0q(v11, &EventProfilerExit);
  return result;
}
