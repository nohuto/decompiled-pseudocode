/*
 * XREFs of ?SetVPRPaging@VIDMM_GLOBAL@@QEAAX_N@Z @ 0x1C0029364
 * Callers:
 ...
 * Callees:
 *     ?Defragment@VIDMM_SEGMENT@@UEAAX_K0@Z @ 0x1C005C110 (-Defragment@VIDMM_SEGMENT@@UEAAX_K0@Z.c)
 */
...
void __fastcall VIDMM_GLOBAL::SetVPRPaging(VIDMM_GLOBAL *this, unsigned __int64 a2, unsigned __int64 a3)
{
  ...
  *((_BYTE *)this + 40873) = (8 * v3) | *((_BYTE *)this + 40873) & 0xF7;
}
