/*
 * XREFs of VidSchiProcessCrossAdapterSignaledSyncObjects @ 0x1C002EBA0
 * Callers:
...
_QWORD *__fastcall VidSchiProcessCrossAdapterSignaledSyncObjects(struct HwQueueStagingList *a1, unsigned __int64 a2)
{
  __int64 **v4; // rcx
  __int64 *v5; // rax
  __int64 *v6; // rdx
