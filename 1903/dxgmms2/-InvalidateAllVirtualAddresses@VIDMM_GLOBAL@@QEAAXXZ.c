/*
 * XREFs of ?InvalidateAllVirtualAddresses@VIDMM_GLOBAL@@QEAAXXZ @ 0x1C00ACD78
 * Callers:
 *     VidMmInvalidateAllVirtualAddresses @ 0x1C0024A20 (VidMmInvalidateAllVirtualAddresses.c)
 * Callees:
