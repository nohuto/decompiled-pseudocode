/*
 * XREFs of ?VidMmReserveGpuVirtualAddressRangeCb@VIDMM_GLOBAL@@QEAAJPEAU_DXGKARGCB_RESERVEGPUVIRTUALADDRESSRANGE@@@Z @ 0x1C005EFD8
 * Callers:
 *     VidMmReserveGpuVirtualAddressRangeCb @ 0x1C00015D0 (VidMmReserveGpuVirtualAddressRangeCb.c)
 * Callees:
