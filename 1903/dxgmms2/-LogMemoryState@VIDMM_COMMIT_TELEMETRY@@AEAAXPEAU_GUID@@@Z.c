/*
 * XREFs of ?LogMemoryState@VIDMM_COMMIT_TELEMETRY@@AEAAXPEAU_GUID@@@Z @ 0x1C00C4B04
 * Callers:
...
void __fastcall VIDMM_COMMIT_TELEMETRY::LogMemoryState(VIDMM_COMMIT_TELEMETRY *this, struct _GUID *a2)
{
  ...
  if ( *((_BYTE *)this + 24) )
  {
      ...
      && (qword_1C004E060 & 0x10000) == qword_1C004E060 )
    {
      ...
      TlgWrite((TraceLoggingHProvider)&hProvider, &unk_1C0040B8A, v8, v7, 5u, &pData);
    }
    ...
    if ( *(_DWORD *)(*(_QWORD *)this + 6992LL) )
    {
      ...
      do
      {
        ...
        if ( (unsigned int)hProvider <= 5 )
          goto LABEL_22;
        if ( (qword_1C004E058 & 0x10000) == 0 || (v22 = 1, (v13 & 0x10000) != v13) )
          v22 = 0;
        if ( v22 )
        {
          v23 = *(unsigned __int16 **)(*(_QWORD *)(v11 + 24) + 1408LL);
          v38 = &v41;
          v39 = 2LL;
          v24 = *v23;
          v40 = *((_QWORD *)v23 + 1);
          ...
          *(_QWORD *)&pDesc.Size = 6LL;
          ...
          v49 = 8LL;
          v25 = a2;
          TlgWrite((TraceLoggingHProvider)&hProvider, &unk_1C0040B0B, a2, (LPCGUID)v18, 8u, &pData);
          v18 = v35;
          v11 = *(_QWORD *)this;
          v13 = qword_1C004E060;
        }
...
LABEL_22:
        ...
        if ( (*(_BYTE *)(1560LL * v12 + *(_QWORD *)(v11 + 40184) + 536) & 2) != 0 )
        {
          ...
          if ( (unsigned int)hProvider > 5 )
          {
            if ( (qword_1C004E058 & 0x10000) == 0 || (v28 = 1, (v13 & 0x10000) != v13) )
              v28 = 0;
            if ( v28 )
            {
              v29 = *(unsigned __int16 **)(*(_QWORD *)(v11 + 24) + 1408LL);
              v38 = &v41;
              v39 = 2LL;
              v30 = *v29;
              v40 = *((_QWORD *)v29 + 1);
              ...
              *(_QWORD *)&pDesc.Size = 9LL;
              ...
              v36 = v27;
              v49 = 8LL;
              TlgWrite((TraceLoggingHProvider)&hProvider, &unk_1C0040B0B, v25, (LPCGUID)v18, 8u, &pData);
              v11 = *(_QWORD *)this;
              v13 = qword_1C004E060;
            }
          }
