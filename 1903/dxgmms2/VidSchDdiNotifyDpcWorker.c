/*
 * XREFs of VidSchDdiNotifyDpcWorker @ 0x1C002DCC0
 * Callers:
...
void __fastcall VidSchDdiNotifyDpcWorker(__int64 a1, int a2)
{
  ...
  v2 = *(union _SLIST_HEADER **)(a1 + 528);
  v5 = ExpInterlockedFlushSList(v2 + 106);
  v6 = 0LL;
  if ( v5 )
  {
    do
    ...
    do
    {
      ...
      if ( ((LODWORD(v8->Next) - 1) & 0xFFFFFFF6) != 0 || Next == 10 )
      {
        switch ( Next )
        {
          ...
          case 0xFu:
            v11 = v8[2].Next;
            ExpInterlockedPushEntrySList((PSLIST_HEADER)&v11[373], v8);
            if ( bTracingEnabled )
          ...
          default:
            if ( Next <= 0xA && (v12 = 1160, _bittest(&v12, Next)) )
            {
              ...
              ExpInterlockedPushEntrySList(
                (PSLIST_HEADER)(*(&v2[161].Alignment + *((unsigned int *)&v8[4].Next + 2)) + 33648),
                v8);
            }
            else if ( Next == 14 )
            {
      ...
      else
      {
        if ( a2 )
        {
          ...
          {
            LOBYTE(v10) = 1;
            VIDMM_GLOBAL::ApertureCorruptionCheck(*(VIDMM_GLOBAL **)(a1 + 552), v10);
          }
        }
