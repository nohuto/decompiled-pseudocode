/*
 * XREFs of ?SuspendResume@VIDMM_DEVICE@@QEAAX_N0@Z @ 0x1C008134C
 * Callers:
 *     ?VidMmSuspendResumeDevice@@YAXPEAVVIDMM_DEVICE@@_N1@Z @ 0x1C0014C70 (-VidMmSuspendResumeDevice@@YAXPEAVVIDMM_DEVICE@@_N1@Z.c)
 * Callees:
