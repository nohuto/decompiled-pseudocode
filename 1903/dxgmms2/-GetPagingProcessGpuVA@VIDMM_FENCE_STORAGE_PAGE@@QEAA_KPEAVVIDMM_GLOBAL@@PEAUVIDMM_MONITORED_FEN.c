/*
 * XREFs of ?GetPagingProcessGpuVA@VIDMM_FENCE_STORAGE_PAGE@@QEAA_KPEAVVIDMM_GLOBAL@@PEAUVIDMM_MONITORED_FENCE_STORAGE@@I@Z @ 0x1C00B6E14
 * Callers:
...
LABEL_7:
  ...
  while ( *((_QWORD *)a2 + 5040) != *(v12 - 1) || *((_DWORD *)v12 + 5) != 1 << a4 )
  {
    v12 = (__int64 *)*v12;
    if ( v12 == (__int64 *)(i + 4) )
      goto LABEL_7;
