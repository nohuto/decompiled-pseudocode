/*
 * XREFs of VidSchSetAbsolutePriorityHwContext @ 0x1C00CD0B0
 * Callers:
 *     <none>
 * Callees:
 *     VidSchiUpdateDdiHwContextPriority @ 0x1C00CD7A0 (VidSchiUpdateDdiHwContextPriority.c)
 */

__int64 __fastcall VidSchSetAbsolutePriorityHwContext(__int64 a1, __int64 a2, char a3)
{
  __int64 v3; // rsi
  __int64 v6; // rax
  __int64 v8; // rax
    ...
    if ( *(_BYTE *)(v9 + 204) || _InterlockedCompareExchange((volatile signed __int32 *)(v9 + 200), 0, 0) )
    {
      ...
      *(_QWORD *)(v10 + 32) = -1071775232LL;
      ...
      return 3223192064LL;
           ...
           || a3
           || *(_BYTE *)(*(_QWORD *)(*(_QWORD *)(v9 + 40) + 8LL) + 297LL)
