/*
 * XREFs of ?TransferMemory@VIDMM_MEMORY_SEGMENT@@QEAAJPEAU_VIDMM_GLOBAL_ALLOC@@W4_DXGK_MEMORY_TRANSFER_DIRECTION@@PEAVVIDMM_SEGMENT@@T_LARGE_INTEGER@@PEA_N4@Z @ 0x1C0081C34
 * Callers:
        ...
        bool *a7)
{
  ...
  if ( *((_DWORD *)a2 + 16) )
  {
    ...
    if ( TemporaryResourcesForAllocation < 0 )
    {
      v14 = this[1];
      v15 = *((_QWORD *)v14 + 5023);
      if ( (*(_BYTE *)(1560LL * *((unsigned int *)this + 95) + v15 + 436) & 4) != 0 )
      {
