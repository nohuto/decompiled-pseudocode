/*
 * XREFs of McTemplateK0pqXR1qqqXR5 @ 0x1C002C714
 * Callers:
...
ULONG McTemplateK0pqXR1qqqXR5(__int64 a1, const EVENT_DESCRIPTOR *a2, __int64 a3, ...)
{
  ...
  v17 = 4LL;
  v20 = 0;
  return McGenEventWrite((PMCGEN_TRACE_CONTEXT)&DxgkControlGuid_Context, a2, 0LL, 8u, &EventData);
}
