/*
 * XREFs of McTemplateK0ppqq @ 0x1C0025E28
 * Callers:
...
ULONG McTemplateK0ppqq(__int64 a1, __int64 a2, const GUID *a3, ...)
{
  ...
  v12 = 4LL;
  va_copy(v11, va3);
  return McGenEventWrite((PMCGEN_TRACE_CONTEXT)&DxgkControlGuid_Context, &EventLock, a3, 5u, &EventData);
}
