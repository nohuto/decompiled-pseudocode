/*
 * XREFs of ?RemoveDmaBufferFromPool@VIDMM_DMA_POOL@@IEAAXPEAU_VIDMM_DMA_BUFFER@@@Z @ 0x1C00830A8
 * Callers:
  ...
  *((_DWORD *)this + 34) += -24 * *((_DWORD *)a2 + 13);
  if ( v6 )
  {
    v7 = *(_QWORD *)(*(_QWORD *)(*((_QWORD *)v6 + 1) + 16LL)
                   + 8LL * *(unsigned int *)(*(_QWORD *)(*(_QWORD *)v6 + 24LL) + 208LL));
    KeEnterCriticalRegion();
    ExAcquirePushLockExclusiveEx(v7 + 432, 0LL);
    *(_QWORD *)(v7 + 448) -= *((_QWORD *)a2 + 5);
    --*(_DWORD *)(v7 + 440);
    *(_DWORD *)(v7 + 456) += -24 * *((_DWORD *)a2 + 12);
    *(_DWORD *)(v7 + 460) += -24 * *((_DWORD *)a2 + 13);
    ExReleasePushLockExclusiveEx(v7 + 432, 0LL);
