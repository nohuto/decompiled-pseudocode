/*
 * XREFs of McTemplateK0ppqxqpq @ 0x1C002C514
 * Callers:
...
ULONG McTemplateK0ppqxqpq(__int64 a1, __int64 a2, const GUID *a3, ...)
{
  ...
  v16 = 8LL;
  v18 = 4LL;
  return McGenEventWrite((PMCGEN_TRACE_CONTEXT)&DxgkControlGuid_Context, &EventDmaSubmit, a3, 8u, &EventData);
}
