/*
 * XREFs of McTemplateK0qqqxxp @ 0x1C0029204
 * Callers:
...
ULONG __fastcall McTemplateK0qqqxxp(
        __int64 a1,
        __int64 a2,
        const GUID *a3,
        int a4,
        ...
        char a9)
{
  ...
  v20 = 8LL;
  v22 = 8LL;
  return McGenEventWrite((PMCGEN_TRACE_CONTEXT)&DxgkControlGuid_Context, &EventUpdateVPR, a3, 7u, &EventData);
}
