/*
 * XREFs of McTemplateK0pppxqpq @ 0x1C0027620
 * Callers:
...
ULONG McTemplateK0pppxqpq(__int64 a1, __int64 a2, const GUID *a3, ...)
{
  ...
  v16 = 8LL;
  v18 = 4LL;
  return McGenEventWrite((PMCGEN_TRACE_CONTEXT)&DxgkControlGuid_Context, &EventPagingQueueSubmit, a3, 8u, &EventData);
}
