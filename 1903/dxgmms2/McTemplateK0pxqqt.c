/*
 * XREFs of McTemplateK0pxqqt @ 0x1C0028D24
 * Callers:
 ...
 *     ?ReportBlockStates@VIDMM_RECYCLE_HEAP@@QEAAXXZ @ 0x1C00BB708 (-ReportBlockStates@VIDMM_RECYCLE_HEAP@@QEAAXXZ.c)
...
ULONG McTemplateK0pxqqt(__int64 a1, const EVENT_DESCRIPTOR *a2, const GUID *a3, ...)
{
