/*
 * XREFs of ?InitDmaPools@VIDMM_GLOBAL@@QEAAJXZ @ 0x1C0090538
 * Callers:
 ...
 *     ??0VIDMM_DMA_POOL@@QEAA@PEAVVIDMM_GLOBAL@@KPEAVVIDMM_DEVICE@@PEAVDXGCONTEXT@@KKKKKH@Z @ 0x1C00854C0 (--0VIDMM_DMA_POOL@@QEAA@PEAVVIDMM_GLOBAL@@KPEAVVIDMM_DEVICE@@PEAVDXGCONTEXT@@KKKKKH@Z.c)
 */
  ...
  if ( *((_DWORD *)this + 1748) )
  {
    while ( 1 )
    {
      ...
      *((_QWORD *)this + v2 + 79) = v6;
      ...
      if ( v8 < 0 )
      {
        _InterlockedAdd(&dword_1C004E624, 1u);
    ...
    _InterlockedAdd(&dword_1C004E620, 1u);
    v14 = WdLogNewEntry5_WdLowResource(v7);
    *(_QWORD *)(v14 + 24) = 1861LL;
