/*
 * XREFs of ?UnpinOneAllocation@VIDMM_GLOBAL@@QEAA_NPEAUVIDMM_ALLOC@@W4VIDMM_UNPIN_ACTION@@_N@Z @ 0x1C0084468
 * Callers:
 ...
 *     ?UnpinAllocation@VIDMM_GLOBAL@@QEAAXPEAU_VIDMM_MULTI_ALLOC@@@Z @ 0x1C00B03B0 (-UnpinAllocation@VIDMM_GLOBAL@@QEAAXPEAU_VIDMM_MULTI_ALLOC@@@Z.c)
...
bool __fastcall VIDMM_GLOBAL::UnpinOneAllocation(struct VIDMM_ALLOC **a1, __int64 a2, const GUID *a3, char a4)
{
  __int64 v5; // rbp
  bool v8; // di
  __int64 v9; // rax
