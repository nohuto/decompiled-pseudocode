 ...
 *     VidMmReportContextAllocList @ 0x1C00B76D0 (VidMmReportContextAllocList.c)
 *     VidMmReportMultiAlloc @ 0x1C00B77E0 (VidMmReportMultiAlloc.c)
 *     ?ReportState@VIDMM_PAGE_TABLE_BASE@@QEAAXPEAVCVirtualAddressAllocator@@@Z @ 0x1C00BA178 (-ReportState@VIDMM_PAGE_TABLE_BASE@@QEAAXPEAVCVirtualAddressAllocator@@@Z.c)
 * Callees:
