/*
 * XREFs of ?NotifyAllocationReclaimed@VIDMM_GLOBAL@@QEAAXPEAU_VIDMM_GLOBAL_ALLOC@@H@Z @ 0x1C00AE038
 * Callers:
 ...
 *     ?NotifyAllocationReclaimed@@YAXPEAX@Z @ 0x1C00AE010 (-NotifyAllocationReclaimed@@YAXPEAX@Z.c)
