/*
 * XREFs of ?EvictOneAllocation@VIDMM_GLOBAL@@QEAAXPEAUVIDMM_ALLOC@@_N@Z @ 0x1C00605E4
 * Callers:
 ...
 *     ?EvictPageTable@VIDMM_PAGE_TABLE@@QEAAXPEAVCVirtualAddressAllocator@@_KE@Z @ 0x1C006050C (-EvictPageTable@VIDMM_PAGE_TABLE@@QEAAXPEAVCVirtualAddressAllocator@@_KE@Z.c)
...
void __fastcall VIDMM_GLOBAL::EvictOneAllocation(struct VIDMM_ALLOC **this, struct VIDMM_ALLOC *a2, const GUID *a3)
{
  bool v3; // si
  VIDMM_GLOBAL *v5; // rbp
  __int64 v6; // rdi
  ...
  if ( !v3 || (this = *(struct VIDMM_ALLOC ***)(*((_QWORD *)a2 + 1) + 8LL), ((_DWORD)this[13] & 2) != 0) )
  {
    if ( *(_DWORD *)(v6 + 128) == 1 )
    {
      LOBYTE(a3) = 1;
      LOBYTE(v10) = 0;
      (*(void (__fastcall **)(_QWORD, __int64, const GUID *, _QWORD, int, _QWORD))(**(_QWORD **)(v6 + 136) + 48LL))(
        *(_QWORD *)(v6 + 136),
        v6,
        a3,
        0LL,
  ...
  if ( bTracingEnabled )
  {
    if ( (Microsoft_Windows_DxgKrnlEnableBits & 0x40) != 0 )
      McTemplateK0p((__int64)this, &EventEvictAllocation, a3, v6);
  }
}
