/*
 * XREFs of McTemplateK0pdd @ 0x1C002C114
 * Callers:
 *     VidSchiSetInProcessPriorityContext @ 0x1C0014E30 (VidSchiSetInProcessPriorityContext.c)
 * Callees:
 *     __security_check_cookie @ 0x1C0018060 (__security_check_cookie.c)
 *     McGenEventWrite @ 0x1C0025A44 (McGenEventWrite.c)
 */

ULONG McTemplateK0pdd(__int64 a1, __int64 a2, const GUID *a3, ...)
{
