/*
 * XREFs of ?BeginCPUAccess@VIDMM_GLOBAL@@QEAAJPEAU_VIDMM_MULTI_ALLOC@@KKIPEAU_VIDMM_REGION@@PEAPEAX@Z @ 0x1C0061464
 * Callers:
 *     VidMmBeginCPUAccess @ 0x1C0001780 (VidMmBeginCPUAccess.c)
 * Callees:
 *     ?IsCurrentProcess@VIDMM_PROCESS@@QEAAEXZ @ 0x1C00017A4 (-IsCurrentProcess@VIDMM_PROCESS@@QEAAEXZ.c)
 ...
 *     ?WaitOnAllocForceSync@VIDMM_GLOBAL@@QEAAXPEAUVIDMM_ALLOC@@@Z @ 0x1C007B7B0 (-WaitOnAllocForceSync@VIDMM_GLOBAL@@QEAAXPEAUVIDMM_ALLOC@@@Z.c)
...
LABEL_45:
  ...
  *a7 = 0LL;
  ...
  if ( (v15 & 0x82) != 0 )
  {
    ...
    {
      v30 = WdLogNewEntry5_WdAssertion(v16, v19);
      *(_QWORD *)(v30 + 24) = 7791LL;
      goto LABEL_43;
    }
    if ( !BYTE1(this[442].Data1) && (v19 & 4) != 0 )
    {
      v30 = WdLogNewEntry5_WdAssertion(v16, v19);
      *(_QWORD *)(v30 + 24) = 7802LL;
      goto LABEL_43;
    }
  }
  if ( (v15 & 0x81) != 0 )
