/*
 * XREFs of ?Init@VIDMM_DMA_POOL@@QEAAJXZ @ 0x1C0085354
 * Callers:
 *     VidMmInitDmaPool @ 0x1C00178B0 (VidMmInitDmaPool.c)
 ...
 *     ?UpdateFairResourceUsage@VIDMM_DMA_POOL@@IEAAXXZ @ 0x1C0085448 (-UpdateFairResourceUsage@VIDMM_DMA_POOL@@IEAAXXZ.c)
 */
  ...
  if ( VIDMM_GLOBAL::VerifySegmentSet(*(VIDMM_GLOBAL **)this, *((_DWORD *)this + 2), *((_DWORD *)this + 9), 1, &v12) )
  {
    ...
    while ( 1 )
    {
      ...
      if ( (unsigned int)++v4 >= 2 )
      {
        ...
        v6 = (VIDMM_DMA_POOL **)qword_1C004E760;
        v7 = (VIDMM_DMA_POOL *)((char *)this + 112);
        if ( *(struct _LIST_ENTRY **)qword_1C004E760 != &VIDMM_DMA_POOL::_DmaPoolsListHead )
          __fastfail(3u);
        *(_QWORD *)v7 = &VIDMM_DMA_POOL::_DmaPoolsListHead;
        *((_QWORD *)this + 15) = v6;
        *v6 = v7;
        qword_1C004E760 = (__int64)this + 112;
