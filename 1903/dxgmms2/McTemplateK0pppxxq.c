/*
 * XREFs of McTemplateK0pppxxq @ 0x1C0025C30
 * Callers:
...
ULONG McTemplateK0pppxxq(__int64 a1, __int64 a2, const GUID *a3, ...)
{
  ...
  v14 = 8LL;
  v16 = 4LL;
  return McGenEventWrite((PMCGEN_TRACE_CONTEXT)&DxgkControlGuid_Context, &EventMemoryTransfer, a3, 7u, &EventData);
}
