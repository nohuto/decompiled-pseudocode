/*
 * XREFs of CreateMergeLink @ 0x140007120
 * Callers:
 *     CreateRegistryLinksForMachine @ 0x140007080 (CreateRegistryLinksForMachine.c)
 * Callees:
 *     CreateKeyRecursively @ 0x1400072A0 (CreateKeyRecursively.c)
