/*
 * XREFs of SmpSbCreateSession @ 0x140002BE0
 * Callers:
...
NTSTATUS __fastcall SmpSbCreateSession(__int64 a1, void *a2, __int128 *a3, __int64 a4, _OWORD *a5)
{
  int v5; // eax
  __int64 v8; // rax
  __int64 v9; // rbx
  ...
  v21 = 0LL;
  v22 = v5;
  v8 = SmpSearchKnownSubSysDatabase(a1, &v20);
  v9 = v8;
  if ( v8 )
  {
    v10 = SmpWaitForSingleSubSys(v8);
    if ( v10 < 0 )
      goto LABEL_11;
    v11 = *a3;
    v34 = 0;
    ...
    if ( v10 >= 0 )
    {
      ...
      *(_QWORD *)&LpcReply.u1.s1.DataLength = 18874520LL;
      ...
      if ( v10 >= 0 )
      {
        v10 = v25;
LABEL_11:
        SmpDereferenceKnownSubSys((PVOID)v9);
        return v10;
      }
