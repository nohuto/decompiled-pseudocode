/*
 * XREFs of SmpPagefileInitialize @ 0x14000B8B8
 * Callers:
 *     SmpAsyncMemoryConfiguration @ 0x14000B740 (SmpAsyncMemoryConfiguration.c)
 * Callees:
 *     SmpQueryFilterPagesDumpSetting @ 0x14000BA8C (SmpQueryFilterPagesDumpSetting.c)
 *     SmpQueryCrashDumpType @ 0x14000BADC (SmpQueryCrashDumpType.c)
 ...
 *     SmpQueryCopyDumpSetting @ 0x14000D204 (SmpQueryCopyDumpSetting.c)
...
NTSTATUS SmpPagefileInitialize()
{
  ...
  qword_140022598 = (__int64)&SmpPagingFileDescriptorList;
  SmpPagingFileDescriptorList = &SmpPagingFileDescriptorList;
  qword_140022578 = (__int64)&SmpVolumeDescriptorList;
