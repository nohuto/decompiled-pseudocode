/*
 * XREFs of SmpBuildSubSystemLists @ 0x140009680
 * Callers:
 *     <none>
 * Callees:
 *     SmpFindRegistryValueEx @ 0x140009FB4 (SmpFindRegistryValueEx.c)
...
LABEL_18:
        ...
        *(_QWORD *)(v10 + 8) = Buffer;
        ...
        {
          v13 = (UNICODE_STRING **)qword_140022268;
          if ( *(__int64 **)qword_140022268 != &SmpSubSystemsRequired )
            goto LABEL_18;
          *(_QWORD *)&v9->Length = &SmpSubSystemsRequired;
          v9->Buffer = (PWSTR)v13;
          *v13 = v9;
          qword_140022268 = (__int64)v9;
          *a6 += 2;
          a6[1] += v9[2].Length + v9[1].Length + 4;
        }
        else
        {
          v16 = (UNICODE_STRING **)qword_140022278;
          if ( *(__int64 **)qword_140022278 != &SmpSubSystemsToDefer )
            goto LABEL_18;
          *(_QWORD *)&v9->Length = &SmpSubSystemsToDefer;
          v9->Buffer = (PWSTR)v16;
          *v16 = v9;
          qword_140022278 = (__int64)v9;
        }
