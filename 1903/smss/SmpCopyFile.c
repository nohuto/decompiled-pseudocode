/*
 * XREFs of SmpCopyFile @ 0x140010D1C
 * Callers:
 ...
 *     _TlgKeywordOn @ 0x140011F60 (_TlgKeywordOn.c)
...
__int64 __fastcall SmpCopyFile(HANDLE FileHandle, struct _UNICODE_STRING *a2, union _LARGE_INTEGER a3)
{
  ...
  if ( v9 >= 0 )
  {
    ...
    if ( v3.QuadPart )
    {
      ...
      if ( v3.QuadPart % (unsigned __int64)(unsigned int)dword_1400222C8 )
        v8 = dword_1400222C8;
...
LABEL_13:
      ...
      if ( (unsigned int)dword_140021018 > 5 && TlgKeywordOn(v14, v13) )
      {
        ...
        v30 = 4LL;
        v32 = 8LL;
        TlgWrite((TraceLoggingHProvider)4, &unk_14001D2C9, v15, v16, 4u, &pData);
      }
      v11 = FileHandlea;
    }
    NtClose(v11);
