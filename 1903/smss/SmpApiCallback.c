/*
 * XREFs of SmpApiCallback @ 0x140003880
 * Callers:
 *     <none>
 * Callees:
 *     SmpSessionComplete @ 0x140001010 (SmpSessionComplete.c)
 ...
 *     SmpMarkThreadFree @ 0x140004420 (SmpMarkThreadFree.c)
 *     SmpMarkThreadBusy @ 0x14000447C (SmpMarkThreadBusy.c)
 ...
 *     _guard_dispatch_icall_nop @ 0x14000D660 (_guard_dispatch_icall_nop.c)
...
NTSTATUS __fastcall SmpApiCallback(__int64 a1, __int64 a2)
{
  ...
  if ( v7 != 5 )
  {
    if ( (unsigned int)v7 <= 2 )
    {
      ...
      v11 = v3;
      v12 = v6;
      if ( v10 == SmpSessionComplete )
      {
        v13 = SmpSessionComplete();
        goto LABEL_30;
      }
      goto LABEL_52;
    }
...
LABEL_28:
    ...
    {
      v13 = SmpExecPgm((__int64)v21, (__int64)v6);
LABEL_30:
      v5 = v13;
      goto LABEL_31;
    }
LABEL_52:
    v13 = ((__int64 (__fastcall *)(_BYTE *, _BYTE *, __int64))v10)(v21, v12, v11);
    goto LABEL_30;
  }
LABEL_17:
  if ( (*v6 & 6) == 0 )
