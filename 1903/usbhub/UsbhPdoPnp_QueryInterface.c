/*
 * XREFs of UsbhPdoPnp_QueryInterface @ 0x1C0027180
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall UsbhPdoPnp_QueryInterface(__int64 a1, IRP *a2)
{
  ...
  int v126; // r10d
  int v127; // eax
  int v128; // [rsp+48h] [rbp-50h]
  struct _DEVICE_OBJECT *DeviceObject; // [rsp+50h] [rbp-48h]
  KIRQL v130; // [rsp+A0h] [rbp+8h]
  unsigned int v131; // [rsp+B8h] [rbp+20h]
        ...
        if ( v19 )
        {
          ...
          if ( v10 )
          {
            ...
            if ( PoolWithTag )
            {
              ...
              *((_QWORD *)PoolWithTag + 3) = 1364543814LL;
...
LABEL_223:
         ...
         0x10uLL) == 16 )
  {
    ...
    SSHub = UsbhBusifGetSSHub(*(_QWORD *)(v4 + 1184), v118, a2);
    UsbhUnlatchPdo(*(_QWORD *)(v4 + 1184), v10, (__int64)a2, 0x51554946u);
LABEL_70:
  ...
  if ( RtlCompareMemory(CurrentStackLocation->Parameters.Create.SecurityContext, &GUID_PNP_LOCATION_INTERFACE, 0x10uLL) == 16 )
  {
    ...
    if ( v50 )
    {
      ...
      if ( v59 )
      {
        ...
        {
LABEL_185:
          v120 = *(_DWORD *)(v59 + 1288);
          if ( v120 )
            *(_DWORD *)(v59 + 1288) = v120 - 1;
        }
        else
        {
          while ( 1 )
...
LABEL_126:
            KeReleaseSpinLock(v73, v130);
            if ( !v86 )
            {
              v123 = PdoExt(a1);
              v124 = UsbhSyncResetDeviceInternal(*(PDEVICE_OBJECT *)(v4 + 1184), (__int64)(v123 + 236), a1);
              Log(*(_QWORD *)(v4 + 1184), 256, 1902732882, (__int64)a2, v124);
              if ( (v125 & 0xC0000000) == 0xC0000000 )
              {
                if ( !Usb_Disconnected(v125) )
                {
                  LOBYTE(v128) = 0;
                  UsbhException(
                    *(_QWORD *)(v4 + 1184),
...
LABEL_146:
              ...
              v106 = IofCallDriver(DeviceObject, a2);
              v107 = *(_QWORD *)(v4 + 1184);
              SSHub = v106;
              Log(v107, 256, 1968194639, v10, 1364543814LL);
              v108 = KeAcquireSpinLockRaiseToDpc((PKSPIN_LOCK)&WPP_MAIN_CB.Queue.Wcb.NumberOfChannels);
              WPP_MAIN_CB.Dpc.DeferredRoutine = (void (__fastcall *)(_KDPC *, void *, void *, void *))&WPP_MAIN_CB.Dpc.DeferredContext;
              Log(v107, 256, 1685218896, v10, 1364543814LL);
              v109 = *(_QWORD *)(v10 + 64);
              if ( v109 )
              {
                if ( *(_DWORD *)v109 != 1329877064 )
                  UsbhTrapFatal_Dbg(v10, *(_QWORD *)(v10 + 64));
                v110 = (_QWORD *)(v109 + 1272);
                v111 = *(_QWORD **)(v109 + 1272);
                if ( v111 == (_QWORD *)(v109 + 1272) )
                {
LABEL_218:
                  v127 = *(_DWORD *)(v109 + 1288);
                  if ( v127 )
                    *(_DWORD *)(v109 + 1288) = v127 - 1;
                }
                else
                {
                  while ( 1 )
                  {
                    ...
                    if ( (UsbhLogMask & 0x100) != 0 )
                    {
                      if ( v107 )
                      {
                        ...
                        if ( v113 )
                        {
                          v114 = *(_QWORD *)(v113 + 888)
                               + 32LL
                               * ((unsigned int)_InterlockedDecrement((volatile signed __int32 *)(v113 + 880)) & *(_DWORD *)(v113 + 884));
                          *(_DWORD *)v114 = 1064591724;
                          *(_QWORD *)(v114 + 8) = 0LL;
                          *(_QWORD *)(v114 + 16) = v109;
                          *(_QWORD *)(v114 + 24) = 1364543814LL;
                        }
                      }
                    }
                    if ( *((_DWORD *)v112 + 6) == 1364543814 && (IRP *)v112[5] == a2 )
                      break;
                    v111 = (_QWORD *)*v111;
                    if ( v111 == v110 )
                      goto LABEL_218;
                ...
                if ( (_QWORD *)*v110 == v110 && !*(_DWORD *)(v109 + 1288) )
                  KeSetEvent((PRKEVENT)(v109 + 1296), 0, 0);
                WPP_MAIN_CB.Dpc.DeferredRoutine = 0LL;
...
LABEL_226:
  ...
  if ( v29 != 16 )
  {
    ...
    if ( v39 )
    {
      ...
      {
LABEL_195:
        v122 = *(_DWORD *)(v39 + 1288);
        if ( v122 )
          *(_DWORD *)(v39 + 1288) = v122 - 1;
        goto LABEL_68;
      }
      while ( 1 )
      {
...
LABEL_217:
  ...
  {
    v119 = CurrentStackLocation->Parameters.Read.ByteOffset;
    if ( a2->IoStatus.Status )
    {
      *(_DWORD *)v119.QuadPart = 65608;
LABEL_172:
      *(_QWORD *)(v119.QuadPart + 8) = v4;
      *(_QWORD *)(v119.QuadPart + 32) = UsbhD3ColdSupportInterfaceSetD3ColdSupport;
      *(_QWORD *)(v119.QuadPart + 40) = UsbhD3ColdSupportInterfaceGetIdleWakeInfo;
      *(_QWORD *)(v119.QuadPart + 24) = UsbhD3ColdSupportInterfaceDereference;
      *(_QWORD *)(v119.QuadPart + 16) = UsbhD3ColdSupportInterfaceReference;
      *(_QWORD *)(v119.QuadPart + 48) = UsbhD3ColdSupportInterfaceGetD3ColdCapability;
      *(_QWORD *)(v119.QuadPart + 56) = UsbhD3ColdSupportInterfaceGetD3ColdBusDriverSupport;
      *(_QWORD *)(v119.QuadPart + 64) = UsbhD3ColdSupportInterfaceGetLastTransitionStatus;
      UsbhUnlatchPdo(*(_QWORD *)(v4 + 1184), v10, (__int64)a2, 0x51554946u);
      a2->IoStatus.Status = 0;
      IofCompleteRequest(a2, 0);
      return 0LL;
    }
    if ( *(_WORD *)v119.QuadPart == 72 && *(_WORD *)(v119.QuadPart + 2) == 1 )
    {
      *(_OWORD *)(v4 + 2976) = *(_OWORD *)v119.QuadPart;
      *(_OWORD *)(v4 + 2992) = *(_OWORD *)(v119.QuadPart + 16);
      *(_OWORD *)(v4 + 3008) = *(_OWORD *)(v119.QuadPart + 32);
      *(_OWORD *)(v4 + 3024) = *(_OWORD *)(v119.QuadPart + 48);
      *(_QWORD *)(v4 + 3040) = *(_QWORD *)(v119.QuadPart + 64);
      goto LABEL_172;
    }
    UsbhUnlatchPdo(*(_QWORD *)(v4 + 1184), v10, (__int64)a2, 0x51554946u);
