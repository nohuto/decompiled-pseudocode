/*
 * XREFs of UsbhPdoPowerWorkerInternal @ 0x1C000BF48
 * Callers:
 *     UsbhPdoPower @ 0x1C000BF10 (UsbhPdoPower.c)
 *     UsbhPdoPowerWorker @ 0x1C004C2D0 (UsbhPdoPowerWorker.c)
 * Callees:
...
LABEL_15:
  ...
  return (unsigned int)off_1C0061938[2 * v9](a1, (ULONG_PTR)a2);
}
