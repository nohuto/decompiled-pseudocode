/*
 * XREFs of RtlStringCchPrintfExW @ 0x1C00297D0
 * Callers:
 *     UsbhBusIfLocationGetLocationStrings @ 0x1C0029730 (UsbhBusIfLocationGetLocationStrings.c)
 * Callees:
...
LABEL_3:
  if ( v9 >= 0 )
  {
    ...
    if ( (dwFlags & 0x100) != 0 )
    {
      v12 = (NTSTRSAFE_PCWSTR)&unk_1C0065A68;
      if ( pszFormat )
        v12 = pszFormat;
    }
    else
