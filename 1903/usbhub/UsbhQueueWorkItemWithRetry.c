/*
 * XREFs of UsbhQueueWorkItemWithRetry @ 0x1C001BB80
 * Callers:
 ...
 *     UsbhIsrRetryTimer @ 0x1C0049750 (UsbhIsrRetryTimer.c)
 *     UsbhResetIrqPipeRetryTimer @ 0x1C0049B80 (UsbhResetIrqPipeRetryTimer.c)
 *     UsbHubhInitTimeoutTimer @ 0x1C0051020 (UsbHubhInitTimeoutTimer.c)
 *     UsbhInitRetryTimer @ 0x1C0051C40 (UsbhInitRetryTimer.c)
 *     UsbhIdleIrpRetryTimer @ 0x1C005C8C0 (UsbhIdleIrpRetryTimer.c)
 *     UsbhIdleIrp_NoIrp @ 0x1C005CDEC (UsbhIdleIrp_NoIrp.c)
 *     UsbhSS_WakeIrpRetryTimer @ 0x1C005D6E0 (UsbhSS_WakeIrpRetryTimer.c)
 * Callees:
        ...
        unsigned int a7)
{
  ...
  __int64 v27; // rcx
  __int64 v28; // rax
  void (__fastcall *v29)(__int64, __int64, void *, _QWORD, _DWORD *, int); // rax
  int v30; // ecx
...
LABEL_59:
  ...
  *((_QWORD *)v19 + 3) = a3;
  ...
  if ( *(_DWORD *)v28 != 541218120 )
    UsbhTrapFatal_Dbg(a1, *(_QWORD *)(a1 + 64));
  v29 = *(void (__fastcall **)(__int64, __int64, void *, _QWORD, _DWORD *, int))(v28 + 4784);
  if ( v29 )
  {
    LOBYTE(v32) = v33;
