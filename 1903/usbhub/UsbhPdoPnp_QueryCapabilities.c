/*
 * XREFs of UsbhPdoPnp_QueryCapabilities @ 0x1C0029A00
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall UsbhPdoPnp_QueryCapabilities(__int64 a1, IRP *a2)
{
  ...
  v11 = v3[355];
  v12 = HIDWORD(SecurityContext->SecurityQos);
  *(_SECURITY_QUALITY_OF_SERVICE **)((char *)&SecurityContext[2].SecurityQos + 4) = 0LL;
  ...
  LOBYTE(v16) = FullCreateOptions < 2;
  LODWORD(SecurityContext[1].SecurityQos) = v16 + 3;
