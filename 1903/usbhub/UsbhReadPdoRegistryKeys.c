/*
 * XREFs of UsbhReadPdoRegistryKeys @ 0x1C00224E0
 * Callers:
    ...
    while ( 1 )
    {
      ...
      if ( v24 == 1 )
      {
        for ( i = 8; ; i = v17 )
        {
          ...
          LOBYTE(v18) = *((_BYTE *)v2 + 12);
          if ( (UsbhGetPdoRegistryParameter(a2, *v2, v15, i, &v24, &v25, v18) & 0xC0000000) == 0xC0000000 )
            goto LABEL_17;
          if ( v24 != 1 )
            goto LABEL_17;
          v17 = v25;
          ...
          if ( v25 <= i )
          {
            ((void (__fastcall *)(struct _DEVICE_OBJECT *, wchar_t *, void *, _QWORD))v2[3])(a2, *v2, v15, v25);
LABEL_17:
...
LABEL_11:
      ...
      if ( v11 >= 0 && v5 == 4 && v4 == 4 && v22 )
        ((void (__fastcall *)(struct _DEVICE_OBJECT *, wchar_t *, int *, __int64))v2[3])(a2, *v2, &v22, 4LL);
      goto LABEL_12;
    }
    v16 = v9[2];
    if ( v16 > 4 )
