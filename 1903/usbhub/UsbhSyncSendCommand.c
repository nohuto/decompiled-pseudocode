/*
 * XREFs of UsbhSyncSendCommand @ 0x1C00182D0
 * Callers:
...
__int64 __fastcall UsbhSyncSendCommand(__int64 a1, __int64 a2, __int64 a3, _WORD *a4, int a5, _DWORD *a6)
{
  ...
  IRP *v36; // [rsp+88h] [rbp-49h]
  struct _IO_STATUS_BLOCK v37; // [rsp+90h] [rbp-41h] BYREF
  ...
  unsigned int v41; // [rsp+128h] [rbp+57h] BYREF
  char *v42; // [rsp+130h] [rbp+5Fh]
  _WORD *v43; // [rsp+140h] [rbp+6Fh]
  ...
  if ( v11 )
  {
    ...
    CurrentStackLocation[-1].Parameters.WMI.ProviderId = (unsigned __int64)&v41;
  ...
  else
  {
    ...
    if ( v19 )
    {
      ...
      v22 = IoBuildDeviceIoControlRequest(0x220003u, *(PDEVICE_OBJECT *)(v10 + 1208), 0LL, 0, 0LL, 0, 1u, &Object, &v37);
      v36 = v22;
      if ( (UsbhLogMask & 8) != 0 )
      {
        v23 = *(_QWORD *)(a1 + 64);
