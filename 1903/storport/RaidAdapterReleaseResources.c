/*
 * XREFs of RaidAdapterReleaseResources @ 0x1C0073254
 * Callers:
 ...
 *     RaAdapterDeregisterFromIdleDetection @ 0x1C003F184 (RaAdapterDeregisterFromIdleDetection.c)
 *     RaidFreeMappingList @ 0x1C0043134 (RaidFreeMappingList.c)
