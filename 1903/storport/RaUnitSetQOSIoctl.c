/*
 * XREFs of RaUnitSetQOSIoctl @ 0x1C0044A88
 * Callers:
 *     RaUnitDeviceControlIrp @ 0x1C0007604 (RaUnitDeviceControlIrp.c)
 * Callees:
 *     RaidCompleteRequestEx @ 0x1C000A830 (RaidCompleteRequestEx.c)
 *     RaidAdapterEnableQosWaitTimeoutCheck @ 0x1C00337E8 (RaidAdapterEnableQosWaitTimeoutCheck.c)
...
__int64 __fastcall RaUnitSetQOSIoctl(__int64 a1, IRP *a2)
{
  ...
  v5 = 0;
  if ( *(_DWORD *)(a1 + 684) || *(_DWORD *)(a1 + 692) || *(_DWORD *)(a1 + 688) || (*(_BYTE *)(a1 + 162) & 1) != 0 )
  {
  ...
  if ( v6 )
  {
    ...
    if ( v7 )
    {
      if ( v7 != 20 )
      {
        ...
        v9 = 41;
LABEL_84:
        WPP_SF_q((__int64)v8->AttachedDevice, v9, (__int64)&WPP_a32982da72aa344f3768c69018313f42_Traceguids, a1);
LABEL_85:
        v5 = -1073741637;
        goto LABEL_86;
      }
...
LABEL_33:
  ...
  if ( Flags != -1 && Flags != 500 * (Flags / 0x1F4) )
  {
    ...
    v17 = 47;
LABEL_78:
    WPP_SF_q((__int64)v16->AttachedDevice, v17, (__int64)&WPP_a32982da72aa344f3768c69018313f42_Traceguids, a1);
LABEL_79:
    v5 = -1073741811;
    goto LABEL_86;
  }
  ...
  *(_DWORD *)(a1 + 2724) = HIDWORD(MasterIrp->MdlAddress);
  *(_DWORD *)(a1 + 2736) = *(&MasterIrp->Flags + 1) / 0x3E8;
  v19 = MasterIrp->Flags;
  if ( v19 == -1 )
    v20 = -1;
  else
    v20 = v19 / 0x1F4;
  *(_DWORD *)(a1 + 2744) = v20;
  *(_DWORD *)(a1 + 2740) = MasterIrp->AssociatedIrp.IrpCount / 0x3E8u;
  *(_DWORD *)(a1 + 2732) = MasterIrp->ThreadListEntry.Flink;
  ...
  if ( v21 == -1 )
    ...
    v22 = v21 / 0x1F4;
  *(_DWORD *)(a1 + 2728) = v22;
  if ( *(_DWORD *)(a1 + 2744) == -1 && !*(_DWORD *)(a1 + 2732) && v22 == -1 )
  {
    RaidUnitDisableWaitCheckTimer(a1);
  }
  else if ( !_InterlockedCompareExchange((volatile signed __int32 *)(a1 + 2752), 1, 0) )
  {
    RaidAdapterEnableQosWaitTimeoutCheck(*(_QWORD *)(a1 + 24));
  }
  v23 = 10000000 * (*(_DWORD *)(a1 + 2736) + 1 + ((unsigned int)(*(_DWORD *)(a1 + 2728) + *(_DWORD *)(a1 + 2744)) >> 1));
