/*
 * XREFs of RaidUnitSetDevicePowerIrp @ 0x1C0010588
 * Callers:
...
__int64 __fastcall RaidUnitSetDevicePowerIrp(struct _SLIST_ENTRY *Context, _SLIST_ENTRY *Irp)
{
  ...
  if ( *((_DWORD *)&Context[12].Next + 3) == 4 && *(_DWORD *)(*((_QWORD *)&Irp[11].Next + 1) + 24LL) == 1 )
  {
    if ( (*(_BYTE *)(v2 + 109) & 4) == 0 && *(_QWORD *)(v2 + 5024) )
    {
      v7 = BYTE1(Context[10].Next);
      if ( (v7 & 8) == 0 )
      {
        BYTE1(Context[10].Next) = v7 | 8;
    ...
    if ( *(int *)(v2 + 268) > 1 )
    {
      ...
      *(_BYTE *)(*((_QWORD *)&Irp[11].Next + 1) + 3LL) |= 1u;
      ExpInterlockedPushEntrySList((PSLIST_HEADER)(v2 + 5008), Context + 105);
