/*
 * XREFs of RaUnitWaitForRemoveLock @ 0x1C0015AD4
 * Callers:
...
__int64 __fastcall RaUnitWaitForRemoveLock(__int64 a1)
{
  ...
  if ( v3 + _InterlockedExchangeAdd((volatile signed __int32 *)(a1 + 680), v3 - 0x10000000) - 0x10000000 > 0 )
  {
    v8 = KeWaitForSingleObject((PVOID)(a1 + 176), Executive, 0, 0, 0LL);
    if ( v8 == 258
  ...
  _InterlockedExchangeAdd((volatile signed __int32 *)(a1 + 680), 0x10000000u);
  if ( (_DWORD)v4 )
  {
    v9 = 0LL;
    v10 = v4;
