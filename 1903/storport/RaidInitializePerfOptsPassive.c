/*
 * XREFs of RaidInitializePerfOptsPassive @ 0x1C0019334
 * Callers:
  ...
  if ( v3 > 1 )
  {
    ...
    *(_QWORD *)(v4 + 4752) = v70;
    ...
    if ( v68 )
    {
      ...
      do
      {
        InitializeSListHead((PSLIST_HEADER)(v71 + *(_QWORD *)(v4 + 4752)));
        v71 += 64LL;
        --v69;
      }
      while ( v69 );
    ...
    do
    {
      *v73 = v72;
      ExpInterlockedPushEntrySList(
        (PSLIST_HEADER)(*(_QWORD *)(v4 + 4752) + ((unsigned __int64)(v72 % v68) << 6)),
        PoolWithTag);
      ++v72;
      v73 += 8;
      PoolWithTag += 2;
...
LABEL_91:
  ...
  if ( (v30 & 1) == 0 )
    v31 = v30;
  v98 = v31;
  v32 = (char *)ExAllocatePoolWithTag(NonPagedPoolNx, v31 * *(unsigned __int16 *)(v4 + 4742), 0x72446152u);
  P = v32;
  v33 = v32;
  if ( !v32 )
  {
  ...
  memset(v32, 0, v31 * *(unsigned __int16 *)(v4 + 4742));
  v34 = 0;
  if ( *(_WORD *)(v4 + 4742) )
  {
    v35 = v31;
...
LABEL_88:
  ...
  if ( *(_WORD *)(v4 + 4742) )
  {
        ...
        for ( j = 0; j < 0x40; ++j )
        {
          ...
          if ( *(_BYTE *)(v81 + j + v83) == 0xFF )
          {
            if ( !*((_WORD *)v80 + 1) )
            {
              ...
              do
              {
                v85 = (v84 + 1) % (unsigned int)*(unsigned __int16 *)(v4 + 4742);
            ...
            *(_BYTE *)(v81 + j + v83) = v80[v76 + 4];
            if ( v77 == v79 )
            {
              ...
              if ( v76 == *((_WORD *)v80 + 1) )
              {
                v74 = ((unsigned int)(unsigned __int16)v74 + 1) % *(unsigned __int16 *)(v4 + 4742);
                v80 = &v78[v16 * v74];
                v76 = 0;
              }
            }
    ...
    while ( v15 < *(_WORD *)(v4 + 4742) );
    v5 = v87;
  }
  ExFreePoolWithTag(v33, 0x72446152u);
  *(_WORD *)(v4 + 4740) = v97 | *(_WORD *)(v4 + 4740) & 0xFC03 | 2;
  return v5;
}
