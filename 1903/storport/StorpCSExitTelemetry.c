/*
 * XREFs of StorpCSExitTelemetry @ 0x1C004C1B8
 * Callers:
...
void __fastcall StorpCSExitTelemetry(__int64 a1)
{
  ...
  if ( a1 )
  {
    ...
    v3 = *(_QWORD *)(a1 + 5280);
    if ( v3 )
      *(_QWORD *)(a1 + 5288) += (MEMORY[0xFFFFF78000000008] - v3) / 0x2710uLL;
    if ( *(_QWORD *)(a1 + 5024) )
    {
      v4 = *(_QWORD *)(a1 + 5304);
      if ( v4 )
        *(_QWORD *)(a1 + 5312) += (v2 - v4) / 0x2710uLL;
      v5 = *(_QWORD *)(a1 + 5320);
      if ( v5 )
        *(_QWORD *)(a1 + 5328) += (v2 - v5) / 0x2710uLL;
      v6 = *(const struct _TlgProvider_t **)(a1 + 5296);
      if ( v6 )
        v6 = (const struct _TlgProvider_t *)((char *)v6 - *(_QWORD *)(a1 + 5272));
      if ( (unsigned int)dword_1C0061058 > 5 && TlgKeywordOn(v6, 0x400000000000uLL) )
      {
        ...
        v102 = 4LL;
        v26 = *(_DWORD *)(v10 + 12);
        v11 = (const struct _TlgProvider_t *)(v2 - *(_QWORD *)(a1 + 5272));
        v41 = *(_QWORD *)(a1 + 5288);
        v42 = *(_QWORD *)(a1 + 5328);
        v43 = *(_QWORD *)(a1 + 5312);
        v27 = *(_DWORD *)(a1 + 5356);
        ...
        v126 = 8LL;
        v128 = 4LL;
        TlgWrite(v11, &unk_1C0058271, v7, v8, 0x11u, &pData);
      }
    }
    ...
    for ( i = *(__int64 **)(a1 + 120); i != (__int64 *)(a1 + 120); i = (__int64 *)*i )
    {
      if ( RaidUnitCheckAndAcquirePoFx((__int64)(i - 7)) )
      {
        v13 = i[212];
        if ( v13 )
          i[213] += (v2 - v13) / 0x2710uLL;
        v14 = i[214];
        if ( v14 )
          i[215] += (v2 - v14) / 0x2710uLL;
        v15 = (const struct _TlgProvider_t *)i[211];
        if ( v15 )
          v15 = (const struct _TlgProvider_t *)((char *)v15 - *(_QWORD *)(a1 + 5272));
        if ( (unsigned int)dword_1C0061058 > 5 )
        {
          if ( TlgKeywordOn(v15, 0x400000000000uLL) )
          {
            ...
            v33 = v19;
            v24 = v18;
            v20 = (const struct _TlgProvider_t *)(v2 - *(_QWORD *)(a1 + 5272));
            v48 = *(_QWORD *)(a1 + 5288);
            v49 = i[213];
            v50 = i[215];
            v35 = *((_DWORD *)i + 437);
            ...
            v95 = 8LL;
            v97 = 4LL;
            TlgWrite(v20, &unk_1C00568E3, (LPCGUID)1, v16, 0x17u, &v55);
          }
        }
        ExReleaseRundownProtectionCacheAware((PEX_RUNDOWN_REF_CACHE_AWARE)i[178]);
      }
      *(__int64 *)((char *)i + 1748) = 0LL;
