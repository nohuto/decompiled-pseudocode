/*
 * XREFs of RaUnitStartIo @ 0x1C00035B0
 * Callers:
 *     <none>
 * Callees:
 ...
 *     RaidSrbIsPowerRequired @ 0x1C0039650 (RaidSrbIsPowerRequired.c)
...
LABEL_14:
  if ( (*(_BYTE *)(a2 + 142) & 0x20) != 0 )
  {
    ...
    if ( v47[1] != -1LL )
      v6 = KeQueryUnbiasedInterruptTime() + (unsigned int)(5000000 * *(_DWORD *)(v3 + 2744)) - v47[1];
    ExFreePoolWithTag(v47, 0x54436152u);
  }
  if ( (*(_BYTE *)(v3 + 162) & 2) != 0 && (unsigned __int8)RaidIsUnresponsiveBlockedCmd(v7) )
  {
...
LABEL_99:
    ...
    v63 = StorRemoveIoGatewayItem(*(PKSPIN_LOCK *)(v3 + 408));
    *(_QWORD *)(a2 + 56) = 0LL;
    v64 = v63;
    ...
    if ( v64 )
      ...
      v66 = (struct _KDPC *)(v3 + 952);
    LOBYTE(v32) = KeInsertQueueDpc(v66, 0LL, 0LL);
    return v32;
  }
  CurrentNodeNumber = KeGetCurrentNodeNumber();
  v19 = ExpInterlockedPopEntrySList((PSLIST_HEADER)(*(_QWORD *)(v3 + 256) + ((unsigned __int64)CurrentNodeNumber << 6)));
  if ( !v19 )
  {
    v56 = 0;
    v57 = 0;
...
LABEL_105:
    ...
    while ( 1 )
    {
      v19 = ExpInterlockedPopEntrySList((PSLIST_HEADER)(*(_QWORD *)(v3 + 256) + ((unsigned __int64)v56 << 6)));
      if ( v19 )
        break;
      if ( ++v56 >= v58 )
        goto LABEL_105;
...
LABEL_18:
  ...
  *a3 = v20;
  ...
  if ( *(char *)(v3 + 161) < 0 && *(_DWORD *)(v3 + 204) != 1 )
  {
