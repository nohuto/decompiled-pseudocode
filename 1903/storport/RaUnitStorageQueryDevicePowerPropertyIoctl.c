/*
 * XREFs of RaUnitStorageQueryDevicePowerPropertyIoctl @ 0x1C006F178
 * Callers:
  ...
  else
  {
    ...
    if ( Length >= 0x14 )
    {
      ...
      *(_DWORD *)(&MasterIrp->Size + 1) = 20;
      LOBYTE(MasterIrp->MdlAddress) = (*(_DWORD *)(a1 + 1568) & 2) != 0;
      BYTE1(MasterIrp->MdlAddress) = (*(_DWORD *)(a1 + 1568) & 4) != 0;
      if ( RaidUnitCheckAndAcquirePoFx(a1) )
      {
        BYTE2(MasterIrp->MdlAddress) = 1;
        BYTE3(MasterIrp->MdlAddress) = (*(_BYTE *)(a1 + 161) & 4) != 0;
      ...
      BYTE4(MasterIrp->MdlAddress) = (*(_BYTE *)(a1 + 161) & 2) != 0;
