/*
 * XREFs of StorpTelemetrySendUnitPauseRequestCounters @ 0x1C000C744
 * Callers:
...
void __fastcall StorpTelemetrySendUnitPauseRequestCounters(__int64 a1)
{
  ...
  if ( *(_DWORD *)(a1 + 1864)
    || *(_DWORD *)(a1 + 1868)
    || *(_DWORD *)(a1 + 1872)
    || (v2 = *(_QWORD *)(a1 + 24), *(_DWORD *)(v2 + 5384))
    || *(_DWORD *)(v2 + 5380) )
  {
    if ( (unsigned int)dword_1C0061058 > 5 )
    {
      if ( TlgKeywordOn((TraceLoggingHProvider)a1, 0x400000000000uLL) )
      {
        ...
        v36 = 4LL;
        v38 = 4LL;
        TlgWrite((TraceLoggingHProvider)v6, &unk_1C0057439, v4, v5, 0xDu, &pData);
      }
    }
    *(_QWORD *)(a1 + 1864) = 0LL;
    *(_DWORD *)(a1 + 1872) = 0;
