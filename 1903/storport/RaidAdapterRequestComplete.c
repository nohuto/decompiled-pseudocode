/*
 * XREFs of RaidAdapterRequestComplete @ 0x1C00057A0
 * Callers:
 ...
 *     StorTickEventQueue @ 0x1C000F3C0 (StorTickEventQueue.c)
 *     RaidAdapterProgramCryptoKeyRoutine @ 0x1C0034290 (RaidAdapterProgramCryptoKeyRoutine.c)
 *     RaidpAdapterContinueDataBufferScatterGather @ 0x1C0037520 (RaidpAdapterContinueDataBufferScatterGather.c)
...
char __fastcall RaidAdapterRequestComplete(__int64 a1, __int64 a2, char a3)
{
  ...
  if ( a3 )
    goto LABEL_6;
  if ( (((unsigned __int64)qword_1C00612B0 >> 3) & 1) != 0 )
      ...
      if ( v9 || (_BYTE)v8 == 1 )
      {
        if ( (unsigned int)dword_1C0061058 > 5 )
        {
          ...
          if ( (_BYTE)v8 )
          {
            ...
            LOBYTE(v8) = TlgWrite(v15, &unk_1C0055C28, v16, v17, 7u, &pData);
          }
        }
        return (char)v8;
      }
