/*
 * XREFs of RaidZoneWriteGroupListSearchRequest @ 0x1C0038908
 * Callers:
 ...
 *     PortSrbGetLbaFromCdb @ 0x1C0051048 (PortSrbGetLbaFromCdb.c)
 */
...
LABEL_42:
  ...
  v35 = *(_QWORD *)(v32 + 2776) / (unsigned __int64)v46;
