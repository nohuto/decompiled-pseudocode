/*
 * XREFs of RaidAdapterConfigureResources @ 0x1C001D45C
 * Callers:
 ...
 *     RaInitializeBus @ 0x1C006DF38 (RaInitializeBus.c)
...
__int64 __fastcall RaidAdapterConfigureResources(__int64 a1)
{
  ...
  if ( (int)result >= 0 )
  {
    if ( (unsigned int)RaInitializeBus(a1 + 592, *(_QWORD *)(a1 + 24)) != -1073741637 || (*(_BYTE *)(a1 + 104) & 8) != 0 )
    {
      ...
      KeInitializeDpc((PRKDPC)(a1 + 5480), RaidQueueWaitCheckDpcRoutine, *(PVOID *)(a1 + 8));
      return 0LL;
    }
    else
    {
