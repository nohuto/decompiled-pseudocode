/*
 * XREFs of McTemplateK0pzqqxxtt @ 0x1C0032208
 * Callers:
...
{
  struct _MCGEN_TRACE_CONTEXT *p_Logger; // rcx
  __int64 v4; // rax
  int v5; // edx
  ...
  v12 = 0;
  if ( !v27 )
    p_Logger = (struct _MCGEN_TRACE_CONTEXT *)&Context.Logger;
  v14 = 4LL;
  v10 = p_Logger;
  va_copy(v13, va1);
  v16 = 4LL;
  ...
  v22 = 4LL;
  v24 = 4LL;
  return McGenEventWrite(p_Logger, &EventDpc, 0LL, 9u, &EventData);
}
