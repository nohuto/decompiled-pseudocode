/*
 * XREFs of FillBufferWithDriverTelemetryDump @ 0x1C0050074
 * Callers:
 *     RaidStandardSecondaryDumpCallback @ 0x1C0050350 (RaidStandardSecondaryDumpCallback.c)
 * Callees:
...
LABEL_35:
    ...
    while ( 1 )
    {
      v19 = *(_QWORD *)(*(_QWORD *)(v3 + 24) + 5000LL) + 48LL * v17;
