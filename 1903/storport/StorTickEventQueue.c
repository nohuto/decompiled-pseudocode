/*
 * XREFs of StorTickEventQueue @ 0x1C000F3C0
 * Callers:
 ...
 *     StorEtwHwTimeoutDetectedEvent @ 0x1C004A328 (StorEtwHwTimeoutDetectedEvent.c)
 *     StorEtwMiniportBugAbortTimeoutEvent @ 0x1C004AFEC (StorEtwMiniportBugAbortTimeoutEvent.c)
...
__int64 __fastcall StorTickEventQueue(__int64 a1, __int64 a2)
{
  ...
  v4 = 0;
  _interlockedbittestandreset((volatile signed __int32 *)(a1 + 168), 2u);
  v6 = 0;
  v28 = 0;
  v30 = v2;
  if ( (*(_BYTE *)a2 & 1) == 0 )
      ...
      if ( v15 < *(_QWORD *)(v16 + 2768) )
      {
        ...
        if ( MiniportBugActionPolicy == 1 )
        {
          StorEtwMiniportBugResetBrokenEvent(
            v14 - 64,
            *(_QWORD *)(*(_QWORD *)(v12 + 224) + 2768LL) - *(_QWORD *)(v14 + 24),
            &v33);
        }
...
LABEL_82:
  if ( v28 )
    _interlockedbittestandset((volatile signed __int32 *)(a1 + 168), 2u);
  return v6;
}
