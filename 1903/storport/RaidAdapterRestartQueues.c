/*
 * XREFs of RaidAdapterRestartQueues @ 0x1C001655C
 * Callers:
 ...
 *     RaidAdapterRestartDpcRoutine @ 0x1C0034E90 (RaidAdapterRestartDpcRoutine.c)
...
LABEL_31:
    if ( !v3 )
      goto LABEL_6;
    v14 = *(_QWORD *)(v3[8] + 32);
    (*(void (__fastcall **)(_QWORD, __int64 *, _QWORD *))(v14 + 392))(*(_QWORD *)(v14 + 384), v3 - 15, v17);
  }
  if ( !v4 )
    KeAcquireInStackQueuedSpinLock((PKSPIN_LOCK)v1, &v15);
