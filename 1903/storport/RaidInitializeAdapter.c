/*
 * XREFs of RaidInitializeAdapter @ 0x1C006D634
 * Callers:
 ...
 *     PortGetLinkTimeoutValue @ 0x1C001ABAC (PortGetLinkTimeoutValue.c)
 ...
 *     RaidAllocateDeviceProperty @ 0x1C001CC50 (RaidAllocateDeviceProperty.c)
...
LABEL_9:
  ...
  *(_DWORD *)(a1 + 312) = v14;
  ...
  if ( (int)result >= 0 )
  {
    PortGetDriverParameters(*(_QWORD *)(a1 + 16) + 40LL, a7);
    ...
    *(_QWORD *)(a1 + 5032) = 0LL;
    ...
    PortGetRegistrySettings(v27, a7);
    ...
    *(_QWORD *)(a1 + 5000) = (a1 + 5760) & -(__int64)(v29 != 0);
    ...
    if ( (byte_1C0061741 & 1) != 0 )
      McTemplateK0qzzqxtqqt(
        ...
        v32,
        *(_DWORD *)(a1 + 56),
        *(unsigned __int64 **)(a1 + 4808),
        *(unsigned __int64 **)(a1 + 4800),
        *(_DWORD *)(a1 + 312),
        *(_QWORD *)(a1 + 104),
    ...
    if ( (unsigned int)dword_1C0061058 > 5 )
    {
      if ( TlgKeywordOn(v34, 0x400000000000uLL) )
      {
        ...
        *(_QWORD *)&pData[11].Size = 1LL;
        TlgWrite(v35, &unk_1C0055A04, v36, v37, 0xCu, pData);
      }
    }
    KeInitializeDpc(
