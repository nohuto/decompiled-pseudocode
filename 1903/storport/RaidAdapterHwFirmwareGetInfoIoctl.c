/*
 * XREFs of RaidAdapterHwFirmwareGetInfoIoctl @ 0x1C0033E08
 * Callers:
 ...
 *     RaTranslateMiniportFirmwareInfoToHwFirmwareInfo @ 0x1C0042B1C (RaTranslateMiniportFirmwareInfoToHwFirmwareInfo.c)
 */
