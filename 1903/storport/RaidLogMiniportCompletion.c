/*
 * XREFs of RaidLogMiniportCompletion @ 0x1C0005970
 * Callers:
...
LABEL_36:
  ...
  v18 = a1[27];
  v19 = a1[21];
  if ( v18 && *(_DWORD *)(v18 + 4996) )
  {
    if ( *(_QWORD *)(v18 + 5000) )
    {
      v20 = *(_QWORD *)(v18 + 5000)
          + 48LL
          * ((unsigned int)_InterlockedIncrement((volatile signed __int32 *)(v18 + 4992)) % *(_DWORD *)(v18 + 4996));
      *(_DWORD *)v20 = 1;
