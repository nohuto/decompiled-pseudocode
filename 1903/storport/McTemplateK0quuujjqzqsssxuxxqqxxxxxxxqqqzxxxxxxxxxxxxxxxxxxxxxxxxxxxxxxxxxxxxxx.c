/*
 * XREFs of McTemplateK0quuujjqzqsssxuxxqqxxxxxxxqqqzxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxx @ 0x1C000D620
 * Callers:
        ...
        char a63)
{
  ...
  v146 = &a33;
  if ( v79 )
    v78 = (struct _MCGEN_TRACE_CONTEXT *)&Context.Logger;
  v143 = v78;
  v148 = &a34;
  v150 = &a35;
  v152 = &a36;
  ...
  v219 = 8LL;
  v221 = 8LL;
  return McGenEventWrite(v78, &EventUnitPerformance, 0LL, 0x44u, &EventData);
}
