/*
 * XREFs of StorpTelemetryMarkUnitResponsive @ 0x1C004EB9C
 * Callers:
...
void __fastcall StorpTelemetryMarkUnitResponsive(__int64 a1)
{
  ...
  if ( (*(_BYTE *)(a1 + 162) & 2) != 0 && (unsigned int)dword_1C0061058 > 5 )
  {
    if ( TlgKeywordOn((TraceLoggingHProvider)a1, 0x400000000000uLL) )
    {
      ...
      v28 = 4LL;
      v30 = 4LL;
      TlgWrite(v4, &unk_1C0057A23, v2, (LPCGUID)v3, 0xBu, &pData);
    }
  }
}
