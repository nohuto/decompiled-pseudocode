/*
 * XREFs of StorPortAdapterIdleState @ 0x1C0040490
 * Callers:
 *     <none>
 * Callees:
...
ULONG __fastcall StorPortAdapterIdleState(__int64 a1, unsigned int Arg2, const GUID *Arg3)
{
  ...
  if ( v3 )
  {
    v7 = *(char *)(a1 + 108) < 0;
    v8 = *(_QWORD *)(a1 + 5024);
    *(_QWORD *)(a1 + 5320) = MEMORY[0xFFFFF78000000008];
    v9 = *(_DWORD *)(v8 + 20);
    if ( v7 )
      v10 = v9 | 0x10;
    else
  ...
  else
  {
    ...
    if ( *(_QWORD *)(a1 + 5320) )
    {
      if ( (*(_DWORD *)(*(_QWORD *)(a1 + 5024) + 20LL) & 0x10) != 0 || *(char *)(a1 + 108) < 0 )
      {
        v6 = MEMORY[0xFFFFF78000000008] - *(_QWORD *)(a1 + 5320);
        *(_QWORD *)(a1 + 5328) += v6 / 0x2710;
        if ( v6 / 0x2710 >= 0x2710 )
          ++*(_DWORD *)(a1 + 5364);
      }
      *(_QWORD *)(a1 + 5320) = 0LL;
