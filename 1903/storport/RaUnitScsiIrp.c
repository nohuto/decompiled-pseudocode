/*
 * XREFs of RaUnitScsiIrp @ 0x1C0007D30
 * Callers:
 ...
 *     RaUnitCheckRemoveStateForDisabled @ 0x1C00442F4 (RaUnitCheckRemoveStateForDisabled.c)
 ...
 *     RaUnitSwallowStopUnitCommand @ 0x1C0046740 (RaUnitSwallowStopUnitCommand.c)
...
__int64 __fastcall RaUnitScsiIrp(__int64 a1, IRP *a2)
{
  ...
  {
LABEL_76:
    v12 = (volatile signed __int32 *)(a1 + 680);
...
LABEL_85:
        if ( _InterlockedExchangeAdd(v12, 0xFFFFFFFF) == 1 )
          KeSetEvent((PRKEVENT)(a1 + 176), 0, 0);
...
LABEL_25:
    ...
    && (v42 = RaUnitSwallowStopUnitCommand(a1)) != 0 )
  {
    ...
    if ( WPP_GLOBAL_Control != (PDEVICE_OBJECT)&WPP_GLOBAL_Control
      ...
      && BYTE1(WPP_GLOBAL_Control->Timer) >= 4u )
    {
      WPP_SF_qq(WPP_GLOBAL_Control->AttachedDevice, 21LL, &WPP_a32982da72aa344f3768c69018313f42_Traceguids, a1, a2);
    }
    return v43;
  }
  else
  {
    if ( StorEtwLoggingEnabled && (byte_1C0061741 & 0x3C) != 0 && ((LOBYTE(v18->SecurityQos) - 8) & 0x5D) == 0 )
    {
