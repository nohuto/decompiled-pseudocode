/*
 * XREFs of McTemplateK0pqqx @ 0x1C00320C0
 * Callers:
...
ULONG McTemplateK0pqqx(struct _MCGEN_TRACE_CONTEXT *a1, __int64 a2, __int64 a3, ...)
{
  ...
  v12 = 8LL;
  va_copy(v11, va3);
  return McGenEventWrite(a1, &EventIsr, 0LL, 5u, &EventData);
}
