/*
 * XREFs of RaidpAdapterRedirectDpcRoutine @ 0x1C001DE80
 * Callers:
 *     <none>
 * Callees:
        ...
        PVOID SystemArgument2)
{
  ...
  if ( StorEtwLoggingEnabled && (byte_1C0061743 & 4) != 0 )
  {
    if ( UseQPCTime )
  ...
  if ( (unsigned int)(MEMORY[0xFFFFF78000000320] - v21) > v8[1198] )
  {
    v8[1198] = MEMORY[0xFFFFF78000000320] - v21;
    v8[1199] = v6;
  }
  if ( v6 > v8[1197] )
    v8[1197] = v6;
  if ( StorEtwLoggingEnabled && (byte_1C0061743 & 4) != 0 && v6 >= 0x19 )
  {
