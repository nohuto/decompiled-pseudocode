/*
 * XREFs of StorpTelemetryLogUnitErrorDataCriticalData @ 0x1C004DD48
 * Callers:
  ...
  if ( (unsigned int)dword_1C0061058 > 5 )
  {
    if ( TlgKeywordOn((TraceLoggingHProvider)a1, 0x800000000000uLL) )
    {
      ...
      *(_QWORD *)&hProvider.LevelPlus1 = g_SystemUptime_s;
      ...
      v69 = 2LL;
      v71[1] = 0;
      TlgWrite(&hProvider, &unk_1C00572B4, v13, v14, 0x1Cu, (EVENT_DATA_DESCRIPTOR *)&hProvider.ProviderMetadataPtr);
    }
  }
}
