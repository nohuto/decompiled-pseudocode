/*
 * XREFs of RaidUnitPendingDpcRoutine @ 0x1C000F310
 * Callers:
 *     <none>
 * Callees:
        ...
        PVOID SystemArgument2)
{
  ...
  if ( *(int *)(v4 + 1520) <= 0 )
  {
    ...
    {
      if ( (*(char *)(v4 + 161) < 0 || *(_QWORD *)(*(_QWORD *)(v4 + 24) + 5024LL)) && (*(_DWORD *)(v4 + 168) & 4) == 0 )
        RaidUnitDisablePendingTimer(v4);
      if ( _InterlockedExchange((volatile __int32 *)(v4 + 1504), 0) )
      {
...
LABEL_20:
      ...
      if ( v12 != -1 )
      {
        ...
        if ( !v12 || v12 < (unsigned int)v11 )
        {
          ...
          *(_BYTE *)(v4 + 162) |= 2u;
          ...
          {
            WPP_SF_q(WPP_GLOBAL_Control->AttachedDevice, 60LL, &WPP_a32982da72aa344f3768c69018313f42_Traceguids, v4);
          }
        }
      }
    }
  ...
  else if ( v7 )
  {
    if ( WPP_GLOBAL_Control != (PDEVICE_OBJECT)&WPP_GLOBAL_Control
      ...
      && BYTE1(WPP_GLOBAL_Control->Timer) >= 2u )
    {
      WPP_SF_q(WPP_GLOBAL_Control->AttachedDevice, 61LL, &WPP_a32982da72aa344f3768c69018313f42_Traceguids, v4);
    }
