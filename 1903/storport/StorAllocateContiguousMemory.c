/*
 * XREFs of StorAllocateContiguousMemory @ 0x1C006BC9C
 * Callers:
 *     StorPortGetAdditionalCrashDumpArea @ 0x1C0011CA4 (StorPortGetAdditionalCrashDumpArea.c)
 *     RaidDmaAllocateUncachedExtension @ 0x1C0022048 (RaidDmaAllocateUncachedExtension.c)
 * Callees:
