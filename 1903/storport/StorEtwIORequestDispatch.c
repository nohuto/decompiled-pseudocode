/*
 * XREFs of StorEtwIORequestDispatch @ 0x1C004A57C
 * Callers:
 ...
 *     StRtlIoStorInfoGetNvCachePriority @ 0x1C00522CC (StRtlIoStorInfoGetNvCachePriority.c)
 */
  ...
  if ( !v10 )
  {
    if ( ((v2 - 8) & 0x5F) != 0 )
    {
      ...
      if ( ((v2 - 10) & 0x5F) == 0 )
      {
        ...
        {
          if ( (byte_1C0061741 & 0x20) != 0 )
          {
            v15 = (const EVENT_DESCRIPTOR *)&EventPagingWriteRequest;
            goto LABEL_28;
          }
        }
        else if ( (byte_1C0061741 & 8) != 0 )
        {
    ...
    else
    {
      ...
      if ( (NvCachePriority & 0x42) != 0 )
      {
        if ( (byte_1C0061741 & 0x10) != 0 )
        {
          v15 = (const EVENT_DESCRIPTOR *)&EventPagingReadRequest;
          goto LABEL_28;
        }
      }
      else if ( (byte_1C0061741 & 4) != 0 )
      {
