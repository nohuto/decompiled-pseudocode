/*
 * XREFs of StorpUnitInitializePoFxPower @ 0x1C003E104
 * Callers:
 ...
 *     RaidStorPoFxComponentVersionAndSizeIsValid @ 0x1C002144C (RaidStorPoFxComponentVersionAndSizeIsValid.c)
 ...
 *     RaidStorPoFxDeviceVersionAndSizeIsValid @ 0x1C00218A4 (RaidStorPoFxDeviceVersionAndSizeIsValid.c)
...
__int64 __fastcall StorpUnitInitializePoFxPower(__int64 a1, __int64 a2, int *a3, _BYTE *a4)
{
  ...
  if ( Pool )
  {
    ...
    *((_QWORD *)v18 + 1) = v18 + 144;
    ...
    if ( *a3 == 3 && (a3[3] & 0x20) != 0 )
      *((_DWORD *)v18 + 8) |= 0x80u;
    v21 = *(struct _EX_RUNDOWN_REF_CACHE_AWARE **)(v8 + 1480);
    *(_QWORD *)(v8 + 1488) = v18;
