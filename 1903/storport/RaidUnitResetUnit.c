/*
 * XREFs of RaidUnitResetUnit @ 0x1C0048328
 * Callers:
 ...
 *     StorpAggregateHierarchicalResetLun @ 0x1C004BD18 (StorpAggregateHierarchicalResetLun.c)
 */
  ...
  if ( Srb )
  {
    ...
    if ( v13 )
    {
      ...
      if ( (unsigned int)dword_1C0061058 > 5 )
      {
        ...
        v44 = 1LL;
        v46 = 8LL;
        TlgWrite(v21, &unk_1C0056165, v17, v18, 0xAu, &pData);
      }
