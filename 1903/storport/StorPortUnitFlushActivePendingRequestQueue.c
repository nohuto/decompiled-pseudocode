/*
 * XREFs of StorPortUnitFlushActivePendingRequestQueue @ 0x1C0007274
 * Callers:
...
void __fastcall StorPortUnitFlushActivePendingRequestQueue(__int64 a1)
{
  ...
  if ( (unsigned __int8)RaidUnitCheckAndAcquirePoFx(a1) )
  {
    while ( 1 )
    {
      v2 = (_QWORD *)(*(_QWORD *)(a1 + 1488) + 72LL);
      if ( (_QWORD *)*v2 == v2 )
        break;
      v3 = *(_QWORD **)(*(_QWORD *)(a1 + 1488) + 80LL);
      if ( (_QWORD *)*v3 != v2 || (v4 = (_QWORD *)v3[1], (_QWORD *)*v4 != v3) )
        __fastfail(3u);
      *(_QWORD *)(*(_QWORD *)(a1 + 1488) + 80LL) = v4;
      *v4 = v2;
      v5 = v3[2];
