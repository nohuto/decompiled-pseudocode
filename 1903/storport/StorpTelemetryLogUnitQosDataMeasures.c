/*
 * XREFs of StorpTelemetryLogUnitQosDataMeasures @ 0x1C004E408
 * Callers:
...
void __fastcall StorpTelemetryLogUnitQosDataMeasures(const struct _TlgProvider_t *a1)
{
  ...
  if ( (unsigned int)dword_1C0061058 > 5 )
  {
    if ( TlgKeywordOn(a1, 0x400000000000uLL) )
    {
      ...
      *(_DWORD *)hProvider = *(_DWORD *)(v2 + 2724);
      *(_DWORD *)&hProvider[4] = *(_DWORD *)(v2 + 2728);
      *(_QWORD *)&hProvider[8] = *(_QWORD *)(v2 + 2732);
      *(_QWORD *)&hProvider[16] = *(_QWORD *)(v2 + 2740);
      v6 = (*(_BYTE *)(v2 + 162) & 2) != 0;
      v21 = 16LL;
      v14 = v6;
      *(_OWORD *)&hProvider[36] = *(_OWORD *)(v2 + 1824);
      v15 = *(_BYTE *)(v3 + 32);
      *(_QWORD *)&hProvider[52] = *(_QWORD *)(v2 + 1840);
      v18 = *(_QWORD *)(v2 + 1848);
      *(_QWORD *)&hProvider[24] = *(_QWORD *)(v2 + 1856);
      *(_DWORD *)&hProvider[32] = *(_DWORD *)(v3 + 28);
      ...
      v62 = 4LL;
      v64 = 4LL;
      TlgWrite((TraceLoggingHProvider)hProvider, &unk_1C0057084, v9, v10, 0x1Au, &pData);
    }
  }
}
