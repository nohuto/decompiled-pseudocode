/*
 * XREFs of RaidInitializePerfOpts @ 0x1C0021ADC
 * Callers:
...
__int64 __fastcall RaidInitializePerfOpts(__int64 a1, char a2, unsigned int *a3)
{
  ...
  if ( !v6 )
  {
    ...
    v34 = 23LL;
LABEL_70:
    WPP_SF_(v33->AttachedDevice, v34, &WPP_a09e26a5f087304ee2330933c6b86cea_Traceguids);
LABEL_71:
    v12 = -1056964602;
    goto LABEL_58;
  }
  ...
  if ( v14 >= 5 && v6[1] >= 0x28 )
  {
    ...
    {
      RaidInitializeDma(v39, *(_QWORD *)(v7 + 32), v7 + 304);
      v3 = 0LL;
    }
    if ( v7 != -696 && (v40 = *v37) != 0 && (v41 = *(_QWORD *)(v40 + 8)) != 0 )
    {
      if ( *(int *)(v7 + 724) < 3 || (v42 = *(__int64 (__fastcall **)(__int64, _QWORD *))(v41 + 128)) == 0LL )
      {
LABEL_94:
        v4 = a2;
LABEL_20:
...
LABEL_44:
    ...
    {
LABEL_32:
      *(_WORD *)(v7 + 4740) = v17 ^ (v17 ^ (4 * v19)) & 0x3FC | 2;
      v21 = v48;
      v22 = v20 + 1;
      *(_WORD *)(v7 + 4742) = KeQueryActiveGroupCount();
      if ( v18 < v22 )
      {
        ...
        do
        {
          epi16 = _mm_extract_epi16(*(__m128i *)(*(_QWORD *)(v7 + 4440) + v23), 4);
          v25 = *(_QWORD *)(*(_QWORD *)(v7 + 4440) + v23);
          if ( epi16 != 0xFFFF )
          {
            if ( v48 && (v6[2] & 0xC) == 0xC )
            {
    ...
    v36 = 26LL;
LABEL_80:
    WPP_SF_(v35->AttachedDevice, v36, &WPP_a09e26a5f087304ee2330933c6b86cea_Traceguids);
    goto LABEL_81;
  }
