/*
 * XREFs of StorpLogPerAdapterStatistics @ 0x1C000E660
 * Callers:
 ...
 *     StorpInitializeHierarchicalResetBuckets @ 0x1C000E794 (StorpInitializeHierarchicalResetBuckets.c)
...
void __fastcall StorpLogPerAdapterStatistics(__int64 a1)
{
    ...
    && TlgKeywordOn(v2, 0x400000000000uLL) )
  {
    ...
    v59 = 4LL;
    v61 = 1LL;
    TlgWrite(v5, &unk_1C005854A, v6, v7, 0x13u, &pData);
  }
    ...
    && TlgKeywordOn(v3, 0x400000000000uLL) )
  {
    ...
    v59 = 4LL;
    v61 = 1LL;
    TlgWrite(v8, &unk_1C0058F22, v9, v10, 0x13u, &pData);
  }
