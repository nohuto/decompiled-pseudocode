/*
 * XREFs of StorPortNotification @ 0x1C0005250
 * Callers:
      ...
      case 4102:
        if ( StorEtwLoggingEnabled )
        {
          ...
          if ( v65 )
          {
            ...
            if ( v7 )
            {
              if ( (byte_1C0061741 & 2) != 0 || (byte_1C0061743 & 2) != 0 )
                *(_QWORD *)(v7 + 720) = v63;
              ...
              v8 = *(_QWORD *)(v7 + 224);
              if ( v8 && *(_DWORD *)(v8 + 1556) && (byte_1C0061743 & 2) != 0 )
              {
                LOBYTE(v5) = 1;
          ...
          switch ( a1 )
          {
            ...
            case 4103:
              ...
              if ( v4 && v63 && LOWORD(v63->TargetInfoAsUlong) == 1 && (v65 & 0xFFFFFFFFFFFFFFF8uLL) == 0 )
              {
                ...
                {
                  *(_QWORD *)(Unit + 1616) = v51;
                  v54 = RaidUnitProcessAsyncNotification(v4, v52, Unit + 1608);
                }
              }
              else
              {
