/*
 * XREFs of RaidAdapterPowerUpDeviceCompletionLastStep @ 0x1C0016380
 * Callers:
 *     RaidAdapterDevicePowerUpSrbComplete @ 0x1C0012190 (RaidAdapterDevicePowerUpSrbComplete.c)
  ...
  *(_DWORD *)(a2 + 268) = LowPart;
  ...
  while ( 1 )
  {
    ...
    if ( *((_BYTE *)&v8[-2].Next + 9) )
    {
      ...
      *(_QWORD *)(v9 + 1664) = 0LL;
      *(_BYTE *)(v9 + 1657) = 0;
      RaidUnitProcessSetDevicePowerIrp((__int64)&v8[-105], v10);
