/*
 * XREFs of McTemplateK0pqquuuqpp @ 0x1C0039C40
 * Callers:
...
ULONG McTemplateK0pqquuuqpp(struct _MCGEN_TRACE_CONTEXT *a1, __int64 a2, const GUID *a3, ...)
{
  ...
  v20 = 8LL;
  v22 = 8LL;
  return McGenEventWrite(a1, &EventStateChangeDetected, a3, 0xAu, &EventData);
}
