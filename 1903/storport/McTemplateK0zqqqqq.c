/*
 * XREFs of McTemplateK0zqqqqq @ 0x1C00493AC
 * Callers:
...
ULONG __fastcall McTemplateK0zqqqqq(
        __int64 a1,
        __int64 a2,
        __int64 a3,
        ...
        char a9)
{
  ...
  unsigned __int64 *v13; // [rsp+40h] [rbp-41h]
  ...
  v24 = &a9;
  v25 = 4LL;
  return McGenEventWrite((PMCGEN_TRACE_CONTEXT)v10, &EventIncreaseAdapterResourceList, 0LL, 7u, &EventData);
}
