/*
 * XREFs of StorEtwLogoRequestServiceTimeEventData @ 0x1C004AAAC
 * Callers:
...
int __fastcall StorEtwLogoRequestServiceTimeEventData(__int64 a1, char a2, __int64 a3)
{
  ...
  if ( !a2 )
  {
    ...
    {
      if ( v25.QuadPart && v14 )
        v7 = 10000 * (1000 * (v14 % v25.QuadPart) % v25.QuadPart) / v25.QuadPart
    ...
    if ( v15 >= v13 )
    {
      ...
      {
        if ( v25.QuadPart && v16 )
          v8 = 10000 * (1000 * (v16 % v25.QuadPart) % v25.QuadPart) / v25.QuadPart
