/*
 * XREFs of StorPortExtendedFunction @ 0x1C000E990
 * Callers:
 *     <none>
 * Callees:
 ...
 *     StorpGetProcessorIndexFromNumber @ 0x1C001E130 (StorpGetProcessorIndexFromNumber.c)
 ...
 *     RaidAdapterIsRegisteredForIdleDetection @ 0x1C001EC00 (RaidAdapterIsRegisteredForIdleDetection.c)
 ...
 *     RaidGetAssociatedXrb @ 0x1C0036A94 (RaidGetAssociatedXrb.c)
 *     RaidInitializeCryptoEngine @ 0x1C0037038 (RaidInitializeCryptoEngine.c)
 *     RaidInitializeRpmb @ 0x1C0037190 (RaidInitializeRpmb.c)
 ...
 *     RaidAdapterCacheOperationalPowerRange @ 0x1C003A3EC (RaidAdapterCacheOperationalPowerRange.c)
 ...
 *     StorBuildScatterGatherListProxy @ 0x1C003A82C (StorBuildScatterGatherListProxy.c)
 *     StorDelayExecution @ 0x1C003A88C (StorDelayExecution.c)
 ...
 *     StorpAllocateContiguousMemorySpecifyCacheNode @ 0x1C003BE64 (StorpAllocateContiguousMemorySpecifyCacheNode.c)
 ...
 *     StorpFlushDataBufferMdl @ 0x1C003C7EC (StorpFlushDataBufferMdl.c)
 ...
 *     StorpGetActiveGroupCount @ 0x1C003CE6C (StorpGetActiveGroupCount.c)
 *     StorpGetActiveNodeCount @ 0x1C003CEA0 (StorpGetActiveNodeCount.c)
 *     StorpGetCurrentProcessorIndex @ 0x1C003CF34 (StorpGetCurrentProcessorIndex.c)
 *     StorpGetCurrentProcessorNumber @ 0x1C003CF58 (StorpGetCurrentProcessorNumber.c)
 *     StorpGetDataInSgList @ 0x1C003CF84 (StorpGetDataInSgList.c)
 *     StorpGetGroupAffinity @ 0x1C003D1BC (StorpGetGroupAffinity.c)
 *     StorpGetHighestNodeNumber @ 0x1C003D218 (StorpGetHighestNodeNumber.c)
 *     StorpGetLogicalProcessorRelationship @ 0x1C003D24C (StorpGetLogicalProcessorRelationship.c)
 *     StorpGetNodeAffinity @ 0x1C003D2A0 (StorpGetNodeAffinity.c)
 *     StorpGetPfns @ 0x1C003D2E0 (StorpGetPfns.c)
 *     StorpGetProcessorCount @ 0x1C003D37C (StorpGetProcessorCount.c)
 *     StorpGetRequestInfo @ 0x1C003D3B4 (StorpGetRequestInfo.c)
...
LABEL_39:
      ...
      case 0x31u:
        ...
        {
LABEL_145:
          if ( CurrentIrql == 2 || (*(_BYTE *)(v53 + 161) & 1) != 0 || *(char *)(v53 + 160) < 0 )
            v11 = 2;
...
LABEL_183:
            ExReleaseRundownProtectionCacheAware(*(PEX_RUNDOWN_REF_CACHE_AWARE *)(v62 + 1480));
            return v14;
          }
        }
