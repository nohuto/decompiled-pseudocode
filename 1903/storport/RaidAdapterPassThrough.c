/*
 * XREFs of RaidAdapterPassThrough @ 0x1C0072F94
 * Callers:
 ...
 *     RaidRecordPassthroughData @ 0x1C003722C (RaidRecordPassthroughData.c)
...
__int64 __fastcall RaidAdapterPassThrough(__int64 a1, IRP *a2, char a3)
{
    ...
    && (Unit = RaidAdapterFindUnit(a1, v14)) != 0 )
  {
    ...
    if ( CurrentStackLocation->MinorFunction || (*(_BYTE *)(Unit + 160) & 1) == 0 )
    {
