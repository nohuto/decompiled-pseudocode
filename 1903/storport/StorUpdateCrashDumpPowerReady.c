/*
 * XREFs of StorUpdateCrashDumpPowerReady @ 0x1C0016768
 * Callers:
...
char __fastcall StorUpdateCrashDumpPowerReady(__int64 a1)
{
  ...
  else
  {
    ...
    if ( (*(_BYTE *)(v2 + 162) & 4) == 0
      && (*(_DWORD *)(v2 + 204) != 4 || *(_DWORD *)(v2 + 692) || (*(_BYTE *)(v2 + 161) & 0x44) != 0x44) )
    {
      ...
      if ( !StorPoFxComponent
        ...
        || *StorPoFxComponent == 1 && (*(_BYTE *)(v2 + 161) & 0x40) != 0 && *(_DWORD *)(v9 + 16) > v8 )
      {
        v3 = 0;
      }
