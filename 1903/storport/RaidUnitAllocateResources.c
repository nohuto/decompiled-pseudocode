/*
 * XREFs of RaidUnitAllocateResources @ 0x1C001542C
 * Callers:
 ...
 *     StorCreateEventQueue @ 0x1C00157D0 (StorCreateEventQueue.c)
...
__int64 __fastcall RaidUnitAllocateResources(__int64 a1)
{
  ...
  v1 = *(_QWORD *)(a1 + 24);
  *(_DWORD *)(a1 + 1440) = -1;
  *(_DWORD *)(a1 + 680) = 0x10000000;
  KeInitializeEvent((PRKEVENT)(a1 + 176), SynchronizationEvent, 0);
  ...
  EventQueue = StorCreateEventQueue(a1 + 216);
  if ( EventQueue < 0 )
    goto LABEL_32;
  v4 = *(_QWORD *)(a1 + 24);
  if ( v4 )
