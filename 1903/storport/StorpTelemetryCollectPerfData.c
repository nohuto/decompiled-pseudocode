/*
 * XREFs of StorpTelemetryCollectPerfData @ 0x1C000AAD0
 * Callers:
...
LABEL_82:
    if ( v51 )
    {
      _InterlockedIncrement64((volatile signed __int64 *)(a3 + 1880));
      _InterlockedExchangeAdd64((volatile signed __int64 *)(a3 + 1888), v51);
      if ( v51 > *(_QWORD *)(a3 + 1896) )
        *(_QWORD *)(a3 + 1896) = v51;
      if ( *(_BYTE *)(a2 + 2) == 40 && v51 > *(unsigned int *)(a2 + 40) )
        _InterlockedIncrement64((volatile signed __int64 *)(a3 + 1904));
    }
  }
  if ( v8 )
    return 3221225473LL;
...
LABEL_100:
  v22 = dword_1C006147C;
  v23 = v56 * (unsigned __int16)qword_1C0061450;
LABEL_27:
  v24 = v21 + v23;
  ...
  v27 = v26 * HIDWORD(qword_1C0061480);
  v28 = 0;
  v29 = *(_QWORD *)(a3 + 1952) + v27 + 24 * (v24 + (unsigned __int64)v22);
  v30 = *(_BYTE *)(a2 + 3);
  if ( *(_BYTE *)(a2 + 2) == 40 )
  {
    if ( !*(_DWORD *)(a2 + 20) )
