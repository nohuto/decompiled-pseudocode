/*
 * XREFs of StorEtwMiniportLogError @ 0x1C003A974
 * Callers:
...
__int64 __fastcall StorEtwMiniportLogError(__int64 a1, __int64 a2, char a3, unsigned __int64 *a4, int a5, __int64 a6)
{
  char v6; // r14
  unsigned int v7; // ebx
  char v10; // r15
  ...
  unsigned __int64 *v23; // [rsp+A0h] [rbp-49h]
