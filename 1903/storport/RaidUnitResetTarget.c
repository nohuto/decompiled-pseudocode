/*
 * XREFs of RaidUnitResetTarget @ 0x1C004806C
 * Callers:
 ...
 *     StorpAggregateHierarchicalResetTarget @ 0x1C004BD6C (StorpAggregateHierarchicalResetTarget.c)
 */
  ...
  if ( Srb )
  {
    ...
    if ( v13 )
    {
      ...
      if ( (unsigned int)dword_1C0061058 > 5 )
      {
        ...
        v40 = 1LL;
        v42 = 8LL;
        TlgWrite((TraceLoggingHProvider)8, &unk_1C0056068, v18, v19, 8u, &pData);
      }
