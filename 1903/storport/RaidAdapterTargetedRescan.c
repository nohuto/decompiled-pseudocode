/*
 * XREFs of RaidAdapterTargetedRescan @ 0x1C0022F00
 * Callers:
...
__int64 __fastcall RaidAdapterTargetedRescan(__int64 a1, int a2, __int64 *a3, char a4)
{
  ...
  if ( Microsoft_Windows_StorPortEnableBits < 0 )
    McTemplateK0zqquuuqpp(
      ...
      *(_QWORD *)(a1 + 4928),
      *(_QWORD *)(a1 + 4936));
  if ( (*(_DWORD *)(a1 + 4908) & 4) != 0 )
  {
    v5 = *(unsigned __int8 *)(a1 + 401);
    if ( *(_QWORD *)(a1 + 4960) )
    {
      v14 = (struct _RTL_BITMAP *)(a1 + 4944);
      if ( (*(_DWORD *)(a1 + 4912) & 1) != 0 )
        RtlSetBit(v14, v10);
      else
        RtlClearBit(v14, v10);
    }
