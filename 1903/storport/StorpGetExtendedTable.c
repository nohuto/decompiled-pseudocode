/*
 * XREFs of StorpGetExtendedTable @ 0x1C003D000
 * Callers:
...
__int128 *__fastcall StorpGetExtendedTable(__int64 a1, __int64 *a2)
{
  ...
  if ( a2 )
  {
    if ( a1 )
    {
      ...
      *(_OWORD *)(v5 + 16) = xmmword_1C0061570;
      *(_OWORD *)(v5 + 32) = xmmword_1C0061580;
      *(_OWORD *)(v5 + 48) = xmmword_1C0061590;
      *(_OWORD *)(v5 + 64) = xmmword_1C00615A0;
      *(_QWORD *)(v5 + 80) = qword_1C00615B0;
      *a2 = v5;
    }
    else
    {
