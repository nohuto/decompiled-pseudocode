/*
 * XREFs of GatewayRegisterForEmptyNotification @ 0x1C0017280
 * Callers:
...
char __fastcall GatewayRegisterForEmptyNotification(__int64 a1, __int64 a2, IRP *a3)
{
  char v6; // di
  ...
  if ( v6 )
    RaidAdapterStopOnPowerdown(a2, a3);
  return v6;
}
