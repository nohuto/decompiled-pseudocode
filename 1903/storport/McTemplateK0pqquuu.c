/*
 * XREFs of McTemplateK0pqquuu @ 0x1C0039B84
 * Callers:
...
ULONG McTemplateK0pqquuu(struct _MCGEN_TRACE_CONTEXT *a1, __int64 a2, __int64 a3, ...)
{
  ...
  v14 = 1LL;
  v16 = 1LL;
  return McGenEventWrite(a1, &EventPortPauseDevice, 0LL, 7u, &EventData);
}
