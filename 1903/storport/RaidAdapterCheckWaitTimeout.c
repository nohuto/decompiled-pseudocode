/*
 * XREFs of RaidAdapterCheckWaitTimeout @ 0x1C001E3E8
 * Callers:
 *     RaidQueueWaitCheckDpcRoutine @ 0x1C001E3C0 (RaidQueueWaitCheckDpcRoutine.c)
 * Callees:
 ...
 *     RaidLunQueueCheckWaitTimeout @ 0x1C003853C (RaidLunQueueCheckWaitTimeout.c)
 */
...
void __fastcall RaidAdapterCheckWaitTimeout(__int64 a1)
{
  ...
  if ( *v2 != (__int64 **)v2 )
  {
    ...
    {
      v17 = v16[3];
      if ( (*((_BYTE *)v17 + 162) & 2) == 0 )
      {
        v18 = (ULONGLONG)*(v16 - 2);
        if ( v18 == -1LL || v18 >= UnbiasedInterruptTime )
          break;
      }
      if ( (*((_BYTE *)v17 + 162) & 2) == 0 && !v4 )
      {
        v6 = v17[3];
        v4 = 1;
        v5 = *(_DWORD *)(a1 + 792);
...
LABEL_2:
  while ( 1 )
  {
    ...
    v28 = v7[2];
    v29 = *(_BYTE *)(v27 + 162);
    RaidDeleteDeviceQueueEntry(v27 + 400, *(_BYTE *)(v28 + 142) & 1);
    _InterlockedIncrement64((volatile signed __int64 *)(v27 + 1840));
          ...
          (v9 = Pool) != 0LL) )
    {
      ...
      if ( v10 != (_QWORD *)(a1 + 120) )
      {
        ...
        do
        {
          v12 = v10 - 7;
          if ( *((_BYTE *)v10 + 2664)
            && (*((_DWORD *)v12 + 686) != -1 || (*((_BYTE *)v12 + 162) & 2) != 0)
      ...
      if ( v8 )
      {
        ...
        do
        {
          ...
          if ( v58 > v3 )
          {
            v39 = RaidLunQueueCheckWaitTimeout(*v14 + 400, v58 - v3, &v53);
            v3 += v39;
            if ( v39 )
              _InterlockedExchangeAdd64((volatile signed __int64 *)(*v14 + 1848), v39);
          }
