/*
 * XREFs of RaDriverScsiIrp @ 0x1C0007C90
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall RaDriverScsiIrp(__int64 a1, __int64 a2)
{
  ...
  {
    WPP_SF_qq(WPP_GLOBAL_Control->AttachedDevice, 18LL, &WPP_0ece2f36f1a933110a118c5b83c83ab6_Traceguids, a1, a2);
  }
  *(_BYTE *)(a2 + 141) = -88;
  v4 = *(_DWORD **)(a1 + 64);
  if ( *v4 )
...
LABEL_7:
  if ( WPP_GLOBAL_Control != (PDEVICE_OBJECT)&WPP_GLOBAL_Control
    ...
    && BYTE1(WPP_GLOBAL_Control->Timer) >= 4u )
  {
    WPP_SF_qqD(WPP_GLOBAL_Control->AttachedDevice, 19LL, &WPP_0ece2f36f1a933110a118c5b83c83ab6_Traceguids, a1, a2, v6);
  }
  return v6;
}
