/*
 * XREFs of RaidAdapterSendRPMBCommandSynchronously @ 0x1C0035620
 * Callers:
...
__int64 __fastcall RaidAdapterSendRPMBCommandSynchronously(__int64 a1, IRP *a2, char a3, void *a4, int a5)
{
  ...
  _BYTE *v22; // r14
  IRP *v23; // rbx
  _IRP::$04B1A7556B4AC6D95596C3902CEA633C *p_AssociatedIrp; // rcx
  __int64 v25; // rax
  __int16 v26; // ax
  __int64 v27; // r8
  int v28; // eax
...
LABEL_42:
  ...
  else
  {
    ...
    *((_QWORD *)Srb + 6) = v10;
    ...
    p_AssociatedIrp = (_IRP::$04B1A7556B4AC6D95596C3902CEA633C *)(Srb + 72);
    *(_QWORD *)(v10 + 168) = Srb;
    v25 = *((_QWORD *)Srb + 3);
    *(_QWORD *)(v10 + 176) = a2;
    v23 = a2;
  ...
  BYTE1(p_AssociatedIrp->MasterIrp) = *(_BYTE *)(a1 + 5584);
  v26 = *(_WORD *)(a1 + 5586);
