/*
 * XREFs of TranslateToExtendedSrb @ 0x1C0041B70
 * Callers:
 *     RaidUnitClaimIrp @ 0x1C0003AB0 (RaidUnitClaimIrp.c)
 * Callees:
 *     McTemplateK0zx @ 0x1C0041624 (McTemplateK0zx.c)
 *     TranslateScsiRequestBlockToIoInfoSrbExData @ 0x1C0041894 (TranslateScsiRequestBlockToIoInfoSrbExData.c)
 *     TranslateScsiRequestBlockToScsiCdb16SrbExData @ 0x1C00419F8 (TranslateScsiRequestBlockToScsiCdb16SrbExData.c)
 *     TranslateScsiRequestBlockToStorageRequestBlock @ 0x1C0041A54 (TranslateScsiRequestBlockToStorageRequestBlock.c)
 */
...
LABEL_51:
  ...
  if ( (Microsoft_Windows_StorPortEnableBits & 0x40) != 0 )
    McTemplateK0zx(v20.QuadPart, v19.QuadPart, v21.QuadPart, (unsigned __int64 *)L"Translate SCSI_REQUEST_BLOCK", v6);
