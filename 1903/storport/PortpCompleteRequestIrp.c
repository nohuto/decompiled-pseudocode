/*
 * XREFs of PortpCompleteRequestIrp @ 0x1C0051BA8
 * Callers:
 *     PortpAsyncCompletion @ 0x1C0051A80 (PortpAsyncCompletion.c)
 *     PortpCancelRoutine @ 0x1C0051B10 (PortpCancelRoutine.c)
 * Callees:
