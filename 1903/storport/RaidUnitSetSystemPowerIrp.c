/*
 * XREFs of RaidUnitSetSystemPowerIrp @ 0x1C0010424
 * Callers:
...
__int64 __fastcall RaidUnitSetSystemPowerIrp(__int64 a1, IRP *a2, __int64 a3)
{
  ...
  v9 = (_DWORD)LowPart != 1 && *(_DWORD *)(a1 + 200) < (int)LowPart;
  *(_BYTE *)(a1 + 212) = v9;
  *(_DWORD *)(a1 + 200) = LowPart;
  *(_DWORD *)(a1 + 208) = EaLength;
  if ( v9 )
  {
    if ( (_DWORD)LowPart == 5 )
