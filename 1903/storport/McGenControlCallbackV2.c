/*
 * XREFs of McGenControlCallbackV2 @ 0x1C001F490
 * Callers:
 *     <none>
 * Callees:
 ...
 *     StorEtwAdapterNeedsUpdate @ 0x1C004A2FC (StorEtwAdapterNeedsUpdate.c)
 */
        ...
        if ( v23 )
        {
          if ( (_DWORD)v22 )
          {
            ...
            do
            {
              ...
              ExReleaseRundownProtectionCacheAware(*(PEX_RUNDOWN_REF_CACHE_AWARE *)(*v35++ + 256));
              --v22;
            }
            while ( v22 );
          }
