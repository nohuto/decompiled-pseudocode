/*
 * XREFs of RaidBusEnumeratorGetUnit @ 0x1C00147A4
 * Callers:
 ...
 *     RaidAdapterFindZombieUnit @ 0x1C0014C08 (RaidAdapterFindZombieUnit.c)
...
__int64 __fastcall RaidBusEnumeratorGetUnit(__int64 *a1, unsigned int a2, __int64 a3)
{
  ...
  if ( (int)result >= 0 )
  {
    ...
    if ( ZombieUnit )
    {
      Unit = ZombieUnit & -(__int64)((*(_BYTE *)(ZombieUnit + 160) & 4) != 0);
      v13 = Unit;
      if ( Unit )
        goto LABEL_7;
    }
