/*
 * XREFs of StorpTelemetryLogUnitErrorDataMeasures @ 0x1C000DDD4
 * Callers:
  ...
  if ( (unsigned int)dword_1C0061058 > 5 )
  {
    if ( TlgKeywordOn((TraceLoggingHProvider)a1, 0x400000000000uLL) )
    {
      ...
      *(_QWORD *)&hProvider.LevelPlus1 = g_SystemUptime_s;
      ...
      v63 = 2LL;
      v65[1] = 0;
      TlgWrite(&hProvider, &unk_1C00576C1, v11, v12, 0x1Au, (EVENT_DATA_DESCRIPTOR *)&hProvider.ProviderMetadataPtr);
    }
  }
}
