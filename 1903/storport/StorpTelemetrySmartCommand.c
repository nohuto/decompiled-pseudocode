/*
 * XREFs of StorpTelemetrySmartCommand @ 0x1C0002CB8
 * Callers:
...
NTSTATUS __fastcall StorpTelemetrySmartCommand(__int64 a1, char a2, unsigned int *a3)
{
  __int64 v6; // rcx
  char *v7; // rcx
  PIRP v8; // rax
  ...
  *(_DWORD *)(v7 + 5) = -1035010047;
  ...
  if ( result >= 0 && (IoStatusBlock.Information < 0x2C || *a3 != 28 || a3[6] < 0x10) )
    return -1073741637;
  return result;
}
