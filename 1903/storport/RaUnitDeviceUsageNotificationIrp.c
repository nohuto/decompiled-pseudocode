/*
 * XREFs of RaUnitDeviceUsageNotificationIrp @ 0x1C0015F54
 * Callers:
 ...
 *     RaidSecondaryDumpRegister @ 0x1C00230A0 (RaidSecondaryDumpRegister.c)
              ...
              if ( Lock )
              {
                ...
                *(_BYTE *)(v2 + 104) |= 0x80u;
                ...
                if ( (unsigned int)dword_1C0061058 > 5 && TlgKeywordOn(v10, 0x400000000000uLL) )
                {
                  ...
                  TlgWrite(v14, &unk_1C00560DA, v15, v16, 0xBu, &pData);
                }
              }
              else
              {
                *(_BYTE *)(a1 + 162) = v11 & 0xFE;
                *(_BYTE *)(v2 + 104) &= ~0x80u;
