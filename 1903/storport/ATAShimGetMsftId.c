/*
 * XREFs of ATAShimGetMsftId @ 0x1C00505F0
 * Callers:
 *     ATADeviceIdShimStorageDeviceIdCompletionHook @ 0x1C0050580 (ATADeviceIdShimStorageDeviceIdCompletionHook.c)
 * Callees:
 *     __security_check_cookie @ 0x1C00232C0 (__security_check_cookie.c)
 *     RaidAddATADeviceIdMapping @ 0x1C0038DC0 (RaidAddATADeviceIdMapping.c)
 *     RaidCheckATADeviceIdMapping @ 0x1C0039024 (RaidCheckATADeviceIdMapping.c)
 *     RaidSaveATADeviceIdMapping @ 0x1C0039198 (RaidSaveATADeviceIdMapping.c)
 *     TrimString @ 0x1C0050CC0 (TrimString.c)
 */
