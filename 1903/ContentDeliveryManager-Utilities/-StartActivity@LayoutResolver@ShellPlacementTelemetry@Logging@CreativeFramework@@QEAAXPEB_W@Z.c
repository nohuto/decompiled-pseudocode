/*
 * XREFs of ?StartActivity@LayoutResolver@ShellPlacementTelemetry@Logging@CreativeFramework@@QEAAXPEB_W@Z @ 0x1800A04B4
 * Callers:
        ...
        const wchar_t *a2)
{
  ...
  const wchar_t *v18; // [rsp+88h] [rbp+27h]
  ...
  *(_DWORD *)v4 = 1;
    ...
    && (*((_QWORD *)v7 + 3) & 0x400000000000LL) == *((_QWORD *)v7 + 3) )
  {
    ...
    TlgWrite(v8, &unk_18016F1FA, (LPCGUID)(v10 + 8), v11, 5u, &pData);
  }
  if ( !*((_DWORD *)this + 8) )
