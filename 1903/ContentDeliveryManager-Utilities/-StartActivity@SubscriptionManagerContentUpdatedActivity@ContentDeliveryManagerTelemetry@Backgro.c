/*
 * XREFs of ?StartActivity@SubscriptionManagerContentUpdatedActivity@ContentDeliveryManagerTelemetry@Background@ContentDeliveryManager@@QEAAXXZ @ 0x18003D6E0
 * Callers:
        ...
        ContentDeliveryManager::Background::ContentDeliveryManagerTelemetry::SubscriptionManagerContentUpdatedActivity *this)
{
    ...
    && (*((_QWORD *)v2 + 3) & 0x200000000000LL) == *((_QWORD *)v2 + 3) )
  {
    ...
    TlgWrite(v2, &unk_18016C2FF, (LPCGUID)(v3 + 8), v4, 4u, &pData);
  }
  if ( !*((_DWORD *)this + 8) )
