/*
 * XREFs of _lambda_91da0398866e2bc6f1173300c449b4ce_::operator() @ 0x18000E514
 * Callers:
 *     Windows::Internal::COperationLambdaVar_0__lambda_91da0398866e2bc6f1173300c449b4ce__Windows::Internal::CHSTRINGResult_::Run @ 0x1800186C0 (Windows--Internal--COperationLambdaVar_0__lambda_91da0398866e2bc6f1173300c449b4ce__Windows--Inte.c)
 * Callees:
...
LABEL_131:
  ...
  if ( v31 >= 0 )
  {
    ...
    v34 = Microsoft::WRL::Wrappers::HStringReference::HStringReference(&hstringHeader, &off_1800D84F0);
    v35 = v64;
    v64 = 0LL;
    if ( v35 )
