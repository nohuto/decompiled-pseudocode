/*
 * XREFs of ?_Getffld@?$num_get@_WV?$istreambuf_iterator@_WU?$char_traits@_W@std@@@std@@@std@@AEBAHPEADAEAV?$istreambuf_iterator@_WU?$char_traits@_W@std@@@2@1AEAVios_base@2@PEAH@Z @ 0x180092290
 * Callers:
 *     ?do_get@?$num_get@_WV?$istreambuf_iterator@_WU?$char_traits@_W@std@@@std@@@std@@MEBA?AV?$istreambuf_iterator@_WU?$char_traits@_W@std@@@2@V32@0AEAVios_base@2@AEAHAEAO@Z @ 0x1800915C0 (-do_get@-$num_get@_WV-$istreambuf_iterator@_WU-$char_traits@_W@std@@@std@@@std@@MEB_ea_1800915C0.c)
 *     ?do_get@?$num_get@_WV?$istreambuf_iterator@_WU?$char_traits@_W@std@@@std@@@std@@MEBA?AV?$istreambuf_iterator@_WU?$char_traits@_W@std@@@2@V32@0AEAVios_base@2@AEAHAEAN@Z @ 0x1800916B0 (-do_get@-$num_get@_WV-$istreambuf_iterator@_WU-$char_traits@_W@std@@@std@@@std@@MEB_ea_1800916B0.c)
 *     ?do_get@?$num_get@_WV?$istreambuf_iterator@_WU?$char_traits@_W@std@@@std@@@std@@MEBA?AV?$istreambuf_iterator@_WU?$char_traits@_W@std@@@2@V32@0AEAVios_base@2@AEAHAEAM@Z @ 0x1800917A0 (-do_get@-$num_get@_WV-$istreambuf_iterator@_WU-$char_traits@_W@std@@@std@@@std@@MEB_ea_1800917A0.c)
 * Callees:
        ...
        __int64 a6)
{
  ...
  if ( (*(_DWORD *)(a5 + 24) & 0x3000) == 0x3000 )
    return std::num_get<wchar_t,std::istreambuf_iterator<wchar_t>>::_Getffldx(
             a1,
             (_DWORD)a2,
             (_DWORD)a3,
             (_DWORD)a4,
  ...
  v11 = std::use_facet<std::numpunct<wchar_t>>(&v70);
  v70 = v11;
  if ( v10 )
  {
  ...
  v16 = std::use_facet<std::ctype<wchar_t>>(&v68);
  if ( v15 )
  {
...
LABEL_65:
          ...
          std::string::append((char *)v74, 1uLL, 0);
          ++v23;
        }
        else
        {
...
LABEL_46:
        std::istreambuf_iterator<unsigned short>::_Inc(a3);
        if ( std::istreambuf_iterator<wchar_t>::equal(a3, v69) )
          goto LABEL_47;
      }
    }
    while ( 1 )
