/*
 * XREFs of ?InstallAppByStoreId@Actions@CreativeFramework@@YAXPEB_W0_N1110000@Z @ 0x180082998
 * Callers:
 ...
 *     ?ParseStoreId@StoreHelpers@CreativeFramework@@YAJPEAUHSTRING__@@PEAPEAU3@1@Z @ 0x180081F78 (-ParseStoreId@StoreHelpers@CreativeFramework@@YAJPEAUHSTRING__@@PEAPEAU3@1@Z.c)
        ...
        const wchar_t *a10)
{
  ...
  __int64 v19; // rbx
  __int64 (__fastcall *v20)(__int64, PVOID, __int64, PVOID, PVOID, PVOID, PVOID, _QWORD); // r15
  HSTRING_HEADER *v21; // r14
  HSTRING_HEADER *v22; // rsi
  ...
  HSTRING v29; // [rsp+58h] [rbp-A8h] BYREF
  ...
  if ( !a4 )
  {
    ...
    WindowsDeleteString(0LL);
    v29 = 0LL;
    v17 = CreativeFramework::StoreHelpers::ParseStoreId((HSTRING)v15[1].Reserved.Reserved1, &v29, &string, v16);
    v18 = retaddr;
    if ( v17 < 0 )
    {
LABEL_15:
      ...
      JUMPOUT(0x180082C35LL);
    }
    StringRawBuffer = WindowsGetStringRawBuffer(string, 0LL);
    v36 = WindowsGetStringRawBuffer(v29, 0LL);
    v31 = v30;
    if ( v30 )
  ...
  v19 = v30;
  v20 = *(__int64 (__fastcall **)(__int64, PVOID, __int64, PVOID, PVOID, PVOID, PVOID, _QWORD))(*(_QWORD *)v30 + 112LL);
  v21 = Microsoft::WRL::Wrappers::HStringReference::HStringReference(&v40, &v37);
  v22 = Microsoft::WRL::Wrappers::HStringReference::HStringReference(&v41, &v38);
  v23 = Microsoft::WRL::Wrappers::HStringReference::HStringReference(&v42, v39);
