/*
 * XREFs of ?Revert@NotificationManagerService@Actions@CreativeFramework@@UEAAXXZ @ 0x180090BE0
 * Callers:
 *     <none>
 * Callees:
        ...
        CreativeFramework::Actions::NotificationManagerService *this)
{
  ...
  __int64 v5; // rbx
  __int64 (__fastcall *v6)(__int64, PVOID, PVOID); // r14
  const WCHAR *v7; // rax
...
LABEL_13:
  ...
  if ( *((_QWORD *)this + 13) >= 8uLL )
    v7 = *(const WCHAR **)v7;
  v13 = v7;
  v8 = Microsoft::WRL::Wrappers::HStringReference::HStringReference(&v15, &v13);
  v9 = (const WCHAR *)((char *)this + 48);
  if ( *((_QWORD *)this + 9) >= 8uLL )
    v9 = *(const WCHAR **)v9;
  v13 = v9;
  v10 = Microsoft::WRL::Wrappers::HStringReference::HStringReference(&v16, &v13);
  v11 = v6(v5, v10[1].Reserved.Reserved1, v8[1].Reserved.Reserved1);
  if ( v11 < 0 )
  {
    wil::details::in1diag3::Throw_Hr(
      retaddr,
