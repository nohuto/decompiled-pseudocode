...
void **__fastcall std::map<std::wstring,std::shared_ptr<CreativeFramework::CommonHelper::ISettingsContainer>,CreativeFramework::CommonHelper::Details::less,std::allocator<std::pair<std::wstring const,std::shared_ptr<CreativeFramework::CommonHelper::ISettingsContainer>>>>::operator[](
        void ***a1,
        void **a2)
{
  void **v4; // rbx
  __int64 v5; // rcx
  __int64 v6; // rax
  void **v8; // [rsp+38h] [rbp-39h] BYREF
  __int128 v9; // [rsp+40h] [rbp-31h] BYREF
  __int64 v10; // [rsp+50h] [rbp-21h]
  __int64 v11; // [rsp+58h] [rbp-19h]
  __int64 v12; // [rsp+60h] [rbp-11h]
  void *v13[2]; // [rsp+68h] [rbp-9h] BYREF
  ...
  v10 = 0LL;
  LOWORD(v9) = 0;
  std::wstring::assign((void **)&v9, v4 + 4, 0LL, 0xFFFFFFFFFFFFFFFFuLL);
  v15 = 7LL;
  v14 = 0LL;
  LOWORD(v13[0]) = 0;
  std::wstring::assign(v13, a2, 0LL, 0xFFFFFFFFFFFFFFFFuLL);
  if ( CreativeFramework::CommonHelper::Details::less::operator()(v5, (__int64)v13, (const WCHAR *)&v9) )
  {
LABEL_3:
    v9 = 0LL;
    v15 = 7LL;
    ...
    v16 = 0LL;
    v9 = 0uLL;
    v6 = std::_Tree_buy<std::pair<std::wstring const,std::shared_ptr<CreativeFramework::CommonHelper::ISettingsContainer>>>::_Buynode<std::pair<std::wstring,std::shared_ptr<CreativeFramework::CommonHelper::ISettingsContainer>>>(
           a1,
           v13);
    std::_Tree<std::_Tmap_traits<std::wstring,std::shared_ptr<CreativeFramework::CommonHelper::ISettingsContainer>,CreativeFramework::CommonHelper::Details::less,std::allocator<std::pair<std::wstring const,std::shared_ptr<CreativeFramework::CommonHelper::ISettingsContainer>>>,0>>::_Insert_hint<std::pair<std::wstring const,std::shared_ptr<CreativeFramework::CommonHelper::ISettingsContainer>> &,std::_Tree_node<std::pair<std::wstring const,std::shared_ptr<CreativeFramework::CommonHelper::ISettingsContainer>>,void *> *>(
      (_DWORD)a1,
      (unsigned int)&v8,
      (_DWORD)v4,
      v6 + 32,
      v6);
    v4 = v8;
    std::pair<std::wstring const,std::shared_ptr<CreativeFramework::CommonHelper::ISettingsContainer>>::~pair<std::wstring const,std::shared_ptr<CreativeFramework::CommonHelper::ISettingsContainer>>((__int64)v13);
  }
  return v4 + 8;
}
