/*
 * XREFs of ??$TriggerRegistrationCompleted@AEAPEB_WAEAPEB_WAEAPEB_WAEAPEB_WAEAPEB_WAEAPEB_W@TriggerManagerRegisterActivity@ContentDeliveryManagerTelemetry@Background@ContentDeliveryManager@@SAXAEAPEB_W00000PEBD@Z @ 0x180068B60
 * Callers:
        ...
        const unsigned __int16 *a7)
{
  ...
  if ( *(_DWORD *)v11 > 5u )
  {
      ...
      && (*((_QWORD *)v12 + 3) & 0x400000000000LL) == *((_QWORD *)v12 + 3) )
    {
      ...
      v45 = v15 + 1;
      v44 = v23;
      LODWORD(v11) = TlgWrite(v12, &unk_18016DE77, 0LL, 0LL, 9u, &pData);
    }
  }
  return (int)v11;
}
