/*
 * XREFs of ?StopActivity@TriggerManagerRegisterActivity@ContentDeliveryManagerTelemetry@Background@ContentDeliveryManager@@MEAAXXZ @ 0x1800619D0
 * Callers:
 *     <none>
 * Callees:
...
void __fastcall ContentDeliveryManager::Background::ContentDeliveryManagerTelemetry::TriggerManagerRegisterActivity::StopActivity(
  ...
  if ( v4 )
  {
    ...
    **((_DWORD **)this + 6) = 2;
    ...
    if ( *(_DWORD *)v6 > 5u )
    {
      ...
      v87 = v10 + 1;
      v88 = 0;
      TlgWrite(v6, &unk_18016E0C5, (LPCGUID)(*((_QWORD *)this + 6) + 8LL), 0LL, 0x15u, &pData);
    }
  }
  else
  {
    ...
    **((_DWORD **)this + 6) = 2;
    ...
    if ( *(_DWORD *)v27 > 5u )
    {
      ...
      v33 = CurrentThreadId;
      v94 = &v33;
      TlgWrite(v27, &unk_18016DEEF, (LPCGUID)(*((_QWORD *)this + 6) + 8LL), 0LL, 5u, &v89);
    }
  }
  if ( *((_DWORD *)this + 8) )
  {
