...
wchar_t *__fastcall CreativeFramework::TargetedContentLayoutHelpers::Tile::Tile(wchar_t *this, wchar_t *a2)
{
  ...
  *this = 0;
  ...
  std::wstring::assign(String, (char *)a2, v3);
  v5 = std::wstring::find((char *)String, L"!", 0LL, asc_18010AE04[0] != 0);
  *((_BYTE *)this + 48) = 0;
  if ( this != String )
