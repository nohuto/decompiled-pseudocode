/*
 * XREFs of ?Stop@SubscriptionManagerContentUpdatedActivity@ContentDeliveryManagerTelemetry@Background@ContentDeliveryManager@@QEAAXIIII@Z @ 0x18003D7FC
 * Callers:
  ...
  if ( v6 )
  {
    ...
    **((_DWORD **)this + 6) = 2;
      ...
      && (*((_QWORD *)v8 + 3) & 0x200000000000LL) == *((_QWORD *)v8 + 3) )
    {
      ...
      v84 = 4LL;
      v86 = 4LL;
      TlgWrite(v9, &unk_18016BE8D, (LPCGUID)(*((_QWORD *)this + 6) + 8LL), 0LL, 0x16u, &pData);
    }
  }
  else
  {
    ...
    **((_DWORD **)this + 6) = 2;
      ...
      && (*((_QWORD *)v28 + 3) & 0x200000000000LL) == *((_QWORD *)v28 + 3) )
    {
      ...
      v52 = 4LL;
      v54 = 4LL;
      TlgWrite(v29, &unk_18016C207, (LPCGUID)(*((_QWORD *)this + 6) + 8LL), 0LL, 9u, &pData);
    }
  }
