/*
 * XREFs of ?do_put@?$money_put@DV?$ostreambuf_iterator@DU?$char_traits@D@std@@@std@@@std@@MEBA?AV?$ostreambuf_iterator@DU?$char_traits@D@std@@@2@V32@_NAEAVios_base@2@DO@Z @ 0x1800C93C0
 * Callers:
 *     <none>
 * Callees:
        ...
        double a7)
{
  ...
  if ( v11 >= 0 )
  {
    ...
    (*(void (__fastcall **)(_QWORD, char *, char *, void **))(*(_QWORD *)v22[1] + 56LL))(
      ...
      &Buffer[v12],
      v19);
    std::string::append((char *)v25, i, v18);
    v24[3] = (void *)15;
    v24[2] = 0LL;
    LOBYTE(v24[0]) = 0;
