/*
 * XREFs of ?what@ResultException@wil@@UEBAPEBDXZ @ 0x180002710
 * Callers:
 *     <none>
 * Callees:
 *     ?GetFailureLogString@wil@@YAJPEAG_KAEBUFailureInfo@1@@Z @ 0x180001C7C (-GetFailureLogString@wil@@YAJPEAG_KAEBUFailureInfo@1@@Z.c)
 *     ?create@shared_buffer@details@wil@@QEAA_NPEBX_K@Z @ 0x180001EDC (-create@shared_buffer@details@wil@@QEAA_NPEBX_K@Z.c)
