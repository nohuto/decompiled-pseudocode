/*
 * XREFs of _lambda_c61fab55ebd7ca4a424d2b4e7316a3f3_::__lambda_c61fab55ebd7ca4a424d2b4e7316a3f3_ @ 0x180073154
 * Callers:
 *     _Windows::Services::TargetedContent::Internal::GetTriggerStateTransitionsFromSetting_::_1_::dtor$2 @ 0x1800D0CAE (_Windows--Services--TargetedContent--Internal--GetTriggerStateTransitionsFromSettin_ea_1800D0CAE.c)
 *     _Windows::Services::TargetedContent::Internal::GetTriggeredRegistration_::_1_::dtor$2 @ 0x1800D0D95 (_Windows--Services--TargetedContent--Internal--GetTriggeredRegistration_--_1_--dtor$2.c)
 * Callees:
