/*
 * XREFs of _CRT_INIT @ 0x1800CA40C
 * Callers:
 *     __DllMainCRTStartup @ 0x1800CA694 (__DllMainCRTStartup.c)
 * Callees:
 *     _amsg_exit_0 @ 0x1800CB1F5 (_amsg_exit_0.c)
 *     _IsNonwritableInCurrentImage @ 0x1800CB260 (_IsNonwritableInCurrentImage.c)
 *     _initterm_0 @ 0x1800CB3CE (_initterm_0.c)
