/*
 * XREFs of ?Stop@?$ActivityBase@VCDMUtilsUnlockLogging@@$00$0A@$04$0A@U_TlgReflectorTag_Param0IsProviderType@@@wil@@QEAAXJ@Z @ 0x18007EC58
 * Callers:
...
int __fastcall wil::ActivityBase<CDMUtilsUnlockLogging,1,0,5,0,_TlgReflectorTag_Param0IsProviderType>::Stop(
        CDMUtilsUnlockTelemetry::ExtendedExecutionRequested *this)
{
  ...
  *(_DWORD *)(v2 + 72) = v5;
  ...
  {
    LODWORD(v6) = wil::ActivityBase<CDMUtilsUnlockLogging,1,0,5,0,_TlgReflectorTag_Param0IsProviderType>::ReportStopActivity(this);
  }
  if ( *((_DWORD *)this + 8) )
  {
    v9 = (CDMUtilsUnlockTelemetry::ExtendedExecutionRequested *)((char *)this + 8);
