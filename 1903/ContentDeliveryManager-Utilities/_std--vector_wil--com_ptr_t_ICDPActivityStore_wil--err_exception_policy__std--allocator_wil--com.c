/*
 * XREFs of _std::vector_wil::com_ptr_t_ICDPActivityStore_wil::err_exception_policy__std::allocator_wil::com_ptr_t_ICDPActivityStore_wil::err_exception_policy_____::_Reallocate_::_1_::catch$0 @ 0x1800CEF30
 * Callers:
 *     <none>
 * Callees:
