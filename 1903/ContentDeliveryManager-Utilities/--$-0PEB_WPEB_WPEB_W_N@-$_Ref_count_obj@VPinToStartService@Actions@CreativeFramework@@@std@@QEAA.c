/*
 * XREFs of ??$?0PEB_WPEB_WPEB_W_N@?$_Ref_count_obj@VPinToStartService@Actions@CreativeFramework@@@std@@QEAA@$$QEAPEB_W00$$QEA_N@Z @ 0x180089C54
 * Callers:
 *     ??$make_shared@VPinToStartService@Actions@CreativeFramework@@PEB_WPEB_WPEB_W_N@std@@YA?AV?$shared_ptr@VPinToStartService@Actions@CreativeFramework@@@0@$$QEAPEB_W00$$QEA_N@Z @ 0x180088C88 (--$make_shared@VPinToStartService@Actions@CreativeFramework@@PEB_WPEB_WPEB_W_N@std@@YA-AV-$share.c)
 * Callees:
        ...
        char *a5)
{
  ...
  *(_WORD *)v11 = 0;
  ...
  std::wstring::assign(v11, v10, v14);
  *(_QWORD *)(v6 + 64) = 7LL;
  *(_QWORD *)(v6 + 56) = 0LL;
  *(_WORD *)(v6 + 40) = 0;
  if ( *(_WORD *)v9 )
  ...
  std::wstring::assign((_QWORD *)(v6 + 40), v9, v15);
  *(_QWORD *)(v6 + 96) = 7LL;
  *(_QWORD *)(v6 + 88) = 0LL;
  *(_WORD *)(v6 + 72) = 0;
  if ( *(_WORD *)v8 )
  ...
  std::wstring::assign((_QWORD *)(v6 + 72), v8, v12);
  *(_BYTE *)(v6 + 104) = v7;
  return a1;
}
