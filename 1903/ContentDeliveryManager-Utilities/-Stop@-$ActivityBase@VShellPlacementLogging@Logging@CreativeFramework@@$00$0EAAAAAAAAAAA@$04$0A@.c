/*
 * XREFs of ?Stop@?$ActivityBase@VShellPlacementLogging@Logging@CreativeFramework@@$00$0EAAAAAAAAAAA@$04$0A@U_TlgReflectorTag_Param0IsProviderType@@@wil@@QEAAXJ@Z @ 0x1800A44DC
 * Callers:
  ...
  *(_DWORD *)(v4 + 72) = v7;
  ...
  if ( v7 )
  {
      ...
      && (*((_QWORD *)v8 + 3) & 0x400000000000LL) == *((_QWORD *)v8 + 3) )
    {
      ...
      p_SRWLock = &SRWLock;
      v25 = 4;
      TlgWrite(v8, &unk_18016D057, (LPCGUID)(*((_QWORD *)this + 6) + 8LL), 0LL, 5u, &pData);
    }
  }
  else
  {
