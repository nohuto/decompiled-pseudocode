/*
 * XREFs of ?Stop@DiagTrackRuleSetHandlerAddRule@ContentDeliveryManagerTelemetry@Background@ContentDeliveryManager@@QEAAXPEBD@Z @ 0x180078E84
 * Callers:
  ...
  if ( v6 )
  {
    ...
    **((_DWORD **)this + 6) = 2;
    ...
    if ( *(_DWORD *)v8 > 5u )
    {
      ...
      v93 = a2;
      v94 = v11 + 1;
      TlgWrite(v8, &unk_18016EA75, (LPCGUID)(*((_QWORD *)this + 6) + 8LL), 0LL, 0x16u, &pData);
    }
  }
  else
  {
    ...
    **((_DWORD **)this + 6) = 2;
    ...
    if ( *(_DWORD *)v30 > 5u )
    {
      ...
      if ( !a2 )
        a2 = (const char *)&word_1800FD1E0;
      v103 = a2;
      TlgWrite(v30, &unk_18016E67F, (LPCGUID)(*((_QWORD *)this + 6) + 8LL), 0LL, 6u, &v96);
    }
  }
  if ( *((_DWORD *)this + 8) )
  {
