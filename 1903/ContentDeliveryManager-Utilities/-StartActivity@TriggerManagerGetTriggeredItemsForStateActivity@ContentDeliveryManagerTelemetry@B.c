/*
 * XREFs of ?StartActivity@TriggerManagerGetTriggeredItemsForStateActivity@ContentDeliveryManagerTelemetry@Background@ContentDeliveryManager@@QEAAXPEB_W0PEBD@Z @ 0x180063614
 * Callers:
        ...
        const char *a4)
{
  ...
  *(_DWORD *)v8 = 1;
  ...
  if ( *(_DWORD *)v12 > 5u )
  {
    ...
    TlgWrite(v12, &unk_18016DDF4, (LPCGUID)(v19 + 8), v20, 7u, &pData);
  }
  if ( !*((_DWORD *)this + 8) )
