/*
 * XREFs of ?GetPackageFullNameFromProcess@CallerIdentity@@YAJPEAXPEAPEAG@Z @ 0x180054E54
 * Callers:
 ...
 * Callees:
 *     ?CoAllocStringLen@@YAJPEBG_KPEAPEAG@Z @ 0x180054D64 (-CoAllocStringLen@@YAJPEBG_KPEAPEAG@Z.c)
 */
