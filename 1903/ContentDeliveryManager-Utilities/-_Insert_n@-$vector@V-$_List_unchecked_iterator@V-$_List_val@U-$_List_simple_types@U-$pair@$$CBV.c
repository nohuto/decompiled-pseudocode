        ...
        void **a5)
{
  ...
  if ( a4 )
  {
    ...
    {
      v20 = *a5;
      if ( (v10 - (__int64)a3) >> 3 >= a4 )
      {
        v24 = 8 * a4;
        v25 = (char *)(v10 - 8 * a4);
        a1[1] = std::_Uninit_move<std::_List_unchecked_const_iterator<std::_List_val<std::_List_simple_types<std::wstring>>,std::_Iterator_base0> *,std::_List_unchecked_const_iterator<std::_List_val<std::_List_simple_types<std::wstring>>,std::_Iterator_base0> *,std::_Wrap_alloc<std::allocator<std::_List_unchecked_const_iterator<std::_List_val<std::_List_simple_types<std::wstring>>,std::_Iterator_base0>>>,std::_List_unchecked_const_iterator<std::_List_val<std::_List_simple_types<std::wstring>>,std::_Iterator_base0>>(
                  v25,
                  v10,
                  a1[1]);
        while ( v25 != a3 )
        {
          v25 -= 8;
          *(_QWORD *)&v25[v24] = *(_QWORD *)v25;
        }
        v22 = (unsigned __int64)(v24 + 7) >> 3;
        v23 = a3 <= &a3[v24];
      }
      else
      {
        ...
        v21 = a1[1];
        a1[1] = v21 + 8 * a4;
        v22 = (v21 - (unsigned __int64)a3 + 7) >> 3;
        v23 = (unsigned __int64)a3 <= v21;
      }
      if ( !v23 )
        v22 = 0LL;
      if ( v22 )
        memset64(a3, (unsigned __int64)v20, v22);
    }
    else
    {
      v11 = (v10 - *a1) >> 3;
      ...
      if ( v12 )
      {
        if ( v12 > 0x1FFFFFFFFFFFFFFFLL || (v15 = (char *)operator new(8 * v12), (v27 = v15) == 0LL) )
          std::_Xbad_alloc();
      }
      v16 = (__int64)&a3[-*a1] >> 3;
      try
