/*
 * XREFs of ??1?$_Temp_iterator@V?$shared_ptr@UItem@TargetedContentLayoutHelpers@CreativeFramework@@@std@@@std@@QEAA@XZ @ 0x1800A6C00
 * Callers:
 ...
 *     _CreativeFramework::TargetedContentLayoutHelpers::SortAndValidateLists_::_1_::dtor$3 @ 0x1800D493D (_CreativeFramework--TargetedContentLayoutHelpers--SortAndValidateLists_--_1_--dtor$3.c)
 * Callees:
