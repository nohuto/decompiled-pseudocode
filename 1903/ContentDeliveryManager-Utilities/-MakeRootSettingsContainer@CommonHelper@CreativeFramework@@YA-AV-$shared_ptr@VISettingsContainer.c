/*
 * XREFs of ?MakeRootSettingsContainer@CommonHelper@CreativeFramework@@YA?AV?$shared_ptr@VISettingsContainer@CommonHelper@CreativeFramework@@@std@@XZ @ 0x1800AD81C
 * Callers:
...
__int64 *__fastcall CreativeFramework::CommonHelper::MakeRootSettingsContainer(__int64 *a1)
{
  ...
  v4 = *v10;
  v11 = 0LL;
  v5 = (*(__int64 (__fastcall **)(__int64 *, __int64 **))(v4 + 48))(v10, &v11);
  v6 = retaddr;
  if ( v5 < 0 )
  {
LABEL_15:
    ...
    JUMPOUT(0x1800AD9BALL);
  }
  v12[0] = 0LL;
  v7 = *v11;
  v12[0] = 0LL;
  v8 = (*(__int64 (__fastcall **)(__int64 *, _QWORD *))(v7 + 80))(v11, v12);
  if ( v8 < 0 )
  {
    wil::details::in1diag3::Throw_Hr(
      retaddr,
...
LABEL_14:
  ...
  CreativeFramework::CommonHelper::MakeSettingsContainer(a1, v12[0]);
  if ( v12[0] )
