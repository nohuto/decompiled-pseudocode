/*
 * XREFs of ?Stop@TriggerManagerRegisterActivity@ContentDeliveryManagerTelemetry@Background@ContentDeliveryManager@@QEAAX_NPEBD@Z @ 0x180062000
 * Callers:
  ...
  if ( v8 )
  {
    ...
    **((_DWORD **)this + 6) = 2;
    ...
    if ( *(_DWORD *)v10 > 5u )
    {
      ...
      v98 = a3;
      v99 = v13 + 1;
      TlgWrite(v10, &unk_18016DF4E, (LPCGUID)(*((_QWORD *)this + 6) + 8LL), 0LL, 0x17u, &pData);
    }
  }
  else
  {
    ...
    **((_DWORD **)this + 6) = 2;
    ...
    if ( *(_DWORD *)v32 > 5u )
    {
      ...
      if ( !a3 )
        a3 = (const char *)&word_1800FD1E0;
      v110 = a3;
      TlgWrite(v32, &unk_18016DD77, (LPCGUID)(*((_QWORD *)this + 6) + 8LL), 0LL, 7u, &v101);
    }
  }
  if ( *((_DWORD *)this + 8) )
  {
