/*
 * XREFs of ?EnsureMrtResourceMapInitialized@ToastHelpers@NotificationManager@CreativeFramework@@AEAAXXZ @ 0x18009BF8C
 * Callers:
        ...
        CreativeFramework::NotificationManager::ToastHelpers *this)
{
  ...
  int v29; // eax
  LPVOID v30; // rbx
  __int64 (__fastcall *v31)(LPVOID, GUID *, char *); // r14
  __int64 v32; // rcx
  int v33; // eax
  LPVOID v34; // rbx
  ...
  __int64 v43; // [rsp+60h] [rbp-11h] BYREF
  __int64 v44; // [rsp+68h] [rbp-9h] BYREF
  int v45; // [rsp+70h] [rbp-1h] BYREF
  ...
  v43 = 0LL;
  ActivationFactory = RoGetActivationFactory(string, &GUID_86f5b0ee_9560_4d76_a06a_ca4c8bfe4426, &v43);
  v4 = retaddr;
  if ( ActivationFactory < 0 )
    goto LABEL_36;
  v42 = 0LL;
  v5 = v43;
  v6 = *(__int64 (__fastcall **)(__int64, _QWORD, __int64 *))(*(_QWORD *)v43 + 128LL);
...
LABEL_39:
  ...
  v11 = RoGetActivationFactory(
          *(_QWORD *)&hstringHeader.Reserved.Reserved2[16],
          &GUID_4408fb32_c420_41c5_b6c1_edce489bb84d,
          &v41);
  v12 = retaddr;
  if ( v11 < 0 )
  {
...
LABEL_41:
  ...
  v13 = *v41;
  v40 = 0LL;
  v14 = (*(__int64 (__fastcall **)(__int64 *, __int64, __int64 **))(v13 + 208))(v41, v42, &v40);
  v15 = retaddr;
  if ( v14 < 0 )
    goto LABEL_41;
  v16 = (*(__int64 (__fastcall **)(__int64 *, int *))(*v40 + 56))(v40, &v45);
  if ( v16 < 0 )
  {
    wil::details::in1diag3::Throw_Hr(
      retaddr,
  ...
  v17 = *v40;
  v44 = 0LL;
  v18 = (*(__int64 (__fastcall **)(__int64 *, _QWORD, __int64 *))(v17 + 48))(v40, 0LL, &v44);
  v19 = retaddr;
  if ( v18 < 0 )
  {
LABEL_44:
  ...
  v39 = 0LL;
  v20 = v44;
  v21 = *(__int64 (__fastcall **)(__int64, HSTRING *))(*(_QWORD *)v44 + 176LL);
