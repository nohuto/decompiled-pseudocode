/*
 * XREFs of ??1UtcWrapperBase@Diagnostics@Microsoft@@UEAA@XZ @ 0x1800A8E84
 * Callers:
 *     ??_EUtcWrapperBase@Diagnostics@Microsoft@@UEAAPEAXI@Z @ 0x1800175D0 (--_EUtcWrapperBase@Diagnostics@Microsoft@@UEAAPEAXI@Z.c)
 * Callees:
 *     <none>
 */
