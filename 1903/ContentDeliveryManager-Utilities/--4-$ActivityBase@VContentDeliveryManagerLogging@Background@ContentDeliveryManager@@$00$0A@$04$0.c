/*
 * XREFs of ??4?$ActivityBase@VContentDeliveryManagerLogging@Background@ContentDeliveryManager@@$00$0A@$04$0A@U_TlgReflectorTag_Param0IsProviderType@@@wil@@QEAAAEAV01@AEBV01@@Z @ 0x1800672B4
 * Callers:
        ...
        _QWORD *a2)
{
  ...
  else
  {
    ...
    if ( v11 )
    {
      ...
      *(_QWORD *)(a1 + 304) = v11;
      *(_QWORD *)(a1 + 48) = (unsigned __int64)(v11 + 2) & -(__int64)(v11 != 0LL);
