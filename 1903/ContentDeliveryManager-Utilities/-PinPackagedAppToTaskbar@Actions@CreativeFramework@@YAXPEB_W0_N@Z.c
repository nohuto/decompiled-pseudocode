/*
 * XREFs of ?PinPackagedAppToTaskbar@Actions@CreativeFramework@@YAXPEB_W0_N@Z @ 0x18008F730
 * Callers:
 ...
 *     ?PinApp@Actions@CreativeFramework@@YAXPEB_W_N01@Z @ 0x18008F590 (-PinApp@Actions@CreativeFramework@@YAXPEB_W_N01@Z.c)
