/*
 * XREFs of ?StartActivity@CreativeEventActivity@ShellPlacementTelemetry@Logging@CreativeFramework@@QEAAXPEBG0I@Z @ 0x1800253B4
 * Callers:
        ...
        int a4)
{
  ...
  *(_DWORD *)v7 = 1;
  ...
  if ( *(_DWORD *)v11 > 5u )
  {
    ...
    TlgWrite(v11, &unk_18016BB06, (LPCGUID)(v15 + 8), v16, 7u, &pData);
  }
  if ( !*((_DWORD *)this + 8) )
