/*
 * XREFs of ?Stop@?$ActivityBase@VShellPlacementLogging@Logging@CreativeFramework@@$00$0CAAAAAAAAAAA@$04$0A@U_TlgReflectorTag_Param0IsProviderType@@@wil@@QEAAXJ@Z @ 0x18002E6CC
 * Callers:
  ...
  if ( v5 )
  {
    ...
    if ( *(_DWORD *)v6 > 5u )
    {
        ...
        && (*((_QWORD *)v7 + 3) & 0x200000000000LL) == *((_QWORD *)v7 + 3) )
      {
        ...
        p_SRWLock = &SRWLock;
        v24 = 4;
        LODWORD(v6) = TlgWrite(v7, &unk_18016B127, (LPCGUID)(*(_QWORD *)(a1 + 48) + 8LL), 0LL, 5u, &pData);
      }
    }
  }
  else
