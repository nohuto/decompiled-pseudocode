/*
 * XREFs of ?StartActivity@SendAppServiceMessageActivity@ShellPlacementTelemetry@Logging@CreativeFramework@@QEAAXW4TriggerId@Triggers@4@@Z @ 0x1800260F4
 * Callers:
        ...
        int a2)
{
  ...
  *(_DWORD *)v4 = 1;
    ...
    && (*((_QWORD *)v7 + 3) & 0x200000000000LL) == *((_QWORD *)v7 + 3) )
  {
    ...
    TlgWrite(v8, &unk_18016B0C7, (LPCGUID)(v10 + 8), v11, 5u, &pData);
  }
  if ( !*(_DWORD *)(a1 + 32) )
