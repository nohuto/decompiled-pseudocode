/*
 * XREFs of _Wcscoll @ 0x1800CA078
 * Callers:
 *     ?do_compare@?$collate@_W@std@@MEBAHPEB_W000@Z @ 0x1800C0A50 (-do_compare@-$collate@_W@std@@MEBAHPEB_W000@Z.c)
 * Callees:
 *     _GetLocaleHandleByColl @ 0x1800B74DC (_GetLocaleHandleByColl.c)
 *     _GetLocaleHandleById @ 0x1800B74E8 (_GetLocaleHandleById.c)
 *     __crtCompareStringW_Stub @ 0x1800B7578 (__crtCompareStringW_Stub.c)
 */
