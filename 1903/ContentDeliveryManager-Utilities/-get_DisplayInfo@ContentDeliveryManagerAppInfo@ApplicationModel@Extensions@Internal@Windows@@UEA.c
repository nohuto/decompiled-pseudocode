/*
 * XREFs of ?get_DisplayInfo@ContentDeliveryManagerAppInfo@ApplicationModel@Extensions@Internal@Windows@@UEAAJPEAPEAUIAppDisplayInfo@25@@Z @ 0x18009E460
 * Callers:
 *     <none>
 * Callees:
        ...
        const char *a4)
{
  ...
  try
  {
    v4 = (struct Windows::ApplicationModel::IAppDisplayInfo *)*((_QWORD *)this + 10);
    if ( v4 )
    {
      *a2 = v4;
