/*
 * XREFs of ?GetCachedFeatureEnabledState@?$Feature@U__WilFeatureTraits_Feature_SilentInstalledApps@@@wil@@CA?AW4wil_details_CachedFeatureEnabledState@@_N@Z @ 0x180034DB0
 * Callers:
 *     ?IsEnabled@?$Feature@U__WilFeatureTraits_Feature_SilentInstalledApps@@@wil@@SA_NXZ @ 0x18002DD90 (-IsEnabled@-$Feature@U__WilFeatureTraits_Feature_SilentInstalledApps@@@wil@@SA_NXZ.c)
 * Callees:
