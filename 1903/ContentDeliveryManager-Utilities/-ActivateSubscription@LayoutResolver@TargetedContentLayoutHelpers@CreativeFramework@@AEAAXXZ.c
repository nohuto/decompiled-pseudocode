/*
 * XREFs of ?ActivateSubscription@LayoutResolver@TargetedContentLayoutHelpers@CreativeFramework@@AEAAXXZ @ 0x1800A2734
 * Callers:
 ...
 *     ??$WaitForCompletion@PEAU?$IAsyncOperation@PEAVTargetedContentSubscription@TargetedContent@Services@Windows@@@Foundation@Windows@@@details@wil@@YAJPEAU?$IAsyncOperation@PEAVTargetedContentSubscription@TargetedContent@Services@Windows@@@Foundation@Windows@@W4tagCOWAIT_FLAGS@@KPEA_N@Z @ 0x1800A54BC (--$WaitForCompletion@PEAU-$IAsyncOperation@PEAVTargetedContentSubscription@TargetedContent@Servi.c)
        ...
        CreativeFramework::TargetedContentLayoutHelpers::LayoutResolver *this)
{
  ...
  HSTRING_HEADER v16; // [rsp+48h] [rbp-30h] BYREF
  wil::details::in1diag3 *retaddr; // [rsp+78h] [rbp+0h]

  v15[1] = -2LL;
  v13 = L"Windows.Services.TargetedContent.TargetedContentSubscription";
  v14 = 0LL;
  v1 = Microsoft::WRL::Wrappers::HStringReference::HStringReference(&v16, &v13);
  try
  {
    v2 = v1;
    v3 = v14;
    ...
    ActivationFactory = RoGetActivationFactory(
                          ...
                          &GUID_faddfe80_360d_4916_b53c_7ea27090d02a,
                          &v14);
