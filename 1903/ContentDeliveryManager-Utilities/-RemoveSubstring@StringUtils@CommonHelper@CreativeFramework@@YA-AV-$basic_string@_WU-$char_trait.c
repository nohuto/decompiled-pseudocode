/*
 * XREFs of ?RemoveSubstring@StringUtils@CommonHelper@CreativeFramework@@YA?AV?$basic_string@_WU?$char_traits@_W@std@@V?$allocator@_W@2@@std@@PEB_W0@Z @ 0x1800A9174
 * Callers:
 ...
 * Callees:
 *     ?erase@?$basic_string@_WU?$char_traits@_W@std@@V?$allocator@_W@2@@std@@QEAAAEAV12@_K0@Z @ 0x1800332F0 (-erase@-$basic_string@_WU-$char_traits@_W@std@@V-$allocator@_W@2@@std@@QEAAAEAV12@_K0@Z.c)
...
char *__fastcall CreativeFramework::CommonHelper::StringUtils::RemoveSubstring(char *a1, char *a2, char *a3)
{
  ...
  *(_WORD *)a1 = 0;
  ...
  v11 = std::wstring::find(a1, v8, 0LL, v15);
  if ( v11 != -1LL )
  {
