/*
 * XREFs of ?IsEnabled@?$Feature@U__WilFeatureTraits_Feature_AppDefaultsEdgeCoinCampaign@@@wil@@SA_NXZ @ 0x18002DE60
 * Callers:
 *     <none>
 * Callees:
 ...
 *     ?GetCachedFeatureEnabledState@?$Feature@U__WilFeatureTraits_Feature_AppDefaultsEdgeCoinCampaign@@@wil@@CA?AW4wil_details_CachedFeatureEnabledState@@_N@Z @ 0x1800350C0 (-GetCachedFeatureEnabledState@-$Feature@U__WilFeatureTraits_Feature_AppDefaultsEdgeCoinCampaign@.c)
 */
