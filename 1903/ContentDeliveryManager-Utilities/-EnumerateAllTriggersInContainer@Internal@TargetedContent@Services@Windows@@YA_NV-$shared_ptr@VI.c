/*
 * XREFs of ?EnumerateAllTriggersInContainer@Internal@TargetedContent@Services@Windows@@YA_NV?$shared_ptr@VISettingsContainer@CommonHelper@CreativeFramework@@@std@@V?$function@$$A6A_NV?$shared_ptr@VISettingsContainer@CommonHelper@CreativeFramework@@@std@@AEAVPropertySetHelper@Triggers@CreativeFramework@@@Z@6@@Z @ 0x180071724
 * Callers:
 ...
 *     ?UpdateTriggerStateIfNeeded@Internal@TargetedContent@Services@Windows@@YAJPEAUHSTRING__@@AEAVsrwlock@wil@@V?$function@$$A6AXPEAUITargetedContentTriggerInternal@Internal@TargetedContent@Services@Windows@@W4TargetedContentTriggerState@2345@1@Z@std@@@Z @ 0x18007501C (-UpdateTriggerStateIfNeeded@Internal@TargetedContent@Services@Windows@@YAJPEAUHSTRING__@@AEAVsrw.c)
 * Callees:
 ...
 *     ??1OutRef@RoVariant@@QEAA@XZ @ 0x180070978 (--1OutRef@RoVariant@@QEAA@XZ.c)
...
char __fastcall Windows::Services::TargetedContent::Internal::EnumerateAllTriggersInContainer(__int64 *a1, __int64 a2)
{
  ...
  char v68[8]; // [rsp+E8h] [rbp-18h] BYREF
  volatile signed __int32 *v69; // [rsp+F0h] [rbp-10h]
  __int64 v70; // [rsp+F8h] [rbp-8h] BYREF
  __int64 v71; // [rsp+108h] [rbp+8h] BYREF
  void *v72[4]; // [rsp+118h] [rbp+18h] BYREF
  __int64 v73[2]; // [rsp+138h] [rbp+38h] BYREF
...
LABEL_100:
    ...
    if ( !v21 )
      goto LABEL_97;
    v10 = (*(__int64 (__fastcall **)(__int64, _QWORD *, __int64 *))(*(_QWORD *)v21 + 16LL))(v21, v20, &v57);
