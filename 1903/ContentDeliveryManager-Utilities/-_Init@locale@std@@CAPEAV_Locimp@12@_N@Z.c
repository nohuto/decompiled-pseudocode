/*
 * XREFs of ?_Init@locale@std@@CAPEAV_Locimp@12@_N@Z @ 0x1800AEAD0
 * Callers:
 ...
 *     ?_Setgloballocale@locale@std@@CAXPEAX@Z @ 0x1800AED60 (-_Setgloballocale@locale@std@@CAXPEAX@Z.c)
...
struct std::locale::_Locimp *__fastcall std::locale::_Init(char a1)
{
  ...
  v2 = (struct std::locale::_Locimp *)qword_18018E400;
  if ( !qword_18018E400 )
  {
    ...
    *((_DWORD *)v2 + 8) = 63;
    ...
    qword_18018E450 = (__int64)std::locale::_Locimp::_Clocptr;
  }
  if ( a1 )
    (*(void (__fastcall **)(struct std::locale::_Locimp *))(*(_QWORD *)v2 + 8LL))(v2);
