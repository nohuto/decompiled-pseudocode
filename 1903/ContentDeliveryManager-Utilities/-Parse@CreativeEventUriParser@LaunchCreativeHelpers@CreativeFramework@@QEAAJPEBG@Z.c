/*
 * XREFs of ?Parse@CreativeEventUriParser@LaunchCreativeHelpers@CreativeFramework@@QEAAJPEBG@Z @ 0x1800543A4
 * Callers:
        ...
        unsigned __int16 *a2)
{
  ...
  unsigned int v4; // ebx
  __int64 v5; // rbx
  __int64 (__fastcall *v6)(__int64, _QWORD, __int64 *); // r14
  _QWORD *v7; // rsi
  int v8; // eax
  int v9; // eax
  __int64 v10; // r9
  ...
  __int64 v37; // rcx
  __int64 v38; // rcx
  _BYTE v40[8]; // [rsp+30h] [rbp-59h] BYREF
  ...
  HSTRING v45; // [rsp+58h] [rbp-31h] BYREF
  HSTRING v46; // [rsp+60h] [rbp-29h] BYREF
  __int64 v47; // [rsp+68h] [rbp-21h] BYREF
  __int64 (__fastcall ***v48)(_QWORD, GUID *, __int64 *); // [rsp+70h] [rbp-19h] BYREF
  ...
  {
    v52 = 0LL;
    v9 = (*(__int64 (__fastcall **)(__int64, HSTRING *))(*(_QWORD *)v42 + 136LL))(v42, &v52);
    v4 = v9;
    if ( v9 < 0 )
    {
      v10 = (unsigned int)v9;
...
LABEL_85:
    ...
    v51 = 0LL;
    v13 = (*(__int64 (__fastcall **)(__int64, HSTRING *))(*(_QWORD *)v42 + 104LL))(v42, &v51);
    v4 = v13;
    if ( v13 < 0 )
    {
      wil::details::in1diag3::Return_Hr(
...
LABEL_81:
    ...
    if ( v15 >= 0 )
    {
      ...
      if ( v15 >= 0 )
      {
        ...
        v48 = 0LL;
        v19 = (*(__int64 (__fastcall **)(__int64, __int64 (__fastcall ****)(_QWORD, GUID *, __int64 *)))(*(_QWORD *)v42 + 120LL))(
                v42,
                &v48);
        v4 = v19;
        if ( v19 >= 0 )
        {
          ...
          if ( v20 >= 0 )
          {
            ...
            if ( v21 >= 0 )
            {
              v24 = (*(__int64 (__fastcall **)(__int64, _BYTE *))(*(_QWORD *)v43 + 56LL))(v43, v40);
              v4 = v24;
              if ( v24 >= 0 )
              {
                while ( v40[0] )
...
LABEL_67:
                  ...
                  v26 = (*(__int64 (__fastcall **)(__int64, _BYTE *))(*(_QWORD *)v43 + 64LL))(v43, v40);
                  v4 = v26;
                  if ( v26 < 0 )
                  {
                    v31 = 81LL;
