/*
 * XREFs of ?ResolveRatingImage@ToastHelpers@NotificationManager@CreativeFramework@@AEAAXPEB_W@Z @ 0x18009C4AC
 * Callers:
 ...
 *     __report_rangecheckfailure @ 0x1800CAAE8 (__report_rangecheckfailure.c)
...
LABEL_20:
  ...
  v12 = (_QWORD *)std::map<std::wstring,std::wstring>::operator[]((char *)this + 32, v15);
  if ( *(_WORD *)v11 )
  {
    do
      ++v4;
