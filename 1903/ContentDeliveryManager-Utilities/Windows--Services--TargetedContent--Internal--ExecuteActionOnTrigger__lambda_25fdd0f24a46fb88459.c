/*
 * XREFs of Windows::Services::TargetedContent::Internal::ExecuteActionOnTrigger__lambda_25fdd0f24a46fb884595cc4fd71754f0___ @ 0x180068134
 * Callers:
        ...
        __int64 a2)
{
  ...
  const char *v30; // r9
  __int64 result; // rax
  HSTRING v32; // [rsp+40h] [rbp-98h] BYREF
  HSTRING v33; // [rsp+48h] [rbp-90h] BYREF
  HSTRING v34; // [rsp+50h] [rbp-88h] BYREF
  HSTRING string; // [rsp+58h] [rbp-80h]
  HSTRING v36; // [rsp+60h] [rbp-78h] BYREF
  PCWSTR StringRawBuffer; // [rsp+68h] [rbp-70h] BYREF
  PCWSTR v38; // [rsp+70h] [rbp-68h] BYREF
  PCWSTR v39; // [rsp+78h] [rbp-60h] BYREF
  PCWSTR v40; // [rsp+80h] [rbp-58h] BYREF
  const WCHAR *v41; // [rsp+88h] [rbp-50h] BYREF
  const WCHAR *v42[9]; // [rsp+90h] [rbp-48h] BYREF
  wil::details::in1diag3 *retaddr; // [rsp+D8h] [rbp+0h]
  unsigned int v44; // [rsp+E0h] [rbp+8h] BYREF
  __int64 v45; // [rsp+E8h] [rbp+10h]
  HSTRING v46; // [rsp+F0h] [rbp+18h] BYREF
  HSTRING v47; // [rsp+F8h] [rbp+20h] BYREF

  v45 = a2;
  v42[1] = (const WCHAR *)-2LL;
  string = 0LL;
        ...
        if ( v9 >= 0 )
        {
          ...
          if ( v12 >= 0 )
          {
            ...
            if ( v15 >= 0 )
            {
              ...
              if ( v18 >= 0 )
              {
                v20 = (*(__int64 (__fastcall **)(__int64, unsigned int *))(*(_QWORD *)a1 + 80LL))(a1, &v44);
                v21 = retaddr;
                if ( v20 >= 0 )
                {
                  v22 = (const WCHAR *)Windows::Services::TargetedContent::Internal::ResolveNameFromTrigger(v44);
                  Windows::Services::TargetedContent::Internal::GetNameForTrigger(&v36, a1);
                  v23 = v46;
                  v24 = v47;
                  v25 = v32;
                  v26 = v33;
                  ...
                  v39 = WindowsGetStringRawBuffer(v26, 0LL);
                  v40 = WindowsGetStringRawBuffer(v27, 0LL);
                  v42[0] = WindowsGetStringRawBuffer(v28, 0LL);
                  v41 = v22;
                  v29 = v45;
                  v38 = WindowsGetStringRawBuffer(**(HSTRING **)(v45 + 8), 0LL);
                  ContentDeliveryManager::Background::ContentDeliveryManagerTelemetry::TriggerManagerRegisterActivity::TriggerRegistrationPreconditionFailed<wchar_t const * &,wchar_t const * &,wchar_t const * &,wchar_t const * &,wchar_t const *,wchar_t const * &>(
                    ...
                    &v38,
                    &StringRawBuffer,
                    (const unsigned __int16 *)(**(_QWORD **)(v29 + 16) + 8LL));
