/*
 * XREFs of ??0AppInstallService@Actions@CreativeFramework@@QEAA@PEB_W_N11100000@Z @ 0x180082FAC
 * Callers:
        ...
        wchar_t *a11)
{
  ...
  *((_WORD *)this + 56) = 0;
  ...
  std::wstring::assign((_QWORD *)this + 14, (char *)Src, v16);
  *((_QWORD *)this + 21) = 7LL;
  *((_QWORD *)this + 20) = 0LL;
  *((_WORD *)this + 72) = 0;
  *((_QWORD *)this + 25) = 7LL;
  ...
  *((_WORD *)this + 104) = 0;
  ...
  std::wstring::assign((_QWORD *)this + 26, (char *)a10, v17);
  *((_QWORD *)this + 33) = 7LL;
  *((_QWORD *)this + 32) = 0LL;
  *((_WORD *)this + 120) = 0;
  if ( *a11 )
  ...
  std::wstring::assign((_QWORD *)this + 30, (char *)a11, v18);
  if ( a8 )
  {
    if ( *a8 )
    {
    ...
    std::wstring::assign((_QWORD *)this + 18, (char *)a8, v19);
  }
  if ( a9 )
  {
    if ( *a9 )
    ...
    std::wstring::assign((_QWORD *)this + 22, (char *)a9, v12);
  }
  return this;
}
