/*
 * XREFs of ?IsEnabled@?$Feature@U__WilFeatureTraits_Feature_BannersCanTargetKnownFolders@@@wil@@SA_NXZ @ 0x18002DDF0
 * Callers:
 *     <none>
 * Callees:
 ...
 *     ?GetCachedFeatureEnabledState@?$Feature@U__WilFeatureTraits_Feature_BannersCanTargetKnownFolders@@@wil@@CA?AW4wil_details_CachedFeatureEnabledState@@_N@Z @ 0x180034F58 (-GetCachedFeatureEnabledState@-$Feature@U__WilFeatureTraits_Feature_BannersCanTargetKnownFolders.c)
 */
