/*
 * XREFs of ?IsMsaConnected@Actions@CreativeFramework@@YA_NXZ @ 0x180082098
 * Callers:
 ...
 *     ??$GetActivationFactory@UIWebAuthenticationCoreManagerStatics@Core@Web@Authentication@Security@Windows@@@wil@@YA?AV?$com_ptr_t@UIWebAuthenticationCoreManagerStatics@Core@Web@Authentication@Security@Windows@@Uerr_exception_policy@wil@@@0@PEB_W@Z @ 0x180083DCC (--$GetActivationFactory@UIWebAuthenticationCoreManagerStatics@Core@Web@Authentication@Security@W.c)
 *     ??$GetActivationFactory@UIInspectable@@@wil@@YA?AV?$com_ptr_t@UIInspectable@@Uerr_exception_policy@wil@@@0@PEB_W@Z @ 0x180083E9C (--$GetActivationFactory@UIInspectable@@@wil@@YA-AV-$com_ptr_t@UIInspectable@@Uerr_exception_poli.c)
 *     ??$WaitForCompletion@PEAU?$IAsyncOperation@PEAVWebAccountProvider@Credentials@Security@Windows@@@Foundation@Windows@@@details@wil@@YAJPEAU?$IAsyncOperation@PEAVWebAccountProvider@Credentials@Security@Windows@@@Foundation@Windows@@W4tagCOWAIT_FLAGS@@KPEA_N@Z @ 0x1800845BC (--$WaitForCompletion@PEAU-$IAsyncOperation@PEAVWebAccountProvider@Credentials@Security@Windows@@.c)
 *     ??$WaitForCompletion@PEAU?$IAsyncOperation@PEAVGetDefaultSignInAccountResult@Web@Authentication@Security@Internal@Windows@@@Foundation@Windows@@@details@wil@@YAJPEAU?$IAsyncOperation@PEAVGetDefaultSignInAccountResult@Web@Authentication@Security@Internal@Windows@@@Foundation@Windows@@W4tagCOWAIT_FLAGS@@KPEA_N@Z @ 0x1800847E8 (--$WaitForCompletion@PEAU-$IAsyncOperation@PEAVGetDefaultSignInAccountResult@Web@Authentication@.c)
...
{
  __int64 v1; // rbx
  __int64 (__fastcall *v2)(__int64, PVOID, PVOID, __int64 *); // r14
  HSTRING_HEADER *v3; // rdi
  HSTRING_HEADER *v4; // rsi
  int v5; // eax
  __int64 v6; // rbx
  int v7; // eax
  ...
  v3 = Microsoft::WRL::Wrappers::HStringReference::HStringReference(&v43, &v39);
  v4 = Microsoft::WRL::Wrappers::HStringReference::HStringReference(&v42, &v38);
  v34 = 0LL;
  v5 = v2(v1, v4[1].Reserved.Reserved1, v3[1].Reserved.Reserved1, &v34);
  if ( v5 < 0 )
  {
...
LABEL_51:
  ...
  v40 = 0LL;
  LODWORD(v33) = 4;
  v7 = wil::details::WaitForCompletion<Windows::Foundation::IAsyncOperation<Windows::Security::Credentials::WebAccountProvider *> *>(v34);
  if ( v7 >= 0 )
  ...
  if ( v9 )
  {
    ...
    if ( v10 >= 0 )
    {
      *(GUID *)&v42.Reserved.Reserved1 = GUID_00000000_0000_0000_0000_000000000000;
      v12 = (*(__int64 (__fastcall **)(__int64 *, __int64, HSTRING_HEADER *))(*v37 + 264))(v37, v9, &v42);
      v13 = retaddr;
      if ( v12 >= 0 )
      {
        v36 = 0LL;
        v14 = *v37;
        v36 = 0LL;
        v15 = (*(__int64 (__fastcall **)(__int64 *, __int64 *))(v14 + 232))(v37, &v36);
        v16 = retaddr;
        if ( v15 >= 0 )
        {
          v17 = v36;
          v38 = 0LL;
          LODWORD(v33) = 42;
          DefaultSignInAccount = wil::details::WaitForCompletion<Windows::Foundation::IAsyncOperation<Windows::Internal::Security::Authentication::Web::GetDefaultSignInAccountResult *> *>(v36);
          ...
          if ( DefaultSignInAccount >= 0 )
          {
            ...
            v21 = *(_QWORD *)v20;
            v35 = 0LL;
            v22 = (*(__int64 (__fastcall **)(const WCHAR *, __int64 **))(v21 + 48))(v20, &v35);
            v23 = retaddr;
            if ( v22 >= 0 )
            {
              v24 = v35;
...
LABEL_35:
              ...
              v25 = *v35;
              v33 = 0LL;
              v26 = (*(__int64 (__fastcall **)(__int64 *, __int64 *))(v25 + 48))(v35, &v33);
              v27 = retaddr;
              if ( v26 >= 0 )
              {
                if ( v33 )
                {
                  *(GUID *)&v43.Reserved.Reserved1 = GUID_00000000_0000_0000_0000_000000000000;
                  v28 = (*(__int64 (__fastcall **)(__int64 *, __int64, HSTRING_HEADER *))(*v37 + 264))(v37, v33, &v43);
                  v29 = retaddr;
                  if ( v28 >= 0 )
                  {
