/*
 * XREFs of _Strcoll @ 0x1800C9F20
 * Callers:
 *     ?do_compare@?$collate@D@std@@MEBAHPEBD000@Z @ 0x1800C7CE0 (-do_compare@-$collate@D@std@@MEBAHPEBD000@Z.c)
 * Callees:
 *     _GetLocaleHandleByColl @ 0x1800B74DC (_GetLocaleHandleByColl.c)
 *     _GetLocaleHandleById @ 0x1800B74E8 (_GetLocaleHandleById.c)
 *     __crtCompareStringA_Stub @ 0x1800B756C (__crtCompareStringA_Stub.c)
 *     memcmp_0 @ 0x1800CB1DD (memcmp_0.c)
 */
