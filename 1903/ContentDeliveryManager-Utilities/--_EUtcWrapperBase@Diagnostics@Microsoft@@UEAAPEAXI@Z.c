/*
 * XREFs of ??_EUtcWrapperBase@Diagnostics@Microsoft@@UEAAPEAXI@Z @ 0x1800175D0
 * Callers:
 *     <none>
 * Callees:
 *     ??1UtcWrapperBase@Diagnostics@Microsoft@@UEAA@XZ @ 0x1800A8E84 (--1UtcWrapperBase@Diagnostics@Microsoft@@UEAA@XZ.c)
 */
