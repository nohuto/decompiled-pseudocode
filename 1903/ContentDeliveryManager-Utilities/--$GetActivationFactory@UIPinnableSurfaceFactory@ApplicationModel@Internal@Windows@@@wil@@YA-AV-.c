/*
 * XREFs of ??$GetActivationFactory@UIPinnableSurfaceFactory@ApplicationModel@Internal@Windows@@@wil@@YA?AV?$com_ptr_t@UIPinnableSurfaceFactory@ApplicationModel@Internal@Windows@@Uerr_exception_policy@wil@@@0@PEB_W@Z @ 0x18009A290
 * Callers:
        ...
        const WCHAR *a1)
{
  ...
  v6[3] = a1;
  v6[0] = L"Windows.Internal.ApplicationModel.TaskbarPinnableSurface";
  *(_QWORD *)a1 = 0LL;
