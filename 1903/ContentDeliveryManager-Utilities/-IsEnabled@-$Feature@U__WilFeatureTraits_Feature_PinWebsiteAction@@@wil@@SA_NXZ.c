/*
 * XREFs of ?IsEnabled@?$Feature@U__WilFeatureTraits_Feature_PinWebsiteAction@@@wil@@SA_NXZ @ 0x1800818C0
 * Callers:
 *     <none>
 * Callees:
...
char wil::Feature<__WilFeatureTraits_Feature_PinWebsiteAction>::IsEnabled()
{
