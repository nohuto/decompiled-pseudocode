/*
 * XREFs of _Towlower @ 0x1800AF370
 * Callers:
 *     ?do_tolower@?$ctype@_W@std@@MEBA_W_W@Z @ 0x180024520 (-do_tolower@-$ctype@_W@std@@MEBA_W_W@Z.c)
 *     ?do_tolower@?$ctype@_W@std@@MEBAPEB_WPEA_WPEB_W@Z @ 0x180024540 (-do_tolower@-$ctype@_W@std@@MEBAPEB_WPEA_WPEB_W@Z.c)
 * Callees:
