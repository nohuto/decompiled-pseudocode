/*
 * XREFs of ??$GetActivationFactory@UIHashAlgorithmNamesStatics@Core@Cryptography@Security@Windows@@@wil@@YA?AV?$com_ptr_t@UIHashAlgorithmNamesStatics@Core@Cryptography@Security@Windows@@Uerr_exception_policy@wil@@@0@PEB_W@Z @ 0x180088DE8
 * Callers:
        ...
        const WCHAR *a1)
{
  ...
  v6[3] = a1;
  v6[0] = L"Windows.Security.Cryptography.Core.HashAlgorithmNames";
  *(_QWORD *)a1 = 0LL;
