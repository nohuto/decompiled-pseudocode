/*
 * XREFs of ?NotifyFailure@?$ActivityBase@VShellPlacementLogging@Logging@CreativeFramework@@$00$0EAAAAAAAAAAA@$04$0A@U_TlgReflectorTag_Param0IsProviderType@@@wil@@UEAA_NAEBUFailureInfo@2@@Z @ 0x1800A3E50
 * Callers:
 *     <none>
 * Callees:
        ...
        int *a2)
{
  ...
  if ( v6 )
  {
      ...
      && (*((_QWORD *)v7 + 3) & 0x600000000000LL) == *((_QWORD *)v7 + 3) )
    {
      ...
      v146 = 2 * v11 + 2;
      v147 = 0;
      TlgWrite(v8, &unk_18016D2E1, (LPCGUID)(*(_QWORD *)(a1 + 48) + 8LL), 0LL, 0x11u, &pData);
    }
  }
         ...
         && (*((_QWORD *)v7 + 3) & 0x400000000000LL) == *((_QWORD *)v7 + 3) )
  {
    ...
    v107 = v28 + 1;
    v108 = 0;
    TlgWrite(v8, &unk_18016D126, (LPCGUID)(*(_QWORD *)(a1 + 48) + 8LL), 0LL, 0x14u, &v63);
  }
