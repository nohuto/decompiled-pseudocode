/*
 * XREFs of ?_Putmfld@?$money_put@_WV?$ostreambuf_iterator@_WU?$char_traits@_W@std@@@std@@@std@@AEBA?AV?$ostreambuf_iterator@_WU?$char_traits@_W@std@@@2@V32@_NAEAVios_base@2@_W1V?$basic_string@_WU?$char_traits@_W@std@@V?$allocator@_W@2@@2@3@Z @ 0x1800C0168
 * Callers:
 ...
 *     ??$use_facet@V?$moneypunct@_W$00@std@@@std@@YAAEBV?$moneypunct@_W$00@0@AEBVlocale@0@@Z @ 0x1800B9570 (--$use_facet@V-$moneypunct@_W$00@std@@@std@@YAAEBV-$moneypunct@_W$00@0@AEBVlocale@0@@Z.c)
 *     ??$use_facet@V?$moneypunct@_W$0A@@std@@@std@@YAAEBV?$moneypunct@_W$0A@@0@AEBVlocale@0@@Z @ 0x1800B96B0 (--$use_facet@V-$moneypunct@_W$0A@@std@@@std@@YAAEBV-$moneypunct@_W$0A@@0@AEBVlocale@0@@Z.c)
...
LABEL_76:
          ...
          if ( v45 > (unsigned int)v65 )
          {
            ...
            *v9 = v51;
            ...
            if ( *(_QWORD *)(v11 + 24) < 8uLL )
              ...
              v54 = *(unsigned __int16 **)v11;
            v55 = &v54[*(_QWORD *)(v11 + 16) - (unsigned int)v65];
            v38 = *v9;
            *(_OWORD *)v72 = *v9;
            ...
            do
            {
              std::ostreambuf_iterator<wchar_t>::operator=((__int64)v72, *v55++);
              --v56;
            }
            while ( v56 );
          }
          else
          {
            ...
            *(_OWORD *)v72 = v38;
            ...
            do
            {
              std::ostreambuf_iterator<wchar_t>::operator=((__int64)v72, *v49++);
              --v47;
            }
            while ( v47 );
          }
