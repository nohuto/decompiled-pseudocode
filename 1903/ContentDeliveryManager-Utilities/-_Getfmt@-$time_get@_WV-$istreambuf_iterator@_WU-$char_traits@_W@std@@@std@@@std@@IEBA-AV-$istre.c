/*
 * XREFs of ?_Getfmt@?$time_get@_WV?$istreambuf_iterator@_WU?$char_traits@_W@std@@@std@@@std@@IEBA?AV?$istreambuf_iterator@_WU?$char_traits@_W@std@@@2@V32@0AEAVios_base@2@AEAHPEAUtm@@PEBD@Z @ 0x1800AACB0
 * Callers:
        ...
        _BYTE *a8)
{
  ...
  _BYTE v28[16]; // [rsp+80h] [rbp-38h] BYREF

  v11 = a5;
  v12 = **(_QWORD **)(a5 + 64);
  a5 = v12;
  (*(void (__fastcall **)(__int64))(*(_QWORD *)v12 + 8LL))(v12);
  v13 = std::use_facet<std::ctype<wchar_t>>(&a5);
  if ( v12 )
  {
  ...
  if ( *a8 )
  {
    ...
    do
    {
      ...
      else
      {
        ...
        if ( v16 == 32 )
        {
          while ( !std::istreambuf_iterator<wchar_t>::equal(v20, a4) )
          {
