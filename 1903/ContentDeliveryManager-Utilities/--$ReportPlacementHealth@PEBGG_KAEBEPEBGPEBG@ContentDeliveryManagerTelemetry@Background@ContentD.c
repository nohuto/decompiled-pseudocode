/*
 * XREFs of ??$ReportPlacementHealth@PEBGG_KAEBEPEBGPEBG@ContentDeliveryManagerTelemetry@Background@ContentDeliveryManager@@SAX$$QEAPEBG$$QEAG$$QEA_KAEBE00PEBD@Z @ 0x180035850
 * Callers:
...
int __fastcall ContentDeliveryManager::Background::ContentDeliveryManagerTelemetry::ReportPlacementHealth<unsigned short const *,unsigned short,unsigned __int64,unsigned char const &,unsigned short const *,unsigned short const *>(
        const WCHAR **a1,
        __int64 a2,
        __int64 a3,
        __int64 a4,
        ...
        const unsigned __int16 *a7)
{
  ...
  {
    LODWORD(v10) = 0;
    if ( (*((_QWORD *)v11 + 2) & 0x800000000000LL) != 0
      && (*((_QWORD *)v11 + 3) & 0x800000000000LL) == *((_QWORD *)v11 + 3) )
    {
      ...
      v36 = v14 + 1;
      v35 = v17;
      LODWORD(v10) = TlgWrite(v11, &unk_18016BA71, 0LL, 0LL, 9u, &pData);
    }
  }
  return (int)v10;
}
