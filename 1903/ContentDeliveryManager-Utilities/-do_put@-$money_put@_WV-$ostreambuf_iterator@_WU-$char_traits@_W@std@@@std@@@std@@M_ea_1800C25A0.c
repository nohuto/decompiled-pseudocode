/*
 * XREFs of ?do_put@?$money_put@_WV?$ostreambuf_iterator@_WU?$char_traits@_W@std@@@std@@@std@@MEBA?AV?$ostreambuf_iterator@_WU?$char_traits@_W@std@@@2@V32@_NAEAVios_base@2@_WO@Z @ 0x1800C25A0
 * Callers:
 *     <none>
 * Callees:
 ...
 *     sprintf_s_0 @ 0x1800CB028 (sprintf_s_0.c)
        ...
        double a7)
{
  ...
  if ( v11 >= 0 )
  {
    ...
    (*(void (__fastcall **)(_QWORD, char *, char *, void **))(*(_QWORD *)v22[1] + 88LL))(
      ...
      &Buffer[v12],
      v19);
    std::wstring::append((char *)v25, i, v18);
    v24[3] = (void *)7;
    v24[2] = 0LL;
    LOWORD(v24[0]) = 0;
