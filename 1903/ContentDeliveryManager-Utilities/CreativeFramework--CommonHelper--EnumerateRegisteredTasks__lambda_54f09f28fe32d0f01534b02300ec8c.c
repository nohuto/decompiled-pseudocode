/*
 * XREFs of CreativeFramework::CommonHelper::EnumerateRegisteredTasks__lambda_54f09f28fe32d0f01534b02300ec8cff___ @ 0x1800ACA5C
 * Callers:
        ...
        __int64 a1)
{
  ...
  __int64 *v28; // [rsp+40h] [rbp-81h] BYREF
  __int64 *v29; // [rsp+48h] [rbp-79h] BYREF
  HSTRING v30; // [rsp+50h] [rbp-71h] BYREF
  __int64 v31; // [rsp+58h] [rbp-69h] BYREF
  __int64 *v32; // [rsp+60h] [rbp-61h] BYREF
  __int64 v33; // [rsp+68h] [rbp-59h] BYREF
  __int64 *v34; // [rsp+70h] [rbp-51h]
  const WCHAR *v35[2]; // [rsp+78h] [rbp-49h] BYREF
...
LABEL_34:
  ...
  v5 = *v32;
  v33 = 0LL;
  v6 = (*(__int64 (__fastcall **)(__int64 *, __int64 *))(v5 + 48))(v32, &v33);
  v7 = retaddr;
  if ( v6 < 0 )
  {
LABEL_35:
...
LABEL_36:
  ...
  v11 = *v29;
  v28 = 0LL;
  v12 = (*(__int64 (__fastcall **)(__int64 *, __int64 **))(v11 + 48))(v29, &v28);
  v13 = retaddr;
  if ( v12 < 0 )
  {
LABEL_37:
...
LABEL_38:
  ...
  while ( 1 )
  {
    if ( (*(int (__fastcall **)(__int64 *, __int64 *))(*v28 + 56))(v28, &v27) < 0 || !(_BYTE)v27 )
      goto LABEL_24;
    v29 = 0LL;
    v14 = *v28;
    v29 = 0LL;
    v15 = (*(__int64 (__fastcall **)(__int64 *, __int64 **))(v14 + 48))(v28, &v29);
    v16 = retaddr;
    if ( v15 < 0 )
      goto LABEL_32;
    v31 = 0LL;
    v17 = *v29;
    v31 = 0LL;
    v18 = (*(__int64 (__fastcall **)(__int64 *, __int64 *))(v17 + 56))(v29, &v31);
    if ( v18 < 0 )
    {
      wil::details::in1diag3::Throw_Hr(
        retaddr,
...
LABEL_32:
    ...
    v19 = v31;
    v30 = 0LL;
    v20 = *(__int64 (__fastcall **)(__int64, HSTRING *))(*(_QWORD *)v31 + 56LL);
    ...
    if ( (*(unsigned int (__fastcall **)(__int64 *, __int64 *))(*v28 + 64))(v28, &v27) == -2147483637 )
      goto LABEL_20;
    if ( v31 )
  ...
  v35[0] = WindowsGetStringRawBuffer(v30, 0LL);
