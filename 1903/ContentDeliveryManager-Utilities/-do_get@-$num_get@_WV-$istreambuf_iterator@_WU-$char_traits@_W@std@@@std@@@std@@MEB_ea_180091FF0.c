/*
 * XREFs of ?do_get@?$num_get@_WV?$istreambuf_iterator@_WU?$char_traits@_W@std@@@std@@@std@@MEBA?AV?$istreambuf_iterator@_WU?$char_traits@_W@std@@@2@V32@0AEAVios_base@2@AEAHAEA_N@Z @ 0x180091FF0
 * Callers:
 *     <none>
 * Callees:
 ...
 *     ?append@?$basic_string@_WU?$char_traits@_W@std@@V?$allocator@_W@2@@std@@QEAAAEAV12@AEBV12@_K1@Z @ 0x180076514 (-append@-$basic_string@_WU-$char_traits@_W@std@@V-$allocator@_W@2@@std@@QEAAAEAV12@AEBV12@_K1@Z.c)
 ...
 *     ?append@?$basic_string@_WU?$char_traits@_W@std@@V?$allocator@_W@2@@std@@QEAAAEAV12@_K_W@Z @ 0x1800935F8 (-append@-$basic_string@_WU-$char_traits@_W@std@@V-$allocator@_W@2@@std@@QEAAAEAV12@_K_W@Z.c)
        ...
        bool *a7)
{
  ...
  if ( (*(_DWORD *)(a5 + 24) & 0x4000) != 0 )
  {
    ...
    v12 = std::use_facet<std::numpunct<wchar_t>>(&v21);
    if ( v11 )
    {
    ...
    std::wstring::append((char *)v27, v29, 0LL, 0xFFFFFFFFFFFFFFFFuLL);
    if ( v30 >= 8 )
    ...
    if ( v28 >= 8 )
      v14 = (__int16 *)v27[0];
    v15 = v22;
    v10 = std::_Getloctxt<unsigned short,std::istreambuf_iterator<unsigned short>>(a3, (__int64)v22, 2uLL, v14);
    if ( v28 >= 8 )
  ...
  if ( std::istreambuf_iterator<wchar_t>::equal(a3, v15) )
    *a6 |= 1u;
  if ( v10 >= 0 )
    *v25 = v10 != 0;
  else
