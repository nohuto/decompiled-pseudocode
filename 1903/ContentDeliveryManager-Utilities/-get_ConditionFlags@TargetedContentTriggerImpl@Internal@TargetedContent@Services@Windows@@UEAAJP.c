/*
 * XREFs of ?get_ConditionFlags@TargetedContentTriggerImpl@Internal@TargetedContent@Services@Windows@@UEAAJPEAW4TargetedContentTriggerConditionFlags@2345@@Z @ 0x18005E450
 * Callers:
 *     <none>
 * Callees:
 *     <none>
