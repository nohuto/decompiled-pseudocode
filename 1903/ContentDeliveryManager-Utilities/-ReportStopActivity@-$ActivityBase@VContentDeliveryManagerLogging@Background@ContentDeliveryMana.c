/*
 * XREFs of ?ReportStopActivity@?$ActivityBase@VContentDeliveryManagerLogging@Background@ContentDeliveryManager@@$00$0A@$04$0A@U_TlgReflectorTag_Param0IsProviderType@@@wil@@AEAAXJ@Z @ 0x180067668
 * Callers:
  ...
  if ( a2 < 0 )
  {
    ...
    if ( v6 )
    {
        ...
        && (*((_QWORD *)v7 + 3) & 0x200000000000LL) == *((_QWORD *)v7 + 3) )
      {
        ...
        v76 = 2 * v11 + 2;
        v77 = 0;
        TlgWrite(v8, &unk_18016B53D, (LPCGUID)(a1[6] + 8LL), 0LL, 0x11u, &pData);
      }
    }
           ...
           && (*((_QWORD *)v7 + 3) & 0x200000000000LL) == *((_QWORD *)v7 + 3) )
    {
      ...
      v89 = 2 * v28 + 2;
      v90 = 0;
      TlgWrite(v8, &unk_18016BD32, (LPCGUID)(v26 + 8), 0LL, 7u, &v78);
    }
  }
