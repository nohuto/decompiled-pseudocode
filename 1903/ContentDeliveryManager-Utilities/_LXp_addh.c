/*
 * XREFs of _LXp_addh @ 0x1800B7630
 * Callers:
 *     _LXp_addx @ 0x1800B7988 (_LXp_addx.c)
 *     _LXp_mulh @ 0x1800B7A00 (_LXp_mulh.c)
 * Callees:
 *     _LDscale @ 0x1800B7624 (_LDscale.c)
 *     _Feraise @ 0x1800C9918 (_Feraise.c)
 *     _LDtest @ 0x1800C9EC0 (_LDtest.c)
 *     _LDint @ 0x1800C9ECC (_LDint.c)
      ...
      if ( v14 > -26 || v34 == 0.0 )
      {
        if ( v14 < 26 || v34 == 0.0 )
        {
          ...
          if ( v8 - 26 < (int)v22 )
          {
            ...
            LDint(&v34, v22);
            LDscale((unsigned __int16 *)&v34, v32);
            v23 = a1[v3] - v34;
            a1[v3] = v23;
            if ( v23 == 0.0 )
            {
