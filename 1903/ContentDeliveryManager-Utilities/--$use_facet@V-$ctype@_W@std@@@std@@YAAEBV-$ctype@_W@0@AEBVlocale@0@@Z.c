/*
 * XREFs of ??$use_facet@V?$ctype@_W@std@@@std@@YAAEBV?$ctype@_W@0@AEBVlocale@0@@Z @ 0x180076828
 * Callers:
...
struct std::_Facet_base *__fastcall std::use_facet<std::ctype<wchar_t>>(__int64 *a1)
{
  ...
  v2 = std::_Facetptr<std::ctype<wchar_t>>::_Psave;
  v11 = (struct std::_Facet_base *)std::_Facetptr<std::ctype<wchar_t>>::_Psave;
  ...
  if ( !v5 )
  {
    ...
    if ( !v5 )
    {
      ...
      else
      {
        ...
        v5 = v11;
        std::_Facetptr<std::ctype<wchar_t>>::_Psave = (__int64)v11;
