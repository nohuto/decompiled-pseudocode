/*
 * XREFs of ?Destroy@SemaphoreValue@details_abi@wil@@QEAAXXZ @ 0x18000381C
 * Callers:
...
void __fastcall wil::details_abi::SemaphoreValue::Destroy(wil::details_abi::SemaphoreValue *this)
{
  ...
  if ( *(_QWORD *)this )
  {
    ...
    if ( !CloseHandle(v1) )
    {
      wil::details::in1diag3::_FailFast_GetLastError(retaddr, (void *)0x8F0, v4, v5);
      JUMPOUT(0x1800038B1LL);
    }
