/*
 * XREFs of ?WilApiImpl_SubscribeFeatureStateChangeNotification@details@wil@@YAXPEAPEAUFEATURE_STATE_CHANGE_SUBSCRIPTION__@@P6AXPEAX@Z1@Z @ 0x1800093E0
 * Callers:
 *     <none>
 * Callees:
 *     ?SubscribeUnderLock@SubscriptionList@details_abi@wil@@QEAAXPEAPEAUFEATURE_STATE_CHANGE_SUBSCRIPTION__@@P6AXPEAX@Z1@Z @ 0x180008428 (-SubscribeUnderLock@SubscriptionList@details_abi@wil@@QEAAXPEAPEAUFEATURE_STATE_CHANGE_SUBSCRIPT.c)
        ...
        void *a4)
{
  ...
  *this = 0LL;
  ...
  {
    AcquireSRWLockExclusive(&SRWLock);
    if ( !*((_QWORD *)&xmmword_18018D1F0 + 1) )
    {
      v7 = qword_18018D1B8;
      if ( qword_18018D1B8 )
      {
        *((_QWORD *)&xmmword_18018D1F0 + 1) = 0LL;
        AcquireSRWLockExclusive(qword_18018D1B8);
        wil::details_abi::SubscriptionList::SubscribeUnderLock(
          (wil::details_abi::SubscriptionList *)&v7[25],
          (struct FEATURE_STATE_CHANGE_SUBSCRIPTION__ **)&xmmword_18018D1F0 + 1,
    ...
    wil::details_abi::SubscriptionList::SubscribeUnderLock(
      (wil::details_abi::SubscriptionList *)&stru_18018D248,
      this,
      (void (*)(void *))a2,
      0LL);
    if ( *this )
