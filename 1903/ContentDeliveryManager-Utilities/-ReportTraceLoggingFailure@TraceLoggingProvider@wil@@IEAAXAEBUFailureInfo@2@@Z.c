/*
 * XREFs of ?ReportTraceLoggingFailure@TraceLoggingProvider@wil@@IEAAXAEBUFailureInfo@2@@Z @ 0x180006A2C
 * Callers:
        ...
        const struct wil::FailureInfo *a2)
{
  ...
  const WCHAR *v45; // [rsp+E8h] [rbp-20h]
  ...
  const unsigned __int16 *v73; // [rsp+198h] [rbp+90h]
  ...
  if ( *(_DWORD *)v2 > 2u )
  {
    ...
    v74 = v5 + 1;
    v75 = 0;
    TlgWrite(v2, &unk_18016AD1B, 0LL, 0LL, 0x14u, &pData);
  }
}
