/*
 * XREFs of ?put_Predecessor@TargetedContentTriggerImpl@Internal@TargetedContent@Services@Windows@@UEAAJPEAUHSTRING__@@@Z @ 0x18005DB50
 * Callers:
 *     <none>
 * Callees:
