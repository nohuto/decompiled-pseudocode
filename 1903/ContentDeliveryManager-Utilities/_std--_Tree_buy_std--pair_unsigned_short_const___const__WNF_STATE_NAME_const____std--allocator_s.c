/*
 * XREFs of _std::_Tree_buy_std::pair_unsigned_short_const___const__WNF_STATE_NAME_const____std::allocator_std::pair_unsigned_short_const___const__WNF_STATE_NAME_const_______::_Buynode_std::pair_unsigned_short_const____WNF_STATE_NAME_const______::_1_::catch$0 @ 0x1800D16C7
 * Callers:
 *     <none>
 * Callees:
