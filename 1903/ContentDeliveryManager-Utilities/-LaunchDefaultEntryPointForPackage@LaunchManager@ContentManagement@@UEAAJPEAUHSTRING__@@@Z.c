/*
 * XREFs of ?LaunchDefaultEntryPointForPackage@LaunchManager@ContentManagement@@UEAAJPEAUHSTRING__@@@Z @ 0x18000D330
 * Callers:
 *     <none>
 * Callees:
...
LABEL_21:
  ...
  v21 = &v36;
  *(_QWORD *)v30 = retaddr;
  v31 = "shellcommon\\shell\\contentdeliverymanager\\utils\\dll\\contentmanagementbroker.cpp";
  v32 = 0LL;
  v33 = 392;
  if ( (`wil::Feature<__WilFeatureTraits_Feature_GenericActionAndTrigger>::GetFeaturePropertyCache'::`2'::data & 0x30) == 0 )
  ...
  *(_QWORD *)v26 = ThreadLocalDataCache;
  ...
  v18 = lambda_fb48ef3a2c30e4b7127ba6e0ec514475_::operator()(&v21);
  v19 = v18;
  if ( v18 < 0 )
