/*
 * XREFs of ?GetCachedVariantState@?$Feature@U__WilFeatureTraits_Feature_YourPhoneTaskbarIcon@@@wil@@CA?AW4Variant_YourPhoneTaskbarIcon@@XZ @ 0x1800146CC
 * Callers:
