/*
 * XREFs of _Towupper @ 0x1800AF9B4
 * Callers:
 *     ?do_toupper@?$ctype@G@std@@MEBAGG@Z @ 0x1800245B0 (-do_toupper@-$ctype@G@std@@MEBAGG@Z.c)
 *     ?do_toupper@?$ctype@_W@std@@MEBAPEB_WPEA_WPEB_W@Z @ 0x1800245D0 (-do_toupper@-$ctype@_W@std@@MEBAPEB_WPEA_WPEB_W@Z.c)
 * Callees:
