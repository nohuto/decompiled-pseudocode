/*
 * XREFs of __GSHandlerCheck_EH @ 0x1800CB128
 * Callers:
 *     <none>
 * Callees:
 *     __CxxFrameHandler3_0 @ 0x1800CA8E6 (__CxxFrameHandler3_0.c)
 *     __GSHandlerCheckCommon @ 0x1800CB094 (__GSHandlerCheckCommon.c)
 */
