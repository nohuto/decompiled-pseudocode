/*
 * XREFs of ?NotifyFailure@?$ActivityBase@VContentDeliveryManagerLogging@Background@ContentDeliveryManager@@$00$0CAAAAAAAAAAA@$04$0A@U_TlgReflectorTag_Param0IsProviderType@@@wil@@UEAA_NAEBUFailureInfo@2@@Z @ 0x1800411D0
 * Callers:
 *     <none>
 * Callees:
        ...
        int *a2)
{
  ...
  if ( v4 )
  {
      ...
      && (*((_QWORD *)v5 + 3) & 0x200000000000LL) == *((_QWORD *)v5 + 3) )
    {
      ...
      v91 = 2 * v9 + 2;
      v92 = 0;
      TlgWrite(v6, &unk_18016B8B5, (LPCGUID)(a1[6] + 8LL), 0LL, 0x11u, &pData);
    }
  }
         ...
         && (*((_QWORD *)v5 + 3) & 0x200000000000LL) == *((_QWORD *)v5 + 3) )
  {
    ...
    v98 = v26 + 1;
    v99 = 0;
    TlgWrite(v6, &unk_18016B405, (LPCGUID)(a1[6] + 8LL), 0LL, 0x14u, &pData);
  }
