/*
 * XREFs of ?GetIids@MobilityExperienceSettings@ContentManagement@@UEAAJPEAKPEAPEAU_GUID@@@Z @ 0x18000F040
 * Callers:
 *     ?GetIids@MobilityExperienceSettings@ContentManagement@@WDA@EAAJPEAKPEAPEAU_GUID@@@Z @ 0x18001EA70 (-GetIids@MobilityExperienceSettings@ContentManagement@@WDA@EAAJPEAKPEAPEAU_GUID@@@Z.c)
 * Callees:
 *     <none>
 */
