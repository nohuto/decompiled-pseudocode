/*
 * XREFs of __tailMerge_ext_ms_win_security_slc_l1_1_0_dll @ 0x1800CB5D9
 * Callers:
 *     __imp_load_SLGetWindowsInformationDWORD @ 0x1800CB5CD (__imp_load_SLGetWindowsInformationDWORD.c)
 * Callees:
