/*
 * XREFs of ?NotifyFailure@?$ActivityBase@VMobilityExperienceLogging@Telemetry@MobilityExperience@@$00$0IAAAAAAAAAAA@$04$0A@U_TlgReflectorTag_Param0IsProviderType@@@wil@@UEAA_NAEBUFailureInfo@2@@Z @ 0x1800498E0
 * Callers:
 *     <none>
 * Callees:
...
char __fastcall wil::ActivityBase<MobilityExperience::Telemetry::MobilityExperienceLogging,1,140737488355328,5,0,_TlgReflectorTag_Param0IsProviderType>::NotifyFailure(
        __int64 a1,
        int *a2)
{
  int v3; // edx
  ...
  if ( v6 )
  {
      ...
      && (*((_QWORD *)v7 + 3) & 0xA00000000000LL) == *((_QWORD *)v7 + 3) )
    {
      ...
      v146 = 2 * v11 + 2;
      v147 = 0;
      TlgWrite(v8, &unk_18016C78E, (LPCGUID)(*(_QWORD *)(a1 + 48) + 8LL), 0LL, 0x11u, &pData);
    }
  }
         ...
         && (*((_QWORD *)v7 + 3) & 0x800000000000LL) == *((_QWORD *)v7 + 3) )
  {
    ...
    v107 = v28 + 1;
    v108 = 0;
    TlgWrite(v8, &unk_18016C656, (LPCGUID)(*(_QWORD *)(a1 + 48) + 8LL), 0LL, 0x14u, &v63);
  }
