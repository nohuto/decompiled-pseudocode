/*
 * XREFs of _dynamic_atexit_destructor_for__ContentManagement::TargetedContent::Internal::SubscriptionManagerImpl::s_singletonSubscriptionManagerWeak__ @ 0x1800D5B70
 * Callers:
 *     <none>
 * Callees:
