/*
 * XREFs of _std::make_shared_CreativeFramework::Actions::TaskbarPinService_wchar_t_const___bool__::_1_::dtor$1 @ 0x1800D2DF3
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall std::make_shared_CreativeFramework::Actions::TaskbarPinService_wchar_t_const___bool__::_1_::dtor_1(
        __int64 a1,
        __int64 a2)
{
  __int64 result; // rax
