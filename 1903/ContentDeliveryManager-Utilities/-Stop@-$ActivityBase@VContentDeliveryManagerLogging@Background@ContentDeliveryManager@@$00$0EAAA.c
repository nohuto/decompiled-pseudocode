/*
 * XREFs of ?Stop@?$ActivityBase@VContentDeliveryManagerLogging@Background@ContentDeliveryManager@@$00$0EAAAAAAAAAAA@$04$0A@U_TlgReflectorTag_Param0IsProviderType@@@wil@@QEAAXJ@Z @ 0x1800511EC
 * Callers:
  ...
  *(_DWORD *)(v2 + 72) = v5;
  ...
  if ( v5 )
  {
      ...
      && (*((_QWORD *)v6 + 3) & 0x400000000000LL) == *((_QWORD *)v6 + 3) )
    {
      ...
      p_SRWLock = &SRWLock;
      v20 = 4;
      TlgWrite(v6, &unk_18016D057, (LPCGUID)(a1[6] + 8LL), 0LL, 5u, &pData);
    }
  }
  else
  {
