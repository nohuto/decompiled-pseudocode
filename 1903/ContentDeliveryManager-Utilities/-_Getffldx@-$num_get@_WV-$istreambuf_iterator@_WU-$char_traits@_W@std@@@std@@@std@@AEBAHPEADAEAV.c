/*
 * XREFs of ?_Getffldx@?$num_get@_WV?$istreambuf_iterator@_WU?$char_traits@_W@std@@@std@@@std@@AEBAHPEADAEAV?$istreambuf_iterator@_WU?$char_traits@_W@std@@@2@1AEAVios_base@2@PEAH@Z @ 0x180092E40
 * Callers:
        ...
        int *a6)
{
  ...
  v11 = std::use_facet<std::numpunct<wchar_t>>(&v72);
  v75 = v11;
  if ( v9 )
  {
  ...
  v14 = std::use_facet<std::ctype<wchar_t>>(&v72);
  if ( v13 )
  {
...
LABEL_70:
          ...
          std::string::append((char *)v79, 1uLL, 0);
          ++v22;
        }
        else
        {
...
LABEL_51:
        std::istreambuf_iterator<unsigned short>::_Inc(a3);
        if ( std::istreambuf_iterator<wchar_t>::equal(a3, v73) )
          goto LABEL_52;
      }
    }
    while ( 1 )
