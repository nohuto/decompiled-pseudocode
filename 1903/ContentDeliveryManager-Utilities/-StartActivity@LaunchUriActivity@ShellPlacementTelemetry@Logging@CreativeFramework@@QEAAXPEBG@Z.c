/*
 * XREFs of ?StartActivity@LaunchUriActivity@ShellPlacementTelemetry@Logging@CreativeFramework@@QEAAXPEBG@Z @ 0x180025A54
 * Callers:
        ...
        const unsigned __int16 *a2)
{
  ...
  *(_DWORD *)v4 = 1;
    ...
    && (*((_QWORD *)v7 + 3) & 0x200000000000LL) == *((_QWORD *)v7 + 3) )
  {
    ...
    TlgWrite(v8, &unk_18016BA23, (LPCGUID)(v10 + 8), v11, 5u, &pData);
  }
  if ( !*((_DWORD *)this + 8) )
