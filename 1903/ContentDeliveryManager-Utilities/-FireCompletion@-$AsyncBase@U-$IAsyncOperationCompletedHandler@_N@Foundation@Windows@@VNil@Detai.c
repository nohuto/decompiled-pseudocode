/*
 * XREFs of ?FireCompletion@?$AsyncBase@U?$IAsyncOperationCompletedHandler@_N@Foundation@Windows@@VNil@Details@WRL@Microsoft@@$00U?$AsyncOptions@$0?0$0A@$1?GUID_CAUSALITY_WINDOWS_PLATFORM_ID@@3U_GUID@@B$01@67@@WRL@Microsoft@@UEAAJXZ @ 0x18007FAF0
 * Callers:
 *     <none>
 * Callees:
        ...
        signed __int32 *a1)
{
  ...
  if ( *((_QWORD *)a1 + 3) && _InterlockedIncrement(a1 + 4) == 1 )
  {
    ...
    if ( v5(a1, &GUID_cdb5efb3_5788_509d_9be1_71ccb8a3362a, &v16) >= 0 )
    {
      v15 = -2;
