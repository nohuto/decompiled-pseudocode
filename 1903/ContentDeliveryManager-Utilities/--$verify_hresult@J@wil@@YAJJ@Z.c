/*
 * XREFs of ??$verify_hresult@J@wil@@YAJJ@Z @ 0x180014E7C
 * Callers:
 ...
 *     ??$?0PEB_WPEB_WPEB_W@?$_Ref_count_obj@VSetDefaultApplicationService@Actions@CreativeFramework@@@std@@QEAA@$$QEAPEB_W00@Z @ 0x18008A4C8 (--$-0PEB_WPEB_WPEB_W@-$_Ref_count_obj@VSetDefaultApplicationService@Actions@CreativeFramework@@@.c)
 ...
 *     ?InitializeMRTObjects@MRTHelperBase@ShellMRTHelper@@AEAAJXZ @ 0x18009EF08 (-InitializeMRTObjects@MRTHelperBase@ShellMRTHelper@@AEAAJXZ.c)
