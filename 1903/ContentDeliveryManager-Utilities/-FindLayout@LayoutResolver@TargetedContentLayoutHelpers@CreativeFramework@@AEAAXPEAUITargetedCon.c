/*
 * XREFs of ?FindLayout@LayoutResolver@TargetedContentLayoutHelpers@CreativeFramework@@AEAAXPEAUITargetedContentCollection@TargetedContent@Services@Windows@@PEAUHSTRING__@@PEAUITargetedContentIdAliasStore@Internal@567@@Z @ 0x1800A2B18
 * Callers:
        ...
        struct Windows::Services::TargetedContent::Internal::ITargetedContentIdAliasStore *a4)
{
  ...
  v12 = Microsoft::WRL::Wrappers::HStringReference::HStringReference(&v36, (const WCHAR **)off_1800F5FB0);
...
LABEL_18:
  ...
  v17 = Microsoft::WRL::Wrappers::HStringReference::HStringReference(&v36, (const WCHAR **)off_1800F5FB0);
  v18 = v33;
  v33 = 0LL;
  if ( v18 )
...
LABEL_20:
  ...
  v30 = Microsoft::WRL::Wrappers::HStringReference::HStringReference(&v36, (const WCHAR **)off_1800F5FB8);
