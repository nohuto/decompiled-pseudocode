/*
 * XREFs of wil_details_FeaturePropertyCache_ReportUsageToService @ 0x1C000194C
 * Callers:
...
LABEL_17:
  ...
  if ( (_DWORD)result )
  {
    ...
    if ( g_wil_details_pfnFeatureLoggingHook )
      return (__int64 (__fastcall *)(_QWORD, _QWORD, _QWORD, _QWORD, _QWORD, _QWORD, _DWORD, _QWORD))g_wil_details_pfnFeatureLoggingHook(19581266LL, &Feature_AmdPpmAllowPseudoEpp_logged_traits, 0LL, v2, &v5, 0LL, 0, 1LL);
  }
  return result;
}
