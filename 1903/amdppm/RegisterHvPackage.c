/*
 * XREFs of RegisterHvPackage @ 0x1C0021370
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall RegisterHvPackage(__int64 a1)
{
  ...
  if ( v2 >= 0 )
  {
    ...
    while ( (__int64 *)v3 != &qword_1C0013448 );
    if ( !v5 )
    {
LABEL_6:
      v5 = 0LL;
      ...
      if ( (int)HvlQueryStartedProcessors(&v14, 0LL) >= 0 )
      {
        ...
        if ( PoolWithTag )
        {
          ...
          {
            v8 = ExAllocatePoolWithTag(NonPagedPoolNx, 0x30uLL, 0x72637250u);
            v5 = (__int64)v8;
            if ( v8 )
            {
              memset(v8, 0, 0x30uLL);
