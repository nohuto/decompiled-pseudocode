 ...
 *     GetPackageAffinity @ 0x1C002C170 (GetPackageAffinity.c)
...
__int64 __fastcall InitCpcStatesInternal(__int64 a1, __int64 (__fastcall *a2)(_QWORD *, _QWORD))
{
  ...
  _BYTE *v138; // [rsp+C8h] [rbp-38h]
  BOOL v139; // [rsp+D0h] [rbp-30h]
  int v140; // [rsp+D4h] [rbp-2Ch]
  _QWORD *v141; // [rsp+D8h] [rbp-28h]
...
LABEL_8:
  ...
  while ( !(unsigned int)EnumerateNextDevice((__int64)v134, &DeferredContext) )
  {
    if ( !*((_BYTE *)DeferredContext + 78) )
    {
      v138 = (_BYTE *)*((_QWORD *)DeferredContext + 72);
      if ( (int)GetPackageAffinity(DeferredContext, v153) >= 0 )
        v139 = KeIsEqualAffinityEx(v153, v152) != 0;
      break;
    }
  }
  ResetEnumerationContext(v134);
        ...
        if ( !(unsigned int)EnumerateNextDevice((__int64)v134, &DeferredContext) )
        {
          do
          {
            ...
            if ( v73[67] )
            {
              ...
              *((_DWORD *)v73 + 13) = v101;
              if ( v101 != v102[181] )
                ProcLibCapChange(v142, v102[112], v102[124], v101);
              v100 = v138;
            }
            *((_QWORD *)v73 - 4) = v102;
            *(_QWORD *)(v98 + 8) = v73 - 32;
