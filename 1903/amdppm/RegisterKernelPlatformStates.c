/*
 * XREFs of RegisterKernelPlatformStates @ 0x1C002887C
 * Callers:
...
__int64 __fastcall RegisterKernelPlatformStates(__int64 a1)
{
  ...
  v1 = (unsigned int)dword_1C0013970;
  v2 = dword_1C0013414;
  if ( !dword_1C0013970 )
    return 0;
  v4 = (48 * dword_1C0013970 + 59) & 0xFFFFFFFC;
  PoolWithTag = (char *)ExAllocatePoolWithTag(PagedPool, v4 + 8 * dword_1C0013414 * dword_1C0013970, 0x72637250u);
  v6 = PoolWithTag;
  if ( !PoolWithTag )
  {
  ...
  if ( (_DWORD)v1 )
  {
    ...
    while ( 1 )
    {
      ...
      *v8 = v9;
      v8[8] = v2;
      ProcessorNumberFromIndex = ((__int64 (__fastcall *)(_QWORD, _DWORD *, _QWORD))qword_1C00136C8)(
                                   *(_QWORD *)(a1 + 1104),
                                   v8,
                                   0LL);
...
LABEL_20:
  *(_DWORD *)v6 = 62;
  *((_DWORD *)v6 + 1) = dword_1C0013970;
  *((_DWORD *)v6 + 2) = dword_1C0013970;
  ...
  *((_QWORD *)v6 + 4) = PepIdleComplete;
  ProcessorNumberFromIndex = ((__int64 (__fastcall *)(char *))qword_1C0013658)(v6);
  if ( ProcessorNumberFromIndex >= 0 )
  {
    Src = v6;
    v6 = 0LL;
