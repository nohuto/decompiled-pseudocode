/*
 * XREFs of PopulateEnergyEstimationParameters @ 0x1C00360F0
 * Callers:
...
LABEL_13:
      ...
      if ( (unsigned int)dword_1C0013068 > 5
        && (qword_1C0013078 & 0x400000000000LL) != 0
        && (qword_1C0013080 & 0x400000000000LL) == qword_1C0013080 )
      {
        v23 = 0;
        v26 = 0;
        v19 = (char *)&v14;
        ...
        v25 = 2;
        v28 = 4 * v9;
        TlgWrite(&hProvider, &unk_1C0010879, (LPCGUID)v4, v5, 6u, &pData);
      }
    }
LABEL_24:
    cData[0] = v0;
