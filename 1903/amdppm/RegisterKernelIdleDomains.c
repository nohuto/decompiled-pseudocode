/*
 * XREFs of RegisterKernelIdleDomains @ 0x1C0028E88
 * Callers:
...
__int64 __fastcall RegisterKernelIdleDomains(__int64 a1)
{
  ...
  _QWORD v33[3]; // [rsp+28h] [rbp-A1h] BYREF
  ...
  *v5 = *v2;
  ...
  if ( *v16 )
  {
    ...
    {
      v19 = 3 * v18;
      if ( v16[6 * v18 + 6] < **(_DWORD **)(a1 + 712) )
      {
        v20 = qword_1C0013458;
        if ( (__int64 *)qword_1C0013458 == &qword_1C0013458 )
          goto LABEL_23;
        do
        {
          v21 = v20;
        ...
        while ( (__int64 *)v20 != &qword_1C0013458 );
        if ( !v21 )
        {
LABEL_23:
          ...
          *(_QWORD *)(v21 + 16) = v21 + 16;
          v23 = (__int64 *)qword_1C0013460;
          if ( *(__int64 **)qword_1C0013460 != &qword_1C0013458 )
            goto LABEL_35;
          *(_QWORD *)v21 = &qword_1C0013458;
          *(_QWORD *)(v21 + 8) = v23;
          *v23 = v21;
          qword_1C0013460 = v21;
...
LABEL_35:
        ...
        *(_QWORD *)(v21 + 24) = v26;
        ...
        if ( *(_DWORD *)(v21 + 32) != *(_DWORD *)(v21 + 44) )
          goto LABEL_32;
        v17 = i;
        v28 = *(_DWORD *)(*(_QWORD *)(a1 + 520) + 24 * (i + 1LL));
        if ( v28 < *v5 )
          break;
      }
LABEL_33:
    ...
    KeOrAffinityEx(*(_QWORD *)(32LL * v28 + *(_QWORD *)(a1 + 712) + 16) + 48LL, v34, v34);
LABEL_32:
    v17 = i;
    goto LABEL_33;
  }
