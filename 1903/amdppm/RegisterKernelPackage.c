/*
 * XREFs of RegisterKernelPackage @ 0x1C002BFC0
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall RegisterKernelPackage(__int64 a1)
{
  ...
  if ( *(_BYTE *)(a1 + 78) )
    ...
    v2 = ((__int64 (__fastcall *)(_QWORD))qword_1C0013720)(*(unsigned int *)(a1 + 56));
  v3 = v2;
  v4 = qword_1C0013448;
  if ( (__int64 *)qword_1C0013448 != &qword_1C0013448 )
  {
    do
    {
      v5 = v4;
    ...
    while ( (__int64 *)v4 != &qword_1C0013448 );
    if ( v5 )
      goto LABEL_12;
  }
  ...
  if ( PoolWithTag )
  {
    ...
    *(_DWORD *)(v5 + 32) = v3;
    *(_DWORD *)(v5 + 36) = ((__int64 (__fastcall *)(_QWORD))qword_1C0013728)(v3);
    *(_DWORD *)(v5 + 36) += HalPrivateDispatchTable[145](v3);
    *(_QWORD *)(v5 + 24) = v5 + 16;
    *(_QWORD *)(v5 + 16) = v5 + 16;
    v8 = (__int64 *)qword_1C0013450;
    if ( *(__int64 **)qword_1C0013450 != &qword_1C0013448 )
      goto LABEL_15;
    *(_QWORD *)v5 = &qword_1C0013448;
    *(_QWORD *)(v5 + 8) = v8;
    *v8 = v5;
    qword_1C0013450 = v5;
LABEL_12:
