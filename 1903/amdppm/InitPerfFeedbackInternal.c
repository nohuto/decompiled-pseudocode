/*
 * XREFs of InitPerfFeedbackInternal @ 0x1C0029F7C
 * Callers:
 *     RegisterHvPerfFeedbackCounters @ 0x1C00216C0 (RegisterHvPerfFeedbackCounters.c)
 *     RegisterKernelPerfFeedback @ 0x1C002A360 (RegisterKernelPerfFeedback.c)
 * Callees:
