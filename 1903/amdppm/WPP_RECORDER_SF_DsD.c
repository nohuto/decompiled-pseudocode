/*
 * XREFs of WPP_RECORDER_SF_DsD @ 0x1C000AD54
 * Callers:
 *     ValidateAcpi_PSD_TSD @ 0x1C002F04C (ValidateAcpi_PSD_TSD.c)
 * Callees:
...
__int64 WPP_RECORDER_SF_DsD(__int64 a1, __int64 a2, __int64 a3, unsigned __int16 a4, int a5, ...)
{
  ...
  LOWORD(v13) = a4;
  return WppAutoLogTrace(a1, 2LL, 1LL, &WPP_885f9b737e553b3972faa1b865470758_Traceguids, v13, (__int64 *)va);
}
