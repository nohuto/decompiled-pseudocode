/*
 * XREFs of USBHwSelectAudioConfiguration @ 0x1C002A3AC
 * Callers:
 *     USBDeviceStart @ 0x1C0029190 (USBDeviceStart.c)
 * Callees:
 *     memmove @ 0x1C00123C0 (memmove.c)
 *     USBHwAllocateAndBag @ 0x1C0029C6C (USBHwAllocateAndBag.c)
 *     USBHwSubmitUrbToUsbdSynch @ 0x1C0029CC0 (USBHwSubmitUrbToUsbdSynch.c)
 *     USBParseCreateMIDLegacyInterfaceList @ 0x1C002BF14 (USBParseCreateMIDLegacyInterfaceList.c)
 *     USBParseCreateInterfaceList @ 0x1C002BFF8 (USBParseCreateInterfaceList.c)
 */
...
LABEL_13:
  if ( v6 >= 0 )
  {
    ...
    {
      v6 = USBHwSubmitUrbToUsbdSynch(*(PDEVICE_OBJECT *)(a1 + 40), (PURB)ConfigurationRequest, 0LL);
