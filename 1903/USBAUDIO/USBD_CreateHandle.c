/*
 * XREFs of USBD_CreateHandle @ 0x1C000FEF4
 * Callers:
 *     USBDeviceGetOffloadCapability @ 0x1C0029A20 (USBDeviceGetOffloadCapability.c)
 *     USBHwSelectStreamingAudioInterfaceSideband @ 0x1C002AA28 (USBHwSelectStreamingAudioInterfaceSideband.c)
 * Callees:
 *     USBDInternal_BuildAndSendQueryInterfaceSynchronously @ 0x1C000F614 (USBDInternal_BuildAndSendQueryInterfaceSynchronously.c)
