/*
 * XREFs of USBHwGetDeviceIDString @ 0x1C002B790
 * Callers:
 *     USBDeviceStart @ 0x1C0029190 (USBDeviceStart.c)
 * Callees:
 *     memmove @ 0x1C00123C0 (memmove.c)
 *     RegistryReadPnPKeyValue @ 0x1C0028574 (RegistryReadPnPKeyValue.c)
 *     USBHwSyncGetStringDescriptor @ 0x1C002B698 (USBHwSyncGetStringDescriptor.c)
 */
