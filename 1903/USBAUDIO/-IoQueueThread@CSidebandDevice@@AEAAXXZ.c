/*
 * XREFs of ?IoQueueThread@CSidebandDevice@@AEAAXXZ @ 0x1C000C1A8
 * Callers:
 *     ?staticIoQueueThread@CSidebandDevice@@SAXPEAX@Z @ 0x1C000C570 (-staticIoQueueThread@CSidebandDevice@@SAXPEAX@Z.c)
 * Callees:
