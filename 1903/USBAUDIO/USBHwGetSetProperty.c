/*
 * XREFs of USBHwGetSetProperty @ 0x1C0029E4C
 * Callers:
 *     USBHwGetSetByte @ 0x1C0029FB0 (USBHwGetSetByte.c)
 *     USBHwGetSetShort @ 0x1C002A060 (USBHwGetSetShort.c)
 *     USBHwGetSetMemory @ 0x1C002A120 (USBHwGetSetMemory.c)
 *     USBCntrlGetSetGEQ @ 0x1C002EBB0 (USBCntrlGetSetGEQ.c)
 *     USBCntrlGetSetProcessingUnitValue @ 0x1C002ED70 (USBCntrlGetSetProcessingUnitValue.c)
 *     USBCntrlMuxSource @ 0x1C002EE20 (USBCntrlMuxSource.c)
 *     USBCntrlGetSetMixerLevels @ 0x1C002EED0 (USBCntrlGetSetMixerLevels.c)
