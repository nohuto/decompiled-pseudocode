/*
 * XREFs of PropertyAudioSignalProcessingPinValidation @ 0x1C0025C2C
 * Callers:
 *     PropertyAudioSignalProcessingBasicSupport @ 0x1C0025CD0 (PropertyAudioSignalProcessingBasicSupport.c)
