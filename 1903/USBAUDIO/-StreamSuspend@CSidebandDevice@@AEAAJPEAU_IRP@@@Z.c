/*
 * XREFs of ?StreamSuspend@CSidebandDevice@@AEAAJPEAU_IRP@@@Z @ 0x1C000E41C
 * Callers:
    ...
    if ( CSidebandDevice::IsValidEndpointIndex(this, NamedPipeType) )
    {
      ...
      if ( PinFromEpIndex >= 0 )
      {
        ...
        if ( PinFromEpIndex >= 0 )
        {
          ...
          PinFromEpIndex = PinSetDeviceState(v11, 0LL);
          v23 = PinFromEpIndex;
          v5 = PinFromEpIndex;
          if ( PinFromEpIndex >= 0 || WPP_RECORDER_INITIALIZED == (_UNKNOWN *)&WPP_RECORDER_INITIALIZED )
            goto LABEL_30;
          v10 = 96;
        }
        else
