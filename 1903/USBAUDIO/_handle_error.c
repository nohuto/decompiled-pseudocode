/*
 * XREFs of _handle_error @ 0x1C0011038
 * Callers:
 *     log10 @ 0x1C0010BC8 (log10.c)
 *     _pow_special @ 0x1C0011170 (_pow_special.c)
 * Callees:
 *     __security_check_cookie @ 0x1C0010AE0 (__security_check_cookie.c)
 *     _call_matherr @ 0x1C0010F08 (_call_matherr.c)
 *     _exception_enabled @ 0x1C0010F78 (_exception_enabled.c)
 *     _raise_exc @ 0x1C0011340 (_raise_exc.c)
 *     _set_errno_from_matherr @ 0x1C0011600 (_set_errno_from_matherr.c)
