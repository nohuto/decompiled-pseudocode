/*
 * XREFs of USBHwDataPipeReset @ 0x1C002B990
 * Callers:
 ...
 *     USBType1HandleUrbError @ 0x1C002F644 (USBType1HandleUrbError.c)
 *     USBCaptureStartTransfers @ 0x1C002FFC0 (USBCaptureStartTransfers.c)
 * Callees:
 *     WPP_RECORDER_SF_qd @ 0x1C0001404 (WPP_RECORDER_SF_qd.c)
 *     PinWaitForStarvation @ 0x1C00023BC (PinWaitForStarvation.c)
 *     USBHwAbortOrResetPipe @ 0x1C002B8F4 (USBHwAbortOrResetPipe.c)
 */
