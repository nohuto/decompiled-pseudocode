/*
 * XREFs of PropertyAudioSignalProcessingBasicSupport @ 0x1C0025CD0
 * Callers:
 *     <none>
 * Callees:
 *     PropertyAudioSignalProcessingPinValidation @ 0x1C0025C2C (PropertyAudioSignalProcessingPinValidation.c)
 */
