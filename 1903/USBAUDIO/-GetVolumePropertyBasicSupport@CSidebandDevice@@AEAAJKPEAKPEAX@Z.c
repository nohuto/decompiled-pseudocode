/*
 * XREFs of ?GetVolumePropertyBasicSupport@CSidebandDevice@@AEAAJKPEAKPEAX@Z @ 0x1C000AB28
 * Callers:
 ...
 *     PropertyGetDbBasicSupportSideband @ 0x1C0026C78 (PropertyGetDbBasicSupportSideband.c)
 */
