 ...
 *     USBCaptureCompleteCallback @ 0x1C00059D0 (USBCaptureCompleteCallback.c)
 ...
 *     ?IrpMJInternalIoControlHandler@CSidebandDevice@@UEAAJPEAU_DEVICE_OBJECT@@PEAU_IRP@@@Z @ 0x1C000BA00 (-IrpMJInternalIoControlHandler@CSidebandDevice@@UEAAJPEAU_DEVICE_OBJECT@@PEAU_IRP@@@Z.c)
 ...
 *     ?EmptyAndCancelIrpsInQueue@CSidebandDevice@@AEAAJPEAU_LIST_ENTRY@@@Z @ 0x1C000C498 (-EmptyAndCancelIrpsInQueue@CSidebandDevice@@AEAAJPEAU_LIST_ENTRY@@@Z.c)
 *     ?staticCsqCompleteCanceledIrp@CSidebandDevice@@SAXPEAU_IO_CSQ@@PEAU_IRP@@@Z @ 0x1C000C680 (-staticCsqCompleteCanceledIrp@CSidebandDevice@@SAXPEAU_IO_CSQ@@PEAU_IRP@@@Z.c)
 ...
 *     PinReset @ 0x1C0022310 (PinReset.c)
 *     USBHwGetTransportResources @ 0x1C002A580 (USBHwGetTransportResources.c)
 *     USBHwSetTransportResources @ 0x1C002A880 (USBHwSetTransportResources.c)
