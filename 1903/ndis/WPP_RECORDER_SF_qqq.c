 ...
 *     ?ndisSetupMiniportProtocolHandlers@@YAXPEAU_NDIS_OPEN_BLOCK@@PEAU_NDIS_PROTOCOL_BLOCK@@PEAU_NDIS_MINIPORT_BLOCK@@@Z @ 0x1C002493C (-ndisSetupMiniportProtocolHandlers@@YAXPEAU_NDIS_OPEN_BLOCK@@PEAU_NDIS_PROTOCOL_BLOCK@@PEAU_NDIS.c)
 ...
 *     ndisOidPrePMProtocolOffloadList @ 0x1C0074400 (ndisOidPrePMProtocolOffloadList.c)
 ...
 * 00000001C0008B3C: jb      loc_1C004637E
 ...
 * 00000001C004637E: lea     rax, [rdi+rdi*4]
 * 00000001C0046382: add     rax, rax
 * 00000001C0046385: cmp     [rcx+rax*8+29h], sil
 * 00000001C004638A: jb      loc_1C0008B42
 * 00000001C0046390: mov     rcx, [rsp+68h+arg_20]; struct _GUID *
 * 00000001C0046398: lea     rax, [rsp+68h+arg_38]
 * 00000001C00463A0: mov     [rsp+68h+var_28], 0
 * 00000001C00463A9: lea     r8, [rsp+68h+arg_28]
 * 00000001C00463B1: mov     [rsp+68h+var_30], 8
 * 00000001C00463BA: mov     r9d, 8
 * 00000001C00463C0: mov     [rsp+68h+var_38], rax
 * 00000001C00463C5: lea     rax, [rsp+68h+arg_30]
 * 00000001C00463CD: mov     [rsp+68h+var_40], 8
 * 00000001C00463D6: movzx   edx, bp; unsigned __int16
 * 00000001C00463D9: mov     [rsp+68h+var_48], rax
 * 00000001C00463DE: call    ?ndisWppFastTraceMessage@@YAXPEBU_GUID@@GZZ; ndisWppFastTraceMessage(_GUID const *,ushort,...)
 * 00000001C00463E3: nop
 * 00000001C00463E4: jmp     loc_1C0008B42
 */
