/*
 * XREFs of ?ndisPcwEnumerateInstances@@YAJPEAU_PCW_BUFFER@@@Z @ 0x1C00AF50C
 * Callers:
...
__int64 __fastcall ndisPcwEnumerateInstances(PPCW_BUFFER Buffer)
{
  ...
  while ( v5 && v2 >= 0 )
  {
    if ( v5->PnPDeviceState == NdisPnPDeviceStarted && (unsigned __int8)ndisReferenceMiniport((__int64)v5) )
    {
