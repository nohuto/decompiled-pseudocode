/*
 * XREFs of ?NdisPDPIClearReceiveFilter@@YAXPEAUNDIS_PD_FILTER_HANDLE__@@@Z @ 0x1C011FE30
 * Callers:
 *     <none>
 * Callees:
 ...
 *     ??_GNDIS_PD_FILTER@@QEAAPEAXI@Z @ 0x1C011E0A0 (--_GNDIS_PD_FILTER@@QEAAPEAXI@Z.c)
 */
...
void __fastcall NdisPDPIClearReceiveFilter(struct NDIS_PD_FILTER_HANDLE__ *a1)
{
  ...
  v13.m_Lock = (KPushLockBase *)qword_1C00E67A8;
