/*
 * XREFs of ndisMAllocSGListS @ 0x1C0079544
 * Callers:
...
LABEL_50:
  ...
  if ( v18 )
  {
    ...
    *(_QWORD *)&a2->MacReserved[a2->Private.NdisPacketOobOffset + 24] = v18;
    Status = (*(__int64 (__fastcall **)(_QWORD, _QWORD, struct _MDL *, char *, UINT, void (__fastcall *)(struct _DEVICE_OBJECT *, struct _IRP *, struct _SCATTER_GATHER_LIST *, struct _NDIS_PACKET *), struct _NDIS_PACKET *, char, _SLIST_ENTRY *, _DWORD))(*(_QWORD *)(*(_QWORD *)(v2 + 24) + 8LL) + 112LL))(
               *(_QWORD *)(v2 + 24),
               *(_QWORD *)(a1 + 3824),
               v40,
               v21,
  ...
  {
    LOBYTE(v39) = 1;
    v22 = (*(__int64 (__fastcall **)(_QWORD, _QWORD, struct _MDL *, char *, _DWORD, void (__fastcall *)(struct _DEVICE_OBJECT *, struct _IRP *, struct _SCATTER_GATHER_LIST *, struct _NDIS_PACKET *), struct _NDIS_PACKET *, int))(*(_QWORD *)(*(_QWORD *)(v2 + 24) + 8LL) + 88LL))(
            *(_QWORD *)(v2 + 24),
            *(_QWORD *)(a1 + 3824),
            v40,
            v43,
...
LABEL_27:
  ...
  if ( v22 < 0 )
  {
    ...
    if ( PoolWithTag )
    {
      ...
      if ( Status )
        goto LABEL_35;
      ndisMCopyFromPacketToBuffer((_DWORD)a2, v30, Length, (_DWORD)v31, (__int64)&v46);
      if ( v46 == Length )
      {
        a2->Private.Flags |= 0x800u;
        ...
        *(_QWORD *)&a2->MacReserved[a2->Private.NdisPacketOobOffset + 24] = v33;
        ...
        v32 = (*(__int64 (__fastcall **)(__int64, _QWORD, PNDIS_BUFFER, char *, UINT, void (__fastcall *)(struct _DEVICE_OBJECT *, struct _IRP *, struct _SCATTER_GATHER_LIST *, struct _NDIS_PACKET *), struct _NDIS_PACKET *, int))(*(_QWORD *)(v36 + 8) + 88LL))(
                v36,
                *(_QWORD *)(a1 + 3824),
                v33,
                v34,
