/*
 * XREFs of ndisMInitializeMiniportBlockFront @ 0x1C012EEC0
 * Callers:
 ...
 * Callees:
 *     ndisInitializeULongRef @ 0x1C002F510 (ndisInitializeULongRef.c)
...
__int64 __fastcall ndisMInitializeMiniportBlockFront(char *DeferredContext, int a2)
{
  ...
  *((_QWORD *)DeferredContext + 245) = DeferredContext;
  ndisInitializeULongRef((__int64)(DeferredContext + 4432));
