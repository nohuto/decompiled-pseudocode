/*
 * XREFs of ?ndisOidPreMiniportSetEncapsulation@@YAEPEAU_NDIS_MINIPORT_BLOCK@@PEAU_NDIS_OID_REQUEST@@PEAH@Z @ 0x1C003CC50
 * Callers:
    ...
    *(_QWORD *)&v13->MiniportMergedEncapsulation.IPv6.Enabled = *((_QWORD *)InformationBuffer + 2);
    ...
    else
    {
      ...
      if ( a1->MajorNdisVersion < 6u )
      {
        ...
        ndisTranslateOffloadSetsToTasks((char)a1);
      ...
      else
      {
        ...
        a2->DATA.QUERY_INFORMATION.InformationBuffer = &v14->MiniportMergedEncapsulation;
