/*
 * XREFs of ?ndisPendWorkOnSetBusyAsyncLocked@@YAXPEAU_NDIS_SELECTIVE_SUSPEND@@W4_NDIS_SS_BUSY_REASON@@PEAXKPEAPEAU_NET_BUFFER_LIST@@PEAU_LIST_ENTRY@@PEAE@Z @ 0x1C00B5BE4
 * Callers:
 ...
 * Callees:
 *     ?ndisRemoveFromNblQueueByCancelId@@YAPEAU_NET_BUFFER_LIST@@PEAU_NBL_QUEUE@@PEAX@Z @ 0x1C00B5CBC (-ndisRemoveFromNblQueueByCancelId@@YAPEAU_NET_BUFFER_LIST@@PEAU_NBL_QUEUE@@PEAX@Z.c)
 *     ndisDequeueDirectOidsByRequestId @ 0x1C00B82B8 (ndisDequeueDirectOidsByRequestId.c)
 *     ndisQueueReceiveNblsOnMiniport @ 0x1C00B8958 (ndisQueueReceiveNblsOnMiniport.c)
 *     ndisQueueSendNblsOnMiniport @ 0x1C00B89C4 (ndisQueueSendNblsOnMiniport.c)
 */
