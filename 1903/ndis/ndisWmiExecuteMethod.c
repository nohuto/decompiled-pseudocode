 ...
 *     NdisWdfExecuteMethod @ 0x1C009EB80 (NdisWdfExecuteMethod.c)
 * Callees:
 ...
 *     ?ndisWmiXlateNdisOffloadToWmiOffload@@YAXPEAU_NDIS_OFFLOAD@@@Z @ 0x1C00A7848 (-ndisWmiXlateNdisOffloadToWmiOffload@@YAXPEAU_NDIS_OFFLOAD@@@Z.c)
 *     ?ndisWmiXlateNdisRecvQueueParamsToWmiRecvQueueParams@@YAXPEAU_NDIS_RECEIVE_QUEUE_PARAMETERS@@@Z @ 0x1C00A7B70 (-ndisWmiXlateNdisRecvQueueParamsToWmiRecvQueueParams@@YAXPEAU_NDIS_RECEIVE_QUEUE_PARAMETERS@@@Z.c)
