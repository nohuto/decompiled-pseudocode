/*
 * XREFs of NdisMIdleNotificationConfirm @ 0x1C00B6E00
 * Callers:
 *     <none>
 * Callees:
 ...
 *     ?ndisAoAcIdleRequestConfirm@@YAJPEAU_NDIS_MINIPORT_BLOCK@@@Z @ 0x1C00BACA8 (-ndisAoAcIdleRequestConfirm@@YAJPEAU_NDIS_MINIPORT_BLOCK@@@Z.c)
