/*
 * XREFs of ?ndisVerifyNdisTryAcquireRWLockWrite@@YAEPEAU_NDIS_RW_LOCK_EX@@PEAU_LOCK_STATE_EX@@E@Z @ 0x1C00C4090
 * Callers:
 *     <none>
 * Callees:
 ...
 *     NdisTryAcquireRWLockWrite @ 0x1C00C4330 (NdisTryAcquireRWLockWrite.c)
 */
