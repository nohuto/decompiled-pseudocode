/*
 * XREFs of ?RtlUnicodeStringCopyString@@YAJPEAU_UNICODE_STRING@@PEB_W@Z @ 0x1C001F460
 * Callers:
 ...
 * Callees:
 *     RtlWideCharArrayCopyStringWorker @ 0x1C001F4BC (RtlWideCharArrayCopyStringWorker.c)
 *     RtlUnicodeStringValidateDestWorker @ 0x1C001F524 (RtlUnicodeStringValidateDestWorker.c)
 */
