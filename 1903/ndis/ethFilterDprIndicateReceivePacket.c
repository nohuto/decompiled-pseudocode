/*
 * XREFs of ethFilterDprIndicateReceivePacket @ 0x1C00A2310
 * Callers:
 *     <none>
 * Callees:
 ...
 *     ethFilterReceivePacketStats @ 0x1C00A309C (ethFilterReceivePacketStats.c)
...
void __fastcall ethFilterDprIndicateReceivePacket(struct _NDIS_MINIPORT_BLOCK *a1, ULONG_PTR a2, unsigned int a3)
{
  unsigned int Number; // ebp
  _X_FILTER *EthDB; // r15
  signed int PnPFlags; // r8d
    ...
    if ( SingleActiveOpen && SingleActiveOpen->ProtocolMajorVersion < 6 )
    {
         ...
         || *(_NDIS_OPEN_BLOCK **)&v11->MacReserved[v11->Private.NdisPacketOobOffset + 24] != SingleActiveOpen) )
      {
        ...
        *((_BYTE *)SingleActiveOpen->ReceivedAPacketSlot + 4096 * Number) = 1;
        ...
        {
          ethFilterReceivePacketStats(a1, MappedSystemVa, (unsigned int)ByteCount);
          Flags = v11->Private.Flags;
        ...
        v28 = IndicatedPacket[v27];
        IndicatedPacket[v27] = v11;
        if ( (_BYTE)v92
              ...
              *((_BYTE *)OpenList->ReceivedAPacketSlot + 4096 * v81) = 1;
              ...
              if ( v72 && (v65 = OpenList->ReceivePacketHandler) != 0LL && (!v59 || v84->SingleActiveOpen) )
              {
                ...
                if ( v66 && v62 == -1073741670 )
                {
                  ndisNblTrackerTransferOwnershipSingleNbl(
                    v66,
                    (struct NDIS_NBL_TRACKER_HANDLE__ *)v61,
                    OpenList->NblTracker,
                    ByteCount);
        ...
        || *(_NDIS_OPEN_BLOCK **)&v11->MacReserved[v11->Private.NdisPacketOobOffset + 24] != v36 )
      {
        ...
        *((_BYTE *)v36->ReceivedAPacketSlot + 4096 * Number) = 1;
        ...
        else
        {
          ...
          {
            ndisNblTrackerTransferOwnershipSingleNbl(v45, (struct NDIS_NBL_TRACKER_HANDLE__ *)v40, v36->NblTracker, v39);
        ...
        if ( *(_MDL **)((char *)&v11[1].Private.Head + v11->Private.NdisPacketOobOffset) )
        {
          ...
          *(unsigned int *)((char *)&v11->Private.Count + v11->Private.NdisPacketOobOffset) = 259;
          if ( (v11[-1].Reserved[1] & 1) == 0 || *(_DWORD *)&v11[-1].ProtocolReserved[4] != -1 )
          {
            v74 = v11;
LABEL_126:
            ndisReturnPacketToNetBufferList(a1, v74);
            goto LABEL_136;
          }
LABEL_131:
