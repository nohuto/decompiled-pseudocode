/*
 * XREFs of ?NdisTraceLoggingRscConfigOffloads@@YAXPEAU_NDIS_MINIPORT_BLOCK@@PEAU_NDIS_OFFLOAD@@@Z @ 0x1C0020BDC
 * Callers:
...
void __fastcall NdisTraceLoggingRscConfigOffloads(struct _NDIS_MINIPORT_BLOCK *a1, struct _NDIS_OFFLOAD *a2)
{
  ...
  if ( hProvider.LevelPlus1 > 5 )
  {
    if ( TlgKeywordOn(&hProvider, 0x200000000000uLL) )
    {
      ...
      v11 = 4LL;
      v13 = 4LL;
      TlgWrite(&hProvider, &unk_1C00D128E, v2, (LPCGUID)v3, 5u, &pData);
    }
  }
}
