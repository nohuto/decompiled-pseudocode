/*
 * XREFs of ?moveElements@?$KArray@ULwfBindProperties@@$00@Rtl@@AEAAXKKK@Z @ 0x1C01259E0
 * Callers:
 *     ?insertAt@?$KArray@ULwfBindProperties@@$00@Rtl@@QEAA_N_K$$QEAULwfBindProperties@@@Z @ 0x1C0125814 (-insertAt@-$KArray@ULwfBindProperties@@$00@Rtl@@QEAA_N_K$$QEAULwfBindProperties@@@Z.c)
 * Callees:
    ...
    if ( a2 >= a3 )
    {
      ...
      if ( v19 < v25 )
      {
        ...
        do
        {
          ...
          ++v19;
          v27 += 64LL;
          *(_OWORD *)(v28 + v26) = *(_OWORD *)v29;
          *(_DWORD *)(v28 + v26 + 16) = *(_DWORD *)(v29 + 16);
          v26 += 64LL;
          *(_DWORD *)(v28 + v26 - 44) = *(_DWORD *)(v29 + 20);
          *(_QWORD *)(v28 + v26 - 40) = *(_QWORD *)(v29 + 24);
          *(_QWORD *)(v29 + 24) = 0LL;
          *(_QWORD *)(v29 + 16) = 0LL;
          *(_DWORD *)(v28 + v26 - 32) = *(_DWORD *)(v29 + 32);
          *(_DWORD *)(v28 + v26 - 28) = *(_DWORD *)(v29 + 36);
          *(_QWORD *)(v28 + v26 - 24) = *(_QWORD *)(v29 + 40);
          *(_QWORD *)(v29 + 40) = 0LL;
          *(_QWORD *)(v29 + 32) = 0LL;
          *(_DWORD *)(v28 + v26 - 16) = *(_DWORD *)(v29 + 48);
          *(_BYTE *)(v28 + v26 - 12) = *(_BYTE *)(v29 + 52);
          *(_DWORD *)(v28 + v26 - 8) = *(_DWORD *)(v29 + 56);
        }
        while ( v19 < v25 );
      }
      if ( v19 < a2 + a4 )
