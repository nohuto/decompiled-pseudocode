/*
 * XREFs of ?ndisCompareGuid@@YAJPEBU_GUID@@0@Z @ 0x1C0011F54
 * Callers:
 ...
 *     ?ndisIfFindAvailableCompartmentId@@YAIPEBU_GUID@@@Z @ 0x1C00639FC (-ndisIfFindAvailableCompartmentId@@YAIPEBU_GUID@@@Z.c)
