 ...
 * Callers:
 *     ndisNsiSetAllJobInformation @ 0x1C00ABF20 (ndisNsiSetAllJobInformation.c)
 * Callees:
 ...
 *     ndisIfSetCompartmentJobObject @ 0x1C0067CD4 (ndisIfSetCompartmentJobObject.c)
 *     ?ndisCmDereferenceCompartment@@YAXPEAX@Z @ 0x1C00ABAA4 (-ndisCmDereferenceCompartment@@YAXPEAX@Z.c)
