/*
 * XREFs of ndisDeviceInternalDispatch @ 0x1C00A4C88
 * Callers:
 *     NdisWdfDeviceInternalControlIrpHandler @ 0x1C009EB50 (NdisWdfDeviceInternalControlIrpHandler.c)
 *     ndisDeviceInternalIrpDispatch @ 0x1C00A4DA0 (ndisDeviceInternalIrpDispatch.c)
 * Callees:
