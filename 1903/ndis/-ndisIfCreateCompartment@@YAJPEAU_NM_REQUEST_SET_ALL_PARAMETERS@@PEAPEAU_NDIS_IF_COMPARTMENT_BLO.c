/*
 * XREFs of ?ndisIfCreateCompartment@@YAJPEAU_NM_REQUEST_SET_ALL_PARAMETERS@@PEAPEAU_NDIS_IF_COMPARTMENT_BLOCK@@@Z @ 0x1C0062F30
 * Callers:
        ...
        struct _NDIS_IF_COMPARTMENT_BLOCK **a2)
{
  __int64 v2; // r14
  int Network; // esi
  struct _NDIS_IF_COMPARTMENT_BLOCK **v4; // r12
  char v6; // bp
  _GUID *v7; // rbx
  KIRQL v8; // r15
    ...
    if ( Network >= 0 )
    {
      ...
      *v4 = v28;
      ...
      else
      {
        ...
        v13 = v28;
        v28->LoopbackInfo.NamespaceGuid = CompartmentBlock->LoopbackInfo.CompartmentGuid;
