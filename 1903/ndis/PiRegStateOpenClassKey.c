/*
 * XREFs of PiRegStateOpenClassKey @ 0x1C0128D48
 * Callers:
...
__int64 __fastcall PiRegStateOpenClassKey(unsigned int *a1, __int64 a2, int a3, int *a4, _QWORD *a5)
{
  ...
  int v12; // esi
  int v13; // edi
  __int64 v14; // [rsp+70h] [rbp-61h] BYREF
  HANDLE Handle; // [rsp+78h] [rbp-59h] BYREF
  __int64 v16[2]; // [rsp+80h] [rbp-51h] BYREF
  ...
  *a5 = 0LL;
  ...
  if ( (int)result >= 0 )
  {
    ...
    if ( (_DWORD)v14 )
    {
      WstrKey = CmRegUtilCreateWstrKey((int)Handle, (int)Dest, v8, v9, 0LL, (__int64)&v14, (__int64)v16);
      v12 = v14;
    }
    else
    {
