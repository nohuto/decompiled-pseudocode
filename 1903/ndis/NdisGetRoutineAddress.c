/*
 * XREFs of NdisGetRoutineAddress @ 0x1C0039A40
 * Callers:
 *     ?ndisVerifierGetRoutineAddress@@YAPEAXPEAU_UNICODE_STRING@@@Z @ 0x1C00A98B0 (-ndisVerifierGetRoutineAddress@@YAPEAXPEAU_UNICODE_STRING@@@Z.c)
 * Callees:
 *     FindExportedRoutineByName @ 0x1C0039AAC (FindExportedRoutineByName.c)
 */
