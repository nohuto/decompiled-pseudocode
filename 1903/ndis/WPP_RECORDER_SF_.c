 ...
 *     NdisCloseFile @ 0x1C0080B20 (NdisCloseFile.c)
 *     NdisOpenFile @ 0x1C0081470 (NdisOpenFile.c)
 *     NdisUnmapFile @ 0x1C0081BC0 (NdisUnmapFile.c)
 ...
 *     ?NdisGetVersion640Shim@@YAIXZ @ 0x1C00C2440 (-NdisGetVersion640Shim@@YAIXZ.c)
 ...
 * 00000001C0011CE0: jb      loc_1C0054A78
 ...
 * 00000001C0054A78: lea     rax, [rdi+rdi*4]
 * 00000001C0054A7C: add     rax, rax
 * 00000001C0054A7F: cmp     [rcx+rax*8+29h], bpl
 * 00000001C0054A84: jb      loc_1C0011CE6
 * 00000001C0054A8A: mov     rcx, [rsp+48h+arg_20]; struct _GUID *
 * 00000001C0054A8F: xor     r8d, r8d
 * 00000001C0054A92: movzx   edx, si; unsigned __int16
 * 00000001C0054A95: call    ?ndisWppFastTraceMessage@@YAXPEBU_GUID@@GZZ; ndisWppFastTraceMessage(_GUID const *,ushort,...)
 * 00000001C0054A9A: nop
 * 00000001C0054A9B: jmp     loc_1C0011CE6
 */
