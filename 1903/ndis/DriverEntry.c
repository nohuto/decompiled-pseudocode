 ...
 *     McGenEventRegister @ 0x1C00327CC (McGenEventRegister.c)
 *     ndisDoesSystemSupportSriov @ 0x1C00328FC (ndisDoesSystemSupportSriov.c)
 *     ?ndisRegisterPDCounterSets@@YAXXZ @ 0x1C0032C84 (-ndisRegisterPDCounterSets@@YAXXZ.c)
 ...
 *     ndisVerifierInitialization @ 0x1C003F6C0 (ndisVerifierInitialization.c)
...
NTSTATUS __stdcall DriverEntry(_DRIVER_OBJECT *DriverObject, PUNICODE_STRING RegistryPath)
{
  ...
  *(_OWORD *)&ObjectAttributes.SecurityDescriptor = 0LL;
  ...
  qword_1C00E7F40 = (__int64)&ndisGlobalPacketPoolList;
  ndisGlobalPacketPoolList.Flink = &ndisGlobalPacketPoolList;
  qword_1C00E7F28 = (__int64)&ndisGlobalNetBufferPoolList;
  ndisGlobalNetBufferPoolList.Flink = &ndisGlobalNetBufferPoolList;
  qword_1C00E7F08 = (__int64)&ndisGlobalNetBufferListPoolList;
  ndisGlobalNetBufferListPoolList.Flink = &ndisGlobalNetBufferListPoolList;
  qword_1C00E6AC8 = (__int64)&ndisGlobalTimerList;
  ...
  *(_QWORD *)&v62.PoolTag = 1684948046LL;
  ...
  else
  {
    ...
    qword_1C00E6210 = (__int64)KeRegisterProcessorChangeCallback(
