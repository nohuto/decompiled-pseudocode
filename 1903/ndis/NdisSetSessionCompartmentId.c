/*
 * XREFs of NdisSetSessionCompartmentId @ 0x1C00ABB90
 * Callers:
 *     ndisNsiSetAllSessionInformation @ 0x1C00ABFC0 (ndisNsiSetAllSessionInformation.c)
 * Callees:
 ...
 *     ?ndisCmLazyInitializeCleanup@@YAXXZ @ 0x1C00ABAB8 (-ndisCmLazyInitializeCleanup@@YAXXZ.c)
 */
