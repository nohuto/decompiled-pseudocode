/*
 * XREFs of ?ndisVerifierFreeMemory@@YAXPEAXII@Z @ 0x1C00A97F0
 * Callers:
 *     <none>
 * Callees:
 *     NdisFreeMemory @ 0x1C001A390 (NdisFreeMemory.c)
 */
...
void __fastcall ndisVerifierFreeMemory(char *VirtualAddress, UINT Length, UINT MemoryFlags)
{
  ...
  if ( (WORD2(WPP_MAIN_CB.Queue.Wcb.DeviceRoutine) & 0x400) != 0 )
  {
    ...
    if ( (WORD2(WPP_MAIN_CB.Queue.Wcb.DeviceRoutine) & 0x800) == 0 )
    {
