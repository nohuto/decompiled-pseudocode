/*
 * XREFs of ?ndisNblVerifyRxIndication@@YAXPEBU_NET_BUFFER_LIST@@KKKPEBU_NDIS_OBJECT_HEADER@@W4_NDIS_MEDIUM@@@Z @ 0x1C00A9D28
 * Callers:
 ...
 * Callees:
 *     ndisParseReceivedNBL @ 0x1C009C070 (ndisParseReceivedNBL.c)
        ...
        enum _NDIS_MEDIUM a6)
{
  ...
  _DWORD v20[21]; // [rsp+24h] [rbp-54h] BYREF
  ...
  if ( v7 )
  {
    ...
    do
    {
      ...
      LOBYTE(v22) = 0;
      if ( ndisParseReceivedNBL(a6, v9, v20, (char *)&v22) && (_BYTE)v22 )
      {
        v11 |= LOWORD(v20[0]);
        v12 |= ~LOWORD(v20[0]);
      }
