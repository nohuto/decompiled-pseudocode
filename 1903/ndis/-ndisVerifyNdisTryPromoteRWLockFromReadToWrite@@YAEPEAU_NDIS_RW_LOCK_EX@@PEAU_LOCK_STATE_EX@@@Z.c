/*
 * XREFs of ?ndisVerifyNdisTryPromoteRWLockFromReadToWrite@@YAEPEAU_NDIS_RW_LOCK_EX@@PEAU_LOCK_STATE_EX@@@Z @ 0x1C00C4110
 * Callers:
 *     <none>
 * Callees:
 ...
 *     ?IncrementReadConcurrency@@YAXPEAUNDIS_VERIFY_RW_LOCK_EX@@@Z @ 0x1C00C3C94 (-IncrementReadConcurrency@@YAXPEAUNDIS_VERIFY_RW_LOCK_EX@@@Z.c)
 ...
 *     NdisTryPromoteRWLockFromReadToWrite @ 0x1C00C4410 (NdisTryPromoteRWLockFromReadToWrite.c)
 */
