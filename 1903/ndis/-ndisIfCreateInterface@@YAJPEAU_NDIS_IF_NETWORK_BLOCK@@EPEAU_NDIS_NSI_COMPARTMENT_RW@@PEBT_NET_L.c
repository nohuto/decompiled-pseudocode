 ...
 *     ?ndisIsValidIfString@@YAEPEBU_IF_COUNTED_STRING_LH@@@Z @ 0x1C003F52C (-ndisIsValidIfString@@YAEPEBU_IF_COUNTED_STRING_LH@@@Z.c)
...
LABEL_76:
          ...
          *((_QWORD *)v13 + 79) = 1LL;
          if ( v43 )
          {
            RtlInitUnicodeString(&DestinationString, &xmmword_1C00E6222);
            ...
            *((_WORD *)v13 + 24) = Destination.Length;
            RtlInitUnicodeString(&DestinationString, &xmmword_1C00E6432);
            *(_DWORD *)&Destination.Length = 0x2000000;
