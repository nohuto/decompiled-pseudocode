/*
 * XREFs of ?ndisNetBufferToPacket@@YAHPEAU_NET_BUFFER@@EPEAPEAU_NDIS_PACKET@@@Z @ 0x1C0079F40
 * Callers:
...
__int64 __fastcall ndisNetBufferToPacket(struct _NET_BUFFER *a1, char a2, struct _NDIS_PACKET **a3)
{
  ...
  __int64 result; // rax
  PNDIS_PACKET v8; // rcx
  $51DBE7D49081C70A4012B25DC692ADFB *ProtocolReserved; // r9
  _MDL *CurrentMdl; // rdx
  ...
  *a3 = 0LL;
  ...
  if ( !Status )
  {
    ...
    ProtocolReserved = ($51DBE7D49081C70A4012B25DC692ADFB *)v8->ProtocolReserved;
    if ( !a2 )
