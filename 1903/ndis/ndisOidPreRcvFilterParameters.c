/*
 * XREFs of ndisOidPreRcvFilterParameters @ 0x1C0060750
 * Callers:
 *     <none>
 * Callees:
...
LABEL_13:
  ...
  NewIrql = KeAcquireSpinLockRaiseToDpc(&v3->Lock);
  ...
  v14 = v5 + ReceiveFilterByFilterId->RequestBuffer * HIDWORD(ReceiveFilterByFilterId->ReturnPacketsQueue);
  *(_DWORD *)(v1 + 68) = v14;
  if ( v14 <= *(_DWORD *)(v1 + 52) )
  {
    memmove(v17, (char *)&ReceiveFilterByFilterId->PacketList.Flink + 4, v5);
    v17[5] = v5;
    memmove(&v17[v5 / 4], (char *)p_Type + p_Type[38], p_Type[40] * p_Type[39]);
    v3->MiniportThread = 0LL;
