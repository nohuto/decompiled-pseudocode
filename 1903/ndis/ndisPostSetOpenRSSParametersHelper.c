/*
 * XREFs of ndisPostSetOpenRSSParametersHelper @ 0x1C003B8B8
 * Callers:
...
void __fastcall ndisPostSetOpenRSSParametersHelper(_QWORD *a1, __int64 a2, __int64 a3)
{
  unsigned int v6; // edx
  unsigned int v7; // esi
  KSPIN_LOCK *v8; // rbx
  ...
  if ( v6 > v7 )
    v7 = v6;
  v10 = *(_WORD *)(a3 + 4) & 0x10;
  v11 = KeAcquireSpinLockRaiseToDpc(a1 + 12);
  v12 = a1[7];
  NewIrql = v11;
