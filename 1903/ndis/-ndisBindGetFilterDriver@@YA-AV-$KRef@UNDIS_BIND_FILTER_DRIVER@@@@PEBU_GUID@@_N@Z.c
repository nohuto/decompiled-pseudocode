/*
 * XREFs of ?ndisBindGetFilterDriver@@YA?AV?$KRef@UNDIS_BIND_FILTER_DRIVER@@@@PEBU_GUID@@_N@Z @ 0x1C01028F4
 * Callers:
 *     NdisFRegisterFilterDriver @ 0x1C00373A0 (NdisFRegisterFilterDriver.c)
 *     ?BuildFilterLink@BindStack@Ndis@@AEAA?AV?$unique_ptr@UNDIS_BIND_FILTER_LINK@@U?$default_delete@UNDIS_BIND_FILTER_LINK@@@wistd@@@wistd@@PEBU_GUID@@K@Z @ 0x1C010280C (-BuildFilterLink@BindStack@Ndis@@AEAA-AV-$unique_ptr@UNDIS_BIND_FILTER_LINK@@U-$default_delete@U.c)
 * Callees:
 ...
 *     ?grow@?$KArray@V?$KRef@UNDIS_BIND_FILTER_DRIVER@@@@$00@Rtl@@AEAA_N_K@Z @ 0x1C010A8F4 (-grow@-$KArray@V-$KRef@UNDIS_BIND_FILTER_DRIVER@@@@$00@Rtl@@AEAA_N_K@Z.c)
 *     ??$allocate@$$V@?$KRef@UNDIS_BIND_FILTER_DRIVER@@@@QEAA_NXZ @ 0x1C010AED0 (--$allocate@$$V@-$KRef@UNDIS_BIND_FILTER_DRIVER@@@@QEAA_NXZ.c)
...
_QWORD *__fastcall ndisBindGetFilterDriver(_QWORD *a1, _QWORD *a2, char a3)
{
  ...
  v21.m_Lock = (KPushLockBase *)qword_1C00E67B8;
  v21.m_Region.m_Entered = 0;
  KLockHolder::AcquireExclusive(&v21);
  v6 = qword_1C00E67B8;
  v7 = 0LL;
  v8 = *(unsigned int *)(qword_1C00E67B8 + 28);
  v20 = v8;
  while ( v7 != v8 )
  {
    ...
    *(_OWORD *)((char *)P + 24) = *(_OWORD *)a2;
    if ( ndisBindReadFilterDriverConfiguration(v14) )
    {
      ...
      if ( (unsigned __int8)Rtl::KArray<KRef<NDIS_BIND_FILTER_DRIVER>,1>::grow(
                              qword_1C00E67B8 + 24,
                              (unsigned int)(*(_DWORD *)(qword_1C00E67B8 + 28) + 1)) )
      {
