/*
 * XREFs of ?ndisVerifyNdisTryAcquireRWLockRead@@YAEPEAU_NDIS_RW_LOCK_EX@@PEAU_LOCK_STATE_EX@@E@Z @ 0x1C00C4010
 * Callers:
 *     <none>
 * Callees:
 ...
 *     NdisTryAcquireRWLockRead @ 0x1C00C4270 (NdisTryAcquireRWLockRead.c)
 */
