/*
 * XREFs of ndisWmiQueryAllData @ 0x1C00A8D0C
 * Callers:
 *     ndisWMIDispatch @ 0x1C00191AC (ndisWMIDispatch.c)
 *     NdisWdfQueryAllData @ 0x1C009F010 (NdisWdfQueryAllData.c)
 * Callees:
 ...
 *     ?ndisWmiGuidIsAdapterSpecific@@YAEPEAU_GUID@@@Z @ 0x1C00A74E4 (-ndisWmiGuidIsAdapterSpecific@@YAEPEAU_GUID@@@Z.c)
