/*
 * XREFs of ndisMValidatePMWakePacket @ 0x1C00736CC
 * Callers:
 ...
 *     ndisMEvaluateMagicPacketWake @ 0x1C0073128 (ndisMEvaluateMagicPacketWake.c)
    ...
    if ( (v8 & 7) == 0 )
    {
      if ( (unsigned int)v8 <= v4 && v6 + v8 >= v6 )
      {
        ...
        if ( v9 >= (unsigned int)v8 && v9 <= v4 )
        {
          ...
          if ( *(_DWORD *)(v6 + 148) >= 0x80u && (byte_1C00E8045 & 0x20) != 0 )
