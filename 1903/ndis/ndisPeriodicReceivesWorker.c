/*
 * XREFs of ndisPeriodicReceivesWorker @ 0x1C00AEEC0
 * Callers:
 *     <none>
 * Callees:
 ...
 *     ?ndisGetMiniportIndicateList@@YAPEAU_NET_BUFFER_LIST@@PEAU_NDIS_MINIPORT_BLOCK@@@Z @ 0x1C00ACC8C (-ndisGetMiniportIndicateList@@YAPEAU_NET_BUFFER_LIST@@PEAU_NDIS_MINIPORT_BLOCK@@@Z.c)
