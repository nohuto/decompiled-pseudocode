/*
 * XREFs of ?moveElements@?$KArray@V?$unique_ptr@UNDIS_BIND_PROTOCOL_LINK@@U?$default_delete@UNDIS_BIND_PROTOCOL_LINK@@@wistd@@@wistd@@$00@Rtl@@AEAAXKKK@Z @ 0x1C010A5F8
 * Callers:
  ...
  if ( a2 != a3 && a4 )
  {
    if ( a2 >= a3 )
    {
      ...
      if ( v18 < a3 + a4 )
      {
        ...
        do
        {
          wistd::unique_ptr<NDIS_BIND_PROTOCOL_LINK,wistd::default_delete<NDIS_BIND_PROTOCOL_LINK>>::`scalar deleting destructor'((NDIS_BIND_LINK_BASE **)(v26 + *(_QWORD *)(a1 + 8)));
          v27 = *(_QWORD *)(a1 + 8);
          v28 = v18 + v19;
          v29 = v28;
          ++v18;
      ...
      if ( v18 < a2 + a4 )
      {
        ...
        do
        {
          result = wistd::unique_ptr<NDIS_BIND_PROTOCOL_LINK,wistd::default_delete<NDIS_BIND_PROTOCOL_LINK>>::`scalar deleting destructor'((NDIS_BIND_LINK_BASE **)(v31 + *(_QWORD *)(a1 + 8)));
          v31 += 8LL;
          --v32;
        }
        while ( v32 );
    ...
    else
    {
      ...
      if ( v8 > a3 )
      {
        ...
        {
          v14 = v8 - 1;
          wistd::unique_ptr<NDIS_BIND_PROTOCOL_LINK,wistd::default_delete<NDIS_BIND_PROTOCOL_LINK>>::`scalar deleting destructor'((NDIS_BIND_LINK_BASE **)(*(_QWORD *)(a1 + 8) + 8 * v14));
          v15 = *(_QWORD *)(a1 + 8);
          v16 = v8 - v9 - 1;
      ...
      while ( v8 > a2 )
        result = wistd::unique_ptr<NDIS_BIND_PROTOCOL_LINK,wistd::default_delete<NDIS_BIND_PROTOCOL_LINK>>::`scalar deleting destructor'((NDIS_BIND_LINK_BASE **)(*(_QWORD *)(a1 + 8) + 8LL * --v8));
    }
  }
  return result;
}
