        ...
        __int64 a2)
{
  ...
  v8.m_State = Unlocked;
  v8.m_Lock = (KPushLockBase *)qword_1C00E67B8;
...
LABEL_17:
    ...
    v4 = qword_1C00E67B8;
    v8.m_State = Shared;
    if ( *(unsigned int *)(qword_1C00E67B8 + 44) < i )
      goto LABEL_16;
    if ( i >= *(unsigned int *)(qword_1C00E67B8 + 44) )
      goto LABEL_17;
    if ( (*(_QWORD *)(*(_QWORD *)(qword_1C00E67B8 + 48) + 8 * i) != 0LL) != (v6 != 0LL) )
LABEL_16:
      i = 0LL;
    if ( v6 )
    {
