/*
 * XREFs of ?ndisMInitializeScatterGatherDmaInternal@@YAHPEAXEKK@Z @ 0x1C0035504
 * Callers:
 *     NdisMRegisterScatterGatherDma @ 0x1C00353C0 (NdisMRegisterScatterGatherDma.c)
 *     NdisMInitializeScatterGatherDma @ 0x1C0078F60 (NdisMInitializeScatterGatherDma.c)
 * Callees:
 ...
 *     ndisAssignSGListLookasideList @ 0x1C0035C78 (ndisAssignSGListLookasideList.c)
