...
__int64 __fastcall ndisPktMonOpenRegister(__int64 a1)
{
  ...
  v13[0] = 786442LL;
  v12[0] = 1;
  v6 = PktMonClientComponentRegister(a1 + 920, v1 + 808, v1 + 72, 4, *(_DWORD *)(v4 + 464));
  if ( v6 )
  {
...
LABEL_16:
    v6 = PktMonClientAddEdge(v2, (__int64)v13, v9, v10, *(_DWORD *)(*(_QWORD *)(a1 + 16) + 464LL), (_QWORD *)(a1 + 936));
    if ( !v6 )
      return v6;
    if ( WPP_RECORDER_INITIALIZED != (_UNKNOWN *)&WPP_RECORDER_INITIALIZED )
    {
