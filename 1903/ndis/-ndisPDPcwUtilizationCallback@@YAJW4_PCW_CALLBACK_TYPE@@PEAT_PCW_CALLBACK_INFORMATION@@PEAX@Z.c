/*
 * XREFs of ?ndisPDPcwUtilizationCallback@@YAJW4_PCW_CALLBACK_TYPE@@PEAT_PCW_CALLBACK_INFORMATION@@PEAX@Z @ 0x1C00BF940
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall ndisPDPcwUtilizationCallback(int a1, union _PCW_CALLBACK_INFORMATION *a2, void *a3)
{
  ...
  v7 = qword_1C00E67A8;
  v8 = qword_1C00E67A8 + 8;
  v9 = *(_QWORD **)(qword_1C00E67A8 + 8);
  while ( v9 != (_QWORD *)v8 )
  {
    v10 = (__int64 *)v9[6];
    if ( v10 != v9 + 6 )
