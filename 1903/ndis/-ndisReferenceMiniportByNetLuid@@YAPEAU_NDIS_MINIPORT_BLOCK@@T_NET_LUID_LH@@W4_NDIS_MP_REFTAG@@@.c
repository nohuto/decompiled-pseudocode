/*
 * XREFs of ?ndisReferenceMiniportByNetLuid@@YAPEAU_NDIS_MINIPORT_BLOCK@@T_NET_LUID_LH@@W4_NDIS_MP_REFTAG@@@Z @ 0x1C00BCB14
 * Callers:
...
struct _NDIS_MINIPORT_BLOCK *__fastcall ndisReferenceMiniportByNetLuid(union _NET_LUID_LH a1, enum _NDIS_MP_REFTAG a2)
{
  ...
  {
    v6 = ndisIfReferenceMiniport((__int64)InterfaceByNetLuid);
    v8 = v6;
    if ( v6 )
    {
      if ( (*(_DWORD *)(v6 + 124) & 0x1080110) == 0
        && *(_DWORD *)(v6 + 1520) == 1
        && (unsigned __int8)ndisReferenceMiniport(v6) )
      {
