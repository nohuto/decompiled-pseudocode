/*
 * XREFs of ?ndisPublishSleepStudyCustomDataCsSpuriousWakeStats@@YAXEPEBU_GUID@@PEAU_NDIS_MINIPORT_CS_SPURIOUS_WAKE_STATS@@PEAU_NDIS_MINIPORT_CS_SPURIOUS_WAKE_STATS_EX@@@Z @ 0x1C011C8B4
 * Callers:
        ...
        struct _NDIS_MINIPORT_CS_SPURIOUS_WAKE_STATS_EX *a4)
{
  ...
  v5 = (const wchar_t **)off_1C00CBFF0;
  v9 = 11LL;
  do
  {
  ...
  while ( v9 );
  v10 = (const wchar_t **)off_1C00CBFC0;
  v11 = 5LL;
  do
  {
