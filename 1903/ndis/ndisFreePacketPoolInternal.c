/*
 * XREFs of ndisFreePacketPoolInternal @ 0x1C0081C50
 * Callers:
 *     NdisFreePacketPool @ 0x1C0081150 (NdisFreePacketPool.c)
 *     ?ndisVerifierFreePacketPool@@YAXPEAX@Z @ 0x1C00A9890 (-ndisVerifierFreePacketPool@@YAXPEAX@Z.c)
 * Callees:
 *     ?ndisFreePacketPoolHdr@@YAXPEAU_NDIS_PKT_POOL_HDR@@PEAU_NDIS_PKT_POOL@@@Z @ 0x1C0080604 (-ndisFreePacketPoolHdr@@YAXPEAU_NDIS_PKT_POOL_HDR@@PEAU_NDIS_PKT_POOL@@@Z.c)
 */
