/*
 * XREFs of ndisWdfNotifyDevicePower @ 0x1C00A6F44
 * Callers:
 ...
 *     ndisWdfPowerResumeComplete @ 0x1C00BA5BC (ndisWdfPowerResumeComplete.c)
 *     ndisWdfSendPmParametersForSuspend @ 0x1C00BA608 (ndisWdfSendPmParametersForSuspend.c)
 *     ?ndisAoAcPauseRefTimeAccumulation@@YAXPEAU_NDIS_MINIPORT_AOAC@@@Z @ 0x1C00BAE48 (-ndisAoAcPauseRefTimeAccumulation@@YAXPEAU_NDIS_MINIPORT_AOAC@@@Z.c)
 ...
 *     ?ndisWdfIsAoAcPowerTransition@@YAEPEAU_NDIS_MINIPORT_BLOCK@@@Z @ 0x1C00BD79C (-ndisWdfIsAoAcPowerTransition@@YAEPEAU_NDIS_MINIPORT_BLOCK@@@Z.c)
