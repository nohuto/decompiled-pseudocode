 ...
 *     NdisWdfDeviceControlIrpHandler @ 0x1C009EB20 (NdisWdfDeviceControlIrpHandler.c)
 * Callees:
 ...
 *     ndisIovIoctlDetach @ 0x1C00B1B80 (ndisIovIoctlDetach.c)
 *     ndisIovIoctlInvalidate @ 0x1C00B1BD8 (ndisIovIoctlInvalidate.c)
 *     ndisIovIoctlNotification @ 0x1C00B1CDC (ndisIovIoctlNotification.c)
