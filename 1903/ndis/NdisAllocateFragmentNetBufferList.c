/*
 * XREFs of NdisAllocateFragmentNetBufferList @ 0x1C007A0A0
 * Callers:
 *     <none>
 * Callees:
 ...
 *     NetioCopyOpaqueNetBufferListInformation @ 0x1C007AA7C (NetioCopyOpaqueNetBufferListInformation.c)
...
LABEL_55:
    ...
    if ( byte_1C00E5E20 )
    {
      NetBufferAndNetBufferList->NetBufferListInfo[13] = (void *)v36[31];
    }
    else if ( Microsoft_Windows_Networking_CorrelationEnabled )
    {
      ...
      *(_QWORD *)(((unsigned __int64)v42 & 0xFFFFFFFFFFFFFFC0uLL) + 0x80) = v36[31] & 0x7FFFFFFFFFFFFFFFLL;
