/*
 * XREFs of ?ndisIfRegisterInterfaceEx@@YAHPEAXT_NET_LUID_LH@@0PEAU_NET_IF_INFORMATION@@W4NdisIfBlockSource@@KPEAK@Z @ 0x1C0024C80
 * Callers:
 *     NdisIfRegisterInterface @ 0x1C00666F0 (NdisIfRegisterInterface.c)
