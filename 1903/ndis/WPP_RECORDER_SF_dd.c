 ...
 * 00000001C001D7B1: jb      loc_1C005A00C
 ...
 * 00000001C005A00C: lea     rax, [rbx+rbx*4]
 * 00000001C005A010: add     rax, rax
 * 00000001C005A013: cmp     [rcx+rax*8+29h], r14b
 * 00000001C005A018: jb      loc_1C001D7B7
 * 00000001C005A01E: and     [rsp+58h+var_28], 0
 * 00000001C005A024: lea     rax, [rsp+58h+arg_30]
 * 00000001C005A02C: mov     rcx, [rsp+58h+arg_20]; struct _GUID *
 * 00000001C005A034: lea     r8, [rsp+58h+arg_28]
 * 00000001C005A03C: mov     [rsp+58h+var_30], r14
 * 00000001C005A041: mov     r9, r14
 * 00000001C005A044: movzx   edx, di; unsigned __int16
 * 00000001C005A047: mov     [rsp+58h+var_38], rax
 * 00000001C005A04C: call    ?ndisWppFastTraceMessage@@YAXPEBU_GUID@@GZZ; ndisWppFastTraceMessage(_GUID const *,ushort,...)
 * 00000001C005A051: nop
 * 00000001C005A052: jmp     loc_1C001D7B7
 */
