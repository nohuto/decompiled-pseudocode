 ...
 *     NdisWdfMiniportStarted @ 0x1C009EE40 (NdisWdfMiniportStarted.c)
        ...
        enum CallRunMode a4)
{
  ...
  if ( a2 )
  {
    if ( !Ndis::BindState::SetBinding(v8, BindingEnabled, a3) || (unsigned __int8)byte_1C00E673B < 4u )
      goto LABEL_3;
  ...
  {
    if ( !Ndis::BindState::SetBinding(v8, BindingDisabled, a3) || (unsigned __int8)byte_1C00E673B < 4u )
      goto LABEL_3;
    v11 = a1 ? *(unsigned __int16 **)(a1 + 3856) : 0LL;
    if ( WPP_RECORDER_INITIALIZED == (_UNKNOWN *)&WPP_RECORDER_INITIALIZED )
      goto LABEL_3;
