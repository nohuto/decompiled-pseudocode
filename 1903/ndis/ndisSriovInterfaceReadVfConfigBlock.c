/*
 * XREFs of ndisSriovInterfaceReadVfConfigBlock @ 0x1C011B240
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall ndisSriovInterfaceReadVfConfigBlock(__int64 a1, __int16 a2, int a3, void *a4, size_t Size)
{
  int v8; // edx
  ...
  if ( PoolWithTag )
  {
    ...
    *(_QWORD *)((char *)v15 + 4) = 12LL;
    ...
    if ( !SetMiniport )
      memmove(a4, (char *)v11 + (unsigned int)v11[4], (unsigned int)Size);
