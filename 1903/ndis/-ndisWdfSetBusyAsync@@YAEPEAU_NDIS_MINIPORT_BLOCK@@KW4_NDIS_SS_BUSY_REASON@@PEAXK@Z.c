/*
 * XREFs of ?ndisWdfSetBusyAsync@@YAEPEAU_NDIS_MINIPORT_BLOCK@@KW4_NDIS_SS_BUSY_REASON@@PEAXK@Z @ 0x1C00B62D0
 * Callers:
...
LABEL_6:
  ...
  if ( v7 )
  {
    if ( byte_1C00E5E20 && (*((_DWORD *)&a1->PktMonComp + 3) & 2) != 0 )
      PktMonClientNblDropNdis((_DWORD)a1 + 5800, (_DWORD)v7, v20, 2, -1071448017, -536866804);
    Alignment = v7;
    do
    {
