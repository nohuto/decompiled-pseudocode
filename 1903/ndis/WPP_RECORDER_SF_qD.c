 ...
 *     ?NdisPDGetBuffersFromBufferSet@@YAXPEAUPD_BUFFER_SET_HANDLE__@@PEAKPEAPEAU_PD_BUFFER@@@Z @ 0x1C00BED40 (-NdisPDGetBuffersFromBufferSet@@YAXPEAUPD_BUFFER_SET_HANDLE__@@PEAKPEAPEAU_PD_BUFFER@@@Z.c)
 ...
 * 00000001C0009DFF: jb      loc_1C004700E
 ...
 * 00000001C004700E: lea     rax, [rdi+rdi*4]
 * 00000001C0047012: add     rax, rax
 * 00000001C0047015: cmp     [rcx+rax*8+29h], sil
 * 00000001C004701A: jb      loc_1C0009E05
 * 00000001C0047020: and     [rsp+68h+var_38], 0
 * 00000001C0047026: lea     rax, [rsp+68h+arg_30]
 * 00000001C004702E: mov     rcx, [rsp+68h+arg_20]; struct _GUID *
 * 00000001C0047036: lea     r8, [rsp+68h+arg_28]
 * 00000001C004703E: mov     [rsp+68h+var_40], rbx
 * 00000001C0047043: mov     r9d, 8
 * 00000001C0047049: movzx   edx, bp; unsigned __int16
 * 00000001C004704C: mov     [rsp+68h+var_48], rax
 * 00000001C0047051: call    ?ndisWppFastTraceMessage@@YAXPEBU_GUID@@GZZ; ndisWppFastTraceMessage(_GUID const *,ushort,...)
 * 00000001C0047056: nop
 * 00000001C0047057: jmp     loc_1C0009E05
 */
