/*
 * XREFs of ?ndisPnPIrpDeviceUsageNotification@@YAJPEAU_DEVICE_OBJECT@@PEAU_NDIS_MINIPORT_BLOCK@@PEAU_IRP@@PEAE3@Z @ 0x1C00A3D64
 * Callers:
        ...
        unsigned __int8 *a5)
{
  ...
  if ( CurrentStackLocation->Parameters.Create.Options == 1 )
  {
    ...
    *(_OWORD *)&CurrentStackLocation[-1].Parameters.ReadWriteConfig.Length = *(_OWORD *)&CurrentStackLocation->Parameters.ReadWriteConfig.Length;
    ...
    v12 = IoSynchronousCallDriver(a2->NextDeviceObject, a3, a3, a4);
    v10 = v12;
    if ( !Lock || v12 >= 0 )
