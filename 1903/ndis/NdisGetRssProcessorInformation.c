/*
 * XREFs of NdisGetRssProcessorInformation @ 0x1C0034510
 * Callers:
 *     ndisGetAdapterRssInfo @ 0x1C0021168 (ndisGetAdapterRssInfo.c)
 *     ndisGetHardwareInfo @ 0x1C00950D8 (ndisGetHardwareInfo.c)
 * Callees:
 *     ndisCalculateRssProcessorCount @ 0x1C003461C (ndisCalculateRssProcessorCount.c)
 *     ndisPopulateRssProcessorSet @ 0x1C00346C0 (ndisPopulateRssProcessorSet.c)
 */
