/*
 * XREFs of ?ndisBuildBindings@@YAJPEBU_GUID@@AEAUBindStack@Ndis@@@Z @ 0x1C0125E24
 * Callers:
 ...
 *     ??1NetworkInterfaceBindProperties@@QEAA@XZ @ 0x1C00C7268 (--1NetworkInterfaceBindProperties@@QEAA@XZ.c)
 ...
 *     ndisIntersectAtoms @ 0x1C012624C (ndisIntersectAtoms.c)
