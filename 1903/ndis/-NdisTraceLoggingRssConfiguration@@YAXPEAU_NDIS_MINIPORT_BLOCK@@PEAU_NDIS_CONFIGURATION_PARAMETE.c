/*
 * XREFs of ?NdisTraceLoggingRssConfiguration@@YAXPEAU_NDIS_MINIPORT_BLOCK@@PEAU_NDIS_CONFIGURATION_PARAMETER@@H@Z @ 0x1C0030818
 * Callers:
        ...
        struct _NDIS_CONFIGURATION_PARAMETER *a2)
{
  ...
  if ( hProvider.LevelPlus1 > 5 && TlgKeywordOn(&hProvider, 0x200000000000uLL) )
  {
    ...
    v14 = &v8;
    v15 = 4LL;
    TlgWrite(&hProvider, &unk_1C00D0D6C, v2, v3, 5u, &pData);
  }
}
