/*
 * XREFs of ??$RegisterNodeForVisit@VIBitmapRealization@@@CDebugTreeDumper@@QEAAXPEAVIBitmapRealization@@_N@Z @ 0x180174194
 * Callers:
...
__int64 __fastcall CDebugTreeDumper::RegisterNodeForVisit<IBitmapRealization>(__int64 a1, __int64 a2)
{
  __int64 v2; // rdi
  __int64 result; // rax
  __int64 v5; // r8
  ...
  {
    v16 = 0LL;
    std::function_void___cdecl_void___CDebugTreeDumper____::operator___lambda_fab49bea0c152df40203ec606f021e9f__void_((__int64)v15);
    v8 = v9;
