/*
 * XREFs of ?AnimationEnded@BamoCompObjectDiagnosticsRootProxyImpl@BamoImpl@@QEAAJI_KIIW4AnimationEndedReasonType@@W4DCOMPOSITION_EXPRESSION_TYPE@@PEBEI@Z @ 0x180199A84
 * Callers:
...
LABEL_3:
  ...
  v11[1] = v9;
  LOWORD(v8) = 4;
  return CoreUICallSend(v10, v11, 2LL, 0LL, v8, &unk_1802BE013, a2, a3);
}
