/*
 * XREFs of ?ComputeNormalizedLine@MeshGraph@Mesh@@SA?AVLine2d@2@AEBUD2D_VECTOR_2F@@0@Z @ 0x1801B9BEC
 * Callers:
 ...
 *     ?ComputeRadialIndex@MeshGraph@Mesh@@SAMAEBVLine2d@2@@Z @ 0x1801B9D08 (-ComputeRadialIndex@MeshGraph@Mesh@@SAMAEBVLine2d@2@@Z.c)
 */
  ...
  *(_QWORD *)a1 = *a2;
  ...
  if ( !*(_BYTE *)(v3 + 17) && !*(_BYTE *)(v3 + 16) )
  {
    ...
    if ( v7 <= 0.000099999997 )
    {
      ...
      v9 = (struct D2D_VECTOR_2F)_mm_unpacklo_ps(v8, v4).m128_u64[0];
LABEL_13:
      v13 = v9;
                                                          ...
                                                          - 1.4142135)) & _xmm) <= 0.000099999997 )
    {
      ...
      v9 = (struct D2D_VECTOR_2F)_mm_unpacklo_ps(v4, v10).m128_u64[0];
      goto LABEL_13;
    }
  }
LABEL_14:
  ...
  {
    v13 = (struct D2D_VECTOR_2F)_mm_unpacklo_ps(
