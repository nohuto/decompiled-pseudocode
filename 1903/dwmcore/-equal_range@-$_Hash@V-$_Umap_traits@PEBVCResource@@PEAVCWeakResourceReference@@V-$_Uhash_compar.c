        ...
        unsigned __int8 *a3)
{
  ...
  v8 = v5 & qword_18033FFC0;
  for ( i = *(_QWORD *)(qword_18033FFA8 + 16 * (v5 & qword_18033FFC0)); ; i = *v12 )
  {
    v10 = i;
    ...
    {
      do
        v15 = std::_Hash<std::_Umap_traits<CResource const *,CWeakResourceReference *,std::_Uhash_compare<CResource const *,std::hash<CResource const *>,std::equal_to<CResource const *>>,std::allocator<std::pair<CResource const * const,CWeakResourceReference *>>,0>>::_End(
                (__int64)&CWeakResourceReference::s_weakReferenceMap,
                &v20,
                v8);
