/*
 * XREFs of McTemplateU0qqqxxpp @ 0x1801C5180
 * Callers:
...
ULONG __fastcall McTemplateU0qqqxxpp(
        __int64 a1,
        __int64 a2,
        __int64 a3,
        int a4,
        ...
        char a9)
{
  ...
  v22 = 8LL;
  v24 = 8LL;
  return McGenEventWrite(Microsoft_Windows_Dwm_Core_Provider_Context, &EVTDESC_VISUAL_SET_INTERACTION, a3, 8u, &v10);
}
