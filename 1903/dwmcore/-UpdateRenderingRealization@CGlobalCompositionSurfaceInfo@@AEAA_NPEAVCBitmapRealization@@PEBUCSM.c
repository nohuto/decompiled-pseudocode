/*
 * XREFs of ?UpdateRenderingRealization@CGlobalCompositionSurfaceInfo@@AEAA_NPEAVCBitmapRealization@@PEBUCSM_BUFFER_ATTRIBUTES@@PEAUHRGN__@@PEBUScrollOptimization@@_N@Z @ 0x18003C618
 * Callers:
        ...
        bool a6)
{
  ...
  else
  {
    ...
    if ( (unsigned __int8)operator!=(&v56) || !(unsigned __int8)CMILMatrix::IsEqualTo<0>(v51, v49) )
      v7 = 1;
    v26 = v37;
    if ( v37
  ...
  if ( *((_BYTE *)this + 80) )
  {
    if ( v6 )
    {
      ...
      {
        v39 = v34;
        if ( !detail::basic_iterator<CD3DDeviceLevel1::CUnpinResource>::operator!=(&v39, &v40) )
          break;
