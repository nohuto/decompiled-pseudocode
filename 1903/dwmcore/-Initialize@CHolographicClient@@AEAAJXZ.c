/*
 * XREFs of ?Initialize@CHolographicClient@@AEAAJXZ @ 0x180249034
 * Callers:
...
__int64 __fastcall CHolographicClient::Initialize(LARGE_INTEGER *this)
{
  ...
  AnalogExclusiveTokenEvent = NtTokenManagerGetAnalogExclusiveTokenEvent(&this[31]);
  if ( AnalogExclusiveTokenEvent >= 0 )
  {
    ...
    if ( v5 < 0 )
      ...
      QueryPerformanceFrequency(this + 34);
  }
  else
  {
