/*
 * XREFs of ?Unregister@BamoDataProviderRegistrarPrincipalImpl@BamoImpl@@QEAAJI@Z @ 0x180196D00
 * Callers:
 *     ?Thunk_Unregister_5@?$IDataProviderRegistrarPrincipal_Receive@VBamoDataProviderRegistrarPrincipalImpl@BamoImpl@@@@SAJPEAXPEAPEAX@Z @ 0x180196CF0 (-Thunk_Unregister_5@-$IDataProviderRegistrarPrincipal_Receive@VBamoDataProviderRegistrarPrincipa.c)
 * Callees:
        ...
        unsigned int a2)
{
  ...
  v7 = v4[5];
  v8 = v6;
  v9 = *(Microsoft::BamoImpl::BaseBamoConnectionImpl **)(*(_QWORD *)(v7 + 24) + 24LL);
  Item = Microsoft::BamoImpl::BaseBamoConnectionImpl::GetItem(v9, *(unsigned int *)(v7 + 36), a2);
  v11 = Item;
  if ( Item )
    v12 = (char *)Item - 16;
  else
