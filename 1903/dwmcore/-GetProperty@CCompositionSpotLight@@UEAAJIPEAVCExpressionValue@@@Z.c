/*
 * XREFs of ?GetProperty@CCompositionSpotLight@@UEAAJIPEAVCExpressionValue@@@Z @ 0x1800B62D0
 * Callers:
 *     <none>
 * Callees:
...
LABEL_9:
  ...
  {
    v3 = -2147024809;
    MilInstrumentationCheckHR_MaybeFailFast(v6, 0LL, v7, 0x80070057, 0xA1u, (void *)(v7 & v11));
  }
  return v3;
}
