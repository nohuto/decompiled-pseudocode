/*
 * XREFs of ?GenerateMaskIntermediate@ShadowIntermediates@CDropShadow@@CAJPEAVCDrawingContext@@AEBUD2D_SIZE_F@@PEAVCSpriteVisualContent@@PEAPEAVCRenderTargetImageSource@@@Z @ 0x18000D7A0
 * Callers:
...
LABEL_14:
  ...
  v14 = CDrawingContext::Clear(this, &stru_180283020);
  v10 = v14;
  if ( v14 < 0 )
  {
