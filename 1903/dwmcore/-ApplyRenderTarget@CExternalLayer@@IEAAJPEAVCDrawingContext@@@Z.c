/*
 * XREFs of ?ApplyRenderTarget@CExternalLayer@@IEAAJPEAVCDrawingContext@@@Z @ 0x18007ADCC
 * Callers:
  ...
  *(_QWORD *)&v22.b = 0LL;
  ...
  else
  {
    ...
    *((_BYTE *)this + 33) = 1;
    ...
    v20 = (float)v17[32];
    v21 = v11;
    v5 = CDrawingContext::PushGpuClipRectInternal((__int64)a2, 0LL, (float *)&v18, 1, 1);
    v7 = v5;
    if ( v5 < 0 )
    {
      v16 = 158;
