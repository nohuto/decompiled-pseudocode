/*
 * XREFs of ?ApplyMaskToValue@CExpressionValue@@QEAAJPEAVSubchannelMaskInfo@@@Z @ 0x1801C1AF8
 * Callers:
...
__int64 __fastcall CExpressionValue::ApplyMaskToValue(CExpressionValue *this, struct SubchannelMaskInfo *a2)
{
  ...
  for ( i = 0; i < v5; *((_DWORD *)&v26 + v9) = v8 )
  {
    ...
    else
    {
      ...
      {
        v10 = -2147467259;
        MilInstrumentationCheckHR_MaybeFailFast(v9, 0LL, 0, 0x80004005, 0x30Au, 0LL);
        return v10;
      }
    ...
    {
      v10 = -2147467259;
      MilInstrumentationCheckHR_MaybeFailFast(v12, 0LL, 0, 0x80004005, 0x315u, 0LL);
      return v10;
    }
    if ( i >= 0x10 )
    {
      v10 = -2147467259;
      MilInstrumentationCheckHR_MaybeFailFast(v12, 0LL, 0, 0x80004005, 0x320u, 0LL);
      return v10;
    }
    v8 = LODWORD(v30[v13]);
    v9 = i++;
...
LABEL_29:
  ...
  v10 = -2147467259;
  MilInstrumentationCheckHR_MaybeFailFast(v9, 0LL, 0, 0x80004005, 0x357u, 0LL);
  return v10;
}
