/*
 * XREFs of ?TransformInput@CInteractionContextTransformHelper@@QEAAJAEBUtagPOINTER_INFO@@_NPEAU2@@Z @ 0x18025EFB4
 * Callers:
 ...
 *     s_TransformPointByMatrix @ 0x18025F8DC (s_TransformPointByMatrix.c)
 */
