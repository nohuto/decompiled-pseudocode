/*
 * XREFs of ?SendInteractionSummary@CTelemetryTouchLatencyAnalysis@@AEAAJXZ @ 0x18018F55C
 * Callers:
 ...
 *     ?zInternalRelatedId@?$_TlgActivityBase@V?$TraceLoggingActivity@$1?g_hDwmInteractionProvider@@3QEBU_TlgProvider_t@@EB$0A@$04U_TlgReflectorTag_Param0IsHProvider@@@@$0A@$04@@QEBAPEBU_GUID@@XZ @ 0x1800EA8F4 (-zInternalRelatedId@-$_TlgActivityBase@V-$TraceLoggingActivity@$1-g_hDwmInteractionProvider@@3QE.c)
 ...
 *     ??0?$TraceLoggingActivity@$1?g_hDwmInteractionProvider@@3QEBU_TlgProvider_t@@EB$0A@$04U_TlgReflectorTag_Param0IsHProvider@@@@QEAA@XZ @ 0x18018E58C (--0-$TraceLoggingActivity@$1-g_hDwmInteractionProvider@@3QEBU_TlgProvider_t@@EB$0A@$04U_TlgRefle.c)
 *     ??1?$TraceLoggingActivity@$1?g_hDwmInteractionProvider@@3QEBU_TlgProvider_t@@EB$0A@$04U_TlgReflectorTag_Param0IsHProvider@@@@QEAA@XZ @ 0x18018E5A0 (--1-$TraceLoggingActivity@$1-g_hDwmInteractionProvider@@3QEBU_TlgProvider_t@@EB$0A@$04U_TlgRefle.c)
...
LABEL_35:
        ...
        if ( (unsigned int)hProvider > 5 && TlgKeywordOn((TraceLoggingHProvider)&hProvider, 0LL) )
        {
          ...
          TlgWrite((TraceLoggingHProvider)&hProvider, &unk_1802DA368, &pActivityId, v33, 2u, &pData);
        }
        if ( (unsigned int)hProvider > 4 )
        {
          if ( TlgKeywordOn((TraceLoggingHProvider)&hProvider, 0x400000000002uLL) )
          {
            ...
            *(float *)v40.m128i_i32 = (float)v41;
            ...
            v214 = (char *)this + 3888;
            v215 = v207;
            TlgWrite((TraceLoggingHProvider)&hProvider, &unk_1802DA030, &pActivityId, 0LL, 0x37u, &v106);
          }
          if ( (unsigned int)hProvider > 4 )
          {
            if ( TlgKeywordOn((TraceLoggingHProvider)&hProvider, 0x400000000002uLL) )
            {
              ...
              v256 = 0;
              v258 = 4LL;
              TlgWrite((TraceLoggingHProvider)&hProvider, &unk_1802D9ACC, &pActivityId, 0LL, 0x4Au, &v106);
            }
            else
            {
              v45 = (char *)this + 3180;
            ...
            if ( (unsigned int)hProvider > 4 && TlgKeywordOn((TraceLoggingHProvider)&hProvider, 0x400000000002uLL) )
            {
              ...
              TlgWrite((TraceLoggingHProvider)&hProvider, &unk_1802D9669, &pActivityId, 0LL, 0x42u, &v106);
            }
          }
        }
        v104 = 2;
        if ( (unsigned int)hProvider > 5 && TlgKeywordOn((TraceLoggingHProvider)&hProvider, 0LL) )
          TlgWrite((TraceLoggingHProvider)&hProvider, &unk_1802D9643, &pActivityId, 0LL, 2u, &pData);
      }
    }
  }
LABEL_65:
