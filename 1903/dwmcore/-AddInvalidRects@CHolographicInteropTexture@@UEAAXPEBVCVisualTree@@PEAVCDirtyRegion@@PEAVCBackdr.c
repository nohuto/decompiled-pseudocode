/*
 * XREFs of ?AddInvalidRects@CHolographicInteropTexture@@UEAAXPEBVCVisualTree@@PEAVCDirtyRegion@@PEAVCBackdropRegion@@@Z @ 0x180246880
 * Callers:
 *     <none>
 * Callees:
        ...
        struct CBackdropRegion *a4)
{
  ...
  unsigned int v8; // eax
  __int64 v9; // r14
  struct D2D_RECT_F v10; // [rsp+20h] [rbp-38h] BYREF
  ...
  if ( v6 )
  {
    ...
    else
    {
      ...
      if ( v8 )
      {
        ...
        do
        {
          v10 = *(struct D2D_RECT_F *)(v5 + v6 + 1116);
          CDirtyRegion::Add(a3, 0LL, 0, &v10);
          v5 += 16LL;
          --v9;
        }
        while ( v9 );
