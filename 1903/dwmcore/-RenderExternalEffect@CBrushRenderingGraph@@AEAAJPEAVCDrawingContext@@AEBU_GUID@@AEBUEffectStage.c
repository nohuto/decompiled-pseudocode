/*
 * XREFs of ?RenderExternalEffect@CBrushRenderingGraph@@AEAAJPEAVCDrawingContext@@AEBU_GUID@@AEBUEffectStage@@AEBUIntermediateConfigurationInputs@1@PEAUEffectInput@@@Z @ 0x18003B01C
 * Callers:
 ...
 *     ?DetermineOutputScale@CCustomBlur@@SAMMMW4D2D1_GAUSSIANBLUR_OPTIMIZATION@@@Z @ 0x18003B574 (-DetermineOutputScale@CCustomBlur@@SAMMMW4D2D1_GAUSSIANBLUR_OPTIMIZATION@@@Z.c)
        ...
        struct EffectInput *a6)
{
  ...
  struct CRenderTargetImageSource *v72; // [rsp+68h] [rbp-A0h] BYREF
  struct ID2D1Bitmap1 *v73; // [rsp+70h] [rbp-98h] BYREF
  char *v74; // [rsp+78h] [rbp-90h] BYREF
  ...
  _BYTE v95[40]; // [rsp+188h] [rbp+80h] BYREF
  ...
  *((float *)&v98 + 1) = v21.m128_f32[0];
  v22 = Matrix3x3::operator*(v6 + 48, v95, v96);
  v23 = *(_OWORD *)v22;
  v24 = *(_OWORD *)(v22 + 16);
  ...
  *(_QWORD *)v96 = "DWM External Effect intermediate";
  ...
  else
  {
    ...
    *(_QWORD *)v96 = LODWORD(x_low);
    ...
    v59 = Matrix3x3::operator*(v74, v95, v96);
    v60 = *(_OWORD *)v59;
    v61 = *(_OWORD *)(v59 + 16);
