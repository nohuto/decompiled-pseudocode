/*
 * XREFs of ?TryGetDataForInteraction@CTelemetryComputeScribbleAggregator@@SA_NIPEAUComputeScribbleLatencyData@@@Z @ 0x180193BA0
 * Callers:
        ...
        struct ComputeScribbleLatencyData *a2)
{
  ...
  v4 = (_DWORD *)xmmword_18033FFD0;
  v5 = 1;
  v6 = *(_DWORD **)xmmword_18033FFD0;
  while ( v6 != v4 )
  {
    if ( a1 >= v6[4] && a1 <= v6[5] )
    {
