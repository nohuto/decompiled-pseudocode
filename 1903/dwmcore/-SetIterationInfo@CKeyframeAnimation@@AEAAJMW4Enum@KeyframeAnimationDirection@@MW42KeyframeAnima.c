/*
 * XREFs of ?SetIterationInfo@CKeyframeAnimation@@AEAAJMW4Enum@KeyframeAnimationDirection@@MW42KeyframeAnimationStopBehavior@@@Z @ 0x1800C6FE4
 * Callers:
        ...
        unsigned int a5)
{
  ...
  {
    v12 = -2147418113;
    MilInstrumentationCheckHR_MaybeFailFast(a1, 0LL, 0, 0x8000FFFF, 0x3D7u, 0LL);
    return v12;
  }
  if ( a2 != 1.0 )
  {
