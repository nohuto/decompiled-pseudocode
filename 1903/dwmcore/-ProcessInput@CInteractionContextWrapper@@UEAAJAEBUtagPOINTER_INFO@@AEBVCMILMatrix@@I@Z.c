/*
 * XREFs of ?ProcessInput@CInteractionContextWrapper@@UEAAJAEBUtagPOINTER_INFO@@AEBVCMILMatrix@@I@Z @ 0x180234AA0
 * Callers:
 *     <none>
 * Callees:
        ...
        int a4)
{
  ...
  *((_QWORD *)this + 31) = *((_QWORD *)a2 + 2);
  ...
  if ( dword_18033A240 > 4u && TlgKeywordOn((TraceLoggingHProvider)&dword_18033A240, 2uLL) )
  {
    ...
    v122 = v24;
    v124 = v24;
    TlgWrite(v23, &unk_1802DF0C9, 0LL, 0LL, 0x1Du, &pData);
