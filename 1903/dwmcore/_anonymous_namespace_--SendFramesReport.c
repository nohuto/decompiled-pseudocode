/*
 * XREFs of _anonymous_namespace_::SendFramesReport @ 0x18007B5F8
 * Callers:
 ...
 *     _anonymous_namespace_::QpcToFileTimeAndGetCurrentFileTime @ 0x1800A5B74 (_anonymous_namespace_--QpcToFileTimeAndGetCurrentFileTime.c)
 ...
 *     ??$_Insert_range@PEAD@?$vector@DV?$allocator@D@std@@@std@@AEAAXV?$_Vector_const_iterator@V?$_Vector_val@U?$_Simple_types@D@std@@@std@@@1@PEAD1Uforward_iterator_tag@1@@Z @ 0x1800C71B0 (--$_Insert_range@PEAD@-$vector@DV-$allocator@D@std@@@std@@AEAAXV-$_Vector_const_iterator@V-$_Vec.c)
 *     ??$_Emplace_reallocate@D@?$vector@DV?$allocator@D@std@@@std@@QEAAPEADQEAD$$QEAD@Z @ 0x1800C72F0 (--$_Emplace_reallocate@D@-$vector@DV-$allocator@D@std@@@std@@QEAAPEADQEAD$$QEAD@Z.c)
  ...
  *(_BYTE *)v51 = 0;
  ...
  if ( dword_18033A1D0 > 5u && TlgKeywordOn((TraceLoggingHProvider)&dword_18033A1D0, 0x400000000000uLL) )
  {
    ...
    *v80 = v79;
    ...
    TlgWrite((TraceLoggingHProvider)&dword_18033A1D0, &unk_1802D90F2, 0LL, 0LL, 0xDu, &pData);
  }
