/*
 * XREFs of ?SyncIndirectSwapchainRenderTargetCreate@CChannel@@UEAAJIPEAXU_LUID@@I@Z @ 0x180159240
 * Callers:
 *     <none>
 * Callees:
        ...
        unsigned int a5)
{
  ...
  signed int v15; // [rsp+38h] [rbp-38h]
  ...
  v9 = a5;
  CChannel::CheckHandle((__int64)this, a5, 189);
  v16[0] = 205;
  v20 = 0;
  v16[1] = a2;
  v17 = a3;
  ...
  else
  {
    v12 = v15;
    if ( v15 < 0 )
      MilInstrumentationCheckHR_MaybeFailFast(v11, 0LL, 0, v15, 0x89Au, 0LL);
  }
