/*
 * XREFs of ?Divide@CExpressionValueStack@@QEAAJXZ @ 0x1800850DC
 * Callers:
 ...
 *     ?D3DXQuaternionMultiply@@YAPEAUD2DQuaternion@@PEAU1@PEBU1@1@Z @ 0x180228FBC (-D3DXQuaternionMultiply@@YAPEAUD2DQuaternion@@PEAU1@PEBU1@1@Z.c)
 */
...
__int64 __fastcall CExpressionValueStack::Divide(CExpressionValueStack *this)
{
  ...
  if ( v7 != 18 )
  {
    ...
    else
    {
      ...
      {
        v18 = *(float *)&v28.m128i_i32[1];
        if ( *(float *)&v28.m128i_i32[1] != 0.0 )
        {
          v19 = *(float *)&v28.m128i_i32[2];
          if ( *(float *)&v28.m128i_i32[2] != 0.0 )
          {
            v20 = *(float *)&v29.m128i_i32[2];
            v21 = (__m128)v29.m128i_u32[0];
            v21.m128_f32[0] = *(float *)v29.m128i_i32 / *(float *)v28.m128i_i32;
            *(_DWORD *)(v3 + 8 * v4 + 72) = 52;
            v22 = (__m128)v29.m128i_u32[1];
            v22.m128_f32[0] = *(float *)&v29.m128i_i32[1] / v18;
            *(float *)&v29.m128i_i32[2] = v20 / v19;
            *(_QWORD *)(v3 + 8 * v4) = _mm_unpacklo_ps(v21, v22).m128_u64[0];
            *(float *)(v3 + 8 * v4 + 8) = v20 / v19;
            goto LABEL_7;
          }
        }
      }
