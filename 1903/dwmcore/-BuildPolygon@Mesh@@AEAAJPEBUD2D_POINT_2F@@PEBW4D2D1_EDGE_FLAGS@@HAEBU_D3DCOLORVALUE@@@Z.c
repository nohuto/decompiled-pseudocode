/*
 * XREFs of ?BuildPolygon@Mesh@@AEAAJPEBUD2D_POINT_2F@@PEBW4D2D1_EDGE_FLAGS@@HAEBU_D3DCOLORVALUE@@@Z @ 0x1801B92EC
 * Callers:
 ...
 *     ?AddPolygon@MeshGraph@Mesh@@QEAAJPEAUMeshEdge@2@@Z @ 0x1801B9198 (-AddPolygon@MeshGraph@Mesh@@QEAAJPEAUMeshEdge@2@@Z.c)
 ...
 *     ?AllocateVertex@Mesh@@AEAAJHPEAH@Z @ 0x1801B9270 (-AllocateVertex@Mesh@@AEAAJHPEAH@Z.c)
