/*
 * XREFs of ?ConfigureInteractionContext@CInteractionContextWrapper@@AEAAJPEAUHINTERACTIONCONTEXT__@@AEBUSetupInfo@@@Z @ 0x180233BD4
 * Callers:
 *     ?ApplySetupInfo@CInteractionContextWrapper@@UEAAJAEBUSetupInfo@@@Z @ 0x180233A30 (-ApplySetupInfo@CInteractionContextWrapper@@UEAAJAEBUSetupInfo@@@Z.c)
 *     ?EnsureInteractionContext@CInteractionContextWrapper@@AEAAJXZ @ 0x180234040 (-EnsureInteractionContext@CInteractionContextWrapper@@AEAAJXZ.c)
 * Callees:
      ...
      if ( v12 >= 0 )
      {
        ...
        if ( v24 >= 0 )
        {
          ...
          if ( dword_18033A240 > 4u && TlgKeywordOn((TraceLoggingHProvider)&dword_18033A240, 2uLL) )
          {
            ...
            v41 = v20;
            v44 = v20;
            TlgWrite(v19, &unk_1802DEEE1, 0LL, 0LL, 7u, &pData);
            v12 = v24;
          }
          if ( v12 >= 0 )
          {
