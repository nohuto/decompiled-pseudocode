/*
 * XREFs of ?CalculateValueWorker@CConditionalExpression@@UEAAJPEAVCExpressionValueStack@@_KPEA_N@Z @ 0x1801D4370
 * Callers:
 *     <none>
 * Callees:
      ...
      if ( v12 )
      {
        do
        {
          ...
          if ( v39 )
          {
            ...
            v17 = (*(__int64 (__fastcall **)(__int64, struct CExpressionValueStack *, unsigned __int64, bool *))(*(_QWORD *)v16 + 240LL))(
                    v16,
                    a2,
                    a3,
                    a4);
...
LABEL_17:
        ...
        if ( v23 )
        {
          v24 = (*(__int64 (__fastcall **)(__int64, struct CExpressionValueStack *, unsigned __int64, bool *))(*(_QWORD *)v23 + 240LL))(
                  v23,
                  a2,
                  a3,
                  a4);
  ...
  else
  {
    ...
    else
    {
      ...
      if ( (int)v30 < 0 )
      {
        ...
        if ( v34 )
        {
          v35 = (*(__int64 (__fastcall **)(__int64, struct CExpressionValueStack *, unsigned __int64, bool *))(*(_QWORD *)v34 + 240LL))(
                  v34,
                  a2,
                  a3,
                  a4);
      ...
      else
      {
        ...
        v32 = (*(__int64 (__fastcall **)(__int64, struct CExpressionValueStack *, unsigned __int64, bool *))(*(_QWORD *)v31 + 240LL))(
                v31,
                a2,
                a3,
                a4);
