/*
 * XREFs of ?SetDeviceTransform@COcclusionContext@@QEAAJPEBVCMILMatrix@@@Z @ 0x180068030
 * Callers:
...
__int64 __fastcall COcclusionContext::SetDeviceTransform(COcclusionContext *this, const struct CMILMatrix *a2)
{
  ...
  if ( a2 && !CMILMatrix::IsIdentity<0>((__int64)a2) )
  {
    ...
    {
      if ( !*((_BYTE *)this + 824) || !(unsigned __int8)CMILMatrix::IsEqualTo<0>((char *)this + 828, v4) )
        v3 = 1;
    ...
    {
      v2 = -2003304441;
      MilInstrumentationCheckHR_MaybeFailFast(v8, 0LL, 0, -2003304441, 0x8Eu, 0LL);
    }
  }
  else
  {
