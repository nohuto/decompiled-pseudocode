/*
 * XREFs of ?CreateCVI@CVisualSurface@@AEAAJPEAPEAVCCachedVisualImage@@@Z @ 0x1801FDFF0
 * Callers:
 ...
 *     ?SetForVisualSurface@CCachedVisualImage@@QEAAXXZ @ 0x1801C971C (-SetForVisualSurface@CCachedVisualImage@@QEAAXXZ.c)
 */
