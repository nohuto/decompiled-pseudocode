/*
 * XREFs of ?GetPresentStatistics@CRenderTargetManager@@QEAAJPEAIPEA_NPEAUDXGI_FRAME_STATISTICS_DWM@@PEAU_UNSIGNED_RATIO@@@Z @ 0x180097668
 * Callers:
  ...
  *a3 = 0;
  ...
  do
  {
      ...
      && !(*(unsigned __int8 (__fastcall **)(_QWORD *))(*v11 + 248LL))(v11) )
    {
      ...
      if ( v13 < 0 )
        MilInstrumentationCheckHR_MaybeFailFast((__int64)v14, &dword_1802C02F8, 2u, v13, 0x3BEu, 0LL);
      if ( !v6 || v6 >= 0 && v15 < 0 )
        v6 = v15;
      v8 = a4;
...
LABEL_30:
    if ( *a2 )
    {
      ...
      if ( PrimaryRenderTargetNoRef )
      {
        ...
        v20 = v18;
        if ( v18 < 0 )
          MilInstrumentationCheckHR_MaybeFailFast(v19, &dword_1802C02F8, 2u, v18, 0x3CBu, 0LL);
        if ( !v6 || v6 >= 0 && v20 < 0 )
          v6 = v20;
        LODWORD(v5) = 1;
      }
