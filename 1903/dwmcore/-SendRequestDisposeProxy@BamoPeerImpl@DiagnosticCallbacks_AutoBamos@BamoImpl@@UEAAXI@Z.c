/*
 * XREFs of ?SendRequestDisposeProxy@BamoPeerImpl@DiagnosticCallbacks_AutoBamos@BamoImpl@@UEAAXI@Z @ 0x18018B2E0
 * Callers:
 *     <none>
 * Callees:
        ...
        int a2)
{
  ...
  LOWORD(v5) = 5;
  v4 = CoreUICallSend(v3, v7, 2LL, 1LL, v5, &unk_1802BE022, a2, v6);
  if ( v4 < 0 )
  {
