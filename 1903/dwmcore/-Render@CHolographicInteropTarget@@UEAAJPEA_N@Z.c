/*
 * XREFs of ?Render@CHolographicInteropTarget@@UEAAJPEA_N@Z @ 0x180245980
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall CHolographicInteropTarget::Render(CHolographicInteropTarget *this, bool *a2)
{
  ...
  LODWORD(v2) = 0;
  v3 = qword_180340C90 + 1;
  *a2 = 0;
  qword_180340C90 = v3;
  if ( (Microsoft_Windows_Dwm_CoreEnableBits & 0x40000) != 0 )
    McTemplateU0pp((__int64)this, &EVTDESC_HOLOGRAPHICINTEROPTARGET_RENDER, v3, qword_180340C88);
  ...
  if ( (Microsoft_Windows_Dwm_CoreEnableBits & 0x40000) != 0 )
    McTemplateU0xxxx(
      ...
      qword_180340C90,
      qword_180340C88,
      qword_180340C90 - qword_180340C88,
      v2);
  return 0LL;
}
