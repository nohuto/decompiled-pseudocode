/*
 * XREFs of ?HwndBitmapUpdateVisual@CChannel@@UEAAJII@Z @ 0x1800D6750
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall CChannel::HwndBitmapUpdateVisual(CChannel *this, unsigned int a2, unsigned int a3)
{
  unsigned int v6; // ebx
  ...
  CChannel::CheckHandle((__int64)this, a2, 79);
  CChannel::CheckOptionalHandle((__int64)this, a3, 189LL);
  v8[0] = 202;
  v8[1] = a2;
  v8[2] = a3;
