/*
 * XREFs of McTemplateU0qQR0qQR2qQR4qQR6qQR8 @ 0x180178E58
 * Callers:
...
ULONG __fastcall McTemplateU0qQR0qQR2qQR4qQR6qQR8(
        __int64 a1,
        __int64 a2,
        __int64 a3,
        __int64 a4,
        ...
        __int64 a12)
{
  ...
  v30 = 4LL;
  v35 = 4LL;
  return McGenEventWrite(Microsoft_Windows_Dwm_Core_Provider_Context, &EVTDESC_PROCESS_ATTRIBUTION, a3, 0xBu, &v13);
}
