/*
 * XREFs of ??0CWindowNode@@IEAA@PEAVCComposition@@@Z @ 0x180028128
 * Callers:
...
CWindowNode *__fastcall CWindowNode::CWindowNode(CWindowNode *this, struct CComposition *a2)
{
  ...
  *((_DWORD *)this + 238) = dword_180340224;
  *((_DWORD *)this + 239) = dword_180340228;
  *((_DWORD *)this + 240) = dword_18034022C;
  result = this;
  *((_QWORD *)this + 122) = 0LL;
  *((_QWORD *)this + 123) = 0LL;
  *((_BYTE *)this + 1016) = 0;
