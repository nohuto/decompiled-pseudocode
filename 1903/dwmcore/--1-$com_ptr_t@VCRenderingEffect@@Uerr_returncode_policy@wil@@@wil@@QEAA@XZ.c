/*
 * XREFs of ??1?$com_ptr_t@VCRenderingEffect@@Uerr_returncode_policy@wil@@@wil@@QEAA@XZ @ 0x1800CF950
 * Callers:
 ...
 *     ??1SharedStateLayer@@QEAA@XZ @ 0x1800CF940 (--1SharedStateLayer@@QEAA@XZ.c)
