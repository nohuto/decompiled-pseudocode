/*
 * XREFs of ??$WalkSubtree@VCPreComputeContext@@@CVisualTreeIterator@@QEAAJPEBVCVisualTree@@PEBVCVisual@@PEAVCPreComputeContext@@W4WalkReason@@@Z @ 0x180064700
 * Callers:
...
LABEL_28:
    ...
    v15 = CPreComputeContext::PreSubgraph(a4, a2, (struct CManipulationManager *)&v74);
    v11 = v15;
    if ( v15 < 0 )
    {
      v70 = 219;
LABEL_112:
      MilInstrumentationCheckHR_MaybeFailFast((unsigned int)v16, 0LL, 0, v15, v70, 0LL);
      goto LABEL_33;
    }
    if ( !(_BYTE)v74 )
      goto LABEL_9;
    ...
    *(_QWORD *)&v72 = *(_QWORD *)(a1 + 16);
    ...
    {
      v13 = -2147024362;
      MilInstrumentationCheckHR_MaybeFailFast(v44, 0LL, 0, -2147024362, 0x4Cu, 0LL);
      v11 = -2147024362;
LABEL_101:
...
LABEL_67:
  ...
  MilInstrumentationCheckHR_MaybeFailFast((unsigned int)v16, 0LL, 0, v11, 0xEAu, 0LL);
LABEL_33:
  v12 = v75;
LABEL_34:
  ...
  if ( v12 )
  {
    ...
    if ( !Value )
    {
      ...
      {
        MilInstrumentationCheckHR_MaybeFailFast(v66, 0LL, 0, -2147024882, 0x42u, 0LL);
        goto LABEL_45;
      }
