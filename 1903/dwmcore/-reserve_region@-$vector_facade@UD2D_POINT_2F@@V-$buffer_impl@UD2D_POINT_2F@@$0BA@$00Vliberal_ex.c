/*
 * XREFs of ?reserve_region@?$vector_facade@UD2D_POINT_2F@@V?$buffer_impl@UD2D_POINT_2F@@$0BA@$00Vliberal_expansion_policy@detail@@@detail@@@detail@@IEAAPEAUD2D_POINT_2F@@_K0@Z @ 0x1801B05E8
 * Callers:
 *     ?AddLine@CDrawListPolygonBuilder@@EEAAXUD2D_POINT_2F@@@Z @ 0x1801AF440 (-AddLine@CDrawListPolygonBuilder@@EEAAXUD2D_POINT_2F@@@Z.c)
 *     ?AddLines@CDrawListPolygonBuilder@@EEAAXPEBUD2D_POINT_2F@@I@Z @ 0x1801AF480 (-AddLines@CDrawListPolygonBuilder@@EEAAXPEBUD2D_POINT_2F@@I@Z.c)
  ...
  *(_QWORD *)&v17 = v8 + 8 * v10;
  ...
  if ( v11 > a3 )
  {
    ...
    *((_QWORD *)&v19 + 1) = v10;
    ...
    {
LABEL_20:
      _o__invalid_parameter_noinfo_noreturn(v7, v6, v10, v9);
      __debugbreak();
    }
    v20 = v10;
    v17 = v19;
