/*
 * XREFs of ?CreateD2DBitmapInternal@CD2DContext@@AEAAJPEAUID3D11Texture2D@@AEBUD3D11_TEXTURE2D_DESC@@AEBUD2D1_BITMAP_PROPERTIES1@@W4DXGI_COLOR_SPACE_TYPE@@VDisplayId@@_NPEAPEAVCD2DBitmap@@@Z @ 0x1800B3B2C
 * Callers:
 ...
 *     ?CreateD2DBitmap@CD2DContext@@MEAAJPEAUID3D11Texture2D@@AEBUD3D11_TEXTURE2D_DESC@@AEBUD2D1_BITMAP_PROPERTIES1@@W4DXGI_COLOR_SPACE_TYPE@@VDisplayId@@PEAPEAVCD2DBitmap@@@Z @ 0x18015C2B0 (-CreateD2DBitmap@CD2DContext@@MEAAJPEAUID3D11Texture2D@@AEBUD3D11_TEXTURE2D_DESC@@AEBUD2D1_BITMA.c)
 * Callees:
        ...
        _QWORD *a8)
{
  ...
  *a8 = 0LL;
  ...
  if ( *(_DWORD *)(a3 + 12) == 1 )
  {
    ...
    if ( v14 < 0 )
    {
      MilInstrumentationCheckHR_MaybeFailFast(v15, 0LL, 0, v14, 0x672u, 0LL);
      goto LABEL_6;
    }
    v17 = v27;
  }
  else
  {
    ...
    if ( v21 < 0 )
    {
      MilInstrumentationCheckHR_MaybeFailFast(v22, 0LL, 0, v21, 0x67Du, 0LL);
      goto LABEL_6;
    }
    ...
    if ( v23 < 0 )
    {
      MilInstrumentationCheckHR_MaybeFailFast(v24, 0LL, 0, v23, 0x67Fu, 0LL);
      goto LABEL_6;
    }
    v17 = a8;
    v27 = a8;
  ...
  v16 = Internal;
  if ( Internal < 0 )
    MilInstrumentationCheckHR_MaybeFailFast(v19, 0LL, 0, Internal, 0x692u, 0LL);
LABEL_6:
  if ( v26 )
