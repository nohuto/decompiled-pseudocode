/*
 * XREFs of ?Snapshot@CCachedVisualImage@@QEAAJPEBUtagRECT@@@Z @ 0x18002D874
 * Callers:
 *     ?ProcessSnapshot@CCachedVisualImage@@QEAAJPEAVCResourceTable@@PEBUtagMILCMD_CACHEDVISUALIMAGE_SNAPSHOT@@@Z @ 0x18002E274 (-ProcessSnapshot@CCachedVisualImage@@QEAAJPEAVCResourceTable@@PEBUtagMILCMD_CACHEDVISUALIMAGE_SN.c)
      ...
      if ( v8 > 0 )
      {
        ...
        do
        {
            ...
            && !(*(unsigned __int8 (__fastcall **)(__int64))(*(_QWORD *)(*(_QWORD *)(v11 + 8) + 144LL) + 104LL))(*(_QWORD *)(v11 + 8) + 144LL) )
          {
            ...
            DynArray<CCachedVisualImage::RenderTargetBitmapInfo,1>::RemoveAt((__int64 *)this + 30, v10);
          }
          --v8;
        }
        while ( v8 > 0 );
