/*
 * XREFs of ?SetProperty@CCompositionGlyphRun@@UEAAJIW4DCOMPOSITION_EXPRESSION_TYPE@@PEBX@Z @ 0x1801D1100
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall CCompositionGlyphRun::SetProperty(__int64 a1, int a2, int a3)
{
  ...
  v11[0] = 1LL;
  v11[1] = &CCompositionGlyphRun::k_rgAnimDef;
