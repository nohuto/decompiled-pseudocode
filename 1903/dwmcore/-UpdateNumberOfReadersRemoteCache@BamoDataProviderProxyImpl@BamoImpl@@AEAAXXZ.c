/*
 * XREFs of ?UpdateNumberOfReadersRemoteCache@BamoDataProviderProxyImpl@BamoImpl@@AEAAXXZ @ 0x180199718
 * Callers:
        ...
        BamoImpl::BamoDataProviderProxyImpl *this)
{
  ...
  if ( *(_QWORD *)(v2 + 40) )
  {
    ...
    LOWORD(v4) = 4;
    v3 = CoreUICallSend(*(_QWORD *)(v2 + 48), v7, 2LL, 0LL, v4, &unk_1802BC765, v5, v6);
