/*
 * XREFs of DecodeInputTexcoord @ 0x1800330B8
 * Callers:
...
__int64 __fastcall DecodeInputTexcoord(__int64 a1, __int64 a2, __int16 a3, int a4)
{
  ...
  if ( v5 )
  {
    if ( *(_BYTE *)(a2 + 154) )
    {
      ...
      v8 = appended;
      if ( appended < 0 )
        MilInstrumentationCheckHR_MaybeFailFast(v11, 0LL, 0, appended, 0x204u, 0LL);
    }
    else
    {
      v6 = CShaderLinkingGraphBuilder::SwizzleNode(a1, v4, 256LL);
      v8 = v6;
      if ( v6 < 0 )
        MilInstrumentationCheckHR_MaybeFailFast(v7, 0LL, 0, v6, 0x209u, 0LL);
    }
  }
  else
  {
