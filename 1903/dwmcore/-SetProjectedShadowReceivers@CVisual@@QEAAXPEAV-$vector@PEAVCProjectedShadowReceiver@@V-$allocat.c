/*
 * XREFs of ?SetProjectedShadowReceivers@CVisual@@QEAAXPEAV?$vector@PEAVCProjectedShadowReceiver@@V?$allocator@PEAVCProjectedShadowReceiver@@@std@@@std@@@Z @ 0x180003664
 * Callers:
...
__int64 __fastcall CVisual::SetProjectedShadowReceivers(__int64 a1, __int64 a2)
{
  ...
  if ( a2 )
  {
    ...
    {
      result = CSparseAlignedStorage<8,8>::AllocatedStorage::ReserveSlot(a1 + 224, 16LL);
      *(_QWORD *)result = a2;
    }
  }
  ...
  {
    *v3 &= ~0x10000u;
    result = CSparseAlignedStorage<8,8>::AllocatedStorage::FindSlot(v3, 16LL);
