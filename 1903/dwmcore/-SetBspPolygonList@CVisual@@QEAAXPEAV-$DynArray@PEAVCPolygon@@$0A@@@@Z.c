/*
 * XREFs of ?SetBspPolygonList@CVisual@@QEAAXPEAV?$DynArray@PEAVCPolygon@@$0A@@@@Z @ 0x1801C46F4
 * Callers:
...
__int64 __fastcall CVisual::SetBspPolygonList(__int64 a1, __int64 a2)
{
  ...
  if ( a2 )
  {
    ...
    {
      result = (__int64)CSparseAlignedStorage<8,8>::AllocatedStorage::ReserveSlot(a1 + 224, 4);
      *(_QWORD *)result = a2;
    }
  }
