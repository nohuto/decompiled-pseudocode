/*
 * XREFs of ?GenerateDrawList@CAtlasedRectsGroup@@UEAAJPEAVCDrawingContext@@AEBUD2D_SIZE_F@@PEAVCDrawListCache@@@Z @ 0x180052440
 * Callers:
 *     <none>
 * Callees:
        ...
        struct CDrawListCache *a4)
{
  ...
  v55 = 2;
  v81 = 0;
  CMatrixStack::Top((struct CDrawingContext *)((char *)a2 + 480), (struct CMILMatrix *)v78);
  CMILMatrix::Get2DScaleDimensions((CMILMatrix *)v78, (float *)&v56, (float *)&v56 + 1);
  if ( !v9 )
  {
    CpuClip = CDrawingContext::GetCpuClip(a2, v10, (struct CCpuClip *)&v72);
    v7 = CpuClip;
    if ( CpuClip < 0 )
    {
  ...
  {
LABEL_32:
    Microsoft::WRL::ComPtr<ID2DBitmap>::InternalRelease((__int64 *)&v50 + 1);
  ...
  if ( (v6 & 1) != 0 )
  {
    Microsoft::WRL::ComPtr<ID2DBitmap>::InternalRelease(&v53);
    Microsoft::WRL::ComPtr<ID2DBitmap>::InternalRelease(&v52);
  }
  if ( !v18 )
  {
    v7 = -2147024882;
...
LABEL_21:
    ...
    *(_QWORD *)&v50 = 2LL;
    ...
    while ( 1 )
    {
      ...
      v90 = _xmm;
      MILMatrix3x2::InferAffineMatrix((__int64)v62, v32, (float *)(v23 + 16LL * v4));
      if ( v46 )
      {
        v83 = v62[0];
        v85 = v62[1];
