/*
 * XREFs of ?_SendUpdateToRenderThread@CManipulation@@AEAAJ_NPEBUD2DVector3@@1@Z @ 0x1801E4094
 * Callers:
 *     ?CompleteManipulation@CManipulation@@UEAAJW4InteractionState@@@Z @ 0x1801E2800 (-CompleteManipulation@CManipulation@@UEAAJW4InteractionState@@@Z.c)
        ...
        const struct D2DVector3 *a4)
{
  ...
  if ( dword_18033A240 > 4u && TlgKeywordOn((TraceLoggingHProvider)&dword_18033A240, 2uLL) )
  {
    ...
    *((_QWORD *)&v53 + 1) = v9;
    ...
    v111 = v9;
    v113 = v9;
    TlgWrite((TraceLoggingHProvider)&dword_18033A240, &unk_1802DC792, 0LL, 0LL, 0x29u, &pData);
  }
  ...
  if ( v16 )
  {
    ...
    v54 = v26;
    LOWORD(cData) = 0;
    ManipulationManager = CoreUICallSend(v31, &v39, 1LL, 10LL, cData, &unk_1802B2E66, (unsigned int)&v40, &pData);
    v14 = ManipulationManager;
    if ( ManipulationManager >= 0 )
    {
