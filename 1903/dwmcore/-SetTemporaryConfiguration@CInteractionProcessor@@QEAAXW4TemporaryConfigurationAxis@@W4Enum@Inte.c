/*
 * XREFs of ?SetTemporaryConfiguration@CInteractionProcessor@@QEAAXW4TemporaryConfigurationAxis@@W4Enum@InteractionConfigurationUpdateType@@_NU?$TMILFlagsEnum@W4FlagsEnum@DwmInteractionTypeTouchPrimitiveType@@@@@Z @ 0x180232E98
 * Callers:
...
char __fastcall CInteractionProcessor::SetTemporaryConfiguration(_BYTE *a1, int a2, int a3, unsigned __int8 a4, int a5)
{
  ...
  {
    result = TlgKeywordOn((TraceLoggingHProvider)&dword_18033A240, 2uLL);
    if ( result )
    {
      v32 = a1;
      v34 = &v32;
      ...
      v54 = &v31;
      v55 = 4LL;
      return TlgWrite((TraceLoggingHProvider)&dword_18033A240, &unk_1802DE3FE, 0LL, 0LL, 0xDu, &pData);
    }
  }
  return result;
}
