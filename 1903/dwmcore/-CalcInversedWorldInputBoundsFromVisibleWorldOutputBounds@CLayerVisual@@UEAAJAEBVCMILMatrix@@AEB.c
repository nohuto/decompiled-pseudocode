        ...
        _OWORD *a6)
{
  ...
  __int128 v61; // xmm1
  void *v62[2]; // [rsp+38h] [rbp-B9h] BYREF
  ...
  if ( !*(_QWORD *)(a1 + 560) )
  {
    ...
    {
      MilInstrumentationCheckHR_MaybeFailFast(v10, 0LL, 0, BoundsWithLayerEffect, 0xE6u, 0LL);
    }
    else
    {
      ...
      *(float *)v75 = v13;
      ...
      v23 = CVisual::CalcInversedWorldInputBoundsFromVisibleWorldOutputBounds((CLayerVisual *)a1, a2, (__int64)a5, a6);
      v11 = v23;
      if ( v23 < 0 )
        MilInstrumentationCheckHR_MaybeFailFast(v24, 0LL, 0, v23, 0xF6u, 0LL);
    }
    return v11;
  }
  ...
  if ( ShadowBounds < 0 )
  {
    MilInstrumentationCheckHR_MaybeFailFast(v27, 0LL, 0, ShadowBounds, 0x100u, 0LL);
    return v11;
  }
    ...
    *(_OWORD *)v75 = v77;
    if ( CLayerVisual::GetFlatteningToLocalSpace((CLayerVisual *)a1) )
    {
      *(_OWORD *)v75 = *(_OWORD *)(a1 + 164);
      ...
      v11 = v57;
      if ( v57 < 0 )
        MilInstrumentationCheckHR_MaybeFailFast(v58, 0LL, 0, v57, 0x162u, 0LL);
    }
    else
    {
      v59 = CVisual::CalcInversedWorldInputBoundsFromVisibleWorldOutputBounds((CLayerVisual *)a1, a2, (__int64)a5, a6);
      v11 = v59;
      if ( v59 < 0 )
        MilInstrumentationCheckHR_MaybeFailFast(v60, 0LL, 0, v59, 0x16Eu, 0LL);
    }
  }
  return v11;
}
