/*
 * XREFs of ??$_Emplace_reallocate@AEBQEAUDepthGraphNode@@@?$vector@PEAUDepthGraphNode@@V?$allocator@PEAUDepthGraphNode@@@std@@@std@@QEAAPEAPEAUDepthGraphNode@@QEAPEAU2@AEBQEAU2@@Z @ 0x18025C51C
 * Callers:
...
__int64 __fastcall std::vector<DepthGraphNode *>::_Emplace_reallocate<DepthGraphNode * const &>(
        __int64 a1,
        _BYTE *a2,
        _QWORD *a3)
{
