/*
 * XREFs of ?CheckComputeScribbleSupportForCurrentFrame@CHwFullScreenRenderTarget@@UEAAJPEA_N@Z @ 0x1801672B0
 * Callers:
 *     <none>
 * Callees:
 ...
 *     ?FireEtwEvent@ComputeScribbleSupportResult@@QEAAXXZ @ 0x1801AD87C (-FireEtwEvent@ComputeScribbleSupportResult@@QEAAXXZ.c)
 */
