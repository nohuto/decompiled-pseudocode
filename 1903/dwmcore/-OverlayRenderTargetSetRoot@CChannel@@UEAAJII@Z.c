/*
 * XREFs of ?OverlayRenderTargetSetRoot@CChannel@@UEAAJII@Z @ 0x180158CD0
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall CChannel::OverlayRenderTargetSetRoot(CChannel *this, unsigned int a2, unsigned int a3)
{
  unsigned int v6; // ebx
