/*
 * XREFs of ?CreateAndCacheBitmap@CD2DBitmapCache@@IEAAJU_LUID@@PEAPEAVCSecondaryD2DBitmap@@@Z @ 0x1800B33DC
 * Callers:
        ...
        struct CSecondaryD2DBitmap **a3)
{
  ...
  *a3 = 0LL;
  ...
  if ( dword_180340248 > *(_DWORD *)(*((_QWORD *)NtCurrentTeb()->ThreadLocalStoragePointer + (unsigned int)tls_index)
                                   + 4LL) )
  {
    Init_thread_header(&dword_180340248);
    if ( dword_180340248 == -1 )
    {
      dword_180340258 = 24;
      qword_180340250 = (__int64)"DWM Sysmem Source Bitmap";
      dword_180340268 = 23;
      qword_180340260 = (__int64)"DWM Cross-Device Bitmap";
      Init_thread_footer(&dword_180340248);
    }
  }
  v7 = (const struct CResourceTag *)off_180339A68;
  if ( !*((_QWORD *)this + 5) )
    v7 = off_180339A60;
