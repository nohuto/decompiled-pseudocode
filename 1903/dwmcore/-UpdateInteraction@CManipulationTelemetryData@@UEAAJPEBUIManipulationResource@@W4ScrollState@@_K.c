/*
 * XREFs of ?UpdateInteraction@CManipulationTelemetryData@@UEAAJPEBUIManipulationResource@@W4ScrollState@@_K@Z @ 0x1802361C0
 * Callers:
 *     <none>
 * Callees:
  ...
  while ( v38 )
  {
    ...
    *(_OWORD *)v42 = 0LL;
    ...
    if ( dword_18033A240 > 5u && TlgKeywordOn((TraceLoggingHProvider)&dword_18033A240, 2uLL) )
    {
      ...
      v77 = 8LL;
      v79 = 4LL;
      TlgWrite((TraceLoggingHProvider)&dword_18033A240, &unk_1802DF281, 0LL, 0LL, 0xFu, &pData);
    }
