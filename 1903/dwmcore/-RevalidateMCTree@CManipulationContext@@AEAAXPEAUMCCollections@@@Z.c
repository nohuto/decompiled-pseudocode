/*
 * XREFs of ?RevalidateMCTree@CManipulationContext@@AEAAXPEAUMCCollections@@@Z @ 0x18023DFF0
 * Callers:
    ...
    while ( 1 )
    {
      ...
      for ( i = ClosestInteractionAncestor; i; i = CManipulationContext::GetClosestInteractionAncestor(v25, v20) )
      {
        if ( dword_18033A240 > 4u && TlgKeywordOn((TraceLoggingHProvider)&dword_18033A240, 2uLL) )
        {
          ...
          v52 = i;
          v69 = 8LL;
          TlgWrite((TraceLoggingHProvider)&dword_18033A240, &unk_1802E08FF, 0LL, 0LL, 4u, &pData);
        }
        *((_BYTE *)i + 184) |= 0x40u;
        v25 = 0LL;
        v26 = *((_QWORD *)i + 13);
      ...
      for ( j = v19; j; j = (struct CInteraction *)*((_QWORD *)j + 25) )
      {
        if ( dword_18033A240 > 4u && TlgKeywordOn((TraceLoggingHProvider)&dword_18033A240, 2uLL) )
        {
          ...
          v52 = j;
          v69 = 8LL;
          TlgWrite((TraceLoggingHProvider)&dword_18033A240, &unk_1802E084C, 0LL, 0LL, 4u, &pData);
        }
        *((_BYTE *)j + 184) |= 0x80u;
      }
      if ( dword_18033A240 > 4u && TlgKeywordOn((TraceLoggingHProvider)&dword_18033A240, 2uLL) )
      {
        ...
        v56 = v19;
        v71 = 8LL;
        TlgWrite((TraceLoggingHProvider)&dword_18033A240, &unk_1802E089D, 0LL, 0LL, 5u, &pData);
      }
...
LABEL_67:
    ...
    while ( 1 )
    {
      ...
      if ( dword_18033A240 > 4u && TlgKeywordOn((TraceLoggingHProvider)&dword_18033A240, 2uLL) )
      {
        ...
        v73 = v38 + 6;
        v76 = 4;
        TlgWrite((TraceLoggingHProvider)&dword_18033A240, &unk_1802E0951, 0LL, 0LL, 7u, &pData);
      }
