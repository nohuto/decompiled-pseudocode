/*
 * XREFs of ?SetNormalInput@?$CScenePbrMaterialGeneratedT@VCScenePbrMaterial@@VCSceneMaterial@@@@QEAAJPEAVCSceneMaterialInput@@@Z @ 0x1801A21A8
 * Callers:
        ...
        struct CResource *a2)
{
  ...
  if ( a2 != this[15] )
  {
    ...
    if ( v5 < 0 )
    {
      MilInstrumentationCheckHR_MaybeFailFast(v6, 0LL, 0, v5, 0x5B8u, 0LL);
    }
    else
    {
