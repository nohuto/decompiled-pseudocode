/*
 * XREFs of ?_Buynode0@?$_List_alloc@U?$_List_base_types@UCasterEntry@CProjectedShadowScene@@V?$allocator@UCasterEntry@CProjectedShadowScene@@@std@@@std@@@std@@QEAAPEAU?$_List_node@UCasterEntry@CProjectedShadowScene@@PEAX@2@PEAU32@0@Z @ 0x180006840
 * Callers:
