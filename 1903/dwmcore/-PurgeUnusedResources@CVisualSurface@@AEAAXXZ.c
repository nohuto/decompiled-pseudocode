/*
 * XREFs of ?PurgeUnusedResources@CVisualSurface@@AEAAXXZ @ 0x1801FE698
 * Callers:
 ...
 *     ??$swap_helper@$03@?$expandable_buffer_base@V?$com_ptr_t@VCCachedVisualImage@@Uerr_returncode_policy@wil@@@wil@@$03@detail@@QEAA_NAEAV01@@Z @ 0x1801FDE70 (--$swap_helper@$03@-$expandable_buffer_base@V-$com_ptr_t@VCCachedVisualImage@@Uerr_returncode_po.c)
