/*
 * XREFs of ??0CInteractionTrackerBindingManager@@QEAA@PEAVCComposition@@@Z @ 0x1801DED50
 * Callers:
        ...
        struct CComposition *a2)
{
  ...
  *((_QWORD *)this + 9) = 0LL;
  *((_QWORD *)this + 10) = 0LL;
  *((_QWORD *)this + 9) = std::_List_alloc<std::_List_base_types<std::pair<CVisual * const,CDropShadow::ShadowIntermediates>>>::_Buynode0(
                            (__int64)this,
                            0LL,
                            0LL);
  *((_QWORD *)v2 + 3) = 0LL;
