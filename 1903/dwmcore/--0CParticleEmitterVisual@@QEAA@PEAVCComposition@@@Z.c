/*
 * XREFs of ??0CParticleEmitterVisual@@QEAA@PEAVCComposition@@@Z @ 0x1801EB050
 * Callers:
 ...
 *     ??0ParticleCollection@CParticleEmitterVisual@@QEAA@XZ @ 0x1801EB370 (--0ParticleCollection@CParticleEmitterVisual@@QEAA@XZ.c)
 */
