/*
 * XREFs of McTemplateU0xxxtxxxxxxxxqN16 @ 0x1801938E4
 * Callers:
        ...
        ...)
{
  ...
  v41 = 4LL;
  v43 = 128LL;
  return McGenEventWrite(Microsoft_Windows_Dwm_Core_Provider_Context, &EVTDESC_SCHEDULE_GLITCH, a3, 0xFu, &v15);
}
