/*
 * XREFs of ?RailsUpdate@GestureTargeting@InputTraceLogging@@SAXPEBUInteractionUpdate@CManipulationManager@@@Z @ 0x1800C385C
 * Callers:
        ...
        const struct CManipulationManager::InteractionUpdate *a1)
{
  ...
  if ( *(_DWORD *)v3 > 4u && TlgKeywordOn((TraceLoggingHProvider)v2[1], 0x800uLL) )
  {
    ...
    TlgCreateSz(&v62, v21);
    TlgWrite(v3, &unk_1802E0043, 0LL, 0LL, 0xFu, &pData);
  }
}
