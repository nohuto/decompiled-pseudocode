/*
 * XREFs of ?GenerateDrawList@CHwndBitmap@@UEAAJPEAVCDrawingContext@@AEBUD2D_SIZE_F@@PEAVCDrawListCache@@@Z @ 0x180216030
 * Callers:
 *     <none>
 * Callees:
...
LABEL_24:
  Microsoft::WRL::ComPtr<ID2DBitmap>::InternalRelease((__int64 *)&v25 + 1);
