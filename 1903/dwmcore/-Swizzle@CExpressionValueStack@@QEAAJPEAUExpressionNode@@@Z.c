/*
 * XREFs of ?Swizzle@CExpressionValueStack@@QEAAJPEAUExpressionNode@@@Z @ 0x180080620
 * Callers:
...
__int64 __fastcall CExpressionValueStack::Swizzle(unsigned __int64 this, struct ExpressionNode *a2)
{
  int v2; // eax
  __int64 v4; // r14
  __int64 v5; // rbx
  ...
  for ( i = 0; i < v7; *((_DWORD *)&v27 + this) = v10 )
  {
    ...
    else
    {
      ...
      LODWORD(this) = 4 * (*((unsigned __int8 *)a2 + v4 + 4) - i) - 4;
