/*
 * XREFs of ?CheckTargetsForInteractionSource@CInteractionTracker@@SAXPEAUExpressionReferenceInfo@@PEAVCResource@@1@Z @ 0x1801D9B70
 * Callers:
        ...
        struct CResource *a3)
{
  ...
  if ( TraceLoggingProviderEnabled((TraceLoggingHProvider)&dword_18033A240, 4u, 2uLL)
    && a2
    && a3
    ...
    *((_BYTE *)v10 + 272) |= 4u;
    if ( InteractionSourceManager::TryGetActiveChainingHelper((struct CResource *)((char *)a3 + 192)) )
    {
      if ( CVisual::GetInteractionInternal(v6) )
      {
        ...
        if ( InteractionInternal == v8 && dword_18033A240 > 4u )
        {
