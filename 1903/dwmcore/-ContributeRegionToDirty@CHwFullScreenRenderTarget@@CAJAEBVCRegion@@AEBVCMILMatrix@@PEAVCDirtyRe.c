/*
 * XREFs of ?ContributeRegionToDirty@CHwFullScreenRenderTarget@@CAJAEBVCRegion@@AEBVCMILMatrix@@PEAVCDirtyRegion@@@Z @ 0x1801676C0
 * Callers:
        ...
        struct CDirtyRegion *a3)
{
  ...
  struct D2D_RECT_F v19; // [rsp+70h] [rbp+27h] BYREF
  ...
  if ( *(_DWORD *)v3 )
  {
    ...
    while ( (unsigned __int64)v15 < v14 )
    {
      ...
      CMILMatrix::Transform2DBoundsHelper<0>(a2, (__int64)v18, &v19.left);
      v8 = CDirtyRegion::Add(a3, 0LL, 0, &v19);
      v10 = v8;
      if ( v8 < 0 )
      {
