/*
 * XREFs of ?Present@CRemoteAppRenderTarget@@UEAAJ_NI@Z @ 0x1801A5DE0
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall CRemoteAppRenderTarget::Present(CRemoteAppRenderTarget *this)
{
  ...
  v1 = 0;
  if ( *((_BYTE *)this + 240) && *(_DWORD *)(*((_QWORD *)this - 6) + 1096LL) == 6 )
  {
    ...
    {
      MilInstrumentationCheckHR_MaybeFailFast(v4, 0LL, 0, v3, 0xC4u, 0LL);
    }
  }
  result = v1;
  *((_BYTE *)this + 240) = 0;
