/*
 * XREFs of ?CalcWorldSpaceClippedBounds@CDrawingContext@@QEAAXAEBV?$TMilRect_@MUMilRectF@@UMilPointAndSizeF@@UNotNeeded@RectUniqueness@@@@PEAV2@@Z @ 0x1800534D8
 * Callers:
...
__int64 __fastcall CDrawingContext::CalcWorldSpaceClippedBounds(__int64 a1, __int64 a2, float *a3)
{
  ...
  result = CScopedClipStack::GetClipBoundsWorld(a1 + 1008, &v12);
  if ( v12 > *a3 )
    *a3 = v12;
  if ( v13 > a3[1] )
    a3[1] = v13;
