/*
 * XREFs of ?CurrentInertiaVelocity@CScaleMotion@@MEBAMXZ @ 0x180210A80
 * Callers:
 *     ?CurrentInertiaVelocity@CPositionMotion@@MEBAMXZ @ 0x180210B10 (-CurrentInertiaVelocity@CPositionMotion@@MEBAMXZ.c)
 * Callees:
