/*
 * XREFs of ?Present@CHDRConversionRenderTarget@@UEAAJ_N0PEBURenderTargetPresentParameters@@@Z @ 0x180169280
 * Callers:
 *     <none>
 * Callees:
        ...
        const struct RenderTargetPresentParameters *a4)
{
  ...
  if ( v13 )
  {
    ...
    Microsoft::WRL::ComPtr<ID2DBitmap>::InternalRelease(&v79);
