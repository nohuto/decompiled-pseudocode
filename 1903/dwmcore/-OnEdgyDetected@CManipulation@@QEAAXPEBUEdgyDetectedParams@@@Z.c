/*
 * XREFs of ?OnEdgyDetected@CManipulation@@QEAAXPEBUEdgyDetectedParams@@@Z @ 0x1801E2BF8
 * Callers:
 *     ?s_OnReceiveInputThreadMessage@CGlobalInputManager@@CAJPEAXPEBXH@Z @ 0x1802376E0 (-s_OnReceiveInputThreadMessage@CGlobalInputManager@@CAJPEAXPEBXH@Z.c)
 * Callees:
...
void __fastcall CManipulation::OnEdgyDetected(CManipulation *this, const struct EdgyDetectedParams *a2)
{
  ...
  if ( CNotificationResource::ShouldNotify(this) )
  {
    ...
    LOWORD(v8) = 0;
    CoreUICallSend(v4, v10, 2LL, 12LL, v8, &unk_1802B2E92, (unsigned int)v11, v9);
  }
}
