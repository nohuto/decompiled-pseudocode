/*
 * XREFs of ?ProcessScribbleFrame@CScheduler@CComputeScribbleRenderer@@AEAAJXZ @ 0x1801B78AC
 * Callers:
 ...
 *     ?AddLatencyData@CTelemetryComputeScribbleAggregator@@SAXAEBV?$vector@UComputeScribbleLatencyData@@V?$allocator@UComputeScribbleLatencyData@@@std@@@std@@@Z @ 0x180193AE8 (-AddLatencyData@CTelemetryComputeScribbleAggregator@@SAXAEBV-$vector@UComputeScribbleLatencyData.c)
 ...
 *     ??D?$_Deque_const_iterator@V?$_Deque_val@U?$_Deque_simple_types@UScribbleFrame@CScheduler@CComputeScribbleRenderer@@@std@@@std@@@std@@QEBAAEBUScribbleFrame@CScheduler@CComputeScribbleRenderer@@XZ @ 0x1801B6D74 (--D-$_Deque_const_iterator@V-$_Deque_val@U-$_Deque_simple_types@UScribbleFrame@CScheduler@CCompu.c)
...
LABEL_7:
  ...
  if ( this != (CComputeScribbleRenderer::CScheduler *)-104LL )
    v13 = v12;
  *(_QWORD *)&v36 = v13;
  v17 = *(unsigned int *)(std::_Deque_const_iterator<std::_Deque_val<std::_Deque_simple_types<CComputeScribbleRenderer::CScheduler::ScribbleFrame>>>::operator*((__int64 **)&v36)
                        + 16);
  v18 = v17 == v4;
  v19 = 0;
  if ( v20 > v18 )
  {
    v21 = (const struct CComputeScribbleRenderer::CScheduler::ScribbleFrame *)std::deque<CComputeScribbleRenderer::CScheduler::ScribbleFrame>::operator[](
                                                                                (__int64)this + 104,
                                                                                v18);
    v19 = CComputeScribbleRenderer::CScheduler::SetupWakeupFence(this, v21);
    if ( v19 < 0 )
  ...
  if ( v17 == v4 )
  {
    ...
    *(_QWORD *)v31 = 0LL;
    ...
    _InterlockedExchangeAdd64(&qword_18033C8F8, v42);
    if ( !v30 )
      CTelemetryComputeScribbleAggregator::AddLatencyData((unsigned int **)v31);
    if ( *(_QWORD *)v31 )
      std::_Deallocate<16,0>(*(void **)v31, 24 * ((*((_QWORD *)&v32 + 1) - *(_QWORD *)v31) / 24LL));
  }
  if ( v19 >= 0 )
