/*
 * XREFs of ?SendAckProxyReference@BamoPeerImpl@dataprovider_AutoBamos@BamoImpl@@UEAAXI_N@Z @ 0x1800E4B40
 * Callers:
 *     <none>
 * Callees:
        ...
        unsigned __int8 a3)
{
  ...
  LODWORD(v8) = a3;
  LOWORD(v6) = 5;
  v5 = CoreUICallSend(v4, v9, 2LL, 6LL, v6, &unk_1802BC76D, a2, v8);
  if ( v5 < 0 )
  {
