/*
 * XREFs of ?ProcessSetConstantOpacity@CMeshGeometry2D@@QEAAJPEAVCResourceTable@@PEBUtagMILCMD_MESHGEOMETRY2D_SETCONSTANTOPACITY@@@Z @ 0x180217DD0
 * Callers:
 ...
 *     ?GetVertexCount@CMeshGeometry2D@@UEAAIXZ @ 0x180217C40 (-GetVertexCount@CMeshGeometry2D@@UEAAIXZ.c)
 */
