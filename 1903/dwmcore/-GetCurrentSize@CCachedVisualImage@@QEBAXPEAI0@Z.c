/*
 * XREFs of ?GetCurrentSize@CCachedVisualImage@@QEBAXPEAI0@Z @ 0x1800437D8
 * Callers:
 ...
 *     ?GetSize@CCachedVisualImage@@UEBAXPEAI0@Z @ 0x1801C92C0 (-GetSize@CCachedVisualImage@@UEBAXPEAI0@Z.c)
