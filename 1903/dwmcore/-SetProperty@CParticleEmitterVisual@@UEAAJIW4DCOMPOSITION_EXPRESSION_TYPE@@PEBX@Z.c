/*
 * XREFs of ?SetProperty@CParticleEmitterVisual@@UEAAJIW4DCOMPOSITION_EXPRESSION_TYPE@@PEBX@Z @ 0x1801EE0C0
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall CParticleEmitterVisual::SetProperty(float *a1, int a2, int a3)
{
  ...
  {
    v8 = (*((__int64 (__fastcall **)(char *, _DWORD *, __int64))AnimatablePropertyInfo + 3))(
