/*
 * XREFs of ?RouteFrameInput@CGlobalManipulationManager@@AEAAXPEAVCManipulationFrame@@@Z @ 0x18023A46C
 * Callers:
 *     ?RouteAllFrames@CGlobalManipulationManager@@AEAAXPEAVCManipulationFrame@@@Z @ 0x18023A3D4 (-RouteAllFrames@CGlobalManipulationManager@@AEAAXPEAVCManipulationFrame@@@Z.c)
 * Callees:
              ...
              *(_DWORD *)((char *)a2 + v15 + 152) = 0;
              if ( dword_18033A240 > 4u )
              {
                if ( TlgKeywordOn((TraceLoggingHProvider)&dword_18033A240, 2uLL) )
                {
                  ...
                  v34 = 8;
                  v35 = 0;
                  TlgWrite((TraceLoggingHProvider)&dword_18033A240, &unk_1802DFB6D, 0LL, 0LL, 5u, &pData);
                  v12 = v22;
                  v16 = v21;
                }
              }
