/*
 * XREFs of ?StringCchCatExW@@YAJPEAG_KPEBGPEAPEAGPEA_KK@Z @ 0x18022A914
 * Callers:
 ...
 * Callees:
 *     StringCopyWorkerW_0 @ 0x18022AA14 (StringCopyWorkerW_0.c)
 *     StringLengthWorkerW @ 0x18022AA90 (StringLengthWorkerW.c)
 */
