/*
 * XREFs of ?CalculateCenterPointForAxis@CInteractionTracker@@AEAAJPEAVCExpressionValueStack@@_KW4ScrollState@@W4ScrollAxis@@PEAM@Z @ 0x1801D91E0
 * Callers:
...
LABEL_24:
  ...
  MilInstrumentationCheckHR_MaybeFailFast(v14, 0LL, 0, v13, 0x16A4u, 0LL);
  return v15;
}
