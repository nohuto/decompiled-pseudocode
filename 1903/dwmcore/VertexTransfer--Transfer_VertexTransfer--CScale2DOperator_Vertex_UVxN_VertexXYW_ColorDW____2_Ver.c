/*
 * XREFs of VertexTransfer::Transfer_VertexTransfer::CScale2DOperator_Vertex_UVxN_VertexXYW_ColorDW____2_Vertex_UVxN_VertexXYW_ColorDW___ @ 0x1801B3AD4
 * Callers:
...
unsigned __int64 __fastcall VertexTransfer::Transfer_VertexTransfer::CScale2DOperator_Vertex_UVxN_VertexXYW_ColorDW____2_Vertex_UVxN_VertexXYW_ColorDW___(
        __int64 a1,
        float *a2)
{
  ...
  for ( i = *(float *)(a1 + 44);
        v4 < v3;
        *(_DWORD *)(v9 + 12) = result | (((int)(float)(unsigned __int8)BYTE1(*(_DWORD *)(v8 + 12)) | (((int)(float)(unsigned __int8)BYTE2(*(_DWORD *)(v8 + 12)) | ((int)(float)((float)HIBYTE(*(_DWORD *)(v8 + 12)) * i) << 8)) << 8)) << 8) )
  {
    ...
    *(_DWORD *)(v9 + 8) = 1065353216;
    ++v4;
    result = (unsigned int)(int)(float)(unsigned __int8)*(_DWORD *)(v8 + 12);
  }
  return result;
}
