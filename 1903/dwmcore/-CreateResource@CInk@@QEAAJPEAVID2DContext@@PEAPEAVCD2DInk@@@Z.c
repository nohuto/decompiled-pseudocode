/*
 * XREFs of ?CreateResource@CInk@@QEAAJPEAVID2DContext@@PEAPEAVCD2DInk@@@Z @ 0x180216604
 * Callers:
...
__int64 __fastcall CInk::CreateResource(CInk *this, struct ID2DContext *a2, struct CD2DInk **a3)
{
  ...
  if ( v9 < 0 )
  {
    MilInstrumentationCheckHR_MaybeFailFast(v10, 0LL, 0, v9, 0x132u, 0LL);
  }
  else
  {
    ...
    {
      MilInstrumentationCheckHR_MaybeFailFast(v13, 0LL, 0, ID2D1InkAndInkStyle, 0x134u, 0LL);
      v7 = v20;
    }
    else
    {
      ...
      if ( v14 < 0 )
      {
        MilInstrumentationCheckHR_MaybeFailFast(v15, 0LL, 0, v14, 0x135u, 0LL);
      }
      else
      {
        v16 = v18;
