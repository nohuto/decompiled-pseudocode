/*
 * XREFs of ?SetProperty@CVisual@@UEAAJIW4DCOMPOSITION_EXPRESSION_TYPE@@PEBX@Z @ 0x18007F310
 * Callers:
...
LABEL_42:
        v8 = -2147024809;
        MilInstrumentationCheckHR_MaybeFailFast((unsigned int)a1, 0LL, 0, -2147024809, 0xA42u, 0LL);
        return v8;
      }
      v19 = *(float *)(a4 + 4);
      v20 = *(float *)a4;
  ...
  if ( a2 > 0x1A )
  {
    ...
    if ( v24 )
    {
      ...
      if ( v25 )
      {
        ...
        {
          y = CVisual::GetRelativeOffsetInternal((CVisual *)a1, &v32)->y;
...
LABEL_24:
      ...
      v17 = v7;
      x = CVisual::GetRelativeOffsetInternal(v4, &v32)->x;
    }
    else
    {
