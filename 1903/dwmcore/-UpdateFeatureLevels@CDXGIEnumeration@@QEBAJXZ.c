/*
 * XREFs of ?UpdateFeatureLevels@CDXGIEnumeration@@QEBAJXZ @ 0x1800A87A0
 * Callers:
 ...
 *     ?AreEffectsSupported@CD3DDeviceLevel1@@QEAA_NXZ @ 0x1800A8BCC (-AreEffectsSupported@CD3DDeviceLevel1@@QEAA_NXZ.c)
 */
