/*
 * XREFs of ?reserve_region@?$vector_facade@VMatrix3x2F@D2D1@@V?$buffer_impl@VMatrix3x2F@D2D1@@$09$00Vliberal_expansion_policy@detail@@@detail@@@detail@@IEAAPEAVMatrix3x2F@D2D1@@_K0@Z @ 0x18025FBD8
 * Callers:
  ...
  *(_QWORD *)&v9 = v4 + 24 * v7;
  ...
  else
  {
    ...
    *((_QWORD *)&v18 + 1) = v7;
    ...
    {
LABEL_19:
      _o__invalid_parameter_noinfo_noreturn(v9, v6, v7, v5);
      JUMPOUT(0x18025FD80LL);
    }
    v19 = v7;
    v14 = 24 * a2;
    v16 = v18;
