/*
 * XREFs of ?QueryInterface@BamoDataProviderRegistrarPrincipal@@UEAAJAEBU_GUID@@PEAPEAX@Z @ 0x180196B20
 * Callers:
 *     ?QueryInterface@BamoDataProviderRegistrarPrincipal@@W7EAAJAEBU_GUID@@PEAPEAX@Z @ 0x1800ECF30 (-QueryInterface@BamoDataProviderRegistrarPrincipal@@W7EAAJAEBU_GUID@@PEAPEAX@Z.c)
 * Callees:
