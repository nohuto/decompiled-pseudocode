/*
 * XREFs of ?HasPrefilterScale@CSecondaryD2DBitmap@@IEBA_NXZ @ 0x18003F030
 * Callers:
 *     ?GetSize@CSecondaryD2DBitmap@@UEBAXPEAI0@Z @ 0x18003EB10 (-GetSize@CSecondaryD2DBitmap@@UEBAXPEAI0@Z.c)
