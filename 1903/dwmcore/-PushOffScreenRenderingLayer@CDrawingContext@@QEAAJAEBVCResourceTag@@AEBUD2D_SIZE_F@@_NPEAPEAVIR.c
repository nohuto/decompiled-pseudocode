/*
 * XREFs of ?PushOffScreenRenderingLayer@CDrawingContext@@QEAAJAEBVCResourceTag@@AEBUD2D_SIZE_F@@_NPEAPEAVIRenderTargetBitmap@@@Z @ 0x18003E014
 * Callers:
  ...
  *(_QWORD *)&v20 = 0LL;
  ...
  else
  {
    ...
    if ( v12 < 0 )
    {
      ...
      v11 = (COffScreenRenderingLayer *)v20;
    }
    else
    {
      v11 = (COffScreenRenderingLayer *)v20;
      ...
      if ( v15 >= 0 )
      {
        SetInterface<IRenderTargetBitmap,IRenderTargetBitmap>(a5, *((_QWORD *)v11 + 1));
        return v14;
      }
