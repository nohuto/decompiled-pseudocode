/*
 * XREFs of ?Update@BulkAnimator@Particles@@SAXPEBVITwoInputAnimator@2@UParticleStreamInfo@2@11I@Z @ 0x1801EA284
 * Callers:
...
__int64 __fastcall Particles::BulkAnimator::Update(__int64 a1, __int64 a2, __int64 *a3, __int64 *a4, unsigned int a5)
{
  ...
  v9 = (*(unsigned int (__fastcall **)(__int64))(*(_QWORD *)a1 + 16LL))(a1) >> 2;
  ...
  if ( a5 )
  {
    while ( 1 )
    {
      ...
      (**(void (__fastcall ***)(__int64, __int64 *, __int64 *, __int64 *))a1)(a1, &v23, &v21, &v19);
      ++v12;
