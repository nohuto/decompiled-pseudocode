/*
 * XREFs of ?GetProperty@CComponentTransform2D@@UEAAJIPEAVCExpressionValue@@@Z @ 0x1800B60E0
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall CComponentTransform2D::GetProperty(CComponentTransform2D *this, int a2, struct CExpressionValue *a3)
{
  ...
  else
  {
    ...
    {
      v3 = -2147024809;
      MilInstrumentationCheckHR_MaybeFailFast(v6, 0LL, v7, 0x80070057, 0x6Fu, (void *)(v7 & v11));
    }
  }
  return v3;
}
