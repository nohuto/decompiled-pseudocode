/*
 * XREFs of ?LoadRuntime@CMmcssTask@@AEAAJXZ @ 0x1800D0C18
 * Callers:
        ...
        *((_QWORD *)this + 7) = v5;
        if ( v5 )
        {
          ...
          *((_QWORD *)this + 9) = v6;
          ...
          if ( v1 >= 0 )
            v1 = -2003304445;
          MilInstrumentationCheckHR_MaybeFailFast(v15, 0LL, 0, v1, 0x14Eu, 0LL);
        }
        else
        {
          v12 = GetLastError();
          ...
          if ( v1 >= 0 )
            v1 = -2003304445;
          MilInstrumentationCheckHR_MaybeFailFast(v13, 0LL, 0, v1, 0x14Cu, 0LL);
        }
      }
      else
      {
        ...
        if ( v1 >= 0 )
          v1 = -2003304445;
        MilInstrumentationCheckHR_MaybeFailFast(v11, 0LL, 0, v1, 0x14Au, 0LL);
      }
    }
    else
    {
      ...
      if ( v1 >= 0 )
        v1 = -2003304445;
      MilInstrumentationCheckHR_MaybeFailFast(v9, 0LL, 0, v1, 0x147u, 0LL);
    }
