/*
 * XREFs of ?SetProperty@CDropShadow@@UEAAJIW4DCOMPOSITION_EXPRESSION_TYPE@@PEBX@Z @ 0x1801CA5C0
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall CDropShadow::SetProperty(__int64 a1, int a2, int a3)
{
  ...
  if ( AnimatablePropertyInfo )
  {
    ...
    v9 = v7;
    if ( v7 < 0 )
      MilInstrumentationCheckHR_MaybeFailFast(v8, 0LL, 0, v7, 0x78u, 0LL);
  }
  else
  {
    v9 = -2147024809;
    MilInstrumentationCheckHR_MaybeFailFast(v5, 0LL, 0, 0x80070057, 0x7Cu, 0LL);
  }
  return v9;
}
