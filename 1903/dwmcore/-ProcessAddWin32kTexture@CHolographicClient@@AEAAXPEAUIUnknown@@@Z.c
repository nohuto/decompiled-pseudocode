/*
 * XREFs of ?ProcessAddWin32kTexture@CHolographicClient@@AEAAXPEAUIUnknown@@@Z @ 0x180249684
 * Callers:
...
void __fastcall CHolographicClient::ProcessAddWin32kTexture(CHolographicClient *this, struct IUnknown *a2)
{
  ...
  if ( ((__int64 (__fastcall *)(struct IUnknown *, GUID *, __int64 *))a2->lpVtbl->QueryInterface)(
         ...
         &v3) >= 0 )
  {
    (*(void (__fastcall **)(_QWORD, __int64))(**((_QWORD **)this + 3) + 56LL))(*((_QWORD *)this + 3), v3);
