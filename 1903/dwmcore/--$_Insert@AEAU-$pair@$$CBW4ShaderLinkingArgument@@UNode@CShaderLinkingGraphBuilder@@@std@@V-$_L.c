        ...
        __int64 *a4)
{
  ...
  while ( v15 != *(_QWORD *)(*(_QWORD *)(v11 + 24) + 8 * v13) )
  {
    v15 = *(_QWORD *)(v14 + 8);
    v14 = v15;
    if ( *(_WORD *)v6 == *(_WORD *)(v15 + 16) )
    {
      std::list<std::pair<enum ShaderLinkingArgument const,CShaderLinkingGraphBuilder::Node>>::erase(v11 + 8, &v23, a4);
      *(_QWORD *)a2 = v14;
      *(_BYTE *)(a2 + 8) = 0;
      return a2;
    }
  ...
  std::_Hash<std::_Umap_traits<enum ShaderLinkingArgument,CShaderLinkingGraphBuilder::Node,std::_Uhash_compare<enum ShaderLinkingArgument,std::hash<enum ShaderLinkingArgument>,std::equal_to<enum ShaderLinkingArgument>>,std::allocator<std::pair<enum ShaderLinkingArgument const,CShaderLinkingGraphBuilder::Node>>,0>>::_Check_size(v11);
  *(_QWORD *)a2 = a4;
  *(_BYTE *)(a2 + 8) = 1;
  return a2;
}
