/*
 * XREFs of ?IsMonitorSpecificContent@CCachedVisualImage@@UEBA_NXZ @ 0x1801C9570
 * Callers:
 *     ?IsMonitorSpecificContent@CHwndBitmap@@UEBA_NXZ @ 0x180216540 (-IsMonitorSpecificContent@CHwndBitmap@@UEBA_NXZ.c)
 * Callees:
