/*
 * XREFs of ?Init@CHwTextureRenderTarget@@IEAAJPEAVCD3DDeviceLevel1@@AEBVCResourceTag@@IIAEBUPixelFormatInfo@@_N@Z @ 0x1800B23A0
 * Callers:
        ...
        bool a7)
{
  ...
  if ( (unsigned int)v11 > *((_DWORD *)a2 + 189) )
  {
    v23 = *((_DWORD *)a2 + 189);
LABEL_19:
    v18 = -2003292287;
