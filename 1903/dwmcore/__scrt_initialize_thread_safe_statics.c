/*
 * XREFs of __scrt_initialize_thread_safe_statics @ 0x1800E8360
 * Callers:
 *     <none>
 * Callees:
...
__int64 _scrt_initialize_thread_safe_statics()
{
  ...
  InitializeCriticalSectionAndSpinCount(&stru_18033C498, 0xFA0u);
...
LABEL_13:
  ...
  {
    hHandle = 0LL;
    ((void (__fastcall *)(void *))ProcAddress)(&unk_18033C4C0);
    qword_18033C4D0 = __ROR8__(v2, 64 - ((unsigned __int8)_security_cookie & 0x3Fu)) ^ _security_cookie;
    qword_18033C4D8 = __ROR8__(v4, 64 - ((unsigned __int8)_security_cookie & 0x3Fu)) ^ _security_cookie;
  }
  else
  {
