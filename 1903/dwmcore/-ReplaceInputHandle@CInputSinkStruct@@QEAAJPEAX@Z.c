/*
 * XREFs of ?ReplaceInputHandle@CInputSinkStruct@@QEAAJPEAX@Z @ 0x180029540
 * Callers:
 *     ?UpdateInputSink@CInteraction@@QEAAJPEAX@Z @ 0x1800294B4 (-UpdateInputSink@CInteraction@@QEAAJPEAX@Z.c)
 * Callees:
 *     ?InitializeQueues@CInputSinkStruct@@AEAAXXZ @ 0x180029638 (-InitializeQueues@CInputSinkStruct@@AEAAXXZ.c)
