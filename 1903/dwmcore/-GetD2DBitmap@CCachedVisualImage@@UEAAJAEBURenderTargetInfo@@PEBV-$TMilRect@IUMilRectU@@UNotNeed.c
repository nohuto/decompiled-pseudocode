/*
 * XREFs of ?GetD2DBitmap@CCachedVisualImage@@UEAAJAEBURenderTargetInfo@@PEBV?$TMilRect@IUMilRectU@@UNotNeeded@RectUniqueness@@@@_NPEAPEAUID2D1Bitmap1@@@Z @ 0x1801C91F0
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall CCachedVisualImage::GetD2DBitmap(__int64 a1, __int64 a2, __int64 a3, char a4, _QWORD *a5)
{
  ...
  *a5 = 0LL;
  ...
  if ( v9 < 0 )
  {
    MilInstrumentationCheckHR_MaybeFailFast(v10, &dword_180311B98, 1u, v9, 0x6D4u, 0LL);
  }
  else if ( v16 )
  {
    LOBYTE(v11) = a4;
    ...
    v12 = v13;
    if ( v13 < 0 )
      MilInstrumentationCheckHR_MaybeFailFast(v14, &dword_180311B98, 1u, v13, 0x6DDu, 0LL);
  }
  return v12;
}
