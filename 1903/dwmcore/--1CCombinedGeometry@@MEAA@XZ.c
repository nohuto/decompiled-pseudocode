/*
 * XREFs of ??1CCombinedGeometry@@MEAA@XZ @ 0x1801CF4F0
 * Callers:
 *     ??_ECCombinedGeometry@@MEAAPEAXI@Z @ 0x18019EEC0 (--_ECCombinedGeometry@@MEAAPEAXI@Z.c)
 * Callees:
 *     ?UnRegisterNotifiers@CCombinedGeometry@@UEAAXXZ @ 0x180212910 (-UnRegisterNotifiers@CCombinedGeometry@@UEAAXXZ.c)
 */
