/*
 * XREFs of ?PushHoverPointer@CHoverPointerSource@@UEAAJAEBUD2D_POINT_2F@@@Z @ 0x1800A4240
 * Callers:
 *     <none>
 * Callees:
    ...
    if ( v5 )
    {
      ...
      else
      {
        ...
        if ( v9 )
        {
          ...
          v15 = this;
          v11 = v9;
          v2 = CoreUICallSend(v5, &v11, 1LL, 10LL, v10, &unk_1802B2E82, (unsigned int)&v15, &v14);
          if ( v2 < 0 )
