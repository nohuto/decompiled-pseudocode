/*
 * XREFs of ?Matrix4x4FromRotationY@CExpressionValueStack@@QEAAJI@Z @ 0x1802025FC
 * Callers:
...
LABEL_11:
  ...
  if ( *(_DWORD *)(v5 + 72) != 18 )
    goto LABEL_11;
  D2DMatrixRotationY((struct D2DMatrix *)v17, *(float *)v5);
LABEL_10:
  v9 = v17[1];
  *(_OWORD *)v5 = v17[0];
  v10 = v17[2];
