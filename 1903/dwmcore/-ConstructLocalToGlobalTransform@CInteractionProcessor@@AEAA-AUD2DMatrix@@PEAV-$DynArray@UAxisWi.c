/*
 * XREFs of ?ConstructLocalToGlobalTransform@CInteractionProcessor@@AEAA?AUD2DMatrix@@PEAV?$DynArray@UAxisWithType@@$0A@@@@Z @ 0x180230A48
 * Callers:
...
__int64 __fastcall CInteractionProcessor::ConstructLocalToGlobalTransform(__int64 *a1, __int64 a2, __int64 *a3)
{
  ...
  if ( dword_18033A240 > 4u && TlgKeywordOn((TraceLoggingHProvider)&dword_18033A240, 2uLL) )
  {
    ...
    v54 = a2 + 40;
    v55 = v14;
    TlgWrite((TraceLoggingHProvider)&dword_18033A240, &unk_1802DE9A9, 0LL, 0LL, 0x11u, &pData);
  }
  return a2;
}
