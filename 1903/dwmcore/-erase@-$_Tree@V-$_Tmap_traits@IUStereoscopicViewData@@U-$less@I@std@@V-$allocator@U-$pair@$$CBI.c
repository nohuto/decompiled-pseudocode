 ...
 *     ?_Erase@?$_Tree@V?$_Tmap_traits@IUStereoscopicViewData@@U?$less@I@std@@V?$allocator@U?$pair@$$CBIUStereoscopicViewData@@@std@@@3@$0A@@std@@@std@@IEAAXPEAU?$_Tree_node@U?$pair@$$CBIUStereoscopicViewData@@@std@@PEAX@2@@Z @ 0x180243C30 (-_Erase@-$_Tree@V-$_Tmap_traits@IUStereoscopicViewData@@U-$less@I@std@@V-$allocator@U-$pair@$$CB.c)
 */
        ...
        __int64 *a4)
{
  ...
  else
  {
    while ( v6 != a4 )
    {
      ...
      std::_Deallocate<16,0>(v14, 0xE0uLL);
    }
    *a2 = v6;
  }
  return a2;
