/*
 * XREFs of ?SortVisuals@CDepthSortingLayer@@QEAA_NPEAV?$vector@PEAVCVisual@@V?$allocator@PEAVCVisual@@@std@@@std@@AEBV?$vector@VCVisualDepthGeometry@@V?$allocator@VCVisualDepthGeometry@@@std@@@3@@Z @ 0x18025C8E8
 * Callers:
 ...
 *     ??0?$vector@UDepthGraphNode@@V?$allocator@UDepthGraphNode@@@std@@@std@@QEAA@_KAEBV?$allocator@UDepthGraphNode@@@1@@Z @ 0x18025C704 (--0-$vector@UDepthGraphNode@@V-$allocator@UDepthGraphNode@@@std@@@std@@QEAA@_KAEBV-$allocator@UD.c)
 *     ?_Tidy@?$vector@UDepthGraphNode@@V?$allocator@UDepthGraphNode@@@std@@@std@@AEAAXXZ @ 0x18025CC28 (-_Tidy@-$vector@UDepthGraphNode@@V-$allocator@UDepthGraphNode@@@std@@@std@@AEAAXXZ.c)
 */
