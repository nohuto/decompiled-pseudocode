/*
 * XREFs of McTemplateU0qqqqq @ 0x1801797FC
 * Callers:
...
ULONG __fastcall McTemplateU0qqqqq(__int64 a1, __int64 a2, __int64 a3, int a4, char a5, char a6, char a7)
{
  ...
  v17 = &a7;
  v18 = 4LL;
  return McGenEventWrite(Microsoft_Windows_Dwm_Core_Provider_Context, &EVTDESC_SCHEDULE_WFW_Stop, a3, 6u, &v8);
}
