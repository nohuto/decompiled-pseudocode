/*
 * XREFs of ?SupportsInteractionType@CInteractionProcessor@@QEBAHW4InputType@@I_N@Z @ 0x1800C839C
 * Callers:
 *     ?SupportsInteractionType@CInteraction@@UEBAHW4InputType@@I_N@Z @ 0x1800C8380 (-SupportsInteractionType@CInteraction@@UEBAHW4InputType@@I_N@Z.c)
 *     ?SupportsInteractionType@CInteractionRoot@@UEBAHW4InputType@@I_N@Z @ 0x18023ECF0 (-SupportsInteractionType@CInteractionRoot@@UEBAHW4InputType@@I_N@Z.c)
 * Callees:
