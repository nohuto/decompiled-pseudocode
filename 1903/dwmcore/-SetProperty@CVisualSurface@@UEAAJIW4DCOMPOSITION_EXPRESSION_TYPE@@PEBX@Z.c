/*
 * XREFs of ?SetProperty@CVisualSurface@@UEAAJIW4DCOMPOSITION_EXPRESSION_TYPE@@PEBX@Z @ 0x1801FE830
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall CVisualSurface::SetProperty(__int64 a1, int a2, int a3)
{
  ...
  {
    v9 = -2147024809;
    MilInstrumentationCheckHR_MaybeFailFast(v5, 0LL, 0, 0x80070057, 0x44u, 0LL);
  }
  return v9;
}
