/*
 * XREFs of ?DwmHolographicSuspendRequest_@CompositorTracing@@QEAAX_N@Z @ 0x1802414D4
 * Callers:
 *     ?ToggleSuspension@CHolographicManager@@UEAAX_N@Z @ 0x1800D5E60 (-ToggleSuspension@CHolographicManager@@UEAAX_N@Z.c)
 * Callees:
...
void __fastcall CompositorTracing::DwmHolographicSuspendRequest_(CompositorTracing *this, char a2)
{
  ...
  if ( *(_DWORD *)v2 > 4u )
  {
    if ( TlgKeywordOn(v2, 0x400000000000uLL) )
    {
      ...
      v5 = &v8;
      v6 = 1;
      TlgWrite(v3, &unk_1802E0C60, 0LL, 0LL, 3u, &pData);
    }
  }
}
