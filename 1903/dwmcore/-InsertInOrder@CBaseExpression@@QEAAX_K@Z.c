/*
 * XREFs of ?InsertInOrder@CBaseExpression@@QEAAX_K@Z @ 0x1800BDB78
 * Callers:
 ...
 *     ?InsertDependenciesInOrder@CExpression@@UEAAX_K@Z @ 0x1800BDA60 (-InsertDependenciesInOrder@CExpression@@UEAAX_K@Z.c)
 ...
 *     ?InsertDependenciesInOrder@CConditionalExpression@@UEAAX_K@Z @ 0x1801D4840 (-InsertDependenciesInOrder@CConditionalExpression@@UEAAX_K@Z.c)
 * Callees:
  ...
  *((_DWORD *)this + 37) = v2 + 1;
  if ( v2 < 1 && *((_QWORD *)this + 19) != a2 )
  {
    ...
    if ( (*((_BYTE *)this + 208) & 2) != 0 )
    {
      ...
      {
        v13 = DynArrayImpl<1>::AddMultipleAndSet(v10 + 168, 8u, v10, &v16);
        if ( v13 < 0 )
