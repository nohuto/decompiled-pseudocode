/*
 * XREFs of ?SetHardwareProtection@CHwSurfaceRenderTarget@@UEAAJ_N@Z @ 0x180163AC0
 * Callers:
 *     ?SetHardwareProtection@CHwTextureRenderTarget@@UEAAJ_N@Z @ 0x180163B20 (-SetHardwareProtection@CHwTextureRenderTarget@@UEAAJ_N@Z.c)
 * Callees:
