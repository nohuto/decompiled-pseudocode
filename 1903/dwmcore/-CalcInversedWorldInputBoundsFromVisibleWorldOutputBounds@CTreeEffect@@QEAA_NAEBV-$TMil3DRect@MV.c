...
__int64 __fastcall CTreeEffect::CalcInversedWorldInputBoundsFromVisibleWorldOutputBounds(_QWORD *a1)
{
  __int64 result; // rax

  result = 0LL;
  if ( *a1 )
    return CEffectBrush::CalcInversedWorldInputBoundsFromVisibleWorldOutputBounds(*a1);
  return result;
}
