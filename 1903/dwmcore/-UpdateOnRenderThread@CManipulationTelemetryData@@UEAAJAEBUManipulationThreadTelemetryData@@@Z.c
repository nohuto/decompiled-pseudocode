/*
 * XREFs of ?UpdateOnRenderThread@CManipulationTelemetryData@@UEAAJAEBUManipulationThreadTelemetryData@@@Z @ 0x1802366F0
 * Callers:
 *     <none>
 * Callees:
        ...
        const struct ManipulationThreadTelemetryData *a2)
{
  ...
  if ( dword_18033A240 > 5u && TlgKeywordOn((TraceLoggingHProvider)&dword_18033A240, 2uLL) )
  {
    ...
    v50 = 4LL;
    v52 = 4LL;
    TlgWrite((TraceLoggingHProvider)&dword_18033A240, &unk_1802DF49D, 0LL, 0LL, 0xDu, &pData);
  }
