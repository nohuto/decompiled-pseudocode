/*
 * XREFs of ?ProgressSeek@CKeyframeAnimation@@AEAAJM@Z @ 0x1801E1A34
 * Callers:
  ...
  else
  {
    ...
    if ( (v4 & 1) != 0 && (v4 & 2) == 0 )
    {
      *((_DWORD *)this + 125) = 0;
      ...
      if ( *(_DWORD *)(v8 + 496) == 1 && (v13 = *(_DWORD *)(v8 + 448)) != 0 )
      {
        v14 = *(KeyframeSequence **)(v8 + 360);
        ...
        {
          *(_BYTE *)(v8 + 540) &= ~0x40u;
          *(_BYTE *)(v8 + 540) |= *(_DWORD *)(v8 + 452) < v13 ? 0 : 0x40;
          *(_DWORD *)(v8 + 452) = (int)v15;
          KeyframeSequence::ConfigureTimer(v14);
          *(_DWORD *)(v16 + 92) = 0;
        }
      }
      ...
      {
        KeyframeSequence::ConfigureTimer(*(KeyframeSequence **)(v8 + 360));
