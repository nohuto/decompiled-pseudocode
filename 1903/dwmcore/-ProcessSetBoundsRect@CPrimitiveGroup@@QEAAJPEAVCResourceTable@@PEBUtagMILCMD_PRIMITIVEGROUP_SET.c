/*
 * XREFs of ?ProcessSetBoundsRect@CPrimitiveGroup@@QEAAJPEAVCResourceTable@@PEBUtagMILCMD_PRIMITIVEGROUP_SETBOUNDSRECT@@@Z @ 0x18003A690
 * Callers:
        ...
        const struct tagMILCMD_PRIMITIVEGROUP_SETBOUNDSRECT *a3)
{
    ...
    && (unsigned __int8)operator!=(v3 + 92) )
  {
    v7 = *v6;
    *v5 = *v4;
    (*(void (__fastcall **)(__int64 *, __int64))(v7 + 64))(v6, 3LL);
  }
  return 0LL;
}
