/*
 * XREFs of ?ProcessSetViewBox@CShapeVisual@@QEAAJPEAVCResourceTable@@PEBUtagMILCMD_SHAPEVISUAL_SETVIEWBOX@@@Z @ 0x1801FA400
 * Callers:
        ...
        const struct tagMILCMD_SHAPEVISUAL_SETVIEWBOX *a3)
{
  ...
  v7 = -2003303421;
  MilInstrumentationCheckHR_MaybeFailFast(v6, 0LL, 0, 0x88980403, 0x13u, 0LL);
  return v7;
}
