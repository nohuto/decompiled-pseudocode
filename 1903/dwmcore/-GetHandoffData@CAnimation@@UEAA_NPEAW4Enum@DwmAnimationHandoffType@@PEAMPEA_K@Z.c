/*
 * XREFs of ?GetHandoffData@CAnimation@@UEAA_NPEAW4Enum@DwmAnimationHandoffType@@PEAMPEA_K@Z @ 0x1800BCAE0
 * Callers:
 *     <none>
 * Callees:
    ...
    if ( (*((_BYTE *)this + 8) & 0x40) == 0 )
    {
      if ( *((_DWORD *)this + 49) )
      {
        ...
        if ( (_DWORD)v14 )
        {
          ...
          v19[1] = v14;
          LOWORD(v17) = 1;
          CoreUICallSend(*(_QWORD *)(*(_QWORD *)(v16 + 1224) + 48LL), v19, 2LL, 1LL, v17, &unk_1802B2E2B, v15, v18);
          *((_BYTE *)this + 8) |= 0x40u;
        }
      }
    }
