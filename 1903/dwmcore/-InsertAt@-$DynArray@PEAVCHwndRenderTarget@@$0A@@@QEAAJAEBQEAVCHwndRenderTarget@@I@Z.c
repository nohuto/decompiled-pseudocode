/*
 * XREFs of ?InsertAt@?$DynArray@PEAVCHwndRenderTarget@@$0A@@@QEAAJAEBQEAVCHwndRenderTarget@@I@Z @ 0x1800A3BAC
 * Callers:
...
__int64 __fastcall DynArray<CHwndRenderTarget *,0>::InsertAt(__int64 a1, unsigned __int64 a2)
{
  ...
  v11 = (_QWORD *)a2;
  v3 = DynArrayImpl<0>::Grow(a1, 8u, 1, 0, (unsigned __int64 *)&v11);
  v5 = v3;
  if ( v3 < 0 )
  {
