/*
 * XREFs of ?EnsureResources@CCaptureRenderTarget@@IEAAJPEAVCD3DDeviceLevel1@@@Z @ 0x1800EBBE4
 * Callers:
 ...
 *     ??1?$unique_any_t@V?$unique_storage@U?$handle_null_resource_policy@P6AHPEAX@Z$1?CloseHandle@@YAH0@Z@details@wil@@@details@wil@@@wil@@QEAA@XZ @ 0x18015BBC4 (--1-$unique_any_t@V-$unique_storage@U-$handle_null_resource_policy@P6AHPEAX@Z$1-CloseHandle@@YAH.c)
...
LABEL_4:
    for ( i = (__int64)(*((_QWORD *)this + 65) - *((_QWORD *)this + 64)) >> 3; ; LODWORD(i) = i + 1 )
    {
      ...
      if ( v11 < 0 )
      {
        MilInstrumentationCheckHR_MaybeFailFast(v12, 0LL, 0, v11, 0x143u, 0LL);
        goto LABEL_27;
      }
      ...
      if ( ((*((_QWORD *)this + 65) - *((_QWORD *)this + 64)) & 0xFFFFFFFFFFFFFFF8uLL) == 0 )
      {
        ...
        if ( updated < 0 )
        {
          MilInstrumentationCheckHR_MaybeFailFast(v15, 0LL, 0, updated, 0x154u, 0LL);
          goto LABEL_27;
        }
        if ( !*((_BYTE *)this + 418) )
        {
      ...
      if ( v16 < 0 )
      {
        MilInstrumentationCheckHR_MaybeFailFast(v17, 0LL, 0, v16, 0x161u, 0LL);
LABEL_22:
...
LABEL_27:
      ...
      if ( v18 < 0 )
      {
        MilInstrumentationCheckHR_MaybeFailFast(v19, 0LL, 0, v18, 0x164u, 0LL);
        goto LABEL_22;
      }
      ...
      if ( v20 < 0 )
      {
        MilInstrumentationCheckHR_MaybeFailFast(v21, 0LL, 0, v20, 0x16Bu, 0LL);
        goto LABEL_22;
      }
      v26 = v27;
  ...
  MilInstrumentationCheckHR_MaybeFailFast(v7, 0LL, 0, SupportedFence, 0x12Eu, 0LL);
LABEL_28:
  if ( v2 < 0 )
  {
