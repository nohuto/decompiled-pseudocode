/*
 * XREFs of ?HandleGetD2DFactoryNoRef@CD3DDeviceManager@@QEAAJPEAPEAVCD2DFactory@@@Z @ 0x1800D2370
 * Callers:
...
__int64 __fastcall CD3DDeviceManager::HandleGetD2DFactoryNoRef(CD3DDeviceManager *this, struct CD2DFactory **a2)
{
  ...
  if ( qword_1803403A8 )
    goto LABEL_2;
  v7 = CD2DFactory::Create(v3, 0, &qword_1803403A8);
  v5 = v7;
  if ( v7 < 0 )
  {
  ...
  v9 = CMesh2DEffect::Register(qword_1803403A8);
  v5 = v9;
  if ( v9 < 0 )
