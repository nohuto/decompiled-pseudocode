/*
 * XREFs of ?UpdateDisplay@COverlayContext@@QEAAXPEBVCDisplay@@@Z @ 0x1800AF814
 * Callers:
...
void __fastcall COverlayContext::UpdateDisplay(COverlayContext *this, const struct CDisplay *a2)
{
  ...
  *(_DWORD *)(v6 + 13408) = 0;
  ...
  if ( qword_18033CC08 )
  {
    ...
    {
      v9 = *((_QWORD *)qword_18033CC08 + 8);
      while ( v7 != *(_QWORD *)(*(_QWORD *)(v9 + 8 * v8) + 336LL) )
      {
        v8 = (unsigned int)(v8 + 1);
        if ( (unsigned int)v8 >= *((_DWORD *)qword_18033CC08 + 22) )
          return;
      }
      IsXboxAdapter = CDXGIAdapterLimited::IsXboxAdapter(*(const wchar_t **)(v9 + 8 * v8));
