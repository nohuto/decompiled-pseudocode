/*
 * XREFs of ?EnumerateOutputs@CDisplaySet@@AEAAJXZ @ 0x1800A7A84
 * Callers:
 ...
 *     ?IsAttachedToDesktop@DXGIOutputInfo@@QEBA_NXZ @ 0x1800A7BE4 (-IsAttachedToDesktop@DXGIOutputInfo@@QEBA_NXZ.c)
...
LABEL_3:
  ...
  while ( 1 )
  {
    ...
    {
      v17 = DynArrayImpl<0>::AddMultipleAndSet((__int64)this + 48, 8, 1, &v22);
      v2 = v17;
      if ( v17 < 0 )
