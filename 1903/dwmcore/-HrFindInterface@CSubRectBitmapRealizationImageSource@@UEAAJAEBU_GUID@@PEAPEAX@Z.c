/*
 * XREFs of ?HrFindInterface@CSubRectBitmapRealizationImageSource@@UEAAJAEBU_GUID@@PEAPEAX@Z @ 0x18025AD50
 * Callers:
 *     <none>
 * Callees:
 *     <none>
...
__int64 __fastcall CSubRectBitmapRealizationImageSource::HrFindInterface(
