/*
 * XREFs of ?GetSimplifiedPathData@CShape@@QEBAJPEAPEAVCPathData@@@Z @ 0x18024BA58
 * Callers:
...
LABEL_5:
  ...
  v5 = (*(__int64 (__fastcall **)(CShape *, struct CPathData **))(*(_QWORD *)this + 56LL))(this, &v9);
  v2 = v5;
  if ( v5 >= 0 )
  {
  ...
  MilInstrumentationCheckHR_MaybeFailFast(v6, 0LL, 0, v5, 0x3BCu, 0LL);
  v7 = v9;
LABEL_6:
  if ( v7 )
  {
