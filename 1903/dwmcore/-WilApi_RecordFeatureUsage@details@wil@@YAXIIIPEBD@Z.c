/*
 * XREFs of ?WilApi_RecordFeatureUsage@details@wil@@YAXIIIPEBD@Z @ 0x1800ACDBC
 * Callers:
 ...
 *     ?RecordSRUMFeatureUsage@details@wil@@YAXIII@Z @ 0x1801560A0 (-RecordSRUMFeatureUsage@details@wil@@YAXIII@Z.c)
 * Callees:
