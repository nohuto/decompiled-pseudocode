/*
 * XREFs of ?UpdateValueWithChaining@CScrollAnimation@@IEAAMMMW4Boundary@@@Z @ 0x18020798C
 * Callers:
 ...
 *     ?ChainToParent@CChainingHelper@@QEAAXW4ScrollAxis@@W4Boundary@@_N@Z @ 0x180220AB0 (-ChainToParent@CChainingHelper@@QEAAXW4ScrollAxis@@W4Boundary@@_N@Z.c)
...
float __fastcall CScrollAnimation::UpdateValueWithChaining(__int64 a1, float a2, float a3, unsigned int a4)
{
  ...
  if ( ActiveChainingHelper )
  {
    ...
    if ( dword_18033A240 > 4u && TlgKeywordOn((TraceLoggingHProvider)&dword_18033A240, 2uLL) )
    {
      ...
      v90 = v19;
      TlgWrite((TraceLoggingHProvider)&dword_18033A240, &unk_1802DD387, 0LL, 0LL, 0x10u, &pData);
    }
    v20 = *(_BYTE *)(a1 + 428);
    if ( (v20 & 2) == 0 && v12 == 2 )
    {
