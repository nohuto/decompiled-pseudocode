/*
 * XREFs of ?Remove@?$CQueue@V?$ComPtr@VCManipulationFrame@@@WRL@Microsoft@@@@AEAA?AV?$ComPtr@VCManipulationFrame@@@WRL@Microsoft@@_NPEAI@Z @ 0x1800D7C58
 * Callers:
...
LABEL_10:
  ...
  v7 = (void **)qword_1803404B8;
  v11 = *(_QWORD **)(qword_1803404B8 + 8);
  if ( *(void ***)qword_1803404B8 != &CGlobalManipulationManager::s_InputQueue || *v11 != qword_1803404B8 )
    goto LABEL_10;
  qword_1803404B8 = *(_QWORD *)(qword_1803404B8 + 8);
