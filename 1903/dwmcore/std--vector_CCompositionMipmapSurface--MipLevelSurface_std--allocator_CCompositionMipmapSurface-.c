/*
 * XREFs of std::vector_CCompositionMipmapSurface::MipLevelSurface_std::allocator_CCompositionMipmapSurface::MipLevelSurface___::_Resize__lambda_a2eaa8aad34492302e036d5b613ed997___ @ 0x1801D12C4
 * Callers:
 ...
 *     ?_Change_array@?$vector@UMipLevelSurface@CCompositionMipmapSurface@@V?$allocator@UMipLevelSurface@CCompositionMipmapSurface@@@std@@@std@@AEAAXQEAUMipLevelSurface@CCompositionMipmapSurface@@_K1@Z @ 0x1801D1F6C (-_Change_array@-$vector@UMipLevelSurface@CCompositionMipmapSurface@@V-$allocator@UMipLevelSurfac.c)
 */
