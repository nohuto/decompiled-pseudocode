/*
 * XREFs of ??_GCRemoteSuperWetInkScribble@@UEAAPEAXI@Z @ 0x1801B2760
 * Callers:
 *     <none>
 * Callees:
...
CRemoteSuperWetInkScribble *__fastcall CRemoteSuperWetInkScribble::`scalar deleting destructor'(
