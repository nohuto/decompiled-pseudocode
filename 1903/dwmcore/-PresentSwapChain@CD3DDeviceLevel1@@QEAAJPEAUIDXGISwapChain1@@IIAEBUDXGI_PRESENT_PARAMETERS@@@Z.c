/*
 * XREFs of ?PresentSwapChain@CD3DDeviceLevel1@@QEAAJPEAUIDXGISwapChain1@@IIAEBUDXGI_PRESENT_PARAMETERS@@@Z @ 0x18015E084
 * Callers:
        ...
        const struct DXGI_PRESENT_PARAMETERS *a5)
{
  ...
  if ( v5 < 0 )
  {
    MilInstrumentationCheckHR_MaybeFailFast((__int64)this, &dword_1802E4148, 1u, v5, 0xC51u, 0LL);
  }
  else
  {
    ...
    if ( v8 < 0 )
    {
      MilInstrumentationCheckHR_MaybeFailFast(v9, &dword_1802E4148, 1u, v8, 0xC55u, 0LL);
    }
    else if ( (v6 & 1) == 0 )
    {
