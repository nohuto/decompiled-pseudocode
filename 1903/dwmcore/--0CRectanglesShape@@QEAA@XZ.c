/*
 * XREFs of ??0CRectanglesShape@@QEAA@XZ @ 0x1800B57A0
 * Callers:
 *     _dynamic_initializer_for__CRectanglesShape::sc_emptyShape__ @ 0x180003450 (_dynamic_initializer_for__CRectanglesShape--sc_emptyShape__.c)
 * Callees:
 *     <none>
 */
