/*
 * XREFs of ?VisualSetClip@CChannel@@UEAAJII@Z @ 0x1800400D0
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall CChannel::VisualSetClip(CChannel *this, unsigned int a2, unsigned int a3)
{
  unsigned int v6; // ebx
  ...
  CChannel::CheckOptionalHandle(this, a3, 62LL);
  v8[0] = 485;
  v8[1] = a2;
  v8[2] = a3;
