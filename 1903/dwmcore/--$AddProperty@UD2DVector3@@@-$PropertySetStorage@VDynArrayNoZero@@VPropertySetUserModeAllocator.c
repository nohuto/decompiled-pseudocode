/*
 * XREFs of ??$AddProperty@UD2DVector3@@@?$PropertySetStorage@VDynArrayNoZero@@VPropertySetUserModeAllocator@@@@QEAAJW4DCOMPOSITION_EXPRESSION_TYPE@@PEBUD2DVector3@@PEAI@Z @ 0x18001E19C
 * Callers:
...
LABEL_6:
  ...
  if ( (int)result >= 0 )
  {
    *(_DWORD *)(a1 + 56) += 12;
    v14 = *(_QWORD *)(a1 + 32);
    *(_QWORD *)(v5 + v14) = *(_QWORD *)a3;
    *(_DWORD *)(v5 + v14 + 8) = *(_DWORD *)(a3 + 8);
    result = 0LL;
    *a4 = v7;
  }
  return result;
