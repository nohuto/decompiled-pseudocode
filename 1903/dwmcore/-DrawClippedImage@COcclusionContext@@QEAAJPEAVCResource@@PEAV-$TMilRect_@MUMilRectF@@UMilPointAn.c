/*
 * XREFs of ?DrawClippedImage@COcclusionContext@@QEAAJPEAVCResource@@PEAV?$TMilRect_@MUMilRectF@@UMilPointAndSizeF@@UNotNeeded@RectUniqueness@@@@AEBVCShape@@U?$TMILFlagsEnum@W4FlagsEnum@MilSourceModification@@@@@Z @ 0x180019604
 * Callers:
...
__int64 __fastcall COcclusionContext::DrawClippedImage(__int64 a1, __int64 a2, float *a3, __int64 a4, unsigned int a5)
{
  ...
  if ( !*(_DWORD *)(a1 + 1044) )
  {
    ...
    if ( DoesImageOcclude < 0 )
    {
      v24 = 1272;
LABEL_29:
      MilInstrumentationCheckHR_MaybeFailFast(v11, 0LL, 0, DoesImageOcclude, v24, 0LL);
      goto LABEL_23;
    }
    if ( v26
      ...
      && LODWORD(v25[0]) )
    {
      ...
      {
        v5 = -2147024882;
        MilInstrumentationCheckHR_MaybeFailFast(v14, 0LL, 0, -2147024882, 0x4FEu, 0LL);
      }
    }
  }
LABEL_23:
