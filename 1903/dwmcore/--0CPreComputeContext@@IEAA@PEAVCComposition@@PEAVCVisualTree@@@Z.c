/*
 * XREFs of ??0CPreComputeContext@@IEAA@PEAVCComposition@@PEAVCVisualTree@@@Z @ 0x1800EC034
 * Callers:
 ...
 *     ??0CBspPreComputeHelper@@QEAA@XZ @ 0x1800D2A5C (--0CBspPreComputeHelper@@QEAA@XZ.c)
 */
