/*
 * XREFs of ?BuildDrawList@CCompositionSkyBoxBrush@@AEAAJPEAVCBrushDrawListGenerator@@PEAVCDrawListEntryBuilder@@@Z @ 0x1801D28CC
 * Callers:
...
LABEL_22:
  ...
  {
LABEL_36:
    Microsoft::WRL::ComPtr<ID2DBitmap>::InternalRelease((__int64 *)&v32 + 1);
    Microsoft::WRL::ComPtr<ID2DBitmap>::InternalRelease((__int64 *)&v32);
LABEL_23:
    if ( v11 >= 0 )
      goto LABEL_25;
    goto LABEL_24;
