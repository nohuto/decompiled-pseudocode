/*
 * XREFs of ?EnsureTargetBitmap@CDecodeBitmap@@QEAAJIIW4DXGI_FORMAT@@W4DXGI_ALPHA_MODE@@VDisplayId@@_N@Z @ 0x180264AF4
 * Callers:
  ...
  else
  {
    ...
    else
    {
      ...
      *(_BYTE *)(a1 + 205) = 0;
      ...
      if ( v15 < 0 )
      {
        MilInstrumentationCheckHR_MaybeFailFast(v16, 0LL, 0, v15, 0x6Fu, 0LL);
      }
      else
      {
