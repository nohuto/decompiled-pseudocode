/*
 * XREFs of ?CheckSingleBitmapLuidAndDisplayId@CRenderTargetBitmap@@IEBAJU_LUID@@VDisplayId@@@Z @ 0x1800B2F28
 * Callers:
...
__int64 __fastcall CRenderTargetBitmap::CheckSingleBitmapLuidAndDisplayId(__int64 a1, __int64 a2, int a3)
{
  ...
  else
  {
    ...
    if ( __PAIR64__(HIDWORD(v12), v5) != v13
      || (_DWORD)v9 != a3 && (_DWORD)v9 != (_DWORD)DisplayId::None && a3 != (_DWORD)DisplayId::All )
    {
      v8 = -2003304287;
      MilInstrumentationCheckHR_MaybeFailFast(v9, 0LL, 0, 0x889800A1, 0x1BAu, 0LL);
    }
  }
  return v8;
}
