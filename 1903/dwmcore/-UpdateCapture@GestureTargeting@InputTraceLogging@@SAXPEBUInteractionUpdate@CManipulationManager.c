/*
 * XREFs of ?UpdateCapture@GestureTargeting@InputTraceLogging@@SAXPEBUInteractionUpdate@CManipulationManager@@@Z @ 0x18023B5D0
 * Callers:
        ...
        const struct CManipulationManager::InteractionUpdate *a1)
{
  ...
  if ( *(_DWORD *)v4 > 4u && TlgKeywordOn((TraceLoggingHProvider)v3[1], 0x800uLL) )
  {
    ...
    v53 = 8LL;
    v55 = 1LL;
    TlgWrite(v4, &unk_1802DFE43, 0LL, 0LL, 0x11u, &pData);
  }
}
