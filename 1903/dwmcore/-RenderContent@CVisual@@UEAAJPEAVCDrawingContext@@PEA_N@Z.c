/*
 * XREFs of ?RenderContent@CVisual@@UEAAJPEAVCDrawingContext@@PEA_N@Z @ 0x18004F290
 * Callers:
...
LABEL_6:
  ...
  if ( v10 )
  {
    ...
    if ( dword_180340294 > *(_DWORD *)(v12 + 4) )
    {
      ...
      || !(*(unsigned __int8 (__fastcall **)(__int64, struct CDrawingContext *))(*(_QWORD *)v10 + 256LL))(v10, a2) )
    {
      ...
      if ( v13 < 0 )
      {
        MilInstrumentationCheckHR_MaybeFailFast(v14, &dword_18033ADF0, 2u, v13, 0x11A5u, 0LL);
      }
...
LABEL_27:
        ...
        MilInstrumentationCheckHR_MaybeFailFast(v22, &dword_18033ADF0, 2u, v21, 0x11A1u, 0LL);
LABEL_72:
        v43 = v60;
        if ( v60 )
        {
...
LABEL_70:
    MilInstrumentationCheckHR_MaybeFailFast((unsigned int)v18, &dword_18033ADF0, 2u, v17, 0x1199u, 0LL);
    goto LABEL_72;
  }
LABEL_18:
