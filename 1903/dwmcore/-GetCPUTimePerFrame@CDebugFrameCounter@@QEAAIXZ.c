/*
 * XREFs of ?GetCPUTimePerFrame@CDebugFrameCounter@@QEAAIXZ @ 0x1801936D8
 * Callers:
 ...
 * Callees:
 *     ?GetFrameCountInternal@CDebugFrameCounter@@IEAAIXZ @ 0x180193728 (-GetFrameCountInternal@CDebugFrameCounter@@IEAAIXZ.c)
 */
