/*
 * XREFs of ?Flatten@?$CBezierFlattener@MVCMilPoint2F@@@@QEAA_NPEAVCMilPoint2F@@0PEAMIPEAI_N@Z @ 0x18024BF24
 * Callers:
 ...
 * Callees:
 *     ?HalveTheStep@?$CBezierFlattener@MVCMilPoint2F@@@@IEAAXXZ @ 0x18024C0BC (-HalveTheStep@-$CBezierFlattener@MVCMilPoint2F@@@@IEAAXXZ.c)
 *     ?Step@?$CBezierFlattener@MVCMilPoint2F@@@@IEAAXXZ @ 0x18024C2E8 (-Step@-$CBezierFlattener@MVCMilPoint2F@@@@IEAAXXZ.c)
 *     ?TryDoubleTheStep@?$CBezierFlattener@MVCMilPoint2F@@@@IEAA_NXZ @ 0x18024C37C (-TryDoubleTheStep@-$CBezierFlattener@MVCMilPoint2F@@@@IEAA_NXZ.c)
 */
        ...
        _DWORD *a6)
{
  ...
  while ( *(_DWORD *)(a1 + 80) > v8 )
  {
    ...
    *(_QWORD *)(a2 + 8 * v11) = *(_QWORD *)(v10 + 48);
    ...
    if ( fmaxf(
           COERCE_DOUBLE(COERCE_UNSIGNED_INT64(*(float *)(v10 + 64)) & _xmm),
           COERCE_DOUBLE(COERCE_UNSIGNED_INT64(*(float *)(v10 + 68)) & _xmm)) <= *(float *)(v10 + 32)
      || *(float *)(v10 + 88) <= 0.001 )
    {
