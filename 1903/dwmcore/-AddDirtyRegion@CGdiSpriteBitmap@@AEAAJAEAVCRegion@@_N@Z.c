/*
 * XREFs of ?AddDirtyRegion@CGdiSpriteBitmap@@AEAAJAEAVCRegion@@_N@Z @ 0x18008D894
 * Callers:
 ...
 *     ?Offset@CRgnData@Internal@FastRegion@@QEAA_NHH@Z @ 0x180214890 (-Offset@CRgnData@Internal@FastRegion@@QEAA_NHH@Z.c)
 */
