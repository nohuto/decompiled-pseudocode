/*
 * XREFs of ??$RegisterNodeForVisit@VCSpriteVisualContent@@@CDebugTreeDumper@@QEAAXPEAVCSpriteVisualContent@@_N@Z @ 0x1801CADF4
 * Callers:
...
__int64 __fastcall CDebugTreeDumper::RegisterNodeForVisit<CSpriteVisualContent>(_QWORD *a1, __int64 a2)
{
  __int64 v2; // rdi
  __int64 result; // rax
  __int64 v5; // r8
  ...
  {
    v16 = 0LL;
    std::function_void___cdecl_void___CDebugTreeDumper____::operator___lambda_62e64e60f9736b2b6195c9f34efcaa56__void_((__int64)v15);
