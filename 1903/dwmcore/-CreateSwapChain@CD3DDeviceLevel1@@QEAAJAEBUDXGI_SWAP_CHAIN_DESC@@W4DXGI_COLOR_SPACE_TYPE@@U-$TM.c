/*
 * XREFs of ?CreateSwapChain@CD3DDeviceLevel1@@QEAAJAEBUDXGI_SWAP_CHAIN_DESC@@W4DXGI_COLOR_SPACE_TYPE@@U?$TMILFlagsEnum@W4FlagsEnum@MilRTInitialization@@@@PEBVCDisplay@@PEAPEAVCSwapChainBase@@@Z @ 0x1800E31CC
 * Callers:
  ...
  *(_QWORD *)a6 = 0LL;
  ...
  if ( (a4 & 0x4000) != 0 )
  {
    *(_QWORD *)v59 = 0LL;
    ...
    if ( DXGIOutput < 0 )
    {
      MilInstrumentationCheckHR_MaybeFailFast(v39, &dword_1802920EC, 1u, DXGIOutput, 0x698u, 0LL);
    }
    else
    {
      v40 = v60;
      ...
      if ( v42 < 0 )
      {
        MilInstrumentationCheckHR_MaybeFailFast(v43, &dword_1802920EC, 1u, v42, 0x69Au, 0LL);
      }
      else
      {
        v44 = *(_QWORD *)v59;
        ...
        if ( v46 < 0 )
        {
          MilInstrumentationCheckHR_MaybeFailFast(0LL, &dword_1802920EC, 1u, v46, 0x69Bu, 0LL);
        }
        else
        {
          v47 = v57;
          ...
          if ( v50 < 0 )
          {
            MilInstrumentationCheckHR_MaybeFailFast(v51, &dword_1802920EC, 1u, v50, 0x6A5u, 0LL);
          }
          else
          {
            ...
            v10 = v52;
            if ( v52 < 0 )
              MilInstrumentationCheckHR_MaybeFailFast(v53, &dword_1802920EC, 1u, v52, 0x6AFu, 0LL);
            else
              *(_QWORD *)a6 = v62;
          }
        }
...
LABEL_29:
    v30 = v11;
LABEL_61:
    MilInstrumentationCheckHR_MaybeFailFast((__int64)this, &dword_1802920EC, 1u, v30, v54, 0LL);
    goto LABEL_24;
  }
  v56 = 0LL;
  v57 = 0LL;
  do
  {
    ...
    if ( v14 < 0 )
    {
      MilInstrumentationCheckHR_MaybeFailFast(0LL, &dword_1802920EC, 1u, v14, 0x621u, 0LL);
      goto LABEL_47;
    }
    v15 = v61;
    v58 = 0LL;
    if ( (a4 & 0x2000) != 0 )
    {
      ...
      if ( v33 < 0 )
      {
        MilInstrumentationCheckHR_MaybeFailFast(v34, &dword_1802920EC, 1u, v33, 0x633u, 0LL);
        Microsoft::WRL::ComPtr<ID2DBitmap>::InternalRelease((__int64 *)&v58);
LABEL_47:
        Microsoft::WRL::ComPtr<ID2DBitmap>::InternalRelease(&v61);
        goto LABEL_23;
    ...
    else
    {
      ...
      if ( v17 < 0 )
      {
        MilInstrumentationCheckHR_MaybeFailFast(v18, &dword_1802920EC, 1u, v17, 0x63Eu, 0LL);
        Microsoft::WRL::ComPtr<ID2DBitmap>::InternalRelease((__int64 *)&v58);
        goto LABEL_47;
      }
      v19 = v58;
  ...
  MilInstrumentationCheckHR_MaybeFailFast(v21, &dword_1802920EC, 1u, v37, v55, 0LL);
LABEL_23:
  Microsoft::WRL::ComPtr<ID2DBitmap>::InternalRelease((__int64 *)&v57);
  Microsoft::WRL::ComPtr<ID2DBitmap>::InternalRelease((__int64 *)&v56);
LABEL_24:
