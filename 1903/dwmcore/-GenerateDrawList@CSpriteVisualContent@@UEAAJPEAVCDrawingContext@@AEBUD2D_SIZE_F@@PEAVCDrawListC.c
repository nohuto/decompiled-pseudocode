/*
 * XREFs of ?GenerateDrawList@CSpriteVisualContent@@UEAAJPEAVCDrawingContext@@AEBUD2D_SIZE_F@@PEAVCDrawListCache@@@Z @ 0x180075D50
 * Callers:
 *     <none>
 * Callees:
        ...
        struct CDrawListCache *a4)
{
  ...
  if ( dword_18034029C > *(_DWORD *)(*((_QWORD *)NtCurrentTeb()->ThreadLocalStoragePointer + (unsigned int)tls_index)
                                   + 4LL) )
  {
    Init_thread_header(&dword_18034029C);
    if ( dword_18034029C == -1 )
    {
      dword_18033ADFC = -2147022876;
      Init_thread_footer(&dword_18034029C);
    }
  }
  v8 = *this;
  v28 = &v27;
  ...
  *(_QWORD *)v29 = 0LL;
  ...
  if ( v11 < 0 )
  {
    MilInstrumentationCheckHR_MaybeFailFast(v10, &dword_18033ADF8, 2u, v11, 0xDEu, 0LL);
    goto LABEL_13;
  }
  v13 = this[8];
  if ( !v13 )
  {
    ...
    if ( v17 < 0 )
    {
      MilInstrumentationCheckHR_MaybeFailFast(v18, &dword_18033ADF8, 2u, v17, 0xE3u, 0LL);
    }
    else
    {
      v31[0] = v27;
      ...
      MilInstrumentationCheckHR_MaybeFailFast(v20, &dword_18033ADF8, 2u, DrawList, 0xE9u, 0LL);
      CDrawListEntryBuilder::~CDrawListEntryBuilder((CDrawListEntryBuilder *)v46);
    }
  ...
  if ( *((_BYTE *)a2 + 6351) )
  {
    ...
    v11 = v25;
    if ( v25 < 0 )
      MilInstrumentationCheckHR_MaybeFailFast(v26, &dword_18033ADF8, 2u, v25, 0xF4u, 0LL);
  }
LABEL_13:
  if ( v27 )
