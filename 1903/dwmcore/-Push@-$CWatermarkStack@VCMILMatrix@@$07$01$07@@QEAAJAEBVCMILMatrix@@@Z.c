/*
 * XREFs of ?Push@?$CWatermarkStack@VCMILMatrix@@$07$01$07@@QEAAJAEBVCMILMatrix@@@Z @ 0x180071F90
 * Callers:
...
__int64 __fastcall CWatermarkStack<CMILMatrix,8,2,8>::Push(unsigned int *a1, __int64 a2)
{
  ...
  {
    v10 = -2147024362;
    MilInstrumentationCheckHR_MaybeFailFast(v15, 0LL, 0, -2147024362, 0x55u, 0LL);
LABEL_14:
    v2 = v17;
    goto LABEL_5;
  }
