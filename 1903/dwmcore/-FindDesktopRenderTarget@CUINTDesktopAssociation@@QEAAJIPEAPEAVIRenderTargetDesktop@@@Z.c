/*
 * XREFs of ?FindDesktopRenderTarget@CUINTDesktopAssociation@@QEAAJIPEAPEAVIRenderTargetDesktop@@@Z @ 0x18018CDFC
 * Callers:
        ...
        struct IRenderTargetDesktop **a3)
{
  ...
  *a3 = 0LL;
  ...
  {
    v6 = -2003292412;
    MilInstrumentationCheckHR_MaybeFailFast(v7, &dword_1802E4664, 1u, 0x88982F04, 0x78u, 0LL);
  }
LABEL_8:
