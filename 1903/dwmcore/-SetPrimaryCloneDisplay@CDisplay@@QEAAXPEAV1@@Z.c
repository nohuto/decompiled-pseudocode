/*
 * XREFs of ?SetPrimaryCloneDisplay@CDisplay@@QEAAXPEAV1@@Z @ 0x1800A4D44
 * Callers:
...
void __fastcall CDisplay::SetPrimaryCloneDisplay(CDisplay *this, struct CDisplay *a2)
{
  ...
  *((_QWORD *)this + 19) = a2;
  if ( v2 )
  {
    DisplayId = CDisplay::GetDisplayId((__int64)this, &v10);
    v5(v6, (unsigned int)*DisplayId);
  }
  if ( *((_QWORD *)this + 10) )
  {
    v7 = CDisplay::GetDisplayId((__int64)this, &v10);
