/*
 * XREFs of _anonymous_namespace_::FrameSequenceInfo::operator_ @ 0x180072148
 * Callers:
 *     _anonymous_namespace_::SealCurrentFrameSequence @ 0x180075728 (_anonymous_namespace_--SealCurrentFrameSequence.c)
 * Callees:
 *     ?clear@?$_Tree@V?$_Tset_traits@_KU?$less@_K@std@@V?$allocator@_K@2@$0A@@std@@@std@@QEAAXXZ @ 0x1800725E0 (-clear@-$_Tree@V-$_Tset_traits@_KU-$less@_K@std@@V-$allocator@_K@2@$0A@@std@@@std@@QEAAXXZ.c)
 *     std::_Tree_std::_Tmap_traits__anonymous_namespace_::AnimationId_unsigned_int_A0x155a666c::AnimationId::LessThan_std::allocator_std::pair__anonymous_namespace_::AnimationId_const__unsigned_int____0___::clear @ 0x180072924 (std--_Tree_std--_Tmap_traits__anonymous_namespace_--AnimationId_unsigned_int_A0x155_ea_180072924.c)
 */
...
__int64 __fastcall anonymous_namespace_::FrameSequenceInfo::operator_(__int64 a1, __int64 a2)
{
  ...
  *(_DWORD *)(a1 + 404) = *(_DWORD *)(a2 + 404);
  if ( a1 + 408 != a2 + 408 )
  {
    std::_Tree<std::_Tset_traits<unsigned __int64,std::less<unsigned __int64>,std::allocator<unsigned __int64>,0>>::clear(a1 + 408);
    v6 = *v5;
    *v5 = *v4;
    *v4 = v6;
    v7 = v5[1];
  ...
  if ( a1 + 424 != a2 + 424 )
  {
    std::_Tree<std::_Tset_traits<unsigned __int64,std::less<unsigned __int64>,std::allocator<unsigned __int64>,0>>::clear(a1 + 424);
    v10 = *v9;
    *v9 = *v8;
    *v8 = v10;
    v11 = *(_QWORD *)(a1 + 432);
