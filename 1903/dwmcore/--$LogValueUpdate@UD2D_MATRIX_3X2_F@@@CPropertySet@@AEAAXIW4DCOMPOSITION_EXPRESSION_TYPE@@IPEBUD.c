/*
 * XREFs of ??$LogValueUpdate@UD2D_MATRIX_3X2_F@@@CPropertySet@@AEAAXIW4DCOMPOSITION_EXPRESSION_TYPE@@IPEBUD2D_MATRIX_3X2_F@@@Z @ 0x18001E13C
 * Callers:
      ...
      if ( v6 )
      {
        ...
        if ( v7 )
        {
              ...
              if ( v10 )
              {
                ...
                if ( v11 )
                {
                  ...
                  if ( (_DWORD)v12 )
                  {
                    ...
                    if ( dword_18033A240 > 5u )
                    {
                      if ( TlgKeywordOn((TraceLoggingHProvider)&dword_18033A240, 1uLL) )
                      {
                        ...
                        v84 = 4LL;
                        v86 = 4LL;
                        TlgWrite((TraceLoggingHProvider)&dword_18033A240, &unk_1802DD0F6, 0LL, 0LL, 0x16u, &pData);
                      }
                    }
                  }
                  else if ( dword_18033A240 > 5u && TlgKeywordOn((TraceLoggingHProvider)&dword_18033A240, 1uLL) )
                  {
                    ...
                    v64 = 4LL;
                    v66 = 4LL;
                    TlgWrite((TraceLoggingHProvider)&dword_18033A240, &unk_1802DD070, 0LL, 0LL, 0xCu, &pData);
                  }
                }
                else if ( dword_18033A240 > 5u && TlgKeywordOn((TraceLoggingHProvider)&dword_18033A240, 1uLL) )
                {
                  ...
                  v60 = 4LL;
                  v62 = 4LL;
                  TlgWrite((TraceLoggingHProvider)&dword_18033A240, &unk_1802DCFFC, 0LL, 0LL, 0xAu, &pData);
                }
              }
              else if ( dword_18033A240 > 5u && TlgKeywordOn((TraceLoggingHProvider)&dword_18033A240, 1uLL) )
              {
                ...
                v60 = 4LL;
                v62 = 4LL;
                TlgWrite((TraceLoggingHProvider)&dword_18033A240, &unk_1802DCF88, 0LL, 0LL, 0xAu, &pData);
              }
            }
            else if ( dword_18033A240 > 5u && TlgKeywordOn((TraceLoggingHProvider)&dword_18033A240, 1uLL) )
            {
          ...
          else if ( dword_18033A240 > 5u && TlgKeywordOn((TraceLoggingHProvider)&dword_18033A240, 1uLL) )
          {
            ...
            v58 = 4LL;
            v60 = 4LL;
            TlgWrite((TraceLoggingHProvider)&dword_18033A240, &unk_1802DD283, 0LL, 0LL, 9u, &pData);
          }
        }
        else if ( dword_18033A240 > 5u && TlgKeywordOn((TraceLoggingHProvider)&dword_18033A240, 1uLL) )
        {
          ...
          v56 = 4LL;
          v58 = 4LL;
          TlgWrite((TraceLoggingHProvider)&dword_18033A240, &unk_1802DD215, 0LL, 0LL, 8u, &pData);
        }
      }
      else if ( dword_18033A240 > 5u && TlgKeywordOn((TraceLoggingHProvider)&dword_18033A240, 1uLL) )
      {
        ...
        v54 = 4LL;
        v56 = 4LL;
        TlgWrite((TraceLoggingHProvider)&dword_18033A240, &unk_1802DD1AE, 0LL, 0LL, 7u, &pData);
      }
    }
    else if ( dword_18033A240 > 5u && TlgKeywordOn((TraceLoggingHProvider)&dword_18033A240, 1uLL) )
    {
