/*
 * XREFs of ?FindMatchingBitmap@CRenderTargetBitmapCache@@AEAAJIIAEBUPixelFormatInfo@@_N1PEAPEAVCScratchRenderTargetBitmap@@@Z @ 0x180047328
 * Callers:
 ...
 * Callees:
 *     ?IsValid@CHwTextureRenderTarget@@UEBA_NXZ @ 0x1800474A0 (-IsValid@CHwTextureRenderTarget@@UEBA_NXZ.c)
