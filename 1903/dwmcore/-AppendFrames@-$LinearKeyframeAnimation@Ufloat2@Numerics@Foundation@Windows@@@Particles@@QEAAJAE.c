/*
 * XREFs of ?AppendFrames@?$LinearKeyframeAnimation@Ufloat2@Numerics@Foundation@Windows@@@Particles@@QEAAJAEBV?$span@$$CBUParticleBindingData@@$0?0@gsl@@@Z @ 0x1801E9728
 * Callers:
 *     ?OnBindingChanged@CParticleVector2Behavior@@MEAAJAEAV?$span@$$CBUParticleBindingData@@$0?0@gsl@@_N@Z @ 0x1801EF170 (-OnBindingChanged@CParticleVector2Behavior@@MEAAJAEAV-$span@$$CBUParticleBindingData@@$0-0@gsl@@.c)
 * Callees:
