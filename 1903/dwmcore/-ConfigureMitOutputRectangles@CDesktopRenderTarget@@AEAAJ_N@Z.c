/*
 * XREFs of ?ConfigureMitOutputRectangles@CDesktopRenderTarget@@AEAAJ_N@Z @ 0x1800938B4
 * Callers:
...
__int64 __fastcall CDesktopRenderTarget::ConfigureMitOutputRectangles(CDesktopRenderTarget *this, char a2)
{
  ...
  enum DXGI_MODE_ROTATION v40; // [rsp+A8h] [rbp-19h]
  ...
  *(_OWORD *)lpMem_8 = 0LL;
  ...
  if ( *((_DWORD *)this + 50) )
  {
    ...
    while ( 1 )
    {
      ...
      v9 = *((_QWORD *)this + 22);
      v33 = 2;
      DisplayRect = (__int128 *)CHwndRenderTarget::GetDisplayRect(*(_QWORD *)(v9 + 8LL * v7));
      v11 = *((_QWORD *)this + 22);
      v32 = *DisplayRect;
      ...
      v15 = *((_QWORD *)this + 22);
      v40 = Rotation;
      ClipBox = (__int128 *)CHwndRenderTarget::GetClipBox(*(_QWORD *)(v15 + 8LL * v7));
      v17 = *((_QWORD *)this + 22);
      v42 = *ClipBox;
