/*
 * XREFs of ?GetOrCreateCompositionStatsForMonitor@CCompositionSwapchainStatistics@@AEAAAEAUCompositionStatsPerMonitor@1@PEAUHMONITOR__@@@Z @ 0x1802653A8
 * Callers:
 *     ?RecordCompositionMode@CCompositionSwapchainStatistics@@UEAA_NPEAUHMONITOR__@@W4BufferCompositionMode@@@Z @ 0x180265550 (-RecordCompositionMode@CCompositionSwapchainStatistics@@UEAA_NPEAUHMONITOR__@@W4BufferCompositio.c)
 *     ?RecordOutputColorSpace@CCompositionSwapchainStatistics@@UEAA_NPEAUHMONITOR__@@W4DXGI_COLOR_SPACE_TYPE@@@Z @ 0x180265590 (-RecordOutputColorSpace@CCompositionSwapchainStatistics@@UEAA_NPEAUHMONITOR__@@W4DXGI_COLOR_SPAC.c)
 *     ?RecordTransform@CCompositionSwapchainStatistics@@UEAA_NPEAUHMONITOR__@@AEBVCMILMatrix@@@Z @ 0x1802655C0 (-RecordTransform@CCompositionSwapchainStatistics@@UEAA_NPEAUHMONITOR__@@AEBVCMILMatrix@@@Z.c)
 * Callees:
