/*
 * XREFs of ?NotifyDirtySurface@CWindowNode@@QEAAJAEBVCRegion@@_N1@Z @ 0x18008E320
 * Callers:
...
LABEL_82:
            if ( v54 )
              CMergedRectBase<4>::SwapExisting((__int64)this + 560, 0, v54);
          }
LABEL_30:
          LODWORD(v8) = 0;
          v35 = (char *)this + 624;
