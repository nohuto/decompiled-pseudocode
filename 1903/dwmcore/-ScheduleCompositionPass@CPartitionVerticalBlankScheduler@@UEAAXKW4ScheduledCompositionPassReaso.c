/*
 * XREFs of ?ScheduleCompositionPass@CPartitionVerticalBlankScheduler@@UEAAXKW4ScheduledCompositionPassReason@@@Z @ 0x1800BA4C0
 * Callers:
...
LABEL_2:
  _m_prefetchw(&dword_180340100);
  result = (unsigned int)~_InterlockedOr(&dword_180340100, a3);
