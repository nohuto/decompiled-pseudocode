/*
 * XREFs of ?GetTopCpuClipInScope@CScopedClipStack@@QEAAJPEAPEBVCShape@@@Z @ 0x18006EF7C
 * Callers:
      ...
      if ( v12 < (unsigned int)v11 )
      {
        do
        {
          ...
          if ( !*v15 )
          {
            ...
            {
              v16 = CShapePtr::CopyShape((CShapePtr *)v14, (const struct CMILMatrix *)(v14 + 2), v15);
              v4 = v16;
              if ( v16 < 0 )
              {
