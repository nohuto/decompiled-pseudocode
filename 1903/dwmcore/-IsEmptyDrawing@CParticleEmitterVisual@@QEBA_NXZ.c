/*
 * XREFs of ?IsEmptyDrawing@CParticleEmitterVisual@@QEBA_NXZ @ 0x1801EA540
 * Callers:
 *     ?IsEmptyDrawing@CParticleEmitter@@UEBA_NXZ @ 0x1801EA530 (-IsEmptyDrawing@CParticleEmitter@@UEBA_NXZ.c)
