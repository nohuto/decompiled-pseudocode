/*
 * XREFs of _anonymous_namespace_::DecomposeMatrix @ 0x1802311BC
 * Callers:
 ...
 *     ?Set2DRotation@CMILMatrix@@QEAAXMMM@Z @ 0x18021CDEC (-Set2DRotation@CMILMatrix@@QEAAXMMM@Z.c)
 *     TransformPoint @ 0x180233628 (TransformPoint.c)
  ...
  *((_DWORD *)a6 + 16) = *(_DWORD *)(a3 + 64);
  ...
  if ( dword_18033A240 > 4u )
  {
    if ( TlgKeywordOn((TraceLoggingHProvider)&dword_18033A240, 2uLL) )
    {
      ...
      v146 = v22;
      v148 = v22;
      TlgWrite(v21, &unk_1802DEB1B, 0LL, 0LL, 0x25u, &pData);
    }
  }
}
