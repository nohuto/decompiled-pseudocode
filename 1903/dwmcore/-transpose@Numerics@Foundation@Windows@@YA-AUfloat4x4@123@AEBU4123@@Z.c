/*
 * XREFs of ?transpose@Numerics@Foundation@Windows@@YA?AUfloat4x4@123@AEBU4123@@Z @ 0x1801B8F90
 * Callers:
 ...
 *     ?GetTranspose@CMILMatrix@@QEBA?AV1@XZ @ 0x18021C954 (-GetTranspose@CMILMatrix@@QEBA-AV1@XZ.c)
 * Callees:
