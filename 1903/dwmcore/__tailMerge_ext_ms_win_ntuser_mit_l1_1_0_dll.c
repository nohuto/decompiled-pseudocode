/*
 * XREFs of __tailMerge_ext_ms_win_ntuser_mit_l1_1_0_dll @ 0x1800E948E
 * Callers:
 *     __imp_load_MITGetCursorUpdateHandle @ 0x1800E9482 (__imp_load_MITGetCursorUpdateHandle.c)
 * Callees:
