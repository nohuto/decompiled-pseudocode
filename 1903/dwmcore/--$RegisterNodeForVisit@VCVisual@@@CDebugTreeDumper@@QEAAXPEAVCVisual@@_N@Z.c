/*
 * XREFs of ??$RegisterNodeForVisit@VCVisual@@@CDebugTreeDumper@@QEAAXPEAVCVisual@@_N@Z @ 0x180174098
 * Callers:
...
__int64 __fastcall CDebugTreeDumper::RegisterNodeForVisit<CVisual>(__int64 a1, __int64 a2)
{
  __int64 v2; // rdi
  __int64 result; // rax
  __int64 v5; // r8
  __int64 v6; // rax
  _QWORD *v7; // rdx
  char v8; // [rsp+20h] [rbp-89h]
  char v9; // [rsp+30h] [rbp-79h]
  ...
  v2 = a2;
  v10 = a2;
  result = std::_Tree<std::_Tset_traits<__int64,std::less<__int64>,std::allocator<__int64>,0>>::count(a1 + 24, &v10);
  if ( !result )
  {
    v16 = 0LL;
    std::function_void___cdecl_void___CDebugTreeDumper____::operator___lambda_c03835fc5c7dc0aa41433fd397421b59__void_((__int64)v15);
    v8 = v9;
    ...
    else
    {
      *v7 = v2;
      v7[8] = 0LL;
      std::_Func_class<void,void *,CDebugTreeDumper *>::_Reset_move(v7 + 1, v13);
      *(_QWORD *)(a1 + 48) += 72LL;
    }
    std::_Func_class<void,void *,CDebugTreeDumper *>::_Tidy(v13);
    return std::_Func_class<void,void *,CDebugTreeDumper *>::_Tidy(v15);
  }
  return result;
}
