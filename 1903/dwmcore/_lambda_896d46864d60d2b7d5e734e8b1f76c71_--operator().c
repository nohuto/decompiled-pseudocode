/*
 * XREFs of _lambda_896d46864d60d2b7d5e734e8b1f76c71_::operator() @ 0x18008CCFC
 * Callers:
...
__int64 __fastcall lambda_896d46864d60d2b7d5e734e8b1f76c71_::operator()(__int64 a1, __int64 a2)
{
  ...
  __m128 v21; // [rsp+40h] [rbp-20h] BYREF
  ...
  *(unsigned __int64 *)((char *)v20.m128_u64 + 4) = __PAIR64__(LODWORD(v9), LODWORD(v8));
  ...
  if ( !v3 )
  {
    CMILMatrix::Transform2DBoundsHelper<0>(*(CMILMatrix **)(a1 + 8), (__int64)&v20, v21.m128_f32);
    v7 = v21.m128_f32[0];
    v8 = v21.m128_f32[1];
    v9 = v21.m128_f32[2];
    v10 = v21.m128_i32[3];
