/*
 * XREFs of ??_ECManipulationTelemetryData@@UEAAPEAXI@Z @ 0x1801D6C2C
 * Callers:
 *     ??_ECManipulationTelemetryData@@W7EAAPEAXI@Z @ 0x1800ED590 (--_ECManipulationTelemetryData@@W7EAAPEAXI@Z.c)
 * Callees:
