/*
 * XREFs of ?CopyPixelsToBitmap@CD3DSurface@@QEAAJAEBV?$TMilRect@IUMilRectU@@UNotNeeded@RectUniqueness@@@@IPEBV2@PEAVIBitmapDest@@HH@Z @ 0x1800B1818
 * Callers:
              ...
              if ( v31 >= 0 )
              {
                ...
                while ( 1 )
                {
                  ...
                  if ( bottom < v57.bottom )
                    v41 = bottom;
                  v57.bottom = v41;
                  if ( !TMilRect<unsigned int,MilRectU,RectUniqueness::NotNeeded>::IsEmpty(&v57) )
                  {
                    ...
                    {
                      v18 = -2147024362;
                      MilInstrumentationCheckHR_MaybeFailFast(v48, 0LL, 0, 0x80070216, 0x336u, 0LL);
                      goto LABEL_26;
                    }
                    if ( (int)v48 + (int)v47 < (unsigned int)v47 )
                    {
                      v18 = -2147024362;
                      MilInstrumentationCheckHR_MaybeFailFast(v48, 0LL, 0, 0x80070216, 0x338u, 0LL);
                      goto LABEL_26;
                    }
