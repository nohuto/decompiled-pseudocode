 ...
 *     ?_Lrotate@?$_Tree_val@U?$_Tree_simple_types@V?$basic_string@GU?$char_traits@G@std@@V?$allocator@G@2@@std@@@std@@@std@@QEAAXPEAU?$_Tree_node@V?$basic_string@GU?$char_traits@G@std@@V?$allocator@G@2@@std@@PEAX@2@@Z @ 0x180030758 (-_Lrotate@-$_Tree_val@U-$_Tree_simple_types@V-$basic_string@GU-$char_traits@G@std@@V-$allocator@.c)
  ...
  while ( *(_BYTE *)(v13 + 24) == v10 )
  {
    ...
    if ( v17 == *v18 )
    {
      ...
      if ( v14 == *(_QWORD *)(v17 + 16) )
        std::_Tree_val<std::_Tree_simple_types<std::wstring>>::_Lrotate(a1, *(_QWORD *)(v14 + 8));
      *(_BYTE *)(*(_QWORD *)(v14 + 8) + 24LL) = 1;
      *(_BYTE *)(*(_QWORD *)(*(_QWORD *)(v14 + 8) + 8LL) + 24LL) = v10;
      std::_Tree_val<std::_Tree_simple_types<std::wstring>>::_Rrotate(a1, *(_QWORD **)(*(_QWORD *)(v14 + 8) + 8LL));
    }
    else
    {
      if ( *(_BYTE *)(v19 + 24) == v10 )
...
LABEL_13:
      ...
      if ( v14 == *(_QWORD *)v17 )
        std::_Tree_val<std::_Tree_simple_types<std::wstring>>::_Rrotate(a1, *(_QWORD **)(v14 + 8));
      *(_BYTE *)(*(_QWORD *)(v14 + 8) + 24LL) = 1;
      *(_BYTE *)(*(_QWORD *)(*(_QWORD *)(v14 + 8) + 8LL) + 24LL) = v10;
      std::_Tree_val<std::_Tree_simple_types<std::wstring>>::_Lrotate(a1, *(_QWORD *)(*(_QWORD *)(v14 + 8) + 8LL));
    }
LABEL_14:
    v13 = *(_QWORD *)(v14 + 8);
  }
