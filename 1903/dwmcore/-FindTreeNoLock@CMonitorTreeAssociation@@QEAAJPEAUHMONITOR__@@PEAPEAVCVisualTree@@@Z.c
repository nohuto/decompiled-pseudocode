/*
 * XREFs of ?FindTreeNoLock@CMonitorTreeAssociation@@QEAAJPEAUHMONITOR__@@PEAPEAVCVisualTree@@@Z @ 0x180085FDC
 * Callers:
        ...
        struct CVisualTree **a3)
{
  ...
  *a3 = 0LL;
  ...
  {
    v5 = -2003292412;
    MilInstrumentationCheckHR_MaybeFailFast((unsigned int)this, &dword_1802C02F0, 1u, -2003292412, 0x90u, 0LL);
  }
  return v5;
}
