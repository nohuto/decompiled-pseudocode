/*
 * XREFs of ?SetNormalData@?$CSceneMeshGeneratedT@VCSceneMesh@@VCSceneObject@@@@QEAAJPEAVCSharedSectionWrapper@@@Z @ 0x1801A2124
 * Callers:
        ...
        struct CResource *a2)
{
  ...
  if ( a2 != this[13] )
  {
    ...
    if ( v5 < 0 )
    {
      MilInstrumentationCheckHR_MaybeFailFast(v6, 0LL, 0, v5, 0x278u, 0LL);
    }
    else
    {
