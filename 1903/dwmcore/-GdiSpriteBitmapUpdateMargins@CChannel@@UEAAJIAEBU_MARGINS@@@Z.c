/*
 * XREFs of ?GdiSpriteBitmapUpdateMargins@CChannel@@UEAAJIAEBU_MARGINS@@@Z @ 0x18003FB70
 * Callers:
 *     <none>
 * Callees:
...
LABEL_9:
  ...
  {
    v13 = CDataStreamWriter::EnsureItem(*((CDataStreamWriter **)this + 20), 0x18u);
    v15 = v13;
    if ( v13 >= 0 )
    {
    ...
    MilInstrumentationCheckHR_MaybeFailFast(v14, 0LL, 0, v13, 0x106u, 0LL);
  }
  else
  {
