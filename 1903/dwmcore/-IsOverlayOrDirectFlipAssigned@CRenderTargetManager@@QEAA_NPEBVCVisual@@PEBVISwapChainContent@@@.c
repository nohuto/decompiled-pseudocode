/*
 * XREFs of ?IsOverlayOrDirectFlipAssigned@CRenderTargetManager@@QEAA_NPEBVCVisual@@PEBVISwapChainContent@@@Z @ 0x18001756C
 * Callers:
 *     ?SuppressPrimayUpdatesForVisual@CCompositionSurfaceBitmap@@UEBA_NPEBVCVisual@@@Z @ 0x180019320 (-SuppressPrimayUpdatesForVisual@CCompositionSurfaceBitmap@@UEBA_NPEBVCVisual@@@Z.c)
 * Callees:
