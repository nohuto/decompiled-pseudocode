/*
 * XREFs of ??0CDrawingContext@@AEAA@PEAVCComposition@@@Z @ 0x180046878
 * Callers:
 ...
 *     ??0CContextState@@QEAA@XZ @ 0x180046CE0 (--0CContextState@@QEAA@XZ.c)
...
CDrawingContext *__fastcall CDrawingContext::CDrawingContext(CDrawingContext *this, struct CComposition *a2)
{
  ...
  *((_BYTE *)this + 6352) = __PAIR64__(
                              CCommonRegistryData::m_fDisableProjectedShadowsRendering,
                              CCommonRegistryData::m_fDisableProjectedShadows) == 0;
  return result;
}
