/*
 * XREFs of ?ImageLegacyMilBrushUpdate@CChannel@@UEAAJINAEBUMilRectF@@0IIIW4Enum@MilBrushMappingMode@@1IIW43MilStretch@@W43MilTileMode@@W43MilHorizontalAlignment@@W43MilVerticalAlignment@@I@Z @ 0x1800D0F80
 * Callers:
 *     <none>
 * Callees:
        ...
        unsigned int a17)
{
  ...
  CChannel::CheckHandle(v17, a2, 81);
  v19 = a6;
  CChannel::CheckOptionalHandle(v17, a6, 57LL);
  v20 = a7;
  CChannel::CheckOptionalHandle(v17, a7, 179LL);
  v21 = a8;
  CChannel::CheckOptionalHandle(v17, a8, 179LL);
  v22 = a11;
  CChannel::CheckOptionalHandle(v17, a11, 138LL);
  v23 = a12;
  CChannel::CheckOptionalHandle(v17, a12, 138LL);
  LODWORD(v17) = a17;
  CChannel::CheckOptionalHandle(a1, a17, 82LL);
  v29 = 561;
