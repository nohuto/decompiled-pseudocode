/*
 * XREFs of ?RemoveSourceEntry@DataProviderProxy@@QEAAJPEAVBamoDataSourceProxy@@@Z @ 0x180199648
 * Callers:
 *     ?OnDisconnected@DataSourceProxy@@MEAAJXZ @ 0x180198060 (-OnDisconnected@DataSourceProxy@@MEAAJXZ.c)
