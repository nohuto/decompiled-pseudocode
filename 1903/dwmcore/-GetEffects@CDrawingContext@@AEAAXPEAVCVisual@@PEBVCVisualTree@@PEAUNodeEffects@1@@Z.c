/*
 * XREFs of ?GetEffects@CDrawingContext@@AEAAXPEAVCVisual@@PEBVCVisualTree@@PEAUNodeEffects@1@@Z @ 0x18005FBE0
 * Callers:
  ...
  *((float *)a4 + 2) = v17;
  ...
  if ( v18 )
  {
    ...
    else
    {
      ...
      if ( v23 >= 0 )
        goto LABEL_24;
      MilInstrumentationCheckHR_MaybeFailFast((unsigned int)v24, 0LL, 0, v23, 0x63u, 0LL);
    }
    v24 = v50;
LABEL_24:
