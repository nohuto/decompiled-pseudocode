/*
 * XREFs of ?AlphaDivide_64bppABGRFloat@@YAXPEBUPipelineParams@@PEBUScanOpParams@@@Z @ 0x180225F50
 * Callers:
 *     <none>
 * Callees:
 *     ??BCFloat16@@QEAAMXZ @ 0x1802255D4 (--BCFloat16@@QEAAMXZ.c)
 */
...
void __fastcall AlphaDivide_64bppABGRFloat(const struct PipelineParams *a1, const struct ScanOpParams *a2)
{
  ...
  if ( *((_DWORD *)a1 + 2) )
  {
    ...
    do
    {
      ...
      if ( v3 != CFloat16::operator float((unsigned __int16 *)&word_18033BDA4) )
      {
        v5 = CFloat16::operator float(v2);
        if ( v5 != CFloat16::operator float(word_18034004C) )
        {
          ...
          v66 = CFloat16::operator float((unsigned __int16 *)&v65) * v22;
          v25 = fabs(v66);
          ...
          *v23 = v27;
          ...
          v66 = CFloat16::operator float((unsigned __int16 *)&v65) * v39;
          v42 = fabs(v66);
          ...
          *(_WORD *)(v40 + 2) = v44;
          ...
          v65 = CFloat16::operator float((unsigned __int16 *)&v65) * v56;
          v58 = fabs(v65);
