/*
 * XREFs of ?RecordWindowMoveOptimization@CDrawingContext@@QEAAJPEAVCWindowNode@@PEAUHWND__@@PEA_N@Z @ 0x18005164C
 * Callers:
...
LABEL_55:
  ...
  if ( v38[1] )
  {
    ...
    CScopedClipStack::GetClipBoundsWorld((char *)this + 1008, &v49);
