/*
 * XREFs of ??1CGlobalCompositionSurfaceInfo@@MEAA@XZ @ 0x18003A720
 * Callers:
...
void __fastcall CGlobalCompositionSurfaceInfo::~CGlobalCompositionSurfaceInfo(CGlobalCompositionSurfaceInfo *this)
{
  ...
  *((_QWORD *)this + 2) = &CGlobalCompositionSurfaceInfo::`vftable'{for `IDeviceResourceNotify'};
  ...
  if ( *((_QWORD *)this + 48) )
  {
    ...
    if ( dword_18033A1D0 > 5u && TlgKeywordOn((TraceLoggingHProvider)&dword_18033A1D0, 0x200000000000uLL) )
    {
      ...
      v22 = 8;
      v25 = 8;
      TlgWrite((TraceLoggingHProvider)&dword_18033A1D0, &unk_1802E0F16, 0LL, 0LL, 0xAu, &pData);
    }
