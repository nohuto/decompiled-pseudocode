/*
 * XREFs of ??$_Emplace_reallocate@AEAUD2D_POINT_2F@@@?$vector@UD2D_POINT_2F@@V?$allocator@UD2D_POINT_2F@@@std@@@std@@QEAAPEAUD2D_POINT_2F@@QEAU2@AEAU2@@Z @ 0x18024DB38
 * Callers:
...
__int64 __fastcall std::vector<D2D_POINT_2F>::_Emplace_reallocate<D2D_POINT_2F &>(__int64 a1, _BYTE *a2, _QWORD *a3)
{
  __int64 v4; // rsi
  __int64 v6; // rax
