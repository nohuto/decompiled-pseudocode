/*
 * XREFs of ??$UpdateProperty@_N@CPropertySet@@AEAAJIW4DCOMPOSITION_EXPRESSION_TYPE@@PEB_N@Z @ 0x1801F4804
 * Callers:
...
__int64 __fastcall CPropertySet::UpdateProperty<bool>(CResource *this, unsigned int a2, int a3, unsigned __int8 *a4)
{
  __int64 v4; // rax
  unsigned int v5; // ebx
  signed int v6; // eax
  ...
  {
    *(_BYTE *)((*(_DWORD *)(v4 + 8LL * a2 + 4) & 0x1FFFFFFF) + *((_QWORD *)this + 14)) = *a4;
