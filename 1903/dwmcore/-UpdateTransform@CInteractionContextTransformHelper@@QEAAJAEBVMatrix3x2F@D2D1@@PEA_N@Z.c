/*
 * XREFs of ?UpdateTransform@CInteractionContextTransformHelper@@QEAAJAEBVMatrix3x2F@D2D1@@PEA_N@Z @ 0x18025F680
 * Callers:
 ...
 *     GetInverse @ 0x18025EA78 (GetInverse.c)
 *     IsEqualMatrix @ 0x18025EC00 (IsEqualMatrix.c)
 */
