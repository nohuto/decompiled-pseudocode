/*
 * XREFs of McTemplateU0xqdddd @ 0x18015EDA4
 * Callers:
...
ULONG __fastcall McTemplateU0xqdddd(__int64 a1, __int64 a2, __int64 a3, __int64 a4, char a5, char a6, char a7, char a8)
{
