/*
 * XREFs of ?ProcessUpdate@CCompositionSurfaceBitmap@@UEAAJPEBVCResourceTable@@PEBUtagMILCMD_COMPOSITIONSURFACEBITMAP@@@Z @ 0x18002A360
 * Callers:
...
LABEL_7:
  ...
  TranslateDXGIorD3DErrorInContext(v4, 11LL, &v11);
  if ( (Microsoft_Windows_Dwm_CoreEnableBits & 0x20) != 0 )
