/*
 * XREFs of ?ProcessUpdateMargins@CGdiSpriteBitmap@@QEAAJPEBVCResourceTable@@PEBUtagMILCMD_GDISPRITEBITMAP_UPDATEMARGINS@@@Z @ 0x18002BD84
 * Callers:
        ...
        const struct tagMILCMD_GDISPRITEBITMAP_UPDATEMARGINS *a3)
{
  ...
  {
    v4 = -2147024809;
    MilInstrumentationCheckHR_MaybeFailFast((unsigned int)this, 0LL, 0, -2147024809, 0x166u, 0LL);
  }
