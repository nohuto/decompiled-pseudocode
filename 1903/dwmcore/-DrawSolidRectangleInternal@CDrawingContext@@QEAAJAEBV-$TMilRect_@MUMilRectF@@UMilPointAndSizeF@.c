/*
 * XREFs of ?DrawSolidRectangleInternal@CDrawingContext@@QEAAJAEBV?$TMilRect_@MUMilRectF@@UMilPointAndSizeF@@UNotNeeded@RectUniqueness@@@@AEBU_D3DCOLORVALUE@@@Z @ 0x18016EED0
 * Callers:
...
__int64 __fastcall CDrawingContext::DrawSolidRectangleInternal(CDrawingContext *a1, __int64 a2, __int128 *a3)
{
  ...
  *((_DWORD *)a1 + 64) = *((_DWORD *)a1 + 69);
  ...
  v7 = v5;
  if ( v5 < 0 )
    MilInstrumentationCheckHR_MaybeFailFast(v6, 0LL, 0, v5, 0x3DEu, 0LL);
  *((_DWORD *)a1 + 64) = v3;
  return v7;
}
