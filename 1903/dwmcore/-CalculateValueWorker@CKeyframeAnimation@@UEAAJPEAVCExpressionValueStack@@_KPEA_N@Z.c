/*
 * XREFs of ?CalculateValueWorker@CKeyframeAnimation@@UEAAJPEAVCExpressionValueStack@@_KPEA_N@Z @ 0x180081380
 * Callers:
...
LABEL_43:
        ...
        *((_QWORD *)this + 58) = v39;
        ...
        {
          LODWORD(v39) = *((unsigned __int8 *)this + 540);
          v40 = v39;
        ...
        if ( (v40 & 8) == 0 )
        {
          ...
          if ( *((_QWORD *)this + 44) )
          {
            ...
            if ( v53 < 0 )
            {
              MilInstrumentationCheckHR_MaybeFailFast(v39, 0LL, 0, v53, 0x8A5u, 0LL);
LABEL_48:
              if ( v9 < 0 )
              {
                MilInstrumentationCheckHR_MaybeFailFast(v39, 0LL, 0, v9, 0x5F0u, 0LL);
                goto LABEL_14;
              }
...
LABEL_126:
                ...
                v83 = 18;
                v84 = 0;
                v56 = DynArrayImpl<1>::AddMultiple((__int64)a2 + 24, 80, 5, v77);
                v9 = v56;
                if ( v56 < 0 )
                {
              ...
              MilInstrumentationCheckHR_MaybeFailFast(
                ...
                0x270u,
                0LL);
              MilInstrumentationCheckHR_MaybeFailFast(v60, 0LL, 0, v9, 0x5F9u, 0LL);
              goto LABEL_14;
            }
          }
          *((_BYTE *)this + 540) |= 8u;
...
LABEL_10:
    ...
    v87 = 18;
    v88 = 0;
    v64 = DynArrayImpl<1>::AddMultiple((__int64)a2 + 24, 80, 5, v77);
    v61 = v64;
    if ( v64 < 0 )
    {
  ...
  MilInstrumentationCheckHR_MaybeFailFast(
    ...
    0LL);
  v9 = v61;
  MilInstrumentationCheckHR_MaybeFailFast(v68, 0LL, 0, v61, 0x642u, 0LL);
  if ( v82 )
