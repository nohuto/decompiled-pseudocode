/*
 * XREFs of ?EmitGeometry@CWARPDrawListEntry@@UEBAJPEAVCD3DBatchExecutionContext@@PEBVCBaseDrawListEntry@@@Z @ 0x1801BAC40
 * Callers:
 *     <none>
 * Callees:
 ...
 *     ?BlendModeToWarpBlendMode@@YA?AW4Enum@WarpBlendMode2@@W41BlendMode@@@Z @ 0x1801BAB38 (-BlendModeToWarpBlendMode@@YA-AW4Enum@WarpBlendMode2@@W41BlendMode@@@Z.c)
 *     ?ExtendModeToWarpAddressMode@@YA?AW4Enum@WarpAddressMode@@AEBW4D2D1_EXTEND_MODE@@@Z @ 0x1801BB1A4 (-ExtendModeToWarpAddressMode@@YA-AW4Enum@WarpAddressMode@@AEBW4D2D1_EXTEND_MODE@@@Z.c)
 */
        ...
        const struct CBaseDrawListEntry *a3)
{
  ...
  __int32 v6; // xmm7_4
  __int32 v7; // xmm8_4
  struct CD3DBatchExecutionContext *v8; // rdi
  __int32 v9; // xmm9_4
  __m128 v10; // xmm10
  __m128 v11; // xmm11
  __int32 v12; // xmm0_4
  ...
  *(_QWORD *)&v59 = v61;
  ...
  if ( v44 < 0 )
    MilInstrumentationCheckHR_MaybeFailFast(v45, 0LL, 0, v44, 0x16Eu, 0LL);
  ++dword_18033C878;
  return 0LL;
}
