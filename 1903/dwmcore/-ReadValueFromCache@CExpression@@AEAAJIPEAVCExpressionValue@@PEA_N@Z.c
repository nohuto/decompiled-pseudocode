/*
 * XREFs of ?ReadValueFromCache@CExpression@@AEAAJIPEAVCExpressionValue@@PEA_N@Z @ 0x180084014
 * Callers:
    ...
    if ( v13 <= 52 )
    {
      ...
      if ( !v15 )
      {
        ...
        if ( v8 >= 0 )
        {
          ...
          *((_DWORD *)a3 + 18) = 11;
          *((_BYTE *)a3 + 76) = 1;
          Microsoft::WRL::ComPtr<CPathData>::operator=((char *)a3 + 64, v20);
LABEL_52:
          if ( *(int *)(*((_QWORD *)this + 38) + 4LL) < 0 )
            CExpression::LogCacheAccess(this, v19, a2, a3);
          v10 = 1;
          goto LABEL_3;
        }
        v25 = 1565;
      ...
      if ( !v18 )
      {
        ...
        v25 = 1509;
LABEL_57:
        MilInstrumentationCheckHR_MaybeFailFast(v9, 0LL, 0, v8, v25, 0LL);
        return v11;
      }
      if ( v18 == 7 )
      {
