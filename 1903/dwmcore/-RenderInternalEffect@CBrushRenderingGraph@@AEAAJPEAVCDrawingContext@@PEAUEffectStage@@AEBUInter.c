/*
 * XREFs of ?RenderInternalEffect@CBrushRenderingGraph@@AEAAJPEAVCDrawingContext@@PEAUEffectStage@@AEBUIntermediateConfigurationInputs@1@PEAUEffectInput@@@Z @ 0x1802062AC
 * Callers:
        ...
        struct EffectInput *a5)
{
  ...
  struct CRenderTargetImageSource *v40; // [rsp+58h] [rbp-B0h] BYREF
  ...
  *((float *)a5 + 19) = 0.0 - (float)((float)(1.0 / v10.m128_f32[0]) * 0.0);
  ...
  v24 = CDrawingContext::PushTransformInternal((CDrawingContext *)a2, 0LL, (const struct CMILMatrix *)&v58, 0, 1);
  v14 = v24;
  if ( v24 < 0 )
  {
  ...
  v28 = CDrawListCache::Render((__int64)v38, (CDrawingContext *)a2, (float *)&v58, 1.0);
  v14 = v28;
  if ( v28 < 0 )
  {
