/*
 * XREFs of ?WaitForVBlank@CHolographicManager@@QEAAJXZ @ 0x180242610
 * Callers:
 *     ?WaitForVBlank@CHolographicInteropTarget@@UEAAJPEAX@Z @ 0x180246320 (-WaitForVBlank@CHolographicInteropTarget@@UEAAJPEAX@Z.c)
 * Callees:
