/*
 * XREFs of ?IntersectsWithAntiOccluder@CArrayBasedCoverageSet@@AEBA_NAEBV?$TMilRect_@MUMilRectF@@UMilPointAndSizeF@@UNotNeeded@RectUniqueness@@@@HPEAH@Z @ 0x180053A40
 * Callers:
...
__int64 __fastcall CArrayBasedCoverageSet::IntersectsWithAntiOccluder(__int64 a1, __int64 a2, int a3, _DWORD *a4)
{
  ...
  *a4 = 0;
  ...
  do
  {
    ...
    if ( v8 > a3 )
      break;
    if ( (unsigned __int8)TMilRect<float,MilRectF,RectUniqueness::NotNeeded>::DoesIntersectUnsafe(v7 + 36 * v5, a2) )
    {
      v6 = 1;
      *v9 = v8;
    }
