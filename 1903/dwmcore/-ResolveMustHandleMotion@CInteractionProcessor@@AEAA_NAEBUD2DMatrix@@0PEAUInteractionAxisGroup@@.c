/*
 * XREFs of ?ResolveMustHandleMotion@CInteractionProcessor@@AEAA_NAEBUD2DMatrix@@0PEAUInteractionAxisGroup@@PEAUInteractionAxis@@PEAW4InteractionState@@@Z @ 0x180232800
 * Callers:
...
LABEL_16:
  if ( dword_18033A240 > 4u && TlgKeywordOn((TraceLoggingHProvider)&dword_18033A240, 2uLL) )
  {
    ...
    v79 = v18;
    v81 = v18;
    TlgWrite((TraceLoggingHProvider)&dword_18033A240, &unk_1802DE6FD, 0LL, 0LL, 0x17u, &pData);
  }
  return v9;
}
