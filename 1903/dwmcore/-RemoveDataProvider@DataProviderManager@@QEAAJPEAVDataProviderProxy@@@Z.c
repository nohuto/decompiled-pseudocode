/*
 * XREFs of ?RemoveDataProvider@DataProviderManager@@QEAAJPEAVDataProviderProxy@@@Z @ 0x180189900
 * Callers:
 ...
 *     ?OnDisconnected@DataProviderProxy@@MEAAJXZ @ 0x1801992E0 (-OnDisconnected@DataProviderProxy@@MEAAJXZ.c)
 * Callees:
