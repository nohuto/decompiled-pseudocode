/*
 * XREFs of ?Contains@CRegion@FastRegion@@QEBA_NAEBV12@@Z @ 0x18003CE5C
 * Callers:
 ...
 *     ?Contains@CRgnData@Internal@FastRegion@@QEBA_NAEBUtagRECT@@@Z @ 0x18003D318 (-Contains@CRgnData@Internal@FastRegion@@QEBA_NAEBUtagRECT@@@Z.c)
