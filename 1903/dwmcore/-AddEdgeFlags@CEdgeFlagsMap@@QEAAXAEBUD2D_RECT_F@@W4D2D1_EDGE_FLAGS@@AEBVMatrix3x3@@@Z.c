/*
 * XREFs of ?AddEdgeFlags@CEdgeFlagsMap@@QEAAXAEBUD2D_RECT_F@@W4D2D1_EDGE_FLAGS@@AEBVMatrix3x3@@@Z @ 0x1801BB4FC
 * Callers:
 ...
 *     ?Is2DAffine@Matrix3x3@@QEBA_NXZ @ 0x18021D8EC (-Is2DAffine@Matrix3x3@@QEBA_NXZ.c)
 */
