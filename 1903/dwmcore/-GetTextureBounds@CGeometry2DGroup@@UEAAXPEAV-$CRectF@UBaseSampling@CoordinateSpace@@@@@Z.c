/*
 * XREFs of ?GetTextureBounds@CGeometry2DGroup@@UEAAXPEAV?$CRectF@UBaseSampling@CoordinateSpace@@@@@Z @ 0x180212E80
 * Callers:
 *     <none>
 * Callees:
    ...
    if ( (v5 & 1) != 0 )
    {
      ...
      if ( *(_DWORD *)(a1 + 96) )
      {
        do
        {
          ...
          if ( v7 )
          {
            (*(void (__fastcall **)(__int64, float *))(*(_QWORD *)v7 + 216LL))(v7, v11);
