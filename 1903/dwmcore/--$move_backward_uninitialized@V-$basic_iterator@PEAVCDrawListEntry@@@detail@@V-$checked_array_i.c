/*
 * XREFs of ??$move_backward_uninitialized@V?$basic_iterator@PEAVCDrawListEntry@@@detail@@V?$checked_array_iterator@PEAPEAVCDrawListEntry@@@stdext@@@detail@@YAXV?$basic_iterator@PEAVCDrawListEntry@@@0@0V?$checked_array_iterator@PEAPEAVCDrawListEntry@@@stdext@@@Z @ 0x180182FA4
 * Callers:
  ...
  if ( *a2 != *(_QWORD *)a1 )
  {
    ...
    do
    {
      ...
      *a2 = (__int64)v6;
      ...
      {
        _o__invalid_parameter_noinfo_noreturn(a1, a2, a3, v4);
        JUMPOUT(0x180182FF2LL);
      }
      *(_QWORD *)(v5 + 8 * a1) = *v6;
      result = *a2;
    }
