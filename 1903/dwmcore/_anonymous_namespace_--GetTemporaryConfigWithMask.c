/*
 * XREFs of _anonymous_namespace_::GetTemporaryConfigWithMask @ 0x1800C4D44
 * Callers:
 ...
 *     ?SupportsInteractionType@CInteractionProcessor@@QEBAHW4InputType@@I_N@Z @ 0x1800C839C (-SupportsInteractionType@CInteractionProcessor@@QEBAHW4InputType@@I_N@Z.c)
 ...
 *     ?CanSkipChildren@CInteractionProcessor@@QEBAHXZ @ 0x1802300CC (-CanSkipChildren@CInteractionProcessor@@QEBAHXZ.c)
