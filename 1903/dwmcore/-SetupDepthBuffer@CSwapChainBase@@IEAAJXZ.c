/*
 * XREFs of ?SetupDepthBuffer@CSwapChainBase@@IEAAJXZ @ 0x1800E3A24
 * Callers:
...
__int64 __fastcall CSwapChainBase::SetupDepthBuffer(CSwapChainBase *this)
{
  ...
  v5 = (*(__int64 (__fastcall **)(CSwapChainBase *))(*(_QWORD *)this + 256LL))(this);
  ...
  v8 = v6;
  if ( v6 < 0 )
    MilInstrumentationCheckHR_MaybeFailFast(v7, &dword_1802B2900, 9u, v6, 0x183u, 0LL);
