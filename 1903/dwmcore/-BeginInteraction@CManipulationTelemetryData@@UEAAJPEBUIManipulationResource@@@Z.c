/*
 * XREFs of ?BeginInteraction@CManipulationTelemetryData@@UEAAJPEBUIManipulationResource@@@Z @ 0x180235A00
 * Callers:
 *     <none>
 * Callees:
    ...
    else
    {
      ...
      if ( is_mul_ok(v10, 2uLL) )
      {
        ...
        if ( dword_18033A240 > 5u && TlgKeywordOn((TraceLoggingHProvider)&dword_18033A240, 2uLL) )
        {
          ...
          v31 = 4LL;
          v33 = 4LL;
          TlgWrite((TraceLoggingHProvider)&dword_18033A240, &unk_1802DF646, 0LL, 0LL, v13 + 6, &pData);
        }
