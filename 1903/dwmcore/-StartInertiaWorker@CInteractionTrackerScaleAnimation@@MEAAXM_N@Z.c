/*
 * XREFs of ?StartInertiaWorker@CInteractionTrackerScaleAnimation@@MEAAXM_N@Z @ 0x1802097B0
 * Callers:
 *     <none>
 * Callees:
        ...
        bool a3)
{
  ...
  v8 = (CMotion *)(*(__int64 (__fastcall **)(CInteractionTrackerScaleAnimation *))(*(_QWORD *)this + 312LL))(this);
