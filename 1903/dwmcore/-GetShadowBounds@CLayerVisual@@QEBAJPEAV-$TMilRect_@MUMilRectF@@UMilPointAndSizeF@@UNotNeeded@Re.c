/*
 * XREFs of ?GetShadowBounds@CLayerVisual@@QEBAJPEAV?$TMilRect_@MUMilRectF@@UMilPointAndSizeF@@UNotNeeded@RectUniqueness@@@@@Z @ 0x180013190
 * Callers:
...
__int64 __fastcall CLayerVisual::GetShadowBounds(CVisual *a1, struct D2D_RECT_F *a2)
{
  ...
  *a2 = (struct D2D_RECT_F)TMilRect<float,MilRectF,RectUniqueness::NotNeeded>::sc_rcEmpty;
  ...
  if ( MaskBounds < 0 )
  {
    MilInstrumentationCheckHR_MaybeFailFast(v8, 0LL, 0, MaskBounds, 0x1E9u, 0LL);
  }
  else
  {
    v10 = *((_QWORD *)a1 + 70);
    v11 = *(float *)(v10 + 96);
    *(_QWORD *)v12 = *(_QWORD *)(v10 + 104);
    if ( !IsEmpty(&v13) )
    {
