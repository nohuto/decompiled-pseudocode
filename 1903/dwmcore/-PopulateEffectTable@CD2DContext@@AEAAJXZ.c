/*
 * XREFs of ?PopulateEffectTable@CD2DContext@@AEAAJXZ @ 0x180026534
 * Callers:
...
LABEL_3:
  ...
  MilInstrumentationCheckHR_MaybeFailFast(v8, 0LL, 0, v7, 0x8C9u, 0LL);
LABEL_4:
  if ( v1 < 0 )
