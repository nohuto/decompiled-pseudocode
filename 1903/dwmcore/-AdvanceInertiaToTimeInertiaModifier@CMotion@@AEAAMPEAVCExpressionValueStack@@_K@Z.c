/*
 * XREFs of ?AdvanceInertiaToTimeInertiaModifier@CMotion@@AEAAMPEAVCExpressionValueStack@@_K@Z @ 0x18020FAE0
 * Callers:
        ...
        __int64 a3)
{
  ...
  if ( dword_18033A240 > 4u )
  {
    if ( TlgKeywordOn((TraceLoggingHProvider)&dword_18033A240, 2uLL) )
    {
      ...
      v34 = v15;
      v35 = 4;
      TlgWrite((TraceLoggingHProvider)&dword_18033A240, &unk_1802DD691, 0LL, 0LL, 8u, &pData);
      return v16;
    }
  }
  return result;
