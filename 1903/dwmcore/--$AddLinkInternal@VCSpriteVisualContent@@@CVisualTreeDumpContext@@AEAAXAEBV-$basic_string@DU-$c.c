/*
 * XREFs of ??$AddLinkInternal@VCSpriteVisualContent@@@CVisualTreeDumpContext@@AEAAXAEBV?$basic_string@DU?$char_traits@D@std@@V?$allocator@D@2@@std@@PEAVCSpriteVisualContent@@_N@Z @ 0x1801CACE8
 * Callers:
...
void __fastcall CVisualTreeDumpContext::AddLinkInternal<CSpriteVisualContent>(__int64 *a1, __int64 a2, __int64 a3)
{
  ...
  if ( a3 )
    CDebugTreeDumper::RegisterNodeForVisit<CSpriteVisualContent>(a1[14], a3);
}
