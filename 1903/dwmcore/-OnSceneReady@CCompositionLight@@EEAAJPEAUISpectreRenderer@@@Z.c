/*
 * XREFs of ?OnSceneReady@CCompositionLight@@EEAAJPEAUISpectreRenderer@@@Z @ 0x1801C7980
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall CCompositionLight::OnSceneReady(CCompositionLight *this, struct ISpectreRenderer *a2)
{
  ...
  v5 = (*(__int64 (__fastcall **)(char *))(*((_QWORD *)this - 9) + 224LL))((char *)this - 72);
  v6 = v4(a2, v5, (char *)this + 96);
  v8 = v6;
  if ( v6 < 0 )
    MilInstrumentationCheckHR_MaybeFailFast(v7, 0LL, 0, v6, 0x23Bu, 0LL);
  return v8;
}
