/*
 * XREFs of ?_Reallocate_exactly@?$vector@V?$ComPtr@VCPathData@@@WRL@Microsoft@@V?$allocator@V?$ComPtr@VCPathData@@@WRL@Microsoft@@@std@@@std@@AEAAX_K@Z @ 0x1801E1E58
 * Callers:
...
__int64 __fastcall std::vector<Microsoft::WRL::ComPtr<CPathData>>::_Reallocate_exactly(_QWORD *a1, unsigned __int64 a2)
{
  ...
  return std::vector<Microsoft::WRL::ComPtr<CPathData>>::_Change_array((__int64)a1, v6, v4, a2);
}
