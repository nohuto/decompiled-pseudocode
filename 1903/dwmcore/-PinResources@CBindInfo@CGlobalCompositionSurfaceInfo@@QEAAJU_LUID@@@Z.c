/*
 * XREFs of ?PinResources@CBindInfo@CGlobalCompositionSurfaceInfo@@QEAAJU_LUID@@@Z @ 0x18025D740
 * Callers:
 *     ?PinResources@CGlobalCompositionSurfaceInfo@@UEAAJU_LUID@@@Z @ 0x18025DA00 (-PinResources@CGlobalCompositionSurfaceInfo@@UEAAJU_LUID@@@Z.c)
 * Callees:
    ...
    if ( v6 )
    {
      *((_DWORD *)v3 + 56) = 0;
      ...
      if ( *((_DWORD *)v3 + 56) )
      {
        ...
        if ( D3DDevice < 0 )
        {
          MilInstrumentationCheckHR_MaybeFailFast(v12, &dword_180314528, 2u, D3DDevice, 0x4F1u, 0LL);
          v5 = v18;
          goto LABEL_24;
        }
        v5 = v18;
...
LABEL_18:
      ...
      v4 = -2147467259;
      MilInstrumentationCheckHR_MaybeFailFast((__int64)this, &dword_180314528, 2u, 0x80004005, 0x4EBu, 0LL);
    }
    else
    {
      v4 = -2147024882;
      MilInstrumentationCheckHR_MaybeFailFast(v7, &dword_180314528, 2u, 0x8007000E, 0x4CDu, 0LL);
    }
  }
  else
  {
    ...
    v17 = 1281;
LABEL_23:
    MilInstrumentationCheckHR_MaybeFailFast((__int64)this, &dword_180314528, 2u, v13, v17, 0LL);
LABEL_24:
    if ( v4 >= 0 )
      goto LABEL_31;
  }
