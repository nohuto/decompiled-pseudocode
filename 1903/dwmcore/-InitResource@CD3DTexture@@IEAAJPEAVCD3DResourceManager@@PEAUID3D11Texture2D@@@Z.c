/*
 * XREFs of ?InitResource@CD3DTexture@@IEAAJPEAVCD3DResourceManager@@PEAUID3D11Texture2D@@@Z @ 0x1800B28FC
 * Callers:
        ...
        struct ID3D11Texture2D *a3)
{
  ...
  if ( *((_DWORD *)this + 46) )
  {
    ...
    v3 = -2003292288;
    MilInstrumentationCheckHR_MaybeFailFast(v9, 0LL, 0, 0x88982F80, 0xA4u, 0LL);
  }
  else
  {
LABEL_4:
