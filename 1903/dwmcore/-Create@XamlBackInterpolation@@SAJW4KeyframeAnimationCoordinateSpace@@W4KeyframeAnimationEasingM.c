/*
 * XREFs of ?Create@XamlBackInterpolation@@SAJW4KeyframeAnimationCoordinateSpace@@W4KeyframeAnimationEasingMode@@MPEAPEAVKeyframeInterpolation@@@Z @ 0x180209D64
 * Callers:
...
__int64 __fastcall XamlBackInterpolation::Create(int a1, unsigned int a2, float a3, _QWORD *a4)
{
  float v4; // xmm6_4
  _DWORD *v8; // rax
  _DWORD *v9; // rbx
  ...
  if ( v8 )
  {
    ...
    v9[2] = 0;
    *(_QWORD *)v9 = &XamlBackInterpolation::`vftable';
  }
  else
  {
    v9 = 0LL;
