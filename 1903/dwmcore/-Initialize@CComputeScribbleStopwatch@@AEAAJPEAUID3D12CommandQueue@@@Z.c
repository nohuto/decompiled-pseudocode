/*
 * XREFs of ?Initialize@CComputeScribbleStopwatch@@AEAAJPEAUID3D12CommandQueue@@@Z @ 0x1801BD8C0
 * Callers:
        ...
        struct ID3D12CommandQueue *a2)
{
  ...
  wil::com_ptr_t<ID3D12Fence,wil::err_returncode_policy>::reset((__int64 *)&v18);
