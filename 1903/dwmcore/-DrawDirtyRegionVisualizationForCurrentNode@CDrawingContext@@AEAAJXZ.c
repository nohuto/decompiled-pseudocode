/*
 * XREFs of ?DrawDirtyRegionVisualizationForCurrentNode@CDrawingContext@@AEAAJXZ @ 0x18016D1D4
 * Callers:
 ...
 *     ?CurrentRedrawRegionColor@CComposition@@QEAA?AU_D3DCOLORVALUE@@XZ @ 0x180177278 (-CurrentRedrawRegionColor@CComposition@@QEAA-AU_D3DCOLORVALUE@@XZ.c)
...
__int64 __fastcall CDrawingContext::DrawDirtyRegionVisualizationForCurrentNode(CComposition **this)
{
  ...
  __m128 v35[4]; // [rsp+88h] [rbp-80h] BYREF
  int v36; // [rsp+C8h] [rbp-40h]
  __m128 v37; // [rsp+D8h] [rbp-30h] BYREF
  ...
  *(_OWORD *)&v30[1] = 0LL;
  ...
  v36 = 0;
  CMILMatrix::SetToInverse(v35, (const struct CMILMatrix *)(this + 758));
