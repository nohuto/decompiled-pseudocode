/*
 * XREFs of ?CheckOcclusionState@CHwndRenderTarget@@UEAAJXZ @ 0x1800BAA00
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall CHwndRenderTarget::CheckOcclusionState(CHwndRenderTarget *this)
{
  ...
  if ( v3 < 0 )
  {
    MilInstrumentationCheckHR_MaybeFailFast(v5, &dword_1802C0180, 2u, v3, 0x6F1u, 0LL);
  }
         ...
         && (*((_BYTE *)this + 795) || *((_QWORD *)this + 58) != *(_QWORD *)(*((_QWORD *)this - 6) + 384LL) - 1LL) )
  {
    ...
    v6 = v8;
    if ( v8 < 0 )
      MilInstrumentationCheckHR_MaybeFailFast(v9, &dword_1802C0180, 2u, v8, 0x6FEu, 0LL);
    if ( *((_BYTE *)this + 795) )
    {
    ...
    if ( v6 >= 0 )
      goto LABEL_6;
    MilInstrumentationCheckHR_MaybeFailFast(v9, &dword_1802C0180, 2u, v6, 0x700u, 0LL);
  }
  if ( v6 < 0 )
  {
