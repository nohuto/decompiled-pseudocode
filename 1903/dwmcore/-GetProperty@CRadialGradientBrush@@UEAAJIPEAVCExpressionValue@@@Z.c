/*
 * XREFs of ?GetProperty@CRadialGradientBrush@@UEAAJIPEAVCExpressionValue@@@Z @ 0x1801F5E00
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall CRadialGradientBrush::GetProperty(CRadialGradientBrush *this, int a2, struct CExpressionValue *a3)
{
  ...
  {
    v4 = -2147024809;
    MilInstrumentationCheckHR_MaybeFailFast(v6, 0LL, v7, 0x80070057, 0x21u, (void *)(v7 & v10));
  }
  return v4;
}
