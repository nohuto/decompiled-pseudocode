/*
 * XREFs of VertexTransfer::Transfer_VertexTransfer::CGeneral3DOperator_Vertex_UVxN_VertexXYW_ColorDW____2_Vertex_UVxN_VertexXYW_ColorDW___ @ 0x1801B32A0
 * Callers:
 ...
 *     ?ComputeAdjointIgnoreZ@CMILMatrix@@SA?AV1@AEBV1@@Z @ 0x180017C58 (-ComputeAdjointIgnoreZ@CMILMatrix@@SA-AV1@AEBV1@@Z.c)
 */
        ...
        float *a2)
{
  ...
  __int64 v12; // rbx
  __int64 v13; // rdi
  _OWORD v14[4]; // [rsp+30h] [rbp-D8h] BYREF
  ...
  for ( i = result;
        v6 < v5;
        *(_DWORD *)(v13 + 12) = result | (((int)(float)(unsigned __int8)BYTE1(*(_DWORD *)(v12 + 12)) | (((int)(float)(unsigned __int8)BYTE2(*(_DWORD *)(v12 + 12)) | ((int)(float)((float)HIBYTE(*(_DWORD *)(v12 + 12)) * v7) << 8)) << 8)) << 8) )
  {
    ...
    VertexTransfer::CGeneral3DOperator<Vertex_UVxN<VertexXYW_ColorDW>>::Transform(
      ...
      *(_DWORD *)(a1 + 40),
      ...
      (char *)v13);
    ++v6;
    result = (unsigned int)(int)(float)(unsigned __int8)*(_DWORD *)(v12 + 12);
  }
  return result;
}
