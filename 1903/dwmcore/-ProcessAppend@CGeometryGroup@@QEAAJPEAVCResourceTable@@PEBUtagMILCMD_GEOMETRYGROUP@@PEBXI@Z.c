/*
 * XREFs of ?ProcessAppend@CGeometryGroup@@QEAAJPEAVCResourceTable@@PEBUtagMILCMD_GEOMETRYGROUP@@PEBXI@Z @ 0x180211244
 * Callers:
        ...
        unsigned int a5)
{
  ...
  v8 = 0;
  v26 = 0LL;
  v9 = CResource::UnmarshalResourceArray(a4, a5, v5, 0x3Eu, (unsigned int *)&v25, &Src, (__int64)a2, 0);
  v11 = Src;
  v12 = v9;
  v13 = (unsigned int)v25;
  if ( v9 < 0 )
  {
    MilInstrumentationCheckHR_MaybeFailFast(v10, 0LL, 0, v9, 0x28Cu, 0LL);
  }
  else if ( (_DWORD)v25 )
  {
    v14 = *((_DWORD *)this + 40);
    ...
    {
      v12 = -2147024362;
      MilInstrumentationCheckHR_MaybeFailFast(v10, 0LL, 0, 0x80070216, 0x292u, 0LL);
      goto LABEL_18;
    }
    ...
    if ( v16 < 0 )
    {
      MilInstrumentationCheckHR_MaybeFailFast(v17, 0LL, 0, v16, 0x295u, 0LL);
    }
    else
    {
      v8 = 1;
      ...
      if ( v18 < 0 )
      {
        MilInstrumentationCheckHR_MaybeFailFast(v19, 0LL, 0, v18, 0x29Bu, 0LL);
        v6 = v26;
      }
      else
      {
