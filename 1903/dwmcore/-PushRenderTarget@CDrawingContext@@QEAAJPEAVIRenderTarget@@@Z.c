/*
 * XREFs of ?PushRenderTarget@CDrawingContext@@QEAAJPEAVIRenderTarget@@@Z @ 0x18004BBA0
 * Callers:
...
LABEL_16:
    ...
    *v2 = a2;
    ...
    (**(void (__fastcall ***)(_QWORD, GUID *, char *))*v2)(
      *v2,
      ...
      (char *)this + 368);
    v16 = (*(__int64 (__fastcall **)(_QWORD, __int64 *))(*(_QWORD *)*v2 + 40LL))(*v2, &v29);
    v7 = v16;
    if ( v16 < 0 )
    {
    ...
    else
    {
      ...
      {
        v20 = (*(__int64 (__fastcall **)(_QWORD, char *, _QWORD))(**((_QWORD **)this + 48) + 24LL))(
                *((_QWORD *)this + 48),
                (char *)this + 8,
                *v2);
        v7 = v20;
  ...
  if ( *v2 )
  {
    (**(void (__fastcall ***)(_QWORD, GUID *, __int64 *))*v2)(*v2, &GUID_d96ea0e9_6207_4781_b3d6_49c499730deb, v14);
    (*(void (__fastcall **)(_QWORD, char *))(*(_QWORD *)*v2 + 40LL))(*v2, (char *)this + 384);
