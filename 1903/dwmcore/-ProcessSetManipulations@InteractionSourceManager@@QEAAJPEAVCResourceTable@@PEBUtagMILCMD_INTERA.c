/*
 * XREFs of ?ProcessSetManipulations@InteractionSourceManager@@QEAAJPEAVCResourceTable@@PEBUtagMILCMD_INTERACTIONTRACKER_SETMANIPULATIONS@@PEBUMarshaledManipulationInfo@@@Z @ 0x18021F4B8
 * Callers:
 *     ?ProcessSetManipulations@CInteractionTracker@@QEAAJPEAVCResourceTable@@PEBUtagMILCMD_INTERACTIONTRACKER_SETMANIPULATIONS@@PEBXI@Z @ 0x1801DB79C (-ProcessSetManipulations@CInteractionTracker@@QEAAJPEAVCResourceTable@@PEBUtagMILCMD_INTERACTION.c)
 * Callees:
 ...
 *     ??$emplace@AEAV?$com_ptr_t@VCManipulation@@Uerr_returncode_policy@wil@@@wil@@V?$unique_ptr@VCChainingHelper@@U?$default_delete@VCChainingHelper@@@std@@@std@@@?$_Hash@V?$_Umap_traits@V?$com_ptr_t@VCManipulation@@Uerr_returncode_policy@wil@@@wil@@V?$unique_ptr@VCChainingHelper@@U?$default_delete@VCChainingHelper@@@std@@@std@@V?$_Uhash_compare@V?$com_ptr_t@VCManipulation@@Uerr_returncode_policy@wil@@@wil@@U?$hash@V?$com_ptr_t@VCManipulation@@Uerr_returncode_policy@wil@@@wil@@@std@@U?$equal_to@V?$com_ptr_t@VCManipulation@@Uerr_returncode_policy@wil@@@wil@@@4@@4@V?$allocator@U?$pair@$$CBV?$com_ptr_t@VCManipulation@@Uerr_returncode_policy@wil@@@wil@@V?$unique_ptr@VCChainingHelper@@U?$default_delete@VCChainingHelper@@@std@@@std@@@std@@@4@$0A@@std@@@std@@QEAA?AU?$pair@V?$_List_iterator@V?$_List_val@U?$_List_simple_types@U?$pair@$$CBV?$com_ptr_t@VCManipulation@@Uerr_returncode_policy@wil@@@wil@@V?$unique_ptr@VCChainingHelper@@U?$default_delete@VCChainingHelper@@@std@@@std@@@std@@@std@@@std@@@std@@_N@1@AEAV?$com_ptr_t@VCManipulation@@Uerr_returncode_policy@wil@@@wil@@$$QEAV?$unique_ptr@VCChainingHelper@@U?$default_delete@VCChainingHelper@@@std@@@1@@Z @ 0x18021E2B0 (--$emplace@AEAV-$com_ptr_t@VCManipulation@@Uerr_returncode_policy@wil@@@wil@@V-$unique_ptr@VCCha.c)
 ...
 *     ?IsManipulationActive@InteractionSourceManager@@AEAA_NPEBVCManipulation@@@Z @ 0x18021EF8C (-IsManipulationActive@InteractionSourceManager@@AEAA_NPEBVCManipulation@@@Z.c)
        ...
        const struct MarshaledManipulationInfo *a4)
{
  ...
  __int64 v25; // rcx
  __int64 v27; // rdx
  struct CManipulation *v28; // [rsp+28h] [rbp-49h] BYREF
  struct CManipulation *v29; // [rsp+30h] [rbp-41h] BYREF
  _QWORD *v30; // [rsp+38h] [rbp-39h] BYREF
  _BYTE *v31; // [rsp+40h] [rbp-31h]
  _BYTE *v32; // [rsp+48h] [rbp-29h]
  __int64 v33; // [rsp+50h] [rbp-21h] BYREF
  CResource *v34; // [rsp+58h] [rbp-19h]
  __int64 v35; // [rsp+60h] [rbp-11h] BYREF
  __int64 v36; // [rsp+68h] [rbp-9h] BYREF
  char v37[88]; // [rsp+70h] [rbp-1h] BYREF
  wil::details::in1diag3 *retaddr; // [rsp+D0h] [rbp+5Fh]
  int v39; // [rsp+D8h] [rbp+67h]
  const struct MarshaledManipulationInfo *v42; // [rsp+F0h] [rbp+7Fh]
  ...
  if ( *((_DWORD *)a3 + 2) )
  {
    while ( 1 )
    {
      ResourceWithoutType = CResourceTable::GetResourceWithoutType(v8, *v7);
      v12 = v7[1];
      ...
      if ( v12 )
        ...
        v14 = 0LL;
      if ( !v13
        || !(*(unsigned __int8 (__fastcall **)(__int64, __int64))(*(_QWORD *)v13 + 48LL))(v13, 100LL)
        || v14 && !(*(unsigned __int8 (__fastcall **)(struct CResource *, __int64))(*(_QWORD *)v14 + 48LL))(v14, 87LL) )
      {
        v23 = -2003303421;
      ...
      if ( v5 == v6 )
      {
        std::vector<ID3D11SamplerState *>::_Emplace_reallocate<ID3D11SamplerState * const &>((__int64)&v30, v6, &v29);
        v5 = v32;
        v6 = v31;
      }
      else
...
LABEL_23:
      ...
      v7 = (unsigned int *)((char *)v42 + 8);
      v42 = (const struct MarshaledManipulationInfo *)((char *)v42 + 8);
      ...
      v8 = a2;
      if ( (unsigned int)++v39 >= *((_DWORD *)a3 + 2) )
        goto LABEL_28;
    }
    ...
    v22 = CResource::RegisterNotifier(v34, v15);
    v23 = v22;
    if ( v22 < 0 )
    {
      v27 = 94LL;
...
LABEL_28:
  InteractionSourceManager::CleanupManipulationMap(this, &v30);
  if ( !*((_DWORD *)v34 + 42) )
...
LABEL_31:
  if ( v30 )
    std::_Deallocate<16,0>(v30, (v5 - (_BYTE *)v30) & 0xFFFFFFFFFFFFFFF8uLL);
  return v23;
}
