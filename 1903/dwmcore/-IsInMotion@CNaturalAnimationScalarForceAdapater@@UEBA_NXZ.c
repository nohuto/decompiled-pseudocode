/*
 * XREFs of ?IsInMotion@CNaturalAnimationScalarForceAdapater@@UEBA_NXZ @ 0x180221AE0
 * Callers:
 *     <none>
 * Callees:
 ...
 *     ?IsInMotion@CScalarForceEvaluator@@QEBA_NXZ @ 0x180221278 (-IsInMotion@CScalarForceEvaluator@@QEBA_NXZ.c)
