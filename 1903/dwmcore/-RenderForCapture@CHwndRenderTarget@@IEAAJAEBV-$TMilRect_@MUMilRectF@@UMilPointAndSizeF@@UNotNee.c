/*
 * XREFs of ?RenderForCapture@CHwndRenderTarget@@IEAAJAEBV?$TMilRect_@MUMilRectF@@UMilPointAndSizeF@@UNotNeeded@RectUniqueness@@@@@Z @ 0x1800B44D0
 * Callers:
...
__int64 __fastcall CHwndRenderTarget::RenderForCapture(__int64 a1, __int128 *a2)
{
  ...
  v3 = 0;
  DrawingContext = CRenderTarget::GetDrawingContext((CRenderTarget *)a1, (bool)a2);
  v6 = *(_QWORD *)(a1 + 120);
  v7 = DrawingContext;
  if ( !v6 )
    return v3;
...
LABEL_23:
  ...
  *(_BYTE *)(*(_QWORD *)(a1 + 16) + 1273LL) = 1;
  ...
  else
  {
    ...
    v12 = CDrawingContext::DrawVisualTree(v7, *(float **)(a1 + 120), a2, 0LL, 0x7FFFFFFF, 1, 0, 1, 0LL, 1, 0);
    v3 = v12;
    if ( v12 < 0 )
    {
