/*
 * XREFs of ?Initialize@CPartitionVerticalBlankScheduler@@AEAAJXZ @ 0x1800DE7B0
 * Callers:
...
__int64 __fastcall CPartitionVerticalBlankScheduler::Initialize(CPartitionVerticalBlankScheduler *this)
{
  ...
  *((_QWORD *)this + 3) = WaitableTimerW;
      ...
      else
      {
        ...
        *((_BYTE *)this + 26236) = 1;
        v3 = CGlobalComposition::Create(
               ...
               this,
               v6,
               (CPartitionVerticalBlankScheduler *)((char *)this + 30920),
  ...
  if ( (v5 & 0x80000000) == 0 )
    v5 = -2003304445;
  MilInstrumentationCheckHR_MaybeFailFast(v10, 0LL, 0, v5, 0xDFu, 0LL);
  return v5;
}
