/*
 * XREFs of ?Draw@CSceneWorld@@UEAAJPEAVCDrawingContext@@AEBUD2D_SIZE_F@@PEA_NPEAV?$TMilRect_@MUMilRectF@@UMilPointAndSizeF@@UNotNeeded@RectUniqueness@@@@@Z @ 0x1802058F0
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall CSceneWorld::Draw(__int64 a1, CDrawingContext *a2)
{
  ...
  v8 = CDrawingContext::DrawSolidRectangle(a2, &v16, &xmmword_180312430);
  v7 = v8;
  if ( v8 >= 0 )
    return 0;
