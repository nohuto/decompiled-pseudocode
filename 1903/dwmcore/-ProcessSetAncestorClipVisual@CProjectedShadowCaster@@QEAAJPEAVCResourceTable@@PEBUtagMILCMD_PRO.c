/*
 * XREFs of ?ProcessSetAncestorClipVisual@CProjectedShadowCaster@@QEAAJPEAVCResourceTable@@PEBUtagMILCMD_PROJECTEDSHADOWCASTER_SETANCESTORCLIPVISUAL@@@Z @ 0x18000409C
 * Callers:
        ...
        const struct tagMILCMD_PROJECTEDSHADOWCASTER_SETANCESTORCLIPVISUAL *a3)
{
  ...
  Resource = 0LL;
  if ( (_DWORD)v5 && (Resource = CResourceTable::GetResource(a2, v5, 189LL)) == 0 )
  {
    v4 = -2003303421;
