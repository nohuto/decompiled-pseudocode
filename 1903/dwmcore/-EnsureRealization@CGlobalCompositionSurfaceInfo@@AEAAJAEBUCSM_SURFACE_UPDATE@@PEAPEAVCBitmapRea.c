/*
 * XREFs of ?EnsureRealization@CGlobalCompositionSurfaceInfo@@AEAAJAEBUCSM_SURFACE_UPDATE@@PEAPEAVCBitmapRealization@@@Z @ 0x18003CD3C
 * Callers:
 ...
 * Callees:
 *     ?FindRealizationNoRef@CBindInfo@CGlobalCompositionSurfaceInfo@@QEBAPEAVCBitmapRealization@@I@Z @ 0x18003CDE0 (-FindRealizationNoRef@CBindInfo@CGlobalCompositionSurfaceInfo@@QEBAPEAVCBitmapRealization@@I@Z.c)
