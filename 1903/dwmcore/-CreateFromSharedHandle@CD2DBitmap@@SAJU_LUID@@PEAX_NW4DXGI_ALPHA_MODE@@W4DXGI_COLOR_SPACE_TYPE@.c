/*
 * XREFs of ?CreateFromSharedHandle@CD2DBitmap@@SAJU_LUID@@PEAX_NW4DXGI_ALPHA_MODE@@W4DXGI_COLOR_SPACE_TYPE@@MMVDisplayId@@PEAPEAV1@@Z @ 0x18003F064
 * Callers:
        ...
        _QWORD *a9)
{
  ...
  v13 = a4;
  LOBYTE(a4) = a3;
  v9 = CD3DDeviceManager::OpenSharedHandleAsD2DBitmap(&qword_180340370, a1, a2, a4, v13, a5, a6, a7, a8, v14);
  v11 = v9;
  if ( v9 < 0 )
  {
