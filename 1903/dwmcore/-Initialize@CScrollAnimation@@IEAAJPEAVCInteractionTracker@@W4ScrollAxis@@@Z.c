/*
 * XREFs of ?Initialize@CScrollAnimation@@IEAAJPEAVCInteractionTracker@@W4ScrollAxis@@@Z @ 0x18020731C
 * Callers:
 ...
 *     ?InsertMaskElement@VectorSubchannelMaskInfo@@QEAAJE@Z @ 0x18022A7F0 (-InsertMaskElement@VectorSubchannelMaskInfo@@QEAAJE@Z.c)
 */
...
__int64 __fastcall CScrollAnimation::Initialize(__int64 a1, unsigned int *a2, int a3)
{
  ...
  *(_DWORD *)(a1 + 316) = a3;
  ...
  v12 = CBaseExpression::SetTarget(a1, a2[46], (struct CResource *)a2, v11, 0x12u, v3, v20, v21);
  v9 = v12;
  if ( v12 < 0 )
  {
