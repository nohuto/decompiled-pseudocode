/*
 * XREFs of ?Interpolate@CInterpolatePathsOperation@@QEAAJPEBVCPathData@@0MPEAPEAV2@@Z @ 0x18024C900
 * Callers:
 ...
 *     ?reserve@?$vector@EV?$allocator@E@std@@@std@@QEAAX_K@Z @ 0x18022C54C (-reserve@-$vector@EV-$allocator@E@std@@@std@@QEAAX_K@Z.c)
 */
