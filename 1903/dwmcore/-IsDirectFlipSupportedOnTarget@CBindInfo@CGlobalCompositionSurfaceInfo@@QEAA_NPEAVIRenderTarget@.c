/*
 * XREFs of ?IsDirectFlipSupportedOnTarget@CBindInfo@CGlobalCompositionSurfaceInfo@@QEAA_NPEAVIRenderTarget@@@Z @ 0x18025D034
 * Callers:
 *     ?IsDirectFlipSupportedOnTarget@CGlobalCompositionSurfaceInfo@@UEAA_NPEAVIRenderTarget@@@Z @ 0x18025D6E0 (-IsDirectFlipSupportedOnTarget@CGlobalCompositionSurfaceInfo@@UEAA_NPEAVIRenderTarget@@@Z.c)
 * Callees:
        ...
        struct IRenderTarget *a2)
{
  ...
  v54 = v57[0];
  if ( v2 )
    CDisplaySet::Release(v2, (unsigned int)a2);
  return v54;
}
