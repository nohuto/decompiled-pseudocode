/*
 * XREFs of ?ensure_extra_capacity@?$buffer_impl@PEAVICompositionSurfaceInfoListener@@$00$00Vliberal_expansion_policy@detail@@@detail@@QEAAX_K@Z @ 0x18002AC64
 * Callers:
        ...
        unsigned __int64 a2)
{
  ...
  if ( result < a2 )
  {
    ...
    *((_QWORD *)&v15 + 1) = v6;
    ...
    v17 = v15;
    v18 = 0LL;
    ((void (__fastcall *)(__int128 *, void *, __int64, __int128 *))std::uninitialized_copy<std::move_iterator<ICompositionSurfaceInfoListener * *>,stdext::checked_array_iterator<ICompositionSurfaceInfoListener * *>>)(
      &v15,
      v10,
      v9,
      &v17);
