/*
 * XREFs of ??1CInteraction@@MEAA@XZ @ 0x180029250
 * Callers:
 ...
 *     ?IsDefaultInteractionStateLocked@CInteraction@@AEAA_NXZ @ 0x180029428 (-IsDefaultInteractionStateLocked@CInteraction@@AEAA_NXZ.c)
...
void __fastcall CInteraction::~CInteraction(CInteraction *this)
{
  ...
  *((_QWORD *)this + 1) = &CInteraction::`vftable'{for `CResource'};
  ...
  memset_0((char *)lpMem + (unsigned int)(Size * *((_DWORD *)this + 424)), 0, (unsigned int)Size);
  *((_DWORD *)this + 424) = 0;
