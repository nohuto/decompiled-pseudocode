/*
 * XREFs of ?SetProperty@CInteractionTracker@@MEAAJIW4DCOMPOSITION_EXPRESSION_TYPE@@PEBX@Z @ 0x1801DD1F0
 * Callers:
 *     <none>
 * Callees:
 ...
 *     ?SetScaleInertiaDecayRate@CInteractionTracker@@AEAAXM@Z @ 0x1801DD700 (-SetScaleInertiaDecayRate@CInteractionTracker@@AEAAXM@Z.c)
 */
...
LABEL_23:
  ...
  {
    v20 = -2147024809;
    MilInstrumentationCheckHR_MaybeFailFast(v16, 0LL, 0, 0x80070057, 0x55Au, 0LL);
  }
  else
  {
    return 0;
