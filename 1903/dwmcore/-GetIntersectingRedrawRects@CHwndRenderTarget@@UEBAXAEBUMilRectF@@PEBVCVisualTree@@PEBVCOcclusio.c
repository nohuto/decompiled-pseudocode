/*
 * XREFs of ?GetIntersectingRedrawRects@CHwndRenderTarget@@UEBAXAEBUMilRectF@@PEBVCVisualTree@@PEBVCOcclusionContext@@PEAV?$DynArray@UMilRectF@@$0A@@@@Z @ 0x1801A90F0
 * Callers:
 *     <none>
 * Callees:
