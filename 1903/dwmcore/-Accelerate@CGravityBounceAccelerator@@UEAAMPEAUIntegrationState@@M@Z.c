/*
 * XREFs of ?Accelerate@CGravityBounceAccelerator@@UEAAMPEAUIntegrationState@@M@Z @ 0x180221C40
 * Callers:
 *     <none>
 * Callees:
...
LABEL_15:
  if ( *(_DWORD *)(v11 + 56) && dword_18033A240 > 4u && TlgKeywordOn((TraceLoggingHProvider)&dword_18033A240, 4uLL) )
  {
    v30 = 0;
    v33 = 0;
    v36 = 0;
    ...
    v44 = v18;
    v47 = v18;
    TlgWrite(v19, &unk_1802DD76B, 0LL, 0LL, 0xAu, &pData);
    return v24;
  }
  return v8;
}
