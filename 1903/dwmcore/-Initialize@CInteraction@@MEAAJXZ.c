/*
 * XREFs of ?Initialize@CInteraction@@MEAAJXZ @ 0x1800C1C60
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall CInteraction::Initialize(CInteraction *this)
{
  ...
  {
    v15 = -2147024882;
    MilInstrumentationCheckHR_MaybeFailFast(v3, 0LL, 0, 0x8007000E, 0x7Eu, 0LL);
LABEL_24:
  ...
  {
    v15 = -2147024882;
    MilInstrumentationCheckHR_MaybeFailFast(v6, 0LL, 0, 0x8007000E, 0x81u, 0LL);
    goto LABEL_24;
  }
  ...
  {
    v15 = -2147024882;
    MilInstrumentationCheckHR_MaybeFailFast(v9, 0LL, 0, 0x8007000E, 0x84u, 0LL);
    goto LABEL_24;
  }
  ...
  {
    v15 = -2147024882;
    MilInstrumentationCheckHR_MaybeFailFast(v12, 0LL, 0, 0x8007000E, 0x87u, 0LL);
    goto LABEL_24;
  }
