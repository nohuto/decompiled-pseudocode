/*
 * XREFs of ?DrawAsDrawList@CCompositionGlyphRun@@UEAAJPEAVCDrawingContext@@AEBUD2D_SIZE_F@@PEA_NPEAV?$TMilRect_@MUMilRectF@@UMilPointAndSizeF@@UNotNeeded@RectUniqueness@@@@PEAVCDrawListCache@@@Z @ 0x1801D0CF0
 * Callers:
 *     <none>
 * Callees:
