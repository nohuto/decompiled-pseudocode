/*
 * XREFs of ?QueryInterface@CChannel@@UEAAJAEBU_GUID@@PEAPEAX@Z @ 0x180158FA0
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall CChannel::QueryInterface(CChannel *this, const struct _GUID *a2, void **a3)
{
  ...
  if ( a3 )
  {
    ...
    if ( v5 )
    {
      v3 = -2147467262;
      *a3 = 0LL;
      MilInstrumentationCheckHR_MaybeFailFast((__int64)this, 0LL, 0, 0x80004002, 0x1D3u, 0LL);
    }
    else
    {
LABEL_11:
  ...
  {
    v3 = -2147024809;
    MilInstrumentationCheckHR_MaybeFailFast((__int64)this, 0LL, 0, 0x80070057, 0x1C5u, 0LL);
  }
  return v3;
}
