/*
 * XREFs of ?VisualSetInteraction@CChannel@@UEAAJII@Z @ 0x1800D47A0
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall CChannel::VisualSetInteraction(CChannel *this, unsigned int a2, unsigned int a3)
{
  unsigned int v6; // ebx
  ...
  CChannel::CheckOptionalHandle((__int64)this, a3, 87LL);
  v8[0] = 492;
  v8[1] = a2;
  v8[2] = a3;
