/*
 * XREFs of ??_ECGeometryOnlyDrawListBrush@@UEAAPEAXI@Z @ 0x18004E9C0
 * Callers:
        ...
        char a2)
{
  ...
  if ( (a2 & 1) != 0 )
  {
    ...
    else
    {
      ...
      if ( Current < 0 )
        ModuleFailFastForHRESULT((unsigned int)Current, retaddr, v4);
      v5 = v8;
      if ( *((_DWORD *)v8 + 51) >= *((_DWORD *)v8 + 50) )
      {
        operator delete(this);
      }
      else
      {
        *(_QWORD *)this = *((_QWORD *)v8 + 26);
        ++*((_DWORD *)v5 + 51);
        *((_QWORD *)v5 + 26) = this;
      }
    }
