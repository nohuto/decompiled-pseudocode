/*
 * XREFs of ?RemoveRenderTarget@CRenderTargetManager@@QEAA_NPEAVCRenderTarget@@@Z @ 0x1800D60E8
 * Callers:
 ...
 *     ?DetachFromChannel@CLocalAppRenderTarget@@UEAAXPEAVCChannelContext@@_N@Z @ 0x18019A8F0 (-DetachFromChannel@CLocalAppRenderTarget@@UEAAXPEAVCChannelContext@@_N@Z.c)
