/*
 * XREFs of ?EnsureD2DGeometry@CRegionShape@@AEBAJXZ @ 0x18000CC04
 * Callers:
...
__int64 __fastcall CRegionShape::EnsureD2DGeometry(CRegionShape *this)
{
  ...
  signed __int64 v12; // [rsp+30h] [rbp-D0h] BYREF
  void (__fastcall ***v13)(_QWORD, GUID *, signed __int64 *); // [rsp+38h] [rbp-C8h] BYREF
  void (__fastcall ***v14)(_QWORD, GUID *, signed __int64 *); // [rsp+40h] [rbp-C0h] BYREF
  ...
  if ( !*((_QWORD *)this + 11) )
  {
    ...
    else
    {
      ...
      {
        v14 = 0LL;
        v7 = (*(__int64 (__fastcall **)(_QWORD, _QWORD, _QWORD, void (__fastcall ****)(_QWORD, GUID *, signed __int64 *)))(**((_QWORD **)v15 + 4) + 24LL))(
               *((_QWORD *)v15 + 4),
               v16[0],
               v17,
               &v14);
