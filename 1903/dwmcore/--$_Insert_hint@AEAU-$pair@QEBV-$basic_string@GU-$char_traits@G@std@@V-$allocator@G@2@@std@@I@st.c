...
LABEL_7:
    ...
    if ( (__int64 *)v9 != v5 && v11 >= *(_QWORD *)(v9 + 32) )
      goto LABEL_41;
    LODWORD(a2) = (_DWORD)v7;
    LODWORD(a1) = v8;
    if ( *(_BYTE *)(a3[2] + 25) )
