/*
 * XREFs of ?ProcessUpdate@CSolidColorLegacyMilBrush@@QEAAJPEAVCResourceTable@@PEBUtagMILCMD_SOLIDCOLORLEGACYMILBRUSH@@@Z @ 0x180029BA0
 * Callers:
  ...
  *((_DWORD *)this + 14) = *((_DWORD *)a3 + 2);
  ...
  if ( (_DWORD)v6 )
  {
    ...
    *((_QWORD *)this + 8) = Resource;
    ...
    {
      v11 = -2003303421;
      MilInstrumentationCheckHR_MaybeFailFast(v14, 0LL, 0, -2003303421, 0x61Eu, 0LL);
LABEL_16:
      CSolidColorLegacyMilBrush::UnRegisterNotifiers(this);
      goto LABEL_8;
    }
  ...
  v15 = CResourceTable::GetResource(a2, v7, 179LL);
  *((_QWORD *)this + 9) = v15;
  if ( !v15 )
  {
    v11 = -2003303421;
    MilInstrumentationCheckHR_MaybeFailFast(v16, 0LL, 0, -2003303421, 0x631u, 0LL);
    goto LABEL_16;
  }
LABEL_5:
  ...
  v17 = CResourceTable::GetResource(a2, v8, 179LL);
  *((_QWORD *)this + 10) = v17;
  if ( !v17 )
  {
    v11 = -2003303421;
    MilInstrumentationCheckHR_MaybeFailFast(v18, 0LL, 0, -2003303421, 0x643u, 0LL);
    goto LABEL_16;
  }
LABEL_7:
