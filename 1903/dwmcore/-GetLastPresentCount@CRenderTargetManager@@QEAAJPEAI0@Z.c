/*
 * XREFs of ?GetLastPresentCount@CRenderTargetManager@@QEAAJPEAI0@Z @ 0x180092730
 * Callers:
        ...
        unsigned int *a3)
{
  ...
  do
  {
      ...
      && !(*(unsigned __int8 (__fastcall **)(_QWORD *))(*v8 + 248LL))(v8) )
    {
      ...
      if ( v9 < 0 )
        MilInstrumentationCheckHR_MaybeFailFast(v10, &dword_1802920EC, 1u, v9, 0x3FAu, 0LL);
    ...
    if ( *a2 )
    {
      ...
      if ( PrimaryRenderTargetNoRef )
      {
        v13 = (*(__int64 (__fastcall **)(__int64, unsigned int *))(*((_QWORD *)PrimaryRenderTargetNoRef + 8) + 104LL))(
                ...
                a3);
        if ( v13 < 0 )
          MilInstrumentationCheckHR_MaybeFailFast(v14, &dword_1802920EC, 1u, v13, 0x406u, 0LL);
        LODWORD(v3) = 1;
      }
    }
  }
