/*
 * XREFs of ?BuildD2DBitmapList@CPrimitiveGroup@@AEAAJPEAVID2DContextOwner@@PEAVID2DContext@@IIPEAPEAUID2D1Bitmap@@@Z @ 0x1801C593C
 * Callers:
        ...
        struct ID2D1Bitmap **a6)
{
  ...
  if ( a5 )
  {
    ...
    MilInstrumentationCheckHR_MaybeFailFast(v13, 0LL, 0, D2DBitmapRealizationForContextOwner, 0x42Bu, 0LL);
  }
  return v6;
}
