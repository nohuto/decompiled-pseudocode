/*
 * XREFs of ?BaseAnimationRemoveBinding@CChannel@@UEAAJIIW4Enum@DwmResourceProperty@@@Z @ 0x180157550
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall CChannel::BaseAnimationRemoveBinding(__int64 a1, unsigned int a2, unsigned int a3, unsigned int a4)
{
  ...
  *(__int64 *)((char *)si128.m128i_i64 + 4) = __PAIR64__(a3, a2);
  ...
  if ( v8 < 0 )
  {
    MilInstrumentationCheckHR_MaybeFailFast(v9, 0LL, 0, v8, 0x8E1u, 0LL);
  }
  else
  {
    ...
    v10 = v11;
    if ( v11 < 0 )
      MilInstrumentationCheckHR_MaybeFailFast(v12, 0LL, 0, v11, 0x8E2u, 0LL);
  }
