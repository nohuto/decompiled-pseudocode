/*
 * XREFs of ?Create@CChannelContext@@SAJIK_KPEAVCConnection@@PEAPEAV1@@Z @ 0x180045548
 * Callers:
 ...
 *     ??0CResourceTable@@QEAA@IPEAVCProcessAttribution@@@Z @ 0x180045630 (--0CResourceTable@@QEAA@IPEAVCProcessAttribution@@@Z.c)
        ...
        struct CChannelContext **a5)
{
  ...
  v7 = 0;
  v21[0] = 0LL;
  ProcessAttribution = CProcessAttributionManager::GetProcessAttribution(qword_18033CC50, a2, a3, v21);
  ...
  if ( v14 )
  {
    ...
    if ( v14 )
      CChannelContext::`vector deleting destructor'(v14, 1u);
  }
  else
  {
    v7 = -2147024882;
