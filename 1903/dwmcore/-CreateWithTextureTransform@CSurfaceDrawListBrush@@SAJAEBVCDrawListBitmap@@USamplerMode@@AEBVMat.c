/*
 * XREFs of ?CreateWithTextureTransform@CSurfaceDrawListBrush@@SAJAEBVCDrawListBitmap@@USamplerMode@@AEBVMatrix3x3@@PEAPEAV1@@Z @ 0x180051E20
 * Callers:
        ...
        _QWORD *a4)
{
  ...
  if ( v10 || (v12 = DefaultHeap::Alloc(0x98uLL), (v10 = v12) != 0LL) )
  {
    v14 = *a2;
    v15 = *((_BYTE *)a2 + 2);
    v12 = (_QWORD *)CSurfaceDrawListBrush::CSurfaceDrawListBrush((__int64)v10, (__int64 *)a1, (__int64)&v14, a3);
  }
  *a4 = v12;
  if ( !v12 )
  {
