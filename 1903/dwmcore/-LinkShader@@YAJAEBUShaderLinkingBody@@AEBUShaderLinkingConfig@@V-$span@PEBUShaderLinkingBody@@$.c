/*
 * XREFs of ?LinkShader@@YAJAEBUShaderLinkingBody@@AEBUShaderLinkingConfig@@V?$span@PEBUShaderLinkingBody@@$0?0@gsl@@PEAUVertexShaderDesc@@PEAPEAUID3D10Blob@@@Z @ 0x180033794
 * Callers:
 ...
 *     GetExpectedVertexShaderDesc @ 0x180031238 (GetExpectedVertexShaderDesc.c)
 ...
 *     ??0CShaderLinkingGraphBuilder@@QEAA@XZ @ 0x180031AD4 (--0CShaderLinkingGraphBuilder@@QEAA@XZ.c)
 *     HasWhiteNoise @ 0x180032B10 (HasWhiteNoise.c)
 ...
 *     ?DoesSamplerRequireConstantBufferData@@YA_NAEBUShaderLinkingSamplerDesc@@@Z @ 0x180033D18 (-DoesSamplerRequireConstantBufferData@@YA_NAEBUShaderLinkingSamplerDesc@@@Z.c)
...
__int64 __fastcall LinkShader(__int64 a1, __int64 a2, unsigned __int64 *a3, __int64 a4, struct ID3D10Blob **a5)
{
  ...
  struct ID3D11Module *v79; // [rsp+40h] [rbp-C0h] BYREF
  ...
  int v84[4]; // [rsp+70h] [rbp-90h] BYREF
  ...
  *(_QWORD *)&v90[0] = 4LL;
  ...
  v24 = (_DWORD *)v91[0];
  v90[0] = *(_OWORD *)v91[0];
  ExpectedVertexShaderDesc = GetExpectedVertexShaderDesc((__int64 *)a1, v90, a2, v9, v22);
  v26 = (VertexShaderDesc *)v92[0];
  *(_QWORD *)v92[0] = ExpectedVertexShaderDesc;
  LOBYTE(v27) = *(_BYTE *)(a1 + 32);
  v28 = InitializeShaderLinkingInput((struct ID3D11Linker **)v84, v27, v26);
  v30 = v28;
  if ( v28 < 0 )
  {
...
LABEL_20:
  ...
  *(_QWORD *)&v90[0] = (unsigned int)v80;
  LOBYTE(v88) = 0;
  *((_QWORD *)&v90[0] + 1) = v87;
  v36 = PrepareSamplers((int)v84, a2);
  v30 = v36;
  if ( v36 < 0 )
  {
  ...
  else
  {
    ...
    if ( *v24 )
    {
      while ( 1 )
      {
        ...
        v56 = LoadShaderBody((__int64)v84, v54, v55, v38, (__int64)v90, &v79);
        v30 = v56;
        if ( v56 < 0 )
          break;
        v58 = AppendShaderBody(
                v84,
                (unsigned __int16)v35 | 0x500u,
                (__int128 *)v54,
                a2,
                (__int64)v90,
                (__int64)v79,
      ...
      MilInstrumentationCheckHR_MaybeFailFast(v57, 0LL, 0, v56, 0x4CEu, 0LL);
    }
    else
    {
LABEL_24:
      Microsoft::WRL::ComPtr<ID3D11Device5>::InternalRelease((__int64 *)&v79);
      v40 = LoadShaderBody((__int64)v84, a1, v39, v38, (__int64)byte_1802B2AA6, &v79);
      v30 = v40;
      if ( v40 < 0 )
      {
      ...
      {
        v42 = AppendShaderBody(v84, 10, (__int128 *)a1, a2, (__int64)byte_1802B2AA6, (__int64)v79, v34, &v88);
        v30 = v42;
        if ( v42 < 0 )
        {
        ...
        else
        {
          ...
          {
            v66 = AppendLights(0xAu, v84, (_DWORD *)(a2 + 128), -1);
            v30 = v66;
            if ( v66 < 0 )
            {
