/*
 * XREFs of ?Matrix4x4FromScale@CExpressionValueStack@@QEAAJI@Z @ 0x18020287C
 * Callers:
 ...
 *     ?D2DMatrixScaling@@YAPEAUD2DMatrix@@PEAU1@MMMUD2DVector3@@@Z @ 0x180228C30 (-D2DMatrixScaling@@YAPEAUD2DMatrix@@PEAU1@MMMUD2DVector3@@@Z.c)
 *     ?D2DMatrixScaling@@YAPEAUD2DMatrix@@PEAU1@MUD2DVector3@@@Z @ 0x180228CA4 (-D2DMatrixScaling@@YAPEAUD2DMatrix@@PEAU1@MUD2DVector3@@@Z.c)
 *     ?D2DMatrixScaling@@YAPEAUD2DMatrix@@PEAU1@UD2DVector3@@1@Z @ 0x180228D0C (-D2DMatrixScaling@@YAPEAUD2DMatrix@@PEAU1@UD2DVector3@@1@Z.c)
 */
...
__int64 __fastcall CExpressionValueStack::Matrix4x4FromScale(CExpressionValueStack *this, __int64 a2)
{
  ...
  __int128 v39; // xmm0
  __int128 v40; // xmm1
  unsigned int v41; // [rsp+28h] [rbp-19h]
  __int64 v42; // [rsp+38h] [rbp-9h] BYREF
  int v43; // [rsp+40h] [rbp-1h]
  __int64 v44; // [rsp+48h] [rbp+7h] BYREF
  int v45; // [rsp+50h] [rbp+Fh]
  __int128 v46; // [rsp+58h] [rbp+17h] BYREF
  __int128 v47; // [rsp+68h] [rbp+27h]
  __int128 v48; // [rsp+78h] [rbp+37h]
  __int128 v49; // [rsp+88h] [rbp+47h]
