/*
 * XREFs of ?LogSetOutputValue@CBaseExpression@@AEAAXXZ @ 0x1801E73B4
 * Callers:
...
void __fastcall CBaseExpression::LogSetOutputValue(CBaseExpression *this)
{
        ...
        if ( v21 )
        {
          ...
          if ( v22 )
          {
            ...
            if ( dword_18033A240 > 4u && TlgKeywordOn((TraceLoggingHProvider)&dword_18033A240, 1uLL) )
            {
              ...
              v76 = v24;
              v78 = v24;
              TlgWrite((TraceLoggingHProvider)&dword_18033A240, &unk_1802DCC14, 0LL, 0LL, 0x16u, &pData);
            }
          }
          else if ( dword_18033A240 > 4u && TlgKeywordOn((TraceLoggingHProvider)&dword_18033A240, 1uLL) )
          {
            ...
            v56 = v26;
            v58 = v26;
            TlgWrite((TraceLoggingHProvider)&dword_18033A240, &unk_1802DCE14, 0LL, 0LL, 0xCu, &pData);
          }
        }
        else if ( dword_18033A240 > 4u && TlgKeywordOn((TraceLoggingHProvider)&dword_18033A240, 1uLL) )
        {
          ...
          v52 = v28;
          v54 = v28;
          TlgWrite((TraceLoggingHProvider)&dword_18033A240, &unk_1802DCD58, 0LL, 0LL, 0xAu, &pData);
        }
      }
      else if ( dword_18033A240 > 4u && TlgKeywordOn((TraceLoggingHProvider)&dword_18033A240, 1uLL) )
      {
        ...
        v52 = v30;
        v54 = v30;
        TlgWrite((TraceLoggingHProvider)&dword_18033A240, &unk_1802DCDB6, 0LL, 0LL, 0xAu, &pData);
      }
    }
    else if ( dword_18033A240 > 4u && TlgKeywordOn((TraceLoggingHProvider)&dword_18033A240, 1uLL) )
    {
  ...
  else if ( v4 == 52 )
  {
    if ( dword_18033A240 > 4u && TlgKeywordOn((TraceLoggingHProvider)&dword_18033A240, 1uLL) )
    {
      ...
      v50 = v18;
      v52 = v18;
      TlgWrite((TraceLoggingHProvider)&dword_18033A240, &unk_1802DCF2D, 0LL, 0LL, 9u, &pData);
    }
  }
  else
  {
            ...
            if ( v8 == 7 )
            {
              if ( dword_18033A240 > 4u )
              {
                if ( TlgKeywordOn((TraceLoggingHProvider)&dword_18033A240, 1uLL) )
                {
                  ...
                  v47 = (char *)this + 64;
                  v48 = v9;
                  TlgWrite((TraceLoggingHProvider)&dword_18033A240, &unk_1802DCCB6, 0LL, 0LL, 7u, &pData);
                }
              }
              return;
            }
LABEL_38:
          ...
          if ( dword_18033A240 > 4u && TlgKeywordOn((TraceLoggingHProvider)&dword_18033A240, 1uLL) )
          {
            ...
            v48 = v10;
            v50 = v10;
            TlgWrite((TraceLoggingHProvider)&dword_18033A240, &unk_1802DCED5, 0LL, 0LL, v10 + 4, &pData);
          }
        }
        else if ( dword_18033A240 > 4u && TlgKeywordOn((TraceLoggingHProvider)&dword_18033A240, 1uLL) )
        {
      ...
      else if ( dword_18033A240 > 4u && TlgKeywordOn((TraceLoggingHProvider)&dword_18033A240, 1uLL) )
      {
        ...
        v46 = 8LL;
        v48 = v15;
        TlgWrite((TraceLoggingHProvider)&dword_18033A240, &unk_1802DCE84, 0LL, 0LL, 7u, &pData);
      }
    }
    else if ( dword_18033A240 > 4u && TlgKeywordOn((TraceLoggingHProvider)&dword_18033A240, 1uLL) )
    {
      ...
      v46 = 8LL;
      v48 = 10LL;
      TlgWrite((TraceLoggingHProvider)&dword_18033A240, &unk_1802DCD07, 0LL, 0LL, 7u, &pData);
    }
  }
}
