/*
 * XREFs of ?GetD2DBitmap@CRenderTargetBitmap@@UEAAJAEBURenderTargetInfo@@PEBV?$TMilRect@IUMilRectU@@UNotNeeded@RectUniqueness@@@@_NPEAPEAUID2D1Bitmap1@@@Z @ 0x1800D0730
 * Callers:
 *     <none>
 * Callees:
