/*
 * XREFs of ?Channel_DuplicateHandleOnSource@CComposition@@AEAAJPEAVCChannelContext@@PEAVCResourceTable@@PEBUtagMILCMD_CHANNEL_DUPLICATEHANDLEONSOURCE@@@Z @ 0x1800401F8
 * Callers:
...
__int64 __fastcall CComposition::Channel_DuplicateHandleOnSource(
        ...
        const struct tagMILCMD_CHANNEL_DUPLICATEHANDLEONSOURCE *a4)
{
  ...
  {
    MilInstrumentationCheckHR_MaybeFailFast(v8, 0LL, 0, AttachedChannel, 0x794u, 0LL);
  }
  else
  {
    ...
    v9 = v10;
    if ( v10 < 0 )
      MilInstrumentationCheckHR_MaybeFailFast(v11, 0LL, 0, v10, 0x79Cu, 0LL);
  }
