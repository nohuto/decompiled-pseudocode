/*
 * XREFs of ?HasImpulse@CInteractionTracker@@QEBA_NXZ @ 0x1801DAB68
 * Callers:
...
char __fastcall CInteractionTracker::HasImpulse(CInteractionTracker *this)
{
  ...
  if ( v2 )
  {
    if ( *(float *)((*(__int64 (__fastcall **)(__int64))(*(_QWORD *)v2 + 312LL))(v2) + 40) != 0.0 )
      return 1;
  }
  v4 = *((_QWORD *)this + 42);
  if ( v4 )
  {
    if ( *(float *)((*(__int64 (__fastcall **)(__int64))(*(_QWORD *)v4 + 312LL))(v4) + 40) != 0.0 )
      return 1;
  }
  v5 = *((_QWORD *)this + 40);
  if ( v5 )
  {
    if ( *(float *)((*(__int64 (__fastcall **)(__int64))(*(_QWORD *)v5 + 312LL))(v5) + 40) != 0.0 )
      return 1;
  }
  return v3;
}
