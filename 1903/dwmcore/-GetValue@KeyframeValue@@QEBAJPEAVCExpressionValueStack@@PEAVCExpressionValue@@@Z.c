/*
 * XREFs of ?GetValue@KeyframeValue@@QEBAJPEAVCExpressionValueStack@@PEAVCExpressionValue@@@Z @ 0x1802098E4
 * Callers:
        ...
        struct CExpressionValue *a3)
{
  ...
  v4 = (CKeyframeAnimation *)*((_QWORD *)this + 3);
  v5 = *((_QWORD *)v4 + 44);
  if ( !*(_DWORD *)v5 )
  {
    v6 = CKeyframeAnimation::SampleStartingValue(v4);
    v8 = v6;
    if ( v6 < 0 )
    {
      MilInstrumentationCheckHR_MaybeFailFast(v7, 0LL, 0, v6, 0x6AFu, 0LL);
      goto LABEL_30;
    }
  }
  if ( *(_DWORD *)v5 == 11 )
...
LABEL_30:
  ...
  v8 = -2147467259;
  MilInstrumentationCheckHR_MaybeFailFast(v9, 0LL, 0, 0x80004005, 0x6DFu, 0LL);
  v10 = -2147467259;
LABEL_31:
