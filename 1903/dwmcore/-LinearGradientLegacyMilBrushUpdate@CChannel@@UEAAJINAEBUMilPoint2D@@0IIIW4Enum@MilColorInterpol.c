/*
 * XREFs of ?LinearGradientLegacyMilBrushUpdate@CChannel@@UEAAJINAEBUMilPoint2D@@0IIIW4Enum@MilColorInterpolationMode@@W43MilBrushMappingMode@@W43MilGradientSpreadMethod@@PEBUMilGradientStop@@I@Z @ 0x180158270
 * Callers:
 *     <none>
 * Callees:
        ...
        unsigned int a13)
{
  ...
  CChannel::CheckHandle(a1, a2, 95);
  v16 = a6;
  CChannel::CheckOptionalHandle(a1, a6, 57LL);
  v17 = a7;
  CChannel::CheckOptionalHandle(a1, a7, 179LL);
  v18 = a8;
  CChannel::CheckOptionalHandle(a1, a8, 179LL);
  v27 = 562;
  ...
  *(float *)&v28[1] = v20;
  ...
  {
    v25 = -2147024362;
    MilInstrumentationCheckHR_MaybeFailFast(v22, 0LL, 0, 0x80070216, 0xBB6u, 0LL);
  }
  else
  {
    v29 = 24 * a13;
    ...
    if ( v23 < 0 )
    {
      MilInstrumentationCheckHR_MaybeFailFast(v24, 0LL, 0, v23, 0xBB7u, 0LL);
    }
    else
    {
