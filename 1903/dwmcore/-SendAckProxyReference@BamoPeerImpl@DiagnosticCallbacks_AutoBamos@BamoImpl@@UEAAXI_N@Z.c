/*
 * XREFs of ?SendAckProxyReference@BamoPeerImpl@DiagnosticCallbacks_AutoBamos@BamoImpl@@UEAAXI_N@Z @ 0x18018AEC0
 * Callers:
 *     <none>
 * Callees:
        ...
        unsigned __int8 a3)
{
  ...
  LODWORD(v7) = a3;
  LOWORD(v6) = 4;
  v5 = CoreUICallSend(v4, v8, 2LL, 1LL, v6, &unk_1802BE025, a2, v7);
  if ( v5 < 0 )
  {
