/*
 * XREFs of ?CalcFrustumOutline@@YAXVCMILMatrix@@PEAULine3D@@111@Z @ 0x1801C7158
 * Callers:
 ...
 *     log10f_0 @ 0x1800EC4F7 (log10f_0.c)
 *     sqrtf_0 @ 0x1800EC51B (sqrtf_0.c)
 *     ??0Line3D@@QEAA@UMilPoint4F@@0@Z @ 0x1801C7080 (--0Line3D@@QEAA@UMilPoint4F@@0@Z.c)
 */
