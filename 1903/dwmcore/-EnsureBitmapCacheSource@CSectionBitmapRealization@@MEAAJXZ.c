/*
 * XREFs of ?EnsureBitmapCacheSource@CSectionBitmapRealization@@MEAAJXZ @ 0x1800CE5D0
 * Callers:
 *     <none>
 * Callees:
  ...
  if ( !*((_QWORD *)this + 58) )
  {
    ...
    if ( v6 )
    {
      ...
      if ( v7 )
      {
        ...
        {
          RequiredBufferSize = GetRequiredBufferSize(*((_DWORD *)this + 113), *((unsigned int *)this + 112), &v19);
