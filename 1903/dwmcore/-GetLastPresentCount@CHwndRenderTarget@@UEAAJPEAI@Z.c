/*
 * XREFs of ?GetLastPresentCount@CHwndRenderTarget@@UEAAJPEAI@Z @ 0x180049960
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall CHwndRenderTarget::GetLastPresentCount(CHwndRenderTarget *this, unsigned int *a2)
{
  ...
  if ( v4 )
  {
    ...
    v7 = v5;
    if ( v5 < 0 )
      MilInstrumentationCheckHR_MaybeFailFast(v6, &dword_1802920EC, 1u, v5, 0x69Eu, 0LL);
    else
      *((_DWORD *)this + 118) = *a2;
  }
  else
  {
    v7 = -2003304307;
    MilInstrumentationCheckHR_MaybeFailFast(0, &dword_1802920EC, 1u, -2003304307, 0x6A7u, 0LL);
  }
