/*
 * XREFs of ?InitializeForFormatConversion@CScanPipeline@@QEAAJAEBUPixelFormatInfo@@0IE@Z @ 0x180224A60
 * Callers:
 ...
 *     ?ResetPipeline@CScanPipeline@@MEAAXXZ @ 0x180224A10 (-ResetPipeline@CScanPipeline@@MEAAXXZ.c)
