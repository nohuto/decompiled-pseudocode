/*
 * XREFs of ?ProcessLegacyRegionGeometryUpdateCommand@@YAJPEAVCRegionGeometry@@PEAVCChannelContext@@PEBUtagMILCMD_REGIONGEOMETRY@@PEBXI@Z @ 0x1800C582C
 * Callers:
        ...
        unsigned int a5)
{
  ...
  {
    v9 = -2003303421;
    MilInstrumentationCheckHR_MaybeFailFast((__int64)a1, 0LL, 0, 0x88980403, 0x575u, 0LL);
  }
  else
  {
    v6 = v5 >> 4;
    ...
    v9 = appended;
    if ( appended < 0 )
      MilInstrumentationCheckHR_MaybeFailFast(v8, 0LL, 0, appended, 0x578u, 0LL);
  }
  return v9;
}
