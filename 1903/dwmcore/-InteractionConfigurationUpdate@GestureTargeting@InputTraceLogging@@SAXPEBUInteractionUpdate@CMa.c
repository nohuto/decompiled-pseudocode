/*
 * XREFs of ?InteractionConfigurationUpdate@GestureTargeting@InputTraceLogging@@SAXPEBUInteractionUpdate@CManipulationManager@@@Z @ 0x1800C36EC
 * Callers:
        ...
        const struct CManipulationManager::InteractionUpdate *a1)
{
  ...
  if ( v2 && (v3 = v2 - 1) != 0 )
  {
      ...
      if ( (_DWORD)v5 )
      {
        ...
        else
        {
          ...
          if ( *(_DWORD *)v7 > 4u && TlgKeywordOn((TraceLoggingHProvider)v6[1], 0x800uLL) )
          {
            ...
            v65 = 4;
            v68 = 4;
            TlgWrite(v7, &unk_1802DFF44, 0LL, 0LL, 0x10u, &pData);
          }
        }
      }
      else
    ...
    {
      InputTraceLogging::GestureTargeting::InteractionConfigurationUpdate<DwmTouchpadInteractionConfigurationPrimitive>(a1);
    }
  }
  else
  {
