/*
 * XREFs of ?FindKey@?$CSimpleMap@PEAU_SEB_RPC_PUBLISH_DATA@@PEAXV?$CSimpleMapEqualHelper@PEAU_SEB_RPC_PUBLISH_DATA@@PEAX@ATL@@@ATL@@QEBAHAEBQEAU_SEB_RPC_PUBLISH_DATA@@@Z @ 0x1800DC4E8
 * Callers:
        ...
        __int64 *a2)
{
  ...
  result = 0LL;
  if ( (int)qword_180340460 <= 0 )
    return 0xFFFFFFFFLL;
  v3 = *a2;
  for ( i = Block; *i != v3; ++i )
  {
    result = (unsigned int)(result + 1);
    if ( (int)result >= (int)qword_180340460 )
      return 0xFFFFFFFFLL;
  }
  return result;
}
