/*
 * XREFs of ?CreateNewD2DCommandList@CPrimitiveGroup@@AEAAJPEAVID2DContextOwner@@PEAVID2DContext@@PEAPEAVCD2DCommandList@@@Z @ 0x1801C5C64
 * Callers:
        ...
        struct CD2DCommandList **a4)
{
  ...
  *a4 = 0LL;
  ...
  v59 = 0LL;
  v60 = 0LL;
  v12 = CD2DSharedBuffer::CreateFromSharedSection(*((void **)this + 63), v10, v8, &v59);
  v14 = v12;
  if ( v12 < 0 )
  {
