/*
 * XREFs of ?FillRectanglesAsDrawList@CDrawingContext@@AEAAJ$$QEAV?$unique_ptr@VCDrawListBrush@@U?$default_delete@VCDrawListBrush@@@std@@@std@@AEBV?$span@$$CBUMilRectF@@$0?0@gsl@@AEBU_D3DCOLORVALUE@@@Z @ 0x18009A820
 * Callers:
        ...
        __int128 *a4)
{
    ...
    || (*v25 = 0LL, v54 = CDrawListCache::Create((struct CDrawListCache **)this + 754), v12 = v54, v54 >= 0) )
  {
    ...
    {
      v67 = 0;
      CMatrixStack::Top((CDrawingContext *)((char *)this + 480), (struct CMILMatrix *)&v65);
