/*
 * XREFs of ?CalculateInertiaValueWorker@CInteractionTrackerPositionAnimation@@MEAAJPEAVCExpressionValueStack@@_KMPEAM@Z @ 0x180208DA0
 * Callers:
 *     <none>
 * Callees:
        ...
        float *a5)
{
  ...
  *v7 = v18;
  ...
  if ( dword_18033A240 > 4u && TlgKeywordOn((TraceLoggingHProvider)&dword_18033A240, 2uLL) )
  {
    ...
    v35 = v21;
    v38 = v21;
    TlgWrite((TraceLoggingHProvider)&dword_18033A240, &unk_1802DD525, 0LL, 0LL, 7u, &pData);
  }
  return 0LL;
}
