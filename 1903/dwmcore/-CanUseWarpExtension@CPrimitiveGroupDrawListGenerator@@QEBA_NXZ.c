/*
 * XREFs of ?CanUseWarpExtension@CPrimitiveGroupDrawListGenerator@@QEBA_NXZ @ 0x180258254
 * Callers:
 ...
 *     ??$IsTranslateAndScale@$0A@@CMILMatrix@@AEBA_NXZ @ 0x18021C7EC (--$IsTranslateAndScale@$0A@@CMILMatrix@@AEBA_NXZ.c)
 */
