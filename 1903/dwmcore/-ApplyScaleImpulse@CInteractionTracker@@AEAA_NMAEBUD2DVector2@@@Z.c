/*
 * XREFs of ?ApplyScaleImpulse@CInteractionTracker@@AEAA_NMAEBUD2DVector2@@@Z @ 0x1801D9078
 * Callers:
        ...
        const struct D2DVector2 *a3)
{
  ...
  if ( !v3 || (unsigned int)(v3 - 2) <= 1 )
  {
    ...
    {
      v7 = (*(__int64 (__fastcall **)(_QWORD))(**((_QWORD **)this + 40) + 312LL))(*((_QWORD *)this + 40));
      *(float *)(v7 + 40) = a2 + *(float *)(v7 + 40);
      (*(void (__fastcall **)(_QWORD))(**((_QWORD **)this + 41) + 304LL))(*((_QWORD *)this + 41));
