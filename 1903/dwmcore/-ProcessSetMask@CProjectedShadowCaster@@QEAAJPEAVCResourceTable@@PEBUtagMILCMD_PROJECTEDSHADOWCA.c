/*
 * XREFs of ?ProcessSetMask@CProjectedShadowCaster@@QEAAJPEAVCResourceTable@@PEBUtagMILCMD_PROJECTEDSHADOWCASTER_SETMASK@@@Z @ 0x1801F28E0
 * Callers:
        ...
        const struct tagMILCMD_PROJECTEDSHADOWCASTER_SETMASK *a3)
{
  ...
  {
    v7 = -2003303421;
    MilInstrumentationCheckHR_MaybeFailFast((__int64)this, 0LL, 0, 0x88980403, 0x3Eu, 0LL);
  }
