/*
 * XREFs of ?OnManipulationChanged@InteractionSourceManager@@QEAAXW4Flags@NotificationEventArgs@@PEAVCManipulation@@@Z @ 0x18021F36C
 * Callers:
      ...
      if ( v7 )
      {
          ...
          && CInteractionTracker::AreInteractionAnimationsAlive(*(CInteractionTracker **)(*(_QWORD *)(a1 + 8) + 16LL)) )
        {
          if ( InteractionSourceManager::IsManipulationActive((InteractionSourceManager *)a1, v8) )
            *(_BYTE *)(*(_QWORD *)(*(_QWORD *)a1 + 240LL) + 416LL) |= 4u;
        }
      }
      else
      {
