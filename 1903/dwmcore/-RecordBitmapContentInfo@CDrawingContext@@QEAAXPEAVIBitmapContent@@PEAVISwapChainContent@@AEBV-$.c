/*
 * XREFs of ?RecordBitmapContentInfo@CDrawingContext@@QEAAXPEAVIBitmapContent@@PEAVISwapChainContent@@AEBV?$TMilRect_@MUMilRectF@@UMilPointAndSizeF@@UNotNeeded@RectUniqueness@@@@PEBVCMILMatrix@@@Z @ 0x18005154C
 * Callers:
      ...
      if ( a3 )
      {
        ...
        if ( result )
        {
          ...
          if ( result )
          {
            ...
            CScopedClipStack::GetClipBoundsWorld((char *)this + 1008, &v19);
            left = v18.left;
