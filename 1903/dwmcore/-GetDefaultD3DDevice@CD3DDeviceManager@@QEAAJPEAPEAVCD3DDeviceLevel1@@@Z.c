/*
 * XREFs of ?GetDefaultD3DDevice@CD3DDeviceManager@@QEAAJPEAPEAVCD3DDeviceLevel1@@@Z @ 0x18015F2A0
 * Callers:
...
__int64 __fastcall CD3DDeviceManager::GetDefaultD3DDevice(CD3DDeviceManager *this, struct CD3DDeviceLevel1 **a2)
{
  ...
  *a2 = 0LL;
  ...
  else
  {
    ...
    {
      v7 = -2003304307;
      MilInstrumentationCheckHR_MaybeFailFast(v5, &dword_1802E3D40, 1u, 0x8898008D, 0x1F7u, 0LL);
      goto LABEL_8;
    }
  ...
  MilInstrumentationCheckHR_MaybeFailFast(v5, &dword_1802E3D40, 1u, D3DDevice, v9, 0LL);
LABEL_8:
  if ( v6 )
