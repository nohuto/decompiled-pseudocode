/*
 * XREFs of ?AddLines@CTransformedGeometryHelper@@EEAAXPEBUD2D_POINT_2F@@I@Z @ 0x18024DCC0
 * Callers:
 *     <none>
 * Callees:
        ...
        unsigned int a3)
{
  ...
  *((_QWORD *)this + 5) = v5;
  if ( a3 )
  {
    ...
    do
    {
      CMILMatrix::Transform(*((CMILMatrix **)this + 1), (const struct MilPoint2F *)a2, (struct MilPoint2F *)&v9, 1);
      if ( (_BYTE *)v3[2] == v8 )
      {
        std::vector<D2D_POINT_2F>::_Emplace_reallocate<D2D_POINT_2F &>((__int64)v3, v8, &v9);
      }
      else
      {
        *(_QWORD *)v8 = v9;
