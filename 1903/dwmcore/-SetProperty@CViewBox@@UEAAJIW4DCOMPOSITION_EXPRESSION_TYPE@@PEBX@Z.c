/*
 * XREFs of ?SetProperty@CViewBox@@UEAAJIW4DCOMPOSITION_EXPRESSION_TYPE@@PEBX@Z @ 0x1801FD480
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall CViewBox::SetProperty(__int64 a1, int a2, int a3)
{
  ...
  {
    v9 = -2147024809;
    MilInstrumentationCheckHR_MaybeFailFast(v5, 0LL, 0, 0x80070057, 0x2Bu, 0LL);
  }
  return v9;
}
