/*
 * XREFs of ?CreateLinkedShader@CCompiledEffectCache@@QEAAJIAEBUShaderLinkingConfig@@AEBUShaderLinkingBody@@V?$span@PEBUShaderLinkingBody@@$0?0@gsl@@PEAPEAVCLinkedShader@@@Z @ 0x180027B10
 * Callers:
 ...
 *     ??0CLinkedShader@@QEAA@PEAUID3D10Blob@@I@Z @ 0x180027A64 (--0CLinkedShader@@QEAA@PEAUID3D10Blob@@I@Z.c)
 ...
 *     ?StringCchPrintfA@@YAJPEAD_KPEBDZZ @ 0x1801CE238 (-StringCchPrintfA@@YAJPEAD_KPEBDZZ.c)
        ...
        struct CLinkedShader **a6)
{
  ...
  _OWORD *v37; // [rsp+48h] [rbp-B8h]
  __int64 v38[2]; // [rsp+50h] [rbp-B0h] BYREF
  ...
  {
    StringCchPrintfA(Buffer, 0x20uLL, "id=%p cid=%u lit=%u", this[4], a2, *(_DWORD *)(a3 + 128) != -1);
    if ( (Microsoft_Windows_Dwm_CoreEnableBits & 0x20) != 0 )
  ...
  *(_OWORD *)v38 = v11;
  ...
  LinkedShader = LinkShader(a4, a3, v38, &v36, &v35);
  v14 = LinkedShader;
  if ( LinkedShader >= 0 )
  {
  ...
  else
  {
    ...
    v42 = v30;
    LODWORD(v40) = -1;
    v31 = CCompiledEffectCache::LookupShader((CCompiledEffectCache *)this, a2, (const struct ShaderLinkingConfig *)v39);
    v36 = (__int64)v31;
    if ( v31 )
    {
      *a6 = v31;
    ...
    *(_OWORD *)v38 = *v37;
    ...
    if ( LinkedShader >= 0 )
    {
      Microsoft::WRL::ComPtr<CLinkedShader>::operator=(&v34, (volatile signed __int32 *)v36);
      v6 = v34;
LABEL_6:
