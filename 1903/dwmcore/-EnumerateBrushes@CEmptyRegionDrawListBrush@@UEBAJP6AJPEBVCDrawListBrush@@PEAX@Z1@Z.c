/*
 * XREFs of ?EnumerateBrushes@CEmptyRegionDrawListBrush@@UEBAJP6AJPEBVCDrawListBrush@@PEAX@Z1@Z @ 0x180259E90
 * Callers:
 *     <none>
 * Callees:
    ...
    *(_QWORD *)(v3 + 24) = *((_QWORD *)this + 3);
    ...
    while ( v20 < v19 )
    {
      ...
      *(_OWORD *)(v8 + 32) = v17;
      ...
      if ( v10 < 0 )
      {
        MilInstrumentationCheckHR_MaybeFailFast((__int64)v11, 0LL, 0, v10, 0x91u, 0LL);
        return v12;
      }
