/*
 * XREFs of ?RetireScenario@CTelemetryTouchLatencyAnalysis@@AEAAXPEAUTouchScenarioInfo@1@_N1@Z @ 0x18001DA78
 * Callers:
    ...
    *((_QWORD *)&v10 + 1) = 1LL;
      ...
      && !*(_BYTE *)v5 )
    {
      ...
      if ( hProvider > 5u )
      {
        ...
        TlgWrite((TraceLoggingHProvider)&hProvider, &unk_1802DB1B3, &pActivityId, v24, cData, &pData);
        v23 = hProvider;
      }
      if ( v23 > 4 )
      {
        if ( TlgKeywordOn((TraceLoggingHProvider)&hProvider, 2uLL) )
        {
          ...
          v135 = 2LL;
          v137 = 1LL;
          TlgWrite((TraceLoggingHProvider)&hProvider, &unk_1802DAF90, &pActivityId, 0LL, 0x1Fu, &v81);
          v23 = hProvider;
          v26 = 2LL;
        }
        if ( v23 > 4 )
        {
          if ( TlgKeywordOn((TraceLoggingHProvider)&hProvider, v26) )
          {
            ...
            v151 = 4LL;
            v153 = 4LL;
            TlgWrite((TraceLoggingHProvider)&hProvider, &unk_1802DAC50, &pActivityId, 0LL, 0x27u, &v81);
            v23 = hProvider;
            v30 = 2LL;
          }
          else
          ...
          if ( v23 > 4 && TlgKeywordOn((TraceLoggingHProvider)&hProvider, v30) )
          {
            ...
            v147 = 2LL;
            v149 = 2LL;
            TlgWrite((TraceLoggingHProvider)&hProvider, &unk_1802DA98A, &pActivityId, 0LL, 0x25u, &v81);
            v23 = hProvider;
          }
        }
      }
      v78 = 2;
      if ( v23 > 5 )
        TlgWrite((TraceLoggingHProvider)&hProvider, &unk_1802DA96F, &pActivityId, 0LL, 2u, &pData);
