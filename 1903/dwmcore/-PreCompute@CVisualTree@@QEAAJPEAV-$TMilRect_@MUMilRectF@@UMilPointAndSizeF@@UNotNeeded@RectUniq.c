/*
 * XREFs of ?PreCompute@CVisualTree@@QEAAJPEAV?$TMilRect_@MUMilRectF@@UMilPointAndSizeF@@UNotNeeded@RectUniqueness@@@@@Z @ 0x180055FF0
 * Callers:
 ...
 *     ?PreCompute@COffScreenRenderTarget@@MEAAJXZ @ 0x18019AEF0 (-PreCompute@COffScreenRenderTarget@@MEAAJXZ.c)
 ...
 *     ?CalcAcceleration@CDirtyRegion@@AEAAMAEBUDirtyRegionCachedData@1@0@Z @ 0x1800D156C (-CalcAcceleration@CDirtyRegion@@AEAAMAEBUDirtyRegionCachedData@1@0@Z.c)
 ...
 *     ?SetRedrawRects@CDirtyRegion@@AEAAXXZ @ 0x1801786DC (-SetRedrawRects@CDirtyRegion@@AEAAXXZ.c)
 */
...
__int64 __fastcall CVisualTree::PreCompute(__int64 a1, __int128 *a2)
{
  ...
  {
    v3 = -2003292412;
    MilInstrumentationCheckHR_MaybeFailFast(a1, 0LL, 0, -2003292412, 0x155u, 0LL);
    goto LABEL_75;
  }
  *(_BYTE *)(a1 + 33) = 1;
  ...
  *((_QWORD *)v6 + 49) = v6 + 392;
  ...
  if ( !v12 )
  {
    ...
    {
      MilInstrumentationCheckHR_MaybeFailFast(v121, 0LL, 0, -2147024882, 0x42u, 0LL);
  ...
  if ( !v14 )
  {
    v3 = -2147024882;
    v130 = -2147024882;
    MilInstrumentationCheckHR_MaybeFailFast(v15, 0LL, 0, -2147024882, 0xFu, 0LL);
    MilInstrumentationCheckHR_MaybeFailFast(v128, 0LL, 0, -2147024882, 0xFBu, 0LL);
    v5 = v135;
    goto LABEL_66;
  }
    ...
    while ( 1 )
    {
      if ( *(v49 - 1) > *(v49 - 3) && *v49 > *(v49 - 2) )
      {
        ...
        *(_QWORD *)&v142 = &v6[16 * (unsigned int)v48 + 24];
        if ( (unsigned __int8)TMilRect<float,MilRectF,RectUniqueness::NotNeeded>::DoesIntersectUnsafe(v41 + 24, v142) )
          goto LABEL_87;
        if ( v139 )
          break;
      }
LABEL_83:
    ...
    if ( *v50 >= 0.86000001 )
      goto LABEL_87;
    if ( CalcOvehead((const struct MilRectF *)(v41 + 24), v51) >= 50000.0 )
    {
      LODWORD(v48) = v132;
      v50 = v137;
      goto LABEL_83;
