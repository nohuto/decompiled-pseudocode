/*
 * XREFs of ?StartInertia@CMotion@@IEAAXMM_N0@Z @ 0x18020FFEC
 * Callers:
 ...
 *     ?StartInertia@CPositionMotion@@QEAAXMMMMMM_N0@Z @ 0x180210B54 (-StartInertia@CPositionMotion@@QEAAXMMMMMM_N0@Z.c)
 * Callees:
  ...
  *((_DWORD *)this + 4) = 2;
  if ( dword_18033A240 > 4u )
  {
    if ( TlgKeywordOn((TraceLoggingHProvider)&dword_18033A240, 2uLL) )
    {
      ...
      v33 = 4;
      v36 = 4;
      TlgWrite((TraceLoggingHProvider)&dword_18033A240, &unk_1802DD5CD, 0LL, 0LL, 9u, &pData);
    }
  }
}
