/*
 * XREFs of ?Update@CSecondaryD2DBitmap@@UEAAJAEBV?$TMilRect@IUMilRectU@@UNotNeeded@RectUniqueness@@@@PEAVID2DBitmapCacheSource@@@Z @ 0x18003EB40
 * Callers:
 *     <none>
 * Callees:
 ...
 *     ?HasPrefilterScale@CSecondaryD2DBitmap@@IEBA_NXZ @ 0x18003F030 (-HasPrefilterScale@CSecondaryD2DBitmap@@IEBA_NXZ.c)
...
__int64 __fastcall CSecondaryD2DBitmap::Update(CSecondaryBitmap *this, struct MilRectU *a2, __int64 a3)
{
  ...
  struct tagRECT X; // [rsp+E0h] [rbp+7h]
  ...
  if ( CSecondaryD2DBitmap::HasPrefilterScale((CSecondaryBitmap *)((char *)this - 264)) )
  {
    ...
    *(float *)&v21 = (float)right;
    ...
    if ( LODWORD(v45) < v41.bottom )
      v28 = LODWORD(v45);
    v41.bottom = v28;
    if ( TMilRect<unsigned int,MilRectU,RectUniqueness::NotNeeded>::IsEmpty(&v41) )
    {
  ...
  if ( !(unsigned __int8)CSecondaryBitmap::RectInBounds(this)
    || TMilRect<unsigned int,MilRectU,RectUniqueness::NotNeeded>::IsEmpty(&v41) )
  {
    v13 = -2147024809;
    v29 = -2147024809;
    v31 = 206;
...
LABEL_35:
    v29 = valid;
LABEL_45:
    MilInstrumentationCheckHR_MaybeFailFast(v10, 0LL, 0, v29, v31, 0LL);
    goto LABEL_15;
  }
...
LABEL_7:
  ...
  {
    CD3DResourceManager::ReleaseD3DResourceSourceAfterFrameRetiresInDriver((CD3DResourceManager *)(v8 + 224), v36);
  }
  ...
  CD3DDeviceLevel1::UpdateSubresource((CD3DDeviceLevel1 *)v8, v35, &v41, v38, v34, v32, 0);
