/*
 * XREFs of ?ChoosePixelFormat@CCachedVisualImage@@AEAAXXZ @ 0x18002B4B0
 * Callers:
 ...
 *     ?InitializeViewboxAndRealizationSize@CCachedVisualImage@@AEAAXMM@Z @ 0x1801C941C (-InitializeViewboxAndRealizationSize@CCachedVisualImage@@AEAAXMM@Z.c)
