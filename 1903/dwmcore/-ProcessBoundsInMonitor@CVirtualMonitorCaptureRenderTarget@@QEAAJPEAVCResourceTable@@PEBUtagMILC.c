/*
 * XREFs of ?ProcessBoundsInMonitor@CVirtualMonitorCaptureRenderTarget@@QEAAJPEAVCResourceTable@@PEBUtagMILCMD_VIRTUALMONITORCAPTURERENDERTARGET_BOUNDSINMONITOR@@@Z @ 0x1801A7194
 * Callers:
        ...
        const struct tagMILCMD_VIRTUALMONITORCAPTURERENDERTARGET_BOUNDSINMONITOR *a3)
{
  ...
  *((_DWORD *)this + 158) = v6;
  *((_DWORD *)this + 159) = *((_DWORD *)a3 + 2);
  *((_DWORD *)this + 160) = *((_DWORD *)a3 + 3);
  v7 = *((_QWORD *)this + 82);
  if ( v7 )
  {
    ...
    if ( v8 < 0 )
    {
      MilInstrumentationCheckHR_MaybeFailFast(v9, 0LL, 0, v8, 0xDEu, 0LL);
