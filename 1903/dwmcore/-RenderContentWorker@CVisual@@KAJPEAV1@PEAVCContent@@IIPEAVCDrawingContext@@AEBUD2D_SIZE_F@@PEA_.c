/*
 * XREFs of ?RenderContentWorker@CVisual@@KAJPEAV1@PEAVCContent@@IIPEAVCDrawingContext@@AEBUD2D_SIZE_F@@PEA_NPEAV?$TMilRect_@MUMilRectF@@UMilPointAndSizeF@@UNotNeeded@RectUniqueness@@@@@Z @ 0x180016454
 * Callers:
        ...
        __int64 a8)
{
  ...
  if ( dword_180340294 > *(_DWORD *)(*((_QWORD *)NtCurrentTeb()->ThreadLocalStoragePointer + (unsigned int)tls_index)
                                   + 4LL) )
  {
    Init_thread_header(&dword_180340294);
    if ( dword_180340294 == -1 )
    {
      dword_18033ADF4 = -2147022876;
      Init_thread_footer(&dword_180340294);
    }
  }
    ...
    || !(*(unsigned __int8 (__fastcall **)(__int64, struct IRenderTarget **))(*(_QWORD *)a2 + 256LL))(a2, a5) )
  {
    ...
    if ( v20 < 0 )
    {
      MilInstrumentationCheckHR_MaybeFailFast(v21, &dword_18033ADF0, 2u, v20, 0x11A5u, 0LL);
  ...
  if ( v11 < 0 )
  {
    MilInstrumentationCheckHR_MaybeFailFast(v13, &dword_18033ADF0, 2u, v11, 0x1199u, 0LL);
  }
  else
  {
LABEL_10:
    ...
    MilInstrumentationCheckHR_MaybeFailFast(v16, &dword_18033ADF0, 2u, v15, 0x11A1u, 0LL);
  }
  v19 = v22;
  if ( v22 )
  {
