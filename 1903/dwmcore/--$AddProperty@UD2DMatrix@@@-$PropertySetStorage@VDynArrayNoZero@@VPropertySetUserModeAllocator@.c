/*
 * XREFs of ??$AddProperty@UD2DMatrix@@@?$PropertySetStorage@VDynArrayNoZero@@VPropertySetUserModeAllocator@@@@QEAAJW4DCOMPOSITION_EXPRESSION_TYPE@@PEBUD2DMatrix@@PEAI@Z @ 0x1800BBB98
 * Callers:
...
LABEL_5:
  ...
  *(_DWORD *)(a1 + 24) = v9;
LABEL_6:
  result = DynArrayImpl<0>::Grow(a1 + 32, 1u, 64, 1, 0LL);
  if ( (int)result >= 0 )
  {
    *(_DWORD *)(a1 + 56) += 64;
    v14 = *(_QWORD *)(a1 + 32);
