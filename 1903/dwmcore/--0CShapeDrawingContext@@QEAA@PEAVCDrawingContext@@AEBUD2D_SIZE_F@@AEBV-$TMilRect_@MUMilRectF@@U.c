/*
 * XREFs of ??0CShapeDrawingContext@@QEAA@PEAVCDrawingContext@@AEBUD2D_SIZE_F@@AEBV?$TMilRect_@MUMilRectF@@UMilPointAndSizeF@@UNotNeeded@RectUniqueness@@@@AEBVCMILMatrix@@@Z @ 0x1802530EC
 * Callers:
 ...
 *     ?Clear@CMatrixStack2D@@QEAAXXZ @ 0x18025FA00 (-Clear@CMatrixStack2D@@QEAAXXZ.c)
 */
