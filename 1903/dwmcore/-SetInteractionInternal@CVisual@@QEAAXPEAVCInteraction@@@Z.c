/*
 * XREFs of ?SetInteractionInternal@CVisual@@QEAAXPEAVCInteraction@@@Z @ 0x18002B2C8
 * Callers:
...
void __fastcall CVisual::SetInteractionInternal(CVisual *this, struct CInteraction *a2)
{
  ...
  if ( a2 )
  {
    ...
    {
      *(_QWORD *)CSparseAlignedStorage<8,8>::AllocatedStorage::ReserveSlot((char *)this + 224, 10LL) = a2;
    }
  }
  else if ( v5 )
  {
    *v3 &= ~0x400000u;
    Slot = CSparseAlignedStorage<8,8>::AllocatedStorage::FindSlot(v3, 10LL);
    if ( Slot < *(_DWORD *)(v8 + 4) )
      *(_BYTE *)(Slot + v8 + 8) = v7;
  }
}
