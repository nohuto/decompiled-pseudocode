/*
 * XREFs of __tailMerge_ext_ms_win_ntuser_private_l1_1_0_dll @ 0x1800E9148
 * Callers:
 *     __imp_load_UpdateWindowInputSinkHints @ 0x1800E913C (__imp_load_UpdateWindowInputSinkHints.c)
 * Callees:
