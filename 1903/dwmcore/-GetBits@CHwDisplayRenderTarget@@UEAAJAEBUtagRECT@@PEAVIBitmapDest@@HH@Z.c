/*
 * XREFs of ?GetBits@CHwDisplayRenderTarget@@UEAAJAEBUtagRECT@@PEAVIBitmapDest@@HH@Z @ 0x1800B1640
 * Callers:
 *     ?GetBits@CHwDisplayRenderTarget@@WJA@EAAJAEBUtagRECT@@PEAVIBitmapDest@@HH@Z @ 0x1800EC7E0 (-GetBits@CHwDisplayRenderTarget@@WJA@EAAJAEBUtagRECT@@PEAVIBitmapDest@@HH@Z.c)
 * Callees:
        ...
        int a5)
{
  ...
  if ( (*((unsigned __int8 (__fastcall **)(CD3DDeviceLevel1 **))*this + 4))(this) )
  {
    ...
    {
      v6 = -2147024891;
      MilInstrumentationCheckHR_MaybeFailFast(v11, 0LL, 0, 0x80070005, 0x101u, 0LL);
      goto LABEL_5;
    }
    ...
    if ( Bits < 0 )
    {
      v17 = 279;
LABEL_25:
      MilInstrumentationCheckHR_MaybeFailFast(v13, 0LL, 0, Bits, v17, 0LL);
      goto LABEL_5;
    }
    if ( v22 == *((_QWORD *)this[19] + 89) && v18 == *((_DWORD *)this + 12) )
    {
      v16 = v19;
      if ( v19 )
      {
      ...
      {
        Bits = CD3DDeviceLevel1::CopyPixelsToSlicerBitmap(this[19], v21, a4, a5);
        v6 = Bits;
        if ( Bits >= 0 )
          goto LABEL_5;
        v17 = 294;
