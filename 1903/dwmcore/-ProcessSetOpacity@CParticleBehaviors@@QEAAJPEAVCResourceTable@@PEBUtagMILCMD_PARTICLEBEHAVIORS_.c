/*
 * XREFs of ?ProcessSetOpacity@CParticleBehaviors@@QEAAJPEAVCResourceTable@@PEBUtagMILCMD_PARTICLEBEHAVIORS_SETOPACITY@@@Z @ 0x1801E8C24
 * Callers:
...
__int64 __fastcall CParticleBehaviors::ProcessSetOpacity(
        CParticleBehaviors *this,
        struct CResourceTable *a2,
        const struct tagMILCMD_PARTICLEBEHAVIORS_SETOPACITY *a3)
{
