/*
 * XREFs of ?AllocateVertex@MeshGraph@Mesh@@QEAAJHPEAPEAUMeshVertex@2@@Z @ 0x1801B9294
 * Callers:
...
__int64 __fastcall Mesh::MeshGraph::AllocateVertex(Mesh::MeshGraph *this, int a2, struct Mesh::MeshVertex **a3)
{
  ...
  if ( (int)v5 + a2 > *((_QWORD *)this + 2) )
    return 2147942414LL;
  v8 = (struct Mesh::MeshVertex *)gsl::span<Mesh::MeshVertex,-1>::operator[]((unsigned __int64 *)this + 2, v5);
  *((_DWORD *)this + 8) += a2;
  *a3 = v8;
  return 0LL;
}
