 ...
 *     ?_Change_array@?$vector@UCompositionStatsPerMonitor@CCompositionSwapchainStatistics@@V?$allocator@UCompositionStatsPerMonitor@CCompositionSwapchainStatistics@@@std@@@std@@AEAAXQEAUCompositionStatsPerMonitor@CCompositionSwapchainStatistics@@_K1@Z @ 0x180265604 (-_Change_array@-$vector@UCompositionStatsPerMonitor@CCompositionSwapchainStatistics@@V-$allocato.c)
 */
