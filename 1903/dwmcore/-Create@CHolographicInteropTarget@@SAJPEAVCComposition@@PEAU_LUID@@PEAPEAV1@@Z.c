/*
 * XREFs of ?Create@CHolographicInteropTarget@@SAJPEAVCComposition@@PEAU_LUID@@PEAPEAV1@@Z @ 0x1802455BC
 * Callers:
        ...
        struct CHolographicInteropTarget **a3)
{
  ...
  {
    v9 = -2147024882;
    MilInstrumentationCheckHR_MaybeFailFast(v7, 0LL, 0, 0x8007000E, 0x15u, 0LL);
  }
  return v9;
}
