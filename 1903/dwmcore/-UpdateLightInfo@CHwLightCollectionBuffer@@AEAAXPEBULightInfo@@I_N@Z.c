/*
 * XREFs of ?UpdateLightInfo@CHwLightCollectionBuffer@@AEAAXPEBULightInfo@@I_N@Z @ 0x180009594
 * Callers:
 ...
 * Callees:
 *     ?Transpose@CMILMatrix@@QEAAXXZ @ 0x18000A468 (-Transpose@CMILMatrix@@QEAAXXZ.c)
  ...
  *((_QWORD *)this + 64) = 0LL;
  if ( a3 )
  {
    ...
    do
    {
      ...
      {
        v7 = 1;
        *(__m128 *)((char *)this + 504) = _mm_add_ps(*(__m128 *)((char *)this + 504), *(__m128 *)(v8 - 8));
      }
      v8 += 240;
      --v9;
    }
