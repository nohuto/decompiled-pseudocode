/*
 * XREFs of ?ShouldPresent@CHwDisplayRenderTarget@@MEBAJ_NPEA_NPEAI@Z @ 0x1800BAC50
 * Callers:
        ...
        unsigned int *a4)
{
  ...
  *a4 = 0;
  ...
  if ( v6 )
  {
    ...
    if ( v9 < 0 )
    {
      MilInstrumentationCheckHR_MaybeFailFast((__int64)this, &dword_1802C0180, 2u, v9, 0x302u, 0LL);
    }
    else if ( !(*(unsigned __int8 (__fastcall **)(CHwDisplayRenderTarget *))(*(_QWORD *)this + 32LL))(this) )
    {
      MilInstrumentationCheckHR_MaybeFailFast(v10, &dword_1802C0180, 2u, 0x88980006, 0x30Cu, 0LL);
      return 0LL;
    }
  }
  else
