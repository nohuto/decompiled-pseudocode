/*
 * XREFs of ?DrawBitmapWithPartialOcclusionAsDrawList@CDrawingContext@@AEAAJPEAVIImageSource@@AEBUMilRectF@@1HW4Enum@MilCompositingMode@@_N@Z @ 0x180050734
 * Callers:
        ...
        char a7)
{
  ...
  *(_OWORD *)&v53[1] = *a3;
  ...
  if ( !(unsigned __int8)CMILMatrix::Is2DAxisAlignedPreserving<1>(v20) )
    goto LABEL_35;
  if ( *v14 )
  ...
  CScopedClipStack::GetClipBoundsWorld(a1 + 1008, &v54);
  v23 = *(float *)&v53[1];
