/*
 * XREFs of ?WaitForVBlank@CHolographicInteropTarget@@UEAAJPEAX@Z @ 0x180246320
 * Callers:
 *     <none>
 * Callees:
 *     ?WaitForVBlank@CHolographicManager@@QEAAJXZ @ 0x180242610 (-WaitForVBlank@CHolographicManager@@QEAAJXZ.c)
 */
