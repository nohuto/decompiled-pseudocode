/*
 * XREFs of ?Init@CD3DTexture@@IEAAJPEAVCD3DResourceManager@@PEAUID3D11Texture2D@@I@Z @ 0x1800B2824
 * Callers:
        ...
        unsigned int a4)
{
  ...
  *((_DWORD *)this + 46) = v11;
  ...
  {
    v10 = -2147467259;
    MilInstrumentationCheckHR_MaybeFailFast(v9, 0LL, 0, 0x80004005, 0x6Fu, 0LL);
    return v10;
  }
  *((_DWORD *)this + 43) = a4;
  ...
  {
    v10 = -2147467259;
    MilInstrumentationCheckHR_MaybeFailFast(v9, 0LL, 0, 0x80004005, 0x75u, 0LL);
    return v10;
  }
