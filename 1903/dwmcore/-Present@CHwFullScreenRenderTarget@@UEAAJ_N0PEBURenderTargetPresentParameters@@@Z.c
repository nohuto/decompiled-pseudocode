/*
 * XREFs of ?Present@CHwFullScreenRenderTarget@@UEAAJ_N0PEBURenderTargetPresentParameters@@@Z @ 0x1800B7140
 * Callers:
...
LABEL_30:
  ...
  if ( v53 )
  {
    ...
    else
    {
      ...
      {
        FastRegion::CRegion::Copy((int **)(v20 + 272), v18);
        if ( CSwapChainBase::TryToOrderMetaData((CSwapChainBase *)v20) )
          FastRegion::CRegion::Subtract((FastRegion::CRegion *)(v20 + 200), (const struct CRegion *)v18);
      }
      v21 = v48;
      v45 = (int)v54;
      v15 = (*(__int64 (__fastcall **)(__int64, char *, _QWORD, _QWORD))(*(_QWORD *)v20 + 328LL))(
              v20,
              (char *)this + 128,
              (unsigned int)v50,
              v48);
      ...
      **(_DWORD **)(v20 + 272) = 0;
      *(_DWORD *)(v20 + 368) = 0;
      DynArrayImpl<0>::ShrinkToSize(v20 + 344, 48LL);
      if ( (*(unsigned __int8 (__fastcall **)(__int64))(*(_QWORD *)v20 + 80LL))(v20)
        && (Microsoft_Windows_Dwm_CoreEnableBits & 2) != 0 )
      {
        McTemplateU0pp(v22, &EVTDESC_REMOTEAPP_METADATA_STATS, v20 + 344, *(unsigned int *)(v20 + 368));
      }
      if ( v15 < 0 )
      {
      ...
      if ( v15 == -2005532292 || v15 == -2147024882 || (v23 = 0, v15 == -2005270523) )
      {
        ...
        if ( AdapterHwProtectedEntityCount )
        {
          ...
          if ( v14 )
          {
            ...
            if ( v14 != IsHardwareProtectionDisabled && (Microsoft_Windows_Dwm_CoreEnableBits & 0x20) != 0 )
            {
              McTemplateU0d(
    ...
    if ( v15 >= 0 || v23 >= 0 )
    {
      if ( TranslateDXGIorD3DErrorInContext(v15, 1, &v50) )
      {
        v15 = v50;
        if ( v50 < 0 )
        {
