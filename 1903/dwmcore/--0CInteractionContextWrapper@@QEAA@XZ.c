/*
 * XREFs of ??0CInteractionContextWrapper@@QEAA@XZ @ 0x1800C1D58
 * Callers:
 ...
 *     ??0CInteractionContextTransformHelper@@QEAA@XZ @ 0x1800C1F10 (--0CInteractionContextTransformHelper@@QEAA@XZ.c)
 */
