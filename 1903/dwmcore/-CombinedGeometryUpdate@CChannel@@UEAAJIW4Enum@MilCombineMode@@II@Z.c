/*
 * XREFs of ?CombinedGeometryUpdate@CChannel@@UEAAJIW4Enum@MilCombineMode@@II@Z @ 0x180157AC0
 * Callers:
 *     <none>
 * Callees:
        ...
        unsigned int a5)
{
  ...
  CChannel::CheckHandle(a1, a2, 24);
  CChannel::CheckOptionalHandle(a1, a4, 62LL);
  v9 = a5;
  CChannel::CheckOptionalHandle(a1, a5, 62LL);
  v12[0] = 552;
  v12[1] = a2;
  v12[2] = a3;
  v12[3] = a4;
