/*
 * XREFs of ?Update@CPointerDeviceCache@@SAAEBUDEVICE_INFO@@PEAVCManipulationFrame@@@Z @ 0x1802370C8
 * Callers:
 ...
 *     ?erase@?$_Tree@V?$_Tmap_traits@PEAXUDEVICE_INFO@@U?$less@PEAX@std@@V?$allocator@U?$pair@QEAXUDEVICE_INFO@@@std@@@3@$0A@@std@@@std@@QEAA_KAEBQEAX@Z @ 0x180237150 (-erase@-$_Tree@V-$_Tmap_traits@PEAXUDEVICE_INFO@@U-$less@PEAX@std@@V-$allocator@U-$_ea_180237150.c)
 */
...
const struct DEVICE_INFO *__fastcall CPointerDeviceCache::Update(struct CManipulationFrame *this)
{
  ...
  if ( CManipulationFrame::IsMousewheelFrame(this) )
    CPointerDeviceCache::s_rcMouseRegion = (struct tagRECT)*((_OWORD *)this + 23);
  if ( (_BYTE)v6 )
  {
    v9 = *((_QWORD *)this + 20);
  ...
  return CPointerDeviceCache::Query(*((_QWORD *)this + 20), v4, v6, v7);
}
