/*
 * XREFs of ?UpdateOnManipulationThreadWithoutDelta@CManipulation@@UEAAJAEBUUpdateOnManipulationThreadWithoutDeltaArgs@@@Z @ 0x1801E3C80
 * Callers:
 *     <none>
 * Callees:
 *     ?MilInstrumentationCheckHR_MaybeFailFast@@YAXKQEBJIJIPEAX@Z @ 0x1800969E0 (-MilInstrumentationCheckHR_MaybeFailFast@@YAXKQEBJIJIPEAX@Z.c)
 *     ?_ResetManipulationThreadDataIfNecessary@CManipulation@@AEAAXW4InteractionState@@@Z @ 0x1801E4024 (-_ResetManipulationThreadDataIfNecessary@CManipulation@@AEAAXW4InteractionState@@@Z.c)
  ...
  *(_DWORD *)(v6 + 52) = 1065353216;
    ...
    || ((*(_BYTE *)(v7 + 16) ^ *(_BYTE *)(v6 + 188)) & 2) != 0 )
  {
    ...
    *(_BYTE *)(v6 + 188) ^= (*(_BYTE *)(v7 + 16) ^ *(_BYTE *)(v6 + 188)) & 2;
    ...
    v3 = v8;
    if ( v8 < 0 )
      MilInstrumentationCheckHR_MaybeFailFast(v9, 0LL, 0, v8, 0xAFu, 0LL);
  }
  return v3;
}
