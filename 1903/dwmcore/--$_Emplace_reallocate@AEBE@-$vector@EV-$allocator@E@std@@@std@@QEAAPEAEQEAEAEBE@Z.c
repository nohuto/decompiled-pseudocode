/*
 * XREFs of ??$_Emplace_reallocate@AEBE@?$vector@EV?$allocator@E@std@@@std@@QEAAPEAEQEAEAEBE@Z @ 0x18007B534
 * Callers:
 *     _anonymous_namespace_::PackedStringArrayBuilder::Append @ 0x18007C070 (_anonymous_namespace_--PackedStringArrayBuilder--Append.c)
 ...
 *     _anonymous_namespace_::PackedStringArrayBuilder::PackedStringArrayBuilder @ 0x1800D5B3C (_anonymous_namespace_--PackedStringArrayBuilder--PackedStringArrayBuilder.c)
 * Callees:
 ...
 *     ?_Change_array@?$vector@EV?$allocator@E@std@@@std@@AEAAXQEAE_K1@Z @ 0x1800786A8 (-_Change_array@-$vector@EV-$allocator@E@std@@@std@@AEAAXQEAE_K1@Z.c)
 *     ?_Calculate_growth@?$vector@EV?$allocator@E@std@@@std@@AEBA_K_K@Z @ 0x18007870C (-_Calculate_growth@-$vector@EV-$allocator@E@std@@@std@@AEBA_K_K@Z.c)
