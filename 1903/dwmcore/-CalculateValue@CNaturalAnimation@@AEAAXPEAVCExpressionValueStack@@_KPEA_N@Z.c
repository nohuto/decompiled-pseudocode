/*
 * XREFs of ?CalculateValue@CNaturalAnimation@@AEAAXPEAVCExpressionValueStack@@_KPEA_N@Z @ 0x1801E50FC
 * Callers:
 ...
 *     ?CalculateAnimationElapsedTimeInSeconds@CNaturalAnimation@@AEAAMXZ @ 0x1801E508C (-CalculateAnimationElapsedTimeInSeconds@CNaturalAnimation@@AEAAMXZ.c)
 ...
 *     ?Update@CVector3Force@@QEAA?AUD2DVector3@@MPEAVCExpressionValueStack@@_K@Z @ 0x18022140C (-Update@CVector3Force@@QEAA-AUD2DVector3@@MPEAVCExpressionValueStack@@_K@Z.c)
    ...
    if ( v8 == 18 || v8 == 35 || v8 == 52 )
    {
      ...
      *a4 = v14;
      ...
      if ( *(int *)(*((_QWORD *)this + 38) + 4LL) < 0 )
      {
        ...
        {
          if ( TlgKeywordOn((TraceLoggingHProvider)&dword_18033A240, 4uLL) )
          {
            ...
            v56 = a4;
            v57 = 1;
            TlgWrite((TraceLoggingHProvider)&dword_18033A240, &unk_1802DCA10, 0LL, 0LL, 0xBu, &pData);
          }
        }
      }
    }
