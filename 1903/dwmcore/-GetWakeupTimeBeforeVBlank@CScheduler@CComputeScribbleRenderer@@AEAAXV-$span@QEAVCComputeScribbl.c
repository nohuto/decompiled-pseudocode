/*
 * XREFs of ?GetWakeupTimeBeforeVBlank@CScheduler@CComputeScribbleRenderer@@AEAAXV?$span@QEAVCComputeScribble@@$0?0@gsl@@PEAM1@Z @ 0x1801B7354
 * Callers:
 ...
 *     ??$min@M@std@@YAAEBMAEBM0@Z @ 0x1800EA984 (--$min@M@std@@YAAEBMAEBM0@Z.c)
