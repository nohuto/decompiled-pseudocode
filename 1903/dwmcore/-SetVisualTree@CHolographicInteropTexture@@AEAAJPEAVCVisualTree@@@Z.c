/*
 * XREFs of ?SetVisualTree@CHolographicInteropTexture@@AEAAJPEAVCVisualTree@@@Z @ 0x180247AD8
 * Callers:
...
__int64 __fastcall CHolographicInteropTexture::SetVisualTree(CHolographicInteropTexture **this, struct CVisualTree *a2)
{
  ...
  if ( a2 != this[10] )
  {
    ...
    if ( a2 )
    {
      ...
      if ( v5 < 0 )
      {
        MilInstrumentationCheckHR_MaybeFailFast(v6, 0LL, 0, v5, 0xF9u, 0LL);
      }
      else
      {
        *((_BYTE *)this + 135) = 1;
...
LABEL_9:
          ...
          {
            MilInstrumentationCheckHR_MaybeFailFast(v12, 0LL, 0, PrimaryHMonitor, 0x104u, 0LL);
          }
          else
          {
            ...
            v2 = v13;
            if ( v13 < 0 )
              MilInstrumentationCheckHR_MaybeFailFast(v14, 0LL, 0, v13, 0x105u, 0LL);
          }
        }
      }
    }
