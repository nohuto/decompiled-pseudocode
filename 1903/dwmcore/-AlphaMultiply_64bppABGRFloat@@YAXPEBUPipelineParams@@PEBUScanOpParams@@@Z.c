/*
 * XREFs of ?AlphaMultiply_64bppABGRFloat@@YAXPEBUPipelineParams@@PEBUScanOpParams@@@Z @ 0x180226580
 * Callers:
 *     <none>
 * Callees:
...
void __fastcall AlphaMultiply_64bppABGRFloat(const struct PipelineParams *a1, const struct ScanOpParams *a2)
{
  ...
  if ( v2 )
  {
    ...
    do
    {
      ...
      if ( v4 != CFloat16::operator float((unsigned __int16 *)&word_18033BDA4) )
      {
