/*
 * XREFs of ?ProcessSetViewData@CHolographicExclusiveView@@QEAAJPEAVCResourceTable@@PEBUtagMILCMD_HOLOGRAPHICEXCLUSIVEVIEW_SETVIEWDATA@@@Z @ 0x1802451CC
 * Callers:
 ...
 *     ?PublishPresentData@CHolographicExclusiveView@@QEAAXXZ @ 0x180245290 (-PublishPresentData@CHolographicExclusiveView@@QEAAXXZ.c)
