/*
 * XREFs of ?UpdateTimes@CPartitionVerticalBlankScheduler@@EEAAJXZ @ 0x180096CB0
 * Callers:
 ...
 *     ?CalculateEffectiveRefreshRates@CRateInfo@@QEAAXIPEBUDXGI_FRAME_STATISTICS_DWM@@0@Z @ 0x180098EE0 (-CalculateEffectiveRefreshRates@CRateInfo@@QEAAXIPEBUDXGI_FRAME_STATISTICS_DWM@@0@Z.c)
 ...
 *     ?ComputeLastVSyncFromPreviousFrame@CPartitionVerticalBlankScheduler@@AEAAXXZ @ 0x1800D6E00 (-ComputeLastVSyncFromPreviousFrame@CPartitionVerticalBlankScheduler@@AEAAXXZ.c)
...
LABEL_4:
    ...
    *(_QWORD *)(v11 + 64) = *(_QWORD *)(v12 + 64);
    ...
    {
      MilInstrumentationCheckHR_MaybeFailFast(v16, &dword_1802C02F8, 2u, PresentStatistics, 0xB7Au, 0LL);
      MilInstrumentationCheckHR_MaybeFailFast(v68, &dword_1802C0488, 2u, v18, 0x328u, 0LL);
    }
