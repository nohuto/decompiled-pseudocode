/*
 * XREFs of ?CalcOvehead@@YAMAEBUMilRectF@@0@Z @ 0x1800537A0
 * Callers:
...
float __fastcall CalcOvehead(const struct MilRectF *a1, const struct MilRectF *a2)
{
  ...
  v18 = v4;
  v19 = v5;
  TMilRect<float,MilRectF,RectUniqueness::NotNeeded>::UnionUnsafe(&v16, &v15);
  v10 = v6[1];
  v11 = v6[2];
  v12 = v6[3];
  if ( *v6 > v2 )
  ...
  return fmaxf(
         ...
         - (float)((float)((float)((float)(v7[2] - *v7) * (float)(v7[3] - v7[1]))
