/*
 * XREFs of ?AddDirtyRect@CBitmap@@UEAAJPEBUtagRECT@@@Z @ 0x1800C9420
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall CBitmap::AddDirtyRect(CBitmap *this, struct tagRECT *a2)
{
  ...
  if ( a2 )
  {
    ...
    {
      v4 = -2147024809;
      MilInstrumentationCheckHR_MaybeFailFast((__int64)this, 0LL, 0, 0x80070057, 0x1CFu, 0LL);
      goto LABEL_9;
    }
  }
  if ( !*((_DWORD *)this + 14) )
    ...
    if ( v11 >= 5 )
    {
      do
      {
        ...
        *((_DWORD *)this + 46) = v11 - 1;
        TMilRect<unsigned int,MilRectU,RectUniqueness::NotNeeded>::IsEmpty(v15);
      ...
      while ( v11 > 1 );
      TMilRect<unsigned int,MilRectU,RectUniqueness::NotNeeded>::IsEmpty(*((_DWORD **)this + 22));
    ...
    else
    {
      ...
      if ( !v12 )
      {
        ...
        *((_QWORD *)this + 22) = v12;
        ...
        {
          v4 = -2147024882;
          MilInstrumentationCheckHR_MaybeFailFast(v14, 0LL, 0, 0x8007000E, 0x20Eu, 0LL);
          goto LABEL_9;
        }
        v11 = *((_DWORD *)this + 46);
      }
