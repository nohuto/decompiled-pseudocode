/*
 * XREFs of ?HitTestPoint@CHitTestContext@@QEAAJAEBUHitTestPointRequest@1@AEAUHitTestPointResult@1@@Z @ 0x180086418
 * Callers:
 ...
 *     ?GetInputType@CInputSinkStruct@@SA?AW4CompositionInputType@@W4InputType@@@Z @ 0x180020934 (-GetInputType@CInputSinkStruct@@SA-AW4CompositionInputType@@W4InputType@@@Z.c)
 ...
 *     ?HasInputSink@CInteraction@@QEBA_NXZ @ 0x180086860 (-HasInputSink@CInteraction@@QEBA_NXZ.c)
 ...
 *     ?AdjustInputTypeForInteraction@CHitTestContext@@AEBA?AW4InputType@@W42@PEBVCInteraction@@@Z @ 0x1800868C8 (-AdjustInputTypeForInteraction@CHitTestContext@@AEBA-AW4InputType@@W42@PEBVCInteraction@@@Z.c)
        ...
        struct CHitTestContext::HitTestPointResult *a3)
{
  ...
  __int64 InputHandle; // [rsp+40h] [rbp-59h]
  ...
  if ( (Microsoft_Windows_Dwm_CoreEnableBits & 0x1000) != 0 )
    McTemplateU0xqq(
      ...
      *((_DWORD *)a2 + 2),
      *((_DWORD *)a2 + 3));
  CHitTestContext::EvaluateHitTestAttributesAndInputType(
    (__int64)this,
    *((unsigned int *)a2 + 5),
    *((unsigned int *)a2 + 4));
  v42 = *((_DWORD *)this + 52);
  ...
  if ( (unsigned int)(*((_DWORD *)this + 24) - 2) <= 4 )
  {
    ...
    while ( v8 != v9 )
    {
      v41 = (const struct CInteraction *)v8[1];
...
LABEL_31:
    ...
    if ( !InputHandle && v23 && (!v48 || (unsigned int)CVisual::GetInputQueueType(v47)) )
    {
      ...
      CVisual::GetWorldTransform(v47, *(_QWORD *)a2, 4LL, &v50, 0LL, 0LL);
    }
    if ( v45 < *(_DWORD *)a3 )
    {
      v24 = *((_QWORD *)v21 + 12);
...
LABEL_12:
  ...
  *((_QWORD *)a3 + 3) = v13;
  ...
  {
    v15 = v31 | 0x10000000;
    MilInstrumentationCheckHR_MaybeFailFast(v32, &dword_1802C02F0, 1u, v31 | 0x10000000, 0x29Fu, 0LL);
  }
  else
  {
    v33 = *((_DWORD *)a2 + 4) == 4;
