/*
 * XREFs of ?GetInputEffectForAtlasedSurface@CFilterEffect@@AEAAJPEAVID2DContext@@PEAVID2DContextOwner@@AEBUtagRECT@@PEAVCCompositionSurfaceBitmap@@PEAPEAUID2D1Effect@@@Z @ 0x1801CCFD8
 * Callers:
        ...
        struct ID2D1Effect **a6)
{
    ...
    else
    {
      ...
      else
      {
        ...
        *((float *)&v27 + 3) = bottom;
        ...
        if ( v19 < 0 )
        {
          MilInstrumentationCheckHR_MaybeFailFast(v20, 0LL, 0, v19, 0x33Eu, 0LL);
          goto LABEL_13;
        }
  ...
  MilInstrumentationCheckHR_MaybeFailFast(v11, 0LL, 0, D2DBitmapRealizationForContextOwner, v23, 0LL);
LABEL_13:
  if ( v24 )
