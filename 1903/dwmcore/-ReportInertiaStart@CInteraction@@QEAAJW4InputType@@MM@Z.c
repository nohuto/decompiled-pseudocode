/*
 * XREFs of ?ReportInertiaStart@CInteraction@@QEAAJW4InputType@@MM@Z @ 0x1801D7A74
 * Callers:
 ...
 *     _anonymous_namespace_::InputTypeToInertiaSourceType @ 0x1801D73B4 (_anonymous_namespace_--InputTypeToInertiaSourceType.c)
 */
