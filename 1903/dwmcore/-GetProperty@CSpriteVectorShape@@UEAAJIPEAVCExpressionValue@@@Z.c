/*
 * XREFs of ?GetProperty@CSpriteVectorShape@@UEAAJIPEAVCExpressionValue@@@Z @ 0x1801FB2F0
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall CSpriteVectorShape::GetProperty(CSpriteVectorShape *this, int a2, struct CExpressionValue *a3)
{
  ...
  {
    v4 = -2147024809;
    MilInstrumentationCheckHR_MaybeFailFast(v6, 0LL, v7, 0x80070057, 0x46u, (void *)(v7 & v10));
  }
  return v4;
}
