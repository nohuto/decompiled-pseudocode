/*
 * XREFs of ??$SetProperty@UD2DVector2@@@DataSourcePropertySet@@QEAAJIPEBUD2DVector2@@W4DCOMPOSITION_EXPRESSION_TYPE@@@Z @ 0x180197320
 * Callers:
...
__int64 __fastcall DataSourcePropertySet::SetProperty<D2DVector2>(_QWORD *a1, int a2, _QWORD *a3)
{
  ...
  if ( v12 == a1[1] )
  {
    v5 = PropertySetStorage<DynArrayNoZero,PropertySetUserModeAllocator>::AddProperty<D2DVector2>(
           (__int64)(a1 + 8),
           35,
           a3,
           &v14);
  ...
  else
  {
    ...
    *(_QWORD *)((*(_DWORD *)(v9 + 8 * v8 + 4) & 0x1FFFFFFF) + a1[12]) = *a3;
  }
  return 0LL;
}
