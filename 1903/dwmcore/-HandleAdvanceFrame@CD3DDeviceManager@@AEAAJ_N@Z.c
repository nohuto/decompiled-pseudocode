/*
 * XREFs of ?HandleAdvanceFrame@CD3DDeviceManager@@AEAAJ_N@Z @ 0x180058B80
 * Callers:
...
__int64 __fastcall CD3DDeviceManager::HandleAdvanceFrame(CD3DDeviceManager *this, char a2)
{
  ...
  if ( (_DWORD)qword_180340430 )
  {
    do
    {
      ...
      v54 = v2;
      v4 = 0;
      v5 = *(_QWORD *)(qword_1803403E0 + 24 * v2);
...
LABEL_21:
      ...
      *(_BYTE *)(v5 + 1161) = 1;
      ...
      else
      {
        ...
        for ( v51[0] = v28;
              detail::basic_iterator<CD3DDeviceLevel1::CUnpinResource>::operator!=(&v52, v51);
...
LABEL_79:
  ...
  if ( dword_1803403F8 )
  {
    do
    {
      if ( v49 <= (unsigned int)qword_180340430 )
        break;
