/*
 * XREFs of ?GetPrimaryYUVBitmapRealizationNoRef@CBindInfo@CGlobalCompositionSurfaceInfo@@AEBAPEAVCDxHandleYUVBitmapRealization@@XZ @ 0x18025CFD0
 * Callers:
...
struct CDxHandleYUVBitmapRealization *__fastcall CGlobalCompositionSurfaceInfo::CBindInfo::GetPrimaryYUVBitmapRealizationNoRef(
