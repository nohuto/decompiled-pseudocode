/*
 * XREFs of ?FullyContains@CCpuClip@@QEBA_NAEBV?$TMilRect_@MUMilRectF@@UMilPointAndSizeF@@UNotNeeded@RectUniqueness@@@@PEBUD2D_MATRIX_3X2_F@@@Z @ 0x180087F84
 * Callers:
...
bool __fastcall CCpuClip::FullyContains(__int64 a1, __int128 *a2, __int64 a3)
{
  char v3; // bl
  CMILMatrix *v7; // r14
  CShape *v8; // r15
...
LABEL_5:
  if ( v8 )
    return CCpuClip::RectangleShapeFullyContains((__int64)v8, a2, v7);
  return v3;
}
