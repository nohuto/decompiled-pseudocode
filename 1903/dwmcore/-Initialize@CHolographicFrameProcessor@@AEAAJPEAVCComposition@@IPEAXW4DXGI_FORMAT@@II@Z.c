/*
 * XREFs of ?Initialize@CHolographicFrameProcessor@@AEAAJPEAVCComposition@@IPEAXW4DXGI_FORMAT@@II@Z @ 0x18024A75C
 * Callers:
 ...
 *     ?AddWin32kInteropTexture@CHolographicManager@@QEAA_NPEAUIHolographicWin32kInteropTexture@@PEAX@Z @ 0x180241084 (-AddWin32kInteropTexture@CHolographicManager@@QEAA_NPEAUIHolographicWin32kInteropTexture@@PEAX@Z.c)
 */
  ...
  *((_DWORD *)this + 28) = (_DWORD)a3;
  ...
  if ( v11 != (RTL_SRWLOCK *)v10 )
  {
    ...
    *((_QWORD *)this + 6) = v10;
    ...
    if ( v12 )
    {
      CDirtyRegion::Release((CDirtyRegion *)&v12[1]);
      v11 = (RTL_SRWLOCK *)*((_QWORD *)this + 6);
    }
  }
  if ( v11 )
  ...
  {
    v8 = -2147418113;
    MilInstrumentationCheckHR_MaybeFailFast(0LL, 0LL, 0, 0x8000FFFF, 0x39u, 0LL);
  }
