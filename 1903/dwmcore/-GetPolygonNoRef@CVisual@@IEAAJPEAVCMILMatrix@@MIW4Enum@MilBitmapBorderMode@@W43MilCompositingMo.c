/*
 * XREFs of ?GetPolygonNoRef@CVisual@@IEAAJPEAVCMILMatrix@@MIW4Enum@MilBitmapBorderMode@@W43MilCompositingMode@@W43MilBitmapInterpolationMode@@_N44PEAPEAVCPolygon@@@Z @ 0x1801C32E4
 * Callers:
        ...
        __int64 *a11)
{
  ...
  {
    v16 = (*(__int64 (__fastcall **)(__int64, _QWORD, __int128 *))(*(_QWORD *)a1 + 232LL))(a1, 0LL, &v40);
    v15 = v16;
    if ( v16 < 0 )
    {
      v33 = 6543;
...
LABEL_48:
  ...
  (*(void (__fastcall **)(__int64, __int128 *, __int128 *))(*(_QWORD *)a1 + 328LL))(a1, &v40, &v40);
  ...
  *(_QWORD *)&v34 = v40;
  ...
  if ( (unsigned int)(HIDWORD(v45) + 1) >= HIDWORD(v45) )
  {
    ...
    v15 = v22;
    if ( v22 < 0 )
      MilInstrumentationCheckHR_MaybeFailFast(v17, 0LL, 0, v22, 0xC3u, 0LL);
  }
  else
  {
    v15 = -2147024362;
...
LABEL_16:
  ...
  *(_QWORD *)&v35 = __PAIR64__(DWORD1(v40), DWORD2(v40));
  ...
  if ( v20 + 1 >= v20 )
  {
    ...
    v15 = v25;
    if ( v25 < 0 )
      MilInstrumentationCheckHR_MaybeFailFast(v17, 0LL, 0, v25, 0xC3u, 0LL);
  }
  else
  {
    v15 = -2147024362;
...
LABEL_24:
  ...
  *(_QWORD *)&v36 = *((_QWORD *)&v40 + 1);
  ...
  if ( v23 + 1 >= v23 )
  {
    ...
    v15 = v28;
    if ( v28 < 0 )
      MilInstrumentationCheckHR_MaybeFailFast(v17, 0LL, 0, v28, 0xC3u, 0LL);
  }
  else
  {
    v15 = -2147024362;
...
LABEL_47:
  ...
  if ( v26 + 1 > (unsigned int)v45 )
  {
    ...
    v15 = v31;
    if ( v31 < 0 )
      MilInstrumentationCheckHR_MaybeFailFast(v17, 0LL, 0, v31, 0xC3u, 0LL);
    goto LABEL_38;
  }
  v29 = v43[0];
  v30 = 5LL * v26;
  ...
  *(_DWORD *)(v29 + 4 * v30 + 16) = v42;
  HIDWORD(v45) = v26 + 1;
LABEL_39:
  v16 = CPolygon::Create((__int64)v43, a1, *(_QWORD *)(a1 + 256), a2, SLODWORD(a3), a4, a5, a6, a7, a8, a9, &v39, &v38);
  v15 = v16;
  if ( v16 < 0 )
  {
    v33 = 6575;
...
LABEL_41:
  *a11 = v12;
  v38 = 0LL;
LABEL_49:
  ReleaseInterface<CD3DSurface>(&v38);
