/*
 * XREFs of ?ValidateAdapterLuidAndDisplayId@CD3DDeviceManager@@QEAAJU_LUID@@VDisplayId@@@Z @ 0x1800424C8
 * Callers:
...
__int64 __fastcall CD3DDeviceManager::ValidateAdapterLuidAndDisplayId(unsigned int a1, __int64 a2, int a3)
{
  CDisplaySet *v3; // rbp
  struct _LUID v6; // rdx
  ...
  else
  {
    if ( DisplayId::IsSpecific((DisplayId *)&v17) )
    {
      ...
      {
        v3 = v16;
        v11 = CDisplaySet::ValidateAdapterLuidAndDisplayId((unsigned __int64)v16, a2, a3);
        v10 = v11;
        if ( v11 < 0 )
