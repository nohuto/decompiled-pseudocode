/*
 * XREFs of ?OnVisualPropertyChange@CManipulationContext@@SAXPEAVCVisual@@PEAVCVisualTree@@@Z @ 0x18023D370
 * Callers:
 ...
 *     _lambda_c498f5f4ae65131189ca78714adaa14c_::operator() @ 0x18023BB78 (_lambda_c498f5f4ae65131189ca78714adaa14c_--operator().c)
 */
  ...
  if ( InteractionInternal )
  {
    ...
    do
    {
      ...
      if ( v8 )
      {
        ...
        if ( v12 )
          v11 = *(_DWORD *)(v12 + 76);
        lambda_c498f5f4ae65131189ca78714adaa14c_::operator()(v22, (__int64 *)&v23, v11);
        v13 = 0;
        v14 = *((_QWORD *)v21 + 12);
        if ( v14 )
          v13 = *(_DWORD *)(v14 + 80);
        lambda_c498f5f4ae65131189ca78714adaa14c_::operator()(v22, (__int64 *)&v23 + 1, v13);
        v15 = 0;
        v16 = *((_QWORD *)v21 + 12);
        if ( v16 )
          v15 = *(_DWORD *)(v16 + 88);
        lambda_c498f5f4ae65131189ca78714adaa14c_::operator()(v22, (__int64 *)&v24 + 1, v15);
        v17 = 0;
        v18 = *((_QWORD *)v21 + 12);
        if ( v18 )
          v17 = *(_DWORD *)(v18 + 84);
        lambda_c498f5f4ae65131189ca78714adaa14c_::operator()(v22, (__int64 *)&v24, v17);
        v10 = v20;
      }
      v7 = *(CVisual **)(v9 + 80);
    }
