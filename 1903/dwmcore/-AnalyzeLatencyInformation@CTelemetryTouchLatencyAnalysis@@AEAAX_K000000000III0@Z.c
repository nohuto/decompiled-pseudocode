/*
 * XREFs of ?AnalyzeLatencyInformation@CTelemetryTouchLatencyAnalysis@@AEAAX_K000000000III0@Z @ 0x18001D8AC
 * Callers:
 ...
 *     ?QpcSpanToDurationMicroseconds@CTelemetryTouchLatencyAnalysis@@AEBAI_K0@Z @ 0x18018F520 (-QpcSpanToDurationMicroseconds@CTelemetryTouchLatencyAnalysis@@AEBAI_K0@Z.c)
 ...
 *     ?TryGetDataForInteraction@CTelemetryComputeScribbleAggregator@@SA_NIPEAUComputeScribbleLatencyData@@@Z @ 0x180193BA0 (-TryGetDataForInteraction@CTelemetryComputeScribbleAggregator@@SA_NIPEAUComputeScribbleLatencyDa.c)
 */
    ...
    if ( *((_QWORD *)Scenario + 16) == a15 && a6 - v77 > v39 )
    {
      *((_BYTE *)Scenario + 180) = 1;
      if ( hProvider > 4u && TlgKeywordOn((TraceLoggingHProvider)&hProvider, 2uLL) )
      {
        ...
        v151 = &a10;
        v153 = &a11;
        TlgWrite((TraceLoggingHProvider)&hProvider, &unk_1802DA38E, 0LL, 0LL, 0x23u, &pData);
      }
    }
    else
    {
        ...
        if ( a12 == v52 + 1 && *((_QWORD *)Scenario + 36) - *((_QWORD *)Scenario + 37) > v39 )
        {
          ...
          if ( hProvider > 4u )
          {
            if ( TlgKeywordOn((TraceLoggingHProvider)&hProvider, 2uLL) )
            {
              ...
              v164 = 8LL;
              TlgWrite((TraceLoggingHProvider)&hProvider, &unk_1802DA61C, 0LL, 0LL, 0x28u, &pData);
            }
          }
        }
      }
