/*
 * XREFs of ?HrLock@CBitmap@@IEAAJIIAEBUPixelFormatInfo@@IIPEAXW4WICBitmapLockFlags@@PEAPEAVIBitmapLock@@_NPEAUIUnknown@@@Z @ 0x180044098
 * Callers:
...
LABEL_4:
  v17 = (CBitmapLock *)operator new(0x90uLL);
  if ( v17 )
