/*
 * XREFs of ?Initialize@?$CTypedConstantBuffer@M@@QEAAJPEAVCD3DDeviceLevel1@@W4D3D11_USAGE@@@Z @ 0x180026FC4
 * Callers:
...
__int64 __fastcall CTypedConstantBuffer<float>::Initialize(struct ID3D11Buffer **a1, struct CD3DDeviceLevel1 *a2)
{
  unsigned int v2; // ebx
  int v3; // eax
  unsigned int v4; // ecx
