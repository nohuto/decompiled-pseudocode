        ...
        __int64 a4)
{
  ...
  while ( v15 != *(_QWORD *)(*(_QWORD *)(v11 + 24) + 8 * v13) )
  {
    ...
    {
      std::list<std::pair<CResource const * const,CWeakResourceReference *>>::erase(v11 + 8, &v23, (__int64 *)a4);
      *(_QWORD *)a2 = v14;
      *(_BYTE *)(a2 + 8) = 0;
      return a2;
    }
