/*
 * XREFs of ?CollectStateFromFragment@CRenderingTechnique@@AEAAXPEAVCRenderingTechniqueFragment@@@Z @ 0x180037A28
 * Callers:
...
LABEL_14:
    ...
    for ( j = 0; j < v18; ++j )
    {
      if ( CRenderingTechniqueFragment::SurfaceDescription::operator==((__int64)&v23, (__int64)this + 44 * j + 92) )
        break;
    }
    if ( j >= v18 )
    {
LABEL_17:
      v20 = v23;
      v21 = 44LL * (unsigned int)(*((_DWORD *)this + 21))++;
      v22 = v24;
      *(_QWORD *)((char *)this + v21 + 92) = v20;
      *(_DWORD *)((char *)this + v21 + 100) = v22;
    }
    else
    {
      *((_WORD *)this + 22 * j + 51) |= HIWORD(v24);
    }
  }
  *((_DWORD *)this + 22) |= *((_DWORD *)a2 + 7);
  v12 = *((_DWORD *)a2 + 5);
  if ( (v12 & 0xF) != 0 )
