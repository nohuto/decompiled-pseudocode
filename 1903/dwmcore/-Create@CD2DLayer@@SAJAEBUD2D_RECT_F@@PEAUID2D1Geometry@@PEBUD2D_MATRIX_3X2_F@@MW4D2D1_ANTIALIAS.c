/*
 * XREFs of ?Create@CD2DLayer@@SAJAEBUD2D_RECT_F@@PEAUID2D1Geometry@@PEBUD2D_MATRIX_3X2_F@@MW4D2D1_ANTIALIAS_MODE@@W4D2D1_LAYER_OPTIONS1@@W4D2D1_PRIMITIVE_BLEND@@PEAPEAV1@@Z @ 0x180072A64
 * Callers:
        ...
        struct CD2DLayer **a8)
{
  ...
  *a8 = v13;
  ...
  {
    v9 = -2147024882;
    MilInstrumentationCheckHR_MaybeFailFast(0, 0LL, 0, -2147024882, 0x19u, 0LL);
  }
  return v9;
}
