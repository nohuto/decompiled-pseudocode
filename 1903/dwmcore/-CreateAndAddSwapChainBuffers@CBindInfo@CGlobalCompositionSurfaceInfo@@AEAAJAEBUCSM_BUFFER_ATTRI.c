/*
 * XREFs of ?CreateAndAddSwapChainBuffers@CBindInfo@CGlobalCompositionSurfaceInfo@@AEAAJAEBUCSM_BUFFER_ATTRIBUTES@@AEBUCSM_SWAPCHAIN_REALIZATION_INFO@@@Z @ 0x18003D624
 * Callers:
        ...
        struct _LUID *a3)
{
  ...
  {
    v7 = -2147024809;
    MilInstrumentationCheckHR_MaybeFailFast(v8, &dword_1802D5140, 3u, -2147024809, 0x582u, 0LL);
  }
  else
  {
    ...
    {
      v7 = v9 | 0x10000000;
      MilInstrumentationCheckHR_MaybeFailFast(v10, &dword_1802D5140, 3u, v9 | 0x10000000, 0x58Bu, 0LL);
    }
    else
    {
      if ( a3->HighPart <= 1u )
...
LABEL_4:
        ...
        if ( HighPart )
        {
          while ( 1 )
          {
            ...
            if ( v17 < 0 )
            {
              MilInstrumentationCheckHR_MaybeFailFast(v18, &dword_1802D5140, 3u, v17, 0x5BAu, 0LL);
              goto LABEL_11;
            }
          ...
          MilInstrumentationCheckHR_MaybeFailFast(v16, &dword_1802D5140, 3u, v15, 0x5AFu, 0LL);
          v6 = v30;
        }
        else
        {
LABEL_9:
      ...
      {
        MilInstrumentationCheckHR_MaybeFailFast(v10, &dword_1802D5140, 3u, v7, 0x595u, 0LL);
      }
LABEL_11:
      v19 = v28;
