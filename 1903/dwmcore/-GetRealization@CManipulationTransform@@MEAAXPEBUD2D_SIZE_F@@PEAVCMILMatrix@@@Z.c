/*
 * XREFs of ?GetRealization@CManipulationTransform@@MEAAXPEBUD2D_SIZE_F@@PEAVCMILMatrix@@@Z @ 0x18001E4C0
 * Callers:
 *     <none>
 * Callees:
  ...
  *((_DWORD *)a3 + 16) = 0;
  if ( dword_18033A240 > 4u )
  {
    if ( TlgKeywordOn((TraceLoggingHProvider)&dword_18033A240, 1uLL) )
    {
      ...
      v40 = 4LL;
      v42 = 4LL;
      TlgWrite((TraceLoggingHProvider)&dword_18033A240, &unk_1802DC90C, 0LL, 0LL, 0x12u, &pData);
      v9 = dword_18033A240;
    }
    if ( v9 > 4 )
    {
      if ( TlgKeywordOn((TraceLoggingHProvider)&dword_18033A240, 1uLL) )
      {
        ...
        v32 = 4LL;
        v34 = 4LL;
        TlgWrite((TraceLoggingHProvider)&dword_18033A240, &unk_1802DC991, 0LL, 0LL, 0xEu, &pData);
      }
    }
  }
}
