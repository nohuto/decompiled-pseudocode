/*
 * XREFs of ?OnInteractionUpdate@CGlobalManipulationManager@@AEAAXXZ @ 0x1800C3440
 * Callers:
 *     _lambda_53e4d08f85004fbfe19bb4d1e8c4a6f0_::_lambda_invoker_cdecl_ @ 0x1800D7840 (_lambda_53e4d08f85004fbfe19bb4d1e8c4a6f0_--_lambda_invoker_cdecl_.c)
 *     _lambda_35cedf73a04efee64cd2b082b9370e6e_::_lambda_invoker_cdecl_ @ 0x180237930 (_lambda_35cedf73a04efee64cd2b082b9370e6e_--_lambda_invoker_cdecl_.c)
 * Callees:
 ...
 *     ?SetInteractionConfiguration@CInteractionProcessor@@QEAAJW4Enum@InteractionConfigurationUpdateType@@W42InteractionInputType@@PEBXI@Z @ 0x1800C439C (-SetInteractionConfiguration@CInteractionProcessor@@QEAAJW4Enum@InteractionConfigurationUpdateTy.c)
 ...
 *     ?FindMonitorAndWorkspace@CManipulationContext@@SAXPEAUMCCollections@@PEAVCInteraction@@PEAPEAUHMONITOR__@@PEAK@Z @ 0x18023C5C4 (-FindMonitorAndWorkspace@CManipulationContext@@SAXPEAUMCCollections@@PEAVCInteraction@@PEAPEAUHM.c)
