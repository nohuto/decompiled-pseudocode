/*
 * XREFs of ?RenderBlackShape@CWindowNode@@AEAAJPEAVCDrawingContext@@AEBVCShape@@@Z @ 0x180219AFC
 * Callers:
        ...
        const struct CShape *a3)
{
  ...
  v4 = CDrawingContext::FillRectangularShapeWithColor(a2, a3, (const __m128i *)&stru_1802E4588);
  v6 = v4;
  if ( v4 < 0 )
    MilInstrumentationCheckHR_MaybeFailFast(v5, 0LL, 0, v4, 0xC57u, 0LL);
  else
    *((_BYTE *)a2 + 6355) = 1;
  return v6;
}
