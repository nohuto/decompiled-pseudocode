/*
 * XREFs of ?TransitionDisconnectedTrackersToIdle@CInteractionTrackerBindingManager@@AEAAXPEAVCInteractionTracker@@0@Z @ 0x1801E012C
 * Callers:
  ...
  *(_QWORD *)&v15 = v7;
  ...
  while ( v9 != v8 )
  {
    ...
    if ( *(_DWORD *)(v10 + 168) == 1 )
    {
      ...
      CInteractionTracker::AddOrUpdatePendingInertiaStateChange(v10, 1, v12, 1);
      v13 = CInteractionTracker::GetCurrentValue(v10, 2);
      CInteractionTracker::AddOrUpdatePendingInertiaStateChange(v10, 2, v13, 1);
    }
