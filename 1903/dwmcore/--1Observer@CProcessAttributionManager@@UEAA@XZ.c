/*
 * XREFs of ??1Observer@CProcessAttributionManager@@UEAA@XZ @ 0x18017898C
 * Callers:
 ...
 *     ?NotifyOnDeadObserver@CProcessAttributionManager@@AEAAXPEAVCProcessAttributionObserver@@@Z @ 0x180178AC8 (-NotifyOnDeadObserver@CProcessAttributionManager@@AEAAXPEAVCProcessAttributionObserver@@@Z.c)
 */
