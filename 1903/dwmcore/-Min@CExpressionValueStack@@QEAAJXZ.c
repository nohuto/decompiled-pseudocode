/*
 * XREFs of ?Min@CExpressionValueStack@@QEAAJXZ @ 0x1800D6EB0
 * Callers:
...
__int64 __fastcall CExpressionValueStack::Min(CExpressionValueStack *this)
{
  ...
  if ( v6 != 18 )
  {
    ...
    {
      case '#':
        v14 = fminf(*(float *)(v2 + 8 * v4), *(float *)(v2 + 8 * v5));
        v15 = fminf(*(float *)(v2 + 8 * v4 + 4), *(float *)(v2 + 8 * v5 + 4));
      ...
      case '4':
        ...
        v19 = *(_QWORD *)(v2 + 8 * v5);
        v11.m128_f32[0] = fminf(*(float *)&v17, *(float *)&v19);
        v12.m128_f32[0] = fminf(*((float *)&v17 + 1), *((float *)&v19 + 1));
        v13 = fminf(*(float *)(v2 + 8 * v4 + 8), *(float *)(v2 + 8 * v5 + 8));
