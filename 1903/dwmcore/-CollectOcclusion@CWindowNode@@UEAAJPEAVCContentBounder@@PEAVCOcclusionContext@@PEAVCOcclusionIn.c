/*
 * XREFs of ?CollectOcclusion@CWindowNode@@UEAAJPEAVCContentBounder@@PEAVCOcclusionContext@@PEAVCOcclusionInfo@@@Z @ 0x18005A560
 * Callers:
 *     <none>
 * Callees:
        ...
        struct COcclusionInfo *a4)
{
  ...
  if ( v5 )
  {
    v55 = (*(__int64 (__fastcall **)(char *, struct COcclusionContext *, char *))(*(_QWORD *)v5 + 192LL))(
            v5,
            a3,
            (char *)this + 132);
    RenderBounds = v55;
    if ( v55 < 0 )
      MilInstrumentationCheckHR_MaybeFailFast((unsigned int)v5, 0LL, 0, v55, 0x101Cu, 0LL);
  }
  if ( RenderBounds < 0 )
  {
    v89 = 1724;
  ...
  if ( v13 && CCompositionSurfaceBitmap::HasContent((CCompositionSurfaceBitmap *)(v13 + 64)) )
  {
    ...
    if ( *((_BYTE *)a3 + 825) )
    {
      ...
      *(_OWORD *)v91 = _xmm;
      ...
      if ( v70 < 0 )
      {
        MilInstrumentationCheckHR_MaybeFailFast(v71, 0LL, 0, v70, 0x6E3u, 0LL);
      ...
      if ( RenderBounds < 0 )
      {
        v89 = 1769;
LABEL_148:
        MilInstrumentationCheckHR_MaybeFailFast((unsigned int)v5, 0LL, 0, RenderBounds, v89, 0LL);
        return (unsigned int)RenderBounds;
      }
    }
  }
  ...
  while ( 1 )
  {
    ...
    *(_QWORD *)&v99 = v77;
    ...
    if ( !*((_BYTE *)a3 + 824) )
      v78 = 0LL;
    RenderBounds = (*(__int64 (__fastcall **)(_QWORD, char *, __int64, char *))(**((_QWORD **)a3 + 50) + 32LL))(
                     *((_QWORD *)a3 + 50),
                     v77,
                     v76,
                     v78);
...
LABEL_22:
  ...
  if ( v17 )
  {
    ...
    if ( RenderBounds < 0 )
    {
      MilInstrumentationCheckHR_MaybeFailFast(v20, 0LL, 0, RenderBounds, 0x615u, 0LL);
      LODWORD(v5) = 0;
    }
    else
    {
...
LABEL_66:
      if ( RenderBounds < 0 )
        MilInstrumentationCheckHR_MaybeFailFast((unsigned int)v5, 0LL, 0, RenderBounds, 0x737u, 0LL);
      goto LABEL_58;
    }
LABEL_43:
    RenderBounds = 0;
    if ( (float)right > v33 && v35 > v34 )
    {
      ...
      CMILMatrix::Transform2DBoundsHelper<0>(v38);
      v39 = *((_DWORD *)a3 + 32);
      if ( v39 )
      {
      ...
      *(_QWORD *)&v103 = __PAIR64__(LODWORD(v41), v40);
      ...
      if ( v47 )
      {
        while ( ((v45 >> (char)v5) & 1) == 0 || v46 <= (float)(*((float *)a3 + (unsigned int)v5 + 195) * 0.25) )
        {
        ...
        else
        {
          ...
          v87 = DynArrayImpl<0>::AddMultipleAndSet((char *)a3 + 408, 20LL, 1LL, &v103);
          RenderBounds = v87;
          if ( v87 < 0 )
            MilInstrumentationCheckHR_MaybeFailFast((unsigned int)v5, 0LL, 0, v87, 0xC3u, 0LL);
        }
        if ( RenderBounds >= 0 )
          goto LABEL_58;
        MilInstrumentationCheckHR_MaybeFailFast((unsigned int)v5, 0LL, 0, RenderBounds, 0x6D5u, 0LL);
      }
    }
LABEL_57:
    if ( RenderBounds < 0 )
    {
      MilInstrumentationCheckHR_MaybeFailFast((unsigned int)v5, 0LL, 0, RenderBounds, 0x4D6u, 0LL);
      goto LABEL_66;
    }
  }
  else if ( (_QWORD)v99 )
  {
    ...
    RenderBounds = v54;
    if ( v54 < 0 )
      MilInstrumentationCheckHR_MaybeFailFast((unsigned int)v5, 0LL, 0, v54, 0x73Eu, 0LL);
  }
LABEL_58:
  if ( RenderBounds < 0 )
  {
