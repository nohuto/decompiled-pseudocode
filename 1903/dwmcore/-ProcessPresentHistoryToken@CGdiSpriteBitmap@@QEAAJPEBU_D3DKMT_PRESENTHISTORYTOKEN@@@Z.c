/*
 * XREFs of ?ProcessPresentHistoryToken@CGdiSpriteBitmap@@QEAAJPEBU_D3DKMT_PRESENTHISTORYTOKEN@@@Z @ 0x18008F490
 * Callers:
...
LABEL_17:
          ...
          if ( *(_DWORD *)lpMem )
          {
            if ( v86 == lpMem )
            {
              ...
              if ( v30 >= v29 )
                goto LABEL_22;
              v27 = DefaultHeap::Alloc(v29);
              if ( v27 )
              {
                FastRegion::CRegion::FreeMemory((FastRegion::CRegion *)&v76);
                v76 = (struct FastRegion::Internal::CRgnData *)v27;
                v77[0] = v29;
LABEL_22:
                v31 = *(_DWORD *)v25;
                v32 = 0;
                *v27 = *(_DWORD *)v25;
                ...
                v34 = &v27[2 * v31 + 3];
                v35 = ((char *)&v27[2 * v31] - &v25[*((int *)v25 + 4)]) >> 2;
                if ( (int)*v27 > 0 )
                {
                  v36 = 4 * v35;
                  v37 = v27 + 3;
...
LABEL_40:
    ...
    if ( *(_DWORD *)v88 )
    {
      if ( v89 == v88 )
      {
        ...
        if ( v49 >= v48 )
          goto LABEL_45;
        v46 = DefaultHeap::Alloc(v48);
        if ( v46 )
        {
          FastRegion::CRegion::FreeMemory((FastRegion::CRegion *)&v82);
          v82 = (struct FastRegion::Internal::CRgnData *)v46;
          v83[0] = v48;
LABEL_45:
          v50 = *v45;
          v51 = 0;
          *v46 = *v45;
          ...
          if ( v50 > 0 )
          {
            v54 = 4 * (((char *)&v46[2 * v50] - ((char *)v45 + v45[4])) >> 2);
            v55 = v46 + 3;
            do
            {
              *v55 = *(_DWORD *)((char *)v55 + (char *)v45 - (char *)v46);
              v55 += 2;
              v56 = v51++;
              v46[2 * v56 + 4] = (_DWORD)v45 + 8 * v56 + v54 + v45[2 * v56 + 4] - ((_DWORD)v46 + 8 * v56);
            }
            while ( v51 < *v46 );
          }
