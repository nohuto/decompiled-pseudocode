/*
 * XREFs of ?CreateHitTestRegions@CPrimitiveGroup@@AEBAJXZ @ 0x18000C3BC
 * Callers:
 ...
 *     ?Is2DAxisAlignedPreservingApprox@MILMatrix3x2@@QEBA_NXZ @ 0x18000CAF8 (-Is2DAxisAlignedPreservingApprox@MILMatrix3x2@@QEBA_NXZ.c)
 ...
 *     ??0?$DynArrayIA@V?$TMilRect_@HUtagRECT@@UMilPointAndSizeL@@U_CMilRectL_@RectUniqueness@@@@$0BA@$0A@@@QEAA@XZ @ 0x18000CE1C (--0-$DynArrayIA@V-$TMilRect_@HUtagRECT@@UMilPointAndSizeL@@U_CMilRectL_@RectUniqueness@@@@$0BA@$.c)
...
LABEL_97:
  ...
  while ( 1 )
  {
    ...
    if ( v12 + 144 > v11 )
    {
      ...
      v116 = 0;
      v117 = 0LL;
      v34 = CRegionShape::BuildFromRects(v115, v118[0]);
      v4 = v34;
      if ( v34 < 0 )
      {
