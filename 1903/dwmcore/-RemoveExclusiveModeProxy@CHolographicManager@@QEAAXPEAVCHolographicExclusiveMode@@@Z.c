/*
 * XREFs of ?RemoveExclusiveModeProxy@CHolographicManager@@QEAAXPEAVCHolographicExclusiveMode@@@Z @ 0x180241EF0
 * Callers:
 *     ??1CHolographicExclusiveMode@@MEAA@XZ @ 0x1802447A4 (--1CHolographicExclusiveMode@@MEAA@XZ.c)
 *     ?DetachFromChannel@CHolographicExclusiveMode@@UEAAXPEAVCChannelContext@@_N@Z @ 0x180244840 (-DetachFromChannel@CHolographicExclusiveMode@@UEAAXPEAVCChannelContext@@_N@Z.c)
 * Callees:
