/*
 * XREFs of ?IsShaderLinkingBlacklistedGpu@CCommonRegistryData@@SA_NII@Z @ 0x1800259C4
 * Callers:
...
char __fastcall CCommonRegistryData::IsShaderLinkingBlacklistedGpu(int a1, unsigned __int16 a2)
{
  ...
  {
    v2 = (struct CCommonRegistryData::GpuId *)&unk_1802E3CA0;
    CCommonRegistryData::m_cShaderLinkingBlacklistedGpuIds = 0;
    CCommonRegistryData::m_rgwShaderLinkingBlacklistedGpuIds = (const struct CCommonRegistryData::GpuId *const)&unk_1802E3CA0;
    v6 = 0;
  }
  if ( !v6 )
    return 0;
