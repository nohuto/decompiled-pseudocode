/*
 * XREFs of ?DispatchScribbles@CFramebuffer@CComputeScribbleRenderer@@QEAAJPEAUID3D12CommandQueue@@PEAVCComputeScribbleStopwatch@@_KAEAV?$vector@UComputeScribbleLatencyData@@V?$allocator@UComputeScribbleLatencyData@@@std@@@std@@@Z @ 0x1801B5B1C
 * Callers:
 ...
 *     ?AcquireForScribble@CFramebuffer@CComputeScribbleRenderer@@AEAA_N_K@Z @ 0x1801B57C0 (-AcquireForScribble@CFramebuffer@CComputeScribbleRenderer@@AEAA_N_K@Z.c)
        ...
        _QWORD *a5)
{
  ...
  if ( CComputeScribbleRenderer::CFramebuffer::AcquireForScribble(this, a4) )
  {
    ...
    if ( v14 >= 0 )
    {
      ...
      else
      {
        ...
        if ( v16 >= 0 )
        {
          ...
          v37 = 0;
          lambda_6a58240d8047e86606b12524314309a7_::operator()((__int64)&v35);
          ...
          if ( v19 >= 0 )
          {
            ...
            if ( (Microsoft_Windows_Dwm_CoreEnableBits & 2) != 0 )
              McTemplateU0xxxq(v29, (unsigned int)&EVTDESC_COMPUTESCRIBBLE_GPUFINISHED, a4, v21, v28, (int)v30);
            return 0LL;
          }
