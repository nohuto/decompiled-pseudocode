/*
 * XREFs of ?AddVisualTreeDataToList@CVisual@@IEAAXPEAVCVisualTreeData@@@Z @ 0x180052D58
 * Callers:
 *     ?Link@CVisualTreeData@@MEAAXXZ @ 0x180052D00 (-Link@CVisualTreeData@@MEAAXXZ.c)
 * Callees:
