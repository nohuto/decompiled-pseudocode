/*
 * XREFs of ?DestroyDeviceResources@CD2DContext@@IEAAJXZ @ 0x180024C5C
 * Callers:
 ...
 *     ?MarkAllResourcesInvalid@CD2DResourceManager@@QEAAXXZ @ 0x180024C08 (-MarkAllResourcesInvalid@CD2DResourceManager@@QEAAXXZ.c)
 *     ?DestroyDeviceResources@CDrawListBatchManager@@IEAAXXZ @ 0x180025CD8 (-DestroyDeviceResources@CDrawListBatchManager@@IEAAXXZ.c)
 *     ?ReleaseEffectTable@CD2DContext@@AEAAXXZ @ 0x1800265EC (-ReleaseEffectTable@CD2DContext@@AEAAXXZ.c)
