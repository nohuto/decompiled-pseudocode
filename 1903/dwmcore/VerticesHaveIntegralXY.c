/*
 * XREFs of VerticesHaveIntegralXY @ 0x1800750C4
 * Callers:
...
char __fastcall VerticesHaveIntegralXY(__int64 *a1)
{
  ...
  {
    v3 = v1 * *((_DWORD *)a1 + 2);
    if ( (float)COERCE_DOUBLE(COERCE_UNSIGNED_INT64(*(float *)(v3 + v2)) & _xmm) > 8388608.0
      || (float)COERCE_DOUBLE(COERCE_UNSIGNED_INT64(*(float *)(v3 + v2 + 4)) & _xmm) > 8388608.0 )
    {
      break;
    }
