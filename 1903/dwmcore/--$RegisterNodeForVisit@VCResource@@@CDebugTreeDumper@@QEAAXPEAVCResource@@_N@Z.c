/*
 * XREFs of ??$RegisterNodeForVisit@VCResource@@@CDebugTreeDumper@@QEAAXPEAVCResource@@_N@Z @ 0x1801FBD58
 * Callers:
...
__int64 __fastcall CDebugTreeDumper::RegisterNodeForVisit<CResource>(_QWORD *a1, __int64 a2)
{
  __int64 v2; // rdi
  __int64 result; // rax
  __int64 v5; // r8
  ...
  {
    v16 = 0LL;
    std::function_void___cdecl_void___CDebugTreeDumper____::operator___lambda_603f181036d0da53b7b505f826c78df9__void_((__int64)v15);
