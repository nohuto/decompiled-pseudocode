/*
 * XREFs of ?GetTightBounds@CRegionShape@@UEBAJPEAV?$TMilRect_@MUMilRectF@@UMilPointAndSizeF@@UNotNeeded@RectUniqueness@@@@PEBVCMILMatrix@@@Z @ 0x1800B5FC0
 * Callers:
 *     <none>
 * Callees:
    ...
    *a2 = _mm_shuffle_ps(v9, v9, 57);
    if ( a3 )
    {
      if ( !CMILMatrix::IsIdentity<0>(a3) )
        CMILMatrix::Transform2DBoundsHelper<0>(v11, (__int64)v12, v12);
    }
    return 0LL;
  }
  else
