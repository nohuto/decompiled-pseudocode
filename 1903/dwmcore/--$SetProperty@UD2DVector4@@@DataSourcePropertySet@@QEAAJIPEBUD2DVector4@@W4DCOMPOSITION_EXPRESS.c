/*
 * XREFs of ??$SetProperty@UD2DVector4@@@DataSourcePropertySet@@QEAAJIPEBUD2DVector4@@W4DCOMPOSITION_EXPRESSION_TYPE@@@Z @ 0x1801974E8
 * Callers:
...
__int64 __fastcall DataSourcePropertySet::SetProperty<D2DVector4>(_QWORD *a1, int a2, _OWORD *a3)
{
  ...
  if ( v12 == a1[1] )
  {
    v5 = PropertySetStorage<DynArrayNoZero,PropertySetUserModeAllocator>::AddProperty<D2DVector4>(
           (__int64)(a1 + 8),
           69,
           a3,
           &v14);
