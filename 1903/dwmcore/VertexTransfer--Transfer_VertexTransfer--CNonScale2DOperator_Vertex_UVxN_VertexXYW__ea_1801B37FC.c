/*
 * XREFs of VertexTransfer::Transfer_VertexTransfer::CNonScale2DOperator_Vertex_UVxN_VertexXYW_ColorDW_WorldXYZ_Tangent____2_Vertex_UVxN_VertexXYW_ColorDW_WorldXYZ_Tangent___ @ 0x1801B37FC
 * Callers:
 ...
 *     ?Transform@?$CNonScale2DOperator@U?$Vertex_UVxN@UVertexXYW_ColorDW_WorldXYZ_Tangent@@@@@VertexTransfer@@QEAAXAEBU?$Vertex_UVxN@UVertexXYW_ColorDW@@@@IAEBVCMILMatrix@@PEAU?$Vertex_UVxN@UVertexXYW_ColorDW_WorldXYZ_Tangent@@@@@Z @ 0x1801B50F4 (-Transform@-$CNonScale2DOperator@U-$Vertex_UVxN@UVertexXYW_ColorDW_WorldXYZ_Tangent@@@@@VertexTr.c)
 */
        ...
        CMILMatrix *a4)
{
  ...
  if ( a3 && a4 )
  {
    v4 = CalculateTBNFrameFrom3Vertices((struct D2DQuaternion *)&v15, (__int64)v6, (__int64 *)(a1 + 8), a3, a4);
    v15 = *(_OWORD *)v4;
  }
  if ( v8 )
  {
    do
    {
      ...
      *(_DWORD *)(v13 + 12) = (int)(float)(unsigned __int8)*(_DWORD *)(v12 + 12) | (((int)(float)(unsigned __int8)BYTE1(*(_DWORD *)(v12 + 12)) | (((int)(float)(unsigned __int8)BYTE2(*(_DWORD *)(v12 + 12)) | ((int)(float)((float)HIBYTE(*(_DWORD *)(v12 + 12)) * v11) << 8)) << 8)) << 8);
      LOWORD(v4) = VertexTransfer::TransformDeviceSpacePositionAndNormal(v6++, a3, (__int64)&v15, v13);
      ++v5;
    }
    while ( v5 < v8 );
  }
