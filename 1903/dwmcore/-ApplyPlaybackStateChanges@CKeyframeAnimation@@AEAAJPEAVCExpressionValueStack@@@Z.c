/*
 * XREFs of ?ApplyPlaybackStateChanges@CKeyframeAnimation@@AEAAJPEAVCExpressionValueStack@@@Z @ 0x180081A30
 * Callers:
 ...
 * Callees:
 *     ?Pause@CKeyframeAnimation@@AEAAXXZ @ 0x18001DD00 (-Pause@CKeyframeAnimation@@AEAAXXZ.c)
 ...
 *     ?GetGlobalPlaybackRate@CExpressionManager@@QEAAMPEAVCChannelContext@@@Z @ 0x1800CC430 (-GetGlobalPlaybackRate@CExpressionManager@@QEAAMPEAVCChannelContext@@@Z.c)
    ...
    if ( v6 )
    {
      if ( !v5 )
      {
        ...
        if ( v24 && *(_QWORD *)(v24 + 16) )
        {
          ...
          if ( v26 < 0 )
          {
            MilInstrumentationCheckHR_MaybeFailFast(v27, 0LL, 0, v26, 0x34Bu, 0LL);
            return v7;
          }
          v28 = *((_DWORD *)a2 + 4);
          if ( v28 == v25 + 1 )
          {
            ...
            if ( v29 < 0 )
            {
              MilInstrumentationCheckHR_MaybeFailFast(v30, 0LL, 0, v29, 0x359u, 0LL);
              return v7;
            }
            --*((_DWORD *)a2 + 4);
          }
        ...
        if ( v31 )
        {
          if ( (*(_BYTE *)(v31 + 112) & 4) != 0 )
          {
            ...
            if ( v32 < 0 )
            {
              MilInstrumentationCheckHR_MaybeFailFast(v33, 0LL, 0, v32, 0x362u, 0LL);
              return v7;
            }
          }
        }
...
LABEL_2:
  if ( v6 )
  {
    ...
    if ( v11 )
    {
      ...
      if ( v22 < 0 )
      {
        MilInstrumentationCheckHR_MaybeFailFast(v23, 0LL, 0, v22, 0x3ABu, 0LL);
        return v7;
      }
      *((_QWORD *)this + 58) = *(_QWORD *)(*((_QWORD *)this + 2) + 496LL);
    }
    else if ( v10 )
    {
      ...
      if ( v36 < 0 )
      {
        MilInstrumentationCheckHR_MaybeFailFast(v37, 0LL, 0, v36, 0x3B3u, 0LL);
        return v7;
      }
    }
  }
