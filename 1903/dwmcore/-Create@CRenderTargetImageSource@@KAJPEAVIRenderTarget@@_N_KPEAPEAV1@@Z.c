/*
 * XREFs of ?Create@CRenderTargetImageSource@@KAJPEAVIRenderTarget@@_N_KPEAPEAV1@@Z @ 0x180047F78
 * Callers:
 ...
 *     ??0CRenderTargetImageSource@@IEAA@_N@Z @ 0x180047CC0 (--0CRenderTargetImageSource@@IEAA@_N@Z.c)
        ...
        struct CRenderTargetImageSource **a4)
{
  ...
  {
    v10 = -2147024882;
    MilInstrumentationCheckHR_MaybeFailFast(v13, 0LL, 0, -2147024882, 0x19u, 0LL);
    goto LABEL_8;
  }
  *((_QWORD *)v12 + 24) = a3;
...
LABEL_16:
  ...
  v16 = CRenderTargetBitmap::Initialize(
          (CRenderTargetImageSource *)((char *)v12 + 8),
          (__int64 (__fastcall ***)(struct IRenderTargetBitmap *, GUID *, __int64 *))v20);
  v10 = v16;
  if ( v16 < 0 )
  {
    v19 = 33;
