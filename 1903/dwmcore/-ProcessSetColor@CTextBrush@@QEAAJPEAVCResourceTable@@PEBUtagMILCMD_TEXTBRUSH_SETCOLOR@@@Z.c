/*
 * XREFs of ?ProcessSetColor@CTextBrush@@QEAAJPEAVCResourceTable@@PEBUtagMILCMD_TEXTBRUSH_SETCOLOR@@@Z @ 0x1801FCB6C
 * Callers:
        ...
        const struct tagMILCMD_TEXTBRUSH_SETCOLOR *a3)
{
  ...
  v4 = ((__int64 (__fastcall *)(char *, void *, char *))xmmword_18033BA58)(
         (char *)this + SDWORD2(xmmword_18033BA58),
         &CTextBrush::sc_Color,
         (char *)a3 + 8);
  v6 = v4;
  if ( v4 < 0 )
