/*
 * XREFs of ?CreateCompositingShader@@YAJW4D3D_FEATURE_LEVEL@@V?$span@$$CBUPixelFormatInfo@@$0?0@gsl@@W4DXGI_COLOR_SPACE_TYPE@@PEAPEAUID3D10Blob@@@Z @ 0x1801AE1D0
 * Callers:
        ...
        struct ID3D10Blob **a4)
{
  ...
  *((_QWORD *)&v56 + 1) = &unk_18027CDD0;
  v59 = v56;
  v8 = CShaderLinkingGraphBuilder::Initialize(ppLinker, a1 >= 37632, (unsigned __int64 *)&v59);
  v10 = v8;
  if ( v8 < 0 )
  {
