/*
 * XREFs of ?Geometry2DGroupUpdate@CChannel@@UEAAJIPEBII@Z @ 0x180157FC0
 * Callers:
 *     <none>
 * Callees:
        ...
        unsigned int a4)
{
  ...
  {
    v11 = -2147024362;
    MilInstrumentationCheckHR_MaybeFailFast(0xFFFFFFFFLL, 0LL, 0, 0x80070216, 0xA81u, 0LL);
  }
  else
  {
    v14 = 4 * a4;
    ...
    if ( v9 < 0 )
    {
      MilInstrumentationCheckHR_MaybeFailFast(v10, 0LL, 0, v9, 0xA82u, 0LL);
    }
    else
    {
