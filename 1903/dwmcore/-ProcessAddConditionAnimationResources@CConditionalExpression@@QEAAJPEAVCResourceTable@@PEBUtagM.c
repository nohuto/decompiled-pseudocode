/*
 * XREFs of ?ProcessAddConditionAnimationResources@CConditionalExpression@@QEAAJPEAVCResourceTable@@PEBUtagMILCMD_CONDITIONALEXPRESSION_ADDCONDITIONANIMATIONRESOURCES@@PEBXI@Z @ 0x1801D49FC
 * Callers:
  ...
  if ( *((_DWORD *)a3 + 2) )
  {
    while ( 1 )
    {
      ...
      *(_QWORD *)&v27 = v12;
      ...
      v15 = (__int64)v14;
      if ( !v14
        || !(*(unsigned __int8 (__fastcall **)(struct CResource *, __int64))(*(_QWORD *)v14 + 48LL))(v14, 55LL)
        && !(*(unsigned __int8 (__fastcall **)(__int64, __int64))(*(_QWORD *)v15 + 48LL))(v15, 107LL) )
      {
        v26 = 80;
        goto LABEL_25;
      }
      ...
      *((_QWORD *)&v27 + 1) = v15;
      ...
      a4 += 2;
      (*(void (__fastcall **)(struct CResource *, CConditionalExpression *))(*(_QWORD *)v12 + 224LL))(v12, v8);
      (*(void (__fastcall **)(__int64, CConditionalExpression *))(*(_QWORD *)v15 + 224LL))(v15, v8);
