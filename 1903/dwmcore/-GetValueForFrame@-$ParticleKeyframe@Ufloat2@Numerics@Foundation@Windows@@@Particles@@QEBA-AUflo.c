/*
 * XREFs of ?GetValueForFrame@?$ParticleKeyframe@Ufloat2@Numerics@Foundation@Windows@@@Particles@@QEBA?AUfloat2@Numerics@Foundation@Windows@@AEBV?$span@M$0?0@gsl@@@Z @ 0x1801E9E4C
 * Callers:
