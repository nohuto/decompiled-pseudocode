/*
 * XREFs of VertexTransfer::SimdTransfer_VertexTransfer::CSimdNonScale2DOperator_Vertex_UVxN_VertexXYW_ColorDW_WorldXYZ_Tangent____1_Vertex_UVxN_VertexXYW_ColorDW_WorldXYZ_Tangent___ @ 0x1801B2A4C
 * Callers:
 ...
 *     ?Transform@?$CSimdNonScale2DOperator@U?$Vertex_UVxN@UVertexXYW_ColorDW_WorldXYZ_Tangent@@@@@VertexTransfer@@QEAQXAEBU?$Vertex_UVxN@UVertexXYW_ColorDW@@@@T__m128@@1IPEAU?$Vertex_UVxN@UVertexXYW_ColorDW_WorldXYZ_Tangent@@@@@Z @ 0x1801B5170 (-Transform@-$CSimdNonScale2DOperator@U-$Vertex_UVxN@UVertexXYW_ColorDW_WorldXYZ_Tangent@@@@@Vert.c)
 */
        ...
        CMILMatrix *a4)
{
  ...
  v13 = *(_DWORD *)(a1 + 40) >> 1;
  LODWORD(v14) = _mm_shuffle_ps((__m128)*(unsigned int *)(a1 + 44), (__m128)*(unsigned int *)(a1 + 44), 0).m128_u32[0];
  if ( a3 )
  {
  ...
  {
    v21 = *(_DWORD *)(a1 + 64);
    v22 = *(_QWORD *)(a1 + 56) + (int)((v17 + 1) * v21);
    VertexTransfer::CSimdNonScale2DOperator<Vertex_UVxN<VertexXYW_ColorDW_WorldXYZ_Tangent>>::Transform(
      (unsigned int)v42,
      *(_DWORD *)v5 + v17 * *(_DWORD *)(v5 + 8),
      *(_DWORD *)v5 + v17 * *(_DWORD *)(v5 + 8),
      *(_DWORD *)v5 + *(_DWORD *)(v5 + 8) * (v17 + 1),
      v13,
      *(_QWORD *)(a1 + 56) + (int)(v17 * v21));
    v24 = (float)((float)(_mm_cvtepi32_ps(
                            _mm_xor_si128(
    ...
    *(__m128 *)(v22 + 16) = v31;
    *(_OWORD *)(v22 + 32) = v15;
    v32 = DirectX::PackedVector::XMConvertFloatToHalf(v26, v24);
    *(_WORD *)(v33 + 28) = v32;
    v35 = DirectX::PackedVector::XMConvertFloatToHalf(v34, v24);
    *(_WORD *)(v36 + 30) = v35;
    *(_WORD *)(v22 + 28) = DirectX::PackedVector::XMConvertFloatToHalf(v37, v24);
    LOWORD(v4) = DirectX::PackedVector::XMConvertFloatToHalf(v38, v24);
    v17 = v39 + 2;
  }
  return (__int16)v4;
}
