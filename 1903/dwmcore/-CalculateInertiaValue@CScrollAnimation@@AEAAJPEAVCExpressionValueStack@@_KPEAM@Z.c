/*
 * XREFs of ?CalculateInertiaValue@CScrollAnimation@@AEAAJPEAVCExpressionValueStack@@_KPEAM@Z @ 0x180206F34
 * Callers:
 ...
 *     ?ToSeconds@TimeDelta@@QEBAMXZ @ 0x1801E7180 (-ToSeconds@TimeDelta@@QEBAMXZ.c)
