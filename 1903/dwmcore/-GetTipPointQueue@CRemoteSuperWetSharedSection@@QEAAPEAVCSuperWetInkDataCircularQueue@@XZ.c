/*
 * XREFs of ?GetTipPointQueue@CRemoteSuperWetSharedSection@@QEAAPEAVCSuperWetInkDataCircularQueue@@XZ @ 0x1801BC6F8
 * Callers:
 *     ?IsSuperWetCompatible@CRemoteSuperWetSource@@UEAA_NPEAVID2DContext@@AEBUDCompWetInkStrokeRenderState@@@Z @ 0x1801B2A20 (-IsSuperWetCompatible@CRemoteSuperWetSource@@UEAA_NPEAVID2DContext@@AEBUDCompWetInkStrokeRenderS.c)
