/*
 * XREFs of ?AddHolographicDisplay@CHolographicManager@@QEAA_NPEAVCHolographicDisplay@@@Z @ 0x180240CBC
 * Callers:
 *     ?OnChanged@CHolographicDisplay@@AEAAXXZ @ 0x180244538 (-OnChanged@CHolographicDisplay@@AEAAXXZ.c)
 * Callees:
