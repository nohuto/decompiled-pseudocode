/*
 * XREFs of ?HrInit@CSystemMemoryBitmap@@UEAAJPEAVIBitmapSource@@@Z @ 0x180222CD0
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall CSystemMemoryBitmap::HrInit(CSystemMemoryBitmap *this, struct IBitmapSource *a2)
{
  ...
  if ( inited >= 0 )
  {
    ...
    *((_DWORD *)this + 60) = v9;
    if ( v6 < 0 )
    {
      MilInstrumentationCheckHR_MaybeFailFast(v9, 0LL, 0, v6, 0x17Eu, 0LL);
      goto LABEL_18;
    }
    inited = HrMalloc(v9, *((unsigned int *)this + 43), (void **)this + 29);
    v6 = inited;
    if ( inited < 0 )
    {
      v19 = 390;
    ...
    v14 = *(_QWORD *)a2;
    v20[3] = v10;
    v15 = (*(__int64 (__fastcall **)(struct IBitmapSource *, _DWORD *, __int64, _QWORD, _QWORD))(v14 + 48))(
            a2,
            v20,
            v12,
    ...
    MilInstrumentationCheckHR_MaybeFailFast(v16, 0LL, 0, v15, 0x190u, 0LL);
LABEL_17:
    if ( v6 >= 0 )
      return (unsigned int)v6;
    goto LABEL_18;
