/*
 * XREFs of ?WaitForWork@CPartitionVerticalBlankScheduler@@AEAAXXZ @ 0x1800943DC
 * Callers:
 ...
 *     ?UpdateGlitchList@CDebugFrameCounter@@IEAAXAEA_K@Z @ 0x180193890 (-UpdateGlitchList@CDebugFrameCounter@@IEAAXAEA_K@Z.c)
 */
...
void __fastcall CPartitionVerticalBlankScheduler::WaitForWork(CPartitionVerticalBlankScheduler *this)
{
  ...
  {
LABEL_53:
    D3DObjects = CD3DModuleLoaderInternal::CreateD3DObjects(this, &qword_18033CC08);
    TranslateDXGIorD3DErrorInContext(D3DObjects, 4, &D3DObjects);
    v5 = D3DObjects;
    if ( D3DObjects < 0 )
      MilInstrumentationCheckHR_MaybeFailFast(v25, &dword_1802BFEC8, 1u, D3DObjects, 0xFEu, 0LL);
    if ( qword_18033CC18 )
