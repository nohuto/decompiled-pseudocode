/*
 * XREFs of ?PreallocateGraphObjects@Mesh@@AEAAJ_N@Z @ 0x180088C48
 * Callers:
  ...
  *(_QWORD *)this = v11;
  ...
  if ( v11 )
  {
    *((_DWORD *)this + 2) = v5;
    ...
    if ( v15 < 0 )
    {
      MilInstrumentationCheckHR_MaybeFailFast((unsigned int)v14, 0LL, 0, v15, 0x7Eu, 0LL);
    }
    else
    {
      if ( v6 != &v21 )
  ...
  {
    v15 = -2147024882;
    MilInstrumentationCheckHR_MaybeFailFast((unsigned int)v12, 0LL, 0, -2147024882, 0x7Au, 0LL);
  }
  if ( v21 )
