/*
 * XREFs of ?ClipToPolygon@ClipPlaneIterator@@QEAAJPEAVCPolygon@@AEBVCMILMatrix@@AEBV?$TMilRect_@HUtagRECT@@UMilPointAndSizeL@@U_CMILSurfaceRect_@RectUniqueness@@@@@Z @ 0x18017A85C
 * Callers:
 ...
 *     ?ResetToStart@ClipPlaneIterator@@AEAAXXZ @ 0x18017AE0C (-ResetToStart@ClipPlaneIterator@@AEAAXXZ.c)
