/*
 * XREFs of ?ApplyPositionImpulse@CInteractionTracker@@AEAA_NAEBUD2DVector3@@@Z @ 0x1801D8EF4
 * Callers:
...
char __fastcall CInteractionTracker::ApplyPositionImpulse(CInteractionTracker *this, const struct D2DVector3 *a2)
{
  ...
  if ( !v2 || (unsigned int)(v2 - 2) <= 1 )
  {
    ...
    {
      v6 = *(float *)a2;
      v7 = (*(__int64 (__fastcall **)(_QWORD))(**((_QWORD **)this + 41) + 312LL))(*((_QWORD *)this + 41));
      *(float *)(v7 + 40) = v6 + *(float *)(v7 + 40);
      v8 = *((float *)a2 + 1);
      v9 = (*(__int64 (__fastcall **)(_QWORD))(**((_QWORD **)this + 42) + 312LL))(*((_QWORD *)this + 42));
