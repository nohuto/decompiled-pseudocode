/*
 * XREFs of ?AddMultipleAndSet@?$DynArray@VCZOrderedRect@@$0A@@@QEAAJPEFBVCZOrderedRect@@I@Z @ 0x18008BB94
 * Callers:
...
__int64 __fastcall DynArray<CZOrderedRect,0>::AddMultipleAndSet(__int64 *a1, __int64 a2)
{
  ...
  {
    v6 = -2147024362;
    MilInstrumentationCheckHR_MaybeFailFast((unsigned int)a1, 0LL, 0, -2147024362, 0xB8u, 0LL);
  }
  else
  {
    v6 = 0;
