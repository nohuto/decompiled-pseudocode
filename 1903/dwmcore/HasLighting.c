/*
 * XREFs of HasLighting @ 0x18003119C
 * Callers:
 *     GetExpectedVertexShaderDesc @ 0x180031238 (GetExpectedVertexShaderDesc.c)
 * Callees:
 *     ??9details@gsl@@YA_NV?$span_iterator@V?$span@$$CBW4ShaderLinkingArgument@@$0?0@gsl@@$0A@@01@0@Z @ 0x180032B90 (--9details@gsl@@YA_NV-$span_iterator@V-$span@$$CBW4ShaderLinkingArgument@@$0-0@gsl@@$0A@@01@0@Z.c)
