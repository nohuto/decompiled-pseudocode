/*
 * XREFs of ?ProcessInsertChildAt@CVisual@@QEAAJPEBVCResourceTable@@PEBUtagMILCMD_VISUAL_INSERTCHILDAT@@@Z @ 0x18007D5D4
 * Callers:
        ...
        const struct tagMILCMD_VISUAL_INSERTCHILDAT *a3)
{
  ...
  if ( v3
    ...
    && (*(unsigned __int8 (__fastcall **)(CVisual *, __int64))(*(_QWORD *)this + 48LL))(this, 189LL) )
  {
  ...
  if ( v9 )
  {
    ...
    v12 = inserted;
    if ( inserted < 0 )
      MilInstrumentationCheckHR_MaybeFailFast(v11, 0LL, 0, inserted, 0xD43u, 0LL);
  }
  else
  {
    v12 = -2003303421;
    MilInstrumentationCheckHR_MaybeFailFast((unsigned int)this, 0LL, 0, -2003303421, 0xD40u, 0LL);
  }
  return v12;
}
