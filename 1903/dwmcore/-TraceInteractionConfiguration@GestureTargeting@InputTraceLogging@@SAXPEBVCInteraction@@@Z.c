/*
 * XREFs of ?TraceInteractionConfiguration@GestureTargeting@InputTraceLogging@@SAXPEBVCInteraction@@@Z @ 0x180016B38
 * Callers:
...
void __fastcall InputTraceLogging::GestureTargeting::TraceInteractionConfiguration(const struct CInteraction *a1)
{
  ...
  if ( *(_DWORD *)v7 > 4u && TlgKeywordOn(v7, 0x800uLL) )
  {
    ...
    v80 = v9;
    v82 = v9;
    TlgWrite(v8, &unk_1802DD94B, 0LL, 0LL, 0x16u, &pData);
  }
}
