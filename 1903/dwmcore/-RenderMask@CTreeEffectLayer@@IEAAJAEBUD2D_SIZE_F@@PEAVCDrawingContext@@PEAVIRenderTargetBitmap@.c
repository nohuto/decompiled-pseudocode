/*
 * XREFs of ?RenderMask@CTreeEffectLayer@@IEAAJAEBUD2D_SIZE_F@@PEAVCDrawingContext@@PEAVIRenderTargetBitmap@@@Z @ 0x18017D990
 * Callers:
        ...
        struct IRenderTargetBitmap *a4)
{
  ...
  *(float *)&v18[3] = v11;
  ...
  v12 = CRenderTargetImageSource::Create(a4, 1, 0LL, &v17);
  v14 = v12;
  if ( v12 < 0 )
  {
  ...
  else
  {
    ...
    v14 = v15;
    if ( v15 < 0 )
      MilInstrumentationCheckHR_MaybeFailFast(v16, 0LL, 0, v15, 0x3B5u, 0LL);
  }
  Microsoft::WRL::ComPtr<ID3D11Device5>::InternalRelease((__int64 *)&v17);
  return v14;
}
