/*
 * XREFs of ?SetRenderingEffectState@CD3DBatchExecutionContext@@QEAAJPEBVCRenderingEffect@@@Z @ 0x1801B8D88
 * Callers:
        ...
        const struct CRenderingEffect *a2)
{
  ...
  if ( v4 < 0 )
  {
    MilInstrumentationCheckHR_MaybeFailFast(v5, 0LL, 0, v4, 0x1BEu, 0LL);
  }
  else
  {
    v7 = *((_QWORD *)this + 4);
    ...
    if ( v8 >= 0 )
    {
      ...
      if ( v9 != *((_BYTE *)this + 72) || (_BYTE)v13 != *((_BYTE *)this + 73) || (_DWORD)v12 != *((_DWORD *)this + 19) )
      {
        ...
        (*(void (__fastcall **)(_QWORD, _QWORD))(**((_QWORD **)this + 2) + 136LL))(
          *((_QWORD *)this + 2),
          *(_QWORD *)(*((_QWORD *)this + 1) + ((_BYTE)v13 != 0 ? 1280LL : 1248LL) + v14));
        *((_QWORD *)this + 9) = v16;
        *((_BYTE *)this + 81) = 1;
      }
    }
