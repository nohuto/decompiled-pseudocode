/*
 * XREFs of ?GetProperty@CSurfaceBrush@@UEAAJIPEAVCExpressionValue@@@Z @ 0x1801FBFB0
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall CSurfaceBrush::GetProperty(CSurfaceBrush *this, int a2, struct CExpressionValue *a3)
{
  ...
  {
    v4 = -2147024809;
    MilInstrumentationCheckHR_MaybeFailFast(v6, 0LL, v7, 0x80070057, 0x4Au, (void *)(v7 & v10));
  }
  return v4;
}
