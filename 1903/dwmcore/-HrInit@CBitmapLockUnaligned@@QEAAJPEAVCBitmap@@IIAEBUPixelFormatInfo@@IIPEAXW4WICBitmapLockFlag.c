/*
 * XREFs of ?HrInit@CBitmapLockUnaligned@@QEAAJPEAVCBitmap@@IIAEBUPixelFormatInfo@@IIPEAXW4WICBitmapLockFlags@@II@Z @ 0x180223938
 * Callers:
 ...
 *     ?ReadUnalignedScanline@@YAXPEAEPEBEII@Z @ 0x180223B78 (-ReadUnalignedScanline@@YAXPEAEPEBEII@Z.c)
 */
        ...
        unsigned int a11)
{
  ...
  *((_QWORD *)this + 18) = v12;
  ...
  else
  {
    v22 = -2147024362;
    v19 = 0;
    MilInstrumentationCheckHR_MaybeFailFast(v15, 0LL, 0, 0x80070216, 0x95u, 0LL);
    v18 = v13;
  }
  lpMem = v17;
  v23 = v13 * v19;
  ...
  v27 = CBitmapLock::HrInit(
          v11,
          (struct IBitmapUnlock *)(((unsigned __int64)a2 + 32) & -(__int64)(a2 != 0LL)),
          a3,
          v13,
          a5,
          v19,
