/*
 * XREFs of ??$ResolveProhibitedMotion@UDwmTouchpadInteractionConfigurationPrimitive@@W4FlagsEnum@DwmInteractionTypeTouchpadPrimitiveType@@@CInteractionProcessor@@AEAA_NAEBV?$DynArray@UDwmTouchpadInteractionConfigurationPrimitive@@$0A@@@PEAUInteractionAxis@@PEAW4InteractionState@@@Z @ 0x18022EA48
 * Callers:
 ...
 *     _anonymous_namespace_::AxisContainsInteraction @ 0x18022F250 (_anonymous_namespace_--AxisContainsInteraction.c)
 */
    ...
    if ( v13 >= *(_DWORD *)(*a2 + 4 * v12) && v13 <= *(_DWORD *)(v11 + 4 * v12 + 4) )
    {
      ...
      *(_DWORD *)(v17 + 8) = v16;
      ...
      if ( dword_18033A240 > 4u && TlgKeywordOn((TraceLoggingHProvider)&dword_18033A240, 2uLL) )
      {
        ...
        v95 = 4LL;
        v97 = 4LL;
        TlgWrite((TraceLoggingHProvider)&dword_18033A240, &unk_1802DE0AD, 0LL, 0LL, 0x1Cu, &pData);
        v9 = v23;
      }
    }
    v23 = ++v9;
