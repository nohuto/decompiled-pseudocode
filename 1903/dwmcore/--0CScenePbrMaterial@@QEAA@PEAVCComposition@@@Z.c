/*
 * XREFs of ??0CScenePbrMaterial@@QEAA@PEAVCComposition@@@Z @ 0x18019DB54
 * Callers:
 *     ??0CSceneMetallicRoughnessMaterial@@QEAA@PEAVCComposition@@@Z @ 0x18019DAD0 (--0CSceneMetallicRoughnessMaterial@@QEAA@PEAVCComposition@@@Z.c)
 * Callees:
...
CScenePbrMaterial *__fastcall CScenePbrMaterial::CScenePbrMaterial(CScenePbrMaterial *this, struct CComposition *a2)
{
  ...
  *(_WORD *)(v4 + 24) = 257;
  *((_QWORD *)this + 8) = v4;
  CSceneResourceManager::RegisterSceneListener(*(CSceneResourceManager **)(*((_QWORD *)this + 2) + 128LL), v2);
  *((_DWORD *)this + 21) = 0;
  *((_DWORD *)this + 22) = 0;
  *((_DWORD *)this + 23) = 0;
  *((_DWORD *)this + 24) = 0;
