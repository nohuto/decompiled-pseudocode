/*
 * XREFs of ?RemoveAll@?$CMap@PEAVCPolygon@@PEAUID2D1PrivateCompositorCommandList@@V?$CMapEqualHelper@PEAVCPolygon@@PEAUID2D1PrivateCompositorCommandList@@@@@@QEAAXXZ @ 0x18016B3B4
 * Callers:
 *     ??1CD2DCommandList@@MEAA@XZ @ 0x18016AEA8 (--1CD2DCommandList@@MEAA@XZ.c)
 *     ?ReleaseD2DResources@CD2DCommandList@@UEAAXXZ @ 0x18016B370 (-ReleaseD2DResources@CD2DCommandList@@UEAAXXZ.c)
