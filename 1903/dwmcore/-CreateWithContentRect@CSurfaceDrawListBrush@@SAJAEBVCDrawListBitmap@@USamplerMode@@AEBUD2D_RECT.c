/*
 * XREFs of ?CreateWithContentRect@CSurfaceDrawListBrush@@SAJAEBVCDrawListBitmap@@USamplerMode@@AEBUD2D_RECT_F@@PEAPEAV1@@Z @ 0x180051ED4
 * Callers:
...
__int64 __fastcall CSurfaceDrawListBrush::CreateWithContentRect(__int64 a1, __int16 *a2, float *a3, __int64 *a4)
{
  ...
  v8 = 0;
  (*(void (__fastcall **)(_QWORD, __int128 *))(**(_QWORD **)(a1 + 8) + 40LL))(*(_QWORD *)(a1 + 8), &v24);
  v25[1] = 0.0;
  v25[2] = 0.0;
  v25[3] = 0.0;
  v25[5] = 0.0;
  ...
  if ( v13 || (v15 = DefaultHeap::Alloc(0x98uLL), (v13 = v15) != 0LL) )
  {
    v22 = *a2;
    v23 = *((_BYTE *)a2 + 2);
    v15 = (_QWORD *)CSurfaceDrawListBrush::CSurfaceDrawListBrush((__int64)v13, (__int64 *)a1, (__int64)&v22, v25);
  }
  *a4 = (__int64)v15;
  if ( v15 )
  {
