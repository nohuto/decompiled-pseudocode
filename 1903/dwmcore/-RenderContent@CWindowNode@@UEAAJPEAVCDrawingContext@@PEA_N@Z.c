/*
 * XREFs of ?RenderContent@CWindowNode@@UEAAJPEAVCDrawingContext@@PEA_N@Z @ 0x18004EEE0
 * Callers:
 *     <none>
 * Callees:
...
LABEL_4:
    ...
    v13 = 0;
    if ( BYTE4(qword_180340430) )
      v13 = -2003304307;
    if ( v13 < 0 )
    {
      MilInstrumentationCheckHR_MaybeFailFast(0x8898008D, &dword_1802920EC, 1u, v13, 0x467u, 0LL);
    }
    else
    {
      v14 = 0;
      ...
      {
        while ( __PAIR64__(HIDWORD(v71), v11) != *(_QWORD *)(qword_1803403E0 + 24LL * v14 + 8) )
        {
          if ( ++v14 >= (unsigned int)qword_180340430 )
            goto LABEL_45;
        }
        v12 = *(_QWORD *)(qword_1803403E0 + 24LL * v14);
...
LABEL_27:
    ...
    if ( v18 )
    {
        ...
        && (*(_BYTE *)(v49 + 268) & 2) != 0 )
      {
        ...
        if ( v56 < 0 )
        {
          MilInstrumentationCheckHR_MaybeFailFast(v57, 0LL, 0, v56, 0x881u, 0LL);
      ...
      else
      {
        ...
        if ( v10 < 0 )
        {
          MilInstrumentationCheckHR_MaybeFailFast(v65, 0LL, 0, v10, 0x86Bu, 0LL);
          goto LABEL_29;
        }
      }
    }
