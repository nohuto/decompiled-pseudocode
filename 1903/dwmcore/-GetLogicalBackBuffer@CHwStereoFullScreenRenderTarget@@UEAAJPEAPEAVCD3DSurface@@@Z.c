/*
 * XREFs of ?GetLogicalBackBuffer@CHwStereoFullScreenRenderTarget@@UEAAJPEAPEAVCD3DSurface@@@Z @ 0x1801668E0
 * Callers:
 *     <none>
 * Callees:
        ...
        struct CD3DSurface **a2)
{
  ...
  if ( CHwDisplayRenderTarget::IsValid((CHwStereoFullScreenRenderTarget *)((char *)this - 144)) )
  {
