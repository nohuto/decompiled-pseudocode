/*
 * XREFs of ?ActivateView@CHolographicExclusiveView@@QEAA_NPEAVCHolographicClient@@@Z @ 0x180244C28
 * Callers:
...
bool __fastcall CHolographicExclusiveView::ActivateView(CHolographicExclusiveView *this, struct CHolographicClient *a2)
{
  ...
  else
  {
    ...
    {
      MilInstrumentationCheckHR_MaybeFailFast(v7, 0LL, 0, 0x80004005, 0xCEu, 0LL);
LABEL_8:
