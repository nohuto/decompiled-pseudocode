/*
 * XREFs of ?GetBounds@CGlyphRunContent@@UEBAJPEAVCContentBounder@@PEBUD2D_SIZE_F@@PEAV?$TMilRect_@MUMilRectF@@UMilPointAndSizeF@@UNotNeeded@RectUniqueness@@@@@Z @ 0x180206950
 * Callers:
 *     <none>
 * Callees:
