/*
 * XREFs of ?OnInteractionTrackerTransitionToIdle@InteractionSourceManager@@QEAAXW4ScrollState@@@Z @ 0x18021F0C4
 * Callers:
    ...
    if ( v2 == 2 )
    {
      ...
      while ( v3 != v4 )
      {
        v5 = (CManipulation **)(*(_QWORD *)(*((_QWORD *)a1 + 11) + 8 * ((*((_QWORD *)a1 + 12) - 1LL) & (v3 >> 1)))
                              + 8 * (v3 & 1));
        CManipulation::SetCaptureState_RenderThread(*v5, 0);
