/*
 * XREFs of ?HrConvertBitmap@CFormatConverter@@SAJPEAVIBitmapSource@@AEBUPixelFormatInfo@@PEAPEAV2@@Z @ 0x1802246B0
 * Callers:
 ...
 *     ??0CFormatConverter@@QEAA@XZ @ 0x180223D90 (--0CFormatConverter@@QEAA@XZ.c)
