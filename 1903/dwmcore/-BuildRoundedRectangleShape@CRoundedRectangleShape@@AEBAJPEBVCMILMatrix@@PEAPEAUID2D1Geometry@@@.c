/*
 * XREFs of ?BuildRoundedRectangleShape@CRoundedRectangleShape@@AEBAJPEBVCMILMatrix@@PEAPEAUID2D1Geometry@@@Z @ 0x180017FCC
 * Callers:
    ...
    while ( 1 )
    {
      if ( *v9 )
      {
        v10 = CRoundedRectangleShape::IntersectGeometryBuilder(
                ...
                &dword_180283090[7 * v7],
                &v16,
                v8);
        v6 = v10;
        if ( v10 < 0 )
        {
          MilInstrumentationCheckHR_MaybeFailFast(v4, 0LL, 0, v10, 0x13Fu, 0LL);
LABEL_8:
          if ( v6 < 0 )
