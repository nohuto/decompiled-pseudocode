/*
 * XREFs of McTemplateU0nxxxqqxqqqqqqqqx @ 0x18025DDE0
 * Callers:
 *     ?ProcessSurfaceUpdate@CGlobalCompositionSurfaceInfo@@UEAAJAEBUCSM_SURFACE_UPDATE@@@Z @ 0x18003C4F0 (-ProcessSurfaceUpdate@CGlobalCompositionSurfaceInfo@@UEAAJAEBUCSM_SURFACE_UPDATE@@@Z.c)
 * Callees:
        ...
        char a18)
{
  ...
  v53 = 4LL;
  v55 = 8LL;
  return McGenEventWrite(Microsoft_Windows_Dwm_Core_Provider_Context, &EVTDESC_SCHEDULE_SURFACEUPDATE, 0LL, 0x11u, &v23);
}
