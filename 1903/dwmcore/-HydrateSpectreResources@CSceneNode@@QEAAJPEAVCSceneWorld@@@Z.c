/*
 * XREFs of ?HydrateSpectreResources@CSceneNode@@QEAAJPEAVCSceneWorld@@@Z @ 0x1801F9838
 * Callers:
  ...
  if ( !*((_QWORD *)this + 14) )
  {
    ...
    *((_QWORD *)this + 14) = a2;
    if ( v4 )
    {
      ...
      wil::com_ptr_t<ID3D12Fence,wil::err_returncode_policy>::reset((__int64 *)this + 16);
      v10 = v9(v8, v5);
      v12 = v10;
      if ( v10 < 0 )
      {
    ...
    {
      v6 = (*(__int64 (__fastcall **)(_QWORD))(**((_QWORD **)a2 + 8) + 24LL))(*((_QWORD *)a2 + 8));
      v7 = *v5;
      *v5 = v6;
      if ( v6 )
