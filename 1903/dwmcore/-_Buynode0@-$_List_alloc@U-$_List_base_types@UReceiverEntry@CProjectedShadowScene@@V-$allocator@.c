/*
 * XREFs of ?_Buynode0@?$_List_alloc@U?$_List_base_types@UReceiverEntry@CProjectedShadowScene@@V?$allocator@UReceiverEntry@CProjectedShadowScene@@@std@@@std@@@std@@QEAAPEAU?$_List_node@UReceiverEntry@CProjectedShadowScene@@PEAX@2@PEAU32@0@Z @ 0x180003B34
 * Callers:
 *     ??0CProjectedShadowScene@@QEAA@PEAVCComposition@@@Z @ 0x18000390C (--0CProjectedShadowScene@@QEAA@PEAVCComposition@@@Z.c)
