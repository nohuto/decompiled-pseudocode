/*
 * XREFs of ?GenerateSurfaceBrush@CProjectedShadow@@AEAAJPEAVCDrawingContext@@PEAVCRenderTargetImageSource@@AEAV?$TMilRect_@MUMilRectF@@UMilPointAndSizeF@@UNotNeeded@RectUniqueness@@@@AEAV?$ComPtr@VCSurfaceBrush@@@WRL@Microsoft@@@Z @ 0x1801F17DC
 * Callers:
        ...
        __int64 *a5)
{
  ...
  else
  {
    ...
    *(_DWORD *)(v14 + 88) = 0;
    ...
    v16 = *a5 + SDWORD2(xmmword_18033B978);
    v19[0] = 0;
    ((void (__fastcall *)(__int64, void *, _DWORD *))xmmword_18033B978)(
      v16,
      &CSurfaceBrush::sc_HorizontalAlignment,
      v19);
    v17 = *a5 + SDWORD2(xmmword_18033B9B0);
    v19[0] = 0;
    ((void (__fastcall *)(__int64, void *, _DWORD *))xmmword_18033B9B0)(v17, &CSurfaceBrush::sc_VerticalAlignment, v19);
    v13 = 0;
  }
  if ( v10 )
