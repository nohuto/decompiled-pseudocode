/*
 * XREFs of ?CopyPixels@CD2DBitmap@@UEBAJAEBV?$TMilRect@IUMilRectU@@UNotNeeded@RectUniqueness@@@@IIPEAE@Z @ 0x180018740
 * Callers:
 *     <none>
 * Callees:
        ...
        unsigned __int8 *a5)
{
  ...
  else
  {
    ...
    else
    {
      ...
      if ( v16 < 0 )
      {
        MilInstrumentationCheckHR_MaybeFailFast(v17, 0LL, 0, v16, 0x10Bu, 0LL);
        v6 = v27;
        goto LABEL_7;
      }
      v6 = v27;
  ...
  MilInstrumentationCheckHR_MaybeFailFast(v13, 0LL, 0, v23, v24, 0LL);
LABEL_7:
  if ( v29 )
