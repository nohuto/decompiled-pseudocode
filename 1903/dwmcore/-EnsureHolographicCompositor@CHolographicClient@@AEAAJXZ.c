/*
 * XREFs of ?EnsureHolographicCompositor@CHolographicClient@@AEAAJXZ @ 0x180248D40
 * Callers:
 *     ?Initialize@CHolographicClient@@AEAAJXZ @ 0x180249034 (-Initialize@CHolographicClient@@AEAAJXZ.c)
 * Callees:
 *     ?InternalRelease@?$ComPtr@VID2DBitmap@@@WRL@Microsoft@@IEAAKXZ @ 0x18001F5BC (-InternalRelease@-$ComPtr@VID2DBitmap@@@WRL@Microsoft@@IEAAKXZ.c)
 *     IsCreateHolographicCompositorPresent @ 0x1800E9318 (IsCreateHolographicCompositorPresent.c)
