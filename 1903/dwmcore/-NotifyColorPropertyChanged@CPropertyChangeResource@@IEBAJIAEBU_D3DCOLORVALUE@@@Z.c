/*
 * XREFs of ?NotifyColorPropertyChanged@CPropertyChangeResource@@IEBAJIAEBU_D3DCOLORVALUE@@@Z @ 0x1801CE3B4
 * Callers:
        ...
        const struct _D3DCOLORVALUE *a3)
{
  ...
  if ( CPropertyChangeResource::ShouldNotify(this, a2) )
  {
    ...
    LOWORD(v13) = 4;
    v3 = CoreUICallSend(v9, v14, 2LL, 13LL, v13, &unk_1802B2EAD, v6, &v15);
    if ( v3 == -2018375675 )
      v3 = 0;
    if ( v3 < 0 )
