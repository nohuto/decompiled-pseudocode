/*
 * XREFs of ?FillXBRPass1Buffer@@YAJPEAVCSurfaceShaderComposer@@II@Z @ 0x18017FBAC
 * Callers:
...
__int64 __fastcall FillXBRPass1Buffer(struct CSurfaceShaderComposer *a1, int a2, int a3)
{
  ...
  *(_QWORD *)&v6[2] = v7;
  v7[0] = (float)a2;
  v7[1] = (float)a3;
  v3 = CSurfaceShaderComposer::SetScratchConstantBuffer((__int64)a1, (const void **)v6, D3D11_USAGE_DEFAULT);
  v4 = v3;
  if ( v3 >= 0 )
    return 0LL;
