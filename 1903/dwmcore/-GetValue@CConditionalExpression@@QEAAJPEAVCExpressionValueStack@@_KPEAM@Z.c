/*
 * XREFs of ?GetValue@CConditionalExpression@@QEAAJPEAVCExpressionValueStack@@_KPEAM@Z @ 0x1801D4740
 * Callers:
 ...
 *     ?Accelerate@CExpressionForce@@UEAAMPEAUIntegrationState@@M@Z @ 0x180220740 (-Accelerate@CExpressionForce@@UEAAMPEAUIntegrationState@@M@Z.c)
 * Callees:
 ...
 *     ?GetDebugTargetInfo@CConditionalExpression@@AEBA?AUDebugTargetInfo@1@XZ @ 0x1801D4674 (-GetDebugTargetInfo@CConditionalExpression@@AEBA-AUDebugTargetInfo@1@XZ.c)
        ...
        float *a4)
{
  ...
  v4 = *(_QWORD *)this;
  *a4 = 0.0;
  v9 = (*(__int64 (__fastcall **)(CConditionalExpression *, struct CExpressionValueStack *, unsigned __int64, __int64 *))(v4 + 240))(
         this,
         a2,
         a3,
         &v19);
