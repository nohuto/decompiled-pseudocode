/*
 * XREFs of ?WindowNodeSetSpriteImage@CChannel@@UEAAJII@Z @ 0x1800D1280
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall CChannel::WindowNodeSetSpriteImage(CChannel *this, unsigned int a2, unsigned int a3)
{
  unsigned int v6; // ebx
  ...
  CChannel::CheckOptionalHandle((__int64)this, a3, 60LL);
  v8[0] = 531;
  v8[1] = a2;
  v8[2] = a3;
