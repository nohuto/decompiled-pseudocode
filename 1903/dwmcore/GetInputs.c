/*
 * XREFs of GetInputs @ 0x1800D2CD8
 * Callers:
...
_QWORD *__fastcall GetInputs(_QWORD *a1, int a2)
{
  ...
  if ( dword_180340270 > *(_DWORD *)(*((_QWORD *)NtCurrentTeb()->ThreadLocalStoragePointer + (unsigned int)tls_index)
                                   + 4LL) )
  {
    Init_thread_header(&dword_180340270);
    if ( dword_180340270 == -1 )
    {
      dword_18033AD12 = 33620480;
      word_18033AD0E = 513;
      Init_thread_footer(&dword_180340270);
    }
  }
  if ( a2 )
  {
