/*
 * XREFs of ?EnsureSceneCompositor@CSceneResourceManager@@AEAAJXZ @ 0x18017BC10
 * Callers:
 ...
 *     ?GetAdapterLuid@CDXGIEnumeration@@QEBA?AU_LUID@@I@Z @ 0x1800A4E74 (-GetAdapterLuid@CDXGIEnumeration@@QEBA-AU_LUID@@I@Z.c)
 ...
 *     ??$?8VCD3DDeviceLevel1@@Uerr_returncode_policy@wil@@@wil@@YA_NAEBV?$com_ptr_t@VCD3DDeviceLevel1@@Uerr_returncode_policy@wil@@@0@$$T@Z @ 0x18017B680 (--$-8VCD3DDeviceLevel1@@Uerr_returncode_policy@wil@@@wil@@YA_NAEBV-$com_ptr_t@VCD3DDeviceLevel1@.c)
 ...
 *     ?reset@?$unique_storage@U?$resource_policy@PEAUHINSTANCE__@@P6AHPEAU1@@Z$1?FreeLibrary@@YAH0@ZU?$integral_constant@_K$0A@@wistd@@PEAU1@PEAU1@$0A@$$T@details@wil@@@details@wil@@QEAAXPEAUHINSTANCE__@@@Z @ 0x18017C8AC (-reset@-$unique_storage@U-$resource_policy@PEAUHINSTANCE__@@P6AHPEAU1@@Z$1-FreeLibrary@@YAH0@ZU-.c)
