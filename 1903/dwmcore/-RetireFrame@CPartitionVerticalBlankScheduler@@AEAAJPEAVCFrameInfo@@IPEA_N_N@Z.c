/*
 * XREFs of ?RetireFrame@CPartitionVerticalBlankScheduler@@AEAAJPEAVCFrameInfo@@IPEA_N_N@Z @ 0x1800A52D4
 * Callers:
        ...
        bool a5)
{
  ...
  while ( v10 < *((_DWORD *)a2 + 118) && v10 < *(_DWORD *)(*((_QWORD *)v6 + 3237) + 472LL) )
  {
    ...
    {
      v63 = 1;
      MilInstrumentationCheckHR_MaybeFailFast((__int64)this, &dword_1802C02F4, 1u, 0x80070057, 0x46Au, 0LL);
      MilInstrumentationCheckHR_MaybeFailFast(v57, &dword_1802C02F4, 1u, 0x80070057, 0xBD0u, 0LL);
      v12 = v10;
    }
    else
    {
...
LABEL_10:
  ...
  *((_BYTE *)a2 + 1058) = 1;
  ...
  v37 = 0;
  v38 = _InterlockedExchange64(&qword_18033C8F8, 0LL);
  dword_18033C76C += v38;
  dword_18033C770 += HIDWORD(v38);
  if ( *((_DWORD *)a2 + 284) )
  {
    do
