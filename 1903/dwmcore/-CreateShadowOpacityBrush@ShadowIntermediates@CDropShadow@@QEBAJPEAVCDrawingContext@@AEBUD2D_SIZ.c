/*
 * XREFs of ?CreateShadowOpacityBrush@ShadowIntermediates@CDropShadow@@QEBAJPEAVCDrawingContext@@AEBUD2D_SIZE_F@@MPEAPEAVCDrawListBrush@@@Z @ 0x18000E170
 * Callers:
...
LABEL_38:
    Microsoft::WRL::ComPtr<ID2DBitmap>::InternalRelease((char *)&v36 + 8);
