/*
 * XREFs of ?_Growmap@?$deque@VCMegaRect@@V?$allocator@VCMegaRect@@@std@@@std@@IEAAX_K@Z @ 0x1800B6B6C
 * Callers:
...
void *__fastcall std::deque<CMegaRect>::_Growmap(_QWORD *a1)
{
  ...
  if ( v6 >= 0x1000 )
  {
    ...
    if ( !v19 )
    {
      _o__invalid_parameter_noinfo_noreturn(v21, v20, v22, v23);
      JUMPOUT(0x180140E78LL);
    }
