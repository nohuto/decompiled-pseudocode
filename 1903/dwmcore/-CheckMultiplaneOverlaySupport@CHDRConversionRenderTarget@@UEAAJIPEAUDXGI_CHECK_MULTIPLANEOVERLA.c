/*
 * XREFs of ?CheckMultiplaneOverlaySupport@CHDRConversionRenderTarget@@UEAAJIPEAUDXGI_CHECK_MULTIPLANEOVERLAYSUPPORT_PLANE_INFO@@PEA_N1@Z @ 0x180168830
 * Callers:
 *     <none>
 * Callees:
 ...
 *     ?IsDesktopRect@CHDRConversionRenderTarget@@IEBA_NAEBUtagRECT@@@Z @ 0x18016920C (-IsDesktopRect@CHDRConversionRenderTarget@@IEBA_NAEBUtagRECT@@@Z.c)
 */
        ...
        bool *a5)
{
  ...
  *a5 = 1;
  ...
  if ( !*(_DWORD *)a3 )
  {
    v8 = (CHDRConversionRenderTarget *)((char *)this - 144);
