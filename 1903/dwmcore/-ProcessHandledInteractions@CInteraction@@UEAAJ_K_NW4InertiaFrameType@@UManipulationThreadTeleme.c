/*
 * XREFs of ?ProcessHandledInteractions@CInteraction@@UEAAJ_K_NW4InertiaFrameType@@UManipulationThreadTelemetryData@@PEAW4PointerResult@@@Z @ 0x1801D75A0
 * Callers:
 *     <none>
 * Callees:
        ...
        _DWORD *a6)
{
  ...
  if ( *((_QWORD *)a1 + 33) )
  {
    ...
    {
      a5[17] = (*(__int64 (__fastcall **)(CInteraction *, _QWORD))(*(_QWORD *)a1 + 120LL))(a1, *a5);
