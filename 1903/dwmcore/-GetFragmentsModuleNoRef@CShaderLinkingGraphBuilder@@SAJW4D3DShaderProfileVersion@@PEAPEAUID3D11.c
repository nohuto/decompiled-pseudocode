/*
 * XREFs of ?GetFragmentsModuleNoRef@CShaderLinkingGraphBuilder@@SAJW4D3DShaderProfileVersion@@PEAPEAUID3D11Module@@@Z @ 0x180032DD8
 * Callers:
...
__int64 __fastcall CShaderLinkingGraphBuilder::GetFragmentsModuleNoRef(char a1, struct ID3D11Module **a2)
{
  ...
  if ( !a1 )
  {
    ...
    if ( qword_180340800 )
      goto LABEL_4;
    v6 = D3DLoadModule(&unk_1802F90C0, 0x184FAuLL, &qword_180340800);
    v2 = v6;
    if ( v6 >= 0 )
    {
      v4 = qword_180340800;
  ...
  if ( !qword_180340120 )
  {
    v6 = D3DLoadModule(&unk_180292110, 0x207EEuLL, &qword_180340120);
    v2 = v6;
    if ( v6 >= 0 )
    {
      v4 = qword_180340120;
