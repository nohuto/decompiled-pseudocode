/*
 * XREFs of ?GetBounds@CHwDisplayRenderTarget@@UEAAXPEAUMilRectF@@@Z @ 0x1800C1310
 * Callers:
 *     ?GetBounds@CHwDisplayRenderTarget@@WJA@EAAXPEAUMilRectF@@@Z @ 0x1800EC7F0 (-GetBounds@CHwDisplayRenderTarget@@WJA@EAAXPEAUMilRectF@@@Z.c)
 * Callees:
