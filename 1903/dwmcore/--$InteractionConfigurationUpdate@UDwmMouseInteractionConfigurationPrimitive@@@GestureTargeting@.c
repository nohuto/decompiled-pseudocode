/*
 * XREFs of ??$InteractionConfigurationUpdate@UDwmMouseInteractionConfigurationPrimitive@@@GestureTargeting@InputTraceLogging@@SAXPEBUInteractionUpdate@CManipulationManager@@@Z @ 0x1800C38D4
 * Callers:
  ...
  if ( a1[12] )
  {
    ...
    do
    {
      ...
      if ( *(_DWORD *)v5 > 4u && TlgKeywordOn((TraceLoggingHProvider)v4[1], 0x800uLL) )
      {
        ...
        TlgWrite(v5, &unk_1802E033C, 0LL, 0LL, 0x1Fu, &pData);
      }
      LODWORD(v6) = v71 + 1;
      v71 = (int)v6;
    }
  ...
  else
  {
    ...
    if ( *(_DWORD *)v52 > 4u )
    {
      ...
      if ( (_BYTE)v6 )
      {
        ...
        v102 = v2;
        v103 = 4LL;
        LOBYTE(v6) = TlgWrite(v52, &unk_1802DF8BC, 0LL, 0LL, 0x10u, &pData);
      }
    }
  }
  return (char)v6;
