/*
 * XREFs of ?GetProperty@CManipulation@@UEAAJIPEAVCExpressionValue@@@Z @ 0x1801E2880
 * Callers:
 *     <none>
 * Callees:
...
LABEL_25:
  ...
  v3 = -2147024809;
  MilInstrumentationCheckHR_MaybeFailFast((__int64)this, 0LL, 0, 0x80070057, 0x203u, 0LL);
  return v3;
}
