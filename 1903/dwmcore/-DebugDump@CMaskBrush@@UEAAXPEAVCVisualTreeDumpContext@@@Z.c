/*
 * XREFs of ?DebugDump@CMaskBrush@@UEAAXPEAVCVisualTreeDumpContext@@@Z @ 0x1801E4A30
 * Callers:
 *     <none>
 * Callees:
...
void __fastcall CMaskBrush::DebugDump(CMaskBrush *this, struct CVisualTreeDumpContext *a2)
{
  _QWORD v4[4]; // [rsp+20h] [rbp-38h] BYREF

  CSpriteVisualContent::DebugDump(this, a2);
  std::string::string(v4, (__int64)"CMaskBrush");
  std::string::operator=(a2, v4);
  std::string::_Tidy_deallocate((__int64)v4);
  std::string::string(v4, (__int64)"Mask");
  ...
  CVisualTreeDumpContext::AddLinkInternal<CSpriteVisualContent>((__int64 *)a2, (__int64)v4, *((_QWORD *)this + 11));
  std::string::_Tidy_deallocate((__int64)v4);
}
