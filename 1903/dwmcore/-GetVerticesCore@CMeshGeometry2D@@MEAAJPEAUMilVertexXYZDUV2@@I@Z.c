/*
 * XREFs of ?GetVerticesCore@CMeshGeometry2D@@MEAAJPEAUMilVertexXYZDUV2@@I@Z @ 0x180217CA0
 * Callers:
 *     <none>
 * Callees:
        ...
        unsigned int a3)
{
  ...
  {
    v6 = -2147024809;
    MilInstrumentationCheckHR_MaybeFailFast(v8, 0LL, 0, 0x80070057, 0x12Du, 0LL);
  }
  return v6;
}
