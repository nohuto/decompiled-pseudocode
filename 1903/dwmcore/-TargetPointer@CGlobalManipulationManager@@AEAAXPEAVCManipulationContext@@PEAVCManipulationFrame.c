/*
 * XREFs of ?TargetPointer@CGlobalManipulationManager@@AEAAXPEAVCManipulationContext@@PEAVCManipulationFrame@@KPEAPEAX@Z @ 0x18023AE50
 * Callers:
 ...
 *     ?IsRoute@TargetingInfo@@QEBA_NXZ @ 0x1802385B0 (-IsRoute@TargetingInfo@@QEBA_NXZ.c)
  ...
  if ( (*((_DWORD *)v10 + 3) & 0x40004) != 0 || CManipulationFrame::IsMousewheelFrame(a3) )
  {
    ...
    if ( dword_18033A240 > 4u && TlgKeywordOn((TraceLoggingHProvider)&dword_18033A240, 2uLL) )
    {
      ...
      *((_QWORD *)&v47 + 1) = 8LL;
      ...
      v55 = 4LL;
      TlgWrite(v29, &unk_1802DFBB3, 0LL, 0LL, 8u, &pData);
    }
