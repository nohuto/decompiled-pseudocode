/*
 * XREFs of ?s_HoverHittestRequest@CGlobalInputManager@@SAHPEBU_HOVER_INPUT_INFO@@@Z @ 0x18001FBD8
 * Callers:
...
_BOOL8 __fastcall CGlobalInputManager::s_HoverHittestRequest(const struct _HOVER_INPUT_INFO *a1)
{
  ...
  if ( CGlobalInputManager::s_pInputManager )
  {
    ...
    else
    {
      ...
      if ( v7 < 0 )
      {
        MilInstrumentationCheckHR_MaybeFailFast(v8, &dword_1802C02F0, 1u, v7, 0xD7u, 0LL);
      }
      else
      {
        ...
        v2 = v9;
        if ( v9 < 0 )
          MilInstrumentationCheckHR_MaybeFailFast(v10, &dword_1802C02F0, 1u, v9, 0xE1u, 0LL);
