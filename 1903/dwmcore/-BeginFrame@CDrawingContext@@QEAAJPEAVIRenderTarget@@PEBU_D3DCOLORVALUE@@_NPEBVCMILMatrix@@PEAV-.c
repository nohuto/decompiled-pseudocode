/*
 * XREFs of ?BeginFrame@CDrawingContext@@QEAAJPEAVIRenderTarget@@PEBU_D3DCOLORVALUE@@_NPEBVCMILMatrix@@PEAV?$TValueResource@UMilColorTransform@@UtagMILCMD_COLORTRANSFORMRESOURCE@@$0BH@@@2PEAVCRenderTarget@@@Z @ 0x18004B620
 * Callers:
...
LABEL_70:
  ...
  *(_DWORD *)((char *)this + 6354) = 0;
  v26 = !*((_QWORD *)this + 45)
     ...
     && *(_QWORD *)((*(__int64 (__fastcall **)(_QWORD, __int64))(**((_QWORD **)this + 48) + 160LL))(
                  ...
                  + 616)
     && qword_18033CC08
     && CDXGIEnumeration::IsWarpAdapterLuid(qword_18033CC08, *(struct _LUID *)((char *)this + 392));
  v18 = *((_QWORD *)this + 45) == 0LL;
  *((_BYTE *)this + 6353) = v26;
  v28 = 0;
  if ( v18 )
  ...
  *((_QWORD *)this + 439) = 0LL;
  if ( dword_180340244 > *(_DWORD *)(ThreadLocalStoragePointer[v29] + 4LL) )
  {
    Init_thread_header(&dword_180340244);
    if ( dword_180340244 == -1 )
    {
      ProcessAttribution = CProcessAttributionManager::CreateProcessAttribution(
                             v30,
                             0xFFFFFFFF,
                             (const struct CProcessAttributionManager::ProcessAttributionRecord *)&unk_1803404F0,
                             0,
      ...
      qword_18033CBE8 = (__int64)lpMem;
      Init_thread_footer(&dword_180340244);
    }
  }
  v32 = *((unsigned int *)this + 113);
  v33 = *((_DWORD *)this + 112);
  v34 = (void *)qword_18033CBE8;
  LODWORD(v65) = 10;
  *((_QWORD *)&v65 + 1) = 0LL;
  lpMem = 0LL;
  if ( v33 != (_DWORD)v32 )
