/*
 * XREFs of ?DebuggingStarted@BamoCompObjectDiagnosticsRootProxyImpl@BamoImpl@@QEAAJI_KIW4DCOMPOSITION_EXPRESSION_TYPE@@PEBEI@Z @ 0x180199E98
 * Callers:
...
LABEL_3:
  ...
  v11[1] = v9;
  LOWORD(v8) = 1;
  return CoreUICallSend(v10, v11, 2LL, 0LL, v8, &unk_1802BE002, a2, a3);
}
