/*
 * XREFs of ?SetNonCenteredShaderConstants@CRadialGradientEffect@@QEAAXAEBUD2D_POINT_2F@@MM@Z @ 0x180259B40
 * Callers:
        ...
        float a4)
{
  ...
  x = a2->x;
  v5 = a4 / a3;
  if ( a2->x != *((float *)this + 13) || a2->y != *((float *)this + 14) || v5 != *((float *)this + 11) )
  {
    v6 = a2->x;
    v7 = 0.5 / a4;
    v8 = *(float *)&FLOAT_1_0;
    ...
    *((float *)this + 11) = v5;
    ...
    if ( (float)((float)(v5 * v5) - 0.000001) <= v10 )
      v8 = FLOAT_N1_0;
    *((float *)this + 12) = v8;
    *(struct D2D_POINT_2F *)((char *)this + 52) = *a2;
    *((float *)this + 15) = v11;
    *((float *)this + 16) = v12;
    ++*((_DWORD *)this + 8);
  }
