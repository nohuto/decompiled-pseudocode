/*
 * XREFs of ?EnsureRenderTargets@CVisualCapture@@MEAAJXZ @ 0x1801FD7C0
 * Callers:
 *     <none>
 * Callees:
          ...
          else
          {
            ...
            else
            {
              ...
              if ( ExistingDevice >= 0 )
              {
                ...
                if ( (v3 & 0x80000000) != 0 )
                {
                  MilInstrumentationCheckHR_MaybeFailFast(v17, &dword_1802E4A28, 2u, v3, 0x51u, 0LL);
                  goto LABEL_22;
                }
LABEL_15:
...
LABEL_22:
        ...
        MilInstrumentationCheckHR_MaybeFailFast(v10, &dword_1802E4A28, 2u, ExistingDevice, v20, 0LL);
        goto LABEL_22;
      }
    }
  }
