/*
 * XREFs of McTemplateU0xqddddddddddddqqq @ 0x18018893C
 * Callers:
        ...
        char a19)
{
  ...
  v52 = 4LL;
  v54 = 4LL;
  return McGenEventWrite(Microsoft_Windows_Dwm_Core_Provider_Context, &EVTDESC_OVERLAY_CHECKSUPPORT, a3, 0x12u, &v20);
}
