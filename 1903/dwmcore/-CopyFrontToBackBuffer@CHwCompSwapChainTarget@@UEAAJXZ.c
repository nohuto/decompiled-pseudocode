/*
 * XREFs of ?CopyFrontToBackBuffer@CHwCompSwapChainTarget@@UEAAJXZ @ 0x18023F810
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall CHwCompSwapChainTarget::CopyFrontToBackBuffer(CHwCompSwapChainTarget *this)
{
  ...
  if ( **((_DWORD **)this + 13) || *(_DWORD *)*v2 )
  {
    ...
    v4 = FastRegion::CRegion::Copy((int **)&v24, (int **)this + 13);
    v1 = v4;
    if ( v4 < 0 )
    {
      MilInstrumentationCheckHR_MaybeFailFast(v5, 0LL, 0, v4, 0xD4u, 0LL);
    }
    else
    {
      v6 = FastRegion::CRegion::Union((void **)&v24, v2);
      v1 = v6;
      if ( v6 < 0 )
      {
        MilInstrumentationCheckHR_MaybeFailFast(v7, 0LL, 0, v6, 0xD5u, 0LL);
      }
      else
      {
        v8 = (*(__int64 (__fastcall **)(char *, CD3DDeviceLevel1 **))(*((_QWORD *)this - 26) + 248LL))(
               (char *)this - 208,
               &v18);
        v1 = v8;
        if ( v8 < 0 )
        {
          MilInstrumentationCheckHR_MaybeFailFast(v9, 0LL, 0, v8, 0xD7u, 0LL);
        }
        else
        {
