        ...
        __int64 a4)
{
  ...
  *(_WORD *)(v7 + 24) = 257;
  *(_QWORD *)&v32 = v7;
  CInteractionTrackerBindingManager::GetConnectedTrackersForAxis(a1, a2, 7, (unsigned int)&v32, 0LL);
  v9 = v32;
  v10 = *(_QWORD *)v32;
  v29 = *(_QWORD *)v32;
  while ( v10 != v9 )
  {
    ...
    v13 = (__int64)*v12;
    v14 = (_QWORD *)(*v12)[1];
    v15 = std::_List_alloc<std::_List_base_types<std::pair<wil::com_ptr_t<CManipulation,wil::err_returncode_policy> const,std::unique_ptr<CChainingHelper>>>>::_Buynode0(
            v8,
            *v12,
            v14);
    *((_DWORD *)v15 + 6) = 0;
    v15[2] = v11;
    std::list<std::pair<wil::com_ptr_t<CManipulation,wil::err_returncode_policy> const,std::unique_ptr<CChainingHelper>>>::_Incsize(a4 + 8);
    *(_QWORD *)(v13 + 8) = v15;
    *v14 = v15;
    std::_Hash<std::_Umap_traits<CInteractionTracker *,enum InteractionTrackerBindingModeFlags,std::_Uhash_compare<CInteractionTracker *,std::hash<CInteractionTracker *>,std::equal_to<CInteractionTracker *>>,std::allocator<std::pair<CInteractionTracker * const,enum InteractionTrackerBindingModeFlags>>,0>>::_Insert<std::pair<CInteractionTracker * const,enum InteractionTrackerBindingModeFlags> &,std::_List_unchecked_iterator<std::_List_val<std::_List_simple_types<std::pair<CInteractionTracker * const,enum InteractionTrackerBindingModeFlags>>>>>(
      a4,
      (__int64)&v31,
      (unsigned __int8 *)(**(_QWORD **)(a4 + 8) + 16LL),
      **(_QWORD **)(a4 + 8));
  ...
  {
    v31 = 0LL;
    v16 = std::_Allocate<16,std::_Default_allocate_traits,0>(0x28uLL);
    v17 = a2;
    v18 = a1;
    *(_QWORD *)v16 = v16;
    *(_QWORD *)(v16 + 8) = v16;
    ...
    *(_WORD *)(v16 + 24) = 257;
    *(_QWORD *)&v31 = v16;
    CInteractionTrackerBindingManager::GetConnectedTrackersForAxis(a1, a2, 1, (unsigned int)&v31, 0LL);
    v19 = v31;
    v20 = *(_QWORD *)v31;
    v29 = *(_QWORD *)v31;
    while ( v20 != v19 )
    ...
    std::_Tree<std::_Tmap_traits<enum SceneMaterialInputType::Enum,unsigned int,std::less<enum SceneMaterialInputType::Enum>,std::allocator<std::pair<enum SceneMaterialInputType::Enum const,unsigned int>>,0>>::clear(&v31);
    std::_Deallocate<16,0>((void *)v31, 0x28uLL);
  }
  else
  {
    v17 = a2;
  ...
  {
    v31 = 0LL;
    v21 = std::_Allocate<16,std::_Default_allocate_traits,0>(0x28uLL);
    *(_QWORD *)v21 = v21;
    *(_QWORD *)(v21 + 8) = v21;
    *(_QWORD *)(v21 + 16) = v21;
    *(_WORD *)(v21 + 24) = 257;
    *(_QWORD *)&v31 = v21;
    CInteractionTrackerBindingManager::GetConnectedTrackersForAxis(v18, v17, 2, (unsigned int)&v31, 0LL);
    v22 = v31;
    v23 = *(_QWORD *)v31;
    v29 = *(_QWORD *)v31;
    while ( v23 != v22 )
  ...
  {
    v31 = 0LL;
    v24 = std::_Allocate<16,std::_Default_allocate_traits,0>(0x28uLL);
    *(_QWORD *)v24 = v24;
    *(_QWORD *)(v24 + 8) = v24;
    *(_QWORD *)(v24 + 16) = v24;
    *(_WORD *)(v24 + 24) = 257;
    *(_QWORD *)&v31 = v24;
    CInteractionTrackerBindingManager::GetConnectedTrackersForAxis(v18, v17, 4, (unsigned int)&v31, 0LL);
    v25 = v31;
    v26 = *(_QWORD *)v31;
    v29 = *(_QWORD *)v31;
    while ( v26 != v25 )
  ...
  std::_Tree<std::_Tmap_traits<enum SceneMaterialInputType::Enum,unsigned int,std::less<enum SceneMaterialInputType::Enum>,std::allocator<std::pair<enum SceneMaterialInputType::Enum const,unsigned int>>,0>>::clear(&v32);
  std::_Deallocate<16,0>((void *)v32, 0x28uLL);
}
