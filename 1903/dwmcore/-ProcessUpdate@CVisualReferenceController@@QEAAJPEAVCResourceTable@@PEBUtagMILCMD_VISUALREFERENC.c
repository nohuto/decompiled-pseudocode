/*
 * XREFs of ?ProcessUpdate@CVisualReferenceController@@QEAAJPEAVCResourceTable@@PEBUtagMILCMD_VISUALREFERENCECONTROLLER@@@Z @ 0x1800297E0
 * Callers:
        ...
        const struct tagMILCMD_VISUALREFERENCECONTROLLER *a3)
{
  ...
  if ( (_DWORD)v6 )
  {
    Resource = CResourceTable::GetResource(a2, v6, 189LL);
    *((_QWORD *)this + 7) = Resource;
    if ( !Resource )
    {
      v11 = -2003303421;
      MilInstrumentationCheckHR_MaybeFailFast(v8, 0LL, 0, -2003303421, 0x77Au, 0LL);
LABEL_8:
      CVisualReferenceController::UnRegisterNotifiers(this);
      goto LABEL_4;
    }
