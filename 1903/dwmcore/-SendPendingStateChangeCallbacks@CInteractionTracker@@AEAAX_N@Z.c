/*
 * XREFs of ?SendPendingStateChangeCallbacks@CInteractionTracker@@AEAAX_N@Z @ 0x1801DC654
 * Callers:
      ...
      if ( v11 )
      {
        ...
        if ( v12 )
        {
          ...
          if ( !v13 )
          {
            ...
            LOWORD(v33) = 1;
            CoreUICallSend(v5, v48, 2LL, 8LL, v33, &unk_1802B2E4B, (unsigned int)&v43, *((float *)&v35 + 3));
            if ( *((_BYTE *)this + 626) )
              *((_BYTE *)this + 626) = 0;
            goto LABEL_21;
          }
