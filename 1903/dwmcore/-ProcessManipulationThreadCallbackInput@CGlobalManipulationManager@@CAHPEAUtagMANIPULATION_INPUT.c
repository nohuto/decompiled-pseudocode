/*
 * XREFs of ?ProcessManipulationThreadCallbackInput@CGlobalManipulationManager@@CAHPEAUtagMANIPULATION_INPUT_INFO@@PEAX@Z @ 0x1802399FC
 * Callers:
        ...
        CGlobalManipulationManager *this)
{
  ...
  dword_180340078 = GetCurrentThreadId();
  v14 = 0LL;
