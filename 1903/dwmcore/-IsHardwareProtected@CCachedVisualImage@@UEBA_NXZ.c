/*
 * XREFs of ?IsHardwareProtected@CCachedVisualImage@@UEBA_NXZ @ 0x1801C9500
 * Callers:
 *     ?IsHardwareProtected@CCachedVisualImage@@WIA@EBA_NXZ @ 0x1800ED4E0 (-IsHardwareProtected@CCachedVisualImage@@WIA@EBA_NXZ.c)
 * Callees:
