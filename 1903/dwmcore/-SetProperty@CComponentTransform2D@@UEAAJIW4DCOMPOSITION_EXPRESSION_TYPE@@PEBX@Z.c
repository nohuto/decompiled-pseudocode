/*
 * XREFs of ?SetProperty@CComponentTransform2D@@UEAAJIW4DCOMPOSITION_EXPRESSION_TYPE@@PEBX@Z @ 0x1800B6070
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall CComponentTransform2D::SetProperty(__int64 a1, int a2, int a3, float *a4)
{
  ...
  else
  {
    ...
    {
      v10 = -2147024809;
      MilInstrumentationCheckHR_MaybeFailFast(v6, 0LL, 0, 0x80070057, 0x4Au, 0LL);
      return v10;
    }
  }
