/*
 * XREFs of ?IsCandidateOverlayCompatbile@COverlayContext@@AEBA_NPEAVCVisual@@PEAVISwapChainContent@@AEBUDXGI_MULTIPLANE_OVERLAY_ATTRIBUTES@@W4DXGI_MODE_ROTATION@@I_N@Z @ 0x180186560
 * Callers:
        ...
        bool a7)
{
  ...
  if ( (*(unsigned __int8 (__fastcall **)(struct ISwapChainContent *))(*(_QWORD *)a3 + 104LL))(a3)
    ...
    && (a7 && (*((_BYTE *)this + 13429) || *((_BYTE *)this + 13443)) || *((_BYTE *)this + 13429) || a6 > 2) )
  {
    return 1;
  }
  return v11;
