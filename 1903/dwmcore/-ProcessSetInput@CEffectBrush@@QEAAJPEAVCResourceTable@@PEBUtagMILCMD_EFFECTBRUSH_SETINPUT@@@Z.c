/*
 * XREFs of ?ProcessSetInput@CEffectBrush@@QEAAJPEAVCResourceTable@@PEBUtagMILCMD_EFFECTBRUSH_SETINPUT@@@Z @ 0x1800CCAB4
 * Callers:
        ...
        const struct tagMILCMD_EFFECTBRUSH_SETINPUT *a3)
{
  ...
  if ( *((_QWORD *)this + 11) )
  {
    ...
    v12 = -2003303421;
    MilInstrumentationCheckHR_MaybeFailFast(v6, 0LL, 0, 0x88980403, v14, 0LL);
    return v12;
  }
  return 0;
}
