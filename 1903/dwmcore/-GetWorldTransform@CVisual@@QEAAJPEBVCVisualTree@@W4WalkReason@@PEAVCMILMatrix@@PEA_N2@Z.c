/*
 * XREFs of ?GetWorldTransform@CVisual@@QEAAJPEBVCVisualTree@@W4WalkReason@@PEAVCMILMatrix@@PEA_N2@Z @ 0x180087C60
 * Callers:
...
LABEL_10:
    ...
    if ( v12 < 0 )
    {
      MilInstrumentationCheckHR_MaybeFailFast((unsigned int)Flink, 0LL, 0, v12, 0x768u, 0LL);
      return (unsigned int)v12;
    }
    if ( !v10[7].Blink )
    {
      MilInstrumentationCheckHR_MaybeFailFast((unsigned int)Flink, 0LL, 0, -2003292412, 0x65u, 0LL);
      MilInstrumentationCheckHR_MaybeFailFast(v27, 0LL, 0, -2003292412, 0x76Fu, 0LL);
      return 2291674884LL;
    }
