/*
 * XREFs of ?SetCaptureState_RenderThread@CManipulation@@QEAAJW4CaptureState@@@Z @ 0x1801E338C
 * Callers:
...
__int64 __fastcall CManipulation::SetCaptureState_RenderThread(CManipulation *a1, int a2)
{
  ...
  {
    MilInstrumentationCheckHR_MaybeFailFast(v5, 0LL, 0, RenderToManipulationMsgInfo, 0x3B6u, 0LL);
  }
  else
  {
    ...
    LOWORD(v10) = 1;
    v12 = a1;
    v7 = CoreUICallSend(v13, &v14, 1LL, 10LL, v10, &unk_1802B2E6E, (unsigned int)&v12, v11);
    v6 = v7;
    if ( v7 < 0 )
      MilInstrumentationCheckHR_MaybeFailFast(v8, 0LL, 0, v7, 0x3BFu, 0LL);
  }
  Microsoft::WRL::ComPtr<ID2DBitmap>::InternalRelease((__int64 *)&v13);
  return v6;
}
