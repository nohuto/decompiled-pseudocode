/*
 * XREFs of ?AdvanceInertiaToTime@CMotion@@UEAAMPEAVCExpressionValueStack@@_KMMM@Z @ 0x18020F8A0
 * Callers:
        ...
        float a6)
{
  ...
  *((float *)this + 9) = a5;
  ...
  if ( dword_18033A240 > 4u && TlgKeywordOn((TraceLoggingHProvider)&dword_18033A240, 2uLL) )
  {
    ...
    v33 = v19;
    v36 = v19;
    TlgWrite((TraceLoggingHProvider)&dword_18033A240, &unk_1802DD70A, 0LL, 0LL, 7u, &pData);
  }
  return v21;
}
