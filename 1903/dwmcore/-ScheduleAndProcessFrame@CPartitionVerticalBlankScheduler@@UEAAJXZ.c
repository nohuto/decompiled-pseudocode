/*
 * XREFs of ?ScheduleAndProcessFrame@CPartitionVerticalBlankScheduler@@UEAAJXZ @ 0x180093D30
 * Callers:
 *     <none>
 * Callees:
 ...
 *     ?GetStackCaptureRootFailureAddress@@YAPEAXJ@Z @ 0x18015B224 (-GetStackCaptureRootFailureAddress@@YAPEAXJ@Z.c)
...
LABEL_31:
      ...
      if ( (((unsigned __int8)Microsoft_Windows_Dwm_CoreEnableBits >> 1) & ((_InterlockedOr(&dword_180340100, 1u) & 1) == 0)) != 0 )
