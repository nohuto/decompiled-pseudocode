/*
 * XREFs of ?UnboundedInertiaPanningAtTime@CPositionMotion@@AEBAMM@Z @ 0x180210CC8
 * Callers:
 *     ?AdvanceInertiaToTimeDefault@CPositionMotion@@MEAAMXZ @ 0x180210950 (-AdvanceInertiaToTimeDefault@CPositionMotion@@MEAAMXZ.c)
