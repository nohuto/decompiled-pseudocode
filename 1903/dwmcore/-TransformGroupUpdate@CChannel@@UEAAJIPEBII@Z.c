/*
 * XREFs of ?TransformGroupUpdate@CChannel@@UEAAJIPEBII@Z @ 0x180021CD0
 * Callers:
 *     <none>
 * Callees:
        ...
        unsigned int a4)
{
  ...
  CChannel::CheckHandle(this, a2, 182LL);
  v8 = 4LL * a4;
  ...
  {
    v11 = -2147024362;
    MilInstrumentationCheckHR_MaybeFailFast(0xFFFFFFFF, 0LL, 0, -2147024362, 0xB02u, 0LL);
  }
  else
  {
    si128.m128i_i32[3] = 0;
    ...
    if ( v9 < 0 )
    {
      MilInstrumentationCheckHR_MaybeFailFast(v10, 0LL, 0, v9, 0xB04u, 0LL);
    }
    else
    {
