/*
 * XREFs of ?GetSceneLightRealization@CCompositionEnvironmentLight@@UEBAJAEBVCMILMatrix@@PEAPEAUISpectreLightNode@@@Z @ 0x18020F4A0
 * Callers:
 *     <none>
 * Callees:
        ...
        struct ISpectreLightNode **a3)
{
  ...
  *a3 = (struct ISpectreLightNode *)*((_QWORD *)this + 21);
  ...
  if ( v4 )
  {
    v5 = (*(__int64 (__fastcall **)(__int64, const struct CMILMatrix *))(*(_QWORD *)v4 + 80LL))(v4, a2);
    v6 = v5;
    if ( v5 < 0 )
    {
    ...
    v8 = (*(__int64 (__fastcall **)(_QWORD, char *))(**((_QWORD **)this + 21) + 104LL))(
           *((_QWORD *)this + 21),
           (char *)this + 252);
    if ( v8 >= 0 )
      return 0LL;
