/*
 * XREFs of ?RegisterForSignaling@CGdiSpriteBitmap@@AEAAJXZ @ 0x180039F5C
 * Callers:
...
__int64 __fastcall CGdiSpriteBitmap::RegisterForSignaling(CGdiSpriteBitmap *this)
{
  ...
  else
  {
    ...
    if ( *((_QWORD *)this + 47) )
    {
      ...
      if ( v10 < 0 )
      {
        MilInstrumentationCheckHR_MaybeFailFast(v11, &dword_1802C1870, 1u, v10, 0x3EFu, 0LL);
        goto LABEL_7;
      }
      v4 = 1;
    }
    else
    {
      ...
      if ( v7 < 0 )
      {
        MilInstrumentationCheckHR_MaybeFailFast(v8, &dword_1802C1870, 1u, v7, 0x3E7u, 0LL);
        goto LABEL_7;
      }
    }
    *((_BYTE *)this + 116) |= 8u;
