/*
 * XREFs of ?DrawScene3D@CDrawingContext@@QEAAJPEAUISpectreWorld@@PEAVCCompositionEnvironmentLight@@AEBVCMILMatrix@@@Z @ 0x18016E244
 * Callers:
        ...
        const struct CMILMatrix *a4)
{
  ...
  if ( *((_QWORD *)CurrentVisual + 71) > *(_QWORD *)(*((_QWORD *)CurrentVisual + 2) + 136LL) )
  {
    ...
    *((_QWORD *)&v115 + 1) = v105;
    CMILMatrix::Transform3DBoundsHelper<1>((CMILMatrix *)&v103, (__int64)&v115, &v123);
    ...
    v19 = COERCE_DOUBLE(COERCE_UNSIGNED_INT64(v103._44) & _xmm);
    if ( v19 < 0.000081380211
      || (v20 = COERCE_DOUBLE(COERCE_UNSIGNED_INT64((float)(v103._44 - 1.0)) & _xmm), v20 < 0.000081380211) )
    {
      v21 = *(float *)&FLOAT_1_0;
    }
    else
    ...
    v110 = v103._41 * v21;
    v22 = v103._43 * v21;
    v23 = _mm_cvtpd_ps((__m128d)_mm_and_ps(
    ...
    v23.m128_f32[0] = fmaxf(v23.m128_f32[0], v24);
    ...
    *(_QWORD *)&v113.left = _mm_unpacklo_ps(v23, v25).m128_u64[0];
      ...
      && !*((_DWORD *)this + 64) )
    {
      ...
      if ( v33 )
        ...
        v34 = *(float *)&FLOAT_1_0;
      v100 = 0;
      if ( (float)COERCE_DOUBLE(COERCE_UNSIGNED_INT64((float)(v34 - 1.0)) & _xmm) >= 0.0000011920929 )
      {
...
LABEL_41:
    ...
    else
    {
      ...
      {
        v126 = 0;
        if ( CMILMatrix::SetToInverse((__m128 *)&v125, (const struct CMILMatrix *)&v103) )
        {
      ...
      *(_QWORD *)&v113.right = __PAIR64__(v54.m128_u32[0], LODWORD(v53));
      ...
      else
      {
        ...
        v89 = CDrawingContext::PushTransformInternal(this, 0LL, (const struct CMILMatrix *)&CMILMatrix::Identity, 0, 1);
        v5 = v89;
        if ( v89 < 0 )
        {
        ...
        else
        {
          ...
          {
            *(_QWORD *)&v109.x = 0LL;
            Microsoft::WRL::ComPtr<ID2DBitmap>::InternalRelease((__int64 *)&v109);
            v93 = v102[0];
