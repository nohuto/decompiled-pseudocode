/*
 * XREFs of ?AffectsVisual@CCompositionSpotLight@@UEAA_NPEBVCVisualTree@@PEAVCVisual@@@Z @ 0x180023590
 * Callers:
 *     <none>
 * Callees:
...
LABEL_16:
      ...
      {
        updated = CVisual::UpdateWorldTransform(a3, (CVisual **)v5, (struct CTreeData *)v12, v15, TreeData);
        v10 = updated;
        if ( updated < 0 )
...
LABEL_34:
            if ( v33[7].Blink >= (struct _LIST_ENTRY *)v38 )
              goto LABEL_35;
            v74 = CVisual::UpdateWorldTransform(v28, (CVisual **)v5, (struct CTreeData *)v33, v36, v35);
            v25 = v74;
            if ( v74 < 0 )
