/*
 * XREFs of ?Present@CCaptureRenderTarget@@UEAAJ_NI@Z @ 0x18024F480
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall CCaptureRenderTarget::Present(CCaptureRenderTarget *this)
{
  ...
  if ( D3DDeviceNoRef && CCaptureRenderTarget::GetCurrentFrameBuffer(v1) )
  {
    ...
    if ( v8 < 0 )
    {
      MilInstrumentationCheckHR_MaybeFailFast(v9, 0LL, 0, v8, 0x208u, 0LL);
    }
    else
    {
      ++*((_QWORD *)this + 50);
      ...
      *((_BYTE *)D3DDeviceNoRef + 1164) = 0;
      ...
      if ( v13 < 0 )
      {
        MilInstrumentationCheckHR_MaybeFailFast(v14, 0LL, 0, v13, 0x20Cu, 0LL);
      }
      else
      {
        v19 = 0;
        ...
        v3 = v15;
        if ( v15 < 0 )
          MilInstrumentationCheckHR_MaybeFailFast(v16, 0LL, 0, v15, 0x217u, 0LL);
      }
    }
  }
