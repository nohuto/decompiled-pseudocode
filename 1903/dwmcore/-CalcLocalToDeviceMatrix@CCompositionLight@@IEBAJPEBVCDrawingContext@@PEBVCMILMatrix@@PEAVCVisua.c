/*
 * XREFs of ?CalcLocalToDeviceMatrix@CCompositionLight@@IEBAJPEBVCDrawingContext@@PEBVCMILMatrix@@PEAVCVisual@@PEAV3@3@Z @ 0x1800231B4
 * Callers:
        ...
        struct CMILMatrix *a6)
{
  ...
  if ( WorldTransform < 0 )
  {
    MilInstrumentationCheckHR_MaybeFailFast(v9, 0LL, 0, WorldTransform, 0xBCu, 0LL);
  }
  else
  {
    v13 = v18;
