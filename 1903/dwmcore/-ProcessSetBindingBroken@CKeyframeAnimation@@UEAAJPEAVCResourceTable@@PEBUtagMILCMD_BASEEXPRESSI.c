/*
 * XREFs of ?ProcessSetBindingBroken@CKeyframeAnimation@@UEAAJPEAVCResourceTable@@PEBUtagMILCMD_BASEEXPRESSION_SETBINDINGBROKEN@@@Z @ 0x1800C0230
 * Callers:
 *     <none>
 * Callees:
        ...
        const struct tagMILCMD_BASEEXPRESSION_SETBINDINGBROKEN *a3)
{
  ...
  *((_BYTE *)this + 540) &= ~1u;
  ...
  if ( *((_BYTE *)a3 + 8) && *((_DWORD *)this + 130) == 1 )
  {
    ...
    if ( v10 < 0 )
    {
      MilInstrumentationCheckHR_MaybeFailFast(v11, 0LL, 0, v10, 0x20Au, 0LL);
    }
    else
    {
