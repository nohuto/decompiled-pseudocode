/*
 * XREFs of ?IsHDRContent@CCompositionSurfaceBitmap@@UEBA_NXZ @ 0x18001C770
 * Callers:
 *     ?IsHDRContent@CCompositionSurfaceBitmap@@W7EBA_NXZ @ 0x1800ED040 (-IsHDRContent@CCompositionSurfaceBitmap@@W7EBA_NXZ.c)
 * Callees:
