/*
 * XREFs of ?ProcessSetOriginOffset@CRadialGradientBrush@@QEAAJPEAVCResourceTable@@PEBUtagMILCMD_RADIALGRADIENTBRUSH_SETORIGINOFFSET@@@Z @ 0x1801F5F7C
 * Callers:
        ...
        const struct tagMILCMD_RADIALGRADIENTBRUSH_SETORIGINOFFSET *a3)
{
  ...
  v3 = ((__int64 (__fastcall *)(char *, void *, char *))xmmword_18033B898)(
         (char *)this + SDWORD2(xmmword_18033B898),
