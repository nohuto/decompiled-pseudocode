/*
 * XREFs of ?PartitionTelemetryAnimationScenarioBegin@CChannel@@UEAAJPEBXIAEBU_GUID@@@Z @ 0x1800D7EB0
 * Callers:
 *     <none>
 * Callees:
        ...
        const struct _GUID *a4)
{
  ...
  {
    v11 = -2147024362;
    MilInstrumentationCheckHR_MaybeFailFast(v8, 0LL, 0, 0x80070216, 0x3E5u, 0LL);
  }
  else
  {
    ...
    if ( v9 < 0 )
    {
      MilInstrumentationCheckHR_MaybeFailFast(v10, 0LL, 0, v9, 0x3E6u, 0LL);
    }
    else
    {
