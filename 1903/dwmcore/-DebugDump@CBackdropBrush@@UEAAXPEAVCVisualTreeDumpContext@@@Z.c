/*
 * XREFs of ?DebugDump@CBackdropBrush@@UEAAXPEAVCVisualTreeDumpContext@@@Z @ 0x1801CEC50
 * Callers:
 *     <none>
 * Callees:
...
void __fastcall CBackdropBrush::DebugDump(CBackdropBrush *this, struct CVisualTreeDumpContext *a2)
{
  _QWORD v3[4]; // [rsp+20h] [rbp-38h] BYREF

  CSpriteVisualContent::DebugDump(this, a2);
  std::string::string(v3, (__int64)"CBackdropBrush");
