/*
 * XREFs of ?Update@CDrawListCache@@AEAAX_KPEAPEAVCDrawListEntry@@IW4D2D1_ANTIALIAS_MODE@@_N@Z @ 0x1800760D0
 * Callers:
        ...
        __int64 a6)
{
  ...
  __int64 v62; // r10
  bool v63; // sf
  unsigned int v64; // [rsp+20h] [rbp-A9h]
  _QWORD v65[3]; // [rsp+28h] [rbp-A1h] BYREF
  __int128 v66; // [rsp+40h] [rbp-89h] BYREF
  __int64 v67; // [rsp+50h] [rbp-79h]
  __int128 v68; // [rsp+60h] [rbp-69h] BYREF
  __int64 v69; // [rsp+70h] [rbp-59h]
  struct CDrawListEntry *v70; // [rsp+80h] [rbp-49h] BYREF
  float v71; // [rsp+88h] [rbp-41h]
  float v72; // [rsp+8Ch] [rbp-3Dh]
  __int128 v73; // [rsp+90h] [rbp-39h] BYREF
  void *retaddr; // [rsp+118h] [rbp+4Fh]

  *(_QWORD *)&this = a1;
  *((_QWORD *)&this + 1) = (unsigned int)a6;
  v7 = this;
  v65[0] = (unsigned int)a6;
  v64 = a6;
  v70 = a2;
  v65[1] = a3;
  if ( !a3 && (_DWORD)a6 )
...
LABEL_23:
  ...
  *(_QWORD *)&this = 8 * this;
  ...
  if ( v29 != (_QWORD *)((char *)v29 - this) )
  {
    ...
    do
    {
      ...
      if ( !v20 )
        goto LABEL_141;
      if ( (unsigned __int64)--v20 >= *((_QWORD *)&v68 + 1) )
        goto LABEL_141;
      *(_QWORD *)&this = *v29;
      *(_QWORD *)(v62 + 8 * v20) = *v29;
    }
    while ( v29 != v25 );
  }
  ...
  *((_QWORD *)&v68 + 1) = v26;
  ...
  {
LABEL_141:
    _o__invalid_parameter_noinfo_noreturn(this, v25, v27, v20);
    JUMPOUT(0x1801198EDLL);
  }
  v67 = v26;
  v69 = v26;
...
LABEL_36:
  ...
  a6 = 0LL;
  a2 = (struct CDrawListEntry *)*((_QWORD *)&v73 + 1);
  a3 = (struct CDrawListEntry **)v73;
  while ( a2 != *((struct CDrawListEntry **)&this + 1) || a3 != v65 )
  {
    if ( a2 == *a3 )
      goto LABEL_111;
...
LABEL_50:
      ...
      *(_DWORD *)(v7 + 88) |= v42;
      *(_DWORD *)(v7 + 92) &= v42;
      v68 = *(_OWORD *)(*(__int64 (__fastcall **)(_DWORD *, __int128 *))(*(_QWORD *)v41 + 56LL))(v41, &v73);
      TMilRect<float,MilRectF,RectUniqueness::NotNeeded>::UnionUnsafe(&v70, &v68);
      v39 = (unsigned int)(v39 + 1);
      if ( (unsigned int)v39 >= v64 )
      {
        v43 = _mm_shuffle_ps((__m128)(unsigned int)v70, (__m128)(unsigned int)v70, 225);
        v43.m128_f32[0] = *((float *)&v70 + 1);
