/*
 * XREFs of ?ProcessManipulationInfo@CGlobalManipulationManager@@AEAAXPEAVCManipulationFrame@@@Z @ 0x180239830
 * Callers:
        ...
        struct CManipulationFrame *a2)
{
  ...
  *((_DWORD *)a2 + 34) = *((_DWORD *)a2 + 53) - 1;
  if ( dword_18033A240 > 4u && TlgKeywordOn((TraceLoggingHProvider)&dword_18033A240, 2uLL) )
  {
    ...
    *(_QWORD *)&v17[0] = v10;
    v30 = v9;
    TlgWrite((TraceLoggingHProvider)&dword_18033A240, &unk_1802DFC12, 0LL, 0LL, cData, &pData);
  }
