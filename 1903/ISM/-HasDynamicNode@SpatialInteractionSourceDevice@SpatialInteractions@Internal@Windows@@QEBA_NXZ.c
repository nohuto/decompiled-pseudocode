/*
 * XREFs of ?HasDynamicNode@SpatialInteractionSourceDevice@SpatialInteractions@Internal@Windows@@QEBA_NXZ @ 0x1800E296C
 * Callers:
 ...
 *     ?CanSendPoses@SpatialInteractionEyeGazeSourceObject@SpatialInteractions@Internal@Windows@@UEBA_NXZ @ 0x1800F09C0 (-CanSendPoses@SpatialInteractionEyeGazeSourceObject@SpatialInteractions@Internal@Windows@@UEBA_N.c)
 *     ?CanSendPoses@SpatialInteractionSourceController@SpatialInteractions@Internal@Windows@@UEBA_NXZ @ 0x1801640B0 (-CanSendPoses@SpatialInteractionSourceController@SpatialInteractions@Internal@Windows@@UEBA_NXZ.c)
 * Callees:
 *     <none>
 */
