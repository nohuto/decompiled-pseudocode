/*
 * XREFs of ??$_Emplace_reallocate@AEBVEdge@@@?$vector@VEdge@@V?$allocator@VEdge@@@std@@@std@@QEAAPEAVEdge@@QEAV2@AEBV2@@Z @ 0x1801012EC
 * Callers:
 ...
 *     ??$_Uninitialized_move_al_unchecked@PEAVEdge@@PEAV1@V?$allocator@VEdge@@@std@@@std@@YAPEAVEdge@@PEAV1@QEAV1@1AEAV?$allocator@VEdge@@@0@U_General_ptr_iterator_tag@0@U_Unused_parameter@0@@Z @ 0x1801015A0 (--$_Uninitialized_move_al_unchecked@PEAVEdge@@PEAV1@V-$allocator@VEdge@@@std@@@std@@YAPEAVEdge@@.c)
