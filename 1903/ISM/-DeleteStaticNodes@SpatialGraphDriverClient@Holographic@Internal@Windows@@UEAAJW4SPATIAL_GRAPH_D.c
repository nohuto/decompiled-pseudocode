 ...
 * Callers:
 *     ?DeleteStaticNodes@SpatialGraphDriverClient@Holographic@Internal@Windows@@WBA@EAAJW4SPATIAL_GRAPH_DELETE_STATIC_NODE_OPERATION@@KPEBUSPATIAL_NODE_ID@@@Z @ 0x18003A640 (-DeleteStaticNodes@SpatialGraphDriverClient@Holographic@Internal@Windows@@WBA@EAAJW4SPATIAL_GRAP.c)
 * Callees:
