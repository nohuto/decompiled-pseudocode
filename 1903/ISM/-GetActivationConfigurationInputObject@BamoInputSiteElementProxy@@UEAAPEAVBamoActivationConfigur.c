/*
 * XREFs of ?GetActivationConfigurationInputObject@BamoInputSiteElementProxy@@UEAAPEAVBamoActivationConfigurationInputObjectProxy@@XZ @ 0x180009820
 * Callers:
 *     <none>
 * Callees:
        ...
        BamoInputSiteElementProxy *this)
{
  ...
  if ( *(_DWORD *)(v2 + 136) != CurrentThreadId && *(_DWORD *)(v2 + 24) != CurrentThreadId )
  {
    wil::details::in1diag3::_FailFast_Unexpected(
      ...
      v4);
    JUMPOUT(0x18004182ELL);
  }
  return (struct BamoActivationConfigurationInputObjectProxy *)*((_QWORD *)this + 8);
}
