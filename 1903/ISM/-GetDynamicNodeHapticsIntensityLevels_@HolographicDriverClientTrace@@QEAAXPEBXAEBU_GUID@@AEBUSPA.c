/*
 * XREFs of ?GetDynamicNodeHapticsIntensityLevels_@HolographicDriverClientTrace@@QEAAXPEBXAEBU_GUID@@AEBUSPATIAL_NODE_ID@@H@Z @ 0x180155F04
 * Callers:
 *     ??$GetDynamicNodeHapticsIntensityLevels@PEAVSpatialGraphDriverClient@Holographic@Internal@Windows@@AEBU_GUID@@AEBUSPATIAL_NODE_ID@@AEAE@HolographicDriverClientTrace@@SAX$$QEAPEAVSpatialGraphDriverClient@Holographic@Internal@Windows@@AEBU_GUID@@AEBUSPATIAL_NODE_ID@@AEAE@Z @ 0x18014A1DC (--$GetDynamicNodeHapticsIntensityLevels@PEAVSpatialGraphDriverClient@Holographic@Internal@Window.c)
 * Callees:
        ...
        char a5)
{
  ...
  if ( *(_DWORD *)v7 > 4u )
  {
    if ( TlgKeywordOn(v7, 2uLL) )
    {
      ...
      v15 = 16LL;
      v17 = 4LL;
      TlgWrite(v8, &unk_1801A2574, 0LL, 0LL, 6u, &pData);
    }
  }
}
