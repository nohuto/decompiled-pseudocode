/*
 * XREFs of ?DispatchNextCallback@SipcServer@@UEAAJXZ @ 0x1800279A0
 * Callers:
 *     <none>
 * Callees:
 ...
 *     ?Disconnect@SipcEndpoint@@QEAAX_N@Z @ 0x1800D555C (-Disconnect@SipcEndpoint@@QEAAX_N@Z.c)
