/*
 * XREFs of ?PopulateTargetingData@MPCSixDofProcessor@@EEAAXPEAUMPCHolographicInputContext@@PEAUInputInfo@@@Z @ 0x180131270
 * Callers:
 *     <none>
 * Callees:
 ...
 *     ?transform@Numerics@Foundation@Windows@@YA?AUfloat3@123@AEBU4123@AEBUquaternion@123@@Z @ 0x180097194 (-transform@Numerics@Foundation@Windows@@YA-AUfloat3@123@AEBU4123@AEBUquaternion@123@@Z.c)
 */
        ...
        struct InputInfo *a3)
{
  ...
  *((_DWORD *)a3 + 21) = *((_DWORD *)this + 1256);
  ...
  else
  {
    ...
    *((_DWORD *)a3 + 34) = *((_DWORD *)a2 + 41);
    *((_DWORD *)a3 + 35) = *((_DWORD *)a2 + 42);
    *((_DWORD *)a3 + 36) = *((_DWORD *)a2 + 43);
    v26 = v16;
  }
