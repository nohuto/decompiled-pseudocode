/*
 * XREFs of ?TryCreateAndInitialize@HidLampArrayAttributesReportParser@@SAJPEBUParsedHidReportDescriptor@@PEAPEAV1@@Z @ 0x1800B6F88
 * Callers:
 ...
 *     ??0HidLampArrayAttributesReportParser@@AEAA@XZ @ 0x1800B6BA0 (--0HidLampArrayAttributesReportParser@@AEAA@XZ.c)
