/*
 * XREFs of ?RefreshCursorMagnetismRegistrySettings@ControllerProcessor@@AEAAXXZ @ 0x180076D58
 * Callers:
 *     _lambda_828562b8234057b7c70d01bfff3fe312_::_lambda_invoker_cdecl_ @ 0x180074370 (_lambda_828562b8234057b7c70d01bfff3fe312_--_lambda_invoker_cdecl_.c)
 *     ?Initialize@ControllerProcessor@@IEAAJXZ @ 0x18007615C (-Initialize@ControllerProcessor@@IEAAJXZ.c)
 * Callees:
 *     _lambda_9421d204e635201636d0a16c341872b8_::operator() @ 0x180074E64 (_lambda_9421d204e635201636d0a16c341872b8_--operator().c)
 *     ?ConvertDIPSToPixels@ControllerProcessor@@AEAAKAEBK@Z @ 0x180075DA4 (-ConvertDIPSToPixels@ControllerProcessor@@AEAAKAEBK@Z.c)
 */
