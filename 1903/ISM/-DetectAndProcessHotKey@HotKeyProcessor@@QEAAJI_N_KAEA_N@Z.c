/*
 * XREFs of ?DetectAndProcessHotKey@HotKeyProcessor@@QEAAJI_N_KAEA_N@Z @ 0x180145CDC
 * Callers:
  ...
  *a5 = 0;
  ...
  if ( (unsigned int)dword_1801DE450 > 5 )
  {
    if ( TlgKeywordOn((TraceLoggingHProvider)&dword_1801DE450, 0x20000uLL) )
    {
      ...
      v126 = &v38;
      v127 = 8LL;
      TlgWrite((TraceLoggingHProvider)&dword_1801DE450, &unk_1801A21A1, 0LL, 0LL, cData, &pData);
    }
    if ( (unsigned int)dword_1801DE450 > 5 && TlgKeywordOn((TraceLoggingHProvider)&dword_1801DE450, 0x40000uLL) )
    {
      ...
      v99 = &v40;
      v100 = 8LL;
      TlgWrite((TraceLoggingHProvider)&dword_1801DE450, &unk_1801A1EF1, 0LL, 0LL, 7u, &v90);
    }
  }
  for ( i = (_QWORD *)**((_QWORD **)this + 5); i != *((_QWORD **)this + 5); i = j )
  {
    if ( (unsigned int)dword_1801DE450 > 5 && TlgKeywordOn((TraceLoggingHProvider)&dword_1801DE450, 0x40000uLL) )
    {
      v129 = (char *)i + 28;
      v130 = 4LL;
      TlgWrite((TraceLoggingHProvider)&dword_1801DE450, &unk_1801A1EB7, 0LL, 0LL, 3u, &v128);
    }
    v11 = i[2];
    if ( *(_BYTE *)(v11 + 25) )
    {
...
LABEL_47:
      ...
      if ( (_QWORD)v37 )
      {
        if ( (unsigned int)dword_1801DE450 > 5 && TlgKeywordOn((TraceLoggingHProvider)&dword_1801DE450, 0x40000uLL) )
        {
          ...
          v69 = 8;
          v70 = 0;
          TlgWrite((TraceLoggingHProvider)&dword_1801DE450, &unk_1801A1E14, 0LL, 0LL, 8u, &v52);
        }
        *((_QWORD *)v20 + 2) = a4;
        if ( *((_QWORD *)this + 15) )
        {
          ...
          if ( (unsigned int)dword_1801DE450 > 5 )
          {
            if ( TlgKeywordOn((TraceLoggingHProvider)&dword_1801DE450, 0x20000uLL) )
            {
              ...
              v88 = 8;
              v89 = 0;
              TlgWrite((TraceLoggingHProvider)&dword_1801DE450, &unk_1801A1B83, 0LL, 0LL, 8u, &v71);
            }
          }
        }
        if ( !*((_BYTE *)this + 60) )
  ...
  if ( v132 )
  {
    ...
    while ( v22 != (_QWORD *)*v21 )
    {
      ...
      if ( (unsigned int)dword_1801DE450 > 5 && TlgKeywordOn((TraceLoggingHProvider)&dword_1801DE450, 0x40000uLL) )
      {
        ...
        v112 = 4;
        v113 = 0;
        TlgWrite((TraceLoggingHProvider)&dword_1801DE450, &unk_1801A2024, 0LL, 0LL, 6u, &v101);
      }
      if ( v23 )
      {
        _InterlockedAdd(v23 + 2, 1u);
        ...
        if ( *((_QWORD *)this + 15) )
        {
          ...
          if ( (unsigned int)dword_1801DE450 > 5 )
          {
            if ( TlgKeywordOn((TraceLoggingHProvider)&dword_1801DE450, 0x20000uLL) )
            {
              ...
              v121 = v24 + 2;
              v122 = 4LL;
              TlgWrite((TraceLoggingHProvider)&dword_1801DE450, &unk_1801A1F7C, 0LL, 0LL, 6u, &v114);
            }
          }
        }
