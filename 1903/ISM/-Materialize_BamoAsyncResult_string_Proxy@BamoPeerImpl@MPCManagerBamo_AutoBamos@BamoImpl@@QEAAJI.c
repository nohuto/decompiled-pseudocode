/*
 * XREFs of ?Materialize_BamoAsyncResult_string_Proxy@BamoPeerImpl@MPCManagerBamo_AutoBamos@BamoImpl@@QEAAJI@Z @ 0x18007E598
 * Callers:
 *     ?Thunk_Materialize_BamoAsyncResult_string_Proxy_11@?$IBamoPeer_MPCManagerBamo_AutoBamos_Receive@VBamoPeerImpl@MPCManagerBamo_AutoBamos@BamoImpl@@@@SAJPEAXPEAPEAX@Z @ 0x18007FA00 (-Thunk_Materialize_BamoAsyncResult_string_Proxy_11@-$IBamoPeer_MPCManagerBamo_AutoBamos_Receive@.c)
 * Callees:
