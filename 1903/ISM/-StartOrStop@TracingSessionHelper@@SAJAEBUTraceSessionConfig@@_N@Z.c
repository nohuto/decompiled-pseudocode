/*
 * XREFs of ?StartOrStop@TracingSessionHelper@@SAJAEBUTraceSessionConfig@@_N@Z @ 0x18009F514
 * Callers:
 ...
 *     ??$copy@PEAEPEAE@std@@YAPEAEPEAE00@Z @ 0x18009B8A0 (--$copy@PEAEPEAE@std@@YAPEAEPEAE00@Z.c)
