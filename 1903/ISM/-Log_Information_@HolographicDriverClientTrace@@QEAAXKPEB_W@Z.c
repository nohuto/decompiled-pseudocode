/*
 * XREFs of ?Log_Information_@HolographicDriverClientTrace@@QEAAXKPEB_W@Z @ 0x180159AC8
 * Callers:
 ...
 *     ?PropertyUpdatedListenerThreadProcV2Static@SpatialGraphDriverClient@Holographic@Internal@Windows@@CAKPEAX@Z @ 0x18015C830 (-PropertyUpdatedListenerThreadProcV2Static@SpatialGraphDriverClient@Holographic@Internal@Windows.c)
 * Callees:
        ...
        const wchar_t *a3)
{
  ...
  if ( **(_DWORD **)(v4 + 8) > 4u )
  {
    if ( TlgKeywordOn(*(TraceLoggingHProvider *)(v4 + 8), 2uLL) )
    {
      ...
      TlgWrite(v6, &unk_1801A41A9, 0LL, 0LL, cData, &pData);
    }
  }
}
