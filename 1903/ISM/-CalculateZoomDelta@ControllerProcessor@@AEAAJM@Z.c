/*
 * XREFs of ?CalculateZoomDelta@ControllerProcessor@@AEAAJM@Z @ 0x180075CB4
 * Callers:
...
__int64 __fastcall ControllerProcessor::CalculateZoomDelta(ControllerProcessor *this, float a2)
{
  ...
  if ( v3 > 0.00000011920929 )
  {
    ...
    v5 = GetTickCount() - *((_DWORD *)this + 580);
    if ( (float)v5 < 2500.0 )
    ...
    if ( v6 >= 0.0 )
      ...
      v7 = 1.0 / (float)(1.0 - v6);
    *((float *)this + 579) = v7 + *((float *)this + 579);
  }
  else
  {
    *((_DWORD *)this + 580) = GetTickCount();
  }
  return 0LL;
}
