/*
 * XREFs of ?CreateEndpointToReceiveMessages@TestCommandHost@@AEAAXXZ @ 0x1800106A8
 * Callers:
...
void __fastcall TestCommandHost::CreateEndpointToReceiveMessages(TestCommandHost *this, __int64 a2)
{
  ...
  v4 = *(_QWORD *)this;
  v5 = *(__int64 (__fastcall **)(__int64, __int64, const wchar_t *, char *))(**(_QWORD **)this + 48LL);
  ...
  v14 = (_DWORD)this + 24;
  v7 = (*(__int64 (__fastcall **)(_QWORD, int (*)(void *, const void *, int), TestCommandHost *, _QWORD))(**(_QWORD **)this + 88LL))(
         *(_QWORD *)this,
