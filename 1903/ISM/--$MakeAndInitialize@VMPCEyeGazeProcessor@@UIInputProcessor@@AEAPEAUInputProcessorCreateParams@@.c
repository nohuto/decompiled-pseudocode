/*
 * XREFs of ??$MakeAndInitialize@VMPCEyeGazeProcessor@@UIInputProcessor@@AEAPEAUInputProcessorCreateParams@@@Details@WRL@Microsoft@@YAJPEAPEAUIInputProcessor@@AEAPEAUInputProcessorCreateParams@@@Z @ 0x18013E904
 * Callers:
        ...
        const struct InputProcessorCreateParams **a2)
{
  ...
  *a1 = 0LL;
  ...
  if ( v4 )
  {
    ...
    *v5 = &MPCEyeGazeProcessor::`vftable'{for `IInputProcessor'};
    v5[1] = &MPCEyeGazeProcessor::`vftable'{for `Microsoft::WRL::Details::ImplementsHelper<Microsoft::WRL::RuntimeClassFlags<2>,1,IInputProcessorDeviceUpdate,IInputFocusListener,IMPCInputProviderBase>'};
    v5[2] = &MPCSixDofProcessor::`vftable'{for `IInputFocusListener'};
    v5[3] = &MPCEyeGazeProcessor::`vftable'{for `Microsoft::WRL::Details::ImplementsHelper<Microsoft::WRL::RuntimeClassFlags<2>,1,IMPCInputProviderBase>'};
    *((_DWORD *)v5 + 1158) = 0;
