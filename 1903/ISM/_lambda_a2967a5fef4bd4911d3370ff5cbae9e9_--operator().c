/*
 * XREFs of _lambda_a2967a5fef4bd4911d3370ff5cbae9e9_::operator() @ 0x18013F798
 * Callers:
 *     ??$_Callback_once@V?$tuple@$$QEAV_lambda_a2967a5fef4bd4911d3370ff5cbae9e9_@@AEAVexception_ptr@std@@@std@@U?$integer_sequence@_K$0A@@2@$00@std@@YAHPEAX0PEAPEAX@Z @ 0x18013F6A0 (--$_Callback_once@V-$tuple@$$QEAV_lambda_a2967a5fef4bd4911d3370ff5cbae9e9_@@AEAVexception_ptr@st.c)
 * Callees:
        ...
        const char *a4)
{
  ...
  __m128i v6; // [rsp+20h] [rbp-91h] BYREF
  __int64 *v7; // [rsp+30h] [rbp-81h]
  _QWORD *v8[4]; // [rsp+38h] [rbp-79h] BYREF
  char v9[40]; // [rsp+58h] [rbp-59h] BYREF
  _BYTE v10[40]; // [rsp+80h] [rbp-31h] BYREF
  _QWORD v11[4]; // [rsp+A8h] [rbp-9h] BYREF
  float v12; // [rsp+C8h] [rbp+17h]
  char v13; // [rsp+CCh] [rbp+1Bh]
  ...
  std::pair<std::wstring const,std::variant<unsigned long,bool,float>>::pair<std::wstring const,std::variant<unsigned long,bool,float>>(
    (__int64)v10,
    L"PointScaleFactorStick",
    &v6.m128i_i32[2]);
  std::wstring::wstring(v11, L"DeadZoneAngle");
  v12 = FLOAT_3_0;
  v13 = 2;
  *(float *)&v6.m128i_i32[2] = FLOAT_0_1;
  std::pair<std::wstring const,std::variant<unsigned long,bool,float>>::pair<std::wstring const,std::variant<unsigned long,bool,float>>(
    (__int64)v14,
