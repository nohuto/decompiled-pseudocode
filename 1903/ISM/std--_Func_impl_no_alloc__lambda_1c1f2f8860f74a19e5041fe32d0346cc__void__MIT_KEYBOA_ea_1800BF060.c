/*
 * XREFs of std::_Func_impl_no_alloc__lambda_1c1f2f8860f74a19e5041fe32d0346cc__void__MIT_KEYBOARD_OVERRIDER_INPUT_MESSAGE_const___::_Do_call @ 0x1800BF060
 * Callers:
 *     <none>
 * Callees:
        ...
        const struct _MIT_KEYBOARD_OVERRIDER_INPUT_MESSAGE **a2)
{
  ...
  InputTraceLogging::PerfRegion::PerfRegion(
    ...
    L"MITEP_KEYBOARD_OVERRIDER_INPUT_MESSAGE",
    0LL);
