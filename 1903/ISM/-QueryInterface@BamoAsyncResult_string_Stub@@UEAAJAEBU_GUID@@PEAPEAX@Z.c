/*
 * XREFs of ?QueryInterface@BamoAsyncResult_string_Stub@@UEAAJAEBU_GUID@@PEAPEAX@Z @ 0x1801234B0
 * Callers:
 *     ?QueryInterface@BamoAsyncResult_string_Stub@@W7EAAJAEBU_GUID@@PEAPEAX@Z @ 0x18003A030 (-QueryInterface@BamoAsyncResult_string_Stub@@W7EAAJAEBU_GUID@@PEAPEAX@Z.c)
 * Callees:
