/*
 * XREFs of ?HandStateRead_@SpatialInteractionTraceContinuous@SpatialInteractionDevices@@QEAAXU_GUID@@_J_N2H22@Z @ 0x1800F4E18
 * Callers:
        ...
        bool a8)
{
  ...
  if ( *(_DWORD *)v9 > 5u )
  {
    if ( TlgKeywordOn(v9, 2uLL) )
    {
      ...
      v23 = 1LL;
      v25 = 1LL;
      TlgWrite(v10, &unk_18019FEA1, 0LL, 0LL, 9u, &pData);
    }
  }
}
