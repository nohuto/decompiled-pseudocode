/*
 * XREFs of ?UpdateSystemCursorController@BamoInputSystemProxyImpl@BamoImpl@@QEAAJI@Z @ 0x180064DF4
 * Callers:
 *     ?Thunk_UpdateSystemCursorController_0@?$IInputSystemProxy_Receive@VBamoInputSystemProxyImpl@BamoImpl@@@@SAJPEAXPEAPEAX@Z @ 0x180063B50 (-Thunk_UpdateSystemCursorController_0@-$IInputSystemProxy_Receive@VBamoInputSystemProxyImpl@Bamo.c)
 * Callees:
