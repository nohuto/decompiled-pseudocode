/*
 * XREFs of ?erase@?$_Tree@V?$_Tmap_traits@KUHOTKEY@@U?$less@K@std@@V?$allocator@U?$pair@$$CBKUHOTKEY@@@std@@@3@$0A@@std@@@std@@QEAA?AV?$_Tree_iterator@V?$_Tree_val@U?$_Tree_simple_types@U?$pair@$$CBKUHOTKEY@@@std@@@std@@@std@@@2@V?$_Tree_const_iterator@V?$_Tree_val@U?$_Tree_simple_types@U?$pair@$$CBKUHOTKEY@@@std@@@std@@@std@@@2@0@Z @ 0x18014746C
 * Callers:
 *     ??0HotKeyProcessor@@QEAA@XZ @ 0x1801457BC (--0HotKeyProcessor@@QEAA@XZ.c)
 *     ??1?$map@KUHOTKEY@@U?$less@K@std@@V?$allocator@U?$pair@$$CBKUHOTKEY@@@std@@@3@@std@@QEAA@XZ @ 0x180145A00 (--1-$map@KUHOTKEY@@U-$less@K@std@@V-$allocator@U-$pair@$$CBKUHOTKEY@@@std@@@3@@std@@QEAA@XZ.c)
 * Callees:
...
__int64 **__fastcall std::_Tree<std::_Tmap_traits<unsigned long,HOTKEY,std::less<unsigned long>,std::allocator<std::pair<unsigned long const,HOTKEY>>,0>>::erase(
        __int64 ***a1,
        __int64 **a2,
        __int64 *a3,
        __int64 *a4)
