/*
 * XREFs of ?Materialize_BamoMPCManagerProxy@BamoPeerImpl@MPCManagerBamo_AutoBamos@BamoImpl@@QEAAJI@Z @ 0x18007E828
 * Callers:
 *     ?Thunk_Materialize_BamoMPCManagerProxy_11@?$IBamoPeer_MPCManagerBamo_AutoBamos_Receive@VBamoPeerImpl@MPCManagerBamo_AutoBamos@BamoImpl@@@@SAJPEAXPEAPEAX@Z @ 0x18007FA40 (-Thunk_Materialize_BamoMPCManagerProxy_11@-$IBamoPeer_MPCManagerBamo_AutoBamos_Receive@VBamoPeer.c)
 * Callees:
