/*
 * XREFs of ?SpatialObjectDeviceStopListeningToSpatialObjects_@SpatialInteractionTrace@SpatialInteractionDevices@@QEAAXPEB_WJ@Z @ 0x1800EDA9C
 * Callers:
 *     _lambda_88fb4871a400503c69c7f747a4c77519_::operator() @ 0x1800EB1F4 (_lambda_88fb4871a400503c69c7f747a4c77519_--operator().c)
 * Callees:
        ...
        int a3)
{
  ...
  if ( *(_DWORD *)v4[1] > 4u )
  {
    if ( TlgKeywordOn((TraceLoggingHProvider)v4[1], 2uLL) )
    {
      ...
      v9 = &v12;
      v10 = cData;
      TlgWrite(v6, &unk_18019EC30, 0LL, 0LL, cData, &pData);
    }
  }
}
