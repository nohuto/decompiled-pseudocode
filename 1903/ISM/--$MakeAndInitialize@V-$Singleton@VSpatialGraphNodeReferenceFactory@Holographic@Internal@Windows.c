/*
 * XREFs of ??$MakeAndInitialize@V?$Singleton@VSpatialGraphNodeReferenceFactory@Holographic@Internal@Windows@@V1234@@WRL@Microsoft@@UIInspectable@@$$V@Details@WRL@Microsoft@@YAJPEAPEAUIInspectable@@@Z @ 0x18014AE50
 * Callers:
 ...
 *     ??0SpatialGraphNodeReferenceFactory@Holographic@Internal@Windows@@QEAA@XZ @ 0x180151264 (--0SpatialGraphNodeReferenceFactory@Holographic@Internal@Windows@@QEAA@XZ.c)
        ...
        _QWORD *a1)
{
  ...
  *a1 = 0LL;
  ...
  if ( v2 )
  {
    ...
    *((_BYTE *)v3 + 72) = SpatialGraphDriverClientHelpers::DefaultSpatialGraphSettings(v7);
