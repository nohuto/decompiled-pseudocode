/*
 * XREFs of ?OnMenuPressed@BamoMPCManagerClientPrincipalImpl@BamoImpl@@QEAAJPEAULegacyDeviceInfo@@I@Z @ 0x180115D70
 * Callers:
 *     ?Thunk_OnMenuPressed_54@?$IMPCManagerClientPrincipal_Receive@VBamoMPCManagerClientPrincipalImpl@BamoImpl@@@@SAJPEAXPEAPEAX@Z @ 0x1801164A0 (-Thunk_OnMenuPressed_54@-$IMPCManagerClientPrincipal_Receive@VBamoMPCManagerClientPrincipalImpl@.c)
 * Callees:
