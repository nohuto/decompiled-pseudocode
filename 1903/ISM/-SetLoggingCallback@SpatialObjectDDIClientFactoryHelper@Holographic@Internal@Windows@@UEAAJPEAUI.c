/*
 * XREFs of ?SetLoggingCallback@SpatialObjectDDIClientFactoryHelper@Holographic@Internal@Windows@@UEAAJPEAUISpatialObjectDDIClientLoggingCallback@234@@Z @ 0x1800ED8A0
 * Callers:
 *     <none>
 * Callees:
