/*
 * XREFs of ??$make_shared@VSpatialInteractionEyeGazeSourceObject@SpatialInteractions@Internal@Windows@@PEB_WPEAUISpatialObjectDevice@Holographic@34@PEAUISpatialObject@634@@std@@YA?AV?$shared_ptr@VSpatialInteractionEyeGazeSourceObject@SpatialInteractions@Internal@Windows@@@0@$$QEAPEB_W$$QEAPEAUISpatialObjectDevice@Holographic@Internal@Windows@@$$QEAPEAUISpatialObject@345@@Z @ 0x1800F0568
 * Callers:
