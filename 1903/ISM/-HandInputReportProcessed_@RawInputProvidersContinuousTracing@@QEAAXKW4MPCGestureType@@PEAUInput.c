/*
 * XREFs of ?HandInputReportProcessed_@RawInputProvidersContinuousTracing@@QEAAXKW4MPCGestureType@@PEAUInputInfo@@@Z @ 0x18009D118
 * Callers:
...
char __fastcall RawInputProvidersContinuousTracing::HandInputReportProcessed_(__int64 a1, int a2, int a3, __int64 a4)
{
  ...
  if ( *(_DWORD *)v7 > 5u )
  {
    ...
    if ( (_BYTE)v6 )
    {
      ...
      v30 = 4LL;
      v32 = 16LL;
      LOBYTE(v6) = TlgWrite(v8, &unk_18019C8B2, 0LL, 0LL, 0xCu, &pData);
    }
  }
  return v6;
}
