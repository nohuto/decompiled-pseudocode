/*
 * XREFs of ?try_get_parent_path_range@wil@@YA_NPEBGPEA_K@Z @ 0x1800A0644
 * Callers:
 *     ?CreateDirectoryDeepNoThrow@wil@@YAJPEBG@Z @ 0x18009C714 (-CreateDirectoryDeepNoThrow@wil@@YAJPEBG@Z.c)
 * Callees:
 *     ?find_last_path_segment@wil@@YAPEBGPEBG@Z @ 0x1800A04CC (-find_last_path_segment@wil@@YAPEBGPEBG@Z.c)
 */
