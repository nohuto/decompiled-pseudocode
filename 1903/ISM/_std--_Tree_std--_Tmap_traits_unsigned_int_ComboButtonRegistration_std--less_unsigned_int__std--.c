...
void __fastcall __noreturn std::_Tree_std::_Tmap_traits_unsigned_int_ComboButtonRegistration_std::less_unsigned_int__std::allocator_std::pair_unsigned_int_const__ComboButtonRegistration____0___::_Insert_hint_std::pair_unsigned_int_const__ComboButtonRegistration____std::_Tree_node_std::pair_unsigned_int_const__ComboButtonRegistration__void_______::_1_::catch_41(
        __int64 a1,
        __int64 a2)
{
