  ...
  else
  {
    while ( v5 != a4 )
    {
      ...
      v14 = std::_Tree_val<std::_Tree_simple_types<std::pair<unsigned int const,std::shared_ptr<CustomCursorApplication>>>>::_Extract(
              a1,
              v9);
      wil::com_ptr_t<IMPCInputProviderBase,wil::err_exception_policy>::~com_ptr_t<IMPCInputProviderBase,wil::err_exception_policy>(v14 + 5);
      std::_Deallocate<16,0>(v14, (const struct std::nothrow_t *)0x30);
    }
    *a2 = v5;
  }
  return a2;
