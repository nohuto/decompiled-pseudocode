/*
 * XREFs of ?StartActivity@CloseHolographicDevice@HolographicDriverClientTrace@@QEAAXPEB_WW4TraceDriverType@@AEBU_GUID@@@Z @ 0x18015DA08
 * Callers:
        ...
        __int64 a4)
{
  ...
  if ( *(_DWORD *)v9 > 5u )
  {
    ...
    TlgWrite(v9, &unk_1801A3A08, (LPCGUID)(*(_QWORD *)(a1 + 48) + 8LL), v11, 7u, &pData);
  }
  if ( !*(_DWORD *)(a1 + 32) )
