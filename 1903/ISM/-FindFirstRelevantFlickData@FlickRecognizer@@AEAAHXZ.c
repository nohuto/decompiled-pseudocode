/*
 * XREFs of ?FindFirstRelevantFlickData@FlickRecognizer@@AEAAHXZ @ 0x18010B2A4
 * Callers:
 *     ?CheckForFlick@FlickRecognizer@@AEAAXPEBVGestureSession@@@Z @ 0x18010B174 (-CheckForFlick@FlickRecognizer@@AEAAXPEBVGestureSession@@@Z.c)
 * Callees:
 *     <none>
 */
