/*
 * XREFs of ?GetCachedFeatureEnabledState@?$Feature@U__WilFeatureTraits_Feature_InputVirtualization@@@wil@@CA?AW4wil_details_CachedFeatureEnabledState@@_N@Z @ 0x180107D50
 * Callers:
 ...
 *     ?GetCurrentFeatureEnabledState@?$Feature@U__WilFeatureTraits_Feature_InputVirtualization@@@wil@@CA?AW4wil_details_CachedFeatureEnabledState@@_NPEAW4wil_details_CachedHasNotificationState@@PEAH@Z @ 0x180108058 (-GetCurrentFeatureEnabledState@-$Feature@U__WilFeatureTraits_Feature_InputVirtualization@@@wil@@.c)
 */
