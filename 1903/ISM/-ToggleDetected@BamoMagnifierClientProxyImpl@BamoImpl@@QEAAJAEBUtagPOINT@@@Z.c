/*
 * XREFs of ?ToggleDetected@BamoMagnifierClientProxyImpl@BamoImpl@@QEAAJAEBUtagPOINT@@@Z @ 0x18006FF30
 * Callers:
...
__int64 __fastcall BamoImpl::BamoMagnifierClientProxyImpl::ToggleDetected(
...
LABEL_3:
  ...
  v7[0] = v9;
  v7[1] = v10;
  return CoreUICallSend(v6, v7, 2LL, 35LL);
}
