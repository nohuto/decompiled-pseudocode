/*
 * XREFs of ??0AsyncStringPrincipal@@QEAA@PEAVMPCManagerClientConnection@@V?$function@$$A6AXPEBG@Z@std@@V?$function@$$A6AXJ@Z@3@@Z @ 0x180123140
 * Callers:
 ...
 *     ??0?$function@$$A6AXAEBV?$shared_ptr@VSpatialInteractionSourceDevice@SpatialInteractions@Internal@Windows@@@std@@@Z@std@@QEAA@AEBV01@@Z @ 0x1800E0650 (--0-$function@$$A6AXAEBV-$shared_ptr@VSpatialInteractionSourceDevice@SpatialInteractions@Interna.c)
 */
