/*
 * XREFs of ?StartDeviceObject@PnpDeviceWatcher@@AEAAJAEAUDeviceListEntry@1@@Z @ 0x1800ACAA8
 * Callers:
    ...
    && PnpDevice::OpenInterface(*((PnpDevice **)a2 + 2)) == -2147024864 )
  {
    ...
    if ( InterfacePath >= 0 )
    {
      if ( (unsigned int)hProvider > 5 )
      {
        ...
        TlgWrite((TraceLoggingHProvider)&hProvider, &unk_18019D2C5, 0LL, 0LL, 4u, &pData);
      }
      ...
      if ( v20 )
      {
        ...
        if ( wil::Feature<__WilFeatureTraits_Feature_Servicing_SmartLightFix_25315772>::__private_IsEnabled((__int64)v21) )
          *((_WORD *)v20 + 14) = 3000;
        else
          *((_WORD *)v20 + 14) = 100;
