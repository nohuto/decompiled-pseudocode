/*
 * XREFs of ?UpdateScaleOverride@BamoSystemCursorControllerProxyImpl@BamoImpl@@QEAAJM@Z @ 0x180064C44
 * Callers:
 *     ?Thunk_UpdateScaleOverride_207@?$ISystemCursorControllerProxy_Receive@VBamoSystemCursorControllerProxyImpl@BamoImpl@@@@SAJPEAXPEAPEAX@Z @ 0x18002ED70 (-Thunk_UpdateScaleOverride_207@-$ISystemCursorControllerProxy_Receive@VBamoSystemCursorControlle.c)
 * Callees:
