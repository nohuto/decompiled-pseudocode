/*
 * XREFs of ??0SpatialInteractionSourceController@SpatialInteractions@Internal@Windows@@QEAA@PEAUIHidDevice@123@KKV?$function@$$A6AXXZ@std@@@Z @ 0x180162D4C
 * Callers:
 ...
 *     ??0HID_HANDLE@SpatialInteractionDevices@@QEAA@XZ @ 0x1800DE810 (--0HID_HANDLE@SpatialInteractionDevices@@QEAA@XZ.c)
 ...
 *     ??0SpatialInteractionSourceDevice@SpatialInteractions@Internal@Windows@@QEAA@KKW4InputType@@@Z @ 0x1801630C4 (--0SpatialInteractionSourceDevice@SpatialInteractions@Internal@Windows@@QEAA@KKW4InputType@@@Z.c)
        ...
        __int64 a5)
{
  ...
  *(_OWORD *)((char *)&v19.m256i_u64[1] + 4) = xmmword_180199580;
