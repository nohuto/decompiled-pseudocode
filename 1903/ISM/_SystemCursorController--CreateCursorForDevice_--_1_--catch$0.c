/*
 * XREFs of _SystemCursorController::CreateCursorForDevice_::_1_::catch$0 @ 0x1800C97B0
 * Callers:
 *     <none>
 * Callees:
...
void *__fastcall SystemCursorController::CreateCursorForDevice_::_1_::catch_0(
        __int64 a1,
        __int64 a2,
        __int64 a3,
        const char *a4)
