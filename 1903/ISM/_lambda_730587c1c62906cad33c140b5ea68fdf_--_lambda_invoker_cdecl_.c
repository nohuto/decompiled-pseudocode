/*
 * XREFs of _lambda_730587c1c62906cad33c140b5ea68fdf_::_lambda_invoker_cdecl_ @ 0x180161BD0
 * Callers:
 *     <none>
 * Callees:
 *     ??R?$_Func_class@X$$V@std@@QEBAXXZ @ 0x1800806B8 (--R-$_Func_class@X$$V@std@@QEBAXXZ.c)
 *     ?EnsureWorkerTimer@KeepAliveTimer@ThreadpoolTimerHelpers@@AEAAX_K@Z @ 0x1800E2394 (-EnsureWorkerTimer@KeepAliveTimer@ThreadpoolTimerHelpers@@AEAAX_K@Z.c)
 */
