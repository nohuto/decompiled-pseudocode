...
void __fastcall std::_Tree<std::_Tmap_traits<SPATIAL_NODE_ID,std::vector<std::unique_ptr<Windows::Internal::Holographic::V2PropertyRequest>>,Windows::Internal::Holographic::SpatialNodeIdComp,std::allocator<std::pair<SPATIAL_NODE_ID const,std::vector<std::unique_ptr<Windows::Internal::Holographic::V2PropertyRequest>>>>,0>>::_Erase(
        __int64 a1,
        _QWORD *a2)
{
  _QWORD *v2; // rbx
  ...
  for ( i = a2; !*((_BYTE *)i + 25); v2 = i )
  {
    ...
    if ( v6 )
    {
      ...
      std::_Deallocate<16,0>(v6, (const struct std::nothrow_t *)((v2[8] - (_QWORD)v6) & 0xFFFFFFFFFFFFFFF8uLL));
      v2[6] = 0LL;
      v2[7] = 0LL;
      v2[8] = 0LL;
    }
