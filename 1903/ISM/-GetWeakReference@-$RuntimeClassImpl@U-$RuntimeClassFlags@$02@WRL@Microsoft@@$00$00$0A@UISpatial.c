        ...
        struct IUnknown *a2)
{
  ...
  if ( v2 >= 0 )
  {
    ...
    *(_DWORD *)(WeakReference + 16) = v4;
    ...
    v11 = _InterlockedCompareExchange64((volatile signed __int64 *)(a1 + 72), v9, v4);
