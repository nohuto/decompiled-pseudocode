/*
 * XREFs of ??$MakeAndInitialize@VActivationProcessor@@V1@PEAVDWMInputRouter@@@Details@WRL@Microsoft@@YAJPEAPEAVActivationProcessor@@$$QEAPEAVDWMInputRouter@@@Z @ 0x1800C1B20
 * Callers:
 ...
 *     ??0ActivationProcessor@@QEAA@XZ @ 0x1800C20CC (--0ActivationProcessor@@QEAA@XZ.c)
 */
