/*
 * XREFs of ??$MakeAndInitialize@VHotkeyContextualProcessor@@V1@$$V@Details@WRL@Microsoft@@YAJPEAPEAVHotkeyContextualProcessor@@@Z @ 0x1800C1BB0
 * Callers:
 ...
 *     ??0HotkeyContextualProcessor@@QEAA@XZ @ 0x1800C21A8 (--0HotkeyContextualProcessor@@QEAA@XZ.c)
