/*
 * XREFs of ?GetCachedFeatureEnabledState@?$Feature@U__WilFeatureTraits_Feature_KeyboardInputVirtualization@@@wil@@CA?AW4wil_details_CachedFeatureEnabledState@@_N@Z @ 0x180107E18
 * Callers:
