/*
 * XREFs of ?FeedPositionAnimationData@DWMCursor@@AEAAJXZ @ 0x180144930
 * Callers:
...
__int64 __fastcall DWMCursor::FeedPositionAnimationData(DWMCursor *this)
{
  ...
  void (__fastcall ***v12)(_QWORD); // [rsp+58h] [rbp+10h] BYREF
  ...
  v5 = (*(__int64 (__fastcall **)(__int64, __int64))(*(_QWORD *)(v11 + 8) + 48LL))(v11 + 8, 2LL);
  v6 = v5;
  if ( v5 >= 0 )
  {
    v9 = v11;
