/*
 * XREFs of ?SendMaterializeProxy@BamoMPCConstantManagerClientCallbacksPrincipalImpl@BamoImpl@@UEAAXPEAUIMessageCallSendHost@@PEAVBamoStubImpl@2Microsoft@@@Z @ 0x1801243C0
 * Callers:
 *     <none>
 * Callees:
