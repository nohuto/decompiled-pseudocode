        ...
        char *a2)
{
  ...
  for ( i = a2; !i[25]; v2 = i )
  {
    ...
    std::_Tree<std::_Tset_traits<Windows::Internal::Holographic::TimestampedProperty<std::wstring>,std::less<Windows::Internal::Holographic::TimestampedProperty<std::wstring>>,std::allocator<Windows::Internal::Holographic::TimestampedProperty<std::wstring>>,0>>::erase(
      ...
      *((_QWORD *)v2 + 13),
      v5);
    std::_Deallocate<16,0>(*((void **)v2 + 13), (const struct std::nothrow_t *)0x48);
    std::wstring::_Tidy_deallocate((__int64)(v2 + 64));
    std::wstring::_Tidy_deallocate((__int64)(v2 + 32));
    std::_Deallocate<16,0>(v2, (const struct std::nothrow_t *)0x488);
  }
}
