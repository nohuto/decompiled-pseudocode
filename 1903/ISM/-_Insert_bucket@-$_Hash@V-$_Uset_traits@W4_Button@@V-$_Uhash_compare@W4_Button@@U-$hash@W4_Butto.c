/*
 * XREFs of ?_Insert_bucket@?$_Hash@V?$_Uset_traits@W4_Button@@V?$_Uhash_compare@W4_Button@@U?$hash@W4_Button@@@std@@U?$equal_to@W4_Button@@@3@@std@@V?$allocator@W4_Button@@@3@$0A@@std@@@std@@IEAAXV?$_List_unchecked_const_iterator@V?$_List_val@U?$_List_simple_types@W4_Button@@@std@@@std@@U_Iterator_base0@2@@2@0_K@Z @ 0x180034330
 * Callers:
        ...
        __int64 a4)
{
  ...
  {
    result = *(__int64 **)(v4 + 8 * v5 + 8);
    v8 = *result;
    *(_QWORD *)(v4 + 8 * v5 + 8) = *result;
    if ( v8 != a2 )
    {
      v9 = *(_QWORD *)(a1 + 24);
      result = *(__int64 **)(v9 + 8 * v5 + 8);
      *(_QWORD *)(v9 + 8 * v5 + 8) = result[1];
    }
  }
  return result;
}
