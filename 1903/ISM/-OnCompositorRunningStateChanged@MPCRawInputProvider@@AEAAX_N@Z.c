/*
 * XREFs of ?OnCompositorRunningStateChanged@MPCRawInputProvider@@AEAAX_N@Z @ 0x180094800
 * Callers:
...
void __fastcall MPCRawInputProvider::OnCompositorRunningStateChanged(MPCRawInputProvider *this, char a2)
{
  ...
  volatile signed __int32 *v11[2]; // [rsp+20h] [rbp-28h] BYREF
  PVOID v12; // [rsp+30h] [rbp-18h]
  volatile signed __int32 *v13; // [rsp+60h] [rbp+18h] BYREF
  struct MPCRawInputProvider *v14; // [rsp+68h] [rbp+20h] BYREF
  ...
  if ( a2 )
  {
    if ( !v3 )
    {
      ...
      v14 = this;
      v5 = Microsoft::WRL::Details::Make<SpectrumListener,MPCRawInputProvider *>(v11, &v14);
      v6 = 0LL;
      if ( &v13 != v5 )
      {
        v6 = *v5;
      ...
      v13 = (volatile signed __int32 *)*((_QWORD *)this + 6);
      *((_QWORD *)this + 6) = v6;
  ...
  else if ( v3 )
  {
    ...
    Microsoft::WRL::ComPtr<SpectrumListener>::InternalRelease((volatile signed __int32 **)v9);
    v10 = (MPCHeadMovementDetector *)*((_QWORD *)this + 7);
    *((_QWORD *)this + 7) = 0LL;
    if ( v10 )
    {
      MPCHeadMovementDetector::~MPCHeadMovementDetector(v10);
      operator delete(v10, (const struct std::nothrow_t *)0xA8);
    }
    *((_BYTE *)this + 80) = 0;
  }
