/*
 * XREFs of ?_Destroy@?$vector@V?$ComPtr@VWGIController@@@WRL@Microsoft@@V?$allocator@V?$ComPtr@VWGIController@@@WRL@Microsoft@@@std@@@std@@AEAAXPEAV?$ComPtr@VWGIController@@@WRL@Microsoft@@0@Z @ 0x1800A8208
 * Callers:
 *     _std::vector_Microsoft::WRL::ComPtr_WGIController__std::allocator_Microsoft::WRL::ComPtr_WGIController_____::_Emplace_reallocate_Microsoft::WRL::ComPtr_WGIController____::_1_::catch$32 @ 0x1800A719A (_std--vector_Microsoft--WRL--ComPtr_WGIController__std--allocator_Microsoft--WRL--ComPtr_WGICont.c)
 * Callees:
...
__int64 __fastcall std::vector<Microsoft::WRL::ComPtr<WGIController>>::_Destroy(
        __int64 a1,
