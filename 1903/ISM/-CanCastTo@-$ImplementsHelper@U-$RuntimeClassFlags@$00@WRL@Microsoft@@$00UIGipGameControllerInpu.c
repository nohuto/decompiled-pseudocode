/*
 * XREFs of ?CanCastTo@?$ImplementsHelper@U?$RuntimeClassFlags@$00@WRL@Microsoft@@$00UIGipGameControllerInputSinkPrivate@Internal@Input@Gaming@Windows@@UIHidGameControllerInputSink@Custom@678@UIXusbGameControllerInputSink@Custom@678@@Details@WRL@Microsoft@@IEAAJAEBU_GUID@@PEAPEAXPEA_N@Z @ 0x1800A93A8
 * Callers:
