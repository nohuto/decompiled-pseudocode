/*
 * XREFs of ?UnregisterSpatialEventHandlers@MPCSpatialGestureRecognizerHandler@@AEAAXXZ @ 0x18009155C
 * Callers:
 *     ??1MPCSpatialGestureRecognizerHandler@@UEAA@XZ @ 0x18008F504 (--1MPCSpatialGestureRecognizerHandler@@UEAA@XZ.c)
 * Callees:
