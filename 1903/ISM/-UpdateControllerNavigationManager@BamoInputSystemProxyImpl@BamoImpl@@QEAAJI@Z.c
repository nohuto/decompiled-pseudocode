/*
 * XREFs of ?UpdateControllerNavigationManager@BamoInputSystemProxyImpl@BamoImpl@@QEAAJI@Z @ 0x1800640FC
 * Callers:
 *     ?Thunk_UpdateControllerNavigationManager_0@?$IInputSystemProxy_Receive@VBamoInputSystemProxyImpl@BamoImpl@@@@SAJPEAXPEAPEAX@Z @ 0x180063190 (-Thunk_UpdateControllerNavigationManager_0@-$IInputSystemProxy_Receive@VBamoInputSystemProxyImpl.c)
 * Callees:
