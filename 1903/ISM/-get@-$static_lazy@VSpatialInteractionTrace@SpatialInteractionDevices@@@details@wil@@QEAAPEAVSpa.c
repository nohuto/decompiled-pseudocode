/*
 * XREFs of ?get@?$static_lazy@VSpatialInteractionTrace@SpatialInteractionDevices@@@details@wil@@QEAAPEAVSpatialInteractionTrace@SpatialInteractionDevices@@P6AXXZ@Z @ 0x1800DA21C
 * Callers:
...
_QWORD *__fastcall wil::details::static_lazy<SpatialInteractionDevices::SpatialInteractionTrace>::get(
        __int64 a1,
        void (__cdecl *a2)())
{
  ...
  {
    v5 = qword_1801E0F18;
    qword_1801E0F18[0] = &RawInputProvidersContinuousTracing::`vftable';
    qword_1801E0F30 = (struct _TlgProvider_t *)&`SpatialInteractionDevices::SpatialInteractionTrace::StaticHandle::StaticHandle'::`2'::__hInner;
    atexit(a2);
    wil::TraceLoggingProvider::Register((wil::TraceLoggingProvider *)qword_1801E0F18, qword_1801E0F30);
    InitOnceComplete(&`SpatialInteractionDevices::SpatialInteractionTrace::Instance'::`2'::wrapper, 0, qword_1801E0F18);
  }
  return v5;
}
