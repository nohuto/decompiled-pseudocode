/*
 * XREFs of ?Materialize_BamoEdgyControllerServerProxy@BamoPeerImpl@ISMBamos_AutoBamos@BamoImpl@@QEAAJI@Z @ 0x18005E7A4
 * Callers:
 *     ?Thunk_Materialize_BamoEdgyControllerServerProxy_0@?$IBamoPeer_ISMBamos_AutoBamos_Receive@VBamoPeerImpl@ISMBamos_AutoBamos@BamoImpl@@@@SAJPEAXPEAPEAX@Z @ 0x180062D50 (-Thunk_Materialize_BamoEdgyControllerServerProxy_0@-$IBamoPeer_ISMBamos_AutoBamos_Receive@VBamoP.c)
 * Callees:
        ...
        unsigned int a2)
{
  ...
  *(_QWORD *)v4 = &BamoEdgyControllerServerProxy::`vftable'{for `Microsoft::Bamo::BamoProxy'};
  *((_QWORD *)v4 + 1) = &BamoEdgyControllerServerProxy::`vftable'{for `IEdgyControllerServerProxy'};
  *((_DWORD *)v4 + 6) = 0;
  *((_QWORD *)v4 + 4) = 0LL;
  *((_DWORD *)v4 + 10) = 0;
  *((_WORD *)v4 + 22) = 0;
