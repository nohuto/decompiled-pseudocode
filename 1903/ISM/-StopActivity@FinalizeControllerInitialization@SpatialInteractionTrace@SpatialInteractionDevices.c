/*
 * XREFs of ?StopActivity@FinalizeControllerInitialization@SpatialInteractionTrace@SpatialInteractionDevices@@MEAAXXZ @ 0x1800E58B0
 * Callers:
 *     <none>
 * Callees:
        ...
        SpatialInteractionDevices::SpatialInteractionTrace::FinalizeControllerInitialization *this)
{
  ...
  if ( v4 )
  {
    if ( *(_DWORD *)v6[1] > 4u && TlgKeywordOn((TraceLoggingHProvider)v6[1], 0x400000000000uLL) )
    {
      ...
      TlgWrite(v13, &unk_18019E1FA, (LPCGUID)(*((_QWORD *)this + 6) + 8LL), 0LL, 0x12u, &pData);
    }
  }
  else
  {
    ...
    if ( *(_DWORD *)v14 > 4u && TlgKeywordOn((TraceLoggingHProvider)v6[1], 0x400000000000uLL) )
    {
      ...
      v17 = CurrentThreadId;
      v28 = &v17;
      TlgWrite(v14, &unk_18019E7C8, (LPCGUID)(*((_QWORD *)this + 6) + 8LL), 0LL, 5u, &v23);
    }
  }
  if ( *((_DWORD *)this + 8) )
