/*
 * XREFs of SpatialInteractionDevices::ParseFloatData_DirectX::XMFLOAT4_ @ 0x1800DACDC
 * Callers:
 *     SpatialInteractionDevices::ReadPoseOrientation @ 0x1800DD318 (SpatialInteractionDevices--ReadPoseOrientation.c)
 * Callees:
  ...
  for ( i = 0; i < 4; ++i )
    result = result
          && (int)SpatialInteractionDevices::Internal::HIDGetFloat(
                    this,
                    a2,
                    (struct SpatialInteractionDevices::HID_REPORT *)&unk_180171E30,
                    (enum _HIDP_REPORT_TYPE)*((unsigned __int16 *)&unk_180171E30 + 8 * i),
                    *((_WORD *)&unk_180171E30 + 8 * i + 1),
                    *((_WORD *)&unk_180171E30 + 8 * i + 2),
                    *((_WORD *)&unk_180171E30 + 8 * i + 3),
