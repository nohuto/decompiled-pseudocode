/*
 * XREFs of ?OnPenEventsKernelMessage@PenEventsDispatcherPrincipal@@AEAAXPEBU_MIT_PEN_EVENT_MESSAGE@@@Z @ 0x180032A14
 * Callers:
 *     std::_Func_impl_no_alloc__lambda_169f4db4f162cf2479feb08acf74ea7d__void__MIT_PEN_EVENT_MESSAGE_const___::_Do_call @ 0x180033EC0 (std--_Func_impl_no_alloc__lambda_169f4db4f162cf2479feb08acf74ea7d__void__MIT_PEN_EV_ea_180033EC0.c)
 * Callees:
 ...
 *     ?GetEffectiveButtonRoutingPolicy@PenEventsDispatcherPrincipal@@AEAA?AW4RoutingPolicy@Input@Devices@Internal@Windows@@XZ @ 0x180032138 (-GetEffectiveButtonRoutingPolicy@PenEventsDispatcherPrincipal@@AEAA-AW4RoutingPolicy@Input@Devic.c)
