/*
 * XREFs of ?TrackingStateChanged_@HolographicDriverClientTrace@@QEAAXAEBU_GUID@@AEBUSPATIAL_NODE_ID@@W4SPATIAL_TRACKING_STATE@@2@Z @ 0x18015FD60
 * Callers:
 ...
 *     ?SpatialTrackingStateToString@@YAPEBDW4SPATIAL_TRACKING_STATE@@@Z @ 0x18015D9D4 (-SpatialTrackingStateToString@@YAPEBDW4SPATIAL_TRACKING_STATE@@@Z.c)
...
char __fastcall HolographicDriverClientTrace::TrackingStateChanged_(__int64 a1, __int64 a2, __int64 a3, int a4, int a5)
{
  ...
  if ( **(_DWORD **)(v8 + 8) > 4u )
  {
    ...
    if ( (_BYTE)v8 )
    {
      ...
      v21 = 8LL;
      v20 = &qword_1801E0C60;
      LOBYTE(v8) = TlgWrite(v11, &unk_1801A2924, 0LL, 0LL, 7u, &pData);
    }
  }
  return v8;
}
