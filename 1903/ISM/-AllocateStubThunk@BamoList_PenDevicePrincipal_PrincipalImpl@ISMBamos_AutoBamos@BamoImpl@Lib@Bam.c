/*
 * XREFs of ?AllocateStubThunk@BamoList_PenDevicePrincipal_PrincipalImpl@ISMBamos_AutoBamos@BamoImpl@Lib@Bamo@Microsoft@@UEAAJPEAVBaseBamoPeerImpl@36@PEAPEAVBamoStub@56@@Z @ 0x180127AE0
 * Callers:
 *     <none>
 * Callees:
