/*
 * XREFs of _SystemCursorController::EnsureServiceAndRegisterClient_::_1_::catch$26 @ 0x1800CA699
 * Callers:
 *     <none>
 * Callees:
...
void *__fastcall SystemCursorController::EnsureServiceAndRegisterClient_::_1_::catch_26(
        __int64 a1,
        __int64 a2,
        __int64 a3,
        const char *a4)
