/*
 * XREFs of ?LogMPCSpatialControllerInputReport@ISMTracing@@SAXPEAUInputInfo@@AEB_N@Z @ 0x18013D954
 * Callers:
...
void __fastcall ISMTracing::LogMPCSpatialControllerInputReport(struct InputInfo *a1, const bool *a2)
{
  ...
  if ( *((_DWORD *)a1 + 17) == 3 || *((_DWORD *)a1 + 17) == 6 )
  {
    ...
    if ( *(_DWORD *)v8 > 5u && TlgKeywordOn(v8, 1uLL) )
    {
      ...
      v24 = 4LL;
      v26 = 4LL;
      TlgWrite(v10, &unk_1801A18E3, 0LL, 0LL, 8u, &pData);
    }
  }
  else
  {
    ...
    if ( *(_DWORD *)v4 > 4u )
    {
      if ( TlgKeywordOn(v4, 1uLL) )
      {
        ...
        v24 = v7;
        v26 = v7;
        TlgWrite(v6, &unk_1801A1731, 0LL, 0LL, 8u, &pData);
      }
    }
  }
}
