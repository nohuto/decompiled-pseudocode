/*
 * XREFs of ?BuildAndSendMouseInputInfo@ControllerProcessor@@AEAAJW4GamepadButtons@Input@Gaming@Windows@@0@Z @ 0x1800756F4
 * Callers:
  ...
  for ( i = 0; i < 2; ++i )
  {
    ...
    if ( (v9 != 0) != ((a2 & *(v3 - 1)) != 0) )
    {
      ...
      *((_DWORD *)a1 + v11 + 2771) = v9 != 0;
      if ( v9 )
        v13 = *((_DWORD *)&unk_180199680 + 3 * v11 + 2);
      else
        v13 = *((_DWORD *)&unk_180199680 + 3 * v11 + 1);
      v5 |= v13;
    }
LABEL_11:
    v3 += 2;
