        ...
        char a5)
{
  ...
  if ( *(_DWORD *)v7 > 4u )
  {
    if ( TlgKeywordOn(v7, 2uLL) )
    {
      ...
      v15 = 16LL;
      v17 = 4LL;
      TlgWrite(v8, &unk_1801A23A4, 0LL, 0LL, 6u, &pData);
    }
  }
}
