/*
 * XREFs of ?ControllerNodeStartTracking_@SpatialInteractionTrace@SpatialInteractionDevices@@QEAAXJKKW4SPATIAL_TRACKING_STATE@@_NKAEBUDynamicNodeInfo@Holographic@Internal@Windows@@@Z @ 0x180164DC4
 * Callers:
        ...
        __int64 a8)
{
  ...
  if ( *(_DWORD *)v9 > 4u )
  {
    ...
    if ( (_BYTE)v8 )
    {
      ...
      v29 = 16LL;
      v31 = v11;
      LOBYTE(v8) = TlgWrite(v10, &unk_1801A4BF0, 0LL, 0LL, 0xAu, &pData);
    }
  }
  return (char)v8;
}
