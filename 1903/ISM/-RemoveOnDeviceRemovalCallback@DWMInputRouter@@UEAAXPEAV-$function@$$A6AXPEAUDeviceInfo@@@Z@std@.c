/*
 * XREFs of ?RemoveOnDeviceRemovalCallback@DWMInputRouter@@UEAAXPEAV?$function@$$A6AXPEAUDeviceInfo@@@Z@std@@@Z @ 0x1800C4F60
 * Callers:
 *     <none>
 * Callees:
...
_QWORD *__fastcall DWMInputRouter::RemoveOnDeviceRemovalCallback(__int64 a1, __int64 a2)
{
  _QWORD *i; // r8
  __int64 v4; // [rsp+30h] [rbp+8h] BYREF

  for ( i = *(_QWORD **)(a1 + 736); i != *(_QWORD **)(a1 + 744) && *i != a2; ++i )
    ;
  return std::vector<ISupportedInputUpdateObserver *>::erase(a1 + 736, &v4, (__int64)i);
}
