/*
 * XREFs of ??$emplace_front@AEAVRayStabilizationResult@@@?$deque@VRayStabilizationResult@@V?$allocator@VRayStabilizationResult@@@std@@@std@@QEAAAEAVRayStabilizationResult@@AEAV2@@Z @ 0x18012C53C
 * Callers:
        ...
        __int64 a2)
{
  ...
  *(_DWORD *)(v11 + 96) = *(_DWORD *)(a2 + 96);
  ...
  if ( *a1 )
    v9 = **a1;
  return *(_QWORD *)(*(_QWORD *)(v9 + 8) + 8 * ((unsigned __int64)v8 & (*(_QWORD *)(v9 + 16) - 1LL)));
}
