/*
 * XREFs of ?RequestGripStatusForPanel@BamoHeatGripServicePrincipalImpl@BamoImpl@@QEAAJPEAUHeatPanelInfo@@@Z @ 0x18007A754
 * Callers:
 *     ?Thunk_RequestGripStatusForPanel_122@?$IHeatGripServicePrincipal_Receive@VBamoHeatGripServicePrincipalImpl@BamoImpl@@@@SAJPEAXPEAPEAX@Z @ 0x18007A900 (-Thunk_RequestGripStatusForPanel_122@-$IHeatGripServicePrincipal_Receive@VBamoHeatGripServicePri.c)
 * Callees:
