/*
 * XREFs of ?ParseInputReport@SpatialInteractionDevices@@YAJPEAUHID_HANDLE@1@PEAUHID_REPORT@1@PEAUInputReport@1@@Z @ 0x1800DC924
 * Callers:
 ...
 *     SpatialInteractionDevices::ReadBatteryLevel @ 0x1800DD244 (SpatialInteractionDevices--ReadBatteryLevel.c)
 *     SpatialInteractionDevices::ReadLocalOrientation @ 0x1800DD280 (SpatialInteractionDevices--ReadLocalOrientation.c)
 *     SpatialInteractionDevices::ReadPoseOrientation @ 0x1800DD318 (SpatialInteractionDevices--ReadPoseOrientation.c)
 *     SpatialInteractionDevices::ReadPosePosition @ 0x1800DD344 (SpatialInteractionDevices--ReadPosePosition.c)
 *     SpatialInteractionDevices::ReadThumbstick @ 0x1800DD36C (SpatialInteractionDevices--ReadThumbstick.c)
 *     SpatialInteractionDevices::ReadTouchpad @ 0x1800DD3F8 (SpatialInteractionDevices--ReadTouchpad.c)
 *     SpatialInteractionDevices::ReadTrigger @ 0x1800DD484 (SpatialInteractionDevices--ReadTrigger.c)
