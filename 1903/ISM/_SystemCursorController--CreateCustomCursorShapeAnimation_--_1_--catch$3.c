/*
 * XREFs of _SystemCursorController::CreateCustomCursorShapeAnimation_::_1_::catch$3 @ 0x1800C9D36
 * Callers:
 *     <none>
 * Callees:
...
void *__fastcall SystemCursorController::CreateCustomCursorShapeAnimation_::_1_::catch_3(
        __int64 a1,
        __int64 a2,
        __int64 a3,
        const char *a4)
