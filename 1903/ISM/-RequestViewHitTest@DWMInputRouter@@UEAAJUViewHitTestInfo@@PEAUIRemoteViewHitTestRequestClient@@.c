/*
 * XREFs of ?RequestViewHitTest@DWMInputRouter@@UEAAJUViewHitTestInfo@@PEAUIRemoteViewHitTestRequestClient@@@Z @ 0x1800C5380
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall DWMInputRouter::RequestViewHitTest(__int64 a1, __int128 *a2, __int64 *a3)
{
  ...
  v12 = v5;
  v13 = v4;
  DWMInputRouter::RequestViewHitTestHelper(a1 - 32, &v11, a2);
  if ( a3 )
  {
    v7 = *a2;
    v13 = *((_DWORD *)a2 + 6);
