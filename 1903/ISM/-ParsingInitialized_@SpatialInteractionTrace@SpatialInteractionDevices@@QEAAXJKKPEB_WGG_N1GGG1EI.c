/*
 * XREFs of ?ParsingInitialized_@SpatialInteractionTrace@SpatialInteractionDevices@@QEAAXJKKPEB_WGG_N1GGG1EIKAEBUPoseData@2@2@Z @ 0x1801673C4
 * Callers:
 ...
 *     ??$swprintf_s@$0EA@@@YAHAEAY0EA@_WPEB_WZZ @ 0x1800D7988 (--$swprintf_s@$0EA@@@YAHAEAY0EA@_WPEB_WZZ.c)
        ...
        const struct SpatialInteractionDevices::PoseData *a18)
{
  ...
  if ( *(_DWORD *)v22[1] > 4u )
  {
    if ( TlgKeywordOn((TraceLoggingHProvider)v22[1], 0x400000000000uLL) )
    {
      ...
      TlgWrite(v25, &unk_1801A4AD1, 0LL, 0LL, 0x15u, &pData);
    }
  }
}
