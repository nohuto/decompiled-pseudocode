/*
 * XREFs of ?ReleasePrivateReference@SharedObjectBase@@IEAAIXZ @ 0x1800D6A10
 * Callers:
 ...
 *     ?ReleasePrivateReference@SipcServer@@UEAAXXZ @ 0x1800D6A90 (-ReleasePrivateReference@SipcServer@@UEAAXXZ.c)
 * Callees:
