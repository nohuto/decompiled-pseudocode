/*
 * XREFs of ?NotifyClientOfEdgyDetected@EdgyConnection@@QEAAJPEBUCandidateIdentity@@PEAUCandidateEdgyDetectedInfo@@PEBUEdgyPointerInfo@@2@Z @ 0x180100454
 * Callers:
        ...
        struct D2D_VECTOR_2F a5)
{
  ...
  D2D_VECTOR_2F v21; // [rsp+5Ch] [rbp+Bh]
  ...
  D2D_VECTOR_2F v27; // [rsp+C0h] [rbp+6Fh] BYREF
  ...
  if ( *((_BYTE *)a3 + 1) )
  {
    ...
    v25 = v16;
    v23 = a5;
    v17 = (*(__int64 (__fastcall **)(__int64, __int64, __int64 *, __int64))(*(_QWORD *)v14 + 168LL))(
            v14,
            v15,
            &v19,
            56LL);
