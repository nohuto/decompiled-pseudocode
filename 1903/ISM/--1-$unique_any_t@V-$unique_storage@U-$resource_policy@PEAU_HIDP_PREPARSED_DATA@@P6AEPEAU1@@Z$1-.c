/*
 * XREFs of ??1?$unique_any_t@V?$unique_storage@U?$resource_policy@PEAU_HIDP_PREPARSED_DATA@@P6AEPEAU1@@Z$1?HidD_FreePreparsedData@@YAE0@ZU?$integral_constant@_K$0A@@wistd@@PEAU1@PEAU1@$0A@$$T@details@wil@@@details@wil@@@wil@@QEAA@XZ @ 0x1800AFE00
 * Callers:
 *     _PenDevice::PenDevice_::_1_::dtor$2 @ 0x180129ED7 (_PenDevice--PenDevice_--_1_--dtor$2.c)
 * Callees:
 *     <none>
 */
