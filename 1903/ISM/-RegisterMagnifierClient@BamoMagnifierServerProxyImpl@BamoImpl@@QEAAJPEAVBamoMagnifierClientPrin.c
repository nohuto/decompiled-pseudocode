/*
 * XREFs of ?RegisterMagnifierClient@BamoMagnifierServerProxyImpl@BamoImpl@@QEAAJPEAVBamoMagnifierClientPrincipal@@@Z @ 0x180062094
 * Callers:
...
__int64 __fastcall BamoImpl::BamoMagnifierServerProxyImpl::RegisterMagnifierClient(
        BamoImpl::BamoMagnifierServerProxyImpl *this,
...
LABEL_3:
  ...
  v6[0] = v8;
  v6[1] = v9;
  return CoreUICallSend(v10, v6, 2LL, 37LL);
}
