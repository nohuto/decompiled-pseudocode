/*
 * XREFs of ?OnInput@ActivationProcessor@@UEAAJPEAUInputInfo@@PEAUInputContext@@PEAUContextualProcessorResponse@@@Z @ 0x1800FBA70
 * Callers:
 *     <none>
 * Callees:
 ...
 *     ?IsViewPartOfForegroundApplication@ViewHelper@@SA_NPEAUIViewHierarchy@@I@Z @ 0x180058AFC (-IsViewPartOfForegroundApplication@ViewHelper@@SA_NPEAUIViewHierarchy@@I@Z.c)
 */
