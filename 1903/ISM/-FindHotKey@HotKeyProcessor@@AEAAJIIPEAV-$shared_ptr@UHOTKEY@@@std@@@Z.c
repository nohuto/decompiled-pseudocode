/*
 * XREFs of ?FindHotKey@HotKeyProcessor@@AEAAJIIPEAV?$shared_ptr@UHOTKEY@@@std@@@Z @ 0x18014676C
 * Callers:
...
LABEL_8:
  ...
  if ( (unsigned int)dword_1801DE450 > 5 && TlgKeywordOn((TraceLoggingHProvider)&dword_1801DE450, 0x40000uLL) )
  {
    ...
    v21 = 8LL;
    v23 = 8LL;
    TlgWrite((TraceLoggingHProvider)&dword_1801DE450, &unk_1801A2115, 0LL, 0LL, 7u, &pData);
    v5 = *(__int64 **)(a1 + 24);
  }
  if ( v7 == v5 )
  {
  ...
  else
  {
    ...
    if ( (unsigned int)dword_1801DE450 > 5 && TlgKeywordOn((TraceLoggingHProvider)&dword_1801DE450, 0x40000uLL) )
    {
      ...
      v21 = 8LL;
      v23 = 8LL;
      TlgWrite((TraceLoggingHProvider)&dword_1801DE450, &unk_1801A220A, 0LL, 0LL, 7u, &pData);
    }
  }
  return 0LL;
}
