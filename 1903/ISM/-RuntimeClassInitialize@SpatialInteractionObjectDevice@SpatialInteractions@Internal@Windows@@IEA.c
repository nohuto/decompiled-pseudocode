/*
 * XREFs of ?RuntimeClassInitialize@SpatialInteractionObjectDevice@SpatialInteractions@Internal@Windows@@IEAAJPEAUISpatialInteractionSourceDeviceCollectionInternal@234@PEAUISpatialObjectDDIClientFactory@Holographic@34@PEB_WPEAUISpatialObjectDevice@734@@Z @ 0x1800ED62C
 * Callers:
        ...
        struct Windows::Internal::Holographic::ISpatialObjectDevice *a5)
{
  ...
  Microsoft::WRL::ComPtr<IUnknown>::operator=((__int64 *)this + 14, (__int64)a3);
  v16 = a2;
  if ( a2 )
  ...
  v12 = Microsoft::WRL::AsWeak<Windows::Internal::SpatialInteractions::ISpatialInteractionSourceDeviceCollectionInternal>(
