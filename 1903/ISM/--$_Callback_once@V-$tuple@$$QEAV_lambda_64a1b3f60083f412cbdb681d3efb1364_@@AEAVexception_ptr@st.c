/*
 * XREFs of ??$_Callback_once@V?$tuple@$$QEAV_lambda_64a1b3f60083f412cbdb681d3efb1364_@@AEAVexception_ptr@std@@@std@@U?$integer_sequence@_K$0A@@2@$00@std@@YAHPEAX0PEAPEAX@Z @ 0x180097370
 * Callers:
 *     <none>
 * Callees:
 ...
 *     ??0MPCHeadUpdateListener@@QEAA@XZ @ 0x1800976C8 (--0MPCHeadUpdateListener@@QEAA@XZ.c)
