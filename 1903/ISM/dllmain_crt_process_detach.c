/*
 * XREFs of dllmain_crt_process_detach @ 0x18002B878
 * Callers:
 ...
 *     __scrt_dllmain_uninitialize_critical @ 0x18002BD44 (__scrt_dllmain_uninitialize_critical.c)
 *     __scrt_release_startup_lock @ 0x18002BF30 (__scrt_release_startup_lock.c)
 *     __scrt_uninitialize_crt @ 0x18002BF5C (__scrt_uninitialize_crt.c)
 *     __scrt_fastfail @ 0x18002C028 (__scrt_fastfail.c)
 *     _RTC_Terminate @ 0x18002C1C0 (_RTC_Terminate.c)
 */
