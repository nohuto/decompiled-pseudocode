/*
 * XREFs of ?UpdateHaptics@BamoPenDeviceProxyImpl@BamoImpl@@QEAAJI@Z @ 0x18006442C
 * Callers:
 *     ?Thunk_UpdateHaptics_0@?$IPenDeviceProxy_Receive@VBamoPenDeviceProxyImpl@BamoImpl@@@@SAJPEAXPEAPEAX@Z @ 0x180063500 (-Thunk_UpdateHaptics_0@-$IPenDeviceProxy_Receive@VBamoPenDeviceProxyImpl@BamoImpl@@@@SAJPEAXPEAP.c)
 * Callees:
