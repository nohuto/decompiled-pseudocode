/*
 * XREFs of ?ResendGamepadIsSupportedForProcess@BamoMPCManagerPrincipalImpl@BamoImpl@@QEAAJI@Z @ 0x18007EFC4
 * Callers:
 *     ?Thunk_ResendGamepadIsSupportedForProcess_25@?$IMPCManagerPrincipal_Receive@VBamoMPCManagerPrincipalImpl@BamoImpl@@@@SAJPEAXPEAPEAX@Z @ 0x18007FA50 (-Thunk_ResendGamepadIsSupportedForProcess_25@-$IMPCManagerPrincipal_Receive@VBamoMPCManagerPrinc.c)
 * Callees:
        ...
        unsigned int a2)
{
  ...
  v6 = (*(__int64 (__fastcall **)(char *, __int64, _QWORD))(*((_QWORD *)this - 2) + 88LL))((char *)this - 16, v5, a2);
  if ( v6 < 0 )
