/*
 * XREFs of ??$_Emplace_reallocate@UDeviceDisplayMapping@DWMInputRouter@@@?$vector@UDeviceDisplayMapping@DWMInputRouter@@V?$allocator@UDeviceDisplayMapping@DWMInputRouter@@@std@@@std@@QEAAPEAUDeviceDisplayMapping@DWMInputRouter@@QEAU23@$$QEAU23@@Z @ 0x1800C1D3C
 * Callers:
 ...
 *     ?_Change_array@?$vector@UDeviceDisplayMapping@DWMInputRouter@@V?$allocator@UDeviceDisplayMapping@DWMInputRouter@@@std@@@std@@AEAAXQEAUDeviceDisplayMapping@DWMInputRouter@@_K1@Z @ 0x1800C57E0 (-_Change_array@-$vector@UDeviceDisplayMapping@DWMInputRouter@@V-$allocator@UDeviceDisplayMapping.c)
 */
