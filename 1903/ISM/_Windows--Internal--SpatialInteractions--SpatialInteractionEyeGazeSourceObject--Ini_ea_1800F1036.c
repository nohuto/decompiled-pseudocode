/*
 * XREFs of _Windows::Internal::SpatialInteractions::SpatialInteractionEyeGazeSourceObject::InitializeStreamReaderHelpers_::_1_::catch$5 @ 0x1800F1036
 * Callers:
 *     <none>
 * Callees:
