/*
 * XREFs of ??$_Callback_once@V?$tuple@$$QEAV_lambda_c5f59095f0ae3e38eeaa5c86892cff4d_@@AEAVexception_ptr@std@@@std@@U?$integer_sequence@_K$0A@@2@$00@std@@YAHPEAX0PEAPEAX@Z @ 0x18012E9B0
 * Callers:
 *     <none>
 * Callees:
        ...
        __int64 a2)
{
  ...
  try
  {
    lambda_c5f59095f0ae3e38eeaa5c86892cff4d_::operator()(*(_QWORD *)(a2 + 8));
    result = 1LL;
  }
  catch ( ... )
  {
