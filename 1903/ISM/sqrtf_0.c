 ...
 *     ?XMScalarACos@DirectX@@YAMM@Z @ 0x18009709C (-XMScalarACos@DirectX@@YAMM@Z.c)
 ...
 *     ?RefreshScreenSize@GestureSession@@SAJXZ @ 0x18010AB04 (-RefreshScreenSize@GestureSession@@SAJXZ.c)
 ...
 *     ??$SO3_compute_exp_coefs@M@ST@@YAXMAEAM00@Z @ 0x18016A564 (--$SO3_compute_exp_coefs@M@ST@@YAXMAEAM00@Z.c)
