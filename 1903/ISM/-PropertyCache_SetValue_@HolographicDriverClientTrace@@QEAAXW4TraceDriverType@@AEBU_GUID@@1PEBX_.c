/*
 * XREFs of ?PropertyCache_SetValue_@HolographicDriverClientTrace@@QEAAXW4TraceDriverType@@AEBU_GUID@@1PEBX_K@Z @ 0x18015BF2C
 * Callers:
 *     ?LogValueChanged@PropertyCache@Holographic@Internal@Windows@@MEAAXAEBU_GUID@@AEBV?$vector@EV?$allocator@E@std@@@std@@@Z @ 0x180159930 (-LogValueChanged@PropertyCache@Holographic@Internal@Windows@@MEAAXAEBU_GUID@@AEBV-$vector@EV-$al.c)
 * Callees:
        ...
        char a6)
{
  ...
  if ( **(_DWORD **)(v9 + 8) > 4u )
  {
    ...
    if ( (_BYTE)v9 )
    {
      ...
      v18 = 16LL;
      v20 = 8LL;
      LOBYTE(v9) = TlgWrite(v11, &unk_1801A3968, 0LL, 0LL, 6u, &pData);
    }
  }
  return v9;
}
