/*
 * XREFs of ?Materialize_BamoUIAHitTestInputObjectProxy@BamoPeerImpl@ISMBamos_AutoBamos@BamoImpl@@QEAAJI@Z @ 0x18005F368
 * Callers:
 *     ?Thunk_Materialize_BamoUIAHitTestInputObjectProxy_0@?$IBamoPeer_ISMBamos_AutoBamos_Receive@VBamoPeerImpl@ISMBamos_AutoBamos@BamoImpl@@@@SAJPEAXPEAPEAX@Z @ 0x180062EB0 (-Thunk_Materialize_BamoUIAHitTestInputObjectProxy_0@-$IBamoPeer_ISMBamos_AutoBamos_Receive@VBamo.c)
 * Callees:
        ...
        unsigned int a2)
{
  ...
  *(_QWORD *)v4 = &BamoUIAHitTestInputObjectProxy::`vftable'{for `Microsoft::Bamo::BamoProxy'};
  *((_QWORD *)v4 + 1) = &BamoUIAHitTestInputObjectProxy::`vftable'{for `IUIAHitTestInputObjectProxy'};
  *((_DWORD *)v4 + 6) = 0;
  *((_QWORD *)v4 + 4) = 0LL;
  *((_DWORD *)v4 + 10) = 0;
  *((_WORD *)v4 + 22) = 0;
  *((_QWORD *)v4 + 2) = &BamoImpl::BamoUIAHitTestInputObjectProxyImpl::`vftable';
  *((_QWORD *)v4 + 6) = 0LL;
  *((_QWORD *)v4 + 7) = 0LL;
