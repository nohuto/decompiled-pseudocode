/*
 * XREFs of ?_Reset_move@?$_Func_class@XPEAUISpatialInteractionSourceCollectionCallbacks@SpatialInteractions@Internal@Windows@@@std@@IEAAX$$QEAV12@@Z @ 0x1800E6A80
 * Callers:
 *     ?_Swap@?$_Func_class@XE@std@@IEAAXAEAV12@@Z @ 0x1800E6AD8 (-_Swap@-$_Func_class@XE@std@@IEAAXAEAV12@@Z.c)
 *     ??0?$function@$$A6AXXZ@std@@QEAA@$$QEAV01@@Z @ 0x18016291C (--0-$function@$$A6AXXZ@std@@QEAA@$$QEAV01@@Z.c)
 * Callees:
