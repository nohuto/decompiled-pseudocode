/*
 * XREFs of ?StartRawGameControllerWatcher@WGIRawInputProvider@@AEAAJXZ @ 0x180026E28
 * Callers:
...
__int64 __fastcall WGIRawInputProvider::StartRawGameControllerWatcher(struct _RTL_CRITICAL_SECTION *this)
{
  ...
  *v6 = 0LL;
  ...
  {
    *(_QWORD *)&v26 = 0LL;
    Microsoft::WRL::Details::RuntimeClassImpl<Microsoft::WRL::RuntimeClassFlags<2>,1,0,0,IRawInputProvider>::Release(v7);
  }
