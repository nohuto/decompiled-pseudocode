        ...
        __int64 *a4)
{
  ...
  if ( *(_QWORD *)(v11 + 16 * (v8 & *(_QWORD *)(a1 + 48))) != v12 )
  {
    ...
    {
      std::list<std::pair<unsigned long const,InputContext>>::erase(v29 + 8, &v29, v31);
      throw;
    }
  }
  v13 = v12;
  while ( v13 != *(_QWORD *)(v11 + 16 * (v8 & *(_QWORD *)(a1 + 48))) )
  {
    ...
    {
      std::list<std::pair<unsigned long const,InputContext>>::erase(a1 + 8, &v30, a4);
      *(_QWORD *)a2 = v12;
      *(_BYTE *)(a2 + 8) = 0;
      return a2;
    }
