/*
 * XREFs of ??1OneCoreUAPInputHost@@MEAA@XZ @ 0x18004EAF0
 * Callers:
 ...
 *     ??_GInputProviderManager@@QEAAPEAXI@Z @ 0x18004F0DC (--_GInputProviderManager@@QEAAPEAXI@Z.c)
 *     TraceLoggingUnregister @ 0x180053174 (TraceLoggingUnregister.c)
 */
