/*
 * XREFs of ?_Reallocate_exactly@?$vector@ULampUpdateState@@V?$allocator@ULampUpdateState@@@std@@@std@@AEAAX_K@Z @ 0x1800AFC34
 * Callers:
...
__int64 __fastcall std::vector<LampUpdateState>::_Reallocate_exactly(__int64 a1, unsigned __int64 a2)
{
  ...
  return std::vector<std::function<void (DeviceInfo *)> *,std::allocator<std::function<void (DeviceInfo *)> *>>::_Change_array(
           v10,
           v9,
           v8,
           v7);
