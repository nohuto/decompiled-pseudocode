/*
 * XREFs of ?StartActivity@DeviceRemoved@SpatialInteractionTrace@SpatialInteractionDevices@@QEAAXKK@Z @ 0x1800E4C50
 * Callers:
        ...
        int a3)
{
  ...
  if ( *(_DWORD *)v5 > 4u )
  {
    ...
    TlgWrite(v5, &unk_18019E50F, (LPCGUID)(*((_QWORD *)this + 6) + 8LL), v7, 6u, &pData);
  }
  if ( !*((_DWORD *)this + 8) )
