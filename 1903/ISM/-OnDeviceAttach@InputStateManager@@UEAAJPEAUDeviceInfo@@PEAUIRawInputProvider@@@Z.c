/*
 * XREFs of ?OnDeviceAttach@InputStateManager@@UEAAJPEAUDeviceInfo@@PEAUIRawInputProvider@@@Z @ 0x180012820
 * Callers:
 *     ?OnDeviceAttach@InputStateManager@@W7EAAJPEAUDeviceInfo@@PEAUIRawInputProvider@@@Z @ 0x180038800 (-OnDeviceAttach@InputStateManager@@W7EAAJPEAUDeviceInfo@@PEAUIRawInputProvider@@@Z.c)
 * Callees:
  ...
  if ( InputETW::IsVerboseEnabled(1uLL) )
  {
    ...
    if ( *(_DWORD *)v18 > 5u )
    {
      if ( TlgKeywordOn(v18, 1uLL) )
      {
        ...
        v29 = 8;
        v30 = 0;
        TlgWrite(v19, &unk_18019C3F8, 0LL, 0LL, 4u, &pData);
      }
    }
  }
  if ( a3 )
