/*
 * XREFs of ??0SpatialInteractionEyeGazeObjectDevice@SpatialInteractions@Internal@Windows@@QEAA@XZ @ 0x1800EA6A0
 * Callers:
 ...
 * Callees:
 *     ??0SpatialInteractionObjectDevice@SpatialInteractions@Internal@Windows@@QEAA@XZ @ 0x1800EA76C (--0SpatialInteractionObjectDevice@SpatialInteractions@Internal@Windows@@QEAA@XZ.c)
 */
        ...
        Windows::Internal::SpatialInteractions::SpatialInteractionEyeGazeObjectDevice *this)
{
  ...
  *((_QWORD *)this + 2) = &Windows::Internal::SpatialInteractions::SpatialInteractionEyeGazeObjectDevice::`vftable'{for `IWeakReferenceSource'};
  *((_QWORD *)this + 3) = &Windows::Internal::SpatialInteractions::SpatialInteractionEyeGazeObjectDevice::`vftable'{for `Microsoft::WRL::Details::ImplementsHelper<Microsoft::WRL::RuntimeClassFlags<3>,1,Microsoft::WRL::Details::ImplementsMarker<Microsoft::WRL::FtmBase>>'};
  *((_QWORD *)this + 25) = 0LL;
  *((_QWORD *)this + 26) = 0LL;
  *((_QWORD *)this + 27) = 0LL;
  *((_QWORD *)this + 28) = 0LL;
