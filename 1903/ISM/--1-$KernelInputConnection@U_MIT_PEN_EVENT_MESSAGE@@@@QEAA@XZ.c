/*
 * XREFs of ??1?$KernelInputConnection@U_MIT_PEN_EVENT_MESSAGE@@@@QEAA@XZ @ 0x180031268
 * Callers:
 *     _PenEventsDispatcherPrincipal::PenEventsDispatcherPrincipal_::_1_::dtor$4 @ 0x18003124C (_PenEventsDispatcherPrincipal--PenEventsDispatcherPrincipal_--_1_--dtor$4.c)
 * Callees:
