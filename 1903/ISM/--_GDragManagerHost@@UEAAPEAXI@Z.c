/*
 * XREFs of ??_GDragManagerHost@@UEAAPEAXI@Z @ 0x180068DE0
 * Callers:
 *     <none>
 * Callees:
...
DragManagerHost *__fastcall DragManagerHost::`scalar deleting destructor'(DragManagerHost *this, char a2)
{
  ...
  Microsoft::WRL::ComPtr<Windows::Gaming::Input::Internal::IGipGameControllerProviderPrivate>::InternalRelease((__int64 *)this + 7);
