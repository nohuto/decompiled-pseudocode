/*
 * XREFs of ?SpatialInputController_Removed_@SpatialInteractionTrace@SpatialInteractionDevices@@QEAAXKQEB_W@Z @ 0x1800E4B9C
 * Callers:
        ...
        const WCHAR *a3)
{
  ...
  if ( *(_DWORD *)v4[1] > 4u )
  {
    if ( TlgKeywordOn((TraceLoggingHProvider)v4[1], 0x400000000000uLL) )
    {
      ...
      TlgWrite(v6, &unk_18019E651, 0LL, 0LL, cData, &pData);
    }
  }
}
