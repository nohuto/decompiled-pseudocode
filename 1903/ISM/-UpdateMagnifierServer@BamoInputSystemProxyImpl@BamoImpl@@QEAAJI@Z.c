/*
 * XREFs of ?UpdateMagnifierServer@BamoInputSystemProxyImpl@BamoImpl@@QEAAJI@Z @ 0x180064980
 * Callers:
 *     ?Thunk_UpdateMagnifierServer_0@?$IInputSystemProxy_Receive@VBamoInputSystemProxyImpl@BamoImpl@@@@SAJPEAXPEAPEAX@Z @ 0x1800639D0 (-Thunk_UpdateMagnifierServer_0@-$IInputSystemProxy_Receive@VBamoInputSystemProxyImpl@BamoImpl@@@.c)
 * Callees:
...
__int64 __fastcall BamoImpl::BamoInputSystemProxyImpl::UpdateMagnifierServer(
