/*
 * XREFs of ?PropertyCache_RemoveValue_@HolographicDriverClientTrace@@QEAAXW4TraceDriverType@@AEBU_GUID@@1@Z @ 0x18015BE50
 * Callers:
 *     ?LogValueRemoved@PropertyCache@Holographic@Internal@Windows@@MEAAXAEBU_GUID@@@Z @ 0x180159990 (-LogValueRemoved@PropertyCache@Holographic@Internal@Windows@@MEAAXAEBU_GUID@@@Z.c)
 * Callees:
        ...
        __int64 a4)
{
  ...
  if ( **(_DWORD **)(v7 + 8) > 4u )
  {
    ...
    if ( (_BYTE)v7 )
    {
      ...
      v13 = a3;
      v16 = a4;
      LOBYTE(v7) = TlgWrite(v9, &unk_1801A3EEA, 0LL, 0LL, 5u, &pData);
    }
  }
  return v7;
}
