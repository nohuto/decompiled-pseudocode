/*
 * XREFs of ?InputReportProcessed_@RawInputProvidersContinuousTracing@@QEAAXKJPEAUInputInfo@@@Z @ 0x18009D50C
 * Callers:
        ...
        struct InputInfo *a4)
{
  ...
  if ( a3 >= 0 )
  {
    ...
    if ( *(_DWORD *)v7 > 5u && TlgKeywordOn(v7, 2uLL) )
    {
      ...
      v47 = 1LL;
      v49 = 4LL;
      TlgWrite(v8, &unk_18019C9B6, 0LL, 0LL, 0x15u, &v11);
    }
  }
  else
  {
    ...
    if ( *(_DWORD *)v5 > 2u )
    {
      if ( TlgKeywordOn(v5, 2uLL) )
      {
        ...
        v52 = 4LL;
        v54 = 4LL;
        TlgWrite(v6, &unk_18019CAF3, 0LL, 0LL, 4u, &pData);
      }
    }
  }
}
