/*
 * XREFs of ?Dispose@MessageProxyReconnectAdapter@@QEAAJXZ @ 0x18005A1D4
 * Callers:
 *     ?UnInitialize@InputServiceProxy@@UEAAJXZ @ 0x1801099A0 (-UnInitialize@InputServiceProxy@@UEAAJXZ.c)
