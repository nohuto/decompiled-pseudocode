/*
 * XREFs of ??$Make@VHomeGestureReadyChangedEventArgs@@AEA_NAEAIAEAIAEA_KAEAIAEAI@Details@WRL@Microsoft@@YA?AV?$ComPtr@VHomeGestureReadyChangedEventArgs@@@12@AEA_NAEAI1AEA_K11@Z @ 0x18010F32C
 * Callers:
 ...
 *     ??0HomeGestureReadyChangedEventArgs@@QEAA@_NII_KII@Z @ 0x18010FA2C (--0HomeGestureReadyChangedEventArgs@@QEAA@_NII_KII@Z.c)
 */
