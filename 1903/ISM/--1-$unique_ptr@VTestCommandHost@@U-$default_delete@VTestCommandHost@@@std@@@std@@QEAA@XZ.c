/*
 * XREFs of ??1?$unique_ptr@VTestCommandHost@@U?$default_delete@VTestCommandHost@@@std@@@std@@QEAA@XZ @ 0x18002B500
 * Callers:
 *     _dynamic_atexit_destructor_for__TestCommandHost::m_instance__ @ 0x18003E160 (_dynamic_atexit_destructor_for__TestCommandHost--m_instance__.c)
 * Callees:
