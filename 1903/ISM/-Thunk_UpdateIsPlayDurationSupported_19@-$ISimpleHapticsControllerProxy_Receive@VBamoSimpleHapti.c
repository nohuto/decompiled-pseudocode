/*
 * XREFs of ?Thunk_UpdateIsPlayDurationSupported_19@?$ISimpleHapticsControllerProxy_Receive@VBamoSimpleHapticsControllerProxyImpl@BamoImpl@@@@SAJPEAXPEAPEAX@Z @ 0x180063890
 * Callers:
 *     <none>
 * Callees:
