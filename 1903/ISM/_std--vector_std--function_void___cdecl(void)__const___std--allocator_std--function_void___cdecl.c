/*
 * XREFs of _std::vector_std::function_void___cdecl(void)__const___std::allocator_std::function_void___cdecl(void)__const_____::_Emplace_reallocate_std::function_void___cdecl(void)__const___const_&__::_1_::catch$34 @ 0x18014C177
 * Callers:
 *     <none>
 * Callees:
