/*
 * XREFs of ??1TwoFingerGestureRecognizer@@UEAA@XZ @ 0x18010A2B0
 * Callers:
 *     _GestureSession::GestureSession_::_1_::dtor$4 @ 0x18010A280 (_GestureSession--GestureSession_--_1_--dtor$4.c)
 * Callees:
 *     <none>
 */
