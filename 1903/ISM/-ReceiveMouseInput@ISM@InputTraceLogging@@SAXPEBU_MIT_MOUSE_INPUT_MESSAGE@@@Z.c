/*
 * XREFs of ?ReceiveMouseInput@ISM@InputTraceLogging@@SAXPEBU_MIT_MOUSE_INPUT_MESSAGE@@@Z @ 0x1800BE930
 * Callers:
...
void __fastcall InputTraceLogging::ISM::ReceiveMouseInput(const struct _MIT_MOUSE_INPUT_MESSAGE *a1)
{
  ...
  if ( *(_DWORD *)v2 > 4u )
  {
    if ( TlgKeywordOn(v2, 0x200uLL) )
    {
      ...
      v9 = 8;
      v12 = 8;
      TlgWrite(v3, &unk_18019D9C6, 0LL, 0LL, 4u, &pData);
    }
  }
}
