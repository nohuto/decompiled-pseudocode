/*
 * XREFs of ?UpdateInputObserverManager@BamoInputSystemProxyImpl@BamoImpl@@QEAAJI@Z @ 0x18006475C
 * Callers:
 *     ?Thunk_UpdateInputObserverManager_0@?$IInputSystemProxy_Receive@VBamoInputSystemProxyImpl@BamoImpl@@@@SAJPEAXPEAPEAX@Z @ 0x180063730 (-Thunk_UpdateInputObserverManager_0@-$IInputSystemProxy_Receive@VBamoInputSystemProxyImpl@BamoIm.c)
 * Callees:
