/*
 * XREFs of ?RegisterEdgyControllerClient@BamoEdgyControllerServerPrincipalImpl@BamoImpl@@QEAAJPEBGI@Z @ 0x18006F724
 * Callers:
 *     ?Thunk_RegisterEdgyControllerClient_118@?$IEdgyControllerServerPrincipal_Receive@VBamoEdgyControllerServerPrincipalImpl@BamoImpl@@@@SAJPEAXPEAPEAX@Z @ 0x18006F8A0 (-Thunk_RegisterEdgyControllerClient_118@-$IEdgyControllerServerPrincipal_Receive@VBamoEdgyContro.c)
 * Callees:
        ...
        unsigned int a3)
{
  ...
  v13 = (*(__int64 (__fastcall **)(char *, __int64, const unsigned __int16 *, char *))(*((_QWORD *)this - 2) + 72LL))(
          (char *)this - 16,
          v7,
          a2,
          v12);
