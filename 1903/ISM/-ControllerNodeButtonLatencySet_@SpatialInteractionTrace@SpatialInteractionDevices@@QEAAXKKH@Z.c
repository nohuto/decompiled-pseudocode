/*
 * XREFs of ?ControllerNodeButtonLatencySet_@SpatialInteractionTrace@SpatialInteractionDevices@@QEAAXKKH@Z @ 0x180164D10
 * Callers:
        ...
        int a4)
{
  ...
  if ( *(_DWORD *)v4 > 4u )
  {
    if ( TlgKeywordOn(v4, 2uLL) )
    {
      ...
      v11 = v6;
      v13 = v6;
      TlgWrite(v5, &unk_1801A4490, 0LL, 0LL, 5u, &pData);
    }
  }
}
