/*
 * XREFs of ?HapticsOutputReportPeriodMicrosecondsSet_@SpatialInteractionTrace@SpatialInteractionDevices@@QEAAXKKI@Z @ 0x180166074
 * Callers:
        ...
        int a4)
{
  ...
  if ( *(_DWORD *)v4 > 4u )
  {
    if ( TlgKeywordOn(v4, 2uLL) )
    {
      ...
      v11 = v6;
      v13 = v6;
      TlgWrite(v5, &unk_1801A48DB, 0LL, 0LL, 5u, &pData);
    }
  }
}
