/*
 * XREFs of ?HitTest@DragNDropProcessorLegacy@@AEAAJUtagPOINT@@PEAUHMONITOR__@@PEA_KPEAU2@23@Z @ 0x1800FF1F4
 * Callers:
 ...
 *     ApplyInverseTransformToPoint_0 @ 0x1800FE730 (ApplyInverseTransformToPoint_0.c)
 */
