/*
 * XREFs of ?HapticsIntensityLevelsSet_@SpatialInteractionTrace@SpatialInteractionDevices@@QEAAXKKE@Z @ 0x180165FBC
 * Callers:
        ...
        char a4)
{
  ...
  if ( *(_DWORD *)v4 > 4u )
  {
    if ( TlgKeywordOn(v4, 2uLL) )
    {
      ...
      v11 = v6;
      v13 = 1LL;
      TlgWrite(v5, &unk_1801A47BC, 0LL, 0LL, 5u, &pData);
    }
  }
}
