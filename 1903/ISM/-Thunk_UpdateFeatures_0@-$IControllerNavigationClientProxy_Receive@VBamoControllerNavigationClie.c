/*
 * XREFs of ?Thunk_UpdateFeatures_0@?$IControllerNavigationClientProxy_Receive@VBamoControllerNavigationClientProxyImpl@BamoImpl@@@@SAJPEAXPEAPEAX@Z @ 0x180071730
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall IControllerNavigationClientProxy_Receive<BamoImpl::BamoControllerNavigationClientProxyImpl>::Thunk_UpdateFeatures_0(
        __int64 a1,
        _DWORD **a2)
{
  int v3; // eax
