/*
 * XREFs of ??0MPCConstantManagerClient@@QEAA@PEAVMPCManagerClientConnection@@@Z @ 0x180119268
 * Callers:
 ...
 * Callees:
 *     ?AddRef@BaseBamoConnection@Bamo@Microsoft@@QEAAKXZ @ 0x180024278 (-AddRef@BaseBamoConnection@Bamo@Microsoft@@QEAAKXZ.c)
