/*
 * XREFs of ?SendMessageToNarrator@KeyboardOverriderDispatcher@@AEAAXAEBU_MIT_KEYBOARD_INPUT_MESSAGE@@AEBUKeyboardInputInfo@@@Z @ 0x1800C0D28
 * Callers:
 ...
 *     ?push_back@?$deque@UKeyboardEvent@@V?$allocator@UKeyboardEvent@@@std@@@std@@QEAAXAEBUKeyboardEvent@@@Z @ 0x1800C1670 (-push_back@-$deque@UKeyboardEvent@@V-$allocator@UKeyboardEvent@@@std@@@std@@QEAAXAEBUKeyboardEve.c)
