/*
 * XREFs of ?SetBuffer@RawUsageIndex@details_abi@wil@@QEAAXPEAX_K1@Z @ 0x180051B98
 * Callers:
        ...
        const char *a4)
{
  ...
  {
    wil::details::in1diag3::_FailFast_Unexpected(retaddr, 3166LL, (__int64)"internal\\sdk\\inc\\wil\\staging.h", a4);
    __debugbreak();
  }
