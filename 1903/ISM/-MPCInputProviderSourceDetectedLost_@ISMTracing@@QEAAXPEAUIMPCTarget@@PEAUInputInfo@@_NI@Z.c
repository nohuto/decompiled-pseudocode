/*
 * XREFs of ?MPCInputProviderSourceDetectedLost_@ISMTracing@@QEAAXPEAUIMPCTarget@@PEAUInputInfo@@_NI@Z @ 0x18013E030
 * Callers:
        ...
        unsigned int a5)
{
  ...
  if ( *(_DWORD *)v8 > 4u && TlgKeywordOn((TraceLoggingHProvider)v7[1], 1uLL) )
  {
    ...
    {
      v11 = (const unsigned __int16 *)((char *)&word_180182F8B + 1);
    ...
    v34 = 1;
    v37 = 4;
    TlgWrite(v8, &unk_1801A1210, 0LL, 0LL, 0xAu, &pData);
  }
}
