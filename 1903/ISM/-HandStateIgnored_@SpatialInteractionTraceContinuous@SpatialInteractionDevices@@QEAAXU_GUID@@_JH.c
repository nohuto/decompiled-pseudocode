/*
 * XREFs of ?HandStateIgnored_@SpatialInteractionTraceContinuous@SpatialInteractionDevices@@QEAAXU_GUID@@_JHH@Z @ 0x1800F4D44
 * Callers:
        ...
        char a5)
{
  ...
  if ( *(_DWORD *)v6 > 5u )
  {
    if ( TlgKeywordOn(v6, 2uLL) )
    {
      ...
      v14 = 4LL;
      v16 = 4LL;
      TlgWrite(v7, &unk_18019FF9E, 0LL, 0LL, 6u, &pData);
    }
  }
}
