/*
 * XREFs of ?PostHitTestProcessing@MPCMouseProcessor@@EEAAXPEAUMPCHolographicInputContext@@PEAUInputInfo@@@Z @ 0x18013BED0
 * Callers:
 *     <none>
 * Callees:
        ...
        struct InputInfo *a3)
{
  ...
  if ( MPCInputProviderBase::IsPrimary(this) && *((_DWORD *)this + 1579) )
  {
    Instance = MPCHolographicInputManager::GetInstance();
    v6 = (_OWORD *)(*(__int64 (__fastcall **)(_QWORD))(**((_QWORD **)Instance + 293) + 232LL))(*((_QWORD *)Instance + 293));
    v7 = 2LL;
