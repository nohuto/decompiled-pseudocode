/*
 * XREFs of ?CreateCursorForDevice@SystemCursorService@@QEAAJ_K@Z @ 0x1800CC2D0
 * Callers:
 ...
 *     ??$?0V?$shared_ptr@VSystemCursorService@@@std@@AEA_K@?$_Ref_count_obj@VSystemCursor@@@std@@QEAA@$$QEAV?$shared_ptr@VSystemCursorService@@@1@AEA_K@Z @ 0x1800CB3B0 (--$-0V-$shared_ptr@VSystemCursorService@@@std@@AEA_K@-$_Ref_count_obj@VSystemCursor@@@std@@QEAA@.c)
