/*
 * XREFs of ??$MakeAndInitialize@VAnimationDataProvider@@UIAnimationDataProvider@@$$V@Details@WRL@Microsoft@@YAJPEAPEAUIAnimationDataProvider@@@Z @ 0x180018DC8
 * Callers:
 ...
 * Callees:
 *     ??0AnimationDataProvider@@QEAA@XZ @ 0x180018E78 (--0AnimationDataProvider@@QEAA@XZ.c)
