/*
 * XREFs of ?GetDropTargetClient@BamoInputSiteElementProxy@@UEAAPEAVBamoDropTargetClientProxy@@XZ @ 0x180009690
 * Callers:
 *     <none>
 * Callees:
        ...
        BamoInputSiteElementProxy *this)
{
  ...
  if ( *(_DWORD *)(v2 + 136) != CurrentThreadId && *(_DWORD *)(v2 + 24) != CurrentThreadId )
  {
    wil::details::in1diag3::_FailFast_Unexpected(
      ...
      v4);
    JUMPOUT(0x1800417B6LL);
  }
  return (struct BamoDropTargetClientProxy *)*((_QWORD *)this + 13);
}
