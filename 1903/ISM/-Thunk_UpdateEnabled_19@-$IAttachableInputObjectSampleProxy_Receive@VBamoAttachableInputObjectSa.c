/*
 * XREFs of ?Thunk_UpdateEnabled_19@?$IAttachableInputObjectSampleProxy_Receive@VBamoAttachableInputObjectSampleProxyImpl@BamoImpl@@@@SAJPEAXPEAPEAX@Z @ 0x1800631C0
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall IAttachableInputObjectSampleProxy_Receive<BamoImpl::BamoAttachableInputObjectSampleProxyImpl>::Thunk_UpdateEnabled_19(
        __int64 a1,
        _BYTE **a2)
{
  int v3; // eax
