/*
 * XREFs of ?PredictFromPoses@ComputeVelocityFallbackPosePredictionModel@Holographic@Internal@Windows@@UEAAJPEAUSPATIAL_GRAPH_DYNAMIC_NODE_POSE@@_K_J0@Z @ 0x18015B5D0
 * Callers:
 *     <none>
 * Callees:
 ...
 *     ??$SE3_log@M@ST@@YAXQEAMAEBU?$SE3@M@0@@Z @ 0x180169EA0 (--$SE3_log@M@ST@@YAXQEAMAEBU-$SE3@M@0@@Z.c)
...
LABEL_10:
  ...
  v84 = v34;
  v85 = v35;
  v44 = (double)(int)qword_1801E0BE0;
  v45 = (double)((int)a4 - (int)v76) / (double)(int)qword_1801E0BE0;
  if ( v45 <= 0.0 )
  {
    v51 = v77;
    *(_OWORD *)a5 = v76;
