/*
 * XREFs of ?DragInProgress@DragNDrop@InputETW@@SAXKPEAUtagPOINT@@00_KW4VirtualKeyModifiers@System@Windows@@@Z @ 0x18006B264
 * Callers:
...
char __fastcall InputETW::DragNDrop::DragInProgress(
        unsigned int a1,
        int *a2,
        int *a3,
        int *a4,
  ...
  if ( (_BYTE)v10 )
  {
    ...
    if ( *(_DWORD *)v12 > 5u )
    {
      ...
      if ( (_BYTE)v10 )
      {
        ...
        v46 = 8;
        v49 = 8;
        LOBYTE(v10) = TlgWrite(v13, &unk_18019AE94, 0LL, 0LL, 0xBu, &pData);
      }
    }
  }
  return (char)v10;
