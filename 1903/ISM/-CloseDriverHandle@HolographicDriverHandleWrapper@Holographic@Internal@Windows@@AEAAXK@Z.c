/*
 * XREFs of ?CloseDriverHandle@HolographicDriverHandleWrapper@Holographic@Internal@Windows@@AEAAXK@Z @ 0x180153844
 * Callers:
 ...
 *     _lambda_cba343ad3d751d9ae6873e9ce73e4f02_::operator() @ 0x1801525A0 (_lambda_cba343ad3d751d9ae6873e9ce73e4f02_--operator().c)
  ...
  if ( hObject != (HANDLE)-1LL )
  {
    ...
    if ( Windows::Internal::Holographic::HolographicDeviceOpenCloseTelemetryEnabled )
    {
      ...
      HolographicDriverClientTrace::TelemetryCloseHolographicDevice::StartActivity(
        ...
        LODWORD(this[1].Ptr),
        (char *)&this[1].Ptr + 4);
      lambda_cba343ad3d751d9ae6873e9ce73e4f02_::operator()(v15);
