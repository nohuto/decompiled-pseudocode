/*
 * XREFs of ?Materialize_BamoInputSiteManagerProxy@BamoPeerImpl@ISMBamos_AutoBamos@BamoImpl@@QEAAJI@Z @ 0x18005EAEC
 * Callers:
 *     ?Thunk_Materialize_BamoInputSiteManagerProxy_0@?$IBamoPeer_ISMBamos_AutoBamos_Receive@VBamoPeerImpl@ISMBamos_AutoBamos@BamoImpl@@@@SAJPEAXPEAPEAX@Z @ 0x180062DD0 (-Thunk_Materialize_BamoInputSiteManagerProxy_0@-$IBamoPeer_ISMBamos_AutoBamos_Receive@VBamoPeerI.c)
 * Callees:
