/*
 * XREFs of ?SetDockRoutingPolicy@BamoPenEventsDispatcherPrincipalImpl@BamoImpl@@QEAAJW4RoutingPolicy@Input@Devices@Internal@Windows@@@Z @ 0x180032FE8
 * Callers:
 *     ?Thunk_SetDockRoutingPolicy_3@?$IPenEventsDispatcherPrincipal_Receive@VBamoPenEventsDispatcherPrincipalImpl@BamoImpl@@@@SAJPEAXPEAPEAX@Z @ 0x180033660 (-Thunk_SetDockRoutingPolicy_3@-$IPenEventsDispatcherPrincipal_Receive@VBamoPenEventsDispatcherPr.c)
 * Callees:
...
__int64 __fastcall BamoImpl::BamoPenEventsDispatcherPrincipalImpl::SetDockRoutingPolicy(
        ...
        unsigned int a2)
{
  ...
  v6 = (*(__int64 (__fastcall **)(_QWORD *, __int64, _QWORD))(*((_QWORD *)a1 - 2) + 88LL))((_QWORD *)a1 - 2, v5, a2);
  if ( v6 < 0 )
  {
