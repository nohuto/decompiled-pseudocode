/*
 * XREFs of ?Set3DFocusTarget@MPCInputRouter@@AEAAXPEAUIMPCFocusTarget@@@Z @ 0x180055CB4
 * Callers:
...
void __fastcall MPCInputRouter::Set3DFocusTarget(MPCInputRouter *this, struct IMPCFocusTarget *a2)
{
  ...
  v2 = (struct IMPCFocusTarget **)((char *)this + 832);
  if ( *((struct IMPCFocusTarget **)this + 104) != a2 )
  {
    v5 = (struct IMPCFocusTarget **)((char *)this + 840);
    Microsoft::WRL::ComPtr<Navigation::Server::IMonitorView>::operator=((__int64 *)this + 105, (__int64 *)this + 104);
    if ( *v2 != a2 )
    {
      v12 = a2;
  ...
  if ( *v2
    && *((_BYTE *)this + 928)
    && *((_QWORD *)this + 117) == (*(__int64 (__fastcall **)(struct IMPCFocusTarget *))(*(_QWORD *)*v2 + 56LL))(*v2) )
  {
    Microsoft::WRL::ComPtr<Navigation::Server::IMonitorView>::operator=((__int64 *)this + 103, (__int64 *)v2);
  }
}
