/*
 * XREFs of ?OnFocusRequest@ContextualProcessorManager@@QEAAJPEAUDeviceInfo@@PEAUInputContext@@PEAUIInputBuffer@@PEAPEAUIInputTarget@@@Z @ 0x18000B840
 * Callers:
    ...
    if ( TlgKeywordOn(v12, 1uLL) )
    {
      ...
      if ( **(_DWORD **)(v38 + 8) > 6u )
      {
        if ( TlgKeywordOn(*(TraceLoggingHProvider *)(v38 + 8), 1uLL) )
        {
          ...
          TlgWrite(v39, &unk_18019D947, &ActivityId, pRelatedActivityId, 3u, &pData);
        }
      }
    }
  }
    ...
    while ( 1 )
    {
      ...
      *(_QWORD *)pActivityId.Data4 = 0LL;
        ...
        if ( TlgKeywordOn(v15, 1uLL) )
        {
          ...
          if ( **(_DWORD **)(v41 + 8) > 6u )
          {
            if ( TlgKeywordOn(*(TraceLoggingHProvider *)(v41 + 8), 1uLL) )
            {
              ...
              TlgWrite(v42, &unk_18019D947, &pActivityId, v85, 3u, &v96);
            }
          }
        }
      }
      ...
      if ( **((_DWORD **)v65 + 1) > 4u && TlgKeywordOn(*((TraceLoggingHProvider *)v65 + 1), 1uLL) )
      {
        ...
        TlgWrite(v43, &unk_1801A0426, 0LL, 0LL, 3u, &v98);
      }
      ...
      if ( **((_DWORD **)v66 + 1) > 4u && TlgKeywordOn(*((TraceLoggingHProvider *)v66 + 1), 0x400uLL) )
      {
        ...
        TlgCreateSz(&v93, v44);
        TlgWrite(v45, &unk_1801A049D, 0LL, 0LL, 4u, &v91);
      }
      v67 = 0LL;
      ...
      if ( **((_DWORD **)v67 + 1) > 6u && TlgKeywordOn(*((TraceLoggingHProvider *)v67 + 1), 1uLL) )
      {
        ...
        TlgWrite(v46, &unk_18019D9A7, &pActivityId, v85, 3u, &v100);
      }
      v19 = v54;
...
LABEL_92:
  ...
  if ( **((_DWORD **)v69 + 1) > 6u && TlgKeywordOn(*((TraceLoggingHProvider *)v69 + 1), 1uLL) )
  {
    ...
    TlgWrite(v47, &unk_18019D9A7, &ActivityId, pRelatedActivityId, 3u, &v102);
  }
  return v34;
}
