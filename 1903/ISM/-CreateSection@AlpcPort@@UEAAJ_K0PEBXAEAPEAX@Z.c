/*
 * XREFs of ?CreateSection@AlpcPort@@UEAAJ_K0PEBXAEAPEAX@Z @ 0x1800D4FF0
 * Callers:
 *     <none>
 * Callees:
 ...
 *     ?ComputeFromData@SipcSectionId@@QEAAJ_KPEBX@Z @ 0x1800D4E80 (-ComputeFromData@SipcSectionId@@QEAAJ_KPEBX@Z.c)
 ...
 *     ?InitializeSectionMemory@SipcPort@@KAXPEAUSectionListEntry@1@AEBUSipcSectionId@@@Z @ 0x1800D623C (-InitializeSectionMemory@SipcPort@@KAXPEAUSectionListEntry@1@AEBUSipcSectionId@@@Z.c)
