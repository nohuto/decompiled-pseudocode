/*
 * XREFs of ?Initialize@HidLampArrayDevice@@AEAAJPEAVPnpDevice@@@Z @ 0x1800B3E38
 * Callers:
 ...
 *     ?KeyboardHidUsageToVKey@HidUsageConverter@@SAIG@Z @ 0x1800B6B00 (-KeyboardHidUsageToVKey@HidUsageConverter@@SAIG@Z.c)
 */
...
LABEL_84:
  ...
  if ( (unsigned int)hProvider > 5 )
  {
    ...
    TlgWrite((TraceLoggingHProvider)&hProvider, &unk_18019D811, 0LL, 0LL, 4u, &pData);
  }
...
LABEL_71:
    if ( (unsigned int)hProvider > 5 )
    {
      ...
      TlgWrite((TraceLoggingHProvider)&hProvider, &unk_18019D811, 0LL, 0LL, 4u, &v64);
      if ( (unsigned int)hProvider > 5 )
      {
        ...
        TlgWrite((TraceLoggingHProvider)&hProvider, &unk_18019D811, 0LL, 0LL, 4u, &v68);
      }
    }
