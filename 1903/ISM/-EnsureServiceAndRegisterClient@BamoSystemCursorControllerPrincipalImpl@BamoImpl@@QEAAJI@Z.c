/*
 * XREFs of ?EnsureServiceAndRegisterClient@BamoSystemCursorControllerPrincipalImpl@BamoImpl@@QEAAJI@Z @ 0x1800CA434
 * Callers:
 *     ?Thunk_EnsureServiceAndRegisterClient_0@?$ISystemCursorControllerPrincipal_Receive@VBamoSystemCursorControllerPrincipalImpl@BamoImpl@@@@SAJPEAXPEAPEAX@Z @ 0x1800CAC10 (-Thunk_EnsureServiceAndRegisterClient_0@-$ISystemCursorControllerPrincipal_Receive@VBamoSystemCu.c)
 * Callees:
