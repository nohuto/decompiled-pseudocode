/*
 * XREFs of ?StartAnimation@BamoDragNDropContextualProcessorPrincipalImpl@BamoImpl@@QEAAJII@Z @ 0x180069114
 * Callers:
 *     ?Thunk_StartAnimation_95@?$IDragNDropContextualProcessorPrincipal_Receive@VBamoDragNDropContextualProcessorPrincipalImpl@BamoImpl@@@@SAJPEAXPEAPEAX@Z @ 0x1800693D0 (-Thunk_StartAnimation_95@-$IDragNDropContextualProcessorPrincipal_Receive@VBamoDragNDropContextu.c)
 * Callees:
