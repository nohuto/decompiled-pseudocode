/*
 * XREFs of ?GiveSpatialDataToPID@BamoMPCManagerPrincipalImpl@BamoImpl@@QEAAJI@Z @ 0x18007E064
 * Callers:
 *     ?Thunk_GiveSpatialDataToPID_25@?$IMPCManagerPrincipal_Receive@VBamoMPCManagerPrincipalImpl@BamoImpl@@@@SAJPEAXPEAPEAX@Z @ 0x18007F910 (-Thunk_GiveSpatialDataToPID_25@-$IMPCManagerPrincipal_Receive@VBamoMPCManagerPrincipalImpl@BamoI.c)
 * Callees:
