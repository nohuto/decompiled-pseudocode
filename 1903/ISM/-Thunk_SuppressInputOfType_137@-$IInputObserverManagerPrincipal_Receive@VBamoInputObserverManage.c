/*
 * XREFs of ?Thunk_SuppressInputOfType_137@?$IInputObserverManagerPrincipal_Receive@VBamoInputObserverManagerPrincipalImpl@BamoImpl@@@@SAJPEAXPEAPEAX@Z @ 0x180067C20
 * Callers:
 *     <none>
 * Callees:
 *     <none>
