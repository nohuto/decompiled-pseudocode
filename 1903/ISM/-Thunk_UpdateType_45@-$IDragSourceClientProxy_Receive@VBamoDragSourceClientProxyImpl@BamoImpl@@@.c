/*
 * XREFs of ?Thunk_UpdateType_45@?$IDragSourceClientProxy_Receive@VBamoDragSourceClientProxyImpl@BamoImpl@@@@SAJPEAXPEAPEAX@Z @ 0x180063C20
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall IDragSourceClientProxy_Receive<BamoImpl::BamoDragSourceClientProxyImpl>::Thunk_UpdateType_45(
        __int64 a1,
        _OWORD **a2)
{
  int v3; // eax
