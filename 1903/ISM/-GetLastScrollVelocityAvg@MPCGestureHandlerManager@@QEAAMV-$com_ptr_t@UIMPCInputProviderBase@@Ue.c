/*
 * XREFs of ?GetLastScrollVelocityAvg@MPCGestureHandlerManager@@QEAAMV?$com_ptr_t@UIMPCInputProviderBase@@Uerr_exception_policy@wil@@@wil@@@Z @ 0x180086468
 * Callers:
...
__m128 __fastcall MPCGestureHandlerManager::GetLastScrollVelocityAvg(__int64 a1, __int64 *a2)
{
  ...
  else
  {
    std::map<wil::com_ptr_t<IMPCInputProviderBase,wil::err_exception_policy>,wil::com_ptr_t<MPCGestureHandler,wil::err_exception_policy>>::_Try_emplace<wil::com_ptr_t<IMPCInputProviderBase,wil::err_exception_policy> const &,>(
      ...
      (unsigned __int64)v7,
      a2);
    v5 = *(unsigned int *)(*(_QWORD *)(v7[0] + 40LL) + 956LL);
  }
