/*
 * XREFs of ??_GCustomCursorApplication@@QEAAPEAXI@Z @ 0x1800C91A8
 * Callers:
 *     ?_Destroy@?$_Ref_count_obj@VCustomCursorApplication@@@std@@EEAAXXZ @ 0x1800CAD30 (-_Destroy@-$_Ref_count_obj@VCustomCursorApplication@@@std@@EEAAXXZ.c)
 * Callees:
