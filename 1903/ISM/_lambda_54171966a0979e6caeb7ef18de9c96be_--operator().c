/*
 * XREFs of _lambda_54171966a0979e6caeb7ef18de9c96be_::operator() @ 0x180034C50
 * Callers:
...
__int64 __fastcall lambda_54171966a0979e6caeb7ef18de9c96be_::operator()(
        __int64 a1,
        __int64 a2,
        unsigned int a3,
        int a4,
