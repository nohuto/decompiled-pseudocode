/*
 * XREFs of ?StringToHstringVectorParser@@YA?AV?$com_ptr_t@U?$IVector@PEAUHSTRING__@@@Collections@Foundation@Windows@@Uerr_exception_policy@wil@@@wil@@PEBG@Z @ 0x180120B50
 * Callers:
 *     <none>
 * Callees:
 ...
 *     ?find@?$_WChar_traits@G@std@@SAPEBGPEBG_KAEBG@Z @ 0x1800A04A0 (-find@-$_WChar_traits@G@std@@SAPEBGPEBG_KAEBG@Z.c)
 *     ??0?$Vector@PEAUHSTRING__@@U?$DefaultEqualityPredicate@PEAUHSTRING__@@@Internal@Collections@Foundation@Windows@@U?$DefaultLifetimeTraits@PEAUHSTRING__@@@3456@U?$DefaultVectorOptions@PEAUHSTRING__@@@3456@@Internal@Collections@Foundation@Windows@@QEAA@AEBU?$DefaultEqualityPredicate@PEAUHSTRING__@@@1234@Upermission@01234@@Z @ 0x1801190A4 (--0-$Vector@PEAUHSTRING__@@U-$DefaultEqualityPredicate@PEAUHSTRING__@@@Internal@Collections@Foun.c)
 *     ?substr@?$basic_string_view@GU?$char_traits@G@std@@@std@@QEBA?AV12@_K_K@Z @ 0x180122690 (-substr@-$basic_string_view@GU-$char_traits@G@std@@@std@@QEBA-AV12@_K_K@Z.c)
 */
...
__int64 *__fastcall StringToHstringVectorParser(__int64 *a1, _WORD *a2)
{
  ...
  _WORD *v20; // [rsp+28h] [rbp-30h] BYREF
  ...
  HSTRING v25; // [rsp+B0h] [rbp+58h] BYREF
  ...
  v12 = 44;
  LOWORD(v23) = 44;
  if ( v10 && (v13 = std::_WChar_traits<unsigned short>::find(a2, v10, (__int16 *)&v23)) != 0LL )
    v14 = v13 - a2;
  else
    v14 = v9;
  if ( v14 != v9 )
  {
    ...
    do
    {
      v15 = *(__m128i *)std::basic_string_view<unsigned short>::substr(&v20, v22, v11, v14 - v11, v19, v20, v21);
      string = 0LL;
      ...
      v11 = v14 + 1;
      if ( v14 + 1 < v10
        && (v16 = std::_WChar_traits<unsigned short>::find(&a2[v11], v10 - v11, (__int16 *)&v23)) != 0LL )
      {
        v14 = v16 - a2;
      }
      else
  ...
  v17 = *(__m128i *)std::basic_string_view<unsigned short>::substr(&v20, v22, v11, v9, v19, v20, v21);
  v25 = 0LL;
  Microsoft::WRL::Wrappers::HString::Set(&v25, (const wchar_t *)v17.m128i_i64[0], _mm_srli_si128(v17, 8).m128i_u32[0]);
  (*(void (__fastcall **)(__int64, HSTRING))(*(_QWORD *)v4 + 104LL))(v4, v25);
  *a1 = v4;
