/*
 * XREFs of ?QueryInterface@BamoDataProviderRegistrarProxy@@UEAAJAEBU_GUID@@PEAPEAX@Z @ 0x180017D00
 * Callers:
 *     ?QueryInterface@BamoDataProviderRegistrarProxy@@W7EAAJAEBU_GUID@@PEAPEAX@Z @ 0x1800391B0 (-QueryInterface@BamoDataProviderRegistrarProxy@@W7EAAJAEBU_GUID@@PEAPEAX@Z.c)
 * Callees:
