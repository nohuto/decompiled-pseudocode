/*
 * XREFs of ??1?$ComPtr@VInputSystemServerConnection@@@WRL@Microsoft@@QEAA@XZ @ 0x180057E64
 * Callers:
 *     _InputSystemServerConnection::Create_::_1_::dtor$2 @ 0x18003D348 (_InputSystemServerConnection--Create_--_1_--dtor$2.c)
 * Callees:
