/*
 * XREFs of ?StartActivity@DdiSource_BackgroundInit@SpatialInteractionTrace@SpatialInteractionDevices@@QEAAXPEB_WAEBU_GUID@@@Z @ 0x1800EDFB4
 * Callers:
        ...
        const struct _GUID *a3)
{
  ...
  if ( *(_DWORD *)v7 > 4u )
  {
    ...
    TlgWrite(v7, &unk_18019ED7B, (LPCGUID)(*((_QWORD *)this + 6) + 8LL), v8, 6u, &pData);
  }
  if ( !*((_DWORD *)this + 8) )
