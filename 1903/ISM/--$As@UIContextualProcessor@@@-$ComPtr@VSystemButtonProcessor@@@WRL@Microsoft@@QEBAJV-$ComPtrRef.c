/*
 * XREFs of ??$As@UIContextualProcessor@@@?$ComPtr@VSystemButtonProcessor@@@WRL@Microsoft@@QEBAJV?$ComPtrRef@V?$ComPtr@UIContextualProcessor@@@WRL@Microsoft@@@Details@12@@Z @ 0x1800357E0
 * Callers:
