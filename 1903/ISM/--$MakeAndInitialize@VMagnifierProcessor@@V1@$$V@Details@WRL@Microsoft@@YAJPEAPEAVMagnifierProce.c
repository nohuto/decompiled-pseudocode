/*
 * XREFs of ??$MakeAndInitialize@VMagnifierProcessor@@V1@$$V@Details@WRL@Microsoft@@YAJPEAPEAVMagnifierProcessor@@@Z @ 0x1800C1C68
 * Callers:
 ...
 *     ??0MagnifierProcessor@@QEAA@XZ @ 0x1800C2234 (--0MagnifierProcessor@@QEAA@XZ.c)
