/*
 * XREFs of ?SetHapticsFeedback_@SpatialInteractionTraceContinuous@SpatialInteractionDevices@@QEAAXJKKGEG@Z @ 0x1801683A8
 * Callers:
        ...
        char a7)
{
  ...
  if ( *(_DWORD *)v7 > 5u )
  {
    if ( TlgKeywordOn(v7, 2uLL) )
    {
      ...
      v20 = 1LL;
      v22 = v8;
      TlgWrite(v9, &unk_1801A4762, 0LL, 0LL, 8u, &pData);
    }
  }
}
