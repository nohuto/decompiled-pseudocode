/*
 * XREFs of ?SetResult@BamoAsyncResult_string_PrincipalImpl@BamoImpl@@QEAAJPEBG@Z @ 0x180123790
 * Callers:
 *     ?Thunk_SetResult_0@?$IAsyncResult_string_Principal_Receive@VBamoAsyncResult_string_PrincipalImpl@BamoImpl@@@@SAJPEAXPEAPEAX@Z @ 0x180123880 (-Thunk_SetResult_0@-$IAsyncResult_string_Principal_Receive@VBamoAsyncResult_string_PrincipalImpl.c)
 * Callees:
        ...
        const unsigned __int16 *a2)
{
  ...
  v6 = (*(__int64 (__fastcall **)(char *, __int64, const unsigned __int16 *))(*((_QWORD *)this - 2) + 72LL))(
         (char *)this - 16,
         v5,
         a2);
  if ( v6 < 0 )
