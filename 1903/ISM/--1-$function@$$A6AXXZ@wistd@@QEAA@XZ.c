/*
 * XREFs of ??1?$function@$$A6AXXZ@wistd@@QEAA@XZ @ 0x18001F9B0
 * Callers:
 ...
 *     _MPCHeadUpdateListener::Initialize_::_1_::dtor$0 @ 0x180097B08 (_MPCHeadUpdateListener--Initialize_--_1_--dtor$0.c)
 * Callees:
