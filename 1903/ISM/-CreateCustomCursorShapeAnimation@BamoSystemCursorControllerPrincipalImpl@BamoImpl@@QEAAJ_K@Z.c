/*
 * XREFs of ?CreateCustomCursorShapeAnimation@BamoSystemCursorControllerPrincipalImpl@BamoImpl@@QEAAJ_K@Z @ 0x1800C9A2C
 * Callers:
 *     ?Thunk_CreateCustomCursorShapeAnimation_6@?$ISystemCursorControllerPrincipal_Receive@VBamoSystemCursorControllerPrincipalImpl@BamoImpl@@@@SAJPEAXPEAPEAX@Z @ 0x1800CABD0 (-Thunk_CreateCustomCursorShapeAnimation_6@-$ISystemCursorControllerPrincipal_Receive@VBamoSystem.c)
 * Callees:
