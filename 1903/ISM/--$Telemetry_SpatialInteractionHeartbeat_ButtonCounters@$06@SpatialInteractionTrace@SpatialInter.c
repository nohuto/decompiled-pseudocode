/*
 * XREFs of ??$Telemetry_SpatialInteractionHeartbeat_ButtonCounters@$06@SpatialInteractionTrace@SpatialInteractionDevices@@SAXAEBU_GUID@@GGGIAEAY06$$CBW4ButtonFlags@1@AEAY06$$CBI@Z @ 0x18016235C
 * Callers:
  ...
  if ( (_BYTE)v8 )
  {
    ...
    if ( *(_DWORD *)v10 > 5u )
    {
      ...
      if ( (_BYTE)v8 )
      {
        ...
        v30 = 28;
        v33 = 28;
        LOBYTE(v8) = TlgWrite(v11, &unk_1801A4A33, 0LL, 0LL, 9u, &pData);
      }
    }
  }
  return (char)v8;
