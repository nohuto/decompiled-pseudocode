/*
 * XREFs of ??1?$list@U?$pair@$$CB_KV?$shared_ptr@VSystemCursor@@@std@@@std@@V?$allocator@U?$pair@$$CB_KV?$shared_ptr@VSystemCursor@@@std@@@std@@@2@@std@@QEAA@XZ @ 0x1800C8F68
 * Callers:
 *     _SystemCursorService::SystemCursorService_::_1_::dtor$17 @ 0x1800CBD2D (_SystemCursorService--SystemCursorService_--_1_--dtor$17.c)
 * Callees:
