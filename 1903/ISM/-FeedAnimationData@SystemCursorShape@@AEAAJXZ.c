/*
 * XREFs of ?FeedAnimationData@SystemCursorShape@@AEAAJXZ @ 0x1800CD2B8
 * Callers:
 ...
 *     ?lock@?$weak_ptr@VSystemCursorService@@@std@@QEBA?AV?$shared_ptr@VSystemCursorService@@@2@XZ @ 0x1800CE324 (-lock@-$weak_ptr@VSystemCursorService@@@std@@QEBA-AV-$shared_ptr@VSystemCursorService@@@2@XZ.c)
 */
...
__int64 __fastcall SystemCursorShape::FeedAnimationData(SystemCursorShape *this)
{
  ...
  std::_Ref_count_base *v11; // [rsp+30h] [rbp-10h]
  wil::details::in1diag3 *retaddr; // [rsp+58h] [rbp+18h]
  __int64 v13; // [rsp+60h] [rbp+20h] BYREF
  void (__fastcall ***v14)(_QWORD); // [rsp+68h] [rbp+28h] BYREF
