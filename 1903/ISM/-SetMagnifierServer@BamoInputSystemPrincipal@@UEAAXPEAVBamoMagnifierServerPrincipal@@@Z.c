/*
 * XREFs of ?SetMagnifierServer@BamoInputSystemPrincipal@@UEAAXPEAVBamoMagnifierServerPrincipal@@@Z @ 0x1800233E0
 * Callers:
 ...
 *     ?UpdateMagnifierServerRemoteCacheStatic@BamoInputSystemPrincipalImpl@BamoImpl@@CAJPEAVBamoStubImpl@2Microsoft@@PEAV12@@Z @ 0x180065DF0 (-UpdateMagnifierServerRemoteCacheStatic@BamoInputSystemPrincipalImpl@BamoImpl@@CAJPEAVBamoStubIm.c)
 */

// Hidden C++ exception states: #wind=1
void __fastcall BamoInputSystemPrincipal::SetMagnifierServer(
        struct Microsoft::BamoImpl::ConnectionIndirector **this,
        struct BamoMagnifierServerPrincipal *a2)
{
  ...
  *((_QWORD *)v3 + 7) = a2;
  if ( a2 )
    (**(void (__fastcall ***)(struct BamoMagnifierServerPrincipal *))a2)(a2);
  if ( v4 )
  ...
  for ( i = *((_QWORD *)v3 + 4); ; i = *(_QWORD *)(i + 48) )
  {
    ...
    if ( *(_BYTE *)(i + 32) )
    {
      updated = BamoImpl::BamoInputSystemPrincipalImpl::UpdateMagnifierServerRemoteCacheStatic(
