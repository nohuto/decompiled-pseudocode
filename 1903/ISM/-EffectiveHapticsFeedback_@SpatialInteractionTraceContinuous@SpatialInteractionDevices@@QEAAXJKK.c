/*
 * XREFs of ?EffectiveHapticsFeedback_@SpatialInteractionTraceContinuous@SpatialInteractionDevices@@QEAAXJKKE@Z @ 0x18016503C
 * Callers:
        ...
        char a5)
{
  ...
  if ( *(_DWORD *)v5 > 5u )
  {
    if ( TlgKeywordOn(v5, 2uLL) )
    {
      ...
      v13 = 4LL;
      v15 = 1LL;
      TlgWrite(v6, &unk_1801A4446, 0LL, 0LL, 6u, &pData);
    }
  }
}
