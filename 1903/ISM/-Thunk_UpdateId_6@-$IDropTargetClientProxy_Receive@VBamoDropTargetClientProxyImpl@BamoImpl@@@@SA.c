/*
 * XREFs of ?Thunk_UpdateId_6@?$IDropTargetClientProxy_Receive@VBamoDropTargetClientProxyImpl@BamoImpl@@@@SAJPEAXPEAPEAX@Z @ 0x180063670
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall IDropTargetClientProxy_Receive<BamoImpl::BamoDropTargetClientProxyImpl>::Thunk_UpdateId_6(
        __int64 a1,
        _QWORD **a2)
{
  int v3; // eax
