/*
 * XREFs of SpatialInteractionDevices::GetReportCaps @ 0x1800DC7B4
 * Callers:
 ...
 *     ??$?0$$V@?$_Ref_count_obj@USpatialInputReportCaps@SpatialInteractionDevices@@@std@@QEAA@XZ @ 0x1800DA2C4 (--$-0$$V@-$_Ref_count_obj@USpatialInputReportCaps@SpatialInteractionDevices@@@std@@QEAA@XZ.c)
 ...
 *     ?find@?$_Tree@V?$_Tmap_traits@EV?$shared_ptr@USpatialInputReportCaps@SpatialInteractionDevices@@@std@@U?$less@E@2@V?$allocator@U?$pair@$$CBEV?$shared_ptr@USpatialInputReportCaps@SpatialInteractionDevices@@@std@@@std@@@2@$0A@@std@@@std@@QEAA?AV?$_Tree_iterator@V?$_Tree_val@U?$_Tree_simple_types@U?$pair@$$CBEV?$shared_ptr@USpatialInputReportCaps@SpatialInteractionDevices@@@std@@@std@@@std@@@std@@@2@AEBE@Z @ 0x1800DDAD0 (-find@-$_Tree@V-$_Tmap_traits@EV-$shared_ptr@USpatialInputReportCaps@SpatialInteractionDevices@@.c)
 */
