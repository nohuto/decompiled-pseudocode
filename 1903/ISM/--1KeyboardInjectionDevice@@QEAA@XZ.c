/*
 * XREFs of ??1KeyboardInjectionDevice@@QEAA@XZ @ 0x180074E3C
 * Callers:
 *     _ControllerProcessor::ControllerProcessor_::_1_::dtor$10 @ 0x180074B04 (_ControllerProcessor--ControllerProcessor_--_1_--dtor$10.c)
 * Callees:
