/*
 * XREFs of ??1?$unordered_map@IUViewHierarchyEntry@ViewHierarchy@@U?$hash@I@std@@U?$equal_to@I@4@V?$allocator@U?$pair@$$CBIUViewHierarchyEntry@ViewHierarchy@@@std@@@4@@std@@QEAA@XZ @ 0x180058F54
 * Callers:
 *     _ViewHierarchy::ViewHierarchy_::_1_::dtor$7 @ 0x18003DBE9 (_ViewHierarchy--ViewHierarchy_--_1_--dtor$7.c)
 * Callees:
