/*
 * XREFs of ?GetContainerIdFromInputSitesList@@YA_NAEBV?$vector@V?$ComPtr@VInputSite@@@WRL@Microsoft@@V?$allocator@V?$ComPtr@VInputSite@@@WRL@Microsoft@@@std@@@std@@PEAUCONTAINER_ID@@@Z @ 0x1800C345C
 * Callers:
