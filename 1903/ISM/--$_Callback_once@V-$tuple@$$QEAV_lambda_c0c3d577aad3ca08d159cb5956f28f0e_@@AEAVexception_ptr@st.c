/*
 * XREFs of ??$_Callback_once@V?$tuple@$$QEAV_lambda_c0c3d577aad3ca08d159cb5956f28f0e_@@AEAVexception_ptr@std@@@std@@U?$integer_sequence@_K$0A@@2@$00@std@@YAHPEAX0PEAPEAX@Z @ 0x180025420
 * Callers:
 *     <none>
 * Callees:
