/*
 * XREFs of ?InitializeWaitHandles@EndpointListEntry@SipcServer@@QEAAJXZ @ 0x1800D62D4
 * Callers:
 ...
 *     ?GetWaitHandles@SipcEndpoint@@QEBAXAEAPEAX00@Z @ 0x1800D61D8 (-GetWaitHandles@SipcEndpoint@@QEBAXAEAPEAX00@Z.c)
 */
