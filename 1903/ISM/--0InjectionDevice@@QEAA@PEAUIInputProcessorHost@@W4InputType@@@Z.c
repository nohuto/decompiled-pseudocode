/*
 * XREFs of ??0InjectionDevice@@QEAA@PEAUIInputProcessorHost@@W4InputType@@@Z @ 0x180018D4C
 * Callers:
 *     ??0MouseProcessor@@IEAA@PEAUInputProcessorCreateParams@@@Z @ 0x180018C30 (--0MouseProcessor@@IEAA@PEAUInputProcessorCreateParams@@@Z.c)
