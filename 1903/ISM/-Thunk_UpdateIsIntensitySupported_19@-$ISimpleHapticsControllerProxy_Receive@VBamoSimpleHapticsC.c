/*
 * XREFs of ?Thunk_UpdateIsIntensitySupported_19@?$ISimpleHapticsControllerProxy_Receive@VBamoSimpleHapticsControllerProxyImpl@BamoImpl@@@@SAJPEAXPEAPEAX@Z @ 0x180063750
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall ISimpleHapticsControllerProxy_Receive<BamoImpl::BamoSimpleHapticsControllerProxyImpl>::Thunk_UpdateIsIntensitySupported_19(
        __int64 a1,
        _BYTE **a2)
{
  int v3; // eax
