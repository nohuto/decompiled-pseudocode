 ...
 * Callers:
 *     _Microsoft::BamoImpl::ConnectionIndirector::OnPeerConnected_::_1_::dtor$1 @ 0x18003AC20 (_Microsoft--BamoImpl--ConnectionIndirector--OnPeerConnected_--_1_--dtor$1.c)
 * Callees:
 *     <none>
 */
