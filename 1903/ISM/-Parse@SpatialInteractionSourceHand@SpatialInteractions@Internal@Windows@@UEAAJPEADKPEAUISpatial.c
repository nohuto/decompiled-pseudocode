/*
 * XREFs of ?Parse@SpatialInteractionSourceHand@SpatialInteractions@Internal@Windows@@UEAAJPEADKPEAUISpatialGraphNodeReference@Holographic@34@_JAEBUMatrix4x4@Numerics@Foundation@4@3PEA_NPEAW4MPCAugmentedInputGestureType@@44@Z @ 0x1800F5E90
 * Callers:
 *     <none>
 * Callees:
 ...
 *     ??$HandStateIgnored@U_GUID@@AEA_JII@SpatialInteractionTraceContinuous@SpatialInteractionDevices@@SAX$$QEAU_GUID@@AEA_J$$QEAI2@Z @ 0x1800F2988 (--$HandStateIgnored@U_GUID@@AEA_JII@SpatialInteractionTraceContinuous@SpatialInteractionDevices@.c)
