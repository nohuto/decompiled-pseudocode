/*
 * XREFs of ?QueryInterface@ComboButtonProcessor@@UEAAJAEBU_GUID@@PEAPEAX@Z @ 0x1800FBEE0
 * Callers:
 *     ?QueryInterface@ComboButtonProcessor@@W7EAAJAEBU_GUID@@PEAPEAX@Z @ 0x1800394A0 (-QueryInterface@ComboButtonProcessor@@W7EAAJAEBU_GUID@@PEAPEAX@Z.c)
 * Callees:
