/*
 * XREFs of ?Thunk_UpdateGesturesEnabled_19@?$IMagnifierClientProxy_Receive@VBamoMagnifierClientProxyImpl@BamoImpl@@@@SAJPEAXPEAPEAX@Z @ 0x18006FDA0
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall IMagnifierClientProxy_Receive<BamoImpl::BamoMagnifierClientProxyImpl>::Thunk_UpdateGesturesEnabled_19(
        __int64 a1,
        _BYTE **a2)
{
  int v3; // eax
