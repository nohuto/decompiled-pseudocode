/*
 * XREFs of ?OnCursorVisibilityChanged@SystemCursorService@@UEAAJUCursorId@@UCursorVisibilityData@@@Z @ 0x1800CDA70
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall SystemCursorService::OnCursorVisibilityChanged(SystemCursorService *a1, unsigned int *a2, bool a3)
{
  ...
  v13 = SystemCursor::SetVisible((SystemCursor *)v8[3], a3);
  v14 = v13;
  if ( v13 >= 0 )
    return 0LL;
