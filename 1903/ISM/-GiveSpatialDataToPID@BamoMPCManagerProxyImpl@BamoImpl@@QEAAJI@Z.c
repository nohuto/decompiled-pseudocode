/*
 * XREFs of ?GiveSpatialDataToPID@BamoMPCManagerProxyImpl@BamoImpl@@QEAAJI@Z @ 0x180111A0C
 * Callers:
...
__int64 __fastcall BamoImpl::BamoMPCManagerProxyImpl::GiveSpatialDataToPID(BamoImpl::BamoMPCManagerProxyImpl *this)
{
  int v1; // ebx
  __int64 v2; // rdx
