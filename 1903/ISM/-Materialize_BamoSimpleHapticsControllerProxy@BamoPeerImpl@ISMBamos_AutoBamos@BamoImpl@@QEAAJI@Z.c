/*
 * XREFs of ?Materialize_BamoSimpleHapticsControllerProxy@BamoPeerImpl@ISMBamos_AutoBamos@BamoImpl@@QEAAJI@Z @ 0x18005EFD0
 * Callers:
 *     ?Thunk_Materialize_BamoSimpleHapticsControllerProxy_0@?$IBamoPeer_ISMBamos_AutoBamos_Receive@VBamoPeerImpl@ISMBamos_AutoBamos@BamoImpl@@@@SAJPEAXPEAPEAX@Z @ 0x180062E70 (-Thunk_Materialize_BamoSimpleHapticsControllerProxy_0@-$IBamoPeer_ISMBamos_AutoBamos_Receive@VBa.c)
 * Callees:
        ...
        unsigned int a2)
{
  ...
  *(_QWORD *)v4 = &BamoSimpleHapticsControllerProxy::`vftable'{for `Microsoft::Bamo::BamoProxy'};
  *((_QWORD *)v4 + 1) = &BamoSimpleHapticsControllerProxy::`vftable'{for `ISimpleHapticsControllerProxy'};
  *((_DWORD *)v4 + 6) = 0;
  *((_QWORD *)v4 + 4) = 0LL;
  *((_QWORD *)v4 + 2) = &BamoImpl::BamoSimpleHapticsControllerProxyImpl::`vftable';
  *((_DWORD *)v4 + 10) = 0;
  *((_WORD *)v4 + 22) = 0;
  *((_QWORD *)v4 + 6) = 0LL;
  *((_DWORD *)v4 + 14) = 0;
