/*
 * XREFs of ?AllocateStub@BamoDragNDropContextualProcessorPrincipal@@MEAAJPEAVBamoPeer@ISMBamos_AutoBamos@@PEAPEAVBamoDragNDropContextualProcessorStub@@@Z @ 0x180009290
 * Callers:
 *     <none>
 * Callees:
