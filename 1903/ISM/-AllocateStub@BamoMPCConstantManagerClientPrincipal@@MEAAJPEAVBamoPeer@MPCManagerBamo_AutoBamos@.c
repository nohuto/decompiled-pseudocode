/*
 * XREFs of ?AllocateStub@BamoMPCConstantManagerClientPrincipal@@MEAAJPEAVBamoPeer@MPCManagerBamo_AutoBamos@@PEAPEAVBamoMPCConstantManagerClientStub@@@Z @ 0x180088F50
 * Callers:
 *     <none>
 * Callees:
