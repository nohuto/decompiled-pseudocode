/*
 * XREFs of ??1?$ComPtr@VWGIRawInputProvider@@@WRL@Microsoft@@QEAA@XZ @ 0x1800A7328
 * Callers:
 *     _WGIRawInputProvider::Create_::_1_::dtor$0 @ 0x18003DA3C (_WGIRawInputProvider--Create_--_1_--dtor$0.c)
 * Callees:
