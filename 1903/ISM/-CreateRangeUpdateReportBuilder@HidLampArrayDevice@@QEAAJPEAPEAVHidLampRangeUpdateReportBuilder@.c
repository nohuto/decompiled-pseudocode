/*
 * XREFs of ?CreateRangeUpdateReportBuilder@HidLampArrayDevice@@QEAAJPEAPEAVHidLampRangeUpdateReportBuilder@@@Z @ 0x1800B363C
 * Callers:
        ...
        struct HidLampRangeUpdateReportBuilder **a2)
{
  ...
  RefCountedObject *v7; // [rsp+50h] [rbp+18h] BYREF
