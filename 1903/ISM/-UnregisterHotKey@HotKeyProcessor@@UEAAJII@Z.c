/*
 * XREFs of ?UnregisterHotKey@HotKeyProcessor@@UEAAJII@Z @ 0x1801470D0
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall HotKeyProcessor::UnregisterHotKey(HotKeyProcessor *this, int a2, int a3)
{
         ...
         v5) )
  {
    if ( (unsigned int)dword_1801DE450 > 5 && TlgKeywordOn((TraceLoggingHProvider)&dword_1801DE450, 0x20000uLL) )
    {
      ...
      v11 = 4;
      v10 = &v17;
      TlgWrite((TraceLoggingHProvider)&dword_1801DE450, &unk_1801A1D65, 0LL, 0LL, 4u, &pData);
    }
  }
  else
  {
    ...
    if ( (unsigned int)dword_1801DE450 > 5 && TlgKeywordOn((TraceLoggingHProvider)&dword_1801DE450, 0x20000uLL) )
    {
      ...
      v8 = 63;
      v13 = &v17;
      TlgWrite((TraceLoggingHProvider)&dword_1801DE450, &unk_1801A1CD4, 0LL, 0LL, 5u, &pData);
    }
  }
  return v3;
}
