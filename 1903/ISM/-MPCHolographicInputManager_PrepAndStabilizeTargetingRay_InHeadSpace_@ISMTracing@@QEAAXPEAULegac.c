/*
 * XREFs of ?MPCHolographicInputManager_PrepAndStabilizeTargetingRay_InHeadSpace_@ISMTracing@@QEAAXPEAULegacyInputInfo@@@Z @ 0x180081EA8
 * Callers:
        ...
        struct LegacyInputInfo *a2)
{
  ...
  if ( *(_DWORD *)v3 > 5u )
  {
    if ( TlgKeywordOn(v3, 1uLL) )
    {
      ...
      v17 = 4LL;
      v19 = 4LL;
      TlgWrite(v4, &unk_18019BA0C, 0LL, 0LL, 9u, &pData);
    }
  }
}
