/*
 * XREFs of ?AcceptClientConnection@SipcServer@@UEAAJIP6AXPEAXPEAUISIPCEndpoint@@W4SIPC_ENDPOINT_STATUS@@@Z0PEAPEAU2@@Z @ 0x1800D4A80
 * Callers:
 *     <none>
 * Callees:
...
LABEL_3:
  ...
  ServerEndpoint = (*(__int64 (__fastcall **)(_QWORD, __int64, __int64, HANDLE *, HANDLE *, struct ISIPCEndpoint ***))(**((_QWORD **)this + 15) + 8LL))(
                     *((_QWORD *)this + 15),
                     a2,
                     v11,
                     &hObject,
  ...
  else
  {
    ServerEndpoint = SipcEndpoint::CreateServerEndpoint(
                       ...
                       hObject,
                       v17[0],
                       *(_DWORD *)(*((_QWORD *)this + 25) + 48LL),
                       *(_DWORD *)(*((_QWORD *)this + 25) + 52LL),
                       a3,
                       a4,
                       (struct SipcEndpoint **)(*((_QWORD *)this + 25) + 16LL));
    if ( ServerEndpoint < 0 )
    {
      if ( a5 )
    ...
    {
      ServerEndpoint = SipcServer::EndpointListEntry::InitializeWaitHandles(*((SipcServer::EndpointListEntry **)this + 25));
      if ( ServerEndpoint >= 0 )
      {
        v13 = (_QWORD *)*((_QWORD *)this + 25);
        v14 = (_QWORD *)((char *)this + 176);
        v15 = *((_QWORD *)this + 22);
        if ( *(SipcServer **)(v15 + 8) != (SipcServer *)((char *)this + 176) )
          __fastfail(3u);
        v13[1] = v14;
        *v13 = v15;
        *(_QWORD *)(v15 + 8) = v13;
        ++*((_QWORD *)this + 24);
        *v14 = v13;
        *v5 = (struct ISIPCEndpoint *)((*(_QWORD *)(*((_QWORD *)this + 25) + 16LL) + 16LL) & -(__int64)(*(_QWORD *)(*((_QWORD *)this + 25) + 16LL) != 0LL));
        *((_QWORD *)this + 25) = 0LL;
        return 0LL;
      }
    }
  }
  v16 = (SipcServer::EndpointListEntry *)*((_QWORD *)this + 25);
  if ( v16 )
