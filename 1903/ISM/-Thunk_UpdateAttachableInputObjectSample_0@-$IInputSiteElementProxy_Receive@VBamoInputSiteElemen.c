/*
 * XREFs of ?Thunk_UpdateAttachableInputObjectSample_0@?$IInputSiteElementProxy_Receive@VBamoInputSiteElementProxyImpl@BamoImpl@@@@SAJPEAXPEAPEAX@Z @ 0x180008BC0
 * Callers:
 *     <none>
 * Callees:
