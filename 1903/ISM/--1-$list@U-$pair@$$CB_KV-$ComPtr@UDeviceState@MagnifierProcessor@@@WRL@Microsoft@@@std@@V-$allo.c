/*
 * XREFs of ??1?$list@U?$pair@$$CB_KV?$ComPtr@UDeviceState@MagnifierProcessor@@@WRL@Microsoft@@@std@@V?$allocator@U?$pair@$$CB_KV?$ComPtr@UDeviceState@MagnifierProcessor@@@WRL@Microsoft@@@std@@@2@@std@@QEAA@XZ @ 0x1800C23E4
 * Callers:
 *     _MagnifierProcessor::MagnifierProcessor_::_1_::dtor$12 @ 0x1800C2349 (_MagnifierProcessor--MagnifierProcessor_--_1_--dtor$12.c)
 * Callees:
