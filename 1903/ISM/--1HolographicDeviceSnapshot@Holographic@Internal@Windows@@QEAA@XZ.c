/*
 * XREFs of ??1HolographicDeviceSnapshot@Holographic@Internal@Windows@@QEAA@XZ @ 0x1800D7DE4
 * Callers:
        ...
        Windows::Internal::Holographic::HolographicDeviceSnapshot *this)
{
  ...
  std::_Tree<std::_Tmap_traits<std::wstring,Windows::Internal::Holographic::SpatialGraphSnapshot,Windows::Internal::Holographic::CaseInsensitiveStringLess,std::allocator<std::pair<std::wstring const,Windows::Internal::Holographic::SpatialGraphSnapshot>>,0>>::erase(
    (char *)this + 56,
    &v3,
    **((_QWORD **)this + 7));
  std::_Deallocate<16,0>(*((void **)this + 7), (const struct std::nothrow_t *)0x88);
  std::_Tree<std::_Tmap_traits<std::wstring,Windows::Internal::Holographic::HolographicDisplaySnapshot,Windows::Internal::Holographic::CaseInsensitiveStringLess,std::allocator<std::pair<std::wstring const,Windows::Internal::Holographic::HolographicDisplaySnapshot>>,0>>::erase(
    (char *)this + 40,
    &v3,
    **((_QWORD **)this + 5));
  std::_Deallocate<16,0>(*((void **)this + 5), (const struct std::nothrow_t *)0x488);
