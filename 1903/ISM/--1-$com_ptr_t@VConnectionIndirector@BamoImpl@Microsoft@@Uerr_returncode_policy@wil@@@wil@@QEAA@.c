/*
 * XREFs of ??1?$com_ptr_t@VConnectionIndirector@BamoImpl@Microsoft@@Uerr_returncode_policy@wil@@@wil@@QEAA@XZ @ 0x18005A7B8
 * Callers:
 *     _Microsoft::BamoImpl::BamoPrincipalImpl::BamoPrincipalImpl_::_1_::dtor$1 @ 0x18003D6A4 (_Microsoft--BamoImpl--BamoPrincipalImpl--BamoPrincipalImpl_--_1_--dtor$1.c)
 *     _Microsoft::BamoImpl::BaseBamoConnectionImpl::Join_::_1_::dtor$0 @ 0x18003D6DE (_Microsoft--BamoImpl--BaseBamoConnectionImpl--Join_--_1_--dtor$0.c)
