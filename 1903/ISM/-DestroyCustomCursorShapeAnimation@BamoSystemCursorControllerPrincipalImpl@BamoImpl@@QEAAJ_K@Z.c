/*
 * XREFs of ?DestroyCustomCursorShapeAnimation@BamoSystemCursorControllerPrincipalImpl@BamoImpl@@QEAAJ_K@Z @ 0x1800CA0D0
 * Callers:
 *     ?Thunk_DestroyCustomCursorShapeAnimation_6@?$ISystemCursorControllerPrincipal_Receive@VBamoSystemCursorControllerPrincipalImpl@BamoImpl@@@@SAJPEAXPEAPEAX@Z @ 0x1800CABF0 (-Thunk_DestroyCustomCursorShapeAnimation_6@-$ISystemCursorControllerPrincipal_Receive@VBamoSyste.c)
 * Callees:
