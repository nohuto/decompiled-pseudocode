/*
 * XREFs of ??$MakeAndInitialize@VKeyboardOverriderDispatcher@@V1@AEAV?$ComPtr@UIMessageSession@@@WRL@Microsoft@@@Details@WRL@Microsoft@@YAJPEAPEAVKeyboardOverriderDispatcher@@AEAV?$ComPtr@UIMessageSession@@@12@@Z @ 0x18001D5F4
 * Callers:
 ...
 *     ??0KeyboardOverriderDispatcher@@QEAA@XZ @ 0x180018280 (--0KeyboardOverriderDispatcher@@QEAA@XZ.c)
