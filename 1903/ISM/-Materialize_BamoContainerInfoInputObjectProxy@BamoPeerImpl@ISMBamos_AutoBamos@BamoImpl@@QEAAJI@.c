/*
 * XREFs of ?Materialize_BamoContainerInfoInputObjectProxy@BamoPeerImpl@ISMBamos_AutoBamos@BamoImpl@@QEAAJI@Z @ 0x18005DF38
 * Callers:
 *     ?Thunk_Materialize_BamoContainerInfoInputObjectProxy_0@?$IBamoPeer_ISMBamos_AutoBamos_Receive@VBamoPeerImpl@ISMBamos_AutoBamos@BamoImpl@@@@SAJPEAXPEAPEAX@Z @ 0x180062C70 (-Thunk_Materialize_BamoContainerInfoInputObjectProxy_0@-$IBamoPeer_ISMBamos_AutoBamos_Receive@VB.c)
 * Callees:
        ...
        unsigned int a2)
{
  ...
  *(_QWORD *)v4 = &BamoContainerInfoInputObjectProxy::`vftable'{for `Microsoft::Bamo::BamoProxy'};
  *((_QWORD *)v4 + 1) = &BamoContainerInfoInputObjectProxy::`vftable'{for `IContainerInfoInputObjectProxy'};
  *((_DWORD *)v4 + 6) = 0;
  *((_QWORD *)v4 + 4) = 0LL;
  *((_DWORD *)v4 + 10) = 0;
  *((_WORD *)v4 + 22) = 0;
  *((_QWORD *)v4 + 2) = &BamoImpl::BamoContainerInfoInputObjectProxyImpl::`vftable';
  *((_DWORD *)v4 + 12) = 0;
