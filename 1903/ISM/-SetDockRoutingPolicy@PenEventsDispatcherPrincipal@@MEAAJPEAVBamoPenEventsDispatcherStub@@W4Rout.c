/*
 * XREFs of ?SetDockRoutingPolicy@PenEventsDispatcherPrincipal@@MEAAJPEAVBamoPenEventsDispatcherStub@@W4RoutingPolicy@Input@Devices@Internal@Windows@@@Z @ 0x1800330B0
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall PenEventsDispatcherPrincipal::SetDockRoutingPolicy(__int64 a1, __int64 a2, int a3)
{
  ...
  if ( *(_DWORD *)v5 > 4u && TlgKeywordOn(v5, 0x200uLL) )
  {
    ...
    TlgWrite(v8, &unk_18019B4A4, 0LL, 0LL, 3u, &pData);
  }
  v9 = *(_DWORD *)(a1 + 196);
  *(_DWORD *)(a1 + 196) = a3;
  v10 = a3 != 0;
