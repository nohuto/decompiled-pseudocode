/*
 * XREFs of ?GetCurrentInputTypesString@MPCConstantManager@@AEAA?AV?$basic_string@GU?$char_traits@G@std@@V?$allocator@G@2@@std@@XZ @ 0x180089DF8
 * Callers:
 ...
 *     ??$_UIntegral_to_buff@GI@std@@YAPEAGPEAGI@Z @ 0x1800889BC (--$_UIntegral_to_buff@GI@std@@YAPEAGPEAGI@Z.c)
...
_QWORD *__fastcall MPCConstantManager::GetCurrentInputTypesString(__int64 a1, _QWORD *a2)
{
  ...
  v12[1] = -2LL;
  v12[2] = a2;
  std::wstring::wstring(a2, (const unsigned __int16 *)((char *)&word_180182F8B + 1));
  v4 = 1;
  v5 = *(__int64 **)(a1 + 56);
  v6 = *v5;
  v12[0] = *v5;
