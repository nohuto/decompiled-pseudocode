/*
 * XREFs of ?AttachApplication@BamoSystemCursorControllerPrincipalImpl@BamoImpl@@QEAAJI@Z @ 0x1800C92DC
 * Callers:
 *     ?Thunk_AttachApplication_0@?$ISystemCursorControllerPrincipal_Receive@VBamoSystemCursorControllerPrincipalImpl@BamoImpl@@@@SAJPEAXPEAPEAX@Z @ 0x1800CABA0 (-Thunk_AttachApplication_0@-$ISystemCursorControllerPrincipal_Receive@VBamoSystemCursorControlle.c)
 * Callees:
