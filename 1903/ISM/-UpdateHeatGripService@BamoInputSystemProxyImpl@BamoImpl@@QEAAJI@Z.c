/*
 * XREFs of ?UpdateHeatGripService@BamoInputSystemProxyImpl@BamoImpl@@QEAAJI@Z @ 0x18006453C
 * Callers:
 *     ?Thunk_UpdateHeatGripService_0@?$IInputSystemProxy_Receive@VBamoInputSystemProxyImpl@BamoImpl@@@@SAJPEAXPEAPEAX@Z @ 0x180063510 (-Thunk_UpdateHeatGripService_0@-$IInputSystemProxy_Receive@VBamoInputSystemProxyImpl@BamoImpl@@@.c)
 * Callees:
