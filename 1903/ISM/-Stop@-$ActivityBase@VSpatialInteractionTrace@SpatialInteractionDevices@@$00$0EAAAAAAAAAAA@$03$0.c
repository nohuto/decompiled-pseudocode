/*
 * XREFs of ?Stop@?$ActivityBase@VSpatialInteractionTrace@SpatialInteractionDevices@@$00$0EAAAAAAAAAAA@$03$0A@U_TlgReflectorTag_Param0IsProviderType@@@wil@@QEAAXJ@Z @ 0x1800E4FB0
 * Callers:
 *     wil::details::lambda_call__lambda_43863344d09ba585e99c6477cfc470bc___::_lambda_call__lambda_43863344d09ba585e99c6477cfc470bc___ @ 0x1800E08C0 (wil--details--lambda_call__lambda_43863344d09ba585e99c6477cfc470bc___--_lambda_call__lambda_4386.c)
        ...
        int a2)
{
  ...
  else
  {
    ...
    if ( *(_DWORD *)v8 > 5u && TlgKeywordOn((TraceLoggingHProvider)v7[1], 0x400000000000uLL) )
    {
      ...
      v20 = (int *)&v10;
      v21 = 4;
      TlgWrite(v8, &unk_18019E4B6, (LPCGUID)(*(_QWORD *)(a1 + 48) + 8LL), 0LL, 5u, &pData);
    }
  }
  if ( *(_DWORD *)(a1 + 32) )
