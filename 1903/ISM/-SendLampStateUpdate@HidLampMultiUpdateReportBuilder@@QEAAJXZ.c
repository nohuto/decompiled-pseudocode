/*
 * XREFs of ?SendLampStateUpdate@HidLampMultiUpdateReportBuilder@@QEAAJXZ @ 0x1800B6A8C
 * Callers:
...
__int64 __fastcall HidLampMultiUpdateReportBuilder::SendLampStateUpdate(const WCHAR **this)
{
  int updated; // eax
  unsigned int v2; // ebx
