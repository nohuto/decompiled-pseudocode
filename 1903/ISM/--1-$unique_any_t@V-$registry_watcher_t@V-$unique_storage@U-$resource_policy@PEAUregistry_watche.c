/*
 * XREFs of ??1?$unique_any_t@V?$registry_watcher_t@V?$unique_storage@U?$resource_policy@PEAUregistry_watcher_state@details@wil@@P6AXPEAU123@@Z$1?delete_registry_watcher_state@23@YAX0@ZU?$integral_constant@_K$01@wistd@@PEAU123@PEAU123@$0A@$$T@details@wil@@@details@wil@@Uerr_returncode_policy@3@@wil@@@wil@@QEAA@XZ @ 0x18002B5D0
 * Callers:
 *     _dynamic_atexit_destructor_for__MPCSixDofProcessor::s_registryWatcher__ @ 0x18003E230 (_dynamic_atexit_destructor_for__MPCSixDofProcessor--s_registryWatcher__.c)
 * Callees:
    ...
    if ( _InterlockedExchangeAdd((volatile signed __int32 *)(v1 + 148), 0xFFFFFFFF) == 1 )
    {
      ...
      if ( v1 )
        wil::details::registry_watcher_state::`scalar deleting destructor'(
          (wil::details::registry_watcher_state *)v1,
          v2);
    }
    if ( SRWLock )
