/*
 * XREFs of ?GetMPCInputObject@BamoInputSiteElementProxy@@UEAAPEAVBamoMPCInputObjectProxy@@XZ @ 0x180009640
 * Callers:
 *     <none>
 * Callees:
        ...
        BamoInputSiteElementProxy *this)
{
  ...
  if ( *(_DWORD *)(v2 + 136) != CurrentThreadId && *(_DWORD *)(v2 + 24) != CurrentThreadId )
  {
    wil::details::in1diag3::_FailFast_Unexpected(
      ...
      v4);
    JUMPOUT(0x18004179ELL);
  }
  return (struct BamoMPCInputObjectProxy *)*((_QWORD *)this + 14);
}
