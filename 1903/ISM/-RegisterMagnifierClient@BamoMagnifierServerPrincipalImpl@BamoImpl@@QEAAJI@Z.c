/*
 * XREFs of ?RegisterMagnifierClient@BamoMagnifierServerPrincipalImpl@BamoImpl@@QEAAJI@Z @ 0x180070384
 * Callers:
 *     ?Thunk_RegisterMagnifierClient_0@?$IMagnifierServerPrincipal_Receive@VBamoMagnifierServerPrincipalImpl@BamoImpl@@@@SAJPEAXPEAPEAX@Z @ 0x1800704C0 (-Thunk_RegisterMagnifierClient_0@-$IMagnifierServerPrincipal_Receive@VBamoMagnifierServerPrincip.c)
 * Callees:
