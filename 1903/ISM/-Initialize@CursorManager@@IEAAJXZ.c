/*
 * XREFs of ?Initialize@CursorManager@@IEAAJXZ @ 0x18010E4E8
 * Callers:
 ...
 *     ?_Log_NtStatus@in1diag3@details@wil@@YAXPEAXIPEBDJ@Z @ 0x18009AF74 (-_Log_NtStatus@in1diag3@details@wil@@YAXPEAXIPEBDJ@Z.c)
...
__int64 __fastcall CursorManager::Initialize(CursorManager *this)
{
  ...
  CursorManager *v20; // [rsp+A8h] [rbp+50h] BYREF
...
LABEL_13:
  ...
  v7 = *v2;
  v8 = *(__int64 (__fastcall **)(__int64, __int64, const wchar_t *, __int64 *))(*(_QWORD *)*v2 + 48LL);
  ...
  Descriptor = (*(__int64 (__fastcall **)(_QWORD, __int64 (__fastcall *)(void *, void *, int), CursorManager *, __int64, char *))(*(_QWORD *)*v2 + 88LL))(
                 *v2,
  ...
  v11 = Microsoft::WRL::Details::MakeAndInitialize<MessageProxyReconnectAdapter,MessageProxyReconnectAdapter,_GUID const &,unsigned short const * const &,HotKeyProcessor *>(
          (MessageProxyReconnectAdapter **)this + 6,
          &GUID_5f9adcb2_65c8_40db_988f_dffbe437aa7a,
          (const unsigned __int16 **)&off_18017BE88,
          &v20);
  if ( v11 < 0 )
  {
  ...
  v17 = 1;
  v12 = RtlPublishWnfStateData(WNF_ISM_CURSOR_MANAGER_READY, 0LL, &v17, 4LL, 0LL);
  if ( v12 < 0 )
