/*
 * XREFs of ?Thunk_UpdateActivationListenerInputObject_0@?$IInputSiteElementProxy_Receive@VBamoInputSiteElementProxyImpl@BamoImpl@@@@SAJPEAXPEAPEAX@Z @ 0x1800086A0
 * Callers:
 *     <none>
 * Callees:
