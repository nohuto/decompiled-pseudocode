/*
 * XREFs of ?Stop@DeviceAttached@RawInputProvidersTracing@@QEAAXJK@Z @ 0x18009F8FC
 * Callers:
 *     wil::details::lambda_call__lambda_aa67300acd5065abc23a85a7f508fe1a___::_lambda_call__lambda_aa67300acd5065abc23a85a7f508fe1a___ @ 0x18009BE70 (wil--details--lambda_call__lambda_aa67300acd5065abc23a85a7f508fe1a___--_lambda_call__lambda_aa67.c)
        ...
        int a3)
{
  ...
  if ( v6 )
  {
    if ( *(_DWORD *)v8[1] > 4u && TlgKeywordOn((TraceLoggingHProvider)v8[1], 0x400000000000uLL) )
    {
      ...
      v61 = &v65;
      v64 = 4LL;
      TlgWrite(v15, &unk_18019CD97, (LPCGUID)(*((_QWORD *)this + 6) + 8LL), 0LL, 0x14u, &pData);
    }
  }
  else
  {
    ...
    if ( *(_DWORD *)v16 > 4u && TlgKeywordOn((TraceLoggingHProvider)v8[1], 0x400000000000uLL) )
    {
      ...
      v34 = &v66;
      v35 = 4LL;
      TlgWrite(v16, &unk_18019CCE5, (LPCGUID)(*((_QWORD *)this + 6) + 8LL), 0LL, 7u, &v25);
    }
  }
  if ( *((_DWORD *)this + 8) )
