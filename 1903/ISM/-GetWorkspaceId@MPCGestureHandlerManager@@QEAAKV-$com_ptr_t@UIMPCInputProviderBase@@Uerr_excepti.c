/*
 * XREFs of ?GetWorkspaceId@MPCGestureHandlerManager@@QEAAKV?$com_ptr_t@UIMPCInputProviderBase@@Uerr_exception_policy@wil@@@wil@@@Z @ 0x1800864EC
 * Callers:
...
__int64 __fastcall MPCGestureHandlerManager::GetWorkspaceId(__int64 a1, __int64 *a2)
{
  __int64 **v3; // rax
  __int64 **v4; // r10
  unsigned int v5; // ebx
  ...
  else
  {
    std::map<wil::com_ptr_t<IMPCInputProviderBase,wil::err_exception_policy>,wil::com_ptr_t<MPCGestureHandler,wil::err_exception_policy>>::_Try_emplace<wil::com_ptr_t<IMPCInputProviderBase,wil::err_exception_policy> const &,>(
      ...
      (unsigned __int64)v7,
      a2);
    v5 = *(_DWORD *)(*(_QWORD *)(v7[0] + 40LL) + 912LL);
  }
