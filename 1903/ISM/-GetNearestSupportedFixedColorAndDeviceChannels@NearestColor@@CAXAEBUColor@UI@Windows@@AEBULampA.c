/*
 * XREFs of ?GetNearestSupportedFixedColorAndDeviceChannels@NearestColor@@CAXAEBUColor@UI@Windows@@AEBULampAttributes@@PEAU234@PEAULampColor@@@Z @ 0x1800B5F4C
 * Callers:
 ...
 *     ?SnapChannelToNearest@NearestColor@@CANNN@Z @ 0x1800B638C (-SnapChannelToNearest@NearestColor@@CANNN@Z.c)
 */
