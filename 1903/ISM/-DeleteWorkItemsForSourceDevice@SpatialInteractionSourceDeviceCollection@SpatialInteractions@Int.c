/*
 * XREFs of ?DeleteWorkItemsForSourceDevice@SpatialInteractionSourceDeviceCollection@SpatialInteractions@Internal@Windows@@AEAAXPEBVSpatialInteractionSourceDevice@234@@Z @ 0x1800E1914
 * Callers:
 ...
 *     ??0?$_Deque_const_iterator@V?$_Deque_val@U?$_Deque_simple_types@V?$shared_ptr@VAsynchronousWorkItem@SpatialInteractionSourceDeviceCollection@SpatialInteractions@Internal@Windows@@@std@@@std@@@std@@@std@@QEAA@AEBV01@@Z @ 0x1800E061C (--0-$_Deque_const_iterator@V-$_Deque_val@U-$_Deque_simple_types@V-$shared_ptr@VAsynchronousWorkI.c)
 *     ?erase@?$deque@V?$shared_ptr@VAsynchronousWorkItem@SpatialInteractionSourceDeviceCollection@SpatialInteractions@Internal@Windows@@@std@@V?$allocator@V?$shared_ptr@VAsynchronousWorkItem@SpatialInteractionSourceDeviceCollection@SpatialInteractions@Internal@Windows@@@std@@@2@@std@@QEAA?AV?$_Deque_iterator@V?$_Deque_val@U?$_Deque_simple_types@V?$shared_ptr@VAsynchronousWorkItem@SpatialInteractionSourceDeviceCollection@SpatialInteractions@Internal@Windows@@@std@@@std@@@std@@@2@V?$_Deque_const_iterator@V?$_Deque_val@U?$_Deque_simple_types@V?$shared_ptr@VAsynchronousWorkItem@SpatialInteractionSourceDeviceCollection@SpatialInteractions@Internal@Windows@@@std@@@std@@@std@@@2@0@Z @ 0x1800E6E28 (-erase@-$deque@V-$shared_ptr@VAsynchronousWorkItem@SpatialInteractionSourceDeviceCollection@Spat.c)
 */
        ...
        const struct Windows::Internal::SpatialInteractions::SpatialInteractionSourceDevice *a2)
{
  ...
  _QWORD *v13; // rax
  _QWORD **v14; // rax
  _QWORD *v15; // [rsp+20h] [rbp-49h] BYREF
  ...
  _QWORD v21[3]; // [rsp+68h] [rbp-1h] BYREF
  _QWORD v22[3]; // [rsp+80h] [rbp+17h] BYREF
  _QWORD v23[3]; // [rsp+98h] [rbp+2Fh] BYREF
  struct _RTL_CRITICAL_SECTION *v24; // [rsp+D0h] [rbp+67h] BYREF
  ...
  while ( 1 )
  {
    v7 = *((_QWORD *)this + 72) + *((_QWORD *)this + 71);
    v17 = v5;
    if ( v5 == v7 )
      break;
    if ( v6 )
      ...
      v8 = 0LL;
    v9 = *(_QWORD *)(*(_QWORD *)(v8 + 8) + 8 * (v5 & (*(_QWORD *)(v8 + 16) - 1LL)));
