/*
 * XREFs of ?PublishRemovalIfNeeded@SpatialInteractionEyeGazeSourceObject@SpatialInteractions@Internal@Windows@@UEAAJPEAUISpatialInteractionSourceCollectionCallbacks@234@@Z @ 0x1800F16F0
 * Callers:
 *     <none>
 * Callees:
