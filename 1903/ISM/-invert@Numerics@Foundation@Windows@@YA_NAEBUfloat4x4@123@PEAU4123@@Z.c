/*
 * XREFs of ?invert@Numerics@Foundation@Windows@@YA_NAEBUfloat4x4@123@PEAU4123@@Z @ 0x1800845FC
 * Callers:
        ...
        struct Windows::Foundation::Numerics::float4x4 *a3)
{
  ...
  if ( v20 >= 0.00000011920929 )
  {
    ...
    *((float *)a2 + 5) = (float)((float)((float)(v9 * v35) - (float)(v12 * v46)) + (float)(v13 * v47))
                       * (float)(1.0 / v19);
    ...
    *((float *)a2 + 13) = (float)((float)((float)(v11 * v35) - (float)(v13 * v45)) + (float)(v14 * v46))
                        * (float)(1.0 / v19);
    ...
    *((float *)a2 + 2) = (float)((float)((float)(v23 * v45) - (float)(v24 * v46)) + (float)(v25 * v47)) * v22;
    *((_DWORD *)a2 + 6) = COERCE_UNSIGNED_INT((float)((float)((float)(v23 * v35) - (float)(v26 * v46))
                                                    + (float)(v27 * v47)) * v22) ^ _xmm;
    *((float *)a2 + 10) = (float)((float)((float)(v24 * v35) - (float)(v26 * v45)) + (float)(v28 * v47)) * v22;
    *((_DWORD *)a2 + 14) = COERCE_UNSIGNED_INT((float)((float)((float)(v25 * v35) - (float)(v27 * v45))
                                                     + (float)(v28 * v46)) * v22) ^ _xmm;
    v29 = (float)(v4 * v36) - (float)(v42 * v37);
    v30 = (float)(v4 * v39) - (float)(v43 * v37);
    v31 = (float)(v42 * v39) - (float)(v43 * v36);
    v32 = (float)(v4 * v41) - (float)(v44 * v37);
    v33 = (float)(v42 * v41) - (float)(v44 * v36);
    v34 = (float)(v43 * v41) - (float)(v44 * v39);
    result = 1;
    *((_DWORD *)a2 + 3) = COERCE_UNSIGNED_INT((float)((float)((float)(v29 * v45) - (float)(v30 * v46))
                                                    + (float)(v31 * v47)) * v22) ^ _xmm;
    *((_DWORD *)a2 + 11) = COERCE_UNSIGNED_INT((float)((float)((float)(v30 * v35) - (float)(v32 * v45))
                                                     + (float)(v34 * v47)) * v22) ^ _xmm;
    *((float *)a2 + 7) = (float)((float)((float)(v29 * v35) - (float)(v32 * v46)) + (float)(v33 * v47)) * v22;
    *((float *)a2 + 15) = (float)((float)((float)(v31 * v35) - (float)(v33 * v45)) + (float)(v34 * v46)) * v22;
  }
  else
  {
    result = 0;
