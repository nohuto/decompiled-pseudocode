/*
 * XREFs of ?GetBamoDataSourceStub@AnimationDataProvider@@UEBA?AV?$ComPtr@VBamoDataSourceStub@@@WRL@Microsoft@@V?$ComPtr@VDataSourcePrincipal@@@34@@Z @ 0x1800CFF00
 * Callers:
 *     <none>
 * Callees:
 ...
 *     ?GetStub@BamoPrincipalImpl@BamoImpl@Microsoft@@QEAAPEAVBamoStubImpl@23@PEAVBaseBamoPeer@Bamo@3@_N@Z @ 0x1800D01A4 (-GetStub@BamoPrincipalImpl@BamoImpl@Microsoft@@QEAAPEAVBamoStubImpl@23@PEAVBaseBamoPeer@Bamo@3@_.c)
 */
...
_QWORD *__fastcall AnimationDataProvider::GetBamoDataSourceStub(__int64 a1, _QWORD *a2, __int64 *a3)
{
  ...
  *a2 = 0LL;
  ...
  Microsoft::BamoImpl::BaseBamoConnectionImpl::VerifyLockHeldIfOffThread(*(Microsoft::BamoImpl::BaseBamoConnectionImpl **)(*(_QWORD *)(*a3 + 32) + 24LL));
  v7 = 0LL;
