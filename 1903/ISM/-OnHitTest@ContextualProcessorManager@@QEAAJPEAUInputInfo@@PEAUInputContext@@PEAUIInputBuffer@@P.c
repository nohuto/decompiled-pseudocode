/*
 * XREFs of ?OnHitTest@ContextualProcessorManager@@QEAAJPEAUInputInfo@@PEAUInputContext@@PEAUIInputBuffer@@PEAPEAUIInputTarget@@@Z @ 0x1800F961C
 * Callers:
...
LABEL_21:
  ...
  while ( 1 )
  {
    ...
    if ( **((_DWORD **)v15 + 1) > 4u && TlgKeywordOn(*((TraceLoggingHProvider *)v15 + 1), 1uLL) )
    {
      ...
      TlgWrite(v16, &unk_1801A0464, 0LL, 0LL, 3u, &pData);
    }
