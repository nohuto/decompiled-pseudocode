/*
 * XREFs of ??$ValidateOrthonormalRightHandedMatrix@$00@Details@DirectX@@YQ?AW4OrthonormalMatrixValidationFailures@1@UXMMATRIX@1@@Z @ 0x18014B2E4
 * Callers:
        ...
        double a4)
{
  ...
  v7 = _mm_sub_ps(
         ...
         (__m128)_xmm);
  v8 = *(__m128 *)&a2;
  v9 = _mm_movemask_ps(_mm_cmple_ps(_mm_max_ps(_mm_sub_ps((__m128)0LL, v7), v7), (__m128)_xmm)) != 15;
