/*
 * XREFs of ?QueryInterface@BamoSystemButtonEventControllerProxy@@UEAAJAEBU_GUID@@PEAPEAX@Z @ 0x1800300E0
 * Callers:
 *     ?QueryInterface@BamoSystemButtonEventControllerProxy@@W7EAAJAEBU_GUID@@PEAPEAX@Z @ 0x1800384A0 (-QueryInterface@BamoSystemButtonEventControllerProxy@@W7EAAJAEBU_GUID@@PEAPEAX@Z.c)
 * Callees:
