/*
 * XREFs of ?QueryInterface@BamoAsyncResult_PROPVARIANT_Principal@@UEAAJAEBU_GUID@@PEAPEAX@Z @ 0x180122C90
 * Callers:
 *     ?QueryInterface@BamoAsyncResult_PROPVARIANT_Principal@@W7EAAJAEBU_GUID@@PEAPEAX@Z @ 0x18003A000 (-QueryInterface@BamoAsyncResult_PROPVARIANT_Principal@@W7EAAJAEBU_GUID@@PEAPEAX@Z.c)
 * Callees:
