/*
 * XREFs of ?Initialize@ManipulationInjector@@QEAAXPEAUHMONITOR__@@PEBUtagRECT@@@Z @ 0x1800E7C10
 * Callers:
...
void __fastcall ManipulationInjector::Initialize(ManipulationInjector *this, HMONITOR a2, const struct tagRECT *a3)
{
  ...
  *((_QWORD *)this + 7) = 0LL;
  ...
  {
    v7 = 2 * *((_DWORD *)this + 4);
    if ( a3->right - a3->left < v7 || a3->bottom - a3->top < v7 )
    {
  ...
  *((_DWORD *)this + 183) = v9;
  ...
  switch ( *(_DWORD *)this )
  {
    ...
    case 2:
      ...
      dword_1801DFE4C = (int)(float)((float)((float)((float)v13 * 100.0) / (float)*((int *)this + 193)) + 0.5);
      dword_1801DFE6C = (int)v14;
      v28.x = *((_DWORD *)this + 5);
