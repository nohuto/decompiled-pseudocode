/*
 * XREFs of ?UpdateTestCommands@BamoInputSystemProxyImpl@BamoImpl@@QEAAJI@Z @ 0x180064F04
 * Callers:
 *     ?Thunk_UpdateTestCommands_0@?$IInputSystemProxy_Receive@VBamoInputSystemProxyImpl@BamoImpl@@@@SAJPEAXPEAPEAX@Z @ 0x180063B60 (-Thunk_UpdateTestCommands_0@-$IInputSystemProxy_Receive@VBamoInputSystemProxyImpl@BamoImpl@@@@SA.c)
 * Callees:
