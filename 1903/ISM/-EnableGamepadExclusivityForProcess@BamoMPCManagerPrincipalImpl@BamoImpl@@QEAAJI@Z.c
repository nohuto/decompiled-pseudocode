/*
 * XREFs of ?EnableGamepadExclusivityForProcess@BamoMPCManagerPrincipalImpl@BamoImpl@@QEAAJI@Z @ 0x18007DE7C
 * Callers:
 *     ?Thunk_EnableGamepadExclusivityForProcess_25@?$IMPCManagerPrincipal_Receive@VBamoMPCManagerPrincipalImpl@BamoImpl@@@@SAJPEAXPEAPEAX@Z @ 0x18007F8F0 (-Thunk_EnableGamepadExclusivityForProcess_25@-$IMPCManagerPrincipal_Receive@VBamoMPCManagerPrinc.c)
 * Callees:
