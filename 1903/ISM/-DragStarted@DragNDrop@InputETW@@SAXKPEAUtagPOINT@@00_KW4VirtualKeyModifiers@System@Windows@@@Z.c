/*
 * XREFs of ?DragStarted@DragNDrop@InputETW@@SAXKPEAUtagPOINT@@00_KW4VirtualKeyModifiers@System@Windows@@@Z @ 0x18006B3FC
 * Callers:
...
char __fastcall InputETW::DragNDrop::DragStarted(unsigned int a1, int *a2, int *a3, int *a4, char a5, unsigned int a6)
{
  __int64 v7; // r14
  LPVOID v10; // rax
  __int64 v11; // rcx
  ...
  if ( (_BYTE)v10 )
  {
    ...
    if ( *(_DWORD *)v12 > 5u )
    {
      ...
      if ( (_BYTE)v10 )
      {
        ...
        v46 = 8;
        v49 = 8;
        LOBYTE(v10) = TlgWrite(v13, &unk_18019AD58, 0LL, 0LL, 0xBu, &pData);
      }
    }
  }
  return (char)v10;
