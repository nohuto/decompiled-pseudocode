/*
 * XREFs of ??$make_shared@VSystemCursorService@@PEAVSystemCursorController@@AEAK@std@@YA?AV?$shared_ptr@VSystemCursorService@@@0@$$QEAPEAVSystemCursorController@@AEAK@Z @ 0x1800C8D28
 * Callers:
 ...
 *     ??0SystemCursorService@@QEAA@PEAVSystemCursorController@@K@Z @ 0x1800CBC30 (--0SystemCursorService@@QEAA@PEAVSystemCursorController@@K@Z.c)
 */
  ...
  *a1 = v6 + 16;
  ...
  if ( v6 != (char *)-16LL )
  {
    ...
    if ( !(_DWORD)v7 )
    {
      ...
      *((_QWORD *)v6 + 3) = v6 + 16;
      v10 = (std::_Ref_count_base *)*((_QWORD *)v6 + 4);
      *((_QWORD *)v6 + 4) = v9;
      if ( v10 )
