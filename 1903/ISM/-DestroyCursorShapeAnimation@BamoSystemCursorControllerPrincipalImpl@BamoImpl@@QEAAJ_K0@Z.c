/*
 * XREFs of ?DestroyCursorShapeAnimation@BamoSystemCursorControllerPrincipalImpl@BamoImpl@@QEAAJ_K0@Z @ 0x1800C9DE0
 * Callers:
 *     ?Thunk_DestroyCursorShapeAnimation_203@?$ISystemCursorControllerPrincipal_Receive@VBamoSystemCursorControllerPrincipalImpl@BamoImpl@@@@SAJPEAXPEAPEAX@Z @ 0x1800359F0 (-Thunk_DestroyCursorShapeAnimation_203@-$ISystemCursorControllerPrincipal_Receive@VBamoSystemCur.c)
 * Callees:
