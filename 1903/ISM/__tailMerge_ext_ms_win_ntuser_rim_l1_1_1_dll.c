/*
 * XREFs of __tailMerge_ext_ms_win_ntuser_rim_l1_1_1_dll @ 0x18002DD8B
 * Callers:
 *     __imp_load_InitializePointerDeviceInjectionEx @ 0x18002DD7F (__imp_load_InitializePointerDeviceInjectionEx.c)
 * Callees:
