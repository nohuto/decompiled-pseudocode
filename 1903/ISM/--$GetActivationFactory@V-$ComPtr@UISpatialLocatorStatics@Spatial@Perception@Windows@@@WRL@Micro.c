/*
 * XREFs of ??$GetActivationFactory@V?$ComPtr@UISpatialLocatorStatics@Spatial@Perception@Windows@@@WRL@Microsoft@@@Foundation@Windows@@YAJPEAUHSTRING__@@V?$ComPtrRef@V?$ComPtr@UISpatialLocatorStatics@Spatial@Perception@Windows@@@WRL@Microsoft@@@Details@WRL@Microsoft@@@Z @ 0x18008EECC
 * Callers:
