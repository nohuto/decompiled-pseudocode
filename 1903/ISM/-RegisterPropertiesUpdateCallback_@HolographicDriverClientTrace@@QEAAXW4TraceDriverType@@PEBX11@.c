/*
 * XREFs of ?RegisterPropertiesUpdateCallback_@HolographicDriverClientTrace@@QEAAXW4TraceDriverType@@PEBX11@Z @ 0x18015CA7C
 * Callers:
...
char HolographicDriverClientTrace::RegisterPropertiesUpdateCallback_(__int64 a1, unsigned int a2, ...)
{
  ...
  if ( **(_DWORD **)(v3 + 8) > 4u )
  {
    ...
    if ( (_BYTE)v3 )
    {
      ...
      v12 = 8LL;
      v14 = 8LL;
      LOBYTE(v3) = TlgWrite(v5, &unk_1801A3630, 0LL, 0LL, 6u, &pData);
    }
  }
  return v3;
}
