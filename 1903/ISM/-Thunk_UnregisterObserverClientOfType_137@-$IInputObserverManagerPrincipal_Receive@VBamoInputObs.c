/*
 * XREFs of ?Thunk_UnregisterObserverClientOfType_137@?$IInputObserverManagerPrincipal_Receive@VBamoInputObserverManagerPrincipalImpl@BamoImpl@@@@SAJPEAXPEAPEAX@Z @ 0x180067C40
 * Callers:
 *     <none>
 * Callees:
 *     <none>
