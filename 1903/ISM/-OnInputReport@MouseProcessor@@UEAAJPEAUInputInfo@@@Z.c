/*
 * XREFs of ?OnInputReport@MouseProcessor@@UEAAJPEAUInputInfo@@@Z @ 0x18012B6C0
 * Callers:
 *     <none>
 * Callees:
 *     ?Return_Hr@in1diag3@details@wil@@YAXPEAXIPEBDJ@Z @ 0x180010FD4 (-Return_Hr@in1diag3@details@wil@@YAXPEAXIPEBDJ@Z.c)
 *     _guard_dispatch_icall_nop @ 0x180037DA0 (_guard_dispatch_icall_nop.c)
 *     _lambda_cc14c4b3090cc7c63243ed8c77095553_::operator() @ 0x18012B404 (_lambda_cc14c4b3090cc7c63243ed8c77095553_--operator().c)
 */
...
LABEL_3:
  ...
  *((_BYTE *)this + 84) = v7;
  ...
  lambda_cc14c4b3090cc7c63243ed8c77095553_::operator()(v14, *(_BYTE *)(v8 + 84) != 0 ? 16 : 32, 4, 8);
