/*
 * XREFs of ?Thunk_UpdateDragSourceClient_0@?$IInputSiteElementProxy_Receive@VBamoInputSiteElementProxyImpl@BamoImpl@@@@SAJPEAXPEAPEAX@Z @ 0x180008A10
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall IInputSiteElementProxy_Receive<BamoImpl::BamoInputSiteElementProxyImpl>::Thunk_UpdateDragSourceClient_0(
        __int64 a1,
        unsigned int **a2)
{
  __int64 v3; // r8
  ...
  *(_QWORD *)(a1 + 80) = v7;
  ...
  if ( *(_BYTE *)(a1 + 28) )
  {
    ...
    v11 = (*(__int64 (__fastcall **)(__int64))(*(_QWORD *)(a1 - 16) + 104LL))(a1 - 16);
    if ( v11 < 0 )
      wil::details::in1diag3::FailFast_Hr(
        retaddr,
        (void *)0x15AF,
