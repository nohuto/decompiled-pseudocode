/*
 * XREFs of ?SetError@BamoAsyncResult_PROPVARIANT_PrincipalImpl@BamoImpl@@QEAAJH@Z @ 0x180122F14
 * Callers:
 *     ?Thunk_SetError_5@?$IAsyncResult_PROPVARIANT_Principal_Receive@VBamoAsyncResult_PROPVARIANT_PrincipalImpl@BamoImpl@@@@SAJPEAXPEAPEAX@Z @ 0x180123120 (-Thunk_SetError_5@-$IAsyncResult_PROPVARIANT_Principal_Receive@VBamoAsyncResult_PROPVARIANT_Prin.c)
 * Callees:
