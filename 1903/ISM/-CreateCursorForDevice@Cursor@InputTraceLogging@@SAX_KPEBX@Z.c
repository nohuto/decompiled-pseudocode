/*
 * XREFs of ?CreateCursorForDevice@Cursor@InputTraceLogging@@SAX_KPEBX@Z @ 0x1800CC220
 * Callers:
...
void __fastcall InputTraceLogging::Cursor::CreateCursorForDevice(__int64 a1, const void *a2)
{
  ...
  if ( *(_DWORD *)v2 > 4u )
  {
    if ( TlgKeywordOn(v2, 8uLL) )
    {
      ...
      v7 = v3;
      v10 = v3;
      TlgWrite(v4, &unk_18019DF17, 0LL, 0LL, 4u, &pData);
    }
  }
}
