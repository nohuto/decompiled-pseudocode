/*
 * XREFs of ??1InputAttemptedTargetManager@@QEAA@XZ @ 0x1800707D0
 * Callers:
 *     _InputDeliveryServer::InputDeliveryServer_::_1_::dtor$2 @ 0x18003D555 (_InputDeliveryServer--InputDeliveryServer_--_1_--dtor$2.c)
 * Callees:
