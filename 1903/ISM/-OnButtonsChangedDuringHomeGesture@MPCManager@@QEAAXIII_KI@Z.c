/*
 * XREFs of ?OnButtonsChangedDuringHomeGesture@MPCManager@@QEAAXIII_KI@Z @ 0x18007E8CC
 * Callers:
        ...
        unsigned int a6)
{
  ...
  {
    v13 = (*(__int64 (__fastcall **)(_QWORD, _QWORD, _QWORD, _QWORD, unsigned __int64, unsigned int))(**(_QWORD **)(v12 + 40) + 88LL))(
            *(_QWORD *)(v12 + 40),
            a2,
            a3,
            a4,
