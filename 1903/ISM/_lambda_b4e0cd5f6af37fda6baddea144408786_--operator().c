/*
 * XREFs of _lambda_b4e0cd5f6af37fda6baddea144408786_::operator() @ 0x18016354C
 * Callers:
 ...
 * Callees:
 *     ??4?$TimestampedProperty@W4ButtonFlags@SpatialInteractionDevices@@@Holographic@Internal@Windows@@QEAAAEAU0123@$$QEAW4ButtonFlags@SpatialInteractionDevices@@@Z @ 0x180163400 (--4-$TimestampedProperty@W4ButtonFlags@SpatialInteractionDevices@@@Holographic@Internal@Windows@.c)
 */
