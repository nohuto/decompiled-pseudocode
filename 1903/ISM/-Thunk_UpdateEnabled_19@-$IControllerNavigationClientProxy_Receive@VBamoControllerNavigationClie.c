/*
 * XREFs of ?Thunk_UpdateEnabled_19@?$IControllerNavigationClientProxy_Receive@VBamoControllerNavigationClientProxyImpl@BamoImpl@@@@SAJPEAXPEAPEAX@Z @ 0x180071690
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall IControllerNavigationClientProxy_Receive<BamoImpl::BamoControllerNavigationClientProxyImpl>::Thunk_UpdateEnabled_19(
        __int64 a1,
        _BYTE **a2)
{
  int v3; // eax
