/*
 * XREFs of ??_EInputRedirectionProcessor@@UEAAPEAXI@Z @ 0x180106CD4
 * Callers:
 *     ??_EInputRedirectionProcessor@@WBI@EAAPEAXI@Z @ 0x180039550 (--_EInputRedirectionProcessor@@WBI@EAAPEAXI@Z.c)
 * Callees:
