/*
 * XREFs of ?PropertyCache_Cleared_@HolographicDriverClientTrace@@QEAAXW4TraceDriverType@@AEBU_GUID@@@Z @ 0x18015BD94
 * Callers:
 *     ?LogCleared@PropertyCache@Holographic@Internal@Windows@@MEAAXXZ @ 0x1801598F0 (-LogCleared@PropertyCache@Holographic@Internal@Windows@@MEAAXXZ.c)
 * Callees:
...
char __fastcall HolographicDriverClientTrace::PropertyCache_Cleared_(__int64 a1, unsigned int a2, __int64 a3)
{
  ...
  if ( **(_DWORD **)(v5 + 8) > 4u )
  {
    ...
    if ( (_BYTE)v5 )
    {
      ...
      v11 = a3;
      v12 = 16;
      LOBYTE(v5) = TlgWrite(v7, &unk_1801A4364, 0LL, 0LL, 4u, &pData);
    }
  }
  return v5;
}
