/*
 * XREFs of ??$MakeAndInitialize@VHotKeyProcessor@@V1@PEAVHotkeyContextualProcessor@@@Details@WRL@Microsoft@@YAJPEAPEAVHotKeyProcessor@@$$QEAPEAVHotkeyContextualProcessor@@@Z @ 0x18010853C
 * Callers:
