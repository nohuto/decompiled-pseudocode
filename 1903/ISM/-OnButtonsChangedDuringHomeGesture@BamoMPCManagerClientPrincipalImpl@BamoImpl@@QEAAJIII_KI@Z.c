/*
 * XREFs of ?OnButtonsChangedDuringHomeGesture@BamoMPCManagerClientPrincipalImpl@BamoImpl@@QEAAJIII_KI@Z @ 0x180115424
 * Callers:
 *     ?Thunk_OnButtonsChangedDuringHomeGesture_79@?$IMPCManagerClientPrincipal_Receive@VBamoMPCManagerClientPrincipalImpl@BamoImpl@@@@SAJPEAXPEAPEAX@Z @ 0x180116320 (-Thunk_OnButtonsChangedDuringHomeGesture_79@-$IMPCManagerClientPrincipal_Receive@VBamoMPCManager.c)
 * Callees:
