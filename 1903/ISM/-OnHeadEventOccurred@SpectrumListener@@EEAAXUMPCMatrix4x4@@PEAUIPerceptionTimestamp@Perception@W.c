/*
 * XREFs of ?OnHeadEventOccurred@SpectrumListener@@EEAAXUMPCMatrix4x4@@PEAUIPerceptionTimestamp@Perception@Windows@@@Z @ 0x180095BE0
 * Callers:
 *     <none>
 * Callees:
...
void __fastcall SpectrumListener::OnHeadEventOccurred(__int64 a1, __int128 *a2)
{
  ...
  v7[6] = 2032;
  v4 = MPCInputInfoHelper::PopulateGenericMPCInputInfo(0, 8, 0x20000, *(_DWORD *)(a1 + 120), (__int64)v7);
  if ( v4 < 0 )
  {
