/*
 * XREFs of ?LogLampArrayDeviceAdded@LampArrayTelemetry@@QEAAXPEBGGGGHHHHHH@Z @ 0x1800B156C
 * Callers:
        ...
        char a11)
{
  ...
  if ( (unsigned int)hProvider > 5 )
  {
    if ( TlgKeywordOn((TraceLoggingHProvider)&hProvider, 0x400000000000uLL) )
    {
      ...
      v29 = 4LL;
      v31 = 4LL;
      TlgWrite((TraceLoggingHProvider)&hProvider, &unk_18019D49D, 0LL, 0LL, 0xCu, &pData);
    }
  }
}
