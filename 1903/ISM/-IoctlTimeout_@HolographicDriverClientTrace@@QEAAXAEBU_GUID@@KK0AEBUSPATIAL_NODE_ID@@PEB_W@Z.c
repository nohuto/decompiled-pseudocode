/*
 * XREFs of ?IoctlTimeout_@HolographicDriverClientTrace@@QEAAXAEBU_GUID@@KK0AEBUSPATIAL_NODE_ID@@PEB_W@Z @ 0x180159738
 * Callers:
        ...
        LPCWSTR pwsz)
{
  ...
  if ( **(_DWORD **)(v10 + 8) > 3u )
  {
    if ( TlgKeywordOn(*(TraceLoggingHProvider *)(v10 + 8), 0x200000000000uLL) )
    {
      ...
      v26 = &v13;
      v27 = 8LL;
      TlgWrite(v11, &unk_1801A2F59, 0LL, 0LL, 9u, &pData);
    }
  }
}
