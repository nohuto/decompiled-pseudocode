/*
 * XREFs of ?GetPositionRelativeToSite@DragNDropProcessor@@QEAA?AUtagPOINT@@PEAVInputSite@@U2@@Z @ 0x18006BB24
 * Callers:
 ...
 *     ApplyInverseTransformToPoint @ 0x18006AB0C (ApplyInverseTransformToPoint.c)
 */
