/*
 * XREFs of ?GetPoseAtTime_NotEnoughPosesToExtrapolate_@HolographicDriverClientContinuousTrace@@QEAAXXZ @ 0x180157694
 * Callers:
  ...
  if ( HolographicDriverClientContinuousTrace::IsVerboseTracingEnabled((unsigned __int64)this) )
  {
    ...
    if ( *(_DWORD *)v2 > 5u )
    {
      if ( TlgKeywordOn(v2, 0x800000uLL) )
      {
        ...
        v4 = 0x1000000LL;
        v7 = 8;
        TlgWrite(v3, &unk_1801A28DB, 0LL, 0LL, 3u, &pData);
      }
    }
  }
}
