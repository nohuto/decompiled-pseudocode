/*
 * XREFs of ?assign@shared_buffer@details@wil@@AEAAXPEAJ_K@Z @ 0x180052964
 * Callers:
 *     ??0ResultException@wil@@QEAA@AEBV01@@Z @ 0x18004E618 (--0ResultException@wil@@QEAA@AEBV01@@Z.c)
