/*
 * XREFs of ?_Delete_this@?$_Func_impl_no_alloc@V?$_Binder@U_Unforced@std@@P8SpatialGraphDriverClient@Holographic@Internal@Windows@@EAAXAEAVV2DevicePropertyRequest@456@J@ZPEAV3456@AEBU?$_Ph@$00@2@AEBU?$_Ph@$01@2@@std@@XAEAVV2DevicePropertyRequest@Holographic@Internal@Windows@@J@std@@EEAAX_N@Z @ 0x180160440
 * Callers:
 *     <none>
 * Callees:
