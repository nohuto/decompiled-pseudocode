/*
 * XREFs of ?InjectZoom@ManipulationInjector@@QEAAXMK@Z @ 0x1800E8CE4
 * Callers:
 ...
 *     ?TransitionZoomTypes@ManipulationInjector@@AEAAXXZ @ 0x1800E93E0 (-TransitionZoomTypes@ManipulationInjector@@AEAAXXZ.c)
 *     ?UpdateZoomContacts@ManipulationInjector@@AEAAXIM@Z @ 0x1800E95B4 (-UpdateZoomContacts@ManipulationInjector@@AEAAXIM@Z.c)
 *     ?UpdateZoomContactsForThreshold@ManipulationInjector@@AEAAXI@Z @ 0x1800E9640 (-UpdateZoomContactsForThreshold@ManipulationInjector@@AEAAXI@Z.c)
 */
