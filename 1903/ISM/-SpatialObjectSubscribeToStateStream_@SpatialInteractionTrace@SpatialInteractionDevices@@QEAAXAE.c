/*
 * XREFs of ?SpatialObjectSubscribeToStateStream_@SpatialInteractionTrace@SpatialInteractionDevices@@QEAAXAEBU_GUID@@J@Z @ 0x1800EDF04
 * Callers:
        ...
        int a3)
{
  ...
  if ( *(_DWORD *)v4 > 4u )
  {
    if ( TlgKeywordOn(v4, 2uLL) )
    {
      ...
      v9 = 16;
      v12 = cData;
      TlgWrite(v5, &unk_18019F45F, 0LL, 0LL, cData, &pData);
    }
  }
}
