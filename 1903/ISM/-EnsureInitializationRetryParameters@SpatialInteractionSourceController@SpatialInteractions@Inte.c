/*
 * XREFs of ?EnsureInitializationRetryParameters@SpatialInteractionSourceController@SpatialInteractions@Internal@Windows@@AEAAXXZ @ 0x1801656D0
 * Callers:
        ...
        Windows::Internal::SpatialInteractions::SpatialInteractionSourceController *this)
{
  ...
  if ( !Windows::Internal::SpatialInteractions::SpatialInteractionSourceController::s_InitializationRetryParametersLoaded )
  {
    DwordWithDefault = RegistryHelpers::GetDwordWithDefault(
                         this,
                         (const WCHAR *)&stru_1801AE7E0,
                         L"AttemptsCount",
                         (const wchar_t *)0xA);
    if ( !DwordWithDefault )
      DwordWithDefault = 1;
    Windows::Internal::SpatialInteractions::SpatialInteractionSourceController::s_InitializationAttemptsCount = DwordWithDefault;
    Windows::Internal::SpatialInteractions::SpatialInteractionSourceController::s_InitializationWaitBeforeRetryMilliseconds = RegistryHelpers::GetDwordWithDefault(v2, (const WCHAR *)&stru_1801AE7E0, L"WaitBeforeRetryMS", (const wchar_t *)0x14);
    ...
    Windows::Internal::SpatialInteractions::SpatialInteractionSourceController::s_DynamicNodeInfoBindingWaitBeforeRetryMilliseconds = RegistryHelpers::GetDwordWithDefault(v5, (const WCHAR *)&stru_1801AE7E0, L"DynamicNodeInfoBindingWaitBeforeRetryMS", (const wchar_t *)0x1388);
