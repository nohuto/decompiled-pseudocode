/*
 * XREFs of ?TryCreateAndInitialize@HidLampAttributesResponseReportParser@@SAJPEBUParsedHidReportDescriptor@@PEAPEAV1@@Z @ 0x1800B7D44
 * Callers:
 ...
 *     ??0HidLampAttributesResponseReportParser@@AEAA@XZ @ 0x1800B7624 (--0HidLampAttributesResponseReportParser@@AEAA@XZ.c)
