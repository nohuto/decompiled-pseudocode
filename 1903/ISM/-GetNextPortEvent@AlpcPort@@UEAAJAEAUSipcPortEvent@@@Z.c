/*
 * XREFs of ?GetNextPortEvent@AlpcPort@@UEAAJAEAUSipcPortEvent@@@Z @ 0x1800D5C20
 * Callers:
 *     <none>
 * Callees:
 ...
 *     ?AddSectionListEntry@SipcPort@@IEAAXPEAUSectionListEntry@1@@Z @ 0x1800D4CB0 (-AddSectionListEntry@SipcPort@@IEAAXPEAUSectionListEntry@1@@Z.c)
 *     ?Cancel@AlpcMessage@@QEAAXPEAX@Z @ 0x1800D4D68 (-Cancel@AlpcMessage@@QEAAXPEAX@Z.c)
 *     ?DestroySection@AlpcSectionListEntry@AlpcPort@@UEAAJXZ @ 0x1800D52C0 (-DestroySection@AlpcSectionListEntry@AlpcPort@@UEAAJXZ.c)
 *     ?DiscardAttributes@AlpcMessage@@QEAAJPEAX@Z @ 0x1800D541C (-DiscardAttributes@AlpcMessage@@QEAAJPEAX@Z.c)
 *     ?DisconnectAllSections@SipcPort@@IEAAXXZ @ 0x1800D55D4 (-DisconnectAllSections@SipcPort@@IEAAXXZ.c)
 *     ?FillSectionListEntryPool@AlpcPort@@AEAAJ_K@Z @ 0x1800D57CC (-FillSectionListEntryPool@AlpcPort@@AEAAJ_K@Z.c)
 *     ?FindSectionListEntry@SipcPort@@IEAAPEAUSectionListEntry@1@AEBUSipcSectionId@@@Z @ 0x1800D58F0 (-FindSectionListEntry@SipcPort@@IEAAPEAUSectionListEntry@1@AEBUSipcSectionId@@@Z.c)
 *     ?FreeSectionEntry@AlpcSectionListEntry@AlpcPort@@UEAAXXZ @ 0x1800D5A40 (-FreeSectionEntry@AlpcSectionListEntry@AlpcPort@@UEAAXXZ.c)
 *     ?GetMessageData@AlpcMessage@@QEBA_K_KPEAX@Z @ 0x1800D5BA4 (-GetMessageData@AlpcMessage@@QEBA_K_KPEAX@Z.c)
 *     ?GetValue@?$SerializedIntegral@I@@QEBAIXZ @ 0x1800D619C (-GetValue@-$SerializedIntegral@I@@QEBAIXZ.c)
 *     ?PopFront@?$NtList@UAlpcSectionListEntry@AlpcPort@@@@QEAAPEAUAlpcSectionListEntry@AlpcPort@@XZ @ 0x1800D66B8 (-PopFront@-$NtList@UAlpcSectionListEntry@AlpcPort@@@@QEAAPEAUAlpcSectionListEntry@AlpcPort@@XZ.c)
...
__int64 __fastcall AlpcPort::GetNextPortEvent(AlpcPort *this, struct SipcPortEvent *a2)
{
  ...
  char v29[32]; // [rsp+58h] [rbp-A8h] BYREF
    ...
    *((_DWORD *)v5 + 84) = 1610612736;
    ...
    if ( v9 == 3 )
    {
      if ( (*((_DWORD *)this + 107) & 0x40000000) != 0 )
      {
        ...
        v5[2] &= ~0x2000u;
        v28 = 0LL;
        v13 = NtAlpcSendWaitReceivePort(v12, 0LL, v5, v5 + 168, 0LL, 0LL, 0LL, &v28, v26);
        if ( v13 >= 0 )
          v14 = 0;
        else
...
LABEL_35:
      ...
      else
      {
        ...
        if ( v20 == 32 )
        {
          ...
          AlpcMessage::GetMessageData((AlpcMessage *)v5, 0x20uLL, v29);
