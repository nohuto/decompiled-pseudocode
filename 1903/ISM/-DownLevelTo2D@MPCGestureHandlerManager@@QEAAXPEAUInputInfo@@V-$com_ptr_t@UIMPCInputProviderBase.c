/*
 * XREFs of ?DownLevelTo2D@MPCGestureHandlerManager@@QEAAXPEAUInputInfo@@V?$com_ptr_t@UIMPCInputProviderBase@@Uerr_exception_policy@wil@@@wil@@@Z @ 0x180086124
 * Callers:
...
__int64 __fastcall MPCGestureHandlerManager::DownLevelTo2D(__int64 **a1, __int64 a2, __int64 *a3, const char *a4)
{
  _DWORD *v7; // rbx
  _DWORD *v8; // rsi
  _DWORD *v9; // r14
  ...
  _DWORD *v16; // [rsp+98h] [rbp+58h] BYREF
  ...
  if ( v8 )
  {
    ...
    if ( !(unsigned __int8)MPCGestureHandler::IsInjecting(v7, v14) && v7[228] != *(_DWORD *)(a2 + 696) )
    {
      wil::com_ptr_t<InputSite,wil::err_exception_policy>::com_ptr_t<InputSite,wil::err_exception_policy>(v14, *a3);
      MPCGestureHandlerManager::DetachProvider((MPCGestureHandlerManager *)a1, v14);
      v7 = 0LL;
      v16 = 0LL;
  ...
  if ( !v9 )
  {
    GestureHandlerForWorkspace = (__int64 *)MPCGestureHandlerManager::GetGestureHandlerForWorkspace(
                                              a1,
                                              v14,
                                              *(unsigned int *)(a2 + 696));
    v11 = *GestureHandlerForWorkspace;
    *GestureHandlerForWorkspace = 0LL;
    wil::com_ptr_t<MPCGestureHandler,wil::err_exception_policy>::attach(&v16, v11);
    ...
    wil::com_ptr_t<InputSite,wil::err_exception_policy>::com_ptr_t<InputSite,wil::err_exception_policy>(v14, *a3);
    v7 = v16;
    MPCGestureHandler::AttachProvider(v16, v14);
    std::map<wil::com_ptr_t<IMPCInputProviderBase,wil::err_exception_policy>,wil::com_ptr_t<MPCGestureHandler,wil::err_exception_policy>>::_Try_emplace<wil::com_ptr_t<IMPCInputProviderBase,wil::err_exception_policy> const &,>(
      a1 + 3,
      (unsigned __int64)v14,
      a3);
  ...
  wil::com_ptr_t<InputSite,wil::err_exception_policy>::com_ptr_t<InputSite,wil::err_exception_policy>(v14, *a3);
  MPCGestureHandler::DownLevelTo2D(v7, a2, v14);
