/*
 * XREFs of ?Materialize_BamoDropTargetClientProxy@BamoPeerImpl@ISMBamos_AutoBamos@BamoImpl@@QEAAJI@Z @ 0x18005E60C
 * Callers:
 *     ?Thunk_Materialize_BamoDropTargetClientProxy_0@?$IBamoPeer_ISMBamos_AutoBamos_Receive@VBamoPeerImpl@ISMBamos_AutoBamos@BamoImpl@@@@SAJPEAXPEAPEAX@Z @ 0x180062D30 (-Thunk_Materialize_BamoDropTargetClientProxy_0@-$IBamoPeer_ISMBamos_AutoBamos_Receive@VBamoPeerI.c)
 * Callees:
        ...
        unsigned int a2)
{
  ...
  *(_QWORD *)v4 = &BamoDropTargetClientProxy::`vftable'{for `Microsoft::Bamo::BamoProxy'};
  *((_QWORD *)v4 + 1) = &BamoDropTargetClientProxy::`vftable'{for `IDropTargetClientProxy'};
  *((_DWORD *)v4 + 6) = 0;
  *((_QWORD *)v4 + 4) = 0LL;
  *((_DWORD *)v4 + 10) = 0;
  *((_WORD *)v4 + 22) = 0;
  *((_QWORD *)v4 + 6) = 0LL;
  *((_QWORD *)v4 + 2) = &BamoImpl::BamoDropTargetClientProxyImpl::`vftable';
  *((_QWORD *)v4 + 7) = 0LL;
  *((_QWORD *)v4 + 8) = 0LL;
