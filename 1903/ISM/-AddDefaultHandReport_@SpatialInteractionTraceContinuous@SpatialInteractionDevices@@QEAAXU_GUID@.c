/*
 * XREFs of ?AddDefaultHandReport_@SpatialInteractionTraceContinuous@SpatialInteractionDevices@@QEAAXU_GUID@@_JH@Z @ 0x1800F39FC
 * Callers:
        ...
        int a4)
{
  ...
  if ( *(_DWORD *)v5 > 5u )
  {
    if ( TlgKeywordOn(v5, 2uLL) )
    {
      ...
      v11 = 8LL;
      v13 = 4LL;
      TlgWrite(v6, &unk_1801A008C, 0LL, 0LL, 5u, &pData);
    }
  }
}
