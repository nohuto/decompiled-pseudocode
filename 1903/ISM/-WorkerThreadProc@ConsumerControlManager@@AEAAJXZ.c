/*
 * XREFs of ?WorkerThreadProc@ConsumerControlManager@@AEAAJXZ @ 0x1800AD7B0
 * Callers:
 *     ?WorkerThreadProcThunk@ConsumerControlManager@@CAKPEAX@Z @ 0x1800AD870 (-WorkerThreadProcThunk@ConsumerControlManager@@CAKPEAX@Z.c)
 * Callees:
