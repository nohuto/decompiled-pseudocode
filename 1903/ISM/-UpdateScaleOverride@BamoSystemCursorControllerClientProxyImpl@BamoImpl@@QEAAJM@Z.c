/*
 * XREFs of ?UpdateScaleOverride@BamoSystemCursorControllerClientProxyImpl@BamoImpl@@QEAAJM@Z @ 0x180064BA4
 * Callers:
 *     ?Thunk_UpdateScaleOverride_207@?$ISystemCursorControllerClientProxy_Receive@VBamoSystemCursorControllerClientProxyImpl@BamoImpl@@@@SAJPEAXPEAPEAX@Z @ 0x18002ED50 (-Thunk_UpdateScaleOverride_207@-$ISystemCursorControllerClientProxy_Receive@VBamoSystemCursorCon.c)
 * Callees:
