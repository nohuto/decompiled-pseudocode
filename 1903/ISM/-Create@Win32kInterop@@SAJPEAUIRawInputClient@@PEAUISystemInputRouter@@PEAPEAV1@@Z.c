/*
 * XREFs of ?Create@Win32kInterop@@SAJPEAUIRawInputClient@@PEAUISystemInputRouter@@PEAPEAV1@@Z @ 0x18001EE9C
 * Callers:
...
LABEL_14:
  ...
  {
    v7 = (Win32kInterop *)RefCountedObject::operator new(0x4D0uLL);
    if ( v7 )
