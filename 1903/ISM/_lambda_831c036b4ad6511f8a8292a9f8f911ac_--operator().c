/*
 * XREFs of _lambda_831c036b4ad6511f8a8292a9f8f911ac_::operator() @ 0x1800F3918
 * Callers:
...
bool __fastcall lambda_831c036b4ad6511f8a8292a9f8f911ac_::operator()(unsigned __int64 **a1, __int64 *a2)
{
  _BYTE *v2; // rbx
