/*
 * XREFs of ?SendPointerDelta@ControllerProcessor@@AEAAJUtagPOINT@@@Z @ 0x1800777A8
 * Callers:
...
__int64 __fastcall ControllerProcessor::SendPointerDelta(ControllerProcessor *this, struct tagPOINT a2)
{
  ...
  __int16 v12; // [rsp+92h] [rbp-6Eh]
  LONG v13; // [rsp+9Ch] [rbp-64h]
  LONG y; // [rsp+A0h] [rbp-60h]

  v7 = a2;
  x = a2.x;
  QueryPerformanceCounter(&PerformanceCount);
  memset_0(v8, 0, 0x1A8uLL);
  v10 = 424;
  v8[0] = 4096;
