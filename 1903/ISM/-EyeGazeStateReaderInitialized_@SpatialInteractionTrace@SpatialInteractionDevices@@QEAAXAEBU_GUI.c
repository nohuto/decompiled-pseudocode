/*
 * XREFs of ?EyeGazeStateReaderInitialized_@SpatialInteractionTrace@SpatialInteractionDevices@@QEAAXAEBU_GUID@@_N@Z @ 0x1800F0A24
 * Callers:
        ...
        char a3)
{
  ...
  if ( *(_DWORD *)v5 > 4u )
  {
    if ( TlgKeywordOn(v5, 2uLL) )
    {
      ...
      v7 = a3;
      v13 = 1;
      TlgWrite(v6, &unk_18019FBCE, 0LL, 0LL, 4u, &pData);
    }
  }
}
