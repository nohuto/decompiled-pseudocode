/*
 * XREFs of ?erase@?$_Hash@V?$_Umap_traits@PEAXV?$com_ptr_t@VPenDevice@@Uerr_exception_policy@wil@@@wil@@V?$_Uhash_compare@PEAXU?$hash@PEAX@std@@U?$equal_to@PEAX@2@@std@@V?$allocator@U?$pair@QEAXV?$com_ptr_t@VPenDevice@@Uerr_exception_policy@wil@@@wil@@@std@@@4@$0A@@std@@@std@@QEAA_KAEBQEAX@Z @ 0x180129970
 * Callers:
        ...
        unsigned __int8 *a2)
{
  ...
  {
    std::list<std::pair<void * const,wil::com_ptr_t<PenDevice,wil::err_exception_policy>>>::clear((__int64)(a1 + 1));
