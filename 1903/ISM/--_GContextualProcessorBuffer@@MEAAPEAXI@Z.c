/*
 * XREFs of ??_GContextualProcessorBuffer@@MEAAPEAXI@Z @ 0x18000B500
 * Callers:
 *     ??_EContextualProcessorBuffer@@OBI@EAAPEAXI@Z @ 0x180039420 (--_EContextualProcessorBuffer@@OBI@EAAPEAXI@Z.c)
 * Callees:
