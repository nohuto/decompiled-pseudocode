/*
 * XREFs of dllmain_crt_process_attach @ 0x18002B758
 * Callers:
 *     dllmain_crt_dispatch @ 0x18002B700 (dllmain_crt_dispatch.c)
 * Callees:
 *     ?__scrt_initialize_type_info@@YAXXZ @ 0x18002BB74 (-__scrt_initialize_type_info@@YAXXZ.c)
 ...
 *     __scrt_initialize_crt @ 0x18002BD60 (__scrt_initialize_crt.c)
 *     __scrt_is_nonwritable_in_current_image @ 0x18002BE90 (__scrt_is_nonwritable_in_current_image.c)
 *     __scrt_release_startup_lock @ 0x18002BF30 (__scrt_release_startup_lock.c)
 *     __scrt_get_dyn_tls_init_callback @ 0x18002C008 (__scrt_get_dyn_tls_init_callback.c)
 *     __scrt_fastfail @ 0x18002C028 (__scrt_fastfail.c)
 *     _RTC_Initialize @ 0x18002C17C (_RTC_Initialize.c)
 *     _initterm_0 @ 0x18002C3D6 (_initterm_0.c)
 *     _initterm_e_0 @ 0x18002C3E2 (_initterm_e_0.c)
