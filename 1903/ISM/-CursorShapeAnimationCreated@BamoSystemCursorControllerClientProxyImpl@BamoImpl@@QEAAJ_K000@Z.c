/*
 * XREFs of ?CursorShapeAnimationCreated@BamoSystemCursorControllerClientProxyImpl@BamoImpl@@QEAAJ_K000@Z @ 0x18005C208
 * Callers:
...
__int64 __fastcall BamoImpl::BamoSystemCursorControllerClientProxyImpl::CursorShapeAnimationCreated(
...
LABEL_3:
  ...
  v6[0] = v8;
  v6[1] = v4;
  return CoreUICallSend(v5, v6, 2LL, 49LL);
}
