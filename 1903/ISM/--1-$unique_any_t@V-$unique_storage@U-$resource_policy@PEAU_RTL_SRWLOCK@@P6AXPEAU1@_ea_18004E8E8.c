/*
 * XREFs of ??1?$unique_any_t@V?$unique_storage@U?$resource_policy@PEAU_RTL_SRWLOCK@@P6AXPEAU1@@Z$1?ReleaseSRWLockShared@@YAX0@ZU?$integral_constant@_K$00@wistd@@PEAU1@PEAU1@$0A@$$T@details@wil@@@details@wil@@@wil@@QEAA@XZ @ 0x18004E8E8
 * Callers:
 *     _SpectrumListener::OnHeadEventOccurred_::_1_::dtor$0 @ 0x180095D14 (_SpectrumListener--OnHeadEventOccurred_--_1_--dtor$0.c)
 ...
 *     _Windows::Internal::SpatialInteractions::SpatialInteractionEyeGazeObjectDevice::StartListeningToSpatialObjects_::_1_::dtor$0 @ 0x1800F1D3E (_Windows--Internal--SpatialInteractions--SpatialInteractionEyeGazeObjectDevice--StartListeningTo.c)
 ...
 *     _Windows::Internal::Holographic::HolographicDriverHandleWrapper::OpenDriverHandle_::_1_::dtor$6 @ 0x18015B2AF (_Windows--Internal--Holographic--HolographicDriverHandleWrapper--OpenDriverHandle_--_1_--dtor$6.c)
 * Callees:
 *     <none>
 */
