/*
 * XREFs of _lambda_7c875662d6abaa9f8d1386a75bd755d7_::operator() @ 0x18011A0E8
 * Callers:
 *     Windows::Internal::COperationLambdaVar_0__lambda_7c875662d6abaa9f8d1386a75bd755d7__Windows::Internal::CMarshaledInterfaceResult_Windows::Foundation::IPropertyValue___::Run @ 0x1801203D0 (Windows--Internal--COperationLambdaVar_0__lambda_7c875662d6abaa9f8d1386a75bd755d7___ea_1801203D0.c)
 * Callees:
...
__int64 __fastcall lambda_7c875662d6abaa9f8d1386a75bd755d7_::operator()(__int64 *a1, __int64 a2)
{
  ...
  *(_BYTE *)(a2 + 9) = 1;
  ...
  v7 = *(_QWORD *)(*(_QWORD *)(*a1 + 32) + 152LL);
  v8 = (*(__int64 (__fastcall **)(__int64))(*(_QWORD *)v7 + 72LL))(v7) + 8;
