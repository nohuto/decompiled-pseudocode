/*
 * XREFs of ?QueryInterface@DragNDropProcessorLegacy@@UEAAJAEBU_GUID@@PEAPEAX@Z @ 0x1800FFC00
 * Callers:
 *     ?QueryInterface@DragNDropProcessorLegacy@@W7EAAJAEBU_GUID@@PEAPEAX@Z @ 0x1800394C0 (-QueryInterface@DragNDropProcessorLegacy@@W7EAAJAEBU_GUID@@PEAPEAX@Z.c)
 * Callees:
