/*
 * XREFs of ?StartActivity@OpenHolographicDevice@HolographicDriverClientTrace@@QEAAXPEB_WW4TraceDriverType@@AEBU_GUID@@@Z @ 0x18015DD54
 * Callers:
        ...
        __int64 a4)
{
  ...
  if ( *(_DWORD *)v9 > 5u )
  {
    ...
    TlgWrite(v9, &unk_1801A22E5, (LPCGUID)(*(_QWORD *)(a1 + 48) + 8LL), v11, 7u, &pData);
  }
  if ( !*(_DWORD *)(a1 + 32) )
