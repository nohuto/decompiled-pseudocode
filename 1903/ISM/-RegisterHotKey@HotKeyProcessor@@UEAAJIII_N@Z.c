/*
 * XREFs of ?RegisterHotKey@HotKeyProcessor@@UEAAJIII_N@Z @ 0x180146BC0
 * Callers:
 *     <none>
 * Callees:
 ...
 *     ??$make_shared@UHOTKEY@@$$V@std@@YA?AV?$shared_ptr@UHOTKEY@@@0@XZ @ 0x180145750 (--$make_shared@UHOTKEY@@$$V@std@@YA-AV-$shared_ptr@UHOTKEY@@@0@XZ.c)
  ...
  if ( HotKey >= 0 )
  {
    if ( v19[0] )
    {
      ...
      if ( (unsigned int)dword_1801DE450 > 5 && TlgKeywordOn((TraceLoggingHProvider)&dword_1801DE450, 0x20000uLL) )
      {
        ...
        v32 = (bool *)&v17;
        v36 = 1;
        TlgWrite((TraceLoggingHProvider)&dword_1801DE450, &unk_1801A1C31, 0LL, 0LL, 7u, &pData);
      }
    }
    else
    {
      ...
      *((_BYTE *)v14 + 24) = a5;
      ...
      if ( (unsigned int)dword_1801DE450 > 5 && TlgKeywordOn((TraceLoggingHProvider)&dword_1801DE450, 0x20000uLL) )
      {
        ...
        v29 = &v17;
        v33 = 1;
        TlgWrite((TraceLoggingHProvider)&dword_1801DE450, &unk_1801A1DB4, 0LL, 0LL, 6u, &pData);
      }
    }
  }
  else
