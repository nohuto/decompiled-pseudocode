/*
 * XREFs of ?UnregisterForTestCommandMessage@TestCommandHost@@CAXW4TestCommandMessageType@@PEAXQ6A_N1PEAUTestCommandMessageDataHeader@@@Z@Z @ 0x1800D3894
 * Callers:
 *     ??1DWMCursor@@MEAA@XZ @ 0x180144384 (--1DWMCursor@@MEAA@XZ.c)
 * Callees:
