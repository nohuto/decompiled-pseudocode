/*
 * XREFs of Windows::Internal::Holographic::PosePredictionHelpers::CreatePredictionNode @ 0x180154300
 * Callers:
 ...
 *     ??$SE3_transform_direction3@MMM@ST@@YAXQEAMAEBU?$SE3@M@0@QEBM@Z @ 0x18016A100 (--$SE3_transform_direction3@MMM@ST@@YAXQEAMAEBU-$SE3@M@0@QEBM@Z.c)
 */
        ...
        __int64 a5)
{
  ...
  *((float *)&v23 + 1) = (float)(v16 * a4) + v18;
  v30 = *((_OWORD *)a2 + 1);
  ST::SE3_left_update<float>(&v29, &v22);
  ST::SE3_invert<float>(&v25, &v29);
  *(_QWORD *)&v22 = __PAIR64__(HIDWORD(v25), v25);
  *((_QWORD *)&v22 + 1) = __PAIR64__(DWORD1(v25), DWORD2(v26));
  *(_QWORD *)&v23 = __PAIR64__(HIDWORD(v26), v26);
  *((_QWORD *)&v23 + 1) = __PAIR64__(DWORD1(v26), DWORD2(v25));
  v24 = v27;
  v19 = v23;
  *(_OWORD *)(a5 + 36) = v22;
  v20 = v24;
  ...
  *(_QWORD *)((char *)&v22 + 4) = __PAIR64__(*(_DWORD *)(a1 + 60), v20);
  LODWORD(v19) = *(_DWORD *)(a1 + 40);
  DWORD1(v24) = *(_DWORD *)(a1 + 72);
  LODWORD(v20) = *(_DWORD *)(a1 + 52);
  HIDWORD(v22) = v19;
  DWORD1(v23) = *(_DWORD *)(a1 + 64);
