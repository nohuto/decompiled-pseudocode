        ...
        void *a2)
{
  ...
  if ( !*((_BYTE *)a2 + 25) )
  {
    do
    {
      ...
      std::_Deallocate<16,0>(v2, (const struct std::nothrow_t *)0xE0);
      v2 = v4;
    }
    while ( !*((_BYTE *)v4 + 25) );
  }
