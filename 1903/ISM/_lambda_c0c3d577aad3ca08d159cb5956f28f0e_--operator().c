/*
 * XREFs of _lambda_c0c3d577aad3ca08d159cb5956f28f0e_::operator() @ 0x180025484
 * Callers:
 *     ??$_Callback_once@V?$tuple@$$QEAV_lambda_c0c3d577aad3ca08d159cb5956f28f0e_@@AEAVexception_ptr@std@@@std@@U?$integer_sequence@_K$0A@@2@$00@std@@YAHPEAX0PEAPEAX@Z @ 0x180025420 (--$_Callback_once@V-$tuple@$$QEAV_lambda_c0c3d577aad3ca08d159cb5956f28f0e_@@AEAVexception_ptr@st.c)
 * Callees:
...
void __fastcall lambda_c0c3d577aad3ca08d159cb5956f28f0e_::operator()(_QWORD *a1)
{
  const char *v2; // r9
  struct BamoMPCConstantManagerClientPrincipal *v3; // rbx
  __int128 v4; // [rsp+30h] [rbp-D8h] BYREF
  __int64 *v5; // [rsp+40h] [rbp-C8h]
  void *v6[4]; // [rsp+48h] [rbp-C0h] BYREF
  _BYTE v7[32]; // [rsp+68h] [rbp-A0h] BYREF
  int v8; // [rsp+88h] [rbp-80h]
  char v9; // [rsp+8Ch] [rbp-7Ch]
  _BYTE v10[40]; // [rsp+90h] [rbp-78h] BYREF
  _BYTE v11[40]; // [rsp+B8h] [rbp-50h] BYREF
  _BYTE v12[40]; // [rsp+E0h] [rbp-28h] BYREF
  _BYTE v13[40]; // [rsp+108h] [rbp+0h] BYREF
  _BYTE v14[40]; // [rsp+130h] [rbp+28h] BYREF
  _BYTE v15[40]; // [rsp+158h] [rbp+50h] BYREF
  _BYTE v16[32]; // [rsp+180h] [rbp+78h] BYREF
  float v17; // [rsp+1A0h] [rbp+98h]
  char v18; // [rsp+1A4h] [rbp+9Ch]
  __int64 v19; // [rsp+1A8h] [rbp+A0h] BYREF
  wil::details::in1diag3 *retaddr; // [rsp+1C0h] [rbp+B8h]

  v6[2] = (void *)-2LL;
  IsEdition(10LL);
  v3 = MPCConstantManager::s_instance;
  ...
  std::wstring::wstring(v7, L"ActivationDelta");
  v8 = 2500;
  v9 = 0;
  *((float *)&v4 + 2) = FLOAT_600_0;
  ...
  *((float *)&v4 + 2) = FLOAT_0_00108;
  std::pair<std::wstring const,std::variant<unsigned long,bool,float>>::pair<std::wstring const,std::variant<unsigned long,bool,float>>(
    (__int64)v15,
    L"MouseParams_PointScaleFactorXY",
    (_DWORD *)&v4 + 2);
  std::wstring::wstring(v16, L"MouseParams_PointScaleFactorWheel");
  v17 = FLOAT_0_00075000001;
  v18 = 2;
  *((_QWORD *)&v4 + 1) = v7;
  v5 = &v19;
