/*
 * XREFs of ?UpdateState@MPCButtonHoldHelper@@QEAAX_N_K@Z @ 0x180140A30
 * Callers:
 ...
 * Callees:
 *     ?ResetState@MPCButtonHoldHelper@@QEAAXXZ @ 0x180140A14 (-ResetState@MPCButtonHoldHelper@@QEAAXXZ.c)
 */
