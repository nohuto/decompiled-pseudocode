/*
 * XREFs of ?StartActivity@OnHolographicDisplayChanged@SpatialInteractionTrace@SpatialInteractionDevices@@QEAAXXZ @ 0x1800E4EC0
 * Callers:
        ...
        SpatialInteractionDevices::SpatialInteractionTrace::OnHolographicDisplayChanged *this)
{
  ...
  if ( *(_DWORD *)v3 > 4u )
  {
    ...
    TlgWrite(v3, &unk_18019E59B, (LPCGUID)(*((_QWORD *)this + 6) + 8LL), v4, 4u, &pData);
  }
  if ( !*((_DWORD *)this + 8) )
