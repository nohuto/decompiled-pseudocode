/*
 * XREFs of ?QueryInterface@BamoMagnifierClientProxy@@UEAAJAEBU_GUID@@PEAPEAX@Z @ 0x18006FC70
 * Callers:
 *     ?QueryInterface@BamoMagnifierClientProxy@@W7EAAJAEBU_GUID@@PEAPEAX@Z @ 0x180038470 (-QueryInterface@BamoMagnifierClientProxy@@W7EAAJAEBU_GUID@@PEAPEAX@Z.c)
 * Callees:
