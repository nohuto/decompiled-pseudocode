/*
 * XREFs of ?StartActivity@FinalizeControllerInitialization@SpatialInteractionTrace@SpatialInteractionDevices@@QEAAXK@Z @ 0x1800E4D50
 * Callers:
 *     ??$?0K@FinalizeControllerInitialization@SpatialInteractionTrace@SpatialInteractionDevices@@AEAA@U?$integral_constant@D$0A@@wistd@@$$QEAK@Z @ 0x1800DFA24 (--$-0K@FinalizeControllerInitialization@SpatialInteractionTrace@SpatialInteractionDevices@@AEAA@.c)
 * Callees:
        ...
        int a2)
{
  ...
  *(_DWORD *)v3 = 1;
  ...
  if ( *(_DWORD *)v8 > 4u && TlgKeywordOn((TraceLoggingHProvider)v7[1], 0x400000000000uLL) )
  {
    ...
    TlgWrite(v8, &unk_18019EA78, (LPCGUID)(*((_QWORD *)this + 6) + 8LL), v10, 5u, &pData);
  }
  if ( !*((_DWORD *)this + 8) )
