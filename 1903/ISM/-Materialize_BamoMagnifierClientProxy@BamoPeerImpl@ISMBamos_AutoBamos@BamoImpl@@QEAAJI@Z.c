/*
 * XREFs of ?Materialize_BamoMagnifierClientProxy@BamoPeerImpl@ISMBamos_AutoBamos@BamoImpl@@QEAAJI@Z @ 0x18005ED58
 * Callers:
 *     ?Thunk_Materialize_BamoMagnifierClientProxy_0@?$IBamoPeer_ISMBamos_AutoBamos_Receive@VBamoPeerImpl@ISMBamos_AutoBamos@BamoImpl@@@@SAJPEAXPEAPEAX@Z @ 0x180062E00 (-Thunk_Materialize_BamoMagnifierClientProxy_0@-$IBamoPeer_ISMBamos_AutoBamos_Receive@VBamoPeerIm.c)
 * Callees:
