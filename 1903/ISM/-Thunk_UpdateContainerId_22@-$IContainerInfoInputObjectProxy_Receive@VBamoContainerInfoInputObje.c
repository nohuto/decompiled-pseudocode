/*
 * XREFs of ?Thunk_UpdateContainerId_22@?$IContainerInfoInputObjectProxy_Receive@VBamoContainerInfoInputObjectProxyImpl@BamoImpl@@@@SAJPEAXPEAPEAX@Z @ 0x1800630F0
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall IContainerInfoInputObjectProxy_Receive<BamoImpl::BamoContainerInfoInputObjectProxyImpl>::Thunk_UpdateContainerId_22(
        __int64 a1,
        _DWORD **a2)
{
  int v3; // eax
