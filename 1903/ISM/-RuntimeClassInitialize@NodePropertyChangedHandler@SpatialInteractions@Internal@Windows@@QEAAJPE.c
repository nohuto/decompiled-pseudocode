/*
 * XREFs of ?RuntimeClassInitialize@NodePropertyChangedHandler@SpatialInteractions@Internal@Windows@@QEAAJPEAVSpatialInteractionSourceController@234@AEBUSPATIAL_NODE_ID@@PEAUISpatialGraphDriverClient@Holographic@34@@Z @ 0x180167E94
 * Callers:
        ...
        struct Windows::Internal::Holographic::ISpatialGraphDriverClient *a4)
{
  ...
  *((_OWORD *)this + 4) = *(_OWORD *)a3;
  ...
  v7 = (*(__int64 (__fastcall **)(struct Windows::Internal::Holographic::ISpatialGraphDriverClient *, char *, Windows::Internal::SpatialInteractions::NodePropertyChangedHandler *))(*(_QWORD *)v6 + 64LL))(
         v6,
         (char *)this + 64,
         this);
  v8 = v7;
