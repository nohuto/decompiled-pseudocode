/*
 * XREFs of ?UpdateEdgyControllerServer@BamoInputSystemProxyImpl@BamoImpl@@QEAAJI@Z @ 0x18006431C
 * Callers:
 *     ?Thunk_UpdateEdgyControllerServer_0@?$IInputSystemProxy_Receive@VBamoInputSystemProxyImpl@BamoImpl@@@@SAJPEAXPEAPEAX@Z @ 0x1800631B0 (-Thunk_UpdateEdgyControllerServer_0@-$IInputSystemProxy_Receive@VBamoInputSystemProxyImpl@BamoIm.c)
 * Callees:
