/*
 * XREFs of ?MPCGestureHandler_InjectPress_@ISMTracing@@QEAAXJJKK@Z @ 0x18008E12C
 * Callers:
...
void __fastcall ISMTracing::MPCGestureHandler_InjectPress_(ISMTracing *this, int a2, int a3, int a4, char a5)
{
  __int64 v5; // rcx
  ...
  if ( ISMTracing::IsEnabled((__int64)this) )
  {
    ...
    if ( *(_DWORD *)v6 > 4u )
    {
      if ( TlgKeywordOn(v6, 1uLL) )
      {
        ...
        v17 = v8;
        v20 = v8;
        TlgWrite(v7, &unk_18019C283, 0LL, 0LL, 6u, &pData);
      }
    }
  }
}
