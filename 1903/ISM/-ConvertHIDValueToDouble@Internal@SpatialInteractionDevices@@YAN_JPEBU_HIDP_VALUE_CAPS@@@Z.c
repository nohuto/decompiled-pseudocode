/*
 * XREFs of ?ConvertHIDValueToDouble@Internal@SpatialInteractionDevices@@YAN_JPEBU_HIDP_VALUE_CAPS@@@Z @ 0x1800DEAD8
 * Callers:
 ...
 *     SpatialInteractionDevices::ReadKnownFloats_float_1_ @ 0x1800DAD98 (SpatialInteractionDevices--ReadKnownFloats_float_1_.c)
 *     SpatialInteractionDevices::ReadKnownFloats_DirectX::XMFLOAT2_2_ @ 0x1800DAE60 (SpatialInteractionDevices--ReadKnownFloats_DirectX--XMFLOAT2_2_.c)
 *     SpatialInteractionDevices::ReadKnownFloats_DirectX::XMFLOAT4_4_ @ 0x1800DAF28 (SpatialInteractionDevices--ReadKnownFloats_DirectX--XMFLOAT4_4_.c)
