/*
 * XREFs of ?Thunk_UpdateFeatures_0@?$IControllerNavigationOverrideProxy_Receive@VBamoControllerNavigationOverrideProxyImpl@BamoImpl@@@@SAJPEAXPEAPEAX@Z @ 0x1800717D0
 * Callers:
 *     <none>
 * Callees:
