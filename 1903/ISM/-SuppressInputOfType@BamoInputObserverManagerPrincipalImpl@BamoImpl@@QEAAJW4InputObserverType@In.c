/*
 * XREFs of ?SuppressInputOfType@BamoInputObserverManagerPrincipalImpl@BamoImpl@@QEAAJW4InputObserverType@InputObservation@@I@Z @ 0x180067AB0
 * Callers:
 *     ?Thunk_SuppressInputOfType_137@?$IInputObserverManagerPrincipal_Receive@VBamoInputObserverManagerPrincipalImpl@BamoImpl@@@@SAJPEAXPEAPEAX@Z @ 0x180067C20 (-Thunk_SuppressInputOfType_137@-$IInputObserverManagerPrincipal_Receive@VBamoInputObserverManage.c)
 * Callees:
