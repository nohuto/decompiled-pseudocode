/*
 * XREFs of ?SpatialInteractionEyeGazeObjectDevice_Added_@SpatialInteractionTrace@SpatialInteractionDevices@@QEAAXXZ @ 0x1800F18B4
 * Callers:
        ...
        SpatialInteractionDevices::SpatialInteractionTrace *this)
{
  ...
  if ( *(_DWORD *)v1 > 4u )
  {
    if ( TlgKeywordOn(v1, 2uLL) )
      TlgWrite(v3, &unk_18019FB93, 0LL, 0LL, cData, &pData);
  }
}
