/*
 * XREFs of ?NodePropertyCallbackUnregistered_@HolographicDriverClientTrace@@QEAAXAEBU_GUID@@AEBUSPATIAL_NODE_ID@@@Z @ 0x18015A0D4
 * Callers:
        ...
        const struct SPATIAL_NODE_ID *a3)
{
  ...
  if ( *(_DWORD *)v5 > 4u )
  {
    if ( TlgKeywordOn(v5, 2uLL) )
    {
      ...
      v9 = a2;
      v12 = a3;
      TlgWrite(v7, &unk_1801A34EF, 0LL, 0LL, 4u, &pData);
    }
  }
}
