/*
 * XREFs of ?RegisterObserverClientOfType@BamoInputObserverManagerPrincipalImpl@BamoImpl@@QEAAJW4InputObserverType@InputObservation@@I@Z @ 0x180067964
 * Callers:
 *     ?Thunk_RegisterObserverClientOfType_137@?$IInputObserverManagerPrincipal_Receive@VBamoInputObserverManagerPrincipalImpl@BamoImpl@@@@SAJPEAXPEAPEAX@Z @ 0x180067C00 (-Thunk_RegisterObserverClientOfType_137@-$IInputObserverManagerPrincipal_Receive@VBamoInputObser.c)
 * Callees:
        ...
        unsigned int a3)
{
  ...
  v13 = (*(__int64 (__fastcall **)(_QWORD *, __int64, _QWORD, char *))(*((_QWORD *)a1 - 2) + 72LL))(
          (_QWORD *)a1 - 2,
          v7,
          a2,
          v12);
