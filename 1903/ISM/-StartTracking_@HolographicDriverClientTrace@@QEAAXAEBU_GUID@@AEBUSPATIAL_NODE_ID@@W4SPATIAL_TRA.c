/*
 * XREFs of ?StartTracking_@HolographicDriverClientTrace@@QEAAXAEBU_GUID@@AEBUSPATIAL_NODE_ID@@W4SPATIAL_TRACKING_STATE@@@Z @ 0x18015E4B0
 * Callers:
...
char __fastcall HolographicDriverClientTrace::StartTracking_(__int64 a1, __int64 a2, __int64 a3, int a4)
{
  ...
  if ( **(_DWORD **)(v7 + 8) > 4u )
  {
    ...
    if ( (_BYTE)v7 )
    {
      ...
      v18 = 8LL;
      v17 = &qword_1801E0C60;
      LOBYTE(v7) = TlgWrite(v9, &unk_1801A3C7D, 0LL, 0LL, 6u, &pData);
    }
  }
  return v7;
}
