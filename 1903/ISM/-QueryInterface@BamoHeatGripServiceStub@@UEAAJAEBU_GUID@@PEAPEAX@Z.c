/*
 * XREFs of ?QueryInterface@BamoHeatGripServiceStub@@UEAAJAEBU_GUID@@PEAPEAX@Z @ 0x18007A6D0
 * Callers:
 *     ?QueryInterface@BamoHeatGripServiceStub@@W7EAAJAEBU_GUID@@PEAPEAX@Z @ 0x180038590 (-QueryInterface@BamoHeatGripServiceStub@@W7EAAJAEBU_GUID@@PEAPEAX@Z.c)
 * Callees:
