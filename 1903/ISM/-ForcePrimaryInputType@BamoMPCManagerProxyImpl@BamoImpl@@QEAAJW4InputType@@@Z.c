/*
 * XREFs of ?ForcePrimaryInputType@BamoMPCManagerProxyImpl@BamoImpl@@QEAAJW4InputType@@@Z @ 0x180110DEC
 * Callers:
...
__int64 __fastcall BamoImpl::BamoMPCManagerProxyImpl::ForcePrimaryInputType(Microsoft::BamoImpl::BamoProxyImpl *a1)
{
  int v1; // ebx
  __int64 v2; // rdx
