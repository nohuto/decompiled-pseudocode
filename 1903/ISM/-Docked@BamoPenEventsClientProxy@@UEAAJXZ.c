/*
 * XREFs of ?Docked@BamoPenEventsClientProxy@@UEAAJXZ @ 0x180031D30
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall BamoPenEventsClientProxy::Docked(BamoPenEventsClientProxy *this)
{
  ...
  LODWORD(v1) = BamoImpl::BamoPenEventsClientProxyImpl::Docked((BamoPenEventsClientProxy *)((char *)v1 + 8));
