/*
 * XREFs of ?Thunk_UpdateHWND_6@?$IActivationListenerInputObjectProxy_Receive@VBamoActivationListenerInputObjectProxyImpl@BamoImpl@@@@SAJPEAXPEAPEAX@Z @ 0x180063450
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall IActivationListenerInputObjectProxy_Receive<BamoImpl::BamoActivationListenerInputObjectProxyImpl>::Thunk_UpdateHWND_6(
        __int64 a1,
        _QWORD **a2)
{
  int v3; // eax
