/*
 * XREFs of ?MPCInputRouter_UpdateFocusedInputTarget_@ISMTracing@@QEAAXPEAUIInputTarget@@_NPEAUIMPCInputPostProcessor@@@Z @ 0x180055480
 * Callers:
  ...
  if ( ISMTracing::IsEnabled((__int64)this) )
  {
    ...
    if ( *(_DWORD *)v8 > 4u )
    {
      if ( TlgKeywordOn((TraceLoggingHProvider)v7[1], 1uLL) )
      {
        ...
        v39 = &v16;
        v40 = 4;
        TlgWrite(v8, &unk_18019A9B6, 0LL, 0LL, 9u, &pData);
      }
    }
  }
}
