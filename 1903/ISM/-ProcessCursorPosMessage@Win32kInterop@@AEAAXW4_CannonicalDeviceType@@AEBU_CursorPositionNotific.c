/*
 * XREFs of ?ProcessCursorPosMessage@Win32kInterop@@AEAAXW4_CannonicalDeviceType@@AEBU_CursorPositionNotification@@@Z @ 0x1800BD010
 * Callers:
...
LABEL_11:
  Microsoft::WRL::ComPtr<InputRedirectionProcessor>::InternalRelease(&v19);
  return Microsoft::WRL::ComPtr<InputRedirectionProcessor>::InternalRelease(&v18);
}
