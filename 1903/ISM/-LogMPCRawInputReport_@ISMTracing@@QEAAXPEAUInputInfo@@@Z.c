/*
 * XREFs of ?LogMPCRawInputReport_@ISMTracing@@QEAAXPEAUInputInfo@@@Z @ 0x180094610
 * Callers:
  ...
  if ( ISMTracing::IsVerboseEnabled((__int64)this) )
  {
    if ( ((*((_DWORD *)a2 + 16) - 6) & 0xFFFFFFFD) != 0 )
    {
      ...
      if ( *(_DWORD *)v4 > 4u )
      {
        if ( TlgKeywordOn(v4, 1uLL) )
        {
          ...
          v23 = v6;
          v25 = v6;
          TlgWrite(v5, &unk_18019C43D, 0LL, 0LL, 8u, &pData);
        }
      }
    }
    else
    {
      ...
      if ( *(_DWORD *)v7 > 5u && TlgKeywordOn(v7, 1uLL) )
      {
        ...
        v23 = 4LL;
        v25 = 4LL;
        TlgWrite(v8, &unk_18019C4BB, 0LL, 0LL, 8u, &pData);
      }
    }
  }
}
