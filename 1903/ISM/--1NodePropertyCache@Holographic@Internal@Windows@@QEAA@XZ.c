/*
 * XREFs of ??1NodePropertyCache@Holographic@Internal@Windows@@QEAA@XZ @ 0x180151C84
 * Callers:
 *     _Windows::Internal::Holographic::SpatialGraphDriverClient::SpatialGraphDriverClient_::_1_::dtor$9 @ 0x18015114E (_Windows--Internal--Holographic--SpatialGraphDriverClient--SpatialGraphDriverClient_ea_18015114E.c)
 * Callees:
