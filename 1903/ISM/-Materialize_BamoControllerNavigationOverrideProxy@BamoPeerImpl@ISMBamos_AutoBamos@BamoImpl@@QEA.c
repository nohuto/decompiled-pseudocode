/*
 * XREFs of ?Materialize_BamoControllerNavigationOverrideProxy@BamoPeerImpl@ISMBamos_AutoBamos@BamoImpl@@QEAAJI@Z @ 0x18005E1B4
 * Callers:
 *     ?Thunk_Materialize_BamoControllerNavigationOverrideProxy_0@?$IBamoPeer_ISMBamos_AutoBamos_Receive@VBamoPeerImpl@ISMBamos_AutoBamos@BamoImpl@@@@SAJPEAXPEAPEAX@Z @ 0x180062CA0 (-Thunk_Materialize_BamoControllerNavigationOverrideProxy_0@-$IBamoPeer_ISMBamos_AutoBamos_Receiv.c)
 * Callees:
