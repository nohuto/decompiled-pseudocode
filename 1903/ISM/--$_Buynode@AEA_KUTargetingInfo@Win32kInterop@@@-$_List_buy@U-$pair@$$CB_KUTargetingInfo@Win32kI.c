/*
 * XREFs of ??$_Buynode@AEA_KUTargetingInfo@Win32kInterop@@@?$_List_buy@U?$pair@$$CB_KUTargetingInfo@Win32kInterop@@@std@@V?$allocator@U?$pair@$$CB_KUTargetingInfo@Win32kInterop@@@std@@@2@@std@@QEAAPEAU?$_List_node@U?$pair@$$CB_KUTargetingInfo@Win32kInterop@@@std@@PEAX@1@PEAU21@0AEA_K$$QEAUTargetingInfo@Win32kInterop@@@Z @ 0x1800B9BC0
 * Callers:
