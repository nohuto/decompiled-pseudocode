/*
 * XREFs of ?ResetReportDueToFirmwareUpdate_@SpatialInteractionTrace@SpatialInteractionDevices@@QEAAXKK@Z @ 0x180167BC8
 * Callers:
        ...
        int a3)
{
  ...
  if ( *(_DWORD *)v3 > 4u )
  {
    if ( TlgKeywordOn(v3, 2uLL) )
    {
      ...
      v8 = cData;
      v11 = cData;
      TlgWrite(v4, &unk_1801A4549, 0LL, 0LL, cData, &pData);
    }
  }
}
