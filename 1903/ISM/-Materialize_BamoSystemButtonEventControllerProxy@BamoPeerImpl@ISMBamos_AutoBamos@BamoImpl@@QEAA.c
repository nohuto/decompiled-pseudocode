/*
 * XREFs of ?Materialize_BamoSystemButtonEventControllerProxy@BamoPeerImpl@ISMBamos_AutoBamos@BamoImpl@@QEAAJI@Z @ 0x18002E990
 * Callers:
 *     ?Thunk_Materialize_BamoSystemButtonEventControllerProxy_0@?$IBamoPeer_ISMBamos_AutoBamos_Receive@VBamoPeerImpl@ISMBamos_AutoBamos@BamoImpl@@@@SAJPEAXPEAPEAX@Z @ 0x18002ED30 (-Thunk_Materialize_BamoSystemButtonEventControllerProxy_0@-$IBamoPeer_ISMBamos_AutoBamos_Receive.c)
 * Callees:
