/*
 * XREFs of ?s_DeviceNotificationsCallback@Win32kInterop@@SAHPEAU_CLIENT_DEVICE_NOTIFICATION@@@Z @ 0x1800BFC10
 * Callers:
 *     <none>
 * Callees:
 ...
 *     ?IsTimestampNewest@CursorNotificationProcessor@@QEAA_N_J@Z @ 0x1800BFEA4 (-IsTimestampNewest@CursorNotificationProcessor@@QEAA_N_J@Z.c)
 */
