/*
 * XREFs of ?GetConstantsForInputType@BamoMPCConstantManagerClientPrincipalImpl@BamoImpl@@QEAAJW4InputType@@I@Z @ 0x180089C24
 * Callers:
 *     ?Thunk_GetConstantsForInputType_21@?$IMPCConstantManagerClientPrincipal_Receive@VBamoMPCConstantManagerClientPrincipalImpl@BamoImpl@@@@SAJPEAXPEAPEAX@Z @ 0x18008B0F0 (-Thunk_GetConstantsForInputType_21@-$IMPCConstantManagerClientPrincipal_Receive@VBamoMPCConstant.c)
 * Callees:
