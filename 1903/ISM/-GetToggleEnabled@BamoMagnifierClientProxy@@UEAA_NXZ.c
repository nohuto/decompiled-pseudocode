/*
 * XREFs of ?GetToggleEnabled@BamoMagnifierClientProxy@@UEAA_NXZ @ 0x180032290
 * Callers:
 *     ?GetEnabled@ControllerNavigationClientProxy@@UEAA_NXZ @ 0x1800711B0 (-GetEnabled@ControllerNavigationClientProxy@@UEAA_NXZ.c)
 * Callees:
