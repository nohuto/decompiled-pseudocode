/*
 * XREFs of ?OnInputProviderChanged@BamoMPCManagerClientProxy@@UEAAJAEBULegacyDeviceInfo@@I@Z @ 0x180112760
 * Callers:
 *     <none>
 * Callees:
        ...
        unsigned int a3)
{
  ...
  LODWORD(v4) = BamoImpl::BamoMPCManagerClientProxyImpl::OnInputProviderChanged(
