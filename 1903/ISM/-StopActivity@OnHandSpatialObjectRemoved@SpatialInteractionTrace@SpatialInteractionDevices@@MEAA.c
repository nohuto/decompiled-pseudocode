/*
 * XREFs of ?StopActivity@OnHandSpatialObjectRemoved@SpatialInteractionTrace@SpatialInteractionDevices@@MEAAXXZ @ 0x1800F6FE0
 * Callers:
 *     <none>
 * Callees:
        ...
        SpatialInteractionDevices::SpatialInteractionTrace::OnHandSpatialObjectRemoved *this)
{
  ...
  if ( v4 )
  {
    if ( *(_DWORD *)v6[1] > 4u )
    {
      ...
      v62 = 4LL;
      TlgCreateSz(&v63, v14);
      TlgWrite(v15, &unk_1801A00D8, (LPCGUID)(*((_QWORD *)this + 6) + 8LL), 0LL, 0x15u, &pData);
    }
  }
  else
  {
    ...
    if ( *(_DWORD *)v16 > 4u )
    {
      ...
      v19 = CurrentThreadId;
      v32 = &v19;
      TlgWrite(v16, &unk_1801A0284, (LPCGUID)(*((_QWORD *)this + 6) + 8LL), 0LL, 5u, &v27);
    }
  }
  if ( *((_DWORD *)this + 8) )
