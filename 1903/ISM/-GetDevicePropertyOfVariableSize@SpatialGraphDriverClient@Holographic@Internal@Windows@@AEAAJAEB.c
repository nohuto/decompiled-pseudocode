/*
 * XREFs of ?GetDevicePropertyOfVariableSize@SpatialGraphDriverClient@Holographic@Internal@Windows@@AEAAJAEBU_GUID@@PEAVVariableSizeStructWrapperBase@234@P6AJPEBX_K@ZW4PropertyCacheBehavior@234@@Z @ 0x180155874
 * Callers:
        ...
        char a5)
{
  ...
  v12 = *v7;
  v13 = *(Windows::Internal::Holographic::HolographicDriverHandleWrapper **)(a1 + 104);
  if ( *(_BYTE *)(a1 + 121) )
  {
    v22 = 0LL;
