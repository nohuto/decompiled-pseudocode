/*
 * XREFs of ?GetCachedFeatureEnabledState@?$Feature@U__WilFeatureTraits_Feature_FuzzyInputOnXamlKeyboard@@@wil@@CA?AW4wil_details_CachedFeatureEnabledState@@_N@Z @ 0x18014806C
 * Callers:
 ...
 *     ?GetCurrentFeatureEnabledState@?$Feature@U__WilFeatureTraits_Feature_FuzzyInputOnXamlKeyboard@@@wil@@CA?AW4wil_details_CachedFeatureEnabledState@@_NPEAW4wil_details_CachedHasNotificationState@@PEAH@Z @ 0x180148130 (-GetCurrentFeatureEnabledState@-$Feature@U__WilFeatureTraits_Feature_FuzzyInputOnXamlKeyboard@@@.c)
 */
