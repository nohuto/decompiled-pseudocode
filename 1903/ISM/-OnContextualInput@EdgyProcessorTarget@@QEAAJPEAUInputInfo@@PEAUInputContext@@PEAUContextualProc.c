/*
 * XREFs of ?OnContextualInput@EdgyProcessorTarget@@QEAAJPEAUInputInfo@@PEAUInputContext@@PEAUContextualProcessorResponse@@@Z @ 0x1801035D8
 * Callers:
 *     ?OnInput@EdgyProcessor@@UEAAJPEAUInputInfo@@PEAUInputContext@@PEAUContextualProcessorResponse@@@Z @ 0x180100F20 (-OnInput@EdgyProcessor@@UEAAJPEAUInputInfo@@PEAUInputContext@@PEAUContextualProcessorResponse@@@.c)
 * Callees:
        ...
        struct ContextualProcessorResponse *a4)
{
  ...
  char v29[40]; // [rsp+68h] [rbp+17h] BYREF
    ...
    if ( EdgyProcessorTarget::QualifyEdgyInputReport(this, a2, (struct EdgyPointerInfo *)&v24) )
    {
      ...
      *((_OWORD *)this + 4) = v15;
      ...
      if ( v20 == 3 )
      {
        ...
        v22 = (EdgyImpl *)(*((_QWORD *)this + 15) + 80LL);
        v30 = 0LL;
        if ( EdgyImpl::GetCandidateEdgyDetectedInfo(v22, (struct CandidateEdgyDetectedInfo *)&v25) )
        {
          if ( !v26 )
            *((_DWORD *)this + 8) = 2;
        }
