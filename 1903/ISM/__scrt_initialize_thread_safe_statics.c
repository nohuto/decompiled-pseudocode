/*
 * XREFs of __scrt_initialize_thread_safe_statics @ 0x18002CEF0
 * Callers:
 *     <none>
 * Callees:
...
LABEL_13:
  ...
  {
    hHandle = 0LL;
    ((void (__fastcall *)(void *))ProcAddress)(&unk_1801E0A98);
    qword_1801E0AA8 = __ROR8__(v2, 64 - ((unsigned __int8)_security_cookie & 0x3Fu)) ^ _security_cookie;
    qword_1801E0AB0 = __ROR8__(v4, 64 - ((unsigned __int8)_security_cookie & 0x3Fu)) ^ _security_cookie;
  }
  else
  {
