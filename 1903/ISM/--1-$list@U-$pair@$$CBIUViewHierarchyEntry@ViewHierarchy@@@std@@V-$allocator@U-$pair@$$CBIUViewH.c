/*
 * XREFs of ??1?$list@U?$pair@$$CBIUViewHierarchyEntry@ViewHierarchy@@@std@@V?$allocator@U?$pair@$$CBIUViewHierarchyEntry@ViewHierarchy@@@std@@@2@@std@@QEAA@XZ @ 0x180058F0C
 * Callers:
 *     _ViewHierarchy::ViewHierarchy_::_1_::dtor$20 @ 0x18003DC31 (_ViewHierarchy--ViewHierarchy_--_1_--dtor$20.c)
 * Callees:
