/*
 * XREFs of ?_Buynode0@?$_List_alloc@U?$_List_base_types@U?$pair@$$CBKK@std@@V?$allocator@U?$pair@$$CBKK@std@@@2@@std@@@std@@QEAAPEAU?$_List_node@U?$pair@$$CBKK@std@@PEAX@2@PEAU32@0@Z @ 0x180014274
 * Callers:
