/*
 * XREFs of ??1?$RuntimeClass@U?$RuntimeClassFlags@$01@WRL@Microsoft@@UIRawInputProvider@@UIMouseProcessorForwarding@@VMPCInputProviderBase@@@WRL@Microsoft@@UEAA@XZ @ 0x180139FBC
 * Callers:
 *     _MPCMouseProcessor::MPCMouseProcessor_::_1_::dtor$0 @ 0x18003DC47 (_MPCMouseProcessor--MPCMouseProcessor_--_1_--dtor$0.c)
 * Callees:
 *     <none>
 */
