/*
 * XREFs of ?HandStateReaderInitialized_@SpatialInteractionTrace@SpatialInteractionDevices@@QEAAXAEBU_GUID@@_N1111@Z @ 0x1800F4F24
 * Callers:
 *     ??$HandStateReaderInitialized@U_GUID@@AEB_NAEB_NAEB_NAEB_NAEA_N@SpatialInteractionTrace@SpatialInteractionDevices@@SAX$$QEAU_GUID@@AEB_N111AEA_N@Z @ 0x1800F29F8 (--$HandStateReaderInitialized@U_GUID@@AEB_NAEB_NAEB_NAEB_NAEA_N@SpatialInteractionTrace@SpatialI.c)
 * Callees:
        ...
        bool a7)
{
  ...
  if ( *(_DWORD *)v8 > 4u )
  {
    if ( TlgKeywordOn(v8, 2uLL) )
    {
      ...
      v20 = 1LL;
      v22 = 1LL;
      TlgWrite(v9, &unk_1801A02DF, 0LL, 0LL, 8u, &pData);
    }
  }
}
