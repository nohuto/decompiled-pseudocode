/*
 * XREFs of ?QueryInterface@BamoMPCConstantManagerClientProxy@@UEAAJAEBU_GUID@@PEAPEAX@Z @ 0x1801135D0
 * Callers:
 *     ?QueryInterface@BamoMPCConstantManagerClientProxy@@W7EAAJAEBU_GUID@@PEAPEAX@Z @ 0x180039900 (-QueryInterface@BamoMPCConstantManagerClientProxy@@W7EAAJAEBU_GUID@@PEAPEAX@Z.c)
 * Callees:
