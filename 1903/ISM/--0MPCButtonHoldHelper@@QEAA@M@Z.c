/*
 * XREFs of ??0MPCButtonHoldHelper@@QEAA@M@Z @ 0x180140960
 * Callers:
 ...
 *     ??$make_shared@VMPCButtonHoldHelper@@AEAM@std@@YA?AV?$shared_ptr@VMPCButtonHoldHelper@@@0@AEAM@Z @ 0x180140AB0 (--$make_shared@VMPCButtonHoldHelper@@AEAM@std@@YA-AV-$shared_ptr@VMPCButtonHoldHelper@@@0@AEAM@Z.c)
 * Callees:
        ...
        const char *a4)
{
  ...
  *((_QWORD *)this + 3) = (unsigned int)(int)((double)(int)qword_1801E0C48 * a2);
  return this;
}
