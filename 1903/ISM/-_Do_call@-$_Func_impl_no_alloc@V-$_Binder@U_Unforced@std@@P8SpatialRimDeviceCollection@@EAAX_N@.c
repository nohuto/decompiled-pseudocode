/*
 * XREFs of ?_Do_call@?$_Func_impl_no_alloc@V?$_Binder@U_Unforced@std@@P8SpatialRimDeviceCollection@@EAAX_N@ZPEAV3@AEBU?$_Ph@$00@2@@std@@X_N@std@@EEAAX$$QEA_N@Z @ 0x180056580
 * Callers:
 *     <none>
 * Callees:
 *     <none>
