/*
 * XREFs of ??1?$unordered_map@KUVelocityData@DragNDropProcessor@@U?$hash@K@std@@U?$equal_to@K@4@V?$allocator@U?$pair@$$CBKUVelocityData@DragNDropProcessor@@@std@@@4@@std@@QEAA@XZ @ 0x18006A6AC
 * Callers:
 *     _DragNDropProcessor::DragNDropProcessor_::_1_::dtor$3 @ 0x18006A5C6 (_DragNDropProcessor--DragNDropProcessor_--_1_--dtor$3.c)
 *     _DragNDropProcessor::DragNDropProcessor_::_1_::dtor$7 @ 0x18006A60C (_DragNDropProcessor--DragNDropProcessor_--_1_--dtor$7.c)
 *     _DragNDropProcessorLegacy::DragNDropProcessorLegacy_::_1_::dtor$7 @ 0x1800FE5C3 (_DragNDropProcessorLegacy--DragNDropProcessorLegacy_--_1_--dtor$7.c)
 * Callees:
