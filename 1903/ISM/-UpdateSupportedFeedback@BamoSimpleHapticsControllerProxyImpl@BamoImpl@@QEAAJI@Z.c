/*
 * XREFs of ?UpdateSupportedFeedback@BamoSimpleHapticsControllerProxyImpl@BamoImpl@@QEAAJI@Z @ 0x180064CE4
 * Callers:
 *     ?Thunk_UpdateSupportedFeedback_0@?$ISimpleHapticsControllerProxy_Receive@VBamoSimpleHapticsControllerProxyImpl@BamoImpl@@@@SAJPEAXPEAPEAX@Z @ 0x180063B40 (-Thunk_UpdateSupportedFeedback_0@-$ISimpleHapticsControllerProxy_Receive@VBamoSimpleHapticsContr.c)
 * Callees:
