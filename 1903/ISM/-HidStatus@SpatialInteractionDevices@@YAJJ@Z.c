/*
 * XREFs of ?HidStatus@SpatialInteractionDevices@@YAJJ@Z @ 0x1800DEF9C
 * Callers:
...
__int64 __fastcall SpatialInteractionDevices::HidStatus(SpatialInteractionDevices *this)
{
  ...
  __int64 v4; // rdi
  void *v5; // rsi
  ICreateErrorInfo *pperrinfo; // [rsp+28h] [rbp-69h] BYREF
  IErrorInfo *perrinfo[3]; // [rsp+30h] [rbp-61h] BYREF
  wchar_t v9[64]; // [rsp+48h] [rbp-49h] BYREF
  ...
  {
    pperrinfo = 0LL;
    Microsoft::WRL::ComPtr<Windows::Gaming::Input::Internal::IGipGameControllerProviderPrivate>::InternalRelease((__int64 *)&pperrinfo);
...
LABEL_42:
          ...
          if ( v5 )
          {
            ...
            {
              Microsoft::WRL::ComPtr<Windows::Gaming::Input::Internal::IGipGameControllerProviderPrivate>::InternalRelease((__int64 *)perrinfo);
