        ...
        __int64 *a2)
{
  ...
  for ( i = a2; !*((_BYTE *)i + 25); v2 = i )
  {
    ...
    if ( v5 )
    {
      v6 = (void (__fastcall ***)(_QWORD))(*(__int64 (__fastcall **)(__int64))(*(_QWORD *)v5 + 8LL))(v5);
      (**v6)(v6);
    }
