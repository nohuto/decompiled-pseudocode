/*
 * XREFs of ?CreateCursorForDevice@BamoSystemCursorControllerPrincipalImpl@BamoImpl@@QEAAJ_K@Z @ 0x1800C9618
 * Callers:
 *     ?Thunk_CreateCursorForDevice_6@?$ISystemCursorControllerPrincipal_Receive@VBamoSystemCursorControllerPrincipalImpl@BamoImpl@@@@SAJPEAXPEAPEAX@Z @ 0x1800CABB0 (-Thunk_CreateCursorForDevice_6@-$ISystemCursorControllerPrincipal_Receive@VBamoSystemCursorContr.c)
 * Callees:
        ...
        __int64 a2)
{
  ...
  v6 = (*(__int64 (__fastcall **)(char *, __int64, __int64))(*((_QWORD *)this - 2) + 88LL))((char *)this - 16, v5, a2);
  if ( v6 < 0 )
