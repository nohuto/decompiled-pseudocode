/*
 * XREFs of ?SetRestrictToProcessId@BamoDataSourcePrincipal@@UEAAXI@Z @ 0x1800D1560
 * Callers:
 *     <none>
 * Callees:
 ...
 *     ?UpdateRestrictToProcessIdRemoteCacheStatic@BamoDataSourcePrincipalImpl@BamoImpl@@CAJPEAVBamoStubImpl@2Microsoft@@PEAV12@@Z @ 0x1800D2190 (-UpdateRestrictToProcessIdRemoteCacheStatic@BamoDataSourcePrincipalImpl@BamoImpl@@CAJPEAVBamoStu.c)
 */
