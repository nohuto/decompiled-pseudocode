/*
 * XREFs of ?UpdatePenEventsDispatcherRemoteCache@BamoInputSystemPrincipalImpl@BamoImpl@@AEAAXPEAVBamoStubImpl@2Microsoft@@@Z @ 0x18002EF50
 * Callers:
        ...
        struct Microsoft::BamoImpl::BamoStubImpl *a2)
{
  ...
  if ( *(_QWORD *)(v4 + 40) )
  {
    ...
    v9[1] = *((unsigned int *)this + 6);
    v9[0] = v6;
    v7 = CoreUICallSend(*(_QWORD *)(v4 + 48), v9, 2LL, 32LL);
