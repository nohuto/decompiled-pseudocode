/*
 * XREFs of ?OnInteractiveIntentGesture@BamoMPCManagerClientPrincipalImpl@BamoImpl@@QEAAJPEAULegacyDeviceInfo@@IIII_KI@Z @ 0x180115C28
 * Callers:
 *     ?Thunk_OnInteractiveIntentGesture_43@?$IMPCManagerClientPrincipal_Receive@VBamoMPCManagerClientPrincipalImpl@BamoImpl@@@@SAJPEAXPEAPEAX@Z @ 0x180116440 (-Thunk_OnInteractiveIntentGesture_43@-$IMPCManagerClientPrincipal_Receive@VBamoMPCManagerClientP.c)
 * Callees:
