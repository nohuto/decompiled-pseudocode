/*
 * XREFs of ?Initialize@GazeHidDevice@@QEAAJPEAUGazeDeviceInfo@@@Z @ 0x1800A67D4
 * Callers:
    ...
    if ( Caps >= 0 )
    {
      *((_DWORD *)a2 + 397) = 0;
      ...
      if ( (unsigned __int8)GazeHidParser::IsPropertySupported(v4, 10LL) )
        *((_DWORD *)a2 + 397) = v10 | 2;
      *((_DWORD *)a2 + 401) = *((_DWORD *)this + 14);
      memcpy_0((char *)a2 + 1608, *((const void **)this + 6), *((unsigned int *)this + 14));
