/*
 * XREFs of ?StartTracking@SpatialGraphDriverHandleWrapper@Holographic@Internal@Windows@@QEAAJAEBUSPATIAL_NODE_ID@@W4SPATIAL_TRACKING_STATE@@@Z @ 0x18015E1D0
 * Callers:
        ...
        int a3)
{
  ...
  const char *v16; // r9
  __int64 result; // rax
  const char *v18; // [rsp+28h] [rbp-F0h]
  const char *v19; // [rsp+28h] [rbp-F0h]
  int v20; // [rsp+30h] [rbp-E8h] BYREF
  __int64 v21; // [rsp+38h] [rbp-E0h] BYREF
  __int128 v22; // [rsp+40h] [rbp-D8h] BYREF
  _QWORD v23[4]; // [rsp+50h] [rbp-C8h] BYREF
  char v24; // [rsp+70h] [rbp-A8h]
  __int128 v25; // [rsp+78h] [rbp-A0h] BYREF
  __int64 v26; // [rsp+88h] [rbp-90h]
  int v27; // [rsp+90h] [rbp-88h]
  _QWORD v28[8]; // [rsp+A0h] [rbp-78h] BYREF
  ...
  try
  {
    ...
    if ( (__int64 *)v21 == *v6 )
    {
      *(_QWORD *)&v22 = a1;
      *((_QWORD *)&v22 + 1) = &v21;
      std::function_void___cdecl_void__::operator___lambda_bb99315a2e04bb315428571541c06609__void_((__int64)v28, &v22);
      v9 = *v6;
      *(_QWORD *)&v22 = 0LL;
      DWORD2(v22) = 0;
    ...
    else
    {
      wil::details::in1diag3::FailFast_IfMsg(
        ...
        (void *)0x701,
        (unsigned int)"onecoreuap\\analog\\input\\holographicdriverclientlib\\lib\\spatialgraphdriverclient.cpp",
        (const char *)(*(_DWORD *)(v21 + 44) + *(_DWORD *)(v21 + 48) == 0),
        (void *)"NodeId should not be in map if TrackingState ref count < 1",
        v19);
      *(_QWORD *)&v22 = &v21;
      *((_QWORD *)&v22 + 1) = &v20;
      std::function_void___cdecl_void__::operator___lambda_1fd6b219498efdbd05d8af8c3e9a695a__void_((__int64)v28, &v22);
    ...
    if ( v12 >= 0 )
    {
      std::_Func_class<void,_MIT_KEYBOARD_INPUT_MESSAGE const *>::_Tidy((__int64)v28, v13);
      if ( v5 )
    ...
    else
    {
      ...
      std::_Func_class<void,_MIT_KEYBOARD_INPUT_MESSAGE const *>::_Tidy((__int64)v28, v15);
      if ( v5 )
        LeaveCriticalSection(v5);
      result = v14;
    }
