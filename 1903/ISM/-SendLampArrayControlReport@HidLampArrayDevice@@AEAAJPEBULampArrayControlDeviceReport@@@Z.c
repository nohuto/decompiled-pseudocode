/*
 * XREFs of ?SendLampArrayControlReport@HidLampArrayDevice@@AEAAJPEBULampArrayControlDeviceReport@@@Z @ 0x1800B4F88
 * Callers:
        ...
        const struct LampArrayControlDeviceReport *a2)
{
  ...
  if ( (unsigned int)hProvider > 5 )
  {
    ...
    v15 = v4;
    v24 = 1;
    TlgWrite((TraceLoggingHProvider)&hProvider, &unk_18019D7AB, 0LL, 0LL, 5u, &pData);
  }
  v5 = *((_QWORD *)this + 73);
  ...
  if ( v6 >= 0 )
  {
    ...
    if ( HidD_SetFeature(*(HANDLE *)(*((_QWORD *)this + 2) + 40LL), ReportBuffer, ReportBufferLength) )
    {
      if ( (unsigned int)hProvider > 5 )
      {
        ...
        TlgWrite((TraceLoggingHProvider)&hProvider, &unk_18019D756, 0LL, 0LL, 4u, &v26);
      }
      if ( v10 )
