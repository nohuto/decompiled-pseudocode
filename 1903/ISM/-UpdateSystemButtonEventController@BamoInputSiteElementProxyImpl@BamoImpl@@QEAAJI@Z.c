/*
 * XREFs of ?UpdateSystemButtonEventController@BamoInputSiteElementProxyImpl@BamoImpl@@QEAAJI@Z @ 0x18002F790
 * Callers:
 *     ?Thunk_UpdateSystemButtonEventController_0@?$IInputSiteElementProxy_Receive@VBamoInputSiteElementProxyImpl@BamoImpl@@@@SAJPEAXPEAPEAX@Z @ 0x18002F780 (-Thunk_UpdateSystemButtonEventController_0@-$IInputSiteElementProxy_Receive@VBamoInputSiteElemen.c)
 * Callees:
