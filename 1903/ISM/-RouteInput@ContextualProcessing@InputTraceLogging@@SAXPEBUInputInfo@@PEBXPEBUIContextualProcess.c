/*
 * XREFs of ?RouteInput@ContextualProcessing@InputTraceLogging@@SAXPEBUInputInfo@@PEBXPEBUIContextualProcessor@@_N33@Z @ 0x1800FB2BC
 * Callers:
        ...
        bool a6)
{
  ...
  if ( a3 )
    ...
    v10 = (const unsigned __int16 *)((char *)&word_180182F8B + 1);
  if ( a5 )
  {
    v11 = "Buffer";
  }
  ...
  if ( *(_DWORD *)v12[1] > 4u )
  {
    if ( TlgKeywordOn((TraceLoggingHProvider)v12[1], 0x400uLL) )
    {
      ...
      TlgWrite(v17, &unk_1801A054F, 0LL, 0LL, 7u, &pData);
    }
  }
}
