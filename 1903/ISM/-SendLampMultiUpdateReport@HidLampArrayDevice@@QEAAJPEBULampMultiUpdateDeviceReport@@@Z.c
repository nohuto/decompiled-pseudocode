/*
 * XREFs of ?SendLampMultiUpdateReport@HidLampArrayDevice@@QEAAJPEBULampMultiUpdateDeviceReport@@@Z @ 0x1800B5218
 * Callers:
        ...
        const struct LampMultiUpdateDeviceReport *a2)
{
  ...
  if ( (unsigned int)hProvider > 5 )
  {
    ...
    TlgWrite((TraceLoggingHProvider)&hProvider, &unk_18019D6B4, 0LL, 0LL, 4u, &pData);
  }
  v4 = *((_QWORD *)this + 76);
  ...
  if ( v5 >= 0 )
  {
    ...
    if ( HidD_SetFeature(*(HANDLE *)(*((_QWORD *)this + 2) + 40LL), ReportBuffer, ReportBufferLength) )
    {
      if ( (unsigned int)hProvider > 5 )
      {
        ...
        TlgWrite((TraceLoggingHProvider)&hProvider, &unk_18019D6B4, 0LL, 0LL, 4u, &v21);
      }
      if ( v9 )
