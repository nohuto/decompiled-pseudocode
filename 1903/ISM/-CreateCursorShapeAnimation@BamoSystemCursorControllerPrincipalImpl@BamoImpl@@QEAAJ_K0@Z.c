/*
 * XREFs of ?CreateCursorShapeAnimation@BamoSystemCursorControllerPrincipalImpl@BamoImpl@@QEAAJ_K0@Z @ 0x1800C97E8
 * Callers:
 *     ?Thunk_CreateCursorShapeAnimation_203@?$ISystemCursorControllerPrincipal_Receive@VBamoSystemCursorControllerPrincipalImpl@BamoImpl@@@@SAJPEAXPEAPEAX@Z @ 0x1800359D0 (-Thunk_CreateCursorShapeAnimation_203@-$ISystemCursorControllerPrincipal_Receive@VBamoSystemCurs.c)
 * Callees:
