/*
 * XREFs of std::vector_unsigned_char_std::allocator_unsigned_char___::_Resize__lambda_2b51424039c320f102fd798e073c89b2___ @ 0x180150100
 * Callers:
 ...
 *     ?_Umove_if_noexcept@?$vector@EV?$allocator@E@std@@@std@@AEAAXPEAE00@Z @ 0x180160B38 (-_Umove_if_noexcept@-$vector@EV-$allocator@E@std@@@std@@AEAAXPEAE00@Z.c)
 */
