/*
 * XREFs of ??1?$com_ptr_t@VBamoPeer@MPCManagerBamo_AutoBamos@@Uerr_exception_policy@wil@@@wil@@QEAA@XZ @ 0x18007D3B0
 * Callers:
 *     _MPCManager::OnPeerConnected_::_1_::dtor$0 @ 0x18007EE99 (_MPCManager--OnPeerConnected_--_1_--dtor$0.c)
 * Callees:
