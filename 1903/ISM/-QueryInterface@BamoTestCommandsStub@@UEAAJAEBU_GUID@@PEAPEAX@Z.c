/*
 * XREFs of ?QueryInterface@BamoTestCommandsStub@@UEAAJAEBU_GUID@@PEAPEAX@Z @ 0x1800F90A0
 * Callers:
 *     ?QueryInterface@BamoTestCommandsStub@@W7EAAJAEBU_GUID@@PEAPEAX@Z @ 0x180039410 (-QueryInterface@BamoTestCommandsStub@@W7EAAJAEBU_GUID@@PEAPEAX@Z.c)
 * Callees:
