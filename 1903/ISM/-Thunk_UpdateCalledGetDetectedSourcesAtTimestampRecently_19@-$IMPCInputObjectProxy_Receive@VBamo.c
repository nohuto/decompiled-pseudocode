/*
 * XREFs of ?Thunk_UpdateCalledGetDetectedSourcesAtTimestampRecently_19@?$IMPCInputObjectProxy_Receive@VBamoMPCInputObjectProxyImpl@BamoImpl@@@@SAJPEAXPEAPEAX@Z @ 0x180063050
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall IMPCInputObjectProxy_Receive<BamoImpl::BamoMPCInputObjectProxyImpl>::Thunk_UpdateCalledGetDetectedSourcesAtTimestampRecently_19(
        __int64 a1,
        _BYTE **a2)
{
  int v3; // eax
