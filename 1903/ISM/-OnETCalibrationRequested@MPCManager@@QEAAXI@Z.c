/*
 * XREFs of ?OnETCalibrationRequested@MPCManager@@QEAAXI@Z @ 0x18007E980
 * Callers:
 *     ?OnDeviceUpdate@MPCEyeGazeProcessor@@UEAAJPEAUDeviceInfo@@@Z @ 0x18013EC10 (-OnDeviceUpdate@MPCEyeGazeProcessor@@UEAAJPEAUDeviceInfo@@@Z.c)
 * Callees:
...
void __fastcall MPCManager::OnETCalibrationRequested(MPCManager *this, unsigned int a2)
{
  ...
  while ( (__int64 *)v4 != v2 )
  {
    v5 = (*(__int64 (__fastcall **)(_QWORD, _QWORD))(**(_QWORD **)(v4 + 40) + 96LL))(*(_QWORD *)(v4 + 40), a2);
    if ( v5 < 0 )
