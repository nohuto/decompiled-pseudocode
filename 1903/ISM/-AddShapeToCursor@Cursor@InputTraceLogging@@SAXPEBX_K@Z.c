/*
 * XREFs of ?AddShapeToCursor@Cursor@InputTraceLogging@@SAXPEBX_K@Z @ 0x1800CBF6C
 * Callers:
 ...
 *     ?ShapeIdToString@InputTraceLogging@@CAPEBDTSystemCursorShapeIdDetails@@@Z @ 0x1800CE018 (-ShapeIdToString@InputTraceLogging@@CAPEBDTSystemCursorShapeIdDetails@@@Z.c)
 */
...
void __fastcall InputTraceLogging::Cursor::AddShapeToCursor(__int64 a1, __int64 a2)
{
  ...
  if ( *(_DWORD *)v2[1] > 4u )
  {
    if ( TlgKeywordOn((TraceLoggingHProvider)v2[1], 8uLL) )
    {
      ...
      v7 = v6;
      v15 = 4LL;
      TlgWrite(v5, &unk_18019DF5C, 0LL, 0LL, 6u, &pData);
    }
  }
}
