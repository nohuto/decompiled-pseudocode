/*
 * XREFs of ??1PropertyCache@Holographic@Internal@Windows@@QEAA@XZ @ 0x180151CE8
 * Callers:
 *     _Windows::Internal::Holographic::SpatialGraphDriverClient::SpatialGraphDriverClient_::_1_::dtor$8 @ 0x18015113B (_Windows--Internal--Holographic--SpatialGraphDriverClient--SpatialGraphDriverClient_ea_18015113B.c)
 * Callees:
