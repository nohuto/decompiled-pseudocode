/*
 * XREFs of ??1?$list@U?$pair@QEAUIDCompInputTarget@@V?$vector@KV?$allocator@K@std@@@std@@@std@@V?$allocator@U?$pair@QEAUIDCompInputTarget@@V?$vector@KV?$allocator@K@std@@@std@@@std@@@2@@std@@QEAA@XZ @ 0x1800BAB10
 * Callers:
 *     _Win32kInterop::DeliverInputToAllTargets_::_1_::dtor$13 @ 0x1800BC303 (_Win32kInterop--DeliverInputToAllTargets_--_1_--dtor$13.c)
 * Callees:
