/*
 * XREFs of ?SendInputReport@SpatialRimDeviceCollection@@UEAAJW4MPCAugmentedInputGestureType@@W4MPCGestureType@@KAEBUHandStateMsg@Internal@Spatial@Input@UI@Windows@@UMatrix4x4@Numerics@Foundation@9@@Z @ 0x18009EFB0
 * Callers:
 *     <none>
 * Callees:
 ...
 *     ?IsEnabled@RawInputProvidersContinuousTracing@@SA_NE_K@Z @ 0x18009D890 (-IsEnabled@RawInputProvidersContinuousTracing@@SA_NE_K@Z.c)
