/*
 * XREFs of ?EnsureBamoCallbacks@MPCConstantManagerClient@@AEAAJXZ @ 0x18011C45C
 * Callers:
...
__int64 __fastcall MPCConstantManagerClient::EnsureBamoCallbacks(struct MPCManagerClientConnection **this)
{
  ...
  MPCConstantManagerClientPrincipal *v7; // [rsp+40h] [rbp+8h]
  ...
  if ( *((_QWORD *)this[4] + 19) )
  {
    if ( !this[5] )
    {
      ...
      v5 = (*(__int64 (__fastcall **)(_QWORD))(**((_QWORD **)this[4] + 19) + 72LL))(*((_QWORD *)this[4] + 19));
