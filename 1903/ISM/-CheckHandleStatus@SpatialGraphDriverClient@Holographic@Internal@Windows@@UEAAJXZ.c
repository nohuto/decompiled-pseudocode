 ...
 * Callers:
 *     ?CheckHandleStatus@SpatialGraphDriverClient@Holographic@Internal@Windows@@WBA@EAAJXZ @ 0x18003A610 (-CheckHandleStatus@SpatialGraphDriverClient@Holographic@Internal@Windows@@WBA@EAAJXZ.c)
 * Callees:
