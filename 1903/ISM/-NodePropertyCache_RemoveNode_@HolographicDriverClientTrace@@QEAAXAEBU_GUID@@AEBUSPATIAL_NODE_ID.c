/*
 * XREFs of ?NodePropertyCache_RemoveNode_@HolographicDriverClientTrace@@QEAAXAEBU_GUID@@AEBUSPATIAL_NODE_ID@@@Z @ 0x180159D4C
 * Callers:
        ...
        const struct SPATIAL_NODE_ID *a3)
{
  ...
  if ( *(_DWORD *)v5 > 4u )
  {
    if ( TlgKeywordOn(v5, 2uLL) )
    {
      ...
      v9 = a2;
      v12 = a3;
      TlgWrite(v7, &unk_1801A39C3, 0LL, 0LL, 4u, &pData);
    }
  }
}
