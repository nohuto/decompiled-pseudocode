/*
 * XREFs of ?Initialize@ControllerProcessor@@IEAAJXZ @ 0x18007615C
 * Callers:
 ...
 *     ?RefreshCursorSpeedRegistrySettings@ControllerProcessor@@AEAAXXZ @ 0x180076F10 (-RefreshCursorSpeedRegistrySettings@ControllerProcessor@@AEAAXXZ.c)
