/*
 * XREFs of ?add_ServerConnectionChanged@MPCManagerClient@@UEAAJPEAU?$ITypedEventHandler@PEAVMPCManagerClient@MPCManager@Input@Internal@Windows@@PEAVServerConnectionArgs@2345@@Foundation@Windows@@PEAUEventRegistrationToken@@@Z @ 0x180114F00
 * Callers:
 *     <none>
 * Callees:
 ...
 *     ?Release@?$RuntimeClassImpl@U?$RuntimeClassFlags@$00@WRL@Microsoft@@$00$00$0A@UIServerConnectionArgs@MPCManager@Input@Internal@Windows@@VFtmBase@23@@Details@WRL@Microsoft@@UEAAKXZ @ 0x180113950 (-Release@-$RuntimeClassImpl@U-$RuntimeClassFlags@$00@WRL@Microsoft@@$00$00$0A@UISer_ea_180113950.c)
 */
...
__int64 __fastcall MPCManagerClient::add_ServerConnectionChanged(__int64 a1, struct IUnknown *a2, struct IUnknown **a3)
{
  ...
  volatile signed __int64 *v11; // [rsp+38h] [rbp+10h] BYREF
  ...
  if ( a2 )
  {
    ...
    if ( v5 >= 0 )
    {
      v10 = *(_QWORD *)(*(_QWORD *)(a1 + 1616) + 152LL) != 0LL;
      ...
      v7 = ((__int64 (__fastcall *)(struct IUnknown *, __int64, volatile signed __int64 *))a2->lpVtbl[1].QueryInterface)(
             a2,
             (a1 - 8) & -(__int64)(a1 != 32),
             v11);
      if ( v7 < 0 )
