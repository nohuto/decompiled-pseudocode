/*
 * XREFs of ?Create@WGIRawInputProvider@@SAJPEAUIRawInputClient@@KPEAPEAUIRawInputProvider@@@Z @ 0x180026CC0
 * Callers:
 *     <none>
 * Callees:
 ...
 *     ??0WGIRawInputProvider@@AEAA@PEAUIRawInputClient@@@Z @ 0x180027290 (--0WGIRawInputProvider@@AEAA@PEAUIRawInputClient@@@Z.c)
