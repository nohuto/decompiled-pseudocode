/*
 * XREFs of ?ReportUsageToService@?$Feature@U__WilFeatureTraits_Feature_OnlyShowCursorInOverlayIfHittingShellContent@@@wil@@CAX_NW4ReportingKind@2@_K@Z @ 0x18008376C
 * Callers:
...
void __fastcall wil::Feature<__WilFeatureTraits_Feature_OnlyShowCursorInOverlayIfHittingShellContent>::ReportUsageToService(
        __int64 a1,
        __int64 a2,
        __int64 a3)
{
  ...
  if ( (`wil::Feature<__WilFeatureTraits_Feature_OnlyShowCursorInOverlayIfHittingShellContent>::GetFeaturePropertyCache'::`2'::data & 0x30) == 0 )
    wil::Feature<__WilFeatureTraits_Feature_OnlyShowCursorInOverlayIfHittingShellContent>::GetCachedFeatureEnabledState(a1);
  LOBYTE(v3) = 3;
  v4 = 0;
  v5 = v3;
