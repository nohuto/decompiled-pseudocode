/*
 * XREFs of ??1?$unordered_map@W4TestCommandMessageType@@U?$pair@PEAXP6A_NPEAXPEAUTestCommandMessageDataHeader@@@Z@std@@U?$hash@W4TestCommandMessageType@@@3@U?$equal_to@W4TestCommandMessageType@@@3@V?$allocator@U?$pair@$$CBW4TestCommandMessageType@@U?$pair@PEAXP6A_NPEAXPEAUTestCommandMessageDataHeader@@@Z@std@@@std@@@3@@std@@QEAA@XZ @ 0x1800D36A0
 * Callers:
 *     _TestCommandHost::TestCommandHost_::_1_::dtor$2 @ 0x18003AEB4 (_TestCommandHost--TestCommandHost_--_1_--dtor$2.c)
 *     _DWMCursorBroker::DWMCursorBroker_::_1_::dtor$2 @ 0x18003BB23 (_DWMCursorBroker--DWMCursorBroker_--_1_--dtor$2.c)
 * Callees:
