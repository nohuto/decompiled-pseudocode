/*
 * XREFs of _lambda_f2d9a31b738d46358cc103eee0272db8_::operator() @ 0x1801525D0
 * Callers:
 ...
 *     ??$AreValidFloats@UXMFLOAT3@DirectX@@@@YA_NAEBUXMFLOAT3@DirectX@@@Z @ 0x180149D64 (--$AreValidFloats@UXMFLOAT3@DirectX@@@@YA_NAEBUXMFLOAT3@DirectX@@@Z.c)
...
void __fastcall lambda_f2d9a31b738d46358cc103eee0272db8_::operator()(__int64 **a1)
{
  ...
  if ( v8 && !v7 )
  {
    *(_QWORD *)v4 = qword_1801E1400;
    *(_DWORD *)(v4 + 8) = dword_1801E1408;
...
LABEL_16:
  if ( (*(_BYTE *)(v19 + 16) & 2) == 0 )
  {
    *(_OWORD *)(v12 + 36) = xmmword_180198FD8;
    *(_OWORD *)(v12 + 52) = xmmword_180198FE8;
  ...
  do
  {
    ...
    {
      *(_QWORD *)v26 = qword_1801E1400;
      *((_DWORD *)v26 + 2) = dword_1801E1408;
  ...
  if ( ((*v3)[13] & 0x10) == 0 )
  {
    ...
    if ( (*(_BYTE *)(v35 + 16) & 2) != 0 )
    {
      ...
      *(double *)v39.m128_u64 = DirectX::XMMatrixRTInverse();
      v41 = _mm_movelh_ps((__m128)(unsigned __int64)qword_1801E0400, (__m128)(unsigned int)dword_1801E0408);
      v42 = _mm_add_ps(
              _mm_add_ps(
