/*
 * XREFs of ?NotifyDeviceAttach@ConsumerControlNexusDevice@@AEAAJPEAUIRawInputProvider@@@Z @ 0x1800B045C
 * Callers:
        ...
        struct IRawInputProvider *a2)
{
  ...
  v4 = operator new(0x620uLL, (const struct std::nothrow_t *)&std::nothrow);
  v5 = v4;
  if ( v4 )
  {
...
LABEL_6:
  ...
  *(_DWORD *)(*((_QWORD *)this + 16) + 8LL) = 1568;
  ...
  v9[2] = *((_QWORD *)this + 16);
  v10 = (*(__int64 (__fastcall **)(_QWORD, __int64 (__fastcall *)(WGIController::DeviceRemovalEventArgs *), __int64 *, __int64))(**((_QWORD **)this + 15) + 136LL))(
          *((_QWORD *)this + 15),
  ...
  else
  {
    ...
    WGIController::DeviceRemovalEventArgs::`scalar deleting destructor'((WGIController::DeviceRemovalEventArgs *)v9);
    return v11;
  }
}
