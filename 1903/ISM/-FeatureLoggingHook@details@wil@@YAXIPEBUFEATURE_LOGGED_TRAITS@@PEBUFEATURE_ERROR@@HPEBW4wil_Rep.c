/*
 * XREFs of ?FeatureLoggingHook@details@wil@@YAXIPEBUFEATURE_LOGGED_TRAITS@@PEBUFEATURE_ERROR@@HPEBW4wil_ReportingKind@@PEBW4wil_VariantReportingKind@@E_K@Z @ 0x180028310
 * Callers:
 *     <none>
 * Callees:
    ...
    if ( a5 )
    {
      ...
      if ( **(_DWORD **)(v13 + 8) > 5u && TlgKeywordOn(*(TraceLoggingHProvider *)(v13 + 8), 2uLL) )
      {
        ...
        *(_QWORD *)&pDesc.Size = 4LL;
        v56 = 8LL;
        TlgWrite(v16, &unk_18019A28C, 0LL, 0LL, 9u, &pData);
      }
      if ( *((_BYTE *)a2 + 4) == 1 )
      {
        if ( v9 )
        {
          ...
          if ( *(_DWORD *)v20 > 5u )
          {
            if ( TlgKeywordOn(v20, 0xAuLL) )
            {
              ...
              *(_QWORD *)&pDesc.Size = 4LL;
              v56 = 8LL;
              TlgWrite(v21, &unk_18019A5DB, 0LL, 0LL, 9u, &pData);
            }
          }
        }
      }
      ...
      if ( a6 )
      {
        ...
        if ( *(_DWORD *)v23 > 5u && TlgKeywordOn(v23, 4uLL) )
        {
          ...
          *(_QWORD *)&pDesc.Size = 4LL;
          v56 = 1LL;
          *(_QWORD *)&v57.Size = 8LL;
          TlgWrite(v25, &unk_18019A553, 0LL, 0LL, 0xAu, &pData);
        }
      }
      else if ( a3 )
      {
        ...
        if ( **(_DWORD **)(v29 + 8) > 2u )
        {
          if ( TlgKeywordOn(*(TraceLoggingHProvider *)(v29 + 8), 1uLL) )
          {
            ...
            v70 = 4LL;
            v69 = (char *)a3 + 80;
            TlgWrite(v37, &unk_18019A2FD, 0LL, 0LL, 0x14u, &pData);
          }
        }
      }
    }
