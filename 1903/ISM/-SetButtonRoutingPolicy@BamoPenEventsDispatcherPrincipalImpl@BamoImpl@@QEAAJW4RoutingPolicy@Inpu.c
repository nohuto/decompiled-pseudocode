/*
 * XREFs of ?SetButtonRoutingPolicy@BamoPenEventsDispatcherPrincipalImpl@BamoImpl@@QEAAJW4RoutingPolicy@Input@Devices@Internal@Windows@@@Z @ 0x180032E10
 * Callers:
 *     ?Thunk_SetButtonRoutingPolicy_3@?$IPenEventsDispatcherPrincipal_Receive@VBamoPenEventsDispatcherPrincipalImpl@BamoImpl@@@@SAJPEAXPEAPEAX@Z @ 0x180033650 (-Thunk_SetButtonRoutingPolicy_3@-$IPenEventsDispatcherPrincipal_Receive@VBamoPenEventsDispatcher.c)
 * Callees:
