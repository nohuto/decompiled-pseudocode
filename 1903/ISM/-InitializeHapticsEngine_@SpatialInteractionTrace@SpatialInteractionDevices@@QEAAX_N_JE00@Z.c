/*
 * XREFs of ?InitializeHapticsEngine_@SpatialInteractionTrace@SpatialInteractionDevices@@QEAAX_N_JE00@Z @ 0x180166268
 * Callers:
        ...
        bool a6)
{
  ...
  if ( *(_DWORD *)v6 > 4u )
  {
    if ( TlgKeywordOn(v6, 2uLL) )
    {
      ...
      v16 = 1LL;
      v18 = 1LL;
      TlgWrite(v7, &unk_1801A4809, 0LL, 0LL, 7u, &pData);
    }
  }
}
