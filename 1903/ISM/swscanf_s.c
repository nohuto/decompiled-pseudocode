/*
 * XREFs of swscanf_s @ 0x18002CBCC
 * Callers:
 ...
 * Callees:
 *     __local_stdio_scanf_options @ 0x18002B6B4 (__local_stdio_scanf_options.c)
 *     _o___stdio_common_vswscanf_0 @ 0x18002C45A (_o___stdio_common_vswscanf_0.c)
 */
