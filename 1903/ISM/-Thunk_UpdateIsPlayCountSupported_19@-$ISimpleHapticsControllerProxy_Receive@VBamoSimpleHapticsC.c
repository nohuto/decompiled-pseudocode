/*
 * XREFs of ?Thunk_UpdateIsPlayCountSupported_19@?$ISimpleHapticsControllerProxy_Receive@VBamoSimpleHapticsControllerProxyImpl@BamoImpl@@@@SAJPEAXPEAPEAX@Z @ 0x1800637F0
 * Callers:
 *     <none>
 * Callees:
