/*
 * XREFs of ?Thunk_UpdateStartPosition_9@?$IControllerNavigationClientProxy_Receive@VBamoControllerNavigationClientProxyImpl@BamoImpl@@@@SAJPEAXPEAPEAX@Z @ 0x1800719C0
 * Callers:
 *     <none>
 * Callees:
