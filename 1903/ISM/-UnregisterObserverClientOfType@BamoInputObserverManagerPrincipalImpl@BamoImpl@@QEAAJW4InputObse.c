/*
 * XREFs of ?UnregisterObserverClientOfType@BamoInputObserverManagerPrincipalImpl@BamoImpl@@QEAAJW4InputObserverType@InputObservation@@I@Z @ 0x180067C78
 * Callers:
 *     ?Thunk_UnregisterObserverClientOfType_137@?$IInputObserverManagerPrincipal_Receive@VBamoInputObserverManagerPrincipalImpl@BamoImpl@@@@SAJPEAXPEAPEAX@Z @ 0x180067C40 (-Thunk_UnregisterObserverClientOfType_137@-$IInputObserverManagerPrincipal_Receive@VBamoInputObs.c)
 * Callees:
