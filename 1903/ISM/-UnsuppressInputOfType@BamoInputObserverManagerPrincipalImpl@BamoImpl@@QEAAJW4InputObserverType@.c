/*
 * XREFs of ?UnsuppressInputOfType@BamoInputObserverManagerPrincipalImpl@BamoImpl@@QEAAJW4InputObserverType@InputObservation@@I@Z @ 0x180067DD0
 * Callers:
 *     ?Thunk_UnsuppressInputOfType_137@?$IInputObserverManagerPrincipal_Receive@VBamoInputObserverManagerPrincipalImpl@BamoImpl@@@@SAJPEAXPEAPEAX@Z @ 0x180067C60 (-Thunk_UnsuppressInputOfType_137@-$IInputObserverManagerPrincipal_Receive@VBamoInputObserverMana.c)
 * Callees:
