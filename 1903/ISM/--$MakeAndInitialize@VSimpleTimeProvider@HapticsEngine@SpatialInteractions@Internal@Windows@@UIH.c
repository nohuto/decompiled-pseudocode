/*
 * XREFs of ??$MakeAndInitialize@VSimpleTimeProvider@HapticsEngine@SpatialInteractions@Internal@Windows@@UIHapticsTimerProvider@345@$$V@Details@WRL@Microsoft@@YAJPEAPEAUIHapticsTimerProvider@SpatialInteractions@Internal@Windows@@@Z @ 0x180162150
 * Callers:
 ...
 *     ??0SimpleTimeProvider@HapticsEngine@SpatialInteractions@Internal@Windows@@QEAA@XZ @ 0x180162C7C (--0SimpleTimeProvider@HapticsEngine@SpatialInteractions@Internal@Windows@@QEAA@XZ.c)
