/*
 * XREFs of ?QueryInterface@BamoSimpleHapticsControllerProxy@@UEAAJAEBU_GUID@@PEAPEAX@Z @ 0x1800617C0
 * Callers:
 *     ?QueryInterface@BamoSimpleHapticsControllerProxy@@W7EAAJAEBU_GUID@@PEAPEAX@Z @ 0x180038300 (-QueryInterface@BamoSimpleHapticsControllerProxy@@W7EAAJAEBU_GUID@@PEAPEAX@Z.c)
 * Callees:
