/*
 * XREFs of ?UpdatePenEventsDispatcher@BamoInputSystemProxyImpl@BamoImpl@@QEAAJI@Z @ 0x18002ED84
 * Callers:
 *     ?Thunk_UpdatePenEventsDispatcher_0@?$IInputSystemProxy_Receive@VBamoInputSystemProxyImpl@BamoImpl@@@@SAJPEAXPEAPEAX@Z @ 0x18002ED40 (-Thunk_UpdatePenEventsDispatcher_0@-$IInputSystemProxy_Receive@VBamoInputSystemProxyImpl@BamoImp.c)
 * Callees:
