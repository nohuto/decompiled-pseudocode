/*
 * XREFs of ?Create@GazeProcessor@@SAJPEAUInputProcessorCreateParams@@PEAPEAUIInputProcessor@@@Z @ 0x1801255E0
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall GazeProcessor::Create(struct DeviceInfo **a1, struct IInputProcessor **a2)
{
  ...
  v4 = (GazeProcessor *)RefCountedObject::operator new(0xF0uLL);
  if ( v4 )
