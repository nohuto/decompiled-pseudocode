/*
 * XREFs of ?NodePropertyCallbackCleanedUp_@HolographicDriverClientTrace@@QEAAXAEBU_GUID@@AEBUSPATIAL_NODE_ID@@@Z @ 0x180159ED0
 * Callers:
        ...
        const struct SPATIAL_NODE_ID *a3)
{
  ...
  if ( *(_DWORD *)v5 > 4u )
  {
    if ( TlgKeywordOn(v5, 2uLL) )
    {
      ...
      v9 = a2;
      v12 = a3;
      TlgWrite(v7, &unk_1801A2B2A, 0LL, 0LL, 4u, &pData);
    }
  }
}
