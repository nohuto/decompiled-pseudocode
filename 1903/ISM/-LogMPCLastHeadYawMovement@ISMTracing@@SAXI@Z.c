/*
 * XREFs of ?LogMPCLastHeadYawMovement@ISMTracing@@SAXI@Z @ 0x180096DC0
 * Callers:
 *     ?OnTimerCallback@MPCHeadMovementDetector@@AEAAXXZ @ 0x180096E84 (-OnTimerCallback@MPCHeadMovementDetector@@AEAAXXZ.c)
 * Callees:
...
void __fastcall ISMTracing::LogMPCLastHeadYawMovement(__int64 a1)
{
  ...
  if ( *(_DWORD *)v1 > 4u )
  {
    if ( TlgKeywordOn(v1, 0x400000000001uLL) )
    {
      ...
      v7 = 8;
      v10 = cData;
      TlgWrite(v2, &unk_18019C539, 0LL, 0LL, cData, &pData);
    }
  }
}
