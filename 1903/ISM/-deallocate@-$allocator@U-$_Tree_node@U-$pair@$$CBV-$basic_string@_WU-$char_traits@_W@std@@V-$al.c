...
void __fastcall std::allocator<std::_Tree_node<std::pair<std::wstring const,Windows::Internal::Holographic::HolographicDisplaySnapshot>,void *>>::deallocate(
        ...
        void *a2)
{
  std::_Deallocate<16,0>(a2, (const struct std::nothrow_t *)0x488);
}
