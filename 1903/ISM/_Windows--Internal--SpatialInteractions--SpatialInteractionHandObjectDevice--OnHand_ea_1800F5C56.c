/*
 * XREFs of _Windows::Internal::SpatialInteractions::SpatialInteractionHandObjectDevice::OnHandSpatialObjectRemoved_::_1_::catch$62 @ 0x1800F5C56
 * Callers:
 *     <none>
 * Callees:
