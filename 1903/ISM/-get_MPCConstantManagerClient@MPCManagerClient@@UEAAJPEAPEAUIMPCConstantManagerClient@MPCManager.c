/*
 * XREFs of ?get_MPCConstantManagerClient@MPCManagerClient@@UEAAJPEAPEAUIMPCConstantManagerClient@MPCManager@Input@Internal@Windows@@@Z @ 0x180115040
 * Callers:
 *     <none>
 * Callees:
        ...
        struct Windows::Internal::Input::MPCManager::IMPCConstantManagerClient **a2)
{
  ...
  if ( !*((_QWORD *)this + 219) )
  {
    v19 = (struct MPCManagerClientConnection *)*((_QWORD *)this + 203);
    ...
    v7 = (volatile signed __int64 *)*((_QWORD *)this + 219);
    *((_QWORD *)this + 219) = v6;
    if ( v7 )
    ...
    v8 = (volatile signed __int64 *)v18;
    if ( v18 )
    {
      v18 = 0LL;
