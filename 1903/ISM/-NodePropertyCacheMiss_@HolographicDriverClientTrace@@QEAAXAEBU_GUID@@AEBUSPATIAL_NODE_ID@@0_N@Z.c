/*
 * XREFs of ?NodePropertyCacheMiss_@HolographicDriverClientTrace@@QEAAXAEBU_GUID@@AEBUSPATIAL_NODE_ID@@0_N@Z @ 0x180159C6C
 * Callers:
        ...
        bool a5)
{
  ...
  if ( *(_DWORD *)v8 > 4u )
  {
    if ( TlgKeywordOn(v8, 2uLL) )
    {
      ...
      v17 = 16LL;
      v19 = 4LL;
      TlgWrite(v9, &unk_1801A2B70, 0LL, 0LL, 6u, &pData);
    }
  }
}
