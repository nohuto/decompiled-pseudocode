/*
 * XREFs of ?Thunk_UpdateSourceType_45@?$IDragManagerClientProxy_Receive@VBamoDragManagerClientProxyImpl@BamoImpl@@@@SAJPEAXPEAPEAX@Z @ 0x180063A90
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall IDragManagerClientProxy_Receive<BamoImpl::BamoDragManagerClientProxyImpl>::Thunk_UpdateSourceType_45(
        __int64 a1,
        _OWORD **a2)
{
  int v3; // eax
