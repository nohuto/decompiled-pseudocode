/*
 * XREFs of ?ControllerHapticsStatistics_@SpatialInteractionTrace@SpatialInteractionDevices@@QEAAXKJJN@Z @ 0x180164B84
 * Callers:
        ...
        double a5)
{
  ...
  if ( *(_DWORD *)v5 > 4u )
  {
    if ( TlgKeywordOn(v5, 0x400000000000uLL) )
    {
      ...
      v14 = v7;
      v16 = 8LL;
      TlgWrite(v6, &unk_1801A4946, 0LL, 0LL, 6u, &pData);
    }
  }
}
