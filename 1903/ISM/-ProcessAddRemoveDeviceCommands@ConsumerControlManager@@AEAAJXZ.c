/*
 * XREFs of ?ProcessAddRemoveDeviceCommands@ConsumerControlManager@@AEAAJXZ @ 0x1800AD360
 * Callers:
...
LABEL_44:
      ...
      if ( (int)ConsumerControlGenericDevice::CreateAndInitialize(v3[4], v19 + 2) >= 0 )
      {
        v20 = 0LL;
