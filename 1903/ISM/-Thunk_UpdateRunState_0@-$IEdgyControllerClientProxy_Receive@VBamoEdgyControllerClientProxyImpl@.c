/*
 * XREFs of ?Thunk_UpdateRunState_0@?$IEdgyControllerClientProxy_Receive@VBamoEdgyControllerClientProxyImpl@BamoImpl@@@@SAJPEAXPEAPEAX@Z @ 0x18006F260
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall IEdgyControllerClientProxy_Receive<BamoImpl::BamoEdgyControllerClientProxyImpl>::Thunk_UpdateRunState_0(
        __int64 a1,
        _DWORD **a2)
{
  int v3; // eax
  ...
  *(_DWORD *)(a1 + 64) = **a2;
  if ( *(_BYTE *)(a1 + 28) )
  {
    ...
    v3 = (*(__int64 (__fastcall **)(__int64))(*(_QWORD *)(a1 - 16) + 96LL))(a1 - 16);
    if ( v3 < 0 )
