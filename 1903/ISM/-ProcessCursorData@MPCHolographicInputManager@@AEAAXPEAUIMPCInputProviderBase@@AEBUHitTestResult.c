/*
 * XREFs of ?ProcessCursorData@MPCHolographicInputManager@@AEAAXPEAUIMPCInputProviderBase@@AEBUHitTestResult3D@@W4MPCCursorId@@AEAUCursor3DHitData@@@Z @ 0x180083240
 * Callers:
 ...
 *     ?ReportUsageToService@?$Feature@U__WilFeatureTraits_Feature_OnlyShowCursorInOverlayIfHittingShellContent@@@wil@@CAX_NW4ReportingKind@2@_K@Z @ 0x18008376C (-ReportUsageToService@-$Feature@U__WilFeatureTraits_Feature_OnlyShowCursorInOverlayIfHittingShel.c)
