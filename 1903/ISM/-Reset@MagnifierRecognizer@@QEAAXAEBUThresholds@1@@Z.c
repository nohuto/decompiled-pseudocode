/*
 * XREFs of ?Reset@MagnifierRecognizer@@QEAAXAEBUThresholds@1@@Z @ 0x180106810
 * Callers:
 ...
 *     ??0GestureState@MagnifierRecognizer@@QEAA@XZ @ 0x1801050D4 (--0GestureState@MagnifierRecognizer@@QEAA@XZ.c)
 *     ?clear@?$_Tree@V?$_Tmap_traits@KUContactState@MagnifierRecognizer@@U?$less@K@std@@V?$allocator@U?$pair@$$CBKUContactState@MagnifierRecognizer@@@std@@@4@$0A@@std@@@std@@QEAAXXZ @ 0x180105AF0 (-clear@-$_Tree@V-$_Tmap_traits@KUContactState@MagnifierRecognizer@@U-$less@K@std@@V-$allocator@U.c)
 */
