  ...
  if ( (v18 & 1) != 0 )
  {
    ...
    if ( (_DWORD)v3 )
    {
      ...
      do
      {
        if ( *v25 )
        {
          MiPfCompletePrefetchIos((_QWORD **)(*v25 + 120LL), 0LL, 0LL);
