/*
 * XREFs of MiPrefetchVirtualMemory @ 0x1400F5100
 * Callers:
...
LABEL_13:
          v16 = *(ULONG_PTR **)(qword_140466188 + 8 * v15);
LABEL_14:
          if ( (v50 & 0x80u) == 0 )
          {
            v17 = v16[1008];
