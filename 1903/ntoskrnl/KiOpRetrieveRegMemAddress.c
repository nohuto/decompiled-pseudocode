/*
 * XREFs of KiOpRetrieveRegMemAddress @ 0x14019C008
 * Callers:
 *     KiOp_Div @ 0x14019BF10 (KiOp_Div.c)
 *     KiOp_SGDTSIDT @ 0x1402B3C00 (KiOp_SGDTSIDT.c)
 *     KiOp_SLDTSTRSMSW @ 0x1402B3DC0 (KiOp_SLDTSTRSMSW.c)
 * Callees:
 *     KiOpComputeLinearAddress @ 0x1402B376C (KiOpComputeLinearAddress.c)
 */
