/*
 * XREFs of MiInitializeLoadedModuleList @ 0x140A13DBC
 * Callers:
...
__int64 __fastcall MiInitializeLoadedModuleList(__int64 a1)
{
  ...
  qword_1404648C8 = (__int64)&qword_1404648C0;
  qword_1404648C0 = (__int64)&qword_1404648C0;
  ...
  *(&PsLoadedModuleList + 1) = &PsLoadedModuleList;
  ...
  qword_14042ED08 = (__int64)&ExpCovUnloadedModuleList;
