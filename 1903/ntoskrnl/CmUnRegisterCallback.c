/*
 * XREFs of CmUnRegisterCallback @ 0x140825B50
 * Callers:
  ...
  while ( 1 )
  {
    ...
    if ( *((_QWORD *)NextElement + 3) == Cookie.QuadPart )
    {
      ...
      if ( (v6 & 0x80000000) == 0 )
      {
        ...
        while ( 1 )
        {
          LODWORD(v39) = *((_DWORD *)v5 + 4);
          if ( (_DWORD)v39 == 0x80000000 )
            break;
          ExBlockOnAddressPushLock((__int64)&CallbackListDeleteEvent, (_QWORD *)v5 + 2, &v39, 4uLL, 0LL);
        }
  ...
  *(_QWORD *)&v35 = &v35;
  ...
  while ( 1 )
  {
    ...
    if ( ObReferenceObjectSafe(v15[4]) )
    {
      v19 = v18[2];
      v20 = (_QWORD *)v18[3];
      if ( *(_QWORD **)(v19 + 8) != v18 + 2 || (_QWORD *)*v20 != v18 + 2 )
        __fastfail(3u);
      *v20 = v19;
      *(_QWORD *)(v19 + 8) = v20;
      v21 = *v18;
      v22 = (_QWORD *)v18[1];
      if ( *(_QWORD **)(*v18 + 8LL) != v18 || (_QWORD *)*v22 != v18 )
        __fastfail(3u);
      *v22 = v21;
      *(_QWORD *)(v21 + 8) = v22;
  ...
  while ( 1 )
  {
    ...
    *(_QWORD *)(v25 + 8) = &v35;
    v26 = (PVOID *)(v24 - 16);
    v34[2] = (_QWORD *)(v24 - 16);
    v36 = *(_QWORD *)(v24 - 16 + 48);
    v37 = *(_QWORD *)(v24 - 16 + 56);
    (*((void (__fastcall **)(_QWORD, __int64, __int64 *))v5 + 5))(*((_QWORD *)v5 + 4), 40LL, &v36);
