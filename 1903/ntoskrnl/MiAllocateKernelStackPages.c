/*
 * XREFs of MiAllocateKernelStackPages @ 0x14002CA20
 * Callers:
...
LABEL_4:
    ...
    *(_QWORD *)v13 = v9;
    ...
    if ( !--v6 )
    {
      ...
      v51 = MiLockWorkingSetShared(&unk_140466F80);
      while ( 1 )
      {
        v15 = *(_QWORD *)v13;
        ...
        MiLockPageTableInternal(&unk_140466F80, v46, 0LL, v16);
LABEL_8:
...
LABEL_22:
        ...
        if ( v7 >= v48 )
        {
          if ( v46 )
            MiUnlockPageTableInternal(&unk_140466F80);
          MiUnlockWorkingSetShared(&unk_140466F80, v51);
          return 1LL;
        }
      }
    }
