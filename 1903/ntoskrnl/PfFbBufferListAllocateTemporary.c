/*
 * XREFs of PfFbBufferListAllocateTemporary @ 0x140098AC4
 * Callers:
 *     PfpEventHandleOutOfBuffers @ 0x140098AA0 (PfpEventHandleOutOfBuffers.c)
 *     PfpSectInfoHandleOutOfBuffers @ 0x140747710 (PfpSectInfoHandleOutOfBuffers.c)
 * Callees:
