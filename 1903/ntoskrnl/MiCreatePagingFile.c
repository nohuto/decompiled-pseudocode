/*
 * XREFs of MiCreatePagingFile @ 0x140770618
 * Callers:
 *     NtManagePartition @ 0x14066CA40 (NtManagePartition.c)
 *     NtCreatePagingFile @ 0x1407705E0 (NtCreatePagingFile.c)
 * Callees:
                            ...
                            if ( Pagefile )
                            {
                              ...
                              else
                              {
                                if ( (ULONG_PTR *)a6 == &MiSystemPartition )
                                {
                                  ...
                                  if ( !byte_140466200 && (*(_BYTE *)(v28 + 204) & 0x10) == 0 )
                                  {
                                    *(_OWORD *)&v59[104] = *(_OWORD *)(v28 + 96);
                                    byte_140466200 = IoInitializeCrashDump(FileHandle);
                                  }
                                }
                                return 0LL;
                              }
