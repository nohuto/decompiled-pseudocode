/*
 * XREFs of CmSelectQualifiedInstallLanguage @ 0x140A13344
 * Callers:
...
__int64 __fastcall CmSelectQualifiedInstallLanguage(__int64 a1, unsigned int a2, _DWORD *a3, int a4)
{
  ...
  _DWORD *v42; // [rsp+88h] [rbp-78h]
  UNICODE_STRING DestinationString; // [rsp+90h] [rbp-70h] BYREF
  wchar_t Str2[88]; // [rsp+A0h] [rbp-60h] BYREF
  _BYTE v45[176]; // [rsp+150h] [rbp+50h] BYREF
  ...
  *(_QWORD *)&DestinationString.Length = 0LL;
  ...
  if ( a3 )
  {
    *a3 = 0;
    ...
    if ( v11 != -1 )
    {
      v12 = ((__int64 (__fastcall *)(ULONG_PTR *, _QWORD, _DWORD *))qword_140A53FF8)(&CmControlHive, v11, v39);
      if ( v12 )
      {
        ...
        if ( ValueByName != -1 )
        {
          v26 = ((__int64 (__fastcall *)(ULONG_PTR *, _QWORD, _DWORD *))qword_140A53FF8)(
                  &CmControlHive,
                  ValueByName,
                  v36);
          if ( v26 )
          {
            if ( *(_DWORD *)(v26 + 12) == 7 )
            {
              v27 = CmpValueToData((ULONG_PTR)&CmControlHive, ValueByName, v26, &Size, (__int64)&v38);
              if ( v27 )
              {
                if ( Size < 0xA8 )
                {
                ...
                ((void (__fastcall *)(ULONG_PTR *, __int64 *))qword_140A54000)(&CmControlHive, &v38);
              }
            }
            ((void (__fastcall *)(ULONG_PTR *, _DWORD *))qword_140A54000)(&CmControlHive, v36);
          }
        }
        ((void (__fastcall *)(ULONG_PTR *, _DWORD *))qword_140A54000)(&CmControlHive, v39);
      }
    }
    v14 = CmpWalkPath((__int64)&CmControlHive, a2, L"MUI\\UILanguages");
    if ( v14 == -1 )
      return v10;
    v15 = (_DWORD *)((__int64 (__fastcall *)(ULONG_PTR *, _QWORD, _DWORD *))qword_140A53FF8)(&CmControlHive, v14, v41);
    v31 = v15;
    if ( !v15 )
      return v10;
    v10 &= ~2u;
LABEL_12:
    ...
    while ( 1 )
    {
      CmpFindSubKeyByNumber((__int64)&CmControlHive, v15, v4++, &v37);
      v30 = v4;
      if ( v37 == -1 )
        break;
      v18 = ((__int64 (__fastcall *)(ULONG_PTR *, _QWORD, _DWORD *))qword_140A53FF8)(&CmControlHive, v37, v35);
      v15 = v31;
      if ( v18 )
      {
        ...
        if ( v19 == -1 )
          goto LABEL_58;
        v20 = ((__int64 (__fastcall *)(ULONG_PTR *, _QWORD, _DWORD *))qword_140A53FF8)(&CmControlHive, v19, v36);
        if ( !v20 )
          goto LABEL_58;
        if ( *(_DWORD *)(v20 + 12) == 4 )
        {
          v21 = *(_DWORD *)CmpValueToData((ULONG_PTR)&CmControlHive, v19, v20, &Size, (__int64)&v40);
          Size_4 = v21;
          if ( (v21 & 3) != 0 )
            v16 = (v21 & 0x10) != 0;
          ((void (__fastcall *)(ULONG_PTR *, __int64 *))qword_140A54000)(&CmControlHive, &v40);
        }
        ((void (__fastcall *)(ULONG_PTR *, _DWORD *))qword_140A54000)(&CmControlHive, v36);
        if ( !v16 )
          goto LABEL_58;
        ...
        if ( (*(_BYTE *)(v18 + 2) & 0x20) != 0 )
        {
          ...
          if ( v23 <= 0xA8 )
          {
            CmpCopyCompressedName((unsigned __int64)Str2, v23, v18 + 76, v22);
            goto LABEL_31;
          }
LABEL_58:
          ((void (__fastcall *)(ULONG_PTR *, _DWORD *))qword_140A54000)(&CmControlHive, v35);
          v15 = v31;
          v4 = v30;
          v8 = v28;
        }
...
LABEL_42:
    ...
    ((void (__fastcall *)(ULONG_PTR *, _DWORD *))qword_140A54000)(&CmControlHive, v41);
    if ( v8 || v9 )
      v10 &= ~4u;
    if ( v29 )
    {
