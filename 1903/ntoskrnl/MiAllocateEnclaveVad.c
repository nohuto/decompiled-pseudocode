/*
 * XREFs of MiAllocateEnclaveVad @ 0x14089304C
 * Callers:
...
__int64 __fastcall MiAllocateEnclaveVad(int a1, unsigned __int64 a2, unsigned __int64 a3, __int64 a4, __int64 *a5)
{
  ...
  {
    *(_DWORD *)(v13 + 64) |= 1u;
    v15 = MiReservePtes((__int64)&qword_1404669C0, (unsigned __int64 *)1);
    *(_QWORD *)(v13 + 80) = v15;
    if ( !v15 )
    {
...
LABEL_23:
        ...
        if ( (*(_DWORD *)(v13 + 64) & 1) != 0 )
        {
          ...
          MiReleasePtes((__int64)&qword_1404669C0, *(_QWORD *)(v13 + 80), 1u);
        }
        ExFreePoolWithTag((PVOID)v13, 0);
