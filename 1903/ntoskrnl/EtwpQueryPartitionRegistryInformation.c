/*
 * XREFs of EtwpQueryPartitionRegistryInformation @ 0x14018F580
 * Callers:
 *     EtwpContainerResumeWnfCallback @ 0x140330900 (EtwpContainerResumeWnfCallback.c)
 *     EtwInitializeSiloState @ 0x14076CFF8 (EtwInitializeSiloState.c)
 * Callees:
 *     RtlInitUnicodeString @ 0x1400438D0 (RtlInitUnicodeString.c)
 *     StringToGuidNoBrackets @ 0x14018F82C (StringToGuidNoBrackets.c)
