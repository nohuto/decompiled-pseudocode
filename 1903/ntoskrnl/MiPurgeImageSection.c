/*
 * XREFs of MiPurgeImageSection @ 0x14015C138
 * Callers:
...
char __fastcall MiPurgeImageSection(__int64 a1)
{
  ...
  v1 = a1 + 128;
  LOBYTE(CurrentThread) = qword_140466188;
  v3 = *(_WORD *)(a1 + 60) & 0x3FF;
  v4 = 0LL;
  v35 = 17;
  v5 = a1;
  v28 = 0LL;
  v6 = *(_QWORD *)(qword_140466188 + 8 * v3);
  v29 = v6;
  while ( 1 )
  {
    v30 = v1;
    ...
    if ( v12 < CurrentThread )
    {
      while ( 1 )
      {
        ...
        v13 = MiLockLeafPage((unsigned __int64 *)v12, 0);
...
LABEL_50:
        ...
        else if ( (CurrentThread & 0x400) == 0 )
        {
          ...
          {
            MiReleasePageFileSpace(v6, v15, 1);
...
LABEL_69:
            ...
            *(_QWORD *)v12 = v23;
            if ( v24 )
              LOBYTE(CurrentThread) = MiWritePteShadow(v12);
          }
        }
LABEL_17:
        v12 += 8LL;
