/*
 * XREFs of AuthzBasepGetClaimAttributeValueCopyoutBufferSize @ 0x14092C748
 * Callers:
 *     AuthzBasepGetClaimAttributesCopyoutBufferSize @ 0x14092C8EC (AuthzBasepGetClaimAttributesCopyoutBufferSize.c)
 * Callees:
 *     <none>
 */
