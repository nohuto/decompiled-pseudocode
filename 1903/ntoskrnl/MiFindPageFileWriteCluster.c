/*
 * XREFs of MiFindPageFileWriteCluster @ 0x14014D6C0
 * Callers:
 ...
 *     RtlFindLongestRunClearCapped @ 0x14030CD80 (RtlFindLongestRunClearCapped.c)
...
_DWORD *__fastcall MiFindPageFileWriteCluster(__int64 a1, unsigned int *a2, _DWORD *a3, int a4)
{
  ...
  {
    v12 = v26;
    if ( qword_140465B00 && (v26 & 0x10) == 0 )
      v12 = v26 & ~qword_140465B00;
    v13 = HIDWORD(v12);
  }
  else
  {
