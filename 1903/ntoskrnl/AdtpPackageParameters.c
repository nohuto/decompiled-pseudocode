/*
 * XREFs of AdtpPackageParameters @ 0x140132AB8
 * Callers:
 ...
 *     AdtpIsCorrectlyFormedUnicodeString @ 0x14013308C (AdtpIsCorrectlyFormedUnicodeString.c)
 ...
 *     AdtpEtwBuildDashString @ 0x1406E0930 (AdtpEtwBuildDashString.c)
