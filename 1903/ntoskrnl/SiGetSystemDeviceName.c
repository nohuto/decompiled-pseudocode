/*
 * XREFs of SiGetSystemDeviceName @ 0x1406E1754
 * Callers:
 *     SyspartDirectGetSystemPartition @ 0x1406E1730 (SyspartDirectGetSystemPartition.c)
 *     SyspartDirectGetSystemDisk @ 0x14072C6C0 (SyspartDirectGetSystemDisk.c)
 *     SyspartGetFirmwarePartition @ 0x14073F724 (SyspartGetFirmwarePartition.c)
 *     SyspartDirectGetFirmwareSystemPartition @ 0x140747C00 (SyspartDirectGetFirmwareSystemPartition.c)
