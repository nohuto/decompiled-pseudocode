/*
 * XREFs of VslReportBugCheckProgress @ 0x140290470
 * Callers:
...
LABEL_11:
  ...
  if ( (a5 & 0x40) != 0 )
    ...
    result = VslpEnterIumSecureMode(2, 259LL, 0LL, (__int64)v17);
  if ( (_DWORD)v6 )
  {
    memmove(&v17[2], a3, v6);
    v16 = *a2;
    ...
    *(_QWORD *)&v17[3] = a5 | 6u;
    v17[1] = v16;
    *((_QWORD *)&v17[2] + 1) = v6;
    return VslpEnterIumSecureMode(2, 259LL, 0LL, (__int64)v17);
  }
  return result;
}
