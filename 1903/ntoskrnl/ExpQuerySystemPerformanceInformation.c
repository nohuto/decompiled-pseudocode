/*
 * XREFs of ExpQuerySystemPerformanceInformation @ 0x1406A5030
 * Callers:
 ...
 *     MmGetSharedCommit @ 0x1400F1AB8 (MmGetSharedCommit.c)
 *     MmGetResidentAvailablePages @ 0x1400F1AC8 (MmGetResidentAvailablePages.c)
 *     ExQueryPoolUsage @ 0x1400F1AE4 (ExQueryPoolUsage.c)
 *     MiMaximumCommitmentAvailable @ 0x1400F1C0C (MiMaximumCommitmentAvailable.c)
 *     MiFreePoolPagesLeft @ 0x1400F1C2C (MiFreePoolPagesLeft.c)
 *     MmGetSystemPageCounts @ 0x1400F1C5C (MmGetSystemPageCounts.c)
 *     MmGetNumberOfFreeSystemPtes @ 0x1400F1C70 (MmGetNumberOfFreeSystemPtes.c)
 *     MmGetPeakCommitment @ 0x1400F315C (MmGetPeakCommitment.c)
 *     MmGetTotalCommitLimit @ 0x1400F3178 (MmGetTotalCommitLimit.c)
 *     MmGetTotalCommittedPages @ 0x1400F3194 (MmGetTotalCommittedPages.c)
 *     MmGetAvailablePages @ 0x1400F31B0 (MmGetAvailablePages.c)
 *     MmGetProcessPartitionId @ 0x1400F31CC (MmGetProcessPartitionId.c)
