/*
 * XREFs of SmEtwEnabled @ 0x140106994
 * Callers:
 ...
 *     ?StDmEtwRegionRundown@?$ST_STORE@USM_TRAITS@@@@SAJPEAU_ST_DATA_MGR@1@@Z @ 0x140322500 (-StDmEtwRegionRundown@-$ST_STORE@USM_TRAITS@@@@SAJPEAU_ST_DATA_MGR@1@@Z.c)
...
ULONGLONG *__fastcall SmEtwEnabled(int a1)
{
  ...
  v2[2] = 64;
  v2[3] = 128;
  if ( (v2[a1] & dword_14058C4FC) != 0 )
    return &qword_14058C4F0;
  else
    return 0LL;
}
