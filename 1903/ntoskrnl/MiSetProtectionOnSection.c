/*
 * XREFs of MiSetProtectionOnSection @ 0x14004E5E0
 * Callers:
 ...
 *     MiImageVadHotPatchEligible @ 0x140603124 (MiImageVadHotPatchEligible.c)
 ...
 *     MiGetImageHotPatchTableAddress @ 0x14088E638 (MiGetImageHotPatchTableAddress.c)
 */
        ...
        __int64 a8)
{
  ...
  v200 = *(_QWORD *)(qword_140466188 + 8LL * *(unsigned __int16 *)(a1 + 1454));
  if ( v182 == 5 )
  {
  ...
  if ( v91 < 0 )
  {
    ...
    LODWORD(v145) = ((char)v142->AbEntrySummary | (char)v142->AbOrphanedEntrySummary) ^ 0x3F;
...
LABEL_265:
    ...
    else
    {
      ...
      if ( (__int64)v149->LockState.LockState < 0 )
        KiAbEntryRemoveFromTree(&v142->LockEntries[v148], v145);
    ...
    if ( v96 && ($6EAC78A6FCFADE0A5FA44F358736B38F *)v142->ApcState.ApcListHead[0].Flink != &v142->152 )
...
LABEL_66:
  ...
  if ( v195 == 1 )
  {
    ...
    LODWORD(v95) = ((char)v92->AbEntrySummary | (char)v92->AbOrphanedEntrySummary) ^ 0x3F;
...
LABEL_165:
    ...
    else
    {
      ...
      if ( (__int64)v100->LockState.LockState < 0 )
        KiAbEntryRemoveFromTree(&v92->LockEntries[v99], v95);
    ...
    if ( v96 && ($6EAC78A6FCFADE0A5FA44F358736B38F *)v92->ApcState.ApcListHead[0].Flink != &v92->152 )
      KiCheckForKernelApcDelivery();
    KiLeaveGuardedRegionUnsafe((__int64)v190);
  }
  v60 = v199;
