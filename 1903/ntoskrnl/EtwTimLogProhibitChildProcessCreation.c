/*
 * XREFs of EtwTimLogProhibitChildProcessCreation @ 0x1406F69AC
 * Callers:
...
void __fastcall EtwTimLogProhibitChildProcessCreation(int a1, __int64 a2, UNICODE_STRING *a3, UNICODE_STRING *a4)
{
  ...
  *(_QWORD *)&v48.Length = 0LL;
  ...
  if ( (_DWORD)v42 == 2 && stru_140426650.LevelPlus1 > 5 && TlgKeywordOn(&stru_140426650, 0x200000000001uLL) )
  {
    v72 = v37;
    v71 = v74;
    v73 = *((_QWORD *)v5 + 1);
    ...
    v84 = v37;
    v86[1] = v36;
    TlgWrite(&stru_140426650, &unk_14039422F, 0LL, 0LL, 0xAu, &v70);
  }
  if ( v5 && *v5 )
  {
    v38[0] = *v5 >> 1;
  ...
  *(&UserData.Reserved + 2 * v31) = 0;
  ...
  if ( stru_140426618.LevelPlus1 > 5 && TlgKeywordOn(&stru_140426618, 0x400000000000uLL) )
  {
    ...
    v67 = 2LL;
    v69[1] = 0;
    TlgWrite(&stru_140426618, &unk_140394197, 0LL, 0LL, 0xCu, &pData);
  }
  if ( v8 )
