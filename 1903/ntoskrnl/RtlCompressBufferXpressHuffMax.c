/*
 * XREFs of RtlCompressBufferXpressHuffMax @ 0x1403161C0
 * Callers:
 *     RtlCompressBufferProgress @ 0x14015EE60 (RtlCompressBufferProgress.c)
 *     RtlCompressBufferXpressHuff @ 0x140316100 (RtlCompressBufferXpressHuff.c)
 * Callees:
 ...
 *     XpressDoHuffmanPass @ 0x140319BF8 (XpressDoHuffmanPass.c)
 */
  ...
  if ( a4 >= 0x12C )
  {
    ...
    *((_QWORD *)a6 + 0x8000) = 0LL;
    ...
    while ( 1 )
    {
      ...
      do
      {
        v26 = (unsigned __int16)XpressHashFunction[*v24] ^ (unsigned __int16)word_14039E360[v24[2]] ^ (unsigned __int64)(unsigned __int16)word_14039E160[v24[1]];
        v27 = *(_QWORD *)&a6[8 * v26];
        *(_QWORD *)&a6[8 * v26] = v24++;
