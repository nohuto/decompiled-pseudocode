/*
 * XREFs of BiExportEfiBootManager @ 0x14093132C
 * Callers:
 ...
 *     BiTranslateDisplayOrder @ 0x1409323EC (BiTranslateDisplayOrder.c)
 *     BiTranslateObjectIdentifier @ 0x140932550 (BiTranslateObjectIdentifier.c)
 */
...
__int64 __fastcall BiExportEfiBootManager(__int64 a1, __int64 a2)
{
  ...
  *(_QWORD *)&Count[1] = 0LL;
  v27 = 0LL;
  v7 = BcdOpenObject(a1, &GUID_FIRMWARE_BOOTMGR.Data1, &v21);
  v8 = v7;
  if ( v7 < 0 )
  {
    v9 = 0LL;
  ...
  Element = BiGetElement(v21, 0x24000001u, &P, Count);
  v8 = Element;
  if ( Element < 0 )
  {
...
LABEL_24:
    ...
    v8 = BiHandleFirmwareDefaultEntry(v26, v21, &Buf1, Count);
    if ( v8 < 0 )
    {
      v9 = *(void **)&Count[1];
      goto LABEL_56;
...
LABEL_32:
        ...
        v15 = BiGetElement(v21, 0x25000004u, &v24, &v19);
        v5 = v24;
        v8 = v15;
        if ( v15 < 0 )
        {
        ...
        v17 = BiGetElement(v21, 0x24000002u, &v25, &v19);
        v3 = v25;
        v8 = v17;
        if ( v17 < 0 )
        {
