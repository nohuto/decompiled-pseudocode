/*
 * XREFs of CmpGetSystemControlValues @ 0x140A1378C
 * Callers:
 ...
 *     CmpConvertLangId @ 0x140A13D58 (CmpConvertLangId.c)
 */
...
__int64 __fastcall CmpGetSystemControlValues(_DWORD *a1, __int64 a2, char a3)
{
  ...
  *(_QWORD *)&DestinationString.Length = 0LL;
  ...
  if ( a3 == 1 )
  {
    result = ((__int64 (__fastcall *)(ULONG_PTR *, _QWORD, _DWORD *))qword_140A53FF8)(&CmControlHive, v7, v26);
    v24 = result;
    if ( !result )
      return result;
  ...
  else
  {
    ...
    result = ((__int64 (__fastcall *)(ULONG_PTR *, _QWORD, _DWORD *))qword_140A53FF8)(&CmControlHive, ControlSet, v26);
    v10 = result;
    if ( !result )
      return result;
  ...
  ((void (__fastcall *)(ULONG_PTR *, _DWORD *))qword_140A54000)(&CmControlHive, v26);
  if ( CmControlVector[0] )
  {
    do
    {
      if ( a3 != 1 || *((_BYTE *)v3 + 40) )
      {
        ...
        if ( v14 != -1 )
        {
          result = ((__int64 (__fastcall *)(ULONG_PTR *, _QWORD, _DWORD *))qword_140A53FF8)(&CmControlHive, v14, v26);
          v15 = result;
          if ( !result )
            return result;
          ...
          if ( ValueByName != -1 )
          {
            ...
            if ( v19 )
              v13 = *v19;
            result = ((__int64 (__fastcall *)(ULONG_PTR *, _QWORD, _DWORD *))qword_140A53FF8)(
                       &CmControlHive,
                       ValueByName,
                       v28);
            v20 = result;
            ...
            if ( v13 && !(unsigned __int8)CmpGetBootValueData(v21, result, v3[2], v13) )
              return ((__int64 (__fastcall *)(ULONG_PTR *, _DWORD *))qword_140A54000)(&CmControlHive, v28);
            v23 = v3[4];
            if ( v23 )
              *(_DWORD *)v23 = *(_DWORD *)(v20 + 12);
            ((void (__fastcall *)(ULONG_PTR *, _DWORD *))qword_140A54000)(&CmControlHive, v28);
          }
        }
