/*
 * XREFs of DbgkpTriageDumpSnapData @ 0x140281E60
 * Callers:
 *     <none>
 * Callees:
 *     RtlULongSub @ 0x1400FE514 (RtlULongSub.c)
 *     memmove @ 0x1401D6880 (memmove.c)
 *     DbgkpTriageDumpCheckPresentHashTable @ 0x140281DE0 (DbgkpTriageDumpCheckPresentHashTable.c)
 */
...
LABEL_14:
  ...
  if ( v15 + 16 >= v15
    && RtlULongSub(*(_DWORD *)(v9 + 8312), *(_DWORD *)(a1 + 24), (ULONG *)&pulResult) >= 0
