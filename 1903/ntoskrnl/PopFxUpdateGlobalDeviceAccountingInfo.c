/*
 * XREFs of PopFxUpdateGlobalDeviceAccountingInfo @ 0x1402F5CE0
 * Callers:
...
__int64 __fastcall PopFxUpdateGlobalDeviceAccountingInfo(unsigned __int64 a1, unsigned __int64 a2)
{
  ...
  result = qword_140444888;
  if ( qword_140444888 < a1 )
  {
    v3 = a1 - qword_140444888;
    qword_140444890 += a1 - qword_140444888;
    if ( a1 - qword_140444888 < a2 )
    {
      qword_140444898 += v3;
    }
    else
