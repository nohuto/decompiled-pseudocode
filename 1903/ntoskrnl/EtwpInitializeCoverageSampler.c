/*
 * XREFs of EtwpInitializeCoverageSampler @ 0x140A160D0
 * Callers:
...
__int64 EtwpInitializeCoverageSampler()
{
  ...
  *(_QWORD *)&DestinationString.Length = 0LL;
  ...
  ExInitializePushLock(&stru_140432580);
  ...
  result = ObCreateObjectType(&DestinationString, (__int64)v2, 0LL, (__int64)&qword_140432570);
  if ( (int)result < 0 )
