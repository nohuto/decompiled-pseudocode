 ...
 *     BgpConsoleGetFontName @ 0x140A41540 (BgpConsoleGetFontName.c)
 */
...
__int64 __fastcall BgpConsoleInitialize(unsigned int a1, unsigned int a2, unsigned int a3)
{
  ...
  qword_1404F2AD8 = (__int64)Memory;
  if ( !Memory )
  {
    v11 = -1073741801;
    goto LABEL_12;
  ...
  *(_DWORD *)(v8 + 52) = 22;
  ...
  BgpConsoleGetFontName((unsigned int)dword_14042C198, Str2);
  FontHandle = BgpFoGetFontHandle(Str2[0], &v25);
  v10 = (unsigned int *)qword_1404F2AD8;
  v11 = FontHandle;
  if ( FontHandle >= 0 )
  {
    v11 = BgpConsoleSetPointSize(
            *(_DWORD *)(qword_1404F2AD8 + 4),
            *(_DWORD *)qword_1404F2AD8,
            *(_DWORD *)(qword_1404F2AD8 + 24),
            *(_DWORD *)(qword_1404F2AD8 + 20),
            (__int64)v24,
            (__int64)&v22);
    if ( v11 >= 0 )
    {
      ...
      *((_QWORD *)v10 + 6) = v22;
      ...
      v10 = (unsigned int *)qword_1404F2AD8;
      *(_QWORD *)(qword_1404F2AD8 + 40) = Context;
      if ( Context )
      {
        v14 = 0LL;
        v15 = *v10;
