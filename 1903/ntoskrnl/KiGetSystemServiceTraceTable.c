/*
 * XREFs of KiGetSystemServiceTraceTable @ 0x1408803A0
 * Callers:
 ...
 *     KiSystemServiceTraceTableCompareFunction @ 0x1408804F0 (KiSystemServiceTraceTableCompareFunction.c)
 */
...
__int64 KiGetSystemServiceTraceTable()
{
  ...
  {
    PoolWithTag = ExAllocatePoolWithTag(PagedPool, 0x7450uLL, 0x7454694Bu);
    v1 = (signed __int64)PoolWithTag;
    if ( PoolWithTag )
    {
      memset(PoolWithTag, 0, 0x7450uLL);
      v3 = &off_14094C898;
      v4 = 465LL;
      v5 = v1 + 40;
      do
