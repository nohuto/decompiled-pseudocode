/*
 * XREFs of PspLookupProcessQuotaBlock @ 0x140667428
 * Callers:
 ...
 *     PspHashKeyValue @ 0x140667524 (PspHashKeyValue.c)
 *     PspSafeReferenceQuotaBlock @ 0x140667BF4 (PspSafeReferenceQuotaBlock.c)
 */
