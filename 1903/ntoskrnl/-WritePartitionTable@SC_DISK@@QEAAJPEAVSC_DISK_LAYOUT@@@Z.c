/*
 * XREFs of ?WritePartitionTable@SC_DISK@@QEAAJPEAVSC_DISK_LAYOUT@@@Z @ 0x14034B580
 * Callers:
 ...
 *     ?Initialize@SC_MBR@@QEAAXPEAVSC_DISK@@@Z @ 0x14034B870 (-Initialize@SC_MBR@@QEAAXPEAVSC_DISK@@@Z.c)
