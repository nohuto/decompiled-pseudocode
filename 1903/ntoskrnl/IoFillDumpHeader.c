/*
 * XREFs of IoFillDumpHeader @ 0x140294748
 * Callers:
 ...
 *     KeInitializeCrashDumpHeader @ 0x140298150 (KeInitializeCrashDumpHeader.c)
 *     IopLiveDumpEndMirroringCallback @ 0x1405A8730 (IopLiveDumpEndMirroringCallback.c)
 *     DbgkpTriageDumpFillHeaders @ 0x14084CCD0 (DbgkpTriageDumpFillHeaders.c)
 * Callees:
        ...
        __int64 a8)
{
  ...
  *((_DWORD *)a1 + 2) = 15;
  *((_DWORD *)a1 + 3) = 18363 - (KernelVersionBump != 1);
