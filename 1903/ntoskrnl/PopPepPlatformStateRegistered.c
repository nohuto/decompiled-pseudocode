/*
 * XREFs of PopPepPlatformStateRegistered @ 0x1402FA29C
 * Callers:
...
LABEL_21:
    ...
    if ( v12 && ($6EAC78A6FCFADE0A5FA44F358736B38F *)v3->ApcState.ApcListHead[0].Flink != &v3->152 )
...
LABEL_43:
    ...
    if ( v12 && ($6EAC78A6FCFADE0A5FA44F358736B38F *)v18->ApcState.ApcListHead[0].Flink != &v18->152 )
...
LABEL_60:
    ...
    {
      KiAbEntryRemoveFromTree((__int64)&v30->LockEntries[v37]);
      v31 = 0LL;
    }
...
LABEL_67:
    ...
    if ( v12 && ($6EAC78A6FCFADE0A5FA44F358736B38F *)v30->ApcState.ApcListHead[0].Flink != &v30->152 )
...
LABEL_97:
    ...
    {
      KiAbEntryRemoveFromTree((__int64)&v51->LockEntries[v56]);
      v52 = 0LL;
    }
...
LABEL_104:
    ...
    if ( v12 && ($6EAC78A6FCFADE0A5FA44F358736B38F *)v51->ApcState.ApcListHead[0].Flink != &v51->152 )
