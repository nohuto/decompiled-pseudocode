/*
 * XREFs of MiGetHugeRangeFromNode @ 0x1402C1DC8
 * Callers:
 ...
 *     MiUnlinkHugeRange @ 0x1402C2B0C (MiUnlinkHugeRange.c)
 */
...
__int64 __fastcall MiGetHugeRangeFromNode(_QWORD *a1, unsigned int a2, int a3)
{
  ...
  if ( v3 )
  {
    v7 = dword_140465B40[0];
    v8 = (unsigned int)dword_140465B40[0];
    v9 = (_QWORD *)(v3 + 16LL * a2 * dword_140465B40[0]);
    if ( a3 )
    {
      v10 = 0LL;
    }
    ...
    {
      v9 += (unsigned int)dword_140465B40[0];
      v10 = 1LL;
    }
    v11 = 0LL;
    SpinLock = a1 + 508;
...
LABEL_22:
    ...
    __writecr8(OldIrql);
    if ( v15 && a3 && (*(_DWORD *)(qword_1404661B0 + 8 * v15) & 0x3FFFF) == 1LL )
    {
      MiHugePageOperation(v4);
      KeAcquireInStackQueuedSpinLock(SpinLock, &LockHandle);
      *(_QWORD *)(qword_1404661B0 + 8 * v15) &= 0xFFFFFFFFFFFC0000uLL;
      KeReleaseInStackQueuedSpinLockFromDpcLevel(&LockHandle);
