/*
 * XREFs of PopRecordPepWorkorderBlackboxInformation @ 0x140305F08
 * Callers:
...
LABEL_33:
  ...
  if ( v19 && ($6EAC78A6FCFADE0A5FA44F358736B38F *)CurrentThread->ApcState.ApcListHead[0].Flink != &CurrentThread->152 )
