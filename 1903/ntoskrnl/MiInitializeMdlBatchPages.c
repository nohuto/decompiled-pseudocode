/*
 * XREFs of MiInitializeMdlBatchPages @ 0x14009F4C0
 * Callers:
...
void __fastcall MiInitializeMdlBatchPages(__int64 a1, char a2, int a3)
{
  ...
  _QWORD v30[10]; // [rsp+70h] [rbp+7h] BYREF
  ...
  do
  {
    ...
    if ( !(_DWORD)v13 )
    {
      if ( (unsigned int)MiPfnZeroingNeeded(v16, (unsigned int)v3) )
      {
        if ( !PoolWithTag )
        {
        ...
        if ( v6 == 1 )
          ...
          v17 = dword_140465AB0 & *v25 | (*(_QWORD *)(v16 + 40) >> 58 << byte_140465A4D) | (((unsigned int)(*(_QWORD *)(v16 + 40) >> 36) & 3) << byte_140465A4E);
        v18 = 3 * v17;
        v15 = 1;
...
LABEL_30:
    ...
    if ( !v15 || dword_140465B58[4 * ((unsigned __int64)*(unsigned __int8 *)(v16 + 34) >> 6) + v3] == (_DWORD)v3 )
    {
      v7 = v16;
      v8 = v24;
      *(_QWORD *)(v16 + 16) = v33;
...
LABEL_6:
  ...
  while ( v10 );
  if ( v7 )
    MiChangePageAttributeBatch(v7, (unsigned int)v3, 0LL);
  if ( v12 )
  ...
  if ( v26 )
  {
    ...
    if ( v16 )
      MiChangePageAttributeBatch(v16, (unsigned int)v3, 0LL);
  }
  else if ( PoolWithTag )
  {
    if ( PoolWithTag != v30 )
