/*
 * XREFs of MiZeroCfgSystemWideBitmapWorker @ 0x1400DC230
 * Callers:
...
unsigned int *__fastcall MiZeroCfgSystemWideBitmapWorker(unsigned int *a1, unsigned __int64 a2, unsigned __int64 a3)
{
  ...
  v70 = (a2 >> 3) & 0xFFF;
  v55 = *(_QWORD *)(qword_140466188 + 8 * v7);
...
LABEL_13:
      ...
      if ( (v21 & 1) != 0 )
      {
        ...
        if ( v44 )
          MiReleasePageFileInfo(*(_QWORD *)(qword_140466188 + 8 * ((*(_QWORD *)(v20 + 40) >> 40) & 0x3FFLL)), v44, 1);
        goto LABEL_31;
      }
      if ( (v21 & 0x400) != 0 )
        goto LABEL_31;
...
LABEL_49:
            ...
            if ( dword_14046620C == 1 )
            {
              v48 = v23 & 0x1F;
              LOBYTE(v49) = 1;
              v50 = (volatile signed __int32 *)(qword_140466268 + 4 * (v23 >> 5));
              if ( v48 + 1 > 0x20 )
              {
                if ( (v23 & 0x1F) != 0 )
                {
