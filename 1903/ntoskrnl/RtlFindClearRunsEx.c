/*
 * XREFs of RtlFindClearRunsEx @ 0x140177B9C
 * Callers:
  ...
  if ( v10 )
  {
    ...
    do
    {
      ...
      if ( v14 )
      {
        ...
        v5 = v13 - v9 + 8;
        v17 = *((_BYTE *)&unk_140380E28 - v9) | byte_1403821E8[v15] | v14;
        if ( v17 != 0xFF )
        {
          do
          {
            ...
            v29 = 0;
            for ( j = byte_1403821E8[v28]; ((unsigned __int8)j & v17) != 0; j *= 2 )
              ++v29;
