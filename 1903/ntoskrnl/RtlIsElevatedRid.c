/*
 * XREFs of RtlIsElevatedRid @ 0x1405D7E90
 * Callers:
 ...
 *     SepRemoveDisabledGroupsAndPrivileges @ 0x14061F068 (SepRemoveDisabledGroupsAndPrivileges.c)
 * Callees:
