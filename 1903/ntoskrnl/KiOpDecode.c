/*
 * XREFs of KiOpDecode @ 0x140015A94
 * Callers:
 *     KiPreprocessFault @ 0x140016318 (KiPreprocessFault.c)
 * Callees:
 *     KiOpFetchNextByte @ 0x140015BF4 (KiOpFetchNextByte.c)
 *     KiOpIsPrefix @ 0x140015C18 (KiOpIsPrefix.c)
 *     KiOpLocateDecodeEntry @ 0x140015CBC (KiOpLocateDecodeEntry.c)
 *     KiOpDecodeModRM @ 0x14019D9C0 (KiOpDecodeModRM.c)
 *     memset @ 0x1401D6BC0 (memset.c)
 *     KiOpFetchBytes @ 0x1402B38A8 (KiOpFetchBytes.c)
 */
