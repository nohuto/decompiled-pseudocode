/*
 * XREFs of MiReclaimUnusedUltraMdlMaps @ 0x1400F1EE8
 * Callers:
...
__int64 MiReclaimUnusedUltraMdlMaps()
{
  ...
  if ( KeNumberNodes )
  {
    do
    {
      ...
      do
      {
        while ( *(_WORD *)(v4 + qword_140466778) > 2u )
        {
          v5 = RtlpInterlockedPopEntrySList((PSLIST_HEADER)(qword_140466778 + ((8LL * v2 + v3) << 6)));
          v6 = v5;
          if ( !v5 )
            break;
          ++v1;
