/*
 * XREFs of NtQueryInformationProcess @ 0x1405D12E0
 * Callers:
 *     <none>
 * Callees:
 ...
 *     PsGetWin32KFilterSet @ 0x140115470 (PsGetWin32KFilterSet.c)
 ...
 *     PsGetProcessProtection @ 0x140134530 (PsGetProcessProtection.c)
 ...
 *     PspReadProcessSecurityDomain @ 0x140307680 (PspReadProcessSecurityDomain.c)
 ...
 *     PsQueryProcessQuotaCounters @ 0x1406D74D0 (PsQueryProcessQuotaCounters.c)
 *     KeGetExecuteOptions @ 0x1406DD64C (KeGetExecuteOptions.c)
 ...
 *     ExQueryRaiseUMExceptionOnInvalidHandleClose @ 0x14073B304 (ExQueryRaiseUMExceptionOnInvalidHandleClose.c)
 ...
 *     PsGetKeepAliveCountProcess @ 0x1408C66A4 (PsGetKeepAliveCountProcess.c)
 ...
 *     ExQueryHandleExceptions @ 0x14090B440 (ExQueryHandleExceptions.c)
        ...
        PULONG ReturnLength)
{
  ...
  {
    case ProcessLUIDDeviceMapsEnabled|0x40:
      v10 = 7LL;
      goto LABEL_9;
    case ProcessDebugObjectHandle|0x40:
      v10 = 7LL;
      goto LABEL_9;
    case ProcessDeviceMap|0x40:
LABEL_20:
      v10 = 0LL;
      goto LABEL_9;
  }
...
LABEL_24:
  if ( ProcessInformationClass != (ProcessCookie|ProcessUserModeIOPL) )
  {
...
LABEL_459:
          ...
          case 58:
            ...
            result = ExLockUserBuffer(
                       v6,
                       (unsigned int)v5,
                       (unsigned __int8)KeGetCurrentThread()->$42514DC6747B59BF81E16C40547B231E::gap0[10],
                       1LL,
                       &v194,
                       &P);
            if ( result < 0 )
...
LABEL_177:
          ...
          case 67:
            ...
            if ( v43 >= 0 )
            {
              LOBYTE(v8) = ProcessInformationClass == (ProcessVmCounters|0x40);
...
LABEL_204:
          ...
          case 87:
          case 96:
            if ( ProcessInformationClass == (ProcessDeviceMap|0x40) && !(_DWORD)v5
              || ProcessInformationClass == 96 && (unsigned int)v5 < 4 )
            {
              return -1073741820;
            }
            result = ObReferenceObjectByHandleWithTag(
