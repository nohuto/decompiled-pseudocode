/*
 * XREFs of WheapAllocErrorRecord @ 0x140340154
 * Callers:
 *     WheapReportBootError @ 0x14033FA98 (WheapReportBootError.c)
 *     WheaReportHwError @ 0x14033FCD0 (WheaReportHwError.c)
 * Callees:
 *     WheapInitializeErrorRecordWrapper @ 0x14018AFA8 (WheapInitializeErrorRecordWrapper.c)
 *     memset @ 0x1401D6BC0 (memset.c)
 *     WheapGetPreallocatedErrorRecord @ 0x1403406D4 (WheapGetPreallocatedErrorRecord.c)
