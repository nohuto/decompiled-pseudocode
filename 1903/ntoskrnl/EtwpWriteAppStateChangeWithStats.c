/*
 * XREFs of EtwpWriteAppStateChangeWithStats @ 0x140637274
 * Callers:
...
void EtwpWriteAppStateChangeWithStats()
{
  ...
  {
    if ( TlgKeywordOn(&stru_140426650, 0x200000000003uLL) )
    {
      v11 = *(_DWORD *)(v0 + 744);
      ...
      v45 = 4;
      v48 = 8;
      TlgWrite(&stru_140426650, &unk_140393C48, 0LL, 0LL, 0xDu, &pData);
    }
  }
}
