/*
 * XREFs of IopSetupArbiterAndTranslators @ 0x140753240
 * Callers:
 *     IopResourceRequirementsListToReqList @ 0x140752C80 (IopResourceRequirementsListToReqList.c)
 * Callees:
 *     ExAllocatePoolWithTag @ 0x14036E010 (ExAllocatePoolWithTag.c)
 *     IopFindResourceHandlerInfo @ 0x140753614 (IopFindResourceHandlerInfo.c)
 *     IopFindLegacyBusDeviceNode @ 0x1407536A4 (IopFindLegacyBusDeviceNode.c)
...
__int64 __fastcall IopSetupArbiterAndTranslators(unsigned int *a1, __int64 a2, __int64 a3)
{
  ...
  while ( 1 )
  {
    if ( LegacyBusDeviceNode != IopRootDeviceNode || v6 || v9 )
    {
      ...
      *((_WORD *)LegacyBusDeviceNode + 263) |= v18;
      if ( v19 >= 0 )
      {
        v30 = v36;
      }
      ...
      {
        *((_WORD *)LegacyBusDeviceNode + 262) |= v18;
        if ( (unsigned __int8)v7 <= 0xFu )
        {
LABEL_13:
          v12 = v37;
...
LABEL_24:
          ...
          if ( (unsigned __int8)v7 > 0xFu )
            ...
            v16 = 1 << v7;
          v17 = IopQueryResourceHandlerInterface(1LL, LegacyBusDeviceNode[4], a3, &v36);
          *((_WORD *)LegacyBusDeviceNode + 261) |= v16;
          if ( v17 >= 0 )
          {
            v27 = v36;
          }
          ...
          {
            *((_WORD *)LegacyBusDeviceNode + 260) |= v16;
            if ( (unsigned __int8)v7 <= 0xFu )
            {
LABEL_19:
              v13 = v31;
LABEL_20:
          ...
          *(_QWORD *)(PoolWithTag + 32) = LegacyBusDeviceNode;
          v29 = (PVOID *)LegacyBusDeviceNode[64];
          if ( *v29 != LegacyBusDeviceNode + 63 )
            goto LABEL_68;
          *(_QWORD *)(PoolWithTag + 8) = v29;
          *(_QWORD *)PoolWithTag = LegacyBusDeviceNode + 63;
          *v29 = (PVOID)PoolWithTag;
          v13 = PoolWithTag & -(__int64)(v27 != 0);
      ...
      *(_QWORD *)(v21 + 32) = LegacyBusDeviceNode;
      v24 = (PVOID *)LegacyBusDeviceNode[62];
      if ( *v24 != LegacyBusDeviceNode + 61 )
LABEL_68:
        __fastfail(3u);
      *(_QWORD *)v21 = LegacyBusDeviceNode + 61;
      *(_QWORD *)(v21 + 8) = v24;
      *v24 = (PVOID)v21;
      LegacyBusDeviceNode[62] = v21;
      *(_QWORD *)(v21 + 24) = v30;
      v12 = v21 & -(__int64)(v30 != 0);
      v37 = v12;
      goto LABEL_14;
    }
    v34 = 1;
