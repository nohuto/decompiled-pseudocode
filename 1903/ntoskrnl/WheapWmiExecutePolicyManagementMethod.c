/*
 * XREFs of WheapWmiExecutePolicyManagementMethod @ 0x140342DEC
 * Callers:
 *     WheapWmiExecuteMethod @ 0x140342CBC (WheapWmiExecuteMethod.c)
 * Callees:
 *     WheapCommitPolicy @ 0x14091A4A4 (WheapCommitPolicy.c)
 *     WheapGetAllPolicyBufferSize @ 0x14091A594 (WheapGetAllPolicyBufferSize.c)
 *     WheapGetAllPolicyValues @ 0x14091A5A0 (WheapGetAllPolicyValues.c)
 *     WheapGetPolicyValue @ 0x14091A5E4 (WheapGetPolicyValue.c)
 *     WheapSetPolicyValue @ 0x14091A728 (WheapSetPolicyValue.c)
 */
