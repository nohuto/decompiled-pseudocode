/*
 * XREFs of CmRenameKey @ 0x14082855C
 * Callers:
...
__int64 __fastcall CmRenameKey(ULONG_PTR *a1, unsigned __int16 *a2, char a3)
{
  ULONG_PTR *v3; // rdi
  __int64 v4; // rbx
  ULONG_PTR v5; // r15
  ...
  ULONG_PTR *v146; // [rsp+138h] [rbp+38h]
...
LABEL_130:
    ...
    *(_QWORD *)(v68 + 4) = v8;
    ...
    NameControlBlock = (unsigned int *)CmpGetNameControlBlock(v123, &v144);
    if ( !NameControlBlock )
      goto LABEL_139;
    v73 = v135;
