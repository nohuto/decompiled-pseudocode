/*
 * XREFs of PopFxIssueDirectedPowerTransition @ 0x1402F3D28
 * Callers:
...
__int64 __fastcall PopFxIssueDirectedPowerTransition(ULONG_PTR BugCheckParameter2, char a2, __int64 a3)
{
  ...
  *(_DWORD *)(BugCheckParameter2 + 1168) = -1073741436;
  PopFxQueueWorkOrder(&PopFxSystemWorkQueue, (PLIST_ENTRY)(BugCheckParameter2 + 912), BugCheckParameter2, 0);
