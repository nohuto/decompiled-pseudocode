/*
 * XREFs of EtwpSetCoverageSamplerInformation @ 0x140906780
 * Callers:
 ...
 *     EtwpCovSampApplyBounds @ 0x140900BD8 (EtwpCovSampApplyBounds.c)
  ...
  if ( BYTE4(Handle[0]) )
  {
    ...
    if ( (_DWORD)v4 == 40 )
    {
      ...
      *(_QWORD *)&v49[2] = *((_QWORD *)Address + 4);
      inserted = ObReferenceObjectByHandle(Handle[1], 1u, qword_140432570, AccessMode, &Object, 0LL);
      v6 = (char *)Object;
      if ( inserted >= 0 )
      {
...
LABEL_4:
  ...
  *(_QWORD *)&v49[1] = 0LL;
  v49[2] = 0LL;
  inserted = ObCreateObject(0, qword_140432570, (int)v49, AccessMode, 0, 1216, 0, 0, &Object);
  v6 = (char *)Object;
  if ( inserted >= 0 )
  {
