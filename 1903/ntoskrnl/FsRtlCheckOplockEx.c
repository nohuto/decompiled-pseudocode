/*
 * XREFs of FsRtlCheckOplockEx @ 0x140046520
 * Callers:
 *     FsRtlCheckOplock @ 0x140046470 (FsRtlCheckOplock.c)
 ...
 *     FsRtlGetMarkHandleInfo @ 0x1402832BC (FsRtlGetMarkHandleInfo.c)
...
LABEL_32:
    ...
    {
      if ( byte_140467440[((v17 >> 39) & 0x1FF) - 256] == 1 )
      {
