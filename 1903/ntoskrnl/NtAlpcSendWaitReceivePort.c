/*
 * XREFs of NtAlpcSendWaitReceivePort @ 0x1405DEDB0
 * Callers:
        ...
        PLARGE_INTEGER Timeout)
{
  ...
  v12 = KeGetCurrentThread()->$42514DC6747B59BF81E16C40547B231E::gap0[10];
...
LABEL_9:
  ...
  {
    v19 = &v17->152;
    if ( ($6EAC78A6FCFADE0A5FA44F358736B38F *)v19->ApcState.ApcListHead[0].Flink != v19 && !v17->SpecialApcDisable )
