/*
 * XREFs of MiCreateRetpolineBitmap @ 0x140A19AA8
 * Callers:
...
__int64 __fastcall MiCreateRetpolineBitmap(unsigned __int64 *a1)
{
  ...
  v2 = MiReservePtes((__int64)&qword_1404669C0, (unsigned __int64 *)0x10000);
  v3 = v2;
  if ( v2 )
  {
    v4 = (__int64)(v2 << 25) >> 16;
    if ( (unsigned int)MiInitializeDynamicBitmap(&qword_140464858, v4, 0x80000000LL, 15) )
    {
      *a1 = v4;
      return 0LL;
    }
    MiReleasePtes((__int64)&qword_1404669C0, v3, 0x10000u);
  }
  return 3221225495LL;
}
