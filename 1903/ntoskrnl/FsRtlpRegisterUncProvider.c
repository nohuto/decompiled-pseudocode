/*
 * XREFs of FsRtlpRegisterUncProvider @ 0x14077E5E4
 * Callers:
 *     FsRtlRegisterUncProviderEx2 @ 0x14077E5C0 (FsRtlRegisterUncProviderEx2.c)
 *     FsRtlRegisterUncProvider @ 0x14084EBE0 (FsRtlRegisterUncProvider.c)
 *     FsRtlRegisterUncProviderEx @ 0x14084EC20 (FsRtlRegisterUncProviderEx.c)
 * Callees:
