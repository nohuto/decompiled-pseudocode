/*
 * XREFs of RtlNtStatusToDosErrorNoTeb @ 0x14010D020
 * Callers:
...
ULONG __stdcall RtlNtStatusToDosErrorNoTeb(NTSTATUS Status)
{
  ...
  if ( (Status & 0x20000000) == 0 )
  {
    ...
    while ( 1 )
    {
      ...
      if ( v3 >= v6 )
      {
        if ( v7 < (unsigned __int8)byte_14037FF64[8 * v5] )
        {
          v8 = (unsigned __int16)word_14037FF66[4 * v5];
          if ( byte_14037FF65[8 * v5] == 1 )
