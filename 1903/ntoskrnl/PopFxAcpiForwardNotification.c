/*
 * XREFs of PopFxAcpiForwardNotification @ 0x140304944
 * Callers:
...
__int64 __fastcall PopFxAcpiForwardNotification(__int64 a1, unsigned int a2, __int64 a3, __int64 a4, _BYTE *a5)
{
  ...
  v8 = IoAcquireRemoveLockEx((PIO_REMOVE_LOCK)(a1 + 264), (PVOID)0x72466F50, &Src, 1u, 0x20u);
  if ( v8 >= 0 )
  {
    v9 = (*(__int64 (__fastcall **)(_QWORD, __int64))(*(_QWORD *)(a1 + 80) + 112LL))(a2, a3);
    if ( _InterlockedExchangeAdd((volatile signed __int32 *)(a1 + 268), 0xFFFFFFFF) == 1 )
      KeSetEvent((PRKEVENT)(a1 + 272), 0, 0);
    *a5 = v9;
  }
