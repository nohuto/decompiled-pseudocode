/*
 * XREFs of EtwpSendDataBlock @ 0x140666224
 * Callers:
...
LABEL_10:
      ...
      if ( (v17 - v10) * KeQueryTimeIncrement() >= 600010000
        && stru_140426618.LevelPlus1 > 5
        && TlgKeywordOn(&stru_140426618, 0x200000000800uLL) )
      {
        v37 = 8LL;
        v29 = 2164260864LL;
        v39 = 8LL;
        ...
        v30 = v24 / 10000;
        v40 = v25;
        TlgWrite(&stru_140426618, &unk_140394412, 0LL, 0LL, 5u, &pData);
      }
    }
  }
  else if ( (v6 & 2) != 0 )
