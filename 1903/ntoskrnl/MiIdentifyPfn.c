/*
 * XREFs of MiIdentifyPfn @ 0x1400054D0
 * Callers:
...
LABEL_16:
      ...
      if ( v32 >= 0xFFFF800000000000uLL && byte_140467440[((v32 >> 39) & 0x1FF) - 256] == 5 )
      {
...
LABEL_46:
      ...
      v36 = byte_140467440[((v35 >> 39) & 0x1FF) - 256];
      if ( v36 == 5 )
      {
        a2[2] = v35;
...
LABEL_47:
      ...
      if ( (v7 & 7) != 6 || (v73 & 1) != 0 && !v11 )
      {
        ...
        *a2 = *a2 & 0xFF000000000001FFuLL | ((*(_QWORD *)v38 & 0xFFFFFFFFFFE0000LL | 0x1000000000000000uLL) >> 4);
        ...
        {
          if ( v35 < qword_1404675B0 || v35 > qword_140465EE0 )
...
LABEL_88:
      ...
      if ( v35 <= 0x7FFFFFFEFFFFLL
        || (v44 = (((unsigned __int64)qword_1404675B0 >> 9) & 0x7FFFFFFFF8LL) - 0x98000000000LL,
...
LABEL_86:
      ...
      while ( 1 )
      {
        if ( v45 > 0xFFFFF6FFFFFFFFFFuLL )
          goto LABEL_86;
        if ( v45 <= (((unsigned __int64)qword_140465EE0 >> 9) & 0x7FFFFFFFF8LL) - 0x98000000000LL && v45 >= v44 )
          break;
        ++v34;
