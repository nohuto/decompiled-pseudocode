/*
 * XREFs of Normalization__NormalizeCharacter @ 0x1408D7470
 * Callers:
 *     Normalization__AppendDecomposedChar @ 0x1408D654C (Normalization__AppendDecomposedChar.c)
 *     Normalization__Normalize @ 0x1408D72B8 (Normalization__Normalize.c)
 * Callees:
 *     ComposeHangulLV @ 0x140313784 (ComposeHangulLV.c)
 *     ComposeHangulLVT @ 0x1403137B4 (ComposeHangulLVT.c)
 *     IsHangulLV @ 0x1403137E8 (IsHangulLV.c)
 *     NormBuffer__Append @ 0x14031381C (NormBuffer__Append.c)
 *     NormBuffer__AppendEx @ 0x1403138E8 (NormBuffer__AppendEx.c)
 *     NormBuffer__GetLastChar @ 0x140313988 (NormBuffer__GetLastChar.c)
 *     NormBuffer__Insert @ 0x140313A0C (NormBuffer__Insert.c)
 *     NormBuffer__IsBlocked @ 0x140313AD8 (NormBuffer__IsBlocked.c)
 *     NormBuffer__LastStartBase @ 0x140313B60 (NormBuffer__LastStartBase.c)
 *     NormBuffer__LastStartBasePair @ 0x140313B8C (NormBuffer__LastStartBasePair.c)
 *     NormBuffer__RecheckStartCombinations @ 0x140313BD8 (NormBuffer__RecheckStartCombinations.c)
 *     NormBuffer__ReplaceLastStartBase @ 0x140313D10 (NormBuffer__ReplaceLastStartBase.c)
 *     NormBuffer__ReplaceLastStartBasePair @ 0x140313D84 (NormBuffer__ReplaceLastStartBasePair.c)
 *     NormBuffer__RewindOutputCharacter @ 0x140313DF8 (NormBuffer__RewindOutputCharacter.c)
 *     Normalization__AppendDecomposedChar @ 0x1408D654C (Normalization__AppendDecomposedChar.c)
 *     Normalization__CanCombinableCharactersCombine @ 0x1408D665C (Normalization__CanCombinableCharactersCombine.c)
 */
