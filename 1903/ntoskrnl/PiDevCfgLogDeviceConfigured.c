/*
 * XREFs of PiDevCfgLogDeviceConfigured @ 0x1406FBBB4
 * Callers:
 ...
 *     PnpGetLogString @ 0x1401445A4 (PnpGetLogString.c)
  ...
  *(_QWORD *)&v115.Length = 0LL;
  ...
  if ( a5 < 0 )
  {
    if ( a5 == -1073740959 )
    {
      ...
      {
        v65 = a4 & 1;
        v66 = (const wchar_t *)&dword_14094F874;
        if ( v7 )
          v66 = v7;
    ...
    {
      v75 = a4 & 1;
      v76 = (const wchar_t *)&dword_14094F874;
      if ( v7 )
        v76 = v7;
      PnpGetLogString(*(_QWORD *)(v113 + 16) + 40LL);
      PnpGetLogString(v77);
  ...
  else if ( (a4 & 2) != 0 )
  {
    ...
    {
      v55 = a4 & 1;
      v56 = (const wchar_t *)&dword_14094F874;
      if ( v7 )
        v56 = v7;
      PnpGetLogString(*(_QWORD *)(v113 + 16) + 40LL);
      PnpGetLogString(v57);
  ...
  {
    v16 = a4 & 1;
    v17 = (const wchar_t *)&dword_14094F874;
    if ( v7 )
      v17 = v7;
    PnpGetLogString(*(_QWORD *)(v113 + 16) + 40LL);
    PnpGetLogString(v18);
