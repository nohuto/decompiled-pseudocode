/*
 * XREFs of EtwpCoverageSamplerStart @ 0x140906018
 * Callers:
...
LABEL_16:
  ...
  else
  {
    ...
    if ( ImageNotifyRoutine >= 0 )
    {
      ...
      qword_140432578 = (__int64)Object;
      _InterlockedExchange64((volatile __int64 *)&stru_140432580, 0LL);
      Object[285] |= 1u;
...
LABEL_29:
  if ( (struct _KTHREAD *)qword_140432568 == KeGetCurrentThread() )
  {
    qword_140432568 = 0LL;
