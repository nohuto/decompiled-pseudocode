/*
 * XREFs of sub_1405B0010 @ 0x1405B0010
 * Callers:
 *     <none>
 * Callees:
...
BOOLEAN __fastcall sub_1405B0010(PKDPC Dpc)
{
...
LABEL_31:
    ...
    v39 = 0x891C8B4E8A3A03F5uLL;
    CcAdjustBcbDepth(
      (unsigned int)__ROL4__(8480, 219),
