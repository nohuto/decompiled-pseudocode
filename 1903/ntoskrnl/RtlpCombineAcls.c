/*
 * XREFs of RtlpCombineAcls @ 0x1405DBAD0
 * Callers:
        ...
        _DWORD *a8)
{
  ...
  if ( __PAIR128__((unsigned __int64)a1, (unsigned __int64)a2) != 0 || a3 || a4 || a5 || a6 )
  {
    ...
    {
      v36 = a1 + 8;
      for ( i = 0; i < *((unsigned __int16 *)a1 + 2); v36 += *((unsigned __int16 *)v36 + 1) )
      {
        switch ( *v36 )
        {
          case 2u:
    ...
    {
      v40 = a6 + 8;
      for ( m = 0; m < *((unsigned __int16 *)a6 + 2); v40 += *((unsigned __int16 *)v40 + 1) )
      {
        if ( *v40 == 21 )
        {
          if ( v16 + *((unsigned __int16 *)v40 + 1) < v16 )
            goto LABEL_106;
          v16 += *((unsigned __int16 *)v40 + 1);
          if ( a8 )
            *a8 |= 0x100u;
          if ( *a6 > v12 )
            v12 = *a6;
    ...
    {
      v42 = a4 + 8;
      for ( ii = 0; ii < *((unsigned __int16 *)a4 + 2); v42 += *((unsigned __int16 *)v42 + 1) )
      {
        if ( *v42 == 19 )
        {
          if ( v16 + *((unsigned __int16 *)v42 + 1) < v16 )
            goto LABEL_106;
...
LABEL_54:
                  ...
                  ++v33;
                  v32 = (unsigned __int16 *)((char *)v32 + (unsigned __int16)v35);
                  v54 = v33;
                }
                while ( v33 < *((unsigned __int16 *)a1 + 2) );
                v10 = a5;
                v52 = v34;
                v8 = a6;
              }
            ...
            {
              v44 = v10 + 8;
              for ( jj = 0; jj < *((unsigned __int16 *)v10 + 2); v44 = (_WORD *)((char *)v44 + (unsigned __int16)v46) )
              {
                LOWORD(v46) = v44[1];
                if ( *(_BYTE *)v44 == 20 )
                {
