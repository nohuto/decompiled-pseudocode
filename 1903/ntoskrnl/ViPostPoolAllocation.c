  ...
  *a1 = v2;
  ...
  if ( (a2 & 1) != 0 )
  {
    ...
    if ( v12 > *(_DWORD *)(v6 + 104) )
      *(_DWORD *)(v6 + 104) = v12;
    v13 = v7 + _InterlockedExchangeAdd64(&qword_140446630, v7);
    if ( v13 > qword_140446640 )
      qword_140446640 = v13;
    v14 = _InterlockedIncrement(&dword_140446620);
    if ( v14 > dword_140446628 )
      dword_140446628 = v14;
  }
  else
  {
    ...
    if ( v16 > *(_DWORD *)(v6 + 108) )
      *(_DWORD *)(v6 + 108) = v16;
    v17 = v7 + _InterlockedExchangeAdd64(&qword_140446638, v7);
    if ( v17 > qword_140446648 )
      qword_140446648 = v17;
    v18 = _InterlockedIncrement(&dword_140446624);
    if ( v18 > dword_14044662C )
      dword_14044662C = v18;
  }
  result = v2;
  *v9 = a1;
