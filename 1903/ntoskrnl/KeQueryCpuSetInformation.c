/*
 * XREFs of KeQueryCpuSetInformation @ 0x140781950
 * Callers:
 *     ExpQuerySystemInformation @ 0x1405CAF30 (ExpQuerySystemInformation.c)
 * Callees:
 *     RtlTryEndReadTickLock @ 0x1400F8D9C (RtlTryEndReadTickLock.c)
 *     RtlBeginReadTickLock @ 0x1400F8DB0 (RtlBeginReadTickLock.c)
 *     KiGetCpuSetData @ 0x14013D60C (KiGetCpuSetData.c)
    ...
    *v9 = 32 * KiTotalCpuSetCount;
    ...
    while ( v13 )
    {
      ...
      *(_BYTE *)(v16 + 20) = *(_BYTE *)(CpuSetData + 6);
      ...
      {
        if ( !a4 || (*(_DWORD *)(a4 + 776) & 0x8000000) == 0 )
          goto LABEL_10;
        v23 = v21;
      }
      else
