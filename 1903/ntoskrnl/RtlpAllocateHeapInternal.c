/*
 * XREFs of RtlpAllocateHeapInternal @ 0x1401112F4
 * Callers:
 ...
 *     RtlpHpConvertFlagsToSegmentFlags @ 0x1401113E4 (RtlpHpConvertFlagsToSegmentFlags.c)
...
void *__fastcall RtlpAllocateHeapInternal(_DWORD *HeapHandle, unsigned __int64 a2, unsigned int a3, __int16 a4)
{
  ...
  if ( v11 )
  {
    ...
    {
      if ( (_WORD)v11 == 1 )
        v13 = ((__int64 (__fastcall *)(_DWORD *, _QWORD, __int64, unsigned __int64 *))CLFS_LSN_NULL_EXT)(
                HeapHandle,
                0LL,
                1LL,
                &v19);
  ...
  if ( v11 )
  {
    ...
    if ( (_WORD)v11 == 1 )
      v12 = ((__int64 (__fastcall *)(_DWORD *, void *, __int64, __int64))CLFS_LSN_NULL_EXT)(HeapHandle, v7, 2LL, v18);
    if ( v12 < 0 )
    {
