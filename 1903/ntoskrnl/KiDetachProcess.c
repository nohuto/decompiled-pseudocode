/*
 * XREFs of KiDetachProcess @ 0x14003A6F0
 * Callers:
 ...
 *     KeDetachProcess @ 0x140137F30 (KeDetachProcess.c)
 * Callees:
...
unsigned __int64 __fastcall KiDetachProcess(struct _KTHREAD *a1, char a2)
{
  ...
  $6EAC78A6FCFADE0A5FA44F358736B38F *v11; // rdi
  $65FB4D7BD08F5AAB9FF163CC40489905 *v12; // rcx
...
LABEL_82:
  ...
  if ( !CurrentThread->ApcStateIndex
    ...
    || (v11 = &CurrentThread->152, ($6EAC78A6FCFADE0A5FA44F358736B38F *)v11->ApcState.ApcListHead[0].Flink != v11)
  ...
  if ( a1 == (struct _KTHREAD *)&CurrentThread->600 )
  {
    ...
    if ( ($65FB4D7BD08F5AAB9FF163CC40489905 *)v12->SavedApcState.ApcListHead[0].Flink == v12 )
    {
...
LABEL_39:
  ...
  if ( ($6EAC78A6FCFADE0A5FA44F358736B38F *)v11->ApcState.ApcListHead[0].Flink != v11 )
  {
    LOBYTE(v18) = 1;
