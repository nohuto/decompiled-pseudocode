/*
 * XREFs of PopFxInitializeSocSubsystemStaticInfo @ 0x1408A5B10
 * Callers:
...
LABEL_18:
      ...
      if ( v3 )
        goto LABEL_29;
      v20 = (unsigned int **)qword_140444448;
      if ( *(__int64 **)qword_140444448 != &SocSubsystemsList )
        __fastfail(3u);
      *(_QWORD *)v5 = &SocSubsystemsList;
      *((_QWORD *)v5 + 1) = v20;
      *v20 = v5;
      qword_140444448 = (__int64)v5;
    }
    else
    {
