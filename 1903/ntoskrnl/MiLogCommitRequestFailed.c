/*
 * XREFs of MiLogCommitRequestFailed @ 0x1408984C8
 * Callers:
 ...
 *     PsQueryJobMemoryUsageByProcess @ 0x1408C757C (PsQueryJobMemoryUsageByProcess.c)
 */
    ...
    if ( ((unsigned __int16)v3 & 0x400) == 0 )
    {
      ...
      if ( hProvider->LevelPlus1 > 5 )
      {
        ...
        if ( (_BYTE)v3 )
        {
          ...
          v61 = 8LL;
          v63 = 8LL;
          LOBYTE(v3) = TlgWriteEx(v14, &unk_14038E197, 0LL, 1u, 0LL, 0LL, 0xFu, &pData);
        }
      }
    }
  }
