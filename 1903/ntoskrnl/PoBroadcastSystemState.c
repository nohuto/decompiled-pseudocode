/*
 * XREFs of PoBroadcastSystemState @ 0x140597FF0
 * Callers:
 ...
 *     PopSetupSleepNotifies @ 0x14059AD60 (PopSetupSleepNotifies.c)
 ...
 *     PopUpdateSmbiosData @ 0x140725284 (PopUpdateSmbiosData.c)
 ...
 *     IoNotifyPowerOperationVetoed @ 0x1408600C8 (IoNotifyPowerOperationVetoed.c)
...
__int64 __fastcall PoBroadcastSystemState(__int64 a1, __int64 a2, __int64 a3, __int64 a4)
{
  ...
  v4 = *(_BYTE *)(a1 + 25);
  v6 = (char *)qword_140442FD0;
  *(_BYTE *)qword_140442FD0 = *(_BYTE *)(a1 + 26);
...
LABEL_34:
    ...
    v17 = *(_DWORD *)(a1 + 16);
    if ( v17 == 4 && (PopShutdownPowerOffPolicy || *(_QWORD *)&qword_140443070) )
    {
      v18 = 4LL;
    }
    else
    ...
    *((_DWORD *)v6 + 1) = 1;
    if ( *(_BYTE *)(a1 + 26) != 2
      || (PopDiagTraceEventNoPayload(&POP_ETW_EVENT_DEVICESWAKE),
          qword_140443518 = KeQueryPerformanceCounter(0LL).QuadPart,
          *v6 == 2) )
    {
      if ( v11 )
        PopFxActivateDevicesForSx(1u);
    ...
    do
    {
      ...
      if ( v24 == 1 && *(_BYTE *)(a1 + 26) == 2 && !v11 )
      {
        ...
        if ( PoResumeFromHibernate )
        {
          if ( qword_140443080 )
          {
            v30 = *(_QWORD *)(qword_140443080 + 216);
            if ( v30 )
              PopBootLoaderSiData(v30);
          }
          v31 = *(_QWORD *)(qword_140443080 + 200);
          v32 = *(_QWORD *)(v31 + 968);
    ...
    {
      PopFxIdleDevicesFromSx();
      qword_140443520 = KeQueryPerformanceCounter(0LL).QuadPart;
