/*
 * XREFs of ExpCreateOutputSIGNATURE @ 0x14090DB74
 * Callers:
  ...
  if ( *a2 >= v13 )
  {
    ...
    *(_DWORD *)(a1 + 8) = 2;
    ...
    if ( a8 == 1 )
    {
      ...
      if ( (int)result < 0 )
        return result;
      wcscat_s((wchar_t *)(v14 + 2LL * (unsigned int)v15), v9 - (unsigned int)v15, Src);
      ExFreePoolWithTag(Src, 0);
      LODWORD(v17) = (unsigned __int16)v20 >> 1;
    }
    else
    {
      swprintf_s((wchar_t *)(v14 + 2LL * (unsigned int)v15), v9 - (unsigned int)v15, L"%08x", *a3);
      v17 = -1LL;
      do
        ++v17;
    ...
    if ( (_DWORD)v12 )
      wcscpy_s((wchar_t *)(v14 + 2 * v19), v9 - (unsigned int)v19, a7);
    a2 = v22;
  }
  else
  {
