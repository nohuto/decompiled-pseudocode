/*
 * XREFs of ExpQuerySystemInformation @ 0x1405CAF30
 * Callers:
 ...
 *     MmGetLowestPhysicalPage @ 0x14013D634 (MmGetLowestPhysicalPage.c)
 ...
 *     HvlQueryActiveProcessors @ 0x1402851E0 (HvlQueryActiveProcessors.c)
 *     HvlQueryProcessorTopologyCount @ 0x1402853F0 (HvlQueryProcessorTopologyCount.c)
 ...
 *     IoQueryLowPriorityIoInformation @ 0x1406EB460 (IoQueryLowPriorityIoInformation.c)
 *     SmQueryStoreInformation @ 0x1406EEEA4 (SmQueryStoreInformation.c)
 *     ExpReadComPlusPackage @ 0x1406EFC80 (ExpReadComPlusPackage.c)
 *     ExpQueryModuleInformationEx @ 0x140714A68 (ExpQueryModuleInformationEx.c)
 *     HvlQueryVsmProtectionInfo @ 0x14072CCA4 (HvlQueryVsmProtectionInfo.c)
 *     CmQueryRegistryQuotaInformation @ 0x14072D1A0 (CmQueryRegistryQuotaInformation.c)
 ...
 *     HvlQueryEnlightenmentInfo @ 0x1407891CC (HvlQueryEnlightenmentInfo.c)
 ...
 *     ExpGetSystemProcessorFeaturesInformation @ 0x14090934C (ExpGetSystemProcessorFeaturesInformation.c)
...
LABEL_119:
        ...
        case 0x24u:
          ...
          *(_DWORD *)(a4 + 8) = dword_14044D988;
          *(_DWORD *)(a4 + 12) = dword_14044D984;
          *(_DWORD *)(a4 + 16) = dword_14044D98C;
          *(_DWORD *)(a4 + 20) = dword_14044D990;
          *(_DWORD *)(a4 + 24) = dword_14044D998;
          *(_DWORD *)(a4 + 28) = dword_14044D994;
          *(_DWORD *)(a4 + 32) = dword_14044D99C;
          *(_DWORD *)(a4 + 36) = dword_14044D9A0;
          *(_DWORD *)(a4 + 40) = dword_14044D9A4;
          *(_DWORD *)(a4 + 44) = dword_14044D9A8;
          v32 = 48;
LABEL_270:
          LODWORD(Size) = v32;
          VerifierInformation = HIDWORD(Size);
...
LABEL_305:
        ...
        case 0x99u:
          ...
          if ( Length >= 0x20 )
          {
            ...
            *(_QWORD *)(a4 + 16) = xmmword_1404450F0;
            *(_DWORD *)(a4 + 24) = DWORD2(xmmword_1404450F0);
LABEL_517:
            VerifierInformation = HIDWORD(Size);
            goto LABEL_625;
          }
...
LABEL_141:
        ...
        case 0x9Cu:
          ...
          goto LABEL_625;
        case 0x9Du:
          LODWORD(Size) = WORD1(qword_140432508) + 24;
          if ( Length >= (unsigned int)Size )
          {
            v85 = (void *)(a4 + 24);
            *(_QWORD *)a4 = 0LL;
            ...
            *(_DWORD *)(a4 + 8) = qword_140432508;
            if ( (_WORD)qword_140432508 )
            {
              *(_QWORD *)(a4 + 16) = v85;
              memmove(v85, qword_140432510, WORD1(qword_140432508));
            }
            VerifierInformation = HIDWORD(Size);
          }
          else
        ...
        case 0xB6u:
          ...
          *(_QWORD *)&Src[0] = *(_QWORD *)(*(_QWORD *)(qword_140466188 + 8LL * v22) + 7888LL) << 12;
...
LABEL_60:
        ...
        case 0xB8u:
          ...
          *(_QWORD *)&Src[0] = *(_QWORD *)(*(_QWORD *)(qword_140466188 + 8LL * v28) + 7888LL) << 12;
