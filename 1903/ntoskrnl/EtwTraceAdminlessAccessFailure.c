/*
 * XREFs of EtwTraceAdminlessAccessFailure @ 0x1408FD7E8
 * Callers:
  ...
  if ( a3 )
  {
    if ( stru_140426618.LevelPlus1 > 5 )
    {
      ...
      if ( (_BYTE)v5 )
      {
        ...
        v32 = 4LL;
        v34 = 4LL;
        LOBYTE(v5) = TlgWrite(&stru_140426618, &unk_1403944F6, 0LL, 0LL, 7u, &pData);
      }
    }
  }
  else if ( a4 )
  {
    if ( stru_140426618.LevelPlus1 > 5 )
    {
      ...
      if ( (_BYTE)v5 )
      {
        ...
        v50[1] = 0;
        v52 = 4LL;
        LOBYTE(v5) = TlgWrite(&stru_140426618, &unk_140394463, 0LL, 0LL, 6u, &v44);
      }
    }
  }
  else if ( stru_140426618.LevelPlus1 > 5 )
  {
    LOBYTE(v5) = TlgKeywordOn(&stru_140426618, 0x400000000000uLL);
    if ( (_BYTE)v5 )
    {
      ...
      v41[1] = 0;
      v43 = 4LL;
      LOBYTE(v5) = TlgWrite(&stru_140426618, &unk_1403944AB, 0LL, 0LL, 6u, &v35);
    }
  }
