/*
 * XREFs of ExfWaitForRundownProtectionRelease @ 0x1401149E0
 * Callers:
...
char __fastcall ExfWaitForRundownProtectionRelease(volatile signed __int64 *a1, unsigned __int64 a2)
{
  ...
  signed __int32 v16[6]; // [rsp+50h] [rbp-18h] BYREF
...
LABEL_11:
      ...
      *((_QWORD *)&Object + 1) = (char *)&Object + 8;
      ...
      if ( _interlockedbittestandreset(v16, 0) )
        LOBYTE(v5) = KeWaitForSingleObject(&Object, Executive, 0, 0, 0LL);
    }
