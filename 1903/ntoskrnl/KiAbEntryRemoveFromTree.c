...
__int64 __fastcall KiAbEntryRemoveFromTree(__int64 a1)
{
  ...
  v21 = *(_DWORD *)(a1 + 40);
  v20 = *(_QWORD *)(a1 + 32) & 0x7FFFFFFFFFFFFFFCLL;
  v2 = ((v20 >> 4) & 0x3FF) << 6;
...
LABEL_14:
    ...
    if ( i )
    {
      ...
      if ( v13 )
      {
        ...
        v23.LockQueue.Lock = (unsigned __int64 *volatile)(v17 + 80);
        KxAcquireQueuedSpinLock((__int64)&v23, (volatile __int64 *)(v17 + 80));
        ExReleaseSpinLockExclusiveFromDpcLevel(v3);
        v18 = *(_WORD *)(v17 + 90);
        *(_OWORD *)(v17 + 48) = *(_OWORD *)(v8 + 48);
        *(_OWORD *)(v17 + 64) = *(_OWORD *)(v8 + 64);
        *(_WORD *)(v17 + 90) ^= (*(_WORD *)(v8 + 90) ^ v18) & 0x1FE;
        *(_WORD *)(v17 + 90) = *(_WORD *)(v8 + 90) ^ (*(_WORD *)(v8 + 90) ^ *(_WORD *)(v17 + 90)) & 0x1FF;
...
LABEL_21:
  ...
  *(_BYTE *)(a1 + 39) &= ~0x80u;
  if ( (*(_BYTE *)(a1 + 25) & 1) != 0 )
  {
    ...
    RtlRbRemoveNode(v8 + 64);
  }
  else
  {
    RtlRbRemoveNode(v8 + 48);
  }
LABEL_26:
  KeReleaseInStackQueuedSpinLockFromDpcLevel(&LockHandle);
  ...
  if ( (*(_BYTE *)(a1 + 25) & 1) != 0 )
    ...
    _InterlockedExchangeAdd8((volatile signed __int8 *)(v15 + 1423), 0xFFu);
