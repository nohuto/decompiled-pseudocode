/*
 * XREFs of RtlNumberOfSetBitsEx @ 0x14030DAB0
 * Callers:
 ...
 *     IoSetDumpRangeForPartialKernelDump @ 0x14029CB40 (IoSetDumpRangeForPartialKernelDump.c)
 ...
 *     RtlNumberOfClearBitsEx @ 0x14030DA50 (RtlNumberOfClearBitsEx.c)
...
__int64 __fastcall RtlNumberOfSetBitsEx(_QWORD *a1)
{
  ...
  for ( i = 0; v7; --v7 )
  {
    v12 = *v1++;
    if ( i == v6 - 1 && v3 )
      v12 &= byte_1403821E8[v3];
    ++i;
    v4 += RtlpBitsClearTotal[(unsigned __int8)~v12];
  }
  if ( v10 )
  {
    v13 = ((v10 - 1) >> 3) + 1;
