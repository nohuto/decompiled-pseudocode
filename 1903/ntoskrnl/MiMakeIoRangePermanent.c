/*
 * XREFs of MiMakeIoRangePermanent @ 0x1402C4C54
 * Callers:
...
__int64 __fastcall MiMakeIoRangePermanent(__int64 a1)
{
  ...
  v31 = 0LL;
  v6 = 0;
  v30 = ExAcquireSpinLockExclusive(&dword_140466780);
  v7 = v30;
  v8 = v5 + 1;
  if ( !v8 )
    goto LABEL_34;
  do
  {
    v9 = (_QWORD *)qword_140466790;
    for ( i = qword_140466790 == 0; ; i = v12 == 0LL )
    {
      if ( i )
      {
        v17 = MiRemoveUnmappedIoNode((unsigned __int64 *)&qword_140466798, v1);
        v18 = (_QWORD *)v17;
        if ( !v17 )
        {
          v19 = v1 & 0x1FF;
...
LABEL_40:
  ...
  v26 = 0;
LABEL_43:
  RtlAvlInsertNodeEx((unsigned __int64 *)&qword_1404667E0, (unsigned __int64)v25, v26, (_QWORD *)a1);
LABEL_44:
