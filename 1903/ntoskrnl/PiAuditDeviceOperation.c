/*
 * XREFs of PiAuditDeviceOperation @ 0x140878184
 * Callers:
...
__int64 __fastcall PiAuditDeviceOperation(__int64 a1, int a2, char a3)
{
  ...
  __int64 v47; // [rsp+90h] [rbp-41h] BYREF
  void *v48; // [rsp+98h] [rbp-39h]
  __int64 v49; // [rsp+A0h] [rbp-31h] BYREF
  void *v50; // [rsp+A8h] [rbp-29h]
  __int64 v51; // [rsp+B0h] [rbp-21h] BYREF
  void *v52; // [rsp+B8h] [rbp-19h]
  int v53; // [rsp+C0h] [rbp-11h] BYREF
  const WCHAR *v54; // [rsp+C8h] [rbp-9h] BYREF
...
LABEL_70:
      ...
      if ( v38 == 25 )
      {
        AlternateStringData = PnpFindAlternateStringData(v32, v43, &v54, &v53);
        v38 = 18;
        v36 = v32;
