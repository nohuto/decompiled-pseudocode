/*
 * XREFs of MiAssignSoftwareWsleRegion @ 0x140187F58
 * Callers:
...
__int64 __fastcall MiAssignSoftwareWsleRegion(__int64 a1, unsigned __int64 a2)
{
  ...
  *(&BitMapHeader.SizeOfBitMap + 1) = 0;
  ...
  while ( v11 );
  qword_140465EA8 = v15[1];
  qword_140465EB0 = v15[1];
  qword_140465EB8 = v15[1];
  qword_140465DC8 = v15[5];
  qword_140465DC0 = v15[4];
  *(_QWORD *)(*(_QWORD *)(a1 + 240) + 2912LL) = v15[4];
  result = qword_140465DC8;
  *(_QWORD *)(*(_QWORD *)(a1 + 240) + 2920LL) = qword_140465DC8;
  return result;
}
