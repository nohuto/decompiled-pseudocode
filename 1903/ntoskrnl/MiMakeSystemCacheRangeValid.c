/*
 * XREFs of MiMakeSystemCacheRangeValid @ 0x1400D8290
 * Callers:
...
void __fastcall MiMakeSystemCacheRangeValid(unsigned __int64 a1, unsigned __int64 a2, unsigned int a3, __int64 a4)
{
  ...
  {
    v9 = (LONG *)&unk_14046A540;
    if ( (byte_14046A538 & 7) == 2 )
      v9 = &dword_140467200;
  ...
  MiLockPageTableInternal((__int64)&unk_14046A480, v8, 0LL);
  ...
  v21 = BYTE5(v68) | 4;
  BYTE5(v68) |= 4u;
  v22 = *(_QWORD *)(qword_140466188 + 8LL * (*(_WORD *)(*(_QWORD *)v20 + 60LL) & 0x3FF)) + 0x2000LL;
  v71 = v22;
  v23 = v22;
  v67 = v22;
  if ( (_DWORD)v4 )
        ...
        if ( !*(_QWORD *)(v45 + 32) )
        {
          ...
          if ( v49 )
          {
            if ( (unsigned int)PfSnCheckLoggingForThread((__int64)CurrentThread, (__int64)v49, 4) )
              PfSnLogPageFaultCommon((__int64)v50, v45, *(_QWORD *)(v45 + 24), v46, v51);
...
LABEL_84:
        ...
        else
        {
          while ( 1 )
          {
            ...
            if ( v48 == v47 )
              break;
            if ( (v45 ^ (unsigned __int64)v47) >= 0xF )
              goto LABEL_84;
          }
        }
      }
