/*
 * XREFs of sub_14091F4AC @ 0x14091F4AC
 * Callers:
...
__int64 __fastcall sub_14091F4AC(__int64 a1, __int64 a2, int a3, __int64 a4)
{
  unsigned int *v4; // r8
  signed int v8; // ebx
  unsigned int *v9; // rax
...
LABEL_29:
    if ( v8 >= 0 )
    {
      ...
      if ( qword_1409AD3C8 )
        v22 = qword_1409AD3C8(PoolWithTag);
      else
        v22 = -1073741637;
      v8 = v22;
      if ( v22 < 0 )
      ...
      if ( *(_DWORD *)(a2 + 16) >= 0xFFFFEFC0 )
        goto LABEL_102;
      v24 = *(_DWORD *)(a2 + 16) + 4164;
      if ( v24 < *(_DWORD *)(a2 + 16) + 4160 )
        goto LABEL_102;
...
LABEL_103:
      ...
      *(_DWORD *)(a4 + 4) = 4136;
      v8 = 0;
      v25 = ExAllocatePoolWithTag(PagedPool, 0x1028uLL, 0x20534C53u);
      if ( v25 )
      {
        *(_QWORD *)(a4 + 8) = v25;
        *(_DWORD *)a4 = 0;
...
LABEL_85:
          if ( v47 + 1 < v47 )
            goto LABEL_102;
          v8 = 0;
          if ( (unsigned __int64)(v47 + 1027) <= v42 + (unsigned __int64)*(unsigned int *)(a4 + 4) )
          {
            *v47 = 4104;
            memmove(v47 + 1, PoolWithTag, 0x1008uLL);
            ++*(_DWORD *)a4;
            goto LABEL_88;
          }
LABEL_58:
