/*
 * XREFs of KeFindConfigurationNextEntry @ 0x140A1FCF0
 * Callers:
 *     KeFindConfigurationEntry @ 0x140A1FCC0 (KeFindConfigurationEntry.c)
 *     KeFindConfigurationNextEntry @ 0x140A1FCF0 (KeFindConfigurationNextEntry.c)
 * Callees:
 *     KeFindConfigurationNextEntry @ 0x140A1FCF0 (KeFindConfigurationNextEntry.c)
 */
