/*
 * XREFs of PopPlTraceLogPowerPlane @ 0x140305794
 * Callers:
...
int __fastcall PopPlTraceLogPowerPlane(unsigned __int16 *a1, __int64 a2, ULONG64 a3, ULONG a4)
{
  ...
  if ( pCallbackContext.LevelPlus1 > 5 )
  {
    ...
    v69 = 4LL;
    v71 = 4LL;
    TlgWriteEx(&pCallbackContext, &unk_1403913DE, a3, a4, v14, v15, 7u, &pData);
  }
  v5 = *((_QWORD *)a1 + 6);
  for ( i = 0LL; i < v5; ++i )
  {
    ...
    if ( pCallbackContext.LevelPlus1 > 5 )
    {
      ...
      v40 = 2LL;
      v42 = 32LL;
      TlgWriteEx(&pCallbackContext, &unk_1403914C9, a3, a4, v14, v15, 0xBu, &v24);
    }
    v5 = *((_QWORD *)a1 + 6);
  }
  v8 = 0LL;
      ...
      if ( v10[9] )
      {
        do
        {
          ...
          if ( pCallbackContext.LevelPlus1 > 5 )
          {
            ...
            v57 = 2LL;
            v60 = 0;
            LODWORD(v5) = TlgWriteEx(&pCallbackContext, &unk_14039143C, a3, a4, v14, v15, 0xAu, &v43);
          }
          ++v9;
        }
        while ( v9 < v10[9] );
