/*
 * XREFs of PpmParkRegisterParking @ 0x14019397C
 * Callers:
...
__int64 PpmParkRegisterParking()
{
  ...
  *(_QWORD *)&Affinity.Group = 0LL;
  ...
  if ( PpmParkNodes )
  {
    ...
    if ( (_DWORD)v2 )
    {
      ...
      do
      {
        ...
        {
          LODWORD(v91[0]) = 1310721;
          memset((char *)v91 + 4, 0, 0xA4uLL);
          v55 = *((_WORD *)v5 - 71);
          v56 = *(_QWORD *)(v5 - 138);
          if ( v55 )
            LOWORD(v91[0]) = v55 + 1;
  ...
  {
    LODWORD(v10) = 0;
    v87 = qword_14042A7F8[0];
    v86 = (unsigned __int16 *)PpmCheckRegistered;
    while ( !(unsigned int)KeEnumerateNextProcessor(&v80, &v86) )
    {
      Prcb = KeGetPrcb(v80);
...
LABEL_51:
  ...
  *((_QWORD *)v18 + 1) = v17;
  ...
  if ( (unsigned int)v0 < v78 )
    ...
    v31 = 0LL;
  if ( (int)PpmIdleInitializeConcurrency(v91, v18 + 72, v31) < 0 )
  {
    v36 = 0LL;
    goto LABEL_61;
  }
  ...
  while ( 1 )
  {
    ...
    if ( *v22 )
    {
      ...
      if ( v59 )
        LOWORD(v91[0]) = v59 + 1;
      v91[v59 + 1] |= v60;
      v61 = (unsigned int)v0 >= v78 ? 0LL : (char *)P + 272 * v0 + 8 * v23 + 152;
      if ( (int)PpmIdleInitializeConcurrency(v91, &v18[8 * v23 + 152], v61) < 0 )
        break;
    }
    ++v57;
    ++v23;
