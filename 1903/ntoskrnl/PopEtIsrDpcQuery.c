/*
 * XREFs of PopEtIsrDpcQuery @ 0x1406D4854
 * Callers:
 ...
 *     KeQueryCycleTimeStatsProcessor @ 0x14012A5A4 (KeQueryCycleTimeStatsProcessor.c)
...
__int64 __fastcall PopEtIsrDpcQuery(__int64 a1, _OWORD *a2)
{
  ...
  int v11; // [rsp+3Ah] [rbp-5Eh]
  __int16 v12; // [rsp+3Eh] [rbp-5Ah]
  _QWORD v13[8]; // [rsp+40h] [rbp-58h] BYREF
  ...
  v9[1] = (unsigned __int16 *)qword_140572748[0];
