/*
 * XREFs of KeLoadMTRR @ 0x14059DD00
 * Callers:
 *     KiLoadMTRRTarget @ 0x1405A31F0 (KiLoadMTRRTarget.c)
 * Callees:
 *     KeFlushCurrentTbImmediately @ 0x14017CD10 (KeFlushCurrentTbImmediately.c)
 *     __security_check_cookie @ 0x14019E700 (__security_check_cookie.c)
 *     KiLockStepExecution @ 0x14059DEE8 (KiLockStepExecution.c)
 *     KiWriteFixedMtrr @ 0x14059DF2C (KiWriteFixedMtrr.c)
 *     KiReadFixedMtrr @ 0x14059E038 (KiReadFixedMtrr.c)
 *     KiCompareVarMtrr @ 0x14059E144 (KiCompareVarMtrr.c)
 */
...
__int64 __fastcall KeLoadMTRR(__int64 a1)
{
  ...
  if ( byte_140447090 )
  {
    ...
    if ( qword_1404470A0 )
    {
      ...
      {
        v2 = 0LL;
        v3 = (PVOID)((_BYTE *)qword_1404470A0 - v18);
        v4 = v18;
...
LABEL_11:
    ...
    if ( (_BYTE)qword_140447088 )
    {
      ...
      do
      {
        v13 = qword_140447098;
        v14 = 2 * v11;
        __writemsr(v12 - 1, *((_QWORD *)qword_140447098 + v14));
        v9 = HIDWORD(v13[v14 + 1]);
        __writemsr(v12, v13[v14 + 1]);
        v11 = ++v10;
        v12 += 2;
      }
      while ( v10 < (unsigned __int64)(unsigned __int8)qword_140447088 );
    }
    if ( qword_1404470A0 )
      KiWriteFixedMtrr(qword_1404470A0, v9);
