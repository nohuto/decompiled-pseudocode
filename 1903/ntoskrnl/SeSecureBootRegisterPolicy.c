/*
 * XREFs of SeSecureBootRegisterPolicy @ 0x140A0942C
 * Callers:
 ...
 *     SepSecureBootBuildRules @ 0x140A3DE60 (SepSecureBootBuildRules.c)
...
__int64 __fastcall SeSecureBootRegisterPolicy(ULONG_PTR BugCheckParameter2, ULONG_PTR BugCheckParameter3)
{
  ...
  qword_14046BFF8 = *(_QWORD *)(BugCheckParameter2 + 16);
  ...
  if ( v6[18] || v6[19] )
  {
    qword_14050ECD0 = (__int64)v10 + v10[13] + 60;
...
LABEL_32:
              if ( qword_140509E00 )
              {
                ExFreePoolWithTag(qword_140509E00, 0);
                qword_140509E00 = 0LL;
              }
