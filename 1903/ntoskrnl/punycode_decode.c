/*
 * XREFs of punycode_decode @ 0x1408D579C
 * Callers:
 *     RtlpIdnToUnicodeWorker @ 0x140313034 (RtlpIdnToUnicodeWorker.c)
 * Callees:
 *     _wcsnicmp @ 0x1401A0240 (_wcsnicmp.c)
 *     FindLabelEnd @ 0x140312F58 (FindLabelEnd.c)
 *     InsertChar @ 0x14031300C (InsertChar.c)
 *     ValidateStd3Range @ 0x140313664 (ValidateStd3Range.c)
 *     adapt @ 0x1403136A0 (adapt.c)
 */
