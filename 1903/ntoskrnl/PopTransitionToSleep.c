/*
 * XREFs of PopTransitionToSleep @ 0x14059BD10
 * Callers:
 *     <none>
 * Callees:
...
LONG __fastcall PopTransitionToSleep(struct _KEVENT *a1)
{
  ...
  if ( Lock == 3 || Lock == 6 )
  {
    ...
    {
      if ( (dword_14044304C & 0x20) != 0 && PopEnableMinimalHiberFile || PopForceMinimalHiberFile )
      {
        MmEmptyAllWorkingSets();
        v6 = 1;
      }
...
LABEL_12:
  ...
  KeSetEvent(a1, 0, 1u);
  KeWaitForSingleObject(&a1[1], Executive, 0, 0, 0LL);
  v9 = PopInvokeSystemStateHandler(Lock, qword_140443080);
LABEL_15:
  v10 = v9;
LABEL_16:
  qword_140443660 = __rdtsc();
