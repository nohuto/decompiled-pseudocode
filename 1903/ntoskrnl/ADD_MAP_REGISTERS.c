...
void __fastcall ADD_MAP_REGISTERS(__int64 a1, unsigned int a2, char a3)
{
  ...
  {
    ViHalPreprocessOptions(byte_14042B8A4, "Allocated too many map registers : %x (max %x).", 21, v5);
    VfReportIssueWithOptions(0xE6u, 0x15uLL, v5, *(unsigned int *)(a1 + 152), 0LL, byte_14042B8A4);
  }
}
