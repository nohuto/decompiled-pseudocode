/*
 * XREFs of EtwInitializeSiloState @ 0x14076CFF8
 * Callers:
 ...
 *     EtwpInitializeHashBucket @ 0x14076D410 (EtwpInitializeHashBucket.c)
...
LABEL_12:
  ...
  *((_QWORD *)PsGetServerSiloGlobals((__int64)a1) + 108) = v4;
  ...
  EtwpQueryPartitionRegistryInformation(
    ...
    (GUID *)(v4 + 4168));
  if ( IsHostSilo )
    qword_140A506D8 = KeQueryPerformanceCounter(0LL).QuadPart;
  EtwpInitializeAutoLoggers();
  if ( IsHostSilo )
    qword_140A506E0 = KeQueryPerformanceCounter(0LL).QuadPart;
