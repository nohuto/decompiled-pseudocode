/*
 * XREFs of ExpSetTimerObject @ 0x140008C70
 * Callers:
 ...
 *     KiRemoveEntryTimer @ 0x140130EFC (KiRemoveEntryTimer.c)
        ...
        _BYTE *a10)
{
  ...
  if ( a7 )
  {
    ...
    {
      v92 = ExpCheckWakeTimerAccess((unsigned __int8)KeGetCurrentThread()->$42514DC6747B59BF81E16C40547B231E::gap0[10]);
      v146 = v92;
      if ( v92 )
      {
  ...
  if ( (int)qword_140443C40 < 2 && !byte_140443C13 )
  {
    v146 = 1073741861;
    a6 = 0LL;
    goto LABEL_3;
...
LABEL_93:
  ...
  if ( v71 && ($6EAC78A6FCFADE0A5FA44F358736B38F *)v66->ApcState.ApcListHead[0].Flink != &v66->152 )
...
LABEL_189:
    ...
    if ( v71 && ($6EAC78A6FCFADE0A5FA44F358736B38F *)v100->ApcState.ApcListHead[0].Flink != &v100->152 )
      KiCheckForKernelApcDelivery();
    v72 = _interlockedbittestandset64((volatile signed __int32 *)&ExpWakeTimerLock, 0LL);
    if ( v72 )
  ...
  *(_BYTE *)(BugCheckParameter2 + 304) = v29 ^ (v29 ^ (4 * a7)) & 4;
  ...
  if ( v139 )
  {
    ...
    else if ( a6 )
    {
      ...
      v74 = (_QWORD *)qword_14042F5F8;
      v42 = &ExpWakeTimerList;
      if ( *(__int64 **)qword_14042F5F8 != &ExpWakeTimerList )
        __fastfail(3u);
      *v73 = &ExpWakeTimerList;
      *(_QWORD *)(BugCheckParameter2 + 272) = v74;
      *v74 = v73;
      qword_14042F5F8 = BugCheckParameter2 + 264;
    }
...
LABEL_120:
    ...
    if ( v71 && ($6EAC78A6FCFADE0A5FA44F358736B38F *)v76->ApcState.ApcListHead[0].Flink != &v76->152 )
      KiCheckForKernelApcDelivery();
