/*
 * XREFs of KiTpEmulateInstruction @ 0x1402B4798
 * Callers:
 ...
 *     KiTpDecodeModRm @ 0x1402B4060 (KiTpDecodeModRm.c)
 *     KiTpDecodeModRmOperand @ 0x1402B4148 (KiTpDecodeModRmOperand.c)
 *     KiTpEmulateGroup0Instruction @ 0x1402B42AC (KiTpEmulateGroup0Instruction.c)
 *     KiTpEmulateGroup11Instruction @ 0x1402B4508 (KiTpEmulateGroup11Instruction.c)
 *     KiTpEmulateGroup1Instruction @ 0x1402B45B8 (KiTpEmulateGroup1Instruction.c)
 *     KiTpEmulateMovRegImm @ 0x1402B4DFC (KiTpEmulateMovRegImm.c)
 *     KiTpEmulateMovzx @ 0x1402B4E8C (KiTpEmulateMovzx.c)
 *     KiTpEmulateRegisterPushPop @ 0x1402B4F8C (KiTpEmulateRegisterPushPop.c)
 *     KiTpFetchInstructionBytes @ 0x1402B50B4 (KiTpFetchInstructionBytes.c)
 *     KiTpGetRegisterAddressByIndex @ 0x1402B50F4 (KiTpGetRegisterAddressByIndex.c)
 *     KiTpReadOperandValue @ 0x1402B5258 (KiTpReadOperandValue.c)
 *     KiTpSetFlagsZeroSignParity @ 0x1402B54A4 (KiTpSetFlagsZeroSignParity.c)
 *     KiTpSetImmediateOperandSize @ 0x1402B5514 (KiTpSetImmediateOperandSize.c)
 *     KiTpSignExtendOperandValue @ 0x1402B5544 (KiTpSignExtendOperandValue.c)
 *     KiTpWriteRegisterValue @ 0x1402B556C (KiTpWriteRegisterValue.c)
 */
