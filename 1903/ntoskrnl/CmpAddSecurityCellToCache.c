/*
 * XREFs of CmpAddSecurityCellToCache @ 0x14063CFF4
 * Callers:
 ...
 *     CmpSecConvKey @ 0x14063D44C (CmpSecConvKey.c)
...
__int64 CmpAddSecurityCellToCache(__int64 a1, __int64 a2, char a3, ...)
{
  ...
  v7 = (*(__int64 (__fastcall **)(__int64, _QWORD, _DWORD *))(a1 + 8))(a1, v4, v29);
  v8 = v7;
  if ( v7 )
  {
    ...
    if ( *(_DWORD *)(v7 + 16) < 0xFFFFFFE0 && (_DWORD)v9 != 32 )
    {
      ...
      if ( v10 )
      {
        ...
        *(_QWORD *)(v16 + 8) = v15;
        ...
        v20 = 2 * v18;
        *(_DWORD *)(*(_QWORD *)(a1 + 1880) + 8 * v20) = v4;
