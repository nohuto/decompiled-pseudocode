/*
 * XREFs of KsepMatchInitBiosInfo @ 0x140A02640
 * Callers:
...
__int64 KsepMatchInitBiosInfo()
{
  ...
  KeyHandle = 0LL;
  memset(&qword_140508A88, 0, 0x38uLL);
  v0 = -1;
  ...
  if ( v1 >= 0 )
  {
    ...
    if ( MULTISZ >= 0 )
    {
      ...
      MULTISZ = KsepRegistryQueryMULTISZ(KeyHandle, L"SystemBiosVersion", (__int64)&unk_14046BA50, 520LL, (__int64)&v12);
      word_14046BC56 = 0;
      v4 = 0LL;
      v5 = &unk_14046BA50;
      while ( *v5 != 32 )
...
LABEL_11:
  ...
  {
    qword_140508A88 = (__int64)&unk_14046BA50;
    dword_140508AB0 = v0;
  }
