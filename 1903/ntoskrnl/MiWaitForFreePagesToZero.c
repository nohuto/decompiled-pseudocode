/*
 * XREFs of MiWaitForFreePagesToZero @ 0x14007C090
 * Callers:
...
__int64 __fastcall MiWaitForFreePagesToZero(__int64 a1, __int64 *a2, unsigned int a3)
{
  ...
  while ( 1 )
  {
    while ( 1 )
    {
      ...
      if ( *v5 )
      {
        ...
        if ( (ULONG_PTR *)v9 != &MiSystemPartition )
        {
          ...
          __writecr8(v41);
          v43 = ExAcquireSpinLockExclusive(&dword_140468540);
          v12 = v53;
        ...
        if ( !--qword_1404684A8 )
        {
          v11 = (_QWORD *)qword_1404684D8;
          qword_1404684D8 = 0LL;
        }
        if ( (BYTE6(PerfGlobalGroupMask) & 1) != 0 )
        {
          ExpReleaseSpinLockExclusiveFromDpcLevelInstrumented(&dword_140468540, retaddr);
          LOBYTE(CurrentIrql) = v62;
          v12 = v53;
        }
        else
    ...
    v21 = v55;
LABEL_25:
    if ( !dword_140466950 && (unsigned int)MiSufficientAvailablePages(a1, 160LL) )
      break;
  ...
  if ( (BYTE6(PerfGlobalGroupMask) & 0x21) != 0 )
  {
    ExpAcquireSpinLockExclusiveAtDpcLevelInstrumented(&dword_140468540, v22);
  }
  else
  {
    ...
    if ( _interlockedbittestandset(&dword_140468540, 0x1Fu) )
    {
      ...
      v59 = ExpWaitForSpinLockExclusiveAndAcquire(&dword_140468540, v22);
    }
    v25 = dword_140468540;
    while ( (v25 & 0xBFFFFFFF) != 0x80000000 )
    {
      if ( (v25 & 0x40000000) == 0 )
      {
        v50 = _InterlockedCompareExchange(&dword_140468540, v25 | 0x40000000, v25);
        v18 = v25 == v50;
        v25 = v50;
        if ( !v18 )
          continue;
