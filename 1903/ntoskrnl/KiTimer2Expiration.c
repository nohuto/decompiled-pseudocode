/*
 * XREFs of KiTimer2Expiration @ 0x1400BFE90
 * Callers:
...
LABEL_8:
  ...
  while ( 2 )
  {
    ...
    v14 = (_QWORD *)*v14;
    KiAcquireKobjectLockSafe((volatile signed __int32 *)v18);
    v19 = *(_BYTE *)(v18 + 1);
    if ( (v19 & 2) != 0 )
    {
...
LABEL_18:
  ...
  result = KiShouldActivateHRTimerClock(MEMORY[0xFFFFF78000000008], qword_14044DA48);
  if ( result )
