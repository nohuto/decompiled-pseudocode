/*
 * XREFs of IopGetSetStreamIdentifier @ 0x1402991A4
 * Callers:
 *     IoAllocateSfioStreamIdentifier @ 0x140298370 (IoAllocateSfioStreamIdentifier.c)
 *     IoGetSfioStreamIdentifier @ 0x140298620 (IoGetSfioStreamIdentifier.c)
 * Callees:
...
__int64 __fastcall IopGetSetStreamIdentifier(__int64 a1, unsigned int a2, __int64 a3, __int64 a4, char a5)
{
  ...
  v5 = (_QWORD *)a4;
  LOBYTE(a4) = a5;
  result = IopGetSetSpecificExtension(a1, 4u, 16LL, a4, &v21, &v22);
  v9 = 0;
  if ( (int)result < 0 )
    goto LABEL_38;
  v10 = v21;
