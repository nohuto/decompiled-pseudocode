/*
 * XREFs of MiCheckCommitReleaseFromVad @ 0x1402BAD8C
 * Callers:
 ...
 *     MiComputeCommitChargeForZeroPteRange @ 0x1402BB180 (MiComputeCommitChargeForZeroPteRange.c)
  ...
  for ( i = v12; v10 <= v11; v12 = i )
  {
    ...
    if ( v14 <= v17 )
    {
      while ( 1 )
      {
        ...
        if ( (v18 & 1) != 0 )
        {
          if ( (v18 & 0x200) == 0 || (*(_DWORD *)(a4 + 48) & 0x70) == 0x40 && MiRotatedToFrameBuffer(v10) )
            goto LABEL_47;
          v20 = *(_QWORD *)(48
                          * (((unsigned __int64)MI_READ_PTE_LOCK_FREE((unsigned __int64)&v30) >> 12) & 0xFFFFFFFFFLL)
                          - 0x57FFFFFFFF8LL);
          if ( v20 >= 0 || *(_QWORD *)(a2 + 920) && MiLocateCloneAddress(a2, v20 | 0x8000000000000000uLL) )
            goto LABEL_47;
LABEL_46:
          ++v9;
          goto LABEL_47;
