/*
 * XREFs of SPCallServerHandleWaitForDisplayWindow @ 0x1407474A8
 * Callers:
...
LABEL_15:
  if ( (v13 & 0x80000000) == 0 )
  {
    *(_QWORD *)&DestinationString.Length = 0LL;
    ...
    do
    {
      v16 = KeWaitForSingleObject(&stru_14042C9A0, UserRequest, 1, 1u, 0LL);
      v17 = v16;
    }
    while ( v16 == 257 );
    if ( v16 >= 0 && v16 != 192 )
    {
      do
      {
        v20 = KeWaitForSingleObject(&stru_14042C9C0, UserRequest, 1, 1u, 0LL);
        v17 = v20;
      }
      while ( v20 == 257 );
