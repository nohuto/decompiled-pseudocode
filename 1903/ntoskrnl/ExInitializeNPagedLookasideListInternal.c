/*
 * XREFs of ExInitializeNPagedLookasideListInternal @ 0x1401753A0
 * Callers:
        ...
        int a8)
{
  ...
  *(_QWORD *)(a1 + 80) = 0LL;
  ...
  v13 = (_QWORD *)qword_14042F5B8;
  v14 = (_QWORD *)(a1 + 64);
  if ( *(__int64 **)qword_14042F5B8 != &ExNPagedLookasideListHead )
    __fastfail(3u);
  *v14 = &ExNPagedLookasideListHead;
  v14[1] = v13;
  *v13 = v14;
  qword_14042F5B8 = (__int64)v14;
