/*
 * XREFs of ?ReadPartitionTable@SC_MBR@@QEAAJPEAPEAVSC_DISK_LAYOUT@@@Z @ 0x14034B8D4
 * Callers:
 ...
 *     ?Validate@MBR_ENTRY@@QEAAEK_K@Z @ 0x14034BCB4 (-Validate@MBR_ENTRY@@QEAAEK_K@Z.c)
...
__int64 __fastcall SC_MBR::ReadPartitionTable(SC_DISK **this, struct SC_DISK_LAYOUT **a2)
{
  ...
  unsigned int v27; // [rsp+24h] [rbp-64h]
    ...
    do
    {
      ...
      if ( MBR_ENTRY::Validate((MBR_ENTRY *)(v10 - 4), v14, *((_QWORD *)*this + 30)) )
      {
        *(_DWORD *)&v8[144 * v4 + 48] = 0;
        v16 = (v33 + (unsigned __int64)*((unsigned int *)v10 + 1)) << *((_DWORD *)*this + 58);
...
LABEL_27:
    ...
    else
    {
      ...
      if ( v27 )
        v3 = v27;
      v23 = (char *)SC_ENV::Allocate(144 * v4 + 624);
      v24 = v23;
      if ( v23 )
      {
        memmove(v23, v8, (int)(144 * v4 + 48));
        memset(&v24[144 * v4 + 48], 0, 0x240uLL);
        RtlpSysVolFree(v8);
        v8 = v24;
