/*
 * XREFs of MiRebaseDynamicRelocationRegions @ 0x1409EFE8C
 * Callers:
...
__int64 __fastcall MiRebaseDynamicRelocationRegions(__int64 a1)
{
  ...
  v18 = qword_140467590;
  v6 = *v2;
  if ( (MiFlags & 0x8000) == 0 && qword_1404675D0 == 0xFFFFF68000000000uLL )
    goto LABEL_18;
  v7 = 0;
  if ( 8 * (((unsigned __int64)qword_1404675D0 >> 39) & 0x1FF) != 3944 )
  {
