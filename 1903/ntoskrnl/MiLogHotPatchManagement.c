/*
 * XREFs of MiLogHotPatchManagement @ 0x14088F548
 * Callers:
 ...
 *     _TlgCreateSid @ 0x14008BCA8 (_TlgCreateSid.c)
  ...
  if ( hProvider )
  {
    if ( a1 )
    {
      if ( a1 == 3 )
      {
        if ( hProvider->LevelPlus1 > 5 && TlgKeywordOn(hProvider, 0x20uLL) )
        {
          ...
          TlgWriteEx(v4, &unk_14038DEBD, v10, v11, v16, v17, 9u, &v47);
        }
      }
      else if ( a1 == 1 )
      {
        if ( hProvider->LevelPlus1 > 5 && TlgKeywordOn(hProvider, 0x20uLL) )
        {
          ...
          v67 = 4LL;
          v69 = 4LL;
          TlgWriteEx(v4, &unk_14038DDAE, v12, v13, v16, v17, 6u, &v61);
        }
      }
      else if ( a1 == 4 && hProvider->LevelPlus1 > 5 && TlgKeywordOn(hProvider, 0x20uLL) )
      {
        ...
        TlgWriteEx(v4, &unk_14038DE00, v14, v15, v16, v17, 7u, &v70);
      }
    }
    else if ( hProvider->LevelPlus1 > 5 )
    {
      if ( TlgKeywordOn(hProvider, 0x20uLL) )
      {
        ...
        v44 = 2LL;
        v46[1] = 0;
        TlgWriteEx(v4, &unk_14038DE62, v8, v9, v16, v17, 8u, &pData);
      }
    }
  }
}
