/*
 * XREFs of HvAnalyzeLogFiles @ 0x14083F4E8
 * Callers:
 ...
 *     HvpHeaderCheckSum @ 0x140661000 (HvpHeaderCheckSum.c)
 *     HvpDetermineIncrementalLogFileMaximums @ 0x14083FFD8 (HvpDetermineIncrementalLogFileMaximums.c)
 *     HvpDetermineLatestLogFile @ 0x140840088 (HvpDetermineLatestLogFile.c)
...
LABEL_59:
    if ( stru_140425BC0.LevelPlus1 > 5 && TlgKeywordOn(&stru_140425BC0, 0x400000000000uLL) )
      TlgWrite(&stru_140425BC0, &unk_14038C1C6, 0LL, 0LL, 2u, &v92);
  ...
  if ( stru_140425BC0.LevelPlus1 > 5 )
  {
    ...
    v89 = 4LL;
    v91 = 4LL;
    TlgWrite(&stru_140425BC0, &unk_14038C169, 0LL, 0LL, 7u, &pData);
    LevelPlus1 = stru_140425BC0.LevelPlus1;
  }
  if ( v35 == 1 )
  {
  ...
  else
  {
    ...
    else
    {
      if ( LevelPlus1 > 5 && TlgKeywordOn(&stru_140425BC0, 0x400000000000uLL) )
        TlgWrite(&stru_140425BC0, &unk_14038C13C, 0LL, 0LL, 2u, &v92);
      v53 = v74;
      v54 = *((_QWORD *)v51 + 2);
