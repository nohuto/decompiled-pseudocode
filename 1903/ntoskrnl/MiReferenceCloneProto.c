/*
 * XREFs of MiReferenceCloneProto @ 0x1402E4ECC
 * Callers:
        ...
        volatile signed __int64 **a5)
{
  ...
  *a5 = 0LL;
  ...
  if ( CloneAddress )
  {
    ...
    if ( *(_QWORD *)(qword_140466188 + 8LL * *(unsigned __int16 *)(v10 + 174)) != v12 )
    {
      if ( (a3 & 1) != 0 )
      {
    ...
    if ( (a3 & 1) != 0 )
    {
      if ( (_InterlockedIncrement64(a2 + 2) & 0x7FFFFFFFFFFFFFFLL) == 1 )
      {
        if ( v11 )
          ...
          ++a4[1];
        _InterlockedExchangeAdd64((volatile signed __int64 *)(v12 + 8584), 1uLL);
      }
      else
      {
        ++*a4;
