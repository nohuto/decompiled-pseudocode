/*
 * XREFs of ?wil_details_RecordUsageInPropertyCache@@YA?AUwil_details_RecordUsageResult@@PEATwil_details_FeaturePropertyCache@@W4wil_details_ServiceReportingKind@@II@Z @ 0x1400043D0
 * Callers:
...
LABEL_19:
      ...
      {
        v10 = (union wil_details_FeaturePropertyCache *)(((unsigned int)dword_1404F2E4C >> 7) & 0x3F);
        if ( a3 - 320 == (_DWORD)v10 )
        {
          if ( (dword_1404F2E4C & 0x40) != 0 )
          {
