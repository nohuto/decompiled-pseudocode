/*
 * XREFs of SepMandatoryIntegrityCheck @ 0x1400C9360
 * Callers:
        ...
        __int64 a7)
{
  ...
  char v50; // [rsp+32h] [rbp-56h]
  char v51; // [rsp+34h] [rbp-54h]
...
LABEL_11:
    if ( a5 )
    {
      ...
      {
        ExpAcquireResourceSharedLite(*(_QWORD *)(a4 + 48), 1, (__int64)a3, a4);
      }
    }
