/*
 * XREFs of MiObtainSessionVa @ 0x140138958
 * Callers:
...
LABEL_116:
    ...
    if ( (__int64)v59->LockState.LockState < 0 )
      KiAbEntryRemoveFromTree((__int64)&v52->LockEntries[v58]);
...
LABEL_128:
    ...
    if ( v24 && ($6EAC78A6FCFADE0A5FA44F358736B38F *)v52->ApcState.ApcListHead[0].Flink != &v52->152 )
      ...
      if ( v28->LockState.0 )
      {
        if ( v28 )
        {
          ...
          if ( (__int64)v28->LockState.LockState < 0 )
            KiAbEntryRemoveFromTree((__int64)&v20->LockEntries[v27]);
...
LABEL_33:
  ...
  if ( v24 && ($6EAC78A6FCFADE0A5FA44F358736B38F *)v20->ApcState.ApcListHead[0].Flink != &v20->152 )
    KiCheckForKernelApcDelivery(v30);
  KiLeaveGuardedRegionUnsafe((__int64)CurrentThread);
  return qword_140464998 + (ClearBitsAndSet << 21);
}
