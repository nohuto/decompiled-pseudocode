/*
 * XREFs of PopRequestRead @ 0x1405AD13C
 * Callers:
 *     PopRestoreHiberContext @ 0x140599380 (PopRestoreHiberContext.c)
 *     PopDecompressCallback @ 0x1405ACB70 (PopDecompressCallback.c)
 * Callees:
    ...
    do
    {
      if ( v8 )
      {
        if ( v8 != 1 )
        {
          ...
          v9 = __rdtsc();
          qword_140443688 += v9 - *(_QWORD *)(BugCheckParameter3 + 336);
          ...
          v10 = __rdtsc();
          qword_1404436B8 += (((unsigned __int64)HIDWORD(v10) << 32) | (unsigned int)v10) - v9;
        ...
        v17 = __rdtsc();
        qword_1404436B0 += (((unsigned __int64)HIDWORD(v17) << 32) | (unsigned int)v17) - v14;
...
LABEL_34:
        ...
        v28 = __rdtsc();
        qword_1404436B0 += (((unsigned __int64)HIDWORD(v28) << 32) | (unsigned int)v28)
