/*
 * XREFs of MiUnlinkFreeOrZeroedPage @ 0x14002BE20
 * Callers:
...
__int64 __fastcall MiUnlinkFreeOrZeroedPage(ULONG_PTR a1, __int64 a2, __int16 a3)
{
  ...
  v9 = v8;
  v56 = v8;
  v10 = dword_140465AB0 & (unsigned int)a1 | ((_DWORD)v7 << byte_140465A4D) | (((*(_QWORD *)(v5 + 40) >> 36) & 3) << byte_140465A4E);
  v53 = v7;
  v11 = *(_QWORD *)(qword_140466188 + 8 * ((*(_QWORD *)(v5 + 40) >> 40) & 0x3FFLL));
  if ( a2 )
  {
    LODWORD(v7) = -1;
  }
  ...
  if ( dword_14046620C == 1 )
  {
    v38 = v4 & 0x1F;
    LOBYTE(v39) = 1;
    v40 = (volatile signed __int32 *)(qword_140466268 + 4 * (v4 >> 5));
    if ( v38 + 1 > 0x20 )
    {
      if ( (v4 & 0x1F) != 0 )
      {
    ...
    if ( v15 == 0xFFFFFFFFFLL )
    {
      _InterlockedAnd(
        (volatile signed __int32 *)(*(_QWORD *)(*(_QWORD *)(v11 + 16)
                                              + 1984 * ((unsigned __int64)(unsigned int)v10 >> byte_140465A4D)
                                              + 16 * (v9 + 104)
                                              + 8)
                                  + 4 * ((unsigned __int64)((unsigned int)v10 & dword_140465AB0) >> 5)),
        ~(1 << (v10 & dword_140465AB0 & 0x1F)));
...
LABEL_15:
  v19 = *(_QWORD *)(v11 + 16) + 1984 * ((unsigned __int64)(unsigned int)v10 >> byte_140465A4D);
  ...
  if ( (unsigned int)MmNumberOfChannels > 1 )
    _InterlockedDecrement64((volatile signed __int64 *)(v19
                                                      ...
                                                      * (v9
                                                       + 2LL
                                                       * (unsigned __int8)(MiChannelMaximumPowerOf2Mask & ((unsigned int)v10 >> byte_140465A4E)))
                                                      + 1848));
  ...
  *(_QWORD *)(v5 + 16) = ZeroPte;
  ...
  else if ( (MiFlags & 0x80u) != 0 && (++dword_14046630C & MmPageValidationFrequency) == 0 )
  {
