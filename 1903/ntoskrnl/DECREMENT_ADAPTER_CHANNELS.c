...
void __fastcall DECREMENT_ADAPTER_CHANNELS(__int64 a1)
{
  ...
  {
    ViHalPreprocessOptions(byte_14042B898, "Driver has freed too many simultaneous adapter channels.", 4LL);
    VfReportIssueWithOptions(0xE6u, 4uLL, v2 != *(_DWORD *)(a1 + 180), 0LL, 0LL, byte_14042B898);
  }
}
