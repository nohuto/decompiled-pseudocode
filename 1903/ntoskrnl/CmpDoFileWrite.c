/*
 * XREFs of CmpDoFileWrite @ 0x1406362EC
 * Callers:
 *     CmpFileWrite @ 0x1406E8760 (CmpFileWrite.c)
 ...
 *     CmpSetRespectIoPriorityThread @ 0x1401354B4 (CmpSetRespectIoPriorityThread.c)
 *     CmpSetIoPriorityThread @ 0x14013C82C (CmpSetIoPriorityThread.c)
 *     CmpSetPriorityThread @ 0x14013C840 (CmpSetPriorityThread.c)
