/*
 * XREFs of MiIncrementAweMapCount @ 0x1402D65E0
 * Callers:
...
LABEL_30:
      ...
      else
      {
        ...
        if ( (__int64)v22->LockState.LockState < 0 )
          KiAbEntryRemoveFromTree((__int64)&v14->LockEntries[v21]);
      ...
      if ( v18 && ($6EAC78A6FCFADE0A5FA44F358736B38F *)v14->ApcState.ApcListHead[0].Flink != &v14->152 )
...
LABEL_82:
    ...
    if ( v18 && ($6EAC78A6FCFADE0A5FA44F358736B38F *)v36->ApcState.ApcListHead[0].Flink != &v36->152 )
