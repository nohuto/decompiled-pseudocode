/*
 * XREFs of HvUnCOWReconciledPages @ 0x14011BA7C
 * Callers:
 *     CmpFlushHive @ 0x1406344A4 (CmpFlushHive.c)
 * Callees:
 *     RtlMergeBitMaps @ 0x14011BD88 (RtlMergeBitMaps.c)
 *     HvpViewMapUnCOWAndSealRange @ 0x1406C3160 (HvpViewMapUnCOWAndSealRange.c)
 */
...
LABEL_26:
          ...
          if ( v19 != (_DWORD *)v9 && (*v19 | dword_14037C7E0[v11 & 0x1F]) == -1 )
          {
            v11 = v11 - (v11 & 0x1F) + 32;
          ...
          {
            v21 = v11 & 0x1F;
            if ( (*v19 & ~dword_14037C7E0[v11 & 0x1F]) == 0 )
              break;
          }
LABEL_44:
