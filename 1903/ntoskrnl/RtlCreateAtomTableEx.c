/*
 * XREFs of RtlCreateAtomTableEx @ 0x14010AEA0
 * Callers:
 *     RtlCreateAtomTable @ 0x1406BB9D0 (RtlCreateAtomTable.c)
 * Callees:
 *     memset @ 0x1401D6BC0 (memset.c)
 *     RtlpAllocateAtom @ 0x140668954 (RtlpAllocateAtom.c)
 *     RtlpInitializeLockAtomTable @ 0x1406BB9EC (RtlpInitializeLockAtomTable.c)
