/*
 * XREFs of PiDevCfgQueryDeviceMigrationNode @ 0x140868468
 * Callers:
...
LABEL_31:
    ...
    *((_QWORD *)v9 + 5) = Handle;
    ...
    v11 = _mm_loadu_si128((const __m128i *)off_140947918);
    ...
    LODWORD(v23[43]) = 304;
    v23[52] = v9 + 160;
    RegistryValues = RtlpQueryRegistryValues(0xC0000000, v15, (__int64)v23, 0LL);
    if ( RegistryValues < 0 )
      goto LABEL_31;
