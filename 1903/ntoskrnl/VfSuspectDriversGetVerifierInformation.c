/*
 * XREFs of VfSuspectDriversGetVerifierInformation @ 0x140976E20
 * Callers:
 ...
 *     VfTargetDriversGetZeroCounters @ 0x14097400C (VfTargetDriversGetZeroCounters.c)
  ...
  *a3 = 0;
  ...
  if ( (__int64 *)VfSuspectDriversList != &VfSuspectDriversList )
  {
    while ( 1 )
    {
      ...
      *(_DWORD *)(v6 + 20) = ViVerifyAllDrivers;
      *(_DWORD *)(v6 + 40) = dword_1404465E4;
      *(_DWORD *)(v6 + 44) = dword_1404465E8;
      *(_DWORD *)(v6 + 92) = dword_140446618;
      *(_DWORD *)(v6 + 48) = dword_1404465EC;
      *(_DWORD *)(v6 + 52) = dword_1404465F0;
      *(_DWORD *)(v6 + 56) = dword_1404465F4;
      *(_DWORD *)(v6 + 60) = dword_1404465F8;
      *(_DWORD *)(v6 + 64) = dword_1404465FC;
      *(_DWORD *)(v6 + 68) = dword_140446600;
      *(_DWORD *)(v6 + 72) = dword_140446604;
      *(_DWORD *)(v6 + 76) = dword_140446608;
      *(_DWORD *)(v6 + 80) = dword_14044660C;
      ...
      *(_DWORD *)(v6 + 88) = *((_DWORD *)v10 + 5);
      ...
      if ( v16 > v15 )
      {
        ...
        ((void (__fastcall *)(__int64, _QWORD *, __int64 (__fastcall *)(__int64, __int64), _QWORD *))VfAvlEnumerateNodes)(
          v17,
          v20,
