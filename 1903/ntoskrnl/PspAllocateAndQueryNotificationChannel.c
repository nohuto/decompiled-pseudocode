/*
 * XREFs of PspAllocateAndQueryNotificationChannel @ 0x1406158DC
 * Callers:
...
LABEL_25:
  ...
  if ( v24 == 1 )
  {
    ObFastDereferenceObject((signed __int64 *)(*(_QWORD *)(a1 + 184) + 864LL), (unsigned __int64)v15);
  }
  else if ( v15 )
  {
  ...
  if ( ObjectSecurity < 0 )
    goto LABEL_25;
  v16 = (unsigned __int8 **)TokenInformation[0];
