/*
 * XREFs of NtQueryInformationJobObject @ 0x140612130
 * Callers:
 *     <none>
 * Callees:
 ...
 *     KeIsSingleGroupAffinityEx @ 0x140131300 (KeIsSingleGroupAffinityEx.c)
 ...
 *     PspLimitViolationRateControlToleranceLimitField @ 0x14061572C (PspLimitViolationRateControlToleranceLimitField.c)
