/*
 * XREFs of ExpSetBootEntry @ 0x14090EF38
 * Callers:
 *     NtAddBootEntry @ 0x140910E20 (NtAddBootEntry.c)
 *     NtModifyBootEntry @ 0x140911F40 (NtModifyBootEntry.c)
 * Callees:
...
__int64 __fastcall ExpSetBootEntry(int a1, _DWORD *a2, unsigned __int64 a3)
{
  ...
  __int64 v19; // rsi
  struct _FILE_PATH *v20; // r13
  char *v21; // rsi
  int v22; // eax
  unsigned int v23; // r14d
  struct _FILE_PATH *v24; // rax
  struct _FILE_PATH *v25; // rsi
  ULONG Length; // eax
  ULONG v27; // eax
  ULONG v28; // esi
  size_t v29; // rbx
...
LABEL_91:
    ...
    if ( EnvironmentVariable < 0 )
      goto LABEL_91;
    v50 = 1;
    v20 = (struct _FILE_PATH *)&v15[*((unsigned int *)v15 + 11) + 28];
  }
  else
  {
    v50 = 0;
...
LABEL_92:
  ...
  if ( v30 )
  {
    ...
    *((_DWORD *)v38 + 3) = v28;
    v39 = (struct _FILE_PATH *)&v38[*((unsigned int *)v15 + 11)];
    v43 = v47;
