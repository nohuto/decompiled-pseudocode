/*
 * XREFs of FsRtlpGetMaxVirtualDiskNestingLevel @ 0x14019BDD0
 * Callers:
 *     FsRtlQueryMaximumVirtualDiskNestingLevel @ 0x140175860 (FsRtlQueryMaximumVirtualDiskNestingLevel.c)
 * Callees:
