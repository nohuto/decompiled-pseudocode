/*
 * XREFs of MxGetNextPage @ 0x1409F3A20
 * Callers:
 *     MxMapVa @ 0x1409F36A4 (MxMapVa.c)
 * Callees:
 *     MxBootDescriptorDepleted @ 0x1409F3B58 (MxBootDescriptorDepleted.c)
...
__int64 __fastcall MxGetNextPage(int a1, int a2)
{
  ...
  do
  {
    v6 = (__int64 *)MxFreeDescriptor[a1];
...
LABEL_16:
  ...
  if ( a2 != 1 )
  {
    v6 = (__int64 *)MxSwitchDescriptors();
    if ( v6 )
      goto LABEL_8;
    byte_140466339 = 16;
  }
