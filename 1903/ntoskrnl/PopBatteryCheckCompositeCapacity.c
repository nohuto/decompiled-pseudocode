/*
 * XREFs of PopBatteryCheckCompositeCapacity @ 0x140738A38
 * Callers:
...
LABEL_4:
  ...
  LODWORD(v14) = 100000;
  if ( HIDWORD(qword_140443260) > (unsigned int)v13 )
  {
    if ( HIDWORD(qword_140443260) )
      v14 = 100000 * v13 / (unsigned __int64)HIDWORD(qword_140443260);
    else
      LODWORD(v14) = 0;
  }
  v15 = 0;
  if ( dword_14044338C != -1 )
    v15 = v14 - dword_14044338C;
  v16 = ((int)v14 + 500) / 0x3E8u;
  v17 = (dword_14044338C + 500) / 0x3E8u;
  if ( v16 != v17 )
    *a3 = v16 - v17;
  v6 = byte_14044339C;
  LOBYTE(v7) = byte_140443388;
  dword_14044338C = v14;
  if ( a2 == 1 )
  {
    v6 = 0;
...
LABEL_20:
  ...
  v18 = dword_140443398;
  if ( dword_140443398 < (unsigned int)v14 )
  {
    v18 = v14;
    dword_140443398 = v14;
  }
  ...
  if ( byte_14044339C != v6 )
  {
    ...
    if ( pCallbackContext.LevelPlus1 > 5 )
    {
      if ( TlgKeywordOn(&pCallbackContext, 0x400000000000uLL) )
      {
        ...
        v37 = (unsigned __int8)byte_14044339C;
        v38 = dword_140443214;
        if ( (v20 & 1) == 0 )
          v21 = "DC Power";
        ...
        if ( HIDWORD(qword_140443260) )
        {
          v34 = (unsigned int)((HIDWORD(qword_140443260) >> 1) + 100 * v22) / HIDWORD(qword_140443260);
          v27 = 100000 * v22 / (unsigned __int64)HIDWORD(qword_140443260);
        }
        else
        {
          v34 = 0;
        ...
        v68 = 4LL;
        v70 = 4LL;
        TlgWrite(&pCallbackContext, &unk_14038ECAE, 0LL, 0LL, 0x10u, &pData);
      }
    }
  }
  if ( byte_140443388 != (_BYTE)v7 )
  {
    byte_140443388 = v7;
    ...
    if ( pCallbackContext.LevelPlus1 > 5 )
    {
      if ( TlgKeywordOn(&pCallbackContext, 0x400000000000uLL) )
      {
        ...
        v42 = (unsigned __int8)byte_140443388;
        v41 = dword_140443214;
        if ( (v30 & 1) == 0 )
          v8 = "DC Power";
        if ( (v30 & 2) == 0 )
        ...
        if ( HIDWORD(qword_140443260) )
        {
          v34 = (unsigned int)((HIDWORD(qword_140443260) >> 1) + 100 * v31) / HIDWORD(qword_140443260);
          v32 = 100000 * v31 / (unsigned __int64)HIDWORD(qword_140443260);
        }
        else
        {
          v34 = 0;
        ...
        v68 = v33;
        v70 = v33;
        TlgWrite(&pCallbackContext, &unk_14038EB4D, 0LL, 0LL, 0x10u, &pData);
      }
    }
  }
}
