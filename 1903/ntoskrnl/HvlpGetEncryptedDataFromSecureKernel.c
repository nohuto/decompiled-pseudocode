/*
 * XREFs of HvlpGetEncryptedDataFromSecureKernel @ 0x14028C068
 * Callers:
 *     HvlGetEncryptedData @ 0x14028BD30 (HvlGetEncryptedData.c)
 * Callees:
...
__int64 __fastcall HvlpGetEncryptedDataFromSecureKernel(__int64 a1, __int64 a2, int a3, _DWORD *a4, _QWORD *a5)
{
  ...
  *a5 = 0LL;
  ...
  {
    result = HvlpStartSecurePageListIteration(1LL, 2 * ((HvlpFlags >> 1) & 1) + 1);
    if ( (int)result < 0 )
      return result;
