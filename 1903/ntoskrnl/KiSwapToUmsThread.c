/*
 * XREFs of KiSwapToUmsThread @ 0x140880D60
 * Callers:
 ...
 *     KeSaveLegacyFloatingPointControlWord @ 0x1401C4220 (KeSaveLegacyFloatingPointControlWord.c)
 ...
 *     KeFixUserSwitchContext @ 0x140881E68 (KeFixUserSwitchContext.c)
