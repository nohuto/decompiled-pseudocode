/*
 * XREFs of CcMapDataForOverwrite @ 0x14011DF68
 * Callers:
...
__int64 __fastcall CcMapDataForOverwrite(__int64 a1, _DWORD *a2, unsigned int a3, _QWORD *a4, unsigned __int64 *a5)
{
  ...
  v6 = (int)a2;
  v7 = a1;
  v20 = (a3 + 4095LL + (unsigned __int64)(*a2 & 0xFFF)) >> 12;
  ...
  v12 = a5;
  CcMapDataCommon(v7, v6, a3, 1, (__int64)&v22, (__int64)a5);
  v13 = *v12;
  v14 = v20;
  while ( v14 )
  {
    ...
    MmCheckCachedPageStates(v13, 1LL, 5u, &v23);
    if ( !v23 )
      MmCheckCachedPageStates(v13, 1LL, 4u, 0LL);
    v13 += 4096LL;
  }
