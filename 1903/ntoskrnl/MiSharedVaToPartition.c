/*
 * XREFs of MiSharedVaToPartition @ 0x1400F042C
 * Callers:
...
ULONG_PTR *__fastcall MiSharedVaToPartition(__int64 a1, unsigned __int64 a2, unsigned __int64 a3)
{
  ...
  v9 = v6;
  if ( (v6 & 0x400) != 0 && (unsigned __int8)MI_PROTO_FORMAT_COMBINED(v6) )
...
LABEL_29:
  if ( *v14 )
    return *(ULONG_PTR **)(qword_140466188 + 8LL * (*(_WORD *)(*v14 + 60LL) & 0x3FF));
  return (ULONG_PTR *)v7;
}
