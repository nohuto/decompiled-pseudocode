/*
 * XREFs of EtwTiLogSetContextThread @ 0x1406CA754
 * Callers:
...
void __fastcall EtwTiLogSetContextThread(char a1, __int64 a2, __int64 a3, unsigned int a4)
{
  ...
  __int64 v33[12]; // [rsp+2C0h] [rbp+1C0h] BYREF
  ...
  if ( EtwProviderEnabled(EtwThreatIntProvRegHandle, 0, 0xC000uLL) )
  {
    ...
    if ( Process != v8 )
    {
      ...
      if ( EtwEventEnabled(EtwThreatIntProvRegHandle, v10) )
      {
        ...
        {
          v29 = 0;
          v32[v20].Ptr = (ULONGLONG)&unk_14039ED50;
          v24 = 0;
          *(_QWORD *)&v32[v20].Size = 2LL;
          ...
          do
          {
            v28 = v19++;
            v28 *= 2LL;
            *(&v32[0].Ptr + v28) = (ULONGLONG)&unk_14039ED50;
        ...
        EtwpTiVadQueryEventWrite(v32, 0x26u, v19, v8, v33, 1u, v10, v7);
      }
    }
  }
}
