/*
 * XREFs of CmpCheckKey @ 0x140651270
 * Callers:
 *     CmpCheckRegistry2 @ 0x140650910 (CmpCheckRegistry2.c)
 * Callees:
 *     CmpHKeyNameLen @ 0x140091F94 (CmpHKeyNameLen.c)
 ...
 *     CmpIncrementCachedSecurityRefcount @ 0x140651D00 (CmpIncrementCachedSecurityRefcount.c)
 *     CmpGetIndexElementSize @ 0x140652300 (CmpGetIndexElementSize.c)
