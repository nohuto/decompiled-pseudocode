/*
 * XREFs of NtCreateTimer2 @ 0x14068DC30
 * Callers:
 *     NtCreateIRTimer @ 0x140747FF0 (NtCreateIRTimer.c)
 * Callees:
 *     ExpExTimerAttributesAreValid @ 0x1400E3E60 (ExpExTimerAttributesAreValid.c)
