/*
 * XREFs of PiDqPropertyCallback @ 0x1405BB290
 * Callers:
 *     <none>
 * Callees:
...
LABEL_11:
    ...
    if ( v18 )
    {
      ...
      if ( !*(_QWORD *)a1 )
      {
        PnpObjectType = PiDqGetPnpObjectType(*(_DWORD *)(*(_QWORD *)(*(_QWORD *)(a1 + 40) + 24LL) + 16LL));
    ...
    {
      v19 = PiDqGetPnpObjectType(*(_DWORD *)(*(_QWORD *)(*(_QWORD *)(a1 + 40) + 24LL) + 16LL));
    }
    if ( (v9 & 0x80000000) != 0 )
      return v9;
