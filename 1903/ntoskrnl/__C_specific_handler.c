/*
 * XREFs of __C_specific_handler @ 0x14019E730
 * Callers:
 *     __GSHandlerCheck_SEH @ 0x1401BFD08 (__GSHandlerCheck_SEH.c)
 * Callees:
 *     RtlUnwindEx @ 0x140019840 (RtlUnwindEx.c)
 *     KeCheckStackAndTargetAddress @ 0x1400BFE30 (KeCheckStackAndTargetAddress.c)
 *     _NLG_Notify @ 0x14019F700 (_NLG_Notify.c)
 *     __NLG_Return2 @ 0x14019F730 (__NLG_Return2.c)
 */
        ...
        struct _DISPATCHER_CONTEXT *DispatcherContext)
{
  ...
  v11 = DispatcherContext->ControlPc - (_QWORD)ImageBase;
  HandlerData = (ULONG *)DispatcherContext->HandlerData;
  ScopeIndex = DispatcherContext->ScopeIndex;
  if ( (ExceptionRecord->ExceptionFlags & 0x66) != 0 )
  {
    v17 = *HandlerData;
    v18 = DispatcherContext->TargetIp - (_QWORD)ImageBase;
