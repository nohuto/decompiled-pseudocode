/*
 * XREFs of ExAllocateHeapPool @ 0x1400378E0
 * Callers:
 ...
 *     ExPoolIsZeroingSupportPresent @ 0x1401BFB94 (ExPoolIsZeroingSupportPresent.c)
 ...
 *     RtlpHpExtrasAppend @ 0x14031B4E4 (RtlpHpExtrasAppend.c)
 *     EtwTracePool @ 0x14032DF54 (EtwTracePool.c)
 *     ExCheckSingleFilter @ 0x1403391EC (ExCheckSingleFilter.c)
 *     ExpSanitizePoolTag @ 0x14033994C (ExpSanitizePoolTag.c)
...
LABEL_31:
  ...
  if ( (unsigned int)v6 >= dword_14046FA10 )
    LODWORD(v6) = 0;
  v22 = (char *)&unk_14046FA40 + 8384 * (unsigned int)v6;
  if ( v14 >= NonPagedPool )
  {
    if ( (v14 & 0x21) == 0x21 )
    {
  ...
  if ( v21 > 0xFE0 )
  {
    ...
    if ( (v28 || (v28 = qword_1404367C8) != 0) && v25 > v28 )
    {
      v30 = *(_QWORD *)(v23 + 56);
      if ( v30 )
...
LABEL_163:
  ...
  v133 = v77;
  if ( (v75 || (v76 = qword_1404367C8) != 0) && v64 > v76 )
  {
    v78 = *(_QWORD *)(v23 + 56);
    if ( v78 )
