/*
 * XREFs of KeAbProcessBaseIoPriorityChangeInternal @ 0x14007FFF0
 * Callers:
 *     KeAbProcessBaseIoPriorityChange @ 0x14007FFB4 (KeAbProcessBaseIoPriorityChange.c)
 *     IoUpdateThreadIoRateThrottle @ 0x14029BED0 (IoUpdateThreadIoRateThrottle.c)
 * Callees:
