/*
 * XREFs of CcInitializeCacheMapEx @ 0x14000D700
 * Callers:
 *     CcInitializeCacheMap @ 0x14013C300 (CcInitializeCacheMap.c)
 * Callees:
...
LABEL_62:
    ...
    v50 = 0LL;
    v51 = *(_QWORD *)(qword_140466188 + 8LL * (*(_WORD *)(**((_QWORD **)Object + 5) + 60LL) & 0x3FF));
