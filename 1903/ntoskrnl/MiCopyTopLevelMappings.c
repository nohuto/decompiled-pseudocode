/*
 * XREFs of MiCopyTopLevelMappings @ 0x1400E2F44
 * Callers:
...
__int64 __fastcall MiCopyTopLevelMappings(__int64 a1, __int64 a2)
{
  ...
  memmove(
    ...
    8 * ((((unsigned __int64)qword_1404675B0 >> 39) & 0x1FF) - 256));
  MiShadowTopLevelPxes(a1, 0xFFFFF6FB7DBED800uLL, 256LL);
  v4 = (((unsigned __int64)qword_140465EE0 >> 39) & 0x1FF) + 1;
  memmove((void *)(a2 + 8 * v4), (const void *)(8 * v4 - 0x90482413000LL), 8LL * (unsigned int)(512 - v4));
  result = 0LL;
  v6 = *(_QWORD *)(a1 + 1024);
  if ( v6 )
    result = *(_QWORD *)(v6 + 1096);
  *(_QWORD *)(a2 + 8 * (((unsigned __int64)qword_1404659D0 >> 39) & 0x1FF)) = result;
  return result;
}
