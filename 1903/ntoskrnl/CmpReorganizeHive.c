/*
 * XREFs of CmpReorganizeHive @ 0x14065EAFC
 * Callers:
 ...
 *     CmpSwapHiveStorage @ 0x14082F648 (CmpSwapHiveStorage.c)
            ...
            else
            {
              ...
              if ( v6 >= 0 )
              {
                  ...
                  || *(_DWORD *)(BugCheckParameter2 + 4804) == *(_DWORD *)(v14 + 4804) )
                {
                  *(_QWORD *)(v14 + 56) = 0LL;
                  ...
                  if ( stru_140425BC0.LevelPlus1 > 5 && TlgKeywordOn(&stru_140425BC0, 0x400000000000uLL) )
                  {
                    ...
                    v56 = 4LL;
                    v58 = 4LL;
                    TlgWrite(&stru_140425BC0, &unk_14038BCCA, 0LL, 0LL, 5u, &v52);
                  }
                  CmpLockRegistry();
                ...
                else
                {
                  if ( stru_140425BC0.LevelPlus1 > 5 && TlgKeywordOn(&stru_140425BC0, 0x400000000000uLL) )
                  {
                    ...
                    v61 = 4LL;
                    v63 = 4LL;
                    TlgWrite(&stru_140425BC0, &unk_14038BD10, 0LL, 0LL, 4u, &v59);
                  }
                  CmpLockRegistry();
                  HvLockHiveFlusherShared(BugCheckParameter2);
                  HvLockHiveWriter(BugCheckParameter2);
              ...
              else
              {
                if ( stru_140425BC0.LevelPlus1 > 5 && TlgKeywordOn(&stru_140425BC0, 0x400000000000uLL) )
                {
                  ...
                  v49 = &v34[54];
                  v51 = 0;
                  TlgWrite(&stru_140425BC0, &unk_14038BD68, 0LL, 0LL, 9u, &v35);
                }
...
LABEL_20:
  if ( stru_140425BC0.LevelPlus1 > 5 && TlgKeywordOn(&stru_140425BC0, 0x400000000000uLL) )
  {
    ...
    v65 = &v22;
    v66 = 4LL;
    TlgWrite(&stru_140425BC0, &unk_14038BC98, 0LL, 0LL, 3u, &pData);
  }
  return (unsigned int)v6;
}
