/*
 * XREFs of AlpcpReceiveMessagePort @ 0x1405DFFD0
 * Callers:
 ...
 *     AlpcpQueryHeadLargeQueue @ 0x1405E07E0 (AlpcpQueryHeadLargeQueue.c)
      ...
      if ( v9 )
      {
        ...
        *(_QWORD *)(v6 + 240) = p_Timer;
        ...
        if ( v25 )
        {
          ExAcquirePushLockExclusiveEx(v6 + 224, 0LL);
          v28 = &v33[1].Timer;
          v29 = *(_QWORD *)&v33[1].Timer.Header.Lock;
          if ( v29 )
          {
            v33[1].RelativeTimerBias = 0LL;
            Flink = v33[1].Timer.Header.WaitListHead.Flink;
            if ( *(_KTIMER **)(v29 + 8) != v28 || (_KTIMER *)Flink->Flink != v28 )
LABEL_132:
              __fastfail(3u);
            Flink->Flink = (struct _LIST_ENTRY *)v29;
            *(_QWORD *)(v29 + 8) = Flink;
