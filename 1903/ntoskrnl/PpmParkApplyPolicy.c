/*
 * XREFs of PpmParkApplyPolicy @ 0x140194168
 * Callers:
...
__int64 PpmParkApplyPolicy()
{
  ...
  {
    v2 = 64;
    v3 = 341LL * dword_140443ACC;
    v73 = WORD2(PpmCurrentProfile[v3 + 22]);
    v72 = HIWORD(PpmCurrentProfile[v3 + 22]);
    if ( (((unsigned __int64)qword_14042A698[(unsigned __int64)(unsigned int)KiProcessorIndexToNumberMappingTable[0] >> 6] >> (KiProcessorIndexToNumberMappingTable[0] & 0x3F)) & 1) == 0 )
    {
