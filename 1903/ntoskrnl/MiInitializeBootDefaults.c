/*
 * XREFs of MiInitializeBootDefaults @ 0x140A1F230
 * Callers:
...
__int64 __fastcall MiInitializeBootDefaults(__int64 a1)
{
  ...
  do
  {
    InitializeSListHead(&stru_140466800[v6]);
    if ( v6 )
      v7 = 2 * byte_140466820[v6 - 1];
    else
      v7 = 8;
    *v5 = v7;
    ++v6;
  ...
  while ( v6 < 2 );
  dword_14046636C = 5;
  qword_140465A08 = (__int64)&qword_140465A00;
  qword_140465A00 = (__int64)&qword_140465A00;
  qword_1404659F8 = -10000000LL * dword_1405711A4;
  qword_140466380 = 0LL;
  SpinLock = 0LL;
  qword_140464590 = 0LL;
  qword_1404645A8 = 0x7FF5FFFFFFFFLL;
  result = (unsigned __int8)ExGenRandom(1) << 16;
  qword_1404645A8 += 0xFFFFFFFDFF800000uLL - result;
  return result;
}
