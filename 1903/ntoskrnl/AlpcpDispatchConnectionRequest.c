/*
 * XREFs of AlpcpDispatchConnectionRequest @ 0x140645950
 * Callers:
 ...
 *     PsGetProcessJob @ 0x140122CD0 (PsGetProcessJob.c)
 *     PsGetJobEffectiveFreezeCount @ 0x140307094 (PsGetJobEffectiveFreezeCount.c)
