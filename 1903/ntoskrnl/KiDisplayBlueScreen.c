/*
 * XREFs of KiDisplayBlueScreen @ 0x1402A9008
 * Callers:
 ...
 *     KiBugCheckConvertParameterValueToUnicodeString @ 0x1402A8C5C (KiBugCheckConvertParameterValueToUnicodeString.c)
...
__int64 __fastcall KiDisplayBlueScreen(int a1)
{
  ...
  v3 = KiBugCheckDriver;
  v4 = (unsigned __int64 *)&qword_14044D248;
  ...
  *(_WORD *)(v10 + 2 * v14) = 0;
  ...
  {
    BgpFwDisplayBugCheckScreen(v16, (unsigned int)&qword_14044D248, v3, (unsigned int)v27, a1);
    v10 = *((_QWORD *)&v27[1] + 1);
    v15 = v27[1];
  }
  BgpFwReleaseLock();
