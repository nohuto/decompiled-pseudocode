/*
 * XREFs of RtlIoDecodeMemIoResource @ 0x14018D510
 * Callers:
 *     PnpFilterResourceRequirementsList @ 0x14076325C (PnpFilterResourceRequirementsList.c)
 *     IopGenericScoreRequirement @ 0x1407638D0 (IopGenericScoreRequirement.c)
 *     IopGenericUnpackRequirement @ 0x140763950 (IopGenericUnpackRequirement.c)
 * Callees:
 *     <none>
 */
