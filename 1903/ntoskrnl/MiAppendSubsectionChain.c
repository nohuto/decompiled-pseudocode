/*
 * XREFs of MiAppendSubsectionChain @ 0x1400EAEF8
 * Callers:
...
LABEL_4:
  ...
  *(_QWORD *)(a1 + 16) = v14;
  for ( j = v14; j; v10 = v26 )
  {
    MiInsertSubsectionNode(v10, j, 1);
    j = *(_QWORD *)(j + 16);
  }
  ExReleaseSpinLockExclusiveFromDpcLevel((PEX_SPIN_LOCK)(v26 + 72));
  if ( KiIrqlFlags && (KiIrqlFlags & 1) != 0 && KeGetCurrentIrql() >= 2u && v12 < 2u )
  ...
  __writecr8(v12);
  if ( v7 )
    MiReturnCrossPartitionSectionCharges(*(_QWORD *)(qword_140466188 + 8LL * (*(_WORD *)(v26 + 60) & 0x3FF)), 1LL, v7);
  return 0LL;
}
