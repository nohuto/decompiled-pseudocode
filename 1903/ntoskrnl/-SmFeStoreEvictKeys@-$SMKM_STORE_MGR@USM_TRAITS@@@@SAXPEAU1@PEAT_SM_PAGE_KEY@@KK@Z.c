/*
 * XREFs of ?SmFeStoreEvictKeys@?$SMKM_STORE_MGR@USM_TRAITS@@@@SAXPEAU1@PEAT_SM_PAGE_KEY@@KK@Z @ 0x140325E94
 * Callers:
...
LABEL_26:
  ...
  if ( (__int64)v21->LockState.LockState < 0 )
    KiAbEntryRemoveFromTree((__int64)&v15->LockEntries[v20]);
...
LABEL_33:
  ...
  if ( v22 && ($6EAC78A6FCFADE0A5FA44F358736B38F *)v15->ApcState.ApcListHead[0].Flink != &v15->152 )
