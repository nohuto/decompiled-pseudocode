/*
 * XREFs of PiDqActionDataGetChangedProperties @ 0x14071DE78
 * Callers:
        ...
        unsigned int *a10)
{
  ...
  _OWORD v50[3]; // [rsp+98h] [rbp-31h] BYREF
...
LABEL_14:
    ...
    if ( a4 )
    {
      ...
      if ( v11 < 0 )
        goto LABEL_23;
      v23 = v47;
      v24 = (const wchar_t *)*((_QWORD *)&v50[1] + 1);
      while ( 1 )
      {
      ...
      if ( *a10 )
      {
        ...
        {
          v32 = 48LL * v29;
          if ( LODWORD(v50[1]) == *(_DWORD *)(v32 + v31 + 16) )
          {
            v33 = *(_QWORD *)&v50[0] - *(_QWORD *)(v32 + v31);
            if ( *(_QWORD *)&v50[0] == *(_QWORD *)(v32 + v31) )
              v33 = *((_QWORD *)&v50[0] + 1) - *(_QWORD *)(v32 + v31 + 8);
            if ( !v33 && DWORD1(v50[1]) == *(_DWORD *)(v32 + v31 + 20) )
              break;
          }
          if ( ++v29 >= v28 )
            goto LABEL_59;
