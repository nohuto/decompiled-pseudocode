/*
 * XREFs of CmpBuildAdminInformation @ 0x1406F58F0
 * Callers:
 ...
 *     RtlCopyLuidAndAttributesArray @ 0x1406F5B90 (RtlCopyLuidAndAttributesArray.c)
 */
...
__int64 __fastcall CmpBuildAdminInformation(_QWORD *a1, __int64 *a2)
{
  ...
  __int64 v26; // rdx
  __int64 v27; // r13
  struct _SID_AND_ATTRIBUTES *v28; // r15
      ...
      *((_DWORD *)v20 + 22) = v22;
      ...
      if ( v14 )
        RtlCopySidAndAttributesArray(
          ...
          &RemainingSidArea,
          (PULONG)&TokenInformation);
      RtlSidHashInitialize(*((__int64 **)v20 + 12), *v21, (_QWORD *)v20 + 11);
      *(_QWORD *)v20 = v21;
