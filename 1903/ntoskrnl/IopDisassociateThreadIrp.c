/*
 * XREFs of IopDisassociateThreadIrp @ 0x1402934B0
 * Callers:
 ...
 *     IoAllocateErrorLogEntry @ 0x140177060 (IoAllocateErrorLogEntry.c)
  ...
  if ( *(unsigned int **)(*(_QWORD *)p_SystemCallNumber + 8LL) != p_SystemCallNumber
    ...
    || (*(_QWORD *)p_SystemCallNumber = v8,
        *(_QWORD *)(v8 + 8) = p_SystemCallNumber,
        v3[1] = v3,
        *v3 = v3,
        v9 = (_QWORD *)qword_140461A68,
        *(__int64 **)qword_140461A68 != &IopDeadIrps) )
  {
    __fastfail(3u);
  }
  *v7 = &IopDeadIrps;
