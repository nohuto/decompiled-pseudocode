/*
 * XREFs of MiProbeAndLockPages @ 0x14008E9A0
 * Callers:
 ...
 *     VmProbeAndLockPages @ 0x140329660 (VmProbeAndLockPages.c)
    ...
    *(_QWORD *)v74[6] = -1LL;
    ...
    if ( (v6 & 0x3F) != 0 || !MiProbePacketContended((__int64)v74) )
    {
      if ( v74[20] == -1LL )
      {
        ...
        v75 = v43;
        v74[16] = ((unsigned __int64)MI_READ_PTE_LOCK_FREE(&v75) >> 12) & 0xFFFFFFFFFLL;
      }
      else
      {
...
LABEL_38:
  ...
  if ( v74[4] && (unsigned int)MiPageTableLockIsContended(v74[12], v74[4]) )
    goto LABEL_74;
  v14 = (*(_BYTE *)(v13 + 184) & 7) == 2 ? &dword_140467200 : (LONG *)(v13 + 192);
  if ( (*v14 & 0x40000000) != 0 )
    goto LABEL_74;
...
LABEL_14:
        ...
        LODWORD(v20) = MiLockPageLeafPageTable(v74, v20) )
  {
    ...
    if ( !v78 )
    {
      v74[16] = ((unsigned __int64)MI_READ_PTE_LOCK_FREE(&v74[5]) >> 12) & 0xFFFFFFFFFLL;
      if ( (v74[8] & 0xF) == 1 && LODWORD(v74[11]) != 3 )
      {
        v73 = v74[5];
        if ( (*(_QWORD *)(48 * (((unsigned __int64)MI_READ_PTE_LOCK_FREE(&v73) >> 12) & 0xFFFFFFFFFLL) - 0x57FFFFFFFD8LL) & 0x20000000000000LL) != 0 )
        {
          v24 = 0LL;
          v25 = v23;
          ...
          while ( 1 )
          {
            ...
            if ( (v28 & 0xF0FF000000000FFFuLL) != v73 )
              break;
            v29 = 48 * (((unsigned __int64)MI_READ_PTE_LOCK_FREE(&v76) >> 12) & 0xFFFFFFFFFLL);
            if ( (*(_QWORD *)(v29 - 0x57FFFFFFFD8LL) & 0x20000000000000LL) == 0 )
              break;
            v30 = (_QWORD *)qword_140465BC8;
