/*
 * XREFs of PpmInitPolicyConfiguration @ 0x1409ED550
 * Callers:
 ...
 *     PpmBeginProfileAccumulation @ 0x1406F03A8 (PpmBeginProfileAccumulation.c)
...
LONG PpmInitPolicyConfiguration()
{
  ...
  do
  {
    ...
    while ( (__int64)v3 < (__int64)qword_140438658 );
    v0 += 40;
    --v1;
  }
  while ( v1 );
  ...
  xmmword_1404370EC = (__int128)NullGuid;
  dword_1404370FC = 2;
  ...
  qsort(&PpmPolicyConfigTable, 0x34uLL, 0x28uLL, PpmInfoConfigComparer);
