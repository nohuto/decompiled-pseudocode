/*
 * XREFs of MxComputeFreeNodeDescriptorRequirements @ 0x1409F38CC
 * Callers:
 ...
 *     MxComputePfnPagesNeeded @ 0x1409F3B6C (MxComputePfnPagesNeeded.c)
 */
...
LABEL_9:
    ...
    while ( 1 )
    {
      ...
      v12 = (unsigned int)MiPageToNode(v11, 0);
      if ( v6 != -1 )
      {
