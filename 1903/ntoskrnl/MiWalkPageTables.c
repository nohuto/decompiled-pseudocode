/*
 * XREFs of MiWalkPageTables @ 0x140048F60
 * Callers:
...
__int64 __fastcall MiWalkPageTables(__int16 *a1)
{
  ...
  if ( !*((_BYTE *)a1 + 5) )
    *((_BYTE *)a1 + 5) = 15;
  v2 = *((_QWORD *)a1 + 2);
  *((_QWORD *)a1 + 8) = *(_QWORD *)(qword_140466188 + 8LL * *(unsigned __int16 *)(v2 + 174));
  v3 = *((_QWORD *)a1 + 6);
  if ( v3 )
  {
  ...
  else
  {
    ...
    if ( (*(_BYTE *)(v2 + 184) & 7) != 0 )
    {
      ...
      {
        case 1:
          si128.m128i_i64[0] = qword_1404659D0;
          si128.m128i_i64[1] = qword_1404659D0 + 0x7FFFFFFFFFLL;
          break;
        case 2:
          si128.m128i_i64[0] = qword_140465D98;
          si128.m128i_i64[1] = qword_140465D98 + (qword_140465D78 << 21) - 1;
          break;
        case 3:
          si128.m128i_i64[0] = qword_140465D50;
          si128.m128i_i64[1] = qword_140465D50 + (qword_140465D30 << 21) - 1;
          break;
        case 4:
          si128.m128i_i64[0] = qword_140465CC0;
          si128.m128i_i64[1] = qword_140465CC0 + (qword_140465CA0 << 21) - 1;
          break;
        case 6:
          si128.m128i_i64[0] = qword_140465C30;
          si128.m128i_i64[1] = qword_140465C30 + (qword_140465C10 << 21) - 1;
          break;
      }
      goto LABEL_17;
    }
    ...
    {
      v5 = 276840448LL;
      qword_140465EF8 = 0x10000000LL;
      qword_140465EE8 = 276840448LL;
      qword_140465EF0 = 276824064LL;
    }
    v38 = qword_140465ED8 + v5 - 1;
  }
  v53 = 2;
LABEL_17:
  v6 = &v44;
