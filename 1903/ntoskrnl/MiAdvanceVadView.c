...
__int64 __fastcall MiAdvanceVadView(__int64 a1, __int64 a2)
{
  ...
  if ( (*(_DWORD *)(a1 + 48) & 0x100000) == 0 )
  {
    ...
    if ( v9 )
    {
      SubsectionNode = MiLocatePagefileSubsection((unsigned int *)(v6 + 128), &v16);
      v8 = v16;
    }
    else
    {
      SubsectionNode = MiLocateSubsectionNode(v6, v7, 0);
    }
    v11 = (__int64)SubsectionNode;
    v12 = (unsigned __int64)*(unsigned __int8 *)(a1 + 33) << 32;
    v13 = v8 - (*((unsigned int *)SubsectionNode + 9) | ((unsigned __int64)(SubsectionNode[16] & 0xFFC0) << 26));
