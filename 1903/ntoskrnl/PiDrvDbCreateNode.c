/*
 * XREFs of PiDrvDbCreateNode @ 0x1407565AC
 * Callers:
...
__int64 __fastcall PiDrvDbCreateNode(PCWSTR Source, int a2, __int64 a3, const WCHAR *a4, __int64 *a5)
{
  ...
  int v16; // eax
  __int64 *v17; // rax
  OBJECT_ATTRIBUTES ObjectAttributes; // [rsp+30h] [rbp-58h] BYREF
...
LABEL_14:
    ...
    {
      *(_DWORD *)(v9 + 496) = 259;
      v17 = (__int64 *)qword_14045EE38;
      if ( *(__int64 **)qword_14045EE38 != &PiDrvDbNodeList )
        __fastfail(3u);
      *(_QWORD *)(v9 + 8) = qword_14045EE38;
