/*
 * XREFs of RtlpMuiRegGetOrAddLangInfo @ 0x140785C78
 * Callers:
 ...
 * Callees:
 *     RtlpMuiRegGetLangInfoIndex @ 0x140785D40 (RtlpMuiRegGetLangInfoIndex.c)
 *     RtlpMuiRegResizeLanguages @ 0x140945AA0 (RtlpMuiRegResizeLanguages.c)
 */
