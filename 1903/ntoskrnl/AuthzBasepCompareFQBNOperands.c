/*
 * XREFs of AuthzBasepCompareFQBNOperands @ 0x1403469BC
 * Callers:
 *     AuthzBasepEvaluateExpression @ 0x140095A60 (AuthzBasepEvaluateExpression.c)
 ...
 *     AuthzBasepGetConstantOperand @ 0x140095BAC (AuthzBasepGetConstantOperand.c)
 *     RtlIsNameInExpression @ 0x140096220 (RtlIsNameInExpression.c)
 *     AuthzBasepGetOperandStringCaseForEvaluation @ 0x140096838 (AuthzBasepGetOperandStringCaseForEvaluation.c)
 *     memset @ 0x1401D6BC0 (memset.c)
 *     AuthzBasepCompareUnsigned @ 0x140346EAC (AuthzBasepCompareUnsigned.c)
