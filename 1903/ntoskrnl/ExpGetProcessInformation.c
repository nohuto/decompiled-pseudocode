/*
 * XREFs of ExpGetProcessInformation @ 0x1405F8B60
 * Callers:
...
__int64 __fastcall ExpGetProcessInformation(_DWORD *a1, unsigned int a2, unsigned int *a3, _DWORD *a4, int a5)
{
  ...
  int PackageIdentity; // [rsp+50h] [rbp-618h]
  ...
  __int64 v107; // [rsp+C0h] [rbp-5A8h] BYREF
  PVOID P; // [rsp+C8h] [rbp-5A0h] BYREF
  __int64 v109; // [rsp+D0h] [rbp-598h] BYREF
  ...
  _BYTE v134[144]; // [rsp+490h] [rbp-1D8h] BYREF
  _BYTE v135[256]; // [rsp+520h] [rbp-148h] BYREF
    ...
    if ( v29 <= a2 )
    {
      ...
      else
      {
        ...
        *((_QWORD *)v52 + 8) = 0LL;
        ...
        {
          v56 = qword_140465BC0 << 12;
          *((_QWORD *)v52 + 18) = qword_140465BC0 << 12;
          *((_QWORD *)v52 + 1) = v56;
        }
        if ( v28 >= 0 )
          goto LABEL_116;
        ...
        if ( !v6 )
        {
          ...
          if ( v87 >= 0 )
          {
            ...
            *((_DWORD *)v18 + 12) = 0;
            ...
            else if ( qword_140463868 && v19 == (PEPROCESS)qword_140463868 )
            {
...
LABEL_46:
            ...
            if ( Object != PsIdleProcess )
            {
              ...
              {
                v31 = -1073741275;
                if ( *((_QWORD *)v11 + 232) && (_QWORD)xmmword_140436A40 )
                {
                  v31 = ((__int64 (__fastcall *)(__int64, PVOID *))xmmword_140436A40)(v30, &P);
                }
                else
                {
                  v32 = *((_QWORD *)v11 + 141);
            ...
            if ( v75 )
            {
              ...
              else
              {
                *((_DWORD *)v12 + 14) = (_DWORD)v13 - (_DWORD)v12;
                memmove(v13, v135, (unsigned int)v75);
                v80 = v88;
              ...
              if ( v28 >= 0 )
              {
                ...
                else
                {
                  *((_DWORD *)v12 + 84) = (_DWORD)v13 - (_DWORD)v12;
                  memmove(v13, v134, (unsigned int)v74);
