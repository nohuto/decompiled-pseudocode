/*
 * XREFs of PopPepTriggerActivity @ 0x1400B25E8
 * Callers:
 *     PopPepUpdateIdleState @ 0x1400B0724 (PopPepUpdateIdleState.c)
 *     PopPepTryPowerUpComponent @ 0x1400B0870 (PopPepTryPowerUpComponent.c)
 ...
 * Callees:
 *     PopPepCancelActivities @ 0x1400B1DF0 (PopPepCancelActivities.c)
