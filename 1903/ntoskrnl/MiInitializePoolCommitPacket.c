/*
 * XREFs of MiInitializePoolCommitPacket @ 0x140022864
 * Callers:
 ...
 *     MiGetLargePageChain @ 0x1400A3BCC (MiGetLargePageChain.c)
        ...
        __int64 a6)
{
  ...
  *(_QWORD *)(a6 + 56) = (((v7 + v10 - 1) >> 9) & 0x7FFFFFFFF8LL) - 0x98000000000LL;
  ...
  if ( (a5 & 1) != 0 )
  {
    ...
    {
      v14 = 6;
      v15 = (unsigned __int16 *)&unk_140466D00;
    }
    v16 = v15[87];
    *(_QWORD *)(a6 + 40) = v15;
    v17 = qword_140466188;
