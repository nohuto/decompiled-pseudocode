/*
 * XREFs of KiUpdateTimeAssist @ 0x1400F9BA8
 * Callers:
 *     KeResumeClockTimerFromIdle @ 0x140033A00 (KeResumeClockTimerFromIdle.c)
 *     KeSynchronizeTimeToQpc @ 0x14016A1C0 (KeSynchronizeTimeToQpc.c)
 * Callees:
 *     KiComputeNewSystemTime @ 0x1400F9D6C (KiComputeNewSystemTime.c)
