/*
 * XREFs of MiIsProbeActive @ 0x140116C04
 * Callers:
 *     MiReplaceRotateWithDemandZero @ 0x140116764 (MiReplaceRotateWithDemandZero.c)
 *     MmIsIoSpaceActive @ 0x1402C4FC0 (MmIsIoSpaceActive.c)
...
__int64 __fastcall MiIsProbeActive(unsigned __int64 a1, __int64 a2, char a3)
{
  ...
  v4 = 0;
  v5 = 0;
  v8 = ExAcquireSpinLockShared(&dword_140466780);
  v9 = (_QWORD *)qword_140466788;
  v10 = v8;
  if ( qword_140466788 )
  {
    if ( (a3 & 1) != 0 )
