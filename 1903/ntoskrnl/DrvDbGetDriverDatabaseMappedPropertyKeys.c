/*
 * XREFs of DrvDbGetDriverDatabaseMappedPropertyKeys @ 0x14093F7FC
 * Callers:
        ...
        unsigned int *a6)
{
  ...
  v11 = 0;
  *a6 = 0;
  CompositeMappedPropertyKeys = DrvDbGetCompositeMappedPropertyKeys(a1, (_OWORD **)&off_140427060, 7u, a4, a5, v34);
    ...
    while ( 1 )
    {
      ...
      if ( Value != -1073741772 )
      {
        ...
        if ( v9 && (unsigned int)a6 < v7 )
        {
          ...
          *(_DWORD *)(v9 + 4 * v15 + 16) = *(_DWORD *)(v21 + 16);
        }
        if ( v11 + 1 < v11 )
        {
