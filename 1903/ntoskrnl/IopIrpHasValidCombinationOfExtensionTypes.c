/*
 * XREFs of IopIrpHasValidCombinationOfExtensionTypes @ 0x14029A32C
 * Callers:
 *     IoSetAdapterCryptoEngineExtension @ 0x14029A1D0 (IoSetAdapterCryptoEngineExtension.c)
 *     IoSetFsTrackOffsetState @ 0x14029A220 (IoSetFsTrackOffsetState.c)
