/*
 * XREFs of PopBatteryInitialize @ 0x1408A9C10
 * Callers:
 ...
 *     PopPrepareIoctl @ 0x140778E48 (PopPrepareIoctl.c)
 */
...
NTSTATUS __fastcall PopBatteryInitialize(__int64 a1)
{
  ...
  if ( result >= 0 )
  {
    ...
    *(_DWORD *)(a1 + 104) = 3;
    v9 = (_QWORD *)(a1 + 64);
    v10 = (_QWORD *)qword_140443238;
    if ( *(__int64 **)qword_140443238 != &qword_140443230 )
      __fastfail(3u);
    v9[1] = qword_140443238;
    *v9 = &qword_140443230;
    *v10 = v9;
    ++dword_140443214;
    ++dword_140443278;
    result = 0;
    qword_140443238 = (__int64)v9;
    byte_140443218 = 1;
  }
  return result;
}
