/*
 * XREFs of PoFxRegisterDevice @ 0x14076EE00
 * Callers:
 *     <none>
 * Callees:
...
LABEL_6:
    ...
    if ( v13 >= 0 && v12 )
    {
      ...
      if ( (v17 & 2) != 0 )
      {
        _InterlockedOr((volatile signed __int32 *)(v16 + 816), 0x200u);
        v17 = *((_QWORD *)v4 + 1);
      }
      if ( (v17 & 4) != 0 )
        _InterlockedOr((volatile signed __int32 *)(v16 + 816), 0x400u);
      _InterlockedOr((volatile signed __int32 *)(v16 + 816), 0x20u);
      if ( !v18 && !v19 && !v20 && !v21 && !v22 )
        _InterlockedOr((volatile signed __int32 *)(v16 + 816), 1u);
    }
    goto LABEL_8;
  }
LABEL_36:
