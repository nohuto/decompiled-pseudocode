/*
 * XREFs of PpmInfoAdjustSetting @ 0x1406A1968
 * Callers:
 *     PpmSetProfilePolicySetting @ 0x1406A0B54 (PpmSetProfilePolicySetting.c)
 * Callees:
 *     PpmPerfComputePerfReductionTolerance @ 0x1402F6F30 (PpmPerfComputePerfReductionTolerance.c)
 *     PpmInfoWriteData @ 0x1406A1A20 (PpmInfoWriteData.c)
 */
