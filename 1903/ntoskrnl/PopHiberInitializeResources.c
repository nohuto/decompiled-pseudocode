/*
 * XREFs of PopHiberInitializeResources @ 0x140726638
 * Callers:
...
LABEL_23:
    PoolWithTag = qword_1404434A8;
    v1 = 1;
    v20 = 1;
    v19 = 1;
    memset(qword_1404434A8, 0, 0x80uLL);
    v21 = 12288;
    PoolWithTag[1] = qword_140443428;
    v25 = (char *)qword_1404434A0;
    goto LABEL_21;
  }
  if ( PopHiberChecksummingEnabledReg )
  {
  ...
  v21 = v24;
LABEL_21:
  PoSetHiberRange(MemoryMap, 0x8000u, qword_1404434A0, 0x3000uLL, 0x72626968u);
  result = v25;
  MemoryMap[34] = v25;
