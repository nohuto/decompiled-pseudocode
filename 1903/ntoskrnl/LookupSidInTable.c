/*
 * XREFs of LookupSidInTable @ 0x1406DC7D4
 * Callers:
        ...
        _QWORD *a7)
{
  ...
  *a7 = 0LL;
  ...
  {
    v25 = 1;
    v16 = RtlSubAuthorityCountSid(Sid);
    if ( !*v16 )
      goto LABEL_6;
    v17 = *RtlSubAuthoritySid(Sid, (unsigned int)*v16 - 1);
...
LABEL_6:
  v12 = 0;
  v13 = (PSID *)&unk_140428460;
  do
  {
    if ( !v25 )
    {
      Str2a = (wchar_t *)((char *)&unk_140428450 + 104 * v12 + 2);
...
LABEL_10:
  ...
  {
    v14 = v12;
    return (__int64)&unk_140428450 + 104 * v14;
  }
  if ( v10 && a6 && !a3 && v11 < 0x3F )
  {
    if ( v23 )
    {
      ...
      {
        v18 = 104LL * v11;
        v19 = *(void **)((char *)&unk_140428450 + v18 + 16);
        if ( v19 )
        {
          ...
          *a7 = v21;
          ...
          {
            _mm_lfence();
            memmove(v21, *(const void **)((char *)&unk_140428450 + v18 + 16), v20);
            v22 = RtlSubAuthorityCountSid(*(PSID *)((char *)&unk_140428450 + v18 + 16));
