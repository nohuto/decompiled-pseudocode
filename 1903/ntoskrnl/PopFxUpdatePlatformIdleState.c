/*
 * XREFs of PopFxUpdatePlatformIdleState @ 0x1402F5D50
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall PopFxUpdatePlatformIdleState(__int64 a1, int a2, _DWORD *a3)
{
  ...
  if ( *a3 )
  {
    ...
    if ( *(_QWORD *)(a1 + 152) )
    {
      v6 = IoAcquireRemoveLockEx((PIO_REMOVE_LOCK)(a1 + 232), 0LL, &Src, 1u, 0x20u);
      if ( v6 >= 0 )
      {
        v7 = a3[1];
        v11 = 0LL;
        ...
        v12[0] = a2;
        v6 = v9(v8, &GUID_PLATFORM_IDLE_UPDATE, v12, 12LL, 0LL, 0LL, &v11);
