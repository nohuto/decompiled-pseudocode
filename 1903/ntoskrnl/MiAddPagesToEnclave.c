/*
 * XREFs of MiAddPagesToEnclave @ 0x1402D3228
 * Callers:
...
__int64 __fastcall MiAddPagesToEnclave(__int64 a1, unsigned __int64 a2, ULONG_PTR a3, ULONG_PTR a4, unsigned int a5)
{
  ...
  v12 = *(_QWORD *)(qword_140466188 + 8LL * v11[87]);
  v13 = *(_QWORD *)(a1 + 104);
  v39 = v12;
...
LABEL_69:
          ...
          if ( v15 )
            MiReleasePtes((__int64)&qword_1404669C0, v15, 1u);
          if ( v10 )
...
LABEL_8:
    ...
    MiMakeValidPte(v14, qword_140466860, 536870913);
