/*
 * XREFs of MiZeroLargePages @ 0x14018FA6C
 * Callers:
...
__int64 __fastcall MiZeroLargePages(__int64 a1, unsigned __int64 a2)
{
  __int64 v2; // r13
  unsigned int v3; // edi
  int v4; // r14d
...
LABEL_2:
  ...
  while ( 1 )
  {
    ...
    if ( (unsigned int)MiGetPagesToZero((__int64)&MiSystemPartition, a2, v3) )
    {
