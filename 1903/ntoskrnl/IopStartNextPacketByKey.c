/*
 * XREFs of IopStartNextPacketByKey @ 0x140299558
 * Callers:
 *     IoStartNextPacketByKey @ 0x140298DB0 (IoStartNextPacketByKey.c)
 *     IopStartNextPacketByKeyEx @ 0x14029961C (IopStartNextPacketByKeyEx.c)
 * Callees:
