/*
 * XREFs of AuthzBasepAddAccessTypeList @ 0x140113154
 * Callers:
 ...
 * Callees:
 *     AuthzBasepSetAccessReasons @ 0x140113250 (AuthzBasepSetAccessReasons.c)
 *     AuthzBasepSetAppContainerAccessReasons @ 0x14034683C (AuthzBasepSetAppContainerAccessReasons.c)
 *     AuthzBasepUpdateParentTypeList @ 0x140346884 (AuthzBasepUpdateParentTypeList.c)
 */
