/*
 * XREFs of RtlpGenericInverseCouplingWorker @ 0x1403157B0
 * Callers:
 *     RtlScrubMemory @ 0x1403154E8 (RtlScrubMemory.c)
 * Callees:
 *     RtlpTestAndFillMemoryUp @ 0x14031605C (RtlpTestAndFillMemoryUp.c)
 *     RtlpTestMemory @ 0x140316084 (RtlpTestMemory.c)
 */
