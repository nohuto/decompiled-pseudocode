/*
 * XREFs of MiInitializeNonPagedPool @ 0x1409F18B4
 * Callers:
...
__int64 MiInitializeNonPagedPool()
{
  ...
  if ( KeNumberNodes )
  {
    do
    {
      ...
      v14 = 11LL * v7;
      v15 = v12 * v7 + v5;
      qword_140465A58[v14 + 10].Alignment = v15;
      v13[v14 + 10].Region = v15 + v12;
      if ( !(unsigned int)MiBuildDynamicRegion((__int64 *)&qword_140465A58[v14 + 4], v15, v12) )
        return 0LL;
    }
