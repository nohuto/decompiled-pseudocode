/*
 * XREFs of PopFxComponentPerfWork @ 0x1402F2ED0
 * Callers:
 *     <none>
 * Callees:
...
LONG __fastcall PopFxComponentPerfWork(volatile signed __int32 *a1)
{
  ...
  v7 = *(_QWORD *)(v1 + 80);
  result = _InterlockedExchangeAdd((volatile signed __int32 *)(v7 + 236), 0xFFFFFFFF);
  if ( result == 1 )
    return KeSetEvent((PRKEVENT)(v7 + 240), 0, 0);
  return result;
}
