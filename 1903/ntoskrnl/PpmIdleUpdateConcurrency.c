/*
 * XREFs of PpmIdleUpdateConcurrency @ 0x1402EFA58
 * Callers:
 *     PpmIdleExecuteTransition @ 0x140031530 (PpmIdleExecuteTransition.c)
 *     PpmIdleInstallConcurrency @ 0x1402EF350 (PpmIdleInstallConcurrency.c)
 *     PpmIdleRemoveConcurrency @ 0x1402EF680 (PpmIdleRemoveConcurrency.c)
 * Callees:
