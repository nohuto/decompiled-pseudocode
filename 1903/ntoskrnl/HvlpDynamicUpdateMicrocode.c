/*
 * XREFs of HvlpDynamicUpdateMicrocode @ 0x140851528
 * Callers:
 *     HvlUpdateMicrocodeDatabase @ 0x140851490 (HvlUpdateMicrocodeDatabase.c)
 * Callees:
 ...
 *     HvcallInitInputControl @ 0x140344014 (HvcallInitInputControl.c)
