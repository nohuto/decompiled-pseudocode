/*
 * XREFs of ExAcquireFastResourceSharedStarveExclusive @ 0x14016ABA0
 * Callers:
 ...
 *     ExpTryAcquireResourceSharedStarveExclusive @ 0x14012ED3C (ExpTryAcquireResourceSharedStarveExclusive.c)
