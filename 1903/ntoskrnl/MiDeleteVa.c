/*
 * XREFs of MiDeleteVa @ 0x14004B480
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall MiDeleteVa(__int64 a1, ULONG_PTR a2, int a3)
{
  ...
  if ( (v3 & 1) == 0 )
  {
    if ( (v3 & 0x400) == 0 )
    {
      ...
      v149 = v3;
      v60 = *(_QWORD *)(qword_140466188 + 8 * v59);
      if ( (v3 & 4) != 0 || (v3 & 2) != 0 )
      ...
      if ( (v10 & 0x40) != 0 )
      {
        if ( qword_140465B00 && (v3 & 0x10) == 0 )
          LOWORD(v3) = ~(_WORD)qword_140465B00 & v3;
...
LABEL_95:
    ...
    v80 = v3;
    if ( qword_140465B00 && (v3 & 0x10) == 0 )
      v80 = v3 & ~qword_140465B00;
    v81 = v80 >> 16;
    v82 = v3;
    if ( qword_140465B00 && (v3 & 0x10) == 0 )
      v82 = v3 & ~qword_140465B00;
...
LABEL_74:
  ...
  if ( (v10 & 0x50) != 0x40 )
    goto LABEL_75;
  if ( (v10 & 2) != 0 && (*(_BYTE *)(v138 + 187) & 1) == 0 && dword_140466368 )
  {
...
LABEL_47:
  ...
  if ( MiPteInShadowRange(v36) )
  {
    ...
    {
      if ( !HIBYTE(word_140465BEC) && (v46 & 1) != 0 )
