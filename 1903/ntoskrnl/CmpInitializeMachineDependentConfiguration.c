/*
 * XREFs of CmpInitializeMachineDependentConfiguration @ 0x140A0B95C
 * Callers:
...
NTSTATUS __fastcall CmpInitializeMachineDependentConfiguration(__int64 a1)
{
  ...
  UNICODE_STRING DestinationString; // [rsp+50h] [rbp-D8h] BYREF
  OBJECT_ATTRIBUTES ObjectAttributes; // [rsp+60h] [rbp-C8h] BYREF
  int Data; // [rsp+90h] [rbp-98h] BYREF
  ULONG Disposition; // [rsp+94h] [rbp-94h] BYREF
  HANDLE SectionHandle; // [rsp+98h] [rbp-90h] BYREF
  ...
  *(_QWORD *)&DestinationString.Length = 0LL;
  ...
  do
  {
    ...
    *(_WORD *)((char *)&CmpDeviceIndexTable + v2) = 0;
    ++v4;
    v2 += 2LL;
  }
  while ( v4 < 0x2A );
