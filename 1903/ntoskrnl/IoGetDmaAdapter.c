/*
 * XREFs of IoGetDmaAdapter @ 0x14077B4F0
 * Callers:
        ...
        PULONG NumberOfMapRegisters)
{
  ...
  if ( PhysicalDeviceObject )
  {
    ...
    ((void (__fastcall *)(struct _KTHREAD *, PDEVICE_OBJECT))off_140424648[0])(
      KeGetCurrentThread(),
    ...
    ((void (__fastcall *)(struct _KTHREAD *, _QWORD))off_140424648[0])(KeGetCurrentThread(), 0LL);
  }
