/*
 * XREFs of MiGetKernelStackSwapSupport @ 0x1400F15E0
 * Callers:
...
__int64 __fastcall MiGetKernelStackSwapSupport(__int64 a1, __int64 a2)
{
  ...
  v2 = -1;
  v3 = 0;
  v5 = *(_QWORD *)(qword_140466188 + 8LL * *(unsigned __int16 *)(a2 + 1454));
  v6 = *(_DWORD *)(v5 + 7896);
  if ( !v6 )
    return 3221225799LL;
  v7 = (__int64 *)(v5 + 7904);
  ...
  *(_DWORD *)(a1 + 72) = MiFindFreePageFileSpace(v5, v12, 6 * v9, 0x21u);
  return 0LL;
}
