/*
 * XREFs of MiActOnPartitionNodePages @ 0x1402E8F4C
 * Callers:
...
LABEL_44:
    ...
    if ( (char *)v10 != v18 && (*(_DWORD *)v10 | dword_14037C7E0[v11 & 0x1F]) == -1 )
    {
    ...
    while ( v17 < v15 && _bittest64(v8, v17) )
      ++v17;
    v16 = 0LL;
    if ( (char *)v10 != v18 && (*(_DWORD *)v10 & ~dword_14037C7E0[v17 & 0x1F]) == 0 )
    {
      v16 = 32 - (v17 & 0x1F);
      if ( v16 == -1 )
        goto LABEL_43;
