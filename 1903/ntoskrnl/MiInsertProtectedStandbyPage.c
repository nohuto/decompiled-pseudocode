/*
 * XREFs of MiInsertProtectedStandbyPage @ 0x140024110
 * Callers:
...
__int64 __fastcall MiInsertProtectedStandbyPage(__int64 a1, __int64 a2)
{
  ...
  if ( (v4 & 0x10000000000000LL) != 0 || byte_14046971E && _bittest64((const signed __int64 *)qword_14046A040, v6 >> 9) )
  ...
  if ( (v7 & 0x40) != 0 )
    return MiPfnReferenceCountIsZero(a2, v6);
  v8 = *(_QWORD *)(qword_140466188 + 8 * ((v4 >> 40) & 0x3FF));
  if ( *(_QWORD *)(qword_140466188 + 8 * ((*(_QWORD *)(a1 + 40) >> 40) & 0x3FFLL)) != v8 || (v7 & 7u) >= 5 )
    return MiPfnReferenceCountIsZero(a2, v6);
...
LABEL_17:
  ...
  *(_QWORD *)(a1 + 40) = v20 | v19 & *(_QWORD *)(a1 + 40);
  ...
  if ( (v21 & 8) != 0 )
    ...
    v22 = v21 & 7;
  v23 = (_QWORD *)(*(_QWORD *)(*(_QWORD *)(qword_140466188 + 8 * ((*(_QWORD *)(a2 + 40) >> 40) & 0x3FFLL)) + 16LL)
