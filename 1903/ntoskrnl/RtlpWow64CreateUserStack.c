/*
 * XREFs of RtlpWow64CreateUserStack @ 0x1406DC048
 * Callers:
...
NTSTATUS __fastcall RtlpWow64CreateUserStack(unsigned __int64 a1, unsigned __int64 a2, __int64 a3, int a4, __int64 a5)
{
  ...
  v33 = a1;
  v31 = 0LL;
  v7 = KeGetCurrentThread()->ApcState.Process[1].ActiveProcessors.Bitmap[0];
  v23 = v7;
  if ( !a1 || (v8 = a2) == 0 )
  {
    v16 = 0;
  ...
  if ( v32 && v9 < v32 )
  {
    v9 = (v32 + 4095) & 0xFFFFFFFFFFFFF000uLL;
    ...
    *(_QWORD *)(a5 + 40) = v12 + v10;
    ...
    if ( v14 < 0
      ...
      && (BaseAddress = v15 - 0x2000,
          v25 = 0x2000LL,
          v14 = ZwAllocateVirtualMemory((HANDLE)0xFFFFFFFFFFFFFFFFLL, &BaseAddress, 0LL, &v25, 0x1000u, 0x104u),
          v14 < 0) )
    {
      v27 = *(PVOID *)(a5 + 56);
      v26 = 0LL;
