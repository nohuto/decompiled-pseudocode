/*
 * XREFs of AlpcpEnterAllocationEventMessageLog @ 0x1408859A4
 * Callers:
 ...
 *     AlpcpAllocateMessageLog @ 0x1408857B4 (AlpcpAllocateMessageLog.c)
 */
...
char __fastcall AlpcpEnterAllocationEventMessageLog(__int64 a1)
{
  ...
  if ( MessageLog )
  {
    ...
    *(_DWORD *)(MessageLog + 44) = 1;
    v3 = (__int64 *)qword_140446748;
    if ( *(__int64 **)qword_140446748 != &AlpcpMessageLogListHead
      || (*(_QWORD *)(MessageLog + 8) = qword_140446748,
          *(_QWORD *)MessageLog = &AlpcpMessageLogListHead,
          v4 = (char *)(MessageLog + 16),
          *v3 = MessageLog,
          qword_140446748 = MessageLog,
