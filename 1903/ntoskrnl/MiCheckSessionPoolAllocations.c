/*
 * XREFs of MiCheckSessionPoolAllocations @ 0x140727D44
 * Callers:
...
void MiCheckSessionPoolAllocations()
{
  ...
  v9 = qword_1404659D8 + 4096;
  v0 = 292LL;
  if ( _BitScanReverse64((unsigned __int64 *)&v2, 0x124uLL) )
    v0 = 1LL << v2;
  v10 = v0;
  v3 = 2LL;
  v4 = (ULONG_PTR *)KeGetCurrentThread()->ApcState.Process[1].ActiveProcessors.Bitmap[1];
  v5 = &v10;
  BugCheckParameter3 = v4[157];
  v12 = v4[158];
  do
  {
    v6 = *(v5 - 1);
