/*
 * XREFs of KeNumaInitialize @ 0x140A2244C
 * Callers:
...
__int64 (*KeNumaInitialize())()
{
  ...
  char v2; // [rsp+80h] [rbp+8h] BYREF

  memset(v1, 0, 0x40uLL);
  result = (__int64 (*)())((__int64 (__fastcall *)(__int64, __int64, _QWORD *, char *))off_140426798[0])(
                            11LL,
                            64LL,
                            v1,
                            &v2);
  if ( (int)result >= 0 )
  {
    ...
    KiNumaQueryNodeDistance = (__int64 (__fastcall *)())v1[7];
