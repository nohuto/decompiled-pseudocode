/*
 * XREFs of PopInitializePowerSettings @ 0x140A20E5C
 * Callers:
...
const WNF_STATE_NAME *PopInitializePowerSettings()
{
  ...
  qword_140442CC8 = (__int64)&PopRegisteredPowerSettingCallbacks;
  PopRegisteredPowerSettingCallbacks = (__int64)&PopRegisteredPowerSettingCallbacks;
  qword_140442C98 = (__int64)&PopPowerSettings;
