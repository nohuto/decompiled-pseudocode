/*
 * XREFs of PspRevertContainerImpersonation @ 0x140036810
 * Callers:
 *     PsImpersonateContainerOfThread @ 0x1400471A0 (PsImpersonateContainerOfThread.c)
 *     NtRevertContainerImpersonation @ 0x140132340 (NtRevertContainerImpersonation.c)
...
__int64 __fastcall PspRevertContainerImpersonation(ULONG_PTR BugCheckParameter1)
{
  ...
  v1 = *(void **)(BugCheckParameter1 + 1928);
  if ( !v1 )
    return 3221225473LL;
...
LABEL_27:
  ...
  *(_QWORD *)(BugCheckParameter1 + 1928) = 0LL;
