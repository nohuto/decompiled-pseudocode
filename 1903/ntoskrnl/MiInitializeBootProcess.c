/*
 * XREFs of MiInitializeBootProcess @ 0x140A202F0
 * Callers:
...
__int64 MiInitializeBootProcess()
{
  ...
  *v1 = 0LL;
  ...
  v2 = (unsigned __int64 **)qword_140465A08;
  v3 = &Process[2].Affinity.Bitmap[5];
  if ( *(__int64 **)qword_140465A08 != &qword_140465A00 )
    __fastfail(3u);
  Process[2].Affinity.Bitmap[6] = qword_140465A08;
  *v3 = (unsigned __int64)&qword_140465A00;
  *v2 = v3;
  qword_140465A08 = (__int64)&Process[2].Affinity.Bitmap[5];
