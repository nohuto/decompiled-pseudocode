/*
 * XREFs of PpmParkCalculateUnparkCount @ 0x140121C20
 * Callers:
...
char PpmParkCalculateUnparkCount()
{
  ...
  do
  {
    ...
    {
      v10 = *(_BYTE *)(v9 + v6 + 128);
      if ( !v10 || ((unsigned __int8)(1 << (v7 + 1)) & *(_BYTE *)(v6 + 146)) != 0 )
        goto LABEL_48;
