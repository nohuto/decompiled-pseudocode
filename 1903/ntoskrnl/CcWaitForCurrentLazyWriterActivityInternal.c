/*
 * XREFs of CcWaitForCurrentLazyWriterActivityInternal @ 0x14017112C
 * Callers:
 *     CcWaitForCurrentLazyWriterActivityHelper @ 0x140171100 (CcWaitForCurrentLazyWriterActivityHelper.c)
