/*
 * XREFs of AnFwpProgressAnimationManual @ 0x1409941C8
 * Callers:
...
LONGLONG AnFwpProgressAnimationManual()
{
  ...
  result = qword_1404F2AE8;
  if ( v0.QuadPart + v2 >= qword_1404F2AE8 + v7.QuadPart / 33 )
  {
    v4 = word_140429E28;
    if ( word_140429E28 != -7989 && (qword_1404F2AE8 - v0.QuadPart - v2) / v1 >= 2 )
      v4 = ++word_140429E28;
    if ( (unsigned __int16)(v4 + 8110) <= 0x79u )
    {
      LogFwStat(1, 1, 0LL);
      BgpTxtDisplayCharacter(qword_14042C0F0, word_140429E28, 0, 0LL, 0LL);
      LogFwStat(0, 1, 0LL);
      v4 = word_140429E28;
    }
    v5 = -8118;
