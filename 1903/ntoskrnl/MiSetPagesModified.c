/*
 * XREFs of MiSetPagesModified @ 0x1402C33FC
 * Callers:
...
__int64 __fastcall MiSetPagesModified(__int64 *a1, int a2)
{
  ...
  v4 = *(_QWORD *)(qword_140466188 + 8LL * (*((_WORD *)a1 + 30) & 0x3FF));
  v46 = v4;
  v45[1] = v4;
  v52 = *a1;
  v47 = v52;
  ...
  if ( v9 >= 0 )
  {
          ...
          *(_BYTE *)(v17 - 0x58000000000LL + 34) = v19 | 0x10;
          ...
          if ( v18 )
            MiReleasePageFileInfo(
              *(_QWORD *)(qword_140466188 + 8 * ((*(_QWORD *)(v17 - 0x58000000000LL + 40) >> 40) & 0x3FFLL)),
              v18,
              1);
          v10 = v42;
        }
    ...
    if ( v23 )
    {
      ...
      if ( v34 && ($6EAC78A6FCFADE0A5FA44F358736B38F *)v27->ApcState.ApcListHead[0].Flink != &v27->152 )
