/*
 * XREFs of MiInsertHugeRangeInList @ 0x1402C27AC
 * Callers:
...
__int64 __fastcall MiInsertHugeRangeInList(int a1, char a2, _QWORD *a3)
{
  ...
  v4 = a1 & 0x3FFFF;
  v6 = *(_QWORD *)(qword_1404661B0 + 8 * v4);
  if ( a3 )
    v7 = a3;
  else
    v7 = *(_QWORD **)(qword_140466188 + 8 * ((v6 >> 40) & 0x7FF));
  v8 = (v6 >> 51) & 0x3F;
  v9 = v7[889] + 8LL * (unsigned int)(2 * v8 * dword_140465B40[0]);
  v10 = a2 & 1;
  if ( (a2 & 1) != 0 )
  {
    v11 = 1824LL;
  ...
  {
    v9 += 8LL * (unsigned int)dword_140465B40[0];
    v11 = 1832LL;
  }
  v22 = v4 % (unsigned int)dword_140465B40[0];
  ...
  if ( (v16 & 0x3FFFF) != 0 )
  {
    ...
    *(_QWORD *)(qword_1404661B0 + 8 * v17) = v15 | *(_QWORD *)(qword_1404661B0 + 8 * v17) & 0xFFFFFFC0000FFFFFuLL;
  }
  else
  {
    *(_QWORD *)(v3 + 8 * v4) = v14;
