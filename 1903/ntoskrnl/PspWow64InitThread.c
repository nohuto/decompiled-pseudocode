/*
 * XREFs of PspWow64InitThread @ 0x1406C94A8
 * Callers:
 ...
 *     RtlpArchContextFlagFromMachine @ 0x1406CA730 (RtlpArchContextFlagFromMachine.c)
...
__int64 __fastcall PspWow64InitThread(_KPROCESS *BugCheckParameter1, __int64 a2, _QWORD *a3, __int64 a4)
{
  ...
  v7 = 0;
  v8 = BugCheckParameter1[1].ActiveProcessors.Bitmap[6];
  ...
  v15 = a3[16];
  v16 = a3[17];
  KiStackAttachProcess(BugCheckParameter1, v11, (__int64)v23);
  v17 = v21;
  *(_QWORD *)(v22 + 5256) = v21;
  *v17 = v9 << 16;
  switch ( v9 )
