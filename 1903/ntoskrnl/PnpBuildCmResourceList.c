/*
 * XREFs of PnpBuildCmResourceList @ 0x1407525C0
 * Callers:
...
int __fastcall PnpBuildCmResourceList(__int64 a1, int a2)
{
  ...
  __int64 Destination; // [rsp+48h] [rbp-C0h]
  UNICODE_STRING Destination_8; // [rsp+50h] [rbp-B8h] BYREF
  __int64 v41; // [rsp+60h] [rbp-A8h]
  _QWORD v42[2]; // [rsp+68h] [rbp-A0h] BYREF
  PVOID P[2]; // [rsp+78h] [rbp-90h] BYREF
  HANDLE Handle[2]; // [rsp+88h] [rbp-80h] BYREF
  UNICODE_STRING v45; // [rsp+98h] [rbp-70h] BYREF
...
LABEL_42:
  ...
  LODWORD(v41) = 20 * (v5 + 1);
  PoolWithTag = ExAllocatePoolWithTag(PagedPool, (unsigned int)v41, 0x20207050u);
  Handle[0] = PoolWithTag;
  v11 = PoolWithTag;
  if ( !PoolWithTag )
  {
LABEL_37:
...
LABEL_43:
  ...
  memset(PoolWithTag, 0, (unsigned int)v41);
  v12 = ExAllocatePoolWithTag(PagedPool, (unsigned int)v41, 0x20207050u);
  v13 = v12;
  if ( !v12 )
  {
    ...
    if ( (_DWORD)v38 )
    {
      ...
      if ( (int)v7 >= 0 )
      {
        ...
        *(_QWORD *)&Destination_8.Length = 0LL;
        ...
        v42[1] = L"PnP Manager";
        P[1] = L"PnpManager";
        v29 = ObQueryNameStringMode(v28, (__int64)&v45, 0x200u, &v38, 0);
        v30 = Handle[0];
        if ( v29 >= 0 )
        {
          v45.MaximumLength = 496;
          Buffer = (wchar_t *)&v46;
          if ( v45.Length )
            Buffer = v45.Buffer;
          v45.Buffer = Buffer;
          ...
          v32 = v41;
          if ( (int)IopWriteResourceList(v30, v42, P, &Destination_8, v13, v41) >= 0 )
          {
            Destination_8 = v45;
            RtlAppendUnicodeToString(&Destination_8, L".Translated");
            IopWriteResourceList(v30, v42, P, &Destination_8, v11, v32);
          }
        }
...
LABEL_17:
    ...
    if ( v24 )
    {
      ...
      while ( v26 );
      v4 = *(_QWORD *)&Destination_8.Length;
      v11 = Handle[0];
      v14 = Destination;
    }
