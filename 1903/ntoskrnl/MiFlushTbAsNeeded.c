/*
 * XREFs of MiFlushTbAsNeeded @ 0x140021F90
 * Callers:
 ...
 *     MiCanMergeTbFlushEntryBackwards @ 0x14011C8FC (MiCanMergeTbFlushEntryBackwards.c)
...
__int64 __fastcall MiFlushTbAsNeeded(ULONG_PTR BugCheckParameter2, unsigned __int64 a2, int a3, int a4)
{
  ...
  if ( a2 )
  {
    ...
    while ( 1 )
    {
      ...
      if ( qword_140465B00 && (BugCheckParameter4 & 0x10) == 0 )
        BugCheckParameter4 &= ~qword_140465B00;
