/*
 * XREFs of MiTransientPageListWriter @ 0x1402E7AB4
 * Callers:
...
__int64 __fastcall MiTransientPageListWriter(unsigned __int64 a1, unsigned __int64 a2)
{
  ...
  v4 = ExAcquireSpinLockShared(&dword_1404660E0);
  v5 = (_QWORD *)qword_1404660E8;
  v6 = v4;
  v7 = 0;
  while ( v5 )
  {
  ...
  if ( v5 && (!v5[4] || a2 < v5[5] || a2 > v5[6]) )
    v5 = 0LL;
  ExReleaseSpinLockSharedFromDpcLevel(&dword_1404660E0);
