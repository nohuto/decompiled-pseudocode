/*
 * XREFs of PerfLogImageLoad @ 0x1405EC1AC
 * Callers:
  ...
  if ( a1 && *a1 && *((_QWORD *)a1 + 1) )
  {
    ...
    *(_WORD *)v12 = BYTE2(v6) & 7;
    ...
    if ( EtwpHostSiloState != -4516 && (*(_DWORD *)(EtwpHostSiloState + 4516) & 4) != 0 )
      EtwpPsProvTraceImage(a1, (ULONGLONG)v8, 5121, 0);
    v17[0] = v8;
    v17[1] = 56LL;
    v17[2] = *((_QWORD *)a1 + 1);
    v18 = *a1;
    ...
    v21 = 2LL;
    if ( a2 )
      EtwTraceSiloKernelEvent(*(_QWORD *)(a2 + 1776), (int)v17, 3, 4u, 778, 5249283);
    else
