/*
 * XREFs of KiSetPriorityFloor @ 0x14009EEC0
 * Callers:
...
char __fastcall KiSetPriorityFloor(ULONG_PTR BugCheckParameter1, __int64 *a2, signed __int8 a3, char a4)
{
  char v4; // si
  ...
  *(_DWORD *)(BugCheckParameter1 + 1408) |= 1 << a3;
  ...
  {
    KiSetPriorityThread((_BYTE *)BugCheckParameter1, a2, a3);
    v4 = 1;
  }
  if ( !a4 )
