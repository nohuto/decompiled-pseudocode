/*
 * XREFs of SmQueryStoreInformation @ 0x1406EEEA4
 * Callers:
...
__int64 __fastcall SmQueryStoreInformation(__int64 a1, __int64 a2, int a3, __int64 a4, _DWORD *a5)
{
  ...
  *(_QWORD *)v9 = *(_QWORD *)(a2 + 16);
  ...
  switch ( v8[1] )
  {
    ...
    case 8:
      return SmcProcessListRequest((unsigned int)&unk_14058C1C0, v8[2], v9[0], (_DWORD)a5, PreviousMode);
    case 15:
    ...
    case 13:
      return SmcProcessStatsRequest((unsigned int)&unk_14058C1C0, v8[2], v9[0], (_DWORD)a5, PreviousMode);
    default:
      return 3221225475LL;
  }
}
