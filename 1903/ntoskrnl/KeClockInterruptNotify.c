/*
 * XREFs of KeClockInterruptNotify @ 0x140034500
 * Callers:
 *     <none>
 * Callees:
 *     KeGetPrcb @ 0x140005278 (KeGetPrcb.c)
 *     KiCheckPreferredHeteroProcessor @ 0x1400119D8 (KiCheckPreferredHeteroProcessor.c)
 *     KiShouldScanSharedReadyQueue @ 0x140011CD0 (KiShouldScanSharedReadyQueue.c)
 *     KeYieldProcessorEx @ 0x14002D3D0 (KeYieldProcessorEx.c)
 *     KeAccumulateTicks @ 0x140033360 (KeAccumulateTicks.c)
 *     PoExecutePerfCheck @ 0x140035CA0 (PoExecutePerfCheck.c)
 *     KiForwardTick @ 0x140035D50 (KiForwardTick.c)
 *     KiCheckGroupSchedulingQuantumEnd @ 0x1400361F0 (KiCheckGroupSchedulingQuantumEnd.c)
 ...
 *     KiIsQosGroupingActive @ 0x1401BE7E4 (KiIsQosGroupingActive.c)
 *     KiIsQosGroupingClass @ 0x1401BE808 (KiIsQosGroupingClass.c)
...
LABEL_206:
  ...
  v19 = 24LL * (unsigned int)KiClockTickTraceIndex + 4511168;
  ...
  *((_QWORD *)&v29 + 1) = 0LL;
  ...
  if ( (unsigned int)KeNumberProcessors_0 > 1 )
  {
    ...
    for ( ; v52 < (unsigned __int16)*v51; *(_QWORD *)&KiClockCheckPending[4 * v54 + 4] = *(_QWORD *)&v51[4 * v54 + 4] )
      v54 = v52++;
    for ( dword_14042A0F4 = 0; v52 < (unsigned __int16)word_14042A0F2; *(_QWORD *)&KiClockCheckPending[4 * v55 + 4] = 0LL )
      v55 = v52++;
  }
