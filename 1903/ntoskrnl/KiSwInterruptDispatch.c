/*
 * XREFs of KiSwInterruptDispatch @ 0x1401AAEA0
 * Callers:
 *     KiSwInterrupt @ 0x1401C9730 (KiSwInterrupt.c)
 * Callees:
 *     KeExitRetpoline @ 0x1400FF0D8 (KeExitRetpoline.c)
 *     memmove @ 0x1401D6880 (memmove.c)
 *     KiGetTrapFrameMode @ 0x1402A42AC (KiGetTrapFrameMode.c)
 *     KiReadKernelDr7 @ 0x1402A4554 (KiReadKernelDr7.c)
