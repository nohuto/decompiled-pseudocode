/*
 * XREFs of PopMarkHiberPhase @ 0x1405ACEB4
 * Callers:
...
void __fastcall PopMarkHiberPhase(unsigned int *Address)
{
  ...
  PoSetHiberRange(0LL, 0x10000u, qword_140443450, Length, 0);
  ...
  PoSetHiberRange(0LL, 0x10000u, qword_140443418, (unsigned int)dword_140443420, 0);
