/*
 * XREFs of MmCreatePeb @ 0x14067A018
 * Callers:
  ...
  *((_WORD *)a4 + 4) = v7;
  ...
  else
  {
    ...
    *(_QWORD *)((char *)&v36[1] + 4) = 10LL;
    ...
    {
      v24 = _InterlockedExchangeAdd(&dword_1404659F4, 1u) + 1;
      do
      {
        v25 = v24 & 0x3F;
        v26 = 1LL << v25;
    ...
    *(_QWORD *)(v27 + 192) = qword_1404659F8;
    ...
    *(_QWORD *)(v27 + 1976) = v33;
    *(_DWORD *)(v27 + 1984) = 0;
    if ( a1[133] && (v28 = MiInitializeWowPeb(v36, v14, a1, a4), v28 < 0) )
    {
      KeUnstackDetachProcess(&ApcState);
