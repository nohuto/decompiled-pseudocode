/*
 * XREFs of MiCoalesceFreeLargePages @ 0x14009BB30
 * Callers:
    ...
    if ( v14 )
    {
      ...
      while ( 1 )
      {
        ...
        if ( (*(_BYTE *)(v18 + 34) & 7u) > 1
          ...
          || *(__int64 *)(v18 + 8) >= 0
          || *(_QWORD *)(qword_140466188 + 8 * ((*(_QWORD *)(v18 + 40) >> 40) & 0x3FFLL)) != a1 )
        {
          break;
        }
        ++v19;
...
LABEL_21:
      ...
      for ( j = 0; j < v14; v22 += 48 * v8 )
      {
        ...
        if ( *(__int64 *)(v22 + 8) >= 0 )
          break;
        if ( *(_QWORD *)(qword_140466188 + 8 * ((*(_QWORD *)(v22 + 40) >> 40) & 0x3FFLL)) != v5 )
          break;
        ++j;
      }
      if ( j == v14 )
...
LABEL_38:
  ...
  while ( v13 <= 0xFFFFFFFFFLL
       ...
       && *(__int64 *)(v12 + 8) < 0
       && *(_QWORD *)(qword_140466188 + 8 * ((*(_QWORD *)(v12 + 40) >> 40) & 0x3FFLL)) == v5 )
  {
    ++v11;
    v13 += v8;
