    ...
    if ( v4 )
    {
      ...
      if ( v5 )
      {
        if ( v5 == 5 && (unsigned int)(a3 - 2) <= 2 )
          PfpLogScenarioEvent(1, 2, 1, dword_140467B94, 0);
LABEL_7:
      ...
      PfpPowerActionStartScenarioTracing((__int64)&qword_140467B60, a2);
      if ( dword_140467B90 == 5 )
        PfSnBeginBootPhase(4LL);
      PfpScenCtxScenarioSet((ULONG_PTR)&qword_140467B60);
      PfpScenCtxScenarioSet((ULONG_PTR)&qword_140467B60);
      PfpScenCtxScenarioSet((ULONG_PTR)&qword_140467B60);
    ...
    else
    {
      ...
      if ( (unsigned int)result <= 3 )
      {
        ...
        v11 = PfpScenCtxPrefetchWait((ULONG_PTR)&qword_140467B60, v8, v9);
  ...
  else
  {
    ...
    if ( (unsigned int)result <= 2 || a3 == 5 )
      return PfpScenCtxScenarioSet((ULONG_PTR)&qword_140467B60);
  }
  return result;
}
