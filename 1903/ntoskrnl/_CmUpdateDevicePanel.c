/*
 * XREFs of _CmUpdateDevicePanel @ 0x1406FF59C
 * Callers:
 ...
 *     _CmGetDevicePanelGroup @ 0x140789D3C (_CmGetDevicePanelGroup.c)
...
LABEL_18:
            ...
            *(_OWORD *)v73 = DEVPKEY_Device_PhysicalDeviceLocationPanel;
            ...
            while ( 2 )
            {
              ...
              if ( v35 < 7 )
                v34 = (unsigned int)dword_1403894D0[v35];
              v65 = v34;
              if ( v5 )
              {
LABEL_154:
...
LABEL_221:
                        ...
                        if ( v70 || (v70 = ExAllocatePoolWithTag(PagedPool, 0x72uLL, 0x52504E50u), (v43 = v70) != 0LL) )
                        {
                          ...
                          if ( ((*(_DWORD *)v62 >> 20) & 7) != 7 )
                            v44 = (unsigned int)dword_1403894D0[(*(_DWORD *)v62 >> 20) & 7];
                          v54 = v44;
