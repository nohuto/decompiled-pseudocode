/*
 * XREFs of PnpCmResourcesToIoResources @ 0x140753CD8
 * Callers:
 ...
 * Callees:
 *     RtlCmDecodeMemIoResource @ 0x14013B5B0 (RtlCmDecodeMemIoResource.c)
    ...
    while ( 1 )
    {
      ...
      *((_WORD *)v18 + 3) = 0;
      switch ( v20->Type )
      {
        ...
        case 6u:
          *((_DWORD *)v18 + 3) = v20->u.Generic.Start.LowPart;
          *((_DWORD *)v18 + 4) = v20->u.Generic.Start.LowPart - 1 + v20->u.Generic.Start.HighPart;
          HighPart = v20->u.Generic.Start.HighPart;
          break;
        case 7u:
LABEL_24:
