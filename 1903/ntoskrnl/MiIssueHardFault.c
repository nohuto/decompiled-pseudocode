/*
 * XREFs of MiIssueHardFault @ 0x140007100
 * Callers:
...
__int64 __fastcall MiIssueHardFault(__int64 a1, ULONG_PTR a2, __int64 a3, __int64 a4)
{
  ...
  *(_DWORD *)(a2 + 184) = v21;
  ...
  else
  {
    ...
    {
      if ( ((PerfGlobalGroupMask & 0x2000) != 0 || (dword_140503A14 & 1) != 0) && (v23 & 0x100) == 0 && (v23 & 8) == 0 )
      {
        v42 = *(_QWORD *)(a2 + 96);
        v43 = *(_QWORD *)(a2 + 224);
        v53 = *(_QWORD *)(a2 + 200);
...
LABEL_25:
        if ( dword_140466368
          && (_DWORD)v61 != 2
          && (unsigned int)MiGetEffectivePagePriorityThread(v8) >= dword_14046636C )
        {
...
LABEL_69:
      ...
      if ( !HIBYTE(word_140465BEC) && (v47 & 1) != 0 )
        v47 |= v51;
      *(_QWORD *)v26 = v47;
...
LABEL_51:
    ...
    if ( (unsigned int)MiPteInShadowRange(v26, v36, v38, v37) )
    {
      if ( (unsigned int)MiPteHasShadow() )
      {
        if ( !HIBYTE(word_140465BEC) && (TransitionPteValid & 1) != 0 )
