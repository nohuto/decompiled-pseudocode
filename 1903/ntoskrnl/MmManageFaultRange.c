/*
 * XREFs of MmManageFaultRange @ 0x140179D24
 * Callers:
 *     RtlpEnvRegisterFaultRange @ 0x140179CD8 (RtlpEnvRegisterFaultRange.c)
 * Callees:
...
__int64 __fastcall MmManageFaultRange(ULONG_PTR BugCheckParameter3, ULONG_PTR BugCheckParameter4, char a3, char a4)
{
  ...
  {
    v10 = 0;
    v11 = (volatile signed __int64 *)&unk_140464518;
    while ( 1 )
    {
      v12 = v11 - 3;
...
LABEL_5:
  ...
  {
    v16 = (unsigned __int64 *)&unk_1404644F8;
  }
  v17 = ExAcquireSpinLockExclusive(&dword_1404644F0);
...
LABEL_20:
  ...
  v18 = 0LL;
LABEL_21:
  ExReleaseSpinLockExclusiveFromDpcLevel(&dword_1404644F0);
  ...
  {
    v22 = 0LL;
    while ( v18 != (unsigned __int64 *)((char *)&unk_140464500 + 40 * v22) )
    {
