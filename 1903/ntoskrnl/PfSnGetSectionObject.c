/*
 * XREFs of PfSnGetSectionObject @ 0x140628628
 * Callers:
 ...
 *     PfSnIsSectionPrefetchedAfterPhase @ 0x1406289D8 (PfSnIsSectionPrefetchedAfterPhase.c)
  ...
  if ( (*(_QWORD *)(v18 + 24) & 0x400000000LL) == 0 )
  {
    ...
    if ( v19 < 0
      || (v19 = PfpFileCheckAttributesForPrefetch(
                  ...
                  (((dword_140467B30 & 0x10) == 0) << 14) + 4864),
          v19 < 0) )
    {
      v16 = v40.m256i_i64[3];
      goto LABEL_27;
