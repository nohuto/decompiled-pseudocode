/*
 * XREFs of VfSuspectDriversParseRegistryString @ 0x140A3E484
 * Callers:
...
int VfSuspectDriversParseRegistryString()
{
  ...
  _QWORD *v10; // rdi
  _QWORD *v11; // rax
  const void *v13; // [rsp+20h] [rbp-28h] BYREF
...
LABEL_30:
    ...
    LODWORD(Entry) = v8 + 2;
    LOWORD(v13) = 2 * (((char *)v6 - (char *)v0) >> 1);
    WORD1(v13) = v8 + 2;
...
LABEL_27:
    ...
    else
    {
      ...
      {
        VfDriverLock();
        v11 = (_QWORD *)qword_140435A08;
        if ( *(__int64 **)qword_140435A08 != &VfExcludedDriversList )
          __fastfail(3u);
        *v10 = &VfExcludedDriversList;
        v10[1] = v11;
        *v11 = v10;
        qword_140435A08 = (__int64)v10;
        goto LABEL_27;
      }
    }
    v4 = 0x100002601LL;
