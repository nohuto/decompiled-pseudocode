/*
 * XREFs of KiUpdateProcessorCount @ 0x14059F558
 * Callers:
 *     KiUpdateNumberProcessorsIpi @ 0x1405AB3B0 (KiUpdateNumberProcessorsIpi.c)
 *     KeStartAllProcessors @ 0x1409EDD08 (KeStartAllProcessors.c)
 * Callees:
 *     KeAddProcessorAffinityEx @ 0x1400BE1E0 (KeAddProcessorAffinityEx.c)
 *     KiGetCurrentGroupCount @ 0x14013D788 (KiGetCurrentGroupCount.c)
 */
