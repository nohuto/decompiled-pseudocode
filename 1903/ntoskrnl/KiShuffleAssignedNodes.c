/*
 * XREFs of KiShuffleAssignedNodes @ 0x140A3C118
 * Callers:
...
void __fastcall KiShuffleAssignedNodes(__int64 *a1, unsigned __int16 a2, __int64 a3, __int64 a4)
{
  ...
  __int64 v36; // r8
  int v37; // r9d
  __int16 v38; // [rsp+0h] [rbp-68h]
  unsigned __int16 v39; // [rsp+2h] [rbp-66h]
  unsigned int v40; // [rsp+8h] [rbp-60h]
  unsigned int v41; // [rsp+Ch] [rbp-5Ch]
  __int64 *v42; // [rsp+10h] [rbp-58h]
  __int64 v43; // [rsp+18h] [rbp-50h]
            ...
            if ( v17 != v16 )
            {
              ...
              if ( *(_DWORD *)(v4 + 4LL * v22) >= v21 )
              {
                ...
                do
                {
                  ...
                  {
                    v25 = a1[v24];
                    if ( *(_WORD *)(v25 + 144) == v17 && (*(_BYTE *)(v25 + 181) & 2) != 0 )
                ...
                do
                {
                  ...
                  {
                    v32 = a1[v31];
                    if ( *(_WORD *)(v32 + 144) == *(_WORD *)(v11 + 144) && (*(_BYTE *)(v32 + 181) & 2) != 0 )
                      v28 += *((_DWORD *)KeNodeDistance
                             + *(unsigned __int16 *)(v32 + 146)
                             + (unsigned __int16)KeNumberNodes * *(unsigned __int16 *)(v43 + 146))
                           / ((unsigned int)*(unsigned __int16 *)(a4 + 2LL * *(unsigned __int16 *)(v11 + 144)) - 1);
                  }
                  ++v31;
                }
                while ( v31 < a2 );
...
LABEL_43:
        ...
        {
          v34 = *(unsigned __int16 *)(v11 + 144);
          v35 = a1[v12];
          v9 = 1;
          v46 = 1;
          v36 = *(unsigned __int16 *)(v35 + 144);
          *(_WORD *)(v11 + 144) = v36;
          *(_WORD *)(v35 + 144) = v34;
          LODWORD(v35) = *(unsigned __int8 *)(v35 + 180);
          v37 = *(unsigned __int8 *)(v11 + 180);
          *(_DWORD *)(v4 + 4 * v34) += v35 - v37;
          *(_DWORD *)(v4 + 4 * v36) += v37 - v35;
        }
LABEL_47:
        ++v8;
        ++v10;
