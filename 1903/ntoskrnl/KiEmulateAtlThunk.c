/*
 * XREFs of KiEmulateAtlThunk @ 0x1402B6B40
 * Callers:
...
__int64 __fastcall KiEmulateAtlThunk(unsigned int *a1, _DWORD *a2, unsigned int *a3, unsigned int *a4, _DWORD *a5)
{
  ...
  v23 = (unsigned int)*a2;
  v22 = 0;
  v11 = (_WORD *)&KeGetPcr()->NtTib.$9424C633A3F015B2949C47ACD1C6BB49::$C9A5EC8C1EDA84B9BBBFFDE0BE1813B0::Self[218].SubSystemTib
      + 1;
  if ( (*v11 & 1) != 0 )
  {
    v12 = 1;
