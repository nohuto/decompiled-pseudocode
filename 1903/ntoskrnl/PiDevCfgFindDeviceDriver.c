/*
 * XREFs of PiDevCfgFindDeviceDriver @ 0x1406FACDC
 * Callers:
 ...
 *     PiDevCfgCompareDrivers @ 0x14029F1FC (PiDevCfgCompareDrivers.c)
...
LABEL_128:
      ...
      if ( v14 )
      {
        ...
        if ( v83 )
        {
          v56 = *v83 - asc_14078D490[0];
          if ( !v56 )
            v56 = v83[1] - asc_14078D490[1];
          if ( !v56 )
            goto LABEL_144;
          v57 = v83;
          if ( *v83 )
