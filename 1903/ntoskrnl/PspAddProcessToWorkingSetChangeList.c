/*
 * XREFs of PspAddProcessToWorkingSetChangeList @ 0x1408C7680
 * Callers:
 *     NtSetInformationJobObject @ 0x140613A70 (NtSetInformationJobObject.c)
 *     PspSetJobLimitsProcessCallback @ 0x1408C8280 (PspSetJobLimitsProcessCallback.c)
 * Callees:
      ...
      if ( (_BYTE)PoolWithTag )
      {
        ...
        if ( PoolWithTag )
        {
          ...
          *(_QWORD *)(PoolWithTag + 24) = *(_QWORD *)(v3 + 792);
          v4 = (__int64 *)qword_14042BDA8;
          if ( *(__int64 **)qword_14042BDA8 != &PspWorkingSetChangeHead )
            __fastfail(3u);
          *(_QWORD *)PoolWithTag = &PspWorkingSetChangeHead;
          *(_QWORD *)(PoolWithTag + 8) = v4;
          *v4 = PoolWithTag;
          qword_14042BDA8 = PoolWithTag;
        }
        else
        {
