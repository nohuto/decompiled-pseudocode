/*
 * XREFs of RtlMarkHiberPhase @ 0x14031857C
 * Callers:
...
unsigned __int64 RtlMarkHiberPhase()
{
  ...
  {
    BugCheckParameter3[0] = qword_140443080;
    if ( !qword_140443080 )
      goto LABEL_118;
    v0 = *(_DWORD *)(qword_140443080 + 184);
    if ( v0 == 8 )
    {
      v1 = (unsigned __int64)XpressHashFunction >> 12;
      v133 = (unsigned __int64)XpressHashFunction >> 12;
      v131 = (unsigned __int64)" the end of the database offset 0x%x size 0x%x" >> 12;
      if ( (unsigned __int64)XpressHashFunction >> 12 < (unsigned __int64)" the end of the database offset 0x%x size 0x%x" >> 12 )
      {
        do
        {
          v2 = 0LL;
...
LABEL_56:
          ...
          if ( v19 )
            v20 = v2;
          v23 = (unsigned __int64)" the end of the database offset 0x%x size 0x%x" >> 12;
          v24 = v20 >> 12;
          v136 = v24;
          if ( v21 < v131 )
          {
...
LABEL_178:
  ...
  if ( (KiBugCheckActive & 3) == 0 )
  {
    v135 = qword_140443080;
    if ( !qword_140443080 )
LABEL_118:
      KeBugCheckEx(0xA0u, 0x10BuLL, 0xAuLL, 0LL, 0LL);
    result = *(unsigned int *)(qword_140443080 + 184);
    if ( (_DWORD)result == 8 )
    {
      v82 = (unsigned __int64)XpressHighBitIndexTable >> 12;
      result = (unsigned __int64)&unk_14039EF5F >> 12;
      v134 = (unsigned __int64)XpressHighBitIndexTable >> 12;
      for ( m = (unsigned __int64)&unk_14039EF5F >> 12; v82 < m; v134 = v82 )
      {
        v83 = 0LL;
