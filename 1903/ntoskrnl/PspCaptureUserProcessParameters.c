/*
 * XREFs of PspCaptureUserProcessParameters @ 0x1406B0910
 * Callers:
 ...
 *     PspCaptureAndValidateUnicodeString @ 0x1406B0FE8 (PspCaptureAndValidateUnicodeString.c)
 *     PspValidateEnvironmentBlock @ 0x1406B1060 (PspValidateEnvironmentBlock.c)
