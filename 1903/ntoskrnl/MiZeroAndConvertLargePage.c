/*
 * XREFs of MiZeroAndConvertLargePage @ 0x1400A2188
 * Callers:
...
__int64 __fastcall MiZeroAndConvertLargePage(__int64 a1, unsigned int a2, int a3, char a4)
{
  ...
  {
    if ( (_DWORD)v5 != 1
      && dword_140465B58[4 * ((unsigned __int64)*(unsigned __int8 *)(v7 + 34) >> 6) + v5] == (_DWORD)v5 )
    {
      MiChangePageAttributeBatch(v10, (unsigned int)v5, ZeroPte);
      v10 = 0LL;
    }
    result = MiZeroLargePage(v7, a2, (unsigned int)v5, v9);
  }
  if ( v10 )
    return MiChangePageAttributeBatch(v10, (unsigned int)v5, ZeroPte);
  return result;
}
