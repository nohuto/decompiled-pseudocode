/*
 * XREFs of DbgkCaptureLiveDump @ 0x14084B148
 * Callers:
 ...
 *     DbgkpLkmdSnapThread @ 0x140281954 (DbgkpLkmdSnapThread.c)
 ...
 *     DbgkpLkmdSqmStatus @ 0x14084BD0C (DbgkpLkmdSqmStatus.c)
...
__int64 __fastcall DbgkCaptureLiveDump(__int64 a1, __int64 a2, unsigned int a3, __int64 a4)
{
  ...
  {
    EtwRegister(&stru_140396C88, 0LL, 0LL, &RegHandle);
    v7 = RegHandle;
    if ( RegHandle )
