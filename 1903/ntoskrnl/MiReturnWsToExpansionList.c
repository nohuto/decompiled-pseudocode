/*
 * XREFs of MiReturnWsToExpansionList @ 0x14004AD10
 * Callers:
...
_QWORD *__fastcall MiReturnWsToExpansionList(__int64 a1, int a2)
{
  ...
  result = (_QWORD *)(a1 + 24);
  v4 = (_QWORD *)(*(_QWORD *)(qword_140466188 + 8LL * *(unsigned __int16 *)(a1 + 174)) + 7808LL);
  if ( !a2 )
  {
    v5 = *(_QWORD **)(*(_QWORD *)(qword_140466188 + 8LL * *(unsigned __int16 *)(a1 + 174)) + 7816LL);
    if ( (_QWORD *)*v5 == v4 )
    {
      *result = v4;
      result[1] = v5;
