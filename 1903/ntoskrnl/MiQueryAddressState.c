/*
 * XREFs of MiQueryAddressState @ 0x1400C63D0
 * Callers:
 ...
 *     MiQueryStateMatches @ 0x1400B7C2C (MiQueryStateMatches.c)
 ...
 *     MiGetValidAweProtection @ 0x1402D6598 (MiGetValidAweProtection.c)
 *     MiSkipEntirePagefileRegions @ 0x1402D8C08 (MiSkipEntirePagefileRegions.c)
...
LABEL_2:
  ...
  if ( v17 < 0xFFFF800000000000uLL || v17 >= qword_1404675B0 && v17 <= qword_140465EE0 )
...
LABEL_61:
    ...
    *v163 = 0;
    ...
    if ( !BugCheckParameter2 )
    {
      if ( !a5 || MiQueryStateMatches(a5, 0x2000, 0, 0) )
      {
...
LABEL_137:
          ...
          else
          {
            ...
            if ( !a5 || MiQueryStateMatches(a5, v73, ValidAweProtection, 0) )
            {
              v74 = v139;
              if ( v72 )
              {
