/*
 * XREFs of MiResolveMappedFileFault @ 0x1400A5990
 * Callers:
...
LABEL_101:
  ...
  v19 = v9;
  v62 = v9;
  v20 = *(ULONG_PTR **)(qword_140466188 + 8 * v18);
  v65 = v20;
  v24 = v72;
  ...
  if ( MI_READ_PTE_LOCK_FREE(a2) == v24 )
  {
      ...
      || (*(_BYTE *)(v74 + 34) & 0x20) != 0 && (*(_DWORD *)(*(_QWORD *)v74 + 160LL) & 0x20) == 0 )
    {
      ...
      if ( (unsigned int)(v62 - 1) <= 1 )
        goto LABEL_32;
      if ( (*(_DWORD *)(v13 + 56) & 0x40020) == 0x20 && v27 && !dword_140466824 )
      {
        if ( !v29 )
        {
LABEL_32:
...
LABEL_123:
                  ...
                  MiFreeInPageSupportBlock((char *)v26);
                  return 3221225495LL;
                }
LABEL_52:
                *v84 = v26;
