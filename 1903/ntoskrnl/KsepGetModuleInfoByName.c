/*
 * XREFs of KsepGetModuleInfoByName @ 0x14088405C
 * Callers:
 *     KsepResolveShimHooks @ 0x140883514 (KsepResolveShimHooks.c)
 * Callees:
 ...
 *     RtlCompareString @ 0x140657D30 (RtlCompareString.c)
 */
...
__int64 __fastcall KsepGetModuleInfoByName(PCWSTR SourceString, _DWORD *a2, _QWORD *a3)
{
  ...
  int v6; // ebx
  __int64 v7; // r14
  STRING String2; // [rsp+20h] [rbp-30h] BYREF
  UNICODE_STRING DestinationString; // [rsp+30h] [rbp-20h] BYREF
  STRING String1; // [rsp+40h] [rbp-10h] BYREF
