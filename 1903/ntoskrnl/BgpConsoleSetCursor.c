...
__int64 __fastcall BgpConsoleSetCursor(unsigned int a1, unsigned int a2, unsigned int a3)
{
  ...
  BgpFwAcquireLock();
  v6 = (_DWORD *)qword_1404F2AD8;
  v7 = 0;
  if ( qword_1404F2AD8 )
  {
    if ( a1 >= 0x50 || a2 >= *(_DWORD *)(qword_1404F2AD8 + 4) || a3 > 0x64 )
    {
      v7 = -1073741811;
    }
    else if ( *(_DWORD *)(qword_1404F2AD8 + 68) != a1
           || *(_DWORD *)(qword_1404F2AD8 + 72) != a2
           || *(_DWORD *)(qword_1404F2AD8 + 76) != a3 )
    {
      if ( *(_DWORD *)(qword_1404F2AD8 + 76) )
      {
        *(_DWORD *)(qword_1404F2AD8 + 76) = 0;
