/*
 * XREFs of PnpReplacePartitionUnit @ 0x14086E0C0
 * Callers:
 ...
 *     KeFindFirstSetLeftAffinityEx @ 0x1402A4DB0 (KeFindFirstSetLeftAffinityEx.c)
 ...
 *     PnprMmConstruct @ 0x14087041C (PnprMmConstruct.c)
...
LONG __fastcall PnpReplacePartitionUnit(_QWORD *a1)
{
  ...
  char v87[72]; // [rsp+58h] [rbp-A8h] BYREF
  _QWORD v88[22]; // [rsp+A0h] [rbp-60h] BYREF

  Affinity.Mask = 0LL;
  *(_QWORD *)&Affinity.Group = 0LL;
  memset(v88, 0, 0xA8uLL);
  PreviousAffinity.Mask = 0LL;
  *(_QWORD *)&PreviousAffinity.Group = 0LL;
  memset(v87, 0, 0x3CuLL);
  ...
  if ( *((int *)a1 + 4) >= 0 )
  {
    ...
    if ( !v4 || (v5 = *(_QWORD *)(*(_QWORD *)(v4 + 312) + 40LL)) == 0 || (*(_DWORD *)(v5 + 396) & 0x20000) != 0 )
    {
      if ( v4 )
      {
        ...
        if ( v27 )
        {
          IoAddTriageDumpDataBlock(*(_QWORD *)(v4 + 8), (PVOID)(unsigned int)*(__int16 *)(v27 + 2));
          v4 = a1[1];
          v28 = *(_QWORD *)(v4 + 8);
          if ( *(_WORD *)(v28 + 56) )
          {
            IoAddTriageDumpDataBlock(v28 + 56, (PVOID)2);
        ...
        if ( v29 )
        {
          ...
          if ( v4 )
            ...
            LODWORD(v31) = 0;
          IoAddTriageDumpDataBlock(v31, (PVOID)0x310);
          if ( *(_WORD *)(v30 + 40) )
          {
...
LABEL_171:
      ...
      *(_DWORD *)(v9 + 176) = v3;
      ...
      {
        if ( ((v88[((unsigned __int64)(unsigned int)KiProcessorIndexToNumberMappingTable[0] >> 6) + 1] >> (KiProcessorIndexToNumberMappingTable[0] & 0x3F)) & 1) != 0 )
          FirstSetLeftAffinity = 0;
        else
          FirstSetLeftAffinity = KeFindFirstSetLeftAffinityEx((__int16 *)v88);
