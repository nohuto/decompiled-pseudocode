/*
 * XREFs of NtQueryKey @ 0x1405FF6B0
 * Callers:
...
LABEL_57:
  ...
  if ( v31 )
  {
    ...
    if ( v24
      && ($6EAC78A6FCFADE0A5FA44F358736B38F *)v23->ApcState.ApcListHead[0].Flink != &v23->152
  ...
  if ( v32 )
  {
    ...
    if ( v24
      && ($6EAC78A6FCFADE0A5FA44F358736B38F *)v26->ApcState.ApcListHead[0].Flink != &v26->152
