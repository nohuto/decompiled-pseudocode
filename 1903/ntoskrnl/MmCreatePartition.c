/*
 * XREFs of MmCreatePartition @ 0x14019A610
 * Callers:
...
__int64 __fastcall MmCreatePartition(_QWORD *a1, char a2)
{
  ...
  if ( (a2 & 1) != 0 )
  {
    *a1 = &MiSystemPartition;
    result = 0LL;
    qword_140468528 = (__int64)a1;
    return result;
  }
  v4 = MiSizeMemoryListLocks();
  v5 = v4
     + ((1984LL * (unsigned __int16)KeNumberNodes + 12495 + 40LL * (unsigned int)(2 * dword_140465AB4)) & 0xFFFFFFFFFFFFFFF0uLL)
     + 24LL * dword_140466100 * (unsigned int)(unsigned __int16)KeNumberNodes
     + 16LL * (unsigned int)(2 * dword_140465AB4);
  ...
  v7[264] = v9;
  v10 = v9 + 40LL * (unsigned int)dword_140465AB4;
  v7[265] = v10;
  v11 = (v10 + 40LL * (unsigned int)dword_140465AB4 + 15) & 0xFFFFFFFFFFFFFFF0uLL;
  v7[517] = v11;
  v12 = v11 + 16LL * (unsigned int)dword_140465AB4;
  v7[518] = v12;
  v13 = 16LL * (unsigned int)dword_140465AB4 + v12;
  v7[21] = a1;
  v7[621] = v13;
  v7[629] = v13 + v4;
