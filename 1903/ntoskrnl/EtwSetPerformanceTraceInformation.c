/*
 * XREFs of EtwSetPerformanceTraceInformation @ 0x1408F6580
 * Callers:
 ...
 *     EtwpUpdateTagFilter @ 0x14077F5DC (EtwpUpdateTagFilter.c)
 ...
 *     EtwpUpdateProcessorTraceEvents @ 0x140907218 (EtwpUpdateProcessorTraceEvents.c)
                ...
                if ( (v45 & 3) == 0 )
                {
                  if ( !PsIsCurrentThreadInServerSilo() || (unsigned int)(v7 - 14) > 1 )
                  {
                    ...
                    if ( v50 )
                    {
                      ...
                      {
                        case 6:
                          updated = EtwpUpdateStackTracing((struct _RTL_BITMAP *)v19, (__int64)v47, v46);
                          break;
                        case 15:
