...
void PopBatteryWorker()
{
  ...
  do
  {
    ...
    if ( (xmmword_140443240 & 0x10) != v22 )
    {
      ...
      if ( pCallbackContext.LevelPlus1 > 5 )
      {
        ...
        v116 = 1LL;
        v118 = 4LL;
        TlgWrite(&pCallbackContext, &unk_14038F08C, 0LL, 0LL, 4u, &v114);
      }
    }
  ...
  {
    LODWORD(v84[2]) = dword_140443274;
    v84[0] = xmmword_140443254;
    LODWORD(v55) = 0;
    LODWORD(pData) = 0;
    *(_OWORD *)((char *)&v84[2] + 4) = xmmword_140443240;
    *(_QWORD *)((char *)&v84[3] + 4) = __PAIR64__(dword_140443210, dword_140443214);
    v84[1] = xmmword_140443264;
    Timeout = 0LL;
    ...
    if ( pCallbackContext.LevelPlus1 > 5 && TlgKeywordOn(&pCallbackContext, 0x400000000000uLL) )
    {
      ...
      v110 = &v75;
      v113 = 4LL;
      TlgWrite(&pCallbackContext, &unk_14038EEF8, 0LL, 0LL, 0x13u, &v85);
    }
    if ( v3 == 1 )
    {
      if ( v21 )
    ...
    if ( v58 )
    {
      ...
      if ( pCallbackContext.LevelPlus1 > 5 )
      {
        ...
        v120 = &v77;
        v121 = 4LL;
        TlgWrite(&pCallbackContext, &unk_14038EE01, 0LL, 0LL, 3u, &v119);
      }
    }
  }
