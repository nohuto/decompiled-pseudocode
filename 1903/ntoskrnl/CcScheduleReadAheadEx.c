/*
 * XREFs of CcScheduleReadAheadEx @ 0x1400A9CA0
 * Callers:
 ...
 *     CcScheduleReadAhead @ 0x14027D7A0 (CcScheduleReadAhead.c)
 ...
 *     CcDetermineReadPattern @ 0x1400AA0FC (CcDetermineReadPattern.c)
...
char __fastcall CcScheduleReadAheadEx(_SLIST_ENTRY *Object, _QWORD *a2, unsigned int a3, struct _KTHREAD *a4)
{
  ...
  struct _KTHREAD *v52; // [rsp+F0h] [rbp+7Fh]
...
LABEL_28:
                            ...
                            if ( (int)CcAllocateWorkQueueEntry(Partition, &v46) >= 0 )
                            {
                              ...
                              if ( (v11[38] & 0x10000000) != 0 )
                                CcChargeThreadForReadAhead((_DWORD)Object, v27, v28, v18, (__int64)v52);
                              ...
                              *((_QWORD *)&v29[1].Next + 1) = 0LL;
                              IoReferenceIoAttributionFromThread(v52, (__int64)(&v29[1].Next + 1));
...
LABEL_72:
                      ...
                      if ( (v11[38] & 0x10000000) != 0 )
                      {
                        CcChargeThreadForReadAhead((_DWORD)Object, v23, v22, v18, (__int64)v52);
