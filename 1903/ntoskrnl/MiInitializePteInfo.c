/*
 * XREFs of MiInitializePteInfo @ 0x1409EEF28
 * Callers:
        ...
        unsigned int a7)
{
  ...
  if ( !a3 )
  {
    ...
    v14 = MiReservePtes((__int64)&qword_1404669C0, (unsigned __int64 *)(unsigned int)v7);
    v8 = v14;
    if ( !v14 )
      return 0LL;
  ...
  {
    if ( v8 )
      MiReleasePtes((__int64)&qword_1404669C0, v8, v7);
    return 0LL;
  }
  *(_DWORD *)(a1 + 24) = 2;
  v15 = *(_DWORD *)(a1 + 24);
