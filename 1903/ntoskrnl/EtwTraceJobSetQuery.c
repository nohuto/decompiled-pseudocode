/*
 * XREFs of EtwTraceJobSetQuery @ 0x1408F41CC
 * Callers:
...
void __fastcall EtwTraceJobSetQuery(__int64 a1, __int64 a2, __int64 a3, __int64 a4, char a5)
{
  ...
  _QWORD v36[2]; // [rsp+70h] [rbp-98h] BYREF
  __int64 v37; // [rsp+80h] [rbp-88h]
  _QWORD v38[2]; // [rsp+88h] [rbp-80h] BYREF
  char *v39; // [rsp+98h] [rbp-70h] BYREF
  ...
  _QWORD v56[8]; // [rsp+178h] [rbp+70h] BYREF
