/*
 * XREFs of KiMceDispatch @ 0x140367EF0
 * Callers:
 *     KiMceLinkage @ 0x14036D280 (KiMceLinkage.c)
 * Callees:
 *     <none>
 */
...
__int64 __fastcall KiMceDispatch(_QWORD *a1, unsigned int a2)
{
  ...
  if ( Number == v10 )
  {
    ...
    do
    {
      ...
      {
        v15 = a1[3];
        if ( v15 <= v14 && v15 > v14 - ((-(__int64)((*(_BYTE *)(v7 + 2171) & 8) != 0) & 0xFFFFFFFFFFFFE1D0uLL) + 0x2000) )
          break;
        if ( (*(_BYTE *)(v7 + 2171) & 8) != 0 )
        {
          v16 = *(_QWORD *)(v14 + 8);
