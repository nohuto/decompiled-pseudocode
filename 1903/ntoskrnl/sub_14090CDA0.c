/*
 * XREFs of sub_14090CDA0 @ 0x14090CDA0
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall sub_14090CDA0(_DWORD *a1, _DWORD *a2, unsigned int a3, _DWORD *a4, _BYTE *a5)
{
  int v9; // eax
...
LABEL_18:
  ...
  {
    *a5 = 1;
    return (unsigned int)sub_14072B4E0(a1, a2, a3, a4, 4);
  }
  else
  {
    v15 = -1073741772;
