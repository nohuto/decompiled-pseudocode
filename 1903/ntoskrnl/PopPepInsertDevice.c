/*
 * XREFs of PopPepInsertDevice @ 0x140191B88
 * Callers:
...
_QWORD *__fastcall PopPepInsertDevice(__int64 a1, __int64 *a2)
{
  ...
  v4 = (__int64 **)qword_1404427F8;
  if ( *(__int64 **)qword_1404427F8 != &PopPepDeviceList )
    __fastfail(3u);
  a2[1] = qword_1404427F8;
  *a2 = (__int64)&PopPepDeviceList;
  *v4 = a2;
  qword_1404427F8 = (__int64)a2;
      ...
      if ( v14->LockState.0 )
      {
        if ( v14 )
        {
          ...
          if ( (__int64)v14->LockState.LockState < 0 )
            KiAbEntryRemoveFromTree((__int64)&v6->LockEntries[v13]);
