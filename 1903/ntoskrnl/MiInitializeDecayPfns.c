/*
 * XREFs of MiInitializeDecayPfns @ 0x140A17614
 * Callers:
...
PSLIST_ENTRY MiInitializeDecayPfns()
{
  ...
  if ( ((unsigned __int8)&stru_1404664F0 & 0xF) != 0 )
    RtlRaiseStatus(-2147483646);
  stru_1404664F0 = 0uLL;
  v0 = 48 * qword_1404664E0 - 0x57FFFFE8030LL;
  v1 = 2048LL;
  *(_QWORD *)(v0 + 40) = *(_QWORD *)(v0 + 40) & 0xFFFFFFF000000000uLL | 1;
  do
  {
    result = RtlpInterlockedPushEntrySList(&stru_1404664F0, (PSLIST_ENTRY)v0);
    v0 -= 48LL;
    --v1;
  }
  while ( v1 );
