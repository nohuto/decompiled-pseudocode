/*
 * XREFs of MiTrimAllSystemPagableMemory @ 0x1402C8FF0
 * Callers:
...
__int64 __fastcall MiTrimAllSystemPagableMemory(int a1, int a2)
{
  ...
  CurrentThread = 0LL;
  v13 = 0;
  if ( _InterlockedIncrement(&dword_140466908) <= 1 && KeAreInterruptsEnabled() )
  {
...
LABEL_22:
        ...
        {
          if ( a1 == 1 )
            v18 = *(ULONG_PTR **)(qword_140466188 + 8LL * *(unsigned __int16 *)(SessionVm + 174));
          else
