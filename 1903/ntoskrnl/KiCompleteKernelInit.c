/*
 * XREFs of KiCompleteKernelInit @ 0x1405A1ABC
 * Callers:
...
__int64 __fastcall KiCompleteKernelInit(__int64 a1, __int64 a2, int a3)
{
  ...
  {
    qword_14044DC58 = 0LL;
    qword_14044DC50 = (__int64)&qword_14044DC48;
    qword_14044DC48 = (__int64)&qword_14044DC48;
    KeInitializeTimer2((__int64)&KiForegroundState);
    KeInitializeDpc((PRKDPC)&stru_14044DBC8, (PKDEFERRED_ROUTINE)KiProcessPendingForegroundBoosts, 0LL);
    KeInitializeDpc(&stru_14044DC08, (PKDEFERRED_ROUTINE)KiTriggerForegroundBoostDpc, 0LL);
  }
  v7 = 0;
