/*
 * XREFs of RtlpSetSecurityObject @ 0x1405C7BE0
 * Callers:
 *     SeSetSecurityDescriptorInfo @ 0x1405C7BA0 (SeSetSecurityDescriptorInfo.c)
 *     CmpSetSecurityDescriptorInfo @ 0x14063BAF0 (CmpSetSecurityDescriptorInfo.c)
 *     SeSetSecurityDescriptorInfoEx @ 0x1406E9E20 (SeSetSecurityDescriptorInfoEx.c)
 * Callees:
        ...
        __int64 *a8)
{
  ...
  unsigned __int8 *v121; // [rsp+E8h] [rbp-20h]
  ...
  *(_DWORD *)PoolType.Value = a6;
  ...
  if ( (v18 & 0x10) != 0 )
  {
    if ( v18 >= 0 )
    {
      v12 = *(unsigned __int16 **)(v17 + 24);
    }
    else
    {
      v19 = *(unsigned int *)(v17 + 12);
      if ( (_DWORD)v19 )
        v12 = (unsigned __int16 *)(v17 + v19);
    }
  }
  if ( !a8 )
  {
        ...
        *(_WORD *)&PoolType.Value[4] = 768;
        ...
        if ( ServerAcl >= 0 )
        {
          ...
          while ( 1 )
          {
            ...
            AceBySid = RtlFindAceBySid(v69, &Sid, &v93);
            if ( !AceBySid )
              break;
...
LABEL_189:
  ...
  TokenTrustLevel = SepLocateTokenTrustLevel(v118);
...
LABEL_88:
    ...
    if ( (a2 & 0x100) != 0 )
    {
      ...
      if ( (a5 & 2) == 0 )
      {
        ServerAcl = RtlpValidFilterAclSubjectContext(v12, TokenTrustLevel);
        if ( ServerAcl < 0 )
          goto LABEL_76;
      }
      v54 = v107;
...
LABEL_92:
        if ( (a2 & 0x20) != 0 )
        {
          ...
          if ( (a5 & 2) != 0 )
          {
            ...
            v57 = Src;
            v56 = (int)v108;
            v58 = (2 * (v93 & 0x1400 | (2 * (v93 & 8 | 4)))) | v92;
            v101 = 1;
            v54 = v107;
            v92 = v58;
            v109 = (PVOID)v123;
...
LABEL_65:
      ...
      v100 = 1;
      v108 = (PVOID)v122;
      v92 = 2 * (v93 & 0x1400 | (2 * (v93 & 8 | 0x2004)));
      v54 = v107;
    }
    else
    {
  ...
  if ( TokenTrustLevel )
  {
    ...
    while ( 1 )
    {
      v77 = RtlFindAceByType((__int64)Src, 20, &v93);
      v108 = v77;
      if ( v77 )
      {
        if ( (v77[1] & 0xFF000000) != 0 )
          goto LABEL_189;
        if ( !RtlpValidTrustSubjectContext(TokenTrustLevel, (__int64)(v77 + 2), v78, &v107) )
          break;
        v77 = v108;
      }
      ++v93;
