/*
 * XREFs of KiDispatchException @ 0x140015DB0
 * Callers:
 *     KiInitializeUserApc @ 0x14012BB10 (KiInitializeUserApc.c)
 *     KxExceptionDispatchOnExceptionStack @ 0x1401C4980 (KxExceptionDispatchOnExceptionStack.c)
        ...
        char a5)
{
  ...
  if ( a5 && Process[2].ActiveProcessors.Bitmap[13] )
  {
    ...
    {
      LODWORD(CurrentThread) = ((__int64 (__fastcall *)(PEXCEPTION_RECORD, __int64, __int64, _QWORD, char))xmmword_140436A20)(
                                 ExceptionRecord,
                                 v32,
                                 a3,
                                 0LL,
