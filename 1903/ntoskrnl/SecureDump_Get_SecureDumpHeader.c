/*
 * XREFs of SecureDump_Get_SecureDumpHeader @ 0x14029BB50
 * Callers:
...
__int64 __fastcall SecureDump_Get_SecureDumpHeader(__int64 a1, _DWORD *a2, unsigned int a3)
{
  ...
  if ( !byte_140464454 )
    return 3221225485LL;
  if ( a3 < dword_1404644A0 )
    return 3221225485LL;
  v5 = a3;
  if ( a3 < pcbResult + (unsigned __int64)(unsigned int)dword_14046446C + 4184 )
    return 3221225485LL;
  memset(a2, 0, a3);
  a2[2] = 1;
  a2[3] = dword_1404644A0;
  *a2 = *(_DWORD *)a1;
  a2[1] = *(_DWORD *)(a1 + 4);
  a2[12] = *(_DWORD *)(a1 + 48);
  ...
  *((_QWORD *)a2 + 11) = 0LL;
  ...
  a2[5] = 4184;
  a2[4] = pcbResult;
  memmove(a2 + 1046, qword_140464478, pcbResult);
  v7 = a2[4] + a2[5];
  a2[10] = cbOutput;
  v8 = dword_140464498;
  a2[7] = v7;
  a2[8] = v8;
  a2[6] = dword_14046446C;
  memmove((char *)a2 + v7, qword_140464470, (unsigned int)dword_14046446C);
  a2[9] = dword_14046449C;
  return 0LL;
}
