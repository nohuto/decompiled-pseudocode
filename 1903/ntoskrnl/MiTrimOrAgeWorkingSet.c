/*
 * XREFs of MiTrimOrAgeWorkingSet @ 0x1400480E0
 * Callers:
 ...
 *     MiComputeTrimAmount @ 0x1402C81DC (MiComputeTrimAmount.c)
...
__int64 __fastcall MiTrimOrAgeWorkingSet(__int64 a1, __int64 a2, unsigned int a3)
{
  ...
  v88 = *(_QWORD *)(*(_QWORD *)(qword_140466188 + 8LL * *(unsigned __int16 *)(a1 + 174)) + 7800LL);
  v5 = *(_BYTE *)(a1 + 184) & 7;
  if ( v5 )
  {
    if ( v5 == 1 )
...
LABEL_47:
  ...
  if ( v34 != 1 )
  {
    ...
    v86 = 0LL;
    v40 = (LONG *)(a1 + 192);
    v41 = v39 == 2 ? &dword_140467200 : (LONG *)(a1 + 192);
    if ( *((_QWORD *)v41 + 5) )
    {
      v84 = 0LL;
      if ( v39 == 2 )
...
LABEL_120:
  ...
  if ( !v34 )
  {
    if ( qword_140466340 )
    {
      v56 = (_QWORD *)_InterlockedExchange64(&qword_140466340, 0LL);
      if ( v56 )
      {
        ...
        {
          if ( !qword_140466340 && !_InterlockedCompareExchange64(&qword_140466340, (signed __int64)v56, 0LL) )
            return v34;
          v59 = v56;
