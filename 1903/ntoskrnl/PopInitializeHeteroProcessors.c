/*
 * XREFs of PopInitializeHeteroProcessors @ 0x140773BB8
 * Callers:
 ...
 *     PpmIdleEnableIdleDurationExpirationTimeout @ 0x1402EF32C (PpmIdleEnableIdleDurationExpirationTimeout.c)
  ...
  if ( a1 )
  {
    ...
    if ( !v10 )
    {
      ...
      else
      {
        ...
        {
          v59[1] = (unsigned __int16 *)qword_14042A698[0];
...
LABEL_116:
  ...
  {
    v63[1] = (unsigned __int16 *)qword_14042A7F8[0];
