/*
 * XREFs of ?BTreeDeleteEx@?$B_TREE@KU_ST_REGION_ENTRY@?$ST_STORE@USM_TRAITS@@@@$0BAAA@UNP_CONTEXT@@UST_REGION_ENTRY_COMPARATOR@2@@@SAJPEAU1@PEAUSEARCH_RESULT@1@@Z @ 0x140151E8C
 * Callers:
    ...
    if ( (unsigned __int16)*v7 < v11 )
    {
      ...
      if ( v19 < v11 )
      {
        ...
        if ( (v18 & 1) != 0 )
        {
          ...
          *v4 = v32;
          v33 = (unsigned __int16)*(_DWORD *)v32;
          if ( *(_BYTE *)(v32 + 3) )
            v34 = 4 * v33 + 16;
          else
            v34 = 16 * (v33 + 1);
          v4[1] = v32 + v34 - (_QWORD)v14;
        }
      }
      else
      {
