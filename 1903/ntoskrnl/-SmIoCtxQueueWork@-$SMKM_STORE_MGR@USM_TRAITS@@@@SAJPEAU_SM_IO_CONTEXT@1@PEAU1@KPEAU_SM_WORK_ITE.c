/*
 * XREFs of ?SmIoCtxQueueWork@?$SMKM_STORE_MGR@USM_TRAITS@@@@SAJPEAU_SM_IO_CONTEXT@1@PEAU1@KPEAU_SM_WORK_ITEM@1@@Z @ 0x14014C5E8
 * Callers:
...
__int64 __fastcall SMKM_STORE_MGR<SM_TRAITS>::SmIoCtxQueueWork(__int64 *a1, __int64 a2, int a3, int *a4)
{
  ...
  else
  {
    ...
    v18 = SmKmStoreRefFromStoreIndex(a2, v6 & 0x3FF);
    v19 = *(_QWORD *)v18;
    if ( (*(_BYTE *)(*(_QWORD *)v18 + 6021LL) & 4) != 0
      && (a4[2] & 0x4000000) != 0
