/*
 * XREFs of ObpIncrementHandleCountEx @ 0x1405F5040
 * Callers:
 ...
 *     OBJECT_HEADER_TO_PROCESS_INFO @ 0x14013BFC8 (OBJECT_HEADER_TO_PROCESS_INFO.c)
 *     __security_check_cookie @ 0x14019E700 (__security_check_cookie.c)
 *     _guard_dispatch_icall @ 0x1401CC5F0 (_guard_dispatch_icall.c)
 *     PsReturnSharedPoolQuota @ 0x1405C866C (PsReturnSharedPoolQuota.c)
 *     SeComputeQuotaInformationSize @ 0x1405D6830 (SeComputeQuotaInformationSize.c)
...
LABEL_27:
  ...
  if ( (_KPROCESS *)BugCheckParameter1 != KeGetCurrentThread()->ApcState.Process && v52 != 3 )
  {
    ...
    KiStackAttachProcess(v31, 0, (__int64)v57);
  }
