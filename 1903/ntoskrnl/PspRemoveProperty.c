/*
 * XREFs of PspRemoveProperty @ 0x140139298
 * Callers:
 *     PsSetThreadProperty @ 0x140139170 (PsSetThreadProperty.c)
 *     PsSetJobProperty @ 0x1403071E0 (PsSetJobProperty.c)
 *     PspEmptyPropertySet @ 0x14060EEF4 (PspEmptyPropertySet.c)
 * Callees:
 *     KeAcquireSpinLockRaiseToDpc @ 0x140008500 (KeAcquireSpinLockRaiseToDpc.c)
 *     ObfDereferenceObjectWithTag @ 0x14003FB20 (ObfDereferenceObjectWithTag.c)
 *     KxReleaseSpinLock @ 0x1400A20A0 (KxReleaseSpinLock.c)
 *     PspFindPropertySetEntry @ 0x140139364 (PspFindPropertySetEntry.c)
