/*
 * XREFs of ?RtlStringCbCopyUnicodeString@@YAJPEAG_KPEBU_UNICODE_STRING@@@Z @ 0x140324744
 * Callers:
 *     SmKmKeyGenStart @ 0x1408EA240 (SmKmKeyGenStart.c)
 * Callees:
 *     RtlUnicodeStringValidateSrcWorker @ 0x1403247F8 (RtlUnicodeStringValidateSrcWorker.c)
 */
