/*
 * XREFs of NtQueryInformationThread @ 0x1405E5490
 * Callers:
 *     <none>
 * Callees:
 ...
 *     PspQueryLastCallThread @ 0x1408C696C (PspQueryLastCallThread.c)
        ...
        PULONG ReturnLength)
{
  ...
  struct _PROCESSOR_NUMBER v59; // [rsp+5Ch] [rbp-22Ch] BYREF
  ...
  v61 = CurrentThread;
  v70[1] = CurrentThread;
  v54 = CurrentThread->$42514DC6747B59BF81E16C40547B231E::gap0[10];
  if ( v54 )
  {
...
LABEL_161:
          ...
          case 33:
            ...
            *(_WORD *)&v59.Number = 64;
            ...
            ObfDereferenceObjectWithTag(Object, 0x79517350u);
            *(struct _PROCESSOR_NUMBER *)ThreadInformation = v59;
            if ( ReturnLength )
              *ReturnLength = 4;
            return 0;
          case 34:
