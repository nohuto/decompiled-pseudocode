/*
 * XREFs of HvpGenerateLogEntryChecksums @ 0x14065DF08
 * Callers:
 ...
 *     SymCryptMarvin32Init @ 0x1401BA24C (SymCryptMarvin32Init.c)
 *     SymCryptMarvin32Result @ 0x1401BA268 (SymCryptMarvin32Result.c)
