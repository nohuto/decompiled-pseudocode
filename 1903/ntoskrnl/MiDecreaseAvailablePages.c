/*
 * XREFs of MiDecreaseAvailablePages @ 0x1400DB4B8
 * Callers:
...
__int64 __fastcall MiDecreaseAvailablePages(__int64 a1, __int64 a2, unsigned __int64 a3, unsigned int a4)
{
  ...
  if ( a2 == 1 )
  {
    v9 = _InterlockedDecrement64((volatile signed __int64 *)(a1 + 8064));
    if ( v9 == *(_QWORD *)(a1 + 6120) || v9 == *(_QWORD *)(a1 + 6128) )
      MiUpdateAvailableEvents(a1);
    v7 = v9 + 1;
  }
  else
  {
    v7 = _InterlockedExchangeAdd64((volatile signed __int64 *)(a1 + 8064), -a2);
    v8 = *(_QWORD *)(a1 + 6128);
    v9 = v7 - a2;
    if ( v7 - a2 <= v8 && v7 > v8 || (v10 = *(_QWORD *)(a1 + 6120), v9 <= v10) && v7 > v10 )
      MiUpdateAvailableEvents(a1);
  }
  v11 = 0;
  if ( v9 <= 0x420 )
