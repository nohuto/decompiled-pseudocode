/*
 * XREFs of EtwpApplyEventIdPayloadFilter @ 0x140332374
 * Callers:
 ...
 *     EtwpPerfectHashFunctionSearch @ 0x140332D04 (EtwpPerfectHashFunctionSearch.c)
        ...
        unsigned __int8 a9)
{
  ...
  else
  {
    ...
    v14 = 104LL * a2;
    if ( !*(_QWORD *)(v14 + *(_QWORD *)(a1 + 384) + 72) || (v15 = EtwpPerfectHashFunctionSearch(a5), *v16 == v15) )
    {
