/*
 * XREFs of KeInitializeProcess @ 0x140692038
 * Callers:
 *     KiInitializeKernel @ 0x1405A1240 (KiInitializeKernel.c)
 *     PspAllocateProcess @ 0x14068E52C (PspAllocateProcess.c)
 * Callees:
 *     KiSetIdealNodeProcessByGroup @ 0x1400E5110 (KiSetIdealNodeProcessByGroup.c)
 *     KeSetGroupMaskProcess @ 0x1400E5274 (KeSetGroupMaskProcess.c)
