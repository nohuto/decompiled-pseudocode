 ...
 *     KdpGetContextEx @ 0x1402A252C (KdpGetContextEx.c)
 *     KdpSetContextEx @ 0x1402A2710 (KdpSetContextEx.c)
 *     KdpWriteCustomBreakpoint @ 0x1402A2844 (KdpWriteCustomBreakpoint.c)
 *     KdpSysReadIoSpace @ 0x1402A2EC0 (KdpSysReadIoSpace.c)
 *     KdpSysReadMsr @ 0x1402A2F7C (KdpSysReadMsr.c)
 *     KdpSysWriteIoSpace @ 0x1402A2FB0 (KdpSysWriteIoSpace.c)
 *     KdpSysWriteMsr @ 0x1402A3068 (KdpSysWriteMsr.c)
...
__int64 __fastcall KdpSendWaitContinue(__int64 a1, __int64 a2, __int64 a3, __int64 a4)
{
  ...
  while ( !(_BYTE)KdDebuggerNotPresent )
  {
    while ( 1 )
    {
      ...
      v7 = KdReceivePacket(2LL, v22, &v16, v39, &KdpContext);
      if ( v7 == 2 )
        break;
      if ( v7 != 1 )
      {
        switch ( LODWORD(v44[0]) )
        {
          ...
          case 0x313C:
            ...
            return 1LL;
          case 0x313D:
            KdpReadPhysicalMemory((__int64)v44, (__int64)&v16, v8, (__int64)&KdpContext);
            continue;
          case 0x313E:
          ...
          case 0x3146:
            ...
            *(_OWORD *)&v44[2] = KdVersionBlock;
            v37[0] = 56LL;
            v11 = 0LL;
            v44[6] = (PVOID)qword_1404283D8;
            v37[1] = v44;
            *(_OWORD *)&v44[4] = xmmword_1404283C8;
            LODWORD(v44[0]) = 12614;
            goto LABEL_45;
          case 0x3147:
