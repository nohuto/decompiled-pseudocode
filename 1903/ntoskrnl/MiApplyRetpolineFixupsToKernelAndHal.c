/*
 * XREFs of MiApplyRetpolineFixupsToKernelAndHal @ 0x1409F0194
 * Callers:
...
NTSTATUS __fastcall MiApplyRetpolineFixupsToKernelAndHal(__int64 a1, __int64 a2, __int64 a3)
{
  ...
  dword_14046484C = *(_DWORD *)(*(_QWORD *)(a1 + 240) + 3452LL) >> 12;
  if ( (KiSpeculationFeatures & 0x2000000) != 0 )
  {
    MiSetRetpolineRoutines(*(_QWORD *)(a2 + 48));
    if ( dword_140464888 > (unsigned int)dword_14046484C )
      return -1073741811;
  }
