/*
 * XREFs of IopUpdateMinidumpContext @ 0x140297338
 * Callers:
  ...
  if ( v11 == 307 )
  {
    ...
    do
    {
      for ( i = (_QWORD *)*v28; i; i = (_QWORD *)*i )
      {
        ...
        v30 = i[6];
        if ( v30 != 1 )
          IoAddTriageDumpDataBlock(v30, (PVOID)0x40);
      }
      v28 += 5;
      --v17;
    }
    ...
    if ( v31 && v31 != *(_QWORD *)(Prcb + 25008) )
    {
      v32 = (unsigned int)(8 * dword_140571364);
      v33 = *(_DWORD *)(Prcb + 25008) - v31;
