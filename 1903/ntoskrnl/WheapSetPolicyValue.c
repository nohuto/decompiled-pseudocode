/*
 * XREFs of WheapSetPolicyValue @ 0x14091A728
 * Callers:
 *     WheapWmiExecutePolicyManagementMethod @ 0x140342DEC (WheapWmiExecutePolicyManagementMethod.c)
 * Callees:
 *     <none>
 */
...
__int64 __fastcall WheapSetPolicyValue(unsigned int a1, unsigned int *a2)
{
  ...
  if ( a1 < 7 )
  {
    v2 = *a2;
    v3 = a1;
    if ( *a2 >= dword_140948250[6 * a1] && v2 <= dword_140948254[6 * a1] )
    {
      _mm_lfence();
      v4 = (&off_140948248)[3 * a1];
      if ( *v4 == -1 )
      {
        v5 = 0;
        if ( a1 )
