/*
 * XREFs of PopPowerActionWatchdog @ 0x1402F7D60
 * Callers:
...
void __noreturn PopPowerActionWatchdog()
{
  ...
  {
    BugCheckParameter4 = (struct _KTHREAD *)qword_1404431E8;
    if ( !qword_1404431E8 )
    {
      BugCheckParameter4 = (struct _KTHREAD *)qword_1404431F0;
      if ( !qword_1404431F0 )
      {
        BugCheckParameter4 = (struct _KTHREAD *)qword_1404431F8;
        if ( !qword_1404431F8 )
        {
  ...
  KeBugCheckEx(0xA0u, v0, dword_140443060, PopSleepCheckpoint, (ULONG_PTR)BugCheckParameter4);
}
