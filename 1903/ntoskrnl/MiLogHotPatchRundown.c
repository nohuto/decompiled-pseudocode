/*
 * XREFs of MiLogHotPatchRundown @ 0x1405B1004
 * Callers:
 *     MiTracingEnabledCallback @ 0x1405B18A0 (MiTracingEnabledCallback.c)
 * Callees:
 ...
 *     MiIsActiveSystemHotPatch @ 0x1405B0FD4 (MiIsActiveSystemHotPatch.c)
  ...
  if ( hProvider && dword_1404648B0 )
  {
    ...
    while ( i )
    {
      if ( hProvider->LevelPlus1 > 5 && TlgKeywordOn(hProvider, 0x20uLL) )
      {
        ...
        v127 = 2LL;
        v129[1] = 0;
        TlgWriteEx(v5, &unk_14038DD5B, v4, (ULONG)v5, v45, v46, 6u, &pData);
      }
      v6 = *(_QWORD ***)(i + 8);
      v7 = i;
      if ( v6 )
    ...
    while ( k )
    {
      ...
      while ( j )
      {
        if ( hProvider->LevelPlus1 > 5 && TlgKeywordOn(hProvider, 0x20uLL) )
        {
          ...
          TlgWriteEx(v14, &unk_14038DBC7, v13, (ULONG)v14, v45, v46, 7u, &v130);
        }
        v15 = *(_QWORD ***)(j + 8);
        v16 = j;
        if ( v15 )
    ...
    while ( m )
    {
      if ( hProvider->LevelPlus1 > 5 && TlgKeywordOn(hProvider, 0x20uLL) )
      {
        ...
        v83 = 2LL;
        v85[1] = 0;
        TlgWriteEx(v24, &unk_14038DC2A, v23, (ULONG)v24, v45, v46, 9u, &v71);
      }
      v25 = *(_QWORD ***)(m + 8);
      v26 = m;
      if ( v25 )
    ...
    for ( n = (PVOID *)PsLoadedModuleList; n != &PsLoadedModuleList; n = (PVOID *)*n )
    {
      if ( MiIsActiveSystemHotPatch((__int64)n) && hProvider->LevelPlus1 > 5 && TlgKeywordOn(hProvider, 0x20uLL) )
      {
        ...
        v118 = 2LL;
        v120[1] = 0;
        TlgWriteEx(v30, &unk_14038DA95, v29, (ULONG)v30, v45, v46, 8u, &v108);
      }
    }
      ...
      if ( v37 )
      {
        ...
        if ( hProvider->LevelPlus1 > 5 )
        {
          if ( TlgKeywordOn(hProvider, 0x20uLL) )
          {
            ...
            v105 = 4LL;
            v107 = 4LL;
            TlgWriteEx(v38, &unk_14038DB0D, v40, v39, v45, v46, 0xDu, &v86);
          }
        }
      }
      v41 = *(_QWORD ***)(jj + 8);
