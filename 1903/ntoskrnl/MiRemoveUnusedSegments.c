/*
 * XREFs of MiRemoveUnusedSegments @ 0x1402BA3E0
 * Callers:
...
__int64 __fastcall MiRemoveUnusedSegments(__int64 a1, unsigned __int64 a2)
{
  ...
  if ( a2 )
  {
    if ( a2 >= qword_14046A568 )
      v6 = 0LL;
    else
      v6 = qword_14046A568 - a2;
    v7 = 0;
  }
  else
  {
  ...
  v8 = 1000LL * *(_QWORD *)(a1 + 7888) / qword_14046A350;
  if ( v8 )
  {
    v9 = *(_QWORD *)(a1 + 1632);
    v10 = ((unsigned __int64)qword_140464598 * (unsigned __int128)0x624DD2F1A9FBE77uLL) >> 64;
    v11 = v9;
    v12 = v8 * (qword_140464598 / 0x3E8uLL);
    if ( v12 <= v9 )
      v11 = v8 * (qword_140464598 / 0x3E8uLL);
    if ( v11 )
    {
      v13 = v9 - v11;
      if ( v13 < 0x100000 )
        ...
        while ( 1 )
        {
          ...
          else
          {
            if ( !v7 )
              return v2;
            v12 = qword_14046A5E8;
            v10 = qword_14046A5E8 / 0xAuLL;
            if ( qword_14046A568 < 9 * (qword_14046A5E8 / 0xAuLL) )
              return v2;
            --v7;
          }
          if ( !(unsigned int)MiShouldTrimUnusedSegments(v12, v10, qword_14046A568) || *(_QWORD *)(a1 + 1632) <= v13 )
            return v2;
          if ( (++v3 & 0x3F) == 0 )
          {
