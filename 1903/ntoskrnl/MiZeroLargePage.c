/*
 * XREFs of MiZeroLargePage @ 0x14012910C
 * Callers:
...
LABEL_36:
  ...
  result = MiReservePtes((__int64)&qword_1404669C0, (unsigned __int64 *)(unsigned int)v8);
  v12 = result;
  if ( result )
  {
...
LABEL_11:
      ...
      return MiReleasePtes((__int64)&qword_1404669C0, v12, v8);
    }
    v13 = (_QWORD *)v12;
    v14 = v6 << 12;
    v15 = v8;
