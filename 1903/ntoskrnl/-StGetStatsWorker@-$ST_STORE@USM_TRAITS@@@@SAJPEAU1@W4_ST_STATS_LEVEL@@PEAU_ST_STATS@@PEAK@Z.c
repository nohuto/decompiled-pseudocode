/*
 * XREFs of ?StGetStatsWorker@?$ST_STORE@USM_TRAITS@@@@SAJPEAU1@W4_ST_STATS_LEVEL@@PEAU_ST_STATS@@PEAK@Z @ 0x140137778
 * Callers:
 ...
 *     StLcBucketsCopy @ 0x14032455C (StLcBucketsCopy.c)
 */
