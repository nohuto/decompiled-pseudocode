/*
 * XREFs of HvlpGetEncryptedDataFromHypervisor @ 0x14028BE9C
 * Callers:
...
__int64 __fastcall HvlpGetEncryptedDataFromHypervisor(__int64 a1, char *a2, unsigned int a3, _DWORD *a4, __int64 a5)
{
  ...
  *v5 = 0LL;
  ...
  if ( v13 )
  {
    ...
    do
    {
      ...
      *(_QWORD *)(8 * (((unsigned __int64)qword_140463168 >> 12) & 0xFFFFFFFFFLL) - 0x98000000000LL) = v19;
      v16 = __readcr4();
      if ( (v16 & 0x20080) != 0 )
      {
        __writecr4(v16 ^ 0x80);
      ...
      memmove(a2, qword_140463168, 0x1000uLL);
      a2 += 4096;
      v15 += 4096LL;
      --v14;
    }
  ...
  *v5 = v11;
  *a4 = v13 << 12;
  dword_140463190 = v10 - v13;
  qword_140463188 = v11 + v13;
  return 0LL;
}
