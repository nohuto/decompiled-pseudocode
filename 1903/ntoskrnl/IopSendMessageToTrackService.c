/*
 * XREFs of IopSendMessageToTrackService @ 0x1408548B4
 * Callers:
  ...
  while ( 1 )
  {
    if ( !IopLinkTrackingServiceObject )
    {
      ...
      else
      {
        ...
        KeResetEvent(&stru_140461BA0);
        ExQueueWorkItem(&IopLinkTrackingPacket, DelayedWorkQueue);
        v9 = KeWaitForSingleObject(&stru_140461BA0, Executive, PreviousMode, 0, 0LL);
        v10 = v9;
        if ( v9 != 192 && v9 != 257 && dword_140461BB8 < 0 )
          v10 = dword_140461BB8;
        KeSetEvent(&IopLinkTrackingPortObject, 0, 0);
        if ( v10 )
          return v10;
    ...
    *v12 = 12058768LL;
    v16 = LpcpRequestWaitReplyPort((void ***)IopLinkTrackingServiceObject, (__int64)v12, (unsigned __int64)v17, 0, 0, 2);
    v10 = v16;
    if ( v16 >= 0 )
      return v18;
    if ( v16 != -1073741769
