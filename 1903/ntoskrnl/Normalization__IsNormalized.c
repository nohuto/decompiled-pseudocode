/*
 * XREFs of Normalization__IsNormalized @ 0x1408D6BF4
 * Callers:
 *     RtlIsNormalizedString @ 0x1408D7CD0 (RtlIsNormalizedString.c)
 * Callees:
 *     CanComposeHangul @ 0x140313740 (CanComposeHangul.c)
 *     Normalization__CanCombinableCharactersCombine @ 0x1408D665C (Normalization__CanCombinableCharactersCombine.c)
 *     Normalization__CanCombineWithStartBase @ 0x1408D67C0 (Normalization__CanCombineWithStartBase.c)
 *     Normalization__CanCombineWithStartFirstPair @ 0x1408D680C (Normalization__CanCombineWithStartFirstPair.c)
 *     Normalization__GetLastChar @ 0x1408D693C (Normalization__GetLastChar.c)
 */
