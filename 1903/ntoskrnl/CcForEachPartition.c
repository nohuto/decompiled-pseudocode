/*
 * XREFs of CcForEachPartition @ 0x1400F96E0
 * Callers:
 *     CcGetDirtyPages @ 0x1400F96A0 (CcGetDirtyPages.c)
 ...
 *     CcCoalescingCallBack @ 0x14027C9C0 (CcCoalescingCallBack.c)
 *     CcIsThereDirtyData @ 0x14027DA80 (CcIsThereDirtyData.c)
