/*
 * XREFs of RtlpCreateSplitBlock @ 0x14030F704
 * Callers:
 ...
 *     RtlpFindEntry @ 0x14031A8B4 (RtlpFindEntry.c)
 *     RtlpHeapAddListEntry @ 0x14031A9D8 (RtlpHeapAddListEntry.c)
 *     RtlpHeapRemoveListEntry @ 0x14031ACA0 (RtlpHeapRemoveListEntry.c)
 */
  ...
  *(_BYTE *)(a3 + 15) = 0;
  if ( !a5 )
  {
    *(_BYTE *)(a3 + 10) = 0;
    v51 = (_QWORD *)(a1 + 336);
    if ( *(_QWORD *)(a1 + 312) )
      v52 = (_QWORD *)RtlpFindEntry(a1, v13);
    else
      v52 = (_QWORD *)*v51;
    if ( v51 != v52 )
    {
...
LABEL_54:
  ...
  *(_BYTE *)(a3 + 10) &= 0xF0u;
  ...
  {
    v59 = (_DWORD *)(a3 + 32);
    v60 = (16 * (unsigned __int64)v13 - 32) >> 2;
    if ( v60 )
    {
  ...
  v61 = (_QWORD *)(a1 + 336);
  if ( *(_QWORD *)(a1 + 312) )
    v62 = (_QWORD *)RtlpFindEntry(a1, v13);
  else
    v62 = (_QWORD *)*v61;
  if ( v61 != v62 )
  {
