/*
 * XREFs of TtmiLogCalloutStop @ 0x1408C075C
 * Callers:
...
char __fastcall TtmiLogCalloutStop(int a1, int a2, __int64 a3, int a4, int a5, unsigned __int64 a6)
{
  ...
  if ( a6 > 0x1312D00 )
  {
    if ( stru_1409AD8A8.LevelPlus1 > 5 )
    {
      LOBYTE(v6) = TlgKeywordOn(&stru_1409AD8A8, 0x400000000001uLL);
      if ( (_BYTE)v6 )
      {
        ...
        v49[3] = &v23;
        v49[4] = 8LL;
        LOBYTE(v6) = TlgWrite(&stru_1409AD8A8, &unk_1403927CB, 0LL, 0LL, 0xAu, &v37);
      }
    }
  }
  else if ( stru_1409AD8E0.LevelPlus1 > 5 )
  {
    LOBYTE(v6) = TlgKeywordOn(&stru_1409AD8E0, 1uLL);
    if ( (_BYTE)v6 )
    {
      ...
      v36[3] = &v21;
      v36[4] = 8LL;
      LOBYTE(v6) = TlgWrite(&stru_1409AD8E0, &unk_140392A06, 0LL, 0LL, 0xAu, &pData);
    }
  }
  return (char)v6;
}
