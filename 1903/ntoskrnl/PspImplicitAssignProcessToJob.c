/*
 * XREFs of PspImplicitAssignProcessToJob @ 0x140694880
 * Callers:
 ...
 *     PspValidateJobChainLimits @ 0x14069583C (PspValidateJobChainLimits.c)
 *     PspValidateJobAssignmentMemoryPartition @ 0x14069594C (PspValidateJobAssignmentMemoryPartition.c)
 */

__int64 __fastcall PspImplicitAssignProcessToJob(__int64 a1, ULONG_PTR a2, unsigned int a3)
{
...
LABEL_5:
  ...
  {
    v13 = (volatile signed __int32 *)(a2 + 2088);
    v14 = 7LL;
    do
    {
    ...
    while ( v14 );
    _interlockedbittestandset((volatile signed __int32 *)(a2 + 2124), 0x1Fu);
  }
  PspUnlockJobChain(a1, (__int64)CurrentThread, 0);
  v15 = PspApplyWorkingSetLimitsToProcess(a2);
  if ( v15 >= 0 && !(unsigned int)MmAssignProcessToJob(a2) )
