/*
 * XREFs of MiFlushSectionInternal @ 0x140051530
 * Callers:
    ...
    while ( 1 )
    {
      while ( 1 )
      {
        ...
        if ( (*(_QWORD *)v15 & 0xC00LL) != 0x800 )
          goto LABEL_64;
        if ( !v22 || !qword_140465B00 || (v22 & qword_140465B00) != 0 )
        {
          v23 = *(_QWORD *)v15;
...
LABEL_65:
    ...
    v31 = v26 & 1;
    v32 = *(ULONG_PTR **)(qword_140466188 + 8 * ((*(_QWORD *)(v25 + 40) >> 40) & 0x3FFLL));
    v33 = *(_DWORD *)(v25 + 16);
    v96 = v32;
    v34 = (v33 & 0x400) != 0LL;
    v35 = v30 & 2;
...
LABEL_148:
  ...
  if ( v48 )
    MiReturnCrossPartitionSectionCharges(*(_QWORD *)(qword_140466188 + 8LL * (*(_WORD *)(v89 + 60) & 0x3FF)), 1LL, v48);
  if ( v95 )
