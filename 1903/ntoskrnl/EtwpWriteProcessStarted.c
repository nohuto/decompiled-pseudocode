/*
 * XREFs of EtwpWriteProcessStarted @ 0x14063531C
 * Callers:
 ...
 *     MmGetSessionCreateTime @ 0x140637248 (MmGetSessionCreateTime.c)
 */
...
char __fastcall EtwpWriteProcessStarted(__int64 a1, int *a2, __int64 a3, unsigned __int16 *a4)
{
  ...
  {
    LOBYTE(v4) = TlgKeywordOn(&stru_140426650, 3uLL);
    if ( (_BYTE)v4 )
    {
      v17 = *(_QWORD *)(a1 + 784);
      v12 = *(_DWORD *)(a1 + 744);
      ...
      v51 = 2LL;
      v53[1] = 0;
      LOBYTE(v4) = TlgWrite(&stru_140426650, &unk_14039406D, 0LL, 0LL, 0x13u, &pData);
    }
  }
  return v4;
}
