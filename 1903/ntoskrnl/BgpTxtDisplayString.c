/*
 * XREFs of BgpTxtDisplayString @ 0x1409946C8
 * Callers:
 ...
 *     BgpFoGetAdvanceWidth @ 0x140349238 (BgpFoGetAdvanceWidth.c)
 ...
 *     BgpTxtClearRegion @ 0x140994698 (BgpTxtClearRegion.c)
 *     TxtpJustifyRectangle @ 0x140994920 (TxtpJustifyRectangle.c)
 */

__int64 __fastcall BgpTxtDisplayString(__int64 a1, __int16 *a2, int a3, int a4, __m128i *a5)
{
  __int16 *v6; // r14
