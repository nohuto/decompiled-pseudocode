/*
 * XREFs of IopGetBootDiskInformation @ 0x140A39FEC
 * Callers:
 *     IoGetBootDiskInformation @ 0x140856510 (IoGetBootDiskInformation.c)
 * Callees:
 ...
 *     IopVerifyDiskSignature @ 0x14078A1FC (IopVerifyDiskSignature.c)
 */
...
__int64 __fastcall IopGetBootDiskInformation(__int64 a1, unsigned int a2)
{
  ...
  STRING String1; // [rsp+A8h] [rbp-60h] BYREF
