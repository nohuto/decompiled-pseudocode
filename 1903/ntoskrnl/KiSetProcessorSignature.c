/*
 * XREFs of KiSetProcessorSignature @ 0x1405A2324
 * Callers:
 ...
 *     KiPublishProcessorFeatures @ 0x140A08DD8 (KiPublishProcessorFeatures.c)
 */
...
ULONG_PTR __fastcall KiSetProcessorSignature(__int64 a1, int a2)
{
  ...
  do
  {
    v19 = *(_DWORD *)((char *)&unk_14037B65C + v18);
    if ( (v19 & 2) == 0 )
    {
      if ( !HIBYTE(v19) || (v20 = HIBYTE(v19), _bittest((const int *)&v20, *(unsigned __int8 *)(a1 + 141))) )
      {
        ...
        v26 = 0;
        v27 = *(int *)((char *)&unk_14037B658 + v18);
        v28 = *(_DWORD *)((char *)&unk_14037B654 + v18);
        ...
        else
        {
          v29 = v19 & 8;
          if ( (v19 & 8) != 0
            && (v15 & *(_QWORD *)((_BYTE *)&unk_14037B660 + v18)) == *(_QWORD *)((char *)&unk_14037B660 + v18) )
          {
            v26 = 1;
          }
          else if ( (v19 & 0x10) != 0
                 && (v16 & *(_QWORD *)((_BYTE *)&unk_14037B660 + v18)) == *(_QWORD *)((char *)&unk_14037B660 + v18) )
          {
            v26 = 1;
          }
        }
        if ( !v26 )
        {
          if ( (v19 & 1) != 0 )
          {
            if ( !*(_DWORD *)(a1 + 36) )
            {
              ...
              LODWORD(v27) = *(_DWORD *)((char *)&unk_14037B658 + v18);
              v28 = *(_DWORD *)((char *)&unk_14037B654 + v18);
            }
          ...
          if ( (v19 & 4) != 0 && *(_DWORD *)(a1 + 36) )
          {
            if ( v29 )
            {
              LOBYTE(v26) = (KeFeatureBits & *(_QWORD *)((_BYTE *)&unk_14037B660 + v18)) == *(_QWORD *)((char *)&unk_14037B660 + v18);
            }
            else if ( (v19 & 0x10) != 0
                   && (KeFeatureBits2 & *(_QWORD *)((_BYTE *)&unk_14037B660 + v18)) == *(_QWORD *)((char *)&unk_14037B660
                                                                                                 + v18) )
            {
LABEL_93:
              KeBugCheckEx(
                ...
                *(unsigned int *)((char *)&unk_14037B654 + v18),
                *(int *)((char *)&unk_14037B658 + v18));
            }
            if ( v26 )
              goto LABEL_93;
          }
        ...
        if ( v29 )
        {
          v15 |= *(_QWORD *)((char *)&unk_14037B660 + v18);
          v30 = v19 & 0x10;
        }
        else
        {
          v30 = v19 & 0x10;
          if ( (v19 & 0x10) != 0 )
            v16 |= *(_QWORD *)((char *)&unk_14037B660 + v18);
        }
        if ( (v19 & 4) != 0 && *(_DWORD *)(a1 + 36) )
        {
          v31 = 0;
          if ( v29 )
          {
            LOBYTE(v31) = (KeFeatureBits & *(_QWORD *)((_BYTE *)&unk_14037B660 + v18)) == *(_QWORD *)((char *)&unk_14037B660 + v18);
            goto LABEL_39;
          }
          if ( !v30
            || (KeFeatureBits2 & *(_QWORD *)((_BYTE *)&unk_14037B660 + v18)) != *(_QWORD *)((char *)&unk_14037B660 + v18) )
          {
LABEL_39:
            if ( !v31 )
              KeBugCheckEx(
...
LABEL_40:
  ...
  {
    v33 = (unsigned int *)(0x140000000LL + 24 * i + 3619456);
    v34 = *(_DWORD *)(0x140000004LL + 24 * i + 3619456);
    if ( (v34 & 2) == 0 )
    {
      if ( !HIBYTE(v34) || (v35 = HIBYTE(v34), _bittest((const int *)&v35, *(unsigned __int8 *)(a1 + 141))) )
      {
        ...
        if ( (v36 & *(_QWORD *)(0x140000010LL + 24 * i + 3619456)) == *(_QWORD *)(0x140000010LL + 24 * i + 3619456) )
        {
          v37 = __readmsr(*v33);
          for ( j = *(_QWORD *)(0x140000008LL + 24 * i + 3619456); ; j += 24LL )
          {
            v14 = *(_QWORD *)j;
            if ( !*(_QWORD *)j )
              break;
...
LABEL_98:
  ...
  while ( *(_DWORD *)((char *)&KiCpuTable + v46) != *(unsigned __int8 *)(a1 + 141)
       || *(_DWORD *)((char *)&unk_14038AA74 + v46) != a2 )
  {
    v44 = (unsigned int)(v44 + 1);
    v45 = (unsigned int)v44;
    v46 = 20 * v44;
    if ( *((_DWORD *)&unk_14038AA78 + 5 * v44) == 19 )
      goto LABEL_86;
  }
  *(_DWORD *)(a1 + 1740) = dword_14038AA80[5 * v45];
LABEL_86:
