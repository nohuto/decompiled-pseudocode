/*
 * XREFs of ExpGetSystemEmulationBasicInformation @ 0x1401298B8
 * Callers:
...
__int64 __fastcall ExpGetSystemEmulationBasicInformation(__int64 a1)
{
  ...
  *(_QWORD *)(a1 + 40) = v2 - 1;
  ...
  v11[3] = v13;
  v14 = -1;
  if ( *(_QWORD *)(*(_QWORD *)(qword_140466188 + 8LL * v9) + 7872LL) <= 0xFFFFFFFFuLL )
    v14 = *(_QWORD *)(*(_QWORD *)(qword_140466188 + 8LL * v9) + 7872LL);
  v11[4] = v14;
  if ( *(_QWORD *)(*(_QWORD *)(qword_140466188 + 8LL * v9) + 7880LL) <= 0xFFFFFFFFuLL )
    v12 = *(_QWORD *)(*(_QWORD *)(qword_140466188 + 8LL * v9) + 7880LL);
  v11[5] = v12;
  return v10;
}
