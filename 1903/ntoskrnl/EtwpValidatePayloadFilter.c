/*
 * XREFs of EtwpValidatePayloadFilter @ 0x1409086E4
 * Callers:
...
__int64 __fastcall EtwpValidatePayloadFilter(_QWORD *a1, __int16 *a2, unsigned int a3)
{
  ...
  int v55; // [rsp+8h] [rbp-90h]
  int v56; // [rsp+Ch] [rbp-8Ch]
  int v57; // [rsp+14h] [rbp-84h]
  _WORD *v58; // [rsp+18h] [rbp-80h]
  _BYTE *v59; // [rsp+20h] [rbp-78h]
  int v60; // [rsp+2Ch] [rbp-6Ch]
  __int64 v61; // [rsp+38h] [rbp-60h]
  _WORD *v62; // [rsp+40h] [rbp-58h]
                ...
                if ( v18 == v19 )
                {
                  ...
                  if ( (unsigned __int16)a2[24] == v21 )
                  {
                      ...
                      && (v18 & 3) == 0 )
                    {
                      ...
                      v58 = (__int16 *)((char *)a2 + (unsigned __int16)a2[22]);
                      v29 = (__int64)a2 + v12;
                      v30 = (unsigned __int16)a2[23] >> 1;
                      v31 = (__int16 *)((char *)a2 + v15);
                      v32 = 0LL;
                      v62 = v31;
                      v59 = (char *)a2 + (unsigned __int16)a2[24];
                      v56 = 0;
                      if ( v26 / 0xC )
                      {
                        while ( 1 )
                        {
                          v63 = v32 | (1LL << (*(_WORD *)v25 % 0x3Fu));
...
LABEL_59:
                                ...
                                v49 = (unsigned __int64)a2
                                    ...
                                    + (unsigned __int64)(unsigned __int16)v57;
                                if ( *v59 )
                                {
                                  do
                                  {
