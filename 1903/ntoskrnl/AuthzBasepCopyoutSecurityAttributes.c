/*
 * XREFs of AuthzBasepCopyoutSecurityAttributes @ 0x1400935F4
 * Callers:
        ...
        size_t Size)
{
  ...
  _DWORD *v17; // r14
  const UNICODE_STRING *SecurityAttribute; // r13
  char *v19; // rdi
  int Buffer_high; // ecx
  __int64 Length; // rcx
  char *v22; // rdi
            ...
            if ( a3 )
            {
              ...
              while ( 1 )
              {
                ...
                *(v17 - 1) = *(_DWORD *)(&SecurityAttribute[3].MaximumLength + 1);
                ...
                v32 = Length;
                if ( (unsigned __int64)&v19[Length] > v10 )
                  goto LABEL_28;
                *((_WORD *)v17 - 12) = Length;
                *((_WORD *)v17 - 11) = Length;
                *((_QWORD *)v17 - 2) = v19;
                memmove(v19, SecurityAttribute[2].Buffer, (unsigned int)Length);
                v22 = &v19[v32];
