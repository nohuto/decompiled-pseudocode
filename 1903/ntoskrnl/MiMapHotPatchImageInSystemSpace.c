/*
 * XREFs of MiMapHotPatchImageInSystemSpace @ 0x14089008C
 * Callers:
...
__int64 __fastcall MiMapHotPatchImageInSystemSpace(_QWORD *a1)
{
  ...
  if ( Mdl )
  {
    ...
    if ( v9 )
    {
      ...
      {
        ++v10;
        v11->Next = (struct _MDL *)qword_140466858;
    ...
    v18 = MiReservePtes((__int64)&qword_1404669C0, (unsigned __int64 *)(unsigned int)v3);
    if ( v18 )
    {
