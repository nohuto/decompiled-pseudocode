/*
 * XREFs of CmpTryAcquireKcbIXLocks @ 0x1407451A4
 * Callers:
 *     CmpPerformUnloadKey @ 0x14069AC04 (CmpPerformUnloadKey.c)
 *     CmpPrepareForSubtreeInvalidationWorker @ 0x140728220 (CmpPrepareForSubtreeInvalidationWorker.c)
 ...
 * Callees:
 *     CmpTryAcquireIXLockWithRollbackPacket @ 0x140745210 (CmpTryAcquireIXLockWithRollbackPacket.c)
 */
