/*
 * XREFs of PspPrepareSystemDllInitBlock @ 0x140679C8C
 * Callers:
 ...
 *     MmGetCfgBitMapInformation @ 0x140679E7C (MmGetCfgBitMapInformation.c)
...
__int64 __fastcall PspPrepareSystemDllInitBlock(__int64 a1, __int64 a2, __int64 a3)
{
  ...
  v8 = Process[1].ActiveProcessors.Bitmap[6];
  if ( v8 )
  {
    v19 = *(_WORD *)(v8 + 8);
    if ( v19 == 332 || v19 == 452 )
