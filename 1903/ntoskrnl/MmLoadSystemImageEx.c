/*
 * XREFs of MmLoadSystemImageEx @ 0x14070DAB0
 * Callers:
 ...
 *     IopLoadCrashdmpImage @ 0x140747C90 (IopLoadCrashdmpImage.c)
 ...
 *     MiValidateStrongCodeDriverImage @ 0x1402C3D44 (MiValidateStrongCodeDriverImage.c)
...
LABEL_12:
    ...
    if ( !v8 )
    {
      _InterlockedExchangeAdd(&dword_140466A50, v6);
      v12 = (char *)P;
    }
    v19 = (__int64)v68;
    v62 = 1;
    ...
    if ( (a4 & 0x21) == 0 && SystemAddressForImage == *(_QWORD *)(*v68 + 32) )
    {
      if ( (unsigned int)MiUseLargeDriverPage(&String1) )
      {
        ...
        if ( v42 )
        {
          _InterlockedExchangeAdd((_DWORD *)&xmmword_140464940 + 3, -v6);
          v12 = (char *)P;
