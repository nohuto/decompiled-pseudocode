/*
 * XREFs of IoIncrementKeepAliveCount @ 0x140299860
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall IoIncrementKeepAliveCount(__int64 a1, void *a2)
{
  ...
  if ( v4 >= 0 && v12 == 1 )
  {
    ...
    {
      v6 = KeAcquireSpinLockRaiseToDpc(&qword_140461B10);
      v7 = (_BYTE *)v13;
      v8 = v6;
      ++*(_DWORD *)(v13 + 32);
      if ( !v7[16] )
      {
        v9 = qword_140461B00;
        if ( *((PVOID **)qword_140461B00 + 1) != &qword_140461B00 )
          __fastfail(3u);
        *(_QWORD *)v7 = qword_140461B00;
        *((_QWORD *)v7 + 1) = &qword_140461B00;
        v9[1] = v7;
        qword_140461B00 = v7;
        v7[16] = 1;
        if ( !byte_140461B38 )
