/*
 * XREFs of sub_140921110 @ 0x140921110
 * Callers:
...
__int64 __fastcall sub_140921110(__int64 a1, __int64 a2, __int64 a3, __int64 a4)
{
  unsigned int v6; // r8d
  unsigned int *v7; // rax
  unsigned int i; // ecx
...
LABEL_19:
  if ( (v6 & 0x80000000) == 0 )
  {
    ...
    if ( v14 >= 0 && v14 != 192 )
    {
      ...
      do
      {
        v16 = KeWaitForSingleObject(&stru_14042C9C0, UserRequest, 1, 1u, &Interval);
        v15 = v16;
      }
      while ( v16 == 257 );
