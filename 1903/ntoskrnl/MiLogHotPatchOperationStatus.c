/*
 * XREFs of MiLogHotPatchOperationStatus @ 0x14088FBF8
 * Callers:
    ...
    if ( a5 )
    {
      if ( a5 == 1 )
      {
        if ( hProvider->LevelPlus1 > 5 )
        {
          ...
          if ( result )
          {
            ...
            v43 = 2LL;
            v45[1] = 0;
            return TlgWriteEx(v16, &unk_14038DF28, v14, v15, v20, v21, 7u, &v35);
          }
        }
      }
      else if ( hProvider->LevelPlus1 > 5 )
      {
        ...
        if ( result )
        {
          ...
          v54 = 2LL;
          v56[1] = 0;
          return TlgWriteEx(v19, &unk_14038DF8B, v17, v18, v20, v21, 7u, &v46);
        }
      }
    }
    else
    {
      ...
      if ( hProvider->LevelPlus1 > 5 )
      {
        ...
        if ( result )
        {
          ...
          v68 = 2LL;
          v70[1] = 0;
          return TlgWriteEx(v10, &unk_14038E11C, v12, v13, v20, v21, 9u, &pData);
        }
      }
    }
  }
