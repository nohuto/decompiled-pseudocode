/*
 * XREFs of WdipSemUpdateProviderTableWithEvent @ 0x14076C998
 * Callers:
 *     WdipSemUpdateProviderTableWithScenario @ 0x14076C924 (WdipSemUpdateProviderTableWithScenario.c)
 * Callees:
 *     EtwEventEnabled @ 0x140047610 (EtwEventEnabled.c)
 *     memset @ 0x1401D6BC0 (memset.c)
 *     WdipSemFastAllocate @ 0x140716A60 (WdipSemFastAllocate.c)
 *     WdipSemQueryProviderTable @ 0x14076CA3C (WdipSemQueryProviderTable.c)
...
__int64 __fastcall WdipSemUpdateProviderTableWithEvent(__int64 a1)
{
  ...
  if ( a1 )
  {
    ...
    else if ( (unsigned int)dword_140435200 >= 0x400 )
    {
    ...
    else
    {
      ...
      if ( v5 )
      {
        memset(v5, 0, 0x50uLL);
        *v6 = *(_OWORD *)a1;
        WdipSemProviderTable[dword_140435200++] = v6;
        *(_QWORD *)(a1 + 40) = v6;
      }
      else
      {
