/*
 * XREFs of CmpSetValueDataNew @ 0x14062F154
 * Callers:
        ...
        _DWORD *a5)
{
  ...
  {
    Cell = HvAllocateCell(BugCheckParameter2, Size, a4, (__int64)&v25, (__int64)&v27);
    *a5 = Cell;
    if ( Cell != -1 )
    {
      memmove(v25, Src, v5);
...
LABEL_5:
  ...
  else
  {
    ...
    v25 = 0LL;
    v23[0] = -1;
    v13 = HvAllocateCell(BugCheckParameter2, 8, a4, (__int64)&v26, (__int64)v24);
    *a5 = v13;
    if ( v13 != -1 )
    {
      v14 = v26;
      *v26 = 25188;
      ...
      v16 = HvAllocateCell(BugCheckParameter2, 4 * (unsigned int)(unsigned __int16)v15, a4, (__int64)&v25, (__int64)v23);
      v17 = v25;
      v14[1] = v16;
      if ( v16 != -1 )
      {
