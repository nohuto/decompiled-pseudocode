/*
 * XREFs of IoFillTriageDumpBuffer @ 0x140294A14
 * Callers:
 ...
 *     IopSizeTriageDumpDataBlocks @ 0x1402972B8 (IopSizeTriageDumpDataBlocks.c)
  ...
  *((_DWORD *)a2 + 17) = v16;
  ...
  if ( (v13 & 0x20) != 0 )
  {
    if ( (*((_DWORD *)Src + 30) & 0x20000) != 0 )
    {
      ...
      {
        if ( MaxValidMemorySize + v24 >= (unsigned int)v22 )
        {
          *((_DWORD *)a2 + 17) |= 0x100u;
        }
        else
        {
          *((_DWORD *)a2 + 10) = v24;
          v24 = (MaxValidMemorySize + v24 + 7) & 0xFFFFFFF8;
  ...
  {
    if ( (unsigned int)v41 + v24 >= (unsigned int)v22 )
    {
      *((_DWORD *)a2 + 17) |= 0x100u;
    }
    else
  ...
  if ( (_DWORD)v45 && v45 + 36608 <= (unsigned __int64)(unsigned int)v22 )
  {
    memmove((char *)v34 + (unsigned int)v45, KeGetCurrentPrcb(), 0x8F00uLL);
    v46 = (unsigned int)v22;
  }
  v47 = *((unsigned int *)a2 + 8);
  v48 = Src;
  if ( (_DWORD)v47 && v47 + 2176 <= v46 )
    memmove((char *)v34 + (unsigned int)v47, *((const void **)Src + 23), 0x880uLL);
  v49 = *((unsigned int *)a2 + 9);
  if ( (_DWORD)v49 )
  {
    v46 = (unsigned int)v22;
    if ( v49 + 2080 <= (unsigned __int64)(unsigned int)v22 )
      memmove((char *)v34 + (unsigned int)v49, v48, 0x820uLL);
  }
