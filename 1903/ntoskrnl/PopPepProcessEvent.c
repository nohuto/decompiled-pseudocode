/*
 * XREFs of PopPepProcessEvent @ 0x1400B1E84
 * Callers:
 ...
 *     PopPepComponentGetWork @ 0x1400B20C0 (PopPepComponentGetWork.c)
...
char __fastcall PopPepProcessEvent(__int64 a1, __int64 a2, unsigned int a3, unsigned int a4, __int64 a5, __int64 a6)
{
  ...
  if ( (_DWORD)v6 == 6 || (v11 = *((_DWORD *)&unk_14036FCFC + 34 * v6), (int)v11 < 2) )
    v11 = 2;
