/*
 * XREFs of BiCreateBootEntry @ 0x1409306FC
 * Callers:
...
__int64 __fastcall BiCreateBootEntry(void *a1, _QWORD *a2)
{
  _DWORD *v2; // rdi
  void *v3; // rsi
  void *v4; // r12
  struct _FILE_PATH *v5; // r15
  int Element; // ebx
  int v8; // eax
  __int64 v9; // r13
  __int64 v10; // rax
  ...
  v4 = 0LL;
  v5 = 0LL;
  Element = BiGetElement((__int64)a1, 0x12000004u, P, &v38);
  if ( Element < 0 )
    goto LABEL_23;
  Element = BiGetElement((__int64)a1, 0x11000001u, &v32, &Size);
  if ( Element < 0 )
  {
    v2 = v32;
    goto LABEL_23;
  }
  v8 = BiGetElement((__int64)a1, 0x12000002u, &Src, &Size);
  v2 = v32;
  Element = v8;
  v3 = Src;
  if ( v8 < 0 )
  ...
  if ( v14 + 12 < v14 )
    goto LABEL_21;
  PoolWithTag = (struct _FILE_PATH *)ExAllocatePoolWithTag(PagedPool, v15, 0x4B444342u);
  v5 = PoolWithTag;
  if ( !PoolWithTag )
  {
LABEL_13:
  ...
  memmove(&v5->FilePath[v17], v3, v29);
  Element = BiTranslateFilePath(v5, 4u);
  if ( Element >= 0 )
  {
    KeyName = BiGetKeyName(a1, &v34);
    v4 = v34;
    Element = KeyName;
    if ( KeyName >= 0 )
    {
      ...
      if ( (unsigned int)v38 + v21 + MEMORY[4] + 4 >= (unsigned int)v38 )
      {
        ...
        *((_DWORD *)v22 + 1) = v30;
        ...
        memmove(&v31[(unsigned int)Size], 0LL, MEMORY[4]);
        *(_QWORD *)(v31 + 28) = 0x53574F444E4957LL;
        *((_DWORD *)v31 + 10) = (_DWORD)v32;
        *((_DWORD *)v31 + 11) = (_DWORD)Src;
        *((_DWORD *)v31 + 9) = 1;
        swprintf_s((wchar_t *)v31 + 24, (unsigned int)v9 + 11LL, L"%s%s", L"BCDOBJECT=", v4);
        v27 = &v31[*((unsigned int *)v31 + 11) + 28];
        Element = 0;
        *(_DWORD *)v27 = 1;
        *((_DWORD *)v27 + 1) = 16;
        *((_DWORD *)v27 + 2) = 4;
