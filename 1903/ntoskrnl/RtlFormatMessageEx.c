/*
 * XREFs of RtlFormatMessageEx @ 0x1408CF5E4
 * Callers:
 ...
 *     RtlFormatMessage @ 0x1408CF590 (RtlFormatMessage.c)
 * Callees:
...
LABEL_3:
  ...
  while ( 1 )
  {
    ...
    if ( (unsigned __int16)(v20 - 49) <= (unsigned __int16)v84 )
    {
      ...
      v23 = *a1;
      v24 = *a1;
      if ( (unsigned __int16)*a1 >= 0x30u && v23 <= 0x39u )
      {
        ++a1;
        v22 = v23 + 2 * (5 * v22 - 24);
        v25 = *a1;
        v24 = *a1;
        if ( (unsigned __int16)*a1 >= 0x30u && v25 <= 0x39u )
        {
          ++a1;
          v22 = v25 + 2 * (5 * v22 - 24);
          v24 = *a1;
