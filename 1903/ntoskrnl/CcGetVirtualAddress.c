/*
 * XREFs of CcGetVirtualAddress @ 0x1400D61E0
 * Callers:
  ...
  if ( *(_QWORD *)(a1 + 168) )
  {
    ...
    else
    {
      ...
      if ( _interlockedbittestandset(&dword_140464580, 0x1Fu) )
      {
        ...
        v51 = ExpWaitForSpinLockExclusiveAndAcquire(&dword_140464580, CurrentIrql);
      }
      v15 = dword_140464580;
      while ( (v15 & 0xBFFFFFFF) != 0x80000000 )
      {
        if ( (v15 & 0x40000000) == 0 )
        {
          v39 = _InterlockedCompareExchange(&dword_140464580, v15 | 0x40000000, v15);
          v38 = v15 == v39;
          v15 = v39;
          if ( !v38 )
            continue;
