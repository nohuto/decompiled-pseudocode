/*
 * XREFs of PoFxCompleteDevicePowerNotRequired @ 0x140181930
 * Callers:
 *     <none>
 * Callees:
...
void __fastcall PoFxCompleteDevicePowerNotRequired(ULONG_PTR BugCheckParameter2)
{
  ...
  if ( !v2 )
  {
    ...
    v3 = KeAcquireSpinLockRaiseToDpc((PKSPIN_LOCK)(BugCheckParameter2 + 352));
    if ( *(_DWORD *)(BugCheckParameter2 + 36) == 2 )
      PopFxQueueWorkOrder(&PopFxSystemWorkQueue, (PLIST_ENTRY)(BugCheckParameter2 + 296), BugCheckParameter2, 0);
