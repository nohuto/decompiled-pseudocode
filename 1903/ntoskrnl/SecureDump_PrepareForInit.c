/*
 * XREFs of SecureDump_PrepareForInit @ 0x14019B52C
 * Callers:
      ...
      if ( v5 >= 0 )
      {
        ...
        if ( !dword_14046445C
          ...
          && (int)SecureDump_ReadRegistry(
                    ...
                    1,
                    (unsigned int)&qword_140464470,
                    (__int64)&dword_14046446C) >= 0 )
        {
          ForceDumpDisabled = 0;
          goto LABEL_8;
        }
