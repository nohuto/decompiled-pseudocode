/*
 * XREFs of MiSnapDriverRange @ 0x140710DE8
 * Callers:
 *     MiCheckForDiscardableLongJumpTable @ 0x1402DD5D0 (MiCheckForDiscardableLongJumpTable.c)
        ...
        unsigned __int64 *a6)
{
  ...
  struct _IMAGE_NT_HEADERS64 *v42; // [rsp+68h] [rbp-70h]
