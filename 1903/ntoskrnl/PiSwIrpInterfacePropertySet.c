/*
 * XREFs of PiSwIrpInterfacePropertySet @ 0x1407772E4
 * Callers:
 ...
 *     PiSwValidatePropertyArray @ 0x14071FA9C (PiSwValidatePropertyArray.c)
...
__int64 __fastcall PiSwIrpInterfacePropertySet(PIRP Irp)
{
  ...
  if ( v4 < 0 )
    goto LABEL_13;
  NdrMesTypeDecode3(v10, "TP 3\a", &off_140947608, &off_140425540, 4, &v9);
