/*
 * XREFs of SmpKeyedStoreEntryGet @ 0x14008AF3C
 * Callers:
          ...
          if ( v22->LockState.0 )
          {
            if ( v22 )
            {
              ...
              if ( (__int64)v22->LockState.LockState < 0 )
                KiAbEntryRemoveFromTree((__int64)&v15->LockEntries[v21]);
...
LABEL_43:
      ...
      if ( v18 && ($6EAC78A6FCFADE0A5FA44F358736B38F *)v15->ApcState.ApcListHead[0].Flink != &v15->152 )
