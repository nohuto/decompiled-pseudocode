/*
 * XREFs of ExpScanSystemLookasideList @ 0x1400FF428
 * Callers:
 *     KeBalanceSetManager @ 0x14018D570 (KeBalanceSetManager.c)
 * Callees:
 *     ExpComputeLookasideDepth @ 0x1400FF5E4 (ExpComputeLookasideDepth.c)
...
__int64 ExpScanSystemLookasideList()
{
  ...
  for ( i = 0; i < dword_14046FA10; ++i )
  {
    v12 = 2LL;
    v13 = (char *)&unk_14046FA80 + 8384 * i;
    do
    {
