/*
 * XREFs of MiCreatePagefile @ 0x1407711D8
 * Callers:
        ...
        char a8)
{
  ...
  *v13 = a4;
  v13[2] = a4;
  *((_DWORD *)v13 + 31) = dword_14057119C;
  *((_DWORD *)v13 + 34) = 4 * dword_14057119C;
  v13[32] = a1;
  v13[29] = 0LL;
...
LABEL_20:
    ...
    while ( 1 )
    {
      ModWriterEntry = MiAllocateModWriterEntry(a1, (unsigned int)dword_14057119C, 0);
      v18 = ModWriterEntry;
      if ( !ModWriterEntry )
        goto LABEL_38;
