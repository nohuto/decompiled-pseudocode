/*
 * XREFs of PfTCreateTraceDump @ 0x14069BF00
 * Callers:
...
__int64 __fastcall PfTCreateTraceDump(_QWORD *a1)
{
  ...
  v3 = 0;
  v4 = 0;
  for ( i = 0; (__int64 *)v1 != &qword_140467658; v1 = *(_QWORD *)v1 )
    i += *(_DWORD *)(v1 + 32);
  v6 = 2LL * i;
...
LABEL_8:
        ...
        if ( v17 != 0xFFFF )
        {
          ...
          if ( v17 < v18 || v17 >= *(_DWORD *)(v2 + 32) + (unsigned int)v18 )
          {
            ...
            {
              v67 = *(_QWORD *)(v67 + 8);
              if ( (__int64 *)v67 == &qword_140467658 )
                v67 = qword_140467660;
              if ( v67 == v2 )
                break;
              v68 = *(_WORD *)(v67 + 36);
...
LABEL_14:
        ...
        if ( v16 != 0xFFFF )
        {
          ...
          if ( v16 < v21 || v16 >= *(_DWORD *)(v2 + 32) + (unsigned int)v21 )
          {
            ...
            {
              v69 = *(_QWORD *)(v69 + 8);
              if ( (__int64 *)v69 == &qword_140467658 )
                v69 = qword_140467660;
              if ( v69 == v2 )
                break;
              v70 = *(_WORD *)(v69 + 36);
...
LABEL_27:
    ...
    while ( v9 != (__int64 *)qword_140467630 );
    if ( v3 )
    {
      v26 = 16 * v3;
      v27 = 32 * v4;
              ...
              if ( ((unsigned __int8)*(_QWORD *)v38 & 3u) < 2 )
              {
                ...
                if ( v46 != 0xFFFF )
                {
                  ...
                  if ( v46 < v47 || v46 >= *(_DWORD *)(v2 + 32) + (unsigned int)v47 )
                  {
                    ...
                    {
                      v63 = *(_QWORD *)(v63 + 8);
                      if ( (__int64 *)v63 == &qword_140467658 )
                        v63 = qword_140467660;
                      if ( v63 == v2 )
                        break;
                      v64 = *(_WORD *)(v63 + 36);
...
LABEL_45:
                ...
                if ( v45 != 0xFFFF )
                {
                  ...
                  if ( v45 < v49 || v45 >= *(_DWORD *)(v2 + 32) + (unsigned int)v49 )
                  {
                    ...
                    {
                      v65 = *(_QWORD *)(v65 + 8);
                      if ( (__int64 *)v65 == &qword_140467658 )
                        v65 = qword_140467660;
                      if ( v65 == v2 )
                        break;
                      v66 = *(_WORD *)(v65 + 36);
...
LABEL_58:
        ...
        while ( v31 != (__int64 *)qword_140467630 );
        v56 = HIWORD(v76[10]);
        v8 = P;
  ...
  PfTFreeBufferList(&unk_140467618);
  PfTFreeBufferList(&unk_140467640);
  return v32;
}
