/*
 * XREFs of MiGetUltraMapping @ 0x14002A890
 * Callers:
...
LABEL_19:
  ...
  *v34 = v35;
LABEL_35:
  _bittestandset64((signed __int64 *)qword_140466760, v37);
LABEL_20:
  v23 = 0LL;
  if ( (a4 & 2) == 0 )
  {
    while ( 1 )
    {
      SetBitsAndClear = RtlFindSetBitsAndClearEx(&qword_140466748, 1LL, qword_140466740);
      v26 = SetBitsAndClear;
      if ( SetBitsAndClear != -1 )
        break;
      KeFlushTb(0LL, 2LL);
      v43 = 0LL;
      for ( i = (unsigned __int64)qword_140466748 >> 6; v43 < i; *v45 |= v46 )
      {
        v45 = (_QWORD *)(qword_140466750 + 8 * v43);
        v46 = *((_QWORD *)qword_140466760 + v43++);
      }
      memset(qword_140466760, 0, 4 * (((unsigned __int64)qword_140466758 >> 5) + ((qword_140466758 & 0x1F) != 0)));
    }
    qword_140466740 = SetBitsAndClear + 1;
