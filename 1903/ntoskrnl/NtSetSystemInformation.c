/*
 * XREFs of NtSetSystemInformation @ 0x1406A6DC0
 * Callers:
 ...
 *     MiGetThreadPartition @ 0x14013DB4C (MiGetThreadPartition.c)
 ...
 *     CmSetRegistryQuotaInformation @ 0x140827120 (CmSetRegistryQuotaInformation.c)
 ...
 *     ExpSetProcessorMicrocodeUpdateInformation @ 0x14090A224 (ExpSetProcessorMicrocodeUpdateInformation.c)
 ...
 *     ExpCapabilityCheck @ 0x14090D3B4 (ExpCapabilityCheck.c)
  ...
  if ( SystemInformationClass <= SystemSoftRebootInformation )
  {
    ...
    if ( v39 )
    {
      ...
      *(_OWORD *)&CriticalProcessExceptionData = v122[0];
      xmmword_140432530 = v122[1];
      xmmword_140432540 = v122[2];
      return 0;
    }
    if ( (_DWORD)v3 != 16 )
      return -1073741820;
...
LABEL_416:
    if ( qword_140436528 )
      return qword_140436528((unsigned int)SystemInformationClass, SystemInformation, (unsigned int)v3);
    return -1073741637;
  }
  switch ( SystemInformationClass )
  {
