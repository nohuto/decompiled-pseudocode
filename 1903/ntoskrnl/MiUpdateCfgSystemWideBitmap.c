/*
 * XREFs of MiUpdateCfgSystemWideBitmap @ 0x14066F624
 * Callers:
 ...
 *     MiGetImageWowSubsystemIndex @ 0x1406E1324 (MiGetImageWowSubsystemIndex.c)
 */
...
__int64 __fastcall MiUpdateCfgSystemWideBitmap(__int64 *a1, unsigned __int64 a2, __int64 a3)
{
  ...
  do
  {
    ...
    if ( !v7 && (*(_BYTE *)(v4 + 14) & 0x40) != 0 )
      v8 = *((_QWORD *)&unk_1404647B8 + 8 * (unsigned __int64)(unsigned int)MiGetImageWowSubsystemIndex(v4));
