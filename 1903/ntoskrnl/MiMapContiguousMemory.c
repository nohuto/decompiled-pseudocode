/*
 * XREFs of MiMapContiguousMemory @ 0x140118AF4
 * Callers:
...
__int64 __fastcall MiMapContiguousMemory(unsigned __int64 a1, unsigned __int64 a2, unsigned int a3, char a4)
{
  ...
  if ( (a1 & 0x1FFFFF) == 0 && a2 >= 0x200000 )
  {
    ...
    if ( (a4 & 1) == 0 )
    {
      v14 = MiMapContiguousMemoryLarge(v9, (__int64)&v21);
      if ( v14 )
        goto LABEL_18;
    }
  }
  ...
  v12 = MiReservePtes((__int64)&qword_1404669C0, (unsigned __int64 *)v10);
  if ( !v12 )
    return 0LL;
  v13 = v22 | 2;
  if ( (a4 & 2) == 0 )
    v13 = v22;
  if ( (int)MiFillSystemPtes(v12, v8, v23, v5, v13, &v21) < 0 )
  {
    MiReleasePtes((__int64)&qword_1404669C0, v12, v10);
    return 0LL;
  }
  v14 = v24 + ((__int64)(v12 << 25) >> 16);
LABEL_18:
  v15 = v21 & 1;
  if ( (v21 & 1) != 0 )
