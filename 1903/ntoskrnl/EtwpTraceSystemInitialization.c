/*
 * XREFs of EtwpTraceSystemInitialization @ 0x140A15EB0
 * Callers:
...
char EtwpTraceSystemInitialization()
{
  ...
  __int64 SystemTime; // [rsp+78h] [rbp-90h] BYREF
  LARGE_INTEGER v26; // [rsp+80h] [rbp-88h] BYREF
  _QWORD v27[2]; // [rsp+88h] [rbp-80h] BYREF
  _QWORD v28[2]; // [rsp+98h] [rbp-70h] BYREF
  ...
  __int64 *p_SystemTime; // [rsp+1D8h] [rbp+D0h]
  ...
  _QWORD *v59; // [rsp+2C8h] [rbp+1C0h]
  __int64 v60; // [rsp+2D0h] [rbp+1C8h]
  int *v61; // [rsp+2D8h] [rbp+1D0h]
  __int64 v62; // [rsp+2E0h] [rbp+1D8h]
  int *v63; // [rsp+2E8h] [rbp+1E0h]
  __int64 v64; // [rsp+2F0h] [rbp+1E8h]
  EVENT_DATA_DESCRIPTOR v65; // [rsp+2F8h] [rbp+1F0h] BYREF
  int *v66; // [rsp+318h] [rbp+210h]
  ...
  {
    v26 = KeBootTime;
    if ( stru_140426618.LevelPlus1 > 5 && TlgKeywordOn(&stru_140426618, 0x800000000000uLL) )
    {
      ...
      v62 = 4LL;
      v64 = 1LL;
      TlgWrite(&stru_140426618, &unk_1403936E6, 0LL, 0LL, 0xCu, &pData);
    }
    ...
    if ( (_BYTE)Version )
    {
      ...
      {
        LOBYTE(Version) = TlgKeywordOn(&stru_140426618, 0x400000000000uLL);
        if ( (_BYTE)Version )
        {
          LOBYTE(v14) = v9;
          v16 = (LODWORD(v28[0]) >> 10) & 0xF;
          v66 = &v16;
          v68 = &v14;
          v67 = 4LL;
          v69 = 1LL;
          LOBYTE(Version) = TlgWrite(&stru_140426618, &unk_1403936B1, 0LL, 0LL, 4u, &v65);
        }
      }
    }
    if ( EtwKernelProvRegHandle )
    {
      *(_QWORD *)&UserData.Size = 4LL;
      ...
      v33 = 4LL;
      p_SystemTime = (__int64 *)&VersionInformation_4[1];
      v35 = 4LL;
      ...
      if ( (*(_DWORD *)(v6 + 116) & 0x100) != 0 || *(_QWORD *)(v6 + 208) )
      {
        ...
        if ( (_BYTE)Version )
        {
          *(_QWORD *)&UserData.Size = 8LL;
          UserData.Ptr = v6 + 208;
          v11 = *(_QWORD *)(v5 + 240) + 3472LL;
          v33 = 64LL;
          p_SystemTime = (__int64 *)v11;
      ...
      if ( (qword_1404324F8 & 4) != 0 )
      {
        ...
        v12 = *(_QWORD *)(KeLoaderBlock_0 + 240) + 2896LL;
        *(_QWORD *)&UserData.Size = 8LL;
        UserData.Ptr = v12;
        p_SystemTime = &SystemTime;
        v33 = 8LL;
        v34 = (_DWORD *)(*(_QWORD *)(KeLoaderBlock_0 + 240) + 2888LL);
        v35 = 4LL;
