/*
 * XREFs of RtlCSparseBitmapFindBitSetCapped @ 0x14001FF04
 * Callers:
 ...
 * Callees:
 *     RtlLengthCurrentClearRunForwardEx @ 0x14030D974 (RtlLengthCurrentClearRunForwardEx.c)
 */
    ...
    if ( _bittest64((const signed __int64 *)(a1 + 56), (unsigned __int64)a2 >> 30) )
    {
      if ( _bittest64(*(const signed __int64 **)a1, (unsigned __int64)a2 >> 15) )
      {
        ...
        else if ( v8 <= 0 )
        {
          ...
          v15 = (a2 % 0x8000) & 0x1F;
          v16 = *(_DWORD *)v14 & dword_14037C7E0[v15];
