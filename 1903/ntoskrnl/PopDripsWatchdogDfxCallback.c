/*
 * XREFs of PopDripsWatchdogDfxCallback @ 0x1408AAD60
 * Callers:
 *     <none>
 * Callees:
 *     PopFxBuildDripsBlockingDeviceList @ 0x1402F22EC (PopFxBuildDripsBlockingDeviceList.c)
 *     PopFxIsDirectedPowerTransitionSupported @ 0x1402F38EC (PopFxIsDirectedPowerTransitionSupported.c)
 ...
 *     PopDirectedDripsMarkCandidateDevice @ 0x1408A45CC (PopDirectedDripsMarkCandidateDevice.c)
 *     PopFxDestroyDripsBlockingDeviceList @ 0x1408A5A74 (PopFxDestroyDripsBlockingDeviceList.c)
 *     PopDripsWatchdogInvokeDeviceCallbacks @ 0x1408BA698 (PopDripsWatchdogInvokeDeviceCallbacks.c)
 */
