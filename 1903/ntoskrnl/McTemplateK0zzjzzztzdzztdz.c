/*
 * XREFs of McTemplateK0zzjzzztzdzztdz @ 0x14014476C
 * Callers:
...
ULONG __fastcall McTemplateK0zzjzzztzdzztdz(
        __int64 a1,
        ...
        const wchar_t *a17)
{
  ...
  v81 = v43;
  v83 = 0;
  return McGenEventWrite((PMCGEN_TRACE_CONTEXT)&MS_KernelPnP_Provider_Context, a2, 0LL, 0xFu, &EventData);
}
