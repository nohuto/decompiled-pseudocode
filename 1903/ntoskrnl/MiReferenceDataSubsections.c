/*
 * XREFs of MiReferenceDataSubsections @ 0x1400A8B68
 * Callers:
...
__int64 __fastcall MiReferenceDataSubsections(__int64 a1, __int64 *a2, unsigned __int64 a3, int a4, unsigned int *a5)
{
  ...
  *a5 = 3;
  ...
  v14 = MiAddViewsForSection((__int64 *)v11, v12, v13);
  v15 = v14;
  if ( (v13 & 0x400) == 0 )
    goto LABEL_5;
  if ( v14 < 0 )
  {
    v15 = MiAddViewsForSection((__int64 *)v11, v12, v13 & 0xFBFF);
LABEL_5:
    v16 = 0;
    goto LABEL_6;
  }
