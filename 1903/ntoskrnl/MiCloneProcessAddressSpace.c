/*
 * XREFs of MiCloneProcessAddressSpace @ 0x14089AED4
 * Callers:
...
__int64 __fastcall MiCloneProcessAddressSpace(__int64 BugCheckParameter1, _KPROCESS *a2, int a3)
{
  ...
  if ( !*(_QWORD *)(v26 + 360) || v11 )
  {
    ...
    if ( v25 )
    {
      ...
      if ( v11 )
      {
        v15 = MiBuildNewCloneDescriptor(a2, 2LL, *(_QWORD *)(v26 + 360));
        v7 = v15;
        if ( !v15 )
        {
          v12 = -1073741670;
        ...
        *(_QWORD *)(v7[3] + 16LL) = *(_QWORD *)(v7[3] + 16LL) & 0x7FFFFFFFFFFFFFFLL | 0x2000000000000000LL;
        *(_QWORD *)(v7[3] + 48LL) = *(_QWORD *)(v7[3] + 48LL) & 0x7FFFFFFFFFFFFFFLL | 0x800000000000000LL;
      }
      v12 = MiCloneVads((_QWORD *)BugCheckParameter1, a2, (__int64)P, (__int64)v7, v23, &v21);
      if ( v12 >= 0 )
      {
        P = 0LL;
        ...
        if ( v7 )
        {
          ...
          {
            v7[6] = v17;
            MiInsertClone((__int64)a2, v7, 0LL, v19);
          }
          else
          {
LABEL_38:
            MiFreeCloneDescriptor(a2, v7);
          }
          v7 = 0LL;
        }
        if ( v12 >= 0 )
