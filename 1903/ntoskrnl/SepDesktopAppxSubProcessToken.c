...
__int64 __fastcall SepDesktopAppxSubProcessToken(__int64 a1, __int64 a2, char a3, _BYTE *a4, _BYTE *a5)
{
  ...
  size_t *v17; // [rsp+20h] [rbp-C1h]
  GUID *v18; // [rsp+28h] [rbp-B9h]
  __int64 *v19; // [rsp+30h] [rbp-B1h]
  ...
  *a4 = 0;
  ...
  v36 = 2097182;
  *a5 = 0;
  PackageClaims = RtlQueryPackageClaims(a1, 0LL, 0LL, 0LL, v17, v18, (int)v19, v20);
  v12 = PackageClaims;
  if ( PackageClaims < 0 )
  {
  ...
  *a5 = 1;
  ...
  if ( (a3 & 1) != 0 && (v14 & 0x20) != 0 )
  {
    v12 = SepDesktopAppModifyTokenBreakaway(a1, &v22, 0LL);
    if ( v12 < 0 )
      goto LABEL_8;
    v14 = v22;
  }
  if ( (a3 & 6) == 0 && (v14 & 0x20) == 0 )
    goto LABEL_23;
  if ( (a3 & 2) != 0 && (v14 & 0x20) == 0 )
  {
    LOBYTE(v11) = 1;
    v12 = SepDesktopAppModifyTokenBreakaway(a1, &v22, v11);
    if ( v12 < 0 )
      goto LABEL_8;
  }
  if ( !(unsigned __int8)SepVerifyDesktopAppPolicyOverrideCaller(a1) )
  {
    v14 = v22;
LABEL_23:
    if ( (v14 & 0xFF0000) == 0x30000LL )
      v9 = (v14 & 0x2000) == 0LL;
    LOBYTE(v11) = v9;
    v12 = SepVerifyDesktopAppxImage(a2, a1, v11, v21);
    if ( v12 < 0 )
      goto LABEL_8;
    if ( !v21[0] )
    {
      ...
      v12 = AuthzBasepSetSecurityAttributesToken(*(_QWORD *)(a1 + 776), v25, v23);
