      ...
      if ( (struct _LIST_ENTRY *)a1 == Flink[1].Flink )
      {
        ...
        if ( v8 < 0 )
        {
          ViHalPreprocessOptions(
            ...
            (const void *)0x18);
          VfReportIssueWithOptions(0xE6u, 0x18uLL, a1, (ULONG_PTR)Flink, 0LL, byte_14042B918);
        }
        ...
        if ( LODWORD(Flink[10].Flink) )
        {
          ViHalPreprocessOptions(
            ...
            (const void *)9,
            a1);
          VfReportIssueWithOptions(0xE6u, 9uLL, a1, SLODWORD(Flink[10].Flink), (ULONG_PTR)Flink, byte_14042B908);
        }
        if ( LODWORD(Flink[10].Blink) )
        {
          ViHalPreprocessOptions(
            ...
            (const void *)0xA,
            a1);
          VfReportIssueWithOptions(0xE6u, 0xAuLL, a1, SLODWORD(Flink[10].Blink), (ULONG_PTR)Flink, byte_14042B90C);
        }
