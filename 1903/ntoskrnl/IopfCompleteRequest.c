/*
 * XREFs of IopfCompleteRequest @ 0x1400668F0
 * Callers:
...
void __fastcall IopfCompleteRequest(ULONG_PTR BugCheckParameter1, unsigned __int8 a2)
{
  ...
  __int64 v152; // [rsp+88h] [rbp-29h] BYREF
...
LABEL_199:
  ...
  if ( !v65 )
  {
    IopCompleteRequest((__int64)v66, (__int64)v158, &v155, (__int64 *)(BugCheckParameter1 + 192), &v155);
    return;
  }
  v149 = 0LL;
  v150 = 0LL;
