/*
 * XREFs of PopPublishAndResetPowerRequestsCollectionStats @ 0x1408B7644
 * Callers:
 ...
 *     PoQueryStopWatchCollection @ 0x1403067F8 (PoQueryStopWatchCollection.c)
 *     PoResetStopWatchCollection @ 0x140306850 (PoResetStopWatchCollection.c)
