/*
 * XREFs of MiUnlinkStandbyBatch @ 0x1400D99C0
 * Callers:
              ...
              && KeGetCurrentThread()->ApcState.Process->AddressPolicy != 1 )
            {
              ...
              if ( (v13 & 0x20) == 0 || (v13 & 0x42) == 0 )
              {
                ...
                if ( DeepFreezeStartTime )
                {
                  ...
                  LOBYTE(DeepFreezeStartTime) = v13 | 0x20;
                  if ( (v19 & 0x20) == 0 )
                    DeepFreezeStartTime = *(_QWORD *)a2;
                  LOBYTE(v13) = DeepFreezeStartTime;
                  if ( (v19 & 0x42) != 0 )
                    LOBYTE(v13) = DeepFreezeStartTime | 0x42;
                }
              }
            }
            if ( (v13 & 1) != 0 )
...
LABEL_29:
      ...
      if ( (*(_QWORD *)a2 & 0xC00LL) != 0x800 )
        return a5 - v6;
      if ( !v10 || !qword_140465B00 || (qword_140465B00 & v10) != 0 )
      {
        v11 = *(_QWORD *)a2;
        if ( qword_140465B00 && (v10 & 0x10) == 0 )
          v11 = v10 & ~qword_140465B00;
        goto LABEL_10;
      }
    }
  }
