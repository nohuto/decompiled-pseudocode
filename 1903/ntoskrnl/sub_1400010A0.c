/*
 * XREFs of sub_1400010A0 @ 0x1400010A0
 * Callers:
...
void __fastcall sub_1400010A0(__int64 a1, _BYTE *a2, char *a3, unsigned int a4, __int64 a5, unsigned int a6, _BYTE *a7)
{
  int v7; // r13d
  __int64 v10; // rbp
  int v11; // r15d
