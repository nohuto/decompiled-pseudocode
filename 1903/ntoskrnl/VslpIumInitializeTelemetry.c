/*
 * XREFs of VslpIumInitializeTelemetry @ 0x140A218E0
 * Callers:
...
char VslpIumInitializeTelemetry()
{
  ...
  if ( (*(_DWORD *)(KeLoaderBlock_0 + 264) & 1) != 0 )
  {
    ...
    if ( result )
    {
      ...
      v12[0] = v4;
      v14 = 4;
      result = TlgWrite(&stru_140426D80, &unk_14038C85A, 0LL, 0LL, 5u, &pData);
    }
  }
  if ( stru_140426D80.LevelPlus1 > 5 )
  {
    ...
    if ( result )
    {
      ...
      v8 = v6;
      v9 = 4;
      result = TlgWrite(&stru_140426D80, &unk_14038C835, 0LL, 0LL, 3u, &pData);
    }
  }
LABEL_5:
  if ( !VslVsmEnabled )
