/*
 * XREFs of MiFinishHardFault @ 0x140090EC0
 * Callers:
...
__int64 __fastcall MiFinishHardFault(__int64 a1, __int64 a2, __int64 a3, _QWORD *a4)
{
  ...
  if ( v85 >= 0 && !(unsigned int)MiIsFaultPteIntact(a1, v99, v91, v5 + 168) )
    v85 = -1073740748;
  if ( v23 >= 0
  ...
  while ( 1 )
  {
    ...
    else
    {
      ...
      v87 = v56;
      __writecr8(2uLL);
      if ( KiIrqlFlags && (KiIrqlFlags & 1) != 0 && (unsigned __int8)v56 < 2u )
    ...
    if ( (v9 & 0x30) != 0 )
    {
      ...
      if ( (v9 & 0x30) == 0x10 )
      {
        ...
        if ( (v9 & 4) != 0 && (*(_DWORD *)(v30 + 16) & 0x400LL) == 0 && !(unsigned int)MiIsPfnCommitNotCharged(v30) )
          MiChargeCommit(*(_QWORD *)(qword_140466188 + 8 * ((*(_QWORD *)(v30 + 40) >> 40) & 0x3FFLL)), 1uLL, 4u);
...
LABEL_190:
    ...
    if ( v30 == v90 )
    {
      ...
      if ( v92 )
      {
        ...
        MiSwapHardFaultPage(v91, v30, v60, v29);
        v28 = v83;
        v32 = v60;
        DecayPfn = BugCheckParameter2;
        v90 = v60;
      ...
      if ( v85 >= 0 && v30 == v32 )
      {
        ...
        v61 = *(_BYTE *)(v30 + 34) & 0xFE;
        *(_QWORD *)(v30 + 24) ^= ((*(_QWORD *)(v30 + 24) + 1LL) ^ *(_QWORD *)(v30 + 24)) & 0x3FFFFFFFFFFFFFFFLL;
        *(_BYTE *)(v30 + 34) = v61 | 6;
        MiRemoveLockedPageChargeAndDecRef(v30);
        v62 = *(_QWORD *)(v30 + 40);
        v63 = *(_QWORD *)(qword_140466188 + 8 * ((v62 >> 40) & 0x3FF));
        v64 = *(_DWORD *)(v30 + 16);
        v102 = v63;
        if ( (v64 & 0x400) == 0 && (unsigned int)MiIsPteInStore(v63, *(_QWORD *)(v30 + 16)) )
        {
        ...
        if ( (v62 & 0x200000000000000LL) != 0 )
        {
          v65 = v91;
          if ( ((*v91 >> 5) & 0x1F) == 0x18 )
            MiMakeProtoReadOnly(v91, v30);
          MiMakeTransitionPteValid(v65);
          if ( MiPteInShadowRange((unsigned __int64)v91) )
          {
            ...
            if ( !HIBYTE(word_140465BEC) && (v68 & 1) != 0 )
              v28 |= 0x8000000000000000uLL;
            *v67 = v28;
            MiWritePteShadow(v67, v28);
          }
          else
          {
LABEL_114:
...
LABEL_156:
    ...
    *(_WORD *)(v30 + 32) = v35;
    ...
    if ( v39 <= 0xFFFFF6BFFFFFFF78uLL && v39 >= 0xFFFFF68000000000uLL || (v40 = *(_BYTE *)(v30 + 35), (v40 & 0x20) == 0) )
    {
      ...
      v42 = *(_QWORD *)(qword_140466188 + 8 * ((v36 >> 40) & 0x3FF));
      if ( v41 == 1 )
      {
        v43 = *(_QWORD *)(v42 + 7232);
        if ( v43 )
...
LABEL_61:
          ...
          {
LABEL_75:
            v53 = _InterlockedExchangeAdd64((volatile signed __int64 *)(v42 + 8424), 0xFFFFFFFFFFFFFFFFuLL);
            v54 = *(_QWORD *)(v42 + 7200);
            if ( v53 >= v54 && v53 - 1 < v54 || (v55 = *(_QWORD *)(v42 + 7192), v53 >= v55) && v53 - 1 < v55 )
      ...
      if ( (ULONG_PTR *)v42 == &MiSystemPartition )
      {
        ...
        _InterlockedExchangeAdd64(&qword_14046A440, v48);
      }
      else
      {
...
LABEL_73:
  ...
  v57 = BugCheckParameter2;
  if ( v52 )
    MiInsertAndUnlockStandbyPages(BugCheckParameter2, v107, v52, v87);
  v23 = v86;
LABEL_84:
  if ( v89 )
  {
    if ( (_BYTE)CurrentIrql == 17 )
      ...
      v58 = 17;
    MiUnlockProtoPoolPage(v89, v58);
  }
  if ( (*(_DWORD *)(v5 + 192) & 0x8000) != 0 )
  {
    MmCheckCachedPageStates(v99 + (*(_DWORD *)(v5 + 96) & 0x3FFFF), (unsigned int)v98[10], 2LL, 0LL);
    v77 = v100;
  ...
  if ( v92 )
  {
    v82 = *(_QWORD *)(qword_140466188 + 8 * ((*(_QWORD *)(v92 + 40) >> 40) & 0x3FFLL));
