/*
 * XREFs of RawInitiateDeleteVolume @ 0x1400B59C8
 * Callers:
      ...
      if ( *(char **)(*(_QWORD *)p_FilterContexts + 8LL) == p_FilterContexts )
      {
        ...
        if ( (char *)Blink->Flink == p_FilterContexts )
        {
          ...
          *(_DWORD *)&AdvancedHeader[1].NodeTypeCode |= 6u;
          v16 = (struct _LIST_ENTRY *)qword_140436888;
          if ( *(__int64 **)qword_140436888 == &RawDismountedQueue )
          {
            *(_QWORD *)p_FilterContexts = &RawDismountedQueue;
            ...
            qword_140436888 = (__int64)&AdvancedHeader[1].FilterContexts;
