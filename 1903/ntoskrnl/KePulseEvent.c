/*
 * XREFs of KePulseEvent @ 0x1400F3050
 * Callers:
...
LABEL_60:
              ...
              *(_QWORD *)(v33 + 32) = v13;
              ...
              {
                KiWakeOtherQueueWaiters((__int64)v38, v33);
                v33 = v42;
              }
            }
            else
            {
              v34 = KiWakeQueueWaiter((__int64)v38, (_QWORD *)v42, v13);
              v33 = v42;
              if ( !v34 )
              {
                v32 = (_QWORD *)(v42 + 8);
...
LABEL_38:
            ...
            *(_QWORD *)(v25 + 32) = v17;
            ...
            {
              KiWakeOtherQueueWaiters((__int64)v37, v25);
              v25 = v41;
            }
          }
          else
          {
            v26 = KiWakeQueueWaiter((__int64)v37, (_QWORD *)v41, v17);
            v25 = v41;
            if ( !v26 )
            {
              v24 = (_QWORD *)(v41 + 8);
...
LABEL_7:
  ...
  if ( Wait )
    v3 = 3;
  KiExitDispatcher((__int64)CurrentPrcb, v3, 1u, v4, CurrentIrql);
  return SignalState;
}
