/*
 * XREFs of KiProcessSecondarySignalList @ 0x1402AA3B0
 * Callers:
 *     <none>
 * Callees:
  ...
  if ( (__int64 *)KiSecondarySignalList != &KiSecondarySignalList )
  {
    ...
    if ( *(__int64 **)(v8 + 8) != &v8
      ...
      || (*v9 = &KiSecondarySignalList,
          v9 = (__int64 **)qword_140447188,
          *(_QWORD *)qword_140447188 = &v8,
          v5 = KiSecondarySignalList,
          qword_140447188 = (__int64)v4,
          *(__int64 **)(KiSecondarySignalList + 8) != &KiSecondarySignalList)
    ...
    *(_QWORD *)(v5 + 8) = v4;
    qword_140447188 = (__int64)&KiSecondarySignalList;
