/*
 * XREFs of sub_1409D0FB4 @ 0x1409D0FB4
 * Callers:
 ...
 *     MmImageSectionPagable @ 0x1406A5B6C (MmImageSectionPagable.c)
 */

__int64 __fastcall sub_1409D0FB4(__int64 a1, ULONG_PTR a2, char a3)
{
  _BYTE *v3; // rbx
  __int64 v5; // r13
  int v6; // edi
          ...
          if ( v112 != v74 )
          {
            ...
            if ( (_DWORD)v113 )
            {
              ...
              do
              {
                ...
                v131 = v186;
                v132 = (__int64)v191;
                sub_1401B87DC((__int64)v22, (__int64)v191, v117);
                v133 = v207;
...
LABEL_212:
        ...
        *(_DWORD *)(v152 + 2088) += v146;
        ...
        {
          if ( (_DWORD)v146 )
            sub_1401B877C(v152, v40, v146, v161 + 28);
        }
        *(_DWORD *)(v161 + 24) = 1;
        *(_QWORD *)a1 = v152;
        return 0LL;
      }
      v152 = sub_14036AB20(v22, v151, v149);
      if ( v152 )
      {
        v153 = *((_DWORD *)v22 + 612);
        if ( (v153 & 4) == 0 )
    ...
    {
      LODWORD(v188) = 1073753351;
      KeBugCheckEx(__ROR4__(1073741903, 222), 0xAuLL, a2, 4uLL, 0LL);
    }
    if ( !*((_DWORD *)v3 + 574) )
    {
      *((_QWORD *)v3 + 289) = 0LL;
