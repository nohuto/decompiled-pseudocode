/*
 * XREFs of MmWriteTriageInformation @ 0x1402C6718
 * Callers:
...
__int64 __fastcall MmWriteTriageInformation(_OWORD *a1)
{
  ...
  *((_QWORD *)&v5 + 1) = qword_1404669B0;
  *(_QWORD *)&v6 = qword_1404644C8;
  *((_QWORD *)&v6 + 1) = qword_1404669B8;
  *(_QWORD *)&v7 = qword_1404669A8;
  *((_QWORD *)&v7 + 1) = qword_14046A568;
  *(_QWORD *)&v8 = qword_14046A080;
  result = qword_14046A088;
  *a1 = v4;
  *((_QWORD *)&v8 + 1) = result;
  a1[1] = v5;
  a1[2] = v6;
