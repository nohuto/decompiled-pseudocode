...
LABEL_33:
              ...
              {
                v14 = (unsigned int *)(qword_14050ECC8 + 8);
                while ( 1 )
                {
                  if ( *(v14 - 1) == ElementType )
                  {
                    ...
                    if ( !v15 || v15 == v6 )
                    {
                      v16 = *(_WORD *)(*v14 + qword_14050ECD0);
                      if ( ((v16 & 0x20) == 0 || (dword_14046BFEC & 4) != 0)
                        && ((v16 & 0x40) == 0 || (dword_14046BFEC & 0x10) != 0) )
                      {
                        break;
                      }
                    }
                  ...
                  ++v13;
                  v14 += 3;
                  if ( v13 >= *((unsigned __int16 *)qword_140509E00 + 18) )
                    goto LABEL_22;
                }
                if ( v7 == FilterBootOptionOperationSetElement )
                {
                  v8 = SepSecureBootValidateBcdDataAgainstBcdRule(qword_14050ECC8 + 12LL * v13, Data, v9);
                }
                else
                {
                  v8 = 0;
                  v17 = *(unsigned int *)(qword_14050ECC8 + 12LL * v13 + 8);
                  if ( (*(_BYTE *)(v17 + qword_14050ECD0) & 0x1F) != 8 || *(_WORD *)(v17 + qword_14050ECD0 + 2) )
                    v8 = -1069350910;
                }
              }
              goto LABEL_58;
