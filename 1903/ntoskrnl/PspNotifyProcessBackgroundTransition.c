/*
 * XREFs of PspNotifyProcessBackgroundTransition @ 0x14009DA08
 * Callers:
 *     PspApplyJobChainLimitsToProcess @ 0x140693F78 (PspApplyJobChainLimitsToProcess.c)
 *     PspSetProcessBackgroundCountCallback @ 0x1406EC6B0 (PspSetProcessBackgroundCountCallback.c)
 * Callees:
...
_QWORD *__fastcall PspNotifyProcessBackgroundTransition(__int64 a1, int a2)
{
  ...
  v5 = (volatile signed __int64 *)(a1 + 1760);
