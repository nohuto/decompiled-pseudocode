/*
 * XREFs of WbReleaseLeastRecentlyUsedHeapExecutedBlocks @ 0x1406D5E08
 * Callers:
  ...
  if ( a2 > 0 )
  {
    ...
    do
    {
      ...
      if ( v14 )
      {
        v15 = *(_QWORD *)(v14 + 48);
        v16 = 0LL;
        if ( (int)sub_1406D5FB8((int)a1 + 8, v15, 8, -1, (__int64)&v16) >= 0 )
          sub_1405CA528(a1, v16);
      }
