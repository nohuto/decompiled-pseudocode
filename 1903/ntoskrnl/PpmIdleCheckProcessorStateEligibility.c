/*
 * XREFs of PpmIdleCheckProcessorStateEligibility @ 0x1402EEF84
 * Callers:
 *     PpmIdleSelectStates @ 0x140189C30 (PpmIdleSelectStates.c)
 *     PpmIdleSelectCoordinatedProcessorDependency @ 0x1402EF748 (PpmIdleSelectCoordinatedProcessorDependency.c)
 * Callees:
