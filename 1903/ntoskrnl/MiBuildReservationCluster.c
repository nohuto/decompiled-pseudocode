/*
 * XREFs of MiBuildReservationCluster @ 0x140162FB0
 * Callers:
  ...
  while ( 1 )
  {
    ...
    if ( !_bittest64((const signed __int64 *)v77[2], v14) )
    {
      ...
      *(_QWORD *)(v75 + 24) ^= (*(_QWORD *)(v75 + 24) ^ (*(_QWORD *)(v75 + 24) + 1LL)) & 0x3FFFFFFFFFFFFFFFLL;
      ...
      v20 = MiReservePtes((__int64)&qword_1404669C0, (unsigned __int64 *)1);
      v76 = v20;
      v21 = v20;
      if ( v20 )
      {
...
LABEL_14:
          *(_QWORD *)v21 = v22;
          ...
          if ( (unsigned int)v28 >= v31 - 1 )
            LODWORD(v28) = v31 - 1;
          if ( qword_140465B00 && (v27 & 0x10) == 0 )
            v30 = v27 & ~qword_140465B00;
          v32 = HIDWORD(v30);
          ...
          if ( qword_140465B00 && (v50 & 0x10) == 0 )
            v50 &= ~qword_140465B00;
          v14 = HIDWORD(v50);
          MiReleasePtes((__int64)&qword_1404669C0, v76, 1u);
          goto LABEL_54;
        }
