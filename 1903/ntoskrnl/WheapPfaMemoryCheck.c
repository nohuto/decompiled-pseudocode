/*
 * XREFs of WheapPfaMemoryCheck @ 0x14091ADF8
 * Callers:
...
LABEL_7:
        ...
        {
          PoolWithTag = (char *)qword_140509AC8;
          v9 = *(_QWORD *)qword_140509AC8;
          if ( *(_QWORD *)(*(_QWORD *)qword_140509AC8 + 8LL) != qword_140509AC8 )
            goto LABEL_21;
          v10 = *(_QWORD **)(qword_140509AC8 + 8);
          if ( *v10 != qword_140509AC8 )
            goto LABEL_21;
          *v10 = v9;
          *(_QWORD *)(v9 + 8) = v10;
