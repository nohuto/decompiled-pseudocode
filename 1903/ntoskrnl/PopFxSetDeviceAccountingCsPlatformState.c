/*
 * XREFs of PopFxSetDeviceAccountingCsPlatformState @ 0x1402F5050
 * Callers:
...
LABEL_26:
    ...
    v21 = 1;
    return ZwUpdateWnfStateData((__int64)&WNF_PO_DRIPS_DEVICE_CONSTRAINTS_REGISTERED, (__int64)&v21, 1LL);
  }
  return result;
}
