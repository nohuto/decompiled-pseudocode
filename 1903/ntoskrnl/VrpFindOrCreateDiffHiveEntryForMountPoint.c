/*
 * XREFs of VrpFindOrCreateDiffHiveEntryForMountPoint @ 0x140846FDC
 * Callers:
...
LABEL_2:
  ...
  {
    v15 = DiffHiveEntry[1] & (-1LL << (dword_140463524 & 0x1F));
    v12 = qword_140463528;
    v13 = (37
         * (BYTE6(v15)
          + 37
         ...
         + HIBYTE(v15)) & (((unsigned int)dword_140463524 >> 5) - 1);
    *DiffHiveEntry = *(_QWORD *)(qword_140463528 + 8 * v13);
