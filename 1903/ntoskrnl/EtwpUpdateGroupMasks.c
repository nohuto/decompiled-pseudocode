/*
 * XREFs of EtwpUpdateGroupMasks @ 0x140707858
 * Callers:
 ...
 *     EtwpCheckSiloGroupMasks @ 0x1403308C4 (EtwpCheckSiloGroupMasks.c)
...
__int64 __fastcall EtwpUpdateGroupMasks(__int64 a1, __int64 a2)
{
  ...
  if ( *(_QWORD *)(a1 + 1112) == EtwpHostSiloState || (result = EtwpCheckSiloGroupMasks((char *)a2), (int)result >= 0) )
  {
    if ( a2
      && (*(_DWORD *)(a2 + 4) & 0x402) != 0
