/*
 * XREFs of MiUnlinkNodeLargePageHelper @ 0x14009C010
 * Callers:
...
__int64 __fastcall MiUnlinkNodeLargePageHelper(_QWORD *a1, __int64 a2, unsigned int a3, unsigned int a4, char a5)
{
  ...
  v10 = *(_QWORD *)(qword_140466188 + 8 * ((*(_QWORD *)(a2 + 40) >> 40) & 0x3FFLL));
  if ( v9 == 1 )
  {
    v13 = _InterlockedDecrement64((volatile signed __int64 *)(v10 + 8064));
  ...
  {
    v11 = _InterlockedExchangeAdd64((volatile signed __int64 *)(v10 + 8064), -(__int64)v9);
    v12 = *(_QWORD *)(v10 + 6128);
    v13 = v11 - v9;
  ...
  if ( v13 <= 0x420 )
  {
    ...
    if ( v13 < 0xA0 && v11 >= 0xA0 && *(_DWORD *)(v10 + 1144) )
      KeSetEvent((PRKEVENT)(v10 + 1000), 0, 0);
  }
  if ( v13 < 0x9F )
  {
    ...
    else if ( (v30 & 2) != 0 && v13 >= 0x21 )
    {
      v15 = 1;
    }
    else
    {
      v15 = (*(unsigned __int8 *)(v10 + 4) >> 5) & 1;
    }
  }
  else
  {
  ...
  *(_QWORD *)(a2 + 8) = 0LL;
  ...
  v23 = (unsigned int)dword_140465B40[v6];
  if ( v23 == 16 )
    LODWORD(v22) = v22 & 0xF;
  else
    v22 %= v23;
  ...
  if ( (_DWORD)v20 )
    v24 = 2240LL;
  _InterlockedExchangeAdd64((volatile signed __int64 *)(v24 + v10), -(__int64)v9);
  if ( dword_14046620C == 1 )
  {
    v31 = ((a2 + 0x58000000000LL) / 48) & 0x1F;
    v32 = v9;
    v33 = (volatile signed __int32 *)(qword_140466268 + 4 * (v18 >> 5));
    if ( v31 + v9 > 0x20 )
    {
      if ( (v18 & 0x1F) != 0 )
      {
        _InterlockedOr(v33, ((1 << (32 - (v18 & 0x1F))) - 1) << v31);
        v32 = v9 - (32 - (unsigned int)(v18 & 0x1F));
        ++v33;
      }
      if ( v32 >= 0x20 )
      {
...
LABEL_17:
  ...
  else if ( !(_DWORD)v20 && (MiFlags & 0x80u) != 0 && (++dword_14046630C & MmPageValidationFrequency) == 0 )
  {
