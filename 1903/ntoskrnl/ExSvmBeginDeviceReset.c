/*
 * XREFs of ExSvmBeginDeviceReset @ 0x14033D1D0
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall ExSvmBeginDeviceReset(__int64 a1, __int64 a2)
{
  ...
  if ( v10 )
  {
    if ( (unsigned __int64)&ExpSvmDeviceListLock >= 0xFFFF800000000000uLL
      && byte_140467440[(((unsigned __int64)&ExpSvmDeviceListLock >> 39) & 0x1FF) - 256] == 1 )
    {
...
LABEL_15:
  ...
  if ( v13 && ($6EAC78A6FCFADE0A5FA44F358736B38F *)v5->ApcState.ApcListHead[0].Flink != &v5->152 )
...
LABEL_45:
  ...
  if ( v13 && ($6EAC78A6FCFADE0A5FA44F358736B38F *)v18->ApcState.ApcListHead[0].Flink != &v18->152 )
