/*
 * XREFs of PiDevCfgLogDeviceStarted @ 0x1406FB8EC
 * Callers:
      ...
      if ( v6 || !PipIsDevNodeDNStarted(a1) )
      {
        if ( (v5 & 0x2000) != 0 && *(_DWORD *)(a1 + 404) == 14 )
        {
          if ( (byte_14042BDBA & 0x20) == 0 )
            goto LABEL_31;
          v9 = (wchar_t *)&dword_14094F874;
          v27 = v8;
          v20 = &dword_14094F874;
          LOBYTE(v26) = 14;
          v12 = (const wchar_t *)&dword_14094F874;
          v11 = L"null";
        ...
        {
          v21 = (wchar_t *)&dword_14094F874;
          v22 = (const wchar_t *)&dword_14094F874;
          v23 = L"null";
          if ( UnicodeString.Buffer )
            v23 = UnicodeString.Buffer;
          v24 = (const wchar_t *)&dword_14094F874;
          if ( v4 )
            v22 = v4;
          if ( Buffer )
            v24 = Buffer;
