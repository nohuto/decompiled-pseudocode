/*
 * XREFs of PfHardFaultLog @ 0x140126D4C
 * Callers:
  ...
  if ( *a1 || a1[1] )
  {
    if ( a2 )
    {
      ...
      if ( a2 == 2 )
      {
        v9 = 627;
LABEL_13:
        result = (struct _KTHREAD *)EtwTraceSiloTimedEvent(Process[2].ActiveProcessors.Bitmap[3], v9, a3, (int)a1 + 32);
        goto LABEL_3;
      }
    }
    v9 = 544;
