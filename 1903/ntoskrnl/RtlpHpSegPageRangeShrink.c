/*
 * XREFs of RtlpHpSegPageRangeShrink @ 0x14001E830
 * Callers:
 *     RtlpHpSegFree @ 0x14001D4C4 (RtlpHpSegFree.c)
 *     ExFreeHeapPool @ 0x140064DB0 (ExFreeHeapPool.c)
 *     RtlpHpSegPageRangeFree @ 0x14031BBBC (RtlpHpSegPageRangeFree.c)
 * Callees:
...
LABEL_76:
      ...
      if ( v44 && ($6EAC78A6FCFADE0A5FA44F358736B38F *)v40->ApcState.ApcListHead[0].Flink != &v40->152 )
