/*
 * XREFs of ViCopyDeviceDescription @ 0x14096BAB8
 * Callers:
...
__int64 __fastcall ViCopyDeviceDescription(__int64 a1, unsigned int *a2)
{
  ...
  if ( *a2 > 3 )
  {
    ViHalPreprocessOptions(byte_14042B884, "Unknown version %x for DEVICE_DESCRIPTION (%p)", 37, (const void *)*a2);
    VfReportIssueWithOptions(0xE6u, 0x25uLL, *a2, (ULONG_PTR)a2, 0LL, byte_14042B884);
  }
