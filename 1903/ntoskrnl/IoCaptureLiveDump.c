/*
 * XREFs of IoCaptureLiveDump @ 0x140858F44
 * Callers:
...
LABEL_24:
  ...
  *((_QWORD *)v12 + 76) = v11;
  ...
  if ( stru_140425C78.LevelPlus1 > 5 && TlgKeywordOn(&stru_140425C78, 0x200000000000uLL) )
    TlgWrite(&stru_140425C78, &unk_14038C966, (LPCGUID)v12 + 40, (LPCGUID)v12 + 39, 2u, &pData);
...
LABEL_30:
      ...
      if ( inited >= 0 )
      {
        ...
        else
        {
          ...
          if ( stru_140425C78.LevelPlus1 > 5 && TlgKeywordOn(&stru_140425C78, 0x200000000000uLL) )
          {
            ...
            v57 = &v41;
            TlgWrite(&stru_140425C78, &unk_14038C989, (LPCGUID)v12 + 40, (LPCGUID)v12 + 39, 4u, &v54);
          }
  ...
  if ( stru_140425C78.LevelPlus1 > 5 && TlgKeywordOn(&stru_140425C78, 0x200000000000uLL) )
  {
    ...
    TlgWrite(&stru_140425C78, &unk_14038C896, v29, p_pActivityId, 6u, &v45);
  }
  if ( v12 )
  {
    if ( (*((_DWORD *)v12 + 10) & 8) == 0 )
