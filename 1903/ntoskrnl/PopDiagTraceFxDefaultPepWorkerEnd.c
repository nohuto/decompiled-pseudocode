/*
 * XREFs of PopDiagTraceFxDefaultPepWorkerEnd @ 0x1400B2D88
 * Callers:
  ...
  if ( a4 == 2 )
  {
    if ( pCallbackContext.LevelPlus1 > 5 )
    {
      ...
      if ( (_BYTE)v5 )
      {
        ...
        v35 = &v24;
        v36 = v14;
        LOBYTE(v5) = TlgWriteEx(&pCallbackContext, &unk_14039057C, v13, v14, ActivityId, RelatedActivityId, 3u, &pData);
      }
    }
  }
