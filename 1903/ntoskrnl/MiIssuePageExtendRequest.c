/*
 * XREFs of MiIssuePageExtendRequest @ 0x1402CE6CC
 * Callers:
...
__int64 __fastcall MiIssuePageExtendRequest(__int64 a1, unsigned __int64 a2, char a3, unsigned int a4)
{
  ...
  _QWORD v30[12]; // [rsp+38h] [rbp-29h] BYREF
  ...
  if ( (a3 & 2) != 0 )
  {
    v12 = (volatile signed __int32 *)(a1 + (v10 != 0 ? 1368LL : 432LL));
  ...
  else
  {
    ...
    BYTE4(v30[9]) = a4;
    if ( (a3 & 1) != 0 )
      v18 = HIBYTE(v30[9]) & 0xE8 | 2;
    else
      v18 = HIBYTE(v30[9]) & 0xE8;
    HIBYTE(v30[9]) = v18;
    v30[8] = &v30[7];
    v30[7] = &v30[7];
    LOWORD(v30[6]) = 0;
  ...
  *((_QWORD *)v12 + 4) = a2;
  *((_QWORD *)v12 + 3) = a1;
  *((_BYTE *)v12 + 79) = v23 & 0xDF | (&MiOneSecond != (_UNKNOWN *)Timeout ? 0x20 : 0);
  MiQueuePageFileExtension(v12, v15, v9);
  if ( !v11 )
  {
    if ( KeWaitForSingleObject((PVOID)(v12 + 12), Executive, 0, 0, Timeout) == 258 )
    {
      v24 = ExAcquireSpinLockExclusive((PEX_SPIN_LOCK)(a1 + 1280));
      if ( !*((_DWORD *)v12 + 13) )
      {
        v25 = *((_QWORD *)v12 + 10);
        if ( v25 )
