/*
 * XREFs of CcUnpinFileDataEx @ 0x140078D40
 * Callers:
  ...
  if ( *(_QWORD *)(v9 + 168) )
  {
    ...
    else
    {
      ...
      if ( _interlockedbittestandset(&dword_140464580, 0x1Fu) )
      {
        ...
        v54 = ExpWaitForSpinLockExclusiveAndAcquire(&dword_140464580, CurrentIrql);
      }
      v15 = dword_140464580;
      while ( (v15 & 0xBFFFFFFF) != 0x80000000 )
      {
        if ( (v15 & 0x40000000) == 0 )
        {
          v46 = _InterlockedCompareExchange(&dword_140464580, v15 | 0x40000000, v15);
          v25 = v15 == v46;
          v15 = v46;
          if ( !v25 )
            continue;
...
LABEL_28:
  ...
  *(_DWORD *)(v9 + 328) = v26;
  ...
  {
    if ( (_DWORD)v3 != 2 )
      KeBugCheckEx(0x34u, 0x2046AuLL, v3, 0LL, 0LL);
    if ( P[2] )
    {
      v33 = *((_DWORD *)P + 1) >> 12;
      P[2] = 0;
  ...
  else
  {
    v27 = *((_DWORD *)P + 16);
    if ( !v27 )
      KeBugCheckEx(0x34u, 0x433uLL, 0xFFFFFFFFC0000420uLL, 0LL, 0LL);
    v28 = v27 - 1;
    *((_DWORD *)P + 16) = v28;
  }
  if ( v28 )
