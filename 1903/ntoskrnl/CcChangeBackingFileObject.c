/*
 * XREFs of CcChangeBackingFileObject @ 0x14027BE24
 * Callers:
 *     FsRtlChangeBackingFileObject @ 0x14012F860 (FsRtlChangeBackingFileObject.c)
 * Callees:
...
LABEL_144:
      ...
      if ( v13 && ($6EAC78A6FCFADE0A5FA44F358736B38F *)v65->ApcState.ApcListHead[0].Flink != &v65->152 )
...
LABEL_116:
    ...
    if ( !v13 )
      return 0LL;
LABEL_117:
    if ( ($6EAC78A6FCFADE0A5FA44F358736B38F *)v23->ApcState.ApcListHead[0].Flink != &v23->152 )
...
LABEL_85:
  ...
  if ( v13 && ($6EAC78A6FCFADE0A5FA44F358736B38F *)v37->ApcState.ApcListHead[0].Flink != &v37->152 )
