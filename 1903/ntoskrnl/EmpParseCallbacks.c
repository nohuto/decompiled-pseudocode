/*
 * XREFs of EmpParseCallbacks @ 0x1409FA17C
 * Callers:
 *     EmpParseInfDatabase @ 0x1409F9A64 (EmpParseInfDatabase.c)
 * Callees:
 *     EmpSearchCallbackDatabase @ 0x140189AAC (EmpSearchCallbackDatabase.c)
...
__int64 __fastcall EmpParseCallbacks(__int64 a1)
{
  ...
  if ( SectionLineCount )
  {
    while ( 1 )
    {
      ...
      GuidFromName = EmpInfParseGetGuidFromName(a1, "CallbackGuidDef", KeyName, PoolWithTag, v18, v19);
      v10 = v9;
...
LABEL_12:
    ...
    while ( 1 )
    {
      ...
      GuidFromName = ((__int64 (__fastcall *)(__int64, const char *, __int64, __int64 *))EmpInfParseGetGuidFromName)(
                       a1,
                       "EntryTypeGuidDef",
                       v15,
                       &v18);
