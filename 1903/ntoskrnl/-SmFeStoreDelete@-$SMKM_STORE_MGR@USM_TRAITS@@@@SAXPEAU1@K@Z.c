/*
 * XREFs of ?SmFeStoreDelete@?$SMKM_STORE_MGR@USM_TRAITS@@@@SAXPEAU1@K@Z @ 0x140104644
 * Callers:
...
LABEL_28:
  ...
  if ( v17 && ($6EAC78A6FCFADE0A5FA44F358736B38F *)v13->ApcState.ApcListHead[0].Flink != &v13->152 )
