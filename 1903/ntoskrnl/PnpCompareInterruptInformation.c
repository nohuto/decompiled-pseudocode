/*
 * XREFs of PnpCompareInterruptInformation @ 0x140745CC0
 * Callers:
...
char __fastcall PnpCompareInterruptInformation(__int64 a1, const void *a2, unsigned int a3)
{
  ...
  if ( v5 )
  {
    if ( *v5 == a3 )
    {
      ...
      if ( v3 != v4 && stru_140425D20.LevelPlus1 > 5 )
      {
        LOBYTE(v3) = TlgKeywordOn(&stru_140425D20, 0x400000000000uLL);
        if ( (_BYTE)v3 )
        {
          v14[0] = v10;
          v13 = v4;
          ...
          v20 = &v13;
          v24 = 2;
          LOBYTE(v3) = TlgWrite(&stru_140425D20, &unk_14038CC95, 0LL, 0LL, 7u, &pData);
        }
      }
    }
    else if ( stru_140425D20.LevelPlus1 > 5 )
    {
      LOBYTE(v3) = TlgKeywordOn(&stru_140425D20, 0x400000000000uLL);
      if ( (_BYTE)v3 )
      {
        ...
        v20 = v14;
        v24 = 2;
        LOBYTE(v3) = TlgWrite(&stru_140425D20, &unk_14038CD35, 0LL, 0LL, 7u, &pData);
      }
    }
  }
  else if ( stru_140425D20.LevelPlus1 > 5 )
  {
    ...
    if ( (_BYTE)v3 )
    {
      ...
      v17 = &v21;
      v18 = 2;
      LOBYTE(v3) = TlgWrite(&stru_140425D20, &unk_14038CCEC, 0LL, 0LL, 5u, &pData);
    }
  }
  return v3;
}
