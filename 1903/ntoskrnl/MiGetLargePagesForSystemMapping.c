/*
 * XREFs of MiGetLargePagesForSystemMapping @ 0x14088B9D8
 * Callers:
 ...
 *     MiThreadIdealNode @ 0x1402D1DFC (MiThreadIdealNode.c)
...
__int64 __fastcall MiGetLargePagesForSystemMapping(__int64 a1, unsigned __int64 a2)
{
  ...
  if ( (v9 & 0x400) != 0 )
    v15 = 1LL;
  v16 = 0;
  v17 = (int *)(qword_140465A50 + 4LL * v14 * (unsigned int)(unsigned __int16)KeNumberNodes);
  v18 = &v17[v15];
  while ( 1 )
  {
