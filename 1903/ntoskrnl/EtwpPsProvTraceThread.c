/*
 * XREFs of EtwpPsProvTraceThread @ 0x1406C4DCC
 * Callers:
 *     EtwTraceThread @ 0x1406C4A70 (EtwTraceThread.c)
 * Callees:
 *     EtwWrite @ 0x140036280 (EtwWrite.c)
 *     PsQueryThreadStartAddress @ 0x14011C614 (PsQueryThreadStartAddress.c)
...
NTSTATUS __fastcall EtwpPsProvTraceThread(__int64 a1, __int64 a2, char a3)
{
  ...
  __int64 v25; // [rsp+68h] [rbp-E0h] BYREF
  ...
  if ( a3 )
  {
    ...
    if ( CurrentThreadTeb )
    {
      v7 = KeGetCurrentThread()->Process[1].ActiveProcessors.Bitmap[6];
  ...
  else
  {
    ...
    if ( v12 )
    {
      v13 = KeGetCurrentThread()->Process[1].ActiveProcessors.Bitmap[6];
