/*
 * XREFs of KiMcheckFastForward @ 0x1402B6830
 * Callers:
...
unsigned __int64 __fastcall KiMcheckFastForward(ULONG_PTR BugCheckParameter4, char a2)
{
  ...
  if ( (*(_BYTE *)(BugCheckParameter4 + 368) & 1) == 0 )
  {
    ...
    if ( KiKvaShadow )
    {
      ...
      {
        v4 |= 4u;
        _InterlockedAdd(&dword_140446D0C, 1u);
      }
      if ( KiKvaShadow
  ...
  if ( a2 || (v4 & 1) != 0 )
  {
    _InterlockedAdd(&dword_140446D18, 1u);
    if ( (v4 & 1) != 0 )
      _InterlockedAdd(&dword_140446D20, 1u);
    v9 = 1;
  }
  else
  {
    _InterlockedAdd(&dword_140446D1C, 1u);
    v9 = 0;
  }
  v10 = 0LL;
  if ( KiKvaShadow )
...
LABEL_31:
  if ( (v4 & 4) != 0 )
  {
    _InterlockedAdd(&dword_140446D24, 1u);
    ...
    if ( KiKvaShadow )
    {
      ...
      *(_QWORD *)(v10 + 24) = CurrentPrcb->HalReserved[(unsigned __int64)v12 / 8];
      ...
      {
        _InterlockedAdd(&dword_140446D28, 1u);
    ...
    *(_QWORD *)(v3 + 64) = result;
    _InterlockedAdd(&dword_140446D14, 1u);
    *(_WORD *)((char *)&CurrentPrcb->CurrentThread + v12) = 0;
  }
  if ( !a2 )
  {
    _InterlockedAdd(&dword_140446D10, 1u);
