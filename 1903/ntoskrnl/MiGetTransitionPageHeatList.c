/*
 * XREFs of MiGetTransitionPageHeatList @ 0x1402EBC2C
 * Callers:
...
PSLIST_ENTRY MiGetTransitionPageHeatList()
{
  ...
  result = RtlpInterlockedPopEntrySList(&stru_140466550);
  v1 = result;
  if ( result )
  {
  ...
  else
  {
    ...
    {
      v3 = v2;
      v2 = _InterlockedCompareExchange(&dword_140466560, v2 - 1, v2);
      if ( v3 == v2 )
        return v1;
    }
