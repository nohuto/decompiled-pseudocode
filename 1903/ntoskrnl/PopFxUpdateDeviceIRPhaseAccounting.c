/*
 * XREFs of PopFxUpdateDeviceIRPhaseAccounting @ 0x1402F5C3C
 * Callers:
 ...
 *     PopFxAccumulateDeviceIRPhaseAccounting @ 0x1402F1F64 (PopFxAccumulateDeviceIRPhaseAccounting.c)
 */
...
__int64 __fastcall PopFxUpdateDeviceIRPhaseAccounting(char a1)
{
  ...
  if ( byte_140442D70 )
  {
    ...
    if ( a1 )
      qword_140442D68 = PerformanceCounter.QuadPart;
    else
