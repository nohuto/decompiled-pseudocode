/*
 * XREFs of KeDelayExecutionThread @ 0x14003B180
 * Callers:
 ...
 *     ?StNpLeafPageIn@?$ST_STORE@USM_TRAITS@@@@SAJPEAUNP_CTX@NP_CONTEXT@@PEAX_K@Z @ 0x140323A50 (-StNpLeafPageIn@-$ST_STORE@USM_TRAITS@@@@SAJPEAUNP_CTX@NP_CONTEXT@@PEAX_K@Z.c)
 ...
 *     PipEventRemovalCheckOpenHandles @ 0x14087BFB0 (PipEventRemovalCheckOpenHandles.c)
 ...
 *     KiCheckDueTimeExpired @ 0x1400BA960 (KiCheckDueTimeExpired.c)
