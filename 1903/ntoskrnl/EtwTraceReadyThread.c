/*
 * XREFs of EtwTraceReadyThread @ 0x14032E1F4
 * Callers:
...
__int64 __fastcall EtwTraceReadyThread(__int64 a1, char a2, char a3, char a4)
{
  ...
  v7 = (*(_DWORD *)(v6 + 576) & 7) != 0 ? 4 : 0;
  v8 = *(void (__noreturn **)())(a1 + 1696);
  ...
  v16 = &v11;
  v17 = 8;
  return EtwTraceSiloKernelEvent(*(_QWORD *)(v9 + 1776), (int)&v16, 1, 0x20000200u, 1330, v5);
}
