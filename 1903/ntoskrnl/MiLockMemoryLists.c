/*
 * XREFs of MiLockMemoryLists @ 0x1401660A0
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall MiLockMemoryLists(__int64 a1, __int64 a2)
{
  ...
  if ( a2 )
  {
    *v2 = 0LL;
    ...
    {
      v12 = 0;
      for ( i = *v9; v12 < dword_140465AB4; ++v12 )
      {
    ...
    v18[1] = a1 + 8480;
    *v18 = 0LL;
    KxAcquireQueuedSpinLock((__int64)v18, (volatile __int64 *)(a1 + 8480));
    ...
    if ( KeNumberNodes )
    {
      v24 = (volatile __int64 *)(*(_QWORD *)(a1 + 16) + 1952LL);
      do
      {
        v25 = &v2[3 * v19];
        v25[1] = v24;
    ...
    v26[1] = a1 + 8544;
    *v26 = 0LL;
    return KxAcquireQueuedSpinLock((__int64)v26, (volatile __int64 *)(a1 + 8544));
  }
  else
  {
    v5 = dword_140465AB4;
    v6 = (unsigned __int16)KeNumberNodes;
    result = (unsigned int)(unsigned __int16)KeNumberNodes + 2 * dword_140465AB4 + 27;
    if ( (_DWORD)result )
    {
      do
      {
