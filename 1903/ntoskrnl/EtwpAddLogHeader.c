/*
 * XREFs of EtwpAddLogHeader @ 0x1406B91F0
 * Callers:
  ...
  if ( result >= (unsigned __int64)v7 + 104 )
  {
    ...
    *((_WORD *)v20 + 118) = v24.m128i_i16[1];
    ...
    if ( a2[2] + 80 <= *a2 )
    {
      ...
      *((_QWORD *)v31 + 2) = *v9;
      *((_DWORD *)v31 + 8) = 0;
      *((_DWORD *)v31 + 9) = *(_DWORD *)(*(_QWORD *)(a1 + 1112) + 4204LL);
      *((_OWORD *)v31 + 3) = *(_OWORD *)(*(_QWORD *)(a1 + 1112) + 4152LL);
      *((_QWORD *)v31 + 5) = *(_QWORD *)(a1 + 1296);
      *((_OWORD *)v31 + 4) = *(_OWORD *)(*(_QWORD *)(a1 + 1112) + 4168LL);
      a2[2] += 80;
    }
    v32 = *a2;
    a2[12] = a2[2];
