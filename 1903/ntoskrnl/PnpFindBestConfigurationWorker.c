/*
 * XREFs of PnpFindBestConfigurationWorker @ 0x140751FD0
 * Callers:
 *     PnpFindBestConfiguration @ 0x140751F78 (PnpFindBestConfiguration.c)
 * Callees:
 *     IopSelectNextConfiguration @ 0x140751AC0 (IopSelectNextConfiguration.c)
 *     IopTestConfiguration @ 0x1407520E4 (IopTestConfiguration.c)
 *     PnpSelectFirstConfiguration @ 0x140752240 (PnpSelectFirstConfiguration.c)
 *     IopAddRemoveReqDescs @ 0x140753B58 (IopAddRemoveReqDescs.c)
 *     IopRetestConfiguration @ 0x1408610E8 (IopRetestConfiguration.c)
 *     IopSaveRestoreConfiguration @ 0x1408611AC (IopSaveRestoreConfiguration.c)
 */
