/*
 * XREFs of MiFinishVadDeletion @ 0x140056B50
 * Callers:
...
LABEL_102:
  ...
  else
  {
    ...
    if ( (__int64)v24->LockState.LockState < 0 )
      KiAbEntryRemoveFromTree(&v16->LockEntries[v23], v19);
...
LABEL_105:
    ...
    else
    {
      ...
      if ( (__int64)v54->LockState.LockState < 0 )
        KiAbEntryRemoveFromTree(&v48->LockEntries[v53], v50);
    ...
    if ( v20 && ($6EAC78A6FCFADE0A5FA44F358736B38F *)v48->ApcState.ApcListHead[0].Flink != &v48->152 )
      KiCheckForKernelApcDelivery();
    v20 = v47->SpecialApcDisable++ == -1;
    if ( v20 && ($6EAC78A6FCFADE0A5FA44F358736B38F *)v47->ApcState.ApcListHead[0].Flink != &v47->152 )
      KiCheckForKernelApcDelivery();
    if ( v46 )
