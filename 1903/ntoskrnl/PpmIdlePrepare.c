/*
 * XREFs of PpmIdlePrepare @ 0x140032CF0
 * Callers:
...
LABEL_12:
      ...
      *(_DWORD *)(v10 + 528) = v20;
      ...
      {
        v21 = BYTE2(PpmCurrentProfile[341 * dword_140443ACC + 24]);
        *(_BYTE *)(v10 + 542) = v21;
        if ( v21 )
...
LABEL_58:
    ...
    else if ( PoSkipTickMode != 2 || KiSerializeTimerExpiration )
    {
      ...
      if ( KiGroupSchedulingEnabled )
      {
        ...
        if ( (((unsigned __int64)qword_14042A1A8[v54 >> 6] >> (v54 & 0x3F)) & 1) != 0
      ...
      if ( *(_BYTE *)(v6 + 33) )
      {
        ...
        do
        {
          if ( qword_14044DA30[3 * v62] < v61 )
          {
            v36 = (unsigned __int8)v36;
            v61 = qword_14044DA30[3 * v62];
            if ( v62 == 3 )
              v36 = 1LL;
          }
          ++v62;
