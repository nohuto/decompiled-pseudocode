/*
 * XREFs of PsRegisterPicoProvider @ 0x1408CA500
 * Callers:
 *     <none>
 * Callees:
 *     <none>
...
__int64 __fastcall PsRegisterPicoProvider(__int64 a1, _QWORD *a2)
{
  ...
  xmmword_140436A10 = *(_OWORD *)(a1 + 16);
  xmmword_140436A20 = *(_OWORD *)(a1 + 32);
  xmmword_140436A30 = *(_OWORD *)(a1 + 48);
  xmmword_140436A40 = *(_OWORD *)(a1 + 64);
  qword_140436A50 = *(_QWORD *)(a1 + 80);
  PspPicoProviderRanges = _mm_srli_si128((__m128i)xmmword_140436A30, 8).m128i_u64[0];
