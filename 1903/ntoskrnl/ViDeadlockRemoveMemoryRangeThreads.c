/*
 * XREFs of ViDeadlockRemoveMemoryRangeThreads @ 0x140329094
 * Callers:
 ...
 *     VfUtilAddressRangeFit @ 0x14096444C (VfUtilAddressRangeFit.c)
 *     ViDeadlockDatabaseHashIndex @ 0x14097C570 (ViDeadlockDatabaseHashIndex.c)
