/*
 * XREFs of MiClearPartitionPageBitMap @ 0x1402E9A98
 * Callers:
...
LABEL_30:
  ...
  if ( (__int64)v20->LockState.LockState < 0 )
    KiAbEntryRemoveFromTree((__int64)&v14->LockEntries[v19]);
...
LABEL_37:
  ...
  if ( v21 && ($6EAC78A6FCFADE0A5FA44F358736B38F *)v14->ApcState.ApcListHead[0].Flink != &v14->152 )
