/*
 * XREFs of ViDeadlockRemoveNode @ 0x14097CC64
 * Callers:
 *     ViDeadlockForgetResourceHistory @ 0x14097C7E0 (ViDeadlockForgetResourceHistory.c)
...
LABEL_20:
      ...
      *v15 = v14;
      *(_QWORD *)(v14 + 8) = v15;
      ViDeadlockUpdateChildrenCount(*v2, 0xFFFFFFFFLL, v15);
    }
    else
    {
      while ( v7 != v6 )
