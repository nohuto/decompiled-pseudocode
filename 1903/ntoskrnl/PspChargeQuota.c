/*
 * XREFs of PspChargeQuota @ 0x14003AB00
 * Callers:
...
LABEL_3:
  ...
  if ( v11 > v14 )
  {
    ...
    while ( v14 != v19 && v11 > v14 );
  }
  if ( a2 )
  {
    if ( (v8 & 4) != 0 )
    {
      v15 = a4 + _InterlockedExchangeAdd64((volatile signed __int64 *)(a2 + 8 * v4 + 792), a4);
      v16 = a2 + 8 * v4;
      _m_prefetchw((const void *)(v16 + 808));
      v17 = *(_QWORD *)(v16 + 808);
      if ( v15 > v17 )
      {
        do
        {
          v20 = v17;
          v17 = _InterlockedCompareExchange64((volatile signed __int64 *)(v16 + 808), v15, v17);
        }
        while ( v17 != v20 && v15 > v17 );
      }
    }
  }
  return 0LL;
