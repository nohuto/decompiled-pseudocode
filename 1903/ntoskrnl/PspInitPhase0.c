/*
 * XREFs of PspInitPhase0 @ 0x140A0457C
 * Callers:
...
char __fastcall PspInitPhase0(PVOID StartContext)
{
  ...
  *(_QWORD *)&DestinationString.Length = 0LL;
  ...
  qword_140436BA8 = (__int64)&PsActiveProcessHead;
              ...
              if ( PspInitializeSiloStructures() )
              {
                ...
                if ( PspCidTable )
                {
                  ...
                  *(_BYTE *)(PspCidTable + 44) |= 1u;
                  qword_140436C30 = (__int64)PspReaper;
                  qword_140436BD0 = (__int64)PspProcessRundownWorker;
