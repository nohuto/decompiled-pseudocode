/*
 * XREFs of KiInitPrcb @ 0x1405A05EC
 * Callers:
 ...
 *     KiInitializeDpcList @ 0x14013D650 (KiInitializeDpcList.c)
 *     KiIntSteerInitPrcb @ 0x14013D680 (KiIntSteerInitPrcb.c)
...
__int64 __fastcall KiInitPrcb(__int64 a1, int a2)
{
  ...
  *(_DWORD *)(a1 + 22752) = 1;
  ...
  if ( !a2 )
  {
    ...
    memset(&unk_1404470C4, 0, 0xA4uLL);
  }
