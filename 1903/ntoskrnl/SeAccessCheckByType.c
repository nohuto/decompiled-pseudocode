/*
 * XREFs of SeAccessCheckByType @ 0x14000AF80
 * Callers:
 *     NtAccessCheck @ 0x14000C880 (NtAccessCheck.c)
 *     NtAccessCheckByType @ 0x140127570 (NtAccessCheckByType.c)
 *     NtAccessCheckByTypeResultList @ 0x14031C940 (NtAccessCheckByTypeResultList.c)
 * Callees:
