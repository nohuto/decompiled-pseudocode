/*
 * XREFs of CmpFindRedirectedDriverServiceStateNode @ 0x140A12108
 * Callers:
        ...
        __int64 a7)
{
  ...
  if ( !(unsigned __int8)CmpFindHiveSubKey(
                           ...
                           (__int64)v22) )
    return 0;
  SubKeyByName = CmpFindSubKeyByName(BugCheckParameter3, v21, L"\b\n");
  ...
  if ( !v13 )
    return 0;
  v14 = CmpFindSubKeyByName(BugCheckParameter3, v13, (unsigned __int16 *)&CmpDriverStateSourceIdName);
