/*
 * XREFs of SmKmVirtualLockCtxMemoryUnlocked @ 0x140325938
 * Callers:
...
LABEL_29:
    ...
    KiAbThreadRemoveBoosts((ULONG_PTR)v10, BugCheckParameter2, &v27);
    v17 = v10->SpecialApcDisable++ == -1;
    if ( v17 && ($6EAC78A6FCFADE0A5FA44F358736B38F *)v10->ApcState.ApcListHead[0].Flink != &v10->152 )
