/*
 * XREFs of MiInsertLargePageInFreeOrZeroList @ 0x140027570
 * Callers:
...
LABEL_9:
  ...
  v62 = v14 | (!v23 + 1);
  v25 = *(_QWORD *)(qword_140466188 + 8 * ((v20 >> 40) & 0x3FF));
  v26 = 0;
  v61 = 0;
  v80 = v25;
...
LABEL_75:
  if ( v50 )
  {
    if ( v48 >= 0xFFFF800000000000uLL && byte_140467440[((v48 >> 39) & 0x1FF) - 256] == 1 )
...
LABEL_84:
  ...
  if ( v23 && ($6EAC78A6FCFADE0A5FA44F358736B38F *)CurrentThread->ApcState.ApcListHead[0].Flink != &CurrentThread->152 )
