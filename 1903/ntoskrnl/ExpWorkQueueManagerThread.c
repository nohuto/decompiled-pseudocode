/*
 * XREFs of ExpWorkQueueManagerThread @ 0x140766FB0
 * Callers:
 *     <none>
 * Callees:
 ...
 *     KeSetMaximumCountPriQueue @ 0x1402B36EC (KeSetMaximumCountPriQueue.c)
 *     ExAllocatePoolWithTag @ 0x14036E010 (ExAllocatePoolWithTag.c)
 *     ExFreePoolWithTag @ 0x14036E0A0 (ExFreePoolWithTag.c)
 *     ExpCreateWorkerThread @ 0x1406B34F4 (ExpCreateWorkerThread.c)
 *     ExpPartitionCreatePoolDelayed @ 0x140913B88 (ExpPartitionCreatePoolDelayed.c)
 */
...
LABEL_16:
    ...
    do
    {
      ...
      *((_DWORD *)&v17[11].0 + 1) = v17[11].TargetInfoAsUlong;
      if ( ((__int64)v17[11].DpcListEntry.Next & 0x3FFF) >= SLODWORD(v17[11].ProcessorHistory) || v2 )
        v6 = v11;
      v16 += 8LL;
    }
    while ( v16 <= 8 );
