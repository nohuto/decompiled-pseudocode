/*
 * XREFs of AuthzBasepGetClaimAttributesCopyoutBufferSize @ 0x14092C8EC
 * Callers:
 *     AuthzBasepQueryClaimAttributesToken @ 0x1406D1FBC (AuthzBasepQueryClaimAttributesToken.c)
 * Callees:
 *     AuthzBasepGetClaimAttributeValueCopyoutBufferSize @ 0x14092C748 (AuthzBasepGetClaimAttributeValueCopyoutBufferSize.c)
 */
