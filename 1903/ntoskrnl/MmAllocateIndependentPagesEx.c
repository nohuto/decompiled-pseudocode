/*
 * XREFs of MmAllocateIndependentPagesEx @ 0x1400EFC58
 * Callers:
...
__int64 __fastcall MmAllocateIndependentPagesEx(unsigned __int64 a1, int a2, _QWORD *a3, unsigned int a4)
{
  ...
  v7 = (a1 >> 12) + ((a1 & 0xFFF) != 0);
  v8 = MiReservePtes((__int64)&qword_1404669C0, (unsigned __int64 *)(unsigned int)v7);
  if ( !v8 )
    return 0LL;
  ...
  v29 = a3 && (dword_140468484 & 8) != 0 && (a2 == -1 || KeNumberNodes == 1);
