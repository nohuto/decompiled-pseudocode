/*
 * XREFs of EtwpUpdateGlobalGroupMasks @ 0x1406E7148
 * Callers:
...
__int64 __fastcall EtwpUpdateGlobalGroupMasks(__int64 a1, unsigned int a2, unsigned int a3)
{
  ...
  _BYTE v34[32]; // [rsp+70h] [rbp+7h] BYREF
  ...
  else
  {
    ...
    *(_OWORD *)(a1 + 4244) = v14;
    ...
    do
    {
      ...
      v33[v20 + 1] = _mm_and_si128(_mm_andnot_si128(v23, si128), v22);
    ...
    if ( v24 < 0 )
    {
      do
      {
        v31 = ~*(_DWORD *)((char *)v12 + (_QWORD)v33 - a1 - 4228);
        *v12 &= v31;
        v12[8 * v3 + 8] &= v31;
