/*
 * XREFs of SepSecureBootValidateBcdDataAgainstBcdRule @ 0x1408E1FD0
 * Callers:
 ...
 *     SepSecureBootGetQWordPolicyValue @ 0x1408E1DDC (SepSecureBootGetQWordPolicyValue.c)
 */
...
__int64 __fastcall SepSecureBootValidateBcdDataAgainstBcdRule(__int64 a1, _BYTE *a2, unsigned int a3)
{
  ...
  v4 = (_WORD *)(qword_14050ECD0 + *(unsigned int *)(a1 + 8));
  QWordPolicyValue = 0;
  v6 = *v4 & 0x1F;
  if ( v6 != 8 )
  {
