/*
 * XREFs of EmpInfParseGetValueFromSectionAndKeyName @ 0x1409FB4E8
 * Callers:
 ...
 *     EmpInfParseGetStringIndexFromName @ 0x1409FB3E0 (EmpInfParseGetStringIndexFromName.c)
 * Callees:
 *     _strnicmp @ 0x14019FC00 (_strnicmp.c)
 *     CmpGetSectionLineIndex @ 0x1409FB470 (CmpGetSectionLineIndex.c)
 *     CmpGetKeyName @ 0x1409FB58C (CmpGetKeyName.c)
 */
