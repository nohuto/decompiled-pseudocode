/*
 * XREFs of NtSetEaFile @ 0x140858120
 * Callers:
 *     <none>
 * Callees:
 ...
 *     IoCheckEaBufferValidity @ 0x140617EF0 (IoCheckEaBufferValidity.c)
...
LABEL_23:
        ...
        if ( (Flags & 4) != 0 )
        {
          ...
          v32 = 0;
          PoolWithQuota_0 = (struct _FILE_FULL_EA_INFORMATION *)IopVerifierExAllocatePoolWithQuota_0(0LL, EaBufferSize);
