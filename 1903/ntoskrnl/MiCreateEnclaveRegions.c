/*
 * XREFs of MiCreateEnclaveRegions @ 0x140A198C8
 * Callers:
...
LABEL_21:
    ...
    v10 = 0;
LABEL_15:
    RtlAvlInsertNodeEx((unsigned __int64 *)&qword_140465BC8, (unsigned __int64)v11, v10, v1);
LABEL_16:
  ...
  return !qword_140465BC8 || (unsigned int)MiInitializeEnclaveMetadataPage();
}
