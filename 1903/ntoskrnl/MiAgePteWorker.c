/*
 * XREFs of MiAgePteWorker @ 0x14004CF70
 * Callers:
        ...
        char a6)
{
  ...
  if ( a3 < 0xFFFFF68000000000uLL || a3 > 0xFFFFF6FFFFFFFFFFuLL )
  {
      ...
      && ((v13 & 0x20) == 0 || (v13 & 0x42) == 0) )
    {
      ...
      {
        v39 = *(_QWORD *)(DeepFreezeStartTime + 8 * ((v12 >> 3) & 0x1FF));
        HIBYTE(DeepFreezeStartTime) = HIBYTE(*(_QWORD *)v12);
        if ( (v39 & 0x20) == 0 )
          DeepFreezeStartTime = *(_QWORD *)v12;
        HIBYTE(v13) = HIBYTE(DeepFreezeStartTime);
        if ( (v39 & 0x42) != 0 )
          HIBYTE(v13) = HIBYTE(DeepFreezeStartTime);
      }
    }
      ...
      if ( v8 < v7 || v8 > 0xFFFFF6FFFFFFFFFFuLL )
      {
        ...
        if ( v12 >= v11 )
        {
          ...
          if ( v12 <= 0xFFFFF6FB7DBED7F8uLL && (MiFlags & 0xC00000) != 0 )
          {
            ...
            if ( *(_BYTE *)(*(_QWORD *)(result + 184) + 648LL) != 1
              && (v21 & 1) != 0
              && ((v21 & 0x20) == 0 || (v21 & 0x42) == 0) )
            {
              result = KeGetCurrentThread()->ApcState.Process[2].DeepFreezeStartTime;
              if ( result )
              {
    ...
    if ( v33 )
    {
      if ( (a5[17] & 4) == 0 )
      {
        ...
        if ( (v42 & 0xC00) == 0 )
        {
          ...
          {
            ++*((_QWORD *)a5 + 10);
            *(_QWORD *)(v41 + 24) = v42 ^ ((unsigned __int16)v42 ^ (unsigned __int16)(v42 + 1)) & 0x3FF;
            goto LABEL_66;
          }
        }
      }
      if ( (a5[17] & 4) == 0 )
      {
        ...
        {
          v46 = *(_QWORD *)(v44 + 24) & 0x3FFLL;
          if ( v46 + 1 >= v46 && v46 + 1 <= 0x3FF )
          {
            ++*((_QWORD *)a5 + 10);
            *(_QWORD *)(v44 + 24) = (v45 - 4096) ^ ((unsigned __int16)(v45 - 4096) ^ (unsigned __int16)(v45 - 4096 + 1)) & 0x3FF;
LABEL_66:
            result = a5[18];
            if ( a5[19] == (_DWORD)result )
              return MiFreeWsleList(a1, v32, 0);
            return result;
          }
        }
      }
...
LABEL_27:
  ...
  if ( (a6 & 2) != 0 )
    ...
    v25 = (a6 & 4) != 0;
  result = MiClearPteAccessed(a1, a4, a2, v24, dword_140466368, v25);
  if ( (_DWORD)result )
    ++*((_QWORD *)a5 + 3);
  if ( v24 )
  {
