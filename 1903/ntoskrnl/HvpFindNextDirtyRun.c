/*
 * XREFs of HvpFindNextDirtyRun @ 0x140089F8C
 * Callers:
...
char __fastcall HvpFindNextDirtyRun(__int64 a1, unsigned int *a2, unsigned int *a3, unsigned int *a4)
{
  ...
  if ( v13 != v12 && (*v13 | dword_14037C7E0[v4 & 0x1F]) == -1 )
  {
    v11 = v4 - (v4 & 0x1F) + 32;
