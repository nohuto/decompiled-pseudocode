/*
 * XREFs of DrvDbGetDriverFileMappedPropertyKeys @ 0x14093FC6C
 * Callers:
 ...
 *     DrvDbOpenDriverFileRegKey @ 0x140940A24 (DrvDbOpenDriverFileRegKey.c)
 */
        ...
        __int64 a6)
{
  ...
  *(_DWORD *)a6 = 0;
  v10 = a4;
  v11 = a1;
  CompositeMappedPropertyKeys = DrvDbGetCompositeMappedPropertyKeys(a1, (_OWORD **)off_140428118, 1u, a4, a5, v27);
  if ( CompositeMappedPropertyKeys >= 0 )
  {
    ...
    if ( a3 )
      goto LABEL_9;
    CompositeMappedPropertyKeys = DrvDbOpenDriverFileRegKey(v11, a2, v13, 0, (__int64)Handle, 0LL);
    if ( CompositeMappedPropertyKeys >= 0 )
    {
      a3 = Handle[0];
LABEL_9:
