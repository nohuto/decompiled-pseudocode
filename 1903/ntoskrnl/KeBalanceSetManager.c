/*
 * XREFs of KeBalanceSetManager @ 0x14018D570
 * Callers:
 *     <none>
 * Callees:
 ...
 *     ExpScanSystemLookasideList @ 0x1400FF428 (ExpScanSystemLookasideList.c)
...
void __noreturn KeBalanceSetManager()
{
  ...
  Object[1] = (PVOID)(qword_14046A2F8 + 104);
  while ( 1 )
  {
    while ( 1 )
    {
      ...
      if ( !v2 )
        break;
      if ( v2 == 1 )
        MmWorkingSetManager(1LL);
    }
    memset(v17, 0, 0x68uLL);
    VslpEnterIumSecureMode(2, 209LL, 0LL, (__int64)v17);
...
LABEL_9:
    ...
    {
      if ( KiTimelineBitmapTime != (unsigned int)((((MEMORY[0xFFFFF78000000004]
                                                   * (unsigned __int64)MEMORY[0xFFFFF78000000320]) >> 24)
                                                 + ((MEMORY[0xFFFFF78000000004] * HIDWORD(MEMORY[0xFFFFF78000000320])) << 8)) >> 12) )
        KiTimelineBitmapTime = (((MEMORY[0xFFFFF78000000004] * (unsigned __int64)MEMORY[0xFFFFF78000000320]) >> 24)
                              + ((MEMORY[0xFFFFF78000000004] * HIDWORD(MEMORY[0xFFFFF78000000320])) << 8)) >> 12;
    }
  }
