/*
 * XREFs of MmDuplicateMemory @ 0x14059BE8C
 * Callers:
 ...
 *     MiResumeFromHibernate @ 0x140160420 (MiResumeFromHibernate.c)
...
NTSTATUS __fastcall MmDuplicateMemory(__int64 a1)
{
  ...
  if ( result >= 0 )
  {
    ...
    _InterlockedIncrement(&dword_140466950);
...
LABEL_48:
      ...
      if ( v7 == 1 )
      {
        stru_140466228.Parameter = (void *)v5;
        ExQueueWorkItem(&stru_140466228, HyperCriticalWorkQueue);
      }
      else
      {
        _InterlockedAdd(&dword_140466950, 0xFFFFFFFF);
        KeSetEvent(&stru_140466210, 0, 0);
      }
    ...
    MiActOnMirrorBitmap(&qword_140466260, 1LL);
    v24 = 0;
    v23 = 1;
    if ( (v4 & 1) != 0 )
    {
...
LABEL_22:
          ...
          else
          {
            while ( 1 )
            {
              MiActOnMirrorBitmap(&qword_140466250, 2LL);
              if ( v24 == ((v4 & 0xA) == 0) )
              {
                v8 = 1;
                _InterlockedIncrement(&dword_140466828);
              }
              if ( (v4 & 4) != 0 )
              {
                v11 = v5;
              ...
              {
                if ( v8 == 1 )
                  _InterlockedAdd(&dword_140466828, 0xFFFFFFFF);
                dword_14046620C = 0;
                goto LABEL_46;
              }
              if ( v8 == 1 || v21[0] < 0x400 )
...
LABEL_45:
            ...
            if ( *(_QWORD *)(a1 + 24) )
              MiActOnMirrorBitmap(&qword_140466250, 1LL);
            if ( v14 < 2u )
            {
