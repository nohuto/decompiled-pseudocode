/*
 * XREFs of CmpFindControlSet @ 0x14076516C
 * Callers:
...
__int64 __fastcall CmpFindControlSet(ULONG_PTR BugCheckParameter3, __int64 a2, unsigned __int16 *a3, _BYTE *a4)
{
  ...
  *(_QWORD *)&SourceString.Length = 0LL;
  ...
  CmpFindNameInList(BugCheckParameter3, (unsigned int *)(v10 + 36), &DestinationString.Length, 0, 0LL, &v25);
  (*(void (__fastcall **)(ULONG_PTR, _DWORD *))(BugCheckParameter3 + 16))(BugCheckParameter3, v26);
  if ( v25 == -1 )
  {
    *a4 = 1;
  ...
  if ( v11 )
  {
    CmpFindNameInList(BugCheckParameter3, (unsigned int *)(v11 + 36), a3, 0, 0LL, &v25);
    (*(void (__fastcall **)(ULONG_PTR, _DWORD *))(BugCheckParameter3 + 16))(BugCheckParameter3, v26);
    if ( v25 != -1 )
    {
        ...
        if ( v13 )
        {
          ...
          *(_DWORD *)&DestinationString.Length = 0x1000000;
          ...
          if ( v18 )
          {
            ...
            CmpFindNameInList(BugCheckParameter3, (unsigned int *)(v18 + 36), &DestinationString.Length, 0, 0LL, &v24);
            (*(void (__fastcall **)(ULONG_PTR, _DWORD *))(BugCheckParameter3 + 16))(BugCheckParameter3, v26);
            if ( v24 == -1 )
            {
LABEL_23:
