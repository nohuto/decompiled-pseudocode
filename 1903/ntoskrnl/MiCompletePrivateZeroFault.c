/*
 * XREFs of MiCompletePrivateZeroFault @ 0x1400CD960
 * Callers:
...
LABEL_204:
  ...
  {
    v23 = HIBYTE(word_140465BEC);
    goto LABEL_19;
  }
  if ( *(_BYTE *)(((v21 >> 39) & 0x1FF) - 256 + v17 + 4617280) != 1 && (v21 < v7 || v21 > 0xFFFFF6FFFFFFFFFFuLL) )
  {
    if ( v21 > qword_140465EE0 || v21 < qword_1404675B0 )
      v23 = (unsigned __int8)word_140465BEC;
    else
      v23 = HIBYTE(word_140465BEC);
LABEL_19:
    if ( !v23 )
...
LABEL_20:
  ...
  if ( (v16 & 0x40000000) != 0 )
    v24 &= ~4uLL;
  if ( (v16 & 0x20000000) != 0 )
    v24 = ((unsigned __int16)v24 ^ (unsigned __int16)((unsigned __int8)word_140465BEC << 8)) & 0x100 ^ (unsigned __int64)v24;
  if ( (v16 & 0x8000000) != 0 )
    v24 &= ~0x100uLL;
  if ( (v16 & 0x4000000) != 0 )
    v24 |= 0x80uLL;
      ...
      *(_BYTE *)(v31 + 34) = v53;
      ...
      if ( (*(_DWORD *)v5 & 4) != 0 )
      {
        ...
        if ( MiPteInShadowRange(v9) )
        {
          ...
          {
            if ( !HIBYTE(word_140465BEC) && (v103 & 1) != 0 )
