/*
 * XREFs of ViThunkRecoverPristines @ 0x140976744
 * Callers:
 *     VfThunkAddSpecialDriverThunks @ 0x140975E88 (VfThunkAddSpecialDriverThunks.c)
 * Callees:
 *     ViThunkReplacePristine @ 0x140976BDC (ViThunkReplacePristine.c)
 *     ViThunkReplaceSpecialPristine @ 0x140976CB4 (ViThunkReplaceSpecialPristine.c)
 */
