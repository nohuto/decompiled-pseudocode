/*
 * XREFs of RtlpHpLfhBucketUpdateAffinityMapping @ 0x140111FE4
 * Callers:
...
LABEL_34:
      ...
      if ( v31 && ($6EAC78A6FCFADE0A5FA44F358736B38F *)v28->ApcState.ApcListHead[0].Flink != &v28->152 )
        ...
        if ( v44->LockState.0 )
        {
          if ( v44 )
          {
            ...
            if ( (__int64)v44->LockState.LockState < 0 )
              KiAbEntryRemoveFromTree((__int64)&v39->LockEntries[v43]);
...
LABEL_69:
    ...
    if ( v31 && ($6EAC78A6FCFADE0A5FA44F358736B38F *)v39->ApcState.ApcListHead[0].Flink != &v39->152 )
