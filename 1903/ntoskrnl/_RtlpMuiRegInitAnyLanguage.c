/*
 * XREFs of _RtlpMuiRegInitAnyLanguage @ 0x140766834
 * Callers:
 ...
 *     _RtlpMuiRegAddNeutralLanguage @ 0x14076690C (_RtlpMuiRegAddNeutralLanguage.c)
 *     RtlpMuiRegGetOrAddString @ 0x140766934 (RtlpMuiRegGetOrAddString.c)
...
__int64 __fastcall RtlpMuiRegInitAnyLanguage(__int64 a1, __int64 a2, const WCHAR *a3, __int16 a4)
{
  ...
  UNICODE_STRING v14; // [rsp+28h] [rbp-20h] BYREF
