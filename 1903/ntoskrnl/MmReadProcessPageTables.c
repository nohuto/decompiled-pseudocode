/*
 * XREFs of MmReadProcessPageTables @ 0x1402D2028
 * Callers:
...
__int64 __fastcall MmReadProcessPageTables(__int64 a1)
{
  ...
  v3 = ValidPte;
  __wbinvd();
  result = ExTryAcquireSpinLockSharedAtDpcLevel(&dword_140468540);
  v5 = 0;
  if ( (_DWORD)result )
  {
...
LABEL_17:
    ...
    KeFlushSingleCurrentTb(v6, 0);
    ExReleaseSpinLockSharedFromDpcLevel(&dword_140468540);
    return 1LL;
  }
  return result;
}
