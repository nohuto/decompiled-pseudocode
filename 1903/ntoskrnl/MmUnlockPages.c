/*
 * XREFs of MmUnlockPages @ 0x14006A390
 * Callers:
 ...
 *     VmUnlockPages @ 0x140329700 (VmUnlockPages.c)
...
void __stdcall MmUnlockPages(PMDL MemoryDescriptorList)
{
  ...
  do
  {
    ...
    v17 = *(_QWORD *)(qword_140466188 + 8 * ((*(_QWORD *)(v13 + 40) >> 40) & 0x3FFLL));
    v18 = *(_BYTE *)(v13 + 34);
    v54 = v17;
...
LABEL_27:
      ...
      v26 = (v21 >> 40) & 0x3FF;
      v27 = *(_QWORD *)(qword_140466188 + 8 * v26);
      if ( v25 == 1 )
        MiReturnCommit(*(_QWORD *)(qword_140466188 + 8 * v26), 1uLL);
...
LABEL_108:
        ...
        _InterlockedExchangeAdd64(&qword_14046A440, v29);
        goto LABEL_41;
      }
      ...
      while ( 1 )
      {
        ...
        *(_QWORD *)(v32 + 24) = v41;
        ...
        if ( v42 >= 0x10000 )
          break;
        if ( !v34 )
          v34 = *(_QWORD *)(qword_140466188 + 8 * ((*(_QWORD *)(v32 + 40) >> 40) & 0x3FFLL));
        ++v38;
...
LABEL_72:
      if ( v38 )
      {
        if ( (ULONG_PTR *)v34 == &MiSystemPartition )
        {
          ...
          _InterlockedExchangeAdd64(&qword_14046A440, v38);
        }
        else
        {
