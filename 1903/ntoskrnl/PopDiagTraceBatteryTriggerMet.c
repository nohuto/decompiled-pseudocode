/*
 * XREFs of PopDiagTraceBatteryTriggerMet @ 0x1408AD83C
 * Callers:
...
char __fastcall PopDiagTraceBatteryTriggerMet(__int64 a1, __int64 a2, int *a3)
{
  ...
  if ( (unsigned int)*a3 <= 1 )
  {
    ...
    v14 = !v13;
    v29 = v4;
    LOBYTE(v3) = -45 * (dword_14044338C - 12);
    v30 = v11;
    v31 = v12;
    v15 = (dword_14044338C + 500) / 0x3E8u;
    v32 = v14;
    v23 = v6;
    v33 = v6;
    v24 = v7;
    ...
    if ( pCallbackContext.LevelPlus1 > 5 )
    {
      ...
      if ( (_BYTE)v3 )
      {
        ...
        v87 = 4LL;
        v89 = 4LL;
        LOBYTE(v3) = TlgWrite(&pCallbackContext, &unk_14038F76D, 0LL, 0LL, 0xEu, &pData);
      }
    }
  }
  return (char)v3;
