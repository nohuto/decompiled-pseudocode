/*
 * XREFs of CmpDoParseKey @ 0x1405FAD20
 * Callers:
 ...
 *     CmpTransSilentIgnore @ 0x14003FDB0 (CmpTransSilentIgnore.c)
 ...
 *     CmpGetCachedFullKCBName @ 0x14011C6F0 (CmpGetCachedFullKCBName.c)
 ...
 *     CmpRecordParseKcbCacheResult @ 0x1406BCE40 (CmpRecordParseKcbCacheResult.c)
 *     CmpRecordParseStartingKcb @ 0x1406BD1A0 (CmpRecordParseStartingKcb.c)
 *     CmpRecordParseFailure @ 0x1406BD8F0 (CmpRecordParseFailure.c)
 *     CmpCleanupPathInfo @ 0x1406BD9F0 (CmpCleanupPathInfo.c)
 *     CmpRecordParseCachedSymlinkKcb @ 0x1406BDD90 (CmpRecordParseCachedSymlinkKcb.c)
 *     CmRmIsKCBVisible @ 0x1406BE5B0 (CmRmIsKCBVisible.c)
 *     CmpGetComponentHashAtIndex @ 0x1406BEC40 (CmpGetComponentHashAtIndex.c)
 *     CmpLockHashEntrySharedByKcb @ 0x1406CB1C8 (CmpLockHashEntrySharedByKcb.c)
 *     CmpRecordParseWalkResult @ 0x1406CB4C8 (CmpRecordParseWalkResult.c)
...
LABEL_45:
  ...
  *((_QWORD *)&v154 + 1) = v25;
  ...
  v36 = CmpComputeComponentHashes(&v154, v140, v173);
  Child = v36;
  if ( v36 < 0 )
  {
...
LABEL_356:
  ...
  v38 = CmpValidateComponents(v37, v173);
  Child = v38;
  if ( v38 < 0 )
  {
...
LABEL_46:
  ...
  {
    v42 = *(_QWORD *)(v152 + 8);
    started = CmpComputeComponentHashes(&v154, v140, v173);
    Child = started;
    if ( started < 0 )
    {
      v44 = 1280LL;
LABEL_353:
    ...
    started = CmpValidateComponents(v140[0], v173);
    Child = started;
    if ( started < 0 )
    {
      v44 = 1536LL;
...
LABEL_355:
  ...
  {
    ComponentNameAtIndex = CmpGetComponentNameAtIndex(v173, (unsigned int)v12);
      ...
      while ( 1 )
      {
        ...
        if ( (unsigned __int8)CmpIsKeyStackDeleted(v54, v143) )
        {
          if ( CmpLoadingSystemHivesActive
            ...
            && v12 > 0
            && (v64 = CmpGetComponentNameAtIndex(v173, (unsigned int)(v12 - 1)),
        ...
        v55 = CmpGetComponentNameAtIndex(v173, (unsigned int)v12);
        ComponentHashAtIndex = CmpGetComponentHashAtIndex(v173, (unsigned int)v12);
...
LABEL_130:
          ...
          {
            v59 = CmpGetComponentNameAtIndex(v173, (unsigned int)(v12 - 1));
          ...
          {
            v60 = CmpGetComponentNameAtIndex(v173, (unsigned int)v12);
...
LABEL_346:
    ...
    if ( (*(_DWORD *)a7 & 2) != 0 )
    {
      ...
      v72 = CmpGetComponentNameAtIndex(v173, (unsigned int)v71);
      v73 = CmpGetComponentHashAtIndex(v173, (unsigned int)v71);
      v74 = v152;
      v75 = v73;
...
LABEL_175:
      ...
      *(_WORD *)(v84 + 186) &= ~2u;
      v147 = 1;
      KeyBody = CmpCreateKeyBody(BugCheckParameter2, v87, a7, v143, 0, (ULONG_PTR **)&Object, v139);
      Child = KeyBody;
      if ( KeyBody < 0 )
      {
...
LABEL_212:
    ...
    if ( (*(_DWORD *)a7 & 0x20) != 0 )
    {
      ...
      v95 = CmpGetComponentNameAtIndex(v173, (unsigned int)v71);
      v94 = v138;
      ...
      *(_DWORD *)(BugCheckParameter2 + 96) = *(_DWORD *)(a7 + 56);
      Child = CmpCreateKeyBody(BugCheckParameter2, v94, a7, v143, 1, (ULONG_PTR **)&Object, v139);
      v11 = v69;
      if ( Child < 0 )
        goto LABEL_345;
      if ( (unsigned __int8)CmpIsKeyStackDeleted(v54, v143) )
    ...
    if ( !(unsigned __int8)CmpIsKeyStackDeleted(v54, v143) )
    {
      ...
      v125 = CmpCreateKeyBody(BugCheckParameter2, v94, a7, v143, 0, (ULONG_PTR **)&Object, v139);
      Child = v125;
      v11 = v69;
      if ( v125 < 0 )
      {
        CmpRecordParseFailure(a7, 15552LL, (unsigned int)v125);
        goto LABEL_345;
      }
      goto LABEL_212;
    }
    ...
    if ( (*(_DWORD *)a7 & 1) == 0 )
    {
      if ( CmpLoadingSystemHivesActive
        ...
        && *(PVOID *)(BugCheckParameter2 + 32) == CmpMasterHive
        && (*(_DWORD *)(BugCheckParameter2 + 8) & 0x7FE00000) == 0x600000
        && (v96 = CmpGetComponentNameAtIndex(v173, (unsigned int)v71),
      ...
      && (struct _KTHREAD *)CmpMountThread != KeGetCurrentThread() )
    {
      if ( CmpLoadingSystemHivesActive
        && (*(_DWORD *)(BugCheckParameter2 + 8) & 0x7FE00000) == 0x600000
        && (v97 = CmpGetComponentNameAtIndex(v173, (unsigned int)v71),
    ...
    v98 = (const UNICODE_STRING *)CmpGetComponentNameAtIndex(v173, (unsigned int)v71);
    v99 = v157;
    LOBYTE(v100) = 1;
    v101 = (int)v98;
    ...
    if ( (unsigned __int8)CmpIsKeyStackDeleted(v54, v143) )
    {
      ...
      v110 = CmpCreateKeyBody(BugCheckParameter2, v94, a7, v143, 1, (ULONG_PTR **)&Object, v139);
      Child = v110;
      if ( v110 < 0 )
      {
    ...
    if ( !(unsigned __int8)CmpIsKeyStackSymlink(v54) || (*(_DWORD *)a7 & 0x200) != 0 )
    {
      ...
      if ( (*(_DWORD *)(a7 + 24) & 2) == 0 )
      {
        ...
        v118 = CmpCreateKeyBody(BugCheckParameter2, v94, a7, v143, 1, (ULONG_PTR **)&Object, v139);
        Child = v118;
        if ( v118 < 0 )
        {
...
LABEL_282:
    ...
    else
    {
      if ( (*(_DWORD *)(a7 + 24) & 2) == 0 )
      {
        ...
        v113 = CmpGetSymbolicLinkTarget((_DWORD)v54, (unsigned int)v173, 0, 0, v143, a7, (__int64)v161, v99, a7 + 88);
        Child = v113;
        if ( v113 >= 0 )
        {
          *(_DWORD *)a7 &= ~8u;
