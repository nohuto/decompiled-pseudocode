/*
 * XREFs of MiMirrorGatherBrownPages @ 0x1401600F4
 * Callers:
...
LABEL_20:
  KeAcquireInStackQueuedSpinLock(&qword_14046A5A0, &LockHandle);
  v14 = (__int64 *)&unk_140468F50;
  do
  {
  ...
  while ( v8 );
  for ( j = qword_140468F10; j != 0xFFFFFFFFFLL; j = *v24 & 0xFFFFFFFFFLL )
  {
