/*
 * XREFs of MiMirrorPerformBrownWrites @ 0x14015FB5C
 * Callers:
...
__int64 __fastcall MiMirrorPerformBrownWrites(__int64 a1, char a2, _QWORD *a3)
{
  ...
  while ( 1 )
  {
    v8 = v4 & -(__int64)(v4 < qword_140466250);
    for ( i = qword_140466250 - 1; i - v8 == -1LL; i = v21 - 1 )
    {
      v12 = -1LL;
LABEL_44:
      if ( !v8 )
      ...
      v21 = v4 + 1;
      v8 = 0LL;
      if ( v4 + 1 > qword_140466250 )
        v21 = qword_140466250;
    }
    v10 = (_QWORD *)(qword_140466258 + 8 * (v8 >> 6));
    for ( j = ((1LL << (v8 & 0x3F)) - 1) | ~*v10; j == -1; j = ~*v10 )
    {
      if ( (unsigned __int64)++v10 > qword_140466258 + 8 * (i >> 6) )
        goto LABEL_41;
    }
    _BitScanForward64((unsigned __int64 *)&j, ~j);
    v12 = j + (((__int64)v10 - qword_140466258) >> 3 << 6);
    if ( v12 > i )
    {
LABEL_41:
      v12 = -1LL;
...
LABEL_10:
    if ( v12 < v4 || v12 == -1LL )
      goto LABEL_30;
    if ( qword_140466250 > v12 )
    {
      v13 = v12;
      v14 = qword_140466258 + 4 * ((unsigned __int64)(qword_140466250 - 1) >> 5);
      v15 = (_DWORD *)(qword_140466258 + 4 * (v12 >> 5));
      if ( v15 != (_DWORD *)v14 && (*v15 | dword_14037C7E0[v12 & 0x1F]) == -1 )
      {
        v13 = (v12 & 0xFFFFFFFFFFFFFFE0uLL) + 32;
        for ( ++v15; (unsigned __int64)v15 < v14 && *v15 == -1; ++v15 )
          v13 += 32LL;
      }
      while ( v13 < qword_140466250 && _bittest64((const signed __int64 *)qword_140466258, v13) )
        ++v13;
      v16 = 0LL;
      if ( v15 != (_DWORD *)v14 && (*v15 & ~dword_14037C7E0[v13 & 0x1F]) == 0 )
      {
        v16 = 32 - (v13 & 0x1F);
        if ( v16 == -1 )
          goto LABEL_24;
      ...
      for ( k = v16 + v13; k < qword_140466250; ++v16 )
      {
        if ( _bittest64((const signed __int64 *)qword_140466258, k) )
          break;
        if ( v16 == -1 )
          break;
        ++k;
...
LABEL_25:
    ...
    v22 = v12 & 0x1F;
    v23 = v18;
    v24 = (volatile signed __int32 *)(qword_140466268 + 4 * (v12 >> 5));
    if ( v22 + v18 <= 0x20 )
    {
      if ( v18 == 32 )
      {
...
LABEL_29:
  ...
  while ( 1 )
  {
    ...
    *(_QWORD *)v31 &= 0xC000000000000000uLL;
    ...
    v34 = v4 & 0x1F;
    LOBYTE(v35) = 1;
    v36 = (volatile signed __int32 *)(qword_140466268 + 4 * (v4 >> 5));
    if ( v34 + 1 > 0x20 )
    {
      if ( (v4 & 0x1F) != 0 )
      {
...
LABEL_26:
  v6 += v18;
  v51 = v6;
  v49 = (*(__int64 (__fastcall **)(unsigned __int64, unsigned __int64))(a1 + 16))(v12 << 12, v18 << 12);
  v3 = v49;
  if ( v50 )
  {
    ...
    do
    {
      ...
      MiRemoveLockedPageChargeAndDecRef(v42, v45, v46, v47);
