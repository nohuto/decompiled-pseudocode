/*
 * XREFs of MiFillPageWithImageExtentContents @ 0x1402CBB74
 * Callers:
 *     MiCopyImageExtentContents @ 0x1402CB23C (MiCopyImageExtentContents.c)
 *     MiCopyFromDirectMapExtent @ 0x14088C8D0 (MiCopyFromDirectMapExtent.c)
 * Callees:
...
LABEL_74:
    ...
    if ( !HIBYTE(word_140465BEC) && (v38 & 1) != 0 )
      v38 |= 0x8000000000000000uLL;
    *v11 = v38;
    MiWritePteShadow((__int64)v11);
LABEL_75:
