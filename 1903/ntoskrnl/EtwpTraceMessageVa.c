/*
 * XREFs of EtwpTraceMessageVa @ 0x14008BFF0
 * Callers:
 *     NtTraceEvent @ 0x14008C650 (NtTraceEvent.c)
 *     WmiTraceMessage @ 0x140139780 (WmiTraceMessage.c)
 *     WmiTraceMessageVa @ 0x14032CB10 (WmiTraceMessageVa.c)
 * Callees:
...
LABEL_14:
  ...
  v29 = EtwpReserveTraceBuffer(v13, v28, (unsigned int)v62, (unsigned int)&v57, 0);
  v30 = 0;
  v31 = v59;
...
LABEL_78:
  ...
  {
    ReserveTraceBufferStatus = EtwpGetReserveTraceBufferStatus(v31, v67, v33);
    v43 = ReserveTraceBufferStatus;
    v11 = v47;
    v10 = v49;
  }
