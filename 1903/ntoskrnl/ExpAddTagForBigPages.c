/*
 * XREFs of ExpAddTagForBigPages @ 0x140036B90
 * Callers:
        ...
        char a6)
{
  ...
  while ( 1 )
  {
    while ( 1 )
    {
      ...
      if ( v8 )
      {
        v16 = *(_QWORD *)(qword_1404659D8 + 1272);
        v17 = (volatile signed __int32 *)(qword_1404659D8 + 1144);
        v18 = *(_QWORD *)(qword_1404659D8 + 1280);
      }
      else
      {
