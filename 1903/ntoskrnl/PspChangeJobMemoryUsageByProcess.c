/*
 * XREFs of PspChangeJobMemoryUsageByProcess @ 0x1406AF6C0
 * Callers:
...
char __fastcall PspChangeJobMemoryUsageByProcess(char a1, __int64 a2, __int64 a3, __int64 a4)
{
  ...
  $6EAC78A6FCFADE0A5FA44F358736B38F *v25; // rcx
  __int64 v26; // rax
  __int64 i; // rdi
...
LABEL_32:
  ...
  if ( CurrentThread )
  {
    if ( CurrentThread->SpecialApcDisable++ == -1 )
    {
      ...
      if ( ($6EAC78A6FCFADE0A5FA44F358736B38F *)v25->ApcState.ApcListHead[0].Flink != v25 )
