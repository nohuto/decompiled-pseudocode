/*
 * XREFs of SepAdjustAccessStateForConstraints @ 0x1406D54F0
 * Callers:
 *     CmpSetAccessStateForBackupRestore @ 0x1406D5424 (CmpSetAccessStateForBackupRestore.c)
 *     SeAdjustAccessStateForTrustLabel @ 0x1408DAB20 (SeAdjustAccessStateForTrustLabel.c)
 * Callees:
 *     SepLocateTokenTrustLevel @ 0x14000AC44 (SepLocateTokenTrustLevel.c)
 *     SeGetTrustLabelAce @ 0x14000C490 (SeGetTrustLabelAce.c)
