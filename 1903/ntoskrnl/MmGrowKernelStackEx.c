/*
 * XREFs of MmGrowKernelStackEx @ 0x140135DE0
 * Callers:
 ...
 *     MmGrowKernelStack @ 0x1402C4810 (MmGrowKernelStack.c)
 * Callees:
...
__int64 __fastcall MmGrowKernelStackEx(__int64 a1, __int64 a2)
{
  ...
  if ( *(_QWORD *)(CurrentThread + 56) - (*(_QWORD *)(*(_QWORD *)(CurrentThread + 40) + 8LL) & 0xFFFFFFFFFFFFFFFEuLL) < 0x12000 )
    return 3221225659LL;
  v3 = 0;
  v4 = *(_QWORD *)(qword_140466188 + 8LL * *(unsigned __int16 *)(*(_QWORD *)(CurrentThread + 544) + 1454LL));
