/*
 * XREFs of MiGenerateAccessViolation @ 0x1402D285C
 * Callers:
...
_BOOL8 __fastcall MiGenerateAccessViolation(unsigned __int64 *a1)
{
  ...
  if ( (unsigned int)MiDeterminePoolType(*a1) == 32 )
    return 0LL;
  v2 = (_QWORD **)&unk_1404644F8;
  v3 = ExAcquireSpinLockShared(&dword_1404644F0);
  while ( 1 )
  {
    v4 = *v2;
    while ( v4 )
...
LABEL_14:
  ExReleaseSpinLockSharedFromDpcLevel(&dword_1404644F0);
