/*
 * XREFs of PpmApplyProfile @ 0x1408B6A84
 * Callers:
 *     PdcPoPpmApplyProfile @ 0x1408AB820 (PdcPoPpmApplyProfile.c)
 * Callees:
 ...
 *     PpmEndProfileAccumulation @ 0x1408B6CF8 (PpmEndProfileAccumulation.c)
