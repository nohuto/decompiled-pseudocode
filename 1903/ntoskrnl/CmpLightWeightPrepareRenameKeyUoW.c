/*
 * XREFs of CmpLightWeightPrepareRenameKeyUoW @ 0x14083DEB0
 * Callers:
...
LABEL_27:
    ...
    v14 = CmpCopyCell(v4, *(unsigned int *)(*(_QWORD *)(a1 + 48) + 40LL), v4, v2);
    if ( v14 == -1 )
    {
      v9 = -1073741670;
LABEL_26:
    ...
    if ( v15[3] == -1 )
    {
      ...
      Cell = HvAllocateCell(v4, 12, (unsigned int)v2, (__int64)&v25, (__int64)&v31);
      v15[3] = Cell;
      if ( Cell == -1 )
        goto LABEL_15;
      v17 = v25;
