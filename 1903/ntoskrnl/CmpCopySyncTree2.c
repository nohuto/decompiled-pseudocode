/*
 * XREFs of CmpCopySyncTree2 @ 0x140836060
 * Callers:
        ...
        int a7)
{
  ...
  _QWORD v76[8]; // [rsp+C8h] [rbp-1h] BYREF
      ...
      while ( 1 )
      {
        ...
        if ( v78 && a7 != 2 )
        {
          ...
          if ( *(_DWORD *)(v24 + 20) + *(_DWORD *)(v24 + 24) > (unsigned int)(v11[5] + v27) )
            CmpSyncSubKeysAfterDelete(a4, v11, BugCheckParameter2, v24, v8);
...
LABEL_26:
    ...
    if ( !v16 )
      goto LABEL_89;
    CmpInitializeKeyNameString(v16, v76, v8);
    ...
    if ( !v18 )
      goto LABEL_89;
    CmpFindSubKeyByNameWithStatus(BugCheckParameter2, v18, (unsigned __int16 *)v76, &v72);
    v19 = v72;
