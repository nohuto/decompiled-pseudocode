/*
 * XREFs of IopKeepAliveWorker @ 0x140299E90
 * Callers:
 *     <none>
 * Callees:
...
void IopKeepAliveWorker()
{
  ...
  v0 = KeAcquireSpinLockRaiseToDpc(&qword_140461B10);
  qword_140461B40 = (__int64)KeGetCurrentThread();
LABEL_2:
  v1 = v0;
  while ( 1 )
  {
    v2 = qword_140461B00;
    if ( qword_140461B00 == &qword_140461B00 )
      break;
    v3 = *((_DWORD *)qword_140461B00 + 8);
    *((_DWORD *)qword_140461B00 + 8) = 0;
    if ( v3 )
    {
      KeReleaseSpinLock(&qword_140461B10, v1);
      if ( v3 > 0 )
      {
        do
        {
      ...
      if ( (v11 & 0x7FFFFFFF) == 1 )
      {
        v12 = KeAcquireSpinLockRaiseToDpc(&qword_140461B10);
        if ( MEMORY[0xFFFFF78000000014] >= *((_QWORD *)v2 + 6) )
        {
          KeReleaseSpinLock(&qword_140461B10, v12);
          LOBYTE(v7) = *((_BYTE *)v2 + 18);
          v10 = *((_QWORD *)v2 + 3);
          goto LABEL_21;
        }
