/*
 * XREFs of PspApplyTimerDelayProcess @ 0x140307C44
 * Callers:
...
__int64 __fastcall PspApplyTimerDelayProcess(__int64 a1, _DWORD *a2, __int64 a3)
{
  ...
  v11 = _InterlockedCompareExchange64((volatile signed __int64 *)(a1 + 2032), v10, v7 & 0x7FFFFFFFFFFFFFFFLL);
  if ( v12 != v11 )
  {
    do
    {
      ...
      v11 = _InterlockedCompareExchange64((volatile signed __int64 *)(a1 + 2032), v10, v11);
    }
    while ( v11 != v13 );
  }
  if ( (v10 & 0x4000000000000000LL) == 0 )
  {
    do
    {
      ...
      v10 = _InterlockedCompareExchange64((volatile signed __int64 *)(a1 + 2032), v10 & 0x1FFFFFFFFFFFFFFFLL, v10);
    }
    while ( v14 != v10 );
  }
LABEL_22:
