/*
 * XREFs of EtwpDequeueBufferPendingCompression @ 0x14033389C
 * Callers:
 ...
 *     EtwpDequeueBufferPendingCompressionFromQueue @ 0x140333990 (EtwpDequeueBufferPendingCompressionFromQueue.c)
