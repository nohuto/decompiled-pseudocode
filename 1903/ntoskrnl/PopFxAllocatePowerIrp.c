/*
 * XREFs of PopFxAllocatePowerIrp @ 0x140173A60
 * Callers:
        ...
        _QWORD *a8)
{
  ...
  *a8 = 0LL;
  ...
  if ( v14 )
  {
    ...
    {
      v16 = IoAcquireRemoveLockEx((PIO_REMOVE_LOCK)(v14 + 232), 0LL, &Src, 1u, 0x20u);
      if ( v16 < 0 )
      {
LABEL_13:
        v15 = v25;
    ...
    if ( v18 )
    {
      ...
      {
        _m_prefetchw((const void *)(v14 + 32));
        v21 = _InterlockedOr((volatile signed __int32 *)(v14 + 32), 0) & 0x200;
        _InterlockedOr((volatile signed __int32 *)(v14 + 32), 0x20u);
        _InterlockedXor((volatile signed __int32 *)(v14 + 32), 0x200u);
        v16 = 259;
        *(_QWORD *)((v21 != 0 ? 8 : 0) + v14 + 504) = a2;
        *(_DWORD *)((v21 != 0 ? 4 : 0) + v14 + 520) = a3;
        *(_QWORD *)((v21 != 0 ? 8 : 0) + v14 + 528) = a4;
        *(_QWORD *)((v21 != 0 ? 8 : 0) + v14 + 544) = a5;
      }
    }
    else if ( (v19 & 0x10) == 0 )
    {
      ...
      if ( (_InterlockedOr((volatile signed __int32 *)(v14 + 32), 0) & 0x20) != 0 )
      {
        ...
        if ( _InterlockedExchangeAdd((volatile signed __int32 *)(v14 + 236), 0xFFFFFFFF) == 1 )
          KeSetEvent((PRKEVENT)(v14 + 240), 0, 0);
      }
      else
      {
        _InterlockedOr((volatile signed __int32 *)(v14 + 32), 0x10u);
        KeResetEvent((PRKEVENT)(v14 + 560));
        v16 = 0;
        *a7 = *(_QWORD *)(v14 + 16);
        *a8 = *(_QWORD *)(v14 + 24);
      }
