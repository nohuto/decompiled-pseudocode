/*
 * XREFs of ExInitializePagedLookasideListInternal @ 0x1400E5D80
 * Callers:
        ...
        int a8)
{
  ...
  *(_QWORD *)(a1 + 80) = 0LL;
  ...
  v13 = (_QWORD *)qword_14042F588;
  v14 = (_QWORD *)(a1 + 64);
  if ( *(__int64 **)qword_14042F588 != &ExPagedLookasideListHead )
    __fastfail(3u);
  *v14 = &ExPagedLookasideListHead;
  v14[1] = v13;
  *v13 = v14;
  qword_14042F588 = (__int64)v14;
