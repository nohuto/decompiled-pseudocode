/*
 * XREFs of PdcPoQueryExpectedStandbyTime @ 0x1408AB890
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall PdcPoQueryExpectedStandbyTime(unsigned __int64 *a1)
{
  ...
  if ( (unsigned int)result <= 1 || PopPdcLastCsEnterReason == 12 )
  {
    ...
    if ( dword_140442F6C == -1 || dword_140442F68 >= (unsigned int)dword_140442F6C )
    {
      if ( ((dword_140442F6C + 1) & 0xFFFFFFFE) == 0 )
        v1 = -1LL;
    }
    else
    {
      v1 = (unsigned int)PopIdleScanInterval + (unsigned __int64)(unsigned int)(dword_140442F6C - dword_140442F68);
    }
