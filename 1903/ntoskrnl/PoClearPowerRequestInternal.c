/*
 * XREFs of PoClearPowerRequestInternal @ 0x1400EC820
 * Callers:
  ...
  *(_DWORD *)(a1 + 4 * v2 + 32) = v9;
  if ( ((1 << v2) & *(_DWORD *)(a1 + 24)) == 0 && !v9 )
  {
    ...
    if ( (v2 & 0xFFFFFFFC) == 0 && (_DWORD)v2 != 2 || !v10 )
    {
      ...
      PopQueuePowerRequestCallback(a1, (unsigned int)v2, 0LL, v8, LockHandle.LockQueue.Next, LockHandle.LockQueue.Lock);
    }
