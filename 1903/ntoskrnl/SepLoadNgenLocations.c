/*
 * XREFs of SepLoadNgenLocations @ 0x140780F2C
 * Callers:
...
__int64 __fastcall SepLoadNgenLocations(__int64 a1)
{
  ...
  __int64 KeyValueInformation; // [rsp+90h] [rbp-11h] BYREF
  __int64 v31; // [rsp+98h] [rbp-9h]
  _DWORD KeyInformation[12]; // [rsp+A0h] [rbp-1h] BYREF
...
LABEL_39:
  ...
  else
  {
    ...
    if ( v3 >= 0 && KeyInformation[8] && (unsigned int)(KeyInformation[9] - 1) <= 0xFFFE )
    {
      v4 = 0;
      v5 = 0;
      v6 = 0;
      while ( 1 )
      {
        ...
        if ( ((v3 + 0x80000000) & 0x80000000) == 0 && v3 != -2147483643 )
          break;
        if ( HIDWORD(KeyValueInformation) == 4 && (unsigned int)v31 >= 2 )
        {
          v5 += v31 + 16;
          if ( v5 < (int)v31 + 16 )
            goto LABEL_44;
...
LABEL_44:
          ...
          v3 = 0;
          Length = KeyInformation[9] + 16;
          PoolWithTag = ExAllocatePoolWithTag(PagedPool, (unsigned int)(KeyInformation[9] + 16), 0x63734943u);
          if ( PoolWithTag )
          {
