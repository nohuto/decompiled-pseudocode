/*
 * XREFs of MiMakePageAvoidRead @ 0x14006C650
 * Callers:
        ...
        _DWORD *a7)
{
  ...
  *a7 = 0;
  ...
  v149 = v8 >> 16;
  v155 = *(_QWORD *)(v8 >> 16);
  v9 = *(_QWORD *)(qword_140466188 + 8LL * (*(_WORD *)(v155 + 60) & 0x3FF));
  ...
  else
  {
    ...
    NodeShiftedColor = (v11 - 1) << byte_140465A4D;
  }
  v14 = (1 << byte_140465A4E) - 1;
  ...
  v26 = MiReservePtes((__int64)&qword_1404669C0, (unsigned __int64 *)v21);
  v168 = v26;
  if ( v26 )
  {
...
LABEL_31:
    *(_QWORD *)v26 = v27;
    ...
    memmove(v32, Src, v33);
    MiReleasePtes((__int64)&qword_1404669C0, v26, 1u);
LABEL_36:
...
LABEL_49:
      ...
      v49 = *(ULONG_PTR **)(qword_140466188 + 8 * ((v44 >> 40) & 0x3FF));
      if ( v47 )
      {
...
LABEL_131:
            ...
            v100 = *(_QWORD *)(qword_140466188 + 8 * ((v94 >> 40) & 0x3FF));
            if ( v99 == 1 )
            ...
            if ( (ULONG_PTR *)v100 == &MiSystemPartition )
            {
              ...
              _InterlockedExchangeAdd64(&qword_14046A440, v101);
            }
            else
            {
...
LABEL_132:
      ...
      {
        v86 = 1LL;
        if ( HIBYTE(word_140465BEC) || (v84 & 1) == 0 )
          goto LABEL_105;
      }
      else if ( (KeGetCurrentThread()->ApcState.Process[2].ActiveProcessors.Bitmap[4] & 0x100000000000LL) == 0
             || (v84 & 1) == 0 )
