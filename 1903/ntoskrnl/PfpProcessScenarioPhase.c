/*
 * XREFs of PfpProcessScenarioPhase @ 0x140744520
 * Callers:
    ...
    if ( v3 == 4 )
    {
      ...
      if ( v8 )
      {
        if ( v8 == 1 )
        {
          ...
          {
            PfpScenCtxScenarioSet((ULONG_PTR)&qword_140467B60, 4, 0, 0LL);
            if ( dword_140467818 < (unsigned int)dword_14046781C )
              PfpLogScenarioEvent(5, 2, 3, dword_140467B94, 1);
          }
        }
        return v5;
      }
...
LABEL_4:
  ...
  if ( v12 )
  {
    if ( v12 != 1 || dword_140467B90 != 3 )
      return v5;
    PfpScenCtxPrefetchWait((ULONG_PTR)&qword_140467B60, 3, 0x1388u);
    PfpLogScenarioEvent(3, 0, 0, dword_140467B94, 0);
    v10 = 0LL;
    v13 = 3;
    v11 = 0;
LABEL_33:
    PfpScenCtxScenarioSet((ULONG_PTR)&qword_140467B60, v13, v11, v10);
    return v5;
  }
  v14 = RtlGetActiveConsoleId();
  if ( (unsigned int)PsGetCurrentProcessSessionId() == v14 && dword_140467818 < (unsigned int)dword_14046781C )
  {
    v15 = 0;
