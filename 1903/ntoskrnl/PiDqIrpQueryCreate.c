/*
 * XREFs of PiDqIrpQueryCreate @ 0x1405B69F8
 * Callers:
 ...
 *     PiDqQueryGetNextIoctlInfo @ 0x1405B60C0 (PiDqQueryGetNextIoctlInfo.c)
 ...
 *     PnpConvertDevpropcompkeyArrayToString @ 0x140861F7C (PnpConvertDevpropcompkeyArrayToString.c)
 *     PiDqConvertObjectTypeToString @ 0x140865228 (PiDqConvertObjectTypeToString.c)
 *     PiDqConvertQueryFlagsToString @ 0x1408652F0 (PiDqConvertQueryFlagsToString.c)
 *     FilterConvertToString @ 0x140943498 (FilterConvertToString.c)
 */
  ...
  else
  {
    if ( CurrentStackLocation->Parameters.Read.Length >= 0x10 )
    {
      ...
      if ( ValidateQueryData < 0 )
        goto LABEL_13;
      v10 = (void **)(v3 + 24);
      NdrMesTypeDecode3(*(_QWORD *)(v3 + 16), "TP 3\a", &off_14036F1A0, &off_140425530, 0, v3 + 24);
