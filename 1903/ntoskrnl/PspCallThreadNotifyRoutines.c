/*
 * XREFs of PspCallThreadNotifyRoutines @ 0x1405EB7B0
 * Callers:
    ...
    if ( a3 )
    {
      if ( (PspNotifyEnableMask & 0x10) != 0 )
      {
        ...
        do
        {
          ...
          {
            if ( (v17[2].Count & 1) != 0 )
              ((void (__fastcall *)(_QWORD, _QWORD, _QWORD))v17[1].Count)(*(_QWORD *)(a1[68] + 744LL), a1[202], a2);
      ...
      do
      {
        ...
        if ( v8 )
        {
          ...
          if ( (Count & 1) == 0 && (!v5 || (Count & 2) != 0) )
            ((void (__fastcall *)(_QWORD, _QWORD, _QWORD))v9[1].Count)(*(_QWORD *)(a1[68] + 744LL), a1[202], a2);
    ...
    do
    {
      ...
      if ( v13 )
      {
        if ( !v5 || (v13[2].Count & 2) != 0 )
          ((void (__fastcall *)(_QWORD, _QWORD, _QWORD))v13[1].Count)(*(_QWORD *)(a1[68] + 744LL), a1[202], 0LL);
