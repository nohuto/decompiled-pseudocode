/*
 * XREFs of FsRtlIsHpfsDbcsLegal @ 0x14084FBC0
 * Callers:
 *     FsRtlIsHpfsDbcsLegal @ 0x14084FBC0 (FsRtlIsHpfsDbcsLegal.c)
 * Callees:
      ...
      else
      {
        ...
        if ( Length )
        {
          do
          {
            ...
            {
              if ( (v12 & 0x80u) == 0 )
                v13 = (WildCardsPermissible != 0 ? 10 : 2) & byte_14037C8B0[(unsigned __int8)v8[v11]];
              else
                v13 = 1;
              if ( !v13 )
                return 0;
