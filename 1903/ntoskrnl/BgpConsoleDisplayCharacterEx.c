...
__int64 BgpConsoleDisplayCharacterEx(unsigned __int16 a1, unsigned int a2, unsigned int a3, int a4, int a5, ...)
{
  ...
  if ( a2 > 0x50 )
    return 3221225485LL;
  v7 = qword_1404F2AD8;
  if ( a3 > *(_DWORD *)(qword_1404F2AD8 + 4) )
    return 3221225485LL;
  v8 = (int *)(qword_1404F2AD8 + 68);
  v9 = 0;
  v10 = (_DWORD *)(qword_1404F2AD8 + 60);
  v11 = (_DWORD *)(qword_1404F2AD8 + 48);
...
LABEL_22:
    ...
    v9 = BgpDisplayCharacterEx(
           ...
           *(_DWORD *)(qword_1404F2AD8 + 60) + *v11 * *v8,
    ...
    if ( v9 >= 0 )
    {
      ...
      v7 = qword_1404F2AD8;
      *(_WORD *)(qword_1404F2AD8 + 4 * v12 + 88) = a1;
  ...
  if ( v16 >= 5 || (v12 = v16) != 0 )
  {
    ...
    do
    {
      ...
      if ( v19 >= 0 )
      {
        v12 = (unsigned int)v8[1] + 25LL * (unsigned int)*v8;
        v20 = 3 * v12;
        *(_WORD *)(qword_1404F2AD8 + 4 * v20 + 88) = 32;
