/*
 * XREFs of KseRegisterShimEx @ 0x1407593A0
 * Callers:
 ...
 *     KsepIsShimRegistered @ 0x14075954C (KsepIsShimRegistered.c)
 *     KsepValidateShimProviderAndData @ 0x1407595C0 (KsepValidateShimProviderAndData.c)
...
__int64 __fastcall KseRegisterShimEx(__int64 a1, __int64 a2, int a3, __int64 a4)
{
  ...
  if ( LoadedModulesList >= 0 )
  {
    if ( (unsigned int)KsepValidateShimProviderAndData(retaddr, v18, a1) )
    {
      ...
      if ( Paged )
      {
        ...
        if ( (unsigned int)KsepIsShimRegistered(&KseEngine, *(_QWORD *)(a1 + 8), v10, 0LL) )
        {
          ...
          dword_140446844[2 * v16] = -1073741771;
        ...
        else
        {
          ...
          *((_DWORD *)Paged + 7) = a3;
          Paged[4] = a4;
          v11 = (_QWORD *)qword_140468438;
          if ( *(_UNKNOWN **)qword_140468438 != &unk_140468430 )
            __fastfail(3u);
          *Paged = &unk_140468430;
          Paged[1] = v11;
          *v11 = Paged;
          qword_140468438 = (__int64)Paged;
          v12 = _InterlockedExchangeAdd64((volatile signed __int64 *)&qword_140468450, 0xFFFFFFFFFFFFFFFFuLL);
          if ( (v12 & 2) != 0 && (v12 & 4) == 0 )
            ExfTryToWakePushLock((volatile signed __int64 *)&qword_140468450);
          KeAbPostRelease((ULONG_PTR)&qword_140468450);
          KeLeaveCriticalRegionThread((__int64)KeGetCurrentThread());
          LoadedModulesList = 0;
          *(_QWORD *)(a1 + 24) = &unk_140468458;
    ...
    else
    {
      ...
      dword_140446844[2 * v15] = -1073741823;
