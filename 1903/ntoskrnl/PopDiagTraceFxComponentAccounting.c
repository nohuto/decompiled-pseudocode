/*
 * XREFs of PopDiagTraceFxComponentAccounting @ 0x1408AF390
 * Callers:
...
void __fastcall PopDiagTraceFxComponentAccounting(__int64 a1, int a2, __int64 a3, unsigned __int16 *a4, char a5)
{
  ...
  *(_QWORD *)&v19.Length = 0LL;
  ...
  RtlInitUnicodeString(&v19, &word_14078CDD0);
      ...
      *(_QWORD *)&UserData.Size = 1LL;
      ...
      if ( *(_DWORD *)(a3 + 12) != -1 )
      {
        ...
        if ( pCallbackContext.LevelPlus1 > 5 && TlgKeywordOn(&pCallbackContext, 0x400000000000uLL) )
        {
          ...
          v55 = 2LL;
          v57[1] = 0;
          TlgWrite(&pCallbackContext, &unk_140390C44, 0LL, 0LL, 0x10u, &pData);
        }
        if ( v9 )
