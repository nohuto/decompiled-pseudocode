/*
 * XREFs of PopDiagTraceIrpFinishTelemetry @ 0x1401724F0
 * Callers:
      ...
      if ( (unsigned int)(v8 / 0x2710) >= 0x1388 )
      {
        ...
        if ( pCallbackContext.LevelPlus1 > 5 )
        {
          ...
          if ( (_BYTE)UnbiasedInterruptTime )
          {
            ...
            v43 = 4LL;
            v45 = 8LL;
            LOBYTE(UnbiasedInterruptTime) = TlgWrite(&pCallbackContext, &unk_140391050, 0LL, 0LL, 0xBu, &pData);
          }
        }
      }
    }
  ...
  if ( !*(_BYTE *)(v4 + 184) && pCallbackContext.LevelPlus1 > 5 )
  {
    ...
    if ( (_BYTE)UnbiasedInterruptTime )
    {
      ...
      *(_QWORD *)&pDesc.Size = 1LL;
      v37 = 1LL;
      v39 = 4LL;
      LOBYTE(UnbiasedInterruptTime) = TlgWrite(&pCallbackContext, &unk_140390FDE, 0LL, 0LL, 8u, &pData);
    }
  }
