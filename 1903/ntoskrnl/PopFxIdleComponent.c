...
__int64 __fastcall PopFxIdleComponent(ULONG_PTR BugCheckParameter2, ULONG_PTR BugCheckParameter3, __int64 a3)
{
  unsigned int v3; // esi
  char v4; // bp
  __int64 v6; // r11
  ...
  {
    InterruptTimePrecise = RtlGetInterruptTimePrecise(v10, BugCheckParameter3, a3);
  ...
  {
    if ( !v6 )
      v6 = RtlGetInterruptTimePrecise(v10, BugCheckParameter3, a3);
    if ( (*(_DWORD *)(v7 + 92) & 2) == 0
      && !PopFxLowPowerEpoch
