/*
 * XREFs of PopPlRegisterComponent @ 0x140191878
 * Callers:
 ...
 *     PopPlLookupComponentPowerProfile @ 0x1403050D4 (PopPlLookupComponentPowerProfile.c)
 */
...
void __fastcall PopPlRegisterComponent(__int64 a1, __int64 a2, __int64 a3, ULONG a4)
{
  ...
  if ( pCallbackContext.LevelPlus1 > 5 )
  {
    ...
    v32 = v8;
    v33[0] = v7;
    TlgWriteEx(&pCallbackContext, &unk_1403918F6, 2uLL, a4, v11, v12, 8u, &pData);
  }
}
