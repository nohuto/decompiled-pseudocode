/*
 * XREFs of MiHyperPage @ 0x1400DD8BC
 * Callers:
...
__int64 __fastcall MiHyperPage(__int64 a1)
{
  ...
  v1 = (((unsigned __int64)qword_1404675B0 >> 9) & 0x7FFFFFFFF8LL) - 0x98000000000LL;
  v2 = 0;
  v3 = *(_QWORD *)(a1 + 8) | 0x8000000000000000uLL;
  v4 = 0;
  while ( v3 >= 0xFFFFF68000000000uLL && v3 <= 0xFFFFF6FFFFFFFFFFuLL )
  {
    if ( v3 <= (((unsigned __int64)qword_140465EE0 >> 9) & 0x7FFFFFFFF8LL) - 0x98000000000LL && v3 >= v1 )
