/*
 * XREFs of PopEstimateChargeTime @ 0x1408AA470
 * Callers:
...
unsigned __int64 PopEstimateChargeTime()
{
  ...
  {
    for ( i = qword_140443230; (__int64 *)i != &qword_140443230; i = *(_QWORD *)i )
    {
      v7 = *(_DWORD *)(i + 64);
      if ( v7 != -1 )
      {
  ...
  if ( pCallbackContext.LevelPlus1 > 5 )
  {
    ...
    v32 = 8;
    v35 = 4;
    TlgWrite(&pCallbackContext, &unk_14038EE35, 0LL, 0LL, 8u, &pData);
  }
  return v0;
}
