/*
 * XREFs of EtwTraceSystemTimeChange @ 0x14059D710
 * Callers:
...
char __fastcall EtwTraceSystemTimeChange(__int64 *a1, _QWORD *a2, int a3)
{
  ...
  v40 = a3;
  v14[0] = 0x20000LL;
  v14[1] = &word_1405A34F0;
  Process = KeGetCurrentThread()->ApcState.Process;
  ProcessId = (unsigned int)PsGetProcessId(Process);
  LODWORD(v13) = ProcessId;
  v7 = (unsigned __int16 *)Process[1].ActiveProcessors.Bitmap[14];
  if ( !v7 || !*v7 )
    v7 = (unsigned __int16 *)v14;
  if ( stru_140426618.LevelPlus1 > 5 )
  {
    LOBYTE(ProcessId) = TlgKeywordOn(&stru_140426618, 0x400000000000uLL);
    if ( (_BYTE)ProcessId )
    {
      v15 = *a1;
      v16 = *a2;
      ...
      v37[1] = 0;
      v39 = 4LL;
      LOBYTE(ProcessId) = TlgWrite(&stru_140426618, &unk_14039401E, 0LL, 0LL, 8u, &pData);
    }
  }
