/*
 * XREFs of PiCreateDriverSwDeviceCallback @ 0x14087C5A0
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall PiCreateDriverSwDeviceCallback(__int64 a1, __int64 a2, const WCHAR *a3, _DWORD *a4)
{
  ...
  PVOID v65; // [rsp+120h] [rbp+20h] BYREF
  UNICODE_STRING DestinationString; // [rsp+128h] [rbp+28h] BYREF
  UNICODE_STRING v67; // [rsp+138h] [rbp+38h] BYREF
  UNICODE_STRING v68; // [rsp+148h] [rbp+48h] BYREF
  _DWORD v69[2]; // [rsp+158h] [rbp+58h] BYREF
  __int64 v70; // [rsp+160h] [rbp+60h]
  PCWSTR SourceString; // [rsp+168h] [rbp+68h]
  ...
  *(_QWORD *)&v63.Length = 0LL;
  ...
  v76[38] = &v68;
  RegistryValues = RtlpQueryRegistryValues(0xC0000000, (const WCHAR *)Handle, (__int64)v76, 0LL);
  if ( RegistryValues < 0 )
    goto LABEL_128;
...
LABEL_17:
  ...
  v74[1] = v59.Buffer;
  v13 = *(_QWORD *)v57;
  v14 = *(_QWORD *)v57 == (_QWORD)IopRootDeviceNode;
  v69[0] = 2;
  v69[1] = 3;
  if ( v14 )
    goto LABEL_67;
...
LABEL_67:
  ...
  if ( RegistryValue >= 0 )
  {
    if ( v46[1] == 3 )
    {
      ...
      if ( v55 >= 0x28 )
      {
        v73 = (__int64)v46 + (unsigned int)v46[2];
        goto LABEL_77;
      }
    }
...
LABEL_77:
  ...
  {
    if ( !RtlCreateUnicodeString(&v63, SourceString) )
    {
      RegistryValues = -1073741670;
      goto LABEL_127;
    }
LABEL_86:
    v29 = v72;
    for ( i = PnpGetGenericStorePropertyKeys(v72, (int)Handle, 0LL, 0, 0LL, 0, (unsigned int *)&NumberOfBytes);
          ;
...
LABEL_111:
  ...
  RegistryValues = PipMakeGloballyUniqueId(*(_QWORD *)(*(_QWORD *)v12 + 32LL), 0LL, (wchar_t **)&v65);
  if ( RegistryValues < 0 )
    goto LABEL_127;
  v25 = SourceString;
  v26 = -1LL;
  ...
  do
    ++v26;
  while ( *((_WORD *)v65 + v26) );
  v63.MaximumLength = 2 * (v26 + v27 + 2);
  v63.Buffer = (wchar_t *)ExpAllocateStringRoutine((unsigned __int16)(2 * (v26 + v27) + 4));
  if ( !v63.Buffer )
  {
    RegistryValues = -1073741670;
    goto LABEL_127;
  }
  RegistryValues = RtlUnicodeStringPrintf(&v63, L"%ws&%ws", v25, v28);
  if ( RegistryValues >= 0 )
    goto LABEL_86;
LABEL_127:
  v5 = Str1;
