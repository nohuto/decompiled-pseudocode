/*
 * XREFs of PopDiagTraceBatteryAlarmStatus @ 0x1408AD438
 * Callers:
  ...
  if ( (unsigned int)v3 <= 1 )
  {
    ...
    if ( pCallbackContext.LevelPlus1 > 5 )
    {
      ...
      if ( (_BYTE)v3 )
      {
        ...
        v18 = *(_DWORD *)(a1 + 4);
        v19 = *(_DWORD *)(a1 + 16);
        v20 = (unsigned __int8)byte_140443320;
        v14 = v7;
        v22 = v8;
        ...
        v49 = 4LL;
        v51 = 4LL;
        LOBYTE(v3) = TlgWrite(&pCallbackContext, &unk_14038F9BA, 0LL, 0LL, 0xFu, &pData);
      }
    }
    if ( (unsigned int)dword_140443214 > 1 )
    {
      v10 = qword_140443230;
      v3 = (unsigned __int64)&qword_140443230;
      while ( (__int64 *)v10 != &qword_140443230 )
      {
        ++v6;
        if ( *(_DWORD *)(v10 + 64) )
          v3 = (unsigned __int64)&qword_140443230;
        if ( pCallbackContext.LevelPlus1 > 5 )
        {
          if ( TlgKeywordOn(&pCallbackContext, 0x400000000000uLL) )
          {
            ...
            v35 = 4LL;
            v37 = 4LL;
            TlgWrite(&pCallbackContext, &unk_14038F926, 0LL, 0LL, 8u, &pData);
          }
          v3 = (unsigned __int64)&qword_140443230;
        }
        v10 = *(_QWORD *)v10;
