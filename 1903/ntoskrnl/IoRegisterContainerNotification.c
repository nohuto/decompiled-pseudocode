/*
 * XREFs of IoRegisterContainerNotification @ 0x1407883D0
 * Callers:
 *     <none>
 * Callees:
        ...
        case 3:
          ...
          if ( (*(_DWORD *)(*(_QWORD *)(v9 + 312) + 32LL) & 0x400) != 0 )
          {
            ...
            if ( DevicePDO )
            {
              ...
              SessionObjectById = MmGetSessionObjectById(SessionIdFromPDO, v22);
...
LABEL_11:
          ...
          *(_QWORD *)CallbackRegistration = v13;
          v16 = (_QWORD *)qword_140461D68;
          if ( *(PVOID **)qword_140461D68 != &IopSessionNotificationQueueHead )
            __fastfail(3u);
          *v12 = &IopSessionNotificationQueueHead;
          v12[1] = v16;
          *v16 = v12;
          qword_140461D68 = (__int64)v12;
          goto LABEL_13;
        case 5:
