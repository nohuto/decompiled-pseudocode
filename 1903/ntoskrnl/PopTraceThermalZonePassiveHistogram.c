/*
 * XREFs of PopTraceThermalZonePassiveHistogram @ 0x140167438
 * Callers:
 ...
 *     PopDiagSnapPassiveHistogram @ 0x140167D48 (PopDiagSnapPassiveHistogram.c)
  ...
  if ( v4 )
  {
    ...
    if ( pCallbackContext.LevelPlus1 > 5 )
    {
      ...
      if ( (_BYTE)DeviceAttachmentBaseRefWithTag )
      {
        ...
        v14 = 84;
        v17 = 21;
        LOBYTE(DeviceAttachmentBaseRefWithTag) = TlgWrite(&pCallbackContext, &unk_1403903C6, 0LL, 0LL, 7u, &pData);
      }
    }
  }
  if ( v3 )
