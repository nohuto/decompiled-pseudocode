/*
 * XREFs of ?StDmCombinePageRecords@?$ST_STORE@USM_TRAITS@@@@SAXPEAU_ST_DATA_MGR@1@PEAU_ST_PAGE_RECORD@1@PEAUSEARCH_RESULT@?$B_TREE@KU_ST_REGION_ENTRY@?$ST_STORE@USM_TRAITS@@@@$0BAAA@UNP_CONTEXT@@UST_REGION_ENTRY_COMPARATOR@2@@@1@Z @ 0x14014DF80
 * Callers:
...
__int64 __fastcall ST_STORE<SM_TRAITS>::StDmCombinePageRecords(__int64 a1, _DWORD *a2, __int64 a3, __int64 a4)
{
  ...
  *(_DWORD *)(a1 + 1896) = v9;
  ...
  {
    v12 = *(_QWORD *)(a1 + 1912);
    *(_BYTE *)(a1 + 1905) = v10 & 0xFC | 1;
    ST_STORE<SM_TRAITS>::StLazyWorkMgrQueueWork(v12, 5LL, 30000LL, 4294967294LL);
  }
