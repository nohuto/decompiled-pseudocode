/*
 * XREFs of MiComputeSystemTrimCriteria @ 0x1400F3484
 * Callers:
...
__int64 __fastcall MiComputeSystemTrimCriteria(_QWORD *a1, __int64 a2)
{
  ...
  *(_QWORD *)(v2 + 8 * v20 + 2216) = v18;
  ...
  v19 = *(_QWORD *)(v2 + 2392);
  v42 = v41 - AvailablePagesBelowPriority;
  v16 = v21;
  if ( v42 <= v19 )
    v19 = v42;
LABEL_9:
  ...
  {
    v43 = v17 - (AvailablePagesBelowPriority >> 2);
    if ( v43 > v19 && v19 < 0x2000 && !v9 )
    {
