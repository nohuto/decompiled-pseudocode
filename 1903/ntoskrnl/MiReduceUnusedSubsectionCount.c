/*
 * XREFs of MiReduceUnusedSubsectionCount @ 0x1400E0AD8
 * Callers:
...
signed __int64 __fastcall MiReduceUnusedSubsectionCount(_DWORD *a1)
{
  ...
  v1 = *(_QWORD *)(qword_140466188 + 8LL * (*(_WORD *)(*(_QWORD *)a1 + 60LL) & 0x3FF));
  v2 = a1[11];
  v3 = 8LL * v2;
  if ( v3 > 0xFE0 )
  {
...
LABEL_4:
  result = _InterlockedExchangeAdd64(&qword_140464598, -(__int64)v5);
  *(_QWORD *)(v1 + 1632) -= v5;
  return result;
}
