/*
 * XREFs of ViXdvDriverLoadImage @ 0x140966AD4
 * Callers:
 ...
 *     ViXdvGetFuncAddress @ 0x140966D40 (ViXdvGetFuncAddress.c)
...
char __fastcall ViXdvDriverLoadImage(__int64 a1)
{
  ...
  __int64 (__fastcall *v11)(int *, __int64); // rax
  __int64 v12; // rdx
  ...
  do
  {
    ...
    {
      v11 = (__int64 (__fastcall *)(int *, __int64))ViXdvGetFuncAddress(v1, v4, (unsigned int)v8);
