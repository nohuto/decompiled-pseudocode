/*
 * XREFs of KiIntSteerChooseInitialTargetProcessors @ 0x14017CA60
 * Callers:
 *     KiIntSteerConnect @ 0x14017C63C (KiIntSteerConnect.c)
 * Callees:
 *     KeFindFirstSetRightGroupAffinity @ 0x1400FDD50 (KeFindFirstSetRightGroupAffinity.c)
 *     KeIntSteerGetSteeringMode @ 0x14017CB78 (KeIntSteerGetSteeringMode.c)
