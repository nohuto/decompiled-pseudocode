/*
 * XREFs of KiPerformGroupConfiguration @ 0x1409ED7B0
 * Callers:
 ...
 *     KiAssignAllNodesToGroup0 @ 0x1409EDB18 (KiAssignAllNodesToGroup0.c)
 *     KiAssignAdjustableNodes @ 0x140A3BE78 (KiAssignAdjustableNodes.c)
 *     KiAssignFixedNodes @ 0x140A3BF20 (KiAssignFixedNodes.c)
 *     KiShuffleAssignedNodes @ 0x140A3C118 (KiShuffleAssignedNodes.c)
 */
...
__int64 __fastcall KiPerformGroupConfiguration(void *a1)
{
  ...
  if ( KeNumberNodes )
  {
    do
    {
      ((void (__fastcall *)(_QWORD, int *))KiNumaQueryNodeCapacity[0])(v7, &v64);
      v8 = KeNodeBlock[v7];
      *(_BYTE *)(v8 + 180) = v64;
      v4 += v64;
      if ( v64 )
  ...
  if ( KeNumberNodes )
  {
    do
    {
      ...
      {
        ((void (__fastcall *)(_QWORD, _QWORD, int *))KiNumaQueryNodeDistance)(v11, i, &v67);
        v10 = KeNumberNodes;
        v13 = i++;
      }
      ++v11;
