/*
 * XREFs of RtlDeleteRange @ 0x140762250
 * Callers:
 *     ArbBacktrackAllocation @ 0x1407613A0 (ArbBacktrackAllocation.c)
 *     IopPortBacktrackAllocation @ 0x140863290 (IopPortBacktrackAllocation.c)
 * Callees:
