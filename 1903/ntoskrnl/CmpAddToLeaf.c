/*
 * XREFs of CmpAddToLeaf @ 0x1406328AC
 * Callers:
...
__int64 __fastcall CmpAddToLeaf(ULONG_PTR BugCheckParameter2, ULONG_PTR BugCheckParameter3, int a3, __int64 a4)
{
  ...
  CmpFindSubKeyInLeafWithStatus(BugCheckParameter2, v7, a4, (unsigned int)&v21, (__int64)&v22);
...
LABEL_34:
  ...
  {
    v14 = CmpCompareInIndex(BugCheckParameter2, a4, v22, v7, (__int64)&v21);
    if ( v14 != 2 )
    {
      if ( v14 > 0 )
