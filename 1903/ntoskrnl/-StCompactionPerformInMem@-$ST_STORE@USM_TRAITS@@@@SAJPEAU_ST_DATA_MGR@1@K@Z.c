/*
 * XREFs of ?StCompactionPerformInMem@?$ST_STORE@USM_TRAITS@@@@SAJPEAU_ST_DATA_MGR@1@K@Z @ 0x140161C2C
 * Callers:
...
LABEL_19:
      ...
      else
      {
        ...
        {
          v20 = *(_WORD **)v14;
          v5 = (__int64)(*(_QWORD *)v14 - *(_QWORD *)(a1 + 1032)) >> 1;
