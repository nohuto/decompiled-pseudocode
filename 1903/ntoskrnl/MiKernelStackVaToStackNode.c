/*
 * XREFs of MiKernelStackVaToStackNode @ 0x140164A04
 * Callers:
...
_QWORD *__fastcall MiKernelStackVaToStackNode(unsigned __int64 a1)
{
  ...
  v2 = 0LL;
  v3 = ExAcquireSpinLockShared(&dword_140466720);
  v4 = (_QWORD *)qword_140466718;
  while ( v4 )
  {
    if ( a1 > v4[3] )
    {
  ...
  ExReleaseSpinLockSharedFromDpcLevel(&dword_140466720);
