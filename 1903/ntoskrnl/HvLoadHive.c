/*
 * XREFs of HvLoadHive @ 0x14065F05C
 * Callers:
  ...
  if ( HIDWORD(v33) < *(_DWORD *)(v12 + 40) + 4096 && (BYTE2(NlsMbCodePageTag) || (CmpBootType & 6) != 0) )
  {
    if ( stru_140425BC0.LevelPlus1 > 5 && TlgKeywordOn(&stru_140425BC0, 0x200000000000uLL) )
    {
      ...
      *(_QWORD *)&pData[2].Size = 4LL;
      ...
      v38 = &v34;
      v39 = 4LL;
      TlgWrite(&stru_140425BC0, &unk_14038BE63, 0LL, 0LL, 4u, pData);
      v12 = *(_QWORD *)(BugCheckParameter2 + 64);
    }
    *(_DWORD *)(v12 + 4088) |= 4u;
...
LABEL_82:
  ...
  inited = HvpMapHiveImageFromViewMap(BugCheckParameter2, 0LL, *(_DWORD *)(*(_QWORD *)(BugCheckParameter2 + 64) + 40LL));
  v11 = inited;
  if ( inited < 0 )
  {
    cDataa = 140;
