/*
 * XREFs of PfpFlushBuffers @ 0x14065B420
 * Callers:
 ...
 *     PfTAcquireLogEntry @ 0x1408A1668 (PfTAcquireLogEntry.c)
 */
...
char PfpFlushBuffers()
{
  ...
  while ( 1 )
  {
    ...
    v29 = HIDWORD(v30);
    v31 = dword_140467B5C + (((v7 << 8) + v8) >> 10);
    Src = 163851LL;
    PfpCopyEvent(&Src);
    if ( *((int *)&v6->Next + 2) > 1
      || (v25 = *((unsigned int *)&v6->Next + 3), v24 = 94215LL, PfpCopyEvent(&v24), *((int *)&v6->Next + 2) > 1) )
    {
      ...
      if ( (unsigned __int64)Next <= *((_QWORD *)&v6[2].Next + 1) )
      {
        while ( 1 )
        {
          ...
          v18 = PfTAcquireLogEntry(&unk_140467618, v22, 1LL);
          if ( !v18 )
            break;
