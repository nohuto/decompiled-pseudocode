/*
 * XREFs of PopFxClearDirectedDripsCandidateDeviceList @ 0x1402F27F4
 * Callers:
...
LABEL_16:
  ...
  if ( (__int64)v9->LockState.LockState < 0 )
    KiAbEntryRemoveFromTree((__int64)&v2->LockEntries[v8]);
...
LABEL_23:
  ...
  if ( v10 && ($6EAC78A6FCFADE0A5FA44F358736B38F *)v2->ApcState.ApcListHead[0].Flink != &v2->152 )
...
LABEL_45:
  ...
  if ( v10 && ($6EAC78A6FCFADE0A5FA44F358736B38F *)v16->ApcState.ApcListHead[0].Flink != &v16->152 )
