/*
 * XREFs of HvpMappedViewConvertRegionFromLockedToCOWByPolicy @ 0x14072A750
 * Callers:
 *     HvpMappedViewConvertLockedPagesToCOWByPolicy @ 0x14073377C (HvpMappedViewConvertLockedPagesToCOWByPolicy.c)
 * Callees:
