/*
 * XREFs of PspThreadDelete @ 0x14060F400
 * Callers:
 *     <none>
 * Callees:
 ...
 *     KeFoldProcessStatisticsThread @ 0x1400829C8 (KeFoldProcessStatisticsThread.c)
...
unsigned __int64 __fastcall PspThreadDelete(ULONG_PTR BugCheckParameter2)
{
  ...
  if ( result >= qword_140464270 )
  {
    v8 = qword_140464260;
    if ( qword_140464260 )
    {
      if ( (_DWORD)qword_140464278 )
      {
        v9 = 0LL;
        v10 = &ObpObjectTypes;
        v11 = (unsigned int)qword_140464278;
        do
        {
          v12 = *v10;
          if ( ((*(unsigned __int8 *)(*v10 + 66) >> 6) & 1) != _bittest64(&qword_140464280, v9) && !qword_140464230 )
          {
            qword_140464230 = (unsigned int)__ROL4__(1207959560, 133);
            qword_140464238 = 0LL;
            qword_140464240 = 0LL;
            qword_140464248 = 268LL;
            qword_140464250 = v12;
          }
          ++v9;
          ++v10;
      ...
      v13 = 64;
      v14 = (_QWORD *)(qword_1404642A0 + 112);
      v15 = (const char *)(qword_1404642A0 + 112);
      if ( qword_1404642A0 + 112 < (unsigned __int64)(qword_1404642A0 + 176) )
      {
        ...
        while ( (unsigned __int64)v15 < qword_1404642A0 + 176 );
      }
      v16 = 8LL;
      do
      {
        v8 = __ROR8__(v8 - *v14++, qword_140464268);
        v13 -= 8;
        --v16;
      }
      while ( v16 );
      for ( ; v13; --v13 )
      {
        ...
        v8 = __ROR8__(v8 - v17, qword_140464268);
      }
      if ( qword_1404642A8 != v8 )
      {
        if ( qword_140464230 )
          goto LABEL_45;
        qword_140464230 = (unsigned int)__ROR4__(150994945, 152);
        qword_140464238 = 0LL;
        qword_140464240 = 0LL;
        qword_140464248 = 268LL;
        qword_140464250 = qword_1404642A0;
      }
    }
    if ( !qword_140464230 )
    {
...
LABEL_32:
  ...
  if ( v18 )
  {
    ...
    if ( (*(_DWORD *)(BugCheckParameter2 + 1760) & 0x100000) != 0 )
      ((void (__fastcall *)(ULONG_PTR))xmmword_140436A10)(BugCheckParameter2);
