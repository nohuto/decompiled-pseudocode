/*
 * XREFs of PpmPerfRecordUtility @ 0x1400FA9D0
 * Callers:
 *     PpmCheckRecordAllUtility @ 0x1400FA920 (PpmCheckRecordAllUtility.c)
 * Callees:
...
LABEL_18:
  ...
  if ( v21 )
  {
    ...
    *((_WORD *)v26 + 15) = v16;
    v21[4] += (unsigned __int16)v13 - v28;
    *((_WORD *)v26 + 16) = v13;
    v21[5] -= *((unsigned __int8 *)v26 + 34);
    v21[5] += *((unsigned __int8 *)v1 + 304);
    *((_BYTE *)v26 + 34) = *((_BYTE *)v1 + 304);
    v21[6] -= *((unsigned __int8 *)v26 + 35);
    v21[6] += *((unsigned __int8 *)v1 + 305);
    *((_BYTE *)v26 + 35) = *((_BYTE *)v1 + 305);
    if ( (_DWORD)v25 + 1 != v24 )
      v18 = v25 + 1;
    v29 = v21[2];
    v21[1] = v18;
