/*
 * XREFs of _woutput_s @ 0x1401A7488
 * Callers:
 *     _swoutput_s @ 0x1401A7358 (_swoutput_s.c)
 * Callees:
 *     xHalTimerWatchdogStop @ 0x140177050 (xHalTimerWatchdogStop.c)
 *     __security_check_cookie @ 0x14019E700 (__security_check_cookie.c)
 *     _safecrt_mbtowc @ 0x1401A0960 (_safecrt_mbtowc.c)
 *     write_char_1 @ 0x1401A7D94 (write_char_1.c)
 *     write_string_2 @ 0x1401A7DE4 (write_string_2.c)
...
__int64 __fastcall woutput_s(__int64 a1, _WORD *a2, int *a3)
{
  ...
  wchar_t v58[2]; // [rsp+48h] [rbp-B8h] BYREF
  ...
  wchar_t DstCh[512]; // [rsp+70h] [rbp-90h] BYREF
...
LABEL_27:
            ...
            v55 = v5;
            LODWORD(v13) = (unsigned int)&DstCh[72] + 367 - (_DWORD)v26;
            v7 = (wchar_t *)(v26 + 1);
            v6 = v29;
            if ( (v4 & 0x200) != 0 )
            {
