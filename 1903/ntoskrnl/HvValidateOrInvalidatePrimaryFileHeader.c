/*
 * XREFs of HvValidateOrInvalidatePrimaryFileHeader @ 0x1406E98B4
 * Callers:
...
__int64 __fastcall HvValidateOrInvalidatePrimaryFileHeader(__int64 a1, char a2, char a3, char a4)
{
  ...
  int v9; // ecx
  int v10; // eax
  __int64 (__fastcall *v11)(__int64, _QWORD, __int64 *, __int64, int); // rax
  int v12; // ebx
  ...
  if ( *(_QWORD *)(a1 + 1536) )
  {
    ...
    v11 = *(__int64 (__fastcall **)(__int64, _QWORD, __int64 *, __int64, int))(a1 + 40);
    LODWORD(v19) = 0;
    v20 = v8;
    LODWORD(v21) = 4096;
