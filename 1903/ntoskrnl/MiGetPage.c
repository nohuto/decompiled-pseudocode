/*
 * XREFs of MiGetPage @ 0x1400CFE40
 * Callers:
 ...
 *     MiCheckNodeChannelStandbyCount @ 0x1402D91E0 (MiCheckNodeChannelStandbyCount.c)
 *     MiSwapNumaStandbyPage @ 0x1402DA970 (MiSwapNumaStandbyPage.c)
 *     MiPageAvailable @ 0x1402E5818 (MiPageAvailable.c)
 */
...
LABEL_3:
    ...
    if ( v3 > 1 )
    {
      ...
      if ( v12 == v6 )
      {
        ...
        if ( (v9 & 0x20) != 0 )
        {
          ...
          {
            v48 = &v70;
            v49 = (unsigned __int16)(unsigned __int8)MiChannelMaximumPowerOf2Mask & (unsigned __int16)(v10 >> byte_140465A4E);
            v69 = MiChannelMaximumPowerOf2Mask & (v10 >> byte_140465A4E);
            v50 = v3;
            do
            {
              v51 = *v47;
    ...
    do
    {
      if ( v8 )
      {
        v52 = v10 & dword_140465AB0;
        v10 = v10 & dword_140465AB0 | (v12 << byte_140465A4D) | (*v8 << byte_140465A4E);
        v79 = v52 | (v12 << byte_140465A4D) | (*v8 << byte_140465A4E);
      }
      ...
      for ( i = *v14; ; i = v14[1] )
      {
        v17 = (union _SLIST_HEADER *)(v15 + *(_QWORD *)(v5 + 8LL * i + 4136));
...
LABEL_88:
      ...
      {
        KeReleaseInStackQueuedSpinLockFromDpcLevel(&LockHandle);
        MiReturnFreeZeroPage(48 * v25 - 0x58000000000LL);
        _InterlockedAnd64(v66, 0x7FFFFFFFFFFFFFFFuLL);
        if ( (_BYTE)v67 != 17 )
        {
          if ( KiIrqlFlags && (KiIrqlFlags & 1) != 0 && KeGetCurrentIrql() >= 2u && (unsigned __int8)v67 < 2u )
...
LABEL_19:
      ...
      while ( 2 )
      {
        v31 = (union _SLIST_HEADER *)(v27 + *(_QWORD *)(a1 + 8LL * v30 + 4136));
...
LABEL_165:
    if ( (v9 & 0x4000) == 0 )
    {
      ...
      {
        v12 = *(_DWORD *)(qword_140465A50 + 4LL * (v7 + v6 * (unsigned __int16)KeNumberNodes));
        if ( v3 == 1 )
        {
          v8 = 0LL;
          v61 = v10 & dword_140465AB0;
          v10 = v10 & dword_140465AB0 | (v12 << byte_140465A4D);
          v79 = v61 | (v12 << byte_140465A4D);
          continue;
        }
        goto LABEL_3;
      }
