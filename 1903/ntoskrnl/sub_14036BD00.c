/*
 * XREFs of sub_14036BD00 @ 0x14036BD00
 * Callers:
...
__int64 __fastcall sub_14036BD00(__int64 a1, __int64 a2)
{
  __int64 v2; // rdi
  __int64 v3; // rdx
  __int64 v4; // r8
