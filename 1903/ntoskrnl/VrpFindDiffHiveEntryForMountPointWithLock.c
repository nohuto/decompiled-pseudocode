/*
 * XREFs of VrpFindDiffHiveEntryForMountPointWithLock @ 0x140846E54
 * Callers:
...
__int64 __fastcall VrpFindDiffHiveEntryForMountPointWithLock(PCUNICODE_STRING String1)
{
  ...
  *(_QWORD *)&String2.Length = 0LL;
  ...
  v6 = -1LL << (dword_140463524 & 0x1F);
  v7 = v4 & v6;
  if ( (unsigned int)dword_140463524 >> 5 )
  {
    v12 = v4 & v6;
    v8 = qword_140463528
       + 8LL
       * ((37
         * (BYTE6(v12)
         ...
         + HIBYTE(v12)) & (((unsigned int)dword_140463524 >> 5) - 1));
    do
    {
      v8 = *(_QWORD *)v8;
      if ( (v8 & 1) != 0 )
