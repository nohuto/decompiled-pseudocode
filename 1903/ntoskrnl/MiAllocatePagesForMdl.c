/*
 * XREFs of MiAllocatePagesForMdl @ 0x1400EF404
 * Callers:
 *     MmAllocatePartitionNodePagesForMdlEx @ 0x1400EF300 (MmAllocatePartitionNodePagesForMdlEx.c)
 *     MmAllocatePagesForMdl @ 0x140181070 (MmAllocatePagesForMdl.c)
        ...
        unsigned int a8)
{
  ...
  *(_DWORD *)(v18 + 40) = 0;
  ...
  if ( (ULONG_PTR *)v26 == v27 )
    _InterlockedExchangeAdd64(&qword_140466A38, -(__int64)v28);
