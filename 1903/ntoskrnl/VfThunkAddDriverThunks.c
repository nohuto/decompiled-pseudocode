/*
 * XREFs of VfThunkAddDriverThunks @ 0x140975E04
 * Callers:
...
__int64 __fastcall VfThunkAddDriverThunks(void *a1)
{
  ...
  VfThunksExtended = 1;
  _InterlockedOr(v4, 0);
  v3 = (_QWORD *)qword_1404356D8;
  ++ViActiveVerifierThunks;
  if ( *(__int64 **)qword_1404356D8 != &ViVerifierDriverAddedThunkListHead )
    __fastfail(3u);
  *ThunkTable = &ViVerifierDriverAddedThunkListHead;
  ThunkTable[1] = v3;
  *v3 = ThunkTable;
  qword_1404356D8 = (__int64)ThunkTable;
