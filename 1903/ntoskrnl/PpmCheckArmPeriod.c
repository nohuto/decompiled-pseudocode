/*
 * XREFs of PpmCheckArmPeriod @ 0x140194054
 * Callers:
...
char PpmCheckArmPeriod()
{
  ...
  if ( (unsigned int)(10000 * HIDWORD(PpmCurrentProfile[341 * dword_140443ACC + 7])) > (unsigned __int64)PpmCheckMinimumPeriod )
    v0 = (unsigned int)(10000 * HIDWORD(PpmCurrentProfile[341 * dword_140443ACC + 7]));
  if ( !PpmCheckArmed )
    goto LABEL_7;
