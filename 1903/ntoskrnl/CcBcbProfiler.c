/*
 * XREFs of CcBcbProfiler @ 0x1401A9C40
 * Callers:
 *     <none>
 * Callees:
 ...
 *     CcAdjustBcbDepth @ 0x1401CE170 (CcAdjustBcbDepth.c)
...
LABEL_33:
      ...
      if ( !CurrentPrcb->DpcRoutineActive || v37 > DpcStack || v37 < DpcStack - 3072 )
      ...
      v37[1] = 0x891C8B4E8A3A03F5uLL;
      CcAdjustBcbDepth(
        __ROL4__(8480, 219),
        __ROR8__(0x891C8B4E8A3A03F5uLL, 220),
        0,
        v9,
        (unsigned int)__ROR4__(131, 223),
        (__int64)KeBugCheckEx,
        (__int64)DpcStack);
      JUMPOUT(0x1401A9FB9LL);
    }
  }
}
