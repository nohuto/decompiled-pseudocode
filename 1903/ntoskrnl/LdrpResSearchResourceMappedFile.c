/*
 * XREFs of LdrpResSearchResourceMappedFile @ 0x1400AFFDC
 * Callers:
 *     LdrResSearchResource @ 0x14067B1D0 (LdrResSearchResource.c)
 *     LdrResGetRCConfig @ 0x140743308 (LdrResGetRCConfig.c)
 * Callees:
 *     LdrpFindMessageInAlternateModule @ 0x14011CEC8 (LdrpFindMessageInAlternateModule.c)
        ...
        __int64 a9)
{
  ...
  if ( (a3 & 0x10) == 0 && a5 >= 1 && a5 <= 3 )
  {
       ...
       || v16 == 3072) )
    {
      ...
      {
        v15 = v13 | LdrIsResItemExist(BaseAddress, a4, 0LL);
        v14 = a5;
      }
    }
    else
...
LABEL_29:
  ...
  if ( v44 && v27 >= 0 && v47 && v38 )
  {
    if ( v52 )
      ...
      LODWORD(v35) = v53;
    MappingSize = LdrpFindMessageInAlternateModule((_DWORD)v42, *v47, v35, *(_DWORD *)(a4 + 24), 1);
    if ( MappingSize < 0 )
    {
      *v47 = 0LL;
  ...
  if ( v39 )
  {
    if ( (unsigned int)DownLevelLangIDToLanguageName(v39, Src, 86LL) )
    {
      v36 = -1LL;
      do
        ++v36;
