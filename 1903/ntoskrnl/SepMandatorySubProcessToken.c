/*
 * XREFs of SepMandatorySubProcessToken @ 0x140085988
 * Callers:
        ...
        if ( v28 )
        {
          ...
          if ( v30 )
          {
            ...
            if ( v34 )
            {
              v35 = *v33;
              v36 = *(_BYTE *)(*v33 + 1);
              v37 = v36 ? *(_DWORD *)(v35 + 4LL * ((unsigned int)v36 - 1) + 8) : 0;
              v38 = *(_QWORD *)v34;
              v39 = *(_BYTE *)(*(_QWORD *)v34 + 1LL);
              if ( v39 )
              {
                v4 = v39;
          ...
          {
            v31 = *(_QWORD *)v28;
            v32 = *(_BYTE *)(*(_QWORD *)v28 + 1LL);
            if ( v32 && *(_DWORD *)(v31 + 4LL * ((unsigned int)v32 - 1) + 8) > 0x2000u )
            {
              *(_DWORD *)(v31 + 8) = 0x2000;
              *v5 = *v29;
            }
