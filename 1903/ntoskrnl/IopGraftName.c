/*
 * XREFs of IopGraftName @ 0x1406CEEB8
 * Callers:
 ...
 *     IopSymlinkRemoveECP @ 0x140047174 (IopSymlinkRemoveECP.c)
...
LABEL_53:
          ...
          v35 = (struct _FILE_OBJECT *)Object;
          v4 = v55->Length + v34 - *((unsigned __int16 *)a3 + 3);
          while ( 1 )
          {
...
LABEL_20:
  ...
  v44 = EcpContext;
  v45 = *((unsigned __int16 *)EcpContext + 8) + 2 + v43;
  if ( v45 < 0xFFFF )
  {
    IrpExtraCreateParameter = IopSymlinkAllocateAndAddECP(Irp, &v60, v45);
    if ( IrpExtraCreateParameter < 0 )
      goto LABEL_85;
    v46 = v45 + 32;
