/*
 * XREFs of sub_1405CA5E8 @ 0x1405CA5E8
 * Callers:
...
__int64 __fastcall sub_1405CA5E8(int a1, int a2, _QWORD *a3, __int64 a4)
{
  __int64 result; // rax
  __int64 v6; // rdx
  ...
  v7 = 0LL;
  result = sub_1405CACF4(a1 + 8, a2, 8, (unsigned int)&v7, a4);
  if ( (int)result >= 0 && a3 )
  {
    result = sub_1405C9CE8(v7);
    if ( (int)result >= 0 )
      *a3 = v6;
  }
  return result;
