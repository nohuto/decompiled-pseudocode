/*
 * XREFs of MiGetFreeOrZeroPageAnyColor @ 0x1400DBC9C
 * Callers:
 *     MiGetPage @ 0x1400CFE40 (MiGetPage.c)
 * Callees:
 *     MiDemoteLocalLargePage @ 0x1400DBD70 (MiDemoteLocalLargePage.c)
 *     MiRemovePageAnyColor @ 0x14011556C (MiRemovePageAnyColor.c)
 *     MiGetPageSlist @ 0x140115754 (MiGetPageSlist.c)
 */
...
__int64 __fastcall MiGetFreeOrZeroPageAnyColor(__int64 a1, unsigned int a2, unsigned int a3)
{
  ...
  if ( v3 >= 0x10 )
    v3 = 16LL;
  v7 = 1;
  v8 = (unsigned int)dword_140465AB0 * v3;
  v9 = a3 & 0x10001;
  while ( 1 )
  {
    if ( !v9 )
    {
      result = MiDemoteLocalLargePage(a1, a2, a3, v8);
      if ( result )
        return result;
      v7 = 0;
    }
