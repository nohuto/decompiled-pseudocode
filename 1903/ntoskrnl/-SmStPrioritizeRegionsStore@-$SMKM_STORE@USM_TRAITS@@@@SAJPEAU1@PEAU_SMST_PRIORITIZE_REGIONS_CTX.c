/*
 * XREFs of ?SmStPrioritizeRegionsStore@?$SMKM_STORE@USM_TRAITS@@@@SAJPEAU1@PEAU_SMST_PRIORITIZE_REGIONS_CTX@@@Z @ 0x14032053C
 * Callers:
 ...
 *     MmSetPriorityVaRanges @ 0x14088B204 (MmSetPriorityVaRanges.c)
 */
