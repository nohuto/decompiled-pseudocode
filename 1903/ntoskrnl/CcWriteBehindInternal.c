/*
 * XREFs of CcWriteBehindInternal @ 0x14007E1E0
 * Callers:
...
LONG __fastcall CcWriteBehindInternal(__int64 a1)
{
  ...
  unsigned int *v61; // [rsp+F8h] [rbp+7Fh]

  v1 = *(_QWORD *)(a1 + 16);
  memset(&v56, 0, sizeof(v56));
  v61 = *(unsigned int **)(a1 + 24);
  v3 = *(_BYTE *)(a1 + 56);
  ...
  if ( Partition != *(_QWORD *)(a1 + 128) )
    KeBugCheckEx(0x34u, 0x199AuLL, 0xFFFFFFFFC0000420uLL, 0LL, 0LL);
  ...
  for ( i = (KSPIN_LOCK *)(Partition + 192); ; i = (KSPIN_LOCK *)(v5 + 192) )
  {
    ...
    if ( *v18 != -2147483626 && (unsigned __int8)CcIsFatalWriteError(v1) )
    {
      ...
      CcMmLogLostDelayedWriteError(v44, *v18);
