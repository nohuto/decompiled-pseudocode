/*
 * XREFs of PiControlGetPropertyData @ 0x1406A02E0
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall PiControlGetPropertyData(__int64 a1, __int16 *a2, __int64 a3, char a4)
{
  ...
  _WORD v36[2]; // [rsp+48h] [rbp-18h] BYREF
  ...
  if ( (unsigned __int16)(v4 - 1) > 0x18Fu || (v4 & 1) != 0 )
    return 3221225485LL;
  result = PiControlMakeUserModeCallersCopy(&v38, *((void **)a2 + 1), v4, 2u, a4, 1);
  if ( (int)result >= 0 )
  {
    PpDevNodeLockTree(0LL);
    v9 = (struct _DEVICE_OBJECT *)PnpDeviceObjectFromDeviceInstanceWithTag(v36, 1131441744LL);
...
LABEL_21:
              v24 = v40;
              UserModeCallersCopy = PiControlMakeUserModeCallersCopy(v12, PropertyBuffer, v5, 1u, v40, 0);
