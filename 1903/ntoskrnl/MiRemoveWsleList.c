/*
 * XREFs of MiRemoveWsleList @ 0x140023730
 * Callers:
...
__int64 __fastcall MiRemoveWsleList(__int64 a1, __int64 a2, char *a3, __int64 a4)
{
  ...
  if ( !v60 )
    return v10;
  if ( (*(_BYTE *)(v4 + 184) & 7) == 2 )
    v24 = (unsigned __int64 *)&unk_140467240;
  else
...
LABEL_17:
  ...
  if ( v61 )
    LODWORD(xmmword_140464940) = xmmword_140464940 - v61;
  if ( v62 )
    DWORD1(xmmword_140464940) -= v62;
  *(_QWORD *)(v4 + 136) -= v63;
  v27 = 0LL;
  v28 = &a3[-a2];
...
LABEL_30:
      ...
      if ( v33 == 7 )
      {
        ...
        v41 = *(_QWORD *)(qword_140466188 + 8 * v40);
        v42 = *(_QWORD *)(v41 + 7800);
