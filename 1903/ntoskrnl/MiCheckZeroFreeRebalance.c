/*
 * XREFs of MiCheckZeroFreeRebalance @ 0x140109FB0
 * Callers:
...
unsigned __int64 __fastcall MiCheckZeroFreeRebalance(__int64 a1, unsigned int a2)
{
  ...
  v3 = 0;
  v5 = a2 >> byte_140465A4D;
  v6 = 0;
  v7 = *(_QWORD *)(a1 + 16) + 1984LL * (unsigned int)v5;
  if ( (unsigned int)MmNumberOfChannels > 1 )
    v6 = (unsigned __int16)(unsigned __int8)MiChannelMaximumPowerOf2Mask & (unsigned __int16)(a2 >> byte_140465A4E);
  v8 = 0LL;
  v9 = 0LL;
  v10 = v6;
  do
