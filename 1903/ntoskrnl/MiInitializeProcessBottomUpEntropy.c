/*
 * XREFs of MiInitializeProcessBottomUpEntropy @ 0x1406927FC
 * Callers:
...
__int64 __fastcall MiInitializeProcessBottomUpEntropy(__int64 a1)
{
  ...
  if ( *(_QWORD *)(a1 + 1152) > 0x100000000uLL && (*(_DWORD *)(a1 + 2128) & 0x20) != 0 )
  {
  ...
  {
LABEL_20:
    _InterlockedAnd((volatile signed __int32 *)(a1 + 2128), 0xFFFFFFDF);
    v8 = v16;
  }
  if ( v5 == 1 )
