/*
 * XREFs of MiRemoveLargeFreeLoaderDescriptors @ 0x1409F313C
 * Callers:
...
void __fastcall MiRemoveLargeFreeLoaderDescriptors(__int64 a1)
{
  ...
  qword_140A50680 = (__int64)&MxDeferredBootFreeDescriptorHead;
          ...
          do
          {
            ...
            if ( v7 == 2 || v7 == 24 )
            {
              ...
              for ( j = v3[3]; v8; v8 -= v10 )
              {
                ...
                if ( (unsigned int)MiPageToNode(j, 0) == v1 )
                {
                  v5 += v10;
            ...
            if ( v4 )
            {
              ...
              if ( v11 )
              {
                while ( 1 )
                {
                  ...
                  if ( (unsigned int)MiPageToNode(v12, 0) == v1 && v13 >= 0x200000 && v12 >= 0x100000 && v13 >= v6 )
                  {
                    if ( v5 - v13 >= 0x100000 )
                      goto LABEL_29;
...
LABEL_29:
                ...
                *((_DWORD *)v15 + 4) = *(_DWORD *)(v4 + 16);
                ...
                v18 = (v13 + v12) & 0xFFFFFFFFFFFC0000uLL;
                v19 = (__int64 **)qword_140A50680;
                v20 = v18 - v17;
                v15[3] = v17;
                v15[4] = v18 - v17;
...
LABEL_38:
                ...
                else
                {
                  ...
                  *v27 = v26;
                  *(_QWORD *)(v4 + 8) = v26;
                  v28 = *(_QWORD *)(v4 + 24) - v20;
                  *(_QWORD *)(v4 + 24) = v18;
                  *(_QWORD *)(v4 + 32) += v28 - v17;
                }
              }
            }
          }
