/*
 * XREFs of MiBuildForkPte @ 0x1402E1E60
 * Callers:
 ...
 *     MiFindZeroCloneBlock @ 0x1402E40F4 (MiFindZeroCloneBlock.c)
        ...
        _DWORD *a15)
{
  ...
  for ( i = a12; ; v24 = i )
  {
    ...
    if ( v32 == 1 || *(_WORD *)(v31 + 32) > 1u && (*(_QWORD *)(v31 + 40) & 0x200000000000000LL) == 0 )
    {
      ...
      v42 = *(_QWORD *)(qword_140466188 + 8LL * *(unsigned __int16 *)(v123 + 174));
      v124 = v42;
...
LABEL_204:
    ...
    v37 = ZeroPte;
    v124 = v34;
    v39 = *(_QWORD *)(qword_140466188 + 8 * ((v38 >> 40) & 0x3FF));
    v125 = v39;
    if ( *(_QWORD *)(qword_140466188 + 8 * v36) != v39 )
    {
      if ( (i & 1) != 0 )
      {
    ...
    if ( (WsleContents & 0xF) != 8 || (unsigned int)MiLockPageTablePage(v34, 3) )
    {
      ...
      *(_QWORD *)(v62 + 24) ^= (*(_QWORD *)(v62 + 24) ^ (*(_QWORD *)(v62 + 24) + 1LL)) & 0x3FFFFFFFFFFFFFFFLL;
      ...
      {
        v66 = *(_QWORD *)(v31 + 16);
        if ( qword_140465B00 && (v65 & 0x10) == 0 )
          v66 = ~qword_140465B00 & v65;
...
LABEL_31:
  ...
  v94 = 0;
  v122 = 0;
  v95 = *(_QWORD *)(qword_140466188 + 8LL * *(unsigned __int16 *)(a1 + 1454));
  if ( *(_QWORD *)(qword_140466188 + 8LL * *(unsigned __int16 *)(v54 + 174)) == v95 )
  {
LABEL_127:
...
LABEL_136:
    ...
    *(_QWORD *)(a6 + 24) = 2LL;
    ...
    if ( MiPteInShadowRange(a3) )
    {
      ...
      {
        v100 = 1;
        if ( HIBYTE(word_140465BEC) != (_BYTE)v102 )
          goto LABEL_145;
      }
      else if ( (KeGetCurrentThread()->ApcState.Process[2].ActiveProcessors.Bitmap[4] & 0x100000000000LL) == 0 )
      {
...
LABEL_164:
  ...
  if ( (v53 & 1) != 0 )
  {
    if ( !(unsigned int)MiChargeCommit(*(_QWORD *)(qword_140466188 + 8LL * *(unsigned __int16 *)(a1 + 1454)), 1uLL, 0) )
    {
      MiWriteUselessChildPte(a4);
      *v26 = 1;
      goto LABEL_208;
