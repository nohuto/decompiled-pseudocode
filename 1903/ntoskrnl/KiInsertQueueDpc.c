/*
 * XREFs of KiInsertQueueDpc @ 0x1400BCAF0
 * Callers:
 ...
 *     KiForegroundTimerCallback @ 0x14012D420 (KiForegroundTimerCallback.c)
 *     KiEntropyQueueDpc @ 0x140130E00 (KiEntropyQueueDpc.c)
 *     ExpTimeRefreshCallback @ 0x1401716B0 (ExpTimeRefreshCallback.c)
 ...
 *     KiEpfCompletionIsr @ 0x1402B3340 (KiEpfCompletionIsr.c)
 *     PpmHeteroDispatchHgsInterrupt @ 0x140300970 (PpmHeteroDispatchHgsInterrupt.c)
 *     ExpSvmFaultRoutine @ 0x14033E4F0 (ExpSvmFaultRoutine.c)
 *     WheaDeferredRecoveryService @ 0x140341460 (WheaDeferredRecoveryService.c)
        ...
        unsigned __int8 a5)
{
  ...
  unsigned int v51; // [rsp+40h] [rbp-58h] BYREF
