/*
 * XREFs of PopDiagTraceRtcWakeInfo @ 0x14015E2E8
 * Callers:
...
char __fastcall PopDiagTraceRtcWakeInfo(__int64 a1, int a2, int a3, int a4, int a5, int a6, __int64 a7)
{
  ...
  PopDiagInterruptTimeToSystemTime(qword_1404430B0, &v26);
  PopDiagInterruptTimeToSystemTime(qword_1404430C8, &v27);
  PopDiagInterruptTimeToSystemTime(qword_140443088, &v28);
  ...
  if ( pCallbackContext.LevelPlus1 > 5 )
  {
    ...
    if ( result )
    {
      ...
      v83 = 8LL;
      v85 = 4LL;
      result = TlgWrite(&pCallbackContext, &unk_14038FC33, 0LL, 0LL, 0x10u, &pData);
    }
  }
