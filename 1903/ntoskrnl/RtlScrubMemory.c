/*
 * XREFs of RtlScrubMemory @ 0x1403154E8
 * Callers:
 *     MiScrubPage @ 0x1402ECD28 (MiScrubPage.c)
 * Callees:
 *     RtlCompareMemoryUlong @ 0x1401CC270 (RtlCompareMemoryUlong.c)
 *     RtlpGenericInverseCouplingWorker @ 0x1403157B0 (RtlpGenericInverseCouplingWorker.c)
 *     RtlpGenericMATSPlusWorker @ 0x140315A8C (RtlpGenericMATSPlusWorker.c)
 *     RtlpGenericRandomPatternWorker @ 0x140315B90 (RtlpGenericRandomPatternWorker.c)
 *     RtlpGenericStrideWorker @ 0x140315EB4 (RtlpGenericStrideWorker.c)
 */
