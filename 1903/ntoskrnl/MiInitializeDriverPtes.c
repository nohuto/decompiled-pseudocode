/*
 * XREFs of MiInitializeDriverPtes @ 0x140A1630C
 * Callers:
...
LABEL_13:
  ...
  for ( j = qword_140464928[0]; j; j = *(PVOID *)j )
  {
    v16 = 0;
    do
    {
...
LABEL_51:
  ...
  if ( (KiSpeculationFeatures & 0x4000000) != 0 )
    qword_140465CB8 = (unsigned __int64)(((__int64)((*((_QWORD *)qword_140464928[0] + 1) << 25)
                                                  + ((unsigned __int64)*((unsigned int *)qword_140464928[0] + 4) << 28)) >> 16)
                                       - qword_140465CC0) >> 21;
  v45 = v51;
  n = 0LL;
  while ( v45 )
