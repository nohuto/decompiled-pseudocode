/*
 * XREFs of PopDecompressHiberBlocks @ 0x14059A700
 * Callers:
 ...
 *     RtlDecompressBufferProgress @ 0x140317758 (RtlDecompressBufferProgress.c)
        ...
        void (__fastcall *a5)(_DWORD *))
{
  ...
  LODWORD(v8) = (_DWORD)qword_140443498;
  v9 = 0;
  v43 = 0;
  v47 = 0LL;
  v41 = 0;
  ...
  while ( 1 )
  {
    ...
    if ( !qword_1404436D8 && BugCheckParameter3[48] == KeGetCurrentPrcb()->Number && byte_140443440 )
      qword_1404436D8 = KeQueryPerformanceCounter(0LL).QuadPart;
    Number = KeGetCurrentPrcb()->Number;
    if ( BugCheckParameter3[48] == (_DWORD)Number
      && !byte_140443441
      && (!byte_140443440 || (unsigned int)dword_140443424 > 0x640) )
    {
      v15 = __rdtsc();
      if ( byte_140468030 )
      {
      ...
      v16 = __rdtsc();
      qword_1404436C0 += (((unsigned __int64)HIDWORD(v16) << 32) | (unsigned int)v16) - v15;
    }
    v40 = 4;
