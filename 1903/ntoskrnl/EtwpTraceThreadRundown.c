/*
 * XREFs of EtwpTraceThreadRundown @ 0x140146BA0
 * Callers:
...
__int64 __fastcall EtwpTraceThreadRundown(__int64 a1, __int64 a2)
{
  ...
  if ( (struct _KTHREAD *)a1 != KeGetCurrentThread() )
    v5 &= 0xFFFFE7FF;
  v22[0] = *(_DWORD *)(a1 + 1608);
  v22[1] = *(_DWORD *)(a1 + 1616);
  v23 = *(_QWORD *)(a1 + 56);
  v24 = *(_QWORD *)(a1 + 48);
  v27 = *(_QWORD *)(a1 + 576);
  v28 = *(_QWORD *)(a1 + 1696);
  ...
  v34 = v9;
  if ( (*(_BYTE *)(v10 + 1768) & 8) != 0 )
  {
    v17 = v34;
    if ( *(_QWORD *)(v10 + 1560) != v10 + 1560 )
      v17 = 1;
    v34 = v17;
  }
  if ( v11 && v4 )
