/*
 * XREFs of PnpProcessRelation @ 0x14072F16C
 * Callers:
 ...
 *     PnpProcessBusRelations @ 0x14072F3DC (PnpProcessBusRelations.c)
 * Callees:
 ...
 *     IopRemoveRelationFromList @ 0x140875A84 (IopRemoveRelationFromList.c)
      ...
      if ( v63 )
      {
        ...
        if ( v66 )
        {
          ...
          if ( v63 )
            ...
            LODWORD(v68) = 0;
          IoAddTriageDumpDataBlock(v68, (PVOID)0x310);
          if ( *(_WORD *)(v67 + 40) )
          {
          ...
          if ( *(_WORD *)(v69 + 56) )
          {
            ...
            if ( v71 )
              ...
              v73 = 0LL;
            IoAddTriageDumpDataBlock(*(_QWORD *)(v73 + 64), (PVOID)*(unsigned __int16 *)(v72 + 56));
            v63 = *(_QWORD *)(a1 + 32);
          }
          if ( v63 )
          {
            ...
            if ( *(_WORD *)(*(_QWORD *)(v75 + 16) + 56LL) )
            {
              ...
              IoAddTriageDumpDataBlock(
                *(_QWORD *)(*(_QWORD *)(v5 + 16) + 64LL),
                (PVOID)*(unsigned __int16 *)(*(_QWORD *)(v78 + 16) + 56LL));
              v63 = *(_QWORD *)(a1 + 32);
            }
          }
        }
        ...
        if ( v49 )
        {
          ...
          if ( *(_WORD *)(v52 + 56) )
          {
            ...
            if ( v54 )
              ...
              v56 = 0LL;
            IoAddTriageDumpDataBlock(*(_QWORD *)(v56 + 64), (PVOID)*(unsigned __int16 *)(v55 + 56));
            v46 = *(_QWORD *)(a1 + 32);
          }
          if ( v46 )
          {
            ...
            if ( *(_WORD *)(*(_QWORD *)(v58 + 16) + 56LL) )
            {
              ...
              IoAddTriageDumpDataBlock(
                *(_QWORD *)(*(_QWORD *)(v62 + 16) + 64LL),
                (PVOID)*(unsigned __int16 *)(*(_QWORD *)(v61 + 16) + 56LL));
              v46 = *(_QWORD *)(a1 + 32);
            }
          }
        }
