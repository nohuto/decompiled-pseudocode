/*
 * XREFs of SdbResolveDatabaseEx @ 0x140924C00
 * Callers:
...
__int64 __fastcall SdbResolveDatabaseEx(__int64 a1, _QWORD *a2, int *a3, int *a4, _WORD *a5, int a6)
{
  ...
  *a5 = 0;
  ...
  v14 = (GUID **)*((unsigned int *)&off_140428030 + 6 * (int)v15 + 4);
  v18 = *((_DWORD *)&off_140428030 + 6 * (int)v15 + 2);
  v19 = *((_DWORD *)&off_140428030 + 6 * (int)v15 + 3);
  a6 = v18;
  v32 = v19;
  if ( !(_DWORD)v14 )
  {
