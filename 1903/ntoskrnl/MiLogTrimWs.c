/*
 * XREFs of MiLogTrimWs @ 0x140129EAC
 * Callers:
...
void __fastcall MiLogTrimWs(__int64 a1, __int64 a2, __int64 a3, int a4, int a5)
{
  ...
  if ( hProvider )
  {
    MiFillLogProcessInfo(a1, &v16, &psz, *(_QWORD *)(qword_140466188 + 8LL * *(unsigned __int16 *)(a1 + 174)));
    if ( v9->LevelPlus1 > 5 )
    {
      if ( TlgKeywordOn(v9, 1uLL) )
      {
        ...
        v49 = 4;
        v52 = 4;
        TlgWriteEx(v14, &unk_14038D8C5, 0LL, v13, 0LL, 0LL, 0xCu, &pData);
      }
    }
  }
}
