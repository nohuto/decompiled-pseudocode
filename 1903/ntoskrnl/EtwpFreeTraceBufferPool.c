/*
 * XREFs of EtwpFreeTraceBufferPool @ 0x1406B7440
 * Callers:
...
__int64 __fastcall EtwpFreeTraceBufferPool(unsigned int *a1)
{
  ...
  if ( UsedProcessorCount )
  {
    ...
    do
    {
      if ( (a1[3] & 0x10000000) != 0 )
        ...
        v11 = (volatile __int64 *)(*(_QWORD *)(*(_QWORD *)(*((_QWORD *)a1 + 139) + 4136LL) + v9) + 8 * v1);
  ...
  {
    _InterlockedDecrement((volatile signed __int32 *)a1 + 62);
    v17 = (__int64 *)*((_QWORD *)a1 + 146);
    ++v3;
    goto LABEL_22;
  }
  while ( 1 )
  {
    v14 = (__int64 *)*((_QWORD *)a1 + 150);
    if ( !v14 )
      break;
    v18 = *v14;
    v17 = v14 - 4;
...
LABEL_22:
  ...
  _InterlockedExchangeAdd((volatile signed __int32 *)(*((_QWORD *)a1 + 139) + 4LL * (a1[79] & 1) + 4116), -(v3 * a1[1]));
  return 0LL;
}
