/*
 * XREFs of MiAllocateMdlPagesByLists @ 0x1401569B4
 * Callers:
...
LABEL_21:
    ...
    ++v8;
    *v27++ = v22;
    v25 = dword_140465AB0 & v22 | (*(_QWORD *)(v21 + 40) >> 58 << byte_140465A4D) | (((*(_QWORD *)(v21 + 40) >> 36) & 3) << byte_140465A4E);
    v14 = v25 & ~dword_140465A40 | dword_140465A40 & (v25 + 1);
    if ( v8 >= a6 )
      goto LABEL_21;
    v16 = a3;
  }
