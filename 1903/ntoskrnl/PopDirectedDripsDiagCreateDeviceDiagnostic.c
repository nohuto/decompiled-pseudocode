/*
 * XREFs of PopDirectedDripsDiagCreateDeviceDiagnostic @ 0x1408B7D0C
 * Callers:
      ...
      if ( ((v7 + 0x80000000) & 0x80000000) != 0 || v7 == -1073741772 )
      {
        ...
        if ( ((v7 + 0x80000000) & 0x80000000) != 0 || v7 == -1073741772 )
        {
          ...
          if ( ((v7 + 0x80000000) & 0x80000000) != 0 || v7 == -1073741772 )
          {
            ...
            *((_DWORD *)v5 + 30) = a2;
            *(_QWORD *)(a1 + 776) = v5;
            v14 = (_QWORD *)qword_140436E58;
            if ( *(__int64 **)qword_140436E58 != &PopDirectedDripsDiagList )
              __fastfail(3u);
            *(_QWORD *)v5 = &PopDirectedDripsDiagList;
            v7 = 0;
            *((_QWORD *)v5 + 1) = v14;
            *v14 = v5;
            qword_140436E58 = (__int64)v5;
          }
        }
      }
    }
