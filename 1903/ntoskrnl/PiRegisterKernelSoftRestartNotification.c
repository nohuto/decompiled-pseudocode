/*
 * XREFs of PiRegisterKernelSoftRestartNotification @ 0x140876128
 * Callers:
  ...
  else
  {
    ...
    if ( PoolWithTag )
    {
      ...
      else
      {
        ...
        v11 = (_QWORD *)qword_14045EEA8;
        if ( *(PVOID **)qword_14045EEA8 != &PnpKsrNotifyList )
          __fastfail(3u);
        *v10 = &PnpKsrNotifyList;
        v10[1] = v11;
        *v11 = v10;
        qword_14045EEA8 = (__int64)v10;
