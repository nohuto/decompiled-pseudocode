/*
 * XREFs of KiHeteroChooseTargetProcessor @ 0x1402AF588
 * Callers:
 ...
 *     KiFindBiasedProcessorIndex @ 0x1401BE53C (KiFindBiasedProcessorIndex.c)
 *     KiIsFavoredCoreRotationActive @ 0x1401BE7C0 (KiIsFavoredCoreRotationActive.c)
