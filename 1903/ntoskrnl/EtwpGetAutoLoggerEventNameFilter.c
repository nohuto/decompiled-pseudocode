/*
 * XREFs of EtwpGetAutoLoggerEventNameFilter @ 0x1408FDBD4
 * Callers:
  ...
  if ( PoolWithTag )
  {
    ...
    *(_OWORD *)&ObjectAttributes.SecurityDescriptor = 0LL;
    ...
    if ( v39 )
    {
      ...
      do
        ++v8;
      while ( *(_WORD *)(v39 + 2 * v8) );
      v20 = (unsigned int)(2 * (v8 + v19) + 4);
    ...
    *a4 = v23;
    ...
    if ( v23 )
    {
      ...
      LODWORD(v52[39]) = 1;
      v50 = 1;
      if ( (int)RtlpQueryRegistryValues(0x40000000u, (const WCHAR *)KeyHandle, (__int64)v52, 0LL) >= 0 )
      {
        ...
        if ( Handle )
        {
          ...
          RtlpQueryRegistryValues(0x40000000u, v25, (__int64)v52, 0LL);
        }
