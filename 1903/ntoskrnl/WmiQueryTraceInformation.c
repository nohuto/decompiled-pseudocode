/*
 * XREFs of WmiQueryTraceInformation @ 0x140716B20
 * Callers:
  ...
  if ( TraceInformationClass > TraceHandleByNameClass )
  {
    ...
    if ( v16 )
    {
      ...
      if ( !v18 )
      {
        ...
        *((_OWORD *)TraceInformation + 1) = *(_OWORD *)off_14094A5E0;
        *((_OWORD *)TraceInformation + 2) = *(_OWORD *)&off_14094A5F0;
        *((_OWORD *)TraceInformation + 3) = *(_OWORD *)&off_14094A600;
        *((_OWORD *)TraceInformation + 4) = *(_OWORD *)off_14094A610;
        *((_OWORD *)TraceInformation + 5) = *(_OWORD *)&off_14094A620;
        *((_OWORD *)TraceInformation + 6) = *(_OWORD *)off_14094A630;
...
LABEL_24:
    ...
    {
      v44 += *(_QWORD *)(*(_QWORD *)(*(_QWORD *)(*((_QWORD *)v47 + 139) + 4136LL) + ((unsigned __int64)i << 6) + 8)
                       + 8LL * v53);
      v56 = v44;
    }
