/*
 * XREFs of ExInitLicenseData @ 0x140A0D9CC
 * Callers:
...
__int64 ExInitLicenseData()
{
  ...
  qword_1409AD3C0 = (__int64)sub_140622710;
  Time.QuadPart = 0LL;
  qword_1409AD4C8 = (__int64)ExUpdateLicenseDataInternal;
  qword_1409AD4D0 = (__int64)sub_1406AB150;
...
LABEL_19:
  ...
  if ( v9 && ($6EAC78A6FCFADE0A5FA44F358736B38F *)v4->ApcState.ApcListHead[0].Flink != &v4->152 )
...
LABEL_136:
    ...
    if ( v9 && ($6EAC78A6FCFADE0A5FA44F358736B38F *)v61->ApcState.ApcListHead[0].Flink != &v61->152 )
...
LABEL_35:
    ...
    if ( v9 && ($6EAC78A6FCFADE0A5FA44F358736B38F *)v21->ApcState.ApcListHead[0].Flink != &v21->152 )
      KiCheckForKernelApcDelivery(v28);
    KeLeaveCriticalRegionThread((__int64)KeGetCurrentThread());
    if ( !v0 && v19 )
      sub_14090C6A4(&KernelLicensingCacheCorrupt);
    if ( v18 >= 0 && !v19 )
      ExUpdateLicenseDataInternal(dword_140A50154, (unsigned int *)off_1409AD038);
    v29 = &v88;
    v30 = 16LL;
    do
    {
...
LABEL_70:
    ...
    if ( v9 && ($6EAC78A6FCFADE0A5FA44F358736B38F *)v34->ApcState.ApcListHead[0].Flink != &v34->152 )
...
LABEL_90:
    ...
    if ( v9 && ($6EAC78A6FCFADE0A5FA44F358736B38F *)v50->ApcState.ApcListHead[0].Flink != &v50->152 )
