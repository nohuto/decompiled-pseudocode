/*
 * XREFs of RtlpHpVsChunkSplit @ 0x1400620A0
 * Callers:
...
LABEL_128:
        ...
        if ( v55 && ($6EAC78A6FCFADE0A5FA44F358736B38F *)v79->ApcState.ApcListHead[0].Flink != &v79->152 )
    ...
    *(_DWORD *)(v24 + 8) = (unsigned __int8)(RtlpHpHeapGlobals ^ v24 ^ ((unsigned int)(v24 - a2) >> 12));
    ...
    for ( i = 0; ; i = v30 )
    {
      ...
      *(_BYTE *)(v24 + 6) = BYTE6(RtlpHpHeapGlobals) ^ BYTE6(v24);
      if ( (_WORD)v29 )
      {
        ...
        {
          RtlpHpVsFreeChunkRemove(a1, a2, (_DWORD *)v31);
      ...
      if ( v34 < v28 + 16 * (unsigned __int64)v33 )
      {
        ...
        {
          RtlpHpVsFreeChunkRemove(a1, a2, (_DWORD *)v34);
          v33 = *(_WORD *)(a2 + 32);
          v28 = a2 + 48;
          i = v103;
          v30 += WORD1(v35);
          ...
          ((v24 + 4111) & 0xFFFFFFFFFFFFF000uLL) - v24 < 16 * (unsigned __int64)v42) )
    {
      ...
      *(_WORD *)(v68 + 2) = v67;
      v70 = v68 + 16LL * v67;
      v71 = v68 ^ *(_QWORD *)v68;
      LOWORD(v103) = (_WORD)v69;
      *v69 = RtlpHpHeapGlobals ^ v71;
...
LABEL_107:
      ...
      RtlRbInsertNodeEx(a1 + 16, v74, v75, v69 + 1);
    }
    else
    {
      v43 = (unsigned __int64 *)(a1 + 16);
    ...
    *(_WORD *)v24 = RtlpHpHeapGlobals ^ v24 ^ (v47 + (v48 >> 12) - v50);
    ...
    if ( v11 )
    {
      while ( 1 )
      {
        if ( ((unsigned int)RtlpHpHeapGlobals ^ (unsigned int)v24 ^ *(_DWORD *)v24) < (*(_DWORD *)(v11 - 8) ^ (unsigned int)RtlpHpHeapGlobals ^ ((_DWORD)v11 - 8)) )
        {
          v53 = *(_QWORD *)v11;
          if ( (v51 & 1) != 0 )
          {
...
LABEL_56:
    ...
    RtlRbInsertNodeEx(v43, v11, v52, v24 + 8);
  }
  return a4;
}
