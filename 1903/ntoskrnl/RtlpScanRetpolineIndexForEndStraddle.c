/*
 * XREFs of RtlpScanRetpolineIndexForEndStraddle @ 0x140097E9C
 * Callers:
 *     RtlCreateRetpolineRelocationInformation @ 0x1400976CC (RtlCreateRetpolineRelocationInformation.c)
 * Callees:
 *     RtlSizeOfRetpolineIndirectFixup @ 0x1400980EC (RtlSizeOfRetpolineIndirectFixup.c)
 */
