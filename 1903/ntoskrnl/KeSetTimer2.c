...
_BOOL8 __fastcall KeSetTimer2(__int64 a1, __int64 SystemTime, __int64 a3, __int64 a4)
{
  __int64 v5; // r15
  __int64 v6; // rsi
  char v8; // r12
  ...
  if ( (v8 & 4) != 0 )
    InterruptTimePrecise = RtlGetInterruptTimePrecise(&v28, SystemTime, a3);
  else
  ...
  if ( !(unsigned __int8)KiAcquireTimer2LockUnlessDisabled(a1) )
  {
    ...
    *(_BYTE *)(a1 + 128) = v10;
    ...
    if ( v16 == 1 )
    {
      ...
      KiInsertTimer2WithCollectionLockHeld(a1, 1LL, &v26, &v25);
    }
