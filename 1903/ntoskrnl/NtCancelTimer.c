/*
 * XREFs of NtCancelTimer @ 0x140007A80
 * Callers:
 *     <none>
 * Callees:
...
LABEL_45:
      ...
      if ( v24 && ($6EAC78A6FCFADE0A5FA44F358736B38F *)v34->ApcState.ApcListHead[0].Flink != &v34->152 )
    ...
    {
      if ( byte_140467440[(((unsigned __int64)&ExpWakeTimerLock >> 39) & 0x1FF) - 256] == 1 )
      {
...
LABEL_27:
    ...
    if ( v24 && ($6EAC78A6FCFADE0A5FA44F358736B38F *)v33->ApcState.ApcListHead[0].Flink != &v33->152 )
      KiCheckForKernelApcDelivery();
