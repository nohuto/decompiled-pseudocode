/*
 * XREFs of CmpBounceContextStart @ 0x1405FE880
 * Callers:
...
__int64 __fastcall CmpBounceContextStart(__int64 a1, void *a2, size_t a3, __int64 a4, char a5)
{
  ...
  *(_QWORD *)a1 = a2;
  ...
  if ( !qword_140463868 || !(_DWORD)a4 && (unsigned __int8)CmpIsBufferGloballyVisible(a2) )
  {
LABEL_10:
    ...
    && (stru_140425BC0.KeywordAll & 4) == stru_140425BC0.KeywordAll )
  {
    ...
    v18 = 1LL;
    v20 = 8LL;
    TlgWriteAgg((__int64)&stru_140425BC0, (unsigned __int8 *)dword_14038BB6E, a3, a4, 5u, &v14);
  }
  if ( a3 <= 0x40 )
  {
...
LABEL_13:
  ...
  if ( a3 <= 0x1000 )
  {
    ...
    if ( TransientPoolWithQuotaTag
      || (++dword_1404F3058,
          (TransientPoolWithQuotaTag = (void *)((__int64 (__fastcall *)(_QWORD, _QWORD, _QWORD, union _SLIST_HEADER *))qword_1404F3070)(
                                                 (unsigned int)dword_1404F3064,
                                                 (unsigned int)dword_1404F306C,
                                                 (unsigned int)dword_1404F3068,
