/*
 * XREFs of MiDecommitPages @ 0x140057740
 * Callers:
        ...
        _QWORD *a6)
{
  ...
  if ( qword_140465B00 )
  {
    if ( (qword_140465B00 & 0x200) != 0 )
      v12 = 528LL;
    else
      v12 = qword_140465B00 | 0x200;
  }
...
LABEL_10:
  ...
  v131 = v22;
  v26 = *(_BYTE *)(v22 + 184) & 7;
  v142 = *(_QWORD *)(qword_140466188 + 8 * v21);
  if ( v26 < 6u )
  {
    if ( v26 == 2 )
      v28 = &dword_140467200;
...
LABEL_191:
      ...
      if ( (v48 & 0x800) != 0 )
      {
        ...
        if ( !*(_WORD *)(v100 + 32) )
        {
          ...
          v103 = v99;
          v155 = v99;
          v106 = *(_QWORD *)(qword_140466188 + 8 * ((v105 >> 40) & 0x3FF));
          v142 = v106;
          if ( (v99 & 2) != 0 )
        ...
        if ( !v104 )
        {
          ...
          if ( qword_140465B00 && (v103 & 0x10) == 0 )
            v103 &= ~qword_140465B00;
...
LABEL_224:
      ...
      v111 = v48;
      if ( qword_140465B00 && (v48 & 0x10) == 0 )
        v111 = v48 & ~(_WORD)qword_140465B00;
      ...
      if ( v23 >= 0xFFFFF6FB7DBED000uLL && v23 <= 0xFFFFF6FB7DBED7F8uLL )
      {
        ...
        {
          if ( !HIBYTE(word_140465BEC) && (v113 & 1) != 0 )
