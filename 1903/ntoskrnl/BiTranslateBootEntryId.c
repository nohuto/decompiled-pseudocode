/*
 * XREFs of BiTranslateBootEntryId @ 0x140932308
 * Callers:
 *     BiBindEfiBootManager @ 0x14092FC10 (BiBindEfiBootManager.c)
 *     BiTranslateBootOrder @ 0x140932368 (BiTranslateBootOrder.c)
 * Callees:
 *     BiLogMessage @ 0x14073E4B4 (BiLogMessage.c)
 *     BiLookupObjectByBootEntry @ 0x140931EC8 (BiLookupObjectByBootEntry.c)
 */
