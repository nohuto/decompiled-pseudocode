/*
 * XREFs of MiGetPagesToZero @ 0x140029C50
 * Callers:
 ...
 *     KeFindFirstSetLeftGroupAffinity @ 0x14012D3E0 (KeFindFirstSetLeftGroupAffinity.c)
...
__int64 __fastcall MiGetPagesToZero(__int64 a1, unsigned __int64 a2, unsigned int a3)
{
  ...
  v5 = *(_DWORD *)(a2 + 244) >> byte_140465A4D;
  *(_QWORD *)(a2 + 32) = 0LL;
  ...
  while ( 1 )
  {
    ...
    if ( v34 != 0xFFFFFFFFFLL )
      break;
    v31 = dword_140465A40 & (v31 + 1) | v31 & ~dword_140465A40;
    *(_DWORD *)(a2 + 244) = v31;
LABEL_37:
    if ( v31 == v33 )
      goto LABEL_38;
