/*
 * XREFs of ExAcquireSharedWaitForExclusive @ 0x14016A810
 * Callers:
 *     FsRtlAcquireFileForModWriteEx @ 0x14011DBF8 (FsRtlAcquireFileForModWriteEx.c)
 *     ExEnterCriticalRegionAndAcquireSharedWaitForExclusive @ 0x14033A8D0 (ExEnterCriticalRegionAndAcquireSharedWaitForExclusive.c)
 * Callees:
