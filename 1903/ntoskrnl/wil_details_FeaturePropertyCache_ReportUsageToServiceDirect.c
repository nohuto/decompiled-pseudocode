/*
 * XREFs of wil_details_FeaturePropertyCache_ReportUsageToServiceDirect @ 0x1400AF904
 * Callers:
 ...
 * Callees:
 *     wil_details_RecordUsageInPropertyCache @ 0x1400AF9E0 (wil_details_RecordUsageInPropertyCache.c)
