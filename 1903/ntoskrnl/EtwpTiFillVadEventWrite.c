/*
 * XREFs of EtwpTiFillVadEventWrite @ 0x14033104C
 * Callers:
 ...
 *     EtwpTiFillVad @ 0x140330FAC (EtwpTiFillVad.c)
 */
  ...
  if ( a6 )
  {
    ...
    do
    {
      ...
      else
      {
        ...
        v13->Reserved = 0;
        v13->Ptr = (ULONGLONG)&unk_14039ED58;
        v13->Size = 4;
        v13[1].Reserved = 0;
        v13[1].Ptr = (ULONGLONG)&unk_14039ED58;
        v13[1].Size = 8;
        v13[2].Reserved = 0;
        v13[2].Ptr = (ULONGLONG)&unk_14039ED58;
        v13[2].Size = 4;
        v13[3].Reserved = 0;
        v13[3].Ptr = (ULONGLONG)&unk_14039ED58;
        v13[3].Size = 4;
        v13[4].Reserved = 0;
        v13[4].Ptr = (ULONGLONG)&unk_14039ED58;
        v13[4].Size = 8;
        v13[5].Reserved = 0;
        v13[5].Ptr = (ULONGLONG)&unk_14039ED58;
        v13[5].Size = 8;
        v13[6].Reserved = 0;
        UserDataCount += 7;
        v13[6].Ptr = (ULONGLONG)&unk_14039ED58;
        v13[6].Size = 2;
      }
      ++v7;
    }
