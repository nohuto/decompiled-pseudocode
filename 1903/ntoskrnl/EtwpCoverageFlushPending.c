/*
 * XREFs of EtwpCoverageFlushPending @ 0x1406BD290
 * Callers:
...
int *__fastcall EtwpCoverageFlushPending(int **a1)
{
  ...
  if ( *((_DWORD *)a1 + 16) )
  {
    ...
    v9 = *((_WORD *)a1 + 32);
    if ( stru_140426688.LevelPlus1 > 5 )
    {
      if ( TlgKeywordOn(&stru_140426688, 0x400000000000uLL) )
      {
        v5 = *a1;
        v6 = *((_WORD *)v3 + 12);
        v10 = **a1;
        ...
        v30 = *((_QWORD *)v3 + 4);
        v32 = 0;
        v31 = (unsigned __int16)(v6 - v30);
        v16 = 4;
        v19 = 4;
        v22 = 4;
        v25 = 4;
        v28 = 2;
        TlgWrite(&stru_140426688, &unk_14039357E, 0LL, 0LL, 8u, &pData);
      }
    }
