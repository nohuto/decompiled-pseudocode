/*
 * XREFs of MiProbeAndLockPrepare @ 0x14008FB20
 * Callers:
        ...
        int a7)
{
  ...
  *(_QWORD *)(a1 + 32) = 0LL;
  if ( v19 >= 0xFFFF800000000000uLL )
    v20 = byte_140467440[((v19 >> 39) & 0x1FF) - 256];
  else
    v20 = 0;
  if ( v19 >= 0x7FFFFFFF0000LL )
  {
    ...
    if ( v20 == 6 )
    {
      v22 = (char *)&unk_140466D00;
      v32 = *(_DWORD *)(a1 + 64) & 0xFFFFFFF3;
      *(_QWORD *)(a1 + 96) = &unk_140466D00;
      v21 = v32 | 3;
    }
    else
    {
...
LABEL_14:
  ...
  *(_BYTE *)(a1 + 68) = CurrentIrql;
  ...
  if ( v20 == 8 )
  {
    ...
    if ( (v34 & 1) == 0 )
      v35 = v34;
    *(_QWORD *)(a1 + 96) = *(_QWORD *)(qword_140466188 + 8LL * (*(_WORD *)(*(_QWORD *)v35 + 60LL) & 0x3FF)) + 0x2000LL;
  }
  return 0LL;
}
