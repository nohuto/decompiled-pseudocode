/*
 * XREFs of MiGetWorkingSetInfoList @ 0x140101184
 * Callers:
...
LABEL_231:
    ...
    if ( ((v19 & 0xFFFFFFFFFFFFF000uLL) == 0x7FFE0000
       || (v19 & 0xFFFFFFFFFFFFF000uLL) == qword_140465A20 && qword_140465A20)
...
LABEL_182:
    ...
    else
    {
      ...
      if ( !v51 || (unsigned int)MiIsPrototypePteVadLookup(v33) )
        goto LABEL_87;
      if ( qword_140465B00 )
      {
        if ( (v51 & 0x10) != 0 )
