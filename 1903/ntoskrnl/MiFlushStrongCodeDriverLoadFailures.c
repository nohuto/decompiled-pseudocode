/*
 * XREFs of MiFlushStrongCodeDriverLoadFailures @ 0x1409F1470
 * Callers:
...
_QWORD *MiFlushStrongCodeDriverLoadFailures()
{
  ...
  while ( 1 )
  {
    v1 = (unsigned __int16 *)qword_140464908;
    if ( qword_140464908 == &qword_140464908 )
      break;
    if ( *((PVOID **)qword_140464908 + 1) != &qword_140464908
      || (v3 = *(_QWORD *)qword_140464908, *(PVOID *)(*(_QWORD *)qword_140464908 + 8LL) != qword_140464908) )
    {
      __fastfail(3u);
    }
    qword_140464908 = *(PVOID *)qword_140464908;
    *(_QWORD *)(v3 + 8) = &qword_140464908;
    if ( hProvider->LevelPlus1 > 5 && TlgKeywordOn(hProvider, 0x400000000000uLL) )
    {
      ...
      v20 = 4;
      v23 = 4;
      TlgWriteEx(v7, &unk_14038D6DB, v6, (ULONG)v7, v8, v9, 7u, &pData);
    }
