/*
 * XREFs of KiEpfStart @ 0x1402B3424
 * Callers:
...
LABEL_6:
  ...
  if ( v6 )
  {
    _InterlockedIncrement(&dword_140446DB0);
    v7 = _InterlockedIncrement(&dword_140446DB4);
    do
      v10 = dword_140446DB8;
    while ( dword_140446DB8 < v7 && v10 != _InterlockedCompareExchange(&dword_140446DB8, v7, dword_140446DB8) );
    v11 = KeSetKernelStackSwapEnable(0);
    KeWaitForGate((__int64)&v12[3], 39);
    KeSetKernelStackSwapEnable(v11);
    _InterlockedDecrement(&dword_140446DB4);
  }
}
