/*
 * XREFs of MiMapViewOfImageSection @ 0x1405EA270
 * Callers:
        ...
        char a8)
{
  ...
  v109 = v13;
  if ( dword_14046488C
    && dword_140464890 == *(_DWORD *)(v13 + 60)
    && dword_140464894 == *(_DWORD *)(*(_QWORD *)(v10 + 56) + 68LL) )
  {
    __debugbreak();
  }
...
LABEL_98:
            ...
            if ( (v54 & 0x10) == 0 || (PerSessionProtos = MiCommitVadCfgBits(v23, 0LL, 0LL), PerSessionProtos >= 0) )
            {
              if ( *(_QWORD *)(a2 + 80) )
              {
                ...
                if ( PerSessionProtos < 0 )
                  goto LABEL_238;
                **(_QWORD **)(a2 + 80) = v12 ^ v108 ^ qword_140465A28;
                v63 = 0LL;
              }
              else
              {
                ...
                || (v63 = MiAddSecureEntry(v23, (_DWORD)v104 << 12, ((_DWORD)v110 << 12) | 0xFFFu, -2147483647, 0)) != 0 )
              {
                ...
                if ( v63 )
                  MmUnsecureVirtualMemory((HANDLE)(v12 ^ v63 ^ qword_140465A28));
                goto LABEL_98;
              }
              PerSessionProtos = -1073741670;
            }
