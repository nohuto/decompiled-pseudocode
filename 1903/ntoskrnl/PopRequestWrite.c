/*
 * XREFs of PopRequestWrite @ 0x14059A134
 * Callers:
 *     PopWriteHiberImage @ 0x140599B0C (PopWriteHiberImage.c)
 *     PopCompressCallback @ 0x14059A110 (PopCompressCallback.c)
 * Callees:
...
char __fastcall PopRequestWrite(ULONG_PTR BugCheckParameter3, __int64 a2, unsigned int a3)
{
  ...
  ULONG MaxDataSize[2]; // [rsp+50h] [rbp-48h] BYREF
  ...
  for ( i = BugCheckParameter3; ; *(_QWORD *)(i + 336) = v27 )
  {
    while ( 1 )
    {
      ...
      if ( v8 == 1 )
      {
        BugCheckParameter4 = (*(int (__fastcall **)(__int64, ULONG_PTR, __int64))(*(_QWORD *)(i + 168) + 128LL))(
                               ...
                               v6);
        v31 = __rdtsc();
        qword_140443560 += (((unsigned __int64)HIDWORD(v31) << 32) | (unsigned int)v31) - v19;
      ...
      {
        qword_140443558 += v18 - *(_QWORD *)(i + 336);
        ProducerConsumerBufferComplete(v5, v5 + 48, *(_QWORD *)(i + 384), *(_DWORD *)(i + 360));
        v20 = __rdtsc();
        qword_140443580 += (((unsigned __int64)HIDWORD(v20) << 32) | (unsigned int)v20) - v19;
        qword_140443728 += *(_QWORD *)(i + 360);
        dword_140443730 += (unsigned __int64)(*(_QWORD *)(i + 352) + 4095LL) >> 12;
        v21 = *(_QWORD *)(i + 352);
        *(_QWORD *)(i + 376) += v21;
        *(_QWORD *)(i + 344) += v21;
        *(_QWORD *)(i + 352) = 0LL;
    ...
    *(_QWORD *)(i + 360) = v23;
    if ( v22 + v14 > qword_140443410 )
    {
      ...
      *(_QWORD *)MaxDataSize = MmGetNumberOfPhysicalPages(0LL);
      IoAddTriageDumpDataBlock((ULONG)MaxDataSize, (PVOID)(unsigned int)(v34 + 8));
      PopRecordHibernateDiagnosticInfo(i);
      IoAddTriageDumpDataBlock((ULONG)&PopHibernateDiagnosticInfo, (PVOID)0x80);
      KeBugCheckEx(0xA0u, 0xBuLL, qword_140443410, *(unsigned int *)(i + 184), RemainingHibernateRangeDataSize);
    }
    ...
    *(_QWORD *)(i + 352) = v14;
    ...
    v33 = __rdtsc();
    qword_140443560 += (((unsigned __int64)HIDWORD(v33) << 32) | (unsigned int)v33) - v27;
...
LABEL_18:
      ...
      v29 = __rdtsc();
      qword_140443560 += (((unsigned __int64)HIDWORD(v29) << 32) | (unsigned int)v29) - v27;
