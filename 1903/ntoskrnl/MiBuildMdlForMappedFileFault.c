/*
 * XREFs of MiBuildMdlForMappedFileFault @ 0x14002DEF0
 * Callers:
        ...
        _QWORD *a10)
{
  ...
  struct _RTL_BITMAP BitMapHeader; // [rsp+B0h] [rbp-50h] BYREF
  ...
  *(_QWORD *)&BitMapHeader.SizeOfBitMap = 512LL;
  ...
  do
  {
    ...
    if ( SizeOfBitMap > v26 )
    {
      ...
      if ( v30 != v29 && (*v30 | dword_14037C7E0[v26 & 0x1F]) == 0xFFFFFFFF )
      {
        ++v30;
        v28 = v26 - (v26 & 0x1F) + 32;
        v62 = v28;
      ...
      {
        v32 = v28 & 0x1F;
        if ( (*v30 & ~dword_14037C7E0[v28 & 0x1F]) == 0 )
        {
          v31 = 32 - v32;
          v61 = 32 - v32;
          if ( v32 == 33 )
      ...
      while ( 1 )
      {
        ...
        *(_QWORD *)(v44 + 16) = v43;
        ...
        if ( v66 )
        {
          ...
          {
            if ( !HIBYTE(word_140465BEC) && (v49 & 1) != 0 )
