/*
 * XREFs of ExpInitSystemPhase0 @ 0x140A18050
 * Callers:
...
char ExpInitSystemPhase0()
{
  ...
  qword_14042F618 = (__int64)&ExpSystemResourcesList;
  ...
  qword_14042F5B8 = (__int64)&ExNPagedLookasideListHead;
  ExNPagedLookasideListHead = (__int64)&ExNPagedLookasideListHead;
  qword_14042F588 = (__int64)&ExPagedLookasideListHead;
  ExPagedLookasideListHead = (__int64)&ExPagedLookasideListHead;
  qword_1404324B8 = (__int64)&ExpFirmwareTableProviderListHead;
