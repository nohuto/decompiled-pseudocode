/*
 * XREFs of PopDiagTraceDeviceReleaseIrp @ 0x140174C58
 * Callers:
 *     PoDeviceReleaseIrp @ 0x140174C20 (PoDeviceReleaseIrp.c)
 * Callees:
...
void __fastcall PopDiagTraceDeviceReleaseIrp(__int64 a1, __int64 a2)
{
  ...
  if ( PopDiagHandleRegistered )
  {
    ...
    if ( EtwEventEnabled(PopDiagHandle, &POP_ETW_EVENT_IRP_DRIVERRELEASE) )
    {
      ...
      v4 = &v8;
      v5 = 8;
      EtwWriteEx(v2, &POP_ETW_EVENT_IRP_DRIVERRELEASE, 0LL, 0, 0LL, 0LL, 2u, &UserData);
    }
  }
}
