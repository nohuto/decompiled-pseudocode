/*
 * XREFs of WheaWmiDispatch @ 0x14019BA10
 * Callers:
 *     <none>
 * Callees:
 *     WheapWmiRegisterInfo @ 0x14019BA6C (WheapWmiRegisterInfo.c)
 *     WheapWmiExecuteMethod @ 0x140342CBC (WheapWmiExecuteMethod.c)
 *     WheapWmiGetAllData @ 0x140342EE4 (WheapWmiGetAllData.c)
 *     WheapWmiGetSingleInstance @ 0x140342F48 (WheapWmiGetSingleInstance.c)
 */
