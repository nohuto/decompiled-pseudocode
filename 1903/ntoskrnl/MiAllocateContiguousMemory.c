/*
 * XREFs of MiAllocateContiguousMemory @ 0x140117C2C
 * Callers:
 *     MmAllocateContiguousNodeMemory @ 0x140117B90 (MmAllocateContiguousNodeMemory.c)
 *     MmAllocateContiguousMemory @ 0x1402C0C20 (MmAllocateContiguousMemory.c)
 * Callees:
 ...
 *     EtwpGetDurationSince @ 0x14032ED2C (EtwpGetDurationSince.c)
 */
        ...
        unsigned int a6)
{
  ...
  if ( !a4 || (v15 = 0, v14 <= a4) )
  {
    ...
    if ( v8 <= a3 && v8 + v14 > v8 && v8 + v14 - 1 <= a3 )
    {
      ...
      v22 = (_DWORD *)(qword_140465A50 + 4LL * v21 * (unsigned __int16)KeNumberNodes);
      if ( v20 == 0x80000000 )
...
LABEL_20:
      v42 = 135266304;
      v24 = (unsigned int *)(qword_140465A50 + 4LL * v21 * (unsigned __int16)KeNumberNodes);
