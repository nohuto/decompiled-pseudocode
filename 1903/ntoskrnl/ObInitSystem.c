/*
 * XREFs of ObInitSystem @ 0x140A04E20
 * Callers:
 ...
 *     ObpInitInfoBlockOffsets @ 0x140A17C88 (ObpInitInfoBlockOffsets.c)
...
char ObInitSystem()
{
  ...
  *(_QWORD *)&DestinationString.Length = 0LL;
  ...
  if ( !(_DWORD)InitializationPhase )
  {
    ...
    while ( v3 );
    ObpDefaultObject = 0;
    qword_140445B10 = (__int64)&qword_140445B08;
    qword_140445B08 = (__int64)&qword_140445B08;
    byte_140445B02 = 6;
    dword_140445B04 = 1;
    ...
    qword_140445B38 = (__int64)ObpProcessRemoveObjectDpcWorker;
