/*
 * XREFs of PoRegisterPowerSettingCallback @ 0x14069FF90
 * Callers:
 *     HvlpRegisterPowerPolicyCallbacks @ 0x14028B680 (HvlpRegisterPowerPolicyCallbacks.c)
...
LABEL_25:
    ...
    {
      v21 = (_QWORD *)qword_140442CC8;
      if ( *(__int64 **)qword_140442CC8 == &PopRegisteredPowerSettingCallbacks )
      {
        *(_QWORD *)v12 = &PopRegisteredPowerSettingCallbacks;
        *((_QWORD *)v12 + 1) = v21;
        *v21 = v12;
        qword_140442CC8 = (__int64)v12;
LABEL_18:
        v19 = 0;
