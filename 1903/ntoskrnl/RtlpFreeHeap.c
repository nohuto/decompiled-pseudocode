/*
 * XREFs of RtlpFreeHeap @ 0x140310A28
 * Callers:
...
__int64 RtlpFreeHeap(__int64 a1, int a2, __int64 a3, ...)
{
  ...
  int v44; // [rsp+68h] [rbp-40h]
  int v45; // [rsp+78h] [rbp-30h]
  ...
  v11 = RtlpCoalesceFreeBlocks(a1, a3, (ULONG_PTR *)RegionSizea);
  v46 = v11;
  v13 = RegionSize;
