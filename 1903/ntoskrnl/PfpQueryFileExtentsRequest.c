/*
 * XREFs of PfpQueryFileExtentsRequest @ 0x1408A0FA8
 * Callers:
        ...
        *((_WORD *)PoolWithTag + v14) = 92;
        ...
        if ( inited >= 0 )
        {
          ...
          if ( inited >= 0 )
          {
            ...
            inited = v17;
            if ( v17 == 259 )
              KeBugCheckEx(0x191u, 0xF69uLL, 0LL, 0LL, 0LL);
            if ( (v17 & 0xC0000000) != 0xC0000000 )
            {
              ...
              while ( 1 )
              {
                ...
                inited = v20;
                if ( v20 == 259 )
                  KeBugCheckEx(0x191u, 0xFA7uLL, 0LL, 0LL, 0LL);
                if ( v20 >= 0 )
                  break;
                if ( v20 == -1073741807 )
                  goto LABEL_43;
...
LABEL_43:
              ...
              inited = v21;
              if ( v21 == 259 )
                KeBugCheckEx(0x191u, 0xFE2uLL, 0LL, 0LL, 0LL);
              if ( v21 >= 0 )
              {
