/*
 * XREFs of EtwpEnableKernelTrace @ 0x1406E7358
 * Callers:
...
LABEL_57:
  ...
  {
    v14 |= 0x400u;
    qword_1404641A8 = (__int64)EtwpTraceIoInit;
    v27[0] = v14;
  }
  v15 = *((_DWORD *)a2 + 4);
  v16 = v27[4];
  ...
  {
    v16 = v27[4] | 1;
    qword_1404641B0 = (__int64)EtwpTraceOpticalIo;
    v15 = *((_DWORD *)a2 + 4);
    v27[4] |= 1u;
  }
  if ( (v15 & 2) != 0 )
  {
    v16 |= 2u;
    qword_1404641B8 = (__int64)EtwpTraceOpticalIoInit;
    v27[4] = v16;
  }
  ...
  {
    v16 |= 0x1000000u;
    qword_14042A8B0 = (__int64)EtwpTraceWdf;
    v17 = *((_DWORD *)a2 + 4);
    v27[4] = v16;
  }
  if ( (v17 & 0x2000000) != 0 )
  {
    v16 |= 0x2000000u;
    qword_14042A8B8 = (__int64)EtwpTraceWdf;
    v27[4] = v16;
  }
  if ( (*((_DWORD *)a2 + 2) & 0x8000000) != 0 )
  {
    v27[2] |= 0x8000000u;
    qword_14042A8C0 = (__int64)EtwpSystemTraceWdf;
  }
  v18 = *(_DWORD *)a2;
...
LABEL_50:
    ...
    if ( (v19 & 0x400) != 0 )
    {
      for ( i = 0; i < EtwpPmcProfile; ++i )
        KeStartProfile((ULONG_PTR)qword_140432AE8 + 248 * i);
      v27[1] = v10 | 0x400;
    }
