/*
 * XREFs of MiApplyDynamicRelocations @ 0x1409F00C0
 * Callers:
 ...
 *     LdrApplyDynamicRelocations @ 0x140187340 (LdrApplyDynamicRelocations.c)
...
__int64 __fastcall MiApplyDynamicRelocations(char *BaseAddress, ULONGLONG Size, __int64 a3, __int64 a4)
{
  unsigned int v6; // ebp
  NTSTATUS v8; // eax
  unsigned int *v9; // rcx
