/*
 * XREFs of ExpResizeBigPageTable @ 0x140156EA8
 * Callers:
...
__int64 __fastcall ExpResizeBigPageTable(char a1, __int64 a2, _QWORD *a3)
{
  ...
  *a3 = 0LL;
  ...
  if ( (a1 & 0x20) != 0 )
  {
    v4 = *(_QWORD **)(qword_1404659D8 + 1272);
    v5 = (int *)(qword_1404659D8 + 1144);
    v6 = *(_QWORD *)(qword_1404659D8 + 1280);
...
LABEL_16:
  ...
  *(_DWORD *)(v16 + 8 * v18 + 12) = v19;
  ...
  _InterlockedIncrement(&dword_140503A80);
  _InterlockedExchangeAdd64(&qword_140503A90, (int)(v9 >> 12));
  _InterlockedExchangeAdd64(qword_140503A98, v9);
  if ( v3 )
  {
    *(_QWORD *)(qword_1404659D8 + 1272) = v11;
    *(_QWORD *)(qword_1404659D8 + 1280) = v7;
  }
  else
  {
