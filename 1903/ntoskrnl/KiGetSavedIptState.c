/*
 * XREFs of KiGetSavedIptState @ 0x1402AAF20
 * Callers:
 *     <none>
 * Callees:
 *     KiGetSavedSupervisorState @ 0x1402AAFD0 (KiGetSavedSupervisorState.c)
 *     KiXSavesManagesIpt @ 0x1402AB334 (KiXSavesManagesIpt.c)
