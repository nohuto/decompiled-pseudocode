/*
 * XREFs of RtlFindLongestRunClearCapped @ 0x14030CD80
 * Callers:
...
LABEL_45:
    ...
    v16 = 8 * v14 - v15 + 8;
    for ( i = *((_BYTE *)&unk_140380E28 - v15) | byte_1403821E8[v21] | v18; ; i |= v25 )
    {
