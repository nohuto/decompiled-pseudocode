/*
 * XREFs of MiSharePages @ 0x14013EF30
 * Callers:
 ...
 *     MiGetCombineDomain @ 0x14013E5F0 (MiGetCombineDomain.c)
 ...
 *     MiPerformCombineScan @ 0x14013FF70 (MiPerformCombineScan.c)
 ...
 *     MiSetPfnPageState @ 0x1401427EC (MiSetPfnPageState.c)
 *     MiHashIsCommon @ 0x140142AF0 (MiHashIsCommon.c)
 *     MiPopCombineBlock @ 0x140142B4C (MiPopCombineBlock.c)
 *     MiPushCombineBlock @ 0x140142B7C (MiPushCombineBlock.c)
...
LABEL_99:
        ...
        if ( v118 != qword_1404660D0 && v123 == 1 )
        {
        ...
        *(_QWORD *)(v78 + 64) = BugCheckParameter2;
        if ( !(unsigned int)MiMapArbitraryPage(v79, v78, v117, v75, 1) )
        {
          if ( MiPteInShadowRange((unsigned __int64)v76) )
          {
            ...
            {
              if ( !HIBYTE(word_140465BEC) && (v80 & 1) != 0 )
        ...
        if ( !v33 )
        {
          if ( !(unsigned int)MiPerformCombineScan(v126, *(_QWORD *)v133, v118 == qword_1404660D0, v141)
            || v141[0] != v121 )
          {
            goto LABEL_138;
          }
