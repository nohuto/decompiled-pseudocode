/*
 * XREFs of VrpPreLoadKey @ 0x140845104
 * Callers:
...
__int64 __fastcall VrpPreLoadKey(_QWORD *a1, GUID *a2)
{
  ...
  *(_QWORD *)ActivityId.Data4 = 0LL;
  ...
  if ( stru_140425BF8.LevelPlus1 > 5 )
  {
    ...
    v71[0] = v9;
    v71[1] = 0;
    TlgWrite(&stru_140425BF8, &unk_14038C559, &ActivityId, 0LL, 4u, &pData);
  }
                        ...
                        NamespaceNodePlaceholderKey >= 0) )
                  {
                    ...
                    if ( NamespaceNodePlaceholderKey >= 0 )
                    {
                      ...
                      if ( stru_140425BF8.LevelPlus1 > 5 )
                      {
                        ...
                        v65 = &v38;
                        v66 = 4LL;
                        TlgWrite(&stru_140425BF8, &unk_14038C724, &ActivityId, 0LL, 7u, &v56);
                      }
                    }
                  }
                }
...
LABEL_58:
    ...
    && stru_140425BF8.LevelPlus1 > 2 )
  {
    ...
    v73 = &v39;
    v74 = 4LL;
    TlgWrite(&stru_140425BF8, &unk_14038C52F, &ActivityId, 0LL, 3u, &v72);
  }
  if ( v6 )
