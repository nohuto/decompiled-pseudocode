/*
 * XREFs of MiReferenceActiveSubsection @ 0x140072320
 * Callers:
    ...
    if ( v11 >= 2 )
    {
      if ( v11 == 2 && (a2 & 0x20) != 0 && v22 )
      {
        ...
        MiReturnCrossPartitionSectionCharges(
          *(_QWORD *)(qword_140466188 + 8LL * (*(_WORD *)(v23 + 60) & 0x3FF)),
          v8,
          v22);
        if ( !v4 )
...
LABEL_17:
    if ( (a2 & 0x20) != 0 )
    {
      ...
      __writecr8(v5);
      MiReturnCrossPartitionSectionCharges(*(_QWORD *)(qword_140466188 + 8LL * (*(_WORD *)(v3 + 60) & 0x3FF)), v8, v22);
      if ( !v4 )
