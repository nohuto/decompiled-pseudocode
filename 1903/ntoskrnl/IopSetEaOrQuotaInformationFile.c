/*
 * XREFs of IopSetEaOrQuotaInformationFile @ 0x140854B90
 * Callers:
 *     NtSetQuotaInformationFile @ 0x140858F30 (NtSetQuotaInformationFile.c)
 * Callees:
...
signed int __fastcall IopSetEaOrQuotaInformationFile(void *a1, unsigned __int64 a2, void *a3, ULONG a4)
{
  ...
  ULONG Flags; // eax
  struct _FILE_QUOTA_INFORMATION *PoolWithQuota; // rdi
  ULONG v25; // r12d
  int v26; // eax
  PMDL Mdl; // rcx
  char v28; // bl
...
LABEL_23:
        ...
        if ( (Flags & 4) != 0 )
        {
          ...
          {
            v30 = 0;
            PoolWithQuota = (struct _FILE_QUOTA_INFORMATION *)IopVerifierExAllocatePoolWithQuota(NonPagedPoolNx, a4);
