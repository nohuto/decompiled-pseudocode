/*
 * XREFs of MiZeroInParallelWorker @ 0x140123300
 * Callers:
...
void __fastcall MiZeroInParallelWorker(char *StartContext)
{
  ...
  v8 = -(int)MiCreateUltraThreadContext(v79, 0LL, 15LL);
  v9 = 0;
  v10 = v8 != 0 ? 0xF : 0;
  v67 = 0;
  v65 = v10;
...
LABEL_47:
        ...
        if ( !v10 )
        {
          ...
          while ( 1 )
          {
            v48 = MiReservePtes((__int64)&qword_1404669C0, (unsigned __int64 *)(unsigned int)v47);
            v77 = v48;
            v49 = v48;
            if ( v48 )
              break;
...
LABEL_120:
            *(_QWORD *)(v5 + 8 * v13 + 8) -= v47;
            ...
            MiReleasePtes((__int64)&qword_1404669C0, v49, v47);
            goto LABEL_34;
          }
          v56 = v69;
          while ( 2 )
...
LABEL_6:
  ...
  if ( v10 )
    MiDeleteUltraThreadContext((__int64)v79);
}
