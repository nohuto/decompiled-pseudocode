/*
 * XREFs of PopDiagTracePowerButtonBugcheck @ 0x1408B065C
 * Callers:
  ...
  if ( a1 == 7000 )
  {
    ...
    if ( pCallbackContext.LevelPlus1 > 5 )
    {
      if ( TlgKeywordOn(&pCallbackContext, 0x400000000000uLL) )
      {
        ...
        v37 = &v11;
        v38 = 4LL;
        TlgWrite(&pCallbackContext, &unk_140390D9C, 0LL, 0LL, 0xEu, &pData);
      }
    }
  }
  else if ( a1 == 15000 && pCallbackContext.LevelPlus1 > 5 && TlgKeywordOn(&pCallbackContext, 0x800000000000uLL) )
  {
    v10 = dword_140438A68;
    v9 = dword_140438A64;
    v3[0] = byte_140438AA8;
    v13[0] = qword_140438A70;
    v17 = &v10;
    v8 = dword_140438A78;
    v19 = &v9;
    v7 = dword_140438A7C;
    ...
    v37 = &v4;
    v38 = 4LL;
    TlgWrite(&pCallbackContext, &unk_140390EB9, 0LL, 0LL, 0xEu, &pData);
  }
}
