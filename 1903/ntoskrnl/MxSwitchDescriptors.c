/*
 * XREFs of MxSwitchDescriptors @ 0x140A3D74C
 * Callers:
 *     MxGetNextPage @ 0x1409F3A20 (MxGetNextPage.c)
 * Callees:
 *     MiPageToNode @ 0x1400A02E4 (MiPageToNode.c)
 *     MiInitializeBootMemoryDescriptor @ 0x1409F3B10 (MiInitializeBootMemoryDescriptor.c)
 */
...
unsigned __int64 *__fastcall MxSwitchDescriptors(unsigned int a1)
{
  ...
  v4 = (unsigned __int64 *)&qword_140A535F0[5 * a1];
  v5 = v4[4];
  while ( 2 )
  {
    if ( !v5 )
