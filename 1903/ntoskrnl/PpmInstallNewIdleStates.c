/*
 * XREFs of PpmInstallNewIdleStates @ 0x140194B00
 * Callers:
 *     PpmIdleInstallDefaultStates @ 0x140194AE0 (PpmIdleInstallDefaultStates.c)
 * Callees:
 ...
 *     PpmDeepestHardwareIdleState @ 0x140195048 (PpmDeepestHardwareIdleState.c)
 *     PpmResetIdlePolicy @ 0x140195080 (PpmResetIdlePolicy.c)
 *     PpmUpdateProcessorIdleAccounting @ 0x140195214 (PpmUpdateProcessorIdleAccounting.c)
  ...
  if ( (_DWORD)v9 )
  {
    ...
    if ( PoolWithTag )
    {
      ...
      *(_QWORD *)(v46 + 8) = v28;
      ...
      ((void (__fastcall *)(__int64, _DWORD *))off_1404243E8[0])(v33, v47);
