/*
 * XREFs of MiCheckLargePageOk @ 0x140A173F0
 * Callers:
...
__int64 __fastcall MiCheckLargePageOk(ULONG_PTR BugCheckParameter2)
{
  ...
  qword_140A505C0 = *(_QWORD *)(BugCheckParameter2 + 16);
  v3 = *(_QWORD *)qword_140A505C0;
  PsNtosImageBase = *(PVOID *)(qword_140A505C0 + 48);
  v4 = (char *)PsNtosImageBase + *(unsigned int *)(qword_140A505C0 + 64);
  ...
  if ( *(_QWORD *)(qword_140A505C0 + 48) < *(_QWORD *)(MxHalDataTableEntry + 48) )
  {
    v10 = qword_140A505C0;
  }
  else
