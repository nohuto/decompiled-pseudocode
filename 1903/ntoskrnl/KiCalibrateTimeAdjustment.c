/*
 * XREFs of KiCalibrateTimeAdjustment @ 0x14059AE90
 * Callers:
 *     <none>
 * Callees:
 ...
 *     KiPollFreezeExecution @ 0x14013D0FC (KiPollFreezeExecution.c)
 ...
 *     RtlWriteReleaseTickLock @ 0x140181894 (RtlWriteReleaseTickLock.c)
