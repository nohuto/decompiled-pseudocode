/*
 * XREFs of ?SetPartition@SC_MBR@@QEAAJKPEAU_SET_PARTITION_INFORMATION_EX@@@Z @ 0x14034BBC8
 * Callers:
...
__int64 __fastcall SC_MBR::SetPartition(SC_DISK **this, int a2, struct _SET_PARTITION_INFORMATION_EX *a3)
{
  ...
  if ( a2 )
  {
    v9 = SC_MBR::ReadPartitionTable(this, &v17);
    v10 = v17;
    v8 = v9;
    if ( v9 >= 0 )
    {
      ...
      if ( v11 )
      {
        ...
        do
        {
          v14 = v13[32];
          v4 = v13;
          if ( v14 > 0xFu || (v15 = 32801, !_bittest(&v15, v14)) )
          {
            if ( ++v3 == a2 )
              break;
          }
