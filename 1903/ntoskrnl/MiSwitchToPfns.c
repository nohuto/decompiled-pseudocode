/*
 * XREFs of MiSwitchToPfns @ 0x1409F26EC
 * Callers:
...
__int64 __fastcall MiSwitchToPfns(__int64 a1)
{
  ...
  v2 = MmPfnDatabase + 48 * qword_14046A340;
  if ( !qword_14046A340 && !*(_WORD *)(v2 + 32) )
  {
    v17 = MiLockPageInline(MmPfnDatabase + 48 * qword_14046A340);
...
LABEL_20:
      ...
      {
LABEL_55:
        if ( v8 <= qword_14046A348 && v6 + v8 > qword_14046A348 + 1 )
          i[4] = (unsigned int)(qword_14046A348 - v8 + 1);
      }
    }
  }
