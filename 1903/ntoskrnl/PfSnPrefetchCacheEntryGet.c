/*
 * XREFs of PfSnPrefetchCacheEntryGet @ 0x140659C2C
 * Callers:
    ...
    a3 = 37
       * (BYTE6(v26)
        ...
        * (BYTE5(v26)
         + 37
         * (BYTE4(v26)
          + 37 * (BYTE3(v26) + 37 * (BYTE2(v26) + 37 * (BYTE1(v26) + 37 * ((unsigned __int8)v10 + 11623883LL)))))));
    a2 = Buf2;
    v9 = *(_QWORD *)(a1 + 8) + 8LL * (((_DWORD)a3 + HIBYTE(v26)) & (unsigned int)((_DWORD)a4 - 1));
LABEL_5:
    while ( 1 )
    {
      v9 = *(_QWORD *)v9;
