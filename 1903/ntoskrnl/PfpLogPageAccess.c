/*
 * XREFs of PfpLogPageAccess @ 0x14065B730
 * Callers:
...
unsigned __int64 __fastcall PfpLogPageAccess(__int64 a1, unsigned __int64 a2, __int64 *a3, __int64 a4, int a5)
{
  ...
  {
    v14 = qword_140467658;
    v15 = *(unsigned int *)(qword_140467658 + 16);
    v16 = (qword_140467658 + 47) & 0xFFFFFFFFFFFFFFF8uLL;
    if ( *(_QWORD *)(v16 + 40 * v15) != v12 )
    {
      v40 = *(_DWORD *)(qword_140467658 + 32);
      a2 = (HIBYTE(v57)
          + 37
          * (BYTE6(v57)
           + 37
...
LABEL_55:
    ...
    if ( v53 < 3 * (*(_DWORD *)(v14 + 32) >> 2) )
      break;
    if ( (unsigned int)PfTReplaceCurrentBuffer(&unk_140467640, a2) == -1073741823 )
      return 0LL;
  }
  v13 = 1;
  *(_DWORD *)(v14 + 28) = v53 + 1;
...
LABEL_19:
      ...
      v29 = *v5;
      v30 = ((*v5 & 3) == 2) + 1;
      if ( (unsigned int)(v30 + *(_DWORD *)(qword_140467630 + 16)) > *(_DWORD *)(qword_140467630 + 20) )
      {
        while ( (unsigned int)PfTReplaceCurrentBuffer(&unk_140467618, v28) != -1073741823 )
        {
          v28 = qword_140467630;
          if ( (unsigned int)(v30 + *(_DWORD *)(qword_140467630 + 16)) <= *(_DWORD *)(qword_140467630 + 20) )
          {
...
LABEL_20:
  ...
  {
    v18 = (a1 ^ *(_QWORD *)(a1 + 784)) & 0x1FFFFFFFFFFFFFFFLL;
    goto LABEL_11;
  }
  v18 = a1;
LABEL_11:
  ...
  {
    v22 = qword_140467658;
    v23 = *(unsigned int *)(v21 + qword_140467658);
    v24 = (qword_140467658 + 47) & 0xFFFFFFFFFFFFFFF8uLL;
...
LABEL_13:
    ...
    else
    {
      ...
      if ( v44 == v19 )
      {
        *(_DWORD *)(v21 + qword_140467658) = v43;
...
LABEL_52:
        ...
        while ( 1 )
        {
          ...
          if ( v52 == v19 )
          {
            *(_DWORD *)(v21 + qword_140467658) = v50;
            LOWORD(v23) = v50;
            goto LABEL_13;
          }
          if ( !v52 )
...
LABEL_65:
    ...
    {
      if ( (unsigned int)PfTReplaceCurrentBuffer(&unk_140467640, v50) == -1073741823 )
        return 0LL;
      continue;
    }
    break;
...
LABEL_14:
  if ( v22 )
  {
    v25 = 2LL;
    v6 = v23 + *(_WORD *)(v22 + 36);
    v26 = 5LL * (unsigned __int16)v23;
    if ( v20 || (*(_BYTE *)(v24 + 8 * v26 + 8) & 4) != 0 )
    {
      v54 = *(_QWORD *)(v24 + 8 * v26 + 8);
      v5 = a3;
      if ( v17 )
      {
        *(_QWORD *)(v24 + 8 * v26 + 8) = v54 & 0xFFFFFFFFFFFFFFF8uLL | 5;
      }
      else
      {
        v55 = v54 & 0xFFFFFFFFFFFFFFF8uLL | 1;
        *(_QWORD *)(v24 + 8 * v26 + 8) = v55;
        *(_QWORD *)(v24 + 8 * v26 + 8) = v55 & 7 | (8 * (a1 ^ *(_QWORD *)(a1 + 784)));
        *(_DWORD *)(v24 + 8 * v26 + 28) = *(_DWORD *)(a1 + 1180);
        *(_DWORD *)(v24 + 8 * v26 + 24) = *(_DWORD *)(a1 + 744);
        *(_QWORD *)(v24 + 8 * v26 + 16) = a1;
      }
    }
    else
    {
