/*
 * XREFs of WbInitializeEncryptionSegment @ 0x1405B4334
 * Callers:
        ...
        else
        {
          ...
          *(_QWORD *)(a3 + 32) = *(_QWORD *)&v42[2].cache - (_QWORD)v23;
          ...
          if ( (unsigned int)wil_details_FeaturePropertyCache_ReportUsageToServiceDirect(
            ...
            && g_wil_details_pfnFeatureLoggingHook )
          {
            g_wil_details_pfnFeatureLoggingHook(0xE67B5Au, &stru_14037B9B0, 0LL, 0, v37, 0LL, 0, 1uLL);
          }
          if ( *(_DWORD *)(a3 + 48) )
          {
            v9 = -1073741811;
