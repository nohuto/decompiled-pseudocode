/*
 * XREFs of EtwpWriteAppStateChangeSummary @ 0x140634D1C
 * Callers:
        ...
        unsigned __int16 *a6)
{
  ...
  memset(&v58[1], 0, 21);
  v10 = TraceLoggingProviderEnabled(&stru_140426650, 0, 0x200000000000uLL);
  v12 = *(_DWORD *)(a1 + 1620);
  if ( v10 )
  ...
  {
    LOBYTE(v16) = TlgKeywordOn(&stru_140426650, 0x400000000000uLL);
    if ( (_BYTE)v16 )
    {
      v18 = *a2;
      v14 = *a2 == 1;
      ...
      if ( a3 )
      {
        ...
        v39 = v26;
        v40 = v12 == 1;
        v26 = ((unsigned __int64)*(unsigned __int8 *)(a1 + 1787) >> 6) & 1;
      }
      else
      {
        v39 = 0LL;
      ...
      v121[1] = 0;
      v123 = 29LL;
      LOBYTE(v16) = TlgWriteAgg((__int64)&stru_140426650, (unsigned __int8 *)dword_140393827, v30, v31, 0x23u, &v59);
    }
  }
  return v16;
}
