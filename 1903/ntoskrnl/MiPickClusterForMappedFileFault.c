/*
 * XREFs of MiPickClusterForMappedFileFault @ 0x1400A66A0
 * Callers:
...
LABEL_38:
  ...
  if ( !a3 && (v15 & 0x20000000) != 0 )
  {
    ...
    v18 = a4;
    v21 = v38;
    v33 = v22 & (dword_14046682C - 1);
    if ( v20 > v12 + 8 * (((unsigned int)(dword_14046682C - v33) >> 12) - 1LL) )
      v20 = v12 + 8 * (((unsigned int)(dword_14046682C - v33) >> 12) - 1LL);
  }
  else
  {
    v22 = 0;
  ...
  else
  {
    ...
    {
      v34 = (v22 >> 12) & ((unsigned int)(dword_14046682C - 1) >> 12);
      if ( v27 < v12 - 8 * v34 )
        v28 = v12 - 8 * v34;
    }
  }
