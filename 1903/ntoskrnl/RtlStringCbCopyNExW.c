/*
 * XREFs of RtlStringCbCopyNExW @ 0x140135360
 * Callers:
 *     _CmGetDeviceRegPropWorker @ 0x1405C23C4 (_CmGetDeviceRegPropWorker.c)
 * Callees:
 *     RtlStringCopyWorkerW_1 @ 0x140135404 (RtlStringCopyWorkerW_1.c)
 */
        ...
        ULONG dwFlags)
{
  ...
  if ( v9 >= 0 )
  {
    ...
    else
    {
      ...
      if ( v7 )
      {
        v9 = RtlStringCopyWorkerW_1(pszDest, v7, &v13, pszSrc, v11);
        if ( v9 < 0 )
        {
LABEL_14:
          if ( cbDest && v7 )
