/*
 * XREFs of MiMapMdlCommon @ 0x1401988A4
 * Callers:
...
LABEL_30:
    ...
    if ( (unsigned __int64)*v18 <= 0xFFFFFFFFFLL && (*(_QWORD *)(48 * v19 - 0x57FFFFFFFD8LL) & 0x20000000000000LL) != 0 )
    {
      ...
      if ( !*(_WORD *)(v21 + 32) && !dword_14046620C )
        MiShowBadMapper(v19);
      ...
      if ( v31 )
      {
        do
        {
          ...
          if ( MiPteInShadowRange(a2) )
          {
            ...
            {
              v34 = v23;
              if ( HIBYTE(word_140465BEC) == v35 && ((unsigned __int8)v14 & (unsigned __int8)v23) != 0 )
...
LABEL_14:
      if ( MiPteInShadowRange(a2) )
      {
        ...
        {
          v26 = v23;
          if ( HIBYTE(word_140465BEC) == v36 && ((unsigned __int8)v24 & (unsigned __int8)v23) != 0 )
...
LABEL_17:
  ...
  if ( v13 == (_DWORD)v23 )
  {
    ...
    v49 = ExAcquireSpinLockExclusive(&dword_140466700);
    *v37 = qword_140466710;
    qword_140466710 = (__int64)v48;
