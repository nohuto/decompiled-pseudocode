/*
 * XREFs of MiUnlockMdlWritePages @ 0x140024940
 * Callers:
...
void __fastcall MiUnlockMdlWritePages(_QWORD *a1, unsigned __int64 a2, _DWORD *a3, __int64 a4)
{
  ...
  if ( (unsigned __int64)a1 < a2 )
  {
    ...
    do
    {
      ...
      v11 = 1LL;
      v12 = *(_QWORD *)(qword_140466188 + 8 * ((*(_QWORD *)(v9 + 40) >> 40) & 0x3FFLL));
      v13 = *(_QWORD *)(v12 + 7232);
      if ( v13 )
      {
        while ( 1 )
...
LABEL_23:
      ...
      if ( (ULONG_PTR *)v12 == &MiSystemPartition )
      {
        ...
        a4 = _InterlockedExchangeAdd64(&qword_14046A440, a4);
      }
      else
      {
...
LABEL_13:
      ...
      *(_BYTE *)(v9 + 34) &= ~8u;
      ...
      if ( v16 )
      {
        ...
        {
          MiReturnCommit(*(_QWORD *)(qword_140466188 + 8 * ((*(_QWORD *)(v9 + 40) >> 40) & 0x3FFLL)), v23);
          v6 = 0x2AAAAAAAAAAAAAABLL;
        }
        if ( v7 >= 8 )
          *(_BYTE *)(v9 + 35) &= 0xF8u;
