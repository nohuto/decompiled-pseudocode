/*
 * XREFs of CmpMergeKeyValues @ 0x140836F20
 * Callers:
    ...
    if ( v14 )
    {
      ...
      if ( v16 )
      {
        ...
        while ( 1 )
        {
          ...
          if ( !v18 )
            break;
          CmpInitializeValueNameString(v18, (__int64)v25, (__int64)v15);
          v19 = !CmpFindNameInList(v28, v12, (unsigned __int16 *)v25, 0, &v27, &a6);
