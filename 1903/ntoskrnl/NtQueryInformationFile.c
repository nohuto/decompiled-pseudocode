/*
 * XREFs of NtQueryInformationFile @ 0x1405EFFA0
 * Callers:
 ...
 *     RtlIsPartialPlaceholderFileHandle @ 0x1408D6390 (RtlIsPartialPlaceholderFileHandle.c)
 * Callees:
 ...
 *     IopGetModeInformation @ 0x1406C8AB4 (IopGetModeInformation.c)
...
LABEL_46:
      ...
      else
      {
        ...
        __writecr8(1uLL);
        IopCompleteRequest((__int64)&v27->Tail, (__int64)v75, &v74, (__int64 *)&Object[3], &v74);
