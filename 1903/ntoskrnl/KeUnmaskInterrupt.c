/*
 * XREFs of KeUnmaskInterrupt @ 0x140168E80
 * Callers:
 *     IopUnmaskInterrupt @ 0x140168E04 (IopUnmaskInterrupt.c)
 * Callees:
...
LABEL_4:
    ...
    if ( v9 )
      ...
      v12 = ((__int64 (__fastcall *)(__int64, _QWORD, _BOOL8, __int64))off_1404244B8[0])(v11, 0LL, v9, v8);
  }
  if ( v12 != 296 )
    return v12;
  return v7;
