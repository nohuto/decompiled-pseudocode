/*
 * XREFs of KeRemoveSystemServiceTable @ 0x14087EE60
 * Callers:
 *     <none>
 * Callees:
...
char __fastcall KeRemoveSystemServiceTable(int a1)
{
  ...
  if ( (unsigned int)(a1 - 1) <= 1
    && ((_QWORD)xmmword_14058A8A0 || (_QWORD)xmmword_140572AA0 || (_QWORD)xmmword_140572AE0) )
  {
    if ( a1 == 1 )
    {
      *(_QWORD *)&xmmword_140572AA0 = 0LL;
      LODWORD(xmmword_140572AB0) = 0;
      *((_QWORD *)&xmmword_140572AB0 + 1) = 0LL;
    }
    else
    {
