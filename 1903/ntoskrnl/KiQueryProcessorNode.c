/*
 * XREFs of KiQueryProcessorNode @ 0x140186DA8
 * Callers:
 ...
 *     KiIsNodeFull @ 0x140186EE8 (KiIsNodeFull.c)
 *     _guard_dispatch_icall @ 0x1401CC5F0 (_guard_dispatch_icall.c)
 *     HvlpGetLpcbByApicId @ 0x140285FA8 (HvlpGetLpcbByApicId.c)
 *     HvlpGetLpcbByLpIndex @ 0x140285FD8 (HvlpGetLpcbByLpIndex.c)
 */
...
LABEL_7:
          v9 = (unsigned int)*a2;
          if ( (*(_BYTE *)(KeNodeBlock[*a3] + 181) & 2) == 0 )
