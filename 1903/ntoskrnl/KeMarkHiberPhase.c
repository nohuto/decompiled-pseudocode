/*
 * XREFs of KeMarkHiberPhase @ 0x1405AAD48
 * Callers:
...
void __fastcall KeMarkHiberPhase(_QWORD *Address)
{
  ...
  if ( *(_DWORD *)(v1 + 36) )
  {
    PoSetHiberRange(
      ...
      0x10000u,
      Address,
      ((((_DWORD)KeNumberProcessors_0 << 6) + 76351) & 0xFFFFF000) + 28672,
      0x6370654Bu);
  }
  else
  {
    PoSetHiberRange(0LL, 0x10000u, Address, 0x9080uLL, 0x6370654Bu);
    PoSetHiberRange(0LL, 0x10000u, (PVOID)v1, 0x8F00uLL, 0x6370654Bu);
    ...
    for ( i = 1; i <= 4; ++i )
    {
      ...
      if ( i == 1 || i == 2 || i - 3 <= 1 )
      {
        if ( KiKvaShadow )
        {
          ...
          v6 = (void *)(*(_QWORD *)(v5 + 8) - 8160LL);
        }
        else
        {
          v6 = (void *)(v5 - 0x2000);
        }
        PoSetHiberRange(0LL, 0x10000u, v6, 0x2000uLL, 0x6370654Bu);
      }
      ++v3;
    }
  }
  ...
  PoSetHiberRange(
    0LL,
    0x10000u,
    (PVOID)(((*(_QWORD *)(v1 + 23592) + 4095LL) & 0xFFFFFFFFFFFFF000uLL) - 24576),
    0x6000uLL,
    0x6573654Bu);
  v7 = (_QWORD **)(v1 + 11776);
  v8 = 2LL;
  ...
  PoSetHiberRange(0LL, 0x10000u, *(PVOID *)(v1 + 25280), v10, 0x7873654Bu);
  v11 = *(void **)(v1 + 1728);
  if ( v11 )
    PoSetHiberRange(
      0LL,
  ...
  if ( qword_140447098 )
    PoSetHiberRange(0LL, 0x10000u, qword_140447098, 16 * (unsigned int)(unsigned __int8)qword_140447088, 0x7272744Du);
  if ( qword_1404470A0 )
    PoSetHiberRange(0LL, 0x10000u, qword_1404470A0, 0x58uLL, 0x7272744Du);
  v13 = *(_QWORD **)(v1 + 8);
  v14 = (void *)((v13[6] + 4095LL) & 0xFFFFFFFFFFFFF000uLL);
  v15 = v13[7] - (_QWORD)v14;
  PoSetHiberRange(0LL, 0x10000u, v13, 0x820uLL, 0x6874654Bu);
