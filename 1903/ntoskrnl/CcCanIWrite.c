/*
 * XREFs of CcCanIWrite @ 0x1400B4600
 * Callers:
...
LABEL_61:
  ...
  if ( (BYTE6(PerfGlobalGroupMask) & 0x21) != 0 )
  {
    ExpAcquireSpinLockExclusiveAtDpcLevelInstrumented(&dword_140464580, v19);
  }
  else
  {
    ...
    if ( _interlockedbittestandset(&dword_140464580, 0x1Fu) )
    {
      ...
      v77 = ExpWaitForSpinLockExclusiveAndAcquire(&dword_140464580, v19);
      v8 = 0;
    }
    v22 = dword_140464580;
    ...
    do
    {
      if ( (v22 & 0x40000000) == 0 )
      {
        v55 = _InterlockedCompareExchange(&dword_140464580, v22 | 0x40000000, v22);
        v54 = v22 == v55;
        v22 = v55;
        if ( !v54 )
          continue;
...
LABEL_17:
  if ( *(_QWORD *)v18 )
    v23 = *(ULONG_PTR **)(qword_140466188 + 8LL * (*(_WORD *)(*(_QWORD *)v18 + 60LL) & 0x3FF));
  else
...
LABEL_48:
    ...
    if ( (_BYTE)dword_1405711AC )
      v44 = 0x4000LL;
    if ( qword_14046A400 < v44 )
    {
      v50 = (unsigned __int16 **)&unk_1404694A8;
      while ( 1 )
      {
        v69 = *v50;
        if ( dword_140465AB4 )
...
LABEL_153:
        ++v50;
        v8 = 0;
        if ( (__int64)v50 > (__int64)&qword_1404694B0 )
        {
          if ( qword_14046A580 < (unsigned __int64)(qword_14046A5F0 + 800) )
