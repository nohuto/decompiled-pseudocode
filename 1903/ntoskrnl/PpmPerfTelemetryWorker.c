/*
 * XREFs of PpmPerfTelemetryWorker @ 0x14072D2C0
 * Callers:
 *     <none>
 * Callees:
...
__int64 PpmPerfTelemetryWorker()
{
  ...
  if ( pCallbackContext.LevelPlus1 > 5 && TlgKeywordOn(&pCallbackContext, 0x400000000000uLL) )
  {
    ...
    v17 = 36LL;
    v19 = 8LL;
    TlgWrite(&pCallbackContext, &unk_14038E690, 0LL, 0LL, 6u, &pData);
  }
  return PopOkayToQueueNextWorkItem((__int64)&unk_1404442A8);
}
