/*
 * XREFs of PfSnCheckActionsNeeded @ 0x140659940
 * Callers:
  ...
  *(_QWORD *)&v35[1] = a1;
  ...
  else
  {
    ...
    else
    {
      ...
      v27 = PfSnPrefetchCacheEntryGet(&unk_140467D38, *(_QWORD *)&v35[1], v16, &v34);
      v28 = (_DWORD *)v27;
      if ( v27 )
      {
        if ( v34 )
