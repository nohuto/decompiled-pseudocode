/*
 * XREFs of DrvDbSetDeviceIdDriverInfMatches @ 0x140940A6C
 * Callers:
...
__int64 __fastcall DrvDbSetDeviceIdDriverInfMatches(__int64 a1, void *a2, const wchar_t *a3)
{
  ...
  v28 = 0;
  v27 = 0;
  InfoKey = PnpCtxRegQueryInfoKey(a1, a2, 0LL, 0LL, (__int64)&v36, (__int64)&MaxCount, 0LL);
  inited = InfoKey;
  if ( InfoKey >= 0 )
  {
    v6 = MaxCount + 1;
    ...
    if ( v3 )
    {
      ...
      if ( v36 )
      {
        ...
        {
          MaxCount = v6;
          v14 = PnpCtxRegEnumValue(0LL, KeyHandle, v13, PoolWithTag, (__int64)&MaxCount, (__int64)&v28, 0LL, 0);
          inited = v14;
          if ( v14 < 0 )
            break;
          if ( v28 == 3 || !v28 )
...
LABEL_39:
      if ( inited >= 0 )
      {
        while ( *v3 )
        {
          inited = DrvDbSplitDeviceIdDriverInfMatch(v3, (NTSTRSAFE_PWSTR)PoolWithTag, v6, (__int64)&v27);
          if ( inited < 0 )
            break;
          if ( (_BYTE)v27 )
          {
          ...
          inited = RegRtlSetValue(KeyHandle, (const WCHAR *)PoolWithTag, v19, v20, v21);
          if ( inited < 0 )
            break;
          v22 = -1LL;
          do
    ...
    else
    {
      ...
      if ( v23 )
      {
        ...
        {
          MaxCount = v6;
          inited = PnpCtxRegEnumValue(0LL, a2, v24, PoolWithTag, (__int64)&MaxCount, 0LL, 0LL, 0);
          if ( inited < 0 )
            break;
          *(_QWORD *)&DestinationString.Length = 0LL;
          DestinationString.Buffer = 0LL;
