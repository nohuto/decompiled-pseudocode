/*
 * XREFs of ObDuplicateObject @ 0x1405E61D0
 * Callers:
 *     NtDuplicateObject @ 0x1405E6010 (NtDuplicateObject.c)
 *     PspPropagateHandle @ 0x140618184 (PspPropagateHandle.c)
 ...
 *     ObpIncrementHandleCount @ 0x14089E31C (ObpIncrementHandleCount.c)
