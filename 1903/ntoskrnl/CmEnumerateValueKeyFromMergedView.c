/*
 * XREFs of CmEnumerateValueKeyFromMergedView @ 0x14082B7F4
 * Callers:
...
LABEL_45:
      ...
      v29 = *(_WORD *)(v27 + 16);
      v48 = v27 + 20;
      LOWORD(v47) = *(_WORD *)(v27 + 2);
      if ( CmpFindNameInList(*(_QWORD *)(v16 + 32), v14, (unsigned __int16 *)&v47, (v29 & 1) << 16, 0LL, &v39)
        && (_DWORD)v39 == -1 )
      {
        if ( v22 == a4 )
        {
      ...
      v23 = ++v49;
      (*(void (__fastcall **)(_QWORD, _DWORD *))(*(_QWORD *)(v15 + 32) + 16LL))(*(_QWORD *)(v15 + 32), v37);
      if ( v38 )
      {
        (*(void (__fastcall **)(_QWORD, _DWORD *))(*(_QWORD *)(v15 + 32) + 16LL))(*(_QWORD *)(v15 + 32), v41);
        v38 = 0LL;
      }
      if ( v22 > a4 )
        goto LABEL_45;
    ...
    v33 = (*(__int64 (__fastcall **)(_QWORD, _QWORD, _DWORD *))(*(_QWORD *)(v16 + 32) + 8LL))(
            *(_QWORD *)(v16 + 32),
            v14[1],
            v43);
    v31 = v33;
    ...
    v30 = v16;
LABEL_53:
    KeyValueData = CmpQueryKeyValueData(v30, v36, v28, a5, Size, a7, a8);
    if ( v28 )
...
LABEL_55:
    if ( v38 )
      (*(void (__fastcall **)(_QWORD, _DWORD *))(*(_QWORD *)(v15 + 32) + 16LL))(*(_QWORD *)(v15 + 32), v41);
    if ( v31 )
      (*(void (__fastcall **)(_QWORD, _DWORD *))(*(_QWORD *)(v16 + 32) + 16LL))(*(_QWORD *)(v16 + 32), v43);
LABEL_59:
    v21 = v42;
    goto LABEL_60;
  }
...
LABEL_60:
  if ( v46 )
    (*(void (__fastcall **)(_QWORD, _DWORD *))(*(_QWORD *)(v15 + 32) + 16LL))(*(_QWORD *)(v15 + 32), v44);
  if ( v21 )
    (*(void (__fastcall **)(_QWORD, _DWORD *))(*(_QWORD *)(v16 + 32) + 16LL))(*(_QWORD *)(v16 + 32), v45);
LABEL_64:
  if ( !a3 )
  {
