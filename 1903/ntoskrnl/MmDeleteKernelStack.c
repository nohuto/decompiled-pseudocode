...
signed __int64 __fastcall MmDeleteKernelStack(unsigned __int64 a1, char a2)
{
  ...
  if ( (BYTE4(PerfGlobalGroupMask) & 1) != 0 && (a2 & 2) != 0 )
  {
    ...
    v36 = 18LL;
    if ( v14 )
      v36 = (unsigned __int8)byte_1404666FC;
  ...
  if ( !v14 )
  {
    ...
    if ( v20 == -32LL )
    {
      ...
      if ( v21->ParentNode->Affinity.Reserved[0] == (_DWORD)v12 && !v21->CachedStack )
      {
        ...
        *(_QWORD *)(v22 + 4064) = v22 ^ qword_140466940;
  ...
  while ( 1 )
  {
    v25 = (int *)((char *)&qword_140465A58[2 * v11] + v24);
    v59 = v25;
    if ( *(unsigned __int16 *)v25 >= v25[4] )
      goto LABEL_48;
    v26 = (__int64)(v4 << 25) >> 16;
    v61 = (_SLIST_ENTRY *)v26;
    *(_QWORD *)(v26 + 0xFE0) = v26 ^ qword_140466940;
    if ( v11 == 1 )
    ...
    v28 = 1;
    v29 = -1;
    v30 = v4 - 8LL * (unsigned __int8)byte_1404666FC;
    v62 = 1;
    v31 = v30 + 8LL * ((unsigned int)(unsigned __int8)byte_1404666FC + 1);
    v32 = v30 + 8;
    if ( v30 + 8 >= v31 )
      goto LABEL_44;
    do
