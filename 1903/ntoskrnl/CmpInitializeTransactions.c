/*
 * XREFs of CmpInitializeTransactions @ 0x140A15264
 * Callers:
...
__int64 *CmpInitializeTransactions()
{
  ...
  qword_140463698 = (__int64)&CmpRmListHead;
  ...
  qword_140463928 = (__int64)&CmpLazyCommitListHead;
  ...
  _mm_lfence();
  if ( (void *)qword_1404643E0 == CmpRmListLock.Owner )
  {
    v0 = __rdtsc();
    ...
    qword_1404643F8 = v1;
    qword_1404643F0 = KiQueryUnbiasedInterruptTime() + 41929663 * (__rdtsc() >> 4) % 0x12A05F2000LL + 288000000000LL;
  }
  CmpLazyCommitTimer = 8LL;
  qword_140463998 = (__int64)CmpLazyCommitDpcRoutine;
  CmpLazyCommitDpc = 275;
  qword_140463950 = (__int64)&qword_140463948;
  qword_140463948 = (__int64)&qword_140463948;
  qword_1404636E8 = (__int64)&CmpDelayFreeRMListHead;
  ...
  qword_140463778 = (__int64)CmpDelayFreeRMDpcRoutine;
  qword_1404637B0 = (__int64)&qword_1404637A8;
  qword_1404637A8 = (__int64)&qword_1404637A8;
  ...
  qword_1404637B8 = 0LL;
  qword_1404637D8 = 0LL;
  qword_1404638E8 = (__int64)&CmpLightTransactionList;
