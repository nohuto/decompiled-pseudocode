 ...
 *     PopWakeInfoReference @ 0x14013D804 (PopWakeInfoReference.c)
 ...
 *     PopUnlinkWakeSources @ 0x1408A7CB8 (PopUnlinkWakeSources.c)
 */
...
LONG PopHandleWakeSources()
{
  ...
  if ( dword_1404430A0 < 0 || (unsigned __int64)dword_1404430A0 >= 3 )
    v4 = 0LL;
  else
    v4 = (SIZE_T *)qword_1404430B8[3 * dword_1404430A0];
  if ( v0 == 4 )
  {
...
LABEL_37:
  ...
  PopAcquireWakeSourceSpinLock(&LockHandle);
  v7 = (__int64 *)qword_140443F08;
  if ( *(__int64 **)qword_140443F08 != &PopWakeInfoList )
    goto LABEL_37;
  ++PopWakeInfoCount;
