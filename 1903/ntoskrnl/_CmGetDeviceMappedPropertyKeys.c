/*
 * XREFs of _CmGetDeviceMappedPropertyKeys @ 0x14093C038
 * Callers:
        ...
        unsigned int *a7)
{
  ...
  *a7 = 0;
  while ( 1 )
  {
    ...
    if ( a4 )
      goto LABEL_61;
    result = CmGetDeviceMappedPropertyFromRegProp(a1, a2, a3, v12, v37, 0LL, 0, (unsigned int *)&a7, 0);
