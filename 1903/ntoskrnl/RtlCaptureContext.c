/*
 * XREFs of RtlCaptureContext @ 0x1401CBB10
 * Callers:
 *     KeBugCheckEx @ 0x1401C3B20 (KeBugCheckEx.c)
 *     KeSaveStateForHibernate @ 0x1401C4820 (KeSaveStateForHibernate.c)
 ...
 *     IopLiveDumpCorralDpc @ 0x1405A8520 (IopLiveDumpCorralDpc.c)
