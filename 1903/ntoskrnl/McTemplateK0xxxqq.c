/*
 * XREFs of McTemplateK0xxxqq @ 0x140284328
 * Callers:
 *     FsRtlHeatLogIo @ 0x14084FF00 (FsRtlHeatLogIo.c)
 * Callees:
...
ULONG McTemplateK0xxxqq(__int64 a1, const EVENT_DESCRIPTOR *a2, const GUID *a3, ...)
{
  ...
  v12 = 4LL;
  v14 = 4LL;
  return McGenEventWrite((PMCGEN_TRACE_CONTEXT)&MS_StorageTiering_Provider_Context, a2, a3, 6u, &EventData);
}
