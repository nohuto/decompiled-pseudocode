/*
 * XREFs of RtlpGenericRandomPatternWorker @ 0x140315B90
 * Callers:
 *     RtlScrubMemory @ 0x1403154E8 (RtlScrubMemory.c)
 * Callees:
 *     RtlpFillMemoryRandomUp @ 0x14031561C (RtlpFillMemoryRandomUp.c)
 *     RtlpTestMemoryRandomUp @ 0x1403160A8 (RtlpTestMemoryRandomUp.c)
 */
