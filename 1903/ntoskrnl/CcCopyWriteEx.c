/*
 * XREFs of CcCopyWriteEx @ 0x14006FB40
 * Callers:
 *     CcCopyWrite @ 0x14027D190 (CcCopyWrite.c)
 *     CcFastCopyWrite @ 0x14027D3C0 (CcFastCopyWrite.c)
 * Callees:
 *     CcMapAndCopyInToCache @ 0x14006D870 (CcMapAndCopyInToCache.c)
 */

char __fastcall CcCopyWriteEx(__int64 a1, __int64 *a2, unsigned int a3, char a4, char *a5, struct _KTHREAD *a6)
{
  ...
  return CcMapAndCopyInToCache(v10, a5, &v18, a3, v14, a1, &v17, a4, a6);
}
