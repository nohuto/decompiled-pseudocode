/*
 * XREFs of ExpSaAllocatorFree @ 0x14016E380
 * Callers:
...
char __fastcall ExpSaAllocatorFree(ULONG_PTR BugCheckParameter2, __int64 *a2, __int64 a3, unsigned int a4)
{
  ...
  bool v14; // zf
  int v15; // eax
  $6EAC78A6FCFADE0A5FA44F358736B38F *v16; // rax
...
LABEL_66:
  ...
  if ( v14 && ($6EAC78A6FCFADE0A5FA44F358736B38F *)v27->ApcState.ApcListHead[0].Flink != &v27->152 )
...
LABEL_43:
  ...
  {
    v16 = &v17->152;
    if ( ($6EAC78A6FCFADE0A5FA44F358736B38F *)v16->ApcState.ApcListHead[0].Flink != v16 )
