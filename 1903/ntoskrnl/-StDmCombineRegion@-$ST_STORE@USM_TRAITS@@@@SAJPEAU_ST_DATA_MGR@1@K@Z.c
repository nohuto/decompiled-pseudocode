/*
 * XREFs of ?StDmCombineRegion@?$ST_STORE@USM_TRAITS@@@@SAJPEAU_ST_DATA_MGR@1@K@Z @ 0x14014F144
 * Callers:
...
__int64 __fastcall ST_STORE<SM_TRAITS>::StDmCombineRegion(__int64 a1, ULONG a2)
{
  ...
  struct _PRIVILEGE_SET *PoolWithTag; // [rsp+60h] [rbp+30h] BYREF

  v2 = *(struct _PRIVILEGE_SET **)(a1 + 1056);
  if ( v2 )
  {
    *(_QWORD *)(a1 + 1056) = 0LL;
    PoolWithTag = v2;
  ...
  {
    PoolWithTag = (struct _PRIVILEGE_SET *)ExAllocatePoolWithTag(NonPagedPoolNx, 0x1000uLL, 0x74536D73u);
    v2 = PoolWithTag;
    if ( !PoolWithTag )
      return 3221225626LL;
  }
  *(_QWORD *)&v2->PrivilegeCount = 0LL;
  v2->PrivilegeCount = a2;
  v2->Control = 528384;
  ...
  **(_DWORD **)(a1 + 760) = v5;
  ...
  while ( 1 )
  {
    ...
    if ( (v10[1] & 0xFFFFF000) <= 0x1000
      && (unsigned int)((__int64 (__fastcall *)(__int64, struct _PRIVILEGE_SET *, __int64 *, _DWORD *))ST_STORE<SM_TRAITS>::StDmCombineBufferAddEntry)(
                         a1,
                         v2,
                         &v13,
                         v10) == -2147483643 )
    {
      ...
      **(_DWORD **)(a1 + 760) = *v10;
      ...
      v13 = 0LL;
      v14 = 0;
      *(_QWORD *)&PoolWithTag->PrivilegeCount = 0LL;
      v2->PrivilegeCount = a2;
      v2->Control = 528384;
    }
  }
  if ( v2->Privilege >= (LUID_AND_ATTRIBUTES *)((char *)v2 + HIWORD(v2->Control)) )
  {
LABEL_18:
    result = 0LL;
    goto LABEL_19;
