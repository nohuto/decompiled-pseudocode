/*
 * XREFs of MiCreateImageFileMap @ 0x14068AE6C
 * Callers:
 ...
 *     IoIsDeviceEjectable @ 0x1400E2DE8 (IoIsDeviceEjectable.c)
 *     MiLegacyImageArchitecture @ 0x1400E2E08 (MiLegacyImageArchitecture.c)
 *     PsIsCurrentThreadPrefetching @ 0x1401160C0 (PsIsCurrentThreadPrefetching.c)
...
LABEL_26:
  if ( (v22->MdlFlags & 4) != 0 )
    ...
    StartVa = (PVOID *)v22->MappedSystemVa;
  p_FsContext = StartVa;
...
LABEL_96:
      ...
      v56 = MiBuildImageControlArea(a3, (_DWORD)v48, v39, (unsigned int)&v91, a4, (__int64)&FileSize, (__int64)&v87);
      v13 = v87;
      v17 = v56;
      if ( v56 < 0 )
      {
