/*
 * XREFs of RtlpHpLfhSubsegmentCreate @ 0x140111840
 * Callers:
 ...
 *     RtlpHpLfhBucketComputeNewSubsegmentBlockCount @ 0x140111ADC (RtlpHpLfhBucketComputeNewSubsegmentBlockCount.c)
