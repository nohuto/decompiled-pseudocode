/*
 * XREFs of MmMarkPhysicalMemoryAsBad @ 0x1402BEDE0
 * Callers:
...
LABEL_81:
  ...
  if ( (unsigned int)MiAcquireNonPagedResources((ULONG_PTR *)v12, 2uLL) )
  {
    ...
    if ( *(_QWORD *)(qword_140466188 + 8 * ((*(_QWORD *)(v6 + 40) >> 40) & 0x3FFLL)) != v12 )
    {
      _InterlockedAnd64(v7, 0x7FFFFFFFFFFFFFFFuLL);
    ...
    *(_BYTE *)(v6 + 35) = v18 | 0x40;
    ...
    {
      if ( v12 == *(_QWORD *)(qword_140466188 + 8 * ((*(_QWORD *)(v6 + 40) >> 40) & 0x3FFLL)) )
      {
