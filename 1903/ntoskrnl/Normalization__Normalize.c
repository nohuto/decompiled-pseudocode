/*
 * XREFs of Normalization__Normalize @ 0x1408D72B8
 * Callers:
 *     RtlpNormalizeStringWorker @ 0x1408D7DE0 (RtlpNormalizeStringWorker.c)
 * Callees:
 *     memset @ 0x1401D6BC0 (memset.c)
 *     NormBuffer__Append @ 0x14031381C (NormBuffer__Append.c)
 *     Normalization__GuessCharCountBySize @ 0x1408D6BCC (Normalization__GuessCharCountBySize.c)
