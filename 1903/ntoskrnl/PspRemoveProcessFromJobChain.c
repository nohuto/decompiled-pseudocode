/*
 * XREFs of PspRemoveProcessFromJobChain @ 0x140613394
 * Callers:
 ...
 *     PspUnlinkJobProcess @ 0x140697460 (PspUnlinkJobProcess.c)
 ...
 *     PspSubtractAccountingValues @ 0x1406F8238 (PspSubtractAccountingValues.c)
...
void __fastcall PspRemoveProcessFromJobChain(PEPROCESS Process, _QWORD *a2, unsigned int a3, unsigned int a4)
{
  ...
  v19 = a3;
  v5 = a3;
  if ( (Process[2].ActiveProcessors.Bitmap[4] & 0x100000000000LL) == 0 || (a3 & 1) != 0 )
  {
    ...
    if ( (v5 & 2) != 0
      ...
      && (Process[2].ActiveProcessors.Bitmap[4] & 0x4000000000LL) == 0 )
    {
    ...
    if ( v15 )
    {
      do
      {
        ...
        {
          --*(_DWORD *)(v11 + 216);
          if ( (Process[2].ActiveProcessors.Bitmap[4] & 0x2000000000LL) != 0 )
            --*(_DWORD *)(v11 + 1212);
        }
        if ( (v5 & 8) != 0 && v8 )
          ++*(_DWORD *)(v11 + 220);
