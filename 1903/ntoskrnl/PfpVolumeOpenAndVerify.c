/*
 * XREFs of PfpVolumeOpenAndVerify @ 0x1406A9A58
 * Callers:
 *     PfpPrefetchRequestPerform @ 0x1406A9098 (PfpPrefetchRequestPerform.c)
 * Callees:
 *     PfVolumeSupportedForPrefetch @ 0x1400F93E8 (PfVolumeSupportedForPrefetch.c)
...
__int64 __fastcall PfpVolumeOpenAndVerify(__int64 a1, _OWORD *a2, __int64 a3)
{
  ...
  *(_OWORD *)&ObjectAttributes.SecurityDescriptor = 0LL;
  ...
  {
    if ( v7 == 259 )
      KeBugCheckEx(0x191u, 0x132DuLL, 0LL, 0LL, 0LL);
    v9 = FileHandle;
    ...
    if ( DevicePowerState == 259 )
      KeBugCheckEx(0x191u, 0x133DuLL, 0LL, 0LL, 0LL);
...
LABEL_7:
      ...
      if ( (DevicePowerState & 0xC0000000) == 0xC0000000 )
        goto LABEL_16;
      if ( DevicePowerState == 259 )
        KeBugCheckEx(0x191u, 0x1386uLL, 0LL, 0LL, 0LL);
