/*
 * XREFs of CmpRmReDoPhase @ 0x1408326E0
 * Callers:
 *     CmpStartRMLog @ 0x1406993A0 (CmpStartRMLog.c)
 * Callees:
 *     CmSiFreeMemory @ 0x14008BCE0 (CmSiFreeMemory.c)
 *     CmpVerifyLogRecord @ 0x1405B0758 (CmpVerifyLogRecord.c)
 ...
 *     CmpRealignLogBuffers @ 0x1408323C8 (CmpRealignLogBuffers.c)
    ...
    do
    {
      ...
      if ( (peRecordType & 1) != 0 )
      {
        ...
        if ( (int)v2 >= 0 )
        {
          ...
          {
            LODWORD(v2) = CmpDoReadTxRBigLogRecord(pvReadContext, ppvReadBuffer, pcbBuffer, &v10, &plsnUser);
            if ( (int)v2 < 0 )
              break;
            v5 = v10;
