/*
 * XREFs of SeRegisterObjectTypeMandatoryPolicy @ 0x14018B15C
 * Callers:
...
__int64 __fastcall SeRegisterObjectTypeMandatoryPolicy(__int64 a1, int a2)
{
  ...
  __int64 v25; // rdx
  $6EAC78A6FCFADE0A5FA44F358736B38F *v26; // rcx
...
LABEL_30:
  ...
  {
    v26 = &v14->152;
    if ( ($6EAC78A6FCFADE0A5FA44F358736B38F *)v26->ApcState.ApcListHead[0].Flink != v26 )
