/*
 * XREFs of MiFreeUnusedPfnPages @ 0x14019CAD0
 * Callers:
...
LABEL_27:
      if ( ($6EAC78A6FCFADE0A5FA44F358736B38F *)v6->ApcState.ApcListHead[0].Flink != &v6->152 )
...
LABEL_49:
    ...
    if ( v9 && ($6EAC78A6FCFADE0A5FA44F358736B38F *)v15->ApcState.ApcListHead[0].Flink != &v15->152 )
