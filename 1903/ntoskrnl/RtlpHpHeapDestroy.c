/*
 * XREFs of RtlpHpHeapDestroy @ 0x1401667C4
 * Callers:
 ...
 *     RtlpHpSegContextCleanup @ 0x140166970 (RtlpHpSegContextCleanup.c)
 *     RtlpHpLfhContextCleanup @ 0x140166AC8 (RtlpHpLfhContextCleanup.c)
...
__int64 __fastcall RtlpHpHeapDestroy(__int64 a1)
{
  ...
  *(_QWORD *)(v1 + 8) = 0LL;
  ...
  while ( *(_QWORD *)v12 )
  {
    RtlpHpVsSubsegmentCleanup(v11 + 640, v12 ^ *(_QWORD *)v12);
