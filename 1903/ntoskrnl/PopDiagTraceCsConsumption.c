/*
 * XREFs of PopDiagTraceCsConsumption @ 0x1408ADD38
 * Callers:
...
NTSTATUS __fastcall PopDiagTraceCsConsumption(__int64 a1)
{
  ...
  *(_QWORD *)((char *)&v9 + 4) = (unsigned __int16)(v1 / 0x3938700);
  if ( v1 )
  {
    BYTE6(v9) = 100LL * *(_QWORD *)(a1 + 40) / v1;
    BYTE7(v9) = 100LL * *(_QWORD *)(a1 + 48) / v1;
    BYTE10(v9) = 100LL * *(_QWORD *)(a1 + 64) / v1;
    BYTE11(v9) = 100LL * *(_QWORD *)(a1 + 72) / v1;
    BYTE13(v9) = 100LL * *(_QWORD *)(a1 + 88) / v1;
    BYTE14(v9) = 100LL * *(_QWORD *)(a1 + 96) / v1;
    if ( v3 == -1 )
      HIBYTE(v9) = -1;
    else
      HIBYTE(v9) = 100 * v3 / v1;
