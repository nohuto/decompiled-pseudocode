/*
 * XREFs of MiPfPutPagesInTransition @ 0x1400A4A10
 * Callers:
...
__int64 __fastcall MiPfPutPagesInTransition(__int64 a1, _QWORD *a2, int a3)
{
  ...
  v90 = 0LL;
  v108 = 0LL;
  v97 = *(_QWORD *)(qword_140466188 + 8 * v8);
  v9 = *(_DWORD *)(v5 + 88) + 1;
  LOBYTE(v119) = 17;
  v106 = v9;
...
LABEL_90:
        ...
        {
          v30 = v29;
          if ( qword_140465B00 && (v29 & 0x10) == 0 )
            v30 = v29 & ~qword_140465B00;
          goto LABEL_90;
        }
      }
      v31 = v19;
...
LABEL_29:
                  ...
                  if ( (*v41 & 1) != 0 )
                  {
                    v51 = MiPfnZeroingNeeded((__int64)v39, v35);
                    v39 = v102;
                    if ( v51 )
                      v52 = v35;
                    v95 = v52;
