/*
 * XREFs of MiInsertPageInFreeOrZeroedList @ 0x14002AEF0
 * Callers:
...
void __fastcall MiInsertPageInFreeOrZeroedList(ULONG_PTR BugCheckParameter2, __int16 a2)
{
  ...
  LODWORD(v6) = 0;
  v7 = *(_QWORD *)(qword_140466188 + 8 * ((v5 >> 40) & 0x3FF));
  if ( (a2 & 1) != 0 )
  {
  ...
  *(_BYTE *)(v4 + 34) = v12 & 0xC7;
  v13 = byte_14046971E == 0;
  *(_BYTE *)(v4 + 35) &= ~0x20u;
  if ( !v13 && _bittest64((const signed __int64 *)qword_14046A040, BugCheckParameter2 >> 9) )
  {
    if ( (a2 & 0x800) == 0 )
      MiFreeSlabPage(v4);
  }
  else
  {
    ...
    v14 = dword_140465AB0 & (unsigned int)BugCheckParameter2 | (*(_QWORD *)(v4 + 40) >> 58 << byte_140465A4D) | (((unsigned int)(*(_QWORD *)(v4 + 40) >> 36) & 3) << byte_140465A4E);
    v15 = v14;
    v75 = *(_QWORD *)(v7 + 16) + 1984 * (v14 >> byte_140465A4D);
    ...
    if ( v18 )
    {
      if ( qword_140465B00 )
      {
        if ( (v18 & 0x10) != 0 )
          ...
          LODWORD(v18) = ~(_DWORD)qword_140465B00 & v18;
      }
    }
    else
    {
    ...
    *(_QWORD *)(v4 + 16) = v19;
    ...
    if ( (a2 & 0x400) != 0
      || (v20 = (unsigned int)v8,
          v21 = (_QWORD *)(*(_QWORD *)(v7 + 16) + 1984 * (v15 >> byte_140465A4D)),
          v22 = (unsigned __int8)MiChannelMaximumPowerOf2Mask & (unsigned __int16)((unsigned int)v14 >> byte_140465A4E),
...
LABEL_25:
        ...
        if ( (unsigned int)MmNumberOfChannels > 1 )
          _InterlockedIncrement64((volatile signed __int64 *)(v26
                                                            ...
                                                            * (v8
                                                             + 2LL
                                                             * ((unsigned __int8)MiChannelMaximumPowerOf2Mask & (unsigned __int16)((unsigned int)v71 >> byte_140465A4E)))
                                                            + 1848));
        ...
        if ( v32 == 0xFFFFFFFFFLL )
        {
          _InterlockedOr(
            (volatile signed __int32 *)(*(_QWORD *)(*(_QWORD *)(v7 + 16)
                                                  + 1984 * (v28 >> byte_140465A4D)
                                                  + 16 * (v8 + 104)
                                                  + 8)
                                      + 4 * ((unsigned __int64)((unsigned int)v71 & dword_140465AB0) >> 5)),
            1 << (v71 & dword_140465AB0 & 0x1F));
    ...
    if ( v50 )
    {
      ...
      if ( qword_140465B00 )
      {
        if ( (v50 & 0x10) != 0 )
          ...
          LODWORD(v6) = v50 & ~(_DWORD)qword_140465B00;
      }
    }
    v51 = (unsigned int)v6 | 0xFFFFFFFE00000000uLL;
    if ( qword_140465B00 )
    {
      if ( (qword_140465B00 & v51) != 0 )
