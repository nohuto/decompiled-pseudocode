/*
 * XREFs of AuthzBasepGetInternalSecurityAttributesCopyoutBufferSize @ 0x14061B360
 * Callers:
 *     AuthzBasepQueryInternalSecurityAttributesToken @ 0x14061B2D8 (AuthzBasepQueryInternalSecurityAttributesToken.c)
 * Callees:
 *     AuthzBasepGetInternalSecurityAttributeValueCopyoutBufferSize @ 0x140087828 (AuthzBasepGetInternalSecurityAttributeValueCopyoutBufferSize.c)
 */
