/*
 * XREFs of NormBuffer__SortBeforeSameClass @ 0x140313E40
 * Callers:
 *     NormBuffer__AppendAndSortDecomposed @ 0x140313884 (NormBuffer__AppendAndSortDecomposed.c)
 * Callees:
 *     NormBuffer__GetCurrentOutputChar @ 0x140313930 (NormBuffer__GetCurrentOutputChar.c)
 *     Normalization__PageLookup @ 0x1408D7C94 (Normalization__PageLookup.c)
 *     Normalization__TableLookup @ 0x1408D7CAC (Normalization__TableLookup.c)
 */
