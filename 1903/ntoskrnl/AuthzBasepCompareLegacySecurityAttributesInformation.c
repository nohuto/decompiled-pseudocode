/*
 * XREFs of AuthzBasepCompareLegacySecurityAttributesInformation @ 0x140619DC4
 * Callers:
 ...
 *     AuthzBasepCompareSecurityAttribute @ 0x140619D18 (AuthzBasepCompareSecurityAttribute.c)
