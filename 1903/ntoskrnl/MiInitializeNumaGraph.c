/*
 * XREFs of MiInitializeNumaGraph @ 0x1409F24EC
 * Callers:
...
__int64 __fastcall MiInitializeNumaGraph(__int64 a1)
{
        ...
        *v13 = 0LL;
        ...
        if ( KeNumberNodes )
        {
          ...
          do
          {
            ...
            *(_DWORD *)(qword_140465A50 + 4 * v21) = v20;
          }
  ...
  while ( v2 < v4 )
  {
    for ( j = v2; j < v4 + v2; *(_DWORD *)(qword_140465A50 + 4 * v6) = v8 & 0x3F )
    {
      v6 = v2 * (v4 - 1) + j;
      v7 = j++;
      v8 = v7 % v4;
      result = qword_140465A50;
    }
    ++v2;
  }
  return result;
