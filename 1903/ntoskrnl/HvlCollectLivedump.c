/*
 * XREFs of HvlCollectLivedump @ 0x14028BAEC
 * Callers:
...
NTSTATUS __fastcall HvlCollectLivedump(__int64 a1, __int64 a2, _QWORD *a3, __int64 a4)
{
  ...
  if ( (HvlpRootFlags & 2) == 0 || !qword_140463148 )
    return -1073741637;
  if ( VslVsmEnabled )
  {
  ...
  else
  {
    ...
    *(_OWORD *)(v8 + 1) = *(_OWORD *)a2;
    ...
    {
      v12 = *(void **)(a4 + 32);
      v13 = dword_140463158 << 12;
      if ( v12 == *(void **)a4 && *(_DWORD *)(a4 + 8) >= v13 )
        memmove(v12, qword_140463148, v13);
      else
        *(_QWORD *)(a4 + 32) = qword_140463148;
      *(_DWORD *)(a4 + 40) = v13;
