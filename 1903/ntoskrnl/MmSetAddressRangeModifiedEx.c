/*
 * XREFs of MmSetAddressRangeModifiedEx @ 0x14005E4D0
 * Callers:
 ...
 *     MmSetAddressRangeModified @ 0x140135660 (MmSetAddressRangeModified.c)
...
__int64 __fastcall MmSetAddressRangeModifiedEx(unsigned __int64 a1, __int64 a2)
{
  ...
  v8 = 0LL;
  v41 = MiLockWorkingSetOptimal((__int64)&unk_14046A480, v5, v35);
  v10 = *(_QWORD *)(MiGetSystemCacheReverseMap(v7, v9) + 24);
  v11 = v10 & 0xFFFFFFFFFFFFFFFEuLL;
  if ( (v10 & 1) == 0 )
    v11 = v10;
  v42 = *(_QWORD *)(qword_140466188 + 8LL * (*(_WORD *)(*(_QWORD *)v11 + 60LL) & 0x3FF)) + 0x2000LL;
  do
  {
    v12 = *(_QWORD *)v5;
    ...
    if ( (v12 & 1) != 0 )
    {
      ...
      v25 = *(_QWORD *)(qword_140466188 + 8 * ((*(_QWORD *)(v21 + 40) >> 40) & 0x3FFLL));
      v40 = v25;
