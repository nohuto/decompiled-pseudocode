/*
 * XREFs of AlpcpEnterStateChangeEventMessageLog @ 0x140885AD8
 * Callers:
 ...
 *     AlpcpAllocateSnapshotMessageLog @ 0x140885894 (AlpcpAllocateSnapshotMessageLog.c)
