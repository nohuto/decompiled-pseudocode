/*
 * XREFs of NtCreateKeyTransacted_Stub @ 0x14093F020
 * Callers:
        ...
        __int64 a8)
{
  ...
  if ( byte_14050EDF9 )
  {
    v8 = (NTSTATUS (__stdcall *)(PHANDLE, ACCESS_MASK, POBJECT_ATTRIBUTES, ULONG, PUNICODE_STRING, ULONG, HANDLE, PULONG))qword_14050EE00;
  }
  else
  {
    v8 = ZwCreateKeyTransacted;
    byte_14050EDF9 = 1;
    qword_14050EE00 = (__int64)ZwCreateKeyTransacted;
  }
  if ( v8 )
