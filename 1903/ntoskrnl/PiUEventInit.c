/*
 * XREFs of PiUEventInit @ 0x1409F90FC
 * Callers:
...
__int64 __fastcall PiUEventInit(int a1)
{
  ...
  if ( !a1 )
  {
    ...
    do
    {
      *(_QWORD *)((char *)&unk_140460BA8 + v3) = (char *)&PiUEventDevInterfaceClientList + v3;
      *(_QWORD *)((char *)&PiUEventDevInterfaceClientList + v3) = (char *)&PiUEventDevInterfaceClientList + v3;
      *(_QWORD *)((char *)&unk_140460CC8 + v3) = (char *)&PiUEventDevInstanceClientList + v3;
      *(_QWORD *)((char *)&PiUEventDevInstanceClientList + v3) = (char *)&PiUEventDevInstanceClientList + v3;
      *(_QWORD *)((char *)&unk_140460DA8 + v3) = (char *)&PiUEventDevInstancePropertyClientList + v3;
      ...
      *(_QWORD *)((char *)&unk_140460E88 + v3) = (char *)&PiUEventDevHandleClientList + v3;
      v3 += 16LL;
      *v4 = v4;
      --v2;
    }
    while ( v2 );
    qword_140460FE8 = (__int64)&PiUEventUsermodeEventQueue;
    PiUEventUsermodeEventQueue = &PiUEventUsermodeEventQueue;
    qword_140460FF8 = (__int64)&PiUEventBroadcastEventQueue;
