/*
 * XREFs of HUBDESC_InternalValidateInterfaceDescriptor @ 0x1C00341F8
 * Callers:
        ...
        __int64 a5)
{
  ...
  *a3 = v9;
  ...
  v13 = &WPP_78dee903e07d3ced2930c3a7d0bd69e9_Traceguids;
  v14 = v10 - v12;
  ...
  if ( v16 >= 9 )
  {
    if ( WPP_RECORDER_INITIALIZED != (_UNKNOWN *)&WPP_RECORDER_INITIALIZED )
      WPP_RECORDER_SF_DDDD(a5, 9LL, v15, 0x69u, v24);
    v13 = &WPP_78dee903e07d3ced2930c3a7d0bd69e9_Traceguids;
LABEL_19:
    if ( *a1 > 9u )
    {
        ...
        if ( v19 )
        {
          if ( _bittest64(*(const signed __int64 **)(a2 + 216), v17) )
          {
            ...
            if ( WPP_RECORDER_INITIALIZED != (_UNKNOWN *)&WPP_RECORDER_INITIALIZED )
            {
              LODWORD(v26) = v17;
              LODWORD(v25) = v12;
              WPP_RECORDER_SF_dD(a5, 2u, 5u, 0x6Cu, (__int64)&WPP_78dee903e07d3ced2930c3a7d0bd69e9_Traceguids, v25, v26);
            }
            (*(void (__fastcall **)(_QWORD, __int64))(a2 + 24))(*(_QWORD *)(a2 + 40), 103LL);
          }
          if ( !v20 && *(_BYTE *)(a2 + 80) > v17 )
          {
            if ( *(_WORD *)a2 > 0x200u || *(_BYTE *)(a2 + 12) || *(_BYTE *)(a2 + 13) )
              *v5 = 2;
            if ( WPP_RECORDER_INITIALIZED != (_UNKNOWN *)&WPP_RECORDER_INITIALIZED )
    ...
    else
    {
      ...
      {
        LODWORD(v25) = v12;
        WPP_RECORDER_SF_d(a5, 2u, 5u, 0x6Bu, (__int64)&WPP_78dee903e07d3ced2930c3a7d0bd69e9_Traceguids, v25);
      }
...
LABEL_85:
  ...
  *v5 = 1;
  if ( WPP_RECORDER_INITIALIZED != (_UNKNOWN *)&WPP_RECORDER_INITIALIZED )
  {
    WPP_RECORDER_SF_DDD(a5, 2u, v15, 0x68u, (__int64)&WPP_78dee903e07d3ced2930c3a7d0bd69e9_Traceguids, *a1, v12, 9);
    goto LABEL_85;
  }
LABEL_86:
  v11 = 0;
  if ( WPP_RECORDER_INITIALIZED != (_UNKNOWN *)&WPP_RECORDER_INITIALIZED )
    WPP_RECORDER_SF_(a5, 2u, 5u, 0x71u, (__int64)&WPP_78dee903e07d3ced2930c3a7d0bd69e9_Traceguids);
  return v11;
}
