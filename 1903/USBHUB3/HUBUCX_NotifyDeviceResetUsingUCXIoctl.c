/*
 * XREFs of HUBUCX_NotifyDeviceResetUsingUCXIoctl @ 0x1C0022C4C
 * Callers:
 *     HUBDSM_NotifyingDeviceResetToUCXAfterReset2 @ 0x1C001D4F0 (HUBDSM_NotifyingDeviceResetToUCXAfterReset2.c)
 * Callees:
