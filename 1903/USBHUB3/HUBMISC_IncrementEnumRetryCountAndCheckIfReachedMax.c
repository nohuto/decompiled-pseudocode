/*
 * XREFs of HUBMISC_IncrementEnumRetryCountAndCheckIfReachedMax @ 0x1C002A9A8
 * Callers:
 *     HUBDSM_CheckingIfEnumRetryReachedMaximumOnRenumWithAddress0Ownership @ 0x1C001D210 (HUBDSM_CheckingIfEnumRetryReachedMaximumOnRenumWithAddress0Ownership.c)
 * Callees:
  ...
  if ( *(_DWORD *)(a1 + 32) <= 3u )
  {
    ...
    *(_DWORD *)(a1 + 2432) = 0;
    ...
    if ( SLOBYTE(WPP_MAIN_CB.Queue.Wcb.DmaWaitEntry.Blink) < 0 )
      McTemplateK0p(v7, &USBHUB3_ETW_EVENT_DEVICE_ENUMERATION_RETRY, (const GUID *)(a1 + 1516), *(_QWORD *)(a1 + 24));
    v8 = *(_QWORD *)(a1 + 8);
