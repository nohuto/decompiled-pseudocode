/*
 * XREFs of HUBDTX_ValidateAndCacheBOSDescriptorHeader @ 0x1C0027724
 * Callers:
 *     HUBDSM_ValidatingAlternateBOSDescriptorHeader @ 0x1C001F4F0 (HUBDSM_ValidatingAlternateBOSDescriptorHeader.c)
 * Callees:
...
__int64 __fastcall HUBDTX_ValidateAndCacheBOSDescriptorHeader(__int64 a1)
{
  ...
  char v22; // [rsp+110h] [rbp+67h] BYREF
  ...
  *(_QWORD *)&v13[2] = &HUBMISC_LogDescriptorValidationWarningForDevice;
  ...
  if ( (BYTE1(WPP_MAIN_CB.Queue.Wcb.DmaWaitEntry.Blink) & 1) != 0 )
    McTemplateK0p(v5, &USBHUB3_ETW_EVENT_INVALID_BOS_DESCRIPTOR_HEADER, (const GUID *)(a1 + 1516), *(_QWORD *)(a1 + 24));
  return v3;
}
