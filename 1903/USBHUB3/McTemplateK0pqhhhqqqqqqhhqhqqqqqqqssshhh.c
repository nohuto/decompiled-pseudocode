/*
 * XREFs of McTemplateK0pqhhhqqqqqqhhqhqqqqqqqssshhh @ 0x1C0012348
 * Callers:
...
ULONG __fastcall McTemplateK0pqhhhqqqqqqhhqhqqqqqqqssshhh(
        __int64 a1,
        __int64 a2,
        const GUID *a3,
        __int64 a4,
        ...
        char a31)
{
  ...
  return McGenEventWrite(
           (PMCGEN_TRACE_CONTEXT)v40,
           &USBHUB3_ETW_EVENT_DEVICE_ENUMERATION_FAILURE,
           a3,
           0x1Du,
           &EventData);
}
