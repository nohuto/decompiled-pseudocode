/*
 * XREFs of HUBDESC_InternalValidateBillboardCapabilityDescriptor @ 0x1C0035B5C
 * Callers:
  ...
  if ( v9 >= 0x30 )
  {
    ...
    if ( v14 != 4 * v13 + 44 )
    {
      ...
      *v19 = v15;
      if ( WPP_RECORDER_INITIALIZED != (_UNKNOWN *)&WPP_RECORDER_INITIALIZED )
        WPP_RECORDER_SF_DDD(v12, 2u, a3, 0x9Cu, (__int64)&WPP_78dee903e07d3ced2930c3a7d0bd69e9_Traceguids, v8, v14, v15);
    ...
    if ( *v19 <= v9 )
    {
      ...
      if ( result )
      {
        if ( result <= 0x80u )
        {
          ...
          *v5 = 1;
          ...
          {
            LODWORD(v17) = a1[5];
            WPP_RECORDER_SF_d(v12, 2u, 5u, 0xA0u, (__int64)&WPP_78dee903e07d3ced2930c3a7d0bd69e9_Traceguids, v17);
          }
          v16 = 241LL;
        }
        else
        {
          *v5 = 1;
          ...
          {
            LODWORD(v17) = a1[4];
            WPP_RECORDER_SF_d(v12, 2u, 5u, 0x9Fu, (__int64)&WPP_78dee903e07d3ced2930c3a7d0bd69e9_Traceguids, v17);
          }
          v16 = 239LL;
        }
      }
      else
      {
        *v5 = 1;
        if ( WPP_RECORDER_INITIALIZED != (_UNKNOWN *)&WPP_RECORDER_INITIALIZED )
          WPP_RECORDER_SF_(v12, 2u, 5u, 0x9Eu, (__int64)&WPP_78dee903e07d3ced2930c3a7d0bd69e9_Traceguids);
        v16 = 238LL;
      }
    }
    else
    {
      ...
      {
        LODWORD(v17) = v8;
        WPP_RECORDER_SF_d(v12, 2u, 5u, 0x9Du, (__int64)&WPP_78dee903e07d3ced2930c3a7d0bd69e9_Traceguids, v17);
      }
      v16 = 237LL;
    }
...
LABEL_36:
  ...
  {
    if ( WPP_RECORDER_INITIALIZED != (_UNKNOWN *)&WPP_RECORDER_INITIALIZED )
      return WPP_RECORDER_SF_(v12, 2u, 5u, 0xA4u, (__int64)&WPP_78dee903e07d3ced2930c3a7d0bd69e9_Traceguids);
  }
  return result;
}
