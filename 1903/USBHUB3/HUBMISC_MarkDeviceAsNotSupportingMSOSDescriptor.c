/*
 * XREFs of HUBMISC_MarkDeviceAsNotSupportingMSOSDescriptor @ 0x1C00793A4
 * Callers:
 *     HUBDSM_MarkDeviceAsNotSupportingMSOSDescriptor @ 0x1C001E440 (HUBDSM_MarkDeviceAsNotSupportingMSOSDescriptor.c)
 * Callees:
