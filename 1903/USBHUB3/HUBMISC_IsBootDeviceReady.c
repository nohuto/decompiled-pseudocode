/*
 * XREFs of HUBMISC_IsBootDeviceReady @ 0x1C002F5D4
 * Callers:
 *     HUBBOOT_IsBootDeviceReady @ 0x1C003C620 (HUBBOOT_IsBootDeviceReady.c)
 * Callees:
...
LABEL_25:
      WPP_RECORDER_SF_(v4, 4u, 5u, v3, (__int64)&WPP_699d44e6015a36edc2e41426686ae77e_Traceguids);
    }
LABEL_26:
...
LABEL_30:
  WPP_RECORDER_SF_(v7, 4u, 5u, v5, (__int64)&WPP_699d44e6015a36edc2e41426686ae77e_Traceguids);
LABEL_31:
