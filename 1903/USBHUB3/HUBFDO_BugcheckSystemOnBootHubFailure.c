/*
 * XREFs of HUBFDO_BugcheckSystemOnBootHubFailure @ 0x1C000D320
 * Callers:
 *     HUBHSM_BugcheckingSystemOnExcessiveResetsForHubInBootPath @ 0x1C0007CB0 (HUBHSM_BugcheckingSystemOnExcessiveResetsForHubInBootPath.c)
 * Callees:
