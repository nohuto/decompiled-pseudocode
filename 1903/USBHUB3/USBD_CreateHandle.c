/*
 * XREFs of USBD_CreateHandle @ 0x1C003E780
 * Callers:
 *     HUBFDO_SetupHubPostErrataQuery @ 0x1C000D44C (HUBFDO_SetupHubPostErrataQuery.c)
 * Callees:
 *     USBDInternal_BuildAndSendQueryInterfaceSynchronously @ 0x1C003DFB8 (USBDInternal_BuildAndSendQueryInterfaceSynchronously.c)
