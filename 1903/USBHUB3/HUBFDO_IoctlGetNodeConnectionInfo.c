/*
 * XREFs of HUBFDO_IoctlGetNodeConnectionInfo @ 0x1C000C8B4
 * Callers:
...
__int64 __fastcall HUBFDO_IoctlGetNodeConnectionInfo(__int64 a1, __int64 a2, size_t a3, int a4, char a5)
{
  ...
  PKSPIN_LOCK SpinLock; // [rsp+48h] [rbp-20h] BYREF
...
LABEL_39:
  ...
  if ( a5 == 1 )
  {
    ...
    SpinLock = 0LL;
    v47 = 0LL;
    v34 = (struct _MCGEN_TRACE_CONTEXT *)(*(__int64 (__fastcall **)(PWDF_DRIVER_GLOBALS, __int64))(WdfFunctions_01015
                                                                                                 + 2280))(
                                           WdfDriverGlobals,
                                           v5);
  ...
  LODWORD(v42) = v11;
  LODWORD(v41) = v8;
  McTemplateK0pqq(v34, v37, (const GUID *)p_SpinLock, *(_QWORD *)(v10 + 248), v41, v42);
  return (*(__int64 (__fastcall **)(PWDF_DRIVER_GLOBALS, __int64, _QWORD))(WdfFunctions_01015 + 2104))(
           WdfDriverGlobals,
           v5,
           v11);
