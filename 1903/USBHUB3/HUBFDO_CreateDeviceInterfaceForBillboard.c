/*
 * XREFs of HUBFDO_CreateDeviceInterfaceForBillboard @ 0x1C000D9C4
 * Callers:
        ...
        __int64 a6)
{
  ...
  _QWORD v16[2]; // [rsp+50h] [rbp-49h] BYREF
  ...
  if ( DeviceInterfacePath >= 0 )
  {
    ...
    if ( DeviceInterfacePath >= 0 )
    {
      *a4 = 1;
      ...
      if ( DeviceInterfacePath >= 0 )
      {
        (*(void (__fastcall **)(PWDF_DRIVER_GLOBALS, _QWORD, _QWORD *))(WdfFunctions_01015 + 2472))(
          WdfDriverGlobals,
          *a3,
          v16);
