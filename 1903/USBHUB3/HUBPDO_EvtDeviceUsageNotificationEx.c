/*
 * XREFs of HUBPDO_EvtDeviceUsageNotificationEx @ 0x1C00196C0
 * Callers:
 *     <none>
 * Callees:
...
LABEL_29:
    ...
    else if ( WPP_RECORDER_INITIALIZED != (_UNKNOWN *)&WPP_RECORDER_INITIALIZED )
    {
      v18 = (*(__int64 (__fastcall **)(PWDF_DRIVER_GLOBALS, WDFDRIVER__ *, void *))(WdfFunctions_01015 + 1616))(
              ...
              WdfDriverGlobals->Driver,
              off_1C0064130);
      WPP_RECORDER_SF_(*(_QWORD *)(v18 + 64), 2u, 2u, 0x86u, (__int64)&WPP_e683e3a97dd23da98d402d95dd0016a2_Traceguids);
    }
