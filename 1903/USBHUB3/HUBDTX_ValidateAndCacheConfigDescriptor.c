/*
 * XREFs of HUBDTX_ValidateAndCacheConfigDescriptor @ 0x1C0027D84
 * Callers:
 *     HUBDSM_ValidatingAlternateConfigurationDescriptor @ 0x1C001DCA0 (HUBDSM_ValidatingAlternateConfigurationDescriptor.c)
 * Callees:
...
__int64 __fastcall HUBDTX_ValidateAndCacheConfigDescriptor(__int64 a1)
{
  ...
  *(_QWORD *)(a1 + 2008) = v19;
  if ( v19 )
  {
    ...
    {
      if ( (v20 = *(_DWORD *)(a1 + 172), v20 == 3)
        && (v11 = (struct _MCGEN_TRACE_CONTEXT *)*(unsigned int *)(*(_QWORD *)a1 + 760LL),
            ((unsigned __int8)v11 & 1) != 0)
        || v20 == 2 )
      {
