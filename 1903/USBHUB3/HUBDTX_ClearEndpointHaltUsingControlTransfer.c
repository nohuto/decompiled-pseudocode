/*
 * XREFs of HUBDTX_ClearEndpointHaltUsingControlTransfer @ 0x1C002896C
 * Callers:
 *     HUBDSM_ClearingEndpointHaltOnClientResetPipe @ 0x1C001BD40 (HUBDSM_ClearingEndpointHaltOnClientResetPipe.c)
 * Callees:
