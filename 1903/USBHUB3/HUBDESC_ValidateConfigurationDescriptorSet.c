/*
 * XREFs of HUBDESC_ValidateConfigurationDescriptorSet @ 0x1C0034BA4
 * Callers:
  ...
  *(_QWORD *)&v24[3] = v10;
  if ( !a1 )
  {
    if ( WPP_RECORDER_INITIALIZED != (_UNKNOWN *)&WPP_RECORDER_INITIALIZED )
      WPP_RECORDER_SF_(a4, 2u, 5u, 0x7Bu, (__int64)&WPP_78dee903e07d3ced2930c3a7d0bd69e9_Traceguids);
    v12 = 60LL;
LABEL_7:
...
LABEL_8:
  ...
  {
    if ( WPP_RECORDER_INITIALIZED != (_UNKNOWN *)&WPP_RECORDER_INITIALIZED )
      WPP_RECORDER_SF_dD(a4, 2u, 5u, 0x7Cu, (__int64)&WPP_78dee903e07d3ced2930c3a7d0bd69e9_Traceguids, v5, 9);
    v12 = 56LL;
    goto LABEL_7;
  }
  v22 = 0;
...
LABEL_35:
  ...
  if ( v22 == 2 )
    v13 = 0;
  if ( WORD5(v24[12]) != a1[4] && (LOWORD(v24[0]) > 0x200u || WORD6(v24[0])) )
    v13 = 0;
  if ( !v13 )
  {
LABEL_45:
    if ( WPP_RECORDER_INITIALIZED != (_UNKNOWN *)&WPP_RECORDER_INITIALIZED )
      WPP_RECORDER_SF_(a4, 2u, 5u, 0x7Du, (__int64)&WPP_78dee903e07d3ced2930c3a7d0bd69e9_Traceguids);
  }
  return v13;
}
