/*
 * XREFs of HUBDTX_ValidateAndCacheProductIdStringDescriptor @ 0x1C0028AD4
 * Callers:
 *     HUBDSM_ValidatingLanguageSpecificProductIdString @ 0x1C001D160 (HUBDSM_ValidatingLanguageSpecificProductIdString.c)
 * Callees:
