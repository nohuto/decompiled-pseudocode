/*
 * XREFs of HUBHTX_SetLinkStateToRxDetectUsingControlTransfer @ 0x1C00068EC
 * Callers:
 *     HUBPSM30_EnablingSuperSpeedOnTimerExpiration @ 0x1C0010EC0 (HUBPSM30_EnablingSuperSpeedOnTimerExpiration.c)
 * Callees:
