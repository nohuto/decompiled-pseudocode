/*
 * XREFs of HUBMISC_QueryAndCacheRegistryValuesForDevice @ 0x1C0079414
 * Callers:
 *     HUBDSM_QueryingRegistryValuesForDevice @ 0x1C001DBA0 (HUBDSM_QueryingRegistryValuesForDevice.c)
 * Callees:
