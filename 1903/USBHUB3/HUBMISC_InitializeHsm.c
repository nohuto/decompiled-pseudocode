/*
 * XREFs of HUBMISC_InitializeHsm @ 0x1C0079070
 * Callers:
  ...
  *(_QWORD *)(a1 + 2224) = a1;
  ...
  if ( v4 >= 0 )
  {
    ...
    *(_QWORD *)(a1 + 2304) = Timer;
    ...
    {
      WPP_RECORDER_SF_(*(_QWORD *)(a1 + 2520), 2u, 3u, 0xCu, (__int64)&WPP_699d44e6015a36edc2e41426686ae77e_Traceguids);
    }
  }
  else if ( WPP_RECORDER_INITIALIZED != (_UNKNOWN *)&WPP_RECORDER_INITIALIZED )
  {
    v6 = 10;
LABEL_4:
    WPP_RECORDER_SF_d(*(_QWORD *)(a1 + 2520), 2u, 3u, v6, (__int64)&WPP_699d44e6015a36edc2e41426686ae77e_Traceguids, v4);
  }
  return v5;
}
