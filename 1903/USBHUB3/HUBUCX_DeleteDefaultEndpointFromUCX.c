/*
 * XREFs of HUBUCX_DeleteDefaultEndpointFromUCX @ 0x1C0024CD8
 * Callers:
 ...
 *     HUBDSM_DeletingUCXDefaultEndpointOnOperationFailureFor30 @ 0x1C001D450 (HUBDSM_DeletingUCXDefaultEndpointOnOperationFailureFor30.c)
 * Callees:
