/*
 * XREFs of HUBREG_QueryValuesInDeviceHardwareKey @ 0x1C007C4B8
 * Callers:
  ...
  if ( v4 >= 0 )
  {
    ...
    else
    {
      (*(void (__fastcall **)(PWDF_DRIVER_GLOBALS, __int64, __int64 *))(WdfFunctions_01015 + 2472))(
        ...
        v16,
        &v12);
      PoolWithTag = ExAllocatePoolWithTag(ExDefaultNonPagedPoolType, (unsigned __int16)v12, 0x64334855u);
      v8 = PoolWithTag;
      if ( !PoolWithTag )
      {
        if ( WPP_RECORDER_INITIALIZED != (_UNKNOWN *)&WPP_RECORDER_INITIALIZED )
      ...
      memmove(PoolWithTag, Src, (unsigned __int16)v12);
      *(_DWORD *)(a1 + 2164) = (unsigned __int16)v12;
      *(_QWORD *)(a1 + 2168) = v8;
    }
