/*
 * XREFs of HUBPDO_ReEnumerationCallback @ 0x1C001A2C0
 * Callers:
 *     <none>
 * Callees:
        ...
        _QWORD *Context)
{
  ...
  {
    Value = Context[2];
    if ( *(_DWORD *)(Value + 400) != 1 )
    {
      v4 = -1073741811;
      goto LABEL_14;
    }
    if ( !_InterlockedCompareExchange((volatile signed __int32 *)(Value + 4), 1, 0) )
    {
...
LABEL_14:
  if ( WPP_RECORDER_INITIALIZED != (_UNKNOWN *)&WPP_RECORDER_INITIALIZED )
    WPP_RECORDER_SF__guid_dd(*(_QWORD *)(Context[1] + 1432LL), Value, ValueLength, 0x95u, v9, SettingGuid);
  return (unsigned int)v4;
}
