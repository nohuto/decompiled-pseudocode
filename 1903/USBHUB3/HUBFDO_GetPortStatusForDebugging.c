/*
 * XREFs of HUBFDO_GetPortStatusForDebugging @ 0x1C000C65C
 * Callers:
  ...
  for ( i = a1[295]; ; i = *(_QWORD *)(v4 + 248) )
  {
    ...
    if ( *(unsigned __int16 *)(v4 + 200) == a2 )
    {
      ...
      *(_WORD *)(v4 + 174) = v8;
      ...
      {
        LODWORD(v9) = result;
        return WPP_RECORDER_SF_d(a1[315], 2u, 3u, 0x24u, (__int64)&WPP_266c009e770034b9bb66bd8a0240ebba_Traceguids, v9);
      }
      return result;
    }
  }
