/*
 * XREFs of HUBPDO_ReleaseWdfPowerReferenceOnHub @ 0x1C0018D18
 * Callers:
 *     HUBDSM_ReleasingPowerReferenceOnHubOnEnumerationFailure @ 0x1C001C6C0 (HUBDSM_ReleasingPowerReferenceOnHubOnEnumerationFailure.c)
 * Callees:
