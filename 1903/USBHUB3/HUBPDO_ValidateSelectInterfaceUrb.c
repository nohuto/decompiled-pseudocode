/*
 * XREFs of HUBPDO_ValidateSelectInterfaceUrb @ 0x1C0014F88
 * Callers:
 *     HUBDSM_ValidatingSelectInterfaceUrbFromConfigured @ 0x1C001D010 (HUBDSM_ValidatingSelectInterfaceUrbFromConfigured.c)
 * Callees:
...
__int64 __fastcall HUBPDO_ValidateSelectInterfaceUrb(__int64 a1)
{
  ...
  _QWORD v19[5]; // [rsp+58h] [rbp-60h] BYREF
  ...
  (*(void (__fastcall **)(PWDF_DRIVER_GLOBALS, __int64, _QWORD *))(WdfFunctions_01015 + 2128))(
    ...
    v3,
    v19);
  v4 = (unsigned __int16 *)v19[1];
  v5 = 0;
  v6 = *(_QWORD *)(v19[1] + 24LL);
  v17 = v6;
  if ( v6 || *(_DWORD *)(v1 + 388) != -1 )
  {
    if ( v6 != *(_QWORD *)(a1 + 48) )
    {
      if ( *(_WORD *)(v19[1] + 2LL) == 1 )
      {
