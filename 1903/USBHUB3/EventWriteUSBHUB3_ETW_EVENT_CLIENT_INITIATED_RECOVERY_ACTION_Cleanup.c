/*
 * XREFs of EventWriteUSBHUB3_ETW_EVENT_CLIENT_INITIATED_RECOVERY_ACTION_Cleanup @ 0x1C0019E6C
 * Callers:
...
_DWORD *__fastcall EventWriteUSBHUB3_ETW_EVENT_CLIENT_INITIATED_RECOVERY_ACTION_Cleanup(__int64 a1, __int64 a2)
{
  ...
  if ( a1 && *(_QWORD *)a1 )
  {
    ...
    do
    {
      v5 = (struct _MCGEN_TRACE_CONTEXT *)(unsigned int)*v4;
      ...
      *v4 = 0;
      result = dword_1C0067778;
      ++v4;
      v3 += 2;
    }
    while ( (__int64)v3 < (__int64)dword_1C0067778 );
  }
  return result;
}
