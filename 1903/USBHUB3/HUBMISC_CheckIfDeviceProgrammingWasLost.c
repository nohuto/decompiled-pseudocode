/*
 * XREFs of HUBMISC_CheckIfDeviceProgrammingWasLost @ 0x1C002CDD8
 * Callers:
 *     HUBDSM_ClearingDeviceProgrammingLostFlagOnEnum @ 0x1C001D230 (HUBDSM_ClearingDeviceProgrammingLostFlagOnEnum.c)
 * Callees:
 *     <none>
 */
