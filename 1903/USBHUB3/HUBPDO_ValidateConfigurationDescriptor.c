/*
 * XREFs of HUBPDO_ValidateConfigurationDescriptor @ 0x1C0014780
 * Callers:
...
__int64 __fastcall HUBPDO_ValidateConfigurationDescriptor(__int64 a1, unsigned __int8 *a2, int a3)
{
  ...
  *(_WORD *)((char *)&v18 + 5) = (v10 & 0x20) != 0;
  ...
  {
    if ( WPP_RECORDER_INITIALIZED != (_UNKNOWN *)&WPP_RECORDER_INITIALIZED )
      WPP_RECORDER_SF_(*(_QWORD *)(v9 + 1432), 2u, 5u, 0x1Au, (__int64)&WPP_e683e3a97dd23da98d402d95dd0016a2_Traceguids);
    return (unsigned int)-1073737984;
  }
