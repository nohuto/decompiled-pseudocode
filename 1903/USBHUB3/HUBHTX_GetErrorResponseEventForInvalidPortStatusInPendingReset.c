/*
 * XREFs of HUBHTX_GetErrorResponseEventForInvalidPortStatusInPendingReset @ 0x1C0005A94
 * Callers:
 *     HUBPSM20_ErrorOnResettingPort @ 0x1C000FF50 (HUBPSM20_ErrorOnResettingPort.c)
 * Callees:
