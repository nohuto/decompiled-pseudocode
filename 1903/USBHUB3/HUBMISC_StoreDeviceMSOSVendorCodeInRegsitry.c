/*
 * XREFs of HUBMISC_StoreDeviceMSOSVendorCodeInRegsitry @ 0x1C00793DC
 * Callers:
 *     HUBDSM_MarkDeviceAsSupportingMSOSDescriptor @ 0x1C001E460 (HUBDSM_MarkDeviceAsSupportingMSOSDescriptor.c)
 * Callees:
