/*
 * XREFs of sub_18001A0D8 @ 0x18001A0D8
 * Callers:
...
__int64 __fastcall sub_18001A0D8(
        char *a1,
        unsigned __int64 a2,
        __int64 a3,
        _WORD *a4,
...
LABEL_18:
  ...
  while ( 1 )
  {
    ...
    for ( i = a2; i < v8; i += 2LL )
    {
      if ( !*(_WORD *)v11 )
        break;
      sub_18001A234(*(unsigned __int16 *)v11);
      v15 = sub_18001A234(*v14);
      if ( v16 != v15 )
        break;
      v11 += 2;
    }
...
LABEL_12:
    ...
    if ( a7 )
    {
      ...
      {
        v25 = (_DWORD *)((char *)&unk_180165B80 + 56 * v24 - 56);
        if ( *v25 < 3u )
        {
          v26 = (char **)(v25 + 2);
