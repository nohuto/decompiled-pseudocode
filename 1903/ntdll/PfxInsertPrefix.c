/*
 * XREFs of PfxInsertPrefix @ 0x1800E47A0
 * Callers:
 *     <none>
 * Callees:
 *     RtlSplay @ 0x180064960 (RtlSplay.c)
 *     sub_1800E4494 @ 0x1800E4494 (sub_1800E4494.c)
 *     sub_1800E4614 @ 0x1800E4614 (sub_1800E4614.c)
 */
...
BOOLEAN __cdecl PfxInsertPrefix(PPREFIX_TABLE PrefixTable, PSTRING Prefix, PPREFIX_TABLE_ENTRY PrefixTableEntry)
{
  ...
  v6 = sub_1800E4614(&Prefix->Length);
  ...
  if ( i->NameLength == v6 )
  {
    ...
    {
      v11 = sub_1800E4494((unsigned __int16 *)j[2].NextPrefixTree, &Prefix->Length);
      if ( v11 == 2 )
        break;
      if ( v11 == 3 )
      {
