/*
 * XREFs of sub_1800685E0 @ 0x1800685E0
 * Callers:
...
__int64 __fastcall sub_1800685E0(__int64 a1, __int64 a2, unsigned int *a3, unsigned __int64 *a4)
{
  __int64 v5; // r9
  ...
  v5 = 16 * (WORD1(qword_180163540) ^ WORD1(a1) ^ *(unsigned __int16 *)(a1 + 2));
