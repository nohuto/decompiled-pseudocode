/*
 * XREFs of RtlCreateAndSetSD @ 0x1800686E0
 * Callers:
 ...
 *     RtlSetSaclSecurityDescriptor @ 0x180068B20 (RtlSetSaclSecurityDescriptor.c)
 */
...
LABEL_9:
    ...
    Heap = RtlAllocateHeap((__int64)ProcessHeap, dword_18016542C + 1310720, v15);
    v17 = (_BYTE *)Heap;
    if ( Heap )
    {
      v18 = Heap + 40;
      ...
      v7 = RtlAllocateHeap((__int64)ProcessHeap, dword_18016542C + 1310720, v6);
      if ( v7 )
      {
        v19 = 0;
        if ( a2 )
...
LABEL_23:
            ...
            *(_BYTE *)(v7 + 1) = v25 | v26;
            v23 += 12;
            *(_WORD *)(v7 + 2) = v23;
            Acl = RtlCopySid(4 * (unsigned int)v22[1] + 8, (void *)(v7 + 8), v22);
LABEL_24:
            if ( Acl < 0 )
              goto LABEL_48;
...
LABEL_27:
        ...
        if ( Acl >= 0 )
        {
          Acl = RtlSetOwnerSecurityDescriptor((__int64)v17, a3, 0);
          if ( Acl >= 0 )
          {
            Acl = RtlSetGroupSecurityDescriptor((__int64)v17, a4, 0);
            if ( Acl >= 0 )
            {
              Acl = RtlSetDaclSecurityDescriptor((__int64)v17, 1, v29, 0);
              if ( Acl >= 0 )
              {
                LOBYTE(v27) = v30 != 0;
...
LABEL_48:
      RtlFreeHeap((__int64)ProcessHeap, 0, (__int64)v17);
LABEL_33:
      if ( v7 )
