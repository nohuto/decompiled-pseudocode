...
__int64 __fastcall sub_180035FA0(__int64 a1, __int64 a2, volatile signed __int64 *a3, __int64 a4)
{
  ...
  if ( v16 )
  {
    ...
    *((_DWORD *)v8 + 28) = v19;
    ...
    if ( (unsigned int)RtlGetCurrentServiceSessionId(v20) )
      v21 = (__int64)NtCurrentPeb()->HotpatchInformation + 556;
    else
      v21 = 2147353478LL;
    if ( *(_BYTE *)v21 )
      sub_18010F85C(v8, v17, (unsigned int)v19);
  ...
  while ( v24 != &v31 )
  {
    ...
    LOBYTE(v23) = v5;
    v24 = (_QWORD *)*v24;
    sub_180036320(v25, v4, v23);
  }
  if ( (unsigned int)RtlGetCurrentServiceSessionId(v22) )
    v26 = (__int64)NtCurrentPeb()->HotpatchInformation + 556;
  else
    v26 = 2147353478LL;
  if ( *(_BYTE *)v26 )
  {
    ...
    ZwTraceEvent(*(unsigned __int8 *)v9, 1026LL, 8LL, v35);
  }
