...
__int64 __fastcall sub_1800413B0(unsigned __int64 a1, __int64 a2, __int64 a3, int a4)
{
  ...
  if ( !a3 )
    goto LABEL_16;
  v9 = a3 - HIWORD(v69) - a2;
  v10 = *(_QWORD *)(a1 + 8LL * byte_180120E60[(unsigned __int64)((unsigned int)(unsigned __int16)v69 + 15) >> 4] + 128);
  v11 = *(_DWORD *)(v10 + 72);
  v12 = *(_BYTE *)(v10 + 76);
  if ( v11 )
  {
    ...
    if ( *(_BYTE *)(v6 + 45) > 1u )
    {
      ...
      if ( v22 < v24 )
      {
        ...
        if ( (_DWORD)v23 != -1 )
        {
          ...
          do
          {
            v55 = sub_18004308C(v6, (unsigned int)v23, &v70);
            v66 = v55;
            if ( v55 == -1 )
              break;
            v59 = v70;
            ...
            else if ( v31 )
            {
              ...
              ((void (__fastcall *)(_QWORD, __int64, _QWORD))(a1 ^ qword_180163540 ^ *(_QWORD *)(a1 + 32)))(
                *(_QWORD *)a1,
                v6 + (unsigned int)(v55 << v60),
                v70 << v60);
              sub_18004F5D0(a1, v6, v61, v62);
              if ( !v32 )
                break;
              LODWORD(v23) = v59 + v66;
            }
...
LABEL_69:
        ...
        if ( v6 )
        {
          v49 = *(volatile signed __int64 **)(v7
                                            + 8LL
                                            * byte_180120E60[(unsigned __int64)((unsigned int)(unsigned __int16)v69 + 15) >> 4]
                                            + 128);
