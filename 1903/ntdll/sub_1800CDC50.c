...
__int64 __fastcall sub_1800CDC50(_QWORD *a1, STRING *a2)
{
  int v3; // ebx
  ...
  {
    v5 = 0x800000;
    v3 = sub_180025240((unsigned __int16 *)&v7, (unsigned __int16 *)&v10, 0LL, &v5);
    if ( v3 >= 0 )
      v3 = sub_1800CDE60(a1[21], (unsigned int)&v10, a1[2], v5, a1[7], (__int64)v6, a1[5]);
  }
  if ( v9 != v8 )
