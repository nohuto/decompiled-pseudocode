...
__int64 __fastcall LdrLoadEnclaveModule(unsigned __int64 a1, __int64 a2, __int64 a3)
{
  ...
  v5 = sub_18001B2F8(a1, 1);
  v6 = v5;
  if ( !v5 )
    return 3221225632LL;
  if ( *((_DWORD *)v5 + 14) == 16 )
  {
    sub_180021798(*(_QWORD *)(a3 + 8), a2, v13);
    ...
    else
    {
      ...
      v17 = 0;
      v11 = 0x800000;
      v8 = sub_180025240((unsigned __int16 *)a3, (unsigned __int16 *)&v15, 0LL, &v11);
      if ( v8 >= 0 )
      {
        v12[0] = 0;
        v8 = sub_1800CD8F0((_DWORD)v6, (unsigned int)&v15, v11, 7, (__int64)v13, 0LL, 0LL, (__int64)v12);
        if ( v8 >= 0 )
        {
