/*
 * XREFs of sub_1800FCBA8 @ 0x1800FCBA8
 * Callers:
 *     RtlpWow64SetContextOnAmd64 @ 0x18006CDD0 (RtlpWow64SetContextOnAmd64.c)
 * Callees:
 *     sub_1800F6A44 @ 0x1800F6A44 (sub_1800F6A44.c)
 */

__int64 __fastcall sub_1800FCBA8(unsigned int a1, __int64 a2, __int64 a3)
{
  unsigned int v4; // edi
  __int64 v5; // r9
  _OWORD *v6; // rdx
