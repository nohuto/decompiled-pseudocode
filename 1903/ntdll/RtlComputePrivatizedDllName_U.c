...
__int64 __fastcall RtlComputePrivatizedDllName_U(__int16 *a1, __int64 a2, __int64 a3)
{
  ...
  Buffer = (wchar_t *)*((_QWORD *)&xmmword_180164380 + 1);
  Size = 0;
  v11 = 0;
  v12 = v6 == 0LL ? 8 : 0;
  v35 = v4 + 2 * (1 - ((v7 - v3) >> 1));
  if ( *((_QWORD *)&xmmword_180164380 + 1) )
  {
    ...
    if ( (_WORD)xmmword_180164380 )
    {
      do
      {
        if ( *(_WORD *)(*((_QWORD *)&xmmword_180164380 + 1) + 2 * ((unsigned __int64)(unsigned int)Length >> 1)) == 59 )
          break;
        LODWORD(Length) = Length + 2;
      }
      while ( (unsigned int)Length < (unsigned __int16)xmmword_180164380 );
    }
  }
  else
  {
    ...
    v19 = (char *)sub_18006D6B8((unsigned __int16)(v35 + v12 + v18));
    v34 = v19;
    v20 = v19;
    if ( !v19 )
      return 3221225495LL;
    ...
    {
      *(_QWORD *)&v21[2 * v22] = 0x4C004C0044002ELL;
      *(_WORD *)&v21[2 * v22 + 8] = 0;
    }
  }
  ...
  v25 = (char *)sub_18006D6B8((unsigned __int16)v23);
  v26 = v25;
  if ( !v25 )
    return 3221225495LL;
