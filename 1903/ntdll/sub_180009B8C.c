/*
 * XREFs of sub_180009B8C @ 0x180009B8C
 * Callers:
...
__int16 __fastcall sub_180009B8C(_QWORD *a1, _QWORD *a2, char a3, char a4, char a5, char a6)
{
  struct _PEB *v6; // rax
  int v11; // ecx
  int v12; // r8d
      ...
      if ( a2 )
      {
        if ( *a1 )
        {
          if ( *a2 )
          {
            if ( qword_1801663E8 )
            {
              LOWORD(v6) = _InterlockedDecrement16(&word_180162738);
              if ( !(_WORD)v6 )
              {
                if ( (unsigned int)dword_18015F590 > 5 && sub_1800062B0((__int64)&dword_18015F590, 0x200000000000LL) )
                {
                  v14 = *a2 - *a1;
                  v24 = 0;
                  v27 = 0;
                  ...
                  v17 = a4;
                  v36 = 0;
                  v20 = 1000000 * v14 / qword_1801663E8;
                  v18 = a5;
                  v19 = a6;
                  v22 = &v20;
                  v25 = &v16;
