/*
 * XREFs of sub_1800E2674 @ 0x1800E2674
 * Callers:
...
NTSTATUS __fastcall sub_1800E2674(WCHAR *DosFileName, PVOID *BaseModule, PSIZE_T Size, int a4)
{
  __int64 v8; // r14
  __int64 v9; // rcx
  __int64 v10; // rdi
  ...
  if ( (*(_BYTE *)v9 & 1) != 0 )
  {
    if ( RtlGetCurrentServiceSessionId() )
      ...
      v11 = 2147353476LL;
    sub_1800E0820((unsigned __int16 *)&v21, *(unsigned __int8 *)v11);
  }
...
LABEL_26:
      if ( (a4 & 0x20000) != 0 )
      {
        result = sub_1800E2500((char *)DosFileName, &v20);
        if ( result < 0 )
          return result;
...
LABEL_37:
  ...
  if ( (*(_BYTE *)v8 & 1) != 0 )
  {
    ...
    sub_1800E0820((unsigned __int16 *)&v24, *(unsigned __int8 *)v10);
  }
  return v12;
}
