...
__int64 __fastcall sub_1800E2674(wchar_t *String2, wchar_t **a2, _QWORD *a3, int a4)
{
  __int64 v8; // r14
  __int64 v9; // rcx
  int File; // ebx
  ...
  if ( (*(_BYTE *)v9 & 1) != 0 )
  {
    ...
    sub_1800E0820((unsigned __int16 *)&v15);
  }
  if ( !String2 || !a2 || !a3 )
    goto LABEL_31;
  *a2 = 0LL;
...
LABEL_22:
  if ( (a4 & 0x20000) == 0 )
    goto LABEL_26;
  result = sub_1800E2500((__int64)String2, &v14);
  if ( (int)result < 0 )
    return result;
...
LABEL_32:
  ...
  {
    RtlGetCurrentServiceSessionId();
    sub_1800E0820((unsigned __int16 *)&v18);
  }
