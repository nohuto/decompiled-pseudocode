/*
 * XREFs of sub_18002C138 @ 0x18002C138
 * Callers:
 *     sub_18002BFC0 @ 0x18002BFC0 (sub_18002BFC0.c)
 * Callees:
 *     sub_180002358 @ 0x180002358 (sub_180002358.c)
...
__int64 __fastcall sub_18002C138(
        wchar_t *String1,
        int a2,
        unsigned __int16 *a3,
        int *a4,
...
LABEL_31:
  ...
  {
    LOBYTE(v10) = v13;
    v21 = sub_18002C690(v14, v20, v10, v19);
    v24 = (wchar_t *)v21;
    if ( (wchar_t *)v21 == v14 )
      break;
    if ( !v13
      && (a6 && (*v14 == 45 || v21 > v23 && *(_WORD *)(v21 - 2) == 45)
       || (__int64)((v21 - (_QWORD)v14) & 0xFFFFFFFFFFFFFFFEuLL) > v22) )
    {
      return 3221227286LL;
    }
...
LABEL_12:
      ...
      {
        v27 = 1;
        while ( (v13 || (!a6 || (unsigned __int8)sub_180080D64(*v26)) && *v26 >= 0x20u && *v26 != 127)
    ...
    if ( v29 && v29 > v14 )
    {
      ...
      if ( v14 != v29 )
      {
        ...
        do
        {
          if ( v9 >= v12 )
            break;
          if ( !v13 && (a6 && !(unsigned __int8)sub_180080D64(*v30) || *v30 < 0x20u || *v30 == 127) )
            return 3221227286LL;
          v33 = *v30;
...
LABEL_61:
      ...
      for ( i = 36; v38 < v24; i += 36 )
      {
        ...
        if ( v42 < v43 )
        {
          v54 = sub_180002358(v36 - v39, (unsigned int)(v9 - v55) - v59 + 1, v39 == 0);
          v45 = v44 - v59;
          v46 = v36 / (v45 + 1);
          v47 = v36 % (v45 + 1);
          v48 = v47;
...
LABEL_80:
          if ( v35 >= 0x10000 )
          {
            if ( (unsigned __int64)v9 >= v56 - 2 || v49 > v9 )
              return 3221227286LL;
            sub_1800023BC((v35 - 0x10000) / 1024 - 10240, v49, &v60);
            ++v59;
            v50 = v52 - 9216;
