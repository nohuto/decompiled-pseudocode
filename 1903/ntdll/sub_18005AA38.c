...
char __fastcall sub_18005AA38(_WORD *a1, __int64 a2, __int64 a3, __int64 a4, unsigned int a5, int a6)
{
  char v6; // bl
  char v11; // r12
  ...
  if ( !v16 || v16 == 2 )
  {
    if ( !a4 )
      goto LABEL_20;
    if ( (int)sub_1800EB844(a1, a3, a4, &v25) < 0 )
      goto LABEL_19;
    v17 = 0;
...
LABEL_20:
            ...
            if ( !v11 )
            {
              while ( v21 < 4 )
              {
                ...
                if ( v22 == 2 )
                {
                  if ( (unsigned __int8)sub_18005AA38(
