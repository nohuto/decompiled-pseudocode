/*
 * XREFs of sub_180002B80 @ 0x180002B80
 * Callers:
 *     sub_180002940 @ 0x180002940 (sub_180002940.c)
 *     RtlQueryTimeZoneInformation @ 0x180002B70 (RtlQueryTimeZoneInformation.c)
 *     RtlQueryDynamicTimeZoneInformation @ 0x1800EB330 (RtlQueryDynamicTimeZoneInformation.c)
 * Callees:
...
__int64 __fastcall sub_180002B80(char *a1, size_t Size)
{
  unsigned int v2; // esi
  __int64 result; // rax
  int v5; // edi
