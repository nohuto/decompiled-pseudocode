/*
 * XREFs of sub_180108990 @ 0x180108990
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall sub_180108990(
        char *a1,
        size_t Size,
        __int16 *a3,
        unsigned int a4,
...
LABEL_35:
  ...
  while ( 1 )
  {
    ...
    if ( v19 )
    {
      v14 = sub_1800A18F0(v18, v11, v22, v21, &v31);
      if ( v14 < 0 )
        goto LABEL_19;
      a5 = v19;
    }
    ...
    {
      v14 = sub_1800A18F0(v18, v11, v22, v21, &a5);
      if ( v14 < 0 )
      {
LABEL_19:
        v23 = a5;
...
LABEL_27:
  ...
  v14 = sub_1800A18F0(a8, a8 + 4096, (_BYTE *)(v12 + 2), v17 + v12, &v32);
  if ( v14 < 0 )
  {
    v23 = v32;
    goto LABEL_20;
