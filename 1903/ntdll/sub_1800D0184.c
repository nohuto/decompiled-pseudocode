...
char __fastcall sub_1800D0184(int a1, unsigned __int16 *a2, char a3, int a4, unsigned __int16 *a5)
{
  ...
  v9 = RtlRunOnceExecuteOnce(
         &qword_1801660C0,
         (unsigned int (__fastcall *)(volatile signed __int64 *, __int64, unsigned __int64 *))sub_1800827D0,
         0LL,
         0LL);
  if ( v9 >= 0 && (unsigned int)dword_18015F450 > 5 )
  {
    ...
    if ( (_BYTE)v9 )
    {
      ...
      v28 = 2LL;
      v30[1] = v11;
      LOBYTE(v9) = sub_18008935C((__int64)&dword_18015F450, byte_18012BBD1, v10, v11, 9, (__int64)v16);
    }
  }
  return v9;
}
