/*
 * XREFs of RtlWow64LogMessageInEventLogger @ 0x1800D6B70
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall RtlWow64LogMessageInEventLogger(__int16 a1, __int64 a2, unsigned int a3)
{
  ...
  result = LdrLoadDll(0LL, 0LL, (__int64)&unk_180119408, &v14);
  if ( (int)result >= 0 )
  {
    if ( (int)LdrGetProcedureAddressForCaller(v14, &qword_180119428, 0, &v10, 0, retaddr) >= 0
      && (int)LdrGetProcedureAddressForCaller(v14, &qword_180119418, 0, v12, 0, retaddr) >= 0
      && (int)LdrGetProcedureAddressForCaller(v14, &qword_180119438, 0, &v11, 0, retaddr) >= 0 )
    {
