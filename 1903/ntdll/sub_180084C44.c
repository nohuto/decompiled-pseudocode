...
__int64 __fastcall sub_180084C44(__int64 a1, __int64 a2, unsigned __int64 a3, unsigned int a4, int a5)
{
  ...
  if ( a5 )
  {
    v15 = ((__int64 (__fastcall *)(__int64, __int64, _QWORD))(a1 ^ qword_180163540 ^ *(_QWORD *)(a1 + 152)))(
            v13,
            v10,
            v11);
    if ( v15 < 0 )
  ...
  {
    ((void (__fastcall *)(__int64, __int64, _QWORD))(a1 ^ qword_180163540 ^ *(_QWORD *)(a1 + 160)))(v13, v10, v11);
    *(_QWORD *)(a2 + 16) &= ~v12;
    v14 = -(int)v7;
  }
