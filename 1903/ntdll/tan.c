...
double __cdecl tan(double X)
{
  ...
  if ( (v1 & 0xFFFFFFFFFFFFFLL) != 0 )
    sub_1800946BC((unsigned int)"tan", 32, v1, 1, 0, 33, *(__int64 *)&v3, 0LL, 1);
  else
    sub_1800946BC((unsigned int)"tan", 32, 0, 1, 8, 33, *(__int64 *)&v3, 0LL, 1);
  return X;
}
