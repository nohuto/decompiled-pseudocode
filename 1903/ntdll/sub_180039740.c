/*
 * XREFs of sub_180039740 @ 0x180039740
 * Callers:
...
__int64 __fastcall sub_180039740(__int64 SRWLock, __int64 a2, __int64 a3, unsigned int a4, char a5, __int64 a6)
{
  __int64 v7; // r13
  ...
  v7 = a4;
  v9 = WORD1(qword_180163540) ^ WORD1(a3) ^ *(unsigned __int16 *)(a3 + 2);
  RtlRbRemoveNode((PRTL_RB_TREE)(SRWLock + 16), (PRTL_BALANCED_NODE)(a3 + 8));
  v11 = 0LL;
  v12 = qword_180163540 ^ *(_DWORD *)a3 ^ a3;
  v13 = a3 - a2;
  v14 = 16 * HIWORD(v12);
  ...
  *(_QWORD *)(SRWLock + 56) -= (unsigned int)((v14 + (unsigned __int64)(a3 & 0xFFF) + 4095) >> 12)
  ...
  v21 = v18;
  LODWORD(v67) = v19;
  *(_BYTE *)(a3 + 6) = BYTE6(a3) ^ BYTE6(qword_180163540) ^ ((v66 & 0xFF00FFFF | 0x10000) >> 16);
  v70 = (unsigned __int8)(qword_180163540 ^ a3 ^ (v13 >> 12));
  *(_DWORD *)(a3 + 8) = v70;
  v22 = 16 * v18 + 32;
  if ( !v19 )
    v22 = 16 * v18;
  ...
  if ( v25 )
  {
    *(_DWORD *)(a3 + 8) = v70 | 0x200;
    ...
    v65 = ((__int64 (__fastcall *)(__int64, __int64, _QWORD))(SRWLock ^ qword_180163540 ^ *(_QWORD *)(SRWLock + 152)))(
  ...
  *(_WORD *)(a3 + 2) = WORD1(qword_180163540) ^ v21 ^ WORD1(a3);
  if ( v20 )
  {
    v26 = a3 + 16LL * v21;
    if ( v21 )
      ...
      v27 = (unsigned __int16)((qword_180163540 ^ v26 ^ *(_QWORD *)v26) >> 32);
    HIDWORD(v63) = v27 & 0xFF00FFFF | 0x10000;
    LODWORD(v63) = v20 << 16;
    *(_QWORD *)v26 = v63 ^ qword_180163540 ^ v26;
    v28 = v26 + 16LL * v20;
    *(_DWORD *)(v26 + 8) = (unsigned __int8)(qword_180163540 ^ v26 ^ ((unsigned int)(v26 - a2) >> 12));
    if ( v28 < a2 + 16 * ((unsigned __int64)*(unsigned __int16 *)(a2 + 32) + 3) )
      *(_WORD *)(v28 + 4) = WORD2(v28) ^ WORD2(qword_180163540) ^ v20;
    for ( i = 0; ; i = v32 )
    {
      v30 = sub_180039500(SRWLock, a2, v26, &v70);
      v32 = v70;
      v26 = v30;
      if ( v70 == *(unsigned __int16 *)(a2 + 32) )
      {
        sub_180051450(SRWLock, a2);
        return v21;
      }
      if ( v70 <= i )
        break;
      v33 = (v30 - a2 + 4127) & 0xFFFFF000;
      v34 = (v30 + 16 * (WORD1(qword_180163540) ^ WORD1(v30) ^ *(unsigned __int16 *)(v30 + 2)) - a2) & 0xFFFFF000;
      if ( v33 >= v34 )
        break;
      v48 = v34 - v33;
      v49 = v33 >> 12;
      ...
      v67 ^= qword_180163540 ^ v30;
      *(_BYTE *)(v30 + 6) = BYTE6(v67);
      *(_DWORD *)(v30 + 8) = (unsigned __int8)(qword_180163540 ^ v30 ^ ((unsigned int)(v30 - a2) >> 12)) | 0x200;
      v64 = a5 & 1;
      if ( (a5 & 1) == 0 )
      {
        RtlReleaseSRWLockExclusive(*(PRTL_SRWLOCK *)(a6 + 8));
      ...
      sub_180084C44(SRWLock, a2, v50, v31, 0);
      if ( !v64 )
      {
        v52 = a6;
        *(_QWORD *)a6 = 0LL;
    ...
    {
      v60 = sub_18010BC08(v31, a2, v30);
      if ( v60 )
        sub_180068434(SRWLock, a2, v60);
    }
    v35 = 16 * (WORD1(qword_180163540) ^ WORD1(v26) ^ *(unsigned __int16 *)(v26 + 2));
    ...
    *(_WORD *)v26 = qword_180163540 ^ v26 ^ (v37 + (v39 >> 12) - v41);
    v42 = *(PVOID *)(SRWLock + 24);
    ...
    if ( v11 )
    {
      while ( 1 )
      {
        if ( ((unsigned int)qword_180163540 ^ *(_DWORD *)v26 ^ (unsigned int)v26) < ((unsigned int)qword_180163540 ^ *(_DWORD *)(v11 - 8) ^ ((_DWORD)v11 - 8)) )
        {
          v45 = *(_QWORD *)v11;
          if ( v44 )
          {
