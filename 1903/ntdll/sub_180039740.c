...
__int64 __fastcall sub_180039740(__int64 a1, __int64 a2, __int64 a3, unsigned int a4, char a5, __int64 a6)
{
  __int64 v7; // r13
  ...
  *(_DWORD *)(a3 + 8) = v70;
  ...
  if ( v25 )
  {
    *(_DWORD *)(a3 + 8) = v70 | 0x200;
    ...
    v65 = ((__int64 (__fastcall *)(__int64, __int64, _QWORD))(a1 ^ qword_180163540 ^ *(_QWORD *)(a1 + 152)))(
            a1 ^ *(_QWORD *)(a1 + 128),
  ...
  *(_WORD *)(a3 + 2) = WORD1(qword_180163540) ^ v21 ^ WORD1(a3);
  if ( v20 )
  {
    ...
    *(_DWORD *)(v26 + 8) = (unsigned __int8)(qword_180163540 ^ v26 ^ ((unsigned int)(v26 - a2) >> 12));
    ...
    for ( i = 0; ; i = v32 )
    {
      v30 = sub_180039500(a1, a2, v26, &v70);
      v32 = v70;
      v26 = v30;
