...
__int64 __fastcall sub_1800356E0(__int64 a1, __int64 a2, unsigned int a3, unsigned int a4, __int64 a5, char *a6)
{
  __int64 v6; // r12
  __int64 v8; // r10
  __int64 v9; // rdx
    ...
    *(_DWORD *)(v14 + 8) += a3 - 1;
    do
    {
      ...
      if ( v17 )
      {
        if ( v10 )
        {
          v28 = (_RTL_SRWLOCK **)(a2 + 56LL * v15);
          SRWLock = v17 + 4;
          memmove(v28, (const void *)(a2 + 32LL * v15), 0x20uLL);
          v29 = SRWLock;
          v28[6] = (_RTL_SRWLOCK *)v14;
          ...
          v33 = SRWLock;
          *v30 = v31;
          v30[1] = (_RTL_SRWLOCK *)Ptr;
          *Ptr = (_RTL_SRWLOCK *)v30;
          v31[1].Ptr = v30;
...
LABEL_61:
    ...
    if ( v12 != a3 - 1 && _InterlockedExchangeAdd((volatile signed __int32 *)(v14 + 8), 0xFFFFFFFF) == 1 )
      RtlFreeHeap(NtCurrentPeb()->ProcessHeap, dword_180166080 + 3145728, *(PVOID *)v14);
    if ( v13 )
    {
      v36 = (__int64)(v59 - 2);
      v37 = &v56 + 4;
