...
__int64 __fastcall sub_1800D4A28(unsigned __int16 *a1, int *a2)
{
  int v3; // r14d
  int v4; // r8d
  __int64 v5; // rax
  ...
  if ( (int)sub_180073150(&DestinationString.Length, 11LL, 0, &v11) < 0 )
  {
    if ( (int)sub_180073150(&DestinationString.Length, 9LL, 0, &v11) < 0 )
    {
      *a2 = 1;
      return 0LL;
    }
