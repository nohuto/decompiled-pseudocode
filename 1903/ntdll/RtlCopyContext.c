...
NTSTATUS __cdecl RtlCopyContext(PCONTEXT Context, ULONG ContextFlags, PCONTEXT Source)
{
  ...
  v6 = 0;
  XmmRegisters = 0LL;
  result = sub_18001ED88(ContextFlags, 0LL);
  if ( result >= 0 )
  {
    v19 = (_DWORD *)sub_18006656C(Context, ContextFlags);
    v10 = (int *)sub_18006656C(Source, v9);
    v12 = *v11;
    v13 = *v10;
    result = sub_18001ED88(ContextFlags | *v10 | *v11, 0LL);
    if ( result >= 0 )
    {
      ...
      if ( result >= 0 )
      {
        ...
        if ( result >= 0 )
        {
          ...
          {
            sub_1800665B4(v15, Context, v14, Source);
            *v19 |= v12;
            if ( (v20 & 0xFFFFFFFE) != 0 )
            {
              if ( (v14 & 0x10000) != 0 )
            ...
            if ( (v18 & 2) == 0 )
              return v16;
            result = sub_1800667F8(v17, v6, v6, (_DWORD)XmmRegisters, (__int64)XmmRegisters);
            v16 = result;
            if ( result >= 0 )
              return v16;
          }
