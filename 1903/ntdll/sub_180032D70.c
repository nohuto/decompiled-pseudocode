...
struct _PEB *__fastcall sub_180032D70(__int64 a1, __int64 a2)
{
  _QWORD *v2; // rbx
  int v3; // ebp
  __int64 v5; // rdi
  ...
  __int64 v11; // r10
  __int64 v12; // rdx
  void (__fastcall *v13)(__int64, __int64); // r8
  _DWORD *ThreadPoolData; // rcx
  int v15; // eax
  unsigned int v16; // eax
  __int64 v17; // r9
  void (__fastcall **v18)(__int64, __int64); // rsi
  _DWORD *v19; // rcx
  ...
  result = (struct _PEB *)sub_180032F0C(a1, v2, 1LL);
  if ( (_DWORD)result )
  {
    ...
    v11 = v2[13];
    v12 = v2[11];
    v13 = (void (__fastcall *)(__int64, __int64))v2[10];
    ...
    if ( ThreadPoolData )
    {
      ...
      v17 = 8LL * v16;
      v18 = (void (__fastcall **)(__int64, __int64))&ThreadPoolData[v17 + 8];
    ...
    if ( v18 )
    {
      ...
      if ( MEMORY[0x7FFE0008] - MEMORY[0x7FFE03B0] >= (__int64)v18[3] )
      {
        ...
        v18[3] = (void (__fastcall *)(__int64, __int64))result;
      }
    }
  }
  return result;
