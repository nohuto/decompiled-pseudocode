/*
 * XREFs of sub_1800162BC @ 0x1800162BC
 * Callers:
...
__int64 __fastcall sub_1800162BC(__int64 a1, int a2, __int64 a3, __int16 *a4)
{
  unsigned int v4; // ebx
  __int16 v5; // r10
  __int64 v8; // rbp
...
LABEL_3:
    if ( a2 == 1 )
      return (unsigned int)sub_180016414(a1, (unsigned __int16)v5, a3, a4);
    if ( a2 == 2 )
    {
