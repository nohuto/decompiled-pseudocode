...
unsigned __int64 __fastcall sub_18010BEF4(__int64 a1, unsigned __int64 a2, _WORD *a3, char a4, __int64 a5)
{
  __int64 v5; // r12
  unsigned int i; // r14d
  __int64 v11; // rcx
  ...
  for ( i = 0; ; i = v14 )
  {
    a3 = (_WORD *)sub_180039500(a1, a2, (unsigned __int64)a3, &v14);
    if ( v14 == *(unsigned __int16 *)(a2 + 32) )
    {
      sub_180051450(a1, a2);
      return a2;
    }
    if ( v14 <= i || !(unsigned int)sub_18010BD2C(a1, a2, (__int64)a3, a4, v5) )
      break;
  }
  if ( (*(_BYTE *)(a1 + 176) & 1) != 0 && ((unsigned __int64)(a3 + 16) & 0xFFF) != 0 )
  {
    v12 = (_WORD *)sub_18010BC08(v11, a2, (__int64)a3);
    if ( v12 )
      sub_180068434(a1, a2, v12);
  }
  sub_180068434(a1, a2, a3);
  return 0LL;
}
