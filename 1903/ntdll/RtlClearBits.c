/*
 * XREFs of RtlClearBits @ 0x180059350
 * Callers:
 *     sub_1800550B8 @ 0x1800550B8 (sub_1800550B8.c)
 *     sub_18005611C @ 0x18005611C (sub_18005611C.c)
 *     RtlFindSetBitsAndClear @ 0x1800E9AB0 (RtlFindSetBitsAndClear.c)
 * Callees:
...
void __cdecl RtlClearBits(PRTL_BITMAP BitMapHeader, ULONG StartingIndex, ULONG NumberToClear)
{
  ...
  if ( NumberToClear )
  {
    ...
    {
      v7 = ~(byte_1801241F0[NumberToClear] << v4);
LABEL_4:
      *v5 &= v7;
      return;
    }
