...
__int64 __fastcall sub_180003870(
        __int64 a1,
        __int64 a2,
        unsigned __int64 a3,
        _DWORD *a4,
    ...
    if ( v13 == 7 )
    {
      ...
      for ( i = v17; (unsigned __int64)i < v32; v17 = i )
      {
        ...
        if ( (v36 & 0x20) != 0 )
        {
          ...
          v38 = sub_180003C3C(1LL, v17, v37, *(_QWORD *)(a2 + 24));
          *(_QWORD *)(a2 + 24) += 16LL;
        }
        else
        {
          v38 = (*(__int64 (__fastcall **)(char *, __int64, _WORD *, _QWORD, __int64, _QWORD))a2)(
                  v16,
                  1LL,
                  v17,
                  v37,
...
LABEL_10:
  ...
  if ( (v19 & 0x20) != 0 )
  {
    ...
    v21 = sub_180003C3C(v13, v17, v15, *(_QWORD *)(a2 + 24));
  }
  else
  {
