/*
 * XREFs of sub_18004AFB0 @ 0x18004AFB0
 * Callers:
...
signed __int64 __fastcall sub_18004AFB0(__int64 a1, unsigned int a2)
{
  __int64 v4; // r14
  ...
  if ( (result & 3) == 1 )
  {
    ...
    if ( v6 == result )
    {
      ...
      v22 = v12 + v11 + 63;
      if ( (dword_180163534 & 0x200) != 0 )
        v8 = v7;
      v13 = v12 + v11 + 63 + (v9 + 64) * v8;
      result = ((__int64 (__fastcall *)(_QWORD, size_t))(a1 ^ qword_180163540 ^ *(_QWORD *)(a1 + 40)))(
                 *(_QWORD *)a1,
                 v13);
      v14 = 0;
      v15 = result;
        ...
        if ( v8 )
        {
          ...
          do
          {
            *(_QWORD *)(*(_QWORD *)(v15 + 96) + 8 * v17) = v16;
            v18 = *(_BYTE **)(*(_QWORD *)(v15 + 96) + 8 * v17);
            memset(v18, 0, 0x40uLL);
            sub_18004AF48(v18, *(_BYTE *)(v15 + 1), v14);
            ++*(_BYTE *)(v15 + 2);
            v16 += v23;
