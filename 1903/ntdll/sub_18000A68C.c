/*
 * XREFs of sub_18000A68C @ 0x18000A68C
 * Callers:
...
ULONG __fastcall sub_18000A68C(__int64 a1, __int64 a2, int a3)
{
  char v6; // bp
  _QWORD *v7; // rbx
  ...
  if ( !byte_180165408 )
  {
    v9 = RtlRunOnceExecuteOnce(&stru_180166450, sub_18007CD00, 0LL, 0LL);
    if ( v9 )
