...
__int64 __fastcall sub_180046028(__int64 a1, size_t a2, unsigned __int64 a3, unsigned int a4, int *a5)
{
  ...
  if ( a3 > (unsigned int)*(unsigned __int16 *)(a1 + 892) - 16
    || (v10 = sub_180046108(a1 + 832), a3 = (unsigned int)v6, a2 = (unsigned int)v7, v10 == -1) )
  {
    if ( v6 > 0x20000 )
    {
      if ( v6 > *(unsigned int *)(a1 + 464) )
      {
        v12 = (void *)sub_1800508C8(a1, v7, v6, a4);
      }
      else
      {
        v13 = a1 + 256;
        if ( v6 > *(unsigned int *)(a1 + 272) )
          v13 = a1 + 448;
        v12 = sub_180036D88(v13, v7, v6, v6, a4);
      }
    }
    else
    {
      v12 = (void *)sub_18004871C(a1 + 640, a2, a3, a4);
    }
    v10 = (__int64)v12;
  }
  else
