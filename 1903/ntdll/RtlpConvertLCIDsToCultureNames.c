/*
 * XREFs of RtlpConvertLCIDsToCultureNames @ 0x1800EC9F0
 * Callers:
...
__int64 __fastcall RtlpConvertLCIDsToCultureNames(WCHAR *SourceString, __int64 *a2)
{
  ...
  v4 = 0;
  v5 = 0;
  if ( !a2 || !SourceString || *a2 || (int)sub_18000EEB4(SourceString, (__int64)a2, &v14) < 0 )
    return 3221225485LL;
  v6 = 2 * v14;
...
LABEL_16:
    ...
    if ( (int)sub_1800EBD90(&DestinationString.Length, &v20[v4]) < 0 )
      goto LABEL_20;
    v10 = v20[v4];
    Src = &v21;
    v16 = 11141120;
