...
__int64 __fastcall RtlCreateHeap(int a1, char *a2, __int64 a3, unsigned __int64 a4, __int64 a5, __int64 a6)
{
  ...
  char v89[40]; // [rsp+1F0h] [rbp-88h] BYREF
...
LABEL_87:
  ...
  if ( (byte_180166058 & 1) != 0 && (v9 & 2) != 0 && !a2 )
  {
    if ( !v8 )
      goto LABEL_117;
...
LABEL_10:
  ...
  if ( !qword_180166048 )
  {
    ...
    if ( (int)ZwQuerySystemInformation(0LL, v89, 64LL, 0LL) < 0 )
    {
LABEL_205:
      v25 = (__int64 *)v66;
      goto LABEL_206;
  ...
  *(_QWORD *)&v87[3] = v19;
  ...
  if ( (v16 & 0x61000000) != 0 && (v16 & 0x10000000) == 0 )
    return sub_180104AC0(v16, (_DWORD)a2, v22, v20, a5, (__int64)v87);
  NtGlobalFlag = 704;
  v24 = v16;
  v25 = (__int64 *)v66;
  if ( (v16 & 1) != 0 )
...
LABEL_187:
  ...
  if ( v74 )
  {
    sub_180048120(v48, &v75, &v74, 0x8000LL);
    v28 = (char *)(v74 + v75);
    v65 = v74 + v75;
    v69 = v76 - v74;
  }
...
LABEL_67:
  ...
  *(_DWORD *)(v65 + 120) |= 0x80000000;
         ...
         (unsigned __int64)&v72[v69 - v73]) )
  {
    ...
    *(_QWORD *)(v65 + 360) = qword_180166970 ^ *((_QWORD *)&v87[4] + 1);
    *(_DWORD *)(v65 + 688) = 4;
...
LABEL_75:
      ...
      if ( *(_WORD *)(v65 + 208) )
      {
        ...
        if ( *(_BYTE *)v40 && (NtCurrentPeb()->TracingFlags & 1) != 0 )
        {
          ...
          sub_1801032A0(v65, v24, v69, v71, *(unsigned __int8 *)v30);
        }
        v41 = 2147353482LL;
        if ( (unsigned int)RtlGetCurrentServiceSessionId() )
          v42 = (__int64)NtCurrentPeb()->HotpatchInformation + 560;
        else
          v42 = 2147353482LL;
        if ( *(_BYTE *)v42 )
        {
          if ( (unsigned int)RtlGetCurrentServiceSessionId() )
            v41 = (__int64)NtCurrentPeb()->HotpatchInformation + 560;
          sub_1801032A0(v65, v24, v69, v71, *(unsigned __int8 *)v41);
        }
        if ( (unsigned int)RtlGetCurrentServiceSessionId() )
          v43 = (__int64)NtCurrentPeb()->HotpatchInformation + 558;
        else
          v43 = 2147353480LL;
        if ( *(_BYTE *)v43 )
          sub_180101420(v65, v69, v24);
        *(_DWORD *)(v65 + 120) &= ~0x80000000;
        *(_QWORD *)(v65 + 368) = 0LL;
        v10 = (_DWORD *)v65;
        v65 = 0LL;
...
LABEL_88:
  ...
  if ( v65 )
  {
    ...
    {
      v69 = 0LL;
      sub_180048120((__int64)v44, &v65, &v69, 0x8000LL);
    }
  }
  return (__int64)v10;
}
