/*
 * XREFs of sub_180089B20 @ 0x180089B20
 * Callers:
 *     sub_18007DC6C @ 0x18007DC6C (sub_18007DC6C.c)
 * Callees:
 *     sub_180089C98 @ 0x180089C98 (sub_180089C98.c)
 *     memset @ 0x1800A3600 (memset.c)
 */

__int64 __fastcall sub_180089B20(__int64 a1, unsigned __int16 *a2, unsigned __int64 a3, _DWORD *a4)
{
  char v4; // ch
  char v7; // si^1
