/*
 * XREFs of sub_1800FD330 @ 0x1800FD330
 * Callers:
...
__int64 __fastcall sub_1800FD330(__int64 a1, __int64 a2)
{
  __int64 v4; // r14
  __int64 result; // rax
  unsigned int v6; // ecx
  ...
  result = sub_1800090D4(a2, (__int64)&DestinationString, &v17, 0LL, &v16);
  if ( (_DWORD)result != -1073741772 )
  {
    ...
    if ( v16 )
    {
      if ( (_DWORD)result == -2147483643 )
      {
        ...
        if ( v8 )
        {
          if ( !(unsigned int)sub_1800090D4(a2, (__int64)&DestinationString, &v17, v8, &v16) && (v17 == 1 || v17 == 7) )
          {
            v9 = 0;
            v10 = v16 >> 1;
            v11 = v8;
