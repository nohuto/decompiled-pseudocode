/*
 * XREFs of sub_180108BF4 @ 0x180108BF4
 * Callers:
 *     sub_18005E480 @ 0x18005E480 (sub_18005E480.c)
 * Callees:
 *     sub_18005ED00 @ 0x18005ED00 (sub_18005ED00.c)
 *     sub_18005EFF0 @ 0x18005EFF0 (sub_18005EFF0.c)
 *     memset @ 0x1800A3600 (memset.c)
 *     sub_18010A0D4 @ 0x18010A0D4 (sub_18010A0D4.c)
 */

__int64 __fastcall sub_180108BF4(
        unsigned __int64 a1,
        unsigned int a2,
        char *a3,
        unsigned int a4,
  ...
  if ( a4 >= 0x12C )
  {
    ...
    *((_QWORD *)a6 + 0x8000) = 0LL;
    ...
    while ( 1 )
    {
      ...
      do
      {
        v23 = (unsigned __int16)word_1801391E0[*v21] ^ (unsigned __int16)word_1801395E0[v21[2]] ^ (unsigned __int64)(unsigned __int16)word_1801393E0[v21[1]];
        v24 = *(_QWORD *)&a6[8 * v23];
        *(_QWORD *)&a6[8 * v23] = v21++;
...
LABEL_66:
                    ...
                    if ( v43 < 0x100 )
                      v44 = byte_180121790[v43];
                    else
                      v44 = byte_180121790[v43 >> 8] + 8LL;
                    v57 += v44;
                    v45 = v16 + 1;
                    v46 = v43 - (1LL << v44);
                    v47 = 16 * v44;
...
LABEL_87:
      ...
      *(_DWORD *)v10 = 2 * v17 + 1;
      ...
      if ( &v12[4 * ((unsigned __int64)(sub_18005EFF0((_QWORD *)a6 + 163840) + v57 + 31) >> 5) + 258 + v58] >= v61 )
        return 3221225507LL;
      v10 = a6 + 1342240;
      v12 = sub_18005ED00((__int64)(a6 + 1310720), a6 + 1342240, (unsigned __int64)v16, (__int64)v12, v54);
      v59 = v12;
      v55 = v54 == 0;
      v7 = a2;
      if ( !v55 )
