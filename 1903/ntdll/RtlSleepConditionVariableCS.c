/*
 * XREFs of RtlSleepConditionVariableCS @ 0x180060D90
 * Callers:
        ...
        PLARGE_INTEGER Timeout)
{
  ...
  if ( (((unsigned __int8)Ptr ^ (unsigned __int8)v8) & 8) != 0 )
    sub_180060EF4(ConditionVariable, v8);
  if ( MEMORY[0x7FFE036A] > 1u )
  {
    ...
    {
      for ( i = 0; (v20 & 2) != 0 && i != dword_180163B84 / (unsigned int)MEMORY[0x7FFE02D6]; ++i )
        _mm_pause();
    }
  }
  v12 = 0;
  ...
  if ( v12 == 258 || (v20 & 4) == 0 )
  {
    if ( sub_180060CBC((volatile signed __int64 *)ConditionVariable, (__int64)v19) )
    {
      if ( v12 != 258 )
        v12 = 0;
      v7 = v12;
