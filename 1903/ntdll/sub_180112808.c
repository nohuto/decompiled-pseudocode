...
__int64 __fastcall sub_180112808(__int64 a1, void *a2, unsigned int a3, ULONG a4)
{
  unsigned int v4; // ebx
  PVOID *v6; // r15
  _WORD *v7; // rdi
  ...
  if ( NextThread != -2147483622 )
  {
    ...
    *(_DWORD *)(a1 + 1024) = v15;
    ...
    v14 = ZwCreateSection(
            &SectionHandle,
            0xF0007u,
            (POBJECT_ATTRIBUTES)&stru_18013A820,
            &MaximumSize,
            4u,
            0x8000000u,
            0LL);
    ...
    if ( v6 )
    {
      do
      {
        for ( i = 0; i < *((unsigned __int16 *)v20 + 5); ++i )
        {
          ...
          v22 = sub_180112B54((int)v32, a3, a4, v15, Flags, NewThreadHandle);
          v14 = v22;
          if ( v22 == -1073741789 )
            break;
          if ( v22 < 0 )
