        ...
        __int64 *a9)
{
  ...
  *v11 = 0LL;
  ...
  {
    v34 = 76;
    Heap = RtlAllocateHeap(ProcessHeap, (unsigned int)(dword_18016542C + 1310720), 76LL);
    *a3 = Heap;
    if ( !Heap )
      goto LABEL_15;
    ...
    if ( v18 < 0 )
      goto LABEL_16;
    v28 = 84;
    v19 = RtlAllocateHeap(ProcessHeap, (unsigned int)(dword_18016542C + 1310720), 84LL);
    *a7 = v19;
    if ( !v19 )
      goto LABEL_15;
    ...
    if ( v18 != -1073741789 )
      goto LABEL_16;
    v20 = RtlAllocateHeap(ProcessHeap, (unsigned int)(dword_18016542C + 1310720), (unsigned int)a5);
    *a4 = v20;
    if ( !v20 )
      goto LABEL_15;
    ...
    if ( v18 != -1073741789 )
      goto LABEL_16;
    v21 = RtlAllocateHeap(ProcessHeap, (unsigned int)(dword_18016542C + 1310720), (unsigned int)a9);
    *v9 = v21;
    if ( !v21 )
    {
LABEL_15:
  ...
  v31 = 1;
  v29 = 76;
  v26 = RtlAllocateHeap(ProcessHeap, (unsigned int)(dword_18016542C + 1310720), 76LL);
  *a6 = v26;
  if ( !v26 )
    goto LABEL_15;
  ...
  if ( v18 >= 0 )
  {
    ...
    if ( v18 == -1073741789 )
    {
      v27 = RtlAllocateHeap(ProcessHeap, (unsigned int)(dword_18016542C + 1310720), v33);
      *v11 = v27;
      if ( v27 )
      {
...
LABEL_16:
  ...
  if ( *a7 )
  {
    RtlFreeHeap(ProcessHeap, 0LL, *a7);
    *v23 = 0LL;
  }
  if ( *a4 )
  {
