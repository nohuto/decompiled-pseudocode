...
__int64 __fastcall sub_180076888(char a1)
{
  __int64 v2; // rbx
  int v3; // esi
  int v5; // edi
  ...
  while ( 1 )
  {
    ...
    if ( v6 != -1073741806 && v6 != -1073741202 )
      return v2;
    v7 = 0;
    if ( (int)sub_180076A04(v2 + 24, *(unsigned __int16 *)(v2 + 26), &v15) < 0 )
    {
      v8 = *(unsigned __int16 *)(v2 + 26);
      v13 = *(_QWORD *)(v2 + 32);
      v12 = 6;
      if ( (int)sub_180076A04(&v12, v8, &v15) < 0 )
        return v2;
      v7 = 1;
    }
    v9 = v15;
