...
__int64 __fastcall sub_1800EB568(__int64 a1, unsigned int a2)
{
  __int64 v2; // rsi
  size_t v5; // rax
  int v6; // r14d
  ...
  result = sub_180003D40(2, (__int64)L"TimeZoneInformation", 1, &v16);
  if ( (int)result >= 0 )
  {
    if ( (int)RtlWriteRegistryValue(0x40000000, v16, L"Bias", 4, a1, 4) < 0
      ...
      || (int)RtlWriteRegistryValue(0x40000000, v16, L"DaylightName", 1, a1 + 88, 2 * v8 + 2) < 0
    ...
    {
      v12 = RtlWriteRegistryValue(0x40000000, v16, L"TimeZoneKeyName", 1, a1 + 172, 2 * v10 + 2);
      if ( v12 >= 0 )
      {
