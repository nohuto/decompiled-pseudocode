/*
 * XREFs of RtlActivateActivationContextEx @ 0x180070F40
 * Callers:
 *     RtlActivateActivationContext @ 0x180070EF0 (RtlActivateActivationContext.c)
 * Callees:
        ...
        PULONG_PTR Cookie)
{
  ...
  PACTIVATION_CONTEXT_STACK ActivationContextStackPointer; // r15
  NTSTATUS result; // eax
  ...
  if ( Cookie )
    *Cookie = 0LL;
  v6 = (_ACTIVATION_CONTEXT *)&unk_180118538;
  ...
  result = sub_180071068(Flags, ActivationContextStackPointer, &v14);
  if ( result >= 0 )
  {
    v9 = v14;
    v14->Flags = 40;
