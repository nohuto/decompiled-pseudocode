...
__int64 __fastcall sub_1801134A0(__int64 a1, void *a2, PVOID *a3, int a4)
{
                      ...
                      v27 >= 0) )
                {
                        ...
                        v27 >= 0) )
                  {
                    ...
                    if ( v27 >= 0 )
                    {
                      ...
                      v27 = ZwWriteVirtualMemory(a2, BaseAddress, Buffer, v8, 0LL);
                      if ( v27 >= 0 )
                      {
                        v34 = *(void **)(a1 + 904);
                        if ( !v34
                          || (v27 = ZwWriteVirtualMemory(a2, (PVOID)Buffer[113], v34, (unsigned int)v7, 0LL), v27 >= 0) )
                        {
                          v27 = 0;
                          *a3 = BaseAddress;
                          goto LABEL_44;
