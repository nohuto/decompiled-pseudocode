...
LABEL_44:
  ...
  if ( (int)result >= 0 )
  {
    if ( a2 && (int)sub_18001583C((__int64)v42, a2, 1, &v35) < 0 )
    {
      SystemPreferredUILanguages = -1073741772;
      goto LABEL_44;
    }
    ...
    if ( (v11 & 0x800) != 0 )
    {
      if ( !v16
        || ((*a5 = v37,
             SystemPreferredUILanguages = sub_180014248(v16, (__int64)v18, v6, a5, v11, v12, &v36),
...
LABEL_40:
    ...
    v20 = sub_180015604(&v38, (__int64)v42, 0x19u, 0);
    ...
    if ( (v11 & 0x8080) != 0 )
    {
      if ( v20 >= 0 )
      {
        if ( !v38 )
          goto LABEL_33;
        SystemPreferredUILanguages = sub_1800159B8(v11 | 0x30u, (__int64)v18, &v38, 0LL, 0LL, v44, v18[7], v43, 1);
        if ( SystemPreferredUILanguages >= 0 )
        {
          v22 = v38;
          *a5 = v37;
          v23 = sub_180014248(v22, (__int64)v18, v6, a5, v11, v12, &v36);
    ...
    else if ( v20 >= 0 )
    {
      if ( !v38 )
        goto LABEL_33;
      SystemPreferredUILanguages = sub_1800159B8(v11 | 0x20u, (__int64)v18, &v38, 0LL, 0LL, v44, 0LL, v43, 0);
      if ( SystemPreferredUILanguages >= 0 )
      {
        SystemPreferredUILanguages = sub_180015604(&v39, (__int64)v18, 0x19u, 0);
        if ( SystemPreferredUILanguages >= 0 )
        {
          v22 = v38;
          if ( !v39 )
...
LABEL_29:
          ...
          v32 = sub_180014248(v39, (__int64)v18, v6, v5, v11, v12, &v36);
LABEL_92:
