...
double __cdecl log(double X)
{
  ...
  if ( (*(_QWORD *)&X & 0x7FF0000000000000LL) == 0x7FF0000000000000LL )
  {
    if ( (*(_QWORD *)&X & 0xFFFFFFFFFFFFFLL) != 0 )
    {
      ...
      v10 = 0;
LABEL_4:
      sub_1800946BC((unsigned int)&unk_18011FAD8, 26, LODWORD(v1), 1, v10, 33, v11, 0LL, 1);
      return X;
    }
    if ( X >= 0.0 )
      return X;
LABEL_7:
  ...
  {
    X = 0.0;
    sub_1800946BC((unsigned int)&unk_18011FAD8, 26, 0, 2, 4, 34, v2, 0LL, 1);
    return X;
  }
  v3 = 0;
  if ( X < 0.0 )
