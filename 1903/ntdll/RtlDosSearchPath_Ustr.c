      ...
      if ( v35 < v36 )
      {
        while ( 1 )
        {
          ...
          if ( UnicodeString.MaximumLength < v42 + 2 )
          {
            ...
            UnicodeString.Buffer = (wchar_t *)sub_18006D6B8((unsigned __int16)v34, v42);
          ...
          sub_180077E18(&UnicodeString, a3);
          if ( v57 )
...
LABEL_18:
  LOBYTE(v14) = 1;
  if ( (unsigned __int8)sub_180025E00(a3, v14) )
  {
  ...
  if ( a4 && *a4 )
  {
    ...
    if ( v16 <= 0xFFFE )
    {
      if ( v16 > UnicodeString.MaximumLength )
      {
        ...
        Buffer = (wchar_t *)sub_18006D6B8((unsigned __int16)v16, v16);
