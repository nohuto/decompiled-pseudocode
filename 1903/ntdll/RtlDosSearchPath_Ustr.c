/*
 * XREFs of RtlDosSearchPath_Ustr @ 0x180025850
 * Callers:
 *     <none>
 * Callees:
        ...
        SIZE_T *BytesRequired)
{
  ...
  *(_DWORD *)&UnicodeString.Length = 34078720;
  ...
  v13 = (unsigned int)sub_18002891C(FileName);
  InputPathType = v13;
      ...
      if ( v35 < v36 )
      {
        while ( 1 )
        {
          ...
          if ( UnicodeString.MaximumLength < v42 + 2 )
          {
            ...
            UnicodeString.Buffer = (PWCH)sub_18006D6B8((unsigned __int16)v34, v42);
            if ( !UnicodeString.Buffer )
              return -1073741801;
          }
          UnicodeString.Length = 0;
          sub_18006AE10(&UnicodeString, v35, v41);
          if ( v40 && v41 != v40 )
          {
            UnicodeString.Buffer[(unsigned __int64)UnicodeString.Length >> 1] = 92;
            UnicodeString.Length += 2;
          }
          sub_180077E18(&UnicodeString, FileName);
          if ( v57 )
            sub_180077E18(&UnicodeString, v57);
          ...
          if ( (unsigned __int8)sub_180025E00(&UnicodeString, 0LL) )
          {
...
LABEL_18:
  LOBYTE(v14) = 1;
  if ( (unsigned __int8)sub_180025E00(FileName, v14) )
  {
  ...
  if ( DefaultExtension && DefaultExtension->Length )
  {
    ...
    if ( v16 <= 0xFFFE )
    {
      if ( v16 > UnicodeString.MaximumLength )
      {
        ...
        v17 = (WCHAR *)sub_18006D6B8((unsigned __int16)v16, v16);
      ...
      if ( !(unsigned __int8)sub_180025E00(&UnicodeString, v18) )
        goto LABEL_26;
      p_UnicodeString = &UnicodeString;
      goto LABEL_32;
    }
