/*
 * XREFs of sub_1800670D0 @ 0x1800670D0
 * Callers:
 *     RtlEnumerateGenericTableWithoutSplayingAvl @ 0x180067070 (RtlEnumerateGenericTableWithoutSplayingAvl.c)
...
_QWORD *__fastcall sub_1800670D0(_QWORD *a1)
{
  _QWORD *result; // rax
  __int64 v2; // rdx
  _QWORD *v3; // r8
