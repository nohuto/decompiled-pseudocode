...
__int64 __fastcall sub_180003474(__int64 a1, const WCHAR *a2, __int64 a3, __int64 a4, PVOID Environment, char a6)
{
  __int64 v6; // r15
  int v9; // r12d
  __int64 result; // rax
  ...
  v6 = a4;
  v9 = a1;
  result = sub_180003D40(a1, a2, 0LL, &Handle);
  v26 = result;
  if ( (int)result >= 0 )
  {
    v11 = v9 & 0x40000000;
            ...
            if ( v17 )
            {
              ...
              while ( 1 )
              {
                ...
                if ( v14 >= 0 )
                {
                  ...
                  ResultLength = Length;
                  v20 = sub_180003870((int)KeyHandle, a3, v13, (int)&ResultLength, v6, Environment, a6);
                  v27 = v20;
                  v14 = v20;
                  if ( v20 != -1073741789 )
                  {
...
LABEL_23:
                ...
                else
                {
                  if ( v14 == -1073741772 )
                  {
                    ...
                    *(_DWORD *)(v13 + 12) = 0;
                    ResultLength = Length;
                    v14 = sub_180003870((int)KeyHandle, a3, v13, (int)&ResultLength, v6, Environment, a6);
                    v27 = v14;
                  }
                  if ( v14 != -1073741789 )
                    goto LABEL_23;
...
LABEL_41:
            ...
            for ( i = 0; ; ++i )
            {
              ...
              {
                ResultLength = Length;
                v14 = sub_180003870((int)KeyHandle, a3, v13, (int)&ResultLength, a4, Environment, a6);
                v28 = v14;
              }
              if ( v14 == -1073741789 )
              {
                RegionSize = ResultLength + 10LL;
                v24 = sub_180003BA4(&RegionSize);
                v13 = v24;
                if ( !v24 )
                {
                  v14 = v28;
...
LABEL_54:
              ...
              else
              {
                ...
                if ( (*(_BYTE *)(a3 + 8) & 0x40) != 0 )
                {
                  DestinationString.Buffer = (PWCH)(v13 + 20);
