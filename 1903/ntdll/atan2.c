...
double __cdecl atan2(double Y, double X)
{
  ...
  if ( (*(_QWORD *)&X & 0x7FFFFFFFFFFFFFFFuLL) > 0x7FF0000000000000LL )
  {
    v9 = LODWORD(X);
LABEL_3:
    sub_1800946BC((unsigned int)"atan2", 16, v9, 1, 0, 33, *(__int64 *)&X, *(__int64 *)&Y, 2);
    return Y;
  }
  v10 = 0LL;
...
LABEL_8:
      v11 = qword_18015FAD8;
      if ( v3 < 0.0 )
        *(double *)&v11 = -*(double *)&qword_18015FAD8;
      goto LABEL_33;
    }
