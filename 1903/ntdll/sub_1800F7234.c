/*
 * XREFs of sub_1800F7234 @ 0x1800F7234
 * Callers:
...
__int64 __fastcall sub_1800F7234(__int64 a1, PVOID *a2, _QWORD *a3)
{
  WCHAR *v5; // rdx
  __int64 v6; // r8
  WCHAR v7; // ax
  ...
  if ( v6 )
    v8 = v5;
  *v8 = 0;
  if ( !v6 || (int)sub_1800EBCB8(SourceString, 256LL, a1) < 0 )
    return 3221225473LL;
  v9 = 256LL;
  v10 = SourceString;
  do
  ...
  *(_OWORD *)&ObjectAttributes.SecurityDescriptor = 0LL;
  ...
  if ( v18 >= 0 )
  {
    if ( sub_1800F6E14(FileHandle, &v22) < 0 || HIDWORD(v22) )
    {
      v18 = -1073741823;
    }
    else
