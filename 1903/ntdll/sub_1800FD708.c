/*
 * XREFs of sub_1800FD708 @ 0x1800FD708
 * Callers:
...
LABEL_22:
  ...
  if ( a6 )
  {
    if ( v13 )
    {
      ...
      {
        *a6 = 0LL;
        if ( (int)sub_1800162BC(a1, a2, (unsigned __int16)v8, &v28) >= 0 && v28 >= 0 )
        {
          v25 = *(_QWORD *)(a1 + 24);
