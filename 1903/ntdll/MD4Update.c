/*
 * XREFs of MD4Update @ 0x18010C8E0
 * Callers:
 *     MD4Final @ 0x18010C250 (MD4Final.c)
 * Callees:
 *     memmove @ 0x1800A32C0 (memmove.c)
 *     sub_18010C34C @ 0x18010C34C (sub_18010C34C.c)
 */
  ...
  *(_DWORD *)(a1 + 20) = v8 + (a3 >> 29);
  if ( v6 )
  {
    ...
    if ( v6 + a3 >= 0x40 )
    {
      ...
      v4 = v9 - 64;
      sub_18010C34C((_DWORD *)a1, (_DWORD *)(a1 + 24));
      v6 = 0;
    }
  }
  ...
  if ( v4 >= 0x40 )
  {
    ...
    if ( ((unsigned __int8)v5 & 3) != 0 )
    {
      do
      {
        ...
        *(_OWORD *)(a1 + 56) = v5[2];
        *(_OWORD *)(a1 + 72) = v5[3];
        result = (void *)sub_18010C34C((_DWORD *)a1, (_DWORD *)(a1 + 24));
        v5 += 4;
        v4 -= 64;
        --v11;
      }
    ...
    else
    {
      do
      {
        result = (void *)sub_18010C34C((_DWORD *)a1, v5);
        v5 += 4;
        v4 -= 64;
        --v11;
      }
