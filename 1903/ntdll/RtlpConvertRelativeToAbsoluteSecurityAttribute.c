/*
 * XREFs of RtlpConvertRelativeToAbsoluteSecurityAttribute @ 0x1800E7BB0
 * Callers:
 *     <none>
 * Callees:
        ...
        unsigned int *a4)
{
  ...
  if ( v10 < 4 )
    return (unsigned int)-1073741705;
  v9 = sub_18000C2B4((unsigned int *)((char *)a1 + *a1), v10, &v51);
  if ( v9 < 0 )
      ...
      if ( (_DWORD)v13 )
      {
        while ( 1 )
        {
          ...
          if ( (unsigned int)v5 < (unsigned int)v21 || (unsigned int)(v5 - v21) < 2 )
            return (unsigned int)-1073741705;
          v9 = sub_18000C2B4((unsigned int *)((char *)a1 + v21), (unsigned int)(v5 - v21), &v51);
          if ( v9 < 0 )
            return (unsigned int)v9;
          if ( (int)v51 + 2 < (unsigned int)v51
  ...
  *a3 = a3 + 4;
  ...
  if ( v27 > 2u )
  {
    if ( v27 == 3 )
    {
      ...
      {
        v44 = v41;
        v9 = sub_18000C2B4((unsigned int *)((char *)a1 + a1[v41 + 4]), v43, &v51);
        if ( v9 < 0 )
          return (unsigned int)v9;
        v45 = v51 + 2;
        if ( (int)v51 + 2 < (unsigned int)v51 )
