...
__int64 __fastcall sub_180102800(__int64 a1, __int64 a2, _QWORD *a3, unsigned __int64 a4)
{
  signed int v6; // ebx
  char v7; // al
  ...
  if ( a2 == 40 && *(_DWORD *)a1 == 2 )
  {
    if ( *(_QWORD *)(a1 + 8) == -1LL )
    {
      RtlAcquireSRWLockShared(&qword_180166390, 0x28uLL, (unsigned __int64)a3, a4);
      if ( (dword_180166398 & 1) != 0 && (dword_180166398 & 2) != 0 )
      {
        *(_BYTE *)(a1 + 33) |= 1u;
        v6 = sub_180114820(&qword_1801663A0, *(_QWORD *)(a1 + 16), *(_QWORD *)(a1 + 24));
        if ( v6 >= 0 )
        {
          v6 = sub_18006790C((__int64)sub_180102590, a1, 0);
          if ( v6 >= 0 )
          {
      ...
      RtlReleaseSRWLockShared(&qword_180166390);
    }
    else
    {
