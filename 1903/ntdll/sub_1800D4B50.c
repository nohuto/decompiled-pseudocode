...
__int64 __fastcall sub_1800D4B50(__int64 a1)
{
  int inited; // ebx
  char *v2; // rdi
  int ValueKey; // eax
...
LABEL_27:
    ...
    while ( 1 )
    {
      ...
      if ( !ProcessHeap )
        break;
      Heap = RtlAllocateHeap((__int64)ProcessHeap, dword_18016542C + 1572864, v10);
      v4 = Heap;
      if ( !Heap )
        break;
      v2 = (char *)Heap;
