...
LABEL_26:
  ...
  if ( v22 == 3 )
  {
    if ( RtlEqualUnicodeString((unsigned __int16 *)&v28, (__int64)&unk_180118000, 1)
      || RtlEqualUnicodeString((unsigned __int16 *)&v28, (__int64)&unk_180118020, 1)
      || RtlEqualUnicodeString((unsigned __int16 *)&v28, (__int64)&unk_180118010, 1)
      || RtlEqualUnicodeString((unsigned __int16 *)&v28, (__int64)&unk_180118030, 1) )
    {
  ...
  else
  {
    ...
    if ( RtlEqualUnicodeString((unsigned __int16 *)&v28, (__int64)&unk_180118090, 1) )
      return (v1 << 16) | (unsigned int)(2 * v22);
    v27 = &unk_1801180A0;
  }
LABEL_40:
