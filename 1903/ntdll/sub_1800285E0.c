/*
 * XREFs of sub_1800285E0 @ 0x1800285E0
 * Callers:
...
__int64 __fastcall sub_1800285E0(__int64 a1)
{
  int v1; // ebp
  __int16 v2; // di
  int v3; // eax
...
LABEL_26:
  ...
  if ( v22 == 3 )
  {
    if ( RtlEqualUnicodeString(&String1, (PUNICODE_STRING)&stru_180118000, 1u)
      || RtlEqualUnicodeString(&String1, (PUNICODE_STRING)&stru_180118020, 1u)
      || RtlEqualUnicodeString(&String1, (PUNICODE_STRING)&stru_180118010, 1u)
      || RtlEqualUnicodeString(&String1, (PUNICODE_STRING)&stru_180118030, 1u) )
    {
  ...
  if ( v25 )
  {
    ...
    if ( v26 )
    {
      if ( v26 == 1 )
      {
        v27 = (_UNICODE_STRING *)&stru_180118040;
        goto LABEL_40;
      }
      return 0LL;
    }
    v27 = (_UNICODE_STRING *)&unk_180118050;
  }
  else
  {
    ...
    if ( RtlEqualUnicodeString(&String1, (PUNICODE_STRING)&stru_180118090, 1u) )
      return (v1 << 16) | (unsigned int)(2 * v22);
    v27 = (_UNICODE_STRING *)&unk_1801180A0;
  }
LABEL_40:
