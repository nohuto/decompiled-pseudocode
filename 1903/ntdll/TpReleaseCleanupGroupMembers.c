/*
 * XREFs of TpReleaseCleanupGroupMembers @ 0x1800668E0
 * Callers:
 *     <none>
 * Callees:
        ...
        PVOID CleanupParameter)
{
  ...
  {
    if ( !CleanupGroup )
      sub_18010EFC8(0LL, *(_QWORD *)&CancelPendingCallbacks, CleanupParameter);
  }
  else
  {
...
LABEL_12:
    ...
    sub_180066BBC((char *)CleanupGroup + 32, 0LL);
  }
}
