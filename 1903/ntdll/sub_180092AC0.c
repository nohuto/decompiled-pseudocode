/*
 * XREFs of sub_180092AC0 @ 0x180092AC0
 * Callers:
...
unsigned __int64 __fastcall sub_180092AC0(__int64 a1, unsigned __int8 *a2, unsigned __int8 **a3, int a4, int a5)
{
  int v5; // r14d
  __int64 v7; // rbp
...
LABEL_23:
  ...
  while ( 1 )
  {
    if ( (sub_180092AB0()[(unsigned __int8)v7] & 4) != 0 )
    {
      v13 = (char)v7 - 48;
    }
    else
    {
      if ( (sub_180092AB0()[(unsigned __int8)v7] & 0x103) == 0 )
        break;
      v14 = (char)v7 - 32;
