/*
 * XREFs of sub_18007D8F8 @ 0x18007D8F8
 * Callers:
...
__int64 __fastcall sub_18007D8F8(__int64 a1, __int64 a2, __int64 a3, __int64 a4, int a5, _DWORD *a6)
{
  __int64 v6; // r10
  ...
  *a6 = 0;
  ...
  while ( v6 != v18 )
  {
    ...
    {
      if ( !(unsigned __int8)sub_18007DC3C(&v17, v10) )
      {
        v6 = v19;
        v8 = -1073741789;
        break;
    ...
    {
      v8 = sub_18007DA44(a1, v10, a3, &v17);
    }
    v6 = v19;
  }
  if ( !v8 )
