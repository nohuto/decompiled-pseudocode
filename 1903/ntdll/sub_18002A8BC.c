/*
 * XREFs of sub_18002A8BC @ 0x18002A8BC
 * Callers:
...
char __fastcall sub_18002A8BC(unsigned __int16 *a1, __int64 a2)
{
  char result; // al
  _WORD *i; // rax
  __int16 v5; // cx
  ...
  if ( word_180164F10 )
  {
    ...
    *(_WORD *)(a2 + 2) = a1[1] - v5;
    v8 = *((_QWORD *)a1 + 1);
    v7[0] = v5 - 2;
    return RtlEqualUnicodeString(v7, (__int64)&word_180164F10, 1);
  }
  return result;
}
