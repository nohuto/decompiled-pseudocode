 ...
 *     RtlNewSecurityObjectWithMultipleInheritance @ 0x180088310 (RtlNewSecurityObjectWithMultipleInheritance.c)
 *     RtlNewSecurityObject @ 0x180089AC0 (RtlNewSecurityObject.c)
        ...
        GENERIC_MAPPING *a9)
{
  ...
  int v113; // [rsp+90h] [rbp-80h] BYREF
  ...
  *(_QWORD *)v141 = a1;
  ...
  if ( TokenHandle )
  {
    result = ZwQueryInformationToken(TokenHandle, 0xAu, TokenInformation, 0x38u, &v138);
    if ( result < 0 )
      return result;
    v146 = v177;
    if ( v177 == 2 && v178 < 1 )
  ...
  if ( TokenHandle || v128 )
  {
    result = sub_18000F170(TokenHandle, v128 != 0, &BaseAddress, &v165, &v162, &v163, &v159, &v160, &v164);
    if ( result < 0 )
      return result;
...
LABEL_47:
    ...
    if ( !AceByType )
      v47 = 0LL;
    v48 = v156;
    if ( v47 && !(unsigned __int8)sub_18008B9D4(v156, v47, v46, &v113) )
    {
      v33 = -1073741790;
      goto LABEL_308;
    }
...
LABEL_68:
  ...
  v113 = RtlCreateAcl(&v179, 0x80u, 2u);
  v33 = v113;
  if ( v113 < 0 )
    goto LABEL_264;
  v113 = RtlAddMandatoryAce(&v179, 2u, (unsigned __int8)v115, Sid2, 0x11u, v52);
  v33 = v113;
  if ( v113 < 0 )
    goto LABEL_264;
...
LABEL_81:
  ...
  if ( (a7 & 8) == 0 )
  {
    ...
    if ( v95 )
    {
      if ( ClientToken )
      {
        v113 = RtlSidDominates(Sid1, v95, &Dominates);
        v33 = v113;
        if ( v113 >= 0 )
        {
...
LABEL_97:
  ...
  if ( (a7 & 0x1000) == 0 && v124 && ClientToken && *(_QWORD *)v141 )
  {
    ...
    GrantedAccess = 0;
    AccessStatus = 0;
    v113 = sub_1800100C4(v141[0], 0, (int)&v149, v148, a5, AccessMask, a7 | 1, ClientToken, (__int64)GenericMapping);
    v33 = v113;
    if ( v113 < 0 )
      goto LABEL_264;
    if ( (*((_BYTE *)v149 + 2) & 4) == 0 )
...
LABEL_331:
      v75 = 0LL;
LABEL_107:
    if ( sub_18000E7C0(0x10u, (__int64)v75) )
    {
      NewTokenHandle = 0LL;
      ...
      v113 = ZwDuplicateToken(v74, 8u, &ObjectAttributes, 0, TokenImpersonation, &NewTokenHandle);
      v33 = v113;
      if ( v113 < 0 )
        goto LABEL_264;
      v102 = NewTokenHandle;
...
LABEL_259:
      ...
      if ( v33 < 0 || (v33 = AccessStatus, v113 = AccessStatus, AccessStatus < 0) )
      {
LABEL_264:
        v13 = v119;
        goto LABEL_138;
  ...
  if ( v114 && (a7 & 8) == 0 && v76 )
  {
    ...
    *(_QWORD *)v141 = 8LL;
    ...
    v113 = ZwPrivilegeCheck(v74, &RequiredPrivileges, &v117);
    v33 = v113;
    if ( v113 < 0 )
      goto LABEL_264;
    if ( !v117 )
...
LABEL_336:
  ...
  if ( (_BYTE)v118 && (a7 & 0x10) == 0 )
  {
    ...
    LOBYTE(v71) = v127;
    if ( !(unsigned __int8)sub_180066D68(v74, v134, v71, &v161) )
    {
      v33 = v161;
      goto LABEL_308;
    }
  ...
  if ( v128 && HIBYTE(v118) )
  {
    v106 = Src;
    LOBYTE(v72) = v138;
    v107 = sub_1800E6098((_DWORD)Src, v72, v140, (unsigned int)&v150, (__int64)&v121);
    v113 = v107;
    v33 = v107;
    if ( v107 < 0 )
      goto LABEL_264;
  ...
  if ( (v126 & 4) != 0 && Src )
    ...
    v84 = 0;
  Heap = RtlAllocateHeap(HeapHandle, Flags + 1310720, v79 + v78 + 20 + v84 + v82);
  v119 = Heap;
  v86 = Heap;
  if ( !Heap )
  {
  ...
  *(_BYTE *)Heap = 1;
  ...
  if ( !v88 && v133 )
  {
    ...
    if ( !HIBYTE(v115) )
      sub_18000E718((__int64)v87, GenericMapping);
    v86 = v119;
