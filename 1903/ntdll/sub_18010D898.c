/*
 * XREFs of sub_18010D898 @ 0x18010D898
 * Callers:
...
__int64 __fastcall sub_18010D898(unsigned int a1, _DWORD *a2, _DWORD *a3, __int64 a4)
{
  __int64 result; // rax
  unsigned int v9; // ebx
  __int64 v10; // rsi
  ...
  *a3 = 176;
  ...
  if ( !(_DWORD)result )
  {
    ...
    *(_DWORD *)(v10 + 368) = v12;
    ...
    UnicodeString = v16;
    v9 = sub_180004B28(a4, v15, (_UNICODE_STRING *)(v10 + 168));
    if ( v9 )
      goto LABEL_23;
    sub_180086E40(v10, 2);
    v17 = sub_180086E40(v10, 4);
    if ( v17 )
    {
...
LABEL_29:
    _InterlockedDecrement((volatile signed __int32 *)(qword_180163518 + 16LL * *(unsigned int *)(v10 + 20) + 8));
    return v9;
  }
  return result;
}
