...
__int64 __fastcall sub_18002E6A0(__int64 a1, __int64 a2, unsigned int a3, int a4, volatile signed __int32 **a5)
{
  __int64 v9; // rdx
  int v10; // ebx
  ...
  *a5 = 0LL;
  ...
  if ( (a3 & 0x20) == 0 )
    v9 = a2;
  v10 = sub_18002284C(a1, v9, a3, a5, a4);
  if ( v10 == -1073741515 && (a3 & 8) != 0 )
  {
    v10 = sub_18002284C(0LL, a2, 0LL, a5, a4);
    if ( v10 >= 0 )
      *((_DWORD *)*a5 + 26) |= 1u;
  }
