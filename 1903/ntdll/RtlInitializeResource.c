...
void __cdecl RtlInitializeResource(PRTL_RESOURCE Resource)
{
  ...
  Heap = (_RTL_CRITICAL_SECTION_DEBUG *)RtlInterlockedPopEntrySList(&stru_180166180);
  if ( !Heap )
  {
  ...
  if ( !v9 )
    goto LABEL_152;
  v10 = 8LL * v9;
  v11 = &v5[2 * (BackTraceHash % LODWORD(v5[90].Ptr)) + 91];
  v80 = v10;
  _InterlockedIncrement((volatile signed __int32 *)&v5[22]);
  if ( !byte_180165408 )
    RtlAcquireSRWLockExclusive(v11 + 1);
  Ptr = (PSLIST_ENTRY)v11->Ptr;
  if ( v11->Ptr )
  {
    while ( *((_WORD *)&Ptr->Next + 7) != v84 || RtlCompareMemory(&Ptr[1], BackTrace, v10) != v10 )
    {
      Ptr = Ptr->Next;
      if ( !Ptr )
        goto LABEL_19;
...
LABEL_77:
  ...
  while ( 1 )
  {
    v14 = RtlInterlockedPopEntrySList((PSLIST_HEADER)&v5[2 * v13 + 26]);
    if ( v14 )
      break;
    if ( ++v13 >= 0x20 )
      goto LABEL_24;
...
LABEL_30:
  ...
  memmove(&Ptr[1], BackTrace, v10);
  *((_WORD *)&Ptr->Next + 7) = v84;
  *((_WORD *)&Ptr->Next + 4) &= 0xF800u;
  v19 = 2LL * (BackTraceHash % LODWORD(v5[90].Ptr));
  Ptr->Next = (_SLIST_ENTRY *)v5[v19 + 91];
  v5[v19 + 91].Ptr = Ptr;
LABEL_32:
  v20 = *((_WORD *)&Ptr->Next + 4);
  if ( (v20 & 0x7FF) != 0x7FF )
    *((_WORD *)&Ptr->Next + 4) = v20 ^ (v20 ^ (v20 + 1)) & 0x7FF;
  v4 = 0LL;
LABEL_35:
  if ( !byte_180165408 )
  {
...
LABEL_152:
  ...
  v52 = &v5[2 * (v49 % LODWORD(v5[90].Ptr))];
  if ( !byte_180165408 )
    RtlAcquireSRWLockExclusive(v52 + 92);
  if ( !*(_DWORD *)((char *)&Ptr->Next + 10) )
  {
    if ( !byte_180165408 )
      RtlAcquireSRWLockExclusive(v5);
    v53 = (char *)v5[19].Ptr;
    v54 = (unsigned __int64)v5[21].Ptr - 8;
    v26 = LOBYTE(v5[16].Ptr) == 0;
    v88 = v53;
    if ( v26 )
    {
...
LABEL_125:
  ...
  LODWORD(v6) = *((unsigned __int16 *)&Ptr->Next + 6) + (*((unsigned __int16 *)&Ptr->Next + 5) << 16);
LABEL_129:
  if ( !byte_180165408 )
  {
...
LABEL_6:
  ...
  v7 = ZwCreateSemaphore(&SemaphoreHandle, 0x100003u, 0LL, 0, 0x7FFFFFFF);
  if ( v7 < 0 )
  {
    sub_180035DD0((PSLIST_ENTRY)Heap);
    RtlRaiseStatus(v7);
  }
  v8 = ZwCreateSemaphore(&v83, 0x100003u, 0LL, 0, 0x7FFFFFFF);
  if ( v8 < 0 )
  {
  ...
  *(_QWORD *)&Resource->NumberOfWaitingExclusive = 0LL;
  Resource->ExclusiveOwnerThread = v4;
