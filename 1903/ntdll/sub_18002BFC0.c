/*
 * XREFs of sub_18002BFC0 @ 0x18002BFC0
 * Callers:
...
__int64 __fastcall sub_18002BFC0(int a1, wchar_t *a2, int a3, void *a4, int *a5, void *Src, int Normalized)
{
  void *v7; // r15
  wchar_t *v8; // r11
  char v9; // di
  ...
  if ( a3 == -1 )
  {
    if ( (int)sub_180016C58(a2, 0x203uLL, &v21) < 0 )
      return 3221227286LL;
    a3 = v21 + 1;
  }
  v11 = (const WCHAR *)Src;
  v12 = v8[a3 - 1];
  Normalized = v9 & 4;
  result = sub_18002C138(v8, Normalized != 0, (v9 & 2) != 0, (__int64)&v23, (__int64)&v22);
  if ( (int)result < 0 )
    return result;
  if ( !v12 )
    return 3221227286LL;
