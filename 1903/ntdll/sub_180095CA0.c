/*
 * XREFs of sub_180095CA0 @ 0x180095CA0
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall sub_180095CA0(__int64 a1, unsigned __int8 *a2, __int64 a3, __int64 a4)
{
  unsigned int v4; // edi
  ...
  while ( 2 )
  {
    if ( (sub_180092AB0()[v7] & 8) != 0 )
    {
      ...
      while ( 1 )
      {
        v59 = ++v8;
        v57 = v8;
        v11 = sub_180095C64(v6);
        if ( v11 == -1 )
          break;
        if ( (sub_180092AB0()[(unsigned __int8)v11] & 8) == 0 )
        {
...
LABEL_186:
      ...
      if ( v49 == v4 )
      {
        if ( !(unsigned int)sub_180090018(v4) )
          goto LABEL_189;
        v50 = sub_180095C64(v6);
        v51 = *v5++;
        if ( v51 == v50 )
          goto LABEL_189;
        if ( v50 != -1 )
          sub_180096740(v50, v6);
      }
      if ( v4 == -1 )
        goto LABEL_202;
      v52 = v6;
...
LABEL_50:
    ...
    if ( v24 != 110 )
    {
      ...
      else
      {
        ...
        while ( v4 != -1 && (sub_180092AB0()[(unsigned __int8)v4] & 8) != 0 );
        v24 = v69;
        v59 = v8;
        v58 = v4;
      }
...
LABEL_171:
        ...
        if ( v24 == 123 )
        {
          v48 = sub_180095ADC(v47, &v73, &v58, &v57, v71, v26, a1, &v66);
          v5 = v73;
        }
        else
        {
          v48 = sub_180095914(v47, 0LL, &v58, &v57, v71, v26, a1, &v66);
        }
        v4 = v58;
        if ( !v48 )
        {
  ...
  if ( !v60 )
  {
    if ( !v23 )
    {
      while ( 1 )
      {
        ...
        {
          if ( (sub_180092AB0()[(unsigned __int8)v4] & 4) == 0 )
            goto LABEL_157;
          if ( v24 == 111 )
          {
            if ( (int)v4 >= 56 )
        ...
        {
          if ( SLOBYTE(sub_180092AB0()[(unsigned __int8)v4]) >= 0 )
          {
LABEL_157:
            v59 = --v8;
            v57 = v8;
            if ( v4 != -1 )
              sub_180096740(v4, v32);
            break;
          }
          v63 *= 16;
          v40 = (char)v4;
