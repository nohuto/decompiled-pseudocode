/*
 * XREFs of sub_1800D07EC @ 0x1800D07EC
 * Callers:
...
char __fastcall sub_1800D07EC(int a1)
{
  struct _PEB *v1; // rax
  int v3; // r10d
  __int64 v4; // r8
  _DWORD v6[4]; // [rsp+30h] [rbp-68h] BYREF
  _BYTE v7[32]; // [rsp+40h] [rbp-58h] BYREF
  _BYTE v8[16]; // [rsp+60h] [rbp-38h] BYREF
  _DWORD *v9; // [rsp+70h] [rbp-28h]
  ...
  if ( v1->ProcessHeap )
  {
    ...
    if ( (unsigned int)dword_18015F4C0 > 4 )
    {
      ...
      {
        v6[0] = a1;
        sub_1800D0B68(v8, "LdrLoadEnclaveModule");
        v11 = 0;
        v9 = v6;
        v10 = v3;
        LOBYTE(v1) = sub_18008935C((__int64)&dword_18015F4C0, byte_18012B6FD, v4, (__int64)v6, v3, (__int64)v7);
      }
    }
  }
  return (char)v1;
