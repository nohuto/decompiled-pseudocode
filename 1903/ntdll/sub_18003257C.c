...
char __fastcall sub_18003257C(__int64 a1, __int64 a2, char a3)
{
  char v3; // bl
  bool v6; // bp
  ...
  if ( (*(_BYTE *)(a1 + 354) & 1) != 0 )
  {
    ...
    if ( (unsigned int)RtlGetCurrentServiceSessionId(v9) )
      ...
      v11 = 2147353478LL;
    if ( *(_BYTE *)v11 )
      sub_18010F60C(v10, a1);
    RtlAcquireSRWLockExclusive(a2);
    if ( *(_BYTE *)(a1 + 352) )
    {
      sub_180036214(v10 + 16, a1 + 248);
      sub_180036214(v10 + 8, a1 + 288);
      LOBYTE(v12) = v6;
      sub_1800327D4(v10, v12);
      *(_BYTE *)(a1 + 352) = 0;
