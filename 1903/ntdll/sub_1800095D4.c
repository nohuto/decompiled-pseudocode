/*
 * XREFs of sub_1800095D4 @ 0x1800095D4
 * Callers:
...
__int64 __fastcall sub_1800095D4(__int64 a1, const WCHAR *a2, char *a3, __int64 a4, _WORD *a5)
{
  __int16 v6; // bx
  char v9; // di
  __int64 v10; // r8
...
LABEL_4:
    ...
    LOBYTE(v10) = 1;
    result = sub_180015918(a1, a2, v10, &v14);
    if ( (int)result >= 0 )
    {
      v6 = v14;
      v9 = 3;
