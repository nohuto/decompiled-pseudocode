/*
 * XREFs of sub_180099F5C @ 0x180099F5C
 * Callers:
 ...
 *     sub_18009A8B8 @ 0x18009A8B8 (sub_18009A8B8.c)
 *     memset @ 0x1800A3600 (memset.c)
 */

__int64 __fastcall sub_180099F5C(__int64 a1, _WORD *a2, int *a3)
{
  int v4; // edi
  int v5; // r14d
  ...
  char v57[4]; // [rsp+44h] [rbp-BCh] BYREF
  unsigned __int16 v58[2]; // [rsp+48h] [rbp-B8h] BYREF
  ...
  _WORD v65[512]; // [rsp+70h] [rbp-90h] BYREF
  ...
  do
  {
    ...
    if ( (unsigned __int16)(v11 - 32) > 0x5Au )
      ...
      v15 = byte_180120500[v11 - 32] & 0xF;
    v9 = byte_180120500[v15 + v9 + 8 * v15] >> 4;
    v52 = v9;
    switch ( v9 )
    {
      case 8:
...
LABEL_112:
                  ...
                  {
                    do
                      sub_18009A868(32LL, v34, &v53);
                    while ( v53 != -1 && v36 > 0 );
                    v6 = v54;
                  }
                  sub_18009A8B8(v59, v6, v34, &v53);
                  v37 = v61;
                  v38 = 0;
                  if ( (v4 & 0xC) == 8 && v35 > 0 )
                  {
                    do
                      sub_18009A868(48LL, v37, &v53);
                    while ( v53 != -1 && v39 > 0 );
                    v6 = v54;
                  }
                  if ( v56 == v38 && (int)v13 > 0 )
                  {
                    ...
                    {
                      --v41;
                      v42 = sub_180098D6C(v58, v40, dword_18015FF34);
                      if ( v42 == 2 )
                        --v41;
                      v43 = v61;
                      if ( v42 <= 0 )
                        break;
                      sub_18009A868(v58[0], v61, &v53);
                      v40 += v44;
                      if ( v41 <= 0 )
                      {
                        v6 = v54;
                  ...
                  {
                    sub_18009A8B8(v7, (unsigned int)v13, v37, &v53);
                    v43 = v61;
LABEL_133:
                    v12 = v53;
                  }
...
LABEL_52:
              ...
              if ( (v4 & 0x20) != 0 )
              {
                v57[0] = v21;
                v57[1] = 0;
                if ( (int)sub_180098D6C(v65, v57, dword_18015FF34) < 0 )
                  v64 = 1;
              }
              else
              {
