/*
 * XREFs of sub_1800FAE20 @ 0x1800FAE20
 * Callers:
 ...
 *     sub_1800FAB20 @ 0x1800FAB20 (sub_1800FAB20.c)
 * Callees:
...
PSLIST_ENTRY __fastcall sub_1800FAE20(__int64 a1, __int64 a2)
{
  int v4; // ebp
  unsigned int v5; // eax
  __int64 v6; // r8
...
LABEL_9:
  ...
  result = (PSLIST_ENTRY)sub_1800FB38C(v9);
  if ( v4 )
  {
