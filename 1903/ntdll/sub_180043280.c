...
__int64 __fastcall sub_180043280(__int64 a1, int a2, unsigned __int64 a3, unsigned __int64 a4, _QWORD *a5, _WORD *a6)
{
  __int64 v6; // rsi
  ...
  if ( *(_DWORD *)(a1 + 16) == -571548178 )
  {
    ...
    if ( v27 + v7 >= v7
      && (v28 = sub_180044EDC(a1, v26, v25, (int)v27 + (int)v7, (__int64)a5, v22), (v29 = (_QWORD *)v28) != 0LL) )
    {
      if ( v28 != -1 )
      {
        if ( (dword_18016273C & 2) != 0 )
  ...
  if ( (v12 & 0x1000000) == 0 )
  {
    if ( !dword_18015F9B8 )
    {
      ...
      if ( (v14 || (v15 = qword_180163568) != 0) && a4 > v15 )
      {
        v36 = *(_QWORD *)(a1 + 400);
        if ( v36 )
          sub_18010A694(20, a1, 0, v36, v7, v14);
        goto LABEL_42;
      }
    }
    if ( (*(_BYTE *)(a1 + 120) & 1) != 0 )
    {
      v17 = sub_18006E5C8(a1, a3);
    }
    else
    {
      if ( (a3 & 0xF) != 0 )
      {
        v16 = 9;
LABEL_14:
        sub_18010A694(v16, a1, a3, 0, 0LL, 0LL);
        v17 = 0LL;
        goto LABEL_15;
      }
      v17 = a3 - 16;
...
LABEL_15:
    ...
    else if ( !(unsigned __int8)sub_180107B44(a1, v17) )
    {
      goto LABEL_88;
    }
    if ( *(char *)(v17 + 15) >= 0 )
    ...
    {
      if ( (unsigned __int16)qword_180166580 ^ (unsigned __int16)(*(_WORD *)(v17 + 8) ^ a1 ^ (v17 >> 4)) )
        v38 = 0LL;
      else
        v38 = *(_QWORD *)(v17
                        - ((unsigned __int64)((unsigned int)qword_180166580 ^ *(_DWORD *)(v17 + 8) ^ (unsigned int)a1 ^ (unsigned int)(v17 >> 4)) >> 12));
      v39 = *(_WORD *)(v38 + 36);
    }
    if ( *(_BYTE *)(v17 + 15) == 4 )
    {
...
LABEL_42:
      ...
      if ( v44 == 5 )
        ...
        v48 = 0LL;
      if ( (int)sub_1800EFD34(v11, a1, v8, 5, v48) >= 0 )
      {
        v49 = *(_BYTE *)(v17 + 15);
        if ( v49 == 4 )
        {
...
LABEL_40:
                ...
                {
                  RtlSizeHeap(a1, 0, v8);
                  v63 = sub_1800F3190(a1, v13, v8, v62, v10, v11);
                  sub_1800EFD34(v11, a1, v63, 6, v8);
                }
                goto LABEL_42;
              }
              if ( (v13 & 0x10000000) == 0 )
        ...
        if ( v18 )
        {
          ...
          if ( v11 )
          {
            v6 = sub_1800F3190(a1, v13, v18, v19, v10, v11);
            sub_1800EFD34(v11, a1, v6, 6, v18);
          }
          return v6;
        }
        goto LABEL_40;
...
LABEL_88:
    sub_18010A694(3, a1, v17, v8, 0LL, 0LL);
    v30 = -1073741811;
    goto LABEL_43;
  }
  return sub_1801055A0((void *)a1);
}
