...
LABEL_37:
  ...
  {
    v19 = v42;
    if ( a2 && (int)sub_18001583C((__int64)v42, a2, 0, &v37) < 0 )
    {
      v21 = -1073741772;
LABEL_34:
      v8 = v39;
    ...
    {
      *a5 = v17;
      v21 = sub_180014248(v19[7], (__int64)v19, (_DWORD *)a4, a5, v13, v14, &v38);
      if ( v21 >= 0 && v38 )
        goto LABEL_29;
      v21 = sub_180015604(&v40, (__int64)v19, 0x19u, 1);
      if ( v21 >= 0 )
      {
        v21 = sub_1800159B8(v13 | 0x30u, (__int64)v19, &v40, 0LL, 0LL, 0LL, 0LL, 0LL, 0);
        if ( v21 >= 0 )
        {
          v22 = a5;
          *a5 = v39;
    ...
    {
      v20 = sub_180015604(&v40, (__int64)v19, 0x19u, 1);
      v21 = v20;
      if ( (v13 & 0x8080) != 0 )
      {
        if ( v20 >= 0 )
        {
          v21 = sub_1800159B8(v13 | 0x30u, (__int64)v19, &v40, 0LL, 0LL, 0LL, v19[7], 0LL, 1);
          if ( v21 >= 0 )
          {
            v22 = a5;
LABEL_23:
            v23 = v40;
            v24 = sub_180014248(v40, (__int64)v19, (_DWORD *)a4, v22, v13, v14, &v38);
            goto LABEL_24;
          }
        }
      }
      ...
      {
        v21 = sub_1800159B8(v13 | 0x30u, (__int64)v19, &v40, 0LL, 0LL, 0LL, v19[7], 0LL, 0);
        if ( v21 >= 0 )
        {
          v26 = sub_180015604(&v41, (__int64)v19, 0x19u, 1);
          v23 = v40;
          v21 = v26;
          if ( v26 < 0 )
            goto LABEL_82;
...
LABEL_81:
          v35 = v27;
          v10 = v41;
          v24 = sub_180014248(v41, (__int64)v19, (_DWORD *)a4, a5, v13, v35, &v38);
LABEL_24:
          v21 = v24;
LABEL_25:
          if ( v23 )
