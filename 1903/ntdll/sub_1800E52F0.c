        ...
        _DWORD *a9)
{
  ...
  *a8 = 0LL;
  ...
  if ( v20 >= 0 )
  {
    Heap = RtlAllocateHeap((__int64)ProcessHeap, dword_18016542C + 1310720, 24LL * a2[2]);
    v13 = Heap;
    if ( !Heap )
    {
      v15 = -1073741801;
          ...
          if ( v37 )
          {
            ...
            if ( v38 | ~v34[1] & 8 )
            {
              ...
              if ( a2[2] )
              {
                ...
                do
                {
                  if ( sub_1800E5164(v34, (unsigned __int8 *)v40, v99, v98) )
                  {
                    v46 &= ~*(v48 - 3);
                    v47 &= ~*(v48 - 5);
                    v49 &= ~*(v48 - 4);
...
LABEL_90:
    ...
    if ( (*v12 & 0x1000) != 0 )
    {
      ...
      v78 = (void *)RtlAllocateHeap((__int64)ProcessHeap, dword_18016542C + 1310720, a2[1]);
      *v10 = (__int64)v78;
      if ( v78 )
        memmove(v78, a2, a2[1]);
      else
