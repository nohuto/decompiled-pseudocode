/*
 * XREFs of sub_18000EC54 @ 0x18000EC54
 * Callers:
...
__int64 __fastcall sub_18000EC54(__int64 a1)
{
  int v1; // r8d
  struct _TEB *v4; // rdx
  ...
  if ( !NtCurrentTeb()->UserPrefLanguages || !*(_QWORD *)NtCurrentTeb()->UserPrefLanguages )
  {
    if ( a1 )
    {
      v1 = sub_180007D24(a1, 1u, &v25, 3, 0);
      if ( v1 >= 0 )
      {
        v4 = NtCurrentTeb();
        ...
        if ( !MuiImpersonation )
          v1 = sub_180008A20(8, &v26, a1);
        if ( v1 >= 0 )
        {
          v11 = v25;
          *(_DWORD *)(v25 + 40) |= 0x10u;
          v1 = sub_18007C1B8(v11, 0LL, 4LL);
          if ( v1 >= 0 && v26 )
            v1 = sub_18007C1B8(0LL, v26, 5LL);
          v12 = NtCurrentTeb();
