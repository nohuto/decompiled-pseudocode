/*
 * XREFs of RtlSetUserFlagsHeap @ 0x1800EF550
 * Callers:
        ...
        ULONG UserFlagsSet)
{
  ...
  if ( *((_DWORD *)HeapHandle + 4) != -571548178 )
  {
    ...
    if ( (v16 & 0x61000000) != 0 && (v16 & 0x10000000) == 0 )
      return sub_180105AFC(HeapHandle, UserFlagsSet);
    v11 = 1;
    if ( (*((_BYTE *)HeapHandle + 120) & 1) != 0 )
    {
      v17 = sub_18006E5C8((int)HeapHandle, (__int64)BaseAddress);
      goto LABEL_26;
    }
...
LABEL_42:
    ...
    sub_18010A694(v18, (_DWORD)HeapHandle, (_DWORD)BaseAddress, 0, 0LL, 0LL);
    v17 = 0LL;
    goto LABEL_26;
  }
  v8 = sub_180040614(Flags);
  ...
  if ( (dword_18016273C & 2) != 0 )
    v6 -= *((_QWORD *)v6 - 2);
  v13 = sub_180046D10((__int64)HeapHandle, (unsigned __int64)v6, (unsigned int)v12 | *((_DWORD *)HeapHandle + 5), 0LL);
