/*
 * XREFs of sub_18001F4F0 @ 0x18001F4F0
 * Callers:
...
__int64 __fastcall sub_18001F4F0(__int64 a1, unsigned int a2, __int64 a3, unsigned int a4)
{
  char v4; // di
  unsigned int v5; // ebx
  _BYTE *v6; // rcx
  ...
  __int128 v87; // [rsp+B8h] [rbp-5A0h] BYREF
  ...
  v85 = a2;
  v93 = a1;
  if ( sub_18001EE1C(&v70, (PVOID *)&v71) )
  {
    sub_1800A06B0(v97);
    v4 = 0;
    v69 = 0;
    v5 = 0;
    v77 = 0;
    v87 = xmmword_18017A4E0;
    v88 = qword_18017A4F0;
    while ( 1 )
    {
      if ( !(unsigned __int8)sub_18006A9DC(&v70, v100, &v71) )
        return v5;
      v30 = (unsigned int *)sub_1800202C0(v101, &v87);
      v86 = v30;
      v95 = v30;
      if ( !v30 )
        return v5;
      ...
      {
        VirtualMemory = ZwQueryVirtualMemory(-1LL, v101, 0LL, v96, 48LL, 0LL);
        v76 = VirtualMemory;
        if ( VirtualMemory >= 0 )
        {
          if ( (v96[36] & 0x40) != 0 )
...
LABEL_5:
      ...
      else
      {
        ...
        for ( i = 0; ; i = v64 )
        {
          ...
          if ( (BYTE1(v65) & 0xF) == 3 )
            break;
          v64 = (unsigned int)sub_18008296C(v65, (unsigned int)v64) + (unsigned int)v64;
        }
        v32 = *((_QWORD *)&v87 + 1);
        ...
        if ( v38 >= 2 )
        {
          if ( *(_BYTE *)(v36 + 2) )
          {
            ...
            if ( (HIBYTE(v54) & 0xF) == 6 )
            {
              ...
              {
LABEL_185:
                sub_1800FB4F8(DWORD2(v87), v7, v56 - v7, (_DWORD)v30, (__int64)v97, 0LL, (__int64)&v70, (__int64)&v71);
LABEL_186:
                v69 = 0;
                goto LABEL_49;
              }
        ...
        {
LABEL_10:
          if ( (*(_BYTE *)v34 & 0xFE) != 0x48 )
            goto LABEL_11;
          if ( *(_BYTE *)(v34 + 1) != 0x8D )
            goto LABEL_11;
          v7 = *(unsigned __int8 *)(v34 + 2);
          v40 = *(_BYTE *)(v34 + 2) & 7;
          v39 = (v40 | (8 * (*(_BYTE *)v34 & 1))) == 0;
          v35 = v40 | (8 * (*(_BYTE *)v34 & 1u));
          v82 = v40 | (8 * (*(_BYTE *)v34 & 1));
...
LABEL_84:
        ...
        if ( *(_BYTE *)(v34 + 1) == 0x83 && *(_BYTE *)(v34 + 2) == 0xC4 )
          goto LABEL_84;
        if ( *(_BYTE *)v34 != 72 || *(_BYTE *)(v34 + 1) != 0x81 || *(_BYTE *)(v34 + 2) != 0xC4 )
          goto LABEL_10;
LABEL_66:
        for ( k = (_BYTE *)(v34 + 7); ; k += 2 )
        {
LABEL_11:
          while ( 1 )
          {
            ...
            if ( (*(_BYTE *)v34 & 0xF8) == 0x48 )
            {
              ...
              switch ( v44 )
              {
                case -125:
                  ...
                  goto LABEL_88;
                case -127:
                  v100 += ((*(unsigned __int8 *)(v34 + 4) | (*(unsigned __int16 *)(v34 + 5) << 8)) << 8) | *(unsigned __int8 *)(v34 + 3);
                  goto LABEL_166;
                case -115:
                  v66 = *(_BYTE *)(v34 + 2) & 0xF8;
                  if ( v66 == 96 )
                  {
                    v100 = (char *)v99[v35];
                    v100 += *(char *)(v34 + 3);
LABEL_88:
                  ...
                  {
                    v100 = (char *)(v99[v35]
                                  + (((*(unsigned __int8 *)(v34 + 4) | (*(unsigned __int16 *)(v34 + 5) << 8)) << 8) | *(unsigned __int8 *)(v34 + 3)));
LABEL_166:
                    v34 += 7LL;
                  }
                  break;
            ...
            while ( 1 )
            {
              while ( (*(_BYTE *)v34 & 0xF8) == 0x58 )
              {
                if ( (unsigned __int64)v100 < v70 || v100 > v71 - 8 )
                  goto LABEL_184;
                v99[*(_BYTE *)v34 & 7] = *(_QWORD *)v100;
                v100 += 8;
                ++v34;
              }
              if ( (*(_BYTE *)v34 & 0xF0) != 0x40 || (*(_BYTE *)(v34 + 1) & 0xF8) != 0x58 )
                break;
              if ( (unsigned __int64)v100 < v70 || v100 > v71 - 8 )
                goto LABEL_184;
              v99[*(_BYTE *)(v34 + 1) & 7 | (8LL * (*(_BYTE *)v34 & 1))] = *(_QWORD *)v100;
              v100 += 8;
              v34 += 2LL;
            }
            if ( (unsigned __int64)v100 < v70 || v100 > v71 - 8 )
...
LABEL_71:
        ...
        else
        {
          ...
          {
            v61 = sub_18000108C((__int64)v30, v32, v47 + v32);
            if ( !v61 )
              goto LABEL_72;
            v39 = v47 == *v61;
            goto LABEL_71;
...
LABEL_21:
      ...
      while ( 2 )
      {
        ...
        while ( 1 )
        {
          ...
          {
            v15 = (unsigned int)sub_18008296C(*(unsigned __int16 *)&v18[2 * v15 + 4], v7) + (unsigned int)v15;
          }
          else
          {
            if ( v20 > 5 )
