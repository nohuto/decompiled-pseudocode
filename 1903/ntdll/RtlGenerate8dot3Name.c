/*
 * XREFs of RtlGenerate8dot3Name @ 0x1800F62E0
 * Callers:
 *     <none>
 * Callees:
 ...
 *     sub_1800F626C @ 0x1800F626C (sub_1800F626C.c)
 */
        ...
        PUNICODE_STRING Name8dot3)
{
  ...
  if ( !Context->NameLength )
  {
    ...
    while ( 1 )
    {
      v11 = sub_1800F6174(&Name->Length, &v51, v10, AllowExtendedCharacters);
      if ( !v11 )
        break;
      v10 = 0;
      if ( v11 == 46 )
    ...
    while ( 1 )
    {
      v14 = sub_1800F6174(&Name->Length, &v51, 1, AllowExtendedCharacters);
      v15 = v14;
      if ( !v14 || v51 >= v9 || v4 >= 6u )
        break;
      if ( v8 )
      {
        if ( v14 <= 0x7Fu || (v13 = *(_BYTE *)(qword_180166948 + 2LL * v14 + 1) == 0, v16 = 2, v13) )
          v16 = 1;
        v12 += v16;
        if ( v12 > 6 )
          break;
    ...
    else
    {
      ...
      {
        v24 = sub_1800F6174(&Name->Length, v53, 1, AllowExtendedCharacters);
        v25 = v24;
        if ( !v24 )
          break;
        if ( j >= 4 )
        ...
        if ( v8 )
        {
          if ( v24 <= 0x7Fu || (v26 = v24, v27 = 2, !*(_BYTE *)(qword_180166948 + 2 * v26 + 1)) )
            v27 = 1;
          v22 += v27;
          if ( v22 > 4 )
          {
  ...
  if ( v8 )
  {
    ...
    for ( k = 0; v47 < NameLength; ++v47 )
    {
      if ( Context->NameBuffer[v47] <= 0x7Fu
        || (v49 = 2, !*(_BYTE *)(qword_180166948 + 2LL * Context->NameBuffer[v47] + 1)) )
      {
        v49 = 1;
      }
      k += v49;
