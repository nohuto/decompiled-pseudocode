...
__int64 __fastcall RtlGenerate8dot3Name(unsigned __int16 *a1, char a2, __int64 a3, __int64 a4)
{
  ...
  if ( !*(_BYTE *)(a3 + 3) )
  {
    ...
    while ( 1 )
    {
      v11 = sub_1800F6174(a1, &v51, v10, a2);
      if ( !v11 )
        break;
      v10 = 0;
      if ( v11 == 46 )
  ...
  if ( v8 )
  {
    ...
    for ( k = 0; v47 < v46; ++v47 )
    {
      if ( *(_WORD *)(a3 + 2LL * v47 + 4) <= 0x7Fu
        || (v49 = 2, !*(_BYTE *)(qword_180166948 + 2LL * *(unsigned __int16 *)(a3 + 2LL * v47 + 4) + 1)) )
      {
        v49 = 1;
      }
      k += v49;
