        ...
        __int64 a8)
{
  ...
  if ( (*(_BYTE *)v11 & 1) != 0 )
  {
    ...
    if ( RtlGetCurrentServiceSessionId() )
      ...
      v13 = 2147353476LL;
    sub_1800E0820((unsigned __int16 *)v33, *(unsigned __int8 *)v13);
  }
  else
  {
    v12 = 2147353476LL;
  ...
  v14 = v8 & 0x1000;
  v36 = v14;
  result = sub_1800E2500(Handle, &v37);
  if ( result < 0 && (v8 & 0x1000) != 0 )
    return result;
  result = sub_1800E29E8(Handle, 0LL, v58, 0x40u);
  if ( result < 0 )
    return result;
  if ( v58[0] != 23117 )
    goto LABEL_15;
  ...
  result = sub_1800E29E8(Handle, v59, &v47, 0x108u);
  if ( result < 0 )
    return result;
  if ( v47 != 17744 )
    goto LABEL_15;
...
LABEL_35:
    ...
    v16 = sub_1800E29E8((char *)Handlea, v50 + v18 + 24, v33[0], v23);
    v31 = v16;
    if ( v16 >= 0 )
    {
      v24 = v33[0];
      ...
      if ( v25 < v49 && (v27 = v22 + (unsigned int)v24[5] - (unsigned __int64)(unsigned int)v24[3]) != 0 )
      {
        ...
        if ( v16 >= 0 )
        {
          if ( v35 == 3 )
          {
            ...
            {
              v16 = sub_180058950(0LL, 0, *((_WORD *)v39 + 8), v34, v60);
              v31 = v16;
              if ( v16 < 0 && v36 )
                goto LABEL_55;
            }
          ...
          if ( v16 >= 0 )
          {
            ...
            if ( v43 )
            {
              ...
              v16 = RtlLcidToLocaleName(v32, &LocaleName, 2u, 0);
              v31 = v16;
              if ( v16 >= 0 )
              {
                v30 = -1LL;
...
LABEL_56:
  ...
  if ( (*(_BYTE *)v10 & 1) != 0 )
  {
    ...
    sub_1800E0820((unsigned __int16 *)&v44, *(unsigned __int8 *)v12);
  }
  return v16;
}
