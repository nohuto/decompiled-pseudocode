...
__int64 __fastcall sub_1800FD168(__int64 a1, __int64 a2, _BYTE *a3, _WORD *a4)
{
  void *Heap; // rdi
  int v9; // esi
  int v10; // eax
  ...
  if ( a2 && a1 )
  {
    ...
    v10 = sub_1800090D4(a1, (__int64)&DestinationString, &v16, 0LL, &v15);
    if ( !v15 || v10 == -1073741772 )
      return (unsigned int)-1073741823;
    Heap = (void *)RtlAllocateHeap((__int64)NtCurrentPeb()->ProcessHeap, 8u, v15);
    if ( !Heap )
      return (unsigned int)-1073741801;
    v11 = sub_1800090D4(a1, (__int64)&DestinationString, &v16, Heap, &v15);
    if ( v11 >= 0 )
    {
      if ( v16 == 1
                                                                      ...
                                                                      &v17)) )
      {
        ...
        if ( ((v17 - 4096) & 0xFFFFFBFF) != 0 )
          goto LABEL_14;
        v11 = sub_180015918(a2, DestinationString.Buffer, 0LL, (__int16 *)&v19);
        if ( v11 >= 0 )
        {
          v12 = v19;
          v9 = 3;
