...
__int64 __fastcall TpSimpleTryPost(struct _PEB_LDR_DATA *Ldr, __int64 a2, __int64 a3, __int64 a4)
{
  ...
  {
    Heap = RtlAllocateHeap(NtCurrentPeb()->ProcessHeap, (dword_180166080 + 0x200000) | 8u, 240LL);
    v9 = (_QWORD *)Heap;
    v14 = Heap;
    if ( Heap )
    {
      *(_QWORD *)(Heap + 176) = retaddr;
      v10 = sub_180037608(Heap, v5, a3, v7, (__int64)off_1801183B0, (__int64)off_1801183D0);
      v12 = v10;
      if ( v10 >= 0 )
      {
        v10 = 0;
    ...
    if ( v9 )
    {
      RtlFreeHeap(NtCurrentPeb()->ProcessHeap, (unsigned int)(dword_180166080 + 0x200000), v14);
      v9 = 0LL;
      v10 = v12;
    }
    if ( v10 >= 0 )
