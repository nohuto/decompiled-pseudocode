/*
 * XREFs of RtlWow64GetCurrentCpuArea @ 0x180066440
 * Callers:
 *     RtlWow64GetCurrentMachine @ 0x1800662A0 (RtlWow64GetCurrentMachine.c)
 * Callees:
 *     RtlWow64GetCpuAreaInfo @ 0x1800664C0 (RtlWow64GetCpuAreaInfo.c)
 */
