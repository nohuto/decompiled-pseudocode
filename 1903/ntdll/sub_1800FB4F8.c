/*
 * XREFs of sub_1800FB4F8 @ 0x1800FB4F8
 * Callers:
...
__int64 __fastcall sub_1800FB4F8(
        __int64 a1,
        __int64 a2,
        unsigned int a3,
        _BYTE *a4,
        ...
        _QWORD *a8)
{
    ...
    if ( v12[2] )
    {
      do
      {
        ...
        if ( (HIBYTE(v14) & 0xF) == 0xA )
          break;
        v11 = (unsigned int)sub_18008296C(v14) + (unsigned int)v11;
      }
  ...
  while ( 1 )
  {
    v19 = (unsigned __int8)HIBYTE(*v18) >> 4;
    if ( (*v18 & 0xF00) != 0 )
      break;
    if ( v17 >= a3 )
    {
  ...
  if ( (unsigned int)v11 >= v13 )
    goto LABEL_23;
  if ( (HIBYTE(*v18) & 0xF) == 2 && HIBYTE(*v18) < 0x10u )
  {
    if ( v17 >= a3 )
      *(_QWORD *)(a5 + 152) += 8LL;
    v11 = (unsigned int)(v11 + 1);
  }
  if ( (unsigned int)v11 >= v13 || (v12[2 * v11 + 5] & 0xF) != 0xA )
  {
LABEL_23:
    v21 = *(_QWORD **)(a5 + 152);
