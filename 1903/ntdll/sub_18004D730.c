...
__int64 __fastcall sub_18004D730(__int64 a1, char a2)
{
  ...
  union _SLIST_HEADER **v46; // r8
  int v47; // r9d
  __int64 v48; // rcx
  union _SLIST_HEADER *v49; // rdx
  union _SLIST_HEADER *v50; // rcx
  struct _SLIST_ENTRY *v51; // rdx
...
LABEL_2:
    ...
    if ( v4 )
    {
      ...
      HeapVirtualAffinity_high = (unsigned __int8)HIWORD(v10->HeapVirtualAffinity);
      if ( HeapVirtualAffinity_high == HIBYTE(HIWORD(v10->HeapVirtualAffinity)) )
      {
        v39 = sub_18004A7A0();
      ...
      {
        v13 = (unsigned __int8)(HIWORD(v10->HeapVirtualAffinity) ^ (HeapVirtualAffinity_high + 1)) ^ HIWORD(v10->HeapVirtualAffinity);
      }
      HIWORD(v10->HeapVirtualAffinity) = v13;
      v14 = sub_18004DB68(v9 + 32, (unsigned int)(v8 >> 16), byte_180163580[HeapVirtualAffinity_high], v11);
...
LABEL_23:
      ...
      while ( 1 )
      {
        ...
        while ( 1 )
        {
          ...
          {
            Next = (union _SLIST_HEADER *)v30->Next->Next;
            v30->Next = 0LL;
            RtlInterlockedPushEntrySList_0(Next, v29);
          }
        }
        if ( v19 == (struct _SLIST_ENTRY *)_InterlockedCompareExchange64(v23, (signed __int64)v30, (signed __int64)v19) )
          break;
        v20 = (__int64 *)(a1 + 16);
        if ( v30 )
        {
...
LABEL_43:
      ...
      if ( _InterlockedAnd((volatile signed __int32 *)&v19[2].Next + 3, 0xFFFFFFFD) != 2 )
        goto LABEL_45;
      v42 = (union _SLIST_HEADER *)v19->Next->Next;
      v19->Next = 0LL;
    ...
    do
    {
      ...
      if ( (*((_DWORD *)&v38[-1].Next + 3) & 1) == 0 )
      {
        ...
        if ( _InterlockedAnd((volatile signed __int32 *)&v19[2].Next + 3, 0xFFFFFFFD) != 2 )
          goto LABEL_85;
LABEL_84:
        v44 = (union _SLIST_HEADER *)v19->Next->Next;
        v19->Next = 0LL;
...
LABEL_45:
    ...
    *((_BYTE *)&v19[2].Next + 11) = a2;
    ...
    v33 = v19->Next;
    if ( v19->Next == (struct _SLIST_ENTRY *)a1 )
    {
      ...
      v19 = (struct _SLIST_ENTRY *)_InterlockedExchange64((volatile __int64 *)(a1 + 8), (__int64)v19);
      if ( v19 )
      {
        _m_prefetchw((char *)&v19[2].Next + 12);
        ...
        {
LABEL_101:
          v50 = (union _SLIST_HEADER *)v19->Next->Next;
          v19->Next = 0LL;
LABEL_99:
          v51 = v19 + 3;
LABEL_100:
        ...
        else if ( sub_180043114(a1, (__int64)v19) )
        {
          while ( 1 )
          {
            ...
            {
              v53 = (union _SLIST_HEADER **)v19->Next;
              v54 = 0;
              while ( 1 )
              {
                ...
                if ( v49 )
                {
                  if ( (*((_DWORD *)&v49[2].HeaderX64 + 3) & 1) == 0
                    && v49 == (union _SLIST_HEADER *)_InterlockedCompareExchange64(
    ...
    else
    {
      ...
      v46 = (union _SLIST_HEADER **)v19->Next;
      v47 = 0;
      while ( 1 )
      {
...
LABEL_97:
        ...
        {
LABEL_98:
          v50 = (union _SLIST_HEADER *)(*(_QWORD *)(*((_QWORD *)&v19->Next->Next[1].Next + 1)
...
LABEL_104:
      ...
      {
        v50 = *(union _SLIST_HEADER **)v49->Alignment;
        v49->Alignment = 0LL;
        v51 = (struct _SLIST_ENTRY *)&v49[3];
        goto LABEL_100;
      }
    }
  }
