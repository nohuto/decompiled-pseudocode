...
PSLIST_ENTRY __stdcall RtlInterlockedPushEntrySList_0(PSLIST_HEADER ListHead, PSLIST_ENTRY ListEntry)
{
  union _SLIST_HEADER v5; // rax
  struct _SLIST_ENTRY *Region; // r8
  ...
  do
  {
    Region = (struct _SLIST_ENTRY *)v5.Region;
