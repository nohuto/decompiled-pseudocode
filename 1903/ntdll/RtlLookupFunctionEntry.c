        ...
        PUNWIND_HISTORY_TABLE HistoryTable)
{
  ...
  {
    HistoryTable->Once = 0;
    result = *(PRUNTIME_FUNCTION *)&dword_18017A3F0[4 * (unsigned __int8)byte_18017A3F5 + 8];
    if ( result )
    {
      v31 = *(_QWORD *)&dword_18017A3F0[4 * (unsigned __int8)byte_18017A3F5 + 6];
  ...
  if ( ControlPc < qword_18017A3F8
    ...
    || (GlobalHint = HistoryTable->GlobalHint, v28 = GlobalHint, GlobalHint >= dword_18017A3F0[0]) )
  {
LABEL_26:
...
LABEL_2:
    ...
    {
      v6 = sub_18001E620(ControlPc, &v32);
    }
    else
    {
      v6 = xmmword_18017A4E0;
      v32 = xmmword_18017A4E0;
      v33 = qword_18017A4F0;
    }
    if ( v6 )
    {
    ...
    {
      v8 = (struct _IMAGE_RUNTIME_FUNCTION_ENTRY *)sub_180073F4C(ControlPc, ImageBase);
    }
    if ( v8 )
    {
      if ( HistoryTable )
  ...
  while ( 1 )
  {
    v29 = *(unsigned int **)&dword_18017A3F0[4 * v28 + 8];
    v30 = *(_QWORD *)&dword_18017A3F0[4 * v28 + 6];
    if ( ControlPc >= v30 + *v29 && ControlPc < v30 + v29[1] )
      break;
    if ( ++v28 >= dword_18017A3F0[0] )
      goto LABEL_26;
  }
  result = *(PRUNTIME_FUNCTION *)&dword_18017A3F0[4 * v28 + 8];
