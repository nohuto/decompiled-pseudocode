/*
 * XREFs of RtlCreateTimer @ 0x180030E70
 * Callers:
 *     RtlSetTimer @ 0x18010FB00 (RtlSetTimer.c)
 * Callees:
        ...
        ULONG Flags)
{
  ...
  if ( NtCurrentPeb()->Ldr->ShutdownInProgress )
    return -1073741823;
  *Handle = 0LL;
  v10 = sub_180030D7C(&TokenHandle, Flags & 0x100);
  v19 = v10;
  if ( v10 < 0 )
  {
    v12 = 0LL;
  ...
  else
  {
    ...
    if ( Heap )
    {
      ...
      *((_QWORD *)Heap + 8) = 0LL;
      *((_DWORD *)Heap + 23) = 0;
      v10 = sub_180030DFC((HANDLE *)Heap + 2, Flags, TokenHandle);
      v19 = v10;
      if ( v10 < 0 )
        goto LABEL_16;
      v12[4] = Function;
      ...
      *((_BYTE *)v12 + 88) = Period != 0;
      ...
      CallbackEnviron.FinalizationCallback = (PTP_SIMPLE_CALLBACK)sub_18007A770;
      v10 = TpAllocTimer(v13, (PTP_TIMER_CALLBACK)sub_1800305A0, v12, &CallbackEnviron);
      v19 = v10;
      if ( v10 < 0 )
        goto LABEL_16;
