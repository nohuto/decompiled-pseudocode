 ...
 *     <none>
 * Callees:
 *     ZwQueryMutant @ 0x18009F0B0 (ZwQueryMutant.c)
 */

NTSTATUS __fastcall sub_1801120C0(HANDLE MutantHandle, char *MutantInformation, unsigned int a3, ULONG *ReturnLength)
{
  NTSTATUS result; // eax
