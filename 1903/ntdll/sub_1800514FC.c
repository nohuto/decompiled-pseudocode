/*
 * XREFs of sub_1800514FC @ 0x1800514FC
 * Callers:
...
__int64 __fastcall sub_1800514FC(__int64 a1, __int64 a2, __int64 a3)
{
  __int64 v5; // rdi
  unsigned int v6; // ebx
  int v7; // eax
  ...
  v6 = -*(_DWORD *)a1;
  v7 = sub_1800515C4(a1, v5, 256 - (unsigned int)*(unsigned __int8 *)(a1 + 10));
  v9 = v6;
  v10 = (v8 + v7) << 12;
  v11 = v6 - v10;
  *(_DWORD *)(a2 + 24) = v10;
