/*
 * XREFs of sub_1800FC3A4 @ 0x1800FC3A4
 * Callers:
...
char __fastcall sub_1800FC3A4(__int64 a1, unsigned int a2, const void *a3, _QWORD *a4)
{
  __int64 v4; // rsi
  __int64 v8; // rax
  _QWORD *v10; // rcx
  ...
  if ( a2 <= 0x100 )
  {
    if ( (unsigned __int8)sub_1800FC54C(a1, a2, a3, v18) )
    {
      v8 = v18[0];
      ++*(_DWORD *)(v18[0] + 4LL);
      if ( a4 )
    ...
    {
      v12 = *(_QWORD *)(a1 + 24);
      if ( v12 && *(_QWORD *)(a1 + 32) > v12 || (v13 = sub_1800FC320(0x10000uLL), (v10 = v13) == 0LL) )
      {
LABEL_11:
        if ( a4 )
          *a4 = 0LL;
