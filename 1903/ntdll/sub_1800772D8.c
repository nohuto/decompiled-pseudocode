/*
 * XREFs of sub_1800772D8 @ 0x1800772D8
 * Callers:
...
__int64 __fastcall sub_1800772D8(
        ...
        PUNICODE_STRING *NewName)
{
  ...
  _BYTE v21[56]; // [rsp+100h] [rbp-138h] BYREF
  char v22; // [rsp+140h] [rbp-F8h] BYREF
      ...
      if ( (NewFlags & 1) == 0 )
      {
        ...
        if ( ActivationContextSectionString >= 0 )
        {
          if ( ReturnedData.ulDataFormatVersion == 1 )
          {
            ...
            String1.Buffer = (PWCH)((char *)ReturnedData.AssemblyMetadata.lpSectionBase
                                  + *((unsigned int *)ReturnedData.AssemblyMetadata.lpInformation + 24));
            LocaleName.Buffer = (PWCH)&v22;
            ...
            if ( ActivationContextSectionString >= 0 )
            {
              ...
              {
                v12 = ((__int64 (__fastcall *)(__int64, _QWORD, __int64 *))qword_180165FF8)(hActCtx, a2, &v16);
