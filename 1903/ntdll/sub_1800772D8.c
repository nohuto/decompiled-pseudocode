...
__int64 __fastcall sub_1800772D8(__int128 *a1, unsigned __int16 a2, __int64 a3, UNICODE_STRING *a4, __int64 a5)
{
  __int64 v9; // rdi
        ...
        if ( ActivationContextSectionString >= 0 )
        {
          if ( HIDWORD(v21[0]) == 1 )
          {
            ...
            if ( ActivationContextSectionString >= 0 )
            {
              ...
              {
                v12 = ((__int64 (__fastcall *)(__int64, _QWORD, __int64 *))qword_180165FF8)(v9, a2, &v18);
