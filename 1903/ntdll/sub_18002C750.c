...
__int64 __fastcall sub_18002C750(__int64 a1, _QWORD *a2)
{
  unsigned int v2; // ebx
  __int64 v5; // rax
  unsigned int v6; // edi
  ...
  if ( a2 && a1 )
  {
    ...
    {
      if ( (unsigned int)sub_18007A604(a1, &v12, &v16) )
      {
        v9 = v12;
        if ( v12 )
        {
          ...
          if ( *v12 )
          {
            ...
            {
              if ( v11[4] == 1
                && (unsigned int)sub_18002CDC0(v11, &v14)
      ...
      sub_18002DDE0((unsigned __int16)v6, (unsigned __int16)v7, &v15);
      *a2 = v15;
    }
    return 1;
  }
