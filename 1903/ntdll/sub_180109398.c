/*
 * XREFs of sub_180109398 @ 0x180109398
 * Callers:
...
__int64 __fastcall sub_180109398(
        unsigned __int64 a1,
        unsigned int a2,
        __int64 a3,
        unsigned int a4,
  ...
  while ( 2 )
  {
    ...
    if ( (unsigned __int64)v58 < v22 )
    {
      ...
      do
      {
        v25 += 8;
        LOWORD(v24) = v24 + 1;
        v26 = (unsigned __int16)word_1801391E0[v21[2] + 512] ^ (unsigned __int16)word_1801391E0[*v21] ^ (unsigned __int64)(unsigned __int16)word_1801391E0[v21[1] + 256];
