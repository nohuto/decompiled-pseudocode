/*
 * XREFs of sub_1800823E0 @ 0x1800823E0
 * Callers:
...
int __fastcall sub_1800823E0(_QWORD *a1)
{
  __int64 v2; // rbx
  struct _PEB *v3; // rax
  __int64 v4; // rax
  ...
  if ( !*(_QWORD *)v4 )
  {
    ...
    if ( *(_UNKNOWN ***)off_18015F578[0] != &off_18015F570 )
      __fastfail(3u);
    *(_QWORD *)v4 = &off_18015F570;
    *(_QWORD *)(v4 + 8) = v5;
    *v5 = v4;
    off_18015F578[0] = (_UNKNOWN **)v4;
  }
  v6 = _InterlockedCompareExchange64((volatile signed __int64 *)&stru_1801662F8, 0LL, 1LL);
  if ( v6 != 1 )
  {
    do
    {
      ...
      v9 = v6 + v7;
      v10 = v6;
      v6 = _InterlockedCompareExchange64((volatile signed __int64 *)&stru_1801662F8, v9, v6);
    }
    while ( v10 != v6 );
    if ( v8 == 2 )
    {
...
LABEL_19:
        ...
        v6 = _InterlockedCompareExchange64((volatile signed __int64 *)&stru_1801662F8, 0LL, v9);
        v13 = v9 == v6;
        v9 = v6;
        if ( v13 )
          goto LABEL_19;
      ...
      while ( 1 )
      {
        v6 = _InterlockedCompareExchange64((volatile signed __int64 *)&stru_1801662F8, v9 - 4, v9);
        v13 = v9 == v6;
        v9 = v6;
        if ( v13 )
          break;
