/*
 * XREFs of RtlAddResourceAttributeAce @ 0x1800E7240
 * Callers:
 *     <none>
 * Callees:
 ...
 *     sub_1800E8510 @ 0x1800E8510 (sub_1800E8510.c)
 */
        ...
        _DWORD *a7)
{
  ...
  *a7 = 0;
  ...
  if ( *(_BYTE *)(a5 + 1) == 1 && !*(_DWORD *)(a5 + 8) )
  {
    ...
    LODWORD(v27) = v13;
    if ( (Size_4 & 0xFFFFFFE0) == 0 && !a4 && (unsigned __int8)sub_1800E8510(a6) && *(_DWORD *)(a6 + 4) == 1 )
    {
      v9 = Src;
      v11 = RtlpConvertAbsoluteToRelativeSecurityAttribute(*(_QWORD *)(a6 + 8), Src, &Size);
      if ( v11 == -1073741789 )
      {
        Heap = RtlAllocateHeap((__int64)NtCurrentPeb()->ProcessHeap, dword_18016542C + 1310720, Size);
        v9 = (_BYTE *)Heap;
        if ( !Heap )
