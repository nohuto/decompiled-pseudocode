...
char __fastcall sub_1801052B0(unsigned __int64 a1, int a2, __int64 a3, _QWORD *a4, _DWORD *a5)
{
  ...
  if ( sub_180019C74((_DWORD *)a1, "RtlGetUserInfoHeap") )
  {
    ...
    if ( sub_1800704A4(a1, v13, "RtlGetUserInfoHeap") )
