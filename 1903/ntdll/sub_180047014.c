/*
 * XREFs of sub_180047014 @ 0x180047014
 * Callers:
 ...
 *     sub_1800804E0 @ 0x1800804E0 (sub_1800804E0.c)
...
__int64 __fastcall sub_180047014(__int64 a1, __int64 a2, char a3, __int64 *a4, unsigned int a5, int a6)
{
  unsigned int v9; // esi
  __int64 result; // rax
      ...
      if ( a3 )
      {
        ...
        if ( *(_DWORD *)(a1 + 124) )
        {
          ...
          if ( HIBYTE(v17) != ((unsigned __int8)v17 ^ (unsigned __int8)(BYTE1(v17) ^ BYTE2(v17))) )
            sub_18010A694(3, a1, v15 - 16, 0, 0LL, 0LL);
        }
