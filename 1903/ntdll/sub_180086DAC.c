...
__int64 __fastcall sub_180086DAC(__int64 a1, _QWORD *a2)
{
  ...
  if ( *(_WORD *)(a1 + 144) )
  {
    ...
    return sub_18000456C((__int64)&DestinationString, a2, v3);
  }
...
LABEL_6:
    ...
    v8 = *(_QWORD *)(qword_180163518 + 16LL * v7);
    if ( (v8 & 1) == 0 )
    {
      *a2 = v8;
      return 0LL;
    }
    _InterlockedDecrement((volatile signed __int32 *)(qword_180163518 + 16LL * v7 + 8));
    return 4201LL;
  }
  result = sub_18010D214(v5, &v10);
  if ( !(_DWORD)result )
  {
    v7 = v10;
    v6 = qword_180163518;
