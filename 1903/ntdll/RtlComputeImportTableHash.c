...
LABEL_33:
  ...
  v8 = sub_18001C4DC((unsigned __int64)BaseAddress, 0, 1u, &v26, &v24);
  if ( v8 >= 0 )
  {
    v9 = (ULONG *)v24;
    goto LABEL_18;
...
LABEL_18:
    for ( k = RtlImageNtHeader(BaseAddress); v9; v9 += 5 )
    {
      ...
      *Heap = 0LL;
      Heap[1] = v13;
      sub_1800DF53C((__int64)Heap, (__int64 ***)&v22);
      if ( k->OptionalHeader.Magic == 267 )
        v16 = sub_1800DF2D0(v15, BaseAddress, k, v9);
      else
        v16 = sub_1800DF390(v15, BaseAddress, k, v9);
      v4 = v16;
      if ( v16 < 0 )
        goto LABEL_33;
    }
    v4 = sub_1800DF454(v22, Hash);
    goto LABEL_33;
  }
  v4 = -1073741687;
LABEL_11:
