/*
 * XREFs of sub_180114B68 @ 0x180114B68
 * Callers:
...
_QWORD *__fastcall sub_180114B68(__int64 a1, unsigned __int64 a2, unsigned int a3)
{
...
LABEL_31:
    if ( !v10 )
      goto LABEL_39;
    if ( (unsigned int)sub_180115D28(v10, &v33) )
      goto LABEL_35;
  }
  v10 = 0LL;
LABEL_35:
...
LABEL_52:
      if ( v10 )
      {
        if ( !(unsigned int)sub_180115508(v10 + 16) )
          v10 = 0LL;
        goto LABEL_80;
      }
LABEL_55:
