...
_QWORD *__fastcall sub_180114B68(__int64 a1, unsigned __int8 *a2, unsigned int a3)
{
...
LABEL_31:
    if ( !v16 )
      goto LABEL_39;
    if ( (unsigned int)sub_180115D28(v16, &v39) )
      goto LABEL_35;
  }
  v16 = 0LL;
LABEL_35:
...
LABEL_52:
      if ( v16 )
      {
        if ( !(unsigned int)sub_180115508(v16 + 16) )
          v16 = 0LL;
        goto LABEL_80;
      }
LABEL_55:
