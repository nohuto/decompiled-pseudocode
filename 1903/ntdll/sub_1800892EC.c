...
__int64 __fastcall sub_1800892EC(unsigned __int16 a1, char a2, signed __int32 *a3, __int16 a4, _QWORD *a5)
{
  __int64 result; // rax
  __int64 v8; // r14
  __int64 v9; // rcx
  ...
  if ( !qword_180163518 )
    return 4201LL;
  if ( (a1 & 0x7FFFu) >= 0x40 && (result = sub_18010D214(a1, &v26), (_DWORD)result) )
  {
    v8 = v27;
  }
  else
  {
    v9 = 2LL * v26;
    _InterlockedIncrement((volatile signed __int32 *)(qword_180163518 + 16LL * v26 + 8));
    v8 = *(_QWORD *)(qword_180163518 + 8 * v9);
    if ( (v8 & 1) != 0 )
    {
      _InterlockedDecrement((volatile signed __int32 *)(qword_180163518 + 8 * v9 + 8));
      return 4201LL;
    }
    v27 = *(_QWORD *)(qword_180163518 + 8 * v9);
    result = 0LL;
  }
  v42 = result;
  if ( !(_DWORD)result )
  {
    ...
    if ( !v16 )
    {
      ...
      v42 = v19;
LABEL_40:
      _InterlockedDecrement((volatile signed __int32 *)(qword_180163518 + 16LL * *(unsigned int *)(v15 + 20) + 8));
      return v42;
    }
