/*
 * XREFs of sub_1800DF878 @ 0x1800DF878
 * Callers:
 *     ApiSetQueryApiSetPresenceEx @ 0x1800D5730 (ApiSetQueryApiSetPresenceEx.c)
 * Callees:
 *     sub_1800290D0 @ 0x1800290D0 (sub_1800290D0.c)
 */

__int64 __fastcall sub_1800DF878(_DWORD *a1, unsigned __int16 *a2, char *a3, bool *a4)
{
  unsigned int v4; // ebx
  char v8; // si
  bool v9; // bp
...
LABEL_14:
  v20 = (unsigned int *)sub_1800290D0(a1, v10, (unsigned __int16)v13 >> 1);
  v21 = v20;
  if ( v20 )
  {
    v22 = 0;
