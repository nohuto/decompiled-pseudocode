/*
 * XREFs of RtlCreateProcessReflection @ 0x1800D5E70
 * Callers:
 *     <none>
 * Callees:
  ...
  if ( ProcessHandle == (HANDLE)-1LL )
  {
    *((_DWORD *)v12 + 2) = Flags | 0x10;
    ...
    if ( v11 >= 0 && ReflectionInformation )
    {
      ...
      ReflectionInformation->ReflectionClientId.UniqueProcess = (HANDLE)*((_QWORD *)v20 + 9);
      v14 = v20;
LABEL_40:
      ReflectionInformation->ReflectionClientId.UniqueThread = (HANDLE)*((_QWORD *)v14 + 10);
      goto LABEL_41;
    }
    goto LABEL_41;
  }
  MaximumSize.QuadPart = CommitSize;
  v11 = ZwCreateSection(&SectionHandle, 6u, 0LL, &MaximumSize, 4u, 0x8000000u, 0LL);
  if ( v11 < 0 )
    goto LABEL_41;
  ViewSize = CommitSize;
           ...
           v11 >= 0)) )
    {
      ...
      *((_QWORD *)v16 + 10) = *((_QWORD *)v15 + 10);
      v11 = sub_180005760(
              ...
              0LL,
              FileHandle,
              (PUSER_THREAD_START_ROUTINE)sub_1800D6400,
              v26,
              &Handle,
              0LL);
      if ( v11 >= 0 )
      {
        if ( ReflectionInformation )
        {
          ...
          if ( ZwWaitForMultipleObjects(2u, Handles, WaitAny, 0, 0LL) == 1 )
          {
            if ( *((_QWORD *)v21 + 7) )
            {
                     ...
                     2u) >= 0 )
              {
                ...
                if ( v18 >= 0 )
                {
                  ...
                  ReflectionInformation->ReflectionClientId.UniqueProcess = (HANDLE)*((_QWORD *)v21 + 9);
                  v14 = v21;
                  goto LABEL_40;
                }
              }
...
LABEL_41:
    if ( v26 )
      ZwUnmapViewOfSection(ProcessHandle, v26);
    goto LABEL_43;
  }
  v26 = 0LL;
LABEL_43:
