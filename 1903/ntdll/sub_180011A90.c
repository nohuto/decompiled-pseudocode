/*
 * XREFs of sub_180011A90 @ 0x180011A90
 * Callers:
  ...
  if ( *(_WORD *)(a1 + 4) )
  {
    ...
    while ( 1 )
    {
      if ( *(_BYTE *)v20 == 17 )
      {
        if ( a11 == 3 )
        {
          if ( RtlFindAceByType(v21, 17LL, 0LL) )
          {
LABEL_14:
            if ( !v16 )
              break;
...
LABEL_5:
          result = sub_180011C80(v20, a5, a6, a7, a8, a9, a10, (__int64)v23, v21, (__int64)&v24, (__int64)va);
