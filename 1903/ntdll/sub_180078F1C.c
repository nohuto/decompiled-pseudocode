/*
 * XREFs of sub_180078F1C @ 0x180078F1C
 * Callers:
...
__int64 __fastcall sub_180078F1C(__int64 a1)
{
  ...
  Heap = (_QWORD *)RtlAllocateHeap((__int64)NtCurrentPeb()->ProcessHeap, (dword_180166080 + 786432) | 8u, 24LL);
  if ( !Heap )
    return RtlReleaseSRWLockExclusive(v1);
  if ( (int)ZwDuplicateObject(-1LL, -2LL, -1LL, &v7, 0, 0) < 0 )
  {
    RtlFreeHeap((__int64)NtCurrentPeb()->ProcessHeap, dword_180166080 + 786432, (__int64)Heap);
    return RtlReleaseSRWLockExclusive(v1);
  }
  Heap[2] = v7;
  v5 = *(_QWORD **)(a1 + 464);
