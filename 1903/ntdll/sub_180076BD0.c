/*
 * XREFs of sub_180076BD0 @ 0x180076BD0
 * Callers:
 ...
 *     sub_180076DC0 @ 0x180076DC0 (sub_180076DC0.c)
...
__int64 __fastcall sub_180076BD0(__int64 a1, __int64 a2)
{
  __int64 v2; // r15
  int v3; // ebx
  ...
  if ( v6 != 0x80000000 )
  {
    ...
    else
    {
      ...
      result = sub_1800F0F8C(a1, &v49[4], &v49[5]);
    }
    if ( (int)result < 0 )
      return result;
    result = v4(v49, v2);
    ...
    while ( 1 )
    {
      while ( 1 )
      {
        result = sub_180050F4C(a1, (__int64)v46);
        ...
        if ( v8 )
        {
          ...
          v44 = v46[0];
          v45 = v19;
          v23 = (*(_DWORD *)(v47 + 20) & 0x40000000) != 0 ? 64 : 4;
          v40 = v23;
        }
        else if ( (v46[2] & 0x80000000LL) != 0 )
        {
          ...
          v44 = v46[0];
          v45 = v19;
          v23 = sub_18004733C((_DWORD *)a1, 0);
          v40 = v23;
        }
        else
        {
          sub_1800F0614(v21, v21, (unsigned int)&v44, (unsigned int)&v45, (__int64)v50, (__int64)&v40);
          v18 = v44;
          v19 = v45;
          v23 = v40;
        }
...
LABEL_70:
      ...
      else
      {
        ...
        {
          sub_1800F0614(v48, v46[0], (unsigned int)&v44, (unsigned int)&v45, (__int64)v50, (__int64)&v40);
          if ( v41 < 4 )
          {
            v18 = v44;
            v19 = v45;
...
LABEL_99:
    ...
    else
    {
      ...
      v49[3] = *(_QWORD *)(v25 + 32);
      LODWORD(v49[4]) = 1;
      HIDWORD(v49[4]) = sub_18004733C((_DWORD *)a1, 0);
    }
    result = v43(v49, v42);
    if ( (int)result < 0 )
      return result;
