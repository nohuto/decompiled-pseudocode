/*
 * XREFs of sub_180100C50 @ 0x180100C50
 * Callers:
 *     sub_18010062C @ 0x18010062C (sub_18010062C.c)
 * Callees:
 *     sub_180079550 @ 0x180079550 (sub_180079550.c)
 */

__int64 __fastcall sub_180100C50(__int64 a1, int a2)
{
  int v4; // edi
  char v5; // r15
  _WORD *v6; // rbx
...
LABEL_12:
    ...
    v11 = *v8;
    v14 = -1;
    if ( (int)sub_180079550(v10, v9, v11, &v14) < 0 )
      goto LABEL_12;
    v12 = v14;
