/*
 * XREFs of sub_180079B64 @ 0x180079B64
 * Callers:
...
__int64 __fastcall sub_180079B64(__int64 a1, __int64 a2)
{
  ...
  result = BYTE1(v7->HeapVirtualAffinity);
  if ( (_DWORD)result != (_DWORD)v6 )
  {
    BYTE1(v7->HeapVirtualAffinity) = v6;
    return result;
  }
  ...
  if ( !result )
  {
    result = sub_180079D10(a1, a2, v16);
