/*
 * XREFs of sub_18006EC08 @ 0x18006EC08
 * Callers:
...
void __fastcall sub_18006EC08(__int64 a1, unsigned __int64 a2)
{
  ULONG_PTR v3; // rdi
  _QWORD *v4; // rsi
  _QWORD *v5; // rbx
              ...
              if ( v8 != (_QWORD *)v3 )
              {
                do
                {
                  ...
                  if ( !*((_DWORD *)v8 - 1) )
                  {
                    ...
                    *v12 = v13;
                    *(_QWORD *)(v13 + 8) = v12;
                    RtlFreeHeap((__int64)NtCurrentPeb()->ProcessHeap, 0, (__int64)(v8 - 1));
                  }
                  v8 = v12;
                }
                while ( v12 != (_QWORD *)v3 );
