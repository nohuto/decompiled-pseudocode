/*
 * XREFs of sub_18005300C @ 0x18005300C
 * Callers:
...
__int64 __fastcall sub_18005300C(
        __int64 a1,
        _OWORD *a2,
        __int16 a3,
        unsigned __int16 a4,
        ...
        __int64 a10)
{
  ...
  *(_DWORD *)(a10 + 128) = 0;
  ...
  if ( (*(_BYTE *)(a1 + 240) & 4) != 0 )
  {
    if ( (unsigned __int8)sub_18010D1A8(4LL, a2, a1, a2) )
    {
      v60 = alloca(2064LL);
      v82 = &v66;
      sub_18010D4AC(&v82, &v71);
    }
    v11 = a2;
    v12 = v75;
  }
...
LABEL_15:
    v23 = 2LL * v81;
    _InterlockedAdd((volatile signed __int32 *)(qword_180163518 + 16LL * v81 + 8), 1u);
    if ( (*(_QWORD *)(qword_180163518 + 8 * v23) & 1) == 0 )
    {
      v83 = *(_QWORD *)(qword_180163518 + 8 * v23);
      v14 = 0;
      v79 = 0;
      goto LABEL_17;
    }
    _InterlockedDecrement((volatile signed __int32 *)(qword_180163518 + 8 * v23 + 8));
LABEL_78:
    v14 = 4201;
    goto LABEL_60;
  }
  v14 = sub_18010D214((unsigned int)v22, &v81);
  v79 = v14;
  if ( !v14 )
  {
    v15 = v77;
...
LABEL_59:
  ...
  {
    if ( ZwQueryInformationToken((HANDLE)0xFFFFFFFFFFFFFFFALL, 1u, TokenInformation, 0x58u, &ReturnLength) >= 0 )
    {
      v61 = ReturnLength - 16;
      ReturnLength = v61;
  ...
  if ( a8 )
  {
    ...
    {
      v32 = v28;
      v33 = v31 ? *(_BYTE *)(16LL * v30 + v84 + 12) : 0;
      if ( v33 )
      {
        if ( v33 == 1 )
        {
...
LABEL_30:
  ...
  if ( v14 )
  {
    _InterlockedDecrement((volatile signed __int32 *)(qword_180163518 + 16 * v22 + 8));
    return v14;
  }
  *(_DWORD *)(v29 + 24) = v28;
  v34 = v83;
  v35 = sub_18005364C(v83, v28, NtCurrentTeb()->CurrentIdealProcessor.Reserved, &v86, &v80);
  v36 = v35;
  if ( v35 )
  {
    *(_QWORD *)v29 = v34;
    ...
    if ( a8 )
    {
      ...
      do
      {
        ...
        if ( v54 )
        {
          if ( v54 == 1 )
          {
            v58 = *((unsigned int *)v49 - 1);
            v59 = (char *)v91;
            memmove(v91, *(const void **)(v49 - 12), v58);
            v91 = &v59[v58];
          }
  ...
  if ( v28 <= 0xFFF8 )
    ...
    v14 = 534;
  _InterlockedDecrement((volatile signed __int32 *)(qword_180163518 + 16LL * v88 + 8));
  return v14;
}
