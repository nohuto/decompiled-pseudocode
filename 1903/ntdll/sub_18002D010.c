/*
 * XREFs of sub_18002D010 @ 0x18002D010
 * Callers:
...
__int64 __fastcall sub_18002D010(__int64 a1, __int64 a2)
{
  _WORD *v4; // rcx
  ...
  _DWORD *v23; // rcx
  __int64 v24; // rdi
  _DWORD v25[72]; // [rsp+20h] [rbp-168h] BYREF

  memset(v25, 0, 0x11CuLL);
...
LABEL_5:
  ...
  v9 = LOWORD(v25[1]) == v7;
LABEL_37:
  if ( !v8 && (!v9 || LOWORD(v25[2]) >= *v4) )
    goto LABEL_5;
LABEL_6:
  if ( v6 == -1 )
    v10 = (char *)&unk_180118270;
  else
    v10 = (char *)&unk_180118270 + 32 * v6;
  v11 = *(_DWORD **)(a2 + 24);
  v12 = 0LL;
  if ( !*v11 )
    return 1LL;
    ...
    if ( v13 )
    {
      ...
      if ( v14 )
      {
        while ( 2 )
        {
          ...
          do
          {
            v18 = *(_QWORD *)(v13 + 16 * (v17 + v16) + 120) - *(_QWORD *)(v10 + 4);
            if ( !v18 )
              v18 = *(_QWORD *)(v13 + 16 * (v17 + v16) + 128) - *(_QWORD *)(v10 + 12);
            if ( !v18 )
            {
              v19 = (unsigned __int64)(unsigned int)v15 << 7;
              if ( !*(_QWORD *)(v19 + v13 + 80) && *(_DWORD *)(v19 + v13 + 88) == 2 )
                *(_QWORD *)(v19 + v13 + 80) = sub_180110078(*(_QWORD *)(v19 + v13 + 72));
      ...
      if ( (unsigned int)v15 >= v20 )
      {
        ...
        if ( v20 )
        {
          ...
          if ( !*(_QWORD *)(v24 + 80) && *(_DWORD *)(v24 + 88) == 2 )
            *(_QWORD *)(v24 + 80) = sub_180110078(*(_QWORD *)(v24 + 72));
