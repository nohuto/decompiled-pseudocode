/*
 * XREFs of sub_180063920 @ 0x180063920
 * Callers:
...
__int64 __fastcall sub_180063920(__int64 a1, __int64 a2, unsigned int a3, int a4, _DWORD *a5, int a6, char *a7)
{
  int v7; // r14d
  char v10; // r10
  char v11; // cl
