...
BOOLEAN __fastcall sub_180105AFC(PRTL_CRITICAL_SECTION *HeapHandle, int a2, char *a3, ULONG a4, ULONG UserFlagsSet)
{
  BOOLEAN v9; // di
  char v10; // r14
  ULONG v12; // esi
  ...
  if ( ((UserFlagsSet | a4) & 0xFFFFF1FF) != 0 )
    return 0;
  if ( sub_180019C74(HeapHandle, "RtlSetUserFlagsHeap") )
  {
    ...
    if ( sub_1800704A4((unsigned __int64)HeapHandle, v13, "RtlSetUserFlagsHeap") )
    {
