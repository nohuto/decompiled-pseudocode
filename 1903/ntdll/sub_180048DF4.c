/*
 * XREFs of sub_180048DF4 @ 0x180048DF4
 * Callers:
...
__int64 *__fastcall sub_180048DF4(__int64 a1, __int64 a2, __int64 a3, __int64 a4, unsigned __int64 a5, __int64 *a6)
{
  ...
  *(_BYTE *)(v6 + 15) = 3;
  ...
  else
  {
    v11 = ((v6 - a2) >> 16) + 1;
    if ( v11 >= 0xFE )
      sub_18010A694(3, v10, a3 - 16, a2, 0LL, 0LL);
  }
  v12 = dword_180166578 < 1;
  *(_BYTE *)(v6 + 14) = v11;
  if ( v12 )
    goto LABEL_4;
  v13 = a5 == v6;
