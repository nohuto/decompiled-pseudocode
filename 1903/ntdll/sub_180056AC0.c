        ...
        unsigned int *a9)
{
  ...
  if ( (*(_BYTE *)v11 & 1) != 0 )
  {
    ...
    if ( (unsigned int)RtlGetCurrentServiceSessionId() )
      ...
      v43 = 2147353476LL;
    sub_1800E0820(&v71, *(unsigned __int8 *)v43);
  }
  else
  {
    v12 = 2147353476LL;
  ...
  if ( (v10 & 0x10) == 0 )
  {
    ...
    if ( a5 >= 1 && a5 <= 3 )
    {
         ...
         || v37 == 3072) )
      {
        ...
        if ( RCConfig >= 0 )
        {
          v15 = v13 | sub_180018610(v54, (const wchar_t **)v58, v39, v10);
        }
        else
        {
...
LABEL_39:
  ...
  else
  {
    ...
    v19 = v57;
    v18 = v54;
    result = sub_180058950(v54, v57, v47, v35, (__int64)v77);
    ...
    if ( v59 && (~v15 & 0x40000) != 0 )
    {
      ...
      if ( v60 && v21 )
      {
        if ( v66 )
          ...
          LODWORD(v44) = v67;
        MappingSize = sub_180067D14(v56, *v60, v44, *((_DWORD *)v58 + 6), 1);
        v48 = MappingSize;
        if ( MappingSize < 0 )
        {
          *v60 = 0LL;
...
LABEL_37:
      ...
      if ( v51 || v50 || (int)sub_1800549C0(v54) < 0 )
      {
        if ( (v15 & 0x40000) != 0 )
        {
          v17 = 0;
...
LABEL_40:
  if ( (unsigned int)RtlGetCurrentServiceSessionId() )
  {
    v31 = (__int64)NtCurrentPeb()->HotpatchInformation + 555;
    MappingSize = v48;
  }
  if ( (*(_BYTE *)v31 & 1) != 0 )
  {
    ...
    sub_1800E0820(&v75, *(unsigned __int8 *)v12);
  }
