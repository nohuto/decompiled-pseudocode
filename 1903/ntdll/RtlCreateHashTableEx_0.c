...
char __fastcall RtlCreateHashTableEx_0(PVOID *a1, unsigned int a2, int a3, int a4)
{
  unsigned int v4; // esi
  char *Heap; // rbx
  int v10; // eax
  ...
  if ( a2 > 0x80 )
  {
    ...
    if ( v16 )
    {
      ...
      *((_QWORD *)Heap + 4) = v17;
      while ( 1 )
      {
        v19 = sub_18006FB9C((unsigned int)v18);
        if ( !v19 )
          break;
...
LABEL_18:
  ...
  sub_18006FB7C(v11, *((unsigned int *)Heap + 2));
  *((_QWORD *)Heap + 4) = v12;
LABEL_9:
  *a1 = Heap;
  return 1;
