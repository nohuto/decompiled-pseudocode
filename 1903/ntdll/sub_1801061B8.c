      ...
      if ( *(_DWORD *)(a1 + 124) )
      {
        *((_DWORD *)v9 + 2) ^= *(_DWORD *)(a1 + 136);
        if ( *((_BYTE *)v9 + 11) != (*((_BYTE *)v9 + 8) ^ (unsigned __int8)(*((_BYTE *)v9 + 9) ^ *((_BYTE *)v9 + 10))) )
          sub_180101024(a1, (unsigned __int64)(v8 - 2));
      }
      v8 = (_QWORD *)*v8;
...
LABEL_35:
    ...
    if ( byte_1801638C0 && *(_QWORD *)(a1 + 328) && (int)ZwAllocateVirtualMemory() >= 0 )
      v4 = v26 + 1032;
    v10 = 129LL;
    v11 = *(__int64 **)(a1 + 272);
      ...
      while ( 1 )
      {
        if ( *(_DWORD *)(a1 + 124) )
        {
          *((_DWORD *)v11 + 14) ^= *(_DWORD *)(a1 + 136);
          ...
          {
            sub_180101024(a1, (unsigned __int64)(v11 + 6));
            v10 = 129LL;
          }
        }
        if ( v4 )
        ...
        if ( (*((_BYTE *)v11 + 58) & 4) != 0 && !sub_1800F2ED4(a1, (unsigned __int64)(v11 + 6)) )
          break;
        if ( *(_DWORD *)(a1 + 124) )
        {
...
LABEL_74:
              v27 = 0LL;
              sub_180048120(v18, &v26, &v27, 0x8000LL);
              return 1;
            }
            while ( 1 )
            {
    ...
    {
      while ( (unsigned __int8)sub_180106954(
                                 a1,
                                 (int)v17 - 24,
                                 v6,
                                 (unsigned int)&v25,
...
LABEL_37:
    ...
    {
      v27 = 0LL;
      sub_180048120(v14, &v26, &v27, 0x8000LL);
    }
    return 0;
  }
  return 1;
