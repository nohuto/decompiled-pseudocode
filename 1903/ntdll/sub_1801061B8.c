/*
 * XREFs of sub_1801061B8 @ 0x1801061B8
 * Callers:
...
char __fastcall sub_1801061B8(unsigned __int64 a1, char a2)
{
  ...
  v4 = 0LL;
  BaseAddress = 0LL;
  if ( !(unsigned __int8)sub_180106798((void *)a1) )
    goto LABEL_37;
      ...
      if ( *(_DWORD *)(a1 + 124) )
      {
        *(_DWORD *)(v8 + 8) ^= *(_DWORD *)(a1 + 136);
        if ( *(_BYTE *)(v8 + 11) != (*(_BYTE *)(v8 + 8) ^ (unsigned __int8)(*(_BYTE *)(v8 + 9) ^ *(_BYTE *)(v8 + 10))) )
          sub_180101024(a1, (unsigned __int64)(v7 - 2));
      }
      v7 = (_QWORD *)*v7;
      ...
      while ( 1 )
      {
        if ( *(_DWORD *)(a1 + 124) )
        {
          *((_DWORD *)v10 + 14) ^= *(_DWORD *)(a1 + 136);
          ...
          {
            sub_180101024(a1, (unsigned __int64)(v10 + 6));
            v9 = 129LL;
          }
        }
        if ( v4 )
          ...
          if ( v11 )
          {
            if ( (v11 & 0x8000u) == 0 )
            {
              if ( (v11 & 0x800) == 0 && v11 < *(_WORD *)(a1 + 224) )
                *(_QWORD *)&v4[8 * v11] += (unsigned __int64)v10[4] >> 4;
            }
            else
            {
              v12 = v11 & 0x7FFF;
        ...
        if ( (*((_BYTE *)v10 + 58) & 4) != 0 && !sub_1800F2ED4(a1, (unsigned __int64)(v10 + 6)) )
          break;
        if ( *(_DWORD *)(a1 + 124) )
        {
...
LABEL_74:
            RegionSize = 0LL;
            sub_180048120(v16, &BaseAddress, &RegionSize, 0x8000u);
            return 1;
          }
          while ( 1 )
          {
    ...
    {
      while ( (unsigned __int8)sub_180106954(a1, (__int64)&v21, (__int64)&v22, (__int64)v4, (__int64)BaseAddress) )
      {
        v15 = (_QWORD *)*v15;
        if ( v15 == (_QWORD *)(a1 + 288) )
        {
...
LABEL_37:
    ...
    {
      RegionSize = 0LL;
      sub_180048120(v13, &BaseAddress, &RegionSize, 0x8000u);
    }
    return 0;
  }
  return 1;
