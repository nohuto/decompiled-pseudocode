/*
 * XREFs of sub_1800E42B8 @ 0x1800E42B8
 * Callers:
...
__int64 __fastcall sub_1800E42B8(_QWORD *a1, _WORD *a2)
{
  int v3; // r11d
  ...
  sub_18007A238(a1, (__int64)&v13, &v14);
  v3 = v13;
  v4 = v13;
  a2[7] = (v13 + 1) % 7u;
  ...
  {
    v8 = byte_180124000[v7];
    v9 = word_180124178[v8];
  }
  else
  {
    v8 = byte_180123E80[v7];
    v9 = word_180123E48[v8];
  }
  v10 = v14;
  a2[1] = v8 + 1;
  *a2 = v5 + 1601;
