/*
 * XREFs of RtlpConvertAbsoluteToRelativeSecurityAttribute @ 0x1800E7840
 * Callers:
...
__int64 __fastcall RtlpConvertAbsoluteToRelativeSecurityAttribute(__int64 a1, unsigned int *a2, unsigned int *a3)
{
  ...
  if ( (unsigned int)(v7 + 20) < 0x14 )
    return (unsigned int)-1073741675;
  v9 = sub_18000C2B4(*(_WORD **)a1, 0xFFFFuLL, &v34);
  if ( v9 < 0 )
  ...
  if ( v13 > 2u )
  {
    if ( v13 == 3 )
    {
      ...
      if ( *(_DWORD *)(a1 + 16) )
      {
        while ( 1 )
        {
          v9 = sub_18000C2B4(*(_WORD **)(*(_QWORD *)(a1 + 24) + 8LL * v16), 0xFFFFuLL, &v34);
          if ( v9 < 0 )
            return (unsigned int)v9;
          v18 = v34 + 2;
...
LABEL_51:
  ...
  {
    a2[j + 4] = v24;
    v9 = sub_18000C2B4(*(_WORD **)(*(_QWORD *)(a1 + 24) + 8LL * j), 0xFFFFuLL, &v34);
    if ( v9 < 0 )
      break;
    v31 = v34 + 2;
