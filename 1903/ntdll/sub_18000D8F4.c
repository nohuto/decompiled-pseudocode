/*
 * XREFs of sub_18000D8F4 @ 0x18000D8F4
 * Callers:
...
void *__fastcall sub_18000D8F4(__int64 a1, _OWORD *a2, unsigned int a3)
{
  unsigned int v3; // ebx
  _OWORD *v4; // rsi
  unsigned int v5; // eax
  ...
  if ( v3 >= 0x40 )
  {
    ...
    if ( ((unsigned __int8)v4 & 7) != 0 )
    {
      do
      {
        ...
        *(_OWORD *)(a1 + 72) = v4[2];
        *(_OWORD *)(a1 + 88) = v4[3];
        result = (void *)sub_18000D9F8(a1, a1 + 40);
        v4 += 4;
        v3 -= 64;
        --v10;
      }
    ...
    else
    {
      do
      {
        result = (void *)sub_18000D9F8(a1, v4);
        v4 += 4;
        v3 -= 64;
        --v10;
      }
