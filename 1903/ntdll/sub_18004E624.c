/*
 * XREFs of sub_18004E624 @ 0x18004E624
 * Callers:
...
__int64 __fastcall sub_18004E624(__int64 a1, unsigned __int64 a2, __int64 a3, __int64 a4)
{
  int v7; // ebx
  __int64 v8; // r10
  ...
  if ( a4 )
  {
    v7 = sub_18004E6F8(a1, (__int64)a2 / 0x8000, v18, &v19);
    if ( v7 >= 0 )
    {
      v8 = *(_QWORD *)(a1 + 8);
      v9 = a2 >> 6;
