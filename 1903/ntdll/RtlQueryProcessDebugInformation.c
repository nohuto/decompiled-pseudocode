...
__int64 __fastcall RtlQueryProcessDebugInformation(_QWORD *a1, unsigned int a2, __int64 a3)
{
  ...
  *(_QWORD *)(a3 + 72) = 208LL;
  ...
  {
    if ( (a2 & 0x41) == 0 || (LODWORD(v3) = sub_18007533C(v4, a2, a3), !(_DWORD)v3) )
    {
      if ( (a2 & 2) == 0 || (LODWORD(v3) = RtlQueryProcessBackTraceInformation(a3), !(_DWORD)v3) )
      {
        if ( (a2 & 0x20) == 0 || (LODWORD(v3) = RtlQueryProcessLockInformation(a3), !(_DWORD)v3) )
        {
          ...
          {
            if ( (a2 & 0x80u) == 0 || (LODWORD(v3) = sub_1800DA48C(a3), !(_DWORD)v3) )
            {
              if ( (a2 & 0xC00) != 0 )
                LODWORD(v3) = sub_1800D7F2C(a3, a2);
            }
          }
        }
      }
  ...
  if ( ((a2 - 1024) & 0xFFFFFBFF) == 0 )
  {
    ...
    if ( (int)ZwOpenProcess(&v21, 4096LL, &v33, &v27) >= 0 )
    {
      if ( (int)RtlWow64GetProcessMachines(v21, v22, 0LL) >= 0 )
      {
        ...
        {
          LODWORD(v20) = 0;
          if ( (int)ZwDuplicateObject(-1LL, v21, -1LL, &v24, 16, 0) >= 0 )
          {
  ...
  v14 = v23;
  v25 = 0LL;
  result = sub_1800757D8(a3, a1, v23, &v25);
  if ( (int)result >= 0 )
  {
    v15 = v25;
    v16 = v25;
    if ( !v25 )
      v16 = *(_QWORD *)(a3 + 136);
    LODWORD(v3) = sub_1801042F4(v16, &v32);
    v12 = v15;
    if ( (int)v3 >= 0 )
    {
      LODWORD(v3) = sub_180005760(v15, 0LL, 6, 0, 0LL, 0LL, v20, (__int64)v26, *(_QWORD *)(a3 + 16), &v31, 0LL);
      if ( (int)v3 >= 0 )
      {
        v18 = v31;
        LOBYTE(v17) = 1;
      ...
      if ( (a2 & 0x40) != 0 && !*(_QWORD *)(a3 + 96) )
        LODWORD(v3) = -1073741558;
      if ( (int)v3 >= 0 )
        LODWORD(v3) = sub_1800D83A4(a3, a2, a3 + 208, *(_QWORD *)(a3 + 72) - 208LL);
      return (unsigned int)v3;
    }
LABEL_25:
    ZwClose(v12);
