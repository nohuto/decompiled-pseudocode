/*
 * XREFs of RtlQueryProcessDebugInformation @ 0x180075100
 * Callers:
...
NTSTATUS __cdecl RtlQueryProcessDebugInformation(HANDLE UniqueProcessId, ULONG Flags, PRTL_DEBUG_INFORMATION Buffer)
{
  ...
  if ( v9 )
  {
    ...
    else if ( NtCurrentTeb()->ClientId.UniqueProcess != UniqueProcessId )
    {
      ...
      *(_OWORD *)&ObjectAttributes.SecurityDescriptor = 0LL;
      ...
      v10 = ZwOpenProcess(&ProcessHandle, 0x1FFFFFu, &ObjectAttributes, &ClientId);
      v11 = ProcessHandle;
      v4 = v32;
      v32[1] = sub_180079770;
      if ( v10 < 0 )
        v11 = 0LL;
      v32[2] = ZwQueryInformationProcess;
      ProcessHandle = v11;
      v32[0] = v11;
    }
  }
  ...
  {
    if ( (Flags & 0x41) == 0 || (LODWORD(v3) = sub_18007533C(v4, Flags, Buffer), !(_DWORD)v3) )
    {
      if ( (Flags & 2) == 0 || (LODWORD(v3) = RtlQueryProcessBackTraceInformation(Buffer), !(_DWORD)v3) )
      {
        if ( (Flags & 0x20) == 0 || (LODWORD(v3) = RtlQueryProcessLockInformation(Buffer), !(_DWORD)v3) )
        {
          ...
          {
            if ( (Flags & 0x80u) == 0 || (LODWORD(v3) = sub_1800DA48C(Buffer), !(_DWORD)v3) )
            {
              if ( (Flags & 0xC00) != 0 )
                LODWORD(v3) = sub_1800D7F2C(Buffer, Flags);
            }
          }
        }
      }
  ...
  v14 = v22;
  v24 = 0LL;
  result = sub_1800757D8(Buffer, UniqueProcessId, v22, &v24);
  if ( result >= 0 )
  {
    v15 = v24;
    ...
    LODWORD(v3) = sub_1801042F4(TargetProcessHandle, &v30);
    v12 = v15;
    if ( (int)v3 >= 0 )
    {
      LODWORD(v3) = sub_180005760(v15, 0LL, 6, 0, 0LL, 0LL, Options, v25, Buffer->ViewBaseTarget, &Handle, 0LL);
      if ( (int)v3 >= 0 )
      {
        v17 = Handle;
        v18 = ZwWaitForSingleObject(Handle, 1u, &Timeout);
        LODWORD(v3) = v18;
        if ( v18 < 0 )
        {
          ZwTerminateThread(v17, v18);
        }
        else
        {
      ...
      {
        if ( !v14 )
          LODWORD(v3) = sub_1800D7D40(Buffer);
        if ( (int)v3 < 0 )
          return (int)v3;
      }
      ...
      if ( (Flags & 0x40) != 0 && !Buffer->Modules )
        LODWORD(v3) = -1073741558;
      if ( (int)v3 >= 0 )
        LODWORD(v3) = sub_1800D83A4(Buffer, Flags, &Buffer[1], Buffer->OffsetFree - 208);
      return (int)v3;
    }
LABEL_25:
    ZwClose(v12);
