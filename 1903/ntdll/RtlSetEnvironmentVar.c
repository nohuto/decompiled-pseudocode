...
__int64 __fastcall RtlSetEnvironmentVar(__int64 *a1, unsigned __int16 *a2, size_t a3, _WORD *a4, unsigned __int64 a5)
{
  ...
  struct _RTL_USER_PROCESS_PARAMETERS *ProcessParameters; // r13
  char *v14; // rdx
  ...
  __int64 v39; // rbx
  char v40; // bl
  struct _RTL_USER_PROCESS_PARAMETERS *v41; // rax
  char *v42; // r14
  __int16 v43; // ax
  ...
  struct _RTL_USER_PROCESS_PARAMETERS *v60; // [rsp+48h] [rbp-70h]
...
LABEL_83:
    ...
    v45 = (char *)sub_18005D77C(2 * (a5 + ((v17 - v55) >> 1) - v62));
    if ( v45 )
    {
      memmove(v45, v55, 2LL * (unsigned int)((v61 - v55) >> 1));
      v46 = &v45[2 * (unsigned int)((v61 - v55) >> 1)];
      memmove(v46, a4, 2 * a5);
      *(_WORD *)&v46[2 * a5] = 0;
