/*
 * XREFs of sub_18000D9F8 @ 0x18000D9F8
 * Callers:
...
__int64 __fastcall sub_18000D9F8(_DWORD *a1, __int64 a2)
{
  __int64 v3; // rdx
  _QWORD *v4; // rcx
  __int64 v5; // r8
  ...
  if ( v45 )
  {
    ...
    do
    {
      ...
      v79 = dword_180120C30[v70] + (v73 & v93 ^ v64 & ~v73) + (__ROR4__(v73, 6) ^ __ROR4__(v73, 11) ^ __ROR4__(v73, 25));
      ...
      v89 = v73
          + v98[v88]
          + dword_180120C30[(unsigned int)(v80 + 1)]
          + (v12 & v48 ^ v90 & ~v12)
          + (__ROR4__(v12, 6) ^ __ROR4__(v12, 11) ^ __ROR4__(v12, 25));
      v11 = v89 + v76;
