...
__int64 __fastcall sub_1800D02E4(__int64 a1, __int64 a2, int a3, unsigned int a4, void *Src)
{
  size_t v6; // rbp
  __int64 result; // rax
  __int64 v10; // rdi
  ...
  v6 = a4;
  result = RtlAllocateHeap((__int64)NtCurrentPeb()->ProcessHeap, dword_18016542C + 1572864, a4 + 54);
  v10 = result;
  if ( result )
  {
    v11 = 5296;
