...
__int64 sub_1800DD010()
{
  ...
  if ( VirtualMemory >= 0 )
  {
    ...
    *(_DWORD *)(v2 + 520) = v10;
    sub_18006DA5C((unsigned __int64)NtCurrentPeb()->ImageBaseAddress, 0, (__int64)v27);
    *(_DWORD *)(v2 + 532) = v27[0];
    *(_DWORD *)(v2 + 524) = v27[2];
    *(_DWORD *)(v2 + 528) = v27[3];
    ...
    else
    {
      ...
      if ( VirtualMemory >= 0 )
      {
        *v18 += UnicodeString.Length;
        ...
        if ( VirtualMemory >= 0 )
        {
          *(_DWORD *)(v2 + 564) = sub_1800DD510(v25, v24);
