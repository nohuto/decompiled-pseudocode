/*
 * XREFs of sub_1800FEF08 @ 0x1800FEF08
 * Callers:
...
__int64 __fastcall sub_1800FEF08(__int64 a1, unsigned __int16 *a2)
{
  int v3; // edx
  int v5; // ebx
  _WORD *v6; // rdi
  ...
  v3 = a2[1] >> 14;
  v17 = -1;
  v5 = sub_1800162BC(a1, v3, *a2, (__int16 *)&i);
  if ( v5 >= 0 )
  {
    ...
    else
    {
      ...
      while ( 1 )
      {
        ...
        for ( i = a2[v7 + 3]; ; v12 = i )
        {
          v13 = (v6[4] >> v11) & 3;
          v19 = 0LL;
          if ( sub_1800FD708(a1, v9, v12, v13, v6[v10 + 6], (__int64 *)&v19, &v17) )
          {
