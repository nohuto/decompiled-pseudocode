...
bool __fastcall sub_18005A624(__int64 a1)
{
  bool v1; // di
  char v2; // si
  __int64 v3; // rbx
  ...
  if ( RtlDosPathNameToRelativeNtPathName_U(a1, (int)&v17, 0LL, (__int64)&v18) )
  {
    ...
    {
      v2 = 1;
      if ( (int)ZwCreateSection(&v12, 983045LL, 0LL) >= 0 )
      {
        v11 = 0LL;
        v15 = 0LL;
        ...
        if ( v6 >= 0 )
        {
          if ( RtlImageNtHeader(v9) )
          {
            ...
            v7 = v9 | 1;
            v26[2] = 0LL;
            if ( (int)sub_180018D8C(v9 | 1, (__int64)v26, 3u, 0x30u, (unsigned __int64 *)&v16) >= 0
