/*
 * XREFs of sub_18006F7C4 @ 0x18006F7C4
 * Callers:
...
__int64 __fastcall sub_18006F7C4(__int64 a1, int a2, unsigned int a3)
{
  __int64 v3; // rbx
  unsigned int v6; // ebp
  unsigned int v7; // ecx
  ...
  while ( 1 )
  {
    v9 = ((__int64 (__fastcall *)(__int64, _QWORD, _QWORD, char *, unsigned int *))(a1 ^ qword_180163540 ^ *(_QWORD *)(a1 + 136)))(
           a1 ^ *(_QWORD *)(a1 + 128),
           (unsigned int)v3,
           a3,
           &v16,
  ...
  if ( (v16 & 1) != 0 )
    v10 = v3;
  if ( ((int (__fastcall *)(__int64, __int64, _QWORD))(a1 ^ qword_180163540 ^ *(_QWORD *)(a1 + 152)))(
         a1 ^ *(_QWORD *)(a1 + 128),
         v9,
         v10) >= 0 )
  {
    ...
    *(_WORD *)(v9 + 52) = 0;
    v8 = v9;
    *(_WORD *)(v9 + 50) = v12;
    *(_QWORD *)(v9 + 48) ^= (v9 + 48) ^ qword_180163540;
    return v8;
  }
LABEL_20:
  if ( v9 )
    ((void (__fastcall *)(__int64, __int64, _QWORD, _QWORD))(a1 ^ qword_180163540 ^ *(_QWORD *)(a1 + 144)))(
      a1 ^ *(_QWORD *)(a1 + 128),
      v9,
      (unsigned int)v3,
      a3);
