/*
 * XREFs of sub_180089DB0 @ 0x180089DB0
 * Callers:
 *     RtlCreateUserProcessEx @ 0x180089CF0 (RtlCreateUserProcessEx.c)
 *     RtlCloneUserProcess @ 0x1800D6770 (RtlCloneUserProcess.c)
 * Callees:
 *     __security_check_cookie @ 0x18008C7B0 (__security_check_cookie.c)
 *     ZwCreateUserProcess @ 0x18009DF50 (ZwCreateUserProcess.c)
 *     memset @ 0x1800A3600 (memset.c)
 */

__int64 __fastcall sub_180089DB0(unsigned __int16 *a1, __int64 a2, int a3, int a4, __int64 a5, _DWORD *a6)
{
  ...
  *a6 = 104;
  ...
  v40 = 32LL * v10 + 8;
  return ZwCreateUserProcess(a6 + 2, a6 + 4, 0x2000000LL, 0x2000000LL, &v33, &v27, a3, a4, a2, v39, &v40);
}
