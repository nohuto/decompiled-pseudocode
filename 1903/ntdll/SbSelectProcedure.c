        ...
        if ( v19 )
        {
          ...
          if ( v20 )
          {
            if ( *((_DWORD *)v20 + 12) && *((_DWORD *)v20 + 3) )
            {
              ...
              if ( v30 )
                goto LABEL_46;
              if ( !(unsigned int)EtwEventRegister((int)&unk_180120560, 0LL, 0LL, (__int64)&v41) )
              {
...
LABEL_46:
                  ...
                  v39 = 2 * (v15 + 1);
                  v45[9] = v39;
                  EtwEventWrite(v30, &unk_180120580, 5LL, v45);
                }
              }
            }
          }
    ...
    {
      if ( (unsigned int)EtwEventRegister((int)&unk_180120560, 0LL, 0LL, (__int64)&v40) )
      {
LABEL_39:
        v15 = -1LL;
        goto LABEL_16;
      ...
      else
      {
        ...
        sub_18010FDD8(v40, (_DWORD)v17 + 48, 0, v23->ImagePathName.Length, (__int64)v23->ImagePathName.Buffer);
        v22 = v42;
      }
    }
    if ( v22 )
    {
      ...
      v37 = v29;
      v44[9] = v29;
      EtwEventWrite(v22, &unk_180120570, 5LL, v44);
    }
    goto LABEL_39;
  }
  return 0LL;
