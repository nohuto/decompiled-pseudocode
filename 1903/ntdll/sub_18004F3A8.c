...
void __fastcall sub_18004F3A8(_RTL_SRWLOCK *a1, __int64 a2, __int64 a3)
{
  __int64 v3; // rdi
  _QWORD *v6; // r15
  _QWORD *i; // r14
  ...
  if ( (*(_BYTE *)a2 & 1) != 0 )
  {
    ...
    if ( v14 )
    {
      ...
      do
      {
        sub_18004F3A8(a1, *(_QWORD *)(v3 + *(_QWORD *)(a2 + 96)), a3);
        a3 = v22;
        v3 += 8LL;
        --v15;
      }
        ...
        do
        {
          ...
          if ( (_DWORD)v17 )
          {
            if ( v10 )
            {
              ...
              v19 = (_DWORD)v11 << v18;
              v20 = (_DWORD)v17 << v18;
              ((void (__fastcall *)(PVOID, char *, _QWORD))((unsigned __int64)a1 ^ qword_180163540 ^ (__int64)a1[4].Ptr))(
                a1->Ptr,
                (char *)i + (unsigned int)((_DWORD)v11 << v18),
                (unsigned int)((_DWORD)v17 << v18));
              sub_18004F5D0(a1, i, v19, v20);
              LODWORD(v11) = v17 + v11;
            }
            else
            {
