/*
 * XREFs of sub_18004F3A8 @ 0x18004F3A8
 * Callers:
...
_QWORD *__fastcall sub_18004F3A8(__int64 a1, unsigned __int64 a2, unsigned __int64 a3, unsigned __int64 a4)
{
  __int64 v4; // rdi
  _QWORD *v7; // r15
  ...
  if ( (*(_BYTE *)a2 & 1) != 0 )
  {
    ...
    if ( v17 )
    {
      ...
      do
      {
        sub_18004F3A8(a1, *(_QWORD *)(v4 + *(_QWORD *)(a2 + 96)), a3);
        a3 = v25;
        v4 += 8LL;
        --v18;
      }
        ...
        do
        {
          ...
          if ( (_DWORD)v20 )
          {
            if ( v12 )
            {
              ...
              v22 = (_DWORD)v13 << v21;
              v23 = (_DWORD)v20 << v21;
              ((void (__fastcall *)(_QWORD, char *, _QWORD))(a1 ^ qword_180163540 ^ *(_QWORD *)(a1 + 32)))(
                *(_QWORD *)a1,
                (char *)i + (unsigned int)((_DWORD)v13 << v21),
                (unsigned int)((_DWORD)v20 << v21));
              sub_18004F5D0(a1, i, v22, v23);
              LODWORD(v13) = v20 + v13;
            }
            else
            {
