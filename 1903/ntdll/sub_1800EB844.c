/*
 * XREFs of sub_1800EB844 @ 0x1800EB844
 * Callers:
...
__int64 __fastcall sub_1800EB844(__int64 a1, __int64 a2, __int64 a3, __int16 *a4)
{
  unsigned int v4; // ebx
  __int64 v7; // r11
  int v9; // ebp
  ...
  if ( !a2 || !a3 || !a4 )
    return 3221225485LL;
  *a4 = -1;
  if ( (int)sub_1800ED4B0(a1, v13, &v14) < 0 )
    return 3221225701LL;
  ...
  {
    v12 = *(_QWORD *)(v7 + 8);
    while ( !(unsigned __int8)sub_1800EC73C(a2, v13[0], v14, v12 + 12LL * v10) )
    {
      if ( ++v10 >= v9 )
      {
        v11 = -1;
