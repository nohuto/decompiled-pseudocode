/*
 * XREFs of sub_18005108C @ 0x18005108C
 * Callers:
...
__int64 __fastcall sub_18005108C(__int64 *a1, __int64 a2, char a3)
{
  unsigned int v3; // ebx
  __int64 v4; // rsi
  __int64 *v5; // r14
...
LABEL_17:
      ...
      if ( v20 == 8 )
      {
        v23 = sub_1800019C8(v5[3], v21, v21, v24, &v25, (__int64)&v26);
        *(_QWORD *)v4 = v23;
        if ( v23 )
        {
          sub_180051304((_DWORD)v5, v4, v24[0], v25, v26);
          v13 = 0x8000;
          goto LABEL_11;
        }
      }
      ...
      {
        v22 = sub_180051668(v5[4], v21, v21, (unsigned int)v24, (__int64)&v25, (__int64)&v26);
        *(_QWORD *)v4 = v22;
        if ( v22 )
        {
          sub_180051304((_DWORD)v5, v4, v24[0], v25, v26);
...
LABEL_6:
  ...
  if ( (*(_BYTE *)(v9 + 24) & 0xC) == 8 )
    v12 = sub_1800019C8(v5[3], v10, v11, v24, &v25, (__int64)&v26);
  else
    v12 = sub_180051668(v5[4], v10, v11, (unsigned int)v24, (__int64)&v25, (__int64)&v26);
  *(_QWORD *)v4 = v12;
  if ( !v12 )
    goto LABEL_16;
  sub_180051304((_DWORD)v5, v4, v24[0], v25, v26);
