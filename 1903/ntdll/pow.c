...
LABEL_91:
            ...
            if ( (v38 & qword_18015FFB8) != 0 )
              v62 = dword_18015FF60;
            *(_QWORD *)&X = sub_180095810(v65, Y, *(double *)&v38, v62).m128_u64[0];
            return X;
          }
          ...
          if ( *(_QWORD *)&v33 != qword_180160090 )
          {
            if ( v31 )
            {
              ...
              else
              {
                ...
                *(_QWORD *)&X = sub_180095810(v65, Y, *(double *)&v37, dword_18015FF5C).m128_u64[0];
              }
            }
            else
            {
      ...
      if ( (*(_QWORD *)&X & qword_18015FF90) != qword_18015FF90 )
      {
        if ( (*(_QWORD *)&X & qword_18015FFB8) != 0 )
        {
          if ( *(_QWORD *)&X != qword_18015FFE8 )
          {
            ...
            v57 = Y;
LABEL_99:
            *(_QWORD *)&X = sub_180095810(X, Y, v57, dword_18015FF4C).m128_u64[0];
            return X;
          }
LABEL_50:
          v56 = 0.0;
...
LABEL_62:
        ...
        *(_QWORD *)&X = sub_180095810(X, Y, COERCE_DOUBLE(v58 | v67), dword_18015FF44).m128_u64[0];
        return X;
      }
      goto LABEL_71;
    }
...
LABEL_71:
    ...
    if ( (*(_QWORD *)&X & qword_18015FF90) != qword_18015FF90 )
    {
      if ( *(_QWORD *)&X != qword_18015FFF0 )
      {
        *(_QWORD *)&X = sub_180095810(X, Y, *(double *)&qword_18015FFD0, dword_18015FF54).m128_u64[0];
        return X;
      }
      goto LABEL_62;
    }
...
LABEL_95:
    ...
    if ( (*(_QWORD *)&v63 & qword_18015FFC0) != 0 )
    {
      ...
      *(_QWORD *)&X = sub_180095810(X, Y, v55, dword_18015FF50).m128_u64[0];
    }
    else
    {
      *(_QWORD *)&X = sub_180095810(X, Y, v55, dword_18015FF48).m128_u64[0];
    }
  }
  return X;
}
