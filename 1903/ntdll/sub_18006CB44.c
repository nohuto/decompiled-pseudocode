/*
 * XREFs of sub_18006CB44 @ 0x18006CB44
 * Callers:
 *     SbSelectProcedure @ 0x18002CE20 (SbSelectProcedure.c)
 * Callees:
 *     sub_18006CCB4 @ 0x18006CCB4 (sub_18006CCB4.c)
 *     sub_18006CCF0 @ 0x18006CCF0 (sub_18006CCF0.c)
 *     __security_check_cookie @ 0x18008C7B0 (__security_check_cookie.c)
 *     sub_180110078 @ 0x180110078 (sub_180110078.c)
 */

__int64 __fastcall sub_18006CB44(__int64 a1, __int64 a2, __int64 a3, unsigned int a4)
{
  __int64 v4; // rbp
  _DWORD *v7; // rax
  __int64 i; // r15
  ...
  v4 = a3;
  if ( !(unsigned int)sub_18006CCF0(a4, v27, &v26) )
    return 0LL;
  v7 = *(_DWORD **)(a2 + 24);
...
LABEL_6:
        ...
        if ( !*(_QWORD *)(v21 + v9 + 80) && *(_DWORD *)(v21 + v9 + 88) == 2 )
          *(_QWORD *)(v21 + v9 + 80) = sub_180110078(*(_QWORD *)(v21 + v9 + 72));
...
LABEL_7:
      ...
      if ( v10 >= v12 )
      {
        ...
        if ( v12 )
        {
          while ( (unsigned int)sub_18006CCB4(v27, v9 + ((unsigned __int64)v13 << 7) + 72) != 1 )
          {
            if ( ++v13 >= v14 )
              goto LABEL_14;
          }
          ...
          if ( !*(_QWORD *)(v15 + v9 + 80) && *(_DWORD *)(v15 + v9 + 88) == 2 )
            *(_QWORD *)(v15 + v9 + 80) = sub_180110078(*(_QWORD *)(v15 + v9 + 72));
        ...
        if ( v13 >= v16 )
        {
          ...
          if ( v16 )
          {
            ...
            if ( !*(_QWORD *)(v20 + v9 + 80) && *(_DWORD *)(v20 + v9 + 88) == 2 )
              *(_QWORD *)(v20 + v9 + 80) = sub_180110078(*(_QWORD *)(v20 + v9 + 72));
