...
__int64 __fastcall sub_180022698(unsigned __int16 *a1, unsigned __int16 *a2, int a3, __int64 a4, _DWORD *a5)
{
  ...
  for ( j = (unsigned __int16 *)*((_QWORD *)v8 + 1); v10; v9 = v12 + 65599 * v9 )
  {
    ...
    if ( v12 >= 0x61u )
    {
      if ( v12 > 0x7Au )
      {
        if ( qword_180166510 && v12 >= 0xC0u )
          v12 += *(_WORD *)(qword_180166510
                          + 2LL
                          * ((v12 & 0xF)
                           + (unsigned int)*(unsigned __int16 *)(qword_180166510
                                                               + 2LL
                                                               * (((v12 >> 4) & 0xF)
                                                                + (unsigned int)*(unsigned __int16 *)(qword_180166510 + 2 * ((unsigned __int64)v12 >> 8))))));
      }
      else
      {
        v12 -= 32;
...
LABEL_32:
  ...
  v13 = sub_18002284C((_DWORD)v8, (_DWORD)a2, a3, a4, v9);
  if ( v13 >= 0 && a5 )
  ...
  if ( a2 )
  {
    if ( (unsigned int)RtlGetCurrentServiceSessionId() )
      v16 = (__int64)NtCurrentPeb()->HotpatchInformation + 554;
    else
      v16 = 2147353476LL;
...
LABEL_47:
        ...
        sub_1800CFA48(5280, 0, 0, v22, v25, 0LL);
      }
    }
  }
  else
