...
char __fastcall sub_180046728(unsigned __int64 a1, __int64 a2, __int64 a3, char a4, char a5, __int16 a6, __int64 a7)
{
  int v7; // r13d
  ...
  *(_WORD *)(a3 + 12) = *(_WORD *)(a1 + 140) ^ a6;
  ...
  else
  {
    ...
    if ( v10 >= 0xFE )
      sub_18010A694(3, *(_QWORD *)(a2 + 40), a3, a2, 0LL, 0LL);
  }
  *(_BYTE *)(a3 + 14) = v10;
  *(_BYTE *)(a3 + 11) = 0;
  v11 = a3 + 16 * a7;
      ...
      *(_BYTE *)(a3 + 15) = 0;
      if ( a5 )
      {
        *(_BYTE *)(a3 + 10) &= 0xF0u;
        ...
        v58 = (__int64 *)(a1 + 336);
        if ( *(_QWORD *)(a1 + 312) )
          v59 = sub_1800466AC(a1, (unsigned __int16)a7);
        else
          v59 = (__int64 *)*v58;
        if ( v58 != v59 )
        {
        ...
        {
          sub_18010A694(13, 0, (_DWORD)v59, 0, *v63, 0LL);
        }
...
LABEL_146:
          v70 = v68;
          LOBYTE(v68) = 1;
          sub_180046B74(a1, (_DWORD)v65, v68, a3 + 16, v70, *(unsigned __int16 *)(a3 + 8));
        }
        if ( *(_DWORD *)(a1 + 124) )
        {
      ...
      *(_BYTE *)(a3 + 10) = 0;
      v12 = (__int64 *)(a1 + 336);
      if ( *(_QWORD *)(a1 + 312) )
        v13 = sub_1800466AC(a1, (unsigned __int16)a7);
      else
        v13 = (__int64 *)*v12;
      if ( v12 != v13 )
      {
      ...
      {
        sub_18010A694(13, 0, (_DWORD)v13, 0, *v38, 0LL);
      }
      *(_QWORD *)(a1 + 192) += *(unsigned __int16 *)(a3 + 8);
      v32 = *(__int64 **)(a1 + 312);
      if ( !v32 )
...
LABEL_25:
        LOBYTE(v17) = 1;
        sub_180047014(a1, (_DWORD)v21, v17, v11 + 16, v24, *(unsigned __int16 *)(v11 + 8));
      }
      *v16 = v18;
      *(_QWORD *)(v18 + 8) = v16;
      if ( (*(_BYTE *)(v11 + 10) & 8) == 0 || (unsigned __int8)sub_180047214(a1, a3 + 16 * a7) )
      {
        if ( a5 )
        {
          v43 = *(_BYTE *)(v11 + 10);
        ...
        *(_BYTE *)(a3 + 15) = 0;
        if ( !a5 )
        {
          *(_BYTE *)(a3 + 10) = 0;
          v26 = (__int64 *)(a1 + 336);
          if ( *(_QWORD *)(a1 + 312) )
            v27 = sub_1800466AC(a1, (unsigned __int16)v25);
          else
            v27 = (__int64 *)*v26;
          if ( v26 != v27 )
          {
          ...
          {
            sub_18010A694(13, 0, (_DWORD)v27, 0, *v30, 0LL);
          }
          *(_QWORD *)(a1 + 192) += *(unsigned __int16 *)(a3 + 8);
          v32 = *(__int64 **)(a1 + 312);
          if ( v32 )
...
LABEL_47:
        ...
        *(_BYTE *)(a3 + 10) &= 0xF0u;
        ...
        v48 = (__int64 *)(a1 + 336);
        if ( *(_QWORD *)(a1 + 312) )
          v49 = sub_1800466AC(a1, (unsigned __int16)v25);
        else
          v49 = (__int64 *)*v48;
        if ( v48 != v49 )
        {
        ...
        {
          sub_18010A694(13, 0, (_DWORD)v49, 0, *v53, 0LL);
        }
        *(_QWORD *)(a1 + 192) += *(unsigned __int16 *)(a3 + 8);
        v32 = *(__int64 **)(a1 + 312);
        if ( !v32 )
...
LABEL_46:
        v69 = v36;
        LOBYTE(v36) = 1;
        sub_180046B74(a1, (_DWORD)v32, v36, (_DWORD)v31, v69, v33);
        goto LABEL_47;
      }
      sub_180045188(a1, a3 + 16 * a7, *(unsigned __int16 *)(v11 + 8), 1);
    }
    else
    {
      sub_18010A694(13, a1, v17, v20, v19, 0LL);
    }
    if ( v7 )
      return 0;
    v7 = 1;
