    ...
    else
    {
      ...
      if ( *(_BYTE *)(v9 + 2) )
      {
        do
        {
          ...
          if ( (BYTE1(v86) & 0xF) == 3 )
            break;
          v85 += sub_18008296C(v86, ImageBase);
        }
...
LABEL_6:
  *EstablisherFrame = Rsp;
  ...
  if ( v14 >= 2 )
  {
    ...
    sub_1800FB4F8(v11, v19, v70 - v71, v74, (__int64)v17, (__int64)ContextPointers, 0LL, 0LL);
    return v8;
  }
  v20 = (_BYTE *)ControlPc;
  v21 = 0;
...
LABEL_64:
  ...
  else
  {
    ...
    {
      v80 = sub_18000108C((__int64)FunctionEntry, v11, (void *)(v60 + v11));
      if ( !v80 )
        goto LABEL_60;
      v49 = v60 == *v80;
LABEL_59:
  ...
  while ( 1 )
  {
    ...
    if ( v32 )
    {
      do
      {
        ...
        {
          v81 = sub_18008296C(*(unsigned __int16 *)&v28[2 * (unsigned int)v29 + 4], (unsigned int)v29);
          v27 = v95;
          LODWORD(v29) = v81 + v29;
        }
        else
