        ...
        _WORD *a13)
{
  ...
  if ( (*(_BYTE *)v18 & 1) != 0 )
  {
    if ( RtlGetCurrentServiceSessionId() )
    {
      v81 = (__int64)&NtCurrentPeb()->SharedData->UserModeGlobalLogger[2];
      v91 = v87;
    }
    else
    {
    ...
    sub_1800E0820(v118, *(unsigned __int8 *)v81);
  }
  if ( !v13 )
    return 3221225485LL;
  if ( !v106 )
  ...
  while ( 2 )
  {
    ...
    while ( 1 )
    {
      ...
      if ( !(v36 >> 1) )
      {
        ...
        if ( v36 )
        {
          result = sub_1800585E0(v104, Handle, v92, v89, v95, v33, v20, &v100, v82);
          v82 = result;
          if ( (int)result < 0 )
            return result;
          if ( v100 )
      ...
      v48 = &v33[2 * v47];
      v112 = v48;
      result = sub_1800585E0(v104, Handle, v92, v89, v95, v48, v20, &v100, v82);
      v82 = result;
      if ( (int)result < 0 )
        return result;
      if ( !v100 )
    ...
    if ( (v16 & 1) != 0 || v96 == 34816 )
    {
      ...
      if ( v21 )
      {
        if ( v65 + v51 < v51 )
          goto LABEL_186;
        v84 = v65 + v51;
        if ( (int)sub_180058928(v84, v13, &v84, v19) < 0 )
          goto LABEL_185;
        v64 = v106;
      }
      v52 = v51 + v66 - v13;
      v116 = v52;
      v67 = sub_1800592B0((unsigned int)v16 & 0xFFFFFFFC, v14, v64, v111, v65, v85);
      if ( !v67 )
        goto LABEL_211;
      if ( v96 == 34816 )
      {
      ...
      if ( *v25 > *(_DWORD *)(v67 + 8) )
      {
        ...
        v69 = sub_1800592B0((unsigned int)v16 & 0xFFFFFFFC, v92, v106, v111, *v25, v85);
        if ( !v69 )
          goto LABEL_211;
        v70 = *(unsigned int *)(v69 + 12);
        v71 = sub_1800592B0((unsigned int)v16 & 0xFFFFFFFC, v92, v106, v111, *(_DWORD *)(v69 + 12), v85);
        v72 = v71;
        v53 = -1073741675;
        if ( v71 )
        {
        ...
        if ( v21
          && ((int)sub_180058928(*(unsigned int *)(v72 + 12), v68, &v84, v19) < 0
           || (int)sub_180058928(v84, v76 - v95, &v84, v77) < 0) )
        {
          goto LABEL_185;
        }
...
LABEL_121:
    ...
    if ( (int)sub_180058928(*v25, v52, &v84, v19) < 0 )
      goto LABEL_185;
    v55 = v84;
    if ( v84 >= v13 - v16 )
    {
...
LABEL_51:
  ...
  if ( (*(_BYTE *)v42 & 1) != 0 )
  {
    if ( RtlGetCurrentServiceSessionId() )
      ...
      v43 = 2147353476LL;
    sub_1800E0820(&v120, *(unsigned __int8 *)v43);
  }
  return v83;
}
