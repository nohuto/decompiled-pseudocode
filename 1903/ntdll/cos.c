/*
 * XREFs of cos @ 0x18008F550
 * Callers:
 *     <none>
 * Callees:
 *     sub_18008FD8C @ 0x18008FD8C (sub_18008FD8C.c)
  ...
  if ( (*(_QWORD *)&X & 0x7FFFFFFFFFFFFFFFuLL) > 0x3FE921FB54442D18LL )
  {
    if ( (*(_QWORD *)&X & 0x7FF0000000000000LL) == 0x7FF0000000000000LL )
    {
      ...
      if ( (*(_QWORD *)&X & 0xFFFFFFFFFFFFFLL) != 0 )
        sub_1800946BC((unsigned int)"cos", 18, LODWORD(X), 1, 0, 33, *(__int64 *)&v1, 0LL, 1);
      else
        sub_1800946BC((unsigned int)"cos", 18, 0, 1, 8, 33, *(__int64 *)&v1, 0LL, 1);
      return result;
    }
    if ( v3 != *(_QWORD *)&X )
      v1 = -X;
    if ( v1 >= 500000.0 )
    {
      sub_1800947EC(0x7FF0000000000000LL, &v22, &v23, &v20);
      v15 = v20;
      v16 = v22;
      v17 = v23;
    }
    ...
    v18 = v15 - 1;
    if ( !v18 )
      return -((double (*)(void))sub_18008FD8C)();
    v19 = v18 - 1;
    if ( !v19 )
