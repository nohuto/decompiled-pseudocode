...
bool __fastcall sub_1800F20B8(unsigned __int16 *a1, unsigned __int64 a2, int a3)
{
  int v6; // eax
  ...
  else
  {
    ...
    if ( !*(_DWORD *)(v14 + 88) )
      return 1;
    v10 = sub_1800F2088(0, a1, (unsigned __int64)(v14 - (_QWORD)a1 + 88) >> 1);
    v12 = sub_1800F2088(v10, (unsigned __int16 *)(v8 + 92), (a2 - v11 - 4) >> 1);
    v7 = v12;
    if ( (a2 & 1) != 0 )
