/*
 * XREFs of sub_1800019C8 @ 0x1800019C8
 * Callers:
 *     sub_18005108C @ 0x18005108C (sub_18005108C.c)
 * Callees:
 *     sub_180001C3C @ 0x180001C3C (sub_180001C3C.c)
 *     RtlAcquireSRWLockShared @ 0x18001A940 (RtlAcquireSRWLockShared.c)
 *     RtlReleaseSRWLockShared @ 0x18001AAF0 (RtlReleaseSRWLockShared.c)
 */

__int64 __fastcall sub_1800019C8(__int64 a1, __int64 a2, __int64 a3, _QWORD *a4, _DWORD *a5, __int64 a6)
{
  int v7; // r10d
  int v8; // eax
  unsigned int v9; // r9d
  ...
  else
  {
    ...
    v11 = *(_QWORD *)(a1 + 8LL * byte_180120E60[(unsigned __int64)((unsigned int)(unsigned __int16)v8 + 15) >> 4] + 128);
    v12 = v7 - HIWORD(v8) - a2;
    v13 = *(_DWORD *)(v11 + 72);
    v14 = *(_BYTE *)(v11 + 76);
    if ( v13 )
...
LABEL_19:
    ...
    if ( (_DWORD)v28 != -1 )
    {
      v32 = sub_180001C3C(a2, v30, v26, a6);
      *a4 = v32;
