...
NTSTATUS __fastcall sub_180069E84(HANDLE TokenHandle, ULONG a2, __int64 a3, _QWORD *a4, _QWORD *a5)
{
  _QWORD *v5; // rbx
  ...
  {
    *v5 |= (2LL * v9) | 1;
    if ( ZwQuerySecurityAttributesToken(TokenHandle, (PUNICODE_STRING)&stru_180118460, 1u, 0LL, 0, &ReturnLength) == -1073741789 )
      *v5 |= 4uLL;
  }
  return 0;
}
