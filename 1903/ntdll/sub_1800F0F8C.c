/*
 * XREFs of sub_1800F0F8C @ 0x1800F0F8C
 * Callers:
 *     sub_180076BD0 @ 0x180076BD0 (sub_180076BD0.c)
 *     sub_1800F0A70 @ 0x1800F0A70 (sub_1800F0A70.c)
 * Callees:
 *     sub_1801076C8 @ 0x1801076C8 (sub_1801076C8.c)
 */

__int64 __fastcall sub_1800F0F8C(__int64 a1, _QWORD *a2, _QWORD *a3)
{
  _QWORD *v4; // r8
