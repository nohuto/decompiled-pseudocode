...
unsigned __int64 __fastcall sub_18003F9C0(unsigned __int64 a1, unsigned __int64 *a2)
{
  ...
  __int64 *v66; // rax
  __int64 *v67; // rax
  __int64 v68; // [rsp+70h] [rbp+8h] BYREF
  unsigned __int64 *v69; // [rsp+78h] [rbp+10h]
...
LABEL_5:
  ...
  {
    v12 = ((__int64 (__fastcall *)(unsigned __int64, __int64 *, unsigned __int64 *))(qword_180166970 ^ *(_QWORD *)(a1 + 360)))(
            a1,
            &v68,
            v2);
  }
  ...
  {
    v58 = *v2;
    if ( v7[5] - *v2 <= 16LL * *(_QWORD *)(a1 + 176) && v7[5] < 16 * (unsigned __int64)*(unsigned int *)(a1 + 148) )
      v58 = v7[5];
    *v2 = (v58 + 4095) & 0xFFFFFFFFFFFFF000uLL;
    v59 = sub_18004733C(a1, 1LL);
    if ( (unsigned int)sub_180047C74(*v2, *(_QWORD *)(a1 + 576) - *(_QWORD *)(a1 + 664), a1, a1 + 376) )
      v12 = ZwAllocateVirtualMemory(-1LL, &v68, 0LL, v2, 4096, v59);
    else
      v12 = -1073741523;
    ++*(_DWORD *)(a1 + 624);
  }
  ...
  *(_BYTE *)(v10 + 15) = 0;
  ...
  {
    sub_18010A694(13, 0, (_DWORD)v17, v20, v21, 0LL);
  }
  v22 = v7[5];
  if ( v22 )
  {
...
LABEL_81:
      sub_180047014(a1, (_DWORD)v23, 0, (_DWORD)v7, v61, v7[5]);
    }
    v24 = *v7;
    v25 = (__int64 *)v7[1];
    v26 = *(_QWORD *)(*v7 + 8LL);
    v27 = *v25;
    if ( *v25 == v26 && (_QWORD *)v27 == v7 )
    {
      *v25 = v24;
      *(_QWORD *)(v24 + 8) = v25;
    }
    ...
    {
      sub_18010A694(13, 0, (_DWORD)v7, v26, v27, 0LL);
    }
  }
  --*(_DWORD *)(v11 + 84);
  ...
  *(_QWORD *)(a1 + 576) += v7[5];
  ...
  v29 = *v2;
  if ( v28 > *v2 || v28 + v7[4] == *(_QWORD *)(v11 + 72) )
  {
    v30 = v29 + v7[4];
    v31 = (_QWORD *)(v30 - 48);
    v31[4] = v30;
...
LABEL_53:
  ...
  *(_BYTE *)(v10 + 14) = v51;
  ...
  {
    if ( (unsigned int)RtlGetCurrentServiceSessionId(v53) )
      v13 = (__int64)NtCurrentPeb()->HotpatchInformation + 550;
    sub_1801033C4(a1, v10, *v2, 16 * *(_QWORD *)(a1 + 192), *(unsigned __int8 *)v13);
  }
  v54 = 2147353482LL;
  v55 = NtCurrentPeb()->HotpatchInformation;
  if ( v55 && *v55 )
    v56 = (__int64)NtCurrentPeb()->HotpatchInformation + 560;
  else
    v56 = 2147353482LL;
  if ( *(_BYTE *)v56 )
  {
    if ( (unsigned int)RtlGetCurrentServiceSessionId(v56) )
      v54 = (__int64)NtCurrentPeb()->HotpatchInformation + 560;
    sub_1801033C4(a1, v10, *v2, 16 * *(_QWORD *)(a1 + 192), *(unsigned __int8 *)v54);
  }
  return v10;
}
