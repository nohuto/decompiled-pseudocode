...
ULONG __fastcall sub_1800059B8(__int64 a1, _DWORD *a2, _DWORD *a3, __int64 a4)
{
  ...
  char v33[8]; // [rsp+60h] [rbp-29h] BYREF
  ...
  *(_QWORD *)(a4 + 136) = *(unsigned __int16 *)(a4 + 146) + a4 + 176;
  ...
  if ( !(unsigned int)sub_18000456C(a4 + 144, &v29, v9) )
  {
    _InterlockedDecrement((volatile signed __int32 *)(qword_180163518 + 16LL * *(unsigned int *)(v29 + 20) + 8));
    return 183;
  }
  ...
  if ( !result )
  {
    ...
    SystemInformation = ZwQuerySystemInformation(0LL, v33, 64LL, 0LL);
    if ( SystemInformation < 0 )
      return RtlNtStatusToDosError(SystemInformation);
    *(_DWORD *)(v15 + 208) = ~(v34 - 1) & (*(_DWORD *)(v15 + 208) + v34 - 1);
    ...
    {
      v17 = sub_180004BA8(v15, v7, v8, (*(_DWORD *)(v15 + 324) & 4) != 0);
      if ( v17 )
      {
    ...
    v18 = *(unsigned int *)(v15 + 208);
    v19 = 0xFFFF;
    if ( (unsigned __int64)(v18 - 72) < 0xFFFF )
      v19 = v18 - 72;
    *(_DWORD *)(v15 + 212) = v19 & 0xFFFFFFF8;
    LastErrorValue = sub_180005400(v15);
    if ( LastErrorValue )
      goto LABEL_60;
    if ( (*(_DWORD *)(v15 + 324) & 0x20000) == 0 )
    {
      LastErrorValue = sub_18010D834(*(unsigned __int16 *)(v15 + 20), &v31, &v28);
      if ( LastErrorValue )
        goto LABEL_60;
      *(_QWORD *)(v15 + 560) = v31;
    }
    ...
    if ( (*(_DWORD *)(v15 + 324) & 0x400) == 0 )
    {
      EtwThread = EtwpCreateEtwThread((__int64)sub_18006CF40, v29);
      if ( !EtwThread )
      {
        LastErrorValue = NtCurrentTeb()->LastErrorValue;
        goto LABEL_28;
      }
      *(_QWORD *)(v22 + 32) = EtwThread;
    }
    sub_1800058F4(a4, v22, &v28);
    _InterlockedExchange64((volatile __int64 *)(qword_180163518 + 8 * v21), v22);
