...
__int64 __fastcall sub_180107294(__int64 a1, __int64 a2, __int64 a3, __int64 a4)
{
  __int64 result; // rax
  _BYTE v5[32]; // [rsp+30h] [rbp-38h] BYREF

  if ( (unsigned int)dword_18015F5C8 > 5 )
    return sub_18008935C((__int64)&dword_18015F5C8, byte_18012BE1E, a3, a4, 2, (__int64)v5);
  return result;
}
