/*
 * XREFs of sub_18004580C @ 0x18004580C
 * Callers:
...
void __fastcall sub_18004580C(unsigned __int64 a1, __int64 a2, unsigned __int64 a3)
{
  __int16 v3; // di
  ...
  if ( a3 )
  {
    ...
    v4 = a3;
    v5 = a2;
    if ( !v3 && dword_180166578 >= 1 && (*(_BYTE *)(a2 + 10) & 8) == 0 && ((a2 + 4095) & 0xFFFFFFFFFFFFF000uLL) != a2 )
    {
      if ( NtCurrentPeb()->Ldr )
    ...
    while ( 1 )
    {
      ...
      *(_WORD *)(v5 + 12) = v3 ^ *(_WORD *)(a1 + 140);
      ...
      else
      {
        ...
        if ( ((v5 - v8) >> 16) + 1 >= 0xFE )
          sub_18010A694(3, v13, v5, v8, 0LL, 0LL);
      }
      *(_BYTE *)(v5 + 10) &= 0xF0u;
      *(_BYTE *)(v5 + 14) = v14;
      *(_WORD *)(v5 + 8) = v11;
      ...
      *(_BYTE *)(v5 + 15) = 0;
      ...
      if ( *(_QWORD *)(a1 + 312) )
        v15 = (_QWORD *)sub_1800466AC(a1, v11);
      else
        v15 = (_QWORD *)*v10;
      if ( v10 != v15 )
      {
      ...
      {
        sub_18010A694(13, 0, (_DWORD)v15, 0, *v18, 0LL);
      }
...
LABEL_29:
        LOBYTE(v15) = 1;
        sub_180046B74(a1, (_DWORD)v20, (_DWORD)v15, v5 + 16, v23, *(unsigned __int16 *)(v5 + 8));
      }
      if ( *(_DWORD *)(a1 + 124) )
      {
