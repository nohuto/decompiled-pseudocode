...
NTSTATUS __fastcall sub_18010BA90(PVOID *BaseAddress, void *a2, __int64 a3, int a4)
{
  ...
  *((_BYTE *)BaseAddress + 48) = a4 != 0;
  ...
  if ( ((v6 >> 12) + 7) >> 3 > v7 )
    return -2147483643;
  RegionSize = v6 + v5;
  result = sub_180047BA0(BaseAddress + 1, &RegionSize, 0LL, 1056768, 4u, v12, v14, 0LL);
  if ( result >= 0 )
  {
    ...
    *BaseAddress = v10;
    if ( v11 )
    {
      result = sub_180047BA0(BaseAddress, &v17, 0LL, 1073745920, 4u, v13, v15, 0LL);
      if ( result < 0 )
        return result;
