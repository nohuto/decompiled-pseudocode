/*
 * XREFs of RtlCutoverTimeToSystemTime @ 0x18005DC20
 * Callers:
 *     <none>
 * Callees:
 *     RtlpTimeFieldsToTime @ 0x18005DDF0 (RtlpTimeFieldsToTime.c)
 *     RtlpTimeToTimeFields @ 0x18005E110 (RtlpTimeToTimeFields.c)
 */
        ...
        BOOLEAN ThisYear)
{
  ...
  LONGLONG v18; // [rsp+28h] [rbp-38h] BYREF
  _WORD v19[2]; // [rsp+30h] [rbp-30h] BYREF
  __int16 v20; // [rsp+34h] [rbp-2Ch]
  CSHORT Hour; // [rsp+36h] [rbp-2Ah]
  CSHORT Minute; // [rsp+38h] [rbp-28h]
  CSHORT Second; // [rsp+3Ah] [rbp-26h]
  CSHORT Milliseconds; // [rsp+3Ch] [rbp-24h]
  __int16 v25; // [rsp+3Eh] [rbp-22h]
  __int16 v26; // [rsp+40h] [rbp-20h] BYREF
  CSHORT v27; // [rsp+42h] [rbp-1Eh]
