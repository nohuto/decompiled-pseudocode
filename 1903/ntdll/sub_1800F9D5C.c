 ...
 *     sub_1800F9B28 @ 0x1800F9B28 (sub_1800F9B28.c)
 */

__int64 __fastcall sub_1800F9D5C(__int64 a1, unsigned __int16 *a2, int a3, _BYTE *a4)
{
  int v4; // r15d
  ...
  do
  {
    ...
    while ( 1 )
    {
      while ( 1 )
      {
        ...
        if ( v15 != 1 )
        {
          v16 = *(_BYTE *)((v8 & 0x7F) + (v11 << 7) + *(_QWORD *)(a1 + 40) - 128);
          if ( !v16 )
            goto LABEL_90;
          v17 = v16 & 0xC0;
          v18 = v16 & 0x3F;
...
LABEL_89:
              ...
              case 0xBFu:
                goto LABEL_30;
              case 0xC0u:
                sub_1800F9B28(a1, (__int64)v5, &v34, (unsigned int *)&v30, &v27, &v35);
                if ( (v27 | v35) == 0x80 && (unsigned int)sub_1800F9888(a1, v30, v8) )
                  goto LABEL_30;
                goto LABEL_88;
              case 0xFFu:
                if ( !v8 && v4 <= 1 )
...
LABEL_40:
          if ( (v16 & 0x80) != 0 )
          {
            ...
            if ( !v27 || v27 == 63 )
            {
              ...
              v29 = v27;
              v28 = v35;
              if ( ((v35 - 64) & 0xBF) == 0 && v17 == 0xC0 && (unsigned int)sub_1800F9888(a1, v30, v8) )
                goto LABEL_30;
              goto LABEL_63;
            }
            v20 = v35;
            if ( (v35 & 0xBF) != 0 )
            {
              ...
              {
                v23 = v32;
                if ( (unsigned int)sub_1800F9888(a1, v32, v8) )
                  goto LABEL_30;
                v21 = v28;
              }
...
LABEL_63:
              ...
              {
LABEL_60:
                v24 = sub_1800F9A34(a1, &v33, &v31, v23, v8);
                goto LABEL_61;
              }
              v24 = sub_1800F99E8(a1, &v31, v23, v8);
LABEL_61:
              if ( !v24 )
                goto LABEL_62;
LABEL_30:
            ...
            if ( v35 == 64 )
            {
              if ( (unsigned int)sub_1800F9888(a1, v30, v8) )
                goto LABEL_30;
              v25 = v32;
            }
            if ( v19 <= v18 )
...
LABEL_80:
            ...
            {
LABEL_75:
              v26 = sub_1800F9A34(a1, &v33, &v31, v25, v8);
              goto LABEL_79;
            }
            v26 = sub_1800F99E8(a1, &v31, v25, v8);
LABEL_79:
            if ( v26 )
              goto LABEL_30;
            goto LABEL_80;
...
LABEL_23:
    ...
    if ( *(_BYTE *)(a1 + 112) == 1 || v4 > 1 && sub_1800F90B4(v8, v5[1]) )
      goto LABEL_30;
LABEL_90:
    v35 = 0;
    v27 = 0;
