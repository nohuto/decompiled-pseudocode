...
void __fastcall __noreturn sub_180033CE0(__int64 a1)
{
  ...
  {
    v134 = *(HANDLE *)(a1 + 56);
    v90 = ZwWorkerFactoryWorkerReady(v134);
    if ( v90 >= 0 )
    {
...
LABEL_18:
      ...
      if ( v2 )
        goto LABEL_233;
      sub_18002FFB0((_RTL_SRWLOCK *)a1, (__int64)v135);
      v82 = 1;
      v8 = (_RTL_SRWLOCK *)v99;
      ...
      *Blink = (struct _PEB *)v135;
      ...
      v80 = 1;
      sub_180031620(a1, &v135[14].AlpcSendMessagePort, 0LL);
      while ( 1 )
      {
LABEL_22:
        v89 = 0;
        ...
        {
          v117[3] = dword_180166080 + 3145728;
          Heap = (char *)RtlAllocateHeap(NtCurrentPeb()->ProcessHeap, (dword_180166080 + 3145728) | 8, 0x390uLL);
          if ( !Heap )
          {
LABEL_178:
            Count = 1;
...
LABEL_25:
        ...
        else
        {
          ...
          if ( (unsigned __int8)sub_1800356E0(
                                  (unsigned int)v135,
                                  (_DWORD)MiniPackets,
                                  PacketsReturned,
                                  Count,
...
LABEL_233:
            if ( (v135[11].Flags & 1) != 0 )
            {
              sub_18007EB64(&v135[2].AlpcSendMessagePort, i);
              v135[11].Flags &= ~1u;
            }
            if ( v80 )
            ...
            if ( v82 )
            {
              sub_18007944C(v135, i);
              if ( v83 )
                sub_180078F1C(a1);
            }
            if ( (PVOID)a1 == qword_180166470 )
            {
              sub_18002F2D4((const void **)&qword_180166470, &stru_180166480);
            }
            else if ( a1 == qword_180166458 )
            {
              sub_18002F2D4((const void **)&qword_180166458, &stru_180166468);
            }
            else if ( _InterlockedExchangeAdd((volatile signed __int32 *)a1, 0xFFFFFFFF) == 1 )
            {
              sub_180081630((PVOID)a1);
            }
            sub_18007E820(v109, i);
            sub_18007BD70(BaseAddress);
            sub_18007A798(v135);
            v90 = 0;
            RtlExitUserThread(0);
          }
            ...
            if ( *(_QWORD *)&v135[12].AlpcSendMessageFlags )
            {
              ...
              else
              {
                ...
                if ( RtlGetCurrentServiceSessionId() )
                  v55 = (__int64)&NtCurrentPeb()->SharedData->UserModeGlobalLogger[3];
                else
                  v55 = 2147353478LL;
                if ( *(_BYTE *)v55 )
                  sub_18010F8E0(a1, AlpcSendMessagePort_low, v16, v54, v53);
                if ( v54 != v53 )
                {
                  v138[1] = v53;
                  v138[0] = 0LL;
                  ZwSetInformationThread((HANDLE)0xFFFFFFFFFFFFFFFELL, ThreadGroupInformation, v138, 0x10u);
                  ZwSetInformationThread((HANDLE)0xFFFFFFFFFFFFFFFELL, ThreadIdealProcessor, v104, 4u);
                }
              }
              v121 = NtCurrentTeb();
              *(GUID *)&v135[12].AlpcSendMessage = v121->ActivityId;
...
LABEL_56:
              ...
              else
              {
                ...
                if ( RtlGetCurrentServiceSessionId() )
                  v63 = (__int64)&NtCurrentPeb()->SharedData->UserModeGlobalLogger[3];
                else
                  v63 = 2147353478LL;
                if ( *(_BYTE *)v63 )
                  sub_18010F8E0(a1, v25, v21, v62, v61);
                if ( v62 != v61 )
                {
                  v136[1] = v61;
                  v136[0] = 0LL;
                  ZwSetInformationThread((HANDLE)0xFFFFFFFFFFFFFFFELL, ThreadGroupInformation, v136, 0x10u);
                  ZwSetInformationThread((HANDLE)0xFFFFFFFFFFFFFFFELL, ThreadIdealProcessor, &v105, 4u);
                }
              }
              v107 = v21;
              if ( *(_DWORD *)(a1 + 428) != -1
                || HIDWORD(v135[14].AlpcSendMessagePort) < 0x10
                || (unsigned int)sub_180087A68(a1) )
              {
                break;
              }
LABEL_105:
              ...
              while ( 1 )
              {
                ...
                *(_QWORD *)(v45 + 8) = v43;
                ...
                if ( v44 )
                  break;
                v21 = v92 + 1;
                if ( (int)v92 + 1 >= (unsigned int)dword_180166074 )
                  v21 = 0;
                LODWORD(v92) = v21;
                v107 = v21;
                if ( v21 == v41 )
...
LABEL_76:
              ...
              else
              {
                ...
                if ( RtlGetCurrentServiceSessionId() )
                  v51 = (__int64)&NtCurrentPeb()->SharedData->UserModeGlobalLogger[3];
                else
                  v51 = 2147353478LL;
                if ( *(_BYTE *)v51 )
                  sub_18010F8E0(a1, v35, v37, v50, v49);
                if ( v50 != v49 )
                {
                  ...
                  ZwSetInformationThread((HANDLE)0xFFFFFFFFFFFFFFFELL, ThreadIdealProcessor, v108, 4u);
                }
              }
              if ( (_DWORD)v37 == v96 )
              {
              ...
              *(_QWORD *)&v135[7].AlpcSendMessageFlags = v135[2].AlpcSendMessage;
              v129 = NtCurrentTeb();
              *(GUID *)&v135[12].AlpcSendMessage = v129->ActivityId;
...
LABEL_41:
              ...
              sub_1800351D0(&v135[2].AlpcSendMessagePort);
              ...
              if ( v85 )
              {
                ...
                v133 = *(HANDLE *)(a1 + 56);
                ZwSetInformationWorkerFactory(v133, WorkerFactoryCallbackType, &WorkerFactoryInformation, 4u);
                goto LABEL_233;
              }
...
LABEL_64:
            ...
            while ( 2 )
            {
              while ( (v56 & 1) != 0 )
              {
                if ( (unsigned __int8)sub_180036790(v28, i, v73, v74, DeferredWork) )
                ...
                if ( MEMORY[0x7FFE036A] > 1u )
                {
                  ...
                  {
                    v73 = __rdtsc();
                    v74 = v73 + (unsigned int)dword_180163EC4;
                    while ( 1 )
                    {
                      i = 0LL;
                  ...
                  else
                  {
                    ...
                    {
                      v28 = (unsigned int)v117[0];
                      if ( (v117[0] & 2) == 0 || (_DWORD)i == dword_180163EC4 / (unsigned int)MEMORY[0x7FFE02D6] )
                        break;
                      _mm_pause();
                      i = (unsigned int)(i + 1);
                    }
                ...
                {
                  do
                    ZwWaitForAlertByThreadId((PVOID)(v29 + 16), 0LL);
                  while ( (v117[0] & 4) == 0 );
                }
              }
              v97 = v56 + 1;
