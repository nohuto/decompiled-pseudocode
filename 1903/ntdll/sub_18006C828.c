/*
 * XREFs of sub_18006C828 @ 0x18006C828
 * Callers:
...
_QWORD *__fastcall sub_18006C828(__int64 a1, _QWORD **a2)
{
  _QWORD *v4; // rdi
  _QWORD *v5; // rsi
  __int64 v6; // rax
      ...
      else
      {
        ...
        if ( v21 )
        {
          ...
          *v26 = (_QWORD *)*v27;
          ...
          --*(_DWORD *)(v20 + 24);
          result = (_QWORD *)RtlFreeHeap(qword_180165420, 0, (__int64)v19);
        }
        else
        {
          *v19 = v19;
  ...
  for ( k = *v23; ; k = *v24 )
  {
    if ( k[1] == a1 )
    {
      *v24 = (_QWORD *)*k;
      ...
      --*(_DWORD *)(a1 + 24);
      result = (_QWORD *)RtlFreeHeap(qword_180165420, 0, (__int64)(k - 2));
    }
    else
    {
      v24 = (_QWORD **)k;
...
LABEL_57:
        --*(_DWORD *)(a1 + 24);
        result = (_QWORD *)RtlFreeHeap(qword_180165420, 0, (__int64)v33);
      }
      else
      {
        *v32 = v32;
