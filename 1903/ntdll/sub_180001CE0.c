/*
 * XREFs of sub_180001CE0 @ 0x180001CE0
 * Callers:
...
__int64 __fastcall sub_180001CE0(
        int a1,
        unsigned int a2,
        char a3,
        unsigned int a4,
        ...
        int OutputBuffer)
{
  ...
  do
  {
    ...
    v18 = ZwTraceControl(EtwReceiveReplyDataBlock, InputBuffer, 8u, v12, OutputBufferLength, (PULONG)&ReturnLength);
...
LABEL_9:
  ...
  if ( (_DWORD)v13 )
  {
    if ( *((_DWORD *)v9 + 1) == 1 )
    {
      v11 = ZwTraceControl(EtwGetPrivateSessionTraceHandle, v15, 8 * v13, &OutputBuffer, 2u, &v27);
      if ( !v11 && v27 == 2 )
