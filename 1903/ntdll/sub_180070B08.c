/*
 * XREFs of sub_180070B08 @ 0x180070B08
 * Callers:
...
__int64 __fastcall sub_180070B08(int a1, void *a2, unsigned int a3, _QWORD *a4, __int64 a5, __int64 a6)
{
  unsigned int v7; // eax
  __int64 v8; // rdi
  int v9; // eax
  ...
  v9 = sub_180070C28(a1 & 3, v7, (_DWORD)a2, (unsigned int)&a5, (__int64)&v17, (__int64)v16);
  v11 = v9;
  if ( v9 < 0 )
  {
    DbgPrintEx(
  ...
  v13 = sub_1800711E8(v17, a5, v8, v10, a6);
  v11 = v13;
  if ( v13 < 0 )
  {
    DbgPrintEx(
