/*
 * XREFs of sub_18005E4E0 @ 0x18005E4E0
 * Callers:
...
__int64 __fastcall sub_18005E4E0(
        unsigned __int64 a1,
        unsigned int a2,
        __int64 a3,
        unsigned int a4,
...
LABEL_21:
          ...
          if ( v35 >= 0x100 )
            v36 = byte_180121790[v35 >> 8] + 8LL;
          else
            v36 = byte_180121790[v35];
          v11 = v36 + v63;
          v37 = v35 - (1LL << v36);
          v38 = 16 * v36;
          v39 = v9 - v20 - 3;
...
LABEL_31:
    ...
    *(_DWORD *)v8 = 2 * v16 + 1;
    ...
    if ( v12 + 4 * ((unsigned __int64)(v11 + sub_18005EFF0(a6 + 15304) + 31) >> 5) + v67 + 258 < v69 )
    {
      v8 = (unsigned __int8 *)(a6 + 23184);
      v47 = sub_18005ED00((int)a6 + 61216, (int)a6 + 92736, (_DWORD)v17, v67, v46);
      v7 = v65;
      v6 = v70;
      v10 = a6 + 22608;
      v67 = v47;
