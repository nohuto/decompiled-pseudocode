/*
 * XREFs of RtlFindActivationContextSectionGuid @ 0x1800261E0
 * Callers:
 *     <none>
 * Callees:
        ...
        PACTCTX_SECTION_KEYED_DATA ReturnedData)
{
  ...
  v17 = 0;
  result = sub_1800274B0(Flags, (_DWORD)ExtensionGuid, SectionId, (_DWORD)GuidToFind, (__int64)ReturnedData);
  if ( result >= 0 )
  {
    v20[0] = 32LL;
    v20[1] = ExtensionGuid;
    ...
    v22 = 0LL;
    v19 = 0LL;
    result = sub_180026E54(v20, &v18, &v17, &v19);
    if ( result >= 0 )
      result = 0;
    if ( result >= 0 )
    {
...
LABEL_27:
        ...
        if ( *v18 != 1682469703 )
          goto LABEL_27;
        result = sub_180028CE0(v18, GuidToFind, ReturnedData);
        if ( result >= 0 )
          break;
      ...
      if ( !ReturnedData )
        return 0;
      result = sub_1800776BC(Flags, ReturnedData, v14, v20, v13, v13[8], v13[9], v12);
      if ( result >= 0 )
        return 0;
    }
  }
