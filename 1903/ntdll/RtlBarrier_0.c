...
char __fastcall RtlBarrier_0(__int64 a1, unsigned __int64 a2, unsigned __int64 a3, unsigned __int64 a4)
{
  ...
  if ( v11 )
  {
    ...
    sub_180006FCC(v4 + 4, 1);
  }
  else
  {
    while ( (_DWORD)v15 == *v13 )
      sub_180007424((_QWORD *)(v4 + 4), &v15, 4LL, 0LL, dword_180163B6C);
  }
  if ( v7 )
