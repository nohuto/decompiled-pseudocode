/*
 * XREFs of sub_180005760 @ 0x180005760
 * Callers:
 ...
 *     ZwCreateThreadEx @ 0x18009DE70 (ZwCreateThreadEx.c)
 */

__int64 __fastcall sub_180005760(
        __int64 a1,
        __int64 a2,
        int a3,
        unsigned int a4,
        ...
        _OWORD *a11)
{
  ...
  if ( (v13 & 0x40) == 0 )
    v19 = v18;
  result = ZwCreateThreadEx(&v21, 0x1FFFFFLL, &v23, a1, a8, a9, v19, v12, a6, a5, v29);
  if ( (int)result >= 0 )
  {
    if ( a10 )
      *a10 = v21;
