...
volatile signed __int32 *__fastcall sub_1800097B0(int a1)
{
  _QWORD *i; // rax
  ...
  RtlAcquireSRWLockShared((PRTL_SRWLOCK)(qword_180166088 + 48));
  for ( i = *(_QWORD **)(qword_180166088 + 32); i != (_QWORD *)(qword_180166088 + 32); i = (_QWORD *)*i )
  {
    ...
    if ( *((_DWORD *)i - 1) == a1 )
    {
      ...
      RtlReleaseSRWLockShared((PRTL_SRWLOCK)(qword_180166088 + 48));
      return v3;
    }
  }
  RtlReleaseSRWLockShared((PRTL_SRWLOCK)(qword_180166088 + 48));
  ...
  if ( result )
  {
    ...
    *result = 2623763;
    *((_QWORD *)result + 3) = 0LL;
    v5 = (_RTL_SRWLOCK *)(qword_180166088 + 48);
    *((_DWORD *)result + 1) = a1;
    *((_DWORD *)result + 8) = 1;
    RtlAcquireSRWLockExclusive(v5);
    v6 = (_RTL_SRWLOCK *)qword_180166088;
    ...
    for ( j = *(_QWORD **)(qword_180166088 + 32); j != (_QWORD *)v7; j = (_QWORD *)*j )
    {
      ...
      if ( *((_DWORD *)j - 1) == a1 )
      {
        ...
        RtlReleaseSRWLockExclusive((PRTL_SRWLOCK)(qword_180166088 + 48));
