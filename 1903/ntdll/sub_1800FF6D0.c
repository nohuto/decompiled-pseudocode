/*
 * XREFs of sub_1800FF6D0 @ 0x1800FF6D0
 * Callers:
...
__int64 __fastcall sub_1800FF6D0(__int64 a1, _WORD *a2, unsigned int a3, __int64 a4, wchar_t *a5)
{
  __int16 v5; // bx
  char v8; // r15
  wchar_t *v9; // rsi
    ...
    *(_WORD *)(a4 + 2 * v10 + 20) = 0;
    ...
    if ( v27 )
    {
      ...
      *(_WORD *)(a4 + 2 * v10 + 20) = v31;
      v14 = 0;
      if ( String2 && *String2 && sub_1800129A4(v9, String2) )
      {
        v15 = sub_1800095D4(v36, String2, &v29, v12, &v31);
        v16 = v29;
        if ( v15 < 0 )
        {
      ...
      if ( v9 )
      {
        ...
        do
        {
          if ( !*v9 || v18 >= 8 )
            break;
          v19 = sub_1800095D4(v36, v9, &v26, v12, v28);
          v8 = v26;
          v5 = v28[0];
...
LABEL_43:
    ...
    {
      v13 = sub_1800095D4(a1, DestinationString.Buffer, &v26, v11, v28);
      if ( v13 < 0 )
        return (unsigned int)v13;
      v8 = v26;
      v5 = v28[0];
    ...
    if ( !v27 )
      goto LABEL_43;
    v39[0] &= ~0x20u;
    v13 = sub_1800FE350((__int64 *)(v36 + 24), (__int64)v39, v28);
    if ( v13 >= 0 )
    {
      v5 = v28[0];
      v8 = 2;
