/*
 * XREFs of sub_180070C28 @ 0x180070C28
 * Callers:
...
__int64 __fastcall sub_180070C28(int a1, _QWORD *a2, __int64 a3, _QWORD *a4, volatile signed __int64 *a5, _QWORD *a6)
{
      ...
      if ( !*v13 )
      {
        ...
        *(_OWORD *)Src = *(_OWORD *)(a2[4] + 96LL);
        ...
        if ( v22 > 0x208 )
        {
          ...
          UnicodeString.Buffer = (wchar_t *)sub_18006D6B8((unsigned __int16)(v21 + 14));
...
LABEL_17:
  ...
  else
  {
    ...
    if ( Heap )
    {
      v7 = sub_180071B68(Heap, *(unsigned int *)(v11 + 8), Heap + 16);
      if ( v7 >= 0 )
      {
