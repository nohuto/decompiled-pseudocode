  ...
  if ( (*(_QWORD *)&X & 0x7FFFFFFFFFFFFFFFuLL) > 0x3FE921FB54442D18LL )
  {
    if ( (*(_QWORD *)&X & 0x7FF0000000000000LL) == 0x7FF0000000000000LL )
    {
      ...
      if ( (*(_QWORD *)&v2 & 0xFFFFFFFFFFFFFLL) != 0 )
        sub_1800946BC((unsigned int)"sin", 30, LODWORD(v2), 1, 0, 33, *(__int64 *)&v1, 0LL, 1);
      else
        sub_1800946BC((unsigned int)"sin", 30, 0, 1, 8, 33, *(__int64 *)&v1, 0LL, 1);
      return X;
    }
    v4 = v3 != *(_QWORD *)&X;
    if ( v3 != *(_QWORD *)&X )
    ...
    if ( v1 >= 500000.0 )
    {
      sub_1800947EC(*(_QWORD *)&X, &v22, &v23, &v20);
      v12 = v20;
      v13 = v22;
      v14 = v23;
    }
