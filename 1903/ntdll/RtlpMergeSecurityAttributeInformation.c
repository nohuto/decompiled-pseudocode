/*
 * XREFs of RtlpMergeSecurityAttributeInformation @ 0x1800836A0
 * Callers:
 *     <none>
 * Callees:
...
LABEL_76:
    ...
    {
      Heap = RtlAllocateHeap((__int64)NtCurrentPeb()->ProcessHeap, dword_18016542C + 1310720, v13);
      if ( Heap )
      {
        v14 = (_BYTE *)(Heap + 8);
        *(_QWORD *)Heap = 0LL;
        ...
        *(_WORD *)(Heap + 2) = 8;
        if ( a1 )
        {
          ...
          {
            if ( *v15 == 18 && (v15[1] & 0x10) == 0 && !(unsigned __int8)sub_1800E80D0(v15, Heap, 0LL, v30) )
            {
              if ( !a2 || a4 )
              {
                v27 = 0;
              ...
              {
                LOBYTE(v26) = 1;
                v27 = sub_1800E80D0(v15, a2, v26, v30);
              }
              if ( v27 && v30[0] )
              {
...
LABEL_75:
        ...
        if ( a2 )
        {
          if ( v5 )
          {
            ...
            {
              if ( *v17 == 18 && (v17[1] & 0x10) == 0 && !(unsigned __int8)sub_1800E80D0(v17, Heap, 0LL, v30) )
              {
        ...
        if ( a1 )
        {
          ...
          if ( (_WORD)v19 )
          {
            do
            {
              if ( *v21 == 18 && (v21[1] & 0x10) != 0 && !(unsigned __int8)sub_1800E80D0(v21, Heap, 0LL, v30) )
              {
                if ( a2 )
                  v28 = sub_1800E80D0(v21, a2, 1LL, v30);
                else
                  v28 = 0;
                if ( v28 && v30[0] )
                {
