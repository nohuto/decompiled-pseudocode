...
__int64 __fastcall sub_1800DA48C(_QWORD *a1)
{
  int v3; // r10d
  char *v4; // rax
  __int64 v5; // rbx
  ...
  if ( (NtCurrentPeb()->NtGlobalFlag & 0x2000100) == 0 )
    return 0LL;
  v3 = ((__int64 (__fastcall *)(_QWORD, unsigned int *, _QWORD))qword_18015FA68)(0LL, &v7, 0LL);
  if ( v3 == -1073741820 )
  {
    ...
    if ( v4 )
    {
      ...
      *((_DWORD *)v4 + 1) = 0;
      *(_DWORD *)v4 = v6;
      v3 = ((__int64 (__fastcall *)(_QWORD, unsigned int *, char *))qword_18015FA68)(0LL, &v8, v4);
      if ( v3 >= 0 )
        a1[18] = v5;
      else
