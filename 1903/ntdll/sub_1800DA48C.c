/*
 * XREFs of sub_1800DA48C @ 0x1800DA48C
 * Callers:
...
__int64 __fastcall sub_1800DA48C(PRTL_DEBUG_INFORMATION Buffer)
{
  int v3; // r10d
  ...
  if ( (NtCurrentPeb()->NtGlobalFlag & 0x2000100) == 0 )
    return 0LL;
  v3 = ((__int64 (__fastcall *)(_QWORD, SIZE_T *, _QWORD))qword_18015FA68)(0LL, &Size, 0LL);
  if ( v3 == -1073741820 )
  {
    ...
    if ( v4 )
    {
      ...
      v4->Option = 0;
      v4->SizeStruct = v6;
      v3 = ((__int64 (__fastcall *)(_QWORD, int *, _RTL_PROCESS_VERIFIER_OPTIONS *))qword_18015FA68)(0LL, &v8, v4);
      if ( v3 >= 0 )
