...
struct _PEB *__fastcall sub_18004D024(__int64 a1)
{
  unsigned int v2; // ecx
  __int64 v3; // rdx
  __int64 v4; // r12
        ...
        && (v37 = (unsigned int)(v37 - v36), (unsigned int)v37 < *(_DWORD *)(*p_Next + 36LL)) )
      {
        *((_DWORD *)v16 + 8) = ((_DWORD)v19 << 16) | (v18 + (unsigned __int16)v25 + 1);
        ...
        while ( 1 )
        {
          ...
          if ( v31 )
          {
                                     ...
                                     (signed __int64)v31) )
            {
              ...
              if ( _InterlockedAnd((volatile signed __int32 *)v31 + 11, 0xFFFFFFFD) != 2 )
                goto LABEL_35;
              v32 = (union _SLIST_HEADER *)**v31;
              *v31 = 0LL;
              v33 = (struct _SLIST_ENTRY *)(v31 + 6);
              goto LABEL_73;
            }
          }
          ...
          {
            v32 = (union _SLIST_HEADER *)(*(_QWORD *)(*(_QWORD *)(**v16 + 24LL)
                                                    + 8LL * *((unsigned __int16 *)*v16 + 86)
                                                    + 1192)
                                        + 144LL);
LABEL_72:
            v33 = (struct _SLIST_ENTRY *)(v16 + 6);
LABEL_73:
      ...
      while ( 1 )
      {
        ...
        if ( v37 )
        {
            ...
            && v37 == _InterlockedCompareExchange64(&p_Next[v55 + 2], (signed __int64)v39, v37) )
          {
            ...
            if ( v56 == 2 )
            {
              Next = **(union _SLIST_HEADER ***)v37;
              *(_QWORD *)v37 = 0LL;
              v41 = (struct _SLIST_ENTRY *)(v37 + 48);
              goto LABEL_65;
            }
LABEL_66:
            v42 = *v38;
            ...
            if ( (*((_BYTE *)v16 + 38) & 3) != 0 )
            {
              v61[0] = ((unsigned __int64)v16[1] + 4151) & 0xFFFFFFFFFFFFF000uLL;
              v51 = sub_180107708(v16, v37, p_Next, v36);
              v52 = *(_QWORD *)(v44 + 24);
              v60 = 16 * v51 * (unsigned __int64)*((unsigned __int16 *)v16 + 20);
              v53 = sub_18004733C(v52, 1);
              ZwProtectVirtualMemory(-1LL, v61, &v60, v53, &v67);
            }
            *((_DWORD *)v16[1] + 5) = 0;
            ...
            do
            {
              v46 = *(_QWORD *)(v43 + 160);
              LODWORD(v59) = v46 + v45;
              HIDWORD(v59) = HIDWORD(v46) - 1;
            }
            while ( v46 != _InterlockedCompareExchange64((volatile signed __int64 *)(v43 + 160), v59, v46) );
            v16[1] = 0LL;
...
LABEL_8:
        ...
        {
          Next = (union _SLIST_HEADER *)(*(_QWORD *)(*((_QWORD *)&v39->Next->Next[1].Next + 1)
...
LABEL_10:
  ...
  while ( v2 < 0x81 );
  v7 = (union _SLIST_HEADER *)(a1 + 96);
  v8 = 12LL;
  v63 = (union _SLIST_HEADER *)(a1 + 96);
  v65 = 12LL;
  do
  {
    v9 = 0;
    result = (struct _PEB *)RtlInterlockedFlushSList_0(v7);
    v12 = result;
    if ( result )
    {
      do
      {
        ...
        if ( v48 > 0xF0000 )
          v48 = 983040LL;
        v49 = v48 + *(unsigned __int16 *)(v47 + 18);
        v4 += v49;
        sub_18004AE3C(*(_QWORD *)(a1 + 24), v47, v11);
        ++v9;
        result = (struct _PEB *)RtlGetCurrentServiceSessionId();
        if ( (_DWORD)result )
        {
          result = NtCurrentPeb();
          v50 = (__int64)result->HotpatchInformation + 550;
        }
        else
        {
          v50 = 2147353472LL;
        ...
        if ( *(_BYTE *)v50 )
        {
          ...
          if ( (result->TracingFlags & 1) != 0 )
          {
            ...
            result = (struct _PEB *)sub_1801038C4(*(_QWORD *)(a1 + 24), v47, v49, 0LL);
          }
        }
      }
      while ( v12 );
      ...
      v8 = v65;
      if ( v9 )
        _InterlockedExchangeAdd((volatile signed __int32 *)&v63[1], -v9);
    }
    v7 += 3;
    --v8;
    v63 = v7;
