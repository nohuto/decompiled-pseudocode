/*
 * XREFs of sub_1800FE790 @ 0x1800FE790
 * Callers:
 ...
 *     wcspbrk @ 0x1800924D0 (wcspbrk.c)
 *     memmove @ 0x1800A32C0 (memmove.c)
 *     sub_1800FCFB4 @ 0x1800FCFB4 (sub_1800FCFB4.c)
 */

__int64 __fastcall sub_1800FE790(__int64 a1)
{
  int v1; // r14d
  void *v3; // r13
  void *Heap; // r12
  ...
  if ( (int)sub_1800FCFB4(L"WindowsExcludedProcs", (__int64)&v37, (unsigned int *)&Size, (__int64 *)&Src) >= 0 )
  {
    v29 = 1;
    if ( Src )
  ...
  if ( (int)sub_1800FCFB4(L"Kernel-MUI-Number-Allowed", (__int64)&v37, (unsigned int *)&Size, (__int64 *)&Src) >= 0 )
  {
    v30 = *(_DWORD *)Src;
    RtlFreeHeap((__int64)NtCurrentPeb()->ProcessHeap, 0, (__int64)Src);
    Src = 0LL;
  }
  if ( (int)sub_1800FCFB4(L"Kernel-MUI-Language-Allowed", (__int64)&v37, (unsigned int *)&Size, (__int64 *)&Src) < 0 )
  {
LABEL_27:
    if ( (int)sub_1800FCFB4(L"Kernel-MUI-Language-Disallowed", (__int64)&v37, (unsigned int *)&Size, (__int64 *)&Src) >= 0 )
    {
      v13 = Size;
      v27 = Size + 4;
      if ( (_DWORD)Size == -4 )
...
LABEL_67:
    ...
    if ( (int)sub_1800FCFB4(L"Kernel-MUI-Language-SKU", (__int64)&v37, (unsigned int *)&Size, (__int64 *)&Src) >= 0 )
    {
      v19 = Size;
      v28 = Size + 4;
      if ( (_DWORD)Size == -4 )
