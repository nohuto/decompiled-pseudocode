...
__int64 __fastcall sub_1800FE790(__int64 a1)
{
  ...
  if ( (int)sub_1800FCFB4(L"WindowsExcludedProcs", &Type, (PULONG)&Size, &BaseAddress) >= 0 )
  {
    v29 = 1;
    if ( BaseAddress )
  ...
  if ( (int)sub_1800FCFB4(L"Kernel-MUI-Number-Allowed", &Type, (PULONG)&Size, &BaseAddress) >= 0 )
  {
    v30 = *(_DWORD *)BaseAddress;
    RtlFreeHeap(NtCurrentPeb()->ProcessHeap, 0, BaseAddress);
    BaseAddress = 0LL;
  }
  if ( (int)sub_1800FCFB4(L"Kernel-MUI-Language-Allowed", &Type, (PULONG)&Size, &BaseAddress) < 0 )
  {
LABEL_27:
    if ( (int)sub_1800FCFB4(L"Kernel-MUI-Language-Disallowed", &Type, (PULONG)&Size, &BaseAddress) >= 0 )
    {
      v13 = Size;
      v27 = Size + 4;
      if ( (_DWORD)Size == -4 )
...
LABEL_67:
    ...
    if ( (int)sub_1800FCFB4(L"Kernel-MUI-Language-SKU", &Type, (PULONG)&Size, &BaseAddress) >= 0 )
    {
      v19 = Size;
      v28 = Size + 4;
      if ( (_DWORD)Size == -4 )
