...
__int64 __fastcall RtlCheckTokenMembershipEx(__int64 a1, __int64 a2, int a3, _BYTE *a4)
{
  char v5; // si
  int v8; // ebx
  ...
  if ( (a3 & 0xFFFFFFFC) == 0 )
  {
    ...
    else
    {
      ...
      if ( v8 == -1073741700 )
      {
        ...
        v22[1] = 2;
        v23 = 1;
        v8 = ZwDuplicateToken(v14, 12LL, &v15);
        ZwClose(v14);
      }
      if ( v8 < 0 )
      {
LABEL_19:
    ...
    sub_180014974((unsigned int)v25, 2, 0, 1, a2, 0);
    if ( (v5 & 3) != 0 )
    {
      RtlInitializeSidEx((__int64)v24, (__int64)&unk_18011CB70, 2LL, 2LL);
      sub_180014974((unsigned int)v25, 2, 0, 1, (__int64)v24, 0);
    }
    if ( (v5 & 2) != 0 )
    {
      RtlInitializeSidEx((__int64)v24, (__int64)&unk_18011CB70, 2LL, 2LL);
    ...
    v11 = 56;
    v8 = ZwAccessCheck(v21, v10, 1LL, &unk_18011CB60, v26, &v11, &v13, &v12);
    if ( v8 >= 0 )
    {
      v8 = 0;
      if ( v12 )
