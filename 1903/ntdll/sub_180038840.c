...
char *__fastcall sub_180038840(PRTL_SRWLOCK SRWLock, unsigned int a2, int a3, unsigned int a4, __int64 a5, _DWORD *a6)
{
  __int64 v6; // r14
  int v9; // r11d
  _DWORD *v10; // r13
...
LABEL_22:
    ...
    v19 = (unsigned int)a6;
    *v10 = 0;
    v20 = sub_18006F7C4(SRWLock, v19, a4);
    if ( !v20 )
      return 0LL;
    *v10 = 1;
    if ( (a4 & 1) == 0 )
    ...
    v21 = (unsigned __int64)&SRWLock[4] ^ (unsigned __int64)SRWLock[5].Ptr;
    if ( (PRTL_SRWLOCK)(v21 ^ *(_QWORD *)v21) != &SRWLock[4] )
      __fastfail(3u);
    v22 = (void *)(v20 ^ (unsigned __int64)&SRWLock[4]);
    *(_QWORD *)v20 = v22;
    *(_QWORD *)(v20 + 8) = v20 ^ v21;
    *(_QWORD *)v21 = v20 ^ v21;
    SRWLock[5].Ptr = v22;
    if ( ((__int64)SRWLock[22].Ptr & 1) != 0 && ((v20 + 80) & 0xFFF) != 0 )
    {
      v23 = sub_18010BC08(v22, v20, v20 + 48);
      if ( v23 )
        sub_180068434(SRWLock, v20, v23);
    }
    sub_180068434(SRWLock, v20, v20 + 48);
  }
  v24 = *(_QWORD *)(v14 - 8);
  v25 = v14 - 8;
...
LABEL_43:
  ...
  {
    sub_18010A694(18, (unsigned int)SRWLock ^ (__int64)SRWLock[16].Ptr, v28, v14 - 8, 0LL, 0LL);
    return 0LL;
  }
  if ( !(unsigned int)sub_180039740(SRWLock, a4, v6) )
    return 0LL;
  v29 = (char *)(v14 + 8);
  v30 = 16 * (WORD1(qword_180163540) ^ ((unsigned int)(v14 - 8) >> 16) ^ *(unsigned __int16 *)(v14 - 6)) - 16;
  if ( ((__int64)SRWLock[22].Ptr & 1) != 0 && ((v14 + 24) & 0xFFF) == 0 )
  {
    v29 = (char *)(v14 + 24);
    v30 = 16 * (WORD1(qword_180163540) ^ ((unsigned int)(v14 - 8) >> 16) ^ *(unsigned __int16 *)(v14 - 6)) - 32;
  }
  v31 = *(_DWORD *)v14;
