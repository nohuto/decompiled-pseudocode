...
char __fastcall sub_18005AAF0(int a1, __int64 a2, _DWORD *a3)
{
  ...
  else if ( *(_QWORD *)(a2 + 8) )
  {
    if ( *(_QWORD *)(a2 + 8) == 1LL )
    {
      ...
      *(_WORD *)(a2 + 24) = 0;
      ...
      else
      {
        ...
        v10 = *(_QWORD *)(a2 + 32);
        *(_OWORD *)((unsigned __int16)v8 + v10) = xmmword_18011D9B0;
        *(_WORD *)(a2 + 24) = v8 + 16;
      }
      return v10;
    }
    ...
    if ( !v17 )
      goto LABEL_37;
    LODWORD(v10) = ZwEnumerateKey(v17, v18 - 2, KeyBasicInformation, KeyInformation, 0x220u, &ResultLength);
    v16 = v10;
...
LABEL_37:
    ...
    if ( v28 <= 0xFFFE )
    {
      ...
      v23[1] = v28;
      v24 = &v29;
      LODWORD(v10) = sub_1800DF114(v17, v23, a2 + 24);
      v16 = v10;
      if ( (v10 & 0x80000000) == 0LL )
        return v10;
      LODWORD(Length) = v10;
