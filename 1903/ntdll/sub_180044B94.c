/*
 * XREFs of sub_180044B94 @ 0x180044B94
 * Callers:
...
__int64 __fastcall sub_180044B94(__int64 a1, unsigned __int64 a2, __int64 a3, unsigned int a4, __int64 a5)
{
  unsigned int v5; // ebx
  int *v9; // r14
  int v10; // eax
  ...
  *(_QWORD *)(a5 + 24) = a3;
  ...
  {
LABEL_31:
    v14 = sub_180083D40(a1, a2, a4, a5 + 16);
    goto LABEL_6;
  }
  v11 = 192LL * v10 + a1;
  v12 = sub_180044E1C(v11 + 256, a2);
  if ( v12 )
  {
    v14 = sub_1800449D0(v11 + 256, v12, a2, v13, (int *)(a5 + 16));
LABEL_6:
    v15 = v14;
    goto LABEL_7;
  }
