/*
 * XREFs of sub_1800F14C0 @ 0x1800F14C0
 * Callers:
 *     sub_180050F4C @ 0x180050F4C (sub_180050F4C.c)
 * Callees:
 *     RtlGetCurrentServiceSessionId @ 0x180040780 (RtlGetCurrentServiceSessionId.c)
 *     _guard_dispatch_icall_nop @ 0x1800A0100 (_guard_dispatch_icall_nop.c)
 *     sub_1800F0714 @ 0x1800F0714 (sub_1800F0714.c)
 ...
 *     sub_180108208 @ 0x180108208 (sub_180108208.c)
 */

__int64 __fastcall sub_1800F14C0(__int64 a1, __int64 a2, _QWORD *a3)
{
  char v3; // r14
  _QWORD *v7; // rcx
  __int16 v8; // bp
  ...
  if ( (((*(_DWORD *)(a1 + 112) & 0x61000000) != 0) & !_bittest((const signed __int32 *)(a1 + 112), 0x1Cu)) != 0
    && !(unsigned __int8)sub_180105FE0(a1) )
  {
    v76 = -1073741811;
    goto LABEL_192;
  }
...
LABEL_91:
      ...
      *(_QWORD *)a2 = v34 + 16;
      if ( *(_BYTE *)(a1 + 418) == 2 )
        ...
        v35 = 0LL;
      if ( !v35 || !(unsigned __int8)sub_180107BC4(a1, a2, a3, 2LL) )
      {
...
LABEL_166:
        ...
        if ( v39 != 1 )
        {
          ...
          else if ( (v39 & 0x3F) == 0x3F )
          {
            ...
            {
              if ( (unsigned __int16)qword_180166580 ^ (unsigned __int16)(a1 ^ *(_WORD *)(v12 + 8) ^ (v12 >> 4)) )
                v44 = 0LL;
              else
                v44 = *(_QWORD *)(v12
                                - ((unsigned __int64)((unsigned int)qword_180166580 ^ (unsigned int)a1 ^ *(_DWORD *)(v12 + 8) ^ (unsigned int)(v12 >> 4)) >> 12));
              v45 = *(_WORD *)(v44 + 36);
            }
...
LABEL_29:
      if ( *(_BYTE *)(a1 + 418) == 2 )
        ...
        v15 = 0LL;
      if ( v15 && (unsigned __int8)sub_180107BC4(a1, a2, a3, 2LL) && (*(_WORD *)(a2 + 18) & 0x2000) == 0 )
        goto LABEL_192;
      v16 = *(_QWORD **)a2;
      if ( (*(_BYTE *)(a2 + 18) & 1) != 0 )
      {
