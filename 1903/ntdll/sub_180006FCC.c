/*
 * XREFs of sub_180006FCC @ 0x180006FCC
 * Callers:
 ...
 *     RtlWakeAddressAllNoFence @ 0x1800FC670 (RtlWakeAddressAllNoFence.c)
 *     RtlWakeAddressSingleNoFence @ 0x1800FC680 (RtlWakeAddressSingleNoFence.c)
 * Callees:
 *     sub_180006358 @ 0x180006358 (sub_180006358.c)
 *     ZwAlertThreadByThreadId @ 0x18009D4B0 (ZwAlertThreadByThreadId.c)
 */

int __fastcall sub_180006FCC(unsigned __int64 a1, char a2)
{
  bool v2; // bp
  __int64 v3; // rdi
  __int64 v6; // r10
