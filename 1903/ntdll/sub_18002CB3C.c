...
__int64 __fastcall sub_18002CB3C(__int64 a1, _DWORD *a2, int a3)
{
  ...
  if ( v5 && a1 )
  {
    sub_18002CD98(4LL, &v26);
    if ( !*((_DWORD *)v5 + 2) )
      return 1;
    v8 = v5 + 64;
    sub_18002CDC0(v5 + 64, &v25);
    if ( a3 )
    {
      v4 = 1;
      if ( a3 == 1 )
      {
        ...
        if ( v14 )
        {
          sub_18002CDC0(v14, &v28);
          v15 = v28;
          v16 = 0LL;
          while ( *((_DWORD *)&unk_180162740 + 2 * v16) != *v28 )
          {
...
LABEL_27:
          if ( !v17 && v25 == v15 )
          {
            RtlAcquireSRWLockExclusive(&stru_180166488);
            v18 = 0LL;
            v19 = &unk_180162744;
            v20 = 0;
            v27 = 0LL;
            ...
            *v8 = v22;
            ++*(_QWORD *)v5;
            if ( !(unsigned int)sub_18007D76C(&RegHandle) )
              goto LABEL_20;
            v24 = RegHandle;
            if ( !RegHandle )
              goto LABEL_20;
LABEL_45:
            sub_18010FDD8(v24, *(_QWORD *)(a1 + 80));
LABEL_20:
            ++*(_QWORD *)v5;
            RtlReleaseSRWLockExclusive(&stru_180166488);
          }
        }
      }
    }
    ...
    {
      v4 = sub_18002C750(*(PACTIVATION_CONTEXT *)(a1 + 48), &v28);
      if ( v4 )
      {
        v9 = v28;
        v10 = 0LL;
