/*
 * XREFs of sub_1800D062C @ 0x1800D062C
 * Callers:
...
char __fastcall sub_1800D062C(int a1)
{
  struct _PEB *v1; // rax
  int v3; // r10d
  __int64 v4; // r8
  ...
  if ( v1->ProcessHeap )
  {
    ...
    if ( (unsigned int)dword_18015F4C0 > 4 )
    {
      ...
      {
        v6[0] = a1;
        sub_1800D0B68(v8, "LdrDeleteEnclave");
        v11 = 0;
        v9 = v6;
        v10 = v3;
        LOBYTE(v1) = sub_18008935C((__int64)&dword_18015F4C0, byte_18012BB94, v4, (__int64)v6, v3, (__int64)v7);
      }
    }
  }
  return (char)v1;
