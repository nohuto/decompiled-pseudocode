  ...
  *(_DWORD *)a1 = (a4 | (a4 << 16)) + 4194328;
  ...
  else
  {
    if ( byte_180165B10 )
    {
      ...
      {
        v9 = qword_180165B40;
        *(_QWORD *)(a1 + 40) = qword_180165B40 + a2;
        v10 = *(_DWORD *)(a2 + 16);
        *(_QWORD *)(a2 + 24) = 0LL;
        v11 = (_QWORD **)(a2 + 32);
        while ( v10 )
      ...
      v13 = ZwRequestWaitReplyPort(qword_180165B48, a1, a1);
      if ( a2 )
      {
        v14 = qword_180165B40;
        v15 = (__int64 *)(a2 + 32);
        *(_QWORD *)(a1 + 40) -= qword_180165B40;
    ...
    else
    {
      *(struct _CLIENT_ID *)(a1 + 8) = NtCurrentTeb()->ClientId;
      v13 = ((__int64 (__fastcall *)(__int64, __int64))qword_180165B08)(a1, a1);
    }
    if ( v13 < 0 )
      *(_DWORD *)(a1 + 52) = v13;
