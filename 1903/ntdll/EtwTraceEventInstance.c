/*
 * XREFs of EtwTraceEventInstance @ 0x18010CE90
 * Callers:
 *     <none>
 * Callees:
...
LABEL_16:
    if ( (a1 & 0x1000000) != 0 )
    {
      return (unsigned int)sub_18008567C(a1, (unsigned __int16 *)&Fields, 0x48u, -1072365568);
    }
    else
    {
      v15 = ZwTraceEvent((HANDLE)(unsigned __int16)a1, 0x800u, 0x48u, &Fields);
      if ( !v15 )
        return v4;
