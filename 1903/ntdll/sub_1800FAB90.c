/*
 * XREFs of sub_1800FAB90 @ 0x1800FAB90
 * Callers:
...
__int64 __fastcall sub_1800FAB90(__int64 a1, unsigned __int64 a2, unsigned __int64 a3, _QWORD *a4)
{
  __int64 v6; // rax
  unsigned int v7; // esi
...
LABEL_16:
    ...
    *(_QWORD *)(a1 + 120) = *(_QWORD *)(a1 + 160);
    do
    {
      RtlInitializeSListHead_0((PSLIST_HEADER)(v11 + a1));
      v11 += 16LL;
      --v13;
    }
    while ( v13 );
