 ...
 * Callers:
 *     DbgUiConvertStateChangeStructure @ 0x1800CCEC0 (DbgUiConvertStateChangeStructure.c)
 *     DbgUiConvertStateChangeStructureEx @ 0x1800CCED0 (DbgUiConvertStateChangeStructureEx.c)
 * Callees:
 *     ZwQueryInformationThread @ 0x18009CB80 (ZwQueryInformationThread.c)
 */

__int64 __fastcall sub_1800CCEE0(__int64 a1, __int64 a2, char a3)
{
  _DWORD *v4; // rax
  __int16 v5; // r8
  __int16 v6; // ax
