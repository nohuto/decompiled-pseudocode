/*
 * XREFs of sub_18004622C @ 0x18004622C
 * Callers:
...
__int64 __fastcall sub_18004622C(unsigned __int64 a1, __int64 a2, _QWORD *a3, char a4)
{
...
LABEL_62:
          LOBYTE(v36) = 1;
          sub_180047014(a1, (_DWORD)v40, v36, v8 + 16, v43, *(unsigned __int16 *)(v8 + 8));
        }
        *v35 = v37;
        *(_QWORD *)(v37 + 8) = v35;
        ...
        {
          sub_180045188(a1, v8, *(unsigned __int16 *)(v8 + 8), 1);
        }
      }
      else
      {
        sub_18010A694(13, a1, v36, v39, v38, 0LL);
      }
      a4 = 0;
    }
    v12 = *(__int64 **)(v7 + 24);
...
LABEL_20:
        LOBYTE(v13) = 1;
        sub_180047014(a1, (_DWORD)v17, v13, v7 + 16, v20, *(unsigned __int16 *)(v7 + 8));
      }
      *v12 = v14;
      *(_QWORD *)(v14 + 8) = v12;
      if ( (*(_BYTE *)(v7 + 10) & 8) == 0 || (unsigned __int8)sub_180047214(a1, v7) )
      {
        v21 = *(_BYTE *)(v7 + 10);
        if ( (v21 & 4) != 0 )
        {
      ...
      {
        sub_180045188(a1, v7, *(unsigned __int16 *)(v7 + 8), 1);
      }
    }
    else
    {
      sub_18010A694(13, a1, v13, v16, v15, 0LL);
    }
  }
  v10 = v8 + 16LL * *a3;
  if ( *(_DWORD *)(a1 + 124) )
...
LABEL_88:
          LOBYTE(v48) = 1;
          sub_180047014(a1, (_DWORD)v52, v48, v8 + 16, v55, *(unsigned __int16 *)(v8 + 8));
        }
        *v47 = v49;
        *(_QWORD *)(v49 + 8) = v47;
        if ( (*(_BYTE *)(v8 + 10) & 8) == 0 || (unsigned __int8)sub_180047214(a1, v8) )
      ...
      {
        sub_18010A694(13, a1, v48, v51, v50, 0LL);
      }
      a4 = 0;
    }
    v25 = *(__int64 **)(v10 + 24);
...
LABEL_39:
        LOBYTE(v26) = 1;
        sub_180047014(a1, (_DWORD)v30, v26, v10 + 16, v34, *(unsigned __int16 *)(v10 + 8));
      }
      *v25 = v27;
      *(_QWORD *)(v27 + 8) = v25;
      if ( (*(_BYTE *)(v10 + 10) & 8) == 0 || (unsigned __int8)sub_180047214(a1, v10) )
      {
        v32 = *(_BYTE *)(v10 + 10);
        if ( (v32 & 4) != 0 )
        {
      ...
      sub_180045188(a1, v10, *(unsigned __int16 *)(v10 + 8), 1);
    }
    else
    {
      sub_18010A694(13, a1, v26, v29, v28, 0LL);
    }
  }
  return v8;
}
