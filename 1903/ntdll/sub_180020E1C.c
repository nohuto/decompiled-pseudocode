...
__int64 __fastcall sub_180020E1C(__int64 a1, unsigned __int64 a2, __int64 a3, int a4, unsigned int a5)
{
  __int64 result; // rax
  unsigned int v9; // ebx
  ...
  if ( KiUserInvertedFunctionTable[0] == dword_18017A4D4 )
  {
    byte_18017A4DC = 1;
  }
  else
  {
    ...
    if ( KiUserInvertedFunctionTable[0] != 1 )
    {
      ...
      {
        v10 = (unsigned __int64 *)&unk_18017A500;
        do
        {
          if ( a2 < *v10 )
            break;
