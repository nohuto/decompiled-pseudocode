/*
 * XREFs of sub_18000F5AC @ 0x18000F5AC
 * Callers:
...
__int64 __fastcall sub_18000F5AC(
        unsigned __int8 *a1,
        unsigned __int8 *a2,
        unsigned __int8 *a3,
        unsigned __int8 *a4,
...
LABEL_131:
  ...
  else
  {
    ...
    Heap = RtlAllocateHeap(NtCurrentPeb()->ProcessHeap, (unsigned int)(dword_18016542C + 1310720), v21);
    v15 = Heap;
    if ( Heap )
    {
