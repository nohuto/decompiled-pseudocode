/*
 * XREFs of sub_1800808C0 @ 0x1800808C0
 * Callers:
 *     sub_18002B144 @ 0x18002B144 (sub_18002B144.c)
 * Callees:
 *     sub_180002124 @ 0x180002124 (sub_180002124.c)
 ...
 *     sub_1800F8AEC @ 0x1800F8AEC (sub_1800F8AEC.c)
 */

__int64 __fastcall sub_1800808C0(wchar_t *String1, int a2, wchar_t *a3, int *a4, char a5, char a6)
{
  wchar_t *v6; // rbx
  wchar_t *v7; // rbp
  wchar_t *v8; // rdi
...
LABEL_41:
  ...
  while ( 1 )
  {
    v13 = sub_18002C690(v7, (unsigned __int64)v9, v11);
    v17 = v13;
    if ( v13 == v7 )
      break;
    v18 = 0;
    v19 = v6;
    if ( !v11 && a6 && (*v7 == 45 || (unsigned __int64)v13 > v16 && *(v13 - 1) == 45) )
      goto LABEL_42;
    v20 = L"xl--";
    if ( !v11 )
      v20 = L"xn--";
...
LABEL_13:
      ...
      v63 = 0LL;
      v21 = sub_180002124(v6, v22, &v63, (__int64)v20, 4LL);
      v18 = 0;
      v19 = &v6[v63];
...
LABEL_14:
    ...
    for ( i = v7; i < v17; ++i )
    {
      ...
      {
        if ( !v11
          && (a6 != (_BYTE)v18 && !(unsigned __int8)sub_180080D64(v25)
      ...
      if ( v26 < v27 )
      {
        do
        {
          ...
          if ( v7 < v17 )
          {
            do
            {
              v36 = sub_1800F8AEC(v35, v31, i, v33);
              if ( v36 >= v32 && v36 < v34 )
                v34 = v36;
              v38 = 4LL;
              if ( v36 < 0x10000 )
          ...
          for ( k = v7 < v17; ; k = &v58[v53] < v17 )
          {
            ...
            if ( !k )
              break;
            v42 = sub_1800F8AEC(v39, v31, i, v40);
            v44 = v43 + 1;
            v54 = v42;
            if ( v42 >= v34 )
              v44 = v43;
            ...
            if ( v42 == v34 )
            {
              ...
              if ( v45 <= 25 )
                v51 = 97;
              *v6++ = v45 + v51;
              v52 = sub_180002358(v40, v23 - v62 + 1, v23 == v55);
              v31 = v62;
              v40 = 0LL;
              ++v23;
              LODWORD(v63) = v52;
