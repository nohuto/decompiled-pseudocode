...
__int64 __fastcall RtlGetParentLocaleName(PCWSTR SourceString, __int64 a2, unsigned int a3, char a4)
{
  ...
  v8 = a3 & 4;
  if ( (a3 & 4) != 0
    || !(unsigned __int8)sub_1800F6FF4(SourceString)
    || (v17 = a3 >> 1,
        LOBYTE(v16) = a4,
        LOBYTE(v17) = (a3 & 2) != 0,
        result = sub_1800F6C80(SourceString, v17, v16, a2),
        (int)result < 0) )
  {
    if ( !qword_180166368 && !(unsigned __int8)sub_18007B398() )
      return 3221225473LL;
    v9 = sub_180016E30(SourceString);
    v10 = a3 & 2;
    if ( v9 < 0 )
      goto LABEL_27;
    if ( !v10 )
    ...
    if ( v12 + 2LL * *(unsigned int *)(v11 + *(_QWORD *)(qword_180166368 + 8) + 184) )
    {
      if ( (int)sub_180016C58(v12 + 2LL * *(unsigned int *)(v11 + *(_QWORD *)(qword_180166368 + 8) + 184), 85LL, &v20) < 0 )
        return 3221225473LL;
      LOBYTE(v13) = a4;
      return sub_180016CBC(v13, v14, v20, a2);
    }
    else
    {
LABEL_27:
      if ( !v8 || !(unsigned __int8)sub_1800F6FF4(SourceString) )
        return 3221225711LL;
      LOBYTE(v19) = a4;
      LOBYTE(v18) = v10 != 0;
      return sub_1800F6C80(SourceString, v18, v19, a2);
    }
  }
  return result;
}
