...
__int64 __fastcall sub_18004B7B4(_WORD *Src, int a2, __int64 *a3, int a4, _DWORD *a5)
{
  ...
  Heap = (char *)RtlAllocateHeap(qword_180165B60, dword_18016542C, v11);
  ...
  *((_WORD *)v14 + 12) = 110;
  v36 = 48;
  word_180165B20 = (_WORD)v14 - qword_180165B28 + 26;
  v38 = &word_180165B20;
  v37 = 0LL;
  v39 = 64;
  v40 = 0LL;
  ...
  if ( v15 < 0 )
  {
    RtlFreeHeap(qword_180165B60, 0, qword_180165B28);
    return (unsigned int)v15;
  }
  *(_QWORD *)v14 = 0x50006900700041LL;
  *((_DWORD *)v14 + 2) = 7471215;
  *((_WORD *)v14 + 6) = 116;
  word_180165B20 = (_WORD)v14 - qword_180165B28 + 14;
  v46 = 2;
  v47 = 257;
  v23 = 0x10000LL;
  v16 = ZwCreateSection(&v25, 983071LL, 0LL);
  if ( v16 < 0 )
    goto LABEL_23;
  v29 = v25;
...
LABEL_19:
  ...
  v16 = ZwConnectPort(&qword_180165B48, &word_180165B20, v45, &v28, &v33, v27, v41, &v22);
  ZwClose(v25);
  if ( v16 < 0 )
  {
LABEL_23:
    ...
    *a5 = HIDWORD(v42);
    ...
    if ( v16 >= 0 )
    {
      ...
      *(_QWORD *)&v18[1].InheritedAddressSpace = v41[0];
      ...
      qword_180165B38 = v26;
      qword_180165B30 = v41[2];
      qword_180165B40 = *((_QWORD *)&v32 + 1) - v32;
      memset(v44, 0, sizeof(v44));
      v44[9] = WinSqmStartSqmOptinListener;
      LODWORD(v44[0]) = 96;
      v44[7] = 4096LL;
      v44[8] = v31;
      qword_180165B50 = RtlCreateHeap(0x8000, (char *)v32, v31, 1uLL, 0LL, (__int64)v44);
      if ( qword_180165B50 )
      {
        dword_180165B58 = 0;
        return 0LL;
