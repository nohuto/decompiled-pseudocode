...
__int64 __fastcall sub_180043550(__int64 a1, int a2, char *a3, unsigned __int64 a4)
{
  __int64 v7; // rdi
  struct _TEB *v8; // rdi
  NTSTATUS v9; // ecx
...
LABEL_3:
  ...
  if ( *(_BYTE *)(a1 + 418) == 2 )
  {
    if ( *(_QWORD *)(a1 + 408) )
    {
      ...
      if ( v12[15] < 0 )
      {
        ...
        v16 = qword_180166580 ^ ((unsigned __int64)v12 >> 4) ^ *((_DWORD *)v12 + 2) ^ a1;
        if ( (_WORD)v16 )
          v17 = 0LL;
        else
        ...
        else if ( (v19 & 0x3F) == 0x3F )
        {
          ...
          {
            if ( !((unsigned __int16)qword_180166580 ^ (unsigned __int16)(v15 ^ *(_WORD *)v14 ^ a1)) )
              v7 = *(_QWORD *)&v73[-(((unsigned int)qword_180166580 ^ (unsigned int)v15 ^ *v14 ^ (unsigned int)a1) >> 12)];
            v21 = *(_WORD *)(v7 + 36);
          }
        ...
        if ( v80 )
        {
          sub_180103570(a1, (_DWORD)v80, (_DWORD)Src, v77, a4, 2);
          return (__int64)v80;
        }
        return (__int64)v27;
      }
  ...
  if ( v12 == (char *)a1 )
  {
    sub_18010A694(9, a1, (_DWORD)v12, 0, 0LL, 0LL);
    return 0LL;
  }
  ...
  if ( (v37 & 0x3F) != 0 )
  {
    ...
    else if ( (v37 & 0x3F) == 0x3F )
    {
      ...
      {
        if ( (unsigned __int16)qword_180166580 ^ (unsigned __int16)(a1 ^ *v33 ^ ((unsigned __int64)v11 >> 4)) )
          LOWORD(v41) = MEMORY[0x24];
        else
          LOWORD(v41) = *(_WORD *)(*(_QWORD *)&v11[-(((unsigned int)qword_180166580 ^ (unsigned int)a1 ^ *(_DWORD *)v33 ^ (unsigned int)((unsigned __int64)v11 >> 4)) >> 12)]
                                 + 36LL);
        v28 = v103;
      }
...
LABEL_108:
    ...
    if ( v75 >> 4 > v34 )
    {
      if ( *v36 == 4 || !(unsigned __int8)sub_1800445F8(a1, v28, (_DWORD)v11, a4, v75 >> 4) )
      {
        if ( (v28 & 0x10) != 0 )
        {
          Src = 0LL;
            ...
            if ( *v60 )
            {
              ...
              *((_DWORD *)v62 + 2) = v63;
              if ( HIBYTE(v63) != ((unsigned __int8)v63 ^ (unsigned __int8)(BYTE1(v63) ^ BYTE2(v63))) )
                sub_180101024(a1, v62);
            }
            if ( (v62[10] & 2) != 0 )
            {
              v64 = (_QWORD *)sub_18006E8DC(v62);
              v84 = v64;
              if ( *v60 )
              {
    ...
    if ( (v11[10] & 2) != 0 )
    {
      ...
      *(_OWORD *)v83 = *(_OWORD *)v99;
      ...
      if ( (NtGlobalFlag & 0x800) != 0 )
      {
        v43 = v79;
        v34 = v76;
        *(_WORD *)(v83 + 2) = sub_1800F12BC(a1, *(unsigned __int16 *)(v83 + 2), v76, v79, 4);
LABEL_119:
        v44 = a4;
        LOBYTE(v28) = v103;
LABEL_120:
...
LABEL_135:
            ...
            if ( v43 != v34 )
            {
              ...
              if ( *v82 == 4 )
              {
                ...
                v43 = v79;
                if ( (v93 & 0x800) != 0 )
                  *((_WORD *)v50 + 9) = sub_1800F12BC(a1, *((unsigned __int16 *)v50 + 9), v76, v79, 5);
                v88[0] = &v50[v75];
                v86 = 16 * v76 - v75;
                v85 = sub_180048120(v75, v88, &v86, 0x4000LL);
                if ( v85 >= 0 )
                {
                  *((_QWORD *)v50 + 4) -= v86;
                  v11 = v74;
              ...
              else
              {
                ...
                *v90 = v43;
                ...
                if ( v53 )
                  ...
                  v54 = a1;
                v96 = v54;
                sub_180046728(a1, v54, (_DWORD)v11 + 16 * v43, v49, v52 != 0, v43, v51);
              }
            }
            if ( *v82 != 4 )
            {
    ...
    else
    {
      ...
      {
        v43 = v79;
        v11[11] = sub_1800F12BC(a1, (unsigned __int8)v11[11], *v33, v79, 4);
        LOBYTE(v28) = v103;
        v34 = v76;
        v44 = a4;
        goto LABEL_120;
...
LABEL_193:
  ...
  if ( v72 )
    RtlLeaveCriticalSection(*(_QWORD *)(a1 + 352));
  v69 = NtCurrentPeb()->HotpatchInformation;
  if ( v69 && *v69 )
    v70 = (__int64)NtCurrentPeb()->HotpatchInformation + 550;
  else
    v70 = 2147353472LL;
  ...
  {
    sub_180103570(a1, (_DWORD)Src, (_DWORD)v89, v78, a4, 3);
    return (__int64)Src;
  }
  return (__int64)v71;
}
