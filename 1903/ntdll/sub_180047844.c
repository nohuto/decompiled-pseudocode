...
__int64 __fastcall sub_180047844(__int64 a1, __int64 a2, unsigned int a3, int a4, int a5, int a6, int a7)
{
  ...
  if ( (*(_BYTE *)(a1 + 13) & 7) != 0 )
  {
    ...
    sub_1800506F0(a2 & 0xFFFFFFFFFFE00000uLL, a2, &v31, 0LL);
  ...
  while ( 1 )
  {
    ...
    if ( !v13 )
      goto LABEL_8;
    v23 = sub_18010B474(a1, (int)v13, v8, v16, &SRWLock, (__int64)&v35);
    if ( v23 == -1073741568 )
      break;
    if ( v23 == -1073741566 )
    {
...
LABEL_8:
    ...
    {
      v34 = *(_OWORD *)(a1 + 40);
      v21 = sub_180048170(&BaseAddress, &RegionSize);
    }
    else
    {
      ...
      *(_OWORD *)v33 = *(_OWORD *)(a1 + 40);
      v18 = sub_180047CBC(v17);
      v19 = sub_1800479C8(&BaseAddress, v18, (__int64)v33);
      v21 = v19;
    ...
    sub_18010B3D4(v20, (int)v13, v8, v21 >= 0, &SRWLock, v26);
