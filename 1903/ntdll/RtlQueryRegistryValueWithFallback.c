        ...
        PULONG ResultLength)
{
  ...
  if ( Heap )
  {
    v13 = -1073741772;
    if ( !PrimaryHandle
      || (v13 = ZwQueryValueKey(PrimaryHandle, ValueName, KeyValuePartialInformation, Heap, Length, &v14),
          v13 == -1073741772) )
    {
      if ( !FallbackHandle )
      {
LABEL_16:
      ...
      v13 = ZwQueryValueKey(FallbackHandle, ValueName, KeyValuePartialInformation, Heap, Length, &v14);
    }
