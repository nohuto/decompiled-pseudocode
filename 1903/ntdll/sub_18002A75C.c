/*
 * XREFs of sub_18002A75C @ 0x18002A75C
 * Callers:
 ...
 *     ZwAreMappedFilesTheSame @ 0x18009D850 (ZwAreMappedFilesTheSame.c)
 */

__int64 __fastcall sub_18002A75C(__int64 a1, const void *a2, unsigned int *a3, volatile signed __int32 **a4)
{
  ...
  v5 = qword_1801662D8;
  if ( (qword_1801662E0 & 1) != 0 && qword_1801662D8 )
    v5 = (unsigned __int64)&qword_1801662D8 ^ qword_1801662D8;
  i = 0LL;
  if ( v5 )
  {
    v10 = *a3;
