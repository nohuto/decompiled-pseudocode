...
__int64 __fastcall sub_18002A75C(PVOID File2MappedAsFile, void *Buf1, unsigned int *a3, volatile signed __int32 **a4)
{
  ...
  if ( ((__int64)stru_1801662D8.Min & 1) != 0 && stru_1801662D8.Root )
  ...
  if ( Root )
  {
    ...
    while ( 1 )
    {
      ...
      v12 = *(_QWORD *)(Root + 8);
LABEL_12:
      if ( ((__int64)stru_1801662D8.Min & 1) != 0 && v12 )
        Root ^= v12;
      else
        Root = v12;
      if ( !Root )
