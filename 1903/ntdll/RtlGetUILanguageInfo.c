  ...
  if ( v17 >= 0 )
  {
    if ( v31 )
    {
      ...
      if ( v16 )
      {
        ...
        if ( Heap )
        {
          DestinationString.Buffer = (PWCH)Heap;
          *(_DWORD *)&DestinationString.Length = 11141120;
          RtlInitUnicodeString(&String, v8);
          if ( (int)sub_1800EBD90(&String, &Lcid) < 0 || !RtlLCIDToCultureName(Lcid, &DestinationString) )
          {
            v25 = v31;
            v14 = -1073741811;
            goto LABEL_66;
          ...
          v25 = v31;
          v19 = sub_180016414((__int64)v31, Lcid, 1, v27);
LABEL_50:
          v14 = v19;
          if ( v19 < 0 )
          {
                ...
                while ( !(_BYTE)v12 )
                {
                  if ( v26 )
                  {
                    ...
                    if ( RtlUnicodeStringToInteger(&String, 0x10u, &Lcid) < 0 )
                      break;
                    LOBYTE(v23) = 1;
                    v24 = sub_1800FDDB4((_DWORD)v25, (unsigned int)&v38, (unsigned __int16)Lcid, v23, (__int64)&v38);
                  }
                  else
                  {
                    LOBYTE(v20) = 1;
...
LABEL_66:
      ...
      else
      {
        ...
        {
          v19 = sub_18001583C((__int64)v25, v8, 1, v27);
          goto LABEL_50;
        }
        v14 = -1073741811;
      }
