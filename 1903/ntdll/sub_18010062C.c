...
NTSTATUS __fastcall sub_18010062C(__int64 a1)
{
  ...
  if ( v10 == -1073741772 || v10 == -1073741637 )
  {
    ...
    *(_DWORD *)&String.Length = 11141120;
    ...
    {
      LOBYTE(v14) = 1;
      v15 = sub_180015918(a1, String.Buffer, v14, (__int16 *)&v36);
      v16 = -1;
      if ( v15 >= 0 )
        v16 = v36;
      v42 = v16;
      ...
      v43 = 0LL;
      v44 = 0LL;
      sub_1800094BC(a1, (__int64)&v40, String.Buffer);
      if ( (int)sub_1800FE350((__int64 *)(a1 + 24), (__int64)&v40, 0LL) >= 0 )
      {
        v12 = *(_QWORD *)(a1 + 24);
...
LABEL_16:
    if ( v3 != -1 )
    {
      ...
      {
        if ( (int)sub_18001292C((_QWORD *)a1, v39.Buffer) >= 0 )
        {
          v4 = 1;
        }
        else
