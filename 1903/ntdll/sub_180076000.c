/*
 * XREFs of sub_180076000 @ 0x180076000
 * Callers:
...
__int64 __fastcall sub_180076000(_DWORD *a1, __int64 a2, __int64 a3, unsigned __int64 a4, unsigned __int64 *a5)
{
  ...
  if ( a5 )
    *a5 = 0LL;
  v9 = 64LL;
  sub_18007631C(&v22, &v23, a3);
  if ( v22 == 2 )
    return (unsigned int)v23;
  result = sub_1800763D0(v21, (_DWORD)a5, v10, (unsigned int)&a5, (_DWORD)v5, 64);
  if ( (int)result >= 0 )
  {
