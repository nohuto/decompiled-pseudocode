/*
 * XREFs of RtlExecuteUmsThread @ 0x1800F37A0
 * Callers:
 *     <none>
 * Callees:
 ...
 *     RtlpExecuteUmsThread @ 0x1800A1221 (RtlpExecuteUmsThread.c)
...
__int64 __fastcall RtlExecuteUmsThread(__int64 a1)
{
  ...
  *(_DWORD *)(a1 + 1288) = v4;
  if ( (unsigned int)RtlGetCurrentServiceSessionId() )
    v5 = (__int64)NtCurrentPeb()->HotpatchInformation + 562;
  else
    v5 = 2147353484LL;
