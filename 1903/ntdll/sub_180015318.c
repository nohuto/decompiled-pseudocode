/*
 * XREFs of sub_180015318 @ 0x180015318
 * Callers:
...
__int64 __fastcall sub_180015318(char a1, __int64 a2)
{
  int v4; // ebx
...
LABEL_83:
            v32 = 0;
LABEL_47:
            v4 = sub_180007D24(a2, 1u, &v38, 3 - (unsigned int)(a1 != 0), v32);
            if ( v4 >= 0 )
            {
              v33 = v38;
              if ( v38 )
              {
                ...
                if ( v7 || v6 )
                  *(_DWORD *)(v33 + 40) |= v5;
                v4 = sub_18007C1B8(v33, 0LL, 4LL);
              }
              if ( v8 )
              {
                v37 = sub_180008A20(8, &v39, a2);
                v4 = v37;
                if ( v37 >= 0 )
                  return (unsigned int)sub_18007C1B8(0LL, v39, 5LL);
              }
            }
