/*
 * XREFs of RtlRegisterWait @ 0x180030960
 * Callers:
 *     <none>
 * Callees:
      ...
      *((_QWORD *)Heap + 6) = 0LL;
      ...
      if ( v8 >= 0 )
      {
        ...
        *((_DWORD *)v10 + 22) = 0;
        ...
        CallbackEnviron.FinalizationCallback = (PTP_SIMPLE_CALLBACK)sub_18007C640;
        v8 = TpAllocWait(v11, (PTP_WAIT_CALLBACK)Callback, v10, &CallbackEnviron);
        v15 = v8;
        if ( v8 >= 0 )
        {
