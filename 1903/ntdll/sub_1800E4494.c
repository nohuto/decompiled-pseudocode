/*
 * XREFs of sub_1800E4494 @ 0x1800E4494
 * Callers:
...
__int64 __fastcall sub_1800E4494(unsigned __int16 *a1, unsigned __int16 *a2)
{
  __int64 v2; // rdi
  unsigned int v3; // esi
  const void *v6; // rdx
  ...
  if ( v10 < v9 )
  {
    ...
    if ( NlsMbCodePageTag )
    {
      if ( v16 == 92 )
      {
        for ( i = 0; i < v10; i += (word_180163EE0[*(unsigned __int8 *)(i + v11)] != 0) + 1 )
          ;
        v18 = v14;
        if ( i != v10 )
          v18 = 92;
      ...
      if ( v17 == 92 )
      {
        ...
        {
          do
            LODWORD(v12) = (word_180163EE0[*(unsigned __int8 *)(v12 + v13)] != 0) + 1 + v12;
