/*
 * XREFs of sub_180026FF4 @ 0x180026FF4
 * Callers:
 ...
 *     sub_1800DEB10 @ 0x1800DEB10 (sub_1800DEB10.c)
 */

__int64 __fastcall sub_180026FF4(_DWORD *a1, _QWORD *a2, unsigned int a3, _QWORD *a4, _DWORD *a5)
{
  unsigned int v6; // r9d
  ...
  if ( a2 )
  {
    ...
    if ( (unsigned __int8)sub_1800DEB10(v22, 1LL, 16LL) )
    {
      if ( (unsigned __int8)sub_1800DEB10(
                              ...
                              24LL) )
      {
        ...
        if ( (unsigned __int8)sub_1800DEB10(*(unsigned int *)&v29[24 * v30 + 16], 1LL, 16LL) )
          goto LABEL_5;
        DbgPrintEx(
          0x33u,
          0,
...
LABEL_46:
  ...
  Key[0] = v7;
  v17 = (unsigned int *)bsearch(Key, v16, v13, 0x10uLL, CompareFunction);
LABEL_15:
  if ( !v17 )
    return (unsigned int)-1072365567;
  v18 = v17[1];
