...
struct _PEB *__fastcall sub_18007D570(__int64 a1, __int64 *a2)
{
  ...
  if ( byte_180166551 )
  {
    if ( !byte_180166958 )
    {
      ...
      if ( !result->Ldr->ShutdownInProgress )
      {
        ...
        v24 = UniqueThread;
        RtlAcquireSRWLockShared(&qword_1801662F8, v5, v6, v7);
        for ( i = (_UNKNOWN **)off_18015F570; i != &off_18015F570; i = (_UNKNOWN **)*i )
        {
          ...
          *(_OWORD *)&v20[2] = *(_OWORD *)(v11 + 16);
          ...
          {
            if ( (HANDLE)v20[2] == UniqueThread )
            {
              v16 = sub_180032D40(*((_WORD *)v10 + 1), *((_WORD *)v10 + 22));
          ...
          else
          {
            ...
            *(_OWORD *)&v20[9] = *(_OWORD *)(v20[0] + 32LL);
            v14 = sub_180032D40(WORD1(v20[5]), WORD2(v20[10]));
            v15 = sub_180032D40(*((_WORD *)v10 + 1), *((_WORD *)v10 + 22));
            RtlApplicationVerifierStop(
              515,
...
LABEL_24:
        ...
        return (struct _PEB *)RtlReleaseSRWLockShared(&qword_1801662F8);
      }
    }
  }
  return result;
