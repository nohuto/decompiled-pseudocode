/*
 * XREFs of sub_1800F4FFC @ 0x1800F4FFC
 * Callers:
 ...
 *     RtlDoesNameContainWildCards @ 0x1800F4E20 (RtlDoesNameContainWildCards.c)
 *     RtlRaiseStatus @ 0x1800FBD30 (RtlRaiseStatus.c)
 */

char __fastcall sub_1800F4FFC(unsigned __int16 *a1, unsigned __int16 *a2, char a3, char a4, __int64 a5)
{
  ...
  if ( **((_WORD **)a1 + 1) == 42 )
  {
    ...
    *(_QWORD *)&Expression.Length = *(_QWORD *)a1;
    ...
    v15 = (WCHAR *)(_mm_srli_si128(v12, 8).m128i_u64[0] + 2);
    Expression.Length -= 2;
