/*
 * XREFs of sub_18008567C @ 0x18008567C
 * Callers:
...
__int64 __fastcall sub_18008567C(unsigned __int16 a1, unsigned __int16 *a2, unsigned int a3, int a4)
{
  size_t v4; // r15
  __int64 v6; // rdi
  __int64 v7; // rcx
  ...
  if ( !qword_180163518 )
    return 4201LL;
  if ( (a1 & 0x7FFFu) < 0x40 || (result = sub_18010D214(a1, &v30), !(_DWORD)result) )
  {
    v7 = 2LL * v30;
    _InterlockedIncrement((volatile signed __int32 *)(qword_180163518 + 16LL * v30 + 8));
    v6 = *(_QWORD *)(qword_180163518 + 8 * v7);
    if ( (v6 & 1) == 0 )
    {
      v32 = *(_QWORD *)(qword_180163518 + 8 * v7);
      result = 0LL;
      goto LABEL_5;
    }
  ...
  else
  {
    ...
    else
    {
      ...
      if ( v16 )
        v18 = 0LL;
      v6 = v32;
      v19 = (char *)sub_18005364C(v32, v29, v17->CurrentIdealProcessor.Reserved, v18, &v39);
      v20 = v19;
      v43 = v19;
      if ( v19 )
      {
