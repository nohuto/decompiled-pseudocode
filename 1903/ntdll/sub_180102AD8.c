/*
 * XREFs of sub_180102AD8 @ 0x180102AD8
 * Callers:
...
void sub_180102AD8()
{
  ...
  if ( !qword_180166A38 )
  {
    ...
    if ( RtlCreateMemoryZone(&MemoryZone, (v8 + 4143) & 0xFFFFFFFFFFFFF000uLL, 0) >= 0 )
    {
      ...
      v11 = v10 + 3;
      v12 = v17;
      v10->Region = (ULONGLONG)v9;
      v10[1].Alignment = (ULONGLONG)v12;
      v10[1].Region = 16LL;
      v10[2].Alignment = v4;
      *((_DWORD *)&v10[2].HeaderX64 + 2) = v5;
      while ( 1 )
      {
        RtlInitializeSListHead_0(v11);
        v11[1].Alignment = v3;
        v11[1].Region = (ULONGLONG)v10;
        if ( v3 == v4 )
          break;
        v3 *= 2LL;
        v11 += 2;
      ...
      if ( RtlAllocateMemoryBlockLookaside(v10, 0x1920u, &v18) >= 0 )
      {
        ...
        *v14 = v10;
        if ( !_InterlockedCompareExchange64(&qword_180166A38, (signed __int64)v14, 0LL) )
          return;
        v13 = Block;
      }
      else
