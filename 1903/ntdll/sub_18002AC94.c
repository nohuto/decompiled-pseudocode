...
char *__fastcall sub_18002AC94(__int64 a1)
{
  char *Heap; // rbx
  _QWORD *v3; // rax
  _QWORD *v4; // rdi
  ...
  Heap = (char *)RtlAllocateHeap(HeapHandle, (Flags + 0x40000) | 8, 0x120uLL);
  if ( Heap )
  {
    v3 = RtlAllocateHeap(HeapHandle, (Flags + 0x40000) | 8, 0x50uLL);
    v4 = v3;
    if ( v3 )
    {
      LOBYTE(v5) = 0;
      ...
      *((_DWORD *)v4 + 6) = 1;
      *((_DWORD *)Heap + 69) = 2;
      if ( v8 && !RtlIsCriticalSectionLockedByThread(&stru_18015F3F0) )
