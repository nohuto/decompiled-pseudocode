/*
 * XREFs of sub_18008C14C @ 0x18008C14C
 * Callers:
...
__int64 __fastcall sub_18008C14C(__int64 a1, int a2, unsigned int a3)
{
  int v4; // eax
  bool v5; // zf
  __int64 v6; // rax
