        ...
        PTP_CALLBACK_ENVIRON CallbackEnviron)
{
  ...
  {
    sub_18010EFC8(WorkReturn, Callback, Context);
    return -1073741811;
  }
  else
  {
    *v7 = 0LL;
    Heap = (_TP_WORK *)RtlAllocateHeap(NtCurrentPeb()->ProcessHeap, (dword_180166080 + 0x200000) | 8, 0xF0uLL);
    v10 = Heap;
    BaseAddress = Heap;
    if ( Heap )
    {
      *((_QWORD *)Heap + 22) = retaddr;
      v11 = sub_180037608(
              ...
              (int)CallbackEnviron,
              Flags,
              (__int64)&off_180118390,
              (__int64)&off_180118430);
      v13 = v11;
      if ( v11 >= 0 )
      {
