        ...
        PACTCTX_SECTION_KEYED_DATA ReturnedData)
{
  ...
  v20 = -1;
  v17 = 0;
  result = sub_1800274B0(Flags, (_DWORD)ExtensionGuid, SectionId, (_DWORD)StringToFind, (__int64)ReturnedData);
  if ( result >= 0 )
  {
    v28 = 0;
    v26 = SectionId;
    ...
    else
    {
      ...
      if ( result >= 0 )
      {
        while ( 1 )
        {
          ...
          result = sub_18002715C(v18, v12, StringToFind, ReturnedData, &v20, &v19);
          if ( result >= 0 )
            break;
...
LABEL_12:
          ...
          result = sub_180026E54(&v23, &v18, &v17, &ActivationContext);
          if ( result < 0 )
            goto LABEL_12;
        ...
        if ( !ReturnedData )
          return 0;
        result = sub_1800776BC(Flags, ReturnedData, v13, &v23, v14, v14[9], v14[10], v12);
        if ( result >= 0 )
          return 0;
      }
    }
