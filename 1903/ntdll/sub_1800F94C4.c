/*
 * XREFs of sub_1800F94C4 @ 0x1800F94C4
 * Callers:
...
unsigned __int64 __fastcall sub_1800F94C4(__int64 a1)
{
  ...
  if ( v2 )
  {
    ...
    if ( v4 != (unsigned __int16 *)v5 )
    {
      ...
      while ( 1 )
      {
        ...
        if ( (v10 & 0xC0) != 0xC0 )
          break;
        result = sub_1800F9888(v7, *(unsigned int *)(v3 + 88), (unsigned int)result);
        if ( !(_DWORD)result )
          break;
        v5 = *(_QWORD *)(v3 + 40) - 2LL;
        *(_DWORD *)(v3 + 88) = result;
