/*
 * XREFs of sub_18004F860 @ 0x18004F860
 * Callers:
 *     sub_18004F808 @ 0x18004F808 (sub_18004F808.c)
 *     sub_18010BBB0 @ 0x18010BBB0 (sub_18010BBB0.c)
 * Callees:
 *     sub_1800E9F08 @ 0x1800E9F08 (sub_1800E9F08.c)
 */

__int64 __fastcall sub_18004F860(__int64 a1, signed __int64 a2, __int64 a3)
{
    ...
    if ( _bittest64((const signed __int64 *)(a1 + 56), (unsigned __int64)a2 >> 30) )
    {
      if ( _bittest64(*(const signed __int64 **)a1, (unsigned __int64)a2 >> 15) )
      {
        ...
        else if ( v8 <= 0 )
        {
          ...
          v15 = (a2 % 0x8000) & 0x1F;
          v16 = *(_DWORD *)v14 & dword_1801221C0[v15];
...
LABEL_22:
        ...
        {
          v12 = sub_1800E9F08(v28, v6, 0x40000000LL);
        }
