...
__int64 __fastcall sub_18004E8CC(__int64 a1, int a2, void **a3, unsigned int *a4, _DWORD *a5)
{
  _QWORD **v5; // r13
  _QWORD **v6; // rbx
  unsigned int *v7; // r12
  ...
  v17 = sub_1800479C8(v28, &v30, v30, 0x2000, v15, &v29);
  if ( v17 >= 0 )
  {
    LODWORD(v12) = v30;
    if ( v11 < v30 )
    {
      sub_18010B704(v16, v28[0], v8);
      LODWORD(v12) = v30;
    }
LABEL_8:
    v18 = a5;
...
LABEL_9:
  ...
  {
    v29 = *(_OWORD *)(a1 + 40);
    sub_180048170((unsigned __int64 *)v28, &v30, 0x8000, &v29);
  }
