/*
 * XREFs of sub_180014974 @ 0x180014974
 * Callers:
 ...
 *     RtlAddAccessAllowedAceEx @ 0x180079DF0 (RtlAddAccessAllowedAceEx.c)
 *     RtlAddAccessDeniedAceEx @ 0x180084C20 (RtlAddAccessDeniedAceEx.c)
 ...
 *     RtlAddAuditAccessAceEx @ 0x180089A70 (RtlAddAuditAccessAceEx.c)
 *     RtlAddAuditAccessAce @ 0x18008B0C0 (RtlAddAuditAccessAce.c)
 *     RtlAddAccessDeniedAce @ 0x18008B8F0 (RtlAddAccessDeniedAce.c)
 * Callees:
...
__int64 __fastcall sub_180014974(PACL Acl, unsigned int a2, int a3, int a4, unsigned __int8 *Sid, char a6)
{
  BYTE AclRevision; // bp
