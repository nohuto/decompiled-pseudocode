/*
 * XREFs of ?GoodFaithPLMExemptionTimerExpiredCallback@CApplication@@SAXPEAU_TP_CALLBACK_INSTANCE@@PEAXPEAU_TP_TIMER@@@Z @ 0x18000F3A0
 * Callers:
 *     <none>
 * Callees:
        ...
        struct _TP_TIMER *a3)
{
  ...
  if ( v6 < 0 )
  {
    if ( WPP_GLOBAL_Control != (_UNKNOWN *)&WPP_GLOBAL_Control
      ...
      && *((_BYTE *)WPP_GLOBAL_Control + 25) >= 2u )
    {
      WPP_SF_d(*((_QWORD *)WPP_GLOBAL_Control + 2), 0x16u, &WPP_c27ef931432c3833a68ea220b2e62ed9_Traceguids, v6);
    }
    AudPolicyLogError("CApplication::GoodFaithPLMExemptionTimerExpiredCallback", 1400, v6);
  }
}
