/*
 * XREFs of ??0AAManagerHelper@AssignedAccess@Internal@Windows@@QEAA@XZ @ 0x180033554
 * Callers:
 *     GetAssignedAccessTypeForUser @ 0x1800329CC (GetAssignedAccessTypeForUser.c)
 * Callees:
 *     ?RaiseException@Details@WRL@Microsoft@@YAXJK@Z @ 0x180033928 (-RaiseException@Details@WRL@Microsoft@@YAXJK@Z.c)
