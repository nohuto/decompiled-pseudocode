/*
 * XREFs of dllmain_crt_process_attach @ 0x180034078
 * Callers:
 ...
 *     __scrt_initialize_crt @ 0x18003481C (__scrt_initialize_crt.c)
 *     __scrt_is_nonwritable_in_current_image @ 0x18003494C (__scrt_is_nonwritable_in_current_image.c)
 *     __scrt_release_startup_lock @ 0x1800349EC (__scrt_release_startup_lock.c)
 *     ?__scrt_initialize_type_info@@YAXXZ @ 0x180034C58 (-__scrt_initialize_type_info@@YAXXZ.c)
 *     __scrt_initialize_default_local_stdio_options @ 0x180034C80 (__scrt_initialize_default_local_stdio_options.c)
 *     __scrt_get_dyn_tls_init_callback @ 0x180034CA4 (__scrt_get_dyn_tls_init_callback.c)
 *     __scrt_fastfail @ 0x180034CC4 (__scrt_fastfail.c)
 *     _RTC_Initialize @ 0x180034E18 (_RTC_Initialize.c)
 *     _initterm_0 @ 0x180035076 (_initterm_0.c)
 *     _initterm_e_0 @ 0x180035082 (_initterm_e_0.c)
