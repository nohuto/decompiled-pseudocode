/*
 * XREFs of ??_G?$CGenericApplicationManagerWorkItem@UDuckingGainValueChangedContext@@@@UEAAPEAXI@Z @ 0x180007AA0
 * Callers:
 *     <none>
 * Callees:
        ...
        char a2)
{
  ...
  *a1 = &CGenericApplicationManagerWorkItem<DuckingGainValueChangedContext>::`vftable';
