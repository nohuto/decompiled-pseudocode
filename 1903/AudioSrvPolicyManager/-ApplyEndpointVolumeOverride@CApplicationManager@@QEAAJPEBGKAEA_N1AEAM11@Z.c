/*
 * XREFs of ?ApplyEndpointVolumeOverride@CApplicationManager@@QEAAJPEBGKAEA_N1AEAM11@Z @ 0x18001D7AC
 * Callers:
 ...
 *     WPP_SF_dS @ 0x180018570 (WPP_SF_dS.c)
        ...
        bool *a8)
{
  ...
  {
    WPP_SF_dS(*((_QWORD *)WPP_GLOBAL_Control + 2), 0x35u, &WPP_48f5b41a97d23634bb345404f49671c8_Traceguids, a3, a2);
  }
  v18 = 0LL;
  *a4 = 0;
  v12 = a5;
  ...
  *a7 = 0;
  ...
  {
    WPP_SF_dS(*((_QWORD *)WPP_GLOBAL_Control + 2), 0x1Bu, &WPP_0e5291d43ab738b4f1647aff6bbf1d9a_Traceguids, a3, a2);
  }
  ...
  if ( v16 < 0 )
  {
    ...
    {
      WPP_SF_d(*((_QWORD *)WPP_GLOBAL_Control + 2), 0x1Cu, &WPP_0e5291d43ab738b4f1647aff6bbf1d9a_Traceguids, v16);
    }
    AudPolicyLogError("TsSessionIdAddEndpointVolumeReference", 2452, v16);
  }
  if ( v14 )
