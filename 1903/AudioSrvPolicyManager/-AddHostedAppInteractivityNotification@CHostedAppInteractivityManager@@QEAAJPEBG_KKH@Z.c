/*
 * XREFs of ?AddHostedAppInteractivityNotification@CHostedAppInteractivityManager@@QEAAJPEBG_KKH@Z @ 0x18001F360
 * Callers:
        ...
        int a5)
{
  ...
  v17 = 0LL;
  lpCriticalSection = (LPCRITICAL_SECTION)&unk_18004DC20;
  v16 = 0;
