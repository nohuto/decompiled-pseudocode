/*
 * XREFs of ?Release@?$RuntimeClassImpl@U?$RuntimeClassFlags@$01@WRL@Microsoft@@$00$0A@$0A@UIApplicationSpecificEndpointInfo@@@Details@WRL@Microsoft@@UEAAKXZ @ 0x1800178E0
 * Callers:
 *     <none>
 * Callees:
