/*
 * XREFs of ?ResetReusedSessionGroupingParams@CProcess@@UEAAXXZ @ 0x180014890
 * Callers:
 *     ?SetApplicationHandlesGroupingParams@CProcess@@UEAAXXZ @ 0x180016F80 (-SetApplicationHandlesGroupingParams@CProcess@@UEAAXXZ.c)
 * Callees:
