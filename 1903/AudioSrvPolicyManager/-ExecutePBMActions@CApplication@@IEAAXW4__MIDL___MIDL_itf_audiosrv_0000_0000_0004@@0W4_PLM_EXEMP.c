/*
 * XREFs of ?ExecutePBMActions@CApplication@@IEAAXW4__MIDL___MIDL_itf_audiosrv_0000_0000_0004@@0W4_PLM_EXEMPTION@@IH@Z @ 0x18000E718
 * Callers:
          ...
          else
          {
            ...
            *(_DWORD *)(a1 + 272) = 1;
            if ( WPP_GLOBAL_Control != (_UNKNOWN *)&WPP_GLOBAL_Control
              ...
              && *((_BYTE *)WPP_GLOBAL_Control + 25) >= 4u )
            {
              WPP_SF_(*((_QWORD *)WPP_GLOBAL_Control + 2), 0x15u, &WPP_c27ef931432c3833a68ea220b2e62ed9_Traceguids);
            }
            v21[1] = -1;
            v20 = *(_QWORD *)(a1 + 264);
            v21[0] = -4400000;
