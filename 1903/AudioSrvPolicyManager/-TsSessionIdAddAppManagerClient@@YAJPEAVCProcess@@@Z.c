/*
 * XREFs of ?TsSessionIdAddAppManagerClient@@YAJPEAVCProcess@@@Z @ 0x1800255DC
 * Callers:
...
__int64 __fastcall TsSessionIdAddAppManagerClient(struct CProcess *a1)
{
  ...
  struct TSSession *v8[3]; // [rsp+20h] [rbp-38h] BYREF
  ATL::CAtlException *v9; // [rsp+38h] [rbp-20h] BYREF
