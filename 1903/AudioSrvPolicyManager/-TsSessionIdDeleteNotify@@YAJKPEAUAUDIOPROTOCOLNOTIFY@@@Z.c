/*
 * XREFs of ?TsSessionIdDeleteNotify@@YAJKPEAUAUDIOPROTOCOLNOTIFY@@@Z @ 0x180025500
 * Callers:
 ...
 *     ?TsSessionDeleteNotify@@YAJPEAVTSSession@@PEAUAUDIOPROTOCOLNOTIFY@@@Z @ 0x180024F9C (-TsSessionDeleteNotify@@YAJPEAVTSSession@@PEAUAUDIOPROTOCOLNOTIFY@@@Z.c)
 ...
 *     ?RemoveAt@?$TList@VTSSession@@@@QEAAXPEAX@Z @ 0x180027964 (-RemoveAt@-$TList@VTSSession@@@@QEAAXPEAX@Z.c)
