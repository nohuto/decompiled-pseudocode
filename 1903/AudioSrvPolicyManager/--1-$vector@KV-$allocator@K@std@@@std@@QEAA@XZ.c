/*
 * XREFs of ??1?$vector@KV?$allocator@K@std@@@std@@QEAA@XZ @ 0x180017C38
 * Callers:
 *     _CApplication::RegisterProcessWithApplicationSpecificEndpointInfo_::_1_::dtor$7 @ 0x1800366B0 (_CApplication--RegisterProcessWithApplicationSpecificEndpointInfo_--_1_--dtor$7.c)
 *     _CProcess::CProcess_::_1_::dtor$3 @ 0x180036789 (_CProcess--CProcess_--_1_--dtor$3.c)
 * Callees:
