/*
 * XREFs of ?SafeRegCreateKeyEx@@YAJPEAUHKEY__@@PEBGKPEAGKKPEAU_SECURITY_ATTRIBUTES@@PEAPEAU1@PEAK@Z @ 0x180031E58
 * Callers:
 ...
 *     atexit @ 0x180034AA4 (atexit.c)
 *     _Init_thread_footer @ 0x180035750 (_Init_thread_footer.c)
 *     _Init_thread_header @ 0x1800357B8 (_Init_thread_header.c)
...
LABEL_8:
  ...
  if ( dword_18004DE00 > *(_DWORD *)(*((_QWORD *)NtCurrentTeb()->ThreadLocalStoragePointer + (unsigned int)tls_index)
                                   + 4LL) )
  {
    Init_thread_header(&dword_18004DE00);
    if ( dword_18004DE00 == -1 )
    {
      atexit(SafeRegCreateKeyEx_::_2_::_dynamic_atexit_destructor_for__delKey__);
      Init_thread_footer(&dword_18004DE00);
    }
  }
  v14 = v13 - 1;
  if ( v14 )
...
LABEL_28:
  ...
  else if ( hLibModule && (ProcAddress = (FARPROC)qword_18004DE10) != 0LL
         || (Library = LoadLibraryExW(L"ntdll.dll", 0LL, 0x800u), (hLibModule = Library) != 0LL)
         && (ProcAddress = GetProcAddress(Library, "NtDeleteKey"), (qword_18004DE10 = (__int64)ProcAddress) != 0) )
  {
