/*
 * XREFs of ?DoesGroupConfigExistInStore@AssignedAccessConfigStoreV1@AssignedAccess@Internal@Windows@@EEAA_NXZ @ 0x180033CF0
 * Callers:
 *     <none>
 * Callees:
        ...
        Windows::Internal::AssignedAccess::AssignedAccessConfigStoreV1 *this)
{
  ...
  if ( v2 >= 0 )
  {
    ...
    hKey = 0LL;
    v3 = !RegOpenKeyExW(HKEY_LOCAL_MACHINE, lpSubKey[0], 0, 0x20019u, &hKey)
      && (cSubKeys = 0, !RegQueryInfoKeyW(hKey, 0LL, 0LL, 0LL, &cSubKeys, 0LL, 0LL, 0LL, 0LL, 0LL, 0LL, 0LL))
      && cSubKeys != 0;
  }
  else
  {
