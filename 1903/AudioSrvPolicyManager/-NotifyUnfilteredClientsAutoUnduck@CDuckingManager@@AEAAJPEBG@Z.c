/*
 * XREFs of ?NotifyUnfilteredClientsAutoUnduck@CDuckingManager@@AEAAJPEBG@Z @ 0x18000AA50
 * Callers:
        ...
        const unsigned __int16 *a2)
{
  ...
  HANDLE v11; // rax
  ATL::CAtlException *v13[4]; // [rsp+28h] [rbp-40h] BYREF
  ...
  if ( v4 )
  {
    ...
    {
      WPP_SF_S(*((_QWORD *)WPP_GLOBAL_Control + 2), 0x2Fu, &WPP_2f08ed43560a3dfd6165ccd158e2df11_Traceguids, a2);
    }
    v5 = -1LL;
    do
      ++v5;
