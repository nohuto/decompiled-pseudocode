/*
 * XREFs of dllmain_crt_process_detach @ 0x180034198
 * Callers:
 ...
 *     __scrt_dllmain_uninitialize_critical @ 0x180034800 (__scrt_dllmain_uninitialize_critical.c)
 *     __scrt_release_startup_lock @ 0x1800349EC (__scrt_release_startup_lock.c)
 *     __scrt_uninitialize_crt @ 0x180034A18 (__scrt_uninitialize_crt.c)
 *     ?__scrt_uninitialize_type_info@@YAXXZ @ 0x180034C6C (-__scrt_uninitialize_type_info@@YAXXZ.c)
