/*
 * XREFs of ?TsSessionIdIsAScreenReaderProcess@@YAHKKPEAM@Z @ 0x18002619C
 * Callers:
 *     ?CanBeRemoved@CProcess@@QEAAHXZ @ 0x180012BE0 (-CanBeRemoved@CProcess@@QEAAHXZ.c)
 *     ?GetScreenReaderPolicyVolume@CProcess@@UEAAMXZ @ 0x180013E80 (-GetScreenReaderPolicyVolume@CProcess@@UEAAMXZ.c)
 *     ?IsScreenReaderProcess@CProcess@@UEAA_NXZ @ 0x180013EC0 (-IsScreenReaderProcess@CProcess@@UEAA_NXZ.c)
