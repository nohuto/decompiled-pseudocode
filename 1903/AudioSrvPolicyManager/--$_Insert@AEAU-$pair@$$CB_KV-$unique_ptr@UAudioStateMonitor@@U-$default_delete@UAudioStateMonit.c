        ...
        void **a4)
{
  ...
  void **v35; // [rsp+80h] [rbp+18h] BYREF
  ...
  {
    v22 = *(void ****)(v20 + 8 * v19 + 8);
    v23 = *v22;
    *(_QWORD *)(v20 + 8 * v19 + 8) = *v22;
    if ( v23 != a4 )
      *(_QWORD *)(*((_QWORD *)a1 + 3) + 8 * v19 + 8) = *(_QWORD *)(*(_QWORD *)(*((_QWORD *)a1 + 3) + 8 * v19 + 8) + 8LL);
  }
  v24 = *((_QWORD *)a1 + 2);
  v25 = *((_QWORD *)a1 + 7);
  v26 = (float)(int)v24;
