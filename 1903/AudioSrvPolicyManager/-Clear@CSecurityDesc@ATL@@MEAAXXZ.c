/*
 * XREFs of ?Clear@CSecurityDesc@ATL@@MEAAXXZ @ 0x180031A80
 * Callers:
 *     ??_GCSecurityDesc@ATL@@UEAAPEAXI@Z @ 0x180031550 (--_GCSecurityDesc@ATL@@UEAAPEAXI@Z.c)
 *     ??1CSecurityDesc@ATL@@UEAA@XZ @ 0x180031594 (--1CSecurityDesc@ATL@@UEAA@XZ.c)
