/*
 * XREFs of ?NotifyFilteredClientsAutoUnduck@CDuckingManager@@AEAAJPEBG@Z @ 0x18000A750
 * Callers:
 ...
 *     ?StringCbCopyW@@YAJPEAG_KPEBG@Z @ 0x18000D274 (-StringCbCopyW@@YAJPEAG_KPEBG@Z.c)
 */
...
__int64 __fastcall CDuckingManager::NotifyFilteredClientsAutoUnduck(CDuckingManager *this, const unsigned __int16 *a2)
{
  ...
  if ( v5 )
  {
    ...
    {
      WPP_SF_S(*((_QWORD *)WPP_GLOBAL_Control + 2), 0x2Cu, &WPP_2f08ed43560a3dfd6165ccd158e2df11_Traceguids, a2);
    }
    v6 = -1LL;
    do
      ++v6;
    ...
    if ( v3 < 0 )
    {
      ...
      {
        WPP_SF_d(*((_QWORD *)WPP_GLOBAL_Control + 2), 0x2Du, &WPP_2f08ed43560a3dfd6165ccd158e2df11_Traceguids, v3);
      }
      AudPolicyLogError("CDuckingManager::NotifyFilteredClientsAutoUnduck", 903, v3);
    }
  }
  return 0LL;
}
