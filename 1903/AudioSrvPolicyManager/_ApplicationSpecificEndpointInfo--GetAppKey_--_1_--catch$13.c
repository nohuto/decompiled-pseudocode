/*
 * XREFs of _ApplicationSpecificEndpointInfo::GetAppKey_::_1_::catch$13 @ 0x18003797B
 * Callers:
 *     <none>
 * Callees:
...
void *__fastcall ApplicationSpecificEndpointInfo::GetAppKey_::_1_::catch_13(
        __int64 a1,
        __int64 a2,
        __int64 a3,
        const char *a4)
