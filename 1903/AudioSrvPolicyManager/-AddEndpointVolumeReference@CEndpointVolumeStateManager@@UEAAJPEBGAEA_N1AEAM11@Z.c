/*
 * XREFs of ?AddEndpointVolumeReference@CEndpointVolumeStateManager@@UEAAJPEBGAEA_N1AEAM11@Z @ 0x18002BA50
 * Callers:
 *     <none>
 * Callees:
 ...
 *     ??0?$basic_string@GU?$char_traits@G@std@@V?$allocator@G@2@@std@@QEAA@QEBG@Z @ 0x180015100 (--0-$basic_string@GU-$char_traits@G@std@@V-$allocator@G@2@@std@@QEAA@QEBG@Z.c)
...
__int64 __fastcall CEndpointVolumeStateManager::AddEndpointVolumeReference(
        ...
        bool *a7)
{
  ...
  char *v12; // r14
  __int64 v13; // rbx
  struct IVolumeProvider *v14; // rbx
  HANDLE ProcessHeap; // rax
  CEndpointVolumeState *v16; // rax
  __int64 v17; // rcx
  CEndpointVolumeState *v18; // rax
  _QWORD *v19; // rax
  __int64 v20; // rbx
  __int64 *v21; // rsi
  __int64 v22; // rdx
  ...
  const char *v27; // r9
  __int64 result; // rax
  _BYTE v29[16]; // [rsp+50h] [rbp-98h] BYREF
  __int128 v30; // [rsp+60h] [rbp-88h] BYREF
  __m128i si128; // [rsp+70h] [rbp-78h]
  _OWORD v32[2]; // [rsp+80h] [rbp-68h] BYREF
  void *v33; // [rsp+A0h] [rbp-48h]
  ...
  *a6 = 0;
  ...
  try
  {
    std::wstring::wstring((char *)&v30, a2);
    v12 = (char *)this + 56;
    v13 = std::_Hash<std::_Umap_traits<std::wstring,std::unique_ptr<CEndpointVolumeState>,std::_Uhash_compare<std::wstring,std::hash<std::wstring>,std::equal_to<std::wstring>>,std::allocator<std::pair<std::wstring const,std::unique_ptr<CEndpointVolumeState>>>,0>>::count(
            (char *)this + 56,
            &v30);
    std::wstring::~wstring((__int64)&v30);
    if ( !v13 )
    {
      v14 = (struct IVolumeProvider *)*((_QWORD *)this + 15);
      std::wstring::wstring((char *)&v30, a2);
      ProcessHeap = GetProcessHeap();
      v16 = (CEndpointVolumeState *)HeapAlloc(ProcessHeap, 0, 0x38uLL);
      if ( v16 )
        v18 = CEndpointVolumeState::CEndpointVolumeState(v16, v14, a2);
      else
        v18 = 0LL;
      v32[0] = v30;
      v32[1] = si128;
      ...
      v20 = *v19;
      v21 = *(__int64 **)(*v19 + 8LL);
      v22 = std::_List_buy<std::pair<std::wstring const,std::unique_ptr<CEndpointVolumeState>>>::_Buynode<std::pair<std::wstring,std::unique_ptr<CEndpointVolumeState>>>(
              v17,
              *v19,
              v21,
              v32);
      v23 = *((_QWORD *)v12 + 2);
      if ( v23 == 0x492492492492491LL )
        std::_Xlength_error("list<T> too long");
      *((_QWORD *)v12 + 2) = v23 + 1;
      *(_QWORD *)(v20 + 8) = v22;
      *v21 = v22;
      std::_Hash<std::_Umap_traits<std::wstring,std::unique_ptr<CEndpointVolumeState>,std::_Uhash_compare<std::wstring,std::hash<std::wstring>,std::equal_to<std::wstring>>,std::allocator<std::pair<std::wstring const,std::unique_ptr<CEndpointVolumeState>>>,0>>::_Insert<std::pair<std::wstring const,std::unique_ptr<CEndpointVolumeState>> &,std::_List_unchecked_iterator<std::_List_val<std::_List_simple_types<std::pair<std::wstring const,std::unique_ptr<CEndpointVolumeState>>>>>>(
        v12,
        v29,
        **((_QWORD **)v12 + 1) + 16LL);
      v24 = v33;
      ...
      {
        if ( *((_BYTE *)v33 + 32) )
          (*(void (__fastcall **)(_QWORD, char *))(**((_QWORD **)v33 + 3) + 240LL))(
            *((_QWORD *)v33 + 3),
            (char *)v33 + 40);
        v25 = v24[3];
        if ( v25 )
    ...
    std::wstring::wstring((char *)&v30, a2);
    v26 = std::unordered_map<std::wstring,std::unique_ptr<CEndpointVolumeState>>::at(v12, &v30);
