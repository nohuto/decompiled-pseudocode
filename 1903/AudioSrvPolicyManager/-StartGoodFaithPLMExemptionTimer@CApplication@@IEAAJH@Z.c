/*
 * XREFs of ?StartGoodFaithPLMExemptionTimer@CApplication@@IEAAJH@Z @ 0x18000F1D8
 * Callers:
...
__int64 __fastcall CApplication::StartGoodFaithPLMExemptionTimer(const wchar_t **this)
{
  ...
  {
    WPP_SF_S(*((_QWORD *)WPP_GLOBAL_Control + 2), 0x13u, &WPP_c27ef931432c3833a68ea220b2e62ed9_Traceguids, this[3]);
  }
  if ( !this[53] )
  {
    ...
    if ( v2 < 0 )
    {
      ...
      {
        WPP_SF_d(*((_QWORD *)WPP_GLOBAL_Control + 2), 0x14u, &WPP_c27ef931432c3833a68ea220b2e62ed9_Traceguids, v2);
      }
      AudPolicyLogError("CApplication::StartGoodFaithPLMExemptionTimer", 1324, v2);
    }
  }
  if ( v7 )
  {
