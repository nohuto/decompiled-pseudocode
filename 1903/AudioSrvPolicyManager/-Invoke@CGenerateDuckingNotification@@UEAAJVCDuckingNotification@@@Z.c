/*
 * XREFs of ?Invoke@CGenerateDuckingNotification@@UEAAJVCDuckingNotification@@@Z @ 0x18000A0A0
 * Callers:
 ...
 *     WPP_SF_i @ 0x180008B94 (WPP_SF_i.c)
 *     WPP_SF_id @ 0x180008BD8 (WPP_SF_id.c)
  ...
  if ( !*(_BYTE *)(a1 + 24) )
  {
    if ( v6 )
    {
      ...
      else
      {
        ...
        WPP_SF_id(v19[2], 0x23u, a3, *a2, v20[4]);
        v3 = 2;
      }
      if ( (v3 & 2) != 0 && v20 )
    ...
    else
    {
      ...
      if ( WPP_GLOBAL_Control != (_UNKNOWN *)&WPP_GLOBAL_Control
        ...
        && *((_BYTE *)WPP_GLOBAL_Control + 25) >= 4u )
      {
        WPP_SF_i(*((_QWORD *)WPP_GLOBAL_Control + 2), 0x24u, a3, *a2);
        v14 = (_UNKNOWN **)WPP_GLOBAL_Control;
      }
...
LABEL_29:
  ...
  if ( *(_DWORD *)(a2[2] - 16LL) )
  {
    ...
    else
    {
      ...
      WPP_SF_id(v10[2], 0x21u, a3, *a2, v11[4]);
      v3 = 1;
    }
    if ( (v3 & 1) != 0 && v11 )
...
LABEL_18:
  *(_QWORD *)(*(_QWORD *)(a1 + 8) + 48LL) = *a2;
  if ( WPP_GLOBAL_Control != (_UNKNOWN *)&WPP_GLOBAL_Control
    ...
    && *((_BYTE *)WPP_GLOBAL_Control + 25) >= 4u )
  {
    WPP_SF_i(*((_QWORD *)WPP_GLOBAL_Control + 2), 0x25u, a3, *a2);
  }
    ...
    && *((_BYTE *)WPP_GLOBAL_Control + 25) >= 4u )
  {
    v13 = 38;
LABEL_27:
    WPP_SF_d((TRACEHANDLE)v12[2], v13, &WPP_2f08ed43560a3dfd6165ccd158e2df11_Traceguids, *((_DWORD *)a2 + 2));
LABEL_33:
    v12 = (_UNKNOWN **)WPP_GLOBAL_Control;
  }
  if ( MediaEvent < 0 )
  {
    if ( v12 != &WPP_GLOBAL_Control && (*((_DWORD *)v12 + 7) & 0x8000000) != 0 && *((_BYTE *)v12 + 25) >= 2u )
      WPP_SF_d((TRACEHANDLE)v12[2], 0x29u, &WPP_2f08ed43560a3dfd6165ccd158e2df11_Traceguids, MediaEvent);
    AudPolicyLogError("CGenerateDuckingNotification::Invoke", 757, MediaEvent);
  }
LABEL_40:
  v15 = a2[3];
  if ( v15 )
