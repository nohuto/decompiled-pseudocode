/*
 * XREFs of ?Log_CaughtException@in1diag3@details@wil@@YAJPEAXIPEBD@Z @ 0x180017DE4
 * Callers:
 *     _CApplication::NotifyVolumePolicyChange_::_1_::catch$3 @ 0x180036568 (_CApplication--NotifyVolumePolicyChange_--_1_--catch$3.c)
 * Callees:
