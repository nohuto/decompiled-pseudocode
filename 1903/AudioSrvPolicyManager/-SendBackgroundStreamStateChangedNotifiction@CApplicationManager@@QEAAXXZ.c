/*
 * XREFs of ?SendBackgroundStreamStateChangedNotifiction@CApplicationManager@@QEAAXXZ @ 0x18001E358
 * Callers:
...
void __fastcall CApplicationManager::SendBackgroundStreamStateChangedNotifiction(CApplicationManager *this)
{
  ...
  char v17; // [rsp+48h] [rbp-19h]
  __int64 v18; // [rsp+58h] [rbp-9h]
  struct _RTL_CRITICAL_SECTION *v19; // [rsp+60h] [rbp-1h]
  GUID v20; // [rsp+68h] [rbp+7h]
  GUID v21; // [rsp+78h] [rbp+17h]
