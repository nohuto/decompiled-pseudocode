/*
 * XREFs of __tailMerge_ext_ms_win_session_wtsapi32_l1_1_0_dll @ 0x1800354C8
 * Callers:
 *     __imp_load_WTSFreeMemory @ 0x1800354BC (__imp_load_WTSFreeMemory.c)
 *     __imp_load_WTSQuerySessionInformationW @ 0x180035547 (__imp_load_WTSQuerySessionInformationW.c)
 * Callees:
