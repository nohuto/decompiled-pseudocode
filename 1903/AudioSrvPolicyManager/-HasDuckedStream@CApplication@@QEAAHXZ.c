/*
 * XREFs of ?HasDuckedStream@CApplication@@QEAAHXZ @ 0x18000F950
 * Callers:
 ...
 *     ?SubjectToStreamClassPolicyGains@CProcess@@UEAAHXZ @ 0x180013E20 (-SubjectToStreamClassPolicyGains@CProcess@@UEAAHXZ.c)
