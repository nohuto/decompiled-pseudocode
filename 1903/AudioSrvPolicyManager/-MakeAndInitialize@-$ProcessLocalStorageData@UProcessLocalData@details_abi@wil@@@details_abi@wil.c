/*
 * XREFs of ?MakeAndInitialize@?$ProcessLocalStorageData@UProcessLocalData@details_abi@wil@@@details_abi@wil@@CAJPEBG$$QEAV?$unique_any_t@V?$mutex_t@V?$unique_storage@U?$resource_policy@PEAXP6AXPEAX@Z$1?CloseHandle@details@wil@@YAX0@ZU?$integral_constant@_K$0A@@wistd@@PEAXPEAX$0A@$$T@details@wil@@@details@wil@@Uerr_returncode_policy@3@@wil@@@3@PEAPEAV123@@Z @ 0x180003DB0
 * Callers:
        ...
        unsigned __int64 *a3)
{
  ...
  *(_OWORD *)hObject = 0LL;
  ...
  if ( v14 )
    v16 = v12;
  *v16 = 0;
  StringCchCatW(v35, v14, (char *)L"_p0");
  v17 = 1;
  v18 = v9 >> 33;
  v19 = v11 & 0x7FFFFFFF;
  if ( v19 )
    v17 = v19;
  v20 = wil::semaphore_t<wil::details::unique_storage<wil::details::resource_policy<void *,void (*)(void *),&void wil::details::CloseHandle(void *),wistd::integral_constant<unsigned __int64,0>,void *,void *,0,std::nullptr_t>>,wil::err_returncode_policy>::create(
          hObject,
          v19,
          v17,
          v35);
  ...
  wil::details::in1diag3::Return_Hr(retaddr, (void *)v22, (__int64)"wil", (const char *)(unsigned int)v20);
LABEL_20:
  if ( (v10 & 0x80000000) == 0 )
  {
    *(_DWORD *)v9 = 1;
  ...
  {
    wil::details::in1diag3::Return_Hr(retaddr, (void *)0x138, (__int64)"wil", (const char *)v10);
    v24 = hObject[1];
    v25 = hObject[0];
  }
  if ( v24 && !CloseHandle(v24) )
  {
    wil::details::in1diag3::_FailFast_GetLastError(retaddr, (void *)0x8F0, v27, v28);
    JUMPOUT(0x180004055LL);
  }
  if ( v25 && !CloseHandle(v25) )
  {
    wil::details::in1diag3::_FailFast_GetLastError(retaddr, (void *)0x8F0, v29, v30);
    __debugbreak();
  }
  if ( v9 )
  {
