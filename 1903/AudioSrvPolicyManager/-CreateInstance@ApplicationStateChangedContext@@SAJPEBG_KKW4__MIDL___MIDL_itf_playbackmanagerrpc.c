/*
 * XREFs of ?CreateInstance@ApplicationStateChangedContext@@SAJPEBG_KKW4__MIDL___MIDL_itf_playbackmanagerrpc_0000_0000_0002@@PEAPEAU1@@Z @ 0x1800294D8
 * Callers:
        ...
        _QWORD *a5)
{
  ...
  if ( v12 < 0 )
  {
    ...
    {
      WPP_SF_d(*((_QWORD *)WPP_GLOBAL_Control + 2), 0x24u, &WPP_ddae050dd73e37d577adf215a51a3607_Traceguids, v12);
    }
    AudPolicyLogError("ApplicationStateChangedContext::CreateInstance", 1019, v12);
  }
