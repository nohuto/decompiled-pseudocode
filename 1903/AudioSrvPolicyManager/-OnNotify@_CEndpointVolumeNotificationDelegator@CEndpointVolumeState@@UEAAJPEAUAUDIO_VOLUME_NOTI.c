/*
 * XREFs of ?OnNotify@_CEndpointVolumeNotificationDelegator@CEndpointVolumeState@@UEAAJPEAUAUDIO_VOLUME_NOTIFICATION_DATA@@@Z @ 0x18002B8E0
 * Callers:
 *     <none>
 * Callees:
 *     _o_log10_0 @ 0x18003519C (_o_log10_0.c)
 */
