/*
 * XREFs of ?RpcClientProcessSessionId@@YAJPEAXPEAK1@Z @ 0x180023290
 * Callers:
 *     PbmReportAppInteractivityChange @ 0x180020350 (PbmReportAppInteractivityChange.c)
 *     PbmSwitchSoftNonInteractiveAppsToHardNonInteractive @ 0x1800203D0 (PbmSwitchSoftNonInteractiveAppsToHardNonInteractive.c)
 *     PbmReportHostedAppStateChange @ 0x180020420 (PbmReportHostedAppStateChange.c)
 *     PbmReportAppClosing @ 0x1800204B0 (PbmReportAppClosing.c)
 *     PbmAllowMediaPlaybackForApp @ 0x180020520 (PbmAllowMediaPlaybackForApp.c)
 *     PbmReportApplicationState @ 0x180021370 (PbmReportApplicationState.c)
 *     PbmLaunchBackgroundTask @ 0x180021450 (PbmLaunchBackgroundTask.c)
 *     TS_SessionGetAudioProtocol @ 0x180027370 (TS_SessionGetAudioProtocol.c)
 *     TS_RegisterAudioProtocolNotification @ 0x180027420 (TS_RegisterAudioProtocolNotification.c)
 *     TS_UnregisterAudioProtocolNotification @ 0x180027480 (TS_UnregisterAudioProtocolNotification.c)
 * Callees:
 ...
 *     WPP_SF_q @ 0x18001EC80 (WPP_SF_q.c)
 *     WPP_SF_D @ 0x180022550 (WPP_SF_D.c)
