/*
 * XREFs of ?UpdateStreamCountAndProcessCategory@CProcess@@IEAAXPEBGKHHPEAHPEAW4_APPLICATION_CATEGORY@@@Z @ 0x180012E8C
 * Callers:
 ...
 * Callees:
 *     WPP_SF_dSS @ 0x18000D9F0 (WPP_SF_dSS.c)
    ...
    else if ( !v13 )
    {
      ...
      if ( ThreadpoolTimer
        || (ThreadpoolTimer = CreateThreadpoolTimer(
                                lambda_71eadae99598aaffd4e88ecb8f459962_::_lambda_invoker_cdecl_,
                                this,
                                0LL),
