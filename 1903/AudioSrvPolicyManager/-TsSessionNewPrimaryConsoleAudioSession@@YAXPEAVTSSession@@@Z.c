/*
 * XREFs of ?TsSessionNewPrimaryConsoleAudioSession@@YAXPEAVTSSession@@@Z @ 0x180024680
 * Callers:
    ...
    if ( v2 != (int *)a1 )
    {
      ...
      *((_DWORD *)a1 + 86) = 1;
      if ( g_MaxSessions <= 1 )
      {
        ...
        {
          v6 = *(_DWORD *)a1;
          WPP_SF_dd(*((_QWORD *)WPP_GLOBAL_Control + 2), 0xEu, &WPP_0e5291d43ab738b4f1647aff6bbf1d9a_Traceguids, v5, v6);
        }
        ...
        {
          WPP_SF_(*((_QWORD *)WPP_GLOBAL_Control + 2), 0xFu, &WPP_0e5291d43ab738b4f1647aff6bbf1d9a_Traceguids);
        }
      }
    }
  }
