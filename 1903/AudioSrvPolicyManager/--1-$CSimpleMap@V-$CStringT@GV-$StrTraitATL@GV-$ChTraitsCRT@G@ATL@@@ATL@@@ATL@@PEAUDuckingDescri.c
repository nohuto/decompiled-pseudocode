/*
 * XREFs of ??1?$CSimpleMap@V?$CStringT@GV?$StrTraitATL@GV?$ChTraitsCRT@G@ATL@@@ATL@@@ATL@@PEAUDuckingDescriptor@@V?$CSimpleMapEqualHelper@V?$CStringT@GV?$StrTraitATL@GV?$ChTraitsCRT@G@ATL@@@ATL@@@ATL@@PEAUDuckingDescriptor@@@2@@ATL@@QEAA@XZ @ 0x180014EE4
 * Callers:
 *     ??1CProcess@@MEAA@XZ @ 0x18001264C (--1CProcess@@MEAA@XZ.c)
 *     ??1TSSession@@QEAA@XZ @ 0x180022A5C (--1TSSession@@QEAA@XZ.c)
 *     _CProcess::CProcess_::_1_::dtor$13 @ 0x180036880 (_CProcess--CProcess_--_1_--dtor$13.c)
 *     _CProcess::CProcess_::_1_::dtor$14 @ 0x180036899 (_CProcess--CProcess_--_1_--dtor$14.c)
 * Callees:
