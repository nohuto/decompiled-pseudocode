/*
 * XREFs of __scrt_initialize_onexit_tables @ 0x18003486C
 * Callers:
 *     __scrt_dllmain_before_initialize_c @ 0x1800346F8 (__scrt_dllmain_before_initialize_c.c)
 ...
 *     _initialize_onexit_table @ 0x180035142 (_initialize_onexit_table.c)
 */
