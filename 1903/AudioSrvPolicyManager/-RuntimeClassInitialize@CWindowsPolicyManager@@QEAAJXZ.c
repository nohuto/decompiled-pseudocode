/*
 * XREFs of ?RuntimeClassInitialize@CWindowsPolicyManager@@QEAAJXZ @ 0x1800054E8
 * Callers:
 ...
 *     ?_Log_Win32@in1diag3@details@wil@@YAXPEAXIPEBDK@Z @ 0x1800086E4 (-_Log_Win32@in1diag3@details@wil@@YAXPEAXIPEBDK@Z.c)
