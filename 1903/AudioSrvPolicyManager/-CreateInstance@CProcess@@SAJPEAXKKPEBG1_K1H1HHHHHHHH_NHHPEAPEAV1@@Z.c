/*
 * XREFs of ?CreateInstance@CProcess@@SAJPEAXKKPEBG1_K1H1HHHHHHHH_NHHPEAPEAV1@@Z @ 0x18001126C
 * Callers:
...
LABEL_12:
    ...
    {
      WPP_SF_d(*((_QWORD *)WPP_GLOBAL_Control + 2), 0x28u, &WPP_c27ef931432c3833a68ea220b2e62ed9_Traceguids, v28);
    }
    AudPolicyLogError("CProcess::CreateInstance", 2733, v28);
