/*
 * XREFs of ?ProcessTerminationWatcherCallback@CProcess@@SAXPEAU_TP_CALLBACK_INSTANCE@@PEAXPEAU_TP_WAIT@@J@Z @ 0x180013BA0
 * Callers:
 *     <none>
 * Callees:
        ...
        struct _TP_WAIT *a3)
{
  ...
  if ( v6 < 0 )
  {
    if ( WPP_GLOBAL_Control != (_UNKNOWN *)&WPP_GLOBAL_Control
      ...
      && *((_BYTE *)WPP_GLOBAL_Control + 25) >= 2u )
    {
      WPP_SF_d(*((_QWORD *)WPP_GLOBAL_Control + 2), 0x38u, &WPP_c27ef931432c3833a68ea220b2e62ed9_Traceguids, v6);
    }
    AudPolicyLogError("CProcess::ProcessTerminationWatcherCallback", 3957, v6);
  }
}
