...
void __fastcall std::list<std::pair<std::wstring const,std::unique_ptr<CEndpointVolumeState>>>::clear(__int64 a1)
{
  _QWORD *v2; // rsi
  _QWORD *v3; // r14
  __int64 v4; // rdi
