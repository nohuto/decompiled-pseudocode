/*
 * XREFs of ?TsSessionOnLowPowerEpochStateChanged@@YAXXZ @ 0x180026CE0
 * Callers:
 ...
 *     ?TsSessionGetPrimaryConsoleAudioSession@@YAJPEAPEAVTSSession@@@Z @ 0x180025178 (-TsSessionGetPrimaryConsoleAudioSession@@YAJPEAPEAVTSSession@@@Z.c)
  ...
  if ( !(unsigned int)TsSessionGetPrimaryConsoleAudioSession(&v5) )
  {
    ...
    if ( *((_DWORD *)v5 + 57) || g_bLowPowerEpoch || !*((_DWORD *)v5 + 58) || g_bApmSuspended )
    {
      ...
      if ( v4 && (int)QueueApplicationManagerWorkItem<ModernStandbyStateChangedContext>(v3, (__int64)v4) < 0 )
      {
        ...
        {
          WPP_SF_(*((_QWORD *)WPP_GLOBAL_Control + 2), 0x20u, &WPP_0e5291d43ab738b4f1647aff6bbf1d9a_Traceguids);
        }
