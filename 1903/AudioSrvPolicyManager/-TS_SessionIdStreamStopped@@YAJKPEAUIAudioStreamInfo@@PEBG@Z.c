/*
 * XREFs of ?TS_SessionIdStreamStopped@@YAJKPEAUIAudioStreamInfo@@PEBG@Z @ 0x180027260
 * Callers:
...
__int64 __fastcall TS_SessionIdStreamStopped(DWORD a1, struct IAudioStreamInfo *a2, const unsigned __int16 *a3)
{
  ...
  {
    WPP_SF_d(*((_QWORD *)WPP_GLOBAL_Control + 2), 0x28u, &WPP_0e5291d43ab738b4f1647aff6bbf1d9a_Traceguids, a1);
  }
  ...
  if ( v6 )
  {
    ...
    {
      WPP_SF_d(*((_QWORD *)WPP_GLOBAL_Control + 2), 0x29u, &WPP_0e5291d43ab738b4f1647aff6bbf1d9a_Traceguids, v4);
    }
    AudPolicyLogError("TS_SessionIdStreamStopped", 2781, v4);
  }
  if ( v5 )
