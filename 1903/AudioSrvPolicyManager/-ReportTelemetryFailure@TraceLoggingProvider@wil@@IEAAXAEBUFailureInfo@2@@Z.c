/*
 * XREFs of ?ReportTelemetryFailure@TraceLoggingProvider@wil@@IEAAXAEBUFailureInfo@2@@Z @ 0x1800042F4
 * Callers:
        ...
        const struct wil::FailureInfo *a2)
{
  ...
  const unsigned __int16 *v41; // [rsp+D8h] [rbp-30h]
  ...
  const GUID *v54; // [rsp+128h] [rbp+20h]
  ...
  const unsigned __int16 *v62; // [rsp+158h] [rbp+50h]
    ...
    && (*((_QWORD *)v2 + 3) & 0x200000000000LL) == *((_QWORD *)v2 + 3) )
  {
    ...
    v63 = 2 * v5 + 2;
    v64 = 0;
    TlgWrite(v2, &unk_180042BFA, v17, (LPCGUID)v2, 0x11u, &pData);
  }
}
