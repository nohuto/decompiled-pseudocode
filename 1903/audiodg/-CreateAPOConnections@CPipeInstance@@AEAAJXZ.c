/*
 * XREFs of ?CreateAPOConnections@CPipeInstance@@AEAAJXZ @ 0x14000A0E0
 * Callers:
 ...
 *     ?CanDoInPlace@CConnectionInstance@@QEAAHPEAV1@@Z @ 0x14000A3F0 (-CanDoInPlace@CConnectionInstance@@QEAAHPEAV1@@Z.c)
