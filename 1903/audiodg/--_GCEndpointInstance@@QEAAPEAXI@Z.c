/*
 * XREFs of ??_GCEndpointInstance@@QEAAPEAXI@Z @ 0x1400360DC
 * Callers:
 ...
 *     ??1CDeviceProcessNode@@UEAA@XZ @ 0x140035EB4 (--1CDeviceProcessNode@@UEAA@XZ.c)
 *     ??1CStreamProcessNode@@UEAA@XZ @ 0x140035F68 (--1CStreamProcessNode@@UEAA@XZ.c)
 *     ??1?$CAutoPtr@VCEndpointInstance@@@ATL@@QEAA@XZ @ 0x140039324 (--1-$CAutoPtr@VCEndpointInstance@@@ATL@@QEAA@XZ.c)
 * Callees:
