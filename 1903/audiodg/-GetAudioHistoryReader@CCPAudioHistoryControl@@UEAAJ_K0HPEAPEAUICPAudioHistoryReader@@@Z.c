/*
 * XREFs of ?GetAudioHistoryReader@CCPAudioHistoryControl@@UEAAJ_K0HPEAPEAUICPAudioHistoryReader@@@Z @ 0x140051AA0
 * Callers:
 *     <none>
 * Callees:
        ...
        struct ICPAudioHistoryReader **a5)
{
  ...
  v10 = a3;
  v9 = a2;
  v5 = Microsoft::WRL::Details::MakeAndInitialize<CCPAudioHistoryReader,ICPAudioHistoryReader,unsigned __int64 &,unsigned __int64 &,int &,VolatileControlData * &,SharedMessageQueueItem * &,unsigned int &,unsigned int &,unsigned int &>(
         a5,
         &v9,
         &v10,
         &v11,
