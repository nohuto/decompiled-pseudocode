/*
 * XREFs of __scrt_initialize_thread_safe_statics @ 0x1400171A0
 * Callers:
 *     <none>
 * Callees:
...
__int64 _scrt_initialize_thread_safe_statics()
{
  ...
  InitializeCriticalSectionAndSpinCount(&stru_140086D48, 0xFA0u);
...
LABEL_13:
  ...
  {
    hEvent = 0LL;
    ((void (__fastcall *)(void *))ProcAddress)(&unk_140086D70);
    qword_140086D80 = __ROR8__(v2, 64 - ((unsigned __int8)_security_cookie & 0x3Fu)) ^ _security_cookie;
    qword_140086D88 = __ROR8__(v4, 64 - ((unsigned __int8)_security_cookie & 0x3Fu)) ^ _security_cookie;
  }
  else
  {
