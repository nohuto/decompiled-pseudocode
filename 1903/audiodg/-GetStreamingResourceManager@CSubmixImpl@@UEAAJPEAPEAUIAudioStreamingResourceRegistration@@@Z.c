/*
 * XREFs of ?GetStreamingResourceManager@CSubmixImpl@@UEAAJPEAPEAUIAudioStreamingResourceRegistration@@@Z @ 0x140014830
 * Callers:
 *     <none>
 * Callees:
  ...
  *a2 = 0LL;
  ...
  if ( v5 >= 0 )
    ...
    wil::details::in1diag3::Return_Hr(
      ...
      v7);
  wil::com_ptr_t<IAudioVirtualProtectedOutput,wil::err_returncode_policy>::~com_ptr_t<IAudioVirtualProtectedOutput,wil::err_returncode_policy>(&v9);
  return v6;
}
