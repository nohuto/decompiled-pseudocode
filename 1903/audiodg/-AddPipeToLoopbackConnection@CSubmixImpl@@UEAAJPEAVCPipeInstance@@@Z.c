/*
 * XREFs of ?AddPipeToLoopbackConnection@CSubmixImpl@@UEAAJPEAVCPipeInstance@@@Z @ 0x14003DD30
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall CSubmixImpl::AddPipeToLoopbackConnection(CSubmixImpl *this, struct CPipeInstance *a2)
{
  ...
  if ( v5 )
  {
    ...
    v7 = CPipeInstance::ResolvePendingConnections((__int64)a2, *((_QWORD *)LoopbackConnection + 1), 1LL, 0);
    v8 = v7;
    if ( v7 < 0 )
    {
      v9 = 1250LL;
