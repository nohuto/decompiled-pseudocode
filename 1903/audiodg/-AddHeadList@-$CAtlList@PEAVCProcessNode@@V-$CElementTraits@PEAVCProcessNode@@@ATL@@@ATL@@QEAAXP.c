/*
 * XREFs of ?AddHeadList@?$CAtlList@PEAVCProcessNode@@V?$CElementTraits@PEAVCProcessNode@@@ATL@@@ATL@@QEAAXPEBV12@@Z @ 0x140009B20
 * Callers:
  ...
  if ( v3 )
  {
    ...
    do
    {
      ...
      if ( !*(_QWORD *)(a1 + 32) )
      {
        ...
        v9 = *(_DWORD *)(a1 + 40);
        v10 = (_QWORD *)((char *)v8 + 24 * (unsigned int)(v9 - 1) + 8);
        for ( i = v9 - 1; i >= 0; --i )
        {
          *v10 = *(_QWORD *)(a1 + 32);
          *(_QWORD *)(a1 + 32) = v10;
