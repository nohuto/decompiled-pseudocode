/*
 * XREFs of ?GetPosition_Offload@CCrossProcessClientOutputEndpoint@@IEAAJPEA_K0@Z @ 0x140055608
 * Callers:
        ...
        unsigned __int64 *a3)
{
      ...
      *a2 = v34;
      ...
      if ( v23 > v28 )
      {
        if ( (unsigned int)dword_140086000 > 5 )
        {
          ...
          v47 = 8LL;
          v49 = 8LL;
          TlgWrite((TraceLoggingHProvider)&dword_140086000, &unk_1400702E9, 0LL, (LPCGUID)v3, 7u, &pData);
          v28 = v35;
        }
        *a2 = v28;
      }
  ...
  if ( (unsigned int)dword_140086000 > 5 )
  {
    ...
    v57 = &v38;
    v58 = 8LL;
    TlgWrite((TraceLoggingHProvider)&dword_140086000, &unk_140070357, 0LL, (LPCGUID)v3, 6u, &v50);
  }
  if ( v7 < 0 )
  {
