/*
 * XREFs of ?ParseCommandLine@CAudioDGModule@@QEAA_NPEBGPEAJ@Z @ 0x14002ADA4
 * Callers:
 ...
 *     ?ValidateInheritedHandle@CAudioDGModule@@QEAA_NPEAX@Z @ 0x14002BC1C (-ValidateInheritedHandle@CAudioDGModule@@QEAA_NPEAX@Z.c)
 */
