/*
 * XREFs of McTemplateU0pqqq @ 0x140056D2C
 * Callers:
...
{
  char v7[16]; // [rsp+38h] [rbp-19h] BYREF
  ...
  v14 = &a6;
  v15 = 4LL;
  return McGenEventWrite(a1, (__int64)&EVT_GLITCH_CP_SERVER_OUTPUT_READ_POINTER_OVERWRITE, a3, 5, (__int64)v7);
}
