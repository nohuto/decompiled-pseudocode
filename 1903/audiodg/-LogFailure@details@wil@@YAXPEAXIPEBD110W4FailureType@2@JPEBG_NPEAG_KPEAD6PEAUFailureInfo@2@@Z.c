/*
 * XREFs of ?LogFailure@details@wil@@YAXPEAXIPEBD110W4FailureType@2@JPEBG_NPEAG_KPEAD6PEAUFailureInfo@2@@Z @ 0x140027740
 * Callers:
 ...
 * Callees:
 *     ?RecordFailFast@details@wil@@YAHJ@Z @ 0x140014AC0 (-RecordFailFast@details@wil@@YAHJ@Z.c)
 ...
 *     ?RecordException@details@wil@@YAHJ@Z @ 0x140027D18 (-RecordException@details@wil@@YAHJ@Z.c)
 *     ?RecordLog@details@wil@@YAHJ@Z @ 0x140027D34 (-RecordLog@details@wil@@YAHJ@Z.c)
 *     ?RecordReturn@details@wil@@YAHJ@Z @ 0x140027D50 (-RecordReturn@details@wil@@YAHJ@Z.c)
 ...
 *     ?_FailFastImmediate_Unexpected@in1diag3@details@wil@@YAXXZ @ 0x140028D98 (-_FailFastImmediate_Unexpected@in1diag3@details@wil@@YAXXZ.c)
 */
