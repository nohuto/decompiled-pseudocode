/*
 * XREFs of ?SetCurrentTimeStamp@CCrossProcessBaseEndpoint@@MEAAXPEAUAE_CURRENT_POSITION@@_J@Z @ 0x1400119B0
 * Callers:
 *     <none>
 * Callees:
        ...
        __int64 a3)
{
  ...
  *(struct AE_CURRENT_POSITION *)(v5 + *((_QWORD *)this + 9) + 32) = *a2;
  ...
  if ( (unsigned int)dword_140086000 > 5 )
  {
    ...
    v9[0] = 184549376;
    v10 = 0LL;
    v12 = *(unsigned __int16 *)off_140086008;
    v14 = &unk_14006FF91;
    v13 = 2;
    v15 = 112;
    v16 = 1;
    v7[1] = (unsigned int)&TraceLoggingMetadataEnd - (unsigned int)&TraceLoggingMetadata;
    EtwEventWriteTransfer(qword_140086020, v9, 0LL, 0LL, 9, &v11);
  }
}
