/*
 * XREFs of ?LogGrantCompleted@CSpatialCrossProcessEndpointTraceLogger@@QEAAXI@Z @ 0x14005A188
 * Callers:
        ...
        const GUID *a4)
{
  ...
  if ( (unsigned int)dword_140086100 > 5 )
  {
    ...
    v10 = 0;
    v9 = 4;
    TlgWrite((TraceLoggingHProvider)&dword_140086100, &unk_1400709EF, 0LL, a4, 4u, &v4);
  }
}
