/*
 * XREFs of ?GetGrantedObjectCount@CSpatialCrossProcessBaseEndpoint@@UEAAJPEAI@Z @ 0x14005C0A0
 * Callers:
 *     <none>
 * Callees:
        ...
        const GUID *a4)
{
  ...
  if ( !a2 )
  {
    v5 = -2147467261;
LABEL_5:
    SpatialCPTraceLoggingErrorHelper("CSpatialCrossProcessBaseEndpoint::GetGrantedObjectCount", 1071, v5);
    return v5;
  }
