/*
 * XREFs of ?GetDescription@CProtectedOutputController@@UEAAJPEAKPEAU_GUID@@0PEAPEAU2@@Z @ 0x1400368A0
 * Callers:
 *     <none>
 * Callees:
        ...
        struct _GUID **a5)
{
  ...
  {
    WPP_SF_D(*((_QWORD *)WPP_GLOBAL_Control + 2), 0xBu, (__int64)&WPP_6aaeadc0d6c13bd136ce8c586a8020b6_Traceguids, v5);
  }
