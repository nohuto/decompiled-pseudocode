/*
 * XREFs of ??$MakeAndInitialize@VCCPAudioHistoryControl@@UICPAudioHistoryControl@@AEAPEAUICrossProcessMemory@@@Details@WRL@Microsoft@@YAJPEAPEAUICPAudioHistoryControl@@AEAPEAUICrossProcessMemory@@@Z @ 0x140051820
 * Callers:
 ...
 *     ??0CCPAudioHistoryControl@@QEAA@XZ @ 0x1400518E8 (--0CCPAudioHistoryControl@@QEAA@XZ.c)
