/*
 * XREFs of ?LogClientIndexMap@CSpatialCrossProcessEndpointTraceLogger@@QEAAXIII_NJ@Z @ 0x140059D30
 * Callers:
        ...
        char a6)
{
  ...
  if ( (unsigned int)dword_140086100 > 5 )
  {
    ...
    v19 = 4LL;
    v21 = 4LL;
    TlgWrite((TraceLoggingHProvider)&dword_140086100, &unk_140070A2D, 0LL, a4, 9u, &pData);
  }
}
