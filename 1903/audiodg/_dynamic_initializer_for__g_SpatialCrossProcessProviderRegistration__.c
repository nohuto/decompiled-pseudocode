/*
 * XREFs of _dynamic_initializer_for__g_SpatialCrossProcessProviderRegistration__ @ 0x140001290
 * Callers:
 *     <none>
 * Callees:
...
int __fastcall dynamic_initializer_for__g_SpatialCrossProcessProviderRegistration__(
        __int64 a1,
        ...
        void *a3)
{
  TraceLoggingRegisterEx((TraceLoggingHProvider)&dword_140086100, a2, a3);
