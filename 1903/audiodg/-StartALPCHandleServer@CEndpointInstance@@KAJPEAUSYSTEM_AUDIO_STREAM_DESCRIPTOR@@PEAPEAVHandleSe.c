/*
 * XREFs of ?StartALPCHandleServer@CEndpointInstance@@KAJPEAUSYSTEM_AUDIO_STREAM_DESCRIPTOR@@PEAPEAVHandleSendReceiveServer@@@Z @ 0x140039C38
 * Callers:
 ...
 *     WPP_SF_dD @ 0x140039E74 (WPP_SF_dD.c)
  ...
  *a2 = (struct HandleSendReceiveServer *)v5;
  ...
  if ( v8 < 0 )
  {
    if ( v9 != &WPP_GLOBAL_Control && (*((_DWORD *)v9 + 7) & 0x20000) != 0 && *((_BYTE *)v9 + 25) >= 2u )
      WPP_SF_D((__int64)v9[2], 0xCu, (__int64)&WPP_0ba2ce53590232a88bdc3af682a35f09_Traceguids, v8);
    AudDGTraceLoggingErrorHelper("CEndpointInstance::StartALPCHandleServer", 0x2A5u, v8);
  }
