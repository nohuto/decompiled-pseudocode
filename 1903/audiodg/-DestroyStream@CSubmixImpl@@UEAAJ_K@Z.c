/*
 * XREFs of ?DestroyStream@CSubmixImpl@@UEAAJ_K@Z @ 0x14003DF10
 * Callers:
 *     ?DestroyStream@CStreamGroup@@UEAAJ_K@Z @ 0x14002A760 (-DestroyStream@CStreamGroup@@UEAAJ_K@Z.c)
 *     ?DestroyStream@CProcessSubmix@@UEAAJ_K@Z @ 0x14003F2E0 (-DestroyStream@CProcessSubmix@@UEAAJ_K@Z.c)
 * Callees:
 ...
 *     ?RemoveAt@?$CAtlList@PEAVCChildSubmixInstance@@V?$CElementTraits@PEAVCChildSubmixInstance@@@ATL@@@ATL@@QEAAXPEAU__POSITION@@@Z @ 0x14002F36C (-RemoveAt@-$CAtlList@PEAVCChildSubmixInstance@@V-$CElementTraits@PEAVCChildSubmixInstance@@@ATL@.c)
