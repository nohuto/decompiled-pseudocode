/*
 * XREFs of ?AudCPTraceLoggingErrorHelper@@YAXPEBDIJ@Z @ 0x140053DD8
 * Callers:
...
void __fastcall AudCPTraceLoggingErrorHelper(const char *a1, unsigned int a2, int a3)
{
  ...
  *(_DWORD *)pRelatedActivityId.Data4 = a3;
  ...
  if ( (unsigned int)dword_140086000 > 2 )
  {
    if ( TlgKeywordOn((TraceLoggingHProvider)&dword_140086000, 1uLL) )
    {
      ...
      TlgWrite((TraceLoggingHProvider)&dword_140086000, &unk_1400702BA, 0LL, &pRelatedActivityId, 5u, &pData);
    }
  }
}
