/*
 * XREFs of ?InitializeCPMemory@CSpatialCrossProcessBaseEndpoint@@IEAAJPEAUICrossProcessMemoryManager@@PEBGIIIIPEAPEAUICrossProcessMemory@@@Z @ 0x14005C838
 * Callers:
 ...
 *     ?Create@SpatialBlock@@QEAAJPEAEIIIII@Z @ 0x14005BCA0 (-Create@SpatialBlock@@QEAAJPEAEIIIII@Z.c)
