/*
 * XREFs of ?Initialize@SpatialBlock@@QEAAJPEAEI@Z @ 0x14005C7C8
 * Callers:
 ...
 * Callees:
 *     ?GetMemoryRequirement@SpatialBlock@@SAIIIII@Z @ 0x14005C15C (-GetMemoryRequirement@SpatialBlock@@SAIIIII@Z.c)
 *     ?SetPointersFromDescriptor@SpatialBlock@@AEAAXXZ @ 0x14005D28C (-SetPointersFromDescriptor@SpatialBlock@@AEAAXXZ.c)
 *     ?ValidateDescriptor@SpatialBlock@@QEAAJXZ @ 0x14005D46C (-ValidateDescriptor@SpatialBlock@@QEAAJXZ.c)
 */
