/*
 * XREFs of ?ReleaseInputDataPointer@CSpatialCrossProcessServerInputEndpoint@@UEAAXI_K@Z @ 0x14005FDE0
 * Callers:
 *     <none>
 * Callees:
 ...
 *     ?CommitRead@CSpatialCrossProcessBaseEndpoint@@IEAAJI@Z @ 0x14005BAC0 (-CommitRead@CSpatialCrossProcessBaseEndpoint@@IEAAJI@Z.c)
 */
