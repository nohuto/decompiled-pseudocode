/*
 * XREFs of ?LogEmptyBufferCount@CSpatialCrossProcessEndpointTraceLogger@@QEAAXI@Z @ 0x140059E24
 * Callers:
        ...
        const GUID *a4)
{
  ...
  if ( (unsigned int)dword_140086100 > 5 )
  {
    ...
    v10 = 0;
    v9 = 4;
    TlgWrite((TraceLoggingHProvider)&dword_140086100, &unk_1400708ED, 0LL, a4, 4u, &v4);
  }
}
