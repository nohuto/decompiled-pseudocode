/*
 * XREFs of ??1?$unique_any_t@V?$unique_storage@U?$handle_null_resource_policy@P6AHPEAX@Z$1?CloseHandle@@YAH0@Z@details@wil@@@details@wil@@@wil@@QEAA@XZ @ 0x140001924
 * Callers:
 ...
 *     _CAudioDGModule::CAudioDGModule_::_1_::dtor$3 @ 0x140015398 (_CAudioDGModule--CAudioDGModule_--_1_--dtor$3.c)
 *     _CEndpointInstance::CreateDeviceEndpointInstance_::_1_::dtor$14 @ 0x14001B1D5 (_CEndpointInstance--CreateDeviceEndpointInstance_--_1_--dtor$14.c)
 * Callees:
 *     <none>
 */
