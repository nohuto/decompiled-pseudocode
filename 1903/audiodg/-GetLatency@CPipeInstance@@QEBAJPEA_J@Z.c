/*
 * XREFs of ?GetLatency@CPipeInstance@@QEBAJPEA_J@Z @ 0x14000BAA0
 * Callers:
      ...
      if ( *(_DWORD *)(v5 + 40) == 2 )
      {
        ...
        if ( *(_DWORD *)(v14 + 4) )
        {
          ...
          if ( InitOnceBeginInitialize(&`AudioDgTelemetryProvider::Instance'::`2'::wrapper, 0, &v20, &v23) && v20 )
          {
            ...
            byte_140086EF8 = 1;
            TraceLoggingRegisterEx(qword_140086F00, v16, v17);
            dword_140086EFC = 1;
          ...
          if ( *(_DWORD *)v18 > 2u )
          {
            ...
            v21 = v6;
            v43 = 4LL;
            TlgWrite(v18, &unk_14006FA20, 0LL, v15, 4u, &pData);
          }
        }
      }
    }
      ...
      if ( *(_DWORD *)(v5 + 40) == 2 )
      {
        ...
        if ( *(_DWORD *)(v7 + 4) )
        {
            ...
            && fPending )
          {
            ...
            qword_140086EF0 = (__int64)qword_140086F00;
            byte_140086EF8 = 1;
            TraceLoggingRegisterEx(qword_140086F00, v12, v13);
            dword_140086EFC = 1;
            (*(void (__fastcall **)(__int64 *))(qword_140086EE8 + 8))(&qword_140086EE8);
            InitOnceComplete(&`AudioDgTelemetryProvider::Instance'::`2'::wrapper, 0, &qword_140086EE8);
          }
