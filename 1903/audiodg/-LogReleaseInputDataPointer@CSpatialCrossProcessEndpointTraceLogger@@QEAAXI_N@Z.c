/*
 * XREFs of ?LogReleaseInputDataPointer@CSpatialCrossProcessEndpointTraceLogger@@QEAAXI_N@Z @ 0x14005A2C4
 * Callers:
        ...
        const GUID *a4)
{
  ...
  if ( (unsigned int)dword_140086100 > 5 )
  {
    ...
    v9 = 4LL;
    v11 = 4LL;
    TlgWrite((TraceLoggingHProvider)&dword_140086100, &unk_14007089C, 0LL, a4, 5u, &pData);
  }
}
