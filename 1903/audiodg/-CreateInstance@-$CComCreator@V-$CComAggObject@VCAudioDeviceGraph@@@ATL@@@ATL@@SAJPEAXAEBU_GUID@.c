/*
 * XREFs of ?CreateInstance@?$CComCreator@V?$CComAggObject@VCAudioDeviceGraph@@@ATL@@@ATL@@SAJPEAXAEBU_GUID@@PEAPEAX@Z @ 0x140026B0C
 * Callers:
 ...
 *     ??0?$CComAggObject@VCAudioDeviceGraph@@@ATL@@QEAA@PEAX@Z @ 0x140026070 (--0-$CComAggObject@VCAudioDeviceGraph@@@ATL@@QEAA@PEAX@Z.c)
 */
        ...
        _QWORD *a3)
{
  ...
  try
  {
    *a3 = 0LL;
    ...
    if ( v8 )
      v9 = ATL::CComAggObject<CAudioDeviceGraph>::CComAggObject<CAudioDeviceGraph>((__int64)v8, a1);
    else
      v9 = 0LL;
    v12 = v9;
  }
  ...
  if ( v9 )
  {
    v10 = ATL::CComCriticalSection::Init((struct _RTL_CRITICAL_SECTION *)(v9 + 56));
    if ( v10 >= 0 )
    {
      *(_BYTE *)(v9 + 96) = 1;
      v10 = 0;
