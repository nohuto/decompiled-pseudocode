/*
 * XREFs of ?RuntimeClassInitialize@CCPAudioHistoryReader@@QEAAJ_K0HPEAUVolatileControlData@@PEAUSharedMessageQueueItem@@III@Z @ 0x140017994
 * Callers:
  ...
  *((_DWORD *)this + 22) = v14;
  ...
  if ( a3 != v53 )
  {
    if ( (unsigned int)dword_140086000 > 5 )
    {
      ...
      v47 = 8;
      v50 = 8;
      TlgWrite((TraceLoggingHProvider)&dword_140086000, &unk_14006FEC6, 0LL, a4, 8u, &pData);
      v17 = v53;
      v16 = v31;
    }
    v18 = v30;
