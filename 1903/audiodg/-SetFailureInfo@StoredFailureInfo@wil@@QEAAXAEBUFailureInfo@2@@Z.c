/*
 * XREFs of ?SetFailureInfo@StoredFailureInfo@wil@@QEAAXAEBUFailureInfo@2@@Z @ 0x1400283FC
 * Callers:
 ...
 *     ?create@shared_buffer@details@wil@@QEAA_NPEBX_K@Z @ 0x140028E7C (-create@shared_buffer@details@wil@@QEAA_NPEBX_K@Z.c)
