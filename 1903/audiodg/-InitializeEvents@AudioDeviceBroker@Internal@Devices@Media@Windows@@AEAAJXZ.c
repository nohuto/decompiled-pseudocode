/*
 * XREFs of ?InitializeEvents@AudioDeviceBroker@Internal@Devices@Media@Windows@@AEAAJXZ @ 0x140049600
 * Callers:
 ...
 *     ?AtlHresultFromLastError@ATL@@YAJXZ @ 0x140046B64 (-AtlHresultFromLastError@ATL@@YAJXZ.c)
 */
