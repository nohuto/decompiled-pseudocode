/*
 * XREFs of ?Create@CAudioMediaType@@SAJPEBUtWAVEFORMATEX@@IPEAPEAUIAudioMediaType@@MH@Z @ 0x140007180
 * Callers:
 ...
 * Callees:
 *     ??0CAudioMediaType@@IEAA@XZ @ 0x140007408 (--0CAudioMediaType@@IEAA@XZ.c)
 *     ?IsValidFloatWfx@@YAHPEBUtWAVEFORMATEX@@@Z @ 0x14000743C (-IsValidFloatWfx@@YAHPEBUtWAVEFORMATEX@@@Z.c)
 *     ?IsValidPcmWfx@@YAHPEBUtWAVEFORMATEX@@@Z @ 0x14001419C (-IsValidPcmWfx@@YAHPEBUtWAVEFORMATEX@@@Z.c)
