/*
 * XREFs of ??1CWin32Heap@ATL@@UEAA@XZ @ 0x1400153C4
 * Callers:
 *     ATL::_dynamic_atexit_destructor_for__g_strheap__ @ 0x14001B4F0 (ATL--_dynamic_atexit_destructor_for__g_strheap__.c)
