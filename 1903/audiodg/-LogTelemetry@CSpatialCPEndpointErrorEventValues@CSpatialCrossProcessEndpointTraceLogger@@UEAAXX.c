/*
 * XREFs of ?LogTelemetry@CSpatialCPEndpointErrorEventValues@CSpatialCrossProcessEndpointTraceLogger@@UEAAXXZ @ 0x14005A690
 * Callers:
 *     <none>
 * Callees:
        ...
        CSpatialCrossProcessEndpointTraceLogger::CSpatialCPEndpointErrorEventValues *this)
{
  ...
  if ( *((_QWORD *)this + 1) && *((_QWORD *)this + 2) && *((_QWORD *)this + 3) )
  {
    ...
    if ( **((_BYTE **)this + 1) )
    {
      if ( *(_DWORD *)v4 > 3u )
      {
        if ( TlgKeywordOn(v4, 0x200000000000uLL) )
        {
          ...
          v23 = 4LL;
          v25 = 4LL;
          TlgWrite(v5, &unk_140070637, 0LL, v6, 8u, &pData);
        }
      }
    }
    else if ( *(_DWORD *)v4 > 3u && TlgKeywordOn(v4, 0x400000000000uLL) )
    {
      ...
      v23 = 4LL;
      v25 = 4LL;
      TlgWrite(v7, &unk_1400706D4, 0LL, v8, 8u, &pData);
    }
  }
}
