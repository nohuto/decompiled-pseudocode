  ...
  *a4 = 0LL;
  ...
  if ( v11 >= 0 )
  {
    ...
    *a4 = a2;
    ...
    Microsoft::WRL::ComPtr<Microsoft::WRL::Details::EventTargetArray>::operator=((__int64 *)&v19, (char *)a1);
