/*
 * XREFs of ?LogTelemetry@CSpatialAudioObjectCountValues@CSpatialCrossProcessEndpointTraceLogger@@UEAAXXZ @ 0x14005A500
 * Callers:
 *     <none>
 * Callees:
 ...
 *     ?StdDev@?$CSimplePerfCounterAggregateValues@W4SpatialObjectCountTypes@@I$01@@QEAANW4SpatialObjectCountTypes@@@Z @ 0x14005ADB4 (-StdDev@-$CSimplePerfCounterAggregateValues@W4SpatialObjectCountTypes@@I$01@@QEAANW4SpatialObjec.c)
 */
        ...
        CSpatialCrossProcessEndpointTraceLogger::CSpatialAudioObjectCountValues *this)
{
  ...
  if ( *(_DWORD *)*v1 > 4u && TlgKeywordOn(*v1, 0x400000000000uLL) )
  {
    ...
    v32 = &v10;
    v33 = 8LL;
    TlgWrite(v3, &unk_140070447, 0LL, v6, 0xDu, &pData);
  }
}
