/*
 * XREFs of ??$MakeAndInitialize@VCpuManager@@V1@$$V@Details@WRL@Microsoft@@YAJPEAPEAVCpuManager@@@Z @ 0x14002C390
 * Callers:
 *     ?InitializeCpuManager@@YAJXZ @ 0x14002D5F8 (-InitializeCpuManager@@YAJXZ.c)
 * Callees:
...
__int64 __fastcall Microsoft::WRL::Details::MakeAndInitialize<CpuManager,CpuManager,>(CpuManager **a1)
{
  ...
  CpuManager *v3; // rax
  CpuManager *v4; // rbx
  _OWORD v6[10]; // [rsp+40h] [rbp-C8h] BYREF
  __int64 v7; // [rsp+E0h] [rbp-28h]
  CpuManager *v8; // [rsp+118h] [rbp+10h] BYREF
  CpuManager *v9; // [rsp+120h] [rbp+18h]
