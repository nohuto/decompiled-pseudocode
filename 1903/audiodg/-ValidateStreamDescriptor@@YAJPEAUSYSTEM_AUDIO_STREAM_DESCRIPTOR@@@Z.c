/*
 * XREFs of ?ValidateStreamDescriptor@@YAJPEAUSYSTEM_AUDIO_STREAM_DESCRIPTOR@@@Z @ 0x1400143AC
 * Callers:
 ...
 * Callees:
 *     ?ValidateWaveFormatEx@@YAJPEBUtWAVEFORMATEX@@@Z @ 0x140006FD0 (-ValidateWaveFormatEx@@YAJPEBUtWAVEFORMATEX@@@Z.c)
 */
...
__int64 __fastcall ValidateStreamDescriptor(struct SYSTEM_AUDIO_STREAM_DESCRIPTOR *a1)
{
  ...
  if ( !v2 )
    return 2147500035LL;
  if ( v1 < 0x28 && v2->wFormatTag == 0xFFFE )
    return 2147942487LL;
