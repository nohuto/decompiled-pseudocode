/*
 * XREFs of McTemplateU0pqxxxxffff @ 0x1400537E4
 * Callers:
 *     ?GetCurrentPadding@CCrossProcessBaseEndpoint@@UEAAXPEA_JPEAUAE_CURRENT_POSITION@@@Z @ 0x140052370 (-GetCurrentPadding@CCrossProcessBaseEndpoint@@UEAAXPEA_JPEAUAE_CURRENT_POSITION@@@Z.c)
...
__int64 __fastcall McTemplateU0pqxxxxffff(
        __int64 a1,
        __int64 a2,
        __int64 a3,
        int a4,
        ...
        char a12)
{
  char v13[16]; // [rsp+30h] [rbp-A9h] BYREF
  ...
  v31 = 4LL;
  v33 = 4LL;
  return McGenEventWrite(a1, (__int64)&AudioCore_AEGeneric, a3, 11, (__int64)v13);
}
