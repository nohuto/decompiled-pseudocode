/*
 * XREFs of ?FallbackTelemetryCallback@AudioDgTelemetryProvider@@SAX_NAEBUFailureInfo@wil@@@Z @ 0x14002A7D0
 * Callers:
 *     <none>
 * Callees:
...
void __fastcall AudioDgTelemetryProvider::FallbackTelemetryCallback(char a1, const struct wil::FailureInfo *a2)
{
  ...
  v10 = 0LL;
  if ( InitOnceBeginInitialize(&`AudioDgTelemetryProvider::Instance'::`2'::wrapper, 0, &v9, (LPVOID *)&v10) && v9 )
  {
    ...
    v8 = 0;
    wil::details::static_lazy<AudioDgTelemetryProvider>::Completer::~Completer((unsigned int *)&v7, v5, v6);
  }
  LOBYTE(v4) = a1;
