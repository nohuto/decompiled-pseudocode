/*
 * XREFs of ?GetLatency@CSpatialCrossProcessBaseEndpoint@@UEAAJPEA_J@Z @ 0x14005C110
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall CSpatialCrossProcessBaseEndpoint::GetLatency(CSpatialCrossProcessBaseEndpoint *this, __int64 *a2)
{
  ...
  SpatialCPTraceLoggingErrorHelper("CSpatialCrossProcessBaseEndpoint::GetLatency", 430, v2);
  return v2;
}
