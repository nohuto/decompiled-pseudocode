/*
 * XREFs of ?GetStreamStatus@CSpatialCrossProcessClientOutputEndpoint@@UEAAJPEAW4SpatialStreamStatus@@@Z @ 0x14005ED90
 * Callers:
 *     <none>
 * Callees:
        ...
        enum SpatialStreamStatus *a2)
{
  ...
  SpatialCPTraceLoggingErrorHelper("CSpatialCrossProcessClientOutputEndpoint::GetStreamStatus", 286, v2);
  return v2;
}
