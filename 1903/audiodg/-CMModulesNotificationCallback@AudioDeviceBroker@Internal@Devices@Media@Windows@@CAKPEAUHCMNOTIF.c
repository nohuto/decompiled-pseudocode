/*
 * XREFs of ?CMModulesNotificationCallback@AudioDeviceBroker@Internal@Devices@Media@Windows@@CAKPEAUHCMNOTIFICATION__@@PEAXW4_CM_NOTIFY_ACTION@@PEAU_CM_NOTIFY_EVENT_DATA@@K@Z @ 0x140046B90
 * Callers:
 *     <none>
 * Callees:
        ...
        unsigned int a5)
{
  ...
  __int64 v15[3]; // [rsp+28h] [rbp-48h] BYREF
