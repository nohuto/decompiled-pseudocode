/*
 * XREFs of ?OnLeftSubmixConnected@CSystemAudioDeviceSharedBase@@UEAAJPEAUISubmixInternal@@@Z @ 0x14000E2B0
 * Callers:
 *     <none>
 * Callees:
        ...
        struct ISubmixInternal *a2)
{
  ...
  *((_DWORD *)this + 10) = v3;
  ...
  {
    WPP_SF_D(*((_QWORD *)WPP_GLOBAL_Control + 2), 27LL, &WPP_f525e75cdaa43c3aecad76b58ec104af_Traceguids, v3);
  }
  if ( v6 )
