/*
 * XREFs of ?InitialRegisterForProcess@CpuManager@@EEAAJPEAXPEAURegistrationData@HandleRegistrations@1@@Z @ 0x14002D320
 * Callers:
 *     <none>
 * Callees:
        ...
        struct CpuManager::HandleRegistrations::RegistrationData *a3)
{
  ...
  if ( DuplicateHandle(v7, a2, CurrentProcess, &TargetHandle, 0x2000u, 0, 0) )
  {
    ...
    {
      v15 = (char *)this + 464;
      v14 = RtlPublishWnfStateData(WNF_AUDC_CPUSET_ID, 0LL, (char *)this + 448, 16LL, TargetHandle);
      if ( v14 >= 0 )
      {
        v14 = RtlPublishWnfStateData(WNF_AUDC_CPUSET_ID_SYSTEM, 0LL, v15, 4LL, 0LL);
        if ( v14 >= 0 )
        {
          v9 = 0;
      ...
      RtlPublishWnfStateData(WNF_AUDC_CPUSET_ID_SYSTEM, 0LL, v15, 4LL, 0LL);
    }
    v9 = v14 | 0x10000000;
  }
  else
