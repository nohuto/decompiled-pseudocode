/*
 * XREFs of ?LogAsarUsageReporting@CSpatialCrossProcessEndpointTraceLogger@@QEAAXII@Z @ 0x140059C34
 * Callers:
 *     ?SetObjectUsageCounts@CSpatialCrossProcessBaseEndpoint@@UEAAJII@Z @ 0x14005D1F0 (-SetObjectUsageCounts@CSpatialCrossProcessBaseEndpoint@@UEAAJII@Z.c)
 * Callees:
        ...
        const GUID *a4)
{
  ...
  if ( (unsigned int)dword_140086100 > 5 )
  {
    ...
    v15 = 4LL;
    v17 = 4LL;
    TlgWrite((TraceLoggingHProvider)&dword_140086100, &unk_140070A87, 0LL, a4, 5u, &pData);
    a2 = v9;
    v4 = v10;
  }
  LOBYTE(cData) = 1;
