/*
 * XREFs of ?RemoveAt@?$CAtlList@PEAVCProcessNode@@V?$CElementTraits@PEAVCProcessNode@@@ATL@@@ATL@@QEAAXPEAU__POSITION@@@Z @ 0x140003F50
 * Callers:
 *     ?RemoveDummyProcessNodes@CPipeInstance@@AEAAXXZ @ 0x140003EE4 (-RemoveDummyProcessNodes@CPipeInstance@@AEAAXXZ.c)
