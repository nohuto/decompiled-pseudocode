/*
 * XREFs of ?AddAudioHistoryPacket@CCrossProcessServerOutputEndpoint@@UEAAJIUAE_CURRENT_POSITION@@W4APO_BUFFER_FLAGS@@_K@Z @ 0x140055E30
 * Callers:
 *     <none>
 * Callees:
        ...
        void *Src)
{
  ...
  if ( *(_DWORD *)(v5 + 180) == -1 )
    _InterlockedExchange(
      ...
      *(_DWORD *)(*((_QWORD *)this - 50) + 160LL));
  v9 = *((_QWORD *)this - 51);
  v23 = *(_DWORD *)(v9 + 188);
  v10 = *(_DWORD *)(v9 + 184);
  v11 = *(_DWORD *)(*((_QWORD *)this - 50) + 140LL);
...
LABEL_5:
  ...
  v15 = (const GUID *)*((unsigned int *)this - 98);
  if ( v23 )
  {
    v17 = *(_DWORD *)(((unsigned __int64)(v23 - 1) << 6) + *((_QWORD *)this - 44) + 4)
        + (_DWORD)v15 * *(_DWORD *)(((unsigned __int64)(v23 - 1) << 6) + *((_QWORD *)this - 44) + 56);
    v16 = *((_QWORD *)this - 50);
  }
  else
  {
  ...
  if ( v17 + (_DWORD)v15 * v25 <= *(_DWORD *)(v16 + 168) && a4 )
  {
    ...
    if ( (unsigned int)dword_140086000 > 5 )
    {
      ...
      v44 = 4;
      v47 = 8;
      TlgWrite((TraceLoggingHProvider)&dword_140086000, &unk_1400703A9, 0LL, v15, 9u, &pData);
      v17 = v24;
    }
    v20 = (void *)(*((_QWORD *)this - 51) + v17);
    if ( a4 == BUFFER_SILENT )
      memset_0(v20, 0, v18);
    else
      memcpy_0(v20, Src, v18);
    *(_DWORD *)(((unsigned __int64)v23 << 6) + *((_QWORD *)this - 44)) = 1;
    *(_DWORD *)(((unsigned __int64)v23 << 6) + *((_QWORD *)this - 44) + 4) = v24;
    *(_DWORD *)(((unsigned __int64)v23 << 6) + *((_QWORD *)this - 44) + 56) = v25;
    v21 = *((_QWORD *)this - 44);
    ...
    *(_DWORD *)(((unsigned __int64)v23 << 6) + *((_QWORD *)this - 44) + 8) = a4;
    _InterlockedExchange((volatile __int32 *)(*((_QWORD *)this - 51) + 188LL), v19);
  }
  return 0LL;
}
