/*
 * XREFs of ?InitializeCpuManager@@YAJXZ @ 0x14002D5F8
 * Callers:
...
__int64 InitializeCpuManager(void)
{
  ...
  return Microsoft::WRL::Details::MakeAndInitialize<CpuManager,CpuManager,>((CpuManager **)&qword_140087010);
}
