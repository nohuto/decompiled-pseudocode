/*
 * XREFs of ?GetFormat@CSystemAudioDeviceSharedBase@@UEAAJ_KPEAPEAUtWAVEFORMATEX@@@Z @ 0x140031D90
 * Callers:
 *     <none>
 * Callees:
        ...
        struct tWAVEFORMATEX **a3)
{
  ...
  if ( v5 < 0 )
  {
    ...
    AudDGTraceLoggingErrorHelper("CSystemAudioDeviceSharedBase::GetFormat", 0x254u, v5);
  }
  if ( v8 )
