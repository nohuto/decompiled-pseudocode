/*
 * XREFs of ?AeSendDuplicateHandle@HandleSendReceiveClient@@AEAAJPEAXPEAU_AE_API_MSG@@K0@Z @ 0x1400414C8
 * Callers:
  ...
  if ( (int)result >= 0 )
  {
    ...
    if ( MessageAttribute )
    {
      ...
      *(_DWORD *)(MessageAttribute + 20) = 1048578;
      v9 = 48LL;
      result = ((__int64 (__fastcall *)(void *, __int64, struct _AE_API_MSG *, _BYTE *, struct _AE_API_MSG *, __int64 *, _QWORD, _QWORD))NtAlpcSendWaitReceivePort)(
                 a2,
                 0x20000LL,
                 a3,
                 v11,
