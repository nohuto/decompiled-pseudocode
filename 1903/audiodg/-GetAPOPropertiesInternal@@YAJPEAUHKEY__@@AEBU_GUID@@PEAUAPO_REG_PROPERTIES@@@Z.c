/*
 * XREFs of ?GetAPOPropertiesInternal@@YAJPEAUHKEY__@@AEBU_GUID@@PEAUAPO_REG_PROPERTIES@@@Z @ 0x1400402F0
 * Callers:
 ...
 *     ?GetApoRegKeyPath@@YAJPEAGIPEBG@Z @ 0x1400403C8 (-GetApoRegKeyPath@@YAJPEAGIPEBG@Z.c)
 */
