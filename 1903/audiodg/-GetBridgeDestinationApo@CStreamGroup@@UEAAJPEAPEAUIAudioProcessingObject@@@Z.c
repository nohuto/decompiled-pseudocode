/*
 * XREFs of ?GetBridgeDestinationApo@CStreamGroup@@UEAAJPEAPEAUIAudioProcessingObject@@@Z @ 0x14003CB10
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall CStreamGroup::GetBridgeDestinationApo(CStreamGroup *this, struct IAudioProcessingObject **a2)
{
  ...
  *a2 = 0LL;
  ...
  if ( v2 )
    CPipeInstance::GetAPONodeAndConnection(v2, &GUID_25385759_3236_4101_a943_25693dfb5d2d, 0LL, 0LL, a2);
  return 0LL;
}
