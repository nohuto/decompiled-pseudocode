/*
 * XREFs of ??$MakeAndInitialize@VCStandardEvent@@UICrossProcessEvent@@PEAX@Details@WRL@Microsoft@@YAJPEAPEAUICrossProcessEvent@@$$QEAPEAX@Z @ 0x140036EE8
 * Callers:
 ...
 *     ??0CStandardEvent@@QEAA@XZ @ 0x140036F78 (--0CStandardEvent@@QEAA@XZ.c)
 */
