/*
 * XREFs of ?GetMute@CSystemAudioDeviceOffloadGraph@@UEAAJPEAE@Z @ 0x140033C40
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall CSystemAudioDeviceOffloadGraph::GetMute(CSystemAudioDeviceOffloadGraph *this, unsigned __int8 *a2)
{
  ...
  if ( v4 < 0 )
  {
    ...
    {
      WPP_SF_D(*((_QWORD *)WPP_GLOBAL_Control + 2), 0xEu, (__int64)&WPP_93f76506177b37e92d7cbf41d5171680_Traceguids, v4);
    }
