/*
 * XREFs of ?RuntimeClassInitialize@EventTargetArray@Details@WRL@Microsoft@@QEAAJ_K@Z @ 0x1400024F4
 * Callers:
 ...
 *     ??_L@YAXPEAX_K1P6AX0@Z2@Z @ 0x1400174FC (--_L@YAXPEAX_K1P6AX0@Z2@Z.c)
