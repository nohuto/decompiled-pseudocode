/*
 * XREFs of ?ReleaseOutputDataPointer@CCrossProcessClientOutputEndpoint@@UEAAXPEBUAPO_CONNECTION_PROPERTY@@@Z @ 0x1400559E0
 * Callers:
 *     <none>
 * Callees:
        ...
        const struct APO_CONNECTION_PROPERTY *a2)
{
  ...
  if ( (byte_140087281 & 4) != 0 )
    McTemplateU0pqxxx((__int64)this, (__int64)a2, (__int64)this - 448, 19, u32ValidFrameCount, v7, 0);
  if ( CCrossProcessBaseEndpoint::IsValidOffset(v2, v7) )
  {
    if ( u32ValidFrameCount )
    {
      ...
      v8 = *(_DWORD *)(v10 + 152) + (unsigned int)(v7 % v9);
      if ( (unsigned int)v8 <= *(_DWORD *)(v10 + 156) )
      {
        ...
        if ( (_DWORD)v9 )
        {
          if ( (_DWORD)v9 != 1 )
            goto LABEL_30;
          v12 = *(_DWORD *)(*((_QWORD *)this - 46) + 156LL);
          ...
          if ( a2->u32BufferFlags == BUFFER_VALID )
          {
            ...
            memcpy_0(
              (void *)(*((_QWORD *)this - 47) + *(unsigned int *)(*((_QWORD *)this - 46) + 152LL)),
...
LABEL_29:
          ...
          v19 = v6 - v15;
          v20 = *(unsigned int *)(*((_QWORD *)this - 46) + 152LL);
        }
        else
        {
...
LABEL_30:
  ...
  *((_DWORD *)this + 4) = 3;
  if ( (byte_140087281 & 4) != 0 )
    McTemplateU0pqxxx(v9, v8, (__int64)v2, 20, u32ValidFrameCount, v7, v6);
}
