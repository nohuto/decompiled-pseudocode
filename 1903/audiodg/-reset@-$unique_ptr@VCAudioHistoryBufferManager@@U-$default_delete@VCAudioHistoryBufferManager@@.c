/*
 * XREFs of ?reset@?$unique_ptr@VCAudioHistoryBufferManager@@U?$default_delete@VCAudioHistoryBufferManager@@@wistd@@@wistd@@QEAAXPEAVCAudioHistoryBufferManager@@@Z @ 0x1400155C0
 * Callers:
 *     _dynamic_atexit_destructor_for__g_AudioHistoryManager__ @ 0x14001B4D0 (_dynamic_atexit_destructor_for__g_AudioHistoryManager__.c)
 * Callees:
