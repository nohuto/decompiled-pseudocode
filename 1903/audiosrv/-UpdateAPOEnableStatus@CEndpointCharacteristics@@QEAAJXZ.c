/*
 * XREFs of ?UpdateAPOEnableStatus@CEndpointCharacteristics@@QEAAJXZ @ 0x18011B028
 * Callers:
  ...
  while ( 1 )
  {
    ...
    if ( (*(int (__fastcall **)(_QWORD, LPCWSTR *))(**((_QWORD **)this + 2) + 40LL))(*((_QWORD *)this + 2), &pwsz) >= 0 )
    {
      ...
      if ( (unsigned int)hProvider > 4 && TlgKeywordOn((TraceLoggingHProvider)&hProvider, 0x200000000000uLL) )
      {
        ...
        v31 = &v24;
        v32 = 4LL;
        TlgWrite((TraceLoggingHProvider)&hProvider, &unk_18017A02D, v5, v6, 5u, &pData);
      }
      if ( v23 )
    ...
    v22 = 0LL;
    v8 = (**v7)(v7, &GUID_c537ee8d_5574_454a_9354_aaa4e421d31e, &v22);
    v9 = v8;
    if ( v8 < 0 )
      break;
    v18 = 0LL;
        ...
        && (unsigned int)CEndpointCharacteristics::AreAllNonCriticalAPOsDisabled(this) )
      {
        ...
        if ( (*(int (__fastcall **)(_QWORD, LPCWSTR *))(**((_QWORD **)this + 2) + 40LL))(*((_QWORD *)this + 2), &pwsz) >= 0 )
        {
          ...
          if ( (unsigned int)hProvider > 4 && TlgKeywordOn((TraceLoggingHProvider)&hProvider, 0x200000000000uLL) )
          {
            ...
            TlgWrite((TraceLoggingHProvider)&hProvider, &unk_18017A084, v11, v12, 4u, &pData);
          }
          if ( v18 )
