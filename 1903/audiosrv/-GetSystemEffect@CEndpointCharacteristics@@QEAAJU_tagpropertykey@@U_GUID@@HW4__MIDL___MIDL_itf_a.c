/*
 * XREFs of ?GetSystemEffect@CEndpointCharacteristics@@QEAAJU_tagpropertykey@@U_GUID@@HW4__MIDL___MIDL_itf_audioengineendpoint_0000_0000_0001@@PEAPEAUICompositeSystemEffect@@PEAPEAUIAudioProcessingObject@@PEAPEAUIAudioSystemEffects2@@@Z @ 0x180119288
 * Callers:
 ...
 *     ??8@YAHAEBU_tagpropertykey@@0@Z @ 0x1800CBB50 (--8@YAHAEBU_tagpropertykey@@0@Z.c)
 */
        ...
        struct _GUID *a3)
{
  ...
  {
    v13 = v3;
    return CEndpointCharacteristics::GetStreamEffect(v5, &v13, 1, eHostProcessConnector, 0LL, 0LL, v6);
  }
  else if ( (unsigned int)operator==(v4, (__int64)&PKEY_FX_ModeEffectClsid) )
  {
    v13 = v3;
    return CEndpointCharacteristics::GetModeEffect(v9, &v13, 1, 0, 0LL, 0LL, v10);
  }
  else if ( (unsigned int)operator==(v8, (__int64)&PKEY_FX_EndpointEffectClsid) )
  {
    return CEndpointCharacteristics::GetEndpointEffect(v11, 1, eHostProcessConnector, 0LL, 0LL, v12);
  }
  else
  {
    return 2147942487LL;
