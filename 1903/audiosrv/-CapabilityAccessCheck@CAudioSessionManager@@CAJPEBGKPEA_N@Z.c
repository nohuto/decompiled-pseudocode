/*
 * XREFs of ?CapabilityAccessCheck@CAudioSessionManager@@CAJPEBGKPEA_N@Z @ 0x1800D63FC
 * Callers:
...
__int64 __fastcall CAudioSessionManager::CapabilityAccessCheck(PCWSTR sourceString, unsigned int a2, bool *a3)
{
  ...
  __int64 v18[2]; // [rsp+58h] [rbp-39h] BYREF
  HSTRING string; // [rsp+68h] [rbp-29h] BYREF
  HSTRING_HEADER hstringHeader; // [rsp+70h] [rbp-21h] BYREF
  HSTRING v21; // [rsp+88h] [rbp-9h] BYREF
  HSTRING_HEADER v22; // [rsp+90h] [rbp-1h] BYREF
