/*
 * XREFs of Windows::Internal::ComTaskPool::QueueTask__lambda_c0a465a537957875493a7f1285b2ffbd___ @ 0x180051404
 * Callers:
...
__int64 __fastcall Windows::Internal::ComTaskPool::QueueTask__lambda_c0a465a537957875493a7f1285b2ffbd___(
        __int64 a1,
        __int64 a2,
        unsigned int a3,
        __int64 *a4)
