/*
 * XREFs of ?DoSetProviderChange@PhoneTopology@@AEAAJPEAU_TelephonyInstanceData@@W4TelephonyTypeChangeOp@@@Z @ 0x180147EF4
 * Callers:
 *     ?Process@CallProviderChangeWorkItem@@UEAAXPEAVPhoneTopology@@@Z @ 0x180148D30 (-Process@CallProviderChangeWorkItem@@UEAAXPEAVPhoneTopology@@@Z.c)
 * Callees:
