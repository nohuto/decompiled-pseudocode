/*
 * XREFs of ?DoSetCellularRxMute@PhoneTopology@@AEAAJPEAU_TelephonyInstanceData@@H@Z @ 0x180147A90
 * Callers:
 *     ?Process@CallHoldWorkItem@@UEAAXPEAVPhoneTopology@@@Z @ 0x180148D10 (-Process@CallHoldWorkItem@@UEAAXPEAVPhoneTopology@@@Z.c)
 * Callees:
...
LABEL_16:
    ...
    && fPending )
  {
    ...
    wil::TraceLoggingProvider::Register((wil::TraceLoggingProvider *)&qword_1801B8588, qword_1801B85A0, v13);
  ...
  if ( *(_DWORD *)v14 > 4u )
  {
    ...
    v34 = 4;
    v35 = 0;
    TlgWrite(v14, &unk_18017D602, v11, v12, 5u, &pData);
  }
