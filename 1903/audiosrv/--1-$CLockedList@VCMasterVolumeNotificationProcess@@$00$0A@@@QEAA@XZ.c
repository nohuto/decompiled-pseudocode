/*
 * XREFs of ??1?$CLockedList@VCMasterVolumeNotificationProcess@@$00$0A@@@QEAA@XZ @ 0x1800C8CE4
 * Callers:
 *     _CVolumeStrip::CVolumeStrip_::_1_::dtor$1 @ 0x180071D56 (_CVolumeStrip--CVolumeStrip_--_1_--dtor$1.c)
 * Callees:
