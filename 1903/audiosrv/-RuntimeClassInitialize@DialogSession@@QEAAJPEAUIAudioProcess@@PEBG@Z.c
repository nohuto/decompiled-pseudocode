/*
 * XREFs of ?RuntimeClassInitialize@DialogSession@@QEAAJPEAUIAudioProcess@@PEBG@Z @ 0x18010430C
 * Callers:
        ...
        const unsigned __int16 *a3)
{
  ...
  struct IAudioProcess *v16; // [rsp+78h] [rbp+28h] BYREF
  const unsigned __int16 *v17; // [rsp+80h] [rbp+30h] BYREF
  ...
  if ( v5 >= 0 )
  {
    ...
    *((_QWORD *)this + 2) = 0LL;
    ...
    v5 = Microsoft::WRL::Details::MakeAndInitialize<CVirtualAudioStream,IVirtualAudioStream,IAudioProcess * &,enum _AUDIO_STREAM_EXTENDED_CATEGORY,unsigned short const * &,enum __MIDL___MIDL_itf_mmdeviceapi_0000_0000_0001 &>(
           (_QWORD *)this + 2,
           &v16,
           &v12,
           &v17,
    ...
    if ( v5 >= 0 )
    {
      ...
      LOBYTE(v10) = 1;
      (*(void (__fastcall **)(__int64, _QWORD, __int64))(*(_QWORD *)v13 + 72LL))(v13, *((_QWORD *)this + 3), v10);
      *((_DWORD *)this + 8) = 1;
      v6 = 0;
