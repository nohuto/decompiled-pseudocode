/*
 * XREFs of ?OnDefaultDeviceChanged@CMMNotificationDelegator@@UEAAJW4__MIDL___MIDL_itf_mmdeviceapi_0000_0000_0001@@W4__MIDL___MIDL_itf_mmdeviceapi_0000_0000_0002@@PEBG@Z @ 0x1800EFC10
 * Callers:
 *     <none>
 * Callees:
...
LABEL_17:
  ...
  pData.Ptr = (ULONGLONG)off_180153580;
  p_pData = &pData;
  *(_QWORD *)&pData.Size = v5;
  ...
  if ( v7 >= 0 )
  {
    ...
    if ( *(_DWORD *)v12 > 4u )
    {
      ...
      v20 = 20;
      TlgWrite(v12, &unk_1801789D6, v9, v10, 3u, &pData);
    }
    if ( v5 )
