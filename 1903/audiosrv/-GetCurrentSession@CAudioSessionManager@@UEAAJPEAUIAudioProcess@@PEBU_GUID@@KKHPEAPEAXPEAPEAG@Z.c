/*
 * XREFs of ?GetCurrentSession@CAudioSessionManager@@UEAAJPEAUIAudioProcess@@PEBU_GUID@@KKHPEAPEAXPEAPEAG@Z @ 0x1800D71A0
 * Callers:
 *     <none>
 * Callees:
        ...
        unsigned __int16 **a8)
{
  ...
  *a8 = 0LL;
  ...
  if ( AudioSessionControl < 0
    || (AudioSessionControl = CAudioSessionInstanceId::ToString((__int64)v29, (void **)&v25), AudioSessionControl < 0) )
  {
    v15 = v25;
LABEL_17:
    if ( *a8 )
...
LABEL_21:
  if ( AudioSessionControl < 0 )
    AudSrvTraceLoggingErrorHelper("CAudioSessionManager::GetCurrentSession", 1938, AudioSessionControl);
  CAudioSessionInstanceId::~CAudioSessionInstanceId((CAudioSessionInstanceId *)v29);
