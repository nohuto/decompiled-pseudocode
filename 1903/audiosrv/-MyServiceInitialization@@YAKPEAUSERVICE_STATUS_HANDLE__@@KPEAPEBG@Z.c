/*
 * XREFs of ?MyServiceInitialization@@YAKPEAUSERVICE_STATUS_HANDLE__@@KPEAPEBG@Z @ 0x1800524D0
 * Callers:
 *     ServiceStart @ 0x180052390 (ServiceStart.c)
 * Callees:
 *     ?InitializeAudioThreadpool@@YAJXZ @ 0x180052680 (-InitializeAudioThreadpool@@YAJXZ.c)
 *     McGenEventRegister @ 0x180052758 (McGenEventRegister.c)
