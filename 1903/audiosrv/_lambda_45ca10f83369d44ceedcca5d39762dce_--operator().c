/*
 * XREFs of _lambda_45ca10f83369d44ceedcca5d39762dce_::operator() @ 0x1800EB8D4
 * Callers:
 *     std::_Func_impl_no_alloc__lambda_45ca10f83369d44ceedcca5d39762dce__void_::_Do_call @ 0x1800EC310 (std--_Func_impl_no_alloc__lambda_45ca10f83369d44ceedcca5d39762dce__void_--_Do_call.c)
 * Callees:
...
void __fastcall lambda_45ca10f83369d44ceedcca5d39762dce_::operator()(__int64 a1)
{
  ...
  if ( *v12[1] > 4u )
  {
    ...
    TlgWrite(v6, &unk_18017841C, v5, (LPCGUID)v6, cData, &pData);
  }
  v8 = *(const WCHAR ***)(a1 + 8);
  if ( v8 )
    v9 = *v8;
