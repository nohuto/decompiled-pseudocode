/*
 * XREFs of ??0ResultException@wil@@QEAA@AEBV01@@Z @ 0x1800BB960
 * Callers:
 *     <none>
 * Callees:
 *     _o___std_exception_copy_0 @ 0x180064C2E (_o___std_exception_copy_0.c)
 *     ?assign@shared_buffer@details@wil@@AEAAXPEAJ_K@Z @ 0x1800BCF28 (-assign@shared_buffer@details@wil@@AEAAXPEAJ_K@Z.c)
 */
