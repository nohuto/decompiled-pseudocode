/*
 * XREFs of ?QueryInterface@CMonitorManager@@UEAAJAEBU_GUID@@PEAPEAX@Z @ 0x18010C2A0
 * Callers:
 *     <none>
 * Callees:
...
LABEL_8:
  ...
  {
    WPP_SF_d(*((_QWORD *)WPP_GLOBAL_Control + 2), 0x5Fu, (__int64)&WPP_b9a18bca3a9f3fb3e4a3d91d80ef7b5a_Traceguids, v7);
  }
