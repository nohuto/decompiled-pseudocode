/*
 * XREFs of ?DeriveConnectorFormatWithHighestBitDepthFromStreamFormat@@YAJPEAVCEndpointCharacteristics@@W4__MIDL___MIDL_itf_audioengineendpoint_0000_0000_0001@@PEAUtWAVEFORMATEX@@U_GUID@@PEAPEAU3@@Z @ 0x1800DE65C
 * Callers:
 ...
 *     ?InitWaveFormatEx@@YAXPEAUWAVEFORMATEXTENSIBLE@@_NHHHHK@Z @ 0x1800DFAC0 (-InitWaveFormatEx@@YAXPEAUWAVEFORMATEXTENSIBLE@@_NHHHHK@Z.c)
 */
...
LABEL_6:
  ...
  else
  {
    ...
    if ( v11 < 0 )
    {
      v14 = (unsigned __int16 *)&unk_180180E40;
      v15 = 0;
      do
      {
        if ( v15 >= 5 )
