/*
 * XREFs of ?CreateLowRightsRegistryKey@@YAJPEAUHKEY__@@PEBGKPEAPEAU1@@Z @ 0x18002C350
 * Callers:
...
LABEL_9:
  ...
  if ( !v21 )
  {
    if ( CNtDeleteKey::Init(v20) && !(qword_1801B8910 ? qword_1801B8910(v38) : 87) )
    {
      RegCloseKey(v38);
      v38 = 0LL;
      dwDisposition = 0;
