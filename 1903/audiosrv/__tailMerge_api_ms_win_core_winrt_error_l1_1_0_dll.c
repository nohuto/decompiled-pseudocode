/*
 * XREFs of __tailMerge_api_ms_win_core_winrt_error_l1_1_0_dll @ 0x180065A29
 * Callers:
 *     __imp_load_RoOriginateError @ 0x180065A1D (__imp_load_RoOriginateError.c)
 *     __imp_load_SetRestrictedErrorInfo @ 0x180065C41 (__imp_load_SetRestrictedErrorInfo.c)
 * Callees:
