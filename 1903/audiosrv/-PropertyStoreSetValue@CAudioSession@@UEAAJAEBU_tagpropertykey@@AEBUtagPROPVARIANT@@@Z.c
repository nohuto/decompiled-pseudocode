/*
 * XREFs of ?PropertyStoreSetValue@CAudioSession@@UEAAJAEBU_tagpropertykey@@AEBUtagPROPVARIANT@@@Z @ 0x1800D0CE0
 * Callers:
 *     <none>
 * Callees:
  ...
  if ( v8 != 2 )
    return (*(__int64 (__fastcall **)(_QWORD, const struct _tagpropertykey *, const struct tagPROPVARIANT *))(**((_QWORD **)this + 61) + 48LL))(
             *((_QWORD *)this + 61),
             a2,
             a3);
  AudSrvTraceLoggingErrorHelper("CAudioSession::PropertyStoreSetValue", 5395, -2147024809);
  return 2147942487LL;
}
