/*
 * XREFs of ?SafeRegCreateKeyEx@@YAJPEAUHKEY__@@PEBGKPEAGKKPEAU_SECURITY_ATTRIBUTES@@PEAPEAU1@PEAK@Z @ 0x180028E04
 * Callers:
 ...
 *     ?Init@CNtDeleteKey@@QEAA_NXZ @ 0x1800DFA58 (-Init@CNtDeleteKey@@QEAA_NXZ.c)
 */
...
LABEL_6:
  ...
  if ( dword_1801B8900 > *((_DWORD *)v14 + 1) )
  {
    Init_thread_header(&dword_1801B8900);
    if ( dword_1801B8900 == -1 )
    {
      atexit(SafeRegCreateKeyEx_::_2_::_dynamic_atexit_destructor_for__delKey__);
      Init_thread_footer(&dword_1801B8900);
    }
  }
  v15 = v13 - 1;
  if ( v15 )
...
LABEL_19:
  ...
  else if ( CNtDeleteKey::Init(v14) && !(qword_1801B8910 ? qword_1801B8910(hKey) : 87) )
  {
    RegCloseKey(hKey);
    hKey = 0LL;
    dwDisposition = 0;
