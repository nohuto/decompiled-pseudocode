/*
 * XREFs of ?MeasureClockDrift@CMonitor@@AEAAXNN@Z @ 0x18010F51C
 * Callers:
 ...
 *     WPP_SF_gg @ 0x1801121FC (WPP_SF_gg.c)
 *     WPP_SF_gggg @ 0x180112254 (WPP_SF_gggg.c)
 */
...
void __fastcall CMonitor::MeasureClockDrift(CMonitor *this, double a2, double a3)
{
  ...
  *((_QWORD *)this + 61) = v5 + 1;
  ...
  if ( WPP_GLOBAL_Control != (CAudioSessionManager *)&WPP_GLOBAL_Control
    ...
    && *((_BYTE *)WPP_GLOBAL_Control + 25) >= 4u )
  {
    WPP_SF_g(*((_QWORD *)WPP_GLOBAL_Control + 2), 0x35u, (__int64)&WPP_70b4bc2e72a23cf5637e1be4ab06d41d_Traceguids, v11);
    v13 = *((double *)this + 60);
    v12 = WPP_GLOBAL_Control;
  }
