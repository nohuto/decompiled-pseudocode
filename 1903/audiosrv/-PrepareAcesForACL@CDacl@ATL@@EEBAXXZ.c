/*
 * XREFs of ?PrepareAcesForACL@CDacl@ATL@@EEBAXXZ @ 0x18003AA20
 * Callers:
 *     <none>
 * Callees:
...
LABEL_14:
        ...
        while ( 1 )
        {
          ...
          if ( *((_BYTE *)v20 + 144) )
            goto LABEL_20;
LABEL_42:
          v17 = ATL::CAtlArray<CAudioSession *,ATL::CElementTraits<CAudioSession *>>::operator[](v8, v11 - v4);
          v18 = ATL::CAtlArray<CAudioSession *,ATL::CElementTraits<CAudioSession *>>::operator[](v8, v11);
