/*
 * XREFs of ?OnStateChanged@CAudioSessionManager@@UEAAJPEAUIAudioSessionInfo@@W4_AudioSessionState@@1@Z @ 0x18002B600
 * Callers:
        ...
        enum _AudioSessionState a4)
{
  ...
  _DWORD *v76; // [rsp+38h] [rbp-170h] BYREF
...
LABEL_22:
    ...
    else if ( v4 == AudioSessionStateExpired )
    {
      ...
      v76 = (_DWORD *)((*(__int64 (__fastcall **)(__int64 *))(ATL::g_strmgr + 24))(&ATL::g_strmgr) + 24);
      if ( (int)CAudioSessionInstanceId::ToString((__int64)&v95, (void **)&v76) < 0 )
      {
        ATL::CStringData::Release((ATL::CStringData *)(v76 - 6));
        v25 = 0;
      }
      else
      {
        v23 = v76;
        v24 = *(v76 - 4);
        if ( (((1 - *(v76 - 2)) | (*(v76 - 3) - v24)) & 0x80000000) != 0 )
        {
          ATL::CSimpleStringT<unsigned short,0>::PrepareWrite2((__int64 *)&v76, v24);
          v23 = v76;
        }
