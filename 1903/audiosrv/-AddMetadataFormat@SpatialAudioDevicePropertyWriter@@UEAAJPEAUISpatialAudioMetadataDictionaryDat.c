/*
 * XREFs of ?AddMetadataFormat@SpatialAudioDevicePropertyWriter@@UEAAJPEAUISpatialAudioMetadataDictionaryData@@@Z @ 0x18012F280
 * Callers:
 *     <none>
 * Callees:
              ...
              if ( v31 >= 0 )
              {
                  ...
                  if ( v31 >= 0 )
                  {
                    ...
                    *(_QWORD *)&v34[3] = v34[0];
                    ...
                    if ( v31 >= 0 )
                    {
                      ...
                      *(_OWORD *)&v34[3] = (unsigned __int16)(v23 + 1);
                      v31 = SpatialAudioDevicePropertyWriter::SetPropertyValue(
                              ...
                              (struct tagPROPVARIANT *)&v34[1]);
                      v8 = v31;
                      if ( v31 < 0 && (unsigned int)dword_1801B63C0 > 2 )
                      {
                        v41 = 52LL;
                        ...
                        v44 = &v31;
                        v45 = 4LL;
                        TlgWrite((TraceLoggingHProvider)&dword_1801B63C0, &unk_18017CC9B, v28, v29, 5u, &pData);
                      }
                    }
                    else if ( (unsigned int)dword_1801B63C0 > 2 )
                    {
                      ...
                      v44 = &v31;
                      v45 = 4LL;
                      TlgWrite((TraceLoggingHProvider)&dword_1801B63C0, &unk_18017CC9B, v26, v27, 5u, &pData);
                    }
                  }
                  else if ( (unsigned int)dword_1801B63C0 > 2 )
                  {
                ...
                else
                {
                  ...
                  if ( (unsigned int)dword_1801B63C0 > 2 )
                  {
                    ...
                    v44 = &v31;
                    v45 = 4LL;
                    TlgWrite((TraceLoggingHProvider)&dword_1801B63C0, &unk_18017CCCD, v21, v22, 5u, &pData);
                  }
                }
              }
              else if ( (unsigned int)dword_1801B63C0 > 2 )
