/*
 * XREFs of ?SetPropertyStoreProperty@CPolicyConfig@@SAJPEAUIMMDevice@@HAEBU_tagpropertykey@@AEBUtagPROPVARIANT@@@Z @ 0x1800E0FC0
 * Callers:
        ...
        const struct tagPROPVARIANT *a4)
{
  ...
  {
    AudSrvTraceLoggingErrorHelper("CPolicyConfig::SetPropertyStoreProperty", 2975, DevicePropertyStore);
    v7 = v9[0];
  }
  if ( v7 )
