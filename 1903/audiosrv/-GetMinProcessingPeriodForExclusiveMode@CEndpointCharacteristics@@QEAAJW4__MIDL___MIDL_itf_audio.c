/*
 * XREFs of ?GetMinProcessingPeriodForExclusiveMode@CEndpointCharacteristics@@QEAAJW4__MIDL___MIDL_itf_audioengineendpoint_0000_0000_0001@@PEAUtWAVEFORMATEX@@U_GUID@@PEA_J@Z @ 0x180008204
 * Callers:
        ...
        __int64 *a5)
{
  ...
  *a5 = 30000LL;
  v10 = v5;
  if ( (int)CEndpointCharacteristics::GetSharedModeEnginePeriodicity(this, 0LL, a3, &v10, 0, 0LL, 0LL, &v11, 0LL) >= 0 )
  {
