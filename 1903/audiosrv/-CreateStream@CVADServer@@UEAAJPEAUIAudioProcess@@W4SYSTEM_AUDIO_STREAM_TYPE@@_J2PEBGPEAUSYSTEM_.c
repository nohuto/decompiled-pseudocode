/*
 * XREFs of ?CreateStream@CVADServer@@UEAAJPEAUIAudioProcess@@W4SYSTEM_AUDIO_STREAM_TYPE@@_J2PEBGPEAUSYSTEM_AUDIO_STREAM@@@Z @ 0x18002E790
 * Callers:
 *     <none>
 * Callees:
        ...
        void *a7)
{
  ...
  _QWORD v112[2]; // [rsp+1A8h] [rbp+40h] BYREF
  ...
  if ( v17 )
  {
    ...
    *((_BYTE *)v17 + 440) = 0;
    ...
    if ( !a3 )
    {
      ...
      if ( qword_1801B8850 )
      {
        _InterlockedIncrement((volatile signed __int32 *)qword_1801B8850 + 2);
        v19 = qword_1801B8850;
      }
...
LABEL_33:
      ...
      if ( (unsigned int)(a3 - 1) <= 1 )
        v31 = dword_180172090[v30];
      else
        v31 = dword_180172030[v30];
      v32 = 0;
      if ( v29 )
        v32 = 16;
