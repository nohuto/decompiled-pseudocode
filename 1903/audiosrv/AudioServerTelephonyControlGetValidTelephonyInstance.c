/*
 * XREFs of AudioServerTelephonyControlGetValidTelephonyInstance @ 0x1800EAE30
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall AudioServerTelephonyControlGetValidTelephonyInstance(__int64 a1, unsigned int a2, __int64 a3)
{
  ...
  v7 = ((__int64 (__fastcall *)(struct IUnknown *, _QWORD, __int64))g_TelephonyControl->lpVtbl[5].Release)(
         g_TelephonyControl,
         a2,
         a3);
