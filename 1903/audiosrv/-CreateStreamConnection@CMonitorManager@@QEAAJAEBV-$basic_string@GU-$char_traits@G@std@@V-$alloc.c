/*
 * XREFs of ?CreateStreamConnection@CMonitorManager@@QEAAJAEBV?$basic_string@GU?$char_traits@G@std@@V?$allocator@G@2@@std@@0W4_AUDIO_STREAM_EXTENDED_CATEGORY@@AEAV?$shared_ptr@VCStreamConnection@@@3@@Z @ 0x1801086C8
 * Callers:
 *     ?CreateStreamConnection@CStreamConnectionManagerImpl@@UEAAJAEBV?$basic_string@GU?$char_traits@G@std@@V?$allocator@G@2@@std@@0W4_AUDIO_STREAM_EXTENDED_CATEGORY@@AEAV?$shared_ptr@VCStreamConnection@@@3@@Z @ 0x1801088B0 (-CreateStreamConnection@CStreamConnectionManagerImpl@@UEAAJAEBV-$basic_string@GU-$char_traits@G@.c)
 * Callees:
 ...
 *     ??$_Setp@VCStreamConnectionImpl@CMonitorManager@@@?$shared_ptr@VCStreamConnection@@@std@@AEAAXPEAVCStreamConnectionImpl@CMonitorManager@@U?$integral_constant@_N$0A@@1@@Z @ 0x1801072E0 (--$_Setp@VCStreamConnectionImpl@CMonitorManager@@@-$shared_ptr@VCStreamConnection@@@std@@AEAAXPE.c)
 ...
 *     ?_Throw_NullAlloc@in1diag3@details@wil@@YAXPEAXIPEBD@Z @ 0x18010D80C (-_Throw_NullAlloc@in1diag3@details@wil@@YAXPEAXIPEBD@Z.c)
 */
...
__int64 __fastcall CMonitorManager::CreateStreamConnection(__int64 a1, __int64 **a2, __int64 **a3, int a4, _QWORD *a5)
{
  ...
  *a5 = 0LL;
  ...
  try
  {
    ...
    if ( !v12 )
      wil::details::in1diag3::_Throw_NullAlloc(retaddr, (void *)0x8F, v13, v14);
    v21 = 0LL;
