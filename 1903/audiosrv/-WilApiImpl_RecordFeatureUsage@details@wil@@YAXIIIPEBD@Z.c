/*
 * XREFs of ?WilApiImpl_RecordFeatureUsage@details@wil@@YAXIIIPEBD@Z @ 0x180047CF0
 * Callers:
 *     <none>
 * Callees:
 ...
 *     ?EnsureStateData@FeatureStateManager@details@wil@@AEAA_NXZ @ 0x18005C904 (-EnsureStateData@FeatureStateManager@details@wil@@AEAA_NXZ.c)
 ...
 *     ?QueueBackgroundSRUMUsageReporting@FeatureStateManager@details@wil@@QEAAXIGI@Z @ 0x1800C0404 (-QueueBackgroundSRUMUsageReporting@FeatureStateManager@details@wil@@QEAAXIGI@Z.c)
...
void __fastcall wil::details::WilApiImpl_RecordFeatureUsage(wil::details *this, unsigned int a2, __int64 a3)
{
  ...
  if ( (_DWORD)this || (_DWORD)a3 || v4 )
  {
    ...
    if ( (_DWORD)a3 || v4 == 254 )
    {
      ...
      {
        v7 = (__int64)*(&xmmword_1801B8290 + 1);
        if ( *(&xmmword_1801B8290 + 1) )
          goto LABEL_6;
        v14 = xmmword_1801B8290;
        if ( !xmmword_1801B8290 )
        {
          pftDueTime = 0LL;
          ...
          if ( v15 >= 0 )
          {
            if ( !xmmword_1801B8290 )
              v14 = (void *)pftDueTime;
            xmmword_1801B8290 = v14;
          }
        }
        v16 = ((unsigned __int64)v14 + 32) & -(__int64)(v14 != 0LL);
        AcquireSRWLockExclusive(&SRWLock);
        v17 = *(&xmmword_1801B8290 + 1);
        if ( !*(&xmmword_1801B8290 + 1) )
          v17 = (void *)v16;
        *(&xmmword_1801B8290 + 1) = v17;
...
LABEL_6:
         ...
         && wil::details::FeatureStateManager::EnsureStateData((wil::details::FeatureStateManager *)&wil::details::g_featureStateManager) )
  {
    wil::details_abi::SubscriptionList::OnSignaled(
      (LPCRITICAL_SECTION)*(&xmmword_1801B8290 + 1) + 5,
      (PSRWLOCK)*(&xmmword_1801B8290 + 1));
  }
}
