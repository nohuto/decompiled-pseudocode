/*
 * XREFs of ?_Destroy_if_node@?$_Tree@V?$_Tmap_traits@U_GUID@@UHmdInfo@@U?$less@U_GUID@@@std@@V?$allocator@U?$pair@$$CBU_GUID@@UHmdInfo@@@std@@@4@$0A@@std@@@std@@IEAAXPEAU?$_Tree_node@U?$pair@$$CBU_GUID@@UHmdInfo@@@std@@PEAX@2@@Z @ 0x180127718
 * Callers:
 ...
 *     _std::_Tree_std::_Tmap_traits__GUID_HmdInfo_std::less__GUID__std::allocator_std::pair__GUID_const__HmdInfo____0___::_Insert_hint_std::pair__GUID_const__HmdInfo__&_std::_Tree_node_std::pair__GUID_const__HmdInfo__void_______::_1_::catch$41 @ 0x180125626 (_std--_Tree_std--_Tmap_traits__GUID_HmdInfo_std--less__GUID__std--allocator_std--pair__GUID_cons.c)
 *     _std::_Tree_std::_Tmap_traits__GUID_HmdInfo_std::less__GUID__std::allocator_std::pair__GUID_const__HmdInfo____0___::_Insert_nohint_std::pair__GUID_const__HmdInfo__&_std::_Tree_node_std::pair__GUID_const__HmdInfo__void_______::_1_::catch$22 @ 0x180125808 (_std--_Tree_std--_Tmap_traits__GUID_HmdInfo_std--less__GUID__std--allocator_std--pa_ea_180125808.c)
 * Callees:
