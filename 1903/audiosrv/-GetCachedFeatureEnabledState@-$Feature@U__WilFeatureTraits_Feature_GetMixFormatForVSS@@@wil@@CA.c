/*
 * XREFs of ?GetCachedFeatureEnabledState@?$Feature@U__WilFeatureTraits_Feature_GetMixFormatForVSS@@@wil@@CA?AW4wil_details_CachedFeatureEnabledState@@_N@Z @ 0x1800481A8
 * Callers:
 *     ?ReportUsageToService@?$Feature@U__WilFeatureTraits_Feature_GetMixFormatForVSS@@@wil@@CAX_NW4ReportingKind@2@_K@Z @ 0x180066DF0 (-ReportUsageToService@-$Feature@U__WilFeatureTraits_Feature_GetMixFormatForVSS@@@wil@@CAX_NW4Rep.c)
 * Callees:
