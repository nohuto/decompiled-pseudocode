/*
 * XREFs of ?GetEncoderStaticObjectPosition@SpatialAudioDevicePropertyReader@@UEAAJW4AudioObjectType@@PEAM11@Z @ 0x1801307F0
 * Callers:
 *     <none>
 * Callees:
        ...
        float *a5)
{
  ...
  else
  {
    if ( (unsigned int)dword_1801B63C0 > 2 )
    {
      ...
      v24 = 4LL;
      TlgWrite((TraceLoggingHProvider)&dword_1801B63C0, &unk_18017CCCD, v11, v12, 5u, &pData);
    }
