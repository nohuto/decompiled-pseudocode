/*
 * XREFs of ?RuntimeClassInitialize@SpatialAudioDevicePropertyReader@@QEAAJPEBGPEAUIPropertyStore@@@Z @ 0x180038C1C
 * Callers:
        ...
        if ( a2 && (unsigned int)_o__wcsicmp(a2, &pData) )
        {
          ...
          if ( SpatialAudioDeviceStateReader < 0 )
          {
            if ( (unsigned int)dword_1801B63C0 > 2 )
            {
              ...
              v41 = &v32;
              v42 = 4LL;
              TlgWrite((TraceLoggingHProvider)&dword_1801B63C0, &unk_18017CC9B, v23, v24, 5u, &v36);
            }
            goto LABEL_18;
          }
        }
        else
        {
          ...
          if ( SpatialAudioDeviceStateReader < 0 )
          {
            if ( (unsigned int)dword_1801B63C0 > 2 )
            {
              ...
              v41 = &v32;
              v42 = 4LL;
              TlgWrite((TraceLoggingHProvider)&dword_1801B63C0, &unk_18017CC9B, v26, v27, 5u, &v36);
            }
            goto LABEL_18;
          }
        }
...
LABEL_8:
          ...
          if ( SpatialAudioDeviceStateReader < 0 )
          {
            if ( (unsigned int)dword_1801B63C0 > 2 )
            {
              ...
              v41 = &v32;
              v42 = 4LL;
              TlgWrite((TraceLoggingHProvider)&dword_1801B63C0, &unk_18017CC9B, v13, v14, 5u, &v36);
            }
          }
          else
          {
            ...
            v32 = SpatialAudioDeviceStateReader;
            if ( SpatialAudioDeviceStateReader < 0 && (unsigned int)dword_1801B63C0 > 2 )
            {
              v37 = "SpatialAudioDevicePropertyReader::RuntimeClassInitialize";
              v38 = 57LL;
              v33 = 240;
              ...
              v41 = &v32;
              v42 = 4LL;
              TlgWrite((TraceLoggingHProvider)&dword_1801B63C0, &unk_18017CC9B, v15, v16, 5u, &v36);
            }
          }
        ...
        if ( (unsigned int)dword_1801B63C0 > 2 )
        {
          ...
          v41 = &v32;
          v42 = 4LL;
          TlgWrite((TraceLoggingHProvider)&dword_1801B63C0, &unk_18017CC9B, v30, v31, 5u, &v36);
        }
      }
      else if ( (unsigned int)dword_1801B63C0 > 2 )
      {
        ...
        v41 = &v32;
        v42 = 4LL;
        TlgWrite((TraceLoggingHProvider)&dword_1801B63C0, &unk_18017CC9B, v20, v21, 5u, &v36);
      }
    }
    else if ( (unsigned int)dword_1801B63C0 > 2 )
    {
      ...
      v41 = &v32;
      v42 = 4LL;
      TlgWrite((TraceLoggingHProvider)&dword_1801B63C0, &unk_18017CC9B, v18, v19, 5u, &v36);
    }
LABEL_18:
    Microsoft::WRL::ComPtr<ISpatialAudioPositionCalc>::InternalRelease(&v34);
    Microsoft::WRL::ComPtr<ISpatialAudioPositionCalc>::InternalRelease(ppv);
  ...
  if ( (unsigned int)dword_1801B63C0 > 2 )
  {
    ...
    v48 = &v33;
    v49 = 4LL;
    TlgWrite((TraceLoggingHProvider)&dword_1801B63C0, &unk_18017CC9B, v9, v10, 5u, &pData);
  }
  return (unsigned int)SpatialAudioDeviceStateReader;
}
