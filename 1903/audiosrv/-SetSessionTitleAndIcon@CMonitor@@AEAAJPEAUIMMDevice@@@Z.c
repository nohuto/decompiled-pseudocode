/*
 * XREFs of ?SetSessionTitleAndIcon@CMonitor@@AEAAJPEAUIMMDevice@@@Z @ 0x18011112C
 * Callers:
...
__int64 __fastcall CMonitor::SetSessionTitleAndIcon(CMonitor *this, struct IMMDevice *a2)
{
  ...
  if ( (_WORD)pvar == 31 )
  {
    v3 = (*(__int64 (__fastcall **)(_QWORD, __int64, _QWORD))(**((_QWORD **)this + 28) + 40LL))(
           *((_QWORD *)this + 28),
           v6,
           0LL);
    if ( v3 < 0 )
  ...
  if ( v3 < 0 )
    goto LABEL_11;
  if ( (_WORD)pvar == 31 )
    v3 = (*(__int64 (__fastcall **)(_QWORD, __int64, _QWORD))(**((_QWORD **)this + 28) + 56LL))(
           *((_QWORD *)this + 28),
           v6,
           0LL);
  if ( v3 < 0 )
