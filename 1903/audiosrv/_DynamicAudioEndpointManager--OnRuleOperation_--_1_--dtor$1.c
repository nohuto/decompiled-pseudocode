/*
 * XREFs of _DynamicAudioEndpointManager::OnRuleOperation_::_1_::dtor$1 @ 0x18012B5E5
 * Callers:
 *     <none>
 * Callees:
 *     <none>
...
__int64 __fastcall DynamicAudioEndpointManager::OnRuleOperation_::_1_::dtor_1(__int64 a1, __int64 a2)
{
