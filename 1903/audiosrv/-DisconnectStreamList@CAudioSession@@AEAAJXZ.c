/*
 * XREFs of ?DisconnectStreamList@CAudioSession@@AEAAJXZ @ 0x1800CDACC
 * Callers:
...
__int64 __fastcall CAudioSession::DisconnectStreamList(CAudioSession *this)
{
  ...
  while ( v18 )
  {
    ...
    try
    {
      ATL::CAtlArray<CAudioStream *,ATL::CElementTraits<CAudioStream *>>::RemoveAt(&v17, 0LL);
    }
    ...
    if ( *(_BYTE *)(v7 + 120) )
    {
      ...
      (*(void (__fastcall **)(CAudioSession *, __int64, _QWORD))(*(_QWORD *)v1 + 312LL))(v1, v7, 0LL);
