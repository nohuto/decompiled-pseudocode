/*
 * XREFs of ??1?$unique_ptr@VCVpoContextProxy@@U?$default_delete@VCVpoContextProxy@@@std@@@std@@QEAA@XZ @ 0x1800E4104
 * Callers:
 *     AudioServerGetEndpointVpoContext$dtor$4 @ 0x1800E85A1 (AudioServerGetEndpointVpoContext$dtor$4.c)
 *     AudioServerGetStreamVpoContext$dtor$6 @ 0x1800E94C2 (AudioServerGetStreamVpoContext$dtor$6.c)
 * Callees:
