/*
 * XREFs of PolicyConfigGetEndpointExtendedSpatialLicenseInfo @ 0x1800E2250
 * Callers:
 *     <none>
 * Callees:
        ...
        __int64 a4)
{
  ...
  v9 = (*(__int64 (__fastcall **)(CPolicyConfig *, __int64, _QWORD, __int64))(*(_QWORD *)g_PolicyConfig + 288LL))(
         g_PolicyConfig,
         a2,
         a3,
         a4);
