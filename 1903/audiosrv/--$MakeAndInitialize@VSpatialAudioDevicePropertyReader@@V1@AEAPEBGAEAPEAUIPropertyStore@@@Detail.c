/*
 * XREFs of ??$MakeAndInitialize@VSpatialAudioDevicePropertyReader@@V1@AEAPEBGAEAPEAUIPropertyStore@@@Details@WRL@Microsoft@@YAJPEAPEAVSpatialAudioDevicePropertyReader@@AEAPEBGAEAPEAUIPropertyStore@@@Z @ 0x180035140
 * Callers:
 *     Create_SpatialAudioDevicePropertyReader @ 0x180035098 (Create_SpatialAudioDevicePropertyReader.c)
 * Callees:
 *     ??0SpatialAudioDevicePropertyReader@@QEAA@XZ @ 0x1800351E8 (--0SpatialAudioDevicePropertyReader@@QEAA@XZ.c)
