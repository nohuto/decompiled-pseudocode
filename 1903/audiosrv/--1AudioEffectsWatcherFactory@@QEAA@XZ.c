/*
 * XREFs of ??1AudioEffectsWatcherFactory@@QEAA@XZ @ 0x1800634E4
 * Callers:
 *     _dynamic_atexit_destructor_for__TheAudioEffectsWatcherFactory__ @ 0x180073A40 (_dynamic_atexit_destructor_for__TheAudioEffectsWatcherFactory__.c)
 * Callees:
...
{
  ATL::CAtlList<IPolicyRule *,ATL::CElementTraits<IPolicyRule *>>::RemoveAll(&qword_1801B8C48);
