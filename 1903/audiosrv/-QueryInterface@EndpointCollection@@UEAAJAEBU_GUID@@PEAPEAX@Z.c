/*
 * XREFs of ?QueryInterface@EndpointCollection@@UEAAJAEBU_GUID@@PEAPEAX@Z @ 0x180054670
 * Callers:
 *     ?QueryInterface@EndpointCollection@@W7EAAJAEBU_GUID@@PEAPEAX@Z @ 0x18006C7E0 (-QueryInterface@EndpointCollection@@W7EAAJAEBU_GUID@@PEAPEAX@Z.c)
 * Callees:
