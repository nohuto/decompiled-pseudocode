/*
 * XREFs of ?GetPropertyStoreProperty@CPolicyConfig@@SAJPEAUIMMDevice@@HAEBU_tagpropertykey@@PEAUtagPROPVARIANT@@@Z @ 0x18004024C
 * Callers:
...
LABEL_3:
    if ( v6 < 0 )
      AudSrvTraceLoggingErrorHelper("TryGetDevicePropertyStore", 2348, v6);
    v7 = v10;
    goto LABEL_6;
  }
  v9 = 0LL;
...
LABEL_6:
  if ( v6 >= 0 )
    goto LABEL_7;
LABEL_20:
  AudSrvTraceLoggingErrorHelper("CPolicyConfig::GetPropertyStoreProperty", 2932, v6);
  v7 = v10;
LABEL_10:
  if ( v7 )
