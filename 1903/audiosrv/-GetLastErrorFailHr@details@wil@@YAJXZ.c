/*
 * XREFs of ?GetLastErrorFailHr@details@wil@@YAJXZ @ 0x1800BC00C
 * Callers:
 ...
 * Callees:
 *     ?GetLastErrorFail@details@wil@@YAKPEAXIPEBD110@Z @ 0x1800BBFA0 (-GetLastErrorFail@details@wil@@YAKPEAXIPEBD110@Z.c)
 */
