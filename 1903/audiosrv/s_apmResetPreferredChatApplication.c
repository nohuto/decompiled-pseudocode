/*
 * XREFs of s_apmResetPreferredChatApplication @ 0x1801054B0
 * Callers:
 *     <none>
 * Callees:
...
__int64 s_apmResetPreferredChatApplication()
{
  ...
  __int64 fPending; // [rsp+88h] [rbp+18h] BYREF
  LPVOID Context; // [rsp+90h] [rbp+20h] BYREF
  ...
  if ( (**(int (__fastcall ***)(struct IAudioPolicyManager *, GUID *, __int64 *))g_PolicyManager)(
         ...
         &fPending) < 0
    || (v2 = (*(__int64 (__fastcall **)(__int64))(*(_QWORD *)fPending + 88LL))(fPending), v3 = v2, v2 >= 0) )
  {
    if ( fPending )
