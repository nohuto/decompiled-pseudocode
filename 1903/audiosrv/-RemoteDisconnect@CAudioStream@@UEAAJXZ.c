/*
 * XREFs of ?RemoteDisconnect@CAudioStream@@UEAAJXZ @ 0x1800DAAA0
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall CAudioStream::RemoteDisconnect(HANDLE *this)
{
  ...
  v2 = WaitForSingleObjectEx(this[38], 0x3E8u, 0);
  if ( v2 == 258 )
  {
  ...
  else
  {
    if ( v2 )
    {
      wil::details::in1diag3::FailFast_Unexpected(retaddr, 2512LL, v3, v4);
      __debugbreak();
    }
