/*
 * XREFs of ?CalculatePositions@SpatialAudioPositionCalc@@UEAAJPEAUStaticObjectProjectionData@@PEAT__m128@@I@Z @ 0x18001B4E0
 * Callers:
 *     <none>
 * Callees:
 *     _TlgWrite @ 0x18001AD10 (_TlgWrite.c)
 *     __security_check_cookie @ 0x180063BD0 (__security_check_cookie.c)
 *     sinf_0 @ 0x18006B8D3 (sinf_0.c)
 *     ?ComputeRadialProjectionOffsets@SpatialAudioPositionCalc@@AEAAXPEAUSpatialAudioProjectionOffsets@@PEAUStaticObjectProjectionData@@@Z @ 0x180133EDC (-ComputeRadialProjectionOffsets@SpatialAudioPositionCalc@@AEAAXPEAUSpatialAudioProjectionOffsets.c)
 */
...
LABEL_37:
  ...
  if ( (unsigned int)dword_1801B63C0 > 2 )
  {
    ...
    v75 = &v61;
    v76 = 4LL;
    TlgWrite((TraceLoggingHProvider)&dword_1801B63C0, &unk_18017CCCD, a3, a4, 5u, &pData);
  }
  return 2147942487LL;
}
