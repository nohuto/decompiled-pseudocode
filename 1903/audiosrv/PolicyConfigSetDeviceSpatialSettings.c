/*
 * XREFs of PolicyConfigSetDeviceSpatialSettings @ 0x1800E3120
 * Callers:
 *     <none>
 * Callees:
           ...
           &Context) >= 0 )
    {
      ...
      if ( a4 )
      {
        ...
        if ( *(_DWORD *)v15 > 4u )
        {
          ...
          v49 = 4LL;
          v51 = 16LL;
          TlgWrite(v15, &unk_18017804B, v17, v18, 0xCu, &pData);
        }
      }
      else
      {
        if ( InitOnceBeginInitialize(&`AudioSrvTelemetryProvider::Instance'::`2'::wrapper, 0, &v29, &v30) && v29 )
        {
          ...
          qword_1801B85A0 = (struct _TlgProvider_t *)&`AudioSrvTelemetryProvider::StaticHandle::StaticHandle'::`2'::__hInner;
          atexit(lambda_b4cb8953ddd9016186cd5ae31274160b_::_lambda_invoker_cdecl_);
          wil::TraceLoggingProvider::Register((wil::TraceLoggingProvider *)&qword_1801B8588, qword_1801B85A0, v19);
          InitOnceComplete(&`AudioSrvTelemetryProvider::Instance'::`2'::wrapper, 0, &qword_1801B8588);
        }
        ...
        if ( *(_DWORD *)v20 > 4u )
        {
          ...
          v40 = 16LL;
          v42 = 2LL;
          TlgWrite(v20, &unk_180177FDB, v21, v22, 7u, &pData);
        }
      }
    }
    if ( Context )
