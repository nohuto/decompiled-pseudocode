/*
 * XREFs of ?reset@?$unique_storage@U?$resource_policy@PEAXP6AXPEAX@Z$1?CloseHandle@details@wil@@YAX0@ZU?$integral_constant@_K$0A@@wistd@@PEAXPEAX$0A@$$T@details@wil@@@details@wil@@QEAAXPEAX@Z @ 0x18005D378
 * Callers:
 ...
 *     ?Destroy@SemaphoreValue@details_abi@wil@@QEAAXXZ @ 0x1800BBCD0 (-Destroy@SemaphoreValue@details_abi@wil@@QEAAXXZ.c)
 * Callees:
