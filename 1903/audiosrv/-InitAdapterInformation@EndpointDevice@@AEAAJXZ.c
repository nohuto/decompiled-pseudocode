/*
 * XREFs of ?InitAdapterInformation@EndpointDevice@@AEAAJXZ @ 0x180055830
 * Callers:
...
__int64 __fastcall EndpointDevice::InitAdapterInformation(GUID *this)
{
  ...
  try
  {
    ...
    for ( i = 0; ; ++i )
    {
      ...
      v17 = *(_QWORD *)&v12->Data1 - *((_QWORD *)&unk_1801B6240 + 3 * (int)i);
      if ( *(_QWORD *)&v12->Data1 == *((_QWORD *)&unk_1801B6240 + 3 * (int)i) )
        v17 = *(_QWORD *)v12->Data4 - *((_QWORD *)&unk_1801B6240 + 3 * (int)i + 1);
      if ( !v17 )
        break;
    }
    v18 = (_WORD *)*((_QWORD *)&unk_1801B6240 + 3 * (int)i + 2);
    v19 = -1LL;
    v20 = -1LL;
    do
      ++v20;
