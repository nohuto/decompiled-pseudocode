/*
 * XREFs of ?RemoveHead@?$CAtlList@V?$CAutoPtr@VPhoneTopologyWorkItem@@@ATL@@V?$CAutoPtrElementTraits@VPhoneTopologyWorkItem@@@2@@ATL@@QEAA?AV?$CAutoPtr@VPhoneTopologyWorkItem@@@2@XZ @ 0x180148E54
 * Callers:
