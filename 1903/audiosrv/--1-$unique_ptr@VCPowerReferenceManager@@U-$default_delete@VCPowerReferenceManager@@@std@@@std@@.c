/*
 * XREFs of ??1?$unique_ptr@VCPowerReferenceManager@@U?$default_delete@VCPowerReferenceManager@@@std@@@std@@QEAA@XZ @ 0x1800633B4
 * Callers:
 *     _dynamic_atexit_destructor_for__g_powerReferenceManager__ @ 0x180073AE0 (_dynamic_atexit_destructor_for__g_powerReferenceManager__.c)
 * Callees:
