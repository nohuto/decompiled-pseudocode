/*
 * XREFs of ??1?$CAutoPtrArray@VCAccessAce@CDacl@ATL@@@ATL@@QEAA@XZ @ 0x1800DCF24
 * Callers:
 *     _DetermineLowRightsKeySecurityDescriptor_::_1_::dtor$5 @ 0x180070D85 (_DetermineLowRightsKeySecurityDescriptor_--_1_--dtor$5.c)
 * Callees:
