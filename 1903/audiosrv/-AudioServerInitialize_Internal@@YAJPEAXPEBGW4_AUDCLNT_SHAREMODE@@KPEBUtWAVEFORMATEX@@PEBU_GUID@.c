/*
 * XREFs of ?AudioServerInitialize_Internal@@YAJPEAXPEBGW4_AUDCLNT_SHAREMODE@@KPEBUtWAVEFORMATEX@@PEBU_GUID@@PEAUVadServerSettings@@PEAPEAGPEAUIProcessSubmixProxy@@PEAPEAX@Z @ 0x180028320
 * Callers:
 *     AudioServerInitialize @ 0x180028960 (AudioServerInitialize.c)
 ...
 *     WPP_SF_dS @ 0x1800D217C (WPP_SF_dS.c)
