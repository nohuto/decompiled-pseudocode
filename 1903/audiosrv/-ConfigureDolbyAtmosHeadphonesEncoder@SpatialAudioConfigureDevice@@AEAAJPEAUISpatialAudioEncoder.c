/*
 * XREFs of ?ConfigureDolbyAtmosHeadphonesEncoder@SpatialAudioConfigureDevice@@AEAAJPEAUISpatialAudioEncoderProperties@@@Z @ 0x1801321C4
 * Callers:
      ...
      if ( MetadataDictionaryData >= 0 )
      {
        ...
        if ( MetadataDictionaryData >= 0 )
        {
            ...
            if ( MetadataDictionaryData >= 0 )
            {
              ...
              if ( MetadataDictionaryData >= 0 )
              {
                ...
                if ( MetadataDictionaryData >= 0 )
                {
                  MetadataDictionaryData = (*(__int64 (__fastcall **)(_QWORD, __int64))(**((_QWORD **)this + 11) + 48LL))(
                                             *((_QWORD *)this + 11),
                                             v32[0]);
                  v30 = MetadataDictionaryData;
                  if ( MetadataDictionaryData < 0 && (unsigned int)dword_1801B63C0 > 2 )
                  {
                    ...
                    v39 = &v30;
                    v40 = 4LL;
                    TlgWrite((TraceLoggingHProvider)&dword_1801B63C0, &unk_18017CC9B, v27, v28, 5u, &pData);
                  }
                }
                else if ( (unsigned int)dword_1801B63C0 > 2 )
                {
                  ...
                  v39 = &v30;
                  v40 = 4LL;
                  TlgWrite((TraceLoggingHProvider)&dword_1801B63C0, &unk_18017CC9B, v25, v26, 5u, &pData);
                }
              }
              else if ( (unsigned int)dword_1801B63C0 > 2 )
              {
                ...
                v39 = &v30;
                v40 = 4LL;
                TlgWrite((TraceLoggingHProvider)&dword_1801B63C0, &unk_18017CC9B, v21, v22, 5u, &pData);
              }
            }
            else if ( (unsigned int)dword_1801B63C0 > 2 )
            {
          ...
          else if ( (unsigned int)dword_1801B63C0 > 2 )
          {
            ...
            v39 = &v30;
            v40 = 4LL;
            TlgWrite((TraceLoggingHProvider)&dword_1801B63C0, &unk_18017CC9B, v15, v16, 5u, &pData);
          }
        }
        else if ( (unsigned int)dword_1801B63C0 > 2 )
        {
