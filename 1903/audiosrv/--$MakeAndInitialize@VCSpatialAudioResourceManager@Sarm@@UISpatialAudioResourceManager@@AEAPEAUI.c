/*
 * XREFs of ??$MakeAndInitialize@VCSpatialAudioResourceManager@Sarm@@UISpatialAudioResourceManager@@AEAPEAUIAudioPolicyManager@@@Details@WRL@Microsoft@@YAJPEAPEAUISpatialAudioResourceManager@@AEAPEAUIAudioPolicyManager@@@Z @ 0x18005822C
 * Callers:
    ...
    else
    {
      ...
      else
      {
        ...
        if ( IsEqualGUID )
        {
          ...
          g_SpatialAudioResourceManager = (Sarm::CSpatialAudioResourceManager *)((char *)v4 + 8);
        }
