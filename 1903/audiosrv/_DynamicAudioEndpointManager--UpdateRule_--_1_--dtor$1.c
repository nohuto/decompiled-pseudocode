/*
 * XREFs of _DynamicAudioEndpointManager::UpdateRule_::_1_::dtor$1 @ 0x18012C4BD
 * Callers:
 *     <none>
 * Callees:
 *     <none>
...
__int64 __fastcall DynamicAudioEndpointManager::UpdateRule_::_1_::dtor_1(__int64 a1, __int64 a2)
{
