/*
 * XREFs of ?ServiceMain@@YAXKQEAPEAG@Z @ 0x180050BA0
 * Callers:
 *     <none>
 * Callees:
 *     WppInitUm @ 0x180050B18 (WppInitUm.c)
...
void __fastcall ServiceMain(unsigned int a1, LPCWSTR *a2)
{
  ...
  if ( !hEventShutdown )
  {
    dword_1801B84B0 = GetLastError();
    v7 = (unsigned int)dword_1801B84B0;
LABEL_19:
    ReportStatusToSCMgr(1LL, v7, 0LL, v6);
    return;
  }
  dword_1801B84B0 = (*((__int64 (__fastcall **)(HANDLE *, LPCWSTR, HANDLE, void (__fastcall *)(void *, unsigned __int8), _QWORD, int))gpSvchostSharedGlobals
                     + 24))(
                      &hEventShutdownWait,
                      *a2,
                      hEventShutdown,
  ...
  *((_QWORD *)v8 + 2) = v10;
  if ( v10 )
  {
    ...
    {
LABEL_14:
      Thread = CreateThread(0LL, 0LL, AudioSrvStartupThread, v8, 0, 0LL);
      if ( Thread )
      {
        CloseHandle(Thread);
        return;
      ...
      dword_1801B84B0 = GetLastError();
      v18 = (unsigned int)dword_1801B84B0;
      goto LABEL_22;
    }
    v13 = 0LL;
    while ( 1 )
    {
      ...
      *(_QWORD *)(v13 * 8 + *((_QWORD *)v8 + 2)) = HeapAlloc(hHeap, 8u, v15);
      v16 = *(unsigned __int16 **)(v13 * 8 + *((_QWORD *)v8 + 2));
      if ( !v16 || (int)StringCbCopyW(v16, (unsigned int)v15, a2[v13]) < 0 )
        break;
      ++v12;
      ++v13;
      if ( v12 >= a1 )
  ...
  v18 = 8LL;
LABEL_22:
  ReportStatusToSCMgr(1LL, v18, 0LL, v11);
