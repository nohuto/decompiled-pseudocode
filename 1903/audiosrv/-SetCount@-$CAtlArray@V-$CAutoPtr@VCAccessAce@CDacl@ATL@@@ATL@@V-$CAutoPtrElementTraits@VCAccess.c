/*
 * XREFs of ?SetCount@?$CAtlArray@V?$CAutoPtr@VCAccessAce@CDacl@ATL@@@ATL@@V?$CAutoPtrElementTraits@VCAccessAce@CDacl@ATL@@@2@@ATL@@QEAA_N_KH@Z @ 0x18003EBC0
 * Callers:
 ...
 *     ?RemoveAllAces@CDacl@ATL@@UEAAXXZ @ 0x180044BA0 (-RemoveAllAces@CDacl@ATL@@UEAAXXZ.c)
 * Callees:
