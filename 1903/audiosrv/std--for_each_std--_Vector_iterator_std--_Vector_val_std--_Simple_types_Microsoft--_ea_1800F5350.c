/*
 * XREFs of std::for_each_std::_Vector_iterator_std::_Vector_val_std::_Simple_types_Microsoft::WRL::ComPtr_IStreamGroupProxy_________lambda_e04f4d5da8e4b2898f3ec77e31f85733___ @ 0x1800F5350
 * Callers:
...
__int64 *__fastcall std::for_each_std::_Vector_iterator_std::_Vector_val_std::_Simple_types_Microsoft::WRL::ComPtr_IStreamGroupProxy_________lambda_e04f4d5da8e4b2898f3ec77e31f85733___(
        __int64 *a1,
        _QWORD *a2,
        _QWORD *a3,
        __int64 *a4)
  ...
  for ( i = a2; i != a3; ++i )
  {
    ...
    if ( v8 < 0 )
      AudSrvTraceLoggingErrorHelper(
        "CAudioResourceManager::GetSaDeviceForSharedStream::<lambda_e04f4d5da8e4b2898f3ec77e31f85733>::operator ()",
        2023,
        v8);
  }
  *a1 = 0LL;
