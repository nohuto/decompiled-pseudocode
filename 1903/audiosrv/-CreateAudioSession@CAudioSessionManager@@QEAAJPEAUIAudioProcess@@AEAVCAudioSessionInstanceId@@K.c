/*
 * XREFs of ?CreateAudioSession@CAudioSessionManager@@QEAAJPEAUIAudioProcess@@AEAVCAudioSessionInstanceId@@KKKPEAPEAVCAudioSession@@@Z @ 0x180021E90
 * Callers:
        ...
        struct CAudioSession **a7)
{
  ...
  __int64 v133; // [rsp+F8h] [rbp-580h] BYREF
  ...
  __int64 v145; // [rsp+148h] [rbp-530h]
  struct CAudioSession **v146; // [rsp+150h] [rbp-528h]
  __int64 v147; // [rsp+158h] [rbp-520h] BYREF
  ...
  __int64 v249; // [rsp+420h] [rbp-258h]
  __int64 v250; // [rsp+428h] [rbp-250h]
  __int64 v251; // [rsp+430h] [rbp-248h]
  __int64 v252; // [rsp+438h] [rbp-240h]
  __int64 v253; // [rsp+440h] [rbp-238h]
  ...
  __int64 v265; // [rsp+4A0h] [rbp-1D8h]
  __int64 *v266; // [rsp+4A8h] [rbp-1D0h]
  __int64 v267; // [rsp+4B0h] [rbp-1C8h]
...
LABEL_67:
            *(_QWORD *)(v10 + 392) = GetTickCount64();
            ...
            v255 = -10000LL * *(unsigned int *)(v10 + 312);
            v148 = v255;
            ...
            v38 = v111;
            v256 = v111;
            v111 = (CAudioSession *)v10;
            v108 = (CAudioSession *)v10;
            (*(void (__fastcall **)(__int64))(*(_QWORD *)v10 + 8LL))(v10);
            if ( v38 )
        ...
        v95 = CAudioSession::RegisterOwnerProcess((CAudioSession *)v10, v114);
        v96 = v95;
        v168 = v95;
        if ( v95 >= 0 )
          goto LABEL_67;
        ...
        wil::com_ptr_t<Windows::Graphics::Holographic::IHolographicDisplay,wil::err_returncode_policy>::~com_ptr_t<Windows::Graphics::Holographic::IHolographicDisplay,wil::err_returncode_policy>(&v133);
        wil::com_ptr_t<Windows::Graphics::Holographic::IHolographicDisplay,wil::err_returncode_policy>::~com_ptr_t<Windows::Graphics::Holographic::IHolographicDisplay,wil::err_returncode_policy>(&v108);
        return v96;
      }
LABEL_71:
      if ( v10 != -616 )
    ...
    else
    {
      ...
      v283 = v49;
      v53 = (*(__int64 (__fastcall **)(CAudioSession *, struct IAudioProcess *, __int64, _QWORD, unsigned int, unsigned int, GUID *))(*(_QWORD *)v47 + 240LL))(
              v47,
              v114,
              v52,
              v45,
        ...
        for ( k = *(__int64 **)(*(_QWORD *)v57 + 8 * v62); ; k = (__int64 *)k[11] )
        {
          ...
          if ( v176 == v60 )
          {
            ...
            if ( !(unsigned int)_o__wcsicmp(v264, v263) )
            {
              ...
              v266 = k + 7;
              v98 = *((_DWORD *)k + 16);
              if ( v98 == *(_DWORD *)(v52 + 64) && (v98 || *((_DWORD *)k + 14) == *(_DWORD *)(v52 + 56)) )
              {
                v267 = v52 + 8;
                v268 = k + 1;
                v99 = *((_DWORD *)k + 12);
                if ( v99 == *(_DWORD *)(v52 + 48) )
                {
                  if ( v99 || (v269 = *(_QWORD *)(v52 + 8), v270 = k[1], (v178 = _o__wcsicmp(v270, v269)) == 0) )
                  {
                    v100 = k[3] - *(_QWORD *)(v52 + 24);
                    if ( !v100 )
                      v100 = k[4] - *(_QWORD *)(v52 + 32);
                    if ( !v100 )
                    {
                      v271 = v56;
