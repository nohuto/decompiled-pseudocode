/*
 * XREFs of ?CreateFromValueInternal@SemaphoreValue@details_abi@wil@@AEAAJPEBG_N_K@Z @ 0x18005D158
 * Callers:
        ...
        unsigned __int64 a4)
{
  ...
  else
  {
    ...
    if ( v33 < 0 )
    {
      wil::details::in1diag3::Return_Hr(retaddr, (void *)0x80, (__int64)"wil", (const char *)(unsigned int)v33);
