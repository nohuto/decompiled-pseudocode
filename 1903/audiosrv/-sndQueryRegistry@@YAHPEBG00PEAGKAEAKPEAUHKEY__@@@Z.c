/*
 * XREFs of ?sndQueryRegistry@@YAHPEBG00PEAGKAEAKPEAUHKEY__@@@Z @ 0x18004C568
 * Callers:
 ...
 *     ?sndRegQueryValue@@YAHPEAUHKEY__@@PEBG1KPEAG@Z @ 0x18004C7B8 (-sndRegQueryValue@@YAHPEAUHKEY__@@PEBG1KPEAG@Z.c)
 *     ?GetSoundRegistryPath@@YAHPEAG_KPEBG22@Z @ 0x18004C800 (-GetSoundRegistryPath@@YAHPEAG_KPEBG22@Z.c)
 *     __security_check_cookie @ 0x180063BD0 (__security_check_cookie.c)
 *     ?sndRegQueryUserValue@@YAHPEBG0KPEAG@Z @ 0x18013CA6C (-sndRegQueryUserValue@@YAHPEBG0KPEAG@Z.c)
 */
  ...
  if ( GetSoundRegistryPath(SubKey, (unsigned __int64)a2, a3, a2, a3) )
  {
    if ( a7 ? sndRegQueryValue(a7, SubKey, v10, 0x104u, a4) : (unsigned int)sndRegQueryUserValue(SubKey, v9, 0x104u, a4) )
    {
      ...
      if ( !RegGetValueW(v12, SubKey, gszDefaultFlags, 0x10u, 0LL, &pvData, pcbData) )
        pvData &= 0x380002u;
      if ( !(unsigned int)StringCbCatW(SubKey, 0x25CuLL, (const unsigned __int16 *)gszSlash)
