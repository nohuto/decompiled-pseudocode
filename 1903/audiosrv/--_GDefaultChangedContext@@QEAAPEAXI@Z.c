/*
 * XREFs of ??_GDefaultChangedContext@@QEAAPEAXI@Z @ 0x180107DA4
 * Callers:
 *     ??1?$CAutoPtr@UDefaultChangedContext@@@ATL@@QEAA@XZ @ 0x1801077F4 (--1-$CAutoPtr@UDefaultChangedContext@@@ATL@@QEAA@XZ.c)
