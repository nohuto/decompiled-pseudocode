/*
 * XREFs of _lambda_12caadf06097df6adadb33ec639f4e18_::operator() @ 0x1800376C8
 * Callers:
 *     std::_Func_impl_no_alloc__lambda_12caadf06097df6adadb33ec639f4e18__long_SystemEffectDescriptor___SystemEffectChainDescriptor___::_Do_call @ 0x1800376B0 (std--_Func_impl_no_alloc__lambda_12caadf06097df6adadb33ec639f4e18__long_SystemEffectDescriptor__.c)
 * Callees:
...
__int64 __fastcall lambda_12caadf06097df6adadb33ec639f4e18_::operator()(
        ...
        __int64 a3)
{
  ...
  for ( i = 0; i < *(_DWORD *)(a3 + 8); ++i )
  {
    ...
    if ( VirtualSurroundEffectMode == 2 )
    {
      ...
      v19 = 0;
      v8 = 1;
      if ( (int)lambda_cd418586ae46a8fc9b3fb78e22f50b3b_::operator()(a1 + 1, a2, &v23, &v20, v22) >= 0 )
      {
        v11 = v22[0];
        if ( v22[0] )
        {
...
LABEL_24:
        if ( v8
          && v20
          && ((unsigned __int8)lambda_1cf1c298c02d1937c63822c825393df5_::operator()(v11, v20, 48000LL, 6LL)
           || (unsigned __int8)lambda_1cf1c298c02d1937c63822c825393df5_::operator()(v15, v20, 48000LL, 8LL)
           || (unsigned __int8)lambda_1cf1c298c02d1937c63822c825393df5_::operator()(v16, v20, 44100LL, 6LL)
           || (unsigned __int8)lambda_1cf1c298c02d1937c63822c825393df5_::operator()(v17, v20, 44100LL, 8LL)) )
        {
          v8 = 0;
        }
      }
    ...
    v9 = ATL::CSimpleArray<_GUID,ATL::CSimpleArrayEqualHelper<_GUID>>::Find((char *)*a1 + 72, &v23);
    LODWORD(v18) = 1;
    SystemEffectDescriptor::UpdateEffectsInOverridingChain(
      a2,
      a3,
      v8,
      (unsigned __int64)&unk_1801B7690 & -(__int64)v8,
      v18,
      v9 != -1);
  }
  *(_DWORD *)(a3 + 16) = 28;
