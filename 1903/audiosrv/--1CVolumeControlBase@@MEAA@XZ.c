/*
 * XREFs of ??1CVolumeControlBase@@MEAA@XZ @ 0x1800C52C0
 * Callers:
 ...
 *     _CVolumeSoftware::CVolumeSoftware_::_1_::dtor$0 @ 0x1800C8C8C (_CVolumeSoftware--CVolumeSoftware_--_1_--dtor$0.c)
