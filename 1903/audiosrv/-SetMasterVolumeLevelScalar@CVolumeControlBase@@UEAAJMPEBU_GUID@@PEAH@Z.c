/*
 * XREFs of ?SetMasterVolumeLevelScalar@CVolumeControlBase@@UEAAJMPEBU_GUID@@PEAH@Z @ 0x1800C7BA0
 * Callers:
 *     <none>
 * Callees:
 ...
 *     WPP_SF_qg_guid_ @ 0x1800C8B00 (WPP_SF_qg_guid_.c)
 *     WPP_SF_qggg @ 0x1800C8BC4 (WPP_SF_qggg.c)
 */
