/*
 * XREFs of ?RefreshLicenseStatus@AtmosCheck@@QEAAJPEBG@Z @ 0x18013FDB8
 * Callers:
 ...
 *     ??1?$vector@V?$basic_string@GU?$char_traits@G@std@@V?$allocator@G@2@@std@@V?$allocator@V?$basic_string@GU?$char_traits@G@std@@V?$allocator@G@2@@std@@@2@@std@@QEAA@XZ @ 0x18006A098 (--1-$vector@V-$basic_string@GU-$char_traits@G@std@@V-$allocator@G@2@@std@@V-$allocator@V-$basic_.c)
 *     ??9?$_Vector_const_iterator@V?$_Vector_val@U?$_Simple_types@V?$basic_string@GU?$char_traits@G@std@@V?$allocator@G@2@@std@@@std@@@std@@@std@@QEBA_NAEBV01@@Z @ 0x18006A0E0 (--9-$_Vector_const_iterator@V-$_Vector_val@U-$_Simple_types@V-$basic_string@GU-$char_traits@G@st.c)
  ...
  if ( CurrentEndpointsUnderLock >= 0 )
  {
    ...
    if ( std::_Vector_const_iterator<std::_Vector_val<std::_Simple_types<std::wstring>>>::operator!=(&v24, &v23) )
    {
      ...
      do
      {
        ...
        if ( (unsigned int)dword_1801B64F0 > 5 && TlgKeywordOn((TraceLoggingHProvider)&dword_1801B64F0, 0LL) )
        {
          _TlgCreateAuto(&pDesc, a2);
          v30 = &v22;
          v31 = 1;
          v32 = 0;
          TlgWrite((TraceLoggingHProvider)&dword_1801B64F0, &unk_18017D473, v16, v17, 4u, &pData);
        }
        if ( v11 || v22 )
          v11 = 1;
        v12 += 32LL;
      ...
      if ( v11 )
      {
        ...
        if ( v19 )
        {
          if ( v18 > 5 )
          {
            if ( TlgKeywordOn((TraceLoggingHProvider)&dword_1801B64F0, 0LL) )
            {
              _TlgCreateAuto(&pDesc, a2);
              TlgWrite((TraceLoggingHProvider)&dword_1801B64F0, &unk_18017D208, v20, v21, 3u, &pData);
              v19 = (void (__fastcall ***)(_QWORD))*((_QWORD *)this + 5);
            }
          }
          (**v19)(v19);
