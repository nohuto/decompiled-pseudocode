/*
 * XREFs of ??_GCStreamConnectionImpl@CMonitorManager@@QEAAPEAXI@Z @ 0x180107CB4
 * Callers:
 *     _std::shared_ptr_CStreamConnection_::_Setp_CMonitorManager::CStreamConnectionImpl__::_1_::catch$1 @ 0x18010733D (_std--shared_ptr_CStreamConnection_--_Setp_CMonitorManager--CStreamConnectionImpl__--_1_--catch$.c)
 *     ?_Destroy@?$_Ref_count@VCStreamConnectionImpl@CMonitorManager@@@std@@EEAAXXZ @ 0x18010D7B0 (-_Destroy@-$_Ref_count@VCStreamConnectionImpl@CMonitorManager@@@std@@EEAAXXZ.c)
 * Callees:
