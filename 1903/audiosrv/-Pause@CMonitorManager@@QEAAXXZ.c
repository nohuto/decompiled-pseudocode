/*
 * XREFs of ?Pause@CMonitorManager@@QEAAXXZ @ 0x18010C040
 * Callers:
 *     ?PauseAllMonitors@CStreamConnectionManagerImpl@@UEAAXXZ @ 0x18010C140 (-PauseAllMonitors@CStreamConnectionManagerImpl@@UEAAXXZ.c)
 * Callees:
