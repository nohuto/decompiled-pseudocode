/*
 * XREFs of ?what@ResultException@wil@@UEBAPEBDXZ @ 0x1800BD0A0
 * Callers:
 *     <none>
 * Callees:
 ...
 *     ?StringCchPrintfA@details@wil@@YAJPEAD_KPEBDZZ @ 0x1800BCC2C (-StringCchPrintfA@details@wil@@YAJPEAD_KPEBDZZ.c)
