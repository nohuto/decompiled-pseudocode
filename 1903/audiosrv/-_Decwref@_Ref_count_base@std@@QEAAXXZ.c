/*
 * XREFs of ?_Decwref@_Ref_count_base@std@@QEAAXXZ @ 0x1800632A0
 * Callers:
 ...
 *     _dynamic_atexit_destructor_for__g_weakStreamMonitorManager__ @ 0x180073A00 (_dynamic_atexit_destructor_for__g_weakStreamMonitorManager__.c)
 *     _dynamic_atexit_destructor_for__CStreamConnectionManagerImpl::s_weakSelf__ @ 0x180073B00 (_dynamic_atexit_destructor_for__CStreamConnectionManagerImpl--s_weakSelf__.c)
 * Callees:
