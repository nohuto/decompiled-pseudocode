/*
 * XREFs of ?DoSetCellularRouting@PhoneTopology@@AEAAJAEBU_tagKSTOPOLOGY_ENDPOINTIDPAIR@@@Z @ 0x1801479EC
 * Callers:
 *     ?Process@SetCellularRoutingWorkItem@@UEAAXPEAVPhoneTopology@@@Z @ 0x180148D70 (-Process@SetCellularRoutingWorkItem@@UEAAXPEAVPhoneTopology@@@Z.c)
 * Callees:
