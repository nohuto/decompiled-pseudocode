/*
 * XREFs of _DialogSession::RuntimeClassInitialize_::_1_::dtor$1 @ 0x180104453
 * Callers:
 *     <none>
 * Callees:
 *     <none>
...
__int64 __fastcall DialogSession::RuntimeClassInitialize_::_1_::dtor_1(__int64 a1, __int64 a2)
{
