/*
 * XREFs of PolicyConfigGetAccessibilityAudioMonoMixState @ 0x1800E1B10
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall PolicyConfigGetAccessibilityAudioMonoMixState(__int64 a1, __int64 a2)
{
  ...
  v5 = (*(__int64 (__fastcall **)(CPolicyConfig *, __int64))(*(_QWORD *)g_PolicyConfig + 176LL))(g_PolicyConfig, a2);
