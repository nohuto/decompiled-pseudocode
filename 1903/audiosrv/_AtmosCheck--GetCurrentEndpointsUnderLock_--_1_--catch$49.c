/*
 * XREFs of _AtmosCheck::GetCurrentEndpointsUnderLock_::_1_::catch$49 @ 0x18006AC04
 * Callers:
 *     <none>
 * Callees:
...
void *__fastcall AtmosCheck::GetCurrentEndpointsUnderLock_::_1_::catch_49(
        __int64 a1,
        __int64 a2,
        __int64 a3,
        const char *a4)
