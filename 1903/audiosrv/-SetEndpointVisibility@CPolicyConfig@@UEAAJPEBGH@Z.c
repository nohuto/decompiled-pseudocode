/*
 * XREFs of ?SetEndpointVisibility@CPolicyConfig@@UEAAJPEBGH@Z @ 0x1800E0B80
 * Callers:
 *     <none>
 * Callees:
...
LABEL_3:
  ...
  if ( **((_DWORD **)Context + 1) > 4u )
  {
    ...
    v20 = &v12;
    v21 = 4;
    TlgWrite(v8, &unk_1801781DC, v7, (LPCGUID)v8, 4u, &pData);
  }
  v4 = CoCreateInstance(
  ...
  if ( !v12 )
  {
    ...
    *(_QWORD *)fPending = 0LL;
    ...
    if ( (int)GetAudioSessionManagerProvider((struct CAudioSessionManagerProvider **)fPending) >= 0 )
    {
      ...
      v9 = (volatile signed __int32 *)Context;
      if ( !AudioSessionManager )
        CAudioSessionManager::Disconnect((__int64)Context, 0, 1);
    }
    if ( *(_QWORD *)fPending )
      Microsoft::WRL::Details::RuntimeClassImpl<Microsoft::WRL::RuntimeClassFlags<2>,1,0,0,IUnknown>::Release(*(volatile signed __int32 **)fPending);
    if ( v9 )
