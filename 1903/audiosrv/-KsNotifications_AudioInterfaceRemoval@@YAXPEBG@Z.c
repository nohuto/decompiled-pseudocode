/*
 * XREFs of ?KsNotifications_AudioInterfaceRemoval@@YAXPEBG@Z @ 0x18011EAE8
 * Callers:
 *     ?DeviceRemovalEvent@CAudioSrv@@UEAAJV?$CHeapPtr@U_DEV_BROADCAST_DEVICEINTERFACE_W@@VCCRTAllocator@ATL@@@ATL@@@Z @ 0x1800BF0C0 (-DeviceRemovalEvent@CAudioSrv@@UEAAJV-$CHeapPtr@U_DEV_BROADCAST_DEVICEINTERFACE_W@@VCCRTAllocato.c)
 * Callees:
    ...
    do
    {
      ...
      if ( !v9 )
      {
        if ( v4 == v2 )
          ...
          *(_QWORD *)v4[1] = *v4;
        if ( v4 == (void **)qword_1801B9470 )
          qword_1801B9470 = (__int64)v4[1];
        else
          *((_QWORD *)*v4 + 1) = v4[1];
        --dword_1801B9478;
        *v4 = 0LL;
