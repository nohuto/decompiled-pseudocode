/*
 * XREFs of ServiceDeviceEvent @ 0x180112E28
 * Callers:
 ...
 *     ?EventTypeNameFromEventType@@YAPEBG_K@Z @ 0x180112858 (-EventTypeNameFromEventType@@YAPEBG_K@Z.c)
...
__int64 __fastcall ServiceDeviceEvent(unsigned int a1, struct _DEV_BROADCAST_DEVICEINTERFACE_W *a2)
{
  ...
  if ( (unsigned int)dword_1801B64B8 > 4 )
  {
    ...
    TlgWrite((TraceLoggingHProvider)&dword_1801B64B8, &unk_180179D64, v5, v6, 3u, &pData);
  }
