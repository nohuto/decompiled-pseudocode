/*
 * XREFs of ?IsAudioFormatSupported@CAPOWrapperClient@@AEAAJW4__MIDL___MIDL_itf_audioenginepolicy_0000_0010_0001@@PEAUIAudioMediaType@@1PEAPEAU3@@Z @ 0x18001C940
 * Callers:
 *     ?IsInputFormatSupported@CAPOWrapperClient@@UEAAJPEAUIAudioMediaType@@0PEAPEAU2@@Z @ 0x18001CA80 (-IsInputFormatSupported@CAPOWrapperClient@@UEAAJPEAUIAudioMediaType@@0PEAPEAU2@@Z.c)
 *     ?IsOutputFormatSupported@CAPOWrapperClient@@UEAAJPEAUIAudioMediaType@@0PEAPEAU2@@Z @ 0x18013B060 (-IsOutputFormatSupported@CAPOWrapperClient@@UEAAJPEAUIAudioMediaType@@0PEAPEAU2@@Z.c)
 * Callees:
        ...
        struct IAudioMediaType **a5)
{
  ...
  if ( (unsigned int)dword_1801B64B8 > 2 )
  {
    ...
    v23 = &v14;
    v24 = 4LL;
    TlgWrite((TraceLoggingHProvider)&dword_1801B64B8, &unk_18017CDBD, a3, v9, 5u, &pData);
    v11 = v14;
  }
LABEL_12:
  CoTaskMemFree(pv);
