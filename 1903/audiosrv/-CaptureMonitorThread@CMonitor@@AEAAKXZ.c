/*
 * XREFs of ?CaptureMonitorThread@CMonitor@@AEAAKXZ @ 0x18010E134
 * Callers:
 *     ?CaptureMonitorThreadWrapper@CMonitor@@CAKPEAX@Z @ 0x18010E240 (-CaptureMonitorThreadWrapper@CMonitor@@CAKPEAX@Z.c)
 * Callees:
 ...
 *     ?ResetEngineThreadPriority@@YAJPEAPEAX@Z @ 0x18011245C (-ResetEngineThreadPriority@@YAJPEAPEAX@Z.c)
