/*
 * XREFs of AudioServerTelephonyControlEndSession @ 0x1800EA740
 * Callers:
 *     <none>
 * Callees:
...
__int64 AudioServerTelephonyControlEndSession()
{
  ...
  CWatchdogTimer<1>::CWatchdogTimer<1>(pv, v6[1], v0, (struct _TP_TIMER *)L"AudioServerTelephonyControlEndSession");
  v2 = ((__int64 (__fastcall *)(struct IUnknown *))g_TelephonyControl->lpVtbl[1].Release)(g_TelephonyControl);
