/*
 * XREFs of ?PerformLicenseCheckHelper@AtmosCheck@@AEAAXPEBGHPEAUEndpointSpecificSpatialTechInfo@1@PEA_N@Z @ 0x18006B01C
 * Callers:
        ...
        bool *a5)
{
  ...
  if ( *((_BYTE *)this + 600) )
  {
    if ( (unsigned int)dword_1801B64F0 > 5 )
      TlgWrite((TraceLoggingHProvider)&dword_1801B64F0, &unk_18017D0EE, a3, a4, 2u, &pData);
  }
  else
  {
    v13 = 0;
