/*
 * XREFs of ?DeleteSessionNotification@CAudioSession@@UEAAJPEAUISessionInternalEvents@@@Z @ 0x18003DED0
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall CAudioSession::DeleteSessionNotification(CAudioSession *this, struct ISessionInternalEvents *a2)
{
  ...
  {
    WPP_SF_q(*((_QWORD *)WPP_GLOBAL_Control + 2), 93LL, &WPP_7f1ef5860f2032d8a1536e1a5abdceb7_Traceguids, a2);
  }
  if ( a2 )
