/*
 * XREFs of ?TraceResult@AtmosCheck@@AEAAXJ_N@Z @ 0x180047540
 * Callers:
...
void __fastcall AtmosCheck::TraceResult(AtmosCheck *this, unsigned int a2, char a3)
{
  ...
  if ( !*((_BYTE *)this + 97) || a3 )
  {
    if ( (unsigned int)dword_1801B64F0 > 4 && TlgKeywordOn((TraceLoggingHProvider)&dword_1801B64F0, 0x400000000000uLL) )
    {
      v36 = 0;
      v39 = 0;
      v34 = &v12;
      ...
      v43 = v10;
      TlgWrite((TraceLoggingHProvider)&dword_1801B64F0, &unk_18017D2EF, v11, &pRelatedActivityId, 7u, &pData);
    }
    *((_BYTE *)this + 97) = 1;
  }
  else if ( (unsigned int)dword_1801B64F0 > 4 )
  {
    v24 = 0;
    v27 = 0;
    v22 = &v13;
    ...
    v16 = off_1801B64F8;
    v14[0] = 184549376;
    v17 = *(unsigned __int16 *)off_1801B64F8;
    v19 = &unk_18017D41C;
    v18 = 2;
    v20 = 86;
    v21 = 1;
    v12 = (unsigned int)&TraceLoggingMetadataEnd - (unsigned int)&TraceLoggingMetadata;
    EtwEventWriteTransfer(qword_1801B6510, v14, 0LL, 0LL, 7, &v16);
  }
}
