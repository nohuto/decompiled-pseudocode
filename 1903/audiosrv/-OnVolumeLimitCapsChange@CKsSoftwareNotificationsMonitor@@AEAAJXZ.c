/*
 * XREFs of ?OnVolumeLimitCapsChange@CKsSoftwareNotificationsMonitor@@AEAAJXZ @ 0x1800EC074
 * Callers:
...
__int64 __fastcall CKsSoftwareNotificationsMonitor::OnVolumeLimitCapsChange(CKsSoftwareNotificationsMonitor *this)
{
  ...
  if ( (byte_1801B9781 & 2) != 0 )
    McTemplateU0p(this, &EVT_VOLUME_LIMIT_CHANGED_ENTER, this);
      ...
      if ( v4 >= 0 )
      {
        ...
        if ( v4 >= 0 )
        {
          ...
          if ( v4 >= 0 )
          {
            ...
            {
              if ( (byte_1801B9781 & 2) != 0 )
                McTemplateU0p(v3, &EVT_VOLUME_LIMIT_PUBLISH_WNF_AVLC_STATE, this);
  ...
  if ( (byte_1801B9781 & 2) != 0 )
    McTemplateU0pq(v3, v2, this, (unsigned int)v4);
  if ( pv )
  {
    CoTaskMemFree(pv);
    pv = 0LL;
