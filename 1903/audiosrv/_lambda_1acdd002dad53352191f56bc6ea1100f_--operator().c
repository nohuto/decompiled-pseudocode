/*
 * XREFs of _lambda_1acdd002dad53352191f56bc6ea1100f_::operator() @ 0x1800F583C
 * Callers:
 *     std::_Func_impl_no_alloc__lambda_b2f72c50110305d9aa06d2931c2147e0__void_::_Do_call @ 0x1800F1510 (std--_Func_impl_no_alloc__lambda_b2f72c50110305d9aa06d2931c2147e0__void_--_Do_call.c)
 * Callees:
...
LABEL_10:
      ...
      if ( **((_DWORD **)Context + 1) > 4u )
      {
        ...
        TlgWrite(v14, &unk_18017913A, v13, (LPCGUID)v14, 4u, &pData);
      }
      Microsoft::WRL::ComPtr<ISpatialAudioPositionCalc>::InternalRelease(&v18);
      if ( lpCriticalSection[0] )
        LeaveCriticalSection(lpCriticalSection[0]);
