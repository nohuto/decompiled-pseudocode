/*
 * XREFs of ?AddToDynamicPool@CEndpointResourcePool@Sarm@@QEAAJI@Z @ 0x1801239F4
 * Callers:
...
__int64 __fastcall Sarm::CEndpointResourcePool::AddToDynamicPool(Sarm::CEndpointResourcePool *this, unsigned int Data1)
{
  ...
  if ( (unsigned int)dword_1801B6350 > 4 )
  {
    ...
    v9 = this;
    v22 = 8LL;
    TlgWrite((TraceLoggingHProvider)&dword_1801B6350, &unk_18017A765, &pActivityId, (LPCGUID)(v3 + 20), 8u, &pData);
    v3 = *((_QWORD *)this + 2);
