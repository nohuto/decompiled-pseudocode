/*
 * XREFs of ?GetDeviceSettings@SpatialAudioDevicePropertyReader@@UEAAJPEAUSpatialAudioSettings@@PEAUSpatialAudioEncoderDescriptor@@I@Z @ 0x180043630
 * Callers:
 *     <none>
 * Callees:
        ...
        unsigned int a4)
{
  ...
  if ( !*((_DWORD *)this + 128) )
  {
    ...
    if ( (unsigned int)dword_1801B63C0 > 2 )
    {
      ...
      v22 = v16;
      v23 = 4LL;
      TlgWrite((TraceLoggingHProvider)&dword_1801B63C0, &unk_18017CCCD, v10, v11, 5u, &pData);
    }
    return v14;
  }
  if ( !a2 )
