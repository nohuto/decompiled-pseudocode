/*
 * XREFs of ?PerformLicenseCheckInternalLegacy@AtmosCheck@@AEAAJPEA_N@Z @ 0x180009498
 * Callers:
 ...
 *     ??$?0$0O@@StringReference@Internal@Windows@@QEAA@AEAY0O@$$CBG@Z @ 0x18013D110 (--$-0$0O@@StringReference@Internal@Windows@@QEAA@AEAY0O@$$CBG@Z.c)
...
LABEL_26:
  ...
  if ( (unsigned int)dword_1801B64F0 > 5 )
  {
    ...
    v111 = 0LL;
    v136 = off_1801B64F8;
    v137 = *(unsigned __int16 *)off_1801B64F8;
    v138 = 2;
    v139 = &unk_18017D0D6;
    v140 = 23;
    v141 = 1;
    v94 = (unsigned int)&TraceLoggingMetadataEnd - (unsigned int)&TraceLoggingMetadata;
    EtwEventWriteTransfer(qword_1801B6510, v110, 0LL, 0LL, 3, &v136);
  }
  pcbData = 0;
  v18 = 0;
  if ( !v96 )
