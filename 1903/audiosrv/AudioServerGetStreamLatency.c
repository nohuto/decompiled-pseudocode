/*
 * XREFs of AudioServerGetStreamLatency @ 0x1800E8A70
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall AudioServerGetStreamLatency(char *a1, __int64 a2, __int64 a3)
{
  ...
  v8 = (*(__int64 (__fastcall **)(char *, __int64, __int64))(*(_QWORD *)a1 + 120LL))(a1, a2, a3);
  v9 = v8;
  if ( v8 < 0 )
    AudSrvTraceLoggingErrorHelper("AudioServerGetStreamLatency", 3646, v8);
