/*
 * XREFs of ?FinishConstruction@CServerAudioSessionControl@@UEAAJK_NPEAVCAudioSession@@@Z @ 0x180040400
 * Callers:
 *     <none>
 * Callees:
 ...
 *     WPP_SF_qqS @ 0x1800D533C (WPP_SF_qqS.c)
 */
  ...
  *((_QWORD *)this + 9) = a4;
  ...
  if ( v10 )
  {
    if ( WPP_GLOBAL_Control != (CAudioSessionManager *)&WPP_GLOBAL_Control
      ...
      && *((_BYTE *)WPP_GLOBAL_Control + 25) >= 4u )
    {
      WPP_SF_qq(*((_QWORD *)WPP_GLOBAL_Control + 2), 13LL, &WPP_abea1e1b786a3a68e8bf6ce6f4b20d30_Traceguids, this, a4);
    }
    v13 = *((_QWORD *)this + 9);
    if ( v13 )
    {
  ...
  if ( v10 < 0 )
    AudSrvTraceLoggingErrorHelper("CServerAudioSessionControl::FinishConstruction", 125, v10);
