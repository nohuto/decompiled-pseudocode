/*
 * XREFs of ?CreateBridgeStream@CSharedStreamGroupProxy@@UEAAJPEAUBRIDGE_STREAM_DESCRIPTOR@@PEAUIStreamGroupProxy@@PEAUSYSTEM_AUDIO_STREAM@@@Z @ 0x1800EE650
 * Callers:
 *     <none>
 * Callees:
...
LABEL_10:
  ...
  if ( *(_DWORD *)v14 > 4u )
  {
    ...
    v28 = 8;
    v31 = 8;
    TlgWrite(v14, &unk_180178982, (LPCGUID)v14, v12, 5u, &pData);
  }
  v15 = v17;
  if ( v20 )
