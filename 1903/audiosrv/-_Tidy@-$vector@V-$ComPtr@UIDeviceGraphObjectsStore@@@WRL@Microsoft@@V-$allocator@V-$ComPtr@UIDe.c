/*
 * XREFs of ?_Tidy@?$vector@V?$ComPtr@UIDeviceGraphObjectsStore@@@WRL@Microsoft@@V?$allocator@V?$ComPtr@UIDeviceGraphObjectsStore@@@WRL@Microsoft@@@std@@@std@@AEAAXXZ @ 0x1800F40B0
 * Callers:
...
void __fastcall std::vector<Microsoft::WRL::ComPtr<IDeviceGraphObjectsStore>>::_Tidy(__int64 a1)
{
  __int64 *v1; // rbx
  __int64 *v3; // rsi
  __int64 v4; // rcx
