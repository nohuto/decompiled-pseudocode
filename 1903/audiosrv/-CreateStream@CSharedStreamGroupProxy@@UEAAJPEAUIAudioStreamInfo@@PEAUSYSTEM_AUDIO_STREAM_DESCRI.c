/*
 * XREFs of ?CreateStream@CSharedStreamGroupProxy@@UEAAJPEAUIAudioStreamInfo@@PEAUSYSTEM_AUDIO_STREAM_DESCRIPTOR@@PEAUIAudioGraphCallback@@KPEAUSYSTEM_AUDIO_STREAM@@@Z @ 0x1800EE9F0
 * Callers:
 *     <none>
 * Callees:
...
LABEL_3:
  ...
  *((_QWORD *)a6 + 6) = (unsigned __int64)this & -(__int64)(this != (CSharedStreamGroupProxy *)8);
  ...
  _InterlockedAdd((volatile signed __int32 *)(2 * v13 + 16), 1u);
LABEL_11:
