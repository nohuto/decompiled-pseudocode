/*
 * XREFs of ?Release@?$CComAggObject@VCAPOWrapperSrv@@@ATL@@UEAAKXZ @ 0x18011C2C0
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall ATL::CComAggObject<CAPOWrapperSrv>::Release(volatile signed __int32 *a1)
{
