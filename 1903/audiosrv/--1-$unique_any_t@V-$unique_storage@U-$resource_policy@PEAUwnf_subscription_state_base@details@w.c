/*
 * XREFs of ??1?$unique_any_t@V?$unique_storage@U?$resource_policy@PEAUwnf_subscription_state_base@details@wil@@P6AXPEAU123@@Z$1?delete_wnf_subscription_state@23@YAX0@ZU?$integral_constant@_K$01@wistd@@PEAU123@PEAU123@$0A@$$T@details@wil@@@details@wil@@@wil@@QEAA@XZ @ 0x18013DA44
 * Callers:
 *     _AtmosCheck::AtmosCheck_::_1_::dtor$4 @ 0x18006D18B (_AtmosCheck--AtmosCheck_--_1_--dtor$4.c)
 * Callees:
