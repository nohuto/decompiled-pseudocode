/*
 * XREFs of ?ToString@CAppAudioSessionId@@QEBAJAEAV?$CStringT@GV?$StrTraitATL@GV?$ChTraitsCRT@G@ATL@@@ATL@@@ATL@@@Z @ 0x180023680
 * Callers:
...
__int64 __fastcall CAppAudioSessionId::ToString(__int64 a1, void **a2)
{
  ...
  if ( v4 - 24 != (char *)v6 )
  {
    ...
    catch ( ATL::CAtlException *v13 )
    {
      ...
      v3 = *v9;
      if ( v14 < 0 )
        AudSrvTraceLoggingErrorHelper("CAppAudioSessionId::ToString", 0x209u, v14);
    }
  }
  return v3;
}
