/*
 * XREFs of AudioServerGetEndpointBufferSize @ 0x1800E80A0
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall AudioServerGetEndpointBufferSize(char *a1, __int64 a2, __int64 a3)
{
  ...
  CWatchdogTimer<1>::CWatchdogTimer<1>(
    ...
    *((struct _TP_TIMER **)Context + 1),
    v6,
    (struct _TP_TIMER *)L"AudioServerGetEndpointBufferSize");
  v8 = (*(__int64 (__fastcall **)(char *, __int64, __int64))(*(_QWORD *)a1 + 112LL))(a1, a2, a3);
  v9 = v8;
  if ( v8 < 0 )
    AudSrvTraceLoggingErrorHelper("AudioServerGetEndpointBufferSize", 3612, v8);
