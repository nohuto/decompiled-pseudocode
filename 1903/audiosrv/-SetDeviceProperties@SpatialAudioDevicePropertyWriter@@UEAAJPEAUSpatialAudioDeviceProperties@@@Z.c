/*
 * XREFs of ?SetDeviceProperties@SpatialAudioDevicePropertyWriter@@UEAAJPEAUSpatialAudioDeviceProperties@@@Z @ 0x18012FA40
 * Callers:
 *     <none>
 * Callees:
        ...
        BYTE *a2)
{
  ...
  else
  {
    ...
    if ( (unsigned int)dword_1801B63C0 > 2 )
    {
      ...
      v12 = -2147024809;
      v22 = &v12;
      TlgWrite((TraceLoggingHProvider)&dword_1801B63C0, &unk_18017CCCD, v5, v6, 5u, &pData);
    }
  }
  return v7;
}
