/*
 * XREFs of ?GetAudioFormatForSpatialFormat@CSpatialProperties@@QEAAJPEAVCEndpointCharacteristics@@_NPEBUSpatialAudioSettings@@PEBUtWAVEFORMATEX@@3PEAUIPropertyStore@@PEAUSpatialAudioRelatedGlobalSettings@@V?$function@$$A6A_NPEBUWAVEFORMATEXTENSIBLE@@@Z@std@@PEAUWAVEFORMATEXTENSIBLE@@PEA_N@Z @ 0x18012DFB0
 * Callers:
 ...
 *     ?CopyToWaveFormatExtensible@@YAHPEAUWAVEFORMATEXTENSIBLE@@PEBUtWAVEFORMATEX@@@Z @ 0x180038578 (-CopyToWaveFormatExtensible@@YAHPEAUWAVEFORMATEXTENSIBLE@@PEBUtWAVEFORMATEX@@@Z.c)
        ...
        _BYTE *a11)
{
  ...
  *(GUID *)pvar = PKEY_AudioEndpoint_FormFactor.fmtid;
  ...
  if ( (unsigned int)hProvider > 4 )
  {
    ...
    v128 = 2LL;
    TlgWrite((TraceLoggingHProvider)&hProvider, &unk_18017B728, v24, v25, 0x17u, &pData);
    v23 = (unsigned int)hProvider;
    v21 = a5;
    v22 = v71;
  }
  if ( *(_DWORD *)a4 )
  {
    if ( v60 )
    {
      if ( (unsigned int)v23 > 4 )
        TlgWrite((TraceLoggingHProvider)&hProvider, &unk_18017B5F8, v20, (LPCGUID)v23, 2u, &v80);
    }
    else
    {
      ...
      if ( pvar[0] != *(PROPVARIANT *)(a4 + 12) || pvar[1] != *(PROPVARIANT *)(a4 + 20) )
      {
        if ( v33 > 4 )
        {
          ...
          *(_OWORD *)pvar = *GetPreferredSpatialAudioEncoderId(&v76, v62, a4);
          v85 = pvar;
          v86 = 16LL;
          TlgWrite((TraceLoggingHProvider)&hProvider, &unk_18017B58A, v54, v55, 5u, &v80);
        }
        goto LABEL_35;
      }
      v67 = -1;
      ...
      *(_OWORD *)pvar = PKEY_Endpoint_PreferedPcmChannelCountForHrtf;
      ...
      if ( v61 == -1 )
      {
        if ( (unsigned int)hProvider > 2 )
        {
          ...
          v83 = v69;
          v84 = 16LL;
          TlgWrite((TraceLoggingHProvider)&hProvider, &unk_18017B68A, v36, v37, 4u, &v80);
        }
        goto LABEL_35;
      }
      v38 = 834LL * v61;
      if ( !*(_DWORD *)&v129[v38 + 784] )
      {
        if ( (unsigned int)hProvider > 2 )
        {
          ...
          v83 = v69;
          v84 = 16LL;
          TlgWrite((TraceLoggingHProvider)&hProvider, &unk_18017B634, v39, v40, 4u, &v80);
        }
      ...
      if ( *a8 )
      {
        ...
        {
          TlgCreateWsz(&v82, a2[3]);
          TlgWrite((TraceLoggingHProvider)&hProvider, &unk_18017B47F, v41, v42, 3u, &v80);
        }
      }
      else
      {
        if ( *(_DWORD *)(a4 + 68) != 1 || (v14 & 4) == 0 )
        {
          if ( (v14 & 3) != 0 )
          {
            if ( (unsigned int)hProvider > 2 )
            {
              ...
              v83 = &pv;
              v84 = 4LL;
              TlgWrite((TraceLoggingHProvider)&hProvider, &unk_18017B547, v45, cData, (UINT32)cData, &v80);
            }
            goto LABEL_35;
          }
          ...
          if ( (unsigned int)hProvider > 5 )
          {
            ...
            v99 = (char *)&v80.Size + 2;
            v100 = 2LL;
            TlgWrite((TraceLoggingHProvider)&hProvider, &unk_18017B4C0, v51, v52, 9u, &pData);
          }
          *v70 = 1;
          goto LABEL_5;
        }
        ...
        {
          TlgCreateWsz(&v82, a2[3]);
          TlgWrite((TraceLoggingHProvider)&hProvider, &unk_18017B43A, v43, v44, 3u, &v80);
        }
      }
    }
  ...
  if ( v21 )
  {
    if ( v21->wFormatTag == 0xFFFE )
    {
      ...
      if ( IsSpatialOnlyFormat((DWORD *)((char *)&v21[1].nSamplesPerSec + 2), (__int64)v15, (__int64)v20, v23) )
      {
        ...
        {
          TlgCreateWsz(&v82, a2[3]);
          TlgWrite((TraceLoggingHProvider)&hProvider, &unk_18017B6E1, v26, v27, 3u, &v80);
        }
LABEL_35:
        AsUInt32With = -2147024846;
        goto LABEL_5;
...
LABEL_50:
    ...
    {
      TlgCreateWsz(&v82, a2[3]);
      TlgWrite((TraceLoggingHProvider)&hProvider, &unk_18017B903, v31, v32, 3u, &v80);
    }
    *v70 = 0;
    goto LABEL_5;
  }
...
LABEL_49:
  ...
  {
    TlgCreateWsz(&v82, a2[3]);
    TlgWrite((TraceLoggingHProvider)&hProvider, &unk_18017B945, v28, v29, 3u, &v80);
  }
  pv = 0LL;
  pvar[0] = &pv;
  pvar[1] = 0LL;
