/*
 * XREFs of asm_AudioServerGetApplicationSubmixId @ 0x1800FE540
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall asm_AudioServerGetApplicationSubmixId(_QWORD *a1, _QWORD *a2)
{
  ...
  CWatchdogTimer<1>::CWatchdogTimer<1>(pv, v9[1], v4, (struct _TP_TIMER *)L"asm_AudioServerGetApplicationSubmixId");
