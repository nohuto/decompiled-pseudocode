/*
 * XREFs of ?EndpointRequiresAC97VistaShim@@YAHPEAUIMMDevice@@@Z @ 0x1800E4730
 * Callers:
...
_BOOL8 __fastcall EndpointRequiresAC97VistaShim(struct IMMDevice *a1)
{
                  ...
                  if ( v3 >= 0 )
                  {
                    ...
                    if ( v3 >= 0 && (_WORD)pvar == 31 )
                    {
                      ...
                      *v8 = 0;
                      ...
                      if ( v5 )
                      {
                        v3 = StringCbCatW(SubKey, 0x208uLL, (char *)v21);
  ...
  if ( v3 < 0 )
    AudSrvTraceLoggingErrorHelper("EndpointRequiresAC97VistaShim", 5253, v3);
  if ( v13 )
