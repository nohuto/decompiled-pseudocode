/*
 * XREFs of ??_GCCaptureReference@@QEAAPEAXI@Z @ 0x1800FB9F8
 * Callers:
 *     ?_Destroy@?$_Ref_count_obj@VCCaptureReference@@@std@@EEAAXXZ @ 0x1800FBE50 (-_Destroy@-$_Ref_count_obj@VCCaptureReference@@@std@@EEAAXXZ.c)
 * Callees:
