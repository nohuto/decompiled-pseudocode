/*
 * XREFs of AudioSessionSetDuckingPreference @ 0x18002A340
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall AudioSessionSetDuckingPreference(__int64 *a1, unsigned __int8 a2)
{
  ...
  LPVOID v8; // [rsp+80h] [rbp+8h] BYREF
  WINBOOL v9; // [rsp+88h] [rbp+10h] BYREF

  v2 = *a1;
  v8 = 0LL;
  if ( InitOnceBeginInitialize(&`AudioSrvTelemetryProvider::Instance'::`2'::wrapper, 0, &v9, &v8) && v9 )
  {
    v8 = &qword_1801B8588;
  ...
  v5 = v4;
  if ( v4 < 0 )
    AudSrvTraceLoggingErrorHelper("AudioSessionSetDuckingPreference", 0x9F0u, v4);
