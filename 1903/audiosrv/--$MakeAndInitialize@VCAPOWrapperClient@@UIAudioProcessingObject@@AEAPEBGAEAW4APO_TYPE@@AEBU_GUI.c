/*
 * XREFs of ??$MakeAndInitialize@VCAPOWrapperClient@@UIAudioProcessingObject@@AEAPEBGAEAW4APO_TYPE@@AEBU_GUID@@@Details@WRL@Microsoft@@YAJPEAPEAUIAudioProcessingObject@@AEAPEBGAEAW4APO_TYPE@@AEBU_GUID@@@Z @ 0x180027480
 * Callers:
        ...
        __int64 a4)
{
  ...
  *(_QWORD *)ActivityId.Data4 = 0LL;
  ...
  if ( (unsigned int)dword_1801B64B8 > 2 )
  {
    ...
    v35 = &v19;
    v36 = 4LL;
    TlgWrite((TraceLoggingHProvider)&dword_1801B64B8, &unk_18017CDBD, v16, v17, 5u, &pData);
    Instance = v19;
  }
  if ( Instance >= 0 )
LABEL_10:
