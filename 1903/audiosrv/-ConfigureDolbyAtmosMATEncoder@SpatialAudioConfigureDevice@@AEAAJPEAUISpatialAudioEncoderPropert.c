/*
 * XREFs of ?ConfigureDolbyAtmosMATEncoder@SpatialAudioConfigureDevice@@AEAAJPEAUISpatialAudioEncoderProperties@@@Z @ 0x180132774
 * Callers:
        ...
        if ( MetadataDictionaryData >= 0 )
        {
          ...
          if ( MetadataDictionaryData >= 0 )
          {
            ...
            if ( MetadataDictionaryData >= 0 )
            {
              ...
              {
                v29 = "SpatialAudioConfigureDevice::ConfigureDolbyAtmosMATEncoder";
                v30 = 59LL;
                v25 = 333;
                v31 = &v25;
                v32 = 4LL;
