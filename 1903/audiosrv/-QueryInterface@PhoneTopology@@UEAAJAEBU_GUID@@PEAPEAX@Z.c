/*
 * XREFs of ?QueryInterface@PhoneTopology@@UEAAJAEBU_GUID@@PEAPEAX@Z @ 0x180148D90
 * Callers:
 *     ?QueryInterface@PhoneTopology@@W7EAAJAEBU_GUID@@PEAPEAX@Z @ 0x18006C830 (-QueryInterface@PhoneTopology@@W7EAAJAEBU_GUID@@PEAPEAX@Z.c)
 * Callees:
