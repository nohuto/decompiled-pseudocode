/*
 * XREFs of AudioSessionMeterGetChannelsPeakValues @ 0x1800D4300
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall AudioSessionMeterGetChannelsPeakValues(__int64 *a1, unsigned int a2, __int64 a3)
{
  ...
  CWatchdogTimer<1>::CWatchdogTimer<1>(pv, v13[1], v6, (struct _TP_TIMER *)L"AudioSessionMeterGetChannelsPeakValues");
  v8 = (*(__int64 (__fastcall **)(__int64, _QWORD, __int64))(*(_QWORD *)v3 + 248LL))(v3, a2, a3);
  v9 = v8;
  if ( v8 < 0 )
    AudSrvTraceLoggingErrorHelper("AudioSessionMeterGetChannelsPeakValues", 2428, v8);
