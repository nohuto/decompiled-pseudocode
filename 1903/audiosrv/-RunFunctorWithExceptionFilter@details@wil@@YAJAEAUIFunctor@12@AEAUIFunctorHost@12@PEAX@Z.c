/*
 * XREFs of ?RunFunctorWithExceptionFilter@details@wil@@YAJAEAUIFunctor@12@AEAUIFunctorHost@12@PEAX@Z @ 0x180044590
 * Callers:
 *     <none>
 * Callees:
        ...
        void *a4)
{
  ...
  try
  {
    result = (**(__int64 (__fastcall ***)(struct wil::details::IFunctor *))a2)(a2);
  }
  catch ( ... )
  {
