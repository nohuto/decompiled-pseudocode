/*
 * XREFs of ??1?$CAutoPtrList@UDeviceStateChangedContext@CMonitorManager@@@ATL@@QEAA@XZ @ 0x18010786C
 * Callers:
 *     _CMonitorManager::CMonitorManager_::_1_::dtor$5 @ 0x180071F00 (_CMonitorManager--CMonitorManager_--_1_--dtor$5.c)
 * Callees:
 *     <none>
 */
