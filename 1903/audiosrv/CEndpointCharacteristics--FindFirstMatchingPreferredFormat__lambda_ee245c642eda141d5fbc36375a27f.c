/*
 * XREFs of CEndpointCharacteristics::FindFirstMatchingPreferredFormat__lambda_ee245c642eda141d5fbc36375a27f951___ @ 0x18011363C
 * Callers:
...
__int64 __fastcall CEndpointCharacteristics::FindFirstMatchingPreferredFormat__lambda_ee245c642eda141d5fbc36375a27f951___(
        __int64 a1,
  ...
  while ( 2 )
  {
    ...
    do
    {
      ...
      *(_DWORD *)&v15[1].nChannels = *v11;
      ...
      if ( v24 && (v22 = 0, lambda_53c21122ac2ea0b62ae7643ed09637d7_::operator()(v26 + 3, Src, &v22), v22) )
      {
