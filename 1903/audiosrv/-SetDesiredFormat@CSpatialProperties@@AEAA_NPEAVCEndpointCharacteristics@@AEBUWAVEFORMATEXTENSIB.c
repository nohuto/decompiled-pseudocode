/*
 * XREFs of ?SetDesiredFormat@CSpatialProperties@@AEAA_NPEAVCEndpointCharacteristics@@AEBUWAVEFORMATEXTENSIBLE@@_N@Z @ 0x18012EC74
 * Callers:
        ...
        char a4)
{
  ...
  if ( (unsigned int)hProvider > 4 )
  {
    ...
    v42 = 4;
    v45 = 16;
    TlgWrite((TraceLoggingHProvider)&hProvider, &unk_18017AE53, v9, v10, 0xAu, &pData);
  }
  ...
  if ( (unsigned int)hProvider > 4 && TlgKeywordOn((TraceLoggingHProvider)&hProvider, 0x400000000000uLL) )
  {
    ...
    v27 = 4;
    v30 = 4;
    TlgWrite((TraceLoggingHProvider)&hProvider, &unk_18017AF62, v15, v16, 5u, &pData);
  }
  return v12 >= 0;
}
