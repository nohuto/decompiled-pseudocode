...
_QWORD *__fastcall std::_Tree_comp_alloc<std::_Tmap_traits<std::wstring,std::wstring,std::less<std::wstring>,std::allocator<std::pair<std::wstring const,std::wstring>>,0>>::_Buynode0(
        _QWORD *a1)
{
  _QWORD *result; // rax
