/*
 * XREFs of _dynamic_initializer_for__g_SpatialAudioTraceLoggingProviderRegistration__ @ 0x1800013E0
 * Callers:
 *     <none>
 * Callees:
...
int __fastcall dynamic_initializer_for__g_SpatialAudioTraceLoggingProviderRegistration__(
        ...
        void *a3)
{
  TraceLoggingRegisterEx((TraceLoggingHProvider)&dword_1801B63C0, a2, a3);
