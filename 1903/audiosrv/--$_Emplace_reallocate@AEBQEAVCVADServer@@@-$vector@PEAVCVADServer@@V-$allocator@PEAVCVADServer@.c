/*
 * XREFs of ??$_Emplace_reallocate@AEBQEAVCVADServer@@@?$vector@PEAVCVADServer@@V?$allocator@PEAVCVADServer@@@std@@@std@@QEAAPEAPEAVCVADServer@@QEAPEAV2@AEBQEAV2@@Z @ 0x180009ABC
 * Callers:
        ...
        _QWORD *a3)
{
  ...
  *(_QWORD *)&v14[8 * v6] = *a3;
  ...
  else
  {
    try
    {
      memmove_0(v14, v16, (size_t)&a2[-*a1]);
      v17 = &v14[8 * v6 + 8];
      v18 = a1[1] - (_QWORD)a2;
      v16 = a2;
    }
    ...
    {
      std::_Deallocate<16,0>(v14, 8 * v20);
      throw;
    }
  }
