/*
 * XREFs of ?GetAvailableDynamicObjectCount@CStreamResource@Sarm@@QEBAIXZ @ 0x1801242B4
 * Callers:
...
__int64 __fastcall Sarm::CStreamResource::GetAvailableDynamicObjectCount(Sarm::CEndpointResourcePool **this)
{
  ...
  if ( (unsigned int)dword_1801B6350 > 5 )
  {
    ...
    v11 = 16;
    v14 = 4;
    TlgWrite((TraceLoggingHProvider)&dword_1801B6350, &unk_18017A942, v2, v3, 5u, &pData);
  }
  return v5[0];
}
