/*
 * XREFs of ??1?$vector@V?$basic_string@GU?$char_traits@G@std@@V?$allocator@G@2@@std@@V?$allocator@V?$basic_string@GU?$char_traits@G@std@@V?$allocator@G@2@@std@@@2@@std@@QEAA@XZ @ 0x18006A098
 * Callers:
 *     _AtmosCheck::CheckInstalledAppServicesAvailable_::_1_::dtor$0 @ 0x18006AADF (_AtmosCheck--CheckInstalledAppServicesAvailable_--_1_--dtor$0.c)
 ...
 *     _AtmosCheck::PerformLicenseCheckForAllEndpoints_::_1_::dtor$0 @ 0x18013F962 (_AtmosCheck--PerformLicenseCheckForAllEndpoints_--_1_--dtor$0.c)
 *     ?RefreshLicenseStatus@AtmosCheck@@QEAAJPEBG@Z @ 0x18013FDB8 (-RefreshLicenseStatus@AtmosCheck@@QEAAJPEBG@Z.c)
 *     _AtmosCheck::RefreshLicenseStatus_::_1_::dtor$0 @ 0x180140025 (_AtmosCheck--RefreshLicenseStatus_--_1_--dtor$0.c)
 * Callees:
