/*
 * XREFs of ?Continue@CMonitorManager@@QEAAXXZ @ 0x180108158
 * Callers:
 *     ?ResumeAllMonitors@CStreamConnectionManagerImpl@@UEAAXXZ @ 0x18010CF00 (-ResumeAllMonitors@CStreamConnectionManagerImpl@@UEAAXXZ.c)
 * Callees:
