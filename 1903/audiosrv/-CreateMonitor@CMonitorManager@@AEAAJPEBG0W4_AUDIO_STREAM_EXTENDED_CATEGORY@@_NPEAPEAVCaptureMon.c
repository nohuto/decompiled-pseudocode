/*
 * XREFs of ?CreateMonitor@CMonitorManager@@AEAAJPEBG0W4_AUDIO_STREAM_EXTENDED_CATEGORY@@_NPEAPEAVCaptureMonitor@1@@Z @ 0x180108284
 * Callers:
 ...
 *     ??0CaptureMonitor@CMonitorManager@@QEAA@PEAV1@PEBG1W4_AUDIO_STREAM_EXTENDED_CATEGORY@@_N@Z @ 0x1801076EC (--0CaptureMonitor@CMonitorManager@@QEAA@PEAV1@PEBG1W4_AUDIO_STREAM_EXTENDED_CATEGORY@@_N@Z.c)
...
__int64 __fastcall CMonitorManager::CreateMonitor(__int64 a1, _WORD *a2, _WORD *a3, int a4, char a5, _QWORD *a6)
{
  ...
  *a6 = 0LL;
  ...
  try
  {
    ...
    if ( !v15 )
      wil::details::in1diag3::_Throw_NullAlloc(retaddr, (void *)0xABD, v13, v14);
