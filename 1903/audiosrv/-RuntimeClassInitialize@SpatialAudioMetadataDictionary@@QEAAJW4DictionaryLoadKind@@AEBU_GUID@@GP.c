/*
 * XREFs of ?RuntimeClassInitialize@SpatialAudioMetadataDictionary@@QEAAJW4DictionaryLoadKind@@AEBU_GUID@@GPEBGPEAEI@Z @ 0x180137450
 * Callers:
...
LABEL_13:
  if ( (unsigned int)dword_1801B63C0 > 2 )
  {
    ...
    TlgWrite((TraceLoggingHProvider)&dword_1801B63C0, &unk_18017CD51, v16, v17, 6u, &pData);
