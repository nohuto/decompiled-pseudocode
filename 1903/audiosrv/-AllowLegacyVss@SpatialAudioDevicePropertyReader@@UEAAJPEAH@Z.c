/*
 * XREFs of ?AllowLegacyVss@SpatialAudioDevicePropertyReader@@UEAAJPEAH@Z @ 0x18012FDD0
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall SpatialAudioDevicePropertyReader::AllowLegacyVss(SpatialAudioDevicePropertyReader *this, int *a2)
{
  ...
  if ( *((_DWORD *)this + 128) )
  {
    ...
    {
      v14 = 49LL;
      v13 = "SpatialAudioDevicePropertyReader::AllowLegacyVss";
      v11[0] = 737;
      v15 = v11;
      v16 = 4LL;
      v10 = -2147024809;
