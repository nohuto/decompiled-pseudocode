/*
 * XREFs of ?RuntimeClassInitialize@CAudioSessionManager@@QEAAJPEBG@Z @ 0x18000A014
 * Callers:
...
LABEL_35:
  AudSrvTraceLoggingErrorHelper("CAudioSessionManager::RuntimeClassInitialize", 0x5E7u, v6);
LABEL_18:
  if ( v20 )
