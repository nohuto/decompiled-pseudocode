/*
 * XREFs of ??$LogAecEffectPolicy@$07@@YAXAEBU_AEC_POLICY_RESULTS@@PEBGU_GUID@@W4__MIDL___MIDL_itf_audioengineendpoint_0000_0000_0001@@@Z @ 0x18011D12C
 * Callers:
...
void __fastcall LogAecEffectPolicy<8>(__int64 a1, const WCHAR *a2)
{
  __int64 v3; // r11
  LPCGUID v4; // r9
  __int64 v5; // r10
  ...
  if ( (unsigned int)hProvider > 4 )
  {
    if ( TlgKeywordOn((TraceLoggingHProvider)&hProvider, 8uLL) )
    {
      ...
      v41 = 4LL;
      v43 = 4LL;
      TlgWrite((TraceLoggingHProvider)&hProvider, &unk_18017A215, v6, v4, 0x13u, &pData);
    }
  }
}
