/*
 * XREFs of ??1CPdcActivationClient@@QEAA@XZ @ 0x1800FAAE8
 * Callers:
 *     _CPowerReferenceManager::CPowerReferenceManager_::_1_::dtor$0 @ 0x180071CCE (_CPowerReferenceManager--CPowerReferenceManager_--_1_--dtor$0.c)
 * Callees:
