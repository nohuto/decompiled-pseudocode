/*
 * XREFs of ?ConfigureAuxiliaryInputStreamForStreamGroup@CAudioResourceManager@@IEAAJAEAV?$ComPtr@UIStreamGroupProxy@@@WRL@Microsoft@@PEBG@Z @ 0x1800F617C
 * Callers:
        ...
        const unsigned __int16 *a3)
{
  ...
  volatile signed __int32 *v15; // [rsp+30h] [rbp-D8h] BYREF
  volatile signed __int32 **v16; // [rsp+38h] [rbp-D0h] BYREF
  ...
  {
    CAudioSessionManager::RegisterDisconnectNotificationClient((__int64)v15, a2);
