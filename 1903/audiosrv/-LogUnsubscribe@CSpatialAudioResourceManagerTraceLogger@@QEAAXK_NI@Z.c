/*
 * XREFs of ?LogUnsubscribe@CSpatialAudioResourceManagerTraceLogger@@QEAAXK_NI@Z @ 0x180123750
 * Callers:
        ...
        const GUID *a4)
{
  ...
  if ( (unsigned int)dword_1801B6350 > 5 )
  {
    ...
    v10 = 4LL;
    v12 = 4LL;
    TlgWrite((TraceLoggingHProvider)&dword_1801B6350, &unk_18017A540, a3, a4, 5u, &pData);
  }
}
