/*
 * XREFs of ?FindStreamInfo@AudioJournal@@AEAAJPEAVCEndpointCharacteristics@@PEAPEAUStreamInfo@1@PEAH@Z @ 0x180025D50
 * Callers:
        ...
        int *a4)
{
  ...
  *((_QWORD *)&v23 + 1) = &v28;
  ...
  if ( !a2 )
  {
    v9 = (struct AudioJournal::StreamInfo *)&unk_1801B9180;
    v30 = (struct AudioJournal::StreamInfo *)&unk_1801B9180;
LABEL_24:
  ...
  {
    v5 = (struct AudioJournal::StreamInfo *)&unk_1801B8FF0;
    v6 = 2;
  }
  else
  {
    v5 = (struct AudioJournal::StreamInfo *)&unk_1801B8D98;
    v6 = 3;
  }
  v30 = v5;
  Src = 0LL;
