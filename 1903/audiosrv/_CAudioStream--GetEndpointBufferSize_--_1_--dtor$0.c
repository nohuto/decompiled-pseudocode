/*
 * XREFs of _CAudioStream::GetEndpointBufferSize_::_1_::dtor$0 @ 0x1800DA3D1
 * Callers:
 *     <none>
 * Callees:
 *     <none>
...
__int64 __fastcall CAudioStream::GetEndpointBufferSize_::_1_::dtor_0(__int64 a1, __int64 a2)
{
