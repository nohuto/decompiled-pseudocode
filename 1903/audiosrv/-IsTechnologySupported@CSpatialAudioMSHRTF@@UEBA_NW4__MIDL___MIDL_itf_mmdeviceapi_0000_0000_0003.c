/*
 * XREFs of ?IsTechnologySupported@CSpatialAudioMSHRTF@@UEBA_NW4__MIDL___MIDL_itf_mmdeviceapi_0000_0000_0003@@PEBUtWAVEFORMATEX@@1V?$function@$$A6A_NPEBUWAVEFORMATEXTENSIBLE@@@Z@std@@KPEAIPEA_NPEAUWAVEFORMATEXTENSIBLE@@@Z @ 0x1800693B0
 * Callers:
 *     <none>
 * Callees:
  ...
  if ( !byte_1801B8254 )
  {
    ...
    else
    {
      ...
      if ( (unsigned int)hProvider > 4 )
        TlgWrite((TraceLoggingHProvider)&hProvider, &unk_18017CC62, v15, v16, 2u, &pData);
    }
  }
  v17 = 0;
  LOBYTE(v36[0]) = 0;
