/*
 * XREFs of ?SetSpatialAudioSettings@CSpatialProperties@@QEAAXPEAVCEndpointCharacteristics@@PEBUSpatialAudioSettings@@PEBUtWAVEFORMATEX@@PEAUIPropertyStore@@PEAUSpatialAudioRelatedGlobalSettings@@V?$function@$$A6A_NPEBUWAVEFORMATEXTENSIBLE@@@Z@std@@@Z @ 0x1800032E0
 * Callers:
        ...
        __int64 a7)
{
  ...
  unsigned int v54; // [rsp+A8h] [rbp-78h] BYREF
  ...
  unsigned int v77; // [rsp+ECh] [rbp-34h] BYREF
  ...
  _BYTE v101[16]; // [rsp+1B8h] [rbp+98h] BYREF
  _BYTE v102[16]; // [rsp+1C8h] [rbp+A8h] BYREF
...
LABEL_16:
          ...
          if ( AsUInt32With >= 0 )
          {
            ...
            if ( AsUInt32With >= 0 )
            {
              ...
              if ( AsUInt32With >= 0 )
              {
                v113 = *(_OWORD *)GetPreferredSpatialAudioEncoderId(v101, v54, a3);
                if ( v113 == *(_OWORD *)(a3 + 12) )
                {
                  ...
                  if ( (unsigned int)hProvider > 4 )
                  {
                    ...
                    v172 = &v110;
                    v173 = 2LL;
                    TlgWrite((TraceLoggingHProvider)&hProvider, &unk_18017BE3A, v16, v17, 0xFu, &pData);
                    v14 = (unsigned int)hProvider;
                  }
                  *(_DWORD *)Buf2 = *(_DWORD *)a3;
                  *(_OWORD *)&Buf2[12] = *(_OWORD *)(a3 + 12);
                  HIDWORD(v105) = *((_DWORD *)a3 + 17);
                  if ( *(_DWORD *)Buf2 && (v11 & 3) != 0 )
                  {
                    if ( v14 > 4 )
                    {
                      ...
                      v214 = &v80;
                      v215 = 4LL;
                      TlgWrite((TraceLoggingHProvider)&hProvider, &unk_18017BAEC, v18, v19, cData, &v212);
                    }
                    *(_DWORD *)Buf2 = 0;
                  }
                  v82 = -1;
                  ...
                  if ( *(_DWORD *)Buf2 && v75 == -1 )
                  {
                    if ( (unsigned int)hProvider > 4 )
                    {
                      ...
                      v218 = a3 + 12;
                      v219 = 16LL;
                      TlgWrite((TraceLoggingHProvider)&hProvider, &unk_18017BA9C, v25, v26, 4u, &v216);
                    }
                    goto LABEL_16;
                  }
                  LODWORD(v105) = v11;
                  ...
                  *(GUID *)(a1 + 6856) = GUID_00000000_0000_0000_0000_000000000000;
                  ...
                  if ( (unsigned int)hProvider > 4 )
                  {
                    ...
                    v198 = &Buf2[44];
                    v199 = 16LL;
                    TlgWrite((TraceLoggingHProvider)&hProvider, &unk_18017BC39, v32, v30, 0xFu, &v174);
                  }
                  v33 = 0;
                  v34 = 0;
                  v72 = 0;
                  if ( v64 )
                  {
                    do
                    {
                      if ( (unsigned int)hProvider > 5 )
                      {
                        ...
                        v94 = 0LL;
                        v115 = off_1801B6488;
                        v116 = *(unsigned __int16 *)off_1801B6488;
                        v117 = v36;
                        v118 = &unk_18017BB3B;
                        v119 = 253;
                        v120 = 1;
                        v92 = (unsigned int)&TraceLoggingMetadataEnd - (unsigned int)&TraceLoggingMetadata;
                        EtwEventWriteTransfer(qword_1801B64A0, v93, 0LL, 0LL, 16, &v115);
                        v34 = v72;
                      }
                      v72 = ++v34;
                      v33 = v34;
...
LABEL_83:
                        if ( v53 )
                        {
                          ...
                          if ( AsUInt32With < 0 )
                          {
                            if ( (unsigned int)hProvider > 2 )
                            {
                              ...
                              v231 = 4LL;
                              TlgWrite((TraceLoggingHProvider)&hProvider, &unk_18017BA5E, v44, v45, 4u, &v228);
                            }
                          }
                          else
                          {
                        ...
                        if ( *(_DWORD *)&Buf2[8] != *(_DWORD *)(a1 + 80) )
                        {
                          if ( (unsigned int)hProvider > 4 )
                          {
                            ...
                            v204 = &v68;
                            v205 = 2LL;
                            TlgWrite((TraceLoggingHProvider)&hProvider, &unk_18017BA14, v46, v47, 5u, &v200);
                          }
...
LABEL_78:
                      if ( v54 )
                      {
                        if ( !v76 )
                        {
                          ...
                          if ( AsUInt32With < 0 && (unsigned int)hProvider > 2 )
                          {
                            ...
                            v226 = &AsUInt32With;
                            v227 = 4LL;
                            TlgWrite((TraceLoggingHProvider)&hProvider, &unk_18017B98E, v41, v42, 4u, &v224);
                          }
                        }
                      }
                      goto LABEL_83;
                    ...
                    TlgWrite((TraceLoggingHProvider)&hProvider, &unk_18017B9CF, v39, v40, v38 + 4, &v220);
                  }
                  v37 = AsUInt32With;
                  goto LABEL_77;
                }
                if ( (unsigned int)hProvider > 2 )
                {
                  ...
                  v208 = v48;
                  v209 = 16LL;
                  v114 = *(_OWORD *)GetPreferredSpatialAudioEncoderId(v102, v54, a3);
                  v210 = &v114;
                  v211 = 16LL;
                  TlgWrite((TraceLoggingHProvider)&hProvider, &unk_18017BF2E, v49, v50, 5u, &v206);
                }
