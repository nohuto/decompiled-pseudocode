/*
 * XREFs of ?UpdateRule@DynamicAudioEndpointManager@@QEAAJPEAX_JPEAU_DynamicRoutingRule@@@Z @ 0x18012C4E8
 * Callers:
 *     PolicyConfigUpdateDynamicRoutingRule @ 0x1800E3CB0 (PolicyConfigUpdateDynamicRoutingRule.c)
 * Callees:
