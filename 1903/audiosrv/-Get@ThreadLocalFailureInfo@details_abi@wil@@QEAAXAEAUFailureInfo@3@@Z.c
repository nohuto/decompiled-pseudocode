/*
 * XREFs of ?Get@ThreadLocalFailureInfo@details_abi@wil@@QEAAXAEAUFailureInfo@3@@Z @ 0x1800BF1E0
 * Callers:
 *     ?GetLastError@ThreadLocalData@details_abi@wil@@QEAA_NAEAUFailureInfo@3@IJ@Z @ 0x1800BF49C (-GetLastError@ThreadLocalData@details_abi@wil@@QEAA_NAEAUFailureInfo@3@IJ@Z.c)
 * Callees:
