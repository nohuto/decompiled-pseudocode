/*
 * XREFs of ?CreateInstance@EndpointIterator@@SAJPEAVEndpointCollection@@PEAPEAUIEndpointIterator@@@Z @ 0x1801469CC
 * Callers:
 *     ?GetIterator@EndpointCollection@@UEAAJPEAPEAUIEndpointIterator@@@Z @ 0x180146F10 (-GetIterator@EndpointCollection@@UEAAJPEAPEAUIEndpointIterator@@@Z.c)
 * Callees:
