/*
 * XREFs of ?HandleAccessChangeNotification@@YAJPEBG0@Z @ 0x1800D900C
 * Callers:
...
LABEL_9:
  ...
  (*(void (__fastcall **)(struct IAudioPolicyManager *, const unsigned __int16 *, HLOCAL, const unsigned __int16 *))(*(_QWORD *)g_PolicyManager + 56LL))(
    ...
    a1);
  v15 = 0LL;
  Microsoft::WRL::ComPtr<CAudioSessionManagerProvider>::InternalRelease((volatile signed __int32 **)&v15);
