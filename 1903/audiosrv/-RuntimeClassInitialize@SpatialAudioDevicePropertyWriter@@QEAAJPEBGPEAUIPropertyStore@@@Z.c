/*
 * XREFs of ?RuntimeClassInitialize@SpatialAudioDevicePropertyWriter@@QEAAJPEBGPEAUIPropertyStore@@@Z @ 0x18005EDBC
 * Callers:
        ...
        if ( Instance >= 0 )
        {
          ...
          if ( Instance >= 0 )
          {
            ...
            Instance = CoCreateInstance(
                         ...
                         v25);
            v29 = Instance;
            if ( Instance < 0 && (unsigned int)dword_1801B63C0 > 2 )
            {
              v35 = "SpatialAudioDevicePropertyWriter::RuntimeClassInitialize";
              v36 = 57LL;
              v30 = 147;
