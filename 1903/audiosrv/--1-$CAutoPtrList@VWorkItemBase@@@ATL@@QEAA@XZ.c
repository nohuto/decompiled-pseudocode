/*
 * XREFs of ??1?$CAutoPtrList@VWorkItemBase@@@ATL@@QEAA@XZ @ 0x180145A3C
 * Callers:
 *     _AudioDeviceMgr::AudioDeviceMgr_::_1_::dtor$7 @ 0x18006D4F8 (_AudioDeviceMgr--AudioDeviceMgr_--_1_--dtor$7.c)
 * Callees:
 *     <none>
 */
