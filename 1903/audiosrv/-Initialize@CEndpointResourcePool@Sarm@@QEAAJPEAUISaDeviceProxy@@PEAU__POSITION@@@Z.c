/*
 * XREFs of ?Initialize@CEndpointResourcePool@Sarm@@QEAAJPEAUISaDeviceProxy@@PEAU__POSITION@@@Z @ 0x180123B6C
 * Callers:
 ...
 *     ??$make_shared@UPool@CEndpointResourcePool@Sarm@@AEAIAEAIAEA_J@std@@YA?AV?$shared_ptr@UPool@CEndpointResourcePool@Sarm@@@0@AEAI0AEA_J@Z @ 0x180123984 (--$make_shared@UPool@CEndpointResourcePool@Sarm@@AEAIAEAIAEA_J@std@@YA-AV-$shared_ptr@UPool@CEnd.c)
 */
...
LABEL_5:
  ...
  if ( (unsigned int)dword_1801B6350 > 4 )
  {
    ...
    TlgWrite((TraceLoggingHProvider)&dword_1801B6350, &unk_18017A819, v10, v11, 7u, &pData);
  }
  try
  {
    v12 = v17 != 0;
