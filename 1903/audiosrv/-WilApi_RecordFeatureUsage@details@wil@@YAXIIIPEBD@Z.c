/*
 * XREFs of ?WilApi_RecordFeatureUsage@details@wil@@YAXIIIPEBD@Z @ 0x18006323C
 * Callers:
 ...
 *     ?RecordSRUMFeatureUsage@details@wil@@YAXIII@Z @ 0x1800C0E80 (-RecordSRUMFeatureUsage@details@wil@@YAXIII@Z.c)
 * Callees:
