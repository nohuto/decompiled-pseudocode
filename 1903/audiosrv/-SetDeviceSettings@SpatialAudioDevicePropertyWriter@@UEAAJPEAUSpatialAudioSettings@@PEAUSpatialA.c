/*
 * XREFs of ?SetDeviceSettings@SpatialAudioDevicePropertyWriter@@UEAAJPEAUSpatialAudioSettings@@PEAUSpatialAudioEncoderDescriptor@@I@Z @ 0x180031D90
 * Callers:
 *     <none>
 * Callees:
    ...
    *(_OWORD *)&v30.vt = 0x41u;
    ...
    if ( v29 < 0 )
    {
      if ( (unsigned int)dword_1801B63C0 > 2 )
      {
        ...
        v43 = &v29;
        v44 = 4LL;
        TlgWrite((TraceLoggingHProvider)&dword_1801B63C0, &unk_18017CC9B, v17, v18, 5u, &pData);
      }
    }
    else
    {
      ...
      else if ( (_DWORD)v12 )
      {
        ...
        else
        {
          ...
          if ( (unsigned int)dword_1801B63C0 > 2 )
          {
            ...
            v43 = &v28;
            v44 = 4LL;
            TlgWrite((TraceLoggingHProvider)&dword_1801B63C0, &unk_18017CCCD, v20, v21, 5u, &pData);
          }
        }
      }
      else
