/*
 * XREFs of ?IsTechnologySupported@CSpatialAudioDtsxStereo@@UEBA_NW4__MIDL___MIDL_itf_mmdeviceapi_0000_0000_0003@@PEBUtWAVEFORMATEX@@1V?$function@$$A6A_NPEBUWAVEFORMATEXTENSIBLE@@@Z@std@@KPEAIPEA_NPEAUWAVEFORMATEXTENSIBLE@@@Z @ 0x180069150
 * Callers:
 *     <none>
 * Callees:
...
LABEL_8:
    ...
    v22 = v25;
    CSpatialAudioTech::AssignPriority(v10, (unsigned int)v25, 1LL, 2LL, a7, v24);
    v13 = v24[0];
    if ( v24[0] )
    {
      if ( *a7 )
      ...
      {
        CSpatialAudioTech::AssignPriority(v10, (unsigned int)v22, 3LL, 2LL, a7, v24);
        v13 = v24[0];
      }
    }
LABEL_23:
