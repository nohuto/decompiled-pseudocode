/*
 * XREFs of ?ReportVariantUsageToService@?$Feature@U__WilFeatureTraits_Feature_HangDetectionThresholdTweaking@@@wil@@CAX_NW4Variant_HangDetectionThresholdTweaking@@W4VariantReportingKind@2@_K@Z @ 0x18005B468
 * Callers:
        ...
        __int64 a4)
{
  ...
  if ( (unsigned int)wil_details_FeaturePropertyCache_ReportUsageToServiceDirect(
                       ...
                       16046125LL,
                       (unsigned int)a2 + 320,
                       dword_1801B9834 & (unsigned int)-(a2 != 0)) )
  {
