/*
 * XREFs of ?ProcessDynamicObjectCountChange@CStreamResource@Sarm@@QEAAJIIAEA_J@Z @ 0x180124A6C
 * Callers:
  ...
  if ( v8 >= 0 )
  {
    ...
    *((_DWORD *)this + 18) = v13;
    ...
    if ( (unsigned int)dword_1801B6350 > 5 )
    {
      ...
      v38 = 4;
      v41 = 1;
      TlgWrite((TraceLoggingHProvider)&dword_1801B6350, &unk_18017A86B, v17, v18, 7u, &pData);
    }
