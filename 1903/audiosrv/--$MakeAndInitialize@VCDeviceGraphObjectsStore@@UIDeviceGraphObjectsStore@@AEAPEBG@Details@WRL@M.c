/*
 * XREFs of ??$MakeAndInitialize@VCDeviceGraphObjectsStore@@UIDeviceGraphObjectsStore@@AEAPEBG@Details@WRL@Microsoft@@YAJPEAPEAUIDeviceGraphObjectsStore@@AEAPEBG@Z @ 0x180031014
 * Callers:
        ...
        const unsigned __int16 **a2)
{
  ...
  *a1 = 0LL;
  ...
  if ( v4 )
  {
    ...
    {
      *a1 = 0LL;
      if ( InlineIsEqualGUID(&GUID_13e1fd3a_6577_4852_a153_ed7a794d5b95, &GUID_00000000_0000_0000_c000_000000000046) )
      {
        *a1 = v5;
