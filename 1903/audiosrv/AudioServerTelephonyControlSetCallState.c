/*
 * XREFs of AudioServerTelephonyControlSetCallState @ 0x1800EB120
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall AudioServerTelephonyControlSetCallState(__int64 a1, __int64 a2, unsigned int a3)
{
  __int64 v5; // r8
  void *v6; // r8
  unsigned int v7; // ebx
  ...
  CWatchdogTimer<1>::CWatchdogTimer<1>(pv, v9[1], v5, (struct _TP_TIMER *)L"AudioServerTelephonyControlSetCallState");
  v7 = ((__int64 (__fastcall *)(struct IUnknown *, __int64, _QWORD))g_TelephonyControl->lpVtbl[2].Release)(
         g_TelephonyControl,
         a2,
         a3);
