/*
 * XREFs of ?OnTimer@?$CWatchdogTimer@$00@@AEAAXXZ @ 0x1800C2F20
 * Callers:
 *     ?TimerCallback@?$CWatchdogTimer@$00@@CAXPEAU_TP_CALLBACK_INSTANCE@@PEAXPEAU_TP_TIMER@@@Z @ 0x1800C3500 (-TimerCallback@-$CWatchdogTimer@$00@@CAXPEAU_TP_CALLBACK_INSTANCE@@PEAXPEAU_TP_TIMER@@@Z.c)
 * Callees:
  ...
  if ( (_BYTE)v2 )
  {
      ...
      if ( v2 == 3 )
      {
        ...
        if ( (_BYTE)v2 )
        {
          ...
          if ( **(_DWORD **)(a1 + 8) > 2u && TlgKeywordOn(*(TraceLoggingHProvider *)(a1 + 8), 0x400000000001uLL) )
          {
            ...
            v35 = a1 + 16;
            v36 = 4;
            TlgWrite(v10, &unk_180177922, v8, v9, 5u, &v30);
          }
          ...
          if ( v11 )
          {
            ...
            if ( v18 && **(_DWORD **)(a1 + 8) > 4u && TlgKeywordOn(*(TraceLoggingHProvider *)(a1 + 8), 1uLL) )
            {
              ...
              v43 = a1 + 16;
              v44 = 4;
              TlgWrite(v14, &unk_1801778D4, v13, (LPCGUID)v14, 5u, &v38);
            }
          }
          else
          {
    ...
    else if ( **(_DWORD **)(a1 + 8) > 3u )
    {
      ...
      if ( (_BYTE)v2 )
      {
        ...
        v27 = a1 + 16;
        v28 = 4;
        LOBYTE(v2) = TlgWrite(v5, &unk_180177950, v4, (LPCGUID)v5, 5u, &pData);
      }
    }
  }
  return v2;
