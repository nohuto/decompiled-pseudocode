/*
 * XREFs of ?OnRequestDynamicObjects@CSpatialAudioResourceManager@Sarm@@UEAAJ_JII@Z @ 0x180120F90
 * Callers:
 ...
 *     ?WaitForWorkToComplete@CWorkFifo@@QEAA_NXZ @ 0x180122820 (-WaitForWorkToComplete@CWorkFifo@@QEAA_NXZ.c)
