/*
 * XREFs of ??0RawUsageIndex@details_abi@wil@@QEAA@GGW4CountSize@12@G0@Z @ 0x18004875C
 * Callers:
 ...
 * Callees:
 *     ?GetSize@UsageIndexProperty@details_abi@wil@@QEBA_KXZ @ 0x1800487DC (-GetSize@UsageIndexProperty@details_abi@wil@@QEBA_KXZ.c)
 */
