/*
 * XREFs of ?RegisterForShellWnfNotifications@AtmosCheck@@AEAAJXZ @ 0x180140038
 * Callers:
 ...
 *     ?IsRunningOnXbox@AtmosCheck@@AEBA_NXZ @ 0x18006ACCC (-IsRunningOnXbox@AtmosCheck@@AEBA_NXZ.c)
 *     memcpy_s_0 @ 0x18006B710 (memcpy_s_0.c)
