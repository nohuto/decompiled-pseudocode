/*
 * XREFs of ?CreateMetadataDictionary@SpatialAudioDevicePropertyReader@@UEAAJAEBU_GUID@@PEAPEAUISpatialAudioMetadataDictionaryData@@@Z @ 0x18012FF40
 * Callers:
 *     <none>
 * Callees:
      ...
      if ( PropertyIndexForMetadataFormatID >= 0 )
      {
        if ( (_WORD)pvar == 65 )
        {
          ...
          if ( PropertyIndexForMetadataFormatID >= 0 )
          {
            ...
            v21 = PropertyIndexForMetadataFormatID;
            if ( PropertyIndexForMetadataFormatID < 0 && (unsigned int)dword_1801B63C0 > 2 )
            {
  ...
  else
  {
    ...
    if ( (unsigned int)dword_1801B63C0 > 2 )
    {
      ...
      *(_DWORD *)v23 = -2147024809;
      v36 = (int *)v23;
      v37 = 4LL;
      TlgWrite((TraceLoggingHProvider)&dword_1801B63C0, &unk_18017CCCD, v7, v8, 5u, &pData);
    }
  }
