/*
 * XREFs of ?DoReacquireSaDeviceResource@CConstraintModelResourceManager@@AEAAJKPEAUReacquireResourceHandleInfo@@@Z @ 0x1800FFCC4
 * Callers:
 ...
 *     WPP_SF_ddI @ 0x1801028C4 (WPP_SF_ddI.c)
 *     WPP_SF_ddID @ 0x180102928 (WPP_SF_ddID.c)
