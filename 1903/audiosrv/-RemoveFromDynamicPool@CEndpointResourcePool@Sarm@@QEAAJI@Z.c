/*
 * XREFs of ?RemoveFromDynamicPool@CEndpointResourcePool@Sarm@@QEAAJI@Z @ 0x180123E44
 * Callers:
 ...
 *     ?_FailFast_Hr@in1diag3@details@wil@@YAXPEAXIPEBDJ@Z @ 0x1800C1EE0 (-_FailFast_Hr@in1diag3@details@wil@@YAXPEAXIPEBDJ@Z.c)
 */
        ...
        unsigned int Data1)
{
  ...
  if ( (unsigned int)dword_1801B6350 > 4 )
  {
    ...
    v10 = this;
    v23 = 8LL;
    TlgWrite((TraceLoggingHProvider)&dword_1801B6350, &unk_18017A7BE, v4, &pRelatedActivityId, 8u, &pData);
