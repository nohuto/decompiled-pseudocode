/*
 * XREFs of ?InitializeMonitorRestartTimer@CMonitorManager@@AEAAJK_KPEBK@Z @ 0x18005DF64
 * Callers:
        ...
        const unsigned int *a4)
{
  ...
  {
    WPP_SF_q(*((_QWORD *)WPP_GLOBAL_Control + 2), 55LL, &WPP_b9a18bca3a9f3fb3e4a3d91d80ef7b5a_Traceguids, pv);
  }
  v10 = 0;
  ...
  *((_QWORD *)pv + 37) = ThreadpoolTimer;
  ...
  {
    WPP_SF_d(*((_QWORD *)WPP_GLOBAL_Control + 2), 56LL, &WPP_b9a18bca3a9f3fb3e4a3d91d80ef7b5a_Traceguids, v5);
  }
  if ( v10 )
