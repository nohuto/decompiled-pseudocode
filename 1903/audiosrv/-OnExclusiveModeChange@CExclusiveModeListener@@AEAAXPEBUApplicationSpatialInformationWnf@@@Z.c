/*
 * XREFs of ?OnExclusiveModeChange@CExclusiveModeListener@@AEAAXPEBUApplicationSpatialInformationWnf@@@Z @ 0x180126154
 * Callers:
 *     ?SpatialApplicationInfoUpdateCallback@CExclusiveModeListener@@CAJU_WNF_STATE_NAME@@KPEAU_WNF_TYPE_ID@@PEAXPEBXK@Z @ 0x180127470 (-SpatialApplicationInfoUpdateCallback@CExclusiveModeListener@@CAJU_WNF_STATE_NAME@@KPEAU_WNF_TYP.c)
 * Callees:
...
LABEL_8:
  ...
  else
  {
    ...
    if ( (unsigned int)dword_1801B6350 > 4 )
    {
      ...
      v17 = 4;
      v18 = 0;
      TlgWrite((TraceLoggingHProvider)&dword_1801B6350, &unk_18017ABBF, v5, (LPCGUID)v6, 3u, &pData);
    }
