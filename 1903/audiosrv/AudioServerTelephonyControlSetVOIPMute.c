/*
 * XREFs of AudioServerTelephonyControlSetVOIPMute @ 0x1800EB420
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall AudioServerTelephonyControlSetVOIPMute(__int64 a1, unsigned int a2)
{
  ...
  CWatchdogTimer<1>::CWatchdogTimer<1>(pv, v9[1], v3, (struct _TP_TIMER *)L"AudioServerTelephonyControlSetVOIPMute");
  v5 = ((__int64 (__fastcall *)(struct IUnknown *, _QWORD))g_TelephonyControl->lpVtbl[4].AddRef)(g_TelephonyControl, a2);
