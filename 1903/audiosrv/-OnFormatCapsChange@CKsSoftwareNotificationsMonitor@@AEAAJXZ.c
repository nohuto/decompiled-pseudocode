/*
 * XREFs of ?OnFormatCapsChange@CKsSoftwareNotificationsMonitor@@AEAAJXZ @ 0x1800EBA6C
 * Callers:
 *     ?OnNotify@CKsSoftwareNotificationsMonitor@@UEAAJKPEBU_GUID@@@Z @ 0x1800EC050 (-OnNotify@CKsSoftwareNotificationsMonitor@@UEAAJKPEBU_GUID@@@Z.c)
 * Callees:
 ...
 *     std::function_void___cdecl(void)_::function_void___cdecl(void)___lambda_45ca10f83369d44ceedcca5d39762dce__void_ @ 0x1800EB850 (std--function_void___cdecl(void)_--function_void___cdecl(void)___lambda_45ca10f83369d44ceedcca5d.c)
 */
                  ...
                  else
                  {
                      ...
                      && fPending[1] )
                    {
                      ...
                      wil::TraceLoggingProvider::Register(
                        (wil::TraceLoggingProvider *)&qword_1801B8588,
                        qword_1801B85A0,
                        v18);
                    ...
                    if ( **((_DWORD **)Context + 1) > 4u )
                    {
                      ...
                      TlgWrite(v21, &unk_1801783C6, v20, (LPCGUID)v21, 4u, &pData);
                    }
                    v49 = v50;
                    v42 = v27;
                    v22 = (std::_Ref_count_base *)*((_QWORD *)&v29 + 1);
