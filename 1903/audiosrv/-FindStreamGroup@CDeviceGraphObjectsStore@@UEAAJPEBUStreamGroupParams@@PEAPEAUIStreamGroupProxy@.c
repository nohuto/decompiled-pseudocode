/*
 * XREFs of ?FindStreamGroup@CDeviceGraphObjectsStore@@UEAAJPEBUStreamGroupParams@@PEAPEAUIStreamGroupProxy@@@Z @ 0x18002F410
 * Callers:
 *     <none>
 * Callees:
...
LABEL_13:
    ...
    if ( !memcmp_0(v16, v18, v17 + 18) )
    {
      ...
      if ( *((_BYTE *)v26 + 49) == v21
        ...
        && *((_BYTE *)v6 + 50) == (*(unsigned __int8 (__fastcall **)(struct IStreamGroupProxy *))(*(_QWORD *)v25 + 240LL))(v25) )
      {
        v22 = (unsigned __int8 (__fastcall ***)(_QWORD))(*(__int64 (__fastcall **)(struct IStreamGroupProxy *))(*(_QWORD *)v25 + 264LL))(v25);
        if ( *((_QWORD *)v6 + 7) )
        {
          if ( v22 && (**v22)(v22) )
          {
