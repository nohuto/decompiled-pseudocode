/*
 * XREFs of ?AddTail@?$CAtlList@IV?$CElementTraits@I@ATL@@@ATL@@QEAAPEAU__POSITION@@I@Z @ 0x180149A00
 * Callers:
 *     ?Initialize@TelephonyController@@IEAAJXZ @ 0x18014A578 (-Initialize@TelephonyController@@IEAAJXZ.c)
 * Callees:
 *     ?NewNode@?$CAtlList@IV?$CElementTraits@I@ATL@@@ATL@@AEAAPEAVCNode@12@IPEAV312@0@Z @ 0x18014B064 (-NewNode@-$CAtlList@IV-$CElementTraits@I@ATL@@@ATL@@AEAAPEAVCNode@12@IPEAV312@0@Z.c)
 */
