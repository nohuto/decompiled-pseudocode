/*
 * XREFs of ?UseAutoConvertPCMForLoopbackStreams@CEndpointCharacteristics@@QEAA_NXZ @ 0x18011B5B4
 * Callers:
...
char __fastcall CEndpointCharacteristics::UseAutoConvertPCMForLoopbackStreams(CEndpointCharacteristics *this)
{
  ...
  void *v2; // rcx
  void *v3; // rcx
  struct _GUID v5; // [rsp+30h] [rbp-30h] BYREF
  LPVOID *p_pv; // [rsp+40h] [rbp-20h]
  struct tWAVEFORMATEX *v7; // [rsp+48h] [rbp-18h] BYREF
