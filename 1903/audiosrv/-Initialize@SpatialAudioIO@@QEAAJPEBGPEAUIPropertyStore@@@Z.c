/*
 * XREFs of ?Initialize@SpatialAudioIO@@QEAAJPEBGPEAUIPropertyStore@@@Z @ 0x18003916C
 * Callers:
...
LABEL_12:
  ...
  if ( Instance < 0 )
  {
    if ( (unsigned int)dword_1801B63C0 > 2 )
    {
      ...
      v36 = &v27;
      v37 = 4LL;
      TlgWrite((TraceLoggingHProvider)&dword_1801B63C0, &unk_18017CC9B, v22, v23, 5u, &pData);
    }
    goto LABEL_12;
  }
  v24 = *((_QWORD *)this + 67);
