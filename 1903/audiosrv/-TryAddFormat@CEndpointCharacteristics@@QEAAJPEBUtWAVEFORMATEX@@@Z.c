/*
 * XREFs of ?TryAddFormat@CEndpointCharacteristics@@QEAAJPEBUtWAVEFORMATEX@@@Z @ 0x18011ADFC
 * Callers:
 ...
 *     ?DeviceInUse@AEError@@YA_NJ@Z @ 0x180007A64 (-DeviceInUse@AEError@@YA_NJ@Z.c)
