/*
 * XREFs of ?CalculateDynamicObjectGrantCount@CStreamResource@Sarm@@QEBAIII@Z @ 0x180123FA8
 * Callers:
 *     ?CalculateDynamicObjectGrantCount@CStreamResource@Sarm@@QEBAII@Z @ 0x180123F74 (-CalculateDynamicObjectGrantCount@CStreamResource@Sarm@@QEBAII@Z.c)
 * Callees:
        ...
        const GUID *a3)
{
  ...
  if ( (unsigned int)dword_1801B6350 > 5 )
  {
    ...
    v38 = 1;
    v41 = 4;
    TlgWrite((TraceLoggingHProvider)&dword_1801B6350, &unk_18017AA96, a3, (LPCGUID)v4, 0xCu, &pData);
    LODWORD(v4) = v10;
  }
