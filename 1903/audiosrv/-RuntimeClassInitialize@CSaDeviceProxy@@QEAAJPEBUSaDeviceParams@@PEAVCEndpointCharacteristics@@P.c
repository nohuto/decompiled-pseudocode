/*
 * XREFs of ?RuntimeClassInitialize@CSaDeviceProxy@@QEAAJPEBUSaDeviceParams@@PEAVCEndpointCharacteristics@@PEAUIDeviceGraphObjectsStore@@W4_AUDCLNT_SHAREMODE@@KAEAUSaDeviceResourceParams@@@Z @ 0x180045640
 * Callers:
 ...
 *     WPP_SF_Sddd @ 0x1800F1AAC (WPP_SF_Sddd.c)
 */
    ...
    if ( (_QWORD)v12 )
    {
      ...
      else
      {
        if ( v16 < 0x7FFFFFFF )
        {
          if ( !v15 )
          {
            v15 = (struct IMallocVtbl *)&unk_180162EC4;
            v16 = 0LL;
          }
          if ( v17 )
          {
