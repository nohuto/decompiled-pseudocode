/*
 * XREFs of ?Copy@CAppAudioSessionId@@QEAAJAEBV1@@Z @ 0x18003BD54
 * Callers:
...
__int64 __fastcall CAppAudioSessionId::Copy(CAppAudioSessionId *this, const struct CAppAudioSessionId *a2)
{
  ...
  *((_OWORD *)this + 1) = *((_OWORD *)a2 + 1);
  ...
  if ( v4 - 24 != (_BYTE *)v6 )
  {
    try
    {
      ...
      {
        ATL::CSimpleStringT<unsigned short,0>::SetString((void **)v3, v4, *((_DWORD *)v4 - 4));
      }
    }
  ...
  if ( v7 - 24 != (_BYTE *)v9 )
  {
    try
    {
      ...
      {
        ATL::CSimpleStringT<unsigned short,0>::SetString((void **)v3 + 1, v7, *((_DWORD *)v7 - 4));
      }
    }
  ...
  *((_DWORD *)v3 + 10) = *((_DWORD *)v2 + 10);
  ...
  v14 = (volatile signed __int32 *)((char *)*v11 - 24);
  if ( v12 - 24 != (char *)v14 )
  {
    try
    {
