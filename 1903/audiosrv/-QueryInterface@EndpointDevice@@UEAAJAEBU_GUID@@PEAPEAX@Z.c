/*
 * XREFs of ?QueryInterface@EndpointDevice@@UEAAJAEBU_GUID@@PEAPEAX@Z @ 0x180054E90
 * Callers:
 *     ?QueryInterface@EndpointDevice@@W7EAAJAEBU_GUID@@PEAPEAX@Z @ 0x18006C810 (-QueryInterface@EndpointDevice@@W7EAAJAEBU_GUID@@PEAPEAX@Z.c)
 * Callees:
