/*
 * XREFs of ?RuntimeClassInitialize@SpatialAudioConfigureDevice@@QEAAJPEBGPEAUIPropertyStore@@@Z @ 0x180058C3C
 * Callers:
        ...
        const GUID *a4)
{
  ...
  v17[0] = Create_SpatialAudioDevicePropertyWriter((__int64)a2, (__int64)a3, v4, a4);
  v11 = v17[0];
  if ( v17[0] < 0 )
  {
