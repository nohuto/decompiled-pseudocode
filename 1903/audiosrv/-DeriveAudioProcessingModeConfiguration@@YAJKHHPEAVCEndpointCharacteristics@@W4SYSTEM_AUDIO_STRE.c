/*
 * XREFs of ?DeriveAudioProcessingModeConfiguration@@YAJKHHPEAVCEndpointCharacteristics@@W4SYSTEM_AUDIO_STREAM_TYPE@@W4_AUDCLNT_SHAREMODE@@W4__MIDL___MIDL_itf_audioengineendpoint_0000_0000_0001@@HHPEAU_GUID@@444@Z @ 0x180010080
 * Callers:
        ...
        struct _GUID *a13)
{
  ...
  struct _RTL_CRITICAL_SECTION *v205; // [rsp+108h] [rbp+0h] BYREF
  struct _RTL_CRITICAL_SECTION *v206; // [rsp+110h] [rbp+8h] BYREF
  struct _RTL_CRITICAL_SECTION *v207; // [rsp+118h] [rbp+10h] BYREF
  struct _RTL_CRITICAL_SECTION *v208; // [rsp+120h] [rbp+18h] BYREF
  struct _RTL_CRITICAL_SECTION *v209; // [rsp+128h] [rbp+20h] BYREF
  struct _RTL_CRITICAL_SECTION *v210; // [rsp+130h] [rbp+28h] BYREF
...
LABEL_18:
      ...
      if ( v187[284] )
      {
        ...
        v205 = (struct _RTL_CRITICAL_SECTION *)(v187 + 288);
        v30 = 0;
        v31 = 0LL;
        v192 = 0LL;
        v32 = 0;
...
LABEL_80:
      ...
      if ( v187[668] )
      {
        ...
        v206 = (struct _RTL_CRITICAL_SECTION *)(v187 + 672);
        v47 = 0LL;
        v201 = 0LL;
        v48 = 0;
        v202 = 0LL;
...
LABEL_83:
      ...
      if ( v187[1052] )
      {
        ...
        v207 = (struct _RTL_CRITICAL_SECTION *)(v187 + 1056);
        v58 = 0;
        v59 = 0LL;
        v196 = 0LL;
        v60 = 0;
      ...
      if ( *((int *)v90 + 10) > 0 )
      {
        while ( 1 )
        {
          if ( *(_BYTE *)(*(_QWORD *)ATL::CSimpleArray<_GUID,ATL::CSimpleArrayEqualHelper<_GUID>>::operator[](
                        ...
                        + 20LL) )
          {
            v93 = (_QWORD *)ATL::CSimpleArray<_GUID,ATL::CSimpleArrayEqualHelper<_GUID>>::operator[](
                              (__int64)(v90 + 32),
                              v92);
...
LABEL_167:
    ...
    if ( *((int *)v90 + 10) > 0 )
    {
      while ( 1 )
      {
        v100 = (_QWORD *)ATL::CSimpleArray<_GUID,ATL::CSimpleArrayEqualHelper<_GUID>>::operator[](
                           (__int64)(v90 + 32),
                           v99);
        ...
        if ( v21 )
        {
          ...
          if ( v21 == 1 )
          {
            if ( *(_DWORD *)&v182[4] == 18 )
            {
              if ( v14 )
              {
                v104 = (char *)&unk_180153B78;
                goto LABEL_198;
              }
            }
            else if ( *(_DWORD *)&v182[4] == 3 && v14 )
            {
              v104 = (char *)&unk_180153B68;
              goto LABEL_198;
            }
          }
        }
...
LABEL_191:
        ...
        if ( v21 == 1 && v102 >= 0x15 )
          goto LABEL_191;
        if ( v21 )
          v104 = (char *)*(&off_1801544D0 + v102);
        else
          v104 = (char *)*(&off_1801542D0 + v102);
LABEL_198:
        v187 = v104;
        v105 = 0;
        LODWORD(v184) = 0;
...
LABEL_199:
        ...
        if ( v186[284] )
        {
          ...
          v208 = (struct _RTL_CRITICAL_SECTION *)(v115 + 56);
          v117 = 0;
          v118 = 0LL;
          v188 = 0LL;
          v119 = 0LL;
...
LABEL_270:
        ...
        {
          EnterCriticalSection((LPCRITICAL_SECTION)(v90 + 56));
          v209 = (struct _RTL_CRITICAL_SECTION *)(v90 + 56);
          v133 = 0LL;
          v194 = 0LL;
          v134 = 0LL;
          v195 = 0LL;
...
LABEL_261:
        ...
        v210 = (struct _RTL_CRITICAL_SECTION *)(v114 + 1056);
        v143 = 0;
        v144 = 0LL;
        v190 = 0LL;
        v145 = 0LL;
...
LABEL_305:
              ...
              if ( v169 )
              {
                ...
                {
                  v242 = v167;
                  v170 = (unsigned int)ATL::CSimpleArray<_GUID,ATL::CSimpleArrayEqualHelper<_GUID>>::Find(v90, &v242) == -1;
                  goto LABEL_351;
                }
              }
              v230 = v167;
                ...
                if ( *((int *)v90 + 10) > 0 )
                {
                  while ( 1 )
                  {
                    if ( *(_BYTE *)(*(_QWORD *)ATL::CSimpleArray<_GUID,ATL::CSimpleArrayEqualHelper<_GUID>>::operator[](
                                  ...
                                  + 20LL) )
                    {
                      v172 = (_QWORD *)ATL::CSimpleArray<_GUID,ATL::CSimpleArrayEqualHelper<_GUID>>::operator[](
                                         (__int64)(v90 + 32),
                                         v171);
...
LABEL_342:
              ...
              while ( 1 )
              {
                v179 = (_QWORD *)ATL::CSimpleArray<_GUID,ATL::CSimpleArrayEqualHelper<_GUID>>::operator[](
                                   (__int64)(v90 + 32),
                                   v178);
