/*
 * XREFs of ?GetRule@DynamicAudioEndpointManager@@QEAAJPEAX_JPEAU_DynamicRoutingRule@@@Z @ 0x18012AE24
 * Callers:
 *     PolicyConfigGetDynamicRoutingRule @ 0x1800E2230 (PolicyConfigGetDynamicRoutingRule.c)
 * Callees:
