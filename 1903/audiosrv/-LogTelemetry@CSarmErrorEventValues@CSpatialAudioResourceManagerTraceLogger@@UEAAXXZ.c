/*
 * XREFs of ?LogTelemetry@CSarmErrorEventValues@CSpatialAudioResourceManagerTraceLogger@@UEAAXXZ @ 0x180123520
 * Callers:
 *     <none>
 * Callees:
        ...
        CSpatialAudioResourceManagerTraceLogger::CSarmErrorEventValues *this)
{
  ...
  if ( *((_QWORD *)this + 1) && *((_QWORD *)this + 2) && *((_QWORD *)this + 3) )
  {
    ...
    if ( **((_BYTE **)this + 1) )
    {
      if ( *(_DWORD *)v4 > 3u )
      {
        if ( TlgKeywordOn(v4, 0x400000000000uLL) )
        {
          ...
          v21 = 4LL;
          v23 = 4LL;
          TlgWrite(v6, &unk_18017A61A, v5, (LPCGUID)v6, 7u, &pData);
        }
      }
    }
    else if ( *(_DWORD *)v4 > 3u && TlgKeywordOn(v4, 0x400000000000uLL) )
    {
      ...
      v21 = 4LL;
      v23 = 4LL;
      TlgWrite(v8, &unk_18017A6AF, v7, (LPCGUID)v8, 7u, &pData);
    }
  }
}
