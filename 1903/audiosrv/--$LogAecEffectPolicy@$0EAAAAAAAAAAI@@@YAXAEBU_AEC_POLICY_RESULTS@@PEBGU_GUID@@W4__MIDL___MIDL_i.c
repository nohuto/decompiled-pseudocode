/*
 * XREFs of ??$LogAecEffectPolicy@$0EAAAAAAAAAAI@@@YAXAEBU_AEC_POLICY_RESULTS@@PEBGU_GUID@@W4__MIDL___MIDL_itf_audioengineendpoint_0000_0000_0001@@@Z @ 0x180053FAC
 * Callers:
...
void __fastcall LogAecEffectPolicy<70368744177672>(__int64 a1, const WCHAR *a2)
{
  ...
  if ( (unsigned int)hProvider > 4 )
  {
    if ( TlgKeywordOn((TraceLoggingHProvider)&hProvider, 0x400000000008uLL) )
    {
      ...
      v41 = 4LL;
      v43 = 4LL;
      TlgWrite((TraceLoggingHProvider)&hProvider, &unk_18017A0D3, v6, v4, 0x13u, &pData);
    }
  }
}
