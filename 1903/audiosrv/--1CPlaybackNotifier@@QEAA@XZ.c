/*
 * XREFs of ??1CPlaybackNotifier@@QEAA@XZ @ 0x1800FB8B4
 * Callers:
 *     _CPowerReferenceManager::CPowerReferenceManager_::_1_::dtor$2 @ 0x180071CF6 (_CPowerReferenceManager--CPowerReferenceManager_--_1_--dtor$2.c)
 * Callees:
