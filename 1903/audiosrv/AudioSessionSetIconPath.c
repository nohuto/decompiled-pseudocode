/*
 * XREFs of AudioSessionSetIconPath @ 0x1800D5040
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall AudioSessionSetIconPath(__int64 *a1, __int64 a2, __int64 a3)
{
  ...
  CWatchdogTimer<1>::CWatchdogTimer<1>(pv, v12[1], v6, (struct _TP_TIMER *)L"AudioSessionSetIconPath");
  v8 = (*(__int64 (__fastcall **)(__int64, __int64, __int64))(*(_QWORD *)v3 + 208LL))(v3, a2, a3);
