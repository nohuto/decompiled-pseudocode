/*
 * XREFs of ??1CVADServer@@QEAA@XZ @ 0x1800E4148
 * Callers:
 *     _ATL::CComObject_CVADServer_::CreateInstance_::_1_::dtor$1 @ 0x1800706F0 (_ATL--CComObject_CVADServer_--CreateInstance_--_1_--dtor$1.c)
 * Callees:
