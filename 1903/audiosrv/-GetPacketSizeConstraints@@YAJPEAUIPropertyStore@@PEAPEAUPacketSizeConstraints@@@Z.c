/*
 * XREFs of ?GetPacketSizeConstraints@@YAJPEAUIPropertyStore@@PEAPEAUPacketSizeConstraints@@@Z @ 0x180118860
 * Callers:
...
__int64 __fastcall GetPacketSizeConstraints(struct IPropertyStore *a1, LPVOID **a2)
{
  ...
  Size = 0LL;
  Src = 0LL;
  if ( dword_1801B9A24 > *(_DWORD *)(*((_QWORD *)NtCurrentTeb()->ThreadLocalStoragePointer + (unsigned int)tls_index)
                                   + 4LL) )
  {
    Init_thread_header(&dword_1801B9A24);
    if ( dword_1801B9A24 == -1 )
    {
      xmmword_1801B98B8 = DEVPKEY_KsAudio_PacketSize_Constraints2;
      dword_1801B98C8 = 2;
      xmmword_1801B98CC = DEVPKEY_KsAudio_PacketSize_Constraints;
      dword_1801B98DC = 2;
      Init_thread_footer(&dword_1801B9A24);
    }
  }
  v6 = &xmmword_1801B98B8;
  while ( 1 )
  {
    v21 = 0LL;
