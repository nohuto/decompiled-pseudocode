/*
 * XREFs of ?GetInstanceId@CAudioSession@@UEAAJPEAPEAG@Z @ 0x1800CE7F0
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall CAudioSession::GetInstanceId(CAudioSession *this, unsigned __int16 **a2)
{
  ...
  v4 = CAudioSessionInstanceId::ToString((__int64)this + 656, (void **)&v10);
  v5 = v10;
  v6 = v4;
  if ( v4 < 0 )
    goto LABEL_6;
  ...
  *a2 = v8;
  if ( !v8 )
  {
    v6 = -2147024882;
LABEL_6:
    AudSrvTraceLoggingErrorHelper("CAudioSession::GetInstanceId", 431, v6);
    goto LABEL_7;
  }
