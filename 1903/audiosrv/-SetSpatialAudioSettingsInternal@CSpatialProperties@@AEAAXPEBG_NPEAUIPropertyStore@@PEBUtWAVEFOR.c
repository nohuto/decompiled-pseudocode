/*
 * XREFs of ?SetSpatialAudioSettingsInternal@CSpatialProperties@@AEAAXPEBG_NPEAUIPropertyStore@@PEBUtWAVEFORMATEX@@V?$function@$$A6A_NPEBUWAVEFORMATEXTENSIBLE@@@Z@std@@PEAUWAVEFORMATEXTENSIBLE@@@Z @ 0x180035448
 * Callers:
        ...
        __int64 a7)
{
  ...
  if ( (unsigned int)hProvider > 4 )
  {
    ...
    v348 = (char *)v214 + 12;
    v349 = 16LL;
    TlgWrite((TraceLoggingHProvider)&hProvider, &unk_18017C710, v20, v21, 0x16u, &pData);
    v17 = AsUInt32With;
    v16 = v124;
    v18 = (unsigned int)hProvider;
  }
  ...
  do
  {
    ...
    if ( v18 > 4 )
    {
      ...
      v190 = 0LL;
      v230 = off_1801B6488;
      v231 = *(unsigned __int16 *)off_1801B6488;
      v232 = v26;
      v233 = &unk_18017C61B;
      v234 = 244;
      v235 = 1;
      LODWORD(v168) = (unsigned int)&TraceLoggingMetadataEnd - (unsigned int)&TraceLoggingMetadata;
      EtwEventWriteTransfer(qword_1801B64A0, v189, 0LL, 0LL, 17, &v230);
      v17 = AsUInt32With;
      v16 = v124;
      v23 = v154;
      v18 = (unsigned int)hProvider;
...
LABEL_44:
    ...
    if ( v18 > 4 )
    {
      ...
      v414 = &AsUInt32With;
      v415 = 4LL;
      TlgWrite((TraceLoggingHProvider)&hProvider, &unk_18017B00B, v29, v30, cData, &v412);
    }
    v124 = 0;
    memset_0(&v213, 0, 0x48uLL);
  ...
  if ( !v119 )
  {
    ...
    if ( (unsigned int)hProvider > 4 )
    {
      if ( TlgKeywordOn((TraceLoggingHProvider)&hProvider, 0x400000000000uLL) )
      {
        ...
        TlgWrite((TraceLoggingHProvider)&hProvider, &unk_18017B0A8, v43, v44, 5u, &v428);
        v39 = 0LL;
      }
    }
  }
...
LABEL_176:
      if ( (unsigned int)hProvider > 4 )
      {
        ...
        v410 = &v163;
        v411 = 4LL;
        TlgWrite((TraceLoggingHProvider)&hProvider, &unk_18017AEF7, v75, v76, 7u, &v404);
      }
      goto LABEL_178;
    }
    if ( !v11 )
...
LABEL_169:
    ...
    if ( (unsigned int)hProvider > 4 )
    {
      ...
      v402 = &v163;
      v403 = 4LL;
      TlgWrite((TraceLoggingHProvider)&hProvider, &unk_18017B041, v72, v73, 6u, &v397);
    }
LABEL_178:
    v46 = v126;
...
LABEL_203:
  if ( (unsigned int)hProvider > 5 )
  {
    ...
    v389 = &v133;
    v390 = 1LL;
    TlgWrite((TraceLoggingHProvider)&hProvider, &unk_18017C495, v37, (LPCGUID)v39, 8u, &v378);
  }
  v79 = v121 != 0;
  v121 = -v121;
  v80 = v79 && v117;
  ...
  *(GUID *)(a1 + 6856) = v83;
    ...
    || v88 )
  {
    ...
    if ( (unsigned int)hProvider > 4 )
    {
      ...
      v308 = (char *)v214 + 12;
      v309 = 16LL;
      TlgWrite((TraceLoggingHProvider)&hProvider, &unk_18017C2B0, v94, v95, 0x19u, &v264);
    }
    v96 = 0;
    v97 = 0;
    v159 = 0;
    if ( v147 )
    {
      do
      {
        if ( (unsigned int)hProvider > 5 )
        {
          ...
          TlgWrite((TraceLoggingHProvider)&hProvider, &unk_18017C51D, v99, v100, (UINT32)v100, &v350);
          v97 = v159;
        }
        v159 = ++v97;
        v96 = v97;
...
LABEL_266:
    ...
    if ( (unsigned int)hProvider > 2 )
    {
      ...
      v418 = &AsUInt32With;
      v419 = 4LL;
      TlgWrite((TraceLoggingHProvider)&hProvider, &unk_18017B9CF, v102, v103, 4u, &v416);
      goto LABEL_266;
    }
LABEL_267:
    if ( v101 >= 0 )
...
LABEL_269:
      ...
      if ( (unsigned int)hProvider > 2 )
      {
        ...
        v422 = &AsUInt32With;
        v423 = 4LL;
        TlgWrite((TraceLoggingHProvider)&hProvider, &unk_18017B98E, v104, v105, 4u, &v420);
        v101 = AsUInt32With;
      }
LABEL_273:
      if ( v101 >= 0 )
...
LABEL_274:
        ...
        if ( AsUInt32With < 0 )
        {
          if ( (unsigned int)hProvider > 2 )
          {
            ...
            v426 = &AsUInt32With;
            v427 = 4LL;
            TlgWrite((TraceLoggingHProvider)&hProvider, &unk_18017C277, v108, v109, 4u, &v424);
          }
        }
        else
        {
  ...
  if ( v160 != *(_DWORD *)(a1 + 80) )
  {
    if ( (unsigned int)hProvider > 4 )
    {
      ...
      v395 = &v123;
      v396 = 2LL;
      TlgWrite((TraceLoggingHProvider)&hProvider, &unk_18017BA14, v111, v112, 5u, &v391);
    }
    *(_DWORD *)(a1 + 80) = v110;
  }
LABEL_287:
