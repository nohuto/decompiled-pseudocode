/*
 * XREFs of ?ToMigratedString@CAudioEndpointId@@QEBAJAEAV?$CStringT@GV?$StrTraitATL@GV?$ChTraitsCRT@G@ATL@@@ATL@@@ATL@@@Z @ 0x180025330
 * Callers:
        ...
        if ( v6 >= 0 )
        {
          ...
          if ( v6 >= 0 )
          {
            ...
            do
            {
              ...
              {
                ATL::CSimpleStringT<unsigned short,0>::PrepareWrite2(a2, v15);
                v12 = *a2;
              }
