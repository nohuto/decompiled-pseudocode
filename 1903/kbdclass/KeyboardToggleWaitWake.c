/*
 * XREFs of KeyboardToggleWaitWake @ 0x1C0005E14
 * Callers:
 *     KeyboardClassWaitWakeComplete @ 0x1C0005C00 (KeyboardClassWaitWakeComplete.c)
 *     KeyboardClassSetWmiDataBlock @ 0x1C000F850 (KeyboardClassSetWmiDataBlock.c)
 *     KeyboardClassSetWmiDataItem @ 0x1C000F8F0 (KeyboardClassSetWmiDataItem.c)
 * Callees:
