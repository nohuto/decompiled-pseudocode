...
LABEL_38:
  ...
  if ( v9
    ...
    || (v10 = a1 + 8LL * v7, (v11 = *(_QWORD *)(v10 + 1648)) == 0) )
  {
    *(_BYTE *)(a2 + 3) = 8;
    goto LABEL_38;
  }
  ...
  if ( !(unsigned __int8)ProcessCommandInSpecificQueue(a1, a2, v15, v14) )
  {
    if ( *(_BYTE *)(a2 + 3) == 5
      && *(_WORD *)(v15 + 40)
      && (v21 = *(unsigned __int16 *)(a1 + 272), v22 = 0, *(_BYTE *)(v12 + 4253) |= 0x10u, (v23 = v21) != 0) )
    {
      while ( 1 )
      {
        v24 = 1;
        if ( ((unsigned int)*(unsigned __int16 *)(v15 + 40) + 1) % *(unsigned __int16 *)(a1 + 272) )
          v24 = ((unsigned int)*(unsigned __int16 *)(v15 + 40) + 1) % *(unsigned __int16 *)(a1 + 272);
        *(_WORD *)(v12 + 4244) = v24;
        v15 = 136LL * v24 + *(_QWORD *)(a1 + 760) - 136LL;
        if ( (unsigned __int8)ProcessCommandInSpecificQueue(a1, a2, v15, v14) )
          break;
