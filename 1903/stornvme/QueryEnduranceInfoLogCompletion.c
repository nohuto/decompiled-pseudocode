/*
 * XREFs of QueryEnduranceInfoLogCompletion @ 0x1C0012770
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall QueryEnduranceInfoLogCompletion(__int64 a1, __int64 a2)
{
  ...
  if ( *(_BYTE *)(v2 + 3) == 1 )
  {
    ...
    v8 = *(unsigned __int16 *)(*(_QWORD *)(v4 + 8 * result + 1648) + 94LL);
    *(_DWORD *)(v5 + 36) = 1;
    *(_DWORD *)(v5 + 40) = v8;
  ...
  *(_BYTE *)(SrbExtension + 4253) |= 8u;
  v11 = *(_QWORD *)(SrbExtension + 4200);
  if ( v11 )
    result = NVMeFreeDmaBuffer(v4, *(unsigned int *)(SrbExtension + 4240), v11);
