/*
 * XREFs of NVMeHwUnitControl @ 0x1C00087E0
 * Callers:
 *     <none>
 * Callees:
 *     NVMeLunCompleteAllIORequests @ 0x1C000CB80 (NVMeLunCompleteAllIORequests.c)
...
_BOOL8 __fastcall NVMeHwUnitControl(__int64 a1, int a2, __int64 a3)
{
  ...
  if ( !v5 )
  {
    ...
    return (unsigned int)v13 >= *(_DWORD *)(a1 + 192) || !*(_QWORD *)(a1 + 8 * v13 + 1648);
  }
  v6 = v5 - 1;
  if ( !v6 )
    return 0;
  ...
  if ( !v7 )
  {
    v12 = *(_QWORD *)(a1 + 8LL * *(unsigned __int8 *)(a3 + 10) + 1648);
    if ( v12 )
      *(_DWORD *)(v12 + 20) |= 4u;
    return 0;
  }
