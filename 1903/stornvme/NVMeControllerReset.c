/*
 * XREFs of NVMeControllerReset @ 0x1C000B7AC
 * Callers:
 *     NVMeHwResetBus @ 0x1C00087A0 (NVMeHwResetBus.c)
 *     NVMeControllerAsyncResetWorker @ 0x1C000AB60 (NVMeControllerAsyncResetWorker.c)
 * Callees:
 ...
 *     NVMeCancelAllCompletionQueueDpc @ 0x1C000A6B0 (NVMeCancelAllCompletionQueueDpc.c)
