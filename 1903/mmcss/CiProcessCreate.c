/*
 * XREFs of CiProcessCreate @ 0x1C000B030
 * Callers:
 *     CiThreadCreate @ 0x1C000A7F0 (CiThreadCreate.c)
 *     CiDispatchCreateNotificationClient @ 0x1C000C270 (CiDispatchCreateNotificationClient.c)
 * Callees:
 *     memset @ 0x1C0003400 (memset.c)
 *     CiProcessComparer @ 0x1C000A1E0 (CiProcessComparer.c)
 */
