/*
 * XREFs of CiDispatchCreateTaskIndexClient @ 0x1C000A210
 * Callers:
 *     <none>
 * Callees:
 *     CiTaskIndexReference @ 0x1C0001DD0 (CiTaskIndexReference.c)
 ...
 *     CiLookupTask @ 0x1C000ACC0 (CiLookupTask.c)
...
LABEL_7:
    v12 = *(_QWORD *)(a2 + 48);
    if ( !_InterlockedCompareExchange64(v10 + 1, v12, 0LL) )
    {
      v13 = v16;
      v9 = 0;
      *(_QWORD *)(v12 + 24) = v16;
