/*
 * XREFs of PnpiBiosAddressExtendedToIoDescriptor @ 0x1C00B2E88
 * Callers:
        ...
        char a4)
{
  ...
  result = PnpiUpdateResourceList(v10, &v27, v8);
  if ( result < 0 )
    return result;
  if ( BugCheckParameter2[3] > 1u )
  {
    v13 = (struct _IO_RESOURCE_DESCRIPTOR *)v27;
  }
  else
  {
    result = PnpiUpdateResourceList(v10, &Alignment, v12);
    if ( result < 0 )
      return result;
    v4 = Alignment;
  ...
  if ( BugCheckParameter2[3] )
  {
    ...
    {
      v13->u.Port.Alignment = Alignment;
  ...
  {
    result = RtlIoEncodeMemIoResource(v13, 3u, v18, Alignment, v16, v27);
    if ( result < 0 )
      return result;
