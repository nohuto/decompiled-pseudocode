/*
 * XREFs of ProcessorpReserveIdtEntriesApic @ 0x1C009EDF0
 * Callers:
 *     <none>
 * Callees:
        ...
        _OWORD *a9)
{
  ...
  *((_DWORD *)UserData + 6) = a5;
  ...
  while ( 1 )
  {
    ...
    if ( _bittest64(&v17, v19) )
    {
      v25.Group = *(_WORD *)(a4 + 24);
      *(_WORD *)&v25.Number = v19;
      ProcNumber = v25;
...
LABEL_14:
  ...
  if ( v14 != 1 )
    v22 = v21;
  v23 = RtlAddRange(v22, (unsigned int)Start, a5 + (unsigned int)Start - 1LL, v18, 2 * (a7 & 1) + 1, UserData, Owner);
  if ( v23 >= 0 )
  {
    v14 = a8;
    *UserData |= 1LL << v19;
