/*
 * XREFs of ACPIFilterIrpSetPower @ 0x1C002D400
 * Callers:
 *     <none>
 * Callees:
 ...
 *     ACPIInternalCheckPowerReferences @ 0x1C005688C (ACPIInternalCheckPowerReferences.c)
 */
  ...
  if ( CurrentStackLocation->Parameters.Create.Options )
  {
    ...
    if ( CurrentStackLocation->Parameters.Read.ByteOffset.LowPart == 1 )
    {
      *(_BYTE *)(v6 + 508) = 1;
      ...
      v9 = &ACPIDeviceIrpDelayedDeviceOnRequest;
      if ( !v7 )
