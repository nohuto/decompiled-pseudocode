/*
 * XREFs of ParsePackage @ 0x1C0012880
 * Callers:
 *     <none>
 * Callees:
    ...
    *(_QWORD *)(v11 + 24) = 0LL;
    if ( (_DWORD)v12 != 13 )
    {
      ...
      if ( (unsigned int)v12 > 0xC )
      {
        ...
        if ( (_DWORD)v12 == 255 )
        {
          if ( (unsigned __int8)IsCompatableDSDTRevision(v12, (unsigned int)v12, a3, 1LL) )
            v34 = -1LL;
          else
            v34 = 0xFFFFFFFFLL;
          *(_QWORD *)(v11 + 24) = v34;
...
LABEL_23:
    ...
    *(_QWORD *)(a1 + 120) = v13;
    ...
    if ( v4 != -1072431103 )
      goto LABEL_23;
    LOBYTE(a4) = 1;
    v4 = ParseObjName(a1, a1 + 120, v10 + *(_QWORD *)(v5 + 32) + 8LL, a4);
    if ( v4 != -1072431103 )
      goto LABEL_23;
