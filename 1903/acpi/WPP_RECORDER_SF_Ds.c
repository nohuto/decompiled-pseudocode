/*
 * XREFs of WPP_RECORDER_SF_Ds @ 0x1C0020E1C
 * Callers:
...
__int64 __fastcall WPP_RECORDER_SF_Ds(__int64 a1, __int64 a2, __int64 a3, __int64 a4, int a5, char a6, const char *a7)
{
  ...
  if ( (HIDWORD(WPP_GLOBAL_Control->Timer) & 0x100000) != 0 && BYTE1(WPP_GLOBAL_Control->Timer) >= 2u )
  {
    ...
    pfnWppTraceMessage(
      ...
      43LL,
      &WPP_8836c167c845339ec7b5021a21721c31_Traceguids,
      10LL,
      &a6,
      4LL,
      v12);
  ...
  LOWORD(v13) = 10;
  return WppAutoLogTrace(a1, 2LL, 21LL, &WPP_8836c167c845339ec7b5021a21721c31_Traceguids, v13, &a6);
}
