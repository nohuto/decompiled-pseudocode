/*
 * XREFs of ACPIBusIrpQueryResourceRequirements @ 0x1C0095390
 * Callers:
 *     <none>
 * Callees:
 ...
 *     ACPIInternalInterruptPolarityCacheStorePolaritiesFromList @ 0x1C000AEEC (ACPIInternalInterruptPolarityCacheStorePolaritiesFromList.c)
 ...
 *     ACPIRangeFilterPICInterrupt @ 0x1C002EE34 (ACPIRangeFilterPICInterrupt.c)
...
__int64 __fastcall ACPIBusIrpQueryResourceRequirements(ULONG_PTR a1, IRP *a2)
{
  ...
  if ( P )
  {
    ...
    if ( DeviceResourceList < 0 )
    {
      ...
      {
        v38 = *(const char **)(DeviceExtension + 560);
        if ( (v37 & 0x400000000000LL) != 0 )
          v39 = *(const char **)(DeviceExtension + 568);
      }
      if ( WPP_RECORDER_INITIALIZED != (_UNKNOWN *)&WPP_RECORDER_INITIALIZED )
        WPP_RECORDER_SF_qLqss(
          (__int64)WPP_GLOBAL_Control->DeviceExtension,
