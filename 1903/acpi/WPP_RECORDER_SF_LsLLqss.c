/*
 * XREFs of WPP_RECORDER_SF_LsLLqss @ 0x1C006225C
 * Callers:
        ...
        __int64 a12)
{
  ...
  if ( (HIDWORD(WPP_GLOBAL_Control->Timer) & 0x10000) != 0 && BYTE1(WPP_GLOBAL_Control->Timer) >= 2u )
  {
    ...
    pfnWppTraceMessage(
      ...
      43LL,
      &WPP_77f4a81bb1c43aa26362b868938d336a_Traceguids,
      21LL,
      &a6,
      4LL,
      v20);
  ...
  LOWORD(v24) = 21;
  return WppAutoLogTrace(a1, 2LL, 17LL, &WPP_77f4a81bb1c43aa26362b868938d336a_Traceguids, v24, &a6);
}
