/*
 * XREFs of ACPIFilterIrpFilterResourceRequirements @ 0x1C00939D0
 * Callers:
 *     <none>
 * Callees:
 ...
 *     ACPIInternalInterruptPolarityCacheStorePolarity @ 0x1C000ADF8 (ACPIInternalInterruptPolarityCacheStorePolarity.c)
  ...
  if ( (int)(Status + 0x80000000) < 0 || Status == -1073741637 )
  {
    ...
    if ( updated != -1073741772 )
    {
      if ( updated >= 0 )
      {
        ...
        {
          v27 = *(const char **)(DeviceExtension + 560);
          if ( (v26 & 0x400000000000LL) != 0 )
            v28 = *(const char **)(DeviceExtension + 568);
        }
...
LABEL_7:
  if ( (*(_QWORD *)(DeviceExtension + 8) & 0x200000000000LL) != 0 )
    v9 = *(const char **)(DeviceExtension + 560);
  if ( WPP_RECORDER_INITIALIZED != (_UNKNOWN *)&WPP_RECORDER_INITIALIZED )
  {
