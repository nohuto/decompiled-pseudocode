/*
 * XREFs of ACPIAssociateWakeInterrupt @ 0x1C0060D44
 * Callers:
 ...
 *     ACPIDereferenceWakeInterrupt @ 0x1C00611C4 (ACPIDereferenceWakeInterrupt.c)
  ...
  if ( (int)ACPIFindWakeInterruptForVector(v8, v7, &v19) < 0 )
  {
    ...
    *(_DWORD *)(v9 + 88) = 2;
    ...
    if ( *v15 == v9 + 16 )
    {
      ...
      *v15 = a1;
      *(_QWORD *)(v9 + 24) = a1;
      v16 = (__int64 *)qword_1C0081978;
      if ( *(__int64 **)qword_1C0081978 == &AcpiPowerWaitWakeInterruptList )
      {
        *(_QWORD *)(v9 + 8) = qword_1C0081978;
