/*
 * XREFs of ACPIWakeRemoveDevicesAndUpdate @ 0x1C0021EFC
 * Callers:
 *     ACPIDeviceIrpWaitWakeRequestPending @ 0x1C0021170 (ACPIDeviceIrpWaitWakeRequestPending.c)
...
void __fastcall ACPIWakeRemoveDevicesAndUpdate(__int64 a1, __int64 a2)
{
  ...
  while ( v9 != &AcpiPowerWaitWakeList )
  {
    ...
    else if ( !v4 && (*(_QWORD *)(v10 + 952) & 0x500000000LL) == 0 && *((_DWORD *)v5 + 26) >= AcpiMostRecentSleepState )
    {
      if ( *(_BYTE *)((unsigned int)ACPIGpeIndexToByteIndex(*(unsigned int *)(v10 + 456)) + GpeMap) )
      {
        v20 = *(_QWORD *)(v10 + 8);
        v5 = (__int64 *)&unk_1C006FE7D;
