/*
 * XREFs of ACPITableLoad @ 0x1C0021410
 * Callers:
 ...
 *     ACPIQueryDeviceLockMutexSupport @ 0x1C00241A0 (ACPIQueryDeviceLockMutexSupport.c)
...
__int64 __fastcall ACPITableLoad(__int64 a1, int a2, __int64 a3)
{
  ...
  else
  {
    ...
    if ( !v8 )
    {
      ...
      if ( v10 < 0
        || (EnableDisableCMOSRegions(*(_QWORD *)(RootDeviceExtension + 712)),
