/*
 * XREFs of PnpiBiosPortFixedToIoDescriptor @ 0x1C00B3910
 * Callers:
...
__int64 __fastcall PnpiBiosPortFixedToIoDescriptor(__int64 a1, __int64 a2, __int64 a3, char a4)
{
  __int64 result; // rax
  __int64 v6; // rdx
  ...
  {
    result = PnpiUpdateResourceList((const void **)(a2 + 8LL * (unsigned int)a3), &v7, a3);
    if ( (int)result < 0 )
      return result;
    v6 = v7;
    *(_WORD *)(v7 + 1) = 257;
