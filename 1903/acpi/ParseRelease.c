/*
 * XREFs of ParseRelease @ 0x1C0013B40
 * Callers:
...
__int64 __fastcall ParseRelease(__int64 a1, __int64 a2, unsigned int a3)
{
  ...
  if ( (v5 & 0xF) == 0 )
  {
    v8 = (KSPIN_LOCK *)(v3 + 184);
    *(_DWORD *)(a2 + 16) = v5 + 1;
    a3 = 0;
    v9 = KeAcquireSpinLockRaiseToDpc((PKSPIN_LOCK)(v3 + 184));
    if ( *(_DWORD *)(v3 + 4) )
    {
      v10 = *(_QWORD *)(v3 + 8);
...
LABEL_8:
          KeReleaseSpinLock((PKSPIN_LOCK)(v3 + 184), v9);
          v5 = *(_DWORD *)(a2 + 16);
...
LABEL_10:
  ...
  if ( !v11 )
    v39 = 0LL;
  a3 = PerformMutexDriverCallbacks(3, v3, v39, 0LL, 0);
  if ( a3 != 32772 )
  {
LABEL_11:
    v5 = *(_DWORD *)(a2 + 16) + 1;
