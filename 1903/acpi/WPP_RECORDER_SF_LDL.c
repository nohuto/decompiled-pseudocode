/*
 * XREFs of WPP_RECORDER_SF_LDL @ 0x1C005911C
 * Callers:
...
__int64 WPP_RECORDER_SF_LDL(__int64 a1, _DWORD a2, _DWORD a3, _DWORD a4, __int64 a5, ...)
{
  ...
  if ( (HIDWORD(WPP_GLOBAL_Control->Timer) & 0x10000) != 0 && BYTE1(WPP_GLOBAL_Control->Timer) >= 4u )
    ((void (__fastcall *)(_DEVICE_OBJECT *, __int64, void *, __int64, __int64 *, __int64, __int64 *, __int64, char *, __int64, _QWORD))pfnWppTraceMessage)(
      ...
      0LL);
  LOWORD(v7) = 31;
  return WppAutoLogTrace(a1, 4LL, 17LL, &WPP_2b07ff94468e36517e02013b54d392f0_Traceguids, v7, (__int64 *)va);
}
