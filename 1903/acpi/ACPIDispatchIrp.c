 ...
 *     ACPIWakeDeferredRestoreEnables @ 0x1C006149C (ACPIWakeDeferredRestoreEnables.c)
    ...
    if ( MajorFunction == 27 )
    {
      if ( MinorFunction )
      {
        ...
        if ( MinorFunction >= 0x1Au )
          ...
          v20 = *(unsigned int (__fastcall **)(ULONG_PTR, PIRP))(v19 + 8LL * MinorFunction);
...
LABEL_11:
    ...
    if ( MajorFunction == 22 )
    {
      ...
      if ( MinorFunction >= 4u )
        ...
        v23 = *(__int64 (__fastcall **)(ULONG_PTR, PIRP))(v22 + 8LL * MinorFunction);
      ...
      if ( MajorFunction == 14 )
      {
        ...
        else
        {
          ...
          if ( *(_QWORD *)(v18 + 728) )
          {
            ...
            Status = IofCallDriver(*(PDEVICE_OBJECT *)(v18 + 728), Irp);
            goto LABEL_29;
          }
