/*
 * XREFs of ACPIProcessorContainerEvaluateLpiObject @ 0x1C005CD94
 * Callers:
 *     ACPIProcessorContainerEvaluateLpiObjects @ 0x1C005CE58 (ACPIProcessorContainerEvaluateLpiObjects.c)
 * Callees:
