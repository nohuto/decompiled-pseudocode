/*
 * XREFs of AcpiUnregisterDeviceFirmwareLockHandler @ 0x1C00ADE1C
 * Callers:
 *     ACPIIoctlUnregisterDeviceFirmwareLockHandler @ 0x1C0058000 (ACPIIoctlUnregisterDeviceFirmwareLockHandler.c)
 * Callees:
 *     DereferenceDeviceFirmwareLockHandlerEntry @ 0x1C004F77C (DereferenceDeviceFirmwareLockHandlerEntry.c)
 *     FindDeviceFirmwareLockHandlerEntry @ 0x1C004F9C0 (FindDeviceFirmwareLockHandlerEntry.c)
 */
