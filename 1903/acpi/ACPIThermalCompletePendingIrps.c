/*
 * XREFs of ACPIThermalCompletePendingIrps @ 0x1C00090A0
 * Callers:
...
char __fastcall ACPIThermalCompletePendingIrps(__int64 a1)
{
  ...
  char v33; // [rsp+78h] [rbp-9h]
  KIRQL v34; // [rsp+79h] [rbp-8h]
  _QWORD *v35; // [rsp+80h] [rbp-1h] BYREF
  ...
  do
  {
    ...
    *((_DWORD *)v6 - 30) = 0;
    ...
    if ( *(__int64 **)(*v7 + 8) != v7
      ...
      || (*v13 = (__int64 *)v12, *(_QWORD *)(v12 + 8) = v13, v14 = (__int64 **)v36, (_QWORD **)*v36 != &v35) )
    {
LABEL_29:
      __fastfail(3u);
    }
