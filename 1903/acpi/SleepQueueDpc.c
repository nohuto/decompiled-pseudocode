/*
 * XREFs of SleepQueueDpc @ 0x1C0066F50
 * Callers:
 *     <none>
 * Callees:
...
__int64 **SleepQueueDpc()
{
  ...
  v9 = &v8;
  v8 = (__int64 *)&v8;
  byte_1C0083128 = KeAcquireSpinLockRaiseToDpc(&gmutSleep);
...
LABEL_14:
  ...
  KeReleaseSpinLock(&gmutSleep, byte_1C0083128);
  while ( 1 )
  {
    v5 = v8;
    result = &v8;
    ...
    v8 = (__int64 *)*v8;
    v7[1] = (__int64)&v8;
    RestartContext((PSLIST_ENTRY)v5[3], (*(_DWORD *)(v5[3] + 64) & 0x100) == 0);
  }
}
