/*
 * XREFs of WPP_RECORDER_SF_qssdddd @ 0x1C00601E8
 * Callers:
        ...
        __int64 a8)
{
  ...
  if ( (HIDWORD(WPP_GLOBAL_Control->Timer) & 0x8000) != 0 && BYTE1(WPP_GLOBAL_Control->Timer) >= 4u )
  {
    ...
    pfnWppTraceMessage(
      ...
      43LL,
      &WPP_dce3ffa2f9ac319c4b032626ac70bc0b_Traceguids,
      18LL,
      &a6,
      8LL,
      v14);
  ...
  LOWORD(v17) = 18;
  return WppAutoLogTrace(a1, 4LL, 16LL, &WPP_dce3ffa2f9ac319c4b032626ac70bc0b_Traceguids, v17, &a6);
}
