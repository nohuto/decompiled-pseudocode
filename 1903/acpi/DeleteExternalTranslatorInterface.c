/*
 * XREFs of DeleteExternalTranslatorInterface @ 0x1C00AEF58
 * Callers:
 *     AcpiExternalInterfaceUnload @ 0x1C00AEAA0 (AcpiExternalInterfaceUnload.c)
 *     NotifyExternalTranslationInterfaceChange @ 0x1C00AF1D0 (NotifyExternalTranslationInterfaceChange.c)
 * Callees:
 *     <none>
 */
