/*
 * XREFs of AcpiSetupNativeMethodInterface @ 0x1C00A0B50
 * Callers:
    ...
    if ( AttachedDeviceReference )
    {
      ...
      *((_QWORD *)&OutputBuffer[5] + 1) = AcpiTranslatePepDeviceControlResources;
        ...
        && *((_QWORD *)&OutputBuffer[3] + 1) )
      {
        ...
        xmmword_1C0081BB0 = OutputBuffer[1];
        unk_1C0081BC0 = OutputBuffer[2];
        xmmword_1C0081BD0 = OutputBuffer[3];
        xmmword_1C0081BE0 = OutputBuffer[4];
        xmmword_1C0081BF0 = OutputBuffer[5];
