/*
 * XREFs of ACPIIrpSetPagableCompletionRoutineAndForward @ 0x1C009F02C
 * Callers:
 *     ACPIFilterIrpQueryInterface @ 0x1C00947C0 (ACPIFilterIrpQueryInterface.c)
 *     ACPIFilterIrpQueryPnpDeviceState @ 0x1C009F000 (ACPIFilterIrpQueryPnpDeviceState.c)
 *     ACPIFilterIrpQueryId @ 0x1C00A13C0 (ACPIFilterIrpQueryId.c)
 *     ACPIFilterIrpEject @ 0x1C00AF210 (ACPIFilterIrpEject.c)
 *     ACPIFilterIrpSetLock @ 0x1C00AF460 (ACPIFilterIrpSetLock.c)
 * Callees:
