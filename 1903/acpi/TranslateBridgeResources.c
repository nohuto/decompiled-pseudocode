/*
 * XREFs of TranslateBridgeResources @ 0x1C00B58D0
 * Callers:
 *     <none>
 * Callees:
 *     CmMemIoResourceUpdateType @ 0x1C0060458 (CmMemIoResourceUpdateType.c)
 *     FindTranslationRange @ 0x1C00B56B4 (FindTranslationRange.c)
 */
