/*
 * XREFs of ACPIWakeInitializePciDevice @ 0x1C002ABE8
 * Callers:
...
__int64 __fastcall ACPIWakeInitializePciDevice(ULONG_PTR a1)
{
  ...
  if ( (*(_DWORD *)(DeviceExtension + 8) & 0x10020) == 0x10000LL )
  {
    ...
    if ( PciPmeInterfaceInstantiated )
    {
      ...
      if ( v5 == 1 )
      {
        (*((void (__fastcall **)(_QWORD, char *))PciPmeInterface + 7))(*(_QWORD *)(DeviceExtension + 736), &v6);
        if ( v6 == 1 )
        {
          _InterlockedOr64((volatile signed __int64 *)(DeviceExtension + 8), 0x800000000000000uLL);
          if ( v7 )
          {
            (*((void (__fastcall **)(_QWORD, _QWORD))PciPmeInterface + 6))(*(_QWORD *)(DeviceExtension + 736), 0LL);
          }
          else if ( v4[0] )
          {
            (*((void (__fastcall **)(_QWORD))PciPmeInterface + 5))(*(_QWORD *)(DeviceExtension + 736));
          }
        }
      }
    }
