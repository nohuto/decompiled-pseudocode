/*
 * XREFs of AcpiDiagTraceRecordAmlEvaluationStatistics @ 0x1C0049BF8
 * Callers:
  ...
  if ( (_QWORD)v1 )
  {
    ...
    if ( (unsigned int)(*((_QWORD *)&v1 + 1) >> 11) >= 0x3E8 && hProvider > 5u )
    {
      ...
      if ( (_BYTE)v1 )
      {
        ...
        v11[1] = v4;
        v13 = 4LL;
        LOBYTE(v1) = TlgWrite((TraceLoggingHProvider)&hProvider, &unk_1C0072320, v2, (LPCGUID)v3, 5u, &pData);
      }
    }
  }
  return v1;
