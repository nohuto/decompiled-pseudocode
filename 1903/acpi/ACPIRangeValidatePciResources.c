/*
 * XREFs of ACPIRangeValidatePciResources @ 0x1C002A514
 * Callers:
        ...
        unsigned __int64 a3)
{
  ...
  unsigned __int64 MaximumAddress; // [rsp+50h] [rbp-28h] BYREF
  unsigned __int64 MinimumAddress; // [rsp+58h] [rbp-20h] BYREF
