/*
 * XREFs of ParseTerm @ 0x1C0017FB0
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall ParseTerm(__int64 a1, __int64 a2, unsigned int NameSpaceObjectNoLock)
{
  ...
  __int64 v28; // r10
  __int64 (__fastcall *v29)(__int64, __int64, _QWORD, __int64, _DWORD, __int64); // r11
  __int64 v30; // r14
  ...
  __int64 v155; // r9
  int v156; // ebx
  __int64 (__fastcall *v157)(__int64, __int64, _QWORD, __int64, _DWORD, __int64); // rax
  ...
  __int64 v165; // rcx
  _QWORD *v166; // rax
  __int64 v168; // [rsp+50h] [rbp-B0h]
  char pszDest; // [rsp+60h] [rbp-A0h] BYREF
  char v170; // [rsp+61h] [rbp-9Fh] BYREF
  char Src; // [rsp+160h] [rbp+60h] BYREF
  char v172; // [rsp+161h] [rbp+61h] BYREF
                ...
                else
                {
                  switch ( v92 )
                  {
                    ...
                    case 14:
                      ...
                      break;
                    case 5:
                      v158 = *(unsigned __int64 **)(v30 + 40LL * v32 + 32);
                      v159 = *v158;
                      if ( !*v158 )
                        goto LABEL_402;
                      goto LABEL_401;
                    case 9:
                      PerformMutexDriverCallbacks(1, *(_QWORD *)(v30 + 40LL * v32 + 32), 0LL, 0LL, 0);
                      HeapFree(*(_QWORD *)(v30 + 40LL * v32 + 32));
                      break;
                    case 130:
                      v158 = *(unsigned __int64 **)(v30 + 40LL * v32 + 32);
                    ...
                    case 132:
                      ...
                      {
LABEL_401:
                        DereferenceObjectEx(v159);
                        v158 = *(unsigned __int64 **)(v30 + 40LL * v32 + 32);
                      }
LABEL_402:
                      HeapFree((__int64)v158);
                      break;
                    default:
              ...
              ++v32;
              *(_QWORD *)(v30 + 8 * v33) = 0LL;
              *(_QWORD *)(v30 + 8 * v33 + 8) = 0LL;
              *(_QWORD *)(v30 + 8 * v33 + 16) = 0LL;
              *(_QWORD *)(v30 + 8 * v33 + 24) = 0LL;
          ...
          *v39 = v34;
          ...
          if ( v42 != j )
          {
            v91 = *((unsigned int *)v43 + 1);
            if ( v35 == (_QWORD *)((char *)v43 + v91) )
            {
              *((_DWORD *)v43 + 1) = *((_DWORD *)v35 + 1) + v91;
              v163 = *v34;
        ...
        *((_DWORD *)v48 - 4) = 0;
        ...
        if ( (_QWORD *)*v53 == v51 )
        {
          ...
          *v53 = v48;
          ...
          if ( (_QWORD *)*v48 != k )
          {
            v88 = *((unsigned int *)v49 + 1);
            if ( (_QWORD *)v55 == (_QWORD *)((char *)v49 + v88) )
            {
              *((_DWORD *)v49 + 1) = v88 + *(_DWORD *)(v55 + 4);
              v89 = *v54;
...
LABEL_39:
      ...
      if ( (gDebugger & 0xD0) != 0 && *(_DWORD *)(v3 + 76) )
        ConPrintf(")");
      v26 = *(__int64 (__fastcall **)(__int64, __int64, __int64, __int64))(*(_QWORD *)(v3 + 56) + 48LL);
      if ( v26 )
      {
        v27 = v26(v4, v3, v5, v6);
        NameSpaceObjectNoLock = v27;
        if ( v27 || v3 != *(_QWORD *)(v4 + 416) )
          return v27;
      }
    }
    ++*(_DWORD *)(v3 + 16);
    ...
    {
      v28 = *(_QWORD *)(v3 + 56);
      v29 = *(__int64 (__fastcall **)(__int64, __int64, _QWORD, __int64, _DWORD, __int64))(v28 + 32);
      if ( v29 )
      {
        if ( *(int *)(v28 + 28) >= 0 )
        {
      ...
      while ( 2 )
      {
        *(_DWORD *)(v3 + 72) = v11 + 1;
        ...
        if ( v15 == 67 )
        {
          ...
          while ( (__int64)v16 < (__int64)&qword_1C0082830 );
          if ( v17 != 10 )
          {
            a1 *= 2LL;
            if ( (dword_1C0082788[2 * a1] & 1) != 0 && v17 != -1 )
            {
              ConPrintf("\nHit Breakpoint %d.\n");
              AMLIDebugger(v153, v152, v154, v155);
              v10 = (__int64 **)(v4 + 120);
              v7 = 2;
              v6 = -1LL;
            }
          ...
          if ( !OpcodeTerm )
          {
            ...
            PrintDebugMessage(134, **(unsigned __int8 **)(v4 + 120), *(_QWORD *)(v4 + 120), 0, 0LL);
            v12 = -1072431103;
          ...
          if ( (v22 & 8) != 0 )
          {
            ...
            *(_QWORD *)(v4 + 120) = (char *)v21 + 1;
            NameSpaceObjectNoLock = 0;
            *(_WORD *)(v14 + 2) = 1;
            *(_QWORD *)(v14 + 16) = 0LL;
            if ( (_DWORD)a1 == 10 )
            {
              a1 = **(unsigned __int8 **)(v4 + 120);
              *(_BYTE *)(v14 + 16) = a1;
              ++*(_QWORD *)(v4 + 120);
              if ( (gDebugger & 0xD0) == 0 )
                goto LABEL_158;
            ...
            else
            {
              ...
              if ( (unsigned int)a1 > 0xE )
              {
                if ( (_DWORD)a1 != 255 )
                  goto LABEL_348;
                if ( (unsigned __int8)IsCompatableDSDTRevision(a1, (unsigned int)a1, v21, v6) )
                  v143 = -1LL;
                else
                  v143 = 0xFFFFFFFFLL;
                *(_QWORD *)(v14 + 16) = v143;
...
LABEL_348:
                  ...
                  LogError(3222536193LL);
                  AcpiDiagTraceAmlError(v4, 3222536193LL);
                  PrintDebugMessage(128, **(unsigned __int8 **)(v4 + 120), *(_QWORD *)(v4 + 120), 0, 0LL);
                  v12 = -1072431103;
                  NameSpaceObjectNoLock = -1072431103;
                  goto LABEL_30;
                }
...
LABEL_91:
          ...
          if ( (v22 & 0x10) != 0 )
          {
            v12 = ParseString(v4, v10, v14, 0LL);
          ...
          if ( (v22 & 4) != 0 )
          {
            v130 = *(_QWORD *)(v4 + 96)
                 + 8
                 * ((unsigned int)*(unsigned __int8 *)v21 - 96 + 4LL * ((unsigned int)*(unsigned __int8 *)v21 - 96) + 9);
            if ( v14 != v130 )
            {
          ...
          if ( (v22 & 0x20) == 0 )
          {
            ...
            {
              *v10 = (__int64 *)((char *)v21 + 1);
              v23 = HeapAlloc((struct _SLIST_ENTRY *)(v4 + 480), 1297237576, 0x60u);
              v24 = v23;
              if ( v23 )
              {
                *(_QWORD *)(v23 + 8) = *(_QWORD *)(v4 + 416);
                *(_QWORD *)(v4 + 416) = v23;
                ...
                *(_DWORD *)(v24 + 76) = v23;
                if ( !(_DWORD)v23 )
                  goto LABEL_29;
                v25 = (void *)HeapAlloc(*(struct _SLIST_ENTRY **)(v4 + 320), 1413563464, 40 * (int)v23);
                *(_QWORD *)(v24 + 80) = v25;
                if ( v25 )
                {
...
LABEL_30:
          ...
          if ( *(_BYTE *)v21 == 92 )
          {
            ...
            ++*(_QWORD *)(v4 + 120);
            v12 = ParseNameTail(v4, v4 + 120, &Src);
            NameSpaceObjectNoLock = v12;
            goto LABEL_122;
          }
          if ( *(_BYTE *)v21 == 94 )
...
LABEL_133:
                  ...
                  if ( *(_WORD *)(v85 + 66) == 8 )
                  {
                    NameSpaceObjectNoLock = PushCall((struct _SLIST_ENTRY *)v4, v85, v14);
                  }
                  else
                  {
                    NameSpaceObjectNoLock = 0;
                    ...
                    if ( v87 == 5 )
                    {
                      v119 = HeapAlloc((struct _SLIST_ENTRY *)(v4 + 480), 1297237576, 0x30u);
                      if ( v119 )
                      {
                        *(_QWORD *)(v119 + 8) = *(_QWORD *)(v4 + 416);
        ...
        switch ( v15 )
        {
          ...
          case 'N':
            ...
            if ( !v108 || (*(_DWORD *)(v108 + 28) & 0x20) == 0 )
            {
              LogError(3222536193LL);
              AcpiDiagTraceAmlError(v4, 3222536193LL);
              PrintDebugMessage(132, **(unsigned __int8 **)(v4 + 120), *(_QWORD *)(v4 + 120), 0, 0LL);
              v12 = -1072431103;
              goto LABEL_332;
            }
            if ( (_BYTE)v107 == 92 )
            {
              ...
              ++*(_QWORD *)(v4 + 120);
LABEL_283:
              v12 = ParseNameTail(v4, v4 + 120, &pszDest);
              NameSpaceObjectNoLock = v12;
              goto LABEL_207;
            }
            if ( (_BYTE)v107 == 94 )
...
LABEL_207:
            ...
            *(_DWORD *)(v14 + 24) = v116 + 1;
            v118 = (void *)HeapAlloc((struct _SLIST_ENTRY *)gpheapGlobal, 1381258056, (int)v116 + 1);
            *(_QWORD *)(v14 + 32) = v118;
            if ( v118 )
            {
...
LABEL_334:
              ...
              if ( (_DWORD)a1 == 255 )
              {
                v151 = IsCompatableDSDTRevision(a1, (unsigned int)a1, 1LL, -1LL);
                a1 = 0xFFFFFFFFLL;
                if ( v151 )
                  a1 = -1LL;
                *(_QWORD *)(v14 + 16) = a1;
...
LABEL_225:
              *v10 = (__int64 *)((char *)*v10 - 1);
              LOBYTE(v6) = 1;
              NameSpaceObjectNoLock = ParseString(v4, v10, v14, v6);
              v12 = NameSpaceObjectNoLock;
              v10 = (__int64 **)(v4 + 120);
              if ( NameSpaceObjectNoLock == -1072431103 )
              {
                ...
                {
                  v121 = PushTerm(v4, (unsigned int)*v10, v13, (unsigned int)*(&OpcodeTable + (unsigned __int8)a1), v14);
                  ++*(_QWORD *)(v4 + 120);
                  v10 = (__int64 **)(v4 + 120);
                  v12 = v121;
...
LABEL_33:
            ...
            continue;
          case 'S':
            v67 = ParseSuperName(v4, v14, 0LL);
            goto LABEL_83;
          case 'W':
            v67 = ParseInteger(v10, v14, 2LL);
LABEL_83:
            v12 = v67;
...
LABEL_38:
  ...
  if ( *(int *)(a2 + 28) >= 0 )
    goto LABEL_39;
  v157 = *(__int64 (__fastcall **)(__int64, __int64, _QWORD, __int64, _DWORD, __int64))(a2 + 32);
  if ( !v157 )
    goto LABEL_39;
  NameSpaceObjectNoLock = v157(
                            12LL,
                            1LL,
                            *(unsigned int *)(a2 + 8),
                            *(_QWORD *)(v3 + 64) + 120LL,
