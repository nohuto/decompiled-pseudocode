/*
 * XREFs of ACPISystemPowerQueryDeviceCapabilities @ 0x1C0097C44
 * Callers:
...
__int64 __fastcall ACPISystemPowerQueryDeviceCapabilities(_QWORD *BugCheckParameter2, __int64 a2)
{
  ...
  {
    DeviceCapabilities = ACPIInternalGetDeviceCapabilities(*(PDEVICE_OBJECT *)(BugCheckParameter2[93] + 720LL), v22);
  ...
  if ( DeviceCapabilities < 0 )
  {
    ...
    if ( (*v4 & 0x200000000000LL) != 0 )
    {
      v20 = (char *)BugCheckParameter2[70];
      if ( (v19 & 0x400000000000LL) != 0 )
        v21 = (char *)BugCheckParameter2[71];
    }
    if ( WPP_RECORDER_INITIALIZED != (_UNKNOWN *)&WPP_RECORDER_INITIALIZED )
    {
      WPP_RECORDER_SF_Lqss(
