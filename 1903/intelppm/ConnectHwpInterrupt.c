/*
 * XREFs of ConnectHwpInterrupt @ 0x1C00063E0
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall ConnectHwpInterrupt(__int64 a1)
{
  ...
  if ( v1 && (*(_DWORD *)(v1 + 4) & 0x1000) != 0 )
  {
    ...
    v3 = IsHgsInterruptSupported() && qword_1C001B670 && (unsigned __int8)qword_1C001B670();
    ...
    else if ( WPP_RECORDER_INITIALIZED != (_UNKNOWN *)&WPP_RECORDER_INITIALIZED )
    {
      ...
      WPP_RECORDER_SF_D(
        ...
        3u,
        0xEu,
        (__int64)&WPP_5c4a5938969437c9b8fe677855f8e151_Traceguids,
        v9);
    }
  }
  else
