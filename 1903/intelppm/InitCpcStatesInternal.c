 ...
 *     RegisterKernelCpc @ 0x1C00343F0 (RegisterKernelCpc.c)
 * Callees:
...
__int64 __fastcall InitCpcStatesInternal(__int64 a1, __int64 (__fastcall *a2)(_QWORD *, _QWORD))
{
  ...
  bool v124; // [rsp+62h] [rbp-9Eh]
  bool v125; // [rsp+63h] [rbp-9Dh]
  char v126; // [rsp+64h] [rbp-9Ch]
  char v127[3]; // [rsp+65h] [rbp-9Bh] BYREF
  int v128; // [rsp+68h] [rbp-98h]
  int v129; // [rsp+6Ch] [rbp-94h] BYREF
  unsigned int v130; // [rsp+70h] [rbp-90h]
  unsigned int v131; // [rsp+74h] [rbp-8Ch]
  int v132; // [rsp+78h] [rbp-88h]
  int v133; // [rsp+7Ch] [rbp-84h]
  int v134; // [rsp+80h] [rbp-80h]
  __int64 v135; // [rsp+88h] [rbp-78h]
  _QWORD v136[2]; // [rsp+90h] [rbp-70h] BYREF
  __int64 v137[4]; // [rsp+A0h] [rbp-60h] BYREF
  int v138; // [rsp+C0h] [rbp-40h] BYREF
  int PerfDomain; // [rsp+C4h] [rbp-3Ch]
  BOOL v140; // [rsp+C8h] [rbp-38h]
  int v141; // [rsp+CCh] [rbp-34h]
  int v142; // [rsp+D0h] [rbp-30h] BYREF
  _QWORD *v143; // [rsp+D8h] [rbp-28h]
  __int64 v144; // [rsp+E0h] [rbp-20h]
  __int64 v145; // [rsp+E8h] [rbp-18h] BYREF
  __int64 (__fastcall *v146)(__int64, unsigned int, unsigned int, unsigned int, int, int, int, _DWORD *, __int64); // [rsp+F0h] [rbp-10h] BYREF
  char *v147; // [rsp+F8h] [rbp-8h]
  int v148; // [rsp+100h] [rbp+0h] BYREF
  __int64 v149; // [rsp+108h] [rbp+8h] BYREF
  __int64 v150; // [rsp+110h] [rbp+10h] BYREF
  __int64 (__fastcall *v151)(_QWORD *, _QWORD); // [rsp+118h] [rbp+18h]
  struct _GROUP_AFFINITY Affinity; // [rsp+120h] [rbp+20h] BYREF
  struct _GROUP_AFFINITY PreviousAffinity; // [rsp+130h] [rbp+30h] BYREF
  _BYTE v154[176]; // [rsp+140h] [rbp+40h] BYREF
  _BYTE v155[176]; // [rsp+1F0h] [rbp+F0h] BYREF
  ...
  *(_QWORD *)&Affinity.Group = 0LL;
  ...
  memset(v154, 0, 0xA8uLL);
  memset(v155, 0, 0xA8uLL);
  v143 = 0LL;
  ...
  *(_QWORD *)&PreviousAffinity.Group = 0LL;
  ...
  PerfDomain = GetPerfDomain(a1, (__int64)v137, &v148);
...
LABEL_8:
  ...
  while ( !(unsigned int)EnumerateNextDevice((__int64)v137, &DeferredContext) )
  {
    if ( !*((_BYTE *)DeferredContext + 78) )
      KeAddProcessorAffinityEx(v154, *((unsigned int *)DeferredContext + 14));
  }
  LOBYTE(v11) = 0;
  v140 = v11;
  ResetEnumerationContext(v137);
  while ( !(unsigned int)EnumerateNextDevice((__int64)v137, &DeferredContext) )
  {
    if ( !*((_BYTE *)DeferredContext + 78) )
    {
      v135 = *((_QWORD *)DeferredContext + 72);
      if ( (int)GetPackageAffinity((__int64)DeferredContext, (__int64)v155) >= 0 )
        v140 = KeIsEqualAffinityEx(v155, v154) != 0;
      break;
    }
  }
  ResetEnumerationContext(v137);
  v14 = EnumerateNextDevice((__int64)v137, &DeferredContext);
  v16 = 10;
  if ( !v14 )
  {
    LOBYTE(v17) = v131;
    ...
    while ( 1 )
    {
      ...
      *v18 = IsSupported;
      ...
      v126 = CpcRegisterIsSupported(v20);
      ...
      while ( 1 )
      {
        ...
        v32 = v36;
        v39 = *(_BYTE *)(v35 + 3);
        *(_QWORD *)((char *)v136 + 4) = *(_QWORD *)(v35 + 4);
        BYTE3(v136[0]) = v39;
        LOBYTE(v136[0]) = v36;
LABEL_65:
        v31 = v34 + 1;
...
LABEL_67:
      ...
      {
        v41 = v136[1];
        *(_QWORD *)(v18 + 28) = v136[0];
        *((_DWORD *)v18 + 9) = v41;
      }
      if ( qword_1C001B550 )
      {
        v2 = (unsigned __int8)v2;
        if ( (int)qword_1C001B550(v18 - 92, &v145, &v149, &v150, &v146, v127, &v142, &v138) < 0 )
          v2 = 0;
      }
      v42 = 19LL;
...
LABEL_161:
    ...
    v76 = v71 + ((_BYTE)v128 != 0);
    v77 = (32 * PerfDomain + 447) & 0xFFFFFFF8;
    v131 = v77 + 24 * v76;
    v130 = v131 + 8 * PerfDomain * v76;
    v78 = v130;
    v79 = ExAllocatePoolWithTag(NonPagedPoolNx, v130, 0x72637250u);
    v143 = v79;
    v6 = v79;
    if ( !v79 )
      goto LABEL_8;
...
LABEL_192:
        ...
        *((_DWORD *)v6 + 8) = v92;
        ...
        {
          *((_BYTE *)v6 + 11) = 1;
          if ( (*(_QWORD *)(v80 + 264) & 0x400000000LL) == 0 || (v94 = 0, v127[0]) )
            v94 = 1;
          *((_BYTE *)v6 + 12) = v94;
          *((_DWORD *)v6 + 12) = v142;
          *((_DWORD *)v6 + 108) = v138;
        ...
        *((_DWORD *)v85 + 3) = 1;
        ...
        if ( !(unsigned int)EnumerateNextDevice((__int64)v137, &DeferredContext) )
        {
          ...
          do
          {
            ...
            {
              v105 = (char *)(v102 + 56);
              if ( *(_BYTE *)(v102 + 56) == 127 && !*((_BYTE *)DeferredContext + 78) )
              {
                KeProcessorGroupAffinity(&Affinity, *((unsigned int *)DeferredContext + 14));
              ...
              GenAddrMaybeHidden = ReadGenAddrMaybeHidden((__int64)v104, v105);
              v108 = *((_QWORD *)v75 - 2);
              if ( GenAddrMaybeHidden > v108 )
              {
              ...
              *((_QWORD *)v75 + 3) = GenAddrMaybeHidden;
              v109 = 100 * GenAddrMaybeHidden / v108;
              if ( (unsigned int)v109 > v103 )
                v103 = v109;
              *((_DWORD *)v75 + 13) = v103;
              if ( v103 != v104[181] )
                ProcLibCapChange(v144, v104[112], v104[124], v103);
            }
            InitCommonPerfStateContext((__int64)v104, (_QWORD *)v75 - 4, v101, v103, v103 < 0x64 ? 2 : 0);
            *v100 = v75 + 128;
            *((_QWORD *)v75 + 22) = GetCpcDifferentialFeedback;
            *((_QWORD *)v75 + 23) = v110;
            v111 = *(_BYTE *)(v110 + 153);
            if ( v111 < 0x40u )
              *((_QWORD *)v75 + 20) = (1LL << v111) - 1;
            v112 = *(_BYTE *)(v110 + 141);
            if ( v112 < 0x40u )
              *((_QWORD *)v75 + 21) = (1LL << v112) - 1;
            ++v100;
            if ( (_BYTE)v128 )
            {
              *v100++ = v75 + 192;
              *((_QWORD *)v75 + 30) = *((_QWORD *)v104 + 41);
            }
            v101 += 32LL;
            v75 += 368;
          }
        ...
        if ( v9 >= 0 )
        {
          ...
          if ( (*(_QWORD *)(v144 + 264) & 0x4000000000LL) != 0 )
          {
            ResetEnumerationContext(v137);
            while ( !(unsigned int)EnumerateNextDevice((__int64)v137, &DeferredContext) )
            {
...
LABEL_191:
  ...
  while ( 1 )
  {
    ...
    *(_QWORD *)(v53 - 60) = ReadGenAddrMaybeHidden((__int64)v55, v54 + 224);
    ...
    {
      v124 = ReadGenAddrMaybeHidden((__int64)v55, v54 + 188) != 0;
      v125 = v54[188] != 126;
    }
    if ( v53 - 100 == v13 )
      goto LABEL_144;
...
LABEL_144:
  ...
  if ( v120 )
  {
    if ( WPP_RECORDER_INITIALIZED != (_UNKNOWN *)&WPP_RECORDER_INITIALIZED )
    {
      WPP_RECORDER_SF_iii((__int64)WPP_GLOBAL_Control->DeviceExtension, v60, v61, v62, v114);
      v66 = *((_QWORD *)v13 + 3);
    }
    *(_QWORD *)(v53 - 76) = v66;
    goto LABEL_144;
