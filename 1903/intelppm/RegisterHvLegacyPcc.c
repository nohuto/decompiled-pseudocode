/*
 * XREFs of RegisterHvLegacyPcc @ 0x1C002F370
 * Callers:
 *     <none>
 * Callees:
 ...
 *     DecodeDoorbellAddressIo @ 0x1C002FDDC (DecodeDoorbellAddressIo.c)
 */
...
__int64 __fastcall RegisterHvLegacyPcc(__int64 a1)
{
  ...
  v18 = dword_1C001B830;
  v15 = 0LL;
  if ( (unsigned __int8)qword_1C001B828 <= 1u )
  {
    v4 = qword_1C001B820;
    v5 = qword_1C001B818;
    if ( (_BYTE)qword_1C001B828 == 1 )
    {
  ...
  if ( v9 >= 0 )
  {
    HIDWORD(v21[0]) = dword_1C001B7D8;
    v21[2] = qword_1C001B808;
    LODWORD(v21[3]) = dword_1C001B810;
    v21[6] = v5 << v3;
    v21[5] = v4 << v3;
    ...
    {
      v21[8] = **(_QWORD **)(v14 + 568);
      HIDWORD(v19[0]) = *(_DWORD *)(v14 + 48);
      v19[3] = v21;
      if ( qword_1C001B608 )
        v11 = qword_1C001B608(v19);
      else
        v11 = -1073741822;
      if ( v11 < 0 )
      {
