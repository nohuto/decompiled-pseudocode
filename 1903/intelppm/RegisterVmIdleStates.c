/*
 * XREFs of RegisterVmIdleStates @ 0x1C002FD0C
 * Callers:
 *     RegisterGuestIdleStates @ 0x1C002EB30 (RegisterGuestIdleStates.c)
 *     RegisterHvPepIdleStatesV2 @ 0x1C002F7A4 (RegisterHvPepIdleStatesV2.c)
 * Callees:
