/*
 * XREFs of AcpiParseProcessorContainer @ 0x1C00318E4
 * Callers:
 *     AcpiGetCoordinatedLpiStates @ 0x1C0030CAC (AcpiGetCoordinatedLpiStates.c)
 * Callees:
 *     memset @ 0x1C00046C0 (memset.c)
 *     GetDevExtByAcpiId @ 0x1C0008288 (GetDevExtByAcpiId.c)
 *     RtlUnicodeStringCopyString @ 0x1C000BE28 (RtlUnicodeStringCopyString.c)
