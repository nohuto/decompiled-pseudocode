/*
 * XREFs of sub_1800B8BC0 @ 0x1800B8BC0
 * Callers:
 *     sub_1800B7BF0 @ 0x1800B7BF0 (sub_1800B7BF0.c)
 * Callees:
 *     memcpy @ 0x180125A84 (memcpy.c)
 *     ??2@YAPEAX_K@Z @ 0x180126108 (--2@YAPEAX_K@Z.c)
 *     ?_Xbad_alloc@std@@YAXXZ @ 0x1801275F2 (-_Xbad_alloc@std@@YAXXZ.c)
 */

_DWORD *__fastcall sub_1800B8BC0(__int64 a1, const void *a2, unsigned __int64 a3, int a4)
{
  _DWORD *result; // rax
  int v5; // ebp
