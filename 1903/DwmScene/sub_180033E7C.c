/*
 * XREFs of sub_180033E7C @ 0x180033E7C
 * Callers:
...
void __fastcall sub_180033E7C(__int64 a1)
{
  __int64 v2; // rdx
  __int64 v3; // rbx
  __int64 v4; // rbx
