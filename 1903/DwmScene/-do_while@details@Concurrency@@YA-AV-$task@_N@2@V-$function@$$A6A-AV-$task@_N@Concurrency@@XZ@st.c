/*
 * XREFs of ?do_while@details@Concurrency@@YA?AV?$task@_N@2@V?$function@$$A6A?AV?$task@_N@Concurrency@@XZ@std@@@Z @ 0x1800DE270
 * Callers:
...
_QWORD *__fastcall Concurrency::details::do_while(_QWORD *a1, _QWORD *a2, __int64 a3, __int64 *a4)
{
  ...
  v19 = -2LL;
  v20 = 0uLL;
  v6 = sub_18006CCE8(*a4, (__int64)a2);
  v20 = 0LL;
  v7 = *(_QWORD *)(v6 + 8);
  if ( v7 )
  ...
  LOBYTE(v17[0]) = 0;
  sub_18000E118(v17, 0x1CuLL, 0LL, "IPM_ResolveMultisampledInput");
  sub_1800F964C(v23, &v20, v17);
  ...
  *(_QWORD *)&v21 = a1[8];
  *((_QWORD *)&v21 + 1) = v11;
  sub_18006A210((_QWORD **)v20, (__int64)&v21, (__int64)&v22);
  *a2 = 0LL;
  a2[1] = 0LL;
  v12 = a1[9];
  if ( v12 )
