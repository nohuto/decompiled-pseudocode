/*
 * XREFs of sub_180124F80 @ 0x180124F80
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall sub_180124F80(__int64 a1, __int64 a2)
{
  ...
  if ( !v6 )
  {
    sub_1801247B4((__int64 **)(a1 + 96), (__int64)&v16, &v17);
    v8 = v16 + 40;
    if ( v16 + 40 != a2 )
    {
      v9 = *(_QWORD *)(v16 + 96);
