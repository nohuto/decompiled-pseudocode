/*
 * XREFs of sub_18007D5C0 @ 0x18007D5C0
 * Callers:
 ...
 *     sub_1800E2EDC @ 0x1800E2EDC (sub_1800E2EDC.c)
 *     sub_1800E2F38 @ 0x1800E2F38 (sub_1800E2F38.c)
...
__int64 __fastcall sub_18007D5C0(_QWORD *a1)
{
  __int64 v2; // rcx
  __int64 *v3; // rax
  ...
  *((_QWORD *)&v22 + 1) = v2;
  ...
  v28 = 0;
  v3 = sub_1800779BC((__int64)a1, &v40);
  ...
  v23 = *v3;
  v24 = v4;
  sub_180073974(v36, &v23, (__int64)&v27);
  ...
  *((_QWORD *)&v21 + 1) = v7;
  ...
  v31 = _mm_load_si128(xmmword_180144F90);
  LOBYTE(v30[0]) = 0;
  LOBYTE(v8) = 0;
  sub_18000E118(v30, 0x1BuLL, v8, "kSpectreRenderCB_BeginFrame");
  v9 = sub_1800779BC((__int64)a1, &v42);
  ...
  v25 = *v9;
  v26 = v10;
  sub_180073974(v35, &v25, (__int64)v30);
  ...
  sub_1800E9B4C(v32, &v32);
  v37 = 0LL;
  v38 = 0LL;
  sub_180078A58((__int64)a1, 0, (__int64)&v38, (__int64)&v37);
  sub_180074840(v35);
  sub_180115050(v46);
  v15 = (__int64 *)a1[89];
  for ( i = (__int64 *)a1[88]; i != v15; i += 2 )
  {
    ...
    v18 = sub_1800E2DD4(LocaleT);
    v44 = *(_OWORD *)v18;
    v45 = *(__m256i *)(v18 + 16);
    v19 = sub_1800E2DD4(a1 + 25);
    if ( (*(float *)v19 == -1.0
       && *(float *)(v19 + 4) == -1.0
       && *(_DWORD *)(v19 + 8) == 2
       && !*(_DWORD *)(v19 + 12)
      ...
      && (*(float *)&v45.m256i_i32[1] != -1.0
       ...
       || v45.m256i_i32[5]) )
    {
      sub_1800E2F38(a1 + 25, &v44);
    }
    sub_1800E31E0(a1 + 46, a1 + 25);
    sub_18007CBE4(a1, i);
  }
  sub_1800E2EDC(a1 + 25);
  sub_180074840(v36);
  return sub_180115050(v47);
}
