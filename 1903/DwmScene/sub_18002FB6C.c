...
__int64 **__fastcall sub_18002FB6C(__int64 a1, __int64 **a2, __int64 a3, __int16 a4, int a5)
{
  unsigned int v9; // eax
  int v10; // eax
  int v11; // eax
  ...
  if ( (a4 & 1) != 0 )
  {
    ...
    if ( v16 < 0 )
    {
      ...
      sub_18000E498(v31);
      v26 = (unsigned int)sub_18000E498(v30);
      sub_180065810((unsigned int)pExceptionObject, v26, 723, v16, (__int64)v31, 0);
      throw (Spectre::Engine::EngineException *)pExceptionObject;
    }
    v17 = sub_1800642F8(a1, v27);
    if ( *(_QWORD *)(v17 + 24) >= 0x10uLL )
      v17 = *(_QWORD *)v17;
    sub_18000EE28(v33, (const char *)v17);
    if ( v28 >= 0x10 )
    {
      v18 = v27[0];
      if ( v28 + 1 >= 0x1000 )
