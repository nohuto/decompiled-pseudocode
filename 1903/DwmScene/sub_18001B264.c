/*
 * XREFs of sub_18001B264 @ 0x18001B264
 * Callers:
...
__m128 __fastcall sub_18001B264(__m128 *a1, double a2, double a3, double a4)
{
  __m128 v4; // xmm0
  __m128 v5; // xmm13
  __m128 v6; // xmm14
  ...
  v15 = _mm_sub_ps(
          ...
          _mm_mul_ps(_mm_shuffle_ps(v13, _mm_shuffle_ps(v13, v14, 4), 147), _mm_shuffle_ps(v8, v8, 158)));
  ...
  if ( a1 )
    *a1 = v23;
  return _mm_mul_ps(_mm_div_ps((__m128)xmmword_180142E10, v23), v19);
}
