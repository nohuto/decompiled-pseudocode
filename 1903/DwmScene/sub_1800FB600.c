/*
 * XREFs of sub_1800FB600 @ 0x1800FB600
 * Callers:
...
__int64 __fastcall sub_1800FB600(__int64 *a1, __int64 a2, __int64 a3)
{
  __int64 v4; // rbx
  __int64 v6; // r15
  __int64 v7; // rdx
  ...
  v12 = sub_1800F656C((__int64)a1, v11);
  v13 = 3 * v6;
  ...
  *((_DWORD *)v12 + v13 + 2) = *(_DWORD *)(a3 + 8);
  ...
  sub_1800F62F4(a1, (__int64)v12, v8, v11);
  return *a1 + 4 * v13;
}
