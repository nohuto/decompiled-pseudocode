/*
 * XREFs of sub_1800FFC4C @ 0x1800FFC4C
 * Callers:
...
__int64 __fastcall sub_1800FFC4C(__int64 a1)
{
  __int64 v2; // rax
  __int64 v3; // rcx
  int *v4; // rax
  ...
  if ( *(_DWORD *)(a1 + 1960) )
  {
    ...
    *((_QWORD *)&v26 + 1) = v18;
    sub_1800B0F84(a1, (__int64 *)&v26);
    v29 = 0LL;
    sub_1800B0D54(a1, (__int64 *)&v29);
    sub_1800B1034(a1, *(_DWORD *)(a1 + 1928), 0);
    sub_1800B1034(a1, *(_DWORD *)(a1 + 1932), 1);
    sub_1800B1034(a1, *(_DWORD *)(a1 + 1936), 1);
    *(_BYTE *)(a1 + 465) |= 1u;
    v19 = *(_DWORD *)(a1 + 404);
    v20 = *(_DWORD *)(a1 + 408);
    v21[0] = *(_DWORD *)(a1 + 400);
    ...
    v30[2] = 0LL;
    v30[3] = 0LL;
    sub_18000F3F4(v30, (__int64)&qword_18025C0F8);
    result = sub_1800B1100(a1, v30, v21, -1);
    if ( v10 )
    {
  ...
  else
  {
    ...
    *((_QWORD *)&v25 + 1) = v8;
    sub_1800B0D54(a1, (__int64 *)&v25);
    sub_1800B1034(a1, *(_DWORD *)(a1 + 1928), 1);
    sub_1800B1034(a1, *(_DWORD *)(a1 + 1932), 0);
    result = sub_1800B1034(a1, *(_DWORD *)(a1 + 1936), 0);
    *(_BYTE *)(a1 + 465) &= ~1u;
  }
  return result;
}
