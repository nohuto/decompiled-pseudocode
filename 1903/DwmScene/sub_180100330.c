/*
 * XREFs of sub_180100330 @ 0x180100330
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall sub_180100330(__int64 a1)
{
  _QWORD *v2; // rax
  ...
  *(_BYTE *)(a1 + 465) |= 2u;
  ...
  if ( !*(_QWORD *)(a1 + 1896) )
  {
    ...
    v4 = (__int64 *)sub_18002BFD4(&Src, (_QWORD *)(a1 + 24), " ColorSampler");
    sub_1800644E4(*(_QWORD *)(a1 + 1896), v4);
  }
  return sub_180100F10(a1);
}
