...
__m128 __fastcall sub_180087ACC(double a1, double a2, double a3)
{
  __m128 v3; // xmm7
  __m128 v4; // xmm6
  __m128 v5; // xmm2
  ...
  if ( (_mm_movemask_ps(_mm_cmpeq_ps((__m128)0LL, *(__m128 *)&a2)) & 7) == 7 )
    wassert(
      ...
      0x7AAu);
  if ( (_mm_movemask_ps(_mm_cmpeq_ps(_mm_and_ps((__m128)xmmword_180142EB0, *(__m128 *)&a2), (__m128)xmmword_180142E90)) & 7) != 0 )
  ...
  if ( (_mm_movemask_ps(_mm_cmpeq_ps((__m128)0LL, *(__m128 *)&a3)) & 7) == 7 )
    wassert(
      ...
      L"d:\\os\\public\\amd64fre\\sdk\\inc\\DirectXMathMatrix.inl",
      0x7ACu);
  if ( (_mm_movemask_ps(_mm_cmpeq_ps(_mm_and_ps((__m128)xmmword_180142EB0, *(__m128 *)&a3), (__m128)xmmword_180142E90)) & 7) != 0 )
  ...
  v9 = _mm_sqrt_ps(v8);
  v10 = _mm_cmpneq_ps(v8, (__m128)xmmword_180142E90);
  v11 = _mm_or_ps(
          _mm_and_ps(_mm_and_ps(_mm_cmpneq_ps((__m128)0LL, v9), _mm_div_ps(v3, v9)), v10),
          _mm_andnot_ps(v10, (__m128)xmmword_180142EA0));
  ...
  v18 = _mm_sqrt_ps(v17);
  v19 = _mm_cmpneq_ps(v17, (__m128)xmmword_180142E90);
  v20 = _mm_or_ps(
          _mm_and_ps(_mm_and_ps(_mm_div_ps(v14, v18), _mm_cmpneq_ps((__m128)0LL, v18)), v19),
          _mm_andnot_ps(v19, (__m128)xmmword_180142EA0));
  ...
  return _mm_shuffle_ps(
           _mm_shuffle_ps(
             _mm_or_ps(
               _mm_andnot_ps((__m128)xmmword_180142F10, _mm_shuffle_ps(v21, v21, 0)),
               _mm_and_ps((__m128)xmmword_180142F10, v20)),
             _mm_or_ps(
               _mm_andnot_ps((__m128)xmmword_180142F10, _mm_shuffle_ps(v26, v26, 0)),
               _mm_and_ps((__m128)xmmword_180142F10, v25)),
             68),
           _mm_shuffle_ps(
             _mm_or_ps(
               _mm_andnot_ps((__m128)xmmword_180142F10, _mm_shuffle_ps(v12, v12, 0)),
               _mm_and_ps((__m128)xmmword_180142F10, v11)),
             (__m128)xmmword_180142DB0,
             68),
           136);
}
