/*
 * XREFs of sub_180106DA0 @ 0x180106DA0
 * Callers:
...
unsigned __int64 __fastcall sub_180106DA0(__int64 *a1, char *a2, _DWORD *a3, __int64 *a4)
{
  char *v6; // rbx
  ...
  v14 = (char *)sub_18000F5BC((__int64)a1, v13);
