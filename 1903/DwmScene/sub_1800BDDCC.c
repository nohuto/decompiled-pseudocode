/*
 * XREFs of sub_1800BDDCC @ 0x1800BDDCC
 * Callers:
...
__int64 __fastcall sub_1800BDDCC(__int64 a1, unsigned __int64 *a2)
{
  ...
  v38 = 7LL;
  LOWORD(v36[0]) = 0;
  sub_180026168((char *)v36, L"Camera.", 7uLL);
  v34 = 0LL;
  v35 = 7LL;
  LOWORD(v33[0]) = 0;
  sub_180026168((char *)v33, L"/Internal/Camera.", 0x11uLL);
...
LABEL_14:
  ...
  {
LABEL_16:
    v29 = _mm_load_si128((const __m128i *)&xmmword_18014AA40);
    LOWORD(v28[0]) = 0;
    v15 = v34;
    v16 = v34;
    if ( a2[2] < v34 )
    ...
    if ( a2[3] >= 8 )
      v17 = (void *)*a2;
    sub_180026168((char *)v28, v17, v16);
    v7 = 15;
    v18 = v33;
    if ( v35 >= 8 )
      v18 = (__int64 *)v33[0];
...
LABEL_31:
  ...
  if ( v10 )
  {
    ...
    sub_1800BB640((_QWORD *)(*(_QWORD *)a1 + 1488LL), (__int64)v28, a2);
    v26 = Mtx_unlock(v24);
    if ( v26 )
