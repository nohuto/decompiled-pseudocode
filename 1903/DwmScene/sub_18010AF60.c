/*
 * XREFs of sub_18010AF60 @ 0x18010AF60
 * Callers:
 *     <none>
 * Callees:
...
void __fastcall sub_18010AF60(__int64 a1, __int64 *a2, _QWORD *a3, __int64 *a4, unsigned __int64 *a5)
{
  const void **v9; // rax
  const void *v10; // rdx
  _QWORD *v11; // rax
  ...
  v27 = -2LL;
  v9 = sub_18002BFD4((const void **)&Src, (_QWORD *)(a1 + 24), " ");
  v10 = a5;
  if ( a5[3] >= 0x10 )
    v10 = (const void *)*a5;
  ...
  *(_BYTE *)v11 = 0;
  ...
  v31 = 0LL;
  v32 = 0LL;
  sub_1800AE8E0(a1, &v31, a2);
  sub_18006CCE8(*a2, v13);
  v35[0] = 0LL;
  v35[1] = 0LL;
  sub_1800F964C(v35, &v31, (__int64)&v36);
  memset(v24, 0, sizeof(v24));
  v14 = (__int64 *)(*(__int64 (__fastcall **)(_QWORD, char *))(*(_QWORD *)*a3 + 200LL))(*a3, v28);
  sub_180073974(v24, v14, (__int64)&v36);
  v15 = v29;
...
LABEL_33:
  ...
  v23 = *(_OWORD *)(a1 + 8);
  sub_180017164(&v33, (__int64 *)&v23);
  v18 = *(_QWORD *)(a1 + 112);
  for ( i = *(_QWORD *)(a1 + 104); i != v18; i += 48LL )
    sub_18009A9F0(*a4, &v31, 0LL, &v33);
