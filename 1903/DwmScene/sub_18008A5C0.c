/*
 * XREFs of sub_18008A5C0 @ 0x18008A5C0
 * Callers:
...
_QWORD *__fastcall sub_18008A5C0(_QWORD *a1, _QWORD *a2, __int64 *a3)
{
  __int64 v6; // rdx
  ...
  sub_1800634AC((__int64)(a1 + 2), (__int64)a2);
  v6 = a1[1];
  if ( !v6 )
  {
LABEL_15:
  ...
  *((_QWORD *)&v13 + 1) = v8;
  ...
  if ( v10 )
  {
    ...
    v14 = v13;
    v10 = (void *)sub_180081484(v11, &v14, *a3);
  }
  *a2 = 0LL;
  a2[1] = 0LL;
