...
__int64 __fastcall sub_180041D80(__int64 a1, __int64 *a2)
{
  __int64 v4; // rdx
...
LABEL_3:
  ...
  v6 = (unsigned int *)*a2;
  v25[0] = _mm_load_si128((const __m128i *)&xmmword_1801505E0);
  v25[1] = _mm_load_si128((const __m128i *)&xmmword_1801505C0);
  v26 = 4;
  v27 = 5;
  v28 = 16;
  *(_DWORD *)v34 = *((_DWORD *)v25 + *v6);
  si128 = _mm_load_si128((const __m128i *)&xmmword_1801505D0);
  v20 = 5;
