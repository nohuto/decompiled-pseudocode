/*
 * XREFs of sub_1800CCF98 @ 0x1800CCF98
 * Callers:
...
_QWORD *__fastcall sub_1800CCF98(__int64 *a1, _QWORD *a2)
{
  ...
  v6 = _std_type_info_hash(&qword_180260088);
  v7 = (__int64 *)*a1;
  v8 = *(__int64 **)(*a1 + 8);
  if ( *((_BYTE *)v8 + 25) )
    goto LABEL_10;
