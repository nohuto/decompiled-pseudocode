/*
 * XREFs of sub_180088558 @ 0x180088558
 * Callers:
...
__int64 __fastcall sub_180088558(_QWORD *a1, __int64 a2, unsigned __int8 *a3, __int64 *a4)
{
  __int64 v7; // rax
  ...
  {
    v24 = (_QWORD *)sub_18008D458(a1, v26, a4);
    sub_180088EFC(a1, &v28, *v24);
    throw;
  }
LABEL_23:
  try
