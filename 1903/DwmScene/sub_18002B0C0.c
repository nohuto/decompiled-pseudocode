/*
 * XREFs of sub_18002B0C0 @ 0x18002B0C0
 * Callers:
 *     <none>
 * Callees:
...
__int64 *__fastcall sub_18002B0C0(__int64 a1, __int64 *a2)
{
  int v4; // ebx
  char v5; // al
  __int64 v6; // rbx
  ...
  *a2 = 0LL;
  ...
  v10 = sub_180029B04(a1, &v19);
  sub_1800253B0(*v10, v8);
  v11 = v20;
  if ( v20 )
  {
  ...
  if ( v8 < 0 )
  {
    ...
    sub_18000E498(v23);
    v17 = (unsigned int)sub_18000E498(v22);
    sub_180065810((unsigned int)pExceptionObject, v17, 917, v8, (__int64)v23, 0);
