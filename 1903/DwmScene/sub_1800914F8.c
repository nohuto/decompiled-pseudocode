/*
 * XREFs of sub_1800914F8 @ 0x1800914F8
 * Callers:
...
__int64 __fastcall sub_1800914F8(__int64 a1, __int64 *a2, __int64 a3, __int128 *a4)
{
  __int64 v6; // rcx
  ...
  *(_QWORD *)(v6 + 8) = 0LL;
  *(_QWORD *)(v6 + 16) = 0LL;
  sub_180091224((void **)v6, &v14, (__int64)v15);
  v7 = a2[3];
  if ( v7 >= 0x10 )
  {
    v8 = v7 + 1;
