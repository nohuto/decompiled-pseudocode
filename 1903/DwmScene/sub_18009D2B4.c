/*
 * XREFs of sub_18009D2B4 @ 0x18009D2B4
 * Callers:
...
__int64 __fastcall sub_18009D2B4(__int64 a1, _QWORD *a2, __int64 a3, __int64 a4)
{
  int v6; // eax
  int v7; // edx
  __int64 v8; // rcx
    ...
    else
    {
      ...
      if ( v7 )
      {
        if ( v6 != *(_DWORD *)(a1 + 48) )
        {
          ...
          sub_18006575C(pExceptionObject, v18, 241LL, (__int64)v19, 0);
...
LABEL_13:
  ...
  else if ( v6 != *(_DWORD *)(a1 + 48) )
  {
    ...
    sub_18006575C(pExceptionObject, v17, 262LL, (__int64)v20, 0);
    throw (Spectre::Engine::EngineException *)pExceptionObject;
  }
  v10 = *a2;
  if ( *a2 )
...
LABEL_21:
        sub_18000E498(v19);
        v16 = sub_18000E498(v20);
        sub_18006575C(pExceptionObject, v16, 250LL, (__int64)v19, 0);
        throw (Spectre::Engine::EngineException *)pExceptionObject;
      }
      v10 = v13;
    }
