...
__int64 __fastcall sub_1800B33A4(__int64 **a1, __int64 a2, char a3, __int64 a4, _QWORD *a5)
{
  __int64 *v8; // rdx
  __int64 *v9; // rdi
  __int64 v10; // rax
  ...
  try
  {
    ...
    if ( v11 )
    {
      if ( v9 == (__int64 *)*v8 )
      {
        *(_QWORD *)a2 = *sub_1800B2F30(a1, &v19, 1, v9, a4, a5);
        *(_BYTE *)(a2 + 8) = 1;
        return a2;
      }
      sub_180020AB0(&v15);
    ...
    {
      *(_QWORD *)a2 = *sub_1800B2F30(a1, v20, v11, v9, a4, a5);
      *(_BYTE *)(a2 + 8) = 1;
      result = a2;
    }
  }
