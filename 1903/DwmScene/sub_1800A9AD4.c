/*
 * XREFs of sub_1800A9AD4 @ 0x1800A9AD4
 * Callers:
...
__int64 __fastcall sub_1800A9AD4(__int64 a1, __int64 *a2)
{
  __int64 v4; // rsi
  __int64 result; // rax
  __int64 v6; // r8
  ...
  {
    sub_18000E498(v29);
    v19 = sub_18000E498(v28);
    sub_180027770(pExceptionObject, v19, 278, (__int64)v29, 0);
    throw (Spectre::Engine::EngineInvalidArgException *)pExceptionObject;
  }
  v4 = (unsigned int)sub_180064228(*a2);
  std::shared_ptr<__ExceptionPtr>::operator=((_QWORD *)(a1 + 16 * (v4 + 6)), a2);
  result = get_srw_lock(*a2);
  if ( !*(_QWORD *)(result + 16) )
  {
    v7 = sub_1800A54FC(&v24, v4, v6);
    ...
    *(_BYTE *)v11 = 0;
    ...
    v23 = _mm_load_si128(xmmword_180144F90);
    Src_8.m128i_i8[0] = 0;
    ...
    v25 = _mm_load_si128(xmmword_180144F90);
    LOBYTE(v24) = 0;
    result = sub_1800F3410(*a2, &v31);
