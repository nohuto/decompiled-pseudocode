/*
 * XREFs of sub_180034FB0 @ 0x180034FB0
 * Callers:
 *     <none>
 * Callees:
...
char __fastcall sub_180034FB0(__int64 a1, _QWORD *a2, __int64 a3, unsigned int a4)
{
  __int64 v4; // r15
  char v5; // r14
  __int64 *v6; // rcx
  ...
  if ( *a2 )
  {
    v6 = (__int64 *)sub_18009EB64(*a2, v60, *(unsigned int *)(a1 + 88));
    v7 = 1;
    v8 = *v6;
  }
  else
  ...
  *v6 = 0LL;
  ...
  if ( (unsigned int)sub_18009EBD8(v8) == 1 )
  {
    v11 = *sub_18003167C(v8, &v41);
    v43 = v11;
    v12 = v41;
    if ( !v41 )
      goto LABEL_20;
...
LABEL_20:
  ...
  *(_OWORD *)&v38[1] = 0LL;
  ...
  sub_1800253B0(v39, v13);
  if ( v13 < 0 )
  {
    sub_18011D988(&unk_1802580F8, 3LL, "Failed to read Texture with HRESULT error 0x%.8x", v13);
    v5 = 0;
  }
  else
  {
    v17 = sub_18009EB80(v8);
    v50[0] = 0;
    v50[1] = 4;
    v50[2] = 4;
    v50[3] = 4;
    ...
    v58 = 2;
    v18 = v50[v17];
    v19 = (unsigned int)sub_18009EB80(v8);
    v62[0] = 0;
    v62[1] = 1;
    v20 = &v63;
    for ( i = 20LL; i; --i )
    ...
    v66 = 1;
    v22 = v62[v19];
    v23 = v18 * sub_18009EC10(v8);
    v35 = v23 * sub_18009EB9C(v8);
    LODWORD(v38[0]) = v68;
    v37 = v69;
    v24 = v68;
    if ( v68 > v23 )
    ...
    v48 = v24;
    v46 = v67;
    v25 = sub_18009EB9C(v8);
    v34 = (v22 + v25 - 1) / v22;
    v26 = sub_18009EB48(v8, (v22 + v25 - 1) % v22);
    v33 = v26;
    v27 = 0;
    if ( v26 )
    {
