/*
 * XREFs of sub_18011ECFC @ 0x18011ECFC
 * Callers:
 *     sub_180122C20 @ 0x180122C20 (sub_180122C20.c)
 * Callees:
 ...
 *     sub_1801245B4 @ 0x1801245B4 (sub_1801245B4.c)
 *     sub_1801246AC @ 0x1801246AC (sub_1801246AC.c)
 *     ?IsContext@WorkItem@details@Concurrency@@QEBA_NXZ @ 0x18012472C (-IsContext@WorkItem@details@Concurrency@@QEBA_NXZ.c)
...
__int64 __fastcall sub_18011ECFC(__int64 a1, _QWORD *a2, int a3, int a4)
{
  ...
  sub_1801219EC(a1 + 144, v18, v28);
  v11 = v18[0] + 64;
  v12 = a2;
  if ( a2[3] >= 8uLL )
    v12 = (_QWORD *)*a2;
  if ( (unsigned __int8)sub_1801246AC(v18[0] + 64, v12) )
  {
    v10 = 2;
    if ( a4 == 2 )
    {
    ...
    else
    {
      v22 = 0LL;
      v23 = 0LL;
      sub_18001110C(v21, (__int64)a2);
      v13 = (Concurrency::details::WorkItem *)sub_180124548(v11, v21);
      if ( (unsigned __int8)sub_180124734(v13) )
      {
        si128 = _mm_load_si128((const __m128i *)&xmmword_18014AA40);
        LOWORD(v26[0]) = 0;
        sub_180026168((char *)v26, L"Value", 5uLL);
        v14 = v26;
        ...
        if ( (unsigned __int8)sub_1801246AC(v13, v14)
          && (v19 = 0LL,
              v20 = 0LL,
              sub_18001110C(v18, (__int64)v26),
              v15 = (Concurrency::details::WorkItem *)sub_180124548(v13, v18),
              Concurrency::details::WorkItem::IsContext(v15)) )
        {
          if ( (unsigned int)sub_1801245B4(v15) != a3 )
          {
            v19 = 0LL;
            v20 = 0LL;
            sub_18001110C(v18, (__int64)v26);
            sub_18011EC3C((__int64)v13, v18, a3);
            v10 = 1;
          }
        }
        else
      ...
      {
        if ( (unsigned int)sub_1801245B4(v13) != a3 )
        {
          v22 = 0LL;
          v23 = 0LL;
          sub_18001110C(v21, (__int64)a2);
          sub_18011EC3C(v11, v21, a3);
          v10 = 1;
        }
      }
      else
