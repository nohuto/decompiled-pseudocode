/*
 * XREFs of sub_180097AF4 @ 0x180097AF4
 * Callers:
 ...
 *     sub_1800982F0 @ 0x1800982F0 (sub_1800982F0.c)
 *     sub_180098560 @ 0x180098560 (sub_180098560.c)
 *     sub_18009C02C @ 0x18009C02C (sub_18009C02C.c)
 *     j_j__o_free @ 0x180125F84 (j_j__o_free.c)
 */

unsigned __int64 __fastcall sub_180097AF4(__int64 *a1, __int64 a2, __int64 a3)
{
  __int64 v3; // r12
  __int64 v5; // rdi
  __int64 v6; // rbp
...
LABEL_27:
  ...
  {
    v16 = a2 + 88 * v9;
    result = sub_180097CF0(a2, v16, v5, 0LL);
    v15 = a1[1];
    while ( v16 != a3 )
    {
      result = sub_1800982F0(v15, v16);
      v15 += 88LL;
      v16 += 88LL;
    }
    goto LABEL_27;
  ...
  v17 = v5 + 88 * v8;
  result = sub_180097CF0(a2, a3, v5, 0LL);
  v18 = a1[1];
