/*
 * XREFs of sub_18010D080 @ 0x18010D080
 * Callers:
 ...
 *     sub_1800B890C @ 0x1800B890C (sub_1800B890C.c)
 *     __security_check_cookie @ 0x180126090 (__security_check_cookie.c)
 *     _guard_dispatch_icall_nop @ 0x180127630 (_guard_dispatch_icall_nop.c)
 */

// Hidden C++ exception states: #wind=3
_QWORD *__fastcall sub_18010D080(_QWORD *a1, __int64 a2, __int64 a3)
{
  float v5; // xmm6_4
  float v6; // xmm7_4
  float v7; // xmm8_4
  ...
  *a1 = 0LL;
  a1[1] = 0LL;
  v5 = *(float *)&xmmword_18025E020;
  v6 = *((float *)&xmmword_18025E020 + 1);
  v7 = *((float *)&xmmword_18025E020 + 2);
  v8 = *((float *)&xmmword_18025E020 + 3);
  v9 = *(__int64 **)a2;
  if ( *(_QWORD *)a2 == *(_QWORD *)(a2 + 8) )
  {
    v10 = *(_OWORD **)(a3 + 64);
    v10[12] = xmmword_18026B270;
    v10[13] = xmmword_18026B270;
    v10[14] = xmmword_18026B270;
    v10[15] = xmmword_18026B270;
    v10[16] = xmmword_18026B270;
    v10[17] = xmmword_18026B270;
    v10[18] = xmmword_18026B270;
    v10[19] = xmmword_18026B270;
    v10[20] = xmmword_18026B270;
  }
  else
  {
    ...
    sub_180087340(v14);
    v22 = *(__m128 *)(v14 + 156);
    v18 = (__m128 *)sub_1800B890C(v25[0], &v23);
    v19 = sub_180081E98(&v24, v18, &v22);
    v5 = v19->m128_f32[0];
    v6 = v19->m128_f32[1];
    v7 = v19->m128_f32[2];
    v8 = v19->m128_f32[3];
