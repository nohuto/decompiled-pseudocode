/*
 * XREFs of sub_18011C720 @ 0x18011C720
 * Callers:
 *     <none>
 * Callees:
...
void __fastcall sub_18011C720(__int64 a1, _BYTE *a2, __int64 a3, __int64 a4, void *a5, void *a6, char a7)
{
  __int64 v7; // rax
  void *v8; // rcx
  bool v9; // zf
  ...
  if ( (unsigned int)dword_18025DE98 > 5 )
  {
    ...
    v28 = &a7;
    v29 = 4LL;
    sub_180001128((__int64)&dword_18025DE98, (unsigned __int8 *)dword_180224CCA, 0LL, 0LL, 8u, &v14);
  }
}
