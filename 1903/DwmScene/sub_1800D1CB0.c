/*
 * XREFs of sub_1800D1CB0 @ 0x1800D1CB0
 * Callers:
...
__int64 __fastcall sub_1800D1CB0(__int64 a1, __int64 a2, _QWORD *a3)
{
  __int64 v6; // rdx
  ...
  *(_QWORD *)(a1 + 168) = v6;
  ...
  if ( sub_180064320(a1, 1) )
  {
    v8 = sub_1800642F0(a1);
    v17 = 0LL;
    v18 = 0LL;
    v19 = 0LL;
    sub_18007B178(v8, &v17);
    v9 = 0;
    v10 = v17;
    if ( (v18 - v17) >> 4 )
    {
