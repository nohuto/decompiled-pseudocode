/*
 * XREFs of sub_1800F1298 @ 0x1800F1298
 * Callers:
...
__int64 __fastcall sub_1800F1298(_QWORD *a1, __int64 a2, __int64 a3)
{
  __int64 v5; // r12
  __int64 v6; // rdx
  ...
  *(_DWORD *)(v13 + 32) = *(_DWORD *)(a3 + 32);
  ...
  if ( a2 != v17 )
  {
    sub_1800F1810(v20, a2, v11, a1, v10, v23, v11, -2LL);
    v18 = a1;
    v19 = v14;
    v17 = a1[1];
    v20 = a2;
  }
  sub_1800F1810(v20, v17, v19, v18, v22, v23, v24, v25);
  sub_1800F39AC(a1, v11, v7, v10);
  return *a1 + 8 * v12;
}
