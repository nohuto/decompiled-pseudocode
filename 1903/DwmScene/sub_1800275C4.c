/*
 * XREFs of sub_1800275C4 @ 0x1800275C4
 * Callers:
...
__int64 __fastcall sub_1800275C4(__int64 **a1, __int64 a2, unsigned int *a3)
{
  __int64 *v3; // rbx
  __int64 v6; // rax
  unsigned int v7; // edx
...
LABEL_10:
    v11 = a3;
    v8 = sub_1800268D0((__int64)a1, (__int64)&unk_18014AA83, &v11);
    sub_1800270C4(a1, &v10, v3, (unsigned int *)(v8 + 32), (_QWORD *)v8);
    *(_QWORD *)a2 = v10;
    *(_BYTE *)(a2 + 8) = 1;
  }
  else
