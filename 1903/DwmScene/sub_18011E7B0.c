/*
 * XREFs of sub_18011E7B0 @ 0x18011E7B0
 * Callers:
 ...
 *     _o_floor @ 0x180125A48 (_o_floor.c)
...
__int64 __fastcall sub_18011E7B0(__int64 a1)
{
  int v2; // eax
  __int64 v3; // r14
  __int64 v4; // rsi
  ...
  LOBYTE(v27) = v28;
  sub_18011E310((__int64 *)a1, *(__int64 **)(a1 + 8), *(char **)(a1 + 24), *(char **)(a1 + 32));
  v3 = *(_QWORD *)(a1 + 32);
  v4 = *(_QWORD *)(a1 + 24);
  if ( v4 != v3 )
  {
...
LABEL_47:
    ...
    if ( v38 == *((_QWORD *)&v37 + 1) )
    {
      sub_18000FBE0((char **)&v37, *((char **)&v37 + 1), &v29);
    }
    else
    {
      **((_QWORD **)&v37 + 1) = 0LL;
...
LABEL_37:
  ...
  {
    v24 = *(__int64 **)(a1 + 8);
    v25 = sub_18011E734(&v35, *(__int64 **)a1, v24, j);
    sub_18011EB44(a1, v36, *v25, v24, v27);
  }
  return sub_180011388((__int64 *)&v37);
}
