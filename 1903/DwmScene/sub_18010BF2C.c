/*
 * XREFs of sub_18010BF2C @ 0x18010BF2C
 * Callers:
...
__int64 *__fastcall sub_18010BF2C(__int64 *a1, __int64 *a2)
{
  __int64 *v4; // rdi
  __int64 *v5; // r15
  __int64 *v6; // r12
  ...
  if ( a1 != a2 )
  {
    ...
    if ( a1 + 2 != a2 )
    {
      ...
      do
      {
        ...
        *v4 = 0LL;
        v5[3] = 0LL;
        if ( (unsigned __int8)sub_18010C450(v17, &v14, a1) )
        {
