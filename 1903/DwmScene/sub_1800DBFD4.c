/*
 * XREFs of sub_1800DBFD4 @ 0x1800DBFD4
 * Callers:
...
_QWORD *__fastcall sub_1800DBFD4(__int64 a1, _QWORD *a2, __int64 *a3, __int64 a4, _QWORD *a5)
{
  __int64 v9; // rax
  __int64 v10; // rbx
  ...
  {
    v9 = sub_18006CD84(*a3);
    v10 = sub_180078118(v9);
    si128 = _mm_load_si128(xmmword_180144F90);
    LOBYTE(v26[0]) = 0;
    sub_18000E118(v26, 0x17uLL, 0LL, "Global/PlanarReflection");
    v11 = sub_1800A4004(v10, (__int64)v26);
    ...
    v13 = sub_1800A40C0(v10, &v31);
    v14 = (__int64 *)sub_1800F5820(*v13, v29, v11);
  ...
  *(_QWORD *)&v24 = *a5;
  *((_QWORD *)&v24 + 1) = v19;
  v20 = sub_1800DBE50(a1, &v33, *a3, a4, &v24);
