/*
 * XREFs of sub_1800311C4 @ 0x1800311C4
 * Callers:
...
_QWORD *__fastcall sub_1800311C4(_QWORD *a1, _QWORD *a2, int a3, int a4)
{
  char v8; // bl
  int v9; // ecx
  int v10; // edx
  ...
  if ( !a1[23] )
  {
    ...
    if ( v18 < 0 )
    {
      ...
      sub_18000E498(v36);
      v31 = (unsigned int)sub_18000E498(v35);
      sub_180065810((unsigned int)pExceptionObject, v31, 929, v18, (__int64)v36, 0);
