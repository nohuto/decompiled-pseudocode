/*
 * XREFs of sub_1800B26C4 @ 0x1800B26C4
 * Callers:
...
__int64 __fastcall sub_1800B26C4(float *a1, float *a2, float a3)
{
  float v3; // xmm0_4
  float v4; // xmm0_4
  __int64 result; // rax
  ...
  if ( !a1 )
    wassert(L"pSin", L"d:\\os\\public\\amd64fre\\sdk\\inc\\DirectXMathMisc.inl", 0x90Eu);
  if ( !a2 )
    wassert(L"pCos", L"d:\\os\\public\\amd64fre\\sdk\\inc\\DirectXMathMisc.inl", 0x90Fu);
  v3 = a3 * 0.15915494;
  if ( a3 < 0.0 )
    v4 = v3 - 0.5;
  else
