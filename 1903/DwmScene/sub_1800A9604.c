/*
 * XREFs of sub_1800A9604 @ 0x1800A9604
 * Callers:
...
__int64 __fastcall sub_1800A9604(__int64 a1)
{
  _QWORD *v2; // rdi
  _QWORD *v3; // rsi
  __int64 v4; // rbx
...
LABEL_30:
  ...
  sub_1800AA1DC(v34, v32, *(_QWORD *)v34[0], v34[0], v28);
