/*
 * XREFs of sub_18000DAE0 @ 0x18000DAE0
 * Callers:
...
_QWORD *__fastcall sub_18000DAE0(__int64 *a1, _QWORD *a2)
{
  ...
  v6 = _std_type_info_hash(&qword_18025E760);
  v7 = (__int64 *)*a1;
  v8 = *(__int64 **)(*a1 + 8);
  if ( *((_BYTE *)v8 + 25) )
    goto LABEL_10;
