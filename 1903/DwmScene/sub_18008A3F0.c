/*
 * XREFs of sub_18008A3F0 @ 0x18008A3F0
 * Callers:
...
__int64 __fastcall sub_18008A3F0(_DWORD *a1, unsigned __int64 *a2, unsigned __int64 *a3)
{
  __m128 v3; // xmm8
  __m128 v4; // xmm6
  __m128 v5; // xmm7
  ...
  v10 = _mm_mul_ps(_mm_add_ps(v8, v7), (__m128)xmmword_180145450);
  if ( !a1 )
  ...
  *a1 = v10.m128_i32[0];
  ...
  v11 = _mm_mul_ps(_mm_sub_ps(v8, v7), (__m128)xmmword_180145450);
