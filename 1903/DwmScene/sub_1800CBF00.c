/*
 * XREFs of sub_1800CBF00 @ 0x1800CBF00
 * Callers:
...
__int64 __fastcall sub_1800CBF00(__int64 a1, __int64 *a2)
{
  __int64 result; // rax
  unsigned int v5; // edi
  __int64 **v6; // r14
...
LABEL_9:
    ...
    if ( v7 == *v6 )
    {
      ...
      *((_QWORD *)&v14 + 1) = v10;
      ...
      v17 = v5;
      sub_1800CBD78((__int64 **)(a1 + 128), (__int64)&v16, &v17);
