/*
 * XREFs of sub_1800AA59C @ 0x1800AA59C
 * Callers:
...
void __fastcall sub_1800AA59C(__int64 **a1, unsigned __int64 *a2, __int64 a3)
{
  __int64 *v3; // rbx
  __int64 *v4; // r12
  ...
  if ( v5 > v7 )
  {
    ...
    if ( v5 <= 0x7FFFFFFFFFFFFFFLL )
    {
      ...
      *a1 = 0LL;
      ...
      if ( v5 <= 0x7FFFFFFFFFFFFFFLL )
      {
        v15 = sub_180031D3C((__int64)a1, v5);
        *a1 = v15;
        a1[1] = v15;
        a1[2] = &(*a1)[4 * v5];
LABEL_18:
    ...
    if ( a2 != (unsigned __int64 *)v18 )
    {
      do
      {
        if ( v3 != (__int64 *)v9 )
        {
          ...
          if ( v9[3] >= 8 )
            v19 = (void *)*v9;
          sub_180026168((char *)v3, v19, v9[2]);
        }
        v3 += 4;
        v9 += 4;
      }
  ...
  if ( a2 != (unsigned __int64 *)a3 )
  {
    do
    {
      if ( v3 != (__int64 *)v9 )
      {
        ...
        if ( v9[3] >= 8 )
          v21 = (void *)*v9;
        sub_180026168((char *)v3, v21, v9[2]);
      }
      v3 += 4;
      v9 += 4;
    }
