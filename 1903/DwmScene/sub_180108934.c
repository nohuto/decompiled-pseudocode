/*
 * XREFs of sub_180108934 @ 0x180108934
 * Callers:
 *     sub_180109108 @ 0x180109108 (sub_180109108.c)
 *     sub_18010A120 @ 0x18010A120 (sub_18010A120.c)
 * Callees:
 *     sub_180108548 @ 0x180108548 (sub_180108548.c)
 *     memcmp @ 0x180125AA8 (memcmp.c)
 */

__int64 __fastcall sub_180108934(_QWORD *a1, __int64 a2, char a3, size_t *a4, _QWORD *a5)
{
  _QWORD *v8; // r13
  __int64 *v9; // rbx
  ...
  try
  {
    *(_QWORD *)a2 = *sub_180108548(a1, &v25, v10, v8, (int)a4, v25);
    *(_BYTE *)(a2 + 8) = 1;
    result = a2;
  }
  catch ( ... )
  {
    sub_18010A37C(v27, v26);
    throw;
  }
  return result;
}
