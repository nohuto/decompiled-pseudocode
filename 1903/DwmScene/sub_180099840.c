/*
 * XREFs of sub_180099840 @ 0x180099840
 * Callers:
...
__int128 *__fastcall sub_180099840(unsigned __int64 *a1, _DWORD *a2)
{
  _DWORD *v2; // rbx
  __m128 v3; // xmm8
  ...
  do
  {
    result = xmmword_180142CC0;
    v7 = _mm_add_ps(_mm_mul_ps((__m128)xmmword_180142CC0[v4], v5), v3);
    if ( !v2 )
