/*
 * XREFs of sub_1800A713C @ 0x1800A713C
 * Callers:
...
__int64 __fastcall sub_1800A713C(__int64 **a1, __int64 a2, char a3, _QWORD *a4, char a5)
{
  __int64 *v8; // rdx
  __int64 *v9; // rdi
  __int64 v10; // rax
  ...
  try
  {
    ...
    if ( v11 )
    {
      if ( v9 == (__int64 *)*v8 )
      {
        *(_QWORD *)a2 = *sub_1800A6B4C(a1, v15, 1, v9, a4);
        *(_BYTE *)(a2 + 8) = 1;
        return a2;
      }
      sub_180020AB0(v15);
    ...
    {
      *(_QWORD *)a2 = *sub_1800A6B4C(a1, v15, v11, v9, a4);
      *(_BYTE *)(a2 + 8) = 1;
    }
    result = a2;
  }
