/*
 * XREFs of sub_18011D4A4 @ 0x18011D4A4
 * Callers:
...
__int64 __fastcall sub_18011D4A4(__int64 a1, int a2, __int64 a3)
{
  ...
  v18[1] = -2LL;
  v19 = 0LL;
  *(_QWORD *)&v19 = sub_18006DE14();
  v6 = (struct _Mtx_internal_imp_t *)sub_18011D1A4();
  v21 = v6;
  v7 = Mtx_lock(v6);
  if ( v7 )
  ...
  sub_18011D120();
  sub_18011CA1C(v20);
  sub_18011CF88(&v19, v20);
  sub_18006E244(v20, v18, *(_QWORD **)v20[0], v20[0]);
  j_j__o_free(v20[0]);
  v8 = Mtx_unlock(v6);
  if ( v8 )
  ...
  {
LABEL_21:
    sub_18006E244((_QWORD **)&v19, v18, (_QWORD *)*v9, v9);
