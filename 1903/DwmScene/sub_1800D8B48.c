/*
 * XREFs of sub_1800D8B48 @ 0x1800D8B48
 * Callers:
...
__int64 *__fastcall sub_1800D8B48(__int64 a1, __int64 a2, _QWORD *a3)
{
  __int64 v5; // rax
  __int64 v6; // r13
  __int64 ***v7; // r12
  ...
  *(_QWORD *)(a1 + 208) = v5;
  v75[1] = 0LL;
  v7 = (__int64 ***)(a3 + 17);
  sub_1800A618C(a3 + 17, &v75[1], (size_t *)&Buf2);
  ...
  if ( dword_18026AB18 > *(_DWORD *)(v10 + 44) )
  {
    Init_thread_header(&dword_18026AB18);
    if ( dword_18026AB18 == -1 )
    {
      v80 = 15LL;
      LOBYTE(v78) = 0;
      v79 = 5LL;
      ...
      BYTE5(v78) = 0;
      sub_1800D88A0(&qword_18026AAF0, (__int64 *)&v78);
      if ( v80 >= 0x10 )
      {
        v72 = v78;
        if ( v80 + 1 >= 0x1000 )
      ...
      atexit(sub_18013A790);
      Init_thread_footer(&dword_18026AB18);
    }
  }
  if ( dword_18026AB48 > *(_DWORD *)(v10 + 44) )
  {
    Init_thread_header(&dword_18026AB48);
    if ( dword_18026AB48 == -1 )
    {
      v80 = 15LL;
      LOBYTE(v78) = 0;
      v79 = 5LL;
      ...
      BYTE5(v78) = 0;
      sub_1800D88A0(&qword_18026AB20, (__int64 *)&v78);
      if ( v80 >= 0x10 )
      {
        v73 = v78;
        if ( v80 + 1 >= 0x1000 )
      ...
      atexit(sub_18013A800);
      Init_thread_footer(&dword_18026AB48);
    }
  }
  if ( dword_18026AB78 > *(_DWORD *)(v10 + 44) )
  {
    Init_thread_header(&dword_18026AB78);
    if ( dword_18026AB78 == -1 )
    {
      v80 = 15LL;
      LOBYTE(v78) = 0;
      v79 = 8LL;
      ...
      BYTE8(v78) = 0;
      sub_1800D88A0(&qword_18026AB50, (__int64 *)&v78);
      if ( v80 >= 0x10 )
      {
        v74 = v78;
        if ( v80 + 1 >= 0x1000 )
...
LABEL_67:
      atexit(sub_18013A870);
      Init_thread_footer(&dword_18026AB78);
    }
  }
  v11 = (unsigned __int64 *)sub_1800D9C44(v6, &qword_18026AAF0);
  v12 = (unsigned __int64 *)sub_1800D9C44(v6, &qword_18026AB20);
  v13 = (unsigned __int64 *)sub_1800D9C44(v6, &qword_18026AB50);
  v14 = _mm_mul_ps(
          _mm_add_ps(
            _mm_cvtepi32_ps(
              _mm_xor_si128(
                _mm_and_si128(_mm_load_si128((const __m128i *)&xmmword_1801F7F90), (__m128i)xmmword_180142EC0),
                (__m128i)xmmword_180142ED0)),
            (__m128)xmmword_180142EE0),
          (__m128)xmmword_180142EF0);
  *(__m128 *)&v75[1] = v14;
  ...
  *(_QWORD *)&v9 = 1090519040LL;
  ...
  if ( v65 != (__int64 *)*v7 )
  {
    ...
    do
    {
      if ( *((_DWORD *)v65 + 16) == 1 )
      {
        ...
        v82 = 15LL;
        LOBYTE(v81[0]) = 0;
        sub_180011714(v81, v65 + 4);
        v83 = _mm_sub_pd(*(__m128d *)(v65 + 9), v8);
        v66 = *((_QWORD *)&v78 + 1);
        if ( v79 == *((_QWORD *)&v78 + 1) )
        {
          sub_1800D7304(&v78, *((__int64 *)&v78 + 1), (__int64)v81);
        }
        else
        {
          *(_QWORD *)(*((_QWORD *)&v78 + 1) + 16LL) = 0LL;
          *(_QWORD *)(v66 + 24) = 0LL;
          sub_18000F3F4((_QWORD *)v66, (__int64)v81);
          *(__m128d *)(v66 + 32) = v83;
          *((_QWORD *)&v78 + 1) += 48LL;
        }
        if ( v82 >= 0x10 )
  ...
  sub_1800D9448(v76, a2, a3[16], (unsigned int)&v78, 1082130432, 1090519040, (__int64)&v75[1]);
  sub_1800D1FB4((__int64)&v78);
  return sub_1800D8A78(v6);
}
