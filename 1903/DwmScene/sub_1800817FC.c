/*
 * XREFs of sub_1800817FC @ 0x1800817FC
 * Callers:
...
unsigned __int64 __fastcall sub_1800817FC(__int64 a1)
{
  _QWORD *v2; // rsi
  _QWORD *i; // rbx
  _QWORD *v4; // rsi
  ...
  *(_QWORD *)a1 = &Spectre::Engine::SceneNode::`vftable';
  ...
  sub_18007ED50((__int64 ***)(a1 + 432), &v33, **(__int64 ***)(a1 + 432), *(__int64 **)(a1 + 432));
...
LABEL_51:
  ...
  sub_180011388((__int64 *)(a1 + 32));
  result = (unsigned __int64)&off_1801DD0D0;
