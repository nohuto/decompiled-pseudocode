/*
 * XREFs of sub_1800D9C44 @ 0x1800D9C44
 * Callers:
 ...
 *     sub_1800D8940 @ 0x1800D8940 (sub_1800D8940.c)
...
__int64 *__fastcall sub_1800D9C44(__int64 a1, __int64 *a2, double a3)
{
  ...
  if ( !*(_BYTE *)a1 )
  {
    ...
    sub_18006575C(pExceptionObject, v14, 127LL, (__int64)v17, 0);
...
LABEL_9:
  ...
  if ( v7 == *v6 )
  {
    ...
    v26 = 0;
    v27 = 0;
    sub_180011714(v24, a2);
    v19 = a2[4];
    sub_1800D8940((__int64)v20, (__int64)v23);
    v9 = (_QWORD *)sub_1800D72AC(a1 + 16, (__int64)&v19);
    sub_1800D7724((__int64 **)(a1 + 16), (__int64)v15, 0, v9 + 4, v9);
    if ( v22 >= 0x10 )
    {
      v10 = v21;
      if ( v22 + 1 >= 0x1000 )
