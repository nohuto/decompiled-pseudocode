/*
 * XREFs of sub_180071E48 @ 0x180071E48
 * Callers:
...
__int64 __fastcall sub_180071E48(__int64 **a1, __int64 a2, char a3, _QWORD *a4, _QWORD *a5)
{
  char v6; // al
  __int64 *v9; // rsi
  __int64 v10; // rbx
  ...
  try
  {
    ...
    if ( v11 )
    {
      if ( v9 == (__int64 *)**a1 )
      {
        *(_QWORD *)a2 = *sub_180032498(a1, &v17, 1, v9, (int)a4, a5);
        *(_BYTE *)(a2 + 8) = 1;
        return a2;
      }
      sub_180020AB0(&v17);
    ...
    {
      *(_QWORD *)a2 = *sub_180032498(a1, &v17, v11, v9, (int)a4, a5);
      *(_BYTE *)(a2 + 8) = 1;
    }
    result = a2;
  }
  ...
  {
    sub_180038CA4((__int64)v19, (__int64)v18);
    throw;
  }
  return result;
}
