/*
 * XREFs of sub_180033620 @ 0x180033620
 * Callers:
 *     <none>
 * Callees:
...
bool __fastcall sub_180033620(__int64 a1)
{
  __int64 **v3; // rsi
  __int64 v4; // rdx
  ...
  v21 = -2LL;
  if ( !(unsigned __int8)sub_18006A280() )
  {
    sub_18011D988(&unk_1802580F8, 3LL, "Failed to create CommandList object");
    return 0;
  }
  v3 = (__int64 **)(a1 + 144);
  if ( !*(_QWORD *)(a1 + 144) )
  {
    ...
    v20 = v25;
    sub_180017164(&v18, (__int64 *)&v20);
    v24 = 0LL;
    sub_18002317C(v18, &v24);
    ...
    else
    {
      ...
      sub_1800253B0(v18, v9);
      if ( v9 < 0 )
      {
        sub_18011D988(&unk_1802580F8, 3LL, "Failed to create DeferredContext with HRESULT error 0x%.8x", v9);
        v10 = v24;
        if ( v24 )
        {
          v24 = 0LL;
      ...
      if ( *(_QWORD *)(v13 + 24) >= 0x10uLL )
        v13 = *(_QWORD *)v13;
      sub_18000EE28(*v3, (const char *)v13);
      if ( v23 >= 0x10 )
      {
        v14 = v22[0];
        if ( v23 + 1 >= 0x1000 )
  ...
  return *(_QWORD *)(a1 + 152) || (*(int (__fastcall **)(__int64 *, void *))**v3)(*v3, &unk_18014E3C0) >= 0;
}
