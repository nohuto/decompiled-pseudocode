/*
 * XREFs of sub_18003FC70 @ 0x18003FC70
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall sub_18003FC70(__int64 a1)
{
  __int64 result; // rax
  _QWORD *v3; // rdi
  _QWORD *v4; // rbx
  ...
  v12 = 0LL;
  v13 = 0LL;
  sub_180040064(a1, &v12);
  v16 = 0LL;
  result = (__int64)sub_1800231AC(v12, &v16);
  v3 = *(_QWORD **)(a1 + 552);
  v4 = (_QWORD *)*v3;
  while ( v4 != v3 )
  {
