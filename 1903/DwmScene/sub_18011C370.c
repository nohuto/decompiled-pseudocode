/*
 * XREFs of sub_18011C370 @ 0x18011C370
 * Callers:
 *     <none>
 * Callees:
...
void __fastcall sub_18011C370(__int64 a1, _BYTE *a2, __int64 a3, _BYTE *a4, void *a5, void *a6, char a7)
{
  __int64 v7; // rax
  bool v8; // zf
  void *v9; // rcx
  ...
  if ( (unsigned int)dword_18025DE98 > 5 )
  {
    ...
    v29 = &a7;
    v30 = 4LL;
    sub_180001128((__int64)&dword_18025DE98, (unsigned __int8 *)dword_180224BF8, 0LL, 0LL, 8u, &v14);
  }
}
