 ...
 *     sub_1800884D8 @ 0x1800884D8 (sub_1800884D8.c)
 *     j_j__o_free @ 0x180125F84 (j_j__o_free.c)
 */

void __fastcall sub_18008D4F8(unsigned __int64 **a1, unsigned __int64 a2, unsigned __int64 *a3)
{
  ...
  if ( a2 > v8 )
  {
    if ( a2 <= 0x1FFFFFFFFFFFFFFFLL )
    {
      ...
      *a1 = 0LL;
      ...
      {
        v15 = sub_18001BA38((__int64)a1, v10);
        *a1 = v15;
        a1[1] = v15;
        a1[2] = &(*a1)[v10];
LABEL_15:
...
LABEL_22:
  ...
  if ( a2 > v7 )
  {
    sub_1800884D8(v5, (unsigned __int64)a1[1], a3);
    i = a1[1];
    for ( j = a2 - v7; j; --j )
      *i++ = *a3;
    goto LABEL_22;
