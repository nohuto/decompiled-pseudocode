/*
 * XREFs of sub_180029EA0 @ 0x180029EA0
 * Callers:
 *     sub_18002A400 @ 0x18002A400 (sub_18002A400.c)
 * Callees:
 ...
 *     sub_18002A7B4 @ 0x18002A7B4 (sub_18002A7B4.c)
...
__int64 __fastcall sub_180029EA0(__int64 a1, _QWORD *a2, _QWORD *a3, _QWORD *a4)
{
  ...
  *(_QWORD *)&v25 = a1;
  ...
  if ( (_BYTE)v22 )
  {
    if ( !*a4 )
    {
      ...
      sub_180028088(pExceptionObject, &v28);
  ...
  *(_QWORD *)&v39 = *(_QWORD *)(a1 + 480);
  ...
  if ( v14 == -2005270523 )
  {
    sub_18011D988(&unk_180258080, 3LL, "Present() returned DXGI_ERROR_DEVICE_REMOVED");
  }
  else if ( v14 == -2005270521 )
  {
    sub_18011D988(&unk_180258080, 3LL, "Present() returned DXGI_ERROR_DEVICE_RESET");
  }
  else if ( v14 < 0 )
  {
    sub_18011D988(&unk_180258080, 3LL, "Present() returned error %08x", v14);
  }
  v23 = 0LL;
  v24 = 0LL;
  v19 = (_QWORD **)v25;
  sub_180029B04(v25, &v23);
  if ( v23 )
    sub_1800253B0(v23, v14);
  if ( v24 )
  {
  ...
  return sub_18006885C(v19, v13, v18, v18 - v13, v22);
}
