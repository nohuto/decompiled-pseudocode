/*
 * XREFs of sub_18003DD40 @ 0x18003DD40
 * Callers:
 *     <none>
 * Callees:
...
char __fastcall sub_18003DD40(__int64 a1, __int64 *a2)
{
  __int64 v4; // rdx
  __int64 v5; // rdi
  __int64 v6; // rbx
  ...
  {
    sub_18000E498(v28);
    v24 = sub_18000E498(v27);
    sub_180027770(pExceptionObject, v24, 36, (__int64)v28, 0);
...
LABEL_6:
    ...
    v12 = (*(__int64 (__fastcall **)(__int64, __int64, __int64, _QWORD, __int64))(*(_QWORD *)v6 + 120LL))(
            ...
            0LL,
            a1 + 104);
    sub_1800253B0(v30, v12);
    if ( v12 >= 0 )
    {
      *(_BYTE *)(a1 + 96) = 1;
      v13 = sub_1800642F8(a1, &v25);
      v14 = (const char *)v13;
