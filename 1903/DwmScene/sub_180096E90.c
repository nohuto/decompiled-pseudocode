/*
 * XREFs of sub_180096E90 @ 0x180096E90
 * Callers:
...
__int64 __fastcall sub_180096E90(__int64 a1, __int64 a2, unsigned int a3)
{
  _QWORD *v6; // rax
  int v7; // r14d
  __int64 *v8; // rdi
  ...
  *(_DWORD *)(a1 + 288) = 0;
  ...
  v12 = sub_18003107C(12, v9);
  return sub_1800D24F4(v10, a2, a3, v12, v7, 12);
}
