/*
 * XREFs of sub_18009A9F0 @ 0x18009A9F0
 * Callers:
 ...
 *     sub_18006AB50 @ 0x18006AB50 (sub_18006AB50.c)
 *     sub_18008365C @ 0x18008365C (sub_18008365C.c)
 *     sub_180084370 @ 0x180084370 (sub_180084370.c)
 *     sub_1800879F4 @ 0x1800879F4 (sub_1800879F4.c)
...
unsigned __int64 __fastcall sub_18009A9F0(__int64 a1, __int64 *a2, __int64 a3, __int64 *a4)
{
  __int64 v5; // r13
  __int64 v8; // rcx
  _QWORD *v9; // r8
  ...
  {
    v9 = sub_18006A4A4((_QWORD *)*a2, &v77);
    v93 = 0LL;
    v10 = v9[1];
    if ( v10 )
    {
    ...
    if ( (_QWORD)v93 )
    {
      ...
      v79 = v13;
      v80 = v14;
      v17 = sub_18008365C(v13, &v74);
      v18 = (char *)sub_18002BFD4((const void **)&Src, (_QWORD *)(*a4 + 24), "_");
      v19 = (_QWORD *)sub_180097A68((__int64)&v70, v18, v17);
      ...
      v20->m128i_i8[0] = 0;
      v21 = (unsigned __int64 *)sub_1800D55F0(v93, v81, &v68, a2);
      v22 = *v21;
      v23 = v21[1];
      *v21 = 0LL;
      v21[1] = 0LL;
  ...
  v90 = v34[2];
  v91 = v34[3];
  sub_1800879F4(*(double *)&v88, *(double *)&v89, *(double *)&v90, *(double *)&v91);
  ...
  if ( v37 / 88 )
  {
    v39 = 0LL;
    v61 = 0LL;
    while ( !sub_180099BB8(a1, v36) || v36 < 0x20 && ((1 << v36) & dword_18025C764) == 0 )
    {
LABEL_104:
      ++v36;
      v39 += 88LL;
...
LABEL_100:
    ...
    sub_18008FE08(v63, (__int64)&v95, v5, a2, v35);
    v41 = v95;
    v42 = *(_DWORD *)(v95 + 128);
    if ( v42 )
    {
...
LABEL_95:
    ...
    if ( !v43 )
    {
      ...
      if ( v45 )
      {
        v46 = (_QWORD *)sub_1800A8EF0(v45, v85);
        ...
        if ( v50 )
          sub_1800F4A60(v50, a2, v97);
        sub_18006AB50(*a2, *(_BYTE *)(a1 + 168));
        v87 = *(_OWORD *)(a1 + 172);
        sub_18006A930(*a2, &v87);
        v51 = v61;
        v52 = *(_QWORD *)(v61 + v48 + 40);
        if ( v52 )
        {
          sub_1800F4A60(v52, a2, v49);
          v51 = v61;
        }
        v53 = *(_QWORD *)(v51 + v48 + 56);
        if ( v53 )
        {
          sub_1800F4A60(v53, a2, v49);
          v51 = v61;
        }
        v54 = *(_QWORD *)(v51 + v48 + 72);
        if ( v54 )
          sub_1800F4A60(v54, a2, v49);
        sub_1800965E0(*(_QWORD *)(a1 + 88), a2, *(_QWORD *)(v41 + 136));
        v5 = v65;
      }
      if ( v44 )
      {
