...
_UNKNOWN **__fastcall sub_1800C7110(__int64 a1, __int64 *a2)
{
  __int64 v3; // rdx
  _UNKNOWN **v4; // r15
  ...
  v62[2] = -2LL;
  v61 = a1;
  v46 = sub_18007797C(a1, *(_DWORD *)(*a2 + 112));
  v4 = &off_18025CA00;
  v50 = &off_18025CA00;
  v5 = (volatile signed __int32 **)(sub_1800BB0EC(*a2, v3) + 64);
  do
  {
    v6 = *(v5 - 6);
    if ( v6 )
    ...
    if ( v7 && v10 )
    {
      ...
      *(_DWORD *)(v8 + 104) = v31;
      sub_18008F2E4(v8, v54);
      sub_18008F2F4(v8, v55);
      *(_DWORD *)(v8 + 116) = v56;
      *(float *)(v8 + 112) = v57;
      sub_18008F2F0(v8, v49);
      v58 = 0LL;
      v59 = 0LL;
      v52 = 0LL;
      v40 = *(_QWORD *)(v8 + 64);
      if ( v40 )
      {
        while ( 1 )
        {
          ...
          if ( v45 == _InterlockedCompareExchange((volatile signed __int32 *)(v40 + 8), v45 + 1, v45) )
          {
            v41 = *(_QWORD *)(v8 + 64);
            *((_QWORD *)&v52 + 1) = v41;
            sub_18006B1D8(*(_QWORD *)(v8 + 56), &v58);
            goto LABEL_27;
          }
        }
      }
      v41 = 0LL;
      sub_18006B1D8(0LL, &v58);
LABEL_27:
      if ( v41 )
      {
    ...
    v4 += 18;
    v50 = v4;
    result = &qword_18025CBB0;
  }
  while ( (__int64)v4 < (__int64)&qword_18025CBB0 );
  return result;
}
