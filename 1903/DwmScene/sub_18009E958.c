/*
 * XREFs of sub_18009E958 @ 0x18009E958
 * Callers:
...
__int64 __fastcall sub_18009E958(__int64 a1, int a2, int a3, __int64 a4)
{
  int v7; // r8d
  int v8; // ecx
  unsigned int v9; // ecx
...
LABEL_22:
  ...
  while ( v10 < 0x100 );
  LODWORD(Size) = 1024;
  return sub_18009DF60(a1, 16, 16, 0, 16, 0, a3, v16, Size, a4);
}
