/*
 * XREFs of sub_180077D74 @ 0x180077D74
 * Callers:
 ...
 *     sub_1800736B4 @ 0x1800736B4 (sub_1800736B4.c)
 ...
 *     sub_18007FBE0 @ 0x18007FBE0 (sub_18007FBE0.c)
...
__int64 __fastcall sub_180077D74(__int64 a1, __int64 a2)
{
  unsigned int i; // esi
  _QWORD *v5; // rbx
  _QWORD *v6; // rdi
  ...
  sub_1800736B4((__int64)v31, 3, 1);
  v27 = 0LL;
  v28 = 0LL;
  sub_180063358(a1 + 112, &v27);
  for ( i = 0; i < (unsigned int)sub_180077B7C(a1); ++i )
  {
    v21 = 0LL;
    v22 = 0LL;
    sub_180077A9C(a1, &v21, i);
    if ( !_RTDynamicCast(
            v21,
            0LL,
            ...
            0) )
    {
      v5 = sub_18006CD8C(v21, v26);
      v6 = sub_18006CDC8(v21, v25);
      v7 = sub_18006CD5C(v21, v24);
      v8 = v7[2];
      if ( v7[3] >= 8uLL )
        v7 = (_QWORD *)*v7;
      v9 = sub_180072634((__int64)&v31[16], (__int64)v7, v8);
      v10 = sub_18006E6CC(v9, ": Hardware Feature Level ");
      v11 = v6[2];
      if ( v6[3] >= 8uLL )
        v6 = (_QWORD *)*v6;
      v12 = sub_180072634(v10, (__int64)v6, v11);
      v13 = sub_18006E6CC(v12, ", Engine Feature Level ");
      v14 = v5[2];
      if ( v5[3] >= 8uLL )
        v5 = (_QWORD *)*v5;
      v15 = sub_180072634(v13, (__int64)v5, v14);
      sub_18006E6CC(v15, "; ");
  ...
  *(_QWORD *)(a2 + 24) = 15LL;
  *(_BYTE *)a2 = 0;
  sub_18006F504((const void **)a2, v19, v18);
  unknown_libname_116(v29);
  if ( (_BYTE)v28 )
    sub_180063670(v27);
  sub_1800744A4((__int64)&v31[152]);
