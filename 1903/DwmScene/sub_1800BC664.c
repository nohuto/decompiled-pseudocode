/*
 * XREFs of sub_1800BC664 @ 0x1800BC664
 * Callers:
...
__int64 __fastcall sub_1800BC664(__int64 **a1, __int64 a2, _DWORD *a3)
{
  __int64 *v3; // rbx
  __int64 v6; // rax
  int v7; // edx
...
LABEL_10:
    v11 = a3;
    v8 = sub_180032454((__int64)a1, (__int64)&unk_1801F4792, &v11);
