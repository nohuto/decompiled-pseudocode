/*
 * XREFs of sub_1800BE0F8 @ 0x1800BE0F8
 * Callers:
...
__int64 __fastcall sub_1800BE0F8(__int64 a1, __int64 a2, _QWORD *a3, _QWORD *a4)
{
  __int64 v6; // r14
  char v7; // r12
  char v8; // r15
  ...
  v6 = sub_18007797C(a1, *(_DWORD *)(*(_QWORD *)a2 + 112LL));
  if ( (*(unsigned __int8 (__fastcall **)(_QWORD, __int64))(*(_QWORD *)*a3 + 96LL))(*a3, 7LL) )
    v7 = (*(__int64 (__fastcall **)(__int64, void *, _QWORD))(*(_QWORD *)v6 + 64LL))(v6, &unk_18025A158, 0LL);
  else
    v7 = 0;
  v8 = (*(__int64 (__fastcall **)(__int64, void *, _QWORD))(*(_QWORD *)v6 + 64LL))(v6, &unk_18025A198, 0LL);
  if ( v8 && (*(unsigned int (__fastcall **)(__int64, void *, _QWORD))(*(_QWORD *)v6 + 72LL))(v6, &unk_1802590F8, 0LL) )
    v8 = 0;
  v23 = 0LL;
  v24 = 0LL;
  ...
  v24 = v10;
  v22 = 0uLL;
  sub_1800BB184(v23, &v22);
  if ( v8 )
  {
    v12 = (*(__int64 (__fastcall **)(__int64, void *, _QWORD))(*(_QWORD *)v6 + 72LL))(v6, &unk_18025A1D8, 0LL);
    v13 = v12;
    v14 = 2;
    ...
    if ( v15 )
    {
      v17 = *((_QWORD *)&v22 + 1);
LABEL_31:
      *(float *)(v15 + 280) = (*(float (__fastcall **)(__int64, void *))(*(_QWORD *)v6 + 88LL))(v6, &unk_18025A1B8);
      goto LABEL_33;
    }
LABEL_24:
    v18 = sub_1800BCB48(&v27);
...
LABEL_33:
  if ( v15 )
    *(_BYTE *)(v15 + 136) = v8;
  LOBYTE(v11) = v7;
  result = sub_1800DDA58(v23, a4, v11);
  if ( v17 )
  {
