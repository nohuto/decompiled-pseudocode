/*
 * XREFs of sub_180012B30 @ 0x180012B30
 * Callers:
 *     sub_180013B80 @ 0x180013B80 (sub_180013B80.c)
 * Callees:
...
__int64 __fastcall sub_180012B30(__int64 a1)
{
  __int64 v1; // rax
  ...
  v12 = 0LL;
  v13 = 0LL;
  sub_180012430(v14, &v12);
  v6 = qword_180268E48;
  v7 = *(volatile signed __int32 **)(qword_180268E48 + 104);
  if ( v7 )
  {
  ...
  result = (__int64)sub_180012230(v14, &v17);
  if ( v18 )
  {
