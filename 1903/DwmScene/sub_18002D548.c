/*
 * XREFs of sub_18002D548 @ 0x18002D548
 * Callers:
 ...
 *     sub_180030EC4 @ 0x180030EC4 (sub_180030EC4.c)
...
_QWORD *__fastcall sub_18002D548(_QWORD *a1, int a2, int a3, unsigned int a4, _DWORD *a5)
{
  unsigned int v9; // ebx
  int v10; // edx
  ...
  v36 = a3;
  v33 = 0;
  sub_180030EC4(&v31, (unsigned int)a5[4]);
  if ( HIDWORD(v31) == 1 )
    v9 = a2 | 8;
  else
    v9 = a2 & 0xFFFFFFF7;
