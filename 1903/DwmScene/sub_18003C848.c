/*
 * XREFs of sub_18003C848 @ 0x18003C848
 * Callers:
 *     sub_18003D614 @ 0x18003D614 (sub_18003D614.c)
 * Callees:
 ...
 *     sub_18003C6B4 @ 0x18003C6B4 (sub_18003C6B4.c)
 *     sub_18003D3F0 @ 0x18003D3F0 (sub_18003D3F0.c)
 *     sub_18003D864 @ 0x18003D864 (sub_18003D864.c)
 *     CreateDXGIFactory1 @ 0x180114B54 (CreateDXGIFactory1.c)
...
__int64 __fastcall sub_18003C848(
...
LABEL_176:
  ...
  if ( (a6 & 4) != 0 && v17 < 45312 )
    goto LABEL_10;
  v97[0] = _mm_load_si128((const __m128i *)&xmmword_18014AA60);
  v97[1] = _mm_load_si128((const __m128i *)&xmmword_18014AA50);
  v98 = 37120;
  ...
  do
  {
    ...
    if ( v22 >= v17 && v22 <= a9 )
    {
      if ( v16 == v21 )
      {
        sub_18003C314((const void **)v88, v21, &v86);
        v16 = v89;
        v21 = v88[1];
        v17 = a8;
      }
  ...
  v100 = (a6 & 0x20) != 0;
  v26 = v83;
  v27 = sub_1800161C4((__int64 *)&v83[1]);
  DXGIFactory1 = CreateDXGIFactory1(&stru_18014A260, (void **)v27);
  if ( DXGIFactory1 < 0 )
  {
    v10 = a4;
    goto LABEL_176;
    ...
    for ( LODWORD(v84) = 0; ; LODWORD(v84) = (_DWORD)v84 + 1 )
    {
      ...
      if ( v32 == -2005270526 )
      {
        ...
        while ( 2 )
        {
          ...
          v87 = 0LL;
          v83 = 0LL;
          DXGIFactory1 = sub_18003D3F0(*a2, v29, v21 - v29, 7u, &v87, v85, &v83);
          if ( DXGIFactory1 < 0 )
          {
            v48 = *a2;
            if ( *a2 )
...
LABEL_103:
        ...
        {
          sub_18003C314((const void **)v88, v29, &v84);
          v81[0] = v89;
          v21 = v88[1];
          v29 = v88[0];
        }
...
LABEL_45:
        ...
        if ( (v96 & 2) != 0 )
          v80 = -3.4028235e38;
        v36 = (float *)sub_18003C2AC(&v91, &v80, (__int64 *)a2);
        sub_18003C6B4(&v91, (__int64)v82, 0, v36 + 8, v36);
        goto LABEL_52;
      }
  ...
  if ( a5 == 1 )
  {
    *(_QWORD *)v85 = 0LL;
    v84 = 0LL;
    DXGIFactory1 = sub_18003D3F0(0LL, v29, v21 - v29, 7u, (ID3D11Device **)v85, &v90, &v84);
    if ( DXGIFactory1 >= 0 )
    {
      v86 = 0LL;
...
LABEL_170:
                  ...
                  sub_18003C1EC((__int64)*a2, L"CoreEngine");
                  sub_18003C128(*a3, L"CoreEngine");
                  goto LABEL_127;
                }
              }
              else
...
LABEL_183:
  ...
  sub_18003D864(&v91, v81, *(_QWORD *)v91);
  j_j__o_free(v91);
