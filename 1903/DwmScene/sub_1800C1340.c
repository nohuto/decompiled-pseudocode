/*
 * XREFs of sub_1800C1340 @ 0x1800C1340
 * Callers:
 *     <none>
 * Callees:
...
void __fastcall sub_1800C1340(__int64 a1, __int64 a2, __int64 *a3)
{
  __int64 v6; // rcx
  __m128i v7; // xmm6
  ...
  v48[2] = 0LL;
  v48[3] = 0LL;
  sub_18000F3F4(v48, (__int64)&qword_18025D5D0);
  sub_1800A4A38(a2, &v60, v48);
  v55 = 0uLL;
  sub_1800A817C(v60, (__int64 *)&v55);
  sub_180090A04(v55, (__int64)&qword_18025C5D8, 1);
  sub_1800909E0(v55);
  v54 = 0uLL;
  v49[2] = 0LL;
  v49[3] = 0LL;
  sub_18001110C(v49, (__int64)&unk_180258788);
  sub_18008B2A0(*a3, (__int64)&v54, v49);
  v59 = 0uLL;
  sub_1800FBE44(&v59, a1, 0LL);
  v56 = 0LL;
  v57 = 0LL;
  v39 = 0LL;
  if ( *((_QWORD *)&v54 + 1) )
  ...
  v39 = v54;
  sub_180089824(*a3, (__int64)&v56, qword_18026A080, &v39);
  si128 = _mm_load_si128(xmmword_180144F90);
  LOBYTE(v46[0]) = 0;
  sub_18000E118(v46, 0x10uLL, 0LL, "PlanarReflection");
  sub_180085AD8(v56, v46);
  ...
  v40 = v55;
  sub_18009B98C(v34, &v40);
  v10 = v56;
  sub_180087414(v56);
  *(_QWORD *)(v10 + 448) &= ~2uLL;
  if ( (*(_BYTE *)(a1 + 560) & 1) != 0 )
  {
    v12 = (_QWORD *)sub_1800BB0EC(*a3, v11);
    v13 = sub_1800A817C(v60, &v50);
    v14 = v12 + 27;
    ...
    sub_1800909E0(*v14);
    sub_180090D7C(*v14, 3);
    sub_180090B78((_QWORD *)*v14, 1, 1, 1);
    v58 = 0uLL;
    LOBYTE(v16) = 1;
    sub_1800FBE44(&v58, a1, v16);
    v41 = 0LL;
    if ( *((_QWORD *)&v54 + 1) )
      _InterlockedAdd((volatile signed __int32 *)(*((_QWORD *)&v54 + 1) + 8LL), 1u);
    v41 = v54;
    v17 = (__int64 *)sub_180089824(*a3, (__int64)v52, qword_18026A088, &v41);
