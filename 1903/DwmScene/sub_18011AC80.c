/*
 * XREFs of sub_18011AC80 @ 0x18011AC80
 * Callers:
 *     <none>
 * Callees:
...
ULONG __fastcall sub_18011AC80(
        __int64 a1,
        float a2,
        float a3,
        float a4,
        ...
        __int64 **a21)
{
  ...
  *(_QWORD *)(a1 + 112) = v29;
  ...
  sub_18011A4DC((__int64)v31);
  result = sub_18011BA5C(v31);
  if ( (unsigned int)dword_18025DE60 > 5 && (qword_18025DE70 & 0x400000000000LL) != 0 )
  {
    ...
    if ( (qword_18025DE78 & 0x400000000000LL) == qword_18025DE78 )
    {
      ...
      v112 = 4LL;
      v114 = 4LL;
      return sub_180001128((__int64)&dword_18025DE60, (unsigned __int8 *)dword_180224175, 0LL, 0LL, 0x20u, &v51);
    }
  }
  return result;
}
