/*
 * XREFs of sub_1800D5204 @ 0x1800D5204
 * Callers:
...
char __fastcall sub_1800D5204(_QWORD *a1, _QWORD *a2, __int64 a3)
{
  __int64 v6; // r8
  __int64 *v7; // rax
  __int64 v8; // rdx
  ...
  sub_1800D58D0(a1, v14, a3);
  if ( v14[0] || (v6 = a1[5]) == 0 )
  {
    sub_180063668((__int64)a1);
  ...
  else
  {
    ...
    *a2 = 0LL;
    a2[1] = 0LL;
    sub_180108E50(a1[2 * v9 + 8], a3, v13);
    sub_180063668((__int64)a1);
