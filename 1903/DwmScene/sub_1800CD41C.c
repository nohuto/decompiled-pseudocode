/*
 * XREFs of sub_1800CD41C @ 0x1800CD41C
 * Callers:
 *     sub_1800CE820 @ 0x1800CE820 (sub_1800CE820.c)
 * Callees:
...
_QWORD *__fastcall sub_1800CD41C(__int64 a1, _QWORD *a2, __int64 a3, __int64 *a4)
{
  __int64 v7; // rbx
