/*
 * XREFs of sub_180122800 @ 0x180122800
 * Callers:
 ...
 *     sub_1801246A8 @ 0x1801246A8 (sub_1801246A8.c)
 *     sub_1801246AC @ 0x1801246AC (sub_1801246AC.c)
 *     __security_check_cookie @ 0x180126090 (__security_check_cookie.c)
 */

// Hidden C++ exception states: #wind=1
__int64 __fastcall sub_180122800(__int64 a1, __int64 a2)
{
  int v4; // ebx
  unsigned int v5; // edi
  int v6; // ebx
  ...
  v5 = 0;
  LOWORD(v14[0]) = 0;
  sub_180026168((char *)v14, L"Value", 5uLL);
  if ( !v4 )
  {
    v11 = 4;
    goto LABEL_14;
  ...
  if ( v8 == 1 )
  {
    ...
    if ( si128.m128i_i64[1] >= 8uLL )
      v9 = (__int64 *)v14[0];
    if ( (unsigned __int8)sub_1801246AC(a2, v9) )
    {
      v13[2] = 0LL;
      v13[3] = 0LL;
      sub_18001110C(v13, (__int64)v14);
      v10 = sub_180124548(a2, v13);
      v11 = sub_180122800(a1, v10);
LABEL_14:
      v5 = v11;
    }
  }
