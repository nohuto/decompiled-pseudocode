/*
 * XREFs of sub_1801026A0 @ 0x1801026A0
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall sub_1801026A0(__int64 a1)
{
  __int64 v2; // rdx
  _DWORD *v3; // rbx
  int v4; // xmm6_4
...
LABEL_3:
  v4 = qword_18025DF08;
  v5 = HIDWORD(qword_18025DF08);
  v6 = dword_18025DF10;
  sub_180087414((__int64)v3);
  v3[36] = v4;
  v3[37] = v5;
  v3[38] = v6;
  v7 = _InterlockedIncrement64(&qword_180258748);
  v8 = v20;
  *(_QWORD *)(v20 + 208) = v7;
  v9 = *(_QWORD *)(v8 + 216);
  if ( v7 >= v9 )
  ...
  *(_QWORD *)(v8 + 216) = v9;
  ...
  v17 = qword_18026B298;
  v18 = dword_18026B2A0;
  sub_1800847E4(v8, (unsigned __int64 *)&v17, (__int64)&v15);
  v14 = 0LL;
  ...
  *(_DWORD *)(a1 + 88) = 0;
  *(_QWORD *)(a1 + 124) = qword_18026B298;
  *(_DWORD *)(a1 + 132) = dword_18026B2A0;
  *(_QWORD *)(a1 + 112) = qword_18025DF08;
  *(_DWORD *)(a1 + 120) = dword_18025DF10;
  *(_QWORD *)(a1 + 140) = qword_18026B298;
  *(_DWORD *)(a1 + 148) = dword_18026B2A0;
  *(_DWORD *)(a1 + 136) = 0;
  *(_BYTE *)(a1 + 72) = 0;
  if ( *((_QWORD *)&v20 + 1) )
  {
