...
unsigned __int64 __fastcall sub_18008B6F8(__int64 a1, __int64 *a2, _QWORD *a3)
{
  __int64 v6; // rbx
  __int64 v7; // rdx
  __int64 v8; // rcx
  ...
  {
    sub_18000E498(v47);
    v29 = sub_18000E498(v46);
    sub_180027770(v54, v29, 345, (__int64)v47, 0);
    throw (Spectre::Engine::EngineInvalidArgException *)v54;
  }
  if ( !*a3 )
  {
    sub_18000E498(v49);
    v30 = sub_18000E498(v48);
    sub_180027770(v55, v30, 350, (__int64)v49, 0);
    ...
    while ( 1 )
    {
      ...
      if ( v12 == _InterlockedCompareExchange((volatile signed __int32 *)(v7 + 8), v12 + 1, v12) )
      {
        ...
        *((_QWORD *)&v36 + 1) = v14;
        ...
        {
          sub_18000E498(v51);
          v28 = sub_18000E498(v50);
          sub_180027770(v56, v28, 355, (__int64)v51, 0);
  ...
  *(_QWORD *)&v37 = *a2;
  *((_QWORD *)&v37 + 1) = v8;
  sub_18008AF1C(a1, &v34, (__int64 *)&v37);
  v32 = 0LL;
  v33 = 0LL;
  v38 = 0LL;
  v9 = a3[1];
  ...
  *(_QWORD *)&v38 = *a3;
  *((_QWORD *)&v38 + 1) = v9;
  sub_18008AF1C(a1, &v32, (__int64 *)&v38);
  if ( v34 )
  {
    sub_18000E498(v53);
    v27 = sub_18000E498(v52);
    sub_180027770(pExceptionObject, v27, 363, (__int64)v53, 0);
    throw (Spectre::Engine::EngineInvalidArgException *)pExceptionObject;
  }
  sub_1800634AC(a1 + 16, v10);
  if ( v32 )
  {
  ...
  else
  {
    ...
    *(_QWORD *)&v41 = *a3;
    *((_QWORD *)&v41 + 1) = v22;
    result = sub_180085B50(*a2, (__int64 *)&v41);
  }
  if ( v33 )
  {
