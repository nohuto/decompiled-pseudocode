/*
 * XREFs of sub_1800669D4 @ 0x1800669D4
 * Callers:
...
__int64 __fastcall sub_1800669D4(__int64 a1, __int64 a2, __int64 *a3, _QWORD *a4)
{
  __int64 v8; // rcx
  __int64 v9; // rax
  char v10; // r14
  ...
  *(_QWORD *)(a1 + 424) = 0LL;
  *(_QWORD *)(a1 + 432) = 0LL;
  sub_1800667DC((_QWORD *)(a1 + 440), *a3);
  sub_180066858((_QWORD *)(a1 + 456));
  v15 = operator new(0x190uLL);
  v16 = v15;
  if ( v15 )
  {
    memset(v15, 0, 0x190uLL);
    v17 = sub_1800D8804(v16);
  }
  else
  {
    v17 = 0LL;
