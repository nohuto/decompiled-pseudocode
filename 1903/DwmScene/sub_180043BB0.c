/*
 * XREFs of sub_180043BB0 @ 0x180043BB0
 * Callers:
 *     <none>
 * Callees:
...
char __fastcall sub_180043BB0(__int64 a1, __int64 *a2)
{
  __int64 v4; // rdx
  __int64 v5; // rdi
  __int64 v6; // rbx
  ...
  {
    sub_18000E498(v22);
    v20 = sub_18000E498(v21);
    sub_180027770(pExceptionObject, v20, 38, (__int64)v22, 0);
...
LABEL_6:
    ...
    if ( v9 == a2[1] )
      v9 = a2[3];
    v12 = (*(__int64 (__fastcall **)(__int64, __int64, __int64, _QWORD, __int64))(*(_QWORD *)v6 + 136LL))(
            v6,
            v9,
            v10,
            0LL,
            a1 + 104);
    sub_1800253B0(v24, v12);
    if ( v12 < 0 )
    {
      sub_18011D988(&unk_1802581B8, 5LL, "ERROR: Failed to create Domain shader.\n");
    }
    else
    {
      *(_BYTE *)(a1 + 96) = 1;
