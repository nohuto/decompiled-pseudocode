/*
 * XREFs of sub_180037F90 @ 0x180037F90
 * Callers:
 *     <none>
 * Callees:
 ...
 *     sub_18009EB48 @ 0x18009EB48 (sub_18009EB48.c)
...
char __fastcall sub_180037F90(__int64 a1, _QWORD *a2, const void *a3, int a4)
{
  __int64 v7; // rax
  __int64 *v8; // rcx
  char v9; // bl
  ...
  if ( *a2 )
  {
    v8 = (__int64 *)sub_18009EB64(*a2, v63, *(unsigned int *)(a1 + 88));
    v9 = 1;
    v7 = *v8;
  }
  else
  ...
  *v8 = 0LL;
  ...
  v12 = 4 - ((unsigned int)sub_18009EBF4(v49) != 2);
  v47 = 0LL;
  v48 = 0LL;
  sub_180032E58(&v47, &v49);
  v14 = 1;
  v15 = *(_QWORD *)(*a2 + 128LL);
  if ( v15 )
    v16 = *(_DWORD *)(v15 + 12);
  ...
  {
    v14 = sub_18009EB48(v47, v13);
    v23 = *(_QWORD *)(a1 + 144);
    v24 = sub_18003164C(v17, &v56);
...
LABEL_23:
  ...
  sub_1800253B0(v54, v20);
  v29 = 0;
  if ( v20 < 0 )
  {
    sub_18011D988(&unk_1802580F8, 3LL, "Failed to update Texture with HRESULT error 0x%.8x", v20);
    goto LABEL_50;
  }
  v30 = (unsigned int)sub_18009EB80(v17);
  v65[0] = 0;
  v65[1] = 1;
  v31 = &v66;
  for ( i = 20LL; i; --i )
