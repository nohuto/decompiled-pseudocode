...
LABEL_11:
  ...
  *(_DWORD *)(a15 + 4) = v17;
  v21 = 1;
  *(_DWORD *)a15 = a7;
  *(_DWORD *)(a15 + 8) = _InterlockedIncrement(&dword_180268BD4);
  v22 = a9;
  if ( !a9 || !*a9 )
    v22 = 0LL;
  *(_QWORD *)(a15 + 16) = v22;
  ...
  *(_QWORD *)(a15 + 120) = v24;
  ...
  if ( !byte_180268AB8
    && (!qword_180268AB0 ? (v25 = IsDebuggerPresent()) : (v25 = (unsigned __int8)qword_180268AB0()), !v25)
    || !byte_180258000 )
  {
    v21 = 0;
  }
  if ( a10 || v21 )
  {
    if ( qword_180268AA8 && !byte_180268AD8 )
      qword_180268AA8(a15, lpOutputString, a12);
    if ( !*lpOutputString )
      sub_18000B10C(lpOutputString, a12, a15);
    if ( v21 )
      OutputDebugStringW(lpOutputString);
  }
  else if ( qword_180268AA8 && !byte_180268AD8 )
  {
    qword_180268AA8(a15, 0LL, 0LL);
  }
  if ( byte_180268AC8 )
  {
    if ( qword_180268B18 )
