/*
 * XREFs of sub_1800ABA10 @ 0x1800ABA10
 * Callers:
...
__int64 __fastcall sub_1800ABA10(__int64 a1, __int64 a2)
{
  __int64 v4; // rcx
  char *v5; // rbx
  __int64 v6; // rbp
  ...
  *(_QWORD *)(a1 + 536) = 0LL;
  ...
  do
  {
    `vector constructor iterator'(v5, 64LL, 4LL, (void (__fastcall *)(char *))sub_180017320);
    v5 += 256;
    --v6;
  }
  while ( v6 );
