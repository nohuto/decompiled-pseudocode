/*
 * XREFs of ??1?$_Func_impl@U?$_Callable_obj@V_lambda_8b695f9820225e821433c25f6ed27cb8_@@$0A@@std@@V?$allocator@V?$_Func_class@V?$task@_N@Concurrency@@_N@std@@@2@V?$task@_N@Concurrency@@_N@std@@UEAA@XZ @ 0x1800D65F4
 * Callers:
 *     sub_1800676A0 @ 0x1800676A0 (sub_1800676A0.c)
 *     sub_1800695A0 @ 0x1800695A0 (sub_1800695A0.c)
 * Callees:
