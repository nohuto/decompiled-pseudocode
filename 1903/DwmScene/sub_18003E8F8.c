/*
 * XREFs of sub_18003E8F8 @ 0x18003E8F8
 * Callers:
...
__int64 __fastcall sub_18003E8F8(__int64 a1, _DWORD *a2)
{
  __int64 v4; // rdx
  __int64 v5; // rax
  int v6; // ecx
  ...
  *((_WORD *)a2 + 8) = -1;
  si128 = _mm_load_si128((const __m128i *)&xmmword_18014F250);
  a2[5] = 1;
  ...
  *a2 = *(unsigned __int8 *)(a1 + 61);
  ...
  while ( v14 < 8 );
  v16 = _mm_load_si128((const __m128i *)&xmmword_18014F250);
