/*
 * XREFs of sub_1800FDEB0 @ 0x1800FDEB0
 * Callers:
 *     <none>
 * Callees:
 *     <none>
...
char __fastcall sub_1800FDEB0(float *a1, __int64 a2, int a3, char a4, char a5, char a6, char a7, float a8)
{
  char result; // al
  float v9; // xmm1_4
  float v10; // xmm1_4
  ...
  if ( a6 && (!a5 || !a7) )
    a1[472] = (float)((float)a3 * -0.0099999998) + a1[472];
  v10 = a1[475];
