/*
 * XREFs of sub_180073590 @ 0x180073590
 * Callers:
 *     sub_18006E6CC @ 0x18006E6CC (sub_18006E6CC.c)
 * Callees:
 *     sub_18000A4B0 @ 0x18000A4B0 (sub_18000A4B0.c)
 *     sub_180074334 @ 0x180074334 (sub_180074334.c)
 *     _CxxThrowException @ 0x180125A78 (_CxxThrowException.c)
 *     __security_check_cookie @ 0x180126090 (__security_check_cookie.c)
 *     ?_Getgloballocale@locale@std@@CAPEAV_Locimp@12@XZ @ 0x1801274F6 (-_Getgloballocale@locale@std@@CAPEAV_Locimp@12@XZ.c)
 *     _guard_dispatch_icall_nop @ 0x180127630 (_guard_dispatch_icall_nop.c)
 */

// Hidden C++ exception states: #wind=2
__int64 __fastcall sub_180073590(__int64 a1)
{
  ...
  if ( !v4 )
  {
    ...
    if ( !v4 )
    {
      ...
      if ( !v9 )
      {
        ...
        {
          sub_180074334(pExceptionObject);
