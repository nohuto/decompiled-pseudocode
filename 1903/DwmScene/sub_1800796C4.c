/*
 * XREFs of sub_1800796C4 @ 0x1800796C4
 * Callers:
...
__int64 __fastcall sub_1800796C4(_QWORD *a1, _QWORD *a2, _QWORD *a3, __int64 a4, __int64 a5, __int64 a6)
{
  __int64 v10; // rcx
  __int64 *v11; // rax
  ...
  *((_QWORD *)&v25 + 1) = v10;
  ...
  v34 = 0;
  v11 = sub_1800779BC((__int64)a1, &v43);
  ...
  v26 = *v11;
  v27 = v12;
  sub_180073974(v38, &v26, (__int64)&v33);
  ...
  *((_QWORD *)&v28 + 1) = v15;
  sub_180114E54(
    ...
    1);
  memset(v42, 0, 24);
  v37 = _mm_load_si128(xmmword_180144F90);
  LOBYTE(v36[0]) = 0;
  sub_18000E118(v36, 0x1CuLL, 0LL, "kSpectreRenderCB_PostPresent");
  v16 = sub_1800779BC((__int64)a1, &v45);
  ...
  v29 = *v16;
  v30 = v17;
  sub_180073974(v42, &v29, (__int64)v36);
  ...
  *(_QWORD *)&v32 = *a2;
  *((_QWORD *)&v32 + 1) = v23;
  sub_180078A58((__int64)a1, 6u, (__int64)&v32, (__int64)&v31);
  sub_180074840(v42);
  return sub_180115050(v48);
}
