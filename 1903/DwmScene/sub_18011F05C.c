/*
 * XREFs of sub_18011F05C @ 0x18011F05C
 * Callers:
 *     sub_180122C00 @ 0x180122C00 (sub_180122C00.c)
 *     sub_180122C10 @ 0x180122C10 (sub_180122C10.c)
 * Callees:
...
__int64 __fastcall sub_18011F05C(__int64 a1, _QWORD *a2, double a3, int a4)
{
  ...
  sub_1801219EC(a1 + 144, v17, v27);
  v9 = v17[0] + 64;
  v10 = a2;
  if ( a2[3] >= 8uLL )
    v10 = (_QWORD *)*a2;
  if ( (unsigned __int8)sub_1801246AC(v17[0] + 64, v10) )
  {
    v11 = 2;
    if ( a4 == 2 )
    {
    ...
    else
    {
      v21 = 0LL;
      v22 = 0LL;
      sub_18001110C(v20, (__int64)a2);
      v12 = sub_180124548(v9, v20);
      if ( (unsigned __int8)sub_180124734(v12) )
      {
        ...
        if ( si128.m128i_i64[1] >= 8uLL )
          v13 = (__int64 *)v25[0];
        if ( (unsigned __int8)sub_1801246AC(v12, v13)
          && (v18 = 0LL,
              v19 = 0LL,
              sub_18001110C(v17, (__int64)v25),
              v14 = sub_180124548(v12, v17),
              (unsigned __int8)sub_180124724(v14)) )
        {
          if ( sub_1801245AC(v14) != a3 )
          {
            v18 = 0LL;
            v19 = 0LL;
            sub_18001110C(v17, (__int64)v25);
            sub_18011EF90(v12, v17, a3);
            v11 = 1;
          }
        }
        else
      ...
      else if ( (unsigned __int8)sub_180124724(v12) )
      {
        if ( sub_1801245AC(v12) != a3 )
        {
          v21 = 0LL;
          v22 = 0LL;
          sub_18001110C(v20, (__int64)a2);
          sub_18011EF90(v9, v20, a3);
          v11 = 1;
        }
      }
      else
