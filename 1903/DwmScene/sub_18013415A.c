/*
 * XREFs of sub_18013415A @ 0x18013415A
 * Callers:
 *     <none>
 * Callees:
 ...
 *     ?__ExceptionPtrAssign@@YAXPEAXPEBX@Z @ 0x1801275FE (-__ExceptionPtrAssign@@YAXPEAXPEBX@Z.c)
 */

// positive sp value has been detected, the output may be wrong!
void *__fastcall sub_18013415A(__int64 a1, __int64 a2)
{
  void *v3; // rbx
