/*
 * XREFs of sub_180117B2C @ 0x180117B2C
 * Callers:
...
_DWORD *__fastcall sub_180117B2C(
        __int64 a1,
        __int64 a2,
        unsigned int a3,
        unsigned int a4,
        ...
        __int64 a8)
{
  ...
  if ( v22 != 0.0 )
  {
    ...
    *((float *)&v28 + 1) = (float)((float)(v14 * v18) - (float)(v9 * v16)) * (float)(1.0 / v22);
    ...
    sub_1800B822C((_DWORD *)(a7 + 12LL * a3), &v26);
    sub_1800B822C((_DWORD *)(a7 + 4 * v11), &v26);
    sub_1800B822C((_DWORD *)(a7 + 12LL * a5), &v26);
    sub_1800B822C((_DWORD *)(a8 + 4 * v10), &v28);
    sub_1800B822C((_DWORD *)(a8 + 4 * v11), &v28);
    return sub_1800B822C((_DWORD *)(a8 + 12LL * a5), &v28);
  }
  return result;
}
