/*
 * XREFs of sub_180099620 @ 0x180099620
 * Callers:
...
__int64 __fastcall sub_180099620(__int64 a1, unsigned __int64 a2)
{
  __int64 v2; // r9
  _QWORD *v3; // rdi
  __int64 v4; // rbx
  ...
  if ( a2 >= (*(_QWORD *)(a1 + 112) - v2) / 88 )
  {
    ...
    sub_18006575C(pExceptionObject, v9, 229LL, (__int64)v16, 0);
