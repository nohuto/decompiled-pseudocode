/*
 * XREFs of ?__scrt_initialize_thread_safe_statics@@YAHXZ @ 0x1801265C0
 * Callers:
 *     <none>
 * Callees:
...
LABEL_13:
  ...
  {
    hHandle = 0LL;
    ((void (__fastcall *)(void *))InitializeConditionVariable)(&unk_18026B440);
    qword_18026B450 = __ROR8__(SleepConditionVariableCS, 64 - ((unsigned __int8)_security_cookie & 0x3Fu)) ^ _security_cookie;
    qword_18026B458 = __ROR8__(v4, 64 - ((unsigned __int8)_security_cookie & 0x3Fu)) ^ _security_cookie;
  }
  else
  {
