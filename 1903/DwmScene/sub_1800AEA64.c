/*
 * XREFs of sub_1800AEA64 @ 0x1800AEA64
 * Callers:
 *     sub_1800B1670 @ 0x1800B1670 (sub_1800B1670.c)
 * Callees:
...
__int64 __fastcall sub_1800AEA64(__int64 a1, __int64 a2, __int64 a3, _OWORD *a4, int a5, int a6, _OWORD *a7, int a8)
{
  _OWORD *v11; // rax
  _OWORD *v12; // rax
  _OWORD *v13; // rax
  ...
  *(_DWORD *)&v35[16] = 1065353216;
  if ( a8 != 1 )
  {
    v14 = (_OWORD *)sub_1800AE978(a1, a6, a5);
    sub_180081CAC(&v28, v14);
    if ( a4 )
    {
      ...
      *(__m128 *)v26.m256i_i8 = sub_18001B264(&v24, *(double *)&v15, *(double *)&v16, *(double *)&v17);
      *(_OWORD *)&v26.m256i_u64[2] = v15;
      *(_OWORD *)v27.m256i_i8 = v16;
      *(_OWORD *)&v27.m256i_u64[2] = v17;
      v18 = (_OWORD *)sub_180017DE8((__int64)v25, &v28, &v26);
      sub_180081CAC(&v28, v18);
    }
    if ( a7 )
    {
      v26.m256i_i32[0] = 1065353216;
      ...
      *(__int64 *)((char *)&v27.m256i_i64[1] + 4) = 0LL;
      v27.m256i_i32[7] = 1065353216;
      *(__m128 *)v26.m256i_i8 = sub_18001B264(&v24, *(double *)&v19, *(double *)&v20, *(double *)&v21);
      *(_OWORD *)&v26.m256i_u64[2] = v19;
      *(_OWORD *)v27.m256i_i8 = v20;
      *(_OWORD *)&v27.m256i_u64[2] = v21;
      v22 = (_OWORD *)sub_180017DE8((__int64)v25, &v26, &v28);
      sub_180081CAC(&v28, v22);
    }
    *(_OWORD *)&v35[4] = 0uLL;
    v13 = (_OWORD *)sub_1800B16BC(&v28, v25);
    goto LABEL_11;
  }
  v11 = (_OWORD *)sub_1800AE978(a1, a5, a6);
  sub_180081CAC(&v28, v11);
  if ( a4 )
  {
    v12 = (_OWORD *)sub_180017DE8((__int64)&v26, a4, &v28);
    sub_180081CAC(&v28, v12);
  }
  if ( a7 )
  {
    v13 = (_OWORD *)sub_180017DE8((__int64)&v26, &v28, a7);
LABEL_11:
    sub_180081CAC(&v28, v13);
  }
  sub_1800B14B0(a2, a3, &v28);
  return a2;
}
