/*
 * XREFs of sub_1800A4330 @ 0x1800A4330
 * Callers:
 ...
 *     sub_1800A42EC @ 0x1800A42EC (sub_1800A42EC.c)
 *     j_j__o_free @ 0x180125F84 (j_j__o_free.c)
 */

// Hidden C++ exception states: #wind=2
_QWORD *__fastcall sub_1800A4330(__int64 a1, _QWORD *a2, __int64 a3)
{
  unsigned int v6; // edi
  const void **v7; // rax
  __int64 v8; // rcx
  ...
  *a2 = sub_18006DDDC();
  do
  {
    if ( _bittest64(&a3, v6) )
    {
      v7 = (const void **)sub_1800A42EC(a1, v10, v6);
      sub_1800A1C74(a2, (__int64)v12, 0, v7);
      if ( v11 >= 0x10 )
      {
        v8 = v10[0];
        if ( v11 + 1 >= 0x1000 )
