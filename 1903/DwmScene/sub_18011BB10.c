...
char __fastcall sub_18011BB10(__int64 a1, int a2, _BYTE *a3, _BYTE *a4)
{
  _QWORD *v4; // rbx
  ...
  v31 = a2;
  v4 = *(_QWORD **)(a1 + 112);
  v8 = sub_18011A4DC((__int64)v4);
  result = sub_18011BA5C(v4, v8, (_BYTE *)(a1 + 120));
  if ( (unsigned int)dword_18025DE60 > 5 && (qword_18025DE70 & 0x400000000000LL) != 0 )
  {
    ...
    if ( (qword_18025DE78 & 0x400000000000LL) == qword_18025DE78 )
    {
      v10 = *(_QWORD *)(a1 + 112);
      if ( v10 )
        sub_18011BA5C((_QWORD *)v10, _InterlockedExchangeAdd64((volatile signed __int64 *)(v10 + 144), 0LL), v14);
      else
        v14[0] = 0;
      v11 = -1LL;
      do
      ...
      v28 = a4;
      v29 = v11 + 1;
      return sub_180001128((__int64)&dword_18025DE60, (unsigned __int8 *)dword_1802244A8, 0LL, 0LL, 8u, &v15);
    }
  }
  return result;
}
