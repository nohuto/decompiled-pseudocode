/*
 * XREFs of sub_1800905EC @ 0x1800905EC
 * Callers:
...
__int64 __fastcall sub_1800905EC(__int64 a1, unsigned __int16 a2)
{
  _QWORD *v3; // rax
  _QWORD *v4; // rax
  __int64 v5; // rdi
  ...
  v3 = sub_1800905BC(a1, &v11);
  v4 = (_QWORD *)sub_1800F57F4(*v3, v9);
  v5 = sub_1800F2F68(*v4, a2);
  v6 = v10;
  if ( v10 )
  {
