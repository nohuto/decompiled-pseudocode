/*
 * XREFs of sub_18008D98C @ 0x18008D98C
 * Callers:
...
_QWORD *__fastcall sub_18008D98C(_QWORD *a1, _QWORD *a2, _QWORD *a3, _QWORD *a4)
{
  _QWORD *v5; // rbx
  _QWORD **v8; // r14
  _QWORD *v9; // rax
