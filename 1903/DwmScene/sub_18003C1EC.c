/*
 * XREFs of sub_18003C1EC @ 0x18003C1EC
 * Callers:
...
void __fastcall sub_18003C1EC(__int64 a1, const wchar_t *a2)
{
  unsigned int v4; // eax
  ...
  if ( a1 )
  {
    ...
    (*(void (__fastcall **)(__int64, void *, _QWORD, char *))(*(_QWORD *)a1 + 24LL))(a1, &unk_180210200, v4, String);
  }
}
