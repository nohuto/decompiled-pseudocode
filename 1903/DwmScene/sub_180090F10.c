/*
 * XREFs of sub_180090F10 @ 0x180090F10
 * Callers:
...
__int64 __fastcall sub_180090F10(__int64 a1, __int16 a2, __int64 a3, __int64 a4)
{
  __int64 v6; // rdx
  ...
  v23 = a2;
  v14 = a3;
  sub_18008F670((__int64 **)(a1 + 200), (__int64)&v17, (unsigned __int16 *)&v23);
  *(_DWORD *)(v17 + 32) = 1;
  v13 = 0LL;
  v6 = *(_QWORD *)(a1 + 104);
  if ( !v6 )
...
LABEL_19:
  ...
  v13 = *(_OWORD *)(a1 + 96);
  v8 = sub_18008F718(&v20, (__int64 *)&v13, &v23, &v14);
  v15 = 0LL;
  v15 = *(_OWORD *)v8;
  *v8 = 0LL;
  v8[1] = 0LL;
  result = sub_1800E275C(a4, v18, v14, &v15, v13);
  v10 = v19;
  if ( v19 )
  {
