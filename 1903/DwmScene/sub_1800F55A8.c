/*
 * XREFs of sub_1800F55A8 @ 0x1800F55A8
 * Callers:
 ...
 *     sub_1800F2EE4 @ 0x1800F2EE4 (sub_1800F2EE4.c)
...
__int64 __fastcall sub_1800F55A8(__int64 a1)
{
  __int64 v2; // r14
  __int64 result; // rax
  _QWORD *v4; // rax
  ...
  if ( *(_DWORD *)(a1 + 104) != (_DWORD)result )
  {
    v29 = 0LL;
    v30 = 0LL;
    sub_1800F2EE4(*(_QWORD *)(a1 + 16), &v29);
    v4 = (_QWORD *)sub_1800F57F4(v2, &v23);
    v5 = v29 != *v4;
    v6 = v24;
    if ( v24 )
    {
    ...
    {
      sub_18000E498(v27);
      v22 = sub_18000E498(v26);
      sub_180027770(pExceptionObject, v22, 741, (__int64)v27, 0);
