...
__int64 __fastcall sub_18011FBAC(__int64 a1, _QWORD *a2, _DWORD *a3)
{
  ...
  if ( (unsigned __int8)sub_1801246AC(v9 + 64, v10) )
  {
    ...
    v13 = (Concurrency::details::WorkItem *)sub_180124548(v9 + 64, v19);
    if ( (unsigned __int8)sub_180124734(v13) )
    {
      ...
      if ( (unsigned __int8)sub_1801246AC(v13, v14)
        && (v20[2] = 0LL,
            ...
            v15 = (Concurrency::details::WorkItem *)sub_180124548(v13, v20),
            Concurrency::details::WorkItem::IsContext(v15)) )
      {
        *a3 = sub_1801245B4(v15);
        v11 = 0;
      }
      else
      {
