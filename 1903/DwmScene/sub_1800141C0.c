/*
 * XREFs of sub_1800141C0 @ 0x1800141C0
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall sub_1800141C0(__int64 a1, __int64 a2)
{
  __int64 v3; // r14
  _QWORD *v4; // rsi
  __int64 v5; // r8
  ...
  *((_QWORD *)&v32 + 1) = v14;
  ...
  if ( (_QWORD)v49 != (_QWORD)v32 )
  {
    ...
    {
      sub_1800779F0(*(_QWORD *)(v3 + 56), &v43);
      ...
      v51 = 0LL;
      v18 = v34;
      sub_1800631C0(v34 + 16, &v50);
      v45[2] = 0LL;
      v45[3] = 0LL;
      sub_18001110C(v45, (__int64)&unk_1802587A8);
      v19 = (__int64 *)sub_18008B2A0(v18, v46, v45);
    ...
    if ( (_QWORD)v48 == (_QWORD)v34 )
    {
      ...
      *(_QWORD *)&v40 = *v4;
      *((_QWORD *)&v40 + 1) = v26;
      sub_18008C500(v48, &v40, &v42);
    }
    else
    {
      v54 = 0LL;
      v55 = 0LL;
      sub_1800631C0(v34 + 16, &v54);
      v52 = 0LL;
      v53 = 0LL;
      v41 = 0LL;
      if ( *((_QWORD *)&v32 + 1) )
        _InterlockedIncrement((volatile signed __int32 *)(*((_QWORD *)&v32 + 1) + 8LL));
      v41 = v32;
      sub_180082838(*v4, &v52, 131075LL, &v41);
      v39 = 0LL;
      v24 = v4[1];
      if ( v24 )
      {
