...
__int64 __fastcall sub_180120040(__int64 a1, _QWORD *a2, __m128i *a3)
{
  ...
  if ( (unsigned __int8)sub_1801246AC(v9 + 64, v10) )
  {
    v25[2] = 0LL;
    v25[3] = 0LL;
    sub_18001110C(v25, (__int64)a2);
    v13 = (__crt_strtox *)sub_180124548(v9 + 64, v25);
    if ( (unsigned __int8)sub_180124734(v13) )
    {
      si128 = _mm_load_si128((const __m128i *)&xmmword_18014AA40);
      LOWORD(v31[0]) = 0;
      sub_180026168((char *)v31, L"Value", 5uLL);
      v15 = v31;
      if ( si128.m128i_i64[1] >= 8uLL )
        v15 = (__int64 *)v31[0];
      if ( (unsigned __int8)sub_1801246AC(v13, v15)
        && (v26[2] = 0LL,
            v26[3] = 0LL,
            sub_18001110C(v26, (__int64)v31),
            v16 = (__crt_strtox *)sub_180124548(v13, v26),
            __crt_strtox::is_zero(v16, v17)) )
      {
        sub_180124680(v16, &v23);
        if ( a3 != &v23 )
        {
          unknown_libname_116(a3->m128i_i64);
          *a3 = v23;
          a3[1] = v24;
          v24 = _mm_load_si128((const __m128i *)&xmmword_18014AA40);
          v23.m128i_i16[0] = 0;
        }
    ...
    {
      v22 = 0LL;
      sub_18001110C(&v21, (__int64)v13 + 8);
      if ( a3 != &v21 )
      {
        unknown_libname_116(a3->m128i_i64);
        *a3 = v21;
        a3[1] = v22;
        v22 = _mm_load_si128((const __m128i *)&xmmword_18014AA40);
        v21.m128i_i16[0] = 0;
      }
  ...
  else
  {
    v29 = 0LL;
    v30 = 0LL;
    sub_18008B420(a1, &v29);
    if ( v29 )
      v11 = sub_180120040(v29, a2, a3);
    else
      v11 = 2;
    v12 = v30;
    if ( v30 )
