/*
 * XREFs of sub_1800B73C4 @ 0x1800B73C4
 * Callers:
...
__m128 *__fastcall sub_1800B73C4(__m128 *a1, __m128 *a2)
{
  __m128 *v4; // r15
  __m128 *v5; // rsi
  __m128 v6; // xmm6
  ...
  v5 = a2 + 4;
  v6 = _mm_mul_ps(*v4, (__m128)xmmword_1801F3F20);
  if ( a2 == (__m128 *)-64LL )
    wassert(L"pSource", L"d:\\os\\public\\amd64fre\\sdk\\inc\\DirectXMathConvert.inl", 0x2A5u);
  v7 = a2 + 3;
  v8 = _mm_mul_ps(*v5, (__m128)xmmword_1801F3F30);
  if ( a2 == (__m128 *)-48LL )
    wassert(L"pSource", L"d:\\os\\public\\amd64fre\\sdk\\inc\\DirectXMathConvert.inl", 0x2A5u);
  v9 = _mm_add_ps(v6, _mm_add_ps(v8, _mm_mul_ps(*v7, (__m128)xmmword_1801F3F30)));
  ...
  if ( a2 == (__m128 *)-16LL )
    wassert(L"pSource", L"d:\\os\\public\\amd64fre\\sdk\\inc\\DirectXMathConvert.inl", 0x2A5u);
  v10 = _mm_mul_ps(a2[1], (__m128)xmmword_1801F3F50);
  ...
  if ( a2 == (__m128 *)-32LL )
    wassert(L"pSource", L"d:\\os\\public\\amd64fre\\sdk\\inc\\DirectXMathConvert.inl", 0x2A5u);
  v11 = _mm_mul_ps(a2[2], (__m128)xmmword_1801F3F50);
  ...
  if ( !a2 )
    wassert(L"pSource", L"d:\\os\\public\\amd64fre\\sdk\\inc\\DirectXMathConvert.inl", 0x2A5u);
  v12 = _mm_mul_ps(*a2, (__m128)xmmword_1801F3F50);
  ...
  if ( a2 == (__m128 *)-128LL )
    wassert(L"pSource", L"d:\\os\\public\\amd64fre\\sdk\\inc\\DirectXMathConvert.inl", 0x2A5u);
  v13 = _mm_mul_ps(a2[8], (__m128)xmmword_1801F3F60);
  ...
  if ( a2 == (__m128 *)-96LL )
    wassert(L"pSource", L"d:\\os\\public\\amd64fre\\sdk\\inc\\DirectXMathConvert.inl", 0x2A5u);
  v14 = _mm_mul_ps(a2[6], (__m128)xmmword_1801F3F60);
  ...
  v15 = _mm_sub_ps(
          _mm_sub_ps(_mm_mul_ps(*v4, (__m128)xmmword_1801F3F70), _mm_mul_ps(*v7, (__m128)xmmword_1801F3F40)),
          _mm_mul_ps(*v5, (__m128)xmmword_1801F3F40));
  ...
  if ( !v16 )
    wassert(L"pSource", L"d:\\os\\public\\amd64fre\\sdk\\inc\\DirectXMathConvert.inl", 0x2A5u);
  v17 = _mm_mul_ps(*v16, (__m128)xmmword_1801F3F60);
  ...
  if ( !v5 )
    wassert(L"pSource", L"d:\\os\\public\\amd64fre\\sdk\\inc\\DirectXMathConvert.inl", 0x2A5u);
  v18 = _mm_mul_ps(*v5, (__m128)xmmword_1801F3F60);
  if ( !v7 )
    wassert(L"pSource", L"d:\\os\\public\\amd64fre\\sdk\\inc\\DirectXMathConvert.inl", 0x2A5u);
  v19 = _mm_sub_ps(_mm_mul_ps(*v7, (__m128)xmmword_1801F3F60), v18);
  ...
  sub_1800B7340(a1, COERCE_DOUBLE(1078530011LL));
  return a1;
}
