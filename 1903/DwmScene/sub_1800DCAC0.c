/*
 * XREFs of sub_1800DCAC0 @ 0x1800DCAC0
 * Callers:
...
__int64 __fastcall sub_1800DCAC0(__int64 a1, _BYTE *a2, __int64 a3)
{
  __int64 result; // rax
  __int64 v7; // rax
  int v8; // r12d
    ...
    || (result = *(unsigned int *)(a3 + 20), *(_DWORD *)(a1 + 28) != (_DWORD)result) )
  {
    ...
    *(_QWORD *)(a1 + 24) = *(_QWORD *)(a3 + 16);
    ...
    sub_18000DC70((__int64)v37, &v47, 0);
    v16 = (__int64 *)(a1 + 456);
    ...
    v19 = *v16;
    v40[0] = (__int64)v18;
    sub_1800644E4(v19, v40);
    sub_180064C9C(*v16, *(_DWORD *)a3, *(_DWORD *)(a3 + 4), *(_DWORD *)(a3 + 8), v12, (__int64)a2);
    v20 = sub_18007797C((__int64)v37, 1);
    v21 = (*(unsigned __int8 (__fastcall **)(__int64, void *, _QWORD))(*(_QWORD *)v20 + 64LL))(v20, &unk_1802589D8, 0LL)
       && (*(unsigned __int8 (__fastcall **)(_BYTE *, __int64))(*(_QWORD *)a2 + 96LL))(a2, 6LL);
    v22 = v12 | 0x100;
    v38 = v21 + 1;
    if ( !v21 )
      v22 = v12;
    sub_180026770(v37, &v49, 1u);
    v23 = (__int64 *)(a1 + 472);
    ...
    v26 = *v23;
    v41 = v25;
    sub_1800644E4(v26, (__int64 *)&v41);
    sub_1800D0348((_QWORD *)*v23, *(_DWORD *)a3, *(_DWORD *)(a3 + 4), v38, v22, (__int64)a2);
    v27 = *v16;
    v28 = sub_18006CDB8((__int64)a2);
    v29 = *(_QWORD *)(v27 + 136);
    if ( v29 )
      v30 = sub_180067E94(v29, v28);
    else
      v30 = 0;
    if ( v30 <= 1 )
    {
