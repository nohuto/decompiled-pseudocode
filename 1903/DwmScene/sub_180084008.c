/*
 * XREFs of sub_180084008 @ 0x180084008
 * Callers:
...
__m128 *__fastcall sub_180084008(__int64 a1, __m128 *a2)
{
  __int64 v4; // rdx
  ...
  if ( (_QWORD)v12 )
  {
    ...
    v6 = 7;
    v9 = (__m128 *)sub_180084008(v11, v14);
  }
  else
  {
  ...
  sub_180081E98(a2, (__m128 *)(a1 + 156), &v15);
  return a2;
}
