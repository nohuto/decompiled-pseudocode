/*
 * XREFs of sub_180069010 @ 0x180069010
 * Callers:
...
__int64 __fastcall sub_180069010(float *a1, float a2, float a3, float a4, float a5)
{
  __int64 result; // rax
  _QWORD *v7; // r8
  __int64 v8; // rdx
  ...
  if ( (_QWORD)v23 )
  {
    ...
    *((_DWORD *)a1 + 42) = v13;
    ...
    if ( (_BYTE)result )
    {
      ...
      *(float *)v24 = a1[41];
      *(float *)&v24[1] = a1[42];
      v25 = (*(__int64 (__fastcall **)(float *, _QWORD))(*(_QWORD *)a1 + 264LL))(a1, 0LL);
      v26 = (*(__int64 (__fastcall **)(float *, __int64))(*(_QWORD *)a1 + 264LL))(a1, 1LL);
      v27 = (*(__int64 (__fastcall **)(float *, __int64))(*(_QWORD *)a1 + 264LL))(a1, 2LL);
      v28 = 0;
      v14 = (_QWORD *)(*(__int64 (__fastcall **)(float *))(*(_QWORD *)a1 + 152LL))(a1);
      sub_1800DCAC0(*v14, v23, v24);
      sub_180068EC4((__int64)a1);
      v15 = *v14;
      ...
      v20 = *(_QWORD *)(v15 + 456);
      v17 = sub_18006CDB8(v23);
      v18 = *(_QWORD *)(v20 + 136);
      if ( v18 )
        result = sub_180067E94(v18, v17);
      else
        result = 0LL;
      *((_DWORD *)a1 + 43) = result;
      if ( v16 )
