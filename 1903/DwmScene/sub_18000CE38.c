  ...
  *a3 = 0LL;
  ...
  if ( !v7 )
  {
    if ( GetLastError() != 2 )
    {
      v9 = 192;
LABEL_6:
      v10 = sub_18000C30C(retaddr, v9, (__int64)&unk_1801431D4);
      goto LABEL_21;
    }
LABEL_20:
    v10 = 0;
  ...
  if ( v12 < 0 )
  {
    sub_18000C338(retaddr, 198, (__int64)&unk_1801431D4, v12);
    goto LABEL_21;
  }
  if ( !a2 )
  {
LABEL_17:
  ...
  sub_18000C338(retaddr, 206, (__int64)&unk_1801431D4, v15);
  if ( !CloseHandle(v14) )
  {
    sub_18000D190(retaddr, 2288LL, "d:\\os\\public\\amd64fre\\internal\\sdk\\inc\\wil\\opensource\\wil\\resource.h");
    __debugbreak();
