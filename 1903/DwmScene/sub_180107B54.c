/*
 * XREFs of sub_180107B54 @ 0x180107B54
 * Callers:
...
unsigned __int8 __fastcall sub_180107B54(char *a1, char *a2, char a3)
{
  __int64 v6; // rbp
  ...
  if ( v6 > 32 )
  {
    ...
    result = sub_18010772C(a1, a2, v6, v9, v10, a3);
    if ( v10 > 0x100 )
      return j__o_free(v9);
  }
  else if ( v6 > 1 )
  {
    return (unsigned __int8)sub_18010743C(&v8, a1, a2);
  }
  return result;
}
