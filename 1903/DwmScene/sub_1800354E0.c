/*
 * XREFs of sub_1800354E0 @ 0x1800354E0
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall sub_1800354E0(__int64 a1, __int64 *a2, unsigned int a3, __int128 *a4, unsigned __int8 a5)
{
  __int64 v8; // r15
  __int64 v9; // r14
  __int64 v10; // rdi
  ...
  if ( *a2 )
  {
    v19 = 0LL;
    v20 = 0LL;
    sub_180033E08((__int64 *)(v11 + 128), &v19, *(_DWORD *)(a1 + 88));
    v12 = v19;
    v8 = *(_QWORD *)sub_18003EBA4(v19, &v21);
    v13 = v21;
    if ( v21 )
    {
      v21 = 0LL;
    ...
    v10 = *(_QWORD *)sub_18003E8CC(v12, v23);
    v15 = v23[0];
    if ( v23[0] )
    {
      v23[0] = 0LL;
  ...
  (*(void (__fastcall **)(_QWORD, __int64, __int128 *, _QWORD))(**(_QWORD **)(a1 + 144) + 280LL))(
    *(_QWORD *)(a1 + 144),
    ...
    a3);
  v17 = sub_1800D0C78();
  return sub_1800D0C60(v17, 4LL, 1LL, 1LL);
}
