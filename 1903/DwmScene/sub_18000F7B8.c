/*
 * XREFs of sub_18000F7B8 @ 0x18000F7B8
 * Callers:
...
_QWORD *__fastcall sub_18000F7B8(__int64 a1, _QWORD *a2)
{
  __int64 v4; // r14
  ...
  *(_QWORD *)&v11 = a2;
  sub_180087414(a1);
  v4 = *(_QWORD *)sub_18000F9B8(a1, v14);
  v5 = v15;
  if ( v15 )
  {
