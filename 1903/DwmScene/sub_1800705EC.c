/*
 * XREFs of sub_1800705EC @ 0x1800705EC
 * Callers:
 ...
 *     sub_1800660FC @ 0x1800660FC (sub_1800660FC.c)
 *     sub_180066388 @ 0x180066388 (sub_180066388.c)
 *     memcmp @ 0x180125AA8 (memcmp.c)
 */

_QWORD *__fastcall sub_1800705EC(__int64 ***a1, _QWORD *a2, __int64 *a3, size_t *a4, _QWORD *a5)
{
  __int64 **v9; // rsi
  const void *v10; // rdx
  const void *v11; // rcx
  ...
  if ( a1[1] )
  {
    ...
    if ( a3 == **a1 )
    {
      ...
      if ( v15 < 0 )
      {
        sub_1800660FC(a1, a2, 1, a3, (int)a4, a5);
        return a2;
      }
      goto LABEL_91;
    }
    if ( a3 == (__int64 *)v9 )
    {
      ...
      if ( v23 < 0 )
      {
        sub_1800660FC(a1, a2, 0, v17, (int)a4, a5);
        return a2;
      }
      goto LABEL_91;
    }
    ...
    if ( v29 < 0 )
    {
      ...
      {
        if ( *(_BYTE *)(v30[2] + 25) )
          sub_1800660FC(a1, a2, 0, v30, (int)a4, a5);
        else
          sub_1800660FC(a1, a2, 1, a3, (int)a4, a5);
        return a2;
      }
    ...
    if ( (__int64 **)v39 != v9 )
    {
      ...
      {
LABEL_91:
        *a2 = *(_QWORD *)sub_180066388(a1, (__int64)v54, 0, a4, a5);
        return a2;
      }
    }
    if ( v49 )
      sub_1800660FC(a1, a2, 0, a3, (int)a4, a5);
    else
      sub_1800660FC(a1, a2, 1, (_QWORD *)v39, (int)a4, a5);
    return a2;
  }
  else
  {
    try
    {
      sub_1800660FC(a1, a2, 1, *a1, (int)a4, a5);
      result = a2;
    }
    catch ( ... )
    {
      sub_180069650(v54[0], (__int64)v53);
      throw;
    }
  }
  return result;
