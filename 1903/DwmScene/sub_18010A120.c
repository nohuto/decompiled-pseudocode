...
__int64 __fastcall sub_18010A120(_QWORD *a1, __int64 *a2, _QWORD *a3)
{
  __int64 v6; // rcx
  __int64 v7; // rcx
  _QWORD *v8; // rax
  ...
  *(_QWORD *)&v21 = *a3;
  *((_QWORD *)&v21 + 1) = v7;
  sub_180108C20((__int64)v25, 0, &v21, &v20, a1[114]);
  v8 = (_QWORD *)sub_1801081E8((__int64)(a1 + 110), (__int64)a2);
  sub_180108934(a1 + 110, (__int64)&v24, 0, v8 + 4, v8);
  sub_1800E0E9C(v28);
  sub_1800E0E9C(v27);
  result = sub_18011E090(&v26);
  v10 = a2[3];
  if ( v10 >= 0x10 )
  {
    v11 = *a2;
