/*
 * XREFs of sub_1801016F0 @ 0x1801016F0
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall sub_1801016F0(_QWORD *a1)
{
  __int64 v2; // rbx
  __int64 v3; // rbx
  __int64 v4; // rbx
  ...
  v9 = 0LL;
  std::shared_ptr<__ExceptionPtr>::operator=(a1 + 225, (__int64 *)&v9);
  if ( *((_QWORD *)&v9 + 1) )
  {
  ...
  v10 = 0LL;
  std::shared_ptr<__ExceptionPtr>::operator=(a1 + 227, (__int64 *)&v10);
  if ( *((_QWORD *)&v10 + 1) )
  {
  ...
  v11 = 0LL;
  std::shared_ptr<__ExceptionPtr>::operator=(a1 + 229, (__int64 *)&v11);
  if ( *((_QWORD *)&v11 + 1) )
  {
  ...
  v12 = 0LL;
  std::shared_ptr<__ExceptionPtr>::operator=(a1 + 235, (__int64 *)&v12);
  if ( *((_QWORD *)&v12 + 1) )
  {
  ...
  v13 = 0LL;
  std::shared_ptr<__ExceptionPtr>::operator=(a1 + 237, (__int64 *)&v13);
  if ( *((_QWORD *)&v13 + 1) )
  {
  ...
  v14 = 0LL;
  std::shared_ptr<__ExceptionPtr>::operator=(a1 + 239, (__int64 *)&v14);
  if ( *((_QWORD *)&v14 + 1) )
  {
  ...
  return sub_1800B13B0((__int64)a1);
}
