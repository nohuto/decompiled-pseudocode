/*
 * XREFs of sub_1800B0DD4 @ 0x1800B0DD4
 * Callers:
...
__int64 *__fastcall sub_1800B0DD4(__int64 a1, int a2, int a3, __int64 *a4, __int64 *Src, __int64 *a6)
{
  __int64 *result; // rax
  ...
  *(_DWORD *)(a1 + 172) = a2;
  *(_DWORD *)(a1 + 176) = a3;
  sub_180011714((__int64 *)(a1 + 184), a4);
  sub_180011714((__int64 *)(a1 + 216), Src);
  result = sub_180011714((__int64 *)(a1 + 248), a6);
  v9 = a4[3];
  if ( v9 >= 0x10 )
  {
    v10 = *a4;
