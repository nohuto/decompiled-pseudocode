/*
 * XREFs of sub_1800D7864 @ 0x1800D7864
 * Callers:
...
__int128 *__fastcall sub_1800D7864(__int64 a1, __int128 *a2)
{
  double *i; // rdi
  __int128 v5; // xmm0
  double *v6; // r15
      ...
      *((double *)&v22 + 1) = v10;
      ...
      if ( v13 || v14 )
      {
        while ( 1 )
        {
          ...
          if ( v16 || v17 )
            break;
          sub_180017CD4(v7, (__int64)(v6 - 5));
          v7[4] = *(v6 - 1);
          v7[5] = *v6;
          v7 = v6 - 5;
        }
        sub_180017CD4(v7, (__int64)&v20);
        *((_OWORD *)v7 + 2) = v22;
      }
      else
      {
        sub_1800D7CB4(a1, i, i + 6);
        sub_180017CD4((_QWORD *)a1, (__int64)&v20);
        *(_OWORD *)(a1 + 32) = v22;
      }
