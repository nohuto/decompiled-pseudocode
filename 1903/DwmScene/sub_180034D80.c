/*
 * XREFs of sub_180034D80 @ 0x180034D80
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall sub_180034D80(__int64 a1, _QWORD *a2, unsigned int a3)
{
  __int64 v6; // rax
  __int64 *v7; // rcx
  char v8; // di
  ...
  *v7 = 0LL;
  ...
  if ( v16 )
  {
    v11 = *(_QWORD *)sub_18003DB4C(v16, &v22);
    v12 = v22;
    if ( v22 )
    {
      v22 = 0LL;
    ...
    v14 = (unsigned int)sub_1800299C8(v13, 0);
  }
  else
  {
    v11 = 0LL;
