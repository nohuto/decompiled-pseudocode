/*
 * XREFs of sub_1800F7314 @ 0x1800F7314
 * Callers:
...
__int64 __fastcall sub_1800F7314(__int128 *a1, __int64 *a2, __int64 a3, unsigned int a4)
{
  __int64 v7; // r10
  __int64 v8; // r9
  ...
  sub_1800F74A8(a1, &v16);
  sub_1800A802C(*((_QWORD *)a1 + 2), (__int64)a2, a4);
  sub_18006AA78(*a2);
  sub_18006AC50(*a2, (_QWORD *)a1 + 22);
  v17 = 0LL;
  v10 = *((_QWORD *)a1 + 1);
  if ( !v10 )
  {
LABEL_17:
  ...
  v17 = *a1;
  result = (__int64)sub_18006AB24(*a2, &v17);
