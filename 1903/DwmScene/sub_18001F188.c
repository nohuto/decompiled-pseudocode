/*
 * XREFs of sub_18001F188 @ 0x18001F188
 * Callers:
...
_QWORD *__fastcall sub_18001F188(_QWORD *Src, unsigned __int64 a2, __int64 a3, const void *a4, __int64 a5)
{
  __int64 v5; // r14
  __int64 v6; // rbx
  ...
  v13 = sub_180011480((__int64)Src, v6 + 1);
  Src[2] = v10;
  v14 = 2 * v5;
  v15 = a5 + v5;
  Src[3] = v6;
