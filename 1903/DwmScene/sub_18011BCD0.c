...
int __fastcall sub_18011BCD0(__int64 a1, char a2, _BYTE *a3, _BYTE *a4, void *a5)
{
  _QWORD *v5; // rbx
  ...
  v5 = *(_QWORD **)(a1 + 112);
  v10 = sub_18011A4DC((__int64)v5);
  sub_18011BA5C(v5, v10, (_BYTE *)(a1 + 120));
  v11 = "success";
  v12 = "fail";
  if ( a2 )
    v12 = "success";
  if ( (unsigned int)dword_18025DE60 > 5 && (qword_18025DE70 & 0x400000000000LL) != 0 )
  {
    ...
    if ( (qword_18025DE78 & 0x400000000000LL) == qword_18025DE78 )
    {
      v13 = *(_QWORD *)(a1 + 112);
      if ( v13 )
        sub_18011BA5C((_QWORD *)v13, _InterlockedExchangeAdd64((volatile signed __int64 *)(v13 + 144), 0LL), v26);
      else
        v26[0] = 0;
      v14 = -1LL;
      do
      ...
      v47 = v22;
      v48 = v20 + 1;
      LODWORD(v11) = sub_180001128((__int64)&dword_18025DE60, (unsigned __int8 *)dword_1802243F9, 0LL, 0LL, 0xAu, &v27);
    }
  }
  return (int)v11;
}
