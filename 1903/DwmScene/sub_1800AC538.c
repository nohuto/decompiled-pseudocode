/*
 * XREFs of sub_1800AC538 @ 0x1800AC538
 * Callers:
...
__int64 __fastcall sub_1800AC538(_QWORD *a1, __int64 a2, __int64 a3, _QWORD *a4, __int64 a5)
{
  __int64 v7; // rdx
  __int64 v8; // rbx
  unsigned int v9; // edi
  ...
  if ( a1[15] == v7 )
  {
    sub_1800AA990(a1 + 13, v7, (__int64)v15);
    v8 = *((_QWORD *)&v19 + 1);
  }
  else
  {
  ...
  v14[2] = 0LL;
  v14[3] = 0LL;
  sub_18000F3F4(v14, (__int64)&qword_18025BAF8);
  sub_1800B1100(a1, v14, v13, v9, -2LL, v13[0], 0LL);
  if ( v8 )
  {
