...
__int64 **__fastcall sub_18002FF48(__int64 a1, __int64 **a2, __int64 a3, char a4, int a5)
{
  int v8; // eax
  __int64 v9; // r14
  ...
  if ( (a4 & 1) != 0 )
  {
    ...
    if ( v13 < 0 )
    {
      ...
      sub_18000E498(v28);
      v23 = (unsigned int)sub_18000E498(v27);
      sub_180065810((unsigned int)pExceptionObject, v23, 876, v13, (__int64)v28, 0);
      throw (Spectre::Engine::EngineException *)pExceptionObject;
    }
    v14 = sub_1800642F8(a1, v24);
    if ( *(_QWORD *)(v14 + 24) >= 0x10uLL )
      v14 = *(_QWORD *)v14;
    sub_18000EE28(v30, (const char *)v14);
    if ( v25 >= 0x10 )
    {
      v15 = v24[0];
      if ( v25 + 1 >= 0x1000 )
