/*
 * XREFs of sub_1800B1584 @ 0x1800B1584
 * Callers:
...
__int32 *__fastcall sub_1800B1584(int a1, __int32 *a2, __int32 *a3, int a4, int a5)
{
  __int32 v6; // xmm1_4
  __m128 v7; // xmm6
  __int32 v8; // xmm0_4
  ...
  v12 = v13;
  sub_1800B1670(a1, (unsigned int)&v13, (unsigned int)&v12, a4, a5, 1);
