/*
 * XREFs of __scrt_dllmain_after_initialize_c @ 0x180125BDC
 * Callers:
 ...
 *     _o__configure_narrow_argv @ 0x1801259F5 (_o__configure_narrow_argv.c)
 *     _o__initialize_narrow_environment @ 0x180125A0D (_o__initialize_narrow_environment.c)
