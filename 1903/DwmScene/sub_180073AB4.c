/*
 * XREFs of sub_180073AB4 @ 0x180073AB4
 * Callers:
...
_QWORD *__fastcall sub_180073AB4(_QWORD *a1, unsigned int a2, _QWORD *a3, _QWORD *a4, _QWORD *a5)
{
  void *v9; // rax
  __int64 v10; // rcx
  void *v11; // rax
  ...
  *a1 = &Spectre::Engine::Engine::`vftable';
  ...
  a1[12] = 0LL;
  a1[13] = 0LL;
  sub_18006303C((__int64)(a1 + 14), a2);
  a1[21] = 0LL;
  a1[22] = 0LL;
  a1[21] = sub_18007DD44(a1 + 21);
  v22 = a1 + 23;
  a1[23] = 0LL;
  a1[24] = 0LL;
  a1[23] = sub_18006DDDC();
  ...
  *((_DWORD *)a1 + 60) = 2;
  ...
  a1[37] = 0LL;
  a1[38] = 0LL;
  sub_18006303C((__int64)(a1 + 39), a2);
  sub_1800E3100(a1 + 46);
  a1[58] = 0LL;
  a1[59] = 0LL;
  a1[58] = *a3;
  ...
  *((_BYTE *)a1 + 744) = 1;
  ...
  sub_18006303C((__int64)(a1 + 101), a2);
  a1[108] = 0LL;
  a1[109] = 0LL;
  a1[110] = 0LL;
  a1[111] = 0LL;
  ...
  *(_QWORD *)((char *)a1 + 956) = 1023960469LL;
  ...
  if ( v11 )
  {
    ...
    v11 = (void *)sub_1800E3248(v12);
  }
  a1[123] = v11;
  a1[134] = 0LL;
  a1[135] = 0LL;
  a1[136] = 0LL;
  a1[135] = sub_180041C80();
  *((_DWORD *)a1 + 274) = 1;
  sub_18006303C((__int64)(a1 + 138), (unsigned int)v23);
  *((_BYTE *)a1 + 1160) = 0;
  a1[147] = 0LL;
  a1[148] = 0LL;
  *((_DWORD *)a1 + 298) = 0;
  ...
  *(_QWORD *)((char *)a1 + 1372) = 2139095039LL;
  ...
  a1[177] = 7LL;
  *((_WORD *)a1 + 696) = 0;
  sub_180026168((char *)a1 + 1392, &unk_1801E26D8, 0LL);
  a1[178] = 0LL;
  a1[179] = 0LL;
  a1[178] = sub_18007DD0C(a1 + 178);
  v23 = a1 + 180;
  a1[180] = 0LL;
  a1[181] = 0LL;
  a1[180] = sub_18002B69C();
  sub_1800759B0(a1, 0LL);
  v22 = a1;
  v13 = sub_1800733A0(&v29, &v22);
