...
__int64 __fastcall sub_18000E9D0(__int64 a1, _QWORD *a2)
{
  __int64 result; // rax
  __int64 v5; // rsi
  __int64 v6; // rcx
  ...
  v41 = 0LL;
  v42 = 0LL;
  result = sub_180029B04(a1, &v41);
  if ( v41 )
  {
    v39 = 0LL;
    v40 = 0LL;
    sub_18000D9E0(v41, &v39);
    v30 = 15LL;
    v28[0] = 0;
    v29 = 6LL;
    memmove(v28, "Output", 6uLL);
    v28[6] = 0;
    sub_1800644E4(v39, v28);
    (*(void (__fastcall **)(_QWORD, _DWORD *))(*(_QWORD *)*a2 + 80LL))(*a2, v44);
    v37 = 0LL;
    v5 = *(_QWORD *)sub_18002317C(v41, &v24);
    v6 = v37;
    if ( v37 )
    {
      v37 = 0LL;
    ...
    if ( v7 < 0 )
    {
      ...
      v20 = sub_18000F794(v33, (unsigned int)v7);
      v21 = unknown_libname_174(v43, " HRESULT=");
      unknown_libname_112(v21, v20);
      std::string::_Tidy_deallocate(v33);
      unknown_libname_3(v43);
      sub_18000E498(v35);
      v22 = (unsigned int)sub_18000E498(v34);
      sub_180065810((unsigned int)pExceptionObject, v22, 155, v7, (__int64)v35, 0);
      throw (Spectre::Engine::EngineException *)pExceptionObject;
    }
    sub_18000EE28(*a2, "RenderOutput ColorBuffer");
    sub_18000EE28(v37, "RenderOutput ColorBuffer");
    v9 = _RTDynamicCast(
           v39,
           0LL,
    ...
    sub_18002C1D0(v9, (unsigned int)&v23, (unsigned int)&v26, (unsigned int)&v25, v44[0], v44[1]);
    v11 = v37;
    if ( v37 )
    {
      v37 = 0LL;
    ...
    v12 = sub_18006CD84(v41);
    v38 = 0uLL;
    sub_18000DC70(v12, &v38, 0);
    sub_180064AEC(v38, &v39);
    v27 = v38;
    v38 = 0uLL;
    result = sub_180068920(a1, &v27);
