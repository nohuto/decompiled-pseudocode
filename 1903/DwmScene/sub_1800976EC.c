...
__int64 __fastcall sub_1800976EC(__int64 a1, __int64 a2)
{
  __int64 *v3; // rax
  __int64 *v4; // rax
  ...
  if ( *(_BYTE *)(a1 + 310) )
  {
    sub_18000E498(v6);
    v4 = sub_18000E498(v5);
    sub_18006575C(pExceptionObject, v4, 658LL, (__int64)v6, 0);
  ...
  if ( !a2 )
  {
    sub_18000E498(v5);
    v3 = sub_18000E498(v6);
    sub_180095020(pExceptionObject, v3, 663, (__int64)v5, 0);
    throw (Spectre::Engine::EngineInvalidPointerException *)pExceptionObject;
  }
  return sub_1800977BC(a1, a2, *(unsigned int *)(a1 + 120));
}
