/*
 * XREFs of sub_1800389A0 @ 0x1800389A0
 * Callers:
...
__int64 __fastcall sub_1800389A0(__int64 a1, __int64 a2, const void *a3, unsigned int a4)
{
  size_t v4; // r12
  int v8; // esi
  __int64 v9; // rdx
...
LABEL_3:
  ...
  if ( v8 < 0 )
  {
    ...
    sub_18000E498(v26);
    v19 = (unsigned int)sub_18000E498(v25);
    sub_180065810((unsigned int)pExceptionObject, v19, 432, v8, (__int64)v26, 0);
