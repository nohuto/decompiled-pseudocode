/*
 * XREFs of sub_1800A4A38 @ 0x1800A4A38
 * Callers:
...
_QWORD *__fastcall sub_1800A4A38(__int64 a1, _QWORD *a2, size_t *a3)
{
  __int64 *v5; // rsi
...
LABEL_11:
  ...
  sub_1800A1F4C(v5, (__int64)v20, a3);
  v12 = v20[0];
  *a2 = 0LL;
  a2[1] = 0LL;
  v13 = *(_QWORD *)(v12 + 72);
