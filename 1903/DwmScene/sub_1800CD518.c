/*
 * XREFs of sub_1800CD518 @ 0x1800CD518
 * Callers:
 *     sub_1800CE840 @ 0x1800CE840 (sub_1800CE840.c)
 * Callees:
...
_QWORD *__fastcall sub_1800CD518(__int64 a1, _QWORD *a2, __int64 a3, __int64 *a4)
{
  __int64 v7; // rbx
