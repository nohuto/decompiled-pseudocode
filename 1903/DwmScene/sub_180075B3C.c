/*
 * XREFs of sub_180075B3C @ 0x180075B3C
 * Callers:
...
__int64 __fastcall sub_180075B3C(__int64 a1, __int64 *a2)
{
  __int64 v4; // rdx
  _QWORD *v5; // rbx
  _QWORD *v6; // r14
  ...
  v55 = 0LL;
  v56 = 0LL;
  sub_180063178(a1 + 8, &v55);
  v53 = 0LL;
  v54 = 0LL;
  sub_180063178(a1 + 1104, &v53);
  sub_1800634AC(*a2 + 24, v4);
  if ( !*(_DWORD *)(a1 + 552) && !(*(unsigned __int8 (__fastcall **)(__int64))(*(_QWORD *)*a2 + 32LL))(*a2) )
  {
    ...
    while ( v5 != v6 )
    {
      ...
      {
        sub_18000E498(v41);
        v30 = sub_18000E498(v40);
        sub_18006575C(pExceptionObject, v30, 1202LL, (__int64)v41, 0);
  ...
  sub_18011D988(
    ...
    3LL,
    "-----------------------------------------------------------------------------------");
  v7 = (const char *)sub_18001D8F4(v38);
  v8 = v7;
  if ( *((_QWORD *)v7 + 3) >= 0x10uLL )
    v8 = *(const char **)v7;
  v9 = sub_18006CDB8(*a2);
  sub_18011D988(&unk_1802586D8, 3LL, "Engine::CreateDevice() -- attaching device id %u -- %s", v9, v8);
  if ( v39 >= 0x10 )
  {
    v10 = v38[0];
    if ( v39 + 1 >= 0x1000 )
  ...
  if ( (unsigned int)sub_18006CE74(*a2) )
  {
    v43 = 0LL;
    v44 = 0LL;
    sub_1800761D4(a1, &v43, 1LL, 0LL);
    v47 = 0LL;
    v48 = 0LL;
    v33 = 0LL;
    sub_180077600(a1, &v47, 0LL, &v33);
    if ( v47 )
      sub_1800B3944(v43, &v47);
    v11 = v48;
    if ( v48 )
    {
    ...
    v12 = sub_18006CDF4(*a2, &v35, 0);
    sub_1800B3DF8(v43, v12);
    v13 = v36;
    if ( v36 )
    {
    ...
    *(_QWORD *)&v31 = *a2;
    *((_QWORD *)&v31 + 1) = v14;
    sub_180072E60((__int64 **)(a1 + 184), (__int64)&v37, &v31);
  ...
  v49 = 0LL;
  v50 = 0LL;
  sub_1800631C0(a1 + 112, &v49);
  v17 = *(_QWORD *)(a1 + 96);
  if ( *(_QWORD *)(a1 + 104) == v17 )
  {
    sub_18000FBE0((char **)(a1 + 88), (char *)v17, a2);
  }
  else
  {
    *(_QWORD *)v17 = 0LL;
  ...
  *(_QWORD *)&v32 = *a2;
  *((_QWORD *)&v32 + 1) = v19;
  sub_1800A3998(*(_QWORD *)(a1 + 512), &v32);
  for ( i = 0LL; i < (__int64)(*(_QWORD *)(a1 + 896) - *(_QWORD *)(a1 + 888)) >> 4; ++i )
  {
    v45 = 0LL;
    v46 = 0LL;
    sub_180078048(a1, &v45, i);
    v21 = v45;
    if ( v45 && sub_180064320(v45, 2) )
  ...
  if ( v26 != v27 )
  {
    do
    {
      v51 = 0LL;
      v52 = 0LL;
      sub_1800631C0(*v26 + 16, &v51);
      sub_18006ECE4(*v26, (__int64)&v57);
      if ( (_BYTE)v52 )
        sub_180063668(v51);
      v26 += 2;
    }
  ...
  sub_18006D588(*a2);
  result = sub_180079B84(a1);
  if ( (_BYTE)v54 )
    result = sub_180063668(v53);
  if ( (_BYTE)v56 )
    return sub_180063668(v55);
  return result;
}
