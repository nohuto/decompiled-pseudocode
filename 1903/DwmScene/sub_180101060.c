/*
 * XREFs of sub_180101060 @ 0x180101060
 * Callers:
...
char __fastcall sub_180101060(__int64 a1)
{
  _QWORD *v2; // rax
  __int64 *v3; // rsi
  ...
  v5 = (__int64 *)sub_18002BFD4(&Src, (_QWORD *)(a1 + 24), " DepthSampler");
  sub_1800644E4(*v3, v5);
  v14 = 0;
  v18 = 0;
  v6 = 3;
  ...
  if ( v7 )
    v6 = 6;
  v8 = (_QWORD *)*v3;
  v17 = xmmword_18025E030;
  v16 = v6;
  si128 = _mm_load_si128(&xmmword_18020C030);
  return sub_18009F5B0(v8, &si128, 0LL);
}
