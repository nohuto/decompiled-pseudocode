/*
 * XREFs of sub_180103640 @ 0x180103640
 * Callers:
...
__int64 __fastcall sub_180103640(__int64 *a1, unsigned __int64 a2)
{
  __int64 result; // rax
  ...
  else
  {
    ...
    v9 = sub_18000F5BC((__int64)a1, v8);
    v10 = (__int64)v9;
    v11 = a2 - v5;
    if ( a2 != v5 )
    {
    ...
    return sub_180031B90(a1, v10, a2, v8);
  }
  return result;
}
