/*
 * XREFs of sub_1800DB770 @ 0x1800DB770
 * Callers:
...
unsigned __int64 __fastcall sub_1800DB770(__int64 a1, _QWORD *a2)
{
  __int64 v4; // rdx
  __int64 v5; // rdx
  __int64 v6; // rax
  ...
  *((_QWORD *)&v11 + 1) = v4;
  ...
  if ( *(_QWORD *)(a1 + 56) == v5 )
  {
    result = sub_18000FBE0((char **)(a1 + 40), (char *)v5, a2);
  }
  else
  {
    *(_QWORD *)v5 = 0LL;
