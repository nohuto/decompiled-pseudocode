/*
 * XREFs of sub_1800331A0 @ 0x1800331A0
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall sub_1800331A0(__int64 a1, _QWORD *a2, unsigned __int8 a3, char a4)
{
  __int64 v7; // rax
  __int64 *v8; // rcx
  char v9; // di
  ...
  if ( *a2 )
  {
    sub_180033E08(*a2 + 256LL, &v19, *(unsigned int *)(a1 + 88));
    v8 = &v19;
    v9 = 1;
    v7 = v19;
  }
