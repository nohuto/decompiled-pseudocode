/*
 * XREFs of sub_18011B180 @ 0x18011B180
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall sub_18011B180(__int64 a1, __int64 *a2, _BYTE *a3)
{
  void *v3; // rbx
    ...
    && (qword_18025DE78 & 0x400000000000LL) == qword_18025DE78 )
  {
    ...
    v24 = v8 + 1;
    v23 = a3;
    sub_180001128((__int64)&dword_18025DE60, (unsigned __int8 *)dword_1802240EC, 0LL, 0LL, 7u, &v13);
  }
