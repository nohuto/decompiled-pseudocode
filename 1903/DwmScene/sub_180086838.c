/*
 * XREFs of sub_180086838 @ 0x180086838
 * Callers:
 ...
 *     sub_180084740 @ 0x180084740 (sub_180084740.c)
...
unsigned __int64 __fastcall sub_180086838(__int64 a1, __m128 *a2)
{
  __int64 v4; // rdx
  ...
  if ( (_QWORD)v12 )
  {
    ...
    v6 = 7;
    v9 = sub_180084008(v11, &v15);
  }
  else
  {
    v13 = xmmword_18025E020;
    v9 = (__m128 *)&v13;
  }
  v17 = *v9;
  if ( (v6 & 1) != 0 )
  ...
  sub_180084740(&v17, &v17);
  v14 = *sub_180081E98(&v16, a2, &v17);
  return sub_18008633C(a1, &v14);
}
