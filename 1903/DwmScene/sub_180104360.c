/*
 * XREFs of sub_180104360 @ 0x180104360
 * Callers:
 *     sub_1801061C0 @ 0x1801061C0 (sub_1801061C0.c)
 * Callees:
 *     sub_18001BE10 @ 0x18001BE10 (sub_18001BE10.c)
 *     sub_18006D980 @ 0x18006D980 (sub_18006D980.c)
 *     sub_1800B72A0 @ 0x1800B72A0 (sub_1800B72A0.c)
 *     sub_180105E84 @ 0x180105E84 (sub_180105E84.c)
 *     __security_check_cookie @ 0x180126090 (__security_check_cookie.c)
 *     floorf @ 0x18012720A (floorf.c)
 */

__m128 *__fastcall sub_180104360(__int64 a1, __m128 *a2, __m128 *a3)
{
  int v3; // edi
  __m128 *v6; // rsi
  __int32 v7; // xmm1_4
  ...
  v24 = a1;
  sub_18006D980(a3);
  sub_1800B72A0(a3, COERCE_DOUBLE((unsigned __int64)COERCE_UNSIGNED_INT((float)v3)));
  v6 = &v25;
  v7 = a3->m128_i32[1];
  ...
  *a2 = (__m128)xmmword_18025E030;
  ...
  do
  {
    ...
    sub_180105E84(v16, &v25, ((v14 & 4) != 0 ? v3 * v3 : 0) + v18 + ((v14 & 2) != 0 ? v3 : 0) + (v15 & 1));
