/*
 * XREFs of ?overflow@?$basic_filebuf@DU?$char_traits@D@std@@@std@@MEAAHH@Z @ 0x180033A60
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall std::filebuf::overflow(__int64 a1, _QWORD *a2)
{
  ...
  if ( !(_BYTE)result )
  {
    v19 = 0LL;
    v20 = 0LL;
    sub_180027668(&v19, a2);
    v15 = 0LL;
    sub_180033D1C(v19, &v15);
    v24 = 0LL;
