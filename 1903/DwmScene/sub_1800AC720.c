/*
 * XREFs of sub_1800AC720 @ 0x1800AC720
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall sub_1800AC720(__int64 a1, _QWORD *a2)
{
  __int64 result; // rax
  int v5; // r8d
  int v6; // r8d
  ...
  if ( v7 )
  {
    ...
    v11 = *v9;
    v12 = sub_1800DD73C(*v9, v28, 2LL);
    sub_1800B0F84(a1, v12);
    v13 = sub_1800DD5DC(v11, v29, 2LL);
    result = sub_1800B0D54(a1, v13);
    if ( v10 )
    {
