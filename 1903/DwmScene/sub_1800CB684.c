/*
 * XREFs of sub_1800CB684 @ 0x1800CB684
 * Callers:
...
__m128 *__fastcall sub_1800CB684(__m128 *a1, __m128 *a2)
{
  __m128 v4; // xmm2
  __m128 v5; // xmm2
  __m128 *v6; // r14
  ...
  v4 = _mm_mul_ps(a2[3], (__m128)xmmword_1801F5EA0);
  ...
  if ( a2 == (__m128 *)-16LL )
    wassert(L"pSource", L"d:\\os\\public\\amd64fre\\sdk\\inc\\DirectXMathConvert.inl", 0x2A5u);
  v5 = _mm_mul_ps(a2[1], (__m128)xmmword_1801F5EA0);
  ...
  if ( a2 == (__m128 *)-32LL )
    wassert(L"pSource", L"d:\\os\\public\\amd64fre\\sdk\\inc\\DirectXMathConvert.inl", 0x2A5u);
  v6 = a2 + 8;
  v7 = _mm_mul_ps(a2[2], (__m128)xmmword_1801F5EA0);
  ...
  if ( a2 == (__m128 *)-128LL )
    wassert(L"pSource", L"d:\\os\\public\\amd64fre\\sdk\\inc\\DirectXMathConvert.inl", 0x2A5u);
  v8 = a2 + 6;
  v9 = _mm_mul_ps(*v6, (__m128)xmmword_1801F5E60);
  if ( a2 == (__m128 *)-96LL )
    wassert(L"pSource", L"d:\\os\\public\\amd64fre\\sdk\\inc\\DirectXMathConvert.inl", 0x2A5u);
  v10 = _mm_mul_ps(*v8, (__m128)xmmword_1801F5E50);
  if ( !a2 )
    wassert(L"pSource", L"d:\\os\\public\\amd64fre\\sdk\\inc\\DirectXMathConvert.inl", 0x2A5u);
  v11 = _mm_add_ps(v9, _mm_sub_ps(_mm_mul_ps(*a2, (__m128)xmmword_1801F5E90), v10));
  ...
  v12 = _mm_sub_ps(
          _mm_sub_ps(_mm_mul_ps(*a2, (__m128)xmmword_1801F5E90), _mm_mul_ps(*v8, (__m128)xmmword_1801F5E50)),
          _mm_mul_ps(*v6, (__m128)xmmword_1801F5E60));
  ...
  v13 = _mm_add_ps(_mm_mul_ps(*v8, (__m128)xmmword_1801F5E70), _mm_mul_ps(*a2, (__m128)xmmword_1801F5E90));
  ...
  if ( a2 == (__m128 *)-80LL )
    wassert(L"pSource", L"d:\\os\\public\\amd64fre\\sdk\\inc\\DirectXMathConvert.inl", 0x2A5u);
  v14 = _mm_mul_ps(a2[5], (__m128)xmmword_1801F5E80);
  ...
  if ( a2 == (__m128 *)-112LL )
    wassert(L"pSource", L"d:\\os\\public\\amd64fre\\sdk\\inc\\DirectXMathConvert.inl", 0x2A5u);
  v15 = _mm_mul_ps(a2[7], (__m128)xmmword_1801F5E80);
  ...
  if ( !v16 )
    wassert(L"pSource", L"d:\\os\\public\\amd64fre\\sdk\\inc\\DirectXMathConvert.inl", 0x2A5u);
  v17 = _mm_mul_ps(*v16, (__m128)xmmword_1801F5E80);
  ...
  sub_1800B7340(a1, COERCE_DOUBLE(1050868099LL));
  return a1;
}
