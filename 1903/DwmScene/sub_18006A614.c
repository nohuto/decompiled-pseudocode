/*
 * XREFs of sub_18006A614 @ 0x18006A614
 * Callers:
...
__int64 __fastcall sub_18006A614(__int64 a1, __int64 a2, __int64 a3, unsigned int a4)
{
  __int64 v8; // rdx
  unsigned int v9; // edi
  __int128 v10; // rcx
...
LABEL_3:
  ...
  v18 = 0LL;
  sub_1800DF9DC(*(_QWORD *)(a1 + 96) + 9256LL, &v18, 0LL);
  ...
  for ( i = 0; i < 6; ++i )
  {
    ...
    {
      v19 = 0LL;
      sub_1800DF48C(*(_QWORD *)(a1 + 96) + 4632LL, i, &v19, 0LL);
  ...
  result = sub_1800DF9DC(*(_QWORD *)(a1 + 96) + 9256LL, a2, 0LL);
  if ( a4 != -1 )
  {
    do
    {
      ...
      if ( _bittest((const int *)&result, v9) )
        result = sub_1800DF48C(*(_QWORD *)(a1 + 96) + 4632LL, v9, a3, a4);
      ++v9;
    }
    while ( v9 < 6 );
  }
