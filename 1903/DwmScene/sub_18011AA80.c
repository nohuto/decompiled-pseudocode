/*
 * XREFs of sub_18011AA80 @ 0x18011AA80
 * Callers:
 *     <none>
 * Callees:
...
ULONG __fastcall sub_18011AA80(__int64 a1, __int64 *a2, _BYTE *a3)
{
  __int64 v3; // r14
  __int64 v7; // rax
  __int64 v8; // rcx
  ...
  *(_QWORD *)(a1 + 112) = v10;
  ...
  if ( (unsigned int)dword_18025DE60 > 5 && (qword_18025DE70 & 0x400000000000LL) != 0 )
  {
    ...
    if ( (qword_18025DE78 & 0x400000000000LL) == qword_18025DE78 )
    {
      ...
      v31 = v14 + 1;
      v30 = a3;
      return sub_180001128((__int64)&dword_18025DE60, (unsigned __int8 *)dword_180223D4F, 0LL, 0LL, 7u, &v17);
    }
  }
  return result;
}
