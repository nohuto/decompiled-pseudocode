/*
 * XREFs of sub_1800228D0 @ 0x1800228D0
 * Callers:
 *     <none>
 * Callees:
...
_OWORD *__fastcall sub_1800228D0(__int64 a1, _OWORD *a2, _OWORD *a3)
{
  __int64 v4; // rdx
...
LABEL_77:
      ...
      v51[0] = *a3;
      v51[1] = a3[1];
      v22 = sub_18001D2F0((_QWORD *)a1, &v44, (__int64)v51, (__int64)&v35, a1 + 592);
...
LABEL_76:
        ...
        v50[0] = *a3;
        v50[1] = a3[1];
        v17 = sub_18001CBF4((_QWORD *)a1, &v42, (__int64)v50, (__int64)&v34, a1 + 592);
...
LABEL_75:
        ...
        v49[0] = *a3;
        v49[1] = a3[1];
        v12 = sub_18001CE48((_QWORD *)a1, &v40, (__int64)v49, (__int64)&v33, a1 + 592);
...
LABEL_74:
        ...
        v48[0] = *a3;
        v48[1] = a3[1];
        v6 = sub_18001C9A0((_QWORD *)a1, &v38, (__int64)v48, (__int64)&v32, a1 + 592);
...
LABEL_78:
    ...
    v52[0] = *a3;
    v52[1] = a3[1];
    v27 = sub_18001D09C((_QWORD *)a1, &v46, (__int64)v52, (__int64)&v36, a1 + 592);
