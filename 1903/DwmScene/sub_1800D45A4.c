/*
 * XREFs of sub_1800D45A4 @ 0x1800D45A4
 * Callers:
...
char __fastcall sub_1800D45A4(__int64 *a1, __int64 a2)
{
  __int64 v4; // rax
  size_t v5; // rcx
  ...
  v14 = 0LL;
  v15 = 0LL;
  sub_1800D42A0(&v14, *(_DWORD *)(a2 + 20));
  v17[2] = 0LL;
  v18 = 0LL;
  sub_18000F3F4(v17, (__int64)a1);
  v16 = v17;
  sub_1800D4080((__int64 *)(v14 + 16), (__int64)v20, v17);
  v4 = v20[0];
