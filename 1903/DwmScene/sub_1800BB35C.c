/*
 * XREFs of sub_1800BB35C @ 0x1800BB35C
 * Callers:
...
_QWORD *__fastcall sub_1800BB35C(__int64 a1, _QWORD *a2)
{
  __int64 *v3; // rcx
  ...
  sub_1800DD508(a1, &v18, &v12);
  v3 = v18;
  if ( (v19 - (__int64)v18) >> 4 )
  {
    v4 = (volatile signed __int32 *)v18[1];
    if ( v4 )
    {
