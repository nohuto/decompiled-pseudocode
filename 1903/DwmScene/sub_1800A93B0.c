/*
 * XREFs of sub_1800A93B0 @ 0x1800A93B0
 * Callers:
...
__int64 __fastcall sub_1800A93B0(__int64 a1, __int64 a2, __int64 a3, __int64 a4)
{
  __int64 *v5; // rdi
  _BYTE *v9; // rsi
  size_t v10; // rdx
  ...
  *(_DWORD *)(a1 + 104) = 40960;
  ...
  {
    sub_18000E118((__int64 *)(a1 + 72), 9uLL, 0LL, "<unknown>");
  }
  else
  {
    v9 = (_BYTE *)(a1 + 72);
