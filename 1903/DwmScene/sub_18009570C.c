/*
 * XREFs of sub_18009570C @ 0x18009570C
 * Callers:
...
__int64 __fastcall sub_18009570C(_DWORD *a1)
{
  __int64 result; // rax
  char v3; // bl
  BOOL v4; // r14d
  ...
  if ( !(_DWORD)result || (_DWORD)result == 3 )
  {
    ...
    if ( v5 == 1 )
    {
      v7 = (__int64 *)sub_18009637C(a1, v31, 0LL);
      v8 = *v7;
      v19 = *v7;
    ...
    {
      v10 = (__int64 *)sub_18009637C(a1, v29, 0LL);
      v8 = *v10;
    ...
    *v9 = 0LL;
    ...
    v24 = v21;
    v21 = 0LL;
    v15 = sub_1800963DC(a1, v33, 0LL);
    result = sub_1801166C4(v15, a1[30], (unsigned int)&v24, a1[28], v6, v4, (__int64)v34, 0LL, (__int64)&v25);
