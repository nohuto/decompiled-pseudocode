/*
 * XREFs of sub_180088C0C @ 0x180088C0C
 * Callers:
...
__int64 __fastcall sub_180088C0C(__int64 **a1, __int64 a2, char a3, __int64 a4, _QWORD *a5)
{
  __int64 *v8; // rax
  __int64 *v9; // rsi
  __int64 v10; // rbx
  ...
  if ( !*(_BYTE *)(v10 + 25) )
  {
    do
    {
      v9 = (__int64 *)v10;
      if ( a3 )
        v11 = (int)sub_18008D748(v10 + 32, a4) >= 0;
      else
  ...
  try
  {
    ...
    if ( v11 )
    {
      if ( v9 == (__int64 *)*v8 )
      {
        *(_QWORD *)a2 = *sub_180088740(a1, &v15, 1, v9, a4, a5);
        *(_BYTE *)(a2 + 8) = 1;
        return a2;
      }
      sub_180020AB0(&v15);
    ...
    if ( (int)sub_18008D748(v12 + 4, a4) >= 0 )
    {
      sub_1800893A4(a5 + 4);
      j_j__o_free(a5);
      *(_QWORD *)a2 = v12;
    ...
    {
      *(_QWORD *)a2 = *sub_180088740(a1, &v15, v11, v9, a4, a5);
      *(_BYTE *)(a2 + 8) = 1;
    }
    result = a2;
  }
