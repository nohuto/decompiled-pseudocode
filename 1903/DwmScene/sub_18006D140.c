/*
 * XREFs of sub_18006D140 @ 0x18006D140
 * Callers:
 *     sub_1800233F0 @ 0x1800233F0 (sub_1800233F0.c)
 * Callees:
 *     sub_1800D0BB0 @ 0x1800D0BB0 (sub_1800D0BB0.c)
 *     sub_1800D0C78 @ 0x1800D0C78 (sub_1800D0C78.c)
 */

__int64 __fastcall sub_18006D140(__int64 a1, __int64 a2)
{
  __int64 v3; // rbx
  __int64 result; // rax
  ...
  *(_QWORD *)(a2 + 72) = *(_QWORD *)(a1 + 3968);
  v3 = sub_1800D0C78(a1);
  *(_DWORD *)(a2 + 20) = sub_1800D0BB0(v3, 0LL, 1LL, 1LL);
  *(_DWORD *)(a2 + 24) = sub_1800D0BB0(v3, 1LL, 1LL, 1LL);
  result = sub_1800D0BB0(v3, 11LL, 1LL, 1LL);
  *(_DWORD *)(a2 + 28) = result;
  return result;
}
