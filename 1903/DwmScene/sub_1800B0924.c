/*
 * XREFs of sub_1800B0924 @ 0x1800B0924
 * Callers:
...
char __fastcall sub_1800B0924(__int64 a1, __int64 a2)
{
    ...
    if ( v6 || v7 )
    {
      ...
      if ( *(_QWORD *)(a1 + 200) && v6 )
      {
        ...
        (*(void (__fastcall **)(__int64, __int64 *, _QWORD))(*(_QWORD *)v5 + 64LL))(
          ...
          &v19,
          *(unsigned int *)(a1 + 172));
        sub_1800A5128(v10, a1 + 184, &v21);
        sub_1800A516C(v10, a1 + 184, &v19);
        v11 = v20;
        if ( v20 )
        {
      ...
      if ( *(_QWORD *)(a1 + 264) )
      {
        v14 = (_OWORD *)sub_1800AE978(a1, 2, 0);
        v27[0] = *v14;
        v27[1] = v14[1];
        v27[2] = v14[2];
        v27[3] = v14[3];
        v15 = (_OWORD *)sub_1800B16BC(v27, v18);
        sub_180081CAC(v27, v15);
        sub_1800A5110(v10);
      }
    }
    v16 = v26;
