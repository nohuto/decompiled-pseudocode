/*
 * XREFs of sub_18011DA88 @ 0x18011DA88
 * Callers:
...
__int64 __fastcall sub_18011DA88(__int64 a1, int a2, _QWORD *a3, char a4)
{
  _QWORD *v5; // rbx
  _QWORD *v8; // rdx
  const char *v9; // r8
  ...
  *(_QWORD *)(a1 + 40) = 0LL;
  *(_QWORD *)(a1 + 48) = 0LL;
  sub_18000F3F4((_QWORD *)(a1 + 24), (__int64)v5);
  *(_DWORD *)(a1 + 56) = 0;
  *(_DWORD *)(a1 + 60) = a2;
  if ( a4 )
  {
  ...
  sub_18011D988(&qword_18025E1A0, v10, v9, v5, a2);
  return a1;
}
