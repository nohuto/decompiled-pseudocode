/*
 * XREFs of sub_1800CD990 @ 0x1800CD990
 * Callers:
...
_QWORD *__fastcall sub_1800CD990(_QWORD *a1, __int64 *a2, int a3, __int64 a4, char a5)
{
  ...
  sub_180065810(a1, v16, a3, 2147549183LL, a4, a5);
