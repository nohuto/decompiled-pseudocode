/*
 * XREFs of sub_18005DED4 @ 0x18005DED4
 * Callers:
...
__int64 sub_18005DED4()
{
  ...
  if ( dword_180269D80 > *(_DWORD *)(v0 + 44) )
  {
    Init_thread_header(&dword_180269D80);
    if ( dword_180269D80 == -1 )
    {
      *(_QWORD *)&Src = &unk_1801C7950;
      *((_QWORD *)&Src + 1) = &unk_1801C7EB4;
      *(_QWORD *)&v15 = 0x100000005LL;
      v18 = Src;
      v19 = v15;
      sub_18005DE50();
      v2 = (_QWORD *)sub_1800D44B8(v16);
      v3 = sub_180056944(v2, 0LL, "Font/ShaderModel40/", 0x13uLL);
      si128 = 0LL;
      Src = *(_OWORD *)v3;
      si128 = *((__m128i *)v3 + 1);
      v3[2] = 0LL;
      ...
      *(_BYTE *)v3 = 0;
      ...
      v4[3] = 15LL;
      *(_BYTE *)v4 = 0;
      byte_180269D7C = sub_1800D45A4(&v14, &v18);
      ...
      Init_thread_footer(&dword_180269D80);
    }
  }
  if ( dword_180269D88 > *(_DWORD *)(v0 + 44) )
  {
    Init_thread_header(&dword_180269D88);
    if ( dword_180269D88 == -1 )
    {
      *(_QWORD *)&Src = &unk_1801C7EC0;
      *((_QWORD *)&Src + 1) = &unk_1801C8164;
      *(_QWORD *)&v17 = 0x100000001LL;
      v18 = Src;
      v19 = v17;
      sub_18005DE50();
      v7 = (_QWORD *)sub_1800D44B8(v16);
      v8 = sub_180056944(v7, 0LL, "Font/ShaderModel40/", 0x13uLL);
      si128 = 0LL;
      Src = *(_OWORD *)v8;
      si128 = *((__m128i *)v8 + 1);
      v8[2] = 0LL;
      ...
      *(_BYTE *)v8 = 0;
      ...
      v9[3] = 15LL;
      *(_BYTE *)v9 = 0;
      byte_180269D84 = sub_1800D45A4(&v14, &v18);
      if ( si128.m128i_i64[1] >= 0x10uLL )
      {
        v10 = Src;
        if ( (unsigned __int64)(si128.m128i_i64[1] + 1) >= 0x1000 )
      ...
      Init_thread_footer(&dword_180269D88);
    }
  }
  return 0LL;
}
