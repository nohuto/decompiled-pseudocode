/*
 * XREFs of sub_180134726 @ 0x180134726
 * Callers:
 *     <none>
 * Callees:
...
void __fastcall __noreturn sub_180134726(__int64 a1, __int64 a2)
{
  ...
  sub_1800B2B50((__int64)v3, *(_QWORD **)(a2 + 40), *LocaleT, *(char **)(a2 + 152));
  sub_18006DEA4((__int64)v3, *(__int64 **)(a2 + 40), *LocaleT);
