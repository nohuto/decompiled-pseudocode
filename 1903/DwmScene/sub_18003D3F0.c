/*
 * XREFs of sub_18003D3F0 @ 0x18003D3F0
 * Callers:
 *     sub_18003C848 @ 0x18003C848 (sub_18003C848.c)
 * Callees:
 *     D3D11CreateDevice @ 0x180114B48 (D3D11CreateDevice.c)
...
HRESULT __fastcall sub_18003D3F0(
        ...
        ID3D11DeviceContext **a10)
{
  ...
  if ( dword_180268FE4 > *(_DWORD *)(*((_QWORD *)NtCurrentTeb()->ThreadLocalStoragePointer + (unsigned int)TlsIndex)
                                   + 44LL) )
  {
    Init_thread_header(&dword_180268FE4);
    if ( dword_180268FE4 == -1 )
    {
      byte_180268FE0 = 1;
      Init_thread_footer(&dword_180268FE4);
    }
    goto LABEL_4;
  }
  while ( 1 )
