/*
 * XREFs of sub_180095A3C @ 0x180095A3C
 * Callers:
...
__int64 __fastcall sub_180095A3C(_DWORD *a1, __int64 a2, char a3)
{
  __int64 result; // rax
  char v6; // bl
  BOOL v7; // r14d
  ...
  if ( !(_DWORD)result || (_DWORD)result == 3 )
  {
    ...
    if ( v8 == 1 )
    {
      v10 = (__int64 *)sub_18009637C(a1, v36, 0LL);
      v11 = *v10;
      v23 = *v10;
    ...
    {
      v13 = (__int64 *)sub_18009637C(a1, v34, 0LL);
      v11 = *v13;
    ...
    *v12 = 0LL;
    ...
    v28 = v25;
    v25 = 0LL;
    v18 = sub_18009640C(a1, v38, 0LL);
    v19 = sub_1800963DC(a1, v39, 0LL);
    result = sub_18011735C(v19, v18, a1[30], (unsigned int)&v28, a1[28], v9, v7, a3, (__int64)v40, 0LL, (__int64)&v29);
