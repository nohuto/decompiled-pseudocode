/*
 * XREFs of sub_18003AE34 @ 0x18003AE34
 * Callers:
...
__int64 __fastcall sub_18003AE34(__int64 a1, __int64 a2)
{
  _QWORD *v4; // r14
  _QWORD *v5; // rdi
  ...
  *((_QWORD *)&v50 + 1) = v7;
  v8 = a2 + 8;
  sub_180039B58(a2 + 8, (__int64)&v50, *(_DWORD *)a2, 4);
  v9 = (__int64 *)sub_18009EB64(*v5, v70, *(unsigned int *)(a1 + 88));
  ...
  if ( *(_BYTE *)(a2 + 4) )
  {
    ...
    *((_QWORD *)&v51 + 1) = v20;
    ...
    v22 = &v51;
LABEL_38:
    result = sub_180039B58(a2 + 8, (__int64)v22, *(_DWORD *)a2, v21);
    goto LABEL_39;
  }
  if ( *(_BYTE *)(a2 + 5) )
  {
    sub_180015EA4(v4, &v63, 1u);
    v23 = (_QWORD *)(a1 + 192);
...
LABEL_39:
  if ( *(_BYTE *)(a2 + 5) )
  {
    ...
    {
      v83 = 0uLL;
      sub_18009EB64(*(_QWORD *)(a1 + 144), &v83, *(unsigned int *)(a1 + 88));
      v82 = 0LL;
      if ( *((_QWORD *)&v83 + 1) )
        _InterlockedIncrement((volatile signed __int32 *)(*((_QWORD *)&v83 + 1) + 8LL));
      v65 = v83;
      v27 = sub_180017164(&v72, (__int64 *)&v65);
      sub_18003167C(*v27, &v82);
      v28 = v73;
      if ( v73 )
      {
      ...
      sub_1800253B0(v12, v31);
      if ( v31 < 0 )
      {
        sub_18000E498(v79);
        v46 = (unsigned int)sub_18000E498(v78);
        sub_18006575C((unsigned int)pExceptionObject, v46, 362, (unsigned int)v79, 0);
        throw (Spectre::Engine::EngineException *)pExceptionObject;
      }
      v33 = sub_1800642F8(a1, v76);
      if ( *(_QWORD *)(v33 + 24) >= 0x10uLL )
        v33 = *(_QWORD *)v33;
      sub_18000EE28(v81, (const char *)v33);
      if ( v77 >= 0x10 )
      {
        v34 = v76[0];
        if ( v77 + 1 >= 0x1000 )
      ...
      sub_18002EA0C(v36, (char *)&v49, (char *)&v48, 0x400u);
      sub_180015EA4(v54, &v66, 1u);
      ...
      sub_180064574(*v26, 2LL);
      v53 = 0LL;
      if ( v37 )
        _InterlockedIncrement(v37 + 2);
      *(_QWORD *)&v53 = v36;
      *((_QWORD *)&v53 + 1) = v37;
      result = sub_18009DE28(*v26);
