/*
 * XREFs of sub_180036F30 @ 0x180036F30
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall sub_180036F30(__int64 a1, int a2, _QWORD *a3, unsigned int a4)
{
  __int64 v7; // rax
  __int64 *v8; // rcx
  char v9; // di
  ...
  if ( *a3 )
  {
    v8 = (__int64 *)sub_18009EB64(*a3, v38, *(unsigned int *)(a1 + 88));
    v9 = 1;
    v7 = *v8;
  }
  else
  ...
  *v8 = 0LL;
  ...
  if ( (_QWORD)v29 )
  {
    ...
    v36 = v29;
    v12 = sub_180017164(&v40, (__int64 *)&v36);
    v13 = 4;
    v14 = *v12;
  }
  else
  ...
  *v12 = 0LL;
  ...
  if ( v14 )
  {
    v18 = sub_18003160C((_QWORD *)v14, &v31);
    v19 = 16;
    v20 = v30;
  }
  else
  ...
  if ( v42 )
  {
    v25 = sub_1800D0C78(v20);
    result = sub_1800D0C60(v25, 11LL, 1LL, 1LL);
  }
  v26 = v42;
  if ( v42 )
  {
