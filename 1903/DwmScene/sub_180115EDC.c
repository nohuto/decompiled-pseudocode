/*
 * XREFs of sub_180115EDC @ 0x180115EDC
 * Callers:
...
__int64 __fastcall sub_180115EDC(
        int a1,
        unsigned int a2,
        __int64 a3,
        int a4,
        ...
        __int64 a10)
{
  ...
  if ( a4 != (_DWORD)result )
  {
    do
    {
      ...
      {
        sub_18000E498(v26);
        sub_180116258(pExceptionObject, v26);
      ...
      if ( a6 != 1 || (v18 & 1) == 0 )
        v16 = 0;
      sub_180117B2C(v12, v13, v20, v21, v22, v16, a9, a10);
      result = sub_1801165C0(a1, v20, v21, v22, v16, a8);
