/*
 * XREFs of sub_1800A3068 @ 0x1800A3068
 * Callers:
 ...
 *     sub_1800A8F98 @ 0x1800A8F98 (sub_1800A8F98.c)
...
__int64 __fastcall sub_1800A3068(__int64 a1, __int64 *a2)
{
  ...
  if ( !*a2 )
  {
    ...
    sub_180027770(v31, v17, 444, (__int64)v27, 0);
    throw (Spectre::Engine::EngineInvalidArgException *)v31;
  }
  sub_1800A8F98(*a2, v38);
  v23[2] = 0LL;
  v23[3] = 0LL;
  sub_18000F3F4(v23, (__int64)v38);
  if ( (unsigned __int8)sub_1800A4D90(a1, v23) )
  {
    v14 = sub_18009FB30(&Src, "ShaderManager::AddExtension() -- Extension with name '", v38);
    v15 = sub_18002BF78((__int64)v30, v14, "' is already installed");
    v16 = sub_18000E498(v28);
    sub_180027770(pExceptionObject, v16, 448, v15, 0);
    throw (Spectre::Engine::EngineInvalidArgException *)pExceptionObject;
  }
  sub_1800A93B0(*a2, *(_QWORD *)(a1 + 18688), a1, a1 + 18664);
  sub_1800A1F4C((__int64 *)(a1 + 18592), (__int64)&v25, v38);
  std::shared_ptr<__ExceptionPtr>::operator=((_QWORD *)(v25 + 64), a2);
  v19 = 0LL;
  v20 = 0LL;
  v24[2] = 0LL;
  v24[3] = 0LL;
  sub_18000F3F4(v24, (__int64)v38);
  sub_1800A4A38(a1, &v19, v24);
  v33 = 0LL;
  v34 = 0LL;
  v35 = 0LL;
  sub_18007B178(*(_QWORD *)(a1 + 18688), &v33);
  v4 = 0;
  v5 = v33;
  if ( (v34 - v33) >> 4 )
  {
    ...
    do
    {
      ...
      v21 = v9;
      v22 = v8;
      if ( (unsigned int)sub_18006CDB8(v9) )
      {
        v36 = 0LL;
        v37 = 0LL;
        sub_180063178(v9 + 24, &v36);
        v18 = 0LL;
        if ( v8 )
        {
          _InterlockedIncrement(v8 + 2);
