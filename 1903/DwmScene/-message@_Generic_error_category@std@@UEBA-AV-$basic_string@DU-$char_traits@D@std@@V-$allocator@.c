/*
 * XREFs of ?message@_Generic_error_category@std@@UEBA?AV?$basic_string@DU?$char_traits@D@std@@V?$allocator@D@2@@2@H@Z @ 0x18002BF30
 * Callers:
 *     <none>
 * Callees:
 *     unknown_libname_113 @ 0x18000F6D4 (unknown_libname_113.c)
 *     ?_Syserror_map@std@@YAPEBDH@Z @ 0x180127434 (-_Syserror_map@std@@YAPEBDH@Z.c)
 */
