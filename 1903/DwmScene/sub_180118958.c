/*
 * XREFs of sub_180118958 @ 0x180118958
 * Callers:
...
int __fastcall sub_180118958(_QWORD *a1)
{
  ...
  *a1 = &Spectre::Utils::TelemetryTraceLoggerWin::`vftable';
  v2 = _InterlockedExchangeAdd64(&qword_18026B260, 0xFFFFFFFFFFFFFFFFuLL);
  if ( v2 == 1 )
  {
