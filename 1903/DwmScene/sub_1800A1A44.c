/*
 * XREFs of sub_1800A1A44 @ 0x1800A1A44
 * Callers:
...
__int64 __fastcall sub_1800A1A44(_QWORD *a1, __int64 a2, char a3, const void **a4)
{
  __int64 *v6; // rax
  __int64 *v7; // r13
  __int64 v8; // rbx
  ...
  try
  {
    ...
    if ( v9 )
    {
      if ( v7 == (__int64 *)*v6 )
      {
        *(_QWORD *)a2 = *sub_1800A094C(a1, v32, 1, v7, (__int64)a4);
        *(_BYTE *)(a2 + 8) = 1;
        return a2;
      }
      sub_180020AB0(&v30);
    ...
    {
      *(_QWORD *)a2 = *sub_1800A094C(v32[0], &v31, v9, v31, (__int64)a4);
      *(_BYTE *)(a2 + 8) = 1;
    }
    result = a2;
  }
