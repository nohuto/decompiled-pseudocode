/*
 * XREFs of sub_1800906F4 @ 0x1800906F4
 * Callers:
...
__int64 __fastcall sub_1800906F4(__int64 a1, _QWORD *a2, unsigned __int16 a3, __int64 a4)
{
  __int64 *v8; // rdx
  __int64 *v9; // rax
  __int64 *v10; // rcx
...
LABEL_8:
  ...
  {
    *((_DWORD *)v9 + 8) = 2;
    v11 = (_QWORD *)sub_1800A8EF0(*(_QWORD *)(a1 + 136), v16);
  ...
  {
    *((_DWORD *)v9 + 8) = 3;
    v14 = (_QWORD *)sub_1800A8EF0(*(_QWORD *)(a1 + 136), v18);
