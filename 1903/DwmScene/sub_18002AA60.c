/*
 * XREFs of sub_18002AA60 @ 0x18002AA60
 * Callers:
 *     <none>
 * Callees:
...
__int64 *__fastcall sub_18002AA60(__int64 **a1, __int64 *a2)
{
  __int64 v4; // r12
  __int64 **v5; // r13
  __int64 *v6; // rdi
  ...
  if ( v6 )
  {
    ...
    if ( v14 < 0 )
    {
      ...
      sub_18000E498(v50);
      v43 = (unsigned int)sub_18000E498(v49);
      sub_180065810((unsigned int)v54, v43, 614, v14, (__int64)v50, 0);
  ...
  else
  {
    ...
    v58[3] = 0;
    v57 = 0LL;
    v17 = (__int64 **)sub_1800297DC((__int64)a1, v47);
    v18 = *v17;
    v19 = **v17;
    v20 = sub_1800161C4(&v57);
    (*(void (__fastcall **)(__int64 *, const IID *, __int64 *))(v19 + 48))(v18, &stru_18014A260, v20);
    v21 = v47[0];
    if ( v47[0] )
    {
      v47[0] = 0LL;
    ...
    v22 = sub_1800298D8((__int64)a1, &v44);
    v23 = *v5;
    if ( *v5 )
    {
      *v5 = 0LL;
  ...
  if ( (*(unsigned __int8 (__fastcall **)(__int64))(*(_QWORD *)v4 + 16LL))(v4) )
  {
    ...
    v26 = *v5;
    v27 = **v5;
    v28 = sub_1800161C4(&v56);
    v29 = (*(__int64 (__fastcall **)(__int64 *, _QWORD, void *, __int64 *))(v27 + 72))(v26, 0LL, &unk_18014C368, v28);
    if ( v29 < 0 )
    {
      sub_18000E498(v66);
      ...
      sub_18000E498(v53);
      v38 = (unsigned int)sub_18000E498(v52);
      sub_180065810((unsigned int)pExceptionObject, v38, 654, v29, (__int64)v53, 0);
