/*
 * XREFs of sub_180121624 @ 0x180121624
 * Callers:
 ...
 *     sub_18012186C @ 0x18012186C (sub_18012186C.c)
 */

char *__fastcall sub_180121624(__int64 **a1, __int64 *a2, char *a3, char *a4)
{
  char *result; // rax
  ...
  if ( v9 == 1 && a2 == a1[1] || (v24 = 0, v9) )
  {
    ...
    if ( v9 <= ((char *)v11 - (char *)v12) >> 5 )
    {
      ...
      {
        a1[1] = (__int64 *)sub_1800AB8E8(a2, v12, (char *)&a2[4 * v9]);
        for ( i = a2; i != v12; i += 4 )
          unknown_libname_116(i);
      }
      else
      {
        a1[1] = (__int64 *)sub_1800AB8E8(&v12[-4 * v9], v12, (char *)v12);
        sub_18012186C(a2, &v12[-4 * v9], v12, 0LL, a1);
        v20 = a2;
        v21 = &a2[4 * v9];
        if ( a2 != v21 )
        {
      ...
      return sub_1800AB8E8(a3, a4, (char *)a2);
    }
    else
    {
      ...
      v25 = (char *)sub_180031D3C((__int64)a1, v17);
      sub_1800AB8E8(a3, a4, &v25[32 * v10]);
      v18 = v25;
      v19 = *a1;
      if ( !v24 )
      {
        sub_1800AB8E8(v19, a2, v25);
        v18 = &v25[32 * v10 + 32 * v9];
        v19 = a2;
      }
      sub_1800AB8E8(v19, a1[1], v18);
      return (char *)sub_1800B2924((__int64)a1, (__int64)v25, v26, v17);
    }
  }
  return result;
}
