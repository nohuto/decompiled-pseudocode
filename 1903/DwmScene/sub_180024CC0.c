...
__int64 __fastcall sub_180024CC0(__int64 a1, int a2)
{
  int v3; // r14d
  __int64 result; // rax
  unsigned int i; // r12d
  ...
  *(_DWORD *)(a1 + 416) = a2;
  ...
  for ( i = 0; i < v20; ++i )
  {
    v31 = 0LL;
    v32 = 0LL;
    sub_18006CDF4(a1, &v31, i);
    v33 = 0LL;
    v34 = 0LL;
    sub_1800631C0(v31 + 1, &v33);
    ...
    if ( v12 )
    {
      ...
      if ( v15 )
      {
        v16 = (__int64 *)sub_18009EB1C(v15, v30);
      }
      else
      {
        v23[0] = 0;
