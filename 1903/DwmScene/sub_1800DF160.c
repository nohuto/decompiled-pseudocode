/*
 * XREFs of sub_1800DF160 @ 0x1800DF160
 * Callers:
...
__int64 __fastcall sub_1800DF160(__int64 a1, int a2, __int64 a3)
{
  unsigned int i; // edi
  int v7; // eax
  _QWORD *v8; // rbx
  ...
  *(_QWORD *)a1 = &Spectre::Engine::TextureState::`vftable';
  `eh vector constructor iterator'(
    ...
    0x100uLL,
    6uLL,
    (void (*)(void *))sub_180020090,
    (void (*)(void *))sub_180020490);
  `eh vector constructor iterator'(
    (void *)(a1 + 1544),
    0x100uLL,
    6uLL,
  ...
  *(_BYTE *)(a1 + 4620) = 1;
  for ( i = 0; i < 6; ++i )
  {
    ...
    if ( _bittest(&v7, i) )
    {
      ...
      do
      {
        std::shared_ptr<__ExceptionPtr>::operator=(v8, (_QWORD *)((char *)v8 + v9 + 192));
        v8 += 2;
        --v10;
      }
      while ( v10 );
