/*
 * XREFs of sub_18011F918 @ 0x18011F918
 * Callers:
 *     sub_180122BF0 @ 0x180122BF0 (sub_180122BF0.c)
 * Callees:
 ...
 *     sub_180124544 @ 0x180124544 (sub_180124544.c)
 *     sub_180124548 @ 0x180124548 (sub_180124548.c)
 *     sub_1801246AC @ 0x1801246AC (sub_1801246AC.c)
 *     sub_18012471C @ 0x18012471C (sub_18012471C.c)
...
__int64 __fastcall sub_18011F918(__int64 a1, _QWORD *a2, char a3, int a4)
{
  ...
  if ( (unsigned __int8)sub_1801246AC(v18[0] + 64, v12) )
  {
    ...
    else
    {
      ...
      if ( (unsigned __int8)sub_180124734(v13) )
      {
        ...
        if ( (unsigned __int8)sub_1801246AC(v13, v14)
          && (v19 = 0LL,
              ...
              v15 = sub_180124548(v13, v18),
              (unsigned __int8)sub_18012471C(v15)) )
        {
          if ( (unsigned __int8)sub_180124544(v15) != a3 )
          {
            v19 = 0LL;
            v20 = 0LL;
            sub_18001110C(v18, (__int64)v26);
            sub_18011F854(v13, v18, a3);
            v10 = 1;
          }
        }
        else
      ...
      else if ( (unsigned __int8)sub_18012471C(v13) )
      {
        if ( (unsigned __int8)sub_180124544(v13) != a3 )
        {
          v22 = 0LL;
          v23 = 0LL;
          sub_18001110C(v21, (__int64)a2);
          sub_18011F854(v11, v21, a3);
          v10 = 1;
        }
      }
      else
