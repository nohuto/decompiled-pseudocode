/*
 * XREFs of sub_1800BD278 @ 0x1800BD278
 * Callers:
 *     sub_1800BD374 @ 0x1800BD374 (sub_1800BD374.c)
...
__int64 __fastcall sub_1800BD278(_QWORD *a1)
{
  __int64 v2; // rcx
