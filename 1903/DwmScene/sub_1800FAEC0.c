/*
 * XREFs of sub_1800FAEC0 @ 0x1800FAEC0
 * Callers:
 *     <none>
 * Callees:
...
char __fastcall sub_1800FAEC0(__int64 a1, __int64 a2, int a3, int a4, char a5, __int64 a6)
{
  __int64 v10; // rax
  ...
  v15[3] = 15LL;
  LOBYTE(v15[0]) = 0;
  sub_18000E118(v15, 0x1AuLL, 0LL, "ImageProcessingEffectBloom");
  sub_1800644E4(*(_QWORD *)(a1 + 232), v15);
  return sub_180064C9C(*(_QWORD *)(a1 + 232), a3, a4, a5, a6, a2);
}
