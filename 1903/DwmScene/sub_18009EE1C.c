/*
 * XREFs of sub_18009EE1C @ 0x18009EE1C
 * Callers:
...
__int64 __fastcall sub_18009EE1C(__int64 **a1, __int64 a2, unsigned int *a3)
{
  __int64 *v3; // rbx
  __int64 v6; // rax
  unsigned int v7; // edx
...
LABEL_10:
    v11 = a3;
    v8 = sub_180032454((__int64)a1, (__int64)&unk_1801EF6F8, &v11);
