/*
 * XREFs of sub_1801224F0 @ 0x1801224F0
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall sub_1801224F0(_QWORD *a1, __int64 a2)
{
  _QWORD *v4; // rdi
  _QWORD *v5; // rbx
  __int64 **v6; // rax
  ...
  *(_QWORD *)(a2 + 16) = 0LL;
  ...
  while ( v5 != v4 )
  {
    ...
    sub_180121624((__int64 **)a2, *(__int64 **)(a2 + 8), v10, v11);
    sub_18006DFDC((__int64)&v10);
    v6 = (__int64 **)v5[2];
    if ( *((_BYTE *)v6 + 25) )
    {
