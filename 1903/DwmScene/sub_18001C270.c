/*
 * XREFs of sub_18001C270 @ 0x18001C270
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall sub_18001C270(__int64 a1, __int64 a2, __int64 a3)
{
  float *v6; // rax
  __m128 v7; // xmm1
  __m128 v8; // xmm0
  ...
  v15 = 0LL;
  v16 = 0LL;
  sub_1800631C0(*(_QWORD *)(a1 + 16) + 16LL, &v15);
  v14[2] = 0LL;
  v14[3] = 0LL;
  sub_18001110C(v14, (__int64)&unk_1802587A8);
  v6 = (float *)sub_18008ACB0(*(_QWORD *)(a1 + 16), v14);
