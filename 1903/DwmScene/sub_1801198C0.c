/*
 * XREFs of sub_1801198C0 @ 0x1801198C0
 * Callers:
 *     <none>
 * Callees:
...
ULONG __fastcall sub_1801198C0(__int64 a1, __int64 *a2, __int64 *a3, _BYTE *a4, __int64 a5, void *a6)
{
  __int64 v6; // r14
  __int64 v11; // rax
  __int64 v12; // rcx
  ...
  *(_QWORD *)(a1 + 112) = v11;
  ...
  sub_18011A4DC(v13);
  sub_18011BA5C(v13);
  v14 = (volatile signed __int64 *)sub_180119B30(v6, 0LL);
  v15 = *(_QWORD *)(a1 + 112);
  *(_QWORD *)(a1 + 112) = v14;
  if ( v15 )
  {
  ...
  if ( (unsigned int)dword_18025DE60 > 5 && (qword_18025DE70 & 0x400000000000LL) != 0 )
  {
    ...
    if ( (qword_18025DE78 & 0x400000000000LL) == qword_18025DE78 )
    {
      ...
      v45 = v23;
      v46 = v20 + 1;
      return sub_180001128((__int64)&dword_18025DE60, (unsigned __int8 *)dword_180224829, 0LL, 0LL, 0xAu, &v27);
    }
  }
  return result;
}
