/*
 * XREFs of sub_1800D63A4 @ 0x1800D63A4
 * Callers:
 *     sub_1800D65A8 @ 0x1800D65A8 (sub_1800D65A8.c)
 * Callees:
...
unsigned __int64 __fastcall sub_1800D63A4(__int64 *a1, unsigned __int64 a2)
{
  __int64 ***v4; // rsi
  ...
  if ( a2 <= v6 / 152 )
  {
    if ( a2 <= v5 )
    {
      if ( a2 != v5 )
      {
        ...
        if ( (__int64 ***)v15 != v4 )
        {
          ...
          do
          {
            sub_180069DF4(v16, v21, **v16, (__int64 *)*v16);
            j_j__o_free(*v16);
            v16 += 19;
    ...
    else
    {
      ...
      {
        memset(v4, 0, 0x98uLL);
        result = sub_180066F10((__int64)v4);
        v4 += 19;
      }
      a1[1] = (__int64)v4;
    }
  ...
  else
  {
    ...
    v11 = sub_180069950((__int64)a1, v10);
    v20 = (__int64)v11;
    v12 = &v11[19 * v5];
    v21[0] = v12;
    v13 = a2 - v5;
    try
    {
      while ( v13 )
      {
        ...
        sub_180066F10((__int64)v12);
        v12 += 19;
        --v13;
      }
      v18 = v12;
      sub_1800665C8(*a1, a1[1], v20);
      result = sub_1800693C4(a1, v20, a2, v10);
    }
    catch ( ... )
    {
      sub_1800695AC((__int64)a1, (_QWORD **)v21[0], (_QWORD **)v18);
      v17 = sub_18000F544((__int64)a1);
      sub_180069C38(v17, v20, v10);
      throw;
    }
  }
  return result;
