/*
 * XREFs of sub_180118E00 @ 0x180118E00
 * Callers:
 *     <none>
 * Callees:
...
int __fastcall sub_180118E00(_QWORD *a1, char a2, _BYTE *a3, _BYTE *a4)
{
  void *v4; // rbx
  const char *v9; // rax
  const char *v10; // rbx
  ...
  if ( (unsigned int)dword_18025DE60 > 5 && (qword_18025DE70 & 0x400000000000LL) != 0 )
  {
    ...
    if ( (qword_18025DE78 & 0x400000000000LL) == qword_18025DE78 )
    {
      ...
      v40 = a4;
      v41 = v18 + 1;
      LODWORD(v9) = sub_180001128((__int64)&dword_18025DE60, (unsigned __int8 *)dword_180223BD1, 0LL, 0LL, 9u, &v23);
    }
  }
  return (int)v9;
}
