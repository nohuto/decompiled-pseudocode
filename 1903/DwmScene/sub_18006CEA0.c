/*
 * XREFs of sub_18006CEA0 @ 0x18006CEA0
 * Callers:
 *     <none>
 * Callees:
...
_QWORD *__fastcall sub_18006CEA0(__int64 a1, _QWORD *a2, unsigned int a3)
{
  __int64 v5; // rbx
  __int64 v6; // r15
  __int64 v7; // rcx
  ...
  v13 = a1 + 8;
  sub_1800635DC(a1 + 8);
  sub_18006B944((__int64 **)(a1 + 24), (__int64)&v14, &v15);
  v6 = v14;
  v7 = *(_QWORD *)(v14 + 48);
  if ( *(_QWORD *)(v14 + 40) == v7 )
  {
    v16 = 0LL;
    v17 = 0LL;
    sub_18006ADB8(*(_QWORD *)(a1 + 16), &v16);
