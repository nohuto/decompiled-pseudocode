/*
 * XREFs of sub_1800437F0 @ 0x1800437F0
 * Callers:
 *     <none>
 * Callees:
...
char __fastcall sub_1800437F0(__int64 a1, __int64 *a2)
{
  __int64 v4; // rdx
  __int64 v5; // rdi
  __int64 v6; // rbx
...
LABEL_6:
    ...
    if ( v12 < 0 )
    {
      sub_18011D988(&unk_180258190, 5LL, "ERROR: Failed to create Geometry shader.\n");
    }
    else
    {
      *(_BYTE *)(a1 + 96) = 1;
