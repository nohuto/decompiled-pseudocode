/*
 * XREFs of sub_180123AB0 @ 0x180123AB0
 * Callers:
 *     <none>
 * Callees:
...
__m128i *__fastcall sub_180123AB0(__int64 a1, __m128i *a2, __int64 *a3)
{
  ...
  {
    sub_18000E498(&v13);
    sub_180074178(pExceptionObject, &v13, 0LL);
...
LABEL_14:
    ...
    if ( (unsigned __int64)a3[3] >= 8 )
      a3 = (__int64 *)*a3;
    sub_180026168(v13.m128i_i8, (char *)a3 + 2, v10);
    *a2 = v13;
    a2[1] = si128;
    si128 = _mm_load_si128((const __m128i *)&xmmword_18014AA40);
    v13.m128i_i16[0] = 0;
  ...
  else
  {
    ...
    sub_18001110C(a2, (__int64)byte_18025E1E0);
  }
  return a2;
}
