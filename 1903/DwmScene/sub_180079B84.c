/*
 * XREFs of sub_180079B84 @ 0x180079B84
 * Callers:
...
__int64 __fastcall sub_180079B84(__int64 a1)
{
  int v2; // eax
  unsigned int i; // r15d
  __int64 v4; // r12
  ...
  v28 = -2LL;
  sub_18011D988(&unk_1802586D8, 3LL, (const char *)&unk_1801DFD05);
  v2 = sub_180077B7C(a1);
  sub_18011D988(&unk_1802586D8, 3LL, "Engine has %u device(s) attached:", v2);
  v31 = 0LL;
  v32 = 0LL;
  sub_180063358(a1 + 112, &v31);
  for ( i = 0; i < (unsigned int)sub_180077B7C(a1); ++i )
  {
    v20 = 0LL;
    v21 = 0LL;
    sub_180077A9C(a1, &v20, i);
    v4 = v20;
    v5 = (const char *)sub_18001D8F4(v29);
    v6 = (const char *)sub_18001D8F4(v26);
    v7 = (const char *)sub_18001D8F4(v24);
    v8 = (const char *)sub_18001D8F4(v22);
    v9 = v8;
...
LABEL_37:
  ...
  result = sub_18011D988(
             &unk_1802586D8,
             3LL,
             "-----------------------------------------------------------------------------------");
  if ( (_BYTE)v32 )
    return sub_180063670(v31);
  return result;
}
