/*
 * XREFs of sub_1800A6FDC @ 0x1800A6FDC
 * Callers:
...
__int64 __fastcall sub_1800A6FDC(__int64 **a1, __int64 a2, char a3, int *a4, __int64 a5)
{
  __int64 *v8; // rdx
  __int64 *v9; // rdi
  __int64 v10; // rax
  ...
  try
  {
    ...
    if ( v11 )
    {
      if ( v9 == (__int64 *)*v8 )
      {
        *(_QWORD *)a2 = *sub_1800A68C0(a1, &v15, 1, v9, (int)a4, (_QWORD *)a5);
        *(_BYTE *)(a2 + 8) = 1;
        return a2;
      }
      sub_180020AB0(&v15);
    ...
    if ( *((_DWORD *)v13 + 8) >= *a4 )
    {
      sub_180026420((__int64 ***)(a5 + 56), &v15, **(__int64 ***)(a5 + 56), *(__int64 **)(a5 + 56));
    ...
    {
      *(_QWORD *)a2 = *sub_1800A68C0(a1, &v15, v11, v9, (int)a4, (_QWORD *)a5);
      *(_BYTE *)(a2 + 8) = 1;
    }
    result = a2;
  }
