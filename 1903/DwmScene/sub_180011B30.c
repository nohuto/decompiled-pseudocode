...
__int64 __fastcall sub_180011B30(__int64 a1, _QWORD *a2, __int64 a3, __int64 a4)
{
  ...
  try
  {
    ...
    v13 = v36;
    sub_1800910E0(*(_QWORD *)(v36 + 16), a2, v11);
    if ( (v12 & 8) != 0 )
    {
      v12 &= ~8u;
    ...
    v16 = sub_1800114F0(Src, a2, &qword_18025B538);
    LOBYTE(v17) = a3 != 0;
    sub_1800909E0(*(_QWORD *)(v13 + 16), v16, v17);
    if ( v41 >= 0x10 )
    {
      v18 = Src[0];
      if ( v41 + 1 >= 0x1000 )
