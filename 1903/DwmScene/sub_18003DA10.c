/*
 * XREFs of sub_18003DA10 @ 0x18003DA10
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall sub_18003DA10(_QWORD *a1, __int64 a2)
{
  __int64 v3; // r8
  __int64 v4; // rbx
  __int64 *v5; // rax
  ...
  v4 = 0LL;
LABEL_3:
  v5 = (__int64 *)sub_180044E88((unsigned int)&v12, (unsigned int)"IndexBuffer", v11, a1[12], a2, 2);
  v6 = 0LL;
  if ( &v13 != v5 )
  {
    v6 = *v5;
  ...
  return sub_18006445C(a1, *(unsigned int *)(a1[12] + 12LL), 6LL);
}
