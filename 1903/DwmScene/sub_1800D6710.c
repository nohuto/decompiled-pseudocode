/*
 * XREFs of sub_1800D6710 @ 0x1800D6710
 * Callers:
...
__int64 __fastcall sub_1800D6710(_QWORD *a1, __int64 *a2)
{
  __int64 v2; // rsi
  __int64 i; // rbx
  __int64 v5; // r8
  ...
  for ( i = *a2; i != v2; i += 152LL )
  {
    ...
    if ( *(_BYTE *)(i + 120) )
    {
      result = sub_1800D662C(v7, i);
    }
    else
    {
      sub_1800D662C(v7, a1[1] + 152 * v5);
      *(_BYTE *)(v7 + 120) = 0;
      *(_QWORD *)(v7 + 128) = *(_QWORD *)(i + 128);
      result = sub_180069AC8((_QWORD *)(v7 + 136));
    }
  }
  return result;
}
