/*
 * XREFs of sub_180031944 @ 0x180031944
 * Callers:
...
__int64 __fastcall sub_180031944(_QWORD *a1, int a2)
{
  int v2; // ebx
  char v5; // r15
  __int64 v6; // rcx
  ...
  if ( v6 )
  {
    ...
    v8 = sub_18002D548(&v25, a2, 0, v28, &v26);
  }
  else
  {
    v14 = a1[22];
    ...
    v8 = sub_18002D710(&v25, a2, v27, 1u, &v26);
  }
  v9 = v8;
  if ( v7 != v8 )
  {
...
LABEL_22:
  ...
  {
    v2 = sub_18009EC10(a1);
    v17 = sub_18009EB9C(a1);
    v18 = sub_18009EB80(a1);
    v19 = sub_1800D0B10(&v26, v18);
    sub_180017CD4(a1 + 15, v19);
    if ( v29 >= 0x10 )
    {
      v20 = v26;
      if ( v29 + 1 >= 0x1000 )
...
LABEL_34:
  ...
  {
    v21 = sub_1800D0B10(&v26, 0LL);
    sub_180017CD4(a1 + 15, v21);
    if ( v29 >= 0x10 )
    {
      v20 = v26;
      if ( v29 + 1 >= 0x1000 )
  ...
  return sub_18009EC2C(a1, _mm_unpacklo_ps(v22, v23).m128_u64[0]);
}
