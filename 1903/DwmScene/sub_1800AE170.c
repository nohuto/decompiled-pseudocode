/*
 * XREFs of sub_1800AE170 @ 0x1800AE170
 * Callers:
 ...
 *     sub_1800AACE0 @ 0x1800AACE0 (sub_1800AACE0.c)
 *     sub_1800AAD5C @ 0x1800AAD5C (sub_1800AAD5C.c)
 *     sub_1800AC2E4 @ 0x1800AC2E4 (sub_1800AC2E4.c)
...
char __fastcall sub_1800AE170(__int64 a1, __int64 a2)
{
  __int64 v4; // rdi
  const void *v5; // rdx
  const void *v6; // rcx
  ...
  v4 = _RTDynamicCast(
         ...
         1);
  if ( !sub_1800AA488((_QWORD *)(v4 + 104), (_QWORD *)(a1 + 104))
  ...
  if ( *(_DWORD *)(v4 + 292) != *(_DWORD *)(a1 + 292) )
    return 0;
  if ( sub_18008E15C((__m128 *)(v4 + 296), (__m128 *)(a1 + 296)) )
    return 0;
  ...
  if ( v11 != *(float *)(a1 + 332)
    ...
    || !sub_1800AC2E4((unsigned __int64 *)(v4 + 344), (unsigned __int64 *)(a1 + 344))
    || !sub_1800AC2E4((unsigned __int64 *)(v4 + 352), (unsigned __int64 *)(a1 + 352))
    || *(_DWORD *)(v4 + 360) != *(_DWORD *)(a1 + 360)
    || sub_18009D6BC((unsigned __int64 *)(v4 + 364), (unsigned __int64 *)(a1 + 364)) )
  {
    return 0;
  }
  v12 = *(_BYTE *)(a1 + 388);
    ...
    && *(float *)(v4 + 408) == *(float *)(a1 + 408) )
  {
    ...
    if ( (((*(_QWORD *)(v4 + 424) - (_QWORD)v15) ^ (*(_QWORD *)(a1 + 424) - v14)) & 0xFFFFFFFFFFFFFFE0uLL) == 0
      && sub_1800AACE0(v15, *(char **)(v4 + 424), v14)
      ...
      && sub_1800AAD5C(**(__int64 ***)(v4 + 1616), *(__int64 **)(v4 + 1616), **(__int64 ***)(a1 + 1616))
