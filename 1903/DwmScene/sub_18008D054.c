 ...
 *     sub_18008D7B8 @ 0x18008D7B8 (sub_18008D7B8.c)
 *     __security_check_cookie @ 0x180126090 (__security_check_cookie.c)
 *     _guard_dispatch_icall_nop @ 0x180127630 (_guard_dispatch_icall_nop.c)
 */

// Hidden C++ exception states: #wind=1
void __fastcall sub_18008D054(__int64 a1, __int64 a2)
{
  __int64 v3; // rcx
  __int64 v4; // rbx
  ...
  v5[0] = 1;
  if ( (unsigned __int8)((__int64 (__fastcall *)(__int64, char *, _QWORD, __int64))sub_18008D7B8)(a2 + 72, v5, 0LL, 5LL) )
  {
    v8[0] = 0;
    *(_QWORD *)v6 = qword_18026B298;
    *(_DWORD *)&v6[8] = dword_18026B2A0;
    *(_QWORD *)&v6[12] = qword_18026B298;
    *(_DWORD *)&v6[20] = dword_18026B2A0;
    ...
    *(_QWORD *)&v6[8] = v3;
    sub_18008CEF4((__int64 *)v6, a2 + 48, (__int64)v8);
    if ( *(_QWORD *)&v6[8]
