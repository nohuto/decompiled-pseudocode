/*
 * XREFs of sub_180095EDC @ 0x180095EDC
 * Callers:
...
__int64 __fastcall sub_180095EDC(_DWORD *a1, __int64 a2, char a3)
{
  __int64 result; // rax
  char v6; // bl
  BOOL v7; // r14d
  ...
  if ( !(_DWORD)result || (_DWORD)result == 3 )
  {
    ...
    if ( v8 == 1 )
    {
      v10 = (__int64 *)sub_18009637C(a1, v38, 0LL);
      v11 = *v10;
      v24 = *v10;
    ...
    {
      v13 = (__int64 *)sub_18009637C(a1, v36, 0LL);
      v11 = *v13;
    ...
    *v12 = 0LL;
    ...
    v29 = v26;
    v26 = 0LL;
    v18 = sub_1800963AC(a1, v40, 0LL);
    v19 = sub_18009640C(a1, v41, 0LL);
    v20 = sub_1800963DC(a1, v42, 0LL);
    result = sub_180116BE8(v20, v19, v18, a1[30], (__int64)&v29, a1[28], v9, v7, a3, (__int64)v43, 0LL, (__int64)&v30);
