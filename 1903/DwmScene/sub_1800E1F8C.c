/*
 * XREFs of sub_1800E1F8C @ 0x1800E1F8C
 * Callers:
...
unsigned __int64 __fastcall sub_1800E1F8C(__int64 *a1, __int64 a2)
{
  __int64 v4; // r15
  __int64 v5; // r14
  ...
  try
  {
    ...
    if ( a2 == v12 )
    {
      sub_1800E20C0(v13, v12, v10, a1);
    }
    else
    {
      sub_1800E20C0(v13, a2, v10, a1);
      v16 = v10;
      sub_1800E20C0(a2, a1[1], v11 + v10 + 128, a1);
    }
  }
  catch ( ... )
  {
    sub_1800E2A18(a1, v16, v11 + v10 + 128);
    sub_1800E2B4C(a1, v10, v9);
    throw;
  }
  sub_1800E2960(a1, v10, v6, v9);
  return v11 + *a1;
}
