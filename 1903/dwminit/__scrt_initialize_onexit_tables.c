/*
 * XREFs of __scrt_initialize_onexit_tables @ 0x180005278
 * Callers:
 ...
 *     _initialize_onexit_table @ 0x180005A56 (_initialize_onexit_table.c)
 */
...
char __fastcall _scrt_initialize_onexit_tables(unsigned int a1)
{
  ...
  if ( !byte_18000B0D0 )
  {
    ...
    if ( !(unsigned int)_scrt_is_ucrt_dll_in_use() || a1 )
    {
      ...
      *((_QWORD *)&v4 + 1) = v3;
      Table._end = v3;
      *(_OWORD *)&stru_18000B0B8._first = v4;
      stru_18000B0B8._end = v3;
    }
