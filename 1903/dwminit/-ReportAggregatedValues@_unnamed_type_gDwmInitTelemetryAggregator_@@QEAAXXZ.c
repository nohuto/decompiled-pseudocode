/*
 * XREFs of ?ReportAggregatedValues@_unnamed_type_gDwmInitTelemetryAggregator_@@QEAAXXZ @ 0x1800012BC
 * Callers:
        ...
        const GUID *a4)
{
  ...
  if ( (gDwmInitTelemetryAggregator || dword_18000B74C || dword_18000B750 || dword_18000B754)
    ...
    && (qword_18000B018 & 0x400000000000LL) == qword_18000B018 )
  {
    ...
    v18 = 2LL;
    v20 = 2LL;
    TlgWrite(this, &unk_180008A05, 0LL, a4, 0xAu, &pData);
  }
}
