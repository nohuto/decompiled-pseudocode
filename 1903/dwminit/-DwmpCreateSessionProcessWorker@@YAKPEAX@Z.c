/*
 * XREFs of ?DwmpCreateSessionProcessWorker@@YAKPEAX@Z @ 0x180002AE0
 * Callers:
...
LABEL_33:
  ...
  if ( v5 < 0 )
  {
    DoStackCaptureDirect(v5, 0x4E8u);
    v2 = hToken;
    goto LABEL_34;
  }
  SetLastError(0);
...
LABEL_34:
  ...
  if ( v14 < 0 )
  {
    ...
    if ( (unsigned int)dword_18000B000 > 5 )
    {
      ...
      if ( (qword_18000B010 & 0x400000000000LL) != 0 && (qword_18000B018 & 0x400000000000LL) == qword_18000B018 )
      {
        ...
        v26 = 2LL;
        v28 = 2LL;
        TlgWrite(v9, &unk_1800086B8, v10, v11, 7u, &pData);
      }
    }
    _unnamed_type_gDwmInitTelemetryAggregator_::ReportAggregatedValues(v9, v8, (__int64)v10, v11);
  ...
  if ( v14 < 0 )
  {
    ...
    if ( v14 < 0 )
    {
      DoStackCaptureDirect(v14, 0x58Du);
      v12 = v14;
    }
  }
