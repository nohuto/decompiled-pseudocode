/*
 * XREFs of ?TraceLoggingWriteEtw@@YAXW4DwmInitEtwType@@JI@Z @ 0x180001410
 * Callers:
...
TLG_STATUS __fastcall TraceLoggingWriteEtw(const struct _TlgProvider_t *a1, int a2, const GUID *a3)
{
  ...
  v21 = (int)a3;
  v20 = a2;
  if ( (unsigned int)dword_18000B000 > 4 )
  {
    v7 = 16LL;
    ...
    v17 = 2LL;
    v19 = 2LL;
    return TlgWrite(a1, &unk_18000898A, a3, (LPCGUID)4, 9u, &pData);
  }
  return result;
}
