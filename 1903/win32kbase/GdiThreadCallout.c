/*
 * XREFs of GdiThreadCallout @ 0x1C0059760
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall GdiThreadCallout(__int64 a1, int a2)
{
  ...
  else
  {
    ...
    v5[35] = v5 + 14;
    v5[10] = 0LL;
    return (unsigned int)((__int64 (__fastcall *)(_QWORD *, __int64))qword_1C0215170)(v5 + 10, v6);
  }
  return v4;
}
