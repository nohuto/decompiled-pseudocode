/*
 * XREFs of ?ProcessInput@CPTPProcessor@@QEAAXPEAX0HHH@Z @ 0x1C017B728
 * Callers:
 ...
 *     ?UpdateEnvironment@CPTPProcessor@@AEAAXW4EnvironmentUpdateOptions@@PEAUtagHID_POINTER_DEVICE_INFO@@@Z @ 0x1C017C394 (-UpdateEnvironment@CPTPProcessor@@AEAAXW4EnvironmentUpdateOptions@@PEAUtagHID_POINTER_DEVICE_INF.c)
        ...
        int a6)
{
  ...
  if ( v10 )
  {
    ...
    *(_QWORD *)((char *)this + 1148) = *(_QWORD *)(*((_QWORD *)v12 + 16) + 256LL);
    ...
    v17 = qword_1C0218D50;
    if ( qword_1C0218D50 != *((_QWORD *)this + 302) )
    {
      *((_QWORD *)this + 302) = qword_1C0218D50;
      if ( v17 )
      {
        v18 = *(_QWORD *)v15;
    ...
    v23 = qword_1C0218D58;
    if ( qword_1C0218D58 != *((_QWORD *)this + 303) )
    {
      *((_QWORD *)this + 303) = qword_1C0218D58;
      if ( v23 )
      {
        v24 = *(_QWORD *)v15;
