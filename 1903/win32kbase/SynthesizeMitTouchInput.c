/*
 * XREFs of SynthesizeMitTouchInput @ 0x1C018E91C
 * Callers:
 ...
 *     ?CreateInjectionDevice@@YAHXZ @ 0x1C018E79C (-CreateInjectionDevice@@YAHXZ.c)
 *     ConvertPointCoordinates @ 0x1C018E894 (ConvertPointCoordinates.c)
 */
