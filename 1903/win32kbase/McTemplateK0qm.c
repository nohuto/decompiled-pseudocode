/*
 * XREFs of McTemplateK0qm @ 0x1C00BD86C
 * Callers:
 *     EtwTraceUiAuditWriteClipboard @ 0x1C00BD810 (EtwTraceUiAuditWriteClipboard.c)
 *     EtwTraceUiLimitWriteClipboard @ 0x1C00BD840 (EtwTraceUiLimitWriteClipboard.c)
 * Callees:
