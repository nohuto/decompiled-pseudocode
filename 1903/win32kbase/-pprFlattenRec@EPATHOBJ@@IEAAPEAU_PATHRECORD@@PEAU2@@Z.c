/*
 * XREFs of ?pprFlattenRec@EPATHOBJ@@IEAAPEAU_PATHRECORD@@PEAU2@@Z @ 0x1C007C070
 * Callers:
 *     ?bFlatten@EPATHOBJ@@QEAAHXZ @ 0x1C007C020 (-bFlatten@EPATHOBJ@@QEAAHXZ.c)
 * Callees:
 *     ?bNext@BEZIER32@@QEAAHPEAU_POINTFIX@@@Z @ 0x1C007C270 (-bNext@BEZIER32@@QEAAHPEAU_POINTFIX@@@Z.c)
 ...
 *     ?vInit@BEZIER64@@QEAAXPEAU_POINTFIX@@PEAU_RECTFX@@PEB_J@Z @ 0x1C0127840 (-vInit@BEZIER64@@QEAAXPEAU_POINTFIX@@PEAU_RECTFX@@PEB_J@Z.c)
 */
