/*
 * XREFs of ??$EmitSetProperty@UPropertySetScalarValue@@M@CPropertySetMarshaler@DirectComposition@@AEAA_NPEAPEAVCBatch@1@I@Z @ 0x1C000CA74
 * Callers:
        ...
        unsigned int a3)
{
  ...
  *((_DWORD *)v7 + 5) = *(_DWORD *)(*(_QWORD *)(a1 + 56) + 8 * v4);
  ...
  v8 = *(_QWORD *)(a1 + 56);
  *((_DWORD *)v7 + 7) = *(_DWORD *)((*(_DWORD *)(v8 + 8 * v4 + 4) & 0x1FFFFFFF) + *(_QWORD *)(a1 + 72));
