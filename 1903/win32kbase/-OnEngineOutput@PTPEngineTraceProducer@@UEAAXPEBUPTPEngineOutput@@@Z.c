/*
 * XREFs of ?OnEngineOutput@PTPEngineTraceProducer@@UEAAXPEBUPTPEngineOutput@@@Z @ 0x1C019A410
 * Callers:
 *     <none>
 * Callees:
...
void __fastcall PTPEngineTraceProducer::OnEngineOutput(PTPEngineTraceProducer *this, const struct PTPEngineOutput *a2)
{
  ...
  v2 = dword_1C020F490;
  if ( dword_1C020F490 > 5u && TlgKeywordOn((TraceLoggingHProvider)&dword_1C020F490, 5uLL) )
  {
    v10 = 0;
    v13 = 0;
    v16 = 0;
    ...
    v17 = a2;
    v18 = 20;
    TlgWrite((TraceLoggingHProvider)&dword_1C020F490, &unk_1C01E8C31, 0LL, 0LL, 6u, &pData);
    v2 = dword_1C020F490;
  }
  if ( *((_DWORD *)a2 + 4) && v2 > 5 && TlgKeywordOn((TraceLoggingHProvider)&dword_1C020F490, 5uLL) )
  {
    v10 = 0;
    v13 = 0;
    v16 = 0;
    ...
    v11 = v6;
    v14 = &v18;
    v17 = (const struct PTPEngineOutput *)((char *)a2 + 20);
    v19 = 0;
    v18 = 96 * v5;
    v9 = 8;
    v6[0] = 1;
    v12 = 4;
    v15 = 2;
    TlgWrite((TraceLoggingHProvider)&dword_1C020F490, &unk_1C01E8BEF, 0LL, 0LL, 6u, &pData);
  }
