/*
 * XREFs of ?OnProcessTermination@InputObjectMap@@SAXXZ @ 0x1C00382C0
 * Callers:
...
LABEL_3:
      for ( i = v4 + 1; ; ++i )
      {
        if ( i >= (_QWORD *)((char *)qword_1C02187D0 + 8 * ((unsigned __int64)(unsigned int)dword_1C02187CC >> 5)) )
        {
          v7 = 0LL;
          goto LABEL_6;
        }
