/*
 * XREFs of ?KernelCreateCompositionInputSink@CompositionInputObject@@SAJPEBUCOMPOSITION_INPUT_SINK_V2@@PEAPEAX@Z @ 0x1C008CA00
 * Callers:
        ...
        void **a2)
{
  ...
  _DWORD v36[2]; // [rsp+50h] [rbp-B0h] BYREF
  __int64 v37; // [rsp+58h] [rbp-A8h]
  __int64 v38; // [rsp+60h] [rbp-A0h]
  int v39; // [rsp+68h] [rbp-98h]
  int v40; // [rsp+6Ch] [rbp-94h]
  struct _ACL *v41; // [rsp+70h] [rbp-90h]
  __int64 v42; // [rsp+78h] [rbp-88h]
  _DWORD v43[76]; // [rsp+80h] [rbp-80h] BYREF
  _BYTE v44[336]; // [rsp+1B0h] [rbp+B0h] BYREF
  HANDLE Handle; // [rsp+310h] [rbp+210h] BYREF
  struct _ACL *v46; // [rsp+320h] [rbp+220h] BYREF
  ...
  *v2 = v14;
  v2[1] = v15;
  *((_QWORD *)v2 + 4) = v12;
  if ( v43[0] != 232 && (v43[0] != 296 || v43[58] > 4u) || v43[2] > 4u || v43[16] > 4u || v43[30] > 4u || v43[44] > 4u )
    v13 = -1073741811;
  ...
  if ( v13 < 0 )
    goto LABEL_24;
  v18 = UserAllocDefaultCompositionSecurityDescriptor(v16, &v46);
  v19 = v46;
  v13 = v18;
  if ( v18 >= 0 )
  {
