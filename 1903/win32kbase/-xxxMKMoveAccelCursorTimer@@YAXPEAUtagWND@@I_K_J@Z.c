/*
 * XREFs of ?xxxMKMoveAccelCursorTimer@@YAXPEAUtagWND@@I_K_J@Z @ 0x1C015F0F0
 * Callers:
 *     <none>
 * Callees:
...
void __fastcall xxxMKMoveAccelCursorTimer(struct tagWND *a1, unsigned __int8 *a2)
{
  char v2; // al
  int v3; // ebx
  __int64 v4; // rcx
...
LABEL_6:
    ...
    {
      v3 = (unsigned __int8)byte_1C0214532;
      giMouseMoveTable = 1;
    ...
    {
      a2 = byte_1C02144B1;
      v3 = byte_1C02144B1[giMouseMoveTable++];
    }
    if ( !v3 )
      return;
    goto LABEL_10;
  }
  v3 = 4 * (unsigned __int8)byte_1C0214532;
LABEL_10:
  if ( (_DWORD)gdwInAtomicOperation && (gdwExtraInstrumentations & 1) != 0 )
    KeBugCheckEx(0x160u, (unsigned int)gdwInAtomicOperation, 0LL, 0LL, 0LL);
  UserSessionSwitchLeaveCrit((unsigned int)gdwInAtomicOperation, (__int64)a2);
    ...
    *(GUID *)(v37 + 28) = ActivityId;
    if ( dword_1C020FB50 > 6u )
    {
      if ( TlgKeywordOn((TraceLoggingHProvider)&dword_1C020FB50, 0x2000uLL) )
      {
        ...
        v45 = &v35;
        v46 = 4;
        TlgWrite((TraceLoggingHProvider)&dword_1C020FB50, &unk_1C01E3480, &ActivityId, 0LL, 3u, &v44);
        v15 = dword_1C020FB50;
      }
      if ( v15 > 6 && TlgKeywordOn((TraceLoggingHProvider)&dword_1C020FB50, 0x2000uLL) )
      {
        v51 = 0;
        v36 = v38;
        v49 = &v36;
