/*
 * XREFs of ?CitpDPGetAppIndex@@YAIPEAU_CIT_PROCESS@@@Z @ 0x1C0090B64
 * Callers:
...
__int64 __fastcall CitpDPGetAppIndex(struct _CIT_PROCESS *a1)
{
  ...
  *(_QWORD *)&String2.Length = 0LL;
  ...
  v7 = 0;
  v8 = (PCUNICODE_STRING *)&unk_1C01CE580;
  ...
  if ( *(_DWORD *)v8 > 6u )
  {
    ...
    {
      case 7u:
        if ( (unsigned int)dword_1C020FDE4 < MEMORY[0xFFFFF7800000037C] )
        {
          v10 = &off_1C020FDD8;
          goto LABEL_25;
        }
        break;
      case 8u:
        if ( (unsigned int)dword_1C020F16C < MEMORY[0xFFFFF7800000037C] )
        {
          v10 = &off_1C020F160;
          goto LABEL_25;
        }
        break;
      case 9u:
        if ( (unsigned int)dword_1C020FDB4 < MEMORY[0xFFFFF7800000037C] )
        {
          v10 = &off_1C020FDA8;
          goto LABEL_25;
        }
        break;
      default:
        if ( v1 == 10 && (unsigned int)dword_1C020FD9C < MEMORY[0xFFFFF7800000037C] )
        {
          v10 = &off_1C020FD90;
          goto LABEL_25;
        }
  ...
  else
  {
    ...
    {
      case 6u:
        if ( (unsigned int)dword_1C020FDCC < MEMORY[0xFFFFF7800000037C] )
        {
          v10 = &off_1C020FDC0;
          goto LABEL_25;
        }
        break;
      case 1u:
        if ( (unsigned int)dword_1C020F1CC < MEMORY[0xFFFFF7800000037C] )
        {
          v10 = &off_1C020F1C0;
LABEL_25:
        ...
        break;
      case 2u:
        if ( (unsigned int)dword_1C020F1B4 >= MEMORY[0xFFFFF7800000037C] )
          break;
        v10 = &off_1C020F1A8;
        goto LABEL_25;
      case 3u:
        if ( (unsigned int)dword_1C020FDFC < MEMORY[0xFFFFF7800000037C] )
        {
          v10 = &off_1C020FDF0;
          goto LABEL_25;
        }
        break;
      case 4u:
        if ( (unsigned int)dword_1C020F184 < MEMORY[0xFFFFF7800000037C] )
        {
          v10 = &off_1C020F178;
          goto LABEL_25;
        }
        break;
      default:
        if ( v1 == 5 && (unsigned int)dword_1C020F19C < MEMORY[0xFFFFF7800000037C] )
        {
          v10 = &off_1C020F190;
          goto LABEL_25;
        }
