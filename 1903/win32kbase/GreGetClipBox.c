/*
 * XREFs of GreGetClipBox @ 0x1C003AC40
 * Callers:
...
__int64 __fastcall GreGetClipBox(HDC a1, _DWORD *a2, int a3)
{
  ...
  if ( v20[0] )
  {
    ...
    v25[1] = 0LL;
    v26 = 256;
    DEVLOCKOBJ::bLock((DEVLOCKOBJ *)v24, v20, 1);
    if ( (v24[24] & 1) != 0 )
    {
      if ( DC::prgnRao(v20[0]) )
        v7 = DC::prgnRao(v6);
      ...
      else
      {
        ...
        *a2 -= *v13;
        ...
        if ( a3 )
        {
          ...
          EXFORMOBJ::vInit(&v21, v20, 1026, 0x80000000);
          if ( v21 )
          {
            if ( ((_BYTE)v21[8] & 0x43) != 0x43 )
              bCvtPts1((unsigned __int64)v21, a2, 2LL);
            if ( v23 )
            {
              ++*a2;
              ++a2[2];
