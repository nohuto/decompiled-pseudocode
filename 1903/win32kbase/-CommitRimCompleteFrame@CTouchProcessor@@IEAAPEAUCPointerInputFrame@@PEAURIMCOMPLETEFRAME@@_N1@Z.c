/*
 * XREFs of ?CommitRimCompleteFrame@CTouchProcessor@@IEAAPEAUCPointerInputFrame@@PEAURIMCOMPLETEFRAME@@_N1@Z @ 0x1C0163C70
 * Callers:
  ...
  if ( a4 )
  {
    if ( *((_DWORD *)v6 + 49) )
    {
      if ( WPP_RECORDER_INITIALIZED == (_UNKNOWN *)&WPP_RECORDER_INITIALIZED )
        goto LABEL_81;
      LOBYTE(v7) = 3;
      WPP_RECORDER_SF_((_DWORD)gBaseLog, v7, 7, 158, (__int64)&WPP_06d7dff703a03015e007562f188a8383_Traceguids);
      if ( WPP_RECORDER_INITIALIZED == (_UNKNOWN *)&WPP_RECORDER_INITIALIZED )
        goto LABEL_81;
...
LABEL_81:
  ...
  else if ( *((_DWORD *)v6 + 48) )
  {
    if ( WPP_RECORDER_INITIALIZED == (_UNKNOWN *)&WPP_RECORDER_INITIALIZED )
      goto LABEL_81;
    LOBYTE(v7) = 3;
    WPP_RECORDER_SF_((_DWORD)gBaseLog, v7, 7, 160, (__int64)&WPP_06d7dff703a03015e007562f188a8383_Traceguids);
    if ( WPP_RECORDER_INITIALIZED == (_UNKNOWN *)&WPP_RECORDER_INITIALIZED )
      goto LABEL_81;
    v11 = WPP_GLOBAL_Control;
    if ( !LOWORD(WPP_GLOBAL_Control->DeviceType) )
  ...
  if ( v15 < 0 )
  {
    if ( WPP_RECORDER_INITIALIZED == (_UNKNOWN *)&WPP_RECORDER_INITIALIZED )
      goto LABEL_81;
    LOBYTE(v16) = 2;
    WPP_RECORDER_SF_D((_DWORD)gBaseLog, v16, 7, 162, (__int64)&WPP_06d7dff703a03015e007562f188a8383_Traceguids, v15);
    if ( WPP_RECORDER_INITIALIZED == (_UNKNOWN *)&WPP_RECORDER_INITIALIZED )
      goto LABEL_81;
    v11 = WPP_GLOBAL_Control;
    if ( !LOWORD(WPP_GLOBAL_Control->DeviceType) )
  ...
  *(_QWORD *)&v53 = HMValidateHandleNoSecure(v17, 19);
  ...
  if ( !v24 )
  {
    if ( WPP_RECORDER_INITIALIZED == (_UNKNOWN *)&WPP_RECORDER_INITIALIZED )
      goto LABEL_81;
    LOBYTE(v23) = 2;
    WPP_RECORDER_SF_((_DWORD)gBaseLog, v23, 7, 164, (__int64)&WPP_06d7dff703a03015e007562f188a8383_Traceguids);
    if ( WPP_RECORDER_INITIALIZED == (_UNKNOWN *)&WPP_RECORDER_INITIALIZED )
      goto LABEL_81;
    v11 = WPP_GLOBAL_Control;
    if ( !LOWORD(WPP_GLOBAL_Control->DeviceType) )
  ...
  *((_QWORD *)v24 + 17) = v26;
  if ( !v26 )
  {
    ...
    if ( WPP_RECORDER_INITIALIZED == (_UNKNOWN *)&WPP_RECORDER_INITIALIZED )
      goto LABEL_81;
    LOBYTE(v27) = 2;
    WPP_RECORDER_SF_((_DWORD)gBaseLog, v27, 7, 166, (__int64)&WPP_06d7dff703a03015e007562f188a8383_Traceguids);
    if ( WPP_RECORDER_INITIALIZED == (_UNKNOWN *)&WPP_RECORDER_INITIALIZED )
      goto LABEL_81;
    v11 = WPP_GLOBAL_Control;
    if ( !LOWORD(WPP_GLOBAL_Control->DeviceType) )
  ...
  if ( !*((_QWORD *)v24 + 16) )
  {
    ...
    if ( WPP_RECORDER_INITIALIZED == (_UNKNOWN *)&WPP_RECORDER_INITIALIZED )
      goto LABEL_81;
    LOBYTE(v29) = 2;
    WPP_RECORDER_SF_((_DWORD)gBaseLog, v29, 7, 168, (__int64)&WPP_06d7dff703a03015e007562f188a8383_Traceguids);
    if ( WPP_RECORDER_INITIALIZED == (_UNKNOWN *)&WPP_RECORDER_INITIALIZED )
      goto LABEL_81;
    v11 = WPP_GLOBAL_Control;
    if ( !LOWORD(WPP_GLOBAL_Control->DeviceType) )
  ...
  *(_QWORD *)v24 = gpTouchProcessor;
  ...
  if ( v40 )
  {
    ...
    {
      LOBYTE(v41) = 2;
      WPP_RECORDER_SF_((_DWORD)gBaseLog, v41, 7, 171, (__int64)&WPP_06d7dff703a03015e007562f188a8383_Traceguids);
    }
    v47 = *((_QWORD *)v24 + 15);
    while ( v47 )
    {
