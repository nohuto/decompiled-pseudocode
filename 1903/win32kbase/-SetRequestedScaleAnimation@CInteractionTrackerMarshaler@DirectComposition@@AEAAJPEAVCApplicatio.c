/*
 * XREFs of ?SetRequestedScaleAnimation@CInteractionTrackerMarshaler@DirectComposition@@AEAAJPEAVCApplicationChannel@2@PEAVCBaseExpressionMarshaler@2@PEA_N@Z @ 0x1C01AD76C
 * Callers:
...
__int64 __fastcall DirectComposition::CInteractionTrackerMarshaler::SetRequestedScaleAnimation(
        ...
        bool *a4)
{
  ...
  else
  {
    ...
    v11 = (struct DirectComposition::CWeakReferenceBase *)*((_QWORD *)this + 25);
    if ( v11 )
