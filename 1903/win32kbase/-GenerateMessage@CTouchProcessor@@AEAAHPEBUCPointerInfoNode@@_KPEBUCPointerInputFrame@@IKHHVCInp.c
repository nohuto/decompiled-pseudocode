/*
 * XREFs of ?GenerateMessage@CTouchProcessor@@AEAAHPEBUCPointerInfoNode@@_KPEBUCPointerInputFrame@@IKHHVCInputDest@@@Z @ 0x1C0167B6C
 * Callers:
 ...
 *     EtwTraceBeginPointerMessageGeneration @ 0x1C010D5E0 (EtwTraceBeginPointerMessageGeneration.c)
 *     EtwTraceEndPointerMessageGeneration @ 0x1C010DCD0 (EtwTraceEndPointerMessageGeneration.c)
...
LABEL_24:
    if ( !*(_DWORD *)a9 )
    {
      ...
      {
        LOBYTE(v15) = 4;
        WPP_RECORDER_SF_((_DWORD)gBaseLog, v15, 7, 288, (__int64)&WPP_06d7dff703a03015e007562f188a8383_Traceguids);
        if ( WPP_RECORDER_INITIALIZED != (_UNKNOWN *)&WPP_RECORDER_INITIALIZED )
        {
...
LABEL_30:
  ...
  {
    LOBYTE(v15) = 4;
    WPP_RECORDER_SF_((_DWORD)gBaseLog, v15, 7, 286, (__int64)&WPP_06d7dff703a03015e007562f188a8383_Traceguids);
    if ( WPP_RECORDER_INITIALIZED != (_UNKNOWN *)&WPP_RECORDER_INITIALIZED )
    {
      v22 = WPP_GLOBAL_Control;
      if ( LOWORD(WPP_GLOBAL_Control->DeviceType) )
...
LABEL_34:
        LOBYTE(v15) = 5;
        WPP_RECORDER_SF_(v22->DeviceExtension, v15, 7, v23, (__int64)&WPP_06d7dff703a03015e007562f188a8383_Traceguids);
      }
    }
  }
LABEL_44:
