/*
 * XREFs of ?HandleTSRequest@CBaseInput@@QEAAXW4InputTSRequest@@@Z @ 0x1C0069570
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall CBaseInput::HandleTSRequest(CBaseInput *a1, __int64 a2, __int64 a3)
{
  ...
  {
    if ( *((_DWORD *)&unk_1C01CD2E0 + 6 * (unsigned int)a2) != (_DWORD)a2 )
      MicrosoftTelemetryAssertTriggeredNoArgsKM(a1, a2, a3);
    if ( *((_DWORD *)&unk_1C01CD2E0 + 6 * v3 + 4) >= 0x10u || CBaseInput::ExecutingOnSensorHostingThread(a1) )
    {
      (*((void (__fastcall **)(CBaseInput *))&unk_1C01CD2E0 + 3 * v3 + 1))(a1);
    }
    else
    {
      UserSessionSwitchLeaveCrit(v6, v5);
      CRIMBase::SensorDoWorkAndWait(a1, *((unsigned int *)&unk_1C01CD2E0 + 6 * v3 + 4));
