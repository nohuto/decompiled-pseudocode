/*
 * XREFs of ?SetLastAction@Telemetry@CPTPProcessor@@SAXW4tagPTP_ACTION@@@Z @ 0x1C017BE64
 * Callers:
...
char __fastcall CPTPProcessor::Telemetry::SetLastAction(int a1)
{
  ...
  v3 = (unsigned __int64)(1000
                        * (PerformanceCounter.QuadPart - _InterlockedCompareExchange64(&qword_1C0218D60, 0LL, 0LL)))
     / gliQpcFreq.QuadPart;
  v11 = v3;
  if ( v3 <= 500 )
  {
    _InterlockedCompareExchange64(&qword_1C0218D50, 0LL, 0LL);
    LOBYTE(v3) = _InterlockedCompareExchange64(&qword_1C0218D58, 0LL, 0LL);
    v9 = dword_1C0218D6C;
    if ( hProvider > 5u )
    {
      ...
      if ( (_BYTE)v3 )
      {
        ...
        v21 = &v13;
        v23 = &v9;
        LOBYTE(v3) = TlgWrite((TraceLoggingHProvider)&hProvider, &unk_1C01E710A, 0LL, 0LL, 7u, &pData);
      }
    }
  }
  if ( dword_1C02139D8 || qword_1C02139C0 || gTPTelemTimings <= 0 )
    dword_1C02139DC = a1;
  else
    dword_1C02139D8 = a1;
  if ( a1 > 12 )
...
LABEL_57:
  if ( hProvider > 5u )
  {
    ...
    v26 = &v10;
    v27 = 4LL;
    LOBYTE(v3) = TlgWrite((TraceLoggingHProvider)&hProvider, &unk_1C01E70E5, 0LL, 0LL, 3u, &v25);
  }
  return v3;
}
