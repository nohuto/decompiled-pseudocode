/*
 * XREFs of ?LockShared@CInpLockGuard@@QEAAXAEAVCLockListEntryStack@@@Z @ 0x1C0179560
 * Callers:
...
void __fastcall CInpLockGuard::LockShared(CInpLockGuard *this, struct CLockListEntryStack *a2)
{
  ...
  while ( 1 )
  {
          ...
          *(GUID *)(v60 + 28) = ActivityId;
          if ( dword_1C020FB50 > 6u )
          {
            if ( TlgKeywordOn((TraceLoggingHProvider)&dword_1C020FB50, 0x2000uLL) )
            {
              ...
              v70 = &v55;
              v71 = 4LL;
              TlgWrite((TraceLoggingHProvider)&dword_1C020FB50, &unk_1C01E3480, &ActivityId, 0LL, 3u, &v69);
              v20 = dword_1C020FB50;
            }
            if ( v20 > 6 && TlgKeywordOn((TraceLoggingHProvider)&dword_1C020FB50, 0x2000uLL) )
            {
              ...
              v73 = &v56;
              v74 = 4LL;
              TlgWrite((TraceLoggingHProvider)&dword_1C020FB50, &unk_1C01E34AD, &ActivityId, 0LL, 3u, &v72);
            }
          }
        }
          ...
          if ( v39 && (*(int *)(v39 + 24) > 0 || *(_DWORD *)(v63 + 48)) )
          {
            ...
            if ( dword_1C020FB50 > 6u )
            {
              if ( TlgKeywordOn((TraceLoggingHProvider)&dword_1C020FB50, 0x2000uLL) )
              {
                ...
                v76 = &v58;
                v77 = 4LL;
                TlgWrite((TraceLoggingHProvider)&dword_1C020FB50, &unk_1C01E34D7, &pActivityId, 0LL, 3u, &v75);
              }
            }
          }
        }
    ...
    if ( InputTraceLogging::Perf::s_userCritLoggingEnabled )
    {
      ...
      {
        v53 = *(_DWORD *)(v51 + 24);
        if ( (*(_DWORD *)(v52 + 44) || *(_DWORD *)(v52 + 48) || v53 > 0) && dword_1C020FB50 > 6u )
        {
          if ( TlgKeywordOn((TraceLoggingHProvider)&dword_1C020FB50, 0x2000uLL) )
            TlgWrite((TraceLoggingHProvider)&dword_1C020FB50, &unk_1C01E3461, (LPCGUID)(v52 + 28), 0LL, 2u, &v78);
        }
        *(_DWORD *)(v52 + 44) = 0;
        v59 = 0uLL;
        *(_OWORD *)(v52 + 28) = 0uLL;
