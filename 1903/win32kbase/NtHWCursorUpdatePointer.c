/*
 * XREFs of NtHWCursorUpdatePointer @ 0x1C0130590
 * Callers:
 *     <none>
 * Callees:
...
LABEL_10:
      ...
      *((_QWORD *)&v25 + 1) = v19;
      ...
      v12 = ((__int64 (__fastcall *)(struct _LUID *, int *, _DWORD *, _QWORD))qword_1C0215298)(v20, &v28, v24, 0LL);
    ...
    else
    {
      ...
      v12 = ((__int64 (__fastcall *)(struct _LUID *, int *, _QWORD))qword_1C0215290)(v11, &v28, 0LL);
      v13 = v12 < 0;
    }
    if ( v13 )
      v12 = -1073741823;
