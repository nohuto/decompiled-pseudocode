/*
 * XREFs of PowerIsDisplayIdleExpired @ 0x1C0082CD0
 * Callers:
 *     <none>
 * Callees:
 *     ?IsTimeFromLastInputEvent@CInputGlobals@@QEBA_NK@Z @ 0x1C0081C30 (-IsTimeFromLastInputEvent@CInputGlobals@@QEBA_NK@Z.c)
 ...
 *     PowerIsDisplayBurstActive @ 0x1C0108B90 (PowerIsDisplayBurstActive.c)
...
_BOOL8 __fastcall PowerIsDisplayIdleExpired(int a1, int *a2)
{
  ...
  if ( CInputGlobals::GetGlobalTickCount(gpInputGlobals, 0LL) < (unsigned __int64)qword_1C0215758 )
  {
