/*
 * XREFs of ?ResetOrg@@YAXPEAUHRGN__@@PEAUtagDCE@@H@Z @ 0x1C001F930
 * Callers:
 ...
 *     ?vCalcFillOrigin@DC@@QEAAXXZ @ 0x1C003CA88 (-vCalcFillOrigin@DC@@QEAAXXZ.c)
 ...
 *     GetMonitorRectForDpi @ 0x1C0098218 (GetMonitorRectForDpi.c)
...
void __fastcall ResetOrg(HRGN a1, struct tagDCE *a2, int a3)
{
  ...
  int *v38[2]; // [rsp+70h] [rbp-31h] BYREF
    ...
    if ( LayeredOrRedirectedParent )
    {
        ...
        && GetRedirectionBitmap(v18) )
      {
        ...
        if ( a1 )
        {
          ...
          if ( v38[0] )
          {
            RGNOBJ::bOffset(v38, &v44);
            v25 = v38[0];
          }
          if ( !v39 )
            RGNOBJ::UpdateUserRgn((RGNOBJ *)v38);
          if ( v25 )
            _InterlockedDecrement(v25 + 3);
        }
        v5 = v45;
        goto LABEL_30;
      }
