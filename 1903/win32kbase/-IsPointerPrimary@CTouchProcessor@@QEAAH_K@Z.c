/*
 * XREFs of ?IsPointerPrimary@CTouchProcessor@@QEAAH_K@Z @ 0x1C016DEA0
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall CTouchProcessor::IsPointerPrimary(CTouchProcessor *this, __int64 a2)
{
  ...
  CInpLockGuardShared::CInpLockGuardShared((CInpLockGuardShared *)&v4, (CTouchProcessor *)((char *)this + 48));
  if ( a2 )
