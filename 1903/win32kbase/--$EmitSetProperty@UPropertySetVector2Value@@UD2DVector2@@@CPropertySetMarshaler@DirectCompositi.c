/*
 * XREFs of ??$EmitSetProperty@UPropertySetVector2Value@@UD2DVector2@@@CPropertySetMarshaler@DirectComposition@@AEAA_NPEAPEAVCBatch@1@I@Z @ 0x1C0004FBC
 * Callers:
        ...
        unsigned int a3)
{
  ...
  *(_QWORD *)(v7 + 28) = *(_QWORD *)((*(_DWORD *)(*(_QWORD *)(a1 + 56) + 8 * v4 + 4) & 0x1FFFFFFF) + *(_QWORD *)(a1 + 72));
