/*
 * XREFs of ?DispatchFrame@RIM@InputTraceLogging@@SAXPEBURIMDEV@@PEBURIMCOMPLETEFRAME@@_N@Z @ 0x1C0152394
 * Callers:
        ...
        char a3)
{
  ...
  if ( a3 && dword_1C020FB50 > 4u && TlgKeywordOn((TraceLoggingHProvider)&dword_1C020FB50, 0x100uLL) )
  {
    v40 = 0;
    v38 = &v11;
    v11 = a1;
    v39 = 8;
    TlgWrite((TraceLoggingHProvider)&dword_1C020FB50, &unk_1C01E571D, 0LL, 0LL, 3u, &pData);
  }
  if ( dword_1C020FB50 > 4u )
  {
    if ( TlgKeywordOn((TraceLoggingHProvider)&dword_1C020FB50, 0x100uLL) )
    {
      ...
      v34 = &v11;
      v35 = 4;
      TlgWrite((TraceLoggingHProvider)&dword_1C020FB50, &unk_1C01E5749, 0LL, 0LL, 9u, &v15);
    }
  }
}
