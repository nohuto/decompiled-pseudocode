/*
 * XREFs of ?EmitUpdateRails@CInteractionMarshaler@DirectComposition@@IEAA_NPEAPEAVCBatch@2@@Z @ 0x1C003F43C
 * Callers:
        ...
        struct DirectComposition::CBatch **a2)
{
  ...
  if ( (*((_DWORD *)this + 4) & 0x800) != 0 )
  {
    if ( DirectComposition::CBatch::EnsureBatchBuffer(a2, 0x10uLL, &v6) )
    {
      ...
      *((_DWORD *)v5 + 1) = 222;
      v5[12] = (*((_BYTE *)this + 316) & 0x20) != 0;
      v5[13] = (*((_BYTE *)this + 316) & 0x40) != 0;
