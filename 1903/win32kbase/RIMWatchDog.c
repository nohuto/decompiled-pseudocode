/*
 * XREFs of RIMWatchDog @ 0x1C0038190
 * Callers:
 *     <none>
 * Callees:
        ...
        && (struct _LIST_ENTRY *)(*(_QWORD *)&KeQueryPerformanceCounter(0LL) - (unsigned __int64)v2[45].Blink) > v2[46].Flink )
      {
        if ( !PsGetProcessDebugPort(v2[2].Flink) )
        {
          ...
          if ( dword_1C020F490 > 5u && TlgKeywordOn((TraceLoggingHProvider)&dword_1C020F490, 0x400000000000uLL) )
          {
            ...
            v33 = 4LL;
            TlgWrite((TraceLoggingHProvider)&dword_1C020F490, &unk_1C01E3F54, 0LL, 0LL, 7u, &pData);
          }
        }
      ...
      else
      {
        ...
        if ( (struct _LIST_ENTRY *)(*(_QWORD *)&KeQueryPerformanceCounter(0LL) - (unsigned __int64)v2[44].Blink) > v2[44].Flink )
        {
          ...
          if ( dword_1C020F490 > 5u && TlgKeywordOn((TraceLoggingHProvider)&dword_1C020F490, 0x400000000000uLL) )
          {
            ...
            v44 = 4LL;
            TlgWrite((TraceLoggingHProvider)&dword_1C020F490, &unk_1C01E3F0C, 0LL, 0LL, 7u, &v34);
          }
        }
      }
