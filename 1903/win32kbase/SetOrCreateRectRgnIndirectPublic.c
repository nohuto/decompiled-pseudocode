/*
 * XREFs of SetOrCreateRectRgnIndirectPublic @ 0x1C0027080
 * Callers:
    ...
    if ( v25[0] )
    {
      ...
      *(_QWORD *)&v24 = __PAIR64__(top, left);
        ...
        && ((top & 0xF8000000) == 0 || (top & 0xF8000000) == 0xF8000000) )
      {
        ...
        {
          v15 = *(_DWORD *)(v25[0] + 80LL) == 160;
          v16 = (int *)(v25[0] + 104LL);
          *(_OWORD *)(v25[0] + 88LL) = v24;
          if ( v15 )
          {
            v17 = *v16;
            v2 = 1;
          ...
          else
          {
            ...
            *(_DWORD *)(v8 + 112) = v10;
            *(_DWORD *)(v8 + 116) = 0;
            v22 = (int *)((char *)v16 + (unsigned int)(4 * *v16 + 16));
            *v22 = 2;
            v22[1] = v10;
            v22[2] = bottom;
            v22[3] = v9;
