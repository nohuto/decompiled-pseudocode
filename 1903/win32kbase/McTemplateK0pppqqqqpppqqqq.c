/*
 * XREFs of McTemplateK0pppqqqqpppqqqq @ 0x1C011048C
 * Callers:
 *     EtwTraceWindowRenderingOldToNewRedirectionBitmap @ 0x1C00A6000 (EtwTraceWindowRenderingOldToNewRedirectionBitmap.c)
 *     EtwWindowRendering @ 0x1C01323E0 (EtwWindowRendering.c)
 * Callees:
 *     McGenEventWrite @ 0x1C006C7F8 (McGenEventWrite.c)
 *     __security_check_cookie @ 0x1C00BAF90 (__security_check_cookie.c)
 */

ULONG McTemplateK0pppqqqqpppqqqq(struct _MCGEN_TRACE_CONTEXT *a1, const EVENT_DESCRIPTOR *a2, __int64 a3, ...)
{
  ...
  v30 = 4LL;
  v32 = 4LL;
  return McGenEventWrite(a1, a2, (LPCGUID)&Context.Flags, 0xFu, &EventData);
}
