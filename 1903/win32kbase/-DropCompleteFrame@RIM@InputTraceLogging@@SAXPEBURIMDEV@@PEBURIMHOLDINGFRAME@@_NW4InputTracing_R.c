/*
 * XREFs of ?DropCompleteFrame@RIM@InputTraceLogging@@SAXPEBURIMDEV@@PEBURIMHOLDINGFRAME@@_NW4InputTracing_RimCompletionReason@@@Z @ 0x1C014E7DC
 * Callers:
 ...
 *     ?CompletionReasonToString@InputTraceLogging@@CAPEBDW4InputTracing_RimCompletionReason@@@Z @ 0x1C014E780 (-CompletionReasonToString@InputTraceLogging@@CAPEBDW4InputTracing_RimCompletionReason@@@Z.c)
 */
...
char __fastcall InputTraceLogging::RIM::DropCompleteFrame(__int64 a1, __int64 a2, unsigned __int8 a3, int a4)
{
  ...
  {
    LOBYTE(v4) = TlgKeywordOn((TraceLoggingHProvider)&dword_1C020FB50, 0x100uLL);
    if ( (_BYTE)v4 )
    {
      v11 = *(_QWORD *)(a1 + 472);
      v25 = 0;
      ...
      LOBYTE(v4) = TlgWrite((TraceLoggingHProvider)&dword_1C020FB50, &unk_1C01E5083, 0LL, 0LL, 0xAu, &pData);
    }
  }
  return (char)v4;
}
