/*
 * XREFs of ?UnregisterObject@RegistrarClient@CoreMessagingK@@SAJPEBG@Z @ 0x1C00B829C
 * Callers:
...
__int64 __fastcall CoreMessagingK::RegistrarClient::UnregisterObject(LPCWSTR pwsz)
{
  ...
  v11 = 1uLL;
  v12 = 0LL;
  v2 = CoreUICallSend((int)&v8, (int)&v7, 1, 1, 9, (__int64)&unk_1C01DB3EB, pwsz, &v11, v6);
  if ( v2 < 0 )
  ...
  if ( dword_1C020F5E0 > 5u )
  {
    ...
    v15 = &v7;
    v16 = 4;
    TlgWrite((TraceLoggingHProvider)&dword_1C020F5E0, &unk_1C01EA1B7, 0LL, 0LL, 4u, &pData);
  }
  return v4;
}
