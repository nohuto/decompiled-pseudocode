/*
 * XREFs of ?Create@CSharedWriteScalarMarshaler@DirectComposition@@SAJPEBVCSharedSystemResource@2@PEAPEAV12@@Z @ 0x1C01C60DC
 * Callers:
 *     CreateSharedWriteScalarMarshaler @ 0x1C01C6220 (CreateSharedWriteScalarMarshaler.c)
 * Callees:
