/*
 * XREFs of ?ProcessMouseMove@CMouseProcessor@@AEAAXAEBVCMoveEvent@1@@Z @ 0x1C00312BC
 * Callers:
 ...
 *     IsPointerPromotedMouseMessage @ 0x1C0042D80 (IsPointerPromotedMouseMessage.c)
 ...
 *     ?AnalyzeNewMousePosition@CMouseProcessor@@AEBA?AW4MoveNewPosResult@1@AEBVCMouseEvent@1@@Z @ 0x1C0098134 (-AnalyzeNewMousePosition@CMouseProcessor@@AEBA-AW4MoveNewPosResult@1@AEBVCMouseEvent@1@@Z.c)
...
void __fastcall CMouseProcessor::ProcessMouseMove(CMouseProcessor *this, const struct CMouseProcessor::CMoveEvent *a2)
{
  ...
  {
    LOBYTE(a2) = 4;
    WPP_RECORDER_SF_((_DWORD)gBaseLog, (_DWORD)a2, 6, 44, (__int64)&WPP_a819e7d240c13332848bedce030fc704_Traceguids);
  }
  v4 = 0;
  ...
  else
  {
    ...
    CMouseProcessor::CMouseRawInput::PostRawMouse((char *)this + 3200, 0LL, 0LL);
    if ( !v14 )
    {
      if ( WPP_RECORDER_INITIALIZED != (_UNKNOWN *)&WPP_RECORDER_INITIALIZED )
      {
        LOBYTE(v17) = 3;
        WPP_RECORDER_SF_((_DWORD)gBaseLog, v17, 6, 45, (__int64)&WPP_a819e7d240c13332848bedce030fc704_Traceguids);
      }
      v18 = 11LL;
      goto LABEL_25;
    }
    *((_QWORD *)this + 399) = *(unsigned int *)(*((_QWORD *)v2 + 1) + 40LL);
    v19 = *((_QWORD *)v2 + 1);
    *((_QWORD *)this + 397) = *(_QWORD *)(v19 + 52);
    *((_QWORD *)this + 398) = *(_QWORD *)(v19 + 60);
  }
  if ( (*(_DWORD *)(*((_QWORD *)v2 + 1) + 104LL) & 0x800) != 0
    || !(unsigned __int8)anonymous_namespace_::InMouseRawInputMode(0LL, 1LL, 1LL) )
  {
    ...
    v40 = *((_QWORD *)gpsi + 619);
    _InterlockedCompareExchange((volatile signed __int32 *)this + 860, 1, 1);
    ...
    if ( dword_1C020FB50 > 4u && TlgKeywordOn((TraceLoggingHProvider)&dword_1C020FB50, 0x40uLL) )
    {
      ...
      v54 = &v42;
      v55 = v29;
      TlgWrite((TraceLoggingHProvider)&dword_1C020FB50, &unk_1C01E8269, 0LL, 0LL, 6u, &pData);
    }
    if ( !v43[0] )
    {
      if ( WPP_RECORDER_INITIALIZED != (_UNKNOWN *)&WPP_RECORDER_INITIALIZED )
      {
        LOBYTE(v7) = 4;
        WPP_RECORDER_SF_((_DWORD)gBaseLog, v7, 6, 47, (__int64)&WPP_a819e7d240c13332848bedce030fc704_Traceguids);
      }
      v21 = 13LL;
      goto LABEL_35;
    }
    if ( v4 )
    {
      ...
      if ( v39[0] == v33.x && v39[1] == v33.y )
      {
        ...
        {
          LOBYTE(v20) = 4;
          WPP_RECORDER_SF_((_DWORD)gBaseLog, v20, 6, 48, (__int64)&WPP_a819e7d240c13332848bedce030fc704_Traceguids);
        }
        v21 = 11LL;
        goto LABEL_35;
      }
...
LABEL_17:
    ...
    LOBYTE(v22) = 3;
    WPP_RECORDER_SF_((_DWORD)gBaseLog, v22, 6, v30, (__int64)&WPP_a819e7d240c13332848bedce030fc704_Traceguids);
    goto LABEL_56;
  }
  ...
  {
    LOBYTE(v24) = 3;
    WPP_RECORDER_SF_((_DWORD)gBaseLog, v24, 6, 46, (__int64)&WPP_a819e7d240c13332848bedce030fc704_Traceguids);
  }
  v18 = 12LL;
LABEL_25:
