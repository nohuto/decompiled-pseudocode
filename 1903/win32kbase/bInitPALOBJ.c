/*
 * XREFs of bInitPALOBJ @ 0x1C0268990
 * Callers:
...
__int64 bInitPALOBJ()
{
  ...
  v0 = 0;
  v1 = (int *)&unk_1C0217D7C;
  *(_QWORD *)&pArrayOfSquares.peRed = &unk_1C0217D7C;
  v2 = 0;
  v3 = (int *)&unk_1C0217D7C;
  LODWORD(v4) = 256;
  do
  {
    v5 = v2 * v2;
  ...
  if ( !ghsemPalette )
    return 0LL;
  if ( logDefaultPal != 768 || !word_1C02104C2 )
    goto LABEL_8;
  v17 = 0;
  v16 = 0LL;
  if ( !(unsigned int)PALMEMOBJ::bCreatePalette(
                        (PALMEMOBJ *)&v16,
                        1,
                        (unsigned __int16)word_1C02104C2,
                        dword_1C02104C4,
                        0,
                        0,
                        0,
