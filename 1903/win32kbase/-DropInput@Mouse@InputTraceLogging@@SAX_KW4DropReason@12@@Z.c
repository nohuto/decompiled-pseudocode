/*
 * XREFs of ?DropInput@Mouse@InputTraceLogging@@SAX_KW4DropReason@12@@Z @ 0x1C01908E0
 * Callers:
...
void InputTraceLogging::Mouse::DropInput()
{
  ...
  if ( dword_1C020FB50 > 4u )
  {
    if ( TlgKeywordOn((TraceLoggingHProvider)&dword_1C020FB50, 0x40uLL) )
    {
      ...
      TlgWrite((TraceLoggingHProvider)&dword_1C020FB50, &unk_1C01E865F, 0LL, 0LL, 4u, &pData);
    }
  }
}
