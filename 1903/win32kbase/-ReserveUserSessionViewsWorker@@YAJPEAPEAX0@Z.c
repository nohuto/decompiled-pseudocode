/*
 * XREFs of ?ReserveUserSessionViewsWorker@@YAJPEAPEAX0@Z @ 0x1C0112A5C
 * Callers:
 *     ?ReserveUserSessionViews@@YAJPEAPEAX0@Z @ 0x1C0112A00 (-ReserveUserSessionViews@@YAJPEAPEAX0@Z.c)
 * Callees:
