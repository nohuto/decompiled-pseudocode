/*
 * XREFs of xxxEnumDisplayMonitors @ 0x1C003E730
 * Callers:
...
__int64 __fastcall xxxEnumDisplayMonitors(HDC a1, int *a2, __int64 a3, __int64 a4, int a5)
{
  ...
  __int128 v36; // [rsp+90h] [rbp-41h] BYREF
  ...
  *(_QWORD *)&v40.right = 0LL;
  ...
  if ( !a1 )
  {
    ...
    if ( a2 && !(unsigned int)IntersectRect(&v39, (int *)&v39, a2) )
      return 1LL;
    goto LABEL_3;
  }
  GreLockVisRgn(*(_QWORD *)(gpDispInfo + 40), (int)a2, a3);
...
LABEL_43:
  ...
  if ( (unsigned int)GreGetClipBox(a1, &v39, 0) == 1 )
    goto LABEL_42;
  if ( StyleWindow
    && (*(_WORD *)(*(_QWORD *)(StyleWindow + 40) + 42LL) & 0x3FFF) == 0x29D
    && (W32GetCurrentThreadDpiAwarenessContext() & 0xF) != 2 )
  {
    TransformRectBetweenCoordinateSpaces(&v39, &v39, 0LL, StyleWindow);
  }
  if ( a2 && !(unsigned int)IntersectRect(&v39, (int *)&v39, a2) )
  {
LABEL_42:
...
LABEL_3:
  ...
  for ( i = *(struct tagMONITOR **)(gpDispInfo + 104); i; i = (struct tagMONITOR *)*((_QWORD *)i + 7) )
  {
    if ( (*(_DWORD *)(*((_QWORD *)i + 5) + 24LL) & 1) == 0 )
      continue;
    v34 = *GetMonitorRect(&v36, (__int64)i);
    if ( !(unsigned int)IntersectRect(&v40, (int *)&v39, (int *)&v34) )
      continue;
    if ( a1 )
    {
...
LABEL_15:
    if ( !ThreadUnlock1()
      || (CLockDomainSharedAllowAllRecursion<DLT_HANDLEMANAGER>::CLockDomainSharedAllowAllRecursion<DLT_HANDLEMANAGER>(
            ...
            v11,
            v12),
          (*((_BYTE *)qword_1C0213758 + dword_1C0213760 * (unsigned int)(unsigned __int16)*(_DWORD *)i + 25) & 1) != 0) )
    {
      v13 = 0;
    }
    if ( MonitorDC )
