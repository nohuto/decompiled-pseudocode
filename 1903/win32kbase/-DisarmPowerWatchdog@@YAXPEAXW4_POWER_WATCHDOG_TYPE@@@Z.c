/*
 * XREFs of ?DisarmPowerWatchdog@@YAXPEAXW4_POWER_WATCHDOG_TYPE@@@Z @ 0x1C005B124
 * Callers:
...
void __fastcall DisarmPowerWatchdog(__int64 a1, int a2)
{
  ...
  if ( a1 )
  {
    ...
    {
      if ( TlgKeywordOn((TraceLoggingHProvider)&dword_1C020F458, 0x400000000000uLL) )
      {
        v13 = 0;
        v16 = 0;
        v19 = 0;
        ...
        v7 = a2;
        v18 = 4;
        TlgWrite((TraceLoggingHProvider)&dword_1C020F458, &unk_1C01E3659, 0LL, 0LL, 5u, &pData);
      }
    }
  }
}
