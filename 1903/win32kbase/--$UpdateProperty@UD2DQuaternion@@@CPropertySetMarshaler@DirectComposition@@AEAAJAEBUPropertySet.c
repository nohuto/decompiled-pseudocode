/*
 * XREFs of ??$UpdateProperty@UD2DQuaternion@@@CPropertySetMarshaler@DirectComposition@@AEAAJAEBUPropertySetValue@@PEBUD2DQuaternion@@@Z @ 0x1C00BFE6C
 * Callers:
        ...
        _OWORD *a3)
{
  ...
  {
    *(_OWORD *)((*(_DWORD *)(v5 + 8 * v3 + 4) & 0x1FFFFFFF) + *(_QWORD *)(a1 + 72)) = *a3;
    v6 = *(_QWORD *)(a1 + 56);
