/*
 * XREFs of ?SetReferenceArrayProperty@CClipGroupMarshaler@DirectComposition@@UEAAJPEAVCApplicationChannel@2@IPEAPEAVCResourceMarshaler@2@_KPEA_N@Z @ 0x1C01B1170
 * Callers:
 *     <none>
 * Callees:
        ...
        bool *a6)
{
  ...
  *a6 = 0;
  ...
  if ( v6 >= 0 )
  {
    ...
    {
      if ( *((_QWORD *)this + 10) )
        (*(void (__fastcall **)(DirectComposition::CClipGroupMarshaler *, struct DirectComposition::CApplicationChannel *))(*(_QWORD *)this + 112LL))(
          this,
          a2);
      *((_QWORD *)this + 10) = a4;
      v11 = 0LL;
      ...
      *a6 = 1;
      if ( *((_DWORD *)this + 22) )
      {
        ...
        while ( (unsigned int)v11 < *((_DWORD *)this + 22) );
      }
      *((_DWORD *)this + 23) = 0;
    }
  }
