/*
 * XREFs of ?Remove@BufferCache@CoreMessagingK@@CAXPEAUBufferHeader@12@0@Z @ 0x1C0040F3C
 * Callers:
 *     ?Free@BufferCache@CoreMessagingK@@SAXPEAX@Z @ 0x1C0040DD4 (-Free@BufferCache@CoreMessagingK@@SAXPEAX@Z.c)
