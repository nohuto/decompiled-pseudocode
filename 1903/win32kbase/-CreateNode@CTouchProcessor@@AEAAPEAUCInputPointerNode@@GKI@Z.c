/*
 * XREFs of ?CreateNode@CTouchProcessor@@AEAAPEAUCInputPointerNode@@GKI@Z @ 0x1C0164BE8
 * Callers:
        ...
        unsigned int a4)
{
  ...
  if ( v5 < 2 || v5 > 3 && v5 != 5 )
  {
    if ( WPP_RECORDER_INITIALIZED == (_UNKNOWN *)&WPP_RECORDER_INITIALIZED )
      return 0LL;
    LOBYTE(a2) = 2;
    WPP_RECORDER_SF_D((_DWORD)gBaseLog, a2, 7, 242, (__int64)&WPP_06d7dff703a03015e007562f188a8383_Traceguids, v5);
    if ( WPP_RECORDER_INITIALIZED == (_UNKNOWN *)&WPP_RECORDER_INITIALIZED )
      return 0LL;
  ...
  if ( !v9 )
  {
    if ( WPP_RECORDER_INITIALIZED == (_UNKNOWN *)&WPP_RECORDER_INITIALIZED )
      return 0LL;
    LOBYTE(v8) = 2;
    WPP_RECORDER_SF_((_DWORD)gBaseLog, v8, 7, 244, (__int64)&WPP_06d7dff703a03015e007562f188a8383_Traceguids);
    if ( WPP_RECORDER_INITIALIZED == (_UNKNOWN *)&WPP_RECORDER_INITIALIZED )
      return 0LL;
    v11 = WPP_GLOBAL_Control;
    if ( !LOWORD(WPP_GLOBAL_Control->DeviceType) )
...
LABEL_33:
    LOBYTE(v10) = 5;
    WPP_RECORDER_SF_(v11->DeviceExtension, v10, 7, v12, (__int64)&WPP_06d7dff703a03015e007562f188a8383_Traceguids);
    return 0LL;
  }
  ...
  *((_DWORD *)v9 + 72) = v14 | 0x480;
  if ( !(unsigned int)CTouchProcessor::SetNewValidState(v7, a4, (struct CInputPointerNode *)v9) )
  {
    ...
    {
      LOBYTE(v15) = 2;
      WPP_RECORDER_SF_((_DWORD)gBaseLog, v15, 7, 246, (__int64)&WPP_06d7dff703a03015e007562f188a8383_Traceguids);
    }
