/*
 * XREFs of ?Create@CSharedVisualReferenceControllerMarshaler@DirectComposition@@SAJPEBVCSharedSystemResource@2@PEAPEAV12@@Z @ 0x1C01C5718
 * Callers:
 *     CreateSharedVisualReferenceControllerMarshaler @ 0x1C01C58C0 (CreateSharedVisualReferenceControllerMarshaler.c)
 * Callees:
