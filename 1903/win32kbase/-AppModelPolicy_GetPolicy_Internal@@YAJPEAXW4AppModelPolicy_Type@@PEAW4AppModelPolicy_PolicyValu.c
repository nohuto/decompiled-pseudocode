/*
 * XREFs of ?AppModelPolicy_GetPolicy_Internal@@YAJPEAXW4AppModelPolicy_Type@@PEAW4AppModelPolicy_PolicyValue@@PEAU_PS_PKG_CLAIM@@PEA_K@Z @ 0x1C00844C4
 * Callers:
      ...
      if ( (*(_QWORD *)a4 & 0x400LL) == 0 )
      {
        ...
        if ( (v11 & 4) == 0 )
        {
          ...
          else
          {
            v9 = 196608;
            if ( (v11 & 0x40) == 0 )
              v9 = ((*(_QWORD *)a4 & 0x1000LL) == 0) | 0x30000;
          }
          goto LABEL_6;
        }
      }
