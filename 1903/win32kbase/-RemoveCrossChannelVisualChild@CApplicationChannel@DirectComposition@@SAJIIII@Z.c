/*
 * XREFs of ?RemoveCrossChannelVisualChild@CApplicationChannel@DirectComposition@@SAJIIII@Z @ 0x1C0001AA4
 * Callers:
 *     NtDCompositionRemoveCrossDeviceVisualChild @ 0x1C0001A90 (NtDCompositionRemoveCrossDeviceVisualChild.c)
 * Callees:
