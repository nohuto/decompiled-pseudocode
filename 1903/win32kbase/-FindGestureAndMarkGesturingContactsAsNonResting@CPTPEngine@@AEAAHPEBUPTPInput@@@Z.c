/*
 * XREFs of ?FindGestureAndMarkGesturingContactsAsNonResting@CPTPEngine@@AEAAHPEBUPTPInput@@@Z @ 0x1C0196774
 * Callers:
 *     ?RunStateMachine@CPTPEngine@@AEAAXPEAUPTPInput@@@Z @ 0x1C0197AA8 (-RunStateMachine@CPTPEngine@@AEAAXPEAUPTPInput@@@Z.c)
 * Callees:
 *     ?AreTheseTwoContactsAPan@CPTPEngine@@AEAAHPEBUPTPInput@@PEBUCContactState@@1@Z @ 0x1C019417C (-AreTheseTwoContactsAPan@CPTPEngine@@AEAAHPEBUPTPInput@@PEBUCContactState@@1@Z.c)
 *     ?AreTheseTwoContactsAZoom@CPTPEngine@@AEAAHPEBUPTPInput@@PEBUCContactState@@1@Z @ 0x1C019424C (-AreTheseTwoContactsAZoom@CPTPEngine@@AEAAHPEBUPTPInput@@PEBUCContactState@@1@Z.c)
      ...
      if ( v7 && (v7 & 0x40000) == 0 )
      {
        for ( j = (unsigned int)(i + 1); (unsigned int)j < v4; j = (unsigned int)(j + 1) )
        {
          ...
          if ( v10 )
          {
            ...
            {
              v11 = *((_DWORD *)this + 4);
              v12 = (CPTPEngine *)((char *)this + 296 * (*(_DWORD *)((char *)a2 + v6 + 60) % v11) + 1160);
              v13 = (CPTPEngine *)((char *)this + 296 * (*(_DWORD *)((char *)a2 + v9 + 60) % v11) + 1160);
              if ( (*(_DWORD *)v12 & 0x20000) != 0
                && (*(_DWORD *)v13 & 0x20000) != 0
                && (*(_DWORD *)v12 & 0x40000000) != 0
                && (*(_DWORD *)v13 & 0x40000000) != 0 )
              {
                if ( *((_DWORD *)this + 743) != 2
                  || (v14 = (CPTPEngine *)((char *)this + 296 * *((unsigned int *)this + 734) + 1160), v12 == v14)
                  || v13 == v14 )
                {
