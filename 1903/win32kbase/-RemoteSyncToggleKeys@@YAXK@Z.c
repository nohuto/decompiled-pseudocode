/*
 * XREFs of ?RemoteSyncToggleKeys@@YAXK@Z @ 0x1C0185430
 * Callers:
...
void __fastcall RemoteSyncToggleKeys(int a1)
{
  ...
  if ( gpqForeground )
  {
    ...
    if ( ((gSetLedReceived & 2) == 0) != ((~byte_1C02142E4 & 2) != 0) )
    {
      WORD1(v3[0]) = 144;
      LOBYTE(v3[0]) = 69;
      xxxProcessKeyEvent((unsigned int)v3, 0, v2, 0, 0LL, 0LL);
    ...
    if ( ((gSetLedReceived & 1) == 0) != ((~byte_1C02142E4 & 8) != 0) )
    {
      WORD1(v3[0]) = 145;
      LOBYTE(v3[0]) = 70;
      xxxProcessKeyEvent((unsigned int)v3, 0, v2, 0, 0LL, 0LL);
    ...
    if ( (ApiSetEditionGetActiveHKL() & 0x3FF) == 0x11 && ((gSetLedReceived & 8) == 0) != ((~byte_1C02142C5 & 8) != 0) )
    {
      WORD1(v3[0]) = 21;
      LOBYTE(v3[0]) = 112;
      xxxProcessKeyEvent((unsigned int)v3, 0, v2, 0, 0LL, 0LL);
