/*
 * XREFs of ?OnDelete@ConnectionTargetInfo@CoreMessagingK@@SAXPEAUObjectImpl@2@@Z @ 0x1C00AB050
 * Callers:
 *     <none>
 * Callees:
...
void __fastcall CoreMessagingK::ConnectionTargetInfo::OnDelete(struct CoreMessagingK::ObjectImpl *a1)
{
  ...
  if ( dword_1C020F5E0 > 5u )
  {
    ...
    v11 = 4;
    v14 = 4;
    TlgWrite((TraceLoggingHProvider)&dword_1C020F5E0, &unk_1C01EA472, 0LL, 0LL, 6u, &pData);
    v2 = (CoreMessagingK::ClientPortInfo *)*((_QWORD *)a1 + 2);
  }
