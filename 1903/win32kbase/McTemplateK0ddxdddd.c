/*
 * XREFs of McTemplateK0ddxdddd @ 0x1C010FD98
 * Callers:
 *     EtwTraceTouchHWTimeStamp @ 0x1C010E630 (EtwTraceTouchHWTimeStamp.c)
 * Callees:
 *     McGenEventWrite @ 0x1C006C7F8 (McGenEventWrite.c)
 *     __security_check_cookie @ 0x1C00BAF90 (__security_check_cookie.c)
 */

ULONG __fastcall McTemplateK0ddxdddd(
        ...
        char a10)
{
  ...
  v23 = 4LL;
  v25 = 4LL;
  return McGenEventWrite(a1, &TouchHWTimeStamp, (LPCGUID)&Context.Flags, 8u, &EventData);
}
