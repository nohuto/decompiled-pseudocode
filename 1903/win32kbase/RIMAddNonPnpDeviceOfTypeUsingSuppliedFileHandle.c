/*
 * XREFs of RIMAddNonPnpDeviceOfTypeUsingSuppliedFileHandle @ 0x1C0137C70
 * Callers:
...
LABEL_28:
          if ( v11 >= 0 )
          {
            v11 = RIMCreateDev(v12, a3, (__int64)p_DestinationString, 1, 0, 0LL, (struct _UNICODE_STRING **)&v24);
            if ( v11 >= 0 )
            {
              v18 = v24;
              *(_DWORD *)(v24 + 184) |= 1u;
