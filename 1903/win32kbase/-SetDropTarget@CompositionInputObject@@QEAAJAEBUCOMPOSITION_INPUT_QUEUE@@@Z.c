/*
 * XREFs of ?SetDropTarget@CompositionInputObject@@QEAAJAEBUCOMPOSITION_INPUT_QUEUE@@@Z @ 0x1C007CE3C
 * Callers:
  ...
  if ( InputTraceLogging::Perf::s_userCritLoggingEnabled && v42 && (*(_DWORD *)(v42 + 48) || *(int *)(v42 + 24) > 0) )
  {
    ...
    *(GUID *)(v42 + 28) = ActivityId;
    if ( dword_1C020FB50 > 6u )
    {
      ...
      if ( v31 > 6 && TlgKeywordOn((TraceLoggingHProvider)&dword_1C020FB50, 0x2000uLL) )
      {
        v56 = 0;
        v39 = v43;
        v54 = &v39;
