/*
 * XREFs of ?CitpProcessForegroundChange@@YAHPEAUtagPROCESSINFO@@PEAUtagWND@@0PEAUtagMONITOR@@PEAUtagSHELL_INPUT_USAGE_DATA_INFO@@@Z @ 0x1C0087400
 * Callers:
 *     CitProcessForegroundChange @ 0x1C00873B0 (CitProcessForegroundChange.c)
 *     CitModerncoreProcessForegroundChange @ 0x1C01CA020 (CitModerncoreProcessForegroundChange.c)
 * Callees:
        ...
        struct tagSHELL_INPUT_USAGE_DATA_INFO *a5)
{
  ...
  if ( (unsigned int)IsRemoteConnection(0xFFFFF78000000004uLL, a2, a3) )
  {
    ...
    if ( !v11 )
    {
      if ( (unsigned int)dword_1C020F0F4 < MEMORY[0xFFFFF7800000037C] )
      {
        EtwTelemetryCoverageReport(&off_1C020F0E8);
        v11 = *((_WORD *)v8 + 57);
      }
      *((_BYTE *)v8 + 112) |= 4u;
      *((_WORD *)v8 + 57) = v11 + 1;
