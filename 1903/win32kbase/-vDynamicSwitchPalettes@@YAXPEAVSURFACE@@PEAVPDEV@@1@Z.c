/*
 * XREFs of ?vDynamicSwitchPalettes@@YAXPEAVSURFACE@@PEAVPDEV@@1@Z @ 0x1C0128C5C
 * Callers:
 ...
 *     vMatchAPal @ 0x1C01250B0 (vMatchAPal.c)
 */
...
LABEL_12:
  ...
  if ( (*((_DWORD *)a3 + 543) & 0x100) != 0 && (*((_DWORD *)a1 + 28) & 0x20000000) != 0 )
  {
    ...
    XEPALOBJ::vUnrefPalette((struct _SLIST_ENTRY **)&v17);
    *((_DWORD *)a1 + 28) &= ~0x20000000u;
    *((_QWORD *)a1 + 16) = 0LL;
  }
}
