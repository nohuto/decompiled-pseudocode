/*
 * XREFs of ?CitpLogoff@@YAXPEAU_CIT_IMPACT_CONTEXT@@@Z @ 0x1C0084710
 * Callers:
 *     CitUserChange @ 0x1C0084600 (CitUserChange.c)
 *     CitModerncoreShutdown @ 0x1C01CA130 (CitModerncoreShutdown.c)
 * Callees:
