/*
 * XREFs of ?CitpInteractionSummariesFlush@@YAXPEAU_CIT_IMPACT_CONTEXT@@_N@Z @ 0x1C0086CB8
 * Callers:
...
void __fastcall CitpInteractionSummariesFlush(struct _CIT_IMPACT_CONTEXT *a1, char a2)
{
  ...
  v4 = (struct _CIT_INTERACTION_SUMMARY **)((char *)a1 + 808);
  ...
  while ( 1 )
  {
    ...
    ++v7;
    if ( !a2 && (*((_BYTE *)v8 + 107) || *((_BYTE *)v8 + 115)) )
    {
      v10 = v13;
