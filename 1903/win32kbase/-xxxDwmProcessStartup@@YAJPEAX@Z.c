/*
 * XREFs of ?xxxDwmProcessStartup@@YAJPEAX@Z @ 0x1C00ABABC
 * Callers:
...
__int64 __fastcall xxxDwmProcessStartup(HANDLE Handle)
{
  ...
  char v18; // [rsp+D0h] [rbp+18h] BYREF
  ...
  {
    LeaveEnterCrit::LeaveEnterCrit((LeaveEnterCrit *)&v18, v6);
  ...
  GreUnlockDwmState();
  if ( v5 < 0 || (v5 = ((__int64 (*)(void))qword_1C02151E0)(), v5 < 0) )
  {
LABEL_25:
    GreLockDwmState();
    if ( g_pepDwm == v4 )
    ...
    if ( !g_pepDwm && v2 )
    {
      LeaveEnterCrit::LeaveEnterCrit((LeaveEnterCrit *)&v19, v15);
      UserEnableConsoleMode(1LL);
      LeaveEnterCrit::~LeaveEnterCrit(v16);
    }
  }
  else
  {
