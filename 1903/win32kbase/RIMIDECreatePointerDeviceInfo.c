/*
 * XREFs of RIMIDECreatePointerDeviceInfo @ 0x1C0148F58
 * Callers:
...
LABEL_9:
  ...
  *((_QWORD *)v15 + 94) = 500 * gliQpcFreq.QuadPart / 1000;
  if ( v12 )
  {
    ...
    if ( v13 )
      RIMGetDeviceLocationInfo(v13, (_DWORD *)(a2 + 2088));
  }
  v28 = v46;
...
LABEL_61:
  ...
  {
    *(_DWORD *)(a2 + 1320) = 1;
    RIMReadDigitizerToMonitorMappings((const UNICODE_STRING *)(v12 + 88), a2 + 1320);
    goto LABEL_61;
  }
LABEL_62:
  if ( (*((_DWORD *)v15 + 78) & 0x2000) == 0
    ...
    || *((_DWORD *)v15 + 38) - *((_DWORD *)v15 + 36) <= 1 )
  {
    if ( *(_DWORD *)(a2 + 1320) )
    {
      v36 = HMValidateSharedHandleNoRip(*(_QWORD *)(a2 + 1328), v24, v22);
