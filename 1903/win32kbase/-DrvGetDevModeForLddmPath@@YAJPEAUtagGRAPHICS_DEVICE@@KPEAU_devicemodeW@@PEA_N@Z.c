/*
 * XREFs of ?DrvGetDevModeForLddmPath@@YAJPEAUtagGRAPHICS_DEVICE@@KPEAU_devicemodeW@@PEA_N@Z @ 0x1C009EBD8
 * Callers:
 *     DrvEnumDisplaySettings @ 0x1C003A320 (DrvEnumDisplaySettings.c)
 * Callees:
 *     ?DrvGetDisplayDriverDpiSetting@@YAXPEAU_devicemodeW@@@Z @ 0x1C004AA10 (-DrvGetDisplayDriverDpiSetting@@YAXPEAU_devicemodeW@@@Z.c)
...
__int64 __fastcall DrvGetDevModeForLddmPath(struct tagGRAPHICS_DEVICE *a1, int a2, struct _devicemodeW *a3, bool *a4)
{
  ...
  if ( v9 >= 0 )
  {
    ...
    if ( v16 )
    {
      ...
      v9 = 0;
      if ( !a3
        || (v9 = ((__int64 (__fastcall *)(__int64, struct _devicemodeW *))qword_1C02152D8)(v17 + 200LL * v10, a3),
            v9 >= 0) )
      {
        if ( a4 )
        {
