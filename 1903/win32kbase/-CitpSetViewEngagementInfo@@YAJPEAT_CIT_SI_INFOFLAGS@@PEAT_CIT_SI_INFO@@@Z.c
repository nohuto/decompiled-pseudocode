/*
 * XREFs of ?CitpSetViewEngagementInfo@@YAJPEAT_CIT_SI_INFOFLAGS@@PEAT_CIT_SI_INFO@@@Z @ 0x1C0098450
 * Callers:
  ...
  if ( PsLookupProcessByProcessId((HANDLE)SDWORD2(v7), &Process) >= 0 )
  {
    if ( (unsigned int)PsGetProcessSessionId(Process) == gSessionId )
    {
      ...
      if ( ProcessWin32Process )
      {
        ...
        {
          v5 = CitpInteractionSummaryEnsure(v2, (struct tagPROCESSINFO **)v4[115], 1);
          if ( v5 )
            *((_QWORD *)v5 + 2) |= v7;
          *(_QWORD *)v4[115] = v7;
        }
