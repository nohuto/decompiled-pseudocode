/*
 * XREFs of HMCreateHandleForObject @ 0x1C006F600
 * Callers:
...
LABEL_5:
    ...
    *v6 = *((_QWORD *)gpKernelHandleTable + 3 * *v6);
    ...
    v9[24] = v4;
    v8[v11] = a1;
    *(_QWORD *)a1 = (int)v7 | (unsigned __int64)(*(unsigned __int16 *)((char *)qword_1C0213758
                                                                     + v7 * (unsigned int)dword_1C0213760
                                                                     + 26) << 16);
