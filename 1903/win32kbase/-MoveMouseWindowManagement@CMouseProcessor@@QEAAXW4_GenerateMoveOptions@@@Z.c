/*
 * XREFs of ?MoveMouseWindowManagement@CMouseProcessor@@QEAAXW4_GenerateMoveOptions@@@Z @ 0x1C0030FB4
 * Callers:
...
void __fastcall CMouseProcessor::MoveMouseWindowManagement(_DWORD *a1, __int64 a2, __int64 a3)
{
  ...
  if ( (v3 & 1) != 0 )
  {
    ...
    *((_QWORD *)gpsi + 619) = 0LL;
    v8 = gptCursorAsync;
    *((_QWORD *)v4 + 398) = 0LL;
    *((struct tagPOINT *)v4 + 397) = v8;
  }
  if ( (v3 & 2) != 0 )
  {
    if ( gpqCursor )
      MicrosoftTelemetryAssertTriggeredNoArgsKM(a1, a2, a3);
    RIMLockExclusive(v4 + 892);
    *((_BYTE *)v4 + 3584) = 1;
    *((_QWORD *)v4 + 447) = 0LL;
    ExReleasePushLockExclusiveEx(v4 + 892, 0LL);
    KeLeaveCriticalRegion();
  }
  if ( dword_1C020FB50 > 4u && TlgKeywordOn((TraceLoggingHProvider)&dword_1C020FB50, 0x40uLL) )
  {
    ...
    v13 = 4;
    v16 = 4;
    TlgWrite((TraceLoggingHProvider)&dword_1C020FB50, &unk_1C01E851F, 0LL, 0LL, 4u, &pData);
  }
  if ( v7 )
  {
