/*
 * XREFs of ?UninitializeThreadInfoIocp@@YAXPEAUtagTHREADINFO@@@Z @ 0x1C00353DC
 * Callers:
...
void __fastcall UninitializeThreadInfoIocp(struct tagTHREADINFO *a1, int a2)
{
  ...
  v3 = (void *)*((_QWORD *)a1 + 182);
  if ( v3 )
  {
    ObCloseHandle(v3, 0);
    *((_QWORD *)a1 + 182) = 0LL;
  }
  v4 = (void *)*((_QWORD *)a1 + 181);
  if ( v4 )
  {
    ObCloseHandle(v4, 0);
    *((_QWORD *)a1 + 181) = 0LL;
  ...
  v6 = (void *)*((_QWORD *)a1 + 178);
  if ( v6 )
  {
    ObCloseHandle(v6, 0);
    *((_QWORD *)a1 + 178) = 0LL;
  }
  v7 = (void *)*((_QWORD *)a1 + 177);
  if ( v7 )
  {
