/*
 * XREFs of ?RemoveInertiaInfo@Win32k@InputTraceLogging@@SAXAEBUINERTIA_INFO_INTERNAL@@@Z @ 0x1C017E1FC
 * Callers:
 ...
 *     ?InertiaSourceToString@InputTraceLogging@@CAPEBDW4INERTIA_SOURCE@@@Z @ 0x1C017DE08 (-InertiaSourceToString@InputTraceLogging@@CAPEBDW4INERTIA_SOURCE@@@Z.c)
 */
...
void __fastcall InputTraceLogging::Win32k::RemoveInertiaInfo(const struct INERTIA_INFO_INTERNAL *a1)
{
  ...
  {
    if ( TlgKeywordOn((TraceLoggingHProvider)&dword_1C020FB50, 2uLL) )
    {
      v2 = InputTraceLogging::InertiaSourceToString(*(_DWORD *)(v1 + 24));
      ...
      v22 = &v10;
      v10 = -__CFSHR__(v4, 4);
      TlgWrite((TraceLoggingHProvider)&dword_1C020FB50, &unk_1C01E7424, 0LL, 0LL, v6 + 4, &pData);
    }
  }
}
