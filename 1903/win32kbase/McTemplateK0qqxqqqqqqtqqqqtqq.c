/*
 * XREFs of McTemplateK0qqxqqqqqqtqqqqtqq @ 0x1C01117E8
 * Callers:
 *     EtwTraceTouchPadHWTimeStamp @ 0x1C010E890 (EtwTraceTouchPadHWTimeStamp.c)
 * Callees:
 *     McGenEventWrite @ 0x1C006C7F8 (McGenEventWrite.c)
 *     __security_check_cookie @ 0x1C00BAF90 (__security_check_cookie.c)
 */

ULONG __fastcall McTemplateK0qqxqqqqqqtqqqqtqq(
        ...
        char a20)
{
  ...
  v53 = 4LL;
  v55 = 4LL;
  return McGenEventWrite(a1, &TouchPadHWTimeStamp, (LPCGUID)&Context.Flags, 0x12u, &EventData);
}
