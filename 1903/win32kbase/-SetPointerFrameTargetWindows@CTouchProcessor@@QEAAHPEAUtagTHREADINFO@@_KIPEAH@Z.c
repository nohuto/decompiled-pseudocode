/*
 * XREFs of ?SetPointerFrameTargetWindows@CTouchProcessor@@QEAAHPEAUtagTHREADINFO@@_KIPEAH@Z @ 0x1C0172D00
 * Callers:
 *     <none>
 * Callees:
 ...
 *     ?UsesQueue@CInputDest@@QEBA_NPEBUtagQ@@@Z @ 0x1C015DDB0 (-UsesQueue@CInputDest@@QEBA_NPEBUtagQ@@@Z.c)
...
LABEL_20:
    LOBYTE(v9) = 5;
    WPP_RECORDER_SF_(v11->DeviceExtension, v9, 7, v12, (__int64)&WPP_06d7dff703a03015e007562f188a8383_Traceguids);
LABEL_21:
    v17 = 1;
    goto LABEL_141;
  }
...
LABEL_26:
    LOBYTE(v9) = 5;
    WPP_RECORDER_SF_(v13->DeviceExtension, v9, 7, v14, (__int64)&WPP_06d7dff703a03015e007562f188a8383_Traceguids);
LABEL_27:
    v17 = 0;
    goto LABEL_141;
  }
