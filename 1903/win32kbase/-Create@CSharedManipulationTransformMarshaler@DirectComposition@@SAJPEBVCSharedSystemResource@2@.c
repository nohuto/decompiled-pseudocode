/*
 * XREFs of ?Create@CSharedManipulationTransformMarshaler@DirectComposition@@SAJPEBVCSharedSystemResource@2@PEAPEAV12@@Z @ 0x1C008D9D8
 * Callers:
 *     CreateSharedManipulationTransformMarshaler @ 0x1C008D9A0 (CreateSharedManipulationTransformMarshaler.c)
 * Callees:
