/*
 * XREFs of ?BuildMainItem@@YAHPEAEKPEAKUtagUSAGE_PROPERTIES@@PEAU1@W4_HIDP_REPORT_TYPE@@PEAH1@Z @ 0x1C014BD98
 * Callers:
 ...
 *     ?OpenCollection@@YAHPEAEKW4tagHID_IDE_COL_TYPE@@PEAK@Z @ 0x1C014C5FC (-OpenCollection@@YAHPEAEKW4tagHID_IDE_COL_TYPE@@PEAK@Z.c)
 *     ?SetCollectionLabel@@YAHPEAEKPEAK@Z @ 0x1C014C668 (-SetCollectionLabel@@YAHPEAEKPEAK@Z.c)
 *     ?SetMultiByteValue@@YAHPEAEKPEAKPEAHK1@Z @ 0x1C014C6D4 (-SetMultiByteValue@@YAHPEAEKPEAKPEAHK1@Z.c)
 */
