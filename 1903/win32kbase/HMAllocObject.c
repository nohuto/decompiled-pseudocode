/*
 * XREFs of HMAllocObject @ 0x1C0027A70
 * Callers:
...
LABEL_6:
  ...
  else
  {
    ...
    if ( (v9 & 0x200) != 0 )
    {
      v14 = (const void **)HMAllocateIsolatedType(v7);
    }
    else
    {
...
LABEL_67:
  ...
  v15 = *v10;
  v16 = (char *)qword_1C0213758 + 32 * *v10;
  ...
  *v18 = (__int64)v14;
  ...
  v21 = (int)v15 | (unsigned __int64)(*(unsigned __int16 *)((char *)qword_1C0213758
                                                          + v15 * (unsigned int)dword_1C0213760
                                                          + 26) << 16);
  *v14 = (const void *)v21;
  if ( *(_DWORD *)((char *)&gahti + v38 + 16) )
  {
