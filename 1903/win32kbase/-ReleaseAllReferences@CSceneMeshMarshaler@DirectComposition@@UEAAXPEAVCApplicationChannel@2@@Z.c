/*
 * XREFs of ?ReleaseAllReferences@CSceneMeshMarshaler@DirectComposition@@UEAAXPEAVCApplicationChannel@2@@Z @ 0x1C01BBA20
 * Callers:
 *     <none>
 * Callees:
        ...
        struct DirectComposition::CApplicationChannel *a2)
{
  ...
  v6 = (struct DirectComposition::CResourceMarshaler *)*((_QWORD *)this + 8);
  if ( v6 )
  {
    DirectComposition::CApplicationChannel::ReleaseResource(a2, v6);
    *((_QWORD *)this + 8) = 0LL;
  }
  v7 = (struct DirectComposition::CResourceMarshaler *)*((_QWORD *)this + 9);
  if ( v7 )
  {
    DirectComposition::CApplicationChannel::ReleaseResource(a2, v7);
    *((_QWORD *)this + 9) = 0LL;
  }
  v8 = (struct DirectComposition::CResourceMarshaler *)*((_QWORD *)this + 10);
  if ( v8 )
  {
