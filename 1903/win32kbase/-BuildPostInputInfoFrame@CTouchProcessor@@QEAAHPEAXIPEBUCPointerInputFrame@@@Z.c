/*
 * XREFs of ?BuildPostInputInfoFrame@CTouchProcessor@@QEAAHPEAXIPEBUCPointerInputFrame@@@Z @ 0x1C01614C0
 * Callers:
 *     BuildPostInputInfoFrame @ 0x1C0176C40 (BuildPostInputInfoFrame.c)
 * Callees:
