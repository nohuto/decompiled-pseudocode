/*
 * XREFs of AllocQueue @ 0x1C002F500
 * Callers:
...
__int64 __fastcall AllocQueue(__int64 a1, __int64 a2)
{
  ...
  if ( a2 )
  {
    CLockExclusiveAllowRecursion<DLT_QUEUE>::CLockExclusiveAllowRecursion<DLT_QUEUE>(v13);
    v5 = *(_DWORD *)(v2 + 404);
  }
  else
  {
  ...
  *(_DWORD *)(v2 + 424) = (MEMORY[0xFFFFF78000000320] * (unsigned __int64)MEMORY[0xFFFFF78000000004]) >> 24;
  ...
  else
  {
    ...
    *(_OWORD *)(v2 + 252) = xmmword_1C0214330;
    *(_OWORD *)(v2 + 268) = xmmword_1C0214340;
    v11 = xmmword_1C0214350;
  }
  *(_OWORD *)(v2 + 284) = v11;
LABEL_9:
  if ( (gdwGTERMFlags & 1) == 0 )
    --*(_DWORD *)(v2 + 392);
  LockQCursor(v2, qword_1C0210A48);
  CLockExclusiveAllowRecursion<DLT_QUEUE>::CLockExclusiveAllowRecursion<DLT_QUEUE>(v14);
  return v2;
}
