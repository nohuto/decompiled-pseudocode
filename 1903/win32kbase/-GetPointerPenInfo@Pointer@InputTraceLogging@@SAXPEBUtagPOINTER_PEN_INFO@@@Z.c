/*
 * XREFs of ?GetPointerPenInfo@Pointer@InputTraceLogging@@SAXPEBUtagPOINTER_PEN_INFO@@@Z @ 0x1C016B9F4
 * Callers:
...
void __fastcall InputTraceLogging::Pointer::GetPointerPenInfo(const struct tagPOINTER_PEN_INFO *a1)
{
  ...
  if ( dword_1C020FB50 > 5u )
  {
    if ( TlgKeywordOn((TraceLoggingHProvider)&dword_1C020FB50, 0x20uLL) )
    {
      ...
      v56 = 4LL;
      v55 = v4 + 29;
      TlgWrite((TraceLoggingHProvider)&dword_1C020FB50, &unk_1C01E6042, 0LL, 0LL, 0x16u, &pData);
    }
  }
}
