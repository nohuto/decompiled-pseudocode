/*
 * XREFs of ?DrvEnableDisplay@@YAHPEAUHDEV__@@@Z @ 0x1C00B9F2C
 * Callers:
...
__int64 __fastcall DrvEnableDisplay(HSEMAPHORE *a1, __int64 a2, __int64 a3)
{
  ...
  *(_QWORD *)(v5 + 24) = a1;
  ...
  EtwTraceGreLockReleaseSemaphore((__int64)L"po.hsemDevLock()", (__int64)a1[6], v6);
  ...
  EtwTraceGreLockReleaseSemaphore((__int64)L"ghsemHT", (__int64)ghsemHT, v7);
  if ( ghsemHT )
  {
    ExReleaseResourceAndLeaveCriticalRegion((PERESOURCE)ghsemHT);
    PsLeavePriorityRegion(v11);
  }
  EtwTraceGreLockReleaseSemaphore((__int64)L"ghsemSprite", (__int64)ghsemSprite, v10);
  if ( ghsemSprite )
  {
    ExReleaseResourceAndLeaveCriticalRegion(ghsemSprite);
    PsLeavePriorityRegion(v13);
  }
  EtwTraceGreLockReleaseSemaphore((__int64)L"po.hsemPointer()", (__int64)a1[8], v12);
