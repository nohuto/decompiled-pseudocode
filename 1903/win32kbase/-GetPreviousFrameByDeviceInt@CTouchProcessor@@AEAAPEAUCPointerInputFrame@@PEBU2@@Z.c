/*
 * XREFs of ?GetPreviousFrameByDeviceInt@CTouchProcessor@@AEAAPEAUCPointerInputFrame@@PEBU2@@Z @ 0x1C016CBB0
 * Callers:
        ...
        const struct CPointerInputFrame *a2)
{
  ...
  v8 = (CTouchProcessor *)((char *)this + 104);
  if ( v7 == (CTouchProcessor *)((char *)this + 104) )
    return 0LL;
  v9 = *((_QWORD *)a2 + 8);
  do
  {
