/*
 * XREFs of ?_UploadTelemetryData@DeadzonePalmTelemetry@@AEAAXH@Z @ 0x1C015C7C8
 * Callers:
    ...
    *((_DWORD *)this + 1) = v6;
    if ( v6 )
    {
      ...
      do
      {
        ...
        if ( v16 + 32 >= 0x800 )
        {
          if ( dword_1C020F4C8 > 5u && TlgKeywordOn((TraceLoggingHProvider)&dword_1C020F4C8, 0x400000000000uLL) )
          {
            TlgCreateSz(&pDesc, v2);
            TlgWrite((TraceLoggingHProvider)&dword_1C020F4C8, &unk_1C01E5D11, 0LL, 0LL, 3u, &pData);
          }
          v8 = 0LL;
          v16 = 0LL;
          v4 = 1;
      ...
      if ( v8 )
      {
        ...
        {
          TlgCreateSz(&v21, v2);
          TlgWrite((TraceLoggingHProvider)&dword_1C020F4C8, &unk_1C01E5D11, 0LL, 0LL, 3u, &v20);
        }
        v4 = 1;
      }
      if ( v4 )
