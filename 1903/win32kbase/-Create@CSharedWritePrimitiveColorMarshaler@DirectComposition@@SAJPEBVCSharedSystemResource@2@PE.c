/*
 * XREFs of ?Create@CSharedWritePrimitiveColorMarshaler@DirectComposition@@SAJPEBVCSharedSystemResource@2@PEAPEAV12@@Z @ 0x1C01C5DC8
 * Callers:
 *     CreateSharedWritePrimitiveColorMarshaler @ 0x1C01C5F70 (CreateSharedWritePrimitiveColorMarshaler.c)
 * Callees:
        ...
        struct DirectComposition::CSharedWritePrimitiveColorMarshaler **a2)
{
  ...
  if ( v5 )
  {
    ...
    if ( v6 < 0 )
    {
      (*(void (__fastcall **)(struct DirectComposition::CSharedWritePrimitiveColorMarshaler *, __int64))(*(_QWORD *)v5 + 104LL))(
        v5,
        1LL);
      v5 = 0LL;
    }
