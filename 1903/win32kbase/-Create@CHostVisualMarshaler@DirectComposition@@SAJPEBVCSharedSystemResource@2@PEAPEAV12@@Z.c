/*
 * XREFs of ?Create@CHostVisualMarshaler@DirectComposition@@SAJPEBVCSharedSystemResource@2@PEAPEAV12@@Z @ 0x1C00896FC
 * Callers:
 *     CreateHostVisualMarshaler @ 0x1C00896B0 (CreateHostVisualMarshaler.c)
 * Callees:
        ...
        struct DirectComposition::CHostVisualMarshaler **a2)
{
  ...
  v4 = Win32AllocPoolWithQuotaZInit(0x168uLL, 0x76684344u);
  v5 = (DirectComposition::CVisualMarshaler *)v4;
  if ( v4 )
  {
    memset(v4 + 2, 0, 0x160uLL);
