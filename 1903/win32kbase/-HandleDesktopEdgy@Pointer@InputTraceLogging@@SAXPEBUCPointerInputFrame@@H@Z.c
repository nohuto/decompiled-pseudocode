/*
 * XREFs of ?HandleDesktopEdgy@Pointer@InputTraceLogging@@SAXPEBUCPointerInputFrame@@H@Z @ 0x1C016D100
 * Callers:
...
void __fastcall InputTraceLogging::Pointer::HandleDesktopEdgy(const struct CPointerInputFrame *a1, int a2)
{
  ...
  if ( dword_1C020FB50 > 4u )
  {
    if ( TlgKeywordOn((TraceLoggingHProvider)&dword_1C020FB50, 0x20uLL) )
    {
      ...
      v12 = v3;
      v14 = v3;
      TlgWrite((TraceLoggingHProvider)&dword_1C020FB50, &unk_1C01E5F14, 0LL, 0LL, 6u, &pData);
    }
  }
}
