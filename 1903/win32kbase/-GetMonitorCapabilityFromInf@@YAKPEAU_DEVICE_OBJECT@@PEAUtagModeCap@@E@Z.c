/*
 * XREFs of ?GetMonitorCapabilityFromInf@@YAKPEAU_DEVICE_OBJECT@@PEAUtagModeCap@@E@Z @ 0x1C008A464
 * Callers:
 ...
 *     __report_rangecheckfailure @ 0x1C00BAFD0 (__report_rangecheckfailure.c)
