/*
 * XREFs of NtUserGetKeyboardLayout @ 0x1C002ED80
 * Callers:
 *     <none>
 * Callees:
      ...
      if ( v38 && (*(int *)(v38 + 24) > 0 || *(_DWORD *)(v49 + 48)) )
      {
        ...
        if ( dword_1C020FB50 > 6u )
        {
          if ( TlgKeywordOn((TraceLoggingHProvider)&dword_1C020FB50, 0x2000uLL) )
          {
            ...
            v59 = &v46;
            v60 = 4LL;
            TlgWrite((TraceLoggingHProvider)&dword_1C020FB50, &unk_1C01E34D7, &pActivityId_8, 0LL, 3u, &v58);
          }
        }
      }
    }
      ...
      *(GUID *)(v49 + 28) = pActivityId_8;
      if ( dword_1C020FB50 > 6u )
      {
        if ( TlgKeywordOn((TraceLoggingHProvider)&dword_1C020FB50, 0x2000uLL) )
        {
          ...
          v62 = &v47;
          v63 = 4LL;
          TlgWrite((TraceLoggingHProvider)&dword_1C020FB50, &unk_1C01E3480, &pActivityId_8, 0LL, 3u, &v61);
          v39 = dword_1C020FB50;
        }
        if ( v39 > 6 && TlgKeywordOn((TraceLoggingHProvider)&dword_1C020FB50, 0x2000uLL) )
        {
          ...
          v65 = &v48;
          v66 = 4LL;
          TlgWrite((TraceLoggingHProvider)&dword_1C020FB50, &unk_1C01E34AD, &pActivityId_8, 0LL, 3u, &v64);
        }
      }
    }
