/*
 * XREFs of ?RimDeviceMonitorMapping@RIM@InputTraceLogging@@SAXPEBURIMDEV@@@Z @ 0x1C0134CE4
 * Callers:
...
void __fastcall InputTraceLogging::RIM::RimDeviceMonitorMapping(const struct RIMDEV *a1)
{
  ...
  if ( dword_1C020FB50 > 4u && TlgKeywordOn((TraceLoggingHProvider)&dword_1C020FB50, 0x100uLL) )
  {
    ...
    TlgCreateWsz(&v22, (LPCWSTR)(v9 + 1340));
    TlgCreateWsz(&v23, (LPCWSTR)(v10 + 1596));
    v12 = v11[464];
    v24 = &v13;
    v14 = v11[463];
    v26 = &v14;
    ...
    v29 = 4LL;
    v31 = 4LL;
    TlgWrite((TraceLoggingHProvider)&dword_1C020FB50, &unk_1C01E45C8, 0LL, 0LL, 0xAu, &pData);
  }
}
