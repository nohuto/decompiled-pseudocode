/*
 * XREFs of DirectComposition::CResourceMarshaler::EmitUpdateCommand__lambda_875edf03129d072c2a57026e8b2c9420___lambda_4d09f61986b9554995b0a04d1855f62d___ @ 0x1C01B838C
 * Callers:
...
char __fastcall DirectComposition::CResourceMarshaler::EmitUpdateCommand__lambda_875edf03129d072c2a57026e8b2c9420___lambda_4d09f61986b9554995b0a04d1855f62d___(
        __int64 a1,
    ...
    *((_DWORD *)v13 + 4) = 4 * v12;
    ...
    if ( (_DWORD)v12 )
    {
      ...
      do
      {
        v16 = *a3;
        *a3 = v16 + 1;
        *v14++ = *(_DWORD *)(*(_QWORD *)(*(_QWORD *)(*(_QWORD *)v6 + 344LL) + 8 * v16) + 24LL);
        --v15;
      }
      while ( v15 );
    }
