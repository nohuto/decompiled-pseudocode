/*
 * XREFs of ?OnEvent@PTPEngineTraceProducer@@UEAAJPEAUPTPEngineEvent@@@Z @ 0x1C019A5E0
 * Callers:
...
__int64 __fastcall PTPEngineTraceProducer::OnEvent(PTPEngineTraceProducer *this, struct PTPEngineEvent *a2)
{
  ...
  if ( dword_1C020F490 > 5u && TlgKeywordOn((TraceLoggingHProvider)&dword_1C020F490, 3uLL) )
  {
    ...
    v13 = a2;
    v14 = 4LL;
    TlgWrite((TraceLoggingHProvider)&dword_1C020F490, &unk_1C01E8CA9, 0LL, 0LL, 6u, &pData);
  }
