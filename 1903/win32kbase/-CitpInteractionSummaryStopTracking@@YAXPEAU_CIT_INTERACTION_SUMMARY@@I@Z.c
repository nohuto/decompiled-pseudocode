/*
 * XREFs of ?CitpInteractionSummaryStopTracking@@YAXPEAU_CIT_INTERACTION_SUMMARY@@I@Z @ 0x1C0086DA4
 * Callers:
...
void __fastcall CitpInteractionSummaryStopTracking(struct _CIT_INTERACTION_SUMMARY *a1, int a2)
{
  ...
  *(_QWORD *)v2 = v2;
     ...
     || *((_WORD *)v2 + 48) && *((_WORD *)v2 + 49)) )
  {
    ...
    v14 = (char *)qword_1C0218810 + 800;
    v41 = *((_QWORD *)qword_1C0218810 + 103);
    v37 = a2 - *((_DWORD *)qword_1C0218810 + 208);
    ++*((_QWORD *)qword_1C0218810 + 100);
    if ( (*((_BYTE *)v2 + 88) & 1) != 0 )
    {
      v20 = *((_QWORD *)v2 + 3);
      v21 = &pwsz;
      ...
      if ( hProvider > 5u && TlgKeywordOn((TraceLoggingHProvider)&hProvider, 0x800000000800uLL) )
      {
        ...
        *(_WORD *)v30 = 257;
        ...
        v33 = *((_WORD *)v12 + 4);
        v105 = &v33;
        v107 = &dword_1C02187E8;
        v109 = (char *)&qword_1C02187F4 + 4;
        v111 = &dword_1C02187FC;
        v113 = &qword_1C02187F4;
        v115 = (char *)v11 + 836;
        v117 = v27 + 92;
        v119 = (int *)(v13 + 12);
        v121 = (int *)(v27 + 84);
        ...
        v40[0] = 0x2000000LL;
        v142 = 8LL;
        TlgWrite((TraceLoggingHProvider)&hProvider, &unk_1C01E9643, 0LL, 0LL, 0x36u, &pData);
      }
    }
    else if ( hProvider > 5u )
    {
      if ( TlgKeywordOn((TraceLoggingHProvider)&hProvider, 0x800000000800uLL) )
      {
        ...
        *(_QWORD *)&v46.Size = 16LL;
        ...
        v93 = &v32;
        v95 = &dword_1C02187E8;
        v97 = (char *)&qword_1C02187F4 + 4;
        v99 = &dword_1C02187FC;
        v101 = &qword_1C02187F4;
        v103 = (char *)v11 + 836;
        v105 = (__int16 *)(v17 + 92);
        v107 = (int *)(v13 + 12);
        v109 = (char *)(v17 + 84);
        ...
        v39 = 0x2000000LL;
        v130 = 8LL;
        TlgWrite((TraceLoggingHProvider)&hProvider, &unk_1C01E91F3, 0LL, 0LL, 0x30u, &pData);
      }
    }
  }
}
