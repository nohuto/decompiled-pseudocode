/*
 * XREFs of _woutput_l @ 0x1C00BC110
 * Callers:
 ...
 *     write_char_0 @ 0x1C00BCA40 (write_char_0.c)
 *     write_multi_char_0 @ 0x1C00BCA94 (write_multi_char_0.c)
 *     write_string_0 @ 0x1C00BCAEC (write_string_0.c)
 *     _get_printf_count_output @ 0x1C00BCB78 (_get_printf_count_output.c)
...
LABEL_120:
                  v37 = v59 - v12 - v36;
                  if ( (v6 & 0xC) == 0 )
                    write_multi_char_0(32LL, v37, v61, &v51);
                  write_string_0(v58, v36, v61, &v51);
                  v38 = v61;
                  if ( (v6 & 0xC) == 8 )
                    write_multi_char_0(48LL, v37, v61, &v51);
                  if ( v54 || (int)v12 <= 0 )
                  {
                    write_string_0(v8, (unsigned int)v12, v38, &v51);
LABEL_134:
                    v11 = v51;
                  }
                  else
                  {
                    ...
                    {
                      --v40;
                      v41 = mbtowc(&v57, v39, _mb_cur_max);
                      v42 = v41;
                      if ( v41 == 2 )
                        --v40;
                      if ( v41 <= 0 )
                        break;
                      write_char_0(v57, v61, &v51);
                      v39 += v42;
                      if ( v40 <= 0 )
                      {
                        v7 = v53;
