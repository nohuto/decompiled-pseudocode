/*
 * XREFs of ?CitpUpdateActiveBootId@@YAJIEPEAG0PEAX@Z @ 0x1C00850BC
 * Callers:
 ...
 * Callees:
 *     ?CitpBytesToString@@YAXPEBXIPEAG@Z @ 0x1C00852E4 (-CitpBytesToString@@YAXPEBXIPEAG@Z.c)
...
__int64 __fastcall CitpUpdateActiveBootId(int a1, char a2, unsigned __int16 *a3, unsigned __int16 *a4)
{
  ...
  *(_QWORD *)&Handle.Length = 0LL;
  ...
  v11 = (const unsigned __int16 *)&stru_1C01EAA14.MatchAllKeyword + 2;
