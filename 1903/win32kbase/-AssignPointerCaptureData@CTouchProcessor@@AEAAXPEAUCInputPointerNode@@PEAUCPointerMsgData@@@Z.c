/*
 * XREFs of ?AssignPointerCaptureData@CTouchProcessor@@AEAAXPEAUCInputPointerNode@@PEAUCPointerMsgData@@@Z @ 0x1C0161014
 * Callers:
        ...
        struct CPointerMsgData *a3)
{
  ...
  if ( ((unsigned __int8)v5 & 1) == 0 )
  {
    if ( ((unsigned __int8)v5 & 8) != 0 )
      goto LABEL_14;
    v6 = *((_QWORD *)v4 + 31);
    if ( (struct CInputPointerNode *)v6 == (struct CInputPointerNode *)((char *)v4 + 248) )
      v6 = 0LL;
    ...
    {
LABEL_14:
      v7 = Win32AllocPoolZInit(0x148uLL, 1131443029LL);
      if ( !v7 )
        return;
      v7[10] = *((_WORD *)a3 + 8);
      *((_DWORD *)v7 + 6) = *((_DWORD *)a3 + 7);
      v5 = (_QWORD *)((char *)v4 + 232);
      a2 = (struct CInputPointerNode *)*((_QWORD *)v4 + 29);
      if ( *((struct CInputPointerNode **)a2 + 1) != (struct CInputPointerNode *)((char *)v4 + 232) )
        __fastfail(3u);
      *(_QWORD *)v7 = a2;
      *((_QWORD *)v7 + 1) = v5;
      *((_QWORD *)a2 + 1) = v7;
