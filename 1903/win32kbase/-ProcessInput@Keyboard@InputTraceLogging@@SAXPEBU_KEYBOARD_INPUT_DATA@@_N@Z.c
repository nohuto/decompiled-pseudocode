/*
 * XREFs of ?ProcessInput@Keyboard@InputTraceLogging@@SAXPEBU_KEYBOARD_INPUT_DATA@@_N@Z @ 0x1C017D498
 * Callers:
...
void __fastcall InputTraceLogging::Keyboard::ProcessInput(const struct _KEYBOARD_INPUT_DATA *a1)
{
  ...
  if ( dword_1C020FB50 > 4u )
  {
    if ( TlgKeywordOn((TraceLoggingHProvider)&dword_1C020FB50, 0x4000uLL) )
    {
      ...
      v11 = &v6;
      v12 = cData;
      TlgWrite((TraceLoggingHProvider)&dword_1C020FB50, &unk_1C01E73C0, 0LL, 0LL, cData, &pData);
    }
  }
}
