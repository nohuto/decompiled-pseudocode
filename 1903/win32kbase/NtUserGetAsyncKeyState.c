/*
 * XREFs of NtUserGetAsyncKeyState @ 0x1C0071D10
 * Callers:
 *     <none>
 * Callees:
 ...
 *     ?OnKeyStateRequested@CAsyncKeyEventMonitor@@QEAAXK@Z @ 0x1C0121FE8 (-OnKeyStateRequested@CAsyncKeyEventMonitor@@QEAAXK@Z.c)
 */
    ...
    if ( CurrentProcessWin32Process != *((_QWORD *)gptiForeground + 52) )
    {
      ...
      if ( (W32kEtwEnabledKeyword & 0x400) != 0 )
      {
        if ( (unsigned __int8)(byte_1C020F438 - 1) <= 2u
          || (qword_1C020F420 & 0x400) == 0
          || (v10 = 1, (qword_1C020F428 & 0x400) != qword_1C020F428) )
        {
          v10 = 0;
        }
