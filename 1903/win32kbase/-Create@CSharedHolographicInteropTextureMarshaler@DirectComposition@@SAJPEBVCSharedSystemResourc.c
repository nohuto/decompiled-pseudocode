/*
 * XREFs of ?Create@CSharedHolographicInteropTextureMarshaler@DirectComposition@@SAJPEBVCSharedSystemResource@2@PEAPEAV12@@Z @ 0x1C01C66D8
 * Callers:
 *     CreateSharedHolographicInteropTextureMarshaler @ 0x1C01C68A0 (CreateSharedHolographicInteropTextureMarshaler.c)
 * Callees:
