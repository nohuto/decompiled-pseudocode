/*
 * XREFs of ?AllocateBuffer@SendHost@CoreMessagingK@@SAJPEAUIMessageCallSendHost@@PEA_KIIPEAPEAX@Z @ 0x1C0044550
 * Callers:
 *     <none>
 * Callees:
 ...
 *     ?HRESULTFromNTStatus@HResultUtil@CoreMessagingK@@YAJJ@Z @ 0x1C004460C (-HRESULTFromNTStatus@HResultUtil@CoreMessagingK@@YAJJ@Z.c)
