/*
 * XREFs of InitSystemThread @ 0x1C00A3C60
 * Callers:
 ...
 *     ClearAppStarting @ 0x1C0038620 (ClearAppStarting.c)
    ...
    if ( v35 && (*(int *)(v35 + 24) > 0 || *(_DWORD *)(*(_QWORD *)ActivityId + 48LL)) )
    {
      ...
      if ( dword_1C020FB50 > 6u )
      {
        if ( TlgKeywordOn((TraceLoggingHProvider)&dword_1C020FB50, 0x2000uLL) )
        {
          ...
          v48 = &v42;
          v49 = 4LL;
          TlgWrite((TraceLoggingHProvider)&dword_1C020FB50, &unk_1C01E34D7, (LPCGUID)&ActivityId[12], 0LL, 3u, &pData);
        }
      }
    }
  }
    ...
    *(_OWORD *)(*(_QWORD *)ActivityId + 28LL) = *(_OWORD *)&ActivityId[12];
    if ( dword_1C020FB50 > 6u )
    {
      if ( TlgKeywordOn((TraceLoggingHProvider)&dword_1C020FB50, 0x2000uLL) )
      {
        ...
        v51 = &v43;
        v52 = 4LL;
        TlgWrite((TraceLoggingHProvider)&dword_1C020FB50, &unk_1C01E3480, (LPCGUID)&ActivityId[12], 0LL, 3u, &v50);
        v36 = dword_1C020FB50;
      }
      if ( v36 > 6 && TlgKeywordOn((TraceLoggingHProvider)&dword_1C020FB50, 0x2000uLL) )
      {
        ...
        v54 = &v44;
        v55 = 4LL;
        TlgWrite((TraceLoggingHProvider)&dword_1C020FB50, &unk_1C01E34AD, (LPCGUID)&ActivityId[12], 0LL, 3u, &v53);
      }
    }
  }
