/*
 * XREFs of RIMVirtCreatePointerDeviceInfo @ 0x1C0141E50
 * Callers:
  ...
  *((_QWORD *)v9 + 108) = v9 + 864;
  ...
  if ( ProductString < 0 )
  {
    ...
    if ( dword_1C020F490 > 5u && TlgKeywordOn((TraceLoggingHProvider)&dword_1C020F490, 0x400000000000uLL) )
    {
      ...
      TlgWrite((TraceLoggingHProvider)&dword_1C020F490, &unk_1C01E49C7, 0LL, 0LL, cData, pData);
    }
  }
  *(_OWORD *)(a2 + 2088) = *(_OWORD *)(a6 + 2072);
  *(_OWORD *)(a2 + 2104) = *(_OWORD *)(a6 + 2088);
  *(_QWORD *)(a2 + 2120) = *(_QWORD *)(a6 + 2104);
  v16 = *v8;
      ...
      *((_DWORD *)v9 + 210) = *(_DWORD *)(a6 + 1200);
      ...
      if ( (int)RIMCmAllocPointerDeviceContacts(v9, 2020635474LL) >= 0 )
      {
        ...
        *(_QWORD *)&v63 = v34;
        ...
        {
          v38 = HMValidateSharedHandleNoRip(*(_QWORD *)(a2 + 1328), v35, 1LL);
