/*
 * XREFs of ?UpdateMouseSensitivity@MOUSE_SENSITIVITY_INFO@CMouseAcceleration@@QEAAXI@Z @ 0x1C00A3C00
 * Callers:
 *     ??0CMouseAcceleration@@IEAA@I@Z @ 0x1C00A3B74 (--0CMouseAcceleration@@IEAA@I@Z.c)
 *     UpdateMouseSensitivity @ 0x1C00A3BD0 (UpdateMouseSensitivity.c)
 * Callees:
