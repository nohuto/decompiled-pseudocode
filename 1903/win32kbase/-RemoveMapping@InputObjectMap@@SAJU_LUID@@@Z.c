/*
 * XREFs of ?RemoveMapping@InputObjectMap@@SAJU_LUID@@@Z @ 0x1C01C8200
 * Callers:
...
LABEL_11:
  ...
  v9 = *((_QWORD *)Entry + 1) & (-1LL << (dword_1C02187CC & 0x1F));
  for ( i = (struct InputObjectMapEntry *)((char *)qword_1C02187D0
                                         + 8
                                         * ((37
                                           * (BYTE6(v9)
                                            + 37
                                           ...
                                           + HIBYTE(v9)) & (((unsigned int)dword_1C02187CC >> 5) - 1)));
        (*(_QWORD *)i & 1) == 0;
