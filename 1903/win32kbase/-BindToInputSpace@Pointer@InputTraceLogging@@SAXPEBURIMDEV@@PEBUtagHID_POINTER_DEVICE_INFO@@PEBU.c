/*
 * XREFs of ?BindToInputSpace@Pointer@InputTraceLogging@@SAXPEBURIMDEV@@PEBUtagHID_POINTER_DEVICE_INFO@@PEBUINPUT_SPACE@@PEBUINPUT_SPACE_REGION@@@Z @ 0x1C014558C
 * Callers:
        ...
        const struct INPUT_SPACE_REGION *a4)
{
  ...
  if ( a3 && a4 )
  {
    if ( dword_1C020FB50 > 4u )
    {
      if ( TlgKeywordOn((TraceLoggingHProvider)&dword_1C020FB50, 0x20uLL) )
      {
        ...
        v52 = v7;
        v54 = v7;
        TlgWrite((TraceLoggingHProvider)&dword_1C020FB50, &unk_1C01E4C2B, 0LL, 0LL, 0x15u, &pData);
      }
    }
  }
  else if ( dword_1C020FB50 > 4u && TlgKeywordOn((TraceLoggingHProvider)&dword_1C020FB50, 0x20uLL) )
  {
    ...
    v56 = &v15;
    v57 = 8LL;
    TlgWrite((TraceLoggingHProvider)&dword_1C020FB50, &unk_1C01E4D55, 0LL, 0LL, 3u, &v55);
  }
}
