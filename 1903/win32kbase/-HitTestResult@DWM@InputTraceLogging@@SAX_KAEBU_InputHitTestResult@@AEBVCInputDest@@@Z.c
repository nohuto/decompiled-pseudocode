/*
 * XREFs of ?HitTestResult@DWM@InputTraceLogging@@SAX_KAEBU_InputHitTestResult@@AEBVCInputDest@@@Z @ 0x1C0034A88
 * Callers:
...
LABEL_6:
  ...
  *(_OWORD *)pwsz = *(_OWORD *)(WindowDetails + 16);
  ...
  if ( dword_1C020FB50 > 4u && TlgKeywordOn((TraceLoggingHProvider)&dword_1C020FB50, 2uLL) )
  {
    ...
    v84 = v16;
    v86 = v16;
    TlgWrite((TraceLoggingHProvider)&dword_1C020FB50, &unk_1C01E7603, 0LL, 0LL, 0x21u, &pData);
  }
}
