/*
 * XREFs of ?OnTelemetryOutput@PTPEngineTraceProducer@@UEAAXPEBUPTPTelemetryOutput@@@Z @ 0x1C019A8F0
 * Callers:
 *     <none>
 * Callees:
        ...
        const struct PTPTelemetryOutput *a2)
{
  ...
  if ( dword_1C020F490 > 5u && TlgKeywordOn((TraceLoggingHProvider)&dword_1C020F490, 9uLL) )
  {
    v7 = 8LL;
    v6 = (char *)this + 536;
    v8 = &v4;
    ...
    v12 = a2;
    v13 = 32LL;
    TlgWrite((TraceLoggingHProvider)&dword_1C020F490, &unk_1C01E8B2E, 0LL, 0LL, 6u, &pData);
  }
