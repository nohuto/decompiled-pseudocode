/*
 * XREFs of ?GetPointerMessageInfo@CTouchProcessor@@QEAAH_KHPEAPEAUHWND__@@PEAH2PEAKPEAI@Z @ 0x1C016B620
 * Callers:
 *     <none>
 * Callees:
...
LABEL_12:
    LOBYTE(v12) = 5;
    WPP_RECORDER_SF_(v13->DeviceExtension, v12, 7, v14, (__int64)&WPP_06d7dff703a03015e007562f188a8383_Traceguids);
LABEL_13:
    v18 = 0;
    goto LABEL_35;
  }
