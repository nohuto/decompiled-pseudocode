/*
 * XREFs of ?RtlUnicodeStringCatString@@YAJPEAU_UNICODE_STRING@@PEBG@Z @ 0x1C015D3E0
 * Callers:
 ...
 *     RtlWideCharArrayCopyStringWorker @ 0x1C015D4D8 (RtlWideCharArrayCopyStringWorker.c)
 */
