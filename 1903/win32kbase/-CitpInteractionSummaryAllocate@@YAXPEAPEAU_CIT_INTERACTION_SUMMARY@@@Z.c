/*
 * XREFs of ?CitpInteractionSummaryAllocate@@YAXPEAPEAU_CIT_INTERACTION_SUMMARY@@@Z @ 0x1C0098E3C
 * Callers:
...
void __fastcall CitpInteractionSummaryAllocate(struct _CIT_INTERACTION_SUMMARY **a1)
{
  ...
  v1 = dword_1C021880C;
  v3 = (unsigned __int16)dword_1C021880C;
  v4 = CitAllocZero((unsigned __int16)dword_1C021880C);
  if ( v4 )
  {
    v4[1] = v4;
    *v4 = v4;
    v5 = (*((_WORD *)v4 + 44) ^ (4 * v1)) & 0x7FFC;
  ...
  {
    CitpLogFailureWorker(-1073741670, 0LL, 0xCFFu);
  }
}
