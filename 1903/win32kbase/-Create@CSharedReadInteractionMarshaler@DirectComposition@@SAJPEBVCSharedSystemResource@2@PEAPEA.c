/*
 * XREFs of ?Create@CSharedReadInteractionMarshaler@DirectComposition@@SAJPEBVCSharedSystemResource@2@PEAPEAV12@@Z @ 0x1C00969B8
 * Callers:
 *     CreateSharedReadInteractionMarshaler @ 0x1C0096980 (CreateSharedReadInteractionMarshaler.c)
 * Callees:
        ...
        struct DirectComposition::CSharedReadInteractionMarshaler **a2)
{
  ...
  v4 = (struct DirectComposition::CSharedReadInteractionMarshaler *)Win32AllocPoolWithQuotaZInit(0x38uLL, 0x6A734344u);
  v5 = v4;
  if ( v4 )
  {
    memset(v4, 0, 0x38uLL);
  ...
  if ( v5 )
  {
    v6 = (*(__int64 (__fastcall **)(struct DirectComposition::CSharedReadInteractionMarshaler *, const struct DirectComposition::CSharedSystemResource *))(*(_QWORD *)v5 + 248LL))(
           v5,
           a1);
    if ( v6 < 0 )
    {
