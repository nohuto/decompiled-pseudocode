/*
 * XREFs of ?ShouldEscapeProximity@@YAEXZ @ 0x1C0107ACC
 * Callers:
...
unsigned __int8 __fastcall ShouldEscapeProximity(__int64 a1, __int64 a2, __int64 a3)
{
  unsigned __int64 v3; // r9
  unsigned __int8 result; // al
  unsigned __int8 v5; // [rsp+30h] [rbp-59h] BYREF
  ...
  unsigned __int8 *v12; // [rsp+70h] [rbp-19h]
  ...
  if ( dword_1C020F458 > 5u && TlgKeywordOn((TraceLoggingHProvider)&dword_1C020F458, 0x400000000000uLL) )
  {
    ...
    v25 = 4;
    v28 = 8;
    TlgWrite((TraceLoggingHProvider)&dword_1C020F458, &unk_1C01E35F1, 0LL, 0LL, 8u, &pData);
    v3 = v9;
  }
  result = v5;
