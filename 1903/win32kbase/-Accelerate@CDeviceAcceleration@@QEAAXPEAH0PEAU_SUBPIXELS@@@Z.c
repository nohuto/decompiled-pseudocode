/*
 * XREFs of ?Accelerate@CDeviceAcceleration@@QEAAXPEAH0PEAU_SUBPIXELS@@@Z @ 0x1C0066D98
 * Callers:
  ...
  *((_DWORD *)a4 + 1) = 0;
  if ( v9 )
  {
    ...
    if ( v17 )
    {
      ...
      if ( dword_1C02154D8 < (unsigned int)v19 )
        v20 = (*(_QWORD *)(v33 + 8LL * (unsigned int)dword_1C02154D8)
             + (*(_QWORD *)(v32 + 8LL * (unsigned int)dword_1C02154D8) << 16) / v17
             + v20) >> 1;
      dword_1C02154D8 = v19;
      v21 = qword_1C02154D0 + ((v11 * v20) >> 16);
      v22 = -v21;
      v23 = qword_1C02154C8 + ((v10 * v20) >> 16);
      if ( v21 < 0 )
      {
        v25 = v21;
