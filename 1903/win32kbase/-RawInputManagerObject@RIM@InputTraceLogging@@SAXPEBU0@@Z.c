/*
 * XREFs of ?RawInputManagerObject@RIM@InputTraceLogging@@SAXPEBU0@@Z @ 0x1C00B4004
 * Callers:
...
void __fastcall InputTraceLogging::RIM::RawInputManagerObject(const struct RawInputManagerObject *a1)
{
  ...
  if ( dword_1C020FB50 > 4u && TlgKeywordOn((TraceLoggingHProvider)&dword_1C020FB50, 0x100uLL) )
  {
    ...
    v28 = v14;
    v30 = v14;
    TlgWrite((TraceLoggingHProvider)&dword_1C020FB50, &unk_1C01E4784, 0LL, 0LL, 8u, &pData);
  }
}
