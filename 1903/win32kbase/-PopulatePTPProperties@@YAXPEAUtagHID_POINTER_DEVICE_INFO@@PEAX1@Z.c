/*
 * XREFs of ?PopulatePTPProperties@@YAXPEAUtagHID_POINTER_DEVICE_INFO@@PEAX1@Z @ 0x1C014CDA4
 * Callers:
 *     RIMPopulateExtendedPointerDeviceProperties @ 0x1C014D0DC (RIMPopulateExtendedPointerDeviceProperties.c)
 * Callees:
 *     ?ReadDevicePropertyFromRegistry@@YA_NPEBGPEAX1JPEAJ@Z @ 0x1C005C5E4 (-ReadDevicePropertyFromRegistry@@YA_NPEBGPEAX1JPEAJ@Z.c)
...
void __fastcall PopulatePTPProperties(struct tagHID_POINTER_DEVICE_INFO *a1, void *a2, void *a3)
{
  ...
  v4 = (int *)&v24;
  v6 = (const unsigned __int16 **)&off_1C020FB98;
  v8 = 16LL;
  do
  {
