/*
 * XREFs of ?UserInitialize@@YAJXZ @ 0x1C0073120
 * Callers:
 ...
 *     ?InitializeRemoteSessionOcclusionEvent@@YAJXZ @ 0x1C00A85B8 (-InitializeRemoteSessionOcclusionEvent@@YAJXZ.c)
    ...
    *(GUID *)(v53 + 28) = pActivityId;
    if ( dword_1C020FB50 > 6u )
    {
      if ( TlgKeywordOn((TraceLoggingHProvider)&dword_1C020FB50, 0x2000uLL) )
      {
        ...
        v61 = &v46;
        v62 = 4LL;
        TlgWrite((TraceLoggingHProvider)&dword_1C020FB50, &unk_1C01E3480, &pActivityId, 0LL, 3u, &v60);
        v24 = dword_1C020FB50;
      }
      if ( v24 > 6 && TlgKeywordOn((TraceLoggingHProvider)&dword_1C020FB50, 0x2000uLL) )
      {
        v44 = v54;
        v64 = &v44;
        v65 = 4LL;
        TlgWrite((TraceLoggingHProvider)&dword_1C020FB50, &unk_1C01E34AD, &pActivityId, 0LL, 3u, &v63);
      }
    }
  }
