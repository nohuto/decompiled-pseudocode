/*
 * XREFs of ??$AddProperty@M@CPropertySetMarshaler@DirectComposition@@AEAAJAEBUPropertySetValue@@PEBM@Z @ 0x1C00BF978
 * Callers:
...
__int64 __fastcall DirectComposition::CPropertySetMarshaler::AddProperty<float>(__int64 a1, _DWORD *a2, int *a3)
{
  _QWORD *v3; // rsi
  unsigned int v5; // ebx
  int v6; // eax
