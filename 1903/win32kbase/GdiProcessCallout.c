/*
 * XREFs of GdiProcessCallout @ 0x1C007FB20
 * Callers:
 *     <none>
 * Callees:
    ...
    *(_QWORD *)(a1 + 208) = a1 + 208;
    ...
    if ( ProcessPeb
      && (*(_DWORD *)(ProcessPeb + 264) = 20,
          ...
          ViewSize[1] = a1 + 248,
          LOBYTE(v17) = a2,
          (int)((__int64 (__fastcall *)(__int64, void *, __int64))qword_1C0215038)(
                 a1 + 248,
                 ...
                 v17) >= 0) )
    {
      ...
      if ( v18 < 0 )
        ((void (__fastcall *)(__int64, void *, _QWORD))qword_1C0215038)(a1 + 248, &gDxgkWin32kEngInterface, 0LL);
