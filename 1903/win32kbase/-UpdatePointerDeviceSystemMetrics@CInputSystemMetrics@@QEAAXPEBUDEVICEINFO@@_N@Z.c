/*
 * XREFs of ?UpdatePointerDeviceSystemMetrics@CInputSystemMetrics@@QEAAXPEBUDEVICEINFO@@_N@Z @ 0x1C018FF5C
 * Callers:
 ...
 *     UpdatePointerDeviceSystemMetrics @ 0x1C0184CE0 (UpdatePointerDeviceSystemMetrics.c)
 * Callees:
