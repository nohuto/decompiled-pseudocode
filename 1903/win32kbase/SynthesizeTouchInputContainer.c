/*
 * XREFs of SynthesizeTouchInputContainer @ 0x1C018EBF0
 * Callers:
 *     ?OnTouchSynthesizeNotification@CHidInput@@EEAAJXZ @ 0x1C017F510 (-OnTouchSynthesizeNotification@CHidInput@@EEAAJXZ.c)
 * Callees:
