/*
 * XREFs of ?Insert@CPointerHashTable@NSInstrumentation@@QEAA_NPEBX0@Z @ 0x1C0133F84
 * Callers:
 ...
 * Callees:
 *     ?Wait@CPlatformSingleWatierSignal@NSInstrumentation@@QEAAXXZ @ 0x1C013319C (-Wait@CPlatformSingleWatierSignal@NSInstrumentation@@QEAAXXZ.c)
