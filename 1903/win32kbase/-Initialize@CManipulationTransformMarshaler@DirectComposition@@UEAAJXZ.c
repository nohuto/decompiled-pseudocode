/*
 * XREFs of ?Initialize@CManipulationTransformMarshaler@DirectComposition@@UEAAJXZ @ 0x1C008DAC0
 * Callers:
 *     ?InitializeFromSharedResource@CSharedManipulationTransformMarshaler@DirectComposition@@QEAAJPEBVCSharedSystemResource@2@@Z @ 0x1C008DA64 (-InitializeFromSharedResource@CSharedManipulationTransformMarshaler@DirectComposition@@QEAAJPEBV.c)
 * Callees:
 *     <none>
 */
