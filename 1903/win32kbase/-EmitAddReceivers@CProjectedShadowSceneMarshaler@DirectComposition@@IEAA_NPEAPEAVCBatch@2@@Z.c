/*
 * XREFs of ?EmitAddReceivers@CProjectedShadowSceneMarshaler@DirectComposition@@IEAA_NPEAPEAVCBatch@2@@Z @ 0x1C0003594
 * Callers:
 *     ?EmitUpdateCommands@CProjectedShadowSceneMarshaler@DirectComposition@@MEAA_NPEAPEAVCBatch@2@@Z @ 0x1C00030F0 (-EmitUpdateCommands@CProjectedShadowSceneMarshaler@DirectComposition@@MEAA_NPEAPEAVCBatch@2@@Z.c)
 * Callees:
        ...
        struct DirectComposition::CBatch **a2)
{
  ...
  if ( *((_DWORD *)this + 21) < *((_DWORD *)this + 20) )
  {
    do
    {
      v4 = 4096LL - *(_QWORD *)(*((_QWORD *)*a2 + 17) + 40LL);
      v12 = v4;
      if ( v4 < 0x14 )
      {
      ...
      *((_DWORD *)v6 + 3) = v5;
      ...
      if ( (_DWORD)v5 )
      {
        ...
        {
          v10 = v8++;
          *v7++ = *(_DWORD *)(*(_QWORD *)(*((_QWORD *)this + 9) + 8 * v10) + 24LL);
          --v9;
        }
        while ( v9 );
        v8 = *((_DWORD *)this + 21);
      }
      *((_DWORD *)this + 21) = v5 + v8;
    }
    while ( (unsigned int)v5 + v8 < *((_DWORD *)this + 20) );
  }
  return *((_DWORD *)this + 21) == *((_DWORD *)this + 20);
}
