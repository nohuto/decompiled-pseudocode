/*
 * XREFs of ?Free@?$CTypeIsolation@$0BFAAA@$0BFA@@NSInstrumentation@@IEAAXPEAX@Z @ 0x1C010518C
 * Callers:
 *     ?HMFreeIsolatedType@@YAXEPEAX@Z @ 0x1C0053DE0 (-HMFreeIsolatedType@@YAXEPEAX@Z.c)
 * Callees:
 *     ?CheckAllocationStatus@?$CSectionBitmapAllocator@$0BFAAA@$0BFA@@NSInstrumentation@@QEAA?AW4AllocationStatus@2@PEBX@Z @ 0x1C0080528 (-CheckAllocationStatus@-$CSectionBitmapAllocator@$0BFAAA@$0BFA@@NSInstrumentation@@QEAA-AW4Alloc.c)
