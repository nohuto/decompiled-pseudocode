/*
 * XREFs of ?Connect@RegistrarClient@CoreMessagingK@@CAJXZ @ 0x1C00AB260
 * Callers:
 ...
 *     ?InitializeSecurityDescriptor@RegistrarClient@CoreMessagingK@@CAJPEAU_SECURITY_DESCRIPTOR@@@Z @ 0x1C00AB56C (-InitializeSecurityDescriptor@RegistrarClient@CoreMessagingK@@CAJPEAU_SECURITY_DESCRIPTOR@@@Z.c)
...
__int64 CoreMessagingK::RegistrarClient::Connect(void)
{
  ...
  *((_QWORD *)&v5 + 1) = L"\\BaseNamedObjects\\CoreMessagingRegistrar";
  ...
  if ( dword_1C020F5E0 > 5u )
  {
    ...
    v23 = &v4;
    v24 = 4;
    TlgWrite((TraceLoggingHProvider)&dword_1C020F5E0, &unk_1C01EA18F, 0LL, 0LL, 3u, &pData);
  }
