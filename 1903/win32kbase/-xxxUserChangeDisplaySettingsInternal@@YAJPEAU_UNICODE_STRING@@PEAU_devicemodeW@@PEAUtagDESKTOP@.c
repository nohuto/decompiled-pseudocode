/*
 * XREFs of ?xxxUserChangeDisplaySettingsInternal@@YAJPEAU_UNICODE_STRING@@PEAU_devicemodeW@@PEAUtagDESKTOP@@KPEAXW4_MODE@@PEAU_DXGK_DISPLAY_SCENARIO_CONTEXT@@@Z @ 0x1C004B9BC
 * Callers:
...
LABEL_46:
          ...
          if ( CreateCachedMonitor() )
          {
            ...
            if ( (int)IsFreeAllSpbsSupported() >= 0 )
              FreeAllSpbs();
LABEL_50:
            if ( qword_1C0218870 && (int)IsStopFadeSupported() >= 0 )
              StopFade();
