/*
 * XREFs of ?GetPointerDeviceConfig@InputConfig@@SA_NPEBURIMDEV@@PEBUtagHID_POINTER_DEVICE_INFO@@PEAVCLockedInputSpace@@PEAVCLockedInputSpaceRegion@@@Z @ 0x1C0187F70
 * Callers:
...
LABEL_26:
          ...
          else
          {
            ...
            for ( j = v12[150]; ; j = (_QWORD *)*j )
            {
              ...
              if ( (v15[4] & 2) != 0
                && v15[9] == *((_DWORD *)a1 + 463)
                && v15[10] == *((_DWORD *)a1 + 464)
                && v15[11] == *((_DWORD *)a1 + 466) )
              {
                *(_QWORD *)a3 = v12;
                v4 = 1;
                *(_QWORD *)a4 = v15;
