/*
 * XREFs of DirectComposition::CResourceMarshaler::EmitUpdateCommand__lambda_778e4044449296c5ab55ebb36926d680___lambda_f91f4cf09ba95a878c6ebb7809dc9a5a___ @ 0x1C01B2458
 * Callers:
    ...
    *((_DWORD *)v13 + 4) = 4 * v12;
    ...
    if ( (_DWORD)v12 )
    {
      ...
      do
      {
        v16 = *a3;
        *a3 = v16 + 1;
        *v14++ = *(_DWORD *)(*(_QWORD *)(*(_QWORD *)(*(_QWORD *)v6 + 352LL) + 8 * v16) + 24LL);
        --v15;
      }
      while ( v15 );
    }
