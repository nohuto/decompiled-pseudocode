/*
 * XREFs of ?createrec@EPATHOBJ@@IEAAHPEAVEXFORMOBJ@@PEAU_PATHDATAL@@PEAU_POINTFIX@@@Z @ 0x1C00794F4
 * Callers:
 ...
 *     ?vOffsetPoints@@YAXPEAU_POINTFIX@@0IJJ@Z @ 0x1C0123ED4 (-vOffsetPoints@@YAXPEAU_POINTFIX@@0IJJ@Z.c)
 */
