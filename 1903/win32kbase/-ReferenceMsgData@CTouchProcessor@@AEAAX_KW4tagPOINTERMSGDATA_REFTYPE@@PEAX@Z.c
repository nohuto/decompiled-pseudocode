/*
 * XREFs of ?ReferenceMsgData@CTouchProcessor@@AEAAX_KW4tagPOINTERMSGDATA_REFTYPE@@PEAX@Z @ 0x1C01717A8
 * Callers:
...
char __fastcall CTouchProcessor::ReferenceMsgData(__int64 a1, __int64 a2, __int64 a3)
{
  ...
  if ( (_DWORD)a3 == 1 )
  {
    ...
    if ( (v5 & 0x40) != 0 )
    {
      ...
      {
        LOBYTE(a2) = 2;
        WPP_RECORDER_SF_q((_DWORD)gBaseLog, a2, v3 + 6, 292, (__int64)&WPP_06d7dff703a03015e007562f188a8383_Traceguids);
        v5 = *(_DWORD *)(v4 + 36);
      }
    }
