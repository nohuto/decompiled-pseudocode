/*
 * XREFs of ?QueueMouseEvent@CMouseProcessor@@AEAAXPEBVMouseInputDataEx@1@PEBU_SUBPIXELS@@PEBUtagUIPI_INFO_INT@@PEBUtagPOINT@@@Z @ 0x1C00319DC
 * Callers:
 ...
 *     ?ComputeMouseDataInputSource@MouseInputDataEx@CMouseProcessor@@QEBAXPEAUtagINPUT_MESSAGE_SOURCE@@@Z @ 0x1C003201C (-ComputeMouseDataInputSource@MouseInputDataEx@CMouseProcessor@@QEBAXPEAUtagINPUT_MESSAGE_SOURCE@.c)
...
LABEL_2:
  ...
  if ( v8 )
  {
    ...
    {
      LOBYTE(v15) = 4;
      WPP_RECORDER_SF_((_DWORD)gBaseLog, v15, 6, 19, (__int64)&WPP_a819e7d240c13332848bedce030fc704_Traceguids);
    }
  ...
  if ( v14 )
  {
    ...
    {
      LOBYTE(v15) = 4;
      WPP_RECORDER_SF_((_DWORD)gBaseLog, v15, 6, 21, (__int64)&WPP_a819e7d240c13332848bedce030fc704_Traceguids);
    }
...
LABEL_10:
    ...
    *((_QWORD *)v10 + 1) = 0LL;
    ...
    if ( dword_1C020FB50 > 4u && TlgKeywordOn((TraceLoggingHProvider)&dword_1C020FB50, 0x40uLL) )
    {
      *(_QWORD *)&v33 = *((_QWORD *)v18 + 10);
      ...
      v45 = 4LL;
      v47 = 4LL;
      TlgWrite((TraceLoggingHProvider)&dword_1C020FB50, &unk_1C01E8421, 0LL, 0LL, 7u, &pData);
    }
    if ( v28 )
  ...
  {
    LOBYTE(v15) = 2;
    WPP_RECORDER_SF_((_DWORD)gBaseLog, v15, 6, 20, (__int64)&WPP_a819e7d240c13332848bedce030fc704_Traceguids);
  }
  *((_QWORD *)v10 + 1) = 0LL;
  ExReleasePushLockExclusiveEx(v10, 0LL);
  KeLeaveCriticalRegion();
