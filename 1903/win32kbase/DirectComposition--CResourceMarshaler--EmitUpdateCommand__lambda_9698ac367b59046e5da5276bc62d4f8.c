/*
 * XREFs of DirectComposition::CResourceMarshaler::EmitUpdateCommand__lambda_9698ac367b59046e5da5276bc62d4f84___ @ 0x1C01B5D68
 * Callers:
        ...
        __int64 *a3)
{
  ...
  *((_DWORD *)v5 + 2) = *(_DWORD *)(a1 + 24);
  v6 = *a3;
  *(_QWORD *)(v5 + 12) = *(_QWORD *)(*a3 + 416);
  *((_DWORD *)v5 + 5) = *(_DWORD *)(v6 + 424);
  return 1;
}
