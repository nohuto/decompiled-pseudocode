/*
 * XREFs of ?SetupNewQFrame@CTouchProcessor@@QEAAPEAUCPointerQFrame@@PEAUCPointerInputFrame@@PEAPEAU2@_KVCInputDest@@H@Z @ 0x1C0174600
 * Callers:
...
LABEL_16:
        LOBYTE(v17) = 5;
        WPP_RECORDER_SF_(v19->DeviceExtension, v17, 7, v20, (__int64)&WPP_06d7dff703a03015e007562f188a8383_Traceguids);
      }
    }
  }
