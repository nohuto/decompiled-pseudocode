/*
 * XREFs of ?MouseKeys@@YAHPEAUtagKE@@KH@Z @ 0x1C015E4C0
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall MouseKeys(struct tagKE *a1)
{
  ...
  {
    if ( (dword_1C02145F4 & 4) != 0 && v1 == gNumLockVk && (*((_WORD *)a1 + 1) & 0x8000) == 0 && (_DWORD)v3 == 17 )
    {
  ...
  gMKPreviousVk = v1;
  return off_1C01D3F30[v4](word_1C01EE280[v4]);
}
