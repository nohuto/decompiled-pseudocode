/*
 * XREFs of ?EngineInput@PTP@InputTraceLogging@@SAXPEBUCPointerInputFrame@@_N@Z @ 0x1C017A878
 * Callers:
...
void __fastcall InputTraceLogging::PTP::EngineInput(const struct CPointerInputFrame *a1)
{
  ...
  if ( dword_1C020FB50 > 4u )
  {
    if ( TlgKeywordOn((TraceLoggingHProvider)&dword_1C020FB50, 0x80uLL) )
    {
      ...
      v15 = v3;
      v17 = v3;
      TlgWrite((TraceLoggingHProvider)&dword_1C020FB50, &unk_1C01E731C, 0LL, 0LL, 7u, &pData);
    }
  }
}
