/*
 * XREFs of ?SetReferenceProperty@CVisualMarshaler@DirectComposition@@UEAAJPEAVCApplicationChannel@2@IPEAVCResourceMarshaler@2@PEA_N@Z @ 0x1C007B820
 * Callers:
 ...
 *     ?SetReferenceProperty@CGlyphRunVisualMarshaler@DirectComposition@@UEAAJPEAVCApplicationChannel@2@IPEAVCResourceMarshaler@2@PEA_N@Z @ 0x1C01B8730 (-SetReferenceProperty@CGlyphRunVisualMarshaler@DirectComposition@@UEAAJPEAVCApplicationChannel@2.c)
    ...
    case 23:
      if ( a4 )
      {
                ...
                87LL) )
        {
          v9 = -1073741811;
LABEL_44:
          v10 = (struct DirectComposition::CResourceMarshaler **)((char *)this + 192);
          v11 = 0x100000;
          goto LABEL_10;
        }
        v18 = *((_DWORD *)a4 + 6);
