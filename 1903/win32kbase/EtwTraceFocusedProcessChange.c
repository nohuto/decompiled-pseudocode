/*
 * XREFs of EtwTraceFocusedProcessChange @ 0x1C009C600
 * Callers:
 *     <none>
 * Callees:
...
char __fastcall EtwTraceFocusedProcessChange(GUID *Activity, __int64 a2)
{
  ...
  if ( (W32kEtwEnabledKeyword & 0x8000000000020000uLL) != 0 )
  {
    ...
    if ( (unsigned __int8)(byte_1C020F438 - 1) > 2u && (qword_1C020F420 & 0x8000000000020000uLL) != 0 )
    {
      LOBYTE(v4) = 0;
      if ( (qword_1C020F428 & 0x8000000000020000uLL) == qword_1C020F428 )
      {
        Arg1 = 0LL;
        if ( Activity )
        {
