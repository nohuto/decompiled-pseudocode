/*
 * XREFs of ?xxxMKMoveConstCursorTimer@@YAXPEAUtagWND@@I_K_J@Z @ 0x1C015F5B0
 * Callers:
 *     <none>
 * Callees:
...
void __fastcall xxxMKMoveConstCursorTimer(struct tagWND *a1, __int64 a2)
{
  ...
  {
LABEL_6:
    a2 = giMouseMoveTable % (unsigned int)(unsigned __int8)byte_1C0214531;
    v3 = (unsigned __int8)byte_1C0214532[a2];
    giMouseMoveTable = a2 + 1;
    if ( !v3 )
      return;
    goto LABEL_7;
  }
  v3 = 4 * (unsigned __int8)byte_1C0214532[0];
LABEL_7:
