/*
 * XREFs of ?CitpInteractionSummaryGetOutstanding@@YAPEAU_CIT_INTERACTION_SUMMARY@@PEAU_CIT_PROCESS@@G@Z @ 0x1C01C92D0
 * Callers:
...
struct _CIT_INTERACTION_SUMMARY *__fastcall CitpInteractionSummaryGetOutstanding(struct _CIT_PROCESS *a1)
{
  ...
  if ( (qword_1C02187F4 & 2) != 0 )
  {
    ...
    if ( (unsigned int)v3 >= *((_DWORD *)qword_1C0218810 + 14) )
      return 0LL;
    v4 = *(_QWORD *)qword_1C0218810 + 96 * v3;
