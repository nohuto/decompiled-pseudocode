/*
 * XREFs of HMChangeOwnerPheProcessWorker @ 0x1C008AEA8
 * Callers:
 ...
 *     HMChangeOwnerProcessWorker @ 0x1C01057A0 (HMChangeOwnerProcessWorker.c)
 * Callees:
...
__int64 __fastcall HMChangeOwnerPheProcessWorker(__int64 a1, __int64 a2, int a3)
{
  ...
  v6 = (unsigned int)((a1 - (__int64)qword_1C0213758) >> 5);
  v7 = 3 * v6;
  ...
  *(_DWORD *)(v9 + 16) = 0;
  if ( (*((_BYTE *)&unk_1C01D2E9C + 24 * *(unsigned __int8 *)(a1 + 24)) & 4) != 0 )
