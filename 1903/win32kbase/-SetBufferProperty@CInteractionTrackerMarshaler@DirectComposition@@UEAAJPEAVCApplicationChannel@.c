/*
 * XREFs of ?SetBufferProperty@CInteractionTrackerMarshaler@DirectComposition@@UEAAJPEAVCApplicationChannel@2@IPEBX_KPEA_N@Z @ 0x1C01ACAF0
 * Callers:
 *     <none>
 * Callees:
...
LABEL_58:
      ...
      {
        *(_QWORD *)(*((_QWORD *)this + 41) + 16LL * v27) = v30;
        DirectComposition::CResourceMarshaler::AddRef(*(DirectComposition::CResourceMarshaler **)(*((_QWORD *)this + 41)
                                                                                                + 16LL * v27));
        ++*((_DWORD *)this + 84);
      }
      else
      ...
      if ( v7 >= 0 )
      {
        ...
        if ( !v33 || !(*(unsigned __int8 (__fastcall **)(__int64, __int64))(*(_QWORD *)v33 + 120LL))(v33, 87LL) )
        {
          v7 = -1073741811;
LABEL_53:
          *(_QWORD *)(*((_QWORD *)this + 41) + 16LL * v27 + 8) = 0LL;
          goto LABEL_54;
        }
        *(_QWORD *)(*((_QWORD *)this + 41) + 16LL * v27 + 8) = v33;
        DirectComposition::CResourceMarshaler::AddRef(*(DirectComposition::CResourceMarshaler **)(*((_QWORD *)this + 41)
                                                                                                + 16LL * v27
                                                                                                + 8));
      }
LABEL_54:
      ...
      if ( v14 )
      {
        ...
        if ( v15 )
        {
          ...
          if ( v16 )
          {
            ...
            *(_OWORD *)((char *)this + 360) = *(_OWORD *)a4;
            *(_OWORD *)((char *)this + 376) = *((_OWORD *)a4 + 1);
            *((_DWORD *)this + 98) = a4[8];
            *a6 = 1;
            *((_DWORD *)this + 4) &= ~0x1000000u;
            return (unsigned int)v7;
          }
          v17 = (DirectComposition::CDCompDynamicArrayBase *)*((_QWORD *)this + 43);
          v18 = a4[2];
          Src = *(_QWORD *)a4;
          v36 = v18;
          if ( !v17 )
          ...
          if ( *((_DWORD *)this + 88) != *((_QWORD *)v17 + 3)
            || (v7 = DirectComposition::CDCompDynamicArrayBase::Grow(v17, 1LL, 0x72694344u), v7 >= 0) )
          {
            memmove(
              (void *)(**((_QWORD **)this + 43)
                     + *(_QWORD *)(*((_QWORD *)this + 43) + 32LL) * *((unsigned int *)this + 88)),
              &Src,
              *(_QWORD *)(*((_QWORD *)this + 43) + 32LL));
            ++*((_DWORD *)this + 88);
            *a6 = 1;
          }
          goto LABEL_57;
  ...
  v21 = *((_QWORD *)this + v20 + 30);
  if ( v21 )
  {
    Win32FreePool(v21);
    *((_QWORD *)this + v20 + 30) = 0LL;
  }
  v22 = Win32AllocPoolWithQuotaZInit(Size, 0x72694344u);
  *((_QWORD *)this + v20 + 30) = v22;
  if ( !v22 )
  {
    v7 = -1073741801;
    goto LABEL_58;
