/*
 * XREFs of ?InformUMObservers@CMouseProcessor@@AEAAXAEBVCMouseEvent@1@AEBUtagPOINT@@@Z @ 0x1C003FDAC
 * Callers:
...
LABEL_6:
    ...
    InputExtensibilityCallout::CoreMsgSendMessage(LODWORD(v18[2]), 12LL, v18);
  }
}
