/*
 * XREFs of ?EmitConfigureInternalProperties@CInteractionTrackerMarshaler@DirectComposition@@AEAA_NPEAPEAVCBatch@2@@Z @ 0x1C01ABA34
 * Callers:
        ...
        struct DirectComposition::CBatch **a2)
{
  ...
  if ( (*((_DWORD *)this + 4) & 0x1000000) == 0 )
  {
    if ( DirectComposition::CBatch::EnsureBatchBuffer(a2, 0x30uLL, &v7) )
    {
      ...
      *(_OWORD *)v5 = *(_OWORD *)((char *)this + 360);
      *((_OWORD *)v5 + 1) = *(_OWORD *)((char *)this + 376);
      *((_DWORD *)v5 + 8) = *((_DWORD *)this + 98);
