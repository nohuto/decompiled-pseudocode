/*
 * XREFs of ?DrvSetDisconnectedGraphicsDevice@@YAHH@Z @ 0x1C004FD70
 * Callers:
...
__int64 __fastcall DrvSetDisconnectedGraphicsDevice(int a1)
{
  ...
  *((_WORD *)v4 + 12) = v5;
  *((_WORD *)v4 + 110) = -1;
  RegistryHandleFromDeviceMap = (WCHAR *)DrvGetRegistryHandleFromDeviceMap((unsigned __int16 *)v4, 0, 0LL, 0LL, 0, &v11);
  v7 = v11;
  v8 = RegistryHandleFromDeviceMap;
  if ( v11 >= 0 )
  {
    if ( RegistryHandleFromDeviceMap )
    {
      DrvGetDeviceConfigurationInformation((__int64 *)v4, RegistryHandleFromDeviceMap, 0);
      ZwClose(v8);
      v1 = 1;
    }
    if ( !*((_QWORD *)v4 + 26) )
    {
      v9 = (unsigned __int16 *)PALLOCMEM2(0x20uLL, 0x73726447u, 0);
      *((_QWORD *)v4 + 26) = v9;
      if ( v9 )
      {
