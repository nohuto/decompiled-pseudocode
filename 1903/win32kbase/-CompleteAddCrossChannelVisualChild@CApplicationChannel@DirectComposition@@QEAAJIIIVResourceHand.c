/*
 * XREFs of ?CompleteAddCrossChannelVisualChild@CApplicationChannel@DirectComposition@@QEAAJIIIVResourceHandle@@HI0@Z @ 0x1C0001DAC
 * Callers:
...
LABEL_35:
  ...
  if ( a5 )
  {
    v16 = Win32AllocPoolWithQuotaZInit(0x160uLL);
    v17 = (DirectComposition::CVisualMarshaler *)v16;
    if ( v16 )
    {
      memset((void *)(v16 + 8), 0, 0x158uLL);
