/*
 * XREFs of ?ulDispatchGFPEFunction@XEPALOBJ@@QEAAKW4GFPE_FUNCTION_ID@@K@Z @ 0x1C00547C0
 * Callers:
 ...
 * Callees:
 *     ?ulIndexedGetMatchFromPalentry@@YAKPEAVPALETTE@@K@Z @ 0x1C00548B8 (-ulIndexedGetMatchFromPalentry@@YAKPEAVPALETTE@@K@Z.c)
