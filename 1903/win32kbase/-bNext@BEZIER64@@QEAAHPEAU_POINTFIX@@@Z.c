/*
 * XREFs of ?bNext@BEZIER64@@QEAAHPEAU_POINTFIX@@@Z @ 0x1C0127290
 * Callers:
 *     ?pprFlattenRec@EPATHOBJ@@IEAAPEAU_PATHRECORD@@PEAU2@@Z @ 0x1C007C070 (-pprFlattenRec@EPATHOBJ@@IEAAPEAU_PATHRECORD@@PEAU2@@Z.c)
 * Callees:
 *     ?vBoundBox@@YAXPEAU_POINTFIX@@PEAU_RECTFX@@@Z @ 0x1C007C7C4 (-vBoundBox@@YAXPEAU_POINTFIX@@PEAU_RECTFX@@@Z.c)
 *     ?bIntersect@@YA_NPEAU_RECTFX@@0@Z @ 0x1C012725C (-bIntersect@@YA_NPEAU_RECTFX@@0@Z.c)
 *     ?vInit@HFDBASIS64@@QEAAXJJJJ@Z @ 0x1C01279BC (-vInit@HFDBASIS64@@QEAAXJJJJ@Z.c)
 *     ?vParentError@HFDBASIS64@@QEBAXPEA_J@Z @ 0x1C0127A34 (-vParentError@HFDBASIS64@@QEBAXPEA_J@Z.c)
 *     ?vUntransform@HFDBASIS64@@QEAAXPEAJ@Z @ 0x1C0127A98 (-vUntransform@HFDBASIS64@@QEAAXPEAJ@Z.c)
 */

__int64 __fastcall BEZIER64::bNext(BEZIER64 *this, struct _POINTFIX *a2)
{
  HFDBASIS64 *v4; // r14
  struct _RECTFX *v5; // rdi
  __int64 v6; // rdx
  __int64 v7; // r8
  __int64 v8; // r11
  __int64 v9; // r10
  ...
  *(_QWORD *)&v74.xLeft = 0LL;
  *(_QWORD *)&v74.xRight = 0LL;
  if ( !*((_DWORD *)this + 41) )
  {
...
LABEL_51:
        *((_DWORD *)this + 40) *= 2;
        v37 = *((_QWORD *)this + 11);
        v38 = (v37 + *((_QWORD *)this + 10)) >> 3;
        v39 = *((_QWORD *)this + 9) - v38;
        *((_QWORD *)this + 10) = v38;
        *((_QWORD *)this + 9) = v39 >> 1;
        *((_QWORD *)this + 11) = v37 >> 2;
        v40 = *v33;
        v41 = (*v33 + *((_QWORD *)this + 14)) >> 3;
      ...
      while ( (*((_DWORD *)this + 40) & 1) == 0 )
      {
        ...
        v44 = *((_QWORD *)this + 10);
        *((_QWORD *)this + 11) *= 4LL;
        *((_QWORD *)this + 9) = v44 + 2LL * *((_QWORD *)this + 9);
        *((_QWORD *)this + 10) = 8 * v44 - *((_QWORD *)this + 11);
        v45 = *((_QWORD *)this + 14);
        v46 = *((_QWORD *)this + 13);
        *v33 *= 4LL;
        *((_QWORD *)this + 13) = v45 + 2 * v46;
        *((_QWORD *)this + 14) = 8 * v45 - *v33;
        *((int *)this + 40) >>= 1;
      }
    }
  }
...
LABEL_81:
    *((_DWORD *)this + 41) = 2 * v51;
    v64 = *((_QWORD *)this + 3);
    v65 = (v64 + *((_QWORD *)this + 2)) >> 3;
    v66 = *((_QWORD *)this + 1) - v65;
    *((_QWORD *)this + 2) = v65;
    *((_QWORD *)this + 1) = v66 >> 1;
    *((_QWORD *)this + 3) = v64 >> 2;
    v67 = *((_QWORD *)this + 7);
