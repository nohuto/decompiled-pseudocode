/*
 * XREFs of ?vCopyTo@DC@@QEAAXAEAVXDCOBJ@@@Z @ 0x1C0017B78
 * Callers:
...
void __fastcall DC::vCopyTo(DC *this, struct XDCOBJ *a2)
{
  ...
  struct _BASEOBJECT *v21; // [rsp+28h] [rbp-90h]
  ...
  *v7 = *v9;
  ...
  if ( v13 != v14 )
  {
    if ( v14 )
    {
      ...
      if ( v21 && (*((_DWORD *)v21 + 21) & 1) == 0 )
        HmgDecrementShareReferenceCountEx(v21);
  ...
  *v16 = *v15;
  ...
  {
    *(_QWORD *)(*(_QWORD *)a2 + 296LL) = PALLOCMEM2((unsigned int)(8 * *((_DWORD *)this + 76)), 0x64646147u, 1);
