/*
 * XREFs of ?ProcessMouseEvent@CMouseProcessor@@QEAAXXZ @ 0x1C0032408
 * Callers:
 ...
 *     ?Initialize@CMouseRawInput@CMouseProcessor@@QEAAXAEBVCMouseEvent@2@@Z @ 0x1C0032CC0 (-Initialize@CMouseRawInput@CMouseProcessor@@QEAAXAEBVCMouseEvent@2@@Z.c)
 *     ApiSetEditionForegroundQAccessibleToMouseProducer @ 0x1C0032DD8 (ApiSetEditionForegroundQAccessibleToMouseProducer.c)
 *     ?ComputeUIPIForMouseEvent@CMouseProcessor@@AEAAXPEAURawMouseEvent@1@@Z @ 0x1C0032E94 (-ComputeUIPIForMouseEvent@CMouseProcessor@@AEAAXPEAURawMouseEvent@1@@Z.c)
 *     EtwTraceStopProcessQueuedMouseEvents @ 0x1C0034890 (EtwTraceStopProcessQueuedMouseEvents.c)
 *     ??0RawMouseEvent@CMouseProcessor@@QEAA@XZ @ 0x1C00348B0 (--0RawMouseEvent@CMouseProcessor@@QEAA@XZ.c)
  ...
  while ( 1 )
  {
    ...
    *((_QWORD *)this + 333) = 0LL;
    ...
    if ( dword_1C020FB50 > 4u && TlgKeywordOn((TraceLoggingHProvider)&dword_1C020FB50, 0x40uLL) )
    {
      ...
      TlgCreateSz(&v94, v42);
      TlgWrite((TraceLoggingHProvider)&dword_1C020FB50, &unk_1C01E855B, 0LL, 0LL, 9u, &pData);
    }
      ...
      if ( v43 && (*(int *)(v43 + 24) > 0 || *(_DWORD *)(v67 + 48)) )
      {
        ...
        if ( dword_1C020FB50 > 6u )
        {
          if ( TlgKeywordOn((TraceLoggingHProvider)&dword_1C020FB50, 0x2000uLL) )
          {
            ...
            v96 = &v56;
            v97 = 4LL;
            TlgWrite((TraceLoggingHProvider)&dword_1C020FB50, &unk_1C01E34D7, &ActivityId, 0LL, 3u, &v95);
          }
        }
      }
    }
      ...
      *(GUID *)(v67 + 28) = ActivityId;
      if ( dword_1C020FB50 > 6u )
      {
        if ( TlgKeywordOn((TraceLoggingHProvider)&dword_1C020FB50, 0x2000uLL) )
        {
          ...
          v99 = &v57;
          v100 = 4LL;
          TlgWrite((TraceLoggingHProvider)&dword_1C020FB50, &unk_1C01E3480, &ActivityId, 0LL, 3u, &v98);
          v44 = dword_1C020FB50;
        }
        if ( v44 > 6 && TlgKeywordOn((TraceLoggingHProvider)&dword_1C020FB50, 0x2000uLL) )
        {
          LODWORD(v58) = v68;
          v102 = &v58;
          v103 = 4LL;
          TlgWrite((TraceLoggingHProvider)&dword_1C020FB50, &unk_1C01E34AD, &ActivityId, 0LL, 3u, &v101);
        }
      }
    }
...
LABEL_27:
      ...
      CMouseProcessor::CMouseRawInput::Initialize(
        (CMouseProcessor *)((char *)this + 3200),
      ...
      if ( (unsigned __int8)IsMouseIVEnabled() && (unsigned __int8)isRootPartition() )
        CMouseProcessor::ContainerMouseInputBuffer::CommitStagedChunkInput(
          (CMouseProcessor *)((char *)this + 3632),
          (const struct CMouseProcessor::CMouseEvent *)&v59);
    ...
    else
    {
      ...
      {
        LOBYTE(v30) = 3;
        WPP_RECORDER_SF_((_DWORD)gBaseLog, v30, 6, 15, (__int64)&WPP_a819e7d240c13332848bedce030fc704_Traceguids);
      }
