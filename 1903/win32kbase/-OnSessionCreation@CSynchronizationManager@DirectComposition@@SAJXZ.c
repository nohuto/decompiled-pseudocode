/*
 * XREFs of ?OnSessionCreation@CSynchronizationManager@DirectComposition@@SAJXZ @ 0x1C00A1188
 * Callers:
 *     DCompositionSessionInitialize @ 0x1C00A10A0 (DCompositionSessionInitialize.c)
 * Callees:
