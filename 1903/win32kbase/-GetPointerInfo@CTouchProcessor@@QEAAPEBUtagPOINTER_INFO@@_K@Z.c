/*
 * XREFs of ?GetPointerInfo@CTouchProcessor@@QEAAPEBUtagPOINTER_INFO@@_K@Z @ 0x1C016B030
 * Callers:
 *     <none>
 * Callees:
...
LABEL_18:
    LOBYTE(v4) = 5;
    WPP_RECORDER_SF_(v5->DeviceExtension, v4, 7, v6, (__int64)&WPP_06d7dff703a03015e007562f188a8383_Traceguids);
LABEL_19:
    v12 = 0LL;
    goto LABEL_24;
  }
