/*
 * XREFs of rimOnPnpArrived @ 0x1C00690B0
 * Callers:
 ...
 *     RIMIsTestSigningOn @ 0x1C015CA5C (RIMIsTestSigningOn.c)
        ...
        *(_DWORD *)(v4 + 184) = v14;
        ...
        else
        {
            ...
            && TlgKeywordOn((TraceLoggingHProvider)&hProvider, 0x400000000000uLL) )
          {
            ...
            TlgWrite((TraceLoggingHProvider)&hProvider, &unk_1C01E528B, 0LL, 0LL, 4u, (EVENT_DATA_DESCRIPTOR *)&pData);
          }
        }
LABEL_24:
        if ( WPP_RECORDER_INITIALIZED != (_UNKNOWN *)&WPP_RECORDER_INITIALIZED )
...
LABEL_67:
      ...
      if ( hProvider > 5u && TlgKeywordOn((TraceLoggingHProvider)&hProvider, 0x400000000000uLL) )
      {
        ...
        *(_QWORD *)&pDesc.Size = 8LL;
        v54 = 4LL;
        TlgWrite((TraceLoggingHProvider)&hProvider, &unk_1C01E523A, 0LL, 0LL, 5u, (EVENT_DATA_DESCRIPTOR *)&pData);
      }
      RIMCloseDev(v4);
      RIMFreeDev(a1, v4);
      LOBYTE(v4) = 0;
