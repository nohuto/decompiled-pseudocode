/*
 * XREFs of ?bClone@EPATHOBJ@@QEAAHAEAV1@@Z @ 0x1C00B1260
 * Callers:
 *     <none>
 * Callees:
 *     ?newpathrec@EPATHOBJ@@IEAAHPEAPEAU_PATHRECORD@@PEAKK@Z @ 0x1C007C89C (-newpathrec@EPATHOBJ@@IEAAHPEAPEAU_PATHRECORD@@PEAKK@Z.c)
