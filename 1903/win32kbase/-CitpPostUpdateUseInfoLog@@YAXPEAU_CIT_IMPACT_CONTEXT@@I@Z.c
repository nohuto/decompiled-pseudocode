/*
 * XREFs of ?CitpPostUpdateUseInfoLog@@YAXPEAU_CIT_IMPACT_CONTEXT@@I@Z @ 0x1C0085F30
 * Callers:
 ...
 *     ?CitUpdateInputTypeCoverage@@YAXPEAU_CIT_IMPACT_CONTEXT@@@Z @ 0x1C0086AA4 (-CitUpdateInputTypeCoverage@@YAXPEAU_CIT_IMPACT_CONTEXT@@@Z.c)
...
void __fastcall CitpPostUpdateUseInfoLog(struct _CIT_IMPACT_CONTEXT *a1, int a2)
{
  ...
  if ( *((_WORD *)a1 + 152) )
  {
    ...
    if ( hProvider > 5u && TlgKeywordOn((TraceLoggingHProvider)&hProvider, 0x800000000800uLL) )
    {
      ...
      v160 = 4LL;
      v162 = 4LL;
      TlgWrite((TraceLoggingHProvider)&hProvider, &unk_1C01E8D7C, 0LL, 0LL, 0x2Fu, &pData);
    }
    v36 = *((_DWORD *)a1 + 108);
    ...
    HIDWORD(Data[6]) += v39;
    if ( v174 == 2 || v38 >= dword_1C02187F0 )
    {
      v67 = dword_1C02187F0 / 0x3E8u;
      if ( v40 >= dword_1C02187F0 / 0x3E8u )
        HIDWORD(Data[6]) = dword_1C02187F0 / 0x3E8u - 1;
      if ( (unsigned int)dword_1C020F5A8 > 5 )
      {
        if ( TlgKeywordOn((TraceLoggingHProvider)&dword_1C020F5A8, 0x800000000000uLL) )
        {
          v164 = &v65;
          v166 = &v66;
          v168 = &v47;
          ...
          v173[10] = 8LL;
          v173[12] = 8LL;
          TlgWrite((TraceLoggingHProvider)&dword_1C020F5A8, &unk_1C01E9121, 0LL, 0LL, 0xDu, &v163);
        }
      }
