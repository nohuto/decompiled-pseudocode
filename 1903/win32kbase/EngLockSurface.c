/*
 * XREFs of EngLockSurface @ 0x1C0020240
 * Callers:
...
SURFOBJ *__stdcall EngLockSurface(HSURF hsurf)
{
  ...
  if ( v25 )
  {
       ...
       || (RECALTUNLOCKSTACKBACKTRACE((unsigned __int16)*(_DWORD *)v2), v7 = *(_BYTE *)(v6 + 14), v7 == 5)) )
    {
      ...
      if ( v8 && qword_1C0210538 )
        NSInstrumentation::CReferenceTracker::CReferenceCountedType::ReferenceDereferenceCommon(qword_1C0210538, v8, 0);
    }
    else if ( v7 == 16 )
    {
