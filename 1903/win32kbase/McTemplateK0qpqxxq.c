/*
 * XREFs of McTemplateK0qpqxxq @ 0x1C0110D64
 * Callers:
 ...
 *     EtwTraceDCompDeferBatchEvent @ 0x1C0055A00 (EtwTraceDCompDeferBatchEvent.c)
...
ULONG __fastcall McTemplateK0qpqxxq(
        ...
        char a9)
{
  ...
  v20 = 8LL;
  v22 = 4LL;
  return McGenEventWrite(a1, &DCompDeferBatchEvent, (LPCGUID)&Context.Flags, 7u, &EventData);
}
