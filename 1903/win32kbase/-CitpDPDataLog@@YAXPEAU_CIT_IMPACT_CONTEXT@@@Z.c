/*
 * XREFs of ?CitpDPDataLog@@YAXPEAU_CIT_IMPACT_CONTEXT@@@Z @ 0x1C01C893C
 * Callers:
 ...
 *     ?CitpDPDataSave@@YAJPEAU_CIT_IMPACT_CONTEXT@@@Z @ 0x1C0084638 (-CitpDPDataSave@@YAJPEAU_CIT_IMPACT_CONTEXT@@@Z.c)
 ...
 *     ?CitpDPCalcInit@@YAXPEAU_CIT_DP_CALC_CONTEXT@@NN@Z @ 0x1C01C8854 (-CitpDPCalcInit@@YAXPEAU_CIT_DP_CALC_CONTEXT@@NN@Z.c)
...
void __fastcall CitpDPDataLog(struct _CIT_IMPACT_CONTEXT *a1)
{
  ...
  v1 = (char *)a1 + 552;
  v3 = 0x546000u / BYTE3(qword_1C0218804);
  v4 = 8.0 / (double)BYTE2(qword_1C0218804);
  memset(v73, 0, sizeof(v73));
  CitpDPCalcInit((struct _CIT_DP_CALC_CONTEXT *)v73, v4, (double)(((unsigned int)qword_1C0218804 >> 2) & 0xF) * 0.025);
      ...
      if ( (qword_1C0218804 & 1) != 0 )
      {
        if ( hProvider > 5u )
        {
          ...
          if ( TlgKeywordOn((TraceLoggingHProvider)&hProvider, 0x800000000800uLL) )
          {
            ...
            v135 = &v70;
            v136 = 8LL;
            TlgWrite((TraceLoggingHProvider)&hProvider, &unk_1C01E9AA2, 0LL, 0LL, 0xBu, &pData);
          }
LABEL_13:
          if ( hProvider > 5u )
          {
            if ( TlgKeywordOn((TraceLoggingHProvider)&hProvider, 0x400000000800uLL) )
            {
              ...
              v98 = &v65;
              v93 = 1LL;
              v54 = ((unsigned int)qword_1C0218804 >> 2) & 0xF;
              v100 = &v54;
              v95 = 4LL;
              v102 = &v66;
              v66 = dword_1C0218800 / 0x3E8u;
              v65 = (float)v3;
              v97 = 4LL;
              v104 = &v67;
              v106 = &v72;
              ...
              v116 = &v69;
              TlgWrite((TraceLoggingHProvider)&hProvider, &unk_1C01E956E, 0LL, 0LL, 0x10u, &v89);
            }
          }
        }
      }
      else if ( hProvider > 5u )
      {
        ...
        if ( TlgKeywordOn((TraceLoggingHProvider)&hProvider, 0x400000000800uLL) )
        {
          ...
          v154 = &v71;
          v155 = 8LL;
          TlgWrite((TraceLoggingHProvider)&hProvider, &unk_1C01E9B2B, 0LL, 0LL, 0xBu, &v137);
        }
        goto LABEL_13;
      }
      if ( ++v22 >= 0xB )
