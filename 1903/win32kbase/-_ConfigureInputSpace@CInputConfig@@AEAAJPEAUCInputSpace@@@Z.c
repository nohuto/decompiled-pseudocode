/*
 * XREFs of ?_ConfigureInputSpace@CInputConfig@@AEAAJPEAUCInputSpace@@@Z @ 0x1C0065C58
 * Callers:
 ...
 *     ?Reset@CInputSpace@@QEAAXPEAU1@@Z @ 0x1C0067778 (-Reset@CInputSpace@@QEAAXPEAU1@@Z.c)
