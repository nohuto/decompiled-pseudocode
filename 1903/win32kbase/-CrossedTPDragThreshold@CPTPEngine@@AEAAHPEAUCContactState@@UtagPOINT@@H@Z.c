/*
 * XREFs of ?CrossedTPDragThreshold@CPTPEngine@@AEAAHPEAUCContactState@@UtagPOINT@@H@Z @ 0x1C01944C8
 * Callers:
        ...
        int a4)
{
  ...
  if ( (v4 & 0x10) == 0
    || (*((_DWORD *)this + 815) & 1) != 0
    || (v7 = *((_DWORD *)this + 814), (v7 & 0x2000) != 0)
    || (v7 & 0x1000000) != 0 )
  {
    v8 = 0;
    v12 = 0;
  ...
  if ( *((_DWORD *)this + 742) && *((_QWORD *)a2 + 8) > *((_QWORD *)this + 384) )
    goto LABEL_21;
  v13 = *(_DWORD *)a2;
  if ( (*(_DWORD *)a2 & 0x200000) == 0 )
    goto LABEL_24;
  if ( (v4 & 0x40) != 0 && (int)HIDWORD(*((_QWORD *)a2 + 1)) >= *((_DWORD *)this + 799) && (v13 & 0x100000) != 0 )
  {
    v14 = 276LL;
