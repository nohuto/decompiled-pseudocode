/*
 * XREFs of EtwTraceInputProcessDelay @ 0x1C0035600
 * Callers:
...
LABEL_38:
  ...
  if ( (*(_DWORD *)(v17 + 812) & 0x30) == 0x10 )
  {
    ...
    if ( hProvider > 5u && TlgKeywordOn((TraceLoggingHProvider)&hProvider, 0x400000040000uLL) )
    {
      ...
      v101 = v27;
      v102 = 0;
      TlgWrite((TraceLoggingHProvider)&hProvider, &unk_1C01E3A87, 0LL, 0LL, 0xEu, &pData);
    }
  ...
  else
  {
    ...
    if ( hProvider > 5u && TlgKeywordOn((TraceLoggingHProvider)&hProvider, 0x400000040000uLL) )
    {
      ...
      v74 = v28;
      v75 = 0;
      TlgWrite((TraceLoggingHProvider)&hProvider, &unk_1C01E39CD, 0LL, 0LL, 0xBu, &v54);
    }
  }
  if ( Buffer )
