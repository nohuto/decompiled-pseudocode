/*
 * XREFs of DrvGetSuggestedPhysicalMonitorArraySize @ 0x1C008FF70
 * Callers:
 ...
 *     ?DrvGetNumberOfPhysicalMonitors@@YAJPEAUtagGRAPHICS_DEVICE@@PEAK@Z @ 0x1C008FFF0 (-DrvGetNumberOfPhysicalMonitors@@YAJPEAUtagGRAPHICS_DEVICE@@PEAK@Z.c)
