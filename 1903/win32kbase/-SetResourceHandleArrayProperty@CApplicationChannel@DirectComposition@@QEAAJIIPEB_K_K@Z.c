/*
 * XREFs of ?SetResourceHandleArrayProperty@CApplicationChannel@DirectComposition@@QEAAJIIPEB_K_K@Z @ 0x1C01A6504
 * Callers:
        ...
        unsigned __int64 a5)
{
  ...
  if ( v10 )
  {
    ...
    v11 = (*(__int64 (__fastcall **)(struct DirectComposition::CResourceMarshaler *, _QWORD, __int64, unsigned __int64, char *))(*(_QWORD *)v10 + 160LL))(
            v10,
            a3,
            v5,
            v12,
