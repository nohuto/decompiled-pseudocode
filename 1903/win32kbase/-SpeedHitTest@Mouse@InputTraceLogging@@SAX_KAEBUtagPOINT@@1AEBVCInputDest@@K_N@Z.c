/*
 * XREFs of ?SpeedHitTest@Mouse@InputTraceLogging@@SAX_KAEBUtagPOINT@@1AEBVCInputDest@@K_N@Z @ 0x1C0034984
 * Callers:
  ...
  if ( a6 )
  {
    if ( dword_1C020FB50 > 4u )
    {
      if ( TlgKeywordOn((TraceLoggingHProvider)&dword_1C020FB50, 0x40uLL) )
      {
        ...
        v63 = v20;
        v65 = v20;
        TlgWrite((TraceLoggingHProvider)&dword_1C020FB50, &unk_1C01E7FA9, 0LL, 0LL, 0x11u, &pData);
      }
    }
  }
  else if ( dword_1C020FB50 > 4u && TlgKeywordOn((TraceLoggingHProvider)&dword_1C020FB50, 0x40uLL) )
  {
    v34 = a1;
    v40 = &v34;
    v41 = 8LL;
    ...
    v63 = v27;
    v65 = v27;
    TlgWrite((TraceLoggingHProvider)&dword_1C020FB50, &unk_1C01E8091, 0LL, 0LL, 0x11u, &pData);
  }
}
