/*
 * XREFs of ?InitializeThreadInfoIocp@@YAJPEAU_EPROCESS@@PEAUtagTHREADINFO@@@Z @ 0x1C000FD78
 * Callers:
...
__int64 __fastcall InitializeThreadInfoIocp(struct _EPROCESS *a1, void **a2)
{
  ...
  *(_QWORD *)&v10.Attributes = 512LL;
  v10.RootDirectory = 0LL;
  v10.ObjectName = 0LL;
  *(_OWORD *)&v10.SecurityDescriptor = 0LL;
  v5 = ZwCreateIoCompletion(a2 + 178, 0x1F0003u, &v10, 0);
  if ( v5 < 0 )
  {
    *v2 = 0LL;
  ...
  v6 = a2 + 179;
  v9 = 0;
  v5 = ObDuplicateObject(a1, *v2, a1, a2 + 179, 0, 0, 2, v9);
  if ( v5 < 0 )
    goto LABEL_11;
  ...
  v6 = a2 + 181;
  v5 = ZwCreateWaitCompletionPacket(a2 + 181, 1LL, &v10);
  if ( v5 < 0 )
  {
LABEL_11:
    *v6 = 0LL;
  ...
  return (unsigned int)ZwAssociateWaitCompletionPacket(*v6, *v2, a2[180], 0LL, 1LL, 0, 0LL, 0LL);
}
