/*
 * XREFs of ?ReleaseAllReferences@CExpressionMarshaler@DirectComposition@@MEAAXPEAVCApplicationChannel@2@@Z @ 0x1C0082960
 * Callers:
 *     <none>
 * Callees:
    ...
    if ( *((_DWORD *)this + 46) )
    {
      do
      {
        DirectComposition::CApplicationChannel::ReleaseWeakReference(
          a2,
          *(struct DirectComposition::CWeakReferenceBase **)(*((_QWORD *)this + 22) + 8 * v5));
        v5 = (unsigned int)(v5 + 1);
      }
      while ( (unsigned int)v5 < *((_DWORD *)this + 46) );
      v4 = *((_QWORD *)this + 22);
    }
    Win32FreePool(v4);
    *((_QWORD *)this + 22) = 0LL;
