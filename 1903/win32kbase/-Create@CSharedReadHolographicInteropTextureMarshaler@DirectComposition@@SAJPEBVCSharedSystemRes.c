/*
 * XREFs of ?Create@CSharedReadHolographicInteropTextureMarshaler@DirectComposition@@SAJPEBVCSharedSystemResource@2@PEAPEAV12@@Z @ 0x1C01C67A4
 * Callers:
 *     CreateSharedReadHolographicInteropTextureMarshaler @ 0x1C01C68E0 (CreateSharedReadHolographicInteropTextureMarshaler.c)
 * Callees:
        ...
        struct DirectComposition::CSharedReadHolographicInteropTextureMarshaler **a2)
{
  ...
  if ( v5 )
  {
    v6 = (*(__int64 (__fastcall **)(struct DirectComposition::CSharedReadHolographicInteropTextureMarshaler *, const struct DirectComposition::CSharedSystemResource *))(*(_QWORD *)v5 + 248LL))(
           v5,
           a1);
    if ( v6 < 0 )
    {
      (*(void (__fastcall **)(struct DirectComposition::CSharedReadHolographicInteropTextureMarshaler *, __int64))(*(_QWORD *)v5 + 104LL))(
        v5,
        1LL);
      v5 = 0LL;
    }
