/*
 * XREFs of xxxDisplayDiagBlackScreenDetected @ 0x1C010B4F0
 * Callers:
...
void __fastcall xxxDisplayDiagBlackScreenDetected(int a1, char a2, char a3, __int128 *a4, int *a5)
{
      ...
      *(GUID *)(v162 + 28) = pActivityId;
      if ( dword_1C020FB50 > 6u )
      {
        if ( TlgKeywordOn((TraceLoggingHProvider)&dword_1C020FB50, 0x2000uLL) )
        {
          ...
          v201 = &v146;
          v202 = 4LL;
          TlgWrite((TraceLoggingHProvider)&dword_1C020FB50, &unk_1C01E3480, &pActivityId, 0LL, 3u, &v200);
          v21 = dword_1C020FB50;
        }
        if ( v21 > 6 && TlgKeywordOn((TraceLoggingHProvider)&dword_1C020FB50, 0x2000uLL) )
        {
          ...
          v204 = &v147;
          v205 = 4LL;
          TlgWrite((TraceLoggingHProvider)&dword_1C020FB50, &unk_1C01E34AD, &pActivityId, 0LL, 3u, &v203);
        }
      }
    }
  ...
  if ( !gProtocolType )
  {
    ...
    if ( a2 )
    {
      ...
      xmmword_1C02199E0 = *(_OWORD *)&v175[1];
      v9 = 0;
        ...
        if ( v49 && (*(int *)(v49 + 24) > 0 || *(_DWORD *)(v165 + 48)) )
        {
          ...
          if ( dword_1C020FB50 > 6u )
          {
            if ( TlgKeywordOn((TraceLoggingHProvider)&dword_1C020FB50, 0x2000uLL) )
            {
              ...
              v207 = &v148;
              v208 = 4LL;
              TlgWrite((TraceLoggingHProvider)&dword_1C020FB50, &unk_1C01E34D7, &v167, 0LL, 3u, &v206);
            }
          }
        }
      }
        ...
        *(GUID *)(v165 + 28) = v167;
        if ( dword_1C020FB50 > 6u )
        {
          if ( TlgKeywordOn((TraceLoggingHProvider)&dword_1C020FB50, 0x2000uLL) )
          {
            ...
            v210 = &v149;
            v211 = 4LL;
            TlgWrite((TraceLoggingHProvider)&dword_1C020FB50, &unk_1C01E3480, &v167, 0LL, 3u, &v209);
            v57 = dword_1C020FB50;
          }
          if ( v57 > 6 && TlgKeywordOn((TraceLoggingHProvider)&dword_1C020FB50, 0x2000uLL) )
          {
            ...
            v213 = &v150;
            v214 = 4LL;
            TlgWrite((TraceLoggingHProvider)&dword_1C020FB50, &unk_1C01E34AD, &v167, 0LL, 3u, &v212);
          }
        }
      }
      EtwTraceAcquiredExclusiveUserCrit();
    ...
    if ( a3 )
    {
        ...
        if ( v79 && (*(int *)(v79 + 24) > 0 || *(_DWORD *)(v168 + 48)) )
        {
          ...
          if ( dword_1C020FB50 > 6u )
          {
            if ( TlgKeywordOn((TraceLoggingHProvider)&dword_1C020FB50, 0x2000uLL) )
            {
              ...
              v216 = &v151;
              v217 = 4LL;
              TlgWrite((TraceLoggingHProvider)&dword_1C020FB50, &unk_1C01E34D7, &v170, 0LL, 3u, &v215);
            }
          }
        }
      }
        ...
        *(GUID *)(v168 + 28) = v170;
        if ( dword_1C020FB50 > 6u )
        {
          if ( TlgKeywordOn((TraceLoggingHProvider)&dword_1C020FB50, 0x2000uLL) )
          {
            ...
            v219 = &v152;
            v220 = 4LL;
            TlgWrite((TraceLoggingHProvider)&dword_1C020FB50, &unk_1C01E3480, &v170, 0LL, 3u, &v218);
            v87 = dword_1C020FB50;
          }
          if ( v87 > 6 && TlgKeywordOn((TraceLoggingHProvider)&dword_1C020FB50, 0x2000uLL) )
          {
            v153 = v169;
            v222 = &v153;
            v223 = 4LL;
            TlgWrite((TraceLoggingHProvider)&dword_1C020FB50, &unk_1C01E34AD, &v170, 0LL, 3u, &v221);
          }
        }
      }
      EtwTraceAcquiredExclusiveUserCrit();
      ...
      *(_OWORD *)&v175[1] = xmmword_1C02199E0;
      if ( v75 >= 0 )
      {
            ...
            if ( v114 && (*(int *)(v114 + 24) > 0 || *(_DWORD *)(v171 + 48)) )
            {
              ...
              if ( dword_1C020FB50 > 6u )
              {
                if ( TlgKeywordOn((TraceLoggingHProvider)&dword_1C020FB50, 0x2000uLL) )
                {
                  ...
                  v225 = &v154;
                  v226 = 4LL;
                  TlgWrite((TraceLoggingHProvider)&dword_1C020FB50, &unk_1C01E34D7, &v173, 0LL, 3u, &v224);
                }
              }
            }
          }
            ...
            *(GUID *)(v171 + 28) = v173;
            if ( dword_1C020FB50 > 6u )
            {
              if ( TlgKeywordOn((TraceLoggingHProvider)&dword_1C020FB50, 0x2000uLL) )
              {
                ...
                v228 = &v155;
                v229 = 4LL;
                TlgWrite((TraceLoggingHProvider)&dword_1C020FB50, &unk_1C01E3480, &v173, 0LL, 3u, &v227);
                v122 = dword_1C020FB50;
              }
              if ( v122 > 6 && TlgKeywordOn((TraceLoggingHProvider)&dword_1C020FB50, 0x2000uLL) )
              {
                v156 = v172;
                v231 = &v156;
                v232 = 4LL;
                TlgWrite((TraceLoggingHProvider)&dword_1C020FB50, &unk_1C01E34AD, &v173, 0LL, 3u, &v230);
              }
            }
          }
          EtwTraceAcquiredExclusiveUserCrit();
  ...
  v141 = v158[3];
  if ( a3 && dword_1C020F458 > 5u && TlgKeywordOn((TraceLoggingHProvider)&dword_1C020F458, 0x400000000008uLL) )
  {
    v178 = 2LL;
    v144 = 4;
    v177 = &v144;
    ...
    v194[1] = 0;
    v196 = 4LL;
    TlgWrite((TraceLoggingHProvider)&dword_1C020F458, &unk_1C01E36C2, (LPCGUID)&v175[1], 0LL, 0xCu, &v176);
    v141 = v158[3];
  }
  if ( v141 )
    Win32FreePool(v141);
