/*
 * XREFs of GreSfmCleanupPresentHistory @ 0x1C00AC140
 * Callers:
...
void GreSfmCleanupPresentHistory()
{
  ...
  v7 = 0LL;
  LOBYTE(v1) = 1;
  if ( (int)((__int64 (__fastcall *)(_DWORD *, _QWORD, __int64, _QWORD))qword_1C0215058)(v6, 0LL, v1, 0LL) >= 0 )
  {
    v2 = v6[0];
    if ( v6[0] )
    {
      if ( v6[0] <= 8u || (v0 = PALLOCMEM2((unsigned int)(20 * v6[0]), 0x706D7447u, 1)) != 0LL )
      {
        ...
        v7 = v0;
        LOBYTE(v3) = 1;
        if ( (int)((__int64 (__fastcall *)(_DWORD *, _QWORD, __int64, _QWORD))qword_1C0215058)(v6, 0LL, v3, 0LL) >= 0
          && v6[0]
          && v6[0] <= (unsigned int)v2 )
        {
          ...
          do
          {
            ...
            v5 = 0;
            v5 = *(_DWORD *)&v7[20 * v4];
            ((void (__fastcall *)(int *, _QWORD))qword_1C0215068)(&v5, 0LL);
