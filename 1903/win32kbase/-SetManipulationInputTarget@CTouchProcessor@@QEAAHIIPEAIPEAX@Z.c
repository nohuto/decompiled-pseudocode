/*
 * XREFs of ?SetManipulationInputTarget@CTouchProcessor@@QEAAHIIPEAIPEAX@Z @ 0x1C0172044
 * Callers:
        ...
        void *a5)
{
  ...
  if ( !v9 )
  {
    ...
    {
      LOBYTE(v10) = 2;
      WPP_RECORDER_SF_((_DWORD)gBaseLog, v10, 7, 84, (__int64)&WPP_06d7dff703a03015e007562f188a8383_Traceguids);
    }
