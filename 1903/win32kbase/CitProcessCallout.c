/*
 * XREFs of CitProcessCallout @ 0x1C00372CC
 * Callers:
 ...
 *     ?CitpInteractionSummaryGetOutstanding@@YAPEAU_CIT_INTERACTION_SUMMARY@@PEAU_CIT_PROCESS@@G@Z @ 0x1C01C92D0 (-CitpInteractionSummaryGetOutstanding@@YAPEAU_CIT_INTERACTION_SUMMARY@@PEAU_CIT_PROCESS@@G@Z.c)
 */
...
void __fastcall CitProcessCallout(__int64 a1, char a2)
{
  ...
  if ( a2 )
  {
    *(_QWORD *)(a1 + 920) = 52976LL;
    ...
    if ( qword_1C0218810 && !*((_QWORD *)qword_1C0218810 + 12) )
    {
...
LABEL_28:
      ...
      if ( v9 != *(_QWORD *)&DOUBLE_0_0 )
        CitpContextUserLogon(qword_1C0218810, &v11);
    }
  }
  else
  {
    ...
    if ( CitpProcessInfoIsValid((struct _CIT_PROCESS *)v3) )
    {
      ...
      if ( qword_1C0218810 )
      {
        if ( a1 == *((_QWORD *)qword_1C0218810 + 15) )
