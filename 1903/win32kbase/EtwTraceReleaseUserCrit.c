/*
 * XREFs of EtwTraceReleaseUserCrit @ 0x1C0029F60
 * Callers:
...
char EtwTraceReleaseUserCrit()
{
  ...
  if ( CurrentThreadWin32Thread )
  {
    ...
    _InterlockedIncrement64(&qword_1C0215520[v4 + 30]);
LABEL_9:
    v5 = _InterlockedExchangeAdd64(&qword_1C0215698, CurrentThreadWin32Thread);
    _InterlockedIncrement64(&qword_1C02156B0);
    if ( (W32kEtwEnabledKeyword & 0x200000010000000LL) != 0 )
    {
      LOBYTE(CurrentThreadWin32Thread) = byte_1C020F438 - 1;
      if ( (unsigned __int8)(byte_1C020F438 - 1) > 2u && (qword_1C020F420 & 0x200000010000000LL) != 0 )
      {
        LOBYTE(CurrentThreadWin32Thread) = 0;
        if ( (qword_1C020F428 & 0x200000010000000LL) == qword_1C020F428 )
        {
