/*
 * XREFs of ?ReleaseAllReferences@CGenericMarshaler@DirectComposition@@UEAAXPEAVCApplicationChannel@2@@Z @ 0x1C01B0050
 * Callers:
 *     <none>
 * Callees:
        ...
        struct DirectComposition::CApplicationChannel *a2)
{
  ...
  v2 = (DirectComposition::CReferenceProperty **)*((_QWORD *)this + 6);
  v4 = &v2[*((_QWORD *)this + 7)];
  while ( v2 != v4 )
  {
    v5 = *v2;
