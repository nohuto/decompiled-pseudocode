/*
 * XREFs of ?MarshalSend@SendProcessor@Calling@CoreMessaging@@QEAAJPEAXIPEAD@Z @ 0x1C005F2D4
 * Callers:
...
LABEL_46:
  ...
  *(_DWORD *)v8 = *((_DWORD *)this + 34);
  *((_WORD *)v8 + 2) = *((_WORD *)this + 70);
  *((_WORD *)v8 + 3) = *((_WORD *)this + 71);
  *((_DWORD *)this + 31) = 0;
  v9 = *((_DWORD *)this + 20) == 0;
  v10 = *(char **)this;
