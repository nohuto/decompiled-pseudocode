/*
 * XREFs of ?CreateSurfacePal@@YAHVXEPALOBJ@@KKK@Z @ 0x1C0132BF8
 * Callers:
...
__int64 __fastcall CreateSurfacePal(__int64 a1, __int64 a2, unsigned int a3, unsigned int a4)
{
  ...
  v26 = 0;
  v25 = 0LL;
  Palette = PALMEMOBJ::bCreatePalette((PALMEMOBJ *)&v25, v4 & 0x1F, v8, v6, 0, 0, 0, 0x800u, 1);
  if ( Palette )
  {
    v11 = a3 >> 1;
