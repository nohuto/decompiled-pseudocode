/*
 * XREFs of ?QueueFrame@RIM@InputTraceLogging@@SAXPEBURIMDEV@@PEBURIMCOMPLETEFRAME@@@Z @ 0x1C01526B0
 * Callers:
...
void __fastcall InputTraceLogging::RIM::QueueFrame(const struct RIMDEV *a1, const struct RIMCOMPLETEFRAME *a2)
{
  ...
  if ( dword_1C020FB50 > 4u )
  {
    if ( TlgKeywordOn((TraceLoggingHProvider)&dword_1C020FB50, 0x100uLL) )
    {
      ...
      v33 = &v10;
      v34 = 4;
      TlgWrite((TraceLoggingHProvider)&dword_1C020FB50, &unk_1C01E57BD, 0LL, 0LL, 9u, &pData);
    }
  }
}
