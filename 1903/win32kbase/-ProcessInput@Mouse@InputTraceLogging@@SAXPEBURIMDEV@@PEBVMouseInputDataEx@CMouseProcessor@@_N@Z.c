/*
 * XREFs of ?ProcessInput@Mouse@InputTraceLogging@@SAXPEBURIMDEV@@PEBVMouseInputDataEx@CMouseProcessor@@_N@Z @ 0x1C0032BDC
 * Callers:
        ...
        const struct CMouseProcessor::MouseInputDataEx *a2)
{
  ...
  if ( dword_1C020FB50 > 4u )
  {
    if ( TlgKeywordOn((TraceLoggingHProvider)&dword_1C020FB50, 0x40uLL) )
    {
      ...
      v33 = 4LL;
      v35 = 4LL;
      TlgWrite((TraceLoggingHProvider)&dword_1C020FB50, &unk_1C01E85C9, 0LL, 0LL, 0xCu, &pData);
    }
  }
}
