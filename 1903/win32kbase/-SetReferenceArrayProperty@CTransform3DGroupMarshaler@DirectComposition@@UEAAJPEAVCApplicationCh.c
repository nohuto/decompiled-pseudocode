/*
 * XREFs of ?SetReferenceArrayProperty@CTransform3DGroupMarshaler@DirectComposition@@UEAAJPEAVCApplicationChannel@2@IPEAPEAVCResourceMarshaler@2@_KPEA_N@Z @ 0x1C01BC2D0
 * Callers:
 *     <none>
 * Callees:
        ...
        bool *a6)
{
  ...
  *a6 = 0;
  if ( a3 )
    return 3221225485LL;
  result = DirectComposition::CResourceMarshalerArray::Set((__int64)this + 56, a2, (__int64)a4, a5, 0xB4u);
  if ( (int)result >= 0 )
  {
    *((_DWORD *)this + 20) = 0;
    *((_DWORD *)this + 4) |= 0x80u;
