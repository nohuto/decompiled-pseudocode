/*
 * XREFs of ?Create@CSharedWriteCaptureControllerMarshaler@DirectComposition@@SAJPEBVCSharedSystemResource@2@PEAPEAV12@@Z @ 0x1C01C6B6C
 * Callers:
 *     CreateSharedWriteCaptureControllerMarshaler @ 0x1C01C6CB0 (CreateSharedWriteCaptureControllerMarshaler.c)
 * Callees:
