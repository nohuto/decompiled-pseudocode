/*
 * XREFs of ?ReleaseAllReferences@CInteractionTrackerMarshaler@DirectComposition@@MEAAXPEAVCApplicationChannel@2@@Z @ 0x1C01AC8E0
 * Callers:
 *     <none>
 * Callees:
        ...
        struct DirectComposition::CApplicationChannel *a2)
{
  ...
  v4 = (struct DirectComposition::CWeakReferenceBase **)((char *)this + 304);
  v5 = 3LL;
  do
  {
    if ( *v4 )
  ...
  while ( v7 );
  v9 = (struct DirectComposition::CWeakReferenceBase *)*((_QWORD *)this + 24);
  if ( v9 )
  {
    DirectComposition::CApplicationChannel::ReleaseWeakReference(a2, v9);
    *((_QWORD *)this + 24) = 0LL;
  }
  v10 = (struct DirectComposition::CWeakReferenceBase *)*((_QWORD *)this + 25);
  if ( v10 )
  {
    DirectComposition::CApplicationChannel::ReleaseWeakReference(a2, v10);
    *((_QWORD *)this + 25) = 0LL;
  }
  v11 = (DirectComposition::CInteractionTrackerBindingManagerMarshaler *)*((_QWORD *)this + 50);
  if ( v11 )
  {
    DirectComposition::CInteractionTrackerBindingManagerMarshaler::RemoveTrackerBindings(v11, *((_DWORD *)this + 6));
    DirectComposition::CApplicationChannel::ReleaseResource(
      a2,
