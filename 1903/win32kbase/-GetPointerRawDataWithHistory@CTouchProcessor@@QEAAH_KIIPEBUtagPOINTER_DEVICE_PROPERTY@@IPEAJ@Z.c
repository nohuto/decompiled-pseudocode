/*
 * XREFs of ?GetPointerRawDataWithHistory@CTouchProcessor@@QEAAH_KIIPEBUtagPOINTER_DEVICE_PROPERTY@@IPEAJ@Z @ 0x1C016BE40
 * Callers:
        ...
        char *a7)
{
  ...
  if ( a6 < a4 )
  {
    if ( WPP_RECORDER_INITIALIZED == (_UNKNOWN *)&WPP_RECORDER_INITIALIZED )
      goto LABEL_12;
    LOBYTE(v10) = 3;
    WPP_RECORDER_SF_((_DWORD)gBaseLog, v10, 7, 133, (__int64)&WPP_06d7dff703a03015e007562f188a8383_Traceguids);
    if ( WPP_RECORDER_INITIALIZED == (_UNKNOWN *)&WPP_RECORDER_INITIALIZED )
      goto LABEL_12;
...
LABEL_11:
    LOBYTE(v13) = 5;
    WPP_RECORDER_SF_(v14->DeviceExtension, v13, 7, v15, (__int64)&WPP_06d7dff703a03015e007562f188a8383_Traceguids);
LABEL_12:
    CInpLockGuardShared::~CInpLockGuardShared(v49);
    return 0LL;
  }
  if ( !v9 )
  {
    if ( WPP_RECORDER_INITIALIZED == (_UNKNOWN *)&WPP_RECORDER_INITIALIZED )
      goto LABEL_12;
    LOBYTE(v10) = 3;
    WPP_RECORDER_SF_((_DWORD)gBaseLog, v10, 7, 135, (__int64)&WPP_06d7dff703a03015e007562f188a8383_Traceguids);
    if ( WPP_RECORDER_INITIALIZED == (_UNKNOWN *)&WPP_RECORDER_INITIALIZED )
      goto LABEL_12;
    v14 = WPP_GLOBAL_Control;
    if ( !LOWORD(WPP_GLOBAL_Control->DeviceType) )
  ...
  if ( !FrameById )
  {
    if ( WPP_RECORDER_INITIALIZED == (_UNKNOWN *)&WPP_RECORDER_INITIALIZED )
      goto LABEL_12;
    LOBYTE(v17) = 3;
    WPP_RECORDER_SF_((_DWORD)gBaseLog, v17, 7, 137, (__int64)&WPP_06d7dff703a03015e007562f188a8383_Traceguids);
    if ( WPP_RECORDER_INITIALIZED == (_UNKNOWN *)&WPP_RECORDER_INITIALIZED )
      goto LABEL_12;
    v14 = WPP_GLOBAL_Control;
    if ( !LOWORD(WPP_GLOBAL_Control->DeviceType) )
...
LABEL_33:
  if ( *((void **)FrameById + 8) == TouchExtensibility::hDeviceUser )
  {
    ...
    {
      LOBYTE(v30) = 4;
      WPP_RECORDER_SF_((_DWORD)gBaseLog, (_DWORD)v30, 7, 140, (__int64)&WPP_06d7dff703a03015e007562f188a8383_Traceguids);
    }
    memset(a7, 0, Size);
    if ( WPP_RECORDER_INITIALIZED == (_UNKNOWN *)&WPP_RECORDER_INITIALIZED )
      goto LABEL_65;
  ...
  LOBYTE(v30) = 5;
  WPP_RECORDER_SF_(v31->DeviceExtension, (_DWORD)v30, 7, v32, (__int64)&WPP_06d7dff703a03015e007562f188a8383_Traceguids);
LABEL_65:
  CInpLockGuardShared::~CInpLockGuardShared(v49);
