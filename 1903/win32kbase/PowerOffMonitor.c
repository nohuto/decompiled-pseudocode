/*
 * XREFs of PowerOffMonitor @ 0x1C00B8460
 * Callers:
          ...
          *(GUID *)(v53 + 28) = ActivityId;
          if ( dword_1C020FB50 > 6u )
          {
            if ( TlgKeywordOn((TraceLoggingHProvider)&dword_1C020FB50, 0x2000uLL) )
            {
              ...
              v60 = &v48;
              v61 = 4LL;
              TlgWrite((TraceLoggingHProvider)&dword_1C020FB50, &unk_1C01E3480, &ActivityId, 0LL, 3u, &v59);
              v37 = dword_1C020FB50;
            }
            if ( v37 > 6 && TlgKeywordOn((TraceLoggingHProvider)&dword_1C020FB50, 0x2000uLL) )
            {
              ...
              v63 = &v49;
              v64 = 4LL;
              TlgWrite((TraceLoggingHProvider)&dword_1C020FB50, &unk_1C01E34AD, &ActivityId, 0LL, 3u, &v62);
            }
          }
        }
