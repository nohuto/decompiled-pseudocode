/*
 * XREFs of OpenCacheKeyEx @ 0x1C0011680
 * Callers:
 ...
 *     FastWriteProfileStringW @ 0x1C00A72A0 (FastWriteProfileStringW.c)
...
LABEL_7:
      *(_DWORD *)&Destination.Length = 0x2000000;
      ...
      {
        if ( *off_1C01D3A40[dword_1C01D3690[4 * v4]] == 77 )
        {
          RtlAppendUnicodeToString(&Destination, L"\\Registry\\Machine\\");
        }
        else
      ...
      v12 &= v14;
      RtlAppendUnicodeToString(&Destination, off_1C01D3A40[dword_1C01D3690[4 * v4]] + 1);
      RtlAppendUnicodeToString(&Destination, (&off_1C01D3698)[2 * v4]);
