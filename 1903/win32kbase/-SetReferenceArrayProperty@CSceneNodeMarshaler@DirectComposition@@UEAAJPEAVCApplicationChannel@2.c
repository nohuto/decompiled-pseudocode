/*
 * XREFs of ?SetReferenceArrayProperty@CSceneNodeMarshaler@DirectComposition@@UEAAJPEAVCApplicationChannel@2@IPEAPEAVCResourceMarshaler@2@_KPEA_N@Z @ 0x1C01BC240
 * Callers:
 *     <none>
 * Callees:
        ...
        bool *a6)
{
  ...
  *a6 = 0;
  if ( !a3 )
  {
    result = DirectComposition::CResourceMarshalerArray::Set((__int64)this + 40, a2, (__int64)a4, a5, 0x9Eu);
    if ( (int)result < 0 )
      return result;
    *((_DWORD *)this + 16) = 0;
    *((_DWORD *)this + 4) |= 0x20u;
  ...
  if ( a3 != 1 )
    return 3221225485LL;
  result = DirectComposition::CResourceMarshalerArray::Set((__int64)this + 72, a2, (__int64)a4, a5, 0x97u);
  if ( (int)result >= 0 )
  {
    *((_DWORD *)this + 24) = 0;
    *((_DWORD *)this + 4) |= 0x40u;
