/*
 * XREFs of RIMIDECreateDeviceInstancePath @ 0x1C014897C
 * Callers:
...
__int64 RIMIDECreateDeviceInstancePath()
{
  ...
  if ( !isChildPartition() )
  {
    if ( v4 )
    {
      ...
      v9 = RtlUnicodeStringPrintf(v3, L"\\??\\Microsoft Keyboard RID\\%u", (unsigned int)dword_1C02198F4);
    }
    else
    {
      v9 = RtlUnicodeStringPrintf(v3, L"\\??\\Microsoft Mouse RID\\%u", (unsigned int)dword_1C02198F4);
    }
LABEL_20:
    v0 = v9;
    if ( v9 >= 0 )
  ...
  {
    case 0:
      v9 = RtlUnicodeStringPrintf(v3, L"\\??\\Microsoft Mouse RID\\c\\%u", (unsigned int)dword_1C02198F4);
      goto LABEL_20;
    case 1:
      v9 = RtlUnicodeStringPrintf(v3, L"\\??\\Microsoft Keyboard RID\\c\\%u", (unsigned int)dword_1C02198F4);
      goto LABEL_20;
    case 2:
      v6 = v2;
      v7 = (unsigned __int16)v1;
...
LABEL_9:
      v9 = RtlUnicodeStringPrintf(v3, v8, v7, v6, dword_1C02198F4);
      goto LABEL_20;
  }
  if ( WPP_RECORDER_INITIALIZED != (_UNKNOWN *)&WPP_RECORDER_INITIALIZED )
  {
