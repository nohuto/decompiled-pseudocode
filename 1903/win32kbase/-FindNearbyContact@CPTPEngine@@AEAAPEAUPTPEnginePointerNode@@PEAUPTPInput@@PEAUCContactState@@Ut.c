/*
 * XREFs of ?FindNearbyContact@CPTPEngine@@AEAAPEAUPTPEnginePointerNode@@PEAUPTPInput@@PEAUCContactState@@UtagPOINT@@K@Z @ 0x1C0196900
 * Callers:
        ...
        unsigned int a5)
{
  ...
  while ( 1 )
  {
    v10 = (CPTPEngine *)((char *)this + 296 * (*((_DWORD *)v6 + 1) % v9) + 1160);
    if ( v10 != a3
