/*
 * XREFs of ?ProcessMouseButton@CMouseProcessor@@AEAAXAEBVCButtonEvent@1@@Z @ 0x1C0041208
 * Callers:
        ...
        const struct CMouseProcessor::CButtonEvent *a2)
{
  ...
  {
    LOBYTE(a2) = 4;
    WPP_RECORDER_SF_((_DWORD)gBaseLog, (_DWORD)a2, 6, 22, (__int64)&WPP_a819e7d240c13332848bedce030fc704_Traceguids);
  }
  v4 = *((_QWORD *)v2 + 1);
  v5 = *(_DWORD *)(v4 + 132);
  v6 = *(_DWORD *)(v4 + 100);
    ...
    if ( v6 != 1 )
    {
      *(_QWORD *)&v120.Type = v110;
      ...
      if ( !(unsigned int)ApiSetEditionForegroundQAccessibleToMouseProducer(&v120, v7, 0LL) )
      {
        ...
        {
          LOBYTE(v7) = 3;
          WPP_RECORDER_SF_((_DWORD)gBaseLog, v7, 6, 23, (__int64)&WPP_a819e7d240c13332848bedce030fc704_Traceguids);
        }
        v75 = 14LL;
LABEL_64:
  ...
  if ( !*((_QWORD *)v2 + 5) )
  {
    ...
    {
      LOBYTE(v7) = 3;
      WPP_RECORDER_SF_((_DWORD)gBaseLog, v7, 6, 24, (__int64)&WPP_a819e7d240c13332848bedce030fc704_Traceguids);
    }
    v75 = 15LL;
    goto LABEL_64;
  }
...
LABEL_8:
      ...
      if ( (v15 & 0x80u) == 0LL && CBaseProcessor::IsUMSuppressed(this) )
      {
        ...
        {
          LOBYTE(v13) = 4;
          WPP_RECORDER_SF_((_DWORD)gBaseLog, v13, 6, 27, (__int64)&WPP_a819e7d240c13332848bedce030fc704_Traceguids);
        }
        v75 = 4LL;
        goto LABEL_64;
      }
      ...
      if ( dword_1C020FB50 > 4u && TlgKeywordOn((TraceLoggingHProvider)&dword_1C020FB50, 0x40uLL) )
      {
        ...
        v146 = 8LL;
        TlgWrite((TraceLoggingHProvider)&dword_1C020FB50, &unk_1C01E8397, 0LL, 0LL, 7u, &pData);
      }
      v126 = v12;
                           ...
                           v22 & 1) )
      {
        ...
        {
          LOBYTE(v24) = 4;
          WPP_RECORDER_SF_((_DWORD)gBaseLog, v24, 6, 28, (__int64)&WPP_a819e7d240c13332848bedce030fc704_Traceguids);
        }
      ...
      CMouseProcessor::CMouseRawInput::PostRawMouse((char *)this + 3200, 0LL, 3LL);
      if ( anonymous_namespace_::InMouseRawInputMode(0LL, 1LL, 0LL) )
      {
        ...
        *(_OWORD *)&v120.DeviceQueue.Busy = v89;
        ...
        if ( v134[0] )
        {
          ...
          {
            LOBYTE(v94) = 4;
            WPP_RECORDER_SF_((_DWORD)gBaseLog, v94, 6, 29, (__int64)&WPP_a819e7d240c13332848bedce030fc704_Traceguids);
          }
      ...
      if ( !LODWORD(v122[0]) )
      {
        ...
        {
          LOBYTE(v25) = 3;
          WPP_RECORDER_SF_((_DWORD)gBaseLog, v25, 6, 30, (__int64)&WPP_a819e7d240c13332848bedce030fc704_Traceguids);
        }
        v97 = 13LL;
        goto LABEL_135;
      }
      ...
      if ( _InterlockedCompareExchange((volatile signed __int32 *)this + 860, 1, 1) )
      {
        ...
        if ( *((_DWORD *)v2 + 8) == 1 )
        {
          ...
          *((_DWORD *)this + 827) |= v99;
          CInputDest::operator=(v122, (char *)this + 3312);
        }
        else
        {
      ...
      else if ( *((_DWORD *)v2 + 8) == 1 )
      {
                ...
                ButtonMessage) )
        {
          ...
          {
            LOBYTE(v33) = 3;
            WPP_RECORDER_SF_((_DWORD)gBaseLog, v33, 6, 31, (__int64)&WPP_a819e7d240c13332848bedce030fc704_Traceguids);
          }
          v97 = 17LL;
          goto LABEL_135;
        }
...
LABEL_126:
          LOBYTE(v36) = 3;
          WPP_RECORDER_SF_((_DWORD)gBaseLog, v36, 6, v100, (__int64)&WPP_a819e7d240c13332848bedce030fc704_Traceguids);
          goto LABEL_127;
        }
        if ( v27 )
        {
        ...
        if ( anonymous_namespace_::InMouseRawInputMode((__int64)v122, 1LL, 1LL) )
        {
          ...
          {
            LOBYTE(v43) = 3;
            WPP_RECORDER_SF_((_DWORD)gBaseLog, v43, 6, 35, (__int64)&WPP_a819e7d240c13332848bedce030fc704_Traceguids);
          }
          v97 = 12LL;
          goto LABEL_135;
        }
              ...
              (unsigned int)ApiSetEditionReportMouseBreakToAccessibility(v122, v65, &v120.CurrentIrp, (v66 >> 7) & 1)) )
        {
          ...
          {
            LOBYTE(v44) = 4;
            WPP_RECORDER_SF_((_DWORD)gBaseLog, v44, 6, 37, (__int64)&WPP_a819e7d240c13332848bedce030fc704_Traceguids);
          }
          goto LABEL_48;
        }
        if ( WPP_RECORDER_INITIALIZED != (_UNKNOWN *)&WPP_RECORDER_INITIALIZED )
...
LABEL_141:
      ...
      {
        LOBYTE(v36) = 3;
        WPP_RECORDER_SF_((_DWORD)gBaseLog, v36, 6, 32, (__int64)&WPP_a819e7d240c13332848bedce030fc704_Traceguids);
      }
LABEL_110:
      v97 = 10LL;
LABEL_135:
...
LABEL_48:
    ...
    if ( ButtonMessage == 513 )
    {
      ...
      {
        v78 = 1;
        *((_DWORD *)this + 826) = *(_DWORD *)(*((_QWORD *)v2 + 1) + 72LL);
      }
      *((_BYTE *)this + 3300) = v78;
      v11 = v78;
    }
    else
    {
      ...
      if ( v79 )
      {
        v10 = *(_DWORD *)(*((_QWORD *)v2 + 1) + 72LL) - *((_DWORD *)this + 826);
        if ( v10 <= dword_1C0210360 )
        {
          *((_BYTE *)this + 3300) = 0;
          v79 = 0;
        }
...
LABEL_90:
          ...
          {
            LOBYTE(v10) = 4;
            WPP_RECORDER_SF_((_DWORD)gBaseLog, v10, 6, 26, (__int64)&WPP_a819e7d240c13332848bedce030fc704_Traceguids);
          }
          v75 = 16LL;
          goto LABEL_64;
        }
...
LABEL_76:
  ...
  {
    LOBYTE(v10) = 4;
    WPP_RECORDER_SF_((_DWORD)gBaseLog, v10, 6, 25, (__int64)&WPP_a819e7d240c13332848bedce030fc704_Traceguids);
  }
}
