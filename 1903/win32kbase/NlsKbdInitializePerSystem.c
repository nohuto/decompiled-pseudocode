/*
 * XREFs of NlsKbdInitializePerSystem @ 0x1C00A4830
 * Callers:
 *     <none>
 * Callees:
 *     ?NlsSetKeyStateToggle@@YAXE@Z @ 0x1C00A4A84 (-NlsSetKeyStateToggle@@YAXE@Z.c)
...
void NlsKbdInitializePerSystem()
{
  ...
  *(_QWORD *)&v2.Length = 0LL;
  ...
  if ( gKeyboardInfo == 7 && byte_1C02105C9 == 3 )
