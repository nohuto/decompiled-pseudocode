/*
 * XREFs of McTemplateK0pqqqq @ 0x1C01109C4
 * Callers:
 *     EtwTraceTimerProc @ 0x1C007CC10 (EtwTraceTimerProc.c)
 *     EtwTraceInternalSetTimer @ 0x1C007E610 (EtwTraceInternalSetTimer.c)
 *     EtwDirtyRectUpdate @ 0x1C0081180 (EtwDirtyRectUpdate.c)
 *     EtwLogicalSurfRemovedTranslationFromDirtyEvent @ 0x1C0131F70 (EtwLogicalSurfRemovedTranslationFromDirtyEvent.c)
 *     EtwLogicalSurfRemovedTranslationFromMoveEvent @ 0x1C0131FB0 (EtwLogicalSurfRemovedTranslationFromMoveEvent.c)
 *     EtwTranslationUpdate @ 0x1C0132340 (EtwTranslationUpdate.c)
 * Callees:
 *     McGenEventWrite @ 0x1C006C7F8 (McGenEventWrite.c)
 *     __security_check_cookie @ 0x1C00BAF90 (__security_check_cookie.c)
 */

ULONG McTemplateK0pqqqq(struct _MCGEN_TRACE_CONTEXT *a1, const EVENT_DESCRIPTOR *a2, __int64 a3, ...)
{
