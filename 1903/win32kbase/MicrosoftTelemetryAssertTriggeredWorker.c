/*
 * XREFs of MicrosoftTelemetryAssertTriggeredWorker @ 0x1C01CABB0
 * Callers:
...
LABEL_40:
  ...
  v20 = "<unknown>";
  if ( (unsigned int)dword_1C0248040 > 5 && TlgKeywordOn((TraceLoggingHProvider)&dword_1C0248040, 0x400000000000uLL) )
  {
    v21 = "<unknown>";
    v29 = 10;
    v30 = v15;
    ...
    TlgWrite((TraceLoggingHProvider)&dword_1C0248040, &unk_1C01EA68A, 0LL, 0LL, 0xBu, &pData);
  }
  if ( TraceLoggingProviderEnabled((TraceLoggingHProvider)&dword_1C0248078, 0, 0LL) && !v19 && !KeGetCurrentIrql() )
  {
    ...
    if ( (unsigned int)dword_1C0248040 > 5 && TlgKeywordOn((TraceLoggingHProvider)&dword_1C0248040, 0x400000000000uLL) )
    {
      ...
      v56 = 4LL;
      v58 = 4LL;
      TlgWrite((TraceLoggingHProvider)&dword_1C0248040, &unk_1C01EA621, 0LL, v25, cData, &v43);
    }
