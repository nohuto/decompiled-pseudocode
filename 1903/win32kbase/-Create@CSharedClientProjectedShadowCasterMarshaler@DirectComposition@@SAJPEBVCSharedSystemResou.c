/*
 * XREFs of ?Create@CSharedClientProjectedShadowCasterMarshaler@DirectComposition@@SAJPEBVCSharedSystemResource@2@PEAPEAV12@@Z @ 0x1C01C6ED8
 * Callers:
 *     CreateSharedClientProjectedShadowCasterMarshaler @ 0x1C01C70C0 (CreateSharedClientProjectedShadowCasterMarshaler.c)
 * Callees:
