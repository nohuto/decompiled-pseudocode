/*
 * XREFs of RIMUpdatePrimaryAndFinalizePointerFlags @ 0x1C0155594
 * Callers:
 ...
 *     rimIsPointerDevicePrimaryContactDown @ 0x1C0157E50 (rimIsPointerDevicePrimaryContactDown.c)
...
__int64 __fastcall RIMUpdatePrimaryAndFinalizePointerFlags(__int64 a1, __int64 a2)
{
  ...
  while ( 1 )
  {
    ...
    if ( (v19[585] & 1) != 0 )
    {
      if ( !*(_QWORD *)(a2 + 960) && (v2 || v20) && !v4 && !(unsigned int)RIMCmIsContactSuppressed(v19) )
      {
