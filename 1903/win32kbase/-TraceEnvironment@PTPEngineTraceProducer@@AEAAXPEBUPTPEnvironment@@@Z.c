/*
 * XREFs of ?TraceEnvironment@PTPEngineTraceProducer@@AEAAXPEBUPTPEnvironment@@@Z @ 0x1C019AAC8
 * Callers:
...
void __fastcall PTPEngineTraceProducer::TraceEnvironment(PTPEngineTraceProducer *this, const struct PTPEnvironment *a2)
{
  ...
  {
    v3 = (char *)this + 552;
    if ( TlgKeywordOn((TraceLoggingHProvider)&dword_1C020F490, 3uLL) )
    {
      v9 = v3;
      v11 = v7;
      v13 = &v16;
      ...
      v14 = 2LL;
      v16 = 96LL;
      TlgWrite((TraceLoggingHProvider)&dword_1C020F490, &unk_1C01E8C6C, 0LL, 0LL, 6u, &pData);
      v4 = dword_1C020F490;
    }
    if ( v4 > 5 )
    {
      if ( TlgKeywordOn((TraceLoggingHProvider)&dword_1C020F490, 3uLL) )
      {
        ...
        v15 = a2;
        v16 = 92LL;
        TlgWrite((TraceLoggingHProvider)&dword_1C020F490, &unk_1C01E8B6C, 0LL, 0LL, 6u, &pData);
        v5 = dword_1C020F490;
      }
      if ( v5 > 5 )
      {
        if ( TlgKeywordOn((TraceLoggingHProvider)&dword_1C020F490, 3uLL) )
        {
          ...
          v14 = 2LL;
          v16 = 24LL;
          TlgWrite((TraceLoggingHProvider)&dword_1C020F490, &unk_1C01E8AA6, 0LL, 0LL, 6u, &pData);
          v6 = dword_1C020F490;
        }
        if ( v6 > 5 )
        {
          if ( TlgKeywordOn((TraceLoggingHProvider)&dword_1C020F490, 3uLL) )
          {
            ...
            v14 = 2LL;
            v16 = 296LL;
            TlgWrite((TraceLoggingHProvider)&dword_1C020F490, &unk_1C01E8AEA, 0LL, 0LL, 6u, &pData);
          }
        }
      }
    }
