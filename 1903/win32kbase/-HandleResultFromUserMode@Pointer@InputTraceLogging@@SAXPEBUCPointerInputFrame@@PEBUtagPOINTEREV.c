/*
 * XREFs of ?HandleResultFromUserMode@Pointer@InputTraceLogging@@SAXPEBUCPointerInputFrame@@PEBUtagPOINTEREVENTINT@@PEAXAEBVCInputDest@@@Z @ 0x1C016D5E0
 * Callers:
  ...
  *(_OWORD *)pwsz = *(_OWORD *)(WindowDetails + 16);
  ...
  if ( dword_1C020FB50 > 4u )
  {
    if ( TlgKeywordOn((TraceLoggingHProvider)&dword_1C020FB50, 0x20uLL) )
    {
      ...
      TlgWrite((TraceLoggingHProvider)&dword_1C020FB50, &unk_1C01E6AF2, 0LL, 0LL, 0xFu, &pData);
    }
  }
}
