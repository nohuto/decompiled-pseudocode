/*
 * XREFs of ?SetRemarshalingFlags@CAnimationMarshaler@DirectComposition@@MEAA_NXZ @ 0x1C01B1890
 * Callers:
 *     <none>
 * Callees:
 *     <none>
        ...
        DirectComposition::CAnimationMarshaler *this)
{
  ...
  *((_DWORD *)this + 4) = v1;
  ...
  v5 = *((_QWORD *)this + 24);
  if ( v5 || *((_QWORD *)this + 25) != *((_QWORD *)this + 11) )
  {
    v6 = *((_DWORD *)this + 4);
    if ( (v6 & 0x8000) == 0 )
    {
      *((_DWORD *)this + 4) = v6 | 0x8000;
      *(_QWORD *)(*((_QWORD *)this + 7) + 32LL) = v5;
