/*
 * XREFs of RIMPopulatePointerDevice @ 0x1C0143C54
 * Callers:
 ...
 *     RIMCheckPressureUsageStatus @ 0x1C013DB88 (RIMCheckPressureUsageStatus.c)
...
__int64 __fastcall RIMPopulatePointerDevice(__int64 a1, __int64 a2, __int64 a3, __int16 *a4)
{
  ...
  if ( v42 >= 0 )
  {
    ...
    if ( v5[1] == 13 && *v5 == 2 && RIMIsInputUsagePresent(v6, v14, 0x5Bu) && RIMIsInputUsagePresent(v6, v34, 0x92u) )
