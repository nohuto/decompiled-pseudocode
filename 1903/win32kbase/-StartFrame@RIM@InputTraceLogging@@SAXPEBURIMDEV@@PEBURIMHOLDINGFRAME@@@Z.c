/*
 * XREFs of ?StartFrame@RIM@InputTraceLogging@@SAXPEBURIMDEV@@PEBURIMHOLDINGFRAME@@@Z @ 0x1C014ECE8
 * Callers:
...
void __fastcall InputTraceLogging::RIM::StartFrame(const struct RIMDEV *a1, const struct RIMHOLDINGFRAME *a2)
{
  ...
  if ( dword_1C020FB50 > 4u )
  {
    if ( TlgKeywordOn((TraceLoggingHProvider)&dword_1C020FB50, 0x100uLL) )
    {
      ...
      v17 = &v7;
      v18 = v4;
      TlgWrite((TraceLoggingHProvider)&dword_1C020FB50, &unk_1C01E503E, 0LL, 0LL, 6u, &pData);
    }
  }
}
