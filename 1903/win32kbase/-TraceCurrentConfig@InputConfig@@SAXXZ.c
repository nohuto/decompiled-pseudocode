/*
 * XREFs of ?TraceCurrentConfig@InputConfig@@SAXXZ @ 0x1C00668C0
 * Callers:
  ...
  if ( gpInputConfig )
  {
    ...
    for ( i = **(CInputConfig ***)v0; v1 != v0; i = *(CInputConfig **)i )
    {
      ...
      if ( dword_1C020FB50 > 4u && TlgKeywordOn((TraceLoggingHProvider)&dword_1C020FB50, 2uLL) )
      {
        ...
        v27 = 4LL;
        v29 = 4LL;
        TlgWrite((TraceLoggingHProvider)&dword_1C020FB50, &unk_1C01E7B66, 0LL, 0LL, 7u, &pData);
      }
      KeEnterCriticalRegion();
      ExAcquireResourceSharedLite(CInputConfig::slock, 1u);
      for ( j = v3[150]; j != v3 + 150 && j != (_QWORD *)-16LL; j = (_QWORD *)*j )
      {
        if ( (j[4] & 2) != 0 )
        {
          if ( dword_1C020FB50 > 4u && TlgKeywordOn((TraceLoggingHProvider)&dword_1C020FB50, 2uLL) )
          {
            ...
            v60 = 4LL;
            v62 = 4LL;
            TlgWrite((TraceLoggingHProvider)&dword_1C020FB50, &unk_1C01E799B, 0LL, 0LL, 0x18u, &pData);
          }
        }
        else if ( dword_1C020FB50 > 4u )
        {
          if ( TlgKeywordOn((TraceLoggingHProvider)&dword_1C020FB50, 2uLL) )
          {
            ...
            v31 = v10;
            v33 = v10;
            TlgWrite((TraceLoggingHProvider)&dword_1C020FB50, &unk_1C01E7AE7, 0LL, 0LL, 9u, &pData);
          }
        }
        if ( *((_BYTE *)j + 392) )
