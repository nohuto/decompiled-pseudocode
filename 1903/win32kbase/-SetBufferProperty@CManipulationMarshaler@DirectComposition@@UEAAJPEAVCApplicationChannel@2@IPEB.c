/*
 * XREFs of ?SetBufferProperty@CManipulationMarshaler@DirectComposition@@UEAAJPEAVCApplicationChannel@2@IPEBX_KPEA_N@Z @ 0x1C01A88D0
 * Callers:
 *     <none>
 * Callees:
...
LABEL_22:
  ...
  if ( !v15 )
    return v9;
  if ( !(*(unsigned __int8 (__fastcall **)(__int64, __int64))(*(_QWORD *)v15 + 120LL))(v15, 41LL) )
    return (unsigned int)-1073741811;
