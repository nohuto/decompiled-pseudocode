/*
 * XREFs of ?rimSetPointerDeviceOutputConfig@@YAXPEAURIMDEV@@PEAUtagHID_POINTER_DEVICE_INFO@@PEAVCLockedInputSpace@@PEAVCLockedInputSpaceRegion@@@Z @ 0x1C0145AB4
 * Callers:
 ...
 *     RIMGetVirtualDesktopPhysicalSize @ 0x1C009F380 (RIMGetVirtualDesktopPhysicalSize.c)
 ...
 *     ?GetInputSpace@InputConfig@@SA_NU_LUID@@PEAVCLockedInputSpace@@@Z @ 0x1C0187EB4 (-GetInputSpace@InputConfig@@SA_NU_LUID@@PEAVCLockedInputSpace@@@Z.c)
 */
        ...
        struct CLockedInputSpaceRegion *a4)
{
  ...
  *(_QWORD *)((char *)a2 + 228) = *v4;
  ...
  {
    if ( *((_DWORD *)a1 + 330) && (*(_DWORD *)(v6 + 16) & 2) != 0 )
    {
      v18 = *((_DWORD *)a2 + 37);
  ...
  else
  {
    ...
    *((_DWORD *)a2 + 51) = v15;
    if ( *((_DWORD *)a1 + 330) )
    {
      v16 = HMValidateSharedHandleNoRip(*((_QWORD *)a1 + 166), v15, v10);
