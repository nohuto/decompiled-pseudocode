/*
 * XREFs of ?OnSessionCreation@CConnection@DirectComposition@@SAJH@Z @ 0x1C00A1260
 * Callers:
 ...
 *     ??0CConnection@DirectComposition@@AEAA@XZ @ 0x1C00A1558 (--0CConnection@DirectComposition@@AEAA@XZ.c)
