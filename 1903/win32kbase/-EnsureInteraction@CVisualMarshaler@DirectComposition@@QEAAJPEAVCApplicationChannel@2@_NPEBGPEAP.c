/*
 * XREFs of ?EnsureInteraction@CVisualMarshaler@DirectComposition@@QEAAJPEAVCApplicationChannel@2@_NPEBGPEAPEAVCInteractionMarshaler@2@@Z @ 0x1C007D1B4
 * Callers:
...
LABEL_11:
  ...
  *a5 = (struct DirectComposition::CInteractionMarshaler *)*((_QWORD *)this + 24);
