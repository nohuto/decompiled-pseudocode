/*
 * XREFs of ?SendFrameToUserMode@Pointer@InputTraceLogging@@SAXPEBUCPointerInputFrame@@K@Z @ 0x1C0171E54
 * Callers:
...
void __fastcall InputTraceLogging::Pointer::SendFrameToUserMode(const struct CPointerInputFrame *a1, int a2)
{
  ...
  if ( dword_1C020FB50 > 4u )
  {
    if ( TlgKeywordOn((TraceLoggingHProvider)&dword_1C020FB50, 0x20uLL) )
    {
      ...
      v12 = v3;
      v14 = v3;
      TlgWrite((TraceLoggingHProvider)&dword_1C020FB50, &unk_1C01E6BCA, 0LL, 0LL, 6u, &pData);
    }
  }
}
