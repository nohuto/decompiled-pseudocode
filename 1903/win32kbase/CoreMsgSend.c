/*
 * XREFs of CoreMsgSend @ 0x1C0040B68
 * Callers:
...
__int64 __fastcall CoreMsgSend(void *a1, __int64 a2, const void *a3, unsigned int a4)
{
  ...
  if ( dword_1C020F5E0 > 5u )
  {
    ...
    v15 = 8;
    v18 = 1;
    TlgWrite((TraceLoggingHProvider)&dword_1C020F5E0, &unk_1C01E9FE2, 0LL, 0LL, 4u, &pData);
  }
  ...
  if ( dword_1C020F5E0 > 5u )
  {
    ...
    v14 = v12;
    v15 = 4;
    TlgWrite((TraceLoggingHProvider)&dword_1C020F5E0, &unk_1C01E9F76, 0LL, 0LL, 3u, &pData);
  }
  if ( v10[0] )
