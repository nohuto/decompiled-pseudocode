/*
 * XREFs of ?DoGestureProcessing@CPTPEngine@@AEAAXPEAUPTPInput@@PEAH@Z @ 0x1C0194794
 * Callers:
 *     ?RunStateMachine@CPTPEngine@@AEAAXPEAUPTPInput@@@Z @ 0x1C0197AA8 (-RunStateMachine@CPTPEngine@@AEAAXPEAUPTPInput@@@Z.c)
 * Callees:
 *     ?FindOrAssignPrimary@CPTPEngine@@AEAAPEAUCContactState@@PEAUPTPInput@@@Z @ 0x1C01969A4 (-FindOrAssignPrimary@CPTPEngine@@AEAAPEAUCContactState@@PEAUPTPInput@@@Z.c)
...
void __fastcall CPTPEngine::DoGestureProcessing(CPTPEngine *this, struct PTPInput *a2, int *a3)
{
  ...
  *a3 = 0;
  ...
  do
  {
    v12 = 296LL * (unsigned int)(*(v11 - 2) % *((_DWORD *)this + 4));
  ...
  if ( !v9 )
  {
    ...
    if ( v17 )
    {
      ...
      *((_DWORD *)this + 743) = v16;
      ...
      v20 = v19;
      CBasePTPEngine::SendTelemetryOutput(this, 4LL, &v20);
