/*
 * XREFs of ?FreeFrame@Pointer@InputTraceLogging@@SAXPEBUCPointerInputFrame@@@Z @ 0x1C0166EFC
 * Callers:
...
void __fastcall InputTraceLogging::Pointer::FreeFrame(const struct CPointerInputFrame *a1)
{
  ...
  if ( dword_1C020FB50 > 5u )
  {
    if ( TlgKeywordOn((TraceLoggingHProvider)&dword_1C020FB50, 0x20uLL) )
    {
      ...
      v8 = 8LL;
      v10 = 4LL;
      TlgWrite((TraceLoggingHProvider)&dword_1C020FB50, &unk_1C01E6426, 0LL, 0LL, 5u, &pData);
    }
  }
}
