/*
 * XREFs of McTemplateK0qqxx @ 0x1C0111994
 * Callers:
 *     EtwGdiSysMemToken @ 0x1C0098FE0 (EtwGdiSysMemToken.c)
 *     EtwTraceTokenIndependentFlipSkipCompleteEvent @ 0x1C010E5F0 (EtwTraceTokenIndependentFlipSkipCompleteEvent.c)
 * Callees:
 *     McGenEventWrite @ 0x1C006C7F8 (McGenEventWrite.c)
 *     __security_check_cookie @ 0x1C00BAF90 (__security_check_cookie.c)
 */

ULONG __fastcall McTemplateK0qqxx(
