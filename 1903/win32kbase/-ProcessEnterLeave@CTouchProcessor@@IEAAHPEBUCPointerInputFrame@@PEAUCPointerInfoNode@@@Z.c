/*
 * XREFs of ?ProcessEnterLeave@CTouchProcessor@@IEAAHPEBUCPointerInputFrame@@PEAUCPointerInfoNode@@@Z @ 0x1C016FF4C
 * Callers:
        ...
        struct CPointerInfoNode *a3)
{
  ...
  if ( !a2 )
  {
    ...
    if ( !CPointerInfoNode::IsForManipulationThread(a3) )
    {
      ...
      {
        LOBYTE(v18) = 4;
        WPP_RECORDER_SF_((_DWORD)gBaseLog, v18, 7, 175, (__int64)&WPP_06d7dff703a03015e007562f188a8383_Traceguids);
        if ( WPP_RECORDER_INITIALIZED != (_UNKNOWN *)&WPP_RECORDER_INITIALIZED )
        {
...
LABEL_37:
    ...
    if ( CInputDest::operator==(v45, (__int64)v47, v34) )
    {
      ...
      {
        LOBYTE(v18) = 4;
        WPP_RECORDER_SF_((_DWORD)gBaseLog, v18, 7, 179, (__int64)&WPP_06d7dff703a03015e007562f188a8383_Traceguids);
        if ( WPP_RECORDER_INITIALIZED != (_UNKNOWN *)&WPP_RECORDER_INITIALIZED )
        {
          v20 = WPP_GLOBAL_Control;
          if ( LOWORD(WPP_GLOBAL_Control->DeviceType) )
    ...
    {
      LOBYTE(v18) = 4;
      WPP_RECORDER_SF_((_DWORD)gBaseLog, v18, 7, 181, (__int64)&WPP_06d7dff703a03015e007562f188a8383_Traceguids);
    }
