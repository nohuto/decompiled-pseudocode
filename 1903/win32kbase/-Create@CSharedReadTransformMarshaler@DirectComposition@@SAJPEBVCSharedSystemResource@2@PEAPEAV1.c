/*
 * XREFs of ?Create@CSharedReadTransformMarshaler@DirectComposition@@SAJPEBVCSharedSystemResource@2@PEAPEAV12@@Z @ 0x1C00945B0
 * Callers:
 *     CreateSharedReadTransformMarshaler @ 0x1C0094570 (CreateSharedReadTransformMarshaler.c)
 * Callees:
