/*
 * XREFs of ?EmitCreate@COverlayRenderTargetMarshaler@DirectComposition@@IEAA_NPEAPEAVCBatch@2@@Z @ 0x1C01BDCCC
 * Callers:
 *     ?EmitUpdateCommands@COverlayRenderTargetMarshaler@DirectComposition@@MEAA_NPEAPEAVCBatch@2@@Z @ 0x1C01BDDD0 (-EmitUpdateCommands@COverlayRenderTargetMarshaler@DirectComposition@@MEAA_NPEAPEAVCBatch@2@@Z.c)
 * Callees:
