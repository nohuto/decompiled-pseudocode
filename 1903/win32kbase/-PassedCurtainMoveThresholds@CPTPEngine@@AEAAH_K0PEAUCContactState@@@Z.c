/*
 * XREFs of ?PassedCurtainMoveThresholds@CPTPEngine@@AEAAH_K0PEAUCContactState@@@Z @ 0x1C0196E0C
 * Callers:
        ...
        struct CContactState *a4)
{
  return a3 - a2 <= *((_QWORD *)this + 12) * (unsigned __int64)*((unsigned int *)this + 71) / 0x3E8
      && (int)((HIDWORD(*((_QWORD *)this + 377)) - HIDWORD(*((_QWORD *)a4 + 3)))
             * (HIDWORD(*((_QWORD *)this + 377)) - HIDWORD(*((_QWORD *)a4 + 3)))
             + (*((_QWORD *)this + 377) - *((_QWORD *)a4 + 3)) * (*((_QWORD *)this + 377) - *((_QWORD *)a4 + 3))) > (unsigned __int64)*((unsigned int *)this + 72);
}
