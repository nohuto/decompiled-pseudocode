/*
 * XREFs of RIMDeliverConfigRequest @ 0x1C014312C
 * Callers:
 ...
 *     RIMRevokeConfigurationChange @ 0x1C01440E0 (RIMRevokeConfigurationChange.c)
 *     RIMUnRevokeConfigurationChange @ 0x1C0144650 (RIMUnRevokeConfigurationChange.c)
 * Callees:
...
LABEL_29:
  if ( dword_1C020F490 > 5u && TlgKeywordOn((TraceLoggingHProvider)&dword_1C020F490, 0x400000000000uLL) )
  {
    ...
    v38 = 4LL;
    v40 = 4LL;
    TlgWrite((TraceLoggingHProvider)&dword_1C020F490, &unk_1C01E4B7C, 0LL, 0LL, 7u, &pData);
    v11 = SpecificValueCaps;
  }
  if ( WPP_RECORDER_INITIALIZED != (_UNKNOWN *)&WPP_RECORDER_INITIALIZED )
  {
