/*
 * XREFs of ?FreeMsgData@CTouchProcessor@@AEAAX_K@Z @ 0x1C0167110
 * Callers:
  ...
  *v8 = v5;
  ...
  if ( v7 )
  {
    ...
    if ( v12 == 1 )
    {
      ...
      CTouchProcessor::ReleasePointerCaptureInt((CTouchProcessor *)this, (struct CPointerCaptureInfo *)(v7 + 176));
      v12 = *(_DWORD *)(v7 + 16);
    }
    v13 = v12 - 1;
    *(_DWORD *)(v7 + 16) = v13;
  ...
  if ( (_QWORD *)*v5 == v5 )
  {
    ...
    if ( v14 != v5 )
      MicrosoftTelemetryAssertTriggeredNoArgsKM(v10, v9, v11);
    if ( (_QWORD *)v15[29] != v15 + 29 )
      MicrosoftTelemetryAssertTriggeredNoArgsKM(v10, v9, v11);
    if ( *((_DWORD *)v15 + 13) == 3 )
      CTouchProcessor::FreeNode((CTouchProcessor *)this, (struct CInputPointerNode *)(v5 - 31));
  }
}
