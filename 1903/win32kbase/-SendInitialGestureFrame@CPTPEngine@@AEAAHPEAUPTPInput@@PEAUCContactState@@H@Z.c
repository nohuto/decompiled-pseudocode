/*
 * XREFs of ?SendInitialGestureFrame@CPTPEngine@@AEAAHPEAUPTPInput@@PEAUCContactState@@H@Z @ 0x1C0198B98
 * Callers:
 ...
 *     ?FixupGestureContact@CPTPEngine@@AEAAXPEAUPTPEnginePointerNode@@H@Z @ 0x1C0196A3C (-FixupGestureContact@CPTPEngine@@AEAAXPEAUPTPEnginePointerNode@@H@Z.c)
        ...
        int a4)
{
  ...
  *((_QWORD *)v8 + 14) = v17;
  ...
  if ( (_DWORD)v36 )
  {
    ...
    do
    {
      v28 = (CPTPEngine *)((char *)this + 296 * (*((_DWORD *)v27 - 2) % v26) + 1160);
  ...
  {
    v32 = (CPTPEngine *)((char *)this + 296 * (unsigned int)(*((_DWORD *)i + 1) % *((_DWORD *)this + 4)) + 1160);
