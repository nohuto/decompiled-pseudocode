/*
 * XREFs of ?AddInertiaInfo@Win32k@InputTraceLogging@@SAXAEBUINERTIA_INFO_INTERNAL@@@Z @ 0x1C017D9C4
 * Callers:
...
void __fastcall InputTraceLogging::Win32k::AddInertiaInfo(const struct INERTIA_INFO_INTERNAL *a1)
{
  ...
  if ( dword_1C020FB50 > 4u )
  {
    if ( TlgKeywordOn((TraceLoggingHProvider)&dword_1C020FB50, 2uLL) )
    {
      ...
      v22 = &v10;
      v10 = -__CFSHR__(v4, 4);
      TlgWrite((TraceLoggingHProvider)&dword_1C020FB50, &unk_1C01E7492, 0LL, 0LL, v6 + 4, &pData);
    }
  }
}
