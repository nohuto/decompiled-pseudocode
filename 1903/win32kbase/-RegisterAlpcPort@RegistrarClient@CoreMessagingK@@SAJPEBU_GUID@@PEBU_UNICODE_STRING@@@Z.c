/*
 * XREFs of ?RegisterAlpcPort@RegistrarClient@CoreMessagingK@@SAJPEBU_GUID@@PEBU_UNICODE_STRING@@@Z @ 0x1C00AA504
 * Callers:
        ...
        const struct _UNICODE_STRING *a2)
{
  ...
  if ( dword_1C020F5E0 > 5u )
  {
    ...
    v19 = &v11;
    v20 = 4;
    TlgWrite((TraceLoggingHProvider)&dword_1C020F5E0, &unk_1C01EA2D9, 0LL, 0LL, 5u, &pData);
  }
  return v7;
}
