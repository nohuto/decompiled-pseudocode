/*
 * XREFs of CoreMsgCreatePort @ 0x1C00AA1B0
 * Callers:
...
__int64 __fastcall CoreMsgCreatePort(__int64 a1, void *a2, __int64 a3, void **a4)
{
  ...
  if ( dword_1C020F5E0 > 5u )
  {
    ...
    TlgWrite((TraceLoggingHProvider)&dword_1C020F5E0, &unk_1C01EA0E6, 0LL, 0LL, 4u, &pData);
  }
  *a4 = 0LL;
  ...
  if ( dword_1C020F5E0 > 5u )
  {
    v14 = 4LL;
    v13 = &v11;
    TlgWrite((TraceLoggingHProvider)&dword_1C020F5E0, &unk_1C01EA022, 0LL, 0LL, 3u, &pData);
  }
  if ( v10[0] )
