/*
 * XREFs of ?CitpSetForegroundProcess@@YAHPEAU_CIT_IMPACT_CONTEXT@@IPEAUtagPROCESSINFO@@PEAUtagWND@@PEAUtagMONITOR@@PEAUtagSHELL_INPUT_USAGE_DATA_INFO@@@Z @ 0x1C0087510
 * Callers:
 ...
 *     ?CitpProcessForegroundChange@@YAHPEAUtagPROCESSINFO@@PEAUtagWND@@0PEAUtagMONITOR@@PEAUtagSHELL_INPUT_USAGE_DATA_INFO@@@Z @ 0x1C0087400 (-CitpProcessForegroundChange@@YAHPEAUtagPROCESSINFO@@PEAUtagWND@@0PEAUtagMONITOR@@PEAUtagSHELL_I.c)
 ...
 *     ?CitpProcessGetAppSessionId@@YA?AU_GUID@@PEAUtagPROCESSINFO@@PEAI@Z @ 0x1C0037954 (-CitpProcessGetAppSessionId@@YA-AU_GUID@@PEAUtagPROCESSINFO@@PEAI@Z.c)
 ...
 *     ?CalculateDeltaFrom@CIT_USER_ACTIVITY_STAT@@QEAA?AU1@AEBU1@@Z @ 0x1C0087F44 (-CalculateDeltaFrom@CIT_USER_ACTIVITY_STAT@@QEAA-AU1@AEBU1@@Z.c)
 *     ?CitpGetForegroundWindowInfo@@YAHPEAU_CIT_WINDOW_INFO@@PEAUtagPROCESSINFO@@PEAUtagWND@@@Z @ 0x1C0087FC8 (-CitpGetForegroundWindowInfo@@YAHPEAU_CIT_WINDOW_INFO@@PEAUtagPROCESSINFO@@PEAUtagWND@@@Z.c)
 ...
 *     ?CitpBitmapUpdateForTimeRange@@YAXPEAU_CIT_BITMAP@@IIII@Z @ 0x1C0088110 (-CitpBitmapUpdateForTimeRange@@YAXPEAU_CIT_BITMAP@@IIII@Z.c)
 ...
 *     ?CitpProgDataNotifyUseUpdate@@YAXPEAU_CIT_IMPACT_CONTEXT@@PEAU_CIT_PROG_DATA@@@Z @ 0x1C01C9978 (-CitpProgDataNotifyUseUpdate@@YAXPEAU_CIT_IMPACT_CONTEXT@@PEAU_CIT_PROG_DATA@@@Z.c)
 */
...
LABEL_60:
  ...
  if ( a2 - *((_DWORD *)a1 + 134) > 2 * dword_1C02187EC )
  {
    v59 = 4;
    goto LABEL_60;
  }
LABEL_4:
  if ( a2 - *((_DWORD *)a1 + 196) >= dword_1C0218800 )
    CitpDPDataLog(a1);
  if ( *((_QWORD *)a1 + 15) )
  {
    v14 = *((_DWORD *)a1 + 71);
      ...
      if ( HIBYTE(qword_1C0218804) )
      {
        ...
        if ( hProvider > 5u )
        {
          if ( TlgKeywordOn((TraceLoggingHProvider)&hProvider, 0x800000000800uLL) )
          {
            ...
            v155 = v28;
            v156 = 8LL;
            TlgWrite((TraceLoggingHProvider)&hProvider, &unk_1C01E9CED, 0LL, 0LL, 0x1Eu, &pData);
          }
        }
      }
        ...
        if ( v60 )
        {
          ...
          *((_DWORD *)v60 + 20) = v64;
          ...
          if ( v66 + v63 >= v66 )
            v65 = v66 + v63;
          *((_DWORD *)v61 + 21) = v65;
          CitpProgDataNotifyUseUpdate(qword_1C0218810, v61);
        }
      }
      if ( (qword_1C02187F4 & 1) != 0 )
      {
        ...
        if ( (qword_1C02187F4 & 1) != 0 && a2 - *((_DWORD *)a1 + 208) > HIDWORD(qword_1C02187F4) )
      ...
      if ( HIBYTE(qword_1C0218804) )
      {
        ...
        if ( hProvider > 5u )
        {
          if ( TlgKeywordOn((TraceLoggingHProvider)&hProvider, 0x800000000800uLL) )
          {
            ...
            v188 = v54;
            v189 = 8LL;
            TlgWrite((TraceLoggingHProvider)&hProvider, &unk_1C01E9BB3, 0LL, 0LL, 0x12u, &v157);
          }
        }
      }
    }
