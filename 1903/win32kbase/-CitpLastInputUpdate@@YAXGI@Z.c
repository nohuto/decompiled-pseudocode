/*
 * XREFs of ?CitpLastInputUpdate@@YAXGI@Z @ 0x1C0039778
 * Callers:
 *     CitLastInputUpdate @ 0x1C0039A30 (CitLastInputUpdate.c)
...
void __fastcall CitpLastInputUpdate(unsigned __int16 a1, unsigned int a2)
{
  ...
  if ( qword_1C0218810 )
  {
    if ( a2 < dword_1C0218818 )
      v2 = (MEMORY[0xFFFFF78000000320] * (unsigned __int64)MEMORY[0xFFFFF78000000004]) >> 24;
    v5 = qword_1C0218810;
    dword_1C0218818 = v2;
    CIT_USER_ACTIVE_TRACKER::OnUserActiveEvent((struct _CIT_IMPACT_CONTEXT *)((char *)qword_1C0218810 + 216), v2);
    if ( !v4 )
