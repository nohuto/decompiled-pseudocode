/*
 * XREFs of ?UpdateWindowTreeDpiAwareness@@YAXPEAUtagPROCESSINFO@@PEAUtagWND@@@Z @ 0x1C002934C
 * Callers:
...
void __fastcall UpdateWindowTreeDpiAwareness(struct tagPROCESSINFO *a1, struct tagWND *a2)
{
  ...
  if ( v4 )
  {
    for ( i = (unsigned __int64 *)(v4 + 32); ; ++i )
    {
      ...
      {
        v8 = (char *)qword_1C0213758 + (unsigned int)(unsigned __int16)v6 * dword_1C0213760;
        GetDomainLockRef(14LL, (unsigned __int16)v6, v7);
        v10 = gpKernelHandleTable;
        v11 = v6 >> 16;
        v12 = 3LL * (unsigned int)((v8 - (char *)qword_1C0213758) >> 5);
