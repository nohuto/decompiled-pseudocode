/*
 * XREFs of ?GetEntryFromObject@GdiHandleManager@@QEAAPEAU_ENTRY@@PEAVOBJECT@@@Z @ 0x1C001CE80
 * Callers:
 ...
 *     ?SetCachedDpiScaleValue@DC@@QEAAXJ@Z @ 0x1C0123330 (-SetCachedDpiScaleValue@DC@@QEAAXJ@Z.c)
