/*
 * XREFs of ?IsRCZClick@CPTPEngine@@AEAAHPEAUPTPInput@@PEAUCContactState@@PEAPEAUtagPOINT@@@Z @ 0x1C0196B80
 * Callers:
        ...
        struct tagPOINT **a4)
{
  ...
  if ( v10 )
  {
    ...
    do
    {
      v14 = (_DWORD *)((char *)v8 + 296 * (*((_DWORD *)v12 - 9) % v11) + 1160);
      if ( (*v14 & 0x8000000) != 0 && v14[5] >= *((_DWORD *)v8 + 799) )
      {
        v18 = PtInRect((_DWORD *)v8 + 798, *v12) && PtInRect(v15, *((_QWORD *)v17 + 2));
        if ( (v16 & 1) != 0 )
