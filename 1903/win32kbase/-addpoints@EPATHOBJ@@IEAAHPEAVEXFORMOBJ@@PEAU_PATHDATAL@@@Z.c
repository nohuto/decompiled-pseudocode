/*
 * XREFs of ?addpoints@EPATHOBJ@@IEAAHPEAVEXFORMOBJ@@PEAU_PATHDATAL@@@Z @ 0x1C007942C
 * Callers:
 ...
 *     ?bPolyLineTo@EPATHOBJ@@QEAAHPEAVEXFORMOBJ@@PEAU_POINTL@@K@Z @ 0x1C00793E0 (-bPolyLineTo@EPATHOBJ@@QEAAHPEAVEXFORMOBJ@@PEAU_POINTL@@K@Z.c)
 * Callees:
 ...
 *     ?reinit@EPATHOBJ@@IEAAXXZ @ 0x1C0123E40 (-reinit@EPATHOBJ@@IEAAXXZ.c)
 */
