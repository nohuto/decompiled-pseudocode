/*
 * XREFs of ??$EmitAddTargets@UtagMILCMD_COMPOSITIONLIGHT_ADDTARGETS@@@CCompositionLightMarshaler@DirectComposition@@AEAA_NPEAPEAVCBatch@1@PEAPEAVCResourceMarshaler@1@PEAI2W4MILCMD@@@Z @ 0x1C0006474
 * Callers:
        ...
        unsigned __int64 a5)
{
  ...
  if ( *(_DWORD *)a5 < *a4 )
  {
    do
    {
      v10 = 4096LL - *(_QWORD *)(*((_QWORD *)*a2 + 17) + 40LL);
      a5 = v10;
      if ( v10 < 0x14 )
      {
