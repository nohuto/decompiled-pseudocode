/*
 * XREFs of ??$EmitAddSharedLights@UtagMILCMD_VISUAL_ADDEXCLUDEDSHAREDLIGHTS@@@CVisualMarshaler@DirectComposition@@IEAA_NAEBVCResourceMarshalerArray@1@W4MILCMD@@PEA_KPEAPEAVCBatch@1@@Z @ 0x1C000D1D4
 * Callers:
