/*
 * XREFs of WmsgpPostMessage @ 0x1C0249654
 * Callers:
 *     PostWinlogonMessage @ 0x1C00AC010 (PostWinlogonMessage.c)
 * Callees:
 *     ClientI_WMsgkSendMessage @ 0x1C00AC08C (ClientI_WMsgkSendMessage.c)
 *     WMsg_midl_user_allocate @ 0x1C00AC0D0 (WMsg_midl_user_allocate.c)
