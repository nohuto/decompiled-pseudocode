/*
 * XREFs of ?MouseOutput@PTP@InputTraceLogging@@SAXPEBUCPointerInputFrame@@_KPEBUPTPEngineOutput@@@Z @ 0x1C017ADCC
 * Callers:
        ...
        const struct PTPEngineOutput *a3)
{
  ...
  if ( dword_1C020FB50 > 4u && TlgKeywordOn((TraceLoggingHProvider)&dword_1C020FB50, 0x80uLL) )
  {
    ...
    v38 = 4;
    v41 = 4;
    TlgWrite((TraceLoggingHProvider)&dword_1C020FB50, &unk_1C01E71E5, 0LL, 0LL, 9u, &pData);
  }
}
