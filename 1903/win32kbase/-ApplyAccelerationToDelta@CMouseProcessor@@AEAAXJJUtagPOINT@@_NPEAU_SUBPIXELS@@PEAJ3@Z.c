/*
 * XREFs of ?ApplyAccelerationToDelta@CMouseProcessor@@AEAAXJJUtagPOINT@@_NPEAU_SUBPIXELS@@PEAJ3@Z @ 0x1C0066D2C
 * Callers:
        ...
        int *a8)
{
  ...
  v9 = a3;
  v10 = a2;
  if ( a5 && (*((_BYTE *)qword_1C020B0A8 + 112) || (*(_BYTE *)(&qword_1C0213A18 + 1) & 0x40) == 0) )
  {
    v12 = qword_1C020B0C0;
...
LABEL_7:
  ...
  else
  {
    if ( v10 )
    {
      v15 = *((_DWORD *)this + 17) + v10 * NormalizedMouseSensitivityFactor;
      v16 = v15 % 256;
      *((_DWORD *)this + 17) = v15 % 256;
      v10 = v15 / 256;
      if ( v15 < 0 && v16 > 0 )
      {
        v10 = v15 / 256 + 1;
        *((_DWORD *)this + 17) = v16 - 256;
      }
    }
    if ( v9 )
    {
      v17 = *((_DWORD *)this + 18) + v9 * NormalizedMouseSensitivityFactor;
      v18 = v17 % 256;
      *((_DWORD *)this + 18) = v17 % 256;
      v9 = v17 / 256;
      if ( v17 < 0 && v18 > 0 )
      {
        ++v9;
        *((_DWORD *)this + 18) = v18 - 256;
      }
    }
    v19 = a6;
    *(_DWORD *)a6 = *((_DWORD *)this + 17) << 8;
    v20 = *((_DWORD *)this + 18) << 8;
  }
  *((_DWORD *)v19 + 1) = v20;
