/*
 * XREFs of ?HitTestRequest@DWM@InputTraceLogging@@SAX_KAEBU_InputHitTestRequest@@@Z @ 0x1C0034A14
 * Callers:
...
void __fastcall InputTraceLogging::DWM::HitTestRequest(__int64 a1, const struct _InputHitTestRequest *a2)
{
  ...
  if ( TraceLoggingProviderEnabled((TraceLoggingHProvider)&dword_1C020FB50, 0, 0LL)
    && dword_1C020FB50 > 4u
    && TlgKeywordOn((TraceLoggingHProvider)&dword_1C020FB50, 2uLL) )
  {
    v4 = *v2;
    v44 = &v41;
    v41 = v3;
    ...
    v99 = 4LL;
    v101 = 4LL;
    TlgWrite((TraceLoggingHProvider)&dword_1C020FB50, &unk_1C01E7742, 0LL, 0LL, 0x24u, &pData);
  }
}
