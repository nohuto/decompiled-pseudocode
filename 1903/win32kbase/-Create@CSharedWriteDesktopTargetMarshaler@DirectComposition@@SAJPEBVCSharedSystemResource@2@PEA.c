/*
 * XREFs of ?Create@CSharedWriteDesktopTargetMarshaler@DirectComposition@@SAJPEBVCSharedSystemResource@2@PEAPEAV12@@Z @ 0x1C00A6278
 * Callers:
 *     CreateSharedWriteDesktopTargetMarshaler @ 0x1C00A6240 (CreateSharedWriteDesktopTargetMarshaler.c)
 * Callees:
