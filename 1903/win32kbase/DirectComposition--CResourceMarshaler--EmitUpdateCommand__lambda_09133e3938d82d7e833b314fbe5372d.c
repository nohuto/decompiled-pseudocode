/*
 * XREFs of DirectComposition::CResourceMarshaler::EmitUpdateCommand__lambda_09133e3938d82d7e833b314fbe5372d1___lambda_0de7e8b49aabdfd91187b0359fd6d078___ @ 0x1C01B555C
 * Callers:
 *     ?EmitAttractors@CParticleEmitterVisualMarshaler@DirectComposition@@AEAA_NPEAPEAVCBatch@2@@Z @ 0x1C01B6114 (-EmitAttractors@CParticleEmitterVisualMarshaler@DirectComposition@@AEAA_NPEAPEAVCBatch@2@@Z.c)
 * Callees:
    ...
    *((_DWORD *)v13 + 4) = 4 * v12;
    ...
    if ( (_DWORD)v12 )
    {
      ...
      do
      {
        v16 = *a3;
        *a3 = v16 + 1;
        *v14++ = *(_DWORD *)(*(_QWORD *)(*(_QWORD *)(*(_QWORD *)v6 + 480LL) + 8 * v16) + 24LL);
        --v15;
      }
      while ( v15 );
    }
