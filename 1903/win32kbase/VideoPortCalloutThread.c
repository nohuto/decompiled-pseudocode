/*
 * XREFs of VideoPortCalloutThread @ 0x1C0109510
 * Callers:
      ...
      *(GUID *)(v64 + 28) = ActivityId_8;
      if ( dword_1C020FB50 > 6u )
      {
        if ( TlgKeywordOn((TraceLoggingHProvider)&dword_1C020FB50, 0x2000uLL) )
        {
          ...
          v71 = &v60;
          v72 = 4LL;
          TlgWrite((TraceLoggingHProvider)&dword_1C020FB50, &unk_1C01E3480, &ActivityId_8, 0LL, 3u, &v70);
          v19 = dword_1C020FB50;
        }
        if ( v19 > 6 && TlgKeywordOn((TraceLoggingHProvider)&dword_1C020FB50, 0x2000uLL) )
        {
          ...
          v74 = &v61;
          v75 = 4LL;
          TlgWrite((TraceLoggingHProvider)&dword_1C020FB50, &unk_1C01E34AD, &ActivityId_8, 0LL, 3u, &v73);
        }
      }
    }
          ...
          do
          {
            ...
            else
            {
              if ( (_BYTE)v57 )
              {
                ...
                xxxResetDisplayDevice((__int64)grpdeskRitInput, 0, 0LL);
              }
              else if ( HIBYTE(v57) )
              {
