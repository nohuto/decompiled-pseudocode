/*
 * XREFs of ?ivHandleMouseInputPacket@CBaseInput@@AEAA?AW4IVHandlerResult@@PEAXPEAURawInputManagerObject@@@Z @ 0x1C018CC10
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall CBaseInput::ivHandleMouseInputPacket(__int64 a1, __int64 a2, __int64 a3)
{
  ...
  {
    LOBYTE(a2) = 4;
    WPP_RECORDER_SF_((_DWORD)gBaseLog, a2, 12, 37, (__int64)&WPP_ead607961d3c3e051bc3eba132247bd1_Traceguids);
  }
  v16 = 0LL;
  v17 = 0LL;
  v5 = 1;
...
LABEL_20:
  ...
  if ( !(unsigned __int8)IsRimObjectUnregistered(a3) )
  {
    ...
    else
    {
      ...
      {
        LOBYTE(v11) = 2;
        WPP_RECORDER_SF_((_DWORD)gBaseLog, v11, 12, 38, (__int64)&WPP_ead607961d3c3e051bc3eba132247bd1_Traceguids);
      }
      v5 = 0;
    }
    *(_QWORD *)(a3 + 112) = 0LL;
