/*
 * XREFs of ?SecondaryHitTest@Pointer@InputTraceLogging@@SAXAEBTPOINTERINFOUNION@@AEBVCInputDest@@AEBUtagPOINT@@@Z @ 0x1C0171C58
 * Callers:
    ...
    *(_OWORD *)pwsz_8 = *(_OWORD *)(WindowDetails + 16);
    ...
    if ( dword_1C020FB50 > 4u )
    {
      if ( TlgKeywordOn((TraceLoggingHProvider)&dword_1C020FB50, 0x20uLL) )
      {
        ...
        v50 = v14;
        v53 = v14;
        TlgWrite((TraceLoggingHProvider)&dword_1C020FB50, &unk_1C01E629A, 0LL, 0LL, 0xEu, &pData);
      }
    }
  }
}
