/*
 * XREFs of ?ShouldDeferToken@CSynchronizationManager@DirectComposition@@SA_N_K0@Z @ 0x1C007F378
 * Callers:
 *     DCompositionShouldDeferToken @ 0x1C007F360 (DCompositionShouldDeferToken.c)
 * Callees:
