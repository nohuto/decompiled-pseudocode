/*
 * XREFs of ?_CreateCompositionInputSink@@YAJPEBUCOMPOSITION_INPUT_SINK@@HPEAPEAX@Z @ 0x1C008C7BC
 * Callers:
 *     NtCreateImplicitCompositionInputSink @ 0x1C008C780 (NtCreateImplicitCompositionInputSink.c)
 *     NtCreateCompositionInputSink @ 0x1C008C7A0 (NtCreateCompositionInputSink.c)
 * Callees:
