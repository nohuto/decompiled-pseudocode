/*
 * XREFs of ?Allocate@?$CTypeIsolation@$0NPAAA@$0NPA@@NSInstrumentation@@IEAAPEAXXZ @ 0x1C0124800
 * Callers:
 ...
 *     ?Allocate@?$CSectionBitmapAllocator@$0NPAAA@$0NPA@@NSInstrumentation@@QEAAPEAXXZ @ 0x1C009B234 (-Allocate@-$CSectionBitmapAllocator@$0NPAAA@$0NPA@@NSInstrumentation@@QEAAPEAXXZ.c)
...
PSLIST_ENTRY __fastcall NSInstrumentation::CTypeIsolation<913408,3568>::Allocate(__int64 **a1)
{
  ...
  else
  {
    ...
    {
      v5 = NSInstrumentation::CSectionBitmapAllocator<913408,3568>::Allocate(i[4]);
      if ( v5 )
      {
    ...
    GreLeaveCriticalRegionAndReleasePushLockShared((__int64)v2);
    v6 = NSInstrumentation::CSectionEntry<913408,3568>::Create();
    v7 = (__int64 *)v6;
    if ( v6 )
    {
      v3 = NSInstrumentation::CSectionBitmapAllocator<913408,3568>::Allocate(*((__int64 **)v6 + 4));
      if ( v3 )
      {
        v8 = (__int64)a1[2];
