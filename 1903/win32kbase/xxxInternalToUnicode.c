/*
 * XREFs of xxxInternalToUnicode @ 0x1C00710D0
 * Callers:
        ...
        __int64 a8)
{
  ...
  *a7 = v14;
  ...
  if ( v14 )
  {
    if ( a1 != 18 )
    {
      if ( a1 == (unsigned __int16)word_1C02156E0 )
        word_1C02156E0 = 0;
      goto LABEL_9;
    }
    if ( !word_1C02156DC )
...
LABEL_75:
    ...
    {
      if ( (word_1C02156DC & 0xFF00) != 0 )
      {
        v19 = _byteswap_ushort(word_1C02156DC);
        word_1C02156DC = v19;
      }
      else if ( ((_WORD)v37 != 932 || (unsigned __int16)(word_1C02156DC - 161) > 0x3Eu)
             && (unsigned __int16)(word_1C02156DC - 128) <= 0x7Fu )
      {
        v37 = 1252LL;
      }
    }
...
LABEL_56:
      if ( v36 < 0 )
        goto LABEL_57;
      if ( (unsigned __int16)word_1C02156E0 == a1 )
        return 0LL;
      if ( (unsigned __int8)(byte_1C02156DE - 2) > 1u )
      {
        word_1C02156DC = v36 + 10 * v19;
        if ( !word_1C02156DC )
        {
          v43 = byte_1C02156DE;
          if ( !v36 )
