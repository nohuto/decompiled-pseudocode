/*
 * XREFs of rimObsCheckForObservationPermissions @ 0x1C0159974
 * Callers:
 ...
 * Callees:
 *     ?rimIsProcessLocalSystem@@YAHPEAU_EPROCESS@@@Z @ 0x1C015943C (-rimIsProcessLocalSystem@@YAHPEAU_EPROCESS@@@Z.c)
