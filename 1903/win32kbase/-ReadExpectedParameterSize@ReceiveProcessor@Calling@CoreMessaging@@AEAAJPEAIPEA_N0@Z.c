/*
 * XREFs of ?ReadExpectedParameterSize@ReceiveProcessor@Calling@CoreMessaging@@AEAAJPEAIPEA_N0@Z @ 0x1C009E41C
 * Callers:
...
LABEL_21:
  ...
  if ( !v13 )
  {
    ...
    if ( v14 )
    {
      ...
      if ( (v27 & 1) != 0 || *(_WORD *)(v14 + 2 * (v27 >> 1) - 2) )
        goto LABEL_32;
    }
    return 0LL;
  }
  ...
  v26 = v23 - 1;
  if ( !v26 )
    CoreMessaging::Calling::FailFast::Error((ULONG_PTR)"mincore\\coreui\\dev\\calling\\receiveprocessor.cpp", 0x1E7uLL);
  if ( v26 != 1 )
  {
LABEL_25:
    *((_DWORD *)this + 30) = 205;
