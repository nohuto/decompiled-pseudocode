/*
 * XREFs of ?xxxUserPowerEventCalloutWorker@@YAJPEAU_WIN32_POWEREVENT_PARAMETERS@@@Z @ 0x1C005A12C
 * Callers:
 ...
 *     EtwTraceStopPowerEventCalloutWorker @ 0x1C005A838 (EtwTraceStopPowerEventCalloutWorker.c)
...
LABEL_11:
        ...
        if ( dword_1C02157D0 || gfSwitchInProgress )
          goto LABEL_24;
        HIDWORD(InputBuffer) = v5;
        LOBYTE(InputBuffer) = gProtocolType == 0;
        if ( HIDWORD(qword_1C02157DC) && !gProtocolType && (_DWORD)v5 != 22 )
        {
          if ( (_DWORD)v5 != 1 || !ShouldEscapeProximity() )
            goto LABEL_26;
          HIDWORD(qword_1C02157DC) = 0;
        }
...
LABEL_278:
      ...
      else
      {
        ...
        if ( v6 != 14 )
        {
          ...
          if ( gfSwitchInProgress || dword_1C02157D0 )
            goto LABEL_31;
          if ( v5 == 1 )
          {
            gbBuiltinPanelOn = 1;
            ...
            if ( v99 && (*(int *)(v99 + 24) > 0 || *(_DWORD *)(v136 + 48)) )
            {
              ...
              if ( dword_1C020FB50 > 6u )
              {
                if ( TlgKeywordOn((TraceLoggingHProvider)&dword_1C020FB50, 0x2000uLL) )
                {
                  ...
                  v153 = &v121;
                  v154 = 4LL;
                  TlgWrite((TraceLoggingHProvider)&dword_1C020FB50, &unk_1C01E34D7, &v138, 0LL, 3u, &v152);
                }
              }
            }
          }
            ...
            *(GUID *)(v136 + 28) = v138;
            if ( dword_1C020FB50 > 6u )
            {
              if ( TlgKeywordOn((TraceLoggingHProvider)&dword_1C020FB50, 0x2000uLL) )
              {
                ...
                v156 = &v122;
                v157 = 4;
                TlgWrite((TraceLoggingHProvider)&dword_1C020FB50, &unk_1C01E3480, &v138, 0LL, 3u, &v155);
                v100 = dword_1C020FB50;
              }
              if ( v100 > 6 && TlgKeywordOn((TraceLoggingHProvider)&dword_1C020FB50, 0x2000uLL) )
              {
                v162 = 0;
                v123 = v137;
                v160 = &v123;
                v161 = 4;
                TlgWrite((TraceLoggingHProvider)&dword_1C020FB50, &unk_1C01E34AD, &v138, 0LL, 3u, &v159);
              }
            }
          }
        ...
        if ( v106 && (*(int *)(v106 + 24) > 0 || *(_DWORD *)(v139 + 48)) )
        {
          ...
          if ( dword_1C020FB50 > 6u )
          {
            if ( TlgKeywordOn((TraceLoggingHProvider)&dword_1C020FB50, 0x2000uLL) )
            {
              ...
              v164 = &v124;
              v165 = 4LL;
              TlgWrite((TraceLoggingHProvider)&dword_1C020FB50, &unk_1C01E34D7, &v141, 0LL, 3u, &v163);
            }
          }
        }
      }
        ...
        *(GUID *)(v139 + 28) = v141;
        if ( dword_1C020FB50 > 6u )
        {
          if ( TlgKeywordOn((TraceLoggingHProvider)&dword_1C020FB50, 0x2000uLL) )
          {
            ...
            v167 = &v125;
            v168 = 4;
            TlgWrite((TraceLoggingHProvider)&dword_1C020FB50, &unk_1C01E3480, &v141, 0LL, 3u, &v166);
            v107 = dword_1C020FB50;
          }
          if ( v107 > 6 && TlgKeywordOn((TraceLoggingHProvider)&dword_1C020FB50, 0x2000uLL) )
          {
            v173 = 0;
            v126 = v140;
            v171 = &v126;
            v172 = 4;
            TlgWrite((TraceLoggingHProvider)&dword_1C020FB50, &unk_1C01E34AD, &v141, 0LL, 3u, &v170);
          }
        }
      }
      EtwTraceAcquiredExclusiveUserCrit();
          ...
          *(GUID *)(v133 + 28) = pActivityId;
          if ( dword_1C020FB50 > 6u )
          {
            if ( TlgKeywordOn((TraceLoggingHProvider)&dword_1C020FB50, 0x2000uLL) )
            {
              ...
              v147 = &v119;
              v148 = 4LL;
              TlgWrite((TraceLoggingHProvider)&dword_1C020FB50, &unk_1C01E3480, &pActivityId, 0LL, 3u, &v146);
              v80 = dword_1C020FB50;
            }
            if ( v80 > 6 && TlgKeywordOn((TraceLoggingHProvider)&dword_1C020FB50, 0x2000uLL) )
            {
              v120 = v134;
              v150 = &v120;
              v151 = 4LL;
              TlgWrite((TraceLoggingHProvider)&dword_1C020FB50, &unk_1C01E34AD, &pActivityId, 0LL, 3u, &v149);
            }
          }
        }
        EtwTraceAcquiredExclusiveUserCrit();
  ...
  if ( v6 != 3 )
  {
    ...
    switch ( v6 )
    {
      ...
      case 5:
        ...
        if ( !gProtocolType && byte_1C0214F28 && !dword_1C02157CC && (int)IsPowerOffGdiSupported() >= 0 )
          PowerOffGdi();
...
LABEL_105:
      ...
      case 6:
        ...
        goto LABEL_31;
      case 7:
        if ( gfSwitchInProgress || dword_1C02157D0 || !gPowerTransitionsState )
          goto LABEL_31;
        PowerDimMonitor();
        if ( !gProtocolType )
