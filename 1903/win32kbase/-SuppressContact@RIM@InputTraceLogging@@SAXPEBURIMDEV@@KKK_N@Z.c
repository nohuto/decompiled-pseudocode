/*
 * XREFs of ?SuppressContact@RIM@InputTraceLogging@@SAXPEBURIMDEV@@KKK_N@Z @ 0x1C015B2A0
 * Callers:
        ...
        bool a5)
{
  ...
  if ( dword_1C020FB50 > 4u )
  {
    if ( TlgKeywordOn((TraceLoggingHProvider)&dword_1C020FB50, 0x100uLL) )
    {
      ...
      v20 = 4LL;
      v22 = 4LL;
      TlgWrite((TraceLoggingHProvider)&dword_1C020FB50, &unk_1C01E5CA7, 0LL, 0LL, 7u, &pData);
    }
  }
}
