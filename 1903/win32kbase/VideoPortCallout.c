/*
 * XREFs of VideoPortCallout @ 0x1C0108C70
 * Callers:
 *     <none>
 * Callees:
 ...
 *     CSTRemove @ 0x1C010AE70 (CSTRemove.c)
          ...
          *(GUID *)(v78 + 28) = ActivityId;
          if ( dword_1C020FB50 > 6u )
          {
            if ( TlgKeywordOn((TraceLoggingHProvider)&dword_1C020FB50, 0x2000uLL) )
            {
              ...
              v88 = &v69;
              v89 = 4LL;
              TlgWrite((TraceLoggingHProvider)&dword_1C020FB50, &unk_1C01E3480, &ActivityId, 0LL, 3u, &v87);
              v14 = dword_1C020FB50;
            }
            if ( v14 > 6 && TlgKeywordOn((TraceLoggingHProvider)&dword_1C020FB50, 0x2000uLL) )
            {
              ...
              v91 = &v70;
              v92 = 4LL;
              TlgWrite((TraceLoggingHProvider)&dword_1C020FB50, &unk_1C01E34AD, &ActivityId, 0LL, 3u, &v90);
            }
          }
        }
              ...
              if ( v38 && (*(int *)(v38 + 24) > 0 || *(_DWORD *)(v81 + 48)) )
              {
                ...
                if ( dword_1C020FB50 > 6u )
                {
                  if ( TlgKeywordOn((TraceLoggingHProvider)&dword_1C020FB50, 0x2000uLL) )
                  {
                    ...
                    v94 = &v71;
                    v95 = 4LL;
                    TlgWrite((TraceLoggingHProvider)&dword_1C020FB50, &unk_1C01E34D7, &pActivityId, 0LL, 3u, &v93);
                  }
                }
              }
            }
              ...
              *(GUID *)(v81 + 28) = pActivityId;
              if ( dword_1C020FB50 > 6u )
              {
                if ( TlgKeywordOn((TraceLoggingHProvider)&dword_1C020FB50, 0x2000uLL) )
                {
                  ...
                  v97 = &v72;
                  v98 = 4LL;
                  TlgWrite((TraceLoggingHProvider)&dword_1C020FB50, &unk_1C01E3480, &pActivityId, 0LL, 3u, &v96);
                  v46 = dword_1C020FB50;
                }
                if ( v46 > 6 && TlgKeywordOn((TraceLoggingHProvider)&dword_1C020FB50, 0x2000uLL) )
                {
                  ...
                  v100 = &v73;
                  v101 = 4LL;
                  TlgWrite((TraceLoggingHProvider)&dword_1C020FB50, &unk_1C01E34AD, &pActivityId, 0LL, 3u, &v99);
                }
              }
            }
            EtwTraceAcquiredExclusiveUserCrit();
