/*
 * XREFs of ?TransformPointWithUniformSpaceMapping@@YAHPEAU_MDEV@@PEAH1H@Z @ 0x1C0064D30
 * Callers:
 *     DrvPixelSpaceToUniformSpacePoint @ 0x1C0064920 (DrvPixelSpaceToUniformSpacePoint.c)
 *     DrvUniformSpaceToPixelSpacePoint @ 0x1C0064D00 (DrvUniformSpaceToPixelSpacePoint.c)
 * Callees:
