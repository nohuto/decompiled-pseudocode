/*
 * XREFs of ?ProcessInjectedInput@CTouchProcessor@@QEAAXPEAX0_NK1@Z @ 0x1C01703EC
 * Callers:
        ...
        bool a6)
{
  ...
  if ( v11 )
  {
    ...
    {
      LOBYTE(v18) = 2;
      WPP_RECORDER_SF_((_DWORD)gBaseLog, v18, 7, 31, (__int64)&WPP_06d7dff703a03015e007562f188a8383_Traceguids);
      if ( WPP_RECORDER_INITIALIZED != (_UNKNOWN *)&WPP_RECORDER_INITIALIZED )
      {
        v15 = WPP_GLOBAL_Control;
        if ( LOWORD(WPP_GLOBAL_Control->DeviceType) )
  ...
  {
    LOBYTE(v12) = 2;
    WPP_RECORDER_SF_((_DWORD)gBaseLog, v12, 7, 29, (__int64)&WPP_06d7dff703a03015e007562f188a8383_Traceguids);
    if ( WPP_RECORDER_INITIALIZED != (_UNKNOWN *)&WPP_RECORDER_INITIALIZED )
    {
      v15 = WPP_GLOBAL_Control;
      if ( LOWORD(WPP_GLOBAL_Control->DeviceType) )
...
LABEL_23:
        LOBYTE(v14) = 5;
        WPP_RECORDER_SF_(v15->DeviceExtension, v14, 7, v16, (__int64)&WPP_06d7dff703a03015e007562f188a8383_Traceguids);
      }
    }
  }
