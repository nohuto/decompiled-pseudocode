/*
 * XREFs of ?Create@CSharedReadPrimitiveColorMarshaler@DirectComposition@@SAJPEBVCSharedSystemResource@2@PEAPEAV12@@Z @ 0x1C01C5D1C
 * Callers:
 *     CreateSharedReadPrimitiveColorMarshaler @ 0x1C01C5F30 (CreateSharedReadPrimitiveColorMarshaler.c)
 * Callees:
