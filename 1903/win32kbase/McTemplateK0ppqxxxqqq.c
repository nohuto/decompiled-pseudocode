/*
 * XREFs of McTemplateK0ppqxxxqqq @ 0x1C01106A0
 * Callers:
 *     EtwTraceTokenCompositionSurfaceObjectEvent @ 0x1C0094480 (EtwTraceTokenCompositionSurfaceObjectEvent.c)
 * Callees:
 *     McGenEventWrite @ 0x1C006C7F8 (McGenEventWrite.c)
 *     __security_check_cookie @ 0x1C00BAF90 (__security_check_cookie.c)
 */

ULONG McTemplateK0ppqxxxqqq(struct _MCGEN_TRACE_CONTEXT *a1, __int64 a2, __int64 a3, ...)
{
  ...
  v20 = 4LL;
  v22 = 4LL;
  return McGenEventWrite(a1, &TokenCompositionSurfaceObjectEvent, (LPCGUID)&Context.Flags, 0xAu, &EventData);
}
