/*
 * XREFs of GreCombineRgn @ 0x1C00242A0
 * Callers:
 ...
 *     NtGdiCombineRgn @ 0x1C0094140 (NtGdiCombineRgn.c)
...
LABEL_249:
      ...
      if ( v12 != prgnDefault )
      {
          ...
          && *((_DWORD *)v95[0] + 25) >= *((_DWORD *)v97[0] + 25) )
        {
          ...
          if ( dword_1C02149A0 >= v23 )
          {
            v24 = Win32AllocateFromPagedLookasideList(qword_1C02158D0);
            if ( v24 )
            {
              *(_QWORD *)v24 = 0LL;
              *(_QWORD *)(v24 + 8) = 0LL;
            ...
            if ( v7 == a2 )
            {
              if ( (unsigned int)HmgReplaceObject(v17, (__m128i *)v46) )
              {
                ...
                *((_DWORD *)v46 + 9) = v51;
                ...
                {
                  if ( !v52 )
                    PushThreadGuardedObject((char *)v46 + 48, v95[0], CleanUpRegion);
                  if ( !v8 )
                  {
