/*
 * XREFs of ?UpdateContactRestingState@CPTPEngine@@AEAAXPEAUPTPInput@@UtagPOINT@@_KPEAUCContactState@@@Z @ 0x1C01998B8
 * Callers:
        ...
        struct CContactState *a5)
{
  ...
  v14 = *((_DWORD *)this + 743) == 6 && !__CFSHR__(*(_DWORD *)a5, 8);
  if ( (v10 & 0x200) == 0 && !v14 )
  {
    ...
    if ( v8 >= v15 / 0x3E8 || !v12 )
    {
      ...
      if ( v12 )
      {
        ...
        if ( *((_DWORD *)this + 743) == 2
          && v13
          && (v19 = (CPTPEngine *)((char *)this + 296 * *((unsigned int *)this + 734) + 1160), a5 != v19)
          && (*(_DWORD *)v19 & 0x80u) == 0
        ...
        if ( y >= v17 || !PtInRect((_DWORD *)this + 12, *(_QWORD *)&a3) && v13 || v9 <= *((_QWORD *)this + 384) )
        {
  ...
  if ( *((_DWORD *)this + 743) == 1 && v13 && (*(_DWORD *)a5 & 4) != 0 && *(int *)a5 < 0 )
  {
    for ( i = 0; i < 6; ++i )
    {
      v25 = (CPTPEngine *)((char *)this + 296 * i + 1160);
      if ( a5 != v25 )
      {
        v26 = *(_DWORD *)v25;
        if ( (*(_DWORD *)v25 & 1) != 0
...
LABEL_61:
  *((_DWORD *)this + 815) &= ~1u;
  if ( *((_DWORD *)this + 743) == 1 )
  {
    ...
    for ( j = (CPTPEngine *)((char *)this + 2936); v30 != j; v30 = (struct CContactState *)((char *)v30 + 296) )
    {
