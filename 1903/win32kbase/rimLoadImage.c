/*
 * XREFs of rimLoadImage @ 0x1C005C910
 * Callers:
      ...
      if ( v7 != -1073741820 )
      {
        if ( v7 >= 0 )
        {
          ...
          if ( *v6 )
          {
            ...
            v10 = *(void **)&v6[74 * v8 + 6];
            qword_1C0215428 = (__int64)RtlImageDirectoryEntryToData(
                                         *(PVOID *)&v6[74 * v9 + 6],
                                         1u,
                                         0,
                                         &DestinationString);
            ...
            qword_1C0215418 = 0LL;
            qword_1C0215420 = (__int64)v10 + AddressOfEntryPoint;
            v1 = 1;
            qword_1C0215410 = (__int64)v10;
          }
        }
LABEL_15:
