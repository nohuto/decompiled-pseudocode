/*
 * XREFs of ?AddCrossChannelVisualChild@CApplicationChannel@DirectComposition@@SAJIIIIHII@Z @ 0x1C0001C10
 * Callers:
 *     NtDCompositionAddCrossDeviceVisualChild @ 0x1C0001BE0 (NtDCompositionAddCrossDeviceVisualChild.c)
 * Callees:
...
LABEL_15:
  ...
  {
    if ( SystemVisualFromCrossChannelVisualChild < 0
      && (int)DirectComposition::CApplicationChannel::ReferenceHandleAndLock(a3, &v21) >= 0 )
    {
      v18 = v21;
