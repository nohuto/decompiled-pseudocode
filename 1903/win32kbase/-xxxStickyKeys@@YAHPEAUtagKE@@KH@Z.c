/*
 * XREFs of ?xxxStickyKeys@@YAHPEAUtagKE@@KH@Z @ 0x1C015FB40
 * Callers:
 *     <none>
 * Callees:
...
_BOOL8 __fastcall xxxStickyKeys(struct tagKE *a1, unsigned int a2, __int64 a3)
{
  ...
  if ( v10 == 10 || v11 == 10 )
  {
    if ( (dword_1C0214614 & 4) != 0 )
    {
      if ( (dword_1C0214614 & 1) != 0 )
      {
        xxxTurnOffStickyKeys();
        if ( (dword_1C0214614 & 0x10) != 0 )
