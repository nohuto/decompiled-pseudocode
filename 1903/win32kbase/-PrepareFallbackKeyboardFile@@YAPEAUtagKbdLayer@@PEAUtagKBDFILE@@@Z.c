/*
 * XREFs of ?PrepareFallbackKeyboardFile@@YAPEAUtagKbdLayer@@PEAUtagKBDFILE@@@Z @ 0x1C01803FC
 * Callers:
...
struct tagKbdLayer *__fastcall PrepareFallbackKeyboardFile(struct tagKBDFILE *a1)
{
  ...
  if ( result )
  {
    ...
    *((_OWORD *)result + 1) = unk_1C0247040;
    *((_OWORD *)result + 2) = *(_OWORD *)&off_1C0247050;
    *((_OWORD *)result + 3) = *(_OWORD *)&off_1C0247060;
    *((_OWORD *)result + 4) = *(_OWORD *)&off_1C0247070;
    *((_OWORD *)result + 5) = xmmword_1C0247080;
    *((_QWORD *)result + 12) = qword_1C0247090;
  }
  *((_QWORD *)a1 + 6) = 0LL;
  *((_QWORD *)a1 + 3) = result;
  return result;
