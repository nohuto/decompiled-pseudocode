/*
 * XREFs of RIMFixUpAutoRepeatCompleteFrameUpDowns @ 0x1C014F678
 * Callers:
        ...
        if ( v18 )
        {
          ...
          if ( (unsigned int)v19 < v18 )
          {
            do
            {
              ...
              {
                memmove(
                  (void *)(*(_QWORD *)(a3 + 112) + 192 * v19),
                  (const void *)(*(_QWORD *)(a3 + 112) + 192LL * (unsigned int)(v19 + 1)),
                  0xC0uLL);
                v20 = *(_DWORD *)(a3 + 24);
                v22 = v20;
              }
