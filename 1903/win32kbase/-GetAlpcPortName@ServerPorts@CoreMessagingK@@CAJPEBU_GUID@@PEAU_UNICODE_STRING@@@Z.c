/*
 * XREFs of ?GetAlpcPortName@ServerPorts@CoreMessagingK@@CAJPEBU_GUID@@PEAU_UNICODE_STRING@@@Z @ 0x1C00AB6C8
 * Callers:
 ...
 * Callees:
 *     ?RtlStringCbLengthW@@YAJPEBG_KPEA_K@Z @ 0x1C00AB75C (-RtlStringCbLengthW@@YAJPEBG_KPEA_K@Z.c)
