/*
 * XREFs of ?RimDeviceFlags@RIM@InputTraceLogging@@SAXPEBURIMDEV@@@Z @ 0x1C0134700
 * Callers:
...
void __fastcall InputTraceLogging::RIM::RimDeviceFlags(const struct RIMDEV *a1)
{
  ...
  if ( dword_1C020FB50 > 4u )
  {
    if ( TlgKeywordOn((TraceLoggingHProvider)&dword_1C020FB50, 0x100uLL) )
    {
      ...
      v128 = &v45;
      v45 = -__CFSHR__(v4, 10);
      TlgWrite((TraceLoggingHProvider)&dword_1C020FB50, &unk_1C01E3FC8, 0LL, 0LL, 0x2Bu, &pData);
    }
  }
}
