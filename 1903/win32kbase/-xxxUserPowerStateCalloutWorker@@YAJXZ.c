/*
 * XREFs of ?xxxUserPowerStateCalloutWorker@@YAJXZ @ 0x1C005A854
 * Callers:
 ...
 *     EnterPowerCrit @ 0x1C00A9100 (EnterPowerCrit.c)
 *     LeavePowerCrit @ 0x1C00A9130 (LeavePowerCrit.c)
...
__int64 xxxUserPowerStateCalloutWorker(void)
{
  ...
  if ( v0 == 2 )
  {
    ...
    if ( !gbTtmEnabled )
      PowerOffMonitor((enum POWER_MONITOR_REQUEST_REASON)dword_1C0213C1C);
    ...
    if ( gSessionId != gServiceSessionId )
    {
      ...
      LOBYTE(v22) = 1;
      xxxSendWinlogonPowerMessage(v22, 262LL, &dword_1C0213C08);
    ...
    if ( !(unsigned int)PowerResumeSuspendEvent(v21, v20, 0LL) && (int)IsxxxSendMessageBSMSupported() >= 0 )
    {
      ...
      dword_1C0213BE0 = 16;
      dword_1C0213BE4 = 40;
      Arg1 = &dword_1C0213BE0;
      xxxSendMessageBSM(0LL, 536LL, 4LL);
    }
    if ( dword_1C0213C0C == 5 )
    {
      if ( gProtocolType )
      {
LABEL_88:
...
LABEL_90:
      ...
      if ( (dword_1C0213C10 & 8) != 0 )
      {
        if ( qword_1C0215220 )
          v24 = qword_1C0215220(0LL, 0LL);
        else
          v24 = 0;
        if ( v24 && grpdeskRitInput )
        {
          LOBYTE(v28) = 0;
          xxxUserSetDisplayConfig(0LL, 0LL, 2191LL, 0LL, grpdeskRitInput, v28, 0LL, 0LL, 0LL, v36);
        }
      }
      else
      {
        LOBYTE(v23) = 1;
        xxxSendWinlogonPowerMessage(v23, 259LL, &dword_1C0213C08);
      }
    }
      ...
      else
      {
        ...
        else if ( v0 == 13 )
        {
          ...
          if ( gSessionId != gServiceSessionId )
          {
            EtwTraceWinlogonSleepStartEvent(1LL);
            LOBYTE(v8) = 1;
            xxxSendWinlogonPowerMessage(v8, 263LL, &dword_1C0213C08);
            EtwTraceWinlogonSleepStartEvent(0LL);
          }
        }
      }
