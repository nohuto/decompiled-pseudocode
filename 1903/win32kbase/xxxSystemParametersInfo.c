/*
 * XREFs of xxxSystemParametersInfo @ 0x1C0079CC0
 * Callers:
 ...
 *     ?IsSPIActionAllowedForFilteredProcess@@YAHI@Z @ 0x1C01211D4 (-IsSPIActionAllowedForFilteredProcess@@YAHI@Z.c)
...
__int64 __fastcall xxxSystemParametersInfo(unsigned int a1, unsigned int a2, _DWORD *a3, unsigned int a4)
{
  ...
  if ( IsWin32KFilterEnabled && !(unsigned int)IsSPIActionAllowedForFilteredProcess(v15) )
  {
    ...
    if ( dword_1C020F500 > 5u && TlgKeywordOn((TraceLoggingHProvider)&dword_1C020F500, 0x400000000000uLL) )
    {
      v21 = 0;
      v19 = &v15;
      v20 = 4;
      TlgWrite((TraceLoggingHProvider)&dword_1C020F500, &unk_1C01E3E13, 0LL, 0LL, 3u, &pData);
    }
    return 0LL;
  }
  v8 = a4 & 1;
