/*
 * XREFs of ?DrvGetRegistryHandleFromDeviceMap@@YAPEAXPEAUtagGRAPHICS_DEVICE@@W4_DISP_DRIVER_REGISTRY_TYPE@@PEBKPEAGKPEAJ@Z @ 0x1C001497C
 * Callers:
        ...
        NTSTATUS *a6)
{
  ...
  *(_QWORD *)&DestinationString.Length = 0LL;
  ...
  v13 = *((_DWORD *)a1 + 40) & 8;
  v71 = (WCHAR *)PALLOCMEM2(0x200uLL, 0x706D7447u, 1);
  v14 = v71;
  if ( v71 )
  {
...
LABEL_6:
      ...
      *(_OWORD *)&ObjectAttributes.SecurityDescriptor = 0LL;
      ...
      if ( v15 < 0 )
        goto LABEL_117;
      v10 = (WCHAR *)PALLOCMEM2(0x400uLL, 0x706D7447u, 1);
      if ( !v10 )
      {
        v15 = -1073741670;
        goto LABEL_25;
      ...
      v15 = ZwQueryValueKey(KeyHandle, &DestinationString, KeyValueFullInformation, v10, 0x200u, &ResultLength);
      if ( v15 < 0 )
      {
LABEL_24:
        ZwClose(KeyHandle);
...
LABEL_117:
      ...
      *(_QWORD *)&Destination.Length = 0LL;
      ...
      if ( *v18 )
      {
        ...
        while ( *v18 );
        LODWORD(v17) = *((_DWORD *)v10 + 2);
      }
      v20 = wcsstr((WCHAR *)((char *)v10 + (unsigned int)v17), L"\\CONTROL\\");
      if ( !v20 )
        v20 = wcsstr((WCHAR *)((char *)v10 + *((unsigned int *)v10 + 2)), L"\\SERVICES");
      v21 = -1LL;
      if ( a4 )
      {
        v32 = a5 - 1;
        ...
        do
          ++v33;
        while ( *(WCHAR *)((char *)&v10[v33] + *((unsigned int *)v10 + 2)) );
        v34 = 102;
        v35 = (int)v33;
        *(_QWORD *)Length = 102LL;
        ...
        v36 = (char *)PALLOCMEM2((unsigned int)v34, 0x73726447u, 1);
        v83 = v36;
        v37 = v36;
        if ( v36 )
        {
          ...
          StringCchCopyW(v37, v38, (char *)v10 + *((unsigned int *)v10 + 2));
...
LABEL_81:
      ...
      if ( v84 )
      {
        ...
        do
          ++v21;
        while ( v20[v21] );
        StringCchPrintfW(&v20[v21], 512 - ((unsigned int)(v20 - v10) >> 1) - (unsigned int)v67, L"\\Mon%08X", *v84);
      }
      *(_DWORD *)&Destination.Length = 33423360;
      Destination.Buffer = v10 + 256;
