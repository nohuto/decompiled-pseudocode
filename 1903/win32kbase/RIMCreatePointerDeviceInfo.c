/*
 * XREFs of RIMCreatePointerDeviceInfo @ 0x1C013DBB8
 * Callers:
  ...
  *((_QWORD *)v11 + 108) = v11 + 216;
  ...
  if ( v15 < 0 )
  {
    ...
    if ( dword_1C020F490 > 5u && TlgKeywordOn((TraceLoggingHProvider)&dword_1C020F490, 0x400000000000uLL) )
    {
      ...
      TlgWrite((TraceLoggingHProvider)&dword_1C020F490, &unk_1C01E4AB2, 0LL, 0LL, 5u, &pData);
    }
  }
  if ( (int)RIMGetDeviceLocationInfo(v14, a2 + 2088) < 0 )
      ...
      if ( !v23 )
      {
        ...
        if ( v26 == -1073741668 )
        {
          if ( dword_1C020F490 > 5u && TlgKeywordOn((TraceLoggingHProvider)&dword_1C020F490, 0x400000000000uLL) )
          {
            ...
            TlgWrite((TraceLoggingHProvider)&dword_1C020F490, &unk_1C01E4AB2, 0LL, 0LL, v36, &pData);
          }
          goto LABEL_30;
        }
        goto LABEL_20;
  ...
  if ( (int)rimHidP_GetSpecificValueCaps(0, 13, 0, 86, (__int64)v116, (__int64)&v94, v7) >= 0 )
  {
    if ( v116[10] >= v116[11] || v116[10] < 0 || v116[11] < 0xFFFF )
    {
      if ( dword_1C020F490 > 5u && TlgKeywordOn((TraceLoggingHProvider)&dword_1C020F490, 0x400000000000uLL) )
      {
        ...
        TlgWrite((TraceLoggingHProvider)&dword_1C020F490, &unk_1C01E4AB2, 0LL, 0LL, v38, &pData);
      }
LABEL_71:
      v26 = -1073741668;
      goto LABEL_30;
  ...
  if ( SpecificValueCaps && SpecificValueCaps != -1072627705 )
  {
    if ( dword_1C020F490 > 5u && TlgKeywordOn((TraceLoggingHProvider)&dword_1C020F490, 0x400000000000uLL) )
    {
      ...
      TlgWrite((TraceLoggingHProvider)&dword_1C020F490, &unk_1C01E4AB2, 0LL, 0LL, v28, &pData);
    }
    goto LABEL_30;
  }
  v39 = 6LL;
      ...
      *(_DWORD *)(v12 + 724) = v45;
      ...
      if ( v100 == -1 || v98 == -1 )
      {
        if ( dword_1C020F490 > 5u && TlgKeywordOn((TraceLoggingHProvider)&dword_1C020F490, 0x400000000000uLL) )
        {
          ...
          TlgCreateWsz(&v120, *(LPCWSTR *)(a2 + 216));
          TlgCreateWsz(&v121, L"coordinate usage missing");
          TlgWrite((TraceLoggingHProvider)&dword_1C020F490, &unk_1C01E4AB2, 0LL, 0LL, v90, &pData);
        }
      }
             ...
             || v102[2].m128i_i32[18 * v98 + 3] == v102[2].m128i_i32[18 * v98 + 2] )
      {
        if ( dword_1C020F490 > 5u && TlgKeywordOn((TraceLoggingHProvider)&dword_1C020F490, 0x400000000000uLL) )
        {
          ...
          TlgWrite((TraceLoggingHProvider)&dword_1C020F490, &unk_1C01E4AB2, 0LL, 0LL, v88, &pData);
        }
      }
      else
      {
        ...
        if ( v74 == 7 )
        {
          ...
          if ( (int)ApiSetValidateDeviceSignature(v103, v108, v7, (_DWORD)a4, v12, (__int64)&v104, 0) < 0 )
          {
            ...
            if ( dword_1C020F490 > 5u && TlgKeywordOn((TraceLoggingHProvider)&dword_1C020F490, 0x400000000000uLL) )
            {
              ...
              TlgWrite((TraceLoggingHProvider)&dword_1C020F490, &unk_1C01E4AB2, 0LL, 0LL, v85, &pData);
            }
            goto LABEL_30;
          }
        }
          ...
          if ( *a4 == 4 )
          {
            ...
            if ( (int)ApiSetValidateDeviceSignature(v103, v108, v7, (_DWORD)a4, v12, (__int64)&v104, v98) < 0 )
            {
              ...
              if ( dword_1C020F490 > 5u && TlgKeywordOn((TraceLoggingHProvider)&dword_1C020F490, 0x400000000000uLL) )
              {
                ...
                TlgCreateWsz(&v120, *(LPCWSTR *)(a2 + 216));
                TlgCreateWsz(&v121, L"Failed to validate device signature");
                TlgWrite((TraceLoggingHProvider)&dword_1C020F490, &unk_1C01E4AB2, 0LL, 0LL, v79, &pData);
              }
              v29 = v95;
              goto LABEL_31;
            }
        ...
        {
          v81 = HMValidateSharedHandleNoRip(*(_QWORD *)(a2 + 1328), 1LL, v73);
