/*
 * XREFs of ?Initialize@CMouseRawInput@CMouseProcessor@@QEAAXAEBVCMouseEvent@2@@Z @ 0x1C0032CC0
 * Callers:
        ...
        const struct CMouseProcessor::CMouseEvent *a2)
{
  ...
  *((_QWORD *)this + 7) = *(_OWORD *)&_mm_unpackhi_pd((__m128d)0LL, (__m128d)0LL);
  v4 = *(_DWORD *)(*((_QWORD *)a2 + 1) + 104LL) & 0x10;
  *((_BYTE *)this + 69) = v4 != 0;
  if ( !v4 )
  {
    *((_QWORD *)this + 4) = *(_QWORD *)(*((_QWORD *)a2 + 1) + 80LL);
    *((_QWORD *)this + 3) = *(_QWORD *)(*((_QWORD *)a2 + 1) + 72LL);
    v5 = *((_QWORD *)a2 + 1);
    ...
    *(_WORD *)this = *((_WORD *)this + 35) & *(_WORD *)(*((_QWORD *)a2 + 1) + 36LL);
    ...
    if ( (*(_DWORD *)(*((_QWORD *)a2 + 1) + 104LL) & 0x20) != 0 )
      *((_DWORD *)this + 16) = v2 | 2;
  }
}
