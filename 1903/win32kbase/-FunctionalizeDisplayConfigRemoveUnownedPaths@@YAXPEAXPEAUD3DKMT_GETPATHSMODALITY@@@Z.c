/*
 * XREFs of ?FunctionalizeDisplayConfigRemoveUnownedPaths@@YAXPEAXPEAUD3DKMT_GETPATHSMODALITY@@@Z @ 0x1C012BB08
 * Callers:
...
void __fastcall FunctionalizeDisplayConfigRemoveUnownedPaths(void *a1, struct D3DKMT_GETPATHSMODALITY *a2)
{
  ...
  *((_WORD *)a2 + 10) = 0;
  ...
  if ( v2 )
  {
    ...
    do
    {
      if ( (unsigned __int8)((__int64 (__fastcall *)(void *, _QWORD, _QWORD))qword_1C0215308)(
                              a1,
                              *v8,
                              *((unsigned int *)v7 + 7)) )
      {
