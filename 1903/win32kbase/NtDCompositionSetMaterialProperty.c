/*
 * XREFs of NtDCompositionSetMaterialProperty @ 0x1C008E410
 * Callers:
 *     <none>
 * Callees:
 ...
 *     ?Store@MaterialProperty@@QEAAJPEBUResourceObject@DirectComposition@@@Z @ 0x1C008E504 (-Store@MaterialProperty@@QEAAJPEBUResourceObject@DirectComposition@@@Z.c)
 *     FindOrCreateMaterialProperty @ 0x1C008E578 (FindOrCreateMaterialProperty.c)
 *     CheckShellExperienceComposerAccess @ 0x1C01A315C (CheckShellExperienceComposerAccess.c)
 */
