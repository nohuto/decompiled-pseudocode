/*
 * XREFs of TransformRectBetweenCoordinateSpaces @ 0x1C003F670
 * Callers:
 ...
 *     IsDpiAwarenessBoundaryInParentChain @ 0x1C011243C (IsDpiAwarenessBoundaryInParentChain.c)
 */
...
__int64 __fastcall TransformRectBetweenCoordinateSpaces(_OWORD *a1, __int64 a2, __int64 a3, __int64 a4)
{
    ...
    && ((a2 = 0x20000000LL, (CurrentThreadDpiAwarenessContext & 0xF) == 2)
     && (CurrentThreadDpiAwarenessContext & 0x20000000) != 0
      ...
      : (v24 = 0),
        ...
        v24 == v25)
    || ((v13 = (unsigned int)*v6, (int)v13 >= v6[2]) || v6[1] >= v6[3]) && !(_DWORD)v13 && !v6[1] )
  {
    *a1 = v10;
    return 0LL;
  }
    ...
    if ( v23 )
    {
      if ( v23 != a3 )
      {
        if ( (unsigned int)IsDpiAwarenessBoundaryInParentChain(a3) )
        {
          ...
          if ( v30 )
            return TransformRectBetweenCoordinateSpacesPerMonitor(a1, v6, CurrentThreadDpiAwarenessContext, v9, v30);
        }
      }
    }
  }
  ...
  do
  {
    ...
    if ( (unsigned int)IntersectRect(&v45, (int *)&v43, v6) )
    {
      if ( v39 )
      {
        v31 = HIDWORD(v46);
      ...
      v40 = v17;
      v11 |= TransformRectBetweenCoordinateSpacesPerMonitor(&v45, &v45, CurrentThreadDpiAwarenessContext, v9, v14);
      if ( !v39 )
      {
        v18 = 1;
        v47 = v45;
...
LABEL_74:
  if ( (int)Is_MonitorFromRectSupported(v13, a2, v12) >= 0 )
  {
    ...
    v37 = TransformRectBetweenCoordinateSpacesPerMonitor(&v47, v6, CurrentThreadDpiAwarenessContext, v9, v38);
LABEL_76:
    v11 |= v37;
  }
LABEL_21:
