/*
 * XREFs of RIMVirtCreateDev @ 0x1C014DED4
 * Callers:
        ...
        struct _UNICODE_STRING **a6)
{
  ...
  if ( a4 )
  {
    ...
    *(_DWORD *)&Dev[25].Length = *(_DWORD *)(a5 + 1280);
    HIDWORD(Dev[81].Buffer) = *(_DWORD *)(a5 + 1284);
    *(_QWORD *)&Dev[82].Length = FindRimDevByName((PCUNICODE_STRING)(a5 + 1288));
...
LABEL_56:
        LOBYTE(v16) = 2;
        WPP_RECORDER_SF_((_DWORD)gRimLog, v16, 1, v17, (__int64)&WPP_03619aaa3eac3f95e9b05f540081c405_Traceguids);
        goto LABEL_57;
      }
      goto LABEL_57;
    }
...
LABEL_57:
  ...
  if ( !LOBYTE(Dev[3].Length) )
  {
    ...
    *(&Dev[55].MaximumLength + 1) = *(_WORD *)(a5 + 88);
    *(&Dev[55].MaximumLength + 2) = *(_WORD *)(a5 + 92);
    LOWORD(Dev[55].Buffer) = *(_WORD *)(a5 + 96);
    if ( a4 )
    {
    ...
    else
    {
      ...
      {
        LOBYTE(v19) = 3;
        WPP_RECORDER_SF_((_DWORD)gRimLog, v19, 1, 27, (__int64)&WPP_03619aaa3eac3f95e9b05f540081c405_Traceguids);
      }
      v37 = 0LL;
      ...
      else
      {
        ...
        {
          LOBYTE(v28) = 4;
          WPP_RECORDER_SF_((_DWORD)gRimLog, v28, 1, 28, (__int64)&WPP_03619aaa3eac3f95e9b05f540081c405_Traceguids);
        }
      }
    }
  }
