/*
 * XREFs of ?Free@?$CTypeIsolation@$0HAAA@$0HA@@NSInstrumentation@@IEAAXPEAX@Z @ 0x1C00BD37C
 * Callers:
 ...
 *     ?CheckAllocationStatus@?$CSectionBitmapAllocator@$0HAAA@$0HA@@NSInstrumentation@@QEAA?AW4AllocationStatus@2@PEBX@Z @ 0x1C00BD224 (-CheckAllocationStatus@-$CSectionBitmapAllocator@$0HAAA@$0HA@@NSInstrumentation@@QEAA-AW4Allocat.c)
    ...
    if ( !*(_BYTE *)(a1 + 36) )
    {
      ...
      for ( i = *(_QWORD **)a1; ; i = (_QWORD *)*i )
      {
        ...
        if ( v7 )
        {
          ...
          if ( !v8 )
          {
            NSInstrumentation::CSectionBitmapAllocator<28672,112>::Free((__int64)v6, a2);
            GreLeaveCriticalRegionAndReleasePushLockShared((__int64)v4);
            return;
          }
          v9 = v8 - 1;
