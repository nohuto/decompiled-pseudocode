/*
 * XREFs of bMigrateSurfaceForConversion @ 0x1C0058D60
 * Callers:
 ...
 *     ?bUnMap@SURFREFVIEW@@QEAAHXZ @ 0x1C00615D0 (-bUnMap@SURFREFVIEW@@QEAAHXZ.c)
 ...
 *     ?LockLogicalSurfaceObj@SFMLOGICALSURFACEREF@@AEAAXPEAUHLSURF__@@@Z @ 0x1C009DF3C (-LockLogicalSurfaceObj@SFMLOGICALSURFACEREF@@AEAAXPEAUHLSURF__@@@Z.c)
 *     HmgQueryAltLock @ 0x1C009EAB0 (HmgQueryAltLock.c)
 *     ?SwapShareCount@OBJECT@@SAXPEAV1@0@Z @ 0x1C009F0A4 (-SwapShareCount@OBJECT@@SAXPEAV1@0@Z.c)
 *     ??1SFMLOGICALSURFACEREF@@QEAA@XZ @ 0x1C009FCA0 (--1SFMLOGICALSURFACEREF@@QEAA@XZ.c)
...
__int64 __fastcall bMigrateSurfaceForConversion(struct OBJECT *a1, struct _BASEOBJECT *a2, int a3, struct OBJECT *a4)
{
  ...
  struct OBJECT *v79; // [rsp+48h] [rbp-B8h] BYREF
  _QWORD v80[2]; // [rsp+50h] [rbp-B0h] BYREF
  ...
  struct _SURFOBJ *v87; // [rsp+98h] [rbp-68h]
  struct _SURFOBJ *v88; // [rsp+A0h] [rbp-60h]
  __int128 v89; // [rsp+B0h] [rbp-50h]
  __int128 v90; // [rsp+C0h] [rbp-40h]
  ...
  __int64 v100; // [rsp+160h] [rbp+60h] BYREF
  ...
  v88 = v8;
  SURFREFVIEW::bMap((SURFREFVIEW *)v80, v8);
  v82[0] = 0LL;
  v87 = (struct _SURFOBJ *)(((unsigned __int64)a2 + 24) & -(__int64)(a2 != 0LL));
  SURFREFVIEW::bMap((SURFREFVIEW *)v82, v87);
  *(_DWORD *)a4 = 0;
  v9 = *((_DWORD *)a1 + 28);
  if ( (v9 & 0x80100000) != 0 )
  {
    ...
    v82[0] = 0LL;
    SURFREFVIEW::bUnMapImmediate((SURFREFVIEW *)v80);
    v80[0] = 0LL;
    goto LABEL_73;
  }
  if ( *((_WORD *)a1 + 50) == 3 )
...
LABEL_8:
        ...
        v12) )
  {
    if ( (*(_DWORD *)(v11 + 40) & 0x20000) != 0 )
      *((_DWORD *)a1 + 29) &= ~0x10u;
    v14 = *(_DWORD *)a1;
    v81 = *((_DWORD *)a1 + 29) & 0x80;
    v15 = v14 & 0x800000;
    if ( !v15 || (v78 = 1, (*((_WORD *)a1 + 51) & 0x200) == 0) )
      v78 = 0;
    if ( !v15 || (v77 = 1, (*((_WORD *)a1 + 51) & 0x400) == 0) )
      v77 = 0;
    v16 = *((_QWORD *)a1 + 4);
    ...
    SFMLOGICALSURFACEREF::LockLogicalSurfaceObj((SFMLOGICALSURFACEREF *)&v83, HLSURFCloneWrap);
    if ( !v83 )
    {
      v7 = 0;
    }
      ...
      *((_DWORD *)a2 + 29) ^= (v35 ^ *((_DWORD *)a2 + 29)) & 0x390D;
      ...
      if ( v13 )
      {
        ...
        if ( v22 && (int)IsvSpDwmMigrateSpriteLSurfReferenceSupported() >= 0 )
          vSpDwmMigrateSpriteLSurfReferenceWrap(*((_QWORD *)v10 + 6), v85, a2, v83);
        while ( 1 )
        {
      ...
      if ( (*((_DWORD *)a2 + 29) & 4) != 0 )
      {
        ...
        if ( v67 )
        {
          if ( *(HLSURF **)(v67 + 24) != v13 && (int)IsMulReplaceRedirectionChildSupported() >= 0 )
            MulReplaceRedirectionChild(*(_QWORD *)(v68 + 24), v88, v87);
...
LABEL_64:
        if ( !v7 && v78 != (_DWORD)v13 )
        {
          *((_WORD *)a2 + 51) &= ~0x200u;
          v74 = *(_DWORD *)a1 & 0x800000;
          if ( v74 )
            *((_WORD *)a1 + 51) |= 0x200u;
          if ( v77 != (_DWORD)v13 && v74 )
            *((_WORD *)a1 + 51) |= 0x400u;
        }
        goto LABEL_71;
      }
      v79 = (struct OBJECT *)HmgShareLockCheck(*((_QWORD *)a1 + 4), 5);
      SURFREFVIEW::bUnMapImmediate((SURFREFVIEW *)v80);
      v80[0] = v13;
      v7 = SURFREF::bDeleteSurface(&v79, 0LL);
      if ( !v7 )
        *((_QWORD *)a1 + 70) = v13;
      SURFREF::~SURFREF(&v79);
      if ( v7 )
    ...
    v69 = *((_QWORD *)a1 + 4);
    v70 = HmgQueryAltLock(v69);
    v71 = *((_QWORD *)a2 + 4);
    v72 = v70;
    v73 = HmgQueryAltLock(v71);
    HmgSwapLockedHandleContents(v71, v73, v69, v72, 5);
    v13 = 0LL;
    goto LABEL_62;
  }
  v7 = 0;
