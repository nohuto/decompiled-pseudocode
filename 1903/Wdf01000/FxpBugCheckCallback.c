/*
 * XREFs of FxpBugCheckCallback @ 0x1C0094F10
 * Callers:
 *     <none>
 * Callees:
...
LABEL_9:
        ...
        if ( !unk_1C00AEEA0
          ...
          && *(_FX_DRIVER_GLOBALS **)((char *)&stru_1C00AEE88.m_DriverUsage->FxDriverGlobals
                                    + HIDWORD(KeGetPcr()[1].LockArray) * stru_1C00AEE88.m_EntrySize) == p_Checksum )
        {
          goto LABEL_9;
        }
      }
