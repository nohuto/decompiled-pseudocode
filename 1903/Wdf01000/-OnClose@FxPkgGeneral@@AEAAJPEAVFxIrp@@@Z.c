/*
 * XREFs of ?OnClose@FxPkgGeneral@@AEAAJPEAVFxIrp@@@Z @ 0x1C000A620
 * Callers:
...
__int64 __fastcall FxPkgGeneral::OnClose(FxPkgGeneral *this, FxIrp *FxIrp)
{
  ...
  unsigned __int8 v41; // [rsp+98h] [rbp+10h] BYREF
...
LABEL_9:
          ...
          i = (FxPkgGeneral *)i->__vftable )
    {
      ...
      if ( Flink )
      {
        ...
        if ( m_ParentObject )
        {
          ((void (__fastcall *)(FxObject *, unsigned __int8 *))m_ParentObject->Release)(m_ParentObject, &v41);
        ...
        if ( v15 )
          ((void (__fastcall *)(FxObject *, _QWORD))v15->AddRefOverride)(v15, v41);
      }
    }
    m_Irp = FxIrp->m_Irp;
...
$Passthru:
  ...
  if ( !v27 && _InterlockedExchangeAdd(&this->m_OpenHandleCount, 0xFFFFFFFF) == 1 )
  {
    ...
    if ( BYTE5(v38[1].m_Globals) )
      FxObject::DeleteObject(v38);
  }
  if ( v3 )
