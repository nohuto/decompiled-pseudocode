/*
 * XREFs of imp_WdfUsbTargetPipeWriteSynchronously @ 0x1C006C010
 * Callers:
 *     <none>
 * Callees:
        ...
        unsigned int *BytesWritten)
{
  ...
  if ( BYTE4(DriverGlobals[-2].Driver) )
    WPP_IFR_SF_q(
      ...
      Pipe);
  return FxUsbPipe::_SendTransfer(DriverName, Pipe, Request, RequestOptions, MemoryDescriptor, BytesWritten, 0);
}
