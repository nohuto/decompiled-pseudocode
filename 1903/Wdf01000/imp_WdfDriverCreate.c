/*
 * XREFs of imp_WdfDriverCreate @ 0x1C004D2A0
 * Callers:
 *     <none>
 * Callees:
        ...
        WDFDRIVER__ **Driver)
{
  ...
  bool v29; // [rsp+51h] [rbp-AFh] BYREF
  _WDF_DRIVER_GLOBALS *v30; // [rsp+58h] [rbp-A8h] BYREF
  ...
  if ( (int)result >= 0 )
  {
    ...
    {
      if ( *((_QWORD *)DriverName + 9) || v30->Driver )
      {
        v11 = -1073741437;
        WPP_IFR_SF_qL(
          (_FX_DRIVER_GLOBALS *)DriverName,
          ...
          if ( Tlgg_TelemetryProviderProv.LevelPlus1 > 5 )
          {
            if ( TlgKeywordOn(&Tlgg_TelemetryProviderProv, 0x200000000000uLL) )
            {
              ...
              *(_QWORD *)&_TlgData[2].Size = 16LL;
              ...
              TlgCreateWsz(&_TlgData[5], L"01.029.0");
              v24 = *((_QWORD *)DriverName + 37);
              v32 = *(_DWORD *)(v24 + 16);
              _TlgData[6].Ptr = (unsigned __int64)&v32;
              *(_QWORD *)&_TlgData[6].Size = 4LL;
              v25 = *(_DWORD *)(v24 + 20);
              LODWORD(v24) = *((_DWORD *)DriverName + 110);
              LODWORD(v30) = v25;
              _TlgData[7].Ptr = (unsigned __int64)&v30;
              _TlgData[8].Ptr = (unsigned __int64)(DriverName + 316);
              v28 = v24 & 1;
              *(_QWORD *)&_TlgData[7].Size = 4LL;
              _TlgData[9].Ptr = (unsigned __int64)&v28;
              _TlgData[10].Ptr = (unsigned __int64)&v29;
              ...
              *(_QWORD *)&_TlgData[11].Size = 4LL;
              TlgWrite(&Tlgg_TelemetryProviderProv, (char *)&TlgEvent_1._TlgChannel, v26, v27, 0xCu, _TlgData);
            }
          }
