/*
 * XREFs of imp_WdfDeviceSetPowerCapabilities @ 0x1C0049D50
 * Callers:
 *     <none>
 * Callees:
 ...
 *     ?SetPowerCaps@FxPkgPnp@@QEAAXPEAU_WDF_DEVICE_POWER_CAPABILITIES@@@Z @ 0x1C0086834 (-SetPowerCaps@FxPkgPnp@@QEAAXPEAU_WDF_DEVICE_POWER_CAPABILITIES@@@Z.c)
 */
        ...
        _WDF_DEVICE_POWER_CAPABILITIES *PowerCapabilities)
{
  ...
  if ( PowerCapabilities->Size == 80 )
  {
    ...
    while ( 1 )
    {
      ...
      if ( v9 > 2 )
      {
        WPP_IFR_SF_qsd(m_Globals, (unsigned __int8)p_Offset, v9, 0x2Bu, traceGuid, Device, offsets_0[v6].Name, v9);
        goto LABEL_26;
      }
      ++v6;
      p_Offset += 16;
