/*
 * XREFs of RegistryWriteCurrentTime @ 0x1C0063058
 * Callers:
...
void __fastcall RegistryWriteCurrentTime(_FX_DRIVER_GLOBALS *DriverGlobals)
{
  ...
  _UNICODE_STRING wdfTimeOfLastTelemetryLog; // [rsp+80h] [rbp-88h] BYREF
  __int64 v12; // [rsp+90h] [rbp-78h]
  _OBJECT_ATTRIBUTES ObjectAttributes; // [rsp+98h] [rbp-70h] BYREF
  _OBJECT_ATTRIBUTES v14; // [rsp+C8h] [rbp-40h] BYREF
  _OBJECT_ATTRIBUTES v15; // [rsp+F8h] [rbp-10h] BYREF
  ...
  *(_QWORD *)&wdfTimeOfLastTelemetryLog.Length = parametersPart_buffer;
  wdfTimeOfLastTelemetryLog.Buffer = 0LL;
  v12 = 0LL;
  ...
  *(_QWORD *)&parametersPart.Length = 0LL;
  RtlInitUnicodeString((PUNICODE_STRING)&wdfTimeOfLastTelemetryLog.Buffer, L"TimeOfLastTelemetryLog");
...
LABEL_7:
  ...
  v14.RootDirectory = (void *)currentTime.QuadPart;
  v14.ObjectName = (_UNICODE_STRING *)&parametersPart.Buffer;
  *(_QWORD *)&v14.Length = 48LL;
  *(_QWORD *)&v14.Attributes = 576LL;
  *(_OWORD *)&v14.SecurityDescriptor = 0LL;
  v3 = ZwCreateKey(&hDriver.m_Key, 0x2001Fu, &v14, 0, 0LL, 0, 0LL);
  if ( v3 < 0 )
  {
    v4 = 14;
    goto LABEL_7;
  }
  v15.RootDirectory = hDriver.m_Key;
  v15.ObjectName = (_UNICODE_STRING *)&wdfPart.Buffer;
  *(_QWORD *)&v15.Length = 48LL;
  *(_QWORD *)&v15.Attributes = 576LL;
  *(_OWORD *)&v15.SecurityDescriptor = 0LL;
  v3 = ZwCreateKey(&hParameters.m_Key, 0x2001Fu, &v15, 0, 0LL, 0, 0LL);
  if ( v3 < 0 )
  {
    v4 = 15;
    goto LABEL_7;
  ...
  *(_QWORD *)&parametersPart.Length = MEMORY[0xFFFFF78000000014];
  v3 = ZwSetValueKey(
         hParameters.m_Key,
         (PUNICODE_STRING)&wdfTimeOfLastTelemetryLog.Buffer,
         0,
         0xBu,
         &parametersPart,
         8u);
