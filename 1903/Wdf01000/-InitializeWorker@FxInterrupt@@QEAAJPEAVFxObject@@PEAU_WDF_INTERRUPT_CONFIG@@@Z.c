/*
 * XREFs of ?InitializeWorker@FxInterrupt@@QEAAJPEAVFxObject@@PEAU_WDF_INTERRUPT_CONFIG@@@Z @ 0x1C008D718
 * Callers:
...
LABEL_10:
  ...
  if ( (int)result >= 0 )
  {
    ...
    if ( !this->m_EvtInterruptWorkItem && (!unk_1C00AEEA9 || !this->m_EvtInterruptDpc) )
      return 0LL;
