/*
 * XREFs of ?_IsAffectedByStateSeparationRegistryPolicy@FxRegKey@@SAJPEAU_FX_DRIVER_GLOBALS@@PEAXPEAE@Z @ 0x1C006350C
 * Callers:
        ...
        unsigned __int8 *IsAffectedResult)
{
  ...
  _UNICODE_STRING fullKeyPath; // [rsp+38h] [rbp-C8h] BYREF
  _UNICODE_STRING systemMachineHiveRoot; // [rsp+48h] [rbp-B8h] BYREF
  _UNICODE_STRING softwareMachineHiveRoot; // [rsp+58h] [rbp-A8h] BYREF
  ...
  keyNameInfo = 0LL;
  *(_QWORD *)&fullKeyPath.Length = 0LL;
  v3 = 0LL;
  keyNameInfoSize = 0;
  fullKeyPath.Buffer = 0LL;
