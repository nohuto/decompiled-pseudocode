/*
 * XREFs of ?Disconnect@FxInterrupt@@QEAAJK@Z @ 0x1C000D394
 * Callers:
 ...
 * Callees:
 *     ?DisconnectInternal@FxInterrupt@@QEAAXXZ @ 0x1C000D4A4 (-DisconnectInternal@FxInterrupt@@QEAAXXZ.c)
 *     ?InterruptDisable@FxInterrupt@@AEAAJXZ @ 0x1C000D4FC (-InterruptDisable@FxInterrupt@@AEAAJXZ.c)
