/*
 * XREFs of ?SelectConfigSingle@FxUsbDevice@@QEAAJPEAU_WDF_OBJECT_ATTRIBUTES@@PEAU_WDF_USB_DEVICE_SELECT_CONFIG_PARAMS@@@Z @ 0x1C007640C
 * Callers:
        ...
        _WDF_USB_DEVICE_SELECT_CONFIG_PARAMS *Params)
{
  ...
  const void *_a1; // rbx
  FxUsbInterface **m_Interfaces; // rsi
  _FX_DRIVER_GLOBALS **v10; // r11
  ...
  if ( m_NumInterfaces > 1u )
  {
    ...
    if ( !this->m_ObjectSize )
      _a1 = 0LL;
    WPP_IFR_SF_qdd(this->m_Globals, 2u, 0xEu, 0x1Bu, WPP_FxusbDeviceKm_cpp_Traceguids, _a1, m_NumInterfaces, 0xC000000D);
    return 3221225485LL;
  }
  ...
  *(_OWORD *)&listEntry[0].Interface = 0LL;
  ...
  if ( !listEntry[0].InterfaceDescriptor )
  {
    ...
    if ( !m_ObjectSize )
      v12 = 0LL;
    WPP_IFR_SF_qL(*v10, 2u, 0xEu, 0x1Cu, WPP_FxusbDeviceKm_cpp_Traceguids, v12, (*m_Interfaces)->m_InterfaceNumber);
    return 3221225485LL;
  }
  ConfigRequest = (_FILE_OBJECT *)FxUsbCreateConfigRequest(*v10, this->m_ConfigDescriptor, listEntry, 0xFFFFFFFF);
