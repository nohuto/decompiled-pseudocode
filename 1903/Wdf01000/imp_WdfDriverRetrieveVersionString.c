/*
 * XREFs of imp_WdfDriverRetrieveVersionString @ 0x1C004DA90
 * Callers:
 *     <none>
 * Callees:
        ...
        WDFSTRING__ *String)
{
  ...
  if ( result >= 0 )
  {
    ...
    v6 = L"Kernel Mode Driver Framework (verifier on) version 01.029.0";
    if ( !m_Globals->FxVerifierOn )
      v6 = L"Kernel Mode Driver Framework version 01.029.0";
