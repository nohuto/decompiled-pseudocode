/*
 * XREFs of imp_WdfDeviceSetDeviceState @ 0x1C0049A30
 * Callers:
 *     <none>
 * Callees:
 ...
 *     ?SetPnpState@FxPkgPnp@@QEAAXPEAU_WDF_DEVICE_STATE@@@Z @ 0x1C0086730 (-SetPnpState@FxPkgPnp@@QEAAXPEAU_WDF_DEVICE_STATE@@@Z.c)
 */
