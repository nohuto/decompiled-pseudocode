/*
 * XREFs of ?AddRemovalDevice@FxPkgPnp@@QEAAJPEAU_DEVICE_OBJECT@@@Z @ 0x1C0082C20
 * Callers:
...
LABEL_10:
    ...
    else
    {
      ...
      if ( !m_ObjectSize )
        v12 = 0LL;
      WPP_IFR_SF_qL(this->m_Globals, 2u, 0xCu, 0x49u, WPP_FxPkgPnp_cpp_Traceguids, v12, 0xC000009A);
    }
