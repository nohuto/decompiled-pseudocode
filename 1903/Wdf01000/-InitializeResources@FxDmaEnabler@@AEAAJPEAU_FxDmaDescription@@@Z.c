/*
 * XREFs of ?InitializeResources@FxDmaEnabler@@AEAAJPEAU_FxDmaDescription@@@Z @ 0x1C0033490
 * Callers:
...
__int64 __fastcall FxDmaEnabler::InitializeResources(FxDmaEnabler *this, _FxDmaDescription *AdapterInfo)
{
  ...
  if ( (v14 & 8) != 0 )
  {
    ...
    if ( _a2 < 0 )
    {
      ...
      if ( !v18 )
        v19 = 0LL;
      WPP_IFR_SF_qL(*p_m_Globals, 2u, 0xFu, 0x15u, WPP_FxDmaEnabler_cpp_Traceguids, v19, _a2);
      return v17;
    }
  }
  else if ( (v14 & 4) != 0 )
  ...
  if ( m_Globals->FxVerboseOn )
  {
    ...
    id = AdapterInfo->MaximumFragmentLength;
  }
  m_MaximumLength = this->m_MaximumLength;
  if ( id < m_MaximumLength && m_Globals->FxVerboseOn )
  {
    if ( !this->m_ObjectSize )
      v22 = 0LL;
    WPP_IFR_SF_qii(m_Globals, 5u, v8, 0x17u, WPP_FxDmaEnabler_cpp_Traceguids, v22, m_MaximumLength, id);
  }
  return 0LL;
}
