/*
 * XREFs of ?IoDecrement@FxPowerIdleMachine@@QEAAXPEAXJPEBD@Z @ 0x1C0012C80
 * Callers:
 *     imp_WdfDeviceResumeIdleActual @ 0x1C0017020 (imp_WdfDeviceResumeIdleActual.c)
 *     ?PowerPolicyChildPoweredDown@FxPkgPnp@@QEAAXXZ @ 0x1C0017F70 (-PowerPolicyChildPoweredDown@FxPkgPnp@@QEAAXXZ.c)
