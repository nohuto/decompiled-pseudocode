/*
 * XREFs of CmRegUtilUcValueSetUcString @ 0x1C00C9958
 * Callers:
 ...
 *     CmpRegUtilAllocateUnicodeString @ 0x1C00C9B6C (CmpRegUtilAllocateUnicodeString.c)
 */
...
__int64 __fastcall CmRegUtilUcValueSetUcString(void *KeyHandle, _UNICODE_STRING *ValueName, _UNICODE_STRING *ValueData)
{
  ...
  *(_QWORD *)&tempString.Length = 0LL;
  tempString.Buffer = 0LL;
