/*
 * XREFs of PiRegStateReadStackCreationSettingsFromKey @ 0x1C00C9090
 * Callers:
 ...
 *     SeUtilSecurityInfoFromSecurityDescriptor @ 0x1C00C9504 (SeUtilSecurityInfoFromSecurityDescriptor.c)
 *     CmRegUtilUcValueGetFullBuffer @ 0x1C00C9814 (CmRegUtilUcValueGetFullBuffer.c)
 *     CmRegUtilWstrValueGetDword @ 0x1C00C9A70 (CmRegUtilWstrValueGetDword.c)
 */
