/*
 * XREFs of ?ReleaseResources@FxDmaEnabler@@AEAAXXZ @ 0x1C003374C
 * Callers:
 *     ?Dispose@FxDmaEnabler@@UEAAEXZ @ 0x1C0032F30 (-Dispose@FxDmaEnabler@@UEAAEXZ.c)
 ...
 * Callees:
 *     ?FreeResources@FxDmaEnabler@@AEAAXPEAU_FxDmaDescription@@@Z @ 0x1C0032F6C (-FreeResources@FxDmaEnabler@@AEAAXPEAU_FxDmaDescription@@@Z.c)
 */
