/*
 * XREFs of ?FxIFRSendRecordsToWpp@@YAJ_KPEAU_WDF_IFR_HEADER@@@Z @ 0x1C003E3E0
 * Callers:
 *     ?FxIFRReplay@@YAX_K@Z @ 0x1C003E0C0 (-FxIFRReplay@@YAX_K@Z.c)
 * Callees:
 *     memset @ 0x1C001B300 (memset.c)
 *     FxWmiTraceMessage @ 0x1C003AED8 (FxWmiTraceMessage.c)
 *     ?FxIFRValidateRecord@@YAJPEAU_WDF_IFR_RECORD@@_K1@Z @ 0x1C003E694 (-FxIFRValidateRecord@@YAJPEAU_WDF_IFR_RECORD@@_K1@Z.c)
 */
