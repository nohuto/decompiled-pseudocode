/*
 * XREFs of WPP_IFR_SF_qqq @ 0x1C0033E3C
 * Callers:
 ...
 *     ?PreMapTransfer@FxDmaSystemTransaction@@MEAAEXZ @ 0x1C0036FE0 (-PreMapTransfer@FxDmaSystemTransaction@@MEAAEXZ.c)
 ...
 *     imp_WdfUsbTargetPipeFormatRequestForRead @ 0x1C006B440 (imp_WdfUsbTargetPipeFormatRequestForRead.c)
 *     imp_WdfUsbTargetPipeFormatRequestForUrb @ 0x1C006B5C0 (imp_WdfUsbTargetPipeFormatRequestForUrb.c)
 *     imp_WdfUsbTargetPipeFormatRequestForWrite @ 0x1C006B7E0 (imp_WdfUsbTargetPipeFormatRequestForWrite.c)
 ...
 *     ?PowerMakeWakeRequestNonCancelable@FxPkgPnp@@IEAAEJ@Z @ 0x1C0081688 (-PowerMakeWakeRequestNonCancelable@FxPkgPnp@@IEAAEJ@Z.c)
 *     ?ForceDisconnect@FxInterrupt@@QEAAJXZ @ 0x1C008D4B8 (-ForceDisconnect@FxInterrupt@@QEAAJXZ.c)
 *     ?ForceReconnect@FxInterrupt@@QEAAJXZ @ 0x1C008D554 (-ForceReconnect@FxInterrupt@@QEAAJXZ.c)
 *     ?PowerPolicyUpdateSystemWakeSource@FxPkgPnp@@IEAAXPEAVFxIrp@@@Z @ 0x1C0090910 (-PowerPolicyUpdateSystemWakeSource@FxPkgPnp@@IEAAXPEAVFxIrp@@@Z.c)
