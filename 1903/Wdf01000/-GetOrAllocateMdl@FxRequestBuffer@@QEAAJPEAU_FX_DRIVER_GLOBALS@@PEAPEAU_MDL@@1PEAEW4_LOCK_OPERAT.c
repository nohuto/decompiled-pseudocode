/*
 * XREFs of ?GetOrAllocateMdl@FxRequestBuffer@@QEAAJPEAU_FX_DRIVER_GLOBALS@@PEAPEAU_MDL@@1PEAEW4_LOCK_OPERATION@@EPEA_K@Z @ 0x1C0095D78
 * Callers:
 ...
 *     FxProbeAndLockWithAccess @ 0x1C0095908 (FxProbeAndLockWithAccess.c)
