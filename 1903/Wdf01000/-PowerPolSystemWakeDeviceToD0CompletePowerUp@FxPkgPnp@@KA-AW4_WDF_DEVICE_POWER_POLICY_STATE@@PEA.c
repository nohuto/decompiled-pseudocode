/*
 * XREFs of ?PowerPolSystemWakeDeviceToD0CompletePowerUp@FxPkgPnp@@KA?AW4_WDF_DEVICE_POWER_POLICY_STATE@@PEAV1@@Z @ 0x1C00157D0
 * Callers:
 *     <none>
 * Callees:
 ...
 *     ?SimulateDevicePowerRequired@FxPoxInterface@@QEAAXXZ @ 0x1C0015A58 (-SimulateDevicePowerRequired@FxPoxInterface@@QEAAXXZ.c)
