/*
 * XREFs of ?PnpEventHardwareAvailable@FxPkgPnp@@KA?AW4_WDF_DEVICE_PNP_STATE@@PEAV1@@Z @ 0x1C007D840
 * Callers:
 *     <none>
 * Callees:
 ...
 *     ?CreatePowerThreadIfNeeded@FxPkgPnp@@AEAAJXZ @ 0x1C008F1A0 (-CreatePowerThreadIfNeeded@FxPkgPnp@@AEAAJXZ.c)
 */
