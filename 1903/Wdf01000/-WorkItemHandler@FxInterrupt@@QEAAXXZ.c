/*
 * XREFs of ?WorkItemHandler@FxInterrupt@@QEAAXXZ @ 0x1C008E57C
 * Callers:
 *     ?_InterruptWorkItemCallback@FxInterrupt@@CAXPEAX@Z @ 0x1C008DEA0 (-_InterruptWorkItemCallback@FxInterrupt@@CAXPEAX@Z.c)
 * Callees:
...
void __fastcall FxInterrupt::WorkItemHandler(FxInterrupt *this)
{
  ...
  if ( m_CallbackLock )
  {
    ...
    v3 = *(void (__fastcall **)(void (__fastcall **)(WDFINTERRUPT__ *, void *), __int64, __int64, __int64, char))(qword_1C00AEEC0 + 24LL);
    if ( v3 )
  ...
  {
    v9 = *(void (__fastcall **)(void (__fastcall **)(WDFINTERRUPT__ *, void *), __int64, __int64, __int64, char))(qword_1C00AEEC0 + 24LL);
    if ( v9 )
