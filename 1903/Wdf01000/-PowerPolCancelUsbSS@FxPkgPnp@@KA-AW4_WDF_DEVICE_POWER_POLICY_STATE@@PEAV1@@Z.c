/*
 * XREFs of ?PowerPolCancelUsbSS@FxPkgPnp@@KA?AW4_WDF_DEVICE_POWER_POLICY_STATE@@PEAV1@@Z @ 0x1C008A610
 * Callers:
 *     <none>
 * Callees:
...
{
  return (unsigned int)(FxPkgPnp::PowerPolicyCancelUsbSSIfCapable(This) != 0) + 1466;
}
