/*
 * XREFs of ?Initialize@FxTimer@@QEAAJPEAU_WDF_OBJECT_ATTRIBUTES@@PEAU_WDF_TIMER_CONFIG@@PEAVFxObject@@PEAPEAUWDFTIMER__@@@Z @ 0x1C0013A60
 * Callers:
 ...
 *     ?InitializeEx@MxTimer@@QEAAJPEAXP6AXPEAU_EX_TIMER@@0@ZJKE@Z @ 0x1C0055ED4 (-InitializeEx@MxTimer@@QEAAJPEAXP6AXPEAU_EX_TIMER@@0@ZJKE@Z.c)
 */
        ...
        WDFTIMER__ **Timer)
{
  ...
  else
  {
    ...
    v17 = FxDeviceBase::_SearchForDevice((unsigned __int64)ParentObject, &pCallbacks);
