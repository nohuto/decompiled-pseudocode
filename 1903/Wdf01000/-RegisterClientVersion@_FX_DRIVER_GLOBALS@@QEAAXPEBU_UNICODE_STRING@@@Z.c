/*
 * XREFs of ?RegisterClientVersion@_FX_DRIVER_GLOBALS@@QEAAXPEBU_UNICODE_STRING@@@Z @ 0x1C005BC24
 * Callers:
...
void __fastcall _FX_DRIVER_GLOBALS::RegisterClientVersion(_FX_DRIVER_GLOBALS *this, _UNICODE_STRING *ServiceKeyName)
{
  ...
  *(_QWORD *)&wdfMajorValue.Length = 0LL;
  wdfMajorValue.Buffer = 0LL;
  *(_QWORD *)&wdfMinorValue.Length = 0LL;
  wdfMinorValue.Buffer = 0LL;
