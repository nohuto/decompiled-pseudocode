/*
 * XREFs of USBD_QueryUsbCapability @ 0x1C0094178
 * Callers:
 *     ?QueryUsbCapability@FxUsbDevice@@QEAAJPEBU_GUID@@KPEAXPEAK@Z @ 0x1C0075FC8 (-QueryUsbCapability@FxUsbDevice@@QEAAJPEBU_GUID@@KPEAXPEAK@Z.c)
 * Callees:
 *     __security_check_cookie @ 0x1C001A3B0 (__security_check_cookie.c)
 *     memset @ 0x1C001B300 (memset.c)
 *     USBDInternal_BuildandSendIoctlSynchronously @ 0x1C00936F4 (USBDInternal_BuildandSendIoctlSynchronously.c)
 */
