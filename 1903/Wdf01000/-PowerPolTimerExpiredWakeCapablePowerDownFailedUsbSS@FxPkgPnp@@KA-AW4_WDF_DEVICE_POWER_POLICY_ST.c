/*
 * XREFs of ?PowerPolTimerExpiredWakeCapablePowerDownFailedUsbSS@FxPkgPnp@@KA?AW4_WDF_DEVICE_POWER_POLICY_STATE@@PEAV1@@Z @ 0x1C008BB80
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall FxPkgPnp::PowerPolTimerExpiredWakeCapablePowerDownFailedUsbSS(FxPkgPnp *This)
{
  ...
  return FxPkgPnp::PowerPolicyCancelUsbSSIfCapable(This) != 0 ? 1467 : 1390;
}
