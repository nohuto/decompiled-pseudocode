/*
 * XREFs of ??0FxRequest@@IEAA@PEAU_FX_DRIVER_GLOBALS@@PEAU_IRP@@W4FxRequestIrpOwnership@@W4FxRequestConstructorCaller@@G@Z @ 0x1C0009A10
 * Callers:
        ...
        FxRequestConstructorCaller Caller)
{
  ...
  *(_DWORD *)&this->m_ObjectFlags = 0x10000;
  ...
  {
    v14 = this->m_Globals;
    if ( v14->FxVerifierLock )
    {
      VerifierLock = 0LL;
      FxVerifierLock::CreateAndInitialize(&VerifierLock, v14, this);
  ...
  if ( v10 == FxRequestConstructorCallerIsDriver )
  {
    ...
    {
      v13 = KeAcquireSpinLockRaiseToDpc(&this->m_SpinLock.m_Lock);
