/*
 * XREFs of imp_WdfDeviceSetSpecialFileSupport @ 0x1C004A810
 * Callers:
 *     <none>
 * Callees:
 ...
 *     ?SetSpecialFileSupport@FxPkgPnp@@QEAAXW4_WDF_SPECIAL_FILE_TYPE@@E@Z @ 0x1C00869B8 (-SetSpecialFileSupport@FxPkgPnp@@QEAAXW4_WDF_SPECIAL_FILE_TYPE@@E@Z.c)
 */
...
LABEL_7:
    WPP_IFR_SF_qL(v10, 2u, 0x12u, v9, WPP_FxDeviceApiKm_cpp_Traceguids, Device, FileType);
