/*
 * XREFs of ??0FxVerifierLock@@AEAA@PEAU_FX_DRIVER_GLOBALS@@PEAVFxObject@@E@Z @ 0x1C004E840
 * Callers:
 ...
 * Callees:
 *     ?InitializeLockOrder@FxVerifierLock@@AEAAXXZ @ 0x1C005CCE0 (-InitializeLockOrder@FxVerifierLock@@AEAAXXZ.c)
 */
