/*
 * XREFs of ?FxLibraryCreateDevice@@YAJPEAU_UNICODE_STRING@@@Z @ 0x1C002E9D0
 * Callers:
 *     DriverEntry @ 0x1C002F080 (DriverEntry.c)
 * Callees:
 *     RtlUnicodeStringPrintf @ 0x1C002F610 (RtlUnicodeStringPrintf.c)
 *     ?_CreateAndInitialize@FxCompanionLibrary@@SAJPEAPEAV1@@Z @ 0x1C00444E8 (-_CreateAndInitialize@FxCompanionLibrary@@SAJPEAPEAV1@@Z.c)
 */
...
int __fastcall FxLibraryCreateDevice(_UNICODE_STRING *DeviceName)
{
  ...
  while ( 1 )
  {
    ...
    if ( Device != -1073741771 )
    {
      ...
      v5 = FxCompanionLibrary::_CreateAndInitialize(&qword_1C00AEEE8);
      if ( v5 < 0 )
      {
        if ( WdfLdrDbgPrintOn )
        {
