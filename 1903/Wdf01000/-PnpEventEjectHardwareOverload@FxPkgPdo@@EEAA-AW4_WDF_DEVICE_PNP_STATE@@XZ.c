/*
 * XREFs of ?PnpEventEjectHardwareOverload@FxPkgPdo@@EEAA?AW4_WDF_DEVICE_PNP_STATE@@XZ @ 0x1C007C510
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall FxPkgPdo::PnpEventEjectHardwareOverload(FxPkgPdo *this)
{
  ...
  if ( _a3 < 0 )
  {
    ...
    if ( _a3 == -1073741637 )
    {
      ...
      {
        if ( _FX_DRIVER_GLOBALS::IsVersionGreaterThanOrEqualTo(m_Globals, v19, 0xBu) || v21->FxVerifyDownlevel )
