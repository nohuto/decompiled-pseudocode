/*
 * XREFs of FxIoTargetSendIo @ 0x1C006504C
 * Callers:
 *     imp_WdfIoTargetSendReadSynchronously @ 0x1C0066730 (imp_WdfIoTargetSendReadSynchronously.c)
 *     imp_WdfIoTargetSendWriteSynchronously @ 0x1C0066780 (imp_WdfIoTargetSendWriteSynchronously.c)
 * Callees:
...
LABEL_11:
    ...
    v17 = IoBuffer;
    if ( IoBuffer
      && (v18 = FxRequestBuffer::ValidateMemoryDescriptor(
