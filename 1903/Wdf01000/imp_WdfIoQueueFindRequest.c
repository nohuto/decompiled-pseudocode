/*
 * XREFs of imp_WdfIoQueueFindRequest @ 0x1C00029F0
 * Callers:
 *     <none>
 * Callees:
        ...
        WDFREQUEST__ **OutRequest)
{
  ...
  $41EACD23695CB34D39C03C31B435114F *v20; // rdx
  _QWORD *v21; // rcx
  bool v22; // r9
  _QWORD *v23; // r8
  ...
  $41EACD23695CB34D39C03C31B435114F *v28; // r10
  int v29; // r8d
...
LABEL_19:
  ...
  while ( 1 )
  {
    if ( !*((_BYTE *)v23 - 100) )
    {
      v28 = ($41EACD23695CB34D39C03C31B435114F *)*(v23 - 3);
      if ( !v22 )
      {
        v22 = v28 == v20;
        goto LABEL_62;
