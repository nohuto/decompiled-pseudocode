/*
 * XREFs of ?_InterruptThunk@FxInterrupt@@CAEPEAU_KINTERRUPT@@PEAX@Z @ 0x1C0002D10
 * Callers:
 *     <none>
 * Callees:
...
LABEL_3:
  ...
  {
    v7 = *(void (__fastcall **)(unsigned __int8 (__fastcall **)(WDFINTERRUPT__ *, unsigned int), __int64, __int64, __int64, char))(unk_1C00AEEC0 + 16LL);
    if ( v7 )
    {
      v10 = 2;
  ...
  else
  {
    if ( ServiceContext->m_PassiveHandling )
    {
      ...
      v8 = *(void (__fastcall **)(unsigned __int8 (__fastcall **)(WDFINTERRUPT__ *, unsigned int), __int64, __int64, __int64, char))(unk_1C00AEEC0 + 16LL);
      if ( v8 )
      {
        v11 = 2;
    ...
    {
      v3 = *(void (__fastcall **)(unsigned __int8 (__fastcall **)(WDFINTERRUPT__ *, unsigned int), __int64, __int64, __int64, char))(unk_1C00AEEC0 + 16LL);
      if ( v3 )
      {
        v12 = 2;
