/*
 * XREFs of imp_WdfRegistryCreateKey @ 0x1C0060670
 * Callers:
 *     <none>
 * Callees:
        ...
        WDFKEY__ **Key)
{
  ...
  int v20; // esi
  NTSTATUS v21; // eax
  void *PPObject; // [rsp+40h] [rbp-40h] BYREF
  ...
  WDFKEY__ *keyHandle; // [rsp+C8h] [rbp+48h] BYREF
  FxRegKey *pParent; // [rsp+D0h] [rbp+50h] BYREF
      ...
      if ( (int)result >= 0 )
      {
        ...
        if ( v10 )
        {
          ...
          *(_OWORD *)&ObjectAttributes.SecurityDescriptor = 0LL;
          ...
          {
            FxRegKey::_VerifyStateSeparationRegistryPolicy(*(_FX_DRIVER_GLOBALS **)(v10 + 120), *(void **)(v10 + 112));
