/*
 * XREFs of DxgkDisplayConfigDeviceInfo @ 0x1C00D5770
 * Callers:
 *     <none>
 * Callees:
 ...
 *     ?IsActive@DXGADAPTER@@QEBAHXZ @ 0x1C00067E4 (-IsActive@DXGADAPTER@@QEBAHXZ.c)
 ...
 *     ?ConvertDisplayConfigToDmmRotation@@YA?AW4_D3DKMDT_VIDPN_PRESENT_PATH_ROTATION@@W4DISPLAYCONFIG_ROTATION@@W41@@Z @ 0x1C000E820 (-ConvertDisplayConfigToDmmRotation@@YA-AW4_D3DKMDT_VIDPN_PRESENT_PATH_ROTATION@@W4DISPLAYCONFIG_.c)
 ...
 *     ?ConvertDmmToDisplayConfigColorEncoding@@YA?AW4_DISPLAYCONFIG_COLOR_ENCODING@@T_D3DKMDT_WIRE_FORMAT_AND_PREFERENCE@@@Z @ 0x1C00D3C5C (-ConvertDmmToDisplayConfigColorEncoding@@YA-AW4_DISPLAYCONFIG_COLOR_ENCODING@@T_D3DKMDT_WIRE_FOR.c)
 *     ?IsCurrentModeAdvancedColor@@YAEPEAVDXGADAPTER@@IPEAT_D3DKMDT_WIRE_FORMAT_AND_PREFERENCE@@PEAW4_D3DDDI_OUTPUT_WIRE_COLOR_SPACE_TYPE@@@Z @ 0x1C00D5F1C (-IsCurrentModeAdvancedColor@@YAEPEAVDXGADAPTER@@IPEAT_D3DKMDT_WIRE_FORMAT_AND_PREFERENCE@@PEAW4_.c)
 ...
 *     ?TriggerSDRWhiteLevelChangedWnf@@YAJXZ @ 0x1C026FE70 (-TriggerSDRWhiteLevelChangedWnf@@YAJXZ.c)
        ...
        if ( !v57 )
        {
          ...
          do
          {
            ...
            if ( (int)DeviceInterfaces >= 0 )
            {
              ...
              LODWORD(DeviceInterfaces) = BmlGetPathModalityForAdapter((__int64)v239, v239[8], 0, 1u, 0);
              if ( (int)DeviceInterfaces >= 0 )
              {
...
LABEL_125:
      ...
      else
      {
        ...
        LightweightDeviceAndContext = DisplayConfigFillTargetDeviceInfo(
...
LABEL_191:
      ...
      if ( (int)COREADAPTERACCESS::AcquireExclusive(v242, 1LL, 0LL) < 0 )
      {
