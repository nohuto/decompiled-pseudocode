/*
 * XREFs of ?AcquireTargetModeSet@DXGK_VIDPN_INTERFACE_V1_IMPL@@YAJQEAUD3DKMDT_HVIDPN__@@IPEAPEAUD3DKMDT_HVIDPNTARGETMODESET__@@PEAPEBU_DXGK_VIDPNTARGETMODESET_INTERFACE@@@Z @ 0x1C00E5F00
 * Callers:
 *     <none>
 * Callees:
        ...
        struct D3DKMDT_HVIDPNTARGETMODESET__ **a4)
{
  ...
  struct D3DKMDT_HVIDPNTARGETMODESET__ *v37; // [rsp+60h] [rbp+8h]
  ...
  DXGETWPROFILER_BASE_PushProfilerEntry((__int64)&v34, 7048LL);
  ...
  *a4 = 0LL;
  ...
  if ( !DMMVIDPNTOPOLOGY::IsTargetInTopology((DXGK_VIDPN_INTERFACE_V1_IMPL *)((char *)v14 + 96), v7) )
  {
  ...
  v37 = *(struct D3DKMDT_HVIDPNTARGETMODESET__ **)(*((_QWORD *)v14 + 6) + 392LL);
  v18 = IndexedSet<DMMVIDPNTARGET>::FindById(*((_QWORD *)v14 + 39), v7);
  v22 = v18;
  if ( !v18 )
  {
