/*
 * XREFs of ?DdiQueryMitigatedRanges@ADAPTER_RENDER@@QEAAJPEAU_DXGKARG_QUERYMITIGATEDRANGES@@@Z @ 0x1C0212AA4
 * Callers:
 *     ?QueryMitigatedRanges@DXGK_VIRTUAL_GPU_GPUP@@UEAAJPEAU_DXGKARG_QUERYMITIGATEDRANGES@@@Z @ 0x1C0216CA0 (-QueryMitigatedRanges@DXGK_VIRTUAL_GPU_GPUP@@UEAAJPEAU_DXGKARG_QUERYMITIGATEDRANGES@@@Z.c)
 * Callees:
        ...
        const GUID *a3)
{
  ...
  DXGETWPROFILER_BASE_PushProfilerEntry((__int64)&v30, 5107LL);
...
LABEL_16:
  ...
  v15 = (*(int (__fastcall **)(_QWORD, struct _DXGKARG_QUERYMITIGATEDRANGES *))(*(_QWORD *)(*((_QWORD *)this + 2) + 920LL)
                                                                              + 40LL))(
  ...
  if ( (_DWORD)v15 != -1073741811 && (_DWORD)v15 != -1073741789 && (_DWORD)v15 )
  {
