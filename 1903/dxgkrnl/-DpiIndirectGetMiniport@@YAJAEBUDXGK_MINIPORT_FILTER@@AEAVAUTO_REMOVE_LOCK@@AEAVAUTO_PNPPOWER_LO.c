/*
 * XREFs of ?DpiIndirectGetMiniport@@YAJAEBUDXGK_MINIPORT_FILTER@@AEAVAUTO_REMOVE_LOCK@@AEAVAUTO_PNPPOWER_LOCK@@PEAPEAU_FDO_CONTEXT@@@Z @ 0x1C02AB258
 * Callers:
 ...
 *     DpiGetDeviceInstanceId @ 0x1C029E690 (DpiGetDeviceInstanceId.c)
 */
