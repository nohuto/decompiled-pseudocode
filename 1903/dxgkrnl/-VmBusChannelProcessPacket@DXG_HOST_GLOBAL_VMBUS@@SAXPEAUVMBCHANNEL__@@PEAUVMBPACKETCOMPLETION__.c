/*
 * XREFs of ?VmBusChannelProcessPacket@DXG_HOST_GLOBAL_VMBUS@@SAXPEAUVMBCHANNEL__@@PEAUVMBPACKETCOMPLETION__@@PEAXII@Z @ 0x1C003CFC0
 * Callers:
 *     <none>
 * Callees:
...
LABEL_5:
  ...
  if ( PoolWithTag )
  {
    ...
    v15[1].Parameter = (PVOID)((__int64 (__fastcall *)(struct _LIST_ENTRY *))qword_1C00A3C28)(a1);
    ExQueueWorkItem(v15, NormalWorkQueue);
  }
  else
  {
    v18 = WdLogNewEntry5_WdLowResource(v12, v11, v13, v14);
    *(_QWORD *)(v18 + 24) = 4759LL;
