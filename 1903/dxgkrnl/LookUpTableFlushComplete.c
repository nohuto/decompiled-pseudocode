/*
 * XREFs of LookUpTableFlushComplete @ 0x1C017FEB4
 * Callers:
 *     ?TlgAggregateInternalProviderCallback@@YAXPEBU_GUID@@KE_K1PEAU_EVENT_FILTER_DESCRIPTOR@@PEAX@Z @ 0x1C00C50B0 (-TlgAggregateInternalProviderCallback@@YAXPEBU_GUID@@KE_K1PEAU_EVENT_FILTER_DESCRIPTOR@@PEAX@Z.c)
 ...
 *     ?TlgAggregateInternalFlushWorkItemRoutineKernelMode@@YAXPEAX@Z @ 0x1C02D10D0 (-TlgAggregateInternalFlushWorkItemRoutineKernelMode@@YAXPEAX@Z.c)
 ...
 *     FlushLookUpTableBucket @ 0x1C0059224 (FlushLookUpTableBucket.c)
 *     UpdateInternalStatsOnFlush @ 0x1C02D115C (UpdateInternalStatsOnFlush.c)
 */
  ...
  if ( *(_DWORD *)(a1 + 256) )
  {
    ...
    if ( *(_QWORD *)(v4 + 288) )
    {
      if ( (unsigned int)dword_1C00A1968 > 5 && TlgKeywordOn((TraceLoggingHProvider)&dword_1C00A1968, 0x400000000000uLL) )
      {
        ...
        v33 = 4LL;
        v35 = 4LL;
        TlgWrite((TraceLoggingHProvider)&dword_1C00A1968, &unk_1C0074CF6, 0LL, v6, 0xBu, &pData);
      }
