/*
 * XREFs of ?VmBusChannelProcessPacket@DXG_GUEST_GLOBAL_VMBUS@@SAXPEAUVMBCHANNEL__@@PEAUVMBPACKETCOMPLETION__@@PEAXII@Z @ 0x1C003CE10
 * Callers:
 *     <none>
 * Callees:
        ...
        unsigned int a5)
{
    ...
    if ( v10 )
    {
      ...
      else
      {
        ...
        if ( PoolWithTag )
        {
          ...
          v16[2].List.Flink = (struct _LIST_ENTRY *)((__int64 (__fastcall *)(struct _LIST_ENTRY *))qword_1C00A3C28)(a1);
  ...
  ((void (__fastcall *)(struct _LIST_ENTRY *, _QWORD, _QWORD))qword_1C00A3C68)(a2, 0LL, 0LL);
LABEL_13:
  if ( (Microsoft_Windows_DxgKrnlEnableBits & 0x400000) != 0 )
    McTemplateK0ppq(
      v17,
