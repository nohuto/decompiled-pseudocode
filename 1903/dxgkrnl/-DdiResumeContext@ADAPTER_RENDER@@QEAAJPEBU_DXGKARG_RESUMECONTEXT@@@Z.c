/*
 * XREFs of ?DdiResumeContext@ADAPTER_RENDER@@QEAAJPEBU_DXGKARG_RESUMECONTEXT@@@Z @ 0x1C01FC3E8
 * Callers:
 *     ?ADAPTER_RENDER_DdiResumeContext@@YAJPEAVADAPTER_RENDER@@PEBU_DXGKARG_RESUMECONTEXT@@@Z @ 0x1C003DEE0 (-ADAPTER_RENDER_DdiResumeContext@@YAJPEAVADAPTER_RENDER@@PEBU_DXGKARG_RESUMECONTEXT@@@Z.c)
 * Callees:
