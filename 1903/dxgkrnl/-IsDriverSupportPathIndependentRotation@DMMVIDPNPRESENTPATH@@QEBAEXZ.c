/*
 * XREFs of ?IsDriverSupportPathIndependentRotation@DMMVIDPNPRESENTPATH@@QEBAEXZ @ 0x1C00E613C
 * Callers:
        ...
        __int64 a2)
{
  ...
  v9 = *(_QWORD *)(v8 + 2552);
  if ( *(_BYTE *)(v9 + 233) && *(_BYTE *)(v9 + 234)
    || *(_DWORD *)(*(_QWORD *)(*(_QWORD *)(*(_QWORD *)(v8 + 192) + 64LL) + 40LL) + 28LL) >= 0x4003u )
  {
    return 1;
  }
  return v3;
