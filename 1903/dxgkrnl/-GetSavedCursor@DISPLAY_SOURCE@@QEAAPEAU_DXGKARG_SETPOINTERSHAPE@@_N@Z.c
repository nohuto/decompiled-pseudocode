/*
 * XREFs of ?GetSavedCursor@DISPLAY_SOURCE@@QEAAPEAU_DXGKARG_SETPOINTERSHAPE@@_N@Z @ 0x1C0149F2C
 * Callers:
...
struct _DXGKARG_SETPOINTERSHAPE *__fastcall DISPLAY_SOURCE::GetSavedCursor(DISPLAY_SOURCE *this, char a2)
{
  ...
  {
    v9 = 4LL * (unsigned int)(*(_DWORD *)(v6 + 1872) * *(_DWORD *)(v6 + 1876));
    if ( !is_mul_ok((unsigned int)(*(_DWORD *)(v6 + 1872) * *(_DWORD *)(v6 + 1876)), 4uLL) )
      v9 = -1LL;
