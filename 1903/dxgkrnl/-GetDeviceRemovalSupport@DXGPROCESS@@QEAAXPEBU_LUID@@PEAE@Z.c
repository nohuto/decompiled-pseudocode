/*
 * XREFs of ?GetDeviceRemovalSupport@DXGPROCESS@@QEAAXPEBU_LUID@@PEAE@Z @ 0x1C025E0C8
 * Callers:
  ...
  if ( !v9 )
  {
    ...
    *a3 = 1;
    ...
    while ( 1 )
    {
      ...
      if ( !Current )
        break;
      if ( *(_DWORD *)(Current + 328) != 2 )
      {
        v15 = *(_QWORD *)(*(_QWORD *)(Current + 16) + 16LL);
        if ( !v15 )
        {
          v16 = WdLogNewEntry5_WdAssertion(v14, v13);
          *(_QWORD *)(v16 + 24) = 4670LL;
          WdLogEvent5_WdAssertion(v16);
        }
        if ( *(_DWORD *)(v15 + 276) == a2->LowPart && *(_DWORD *)(v15 + 280) == a2->HighPart )
        {
          *a3 = 0;
          break;
        }
