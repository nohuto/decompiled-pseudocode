/*
 * XREFs of ?EtwProfilerTypeName@DXGGLOBAL@@SAPEAGW4_DXGKETW_PROFILER_TYPE@@PEAI@Z @ 0x1C0298BF4
 * Callers:
...
const wchar_t *__fastcall DXGGLOBAL::EtwProfilerTypeName(int a1, _DWORD *a2)
{
  ...
  if ( a1 <= 5001 )
  {
    ...
    else
    {
      ...
      {
        *a2 = 37;
        return L"DxgkSetProcessSchedulingPriorityBand";
      }
      if ( a1 > 2063 )
      {
        switch ( a1 )
