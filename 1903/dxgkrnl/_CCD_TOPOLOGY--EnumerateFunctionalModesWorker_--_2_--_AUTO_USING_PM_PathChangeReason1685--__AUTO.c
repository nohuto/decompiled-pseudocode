/*
 * XREFs of _CCD_TOPOLOGY::EnumerateFunctionalModesWorker_::_2_::_AUTO_USING_PM_PathChangeReason1685::__AUTO_USING_PM_PathChangeReason1685 @ 0x1C00D0FFC
 * Callers:
...
__int64 __fastcall CCD_TOPOLOGY::EnumerateFunctionalModesWorker_::_2_::_AUTO_USING_PM_PathChangeReason1685::__AUTO_USING_PM_PathChangeReason1685(
        __int64 *a1)
{
  unsigned int i; // r8d
  __int64 v2; // rax
