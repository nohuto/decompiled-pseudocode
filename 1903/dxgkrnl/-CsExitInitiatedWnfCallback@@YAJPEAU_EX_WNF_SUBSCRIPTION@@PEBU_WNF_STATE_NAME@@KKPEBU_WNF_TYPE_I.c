/*
 * XREFs of ?CsExitInitiatedWnfCallback@@YAJPEAU_EX_WNF_SUBSCRIPTION@@PEBU_WNF_STATE_NAME@@KKPEBU_WNF_TYPE_ID@@PEAX@Z @ 0x1C0241780
 * Callers:
 *     <none>
 * Callees:
        ...
        DXGGLOBAL *a6)
{
  ...
  __int64 v15; // rcx
  const GUID *v16; // r8
  unsigned __int8 v18[4]; // [rsp+20h] [rbp-20h] BYREF
  ...
  DXGETWPROFILER_BASE_PushProfilerEntry((__int64)&v20, 8014LL);
  v18[0] = 0;
  v19 = 1;
  PerformanceCounter = KeQueryPerformanceCounter(0LL);
  v8 = ExQueryWnfStateData(a1, &v23, v18, &v19);
  v12 = v8;
  if ( v8 >= 0 )
  {
