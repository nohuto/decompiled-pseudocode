/*
 * XREFs of ?DxgkDrtTestEscape@@YAJPEAVDXGADAPTER@@PEAU_D3DKMT_DRT_ESCAPE_HEAD@@PEAVCOREADAPTERACCESS@@@Z @ 0x1C02386DC
 * Callers:
 ...
 *     ?ForcePState@DXGADAPTER@@QEAAXW4_D3DKMT_DRT_FORCE_PSTATE_BEHAVIOR@@II@Z @ 0x1C01ECB6C (-ForcePState@DXGADAPTER@@QEAAXW4_D3DKMT_DRT_FORCE_PSTATE_BEHAVIOR@@II@Z.c)
 *     ?ForcePStateAcrossNodes@DXGADAPTER@@QEAAXI@Z @ 0x1C01ECBDC (-ForcePStateAcrossNodes@DXGADAPTER@@QEAAXI@Z.c)
 *     ?QueryPStateEngineData@DXGADAPTER@@QEAAXIPEAU_DXGK_POWER_P_COMPONENT@@PEAI@Z @ 0x1C01EE314 (-QueryPStateEngineData@DXGADAPTER@@QEAAXIPEAU_DXGK_POWER_P_COMPONENT@@PEAI@Z.c)
 ...
 *     ?GetContexts@DXGDEVICE@@QEAAXPEAIQEAI@Z @ 0x1C022EC4C (-GetContexts@DXGDEVICE@@QEAAXPEAIQEAI@Z.c)
      ...
      if ( v25 )
      {
        ...
        if ( v26 )
        {
          ...
          if ( !v27 )
          {
            ...
            LODWORD(v10) = COREADAPTERACCESS::AcquireExclusive(a3, 1LL, 0LL);
            if ( (int)v10 >= 0 )
              COREADAPTERACCESS::Release((COREADAPTERACCESS *)a3);
            return (unsigned int)v10;
          }
