/*
 * XREFs of McTemplateK0pqqxpxqqqddddddddddddqqtqq @ 0x1C00367C0
 * Callers:
...
ULONG __fastcall McTemplateK0pqqxpxqqqddddddddddddqqtqq(
        __int64 a1,
        __int64 a2,
        __int64 a3,
        __int64 a4,
        ...
        char a24)
{
  ...
  EVENT_DATA_DESCRIPTOR EventData; // [rsp+80h] [rbp-80h] BYREF
