/*
 * XREFs of ?DxgkWin32kQueryInterface@@YAJPEAU_DXGKWIN32K_INTERFACE@@PEAK@Z @ 0x1C0142EBC
 * Callers:
...
__int64 __fastcall DxgkWin32kQueryInterface(struct _DXGKWIN32K_INTERFACE *a1, unsigned int *a2)
{
  ...
  if ( *(_WORD *)a1 == 792 && *((_WORD *)a1 + 1) == 43 )
  {
    ...
    *((_QWORD *)a1 + 83) = DxgkLPMDisplayControl;
    *((_QWORD *)a1 + 84) = DxgkEnableHighPrecisionBrightness;
    *((_QWORD *)a1 + 85) = DxgkSetHighPrecisionBrightness;
    *((_QWORD *)a1 + 82) = DxgkGetUseHWGPUInRemoteSession;
    *((_QWORD *)a1 + 87) = &DxgkGetMonitorEdid;
    *((_QWORD *)a1 + 86) = DxgkChangeD3RequestsState;
    *((_QWORD *)a1 + 88) = DxgkConvertPathsModalityToDisplayConfig;
    *((_QWORD *)a1 + 89) = DxgkConvertDisplayConfigToDevMode;
    *((_QWORD *)a1 + 90) = DxgkDDisplayEnumInternal;
    *((_QWORD *)a1 + 94) = DxgkDispMgrReferenceObjectByHandle;
    *((_QWORD *)a1 + 95) = DxgkDispMgrIsTargetOwned;
    *((_QWORD *)a1 + 91) = &DxgkGetMonitorDisplayId;
    *((_QWORD *)a1 + 92) = &DxgkEnumerateModesForPathsModality;
    *((_QWORD *)a1 + 93) = DxgCreateLiveDumpWithWdLogs;
    *((_QWORD *)a1 + 96) = DxgkCheckDisplayState;
    *((_QWORD *)a1 + 97) = &DxgkSetKernelDisplayPolicy;
    *((_QWORD *)a1 + 98) = DxgkSendDisplayBrokerMessage;
    result = 0LL;
    *a2 = 792;
  }
  else
