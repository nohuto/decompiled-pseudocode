/*
 * XREFs of ?AddDisplaySource@SESSION_VIEW@@QEAAJPEAVDISPLAY_SOURCE@@E@Z @ 0x1C00CEC6C
 * Callers:
...
__int64 __fastcall SESSION_VIEW::AddDisplaySource(SESSION_VIEW *this, struct DISPLAY_SOURCE *a2, __int64 a3)
{
  SESSION_VIEW *v3; // rax
  _QWORD *v5; // rax
  _QWORD *v6; // rcx
