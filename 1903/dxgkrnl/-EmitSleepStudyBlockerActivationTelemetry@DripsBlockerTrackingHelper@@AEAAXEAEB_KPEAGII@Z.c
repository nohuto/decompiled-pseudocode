/*
 * XREFs of ?EmitSleepStudyBlockerActivationTelemetry@DripsBlockerTrackingHelper@@AEAAXEAEB_KPEAGII@Z @ 0x1C0242180
 * Callers:
        ...
        unsigned int a6)
{
  ...
  if ( dword_1C00A1888 > 5u )
  {
    if ( TlgKeywordOn((TraceLoggingHProvider)&dword_1C00A1888, 0x400000002000uLL) )
    {
      ...
      v21 = 50331648LL;
      v55 = 8;
      TlgWrite((TraceLoggingHProvider)&dword_1C00A1888, &unk_1C007350D, 0LL, v11, 0xEu, &pData);
    }
  }
}
