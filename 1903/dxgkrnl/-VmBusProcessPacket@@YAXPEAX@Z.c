/*
 * XREFs of ?VmBusProcessPacket@@YAXPEAX@Z @ 0x1C0221760
 * Callers:
 *     <none>
 * Callees:
...
LABEL_47:
    ...
    v13 = WdLogNewEntry5_WdError(v17, a2, a3);
    *(_QWORD *)(v13 + 24) = *((unsigned int *)v4 + 22);
    *(_QWORD *)(v13 + 32) = 345LL;
    goto LABEL_44;
  }
LABEL_45:
  if ( !*((_BYTE *)DXGGLOBAL::GetGlobal((__int64)a1, a2) + 303937) )
  {
    v19 = 0;
    *(_BYTE *)(v6 + 49) = 1;
    goto LABEL_47;
