/*
 * XREFs of ?SetPowerComponentIdleCBWorker@DXGADAPTER@@QEAAXIK@Z @ 0x1C0034D2C
 * Callers:
 *     ?SetPowerComponentIdleCB@DXGADAPTER@@QEAAXI@Z @ 0x1C0034BD0 (-SetPowerComponentIdleCB@DXGADAPTER@@QEAAXI@Z.c)
 ...
 *     ?PowerRuntimeComponentIdleStateCallback@DXGADAPTER@@QEAAXKKE@Z @ 0x1C0033B84 (-PowerRuntimeComponentIdleStateCallback@DXGADAPTER@@QEAAXKKE@Z.c)
 *     ?ScheduleComponentIdleListTimer@DXGADAPTER@@QEAAX_J@Z @ 0x1C00345DC (-ScheduleComponentIdleListTimer@DXGADAPTER@@QEAAX_J@Z.c)
 ...
 *     ?RecordIdle@DXGPOWERSTATISTICSTRANSITIONENGINE@@QEAAXXZ @ 0x1C0043818 (-RecordIdle@DXGPOWERSTATISTICSTRANSITIONENGINE@@QEAAXXZ.c)
 */
    ...
    *(_QWORD *)(v6 + 480) = MEMORY[0xFFFFF78000000014];
          ...
          *(int *)(v6 + 352) <= 0) )
    {
      *(_QWORD *)(v6 + 488) = *(_QWORD *)(v6 + 480) + *(_QWORD *)(v6 + 472);
      KeAcquireInStackQueuedSpinLockAtDpcLevel((PKSPIN_LOCK)this + 391, &v20);
      v13 = (char *)*((_QWORD *)this + 386);
      v14 = (char *)this + 3080;
      if ( v13 == (char *)this + 3080 )
        goto LABEL_29;
