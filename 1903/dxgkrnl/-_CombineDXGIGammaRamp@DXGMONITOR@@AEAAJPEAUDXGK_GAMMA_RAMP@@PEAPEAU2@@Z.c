/*
 * XREFs of ?_CombineDXGIGammaRamp@DXGMONITOR@@AEAAJPEAUDXGK_GAMMA_RAMP@@PEAPEAU2@@Z @ 0x1C0128F18
 * Callers:
        ...
        struct DXGK_GAMMA_RAMP **a3)
{
  ...
  if ( DxgiGammaRamp >= 0 )
  {
    ...
    if ( !a2 )
    {
      ...
      if ( v28 )
      {
        LODWORD(v15) = DXGK_GAMMA_RAMP::Initialize((size_t *)v9, (unsigned int)v34, 0LL);
        if ( (int)v15 >= 0 )
        {
    ...
    if ( v14 )
    {
      ...
      {
LABEL_22:
        v31 = DXGK_GAMMA_RAMP::Initialize(v29, (const struct _D3DKMDT_GAMMA_RAMP *)((char *)v14 + 16), v24);
        goto LABEL_23;
      }
      LODWORD(v15) = DXGK_GAMMA_RAMP::Initialize((DXGK_GAMMA_RAMP *)v9, v32, v24);
      if ( (int)v15 >= 0 )
      {
