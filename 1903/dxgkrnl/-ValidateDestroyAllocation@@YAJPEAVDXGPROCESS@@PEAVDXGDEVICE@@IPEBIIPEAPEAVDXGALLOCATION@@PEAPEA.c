/*
 * XREFs of ?ValidateDestroyAllocation@@YAJPEAVDXGPROCESS@@PEAVDXGDEVICE@@IPEBIIPEAPEAVDXGALLOCATION@@PEAPEAVDXGRESOURCE@@@Z @ 0x1C0113440
 * Callers:
 ...
 *     ?ReleaseExclusive@DXGAUTOPUSHLOCK@@QEAAXXZ @ 0x1C00233DC (-ReleaseExclusive@DXGAUTOPUSHLOCK@@QEAAXXZ.c)
...
LABEL_61:
    ...
    if ( v44 )
    {
      ...
      do
      {
        ...
        DxgkUnreferenceDxgAllocation((struct DXGALLOCATION *)v64);
