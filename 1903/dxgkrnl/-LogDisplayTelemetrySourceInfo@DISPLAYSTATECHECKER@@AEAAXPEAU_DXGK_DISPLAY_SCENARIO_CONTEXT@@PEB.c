/*
 * XREFs of ?LogDisplayTelemetrySourceInfo@DISPLAYSTATECHECKER@@AEAAXPEAU_DXGK_DISPLAY_SCENARIO_CONTEXT@@PEBU_DXG_BLACKBOX_DISPLAY_SOURCE_INFO@@@Z @ 0x1C02967A8
 * Callers:
  ...
  if ( a3 && a2 )
  {
    ...
    if ( dword_1C00A1888 > 5u )
    {
      if ( TlgKeywordOn((TraceLoggingHProvider)&dword_1C00A1888, 0x400000000400uLL) )
      {
        ...
        TlgWrite((TraceLoggingHProvider)&dword_1C00A1888, &unk_1C0073D95, (LPCGUID)(v7 + 8), v8, 0x14u, &pData);
      }
    }
  }
  else
