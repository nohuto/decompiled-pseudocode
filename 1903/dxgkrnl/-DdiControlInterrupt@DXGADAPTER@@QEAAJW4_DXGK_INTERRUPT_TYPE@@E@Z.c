/*
 * XREFs of ?DdiControlInterrupt@DXGADAPTER@@QEAAJW4_DXGK_INTERRUPT_TYPE@@E@Z @ 0x1C0138624
 * Callers:
 *     DXGADAPTER_DdiControlInterrupt @ 0x1C00150A0 (DXGADAPTER_DdiControlInterrupt.c)
...
__int64 __fastcall DXGADAPTER::DdiControlInterrupt(DXGADAPTER *this, DXGK_INTERRUPT_TYPE a2, const GUID *a3)
{
  ...
  if ( *((int *)this + 613) >= 1300 && *((_QWORD *)this + 95) )
  {
    ...
    return DXGADAPTER::DdiControlInterrupt2(this, v30, 0);
  }
  v32 = -1;
  v33 = 0LL;
