/*
 * XREFs of ?TraceLogDpiInfo@@YAXPEAU_DPI_INFORMATION@@PEBGAEBU_LUID@@II@Z @ 0x1C012A000
 * Callers:
        ...
        unsigned int a5)
{
  ...
  if ( dword_1C00A1888 > 5u )
  {
    if ( TlgKeywordOn((TraceLoggingHProvider)&dword_1C00A1888, 0x200000000001uLL) )
    {
      ...
      TlgWrite((TraceLoggingHProvider)&dword_1C00A1888, &unk_1C0073824, 0LL, v8, 0x1Au, &pData);
    }
  }
}
