/*
 * XREFs of ?DdiGetScanLine@ADAPTER_DISPLAY@@QEAAJPEAU_DXGKARG_GETSCANLINE@@@Z @ 0x1C01FA5B4
 * Callers:
...
__int64 __fastcall ADAPTER_DISPLAY::DdiGetScanLine(
        ...
        const GUID *a3)
{
  ...
  DXGETWPROFILER_BASE_PushProfilerEntry((__int64)&v33, 5036LL);
...
LABEL_16:
  ...
  v24[3] = v18;
  v26 = *(_QWORD *)(*((_QWORD *)this + 2) + 248LL);
  v24[4] = v26;
  ScanLine = a2->ScanLine;
  v24[5] = ScanLine;
  if ( (_DWORD)v18 )
  {
    v28 = WdLogNewEntry5_WdError(ScanLine, v26, v25);
    *(_QWORD *)(v28 + 24) = v18;
