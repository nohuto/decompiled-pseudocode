/*
 * XREFs of ?CreateStandardAllocation@DXGDEVICE@@QEAAJPEAU_D3DKM_CREATESTANDARDALLOCATION@@PEAVCOREDEVICEACCESS@@@Z @ 0x1C00F0408
 * Callers:
 ...
 *     GetPixelSizeInBytes @ 0x1C0207130 (GetPixelSizeInBytes.c)
 */
