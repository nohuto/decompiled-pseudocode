/*
 * XREFs of DxgkOpenKeyedMutex @ 0x1C026BA80
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall DxgkOpenKeyedMutex(ULONG64 a1, __int64 a2, const GUID *a3)
{
  ...
  DXGETWPROFILER_BASE_PushProfilerEntry((__int64)&v28, 2052LL);
  ...
  if ( Current )
  {
    ...
    v18 = DXGGLOBAL::OpenKeyedMutex(v16, (unsigned int)v33, &v32, &v31, 0LL, 0);
    if ( v18 >= 0 )
    {
      v19 = (_DWORD *)(a1 + 4);
