/*
 * XREFs of ?UpdateGdiInfoForVidPnSource@@YAJPEBU_DXGDMM_INTERFACE@@QEAXIHPEAU_GDIINFO@@PEAU_DPI_INFORMATION@@@Z @ 0x1C0129540
 * Callers:
 ...
 *     ?AvgXY@DpiInternal@@YAJUtagSIZE@@@Z @ 0x1C000DCB4 (-AvgXY@DpiInternal@@YAJUtagSIZE@@@Z.c)
 ...
 *     ?DetermineViewDistance@@YA_NQEAXAEBUtagSIZE@@H1PEAI@Z @ 0x1C012BEE0 (-DetermineViewDistance@@YA_NQEAXAEBUtagSIZE@@H1PEAI@Z.c)
...
LABEL_165:
      ...
      v57 = 0;
      VideoOutputTechnology = DmmGetVideoOutputTechnology((DXGADAPTER *)a2, v166.cx, &v167, 0LL);
