/*
 * XREFs of MonitorGetDpiInfoFromDescriptor @ 0x1C00CFE60
 * Callers:
        ...
        _BYTE *a7)
{
  ...
  __int64 v34; // rcx
  __int64 v35; // rax
  DXGMONITOR *v36; // [rsp+50h] [rbp+8h] BYREF
  ...
  *(_QWORD *)(v11 + 32) = this;
  ...
  v36 = 0LL;
  if ( (int)MONITOR_MGR::_GetMonitorInstance(v17, v8, 0, &v36) < 0 )
    return 3221225485LL;
  v20 = v36;
  if ( !v36 )
  {
  ...
  else
  {
    ...
    PhysicalSize = DisplayID_GetPhysicalSize((DXGMONITOR *)((char *)v20 + 168), a4, v12);
    if ( PhysicalSize < 0 )
      goto LABEL_19;
    PreferredMode = DisplayID_GetPreferredMode((DXGMONITOR *)((char *)v20 + 168), a3);
  }
