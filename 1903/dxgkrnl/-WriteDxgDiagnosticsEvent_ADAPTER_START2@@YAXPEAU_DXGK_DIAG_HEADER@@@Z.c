/*
 * XREFs of ?WriteDxgDiagnosticsEvent_ADAPTER_START2@@YAXPEAU_DXGK_DIAG_HEADER@@@Z @ 0x1C00230A0
 * Callers:
...
void __fastcall WriteDxgDiagnosticsEvent_ADAPTER_START2(struct _DXGK_DIAG_HEADER *a1)
{
    ...
    && TlgKeywordOn((TraceLoggingHProvider)&hProvider, v2) )
  {
    ...
    v15 = 2;
    v17 = a1;
    TlgWrite((TraceLoggingHProvider)&hProvider, &unk_1C0072C6D, 0LL, v4, 5u, &pData);
  }
    ...
    && hProvider > 4u )
  {
    if ( TlgKeywordOn((TraceLoggingHProvider)&hProvider, v3) )
    {
      ...
      v27 = 4;
      v30 = 4;
      TlgWrite((TraceLoggingHProvider)&hProvider, &unk_1C0072BFE, 0LL, v5, 9u, &pData);
    }
  }
}
