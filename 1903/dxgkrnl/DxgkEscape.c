/*
 * XREFs of DxgkEscape @ 0x1C01012F0
 * Callers:
 ...
 *     ?DxgkDiagInitializeCodePointPacket@@YAXPEAU_DXGK_DIAG_CODE_POINT_PACKET@@W4_DXGK_DIAG_CODE_POINT_TYPE@@III@Z @ 0x1C0003604 (-DxgkDiagInitializeCodePointPacket@@YAXPEAU_DXGK_DIAG_CODE_POINT_PACKET@@W4_DXGK_DIAG_CODE_POINT.c)
 ...
 *     ?IsEscapeEnabled@DXGADAPTER@@QEBAEXZ @ 0x1C000B738 (-IsEscapeEnabled@DXGADAPTER@@QEBAEXZ.c)
 ...
 *     ?GetEdidsFromCache@DXGGLOBAL@@QEAAJPEAU_D3DKMT_DXGK_DIAGNOSTICS@@@Z @ 0x1C0041E1C (-GetEdidsFromCache@DXGGLOBAL@@QEAAJPEAU_D3DKMT_DXGK_DIAGNOSTICS@@@Z.c)
 ...
 *     ?CheckDriverCommonEscape@@YAJPEAVDXGADAPTER@@AEBU_D3DKMT_ESCAPE@@PEAX@Z @ 0x1C00FF814 (-CheckDriverCommonEscape@@YAJPEAVDXGADAPTER@@AEBU_D3DKMT_ESCAPE@@PEAX@Z.c)
 ...
 *     ?DodSetDirtyRectMode@ADAPTER_DISPLAY@@QEAAJH@Z @ 0x1C01F1448 (-DodSetDirtyRectMode@ADAPTER_DISPLAY@@QEAAJH@Z.c)
 ...
 *     ?IsAMDDriverEscapeAllowed@@YAHPEAX_K@Z @ 0x1C024051C (-IsAMDDriverEscapeAllowed@@YAHPEAX_K@Z.c)
...
LABEL_69:
                      ...
                      if ( DXGADAPTER::IsRenderAdapter(v20) )
                        v157 = 1;
                      LODWORD(v31) = COREADAPTERACCESS::AcquireExclusive(v260, (unsigned int)v157 + 2, 2LL);
                      if ( (int)v31 < 0 )
                      {
LABEL_104:
                      ...
                      if ( !v157 && DXGADAPTER::IsRenderAdapter(v20) )
                        ADAPTER_RENDER::FlushScheduler(*((_QWORD *)v20 + 320), 2LL, 0xFFFFFFFFLL);
                      v36 = 1;
                      v38 = *(_QWORD *)&v217.Type;
                    }
LABEL_71:
