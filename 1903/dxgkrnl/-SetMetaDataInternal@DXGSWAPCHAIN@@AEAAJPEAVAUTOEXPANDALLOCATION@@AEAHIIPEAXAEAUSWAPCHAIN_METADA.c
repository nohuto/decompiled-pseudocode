/*
 * XREFs of ?SetMetaDataInternal@DXGSWAPCHAIN@@AEAAJPEAVAUTOEXPANDALLOCATION@@AEAHIIPEAXAEAUSWAPCHAIN_METADATA_ETW_INFO@1@D@Z @ 0x1C0287E6C
 * Callers:
        ...
        char a8)
{
  ...
  if ( v17 > 0x2000 )
  {
    v18 = (_QWORD *)WdLogNewEntry5_WdError(this, a2, a3);
