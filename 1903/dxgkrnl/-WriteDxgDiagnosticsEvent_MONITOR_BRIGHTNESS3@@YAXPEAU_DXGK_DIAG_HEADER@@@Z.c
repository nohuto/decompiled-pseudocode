/*
 * XREFs of ?WriteDxgDiagnosticsEvent_MONITOR_BRIGHTNESS3@@YAXPEAU_DXGK_DIAG_HEADER@@@Z @ 0x1C0041898
 * Callers:
...
void __fastcall WriteDxgDiagnosticsEvent_MONITOR_BRIGHTNESS3(struct _DXGK_DIAG_HEADER *a1)
{
  ...
  if ( TraceLoggingProviderEnabled((TraceLoggingHProvider)&hProvider, 4u, 0x200000000020uLL) && hProvider > 4u )
  {
    if ( TlgKeywordOn(v1, 0x200000000020uLL) )
    {
      v7 = 4LL;
      v6 = &unk_1C006E560;
      v8 = v11;
      ...
      v10 = v3;
      v11[1] = (_DWORD)v2;
      TlgWrite(v4, &unk_1C0072DAA, 0LL, v2, 5u, &pData);
    }
  }
}
