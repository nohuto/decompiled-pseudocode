/*
 * XREFs of ?FindOutputDuplManager@@YAJPEAVDXGADAPTER@@IPEAPEAV1@PEA_K12PEAPEAVOUTPUTDUPL_MGR@@@Z @ 0x1C00D51B8
 * Callers:
        ...
        struct OUTPUTDUPL_MGR **a7)
{
  ...
  else
  {
    if ( a3 && !*a3 || a5 && !*a5 )
    {
      ...
      *(_QWORD *)(v17 + 24) = 3134LL;
      WdLogEvent5_WdAssertion(v17);
    }
    *a7 = *(struct OUTPUTDUPL_MGR **)(*((_QWORD *)*a5 + 319) + 104LL);
    return 0LL;
  }
}
