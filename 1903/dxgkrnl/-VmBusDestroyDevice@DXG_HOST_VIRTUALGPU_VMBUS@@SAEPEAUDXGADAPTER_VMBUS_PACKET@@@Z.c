/*
 * XREFs of ?VmBusDestroyDevice@DXG_HOST_VIRTUALGPU_VMBUS@@SAEPEAUDXGADAPTER_VMBUS_PACKET@@@Z @ 0x1C021E3F0
 * Callers:
 *     <none>
 * Callees:
...
char __fastcall DXG_HOST_VIRTUALGPU_VMBUS::VmBusDestroyDevice(struct DXGADAPTER_VMBUS_PACKET *a1)
{
  ...
  _D3DKMT_DESTROYDEVICE v12; // [rsp+50h] [rbp+8h] BYREF
  ...
  if ( *(_BYTE *)(*((_QWORD *)a1 + 5) + 157LL) )
  {
    ...
    if ( v7 )
    {
      v12.hDevice = *(_DWORD *)(v7 + 24);
      v8 = DxgkDestroyDeviceImpl(&v12, 0);
