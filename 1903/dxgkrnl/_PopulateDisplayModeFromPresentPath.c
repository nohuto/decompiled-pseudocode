/*
 * XREFs of _PopulateDisplayModeFromPresentPath @ 0x1C016DF24
 * Callers:
        ...
        unsigned __int8 *a10)
{
  ...
  *a10 = 0;
  ...
  if ( ((v14 >> 3) & 0x3F) != 0 )
  {
    a9[2].Denominator *= (v14 >> 3) & 0x3F;
    v14 = a2[14];
  }
  a9[1].Denominator = DmmMapVSyncFromRationalToInteger(a9 + 2, (unsigned int)((int)(v14 << 29) >> 29), a10);
