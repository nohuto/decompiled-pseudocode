/*
 * XREFs of ?VSyncTelemetryBucket@ADAPTER_DISPLAY@@QEAAXXZ @ 0x1C0036110
 * Callers:
 *     ?VSyncTelemetryTimerDpc@ADAPTER_DISPLAY@@SAXPEAU_KDPC@@PEAX11@Z @ 0x1C00364E0 (-VSyncTelemetryTimerDpc@ADAPTER_DISPLAY@@SAXPEAU_KDPC@@PEAX11@Z.c)
 * Callees:
...
LABEL_14:
  if ( v3 )
  {
      ...
      && TlgKeywordOn(v9, 0x400000002000uLL) )
    {
      ...
      v47[0] = v15;
      v47[1] = 0;
      TlgWrite(v12, &unk_1C00729E2, 0LL, v10, 0xDu, &pData);
    }
