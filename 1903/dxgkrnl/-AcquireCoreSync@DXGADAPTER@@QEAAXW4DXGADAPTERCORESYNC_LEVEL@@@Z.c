/*
 * XREFs of ?AcquireCoreSync@DXGADAPTER@@QEAAXW4DXGADAPTERCORESYNC_LEVEL@@@Z @ 0x1C012771C
 * Callers:
 *     ?DXGADAPTER_AcquireCoreSync@@YAXPEAVDXGADAPTER@@W4DXGADAPTERCORESYNC_LEVEL@@@Z @ 0x1C003E020 (-DXGADAPTER_AcquireCoreSync@@YAXPEAVDXGADAPTER@@W4DXGADAPTERCORESYNC_LEVEL@@@Z.c)
...
void __fastcall DXGADAPTER::AcquireCoreSync(__int64 a1, int a2)
{
  ...
  {
    case 1:
      DXGADAPTER::AcquireCoreResourceShared(a1, 0xFFFFFFFF, 0LL);
      break;
    case 2:
      DXGADAPTER::AcquireCoreResourceExclusive(a1, 2u, 0, 0xFFFFFFFF);
      v10 = *(_QWORD *)(a1 + 2560);
      if ( v10 )
