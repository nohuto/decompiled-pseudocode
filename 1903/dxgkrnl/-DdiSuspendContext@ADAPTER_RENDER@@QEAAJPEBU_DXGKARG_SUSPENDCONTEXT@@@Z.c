/*
 * XREFs of ?DdiSuspendContext@ADAPTER_RENDER@@QEAAJPEBU_DXGKARG_SUSPENDCONTEXT@@@Z @ 0x1C01FF200
 * Callers:
 *     ?ADAPTER_RENDER_DdiSuspendContext@@YAJPEAVADAPTER_RENDER@@PEBU_DXGKARG_SUSPENDCONTEXT@@@Z @ 0x1C003E000 (-ADAPTER_RENDER_DdiSuspendContext@@YAJPEAVADAPTER_RENDER@@PEBU_DXGKARG_SUSPENDCONTEXT@@@Z.c)
 * Callees:
