/*
 * XREFs of DxgkSuspendMemorySegments @ 0x1C01F6DC8
 * Callers:
...
__int64 __fastcall DxgkSuspendMemorySegments(__int64 a1, __int64 a2, __int64 a3)
{
  __int64 v4; // rax
  unsigned int v5; // ebx
...
LABEL_3:
  ...
  return ADAPTER_RENDER::SuspendMemorySegments(v7);
}
