/*
 * XREFs of MonitorDisableMonitorVirtualModeSupport @ 0x1C02C9260
 * Callers:
 ...
 *     ?_DisableVirtualModeSupport@DXGMONITOR@@QEAAJ_N@Z @ 0x1C02CE174 (-_DisableVirtualModeSupport@DXGMONITOR@@QEAAJ_N@Z.c)
 */
