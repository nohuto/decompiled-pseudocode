/*
 * XREFs of ?UnpinDirectFlipAllocation@DXGDEVICE@@QEAAJIIPEAPEAVDXGALLOCATION@@PEAVCOREDEVICEACCESS@@@Z @ 0x1C01501E0
 * Callers:
  ...
  do
  {
    ...
    if ( DXGDEVICE::RemoveDirectFlipAllocationFromList(this, a2, *a4) )
    {
      if ( !*((_QWORD *)v10 + 5) )
      {
        ...
        *(_QWORD *)(v14 + 24) = 6635LL;
        WdLogEvent5_WdAssertion(v14);
      }
      DxgkReferenceDxgAllocation((struct _EX_RUNDOWN_REF *)v10);
      DxgkReferenceDxgResource(*((struct _EX_RUNDOWN_REF **)v10 + 5));
      LODWORD(v5) = (*(__int64 (__fastcall **)(_QWORD, struct DXGALLOCATION *))(*(_QWORD *)(*(_QWORD *)(*((_QWORD *)this + 2) + 544LL)
                                                                                          + 8LL)
                                                                              + 240LL))(
