/*
 * XREFs of ?TdrValidateDebugMode@@YAXXZ @ 0x1C0040D40
 * Callers:
 *     TdrTimedOperationAllowToDebugTimeout @ 0x1C0040DE4 (TdrTimedOperationAllowToDebugTimeout.c)
 *     ?TdrAllowToDebugEngineTimeout@@YA_NPEAU_VIDSCH_NODE@@@Z @ 0x1C023CC70 (-TdrAllowToDebugEngineTimeout@@YA_NPEAU_VIDSCH_NODE@@@Z.c)
