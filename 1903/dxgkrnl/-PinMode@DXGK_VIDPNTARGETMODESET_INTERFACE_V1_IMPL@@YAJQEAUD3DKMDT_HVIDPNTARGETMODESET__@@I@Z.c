/*
 * XREFs of ?PinMode@DXGK_VIDPNTARGETMODESET_INTERFACE_V1_IMPL@@YAJQEAUD3DKMDT_HVIDPNTARGETMODESET__@@I@Z @ 0x1C02BE4E0
 * Callers:
 *     <none>
 * Callees:
        ...
        const GUID *a3)
{
  ...
  DXGETWPROFILER_BASE_PushProfilerEntry((__int64)&v22, 7015LL);
  ...
  *(_QWORD *)(v7 + 32) = this;
  ...
  if ( v9 )
  {
    v15 = DMMVIDPNTARGETMODESET::PinMode(v9, (unsigned int)v4);
    if ( v15 >= 0 )
    {
      v15 = 0;
    }
