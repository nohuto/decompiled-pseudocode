/*
 * XREFs of DpiMiracastStopMiracastSessionAsync @ 0x1C004D050
 * Callers:
  ...
  if ( !(_BYTE)a2 || a3 )
  {
    ...
    if ( PoolWithTag )
    {
      ...
      *((_DWORD *)PoolWithTag + 6) = a4;
      IoInitializeWorkItem(v20, (PIO_WORKITEM)(PoolWithTag + 32));
    ...
    else
    {
      ...
      *(_QWORD *)(v18 + 24) = -1073741801LL;
      ...
      DpiMiracastReleaseMiracastDeviceContext((int *)P, (__int64)DpiMiracastStopMiracastSessionAsync, v19);
    }
    return v17;
  }
  else
  {
    v8 = WdLogNewEntry5_WdError(P, a2, 0LL);
    *(_QWORD *)(v8 + 24) = P;
