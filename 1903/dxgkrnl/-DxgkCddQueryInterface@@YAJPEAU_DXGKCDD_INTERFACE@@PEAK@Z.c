/*
 * XREFs of ?DxgkCddQueryInterface@@YAJPEAU_DXGKCDD_INTERFACE@@PEAK@Z @ 0x1C0142AB8
 * Callers:
...
__int64 __fastcall DxgkCddQueryInterface(struct _DXGKCDD_INTERFACE *a1, unsigned int *a2, __int64 a3)
{
  ...
  if ( *(_DWORD *)a1 != 459280 )
  {
    v12 = (_QWORD *)WdLogNewEntry5_WdError(a1, a2, a3);
    v12[3] = -1073741811LL;
...
LABEL_14:
  ...
  PairingAdapters = DxgkpGetPairingAdapters(v5, *((unsigned int *)a1 + 4), 0LL, 0LL, &v15, &v16, 0);
  v9 = PairingAdapters;
  ...
  if ( v10 && !*((_QWORD *)v10 + 319) )
  {
    v14 = WdLogNewEntry5_WdAssertion(v8, v7);
    *(_QWORD *)(v14 + 24) = 4281LL;
