/*
 * XREFs of ?Discard@CFlipToken@@UEAAXXZ @ 0x1C000F810
 * Callers:
...
void __fastcall CFlipToken::Discard(CFlipToken *this, __int64 a2)
{
  ...
  __int64 v8; // r12
  int v9; // ebx
  void (__fastcall *v10)(__int64, _QWORD, _QWORD, _QWORD, int, int, BOOL, __int64, __int64); // rdi
  ...
  *((_DWORD *)this + 6) = 6;
  ...
  if ( v7 )
  {
    ...
    *(_QWORD *)(v16 + 24) = 2200LL;
    WdLogEvent5_WdAssertion(v16);
  }
  v9 = *((unsigned __int8 *)this + 556);
  v10 = *(void (__fastcall **)(__int64, _QWORD, _QWORD, _QWORD, int, int, BOOL, __int64, __int64))(*((_QWORD *)DXGGLOBAL::m_pGlobal + 38000)
                                                                                                 + 120LL);
  v11 = (*(__int64 (__fastcall **)(CFlipToken *))(*(_QWORD *)this + 112LL))(this);
  v10(v2, v5, v11, *((_QWORD *)this + 12), 6, v9, v6, v8, v4);
  if ( *((_BYTE *)this + 557) )
  {
