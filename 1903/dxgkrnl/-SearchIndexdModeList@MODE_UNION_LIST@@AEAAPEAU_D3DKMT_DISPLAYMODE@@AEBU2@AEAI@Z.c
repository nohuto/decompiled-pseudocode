/*
 * XREFs of ?SearchIndexdModeList@MODE_UNION_LIST@@AEAAPEAU_D3DKMT_DISPLAYMODE@@AEBU2@AEAI@Z @ 0x1C016DDC4
 * Callers:
 ...
 * Callees:
 *     _CompareDisplayMode @ 0x1C016DEA8 (_CompareDisplayMode.c)
 */
