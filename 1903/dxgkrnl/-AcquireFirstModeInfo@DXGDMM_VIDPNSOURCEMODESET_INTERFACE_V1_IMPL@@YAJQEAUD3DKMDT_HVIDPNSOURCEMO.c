/*
 * XREFs of ?AcquireFirstModeInfo@DXGDMM_VIDPNSOURCEMODESET_INTERFACE_V1_IMPL@@YAJQEAUD3DKMDT_HVIDPNSOURCEMODESET__@@PEAPEBU_D3DKMDT_VIDPN_SOURCE_MODE@@@Z @ 0x1C017F390
 * Callers:
 *     <none>
 * Callees:
        ...
        const struct _D3DKMDT_VIDPN_SOURCE_MODE **a3)
{
  ...
  __int64 v26; // rax
  __int64 v27; // rax
  struct DMMVIDPNSOURCEMODE *(__fastcall *v28)(DMMVIDPNSOURCEMODESET *); // [rsp+20h] [rbp-30h] BYREF
  ...
  if ( a2 )
  {
    *(_QWORD *)a2 = 0LL;
    ...
    if ( v10 )
    {
      v29 = 0;
      v33 = 0LL;
      v28 = DMMVIDPNSOURCEMODESET::GetFirstMode;
