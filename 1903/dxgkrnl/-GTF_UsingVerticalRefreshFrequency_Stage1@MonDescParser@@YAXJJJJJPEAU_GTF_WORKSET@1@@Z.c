/*
 * XREFs of ?GTF_UsingVerticalRefreshFrequency_Stage1@MonDescParser@@YAXJJJJJPEAU_GTF_WORKSET@1@@Z @ 0x1C002108C
 * Callers:
 ...
 * Callees:
 *     ?GTF_InitWorkset@MonDescParser@@YAXPEAU_GTF_WORKSET@1@@Z @ 0x1C002130C (-GTF_InitWorkset@MonDescParser@@YAXPEAU_GTF_WORKSET@1@@Z.c)
 */
