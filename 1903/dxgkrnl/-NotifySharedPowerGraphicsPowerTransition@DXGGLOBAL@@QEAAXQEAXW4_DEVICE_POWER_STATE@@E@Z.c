/*
 * XREFs of ?NotifySharedPowerGraphicsPowerTransition@DXGGLOBAL@@QEAAXQEAXW4_DEVICE_POWER_STATE@@E@Z @ 0x1C0244344
 * Callers:
        ...
        char a4)
{
  ...
  for ( i = (__int64 **)*((_QWORD *)this + 175); i != (__int64 **)((char *)this + 1400) && i; i = (__int64 **)*i )
  {
    if ( i[4] == a2 )
    {
      v11 = i[5];
