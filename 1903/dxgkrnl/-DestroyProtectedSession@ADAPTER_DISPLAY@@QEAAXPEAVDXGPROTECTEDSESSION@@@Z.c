/*
 * XREFs of ?DestroyProtectedSession@ADAPTER_DISPLAY@@QEAAXPEAVDXGPROTECTEDSESSION@@@Z @ 0x1C0261108
 * Callers:
...
void __fastcall ADAPTER_DISPLAY::DestroyProtectedSession(DXGADAPTER **this, struct _EX_RUNDOWN_REF *P)
{
  ...
  *(_QWORD *)(v10.Count + 8) = Count;
  ...
  if ( (int)COREADAPTERACCESS::AcquireExclusive(&v17, (unsigned int)(v12 + 1), v12) < 0 )
  {
