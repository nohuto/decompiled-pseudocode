/*
 * XREFs of McTemplateK0qqqqqqqqqDR8 @ 0x1C0046618
 * Callers:
...
ULONG __fastcall McTemplateK0qqqqqqqqqDR8(
        __int64 a1,
        ...
        __int64 a13)
{
  ...
  v32 = 4LL;
  v35 = 0;
  return McGenEventWrite((PMCGEN_TRACE_CONTEXT)&DxgkControlGuid_Context, a2, 0LL, 0xBu, &EventData);
}
