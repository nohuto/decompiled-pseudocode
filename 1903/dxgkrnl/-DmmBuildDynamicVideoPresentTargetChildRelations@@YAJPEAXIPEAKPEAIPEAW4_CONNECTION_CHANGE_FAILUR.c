/*
 * XREFs of ?DmmBuildDynamicVideoPresentTargetChildRelations@@YAJPEAXIPEAKPEAIPEAW4_CONNECTION_CHANGE_FAILURE_REASON@@@Z @ 0x1C02B9FEC
 * Callers:
        ...
        enum _CONNECTION_CHANGE_FAILURE_REASON *a5)
{
  ...
  auto_rc<DMMVIDEOPRESENTTARGETSET>::reset((__int64 *)&v16, 0LL, v13);
  DXGFASTMUTEX::Release(*(struct _KTHREAD ***)(v15[0] + 40));
