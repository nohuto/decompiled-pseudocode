/*
 * XREFs of ?DxgkThreadCallout@@YAJPEAPEAXE@Z @ 0x1C013B440
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall DxgkThreadCallout(void **a1, char a2)
{
  ...
  PoolWithQuotaTag = ExAllocatePoolWithQuotaTag((POOL_TYPE)9, 0x94uLL, 0x4B677844u);
  v8 = PoolWithQuotaTag;
  if ( PoolWithQuotaTag )
  {
    *PoolWithQuotaTag = 0;
    PoolWithQuotaTag[34] = 0;
    PoolWithQuotaTag[35] = 0;
    PoolWithQuotaTag[36] = -1;
