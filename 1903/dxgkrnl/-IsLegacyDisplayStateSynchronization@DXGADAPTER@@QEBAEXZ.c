/*
 * XREFs of ?IsLegacyDisplayStateSynchronization@DXGADAPTER@@QEBAEXZ @ 0x1C000D6C0
 * Callers:
...
unsigned __int8 __fastcall DXGADAPTER::IsLegacyDisplayStateSynchronization(DXGADAPTER *this)
{
  ...
  v1 = 0;
  if ( *((int *)this + 546) < 8960 && (!*((_BYTE *)this + 2501) || !DXGADAPTER::UsingSetTimingsFromVidPn(this)) )
    return 1;
  return v1;
}
