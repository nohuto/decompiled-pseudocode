/*
 * XREFs of ?GetResourceForBar@DXGK_VIRTUAL_GPU_PARAV@@UEAAJPEAU_DXGKARG_GETRESOURCEFORBAR@@@Z @ 0x1C014C700
 * Callers:
 *     <none>
 * Callees:
 *     <none>
        ...
        struct _DXGKARG_GETRESOURCEFORBAR *a2)
{
  ...
  *(_QWORD *)&pResource->Type = 0LL;
  *(_QWORD *)&pResource->u.MessageInterrupt.Translated.Vector = 0LL;
