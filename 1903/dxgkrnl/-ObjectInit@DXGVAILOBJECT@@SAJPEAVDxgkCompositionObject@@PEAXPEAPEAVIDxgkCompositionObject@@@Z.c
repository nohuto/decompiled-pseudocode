/*
 * XREFs of ?ObjectInit@DXGVAILOBJECT@@SAJPEAVDxgkCompositionObject@@PEAXPEAPEAVIDxgkCompositionObject@@@Z @ 0x1C0290F40
 * Callers:
 *     <none>
 * Callees:
 *     ??0DXGVAILOBJECT@@QEAA@XZ @ 0x1C028F4D0 (--0DXGVAILOBJECT@@QEAA@XZ.c)
 */
