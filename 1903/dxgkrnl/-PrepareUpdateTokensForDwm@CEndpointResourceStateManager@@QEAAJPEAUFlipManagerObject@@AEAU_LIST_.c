/*
 * XREFs of ?PrepareUpdateTokensForDwm@CEndpointResourceStateManager@@QEAAJPEAUFlipManagerObject@@AEAU_LIST_ENTRY@@@Z @ 0x1C0062FF4
 * Callers:
 ...
 *     ??$FindProperty@UFlipContentBufferFormatInfo@@@CFlipPropertySetBase@@QEAAXPEAPEAUFlipContentBufferFormatInfo@@@Z @ 0x1C0061D58 (--$FindProperty@UFlipContentBufferFormatInfo@@@CFlipPropertySetBase@@QEAAXPEAPEAUFlipContentBuff.c)
 *     ??$FindProperty@UPresentedSurfaceUpdateFlags@@@CFlipPropertySetBase@@QEAAXPEAPEAUPresentedSurfaceUpdateFlags@@@Z @ 0x1C0061DB8 (--$FindProperty@UPresentedSurfaceUpdateFlags@@@CFlipPropertySetBase@@QEAAXPEAPEAUPresentedSurfac.c)
 ...
 *     ?CreateUpdateTokens@CContentResourceState@@QEAAJPEAVCEndpointResourceStateManager@@AEAU_LIST_ENTRY@@@Z @ 0x1C0064034 (-CreateUpdateTokens@CContentResourceState@@QEAAJPEAVCEndpointResourceStateManager@@AEAU_LIST_ENT.c)
 */
