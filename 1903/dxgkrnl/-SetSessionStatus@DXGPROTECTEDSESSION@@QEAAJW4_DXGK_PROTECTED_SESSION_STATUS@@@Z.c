/*
 * XREFs of ?SetSessionStatus@DXGPROTECTEDSESSION@@QEAAJW4_DXGK_PROTECTED_SESSION_STATUS@@@Z @ 0x1C00448F4
 * Callers:
 ...
 * Callees:
 *     ?QueueSignal@DXGPROTECTEDSESSION@@QEAAJXZ @ 0x1C0261598 (-QueueSignal@DXGPROTECTEDSESSION@@QEAAJXZ.c)
 */
