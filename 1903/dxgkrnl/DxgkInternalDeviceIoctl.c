/*
 * XREFs of DxgkInternalDeviceIoctl @ 0x1C01428A0
 * Callers:
 *     <none>
 * Callees:
 ...
 *     ?ComputeQueryInterface@@YAJPEAU_DXGKCOMPUTE_INTERFACE@@PEAK@Z @ 0x1C003FA84 (-ComputeQueryInterface@@YAJPEAU_DXGKCOMPUTE_INTERFACE@@PEAK@Z.c)
 ...
 *     ?DxgkWin32kQueryInterface@@YAJPEAU_DXGKWIN32K_INTERFACE@@PEAK@Z @ 0x1C0142EBC (-DxgkWin32kQueryInterface@@YAJPEAU_DXGKWIN32K_INTERFACE@@PEAK@Z.c)
 *     DxgkCaptureQueryInterface @ 0x1C020B150 (DxgkCaptureQueryInterface.c)
 */
...
__int64 __fastcall DxgkInternalDeviceIoctl(__int64 a1, __int64 a2, const GUID *a3)
{
  ...
  DXGETWPROFILER_BASE_PushProfilerEntry((__int64)&v32, 2LL);
...
LABEL_63:
    ...
    if ( (unsigned int)v11 < 0x318 || (unsigned int)v10 < 0x318 )
    {
    ...
    Global = (struct DXGKW32KIMPORTS **)DXGGLOBAL::GetGlobal(v5, v4);
...
LABEL_33:
  ...
  v35 = -1073741275;
  LODWORD(v10) = DXGGLOBAL::IterateAdaptersWithCallback((__int64)v29, (__int64)RfxVgpuResetCallback, (__int64)&v35, 0);
  if ( (int)v10 < 0 )
    goto LABEL_62;
  LODWORD(v10) = v35;
  if ( (v35 & 0x80000000) != 0 )
...
LABEL_16:
  ...
  *(_DWORD *)(a2 + 48) = v10;
  ...
  if ( v34 && (Microsoft_Windows_DxgKrnlEnableBits & 0x2000) != 0 )
    McTemplateK0q(v18, &EventProfilerExit, v19, v32);
