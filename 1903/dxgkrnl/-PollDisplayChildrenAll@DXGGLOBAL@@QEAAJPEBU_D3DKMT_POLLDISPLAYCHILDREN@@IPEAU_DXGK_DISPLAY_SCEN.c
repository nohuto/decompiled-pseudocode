/*
 * XREFs of ?PollDisplayChildrenAll@DXGGLOBAL@@QEAAJPEBU_D3DKMT_POLLDISPLAYCHILDREN@@IPEAU_DXGK_DISPLAY_SCENARIO_CONTEXT@@@Z @ 0x1C0244658
 * Callers:
  ...
  if ( v93 && v18 && v96 && v108 && v20 )
  {
    ...
    while ( v24 != v23 && v24 )
    {
      ...
      if ( (_BYTE)v27 )
      {
        ...
        if ( v26[319] )
        {
          LODWORD(v30) = COREADAPTERACCESS::AcquireExclusive(&v102, 1LL, 0LL);
          if ( (int)v30 >= 0 )
          {
            v31 = (void *)v26[24];
            v83[v10] = v31;
    ...
    if ( (*((_DWORD *)a2 + 1) & 4) != 0 && (_DWORD)v10 )
    {
      ...
      while ( v63 != v23 && v63 )
      {
        ...
        if ( (_BYTE)v65 )
        {
          ...
          if ( (int)COREADAPTERACCESS::AcquireExclusive(&v105, 1LL, 0LL) >= 0 )
          {
