/*
 * XREFs of ?DdiReleaseSwizzlingRange@ADAPTER_RENDER@@QEAAJPEBU_DXGKARG_RELEASESWIZZLINGRANGE@@@Z @ 0x1C0144EE0
 * Callers:
 *     ?ADAPTER_RENDER_DdiReleaseSwizzlingRange@@YAJPEAVADAPTER_RENDER@@PEBU_DXGKARG_RELEASESWIZZLINGRANGE@@@Z @ 0x1C001A6D0 (-ADAPTER_RENDER_DdiReleaseSwizzlingRange@@YAJPEAVADAPTER_RENDER@@PEBU_DXGKARG_RELEASESWIZZLINGRA.c)
 * Callees:
        ...
        const GUID *a3)
{
  ...
  DXGETWPROFILER_BASE_PushProfilerEntry((__int64)&v30, 5007LL);
...
LABEL_16:
  ...
  v15 = (*(int (__fastcall **)(_QWORD, const struct _DXGKARG_RELEASESWIZZLINGRANGE *))(*((_QWORD *)this + 2) + 376LL))(
  ...
  if ( (_DWORD)v15 )
  {
    v25 = WdLogNewEntry5_WdError(PrivateDriverData, v22, v23);
    *(_QWORD *)(v25 + 24) = v15;
