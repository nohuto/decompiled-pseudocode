/*
 * XREFs of ?QueueSerializedWorkItem@CSERIALIZEDWORKQUEUE@@QEAAJP6AXPEAX@Z0@Z @ 0x1C015AAEC
 * Callers:
 ...
 *     ?DestroyTtmDevice@DXGSESSIONMGR@@QEAAXPEAX@Z @ 0x1C0276A28 (-DestroyTtmDevice@DXGSESSIONMGR@@QEAAXPEAX@Z.c)
 * Callees:
  ...
  if ( v12 )
  {
    ...
    *v13 = v12;
    ...
    if ( !*((_BYTE *)this + 56) )
    {
      ...
      {
        v3 = -1073741801;
        v21 = WdLogNewEntry5_WdLowResource(v16, v15, v17, v18);
