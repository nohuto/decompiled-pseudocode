/*
 * XREFs of ?DdiDestroyDevice@ADAPTER_RENDER@@QEAAJPEAX@Z @ 0x1C0121868
 * Callers:
 *     ?ADAPTER_RENDER_DdiDestroyDevice@@YAJPEAVADAPTER_RENDER@@PEAX@Z @ 0x1C003DDA0 (-ADAPTER_RENDER_DdiDestroyDevice@@YAJPEAVADAPTER_RENDER@@PEAX@Z.c)
...
__int64 __fastcall ADAPTER_RENDER::DdiDestroyDevice(ADAPTER_RENDER *this, void *a2, const GUID *a3)
{
  __int64 v5; // rdx
  __int64 v6; // rcx
  ...
  if ( (*(_BYTE *)(&DxgkControlGuid_Context + 2) & 2) != 0 )
  {
    ...
    if ( (Microsoft_Windows_DxgKrnlEnableBits & 0x2000) != 0 )
      McTemplateK0q((__int64)this, &EventProfilerEnter, a3, 5027);
  }
  else
  {
    v35 = 0;
  }
  DXGETWPROFILER_BASE_PushProfilerEntry((__int64)&v33, 5027LL);
...
LABEL_16:
  ...
  v18 = (*(int (__fastcall **)(void *))(*((_QWORD *)this + 2) + 576LL))(a2);
  if ( v37[0] )
  ...
  v24 = WdLogNewEntry5_WdEvent(v19);
  *(_QWORD *)(v24 + 24) = v18;
  *(_QWORD *)(v24 + 32) = a2;
