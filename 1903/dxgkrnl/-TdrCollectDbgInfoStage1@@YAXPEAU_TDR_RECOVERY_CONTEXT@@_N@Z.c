/*
 * XREFs of ?TdrCollectDbgInfoStage1@@YAXPEAU_TDR_RECOVERY_CONTEXT@@_N@Z @ 0x1C023CDB0
 * Callers:
 ...
 *     DpiGetAdapterDebugData @ 0x1C004A6DC (DpiGetAdapterDebugData.c)
 *     DpiGetDbgInfoAdapters @ 0x1C004A760 (DpiGetDbgInfoAdapters.c)
 *     DpiGetGlobalDebugData @ 0x1C004A850 (DpiGetGlobalDebugData.c)
 ...
 *     ??0CTDR_DUMP_BUFFER@@QEAA@GPEAXK@Z @ 0x1C023C294 (--0CTDR_DUMP_BUFFER@@QEAA@GPEAXK@Z.c)
