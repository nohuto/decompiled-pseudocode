/*
 * XREFs of ?SetVidPnSourceOwnerInternal@@YAJPEBU_D3DKMT_SETVIDPNSOURCEOWNER@@U_D3DKMT_VIDPNSOURCEOWNER_FLAGS@@PEBQEAXPEAU_DXGK_DISPLAY_SCENARIO_CONTEXT@@@Z @ 0x1C00CB238
 * Callers:
 ...
 *     ?RemoveVidPnOwnership@DXGDEVICE@@QEAAXI@Z @ 0x1C00C8640 (-RemoveVidPnOwnership@DXGDEVICE@@QEAAXI@Z.c)
 *     ?CheckSessionOwnership@DISPLAY_SOURCE@@QEAAEXZ @ 0x1C00CA7CC (-CheckSessionOwnership@DISPLAY_SOURCE@@QEAAEXZ.c)
 ...
 *     ?SetSchedulingPriorityAdjustment@DXGDEVICE@@QEAAXH@Z @ 0x1C00CC390 (-SetSchedulingPriorityAdjustment@DXGDEVICE@@QEAAXH@Z.c)
