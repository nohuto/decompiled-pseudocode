/*
 * XREFs of CreateTokenManagerSessionGlobal @ 0x1C0001340
 * Callers:
 *     ??0DXGSESSIONDATA@@QEAA@K@Z @ 0x1C00C571C (--0DXGSESSIONDATA@@QEAA@K@Z.c)
 * Callees:
 *     ?Initialize@CTokenManager@@AEAAJXZ @ 0x1C00013C0 (-Initialize@CTokenManager@@AEAAJXZ.c)
 *     ??0CTokenManager@@AEAA@XZ @ 0x1C0001518 (--0CTokenManager@@AEAA@XZ.c)
