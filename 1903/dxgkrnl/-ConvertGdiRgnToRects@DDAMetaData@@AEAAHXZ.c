/*
 * XREFs of ?ConvertGdiRgnToRects@DDAMetaData@@AEAAHXZ @ 0x1C027880C
 * Callers:
...
__int64 __fastcall DDAMetaData::ConvertGdiRgnToRects(DDAMetaData *this)
{
  ...
  if ( (unsigned int)v4 <= *((_DWORD *)this + 5) )
  {
    ...
    if ( !(*(unsigned int (__fastcall **)(_QWORD, _QWORD, void *))(*((_QWORD *)this + 7) + 112LL))(
            *((_QWORD *)this + 8),
            ...
            Buffer) )
    {
      v19 = WdLogNewEntry5_WdError(v24, v23, v25);
      *(_QWORD *)(v19 + 24) = 1158LL;
      goto LABEL_11;
    }
  }
  else
  {
    ...
    if ( *((_DWORD *)this + 11) )
    {
      ...
      v19 = WdLogNewEntry5_WdError(v8, v7, v10);
      *(_QWORD *)(v19 + 24) = 1126LL;
      goto LABEL_11;
    }
LABEL_7:
    v14 = *((_QWORD *)this + 7);
    DirtyRectData = DDAMetaData::GetDirtyRectData(this, 1u);
    if ( !(*(unsigned int (__fastcall **)(_QWORD, struct tagRECT *))(v14 + 120))(*((_QWORD *)this + 8), DirtyRectData) )
    {
      v19 = WdLogNewEntry5_WdError(v17, v16, v18);
      *(_QWORD *)(v19 + 24) = 1140LL;
LABEL_11:
