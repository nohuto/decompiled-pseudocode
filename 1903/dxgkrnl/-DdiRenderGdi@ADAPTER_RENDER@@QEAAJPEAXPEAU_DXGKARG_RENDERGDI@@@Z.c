/*
 * XREFs of ?DdiRenderGdi@ADAPTER_RENDER@@QEAAJPEAXPEAU_DXGKARG_RENDERGDI@@@Z @ 0x1C01FBB04
 * Callers:
...
__int64 __fastcall ADAPTER_RENDER::DdiRenderGdi(ADAPTER_RENDER *this, void *a2, const GUID *a3)
{
  __int64 v6; // rdx
  __int64 v7; // rcx
  ...
  if ( (*(_BYTE *)(&DxgkControlGuid_Context + 2) & 2) != 0 )
  {
    ...
    if ( (Microsoft_Windows_DxgKrnlEnableBits & 0x2000) != 0 )
      McTemplateK0q((__int64)this, &EventProfilerEnter, a3, 5066);
  }
  else
  {
    v36 = 0;
  }
  DXGETWPROFILER_BASE_PushProfilerEntry((__int64)&v34, 5066LL);
...
LABEL_16:
  ...
  v19 = (*(int (__fastcall **)(void *, const GUID *))(*((_QWORD *)this + 2) + 792LL))(a2, a3);
  if ( v38[0] )
  ...
  v25[3] = v19;
  v25[4] = a2;
  v25[5] = *(_QWORD *)&a3[1].Data1;
  v25[6] = a3[2].Data1;
  v28 = *(_QWORD *)a3[3].Data4;
  v25[7] = v28;
  if ( (unsigned int)(v19 + 1073741816) > 0xF || (v28 = 32801LL, !_bittest((const int *)&v28, v19 + 1073741816)) )
  {
    if ( (_DWORD)v19 != -1073741592 && (_DWORD)v19 != -1071775743 && (_DWORD)v19 != -1071775232 && (_DWORD)v19 )
    {
