/*
 * XREFs of ?DxgkCreateDeviceImpl@@YAJPEAU_D3DKMT_CREATEDEVICE@@PEAUDXGK_VIRTUAL_GPU_PARAV@@PEAPEAUDXG_SET_GUEST_DATA@@E@Z @ 0x1C00DFCEC
 * Callers:
 *     DxgkCreateDevice @ 0x1C00DFCD0 (DxgkCreateDevice.c)
 *     DxgkCreateDeviceInternal @ 0x1C012FBF8 (DxgkCreateDeviceInternal.c)
