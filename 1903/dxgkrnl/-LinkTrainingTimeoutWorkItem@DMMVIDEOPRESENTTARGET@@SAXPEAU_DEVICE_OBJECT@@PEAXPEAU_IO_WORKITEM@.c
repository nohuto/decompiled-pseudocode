/*
 * XREFs of ?LinkTrainingTimeoutWorkItem@DMMVIDEOPRESENTTARGET@@SAXPEAU_DEVICE_OBJECT@@PEAXPEAU_IO_WORKITEM@@@Z @ 0x1C02BBCF0
 * Callers:
 *     <none>
 * Callees:
        ...
        PIO_WORKITEM IoWorkItem)
{
  ...
  if ( (v8 & 0xFFFFFFFD) == 0 )
  {
    ...
    v14 = (int)COREADAPTERACCESS::AcquireExclusive(&v31, (unsigned int)(v11 + 2), v11);
