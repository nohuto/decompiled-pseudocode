/*
 * XREFs of ??_GDXG_GUEST_REMOTEOBJECTCHANNEL@@IEAAPEAXI@Z @ 0x1C028F700
 * Callers:
 *     ?Delete@DXG_GUEST_REMOTEOBJECTCHANNEL@@UEAAXXZ @ 0x1C02906A0 (-Delete@DXG_GUEST_REMOTEOBJECTCHANNEL@@UEAAXXZ.c)
 * Callees:
