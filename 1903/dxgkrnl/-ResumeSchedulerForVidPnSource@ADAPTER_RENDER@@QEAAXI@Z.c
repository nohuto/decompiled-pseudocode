/*
 * XREFs of ?ResumeSchedulerForVidPnSource@ADAPTER_RENDER@@QEAAXI@Z @ 0x1C01F608C
 * Callers:
...
void __fastcall ADAPTER_RENDER::ResumeSchedulerForVidPnSource(ADAPTER_RENDER *this, __int64 a2)
{
  ...
  *((_DWORD *)this + 135) = v4 & ~v3;
  (*(void (__fastcall **)(_QWORD, _QWORD))(*(_QWORD *)(*((_QWORD *)this + 65) + 8LL) + 1000LL))(
    *((_QWORD *)this + 66),
    v3);
  if ( (Microsoft_Windows_DxgKrnlEnableBits & 0x40) != 0 )
    McTemplateK0xq(v6, &ResumeSchedulerForVidPnSource, v7, *((_QWORD *)this + 2), v3);
}
