/*
 * XREFs of ?SubmitCommandToImplicitQueue@DXGCONTEXT@@QEAAJPEAUVIDSCH_SUBMIT_DATA_BASE@@@Z @ 0x1C020DC10
 * Callers:
...
__int64 __fastcall DXGCONTEXT::SubmitCommandToImplicitQueue(DXGCONTEXT *this, struct VIDSCH_SUBMIT_DATA_BASE *a2)
{
  ...
  if ( (*((_DWORD *)this + 103) & 0x10) == 0 )
    return (*(__int64 (__fastcall **)(_QWORD, struct VIDSCH_SUBMIT_DATA_BASE *, DXGCONTEXT *, struct VIDSCH_SUBMIT_DATA_BASE *))(*(_QWORD *)(*(_QWORD *)(*(_QWORD *)(v2 + 16) + 520LL) + 8LL) + 424LL))(
             *((_QWORD *)this + 34),
             a2,
             this,
             a2);
