/*
 * XREFs of NtFlipObjectAddPoolBuffer @ 0x1C005EC70
 * Callers:
 *     <none>
 * Callees:
        ...
        char *a6)
{
  ...
  struct CFlipPropertySet *v15; // [rsp+30h] [rbp-58h] BYREF
  struct FlipManagerObject *v16; // [rsp+38h] [rbp-50h] BYREF
  struct _LUID v17; // [rsp+40h] [rbp-48h] BYREF
  unsigned __int64 v18; // [rsp+48h] [rbp-40h]
  struct _LUID v19; // [rsp+50h] [rbp-38h]
  ...
  if ( a1 && a2 && a3 && a4 )
  {
    ...
    if ( v11 >= 0 )
    {
      ...
      v8 = v16;
      if ( v11 >= 0 )
        v11 = FlipManagerObject::AddPoolBuffer(v16, v9, a3, &v17, v13);
    }
    if ( v13 )
