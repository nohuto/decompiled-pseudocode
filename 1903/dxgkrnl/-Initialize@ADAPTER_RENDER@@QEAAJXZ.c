/*
 * XREFs of ?Initialize@ADAPTER_RENDER@@QEAAJXZ @ 0x1C015BE84
 * Callers:
 ...
 *     ?RtlUnicodeStringCchCopyStringN@@YAJPEAU_UNICODE_STRING@@PEBG_K@Z @ 0x1C00371A4 (-RtlUnicodeStringCchCopyStringN@@YAJPEAU_UNICODE_STRING@@PEBG_K@Z.c)
 ...
 *     ?IsKnownMismatchedVersionedDriver@ADAPTER_RENDER@@AEAA_NPEAT_LARGE_INTEGER@@0@Z @ 0x1C01F58F8 (-IsKnownMismatchedVersionedDriver@ADAPTER_RENDER@@AEAA_NPEAT_LARGE_INTEGER@@0@Z.c)
    ...
    && !ADAPTER_RENDER::IsKnownMismatchedVersionedDriver(this, (union _LARGE_INTEGER *)&pcchLength, &v154) )
  {
    if ( dword_1C00A1888 > 5u && TlgKeywordOn((TraceLoggingHProvider)&dword_1C00A1888, 0x400000000100uLL) )
    {
      ...
      *(_QWORD *)&pData[1].Type = v99;
      ...
      v173 = 4LL;
      TlgWrite((TraceLoggingHProvider)&dword_1C00A1888, &unk_1C0072A84, 0LL, v124, 0xBu, (EVENT_DATA_DESCRIPTOR *)pData);
    }
