/*
 * XREFs of DpiVerifyResources @ 0x1C017A670
 * Callers:
 *     DpMapMemory @ 0x1C017A3F0 (DpMapMemory.c)
 * Callees:
 *     _guard_dispatch_icall_nop @ 0x1C0024FA0 (_guard_dispatch_icall_nop.c)
 *     DpiDecodeResourceDescriptorLength @ 0x1C0159034 (DpiDecodeResourceDescriptorLength.c)
 */
...
LABEL_33:
  ...
  if ( *(_QWORD *)a2 == 786432LL || v14 == 655360 || v14 == 944 || v14 == 960 )
  {
    ...
    {
      v8 = -1073741811;
      v30 = WdLogNewEntry5_WdError(786432LL, a2, a3);
