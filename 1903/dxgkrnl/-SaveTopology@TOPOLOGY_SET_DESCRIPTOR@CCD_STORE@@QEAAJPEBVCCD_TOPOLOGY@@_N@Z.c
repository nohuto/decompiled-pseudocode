/*
 * XREFs of ?SaveTopology@TOPOLOGY_SET_DESCRIPTOR@CCD_STORE@@QEAAJPEBVCCD_TOPOLOGY@@_N@Z @ 0x1C012BF38
 * Callers:
 *     _anonymous_namespace_::_SaveTopologySetCallback @ 0x1C012CE90 (_anonymous_namespace_--_SaveTopologySetCallback.c)
 * Callees:
