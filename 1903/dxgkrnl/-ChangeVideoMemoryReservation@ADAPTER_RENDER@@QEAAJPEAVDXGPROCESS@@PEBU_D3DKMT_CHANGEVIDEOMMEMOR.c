/*
 * XREFs of ?ChangeVideoMemoryReservation@ADAPTER_RENDER@@QEAAJPEAVDXGPROCESS@@PEBU_D3DKMT_CHANGEVIDEOMMEMORYRESERVATION@@@Z @ 0x1C01F47FC
 * Callers:
        ...
        const struct _D3DKMT_CHANGEVIDEOMMEMORYRESERVATION *a3)
{
  ...
  if ( *(_BYTE *)(v3 + 185) )
    return DXG_GUEST_VIRTUALGPU_VMBUS::VmBusSendChangeVideoMemoryReservation(
             (DXG_GUEST_VIRTUALGPU_VMBUS *)(v3 + 4144),
             a2,
