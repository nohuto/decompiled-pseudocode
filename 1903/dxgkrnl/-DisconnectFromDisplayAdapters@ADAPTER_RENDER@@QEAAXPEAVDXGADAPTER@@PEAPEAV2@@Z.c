/*
 * XREFs of ?DisconnectFromDisplayAdapters@ADAPTER_RENDER@@QEAAXPEAVDXGADAPTER@@PEAPEAV2@@Z @ 0x1C01F4E04
 * Callers:
        ...
        struct DXGADAPTER **a3)
{
  ...
  *((_QWORD *)this + 6) = KeGetCurrentThread();
  ...
  if ( (int)COREADAPTERACCESS::AcquireExclusive(v12, (unsigned int)(v6 + 1), v6) >= 0 )
  {
