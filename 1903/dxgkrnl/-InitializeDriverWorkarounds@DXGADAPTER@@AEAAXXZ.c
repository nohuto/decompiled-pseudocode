/*
 * XREFs of ?InitializeDriverWorkarounds@DXGADAPTER@@AEAAXXZ @ 0x1C0167564
 * Callers:
 ...
 *     ?xwtol@@YAKPEBG@Z @ 0x1C01745EC (-xwtol@@YAKPEBG@Z.c)
 */
...
LABEL_11:
  ...
  if ( v4 >= 0x2000 )
  {
    ...
    {
      Key = *((_DWORD *)this + 72);
      if ( bsearch(&Key, &unk_1C006FCC0, 0x18uLL, 4uLL, UintCompareFunc) )
      {
