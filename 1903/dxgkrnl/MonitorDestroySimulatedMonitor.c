/*
 * XREFs of MonitorDestroySimulatedMonitor @ 0x1C02C917C
 * Callers:
        ...
        struct _DXGK_DISPLAY_SCENARIO_CONTEXT *a3)
{
  ...
  *(_QWORD *)(v6 + 32) = this;
  ...
  v15 = MONITOR_MGR::_HandleRemoveSimulatedMonitor((struct _FAST_MUTEX *)v11->SpinLock, (unsigned int)v4, a3);
  MONITOR_MGR::_LogMonitorPresentEvent(SpinLock, 1073741826LL, v4, v15, 0LL);
  return v15;
}
