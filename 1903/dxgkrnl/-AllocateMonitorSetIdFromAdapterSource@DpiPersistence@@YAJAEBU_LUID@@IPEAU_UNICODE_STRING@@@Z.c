/*
 * XREFs of ?AllocateMonitorSetIdFromAdapterSource@DpiPersistence@@YAJAEBU_LUID@@IPEAU_UNICODE_STRING@@@Z @ 0x1C012B5A4
 * Callers:
        ...
        struct _UNICODE_STRING *a4)
{
  ...
  if ( v7 )
  {
    ...
    LOBYTE(v22.Length) = 0;
    v12 = DpiPersistence::CreateMonitorSetId(this, (const struct _LUID *)v5, (unsigned int)a3, &v22, v21);
    v16 = v12;
    if ( LOBYTE(v22.Length) )
    {
      return 3221225659LL;
    }
    else
