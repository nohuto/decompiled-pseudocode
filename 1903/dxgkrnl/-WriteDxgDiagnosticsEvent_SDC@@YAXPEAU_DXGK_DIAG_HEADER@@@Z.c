/*
 * XREFs of ?WriteDxgDiagnosticsEvent_SDC@@YAXPEAU_DXGK_DIAG_HEADER@@@Z @ 0x1C0019970
 * Callers:
...
void __fastcall WriteDxgDiagnosticsEvent_SDC(struct _DXGK_DIAG_HEADER *a1, __int64 a2)
{
  ...
  if ( *((_BYTE *)DXGGLOBAL::GetGlobal((__int64)a1, a2) + 303928) )
  {
      ...
      && TlgKeywordOn(v7, v8) )
    {
      ...
      v16 = 2;
      v18 = a1;
      TlgWrite(v10, &unk_1C00734EB, 0LL, v9, 5u, &pData);
    }
  }
  else if ( TraceLoggingProviderEnabled((TraceLoggingHProvider)&hProvider, 4u, 0x200000000001uLL) && hProvider > 4u )
  {
    if ( TlgKeywordOn(v3, v4) )
    {
      ...
      v16 = 2;
      v18 = a1;
      TlgWrite(v6, &unk_1C00734C9, 0LL, v5, 5u, &pData);
    }
  }
}
