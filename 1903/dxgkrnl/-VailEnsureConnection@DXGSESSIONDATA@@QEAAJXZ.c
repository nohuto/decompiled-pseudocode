/*
 * XREFs of ?VailEnsureConnection@DXGSESSIONDATA@@QEAAJXZ @ 0x1C0291DC8
 * Callers:
 ...
 *     ?EnableVmBusChannel@DXGVAILGUESTOBJECT@@QEAAJ_N@Z @ 0x1C0049720 (-EnableVmBusChannel@DXGVAILGUESTOBJECT@@QEAAJ_N@Z.c)
...
__int64 __fastcall DXGSESSIONDATA::VailEnsureConnection(DXGSESSIONDATA *this)
{
  ...
  DXGAUTOMUTEX::DXGAUTOMUTEX((DXGAUTOMUTEX *)v21, (DXGSESSIONDATA *)((char *)this + 18720), 0);
  ...
  if ( v5 && ExAcquireRundownProtection(v5 + 7) )
  {
    ...
    else
    {
      ...
      *(_QWORD *)(v12 + 24) = 2354LL;
      ...
      v14 = DXGVAILGUESTOBJECT::EnableVmBusChannel(*((struct _KTHREAD ***)this + 2346), v13);
      v8 = v14;
      if ( v14 < 0 )
      {
  ...
  else
  {
    ...
    v19 = WdLogNewEntry5_WdWarning(v5, v3, v4);
    *(_QWORD *)(v19 + 24) = 1LL;
