/*
 * XREFs of DpiIndirectOpenDevice @ 0x1C02ABE78
 * Callers:
 *     DpiFdoOpenDeviceFileObjectIfNeeded @ 0x1C0160D7C (DpiFdoOpenDeviceFileObjectIfNeeded.c)
 * Callees:
 *     ?DpiIndirectGetObjectName@@YAJPEAXPEAPEAU_OBJECT_NAME_INFORMATION@@@Z @ 0x1C02AB4F0 (-DpiIndirectGetObjectName@@YAJPEAXPEAPEAU_OBJECT_NAME_INFORMATION@@@Z.c)
 */
