/*
 * XREFs of ?AcquireBuffer@DXGSWAPCHAIN@@QEAAJPEAU_D3DKMT_ACQUIRESWAPCHAIN@@PEAI@Z @ 0x1C02857EC
 * Callers:
 ...
 *     ?Remove@DXGFIXEDQUEUE@@QEAAJPEAI@Z @ 0x1C0047F84 (-Remove@DXGFIXEDQUEUE@@QEAAJPEAI@Z.c)
...
LABEL_17:
  ...
  *((_DWORD *)v14 + 6) = 0;
  ...
  LODWORD(a2[1].hNtSwapChain) = Data1;
...
LABEL_28:
  if ( (Microsoft_Windows_DxgKrnlEnableBits & 0x40000000) != 0 )
  {
    ...
    McTemplateK0pqddqq((__int64)this, (__int64)a2, a3, v5, v17, bProducer, bReleaseBeforeAcquire, v20, hNtSwapChain);
  }
