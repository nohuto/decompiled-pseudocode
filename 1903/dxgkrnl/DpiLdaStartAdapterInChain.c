/*
 * XREFs of DpiLdaStartAdapterInChain @ 0x1C02AE70C
 * Callers:
...
LABEL_19:
    ...
    else
    {
      while ( 1 )
      {
        v18 = *(_QWORD *)(*(_QWORD *)(*(_QWORD *)(v6 + 2728) + 8LL * v17) + 64LL);
        if ( *(_DWORD *)(v18 + 236) == 1 )
        {
          started = DpiFdoStartAdapter(*(struct _DEVICE_OBJECT **)(v18 + 24), v9, v8, a4, a5, 0LL);
          if ( started < 0 )
            break;
        }
        if ( ++v17 >= *(_DWORD *)(v6 + 2736) )
          goto LABEL_19;
      }
  ...
  while ( 1 )
  {
    ...
    if ( (unsigned int)(*(_DWORD *)(v16 + 236) - 1) > 1 )
      goto LABEL_3;
    if ( (_BYTE)a2 || *(_DWORD *)(v6 + 1124) != *(_DWORD *)(v16 + 1124) )
      LOBYTE(a2) = 1;
    a3 = (struct _DXGK_DISPLAY_SCENARIO_CONTEXT *)(unsigned int)((_DWORD)a3 + 1);
    *(_BYTE *)(v6 + 2740) = a2;
