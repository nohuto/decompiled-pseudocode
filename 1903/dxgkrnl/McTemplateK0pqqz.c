/*
 * XREFs of McTemplateK0pqqz @ 0x1C0035A94
 * Callers:
...
ULONG McTemplateK0pqqz(__int64 a1, __int64 a2, __int64 a3, ...)
{
  ...
  if ( !v23 )
    v3 = L"NULL";
  v14 = v3;
  return McGenEventWrite((PMCGEN_TRACE_CONTEXT)&DxgkControlGuid_Context, &EventNodeMetadata, 0LL, 5u, &EventData);
}
