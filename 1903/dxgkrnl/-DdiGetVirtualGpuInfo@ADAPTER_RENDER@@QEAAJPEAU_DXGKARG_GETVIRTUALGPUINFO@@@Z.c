/*
 * XREFs of ?DdiGetVirtualGpuInfo@ADAPTER_RENDER@@QEAAJPEAU_DXGKARG_GETVIRTUALGPUINFO@@@Z @ 0x1C0212254
 * Callers:
 *     ?GetVirtualGpuInfo@DXGK_VIRTUAL_GPU_GPUP@@UEAAJPEAU_DXGKARG_GETVIRTUALGPUINFO@@@Z @ 0x1C0216B70 (-GetVirtualGpuInfo@DXGK_VIRTUAL_GPU_GPUP@@UEAAJPEAU_DXGKARG_GETVIRTUALGPUINFO@@@Z.c)
 * Callees:
        ...
        const GUID *a3)
{
  ...
  if ( (*(_BYTE *)(&DxgkControlGuid_Context + 2) & 2) != 0 )
  {
    ...
    if ( (Microsoft_Windows_DxgKrnlEnableBits & 0x2000) != 0 )
      McTemplateK0q((__int64)this, &EventProfilerEnter, a3, 5103);
  }
  else
  {
    v31 = 0;
  }
  DXGETWPROFILER_BASE_PushProfilerEntry((__int64)&v29, 5103LL);
...
LABEL_16:
  ...
  v15 = (*(int (__fastcall **)(_QWORD, struct _DXGKARG_GETVIRTUALGPUINFO *))(*(_QWORD *)(*((_QWORD *)this + 2) + 928LL)
                                                                           + 72LL))(
