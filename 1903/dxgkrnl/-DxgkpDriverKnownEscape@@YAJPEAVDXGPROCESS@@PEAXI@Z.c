/*
 * XREFs of ?DxgkpDriverKnownEscape@@YAJPEAVDXGPROCESS@@PEAXI@Z @ 0x1C023FCC4
 * Callers:
...
LABEL_3:
  ...
  if ( !(_DWORD)v7 )
  {
    ...
    v25 = (v21 >> 6) & 0xFFFFFF;
    if ( (unsigned int)v25 < *((_DWORD *)a1 + 56) )
    {
      v26 = *((_QWORD *)a1 + 26);
      ...
      if ( ((v21 >> 25) & 0x60) == (*(_BYTE *)(v26 + 16 * v25 + 8) & 0x60) && (v27 & 0x2000) == 0 && (v27 & 0x1F) != 0 )
      {
        ...
        v29 = WdLogNewEntry5_WdError(v28, 2LL * (unsigned int)v25, v26);
        *(_QWORD *)(v29 + 24) = 267LL;
...
LABEL_38:
  ...
  if ( (unsigned int)v9 < *((_DWORD *)a1 + 56) )
  {
    ...
    if ( ((v8 >> 25) & 0x60) == (*(_BYTE *)(v10 + 16 * v9 + 8) & 0x60) && (v11 & 0x2000) == 0 && (v11 & 0x1F) != 0 )
    {
      ...
      v13 = WdLogNewEntry5_WdError(v12, 2LL * (unsigned int)v9, v10);
      *(_QWORD *)(v13 + 24) = 267LL;
