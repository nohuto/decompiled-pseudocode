/*
 * XREFs of ?_MonitorTelemetry@MONITOR_MGR@@QEAAXPEAU_DXGK_DISPLAY_SCENARIO_CONTEXT@@@Z @ 0x1C02C8898
 * Callers:
...
void __fastcall MONITOR_MGR::_MonitorTelemetry(struct _FAST_MUTEX *this, struct _DXGK_DISPLAY_SCENARIO_CONTEXT *a2)
{
  ...
  if ( v12 != (MONITOR_MGR *)&this[2].Contention )
  {
    ...
    while ( v13 )
    {
      ...
      DXGMONITOR::_MonitorTelemetry((GUID *)v14, 2LL, (__int64)a2);
