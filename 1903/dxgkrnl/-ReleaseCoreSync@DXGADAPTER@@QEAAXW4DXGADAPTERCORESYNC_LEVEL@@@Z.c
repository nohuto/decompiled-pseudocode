/*
 * XREFs of ?ReleaseCoreSync@DXGADAPTER@@QEAAXW4DXGADAPTERCORESYNC_LEVEL@@@Z @ 0x1C0127AF4
 * Callers:
 *     ?DXGADAPTER_ReleaseCoreSync@@YAXPEAVDXGADAPTER@@W4DXGADAPTERCORESYNC_LEVEL@@@Z @ 0x1C003E060 (-DXGADAPTER_ReleaseCoreSync@@YAXPEAVDXGADAPTER@@W4DXGADAPTERCORESYNC_LEVEL@@@Z.c)
...
LABEL_11:
    v10 = *(_QWORD *)(a1 + 2560);
    if ( v10 )
      ADAPTER_RENDER::FlushScheduler(v10, v8, 0xFFFFFFFF, 0);
    if ( *(_DWORD *)(a1 + 136) == 1 )
    {
