/*
 * XREFs of _lambda_d7c4861ef0734605370a98f05df27570_::operator() @ 0x1C00C7D1C
 * Callers:
 ...
 *     ?IsClientHandleValid@DispBrokerClient@@AEAA_NXZ @ 0x1C00C7E14 (-IsClientHandleValid@DispBrokerClient@@AEAA_NXZ.c)
 */
