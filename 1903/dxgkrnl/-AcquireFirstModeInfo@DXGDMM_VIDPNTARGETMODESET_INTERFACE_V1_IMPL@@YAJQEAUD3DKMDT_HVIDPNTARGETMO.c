/*
 * XREFs of ?AcquireFirstModeInfo@DXGDMM_VIDPNTARGETMODESET_INTERFACE_V1_IMPL@@YAJQEAUD3DKMDT_HVIDPNTARGETMODESET__@@PEAPEBU_D3DKMDT_VIDPN_TARGET_MODE@@@Z @ 0x1C0179500
 * Callers:
 *     <none>
 * Callees:
        ...
        const struct _D3DKMDT_VIDPN_TARGET_MODE **a3)
{
  ...
  DXGETWPROFILER_BASE_PushProfilerEntry((__int64)&v30, 6003LL);
  if ( a2 )
  {
    *(_QWORD *)a2 = 0LL;
    ...
    if ( v10 )
    {
      v29 = 0;
      v33 = 0LL;
      v28 = DMMVIDPNTARGETMODESET::GetFirstMode;
      ...
      if ( v12 == -1071774902 )
      {
        ...
        *(_QWORD *)(v23 + 24) = v10;
        ...
        if ( v33 )
        {
          v25 = WdLogNewEntry5_WdAssertion(v24, v13);
    ...
    {
      v22 = WdLogNewEntry5_WdError(v9, v8, v11);
      *(_QWORD *)(v22 + 24) = this;
  ...
  if ( v32 && (Microsoft_Windows_DxgKrnlEnableBits & 0x2000) != 0 )
    McTemplateK0q(v18, &EventProfilerExit, v19, v30);
  return v16;
}
