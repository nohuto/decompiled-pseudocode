/*
 * XREFs of ?GetGpuPartitionInfo@ADAPTER_RENDER@@QEAAJW4DXG_VIRTUAL_GPU_TYPE@@PEAU_DXGKARG_GETGPUPARTITIONINFO@@@Z @ 0x1C020E988
 * Callers:
        ...
        __int64 a4)
{
  ...
  if ( a2 == 1 )
  {
    if ( !a3->NumGpuPartitionOptions )
      return 3221225507LL;
    if ( *((_QWORD *)a1 + 188)
      || (LOBYTE(a4) = 1, v17 = 32, LODWORD(v6) = ADAPTER_RENDER::SetGpuPartitionCount(a1, 1LL, &v17, a4), (int)v6 >= 0) )
    {
  ...
  else
  {
    ...
    if ( (int)v6 >= 0 )
    {
      ...
      if ( CurrentGpuPartitionCount )
      {
        ...
        {
          v17 = CurrentGpuPartitionCount;
          LOBYTE(v9) = 1;
          v12 = ADAPTER_RENDER::SetGpuPartitionCount(a1, 0LL, &v17, v9);
          v6 = v12;
          if ( v12 < 0 )
          {
