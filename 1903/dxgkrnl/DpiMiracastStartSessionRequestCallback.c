/*
 * XREFs of DpiMiracastStartSessionRequestCallback @ 0x1C02A58C0
 * Callers:
 *     <none>
 * Callees:
...
void __fastcall DpiMiracastStartSessionRequestCallback(_DWORD *P, int *a2)
{
  ...
  *(_QWORD *)(v2 + 88) = 0LL;
  ...
  if ( *a2 < 0 )
  {
    ...
    if ( *a2 != -1073741536 )
      v7 = -2147483647;
    DpiMiracastTearDownAssociation((char *)v2, P[2], v7, 1u, 0);
  }
  DpiMiracastReleaseMiracastDeviceContext((int *)v2, v2, v6);
