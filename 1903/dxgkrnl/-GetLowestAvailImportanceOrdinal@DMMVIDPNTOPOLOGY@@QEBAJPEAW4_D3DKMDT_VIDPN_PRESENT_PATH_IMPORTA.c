/*
 * XREFs of ?GetLowestAvailImportanceOrdinal@DMMVIDPNTOPOLOGY@@QEBAJPEAW4_D3DKMDT_VIDPN_PRESENT_PATH_IMPORTANCE@@@Z @ 0x1C0141088
 * Callers:
        ...
        enum _D3DKMDT_VIDPN_PRESENT_PATH_IMPORTANCE *a2)
{
  ...
  *a2 = D3DKMDT_VPPI_UNINITIALIZED;
  ...
  if ( v5 > 32 )
  {
    v9 = WdLogNewEntry5_WdError(v6, v4, 1LL);
    *(_QWORD *)(v9 + 24) = 32LL;
    *(_QWORD *)(v9 + 32) = this;
