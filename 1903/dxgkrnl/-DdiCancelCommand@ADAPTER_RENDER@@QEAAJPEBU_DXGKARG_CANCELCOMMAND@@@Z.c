/*
 * XREFs of ?DdiCancelCommand@ADAPTER_RENDER@@QEAAJPEBU_DXGKARG_CANCELCOMMAND@@@Z @ 0x1C01F7104
 * Callers:
 *     ?ADAPTER_RENDER_DdiCancelCommand@@YAJPEAVADAPTER_RENDER@@PEBU_DXGKARG_CANCELCOMMAND@@@Z @ 0x1C003DD20 (-ADAPTER_RENDER_DdiCancelCommand@@YAJPEAVADAPTER_RENDER@@PEBU_DXGKARG_CANCELCOMMAND@@@Z.c)
 * Callees:
        ...
        const GUID *a3)
{
  ...
  DXGETWPROFILER_BASE_PushProfilerEntry((__int64)&v30, 5052LL);
...
LABEL_16:
  ...
  v15 = (*(int (__fastcall **)(_QWORD, const struct _DXGKARG_CANCELCOMMAND *))(*((_QWORD *)this + 2) + 728LL))(
  ...
  if ( (_DWORD)v15 )
  {
    v25 = WdLogNewEntry5_WdError(DmaBufferSize, v22, v23);
    *(_QWORD *)(v25 + 24) = v15;
