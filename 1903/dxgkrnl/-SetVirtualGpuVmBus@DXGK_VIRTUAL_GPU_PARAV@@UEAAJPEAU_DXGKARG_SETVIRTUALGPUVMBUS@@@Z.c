/*
 * XREFs of ?SetVirtualGpuVmBus@DXGK_VIRTUAL_GPU_PARAV@@UEAAJPEAU_DXGKARG_SETVIRTUALGPUVMBUS@@@Z @ 0x1C0215830
 * Callers:
 *     <none>
 * Callees:
        ...
        struct _DXGKARG_SETVIRTUALGPUVMBUS *a2)
{
  ...
  if ( (int)v7 >= 0 )
  {
    ...
    if ( g_VgpuDisableVaBackedVm
      || (v14 = ((__int64 (__fastcall *)(_QWORD, struct _EPROCESS **))qword_1C00A3E78)(*v2, &v49), v15 = v49, v14 < 0) )
    {
      v15 = 0LL;
    }
    v16 = 0LL;
