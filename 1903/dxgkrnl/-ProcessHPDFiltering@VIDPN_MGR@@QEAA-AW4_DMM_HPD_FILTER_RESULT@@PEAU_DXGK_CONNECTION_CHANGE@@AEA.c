/*
 * XREFs of ?ProcessHPDFiltering@VIDPN_MGR@@QEAA?AW4_DMM_HPD_FILTER_RESULT@@PEAU_DXGK_CONNECTION_CHANGE@@AEAU_DMM_HPD_FILTER_INFO@@EPEAU_GUID@@@Z @ 0x1C0158244
 * Callers:
  ...
  else
  {
    ...
    if ( dword_1C00A1888 > 5u )
    {
      if ( TlgKeywordOn((TraceLoggingHProvider)&dword_1C00A1888, 0x400000000080uLL) )
      {
        ...
        v65 = &v48;
        v66 = 4LL;
        TlgWrite((TraceLoggingHProvider)&dword_1C00A1888, &unk_1C0074824, pActivityId, v41, 8u, &pData);
      }
    }
