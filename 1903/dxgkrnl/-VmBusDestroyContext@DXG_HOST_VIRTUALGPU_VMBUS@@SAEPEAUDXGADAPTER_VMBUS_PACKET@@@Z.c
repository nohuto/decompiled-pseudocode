/*
 * XREFs of ?VmBusDestroyContext@DXG_HOST_VIRTUALGPU_VMBUS@@SAEPEAUDXGADAPTER_VMBUS_PACKET@@@Z @ 0x1C021E340
 * Callers:
 *     <none>
 * Callees:
...
char __fastcall DXG_HOST_VIRTUALGPU_VMBUS::VmBusDestroyContext(struct DXGADAPTER_VMBUS_PACKET *a1)
{
  ...
  _D3DKMT_DESTROYCONTEXT v13; // [rsp+50h] [rbp+8h] BYREF
  ...
  if ( *(_BYTE *)(*((_QWORD *)a1 + 5) + 157LL) )
  {
    ...
    if ( v7 )
    {
      v13.hContext = *(_DWORD *)(v7 + 24);
      v9 = DxgkDestroyContextImpl(&v13, 0, v8);
