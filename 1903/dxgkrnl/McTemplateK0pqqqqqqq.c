/*
 * XREFs of McTemplateK0pqqqqqqq @ 0x1C003BF0C
 * Callers:
...
ULONG McTemplateK0pqqqqqqq(__int64 a1, const EVENT_DESCRIPTOR *a2, const GUID *a3, ...)
{
  ...
  v18 = 4LL;
  v20 = 4LL;
  return McGenEventWrite((PMCGEN_TRACE_CONTEXT)&DxgkControlGuid_Context, a2, a3, 9u, &EventData);
}
