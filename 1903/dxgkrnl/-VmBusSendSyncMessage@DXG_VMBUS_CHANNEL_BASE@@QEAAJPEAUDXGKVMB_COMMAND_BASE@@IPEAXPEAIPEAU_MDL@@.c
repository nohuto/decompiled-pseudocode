/*
 * XREFs of ?VmBusSendSyncMessage@DXG_VMBUS_CHANNEL_BASE@@QEAAJPEAUDXGKVMB_COMMAND_BASE@@IPEAXPEAIPEAU_MDL@@@Z @ 0x1C022769C
 * Callers:
        ...
        unsigned int *a5)
{
  ...
  if ( v36 - 24 <= 0x1FFE7 && v13 < 0x20000 )
  {
    ...
    v17 = _InterlockedIncrement64(&qword_1C00A4168);
...
LABEL_29:
    v15 = (int)((__int64 (__fastcall *)(struct _KTHREAD *, struct DXGKVMB_COMMAND_BASE *, _QWORD, _QWORD, int, char *, unsigned int *, _QWORD))qword_1C00A3C90)(
                 *this,
                 a2,
                 v36,
                 0LL,
