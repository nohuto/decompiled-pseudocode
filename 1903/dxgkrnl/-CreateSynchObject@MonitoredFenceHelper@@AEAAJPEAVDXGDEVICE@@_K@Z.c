/*
 * XREFs of ?CreateSynchObject@MonitoredFenceHelper@@AEAAJPEAVDXGDEVICE@@_K@Z @ 0x1C0296EDC
 * Callers:
...
__int64 __fastcall MonitoredFenceHelper::CreateSynchObject(MonitoredFenceHelper *this, struct DXGDEVICE *a2, UINT64 a3)
{
  ...
  __int64 v12; // rbx
  __int64 v13; // rax
  struct _OBJECT_HANDLE_INFORMATION *v15; // [rsp+28h] [rbp-29h]
  struct _D3DKMT_CREATESYNCHRONIZATIONOBJECT2 v16; // [rsp+48h] [rbp-9h] BYREF
  struct DXGSYNCOBJECT *v17; // [rsp+B8h] [rbp+67h] BYREF
  ...
  v8 = CreateSynchronizationObjectInternal((__int64)a2, 0, v7, (__int64)&v16, v15, &v17, (__int64 *)this + 4, 0LL);
  v12 = v8;
  if ( v8 < 0 )
  {
    v13 = WdLogNewEntry5_WdWarning(v10, v9, v11);
    *(_QWORD *)(v13 + 24) = v12;
    *(_QWORD *)(v13 + 32) = 1410LL;
