/*
 * XREFs of McTemplateK0qqqpqddddddddddddqqqqqq @ 0x1C00476F4
 * Callers:
...
ULONG __fastcall McTemplateK0qqqpqddddddddddddqqqqqq(
        __int64 a1,
        __int64 a2,
        const GUID *a3,
        int a4,
        ...
        char a26)
{
  ...
  v72 = 4LL;
  v74 = 4LL;
  return McGenEventWrite((PMCGEN_TRACE_CONTEXT)&DxgkControlGuid_Context, &FlipMultiPlaneOverlay, a3, 0x18u, &EventData);
}
