/*
 * XREFs of ?VmBusChannelProcessPacket@DXG_HOST_VIRTUALGPU_VMBUS@@SAXPEAUVMBCHANNEL__@@PEAUVMBPACKETCOMPLETION__@@PEAXII@Z @ 0x1C003D190
 * Callers:
 *     <none>
 * Callees:
...
LABEL_5:
  ...
  if ( PoolWithTag )
  {
    ...
    v16 = ((__int64 (__fastcall *)(struct _LIST_ENTRY *))qword_1C00A3C28)(a1);
    v15[1].Parameter = 0LL;
