/*
 * XREFs of ??0DMMVIDPNPRESENTPATH@@QEAA@PEAVDMMVIDPNSOURCE@@PEAVDMMVIDPNTARGET@@W4_D3DKMDT_VIDPN_PRESENT_PATH_IMPORTANCE@@G@Z @ 0x1C0006870
 * Callers:
        ...
        unsigned __int16 a5)
{
  ...
  *((_QWORD *)this + 19) = 0LL;
  *((_DWORD *)this + 40) = 0;
  v9 = DMMVIDPNPRESENTPATH::SetImportanceOrdinal(this, (unsigned int)v5, (__int64)a3);
  v10 = v9;
  if ( v9 < 0 )
  {
