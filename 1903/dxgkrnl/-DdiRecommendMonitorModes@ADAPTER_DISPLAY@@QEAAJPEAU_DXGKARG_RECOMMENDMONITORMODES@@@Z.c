/*
 * XREFs of ?DdiRecommendMonitorModes@ADAPTER_DISPLAY@@QEAAJPEAU_DXGKARG_RECOMMENDMONITORMODES@@@Z @ 0x1C01704EC
 * Callers:
        ...
        const GUID *a3)
{
  ...
  if ( (*(_BYTE *)(&DxgkControlGuid_Context + 2) & 2) != 0 )
  {
    ...
    if ( (Microsoft_Windows_DxgKrnlEnableBits & 0x2000) != 0 )
      McTemplateK0q((__int64)this, &EventProfilerEnter, a3, 5037);
  }
  else
  {
    v32 = 0;
  }
  DXGETWPROFILER_BASE_PushProfilerEntry((__int64)&v30, 5037LL);
...
LABEL_16:
  ...
  v15 = (*(int (__fastcall **)(_QWORD, struct _DXGKARG_RECOMMENDMONITORMODES *))(*((_QWORD *)this + 2) + 536LL))(
  ...
  v21[3] = v15;
  v23 = *(_QWORD *)(*((_QWORD *)this + 2) + 248LL);
  v21[4] = v23;
  v21[5] = a2->VideoPresentTargetId;
  v21[6] = a2->hMonitorSourceModeSet;
  pMonitorSourceModeSetInterface = a2->pMonitorSourceModeSetInterface;
  v21[7] = pMonitorSourceModeSetInterface;
  if ( (_DWORD)v15 != -1073741801 && (_DWORD)v15 )
  {
    v25 = WdLogNewEntry5_WdError(pMonitorSourceModeSetInterface, v23, v22);
    *(_QWORD *)(v25 + 24) = v15;
