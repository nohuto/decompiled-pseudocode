/*
 * XREFs of ?EndTrackedWorkload@DXGTRACKEDWORKLOAD@@QEAAJPEBU_D3DKMT_ENDTRACKEDWORKLOAD@@@Z @ 0x1C02971AC
 * Callers:
 ...
 *     ?Scale@RollingStats@@QEAAXN@Z @ 0x1C00648B0 (-Scale@RollingStats@@QEAAXN@Z.c)
 *     ?SetEffectivePowerLevel@TrackedWorkloadMonitor@@QEAAXI_N@Z @ 0x1C00648F4 (-SetEffectivePowerLevel@TrackedWorkloadMonitor@@QEAAXI_N@Z.c)
        ...
        const struct _D3DKMT_ENDTRACKEDWORKLOAD *a2)
{
  ...
  wil_details_FeaturePropertyCache_ReportUsageToService(
    ...
    15862628LL,
    (const struct FEATURE_LOGGED_TRAITS *)&unk_1C0078E34,
    0,
    v11);
