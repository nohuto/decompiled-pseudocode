/*
 * XREFs of ??0CFlipToken@@IEAA@_KPEAVCompositionSurfaceObject@@@Z @ 0x1C005AFE8
 * Callers:
 ...
 * Callees:
 *     ??0CToken@@IEAA@_KPEAVCompositionSurfaceObject@@@Z @ 0x1C001CCE8 (--0CToken@@IEAA@_KPEAVCompositionSurfaceObject@@@Z.c)
 */
