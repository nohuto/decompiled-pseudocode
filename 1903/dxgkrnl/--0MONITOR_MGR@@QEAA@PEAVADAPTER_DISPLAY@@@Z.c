/*
 * XREFs of ??0MONITOR_MGR@@QEAA@PEAVADAPTER_DISPLAY@@@Z @ 0x1C001F85C
 * Callers:
  ...
  *((_QWORD *)this + 96) = v5;
  if ( v5 )
  {
    ...
    *(_DWORD *)(*((_QWORD *)this + 96) + 20LL) = 0;
    ...
    v7 = (_QWORD *)qword_1C00A39E8;
    v8 = (_QWORD *)*((_QWORD *)this + 96);
    if ( *(struct _LIST_ENTRY **)qword_1C00A39E8 != &MONITOR_MGR::_MonitorPendingEventTraceHead )
      __fastfail(3u);
    v8[1] = qword_1C00A39E8;
    *v8 = &MONITOR_MGR::_MonitorPendingEventTraceHead;
    *v7 = v8;
    qword_1C00A39E8 = (__int64)v8;
