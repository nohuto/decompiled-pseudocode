/*
 * XREFs of ?DmmUpdateGammaRampOnVidPnTarget@@YAJQEAXIPEBUDXGK_GAMMA_RAMP@@@Z @ 0x1C0128E18
 * Callers:
...
LABEL_16:
  ...
  if ( v11 )
  {
    ...
    if ( v32 )
    {
      ...
      PathSourceFromTarget = DMMVIDPNTOPOLOGY::GetPathSourceFromTarget((DMMVIDPNTOPOLOGY *)(v32 + 96), (unsigned int)v4);
