/*
 * XREFs of ?OpenEndpoint@CFlipManager@@QEAAJHPEAPEAX@Z @ 0x1C006166C
 * Callers:
...
__int64 __fastcall CFlipManager::OpenEndpoint(CFlipManager *this, int a2, void **a3)
{
  ...
  {
    if ( a2
      || (Global = DXGGLOBAL::GetGlobal(v8, v7), !(*(unsigned int (**)(void))(*((_QWORD *)Global + 38000) + 296LL))()) )
    {
