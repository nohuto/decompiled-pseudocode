/*
 * XREFs of ?DodTerminateIndirectOutput@ADAPTER_DISPLAY@@QEAAJI@Z @ 0x1C01F16B4
 * Callers:
...
LABEL_5:
  ...
  v7 = *((_QWORD *)this + 2);
  if ( (*(_DWORD *)(v7 + 308) & 0x100) == 0 )
  {
    v6 = WdLogNewEntry5_WdWarning(v7, a2, a3);
    *(_QWORD *)(v6 + 24) = *((_QWORD *)this + 2);
    goto LABEL_5;
  }
  v8 = *(unsigned int (__fastcall **)(_QWORD, _QWORD))(v7 + 1808);
  if ( !v8 )
    return 3221225659LL;
  if ( v8(*(_QWORD *)(v7 + 1744), (unsigned int)a2) == -1073741637 )
