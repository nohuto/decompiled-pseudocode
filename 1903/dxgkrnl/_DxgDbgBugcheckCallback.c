/*
 * XREFs of _DxgDbgBugcheckCallback @ 0x1C003F7A0
 * Callers:
 *     <none>
 * Callees:
        ...
        ULONG ReasonSpecificDataLength)
{
  ...
  {
    if ( KiBugCheckData == 278 && qword_1C00A41B8 )
    {
      v4 = (unsigned int)(dword_1C00A41B0 - 1);
      if ( dword_1C00A41B0 != 1 )
      {
        do
        {
          if ( *(_BYTE *)(v4 + qword_1C00A41B8) )
            break;
          v5 = (_DWORD)v4 == 1;
      ...
      ReasonSpecificData[4] = qword_1C00A41B8;
