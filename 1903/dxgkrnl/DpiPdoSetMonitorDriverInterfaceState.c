/*
 * XREFs of DpiPdoSetMonitorDriverInterfaceState @ 0x1C02AFEE0
 * Callers:
...
__int64 __fastcall DpiPdoSetMonitorDriverInterfaceState(PVOID Object, char a2)
{
  ...
  if ( PoolWithTag )
  {
    ...
    *((_BYTE *)PoolWithTag + 24) = a2;
    ...
    v11 = (_QWORD *)qword_1C00A2B20;
    if ( *(__int64 **)qword_1C00A2B20 != &qword_1C00A2B18 )
      __fastfail(3u);
    *PoolWithTag = &qword_1C00A2B18;
    PoolWithTag[1] = v11;
    *v11 = PoolWithTag;
    qword_1C00A2B20 = (__int64)PoolWithTag;
    if ( !byte_1C00A2AD8 )
    {
