/*
 * XREFs of ?DiscardAllCompositionFrames@CCompositionFrameCollection@@UEAAXXZ @ 0x1C001B110
 * Callers:
 *     ??_GCCompositionFrameCollection@@IEAAPEAXI@Z @ 0x1C001B04C (--_GCCompositionFrameCollection@@IEAAPEAXI@Z.c)
 * Callees:
 *     ?Release@CPushLockCriticalSection@@QEAAXXZ @ 0x1C0012C60 (-Release@CPushLockCriticalSection@@QEAAXXZ.c)
 *     _guard_dispatch_icall_nop @ 0x1C0024FA0 (_guard_dispatch_icall_nop.c)
 *     ?AcquireExclusive@CPushLockCriticalSection@@QEAAXXZ @ 0x1C005A478 (-AcquireExclusive@CPushLockCriticalSection@@QEAAXXZ.c)
 */
