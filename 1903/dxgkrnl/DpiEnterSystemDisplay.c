/*
 * XREFs of DpiEnterSystemDisplay @ 0x1C001E0D0
 * Callers:
 *     <none>
 * Callees:
...
LABEL_63:
    ...
    do
    {
      if ( *(_DWORD *)(v11 + 16) != 1953656900
        || *(_DWORD *)(v11 + 20) != 2
        || i == 3 && *(_BYTE *)(v11 + 1155) && *(_BYTE *)(v11 + 480) )
      {
        goto LABEL_39;
      }
      v5 = v11;
...
LABEL_61:
    ...
    {
      v18 = v19;
      if ( !v19 && qword_1C00A29E0 && v5 == *(_QWORD *)(qword_1C00A29E0 + 64) )
        *(_DWORD *)(a2 + 16) = 1;
      else
        *(_DWORD *)(a2 + 16) = 5;
LABEL_60:
