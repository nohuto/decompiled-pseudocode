/*
 * XREFs of ?ProcessGdiSysmemTokens@CTokenManager@@IEAAJXZ @ 0x1C001DA20
 * Callers:
 ...
 *     ?EnsureCurrentLegacyTokenBuffer@CTokenManager@@IEAAJXZ @ 0x1C001DB58 (-EnsureCurrentLegacyTokenBuffer@CTokenManager@@IEAAJXZ.c)
  ...
  *((_QWORD *)this + 12) = KeGetCurrentThread();
  ...
  if ( v4 >= 0 )
  {
    ...
    if ( v4 >= 0 )
    {
      ...
      v9 = (*(__int64 (__fastcall **)(_QWORD, int *, __int64))(*((_QWORD *)Global + 38000) + 160LL))(v6, &v15, v7);
      v10 = *((_QWORD *)this + 23);
      v4 = v9;
      v11 = 40 * v15;
