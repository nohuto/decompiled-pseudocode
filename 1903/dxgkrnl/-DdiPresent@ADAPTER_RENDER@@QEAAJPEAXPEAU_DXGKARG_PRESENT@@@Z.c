/*
 * XREFs of ?DdiPresent@ADAPTER_RENDER@@QEAAJPEAXPEAU_DXGKARG_PRESENT@@@Z @ 0x1C014EEA4
 * Callers:
...
__int64 __fastcall ADAPTER_RENDER::DdiPresent(ADAPTER_RENDER *this, void *a2, const GUID *a3)
{
  ...
  DXGETWPROFILER_BASE_PushProfilerEntry((__int64)&v34, 5031LL);
...
LABEL_16:
  ...
  v19 = (*(int (__fastcall **)(void *, const GUID *))(*((_QWORD *)this + 2) + 608LL))(a2, a3);
  if ( v38[0] )
  ...
  v28 = *(unsigned int *)a3->Data4;
  v25[7] = v28;
  if ( (unsigned int)(v19 + 1073741816) > 0x15 || (v28 = 2129921LL, !_bittest((const int *)&v28, v19 + 1073741816)) )
  {
    if ( (_DWORD)v19 != -1073741674
      && (_DWORD)v19 != -1073741670
