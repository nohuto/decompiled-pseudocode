/*
 * XREFs of ??1?$DXGPOINTERARRAYORDEREDACQUIRE@VDXGSYNCOBJECT@@$1?AcquireSyncObjectMutex@@YAXPEAV1@@Z$1?ReleaseSyncObjectMutex@@YAX0@Z$01@@QEAA@XZ @ 0x1C00072B4
 * Callers:
        ...
        __int64 a1)
{
  ...
  if ( v2 )
  {
    if ( !*(_BYTE *)(a1 + 32) )
    {
      ...
      {
        do
          DXGFASTMUTEX::Release((DXGFASTMUTEX *)(*(_QWORD *)(*(_QWORD *)a1 + 8 * v3++) + 32LL));
