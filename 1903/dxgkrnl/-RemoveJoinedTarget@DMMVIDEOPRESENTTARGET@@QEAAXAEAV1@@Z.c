/*
 * XREFs of ?RemoveJoinedTarget@DMMVIDEOPRESENTTARGET@@QEAAXAEAV1@@Z @ 0x1C00554E0
 * Callers:
        ...
        struct DMMVIDEOPRESENTTARGET *a2)
{
  ...
  *v4 = (struct DMMVIDEOPRESENTTARGET *)v3;
  ...
  ReferenceCounted::Release((DMMVIDEOPRESENTTARGET *)((char *)this + 64), (__int64)a2, (__int64)v4);
  *((_QWORD *)a2 + 66) = 0LL;
}
