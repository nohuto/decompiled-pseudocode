/*
 * XREFs of DpiKsrGetSavedAdapterState @ 0x1C02A934C
 * Callers:
...
__int64 __fastcall DpiKsrGetSavedAdapterState(__int64 a1)
{
  ...
  *v2 = 0;
  ...
  if ( (_DWORD)v9 )
  {
    while ( 1 )
    {
      v11 = *(_QWORD *)v10 - *(_QWORD *)(v1 + 4872);
      if ( *(_QWORD *)v10 == *(_QWORD *)(v1 + 4872) )
        v11 = *(_QWORD *)(v10 + 8) - *(_QWORD *)(v1 + 4880);
      if ( !v11 )
        break;
      ++v8;
    ...
    if ( !*(_BYTE *)(v10 + 16) )
    {
      v12 = *(_DWORD *)(qword_1C00A2C38 + 8);
      if ( v12 >= (unsigned int)v9 )
      {
        v13 = WdLogNewEntry5_WdError(v10, qword_1C00A2C38, v9);
        *(_QWORD *)(v13 + 24) = -1073741823LL;
        WdLogEvent5_WdError(v13);
        return 3221225473LL;
      }
      *(_DWORD *)(qword_1C00A2C38 + 8) = v12 + 1;
      *(_BYTE *)(v10 + 16) = 1;
    }
    *v4 = v10 + 24;
    *v5 = *(_DWORD *)(v10 + 20);
