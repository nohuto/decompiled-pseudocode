/*
 * XREFs of DxgkSignalSynchronizationObjectFromGpuByReference @ 0x1C00F66B0
 * Callers:
 *     ?SignalTokenSync@CAdapter@@UEAAJPEAX_K_N@Z @ 0x1C0007BA0 (-SignalTokenSync@CAdapter@@UEAAJPEAX_K_N@Z.c)
 *     ?AddSignalToContextByPtr@CAdapter@@UEAAJIPEAX_K@Z @ 0x1C005ABE0 (-AddSignalToContextByPtr@CAdapter@@UEAAJIPEAX_K@Z.c)
