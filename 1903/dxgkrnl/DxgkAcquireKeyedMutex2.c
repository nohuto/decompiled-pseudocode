/*
 * XREFs of DxgkAcquireKeyedMutex2 @ 0x1C026AFC0
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall DxgkAcquireKeyedMutex2(ULONG64 a1, __int64 a2, const GUID *a3)
{
  ...
  unsigned int v24[4]; // [rsp+58h] [rbp-40h]
  __int128 v25; // [rsp+68h] [rbp-30h] BYREF
  void *v26[2]; // [rsp+78h] [rbp-20h]
  ...
  DXGETWPROFILER_BASE_PushProfilerEntry((__int64)&v21, 2068LL);
