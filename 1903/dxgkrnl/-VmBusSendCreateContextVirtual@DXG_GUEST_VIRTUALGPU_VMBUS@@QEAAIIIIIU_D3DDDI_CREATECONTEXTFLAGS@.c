/*
 * XREFs of ?VmBusSendCreateContextVirtual@DXG_GUEST_VIRTUALGPU_VMBUS@@QEAAIIIIIU_D3DDDI_CREATECONTEXTFLAGS@@W4_D3DKMT_CLIENTHINT@@IPEAX@Z @ 0x1C022325C
 * Callers:
        ...
        void *Src)
{
  ...
  *(_QWORD *)&v15->0 = 0LL;
  ...
  if ( Size )
  {
    if ( *(_DWORD *)(*((_QWORD *)this + 7) + 1728LL) >= 0x7008u )
