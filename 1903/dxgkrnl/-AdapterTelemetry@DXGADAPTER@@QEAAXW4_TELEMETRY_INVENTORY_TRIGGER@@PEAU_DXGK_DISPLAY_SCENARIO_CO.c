/*
 * XREFs of ?AdapterTelemetry@DXGADAPTER@@QEAAXW4_TELEMETRY_INVENTORY_TRIGGER@@PEAU_DXGK_DISPLAY_SCENARIO_CONTEXT@@@Z @ 0x1C015E4D8
 * Callers:
 ...
 *     DxgkMiracastQueryMiracastSupportNoLock @ 0x1C001F390 (DxgkMiracastQueryMiracastSupportNoLock.c)
...
LABEL_13:
                ...
                &v60) >= 0 )
    {
      ...
      if ( (unsigned int)dword_1C00A1930 > 5 && TlgKeywordOn((TraceLoggingHProvider)&dword_1C00A1930, 0x800000000004uLL) )
      {
        ...
        TlgWrite((TraceLoggingHProvider)&dword_1C00A1930, &unk_1C00725B4, p_ActivityId, v21, 0x36u, &pData);
      }
