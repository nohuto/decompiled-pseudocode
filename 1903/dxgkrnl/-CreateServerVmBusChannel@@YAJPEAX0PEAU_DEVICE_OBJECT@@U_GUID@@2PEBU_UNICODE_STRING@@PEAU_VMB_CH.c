/*
 * XREFs of ?CreateServerVmBusChannel@@YAJPEAX0PEAU_DEVICE_OBJECT@@U_GUID@@2PEBU_UNICODE_STRING@@PEAU_VMB_CHANNEL_STATE_CHANGE_CALLBACKS@@P6AXPEAUVMBCHANNEL__@@PEAUVMBPACKETCOMPLETION__@@0II@ZP6AX5I@ZIPEAPEAU5@@Z @ 0x1C0217518
 * Callers:
        ...
        struct VMBCHANNEL__ **a11)
{
  ...
  *a11 = 0LL;
  ...
  if ( (int)v16 < 0 )
    goto LABEL_22;
  LOBYTE(v15) = 1;
  LODWORD(v16) = ((__int64 (__fastcall *)(const GUID *, __int64, struct VMBCHANNEL__ **))qword_1C00A3BE0)(a3, v15, &v28);
  if ( (int)v16 < 0 )
  {
LABEL_21:
  ...
  LODWORD(v16) = ((__int64 (__fastcall *)(struct VMBCHANNEL__ *, __int64))qword_1C00A3E68)(v28, a1);
  if ( (int)v16 < 0 )
    goto LABEL_19;
  LODWORD(v16) = ((__int64 (__fastcall *)(struct VMBCHANNEL__ *, __int64))qword_1C00A3C50)(v28, 0x20000LL);
  if ( (int)v16 < 0 )
    goto LABEL_19;
  ((void (__fastcall *)(struct VMBCHANNEL__ *, void *))qword_1C00A3CA8)(v28, a2);
  v30 = (__int128)*a4;
  v29 = (__int128)*a5;
  LODWORD(v16) = ((__int64 (__fastcall *)(struct VMBCHANNEL__ *, __int128 *, __int128 *))qword_1C00A3E58)(
                   v28,
                   &v30,
                   &v29);
  if ( (int)v16 < 0 )
    goto LABEL_19;
  LODWORD(v16) = ((__int64 (__fastcall *)(struct VMBCHANNEL__ *, struct _VMB_CHANNEL_STATE_CHANGE_CALLBACKS *))qword_1C00A3C60)(
                   v28,
                   a7);
  if ( (int)v16 < 0 )
    goto LABEL_19;
  LODWORD(v16) = ((__int64 (__fastcall *)(struct VMBCHANNEL__ *, void (*)(struct VMBCHANNEL__ *, struct VMBPACKETCOMPLETION__ *, void *, unsigned int, unsigned int), void (*)(struct VMBCHANNEL__ *, unsigned int)))qword_1C00A3C58)(
                   v28,
                   a8,
                   a9);
  if ( (int)v16 < 0 )
    goto LABEL_19;
  ((void (__fastcall *)(struct VMBCHANNEL__ *, __int64))qword_1C00A3E40)(v28, 2LL);
  ((void (__fastcall *)(struct VMBCHANNEL__ *, const struct _UNICODE_STRING *))qword_1C00A3C40)(v28, a6);
  if ( a10
    && (v19 = ((__int64 (__fastcall *)(struct VMBCHANNEL__ *, _QWORD, _QWORD))qword_1C00A3E48)(
                v28,
  ...
  {
    LODWORD(v16) = ((__int64 (__fastcall *)(struct VMBCHANNEL__ *))qword_1C00A3C10)(v28);
    if ( (int)v16 < 0 )
      goto LABEL_19;
    ((void (__fastcall *)(struct VMBCHANNEL__ *))qword_1C00A3CC0)(v28);
  }
  if ( (int)v16 >= 0 )
  {
    *a11 = v28;
...
LABEL_19:
  ...
  *(_QWORD *)(v24 + 24) = (int)v16;
  ...
  ((void (__fastcall *)(struct VMBCHANNEL__ *))qword_1C00A3BE8)(v28);
LABEL_20:
  if ( (int)v16 < 0 )
    goto LABEL_21;
LABEL_22:
