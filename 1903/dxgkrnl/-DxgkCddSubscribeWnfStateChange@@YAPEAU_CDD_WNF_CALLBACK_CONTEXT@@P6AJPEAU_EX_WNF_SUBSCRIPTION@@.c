/*
 * XREFs of ?DxgkCddSubscribeWnfStateChange@@YAPEAU_CDD_WNF_CALLBACK_CONTEXT@@P6AJPEAU_EX_WNF_SUBSCRIPTION@@PEBU_WNF_STATE_NAME@@KKPEBU_WNF_TYPE_ID@@PEAX@ZPEAU_EPROCESS@@1K3@Z @ 0x1C014AD10
 * Callers:
 *     <none>
 * Callees:
        ...
        void *a5)
{
  ...
  if ( v9 )
  {
    ...
    v15 = ExSubscribeWnfStateChange(v14, a3, a4, 0LL, DxgkWnfStateChangeCallback, v14);
    v19 = v15;
    if ( v15 >= 0 )
      return v14;
