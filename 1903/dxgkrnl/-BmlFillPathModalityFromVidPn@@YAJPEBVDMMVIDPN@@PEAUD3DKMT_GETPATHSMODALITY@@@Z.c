/*
 * XREFs of ?BmlFillPathModalityFromVidPn@@YAJPEBVDMMVIDPN@@PEAUD3DKMT_GETPATHSMODALITY@@@Z @ 0x1C00D1700
 * Callers:
    ...
    do
    {
      ...
      while ( v7 )
      {
        ...
        if ( (*((_QWORD *)v9 + 6) & 0x700000000000LL) == 0x700000000000LL )
        {
          ...
          v11 = *(_QWORD *)(v10 + 16);
          if ( *((_DWORD *)v9 + 16) == *(_DWORD *)(v11 + 276)
            && *((_DWORD *)v9 + 17) == *(_DWORD *)(v11 + 280)
            ...
            && *((_DWORD *)v9 + 19) == *(_DWORD *)(*((_QWORD *)v4 + 12) + 24LL) )
          {
            ...
            *((_DWORD *)v9 + 64) = v21;
            ...
            if ( v20 )
              ReferenceCounted::Release((ReferenceCounted *)(v20 + 88), (__int64)a2, (__int64)v3);
            if ( v16 )
              ReferenceCounted::Release((ReferenceCounted *)(v16 + 88), (__int64)a2, (__int64)v3);
            break;
          }
        }
        else
