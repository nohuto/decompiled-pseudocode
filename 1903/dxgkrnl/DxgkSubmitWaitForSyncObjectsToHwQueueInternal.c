/*
 * XREFs of DxgkSubmitWaitForSyncObjectsToHwQueueInternal @ 0x1C024E208
 * Callers:
 ...
 *     DxgkSubmitWaitForSyncObjectsToHwQueue @ 0x1C024E1F0 (DxgkSubmitWaitForSyncObjectsToHwQueue.c)
 * Callees:
