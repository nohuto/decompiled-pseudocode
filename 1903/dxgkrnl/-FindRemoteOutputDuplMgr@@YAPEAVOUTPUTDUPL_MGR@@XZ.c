/*
 * XREFs of ?FindRemoteOutputDuplMgr@@YAPEAVOUTPUTDUPL_MGR@@XZ @ 0x1C00F37C8
 * Callers:
 ...
 *     OutputDuplProcessRemoteSessionSetPointerShape @ 0x1C0276658 (OutputDuplProcessRemoteSessionSetPointerShape.c)
