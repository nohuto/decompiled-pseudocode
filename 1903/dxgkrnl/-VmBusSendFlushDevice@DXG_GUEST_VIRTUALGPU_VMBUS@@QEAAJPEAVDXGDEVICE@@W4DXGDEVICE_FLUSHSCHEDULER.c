/*
 * XREFs of ?VmBusSendFlushDevice@DXG_GUEST_VIRTUALGPU_VMBUS@@QEAAJPEAVDXGDEVICE@@W4DXGDEVICE_FLUSHSCHEDULER_REASON@@@Z @ 0x1C02244D0
 * Callers:
...
__int64 __fastcall DXG_GUEST_VIRTUALGPU_VMBUS::VmBusSendFlushDevice(DXG_VMBUS_CHANNEL_BASE *a1, __int64 a2, int a3)
{
  ...
  v3 = (struct _MDL *)*(unsigned int *)(*(_QWORD *)(a2 + 40) + 368LL);
  v6 = 0LL;
  v4 = *(_DWORD *)(a2 + 336);
  v7 = (int)v3;
  v8 = 0;
