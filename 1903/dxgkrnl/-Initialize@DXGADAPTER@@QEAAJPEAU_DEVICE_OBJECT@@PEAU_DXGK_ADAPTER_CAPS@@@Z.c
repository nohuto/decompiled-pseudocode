/*
 * XREFs of ?Initialize@DXGADAPTER@@QEAAJPEAU_DEVICE_OBJECT@@PEAU_DXGK_ADAPTER_CAPS@@@Z @ 0x1C01651A8
 * Callers:
 ...
 * Callees:
 *     ?IsSoftwareAdapter@DXGADAPTER@@QEBAEXZ @ 0x1C0001208 (-IsSoftwareAdapter@DXGADAPTER@@QEBAEXZ.c)
 *     ?IsGpuMmuSupported@DXGADAPTER@@QEBAEXZ @ 0x1C0003ED8 (-IsGpuMmuSupported@DXGADAPTER@@QEBAEXZ.c)
 *     ?IsWarpAdapter@DXGADAPTER@@QEBAEXZ @ 0x1C0004110 (-IsWarpAdapter@DXGADAPTER@@QEBAEXZ.c)
 *     ?IsIoMmuSupported@DXGADAPTER@@QEBAEXZ @ 0x1C0004124 (-IsIoMmuSupported@DXGADAPTER@@QEBAEXZ.c)
 *     ?IsXBoxOneDevice@DXGADAPTER@@QEBAEXZ @ 0x1C0006034 (-IsXBoxOneDevice@DXGADAPTER@@QEBAEXZ.c)
 *     ?IsBddFallbackDriver@DXGADAPTER@@QEBAEXZ @ 0x1C00062E4 (-IsBddFallbackDriver@DXGADAPTER@@QEBAEXZ.c)
 *     ?IsBddDevice@DXGADAPTER@@QEBAEXZ @ 0x1C0006300 (-IsBddDevice@DXGADAPTER@@QEBAEXZ.c)
 ...
 *     ?IsSoftGPU@DXGADAPTER@@QEBAEXZ @ 0x1C000B750 (-IsSoftGPU@DXGADAPTER@@QEBAEXZ.c)
 *     ?IsRenderAdapter@DXGADAPTER@@QEBAEXZ @ 0x1C000B7B8 (-IsRenderAdapter@DXGADAPTER@@QEBAEXZ.c)
 ...
 *     ?IsPostAdapter@DXGADAPTER@@QEBAEXZ @ 0x1C001A910 (-IsPostAdapter@DXGADAPTER@@QEBAEXZ.c)
 *     ??_H@YAXPEAX_K1P6APEAX0@Z@Z @ 0x1C001DBB8 (--_H@YAXPEAX_K1P6APEAX0@Z@Z.c)
 *     ?IsComputeOnlyAdapter@DXGADAPTER@@QEBAEXZ @ 0x1C001DFF4 (-IsComputeOnlyAdapter@DXGADAPTER@@QEBAEXZ.c)
 *     ?CheckMcdmDdiOverall@DXGADAPTER@@AEAAJXZ @ 0x1C001F46C (-CheckMcdmDdiOverall@DXGADAPTER@@AEAAJXZ.c)
 *     DxgkConvertWddmVersionToD3DKMTDriverVersion @ 0x1C001F4B0 (DxgkConvertWddmVersionToD3DKMTDriverVersion.c)
 *     ?IsSurpriseRemovalSupport@DXGADAPTER@@QEBAEW4_DXGK_SURPRISE_REMOVAL_TYPE@@@Z @ 0x1C001F538 (-IsSurpriseRemovalSupport@DXGADAPTER@@QEBAEW4_DXGK_SURPRISE_REMOVAL_TYPE@@@Z.c)
 *     ?IsVirtualRenderDevice@DXGADAPTER@@QEBAEXZ @ 0x1C001F54C (-IsVirtualRenderDevice@DXGADAPTER@@QEBAEXZ.c)
 ...
 *     ?SetWarpAdapter@DXGGLOBAL@@QEAAXPEAVDXGADAPTER@@@Z @ 0x1C0023220 (-SetWarpAdapter@DXGGLOBAL@@QEAAXPEAVDXGADAPTER@@@Z.c)
 *     _guard_dispatch_icall_nop @ 0x1C0024FA0 (_guard_dispatch_icall_nop.c)
 *     memset @ 0x1C0025300 (memset.c)
 *     ?RecordFeatureUsage@DXGGLOBAL@@QEAAJW4_DxgKrnlFeature@1@K@Z @ 0x1C00C3294 (-RecordFeatureUsage@DXGGLOBAL@@QEAAJW4_DxgKrnlFeature@1@K@Z.c)
 ...
 *     ?GetDriverCapsSizeFromDdiVersion@@YAII@Z @ 0x1C0167D3C (-GetDriverCapsSizeFromDdiVersion@@YAII@Z.c)
 *     DpiGetDriverVersion @ 0x1C0167D80 (DpiGetDriverVersion.c)
 *     ?CallDriverQueryInterface@DXGADAPTER@@QEAAJPEBU_GUID@@GGPEAX1@Z @ 0x1C0167D94 (-CallDriverQueryInterface@DXGADAPTER@@QEAAJPEBU_GUID@@GGPEAX1@Z.c)
 ...
 *     ?CreateFrameBufferSaveAreaSection@DXGADAPTER@@QEAAJI_K@Z @ 0x1C01EC214 (-CreateFrameBufferSaveAreaSection@DXGADAPTER@@QEAAJI_K@Z.c)
 *     ?InitializeParavirtualizedAdapter@DXGADAPTER@@QEAAJXZ @ 0x1C01ED514 (-InitializeParavirtualizedAdapter@DXGADAPTER@@QEAAJXZ.c)
 *     ?ValidateHardwareReservedRanges@DXGADAPTER@@AEAAJPEBU_DXGK_PHYSICAL_MEMORY_RANGE@@I@Z @ 0x1C01EF900 (-ValidateHardwareReservedRanges@DXGADAPTER@@AEAAJPEBU_DXGK_PHYSICAL_MEMORY_RANGE@@I@Z.c)
 */
...
LABEL_335:
    ...
    && g_wil_details_pfnFeatureLoggingHook )
  {
    g_wil_details_pfnFeatureLoggingHook(
      0x10E0F61u,
      (const struct FEATURE_LOGGED_TRAITS *)&unk_1C006F2F0,
      0LL,
      1,
...
LABEL_340:
  ...
  if ( *((int *)this + 613) >= 2600 && (*((_DWORD *)this + 606) & 8) != 0 )
  {
      ...
      && g_wil_details_pfnFeatureLoggingHook )
    {
      g_wil_details_pfnFeatureLoggingHook(
        0x124B067u,
        (const struct FEATURE_LOGGED_TRAITS *)&unk_1C00767B0,
        0LL,
        1,
