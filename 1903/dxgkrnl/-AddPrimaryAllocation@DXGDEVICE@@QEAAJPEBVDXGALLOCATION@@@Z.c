/*
 * XREFs of ?AddPrimaryAllocation@DXGDEVICE@@QEAAJPEBVDXGALLOCATION@@@Z @ 0x1C0148510
 * Callers:
...
__int64 __fastcall DXGDEVICE::AddPrimaryAllocation(DXGADAPTER **this, const struct DXGALLOCATION *a2)
{
  ...
  if ( DXGDEVICE::InsertPrimaryAllocation(this, v6, a2, &v19) )
  {
    ...
    if ( !v19 )
      return 0LL;
    if ( this[216] != *((DXGADAPTER **)v12 + 2) )
      return 0LL;
    if ( *((_DWORD *)this + 82) != 1 )
      return 0LL;
    if ( (*((_DWORD *)a2 + 18) & 0x800) != 0 )
      return 0LL;
    result = (*(__int64 (__fastcall **)(_QWORD, _QWORD, _QWORD, _QWORD))(*(_QWORD *)(*((_QWORD *)v12 + 68) + 8LL) + 224LL))(
               *((_QWORD *)v12 + 69),
               *((_QWORD *)a2 + 3),
               0LL,
               0LL);
