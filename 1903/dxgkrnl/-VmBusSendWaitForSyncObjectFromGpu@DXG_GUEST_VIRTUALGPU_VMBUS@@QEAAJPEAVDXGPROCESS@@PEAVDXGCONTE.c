/*
 * XREFs of ?VmBusSendWaitForSyncObjectFromGpu@DXG_GUEST_VIRTUALGPU_VMBUS@@QEAAJPEAVDXGPROCESS@@PEAVDXGCONTEXT@@PEBIPEAPEAVDXGSYNCOBJECT@@PEAPEAVDXGDEVICESYNCOBJECT@@PEB_K_KIPEAVDXGHWQUEUE@@@Z @ 0x1C0228510
 * Callers:
        ...
        struct DXGHWQUEUE *a10)
{
  ...
  _BYTE v41[88]; // [rsp+30h] [rbp-58h] BYREF
  struct DXGDEVICESYNCOBJECT **v44; // [rsp+B8h] [rbp+30h]
...
LABEL_7:
  ...
  if ( !a4 || !Src )
  {
    v13 = WdLogNewEntry5_WdError(this, a2, 0LL);
    *(_QWORD *)(v13 + 24) = 6126LL;
LABEL_31:
...
LABEL_8:
  ...
  if ( v19 )
  {
    ...
    *((_DWORD *)v19 + 4) = 25;
    ...
    else
    {
      ...
      if ( a9 )
      {
        ...
        v27 = (char *)a6 - (char *)a5;
        v44 = (struct DXGDEVICESYNCOBJECT **)((char *)a6 - (char *)a5);
        v28 = a9;
    ...
    *((_DWORD *)v19 + 7) = v14;
    v33 = DXG_VMBUS_CHANNEL_BASE::VmBusSendSyncMessageStatusReturn(
            this,
