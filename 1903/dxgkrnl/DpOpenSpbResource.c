/*
 * XREFs of DpOpenSpbResource @ 0x1C02AD350
 * Callers:
 *     <none>
 * Callees:
 ...
 *     ?RtlUnicodeStringPrintf@@YAJPEAU_UNICODE_STRING@@PEBGZZ @ 0x1C00430E0 (-RtlUnicodeStringPrintf@@YAJPEAU_UNICODE_STRING@@PEBGZZ.c)
 *     DpiCreateSpbResourceRecord @ 0x1C02ADC24 (DpiCreateSpbResourceRecord.c)
 */
