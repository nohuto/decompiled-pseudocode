/*
 * XREFs of ?DxgkCddUpdatePresentRects@@YAJPEAVADAPTER_DISPLAY@@IPEAPEBUtagRECT@@PEAI@Z @ 0x1C013ABBC
 * Callers:
  ...
  if ( CddInterface )
  {
    ...
    if ( v13 )
    {
      if ( v13 != -1 )
      {
        ...
        if ( (((unsigned int)ADAPTER_DISPLAY::GetCurrentOrientation((__int64)this, (unsigned int)v6, 1LL) - 2) & 0xFFFFFFFD) == 0 )
        {
          right = v15.right;
          v15.right = v15.bottom;
          v15.bottom = right;
        }
        CurrentOrientation = (unsigned int)ADAPTER_DISPLAY::GetCurrentOrientation((__int64)this, (unsigned int)v6, 0LL);
        DxgkpConvertRects(
