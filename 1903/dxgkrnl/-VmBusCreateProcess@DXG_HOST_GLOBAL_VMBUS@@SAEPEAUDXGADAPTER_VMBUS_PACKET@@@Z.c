/*
 * XREFs of ?VmBusCreateProcess@DXG_HOST_GLOBAL_VMBUS@@SAEPEAUDXGADAPTER_VMBUS_PACKET@@@Z @ 0x1C021D070
 * Callers:
 *     <none>
 * Callees:
 ...
 *     ?IncrementNumVmProcesses@DXGVIRTUALMACHINE@@QEAAJXZ @ 0x1C025E4D8 (-IncrementNumVmProcesses@DXGVIRTUALMACHINE@@QEAAJXZ.c)
