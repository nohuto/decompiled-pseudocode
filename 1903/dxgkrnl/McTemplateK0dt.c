/*
 * XREFs of McTemplateK0dt @ 0x1C0047434
 * Callers:
...
ULONG __fastcall McTemplateK0dt(__int64 a1, const EVENT_DESCRIPTOR *a2, const GUID *a3, int a4, __int64 a5)
{
  ...
  v12 = 0;
  v11 = 4;
  return McGenEventWrite((PMCGEN_TRACE_CONTEXT)&DxgkControlGuid_Context, a2, a3, 3u, &v6);
}
