/*
 * XREFs of ?DpiBrightness3Set@@YAJPEAXKPEAU_DXGK_BRIGHTNESS_SET_IN@@@Z @ 0x1C02A6570
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall DpiBrightness3Set(_QWORD *a1, unsigned int a2, struct _DXGK_BRIGHTNESS_SET_IN *a3)
{
  ...
  __int64 v12; // rax
  __int64 v13; // r9
  __int64 (__fastcall *v14)(_QWORD, _QWORD, struct _DXGK_BRIGHTNESS_SET_IN *); // rax
  ...
  if ( v7 >= 0 )
  {
    ...
    if ( v13 )
    {
      v14 = *(__int64 (__fastcall **)(_QWORD, _QWORD, struct _DXGK_BRIGHTNESS_SET_IN *))(v13 + 32);
      if ( v14 )
