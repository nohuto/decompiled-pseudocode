/*
 * XREFs of ?_RetrieveMonitorConfigurationFromRegistry@DXGMONITOR@@AEAAJPEAXE@Z @ 0x1C0173EA0
 * Callers:
...
__int64 __fastcall DXGMONITOR::_RetrieveMonitorConfigurationFromRegistry(DXGMONITOR *this, void *a2, char a3)
{
  ...
  do
  {
    ...
    if ( v11 < 0 )
    {
      v22 = (_QWORD *)WdLogNewEntry5_WdError(v13, v12, v14);
      v22[3] = v5;
    ...
    {
      v22 = (_QWORD *)WdLogNewEntry5_WdError(v17, v16, v18);
      v22[3] = v33;
      v22[4] = v5;
      v22[5] = *((unsigned int *)this + 11);
LABEL_11:
    ...
    {
      v21 = (_QWORD *)WdLogNewEntry5_WdDmmEvent(v19, v16);
      v21[3] = v33;
      v21[4] = v5;
      v21[5] = *((unsigned int *)this + 11);
