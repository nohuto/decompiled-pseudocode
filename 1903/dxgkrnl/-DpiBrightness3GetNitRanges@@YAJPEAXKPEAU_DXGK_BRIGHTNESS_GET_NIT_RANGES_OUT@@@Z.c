/*
 * XREFs of ?DpiBrightness3GetNitRanges@@YAJPEAXKPEAU_DXGK_BRIGHTNESS_GET_NIT_RANGES_OUT@@@Z @ 0x1C02A6470
 * Callers:
 *     <none>
 * Callees:
        ...
        struct _DXGK_BRIGHTNESS_GET_NIT_RANGES_OUT *a3)
{
  ...
  __int64 v12; // rax
  __int64 v13; // r9
  __int64 (__fastcall *v14)(_QWORD, _QWORD, struct _DXGK_BRIGHTNESS_GET_NIT_RANGES_OUT *); // rax
  ...
  if ( v7 >= 0 )
  {
    ...
    if ( v13 )
    {
      v14 = *(__int64 (__fastcall **)(_QWORD, _QWORD, struct _DXGK_BRIGHTNESS_GET_NIT_RANGES_OUT *))(v13 + 56);
      if ( v14 )
