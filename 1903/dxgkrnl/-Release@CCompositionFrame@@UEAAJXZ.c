/*
 * XREFs of ?Release@CCompositionFrame@@UEAAJXZ @ 0x1C0013FF0
 * Callers:
 *     <none>
 * Callees:
 *     ?ReturnLegacyTokenBuffer@CCompositionFrame@@IEAAXXZ @ 0x1C0014250 (-ReturnLegacyTokenBuffer@CCompositionFrame@@IEAAXXZ.c)
