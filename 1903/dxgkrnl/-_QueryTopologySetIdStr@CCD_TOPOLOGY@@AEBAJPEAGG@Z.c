/*
 * XREFs of ?_QueryTopologySetIdStr@CCD_TOPOLOGY@@AEBAJPEAGG@Z @ 0x1C00D01C0
 * Callers:
 ...
 *     ?IsSameCloneGroup@CCD_TOPOLOGY@@QEBA_NII_N@Z @ 0x1C02C0A18 (-IsSameCloneGroup@CCD_TOPOLOGY@@QEBA_NII_N@Z.c)
 */
...
__int64 __fastcall CCD_TOPOLOGY::_QueryTopologySetIdStr(CCD_TOPOLOGY *this, unsigned __int16 *a2, unsigned __int16 a3)
{
  ...
  {
    v9 = 272LL * v8;
    if ( DxgkIsTargetNonStandard((const struct _LUID *)(v9 + v4 + 64), *(unsigned int *)(v9 + v4 + 76)) )
    {
