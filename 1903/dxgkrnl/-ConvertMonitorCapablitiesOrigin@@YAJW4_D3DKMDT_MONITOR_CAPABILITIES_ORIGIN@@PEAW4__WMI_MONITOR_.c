/*
 * XREFs of ?ConvertMonitorCapablitiesOrigin@@YAJW4_D3DKMDT_MONITOR_CAPABILITIES_ORIGIN@@PEAW4__WMI_MONITOR_CAPABILITY_ORIGIN_TYPE@@@Z @ 0x1C02CEBBC
 * Callers:
  ...
  switch ( (_DWORD)a1 )
  {
    ...
    case 4:
      *(_DWORD *)a2 = 4;
      break;
    default:
      v4 = WdLogNewEntry5_WdError(a1, a2, (unsigned int)(a1 - 3));
      *(_QWORD *)(v4 + 24) = v2;
