/*
 * XREFs of ??1DXGPROCESS@@MEAA@XZ @ 0x1C00F5684
 * Callers:
 *     ??_GDXGPROCESS@@MEAAPEAXI@Z @ 0x1C00073F0 (--_GDXGPROCESS@@MEAAPEAXI@Z.c)
 *     ??1DXGPROCESSVM@@UEAA@XZ @ 0x1C004433C (--1DXGPROCESSVM@@UEAA@XZ.c)
