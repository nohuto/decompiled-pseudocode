/*
 * XREFs of ?RemoveChildTarget@DMMVIDEOPRESENTTARGET@@QEAAXAEAV1@@Z @ 0x1C005545C
 * Callers:
...
void __fastcall DMMVIDEOPRESENTTARGET::RemoveChildTarget(DMMVIDEOPRESENTTARGET *this, struct DMMVIDEOPRESENTTARGET *a2)
{
  ...
  v3 = *((_QWORD *)a2 + 57);
  if ( *(struct DMMVIDEOPRESENTTARGET **)(v3 + 8) != (struct DMMVIDEOPRESENTTARGET *)((char *)a2 + 456)
  ...
  *((_QWORD *)a2 + 59) = 0LL;
  ...
  ReferenceCounted::Release((DMMVIDEOPRESENTTARGET *)((char *)this + 64), (__int64)a2, v3);
}
