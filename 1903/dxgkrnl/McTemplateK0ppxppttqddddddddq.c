/*
 * XREFs of McTemplateK0ppxppttqddddddddq @ 0x1C0043F64
 * Callers:
...
ULONG McTemplateK0ppxppttqddddddddq(__int64 a1, __int64 a2, const GUID *a3, ...)
{
  ...
  v38 = 4LL;
  v40 = 4LL;
  return McGenEventWrite((PMCGEN_TRACE_CONTEXT)&DxgkControlGuid_Context, &EventBlit, a3, 0x12u, &EventData);
}
