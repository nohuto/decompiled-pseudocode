/*
 * XREFs of ?PopulateGdiDisplayModeFromPath@VIDPN_MGR@@SAJPEBVDMMVIDPNPRESENTPATH@@PEAU_CDD_DEVMODE@@@Z @ 0x1C00D1A08
 * Callers:
...
LABEL_13:
  ...
  *(_QWORD *)((char *)a2 + 220) = *(_QWORD *)(v15 + 92);
  ...
  v22 = DmmMapVSyncFromRationalToInteger((const struct _D3DDDI_RATIONAL *)((char *)a2 + 220), v21, 0LL);
