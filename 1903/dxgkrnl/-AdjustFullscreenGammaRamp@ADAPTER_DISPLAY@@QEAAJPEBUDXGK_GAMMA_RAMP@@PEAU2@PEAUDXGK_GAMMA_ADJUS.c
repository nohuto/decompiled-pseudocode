/*
 * XREFs of ?AdjustFullscreenGammaRamp@ADAPTER_DISPLAY@@QEAAJPEBUDXGK_GAMMA_RAMP@@PEAU2@PEAUDXGK_GAMMA_ADJUSTMENT@@@Z @ 0x1C01EFF9C
 * Callers:
 ...
 * Callees:
 *     ?ScaleAndOffset@@YAGGMM@Z @ 0x1C01F3E38 (-ScaleAndOffset@@YAGGMM@Z.c)
 */
