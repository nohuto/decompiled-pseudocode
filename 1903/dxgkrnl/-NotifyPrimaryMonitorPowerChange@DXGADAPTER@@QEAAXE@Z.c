/*
 * XREFs of ?NotifyPrimaryMonitorPowerChange@DXGADAPTER@@QEAAXE@Z @ 0x1C00333A0
 * Callers:
 *     ?PowerSettingCallback@DXGADAPTER@@SAJPEBU_GUID@@PEAXK1@Z @ 0x1C01EDD60 (-PowerSettingCallback@DXGADAPTER@@SAJPEBU_GUID@@PEAXK1@Z.c)
 * Callees:
...
void __fastcall DXGADAPTER::NotifyPrimaryMonitorPowerChange(KSPIN_LOCK *this, char a2)
{
  ...
  DXGAUTOSPINLOCK::DXGAUTOSPINLOCK((DXGAUTOSPINLOCK *)v11, this + 382, 1);
  ...
  *((_BYTE *)this + 3034) = a2;
  ...
  this[360] = (KSPIN_LOCK)this + (-(__int64)(a2 != 0) & 0xFFFFFFFFFFFFFFD0uLL) + 2832;
  DXGADAPTER::UpdateLatencyTolerances((DXGADAPTER *)this);
  if ( this[325] )
  {
    v7 = (DXGADAPTER *)this[389];
    while ( v7 != (DXGADAPTER *)(this + 389) )
    {
      v8 = v7;
      v9 = *((int *)v7 - 10);
      v7 = *(DXGADAPTER **)v7;
      v10 = *(_QWORD *)(this[360] + 16 * v9);
      if ( v10 != *((_QWORD *)v8 - 7) )
