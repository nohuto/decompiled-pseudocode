/*
 * XREFs of ?StartRuntimePowerManagement@DXGADAPTER@@QEAAXXZ @ 0x1C01EEEA0
 * Callers:
...
void __fastcall DXGADAPTER::StartRuntimePowerManagement(DXGADAPTER *this)
{
  ...
  if ( *((_QWORD *)this + 325) )
  {
    ...
    if ( *((int *)this + 546) >= 0x2000 && v2 >= 0x5006 )
    ...
    if ( !*((_BYTE *)this + 3032) )
    {
      v3 = *((unsigned int *)this + 685);
      if ( (_DWORD)v3 != -1 )
        DXGADAPTER::SetPowerComponentActiveCBInternal(this, v3, 0, 0);
    }
    PoFxStartDevicePowerManagement(*((_QWORD *)this + 325));
    if ( v2 >= 0x3008 )
