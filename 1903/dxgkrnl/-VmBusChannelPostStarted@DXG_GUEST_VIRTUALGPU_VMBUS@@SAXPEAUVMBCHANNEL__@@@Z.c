/*
 * XREFs of ?VmBusChannelPostStarted@DXG_GUEST_VIRTUALGPU_VMBUS@@SAXPEAUVMBCHANNEL__@@@Z @ 0x1C021B940
 * Callers:
 *     <none>
 * Callees:
...
void __fastcall DXG_GUEST_VIRTUALGPU_VMBUS::VmBusChannelPostStarted(struct VMBCHANNEL__ *a1)
{
  ...
  v2 = ((__int64 (__fastcall *)(struct VMBCHANNEL__ *))qword_1C00A3C28)(a1);
