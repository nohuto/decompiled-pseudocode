/*
 * XREFs of ?CopyDriverStore@DXGADAPTER@@QEAAJXZ @ 0x1C023A678
 * Callers:
...
__int64 __fastcall DXGADAPTER::CopyDriverStore(DXGADAPTER *this, __int64 a2)
{
  ...
  wil_details_FeaturePropertyCache_ReportUsageToService(
    ...
    17411990LL,
    (const struct FEATURE_LOGGED_TRAITS *)&unk_1C0077FCC,
    0,
    v66);
  wil_details_FeaturePropertyCache_ReportUsageToService(
    (__int64)&Feature_CopyDriverToSystem32__private_propertyCache,
    19649929LL,
    (const struct FEATURE_LOGGED_TRAITS *)&unk_1C0077FC4,
    1,
    v67);
