/*
 * XREFs of DxgkHandleForceProjectionMonitor @ 0x1C02701D0
 * Callers:
 *     <none>
 * Callees:
...
LABEL_54:
  ...
  v28 = (int)COREADAPTERACCESS::AcquireExclusive(&v69, (unsigned int)(v27 + 1), v27);
...
LABEL_47:
  ...
  if ( !LOBYTE(v63.LowPart) )
    goto LABEL_51;
  v50 = DxgkInvalidateMonitorConnections(1LL);
  v54 = v50;
  if ( v50 >= 0 )
    goto LABEL_51;
