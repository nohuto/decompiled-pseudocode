/*
 * XREFs of DXGETWPROFILER_BASE_PushProfilerEntry @ 0x1C000A1C0
 * Callers:
...
__int64 __fastcall DXGETWPROFILER_BASE_PushProfilerEntry(__int64 a1, __int64 a2)
{
  int v2; // ebp
  __int64 v4; // rax
  __int64 result; // rax
  ...
  if ( (unsigned __int8)result < 2u )
  {
    ...
    result = PsGetCurrentProcessSessionId(a1, a2);
    v8 = result;
    if ( (_DWORD)result
      && (result = PsGetThreadSessionId(CurrentThread), (_DWORD)result == v8)
      && (result = IsThreadCrossSessionAttached(v10, v9), !(_DWORD)result)
      && (result = PsGetThreadWin32Thread(CurrentThread)) != 0
      && *(_QWORD *)result )
    {
      v11 = *(_QWORD *)(*(_QWORD *)result + 80LL);
    }
    else
    {
      v11 = 0LL;
