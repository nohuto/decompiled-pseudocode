/*
 * XREFs of ?DpiBrightness3GetCaps@@YAJPEAXKPEAU_DXGK_BRIGHTNESS_CAPS@@@Z @ 0x1C02A6370
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall DpiBrightness3GetCaps(_QWORD *a1, unsigned int a2, struct _DXGK_BRIGHTNESS_CAPS *a3)
{
  ...
  __int64 v12; // rax
  __int64 v13; // r9
  __int64 (__fastcall *v14)(_QWORD, _QWORD, struct _DXGK_BRIGHTNESS_CAPS *); // rax
  ...
  if ( v7 >= 0 )
  {
    ...
    if ( v13 )
    {
      v14 = *(__int64 (__fastcall **)(_QWORD, _QWORD, struct _DXGK_BRIGHTNESS_CAPS *))(v13 + 48);
      if ( v14 )
