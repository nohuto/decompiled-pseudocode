/*
 * XREFs of ?DdiSetContextSchedulingProperties@ADAPTER_RENDER@@QEAAJPEBU_DXGKARG_SETCONTEXTSCHEDULINGPROPERTIES@@@Z @ 0x1C01FC6A0
 * Callers:
 *     ?ADAPTER_RENDER_DdiSetContextSchedulingProperties@@YAJPEAVADAPTER_RENDER@@PEBU_DXGKARG_SETCONTEXTSCHEDULINGPROPERTIES@@@Z @ 0x1C003DF20 (-ADAPTER_RENDER_DdiSetContextSchedulingProperties@@YAJPEAVADAPTER_RENDER@@PEBU_DXGKARG_SETCONTEX.c)
 * Callees:
        ...
        const GUID *a3)
{
  ...
  __int64 v15; // r8
  __int64 v16; // rcx
  __int64 (__fastcall *v17)(_QWORD, const struct _DXGKARG_SETCONTEXTSCHEDULINGPROPERTIES *); // rax
  int v18; // edi
  __int64 v19; // rcx
  _QWORD *v20; // rax
  ...
  if ( (*(_BYTE *)(&DxgkControlGuid_Context + 2) & 2) != 0 )
  {
    ...
    if ( (Microsoft_Windows_DxgKrnlEnableBits & 0x2000) != 0 )
      McTemplateK0q((__int64)this, &EventProfilerEnter, a3, 5117);
  }
  else
  {
    v31 = 0;
  }
  DXGETWPROFILER_BASE_PushProfilerEntry((__int64)&v29, 5117LL);
...
LABEL_16:
  ...
  v16 = *((_QWORD *)this + 2);
  v17 = *(__int64 (__fastcall **)(_QWORD, const struct _DXGKARG_SETCONTEXTSCHEDULINGPROPERTIES *))(v16 + 1176);
  if ( v17 )
