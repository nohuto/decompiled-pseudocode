/*
 * XREFs of ?DdiResumeHwEngine@ADAPTER_RENDER@@QEAAJPEAU_DXGKARG_RESUMEHWENGINE@@@Z @ 0x1C0039670
 * Callers:
 *     ?ADAPTER_RENDER_DdiResumeHwEngine@@YAJPEAVADAPTER_RENDER@@PEAU_DXGKARG_RESUMEHWENGINE@@@Z @ 0x1C003DF00 (-ADAPTER_RENDER_DdiResumeHwEngine@@YAJPEAVADAPTER_RENDER@@PEAU_DXGKARG_RESUMEHWENGINE@@@Z.c)
 * Callees:
...
LABEL_30:
  ...
  v21 = (*(int (__fastcall **)(_QWORD, struct _DXGKARG_RESUMEHWENGINE *))(*((_QWORD *)this + 2) + 1024LL))(
