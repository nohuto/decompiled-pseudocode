/*
 * XREFs of ?DdiDestroyContext@ADAPTER_RENDER@@QEAAJPEAX@Z @ 0x1C012124C
 * Callers:
 *     ?ADAPTER_RENDER_DdiDestroyContext@@YAJPEAVADAPTER_RENDER@@QEAX@Z @ 0x1C003DD80 (-ADAPTER_RENDER_DdiDestroyContext@@YAJPEAVADAPTER_RENDER@@QEAX@Z.c)
...
__int64 __fastcall ADAPTER_RENDER::DdiDestroyContext(ADAPTER_RENDER *this, void *a2, const GUID *a3)
{
  __int64 v5; // rdx
  __int64 v6; // rcx
  ...
  DXGETWPROFILER_BASE_PushProfilerEntry((__int64)&v33, 5042LL);
...
LABEL_16:
  ...
  v18 = (*(int (__fastcall **)(void *))(*((_QWORD *)this + 2) + 648LL))(a2);
  if ( v37[0] )
