/*
 * XREFs of ?VmBusSendUpdateGpuVirtualAddress@DXG_GUEST_VIRTUALGPU_VMBUS@@QEAAJPEAVDXGPROCESS@@IIPEAU_D3DKMT_UPDATEGPUVIRTUALADDRESS@@@Z @ 0x1C0227D6C
 * Callers:
        ...
        struct _D3DKMT_UPDATEGPUVIRTUALADDRESS *a5)
{
  ...
  v39 = v11;
  if ( (unsigned int)v10 < 0x20000 )
  {
    v38 = v10 + 56;
    if ( (unsigned int)(v10 + 56) <= 0x20000 )
    {
          ...
          && ((unsigned __int8)v17 & 0x1F) != 0 )
        {
          ...
          if ( (_BYTE)v17 == 11 )
          {
            ...
            if ( v20 )
            {
              ...
              DXGHANDLETABLELOCKSHARED::~DXGHANDLETABLELOCKSHARED((DXGHANDLETABLELOCKSHARED *)v42);
          ...
          {
            v19 = WdLogNewEntry5_WdError(v17, v14, v16);
            *(_QWORD *)(v19 + 24) = 267LL;
