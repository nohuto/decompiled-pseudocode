/*
 * XREFs of ?_GetMonitorContainerID@DXGMONITOR@@QEAAJPEAU_GUID@@@Z @ 0x1C0171CA8
 * Callers:
 ...
 *     ?DisplayID_GetContainerID@@YAJPEAUDisplayIDObj@@PEAU_GUID@@@Z @ 0x1C0056A20 (-DisplayID_GetContainerID@@YAJPEAUDisplayIDObj@@PEAU_GUID@@@Z.c)
