/*
 * XREFs of MonitorCreateMonitorManager @ 0x1C016C2C8
 * Callers:
 ...
 *     ?_InitializeMonitorManager@MONITOR_MGR@@QEAAJXZ @ 0x1C016C364 (-_InitializeMonitorManager@MONITOR_MGR@@QEAAJXZ.c)
 */
