/*
 * XREFs of ?EnableDxgkrnlTelemetryProviderCallback@@YAXPEBU_GUID@@KE_K1PEAU_EVENT_FILTER_DESCRIPTOR@@PEAX@Z @ 0x1C014C5E0
 * Callers:
 *     <none>
 * Callees:
        ...
        ULONGLONG MatchAnyKeyword)
{
  ...
  {
    if ( (unsigned int)++dword_1C00A2DCC <= 4 )
    {
LABEL_3:
    ...
    SourceId = MEMORY[0xFFFFF78000000014] - qword_1C00A2DD0;
    if ( (unsigned __int64)(MEMORY[0xFFFFF78000000014] - qword_1C00A2DD0) > 0xC92A69C000LL )
    {
      qword_1C00A2DD0 = MEMORY[0xFFFFF78000000014];
      goto LABEL_3;
    }
  }
}
