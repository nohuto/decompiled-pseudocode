/*
 * XREFs of ?DxgkHandleDiagnosticProgressions@@YAJPEAU_DXGK_DIAGNOSTIC_HEADER@@@Z @ 0x1C0048CB0
 * Callers:
 *     <none>
 * Callees:
...
LABEL_3:
  ...
  if ( TraceLoggingProviderEnabled((TraceLoggingHProvider)&dword_1C00A18C0, 4u, 1uLL) )
  {
    ...
    if ( (v7 & 2) != 0 )
    {
      ...
      if ( (unsigned int)dword_1C00A18C0 > 4 )
      {
        if ( TlgKeywordOn((TraceLoggingHProvider)&dword_1C00A18C0, 1uLL) )
        {
          ...
          v22 = 4;
          v25 = 1;
          TlgWrite((TraceLoggingHProvider)&dword_1C00A18C0, &unk_1C0073A98, &pActivityId, v8, 6u, &pData);
        }
      }
    }
    else if ( (unsigned int)dword_1C00A18C0 > 4 && TlgKeywordOn((TraceLoggingHProvider)&dword_1C00A18C0, 1uLL) )
    {
      ...
      v12[0] = v11 & 1;
      v25 = 1;
      TlgWrite((TraceLoggingHProvider)&dword_1C00A18C0, &unk_1C0073A4C, &pActivityId, v10, 6u, &pData);
    }
  }
  return 0LL;
}
