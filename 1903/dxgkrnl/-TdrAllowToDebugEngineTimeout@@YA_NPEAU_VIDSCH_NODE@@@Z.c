/*
 * XREFs of ?TdrAllowToDebugEngineTimeout@@YA_NPEAU_VIDSCH_NODE@@@Z @ 0x1C023CC70
 * Callers:
 *     <none>
 * Callees:
 *     ?TdrValidateDebugMode@@YAXXZ @ 0x1C0040D40 (-TdrValidateDebugMode@@YAXXZ.c)
 */
