/*
 * XREFs of ?ReleaseTargetInfo@DXGDMM_VIDEOPRESENTTARGETSET_INTERFACE_V1_IMPL@@YAJQEAUD3DKMDT_HVIDEOPRESENTTARGETSET__@@QEBU_D3DKMDT_VIDEO_PRESENT_TARGET@@@Z @ 0x1C02B9990
 * Callers:
 *     <none>
 * Callees:
        ...
        const GUID *a3)
{
  ...
  DXGETWPROFILER_BASE_PushProfilerEntry((__int64)&v19, 6047LL);
  if ( a2 )
  {
    ...
    if ( v11 )
    {
      v10 = DMMVIDEOPRESENTTARGETSET::ReleaseDdiEnumerator(v11, a2);
    }
    else
    {
