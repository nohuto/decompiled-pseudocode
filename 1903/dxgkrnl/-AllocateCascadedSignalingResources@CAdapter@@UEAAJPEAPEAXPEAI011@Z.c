/*
 * XREFs of ?AllocateCascadedSignalingResources@CAdapter@@UEAAJPEAPEAXPEAI011@Z @ 0x1C005AC60
 * Callers:
 *     <none>
 * Callees:
 ...
 *     DxgkGetSharedSyncObjectType @ 0x1C012F1A0 (DxgkGetSharedSyncObjectType.c)
