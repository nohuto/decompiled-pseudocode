/*
 * XREFs of ?DxgkSetSyncRefreshCountWaitTargetInternal@@YAJIIII@Z @ 0x1C0100A10
 * Callers:
 ...
 *     ?SetSyncRefreshCountWaitTargetNonPaged@ADAPTER_DISPLAY@@QEAAXIIPEAE@Z @ 0x1C000BCC0 (-SetSyncRefreshCountWaitTargetNonPaged@ADAPTER_DISPLAY@@QEAAXIIPEAE@Z.c)
...
LABEL_71:
                      ...
                      v126 = -1;
                      if ( v100 && v101 )
                        DXGADAPTER::DecrementVSyncWaiter(v106);
                      if ( !v102 )
                      {
                        if ( v103 )
                        {
