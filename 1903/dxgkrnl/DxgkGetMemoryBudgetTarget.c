/*
 * XREFs of DxgkGetMemoryBudgetTarget @ 0x1C017D080
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall DxgkGetMemoryBudgetTarget(ULONG64 a1, __int64 a2, const GUID *a3)
{
  __int64 v4; // rdx
  __int64 v5; // rcx
  __int64 v6; // r8
  ...
  DXGETWPROFILER_BASE_PushProfilerEntry((__int64)&v39, 2144LL);
  if ( CheckTokenForResourceManagerAccess() )
  {
    ...
    if ( v42 >= 0x10 )
    {
      ...
      else
      {
        ...
        v22 = *((_DWORD *)v21 + 75977);
        v45 = v22;
        v23 = *((_DWORD *)v21 + 75978);
        v46 = v23;
