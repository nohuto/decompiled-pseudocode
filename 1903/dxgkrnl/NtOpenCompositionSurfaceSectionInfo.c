/*
 * XREFs of NtOpenCompositionSurfaceSectionInfo @ 0x1C005BC00
 * Callers:
 *     <none>
 * Callees:
        ...
        unsigned __int64 a4)
{
  ...
  CCompositionSurface *v19; // [rsp+88h] [rbp+10h] BYREF
  ...
  if ( v6 >= 0 )
  {
    ...
    if ( (*(unsigned int (__fastcall **)(_QWORD))(*((_QWORD *)Global + 38000) + 296LL))(*((_QWORD *)Global + 38000)) )
    {
      ...
      {
        v19 = 0LL;
        v6 = CompositionSurfaceObject::LockForRead((char *)Object, &v19);
        if ( v6 >= 0 )
        {
          v6 = CCompositionSurface::OpenSectionInfo(
                 ...
                 (struct CSM_SYSMEM_SECTION_INFO *)&v17);
