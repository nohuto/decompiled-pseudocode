/*
 * XREFs of ?PinFrameBufferForSave@DXGADAPTER@@QEAAJI_KPEAPEAU_MDL@@@Z @ 0x1C01ED9E0
 * Callers:
...
LABEL_3:
  ...
  v10 = *((_QWORD *)this + 305) + 352LL * (unsigned int)a2;
  MappedBase = 0LL;
  v11 = 0LL;
  ...
  if ( (int)v14 >= 0 )
  {
    ...
    if ( Mdl )
    {
      ...
      *(_QWORD *)(v10 + 96) = v11;
      *(_DWORD *)(v10 + 88) = 2;
      v23 = DpiAddMemoryTracker(*((_QWORD *)this + 24), (_QWORD *)(v10 + 72));
      v14 = v23;
      if ( v23 >= 0 )
      {
        *(_QWORD *)(v10 + 64) = v11;
