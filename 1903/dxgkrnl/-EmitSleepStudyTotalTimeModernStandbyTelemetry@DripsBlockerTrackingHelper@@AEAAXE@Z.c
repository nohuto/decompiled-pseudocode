/*
 * XREFs of ?EmitSleepStudyTotalTimeModernStandbyTelemetry@DripsBlockerTrackingHelper@@AEAAXE@Z @ 0x1C0242B1C
 * Callers:
        ...
        char a2)
{
  ...
  if ( dword_1C00A1888 > 5u )
  {
    if ( TlgKeywordOn((TraceLoggingHProvider)&dword_1C00A1888, 0x400000002000uLL) )
    {
      ...
      v14 = 50331648LL;
      v32 = v10 + 8;
      TlgWrite((TraceLoggingHProvider)&dword_1C00A1888, &unk_1C007372B, 0LL, v9, v10 + 8, &pData);
    }
  }
}
