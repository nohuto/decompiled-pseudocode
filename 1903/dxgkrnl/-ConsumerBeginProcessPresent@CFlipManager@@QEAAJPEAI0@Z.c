/*
 * XREFs of ?ConsumerBeginProcessPresent@CFlipManager@@QEAAJPEAI0@Z @ 0x1C0060AC4
 * Callers:
 ...
 *     ??2?$DXGQUOTAALLOCATOR@$00$0HFHAEDEG@@@SAPEAX_K@Z @ 0x1C0060758 (--2-$DXGQUOTAALLOCATOR@$00$0HFHAEDEG@@@SAPEAX_K@Z.c)
    ...
    if ( v11 >= 0 )
    {
      ...
      if ( v11 >= 0 )
      {
        CFlipPresentUpdate::SetFlipPropertySet(
          ...
          *(struct CFlipPropertySet **)(*((_QWORD *)this + 25) + 56LL));
        *((_QWORD *)this + 26) = v7;
        *a2 = *((_DWORD *)v7 + 10);
        v15 = *(_QWORD *)(*((_QWORD *)this + 26) + 56LL);
        if ( v15 )
          v3 = *(_DWORD *)(v15 + 32);
        *a3 = v3;
