/*
 * XREFs of DpiValidateSpbResource @ 0x1C02ADDD4
 * Callers:
 *     DpCloseSpbResource @ 0x1C02AD300 (DpCloseSpbResource.c)
 *     DpReadSpbResource @ 0x1C02AD6F0 (DpReadSpbResource.c)
 *     DpSpbResourceIoControl @ 0x1C02AD8A0 (DpSpbResourceIoControl.c)
 *     DpWriteSpbResource @ 0x1C02ADA80 (DpWriteSpbResource.c)
 * Callees:
 *     <none>
 */
...
__int64 __fastcall DpiValidateSpbResource(__int64 a1, __int64 a2, __int64 a3, char a4, __int64 *a5)
{
  ...
  if ( KeGetCurrentIrql() )
  {
    v8 = (_QWORD *)WdLogNewEntry5_WdCriticalError(a1, a2);
    v8[3] = 275LL;
    v8[4] = 21LL;
    v8[5] = a3;
    v8[6] = -1073741811LL;
