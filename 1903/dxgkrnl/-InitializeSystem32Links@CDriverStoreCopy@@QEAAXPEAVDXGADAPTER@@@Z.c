/*
 * XREFs of ?InitializeSystem32Links@CDriverStoreCopy@@QEAAXPEAVDXGADAPTER@@@Z @ 0x1C023B9A0
 * Callers:
...
void __fastcall CDriverStoreCopy::InitializeSystem32Links(CDriverStoreCopy *this, struct DXGADAPTER *a2)
{
  ...
  v22 = 0LL;
  PnpRegistryKeyName = DpiGetPnpRegistryKeyName(*((_QWORD *)a2 + 24), 3LL, (__int64 *)&v22);
  ...
  if ( PnpRegistryKeyName >= 0 )
  {
    ...
    if ( v10 >= 0 )
    {
      v14 = DpiGetPnpRegistryKeyName(*((_QWORD *)a2 + 24), 2LL, (__int64 *)&v22);
      v8 = v14;
      if ( v14 >= 0 )
      {
