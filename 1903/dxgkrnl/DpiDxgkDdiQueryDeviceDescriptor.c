/*
 * XREFs of DpiDxgkDdiQueryDeviceDescriptor @ 0x1C01580F0
 * Callers:
...
__int64 __fastcall DpiDxgkDdiQueryDeviceDescriptor(__int64 a1, __int64 a2, __int64 a3, unsigned int *a4)
{
  ...
  if ( bTracingEnabled && (Microsoft_Windows_DxgKrnlEnableBits & 0x40) != 0 )
    McTemplateK0qqbr1pqqp(a1, &EventEnterDdiQueryDeviceDescriptor, a3, 0, 0, 0LL, a2, a3, 0, 0);
  ...
  if ( bTracingEnabled )
  {
    ...
    if ( (Microsoft_Windows_DxgKrnlEnableBits & 0x40) != 0 )
      McTemplateK0qqbr1pqqp(v11, &EventExitDdiQueryDeviceDescriptor, v12, v4, v10, v11, a2, v5, v9, v11);
  }
