/*
 * XREFs of ?CopyPresentArgs@DXGPRESENT@@QEAAJPEAVDXGCONTEXT@@PEAU_D3DKMT_PRESENT@@@Z @ 0x1C010BE90
 * Callers:
 ...
 *     ?TranslateAndCopyDWMMoveRegionToDDAMoveRegions@@YAXKPEBU_D3DKMT_MOVE_RECT@@PEAU1@@Z @ 0x1C025BCBC (-TranslateAndCopyDWMMoveRegionToDDAMoveRegions@@YAXKPEBU_D3DKMT_MOVE_RECT@@PEAU1@@Z.c)
 */
...
__int64 __fastcall DXGPRESENT::CopyPresentArgs(DXGPRESENT *this, struct DXGCONTEXT *a2, struct _D3DKMT_PRESENT *a3)
{
  ...
  {
    v36 = WdLogNewEntry5_WdWarning(0xFFFFFFFFLL, DirtyRectCount, v9);
    *(_QWORD *)(v36 + 24) = 11020LL;
    goto LABEL_74;
  }
  if ( v21 + (unsigned int)v19 < v21 )
  {
    v36 = WdLogNewEntry5_WdWarning(0xFFFFFFFFLL, DirtyRectCount, v9);
    *(_QWORD *)(v36 + 24) = 11028LL;
LABEL_74:
