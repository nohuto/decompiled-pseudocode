/*
 * XREFs of ?VmBusFlushAdapter@DXG_HOST_VIRTUALGPU_VMBUS@@SAEPEAUDXGADAPTER_VMBUS_PACKET@@@Z @ 0x1C021EF20
 * Callers:
 *     <none>
 * Callees:
...
LABEL_4:
  ...
  if ( v24 )
  {
    ...
    v14 = v13 + 2;
    if ( (int)COREADAPTERACCESS::AcquireExclusive(&v27, (unsigned int)(v13 + 2), v13) >= 0 )
    {
      v15 = v14 + 1;
      v16 = *((_QWORD *)a1 + 5);
