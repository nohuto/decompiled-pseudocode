/*
 * XREFs of ?Feature_ReportWddm2_6ToDriver_Nvidia__private_IsEnabledPreCheck@@YAHXZ @ 0x1C004B4D8
 * Callers:
...
__int64 Feature_ReportWddm2_6ToDriver_Nvidia__private_IsEnabledPreCheck(void)
{
  ...
  wil_details_FeaturePropertyCache_ReportUsageToService(
    ...
    19673580LL,
    (const struct FEATURE_LOGGED_TRAITS *)&unk_1C00700B8,
    1,
    v1);
  return 1LL;
}
