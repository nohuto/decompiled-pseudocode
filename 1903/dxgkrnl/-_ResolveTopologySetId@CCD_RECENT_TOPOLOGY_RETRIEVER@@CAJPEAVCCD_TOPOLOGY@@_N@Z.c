/*
 * XREFs of ?_ResolveTopologySetId@CCD_RECENT_TOPOLOGY_RETRIEVER@@CAJPEAVCCD_TOPOLOGY@@_N@Z @ 0x1C00D3EC0
 * Callers:
...
__int64 __fastcall CCD_RECENT_TOPOLOGY_RETRIEVER::_ResolveTopologySetId(struct CCD_TOPOLOGY *a1, char a2)
{
  ...
  v12[1] = v2;
  v13 = a2;
  v4 = CCD_BTL_CLONE_GROUP_RESOLVER::operator()(v12);
  v8 = v4;
  if ( v4 == -1073741275 )
  {
  ...
  {
    v11 = (_QWORD *)WdLogNewEntry5_WdError(v6, v5, v7);
    v11[3] = v8;
    v11[4] = a1;
    v11[5] = *((_QWORD *)a1 + 8);
    v11[6] = a1;
