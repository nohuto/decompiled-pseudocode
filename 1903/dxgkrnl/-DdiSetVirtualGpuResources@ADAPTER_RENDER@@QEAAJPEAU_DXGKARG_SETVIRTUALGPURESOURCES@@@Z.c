/*
 * XREFs of ?DdiSetVirtualGpuResources@ADAPTER_RENDER@@QEAAJPEAU_DXGKARG_SETVIRTUALGPURESOURCES@@@Z @ 0x1C02140F8
 * Callers:
        ...
        const GUID *a3)
{
  ...
  DXGETWPROFILER_BASE_PushProfilerEntry((__int64)&v27, 5101LL);
...
LABEL_16:
  ...
  v15 = (*(int (__fastcall **)(_QWORD, struct _DXGKARG_SETVIRTUALGPURESOURCES *))(*(_QWORD *)(*((_QWORD *)this + 2)
                                                                                            + 928LL)
                                                                                + 80LL))(
  ...
  if ( (_DWORD)v15 != -1073741823 && (_DWORD)v15 != -1073741811 && (_DWORD)v15 )
  {
