/*
 * XREFs of ?TerminateAllocations@DXGDEVICE@@QEAAXPEAVDXGRESOURCE@@HPEAVDXGALLOCATION@@PEAVCOREDEVICEACCESS@@U_D3DDDICB_DESTROYALLOCATION2FLAGS@@@Z @ 0x1C0115460
 * Callers:
      ...
      *(_QWORD *)(v42 + 192) = 0LL;
          ...
          && !ExIsResourceAcquiredExclusiveLite(*(PERESOURCE *)(v46 + 144)) )
        {
          ...
          *((_BYTE *)a5 + 32) = 0;
          if ( KeGetCurrentThread() != *(struct _KTHREAD **)(v49 + 160) )
            DXGADAPTER::ReleaseCoreResource(v49, *((_DWORD *)a5 + 9), *((_QWORD *)a5 + 5));
          *((_DWORD *)a5 + 9) = -1;
          *((_QWORD *)a5 + 5) = 0LL;
        }
      }
      ...
      if ( v45 )
      {
        ...
        if ( KeGetCurrentThread() != *(struct _KTHREAD **)(v32 + 160) )
        {
          ...
          DXGADAPTER::AcquireCoreResourceShared(*((_QWORD *)a5 + 3), 0xFFFFFFFF, 0LL);
        }
        *((_DWORD *)a5 + 9) = -1;
        *((_QWORD *)a5 + 5) = 0LL;
        *((_BYTE *)a5 + 32) = 1;
