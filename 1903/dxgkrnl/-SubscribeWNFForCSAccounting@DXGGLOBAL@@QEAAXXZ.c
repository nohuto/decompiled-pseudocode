/*
 * XREFs of ?SubscribeWNFForCSAccounting@DXGGLOBAL@@QEAAXXZ @ 0x1C0246220
 * Callers:
...
void __fastcall DXGGLOBAL::SubscribeWNFForCSAccounting(PVOID *this)
{
  ...
  v3 = ExSubscribeWnfStateChange(this + 209, &v15, 1LL, 0LL, AccountingforCSCallBackFn, 0LL);
  v7 = v3;
  if ( v3 >= 0 )
  {
