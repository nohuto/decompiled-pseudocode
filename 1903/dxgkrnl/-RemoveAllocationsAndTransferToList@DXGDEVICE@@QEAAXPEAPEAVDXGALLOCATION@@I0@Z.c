/*
 * XREFs of ?RemoveAllocationsAndTransferToList@DXGDEVICE@@QEAAXPEAPEAVDXGALLOCATION@@I0@Z @ 0x1C014C8D4
 * Callers:
        ...
        struct DXGALLOCATION **a4)
{
  ...
  v5 = a3;
  DXGAUTOPUSHLOCK::DXGAUTOPUSHLOCK((DXGAUTOPUSHLOCK *)v16, this + 20, 0);
  v14 = 0LL;
  v15 = 0;
