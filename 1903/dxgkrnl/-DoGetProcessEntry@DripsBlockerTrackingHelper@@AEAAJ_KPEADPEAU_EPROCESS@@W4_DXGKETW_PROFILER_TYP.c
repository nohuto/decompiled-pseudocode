/*
 * XREFs of ?DoGetProcessEntry@DripsBlockerTrackingHelper@@AEAAJ_KPEADPEAU_EPROCESS@@W4_DXGKETW_PROFILER_TYPE@@PEAI4PEA_N@Z @ 0x1C0241DE4
 * Callers:
 *     ?AddGPUTimeToProcessEntry@DripsBlockerTrackingHelper@@QEAAJ_KPEAU_EPROCESS@@0W4_DXGKETW_PROFILER_TYPE@@@Z @ 0x1C02410C8 (-AddGPUTimeToProcessEntry@DripsBlockerTrackingHelper@@QEAAJ_KPEAU_EPROCESS@@0W4_DXGKETW_PROFILER.c)
 ...
 *     ?AddNewProcessEntry@DripsBlockerTrackingHelper@@AEAAJ_KPEADW4_DXGKETW_PROFILER_TYPE@@PEAI3@Z @ 0x1C02411B8 (-AddNewProcessEntry@DripsBlockerTrackingHelper@@AEAAJ_KPEADW4_DXGKETW_PROFILER_TYPE@@PEAI3@Z.c)
 *     ?AddNewReasonForProcessEntry@DripsBlockerTrackingHelper@@AEAAJ_KPEAD0W4_DXGKETW_PROFILER_TYPE@@PEAI3@Z @ 0x1C024123C (-AddNewReasonForProcessEntry@DripsBlockerTrackingHelper@@AEAAJ_KPEAD0W4_DXGKETW_PROFILER_TYPE@@P.c)
