/*
 * XREFs of ?HandleMonitorDepartureCase@@YAJQEAUMONITORSCOUNT_CALLBACK_CONTEXT@@AEBU_LUID@@IW4MONITOR_EVENT@@_KPEAU_DXGK_DISPLAY_SCENARIO_CONTEXT@@@Z @ 0x1C026F434
 * Callers:
        ...
        struct _DXGK_DISPLAY_SCENARIO_CONTEXT *a6)
{
  ...
  if ( a4 != 10 || a5 != 2 )
  {
    ...
    v39 = DxgkInvalidateMonitorConnections(2LL);
    v25 = 0;
    v41 = v39;
    if ( v39 < 0 )
    {
