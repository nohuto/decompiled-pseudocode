/*
 * XREFs of DxgkMiracastGetNextChunkInfo @ 0x1C004E440
 * Callers:
 ...
 *     DpiMiracastGetDeviceContextFromLuid @ 0x1C004C384 (DpiMiracastGetDeviceContextFromLuid.c)
...
LABEL_20:
  KeReleaseInStackQueuedSpinLock(&LockHandle);
  if ( v14 )
    DpiMiracastReleaseMiracastDeviceContext((int *)v14, v14, v22);
