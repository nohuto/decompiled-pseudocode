/*
 * XREFs of DpiDxgkDdiDisplayDetectControl @ 0x1C0157300
 * Callers:
 ...
 *     DpiFdoInvalidateChildStatus @ 0x1C02A1864 (DpiFdoInvalidateChildStatus.c)
...
__int64 __fastcall DpiDxgkDdiDisplayDetectControl(__int64 a1, __int64 a2, __int64 a3, unsigned int *a4)
{
  ...
  if ( bTracingEnabled )
  {
    ...
    {
      LODWORD(v27) = v10;
      LODWORD(v26) = (*a4 & 0x10000000) != 0;
      LODWORD(v25) = *a4 & 0xFFFFFF;
      LODWORD(v24) = HIBYTE(*a4) & 0xF;
      McTemplateK0pqtqq(v12, &EventExitDdiDisplayDetectControl, (const GUID *)(unsigned int)v25, a3, v24, v25, v26, v27);
    }
  }
  ...
  if ( *((_BYTE *)a4 + 18) )
  {
    LOBYTE(v16) = *((_BYTE *)a4 + 16);
    if ( (*a4 & 0xF000000) != 0x2000000 || !(_BYTE)v16 )
      v9 = 0;
    LOBYTE(v15) = v9;
    ConnectionChanges = DxgkQueryConnectionChanges(*(_QWORD *)(a1 + 24), v15, v16, *((_BYTE *)a4 + 17), 0);
