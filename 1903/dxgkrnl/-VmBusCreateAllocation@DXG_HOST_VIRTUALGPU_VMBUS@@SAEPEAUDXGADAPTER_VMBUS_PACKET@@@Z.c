/*
 * XREFs of ?VmBusCreateAllocation@DXG_HOST_VIRTUALGPU_VMBUS@@SAEPEAUDXGADAPTER_VMBUS_PACKET@@@Z @ 0x1C021BD00
 * Callers:
 *     <none>
 * Callees:
...
LABEL_67:
  ...
  *((_DWORD *)&v87.Flags + 1) = 0;
  ...
  v43 = DxgkCreateAllocationInternal(&v87, (struct DXGALLOCATION **)v83, v37);
  v47 = v43;
  if ( v43 < 0 )
  {
