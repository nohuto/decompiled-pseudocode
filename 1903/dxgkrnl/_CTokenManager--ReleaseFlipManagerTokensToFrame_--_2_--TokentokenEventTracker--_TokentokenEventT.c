/*
 * XREFs of _CTokenManager::ReleaseFlipManagerTokensToFrame_::_2_::TokentokenEventTracker::_TokentokenEventTracker @ 0x1C0059CF0
 * Callers:
        ...
        __int64 a2)
{
  ...
  return (*(__int64 (__fastcall **)(_QWORD, _QWORD))(*((_QWORD *)Global + 38000) + 96LL))(
           *(_QWORD *)a1,
           *(unsigned int *)(a1 + 8));
}
