/*
 * XREFs of ??1CFlipPresentUpdate@@UEAA@XZ @ 0x1C006418C
 * Callers:
 *     ??_GCFlipPresentUpdate@@UEAAPEAXI@Z @ 0x1C0060790 (--_GCFlipPresentUpdate@@UEAAPEAXI@Z.c)
 * Callees:
 *     ?Release@CFlipPropertySetBase@@QEAAKXZ @ 0x1C005E998 (-Release@CFlipPropertySetBase@@QEAAKXZ.c)
 *     ??1CFlipTokenOperation@@MEAA@XZ @ 0x1C0061CF4 (--1CFlipTokenOperation@@MEAA@XZ.c)
 */
