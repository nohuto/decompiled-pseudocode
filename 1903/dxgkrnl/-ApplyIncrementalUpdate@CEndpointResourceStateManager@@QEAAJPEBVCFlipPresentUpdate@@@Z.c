/*
 * XREFs of ?ApplyIncrementalUpdate@CEndpointResourceStateManager@@QEAAJPEBVCFlipPresentUpdate@@@Z @ 0x1C0061FA8
 * Callers:
 ...
 *     ??2?$DXGQUOTAALLOCATOR@$00$0HDHCEDEG@@@SAPEAX_K@Z @ 0x1C0061E8C (--2-$DXGQUOTAALLOCATOR@$00$0HDHCEDEG@@@SAPEAX_K@Z.c)
 *     ?Dequeue@?$CFlipObjectQueue@VCPoolBufferResourceState@@@@QEAAPEAVCPoolBufferResourceState@@XZ @ 0x1C0062474 (-Dequeue@-$CFlipObjectQueue@VCPoolBufferResourceState@@@@QEAAPEAVCPoolBufferResourceState@@XZ.c)
