/*
 * XREFs of ?_PnPTargetDeviceChangeNotification@DXGMONITOR@@CAJPEAX0@Z @ 0x1C02CE290
 * Callers:
 *     <none>
 * Callees:
 ...
 *     ?_OnMonitorFunctionDriverDeparture@DXGMONITOR@@QEAAJPEAU_DXGK_DISPLAY_SCENARIO_CONTEXT@@@Z @ 0x1C02CE1F0 (-_OnMonitorFunctionDriverDeparture@DXGMONITOR@@QEAAJPEAU_DXGK_DISPLAY_SCENARIO_CONTEXT@@@Z.c)
        ...
        struct _DEVICE_OBJECT *Context)
{
  ...
  *(_QWORD *)(v6 + 32) = NotificationStructure;
  if ( NotificationStructure && Context )
  {
    ...
    v18 = COREADAPTERACCESS::AcquireExclusive(&v59, (unsigned int)(v17 + 1), v17);
    if ( v18 >= 0 )
    {
      v24 = *((_QWORD *)v15 + 319);
      if ( !v24 )
