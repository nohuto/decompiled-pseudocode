/*
 * XREFs of ?ClipRects@DXGPRESENT@@SAHPEAUtagRECT@@0PEBU2@1@Z @ 0x1C014D550
 * Callers:
 ...
 * Callees:
 *     ?ClipIntervals@DXGPRESENT@@CAXPEAJ000JJ@Z @ 0x1C0258DA4 (-ClipIntervals@DXGPRESENT@@CAXPEAJ000JJ@Z.c)
