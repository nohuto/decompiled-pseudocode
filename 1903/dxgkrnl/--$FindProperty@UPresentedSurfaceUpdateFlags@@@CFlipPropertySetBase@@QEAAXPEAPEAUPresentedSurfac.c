/*
 * XREFs of ??$FindProperty@UPresentedSurfaceUpdateFlags@@@CFlipPropertySetBase@@QEAAXPEAPEAUPresentedSurfaceUpdateFlags@@@Z @ 0x1C0061DB8
 * Callers:
...
void __fastcall CFlipPropertySetBase::FindProperty<PresentedSurfaceUpdateFlags>(__int64 a1, _QWORD *a2)
{
  unsigned int v2; // r9d
