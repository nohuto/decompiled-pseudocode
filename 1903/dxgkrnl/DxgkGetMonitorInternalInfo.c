/*
 * XREFs of DxgkGetMonitorInternalInfo @ 0x1C00E7750
 * Callers:
 *     <none>
 * Callees:
...
LABEL_16:
            ...
            *(_WORD *)&v100[3] = 0;
            ...
            LODWORD(v102) = MonitorGetAdvancedColorParams(MonitorHandle, &v100[3], (__int64)v109, (__int64)&v101);
...
LABEL_87:
            ...
            wil_details_FeaturePropertyCache_ReportUsageToService(
              ...
              1,
              v98);
            if ( (int)MonitorGetNativeFlags(MonitorHandle, v100, (bool *)&v100[3], (bool *)&v99) >= 0 )
...
LABEL_19:
              *(_QWORD *)&v100[3] = 0LL;
              MonitorGetMonitorOrientationsFromMonitor(MonitorHandle, &v100[7], &v100[3]);
              v44 = v100[7];
              v45 = *(_DWORD *)&v100[3];
              if ( v110 )
              {
