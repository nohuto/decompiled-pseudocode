/*
 * XREFs of ?DdiStopCapture@ADAPTER_RENDER@@QEAAJPEAU_DXGKARG_STOPCAPTURE@@@Z @ 0x1C01FEF24
 * Callers:
 *     ?ADAPTER_RENDER_DdiStopCapture@@YAJPEAVADAPTER_RENDER@@PEAU_DXGKARG_STOPCAPTURE@@@Z @ 0x1C003DFC0 (-ADAPTER_RENDER_DdiStopCapture@@YAJPEAVADAPTER_RENDER@@PEAU_DXGKARG_STOPCAPTURE@@@Z.c)
 * Callees:
...
__int64 __fastcall ADAPTER_RENDER::DdiStopCapture(
        ADAPTER_RENDER *this,
        struct _DXGKARG_STOPCAPTURE *a2,
        const GUID *a3)
{
  __int64 v5; // rdx
  __int64 v6; // rcx
  ...
  _QWORD *v19; // rax
  __int64 v20; // rcx
  struct _DXGKARG_STOPCAPTURE *v21; // rax
  __int64 v22; // r8
  void *v23; // rdx
  ...
  if ( (*(_BYTE *)(&DxgkControlGuid_Context + 2) & 2) != 0 )
  {
    ...
    if ( (Microsoft_Windows_DxgKrnlEnableBits & 0x2000) != 0 )
      McTemplateK0q((__int64)this, &EventProfilerEnter, a3, 5039);
  }
  else
  {
    v32 = 0;
  }
  DXGETWPROFILER_BASE_PushProfilerEntry((__int64)&v30, 5039LL);
...
LABEL_16:
  ...
  v15 = (void *)(*(int (__fastcall **)(_QWORD, struct _DXGKARG_STOPCAPTURE *))(*((_QWORD *)this + 2) + 552LL))(
  ...
  v21 = (struct _DXGKARG_STOPCAPTURE *)WdLogNewEntry5_WdTrace(v16, v14);
  v21[3].hAllocation = v15;
  v23 = *(void **)(*((_QWORD *)this + 2) + 248LL);
  v21[4].hAllocation = v23;
  hAllocation = a2->hAllocation;
  v21[5].hAllocation = a2->hAllocation;
  if ( (_DWORD)v15 )
  {
    v25 = WdLogNewEntry5_WdError(hAllocation, v23, v22);
    *(_QWORD *)(v25 + 24) = v15;
