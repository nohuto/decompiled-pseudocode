/*
 * XREFs of ?ReleaseReference@DXGHWQUEUE@@QEAAXXZ @ 0x1C0024098
 * Callers:
...
void __fastcall DXGHWQUEUE::ReleaseReference(DXGHWQUEUE *this, __int64 a2)
{
  ...
  v3 = _InterlockedDecrement64((volatile signed __int64 *)this + 9);
  if ( v3 < 0 )
  {
  ...
  if ( !v3 )
  {
    ...
    if ( *(_DWORD *)(*(_QWORD *)(*((_QWORD *)v6 + 2) + 16LL) + 176LL) != 4 )
      DXGCONTEXT::DestroyHwQueue((DXGCONTEXT *)v5, this, (struct COREDEVICEACCESS *)v20);
