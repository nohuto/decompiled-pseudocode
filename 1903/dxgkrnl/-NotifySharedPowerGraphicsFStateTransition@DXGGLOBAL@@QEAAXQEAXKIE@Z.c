/*
 * XREFs of ?NotifySharedPowerGraphicsFStateTransition@DXGGLOBAL@@QEAAXQEAXKIE@Z @ 0x1C0042074
 * Callers:
        ...
        char a5)
{
  ...
  {
    KeAcquireInStackQueuedSpinLockAtDpcLevel(this + 171, &LockHandle);
  }
  else if ( (struct _KTHREAD *)this[173] != KeGetCurrentThread() )
  {
    DXGPUSHLOCK::AcquireShared((DXGPUSHLOCK *)(this + 172));
    v9 = 1;
  }
  for ( i = this[175]; (KSPIN_LOCK *)i != this + 175 && i; i = *(_QWORD *)i )
  {
  ...
  {
    ExReleasePushLockSharedEx(this + 172, 0LL);
