/*
 * XREFs of ?BmlGetTargetModePreferenceOnMonitor@@YA?AW4BML_MONITOR_SOURCE_MODE_PREFERENCE@@PEBVDMMVIDPNTARGETMODE@@EPEAVDMMVIDEOPRESENTTARGET@@@Z @ 0x1C0137C10
 * Callers:
 *     BmlCompareTargetModesWithMonitor @ 0x1C0137BA0 (BmlCompareTargetModesWithMonitor.c)
 * Callees:
