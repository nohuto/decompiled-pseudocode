/*
 * XREFs of ?ProcessStatusChange@DXGPROCESS@@IEAAXXZ @ 0x1C011E214
 * Callers:
 *     ?DxgkpProcessStatusChangeWork@@YAXPEAX@Z @ 0x1C011E1F0 (-DxgkpProcessStatusChangeWork@@YAXPEAX@Z.c)
 * Callees:
