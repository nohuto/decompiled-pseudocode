/*
 * XREFs of ?WriteDxgDiagnosticsEvent_CODE_POINT_ADAPTERLUID@@YAXPEAU_DXGK_DIAG_HEADER@@@Z @ 0x1C0003268
 * Callers:
    ...
    switch ( v4 )
    {
      case 'D':
          ...
          && TlgKeywordOn((TraceLoggingHProvider)&hProvider, 0x400000000010uLL) )
        {
          ...
          v30 = 4LL;
          v32 = 4LL;
          TlgWrite((TraceLoggingHProvider)&hProvider, &unk_1C00730FD, 0LL, v12, 9u, &pData);
        }
        break;
      case 'X':
        if ( v3 > 4 && TlgKeywordOn((TraceLoggingHProvider)&hProvider, 0x400000000010uLL) )
        {
          ...
          v26 = 4LL;
          v28 = 4LL;
          TlgWrite((TraceLoggingHProvider)&hProvider, &unk_1C007325E, 0LL, v11, 7u, &pData);
        }
        break;
      case '`':
        if ( v3 > 4 && TlgKeywordOn((TraceLoggingHProvider)&hProvider, 0x400000000010uLL) )
        {
          ...
          v26 = 4LL;
          v28 = 4LL;
          TlgWrite((TraceLoggingHProvider)&hProvider, &unk_1C00731F8, 0LL, v10, 7u, &pData);
        }
        break;
      case 'b':
        if ( *((int *)a1 + 14) < 0 && v3 > 4 && TlgKeywordOn((TraceLoggingHProvider)&hProvider, 0x400000000010uLL) )
        {
          ...
          v25 = v9;
          v26 = 4LL;
          TlgWrite((TraceLoggingHProvider)&hProvider, &unk_1C0073184, 0LL, v9, 6u, &pData);
        }
        break;
      default:
        if ( v4 == 104 && v3 > 4 )
        {
          if ( TlgKeywordOn((TraceLoggingHProvider)&hProvider, 0x400000000010uLL) )
          {
            ...
            v26 = 4LL;
            v28 = 4LL;
            TlgWrite((TraceLoggingHProvider)&hProvider, &unk_1C00730A6, 0LL, v8, 7u, &pData);
          }
        }
        break;
    }
