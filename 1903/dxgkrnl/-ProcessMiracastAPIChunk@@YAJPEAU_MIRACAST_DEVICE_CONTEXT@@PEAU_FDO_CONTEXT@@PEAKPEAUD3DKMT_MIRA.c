/*
 * XREFs of ?ProcessMiracastAPIChunk@@YAJPEAU_MIRACAST_DEVICE_CONTEXT@@PEAU_FDO_CONTEXT@@PEAKPEAUD3DKMT_MIRACAST_CHUNK_DATA@@2@Z @ 0x1C004C0AC
 * Callers:
        ...
        unsigned int *a5)
{
  ...
  else
  {
    ...
    if ( v13 )
    {
      ...
      {
        v15 = WdLogNewEntry5_WdError(v12, v13, a3);
        *(_QWORD *)(v15 + 32) = v14;
        *(_QWORD *)(v15 + 24) = v6;
