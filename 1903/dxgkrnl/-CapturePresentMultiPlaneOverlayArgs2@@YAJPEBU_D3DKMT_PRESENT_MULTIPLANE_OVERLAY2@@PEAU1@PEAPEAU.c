/*
 * XREFs of ?CapturePresentMultiPlaneOverlayArgs2@@YAJPEBU_D3DKMT_PRESENT_MULTIPLANE_OVERLAY2@@PEAU1@PEAPEAU_D3DKMT_MULTIPLANE_OVERLAY2@@PEAPEAUtagRECT@@@Z @ 0x1C027E87C
 * Callers:
        ...
        struct tagRECT **a4)
{
  ...
  *v7 = *(_OWORD *)&a1->hAdapter;
  ...
  if ( v30 - 1 > 6 )
  {
    v26 = (_QWORD *)WdLogNewEntry5_WdError(a1, 0LL, 128LL);
    v26[3] = v10;
    v18 = -1073741811;
    v26[4] = -1073741811LL;
  ...
  if ( v11 > 0xFFFFFFFF )
  {
    v25 = WdLogNewEntry5_WdWarning(v30, 0LL, 128LL);
    *(_QWORD *)(v25 + 24) = 186LL;
