/*
 * XREFs of ?_FillTargetInfoMonitorsCallback@CCD_TOPOLOGY@@CAJPEAX0IW4_DMM_VIDPN_MONITOR_TYPE@@EE@Z @ 0x1C00D8590
 * Callers:
 *     <none>
 * Callees:
        ...
        char a6)
{
  ...
  for ( i = 0; ; ++i )
  {
    ...
    if ( *((_DWORD *)PathDescriptor + 7) == a3
      && *((_DWORD *)PathDescriptor + 4) == *(_DWORD *)(a1 + 276)
      && *((_DWORD *)PathDescriptor + 5) == *(_DWORD *)(a1 + 280) )
    {
      if ( a5 )
