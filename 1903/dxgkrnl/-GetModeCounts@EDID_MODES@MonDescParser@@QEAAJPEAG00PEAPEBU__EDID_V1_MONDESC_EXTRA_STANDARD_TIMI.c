/*
 * XREFs of ?GetModeCounts@EDID_MODES@MonDescParser@@QEAAJPEAG00PEAPEBU__EDID_V1_MONDESC_EXTRA_STANDARD_TIMINGS@@00@Z @ 0x1C0021400
 * Callers:
 ...
 * Callees:
 *     ?Is18ByteDispDesc@EDID_PARSER@MonDescParser@@QEBA_NH@Z @ 0x1C0002330 (-Is18ByteDispDesc@EDID_PARSER@MonDescParser@@QEBA_NH@Z.c)
 *     ?Is18ByteDetTim@EDID_PARSER@MonDescParser@@QEBA_NH@Z @ 0x1C00026B8 (-Is18ByteDetTim@EDID_PARSER@MonDescParser@@QEBA_NH@Z.c)
 ...
 *     ?DenseOnesBitCount@MonDescParser@@YAEE@Z @ 0x1C002160C (-DenseOnesBitCount@MonDescParser@@YAEE@Z.c)
 *     ?GetBlockType@EDID_PARSER@MonDescParser@@QEBA?AW4EDID_V1_BLOCK_TYPE@2@I@Z @ 0x1C0021674 (-GetBlockType@EDID_PARSER@MonDescParser@@QEBA-AW4EDID_V1_BLOCK_TYPE@2@I@Z.c)
 *     ?ChangeCEABlock@EDID_PARSER_CEA_861_EXT@MonDescParser@@QEAAXPEAT_EDID_V1_BLOCK@@@Z @ 0x1C0058158 (-ChangeCEABlock@EDID_PARSER_CEA_861_EXT@MonDescParser@@QEAAXPEAT_EDID_V1_BLOCK@@@Z.c)
 *     ?GetDataBlock@EDID_PARSER_CEA_861_EXT@MonDescParser@@QEAA_NIPEAPEAU_EDID_V1_CEA_861_DATA_HEADER@@@Z @ 0x1C00581A0 (-GetDataBlock@EDID_PARSER_CEA_861_EXT@MonDescParser@@QEAA_NIPEAPEAU_EDID_V1_CEA_861_DATA_HEADER@.c)
 *     ?GetDetTimParser@EDID_PARSER_CEA_861_EXT@MonDescParser@@QEAA_NHAEAVEDID_PARSER_DETAILED_TIMING@2@@Z @ 0x1C0058204 (-GetDetTimParser@EDID_PARSER_CEA_861_EXT@MonDescParser@@QEAA_NHAEAVEDID_PARSER_DETAILED_TIMING@2.c)
 */
        ...
        unsigned __int16 *a7)
{
  ...
  const struct __EDID_V1_MONDESC_EXTRA_STANDARD_TIMINGS *v41; // r8
  ...
  v41 = (MonDescParser *)((char *)v14 + 18 * v30 + 59);
  if ( a4 )
  {
    for ( j = 0; j < 6u; ++j )
    {
...
LABEL_20:
  if ( a6 )
  {
    for ( k = 0; k < 4; k = v35 + 1 )
    {
      v33 = MonDescParser::EDID_PARSER::Is18ByteDetTim((MonDescParser::EDID_PARSER *)v7, k);
      v37 = v34 + 1;
      if ( !v33 )
        v37 = v34;
    }
  ...
  if ( a7 )
  {
    ...
    *a7 = 0;
    if ( *((_DWORD *)v7 + 20) )
    {
      do
      {
        if ( (unsigned int)MonDescParser::EDID_PARSER::GetBlockType(v7, v39) == 2 )
        {
          v44 = 0;
          v45 = &v7[(_QWORD)v7[10]];
          if ( v7 == v45 )
