/*
 * XREFs of ?SetBoundBuffer@CContentResourceState@@QEAAXPEAVCPoolBufferResource@@@Z @ 0x1C00640EC
 * Callers:
 ...
 *     ?RemoveUsageReference@CPoolBufferResource@@QEAAXXZ @ 0x1C006379C (-RemoveUsageReference@CPoolBufferResource@@QEAAXXZ.c)
 */
