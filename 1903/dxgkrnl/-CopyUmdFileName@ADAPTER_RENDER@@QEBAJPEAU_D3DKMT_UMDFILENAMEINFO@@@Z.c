/*
 * XREFs of ?CopyUmdFileName@ADAPTER_RENDER@@QEBAJPEAU_D3DKMT_UMDFILENAMEINFO@@@Z @ 0x1C00E97D8
 * Callers:
 ...
 *     ?IsNullUmdDriver@@YAHAEBU_UNICODE_STRING@@@Z @ 0x1C00E9820 (-IsNullUmdDriver@@YAHAEBU_UNICODE_STRING@@@Z.c)
