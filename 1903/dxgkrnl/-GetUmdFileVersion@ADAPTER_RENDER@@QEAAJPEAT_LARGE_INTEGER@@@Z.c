/*
 * XREFs of ?GetUmdFileVersion@ADAPTER_RENDER@@QEAAJPEAT_LARGE_INTEGER@@@Z @ 0x1C00E8C88
 * Callers:
...
__int64 __fastcall ADAPTER_RENDER::GetUmdFileVersion(union _LARGE_INTEGER *this, union _LARGE_INTEGER *a2)
{
  ...
  *(_QWORD *)&Destination.Length = 0LL;
  ...
  do
  {
    UMDFileName = ADAPTER_RENDER::GetUMDFileName((ADAPTER_RENDER *)this, (enum _KMTUMDVERSION)v6);
  ...
  v9 = ADAPTER_RENDER::GetUMDFileName((ADAPTER_RENDER *)this, (enum _KMTUMDVERSION)v6);
