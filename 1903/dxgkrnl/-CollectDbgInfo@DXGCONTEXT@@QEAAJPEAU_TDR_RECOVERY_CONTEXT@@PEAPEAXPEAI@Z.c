/*
 * XREFs of ?CollectDbgInfo@DXGCONTEXT@@QEAAJPEAU_TDR_RECOVERY_CONTEXT@@PEAPEAXPEAI@Z @ 0x1C020D718
 * Callers:
        ...
        unsigned int *a4)
{
  ...
  *((_DWORD *)v11 + 10) = *((_DWORD *)this + 100);
  *((_DWORD *)v11 + 11) = *((_DWORD *)this + 101);
  *((_DWORD *)v11 + 12) = *((_DWORD *)this + 103);
  *((_DWORD *)v11 + 13) = *((_DWORD *)this + 108);
  *((_DWORD *)v11 + 14) = *((_DWORD *)this + 109);
  *((_DWORD *)v11 + 15) = *((_DWORD *)this + 110);
  *a3 = (char *)*a3 + 64;
  *a4 -= 64;
  return 0LL;
}
