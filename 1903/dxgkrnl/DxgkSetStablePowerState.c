/*
 * XREFs of DxgkSetStablePowerState @ 0x1C02604D0
 * Callers:
 *     <none>
 * Callees:
 ...
 *     ?ReleaseStablePowerReference@ADAPTER_RENDER@@QEAAXXZ @ 0x1C01F5C78 (-ReleaseStablePowerReference@ADAPTER_RENDER@@QEAAXXZ.c)
 */
