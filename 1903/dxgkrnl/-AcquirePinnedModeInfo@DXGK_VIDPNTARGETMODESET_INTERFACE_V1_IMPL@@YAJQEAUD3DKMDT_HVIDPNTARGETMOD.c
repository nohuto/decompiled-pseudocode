/*
 * XREFs of ?AcquirePinnedModeInfo@DXGK_VIDPNTARGETMODESET_INTERFACE_V1_IMPL@@YAJQEAUD3DKMDT_HVIDPNTARGETMODESET__@@PEAPEBU_D3DKMDT_VIDPN_TARGET_MODE@@@Z @ 0x1C00E6920
 * Callers:
 *     <none>
 * Callees:
...
{
  DXGK_VIDPNTARGETMODESET_INTERFACE_V1_IMPL *v4; // rbx
  __int64 v5; // rcx
  const GUID *v6; // r8
  __int64 v7; // rdx
  __int64 v8; // rcx
  ...
  DXGK_VIDPNTARGETMODESET_INTERFACE_V1_IMPL *v34; // [rsp+60h] [rbp+10h] BYREF
  ...
  DXGETWPROFILER_BASE_PushProfilerEntry((__int64)&v31, 7011LL);
    ...
    *(_QWORD *)a2 = 0LL;
    ...
    if ( v13 )
    {
      ...
      v14 = DMMVIDPNTARGETMODESET::AcquireDdiEnumeratorCachedModeInfo<KM_STL::mem_fun_t<DMMVIDPNTARGETMODE *,DMMVIDPNTARGETMODESET>>(
              ...
              &v29,
              &v34);
      v4 = (DXGK_VIDPNTARGETMODESET_INTERFACE_V1_IMPL *)v14;
      if ( v14 == -1071774902 )
      {
