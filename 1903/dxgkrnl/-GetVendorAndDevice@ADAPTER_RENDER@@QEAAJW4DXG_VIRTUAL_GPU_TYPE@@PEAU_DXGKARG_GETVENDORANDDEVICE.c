/*
 * XREFs of ?GetVendorAndDevice@ADAPTER_RENDER@@QEAAJW4DXG_VIRTUAL_GPU_TYPE@@PEAU_DXGKARG_GETVENDORANDDEVICE@@@Z @ 0x1C020ED84
 * Callers:
...
__int64 __fastcall ADAPTER_RENDER::GetVendorAndDevice(__int64 a1, int a2, unsigned int *a3)
{
  __int64 v6; // rdx
  __int64 v7; // r8
  __int64 v8; // rdx
  ...
  {
    v11 = (*(__int64 (__fastcall **)(struct DXGK_VIRTUAL_GPU *, unsigned int *))(*(_QWORD *)VirtualGpuByIndex + 80LL))(
            VirtualGpuByIndex,
            a3);
  }
  else
