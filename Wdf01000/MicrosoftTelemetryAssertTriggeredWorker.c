/*
 * XREFs of MicrosoftTelemetryAssertTriggeredWorker @ 0x1C0086CD4
 * Callers:
 ...
 *     GetImageTuple @ 0x1C0086B8C (GetImageTuple.c)
 *     _tlgCreate1Sz_char @ 0x1C00873D4 (_tlgCreate1Sz_char.c)
 */
