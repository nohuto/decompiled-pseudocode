/*
 * XREFs of ?PowerPolWokeFromS0@FxPkgPnp@@KA?AW4_WDF_DEVICE_POWER_POLICY_STATE@@PEAV1@@Z @ 0x1C0010050
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall FxPkgPnp::PowerPolWokeFromS0(FxPkgPnp *This)
{
  ...
  v2 = FxPkgPnp::PowerPolicySendDevicePowerRequest(This, PowerDeviceD0, Retry, RequestD0ForDeviceWake);
  v3 = 1472;
  if ( v2 < 0 )
    return 1389;
  return v3;
