/*
 * XREFs of ?InvokeCxCallback@FxPnpDeviceD0ExitPreHwDisabled@@MEAAJPEAVFxCxPnpPowerCallbackContext@@W4FxCxInvokeCallbackSubType@@@Z @ 0x1C006D2B0
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall FxPnpDeviceD0ExitPreHwDisabled::InvokeCxCallback(
