/*
 * XREFs of ?InterruptDisableInvokeCallback@FxInterrupt@@AEAAJXZ @ 0x1C007F5D4
 * Callers:
 *     ?_InterruptDisableThunk@FxInterrupt@@CAEPEAX@Z @ 0x1C007FAB0 (-_InterruptDisableThunk@FxInterrupt@@CAEPEAX@Z.c)
 * Callees:
