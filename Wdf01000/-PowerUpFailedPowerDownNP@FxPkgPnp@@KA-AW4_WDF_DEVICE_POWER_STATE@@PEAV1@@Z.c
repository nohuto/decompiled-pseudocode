/*
 * XREFs of ?PowerUpFailedPowerDownNP@FxPkgPnp@@KA?AW4_WDF_DEVICE_POWER_STATE@@PEAV1@@Z @ 0x1C0070180
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall FxPkgPnp::PowerUpFailedPowerDownNP(FxPkgPnp *This)
{
