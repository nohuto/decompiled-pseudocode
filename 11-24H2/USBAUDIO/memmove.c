 ...
 *     USBDInternal_BuildServicePath @ 0x140018C08 (USBDInternal_BuildServicePath.c)
 *     RaiseException @ 0x14001B4D0 (RaiseException.c)
 *     USBHwGetDeviceIDString @ 0x14002D384 (USBHwGetDeviceIDString.c)
 *     DriverCopyRegistryString @ 0x14002D9CC (DriverCopyRegistryString.c)
 *     USBHwLogStartFailure @ 0x14002DBBC (USBHwLogStartFailure.c)
 *     WppTraceCallback @ 0x14002FCD0 (WppTraceCallback.c)
 *     PropertyGetMicArrayGeometry @ 0x1400327D0 (PropertyGetMicArrayGeometry.c)
 *     RegistryGetValue @ 0x1400341E8 (RegistryGetValue.c)
 *     WmiQueryRegInfo @ 0x140034A00 (WmiQueryRegInfo.c)
 ...
 *     USBCaptureCopyRequestToBuffer @ 0x14003A260 (USBCaptureCopyRequestToBuffer.c)
