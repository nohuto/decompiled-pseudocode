/*
 * XREFs of ?GetVolumePropertyBasicSupport@CSidebandDevice@@AEAAJKPEAKPEAX@Z @ 0x14001178C
 * Callers:
 ...
 *     PropertyGetDbBasicSupportSideband @ 0x1400324F4 (PropertyGetDbBasicSupportSideband.c)
 */
        ...
        void *a4)
{
  ...
  if ( PinFromEpIndex >= 0 )
  {
    ...
    if ( PinFromEpIndex >= 0 )
    {
      ...
      if ( PinFromEpIndex >= 0 )
      {
        PinFromEpIndex = PropertyGetDbBasicSupportSideband(*(_QWORD *)(v9 + 200) + *(_DWORD *)(v9 + 196) * v19, v5, a4);
        if ( PinFromEpIndex >= 0 )
          goto LABEL_44;
