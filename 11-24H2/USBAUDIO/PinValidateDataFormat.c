/*
 * XREFs of PinValidateDataFormat @ 0x14003B108
 * Callers:
 ...
 *     PinMIDIDataFormatIntersection @ 0x140030C90 (PinMIDIDataFormatIntersection.c)
          ...
          if ( *(_DWORD *)(a2 + 64) == v11 )
          {
            ...
            if ( *(_DWORD *)(a2 + 72) == v13 )
            {
              if ( (unsigned __int8)IsSampleRateInRange(a2, *(unsigned int *)(a3 + 68)) )
              {
                ...
                {
                  if ( *(unsigned __int16 *)(a3 + 82) == *(_DWORD *)(v14 + 104)
