/*
 * XREFs of PropertyGetProcessControlRange @ 0x140032C34
 * Callers:
 *     TopologyPU3DExtender @ 0x140030FA0 (TopologyPU3DExtender.c)
 *     TopologyPUChorus @ 0x140031090 (TopologyPUChorus.c)
 *     TopologyPUDynRangeCompressor @ 0x140031210 (TopologyPUDynRangeCompressor.c)
 *     TopologyPUReverb @ 0x140031590 (TopologyPUReverb.c)
 * Callees:
