/*
 * XREFs of ?GetMutePropertyBasicSupport@CSidebandDevice@@AEAAJKPEAKPEAX@Z @ 0x140010800
 * Callers:
 ...
 *     PropertyGetBooleanBasicSupportSideband @ 0x140032254 (PropertyGetBooleanBasicSupportSideband.c)
 */
