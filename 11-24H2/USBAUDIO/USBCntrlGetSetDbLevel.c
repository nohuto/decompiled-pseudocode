/*
 * XREFs of USBCntrlGetSetDbLevel @ 0x14003E570
 * Callers:
 *     <none>
 * Callees:
 ...
 *     log10 @ 0x140019EE0 (log10.c)
 *     pow @ 0x14001A240 (pow.c)
  ...
  if ( v13 || *(ULONG **)&WPP_RECORDER_INITIALIZED != &WPP_RECORDER_INITIALIZED )
  {
    WPP_RECORDER_AND_TRACE_SF_ddd(
      ...
      *(_QWORD *)&WPP_RECORDER_INITIALIZED != (_QWORD)&WPP_RECORDER_INITIALIZED,
      ...
      0xAu,
      0xBu,
      (__int64)&WPP_824efa28d3dd3b471526c0dd347ba0ce_Traceguids);
    v7 = v40;
  }
  v14 = v8[19];
  if ( v14 == 8 )
...
LABEL_29:
  ...
  else
  {
    if ( v38 )
    {
      if ( a6 == 131 && (v26 = *(_QWORD *)(v35 + 32), *(_WORD *)(v26 + 8) == 3468) && *(_WORD *)(v26 + 10) == 1 )
      {
        v27 = 0;
        v39 = 0;
      }
