/*
 * XREFs of USBType1AsyncEndpointPollCallback @ 0x140003CE0
 * Callers:
 *     <none>
 * Callees:
 *     KsGateTurnInputOn @ 0x140003FA4 (KsGateTurnInputOn.c)
...
__int64 __fastcall USBType1AsyncEndpointPollCallback(__int64 a1, __int64 a2, struct _KSPIN *a3)
{
  ...
  *(_BYTE *)(v6 + 933) = 0;
  ...
  {
    v10 = *(_DWORD *)(v6 + 872);
    v11 = (*(unsigned __int8 *)(v6 + 993) >> 6) | (4 * *(unsigned __int8 *)(v6 + 994));
