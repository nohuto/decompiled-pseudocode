/*
 * XREFs of _handle_error @ 0x14001AF50
 * Callers:
 *     log10 @ 0x140019EE0 (log10.c)
 *     _pow_special @ 0x14001B260 (_pow_special.c)
 * Callees:
 *     _set_errno_from_matherr @ 0x140019D60 (_set_errno_from_matherr.c)
 *     _call_matherr @ 0x14001AE00 (_call_matherr.c)
 *     _exception_enabled @ 0x14001AE80 (_exception_enabled.c)
 *     _raise_exc @ 0x14001B5A0 (_raise_exc.c)
