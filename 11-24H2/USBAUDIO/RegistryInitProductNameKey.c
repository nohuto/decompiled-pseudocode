/*
 * XREFs of RegistryInitProductNameKey @ 0x14003433C
 * Callers:
 *     FilterInitComponentId @ 0x1400306D0 (FilterInitComponentId.c)
 * Callees:
 *     RegistryCreateMediaCategoriesKey @ 0x140033D94 (RegistryCreateMediaCategoriesKey.c)
 */
