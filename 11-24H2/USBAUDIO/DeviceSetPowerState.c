/*
 * XREFs of DeviceSetPowerState @ 0x14003F210
 * Callers:
 *     <none>
 * Callees:
 *     WPP_RECORDER_AND_TRACE_SF_qdd @ 0x140004F68 (WPP_RECORDER_AND_TRACE_SF_qdd.c)
 *     WmiLogPowerStateChange @ 0x14000B6B4 (WmiLogPowerStateChange.c)
  ...
  if ( v8 || *(ULONG **)&WPP_RECORDER_INITIALIZED != &WPP_RECORDER_INITIALIZED )
    WPP_RECORDER_AND_TRACE_SF_qdd(
      ...
      *(_QWORD *)&WPP_RECORDER_INITIALIZED != (_QWORD)&WPP_RECORDER_INITIALIZED,
      ...
      1u,
      0x29u,
      (__int64)&WPP_36ecd4db00a936131fa2a547c127b75e_Traceguids);
  v9 = *(_QWORD *)(a1 + 16);
  if ( *(_DWORD *)(v9 + 536) != a3 )
  {
