/*
 * XREFs of ?IntersectDataFormatsWithDataRange@CSidebandDevice@@AEAAJPEAPEATKSDATAFORMAT@@KPEAU_KSPIN_DESCRIPTOR_EX@@PEAEPEAK3@Z @ 0x1400052F4
 * Callers:
...
LABEL_25:
  ...
  if ( (_BYTE)a2 || v10 )
  {
    v18 = &WPP_309f1687d4053247ca5427ea11d9cc71_Traceguids;
    LOBYTE(v18) = v10;
