/*
 * XREFs of ?IoQueueThread@CSidebandDevice@@AEAAXXZ @ 0x140006504
 * Callers:
 *     ?staticIoQueueThread@CSidebandDevice@@SAXPEAX@Z @ 0x140014240 (-staticIoQueueThread@CSidebandDevice@@SAXPEAX@Z.c)
 * Callees:
