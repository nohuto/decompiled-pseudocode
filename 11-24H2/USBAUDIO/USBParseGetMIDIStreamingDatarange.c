/*
 * XREFs of USBParseGetMIDIStreamingDatarange @ 0x140037A94
 * Callers:
...
LABEL_17:
  ...
  v8 = USBHwAllocateAndBag((PVOID *)&v32, 8 * (unsigned int)v10->bNumEndpoints + 56, 64LL, *(void **)(a1 + 8));
  if ( v8 < 0 )
    return (unsigned int)v8;
  v15 = (_QWORD *)*v11;
  ...
  *v11 = i;
  i[3] = v10;
  i[6] = i + 7;
  DescriptorInConfiguration = USBParseFindDescriptorInConfiguration(a2, v10, 36LL);
  if ( DescriptorInConfiguration )
  {
    for ( j = 0LL; (unsigned int)j < v10->bNumEndpoints; DescriptorInConfiguration = (__int64)&v18[*v18] )
    {
      *(_QWORD *)(i[6] + 8 * j) = USBParseFindDescriptorInConfiguration(a2, DescriptorInConfiguration, 5LL);
...
LABEL_18:
  ...
  *(_OWORD *)(v13 + 16) = xmmword_1400204D0;
  *(_DWORD *)(v13 + 96) = ((v27 >> 7) & 8) + 8;
  v28 = a5;
  *(_OWORD *)(v13 + 32) = xmmword_1400204E0;
  *(_OWORD *)(v13 + 48) = xmmword_1400204F0;
  *(_OWORD *)(v13 + 64) = xmmword_140020500;
  *(_OWORD *)(v13 + 80) = xmmword_140020510;
  *v28 = v13;
  v29 = 32864;
