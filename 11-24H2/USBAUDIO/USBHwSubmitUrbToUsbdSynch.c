/*
 * XREFs of USBHwSubmitUrbToUsbdSynch @ 0x14003C0BC
 * Callers:
 ...
 *     USBHwAbortOrResetPipe @ 0x14003C020 (USBHwAbortOrResetPipe.c)
 * Callees:
 *     USBD_AssignUrbToIoStackLocation @ 0x14000BDE4 (USBD_AssignUrbToIoStackLocation.c)
 */
...
__int64 __fastcall USBHwSubmitUrbToUsbdSynch(PDEVICE_OBJECT DeviceObject, PURB Urb, USBD_HANDLE USBDHandle)
{
  ...
  struct _IO_STACK_LOCATION *v9; // rdx
  NTSTATUS v10; // eax
  ...
  v9 = v7->Tail.Overlay.CurrentStackLocation - 1;
  if ( USBDHandle )
    USBD_AssignUrbToIoStackLocation(USBDHandle, v9, Urb);
  else
    v9->Parameters.WMI.ProviderId = (ULONG_PTR)Urb;
  v10 = IofCallDriver(DeviceObject, v7);
  if ( v10 == 259 )
  {
