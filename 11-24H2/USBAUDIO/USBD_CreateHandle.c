/*
 * XREFs of USBD_CreateHandle @ 0x1400192D0
 * Callers:
 ...
 * Callees:
 *     USBDInternal_BuildAndSendQueryInterfaceSynchronously @ 0x140018A8C (USBDInternal_BuildAndSendQueryInterfaceSynchronously.c)
