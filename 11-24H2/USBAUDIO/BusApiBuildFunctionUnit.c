/*
 * XREFs of BusApiBuildFunctionUnit @ 0x14002D1DC
 * Callers:
 *     BusApiBuildExtensionFunctionUnit @ 0x14003441C (BusApiBuildExtensionFunctionUnit.c)
 ...
 *     BusApiBuildProcessFunctionUnit @ 0x140034680 (BusApiBuildProcessFunctionUnit.c)
