/*
 * XREFs of PinSetDeviceState @ 0x14003D6D0
 * Callers:
 ...
 * Callees:
 *     WmiLogStreamStateChange @ 0x14000698C (WmiLogStreamStateChange.c)
 ...
 *     DecrementActivePinCount @ 0x14003D930 (DecrementActivePinCount.c)
 */
