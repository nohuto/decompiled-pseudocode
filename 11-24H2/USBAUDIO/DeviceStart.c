 ...
 *     RegistryGetIdleInfo @ 0x140033EA4 (RegistryGetIdleInfo.c)
 *     InitializeIrpThreadAndQueue @ 0x140034B14 (InitializeIrpThreadAndQueue.c)
 */
...
__int64 __fastcall DeviceStart(struct _KSDEVICE *a1, __int64 a2, __int64 a3)
{
  ...
  v7 = &WPP_36ecd4db00a936131fa2a547c127b75e_Traceguids;
  ...
  {
    v27 = &WPP_36ecd4db00a936131fa2a547c127b75e_Traceguids;
    LOWORD(v26) = 24;
    ...
    *((_DWORD *)Context + 134) = 1;
    ...
    else
    {
      ...
      if ( *((_DWORD *)Context + 270) )
      {
        ...
        v12 = *((_DWORD *)Context + 137);
      }
      else
      {
        v11 = *((_DWORD *)Context + 138);
        v12 = *((_DWORD *)Context + 136);
      }
