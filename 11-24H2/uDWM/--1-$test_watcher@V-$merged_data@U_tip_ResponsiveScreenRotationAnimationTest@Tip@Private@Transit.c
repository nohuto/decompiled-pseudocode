/*
 * XREFs of ??1?$test_watcher@V?$merged_data@U_tip_ResponsiveScreenRotationAnimationTest@Tip@Private@Transitions@Udwm@@U12345@@details@tip2@@@tip2@@QEAA@XZ @ 0x18004D534
 * Callers:
 ...
 *     _winrt::Udwm::Transitions::Private::implementation::ScreenRotationTransition::Cancel_::_1_::dtor$0 @ 0x1800F6F8E (_winrt--Udwm--Transitions--Private--implementation--ScreenRotationTransition--Cancel_--_1_--dtor.c)
 *     _winrt::Udwm::Transitions::Private::implementation::ScreenRotationTransition::PreTransition_::_1_::dtor$2 @ 0x1800F8A3D (_winrt--Udwm--Transitions--Private--implementation--ScreenRotationTransition--PreTransition_--_1.c)
 * Callees:
