/*
 * XREFs of ?UpdateNCAreaBackground@CTopLevelWindow@@AEAAJXZ @ 0x180029CA4
 * Callers:
...
__int64 __fastcall CTopLevelWindow::UpdateNCAreaBackground(CTopLevelWindow *this)
{
  ...
  if ( (*(_BYTE *)(*((_QWORD *)this + 89) + 736LL) & 8) == 0
  ...
  if ( std::operator==<CWindowBorder::CCachedBorderBrush>((_QWORD *)this + 34) )
  {
