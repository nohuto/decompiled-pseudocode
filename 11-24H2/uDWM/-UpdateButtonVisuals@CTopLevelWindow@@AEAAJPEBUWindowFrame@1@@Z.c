/*
 * XREFs of ?UpdateButtonVisuals@CTopLevelWindow@@AEAAJPEBUWindowFrame@1@@Z @ 0x180030618
 * Callers:
...
__int64 __fastcall CTopLevelWindow::UpdateButtonVisuals(CButton **this, const struct CTopLevelWindow::WindowFrame *a2)
{
  ...
  if ( v4 < 0 )
  {
    MilInstrumentationCheckHR_MaybeFailFast(0x14u, 0LL, 0LL, v4, 0xA21u, 0LL);
    return v5;
  }
  ...
  if ( v6 < 0 )
  {
    MilInstrumentationCheckHR_MaybeFailFast(0x14u, 0LL, 0LL, v6, 0xA22u, 0LL);
    return v5;
  }
  ...
  if ( v7 < 0 )
  {
    MilInstrumentationCheckHR_MaybeFailFast(0x14u, 0LL, 0LL, v7, 0xA23u, 0LL);
    return v5;
  }
  ...
  if ( v8 < 0 )
  {
    MilInstrumentationCheckHR_MaybeFailFast(0x14u, 0LL, 0LL, v8, 0xA24u, 0LL);
    return v5;
  }
  ...
  if ( a2 )
  {
    ...
    if ( v17 )
    {
      if ( v18 )
      {
        ...
        if ( v22 < 0 )
        {
          MilInstrumentationCheckHR_MaybeFailFast(0x14u, 0LL, 0LL, v22, 0xA75u, 0LL);
          return v5;
        }
      }
      else
      ...
      if ( v24 )
      {
        ...
        if ( v26 < 0 )
        {
          MilInstrumentationCheckHR_MaybeFailFast(0x14u, 0LL, 0LL, v26, 0xA80u, 0LL);
          return v5;
        }
      }
      v27 = this[64];
      if ( v27 )
      {
        ...
        if ( v28 < 0 )
        {
          MilInstrumentationCheckHR_MaybeFailFast(0x14u, 0LL, 0LL, v28, 0xA8Cu, 0LL);
          return v5;
        }
        if ( (*((_BYTE *)this[89] + 736) & 0x40) != 0 )
      ...
      if ( v30 < 0 )
      {
        MilInstrumentationCheckHR_MaybeFailFast(0x14u, 0LL, 0LL, v30, 0xA9Au, 0LL);
        return v5;
      }
    }
    else
    {
      if ( v18 )
      {
        ...
        if ( v33 < 0 )
        {
          MilInstrumentationCheckHR_MaybeFailFast(0x14u, 0LL, 0LL, v33, 0xAABu, 0LL);
          return v5;
        }
      }
      else
      ...
      if ( v35 )
      {
        ...
        if ( v37 < 0 )
        {
          MilInstrumentationCheckHR_MaybeFailFast(0x14u, 0LL, 0LL, v37, 0xAB6u, 0LL);
          return v5;
        }
      }
      v38 = this[64];
      if ( v38 )
      {
        ...
        if ( v39 < 0 )
        {
          MilInstrumentationCheckHR_MaybeFailFast(0x14u, 0LL, 0LL, v39, 0xAC2u, 0LL);
          return v5;
        }
        if ( (*((_BYTE *)this[89] + 736) & 0x40) != 0 )
          CButton::SetGhost(this[64]);
      ...
      if ( v41 < 0 )
      {
        MilInstrumentationCheckHR_MaybeFailFast(0x14u, 0LL, 0LL, v41, 0xAD0u, 0LL);
        return v5;
      }
    }
