/*
 * XREFs of ?ReportUsage@?$FeatureImpl@U__WilFeatureTraits_Feature_HideGlassSheetImmediatelyOnArrangementEnd@@@details@wil@@QEAAX_NW4ReportingKind@3@_K@Z @ 0x1800F2BE8
 * Callers:
