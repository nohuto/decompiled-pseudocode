/*
 * XREFs of ?OnAnimationStart@CAppArrangementDelayed@@EEAAJXZ @ 0x1800D2C80
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall CAppArrangementDelayed::OnAnimationStart(__m128i *this)
{
...
LABEL_14:
  ...
  while ( (unsigned int)v4 < this[7].m128i_i32[2] );
  if ( !v1 )
  {
LABEL_23:
