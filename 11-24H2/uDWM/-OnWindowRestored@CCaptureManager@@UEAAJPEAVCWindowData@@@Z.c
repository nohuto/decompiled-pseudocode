/*
 * XREFs of ?OnWindowRestored@CCaptureManager@@UEAAJPEAVCWindowData@@@Z @ 0x1800AF640
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall CCaptureManager::OnWindowRestored(CCaptureManager *this, struct CWindowData *a2)
{
  ...
  if ( !*((_DWORD *)a2 + 114)
    ...
    || (HostWindowHandleForProxyWindow = CProjectionBorderManager::_GetHostWindowHandleForProxyWindow(this, a2),
        updated = CCaptureManager::_UpdateCaptureControllerCaptureState(this, HostWindowHandleForProxyWindow, 1),
        v6 = updated,
        updated >= 0) )
  {
