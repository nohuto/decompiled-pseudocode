/*
 * XREFs of ?SetupDelayBeforeEntranceAnimation@CDisplayMixedModeAnimatedVisual@@AEAAJXZ @ 0x1800C0988
 * Callers:
 *     ?OnAnimationCompleteImpl@CDisplayMixedModeAnimatedVisual@@EEAAJI@Z @ 0x1800C08C0 (-OnAnimationCompleteImpl@CDisplayMixedModeAnimatedVisual@@EEAAJI@Z.c)
 * Callees:
...
__int64 __fastcall CDisplayMixedModeAnimatedVisual::SetupDelayBeforeEntranceAnimation(CTimelineBase **this)
{
  CBaseObject *v2; // rax
  _QWORD *v3; // r10
  int v4; // ebx
  ...
  if ( v2 )
    v2 = (CBaseObject *)CTimeline<float>::CTimeline<float>(v2, 0.2000000029802322, 0.0, 1.0, 0);
  wil::com_ptr_t<CTimeline<float>,wil::err_returncode_policy>::operator=(this + 58, v2);
  if ( !*v3 )
  {
    v4 = -2147024882;
    v5 = 155LL;
