/*
 * XREFs of ?PostActivateLivePreview@CDesktopManager@@QEAAJPEBUMILCMD_DWM_REDIRECTION_ACTIVATELIVEPREVIEW@@@Z @ 0x1800943DC
 * Callers:
    ...
    if ( v8 )
    {
      ...
      *((_QWORD *)v8 + 1) = *(_QWORD *)((char *)a2 + 12);
      ...
      else
      {
        ...
        if ( v5 >= 0 )
          v5 = -2003304445;
        MilInstrumentationCheckHR_MaybeFailFast(0x14u, 0LL, 0LL, v5, 0xACFu, 0LL);
      }
    }
    else
    {
      v5 = -2147024882;
      MilInstrumentationCheckHR_MaybeFailFast(0x14u, 0LL, 0LL, -2147024882, 0xAB4u, 0LL);
    }
  }
  else
  {
    v5 = -2147467259;
    MilInstrumentationCheckHR_MaybeFailFast(0x14u, 0LL, 0LL, -2147467259, 0xAA9u, 0LL);
  }
  DefaultHeap::Free(v2);
