/*
 * XREFs of ?_UpdateSolidFill@CAccent@@IEAAJPEAVCRenderDataVisual@@KPEBV?$TMilRect_@MUD2D_RECT_F@@UD2D_POINTANDSIZE_F@@UNotNeeded@RectUniqueness@@@@M@Z @ 0x18006602C
 * Callers:
...
__int64 __fastcall CAccent::_UpdateSolidFill(_DWORD *a1, CRenderDataVisual *a2, int a3, __int128 *a4, D3DVALUE a5)
{
  ...
  float v19; // xmm2_4
  __int64 v20; // rdx
  struct _D3DCOLORVALUE v21; // [rsp+20h] [rbp-30h] BYREF
  ...
  v21.r = flt_180105840[(unsigned __int8)a3] / 255.0;
  v21.g = flt_180105840[(unsigned __int64)(unsigned __int16)a3 >> 8] / 255.0;
  v21.b = flt_180105840[BYTE2(a3)] / 255.0;
  v9 = a1[61];
  if ( (v9 & 0x800) != 0 )
    v21.a = 0.0;
  else
  ...
  if ( (v9 & 4) != 0 )
  {
    if ( (v9 & 8) == 0 )
    {
      ...
      {
        CSolidRectangleInstruction::SetRect((__int64)v25, &v23);
