/*
 * XREFs of ??0hresult_class_not_available@winrt@@QEAA@Utake_ownership_from_abi_t@1@AEBUslim_source_location@impl@1@@Z @ 0x1800E01D4
 * Callers:
...
__int64 __fastcall winrt::hresult_class_not_available::hresult_class_not_available(__int64 a1, __int64 a2, __int64 a3)
{
  winrt::hresult_error::hresult_error(a1, winrt::impl::error_class_not_available, a3, a3);
  return a1;
}
