/*
 * XREFs of ?CopyVisual@CAnimatedTransitionVisual@@QEAAJPEAV1@@Z @ 0x1800A46B8
 * Callers:
 ...
 *     ?GetProgress@CAnimatedTransitionVisual@@UEAAJPEAM@Z @ 0x18008A140 (-GetProgress@CAnimatedTransitionVisual@@UEAAJPEAM@Z.c)
 */
