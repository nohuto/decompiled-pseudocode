/*
 * XREFs of ?GetRuntimeClassName@?$produce_base@UWindowJointResizeTransition@implementation@Private@Transitions@Udwm@winrt@@UITransition@456@X@impl@winrt@@UEAAHPEAPEAX@Z @ 0x1800DEB20
 * Callers:
 *     <none>
 * Callees:
 *     <none>
