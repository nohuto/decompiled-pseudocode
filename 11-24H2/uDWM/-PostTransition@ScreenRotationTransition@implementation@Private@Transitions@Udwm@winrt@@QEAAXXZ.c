/*
 * XREFs of ?PostTransition@ScreenRotationTransition@implementation@Private@Transitions@Udwm@winrt@@QEAAXXZ @ 0x1800E122C
 * Callers:
 *     ?PostTransition@?$produce@UScreenRotationTransition@implementation@Private@Transitions@Udwm@winrt@@UITransition@456@@impl@winrt@@UEAAHXZ @ 0x1800E1200 (-PostTransition@-$produce@UScreenRotationTransition@implementation@Private@Transitions@Udwm@winr.c)
 * Callees:
