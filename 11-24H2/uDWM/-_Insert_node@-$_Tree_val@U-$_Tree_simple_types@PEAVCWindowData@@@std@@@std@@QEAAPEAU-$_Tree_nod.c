/*
 * XREFs of ?_Insert_node@?$_Tree_val@U?$_Tree_simple_types@PEAVCWindowData@@@std@@@std@@QEAAPEAU?$_Tree_node@PEAVCWindowData@@PEAX@2@U?$_Tree_id@PEAU?$_Tree_node@PEAVCWindowData@@PEAX@std@@@2@QEAU32@@Z @ 0x1800BD9C0
 * Callers:
