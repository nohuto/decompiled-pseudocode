/*
 * XREFs of ?_Throw_bad_array_new_length@std@@YAXXZ @ 0x180095314
 * Callers:
 ...
 *     ??$_Allocate_manually_vector_aligned@U_Default_allocate_traits@std@@@std@@YAPEAX_K@Z @ 0x18009542C (--$_Allocate_manually_vector_aligned@U_Default_allocate_traits@std@@@std@@YAPEAX_K@Z.c)
