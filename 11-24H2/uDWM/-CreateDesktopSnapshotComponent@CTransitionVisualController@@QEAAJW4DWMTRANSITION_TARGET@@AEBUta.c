/*
 * XREFs of ?CreateDesktopSnapshotComponent@CTransitionVisualController@@QEAAJW4DWMTRANSITION_TARGET@@AEBUtagRECT@@PEAVCStoryboard@@PEAPEAVCAnimationComponent@@@Z @ 0x1800DD130
 * Callers:
        ...
        __int64 *a5)
{
  ...
  *(_DWORD *)(v17 + 60) = 0x7FFFFFFF;
  ...
  v20 = CTransitionVisualController::_SetDesktopId(a1, v30);
  v18 = v20;
  if ( v20 < 0 )
  {
    v25 = 1258;
