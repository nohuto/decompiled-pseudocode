/*
 * XREFs of ?precreate_hstring_on_heap@impl@winrt@@YAPEAUshared_hstring_header@12@I@Z @ 0x1800A0AD0
 * Callers:
 ...
 * Callees:
 *     WINRT_IMPL_HeapAlloc @ 0x18009C5EC (WINRT_IMPL_HeapAlloc.c)
 *     WINRT_IMPL_GetProcessHeap @ 0x18009C5F8 (WINRT_IMPL_GetProcessHeap.c)
