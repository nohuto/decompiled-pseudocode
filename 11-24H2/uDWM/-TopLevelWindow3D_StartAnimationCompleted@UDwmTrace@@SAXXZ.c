/*
 * XREFs of ?TopLevelWindow3D_StartAnimationCompleted@UDwmTrace@@SAXXZ @ 0x18001549C
 * Callers:
...
void __fastcall UDwmTrace::TopLevelWindow3D_StartAnimationCompleted(__int64 a1)
{
    ...
    && (*((_QWORD *)v1 + 3) & 0x200000000000LL) == *((_QWORD *)v1 + 3) )
  {
    ...
    v2 = 0x1000000LL;
    v5 = 8;
    tlgWriteTransfer_EtwEventWriteTransfer((_DWORD)v1, (unsigned int)&unk_180111E41, 0, 0, 3, (__int64)v3);
  }
}
