/*
 * XREFs of ?_SlideWindowHorizontally@CSlide@@IEAAJPEAVCWindowData@@AEBUtagRECT@@_NPEBU3@PEAPEAVCAnimationComponent@@@Z @ 0x1800D5794
 * Callers:
        ...
        struct tagPOINT ***a6)
{
  ...
  if ( v13 >= 0 )
  {
    ...
    if ( a4 )
    {
      ...
      {
        v28 = *(struct tagRECT *)((char *)a2 + 764);
LABEL_24:
  ...
  v15 = (struct tagPOINT **)v26;
  if ( v26 )
    CStoryboard::_RemoveAnimationComponent(this, (struct CVisual **)v26);
LABEL_27:
  if ( a6 )
  {
    if ( v14 < 0 )
