/*
 * XREFs of ??$CreateProxy@VCRectangleGeometryProxy@@@CCompositor@@IEAAJPEAPEAVCRectangleGeometryProxy@@@Z @ 0x18006776C
 * Callers:
...
__int64 __fastcall CCompositor::CreateProxy<CRectangleGeometryProxy>(__int64 a1, CBaseGeometryProxy **a2)
{
  CBaseGeometryProxy *v4; // rbx
  CRectangleGeometryProxy *v5; // rcx
  int v6; // eax
  unsigned int v7; // edi
  ...
  *a2 = 0LL;
  ...
  if ( v4 )
  {
    ...
    *(_QWORD *)v4 = &CTransform3dGroupProxy::`vftable';
    ...
    v6 = CRectangleGeometryProxy::Initialize(v5, *(struct IDwmChannel **)(a1 + 24));
    v7 = v6;
    if ( v6 < 0 )
    {
