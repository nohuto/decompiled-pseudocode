/*
 * XREFs of ?ShouldCloneWindow@CTransitionVisualController@@SA_NPEAUHWND__@@@Z @ 0x180012BB8
 * Callers:
  ...
  if ( GetClassNameW(hWnd, ClassName, 260) )
  {
    ...
    for ( i = 0; i < 6; ++i )
    {
             ...
             0) )
      {
        ...
        do
        {
          v11 = *(WCHAR *)((char *)v10 + (char *)(&off_180102A70)[2 * i] - (char *)ClassName);
          v12 = *v10 - v11;
          if ( v12 )
            break;
          ++v10;
    ...
    for ( j = 0LL; (unsigned int)j < 0xC; j = (unsigned int)(j + 1) )
    {
      ...
      do
      {
        v8 = *(WCHAR *)((char *)v7 + (char *)off_180102AD0[j] - (char *)ClassName);
        v9 = *v7 - v8;
        if ( v9 )
          break;
        ++v7;
