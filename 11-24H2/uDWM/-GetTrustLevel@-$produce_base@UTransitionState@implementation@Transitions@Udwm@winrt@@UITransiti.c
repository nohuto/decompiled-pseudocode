/*
 * XREFs of ?GetTrustLevel@?$produce_base@UTransitionState@implementation@Transitions@Udwm@winrt@@UITransitionState@345@X@impl@winrt@@UEAAHPEAW4TrustLevel@Foundation@Windows@3@@Z @ 0x1800E95A0
 * Callers:
 *     <none>
 * Callees:
 *     <none>
