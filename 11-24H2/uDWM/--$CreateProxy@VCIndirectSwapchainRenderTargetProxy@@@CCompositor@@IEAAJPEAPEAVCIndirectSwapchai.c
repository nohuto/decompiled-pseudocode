/*
 * XREFs of ??$CreateProxy@VCIndirectSwapchainRenderTargetProxy@@@CCompositor@@IEAAJPEAPEAVCIndirectSwapchainRenderTargetProxy@@@Z @ 0x1800B5988
 * Callers:
...
__int64 __fastcall CCompositor::CreateProxy<CIndirectSwapchainRenderTargetProxy>(__int64 a1, CBaseObject **a2)
{
  CBaseObject *v4; // rbx
  ...
  *a2 = 0LL;
  ...
  if ( v4 )
  {
    ...
    *(_QWORD *)v4 = &CIndirectSwapchainRenderTargetProxy::`vftable';
    ...
    v6 = CIndirectSwapchainRenderTargetProxy::Initialize(v5, *(struct IDwmChannel **)(a1 + 24));
    v7 = v6;
    if ( v6 < 0 )
    {
