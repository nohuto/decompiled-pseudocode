/*
 * XREFs of ?ApplyWindowResizeStateTransition@CWindowList@@AEAAJXZ @ 0x1800EE11C
 * Callers:
 ...
 *     ?GetResizeBorderOffsets@CTopLevelWindow@@QEAA?AUtagRECT@@I@Z @ 0x1800DB038 (-GetResizeBorderOffsets@CTopLevelWindow@@QEAA-AUtagRECT@@I@Z.c)
 */
...
__int64 __fastcall CWindowList::ApplyWindowResizeStateTransition(CWindowList *this)
{
  ...
  if ( (*(_BYTE *)(*((_QWORD *)this + 87) + 741LL) & 0x40) == 0 )
  {
