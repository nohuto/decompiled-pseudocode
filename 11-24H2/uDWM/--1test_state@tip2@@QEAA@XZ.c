/*
 * XREFs of ??1test_state@tip2@@QEAA@XZ @ 0x18009892C
 * Callers:
 ...
 *     ?clear@?$vector_nothrow@Utest_flag@tip2@@@tip2@@QEAAXXZ @ 0x180098A20 (-clear@-$vector_nothrow@Utest_flag@tip2@@@tip2@@QEAAXXZ.c)
