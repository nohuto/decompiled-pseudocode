/*
 * XREFs of ?EnsureClientAreaNode@CTopLevelWindow@@QEAAJXZ @ 0x1800295D0
 * Callers:
...
__int64 __fastcall CTopLevelWindow::EnsureClientAreaNode(CTopLevelWindow *this)
{
  ...
  if ( !*((_QWORD *)this + 60) )
  {
    ...
    if ( *((_QWORD *)v5 + 18) )
    {
      ...
      if ( v6 < 0 )
      {
        MilInstrumentationCheckHR_MaybeFailFast(0x14u, 0LL, 0LL, v6, 0x8E4u, 0LL);
      }
      else
      {
        ...
        if ( inserted < 0 )
        {
          MilInstrumentationCheckHR_MaybeFailFast(0x14u, 0LL, 0LL, inserted, 0x8E7u, 0LL);
        }
        else
        {
          v8 = *v2;
          ...
          if ( (*((_BYTE *)this + 200) & 4) != 0 )
          {
            ...
            v1 = updated;
            if ( updated < 0 )
              MilInstrumentationCheckHR_MaybeFailFast(0x14u, 0LL, 0LL, updated, 0x8EEu, 0LL);
          }
        }
      }
    }
