/*
 * XREFs of ?OnWindowStyleUpdated@CTopLevelWindow3D@@QEAAJXZ @ 0x1800132D0
 * Callers:
...
LABEL_18:
  ...
  *((_BYTE *)this + 249) = v5;
  if ( CTopLevelWindow3D::ShouldShowTransition(this) )
  {
    ...
    if ( *((_BYTE *)this + 248) )
    {
      if ( (*(_BYTE *)(v10 + 736) & 0x40) == 0 && !CTopLevelWindow3D::IsWindowInSystemArrangementAnimation(this) )
      {
        if ( *((_QWORD *)this + 40) )
        {
