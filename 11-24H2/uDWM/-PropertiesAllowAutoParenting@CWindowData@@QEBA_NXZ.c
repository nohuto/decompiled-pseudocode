/*
 * XREFs of ?PropertiesAllowAutoParenting@CWindowData@@QEBA_NXZ @ 0x18001E8BC
 * Callers:
 ...
 * Callees:
 *     ?WillEndAnimationCloaked@CWindowData@@QEBA_NXZ @ 0x1800530AC (-WillEndAnimationCloaked@CWindowData@@QEBA_NXZ.c)
 */
