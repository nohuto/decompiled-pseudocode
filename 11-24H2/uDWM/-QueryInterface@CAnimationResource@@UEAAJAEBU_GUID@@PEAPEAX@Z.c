/*
 * XREFs of ?QueryInterface@CAnimationResource@@UEAAJAEBU_GUID@@PEAPEAX@Z @ 0x1800A8040
 * Callers:
 *     <none>
 * Callees:
 *     ?AddRef@CAnimationResource@@UEAAKXZ @ 0x18008B460 (-AddRef@CAnimationResource@@UEAAKXZ.c)
 */
