/*
 * XREFs of ?OnTether@CContactManager@@QEAAJPEBUMILCMD_DWM_REDIRECTION_TETHERCONTACT@@@Z @ 0x1800B7214
 * Callers:
        ...
        const struct MILCMD_DWM_REDIRECTION_TETHERCONTACT *a2)
{
  ...
  CBaseObject *v34; // rcx
  unsigned __int64 v36; // [rsp+70h] [rbp+40h] BYREF
  CBaseObject *v37; // [rsp+80h] [rbp+50h] BYREF
  struct _RTL_CRITICAL_SECTION *v38; // [rsp+88h] [rbp+58h] BYREF
  ...
  if ( !*((_DWORD *)a2 + 2) )
  {
    if ( v10 )
    {
      v37 = *(CBaseObject **)(104LL * v5 + v8 + 72);
      v28 = *((_DWORD *)this + 44);
      v29 = v28 + 1;
      if ( v28 + 1 >= v28 )
      {
        ...
        {
          v31 = DynArrayImpl<0>::AddMultipleAndSet((__int64)this + 152, 8, 1, &v37);
          v30 = v31;
          if ( v31 < 0 )
...
LABEL_44:
  ...
  v12 = CreateTouchVisual<CTetherVisual>(v36, &v37);
  v11 = v12;
  if ( v12 < 0 )
  {
  ...
  v4 = v37;
  v14 = CContactManager::AddToTouchNode(v13, v36, v37);
  v11 = v14;
  if ( v14 < 0 )
  {
  ...
  *(_QWORD *)(v9 + *((_QWORD *)this + 7) + 72) = v4;
  ...
  if ( v17 )
  {
    ...
    *(_BYTE *)(v9 + *((_QWORD *)this + 7) + 96) = 0;
    ...
    {
      Touch = CreateTouchVisual<CDirectTouchVisual>(v36, v22);
      v11 = Touch;
      if ( Touch < 0 )
      {
      ...
      CContactManager::AddToTouchNode(v24, v36, *(struct CVisual **)(104LL * v5 + *((_QWORD *)this + 7) + 48));
      v18 = v19;
    }
    v25 = 104LL * v5;
    v26 = *((_QWORD *)this + 7);
