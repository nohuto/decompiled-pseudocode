/*
 * XREFs of ?GetLegacyPhoneScaleFactor@@YA?AW4DEVICE_SCALE_FACTOR@@UtagSIZE@@0@Z @ 0x1800F5744
 * Callers:
 ...
 *     ?CalcBucketedScaleFactor@@YAIUtagSIZE@@0@Z @ 0x1800F5668 (-CalcBucketedScaleFactor@@YAIUtagSIZE@@0@Z.c)
 */
