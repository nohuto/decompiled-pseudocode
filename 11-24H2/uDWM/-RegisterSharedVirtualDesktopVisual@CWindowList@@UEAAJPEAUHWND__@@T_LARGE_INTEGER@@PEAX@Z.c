/*
 * XREFs of ?RegisterSharedVirtualDesktopVisual@CWindowList@@UEAAJPEAUHWND__@@T_LARGE_INTEGER@@PEAX@Z @ 0x1800F22E0
 * Callers:
 ...
 *     ??0CDCompVirtualDesktopThumbnailData@@QEAA@XZ @ 0x1800EC8FC (--0CDCompVirtualDesktopThumbnailData@@QEAA@XZ.c)
 */
        ...
        void *a4)
{
  ...
  *((_DWORD *)v14 + 30) = 2;
  ...
  if ( v16 < 0 )
  {
    MilInstrumentationCheckHR_MaybeFailFast(0x14u, 0LL, 0LL, v16, 0x1405u, 0LL);
    v8 = v33;
    goto LABEL_29;
  }
  ...
  if ( v17 < 0 )
  {
    MilInstrumentationCheckHR_MaybeFailFast(0x14u, 0LL, 0LL, v17, 0x1406u, 0LL);
    v8 = v33;
    v9 = v34;
    goto LABEL_29;
  }
  ...
  if ( v18 < 0 )
  {
    MilInstrumentationCheckHR_MaybeFailFast(0x14u, 0LL, 0LL, v18, 0x1407u, 0LL);
    goto LABEL_29;
  }
  *((_QWORD *)v15 + 12) = v8;
  *((_QWORD *)v15 + 13) = v9;
