/*
 * XREFs of ?InsertIntoVisualTree@CWindowList@@AEAAJPEAVCWindowData@@@Z @ 0x180025614
 * Callers:
 ...
 *     ?FindPrecedingVisibleWindowVisual@CWindowList@@AEAAPEAVCVisual@@PEAU_LIST_ENTRY@@@Z @ 0x18002578C (-FindPrecedingVisibleWindowVisual@CWindowList@@AEAAPEAVCVisual@@PEAU_LIST_ENTRY@@@Z.c)
...
__int64 __fastcall CWindowList::InsertIntoVisualTree(CWindowList *this, struct _LIST_ENTRY *a2)
{
  ...
  if ( (BYTE6(a2[46].Flink) & 0x10) != 0 )
  {
    Blink = a2[37].Blink[27].Blink[15].Blink;
    PrecedingVisibleWindowVisual = (struct CVisual *)*((_QWORD *)&Blink[9].Blink->Flink
                                                     + (unsigned int)(LODWORD(Blink[11].Flink) - 1));
  }
  else
  {
    Buffer[1] = 0LL;
