/*
 * XREFs of ?Initialize@CDesktopThumbnailBase@@MEAAJXZ @ 0x180086950
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall CDesktopThumbnailBase::Initialize(struct CContainerVisualProxy **this)
{
  ...
  v10 = this;
  v5 = *((_DWORD *)CDesktopManager::s_pDesktopManagerInstance + 320);
  v6 = v5 + 1;
  if ( v5 + 1 < v5 )
  {
    v3 = -2147024362;
...
LABEL_9:
  ...
  v8 = 0;
  if ( v6 > *((_DWORD *)CDesktopManager::s_pDesktopManagerInstance + 319) )
  {
    v8 = DynArrayImpl<0>::AddMultipleAndSet((__int64)CDesktopManager::s_pDesktopManagerInstance + 1256, 8, 1, &v10);
    v3 = v8;
    if ( v8 < 0 )
    {
      v7 = 190;
  ...
  {
    *(_QWORD *)(*((_QWORD *)CDesktopManager::s_pDesktopManagerInstance + 157)
              + 8LL * *((unsigned int *)CDesktopManager::s_pDesktopManagerInstance + 320)) = this;
    *((_DWORD *)v4 + 320) = v6;
  }
  *((_BYTE *)this + 36) |= 8u;
