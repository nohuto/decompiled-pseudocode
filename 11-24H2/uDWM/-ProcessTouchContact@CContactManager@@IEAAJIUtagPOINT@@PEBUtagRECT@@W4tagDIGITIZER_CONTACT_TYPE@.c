/*
 * XREFs of ?ProcessTouchContact@CContactManager@@IEAAJIUtagPOINT@@PEBUtagRECT@@W4tagDIGITIZER_CONTACT_TYPE@@K_K@Z @ 0x18000E778
 * Callers:
 ...
 *     ?SetContactManager@CTouchDragVisual@@QEAAJPEAVCContactManager@@@Z @ 0x18000D560 (-SetContactManager@CTouchDragVisual@@QEAAJPEAVCContactManager@@@Z.c)
 ...
 *     ?UpdateLocation@CDirectTouchVisual@@QEAAJPEBUtagPOINT@@PEBUtagRECT@@@Z @ 0x18000F558 (-UpdateLocation@CDirectTouchVisual@@QEAAJPEBUtagPOINT@@PEBUtagRECT@@@Z.c)
 *     ?IsInInitialDelay@CDirectTouchVisual@@QEBA_NXZ @ 0x18000F9F0 (-IsInInitialDelay@CDirectTouchVisual@@QEBA_NXZ.c)
 ...
 *     ?IsOKToCleanup@CPressTapVisual@@UEAA_NXZ @ 0x1800B6E10 (-IsOKToCleanup@CPressTapVisual@@UEAA_NXZ.c)
 ...
 *     ?IsHolding@CTouchPressHoldVisual@@QEAA_NXZ @ 0x1800DBD50 (-IsHolding@CTouchPressHoldVisual@@QEAA_NXZ.c)
...
LABEL_25:
      ...
      else
      {
        ...
        Touch = CContactManager::AddToTouchNode(v28, a7, (struct CVisual *)*v17);
        v9 = Touch;
        if ( Touch < 0 )
        {
          v84 = 1168;
        ...
        {
          Touch = CTouchDragVisual::SetContactManager((CTouchDragVisual *)*v17, (struct CContactManager *)a1);
          v9 = Touch;
          if ( Touch >= 0 )
          {
...
LABEL_40:
      MilInstrumentationCheckHR_MaybeFailFast(0x14u, 0LL, 0, Touch, v84, 0LL);
      return v9;
    }
    if ( v13 != 3 )
    {
    ...
    else
    {
      ...
      if ( v32 )
      {
        ...
        if ( v56 + 1 >= v56 )
        {
          ...
          {
            v59 = DynArrayImpl<0>::AddMultipleAndSet(v87 + 152, 8LL, 1LL, v88);
            v58 = v59;
            if ( v59 < 0 )
              MilInstrumentationCheckHR_MaybeFailFast(0x14u, 0LL, 0, v59, 0xBEu, 0LL);
          }
          else
          {
    ...
    if ( CTouchPressHoldVisual::IsHolding(*((CTouchPressHoldVisual **)v15 + 8)) )
    {
      ...
      if ( (int)v63 + 1 >= (unsigned int)v63 )
      {
        ...
        {
          v66 = DynArrayImpl<0>::AddMultipleAndSet((char *)v33 + 280, 16LL, 1LL, v88);
          v65 = v66;
          if ( v66 < 0 )
            MilInstrumentationCheckHR_MaybeFailFast(0x14u, 0LL, 0, v66, 0xBEu, 0LL);
        }
        else
        {
...
LABEL_55:
        ...
        if ( v36 )
        {
          ...
          if ( v73 + 1 >= v73 )
          {
            ...
            {
              v76 = DynArrayImpl<0>::AddMultipleAndSet((char *)v33 + 152, 8LL, 1LL, v88);
              v75 = v76;
              if ( v76 < 0 )
                MilInstrumentationCheckHR_MaybeFailFast(0x14u, 0LL, 0, v76, 0xBEu, 0LL);
            }
            else
            {
...
LABEL_156:
            ...
            v31 = DynArrayImpl<0>::AddMultipleAndSet((char *)v33 + 152, 8LL, 1LL, v88);
            if ( v31 >= 0 )
              goto LABEL_156;
            v35 = 190;
          }
          MilInstrumentationCheckHR_MaybeFailFast(0x14u, 0LL, 0, v31, v35, 0LL);
        }
...
LABEL_57:
      ...
      {
        v69 = DynArrayImpl<0>::AddMultipleAndSet((char *)v33 + 152, 8LL, 1LL, v88);
        if ( v69 < 0 )
        {
          v70 = 190;
          v35 = 179;
    ...
    if ( v15[1] )
    {
      ...
      if ( v48 )
      {
        ...
        if ( (int)v50 + 1 >= (unsigned int)v50 )
        {
          ...
          {
            v53 = DynArrayImpl<0>::AddMultipleAndSet(v49, 8LL, 1LL, v88);
            v52 = v53;
            if ( v53 < 0 )
              MilInstrumentationCheckHR_MaybeFailFast(0x14u, 0LL, 0, v53, 0xBEu, 0LL);
          }
          else
          {
