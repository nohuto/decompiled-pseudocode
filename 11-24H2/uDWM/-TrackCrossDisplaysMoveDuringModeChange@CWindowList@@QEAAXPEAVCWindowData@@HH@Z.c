/*
 * XREFs of ?TrackCrossDisplaysMoveDuringModeChange@CWindowList@@QEAAXPEAVCWindowData@@HH@Z @ 0x18001AE00
 * Callers:
        ...
        struct CWindowData *a2)
{
  ...
  if ( this[70] )
  {
    if ( *((_QWORD *)a2 + 55) )
    {
      if ( *((_QWORD *)a2 + 56) )
      {
        if ( CWindowData::IsWindowVisibleAndUncloaked(a2) && (*(_BYTE *)(v4 + 738) & 0x40) == 0 )
        {
          v7 = *(_WORD **)(v4 + 16);
          if ( v7 )
          {
