/*
 * XREFs of ?UpdateClientArea@CWindowIconic@@AEAAJXZ @ 0x18000560C
 * Callers:
...
__int64 __fastcall CWindowIconic::UpdateClientArea(CWindowIconic *this)
{
  ...
  else
  {
    ...
    *(float *)&v21[3] = (float)v23;
    ...
    if ( v10 < 0 )
    {
      MilInstrumentationCheckHR_MaybeFailFast(0x14u, 0LL, 0, v10, 0x10Du, 0LL);
    }
    else
    {
      ...
      if ( v14 < 0 )
      {
        MilInstrumentationCheckHR_MaybeFailFast(0x14u, 0LL, 0, v14, 0x10Eu, 0LL);
      }
      else
      {
        CSolidRectangleInstruction::SetRect(v24, v21);
        v16 = CRenderDataVisual::AddInstruction(*((CRenderDataVisual **)this + 13), v15);
        v5 = v16;
        if ( v16 < 0 )
        {
          MilInstrumentationCheckHR_MaybeFailFast(0x14u, 0LL, 0, v16, 0x111u, 0LL);
        }
        else
        {
