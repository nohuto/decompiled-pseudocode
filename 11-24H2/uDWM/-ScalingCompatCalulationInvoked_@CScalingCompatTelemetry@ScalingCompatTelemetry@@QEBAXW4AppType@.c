/*
 * XREFs of ?ScalingCompatCalulationInvoked_@CScalingCompatTelemetry@ScalingCompatTelemetry@@QEBAXW4AppType@2@II@Z @ 0x1800F57A8
 * Callers:
 ...
 * Callees:
 *     _tlgWriteTransfer_EventWriteTransfer @ 0x180002590 (_tlgWriteTransfer_EventWriteTransfer.c)
        ...
        int a4)
{
  ...
  if ( *v8 > 5u )
  {
    ...
    v17 = 4LL;
    v15 = 4LL;
    LODWORD(v7) = tlgWriteTransfer_EventWriteTransfer((__int64)v8, byte_180112624, 0LL, 0LL, 5u, &v13);
  }
  return v7;
}
