/*
 * XREFs of ?RemoveTargetsForStoryboard@CTransitionVisualController@@QEAAJPEAVCStoryboard@@_NK@Z @ 0x180044548
 * Callers:
        ...
        int a4)
{
  ...
  struct CStoryboard *v24; // [rsp+98h] [rbp+10h]
...
LABEL_3:
  if ( Blink != WindowListForDesktop )
  {
    ...
    for ( i = 0LL; ; i = (unsigned int)(i + 1) )
    {
      ...
      {
        Blink_low = (CTransitionVisualController *)LODWORD(Blink[46].Blink);
        if ( ((unsigned int)Blink_low & 0x40000000) == 0 )
          LODWORD(Blink[46].Blink) = (unsigned int)Blink_low & (v26 | 0x2000000) | 0xFFF;
        if ( v7 )
        {
          ...
          if ( (v12 & 0x20100000) == 0x20100000 )
          {
            ...
            if ( (int)CTransitionVisualController::GetStoredSnapshotNoRef(this, v17, &v22) >= 0 )
            {
              ...
              v18 = v22;
              v19 = CContainerVisual::RemoveChild(*((CContainerVisual **)v22 + 3), v22);
              v5 = v19;
              if ( v19 < 0 )
              {
