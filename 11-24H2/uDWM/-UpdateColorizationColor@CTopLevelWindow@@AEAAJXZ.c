/*
 * XREFs of ?UpdateColorizationColor@CTopLevelWindow@@AEAAJXZ @ 0x18002BC00
 * Callers:
 ...
 *     ?SetClearColor@CGlassColorizationResources@@QEAAXXZ @ 0x18002CBE8 (-SetClearColor@CGlassColorizationResources@@QEAAXXZ.c)
 *     ?SetColor@CGlassColorizationResources@@QEAAXK@Z @ 0x180070558 (-SetColor@CGlassColorizationResources@@QEAAXK@Z.c)
...
__int64 __fastcall CTopLevelWindow::UpdateColorizationColor(CGlassColorizationResources **this)
{
  ...
  if ( !this[71] )
  {
    ...
    {
      this[71] = 0LL;
      MilInstrumentationCheckHR_MaybeFailFast(0x14u, 0LL, 0LL, -2147024882, 0x892u, 0LL);
      return 2147942414LL;
    }
  ...
  if ( !this[72] )
  {
    ...
    MilInstrumentationCheckHR_MaybeFailFast(0x14u, 0LL, 0LL, -2147024882, 0x897u, 0LL);
    return 2147942414LL;
  }
LABEL_3:
  v5 = this[89];
  v6 = v18;
  if ( (*((_BYTE *)v5 + 740) & 0x40) != 0 )
    v6 = v18 | 0x10;
  ...
  {
    LOBYTE(v5) = 1;
    if ( !v7 && (*((_BYTE *)this[89] + 740) & 0x40) == 0 && (v6 & 0x80u) == 0 )
      v6 |= 8u;
  }
  else
  {
  ...
  else
  {
    ...
    if ( v9 < 0 )
    {
      MilInstrumentationCheckHR_MaybeFailFast(0x14u, 0LL, 0LL, v9, 0x8B3u, 0LL);
      return v2;
    }
  }
  ...
  else
  {
    ...
    if ( (int)result < 0 )
    {
      MilInstrumentationCheckHR_MaybeFailFast(0x14u, 0LL, 0LL, result, 0x8C8u, 0LL);
      return v14;
    }
  }
  return result;
