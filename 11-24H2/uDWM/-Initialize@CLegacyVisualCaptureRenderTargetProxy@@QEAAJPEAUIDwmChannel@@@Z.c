/*
 * XREFs of ?Initialize@CLegacyVisualCaptureRenderTargetProxy@@QEAAJPEAUIDwmChannel@@@Z @ 0x180098D2C
 * Callers:
...
__int64 __fastcall CLegacyVisualCaptureRenderTargetProxy::Initialize(
        ...
        struct IDwmChannel *a2)
{
  ...
  v2 = CResourceProxy::Initialize((__int64)this, 0x14u, (__int64)a2);
  v3 = v2;
  if ( v2 < 0 )
