/*
 * XREFs of ?message@hresult_error@winrt@@QEBA?AUhstring@2@XZ @ 0x1800A0980
 * Callers:
 ...
 * Callees:
 *     FormatMessageW_0 @ 0x18009C5D4 (FormatMessageW_0.c)
 ...
 *     ?close@?$handle_type@Uheap_traits@impl@winrt@@@winrt@@QEAAXXZ @ 0x1800A08D0 (-close@-$handle_type@Uheap_traits@impl@winrt@@@winrt@@QEAAXXZ.c)
