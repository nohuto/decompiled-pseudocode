/*
 * XREFs of ?CreateAttachWatcher@HolographicDriverDetectedWatcher@Mirage@Windows@@QEAAJV?$function@$$A6AXXZ@wistd@@@Z @ 0x180096944
 * Callers:
...
__int64 __fastcall Windows::Mirage::HolographicDriverDetectedWatcher::CreateAttachWatcher(__int64 a1, __int64 a2)
{
  ...
  v7 = a2;
  if ( Microsoft::WRL::operator!=<Windows::UI::Composition::ICompositionProjectedShadowReceiver>((_QWORD *)(a1 + 16)) )
