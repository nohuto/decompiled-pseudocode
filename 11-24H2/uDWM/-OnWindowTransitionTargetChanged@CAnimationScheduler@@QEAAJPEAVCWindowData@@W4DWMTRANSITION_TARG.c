/*
 * XREFs of ?OnWindowTransitionTargetChanged@CAnimationScheduler@@QEAAJPEAVCWindowData@@W4DWMTRANSITION_TARGET@@AEBUtagRECT@@2222@Z @ 0x180003294
 * Callers:
          ...
          *(_DWORD *)(a2 + 744) |= 0x4000000u;
          ...
          if ( (int)CTransitionVisualController::GetStoredSnapshotNoRef(
                      *((CTransitionVisualController **)CDesktopManager::s_pDesktopManagerInstance + 24),
                      v20,
                      &v22) >= 0 )
            *(_DWORD *)(*(_QWORD *)(*((_QWORD *)v22 + 30) + 32LL) + 744LL) = *(_DWORD *)(a2 + 744);
        }
      }
    }
  }
