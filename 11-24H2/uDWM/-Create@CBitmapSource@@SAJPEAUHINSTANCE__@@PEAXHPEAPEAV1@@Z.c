/*
 * XREFs of ?Create@CBitmapSource@@SAJPEAUHINSTANCE__@@PEAXHPEAPEAV1@@Z @ 0x18000ABEC
 * Callers:
...
__int64 __fastcall CBitmapSource::Create(HINSTANCE a1, void *a2, __int64 a3, struct CBitmapSource **a4)
{
  ...
  if ( ThemeStream < 0 )
  {
    MilInstrumentationCheckHR_MaybeFailFast(0x14u, 0LL, 0, ThemeStream, 0x43u, 0LL);
  }
  else
  {
    ...
    v6 = v7;
    if ( v7 < 0 )
      MilInstrumentationCheckHR_MaybeFailFast(0x14u, 0LL, 0, v7, 0x46u, 0LL);
  }
  return v6;
}
