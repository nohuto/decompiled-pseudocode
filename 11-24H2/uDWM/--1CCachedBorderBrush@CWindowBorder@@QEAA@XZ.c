/*
 * XREFs of ??1CCachedBorderBrush@CWindowBorder@@QEAA@XZ @ 0x180039B34
 * Callers:
 *     ?_Destroy@?$_Ref_count_obj2@VCCachedBorderBrush@CWindowBorder@@@std@@EEAAXXZ @ 0x180084290 (-_Destroy@-$_Ref_count_obj2@VCCachedBorderBrush@CWindowBorder@@@std@@EEAAXXZ.c)
 * Callees:
