/*
 * XREFs of ?__private_IsEnabled@?$FeatureImpl@U__WilFeatureTraits_Feature_DisplayBugBundle_2510@@@details@wil@@QEAA_NW4ReportingKind@3@@Z @ 0x1800BB7F8
 * Callers:
 ...
 *     ?ReportUsage@?$FeatureImpl@U__WilFeatureTraits_Feature_DisplayBugBundle_2510@@@details@wil@@QEAAX_NW4ReportingKind@3@_K@Z @ 0x1800BB154 (-ReportUsage@-$FeatureImpl@U__WilFeatureTraits_Feature_DisplayBugBundle_2510@@@details@wil@@QEAA.c)
 */
        ...
        wil::details *a1)
{
  ...
  wil::details::FeatureImpl<__WilFeatureTraits_Feature_DisplayBugBundle_2510>::GetCachedFeatureEnabledState(a1, &v6);
  v2 = v6 & 1;
  wil::details::FeatureImpl<__WilFeatureTraits_Feature_DisplayBugBundle_2510>::ReportUsage((__int64)a1, v6 & 1, v3, v4);
  return v2;
}
