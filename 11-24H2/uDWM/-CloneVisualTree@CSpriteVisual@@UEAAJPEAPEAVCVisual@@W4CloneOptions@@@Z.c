/*
 * XREFs of ?CloneVisualTree@CSpriteVisual@@UEAAJPEAPEAVCVisual@@W4CloneOptions@@@Z @ 0x1800D0FF0
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall CSpriteVisual::CloneVisualTree(__int64 a1, CBaseObject **a2)
{
  int v4; // eax
  unsigned int v5; // ebx
  __int64 v6; // rdx
