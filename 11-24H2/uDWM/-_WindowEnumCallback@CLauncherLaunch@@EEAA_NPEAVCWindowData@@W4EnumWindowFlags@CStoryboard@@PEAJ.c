/*
 * XREFs of ?_WindowEnumCallback@CLauncherLaunch@@EEAA_NPEAVCWindowData@@W4EnumWindowFlags@CStoryboard@@PEAJ@Z @ 0x1800512D0
 * Callers:
 *     <none>
 * Callees:
...
char __fastcall CLauncherLaunch::_WindowEnumCallback(struct tagRECT *a1, struct tagRECT *a2, char a3, int *a4)
{
  ...
  if ( (a3 & 1) != 0 )
  {
    v12 = a2[46].right & 0xFFF;
    if ( v12 == 2 )
    {
      if ( a2[8].left == 1 )
        a2[46].right |= 0x4000000u;
