/*
 * XREFs of ?IsInWindowMoveChange@CWindowList@@UEAAJPEAUIDwmWindow@@_NW4tagINPUT_MESSAGE_DEVICE_TYPE@@@Z @ 0x1800F0910
 * Callers:
        ...
        enum tagINPUT_MESSAGE_DEVICE_TYPE a4)
{
  ...
  v9 = v8;
  if ( v8 && (*(_BYTE *)(v8 + 742) & 0x14) != 0 )
    a3 = 0;
  if ( ((a4 - 4) & 0xFFFFFFFB) != 0 || !a3 && (!v8 || (*(_BYTE *)(v8 + 741) & 0x10) == 0) )
    goto LABEL_37;
  ...
  {
    if ( ((v12[46].top & 0x1000) != 0) != a3 || !v9 )
    {
      BYTE1(v12[46].top) = (16 * a3) | BYTE1(v12[46].top) & 0xEF;
...
LABEL_20:
        ...
        if ( v19 )
        {
          if ( v10 )
          {
            started = CTopLevelWindow3D::OnIsInWindowMoveUpdated(v19, ((*v11)[46].top & 0x1000) != 0);
            v13 = started;
            if ( started < 0 )
            {
              v15 = 3496LL;
        ...
        if ( v20 )
          CTopLevelWindow::OnIsInWindowMove(v20, ((*v11)[46].top & 0x1000) != 0, *v11 + 3);
      }
    }
