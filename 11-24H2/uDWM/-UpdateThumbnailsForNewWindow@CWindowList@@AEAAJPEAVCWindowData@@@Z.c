/*
 * XREFs of ?UpdateThumbnailsForNewWindow@CWindowList@@AEAAJPEAVCWindowData@@@Z @ 0x18001A90C
 * Callers:
...
__int64 __fastcall CWindowList::UpdateThumbnailsForNewWindow(CWindowList *this, struct CWindowData *a2)
{
  ...
  for ( i = 0LL; (unsigned int)i < *((_DWORD *)a2 + 140); i = (unsigned int)(i + 1) )
  {
    ...
    if ( v8 < 0 )
    {
      MilInstrumentationCheckHR_MaybeFailFast(0x14u, 0LL, 0, v8, 0x1B3Fu, 0LL);
      return v2;
    }
    ...
    else
    {
      ...
      if ( v11 < 0 )
      {
        MilInstrumentationCheckHR_MaybeFailFast(0x14u, 0LL, 0, v11, 0x1B4Au, 0LL);
        return v2;
      }
    }
  }
