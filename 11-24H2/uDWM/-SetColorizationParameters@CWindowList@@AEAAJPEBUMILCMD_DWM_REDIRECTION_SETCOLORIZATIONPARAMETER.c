/*
 * XREFs of ?SetColorizationParameters@CWindowList@@AEAAJPEBUMILCMD_DWM_REDIRECTION_SETCOLORIZATIONPARAMETERS@@@Z @ 0x1800717A8
 * Callers:
        ...
        const struct MILCMD_DWM_REDIRECTION_SETCOLORIZATIONPARAMETERS *a2)
{
  ...
  else
  {
    ...
    v23 = *(_OWORD *)((char *)CDesktopManager::s_pDesktopManagerInstance + 484);
    v24 = *(_OWORD *)((char *)CDesktopManager::s_pDesktopManagerInstance + 500);
    ...
    *(_QWORD *)&v23 = *(_QWORD *)((char *)a2 + 4);
    ...
    if ( v15 )
    {
      ...
      v4 = IsLightTheme;
      if ( IsLightTheme < 0 )
        MilInstrumentationCheckHR_MaybeFailFast(0x14u, 0LL, 0LL, IsLightTheme, 0x1D1Au, 0LL);
    }
  }
