/*
 * XREFs of ?_EnsureBrushForCVI@CTransitionWindowSnapshot@@AEAAJXZ @ 0x180002C4C
 * Callers:
...
__int64 __fastcall CTransitionWindowSnapshot::_EnsureBrushForCVI(CTransitionWindowSnapshot *this)
{
  ...
  int v6; // eax
  CBaseObject *v8; // rcx
  CMILRefCountBase *v9; // [rsp+70h] [rbp-38h] BYREF
  ...
  if ( v3 < 0 )
  {
    MilInstrumentationCheckHR_MaybeFailFast(0x14u, 0LL, 0, v3, 0xCBu, 0LL);
    goto LABEL_5;
  }
  v11 = _xmm;
  v10 = _xmm;
  v6 = CImageLegacyMilBrushProxy::Update(v9, v4, &v11, &v10, 0LL, 1, 1, 0LL, 0LL, 1);
  v1 = v6;
  if ( v6 < 0 )
  {
    MilInstrumentationCheckHR_MaybeFailFast(0x14u, 0LL, 0, v6, 0xE6u, 0LL);
    goto LABEL_5;
  }
