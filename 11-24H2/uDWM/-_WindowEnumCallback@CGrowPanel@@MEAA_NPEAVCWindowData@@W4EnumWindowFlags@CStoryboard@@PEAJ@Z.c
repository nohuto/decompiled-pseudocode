/*
 * XREFs of ?_WindowEnumCallback@CGrowPanel@@MEAA_NPEAVCWindowData@@W4EnumWindowFlags@CStoryboard@@PEAJ@Z @ 0x1800D7C10
 * Callers:
 *     <none>
 * Callees:
 ...
 *     ?GetPVLTarget@CShrinkPanel@@UEAAHW4DWMTRANSITION_TARGET@@@Z @ 0x1800D1F20 (-GetPVLTarget@CShrinkPanel@@UEAAHW4DWMTRANSITION_TARGET@@@Z.c)
...
LABEL_29:
  ...
  if ( *(_BYTE *)(a1 + 136) )
  {
    v12 = CShrinkPanel::GetPVLTarget(a1, *(_DWORD *)(a2 + 744));
