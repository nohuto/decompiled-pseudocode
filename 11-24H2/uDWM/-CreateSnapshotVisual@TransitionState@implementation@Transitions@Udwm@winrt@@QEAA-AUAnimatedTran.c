/*
 * XREFs of ?CreateSnapshotVisual@TransitionState@implementation@Transitions@Udwm@winrt@@QEAA?AUAnimatedTransitionVisualWrapper@345@UTopLevelWindow3DWrapper@345@@Z @ 0x18004BD94
 * Callers:
        ...
        winrt::Udwm::Transitions::AnimationCompletedHandler *a3)
{
  ...
  v7 = (winrt::Windows::Foundation::IUnknown *)winrt::make<winrt::Udwm::Transitions::implementation::AnimatedTransitionVisualWrapper,CTopLevelWindow3D *>(
                                                 &v11,
                                                 &v13);
  winrt::Udwm::Transitions::TopLevelWindow3DWrapper::operator=((winrt::Windows::Foundation::IUnknown *)(a1 + 112), v7);
  if ( v11 )
