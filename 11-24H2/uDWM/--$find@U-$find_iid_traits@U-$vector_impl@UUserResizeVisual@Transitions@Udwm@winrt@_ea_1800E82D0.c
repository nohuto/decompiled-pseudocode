 ...
 *     ??$is_guid_of@U?$IIterable@UUserResizeVisual@Transitions@Udwm@winrt@@@Collections@Foundation@Windows@winrt@@@winrt@@YA_NAEBUguid@0@@Z @ 0x1800E842C (--$is_guid_of@U-$IIterable@UUserResizeVisual@Transitions@Udwm@winrt@@@Collections@Foundation@Win.c)
 *     ??$is_guid_of@U?$IVectorView@UUserResizeVisual@Transitions@Udwm@winrt@@@Collections@Foundation@Windows@winrt@@@winrt@@YA_NAEBUguid@0@@Z @ 0x1800E84A4 (--$is_guid_of@U-$IVectorView@UUserResizeVisual@Transitions@Udwm@winrt@@@Collections@Foundation@W.c)
 */
