/*
 * XREFs of _winrt::Udwm::Transitions::Private::implementation::WindowJointResizeTransition::PreTransition_::_1_::dtor$3 @ 0x1800F8B6F
 * Callers:
 *     <none>
 * Callees:
 *     <none>
