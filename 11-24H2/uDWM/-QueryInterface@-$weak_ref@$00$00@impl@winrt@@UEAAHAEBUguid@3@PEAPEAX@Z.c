/*
 * XREFs of ?QueryInterface@?$weak_ref@$00$00@impl@winrt@@UEAAHAEBUguid@3@PEAPEAX@Z @ 0x1800DECE0
 * Callers:
 *     <none>
 * Callees:
 ...
 *     ??$is_guid_of@UIWeakReference@impl@winrt@@@winrt@@YA_NAEBUguid@0@@Z @ 0x1800DE414 (--$is_guid_of@UIWeakReference@impl@winrt@@@winrt@@YA_NAEBUguid@0@@Z.c)
 */
