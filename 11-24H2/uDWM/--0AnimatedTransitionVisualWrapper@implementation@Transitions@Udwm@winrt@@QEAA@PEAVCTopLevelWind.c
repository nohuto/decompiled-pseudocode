/*
 * XREFs of ??0AnimatedTransitionVisualWrapper@implementation@Transitions@Udwm@winrt@@QEAA@PEAVCTopLevelWindow3D@@@Z @ 0x18004C940
 * Callers:
        ...
        __int64 a3)
{
  ...
  *v5 = 0LL;
  ...
  v11 = (struct CVisual *)CTopLevelWindow::GetRootVisualNoAddRef(
                            *(_QWORD **)(*(_QWORD *)(*((_QWORD *)this + 6) + 288LL) + 440LL),
                            0);
  v12 = CAnimatedTransitionVisual::ProcessSnapshotOnVisual((CAnimatedTransitionVisual *)*v5, v11, &v20);
  if ( v12 < 0 )
    wil::details::in1diag3::Throw_Hr(
      retaddr,
      (void *)0x1C,
