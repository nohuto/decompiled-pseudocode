/*
 * XREFs of ?GetCachedFeatureEnabledState@?$FeatureImpl@U__WilFeatureTraits_Feature_Capture_CaptureManagerBackport@@@details@wil@@AEAA?ATwil_details_FeatureStateCache@@XZ @ 0x1800B8A3C
 * Callers:
...
_QWORD *__fastcall wil::details::FeatureImpl<__WilFeatureTraits_Feature_Capture_CaptureManagerBackport>::GetCachedFeatureEnabledState(
        wil::details *a1,
        _QWORD *a2)
{
  int v3; // eax
  ...
  *(_DWORD *)a2 = *(_DWORD *)a1;
  if ( (v3 & 6) != 6 )
  {
    ...
    v16 = 0;
    v6 = v5;
    wil::details::FeatureImpl<__WilFeatureTraits_Feature_Capture_CaptureManagerBackport>::GetCurrentFeatureEnabledState(
      v7,
      &v17,
      &v16);
