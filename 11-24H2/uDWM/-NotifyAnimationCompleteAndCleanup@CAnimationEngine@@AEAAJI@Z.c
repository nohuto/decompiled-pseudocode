/*
 * XREFs of ?NotifyAnimationCompleteAndCleanup@CAnimationEngine@@AEAAJI@Z @ 0x18006C4DC
 * Callers:
...
__int64 __fastcall CAnimationEngine::NotifyAnimationCompleteAndCleanup(CAnimationEngine *this, unsigned int a2)
{
