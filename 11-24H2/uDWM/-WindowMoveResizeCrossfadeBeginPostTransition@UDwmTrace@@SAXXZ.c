/*
 * XREFs of ?WindowMoveResizeCrossfadeBeginPostTransition@UDwmTrace@@SAXXZ @ 0x18004C79C
 * Callers:
...
void __fastcall UDwmTrace::WindowMoveResizeCrossfadeBeginPostTransition(__int64 a1)
{
